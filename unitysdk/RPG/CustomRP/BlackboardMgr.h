...
#define RPG_CUSTOMRP_BLACKBOARDMGR_CREATECPP_OFFSET UNITYSDK_OFFSET(0x1C66C8F0)
#define RPG_CUSTOMRP_BLACKBOARDMGR_GET_GLOBALENABLEDIRBLUR_OFFSET UNITYSDK_OFFSET(0x1C66C9D0)
#define RPG_CUSTOMRP_BLACKBOARDMGR_GET_GLOBALENABLEDOF_OFFSET UNITYSDK_OFFSET(0x1C66C9B0)
#define RPG_CUSTOMRP_BLACKBOARDMGR_GET_GLOBALENABLEGAUSSBLUR_OFFSET UNITYSDK_OFFSET(0x1C66C9F0)
#define RPG_CUSTOMRP_BLACKBOARDMGR_GET_GLOBALENABLEMOTIONBLUR_OFFSET UNITYSDK_OFFSET(0x1C66CA10)
#define RPG_CUSTOMRP_BLACKBOARDMGR_GET_GLOBALENABLERADIALBLUR_OFFSET UNITYSDK_OFFSET(0x1C66CA30)
#define RPG_CUSTOMRP_BLACKBOARDMGR_RELEASE_OFFSET UNITYSDK_OFFSET(0x1C66C9A0)
#define RPG_CUSTOMRP_BLACKBOARDMGR_SET_GLOBALENABLEDIRBLUR_OFFSET UNITYSDK_OFFSET(0x1C66C9E0)
#define RPG_CUSTOMRP_BLACKBOARDMGR_SET_GLOBALENABLEDOF_OFFSET UNITYSDK_OFFSET(0x1C66C9C0)
#define RPG_CUSTOMRP_BLACKBOARDMGR_SET_GLOBALENABLEGAUSSBLUR_OFFSET UNITYSDK_OFFSET(0x1C66CA00)
#define RPG_CUSTOMRP_BLACKBOARDMGR_SET_GLOBALENABLEMOTIONBLUR_OFFSET UNITYSDK_OFFSET(0x1C66CA20)
#define RPG_CUSTOMRP_BLACKBOARDMGR_SET_GLOBALENABLERADIALBLUR_OFFSET UNITYSDK_OFFSET(0x1C66CA40)
#define RPG_CUSTOMRP_BLACKBOARDMGR__CTOR_OFFSET UNITYSDK_OFFSET(0x1C66C980)
#define RPG_CUSTOMRP_BLACKBOARDMGR__INITCPP_OFFSET UNITYSDK_OFFSET(0x1C66C990)
#define RPG_CUSTOMRP_BLACKBOARDMGR__INITPROFILE_OFFSET UNITYSDK_OFFSET(0x1C66CA50)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int BlackboardMgr_TypeDefinitionIndex = 36844;

	class BlackboardMgr : public ::System::Object
	{
	public:
		::System::Boolean _GlobalEnableDirBlur_k__BackingField; // 0x10
		::System::Boolean _GlobalEnableGaussBlur_k__BackingField; // 0x11
		::System::Boolean _GlobalEnableRadialBlur_k__BackingField; // 0x12
		::System::Boolean _GlobalEnableMotionBlur_k__BackingField; // 0x13
