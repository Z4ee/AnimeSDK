...
#define RPG_CUSTOMRP_CRPGRAPHICSSETTINGSDATA_VOXELIRRADIANCECACHESETTINGS_GET_RENDERSCALE_OFFSET UNITYSDK_OFFSET(0x1780F4E0)
#define RPG_CUSTOMRP_CRPGRAPHICSSETTINGSDATA_VOXELIRRADIANCECACHESETTINGS_SET_RENDERSCALE_OFFSET UNITYSDK_OFFSET(0x1780F500)
#define RPG_CUSTOMRP_CRPGRAPHICSSETTINGSDATA_VOXELIRRADIANCECACHESETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1780F510)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int CRPGraphicsSettingsData_VoxelIrradianceCacheSettings_TypeDefinitionIndex = 36124;
