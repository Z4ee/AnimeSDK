...
#define RPG_CUSTOMRP_PREVIEWPPFS_METHOD_5_0E3D8071A5930FA8_1_OFFSET UNITYSDK_OFFSET(0xB4F79B0)
#define RPG_CUSTOMRP_PREVIEWPPFS_METHOD_5_0E3D8071A5930FA8_OFFSET UNITYSDK_OFFSET(0xB4F5590)
#define RPG_CUSTOMRP_PREVIEWPPFS_METHOD_5_81A66FB988DFA6AA_OFFSET UNITYSDK_OFFSET(0xB4F64C0)
#define RPG_CUSTOMRP_PREVIEWPPFS_METHOD_5_A2172401030892FD_OFFSET UNITYSDK_OFFSET(0xB4F99A0)
#define RPG_CUSTOMRP_PREVIEWPPFS_METHOD_5_AE80CBC984AADFD5_1_OFFSET UNITYSDK_OFFSET(0xB4F93C0)
#define RPG_CUSTOMRP_PREVIEWPPFS_METHOD_5_AE80CBC984AADFD5_OFFSET UNITYSDK_OFFSET(0xB4F6EE0)
#define RPG_CUSTOMRP_PREVIEWPPFS_METHOD_5_B29205EE7F7B640C_OFFSET UNITYSDK_OFFSET(0xB4F6920)
#define RPG_CUSTOMRP_PREVIEWPPFS_METHOD_5_C83B2479936B63C3_OFFSET UNITYSDK_OFFSET(0xB4F7580)
#define RPG_CUSTOMRP_PREVIEWPPFS_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xB4FA2F0)
#define RPG_CUSTOMRP_PREVIEWPPFS_START_OFFSET UNITYSDK_OFFSET(0xB4F53F0)
#define RPG_CUSTOMRP_PREVIEWPPFS_UPDATE_OFFSET UNITYSDK_OFFSET(0xB4F5470)
#define RPG_CUSTOMRP_PREVIEWPPFS__CTOR_OFFSET UNITYSDK_OFFSET(0xB4FAEC0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int previewPPFS_TypeDefinitionIndex = 47875;
