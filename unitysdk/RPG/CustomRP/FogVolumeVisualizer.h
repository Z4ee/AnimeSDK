...
#define RPG_CUSTOMRP_FOGVOLUMEVISUALIZER_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x18EE3E10)
#define RPG_CUSTOMRP_FOGVOLUMEVISUALIZER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x18EE3D90)
#define RPG_CUSTOMRP_FOGVOLUMEVISUALIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x18EE4160)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int FogVolumeVisualizer_TypeDefinitionIndex = 35408;
