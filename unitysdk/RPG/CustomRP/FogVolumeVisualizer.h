...
#define RPG_CUSTOMRP_FOGVOLUMEVISUALIZER_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x1C6AA460)
#define RPG_CUSTOMRP_FOGVOLUMEVISUALIZER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1C6AA3E0)
#define RPG_CUSTOMRP_FOGVOLUMEVISUALIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C6AA7B0)
