...
#define RPG_CUSTOMRP_RENDERINGGLOBALVARS___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C6E8EC0)
#define RPG_CUSTOMRP_RENDERINGGLOBALVARS___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1C6E8F00)
#define RPG_CUSTOMRP_RENDERINGGLOBALVARS___C__GET_VALIDLOCALREFLECTION_B__108_0_OFFSET UNITYSDK_OFFSET(0x1C6E8F10)
...
namespace RPG::CustomRP
{
	...
	public:
		...
		{
			return (::System::Func_2<::RPG::CustomRP::IPlaneReflection*, ::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(RenderingGlobalVars___c_TypeDefinitionIndex)->GetStaticField(0x3F6E0);
		}
		static ::RPG::CustomRP::RenderingGlobalVars___c** StaticGet___9()
		{
			return (::RPG::CustomRP::RenderingGlobalVars___c**)Il2CppClass::FromTypeDefinitionIndex(RenderingGlobalVars___c_TypeDefinitionIndex)->GetStaticField(0x3F6E8);
		}
