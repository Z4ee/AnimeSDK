...
#define RPG_CUSTOMRP_POSMPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x16AA49D0)
...
namespace RPG::CustomRP
{
	...
	{
	public:
		::UnityEngine::Matrix4x4 oobbDelegateDrawMatrix; // 0x10
		::UnityEngine::Matrix4x4 worldToBounds; // 0x50
		::UnityEngine::Matrix4x4 localToWorld; // 0x90
