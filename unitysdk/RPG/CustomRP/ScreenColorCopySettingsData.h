...
#define RPG_CUSTOMRP_SCREENCOLORCOPYSETTINGSDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1817D7F0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int ScreenColorCopySettingsData_TypeDefinitionIndex = 35229;
