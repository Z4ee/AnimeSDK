...
#define RPG_CUSTOMRP_DEBUGSHADERHOTRELOADRESULTMSG_GETMESSAGETYPE_OFFSET UNITYSDK_OFFSET(0x18EDD380)
#define RPG_CUSTOMRP_DEBUGSHADERHOTRELOADRESULTMSG_READ_OFFSET UNITYSDK_OFFSET(0x18EDD450)
#define RPG_CUSTOMRP_DEBUGSHADERHOTRELOADRESULTMSG_RESET_OFFSET UNITYSDK_OFFSET(0x18EDD4C0)
#define RPG_CUSTOMRP_DEBUGSHADERHOTRELOADRESULTMSG_WRITE_OFFSET UNITYSDK_OFFSET(0x18EDD3C0)
#define RPG_CUSTOMRP_DEBUGSHADERHOTRELOADRESULTMSG__CTOR_OFFSET UNITYSDK_OFFSET(0x18EDD4F0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int DebugShaderHotReloadResultMsg_TypeDefinitionIndex = 35423;
