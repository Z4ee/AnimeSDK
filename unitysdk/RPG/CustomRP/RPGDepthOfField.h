...
#define RPG_CUSTOMRP_RPGDEPTHOFFIELD_ISACTIVEIMPL_OFFSET UNITYSDK_OFFSET(0x181517A0)
#define RPG_CUSTOMRP_RPGDEPTHOFFIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x18151800)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int RPGDepthOfField_TypeDefinitionIndex = 35172;
