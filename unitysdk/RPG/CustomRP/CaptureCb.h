...
#define RPG_CUSTOMRP_CAPTURECB_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C688330)
#define RPG_CUSTOMRP_CAPTURECB_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C6883A0)
#define RPG_CUSTOMRP_CAPTURECB_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C688320)
#define RPG_CUSTOMRP_CAPTURECB__CTOR_OFFSET UNITYSDK_OFFSET(0x1C6882B0)
