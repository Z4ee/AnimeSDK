...
#define RPG_CUSTOMRP_CAPTURECB_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1811F080)
#define RPG_CUSTOMRP_CAPTURECB_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1811F0F0)
#define RPG_CUSTOMRP_CAPTURECB_INVOKE_OFFSET UNITYSDK_OFFSET(0x1811ED30)
#define RPG_CUSTOMRP_CAPTURECB__CTOR_OFFSET UNITYSDK_OFFSET(0x1811E3C0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int CaptureCb_TypeDefinitionIndex = 34998;
