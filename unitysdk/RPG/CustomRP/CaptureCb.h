...
#define RPG_CUSTOMRP_CAPTURECB_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18EC1470)
#define RPG_CUSTOMRP_CAPTURECB_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18EC14E0)
#define RPG_CUSTOMRP_CAPTURECB_INVOKE_OFFSET UNITYSDK_OFFSET(0x18EC1460)
#define RPG_CUSTOMRP_CAPTURECB__CTOR_OFFSET UNITYSDK_OFFSET(0x18EC13F0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int CaptureCb_TypeDefinitionIndex = 35283;
