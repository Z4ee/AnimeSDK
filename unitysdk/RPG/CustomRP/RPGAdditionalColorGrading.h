...
#define RPG_CUSTOMRP_RPGADDITIONALCOLORGRADING__CTOR_OFFSET UNITYSDK_OFFSET(0x16BF6090)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int RPGAdditionalColorGrading_TypeDefinitionIndex = 36238;
