...
#define RPG_CUSTOMRP_RPGADDITIONALCOLORGRADING__CTOR_OFFSET UNITYSDK_OFFSET(0x18EEFD90)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int RPGAdditionalColorGrading_TypeDefinitionIndex = 35456;
