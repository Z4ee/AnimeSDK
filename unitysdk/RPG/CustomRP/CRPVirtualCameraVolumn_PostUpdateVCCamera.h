...
#define RPG_CUSTOMRP_CRPVIRTUALCAMERAVOLUMN_POSTUPDATEVCCAMERA_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18EBFFF0)
#define RPG_CUSTOMRP_CRPVIRTUALCAMERAVOLUMN_POSTUPDATEVCCAMERA_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18EC00A0)
#define RPG_CUSTOMRP_CRPVIRTUALCAMERAVOLUMN_POSTUPDATEVCCAMERA_INVOKE_OFFSET UNITYSDK_OFFSET(0x18EBFC20)
#define RPG_CUSTOMRP_CRPVIRTUALCAMERAVOLUMN_POSTUPDATEVCCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x18EBFF70)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int CRPVirtualCameraVolumn_PostUpdateVCCamera_TypeDefinitionIndex = 35368;
