...
#define RPG_CUSTOMRP_CRPVIRTUALCAMERAVOLUMN_POSTUPDATEVCCAMERA_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1811D480)
#define RPG_CUSTOMRP_CRPVIRTUALCAMERAVOLUMN_POSTUPDATEVCCAMERA_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1811D530)
#define RPG_CUSTOMRP_CRPVIRTUALCAMERAVOLUMN_POSTUPDATEVCCAMERA_INVOKE_OFFSET UNITYSDK_OFFSET(0x1811CB20)
#define RPG_CUSTOMRP_CRPVIRTUALCAMERAVOLUMN_POSTUPDATEVCCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x1811D460)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int CRPVirtualCameraVolumn_PostUpdateVCCamera_TypeDefinitionIndex = 35082;
