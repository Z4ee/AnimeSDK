...
#define RPG_CUSTOMRP_CUSTOMADDITIONALLIGHTDATA_FLUSHDATA_OFFSET UNITYSDK_OFFSET(0x18ED4FF0)
#define RPG_CUSTOMRP_CUSTOMADDITIONALLIGHTDATA_GETLIGHTDELEGATEMESH_OFFSET UNITYSDK_OFFSET(0x18ED56F0)
#define RPG_CUSTOMRP_CUSTOMADDITIONALLIGHTDATA_GETPROFILETYPE_OFFSET UNITYSDK_OFFSET(0x18ED5710)
#define RPG_CUSTOMRP_CUSTOMADDITIONALLIGHTDATA_GET_LIGHTCOMP_OFFSET UNITYSDK_OFFSET(0x18ED4E20)
#define RPG_CUSTOMRP_CUSTOMADDITIONALLIGHTDATA_GET_NEEDUPDATE_OFFSET UNITYSDK_OFFSET(0x18ED4E00)
#define RPG_CUSTOMRP_CUSTOMADDITIONALLIGHTDATA_GET_TRAN_OFFSET UNITYSDK_OFFSET(0x18ED4E50)
#define RPG_CUSTOMRP_CUSTOMADDITIONALLIGHTDATA_GET_USEPIPELINESETTINGS_OFFSET UNITYSDK_OFFSET(0x18ED4E30)
#define RPG_CUSTOMRP_CUSTOMADDITIONALLIGHTDATA_HASFLAG_OFFSET UNITYSDK_OFFSET(0x18ED4E10)
#define RPG_CUSTOMRP_CUSTOMADDITIONALLIGHTDATA_MANUALCREATE_OFFSET UNITYSDK_OFFSET(0x18ED4F10)
#define RPG_CUSTOMRP_CUSTOMADDITIONALLIGHTDATA_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x18ED5820)
#define RPG_CUSTOMRP_CUSTOMADDITIONALLIGHTDATA_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x18ED5780)
#define RPG_CUSTOMRP_CUSTOMADDITIONALLIGHTDATA_ONENABLE_OFFSET UNITYSDK_OFFSET(0x18ED5720)
#define RPG_CUSTOMRP_CUSTOMADDITIONALLIGHTDATA_ONRETURN2POOL_OFFSET UNITYSDK_OFFSET(0x18ED5570)
#define RPG_CUSTOMRP_CUSTOMADDITIONALLIGHTDATA_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x18ED4E60)
#define RPG_CUSTOMRP_CUSTOMADDITIONALLIGHTDATA_PARTICLELIGHTONLOAD_OFFSET UNITYSDK_OFFSET(0x18ED5580)
#define RPG_CUSTOMRP_CUSTOMADDITIONALLIGHTDATA_RESETLIGHTDATA_OFFSET UNITYSDK_OFFSET(0x18ED5460)
#define RPG_CUSTOMRP_CUSTOMADDITIONALLIGHTDATA_SETFLAG_OFFSET UNITYSDK_OFFSET(0x18ED4FD0)
#define RPG_CUSTOMRP_CUSTOMADDITIONALLIGHTDATA_SET_USEPIPELINESETTINGS_OFFSET UNITYSDK_OFFSET(0x18ED4E40)
#define RPG_CUSTOMRP_CUSTOMADDITIONALLIGHTDATA_START_OFFSET UNITYSDK_OFFSET(0x18ED4F70)
#define RPG_CUSTOMRP_CUSTOMADDITIONALLIGHTDATA_SUPPORTSCLUSTERLIGHTING_OFFSET UNITYSDK_OFFSET(0x18ED5700)
#define RPG_CUSTOMRP_CUSTOMADDITIONALLIGHTDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x18ED6490)
#define RPG_CUSTOMRP_CUSTOMADDITIONALLIGHTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18ED62C0)
#define RPG_CUSTOMRP_CUSTOMADDITIONALLIGHTDATA__FLUSHDATA_OFFSET UNITYSDK_OFFSET(0x18ED5000)
#define RPG_CUSTOMRP_CUSTOMADDITIONALLIGHTDATA__ISPOINTSPOT_OFFSET UNITYSDK_OFFSET(0x18ED58C0)
#define RPG_CUSTOMRP_CUSTOMADDITIONALLIGHTDATA__PREPARE_OFFSET UNITYSDK_OFFSET(0x18ED54A0)
#define RPG_CUSTOMRP_CUSTOMADDITIONALLIGHTDATA__UPDATEIFNEEDED_OFFSET UNITYSDK_OFFSET(0x18ED4EC0)
#define RPG_CUSTOMRP_CUSTOMADDITIONALLIGHTDATA__UPDATELIGHTDATAAREA_OFFSET UNITYSDK_OFFSET(0x18ED6250)
#define RPG_CUSTOMRP_CUSTOMADDITIONALLIGHTDATA__UPDATELIGHTDATALOCAL_OFFSET UNITYSDK_OFFSET(0x18ED5F70)
#define RPG_CUSTOMRP_CUSTOMADDITIONALLIGHTDATA__UPDATELIGHTDATASPOT_OFFSET UNITYSDK_OFFSET(0x18ED5ED0)
#define RPG_CUSTOMRP_CUSTOMADDITIONALLIGHTDATA__UPDATELIGHTDATA_OFFSET UNITYSDK_OFFSET(0x18ED5910)
#define RPG_CUSTOMRP_CUSTOMADDITIONALLIGHTDATA__UPDATELIGHTMESHSTENCIL_OFFSET UNITYSDK_OFFSET(0x18ED5CE0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int CustomAdditionalLightData_TypeDefinitionIndex = 35383;
	...
	public:
		...
		{
			return (::UnityEngine::Rendering::CRPLightInfoSpot*)Il2CppClass::FromTypeDefinitionIndex(CustomAdditionalLightData_TypeDefinitionIndex)->GetStaticField(0x12E40);
		}
		static ::UnityEngine::Rendering::CRPLightMeshStencil* StaticGet__MeshStencil()
		{
			return (::UnityEngine::Rendering::CRPLightMeshStencil*)Il2CppClass::FromTypeDefinitionIndex(CustomAdditionalLightData_TypeDefinitionIndex)->GetStaticField(0x12E48);
		}
		static ::UnityEngine::Rendering::CRPLightInfoArea* StaticGet__LightInfoArea()
		{
			return (::UnityEngine::Rendering::CRPLightInfoArea*)Il2CppClass::FromTypeDefinitionIndex(CustomAdditionalLightData_TypeDefinitionIndex)->GetStaticField(0x12E8C);
		}
		static ::UnityEngine::Rendering::CRPLightInfoCommon* StaticGet__LightInfo()
		{
			return (::UnityEngine::Rendering::CRPLightInfoCommon*)Il2CppClass::FromTypeDefinitionIndex(CustomAdditionalLightData_TypeDefinitionIndex)->GetStaticField(0x12EA8);
		}
		static ::System::Single* StaticGet_maxSpotDelegateAngle()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(CustomAdditionalLightData_TypeDefinitionIndex)->GetStaticField(0x12F1C);
		}
		static ::UnityEngine::Rendering::CRPLightInfoLocal* StaticGet__LightInfoLocal()
		{
			return (::UnityEngine::Rendering::CRPLightInfoLocal*)Il2CppClass::FromTypeDefinitionIndex(CustomAdditionalLightData_TypeDefinitionIndex)->GetStaticField(0x12F20);
		}
