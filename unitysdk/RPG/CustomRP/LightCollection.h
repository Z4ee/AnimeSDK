...
#define RPG_CUSTOMRP_LIGHTCOLLECTION_APPLYLIGHTMODE_OFFSET UNITYSDK_OFFSET(0x1743D550)
#define RPG_CUSTOMRP_LIGHTCOLLECTION_GET_MODE_OFFSET UNITYSDK_OFFSET(0x1743D490)
#define RPG_CUSTOMRP_LIGHTCOLLECTION_METHOD_5_4A3C3BDB6511B6FD_OFFSET UNITYSDK_OFFSET(0x1743D640)
#define RPG_CUSTOMRP_LIGHTCOLLECTION_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1743D5C0)
#define RPG_CUSTOMRP_LIGHTCOLLECTION_SET_MODE_OFFSET UNITYSDK_OFFSET(0x1743D4A0)
#define RPG_CUSTOMRP_LIGHTCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1743D770)
#define RPG_CUSTOMRP_LIGHTCOLLECTION__GET_LIGHTSCANNOTBEBAKED_B__9_0_OFFSET UNITYSDK_OFFSET(0x1743D780)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int LightCollection_TypeDefinitionIndex = 49474;
