...
#define RPG_CUSTOMRP_LENSFLARETARGET_COMPARETO_OFFSET UNITYSDK_OFFSET(0x1857D4A0)
#define RPG_CUSTOMRP_LENSFLARETARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1857D4F0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int LensFlareTarget_TypeDefinitionIndex = 37136;
	...
	public:
		...
		::System::Single TotalAspectScale; // 0x2C
		::System::Single TotalOffsetScale; // 0x30
		::System::Single MinSizeWhenFade; // 0x34
		::System::Single SampleRedius; // 0x38
		::System::Single ColorThreshold; // 0x3C
		::System::Single TotalRotationOffset; // 0x40
		::System::Int32 Priority; // 0x44
		::System::Single DephtBias; // 0x48
		::System::Single TotalSizeScale; // 0x4C
