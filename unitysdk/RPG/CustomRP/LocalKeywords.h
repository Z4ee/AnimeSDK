...
#define RPG_CUSTOMRP_LOCALKEYWORDS_ADD_OFFSET UNITYSDK_OFFSET(0x18141A30)
#define RPG_CUSTOMRP_LOCALKEYWORDS_GETKEYWORDS_OFFSET UNITYSDK_OFFSET(0x18141BA0)
#define RPG_CUSTOMRP_LOCALKEYWORDS_RESET_OFFSET UNITYSDK_OFFSET(0x18141A20)
#define RPG_CUSTOMRP_LOCALKEYWORDS__CTOR_OFFSET UNITYSDK_OFFSET(0x18141DD0)
