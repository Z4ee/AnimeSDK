...
#define RPG_CUSTOMRP_LOCALKEYWORDS_ADD_OFFSET UNITYSDK_OFFSET(0x18EE7C00)
#define RPG_CUSTOMRP_LOCALKEYWORDS_GETKEYWORDS_OFFSET UNITYSDK_OFFSET(0x18EE7D50)
#define RPG_CUSTOMRP_LOCALKEYWORDS_RESET_OFFSET UNITYSDK_OFFSET(0x18EE7BF0)
#define RPG_CUSTOMRP_LOCALKEYWORDS__CTOR_OFFSET UNITYSDK_OFFSET(0x18EE7F20)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int LocalKeywords_TypeDefinitionIndex = 35554;
	...
	public:
		...
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Int32>* _LocalMap; // 0x18
		::Il2CppArray<::System::String*>* _Keywords; // 0x20
		::System::Int32 _Count; // 0x28
		::System::Int32 _Mask; // 0x2C
