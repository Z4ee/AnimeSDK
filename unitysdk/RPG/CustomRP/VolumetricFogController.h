...
#define RPG_CUSTOMRP_VOLUMETRICFOGCONTROLLER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1D138820)
#define RPG_CUSTOMRP_VOLUMETRICFOGCONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1D1389D0)
#define RPG_CUSTOMRP_VOLUMETRICFOGCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1D138970)
#define RPG_CUSTOMRP_VOLUMETRICFOGCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1D1388F0)
#define RPG_CUSTOMRP_VOLUMETRICFOGCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D138AC0)
#define RPG_CUSTOMRP_VOLUMETRICFOGCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D138A30)
...
namespace RPG::CustomRP
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::HashSet_1<::RPG::CustomRP::VolumetricFogController*>**)Il2CppClass::FromTypeDefinitionIndex(VolumetricFogController_TypeDefinitionIndex)->GetStaticField(0x61120);
		}
