...
#define RPG_CUSTOMRP_VOLUMETRICFOGCONTROLLER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1EE5CA60)
#define RPG_CUSTOMRP_VOLUMETRICFOGCONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1EE5CC10)
#define RPG_CUSTOMRP_VOLUMETRICFOGCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1EE5CBB0)
#define RPG_CUSTOMRP_VOLUMETRICFOGCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1EE5CB30)
#define RPG_CUSTOMRP_VOLUMETRICFOGCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1EE5CD00)
#define RPG_CUSTOMRP_VOLUMETRICFOGCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EE5CC70)
...
namespace RPG::CustomRP
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::HashSet_1<::RPG::CustomRP::VolumetricFogController*>**)Il2CppClass::FromTypeDefinitionIndex(VolumetricFogController_TypeDefinitionIndex)->GetStaticField(0x3C2D0);
		}
