...
#define RPG_CUSTOMRP_QACAPTUREDATA_DIFF_OFFSET UNITYSDK_OFFSET(0x3947020)
#define RPG_CUSTOMRP_QACAPTUREDATA_GET_EMPTY_OFFSET UNITYSDK_OFFSET(0x3946FD0)
#define RPG_CUSTOMRP_QACAPTUREDATA_OUTPUTASDIFF_OFFSET UNITYSDK_OFFSET(0x3947080)
#define RPG_CUSTOMRP_QACAPTUREDATA_UNSERIALIZE_OFFSET UNITYSDK_OFFSET(0x16BF5DE0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int QACaptureData_TypeDefinitionIndex = 36074;
