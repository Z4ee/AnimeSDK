...
#define RPG_CUSTOMRP_QACAPTUREDATA_DIFF_OFFSET UNITYSDK_OFFSET(0x3B80850)
#define RPG_CUSTOMRP_QACAPTUREDATA_GET_EMPTY_OFFSET UNITYSDK_OFFSET(0x3B80800)
#define RPG_CUSTOMRP_QACAPTUREDATA_OUTPUTASDIFF_OFFSET UNITYSDK_OFFSET(0x3B808B0)
#define RPG_CUSTOMRP_QACAPTUREDATA_UNSERIALIZE_OFFSET UNITYSDK_OFFSET(0x1C6B6430)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int QACaptureData_TypeDefinitionIndex = 36934;
