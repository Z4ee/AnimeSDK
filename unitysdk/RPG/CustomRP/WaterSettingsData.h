...
#define RPG_CUSTOMRP_WATERSETTINGSDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1EE5CDB0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int WaterSettingsData_TypeDefinitionIndex = 37169;
