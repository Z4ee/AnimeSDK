...
#define RPG_CUSTOMRP_WATERSETTINGSDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1D138B70)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int WaterSettingsData_TypeDefinitionIndex = 36310;
