...
#define RPG_CUSTOMRP_CRPGRAPHICSSETTINGSDATA_GLOBALSDFSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x18113990)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int CRPGraphicsSettingsData_GlobalSDFSettings_TypeDefinitionIndex = 35060;
