...
#define RPG_CUSTOMRP_INSTANCEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18EE7B60)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int InstanceInfo_TypeDefinitionIndex = 35251;
