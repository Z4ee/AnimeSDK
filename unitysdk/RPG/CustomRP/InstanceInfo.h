...
#define RPG_CUSTOMRP_INSTANCEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16BEDBD0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int InstanceInfo_TypeDefinitionIndex = 36033;
	...
	public:
		...
		::System::Int32 y; // 0x24
		::System::Double nearDepth; // 0x28
		::System::Double nearDepth01; // 0x30
		::System::Boolean isInFrustum; // 0x38
