...
#define RPG_CUSTOMRP_CRPGRAPHICSSETTINGSDATA_DLSSSETTINGS_GET_DISCARD_OFFSET UNITYSDK_OFFSET(0x16A70640)
#define RPG_CUSTOMRP_CRPGRAPHICSSETTINGSDATA_DLSSSETTINGS_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x16A687B0)
#define RPG_CUSTOMRP_CRPGRAPHICSSETTINGSDATA_DLSSSETTINGS_SET_DISCARD_OFFSET UNITYSDK_OFFSET(0x16A70650)
#define RPG_CUSTOMRP_CRPGRAPHICSSETTINGSDATA_DLSSSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x16A70660)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int CRPGraphicsSettingsData_DLSSSettings_TypeDefinitionIndex = 29296;
