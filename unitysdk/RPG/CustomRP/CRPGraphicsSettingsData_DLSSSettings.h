...
#define RPG_CUSTOMRP_CRPGRAPHICSSETTINGSDATA_DLSSSETTINGS_GET_DISCARD_OFFSET UNITYSDK_OFFSET(0x18113910)
#define RPG_CUSTOMRP_CRPGRAPHICSSETTINGSDATA_DLSSSETTINGS_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x1810BA20)
#define RPG_CUSTOMRP_CRPGRAPHICSSETTINGSDATA_DLSSSETTINGS_SET_DISCARD_OFFSET UNITYSDK_OFFSET(0x18113920)
#define RPG_CUSTOMRP_CRPGRAPHICSSETTINGSDATA_DLSSSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x18113930)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int CRPGraphicsSettingsData_DLSSSettings_TypeDefinitionIndex = 35063;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Boolean))((::PBYTE)hIl2Cpp + RPG_CUSTOMRP_CRPGRAPHICSSETTINGSDATA_DLSSSETTINGS_SET_DISCARD_OFFSET))(this, value);
		}
	};
}
