...
#define RPG_CUSTOMRP_CRPGRAPHICSSETTINGSDATA_DLSSSETTINGS_GET_DISCARD_OFFSET UNITYSDK_OFFSET(0x1780F340)
#define RPG_CUSTOMRP_CRPGRAPHICSSETTINGSDATA_DLSSSETTINGS_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x17807DA0)
#define RPG_CUSTOMRP_CRPGRAPHICSSETTINGSDATA_DLSSSETTINGS_SET_DISCARD_OFFSET UNITYSDK_OFFSET(0x1780F350)
#define RPG_CUSTOMRP_CRPGRAPHICSSETTINGSDATA_DLSSSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1780F360)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int CRPGraphicsSettingsData_DLSSSettings_TypeDefinitionIndex = 36130;
