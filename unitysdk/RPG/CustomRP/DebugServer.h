...
#define RPG_CUSTOMRP_DEBUGSERVER_ADDDEBUGSERVER_OFFSET UNITYSDK_OFFSET(0x16BE1B40)
#define RPG_CUSTOMRP_DEBUGSERVER_ENQUEUECB_OFFSET UNITYSDK_OFFSET(0x16BE2E20)
#define RPG_CUSTOMRP_DEBUGSERVER_ENQUEUEMESSAGE_OFFSET UNITYSDK_OFFSET(0x16BE2DE0)
#define RPG_CUSTOMRP_DEBUGSERVER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x16BE1B30)
#define RPG_CUSTOMRP_DEBUGSERVER_GET_OFFSET UNITYSDK_OFFSET(0x16BE1DE0)
#define RPG_CUSTOMRP_DEBUGSERVER_ONAPPLICATIONPAUSE_OFFSET UNITYSDK_OFFSET(0x16BE2C30)
#define RPG_CUSTOMRP_DEBUGSERVER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x16BE26C0)
#define RPG_CUSTOMRP_DEBUGSERVER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x16BE2340)
#define RPG_CUSTOMRP_DEBUGSERVER_RELEASE_OFFSET UNITYSDK_OFFSET(0x16BE2070)
#define RPG_CUSTOMRP_DEBUGSERVER_UPDATE_OFFSET UNITYSDK_OFFSET(0x16BE2990)
#define RPG_CUSTOMRP_DEBUGSERVER__CTOR_OFFSET UNITYSDK_OFFSET(0x16BE3D70)
#define RPG_CUSTOMRP_DEBUGSERVER__ONCONNECTED_OFFSET UNITYSDK_OFFSET(0x16BE3600)
#define RPG_CUSTOMRP_DEBUGSERVER__ONCONNECTING_OFFSET UNITYSDK_OFFSET(0x16BE3000)
#define RPG_CUSTOMRP_DEBUGSERVER__ONDISCONNECTED_OFFSET UNITYSDK_OFFSET(0x16BE3C30)
#define RPG_CUSTOMRP_DEBUGSERVER__ONWAITING_OFFSET UNITYSDK_OFFSET(0x16BE2F50)
#define RPG_CUSTOMRP_DEBUGSERVER__SETSTATE_OFFSET UNITYSDK_OFFSET(0x16BE2E90)
#define RPG_CUSTOMRP_DEBUGSERVER__STARTLISTENING_OFFSET UNITYSDK_OFFSET(0x16BE2520)
#define RPG_CUSTOMRP_DEBUGSERVER__STOP_OFFSET UNITYSDK_OFFSET(0x16BE2850)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int DebugServer_TypeDefinitionIndex = 36369;
	...
	public:
		...
		{
			return (::RPG::CustomRP::DebugServer**)Il2CppClass::FromTypeDefinitionIndex(DebugServer_TypeDefinitionIndex)->GetStaticField(0x5FDC0);
		}
