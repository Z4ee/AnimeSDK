...
#define RPG_CUSTOMRP_DEBUGSERVER_ADDDEBUGSERVER_OFFSET UNITYSDK_OFFSET(0x1C6A1D90)
#define RPG_CUSTOMRP_DEBUGSERVER_ENQUEUECB_OFFSET UNITYSDK_OFFSET(0x1C6A30A0)
#define RPG_CUSTOMRP_DEBUGSERVER_ENQUEUEMESSAGE_OFFSET UNITYSDK_OFFSET(0x1C6A3060)
#define RPG_CUSTOMRP_DEBUGSERVER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1C6A1D80)
#define RPG_CUSTOMRP_DEBUGSERVER_GET_OFFSET UNITYSDK_OFFSET(0x1C6A2030)
#define RPG_CUSTOMRP_DEBUGSERVER_ONAPPLICATIONPAUSE_OFFSET UNITYSDK_OFFSET(0x1C6A2EB0)
#define RPG_CUSTOMRP_DEBUGSERVER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1C6A2910)
#define RPG_CUSTOMRP_DEBUGSERVER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1C6A2590)
#define RPG_CUSTOMRP_DEBUGSERVER_RELEASE_OFFSET UNITYSDK_OFFSET(0x1C6A22C0)
#define RPG_CUSTOMRP_DEBUGSERVER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1C6A2C10)
#define RPG_CUSTOMRP_DEBUGSERVER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C6A4350)
#define RPG_CUSTOMRP_DEBUGSERVER__ONCONNECTED_OFFSET UNITYSDK_OFFSET(0x1C6A3C40)
#define RPG_CUSTOMRP_DEBUGSERVER__ONCONNECTING_OFFSET UNITYSDK_OFFSET(0x1C6A3640)
#define RPG_CUSTOMRP_DEBUGSERVER__ONDISCONNECTED_OFFSET UNITYSDK_OFFSET(0x1C6A4210)
#define RPG_CUSTOMRP_DEBUGSERVER__ONWAITING_OFFSET UNITYSDK_OFFSET(0x1C6A3590)
#define RPG_CUSTOMRP_DEBUGSERVER__SETSTATE_OFFSET UNITYSDK_OFFSET(0x1C6A3110)
#define RPG_CUSTOMRP_DEBUGSERVER__STARTLISTENING_OFFSET UNITYSDK_OFFSET(0x1C6A2770)
#define RPG_CUSTOMRP_DEBUGSERVER__STOP_OFFSET UNITYSDK_OFFSET(0x1C6A2AD0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int DebugServer_TypeDefinitionIndex = 37228;
	...
	public:
		...
		{
			return (::RPG::CustomRP::DebugServer**)Il2CppClass::FromTypeDefinitionIndex(DebugServer_TypeDefinitionIndex)->GetStaticField(0x3A820);
		}
