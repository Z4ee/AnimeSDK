...
#define RPG_CUSTOMRP_SWRTPASS_DISPOSE_OFFSET UNITYSDK_OFFSET(0x185BC580)
#define RPG_CUSTOMRP_SWRTPASS_INNEREXCUTE_OFFSET UNITYSDK_OFFSET(0x185BACD0)
#define RPG_CUSTOMRP_SWRTPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x185BAC90)
...
namespace RPG::CustomRP
{
	...
	public:
		...
		::UnityEngine::ComputeBuffer* _Indices; // 0x18
		::UnityEngine::ComputeBuffer* _BVHNodes8; // 0x20
		::UnityEngine::ComputeBuffer* _BlasOffsets8; // 0x28
		::SWRT::SWRT* _CurSWRT; // 0x30
		::UnityEngine::ComputeBuffer* _TriangleIndex8; // 0x38
		::UnityEngine::ComputeBuffer* _LocalToWorlds; // 0x40
		::UnityEngine::ComputeBuffer* _Tangents; // 0x48
		::UnityEngine::RenderTexture* _AtlasNormal; // 0x50
		::UnityEngine::RenderTexture* _AtlasAlbedo; // 0x58
		::UnityEngine::Material* _BlitMaterial; // 0x60
		::UnityEngine::ComputeBuffer* _WorldToLocals; // 0x68
		::UnityEngine::ComputeBuffer* _BlasIndex; // 0x70
		::UnityEngine::ComputeBuffer* _Triangle8; // 0x78
		::UnityEngine::ComputeBuffer* _UVs; // 0x80
		::UnityEngine::ComputeBuffer* _Positions; // 0x88
		::UnityEngine::ComputeBuffer* _RendererIndex8; // 0x90
