...
#define RPG_CUSTOMRP_LENSFLAREELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x16A9E040)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int LensFlareElement_TypeDefinitionIndex = 29427;
