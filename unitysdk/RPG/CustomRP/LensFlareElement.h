...
#define RPG_CUSTOMRP_LENSFLAREELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x181419A0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int LensFlareElement_TypeDefinitionIndex = 35194;
