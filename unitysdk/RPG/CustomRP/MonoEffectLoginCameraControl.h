...
#define RPG_CUSTOMRP_MONOEFFECTLOGINCAMERACONTROL_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xCC53E10)
#define RPG_CUSTOMRP_MONOEFFECTLOGINCAMERACONTROL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xCC540C0)
#define RPG_CUSTOMRP_MONOEFFECTLOGINCAMERACONTROL_START_OFFSET UNITYSDK_OFFSET(0xCC53A10)
#define RPG_CUSTOMRP_MONOEFFECTLOGINCAMERACONTROL_UPDATE_OFFSET UNITYSDK_OFFSET(0xCC53AF0)
#define RPG_CUSTOMRP_MONOEFFECTLOGINCAMERACONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xCC542B0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int MonoEffectLoginCameraControl_TypeDefinitionIndex = 48459;
