...
#define RPG_CUSTOMRP_REFLECTIONSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x18F1C480)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int ReflectionSetting_TypeDefinitionIndex = 35525;
