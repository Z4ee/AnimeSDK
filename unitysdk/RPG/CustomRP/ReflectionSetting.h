...
#define RPG_CUSTOMRP_REFLECTIONSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x16C25FE0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int ReflectionSetting_TypeDefinitionIndex = 36307;
