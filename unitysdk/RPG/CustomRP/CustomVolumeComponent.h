...
#define RPG_CUSTOMRP_CUSTOMVOLUMECOMPONENT_ISACTIVEIMPL_OFFSET UNITYSDK_OFFSET(0x1A2F6060)
#define RPG_CUSTOMRP_CUSTOMVOLUMECOMPONENT_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1A2F6040)
#define RPG_CUSTOMRP_CUSTOMVOLUMECOMPONENT_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1A2F6050)
#define RPG_CUSTOMRP_CUSTOMVOLUMECOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2F6070)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int CustomVolumeComponent_TypeDefinitionIndex = 33352;
