...
#define RPG_CUSTOMRP_CUSTOMVOLUMECOMPONENT_ISACTIVEIMPL_OFFSET UNITYSDK_OFFSET(0x1EBD3DF0)
#define RPG_CUSTOMRP_CUSTOMVOLUMECOMPONENT_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1EBD3D60)
#define RPG_CUSTOMRP_CUSTOMVOLUMECOMPONENT_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1EBD3DE0)
#define RPG_CUSTOMRP_CUSTOMVOLUMECOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1EBD3E00)
