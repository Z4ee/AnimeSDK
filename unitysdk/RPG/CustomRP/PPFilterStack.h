...
#define RPG_CUSTOMRP_PPFILTERSTACK_METHOD_3_2DC18F1D65E7C4E2_OFFSET UNITYSDK_OFFSET(0x1743F750)
#define RPG_CUSTOMRP_PPFILTERSTACK_METHOD_3_2F2755BC1AD36AC5_OFFSET UNITYSDK_OFFSET(0x1743EDA0)
#define RPG_CUSTOMRP_PPFILTERSTACK_METHOD_3_4EF88D36217F8FBF_OFFSET UNITYSDK_OFFSET(0x1743F440)
#define RPG_CUSTOMRP_PPFILTERSTACK_METHOD_3_5C4BCAC59235143F_OFFSET UNITYSDK_OFFSET(0x1743E400)
#define RPG_CUSTOMRP_PPFILTERSTACK_METHOD_3_697DBF286300F7D4_OFFSET UNITYSDK_OFFSET(0x1743F840)
#define RPG_CUSTOMRP_PPFILTERSTACK_METHOD_3_8FD09F643A0F5CC7_OFFSET UNITYSDK_OFFSET(0x1743EBF0)
#define RPG_CUSTOMRP_PPFILTERSTACK_METHOD_3_AC47A0BD30E4B486_OFFSET UNITYSDK_OFFSET(0x1743E970)
#define RPG_CUSTOMRP_PPFILTERSTACK_METHOD_3_B1300CD9F067AF72_OFFSET UNITYSDK_OFFSET(0x17440350)
#define RPG_CUSTOMRP_PPFILTERSTACK_METHOD_3_BF3C1C4015A2B83C_OFFSET UNITYSDK_OFFSET(0x1743F100)
#define RPG_CUSTOMRP_PPFILTERSTACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1743F970)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int PPFilterStack_TypeDefinitionIndex = 49489;
