...
#define RPG_CUSTOMRP_PPFILTERSTACK_METHOD_3_03AF999E66051930_OFFSET UNITYSDK_OFFSET(0x1682C970)
#define RPG_CUSTOMRP_PPFILTERSTACK_METHOD_3_2DC18F1D65E7C4E2_OFFSET UNITYSDK_OFFSET(0x1682D580)
#define RPG_CUSTOMRP_PPFILTERSTACK_METHOD_3_2F2755BC1AD36AC5_OFFSET UNITYSDK_OFFSET(0x1682CBD0)
#define RPG_CUSTOMRP_PPFILTERSTACK_METHOD_3_4EF88D36217F8FBF_OFFSET UNITYSDK_OFFSET(0x1682D270)
#define RPG_CUSTOMRP_PPFILTERSTACK_METHOD_3_5C4BCAC59235143F_OFFSET UNITYSDK_OFFSET(0x1682C0A0)
#define RPG_CUSTOMRP_PPFILTERSTACK_METHOD_3_70CA36E960F87111_OFFSET UNITYSDK_OFFSET(0x1682DEC0)
#define RPG_CUSTOMRP_PPFILTERSTACK_METHOD_3_AC47A0BD30E4B486_OFFSET UNITYSDK_OFFSET(0x1682C610)
#define RPG_CUSTOMRP_PPFILTERSTACK_METHOD_3_B1300CD9F067AF72_OFFSET UNITYSDK_OFFSET(0x1682EF10)
#define RPG_CUSTOMRP_PPFILTERSTACK_METHOD_3_BF3C1C4015A2B83C_OFFSET UNITYSDK_OFFSET(0x1682CF30)
#define RPG_CUSTOMRP_PPFILTERSTACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1682E0C0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int PPFilterStack_TypeDefinitionIndex = 52147;
