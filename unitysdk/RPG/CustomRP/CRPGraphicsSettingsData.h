...
#define RPG_CUSTOMRP_CRPGRAPHICSSETTINGSDATA_ENABLEVSM_OFFSET UNITYSDK_OFFSET(0x16A701F0)
#define RPG_CUSTOMRP_CRPGRAPHICSSETTINGSDATA_GET_AUDIENCEDENSITYQUALITY_OFFSET UNITYSDK_OFFSET(0x16A70270)
#define RPG_CUSTOMRP_CRPGRAPHICSSETTINGSDATA_GET_CROWDDENSITYQUALITY_OFFSET UNITYSDK_OFFSET(0x16A70210)
#define RPG_CUSTOMRP_CRPGRAPHICSSETTINGSDATA_GET_CURRENTPLATFORMCONFIG_OFFSET UNITYSDK_OFFSET(0x16A702A0)
#define RPG_CUSTOMRP_CRPGRAPHICSSETTINGSDATA_GET_PEDESTRIANDENSITYQUALITY_OFFSET UNITYSDK_OFFSET(0x16A70240)
#define RPG_CUSTOMRP_CRPGRAPHICSSETTINGSDATA_SET_AUDIENCEDENSITYQUALITY_OFFSET UNITYSDK_OFFSET(0x16A70280)
#define RPG_CUSTOMRP_CRPGRAPHICSSETTINGSDATA_SET_CROWDDENSITYQUALITY_OFFSET UNITYSDK_OFFSET(0x16A70220)
#define RPG_CUSTOMRP_CRPGRAPHICSSETTINGSDATA_SET_PEDESTRIANDENSITYQUALITY_OFFSET UNITYSDK_OFFSET(0x16A70250)
#define RPG_CUSTOMRP_CRPGRAPHICSSETTINGSDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x16A70350)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int CRPGraphicsSettingsData_TypeDefinitionIndex = 29279;
