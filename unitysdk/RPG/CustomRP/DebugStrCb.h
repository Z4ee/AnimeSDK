...
#define RPG_CUSTOMRP_DEBUGSTRCB_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x185748D0)
#define RPG_CUSTOMRP_DEBUGSTRCB_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18574900)
#define RPG_CUSTOMRP_DEBUGSTRCB_INVOKE_OFFSET UNITYSDK_OFFSET(0x185748C0)
#define RPG_CUSTOMRP_DEBUGSTRCB__CTOR_OFFSET UNITYSDK_OFFSET(0x18574850)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int DebugStrCb_TypeDefinitionIndex = 37057;
