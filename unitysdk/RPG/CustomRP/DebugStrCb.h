...
#define RPG_CUSTOMRP_DEBUGSTRCB_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C6A5610)
#define RPG_CUSTOMRP_DEBUGSTRCB_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C6A5640)
#define RPG_CUSTOMRP_DEBUGSTRCB_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C6A5600)
#define RPG_CUSTOMRP_DEBUGSTRCB__CTOR_OFFSET UNITYSDK_OFFSET(0x1C6A5590)
