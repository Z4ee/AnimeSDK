...
#define RPG_CUSTOMRP_VOLUMETRICCLOUDSPHERESDFADAPTOR_START_OFFSET UNITYSDK_OFFSET(0x18F28C00)
#define RPG_CUSTOMRP_VOLUMETRICCLOUDSPHERESDFADAPTOR_SYNCCLOUDTRANSITIONPARAMS_OFFSET UNITYSDK_OFFSET(0x18F294D0)
#define RPG_CUSTOMRP_VOLUMETRICCLOUDSPHERESDFADAPTOR_UPDATESHADERPARAMS_OFFSET UNITYSDK_OFFSET(0x18F28D60)
#define RPG_CUSTOMRP_VOLUMETRICCLOUDSPHERESDFADAPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x18F29520)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int VolumetricCloudSphereSDFAdaptor_TypeDefinitionIndex = 35411;
