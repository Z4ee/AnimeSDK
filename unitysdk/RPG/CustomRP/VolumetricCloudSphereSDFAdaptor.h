...
#define RPG_CUSTOMRP_VOLUMETRICCLOUDSPHERESDFADAPTOR_START_OFFSET UNITYSDK_OFFSET(0x1D137EF0)
#define RPG_CUSTOMRP_VOLUMETRICCLOUDSPHERESDFADAPTOR_SYNCCLOUDTRANSITIONPARAMS_OFFSET UNITYSDK_OFFSET(0x1D1387C0)
#define RPG_CUSTOMRP_VOLUMETRICCLOUDSPHERESDFADAPTOR_UPDATESHADERPARAMS_OFFSET UNITYSDK_OFFSET(0x1D138050)
#define RPG_CUSTOMRP_VOLUMETRICCLOUDSPHERESDFADAPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D138810)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int VolumetricCloudSphereSDFAdaptor_TypeDefinitionIndex = 36193;
