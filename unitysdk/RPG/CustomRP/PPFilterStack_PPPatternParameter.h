...
#define RPG_CUSTOMRP_PPFILTERSTACK_PPPATTERNPARAMETER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x87890)
#define RPG_CUSTOMRP_PPFILTERSTACK_PPPATTERNPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x87880)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int PPFilterStack_PPPatternParameter_TypeDefinitionIndex = 41893;
