...
#define RPG_CUSTOMRP_RPGLENSDISTORTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18F084F0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int RPGLensDistortion_TypeDefinitionIndex = 35492;
