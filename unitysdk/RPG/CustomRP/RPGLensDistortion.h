...
#define RPG_CUSTOMRP_RPGLENSDISTORTION__CTOR_OFFSET UNITYSDK_OFFSET(0x16C10EB0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int RPGLensDistortion_TypeDefinitionIndex = 36274;
