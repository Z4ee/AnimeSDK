...
#define RPG_CUSTOMRP_PATHTRACINGDEBUG_DUMPPATH__CTOR_OFFSET UNITYSDK_OFFSET(0xA7AE900)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int PathTracingDebug_DumpPath_TypeDefinitionIndex = 41876;
