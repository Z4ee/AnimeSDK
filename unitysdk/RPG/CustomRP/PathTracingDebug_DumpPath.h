...
#define RPG_CUSTOMRP_PATHTRACINGDEBUG_DUMPPATH__CTOR_OFFSET UNITYSDK_OFFSET(0xB4F18A0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int PathTracingDebug_DumpPath_TypeDefinitionIndex = 47851;
