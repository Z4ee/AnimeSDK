...
#define RPG_CUSTOMRP_RPGSKILLRADIALBLUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1816B230)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int RPGSkillRadialBlur_TypeDefinitionIndex = 35214;
