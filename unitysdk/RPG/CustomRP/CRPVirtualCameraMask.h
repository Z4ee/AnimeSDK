...
#define RPG_CUSTOMRP_CRPVIRTUALCAMERAMASK_APPLYMASK_1_OFFSET UNITYSDK_OFFSET(0x1C6865E0)
#define RPG_CUSTOMRP_CRPVIRTUALCAMERAMASK_APPLYMASK_OFFSET UNITYSDK_OFFSET(0x1C685CF0)
#define RPG_CUSTOMRP_CRPVIRTUALCAMERAMASK_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1C686600)
#define RPG_CUSTOMRP_CRPVIRTUALCAMERAMASK_RESETMASK_OFFSET UNITYSDK_OFFSET(0x1C6865F0)
#define RPG_CUSTOMRP_CRPVIRTUALCAMERAMASK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C686610)
