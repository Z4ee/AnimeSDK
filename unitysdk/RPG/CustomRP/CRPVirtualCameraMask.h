...
#define RPG_CUSTOMRP_CRPVIRTUALCAMERAMASK_APPLYMASK_1_OFFSET UNITYSDK_OFFSET(0x17818AA0)
#define RPG_CUSTOMRP_CRPVIRTUALCAMERAMASK_APPLYMASK_OFFSET UNITYSDK_OFFSET(0x178181B0)
#define RPG_CUSTOMRP_CRPVIRTUALCAMERAMASK_ONENABLE_OFFSET UNITYSDK_OFFSET(0x17818AC0)
#define RPG_CUSTOMRP_CRPVIRTUALCAMERAMASK_RESETMASK_OFFSET UNITYSDK_OFFSET(0x17818AB0)
#define RPG_CUSTOMRP_CRPVIRTUALCAMERAMASK__CTOR_OFFSET UNITYSDK_OFFSET(0x17818AD0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int CRPVirtualCameraMask_TypeDefinitionIndex = 36145;
