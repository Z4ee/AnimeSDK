...
#define RPG_CUSTOMRP_BATHROWEVENT_ATTACHTRANS_OFFSET UNITYSDK_OFFSET(0x1C66BD00)
#define RPG_CUSTOMRP_BATHROWEVENT_BEGIN_OFFSET UNITYSDK_OFFSET(0x1C66BFC0)
#define RPG_CUSTOMRP_BATHROWEVENT_END_OFFSET UNITYSDK_OFFSET(0x1C66BFD0)
#define RPG_CUSTOMRP_BATHROWEVENT_EVENT_THROW_OFFSET UNITYSDK_OFFSET(0x1C66BAA0)
#define RPG_CUSTOMRP_BATHROWEVENT_GETEVENTEXECUTORFUN_OFFSET UNITYSDK_OFFSET(0x1C66B9E0)
#define RPG_CUSTOMRP_BATHROWEVENT_UPDATE_OFFSET UNITYSDK_OFFSET(0x1C66BD60)
#define RPG_CUSTOMRP_BATHROWEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C66C020)
