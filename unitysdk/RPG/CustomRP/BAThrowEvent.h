...
#define RPG_CUSTOMRP_BATHROWEVENT_ATTACHTRANS_OFFSET UNITYSDK_OFFSET(0x177FE1E0)
#define RPG_CUSTOMRP_BATHROWEVENT_BEGIN_OFFSET UNITYSDK_OFFSET(0x177FE4A0)
#define RPG_CUSTOMRP_BATHROWEVENT_END_OFFSET UNITYSDK_OFFSET(0x177FE4B0)
#define RPG_CUSTOMRP_BATHROWEVENT_EVENT_THROW_OFFSET UNITYSDK_OFFSET(0x177FDF80)
#define RPG_CUSTOMRP_BATHROWEVENT_GETEVENTEXECUTORFUN_OFFSET UNITYSDK_OFFSET(0x177FDEC0)
#define RPG_CUSTOMRP_BATHROWEVENT_UPDATE_OFFSET UNITYSDK_OFFSET(0x177FE240)
#define RPG_CUSTOMRP_BATHROWEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x177FE500)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int BAThrowEvent_TypeDefinitionIndex = 36325;
