...
#define RPG_CUSTOMRP_RPGLENSGLITCH2__CTOR_OFFSET UNITYSDK_OFFSET(0x18F0B0A0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int RPGLensGlitch2_TypeDefinitionIndex = 35499;
