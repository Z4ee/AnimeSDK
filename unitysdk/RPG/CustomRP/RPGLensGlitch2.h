...
#define RPG_CUSTOMRP_RPGLENSGLITCH2__CTOR_OFFSET UNITYSDK_OFFSET(0x16AC1B30)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int RPGLensGlitch2_TypeDefinitionIndex = 29432;
