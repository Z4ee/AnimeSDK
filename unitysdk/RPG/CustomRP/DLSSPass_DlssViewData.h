...
#define RPG_CUSTOMRP_DLSSPASS_DLSSVIEWDATA_CANFITINPUT_OFFSET UNITYSDK_OFFSET(0x20E7240)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int DLSSPass_DlssViewData_TypeDefinitionIndex = 29180;
