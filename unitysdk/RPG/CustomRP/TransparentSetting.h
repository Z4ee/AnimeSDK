...
#define RPG_CUSTOMRP_TRANSPARENTSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1353F0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int TransparentSetting_TypeDefinitionIndex = 36313;
