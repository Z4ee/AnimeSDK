...
#define RPG_CUSTOMRP_RPGBLOOMRENDERER_PYRAMID__CTOR_OFFSET UNITYSDK_OFFSET(0x16AA7D40)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int RPGBloomRenderer_Pyramid_TypeDefinitionIndex = 29399;
