...
#define RPG_CUSTOMRP_RTIDHANDLE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x3AE1C60)
#define RPG_CUSTOMRP_RTIDHANDLE_EQUALS_OFFSET UNITYSDK_OFFSET(0x3AE1C20)
#define RPG_CUSTOMRP_RTIDHANDLE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19050)
#define RPG_CUSTOMRP_RTIDHANDLE_INIT_OFFSET UNITYSDK_OFFSET(0x3AE1B80)
#define RPG_CUSTOMRP_RTIDHANDLE__CCTOR_OFFSET UNITYSDK_OFFSET(0x185B4780)
#define RPG_CUSTOMRP_RTIDHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x3AE1B80)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int RTIDHandle_TypeDefinitionIndex = 36892;

	struct alignas(8) RTIDHandle
	{
		static ::RPG::CustomRP::RTIDHandle* StaticGet_CameraTarget()
		{
			return (::RPG::CustomRP::RTIDHandle*)Il2CppClass::FromTypeDefinitionIndex(RTIDHandle_TypeDefinitionIndex)->GetStaticField(0xEDD0);
		}
