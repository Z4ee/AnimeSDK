...
#define RPG_CUSTOMRP_MATERIALPARAMS_CLEAR_OFFSET UNITYSDK_OFFSET(0x20E7890)
#define RPG_CUSTOMRP_MATERIALPARAMS_DIFF_OFFSET UNITYSDK_OFFSET(0x20E79A0)
#define RPG_CUSTOMRP_MATERIALPARAMS_GET_EMPTY_OFFSET UNITYSDK_OFFSET(0x20E7960)
#define RPG_CUSTOMRP_MATERIALPARAMS_NEW_OFFSET UNITYSDK_OFFSET(0x16AA1770)
#define RPG_CUSTOMRP_MATERIALPARAMS_OUTPUTASDIFF_OFFSET UNITYSDK_OFFSET(0x20E79F0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int MaterialParams_TypeDefinitionIndex = 29530;
