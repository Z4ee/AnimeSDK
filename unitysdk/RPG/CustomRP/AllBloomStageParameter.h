...
#define RPG_CUSTOMRP_ALLBLOOMSTAGEPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x18EA1F80)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int AllBloomStageParameter_TypeDefinitionIndex = 35463;
