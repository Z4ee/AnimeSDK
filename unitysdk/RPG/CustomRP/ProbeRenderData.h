...
#define RPG_CUSTOMRP_PROBERENDERDATA_RESET_OFFSET UNITYSDK_OFFSET(0x20E7CA0)
#define RPG_CUSTOMRP_PROBERENDERDATA_SETBASEDATA_OFFSET UNITYSDK_OFFSET(0x20E7CE0)
#define RPG_CUSTOMRP_PROBERENDERDATA_SET_OFFSET UNITYSDK_OFFSET(0x20E7CD0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int ProbeRenderData_TypeDefinitionIndex = 29301;
