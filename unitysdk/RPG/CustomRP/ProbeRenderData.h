...
#define RPG_CUSTOMRP_PROBERENDERDATA_RESET_OFFSET UNITYSDK_OFFSET(0x3B806F0)
#define RPG_CUSTOMRP_PROBERENDERDATA_SETBASEDATA_OFFSET UNITYSDK_OFFSET(0x3B80730)
#define RPG_CUSTOMRP_PROBERENDERDATA_SET_OFFSET UNITYSDK_OFFSET(0x3B80720)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int ProbeRenderData_TypeDefinitionIndex = 36994;
