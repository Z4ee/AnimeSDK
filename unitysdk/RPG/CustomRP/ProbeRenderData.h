...
#define RPG_CUSTOMRP_PROBERENDERDATA_RESET_OFFSET UNITYSDK_OFFSET(0x3946EC0)
#define RPG_CUSTOMRP_PROBERENDERDATA_SETBASEDATA_OFFSET UNITYSDK_OFFSET(0x3946F00)
#define RPG_CUSTOMRP_PROBERENDERDATA_SET_OFFSET UNITYSDK_OFFSET(0x3946EF0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int ProbeRenderData_TypeDefinitionIndex = 36135;
