...
#define RPG_CUSTOMRP_MATHEXT_DIV_OFFSET UNITYSDK_OFFSET(0x16BF14A0)
#define RPG_CUSTOMRP_MATHEXT_MAX_OFFSET UNITYSDK_OFFSET(0x16BF1460)
#define RPG_CUSTOMRP_MATHEXT_SQRT_OFFSET UNITYSDK_OFFSET(0x16BF1370)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int MathExt_TypeDefinitionIndex = 36087;
