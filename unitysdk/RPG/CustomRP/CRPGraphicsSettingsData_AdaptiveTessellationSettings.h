...
#define RPG_CUSTOMRP_CRPGRAPHICSSETTINGSDATA_ADAPTIVETESSELLATIONSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x18EB6D20)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int CRPGraphicsSettingsData_AdaptiveTessellationSettings_TypeDefinitionIndex = 35344;
