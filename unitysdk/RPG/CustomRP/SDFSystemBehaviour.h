...
#define RPG_CUSTOMRP_SDFSYSTEMBEHAVIOUR_GETSECTORDATASUBPATH_OFFSET UNITYSDK_OFFSET(0xB4F2360)
#define RPG_CUSTOMRP_SDFSYSTEMBEHAVIOUR_GET_SECTORCOORDS_OFFSET UNITYSDK_OFFSET(0xB4F2680)
#define RPG_CUSTOMRP_SDFSYSTEMBEHAVIOUR_METHOD_5_2A29C6B6D06A660C_OFFSET UNITYSDK_OFFSET(0xB4F1E30)
#define RPG_CUSTOMRP_SDFSYSTEMBEHAVIOUR_METHOD_5_F5447CD65612575D_OFFSET UNITYSDK_OFFSET(0xB4F1CB0)
#define RPG_CUSTOMRP_SDFSYSTEMBEHAVIOUR_START_OFFSET UNITYSDK_OFFSET(0xB4F1C60)
#define RPG_CUSTOMRP_SDFSYSTEMBEHAVIOUR_UNLOADSECTORDATA_OFFSET UNITYSDK_OFFSET(0xB4F22B0)
#define RPG_CUSTOMRP_SDFSYSTEMBEHAVIOUR__CCTOR_OFFSET UNITYSDK_OFFSET(0xB4F28E0)
#define RPG_CUSTOMRP_SDFSYSTEMBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xB4F2700)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int SDFSystemBehaviour_TypeDefinitionIndex = 47876;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(SDFSystemBehaviour_TypeDefinitionIndex)->GetStaticField(0x3D300);
		}
