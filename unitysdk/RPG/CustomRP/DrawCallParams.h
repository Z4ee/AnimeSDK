...
#define RPG_CUSTOMRP_DRAWCALLPARAMS_DIFFKEYWORDS_OFFSET UNITYSDK_OFFSET(0x18577740)
#define RPG_CUSTOMRP_DRAWCALLPARAMS_DIFF_OFFSET UNITYSDK_OFFSET(0x3AE0C40)
#define RPG_CUSTOMRP_DRAWCALLPARAMS_GET_EMPTY_OFFSET UNITYSDK_OFFSET(0x3AE0C00)
#define RPG_CUSTOMRP_DRAWCALLPARAMS_OUTPUTASDIFF_OFFSET UNITYSDK_OFFSET(0x3AE0CA0)
