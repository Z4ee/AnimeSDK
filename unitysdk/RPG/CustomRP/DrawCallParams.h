...
#define RPG_CUSTOMRP_DRAWCALLPARAMS_DIFFKEYWORDS_OFFSET UNITYSDK_OFFSET(0x16A984C0)
#define RPG_CUSTOMRP_DRAWCALLPARAMS_DIFF_OFFSET UNITYSDK_OFFSET(0x20E7390)
#define RPG_CUSTOMRP_DRAWCALLPARAMS_GET_EMPTY_OFFSET UNITYSDK_OFFSET(0x20E7350)
#define RPG_CUSTOMRP_DRAWCALLPARAMS_OUTPUTASDIFF_OFFSET UNITYSDK_OFFSET(0x20E73F0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int DrawCallParams_TypeDefinitionIndex = 29529;
