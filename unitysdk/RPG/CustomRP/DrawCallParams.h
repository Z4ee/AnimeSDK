...
#define RPG_CUSTOMRP_DRAWCALLPARAMS_DIFFKEYWORDS_OFFSET UNITYSDK_OFFSET(0x16BE7E90)
#define RPG_CUSTOMRP_DRAWCALLPARAMS_DIFF_OFFSET UNITYSDK_OFFSET(0x39461B0)
#define RPG_CUSTOMRP_DRAWCALLPARAMS_GET_EMPTY_OFFSET UNITYSDK_OFFSET(0x3946170)
#define RPG_CUSTOMRP_DRAWCALLPARAMS_OUTPUTASDIFF_OFFSET UNITYSDK_OFFSET(0x3946210)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int DrawCallParams_TypeDefinitionIndex = 36378;
