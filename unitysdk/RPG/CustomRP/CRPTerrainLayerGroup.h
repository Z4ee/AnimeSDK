...
#define RPG_CUSTOMRP_CRPTERRAINLAYERGROUP_GET_LAYERS_OFFSET UNITYSDK_OFFSET(0x395CA30)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int CRPTerrainLayerGroup_TypeDefinitionIndex = 36179;
