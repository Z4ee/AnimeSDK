...
#define RPG_CUSTOMRP_UIPOSTPROCESSCMD_EXECUTE_OFFSET UNITYSDK_OFFSET(0xB4F4C10)
#define RPG_CUSTOMRP_UIPOSTPROCESSCMD_GET_KEY_OFFSET UNITYSDK_OFFSET(0xB4F4C00)
#define RPG_CUSTOMRP_UIPOSTPROCESSCMD_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xB4F49C0)
#define RPG_CUSTOMRP_UIPOSTPROCESSCMD_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xB4F4B40)
#define RPG_CUSTOMRP_UIPOSTPROCESSCMD_ONENABLE_OFFSET UNITYSDK_OFFSET(0xB4F4870)
#define RPG_CUSTOMRP_UIPOSTPROCESSCMD__CTOR_OFFSET UNITYSDK_OFFSET(0xB4F52F0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int UIPostProcessCmd_TypeDefinitionIndex = 47874;
