...
#define RPG_CUSTOMRP_PPFILTERSTACK_VIGNETTEPARAMETER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x15B8D0)
#define RPG_CUSTOMRP_PPFILTERSTACK_VIGNETTEPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x15B890)
