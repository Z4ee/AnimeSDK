...
#define RPG_CUSTOMRP_TONEMAPPINGMETHODPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x16ACA360)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int ToneMappingMethodParameter_TypeDefinitionIndex = 29454;
