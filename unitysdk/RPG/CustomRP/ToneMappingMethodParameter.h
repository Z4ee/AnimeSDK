...
#define RPG_CUSTOMRP_TONEMAPPINGMETHODPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C6F14E0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int ToneMappingMethodParameter_TypeDefinitionIndex = 37162;
