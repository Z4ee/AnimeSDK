...
#define RPG_CUSTOMRP_CLOUDTRANSITION_KEYFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x16A8AA00)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int CloudTransition_KeyFrame_TypeDefinitionIndex = 29351;
