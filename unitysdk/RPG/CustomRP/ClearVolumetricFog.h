...
#define RPG_CUSTOMRP_CLEARVOLUMETRICFOG_START_OFFSET UNITYSDK_OFFSET(0x16A8A380)
#define RPG_CUSTOMRP_CLEARVOLUMETRICFOG_UPDATE_OFFSET UNITYSDK_OFFSET(0x16A8A430)
#define RPG_CUSTOMRP_CLEARVOLUMETRICFOG__CTOR_OFFSET UNITYSDK_OFFSET(0x16A8A6E0)
#define RPG_CUSTOMRP_CLEARVOLUMETRICFOG__DOCLEAR_OFFSET UNITYSDK_OFFSET(0x16A8A660)
#define RPG_CUSTOMRP_CLEARVOLUMETRICFOG__RECOVER_OFFSET UNITYSDK_OFFSET(0x16A8A5F0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int ClearVolumetricFog_TypeDefinitionIndex = 29349;
