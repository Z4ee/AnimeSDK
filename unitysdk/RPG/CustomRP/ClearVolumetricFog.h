...
#define RPG_CUSTOMRP_CLEARVOLUMETRICFOG_START_OFFSET UNITYSDK_OFFSET(0x1812D390)
#define RPG_CUSTOMRP_CLEARVOLUMETRICFOG_UPDATE_OFFSET UNITYSDK_OFFSET(0x1812D440)
#define RPG_CUSTOMRP_CLEARVOLUMETRICFOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1812D6F0)
#define RPG_CUSTOMRP_CLEARVOLUMETRICFOG__DOCLEAR_OFFSET UNITYSDK_OFFSET(0x1812D670)
#define RPG_CUSTOMRP_CLEARVOLUMETRICFOG__RECOVER_OFFSET UNITYSDK_OFFSET(0x1812D600)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int ClearVolumetricFog_TypeDefinitionIndex = 35116;
