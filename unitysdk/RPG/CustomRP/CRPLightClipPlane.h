...
#define RPG_CUSTOMRP_CRPLIGHTCLIPPLANE_GET_LIGHT_OFFSET UNITYSDK_OFFSET(0x16A70F80)
#define RPG_CUSTOMRP_CRPLIGHTCLIPPLANE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x16A70820)
#define RPG_CUSTOMRP_CRPLIGHTCLIPPLANE_SET_LIGHT_OFFSET UNITYSDK_OFFSET(0x16A70F90)
#define RPG_CUSTOMRP_CRPLIGHTCLIPPLANE_UPDATELIGHTCLIPPLANES_OFFSET UNITYSDK_OFFSET(0x16A70830)
#define RPG_CUSTOMRP_CRPLIGHTCLIPPLANE__CTOR_OFFSET UNITYSDK_OFFSET(0x16A70FA0)
#define RPG_CUSTOMRP_CRPLIGHTCLIPPLANE__SETCLIPPLANELOCALDATA_OFFSET UNITYSDK_OFFSET(0x16A70AF0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int CRPLightClipPlane_TypeDefinitionIndex = 29297;
