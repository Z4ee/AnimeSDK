...
#define RPG_CUSTOMRP_BATCHANIMATIONEVENT_BUILDEVENTMAP_OFFSET UNITYSDK_OFFSET(0x16A60880)
#define RPG_CUSTOMRP_BATCHANIMATIONEVENT_EXECUTEEVENT_OFFSET UNITYSDK_OFFSET(0x16A60650)
#define RPG_CUSTOMRP_BATCHANIMATIONEVENT_GETEVENTEXECUTORFUN_OFFSET UNITYSDK_OFFSET(0x16A607E0)
#define RPG_CUSTOMRP_BATCHANIMATIONEVENT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x16A60B60)
#define RPG_CUSTOMRP_BATCHANIMATIONEVENT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x16A607F0)
#define RPG_CUSTOMRP_BATCHANIMATIONEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x16A602A0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int BatchAnimationEvent_TypeDefinitionIndex = 29214;
