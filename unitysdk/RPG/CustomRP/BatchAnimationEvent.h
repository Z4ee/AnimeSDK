...
#define RPG_CUSTOMRP_BATCHANIMATIONEVENT_BUILDEVENTMAP_OFFSET UNITYSDK_OFFSET(0x1C66C580)
#define RPG_CUSTOMRP_BATCHANIMATIONEVENT_EXECUTEEVENT_OFFSET UNITYSDK_OFFSET(0x1C66C380)
#define RPG_CUSTOMRP_BATCHANIMATIONEVENT_GETEVENTEXECUTORFUN_OFFSET UNITYSDK_OFFSET(0x1C66C4E0)
#define RPG_CUSTOMRP_BATCHANIMATIONEVENT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1C66C890)
#define RPG_CUSTOMRP_BATCHANIMATIONEVENT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1C66C4F0)
#define RPG_CUSTOMRP_BATCHANIMATIONEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C66C030)
