...
#define RPG_CUSTOMRP_MOTIONBLURQUALITYPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C6B2090)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int MotionBlurQualityParameter_TypeDefinitionIndex = 37145;
