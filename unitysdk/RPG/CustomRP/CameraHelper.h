...
#define RPG_CUSTOMRP_CAMERAHELPER_HASDEBUGFLAG_1_OFFSET UNITYSDK_OFFSET(0x17819270)
#define RPG_CUSTOMRP_CAMERAHELPER_HASDEBUGFLAG_OFFSET UNITYSDK_OFFSET(0x17819250)
#define RPG_CUSTOMRP_CAMERAHELPER_HASFLAG_OFFSET UNITYSDK_OFFSET(0x178191E0)
#define RPG_CUSTOMRP_CAMERAHELPER_SETDEBUGFLAG_1_OFFSET UNITYSDK_OFFSET(0x17819230)
#define RPG_CUSTOMRP_CAMERAHELPER_SETDEBUGFLAG_OFFSET UNITYSDK_OFFSET(0x17819200)
#define RPG_CUSTOMRP_CAMERAHELPER_SETFLAG_1_OFFSET UNITYSDK_OFFSET(0x178191C0)
#define RPG_CUSTOMRP_CAMERAHELPER_SETFLAG_OFFSET UNITYSDK_OFFSET(0x17819190)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int CameraHelper_TypeDefinitionIndex = 36155;
