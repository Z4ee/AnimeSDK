...
#define RPG_CUSTOMRP_CAPTURESETUPCB_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x181241D0)
#define RPG_CUSTOMRP_CAPTURESETUPCB_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18124200)
#define RPG_CUSTOMRP_CAPTURESETUPCB_INVOKE_OFFSET UNITYSDK_OFFSET(0x18123F30)
#define RPG_CUSTOMRP_CAPTURESETUPCB__CTOR_OFFSET UNITYSDK_OFFSET(0x1811E3A0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int CaptureSetupCb_TypeDefinitionIndex = 34997;
