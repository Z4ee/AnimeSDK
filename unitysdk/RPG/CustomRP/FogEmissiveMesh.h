...
#define RPG_CUSTOMRP_FOGEMISSIVEMESH_START_OFFSET UNITYSDK_OFFSET(0x1813D240)
#define RPG_CUSTOMRP_FOGEMISSIVEMESH_UPDATEPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1813D030)
#define RPG_CUSTOMRP_FOGEMISSIVEMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x1813D280)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int FogEmissiveMesh_TypeDefinitionIndex = 35119;
