...
#define RPG_CUSTOMRP_FOGEMISSIVEMESH_START_OFFSET UNITYSDK_OFFSET(0x18EE3790)
#define RPG_CUSTOMRP_FOGEMISSIVEMESH_UPDATEPARAMETERS_OFFSET UNITYSDK_OFFSET(0x18EE3580)
#define RPG_CUSTOMRP_FOGEMISSIVEMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x18EE37D0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int FogEmissiveMesh_TypeDefinitionIndex = 35405;
