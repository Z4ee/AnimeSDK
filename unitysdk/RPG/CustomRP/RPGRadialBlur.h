...
#define RPG_CUSTOMRP_RPGRADIALBLUR_ISACTIVEIMPL_OFFSET UNITYSDK_OFFSET(0x16AC5E70)
#define RPG_CUSTOMRP_RPGRADIALBLUR__CTOR_OFFSET UNITYSDK_OFFSET(0x16AC5FA0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int RPGRadialBlur_TypeDefinitionIndex = 29445;
