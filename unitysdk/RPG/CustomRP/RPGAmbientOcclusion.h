...
#define RPG_CUSTOMRP_RPGAMBIENTOCCLUSION__CTOR_OFFSET UNITYSDK_OFFSET(0x16AA67F0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int RPGAmbientOcclusion_TypeDefinitionIndex = 29392;
