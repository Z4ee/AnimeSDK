...
#define RPG_CUSTOMRP_RPGAMBIENTOCCLUSION__CTOR_OFFSET UNITYSDK_OFFSET(0x18149C90)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int RPGAmbientOcclusion_TypeDefinitionIndex = 35159;
