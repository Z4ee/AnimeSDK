...
#define RPG_CUSTOMRP_RESOLVEDUMP_TEX__CTOR_OFFSET UNITYSDK_OFFSET(0x6E7600)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int ResolveDump_Tex_TypeDefinitionIndex = 36201;
