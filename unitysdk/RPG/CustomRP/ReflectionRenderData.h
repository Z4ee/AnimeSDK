...
#define RPG_CUSTOMRP_REFLECTIONRENDERDATA_RESET_OFFSET UNITYSDK_OFFSET(0x20E8010)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int ReflectionRenderData_TypeDefinitionIndex = 29187;
