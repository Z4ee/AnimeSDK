...
#define RPG_CUSTOMRP_REFLECTIONRENDERDATA_RESET_OFFSET UNITYSDK_OFFSET(0x384AB70)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int ReflectionRenderData_TypeDefinitionIndex = 35239;
