...
#define RPG_CUSTOMRP_FRAMEPASSCAPTURER__QACAPTUREALL_D__13_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x18140050)
#define RPG_CUSTOMRP_FRAMEPASSCAPTURER__QACAPTUREALL_D__13_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x181401F0)
#define RPG_CUSTOMRP_FRAMEPASSCAPTURER__QACAPTUREALL_D__13_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x18140250)
#define RPG_CUSTOMRP_FRAMEPASSCAPTURER__QACAPTUREALL_D__13_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x18140200)
#define RPG_CUSTOMRP_FRAMEPASSCAPTURER__QACAPTUREALL_D__13_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18140040)
#define RPG_CUSTOMRP_FRAMEPASSCAPTURER__QACAPTUREALL_D__13__CTOR_OFFSET UNITYSDK_OFFSET(0x1813F910)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int FramePassCapturer__QACaptureAll_d__13_TypeDefinitionIndex = 35016;
