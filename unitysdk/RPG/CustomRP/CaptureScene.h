...
#define RPG_CUSTOMRP_CAPTURESCENE_CAPTUREAMBIENTTEX_OFFSET UNITYSDK_OFFSET(0x16A7E300)
#define RPG_CUSTOMRP_CAPTURESCENE_CAPTUREPROBEOUTPUT_OFFSET UNITYSDK_OFFSET(0x16A7E250)
#define RPG_CUSTOMRP_CAPTURESCENE_CAPTURESCENEOUTPUT_OFFSET UNITYSDK_OFFSET(0x16A7E200)
#define RPG_CUSTOMRP_CAPTURESCENE_CAPTURE_OFFSET UNITYSDK_OFFSET(0x16A7D720)
#define RPG_CUSTOMRP_CAPTURESCENE_QACAPTUREALL_OFFSET UNITYSDK_OFFSET(0x16A7E360)
#define RPG_CUSTOMRP_CAPTURESCENE__CAPTURECOROUTINE_OFFSET UNITYSDK_OFFSET(0x16A7E2B0)
#define RPG_CUSTOMRP_CAPTURESCENE__CAPTURESCENEOUTPUTCOROUTINE_OFFSET UNITYSDK_OFFSET(0x16A7E1A0)
#define RPG_CUSTOMRP_CAPTURESCENE__CBSCENE_OFFSET UNITYSDK_OFFSET(0x16A7DA40)
#define RPG_CUSTOMRP_CAPTURESCENE__CTOR_OFFSET UNITYSDK_OFFSET(0x16A7E420)
#define RPG_CUSTOMRP_CAPTURESCENE__DUMPPARAMS_OFFSET UNITYSDK_OFFSET(0x16A7D8D0)
#define RPG_CUSTOMRP_CAPTURESCENE__QACAPTUREALL_OFFSET UNITYSDK_OFFSET(0x16A7E3B0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int CaptureScene_TypeDefinitionIndex = 29219;
