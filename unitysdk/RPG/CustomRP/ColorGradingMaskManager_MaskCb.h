...
#define RPG_CUSTOMRP_COLORGRADINGMASKMANAGER_MASKCB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1782B690)
#define RPG_CUSTOMRP_COLORGRADINGMASKMANAGER_MASKCB_GET_KEY_OFFSET UNITYSDK_OFFSET(0x1782B680)
#define RPG_CUSTOMRP_COLORGRADINGMASKMANAGER_MASKCB_RELEASEMASKRT_OFFSET UNITYSDK_OFFSET(0x1782B5B0)
#define RPG_CUSTOMRP_COLORGRADINGMASKMANAGER_MASKCB__CCTOR_OFFSET UNITYSDK_OFFSET(0x1782C1F0)
#define RPG_CUSTOMRP_COLORGRADINGMASKMANAGER_MASKCB__CTOR_OFFSET UNITYSDK_OFFSET(0x1782B670)
#define RPG_CUSTOMRP_COLORGRADINGMASKMANAGER_MASKCB__ENSUREMASKRT_OFFSET UNITYSDK_OFFSET(0x1782C010)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int ColorGradingMaskManager_MaskCb_TypeDefinitionIndex = 36224;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ColorGradingMaskManager_MaskCb_TypeDefinitionIndex)->GetStaticField(0x10270);
		}
