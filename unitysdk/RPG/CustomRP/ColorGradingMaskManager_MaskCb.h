...
#define RPG_CUSTOMRP_COLORGRADINGMASKMANAGER_MASKCB_EXECUTE_OFFSET UNITYSDK_OFFSET(0x192CAA70)
#define RPG_CUSTOMRP_COLORGRADINGMASKMANAGER_MASKCB_GET_KEY_OFFSET UNITYSDK_OFFSET(0x192CAA60)
#define RPG_CUSTOMRP_COLORGRADINGMASKMANAGER_MASKCB_RELEASEMASKRT_OFFSET UNITYSDK_OFFSET(0x192CA990)
#define RPG_CUSTOMRP_COLORGRADINGMASKMANAGER_MASKCB__CCTOR_OFFSET UNITYSDK_OFFSET(0x192CB5D0)
#define RPG_CUSTOMRP_COLORGRADINGMASKMANAGER_MASKCB__CTOR_OFFSET UNITYSDK_OFFSET(0x192CAA50)
#define RPG_CUSTOMRP_COLORGRADINGMASKMANAGER_MASKCB__ENSUREMASKRT_OFFSET UNITYSDK_OFFSET(0x192CB3F0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int ColorGradingMaskManager_MaskCb_TypeDefinitionIndex = 37083;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ColorGradingMaskManager_MaskCb_TypeDefinitionIndex)->GetStaticField(0xE1F0);
		}
