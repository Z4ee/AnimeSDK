...
#define RPG_CUSTOMRP_CRPTERRAIN__GETGROUPSELECTIONDROPDOWNITEMS_D__20_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x17815CA0)
#define RPG_CUSTOMRP_CRPTERRAIN__GETGROUPSELECTIONDROPDOWNITEMS_D__20_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_OBJECT__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x17815EA0)
#define RPG_CUSTOMRP_CRPTERRAIN__GETGROUPSELECTIONDROPDOWNITEMS_D__20_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x17815E30)
#define RPG_CUSTOMRP_CRPTERRAIN__GETGROUPSELECTIONDROPDOWNITEMS_D__20_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x17815F20)
#define RPG_CUSTOMRP_CRPTERRAIN__GETGROUPSELECTIONDROPDOWNITEMS_D__20_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x17815E90)
#define RPG_CUSTOMRP_CRPTERRAIN__GETGROUPSELECTIONDROPDOWNITEMS_D__20_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x17815E40)
#define RPG_CUSTOMRP_CRPTERRAIN__GETGROUPSELECTIONDROPDOWNITEMS_D__20_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17815C90)
#define RPG_CUSTOMRP_CRPTERRAIN__GETGROUPSELECTIONDROPDOWNITEMS_D__20__CTOR_OFFSET UNITYSDK_OFFSET(0x178147D0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int CRPTerrain__GetGroupSelectionDropdownItems_d__20_TypeDefinitionIndex = 36177;
