...
#define RPG_CUSTOMRP_CAPTURESCENE___CAPTURECOROUTINE_D__18_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x181228C0)
#define RPG_CUSTOMRP_CAPTURESCENE___CAPTURECOROUTINE_D__18_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x18123230)
#define RPG_CUSTOMRP_CAPTURESCENE___CAPTURECOROUTINE_D__18_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x18123290)
#define RPG_CUSTOMRP_CAPTURESCENE___CAPTURECOROUTINE_D__18_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x18123240)
#define RPG_CUSTOMRP_CAPTURESCENE___CAPTURECOROUTINE_D__18_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x181228A0)
#define RPG_CUSTOMRP_CAPTURESCENE___CAPTURECOROUTINE_D__18__CTOR_OFFSET UNITYSDK_OFFSET(0x181214F0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int CaptureScene___CaptureCoroutine_d__18_TypeDefinitionIndex = 34989;

	class CaptureScene___CaptureCoroutine_d__18 : public ::System::Object
	{
	public:
		::System::String* _folder_5__2; // 0x10
		::System::String* _txt_path_5__4; // 0x18
		::System::String* _png_path_5__3; // 0x20
		::System::String* _param_str_5__5; // 0x28
