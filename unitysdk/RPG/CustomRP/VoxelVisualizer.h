...
#define RPG_CUSTOMRP_VOXELVISUALIZER_LIGHTCANBEBAKED_OFFSET UNITYSDK_OFFSET(0x106ABA10)
#define RPG_CUSTOMRP_VOXELVISUALIZER_METHOD_5_B37B206BF73A85B5_OFFSET UNITYSDK_OFFSET(0x106AB950)
#define RPG_CUSTOMRP_VOXELVISUALIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x106ABAF0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int VoxelVisualizer_TypeDefinitionIndex = 49488;
