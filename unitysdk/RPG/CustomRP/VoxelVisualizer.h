...
#define RPG_CUSTOMRP_VOXELVISUALIZER_LIGHTCANBEBAKED_OFFSET UNITYSDK_OFFSET(0xCC53880)
#define RPG_CUSTOMRP_VOXELVISUALIZER_METHOD_5_B37B206BF73A85B5_OFFSET UNITYSDK_OFFSET(0xCC5A9C0)
#define RPG_CUSTOMRP_VOXELVISUALIZER__CTOR_OFFSET UNITYSDK_OFFSET(0xCC5AA80)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int VoxelVisualizer_TypeDefinitionIndex = 48475;
