...
#define RPG_CUSTOMRP_VOXELVISUALIZER_LIGHTCANBEBAKED_OFFSET UNITYSDK_OFFSET(0xA7B2440)
#define RPG_CUSTOMRP_VOXELVISUALIZER_METHOD_5_B37B206BF73A85B5_OFFSET UNITYSDK_OFFSET(0xA7B2380)
#define RPG_CUSTOMRP_VOXELVISUALIZER__CTOR_OFFSET UNITYSDK_OFFSET(0xA7B2520)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int VoxelVisualizer_TypeDefinitionIndex = 41885;
