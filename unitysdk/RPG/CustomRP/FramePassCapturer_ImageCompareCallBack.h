...
#define RPG_CUSTOMRP_FRAMEPASSCAPTURER_IMAGECOMPARECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18EE6BC0)
#define RPG_CUSTOMRP_FRAMEPASSCAPTURER_IMAGECOMPARECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18EE6C30)
#define RPG_CUSTOMRP_FRAMEPASSCAPTURER_IMAGECOMPARECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x18EE6BB0)
#define RPG_CUSTOMRP_FRAMEPASSCAPTURER_IMAGECOMPARECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18EE6B40)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int FramePassCapturer_ImageCompareCallBack_TypeDefinitionIndex = 35298;
