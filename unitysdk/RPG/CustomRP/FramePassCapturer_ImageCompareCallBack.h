...
#define RPG_CUSTOMRP_FRAMEPASSCAPTURER_IMAGECOMPARECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x16A9D0E0)
#define RPG_CUSTOMRP_FRAMEPASSCAPTURER_IMAGECOMPARECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x16A9D150)
#define RPG_CUSTOMRP_FRAMEPASSCAPTURER_IMAGECOMPARECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x16A9CD90)
#define RPG_CUSTOMRP_FRAMEPASSCAPTURER_IMAGECOMPARECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x16A9CD70)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int FramePassCapturer_ImageCompareCallBack_TypeDefinitionIndex = 29246;
