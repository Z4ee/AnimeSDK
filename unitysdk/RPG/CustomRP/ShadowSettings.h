...
#define RPG_CUSTOMRP_SHADOWSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1EE58CE0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int ShadowSettings_TypeDefinitionIndex = 36886;
