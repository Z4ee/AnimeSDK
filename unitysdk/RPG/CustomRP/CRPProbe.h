...
#define RPG_CUSTOMRP_CRPPROBE_GETGLOBALROTATIONMATRIX_OFFSET UNITYSDK_OFFSET(0x18EBA670)
#define RPG_CUSTOMRP_CRPPROBE_GETPROBEDELEGATEMESHANDTRANSFORM_OFFSET UNITYSDK_OFFSET(0x18EBA880)
#define RPG_CUSTOMRP_CRPPROBE_GET_ISGLOBALPROBE_OFFSET UNITYSDK_OFFSET(0x18EB9BE0)
#define RPG_CUSTOMRP_CRPPROBE_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x18EB9B90)
#define RPG_CUSTOMRP_CRPPROBE_GET_NEEDUPDATE_OFFSET UNITYSDK_OFFSET(0x18EB9BF0)
#define RPG_CUSTOMRP_CRPPROBE_GET_OVERRIDESTENCIL_OFFSET UNITYSDK_OFFSET(0x18EB9C00)
#define RPG_CUSTOMRP_CRPPROBE_GET_PROBE_OFFSET UNITYSDK_OFFSET(0x18EB9BD0)
#define RPG_CUSTOMRP_CRPPROBE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x18EBAED0)
#define RPG_CUSTOMRP_CRPPROBE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x18EBAE20)
#define RPG_CUSTOMRP_CRPPROBE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x18EBAD70)
#define RPG_CUSTOMRP_CRPPROBE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x18EB9C20)
#define RPG_CUSTOMRP_CRPPROBE_RESETUPDATE_OFFSET UNITYSDK_OFFSET(0x18EBA660)
#define RPG_CUSTOMRP_CRPPROBE_START_OFFSET UNITYSDK_OFFSET(0x18EBACC0)
#define RPG_CUSTOMRP_CRPPROBE__CTOR_OFFSET UNITYSDK_OFFSET(0x18EBAF80)
#define RPG_CUSTOMRP_CRPPROBE__FLUSHDATA_OFFSET UNITYSDK_OFFSET(0x18EBAAF0)
#define RPG_CUSTOMRP_CRPPROBE__PREPARE_OFFSET UNITYSDK_OFFSET(0x18EBA940)
#define RPG_CUSTOMRP_CRPPROBE__UPDATEFILTER_OFFSET UNITYSDK_OFFSET(0x18EBA9F0)
#define RPG_CUSTOMRP_CRPPROBE__UPDATEIFNEEDED_OFFSET UNITYSDK_OFFSET(0x18EB9D00)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int CRPProbe_TypeDefinitionIndex = 35358;
