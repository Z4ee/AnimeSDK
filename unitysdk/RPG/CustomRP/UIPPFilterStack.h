...
#define RPG_CUSTOMRP_UIPPFILTERSTACK_EXECUTE_OFFSET UNITYSDK_OFFSET(0x106A9DE0)
#define RPG_CUSTOMRP_UIPPFILTERSTACK_GET_KEY_OFFSET UNITYSDK_OFFSET(0x106A9DD0)
#define RPG_CUSTOMRP_UIPPFILTERSTACK_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x106A9D10)
#define RPG_CUSTOMRP_UIPPFILTERSTACK_ONENABLE_OFFSET UNITYSDK_OFFSET(0x106A9A40)
#define RPG_CUSTOMRP_UIPPFILTERSTACK__BLIT_1_OFFSET UNITYSDK_OFFSET(0x106AA8B0)
#define RPG_CUSTOMRP_UIPPFILTERSTACK__BLIT_2_OFFSET UNITYSDK_OFFSET(0x106AAA70)
#define RPG_CUSTOMRP_UIPPFILTERSTACK__BLIT_3_OFFSET UNITYSDK_OFFSET(0x106AAC30)
#define RPG_CUSTOMRP_UIPPFILTERSTACK__BLIT_OFFSET UNITYSDK_OFFSET(0x106AA560)
#define RPG_CUSTOMRP_UIPPFILTERSTACK__CHECKALLMATERIALS_OFFSET UNITYSDK_OFFSET(0x106AA6E0)
#define RPG_CUSTOMRP_UIPPFILTERSTACK__CTOR_OFFSET UNITYSDK_OFFSET(0x106AAE80)
#define RPG_CUSTOMRP_UIPPFILTERSTACK__DRAWUIPPPATTERNONLY_OFFSET UNITYSDK_OFFSET(0x106AA2A0)
#define RPG_CUSTOMRP_UIPPFILTERSTACK__DRAWUIPP_OFFSET UNITYSDK_OFFSET(0x106AA210)
#define RPG_CUSTOMRP_UIPPFILTERSTACK__SETMATERIALANIMATIONBINDING_OFFSET UNITYSDK_OFFSET(0x106A9BF0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int UIPPFilterStack_TypeDefinitionIndex = 49501;
