...
#define RPG_CUSTOMRP_CAPTUREBOUNDARY_FETCHTEXTUREDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1781A480)
#define RPG_CUSTOMRP_CAPTUREBOUNDARY_FETCHTEXTUREDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1781A4B0)
#define RPG_CUSTOMRP_CAPTUREBOUNDARY_FETCHTEXTUREDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1781A400)
#define RPG_CUSTOMRP_CAPTUREBOUNDARY_FETCHTEXTUREDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1781A410)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int CaptureBoundary_FetchTextureDelegate_TypeDefinitionIndex = 36051;
