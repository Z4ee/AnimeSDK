...
#define RPG_CUSTOMRP_DLSSPASS_CAMERASTATE_CLEANUP_OFFSET UNITYSDK_OFFSET(0x181354B0)
#define RPG_CUSTOMRP_DLSSPASS_CAMERASTATE_CLEARAUTOMATICSETTINGS_OFFSET UNITYSDK_OFFSET(0x18135160)
#define RPG_CUSTOMRP_DLSSPASS_CAMERASTATE_CRPSETUPDLSSDATA_OFFSET UNITYSDK_OFFSET(0x18135320)
#define RPG_CUSTOMRP_DLSSPASS_CAMERASTATE_GET_ISNEW_OFFSET UNITYSDK_OFFSET(0x18134800)
#define RPG_CUSTOMRP_DLSSPASS_CAMERASTATE_GET_LASTFRAMEID_OFFSET UNITYSDK_OFFSET(0x18135090)
#define RPG_CUSTOMRP_DLSSPASS_CAMERASTATE_GET_SCALEDELEGATE_OFFSET UNITYSDK_OFFSET(0x18135070)
#define RPG_CUSTOMRP_DLSSPASS_CAMERASTATE_GET_VIEWSTATES_OFFSET UNITYSDK_OFFSET(0x18135080)
#define RPG_CUSTOMRP_DLSSPASS_CAMERASTATE_INIT_OFFSET UNITYSDK_OFFSET(0x18134E00)
#define RPG_CUSTOMRP_DLSSPASS_CAMERASTATE_ISALIVE_OFFSET UNITYSDK_OFFSET(0x18134AB0)
#define RPG_CUSTOMRP_DLSSPASS_CAMERASTATE_SCALEFN_OFFSET UNITYSDK_OFFSET(0x18135270)
#define RPG_CUSTOMRP_DLSSPASS_CAMERASTATE_SET_LASTFRAMEID_OFFSET UNITYSDK_OFFSET(0x18134E70)
#define RPG_CUSTOMRP_DLSSPASS_CAMERASTATE_SUBMITCOMMANDS_OFFSET UNITYSDK_OFFSET(0x18134E80)
#define RPG_CUSTOMRP_DLSSPASS_CAMERASTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x181350A0)
#define RPG_CUSTOMRP_DLSSPASS_CAMERASTATE__SUBMITCOMMANDS_G__RUNPASS_20_0_OFFSET UNITYSDK_OFFSET(0x18135CE0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int DLSSPass_CameraState_TypeDefinitionIndex = 34948;
	...
	public:
		...
		::UnityEngine::Rendering::PerformDynamicRes* m_ScaleDelegate; // 0x28
