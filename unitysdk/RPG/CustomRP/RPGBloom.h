...
#define RPG_CUSTOMRP_RPGBLOOM_ISACTIVEIMPL_OFFSET UNITYSDK_OFFSET(0x16BF68E0)
#define RPG_CUSTOMRP_RPGBLOOM__CTOR_OFFSET UNITYSDK_OFFSET(0x16BF69C0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int RPGBloom_TypeDefinitionIndex = 36246;
