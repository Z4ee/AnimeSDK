...
#define RPG_CUSTOMRP_ONDRAWGIZMOCB_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x16AA4950)
#define RPG_CUSTOMRP_ONDRAWGIZMOCB_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x16AA4980)
#define RPG_CUSTOMRP_ONDRAWGIZMOCB_INVOKE_OFFSET UNITYSDK_OFFSET(0x16AA46B0)
#define RPG_CUSTOMRP_ONDRAWGIZMOCB__CTOR_OFFSET UNITYSDK_OFFSET(0x16AA4690)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int OnDrawGizmoCb_TypeDefinitionIndex = 29319;
