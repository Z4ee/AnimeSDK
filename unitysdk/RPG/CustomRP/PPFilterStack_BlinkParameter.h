...
#define RPG_CUSTOMRP_PPFILTERSTACK_BLINKPARAMETER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x3A984C0)
#define RPG_CUSTOMRP_PPFILTERSTACK_BLINKPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x3A98470)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int PPFilterStack_BlinkParameter_TypeDefinitionIndex = 52151;
