...
#define RPG_CUSTOMRP_REFLECTIONPROBEUTILITY_SETGLOBALPROBE_OFFSET UNITYSDK_OFFSET(0x181767B0)
#define RPG_CUSTOMRP_REFLECTIONPROBEUTILITY_SETNULLGLOBALPROBE_OFFSET UNITYSDK_OFFSET(0x18176810)
#define RPG_CUSTOMRP_REFLECTIONPROBEUTILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x18176840)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int ReflectionProbeUtility_TypeDefinitionIndex = 34963;
