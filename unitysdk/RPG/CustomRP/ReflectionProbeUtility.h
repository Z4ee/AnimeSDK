...
#define RPG_CUSTOMRP_REFLECTIONPROBEUTILITY_SETGLOBALPROBE_OFFSET UNITYSDK_OFFSET(0x185B5760)
#define RPG_CUSTOMRP_REFLECTIONPROBEUTILITY_SETNULLGLOBALPROBE_OFFSET UNITYSDK_OFFSET(0x185B57C0)
#define RPG_CUSTOMRP_REFLECTIONPROBEUTILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x185B57F0)
