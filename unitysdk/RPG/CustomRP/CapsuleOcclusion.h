...
#define RPG_CUSTOMRP_CAPSULEOCCLUSION_DESPAWNED_OFFSET UNITYSDK_OFFSET(0x16829EA0)
#define RPG_CUSTOMRP_CAPSULEOCCLUSION_DRAWWIRECAPSULE_OFFSET UNITYSDK_OFFSET(0x1682AD00)
#define RPG_CUSTOMRP_CAPSULEOCCLUSION_FORCESETLOCALLIGHTDIR_OFFSET UNITYSDK_OFFSET(0x1682A180)
#define RPG_CUSTOMRP_CAPSULEOCCLUSION_METHOD_5_06330CD58CB602B6_OFFSET UNITYSDK_OFFSET(0x1682A1D0)
#define RPG_CUSTOMRP_CAPSULEOCCLUSION_METHOD_5_51BBA01F511E6107_OFFSET UNITYSDK_OFFSET(0x1682A3C0)
#define RPG_CUSTOMRP_CAPSULEOCCLUSION_METHOD_5_81324F8D98C88EDA_OFFSET UNITYSDK_OFFSET(0x168297F0)
#define RPG_CUSTOMRP_CAPSULEOCCLUSION_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x16829F70)
#define RPG_CUSTOMRP_CAPSULEOCCLUSION_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x16829E60)
#define RPG_CUSTOMRP_CAPSULEOCCLUSION_METHOD_5_DE41669E7C7D4E6C_OFFSET UNITYSDK_OFFSET(0x1682A7F0)
#define RPG_CUSTOMRP_CAPSULEOCCLUSION_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x16829EE0)
#define RPG_CUSTOMRP_CAPSULEOCCLUSION_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1682AA30)
#define RPG_CUSTOMRP_CAPSULEOCCLUSION_SETCAPSULELIGHTDIR_OFFSET UNITYSDK_OFFSET(0x1682A100)
#define RPG_CUSTOMRP_CAPSULEOCCLUSION_SETDEFAULTBONES_OFFSET UNITYSDK_OFFSET(0x16829B70)
#define RPG_CUSTOMRP_CAPSULEOCCLUSION_SPAWNED_OFFSET UNITYSDK_OFFSET(0x16829E00)
#define RPG_CUSTOMRP_CAPSULEOCCLUSION_TESTCAPSULEDIR_OFFSET UNITYSDK_OFFSET(0x1682A040)
#define RPG_CUSTOMRP_CAPSULEOCCLUSION_UPDATE_OFFSET UNITYSDK_OFFSET(0x1682AB40)
#define RPG_CUSTOMRP_CAPSULEOCCLUSION__CCTOR_OFFSET UNITYSDK_OFFSET(0x1682ADE0)
#define RPG_CUSTOMRP_CAPSULEOCCLUSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1682AD80)
...
namespace RPG::CustomRP
{
	...
	public:
		...
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(CapsuleOcclusion_TypeDefinitionIndex)->GetStaticField(0x64B00);
		}
		static ::Il2CppArray<::System::String*>** StaticGet_DCEODDLKNCI()
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(CapsuleOcclusion_TypeDefinitionIndex)->GetStaticField(0x64B08);
		}
