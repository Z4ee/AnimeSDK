...
#define RPG_CUSTOMRP_GAUSSIANFILTERKERNEL_COMPUTE1DGAUSSIANBLURPARAMCROSSCENTER_OFFSET UNITYSDK_OFFSET(0x1857C920)
#define RPG_CUSTOMRP_GAUSSIANFILTERKERNEL_COMPUTE1DGAUSSIANBLURPARAM_OFFSET UNITYSDK_OFFSET(0x1857C5B0)
#define RPG_CUSTOMRP_GAUSSIANFILTERKERNEL_COMPUTE1DGAUSSIANFILTERKERNEL_OFFSET UNITYSDK_OFFSET(0x1857CB00)
#define RPG_CUSTOMRP_GAUSSIANFILTERKERNEL_SIGNWITHZERO_OFFSET UNITYSDK_OFFSET(0x1857C590)
#define RPG_CUSTOMRP_GAUSSIANFILTERKERNEL_SQUARE_OFFSET UNITYSDK_OFFSET(0x1857C5A0)
#define RPG_CUSTOMRP_GAUSSIANFILTERKERNEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1857CDA0)
#define RPG_CUSTOMRP_GAUSSIANFILTERKERNEL__GAUSSIAN_OFFSET UNITYSDK_OFFSET(0x1857C900)
#define RPG_CUSTOMRP_GAUSSIANFILTERKERNEL__RESET_OFFSET UNITYSDK_OFFSET(0x1857CD30)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int GaussianFilterKernel_TypeDefinitionIndex = 37095;
