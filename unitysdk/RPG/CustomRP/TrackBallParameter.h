...
#define RPG_CUSTOMRP_TRACKBALLPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C6F1530)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int TrackBallParameter_TypeDefinitionIndex = 37109;
