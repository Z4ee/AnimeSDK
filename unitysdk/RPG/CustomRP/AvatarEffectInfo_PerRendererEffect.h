...
#define RPG_CUSTOMRP_AVATAREFFECTINFO_PERRENDEREREFFECT_RESET_OFFSET UNITYSDK_OFFSET(0x177FDDB0)
#define RPG_CUSTOMRP_AVATAREFFECTINFO_PERRENDEREREFFECT_SETSUBMESHINDEX_OFFSET UNITYSDK_OFFSET(0x177FDDE0)
#define RPG_CUSTOMRP_AVATAREFFECTINFO_PERRENDEREREFFECT_UNSETSUBMESHINDEX_OFFSET UNITYSDK_OFFSET(0x177FDE40)
#define RPG_CUSTOMRP_AVATAREFFECTINFO_PERRENDEREREFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x177FDEA0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int AvatarEffectInfo_PerRendererEffect_TypeDefinitionIndex = 36037;
