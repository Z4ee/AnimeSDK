...
#define RPG_CUSTOMRP_AVATAREFFECTINFO_PERRENDEREREFFECT_RESET_OFFSET UNITYSDK_OFFSET(0x18EA5F00)
#define RPG_CUSTOMRP_AVATAREFFECTINFO_PERRENDEREREFFECT_SETSUBMESHINDEX_OFFSET UNITYSDK_OFFSET(0x18EA5F30)
#define RPG_CUSTOMRP_AVATAREFFECTINFO_PERRENDEREREFFECT_UNSETSUBMESHINDEX_OFFSET UNITYSDK_OFFSET(0x18EA5F90)
#define RPG_CUSTOMRP_AVATAREFFECTINFO_PERRENDEREREFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x18EA5FF0)
...
namespace RPG::CustomRP
{
	...
	public:
		...
		::Il2CppArray<::System::Int32>* subMeshIndexMasks; // 0x28
		...
		::System::Boolean ignoreMpb; // 0x3C
		::System::Boolean afterTransparent; // 0x3D
