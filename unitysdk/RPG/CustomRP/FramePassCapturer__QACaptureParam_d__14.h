...
#define RPG_CUSTOMRP_FRAMEPASSCAPTURER__QACAPTUREPARAM_D__14_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x16A9C8F0)
#define RPG_CUSTOMRP_FRAMEPASSCAPTURER__QACAPTUREPARAM_D__14_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x16A9C960)
#define RPG_CUSTOMRP_FRAMEPASSCAPTURER__QACAPTUREPARAM_D__14_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x16A9C9C0)
#define RPG_CUSTOMRP_FRAMEPASSCAPTURER__QACAPTUREPARAM_D__14_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x16A9C970)
#define RPG_CUSTOMRP_FRAMEPASSCAPTURER__QACAPTUREPARAM_D__14_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16A9C8E0)
#define RPG_CUSTOMRP_FRAMEPASSCAPTURER__QACAPTUREPARAM_D__14__CTOR_OFFSET UNITYSDK_OFFSET(0x16A9BFE0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int FramePassCapturer__QACaptureParam_d__14_TypeDefinitionIndex = 29250;
