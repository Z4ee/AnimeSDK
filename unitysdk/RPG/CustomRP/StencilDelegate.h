...
#define RPG_CUSTOMRP_STENCILDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18180F60)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int StencilDelegate_TypeDefinitionIndex = 35089;
