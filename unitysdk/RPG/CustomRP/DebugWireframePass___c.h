...
#define RPG_CUSTOMRP_DEBUGWIREFRAMEPASS___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x18EE1B40)
#define RPG_CUSTOMRP_DEBUGWIREFRAMEPASS___C__CTOR_OFFSET UNITYSDK_OFFSET(0x18EE1B80)
#define RPG_CUSTOMRP_DEBUGWIREFRAMEPASS___C__INNEREXECUTE_B__5_0_OFFSET UNITYSDK_OFFSET(0x18EE1B90)
...
namespace RPG::CustomRP
{
	...
	public:
		...
		{
			return (::System::Func_2<::UnityEngine::Collider*, ::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(DebugWireframePass___c_TypeDefinitionIndex)->GetStaticField(0x61D10);
		}
		static ::RPG::CustomRP::DebugWireframePass___c** StaticGet___9()
		{
			return (::RPG::CustomRP::DebugWireframePass___c**)Il2CppClass::FromTypeDefinitionIndex(DebugWireframePass___c_TypeDefinitionIndex)->GetStaticField(0x61D18);
		}
