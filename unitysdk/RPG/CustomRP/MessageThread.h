...
#define RPG_CUSTOMRP_MESSAGETHREAD_ENQUEUEMESSAGE_OFFSET UNITYSDK_OFFSET(0x16BE2E10)
#define RPG_CUSTOMRP_MESSAGETHREAD_GET_ISINVALID_OFFSET UNITYSDK_OFFSET(0x16BE37C0)
#define RPG_CUSTOMRP_MESSAGETHREAD_ONCONNECTING_OFFSET UNITYSDK_OFFSET(0x16BE3510)
#define RPG_CUSTOMRP_MESSAGETHREAD_PREPARESTOP_OFFSET UNITYSDK_OFFSET(0x16BE2EA0)
#define RPG_CUSTOMRP_MESSAGETHREAD_STOP_OFFSET UNITYSDK_OFFSET(0x16BE2EC0)
#define RPG_CUSTOMRP_MESSAGETHREAD_UPDATE_OFFSET UNITYSDK_OFFSET(0x16BE3800)
#define RPG_CUSTOMRP_MESSAGETHREAD__CTOR_OFFSET UNITYSDK_OFFSET(0x16BE2510)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int MessageThread_TypeDefinitionIndex = 36362;
