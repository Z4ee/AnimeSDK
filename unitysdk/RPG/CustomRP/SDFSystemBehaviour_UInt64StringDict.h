...
#define RPG_CUSTOMRP_SDFSYSTEMBEHAVIOUR_UINT64STRINGDICT__CTOR_OFFSET UNITYSDK_OFFSET(0x106A9720)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int SDFSystemBehaviour_UInt64StringDict_TypeDefinitionIndex = 49505;
