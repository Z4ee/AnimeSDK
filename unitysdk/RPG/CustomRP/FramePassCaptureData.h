...
#define RPG_CUSTOMRP_FRAMEPASSCAPTUREDATA_DIFF_OFFSET UNITYSDK_OFFSET(0x3B7FB30)
#define RPG_CUSTOMRP_FRAMEPASSCAPTUREDATA_GET_EMPTY_OFFSET UNITYSDK_OFFSET(0x3B7FB10)
#define RPG_CUSTOMRP_FRAMEPASSCAPTUREDATA_LOADIMAGE_OFFSET UNITYSDK_OFFSET(0x3B7FAC0)
#define RPG_CUSTOMRP_FRAMEPASSCAPTUREDATA_OUTPUTASDIFF_OFFSET UNITYSDK_OFFSET(0x3B7FB40)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int FramePassCaptureData_TypeDefinitionIndex = 36933;
