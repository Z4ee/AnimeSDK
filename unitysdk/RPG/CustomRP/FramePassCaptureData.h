...
#define RPG_CUSTOMRP_FRAMEPASSCAPTUREDATA_DIFF_OFFSET UNITYSDK_OFFSET(0x3AE0D90)
#define RPG_CUSTOMRP_FRAMEPASSCAPTUREDATA_GET_EMPTY_OFFSET UNITYSDK_OFFSET(0x3AE0D70)
#define RPG_CUSTOMRP_FRAMEPASSCAPTUREDATA_LOADIMAGE_OFFSET UNITYSDK_OFFSET(0x3AE0D20)
#define RPG_CUSTOMRP_FRAMEPASSCAPTUREDATA_OUTPUTASDIFF_OFFSET UNITYSDK_OFFSET(0x3AE0DA0)
