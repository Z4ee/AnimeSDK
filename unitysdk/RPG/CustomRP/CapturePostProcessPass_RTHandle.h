...
#define RPG_CUSTOMRP_CAPTUREPOSTPROCESSPASS_RTHANDLE_GET_FILTERRT_OFFSET UNITYSDK_OFFSET(0x16A7D700)
#define RPG_CUSTOMRP_CAPTUREPOSTPROCESSPASS_RTHANDLE_SET_FILTERRT_OFFSET UNITYSDK_OFFSET(0x16A7D710)
#define RPG_CUSTOMRP_CAPTUREPOSTPROCESSPASS_RTHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x16A7D6F0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int CapturePostProcessPass_RTHandle_TypeDefinitionIndex = 29375;
