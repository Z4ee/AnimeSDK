...
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_GET_BASECAMERA_OFFSET UNITYSDK_OFFSET(0x18ED3950)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_GET_CAMERAREF_OFFSET UNITYSDK_OFFSET(0x18ED3850)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_GET_CAMERASTACK_OFFSET UNITYSDK_OFFSET(0x18ED3760)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_GET_DISABLEMAINCAMERA_OFFSET UNITYSDK_OFFSET(0x18EB4B80)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_GET_ENABLEBLURFULL_OFFSET UNITYSDK_OFFSET(0x18EB4B90)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_GET_ENABLEDEBUGOC_OFFSET UNITYSDK_OFFSET(0x18ED38B0)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_GET_ENABLEDEFORMATION_OFFSET UNITYSDK_OFFSET(0x18ED3900)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_GET_ENABLEHIZOC_OFFSET UNITYSDK_OFFSET(0x18ED3860)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_GET_MAINCAMERADATA_OFFSET UNITYSDK_OFFSET(0x18ED3970)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_GET_MAINCAMERA_OFFSET UNITYSDK_OFFSET(0x18ED3960)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_GET_NEEDUPDATE_OFFSET UNITYSDK_OFFSET(0x18ED3730)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_GET_OVERLAYTYPE_OFFSET UNITYSDK_OFFSET(0x18ED3740)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_GET_VOLUMELAYERMASK_OFFSET UNITYSDK_OFFSET(0x18ED3810)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_GET_VOLUMETRIGGER_OFFSET UNITYSDK_OFFSET(0x18ED3830)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x18ED2D90)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x18ED3E90)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x18ED3D00)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_ONENABLE_OFFSET UNITYSDK_OFFSET(0x18ED3C10)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x18ED2D10)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_REFRESHALLCOLLIDER_1_OFFSET UNITYSDK_OFFSET(0x18ED2D30)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_REFRESHALLCOLLIDER_OFFSET UNITYSDK_OFFSET(0x18ED2D20)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_SET_ENABLEDEBUGOC_OFFSET UNITYSDK_OFFSET(0x18ED38D0)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_SET_ENABLEDEFORMATION_OFFSET UNITYSDK_OFFSET(0x18ED3920)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_SET_ENABLEHIZOC_OFFSET UNITYSDK_OFFSET(0x18ED3880)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_SET_OVERLAYTYPE_OFFSET UNITYSDK_OFFSET(0x18ED3750)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_SET_VOLUMELAYERMASK_OFFSET UNITYSDK_OFFSET(0x18ED3820)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_SET_VOLUMETRIGGER_OFFSET UNITYSDK_OFFSET(0x18ED3840)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_START_OFFSET UNITYSDK_OFFSET(0x18ED3980)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA_UPDATE_OFFSET UNITYSDK_OFFSET(0x18ED2D40)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18ED4DC0)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA__DISABLEHIZOCFORVIRTUALCAMERA_OFFSET UNITYSDK_OFFSET(0x18ED4170)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA__PREPARE_OFFSET UNITYSDK_OFFSET(0x18ED3B10)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA__UPDATEBASECAMERA_OFFSET UNITYSDK_OFFSET(0x18ED3FE0)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA__UPDATEDYNAMICDATA_OFFSET UNITYSDK_OFFSET(0x18ED2E20)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA__UPDATEONSTART_OFFSET UNITYSDK_OFFSET(0x18ED3BB0)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA__UPDATEPRECONFIG_OFFSET UNITYSDK_OFFSET(0x18ED4240)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA__UPDATESTATICDATA_OFFSET UNITYSDK_OFFSET(0x18ED3EA0)
#define RPG_CUSTOMRP_CUSTOMADDITIONALCAMERADATA__UPDATEVIRTUALCAMERA_OFFSET UNITYSDK_OFFSET(0x18ED4C40)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int CustomAdditionalCameraData_TypeDefinitionIndex = 35373;
	...
	public:
		...
		{
			return (::UnityEngine::Camera**)Il2CppClass::FromTypeDefinitionIndex(CustomAdditionalCameraData_TypeDefinitionIndex)->GetStaticField(0x26350);
		}
		static ::RPG::CustomRP::CustomAdditionalCameraData** StaticGet_s_MainCameraData()
		{
			return (::RPG::CustomRP::CustomAdditionalCameraData**)Il2CppClass::FromTypeDefinitionIndex(CustomAdditionalCameraData_TypeDefinitionIndex)->GetStaticField(0x26358);
		}
