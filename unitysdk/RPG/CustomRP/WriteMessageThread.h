...
#define RPG_CUSTOMRP_WRITEMESSAGETHREAD_ENQUEUEMESSAGE_OFFSET UNITYSDK_OFFSET(0x18184CB0)
#define RPG_CUSTOMRP_WRITEMESSAGETHREAD_GET_ISCONNECTED_OFFSET UNITYSDK_OFFSET(0x18184E10)
#define RPG_CUSTOMRP_WRITEMESSAGETHREAD_STOP_OFFSET UNITYSDK_OFFSET(0x18184C20)
#define RPG_CUSTOMRP_WRITEMESSAGETHREAD__CTOR_OFFSET UNITYSDK_OFFSET(0x181848B0)
#define RPG_CUSTOMRP_WRITEMESSAGETHREAD__ONIDLE_OFFSET UNITYSDK_OFFSET(0x18184E20)
#define RPG_CUSTOMRP_WRITEMESSAGETHREAD__ONWRITING_OFFSET UNITYSDK_OFFSET(0x18184F60)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int WriteMessageThread_TypeDefinitionIndex = 35274;
	...
	public:
		...
		::RPG::CustomRP::IRPMessage* _currentMessage; // 0x58
		::System::IO::BinaryWriter* _bw; // 0x60
		::System::IO::BinaryWriter* _writer; // 0x68
		::System::IO::MemoryStream* _writeMS; // 0x70
