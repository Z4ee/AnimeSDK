...
#define RPG_CUSTOMRP_RPGDEPTHOFFIELD_COCMETHODPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x16AAE980)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int RPGDepthOfField_CoCMethodParameter_TypeDefinitionIndex = 29411;
