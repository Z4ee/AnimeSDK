...
#define RPG_CUSTOMRP_RPGDEPTHOFFIELD_COCMETHODPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1858D0C0)

namespace RPG::CustomRP
{
	inline static constexpr unsigned int RPGDepthOfField_CoCMethodParameter_TypeDefinitionIndex = 37119;
