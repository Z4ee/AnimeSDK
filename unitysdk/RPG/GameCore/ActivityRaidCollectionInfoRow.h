...
#define RPG_GAMECORE_ACTIVITYRAIDCOLLECTIONINFOROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1AB06D50)
#define RPG_GAMECORE_ACTIVITYRAIDCOLLECTIONINFOROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB073F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityRaidCollectionInfoRow_TypeDefinitionIndex = 11848;
