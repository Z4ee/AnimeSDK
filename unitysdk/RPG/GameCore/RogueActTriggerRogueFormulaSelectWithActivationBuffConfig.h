...
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEFORMULASELECTWITHACTIVATIONBUFFCONFIG_METHOD_6_021E2CF43ADE0611_OFFSET UNITYSDK_OFFSET(0x1C49E860)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEFORMULASELECTWITHACTIVATIONBUFFCONFIG_METHOD_6_065DE09249BA9635_OFFSET UNITYSDK_OFFSET(0x1C49E8B0)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEFORMULASELECTWITHACTIVATIONBUFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C49E8A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActTriggerRogueFormulaSelectWithActivationBuffConfig_TypeDefinitionIndex = 18896;
