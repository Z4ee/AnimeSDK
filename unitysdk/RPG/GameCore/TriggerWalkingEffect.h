...
#define RPG_GAMECORE_TRIGGERWALKINGEFFECT_METHOD_3_071A17A42EB4D493_OFFSET UNITYSDK_OFFSET(0x190CEE70)
#define RPG_GAMECORE_TRIGGERWALKINGEFFECT_METHOD_3_0CFFD8BD6CFAF8A9_OFFSET UNITYSDK_OFFSET(0x190CEF10)
#define RPG_GAMECORE_TRIGGERWALKINGEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x190CEED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerWalkingEffect_TypeDefinitionIndex = 21308;
