...
#define RPG_GAMECORE_CHALLENGEPEAKREWARDORROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B715550)
#define RPG_GAMECORE_CHALLENGEPEAKREWARDORROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7156C0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 PeakGroupID; // 0x18
