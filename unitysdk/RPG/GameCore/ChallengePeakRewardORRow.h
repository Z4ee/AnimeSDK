...
#define RPG_GAMECORE_CHALLENGEPEAKREWARDORROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x195FF400)
#define RPG_GAMECORE_CHALLENGEPEAKREWARDORROW__CTOR_OFFSET UNITYSDK_OFFSET(0x195FF570)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChallengePeakRewardORRow_TypeDefinitionIndex = 12356;
