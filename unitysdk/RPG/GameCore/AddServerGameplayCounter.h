...
#define RPG_GAMECORE_ADDSERVERGAMEPLAYCOUNTER_METHOD_3_C11ABAD43B559F2F_OFFSET UNITYSDK_OFFSET(0x18643440)
#define RPG_GAMECORE_ADDSERVERGAMEPLAYCOUNTER_METHOD_3_EB9FD8651EB8465F_OFFSET UNITYSDK_OFFSET(0x186433B0)
#define RPG_GAMECORE_ADDSERVERGAMEPLAYCOUNTER__CTOR_OFFSET UNITYSDK_OFFSET(0x18643410)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddServerGameplayCounter_TypeDefinitionIndex = 19520;
