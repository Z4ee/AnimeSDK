...
#define RPG_GAMECORE_MONOPROJECTILEBGCURVE_CALCCURVEPOINTBYDISTANCERATIO_OFFSET UNITYSDK_OFFSET(0x18FF3830)
#define RPG_GAMECORE_MONOPROJECTILEBGCURVE_GETOVERRIDECURVESPEED_OFFSET UNITYSDK_OFFSET(0x18FF3690)
#define RPG_GAMECORE_MONOPROJECTILEBGCURVE_GET_CURRENTBGCURVELINEDISTANCE_OFFSET UNITYSDK_OFFSET(0x18FF3700)
#define RPG_GAMECORE_MONOPROJECTILEBGCURVE_GET_OVERRIDEEASETYPE_OFFSET UNITYSDK_OFFSET(0x18FF3670)
#define RPG_GAMECORE_MONOPROJECTILEBGCURVE_GET_OVERRIDETIMECURVE_OFFSET UNITYSDK_OFFSET(0x18FF3650)
#define RPG_GAMECORE_MONOPROJECTILEBGCURVE_INIT_OFFSET UNITYSDK_OFFSET(0x18FF3720)
#define RPG_GAMECORE_MONOPROJECTILEBGCURVE_SET_CURRENTBGCURVELINEDISTANCE_OFFSET UNITYSDK_OFFSET(0x18FF3710)
#define RPG_GAMECORE_MONOPROJECTILEBGCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x18FF3910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonoProjectileBGCurve_TypeDefinitionIndex = 53815;
	...
	public:
		...
		::RPG::Client::ProjectileBGCurveExportData* HFEJOPFOBKE; // 0x28
		...
		::System::Void set_CurrentBgCurveLineDistance(::System::Single a1)
		{
			return ((::System::Void(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + RPG_GAMECORE_MONOPROJECTILEBGCURVE_SET_CURRENTBGCURVELINEDISTANCE_OFFSET))(this, a1);
		}
