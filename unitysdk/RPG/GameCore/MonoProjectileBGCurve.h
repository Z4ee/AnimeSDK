...
#define RPG_GAMECORE_MONOPROJECTILEBGCURVE_CALCCURVEPOINTBYDISTANCERATIO_OFFSET UNITYSDK_OFFSET(0xCE5A6E0)
#define RPG_GAMECORE_MONOPROJECTILEBGCURVE_GETOVERRIDECURVESPEED_OFFSET UNITYSDK_OFFSET(0xCE5A540)
#define RPG_GAMECORE_MONOPROJECTILEBGCURVE_GET_CURRENTBGCURVELINEDISTANCE_OFFSET UNITYSDK_OFFSET(0xCE5A5B0)
#define RPG_GAMECORE_MONOPROJECTILEBGCURVE_GET_OVERRIDEEASETYPE_OFFSET UNITYSDK_OFFSET(0xCE5A520)
#define RPG_GAMECORE_MONOPROJECTILEBGCURVE_GET_OVERRIDETIMECURVE_OFFSET UNITYSDK_OFFSET(0xCE5A500)
#define RPG_GAMECORE_MONOPROJECTILEBGCURVE_INIT_OFFSET UNITYSDK_OFFSET(0xCE5A5D0)
#define RPG_GAMECORE_MONOPROJECTILEBGCURVE_SET_CURRENTBGCURVELINEDISTANCE_OFFSET UNITYSDK_OFFSET(0xCE5A5C0)
#define RPG_GAMECORE_MONOPROJECTILEBGCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0xCE5A7C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonoProjectileBGCurve_TypeDefinitionIndex = 50049;
