...
#define RPG_GAMECORE_MONOPROJECTILEBGCURVE_CALCCURVEPOINTBYDISTANCERATIO_OFFSET UNITYSDK_OFFSET(0xE6A7E00)
#define RPG_GAMECORE_MONOPROJECTILEBGCURVE_GETOVERRIDECURVESPEED_OFFSET UNITYSDK_OFFSET(0xE6A7C60)
#define RPG_GAMECORE_MONOPROJECTILEBGCURVE_GET_CURRENTBGCURVELINEDISTANCE_OFFSET UNITYSDK_OFFSET(0xE6A7CD0)
#define RPG_GAMECORE_MONOPROJECTILEBGCURVE_GET_OVERRIDEEASETYPE_OFFSET UNITYSDK_OFFSET(0xE6A7C40)
#define RPG_GAMECORE_MONOPROJECTILEBGCURVE_GET_OVERRIDETIMECURVE_OFFSET UNITYSDK_OFFSET(0xE6A7C20)
#define RPG_GAMECORE_MONOPROJECTILEBGCURVE_INIT_OFFSET UNITYSDK_OFFSET(0xE6A7CF0)
#define RPG_GAMECORE_MONOPROJECTILEBGCURVE_SET_CURRENTBGCURVELINEDISTANCE_OFFSET UNITYSDK_OFFSET(0xE6A7CE0)
#define RPG_GAMECORE_MONOPROJECTILEBGCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0xE6A7EE0)
