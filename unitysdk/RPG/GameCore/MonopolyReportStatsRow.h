...
#define RPG_GAMECORE_MONOPOLYREPORTSTATSROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x174479F0)
#define RPG_GAMECORE_MONOPOLYREPORTSTATSROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17448010)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonopolyReportStatsRow_TypeDefinitionIndex = 11057;
