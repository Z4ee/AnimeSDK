...
#define RPG_GAMECORE_MONOPOLYREPORTSTATSROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D1D12C0)
#define RPG_GAMECORE_MONOPOLYREPORTSTATSROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1D1900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonopolyReportStatsRow_TypeDefinitionIndex = 11994;
