...
#define RPG_GAMECORE_ADVSETCONFINEFEATUREPARAM_METHOD_3_D94041FFD446F4F5_OFFSET UNITYSDK_OFFSET(0x18662610)
#define RPG_GAMECORE_ADVSETCONFINEFEATUREPARAM_METHOD_3_F7A2F31455B41CE3_OFFSET UNITYSDK_OFFSET(0x18662690)
#define RPG_GAMECORE_ADVSETCONFINEFEATUREPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x18662660)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSetConfineFeatureParam_TypeDefinitionIndex = 20661;
