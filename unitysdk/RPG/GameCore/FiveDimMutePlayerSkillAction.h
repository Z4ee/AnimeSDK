...
#define RPG_GAMECORE_FIVEDIMMUTEPLAYERSKILLACTION_METHOD_3_9E89A4A5C8890B9E_OFFSET UNITYSDK_OFFSET(0x18910C80)
#define RPG_GAMECORE_FIVEDIMMUTEPLAYERSKILLACTION_METHOD_3_DEB2F9D453B83592_OFFSET UNITYSDK_OFFSET(0x18910B50)
#define RPG_GAMECORE_FIVEDIMMUTEPLAYERSKILLACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18910C60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimMutePlayerSkillAction_TypeDefinitionIndex = 17832;
