...
#define RPG_GAMECORE_GRIDFIGHTTUTORIALTASKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19811AE0)
#define RPG_GAMECORE_GRIDFIGHTTUTORIALTASKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19811C10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightTutorialTaskRow_TypeDefinitionIndex = 13005;
