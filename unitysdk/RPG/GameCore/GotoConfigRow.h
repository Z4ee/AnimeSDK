...
#define RPG_GAMECORE_GOTOCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x197D2850)
#define RPG_GAMECORE_GOTOCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x197D2EF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GotoConfigRow_TypeDefinitionIndex = 12694;
