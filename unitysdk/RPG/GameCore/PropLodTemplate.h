...
#define RPG_GAMECORE_PROPLODTEMPLATE_METHOD_3_B02967909DEB4FF9_OFFSET UNITYSDK_OFFSET(0x1BA247C0)
#define RPG_GAMECORE_PROPLODTEMPLATE_METHOD_3_B043FE86D3E6DAA3_OFFSET UNITYSDK_OFFSET(0x1BA24780)
#define RPG_GAMECORE_PROPLODTEMPLATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA247B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropLodTemplate_TypeDefinitionIndex = 18363;
