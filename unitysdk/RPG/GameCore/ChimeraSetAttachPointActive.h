...
#define RPG_GAMECORE_CHIMERASETATTACHPOINTACTIVE_METHOD_3_768A98070B2AAABC_OFFSET UNITYSDK_OFFSET(0x1CFD2DE0)
#define RPG_GAMECORE_CHIMERASETATTACHPOINTACTIVE_METHOD_3_EE542F70F31BAF9C_OFFSET UNITYSDK_OFFSET(0x1CFD2D80)
#define RPG_GAMECORE_CHIMERASETATTACHPOINTACTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFD2DD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraSetAttachPointActive_TypeDefinitionIndex = 15693;
