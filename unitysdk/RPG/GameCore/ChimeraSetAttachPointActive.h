...
#define RPG_GAMECORE_CHIMERASETATTACHPOINTACTIVE_METHOD_3_768A98070B2AAABC_OFFSET UNITYSDK_OFFSET(0x1964B520)
#define RPG_GAMECORE_CHIMERASETATTACHPOINTACTIVE_METHOD_3_EE542F70F31BAF9C_OFFSET UNITYSDK_OFFSET(0x1964B4C0)
#define RPG_GAMECORE_CHIMERASETATTACHPOINTACTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1964B510)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraSetAttachPointActive_TypeDefinitionIndex = 15092;
