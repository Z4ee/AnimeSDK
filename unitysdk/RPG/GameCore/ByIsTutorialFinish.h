...
#define RPG_GAMECORE_BYISTUTORIALFINISH_METHOD_4_17CFA65CF1D49D17_OFFSET UNITYSDK_OFFSET(0x1B2AC5F0)
#define RPG_GAMECORE_BYISTUTORIALFINISH_METHOD_4_54E934475116746E_OFFSET UNITYSDK_OFFSET(0x1B2AC450)
#define RPG_GAMECORE_BYISTUTORIALFINISH_METHOD_4_9A227DC4712D44C0_OFFSET UNITYSDK_OFFSET(0x1B2AC5C0)
#define RPG_GAMECORE_BYISTUTORIALFINISH_METHOD_4_C6E114333BA1F1B3_OFFSET UNITYSDK_OFFSET(0x1B2AC410)
#define RPG_GAMECORE_BYISTUTORIALFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2AC440)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsTutorialFinish_TypeDefinitionIndex = 23497;
