...
#define RPG_GAMECORE_BYISTUTORIALFINISH_METHOD_4_54E934475116746E_OFFSET UNITYSDK_OFFSET(0x17035AF0)
#define RPG_GAMECORE_BYISTUTORIALFINISH_METHOD_4_88CE9E9EBC9EF094_OFFSET UNITYSDK_OFFSET(0x17035A20)
#define RPG_GAMECORE_BYISTUTORIALFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x17035AA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsTutorialFinish_TypeDefinitionIndex = 22402;
