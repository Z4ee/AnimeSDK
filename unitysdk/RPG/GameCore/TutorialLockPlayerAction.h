...
#define RPG_GAMECORE_TUTORIALLOCKPLAYERACTION_METHOD_3_071171E3F38CEFCD_OFFSET UNITYSDK_OFFSET(0x178DDA60)
#define RPG_GAMECORE_TUTORIALLOCKPLAYERACTION_METHOD_3_6F4CBAE8D5D0773C_OFFSET UNITYSDK_OFFSET(0x178DDAE0)
#define RPG_GAMECORE_TUTORIALLOCKPLAYERACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x178DDAB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TutorialLockPlayerAction_TypeDefinitionIndex = 22325;
