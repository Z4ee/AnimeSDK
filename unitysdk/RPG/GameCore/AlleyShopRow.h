...
#define RPG_GAMECORE_ALLEYSHOPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19471CF0)
#define RPG_GAMECORE_ALLEYSHOPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19472390)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AlleyShopRow_TypeDefinitionIndex = 11986;
	...
	public:
		...
		::System::UInt32 ShopBox; // 0x20
		::System::UInt32 ShopID; // 0x24
