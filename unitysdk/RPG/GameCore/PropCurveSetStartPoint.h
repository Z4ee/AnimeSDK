...
#define RPG_GAMECORE_PROPCURVESETSTARTPOINT_METHOD_3_00394310626B1888_OFFSET UNITYSDK_OFFSET(0x1D176F70)
#define RPG_GAMECORE_PROPCURVESETSTARTPOINT_METHOD_3_928AE2AAAD4807EB_OFFSET UNITYSDK_OFFSET(0x1D176EA0)
#define RPG_GAMECORE_PROPCURVESETSTARTPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D176F20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropCurveSetStartPoint_TypeDefinitionIndex = 20763;
