...
#define RPG_GAMECORE_PROPCURVESETSTARTPOINT_METHOD_3_00394310626B1888_OFFSET UNITYSDK_OFFSET(0x18C68C60)
#define RPG_GAMECORE_PROPCURVESETSTARTPOINT_METHOD_3_926E220588F59CA2_OFFSET UNITYSDK_OFFSET(0x18C68B60)
#define RPG_GAMECORE_PROPCURVESETSTARTPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x18C68BF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropCurveSetStartPoint_TypeDefinitionIndex = 19986;
