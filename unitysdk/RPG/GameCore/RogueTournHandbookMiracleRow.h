...
#define RPG_GAMECORE_ROGUETOURNHANDBOOKMIRACLEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1BB77E30)
#define RPG_GAMECORE_ROGUETOURNHANDBOOKMIRACLEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB78000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournHandbookMiracleRow_TypeDefinitionIndex = 14446;
