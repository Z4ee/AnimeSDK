...
#define RPG_GAMECORE_ROGUETOURNHANDBOOKMIRACLEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CCC6120)
#define RPG_GAMECORE_ROGUETOURNHANDBOOKMIRACLEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CCC62F0)
