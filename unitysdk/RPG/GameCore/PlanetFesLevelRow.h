...
#define RPG_GAMECORE_PLANETFESLEVELROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D79F8F0)
#define RPG_GAMECORE_PLANETFESLEVELROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7A00D0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::RPG::GameCore::ItemConfig*>* GrantItemList; // 0x18
		::Il2CppArray<::System::UInt32>* NewTipsList; // 0x20
		::RPG::GameCore::PlanetFesBigInt* CostNum; // 0x28
		::Il2CppArray<::System::UInt32>* BasicBuffIDList; // 0x30
		::RPG::GameCore::PlanetFesBigInt* GrantGold; // 0x38
