...
#define RPG_GAMECORE_PLANETFESLEVELROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B4D9AB0)
#define RPG_GAMECORE_PLANETFESLEVELROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4DA250)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlanetFesLevelRow_TypeDefinitionIndex = 11733;

	class PlanetFesLevelRow : public ::System::Object
	{
	public:
		::RPG::GameCore::PlanetFesBigInt* CostNum; // 0x10
		::Il2CppArray<::System::UInt32>* BasicBuffIDList; // 0x18
		::Il2CppArray<::System::UInt32>* BuffIDList; // 0x20
		::RPG::GameCore::PlanetFesBigInt* GrantGold; // 0x28
		::Il2CppArray<::System::UInt32>* NewTipsList; // 0x30
