...
#define RPG_GAMECORE_ROGUEPARAMFORMULANOTREQUIREDBUFFCOUNTCONFIG_METHOD_6_407E4F3B288AA239_OFFSET UNITYSDK_OFFSET(0x19BAE1B0)
#define RPG_GAMECORE_ROGUEPARAMFORMULANOTREQUIREDBUFFCOUNTCONFIG_METHOD_6_F63BC793C17B44DF_OFFSET UNITYSDK_OFFSET(0x19BADF00)
#define RPG_GAMECORE_ROGUEPARAMFORMULANOTREQUIREDBUFFCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19BAE080)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamFormulaNotRequiredBuffCountConfig_TypeDefinitionIndex = 18780;
