...
#define RPG_GAMECORE_BYCOMPARESKILLUSAGELIMIT_METHOD_4_550F0B2918A6D1D2_OFFSET UNITYSDK_OFFSET(0x1BBBB6F0)
#define RPG_GAMECORE_BYCOMPARESKILLUSAGELIMIT_METHOD_4_D28121339C9BFB4C_OFFSET UNITYSDK_OFFSET(0x1BBBB9D0)
#define RPG_GAMECORE_BYCOMPARESKILLUSAGELIMIT_METHOD_4_F04844F85281EBCD_OFFSET UNITYSDK_OFFSET(0x1BBBBA50)
#define RPG_GAMECORE_BYCOMPARESKILLUSAGELIMIT_METHOD_4_F593CF1124B31343_OFFSET UNITYSDK_OFFSET(0x1BBBB610)
#define RPG_GAMECORE_BYCOMPARESKILLUSAGELIMIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBBB690)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareSkillUsageLimit_TypeDefinitionIndex = 22730;
