...
#define RPG_GAMECORE_SETTARGETANIMSPEEDSCALE_METHOD_3_7F594083C0BA46DA_OFFSET UNITYSDK_OFFSET(0x18E44350)
#define RPG_GAMECORE_SETTARGETANIMSPEEDSCALE_METHOD_3_C24602D2718DBFA9_OFFSET UNITYSDK_OFFSET(0x18E443D0)
#define RPG_GAMECORE_SETTARGETANIMSPEEDSCALE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E443A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetTargetAnimSpeedScale_TypeDefinitionIndex = 21800;
