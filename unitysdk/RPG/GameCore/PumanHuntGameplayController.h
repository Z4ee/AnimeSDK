...
#define RPG_GAMECORE_PUMANHUNTGAMEPLAYCONTROLLER_METHOD_3_15D8454C0B607FBB_OFFSET UNITYSDK_OFFSET(0x18C7E180)
#define RPG_GAMECORE_PUMANHUNTGAMEPLAYCONTROLLER_METHOD_3_D78CF67F1567E1AF_OFFSET UNITYSDK_OFFSET(0x18C7E290)
#define RPG_GAMECORE_PUMANHUNTGAMEPLAYCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18C7E260)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PumanHuntGameplayController_TypeDefinitionIndex = 20171;
