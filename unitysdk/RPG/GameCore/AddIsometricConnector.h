...
#define RPG_GAMECORE_ADDISOMETRICCONNECTOR_METHOD_3_13EE773768E6A67D_OFFSET UNITYSDK_OFFSET(0x1D6A1AE0)
#define RPG_GAMECORE_ADDISOMETRICCONNECTOR_METHOD_3_874AC86FB48051B5_OFFSET UNITYSDK_OFFSET(0x1D6A1A60)
#define RPG_GAMECORE_ADDISOMETRICCONNECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6A1AB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddIsometricConnector_TypeDefinitionIndex = 21959;
