...
#define RPG_GAMECORE_ADDISOMETRICCONNECTOR_METHOD_3_13EE773768E6A67D_OFFSET UNITYSDK_OFFSET(0x1863FDB0)
#define RPG_GAMECORE_ADDISOMETRICCONNECTOR_METHOD_3_CD9284761691B76B_OFFSET UNITYSDK_OFFSET(0x1863FC60)
#define RPG_GAMECORE_ADDISOMETRICCONNECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1863FD20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddIsometricConnector_TypeDefinitionIndex = 21078;
