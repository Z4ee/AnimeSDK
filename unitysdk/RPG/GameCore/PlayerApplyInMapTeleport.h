...
#define RPG_GAMECORE_PLAYERAPPLYINMAPTELEPORT_METHOD_3_1A765214F38C830A_OFFSET UNITYSDK_OFFSET(0x1D7AA470)
#define RPG_GAMECORE_PLAYERAPPLYINMAPTELEPORT_METHOD_3_7351301541F5FBA7_OFFSET UNITYSDK_OFFSET(0x1D7AA3A0)
#define RPG_GAMECORE_PLAYERAPPLYINMAPTELEPORT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7AA460)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayerApplyInMapTeleport_TypeDefinitionIndex = 20266;
