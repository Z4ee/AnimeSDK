...
#define RPG_GAMECORE_TRIGGERWAVEPERFORMSTARTSTRING_METHOD_3_20B77C99D6968DF8_OFFSET UNITYSDK_OFFSET(0x178D0D20)
#define RPG_GAMECORE_TRIGGERWAVEPERFORMSTARTSTRING_METHOD_3_AD61A5E150F91E24_OFFSET UNITYSDK_OFFSET(0x178D0E30)
#define RPG_GAMECORE_TRIGGERWAVEPERFORMSTARTSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x178D0E00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerWavePerformStartString_TypeDefinitionIndex = 21628;
