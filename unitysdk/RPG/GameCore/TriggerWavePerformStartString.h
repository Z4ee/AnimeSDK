...
#define RPG_GAMECORE_TRIGGERWAVEPERFORMSTARTSTRING_METHOD_3_4E2A1E2548D507A1_OFFSET UNITYSDK_OFFSET(0x1B062520)
#define RPG_GAMECORE_TRIGGERWAVEPERFORMSTARTSTRING_METHOD_3_AD61A5E150F91E24_OFFSET UNITYSDK_OFFSET(0x1B0625F0)
#define RPG_GAMECORE_TRIGGERWAVEPERFORMSTARTSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0625E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerWavePerformStartString_TypeDefinitionIndex = 22559;
