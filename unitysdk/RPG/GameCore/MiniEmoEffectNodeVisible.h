...
#define RPG_GAMECORE_MINIEMOEFFECTNODEVISIBLE_METHOD_2_00DF941BF7B88851_OFFSET UNITYSDK_OFFSET(0x1D1A4350)
#define RPG_GAMECORE_MINIEMOEFFECTNODEVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1A44B0)
