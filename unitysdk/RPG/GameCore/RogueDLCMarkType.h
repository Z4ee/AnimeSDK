...
#define RPG_GAMECORE_ROGUEDLCMARKTYPE_METHOD_2_D101620D901E7C82_OFFSET UNITYSDK_OFFSET(0x18D0FF40)
#define RPG_GAMECORE_ROGUEDLCMARKTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x18D10060)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueDLCMarkType_TypeDefinitionIndex = 17008;
