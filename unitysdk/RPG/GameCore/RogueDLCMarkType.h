...
#define RPG_GAMECORE_ROGUEDLCMARKTYPE_METHOD_2_D101620D901E7C82_OFFSET UNITYSDK_OFFSET(0x17602C90)
#define RPG_GAMECORE_ROGUEDLCMARKTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x17602DB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueDLCMarkType_TypeDefinitionIndex = 16454;
