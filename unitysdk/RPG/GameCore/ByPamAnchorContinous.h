...
#define RPG_GAMECORE_BYPAMANCHORCONTINOUS_METHOD_4_2B1C9D3AD35BE951_OFFSET UNITYSDK_OFFSET(0x1875C060)
#define RPG_GAMECORE_BYPAMANCHORCONTINOUS_METHOD_4_B61411D24DA6E94B_OFFSET UNITYSDK_OFFSET(0x1875C130)
#define RPG_GAMECORE_BYPAMANCHORCONTINOUS__CTOR_OFFSET UNITYSDK_OFFSET(0x1875C0E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByPamAnchorContinous_TypeDefinitionIndex = 18937;
