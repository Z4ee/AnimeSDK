...
#define RPG_GAMECORE_BYPAMANCHORCONTINOUS_METHOD_4_091955F44F6A0038_OFFSET UNITYSDK_OFFSET(0x1B2B0850)
#define RPG_GAMECORE_BYPAMANCHORCONTINOUS_METHOD_4_B61411D24DA6E94B_OFFSET UNITYSDK_OFFSET(0x1B2B0890)
#define RPG_GAMECORE_BYPAMANCHORCONTINOUS_METHOD_4_CDCFCCC98E039071_OFFSET UNITYSDK_OFFSET(0x1B2B09D0)
#define RPG_GAMECORE_BYPAMANCHORCONTINOUS_METHOD_4_EF7941BB3124AEA8_OFFSET UNITYSDK_OFFSET(0x1B2B0A00)
#define RPG_GAMECORE_BYPAMANCHORCONTINOUS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2B0880)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByPamAnchorContinous_TypeDefinitionIndex = 19241;
