...
#define RPG_GAMECORE_TRIGGERBATTLEPOSTURETYPE_METHOD_3_0FBA642362AF0307_OFFSET UNITYSDK_OFFSET(0x178BF9D0)
#define RPG_GAMECORE_TRIGGERBATTLEPOSTURETYPE_METHOD_3_DE5D45D45A22FEBA_OFFSET UNITYSDK_OFFSET(0x178BF950)
#define RPG_GAMECORE_TRIGGERBATTLEPOSTURETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x178BF9A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerBattlePostureType_TypeDefinitionIndex = 18748;
