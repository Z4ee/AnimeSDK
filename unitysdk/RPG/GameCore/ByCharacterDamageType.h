...
#define RPG_GAMECORE_BYCHARACTERDAMAGETYPE_METHOD_4_1F53F44815CFC985_OFFSET UNITYSDK_OFFSET(0x19CBF9F0)
#define RPG_GAMECORE_BYCHARACTERDAMAGETYPE_METHOD_4_6F85A26FBAD6F09D_OFFSET UNITYSDK_OFFSET(0x19CBFBC0)
#define RPG_GAMECORE_BYCHARACTERDAMAGETYPE_METHOD_4_C142C3FCF8EF9F73_OFFSET UNITYSDK_OFFSET(0x19CBFBF0)
#define RPG_GAMECORE_BYCHARACTERDAMAGETYPE_METHOD_4_D575714E67674880_OFFSET UNITYSDK_OFFSET(0x19CBF9B0)
#define RPG_GAMECORE_BYCHARACTERDAMAGETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x19CBF9E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCharacterDamageType_TypeDefinitionIndex = 19469;
