...
#define RPG_GAMECORE_BYCHARACTERDAMAGETYPE_METHOD_4_1F53F44815CFC985_OFFSET UNITYSDK_OFFSET(0x16FFC130)
#define RPG_GAMECORE_BYCHARACTERDAMAGETYPE_METHOD_4_DD0601D876C2DDD9_OFFSET UNITYSDK_OFFSET(0x16FFC060)
#define RPG_GAMECORE_BYCHARACTERDAMAGETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x16FFC0E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCharacterDamageType_TypeDefinitionIndex = 18534;
