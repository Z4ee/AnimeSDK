...
#define RPG_GAMECORE_FIVEDIMCREATEMASCOTFAKEPLAYERACTION_METHOD_3_DFCF1393B81B3F91_OFFSET UNITYSDK_OFFSET(0x171E64D0)
#define RPG_GAMECORE_FIVEDIMCREATEMASCOTFAKEPLAYERACTION_METHOD_3_F393BB5F3EC5694E_OFFSET UNITYSDK_OFFSET(0x171ED7B0)
#define RPG_GAMECORE_FIVEDIMCREATEMASCOTFAKEPLAYERACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x171E64B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimCreateMascotFakePlayerAction_TypeDefinitionIndex = 17143;
