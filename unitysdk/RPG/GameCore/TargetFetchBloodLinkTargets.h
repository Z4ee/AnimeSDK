...
#define RPG_GAMECORE_TARGETFETCHBLOODLINKTARGETS_METHOD_4_2268F759788FF74B_OFFSET UNITYSDK_OFFSET(0x18EDB900)
#define RPG_GAMECORE_TARGETFETCHBLOODLINKTARGETS_METHOD_4_239A10FDAAAA42B4_OFFSET UNITYSDK_OFFSET(0x18EE3480)
#define RPG_GAMECORE_TARGETFETCHBLOODLINKTARGETS__CTOR_OFFSET UNITYSDK_OFFSET(0x18EDB8B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchBloodLinkTargets_TypeDefinitionIndex = 22927;
