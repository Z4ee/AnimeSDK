...
#define RPG_GAMECORE_TARGETFETCHBLOODLINKTARGETS_METHOD_4_2268F759788FF74B_OFFSET UNITYSDK_OFFSET(0x1D5A99E0)
#define RPG_GAMECORE_TARGETFETCHBLOODLINKTARGETS_METHOD_4_C6D4CC439835ED0E_OFFSET UNITYSDK_OFFSET(0x1D5A9AB0)
#define RPG_GAMECORE_TARGETFETCHBLOODLINKTARGETS_METHOD_4_CCE3E26F0E4D5035_OFFSET UNITYSDK_OFFSET(0x1D5A9A80)
#define RPG_GAMECORE_TARGETFETCHBLOODLINKTARGETS_METHOD_4_DCEB9E4404DE874E_OFFSET UNITYSDK_OFFSET(0x1D5A9920)
#define RPG_GAMECORE_TARGETFETCHBLOODLINKTARGETS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5A99D0)
