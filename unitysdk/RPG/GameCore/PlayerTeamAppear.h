...
#define RPG_GAMECORE_PLAYERTEAMAPPEAR_METHOD_3_6C9F1A862BB8F8CE_OFFSET UNITYSDK_OFFSET(0x174EAC00)
#define RPG_GAMECORE_PLAYERTEAMAPPEAR_METHOD_3_A594AD8C7AC57AFF_OFFSET UNITYSDK_OFFSET(0x174EAC80)
#define RPG_GAMECORE_PLAYERTEAMAPPEAR__CTOR_OFFSET UNITYSDK_OFFSET(0x174EAC50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayerTeamAppear_TypeDefinitionIndex = 21163;
