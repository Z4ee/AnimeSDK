...
#define RPG_GAMECORE_SETLOCALOFFSETASMOVETARGET_METHOD_3_3AA1BDE1669097C4_OFFSET UNITYSDK_OFFSET(0x176D3A00)
#define RPG_GAMECORE_SETLOCALOFFSETASMOVETARGET_METHOD_3_88AA60530F936F8E_OFFSET UNITYSDK_OFFSET(0x176D3A80)
#define RPG_GAMECORE_SETLOCALOFFSETASMOVETARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x176D3A50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetLocalOffsetAsMoveTarget_TypeDefinitionIndex = 20652;
