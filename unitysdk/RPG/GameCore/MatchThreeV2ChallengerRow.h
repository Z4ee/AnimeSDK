...
#define RPG_GAMECORE_MATCHTHREEV2CHALLENGERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D26EC50)
#define RPG_GAMECORE_MATCHTHREEV2CHALLENGERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D26EF60)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 UnlockBattleItem; // 0x30
		::System::UInt32 LevelID; // 0x34
		::RPG::Client::TextID ChallengerDesc; // 0x38
		::System::UInt32 ChallengerID; // 0x48
