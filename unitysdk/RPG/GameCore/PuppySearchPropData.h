...
#define RPG_GAMECORE_PUPPYSEARCHPROPDATA_METHOD_2_F18ED0756F9C8C91_OFFSET UNITYSDK_OFFSET(0x19AA15E0)
#define RPG_GAMECORE_PUPPYSEARCHPROPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19AA1710)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PuppySearchPropData_TypeDefinitionIndex = 16715;
