...
#define RPG_GAMECORE_PUPPYSEARCHPROPDATA_METHOD_2_91678DA9CCF20B26_OFFSET UNITYSDK_OFFSET(0x1B9A8A80)
#define RPG_GAMECORE_PUPPYSEARCHPROPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9A8B80)
