...
#define RPG_GAMECORE_SETFOLLOWLIGHTDEVICEDAMP_METHOD_3_1620026A22D12DC9_OFFSET UNITYSDK_OFFSET(0x1E82C630)
#define RPG_GAMECORE_SETFOLLOWLIGHTDEVICEDAMP_METHOD_3_E448B03A4E847242_OFFSET UNITYSDK_OFFSET(0x1E82C5E0)
#define RPG_GAMECORE_SETFOLLOWLIGHTDEVICEDAMP__CTOR_OFFSET UNITYSDK_OFFSET(0x1E82C620)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetFollowLightDeviceDamp_TypeDefinitionIndex = 22092;
