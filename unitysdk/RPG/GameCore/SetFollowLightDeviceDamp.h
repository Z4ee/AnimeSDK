...
#define RPG_GAMECORE_SETFOLLOWLIGHTDEVICEDAMP_METHOD_3_1620026A22D12DC9_OFFSET UNITYSDK_OFFSET(0x176CF540)
#define RPG_GAMECORE_SETFOLLOWLIGHTDEVICEDAMP_METHOD_3_BEBC71F5A9CFC810_OFFSET UNITYSDK_OFFSET(0x176CF4C0)
#define RPG_GAMECORE_SETFOLLOWLIGHTDEVICEDAMP__CTOR_OFFSET UNITYSDK_OFFSET(0x176CF510)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetFollowLightDeviceDamp_TypeDefinitionIndex = 20536;
