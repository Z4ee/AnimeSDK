...
#define RPG_GAMECORE_SETFOLLOWLIGHTDEVICEDAMP_METHOD_3_1620026A22D12DC9_OFFSET UNITYSDK_OFFSET(0x18E32A80)
#define RPG_GAMECORE_SETFOLLOWLIGHTDEVICEDAMP_METHOD_3_BEBC71F5A9CFC810_OFFSET UNITYSDK_OFFSET(0x18E32A00)
#define RPG_GAMECORE_SETFOLLOWLIGHTDEVICEDAMP__CTOR_OFFSET UNITYSDK_OFFSET(0x18E32A50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetFollowLightDeviceDamp_TypeDefinitionIndex = 21219;
