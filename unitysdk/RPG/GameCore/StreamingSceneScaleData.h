...
#define RPG_GAMECORE_STREAMINGSCENESCALEDATA_METHOD_2_182D027A9B96A9FD_OFFSET UNITYSDK_OFFSET(0x1B41F2C0)
#define RPG_GAMECORE_STREAMINGSCENESCALEDATA_METHOD_2_5CCF310502397610_OFFSET UNITYSDK_OFFSET(0x1B41F220)
#define RPG_GAMECORE_STREAMINGSCENESCALEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B41F2B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StreamingSceneScaleData_TypeDefinitionIndex = 18394;
