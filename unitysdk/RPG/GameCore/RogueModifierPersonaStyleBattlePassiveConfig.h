...
#define RPG_GAMECORE_ROGUEMODIFIERPERSONASTYLEBATTLEPASSIVECONFIG_METHOD_3_38AEEEDB4F24BD34_OFFSET UNITYSDK_OFFSET(0x19B9A7B0)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONASTYLEBATTLEPASSIVECONFIG_METHOD_3_BC6AB1361717DE7D_OFFSET UNITYSDK_OFFSET(0x19B9A6E0)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONASTYLEBATTLEPASSIVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B9A760)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierPersonaStyleBattlePassiveConfig_TypeDefinitionIndex = 16886;
