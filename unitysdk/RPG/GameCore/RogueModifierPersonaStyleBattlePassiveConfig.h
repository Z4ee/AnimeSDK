...
#define RPG_GAMECORE_ROGUEMODIFIERPERSONASTYLEBATTLEPASSIVECONFIG_METHOD_3_38AEEEDB4F24BD34_OFFSET UNITYSDK_OFFSET(0x17637C80)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONASTYLEBATTLEPASSIVECONFIG_METHOD_3_BC6AB1361717DE7D_OFFSET UNITYSDK_OFFSET(0x17637BB0)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONASTYLEBATTLEPASSIVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17637C30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierPersonaStyleBattlePassiveConfig_TypeDefinitionIndex = 16317;
