...
#define RPG_GAMECORE_ROGUEMODIFIERPERSONASTYLEBATTLEPASSIVECONFIG_METHOD_3_38AEEEDB4F24BD34_OFFSET UNITYSDK_OFFSET(0x1D3FB930)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONASTYLEBATTLEPASSIVECONFIG_METHOD_3_9596DA3A01E46AB8_OFFSET UNITYSDK_OFFSET(0x1D3FB8E0)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONASTYLEBATTLEPASSIVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3FB920)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierPersonaStyleBattlePassiveConfig_TypeDefinitionIndex = 17551;
