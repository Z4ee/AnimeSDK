...
#define RPG_GAMECORE_RTBATTLESKILLCONFIG_METHOD_3_092BA7DB2B1F4D98_OFFSET UNITYSDK_OFFSET(0x1D49B510)
#define RPG_GAMECORE_RTBATTLESKILLCONFIG_METHOD_3_735841C3354A9070_OFFSET UNITYSDK_OFFSET(0x1D49B4B0)
#define RPG_GAMECORE_RTBATTLESKILLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D49B500)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtBattleSkillConfig_TypeDefinitionIndex = 17463;
