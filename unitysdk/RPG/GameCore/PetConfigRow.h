...
#define RPG_GAMECORE_PETCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19A00E00)
#define RPG_GAMECORE_PETCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19A01490)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PetConfigRow_TypeDefinitionIndex = 13716;

	class PetConfigRow : public ::System::Object
	{
	public:
		::System::String* UIPetModelPath; // 0x10
		::System::String* UIIdleShow; // 0x18
		::System::String* ManikinJsonPath; // 0x20
		::System::UInt32 SummonUnitID; // 0x28
		::System::UInt32 PetID; // 0x2C
		::System::UInt32 PetItemID; // 0x30
