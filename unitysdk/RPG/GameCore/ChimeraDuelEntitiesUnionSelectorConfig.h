...
#define RPG_GAMECORE_CHIMERADUELENTITIESUNIONSELECTORCONFIG_METHOD_3_3CD06829264B741E_OFFSET UNITYSDK_OFFSET(0x187F9C80)
#define RPG_GAMECORE_CHIMERADUELENTITIESUNIONSELECTORCONFIG_METHOD_3_70275BFB064647A6_OFFSET UNITYSDK_OFFSET(0x187F9C20)
#define RPG_GAMECORE_CHIMERADUELENTITIESUNIONSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x187F9C70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelEntitiesUnionSelectorConfig_TypeDefinitionIndex = 15076;
