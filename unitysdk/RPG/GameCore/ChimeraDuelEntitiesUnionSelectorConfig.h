...
#define RPG_GAMECORE_CHIMERADUELENTITIESUNIONSELECTORCONFIG_METHOD_3_3603613DF33DD3A3_OFFSET UNITYSDK_OFFSET(0x1C395400)
#define RPG_GAMECORE_CHIMERADUELENTITIESUNIONSELECTORCONFIG_METHOD_3_386811AEE2472893_OFFSET UNITYSDK_OFFSET(0x1C395460)
#define RPG_GAMECORE_CHIMERADUELENTITIESUNIONSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C395450)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelEntitiesUnionSelectorConfig_TypeDefinitionIndex = 15303;
