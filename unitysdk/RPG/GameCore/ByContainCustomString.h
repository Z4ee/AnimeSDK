...
#define RPG_GAMECORE_BYCONTAINCUSTOMSTRING_METHOD_4_1542345E285B8BDB_OFFSET UNITYSDK_OFFSET(0x1A8B51F0)
#define RPG_GAMECORE_BYCONTAINCUSTOMSTRING_METHOD_4_41EFD6A9CAFAAF26_OFFSET UNITYSDK_OFFSET(0x1A8B4F00)
#define RPG_GAMECORE_BYCONTAINCUSTOMSTRING_METHOD_4_55FA5F210AC6EC96_OFFSET UNITYSDK_OFFSET(0x1A8B5190)
#define RPG_GAMECORE_BYCONTAINCUSTOMSTRING_METHOD_4_6ADCD44BF1300457_OFFSET UNITYSDK_OFFSET(0x1A8B4FA0)
#define RPG_GAMECORE_BYCONTAINCUSTOMSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8B4F60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByContainCustomString_TypeDefinitionIndex = 22591;
