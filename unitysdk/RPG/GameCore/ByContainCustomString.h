...
#define RPG_GAMECORE_BYCONTAINCUSTOMSTRING_METHOD_4_0DB5927DFECDAAB4_OFFSET UNITYSDK_OFFSET(0x1701D400)
#define RPG_GAMECORE_BYCONTAINCUSTOMSTRING_METHOD_4_6ADCD44BF1300457_OFFSET UNITYSDK_OFFSET(0x1701D520)
#define RPG_GAMECORE_BYCONTAINCUSTOMSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1701D4A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByContainCustomString_TypeDefinitionIndex = 21662;
