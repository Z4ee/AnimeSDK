...
#define RPG_GAMECORE_CHESTGROUPPROPERTYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1708FF00)
#define RPG_GAMECORE_CHESTGROUPPROPERTYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17090140)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChestGroupPropertyRow_TypeDefinitionIndex = 13183;
