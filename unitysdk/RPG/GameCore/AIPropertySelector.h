...
#define RPG_GAMECORE_AIPROPERTYSELECTOR_METHOD_3_4D13533DD3DAA292_OFFSET UNITYSDK_OFFSET(0x16E916F0)
#define RPG_GAMECORE_AIPROPERTYSELECTOR_METHOD_3_FEF67153DF55FDFB_OFFSET UNITYSDK_OFFSET(0x16E91760)
#define RPG_GAMECORE_AIPROPERTYSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x16E91740)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AIPropertySelector_TypeDefinitionIndex = 14290;
