...
#define RPG_GAMECORE_AIPROPERTYSELECTOR_METHOD_3_4D13533DD3DAA292_OFFSET UNITYSDK_OFFSET(0x1CD67030)
#define RPG_GAMECORE_AIPROPERTYSELECTOR_METHOD_3_FEF67153DF55FDFB_OFFSET UNITYSDK_OFFSET(0x1CD670A0)
#define RPG_GAMECORE_AIPROPERTYSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD67080)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AIPropertySelector_TypeDefinitionIndex = 15423;
