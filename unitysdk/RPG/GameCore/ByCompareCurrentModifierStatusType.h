...
#define RPG_GAMECORE_BYCOMPARECURRENTMODIFIERSTATUSTYPE_METHOD_4_0BA604B637879A0A_OFFSET UNITYSDK_OFFSET(0x19CDA080)
#define RPG_GAMECORE_BYCOMPARECURRENTMODIFIERSTATUSTYPE_METHOD_4_10A7E00360129B2D_OFFSET UNITYSDK_OFFSET(0x19CDA0B0)
#define RPG_GAMECORE_BYCOMPARECURRENTMODIFIERSTATUSTYPE_METHOD_4_4B3F51E7B3B0ED1E_OFFSET UNITYSDK_OFFSET(0x19CD9F00)
#define RPG_GAMECORE_BYCOMPARECURRENTMODIFIERSTATUSTYPE_METHOD_4_8BAD87B37D9BB86F_OFFSET UNITYSDK_OFFSET(0x19CD9EC0)
#define RPG_GAMECORE_BYCOMPARECURRENTMODIFIERSTATUSTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x19CD9EF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareCurrentModifierStatusType_TypeDefinitionIndex = 22682;
