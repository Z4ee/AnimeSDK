...
#define RPG_GAMECORE_STARTEFFECTAIM_METHOD_3_4303E76083E6321A_OFFSET UNITYSDK_OFFSET(0x18E9A2F0)
#define RPG_GAMECORE_STARTEFFECTAIM_METHOD_3_F2D1A1C30CFD26AD_OFFSET UNITYSDK_OFFSET(0x18E9A270)
#define RPG_GAMECORE_STARTEFFECTAIM__CTOR_OFFSET UNITYSDK_OFFSET(0x18E9A2C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StartEffectAim_TypeDefinitionIndex = 21332;
