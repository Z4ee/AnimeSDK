...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_SETCONFIRMDICECOUNTTOMODIFIERMAP_METHOD_3_77E76224515F95EF_OFFSET UNITYSDK_OFFSET(0x1C11A040)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_SETCONFIRMDICECOUNTTOMODIFIERMAP_METHOD_3_FC2F814D0928CA11_OFFSET UNITYSDK_OFFSET(0x1C11A0A0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_SETCONFIRMDICECOUNTTOMODIFIERMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1C11A090)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_SetConfirmDiceCountToModifierMap_TypeDefinitionIndex = 15455;
