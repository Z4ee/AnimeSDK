...
#define RPG_GAMECORE_FIVEDIMCAMERAOBSERVECONFIG_METHOD_2_FD7B29C8EF191907_OFFSET UNITYSDK_OFFSET(0x1D0A3BC0)
#define RPG_GAMECORE_FIVEDIMCAMERAOBSERVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0A5110)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimCameraObserveConfig_TypeDefinitionIndex = 18411;
