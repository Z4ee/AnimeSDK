...
#define RPG_GAMECORE_CHANGECHARACTERCONFIGPARAMCLIENTONLY_METHOD_4_427707F2D7B6B1A6_OFFSET UNITYSDK_OFFSET(0x1B718830)
#define RPG_GAMECORE_CHANGECHARACTERCONFIGPARAMCLIENTONLY_METHOD_4_E47A9EF35EBF2EFA_OFFSET UNITYSDK_OFFSET(0x1B718170)
#define RPG_GAMECORE_CHANGECHARACTERCONFIGPARAMCLIENTONLY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7180D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChangeCharacterConfigParamClientOnly_TypeDefinitionIndex = 22830;
