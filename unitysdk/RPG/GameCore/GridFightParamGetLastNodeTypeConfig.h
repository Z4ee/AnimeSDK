...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETLASTNODETYPECONFIG_METHOD_6_7A91878186EE9543_OFFSET UNITYSDK_OFFSET(0x17270FE0)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETLASTNODETYPECONFIG_METHOD_6_FFBE2F5BDFB6498D_OFFSET UNITYSDK_OFFSET(0x17270D30)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETLASTNODETYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17270EB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightParamGetLastNodeTypeConfig_TypeDefinitionIndex = 17911;
