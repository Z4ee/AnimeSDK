...
#define RPG_GAMECORE_BYCOMPAREABILITYPROPERTY_METHOD_4_935D059FB7CE59F7_OFFSET UNITYSDK_OFFSET(0x17001F90)
#define RPG_GAMECORE_BYCOMPAREABILITYPROPERTY_METHOD_4_D8F8A703CD0E5B2B_OFFSET UNITYSDK_OFFSET(0x17001EC0)
#define RPG_GAMECORE_BYCOMPAREABILITYPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x17001F40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareAbilityProperty_TypeDefinitionIndex = 21776;
