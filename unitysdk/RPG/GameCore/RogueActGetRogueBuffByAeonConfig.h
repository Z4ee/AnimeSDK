...
#define RPG_GAMECORE_ROGUEACTGETROGUEBUFFBYAEONCONFIG_METHOD_6_A4C74D7D0945C395_OFFSET UNITYSDK_OFFSET(0x1D02DFD0)
#define RPG_GAMECORE_ROGUEACTGETROGUEBUFFBYAEONCONFIG_METHOD_6_C173D5A4AD5DC971_OFFSET UNITYSDK_OFFSET(0x1D02DF80)
#define RPG_GAMECORE_ROGUEACTGETROGUEBUFFBYAEONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D02DFC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActGetRogueBuffByAeonConfig_TypeDefinitionIndex = 18834;
