...
#define RPG_GAMECORE_ROGUEACTGETROGUEBUFFBYAEONCONFIG_METHOD_6_0C4427C0C0F41B58_OFFSET UNITYSDK_OFFSET(0x175B6480)
#define RPG_GAMECORE_ROGUEACTGETROGUEBUFFBYAEONCONFIG_METHOD_6_A4C74D7D0945C395_OFFSET UNITYSDK_OFFSET(0x175B66A0)
#define RPG_GAMECORE_ROGUEACTGETROGUEBUFFBYAEONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175B65C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActGetRogueBuffByAeonConfig_TypeDefinitionIndex = 17946;
