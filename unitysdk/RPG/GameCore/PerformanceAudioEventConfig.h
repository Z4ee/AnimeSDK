...
#define RPG_GAMECORE_PERFORMANCEAUDIOEVENTCONFIG_METHOD_2_1F3E0846007AA8FE_OFFSET UNITYSDK_OFFSET(0x1D41C340)
#define RPG_GAMECORE_PERFORMANCEAUDIOEVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D41C5C0)
