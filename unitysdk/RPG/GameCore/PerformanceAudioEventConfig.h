...
#define RPG_GAMECORE_PERFORMANCEAUDIOEVENTCONFIG_METHOD_2_1F3E0846007AA8FE_OFFSET UNITYSDK_OFFSET(0x1D313670)
#define RPG_GAMECORE_PERFORMANCEAUDIOEVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3138F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PerformanceAudioEventConfig_TypeDefinitionIndex = 16217;
