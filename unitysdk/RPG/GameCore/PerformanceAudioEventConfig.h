...
#define RPG_GAMECORE_PERFORMANCEAUDIOEVENTCONFIG_METHOD_2_443B9CEB74630587_OFFSET UNITYSDK_OFFSET(0x17491D70)
#define RPG_GAMECORE_PERFORMANCEAUDIOEVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17492050)
