...
#define RPG_GAMECORE_SETDYNAMICVALUEBYHPRATIO_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x19C41DA0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYHPRATIO_METHOD_4_606922BBB8C6C33D_OFFSET UNITYSDK_OFFSET(0x19C41BA0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYHPRATIO_METHOD_4_8A095C1359E986C9_OFFSET UNITYSDK_OFFSET(0x19C3B280)
#define RPG_GAMECORE_SETDYNAMICVALUEBYHPRATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x19C3B230)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByHPRatio_TypeDefinitionIndex = 21833;
