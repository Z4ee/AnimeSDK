...
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_ADDCRITICALHITDAMAGE_METHOD_3_4246F11DC4E533DD_OFFSET UNITYSDK_OFFSET(0x19620260)
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_ADDCRITICALHITDAMAGE_METHOD_3_CBAA596CBBD20B11_OFFSET UNITYSDK_OFFSET(0x19620330)
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_ADDCRITICALHITDAMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x19620320)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleEffect_AddCriticalHitDamage_TypeDefinitionIndex = 15017;
