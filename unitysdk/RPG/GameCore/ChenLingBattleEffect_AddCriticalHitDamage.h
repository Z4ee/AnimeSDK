...
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_ADDCRITICALHITDAMAGE_METHOD_3_4246F11DC4E533DD_OFFSET UNITYSDK_OFFSET(0x1707D740)
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_ADDCRITICALHITDAMAGE_METHOD_3_CBAA596CBBD20B11_OFFSET UNITYSDK_OFFSET(0x1707D810)
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_ADDCRITICALHITDAMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1707D800)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleEffect_AddCriticalHitDamage_TypeDefinitionIndex = 14484;
