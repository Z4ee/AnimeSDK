...
#define RPG_GAMECORE_ST_BYCOMPAREVARIABLEBOOL_METHOD_4_1C327DD7AAE1D8B8_OFFSET UNITYSDK_OFFSET(0x1DB30CF0)
#define RPG_GAMECORE_ST_BYCOMPAREVARIABLEBOOL_METHOD_4_2BD23335713D87CB_OFFSET UNITYSDK_OFFSET(0x1DB30AD0)
#define RPG_GAMECORE_ST_BYCOMPAREVARIABLEBOOL_METHOD_4_333E05635F7611DF_OFFSET UNITYSDK_OFFSET(0x1DB30D20)
#define RPG_GAMECORE_ST_BYCOMPAREVARIABLEBOOL_METHOD_4_C42E74AABA106CBA_OFFSET UNITYSDK_OFFSET(0x1DB30A90)
#define RPG_GAMECORE_ST_BYCOMPAREVARIABLEBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB30AC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_ByCompareVariableBool_TypeDefinitionIndex = 19838;
