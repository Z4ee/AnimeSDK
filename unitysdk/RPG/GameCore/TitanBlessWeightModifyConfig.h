...
#define RPG_GAMECORE_TITANBLESSWEIGHTMODIFYCONFIG_METHOD_2_BB4A684A34FD86D9_OFFSET UNITYSDK_OFFSET(0x19DE8FC0)
#define RPG_GAMECORE_TITANBLESSWEIGHTMODIFYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19DE9000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TitanBlessWeightModifyConfig_TypeDefinitionIndex = 17123;
