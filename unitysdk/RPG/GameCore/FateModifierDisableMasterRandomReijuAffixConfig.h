...
#define RPG_GAMECORE_FATEMODIFIERDISABLEMASTERRANDOMREIJUAFFIXCONFIG_METHOD_3_54A32D02B730B0B4_OFFSET UNITYSDK_OFFSET(0x19710B70)
#define RPG_GAMECORE_FATEMODIFIERDISABLEMASTERRANDOMREIJUAFFIXCONFIG_METHOD_3_D85EEF5D7F23D1FD_OFFSET UNITYSDK_OFFSET(0x197123F0)
#define RPG_GAMECORE_FATEMODIFIERDISABLEMASTERRANDOMREIJUAFFIXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19710B20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateModifierDisableMasterRandomReijuAffixConfig_TypeDefinitionIndex = 18289;
