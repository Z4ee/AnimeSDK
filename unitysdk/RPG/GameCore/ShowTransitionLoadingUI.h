...
#define RPG_GAMECORE_SHOWTRANSITIONLOADINGUI_METHOD_3_7A261972DF2570AE_OFFSET UNITYSDK_OFFSET(0x1D09C0C0)
#define RPG_GAMECORE_SHOWTRANSITIONLOADINGUI_METHOD_3_82D6BCF3FF7C3E6D_OFFSET UNITYSDK_OFFSET(0x1D09C080)
#define RPG_GAMECORE_SHOWTRANSITIONLOADINGUI__CTOR_OFFSET UNITYSDK_OFFSET(0x1D09C0B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowTransitionLoadingUI_TypeDefinitionIndex = 21463;
