...
#define RPG_GAMECORE_SHOWTRANSITIONLOADINGUI_METHOD_3_0C2EC95E666C1B7F_OFFSET UNITYSDK_OFFSET(0x19C84E10)
#define RPG_GAMECORE_SHOWTRANSITIONLOADINGUI_METHOD_3_7A261972DF2570AE_OFFSET UNITYSDK_OFFSET(0x19C84E90)
#define RPG_GAMECORE_SHOWTRANSITIONLOADINGUI__CTOR_OFFSET UNITYSDK_OFFSET(0x19C84E60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowTransitionLoadingUI_TypeDefinitionIndex = 20492;
