...
#define RPG_GAMECORE_FATECONDFALSECONFIG_METHOD_6_7FC60ACD1E8DE5C3_OFFSET UNITYSDK_OFFSET(0x171C4480)
#define RPG_GAMECORE_FATECONDFALSECONFIG_METHOD_6_E786257BAF99B09F_OFFSET UNITYSDK_OFFSET(0x171C42C0)
#define RPG_GAMECORE_FATECONDFALSECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171C43C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateCondFalseConfig_TypeDefinitionIndex = 17674;
