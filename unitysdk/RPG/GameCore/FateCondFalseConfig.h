...
#define RPG_GAMECORE_FATECONDFALSECONFIG_METHOD_6_7FC60ACD1E8DE5C3_OFFSET UNITYSDK_OFFSET(0x188D1C50)
#define RPG_GAMECORE_FATECONDFALSECONFIG_METHOD_6_E786257BAF99B09F_OFFSET UNITYSDK_OFFSET(0x188D1A90)
#define RPG_GAMECORE_FATECONDFALSECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x188D1B90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateCondFalseConfig_TypeDefinitionIndex = 18287;
