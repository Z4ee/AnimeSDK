...
#define RPG_GAMECORE_CHARACTERUICONFIG_METHOD_2_629855A3FC2CBC6B_OFFSET UNITYSDK_OFFSET(0x1E001A30)
#define RPG_GAMECORE_CHARACTERUICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1E001C00)
