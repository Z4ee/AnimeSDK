...
#define RPG_GAMECORE_CHARACTERUICONFIG_METHOD_2_629855A3FC2CBC6B_OFFSET UNITYSDK_OFFSET(0x1960C030)
#define RPG_GAMECORE_CHARACTERUICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19616C40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterUIConfig_TypeDefinitionIndex = 15724;
