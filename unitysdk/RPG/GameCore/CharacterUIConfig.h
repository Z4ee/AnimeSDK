...
#define RPG_GAMECORE_CHARACTERUICONFIG_METHOD_2_629855A3FC2CBC6B_OFFSET UNITYSDK_OFFSET(0x1B721F80)
#define RPG_GAMECORE_CHARACTERUICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B72C690)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterUIConfig_TypeDefinitionIndex = 15898;
