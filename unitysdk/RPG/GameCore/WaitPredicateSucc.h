...
#define RPG_GAMECORE_WAITPREDICATESUCC_METHOD_3_69022AAB0E332A77_OFFSET UNITYSDK_OFFSET(0x19104680)
#define RPG_GAMECORE_WAITPREDICATESUCC_METHOD_3_A22805024C2A7E40_OFFSET UNITYSDK_OFFSET(0x19104610)
#define RPG_GAMECORE_WAITPREDICATESUCC__CTOR_OFFSET UNITYSDK_OFFSET(0x19104650)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitPredicateSucc_TypeDefinitionIndex = 20946;
