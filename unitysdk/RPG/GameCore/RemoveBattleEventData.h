...
#define RPG_GAMECORE_REMOVEBATTLEEVENTDATA_METHOD_3_194C2DE62E201E11_OFFSET UNITYSDK_OFFSET(0x1B9CE6B0)
#define RPG_GAMECORE_REMOVEBATTLEEVENTDATA_METHOD_3_8D6EAEFCF637E8AD_OFFSET UNITYSDK_OFFSET(0x1B9CE660)
#define RPG_GAMECORE_REMOVEBATTLEEVENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9CE6A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveBattleEventData_TypeDefinitionIndex = 20874;
