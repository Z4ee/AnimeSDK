...
#define RPG_GAMECORE_ADVENTUREBYCOMPARESPRATIO_METHOD_4_24A7BED2FFD833F1_OFFSET UNITYSDK_OFFSET(0x16F4C050)
#define RPG_GAMECORE_ADVENTUREBYCOMPARESPRATIO_METHOD_4_D5013A9698542689_OFFSET UNITYSDK_OFFSET(0x16F4C170)
#define RPG_GAMECORE_ADVENTUREBYCOMPARESPRATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x16F4C0F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureByCompareSPRatio_TypeDefinitionIndex = 19098;
