...
#define RPG_GAMECORE_ADVENTUREBYCOMPARESPRATIO_METHOD_4_0C3F51E86EB65D82_OFFSET UNITYSDK_OFFSET(0x1CBAA290)
#define RPG_GAMECORE_ADVENTUREBYCOMPARESPRATIO_METHOD_4_437C0ACB387FCE3C_OFFSET UNITYSDK_OFFSET(0x1CBAA5C0)
#define RPG_GAMECORE_ADVENTUREBYCOMPARESPRATIO_METHOD_4_BB3837BBB2DF0C31_OFFSET UNITYSDK_OFFSET(0x1CBAA550)
#define RPG_GAMECORE_ADVENTUREBYCOMPARESPRATIO_METHOD_4_D5013A9698542689_OFFSET UNITYSDK_OFFSET(0x1CBAA340)
#define RPG_GAMECORE_ADVENTUREBYCOMPARESPRATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x1CBAA300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureByCompareSPRatio_TypeDefinitionIndex = 20539;
