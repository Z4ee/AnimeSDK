...
#define RPG_GAMECORE_ABORTINSERTABILITY_METHOD_3_51D2CEF4BEC7FE99_OFFSET UNITYSDK_OFFSET(0x185F57E0)
#define RPG_GAMECORE_ABORTINSERTABILITY_METHOD_3_FEAFAFB3463B1D55_OFFSET UNITYSDK_OFFSET(0x185F5860)
#define RPG_GAMECORE_ABORTINSERTABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x185F5830)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AbortInsertAbility_TypeDefinitionIndex = 21559;
