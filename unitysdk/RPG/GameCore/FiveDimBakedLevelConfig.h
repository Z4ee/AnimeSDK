...
#define RPG_GAMECORE_FIVEDIMBAKEDLEVELCONFIG_METHOD_2_D7A4FCA0587A890A_OFFSET UNITYSDK_OFFSET(0x1D0A2310)
#define RPG_GAMECORE_FIVEDIMBAKEDLEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0A26B0)
