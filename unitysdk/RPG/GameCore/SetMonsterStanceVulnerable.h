...
#define RPG_GAMECORE_SETMONSTERSTANCEVULNERABLE_METHOD_3_713878F949729CC6_OFFSET UNITYSDK_OFFSET(0x18E3BD40)
#define RPG_GAMECORE_SETMONSTERSTANCEVULNERABLE_METHOD_3_AD4F4DF77D354890_OFFSET UNITYSDK_OFFSET(0x18E3BDC0)
#define RPG_GAMECORE_SETMONSTERSTANCEVULNERABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E3BD90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetMonsterStanceVulnerable_TypeDefinitionIndex = 21861;
