...
#define RPG_GAMECORE_DISABLEROGUETITANBLESS_METHOD_3_467ADD47683D3CF8_OFFSET UNITYSDK_OFFSET(0x17172F60)
#define RPG_GAMECORE_DISABLEROGUETITANBLESS_METHOD_3_E6B810BACE9EB6B1_OFFSET UNITYSDK_OFFSET(0x17172EE0)
#define RPG_GAMECORE_DISABLEROGUETITANBLESS__CTOR_OFFSET UNITYSDK_OFFSET(0x17172F30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DisableRogueTitanBless_TypeDefinitionIndex = 21335;
