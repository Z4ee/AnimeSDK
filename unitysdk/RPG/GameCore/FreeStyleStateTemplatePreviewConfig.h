...
#define RPG_GAMECORE_FREESTYLESTATETEMPLATEPREVIEWCONFIG_METHOD_2_E8945F9E54EC3410_OFFSET UNITYSDK_OFFSET(0x17220EB0)
#define RPG_GAMECORE_FREESTYLESTATETEMPLATEPREVIEWCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17220EF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FreeStyleStateTemplatePreviewConfig_TypeDefinitionIndex = 14933;
