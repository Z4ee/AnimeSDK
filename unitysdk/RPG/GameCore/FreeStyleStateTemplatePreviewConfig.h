...
#define RPG_GAMECORE_FREESTYLESTATETEMPLATEPREVIEWCONFIG_METHOD_2_E8945F9E54EC3410_OFFSET UNITYSDK_OFFSET(0x1976E7A0)
#define RPG_GAMECORE_FREESTYLESTATETEMPLATEPREVIEWCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1976E7E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FreeStyleStateTemplatePreviewConfig_TypeDefinitionIndex = 15503;
