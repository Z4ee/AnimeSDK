...
#define RPG_GAMECORE_FREESTYLESTATETEMPLATEPREVIEWCONFIG_METHOD_2_E8945F9E54EC3410_OFFSET UNITYSDK_OFFSET(0x18933640)
#define RPG_GAMECORE_FREESTYLESTATETEMPLATEPREVIEWCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18933680)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FreeStyleStateTemplatePreviewConfig_TypeDefinitionIndex = 15440;
