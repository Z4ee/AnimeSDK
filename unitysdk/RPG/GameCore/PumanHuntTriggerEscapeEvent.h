...
#define RPG_GAMECORE_PUMANHUNTTRIGGERESCAPEEVENT_METHOD_3_F03DC8D259D9A2FE_OFFSET UNITYSDK_OFFSET(0x17573C90)
#define RPG_GAMECORE_PUMANHUNTTRIGGERESCAPEEVENT_METHOD_3_F98420EACE63A7EA_OFFSET UNITYSDK_OFFSET(0x17573DA0)
#define RPG_GAMECORE_PUMANHUNTTRIGGERESCAPEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x17573D70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PumanHuntTriggerEscapeEvent_TypeDefinitionIndex = 18516;
