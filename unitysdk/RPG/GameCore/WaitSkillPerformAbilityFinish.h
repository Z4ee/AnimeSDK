...
#define RPG_GAMECORE_WAITSKILLPERFORMABILITYFINISH_METHOD_3_1ECBC3CF1E96D587_OFFSET UNITYSDK_OFFSET(0x17905230)
#define RPG_GAMECORE_WAITSKILLPERFORMABILITYFINISH_METHOD_3_D7A604E2D55CB2FB_OFFSET UNITYSDK_OFFSET(0x17905340)
#define RPG_GAMECORE_WAITSKILLPERFORMABILITYFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x17905310)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitSkillPerformAbilityFinish_TypeDefinitionIndex = 20873;
