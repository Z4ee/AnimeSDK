...
#define RPG_GAMECORE_WAITSKILLPERFORMABILITYFINISH_METHOD_3_D7A604E2D55CB2FB_OFFSET UNITYSDK_OFFSET(0x1D1BCDB0)
#define RPG_GAMECORE_WAITSKILLPERFORMABILITYFINISH_METHOD_3_F9CE2F29AAAE78FE_OFFSET UNITYSDK_OFFSET(0x1D1BCCE0)
#define RPG_GAMECORE_WAITSKILLPERFORMABILITYFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1BCDA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitSkillPerformAbilityFinish_TypeDefinitionIndex = 21869;
