...
#define RPG_GAMECORE_SHOWTALKUI_METHOD_3_4756236345D07731_OFFSET UNITYSDK_OFFSET(0x17705070)
#define RPG_GAMECORE_SHOWTALKUI_METHOD_3_DAA8D128D0A9F768_OFFSET UNITYSDK_OFFSET(0x177050F0)
#define RPG_GAMECORE_SHOWTALKUI__CTOR_OFFSET UNITYSDK_OFFSET(0x177050C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowTalkUI_TypeDefinitionIndex = 19164;
