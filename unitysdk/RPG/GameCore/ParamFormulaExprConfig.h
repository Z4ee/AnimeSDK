...
#define RPG_GAMECORE_PARAMFORMULAEXPRCONFIG_METHOD_4_68E58D600870F792_OFFSET UNITYSDK_OFFSET(0x1BB0DBF0)
#define RPG_GAMECORE_PARAMFORMULAEXPRCONFIG_METHOD_4_872D1353976E3613_OFFSET UNITYSDK_OFFSET(0x1BB0DB90)
#define RPG_GAMECORE_PARAMFORMULAEXPRCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB0DBE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ParamFormulaExprConfig_TypeDefinitionIndex = 16407;
