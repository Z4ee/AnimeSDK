...
#define RPG_GAMECORE_FIVEDIMMOVEPARAMMODIFIERFLOAT_METHOD_3_0C77DB5917BF430F_OFFSET UNITYSDK_OFFSET(0x171FEA70)
#define RPG_GAMECORE_FIVEDIMMOVEPARAMMODIFIERFLOAT_METHOD_3_A0974BDDDB2CD09E_OFFSET UNITYSDK_OFFSET(0x171FEA00)
#define RPG_GAMECORE_FIVEDIMMOVEPARAMMODIFIERFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x171FEA50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimMoveParamModifierFloat_TypeDefinitionIndex = 17023;
