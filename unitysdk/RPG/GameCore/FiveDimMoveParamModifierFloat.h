...
#define RPG_GAMECORE_FIVEDIMMOVEPARAMMODIFIERFLOAT_METHOD_3_0C77DB5917BF430F_OFFSET UNITYSDK_OFFSET(0x1974A4F0)
#define RPG_GAMECORE_FIVEDIMMOVEPARAMMODIFIERFLOAT_METHOD_3_A0974BDDDB2CD09E_OFFSET UNITYSDK_OFFSET(0x1974A480)
#define RPG_GAMECORE_FIVEDIMMOVEPARAMMODIFIERFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1974A4D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimMoveParamModifierFloat_TypeDefinitionIndex = 17643;
