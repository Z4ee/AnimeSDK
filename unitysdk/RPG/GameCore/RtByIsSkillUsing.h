...
#define RPG_GAMECORE_RTBYISSKILLUSING_METHOD_4_33034D1BEA687950_OFFSET UNITYSDK_OFFSET(0x1BB8FF70)
#define RPG_GAMECORE_RTBYISSKILLUSING_METHOD_4_62BA27A72D1A09E5_OFFSET UNITYSDK_OFFSET(0x1BB8FF30)
#define RPG_GAMECORE_RTBYISSKILLUSING_METHOD_4_B0AC0D5C4C815C60_OFFSET UNITYSDK_OFFSET(0x1BB900F0)
#define RPG_GAMECORE_RTBYISSKILLUSING_METHOD_4_E4429D07D0D35F2E_OFFSET UNITYSDK_OFFSET(0x1BB90120)
#define RPG_GAMECORE_RTBYISSKILLUSING__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB8FF60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtByIsSkillUsing_TypeDefinitionIndex = 23375;
