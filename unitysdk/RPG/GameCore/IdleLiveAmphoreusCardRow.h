...
#define RPG_GAMECORE_IDLELIVEAMPHOREUSCARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B692000)
#define RPG_GAMECORE_IDLELIVEAMPHOREUSCARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B692400)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 TriggerNode; // 0x48
