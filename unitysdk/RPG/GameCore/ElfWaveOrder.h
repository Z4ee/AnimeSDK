...
#define RPG_GAMECORE_ELFWAVEORDER_METHOD_2_3516F600CFD2FDC1_OFFSET UNITYSDK_OFFSET(0x188A01A0)
#define RPG_GAMECORE_ELFWAVEORDER__CTOR_OFFSET UNITYSDK_OFFSET(0x188A0280)
