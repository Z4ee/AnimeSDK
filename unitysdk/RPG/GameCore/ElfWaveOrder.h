...
#define RPG_GAMECORE_ELFWAVEORDER_METHOD_2_3516F600CFD2FDC1_OFFSET UNITYSDK_OFFSET(0x17192A70)
#define RPG_GAMECORE_ELFWAVEORDER__CTOR_OFFSET UNITYSDK_OFFSET(0x17192B50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfWaveOrder_TypeDefinitionIndex = 16971;
