...
#define RPG_GAMECORE_ST_ELFBYISTAKEOUTSTATE_METHOD_4_5988BAF5157DD7AF_OFFSET UNITYSDK_OFFSET(0x18DEEEA0)
#define RPG_GAMECORE_ST_ELFBYISTAKEOUTSTATE_METHOD_4_7AF2C8EF441224C1_OFFSET UNITYSDK_OFFSET(0x18DEEDD0)
#define RPG_GAMECORE_ST_ELFBYISTAKEOUTSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18DEEE50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_ElfByIsTakeOutState_TypeDefinitionIndex = 20404;
