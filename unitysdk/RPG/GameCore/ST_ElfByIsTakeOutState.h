...
#define RPG_GAMECORE_ST_ELFBYISTAKEOUTSTATE_METHOD_4_5988BAF5157DD7AF_OFFSET UNITYSDK_OFFSET(0x1B7804A0)
#define RPG_GAMECORE_ST_ELFBYISTAKEOUTSTATE_METHOD_4_A005444ED608D692_OFFSET UNITYSDK_OFFSET(0x1B780650)
#define RPG_GAMECORE_ST_ELFBYISTAKEOUTSTATE_METHOD_4_A6B69EA603A02AE5_OFFSET UNITYSDK_OFFSET(0x1B780680)
#define RPG_GAMECORE_ST_ELFBYISTAKEOUTSTATE_METHOD_4_E1CF2C68C64CB2AE_OFFSET UNITYSDK_OFFSET(0x1B780460)
#define RPG_GAMECORE_ST_ELFBYISTAKEOUTSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B780490)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_ElfByIsTakeOutState_TypeDefinitionIndex = 20743;
