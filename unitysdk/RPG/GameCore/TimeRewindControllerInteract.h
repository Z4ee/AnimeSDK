...
#define RPG_GAMECORE_TIMEREWINDCONTROLLERINTERACT_METHOD_3_7BCD50ADE4A43EB2_OFFSET UNITYSDK_OFFSET(0x1D5279E0)
#define RPG_GAMECORE_TIMEREWINDCONTROLLERINTERACT_METHOD_3_EB8AB12E7EB7DF2F_OFFSET UNITYSDK_OFFSET(0x1D527AB0)
#define RPG_GAMECORE_TIMEREWINDCONTROLLERINTERACT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D527AA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TimeRewindControllerInteract_TypeDefinitionIndex = 20413;
