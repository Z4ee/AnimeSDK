...
#define RPG_GAMECORE_TIMEREWINDCONTROLLERINTERACT_METHOD_3_29D5FFFB74B07D3B_OFFSET UNITYSDK_OFFSET(0x19DE5D10)
#define RPG_GAMECORE_TIMEREWINDCONTROLLERINTERACT_METHOD_3_EB8AB12E7EB7DF2F_OFFSET UNITYSDK_OFFSET(0x19DE5E20)
#define RPG_GAMECORE_TIMEREWINDCONTROLLERINTERACT__CTOR_OFFSET UNITYSDK_OFFSET(0x19DE5DF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TimeRewindControllerInteract_TypeDefinitionIndex = 19509;
