...
#define RPG_GAMECORE_CAKERACEMOVECONFIG_METHOD_2_122FA0AB612CB667_OFFSET UNITYSDK_OFFSET(0x18772F50)
#define RPG_GAMECORE_CAKERACEMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x187730B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceMoveConfig_TypeDefinitionIndex = 17504;
