...
#define RPG_GAMECORE_CAKERACEMOVECONFIG_METHOD_2_122FA0AB612CB667_OFFSET UNITYSDK_OFFSET(0x1704D290)
#define RPG_GAMECORE_CAKERACEMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1704D3F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceMoveConfig_TypeDefinitionIndex = 16910;
