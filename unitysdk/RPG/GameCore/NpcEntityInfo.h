...
#define RPG_GAMECORE_NPCENTITYINFO_METHOD_3_7FD0878B44A9B0D9_OFFSET UNITYSDK_OFFSET(0x17476770)
#define RPG_GAMECORE_NPCENTITYINFO_METHOD_3_91ED8B6831B6AF21_OFFSET UNITYSDK_OFFSET(0x17476710)
#define RPG_GAMECORE_NPCENTITYINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x17476760)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NpcEntityInfo_TypeDefinitionIndex = 18573;
