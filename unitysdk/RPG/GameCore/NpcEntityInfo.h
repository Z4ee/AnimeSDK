...
#define RPG_GAMECORE_NPCENTITYINFO_METHOD_3_7FD0878B44A9B0D9_OFFSET UNITYSDK_OFFSET(0x18BBFD10)
#define RPG_GAMECORE_NPCENTITYINFO_METHOD_3_91ED8B6831B6AF21_OFFSET UNITYSDK_OFFSET(0x18BBFCB0)
#define RPG_GAMECORE_NPCENTITYINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18BBFD00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NpcEntityInfo_TypeDefinitionIndex = 19228;
