...
#define RPG_GAMECORE_NPCENTITYINFO_METHOD_3_7FD0878B44A9B0D9_OFFSET UNITYSDK_OFFSET(0x1BAFBAD0)
#define RPG_GAMECORE_NPCENTITYINFO_METHOD_3_91ED8B6831B6AF21_OFFSET UNITYSDK_OFFSET(0x1BAFBA70)
#define RPG_GAMECORE_NPCENTITYINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAFBAC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NpcEntityInfo_TypeDefinitionIndex = 19505;
