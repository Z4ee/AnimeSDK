...
#define RPG_GAMECORE_ADVFLOATVALUETICKTYPE_LOOP_METHOD_3_4BA5FD92D739C215_OFFSET UNITYSDK_OFFSET(0x1D6B80C0)
#define RPG_GAMECORE_ADVFLOATVALUETICKTYPE_LOOP_METHOD_3_B18473434E8F8E70_OFFSET UNITYSDK_OFFSET(0x1D6B8900)
#define RPG_GAMECORE_ADVFLOATVALUETICKTYPE_LOOP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6B80B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvFloatValueTickType_Loop_TypeDefinitionIndex = 20783;
