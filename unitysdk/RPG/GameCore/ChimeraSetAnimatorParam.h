...
#define RPG_GAMECORE_CHIMERASETANIMATORPARAM_METHOD_3_0FC85A3E4FA76AD5_OFFSET UNITYSDK_OFFSET(0x18809BB0)
#define RPG_GAMECORE_CHIMERASETANIMATORPARAM_METHOD_3_A09047462D543A43_OFFSET UNITYSDK_OFFSET(0x18809B50)
#define RPG_GAMECORE_CHIMERASETANIMATORPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x18809BA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraSetAnimatorParam_TypeDefinitionIndex = 15034;
