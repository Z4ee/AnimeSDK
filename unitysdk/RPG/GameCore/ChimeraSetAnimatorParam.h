...
#define RPG_GAMECORE_CHIMERASETANIMATORPARAM_METHOD_3_0FC85A3E4FA76AD5_OFFSET UNITYSDK_OFFSET(0x170AA600)
#define RPG_GAMECORE_CHIMERASETANIMATORPARAM_METHOD_3_A09047462D543A43_OFFSET UNITYSDK_OFFSET(0x170AA5A0)
#define RPG_GAMECORE_CHIMERASETANIMATORPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x170AA5F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraSetAnimatorParam_TypeDefinitionIndex = 14564;
