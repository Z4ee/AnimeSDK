...
#define RPG_GAMECORE_ROGUEMODIFIERREPAIRMIRACLEAFTERDESTROYCONFIG_METHOD_3_79380190B726AE28_OFFSET UNITYSDK_OFFSET(0x17638000)
#define RPG_GAMECORE_ROGUEMODIFIERREPAIRMIRACLEAFTERDESTROYCONFIG_METHOD_3_A336D933836ACD11_OFFSET UNITYSDK_OFFSET(0x17637F30)
#define RPG_GAMECORE_ROGUEMODIFIERREPAIRMIRACLEAFTERDESTROYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17637FB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierRepairMiracleAfterDestroyConfig_TypeDefinitionIndex = 16533;
