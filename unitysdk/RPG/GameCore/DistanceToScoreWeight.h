...
#define RPG_GAMECORE_DISTANCETOSCOREWEIGHT_METHOD_2_DCCA9A50A79C7BA5_OFFSET UNITYSDK_OFFSET(0x1BB197E0)
#define RPG_GAMECORE_DISTANCETOSCOREWEIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB198F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DistanceToScoreWeight_TypeDefinitionIndex = 15026;
