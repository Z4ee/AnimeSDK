...
#define RPG_GAMECORE_DISTANCETOSCOREWEIGHT_METHOD_2_DCCA9A50A79C7BA5_OFFSET UNITYSDK_OFFSET(0x18880BD0)
#define RPG_GAMECORE_DISTANCETOSCOREWEIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x18880CE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DistanceToScoreWeight_TypeDefinitionIndex = 14800;
