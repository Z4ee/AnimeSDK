...
#define RPG_GAMECORE_CHIMERADUELSHOPEFFECTTARGETSSELECTORCONFIG_METHOD_3_6171872B526F3A43_OFFSET UNITYSDK_OFFSET(0x1CFCE8E0)
#define RPG_GAMECORE_CHIMERADUELSHOPEFFECTTARGETSSELECTORCONFIG_METHOD_3_C77A666CCB152FC2_OFFSET UNITYSDK_OFFSET(0x1CFCE840)
#define RPG_GAMECORE_CHIMERADUELSHOPEFFECTTARGETSSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFCE8D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelShopEffectTargetsSelectorConfig_TypeDefinitionIndex = 15739;
