...
#define RPG_GAMECORE_CHIMERADUELSHOPEFFECTTARGETSSELECTORCONFIG_METHOD_3_6171872B526F3A43_OFFSET UNITYSDK_OFFSET(0x19646870)
#define RPG_GAMECORE_CHIMERADUELSHOPEFFECTTARGETSSELECTORCONFIG_METHOD_3_C77A666CCB152FC2_OFFSET UNITYSDK_OFFSET(0x196467D0)
#define RPG_GAMECORE_CHIMERADUELSHOPEFFECTTARGETSSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19646860)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelShopEffectTargetsSelectorConfig_TypeDefinitionIndex = 15138;
