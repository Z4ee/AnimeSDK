...
#define RPG_GAMECORE_ADVTRACKNPCLOCKALERT_METHOD_3_270D8865533E308D_OFFSET UNITYSDK_OFFSET(0x186673D0)
#define RPG_GAMECORE_ADVTRACKNPCLOCKALERT_METHOD_3_70E1801445196219_OFFSET UNITYSDK_OFFSET(0x186672C0)
#define RPG_GAMECORE_ADVTRACKNPCLOCKALERT__CTOR_OFFSET UNITYSDK_OFFSET(0x186673A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvTrackNpcLockAlert_TypeDefinitionIndex = 21057;
