...
#define RPG_GAMECORE_ADVTRACKNPCLOCKALERT_METHOD_3_270D8865533E308D_OFFSET UNITYSDK_OFFSET(0x1AE48C00)
#define RPG_GAMECORE_ADVTRACKNPCLOCKALERT_METHOD_3_7618B718EB0A65D0_OFFSET UNITYSDK_OFFSET(0x1AE48B30)
#define RPG_GAMECORE_ADVTRACKNPCLOCKALERT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE48BF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvTrackNpcLockAlert_TypeDefinitionIndex = 21380;
