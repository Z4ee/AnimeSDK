...
#define RPG_GAMECORE_MARBLESEALLEVELCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x173984F0)
#define RPG_GAMECORE_MARBLESEALLEVELCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x173987E0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID LevelUpTitle; // 0x20
