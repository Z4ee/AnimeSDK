...
#define RPG_GAMECORE_RESETALLPUZZLESTATESCLIENTONLY_METHOD_3_07B8DD014FCD9563_OFFSET UNITYSDK_OFFSET(0x1D3A3B50)
#define RPG_GAMECORE_RESETALLPUZZLESTATESCLIENTONLY_METHOD_3_964181E194A94DD6_OFFSET UNITYSDK_OFFSET(0x1D3A3B90)
#define RPG_GAMECORE_RESETALLPUZZLESTATESCLIENTONLY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3A3B80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetAllPuzzleStatesClientOnly_TypeDefinitionIndex = 20960;
