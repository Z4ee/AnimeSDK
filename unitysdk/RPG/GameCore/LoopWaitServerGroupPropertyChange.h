...
#define RPG_GAMECORE_LOOPWAITSERVERGROUPPROPERTYCHANGE_METHOD_3_67604A541838EFF1_OFFSET UNITYSDK_OFFSET(0x18A7EEA0)
#define RPG_GAMECORE_LOOPWAITSERVERGROUPPROPERTYCHANGE_METHOD_3_8B0B849A61AA5001_OFFSET UNITYSDK_OFFSET(0x18A7EE10)
#define RPG_GAMECORE_LOOPWAITSERVERGROUPPROPERTYCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x18A7EE70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoopWaitServerGroupPropertyChange_TypeDefinitionIndex = 20155;
