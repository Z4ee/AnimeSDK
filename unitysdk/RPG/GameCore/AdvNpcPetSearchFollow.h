...
#define RPG_GAMECORE_ADVNPCPETSEARCHFOLLOW_METHOD_3_6F0A730AFC6F7736_OFFSET UNITYSDK_OFFSET(0x1BE26340)
#define RPG_GAMECORE_ADVNPCPETSEARCHFOLLOW_METHOD_3_C55CF28F3D268973_OFFSET UNITYSDK_OFFSET(0x1BE26410)
#define RPG_GAMECORE_ADVNPCPETSEARCHFOLLOW__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE26400)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvNpcPetSearchFollow_TypeDefinitionIndex = 19216;
