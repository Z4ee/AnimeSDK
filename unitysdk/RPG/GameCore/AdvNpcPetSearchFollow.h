...
#define RPG_GAMECORE_ADVNPCPETSEARCHFOLLOW_METHOD_3_C55CF28F3D268973_OFFSET UNITYSDK_OFFSET(0x1865B600)
#define RPG_GAMECORE_ADVNPCPETSEARCHFOLLOW_METHOD_3_C9B95E2AFC88E81F_OFFSET UNITYSDK_OFFSET(0x1865B4F0)
#define RPG_GAMECORE_ADVNPCPETSEARCHFOLLOW__CTOR_OFFSET UNITYSDK_OFFSET(0x1865B5D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvNpcPetSearchFollow_TypeDefinitionIndex = 18910;
