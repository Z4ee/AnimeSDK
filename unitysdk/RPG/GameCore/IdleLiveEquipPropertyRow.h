...
#define RPG_GAMECORE_IDLELIVEEQUIPPROPERTYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D20FD20)
#define RPG_GAMECORE_IDLELIVEEQUIPPROPERTYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2101E0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::FixPoint RarityParam; // 0x18
		::RPG::GameCore::FixPoint BasicParam; // 0x20
		::System::UInt32 OffsetQuantizeCount; // 0x28
		::System::Boolean IsRare; // 0x2C
		::System::UInt32 ID; // 0x30
		::RPG::GameCore::IdleLiveAvatarPropertyType PropertyType; // 0x34
		::RPG::GameCore::FixPoint OffsetRange; // 0x38
