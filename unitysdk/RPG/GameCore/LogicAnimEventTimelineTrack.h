...
#define RPG_GAMECORE_LOGICANIMEVENTTIMELINETRACK_METHOD_2_6AB470FED6114195_OFFSET UNITYSDK_OFFSET(0x1BCD2170)
#define RPG_GAMECORE_LOGICANIMEVENTTIMELINETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCD21B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LogicAnimEventTimelineTrack_TypeDefinitionIndex = 15654;
