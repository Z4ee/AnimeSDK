...
#define RPG_GAMECORE_LOGICANIMEVENTTIMELINETRACK_METHOD_2_6AB470FED6114195_OFFSET UNITYSDK_OFFSET(0x198AF310)
#define RPG_GAMECORE_LOGICANIMEVENTTIMELINETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x198AF350)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LogicAnimEventTimelineTrack_TypeDefinitionIndex = 15483;
