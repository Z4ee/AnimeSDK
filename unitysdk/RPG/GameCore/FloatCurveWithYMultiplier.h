...
#define RPG_GAMECORE_FLOATCURVEWITHYMULTIPLIER_METHOD_2_32B91A6B07FC6A7C_OFFSET UNITYSDK_OFFSET(0x1DCAC640)
#define RPG_GAMECORE_FLOATCURVEWITHYMULTIPLIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCAC720)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FloatCurveWithYMultiplier_TypeDefinitionIndex = 16473;
