...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSHOPUPROLEWEIGHTCONFIG_METHOD_3_5C2DB66A129F57EF_OFFSET UNITYSDK_OFFSET(0x1D06B2E0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSHOPUPROLEWEIGHTCONFIG_METHOD_3_A5CBDBAFD298BEB3_OFFSET UNITYSDK_OFFSET(0x1D06B330)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSHOPUPROLEWEIGHTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D06B320)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierShopUpRoleWeightConfig_TypeDefinitionIndex = 18601;
