...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSHOPUPROLEWEIGHTCONFIG_METHOD_3_A5CBDBAFD298BEB3_OFFSET UNITYSDK_OFFSET(0x189BFF40)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSHOPUPROLEWEIGHTCONFIG_METHOD_3_BB9DA511087F0EFA_OFFSET UNITYSDK_OFFSET(0x189BFE70)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSHOPUPROLEWEIGHTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189BFEF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierShopUpRoleWeightConfig_TypeDefinitionIndex = 18385;
