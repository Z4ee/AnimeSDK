...
#define RPG_GAMECORE_ROGUEACTCOMPOSEROGUEMIRACLECONFIG_METHOD_6_8603599A22677009_OFFSET UNITYSDK_OFFSET(0x1D02D910)
#define RPG_GAMECORE_ROGUEACTCOMPOSEROGUEMIRACLECONFIG_METHOD_6_E8AD5CB2D55BE685_OFFSET UNITYSDK_OFFSET(0x1D02D8C0)
#define RPG_GAMECORE_ROGUEACTCOMPOSEROGUEMIRACLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D02D900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActComposeRogueMiracleConfig_TypeDefinitionIndex = 18910;
