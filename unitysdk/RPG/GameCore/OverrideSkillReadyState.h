...
#define RPG_GAMECORE_OVERRIDESKILLREADYSTATE_METHOD_3_672E2314677DD402_OFFSET UNITYSDK_OFFSET(0x1BB09130)
#define RPG_GAMECORE_OVERRIDESKILLREADYSTATE_METHOD_3_AC97774FB7ADC773_OFFSET UNITYSDK_OFFSET(0x1BB09170)
#define RPG_GAMECORE_OVERRIDESKILLREADYSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB09160)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OverrideSkillReadyState_TypeDefinitionIndex = 22016;
