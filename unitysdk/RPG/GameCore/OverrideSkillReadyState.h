...
#define RPG_GAMECORE_OVERRIDESKILLREADYSTATE_METHOD_3_AC97774FB7ADC773_OFFSET UNITYSDK_OFFSET(0x18BCDCD0)
#define RPG_GAMECORE_OVERRIDESKILLREADYSTATE_METHOD_3_B1DB9C67C4B22D60_OFFSET UNITYSDK_OFFSET(0x18BCDC50)
#define RPG_GAMECORE_OVERRIDESKILLREADYSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18BCDCA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OverrideSkillReadyState_TypeDefinitionIndex = 21750;
