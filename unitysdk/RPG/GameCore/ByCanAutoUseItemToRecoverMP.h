...
#define RPG_GAMECORE_BYCANAUTOUSEITEMTORECOVERMP_METHOD_4_136389DBE8071417_OFFSET UNITYSDK_OFFSET(0x19CBEF30)
#define RPG_GAMECORE_BYCANAUTOUSEITEMTORECOVERMP_METHOD_4_543B12DFF3941E7D_OFFSET UNITYSDK_OFFSET(0x19CBF070)
#define RPG_GAMECORE_BYCANAUTOUSEITEMTORECOVERMP_METHOD_4_66AEEE0AB903BF94_OFFSET UNITYSDK_OFFSET(0x19CBF0A0)
#define RPG_GAMECORE_BYCANAUTOUSEITEMTORECOVERMP_METHOD_4_879297B1D9D93B5C_OFFSET UNITYSDK_OFFSET(0x19CBEEF0)
#define RPG_GAMECORE_BYCANAUTOUSEITEMTORECOVERMP__CTOR_OFFSET UNITYSDK_OFFSET(0x19CBEF20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCanAutoUseItemToRecoverMP_TypeDefinitionIndex = 19415;
