...
#define RPG_GAMECORE_AETHERPASSIVESKILLTYPEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CE076A0)
#define RPG_GAMECORE_AETHERPASSIVESKILLTYPEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE07CE0)
