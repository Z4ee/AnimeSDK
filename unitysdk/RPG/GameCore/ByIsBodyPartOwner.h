...
#define RPG_GAMECORE_BYISBODYPARTOWNER_METHOD_4_B18BBDB612DCA333_OFFSET UNITYSDK_OFFSET(0x1874EF40)
#define RPG_GAMECORE_BYISBODYPARTOWNER_METHOD_4_D66BD13C5CDDF0D5_OFFSET UNITYSDK_OFFSET(0x1874F010)
#define RPG_GAMECORE_BYISBODYPARTOWNER__CTOR_OFFSET UNITYSDK_OFFSET(0x1874EFC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsBodyPartOwner_TypeDefinitionIndex = 22286;
