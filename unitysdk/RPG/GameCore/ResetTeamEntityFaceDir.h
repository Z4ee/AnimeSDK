...
#define RPG_GAMECORE_RESETTEAMENTITYFACEDIR_METHOD_3_B94EF0BED4427DA8_OFFSET UNITYSDK_OFFSET(0x18CAB7B0)
#define RPG_GAMECORE_RESETTEAMENTITYFACEDIR_METHOD_3_D81E7799E1483601_OFFSET UNITYSDK_OFFSET(0x18CAB830)
#define RPG_GAMECORE_RESETTEAMENTITYFACEDIR__CTOR_OFFSET UNITYSDK_OFFSET(0x18CAB800)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetTeamEntityFaceDir_TypeDefinitionIndex = 22421;
