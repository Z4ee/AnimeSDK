...
#define RPG_GAMECORE_RESETTEAMENTITYFACEDIR_METHOD_3_B94EF0BED4427DA8_OFFSET UNITYSDK_OFFSET(0x19AD01A0)
#define RPG_GAMECORE_RESETTEAMENTITYFACEDIR_METHOD_3_D81E7799E1483601_OFFSET UNITYSDK_OFFSET(0x19AD0220)
#define RPG_GAMECORE_RESETTEAMENTITYFACEDIR__CTOR_OFFSET UNITYSDK_OFFSET(0x19AD01F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetTeamEntityFaceDir_TypeDefinitionIndex = 22175;
