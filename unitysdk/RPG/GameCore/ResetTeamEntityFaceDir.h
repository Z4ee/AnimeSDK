...
#define RPG_GAMECORE_RESETTEAMENTITYFACEDIR_METHOD_3_9D0FD06796CE961A_OFFSET UNITYSDK_OFFSET(0x1DB93FE0)
#define RPG_GAMECORE_RESETTEAMENTITYFACEDIR_METHOD_3_D81E7799E1483601_OFFSET UNITYSDK_OFFSET(0x1DB94020)
#define RPG_GAMECORE_RESETTEAMENTITYFACEDIR__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB94010)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetTeamEntityFaceDir_TypeDefinitionIndex = 23189;
