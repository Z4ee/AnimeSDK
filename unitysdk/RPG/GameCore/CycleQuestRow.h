...
#define RPG_GAMECORE_CYCLEQUESTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1BC41470)
#define RPG_GAMECORE_CYCLEQUESTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC42270)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CycleQuestRow_TypeDefinitionIndex = 13991;
	...
	public:
		...
		::System::UInt32 CycleID; // 0x20
		::System::UInt32 MinLevel; // 0x24
		::System::UInt32 Cycledays; // 0x28
		::System::UInt32 ActivityModuleID; // 0x2C
		::System::UInt32 FinishedTimes; // 0x30
		::System::UInt32 ScheduleDataID; // 0x34
		::System::UInt32 MaxLevel; // 0x38
		::System::Boolean IsNonPeriodic; // 0x3C
