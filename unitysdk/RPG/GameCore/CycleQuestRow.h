...
#define RPG_GAMECORE_CYCLEQUESTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17143220)
#define RPG_GAMECORE_CYCLEQUESTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17143FD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CycleQuestRow_TypeDefinitionIndex = 13300;

	class CycleQuestRow : public ::System::Object
	{
	public:
		::Il2CppArray<::System::UInt32>* QuestList; // 0x10
		::Il2CppArray<::System::UInt32>* WeekDayList; // 0x18
		::System::UInt32 MaxLevel; // 0x20
		::System::UInt32 Cycledays; // 0x24
		::System::Boolean IsNonPeriodic; // 0x28
		::System::UInt32 FinishedTimes; // 0x2C
