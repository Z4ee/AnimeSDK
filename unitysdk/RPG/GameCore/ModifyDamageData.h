...
#define RPG_GAMECORE_MODIFYDAMAGEDATA_METHOD_3_12B426185D634608_OFFSET UNITYSDK_OFFSET(0x19952070)
#define RPG_GAMECORE_MODIFYDAMAGEDATA_METHOD_3_9FE61590282F36CD_OFFSET UNITYSDK_OFFSET(0x199504C0)
#define RPG_GAMECORE_MODIFYDAMAGEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19950500)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyDamageData_TypeDefinitionIndex = 22284;
