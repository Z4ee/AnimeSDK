...
#define RPG_GAMECORE_MODIFYDAMAGEDATA_METHOD_3_12B426185D634608_OFFSET UNITYSDK_OFFSET(0x1B1A72D0)
#define RPG_GAMECORE_MODIFYDAMAGEDATA_METHOD_3_9FE61590282F36CD_OFFSET UNITYSDK_OFFSET(0x1B1A5740)
#define RPG_GAMECORE_MODIFYDAMAGEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1A5780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyDamageData_TypeDefinitionIndex = 22725;
