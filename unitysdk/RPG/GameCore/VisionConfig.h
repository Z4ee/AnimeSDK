...
#define RPG_GAMECORE_VISIONCONFIG_METHOD_3_02A3043353945C24_OFFSET UNITYSDK_OFFSET(0x178F1550)
#define RPG_GAMECORE_VISIONCONFIG_METHOD_3_950440BE461B50B0_OFFSET UNITYSDK_OFFSET(0x178F11F0)
#define RPG_GAMECORE_VISIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x178F11B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VisionConfig_TypeDefinitionIndex = 16090;
