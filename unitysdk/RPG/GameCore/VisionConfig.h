...
#define RPG_GAMECORE_VISIONCONFIG_METHOD_3_02A3043353945C24_OFFSET UNITYSDK_OFFSET(0x19E4DC60)
#define RPG_GAMECORE_VISIONCONFIG_METHOD_3_950440BE461B50B0_OFFSET UNITYSDK_OFFSET(0x19E4D940)
#define RPG_GAMECORE_VISIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19E4D900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VisionConfig_TypeDefinitionIndex = 16652;
