...
#define RPG_GAMECORE_ST_MAIN_ELFWAITERPUTDOWNFOOD_METHOD_4_7BA00E8C3EA15B02_OFFSET UNITYSDK_OFFSET(0x1B783190)
#define RPG_GAMECORE_ST_MAIN_ELFWAITERPUTDOWNFOOD_METHOD_4_B884D6E687188289_OFFSET UNITYSDK_OFFSET(0x1B7831D0)
#define RPG_GAMECORE_ST_MAIN_ELFWAITERPUTDOWNFOOD__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7831C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_ElfWaiterPutdownFood_TypeDefinitionIndex = 20718;
