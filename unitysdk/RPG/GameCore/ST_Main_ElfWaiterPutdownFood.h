...
#define RPG_GAMECORE_ST_MAIN_ELFWAITERPUTDOWNFOOD_METHOD_4_30A0579FE3DAF283_OFFSET UNITYSDK_OFFSET(0x18DF06D0)
#define RPG_GAMECORE_ST_MAIN_ELFWAITERPUTDOWNFOOD_METHOD_4_B884D6E687188289_OFFSET UNITYSDK_OFFSET(0x18DE82A0)
#define RPG_GAMECORE_ST_MAIN_ELFWAITERPUTDOWNFOOD__CTOR_OFFSET UNITYSDK_OFFSET(0x18DE8250)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_ElfWaiterPutdownFood_TypeDefinitionIndex = 20379;
