...
#define RPG_GAMECORE_FOURROTATEVOXELPLAYEREFFECTCONFIG_METHOD_2_1DAC972606450C06_OFFSET UNITYSDK_OFFSET(0x1DCB8670)
#define RPG_GAMECORE_FOURROTATEVOXELPLAYEREFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCB8720)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FourRotateVoxelPlayerEffectConfig_TypeDefinitionIndex = 16560;
