...
#define RPG_GAMECORE_BYHEROGENDER_METHOD_4_9279A63839C02240_OFFSET UNITYSDK_OFFSET(0x1874BF10)
#define RPG_GAMECORE_BYHEROGENDER_METHOD_4_EBC702719B577E3E_OFFSET UNITYSDK_OFFSET(0x1874BE40)
#define RPG_GAMECORE_BYHEROGENDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1874BEC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByHeroGender_TypeDefinitionIndex = 22748;
