...
#define RPG_GAMECORE_TAMONOTICKLODCONFIG_METHOD_2_7F615F36E74A2526_OFFSET UNITYSDK_OFFSET(0x19CEC2A0)
#define RPG_GAMECORE_TAMONOTICKLODCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19CEC380)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TAMonoTickLodConfig_TypeDefinitionIndex = 18216;
