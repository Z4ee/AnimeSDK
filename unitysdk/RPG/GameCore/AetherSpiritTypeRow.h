...
#define RPG_GAMECORE_AETHERSPIRITTYPEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16F6CED0)
#define RPG_GAMECORE_AETHERSPIRITTYPEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16F6D640)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AetherSpiritTypeRow_TypeDefinitionIndex = 10256;
