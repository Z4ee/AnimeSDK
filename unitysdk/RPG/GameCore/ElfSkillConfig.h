...
#define RPG_GAMECORE_ELFSKILLCONFIG_METHOD_2_ED4267DBF9754373_OFFSET UNITYSDK_OFFSET(0x1D7B64F0)
#define RPG_GAMECORE_ELFSKILLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7B66B0)
