...
#define RPG_GAMECORE_ELFSKILLCONFIG_METHOD_2_ED4267DBF9754373_OFFSET UNITYSDK_OFFSET(0x196DC6F0)
#define RPG_GAMECORE_ELFSKILLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x196DD240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfSkillConfig_TypeDefinitionIndex = 17553;
