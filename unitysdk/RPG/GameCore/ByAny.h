...
#define RPG_GAMECORE_BYANY_METHOD_4_D1BE8A9D7879DA85_OFFSET UNITYSDK_OFFSET(0x16FFA860)
#define RPG_GAMECORE_BYANY_METHOD_4_EEA3E9793C21275B_OFFSET UNITYSDK_OFFSET(0x16FFA930)
#define RPG_GAMECORE_BYANY__CTOR_OFFSET UNITYSDK_OFFSET(0x16FFA8E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByAny_TypeDefinitionIndex = 22068;
