...
#define RPG_GAMECORE_BYANY_METHOD_4_39526544828FD73E_OFFSET UNITYSDK_OFFSET(0x1C2F3510)
#define RPG_GAMECORE_BYANY_METHOD_4_A40E3F1972B18F71_OFFSET UNITYSDK_OFFSET(0x1C2F34E0)
#define RPG_GAMECORE_BYANY_METHOD_4_ECEC94103E835CE2_OFFSET UNITYSDK_OFFSET(0x1C2F3310)
#define RPG_GAMECORE_BYANY_METHOD_4_EEA3E9793C21275B_OFFSET UNITYSDK_OFFSET(0x1C2F3350)
#define RPG_GAMECORE_BYANY__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2F3340)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByAny_TypeDefinitionIndex = 23521;
