...
#define RPG_GAMECORE_FIVEDIMEVENTRECEIVERCONFIG_METHOD_3_563623CBB152C1FB_OFFSET UNITYSDK_OFFSET(0x1D0E3CB0)
#define RPG_GAMECORE_FIVEDIMEVENTRECEIVERCONFIG_METHOD_3_A32F9761C698529B_OFFSET UNITYSDK_OFFSET(0x1D0E3C40)
#define RPG_GAMECORE_FIVEDIMEVENTRECEIVERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0E3C90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimEventReceiverConfig_TypeDefinitionIndex = 18425;
