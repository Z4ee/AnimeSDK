...
#define RPG_GAMECORE_FIVEDIMEVENTRECEIVERCONFIG_METHOD_3_563623CBB152C1FB_OFFSET UNITYSDK_OFFSET(0x171F1740)
#define RPG_GAMECORE_FIVEDIMEVENTRECEIVERCONFIG_METHOD_3_A8668E666C88E992_OFFSET UNITYSDK_OFFSET(0x171F16A0)
#define RPG_GAMECORE_FIVEDIMEVENTRECEIVERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171F1700)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimEventReceiverConfig_TypeDefinitionIndex = 17104;
