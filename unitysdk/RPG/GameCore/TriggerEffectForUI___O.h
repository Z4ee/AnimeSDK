...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_D837DED66799FBE3_DelegateParseJson_1<::RPG::GameCore::MonoEffectFlag>**)Il2CppClass::FromTypeDefinitionIndex(TriggerEffectForUI___O_TypeDefinitionIndex)->GetStaticField(0x304E0);
		}
	};
}
