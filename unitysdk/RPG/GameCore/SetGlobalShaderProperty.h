...
#define RPG_GAMECORE_SETGLOBALSHADERPROPERTY_METHOD_3_1B838168625086EF_OFFSET UNITYSDK_OFFSET(0x1C5FB1B0)
#define RPG_GAMECORE_SETGLOBALSHADERPROPERTY_METHOD_3_8DCD1F65946C397C_OFFSET UNITYSDK_OFFSET(0x1C5FB1F0)
#define RPG_GAMECORE_SETGLOBALSHADERPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5FB1E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetGlobalShaderProperty_TypeDefinitionIndex = 22995;
