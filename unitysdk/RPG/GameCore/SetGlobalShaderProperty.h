...
#define RPG_GAMECORE_SETGLOBALSHADERPROPERTY_METHOD_3_8DCD1F65946C397C_OFFSET UNITYSDK_OFFSET(0x18E33220)
#define RPG_GAMECORE_SETGLOBALSHADERPROPERTY_METHOD_3_B0F7F4901A463CAF_OFFSET UNITYSDK_OFFSET(0x18E331A0)
#define RPG_GAMECORE_SETGLOBALSHADERPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x18E331F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetGlobalShaderProperty_TypeDefinitionIndex = 22844;
