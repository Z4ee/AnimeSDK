...
#define RPG_GAMECORE_SETGLOBALSHADERPROPERTY_METHOD_3_8DCD1F65946C397C_OFFSET UNITYSDK_OFFSET(0x19C50020)
#define RPG_GAMECORE_SETGLOBALSHADERPROPERTY_METHOD_3_B0F7F4901A463CAF_OFFSET UNITYSDK_OFFSET(0x19C4FFA0)
#define RPG_GAMECORE_SETGLOBALSHADERPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x19C4FFF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetGlobalShaderProperty_TypeDefinitionIndex = 22544;
