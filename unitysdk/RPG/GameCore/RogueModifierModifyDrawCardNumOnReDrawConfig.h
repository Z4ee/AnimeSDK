...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYDRAWCARDNUMONREDRAWCONFIG_METHOD_3_58CCD75484C8E1BC_OFFSET UNITYSDK_OFFSET(0x19B55360)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYDRAWCARDNUMONREDRAWCONFIG_METHOD_3_C8B3DC677FE8A8C5_OFFSET UNITYSDK_OFFSET(0x19B5F1C0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYDRAWCARDNUMONREDRAWCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B55310)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyDrawCardNumOnReDrawConfig_TypeDefinitionIndex = 16959;
