...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYDRAWCARDNUMONREDRAWCONFIG_METHOD_3_58CCD75484C8E1BC_OFFSET UNITYSDK_OFFSET(0x18D40B70)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYDRAWCARDNUMONREDRAWCONFIG_METHOD_3_C8B3DC677FE8A8C5_OFFSET UNITYSDK_OFFSET(0x18D40AA0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYDRAWCARDNUMONREDRAWCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D40B20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyDrawCardNumOnReDrawConfig_TypeDefinitionIndex = 16944;
