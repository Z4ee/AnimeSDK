...
#define RPG_GAMECORE_CHARMUSESKILL_METHOD_3_B8DAE52D00A386B2_OFFSET UNITYSDK_OFFSET(0x187D9580)
#define RPG_GAMECORE_CHARMUSESKILL_METHOD_3_ECC15B3979DD8470_OFFSET UNITYSDK_OFFSET(0x187D94A0)
#define RPG_GAMECORE_CHARMUSESKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x187D9520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharmUseSkill_TypeDefinitionIndex = 22654;
