...
#define RPG_GAMECORE_CHENLINGFESITEMRULEGROUPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CFB37B0)
#define RPG_GAMECORE_CHENLINGFESITEMRULEGROUPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFB3990)
