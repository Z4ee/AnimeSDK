...
#define RPG_GAMECORE_TARGETSHUFFLE_METHOD_3_5398DF62FE539598_OFFSET UNITYSDK_OFFSET(0x1D5B72D0)
#define RPG_GAMECORE_TARGETSHUFFLE_METHOD_3_626713B4CAA735FD_OFFSET UNITYSDK_OFFSET(0x1D5B7250)
#define RPG_GAMECORE_TARGETSHUFFLE_METHOD_3_ACBFF3ACD9982E27_OFFSET UNITYSDK_OFFSET(0x1D5B7330)
#define RPG_GAMECORE_TARGETSHUFFLE_METHOD_3_DF571A8D04A9105A_OFFSET UNITYSDK_OFFSET(0x1D5B7350)
#define RPG_GAMECORE_TARGETSHUFFLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5B72C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetShuffle_TypeDefinitionIndex = 23626;
