...
#define RPG_GAMECORE_TARGETSHUFFLE_METHOD_3_1D5CF062A0A7A4C9_OFFSET UNITYSDK_OFFSET(0x18EF8EA0)
#define RPG_GAMECORE_TARGETSHUFFLE_METHOD_3_5398DF62FE539598_OFFSET UNITYSDK_OFFSET(0x18EF6A10)
#define RPG_GAMECORE_TARGETSHUFFLE__CTOR_OFFSET UNITYSDK_OFFSET(0x18EF69F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetShuffle_TypeDefinitionIndex = 22891;
