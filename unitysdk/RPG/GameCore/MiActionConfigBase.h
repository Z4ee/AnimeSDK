...
#define RPG_GAMECORE_MIACTIONCONFIGBASE_METHOD_3_25C4878AB9C73CDE_OFFSET UNITYSDK_OFFSET(0x1AF62AC0)
#define RPG_GAMECORE_MIACTIONCONFIGBASE_METHOD_3_6FB2DB6F1F02CC80_OFFSET UNITYSDK_OFFSET(0x1AF62B20)
#define RPG_GAMECORE_MIACTIONCONFIGBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF62BC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MiActionConfigBase_TypeDefinitionIndex = 16387;
