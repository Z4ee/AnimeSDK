...
#define RPG_GAMECORE_CREATESERVANT_METHOD_3_72F755C00FC88400_OFFSET UNITYSDK_OFFSET(0x1D800AE0)
#define RPG_GAMECORE_CREATESERVANT_METHOD_3_D644100AEC0D4FC2_OFFSET UNITYSDK_OFFSET(0x1D800AA0)
#define RPG_GAMECORE_CREATESERVANT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D800AD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CreateServant_TypeDefinitionIndex = 22724;
