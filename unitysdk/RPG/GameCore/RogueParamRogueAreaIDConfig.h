...
#define RPG_GAMECORE_ROGUEPARAMROGUEAREAIDCONFIG_METHOD_6_3A329085EF2DD255_OFFSET UNITYSDK_OFFSET(0x1764C6E0)
#define RPG_GAMECORE_ROGUEPARAMROGUEAREAIDCONFIG_METHOD_6_A03E222CE844DF1B_OFFSET UNITYSDK_OFFSET(0x1764C430)
#define RPG_GAMECORE_ROGUEPARAMROGUEAREAIDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1764C5B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamRogueAreaIDConfig_TypeDefinitionIndex = 18182;
