...
#define RPG_GAMECORE_ROGUEPARAMROGUEAREAIDCONFIG_METHOD_6_3A329085EF2DD255_OFFSET UNITYSDK_OFFSET(0x1D176A20)
#define RPG_GAMECORE_ROGUEPARAMROGUEAREAIDCONFIG_METHOD_6_EDD94E7CA5098E31_OFFSET UNITYSDK_OFFSET(0x1D1769D0)
#define RPG_GAMECORE_ROGUEPARAMROGUEAREAIDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D176A10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamRogueAreaIDConfig_TypeDefinitionIndex = 19075;
