...
#define RPG_GAMECORE_MONSTEREFFECTSPRELOADITEM_METHOD_2_FF15B12E62B4EA93_OFFSET UNITYSDK_OFFSET(0x199A8350)
#define RPG_GAMECORE_MONSTEREFFECTSPRELOADITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x199A84E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonsterEffectsPreloadItem_TypeDefinitionIndex = 15544;
