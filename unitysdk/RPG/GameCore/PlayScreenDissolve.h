...
#define RPG_GAMECORE_PLAYSCREENDISSOLVE_METHOD_3_32DFF51DCF5F57F7_OFFSET UNITYSDK_OFFSET(0x18C11820)
#define RPG_GAMECORE_PLAYSCREENDISSOLVE_METHOD_3_EEBBF682BF692AC3_OFFSET UNITYSDK_OFFSET(0x18C118A0)
#define RPG_GAMECORE_PLAYSCREENDISSOLVE__CTOR_OFFSET UNITYSDK_OFFSET(0x18C11870)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayScreenDissolve_TypeDefinitionIndex = 22082;
