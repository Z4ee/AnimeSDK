...
#define RPG_GAMECORE_PLAYSCREENDISSOLVE_METHOD_3_32DFF51DCF5F57F7_OFFSET UNITYSDK_OFFSET(0x19A28790)
#define RPG_GAMECORE_PLAYSCREENDISSOLVE_METHOD_3_EEBBF682BF692AC3_OFFSET UNITYSDK_OFFSET(0x19A28810)
#define RPG_GAMECORE_PLAYSCREENDISSOLVE__CTOR_OFFSET UNITYSDK_OFFSET(0x19A287E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayScreenDissolve_TypeDefinitionIndex = 21882;
