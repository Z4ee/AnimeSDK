...
#define RPG_GAMECORE_PLAYSCREENDISSOLVE_METHOD_3_154FE77CFDE2D85C_OFFSET UNITYSDK_OFFSET(0x1BA06FE0)
#define RPG_GAMECORE_PLAYSCREENDISSOLVE_METHOD_3_EEBBF682BF692AC3_OFFSET UNITYSDK_OFFSET(0x1BA07020)
#define RPG_GAMECORE_PLAYSCREENDISSOLVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA07010)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayScreenDissolve_TypeDefinitionIndex = 22309;
