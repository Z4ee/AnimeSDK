...
#define RPG_GAMECORE_WAITSTAMINACHANGE_METHOD_3_702C6D87D788BEC4_OFFSET UNITYSDK_OFFSET(0x191092C0)
#define RPG_GAMECORE_WAITSTAMINACHANGE_METHOD_3_8DCB64DC79BA7B5D_OFFSET UNITYSDK_OFFSET(0x19109340)
#define RPG_GAMECORE_WAITSTAMINACHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x19109310)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitStaminaChange_TypeDefinitionIndex = 19448;
