...
#define RPG_GAMECORE_WAITSTAMINACHANGE_METHOD_3_8DCB64DC79BA7B5D_OFFSET UNITYSDK_OFFSET(0x1DEC2280)
#define RPG_GAMECORE_WAITSTAMINACHANGE_METHOD_3_D525F8452E1B5978_OFFSET UNITYSDK_OFFSET(0x1DEC2230)
#define RPG_GAMECORE_WAITSTAMINACHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEC2270)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitStaminaChange_TypeDefinitionIndex = 20255;
