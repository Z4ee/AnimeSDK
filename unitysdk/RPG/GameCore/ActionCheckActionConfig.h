...
#define RPG_GAMECORE_ACTIONCHECKACTIONCONFIG_METHOD_4_73CE6B3C960F5826_OFFSET UNITYSDK_OFFSET(0x185F98F0)
#define RPG_GAMECORE_ACTIONCHECKACTIONCONFIG_METHOD_4_D0D6C304CFE08799_OFFSET UNITYSDK_OFFSET(0x185F99D0)
#define RPG_GAMECORE_ACTIONCHECKACTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x185F9980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActionCheckActionConfig_TypeDefinitionIndex = 16142;
