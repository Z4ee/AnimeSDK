...
#define RPG_GAMECORE_ADVBYCOMPAREDYNAMICVALUE_METHOD_4_2D748CF15BCBE0FD_OFFSET UNITYSDK_OFFSET(0x16F25900)
#define RPG_GAMECORE_ADVBYCOMPAREDYNAMICVALUE_METHOD_4_BDE3132BB23F6F61_OFFSET UNITYSDK_OFFSET(0x16F25A20)
#define RPG_GAMECORE_ADVBYCOMPAREDYNAMICVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F259A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvByCompareDynamicValue_TypeDefinitionIndex = 18533;
