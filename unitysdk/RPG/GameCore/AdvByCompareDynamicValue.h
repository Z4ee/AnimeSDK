...
#define RPG_GAMECORE_ADVBYCOMPAREDYNAMICVALUE_METHOD_4_112143E8280FEAD6_OFFSET UNITYSDK_OFFSET(0x1BE10730)
#define RPG_GAMECORE_ADVBYCOMPAREDYNAMICVALUE_METHOD_4_2D748CF15BCBE0FD_OFFSET UNITYSDK_OFFSET(0x1BE10420)
#define RPG_GAMECORE_ADVBYCOMPAREDYNAMICVALUE_METHOD_4_5D34C55E81BAC01B_OFFSET UNITYSDK_OFFSET(0x1BE10790)
#define RPG_GAMECORE_ADVBYCOMPAREDYNAMICVALUE_METHOD_4_BDE3132BB23F6F61_OFFSET UNITYSDK_OFFSET(0x1BE104C0)
#define RPG_GAMECORE_ADVBYCOMPAREDYNAMICVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE10480)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvByCompareDynamicValue_TypeDefinitionIndex = 19468;
