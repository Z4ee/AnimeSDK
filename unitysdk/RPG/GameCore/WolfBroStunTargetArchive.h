...
#define RPG_GAMECORE_WOLFBROSTUNTARGETARCHIVE_METHOD_3_DEE461581285A640_OFFSET UNITYSDK_OFFSET(0x19110E30)
#define RPG_GAMECORE_WOLFBROSTUNTARGETARCHIVE_METHOD_3_ECA12B974770CCF9_OFFSET UNITYSDK_OFFSET(0x19110DB0)
#define RPG_GAMECORE_WOLFBROSTUNTARGETARCHIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x19110E00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WolfBroStunTargetArchive_TypeDefinitionIndex = 20848;
