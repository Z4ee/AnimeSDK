...
#define RPG_GAMECORE_WOLFBROSTUNTARGETARCHIVE_METHOD_3_8A6CFB3A9019C803_OFFSET UNITYSDK_OFFSET(0x1D1C3D70)
#define RPG_GAMECORE_WOLFBROSTUNTARGETARCHIVE_METHOD_3_DEE461581285A640_OFFSET UNITYSDK_OFFSET(0x1D1C3DC0)
#define RPG_GAMECORE_WOLFBROSTUNTARGETARCHIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1C3DB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WolfBroStunTargetArchive_TypeDefinitionIndex = 21183;
