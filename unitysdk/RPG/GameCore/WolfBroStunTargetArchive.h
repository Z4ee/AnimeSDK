...
#define RPG_GAMECORE_WOLFBROSTUNTARGETARCHIVE_METHOD_3_8A6CFB3A9019C803_OFFSET UNITYSDK_OFFSET(0x1D6B3F80)
#define RPG_GAMECORE_WOLFBROSTUNTARGETARCHIVE_METHOD_3_DEE461581285A640_OFFSET UNITYSDK_OFFSET(0x1D6B3FD0)
#define RPG_GAMECORE_WOLFBROSTUNTARGETARCHIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6B3FC0)
