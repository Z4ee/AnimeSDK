...
#define RPG_GAMECORE_IDLELIVEGACHAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19843CA0)
#define RPG_GAMECORE_IDLELIVEGACHAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19844020)

namespace RPG::GameCore
{
	inline static constexpr unsigned int IdleLiveGachaRow_TypeDefinitionIndex = 11260;
	...
	public:
		...
		::RPG::GameCore::FixPoint CrystalProbability; // 0x20
		::System::Boolean IsStarUp; // 0x28
		::System::Boolean IsAvatarGroupUp; // 0x29
		::System::UInt32 UpgradeCount; // 0x2C
