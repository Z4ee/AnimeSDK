...
#define RPG_GAMECORE_GRIDFIGHTFUNCMANAGECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x197E6660)
#define RPG_GAMECORE_GRIDFIGHTFUNCMANAGECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x197E67F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightFuncManageConfigRow_TypeDefinitionIndex = 12940;

	class GridFightFuncManageConfigRow : public ::System::Object
	{
	public:
		::RPG::GameCore::GridFightUnlockFunctionType ID; // 0x10
