...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYPERSONAROOMCONTENTCOUNTCONFIG_METHOD_3_638D77F18760891D_OFFSET UNITYSDK_OFFSET(0x1D164180)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYPERSONAROOMCONTENTCOUNTCONFIG_METHOD_3_FFFB1DB462931F41_OFFSET UNITYSDK_OFFSET(0x1D1641D0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYPERSONAROOMCONTENTCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1641C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyPersonaRoomContentCountConfig_TypeDefinitionIndex = 17078;
