...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYPERSONAROOMCONTENTCOUNTCONFIG_METHOD_3_89B16DEC487F35E8_OFFSET UNITYSDK_OFFSET(0x19B5FB40)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYPERSONAROOMCONTENTCOUNTCONFIG_METHOD_3_FFFB1DB462931F41_OFFSET UNITYSDK_OFFSET(0x19B56400)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYPERSONAROOMCONTENTCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B563B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyPersonaRoomContentCountConfig_TypeDefinitionIndex = 16916;
