...
#define RPG_GAMECORE_PERFORMANCEREPLAY_SETFLOORSAVEDVALUE_METHOD_3_6BE9B54F3E26CA82_OFFSET UNITYSDK_OFFSET(0x1749D8D0)
#define RPG_GAMECORE_PERFORMANCEREPLAY_SETFLOORSAVEDVALUE_METHOD_3_F7B69C6EBC081D73_OFFSET UNITYSDK_OFFSET(0x1749D950)
#define RPG_GAMECORE_PERFORMANCEREPLAY_SETFLOORSAVEDVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1749D920)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PerformanceReplay_SetFloorSavedValue_TypeDefinitionIndex = 20021;
