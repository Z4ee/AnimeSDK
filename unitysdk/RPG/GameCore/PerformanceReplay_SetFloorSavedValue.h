...
#define RPG_GAMECORE_PERFORMANCEREPLAY_SETFLOORSAVEDVALUE_METHOD_3_A2D4CC48B92516FA_OFFSET UNITYSDK_OFFSET(0x1D427D80)
#define RPG_GAMECORE_PERFORMANCEREPLAY_SETFLOORSAVEDVALUE_METHOD_3_F7B69C6EBC081D73_OFFSET UNITYSDK_OFFSET(0x1D427DC0)
#define RPG_GAMECORE_PERFORMANCEREPLAY_SETFLOORSAVEDVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D427DB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PerformanceReplay_SetFloorSavedValue_TypeDefinitionIndex = 21603;
