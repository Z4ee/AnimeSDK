...
#define RPG_GAMECORE_FIVEDIMSTARTCHENLINGGAMEBOYCOUNTDOWNACTION_METHOD_3_0EA0FB00F98AE69F_OFFSET UNITYSDK_OFFSET(0x1891F5A0)
#define RPG_GAMECORE_FIVEDIMSTARTCHENLINGGAMEBOYCOUNTDOWNACTION_METHOD_3_FCB6621F07073A92_OFFSET UNITYSDK_OFFSET(0x1891F4E0)
#define RPG_GAMECORE_FIVEDIMSTARTCHENLINGGAMEBOYCOUNTDOWNACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1891F580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimStartChenLingGameBoyCountDownAction_TypeDefinitionIndex = 17742;
