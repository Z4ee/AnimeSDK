...
#define RPG_GAMECORE_FIVEDIMSTARTCHENLINGGAMEBOYCOUNTDOWNACTION_METHOD_3_0EA0FB00F98AE69F_OFFSET UNITYSDK_OFFSET(0x19758F70)
#define RPG_GAMECORE_FIVEDIMSTARTCHENLINGGAMEBOYCOUNTDOWNACTION_METHOD_3_FCB6621F07073A92_OFFSET UNITYSDK_OFFSET(0x19758EB0)
#define RPG_GAMECORE_FIVEDIMSTARTCHENLINGGAMEBOYCOUNTDOWNACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19758F50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimStartChenLingGameBoyCountDownAction_TypeDefinitionIndex = 17769;
