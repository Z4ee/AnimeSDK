...
#define RPG_GAMECORE_TRAINPARTYDIALOGUEEVENTEFFECTCONFIG_METHOD_2_49B4A0675CB2D02F_OFFSET UNITYSDK_OFFSET(0x1D5DD110)
#define RPG_GAMECORE_TRAINPARTYDIALOGUEEVENTEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5DD150)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyDialogueEventEffectConfig_TypeDefinitionIndex = 17880;
