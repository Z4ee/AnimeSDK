...
#define RPG_GAMECORE_MARBLEBYHITLEFT_METHOD_4_6F76C85F504B6F87_OFFSET UNITYSDK_OFFSET(0x1738B140)
#define RPG_GAMECORE_MARBLEBYHITLEFT_METHOD_4_BB59E34F61C43D52_OFFSET UNITYSDK_OFFSET(0x1738B060)
#define RPG_GAMECORE_MARBLEBYHITLEFT__CTOR_OFFSET UNITYSDK_OFFSET(0x1738B0F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleByHitLeft_TypeDefinitionIndex = 15459;
