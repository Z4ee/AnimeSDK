...
#define RPG_GAMECORE_CANCELACTIONDELAYLINK_METHOD_3_225F007A3EC52F8D_OFFSET UNITYSDK_OFFSET(0x187B73B0)
#define RPG_GAMECORE_CANCELACTIONDELAYLINK_METHOD_3_ED20BABB9EF8BE21_OFFSET UNITYSDK_OFFSET(0x187B7430)
#define RPG_GAMECORE_CANCELACTIONDELAYLINK__CTOR_OFFSET UNITYSDK_OFFSET(0x187B7400)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CancelActionDelayLink_TypeDefinitionIndex = 22243;
