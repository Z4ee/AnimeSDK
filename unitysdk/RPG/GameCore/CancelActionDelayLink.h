...
#define RPG_GAMECORE_CANCELACTIONDELAYLINK_METHOD_3_2624D8F9895DCB9E_OFFSET UNITYSDK_OFFSET(0x1CF7CEE0)
#define RPG_GAMECORE_CANCELACTIONDELAYLINK_METHOD_3_ED20BABB9EF8BE21_OFFSET UNITYSDK_OFFSET(0x1CF7CF20)
#define RPG_GAMECORE_CANCELACTIONDELAYLINK__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF7CF10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CancelActionDelayLink_TypeDefinitionIndex = 23007;
