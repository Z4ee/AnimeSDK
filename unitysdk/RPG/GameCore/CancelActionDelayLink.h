...
#define RPG_GAMECORE_CANCELACTIONDELAYLINK_METHOD_3_225F007A3EC52F8D_OFFSET UNITYSDK_OFFSET(0x17052C20)
#define RPG_GAMECORE_CANCELACTIONDELAYLINK_METHOD_3_ED20BABB9EF8BE21_OFFSET UNITYSDK_OFFSET(0x17052CA0)
#define RPG_GAMECORE_CANCELACTIONDELAYLINK__CTOR_OFFSET UNITYSDK_OFFSET(0x17052C70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CancelActionDelayLink_TypeDefinitionIndex = 21507;
