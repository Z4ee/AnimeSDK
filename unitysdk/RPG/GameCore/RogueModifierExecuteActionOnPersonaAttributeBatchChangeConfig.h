...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONAATTRIBUTEBATCHCHANGECONFIG_METHOD_3_43A4082F5CEA3542_OFFSET UNITYSDK_OFFSET(0x19B525E0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONAATTRIBUTEBATCHCHANGECONFIG_METHOD_3_4881175426AEB64B_OFFSET UNITYSDK_OFFSET(0x19B5D520)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONAATTRIBUTEBATCHCHANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B52590)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnPersonaAttributeBatchChangeConfig_TypeDefinitionIndex = 16964;
