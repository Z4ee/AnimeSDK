...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONAATTRIBUTEBATCHCHANGECONFIG_METHOD_3_43A4082F5CEA3542_OFFSET UNITYSDK_OFFSET(0x17631010)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONAATTRIBUTEBATCHCHANGECONFIG_METHOD_3_4881175426AEB64B_OFFSET UNITYSDK_OFFSET(0x17630F40)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONAATTRIBUTEBATCHCHANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17630FC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnPersonaAttributeBatchChangeConfig_TypeDefinitionIndex = 16395;
