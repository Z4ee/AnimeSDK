...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONAATTRIBUTEBATCHCHANGECONFIG_METHOD_3_1CC6857B9F9F4C26_OFFSET UNITYSDK_OFFSET(0x1CFC0920)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONAATTRIBUTEBATCHCHANGECONFIG_METHOD_3_43A4082F5CEA3542_OFFSET UNITYSDK_OFFSET(0x1CFC0970)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONAATTRIBUTEBATCHCHANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFC0960)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnPersonaAttributeBatchChangeConfig_TypeDefinitionIndex = 17126;
