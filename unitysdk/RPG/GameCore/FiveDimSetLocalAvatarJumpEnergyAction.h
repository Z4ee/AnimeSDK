...
#define RPG_GAMECORE_FIVEDIMSETLOCALAVATARJUMPENERGYACTION_METHOD_3_B2A16CF9B7B4B712_OFFSET UNITYSDK_OFFSET(0x1D100590)
#define RPG_GAMECORE_FIVEDIMSETLOCALAVATARJUMPENERGYACTION_METHOD_3_D05CB088EE199B05_OFFSET UNITYSDK_OFFSET(0x1D1005D0)
#define RPG_GAMECORE_FIVEDIMSETLOCALAVATARJUMPENERGYACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1005C0)
