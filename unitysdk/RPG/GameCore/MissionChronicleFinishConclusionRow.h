...
#define RPG_GAMECORE_MISSIONCHRONICLEFINISHCONCLUSIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1AF67EA0)
#define RPG_GAMECORE_MISSIONCHRONICLEFINISHCONCLUSIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF68000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MissionChronicleFinishConclusionRow_TypeDefinitionIndex = 13601;
