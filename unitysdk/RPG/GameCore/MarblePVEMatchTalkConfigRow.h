...
#define RPG_GAMECORE_MARBLEPVEMATCHTALKCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x198D4780)
#define RPG_GAMECORE_MARBLEPVEMATCHTALKCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x198D4900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarblePVEMatchTalkConfigRow_TypeDefinitionIndex = 11347;
