...
#define RPG_GAMECORE_LOCKENTITYTRANSFORM_METHOD_3_B2512780E17E32AD_OFFSET UNITYSDK_OFFSET(0x1736ACB0)
#define RPG_GAMECORE_LOCKENTITYTRANSFORM_METHOD_3_C793415FD13BE741_OFFSET UNITYSDK_OFFSET(0x1736ABE0)
#define RPG_GAMECORE_LOCKENTITYTRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1736AC60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LockEntityTransform_TypeDefinitionIndex = 22026;
