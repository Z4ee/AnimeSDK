...
#define RPG_GAMECORE_PROPSETFOLLOWROTATE_METHOD_3_67FA61460DB4D7D5_OFFSET UNITYSDK_OFFSET(0x1D181E10)
#define RPG_GAMECORE_PROPSETFOLLOWROTATE_METHOD_3_831F99F2590C9610_OFFSET UNITYSDK_OFFSET(0x1D181DD0)
#define RPG_GAMECORE_PROPSETFOLLOWROTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D181E00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropSetFollowRotate_TypeDefinitionIndex = 21826;
