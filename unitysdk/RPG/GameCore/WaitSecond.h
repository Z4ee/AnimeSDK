...
#define RPG_GAMECORE_WAITSECOND_METHOD_3_1A3F428C4F33F876_OFFSET UNITYSDK_OFFSET(0x19107F30)
#define RPG_GAMECORE_WAITSECOND_METHOD_3_B5AEF315722E4F96_OFFSET UNITYSDK_OFFSET(0x19108070)
#define RPG_GAMECORE_WAITSECOND__CTOR_OFFSET UNITYSDK_OFFSET(0x19107FE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitSecond_TypeDefinitionIndex = 22774;
