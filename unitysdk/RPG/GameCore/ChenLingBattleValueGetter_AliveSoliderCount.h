...
#define RPG_GAMECORE_CHENLINGBATTLEVALUEGETTER_ALIVESOLIDERCOUNT_METHOD_3_5FD039C199F528DF_OFFSET UNITYSDK_OFFSET(0x187E7C50)
#define RPG_GAMECORE_CHENLINGBATTLEVALUEGETTER_ALIVESOLIDERCOUNT_METHOD_3_C71066309B5BA03F_OFFSET UNITYSDK_OFFSET(0x187E7CB0)
#define RPG_GAMECORE_CHENLINGBATTLEVALUEGETTER_ALIVESOLIDERCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x187E7CA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleValueGetter_AliveSoliderCount_TypeDefinitionIndex = 14969;
