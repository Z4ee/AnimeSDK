...
#define RPG_GAMECORE_CHENLINGEFFECTPROGRESSROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1E012750)
#define RPG_GAMECORE_CHENLINGEFFECTPROGRESSROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1E012930)
