...
#define RPG_GAMECORE_CHENLINGEFFECTPROGRESSROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x196276E0)
#define RPG_GAMECORE_CHENLINGEFFECTPROGRESSROW__CTOR_OFFSET UNITYSDK_OFFSET(0x196278C0)
