...
#define RPG_GAMECORE_TUTORIALLOCKCONTROL_METHOD_3_53D7290A3C2BBFD0_OFFSET UNITYSDK_OFFSET(0x178DD920)
#define RPG_GAMECORE_TUTORIALLOCKCONTROL_METHOD_3_755DC3DC8EED0A89_OFFSET UNITYSDK_OFFSET(0x178DD8A0)
#define RPG_GAMECORE_TUTORIALLOCKCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x178DD8F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TutorialLockControl_TypeDefinitionIndex = 22318;
