...
#define RPG_GAMECORE_DAMAGETEXTMOBILEPOOLCONFIG_METHOD_2_035CACA4D1CEAC4F_OFFSET UNITYSDK_OFFSET(0x1D016130)
#define RPG_GAMECORE_DAMAGETEXTMOBILEPOOLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0161F0)
