...
#define RPG_GAMECORE_WAITDIALOGUEFINISH_METHOD_3_32DAE2C3099244B1_OFFSET UNITYSDK_OFFSET(0x1B8A2970)
#define RPG_GAMECORE_WAITDIALOGUEFINISH_METHOD_3_8CF24C15668A67BA_OFFSET UNITYSDK_OFFSET(0x1B8A29C0)
#define RPG_GAMECORE_WAITDIALOGUEFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8A29B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitDialogueFinish_TypeDefinitionIndex = 20060;
