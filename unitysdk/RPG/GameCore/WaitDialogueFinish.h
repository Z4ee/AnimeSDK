...
#define RPG_GAMECORE_WAITDIALOGUEFINISH_METHOD_3_73446C8259859243_OFFSET UNITYSDK_OFFSET(0x178F6FD0)
#define RPG_GAMECORE_WAITDIALOGUEFINISH_METHOD_3_8CF24C15668A67BA_OFFSET UNITYSDK_OFFSET(0x178F7050)
#define RPG_GAMECORE_WAITDIALOGUEFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x178F7020)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitDialogueFinish_TypeDefinitionIndex = 19171;
