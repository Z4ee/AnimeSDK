...
#define RPG_GAMECORE_ACTIVITYQUESTTABGROUPUIROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CA15900)
#define RPG_GAMECORE_ACTIVITYQUESTTABGROUPUIROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CA15A80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityQuestTabGroupUIRow_TypeDefinitionIndex = 12228;
