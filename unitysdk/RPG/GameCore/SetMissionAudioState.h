...
#define RPG_GAMECORE_SETMISSIONAUDIOSTATE_METHOD_3_2A623ED5ADA240B7_OFFSET UNITYSDK_OFFSET(0x1C5FFFE0)
#define RPG_GAMECORE_SETMISSIONAUDIOSTATE_METHOD_3_3A2EA40A28025401_OFFSET UNITYSDK_OFFSET(0x1C5FFFA0)
#define RPG_GAMECORE_SETMISSIONAUDIOSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5FFFD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetMissionAudioState_TypeDefinitionIndex = 20881;
