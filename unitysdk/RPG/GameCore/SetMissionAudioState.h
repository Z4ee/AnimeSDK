...
#define RPG_GAMECORE_SETMISSIONAUDIOSTATE_METHOD_3_178D291519872096_OFFSET UNITYSDK_OFFSET(0x176D5330)
#define RPG_GAMECORE_SETMISSIONAUDIOSTATE_METHOD_3_2A623ED5ADA240B7_OFFSET UNITYSDK_OFFSET(0x176D53B0)
#define RPG_GAMECORE_SETMISSIONAUDIOSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x176D5380)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetMissionAudioState_TypeDefinitionIndex = 19849;
