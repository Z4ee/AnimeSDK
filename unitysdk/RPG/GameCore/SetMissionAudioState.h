...
#define RPG_GAMECORE_SETMISSIONAUDIOSTATE_METHOD_3_2A623ED5ADA240B7_OFFSET UNITYSDK_OFFSET(0x1D505650)
#define RPG_GAMECORE_SETMISSIONAUDIOSTATE_METHOD_3_3A2EA40A28025401_OFFSET UNITYSDK_OFFSET(0x1D505610)
#define RPG_GAMECORE_SETMISSIONAUDIOSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D505640)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetMissionAudioState_TypeDefinitionIndex = 21437;
	...
	public:
		...
		static ::System::Void Method_3_3A2EA40A28025401(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::SetMissionAudioState*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::SetMissionAudioState*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_SETMISSIONAUDIOSTATE_METHOD_3_3A2EA40A28025401_OFFSET))(a1, a2);
		}
