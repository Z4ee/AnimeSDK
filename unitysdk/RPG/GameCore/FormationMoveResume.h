...
#define RPG_GAMECORE_FORMATIONMOVERESUME_METHOD_3_01813456843B9B69_OFFSET UNITYSDK_OFFSET(0x1D111AB0)
#define RPG_GAMECORE_FORMATIONMOVERESUME_METHOD_3_93E7DFA72A06626A_OFFSET UNITYSDK_OFFSET(0x1D111A70)
#define RPG_GAMECORE_FORMATIONMOVERESUME__CTOR_OFFSET UNITYSDK_OFFSET(0x1D111AA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FormationMoveResume_TypeDefinitionIndex = 21012;
