...
#define RPG_GAMECORE_FORMATIONMOVERESUME_METHOD_3_01813456843B9B69_OFFSET UNITYSDK_OFFSET(0x1892B3B0)
#define RPG_GAMECORE_FORMATIONMOVERESUME_METHOD_3_6CC38A3EF9444AE0_OFFSET UNITYSDK_OFFSET(0x1892B330)
#define RPG_GAMECORE_FORMATIONMOVERESUME__CTOR_OFFSET UNITYSDK_OFFSET(0x1892B380)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FormationMoveResume_TypeDefinitionIndex = 20231;
