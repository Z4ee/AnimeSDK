...
#define RPG_GAMECORE_FORMATIONMOVERESUME_METHOD_3_01813456843B9B69_OFFSET UNITYSDK_OFFSET(0x17218D80)
#define RPG_GAMECORE_FORMATIONMOVERESUME_METHOD_3_6CC38A3EF9444AE0_OFFSET UNITYSDK_OFFSET(0x17218D00)
#define RPG_GAMECORE_FORMATIONMOVERESUME__CTOR_OFFSET UNITYSDK_OFFSET(0x17218D50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FormationMoveResume_TypeDefinitionIndex = 19556;
