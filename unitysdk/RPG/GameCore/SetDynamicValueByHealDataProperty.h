...
#define RPG_GAMECORE_SETDYNAMICVALUEBYHEALDATAPROPERTY_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1C2E3D00)
#define RPG_GAMECORE_SETDYNAMICVALUEBYHEALDATAPROPERTY_METHOD_4_4008903A8D33DC25_OFFSET UNITYSDK_OFFSET(0x1C2E3AD0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYHEALDATAPROPERTY_METHOD_4_F7F98BCC1E4B66A4_OFFSET UNITYSDK_OFFSET(0x1C2E3B10)
#define RPG_GAMECORE_SETDYNAMICVALUEBYHEALDATAPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2E3B00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByHealDataProperty_TypeDefinitionIndex = 22748;
