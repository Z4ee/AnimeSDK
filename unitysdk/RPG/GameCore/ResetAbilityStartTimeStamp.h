...
#define RPG_GAMECORE_RESETABILITYSTARTTIMESTAMP_METHOD_3_35648A103AEAB256_OFFSET UNITYSDK_OFFSET(0x19ACD9B0)
#define RPG_GAMECORE_RESETABILITYSTARTTIMESTAMP_METHOD_3_F82F32D2DC4B504A_OFFSET UNITYSDK_OFFSET(0x19ACD930)
#define RPG_GAMECORE_RESETABILITYSTARTTIMESTAMP__CTOR_OFFSET UNITYSDK_OFFSET(0x19ACD980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetAbilityStartTimeStamp_TypeDefinitionIndex = 21454;
