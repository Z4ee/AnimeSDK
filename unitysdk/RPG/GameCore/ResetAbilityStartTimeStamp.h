...
#define RPG_GAMECORE_RESETABILITYSTARTTIMESTAMP_METHOD_3_35648A103AEAB256_OFFSET UNITYSDK_OFFSET(0x1DB91CC0)
#define RPG_GAMECORE_RESETABILITYSTARTTIMESTAMP_METHOD_3_5ED9A8F0788B6AF5_OFFSET UNITYSDK_OFFSET(0x1DB91C80)
#define RPG_GAMECORE_RESETABILITYSTARTTIMESTAMP__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB91CB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetAbilityStartTimeStamp_TypeDefinitionIndex = 22438;
