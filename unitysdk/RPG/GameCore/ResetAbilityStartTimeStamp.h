...
#define RPG_GAMECORE_RESETABILITYSTARTTIMESTAMP_METHOD_3_35648A103AEAB256_OFFSET UNITYSDK_OFFSET(0x1759CFF0)
#define RPG_GAMECORE_RESETABILITYSTARTTIMESTAMP_METHOD_3_F82F32D2DC4B504A_OFFSET UNITYSDK_OFFSET(0x1759CF70)
#define RPG_GAMECORE_RESETABILITYSTARTTIMESTAMP__CTOR_OFFSET UNITYSDK_OFFSET(0x1759CFC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetAbilityStartTimeStamp_TypeDefinitionIndex = 20879;
