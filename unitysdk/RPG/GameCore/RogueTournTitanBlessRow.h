...
#define RPG_GAMECORE_ROGUETOURNTITANBLESSROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18D7BF80)
#define RPG_GAMECORE_ROGUETOURNTITANBLESSROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18D7C2D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournTitanBlessRow_TypeDefinitionIndex = 14278;
	...
	public:
		...
		::System::UInt32 TitanBlessID; // 0x20
