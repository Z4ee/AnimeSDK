...
#define RPG_GAMECORE_ROGUETOURNTITANBLESSROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D48E9D0)
#define RPG_GAMECORE_ROGUETOURNTITANBLESSROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D48ECE0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 TitanBlessLevel; // 0x2C
		::RPG::GameCore::RogueTitanType TitanType; // 0x30
		::System::UInt32 TitanBlessID; // 0x34
