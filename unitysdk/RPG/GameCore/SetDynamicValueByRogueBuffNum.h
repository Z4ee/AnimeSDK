...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEBUFFNUM_METHOD_3_9E82885F4351B85D_OFFSET UNITYSDK_OFFSET(0x19C43330)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEBUFFNUM_METHOD_3_F9F18CE0F74E5AD2_OFFSET UNITYSDK_OFFSET(0x19C432C0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEBUFFNUM__CTOR_OFFSET UNITYSDK_OFFSET(0x19C43300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRogueBuffNum_TypeDefinitionIndex = 20549;
