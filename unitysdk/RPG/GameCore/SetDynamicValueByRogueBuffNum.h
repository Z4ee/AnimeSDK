...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEBUFFNUM_METHOD_3_9E82885F4351B85D_OFFSET UNITYSDK_OFFSET(0x176C3380)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEBUFFNUM_METHOD_3_F9F18CE0F74E5AD2_OFFSET UNITYSDK_OFFSET(0x176C3310)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEBUFFNUM__CTOR_OFFSET UNITYSDK_OFFSET(0x176C3350)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRogueBuffNum_TypeDefinitionIndex = 19935;
