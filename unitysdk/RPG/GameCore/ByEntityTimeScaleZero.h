...
#define RPG_GAMECORE_BYENTITYTIMESCALEZERO_METHOD_4_0B6131B44729635F_OFFSET UNITYSDK_OFFSET(0x1BBD8F00)
#define RPG_GAMECORE_BYENTITYTIMESCALEZERO_METHOD_4_3B3BF599154ACB3B_OFFSET UNITYSDK_OFFSET(0x1BBD90B0)
#define RPG_GAMECORE_BYENTITYTIMESCALEZERO_METHOD_4_53BCEA178FE070B5_OFFSET UNITYSDK_OFFSET(0x1BBD9080)
#define RPG_GAMECORE_BYENTITYTIMESCALEZERO_METHOD_4_6A95AFED7A90BAFE_OFFSET UNITYSDK_OFFSET(0x1BBD8EC0)
#define RPG_GAMECORE_BYENTITYTIMESCALEZERO__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBD8EF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByEntityTimeScaleZero_TypeDefinitionIndex = 20351;
