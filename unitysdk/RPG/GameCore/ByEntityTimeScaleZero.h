...
#define RPG_GAMECORE_BYENTITYTIMESCALEZERO_METHOD_4_0B6131B44729635F_OFFSET UNITYSDK_OFFSET(0x187464C0)
#define RPG_GAMECORE_BYENTITYTIMESCALEZERO_METHOD_4_310E0C75F8458A81_OFFSET UNITYSDK_OFFSET(0x187463F0)
#define RPG_GAMECORE_BYENTITYTIMESCALEZERO__CTOR_OFFSET UNITYSDK_OFFSET(0x18746470)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByEntityTimeScaleZero_TypeDefinitionIndex = 19555;
