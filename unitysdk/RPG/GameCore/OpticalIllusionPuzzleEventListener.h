...
#define RPG_GAMECORE_OPTICALILLUSIONPUZZLEEVENTLISTENER_METHOD_3_BF54EF27E3774E9A_OFFSET UNITYSDK_OFFSET(0x1747F380)
#define RPG_GAMECORE_OPTICALILLUSIONPUZZLEEVENTLISTENER_METHOD_3_F5FCE435567054A4_OFFSET UNITYSDK_OFFSET(0x1747F300)
#define RPG_GAMECORE_OPTICALILLUSIONPUZZLEEVENTLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1747F350)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OpticalIllusionPuzzleEventListener_TypeDefinitionIndex = 20410;
