...
#define RPG_GAMECORE_OPTICALILLUSIONPUZZLEEVENTLISTENER_METHOD_3_C0E17500C782E08C_OFFSET UNITYSDK_OFFSET(0x1BB04090)
#define RPG_GAMECORE_OPTICALILLUSIONPUZZLEEVENTLISTENER_METHOD_3_EE63EB5533EB9BCF_OFFSET UNITYSDK_OFFSET(0x1BB040D0)
#define RPG_GAMECORE_OPTICALILLUSIONPUZZLEEVENTLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB040C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OpticalIllusionPuzzleEventListener_TypeDefinitionIndex = 21410;
