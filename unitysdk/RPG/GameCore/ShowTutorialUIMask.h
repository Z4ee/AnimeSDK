...
#define RPG_GAMECORE_SHOWTUTORIALUIMASK_METHOD_3_A9CC483D68BAB43E_OFFSET UNITYSDK_OFFSET(0x17706930)
#define RPG_GAMECORE_SHOWTUTORIALUIMASK_METHOD_3_B7749A00808F7EFC_OFFSET UNITYSDK_OFFSET(0x177069C0)
#define RPG_GAMECORE_SHOWTUTORIALUIMASK__CTOR_OFFSET UNITYSDK_OFFSET(0x17706990)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowTutorialUIMask_TypeDefinitionIndex = 22386;
