...
#define RPG_GAMECORE_SHOWTUTORIALUIMASK_METHOD_3_22C8F22E17A3A439_OFFSET UNITYSDK_OFFSET(0x1D532860)
#define RPG_GAMECORE_SHOWTUTORIALUIMASK_METHOD_3_B7749A00808F7EFC_OFFSET UNITYSDK_OFFSET(0x1D5328B0)
#define RPG_GAMECORE_SHOWTUTORIALUIMASK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5328A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowTutorialUIMask_TypeDefinitionIndex = 24063;
