...
#define RPG_GAMECORE_ROGUEACTPERSONAALLROOMCARDCASTRESETCONFIG_METHOD_7_73BF89DCA39782C6_OFFSET UNITYSDK_OFFSET(0x175BB4C0)
#define RPG_GAMECORE_ROGUEACTPERSONAALLROOMCARDCASTRESETCONFIG_METHOD_7_999D6DE0A337BB53_OFFSET UNITYSDK_OFFSET(0x175BAFF0)
#define RPG_GAMECORE_ROGUEACTPERSONAALLROOMCARDCASTRESETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175BAF10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaAllRoomCardCastResetConfig_TypeDefinitionIndex = 18100;
