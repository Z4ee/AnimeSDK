...
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_PLAYBATCHANIMATION_METHOD_3_6409105B74D7D379_OFFSET UNITYSDK_OFFSET(0x1CFA6160)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_PLAYBATCHANIMATION_METHOD_3_E3EC7A04DDBE4063_OFFSET UNITYSDK_OFFSET(0x1CFA61C0)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_PLAYBATCHANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFA61B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleAbility_PlayBatchAnimation_TypeDefinitionIndex = 15567;
