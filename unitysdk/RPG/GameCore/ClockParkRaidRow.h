...
#define RPG_GAMECORE_CLOCKPARKRAIDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C25D250)
#define RPG_GAMECORE_CLOCKPARKRAIDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C25D800)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClockParkRaidRow_TypeDefinitionIndex = 10801;
