...
#define RPG_GAMECORE_CHARACTERHEADCONSTRAINT_METHOD_2_EEE7245AC9EB9767_OFFSET UNITYSDK_OFFSET(0x1706CAC0)
#define RPG_GAMECORE_CHARACTERHEADCONSTRAINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1706CBD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterHeadConstraint_TypeDefinitionIndex = 19190;
