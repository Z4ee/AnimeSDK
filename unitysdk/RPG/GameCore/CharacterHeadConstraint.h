...
#define RPG_GAMECORE_CHARACTERHEADCONSTRAINT_METHOD_2_EEE7245AC9EB9767_OFFSET UNITYSDK_OFFSET(0x1960E100)
#define RPG_GAMECORE_CHARACTERHEADCONSTRAINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1960E210)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterHeadConstraint_TypeDefinitionIndex = 19719;
