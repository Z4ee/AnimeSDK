...
#define RPG_GAMECORE_PROPCOMPONENT__UNLOADPUZZLEAREA_D__21_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19022D50)
#define RPG_GAMECORE_PROPCOMPONENT__UNLOADPUZZLEAREA_D__21_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19022E00)
#define RPG_GAMECORE_PROPCOMPONENT__UNLOADPUZZLEAREA_D__21_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19022E60)
#define RPG_GAMECORE_PROPCOMPONENT__UNLOADPUZZLEAREA_D__21_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19022E10)
#define RPG_GAMECORE_PROPCOMPONENT__UNLOADPUZZLEAREA_D__21_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19022D40)
#define RPG_GAMECORE_PROPCOMPONENT__UNLOADPUZZLEAREA_D__21__CTOR_OFFSET UNITYSDK_OFFSET(0x19010080)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropComponent__UnloadPuzzleArea_d__21_TypeDefinitionIndex = 57528;
