...
#define RPG_GAMECORE_BYTARGETLOCKHP_METHOD_4_76D9186D63DAC3CA_OFFSET UNITYSDK_OFFSET(0x187620A0)
#define RPG_GAMECORE_BYTARGETLOCKHP_METHOD_4_B39726CB584BD856_OFFSET UNITYSDK_OFFSET(0x18761FC0)
#define RPG_GAMECORE_BYTARGETLOCKHP__CTOR_OFFSET UNITYSDK_OFFSET(0x18762040)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByTargetLockHP_TypeDefinitionIndex = 22598;
