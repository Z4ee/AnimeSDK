...
#define RPG_GAMECORE_BYTARGETLOCKHP_METHOD_4_388C03259B2D7935_OFFSET UNITYSDK_OFFSET(0x1CDCA080)
#define RPG_GAMECORE_BYTARGETLOCKHP_METHOD_4_47068865CC762F93_OFFSET UNITYSDK_OFFSET(0x1CDC9DE0)
#define RPG_GAMECORE_BYTARGETLOCKHP_METHOD_4_76D9186D63DAC3CA_OFFSET UNITYSDK_OFFSET(0x1CDC9E30)
#define RPG_GAMECORE_BYTARGETLOCKHP_METHOD_4_87D8EFEF182A4E23_OFFSET UNITYSDK_OFFSET(0x1CDCA040)
#define RPG_GAMECORE_BYTARGETLOCKHP__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDC9E20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByTargetLockHP_TypeDefinitionIndex = 23349;
