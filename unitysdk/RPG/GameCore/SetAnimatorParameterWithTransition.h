...
#define RPG_GAMECORE_SETANIMATORPARAMETERWITHTRANSITION_METHOD_3_3F8B00BEEABB8596_OFFSET UNITYSDK_OFFSET(0x18E08FE0)
#define RPG_GAMECORE_SETANIMATORPARAMETERWITHTRANSITION_METHOD_3_DD2307795D3E37A0_OFFSET UNITYSDK_OFFSET(0x18E08EF0)
#define RPG_GAMECORE_SETANIMATORPARAMETERWITHTRANSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x18E08F30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetAnimatorParameterWithTransition_TypeDefinitionIndex = 21794;
