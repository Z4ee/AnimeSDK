...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYSHOPGOODNUMCONFIG_METHOD_3_152461E3D4C6E1AD_OFFSET UNITYSDK_OFFSET(0x1D164830)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYSHOPGOODNUMCONFIG_METHOD_3_53B8693196289C29_OFFSET UNITYSDK_OFFSET(0x1D1647E0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYSHOPGOODNUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D164820)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyShopGoodNumConfig_TypeDefinitionIndex = 17257;
