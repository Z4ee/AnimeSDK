...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYSHOPGOODNUMCONFIG_METHOD_3_152461E3D4C6E1AD_OFFSET UNITYSDK_OFFSET(0x17635FA0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYSHOPGOODNUMCONFIG_METHOD_3_B97D9F25199163B4_OFFSET UNITYSDK_OFFSET(0x17635ED0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYSHOPGOODNUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17635F50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyShopGoodNumConfig_TypeDefinitionIndex = 16528;
