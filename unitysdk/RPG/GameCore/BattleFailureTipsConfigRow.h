...
#define RPG_GAMECORE_BATTLEFAILURETIPSCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x194CF440)
#define RPG_GAMECORE_BATTLEFAILURETIPSCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x194CF9C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleFailureTipsConfigRow_TypeDefinitionIndex = 12248;
	...
	public:
		...
		::Il2CppArray<::System::UInt32>* StageIDForce; // 0x20
		::Il2CppArray<::System::UInt32>* WorldList; // 0x28
		::Il2CppArray<::RPG::GameCore::GameModeType>* GameModeList; // 0x30
		::Il2CppArray<::System::UInt32>* MainMissionUnfinishForce; // 0x38
		::Il2CppArray<::System::UInt32>* MainMissionFinishForce; // 0x40
		::Il2CppArray<::System::UInt32>* PlayerLevel; // 0x48
		::Il2CppArray<::System::String*>* CustomStringList; // 0x50
		::Il2CppArray<::System::UInt32>* MonsterTemplateIDList; // 0x58
		::Il2CppArray<::System::UInt32>* MainMissionTakenForce; // 0x60
		::System::UInt32 BattleFailureTipID; // 0x68
		::RPG::GameCore::BattleFailureTipType Type; // 0x6C
		::RPG::Client::TextID TipContent; // 0x70
		::System::UInt32 Priority; // 0x80
