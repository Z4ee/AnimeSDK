...
#define RPG_GAMECORE_BATTLEFAILURETIPSCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x186FBDE0)
#define RPG_GAMECORE_BATTLEFAILURETIPSCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x186FC440)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::System::UInt32>* PlayerLevel; // 0x30
		::Il2CppArray<::System::UInt32>* WorldList; // 0x38
		::Il2CppArray<::System::UInt32>* MainMissionFinishForce; // 0x40
		::Il2CppArray<::RPG::GameCore::StageType>* StageTypeForce; // 0x48
		...
		::RPG::GameCore::BattleFailureTipType Type; // 0x80
		::System::UInt32 BattleFailureTipID; // 0x84
