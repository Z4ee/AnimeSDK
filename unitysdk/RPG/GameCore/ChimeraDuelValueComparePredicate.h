...
#define RPG_GAMECORE_CHIMERADUELVALUECOMPAREPREDICATE_METHOD_3_0CCC44469E3CFBAB_OFFSET UNITYSDK_OFFSET(0x170A25D0)
#define RPG_GAMECORE_CHIMERADUELVALUECOMPAREPREDICATE_METHOD_3_9989082FD5FF9B43_OFFSET UNITYSDK_OFFSET(0x170A7D40)
#define RPG_GAMECORE_CHIMERADUELVALUECOMPAREPREDICATE__CTOR_OFFSET UNITYSDK_OFFSET(0x170A25C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelValueComparePredicate_TypeDefinitionIndex = 14669;
