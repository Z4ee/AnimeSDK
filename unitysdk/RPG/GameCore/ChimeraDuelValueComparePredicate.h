...
#define RPG_GAMECORE_CHIMERADUELVALUECOMPAREPREDICATE_METHOD_3_0CCC44469E3CFBAB_OFFSET UNITYSDK_OFFSET(0x18801910)
#define RPG_GAMECORE_CHIMERADUELVALUECOMPAREPREDICATE_METHOD_3_9989082FD5FF9B43_OFFSET UNITYSDK_OFFSET(0x188072F0)
#define RPG_GAMECORE_CHIMERADUELVALUECOMPAREPREDICATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18801900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelValueComparePredicate_TypeDefinitionIndex = 15139;
