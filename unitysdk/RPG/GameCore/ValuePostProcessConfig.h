...
#define RPG_GAMECORE_VALUEPOSTPROCESSCONFIG_METHOD_2_0ACC4AC96C3EFE2D_OFFSET UNITYSDK_OFFSET(0x1B899A40)
#define RPG_GAMECORE_VALUEPOSTPROCESSCONFIG_METHOD_2_52442D60C7824A6E_OFFSET UNITYSDK_OFFSET(0x1B899AA0)
#define RPG_GAMECORE_VALUEPOSTPROCESSCONFIG_METHOD_2_AD9F627D77468A29_OFFSET UNITYSDK_OFFSET(0x1B89A1F0)
#define RPG_GAMECORE_VALUEPOSTPROCESSCONFIG_METHOD_2_BC56F9321F1A2BDF_OFFSET UNITYSDK_OFFSET(0x1B899200)
#define RPG_GAMECORE_VALUEPOSTPROCESSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B895BF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ValuePostProcessConfig_TypeDefinitionIndex = 23181;
