...
#define RPG_GAMECORE_ELFDRINKMACHINECONFIG_METHOD_3_420011697488CB0F_OFFSET UNITYSDK_OFFSET(0x1D058980)
#define RPG_GAMECORE_ELFDRINKMACHINECONFIG_METHOD_3_60B4DF7F3A810887_OFFSET UNITYSDK_OFFSET(0x1D0589E0)
#define RPG_GAMECORE_ELFDRINKMACHINECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0589D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfDrinkMachineConfig_TypeDefinitionIndex = 18268;
