...
#define RPG_GAMECORE_BLOCKSUBMITEVENTS_METHOD_3_5DFE9CC7FDA56DA3_OFFSET UNITYSDK_OFFSET(0x16FE9720)
#define RPG_GAMECORE_BLOCKSUBMITEVENTS_METHOD_3_F81D693FEF74729A_OFFSET UNITYSDK_OFFSET(0x16FE97A0)
#define RPG_GAMECORE_BLOCKSUBMITEVENTS__CTOR_OFFSET UNITYSDK_OFFSET(0x16FE9770)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BlockSubmitEvents_TypeDefinitionIndex = 22322;
