...
#define RPG_GAMECORE_PLAYVIDEO_METHOD_3_1BDF90B2EDB7B6F8_OFFSET UNITYSDK_OFFSET(0x174C7EA0)
#define RPG_GAMECORE_PLAYVIDEO_METHOD_3_A05594646C89B722_OFFSET UNITYSDK_OFFSET(0x174C7E00)
#define RPG_GAMECORE_PLAYVIDEO__CTOR_OFFSET UNITYSDK_OFFSET(0x174C7E60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayVideo_TypeDefinitionIndex = 19204;
