...
#define RPG_GAMECORE_PLAYVIDEO_METHOD_3_1BDF90B2EDB7B6F8_OFFSET UNITYSDK_OFFSET(0x1BA089A0)
#define RPG_GAMECORE_PLAYVIDEO_METHOD_3_9852B344A9FDE03D_OFFSET UNITYSDK_OFFSET(0x1BA08950)
#define RPG_GAMECORE_PLAYVIDEO__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA08990)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayVideo_TypeDefinitionIndex = 20092;
