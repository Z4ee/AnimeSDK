...
#define RPG_GAMECORE_TRIGGERANIMSTATEONMODIFIERCUSTOMEVENT_METHOD_3_74D65921677ECB80_OFFSET UNITYSDK_OFFSET(0x1D5477F0)
#define RPG_GAMECORE_TRIGGERANIMSTATEONMODIFIERCUSTOMEVENT_METHOD_3_F020E81F9A1CD2AD_OFFSET UNITYSDK_OFFSET(0x1D547840)
#define RPG_GAMECORE_TRIGGERANIMSTATEONMODIFIERCUSTOMEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D547830)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerAnimStateOnModifierCustomEvent_TypeDefinitionIndex = 22870;
