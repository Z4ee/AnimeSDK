...
#define RPG_GAMECORE_TRIGGERANIMSTATEONMODIFIERCUSTOMEVENT_METHOD_3_9C072F47C9660DE6_OFFSET UNITYSDK_OFFSET(0x190BCEE0)
#define RPG_GAMECORE_TRIGGERANIMSTATEONMODIFIERCUSTOMEVENT_METHOD_3_F020E81F9A1CD2AD_OFFSET UNITYSDK_OFFSET(0x190BCF70)
#define RPG_GAMECORE_TRIGGERANIMSTATEONMODIFIERCUSTOMEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x190BCF40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerAnimStateOnModifierCustomEvent_TypeDefinitionIndex = 22073;
