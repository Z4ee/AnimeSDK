...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYSHOPGOODCOSTCONFIG_METHOD_3_DF40D3194D43FE31_OFFSET UNITYSDK_OFFSET(0x17635DF0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYSHOPGOODCOSTCONFIG_METHOD_3_F23BA1BB9CB712C8_OFFSET UNITYSDK_OFFSET(0x17635EC0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYSHOPGOODCOSTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17635E70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyShopGoodCostConfig_TypeDefinitionIndex = 16509;
