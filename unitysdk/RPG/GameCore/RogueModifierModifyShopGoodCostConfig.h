...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYSHOPGOODCOSTCONFIG_METHOD_3_7D892F191F01F94C_OFFSET UNITYSDK_OFFSET(0x1D164780)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYSHOPGOODCOSTCONFIG_METHOD_3_F23BA1BB9CB712C8_OFFSET UNITYSDK_OFFSET(0x1D1647D0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYSHOPGOODCOSTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1647C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyShopGoodCostConfig_TypeDefinitionIndex = 17238;
