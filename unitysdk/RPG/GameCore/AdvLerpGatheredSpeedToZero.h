...
#define RPG_GAMECORE_ADVLERPGATHEREDSPEEDTOZERO_METHOD_3_73D9BACFE1F9D9AA_OFFSET UNITYSDK_OFFSET(0x1CDCCDF0)
#define RPG_GAMECORE_ADVLERPGATHEREDSPEEDTOZERO_METHOD_3_AB951E512D945413_OFFSET UNITYSDK_OFFSET(0x1CDCCDB0)
#define RPG_GAMECORE_ADVLERPGATHEREDSPEEDTOZERO__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDCCDE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvLerpGatheredSpeedToZero_TypeDefinitionIndex = 20761;
