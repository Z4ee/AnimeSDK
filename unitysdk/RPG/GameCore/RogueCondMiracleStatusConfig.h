...
#define RPG_GAMECORE_ROGUECONDMIRACLESTATUSCONFIG_METHOD_6_9B83B137EC577AB3_OFFSET UNITYSDK_OFFSET(0x18CF7510)
#define RPG_GAMECORE_ROGUECONDMIRACLESTATUSCONFIG_METHOD_6_F2ACCF5415F9159D_OFFSET UNITYSDK_OFFSET(0x18CF77C0)
#define RPG_GAMECORE_ROGUECONDMIRACLESTATUSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CF7690)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueCondMiracleStatusConfig_TypeDefinitionIndex = 18801;
