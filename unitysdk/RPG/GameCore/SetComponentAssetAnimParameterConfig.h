...
#define RPG_GAMECORE_SETCOMPONENTASSETANIMPARAMETERCONFIG_METHOD_2_14E5E99F3751DBD5_OFFSET UNITYSDK_OFFSET(0x176B0260)
#define RPG_GAMECORE_SETCOMPONENTASSETANIMPARAMETERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x176B03C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetComponentAssetAnimParameterConfig_TypeDefinitionIndex = 21005;
