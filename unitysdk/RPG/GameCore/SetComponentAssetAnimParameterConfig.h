...
#define RPG_GAMECORE_SETCOMPONENTASSETANIMPARAMETERCONFIG_METHOD_2_14E5E99F3751DBD5_OFFSET UNITYSDK_OFFSET(0x1C2DA590)
#define RPG_GAMECORE_SETCOMPONENTASSETANIMPARAMETERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2DA6F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetComponentAssetAnimParameterConfig_TypeDefinitionIndex = 21989;
