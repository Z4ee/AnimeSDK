...
#define RPG_GAMECORE_ACTIVEACTIONCOUNTDOWN_METHOD_3_4655BE6618E5D798_OFFSET UNITYSDK_OFFSET(0x185FF9E0)
#define RPG_GAMECORE_ACTIVEACTIONCOUNTDOWN_METHOD_3_9BA2FDFD5AB4FBF1_OFFSET UNITYSDK_OFFSET(0x185FFA60)
#define RPG_GAMECORE_ACTIVEACTIONCOUNTDOWN__CTOR_OFFSET UNITYSDK_OFFSET(0x185FFA30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActiveActionCountDown_TypeDefinitionIndex = 22680;
