...
#define RPG_GAMECORE_BYINVISION_METHOD_4_6656D0A4635241BA_OFFSET UNITYSDK_OFFSET(0x1A8D40C0)
#define RPG_GAMECORE_BYINVISION_METHOD_4_6DCF8345B55F05FF_OFFSET UNITYSDK_OFFSET(0x1A8D4240)
#define RPG_GAMECORE_BYINVISION_METHOD_4_A3C5FE9A5FA99F73_OFFSET UNITYSDK_OFFSET(0x1A8D4070)
#define RPG_GAMECORE_BYINVISION_METHOD_4_EA5BCB09E90AA309_OFFSET UNITYSDK_OFFSET(0x1A8D4280)
#define RPG_GAMECORE_BYINVISION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8D40B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByInVision_TypeDefinitionIndex = 19988;
