...
#define RPG_GAMECORE_BYINVISION_METHOD_4_6656D0A4635241BA_OFFSET UNITYSDK_OFFSET(0x170288C0)
#define RPG_GAMECORE_BYINVISION_METHOD_4_7A55C768483C4A74_OFFSET UNITYSDK_OFFSET(0x170287E0)
#define RPG_GAMECORE_BYINVISION__CTOR_OFFSET UNITYSDK_OFFSET(0x17028860)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByInVision_TypeDefinitionIndex = 19093;
