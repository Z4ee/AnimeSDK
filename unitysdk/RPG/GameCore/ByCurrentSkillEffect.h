...
#define RPG_GAMECORE_BYCURRENTSKILLEFFECT_METHOD_4_30752953E6A2CF45_OFFSET UNITYSDK_OFFSET(0x1701F110)
#define RPG_GAMECORE_BYCURRENTSKILLEFFECT_METHOD_4_DBCFCA0ED9894A9E_OFFSET UNITYSDK_OFFSET(0x1701F030)
#define RPG_GAMECORE_BYCURRENTSKILLEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1701F0B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCurrentSkillEffect_TypeDefinitionIndex = 21226;
