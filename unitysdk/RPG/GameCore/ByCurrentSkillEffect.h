...
#define RPG_GAMECORE_BYCURRENTSKILLEFFECT_METHOD_4_123BDBFCBB78609C_OFFSET UNITYSDK_OFFSET(0x1A8B9680)
#define RPG_GAMECORE_BYCURRENTSKILLEFFECT_METHOD_4_30752953E6A2CF45_OFFSET UNITYSDK_OFFSET(0x1A8B96D0)
#define RPG_GAMECORE_BYCURRENTSKILLEFFECT_METHOD_4_E2E80DFD3EF08BEA_OFFSET UNITYSDK_OFFSET(0x1A8B99B0)
#define RPG_GAMECORE_BYCURRENTSKILLEFFECT_METHOD_4_E8CB82B96FFD6B14_OFFSET UNITYSDK_OFFSET(0x1A8B9970)
#define RPG_GAMECORE_BYCURRENTSKILLEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8B96C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCurrentSkillEffect_TypeDefinitionIndex = 22192;
