...
#define RPG_GAMECORE_SETDYNAMICVALUEBYSCEPTERPROPERTY_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x18E27900)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSCEPTERPROPERTY_METHOD_4_5A7B9659C89E2815_OFFSET UNITYSDK_OFFSET(0x18E27610)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSCEPTERPROPERTY_METHOD_4_F167C60CACD40235_OFFSET UNITYSDK_OFFSET(0x18E276E0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSCEPTERPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x18E27690)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByScepterProperty_TypeDefinitionIndex = 22045;
