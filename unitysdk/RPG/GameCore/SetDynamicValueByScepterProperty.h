...
#define RPG_GAMECORE_SETDYNAMICVALUEBYSCEPTERPROPERTY_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x176C4670)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSCEPTERPROPERTY_METHOD_4_5A7B9659C89E2815_OFFSET UNITYSDK_OFFSET(0x176C4380)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSCEPTERPROPERTY_METHOD_4_F167C60CACD40235_OFFSET UNITYSDK_OFFSET(0x176C4450)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSCEPTERPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x176C4400)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByScepterProperty_TypeDefinitionIndex = 21328;
