...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYMAGICROOMMARKPROBABILITYCONFIG_METHOD_3_0CBCB5D95136C041_OFFSET UNITYSDK_OFFSET(0x18D410C0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYMAGICROOMMARKPROBABILITYCONFIG_METHOD_3_E8F39CC57598A818_OFFSET UNITYSDK_OFFSET(0x18D41190)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYMAGICROOMMARKPROBABILITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D41140)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyMagicRoomMarkProbabilityConfig_TypeDefinitionIndex = 16835;
