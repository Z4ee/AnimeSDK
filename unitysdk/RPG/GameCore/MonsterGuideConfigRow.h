...
#define RPG_GAMECORE_MONSTERGUIDECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x199AC0E0)
#define RPG_GAMECORE_MONSTERGUIDECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x199AC880)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::Il2CppArray<::System::UInt32>* DifficultyList; // 0x10
