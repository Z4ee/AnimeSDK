...
#define RPG_GAMECORE_MONSTERGUIDECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B1C8370)
#define RPG_GAMECORE_MONSTERGUIDECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1C8B10)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::System::UInt32>* PhaseList; // 0x28
