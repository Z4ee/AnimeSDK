...
#define RPG_GAMECORE_MONSTERGUIDECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1744FC70)
#define RPG_GAMECORE_MONSTERGUIDECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17450420)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonsterGuideConfigRow_TypeDefinitionIndex = 12993;
