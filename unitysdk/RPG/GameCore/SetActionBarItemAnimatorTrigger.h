...
#define RPG_GAMECORE_SETACTIONBARITEMANIMATORTRIGGER_METHOD_3_1D546558AC1EAFCC_OFFSET UNITYSDK_OFFSET(0x1C2CFD00)
#define RPG_GAMECORE_SETACTIONBARITEMANIMATORTRIGGER_METHOD_3_D8F2233D3B5E73F1_OFFSET UNITYSDK_OFFSET(0x1C2CFD40)
#define RPG_GAMECORE_SETACTIONBARITEMANIMATORTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2CFD30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetActionBarItemAnimatorTrigger_TypeDefinitionIndex = 22343;
