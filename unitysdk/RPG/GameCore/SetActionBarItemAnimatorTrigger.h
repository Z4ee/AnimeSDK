...
#define RPG_GAMECORE_SETACTIONBARITEMANIMATORTRIGGER_METHOD_3_26F40ACAE0E5E5E2_OFFSET UNITYSDK_OFFSET(0x18E06DC0)
#define RPG_GAMECORE_SETACTIONBARITEMANIMATORTRIGGER_METHOD_3_D8F2233D3B5E73F1_OFFSET UNITYSDK_OFFSET(0x18E06E40)
#define RPG_GAMECORE_SETACTIONBARITEMANIMATORTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x18E06E10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetActionBarItemAnimatorTrigger_TypeDefinitionIndex = 22128;
