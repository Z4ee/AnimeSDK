...
#define RPG_GAMECORE_ROGUEMAGICCONDITIONCONFIGBASE_METHOD_6_9C224BD55FB17304_OFFSET UNITYSDK_OFFSET(0x1CFB54D0)
#define RPG_GAMECORE_ROGUEMAGICCONDITIONCONFIGBASE_METHOD_6_DF0C7A30CBDBEC7D_OFFSET UNITYSDK_OFFSET(0x1CFB56E0)
#define RPG_GAMECORE_ROGUEMAGICCONDITIONCONFIGBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFB5340)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueMagicConditionConfigBase_TypeDefinitionIndex = 18820;
