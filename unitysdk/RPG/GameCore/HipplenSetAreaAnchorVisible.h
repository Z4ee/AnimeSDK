...
#define RPG_GAMECORE_HIPPLENSETAREAANCHORVISIBLE_METHOD_3_7A9EA2734F2EDEB2_OFFSET UNITYSDK_OFFSET(0x18A05B90)
#define RPG_GAMECORE_HIPPLENSETAREAANCHORVISIBLE_METHOD_3_CC65DD3416E80510_OFFSET UNITYSDK_OFFSET(0x18A05B10)
#define RPG_GAMECORE_HIPPLENSETAREAANCHORVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x18A05B60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HipplenSetAreaAnchorVisible_TypeDefinitionIndex = 20299;
