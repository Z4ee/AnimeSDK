...
#define RPG_GAMECORE_HIPPLENSETAREAANCHORVISIBLE_METHOD_3_7A9EA2734F2EDEB2_OFFSET UNITYSDK_OFFSET(0x1B68A760)
#define RPG_GAMECORE_HIPPLENSETAREAANCHORVISIBLE_METHOD_3_E579DB78F3CFA92D_OFFSET UNITYSDK_OFFSET(0x1B68A710)
#define RPG_GAMECORE_HIPPLENSETAREAANCHORVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B68A750)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HipplenSetAreaAnchorVisible_TypeDefinitionIndex = 20521;
