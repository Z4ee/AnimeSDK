...
#define RPG_GAMECORE_HIPPLENSETAREAANCHORVISIBLE_METHOD_3_7A9EA2734F2EDEB2_OFFSET UNITYSDK_OFFSET(0x172B0F70)
#define RPG_GAMECORE_HIPPLENSETAREAANCHORVISIBLE_METHOD_3_CC65DD3416E80510_OFFSET UNITYSDK_OFFSET(0x172B0EF0)
#define RPG_GAMECORE_HIPPLENSETAREAANCHORVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x172B0F40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HipplenSetAreaAnchorVisible_TypeDefinitionIndex = 19619;
