...
#define RPG_GAMECORE_ROGUETOURNKEYWORDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D48A870)
#define RPG_GAMECORE_ROGUETOURNKEYWORDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D48AB20)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::Il2CppArray<::System::UInt32>* MazeBuffList; // 0x10
		::System::String* KeywordIcon; // 0x18
