...
#define RPG_GAMECORE_ROGUETOURNKEYWORDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19BCB510)
#define RPG_GAMECORE_ROGUETOURNKEYWORDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19BCB7C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournKeywordRow_TypeDefinitionIndex = 14278;
	...
	public:
		...
		::System::UInt32 KeywordExtraEffect; // 0x2C
