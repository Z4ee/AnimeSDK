...
#define RPG_GAMECORE_TRIGGERDEADHANDLER_METHOD_3_5725CE592047BA15_OFFSET UNITYSDK_OFFSET(0x178C1770)
#define RPG_GAMECORE_TRIGGERDEADHANDLER_METHOD_3_CB0B9C363E504089_OFFSET UNITYSDK_OFFSET(0x178C1880)
#define RPG_GAMECORE_TRIGGERDEADHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x178C1850)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerDeadHandler_TypeDefinitionIndex = 20611;
