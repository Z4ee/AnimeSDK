...
#define RPG_GAMECORE_TRIGGERDEADHANDLER_METHOD_3_AC53DE00CBADDB4C_OFFSET UNITYSDK_OFFSET(0x1B048410)
#define RPG_GAMECORE_TRIGGERDEADHANDLER_METHOD_3_CB0B9C363E504089_OFFSET UNITYSDK_OFFSET(0x1B0484E0)
#define RPG_GAMECORE_TRIGGERDEADHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0484D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerDeadHandler_TypeDefinitionIndex = 21606;
