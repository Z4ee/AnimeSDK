...
#define RPG_GAMECORE_TRIGGERDEADHANDLER_METHOD_3_5725CE592047BA15_OFFSET UNITYSDK_OFFSET(0x19E0A9C0)
#define RPG_GAMECORE_TRIGGERDEADHANDLER_METHOD_3_CB0B9C363E504089_OFFSET UNITYSDK_OFFSET(0x19E0AAD0)
#define RPG_GAMECORE_TRIGGERDEADHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19E0AAA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerDeadHandler_TypeDefinitionIndex = 21191;
