...
#define RPG_GAMECORE_SETDYNAMICVALUEBYBREAKBASEDAMAGE_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x19C409D0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBREAKBASEDAMAGE_METHOD_4_AAFA4C9E08A78775_OFFSET UNITYSDK_OFFSET(0x19C40950)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBREAKBASEDAMAGE_METHOD_4_ED62D92A49158885_OFFSET UNITYSDK_OFFSET(0x19C37E80)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBREAKBASEDAMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C37E30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByBreakBaseDamage_TypeDefinitionIndex = 22311;
