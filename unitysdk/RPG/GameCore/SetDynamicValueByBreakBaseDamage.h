...
#define RPG_GAMECORE_SETDYNAMICVALUEBYBREAKBASEDAMAGE_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1C2E0160)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBREAKBASEDAMAGE_METHOD_4_7DB35A4B7CCF21D0_OFFSET UNITYSDK_OFFSET(0x1C2DFF70)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBREAKBASEDAMAGE_METHOD_4_ED62D92A49158885_OFFSET UNITYSDK_OFFSET(0x1C2DFFB0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBREAKBASEDAMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2DFFA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByBreakBaseDamage_TypeDefinitionIndex = 22752;
