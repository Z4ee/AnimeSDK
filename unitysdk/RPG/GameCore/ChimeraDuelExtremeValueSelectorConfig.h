...
#define RPG_GAMECORE_CHIMERADUELEXTREMEVALUESELECTORCONFIG_METHOD_3_5BB38ADE4FD91208_OFFSET UNITYSDK_OFFSET(0x187FB2F0)
#define RPG_GAMECORE_CHIMERADUELEXTREMEVALUESELECTORCONFIG_METHOD_3_65FFE7FD80CDF64F_OFFSET UNITYSDK_OFFSET(0x187FB360)
#define RPG_GAMECORE_CHIMERADUELEXTREMEVALUESELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x187FB350)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelExtremeValueSelectorConfig_TypeDefinitionIndex = 15103;
