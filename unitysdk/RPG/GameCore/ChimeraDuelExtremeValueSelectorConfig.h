...
#define RPG_GAMECORE_CHIMERADUELEXTREMEVALUESELECTORCONFIG_METHOD_3_5BB38ADE4FD91208_OFFSET UNITYSDK_OFFSET(0x1963D4A0)
#define RPG_GAMECORE_CHIMERADUELEXTREMEVALUESELECTORCONFIG_METHOD_3_65FFE7FD80CDF64F_OFFSET UNITYSDK_OFFSET(0x1963D510)
#define RPG_GAMECORE_CHIMERADUELEXTREMEVALUESELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1963D500)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelExtremeValueSelectorConfig_TypeDefinitionIndex = 15166;
