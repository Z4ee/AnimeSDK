...
#define RPG_GAMECORE_SKILLEXECUTIONSTART_METHOD_3_5D9702C451300878_OFFSET UNITYSDK_OFFSET(0x1770E890)
#define RPG_GAMECORE_SKILLEXECUTIONSTART_METHOD_3_EA412C0BCB9298A4_OFFSET UNITYSDK_OFFSET(0x1770E9A0)
#define RPG_GAMECORE_SKILLEXECUTIONSTART__CTOR_OFFSET UNITYSDK_OFFSET(0x1770E970)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SkillExecutionStart_TypeDefinitionIndex = 20905;
