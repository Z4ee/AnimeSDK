...
#define RPG_GAMECORE_ATTACHENTITYUNSELECTABLE_METHOD_3_62FEA316AD55118E_OFFSET UNITYSDK_OFFSET(0x16F8A210)
#define RPG_GAMECORE_ATTACHENTITYUNSELECTABLE_METHOD_3_EDEB6BCDC10052BA_OFFSET UNITYSDK_OFFSET(0x16F8A320)
#define RPG_GAMECORE_ATTACHENTITYUNSELECTABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F8A2F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AttachEntityUnselectable_TypeDefinitionIndex = 20907;
