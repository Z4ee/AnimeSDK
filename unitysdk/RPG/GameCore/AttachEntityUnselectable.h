...
#define RPG_GAMECORE_ATTACHENTITYUNSELECTABLE_METHOD_3_0BE328EF3FF73917_OFFSET UNITYSDK_OFFSET(0x1A065250)
#define RPG_GAMECORE_ATTACHENTITYUNSELECTABLE_METHOD_3_EDEB6BCDC10052BA_OFFSET UNITYSDK_OFFSET(0x1A065320)
#define RPG_GAMECORE_ATTACHENTITYUNSELECTABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A065310)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AttachEntityUnselectable_TypeDefinitionIndex = 21902;
