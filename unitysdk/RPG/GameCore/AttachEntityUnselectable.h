...
#define RPG_GAMECORE_ATTACHENTITYUNSELECTABLE_METHOD_3_62FEA316AD55118E_OFFSET UNITYSDK_OFFSET(0x19485380)
#define RPG_GAMECORE_ATTACHENTITYUNSELECTABLE_METHOD_3_EDEB6BCDC10052BA_OFFSET UNITYSDK_OFFSET(0x19485490)
#define RPG_GAMECORE_ATTACHENTITYUNSELECTABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x19485460)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AttachEntityUnselectable_TypeDefinitionIndex = 21482;
