...
#define RPG_GAMECORE_SWITCHCASETASKLISTBYATTACKDAMAGETYPE_METHOD_2_60853A5E9CF47B44_OFFSET UNITYSDK_OFFSET(0x18EB92A0)
#define RPG_GAMECORE_SWITCHCASETASKLISTBYATTACKDAMAGETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x18EB93D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchCaseTaskListByAttackDamageType_TypeDefinitionIndex = 22763;
