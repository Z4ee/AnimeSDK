...
#define RPG_GAMECORE_SWITCHCASETASKLISTBYATTACKDAMAGETYPE_METHOD_2_60853A5E9CF47B44_OFFSET UNITYSDK_OFFSET(0x17793040)
#define RPG_GAMECORE_SWITCHCASETASKLISTBYATTACKDAMAGETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x17793170)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchCaseTaskListByAttackDamageType_TypeDefinitionIndex = 22047;
