...
#define RPG_GAMECORE_PLAYERICONCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D7AB660)
#define RPG_GAMECORE_PLAYERICONCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7ABDE0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::IconType Type; // 0x2C
