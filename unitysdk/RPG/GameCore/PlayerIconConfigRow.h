...
#define RPG_GAMECORE_PLAYERICONCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D34F5F0)
#define RPG_GAMECORE_PLAYERICONCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D34FD70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayerIconConfigRow_TypeDefinitionIndex = 14331;
	...
	public:
		...
		::RPG::GameCore::IconType Type; // 0x20
		::System::Boolean IsVisible; // 0x24
		::System::UInt32 ID; // 0x28
		::System::UInt32 Sort; // 0x2C
