...
#define RPG_GAMECORE_STAGEPREFABINFO_METHOD_2_29195A4AE874DBA1_OFFSET UNITYSDK_OFFSET(0x1776B1C0)
#define RPG_GAMECORE_STAGEPREFABINFO_METHOD_2_2B2047CDA46EB222_OFFSET UNITYSDK_OFFSET(0x1776B040)
#define RPG_GAMECORE_STAGEPREFABINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1776B1B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StagePrefabInfo_TypeDefinitionIndex = 17507;
