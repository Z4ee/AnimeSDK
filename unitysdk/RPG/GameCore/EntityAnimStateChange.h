...
#define RPG_GAMECORE_ENTITYANIMSTATECHANGE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xE5DE250)
#define RPG_GAMECORE_ENTITYANIMSTATECHANGE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xE5DE210)
#define RPG_GAMECORE_ENTITYANIMSTATECHANGE_INIT_OFFSET UNITYSDK_OFFSET(0xE5DE1C0)
#define RPG_GAMECORE_ENTITYANIMSTATECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0xE5DE2A0)
