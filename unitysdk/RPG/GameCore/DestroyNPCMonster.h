...
#define RPG_GAMECORE_DESTROYNPCMONSTER_METHOD_3_4B150DAF6771236F_OFFSET UNITYSDK_OFFSET(0x171544F0)
#define RPG_GAMECORE_DESTROYNPCMONSTER_METHOD_3_55AE5D411A652FE6_OFFSET UNITYSDK_OFFSET(0x17154570)
#define RPG_GAMECORE_DESTROYNPCMONSTER__CTOR_OFFSET UNITYSDK_OFFSET(0x17154540)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DestroyNPCMonster_TypeDefinitionIndex = 20122;
