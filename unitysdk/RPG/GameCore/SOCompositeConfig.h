...
#define RPG_GAMECORE_SOCOMPOSITECONFIG_METHOD_4_6BE204EFAD569F8E_OFFSET UNITYSDK_OFFSET(0x18DDED90)
#define RPG_GAMECORE_SOCOMPOSITECONFIG_METHOD_4_F2896E765C3D892C_OFFSET UNITYSDK_OFFSET(0x18DDE500)
#define RPG_GAMECORE_SOCOMPOSITECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18DDEFE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SOCompositeConfig_TypeDefinitionIndex = 18976;
