...
#define RPG_GAMECORE_LOADINGSPECIALTYPECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18A746A0)
#define RPG_GAMECORE_LOADINGSPECIALTYPECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18A74860)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoadingSpecialTypeConfigRow_TypeDefinitionIndex = 13246;
