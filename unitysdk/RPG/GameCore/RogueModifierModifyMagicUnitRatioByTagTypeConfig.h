...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYMAGICUNITRATIOBYTAGTYPECONFIG_METHOD_3_63DC58FFBF96EC94_OFFSET UNITYSDK_OFFSET(0x176348F0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYMAGICUNITRATIOBYTAGTYPECONFIG_METHOD_3_DAD16432DAFF640D_OFFSET UNITYSDK_OFFSET(0x176349C0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYMAGICUNITRATIOBYTAGTYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17634970)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyMagicUnitRatioByTagTypeConfig_TypeDefinitionIndex = 16292;
