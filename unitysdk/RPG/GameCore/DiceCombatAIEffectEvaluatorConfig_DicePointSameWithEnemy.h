...
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEPOINTSAMEWITHENEMY_METHOD_3_764F2CEFEE28A6A3_OFFSET UNITYSDK_OFFSET(0x18863950)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEPOINTSAMEWITHENEMY_METHOD_3_BB1C0E2DF1253F22_OFFSET UNITYSDK_OFFSET(0x188641D0)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEPOINTSAMEWITHENEMY__CTOR_OFFSET UNITYSDK_OFFSET(0x18863940)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatAIEffectEvaluatorConfig_DicePointSameWithEnemy_TypeDefinitionIndex = 15341;
