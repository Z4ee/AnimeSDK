...
#define RPG_GAMECORE_KRATERWORLDSHOPUPGRADECONFIG_METHOD_2_81AB38B5B1B79088_OFFSET UNITYSDK_OFFSET(0x1986B1D0)
#define RPG_GAMECORE_KRATERWORLDSHOPUPGRADECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1986B2A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int KraterWorldShopUpgradeConfig_TypeDefinitionIndex = 15973;
