...
#define RPG_GAMECORE_LEVELPROPMAPHELIOBUSCHALLENGEPARAM_METHOD_3_AEC88C6D75322C15_OFFSET UNITYSDK_OFFSET(0x1734AFC0)
#define RPG_GAMECORE_LEVELPROPMAPHELIOBUSCHALLENGEPARAM_METHOD_3_D1ED602326974780_OFFSET UNITYSDK_OFFSET(0x1734AF10)
#define RPG_GAMECORE_LEVELPROPMAPHELIOBUSCHALLENGEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1734AFB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPropMapHeliobusChallengeParam_TypeDefinitionIndex = 15850;
