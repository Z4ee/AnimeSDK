...
#define RPG_GAMECORE_CHIMERADUELNPCFIREEFFECTNODE_METHOD_3_797014C79AA3D703_OFFSET UNITYSDK_OFFSET(0x18800A80)
#define RPG_GAMECORE_CHIMERADUELNPCFIREEFFECTNODE_METHOD_3_8E91CB792C443B16_OFFSET UNITYSDK_OFFSET(0x18800980)
#define RPG_GAMECORE_CHIMERADUELNPCFIREEFFECTNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x18800A20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelNpcFireEffectNode_TypeDefinitionIndex = 15114;
