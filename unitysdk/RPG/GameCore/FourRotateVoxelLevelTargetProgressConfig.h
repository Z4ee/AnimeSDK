...
#define RPG_GAMECORE_FOURROTATEVOXELLEVELTARGETPROGRESSCONFIG_METHOD_2_B944A30025BFE3A8_OFFSET UNITYSDK_OFFSET(0x1892F750)
#define RPG_GAMECORE_FOURROTATEVOXELLEVELTARGETPROGRESSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1892F930)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FourRotateVoxelLevelTargetProgressConfig_TypeDefinitionIndex = 15867;
