...
#define RPG_GAMECORE_TRYTRIGGERAID_METHOD_3_1682F96EAB3AF4F4_OFFSET UNITYSDK_OFFSET(0x1D29CBA0)
#define RPG_GAMECORE_TRYTRIGGERAID_METHOD_3_FD5896B3643212D9_OFFSET UNITYSDK_OFFSET(0x1D29CB60)
#define RPG_GAMECORE_TRYTRIGGERAID__CTOR_OFFSET UNITYSDK_OFFSET(0x1D29CB90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TryTriggerAid_TypeDefinitionIndex = 23370;
