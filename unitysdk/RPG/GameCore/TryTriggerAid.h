...
#define RPG_GAMECORE_TRYTRIGGERAID_METHOD_3_0B10079365CE8FCD_OFFSET UNITYSDK_OFFSET(0x19E21A40)
#define RPG_GAMECORE_TRYTRIGGERAID_METHOD_3_1682F96EAB3AF4F4_OFFSET UNITYSDK_OFFSET(0x19E21AC0)
#define RPG_GAMECORE_TRYTRIGGERAID__CTOR_OFFSET UNITYSDK_OFFSET(0x19E21A90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TryTriggerAid_TypeDefinitionIndex = 22350;
