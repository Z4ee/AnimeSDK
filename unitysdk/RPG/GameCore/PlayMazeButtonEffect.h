...
#define RPG_GAMECORE_PLAYMAZEBUTTONEFFECT_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1D7A45A0)
#define RPG_GAMECORE_PLAYMAZEBUTTONEFFECT_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D7A4560)
#define RPG_GAMECORE_PLAYMAZEBUTTONEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7A4590)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayMazeButtonEffect_TypeDefinitionIndex = 20262;
