...
#define RPG_GAMECORE_PLAYMAZEBUTTONEFFECT_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x174C22C0)
#define RPG_GAMECORE_PLAYMAZEBUTTONEFFECT_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x174C2240)
#define RPG_GAMECORE_PLAYMAZEBUTTONEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x174C2290)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayMazeButtonEffect_TypeDefinitionIndex = 18798;
