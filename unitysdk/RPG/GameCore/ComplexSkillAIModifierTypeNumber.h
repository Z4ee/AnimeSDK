...
#define RPG_GAMECORE_COMPLEXSKILLAIMODIFIERTYPENUMBER_METHOD_3_5B9115179112F210_OFFSET UNITYSDK_OFFSET(0x17123E20)
#define RPG_GAMECORE_COMPLEXSKILLAIMODIFIERTYPENUMBER_METHOD_3_B6977E2EB11E27AC_OFFSET UNITYSDK_OFFSET(0x17123EB0)
#define RPG_GAMECORE_COMPLEXSKILLAIMODIFIERTYPENUMBER__CTOR_OFFSET UNITYSDK_OFFSET(0x17123E90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAIModifierTypeNumber_TypeDefinitionIndex = 14247;
