...
#define RPG_GAMECORE_PINGPONGPATROLROUTECMPTCONFIG_METHOD_3_3DCC20A19D92D399_OFFSET UNITYSDK_OFFSET(0x174B1E30)
#define RPG_GAMECORE_PINGPONGPATROLROUTECMPTCONFIG_METHOD_3_F6D074428C1F64FD_OFFSET UNITYSDK_OFFSET(0x174B1DA0)
#define RPG_GAMECORE_PINGPONGPATROLROUTECMPTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x174B1E10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PingPongPatrolRouteCmptConfig_TypeDefinitionIndex = 17374;
