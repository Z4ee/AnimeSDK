...
#define RPG_GAMECORE_SETTARGETTRACKMOVE_METHOD_3_2EDB580E08743F56_OFFSET UNITYSDK_OFFSET(0x1C60C690)
#define RPG_GAMECORE_SETTARGETTRACKMOVE_METHOD_3_31FF36CFC9611CDA_OFFSET UNITYSDK_OFFSET(0x1C60C5B0)
#define RPG_GAMECORE_SETTARGETTRACKMOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C60C630)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetTargetTrackMove_TypeDefinitionIndex = 19391;
