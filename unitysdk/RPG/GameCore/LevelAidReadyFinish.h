...
#define RPG_GAMECORE_LEVELAIDREADYFINISH_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1BDE8B70)
#define RPG_GAMECORE_LEVELAIDREADYFINISH_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x1BDE8B20)
#define RPG_GAMECORE_LEVELAIDREADYFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDE8BC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelAidReadyFinish_TypeDefinitionIndex = 54264;
