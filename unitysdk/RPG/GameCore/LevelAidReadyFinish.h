...
#define RPG_GAMECORE_LEVELAIDREADYFINISH_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xB6C4F10)
#define RPG_GAMECORE_LEVELAIDREADYFINISH_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xB6C4EC0)
#define RPG_GAMECORE_LEVELAIDREADYFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0xB6C4F60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelAidReadyFinish_TypeDefinitionIndex = 52354;
