...
#define RPG_GAMECORE_BATTLEPERFORMSTAGECONFIG_METHOD_2_937440B774D5DB89_OFFSET UNITYSDK_OFFSET(0x16FDE620)
#define RPG_GAMECORE_BATTLEPERFORMSTAGECONFIG_METHOD_2_A5912159B00E96B8_OFFSET UNITYSDK_OFFSET(0x16FDE340)
#define RPG_GAMECORE_BATTLEPERFORMSTAGECONFIG_METHOD_2_FA22BD1A983B1E85_OFFSET UNITYSDK_OFFSET(0x16FDE540)
#define RPG_GAMECORE_BATTLEPERFORMSTAGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16FDE530)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattlePerformStageConfig_TypeDefinitionIndex = 16653;
	...
	public:
		...
		static ::System::Void Method_2_A5912159B00E96B8(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::BattlePerformStageConfig*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::BattlePerformStageConfig*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_BATTLEPERFORMSTAGECONFIG_METHOD_2_A5912159B00E96B8_OFFSET))(a1, a2);
		}
