...
#define RPG_GAMECORE_BATTLEPERFORMSTAGECONFIG_METHOD_2_937440B774D5DB89_OFFSET UNITYSDK_OFFSET(0x18702040)
#define RPG_GAMECORE_BATTLEPERFORMSTAGECONFIG_METHOD_2_A5912159B00E96B8_OFFSET UNITYSDK_OFFSET(0x18701D60)
#define RPG_GAMECORE_BATTLEPERFORMSTAGECONFIG_METHOD_2_FA22BD1A983B1E85_OFFSET UNITYSDK_OFFSET(0x18701F60)
#define RPG_GAMECORE_BATTLEPERFORMSTAGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18701F50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattlePerformStageConfig_TypeDefinitionIndex = 17245;
