...
#define RPG_GAMECORE_STARTDIALOGUEENTITYINTERACT_METHOD_3_3143EB70B9C054BC_OFFSET UNITYSDK_OFFSET(0x18E99FF0)
#define RPG_GAMECORE_STARTDIALOGUEENTITYINTERACT_METHOD_3_F7136761A55A8627_OFFSET UNITYSDK_OFFSET(0x18E9A070)
#define RPG_GAMECORE_STARTDIALOGUEENTITYINTERACT__CTOR_OFFSET UNITYSDK_OFFSET(0x18E9A040)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StartDialogueEntityInteract_TypeDefinitionIndex = 19345;
