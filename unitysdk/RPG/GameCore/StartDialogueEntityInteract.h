...
#define RPG_GAMECORE_STARTDIALOGUEENTITYINTERACT_METHOD_3_3143EB70B9C054BC_OFFSET UNITYSDK_OFFSET(0x17774410)
#define RPG_GAMECORE_STARTDIALOGUEENTITYINTERACT_METHOD_3_F7136761A55A8627_OFFSET UNITYSDK_OFFSET(0x17774490)
#define RPG_GAMECORE_STARTDIALOGUEENTITYINTERACT__CTOR_OFFSET UNITYSDK_OFFSET(0x17774460)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StartDialogueEntityInteract_TypeDefinitionIndex = 18688;
