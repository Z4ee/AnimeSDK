...
#define RPG_GAMECORE_PIXAIREFFECTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19A10700)
#define RPG_GAMECORE_PIXAIREFFECTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19A10930)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PixAirEffectRow_TypeDefinitionIndex = 11599;
