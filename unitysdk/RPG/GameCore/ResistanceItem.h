...
#define RPG_GAMECORE_RESISTANCEITEM_METHOD_2_78EF0B7C1F4CBEB7_OFFSET UNITYSDK_OFFSET(0x1D01DB30)
#define RPG_GAMECORE_RESISTANCEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D01DC90)
