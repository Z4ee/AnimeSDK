...
#define RPG_GAMECORE_MARBLEMATCHLEVELCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x173923B0)
#define RPG_GAMECORE_MARBLEMATCHLEVELCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x173925F0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 TutorialGroupID; // 0x18
