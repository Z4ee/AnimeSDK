...
#define RPG_GAMECORE_ADDREGARDASATTACKTYPE_METHOD_3_237B720EDBA8BC16_OFFSET UNITYSDK_OFFSET(0x1D6A46F0)
#define RPG_GAMECORE_ADDREGARDASATTACKTYPE_METHOD_3_7E23866A22331543_OFFSET UNITYSDK_OFFSET(0x1D6A4730)
#define RPG_GAMECORE_ADDREGARDASATTACKTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6A4720)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddRegardAsAttackType_TypeDefinitionIndex = 22947;
