...
#define RPG_GAMECORE_HIDEEFFECTAUTOLAYOUT_METHOD_3_864141A7762A4045_OFFSET UNITYSDK_OFFSET(0x172A9050)
#define RPG_GAMECORE_HIDEEFFECTAUTOLAYOUT_METHOD_3_E5DB7C9101835450_OFFSET UNITYSDK_OFFSET(0x172A8FD0)
#define RPG_GAMECORE_HIDEEFFECTAUTOLAYOUT__CTOR_OFFSET UNITYSDK_OFFSET(0x172A9020)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HideEffectAutoLayout_TypeDefinitionIndex = 20626;
