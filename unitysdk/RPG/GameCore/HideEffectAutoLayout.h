...
#define RPG_GAMECORE_HIDEEFFECTAUTOLAYOUT_METHOD_3_289874D3BE88EC40_OFFSET UNITYSDK_OFFSET(0x1D18C960)
#define RPG_GAMECORE_HIDEEFFECTAUTOLAYOUT_METHOD_3_864141A7762A4045_OFFSET UNITYSDK_OFFSET(0x1D18C9B0)
#define RPG_GAMECORE_HIDEEFFECTAUTOLAYOUT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D18C9A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HideEffectAutoLayout_TypeDefinitionIndex = 22184;
