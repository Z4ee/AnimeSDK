...
#define RPG_GAMECORE_HIPPLENBALLFETCHINTERACTWORKCONFIG_METHOD_3_1C39CE2AD128FB0E_OFFSET UNITYSDK_OFFSET(0x1B6857E0)
#define RPG_GAMECORE_HIPPLENBALLFETCHINTERACTWORKCONFIG_METHOD_3_BEC33EF161559520_OFFSET UNITYSDK_OFFSET(0x1B685780)
#define RPG_GAMECORE_HIPPLENBALLFETCHINTERACTWORKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6857D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HipplenBallFetchInteractWorkConfig_TypeDefinitionIndex = 16125;
