...
#define RPG_GAMECORE_MESSAGEITEMROW_FROMBINARYWITHOUTNEW_OFFSET UNITYSDK_OFFSET(0x1AF5D540)
#define RPG_GAMECORE_MESSAGEITEMROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1AF5D8B0)
#define RPG_GAMECORE_MESSAGEITEMROW_FROMTABLEOFFSET_OFFSET UNITYSDK_OFFSET(0x1AF5F900)
#define RPG_GAMECORE_MESSAGEITEMROW_GET_CANBESENT_OFFSET UNITYSDK_OFFSET(0x1AF5F9B0)
#define RPG_GAMECORE_MESSAGEITEMROW_GET_ISEND_OFFSET UNITYSDK_OFFSET(0x1AF5F990)
#define RPG_GAMECORE_MESSAGEITEMROW_RESET_OFFSET UNITYSDK_OFFSET(0x1AF5F960)
#define RPG_GAMECORE_MESSAGEITEMROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF5F980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MessageItemRow_TypeDefinitionIndex = 13878;
	...
	public:
		...
		::RPG::GameCore::SenderType Sender; // 0x44
		::System::UInt32 ItemContentID; // 0x48
		::System::UInt32 SectionID; // 0x4C
