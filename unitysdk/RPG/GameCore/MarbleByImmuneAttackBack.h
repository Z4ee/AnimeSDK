...
#define RPG_GAMECORE_MARBLEBYIMMUNEATTACKBACK_METHOD_4_4B5AE0432B10E5F1_OFFSET UNITYSDK_OFFSET(0x1BD15B90)
#define RPG_GAMECORE_MARBLEBYIMMUNEATTACKBACK_METHOD_4_7B4B82F0B3EBAFC3_OFFSET UNITYSDK_OFFSET(0x1BD15BF0)
#define RPG_GAMECORE_MARBLEBYIMMUNEATTACKBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD15BE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleByImmuneAttackBack_TypeDefinitionIndex = 16221;
