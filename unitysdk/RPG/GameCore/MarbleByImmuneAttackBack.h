...
#define RPG_GAMECORE_MARBLEBYIMMUNEATTACKBACK_METHOD_4_4B5AE0432B10E5F1_OFFSET UNITYSDK_OFFSET(0x1D4A5DF0)
#define RPG_GAMECORE_MARBLEBYIMMUNEATTACKBACK_METHOD_4_7B4B82F0B3EBAFC3_OFFSET UNITYSDK_OFFSET(0x1D4A5E50)
#define RPG_GAMECORE_MARBLEBYIMMUNEATTACKBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4A5E40)
