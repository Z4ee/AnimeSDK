...
#define RPG_GAMECORE_MARBLEBYIMMUNEATTACKBACK_METHOD_4_0861999BD2C0D2A5_OFFSET UNITYSDK_OFFSET(0x1738B420)
#define RPG_GAMECORE_MARBLEBYIMMUNEATTACKBACK_METHOD_4_51000A96990515A0_OFFSET UNITYSDK_OFFSET(0x1738B340)
#define RPG_GAMECORE_MARBLEBYIMMUNEATTACKBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1738B3D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleByImmuneAttackBack_TypeDefinitionIndex = 15467;
