...
#define RPG_GAMECORE_FATEACTADDBUFFCOUNTCONFIG_METHOD_6_8854D9E7188E8811_OFFSET UNITYSDK_OFFSET(0x1C073190)
#define RPG_GAMECORE_FATEACTADDBUFFCOUNTCONFIG_METHOD_6_FC775AFDE0A652AD_OFFSET UNITYSDK_OFFSET(0x1C073140)
#define RPG_GAMECORE_FATEACTADDBUFFCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C073180)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateActAddBuffCountConfig_TypeDefinitionIndex = 18471;
