...
#define RPG_GAMECORE_FATEACTADDBUFFCOUNTCONFIG_METHOD_6_8854D9E7188E8811_OFFSET UNITYSDK_OFFSET(0x171C02A0)
#define RPG_GAMECORE_FATEACTADDBUFFCOUNTCONFIG_METHOD_6_EA8861A9A754508A_OFFSET UNITYSDK_OFFSET(0x171C0130)
#define RPG_GAMECORE_FATEACTADDBUFFCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171C0200)
