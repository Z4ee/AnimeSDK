...
#define RPG_GAMECORE_FATEACTADDBUFFCOUNTCONFIG_METHOD_6_8854D9E7188E8811_OFFSET UNITYSDK_OFFSET(0x1970A9C0)
#define RPG_GAMECORE_FATEACTADDBUFFCOUNTCONFIG_METHOD_6_EA8861A9A754508A_OFFSET UNITYSDK_OFFSET(0x1970A850)
#define RPG_GAMECORE_FATEACTADDBUFFCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1970A920)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateActAddBuffCountConfig_TypeDefinitionIndex = 18237;
