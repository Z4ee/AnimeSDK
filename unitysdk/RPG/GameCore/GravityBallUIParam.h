...
#define RPG_GAMECORE_GRAVITYBALLUIPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x18439410)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GravityBallUIParam_TypeDefinitionIndex = 53186;
