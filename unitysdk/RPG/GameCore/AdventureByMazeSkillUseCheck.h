...
#define RPG_GAMECORE_ADVENTUREBYMAZESKILLUSECHECK_METHOD_4_36FE640D24138C17_OFFSET UNITYSDK_OFFSET(0x1CDE9970)
#define RPG_GAMECORE_ADVENTUREBYMAZESKILLUSECHECK_METHOD_4_3F21A508368587A6_OFFSET UNITYSDK_OFFSET(0x1CDE99B0)
#define RPG_GAMECORE_ADVENTUREBYMAZESKILLUSECHECK_METHOD_4_A9588FD40DC8C97C_OFFSET UNITYSDK_OFFSET(0x1CDE9B60)
#define RPG_GAMECORE_ADVENTUREBYMAZESKILLUSECHECK_METHOD_4_F6C6BDF8ACE1DC72_OFFSET UNITYSDK_OFFSET(0x1CDE9B30)
#define RPG_GAMECORE_ADVENTUREBYMAZESKILLUSECHECK__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDE99A0)
