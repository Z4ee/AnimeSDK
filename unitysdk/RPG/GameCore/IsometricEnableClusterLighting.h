...
#define RPG_GAMECORE_ISOMETRICENABLECLUSTERLIGHTING_METHOD_3_AC2E8026AF751243_OFFSET UNITYSDK_OFFSET(0x172C1D50)
#define RPG_GAMECORE_ISOMETRICENABLECLUSTERLIGHTING_METHOD_3_C5DC5FB9BC79E7BA_OFFSET UNITYSDK_OFFSET(0x172C1DD0)
#define RPG_GAMECORE_ISOMETRICENABLECLUSTERLIGHTING__CTOR_OFFSET UNITYSDK_OFFSET(0x172C1DA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int IsometricEnableClusterLighting_TypeDefinitionIndex = 20399;
