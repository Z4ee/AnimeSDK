...
#define RPG_GAMECORE_ISOMETRICENABLECLUSTERLIGHTING_METHOD_3_6BC4F6675F81C4B1_OFFSET UNITYSDK_OFFSET(0x1B0164D0)
#define RPG_GAMECORE_ISOMETRICENABLECLUSTERLIGHTING_METHOD_3_C5DC5FB9BC79E7BA_OFFSET UNITYSDK_OFFSET(0x1B016510)
#define RPG_GAMECORE_ISOMETRICENABLECLUSTERLIGHTING__CTOR_OFFSET UNITYSDK_OFFSET(0x1B016500)

namespace RPG::GameCore
{
	inline static constexpr unsigned int IsometricEnableClusterLighting_TypeDefinitionIndex = 21401;
