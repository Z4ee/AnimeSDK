...
#define RPG_GAMECORE_WAITFLOORSAVEDVALUECHANGEV2_METHOD_4_3E56CBFB31CB9E6F_OFFSET UNITYSDK_OFFSET(0x178F9BF0)
#define RPG_GAMECORE_WAITFLOORSAVEDVALUECHANGEV2_METHOD_4_E0735C0821E6B307_OFFSET UNITYSDK_OFFSET(0x178F9B10)
#define RPG_GAMECORE_WAITFLOORSAVEDVALUECHANGEV2__CTOR_OFFSET UNITYSDK_OFFSET(0x178F9B90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitFloorSavedValueChangeV2_TypeDefinitionIndex = 19027;
