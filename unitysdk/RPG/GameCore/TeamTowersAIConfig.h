...
#define RPG_GAMECORE_TEAMTOWERSAICONFIG_METHOD_2_009BFE7AE2857411_OFFSET UNITYSDK_OFFSET(0x1D5C4310)
#define RPG_GAMECORE_TEAMTOWERSAICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5C48E0)
