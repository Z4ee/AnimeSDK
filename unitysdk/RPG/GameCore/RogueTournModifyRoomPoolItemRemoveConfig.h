...
#define RPG_GAMECORE_ROGUETOURNMODIFYROOMPOOLITEMREMOVECONFIG_METHOD_3_0EB6E3CB16422257_OFFSET UNITYSDK_OFFSET(0x1BB7C770)
#define RPG_GAMECORE_ROGUETOURNMODIFYROOMPOOLITEMREMOVECONFIG_METHOD_3_B32521D1618E673B_OFFSET UNITYSDK_OFFSET(0x1BB7C720)
#define RPG_GAMECORE_ROGUETOURNMODIFYROOMPOOLITEMREMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB7C710)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournModifyRoomPoolItemRemoveConfig_TypeDefinitionIndex = 17281;
