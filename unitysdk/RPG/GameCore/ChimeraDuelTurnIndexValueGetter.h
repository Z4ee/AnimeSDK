...
#define RPG_GAMECORE_CHIMERADUELTURNINDEXVALUEGETTER_METHOD_3_886B50E35109FB85_OFFSET UNITYSDK_OFFSET(0x170A7890)
#define RPG_GAMECORE_CHIMERADUELTURNINDEXVALUEGETTER_METHOD_3_F87A272F86ED70C0_OFFSET UNITYSDK_OFFSET(0x170A7930)
#define RPG_GAMECORE_CHIMERADUELTURNINDEXVALUEGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x170A7920)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelTurnIndexValueGetter_TypeDefinitionIndex = 14698;
