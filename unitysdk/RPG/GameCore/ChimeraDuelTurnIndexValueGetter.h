...
#define RPG_GAMECORE_CHIMERADUELTURNINDEXVALUEGETTER_METHOD_3_886B50E35109FB85_OFFSET UNITYSDK_OFFSET(0x196486B0)
#define RPG_GAMECORE_CHIMERADUELTURNINDEXVALUEGETTER_METHOD_3_F87A272F86ED70C0_OFFSET UNITYSDK_OFFSET(0x19648750)
#define RPG_GAMECORE_CHIMERADUELTURNINDEXVALUEGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19648740)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelTurnIndexValueGetter_TypeDefinitionIndex = 15229;
