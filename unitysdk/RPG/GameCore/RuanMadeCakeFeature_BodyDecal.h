...
#define RPG_GAMECORE_RUANMADECAKEFEATURE_BODYDECAL_METHOD_3_DEFDF91091FE0544_OFFSET UNITYSDK_OFFSET(0x18DDC350)
#define RPG_GAMECORE_RUANMADECAKEFEATURE_BODYDECAL_METHOD_3_F6042FB43756DA85_OFFSET UNITYSDK_OFFSET(0x18DDCDA0)
#define RPG_GAMECORE_RUANMADECAKEFEATURE_BODYDECAL__CTOR_OFFSET UNITYSDK_OFFSET(0x18DDC340)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RuanMadeCakeFeature_BodyDecal_TypeDefinitionIndex = 16572;
