...
#define RPG_GAMECORE_RUANMADECAKEFEATURE_BODYDECAL_METHOD_3_DEFDF91091FE0544_OFFSET UNITYSDK_OFFSET(0x19BF9070)
#define RPG_GAMECORE_RUANMADECAKEFEATURE_BODYDECAL_METHOD_3_F6042FB43756DA85_OFFSET UNITYSDK_OFFSET(0x19BF9AD0)
#define RPG_GAMECORE_RUANMADECAKEFEATURE_BODYDECAL__CTOR_OFFSET UNITYSDK_OFFSET(0x19BF9060)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RuanMadeCakeFeature_BodyDecal_TypeDefinitionIndex = 16602;
