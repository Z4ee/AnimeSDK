...
#define RPG_GAMECORE_TARGETFETCHCURRENTDAMAGEATTACKER_METHOD_4_18D02933E0E993EF_OFFSET UNITYSDK_OFFSET(0x1D0B9000)
#define RPG_GAMECORE_TARGETFETCHCURRENTDAMAGEATTACKER_METHOD_4_687EEEC5AC79169E_OFFSET UNITYSDK_OFFSET(0x1D0B8EC0)
#define RPG_GAMECORE_TARGETFETCHCURRENTDAMAGEATTACKER_METHOD_4_9A6BBF47038AF20F_OFFSET UNITYSDK_OFFSET(0x1D0B8F60)
#define RPG_GAMECORE_TARGETFETCHCURRENTDAMAGEATTACKER_METHOD_4_D3D2707BB7C140EB_OFFSET UNITYSDK_OFFSET(0x1D0B8FC0)
#define RPG_GAMECORE_TARGETFETCHCURRENTDAMAGEATTACKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0B8F50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchCurrentDamageAttacker_TypeDefinitionIndex = 23155;
