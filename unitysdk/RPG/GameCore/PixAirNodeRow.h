...
#define RPG_GAMECORE_PIXAIRNODEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D337950)
#define RPG_GAMECORE_PIXAIRNODEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D337A60)
