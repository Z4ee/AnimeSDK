...
#define RPG_GAMECORE_ROGUEAEONLISTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x175E03C0)
#define RPG_GAMECORE_ROGUEAEONLISTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x175E0540)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueAeonListConfigRow_TypeDefinitionIndex = 13576;
