...
#define RPG_GAMECORE_ROGUEAEONLISTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C4A43E0)
#define RPG_GAMECORE_ROGUEAEONLISTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4A4560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueAeonListConfigRow_TypeDefinitionIndex = 14260;
