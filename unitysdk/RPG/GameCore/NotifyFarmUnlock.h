...
#define RPG_GAMECORE_NOTIFYFARMUNLOCK_METHOD_3_2706F263F88A985A_OFFSET UNITYSDK_OFFSET(0x17475580)
#define RPG_GAMECORE_NOTIFYFARMUNLOCK_METHOD_3_2A55B374CF4D81AE_OFFSET UNITYSDK_OFFSET(0x17475470)
#define RPG_GAMECORE_NOTIFYFARMUNLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x17475550)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NotifyFarmUnlock_TypeDefinitionIndex = 20129;
