...
#define RPG_GAMECORE_NOTIFYFARMUNLOCK_METHOD_3_2706F263F88A985A_OFFSET UNITYSDK_OFFSET(0x199D0460)
#define RPG_GAMECORE_NOTIFYFARMUNLOCK_METHOD_3_2A55B374CF4D81AE_OFFSET UNITYSDK_OFFSET(0x199D0350)
#define RPG_GAMECORE_NOTIFYFARMUNLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x199D0430)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NotifyFarmUnlock_TypeDefinitionIndex = 20735;
