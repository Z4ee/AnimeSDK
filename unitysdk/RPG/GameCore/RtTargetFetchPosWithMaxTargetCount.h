...
#define RPG_GAMECORE_RTTARGETFETCHPOSWITHMAXTARGETCOUNT_METHOD_4_498F35F5D5345E49_OFFSET UNITYSDK_OFFSET(0x1B76CA30)
#define RPG_GAMECORE_RTTARGETFETCHPOSWITHMAXTARGETCOUNT_METHOD_4_90AAC1BCA2F86A09_OFFSET UNITYSDK_OFFSET(0x1B76C760)
#define RPG_GAMECORE_RTTARGETFETCHPOSWITHMAXTARGETCOUNT_METHOD_4_A5F2440889445918_OFFSET UNITYSDK_OFFSET(0x1B76CAD0)
#define RPG_GAMECORE_RTTARGETFETCHPOSWITHMAXTARGETCOUNT_METHOD_4_C52A111A708900B1_OFFSET UNITYSDK_OFFSET(0x1B76C860)
#define RPG_GAMECORE_RTTARGETFETCHPOSWITHMAXTARGETCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B76C800)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtTargetFetchPosWithMaxTargetCount_TypeDefinitionIndex = 23387;
