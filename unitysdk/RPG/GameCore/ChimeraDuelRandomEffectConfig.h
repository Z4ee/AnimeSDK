...
#define RPG_GAMECORE_CHIMERADUELRANDOMEFFECTCONFIG_METHOD_3_6C48E30EA6978AAF_OFFSET UNITYSDK_OFFSET(0x1CFCC5D0)
#define RPG_GAMECORE_CHIMERADUELRANDOMEFFECTCONFIG_METHOD_3_CB7095B9C6BCB8EB_OFFSET UNITYSDK_OFFSET(0x1CFC3B80)
#define RPG_GAMECORE_CHIMERADUELRANDOMEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFC3B70)
