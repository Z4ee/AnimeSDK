...
#define RPG_GAMECORE_CHIMERADUELRANDOMEFFECTCONFIG_METHOD_3_6C48E30EA6978AAF_OFFSET UNITYSDK_OFFSET(0x170A3230)
#define RPG_GAMECORE_CHIMERADUELRANDOMEFFECTCONFIG_METHOD_3_CB7095B9C6BCB8EB_OFFSET UNITYSDK_OFFSET(0x170A3290)
#define RPG_GAMECORE_CHIMERADUELRANDOMEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x170A3280)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelRandomEffectConfig_TypeDefinitionIndex = 14703;
