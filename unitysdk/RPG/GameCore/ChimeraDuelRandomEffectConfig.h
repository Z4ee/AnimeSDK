...
#define RPG_GAMECORE_CHIMERADUELRANDOMEFFECTCONFIG_METHOD_3_6C48E30EA6978AAF_OFFSET UNITYSDK_OFFSET(0x19644320)
#define RPG_GAMECORE_CHIMERADUELRANDOMEFFECTCONFIG_METHOD_3_CB7095B9C6BCB8EB_OFFSET UNITYSDK_OFFSET(0x1963B120)
#define RPG_GAMECORE_CHIMERADUELRANDOMEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1963B110)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelRandomEffectConfig_TypeDefinitionIndex = 15234;
