...
#define RPG_GAMECORE_SETREPORTCUSTOMVALUE_METHOD_3_13C3F03F8F06AC9C_OFFSET UNITYSDK_OFFSET(0x18E3FE10)
#define RPG_GAMECORE_SETREPORTCUSTOMVALUE_METHOD_3_DE7A57B1D9F20BFD_OFFSET UNITYSDK_OFFSET(0x18E3FEA0)
#define RPG_GAMECORE_SETREPORTCUSTOMVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E3FE70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetReportCustomValue_TypeDefinitionIndex = 22647;
