...
#define RPG_GAMECORE_FOURROTATEVOXELPORTALCONFIG_METHOD_3_39E82AA087F29BB1_OFFSET UNITYSDK_OFFSET(0x1976B380)
#define RPG_GAMECORE_FOURROTATEVOXELPORTALCONFIG_METHOD_3_E709106C5FE67EE8_OFFSET UNITYSDK_OFFSET(0x1976B310)
#define RPG_GAMECORE_FOURROTATEVOXELPORTALCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1976B360)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FourRotateVoxelPortalConfig_TypeDefinitionIndex = 15924;
