...
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_ONBATTLESTART_METHOD_3_464CA4072D882414_OFFSET UNITYSDK_OFFSET(0x17078310)
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_ONBATTLESTART_METHOD_3_A00494A578F6F2E9_OFFSET UNITYSDK_OFFSET(0x17078270)
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_ONBATTLESTART__CTOR_OFFSET UNITYSDK_OFFSET(0x17078300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleAbilityConditionChecker_OnBattleStart_TypeDefinitionIndex = 14415;
