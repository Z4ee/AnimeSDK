...
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_ONBATTLESTART_METHOD_3_464CA4072D882414_OFFSET UNITYSDK_OFFSET(0x1961AE70)
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_ONBATTLESTART_METHOD_3_A00494A578F6F2E9_OFFSET UNITYSDK_OFFSET(0x1961ADD0)
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_ONBATTLESTART__CTOR_OFFSET UNITYSDK_OFFSET(0x1961AE60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleAbilityConditionChecker_OnBattleStart_TypeDefinitionIndex = 14949;
