...
#define RPG_GAMECORE_PINGPONGPROJECTILEINFO_METHOD_2_03FE1EC9F9161203_OFFSET UNITYSDK_OFFSET(0x174B22C0)
#define RPG_GAMECORE_PINGPONGPROJECTILEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x174B25A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PingPongProjectileInfo_TypeDefinitionIndex = 15554;
