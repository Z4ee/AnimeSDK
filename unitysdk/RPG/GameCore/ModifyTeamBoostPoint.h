...
#define RPG_GAMECORE_MODIFYTEAMBOOSTPOINT_METHOD_3_22B45910F237C5BD_OFFSET UNITYSDK_OFFSET(0x18B420A0)
#define RPG_GAMECORE_MODIFYTEAMBOOSTPOINT_METHOD_3_7742ABF450C29CE9_OFFSET UNITYSDK_OFFSET(0x18B42010)
#define RPG_GAMECORE_MODIFYTEAMBOOSTPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x18B42070)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyTeamBoostPoint_TypeDefinitionIndex = 21490;
