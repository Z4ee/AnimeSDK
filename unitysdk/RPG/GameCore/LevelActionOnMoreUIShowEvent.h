...
#define RPG_GAMECORE_LEVELACTIONONMOREUISHOWEVENT_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xA976730)
#define RPG_GAMECORE_LEVELACTIONONMOREUISHOWEVENT_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xA9766E0)
#define RPG_GAMECORE_LEVELACTIONONMOREUISHOWEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0xA976780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelActionOnMoreUIShowEvent_TypeDefinitionIndex = 45700;
