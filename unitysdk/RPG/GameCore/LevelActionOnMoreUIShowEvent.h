...
#define RPG_GAMECORE_LEVELACTIONONMOREUISHOWEVENT_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xB6C47E0)
#define RPG_GAMECORE_LEVELACTIONONMOREUISHOWEVENT_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xB6C4790)
#define RPG_GAMECORE_LEVELACTIONONMOREUISHOWEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0xB6C4830)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelActionOnMoreUIShowEvent_TypeDefinitionIndex = 52352;
