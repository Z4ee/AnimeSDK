...
#define RPG_GAMECORE_LEVELACTIONONMOREUISHOWEVENT_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1844ACE0)
#define RPG_GAMECORE_LEVELACTIONONMOREUISHOWEVENT_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x1844AC90)
#define RPG_GAMECORE_LEVELACTIONONMOREUISHOWEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1844AD30)
