...
#define RPG_GAMECORE_BYCOMPAREROGUETOURNPERMANANTTALENTSTATE_METHOD_4_18570140CCF40FAD_OFFSET UNITYSDK_OFFSET(0x187397D0)
#define RPG_GAMECORE_BYCOMPAREROGUETOURNPERMANANTTALENTSTATE_METHOD_4_DDCF98CEDDE14F9D_OFFSET UNITYSDK_OFFSET(0x18739890)
#define RPG_GAMECORE_BYCOMPAREROGUETOURNPERMANANTTALENTSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18739840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareRogueTournPermanantTalentState_TypeDefinitionIndex = 20208;
