...
#define RPG_GAMECORE_BYCOMPAREROGUETOURNPERMANANTTALENTSTATE_METHOD_4_18570140CCF40FAD_OFFSET UNITYSDK_OFFSET(0x170154F0)
#define RPG_GAMECORE_BYCOMPAREROGUETOURNPERMANANTTALENTSTATE_METHOD_4_DDCF98CEDDE14F9D_OFFSET UNITYSDK_OFFSET(0x170155B0)
#define RPG_GAMECORE_BYCOMPAREROGUETOURNPERMANANTTALENTSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x17015560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareRogueTournPermanantTalentState_TypeDefinitionIndex = 19533;
