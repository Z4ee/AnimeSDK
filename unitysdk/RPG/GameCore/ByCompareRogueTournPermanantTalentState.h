...
#define RPG_GAMECORE_BYCOMPAREROGUETOURNPERMANANTTALENTSTATE_METHOD_4_6923533940371990_OFFSET UNITYSDK_OFFSET(0x1A89EBA0)
#define RPG_GAMECORE_BYCOMPAREROGUETOURNPERMANANTTALENTSTATE_METHOD_4_DDCF98CEDDE14F9D_OFFSET UNITYSDK_OFFSET(0x1A89EBE0)
#define RPG_GAMECORE_BYCOMPAREROGUETOURNPERMANANTTALENTSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A89EBD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareRogueTournPermanantTalentState_TypeDefinitionIndex = 20436;
