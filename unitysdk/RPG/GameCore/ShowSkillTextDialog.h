...
#define RPG_GAMECORE_SHOWSKILLTEXTDIALOG_METHOD_3_3490FD8F4F485EE3_OFFSET UNITYSDK_OFFSET(0x17703D60)
#define RPG_GAMECORE_SHOWSKILLTEXTDIALOG_METHOD_3_43C8363705D58512_OFFSET UNITYSDK_OFFSET(0x17703DE0)
#define RPG_GAMECORE_SHOWSKILLTEXTDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x17703DB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowSkillTextDialog_TypeDefinitionIndex = 21134;
