...
#define RPG_GAMECORE_CHIMERADUELEVENTTRIGGERSELECTORCONFIG_METHOD_3_415AD604FADA8A23_OFFSET UNITYSDK_OFFSET(0x187FB070)
#define RPG_GAMECORE_CHIMERADUELEVENTTRIGGERSELECTORCONFIG_METHOD_3_8627B742FDD722A2_OFFSET UNITYSDK_OFFSET(0x187FB110)
#define RPG_GAMECORE_CHIMERADUELEVENTTRIGGERSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x187FB100)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelEventTriggerSelectorConfig_TypeDefinitionIndex = 15099;
