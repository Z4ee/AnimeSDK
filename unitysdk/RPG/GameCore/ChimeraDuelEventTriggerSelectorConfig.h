...
#define RPG_GAMECORE_CHIMERADUELEVENTTRIGGERSELECTORCONFIG_METHOD_3_415AD604FADA8A23_OFFSET UNITYSDK_OFFSET(0x1C23EBA0)
#define RPG_GAMECORE_CHIMERADUELEVENTTRIGGERSELECTORCONFIG_METHOD_3_8627B742FDD722A2_OFFSET UNITYSDK_OFFSET(0x1C23EC40)
#define RPG_GAMECORE_CHIMERADUELEVENTTRIGGERSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C23EC30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelEventTriggerSelectorConfig_TypeDefinitionIndex = 15326;
