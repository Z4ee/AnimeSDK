...
#define RPG_GAMECORE_CHIMERADUELBUFFCASTERSELECTORCONFIG_METHOD_3_31048B86FB2E6111_OFFSET UNITYSDK_OFFSET(0x19637940)
#define RPG_GAMECORE_CHIMERADUELBUFFCASTERSELECTORCONFIG_METHOD_3_339B613F449DED3C_OFFSET UNITYSDK_OFFSET(0x196378A0)
#define RPG_GAMECORE_CHIMERADUELBUFFCASTERSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19637930)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelBuffCasterSelectorConfig_TypeDefinitionIndex = 15132;
