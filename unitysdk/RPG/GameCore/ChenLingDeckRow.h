...
#define RPG_GAMECORE_CHENLINGDECKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CFAFF00)
#define RPG_GAMECORE_CHENLINGDECKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFB0440)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::System::UInt32>* ActivityPanelSoldieList; // 0x18
		::Il2CppArray<::System::UInt32>* ShowCardList; // 0x20
		::System::String* DeckIconPath; // 0x28
		::Il2CppArray<::System::UInt32>* InitialCardList; // 0x30
		::Il2CppArray<::System::UInt32>* CardList; // 0x38
		::System::String* IconPath; // 0x40
		::Il2CppArray<::System::UInt32>* InitialEffectList; // 0x48
		::RPG::Client::TextID Desc; // 0x50
		::System::UInt32 GuideGroupID; // 0x60
		::System::UInt32 ID; // 0x64
		::RPG::Client::TextID BGDesc; // 0x68
