...
#define RPG_GAMECORE_CHENLINGDECKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x170847E0)
#define RPG_GAMECORE_CHENLINGDECKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17084D50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingDeckRow_TypeDefinitionIndex = 10345;

	class ChenLingDeckRow : public ::System::Object
	{
	public:
		::Il2CppArray<::System::UInt32>* InitialEffectList; // 0x10
		::System::String* DeckIconPath; // 0x18
		::Il2CppArray<::System::UInt32>* ActivityPanelSoldieList; // 0x20
		::Il2CppArray<::System::UInt32>* RelatedCardList; // 0x28
		::Il2CppArray<::System::UInt32>* ShowCardList; // 0x30
		::Il2CppArray<::System::UInt32>* CardList; // 0x38
		::Il2CppArray<::System::UInt32>* InitialCardList; // 0x40
		::System::String* IconPath; // 0x48
		::RPG::Client::TextID BGDesc; // 0x50
		::System::UInt32 ID; // 0x60
		::System::UInt32 GuideGroupID; // 0x64
