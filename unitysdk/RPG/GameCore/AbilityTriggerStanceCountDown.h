...
#define RPG_GAMECORE_ABILITYTRIGGERSTANCECOUNTDOWN_CLEAR_OFFSET UNITYSDK_OFFSET(0x1070A400)
#define RPG_GAMECORE_ABILITYTRIGGERSTANCECOUNTDOWN_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1070A4A0)
#define RPG_GAMECORE_ABILITYTRIGGERSTANCECOUNTDOWN_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x1070A450)
#define RPG_GAMECORE_ABILITYTRIGGERSTANCECOUNTDOWN_INIT_OFFSET UNITYSDK_OFFSET(0x106DE130)
#define RPG_GAMECORE_ABILITYTRIGGERSTANCECOUNTDOWN__CTOR_OFFSET UNITYSDK_OFFSET(0x1070A4F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AbilityTriggerStanceCountDown_TypeDefinitionIndex = 54036;
