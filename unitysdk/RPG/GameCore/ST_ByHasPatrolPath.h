...
#define RPG_GAMECORE_ST_BYHASPATROLPATH_METHOD_4_4EF75EE25923E29B_OFFSET UNITYSDK_OFFSET(0x18DEDC10)
#define RPG_GAMECORE_ST_BYHASPATROLPATH_METHOD_4_EEA1B1E98F2EBAF1_OFFSET UNITYSDK_OFFSET(0x18DEDCE0)
#define RPG_GAMECORE_ST_BYHASPATROLPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x18DEDC90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_ByHasPatrolPath_TypeDefinitionIndex = 18994;
