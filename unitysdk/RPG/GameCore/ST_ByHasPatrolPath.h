...
#define RPG_GAMECORE_ST_BYHASPATROLPATH_METHOD_4_22F71A1C35A0732B_OFFSET UNITYSDK_OFFSET(0x1B77DB70)
#define RPG_GAMECORE_ST_BYHASPATROLPATH_METHOD_4_76F0E11626B5E74A_OFFSET UNITYSDK_OFFSET(0x1B77D9F0)
#define RPG_GAMECORE_ST_BYHASPATROLPATH_METHOD_4_B1993E383B78DE1E_OFFSET UNITYSDK_OFFSET(0x1B77DBA0)
#define RPG_GAMECORE_ST_BYHASPATROLPATH_METHOD_4_EEA1B1E98F2EBAF1_OFFSET UNITYSDK_OFFSET(0x1B77DA30)
#define RPG_GAMECORE_ST_BYHASPATROLPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B77DA20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_ByHasPatrolPath_TypeDefinitionIndex = 19296;
