...
#define RPG_GAMECORE_MUSICRHYTHMGAMECONFIG_METHOD_2_4A2FAF762F96365A_OFFSET UNITYSDK_OFFSET(0x1BAEBB80)
#define RPG_GAMECORE_MUSICRHYTHMGAMECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAEBE10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MusicRhythmGameConfig_TypeDefinitionIndex = 16268;
