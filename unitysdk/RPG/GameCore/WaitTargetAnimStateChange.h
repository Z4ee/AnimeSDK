...
#define RPG_GAMECORE_WAITTARGETANIMSTATECHANGE_METHOD_4_C981C5C4B2F184A9_OFFSET UNITYSDK_OFFSET(0x1910A1D0)
#define RPG_GAMECORE_WAITTARGETANIMSTATECHANGE_METHOD_4_E3B9800126EF48F8_OFFSET UNITYSDK_OFFSET(0x1910A0F0)
#define RPG_GAMECORE_WAITTARGETANIMSTATECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1910A170)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitTargetAnimStateChange_TypeDefinitionIndex = 21176;
