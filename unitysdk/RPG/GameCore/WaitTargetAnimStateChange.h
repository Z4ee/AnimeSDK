...
#define RPG_GAMECORE_WAITTARGETANIMSTATECHANGE_METHOD_4_112C218C992DC2A1_OFFSET UNITYSDK_OFFSET(0x1D6ADCE0)
#define RPG_GAMECORE_WAITTARGETANIMSTATECHANGE_METHOD_4_195FA657B393C51F_OFFSET UNITYSDK_OFFSET(0x1D6ADD30)
#define RPG_GAMECORE_WAITTARGETANIMSTATECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6ADD20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitTargetAnimStateChange_TypeDefinitionIndex = 22050;
