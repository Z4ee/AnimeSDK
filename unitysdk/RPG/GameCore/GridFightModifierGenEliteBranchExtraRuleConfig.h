...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERGENELITEBRANCHEXTRARULECONFIG_METHOD_3_691C96464841CE93_OFFSET UNITYSDK_OFFSET(0x1D06A020)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERGENELITEBRANCHEXTRARULECONFIG_METHOD_3_CD26292BCAE7F5CF_OFFSET UNITYSDK_OFFSET(0x1D069FD0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERGENELITEBRANCHEXTRARULECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D06A010)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierGenEliteBranchExtraRuleConfig_TypeDefinitionIndex = 18727;
