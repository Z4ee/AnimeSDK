...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERGENELITEBRANCHEXTRARULECONFIG_METHOD_3_2BE0752D268090DA_OFFSET UNITYSDK_OFFSET(0x197F2820)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERGENELITEBRANCHEXTRARULECONFIG_METHOD_3_691C96464841CE93_OFFSET UNITYSDK_OFFSET(0x197ED610)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERGENELITEBRANCHEXTRARULECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197ED5C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierGenEliteBranchExtraRuleConfig_TypeDefinitionIndex = 18477;
