...
#define RPG_GAMECORE_CHIMERADUELLEAVENODE_METHOD_3_68F3C1212D656C7E_OFFSET UNITYSDK_OFFSET(0x187FDB50)
#define RPG_GAMECORE_CHIMERADUELLEAVENODE_METHOD_3_803116249400F93C_OFFSET UNITYSDK_OFFSET(0x187FDC30)
#define RPG_GAMECORE_CHIMERADUELLEAVENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x187FDBE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelLeaveNode_TypeDefinitionIndex = 15124;
