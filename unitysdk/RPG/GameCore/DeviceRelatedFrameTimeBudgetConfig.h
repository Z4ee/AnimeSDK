...
#define RPG_GAMECORE_DEVICERELATEDFRAMETIMEBUDGETCONFIG_METHOD_3_175FBCDD72584A7A_OFFSET UNITYSDK_OFFSET(0x1885DEE0)
#define RPG_GAMECORE_DEVICERELATEDFRAMETIMEBUDGETCONFIG_METHOD_3_FD929D5D14DB5C1C_OFFSET UNITYSDK_OFFSET(0x1885E6C0)
#define RPG_GAMECORE_DEVICERELATEDFRAMETIMEBUDGETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1885DED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DeviceRelatedFrameTimeBudgetConfig_TypeDefinitionIndex = 15593;
