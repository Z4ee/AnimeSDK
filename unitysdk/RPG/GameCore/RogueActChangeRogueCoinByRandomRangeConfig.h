...
#define RPG_GAMECORE_ROGUEACTCHANGEROGUECOINBYRANDOMRANGECONFIG_METHOD_6_1418D4B277F84EBF_OFFSET UNITYSDK_OFFSET(0x175B3000)
#define RPG_GAMECORE_ROGUEACTCHANGEROGUECOINBYRANDOMRANGECONFIG_METHOD_6_D509254B0BDCE9EA_OFFSET UNITYSDK_OFFSET(0x175B3220)
#define RPG_GAMECORE_ROGUEACTCHANGEROGUECOINBYRANDOMRANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175B3140)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActChangeRogueCoinByRandomRangeConfig_TypeDefinitionIndex = 17979;
