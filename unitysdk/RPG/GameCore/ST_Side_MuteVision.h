...
#define RPG_GAMECORE_ST_SIDE_MUTEVISION_METHOD_4_73C6CE936AC572B6_OFFSET UNITYSDK_OFFSET(0x18DF9E60)
#define RPG_GAMECORE_ST_SIDE_MUTEVISION_METHOD_4_7DEDA5E1F28728FC_OFFSET UNITYSDK_OFFSET(0x18DF9D90)
#define RPG_GAMECORE_ST_SIDE_MUTEVISION__CTOR_OFFSET UNITYSDK_OFFSET(0x18DF9E10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_MuteVision_TypeDefinitionIndex = 19049;
