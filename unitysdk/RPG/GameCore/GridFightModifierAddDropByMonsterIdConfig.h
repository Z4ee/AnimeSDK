...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDDROPBYMONSTERIDCONFIG_METHOD_3_68545FC717BE60B0_OFFSET UNITYSDK_OFFSET(0x1C5CFAF0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDDROPBYMONSTERIDCONFIG_METHOD_3_F7660760C49C86AC_OFFSET UNITYSDK_OFFSET(0x1C5CFB40)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDDROPBYMONSTERIDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5CFB30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierAddDropByMonsterIdConfig_TypeDefinitionIndex = 18613;
