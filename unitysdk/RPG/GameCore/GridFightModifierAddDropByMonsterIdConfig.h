...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDDROPBYMONSTERIDCONFIG_METHOD_3_E3D34E6ECB8C8175_OFFSET UNITYSDK_OFFSET(0x1725FFC0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDDROPBYMONSTERIDCONFIG_METHOD_3_F7660760C49C86AC_OFFSET UNITYSDK_OFFSET(0x17260090)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDDROPBYMONSTERIDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17260040)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierAddDropByMonsterIdConfig_TypeDefinitionIndex = 17779;
