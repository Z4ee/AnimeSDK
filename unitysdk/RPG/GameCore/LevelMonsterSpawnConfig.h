...
#define RPG_GAMECORE_LEVELMONSTERSPAWNCONFIG_METHOD_3_113ABBB9CD7BFBC4_OFFSET UNITYSDK_OFFSET(0x18A4A1B0)
#define RPG_GAMECORE_LEVELMONSTERSPAWNCONFIG_METHOD_3_36102E97BFB94F5F_OFFSET UNITYSDK_OFFSET(0x18A4A1F0)
#define RPG_GAMECORE_LEVELMONSTERSPAWNCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18A4A1E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelMonsterSpawnConfig_TypeDefinitionIndex = 16367;
