...
#define RPG_GAMECORE_LEVELMONSTERSPAWNCONFIG_METHOD_3_113ABBB9CD7BFBC4_OFFSET UNITYSDK_OFFSET(0x1C11B6A0)
#define RPG_GAMECORE_LEVELMONSTERSPAWNCONFIG_METHOD_3_36102E97BFB94F5F_OFFSET UNITYSDK_OFFSET(0x1C113C10)
#define RPG_GAMECORE_LEVELMONSTERSPAWNCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C113C00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelMonsterSpawnConfig_TypeDefinitionIndex = 17053;
