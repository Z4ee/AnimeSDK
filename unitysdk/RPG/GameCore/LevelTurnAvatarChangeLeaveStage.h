...
#define RPG_GAMECORE_LEVELTURNAVATARCHANGELEAVESTAGE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xB6E02C0)
#define RPG_GAMECORE_LEVELTURNAVATARCHANGELEAVESTAGE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xB6E0310)
#define RPG_GAMECORE_LEVELTURNAVATARCHANGELEAVESTAGE__CTOR_OFFSET UNITYSDK_OFFSET(0xB6E0360)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelTurnAvatarChangeLeaveStage_TypeDefinitionIndex = 52263;
