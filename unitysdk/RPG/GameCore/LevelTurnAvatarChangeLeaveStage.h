...
#define RPG_GAMECORE_LEVELTURNAVATARCHANGELEAVESTAGE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x19780FD0)
#define RPG_GAMECORE_LEVELTURNAVATARCHANGELEAVESTAGE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x19781020)
#define RPG_GAMECORE_LEVELTURNAVATARCHANGELEAVESTAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x19781070)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelTurnAvatarChangeLeaveStage_TypeDefinitionIndex = 54173;
