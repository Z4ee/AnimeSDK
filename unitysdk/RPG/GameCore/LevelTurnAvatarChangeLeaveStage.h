...
#define RPG_GAMECORE_LEVELTURNAVATARCHANGELEAVESTAGE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xA991EC0)
#define RPG_GAMECORE_LEVELTURNAVATARCHANGELEAVESTAGE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xA991F10)
#define RPG_GAMECORE_LEVELTURNAVATARCHANGELEAVESTAGE__CTOR_OFFSET UNITYSDK_OFFSET(0xA991F60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelTurnAvatarChangeLeaveStage_TypeDefinitionIndex = 45613;
