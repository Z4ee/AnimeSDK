...
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_SELFBOOM_METHOD_3_93CA88E9CC7304EB_OFFSET UNITYSDK_OFFSET(0x1C377C90)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_SELFBOOM_METHOD_3_FE9F22056249F713_OFFSET UNITYSDK_OFFSET(0x1C377C30)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_SELFBOOM__CTOR_OFFSET UNITYSDK_OFFSET(0x1C377C80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleAbility_SelfBoom_TypeDefinitionIndex = 15141;
