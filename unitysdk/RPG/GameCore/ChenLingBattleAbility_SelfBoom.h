...
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_SELFBOOM_METHOD_3_93CA88E9CC7304EB_OFFSET UNITYSDK_OFFSET(0x1707AE80)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_SELFBOOM_METHOD_3_FE9F22056249F713_OFFSET UNITYSDK_OFFSET(0x1707AE20)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_SELFBOOM__CTOR_OFFSET UNITYSDK_OFFSET(0x1707AE70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleAbility_SelfBoom_TypeDefinitionIndex = 14444;
