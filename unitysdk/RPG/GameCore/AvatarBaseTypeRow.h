...
#define RPG_GAMECORE_AVATARBASETYPEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16F952A0)
#define RPG_GAMECORE_AVATARBASETYPEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16F95B60)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* FirstWordText; // 0x28
