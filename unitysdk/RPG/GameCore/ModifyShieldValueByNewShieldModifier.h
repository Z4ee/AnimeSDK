...
#define RPG_GAMECORE_MODIFYSHIELDVALUEBYNEWSHIELDMODIFIER_METHOD_3_55423A6816910B82_OFFSET UNITYSDK_OFFSET(0x174339F0)
#define RPG_GAMECORE_MODIFYSHIELDVALUEBYNEWSHIELDMODIFIER_METHOD_3_C341C0B4861FF80E_OFFSET UNITYSDK_OFFSET(0x17433B10)
#define RPG_GAMECORE_MODIFYSHIELDVALUEBYNEWSHIELDMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x17433A90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyShieldValueByNewShieldModifier_TypeDefinitionIndex = 21844;
