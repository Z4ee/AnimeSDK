...
#define RPG_GAMECORE_TEAMLEADERRUNNING_METHOD_3_2F5A906AF72EAFA3_OFFSET UNITYSDK_OFFSET(0x1C145650)
#define RPG_GAMECORE_TEAMLEADERRUNNING_METHOD_3_8157534A6260AB5A_OFFSET UNITYSDK_OFFSET(0x1C145690)
#define RPG_GAMECORE_TEAMLEADERRUNNING__CTOR_OFFSET UNITYSDK_OFFSET(0x1C145680)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TeamLeaderRunning_TypeDefinitionIndex = 20155;
