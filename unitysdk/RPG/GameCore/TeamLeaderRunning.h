...
#define RPG_GAMECORE_TEAMLEADERRUNNING_METHOD_3_043C0ED3FDDCB3C1_OFFSET UNITYSDK_OFFSET(0x19090CA0)
#define RPG_GAMECORE_TEAMLEADERRUNNING_METHOD_3_87329BE787B6885A_OFFSET UNITYSDK_OFFSET(0x19090C20)
#define RPG_GAMECORE_TEAMLEADERRUNNING__CTOR_OFFSET UNITYSDK_OFFSET(0x19090C70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TeamLeaderRunning_TypeDefinitionIndex = 19932;
