...
#define RPG_GAMECORE_TRAINPARTYSWITCHENVIRONMENT_METHOD_3_52C2C06DDD00F6F6_OFFSET UNITYSDK_OFFSET(0x1B0384D0)
#define RPG_GAMECORE_TRAINPARTYSWITCHENVIRONMENT_METHOD_3_B84BAD2293FC2FB5_OFFSET UNITYSDK_OFFSET(0x1B038510)
#define RPG_GAMECORE_TRAINPARTYSWITCHENVIRONMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B038500)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartySwitchEnvironment_TypeDefinitionIndex = 21546;
