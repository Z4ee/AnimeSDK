...
#define RPG_GAMECORE_TRAINPARTYSWITCHENVIRONMENT_METHOD_3_B84BAD2293FC2FB5_OFFSET UNITYSDK_OFFSET(0x19DFA0F0)
#define RPG_GAMECORE_TRAINPARTYSWITCHENVIRONMENT_METHOD_3_D20CA1DA481BA544_OFFSET UNITYSDK_OFFSET(0x19DFA070)
#define RPG_GAMECORE_TRAINPARTYSWITCHENVIRONMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19DFA0C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartySwitchEnvironment_TypeDefinitionIndex = 21131;
