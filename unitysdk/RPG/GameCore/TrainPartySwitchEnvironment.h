...
#define RPG_GAMECORE_TRAINPARTYSWITCHENVIRONMENT_METHOD_3_B84BAD2293FC2FB5_OFFSET UNITYSDK_OFFSET(0x178B0C60)
#define RPG_GAMECORE_TRAINPARTYSWITCHENVIRONMENT_METHOD_3_D20CA1DA481BA544_OFFSET UNITYSDK_OFFSET(0x178B0BE0)
#define RPG_GAMECORE_TRAINPARTYSWITCHENVIRONMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x178B0C30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartySwitchEnvironment_TypeDefinitionIndex = 20554;
