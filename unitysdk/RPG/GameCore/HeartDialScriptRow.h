...
#define RPG_GAMECORE_HEARTDIALSCRIPTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D3CFE70)
#define RPG_GAMECORE_HEARTDIALSCRIPTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3D0200)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 FullDialogueID; // 0x30
		::System::UInt32 ControlDialogueID; // 0x34
		::System::UInt32 MissingDialogueID; // 0x38
		::System::UInt32 ScriptID; // 0x3C
		::RPG::GameCore::HeartDialEmoType DefaultEmoType; // 0x40
		::System::UInt32 UnLockDialogueID; // 0x44
