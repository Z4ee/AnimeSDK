...
#define RPG_GAMECORE_HEARTDIALSCRIPTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D17DA20)
#define RPG_GAMECORE_HEARTDIALSCRIPTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D17DDB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HeartDialScriptRow_TypeDefinitionIndex = 13613;

	class HeartDialScriptRow : public ::System::Object
	{
	public:
		::Il2CppArray<::Class_1_BC601FCB47AEB5E5*>* TotalEmoInfoList; // 0x10
		...
		::System::UInt32 UnLockDialogueID; // 0x2C
		::System::UInt32 ControlDialogueID; // 0x30
		::System::UInt32 ScriptID; // 0x34
		::RPG::GameCore::HeartDialEmoType DefaultEmoType; // 0x38
		::System::UInt32 LockDialogueID; // 0x3C
		::System::UInt32 FullDialogueID; // 0x40
