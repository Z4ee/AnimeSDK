...
#define RPG_GAMECORE_HEARTDIALSCRIPTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B673D30)
#define RPG_GAMECORE_HEARTDIALSCRIPTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6740C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HeartDialScriptRow_TypeDefinitionIndex = 13222;
	...
	public:
		...
		::Il2CppArray<::RPG::GameCore::HeartDialStepType>* StepList; // 0x20
		::RPG::GameCore::HeartDialEmoType DefaultEmoType; // 0x28
		::System::UInt32 ControlDialogueID; // 0x2C
		::System::UInt32 RaidID; // 0x30
		::System::UInt32 LockDialogueID; // 0x34
		::System::UInt32 UnLockDialogueID; // 0x38
		::System::UInt32 FullDialogueID; // 0x3C
		::System::UInt32 MissingDialogueID; // 0x40
