...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERROUNDBEGINCONFIG_METHOD_3_22B68B3813699ADA_OFFSET UNITYSDK_OFFSET(0x1C5D12E0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERROUNDBEGINCONFIG_METHOD_3_72F3E91EA991969E_OFFSET UNITYSDK_OFFSET(0x1C5D1290)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERROUNDBEGINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5D12D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierExecActionAfterRoundBeginConfig_TypeDefinitionIndex = 18590;
