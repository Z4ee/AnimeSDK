...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERROUNDBEGINCONFIG_METHOD_3_22B68B3813699ADA_OFFSET UNITYSDK_OFFSET(0x17266BC0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERROUNDBEGINCONFIG_METHOD_3_CEE4215048DD8D23_OFFSET UNITYSDK_OFFSET(0x1726A970)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERROUNDBEGINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17266B70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierExecActionAfterRoundBeginConfig_TypeDefinitionIndex = 17759;
