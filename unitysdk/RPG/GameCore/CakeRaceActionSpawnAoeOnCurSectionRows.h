...
#define RPG_GAMECORE_CAKERACEACTIONSPAWNAOEONCURSECTIONROWS_METHOD_3_CFBBF0E5D06805FD_OFFSET UNITYSDK_OFFSET(0x170459E0)
#define RPG_GAMECORE_CAKERACEACTIONSPAWNAOEONCURSECTIONROWS_METHOD_3_F27966EF4AE4A2C2_OFFSET UNITYSDK_OFFSET(0x17046D20)
#define RPG_GAMECORE_CAKERACEACTIONSPAWNAOEONCURSECTIONROWS__CTOR_OFFSET UNITYSDK_OFFSET(0x170459C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionSpawnAoeOnCurSectionRows_TypeDefinitionIndex = 16858;
