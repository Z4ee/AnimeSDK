...
#define RPG_GAMECORE_CAKERACEACTIONSPAWNAOEONCURSECTIONROWS_METHOD_3_CFBBF0E5D06805FD_OFFSET UNITYSDK_OFFSET(0x1876B140)
#define RPG_GAMECORE_CAKERACEACTIONSPAWNAOEONCURSECTIONROWS_METHOD_3_F27966EF4AE4A2C2_OFFSET UNITYSDK_OFFSET(0x1876C480)
#define RPG_GAMECORE_CAKERACEACTIONSPAWNAOEONCURSECTIONROWS__CTOR_OFFSET UNITYSDK_OFFSET(0x1876B120)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionSpawnAoeOnCurSectionRows_TypeDefinitionIndex = 17452;
