...
#define RPG_GAMECORE_INITBATTLEITEMPROGRESSINFO_METHOD_3_3E22D4F9E6C0DF9F_OFFSET UNITYSDK_OFFSET(0x1D21D070)
#define RPG_GAMECORE_INITBATTLEITEMPROGRESSINFO_METHOD_3_5275D65F0270A31E_OFFSET UNITYSDK_OFFSET(0x1D21D0B0)
#define RPG_GAMECORE_INITBATTLEITEMPROGRESSINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D21D0A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int InitBattleItemProgressInfo_TypeDefinitionIndex = 22982;
