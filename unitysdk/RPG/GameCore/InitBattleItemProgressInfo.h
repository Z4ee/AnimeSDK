...
#define RPG_GAMECORE_INITBATTLEITEMPROGRESSINFO_METHOD_3_3822E24E97DAAF75_OFFSET UNITYSDK_OFFSET(0x18A1D900)
#define RPG_GAMECORE_INITBATTLEITEMPROGRESSINFO_METHOD_3_5275D65F0270A31E_OFFSET UNITYSDK_OFFSET(0x18A1D980)
#define RPG_GAMECORE_INITBATTLEITEMPROGRESSINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18A1D950)

namespace RPG::GameCore
{
	inline static constexpr unsigned int InitBattleItemProgressInfo_TypeDefinitionIndex = 22209;
