...
#define RPG_GAMECORE_ROGUEACTPERSONARANDOMROOMCARDCASTCONFIG_METHOD_6_79509067E3B8D684_OFFSET UNITYSDK_OFFSET(0x175BF140)
#define RPG_GAMECORE_ROGUEACTPERSONARANDOMROOMCARDCASTCONFIG_METHOD_6_BC3ABEC34FE34FFD_OFFSET UNITYSDK_OFFSET(0x175BFF90)
#define RPG_GAMECORE_ROGUEACTPERSONARANDOMROOMCARDCASTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175BEE30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaRandomRoomCardCastConfig_TypeDefinitionIndex = 18072;
