...
#define RPG_GAMECORE_FOLLOWSLOTCONSTVALUE_METHOD_2_4DB188DF7CD9C0F4_OFFSET UNITYSDK_OFFSET(0x1BEBDAD0)
#define RPG_GAMECORE_FOLLOWSLOTCONSTVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEBDC60)
