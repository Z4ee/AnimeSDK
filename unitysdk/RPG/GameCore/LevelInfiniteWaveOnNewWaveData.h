...
#define RPG_GAMECORE_LEVELINFINITEWAVEONNEWWAVEDATA_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xCE4A9F0)
#define RPG_GAMECORE_LEVELINFINITEWAVEONNEWWAVEDATA_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xCE4AA40)
#define RPG_GAMECORE_LEVELINFINITEWAVEONNEWWAVEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCE4AA90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelInfiniteWaveOnNewWaveData_TypeDefinitionIndex = 52976;
