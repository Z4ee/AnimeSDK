...
#define RPG_GAMECORE_DICECOMBATPRESETTURNACTORADDLIMITEDDICECONFIG_METHOD_2_DBEAB8C8A0CF9DEE_OFFSET UNITYSDK_OFFSET(0x1D82A4A0)
#define RPG_GAMECORE_DICECOMBATPRESETTURNACTORADDLIMITEDDICECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D82A610)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatPresetTurnActorAddLimitedDiceConfig_TypeDefinitionIndex = 15958;
