...
#define RPG_GAMECORE_BYCHECKMODIFIERCALLBACKSTATUSTYPE_METHOD_4_4A5A36F7E11F37FB_OFFSET UNITYSDK_OFFSET(0x18724240)
#define RPG_GAMECORE_BYCHECKMODIFIERCALLBACKSTATUSTYPE_METHOD_4_4B6B21F84FCB689D_OFFSET UNITYSDK_OFFSET(0x18724310)
#define RPG_GAMECORE_BYCHECKMODIFIERCALLBACKSTATUSTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x187242C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckModifierCallBackStatusType_TypeDefinitionIndex = 21968;
