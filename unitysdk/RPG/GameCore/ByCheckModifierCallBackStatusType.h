...
#define RPG_GAMECORE_BYCHECKMODIFIERCALLBACKSTATUSTYPE_METHOD_4_4B6B21F84FCB689D_OFFSET UNITYSDK_OFFSET(0x19CC9A70)
#define RPG_GAMECORE_BYCHECKMODIFIERCALLBACKSTATUSTYPE_METHOD_4_7F92AC83456AF0E0_OFFSET UNITYSDK_OFFSET(0x19CC9C20)
#define RPG_GAMECORE_BYCHECKMODIFIERCALLBACKSTATUSTYPE_METHOD_4_807F8DBE2A87AA57_OFFSET UNITYSDK_OFFSET(0x19CC9BF0)
#define RPG_GAMECORE_BYCHECKMODIFIERCALLBACKSTATUSTYPE_METHOD_4_B21D5F2B4E4FB1B8_OFFSET UNITYSDK_OFFSET(0x19CC9A30)
#define RPG_GAMECORE_BYCHECKMODIFIERCALLBACKSTATUSTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x19CC9A60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckModifierCallBackStatusType_TypeDefinitionIndex = 22217;
