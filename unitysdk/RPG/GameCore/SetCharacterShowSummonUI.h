...
#define RPG_GAMECORE_SETCHARACTERSHOWSUMMONUI_METHOD_3_9CF148C4A745594C_OFFSET UNITYSDK_OFFSET(0x176AED70)
#define RPG_GAMECORE_SETCHARACTERSHOWSUMMONUI_METHOD_3_ED9BE5B4E4F1FC85_OFFSET UNITYSDK_OFFSET(0x176AECE0)
#define RPG_GAMECORE_SETCHARACTERSHOWSUMMONUI__CTOR_OFFSET UNITYSDK_OFFSET(0x176AED40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetCharacterShowSummonUI_TypeDefinitionIndex = 21595;
