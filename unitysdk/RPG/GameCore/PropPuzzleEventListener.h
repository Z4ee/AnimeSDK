...
#define RPG_GAMECORE_PROPPUZZLEEVENTLISTENER_METHOD_3_03879FF73CE047EA_OFFSET UNITYSDK_OFFSET(0x1D17FFC0)
#define RPG_GAMECORE_PROPPUZZLEEVENTLISTENER_METHOD_3_5A6366B66021B3D7_OFFSET UNITYSDK_OFFSET(0x1D180030)
#define RPG_GAMECORE_PROPPUZZLEEVENTLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D180010)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropPuzzleEventListener_TypeDefinitionIndex = 21339;
	...
	public:
		...
		static ::System::Void Method_3_03879FF73CE047EA(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::PropPuzzleEventListener*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::PropPuzzleEventListener*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_PROPPUZZLEEVENTLISTENER_METHOD_3_03879FF73CE047EA_OFFSET))(a1, a2);
		}
