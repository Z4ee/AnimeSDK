...
#define RPG_GAMECORE_PROPPUZZLEEVENTLISTENER_METHOD_3_03879FF73CE047EA_OFFSET UNITYSDK_OFFSET(0x1BA27070)
#define RPG_GAMECORE_PROPPUZZLEEVENTLISTENER_METHOD_3_5A6366B66021B3D7_OFFSET UNITYSDK_OFFSET(0x1BA270E0)
#define RPG_GAMECORE_PROPPUZZLEEVENTLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA270C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropPuzzleEventListener_TypeDefinitionIndex = 20783;
