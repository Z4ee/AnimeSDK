...
#define RPG_GAMECORE_SHOWDREAMLANDPAGE_GET_PUZZLEITEMRESULT_OFFSET UNITYSDK_OFFSET(0x19C78400)
#define RPG_GAMECORE_SHOWDREAMLANDPAGE_METHOD_3_1FCF73B96BC2C7E9_OFFSET UNITYSDK_OFFSET(0x19C781A0)
#define RPG_GAMECORE_SHOWDREAMLANDPAGE_METHOD_3_4D2EA0A1DE8C9502_OFFSET UNITYSDK_OFFSET(0x19C78220)
#define RPG_GAMECORE_SHOWDREAMLANDPAGE_SET_PUZZLEITEMRESULT_OFFSET UNITYSDK_OFFSET(0x19C78410)
#define RPG_GAMECORE_SHOWDREAMLANDPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C781F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowDreamLandPage_TypeDefinitionIndex = 19970;
