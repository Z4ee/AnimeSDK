...
#define RPG_GAMECORE_SHOWDREAMLANDPAGE_GET_PUZZLEITEMRESULT_OFFSET UNITYSDK_OFFSET(0x1E0A6100)
#define RPG_GAMECORE_SHOWDREAMLANDPAGE_METHOD_3_4D2EA0A1DE8C9502_OFFSET UNITYSDK_OFFSET(0x1E0A5F20)
#define RPG_GAMECORE_SHOWDREAMLANDPAGE_METHOD_3_83AF0C06493B76DF_OFFSET UNITYSDK_OFFSET(0x1E0A5EE0)
#define RPG_GAMECORE_SHOWDREAMLANDPAGE_SET_PUZZLEITEMRESULT_OFFSET UNITYSDK_OFFSET(0x1E0A6110)
#define RPG_GAMECORE_SHOWDREAMLANDPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0A5F10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowDreamLandPage_TypeDefinitionIndex = 20891;
