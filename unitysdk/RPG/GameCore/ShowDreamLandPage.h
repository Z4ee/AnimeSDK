...
#define RPG_GAMECORE_SHOWDREAMLANDPAGE_GET_PUZZLEITEMRESULT_OFFSET UNITYSDK_OFFSET(0x18E5C230)
#define RPG_GAMECORE_SHOWDREAMLANDPAGE_METHOD_3_1FCF73B96BC2C7E9_OFFSET UNITYSDK_OFFSET(0x18E5BFD0)
#define RPG_GAMECORE_SHOWDREAMLANDPAGE_METHOD_3_4D2EA0A1DE8C9502_OFFSET UNITYSDK_OFFSET(0x18E5C050)
#define RPG_GAMECORE_SHOWDREAMLANDPAGE_SET_PUZZLEITEMRESULT_OFFSET UNITYSDK_OFFSET(0x18E5C240)
#define RPG_GAMECORE_SHOWDREAMLANDPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E5C020)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowDreamLandPage_TypeDefinitionIndex = 20112;
