...
#define RPG_GAMECORE_ROGUEMAGICUNITDISPLAYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CFB97C0)
#define RPG_GAMECORE_ROGUEMAGICUNITDISPLAYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFB9980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueMagicUnitDisplayRow_TypeDefinitionIndex = 14301;
