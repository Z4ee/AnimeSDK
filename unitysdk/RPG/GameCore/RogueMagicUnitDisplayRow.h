...
#define RPG_GAMECORE_ROGUEMAGICUNITDISPLAYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x176170F0)
#define RPG_GAMECORE_ROGUEMAGICUNITDISPLAYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x176172B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueMagicUnitDisplayRow_TypeDefinitionIndex = 13619;
