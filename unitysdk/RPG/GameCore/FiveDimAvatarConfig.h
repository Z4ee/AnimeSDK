...
#define RPG_GAMECORE_FIVEDIMAVATARCONFIG_METHOD_2_8235B7A0FC1C516A_OFFSET UNITYSDK_OFFSET(0x1BA881D0)
#define RPG_GAMECORE_FIVEDIMAVATARCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA884E0)
