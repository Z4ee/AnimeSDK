...
#define RPG_GAMECORE_ENABLEINPUT_METHOD_3_B91072B6F482D6D7_OFFSET UNITYSDK_OFFSET(0x196E45F0)
#define RPG_GAMECORE_ENABLEINPUT_METHOD_3_E590F00FC98CBD26_OFFSET UNITYSDK_OFFSET(0x196E4570)
#define RPG_GAMECORE_ENABLEINPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x196E45C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnableInput_TypeDefinitionIndex = 19744;
