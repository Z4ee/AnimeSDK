...
#define RPG_GAMECORE_CHENLINGBATTLEBULLETRAYEXTRACONFIG_METHOD_3_F668979627236BF3_OFFSET UNITYSDK_OFFSET(0x1707CC80)
#define RPG_GAMECORE_CHENLINGBATTLEBULLETRAYEXTRACONFIG_METHOD_3_F8ADF8C1FA561967_OFFSET UNITYSDK_OFFSET(0x1707CC20)
#define RPG_GAMECORE_CHENLINGBATTLEBULLETRAYEXTRACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1707CC70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleBulletRayExtraConfig_TypeDefinitionIndex = 14407;
