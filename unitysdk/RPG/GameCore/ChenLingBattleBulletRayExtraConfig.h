...
#define RPG_GAMECORE_CHENLINGBATTLEBULLETRAYEXTRACONFIG_METHOD_3_F668979627236BF3_OFFSET UNITYSDK_OFFSET(0x187E1AF0)
#define RPG_GAMECORE_CHENLINGBATTLEBULLETRAYEXTRACONFIG_METHOD_3_F8ADF8C1FA561967_OFFSET UNITYSDK_OFFSET(0x187E1A90)
#define RPG_GAMECORE_CHENLINGBATTLEBULLETRAYEXTRACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x187E1AE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleBulletRayExtraConfig_TypeDefinitionIndex = 14877;
