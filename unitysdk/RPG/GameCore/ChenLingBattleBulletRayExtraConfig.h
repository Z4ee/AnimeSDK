...
#define RPG_GAMECORE_CHENLINGBATTLEBULLETRAYEXTRACONFIG_METHOD_3_F668979627236BF3_OFFSET UNITYSDK_OFFSET(0x1961F7B0)
#define RPG_GAMECORE_CHENLINGBATTLEBULLETRAYEXTRACONFIG_METHOD_3_F8ADF8C1FA561967_OFFSET UNITYSDK_OFFSET(0x1961F750)
#define RPG_GAMECORE_CHENLINGBATTLEBULLETRAYEXTRACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1961F7A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleBulletRayExtraConfig_TypeDefinitionIndex = 14941;
