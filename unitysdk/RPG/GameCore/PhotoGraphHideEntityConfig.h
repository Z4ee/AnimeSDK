...
#define RPG_GAMECORE_PHOTOGRAPHHIDEENTITYCONFIG_METHOD_2_63695B24485F3054_OFFSET UNITYSDK_OFFSET(0x19A07DE0)
#define RPG_GAMECORE_PHOTOGRAPHHIDEENTITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19A08190)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotoGraphHideEntityConfig_TypeDefinitionIndex = 20411;
