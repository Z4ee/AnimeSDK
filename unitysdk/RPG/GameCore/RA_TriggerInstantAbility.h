...
#define RPG_GAMECORE_RA_TRIGGERINSTANTABILITY_METHOD_4_53B155005073F8F8_OFFSET UNITYSDK_OFFSET(0x1D193200)
#define RPG_GAMECORE_RA_TRIGGERINSTANTABILITY_METHOD_4_CC0E6546AB35119B_OFFSET UNITYSDK_OFFSET(0x1D1931C0)
#define RPG_GAMECORE_RA_TRIGGERINSTANTABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1931F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RA_TriggerInstantAbility_TypeDefinitionIndex = 19811;
