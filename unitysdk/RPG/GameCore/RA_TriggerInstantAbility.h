...
#define RPG_GAMECORE_RA_TRIGGERINSTANTABILITY_METHOD_4_4CD93DA48073B951_OFFSET UNITYSDK_OFFSET(0x19AA8720)
#define RPG_GAMECORE_RA_TRIGGERINSTANTABILITY_METHOD_4_53B155005073F8F8_OFFSET UNITYSDK_OFFSET(0x19AA87A0)
#define RPG_GAMECORE_RA_TRIGGERINSTANTABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x19AA8770)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RA_TriggerInstantAbility_TypeDefinitionIndex = 18920;
