...
#define RPG_GAMECORE_TRIGGERCUSTOMPHOTOGRAPHCONDITION_METHOD_3_2091F1A9B473AE55_OFFSET UNITYSDK_OFFSET(0x1D5F1B90)
#define RPG_GAMECORE_TRIGGERCUSTOMPHOTOGRAPHCONDITION_METHOD_3_75232C7FF086FA78_OFFSET UNITYSDK_OFFSET(0x1D5F1BD0)
#define RPG_GAMECORE_TRIGGERCUSTOMPHOTOGRAPHCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5F1BC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerCustomPhotoGraphCondition_TypeDefinitionIndex = 21387;
