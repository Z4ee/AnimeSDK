...
#define RPG_GAMECORE_TRIGGERCUSTOMPHOTOGRAPHCONDITION_METHOD_3_75232C7FF086FA78_OFFSET UNITYSDK_OFFSET(0x178C0F50)
#define RPG_GAMECORE_TRIGGERCUSTOMPHOTOGRAPHCONDITION_METHOD_3_FF6D4305DE2D4827_OFFSET UNITYSDK_OFFSET(0x178C0ED0)
#define RPG_GAMECORE_TRIGGERCUSTOMPHOTOGRAPHCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x178C0F20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerCustomPhotoGraphCondition_TypeDefinitionIndex = 19796;
