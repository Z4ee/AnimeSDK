...
#define RPG_GAMECORE_TRIGGERCUSTOMPHOTOGRAPHCONDITION_METHOD_3_75232C7FF086FA78_OFFSET UNITYSDK_OFFSET(0x190BF5C0)
#define RPG_GAMECORE_TRIGGERCUSTOMPHOTOGRAPHCONDITION_METHOD_3_FF6D4305DE2D4827_OFFSET UNITYSDK_OFFSET(0x190BF540)
#define RPG_GAMECORE_TRIGGERCUSTOMPHOTOGRAPHCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x190BF590)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerCustomPhotoGraphCondition_TypeDefinitionIndex = 20477;
