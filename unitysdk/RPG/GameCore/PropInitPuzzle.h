...
#define RPG_GAMECORE_PROPINITPUZZLE_METHOD_3_3D8B0ACB1D1C6C34_OFFSET UNITYSDK_OFFSET(0x1751F3B0)
#define RPG_GAMECORE_PROPINITPUZZLE_METHOD_3_FB3C036FAE9C21EA_OFFSET UNITYSDK_OFFSET(0x1751F230)
#define RPG_GAMECORE_PROPINITPUZZLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1751F300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropInitPuzzle_TypeDefinitionIndex = 18658;
	...
	public:
		...
		static ::System::Void Method_3_FB3C036FAE9C21EA(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::PropInitPuzzle*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::PropInitPuzzle*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_PROPINITPUZZLE_METHOD_3_FB3C036FAE9C21EA_OFFSET))(a1, a2);
		}
