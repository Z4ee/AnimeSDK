...
#define RPG_GAMECORE_ACTIVEVIRTUALCAMERA_PERFORMANCETRANSITION_METHOD_3_2B8DAD87E37E1F9B_OFFSET UNITYSDK_OFFSET(0x1CD78420)
#define RPG_GAMECORE_ACTIVEVIRTUALCAMERA_PERFORMANCETRANSITION_METHOD_3_35FB502404EFCE2A_OFFSET UNITYSDK_OFFSET(0x1CD783D0)
#define RPG_GAMECORE_ACTIVEVIRTUALCAMERA_PERFORMANCETRANSITION_METHOD_3_844132D0780C62B7_OFFSET UNITYSDK_OFFSET(0x1CD78A30)
#define RPG_GAMECORE_ACTIVEVIRTUALCAMERA_PERFORMANCETRANSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD783B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActiveVirtualCamera_PerformanceTransition_TypeDefinitionIndex = 21612;
