...
#define RPG_GAMECORE_ACTIVEVIRTUALCAMERA_PERFORMANCETRANSITION_METHOD_3_23C88642E0A3D114_OFFSET UNITYSDK_OFFSET(0x193D3FB0)
#define RPG_GAMECORE_ACTIVEVIRTUALCAMERA_PERFORMANCETRANSITION_METHOD_3_2B8DAD87E37E1F9B_OFFSET UNITYSDK_OFFSET(0x193D39A0)
#define RPG_GAMECORE_ACTIVEVIRTUALCAMERA_PERFORMANCETRANSITION_METHOD_3_CB29BCDA95B08A8C_OFFSET UNITYSDK_OFFSET(0x193D3930)
#define RPG_GAMECORE_ACTIVEVIRTUALCAMERA_PERFORMANCETRANSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x193D38E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActiveVirtualCamera_PerformanceTransition_TypeDefinitionIndex = 20639;
