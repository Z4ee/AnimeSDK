...
#define RPG_GAMECORE_ACTIVEVIRTUALCAMERA_PERFORMANCETRANSITION_METHOD_3_23C88642E0A3D114_OFFSET UNITYSDK_OFFSET(0x186033F0)
#define RPG_GAMECORE_ACTIVEVIRTUALCAMERA_PERFORMANCETRANSITION_METHOD_3_2B8DAD87E37E1F9B_OFFSET UNITYSDK_OFFSET(0x18602DE0)
#define RPG_GAMECORE_ACTIVEVIRTUALCAMERA_PERFORMANCETRANSITION_METHOD_3_CB29BCDA95B08A8C_OFFSET UNITYSDK_OFFSET(0x18602D70)
#define RPG_GAMECORE_ACTIVEVIRTUALCAMERA_PERFORMANCETRANSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x18602D20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActiveVirtualCamera_PerformanceTransition_TypeDefinitionIndex = 20710;
	...
	public:
		...
		static ::System::Void Method_3_CB29BCDA95B08A8C(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::ActiveVirtualCamera_PerformanceTransition*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::ActiveVirtualCamera_PerformanceTransition*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_ACTIVEVIRTUALCAMERA_PERFORMANCETRANSITION_METHOD_3_CB29BCDA95B08A8C_OFFSET))(a1, a2);
		}
		...
		::RPG::GameCore::ActiveVirtualCamera_PerformanceTransition* Method_3_23C88642E0A3D114(::System::Boolean a1)
		{
			return ((::RPG::GameCore::ActiveVirtualCamera_PerformanceTransition*(*)(::PVOID, ::System::Boolean))((::PBYTE)hIl2Cpp + RPG_GAMECORE_ACTIVEVIRTUALCAMERA_PERFORMANCETRANSITION_METHOD_3_23C88642E0A3D114_OFFSET))(this, a1);
		}
	};
}
