...
#define RPG_GAMECORE_FIVEDIMCANCELDELAYEDSEQUENCEACTION_METHOD_3_3000EC3C49B313FB_OFFSET UNITYSDK_OFFSET(0x1E0E5840)
#define RPG_GAMECORE_FIVEDIMCANCELDELAYEDSEQUENCEACTION_METHOD_3_522916831F04D9FE_OFFSET UNITYSDK_OFFSET(0x1E0E5900)
#define RPG_GAMECORE_FIVEDIMCANCELDELAYEDSEQUENCEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0E58F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimCancelDelayedSequenceAction_TypeDefinitionIndex = 18486;
