...
#define RPG_GAMECORE_LEVELWAVEMONSTER_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xCE57430)
#define RPG_GAMECORE_LEVELWAVEMONSTER_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xCE57480)
#define RPG_GAMECORE_LEVELWAVEMONSTER__CTOR_OFFSET UNITYSDK_OFFSET(0xCE574D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelWaveMonster_TypeDefinitionIndex = 52975;
