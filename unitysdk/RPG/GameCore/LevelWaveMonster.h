...
#define RPG_GAMECORE_LEVELWAVEMONSTER_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xB6E8D30)
#define RPG_GAMECORE_LEVELWAVEMONSTER_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xB6E8D80)
#define RPG_GAMECORE_LEVELWAVEMONSTER__CTOR_OFFSET UNITYSDK_OFFSET(0xB6E8DD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelWaveMonster_TypeDefinitionIndex = 52278;
