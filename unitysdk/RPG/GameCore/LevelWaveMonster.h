...
#define RPG_GAMECORE_LEVELWAVEMONSTER_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1978AA50)
#define RPG_GAMECORE_LEVELWAVEMONSTER_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x1978AAA0)
#define RPG_GAMECORE_LEVELWAVEMONSTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1978AAF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelWaveMonster_TypeDefinitionIndex = 54188;
