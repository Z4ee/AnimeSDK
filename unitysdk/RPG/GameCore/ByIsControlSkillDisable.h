...
#define RPG_GAMECORE_BYISCONTROLSKILLDISABLE_METHOD_4_631F97F6FAF0D41A_OFFSET UNITYSDK_OFFSET(0x18750010)
#define RPG_GAMECORE_BYISCONTROLSKILLDISABLE_METHOD_4_90228BB364D04029_OFFSET UNITYSDK_OFFSET(0x18750130)
#define RPG_GAMECORE_BYISCONTROLSKILLDISABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x187500B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsControlSkillDisable_TypeDefinitionIndex = 21941;
