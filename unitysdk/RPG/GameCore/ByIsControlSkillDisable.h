...
#define RPG_GAMECORE_BYISCONTROLSKILLDISABLE_METHOD_4_3060DC98F6B883AF_OFFSET UNITYSDK_OFFSET(0x1A8DBAD0)
#define RPG_GAMECORE_BYISCONTROLSKILLDISABLE_METHOD_4_414BF58EFE0D7A2C_OFFSET UNITYSDK_OFFSET(0x1A8DB800)
#define RPG_GAMECORE_BYISCONTROLSKILLDISABLE_METHOD_4_88A29348FB66A32A_OFFSET UNITYSDK_OFFSET(0x1A8DBA70)
#define RPG_GAMECORE_BYISCONTROLSKILLDISABLE_METHOD_4_90228BB364D04029_OFFSET UNITYSDK_OFFSET(0x1A8DB8A0)
#define RPG_GAMECORE_BYISCONTROLSKILLDISABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8DB860)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsControlSkillDisable_TypeDefinitionIndex = 22190;
