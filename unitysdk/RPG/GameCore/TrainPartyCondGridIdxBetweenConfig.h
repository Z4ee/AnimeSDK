...
#define RPG_GAMECORE_TRAINPARTYCONDGRIDIDXBETWEENCONFIG_METHOD_5_7853B1A642C5280E_OFFSET UNITYSDK_OFFSET(0x178AA050)
#define RPG_GAMECORE_TRAINPARTYCONDGRIDIDXBETWEENCONFIG_METHOD_5_BAECD8087D163F34_OFFSET UNITYSDK_OFFSET(0x178AA180)
#define RPG_GAMECORE_TRAINPARTYCONDGRIDIDXBETWEENCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x178AA100)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyCondGridIdxBetweenConfig_TypeDefinitionIndex = 16598;
