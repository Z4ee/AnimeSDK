...
#define RPG_GAMECORE_TRAINPARTYCONDGRIDIDXBETWEENCONFIG_METHOD_5_17D4C3672FD5ECB8_OFFSET UNITYSDK_OFFSET(0x1C15F0E0)
#define RPG_GAMECORE_TRAINPARTYCONDGRIDIDXBETWEENCONFIG_METHOD_5_BAECD8087D163F34_OFFSET UNITYSDK_OFFSET(0x1C15F130)
#define RPG_GAMECORE_TRAINPARTYCONDGRIDIDXBETWEENCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C15F120)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyCondGridIdxBetweenConfig_TypeDefinitionIndex = 17360;
