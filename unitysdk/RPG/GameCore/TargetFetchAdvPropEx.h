...
#define RPG_GAMECORE_TARGETFETCHADVPROPEX_METHOD_4_5AC8FA1CBBA8F424_OFFSET UNITYSDK_OFFSET(0x177BBEF0)
#define RPG_GAMECORE_TARGETFETCHADVPROPEX_METHOD_4_8A52D13DCC9D4AE6_OFFSET UNITYSDK_OFFSET(0x177BBE30)
#define RPG_GAMECORE_TARGETFETCHADVPROPEX_TOSTRING_OFFSET UNITYSDK_OFFSET(0x177BC1F0)
#define RPG_GAMECORE_TARGETFETCHADVPROPEX__CTOR_OFFSET UNITYSDK_OFFSET(0x177BBEA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchAdvPropEx_TypeDefinitionIndex = 22141;
