...
#define RPG_GAMECORE_TARGETFETCHADVPROPEX_METHOD_4_114ADA0F957EB749_OFFSET UNITYSDK_OFFSET(0x1D0B52C0)
#define RPG_GAMECORE_TARGETFETCHADVPROPEX_METHOD_4_6B2744F64D3AFFD7_OFFSET UNITYSDK_OFFSET(0x1D0B52F0)
#define RPG_GAMECORE_TARGETFETCHADVPROPEX_METHOD_4_C7E0062DB919BCB2_OFFSET UNITYSDK_OFFSET(0x1D0B4F90)
#define RPG_GAMECORE_TARGETFETCHADVPROPEX_METHOD_4_D7531ED0C64007BC_OFFSET UNITYSDK_OFFSET(0x1D0B4FD0)
#define RPG_GAMECORE_TARGETFETCHADVPROPEX_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1D0B5C10)
#define RPG_GAMECORE_TARGETFETCHADVPROPEX__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0B4FC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchAdvPropEx_TypeDefinitionIndex = 23021;
