...
#define RPG_GAMECORE_VP_SIGMOID_METHOD_3_2012D6FFC937491B_OFFSET UNITYSDK_OFFSET(0x1B8977C0)
#define RPG_GAMECORE_VP_SIGMOID_METHOD_3_99EC068108000D71_OFFSET UNITYSDK_OFFSET(0x1B897740)
#define RPG_GAMECORE_VP_SIGMOID_METHOD_3_A553363E7C1C00AE_OFFSET UNITYSDK_OFFSET(0x1B8977A0)
#define RPG_GAMECORE_VP_SIGMOID_METHOD_3_CA1FAC7460F0171C_OFFSET UNITYSDK_OFFSET(0x1B8976C0)
#define RPG_GAMECORE_VP_SIGMOID__CTOR_OFFSET UNITYSDK_OFFSET(0x1B897730)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VP_Sigmoid_TypeDefinitionIndex = 23205;
