...
#define RPG_GAMECORE_VP_SIGMOID_METHOD_3_2012D6FFC937491B_OFFSET UNITYSDK_OFFSET(0x1D695DD0)
#define RPG_GAMECORE_VP_SIGMOID_METHOD_3_99EC068108000D71_OFFSET UNITYSDK_OFFSET(0x1D695D50)
#define RPG_GAMECORE_VP_SIGMOID_METHOD_3_A553363E7C1C00AE_OFFSET UNITYSDK_OFFSET(0x1D695DB0)
#define RPG_GAMECORE_VP_SIGMOID_METHOD_3_CA1FAC7460F0171C_OFFSET UNITYSDK_OFFSET(0x1D695CD0)
#define RPG_GAMECORE_VP_SIGMOID__CTOR_OFFSET UNITYSDK_OFFSET(0x1D695D40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VP_Sigmoid_TypeDefinitionIndex = 23785;
