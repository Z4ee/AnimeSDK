...
#define RPG_GAMECORE_PIXAIRLASERCONFIG_METHOD_2_1E7D275DC9535EDF_OFFSET UNITYSDK_OFFSET(0x1D7931B0)
#define RPG_GAMECORE_PIXAIRLASERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7933A0)
