...
#define RPG_GAMECORE_PLAYSCREENTRANSFER_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1D7A8000)
#define RPG_GAMECORE_PLAYSCREENTRANSFER_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D7A7FB0)
#define RPG_GAMECORE_PLAYSCREENTRANSFER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7A7FF0)
