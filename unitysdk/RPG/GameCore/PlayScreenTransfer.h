...
#define RPG_GAMECORE_PLAYSCREENTRANSFER_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x174C6430)
#define RPG_GAMECORE_PLAYSCREENTRANSFER_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x174C6390)
#define RPG_GAMECORE_PLAYSCREENTRANSFER__CTOR_OFFSET UNITYSDK_OFFSET(0x174C63F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayScreenTransfer_TypeDefinitionIndex = 22089;
