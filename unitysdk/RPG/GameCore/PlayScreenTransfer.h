...
#define RPG_GAMECORE_PLAYSCREENTRANSFER_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1BA071D0)
#define RPG_GAMECORE_PLAYSCREENTRANSFER_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1BA07180)
#define RPG_GAMECORE_PLAYSCREENTRANSFER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA071C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayScreenTransfer_TypeDefinitionIndex = 22959;
