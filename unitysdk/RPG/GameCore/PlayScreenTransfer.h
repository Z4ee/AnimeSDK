...
#define RPG_GAMECORE_PLAYSCREENTRANSFER_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x19A28A10)
#define RPG_GAMECORE_PLAYSCREENTRANSFER_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19A28970)
#define RPG_GAMECORE_PLAYSCREENTRANSFER__CTOR_OFFSET UNITYSDK_OFFSET(0x19A289D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayScreenTransfer_TypeDefinitionIndex = 22509;
