...
#define RPG_GAMECORE_SETHITOVERRIDELAYERWEIGHT_METHOD_3_271C680D2BC839BD_OFFSET UNITYSDK_OFFSET(0x176D1390)
#define RPG_GAMECORE_SETHITOVERRIDELAYERWEIGHT_METHOD_3_DF5B36B0EDF5BE9B_OFFSET UNITYSDK_OFFSET(0x176D1410)
#define RPG_GAMECORE_SETHITOVERRIDELAYERWEIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x176D13E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetHitOverrideLayerWeight_TypeDefinitionIndex = 21307;
