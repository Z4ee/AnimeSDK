...
#define RPG_GAMECORE_SETHITOVERRIDELAYERWEIGHT_METHOD_3_43C0BA850493C1B8_OFFSET UNITYSDK_OFFSET(0x1C5FC770)
#define RPG_GAMECORE_SETHITOVERRIDELAYERWEIGHT_METHOD_3_DF5B36B0EDF5BE9B_OFFSET UNITYSDK_OFFSET(0x1C5FC7B0)
#define RPG_GAMECORE_SETHITOVERRIDELAYERWEIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5FC7A0)
