...
#define RPG_GAMECORE_SPRITERECTOFFSETCENTERRECORD_METHOD_3_50026B0254414332_OFFSET UNITYSDK_OFFSET(0x1D0B77C0)
#define RPG_GAMECORE_SPRITERECTOFFSETCENTERRECORD_METHOD_3_75D900A22FD2B78E_OFFSET UNITYSDK_OFFSET(0x1D0B7A90)
#define RPG_GAMECORE_SPRITERECTOFFSETCENTERRECORD__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0B77B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SpriteRectOffsetCenterRecord_TypeDefinitionIndex = 24141;
