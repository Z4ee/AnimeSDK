...
#define RPG_GAMECORE_ADVENTITYFACETO_METHOD_3_204FF613057FA30A_OFFSET UNITYSDK_OFFSET(0x16F2CD00)
#define RPG_GAMECORE_ADVENTITYFACETO_METHOD_3_FD7CC3790F63D229_OFFSET UNITYSDK_OFFSET(0x16F2CDC0)
#define RPG_GAMECORE_ADVENTITYFACETO__CTOR_OFFSET UNITYSDK_OFFSET(0x16F2CD70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvEntityFaceTo_TypeDefinitionIndex = 18850;
