...
#define RPG_GAMECORE_WAITENTITYARTLOAD_METHOD_3_04A79627B0DA1171_OFFSET UNITYSDK_OFFSET(0x190FBBE0)
#define RPG_GAMECORE_WAITENTITYARTLOAD_METHOD_3_A5F2D35B64A8871D_OFFSET UNITYSDK_OFFSET(0x190FBB60)
#define RPG_GAMECORE_WAITENTITYARTLOAD__CTOR_OFFSET UNITYSDK_OFFSET(0x190FBBB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitEntityArtLoad_TypeDefinitionIndex = 20808;
