...
#define RPG_GAMECORE_PROPSTATECHANGELISTENERCONFIG_METHOD_3_D41613BCE9AC3605_OFFSET UNITYSDK_OFFSET(0x1D372610)
#define RPG_GAMECORE_PROPSTATECHANGELISTENERCONFIG_METHOD_3_EB67D204EC0DF9F4_OFFSET UNITYSDK_OFFSET(0x1D372690)
#define RPG_GAMECORE_PROPSTATECHANGELISTENERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D372660)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropStateChangeListenerConfig_TypeDefinitionIndex = 20162;
