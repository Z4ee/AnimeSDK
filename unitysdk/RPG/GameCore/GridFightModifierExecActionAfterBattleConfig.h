...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERBATTLECONFIG_METHOD_3_1D36E07CFA00C755_OFFSET UNITYSDK_OFFSET(0x17266060)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERBATTLECONFIG_METHOD_3_34396B854748CA7C_OFFSET UNITYSDK_OFFSET(0x1726A2F0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERBATTLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17266010)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierExecActionAfterBattleConfig_TypeDefinitionIndex = 17757;
