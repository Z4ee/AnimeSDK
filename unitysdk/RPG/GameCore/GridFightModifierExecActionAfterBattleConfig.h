...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERBATTLECONFIG_METHOD_3_1D36E07CFA00C755_OFFSET UNITYSDK_OFFSET(0x1C5D0DA0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERBATTLECONFIG_METHOD_3_D0DD9E73AFDC8331_OFFSET UNITYSDK_OFFSET(0x1C5D0D50)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERBATTLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5D0D90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierExecActionAfterBattleConfig_TypeDefinitionIndex = 18587;
