...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERBATTLECONFIG_METHOD_3_1D36E07CFA00C755_OFFSET UNITYSDK_OFFSET(0x197EBA10)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERBATTLECONFIG_METHOD_3_34396B854748CA7C_OFFSET UNITYSDK_OFFSET(0x197F1820)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERBATTLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197EB9C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierExecActionAfterBattleConfig_TypeDefinitionIndex = 18344;
