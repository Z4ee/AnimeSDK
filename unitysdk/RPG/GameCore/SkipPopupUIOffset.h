...
#define RPG_GAMECORE_SKIPPOPUPUIOFFSET_METHOD_3_3589471145E55210_OFFSET UNITYSDK_OFFSET(0x19C8F7C0)
#define RPG_GAMECORE_SKIPPOPUPUIOFFSET_METHOD_3_3CC6C26BB09F51C9_OFFSET UNITYSDK_OFFSET(0x19C8F740)
#define RPG_GAMECORE_SKIPPOPUPUIOFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x19C8F790)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SkipPopupUIOffset_TypeDefinitionIndex = 21607;
