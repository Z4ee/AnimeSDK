...
#define RPG_GAMECORE_SKIPPOPUPUIOFFSET_METHOD_3_3589471145E55210_OFFSET UNITYSDK_OFFSET(0x1BE52A70)
#define RPG_GAMECORE_SKIPPOPUPUIOFFSET_METHOD_3_C2F12EA658ECF5D3_OFFSET UNITYSDK_OFFSET(0x1BE52A20)
#define RPG_GAMECORE_SKIPPOPUPUIOFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE52A60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SkipPopupUIOffset_TypeDefinitionIndex = 22029;
