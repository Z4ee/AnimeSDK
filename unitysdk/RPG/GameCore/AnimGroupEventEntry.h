...
#define RPG_GAMECORE_ANIMGROUPEVENTENTRY_METHOD_2_543EABFB4E771448_OFFSET UNITYSDK_OFFSET(0x16F81620)
#define RPG_GAMECORE_ANIMGROUPEVENTENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x16F819D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AnimGroupEventEntry_TypeDefinitionIndex = 14910;
