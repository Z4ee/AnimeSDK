...
#define RPG_GAMECORE_STACKREDSTANCE_METHOD_3_6CC2BD20692645B1_OFFSET UNITYSDK_OFFSET(0x1D0B9030)
#define RPG_GAMECORE_STACKREDSTANCE_METHOD_3_B8E9FA3B3A16729A_OFFSET UNITYSDK_OFFSET(0x1D0B8F50)
#define RPG_GAMECORE_STACKREDSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0B8FD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StackRedStance_TypeDefinitionIndex = 22379;
