...
#define RPG_GAMECORE_STACKREDSTANCE_METHOD_3_27ADA3143CBEE4F5_OFFSET UNITYSDK_OFFSET(0x18E86F40)
#define RPG_GAMECORE_STACKREDSTANCE_METHOD_3_FFB439DE3F486B6E_OFFSET UNITYSDK_OFFSET(0x18E86EC0)
#define RPG_GAMECORE_STACKREDSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E86F10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StackRedStance_TypeDefinitionIndex = 21520;
