...
#define RPG_GAMECORE_BATTLEAREAFILTERALLEXPRESSION_METHOD_3_66297788E2FC1F61_OFFSET UNITYSDK_OFFSET(0x1A3E2BE0)
#define RPG_GAMECORE_BATTLEAREAFILTERALLEXPRESSION_METHOD_3_663182C44C259C3D_OFFSET UNITYSDK_OFFSET(0x1A3E2B90)
#define RPG_GAMECORE_BATTLEAREAFILTERALLEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3E2BD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleAreaFilterAllExpression_TypeDefinitionIndex = 16712;
