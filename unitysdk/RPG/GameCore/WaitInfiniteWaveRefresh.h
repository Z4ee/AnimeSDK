...
#define RPG_GAMECORE_WAITINFINITEWAVEREFRESH_METHOD_3_1F720EF2FBC71C56_OFFSET UNITYSDK_OFFSET(0x1D6A5780)
#define RPG_GAMECORE_WAITINFINITEWAVEREFRESH_METHOD_3_7ACF6FC0EA3D7895_OFFSET UNITYSDK_OFFSET(0x1D6A57C0)
#define RPG_GAMECORE_WAITINFINITEWAVEREFRESH__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6A57B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitInfiniteWaveRefresh_TypeDefinitionIndex = 23196;
