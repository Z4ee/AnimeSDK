...
#define RPG_GAMECORE_WAITINFINITEWAVEREFRESH_METHOD_3_3C93D4DDD34839A4_OFFSET UNITYSDK_OFFSET(0x178FC5C0)
#define RPG_GAMECORE_WAITINFINITEWAVEREFRESH_METHOD_3_7ACF6FC0EA3D7895_OFFSET UNITYSDK_OFFSET(0x178FC640)
#define RPG_GAMECORE_WAITINFINITEWAVEREFRESH__CTOR_OFFSET UNITYSDK_OFFSET(0x178FC610)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitInfiniteWaveRefresh_TypeDefinitionIndex = 21690;
