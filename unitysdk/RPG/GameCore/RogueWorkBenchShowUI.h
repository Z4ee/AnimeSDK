...
#define RPG_GAMECORE_ROGUEWORKBENCHSHOWUI_METHOD_3_46FAA2BF84DA4797_OFFSET UNITYSDK_OFFSET(0x18D80780)
#define RPG_GAMECORE_ROGUEWORKBENCHSHOWUI_METHOD_3_5BE551463F291B68_OFFSET UNITYSDK_OFFSET(0x18D80800)
#define RPG_GAMECORE_ROGUEWORKBENCHSHOWUI__CTOR_OFFSET UNITYSDK_OFFSET(0x18D807D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueWorkBenchShowUI_TypeDefinitionIndex = 20964;
