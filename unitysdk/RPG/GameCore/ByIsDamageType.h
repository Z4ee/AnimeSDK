...
#define RPG_GAMECORE_BYISDAMAGETYPE_METHOD_4_3238A7661D414756_OFFSET UNITYSDK_OFFSET(0x1702C5B0)
#define RPG_GAMECORE_BYISDAMAGETYPE_METHOD_4_D6706E5127EB29D6_OFFSET UNITYSDK_OFFSET(0x1702C4E0)
#define RPG_GAMECORE_BYISDAMAGETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1702C560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsDamageType_TypeDefinitionIndex = 21748;
