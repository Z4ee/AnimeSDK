...
#define RPG_GAMECORE_ROGUEMODIFIERGETEXTRABUFFONBUFFADDCONFIG_METHOD_3_55B9D3AE70D213CA_OFFSET UNITYSDK_OFFSET(0x18D3F140)
#define RPG_GAMECORE_ROGUEMODIFIERGETEXTRABUFFONBUFFADDCONFIG_METHOD_3_7D82FA3E41DDBB93_OFFSET UNITYSDK_OFFSET(0x18D3F070)
#define RPG_GAMECORE_ROGUEMODIFIERGETEXTRABUFFONBUFFADDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D3F0F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierGetExtraBuffOnBuffAddConfig_TypeDefinitionIndex = 16894;
