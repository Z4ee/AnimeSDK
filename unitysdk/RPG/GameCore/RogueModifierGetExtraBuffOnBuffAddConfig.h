...
#define RPG_GAMECORE_ROGUEMODIFIERGETEXTRABUFFONBUFFADDCONFIG_METHOD_3_214C6D700984BD8E_OFFSET UNITYSDK_OFFSET(0x1CFC1280)
#define RPG_GAMECORE_ROGUEMODIFIERGETEXTRABUFFONBUFFADDCONFIG_METHOD_3_55B9D3AE70D213CA_OFFSET UNITYSDK_OFFSET(0x1CFC12D0)
#define RPG_GAMECORE_ROGUEMODIFIERGETEXTRABUFFONBUFFADDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFC12C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierGetExtraBuffOnBuffAddConfig_TypeDefinitionIndex = 17071;
