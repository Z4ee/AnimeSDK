...
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBASECONFIG_METHOD_2_8C9B53B7AC888692_OFFSET UNITYSDK_OFFSET(0x1D40E2B0)
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBASECONFIG_METHOD_2_96E7EC1DC56DD81B_OFFSET UNITYSDK_OFFSET(0x1D40DD80)
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBASECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D40E2C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RoguePersonaRoomCardFilterBaseConfig_TypeDefinitionIndex = 19636;
