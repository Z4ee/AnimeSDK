...
#define RPG_GAMECORE_SETINWARDBUBBLEINFO_METHOD_3_03D3F53A6FE74D85_OFFSET UNITYSDK_OFFSET(0x1C5FD230)
#define RPG_GAMECORE_SETINWARDBUBBLEINFO_METHOD_3_E8644714A49E2A38_OFFSET UNITYSDK_OFFSET(0x1C5FD1F0)
#define RPG_GAMECORE_SETINWARDBUBBLEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5FD220)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetInwardBubbleInfo_TypeDefinitionIndex = 20811;
