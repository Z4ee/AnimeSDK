...
#define RPG_GAMECORE_SETINWARDBUBBLEINFO_METHOD_3_03D3F53A6FE74D85_OFFSET UNITYSDK_OFFSET(0x176D2000)
#define RPG_GAMECORE_SETINWARDBUBBLEINFO_METHOD_3_B7E7153889676F5E_OFFSET UNITYSDK_OFFSET(0x176D1F80)
#define RPG_GAMECORE_SETINWARDBUBBLEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x176D1FD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetInwardBubbleInfo_TypeDefinitionIndex = 19774;
