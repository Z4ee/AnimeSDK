...
#define RPG_GAMECORE_SETINWARDBUBBLEINFO_METHOD_3_03D3F53A6FE74D85_OFFSET UNITYSDK_OFFSET(0x18E35540)
#define RPG_GAMECORE_SETINWARDBUBBLEINFO_METHOD_3_B7E7153889676F5E_OFFSET UNITYSDK_OFFSET(0x18E354C0)
#define RPG_GAMECORE_SETINWARDBUBBLEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18E35510)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetInwardBubbleInfo_TypeDefinitionIndex = 20455;
