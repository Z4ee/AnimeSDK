...
#define RPG_GAMECORE_SWORDTRAININGENTERGAME_METHOD_3_B703B7DE70656140_OFFSET UNITYSDK_OFFSET(0x19CE2AD0)
#define RPG_GAMECORE_SWORDTRAININGENTERGAME_METHOD_3_DD91AAEA9E0B3B49_OFFSET UNITYSDK_OFFSET(0x19CE2B50)
#define RPG_GAMECORE_SWORDTRAININGENTERGAME__CTOR_OFFSET UNITYSDK_OFFSET(0x19CE2B20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwordTrainingEnterGame_TypeDefinitionIndex = 19190;
