...
#define RPG_GAMECORE_SWORDTRAININGENTERGAME_METHOD_3_DD91AAEA9E0B3B49_OFFSET UNITYSDK_OFFSET(0x1D592B70)
#define RPG_GAMECORE_SWORDTRAININGENTERGAME_METHOD_3_F18AE3C5EA4A534A_OFFSET UNITYSDK_OFFSET(0x1D592B30)
#define RPG_GAMECORE_SWORDTRAININGENTERGAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1D592B60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwordTrainingEnterGame_TypeDefinitionIndex = 20092;
