...
#define RPG_GAMECORE_SETDYNAMICVALUEBYBASETYPECOUNT_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x18E1CF80)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBASETYPECOUNT_METHOD_4_92B3DB5CEC1DCA23_OFFSET UNITYSDK_OFFSET(0x18E1CD90)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBASETYPECOUNT_METHOD_4_F6D4F2B6B61BBC8B_OFFSET UNITYSDK_OFFSET(0x18E1CCB0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBASETYPECOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x18E1CD30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByBaseTypeCount_TypeDefinitionIndex = 22562;
