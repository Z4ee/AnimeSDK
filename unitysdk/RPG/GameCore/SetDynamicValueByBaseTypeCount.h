...
#define RPG_GAMECORE_SETDYNAMICVALUEBYBASETYPECOUNT_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1C2DEFD0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBASETYPECOUNT_METHOD_4_51F55D538740B0F6_OFFSET UNITYSDK_OFFSET(0x1C2DED90)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBASETYPECOUNT_METHOD_4_92B3DB5CEC1DCA23_OFFSET UNITYSDK_OFFSET(0x1C2DEDE0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBASETYPECOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2DEDD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByBaseTypeCount_TypeDefinitionIndex = 22741;
