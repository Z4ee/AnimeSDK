...
#define RPG_GAMECORE_BYLEVELLOSECHECK_METHOD_4_1B37D6C51D9FE809_OFFSET UNITYSDK_OFFSET(0x1B2AD180)
#define RPG_GAMECORE_BYLEVELLOSECHECK_METHOD_4_8CDC38791FADB5C0_OFFSET UNITYSDK_OFFSET(0x1B2AD000)
#define RPG_GAMECORE_BYLEVELLOSECHECK_METHOD_4_9FAE2967260A1280_OFFSET UNITYSDK_OFFSET(0x1B2AD1B0)
#define RPG_GAMECORE_BYLEVELLOSECHECK_METHOD_4_A8202CAC86D4EF53_OFFSET UNITYSDK_OFFSET(0x1B2AD040)
#define RPG_GAMECORE_BYLEVELLOSECHECK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2AD030)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByLevelLoseCheck_TypeDefinitionIndex = 22593;
