...
#define RPG_GAMECORE_BYLEVELLOSECHECK_METHOD_4_A8202CAC86D4EF53_OFFSET UNITYSDK_OFFSET(0x17035F80)
#define RPG_GAMECORE_BYLEVELLOSECHECK_METHOD_4_D3997D30D1882F69_OFFSET UNITYSDK_OFFSET(0x17035EB0)
#define RPG_GAMECORE_BYLEVELLOSECHECK__CTOR_OFFSET UNITYSDK_OFFSET(0x17035F30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByLevelLoseCheck_TypeDefinitionIndex = 21664;
