...
#define RPG_GAMECORE_ADVENTITYMODIFYCAMERAROOTTRANSFORM_METHOD_3_0EDF947B5C4FB61F_OFFSET UNITYSDK_OFFSET(0x16F2D7F0)
#define RPG_GAMECORE_ADVENTITYMODIFYCAMERAROOTTRANSFORM_METHOD_3_C2B2C0D03881FAAB_OFFSET UNITYSDK_OFFSET(0x16F2D870)
#define RPG_GAMECORE_ADVENTITYMODIFYCAMERAROOTTRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x16F2D840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvEntityModifyCameraRootTransform_TypeDefinitionIndex = 19370;
