...
#define RPG_GAMECORE_ADVENTITYMODIFYCAMERAROOTTRANSFORM_METHOD_3_7DE0EF93A7A82564_OFFSET UNITYSDK_OFFSET(0x1BE1B9C0)
#define RPG_GAMECORE_ADVENTITYMODIFYCAMERAROOTTRANSFORM_METHOD_3_C2B2C0D03881FAAB_OFFSET UNITYSDK_OFFSET(0x1BE1BA00)
#define RPG_GAMECORE_ADVENTITYMODIFYCAMERAROOTTRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE1B9F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvEntityModifyCameraRootTransform_TypeDefinitionIndex = 20253;
