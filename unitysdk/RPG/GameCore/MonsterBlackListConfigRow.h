...
#define RPG_GAMECORE_MONSTERBLACKLISTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D1D2C80)
#define RPG_GAMECORE_MONSTERBLACKLISTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1D2DA0)
