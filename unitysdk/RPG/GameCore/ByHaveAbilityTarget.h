...
#define RPG_GAMECORE_BYHAVEABILITYTARGET_METHOD_4_6415DB9A8AAFA1C2_OFFSET UNITYSDK_OFFSET(0x1A8CCD00)
#define RPG_GAMECORE_BYHAVEABILITYTARGET_METHOD_4_9485F2AF4E0CEFA6_OFFSET UNITYSDK_OFFSET(0x1A8CCEB0)
#define RPG_GAMECORE_BYHAVEABILITYTARGET_METHOD_4_95ED2DCA5EFC5D49_OFFSET UNITYSDK_OFFSET(0x1A8CCD40)
#define RPG_GAMECORE_BYHAVEABILITYTARGET_METHOD_4_B884F6B8C22AE4F3_OFFSET UNITYSDK_OFFSET(0x1A8CCE80)
#define RPG_GAMECORE_BYHAVEABILITYTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8CCD30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByHaveAbilityTarget_TypeDefinitionIndex = 19470;
