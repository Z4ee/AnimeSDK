...
#define RPG_GAMECORE_BYHAVEABILITYTARGET_METHOD_4_95ED2DCA5EFC5D49_OFFSET UNITYSDK_OFFSET(0x1874AB00)
#define RPG_GAMECORE_BYHAVEABILITYTARGET_METHOD_4_C531167F2342AD43_OFFSET UNITYSDK_OFFSET(0x1874AA30)
#define RPG_GAMECORE_BYHAVEABILITYTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1874AAB0)
