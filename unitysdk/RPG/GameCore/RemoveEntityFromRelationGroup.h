...
#define RPG_GAMECORE_REMOVEENTITYFROMRELATIONGROUP_METHOD_3_7A284CCBA7087CE7_OFFSET UNITYSDK_OFFSET(0x19AC87D0)
#define RPG_GAMECORE_REMOVEENTITYFROMRELATIONGROUP_METHOD_3_7EF3FCFD5748B318_OFFSET UNITYSDK_OFFSET(0x19AC8850)
#define RPG_GAMECORE_REMOVEENTITYFROMRELATIONGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x19AC8820)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveEntityFromRelationGroup_TypeDefinitionIndex = 21585;
