...
#define RPG_GAMECORE_REMOVEENTITYFROMRELATIONGROUP_METHOD_3_7EF3FCFD5748B318_OFFSET UNITYSDK_OFFSET(0x1B9CF5D0)
#define RPG_GAMECORE_REMOVEENTITYFROMRELATIONGROUP_METHOD_3_A126D156FBE8B801_OFFSET UNITYSDK_OFFSET(0x1B9CF590)
#define RPG_GAMECORE_REMOVEENTITYFROMRELATIONGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9CF5C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveEntityFromRelationGroup_TypeDefinitionIndex = 22007;
