...
#define RPG_GAMECORE_SHOWCHALLEGESTORYWAVEPANEL_METHOD_3_D830B52A77F54350_OFFSET UNITYSDK_OFFSET(0x176F7B10)
#define RPG_GAMECORE_SHOWCHALLEGESTORYWAVEPANEL_METHOD_3_F9B74FFCCAB68E09_OFFSET UNITYSDK_OFFSET(0x176F7A90)
#define RPG_GAMECORE_SHOWCHALLEGESTORYWAVEPANEL__CTOR_OFFSET UNITYSDK_OFFSET(0x176F7AE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowChallegeStoryWavePanel_TypeDefinitionIndex = 21692;
