...
#define RPG_GAMECORE_SHOWCHALLEGESTORYWAVEPANEL_METHOD_3_D830B52A77F54350_OFFSET UNITYSDK_OFFSET(0x19C77750)
#define RPG_GAMECORE_SHOWCHALLEGESTORYWAVEPANEL_METHOD_3_F9B74FFCCAB68E09_OFFSET UNITYSDK_OFFSET(0x19C776D0)
#define RPG_GAMECORE_SHOWCHALLEGESTORYWAVEPANEL__CTOR_OFFSET UNITYSDK_OFFSET(0x19C77720)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowChallegeStoryWavePanel_TypeDefinitionIndex = 22184;
