...
#define RPG_GAMECORE_SHOWCHALLEGESTORYWAVEPANEL_METHOD_3_D830B52A77F54350_OFFSET UNITYSDK_OFFSET(0x1D5254A0)
#define RPG_GAMECORE_SHOWCHALLEGESTORYWAVEPANEL_METHOD_3_F545A031AF985913_OFFSET UNITYSDK_OFFSET(0x1D525460)
#define RPG_GAMECORE_SHOWCHALLEGESTORYWAVEPANEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D525490)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowChallegeStoryWavePanel_TypeDefinitionIndex = 23198;
