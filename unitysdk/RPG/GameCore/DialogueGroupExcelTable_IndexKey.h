...
#define RPG_GAMECORE_DIALOGUEGROUPEXCELTABLE_INDEXKEY_EQUALS_OFFSET UNITYSDK_OFFSET(0x860DE0)
#define RPG_GAMECORE_DIALOGUEGROUPEXCELTABLE_INDEXKEY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19050)
#define RPG_GAMECORE_DIALOGUEGROUPEXCELTABLE_INDEXKEY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x860D40)
#define RPG_GAMECORE_DIALOGUEGROUPEXCELTABLE_INDEXKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x18EB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DialogueGroupExcelTable_IndexKey_TypeDefinitionIndex = 13025;
