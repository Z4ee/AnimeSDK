...
#define RPG_GAMECORE_CHOSESEQUENCEDSKILLAXIS_METHOD_3_324252EBF37D7FAD_OFFSET UNITYSDK_OFFSET(0x1964EBD0)
#define RPG_GAMECORE_CHOSESEQUENCEDSKILLAXIS_METHOD_3_ECBC2086BA568BD8_OFFSET UNITYSDK_OFFSET(0x1964ECD0)
#define RPG_GAMECORE_CHOSESEQUENCEDSKILLAXIS__CTOR_OFFSET UNITYSDK_OFFSET(0x1964ECC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChoseSequencedSkillAxis_TypeDefinitionIndex = 14748;
