...
#define RPG_GAMECORE_CHOSESEQUENCEDSKILLAXIS_METHOD_3_324252EBF37D7FAD_OFFSET UNITYSDK_OFFSET(0x1880D390)
#define RPG_GAMECORE_CHOSESEQUENCEDSKILLAXIS_METHOD_3_ECBC2086BA568BD8_OFFSET UNITYSDK_OFFSET(0x1880D490)
#define RPG_GAMECORE_CHOSESEQUENCEDSKILLAXIS__CTOR_OFFSET UNITYSDK_OFFSET(0x1880D480)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChoseSequencedSkillAxis_TypeDefinitionIndex = 14682;
