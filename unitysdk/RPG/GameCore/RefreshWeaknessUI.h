...
#define RPG_GAMECORE_REFRESHWEAKNESSUI_METHOD_3_329CFA51C5BE3741_OFFSET UNITYSDK_OFFSET(0x17589C40)
#define RPG_GAMECORE_REFRESHWEAKNESSUI_METHOD_3_65056DCE3EDCEBA8_OFFSET UNITYSDK_OFFSET(0x17589CC0)
#define RPG_GAMECORE_REFRESHWEAKNESSUI__CTOR_OFFSET UNITYSDK_OFFSET(0x17589C90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RefreshWeaknessUI_TypeDefinitionIndex = 20814;
