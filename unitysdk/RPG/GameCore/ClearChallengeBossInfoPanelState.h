...
#define RPG_GAMECORE_CLEARCHALLENGEBOSSINFOPANELSTATE_METHOD_3_43CFBDF13022B8DF_OFFSET UNITYSDK_OFFSET(0x1E347440)
#define RPG_GAMECORE_CLEARCHALLENGEBOSSINFOPANELSTATE_METHOD_3_9603C90F4A875C22_OFFSET UNITYSDK_OFFSET(0x1E347370)
#define RPG_GAMECORE_CLEARCHALLENGEBOSSINFOPANELSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E347430)
