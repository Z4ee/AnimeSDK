...
#define RPG_GAMECORE_TIMEREWINDOVERRIDEMAXREWINDTIME_METHOD_3_0CAAFECD30EF1AC5_OFFSET UNITYSDK_OFFSET(0x1789FC90)
#define RPG_GAMECORE_TIMEREWINDOVERRIDEMAXREWINDTIME_METHOD_3_EC45CCA3915C2292_OFFSET UNITYSDK_OFFSET(0x178898A0)
#define RPG_GAMECORE_TIMEREWINDOVERRIDEMAXREWINDTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x17889870)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TimeRewindOverrideMaxRewindTime_TypeDefinitionIndex = 18983;
