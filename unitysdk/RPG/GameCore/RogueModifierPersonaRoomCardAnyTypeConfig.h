...
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAROOMCARDANYTYPECONFIG_METHOD_3_5168D6BF18BB56C7_OFFSET UNITYSDK_OFFSET(0x1EEFC130)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAROOMCARDANYTYPECONFIG_METHOD_3_A3EADA44CD9DBF6B_OFFSET UNITYSDK_OFFSET(0x1EEFC180)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAROOMCARDANYTYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEFC170)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierPersonaRoomCardAnyTypeConfig_TypeDefinitionIndex = 17614;
