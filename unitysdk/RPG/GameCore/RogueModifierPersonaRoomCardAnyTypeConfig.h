...
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAROOMCARDANYTYPECONFIG_METHOD_3_01F7BE26D6BB8D12_OFFSET UNITYSDK_OFFSET(0x17637590)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAROOMCARDANYTYPECONFIG_METHOD_3_A3EADA44CD9DBF6B_OFFSET UNITYSDK_OFFSET(0x17637660)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAROOMCARDANYTYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17637610)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierPersonaRoomCardAnyTypeConfig_TypeDefinitionIndex = 16369;
