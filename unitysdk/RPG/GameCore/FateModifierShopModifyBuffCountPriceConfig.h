...
#define RPG_GAMECORE_FATEMODIFIERSHOPMODIFYBUFFCOUNTPRICECONFIG_METHOD_3_2A7AB932F38DFCA5_OFFSET UNITYSDK_OFFSET(0x1D08DC30)
#define RPG_GAMECORE_FATEMODIFIERSHOPMODIFYBUFFCOUNTPRICECONFIG_METHOD_3_FEBD683F63DEE041_OFFSET UNITYSDK_OFFSET(0x1D08DBE0)
#define RPG_GAMECORE_FATEMODIFIERSHOPMODIFYBUFFCOUNTPRICECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D08DC20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateModifierShopModifyBuffCountPriceConfig_TypeDefinitionIndex = 19035;
