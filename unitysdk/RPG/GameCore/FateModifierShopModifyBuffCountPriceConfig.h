...
#define RPG_GAMECORE_FATEMODIFIERSHOPMODIFYBUFFCOUNTPRICECONFIG_METHOD_3_2A7AB932F38DFCA5_OFFSET UNITYSDK_OFFSET(0x19711A50)
#define RPG_GAMECORE_FATEMODIFIERSHOPMODIFYBUFFCOUNTPRICECONFIG_METHOD_3_88B22795B96D308C_OFFSET UNITYSDK_OFFSET(0x19712CC0)
#define RPG_GAMECORE_FATEMODIFIERSHOPMODIFYBUFFCOUNTPRICECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19711A00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateModifierShopModifyBuffCountPriceConfig_TypeDefinitionIndex = 18275;
