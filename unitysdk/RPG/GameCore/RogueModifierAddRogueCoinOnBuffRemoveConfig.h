...
#define RPG_GAMECORE_ROGUEMODIFIERADDROGUECOINONBUFFREMOVECONFIG_METHOD_3_D17606A34D59C165_OFFSET UNITYSDK_OFFSET(0x19B4E170)
#define RPG_GAMECORE_ROGUEMODIFIERADDROGUECOINONBUFFREMOVECONFIG_METHOD_3_FD0532D232DBB45C_OFFSET UNITYSDK_OFFSET(0x19B4E240)
#define RPG_GAMECORE_ROGUEMODIFIERADDROGUECOINONBUFFREMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B4E1F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierAddRogueCoinOnBuffRemoveConfig_TypeDefinitionIndex = 16906;
