...
#define RPG_GAMECORE_ROGUEMODIFIERADDROGUECOINONBUFFREMOVECONFIG_METHOD_3_7DD7050B18A685E0_OFFSET UNITYSDK_OFFSET(0x1D3F6C30)
#define RPG_GAMECORE_ROGUEMODIFIERADDROGUECOINONBUFFREMOVECONFIG_METHOD_3_FD0532D232DBB45C_OFFSET UNITYSDK_OFFSET(0x1D3F6C80)
#define RPG_GAMECORE_ROGUEMODIFIERADDROGUECOINONBUFFREMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3F6C70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierAddRogueCoinOnBuffRemoveConfig_TypeDefinitionIndex = 17573;
