...
#define RPG_GAMECORE_MONOPOLYCLICKCONTENTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x174376C0)
#define RPG_GAMECORE_MONOPOLYCLICKCONTENTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x174377E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonopolyClickContentConfigRow_TypeDefinitionIndex = 11017;
