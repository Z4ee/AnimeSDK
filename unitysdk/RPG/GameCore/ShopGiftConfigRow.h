...
#define RPG_GAMECORE_SHOPGIFTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1E09EBA0)
#define RPG_GAMECORE_SHOPGIFTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1E09ECE0)
