...
#define RPG_GAMECORE_ROGUECONDUNLOCKCHEATDICECONFIG_METHOD_6_70E7FA09396A94D4_OFFSET UNITYSDK_OFFSET(0x1C4AF000)
#define RPG_GAMECORE_ROGUECONDUNLOCKCHEATDICECONFIG_METHOD_6_8D344480ECB54AD0_OFFSET UNITYSDK_OFFSET(0x1C4AF050)
#define RPG_GAMECORE_ROGUECONDUNLOCKCHEATDICECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4AF040)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueCondUnlockCheatDiceConfig_TypeDefinitionIndex = 19036;
