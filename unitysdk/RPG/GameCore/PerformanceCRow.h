...
#define RPG_GAMECORE_PERFORMANCECROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x199EF9A0)
#define RPG_GAMECORE_PERFORMANCECROW__CTOR_OFFSET UNITYSDK_OFFSET(0x199F0120)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PerformanceCRow_TypeDefinitionIndex = 13656;
