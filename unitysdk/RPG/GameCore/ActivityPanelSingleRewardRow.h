...
#define RPG_GAMECORE_ACTIVITYPANELSINGLEREWARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CD9A330)
#define RPG_GAMECORE_ACTIVITYPANELSINGLEREWARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD9A4D0)
