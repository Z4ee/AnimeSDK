...
#define RPG_GAMECORE_ACTIVITYPANELSINGLEREWARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18625C30)
#define RPG_GAMECORE_ACTIVITYPANELSINGLEREWARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18625DE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityPanelSingleRewardRow_TypeDefinitionIndex = 10726;
