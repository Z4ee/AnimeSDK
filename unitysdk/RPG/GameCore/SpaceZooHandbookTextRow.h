...
#define RPG_GAMECORE_SPACEZOOHANDBOOKTEXTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B098280)
#define RPG_GAMECORE_SPACEZOOHANDBOOKTEXTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B098910)
