...
#define RPG_GAMECORE_TRIGGERCUSTOMSTRINGLIST_METHOD_3_1452118AC4875011_OFFSET UNITYSDK_OFFSET(0x190BFC30)
#define RPG_GAMECORE_TRIGGERCUSTOMSTRINGLIST_METHOD_3_CDE79589D16A93B8_OFFSET UNITYSDK_OFFSET(0x190BFCB0)
#define RPG_GAMECORE_TRIGGERCUSTOMSTRINGLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x190BFC80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerCustomStringList_TypeDefinitionIndex = 22779;
