...
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMAGICUNITRANDOMCOPYCONFIG_METHOD_6_7BAB9AF7274E3DB1_OFFSET UNITYSDK_OFFSET(0x19AFC220)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMAGICUNITRANDOMCOPYCONFIG_METHOD_6_D6812AC96E9830FC_OFFSET UNITYSDK_OFFSET(0x19AFC000)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMAGICUNITRANDOMCOPYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AFC140)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActTriggerRogueMagicUnitRandomCopyConfig_TypeDefinitionIndex = 18653;
