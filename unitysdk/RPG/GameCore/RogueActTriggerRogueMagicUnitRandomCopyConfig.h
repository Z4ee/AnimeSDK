...
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMAGICUNITRANDOMCOPYCONFIG_METHOD_6_0B196D6C47B380CD_OFFSET UNITYSDK_OFFSET(0x1C49E980)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMAGICUNITRANDOMCOPYCONFIG_METHOD_6_7BAB9AF7274E3DB1_OFFSET UNITYSDK_OFFSET(0x1C49E9D0)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMAGICUNITRANDOMCOPYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C49E9C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActTriggerRogueMagicUnitRandomCopyConfig_TypeDefinitionIndex = 18929;
