...
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_ADDDAMAGEREDUCTION_METHOD_3_32B8CBA74CCEA448_OFFSET UNITYSDK_OFFSET(0x1E00B3A0)
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_ADDDAMAGEREDUCTION_METHOD_3_FE06219AC5FAD47C_OFFSET UNITYSDK_OFFSET(0x1E00B2D0)
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_ADDDAMAGEREDUCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1E00B390)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleEffect_AddDamageReduction_TypeDefinitionIndex = 15616;
