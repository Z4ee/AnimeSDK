...
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_ADDDAMAGEREDUCTION_METHOD_3_32B8CBA74CCEA448_OFFSET UNITYSDK_OFFSET(0x1C37A780)
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_ADDDAMAGEREDUCTION_METHOD_3_FE06219AC5FAD47C_OFFSET UNITYSDK_OFFSET(0x1C37A6B0)
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_ADDDAMAGEREDUCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C37A770)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleEffect_AddDamageReduction_TypeDefinitionIndex = 15179;
