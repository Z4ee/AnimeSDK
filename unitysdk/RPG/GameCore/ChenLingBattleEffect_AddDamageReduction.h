...
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_ADDDAMAGEREDUCTION_METHOD_3_32B8CBA74CCEA448_OFFSET UNITYSDK_OFFSET(0x19620480)
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_ADDDAMAGEREDUCTION_METHOD_3_FE06219AC5FAD47C_OFFSET UNITYSDK_OFFSET(0x196203B0)
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_ADDDAMAGEREDUCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19620470)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleEffect_AddDamageReduction_TypeDefinitionIndex = 15015;
