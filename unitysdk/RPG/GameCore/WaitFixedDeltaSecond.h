...
#define RPG_GAMECORE_WAITFIXEDDELTASECOND_METHOD_3_255B3173F77312BA_OFFSET UNITYSDK_OFFSET(0x178F9250)
#define RPG_GAMECORE_WAITFIXEDDELTASECOND_METHOD_3_9A6E68BCE3C7D18E_OFFSET UNITYSDK_OFFSET(0x178F9140)
#define RPG_GAMECORE_WAITFIXEDDELTASECOND__CTOR_OFFSET UNITYSDK_OFFSET(0x178F9220)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitFixedDeltaSecond_TypeDefinitionIndex = 22059;
