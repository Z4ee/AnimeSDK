...
#define RPG_GAMECORE_WAITFIXEDDELTASECOND_METHOD_3_255B3173F77312BA_OFFSET UNITYSDK_OFFSET(0x19E55B30)
#define RPG_GAMECORE_WAITFIXEDDELTASECOND_METHOD_3_9A6E68BCE3C7D18E_OFFSET UNITYSDK_OFFSET(0x19E55A20)
#define RPG_GAMECORE_WAITFIXEDDELTASECOND__CTOR_OFFSET UNITYSDK_OFFSET(0x19E55B00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitFixedDeltaSecond_TypeDefinitionIndex = 22482;
