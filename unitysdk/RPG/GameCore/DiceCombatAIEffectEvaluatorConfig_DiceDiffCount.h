...
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEDIFFCOUNT_METHOD_3_5A1FF4057D9E81B7_OFFSET UNITYSDK_OFFSET(0x1D0280A0)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEDIFFCOUNT_METHOD_3_DE7FE5750B59D4C6_OFFSET UNITYSDK_OFFSET(0x1D028B90)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEDIFFCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D028090)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatAIEffectEvaluatorConfig_DiceDiffCount_TypeDefinitionIndex = 15999;
