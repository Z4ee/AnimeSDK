...
#define RPG_GAMECORE_ADVWAITARTLOAD_METHOD_3_2BA9E351E2EC6C93_OFFSET UNITYSDK_OFFSET(0x18668540)
#define RPG_GAMECORE_ADVWAITARTLOAD_METHOD_3_6281A7941BDD2F8C_OFFSET UNITYSDK_OFFSET(0x186683F0)
#define RPG_GAMECORE_ADVWAITARTLOAD__CTOR_OFFSET UNITYSDK_OFFSET(0x186684B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvWaitArtLoad_TypeDefinitionIndex = 20910;
