...
#define RPG_GAMECORE_LEVELROTATABLEREGIONBAKEDINFO_DISPOSE_OFFSET UNITYSDK_OFFSET(0x82F250)
#define RPG_GAMECORE_LEVELROTATABLEREGIONBAKEDINFO_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x3C0BE10)
#define RPG_GAMECORE_LEVELROTATABLEREGIONBAKEDINFO_EQUALS_OFFSET UNITYSDK_OFFSET(0x125C0)
#define RPG_GAMECORE_LEVELROTATABLEREGIONBAKEDINFO_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x860F00)
#define RPG_GAMECORE_LEVELROTATABLEREGIONBAKEDINFO_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x860E40)
#define RPG_GAMECORE_LEVELROTATABLEREGIONBAKEDINFO_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0x12370)
#define RPG_GAMECORE_LEVELROTATABLEREGIONBAKEDINFO_GET_POOL_OFFSET UNITYSDK_OFFSET(0x161E0)
#define RPG_GAMECORE_LEVELROTATABLEREGIONBAKEDINFO_GET_POSELIST_OFFSET UNITYSDK_OFFSET(0x3C0BE20)
#define RPG_GAMECORE_LEVELROTATABLEREGIONBAKEDINFO_INIT_OFFSET UNITYSDK_OFFSET(0x6B82D0)
#define RPG_GAMECORE_LEVELROTATABLEREGIONBAKEDINFO_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1DD56FF0)
#define RPG_GAMECORE_LEVELROTATABLEREGIONBAKEDINFO_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1DD57230)
#define RPG_GAMECORE_LEVELROTATABLEREGIONBAKEDINFO_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1DD57100)
#define RPG_GAMECORE_LEVELROTATABLEREGIONBAKEDINFO_OP_LOGICALNOT_OFFSET UNITYSDK_OFFSET(0x1DD572E0)
#define RPG_GAMECORE_LEVELROTATABLEREGIONBAKEDINFO_SET_POSELIST_OFFSET UNITYSDK_OFFSET(0x3C0BE40)
