...
#define RPG_GAMECORE_DICECOMBATBOSSPERSISTENTTIPSCONFIG_METHOD_2_949FCF4B093FFA9B_OFFSET UNITYSDK_OFFSET(0x1C10C740)
#define RPG_GAMECORE_DICECOMBATBOSSPERSISTENTTIPSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C10C830)
