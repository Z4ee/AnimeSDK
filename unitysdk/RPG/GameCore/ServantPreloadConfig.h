...
#define RPG_GAMECORE_SERVANTPRELOADCONFIG_METHOD_3_1C35F7284B8E6633_OFFSET UNITYSDK_OFFSET(0x1C2CF390)
#define RPG_GAMECORE_SERVANTPRELOADCONFIG_METHOD_3_FEAA68D8B5DA4430_OFFSET UNITYSDK_OFFSET(0x1C2CF3D0)
#define RPG_GAMECORE_SERVANTPRELOADCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2CF3C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ServantPreloadConfig_TypeDefinitionIndex = 15699;
