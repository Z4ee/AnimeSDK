...
#define RPG_GAMECORE_SERVANTPRELOADCONFIG_METHOD_3_8E0CA76276B3918C_OFFSET UNITYSDK_OFFSET(0x176A3800)
#define RPG_GAMECORE_SERVANTPRELOADCONFIG_METHOD_3_AAFDFB12992C1B1F_OFFSET UNITYSDK_OFFSET(0x176A37C0)
#define RPG_GAMECORE_SERVANTPRELOADCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x176A37F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ServantPreloadConfig_TypeDefinitionIndex = 14958;
