...
#define RPG_GAMECORE_ATTACKDATA_METHOD_2_0BEDB3D7567D5618_OFFSET UNITYSDK_OFFSET(0x16F8B520)
#define RPG_GAMECORE_ATTACKDATA_METHOD_2_80498888A136FCFD_OFFSET UNITYSDK_OFFSET(0x16F8B9F0)
#define RPG_GAMECORE_ATTACKDATA_SHAREBYCOPY_OFFSET UNITYSDK_OFFSET(0x16F8CBD0)
#define RPG_GAMECORE_ATTACKDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x16F8B650)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AttackData_TypeDefinitionIndex = 20776;
