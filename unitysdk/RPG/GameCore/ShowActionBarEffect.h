...
#define RPG_GAMECORE_SHOWACTIONBAREFFECT_METHOD_3_78D7ADE67CED0140_OFFSET UNITYSDK_OFFSET(0x19C732B0)
#define RPG_GAMECORE_SHOWACTIONBAREFFECT_METHOD_3_AB89412CE31C30EA_OFFSET UNITYSDK_OFFSET(0x19C731D0)
#define RPG_GAMECORE_SHOWACTIONBAREFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x19C73250)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowActionBarEffect_TypeDefinitionIndex = 21695;
