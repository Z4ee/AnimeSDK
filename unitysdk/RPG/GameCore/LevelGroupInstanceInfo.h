...
#define RPG_GAMECORE_LEVELGROUPINSTANCEINFO_METHOD_4_3C9B455DD8EC6D3D_OFFSET UNITYSDK_OFFSET(0x173397A0)
#define RPG_GAMECORE_LEVELGROUPINSTANCEINFO_METHOD_4_7105EEF56A3045DC_OFFSET UNITYSDK_OFFSET(0x17339800)
#define RPG_GAMECORE_LEVELGROUPINSTANCEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x173397F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelGroupInstanceInfo_TypeDefinitionIndex = 15835;
