...
#define RPG_GAMECORE_LEVELGROUPINSTANCEINFO_METHOD_4_3C9B455DD8EC6D3D_OFFSET UNITYSDK_OFFSET(0x19877F00)
#define RPG_GAMECORE_LEVELGROUPINSTANCEINFO_METHOD_4_7105EEF56A3045DC_OFFSET UNITYSDK_OFFSET(0x19877F60)
#define RPG_GAMECORE_LEVELGROUPINSTANCEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19877F50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelGroupInstanceInfo_TypeDefinitionIndex = 16393;
