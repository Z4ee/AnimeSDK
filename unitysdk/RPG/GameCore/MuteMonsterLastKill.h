...
#define RPG_GAMECORE_MUTEMONSTERLASTKILL_METHOD_3_3531F65AE96C84C3_OFFSET UNITYSDK_OFFSET(0x1BAEFE70)
#define RPG_GAMECORE_MUTEMONSTERLASTKILL_METHOD_3_E467C1132D308DB0_OFFSET UNITYSDK_OFFSET(0x1BAEFE30)
#define RPG_GAMECORE_MUTEMONSTERLASTKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAEFE60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MuteMonsterLastKill_TypeDefinitionIndex = 22635;
