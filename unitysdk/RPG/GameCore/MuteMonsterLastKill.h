...
#define RPG_GAMECORE_MUTEMONSTERLASTKILL_METHOD_3_2D470FA93A69D73A_OFFSET UNITYSDK_OFFSET(0x1746A8C0)
#define RPG_GAMECORE_MUTEMONSTERLASTKILL_METHOD_3_3531F65AE96C84C3_OFFSET UNITYSDK_OFFSET(0x1746A940)
#define RPG_GAMECORE_MUTEMONSTERLASTKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x1746A910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MuteMonsterLastKill_TypeDefinitionIndex = 21711;
