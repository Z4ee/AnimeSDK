...
#define RPG_GAMECORE_BYCOMPARECHARACTERID_METHOD_4_957C20B1F770B54C_OFFSET UNITYSDK_OFFSET(0x18728580)
#define RPG_GAMECORE_BYCOMPARECHARACTERID_METHOD_4_D73A40BD30406E35_OFFSET UNITYSDK_OFFSET(0x187286E0)
#define RPG_GAMECORE_BYCOMPARECHARACTERID__CTOR_OFFSET UNITYSDK_OFFSET(0x18728640)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareCharacterID_TypeDefinitionIndex = 21436;
