...
#define RPG_GAMECORE_WAITFOR_METHOD_3_2AD2A82E6EED7C82_OFFSET UNITYSDK_OFFSET(0x178FA000)
#define RPG_GAMECORE_WAITFOR_METHOD_3_C6DCC02255F66DAB_OFFSET UNITYSDK_OFFSET(0x178F9F80)
#define RPG_GAMECORE_WAITFOR__CTOR_OFFSET UNITYSDK_OFFSET(0x178F9FD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitFor_TypeDefinitionIndex = 22065;
