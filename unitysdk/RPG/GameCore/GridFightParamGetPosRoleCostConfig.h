...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETPOSROLECOSTCONFIG_METHOD_6_44C9A9A96E4FC928_OFFSET UNITYSDK_OFFSET(0x172728B0)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETPOSROLECOSTCONFIG_METHOD_6_80A097C617A7876E_OFFSET UNITYSDK_OFFSET(0x17272B60)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETPOSROLECOSTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17272A30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightParamGetPosRoleCostConfig_TypeDefinitionIndex = 17880;
