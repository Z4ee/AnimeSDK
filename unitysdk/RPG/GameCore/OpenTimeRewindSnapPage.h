...
#define RPG_GAMECORE_OPENTIMEREWINDSNAPPAGE_METHOD_3_85F2DC3D559FCBBF_OFFSET UNITYSDK_OFFSET(0x18BC6900)
#define RPG_GAMECORE_OPENTIMEREWINDSNAPPAGE_METHOD_3_FF073FEBB50E6C84_OFFSET UNITYSDK_OFFSET(0x18BC6880)
#define RPG_GAMECORE_OPENTIMEREWINDSNAPPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x18BC68D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OpenTimeRewindSnapPage_TypeDefinitionIndex = 19620;
