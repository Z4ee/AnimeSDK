...
#define RPG_GAMECORE_SWITCHMASCOTCONFIG_METHOD_2_454F489B5C585E7A_OFFSET UNITYSDK_OFFSET(0x177964F0)
#define RPG_GAMECORE_SWITCHMASCOTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17796EF0)
