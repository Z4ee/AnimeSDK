...
#define RPG_GAMECORE_SWITCHMASCOTCONFIG_METHOD_2_7DF43947B3A6411D_OFFSET UNITYSDK_OFFSET(0x1D58CAF0)
#define RPG_GAMECORE_SWITCHMASCOTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D58D4F0)
