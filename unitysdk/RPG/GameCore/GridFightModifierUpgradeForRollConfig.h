...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERUPGRADEFORROLLCONFIG_METHOD_3_39483B27109DC67F_OFFSET UNITYSDK_OFFSET(0x189C0650)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERUPGRADEFORROLLCONFIG_METHOD_3_BF27535F54412D96_OFFSET UNITYSDK_OFFSET(0x189C0720)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERUPGRADEFORROLLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189C06D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierUpgradeForRollConfig_TypeDefinitionIndex = 18451;
