...
#define RPG_GAMECORE_TAROTMAILGROUPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D5C0950)
#define RPG_GAMECORE_TAROTMAILGROUPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5C0AD0)
