...
#define RPG_GAMECORE_TEXTDYNAMICPARAMBASE_METHOD_2_11983C0DBACCDDAF_OFFSET UNITYSDK_OFFSET(0x19DE0230)
#define RPG_GAMECORE_TEXTDYNAMICPARAMBASE_METHOD_2_7C3F7BBE76C0E431_OFFSET UNITYSDK_OFFSET(0x19DDFF50)
#define RPG_GAMECORE_TEXTDYNAMICPARAMBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x19DE0220)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TextDynamicParamBase_TypeDefinitionIndex = 16144;
