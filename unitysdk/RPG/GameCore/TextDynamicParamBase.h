...
#define RPG_GAMECORE_TEXTDYNAMICPARAMBASE_METHOD_2_11983C0DBACCDDAF_OFFSET UNITYSDK_OFFSET(0x17899F40)
#define RPG_GAMECORE_TEXTDYNAMICPARAMBASE_METHOD_2_7C3F7BBE76C0E431_OFFSET UNITYSDK_OFFSET(0x17899C40)
#define RPG_GAMECORE_TEXTDYNAMICPARAMBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x17899F30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TextDynamicParamBase_TypeDefinitionIndex = 15574;
