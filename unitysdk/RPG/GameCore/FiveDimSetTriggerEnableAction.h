...
#define RPG_GAMECORE_FIVEDIMSETTRIGGERENABLEACTION_METHOD_3_D7E1DB40F5DCB9D0_OFFSET UNITYSDK_OFFSET(0x1891D0A0)
#define RPG_GAMECORE_FIVEDIMSETTRIGGERENABLEACTION_METHOD_3_E105A9386EF64789_OFFSET UNITYSDK_OFFSET(0x1891D110)
#define RPG_GAMECORE_FIVEDIMSETTRIGGERENABLEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1891D0F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSetTriggerEnableAction_TypeDefinitionIndex = 17752;
