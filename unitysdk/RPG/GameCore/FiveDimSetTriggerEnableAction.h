...
#define RPG_GAMECORE_FIVEDIMSETTRIGGERENABLEACTION_METHOD_3_A420E0DE267F2002_OFFSET UNITYSDK_OFFSET(0x1BEB2510)
#define RPG_GAMECORE_FIVEDIMSETTRIGGERENABLEACTION_METHOD_3_E105A9386EF64789_OFFSET UNITYSDK_OFFSET(0x1BEB2550)
#define RPG_GAMECORE_FIVEDIMSETTRIGGERENABLEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEB2540)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSetTriggerEnableAction_TypeDefinitionIndex = 17955;
