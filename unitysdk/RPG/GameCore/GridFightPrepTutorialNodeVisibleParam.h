...
#define RPG_GAMECORE_GRIDFIGHTPREPTUTORIALNODEVISIBLEPARAM_METHOD_2_7033E23D706C9022_OFFSET UNITYSDK_OFFSET(0x189CF820)
#define RPG_GAMECORE_GRIDFIGHTPREPTUTORIALNODEVISIBLEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x189CF980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightPrepTutorialNodeVisibleParam_TypeDefinitionIndex = 18885;
