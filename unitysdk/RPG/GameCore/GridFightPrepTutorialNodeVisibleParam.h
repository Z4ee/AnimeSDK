...
#define RPG_GAMECORE_GRIDFIGHTPREPTUTORIALNODEVISIBLEPARAM_METHOD_2_7033E23D706C9022_OFFSET UNITYSDK_OFFSET(0x1D15F5D0)
#define RPG_GAMECORE_GRIDFIGHTPREPTUTORIALNODEVISIBLEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D15F730)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightPrepTutorialNodeVisibleParam_TypeDefinitionIndex = 19737;
