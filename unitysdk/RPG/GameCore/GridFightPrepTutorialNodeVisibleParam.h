...
#define RPG_GAMECORE_GRIDFIGHTPREPTUTORIALNODEVISIBLEPARAM_METHOD_2_7033E23D706C9022_OFFSET UNITYSDK_OFFSET(0x1D3B1A20)
#define RPG_GAMECORE_GRIDFIGHTPREPTUTORIALNODEVISIBLEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3B1B80)
