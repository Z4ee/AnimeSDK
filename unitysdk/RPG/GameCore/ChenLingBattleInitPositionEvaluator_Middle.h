...
#define RPG_GAMECORE_CHENLINGBATTLEINITPOSITIONEVALUATOR_MIDDLE_METHOD_3_492FAF37DB438BA7_OFFSET UNITYSDK_OFFSET(0x1E00D310)
#define RPG_GAMECORE_CHENLINGBATTLEINITPOSITIONEVALUATOR_MIDDLE_METHOD_3_E161DFCCEC26BB36_OFFSET UNITYSDK_OFFSET(0x1E00D3B0)
#define RPG_GAMECORE_CHENLINGBATTLEINITPOSITIONEVALUATOR_MIDDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E00D3A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleInitPositionEvaluator_Middle_TypeDefinitionIndex = 15581;
