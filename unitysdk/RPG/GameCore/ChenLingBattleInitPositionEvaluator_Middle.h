...
#define RPG_GAMECORE_CHENLINGBATTLEINITPOSITIONEVALUATOR_MIDDLE_METHOD_3_492FAF37DB438BA7_OFFSET UNITYSDK_OFFSET(0x19621DB0)
#define RPG_GAMECORE_CHENLINGBATTLEINITPOSITIONEVALUATOR_MIDDLE_METHOD_3_E161DFCCEC26BB36_OFFSET UNITYSDK_OFFSET(0x19621E50)
#define RPG_GAMECORE_CHENLINGBATTLEINITPOSITIONEVALUATOR_MIDDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x19621E40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleInitPositionEvaluator_Middle_TypeDefinitionIndex = 14980;
