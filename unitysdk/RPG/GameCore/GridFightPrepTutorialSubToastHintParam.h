...
#define RPG_GAMECORE_GRIDFIGHTPREPTUTORIALSUBTOASTHINTPARAM_METHOD_2_DF41C104E8E458E4_OFFSET UNITYSDK_OFFSET(0x1D15FAF0)
#define RPG_GAMECORE_GRIDFIGHTPREPTUTORIALSUBTOASTHINTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1603C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightPrepTutorialSubToastHintParam_TypeDefinitionIndex = 19735;
