...
#define RPG_GAMECORE_CHENLINGBATTLEVALUEGETTER_MULTIPLY_METHOD_3_A82E885A7EC87135_OFFSET UNITYSDK_OFFSET(0x1E010A90)
#define RPG_GAMECORE_CHENLINGBATTLEVALUEGETTER_MULTIPLY_METHOD_3_ECA80BD3561E10D7_OFFSET UNITYSDK_OFFSET(0x1E010A30)
#define RPG_GAMECORE_CHENLINGBATTLEVALUEGETTER_MULTIPLY__CTOR_OFFSET UNITYSDK_OFFSET(0x1E010A80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleValueGetter_Multiply_TypeDefinitionIndex = 15631;
