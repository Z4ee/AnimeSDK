...
#define RPG_GAMECORE_CHENLINGBATTLEVALUEGETTER_MULTIPLY_METHOD_3_A82E885A7EC87135_OFFSET UNITYSDK_OFFSET(0x1C37FE70)
#define RPG_GAMECORE_CHENLINGBATTLEVALUEGETTER_MULTIPLY_METHOD_3_ECA80BD3561E10D7_OFFSET UNITYSDK_OFFSET(0x1C37FE10)
#define RPG_GAMECORE_CHENLINGBATTLEVALUEGETTER_MULTIPLY__CTOR_OFFSET UNITYSDK_OFFSET(0x1C37FE60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleValueGetter_Multiply_TypeDefinitionIndex = 15194;
