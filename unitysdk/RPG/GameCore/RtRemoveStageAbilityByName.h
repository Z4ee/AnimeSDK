...
#define RPG_GAMECORE_RTREMOVESTAGEABILITYBYNAME_METHOD_3_6C493AE19846876F_OFFSET UNITYSDK_OFFSET(0x19BEF760)
#define RPG_GAMECORE_RTREMOVESTAGEABILITYBYNAME_METHOD_3_A43DEE9BFA5ACB9E_OFFSET UNITYSDK_OFFSET(0x19BEF7E0)
#define RPG_GAMECORE_RTREMOVESTAGEABILITYBYNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x19BEF7B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtRemoveStageAbilityByName_TypeDefinitionIndex = 22759;
