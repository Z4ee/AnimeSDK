...
#define RPG_GAMECORE_RTREMOVESTAGEABILITYBYNAME_METHOD_3_A43DEE9BFA5ACB9E_OFFSET UNITYSDK_OFFSET(0x1CCEC790)
#define RPG_GAMECORE_RTREMOVESTAGEABILITYBYNAME_METHOD_3_CA6C7B32A3F8645D_OFFSET UNITYSDK_OFFSET(0x1CCEC750)
#define RPG_GAMECORE_RTREMOVESTAGEABILITYBYNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1CCEC780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtRemoveStageAbilityByName_TypeDefinitionIndex = 23806;
