...
#define RPG_GAMECORE_LEVELENTITYREF_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C1133B0)
#define RPG_GAMECORE_LEVELENTITYREF__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1134A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelEntityRef_TypeDefinitionIndex = 18677;
