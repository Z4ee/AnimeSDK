...
#define RPG_GAMECORE_BYHASSKILLTYPE_METHOD_4_C016AB906C6F264A_OFFSET UNITYSDK_OFFSET(0x18749980)
#define RPG_GAMECORE_BYHASSKILLTYPE_METHOD_4_EDA76B9D90772CAD_OFFSET UNITYSDK_OFFSET(0x18749860)
#define RPG_GAMECORE_BYHASSKILLTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x18749900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByHasSkillType_TypeDefinitionIndex = 21953;
