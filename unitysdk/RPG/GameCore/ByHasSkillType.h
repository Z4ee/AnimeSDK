...
#define RPG_GAMECORE_BYHASSKILLTYPE_METHOD_4_0B13F8C95833161B_OFFSET UNITYSDK_OFFSET(0x1CF22940)
#define RPG_GAMECORE_BYHASSKILLTYPE_METHOD_4_85889E9738F6162B_OFFSET UNITYSDK_OFFSET(0x1CF22BB0)
#define RPG_GAMECORE_BYHASSKILLTYPE_METHOD_4_C016AB906C6F264A_OFFSET UNITYSDK_OFFSET(0x1CF229E0)
#define RPG_GAMECORE_BYHASSKILLTYPE_METHOD_4_C70B5A7B0F02775A_OFFSET UNITYSDK_OFFSET(0x1CF22C10)
#define RPG_GAMECORE_BYHASSKILLTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF229A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByHasSkillType_TypeDefinitionIndex = 22771;
