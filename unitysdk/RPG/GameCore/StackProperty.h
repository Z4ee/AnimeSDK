...
#define RPG_GAMECORE_STACKPROPERTY_METHOD_3_6B458B21AD8B655A_OFFSET UNITYSDK_OFFSET(0x18E86BB0)
#define RPG_GAMECORE_STACKPROPERTY_METHOD_3_E9DBEE011D0851D4_OFFSET UNITYSDK_OFFSET(0x18E86C30)
#define RPG_GAMECORE_STACKPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x18E86C00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StackProperty_TypeDefinitionIndex = 22537;
