...
#define RPG_GAMECORE_STACKPROPERTY_METHOD_3_DAA943E71633B030_OFFSET UNITYSDK_OFFSET(0x1D0B8C60)
#define RPG_GAMECORE_STACKPROPERTY_METHOD_3_E53F616E0F02DFDC_OFFSET UNITYSDK_OFFSET(0x1D0B8C20)
#define RPG_GAMECORE_STACKPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0B8C50)
