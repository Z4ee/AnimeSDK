...
#define RPG_GAMECORE_BYTARGETISBETWEENCAMERAANDANOTHER_METHOD_4_3824804D8057BDBB_OFFSET UNITYSDK_OFFSET(0x1CDC6990)
#define RPG_GAMECORE_BYTARGETISBETWEENCAMERAANDANOTHER_METHOD_4_BBE564B0CDBAEBF2_OFFSET UNITYSDK_OFFSET(0x1CDC6950)
#define RPG_GAMECORE_BYTARGETISBETWEENCAMERAANDANOTHER_METHOD_4_CE77DE8BE6C3F0D7_OFFSET UNITYSDK_OFFSET(0x1CDC6B50)
#define RPG_GAMECORE_BYTARGETISBETWEENCAMERAANDANOTHER_METHOD_4_F6B64CC094B21729_OFFSET UNITYSDK_OFFSET(0x1CDC6B80)
#define RPG_GAMECORE_BYTARGETISBETWEENCAMERAANDANOTHER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDC6980)
