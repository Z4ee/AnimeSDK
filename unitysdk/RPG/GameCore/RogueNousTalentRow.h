...
#define RPG_GAMECORE_ROGUENOUSTALENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19BAB5F0)
#define RPG_GAMECORE_ROGUENOUSTALENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19BABEB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueNousTalentRow_TypeDefinitionIndex = 14194;
