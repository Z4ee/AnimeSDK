...
#define RPG_GAMECORE_CREATEAVATARASSISTANT_METHOD_3_6C2C541D8723DF6A_OFFSET UNITYSDK_OFFSET(0x17138FF0)
#define RPG_GAMECORE_CREATEAVATARASSISTANT_METHOD_3_EE674344CF57AFA3_OFFSET UNITYSDK_OFFSET(0x17139070)
#define RPG_GAMECORE_CREATEAVATARASSISTANT__CTOR_OFFSET UNITYSDK_OFFSET(0x17139040)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CreateAvatarAssistant_TypeDefinitionIndex = 21623;
