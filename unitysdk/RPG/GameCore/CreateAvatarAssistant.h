...
#define RPG_GAMECORE_CREATEAVATARASSISTANT_METHOD_3_C038EAFA4213910A_OFFSET UNITYSDK_OFFSET(0x1D9BBE00)
#define RPG_GAMECORE_CREATEAVATARASSISTANT_METHOD_3_EE674344CF57AFA3_OFFSET UNITYSDK_OFFSET(0x1D9BBE40)
#define RPG_GAMECORE_CREATEAVATARASSISTANT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D9BBE30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CreateAvatarAssistant_TypeDefinitionIndex = 23131;
