...
#define RPG_GAMECORE_CREATEAVATARASSISTANT_METHOD_3_6C2C541D8723DF6A_OFFSET UNITYSDK_OFFSET(0x18840200)
#define RPG_GAMECORE_CREATEAVATARASSISTANT_METHOD_3_EE674344CF57AFA3_OFFSET UNITYSDK_OFFSET(0x18840280)
#define RPG_GAMECORE_CREATEAVATARASSISTANT__CTOR_OFFSET UNITYSDK_OFFSET(0x18840250)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CreateAvatarAssistant_TypeDefinitionIndex = 22361;
