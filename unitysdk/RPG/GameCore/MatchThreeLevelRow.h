...
#define RPG_GAMECORE_MATCHTHREELEVELROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x198F0690)
#define RPG_GAMECORE_MATCHTHREELEVELROW__CTOR_OFFSET UNITYSDK_OFFSET(0x198F12C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MatchThreeLevelRow_TypeDefinitionIndex = 11385;
	...
	public:
		...
		::System::UInt32 HPmax; // 0x2C
		::RPG::Client::TextID VictoryDesc; // 0x30
		::RPG::Client::TextID MissionDescription; // 0x40
		::RPG::Client::TextID LoseDesc; // 0x50
		::RPG::Client::TextID LevelDescription; // 0x60
		::System::UInt32 GoMissionCondition; // 0x70
		::System::UInt32 OpponentBirdID; // 0x74
		::System::UInt32 PlayerID; // 0x78
		::System::UInt32 Mode; // 0x7C
		::System::UInt32 OpponentID; // 0x80
		::System::UInt32 PlayerBirdID; // 0x84
		::System::UInt32 RewardID; // 0x88
		::System::UInt32 TurnStep; // 0x8C
		::System::UInt32 LevelMission; // 0x90
		::System::UInt32 LevelID; // 0x94
		::RPG::Client::TextID LevelName; // 0x98
