...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_ATTACKDAMAGE_METHOD_3_6B63F2AEB0090AFF_OFFSET UNITYSDK_OFFSET(0x18875770)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_ATTACKDAMAGE_METHOD_3_B16AA230074706F9_OFFSET UNITYSDK_OFFSET(0x1887B860)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_ATTACKDAMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x18875720)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_AttackDamage_TypeDefinitionIndex = 15214;
