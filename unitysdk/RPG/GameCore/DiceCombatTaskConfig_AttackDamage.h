...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_ATTACKDAMAGE_METHOD_3_3C8C7FC597D5EB8B_OFFSET UNITYSDK_OFFSET(0x1D0349B0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_ATTACKDAMAGE_METHOD_3_6B63F2AEB0090AFF_OFFSET UNITYSDK_OFFSET(0x1D034A80)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_ATTACKDAMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D034A70)
