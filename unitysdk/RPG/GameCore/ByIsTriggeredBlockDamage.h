...
#define RPG_GAMECORE_BYISTRIGGEREDBLOCKDAMAGE_METHOD_4_00B6B408F45CF4DA_OFFSET UNITYSDK_OFFSET(0x1B2AB430)
#define RPG_GAMECORE_BYISTRIGGEREDBLOCKDAMAGE_METHOD_4_26D4B6894AFE9BDF_OFFSET UNITYSDK_OFFSET(0x1B2AB270)
#define RPG_GAMECORE_BYISTRIGGEREDBLOCKDAMAGE_METHOD_4_77B46DD83FAD02B4_OFFSET UNITYSDK_OFFSET(0x1B2AB460)
#define RPG_GAMECORE_BYISTRIGGEREDBLOCKDAMAGE_METHOD_4_AFD752447508E54E_OFFSET UNITYSDK_OFFSET(0x1B2AB2B0)
#define RPG_GAMECORE_BYISTRIGGEREDBLOCKDAMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2AB2A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsTriggeredBlockDamage_TypeDefinitionIndex = 22852;
