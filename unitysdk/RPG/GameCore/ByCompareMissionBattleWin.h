...
#define RPG_GAMECORE_BYCOMPAREMISSIONBATTLEWIN_METHOD_4_852EDC28F80B8366_OFFSET UNITYSDK_OFFSET(0x1700E750)
#define RPG_GAMECORE_BYCOMPAREMISSIONBATTLEWIN_METHOD_4_9FAC217C9534A2E4_OFFSET UNITYSDK_OFFSET(0x1700E820)
#define RPG_GAMECORE_BYCOMPAREMISSIONBATTLEWIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1700E7D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareMissionBattleWin_TypeDefinitionIndex = 19736;
