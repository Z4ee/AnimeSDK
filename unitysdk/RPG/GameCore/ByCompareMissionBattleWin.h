...
#define RPG_GAMECORE_BYCOMPAREMISSIONBATTLEWIN_METHOD_4_1C98C7693F04ADDD_OFFSET UNITYSDK_OFFSET(0x19CF2EA0)
#define RPG_GAMECORE_BYCOMPAREMISSIONBATTLEWIN_METHOD_4_52C5218C0265DA11_OFFSET UNITYSDK_OFFSET(0x19CF3080)
#define RPG_GAMECORE_BYCOMPAREMISSIONBATTLEWIN_METHOD_4_53ABD16D7F9A840E_OFFSET UNITYSDK_OFFSET(0x19CF3050)
#define RPG_GAMECORE_BYCOMPAREMISSIONBATTLEWIN_METHOD_4_9FAC217C9534A2E4_OFFSET UNITYSDK_OFFSET(0x19CF2EE0)
#define RPG_GAMECORE_BYCOMPAREMISSIONBATTLEWIN__CTOR_OFFSET UNITYSDK_OFFSET(0x19CF2ED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareMissionBattleWin_TypeDefinitionIndex = 20777;
