...
#define RPG_GAMECORE_LEVELPEDESTRIANV2INTERSECTIONCHENLINGFACTORYSTATEINFO_METHOD_2_8935A8C6754461D8_OFFSET UNITYSDK_OFFSET(0x18A54170)
#define RPG_GAMECORE_LEVELPEDESTRIANV2INTERSECTIONCHENLINGFACTORYSTATEINFO_METHOD_2_ADAD844C796F44EC_OFFSET UNITYSDK_OFFSET(0x18A544F0)
#define RPG_GAMECORE_LEVELPEDESTRIANV2INTERSECTIONCHENLINGFACTORYSTATEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18A544E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPedestrianV2IntersectionChenLingFactoryStateInfo_TypeDefinitionIndex = 16421;
