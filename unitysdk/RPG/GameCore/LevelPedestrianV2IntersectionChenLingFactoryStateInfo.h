...
#define RPG_GAMECORE_LEVELPEDESTRIANV2INTERSECTIONCHENLINGFACTORYSTATEINFO_METHOD_2_8935A8C6754461D8_OFFSET UNITYSDK_OFFSET(0x1B082AC0)
#define RPG_GAMECORE_LEVELPEDESTRIANV2INTERSECTIONCHENLINGFACTORYSTATEINFO_METHOD_2_ADAD844C796F44EC_OFFSET UNITYSDK_OFFSET(0x1B082E30)
#define RPG_GAMECORE_LEVELPEDESTRIANV2INTERSECTIONCHENLINGFACTORYSTATEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B082E20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPedestrianV2IntersectionChenLingFactoryStateInfo_TypeDefinitionIndex = 16617;
