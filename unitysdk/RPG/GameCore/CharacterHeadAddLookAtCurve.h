...
#define RPG_GAMECORE_CHARACTERHEADADDLOOKATCURVE_METHOD_3_4A825CA9E80EB76F_OFFSET UNITYSDK_OFFSET(0x1960DE60)
#define RPG_GAMECORE_CHARACTERHEADADDLOOKATCURVE_METHOD_3_FF9B2887871438EF_OFFSET UNITYSDK_OFFSET(0x1960DF80)
#define RPG_GAMECORE_CHARACTERHEADADDLOOKATCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1960DF00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterHeadAddLookAtCurve_TypeDefinitionIndex = 20693;
