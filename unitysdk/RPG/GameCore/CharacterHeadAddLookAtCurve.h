...
#define RPG_GAMECORE_CHARACTERHEADADDLOOKATCURVE_METHOD_3_922B5ADDA8948F6C_OFFSET UNITYSDK_OFFSET(0x1D121E00)
#define RPG_GAMECORE_CHARACTERHEADADDLOOKATCURVE_METHOD_3_FF9B2887871438EF_OFFSET UNITYSDK_OFFSET(0x1D121F00)
#define RPG_GAMECORE_CHARACTERHEADADDLOOKATCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D121E90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterHeadAddLookAtCurve_TypeDefinitionIndex = 21666;
