...
#define RPG_GAMECORE_SETDYNAMICVALUE_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1E818A30)
#define RPG_GAMECORE_SETDYNAMICVALUE_METHOD_4_6D5F9207B74221DB_OFFSET UNITYSDK_OFFSET(0x1E818550)
#define RPG_GAMECORE_SETDYNAMICVALUE_METHOD_4_BF3DB2E2C72F0610_OFFSET UNITYSDK_OFFSET(0x1E818350)
#define RPG_GAMECORE_SETDYNAMICVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E818510)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValue_TypeDefinitionIndex = 23548;
