...
#define RPG_GAMECORE_HIDEMONSTERSKILLINVIEWMODE_METHOD_3_4A7F28E96BA1AC16_OFFSET UNITYSDK_OFFSET(0x189FF4E0)
#define RPG_GAMECORE_HIDEMONSTERSKILLINVIEWMODE_METHOD_3_AF40FAAC350034FA_OFFSET UNITYSDK_OFFSET(0x189FF400)
#define RPG_GAMECORE_HIDEMONSTERSKILLINVIEWMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x189FF480)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HideMonsterSkillInViewMode_TypeDefinitionIndex = 22146;
