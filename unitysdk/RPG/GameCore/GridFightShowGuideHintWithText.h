...
#define RPG_GAMECORE_GRIDFIGHTSHOWGUIDEHINTWITHTEXT_METHOD_3_DE418EA7BBDDBEB5_OFFSET UNITYSDK_OFFSET(0x189D76F0)
#define RPG_GAMECORE_GRIDFIGHTSHOWGUIDEHINTWITHTEXT_METHOD_3_E10363977A67381C_OFFSET UNITYSDK_OFFSET(0x189D7770)
#define RPG_GAMECORE_GRIDFIGHTSHOWGUIDEHINTWITHTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x189D7740)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightShowGuideHintWithText_TypeDefinitionIndex = 18894;
