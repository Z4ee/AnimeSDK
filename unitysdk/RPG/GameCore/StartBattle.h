...
#define RPG_GAMECORE_STARTBATTLE_METHOD_3_86CA1652D591F315_OFFSET UNITYSDK_OFFSET(0x17773A70)
#define RPG_GAMECORE_STARTBATTLE_METHOD_3_9C418B1608039801_OFFSET UNITYSDK_OFFSET(0x17773960)
#define RPG_GAMECORE_STARTBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x17773A40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StartBattle_TypeDefinitionIndex = 21632;
