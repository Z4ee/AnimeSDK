...
#define RPG_GAMECORE_TUTORIALWAITCUSTOMSTRING_METHOD_4_917E24E6B202F7F5_OFFSET UNITYSDK_OFFSET(0x190DE180)
#define RPG_GAMECORE_TUTORIALWAITCUSTOMSTRING_METHOD_4_DC113D8FA0466F8C_OFFSET UNITYSDK_OFFSET(0x190DE100)
#define RPG_GAMECORE_TUTORIALWAITCUSTOMSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x190DE150)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TutorialWaitCustomString_TypeDefinitionIndex = 23390;
