...
#define RPG_GAMECORE_EXITGAMEFLOW_METHOD_3_40F4CD8C7BBFBB95_OFFSET UNITYSDK_OFFSET(0x1C068CD0)
#define RPG_GAMECORE_EXITGAMEFLOW_METHOD_3_5A8006FACB5410FE_OFFSET UNITYSDK_OFFSET(0x1C068C90)
#define RPG_GAMECORE_EXITGAMEFLOW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C068CC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ExitGameFlow_TypeDefinitionIndex = 23208;
