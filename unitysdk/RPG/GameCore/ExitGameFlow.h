...
#define RPG_GAMECORE_EXITGAMEFLOW_METHOD_3_9622DD342725DCCC_OFFSET UNITYSDK_OFFSET(0x171B5570)
#define RPG_GAMECORE_EXITGAMEFLOW_METHOD_3_F1CD6625A72C375D_OFFSET UNITYSDK_OFFSET(0x171B54F0)
#define RPG_GAMECORE_EXITGAMEFLOW__CTOR_OFFSET UNITYSDK_OFFSET(0x171B5540)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ExitGameFlow_TypeDefinitionIndex = 22311;
