...
#define RPG_GAMECORE_SETDYNAMICVALUEBYTOURNFLOORTYPE_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x18E29F20)
#define RPG_GAMECORE_SETDYNAMICVALUEBYTOURNFLOORTYPE_METHOD_4_A8197B7D0DA20EF5_OFFSET UNITYSDK_OFFSET(0x18E29CF0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYTOURNFLOORTYPE_METHOD_4_C308C45409B3B076_OFFSET UNITYSDK_OFFSET(0x18E29DC0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYTOURNFLOORTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E29D70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByTournFloorType_TypeDefinitionIndex = 22050;
