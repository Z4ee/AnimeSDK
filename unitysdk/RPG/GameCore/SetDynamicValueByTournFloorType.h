...
#define RPG_GAMECORE_SETDYNAMICVALUEBYTOURNFLOORTYPE_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x19C46C40)
#define RPG_GAMECORE_SETDYNAMICVALUEBYTOURNFLOORTYPE_METHOD_4_A8197B7D0DA20EF5_OFFSET UNITYSDK_OFFSET(0x19C46A10)
#define RPG_GAMECORE_SETDYNAMICVALUEBYTOURNFLOORTYPE_METHOD_4_C308C45409B3B076_OFFSET UNITYSDK_OFFSET(0x19C46AE0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYTOURNFLOORTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C46A90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByTournFloorType_TypeDefinitionIndex = 21855;
