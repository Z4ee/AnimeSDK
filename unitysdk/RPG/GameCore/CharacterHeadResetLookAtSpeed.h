...
#define RPG_GAMECORE_CHARACTERHEADRESETLOOKATSPEED_METHOD_3_43259C2829057634_OFFSET UNITYSDK_OFFSET(0x1D122580)
#define RPG_GAMECORE_CHARACTERHEADRESETLOOKATSPEED_METHOD_3_FDE47A0733DFEC4F_OFFSET UNITYSDK_OFFSET(0x1D1225C0)
#define RPG_GAMECORE_CHARACTERHEADRESETLOOKATSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1225B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterHeadResetLookAtSpeed_TypeDefinitionIndex = 20629;
