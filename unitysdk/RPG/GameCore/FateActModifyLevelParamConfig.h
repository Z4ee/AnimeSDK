...
#define RPG_GAMECORE_FATEACTMODIFYLEVELPARAMCONFIG_METHOD_6_51C134C2E14D8C49_OFFSET UNITYSDK_OFFSET(0x171C1E40)
#define RPG_GAMECORE_FATEACTMODIFYLEVELPARAMCONFIG_METHOD_6_611D252F3AEA0502_OFFSET UNITYSDK_OFFSET(0x171C1CD0)
#define RPG_GAMECORE_FATEACTMODIFYLEVELPARAMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171C1DA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateActModifyLevelParamConfig_TypeDefinitionIndex = 17656;
