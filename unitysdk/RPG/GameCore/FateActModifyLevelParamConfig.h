...
#define RPG_GAMECORE_FATEACTMODIFYLEVELPARAMCONFIG_METHOD_6_130643BD4A5C43C5_OFFSET UNITYSDK_OFFSET(0x1C073810)
#define RPG_GAMECORE_FATEACTMODIFYLEVELPARAMCONFIG_METHOD_6_51C134C2E14D8C49_OFFSET UNITYSDK_OFFSET(0x1C073860)
#define RPG_GAMECORE_FATEACTMODIFYLEVELPARAMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C073850)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateActModifyLevelParamConfig_TypeDefinitionIndex = 18476;
