...
#define RPG_GAMECORE_FATEACTMODIFYLEVELPARAMCONFIG_METHOD_6_51C134C2E14D8C49_OFFSET UNITYSDK_OFFSET(0x1970C560)
#define RPG_GAMECORE_FATEACTMODIFYLEVELPARAMCONFIG_METHOD_6_611D252F3AEA0502_OFFSET UNITYSDK_OFFSET(0x1970C3F0)
#define RPG_GAMECORE_FATEACTMODIFYLEVELPARAMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1970C4C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateActModifyLevelParamConfig_TypeDefinitionIndex = 18242;
