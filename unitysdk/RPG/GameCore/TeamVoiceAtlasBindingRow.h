...
#define RPG_GAMECORE_TEAMVOICEATLASBINDINGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1E1CF620)
#define RPG_GAMECORE_TEAMVOICEATLASBINDINGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1CF790)
