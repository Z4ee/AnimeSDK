...
#define RPG_GAMECORE_ADVGAMEPLAYCOUNTERRECOVER_METHOD_3_148C2F4861C9154A_OFFSET UNITYSDK_OFFSET(0x19425690)
#define RPG_GAMECORE_ADVGAMEPLAYCOUNTERRECOVER_METHOD_3_362DE3F93F7E73DD_OFFSET UNITYSDK_OFFSET(0x19425710)
#define RPG_GAMECORE_ADVGAMEPLAYCOUNTERRECOVER__CTOR_OFFSET UNITYSDK_OFFSET(0x194256E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvGameplayCounterRecover_TypeDefinitionIndex = 20456;
