...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TRIGGERSPECIALHINT_METHOD_3_0488F5D6FCD2DA52_OFFSET UNITYSDK_OFFSET(0x1C11B450)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TRIGGERSPECIALHINT_METHOD_3_88DFFECF1381E3CE_OFFSET UNITYSDK_OFFSET(0x1C11B380)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TRIGGERSPECIALHINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C11B440)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_TriggerSpecialHint_TypeDefinitionIndex = 15432;
