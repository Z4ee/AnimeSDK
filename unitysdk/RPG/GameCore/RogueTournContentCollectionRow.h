...
#define RPG_GAMECORE_ROGUETOURNCONTENTCOLLECTIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17662130)
#define RPG_GAMECORE_ROGUETOURNCONTENTCOLLECTIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17662530)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournContentCollectionRow_TypeDefinitionIndex = 13772;
	...
	public:
		...
		::System::UInt32 CollectionID; // 0x30
		::RPG::Client::TextID CollectionEffectDesc; // 0x38
		::RPG::Client::TextID CollectionName; // 0x48
