...
#define RPG_GAMECORE_TRACKNPCPERCEIVEVALUECONFIG_METHOD_2_654B493F1648967E_OFFSET UNITYSDK_OFFSET(0x190A2910)
#define RPG_GAMECORE_TRACKNPCPERCEIVEVALUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x190A2B10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrackNpcPerceiveValueConfig_TypeDefinitionIndex = 21044;
