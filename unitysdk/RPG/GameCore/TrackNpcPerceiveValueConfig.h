...
#define RPG_GAMECORE_TRACKNPCPERCEIVEVALUECONFIG_METHOD_2_654B493F1648967E_OFFSET UNITYSDK_OFFSET(0x1D52EE80)
#define RPG_GAMECORE_TRACKNPCPERCEIVEVALUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D52F080)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrackNpcPerceiveValueConfig_TypeDefinitionIndex = 21929;
