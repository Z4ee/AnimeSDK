...
#define RPG_GAMECORE_PREPAREFINISHMAZEPUZZLECHALLENGE_METHOD_3_253B404E290E8F52_OFFSET UNITYSDK_OFFSET(0x18C615E0)
#define RPG_GAMECORE_PREPAREFINISHMAZEPUZZLECHALLENGE_METHOD_3_CD9C4753B37DEEFB_OFFSET UNITYSDK_OFFSET(0x18C61560)
#define RPG_GAMECORE_PREPAREFINISHMAZEPUZZLECHALLENGE__CTOR_OFFSET UNITYSDK_OFFSET(0x18C615B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PrepareFinishMazePuzzleChallenge_TypeDefinitionIndex = 20869;
