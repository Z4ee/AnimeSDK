...
#define RPG_GAMECORE_MONOPOLYCHECKSWITCHMAP_METHOD_3_0CDC3B4570B024E7_OFFSET UNITYSDK_OFFSET(0x17437480)
#define RPG_GAMECORE_MONOPOLYCHECKSWITCHMAP_METHOD_3_32372608BF64DE48_OFFSET UNITYSDK_OFFSET(0x17437400)
#define RPG_GAMECORE_MONOPOLYCHECKSWITCHMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x17437450)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonopolyCheckSwitchMap_TypeDefinitionIndex = 19262;
