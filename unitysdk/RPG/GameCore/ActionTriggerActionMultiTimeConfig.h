...
#define RPG_GAMECORE_ACTIONTRIGGERACTIONMULTITIMECONFIG_METHOD_4_0997F8B176ED00BE_OFFSET UNITYSDK_OFFSET(0x16E9E550)
#define RPG_GAMECORE_ACTIONTRIGGERACTIONMULTITIMECONFIG_METHOD_4_D66C6130E0653A01_OFFSET UNITYSDK_OFFSET(0x16E9E7D0)
#define RPG_GAMECORE_ACTIONTRIGGERACTIONMULTITIMECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16E9E6C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActionTriggerActionMultiTimeConfig_TypeDefinitionIndex = 15613;
