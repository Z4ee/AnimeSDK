...
#define RPG_GAMECORE_ACTIONTRIGGERACTIONMULTITIMECONFIG_METHOD_4_D66C6130E0653A01_OFFSET UNITYSDK_OFFSET(0x1AAD8AC0)
#define RPG_GAMECORE_ACTIONTRIGGERACTIONMULTITIMECONFIG_METHOD_4_EBD60B99107DC6E4_OFFSET UNITYSDK_OFFSET(0x1AAD89E0)
#define RPG_GAMECORE_ACTIONTRIGGERACTIONMULTITIMECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAD8A70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActionTriggerActionMultiTimeConfig_TypeDefinitionIndex = 16367;
