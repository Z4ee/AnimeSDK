...
#define RPG_GAMECORE_VIDEOCAPTION_METHOD_2_9A0198C2ADB8ADF6_OFFSET UNITYSDK_OFFSET(0x178EF7A0)
#define RPG_GAMECORE_VIDEOCAPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x178EFA20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VideoCaption_TypeDefinitionIndex = 15579;
