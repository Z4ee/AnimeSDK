...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONROGUEMAGICPOSTSTARTCONFIG_METHOD_3_1DF6C3EC0C499EE3_OFFSET UNITYSDK_OFFSET(0x1CFC0D90)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONROGUEMAGICPOSTSTARTCONFIG_METHOD_3_F8B519C42BDCBEDF_OFFSET UNITYSDK_OFFSET(0x1CFC0D40)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONROGUEMAGICPOSTSTARTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFC0D80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnRogueMagicPostStartConfig_TypeDefinitionIndex = 17018;
