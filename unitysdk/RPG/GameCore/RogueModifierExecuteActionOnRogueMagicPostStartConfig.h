...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONROGUEMAGICPOSTSTARTCONFIG_METHOD_3_1DF6C3EC0C499EE3_OFFSET UNITYSDK_OFFSET(0x18D3E500)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONROGUEMAGICPOSTSTARTCONFIG_METHOD_3_F3F415A8B00D832A_OFFSET UNITYSDK_OFFSET(0x18D3E430)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONROGUEMAGICPOSTSTARTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D3E4B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnRogueMagicPostStartConfig_TypeDefinitionIndex = 16841;
