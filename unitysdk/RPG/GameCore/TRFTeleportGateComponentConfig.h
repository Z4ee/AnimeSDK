...
#define RPG_GAMECORE_TRFTELEPORTGATECOMPONENTCONFIG_METHOD_3_53DD3365BB689D34_OFFSET UNITYSDK_OFFSET(0x1D59CC20)
#define RPG_GAMECORE_TRFTELEPORTGATECOMPONENTCONFIG_METHOD_3_9688010784CB1F58_OFFSET UNITYSDK_OFFSET(0x1D59CBC0)
#define RPG_GAMECORE_TRFTELEPORTGATECOMPONENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D59CC10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TRFTeleportGateComponentConfig_TypeDefinitionIndex = 18691;
