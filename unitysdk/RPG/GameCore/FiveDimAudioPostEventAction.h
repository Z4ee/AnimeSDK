...
#define RPG_GAMECORE_FIVEDIMAUDIOPOSTEVENTACTION_METHOD_3_21244081DC4664B7_OFFSET UNITYSDK_OFFSET(0x19728140)
#define RPG_GAMECORE_FIVEDIMAUDIOPOSTEVENTACTION_METHOD_3_E859BA6BF51BF0EE_OFFSET UNITYSDK_OFFSET(0x197280D0)
#define RPG_GAMECORE_FIVEDIMAUDIOPOSTEVENTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19728120)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimAudioPostEventAction_TypeDefinitionIndex = 17809;
