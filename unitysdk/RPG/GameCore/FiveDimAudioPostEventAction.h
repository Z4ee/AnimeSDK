...
#define RPG_GAMECORE_FIVEDIMAUDIOPOSTEVENTACTION_METHOD_3_21244081DC4664B7_OFFSET UNITYSDK_OFFSET(0x188EB9F0)
#define RPG_GAMECORE_FIVEDIMAUDIOPOSTEVENTACTION_METHOD_3_E859BA6BF51BF0EE_OFFSET UNITYSDK_OFFSET(0x188EB980)
#define RPG_GAMECORE_FIVEDIMAUDIOPOSTEVENTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x188EB9D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimAudioPostEventAction_TypeDefinitionIndex = 17782;
