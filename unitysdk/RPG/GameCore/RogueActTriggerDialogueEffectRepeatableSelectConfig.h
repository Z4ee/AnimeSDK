...
#define RPG_GAMECORE_ROGUEACTTRIGGERDIALOGUEEFFECTREPEATABLESELECTCONFIG_METHOD_6_38665DCFBC22E2F4_OFFSET UNITYSDK_OFFSET(0x1C49E490)
#define RPG_GAMECORE_ROGUEACTTRIGGERDIALOGUEEFFECTREPEATABLESELECTCONFIG_METHOD_6_5712C13427E33378_OFFSET UNITYSDK_OFFSET(0x1C49E440)
#define RPG_GAMECORE_ROGUEACTTRIGGERDIALOGUEEFFECTREPEATABLESELECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C49E480)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActTriggerDialogueEffectRepeatableSelectConfig_TypeDefinitionIndex = 18879;
