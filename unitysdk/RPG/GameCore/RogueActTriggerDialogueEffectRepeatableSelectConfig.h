...
#define RPG_GAMECORE_ROGUEACTTRIGGERDIALOGUEEFFECTREPEATABLESELECTCONFIG_METHOD_6_38665DCFBC22E2F4_OFFSET UNITYSDK_OFFSET(0x18CD5E00)
#define RPG_GAMECORE_ROGUEACTTRIGGERDIALOGUEEFFECTREPEATABLESELECTCONFIG_METHOD_6_BE24719824D70B59_OFFSET UNITYSDK_OFFSET(0x18CD5BE0)
#define RPG_GAMECORE_ROGUEACTTRIGGERDIALOGUEEFFECTREPEATABLESELECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CD5D20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActTriggerDialogueEffectRepeatableSelectConfig_TypeDefinitionIndex = 18636;
