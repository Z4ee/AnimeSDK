...
#define RPG_GAMECORE_ROGUELAYEREFFECTCONFIG_METHOD_2_553FFFFCBE68CCE4_OFFSET UNITYSDK_OFFSET(0x18D1D870)
#define RPG_GAMECORE_ROGUELAYEREFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D1D8B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueLayerEffectConfig_TypeDefinitionIndex = 17018;
