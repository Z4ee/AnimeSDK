...
#define RPG_GAMECORE_ROGUELAYEREFFECTCONFIG_METHOD_2_553FFFFCBE68CCE4_OFFSET UNITYSDK_OFFSET(0x19B41EE0)
#define RPG_GAMECORE_ROGUELAYEREFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B41F20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueLayerEffectConfig_TypeDefinitionIndex = 17032;
