...
#define RPG_GAMECORE_ROGUELAYEREFFECTCONFIG_METHOD_2_553FFFFCBE68CCE4_OFFSET UNITYSDK_OFFSET(0x17610790)
#define RPG_GAMECORE_ROGUELAYEREFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x176107D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueLayerEffectConfig_TypeDefinitionIndex = 16464;
