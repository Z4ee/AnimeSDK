...
#define RPG_GAMECORE_ROGUELAYEREFFECTCONFIG_METHOD_2_553FFFFCBE68CCE4_OFFSET UNITYSDK_OFFSET(0x1CFB3E50)
#define RPG_GAMECORE_ROGUELAYEREFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFB3E90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueLayerEffectConfig_TypeDefinitionIndex = 17194;
