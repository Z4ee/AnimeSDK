...
#define RPG_GAMECORE_CHIMERADUELATTRIBUTECOMPAREPREDICATE_METHOD_3_38D9B5D70352A8CB_OFFSET UNITYSDK_OFFSET(0x187F4F70)
#define RPG_GAMECORE_CHIMERADUELATTRIBUTECOMPAREPREDICATE_METHOD_3_AE95796245A51261_OFFSET UNITYSDK_OFFSET(0x187F4F10)
#define RPG_GAMECORE_CHIMERADUELATTRIBUTECOMPAREPREDICATE__CTOR_OFFSET UNITYSDK_OFFSET(0x187F4F60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelAttributeComparePredicate_TypeDefinitionIndex = 15140;
