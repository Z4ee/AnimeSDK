...
#define RPG_GAMECORE_CHIMERADUELATTRIBUTECOMPAREPREDICATE_METHOD_3_38D9B5D70352A8CB_OFFSET UNITYSDK_OFFSET(0x1C390F40)
#define RPG_GAMECORE_CHIMERADUELATTRIBUTECOMPAREPREDICATE_METHOD_3_AE95796245A51261_OFFSET UNITYSDK_OFFSET(0x1C390EE0)
#define RPG_GAMECORE_CHIMERADUELATTRIBUTECOMPAREPREDICATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C390F30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelAttributeComparePredicate_TypeDefinitionIndex = 15366;
