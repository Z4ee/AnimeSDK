...
#define RPG_GAMECORE_CHIMERADUELATTRIBUTECOMPAREPREDICATE_METHOD_3_38D9B5D70352A8CB_OFFSET UNITYSDK_OFFSET(0x17095BC0)
#define RPG_GAMECORE_CHIMERADUELATTRIBUTECOMPAREPREDICATE_METHOD_3_AE95796245A51261_OFFSET UNITYSDK_OFFSET(0x17095B60)
#define RPG_GAMECORE_CHIMERADUELATTRIBUTECOMPAREPREDICATE__CTOR_OFFSET UNITYSDK_OFFSET(0x17095BB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelAttributeComparePredicate_TypeDefinitionIndex = 14670;
