...
#define RPG_GAMECORE_ROGUEDLCJOYHELPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C4BE530)
#define RPG_GAMECORE_ROGUEDLCJOYHELPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4BE6B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueDLCJoyHelpRow_TypeDefinitionIndex = 14166;
