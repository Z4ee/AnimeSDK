...
#define RPG_GAMECORE_ROGUEDLCJOYHELPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19B315B0)
#define RPG_GAMECORE_ROGUEDLCJOYHELPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19B31730)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueDLCJoyHelpRow_TypeDefinitionIndex = 14018;
