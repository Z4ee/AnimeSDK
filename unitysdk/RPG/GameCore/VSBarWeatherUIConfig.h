...
#define RPG_GAMECORE_VSBARWEATHERUICONFIG_METHOD_3_4D1CC4C8A0253089_OFFSET UNITYSDK_OFFSET(0x190F10C0)
#define RPG_GAMECORE_VSBARWEATHERUICONFIG_METHOD_3_56C36F8EEAAD3EE6_OFFSET UNITYSDK_OFFSET(0x190F1060)
#define RPG_GAMECORE_VSBARWEATHERUICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x190F10B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VSBarWeatherUIConfig_TypeDefinitionIndex = 21699;
