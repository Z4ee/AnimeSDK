...
#define RPG_GAMECORE_IDLELIVEGIFTACTIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D211990)
#define RPG_GAMECORE_IDLELIVEGIFTACTIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D211B70)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::IdleLiveGiftEffectType EffectType; // 0x24
