...
#define RPG_GAMECORE_ADVCHANGESKILLTREELEVEL_METHOD_3_0E6B8BCC6D64CFFC_OFFSET UNITYSDK_OFFSET(0x1864A6B0)
#define RPG_GAMECORE_ADVCHANGESKILLTREELEVEL_METHOD_3_B1B3B1B66E39E3E3_OFFSET UNITYSDK_OFFSET(0x1864A720)
#define RPG_GAMECORE_ADVCHANGESKILLTREELEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1864A6F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvChangeSkillTreeLevel_TypeDefinitionIndex = 20669;
