...
#define RPG_GAMECORE_MATERIALPROPERTYADAPTIONCONFIG_METHOD_2_4C72F6776953E482_OFFSET UNITYSDK_OFFSET(0x18AC7920)
#define RPG_GAMECORE_MATERIALPROPERTYADAPTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18AC7A30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MaterialPropertyAdaptionConfig_TypeDefinitionIndex = 15627;
