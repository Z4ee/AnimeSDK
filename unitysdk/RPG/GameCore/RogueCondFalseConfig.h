...
#define RPG_GAMECORE_ROGUECONDFALSECONFIG_METHOD_6_57CD737F0E0206D7_OFFSET UNITYSDK_OFFSET(0x1C4AEB20)
#define RPG_GAMECORE_ROGUECONDFALSECONFIG_METHOD_6_FC3BB185594E4BBB_OFFSET UNITYSDK_OFFSET(0x1C4AEB70)
#define RPG_GAMECORE_ROGUECONDFALSECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4AEB60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueCondFalseConfig_TypeDefinitionIndex = 19035;
