...
#define RPG_GAMECORE_ROGUECONDFALSECONFIG_METHOD_6_45DB7C0830A847D5_OFFSET UNITYSDK_OFFSET(0x19B1BF90)
#define RPG_GAMECORE_ROGUECONDFALSECONFIG_METHOD_6_FC3BB185594E4BBB_OFFSET UNITYSDK_OFFSET(0x19B1C240)
#define RPG_GAMECORE_ROGUECONDFALSECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B1C110)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueCondFalseConfig_TypeDefinitionIndex = 18756;
