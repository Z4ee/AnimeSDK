...
#define RPG_GAMECORE_ROGUEACTREPLACEALLROGUEFORMULABYCATEGORYCONFIG_METHOD_6_DAC21F1AB0199546_OFFSET UNITYSDK_OFFSET(0x1EE88A40)
#define RPG_GAMECORE_ROGUEACTREPLACEALLROGUEFORMULABYCATEGORYCONFIG_METHOD_6_DE4DC5F95B521DE2_OFFSET UNITYSDK_OFFSET(0x1EE88A90)
#define RPG_GAMECORE_ROGUEACTREPLACEALLROGUEFORMULABYCATEGORYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EE88A80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActReplaceAllRogueFormulaByCategoryConfig_TypeDefinitionIndex = 19430;
