...
#define RPG_GAMECORE_SHAREDBOOL_METHOD_3_2082EC9BFB86A0C3_OFFSET UNITYSDK_OFFSET(0x19C6D7F0)
#define RPG_GAMECORE_SHAREDBOOL_METHOD_3_97073A57071BA0FC_OFFSET UNITYSDK_OFFSET(0x19C6D7B0)
#define RPG_GAMECORE_SHAREDBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x19C6D7E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SharedBool_TypeDefinitionIndex = 17401;
