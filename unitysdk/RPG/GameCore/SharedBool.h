...
#define RPG_GAMECORE_SHAREDBOOL_METHOD_3_2082EC9BFB86A0C3_OFFSET UNITYSDK_OFFSET(0x18E51240)
#define RPG_GAMECORE_SHAREDBOOL_METHOD_3_97073A57071BA0FC_OFFSET UNITYSDK_OFFSET(0x18E51200)
#define RPG_GAMECORE_SHAREDBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x18E51230)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SharedBool_TypeDefinitionIndex = 17396;
