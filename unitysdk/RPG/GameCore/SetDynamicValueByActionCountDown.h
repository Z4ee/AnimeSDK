...
#define RPG_GAMECORE_SETDYNAMICVALUEBYACTIONCOUNTDOWN_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1C2DDFE0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYACTIONCOUNTDOWN_METHOD_4_9263E45F201597C3_OFFSET UNITYSDK_OFFSET(0x1C2DDE70)
#define RPG_GAMECORE_SETDYNAMICVALUEBYACTIONCOUNTDOWN_METHOD_4_B8F7D5595E8F455C_OFFSET UNITYSDK_OFFSET(0x1C2DDE30)
#define RPG_GAMECORE_SETDYNAMICVALUEBYACTIONCOUNTDOWN__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2DDE60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByActionCountDown_TypeDefinitionIndex = 22840;
