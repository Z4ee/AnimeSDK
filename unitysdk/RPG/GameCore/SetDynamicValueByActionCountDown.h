...
#define RPG_GAMECORE_SETDYNAMICVALUEBYACTIONCOUNTDOWN_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x176C0180)
#define RPG_GAMECORE_SETDYNAMICVALUEBYACTIONCOUNTDOWN_METHOD_4_4BCB6E12A3733FEE_OFFSET UNITYSDK_OFFSET(0x176C0100)
#define RPG_GAMECORE_SETDYNAMICVALUEBYACTIONCOUNTDOWN_METHOD_4_9263E45F201597C3_OFFSET UNITYSDK_OFFSET(0x176B6850)
#define RPG_GAMECORE_SETDYNAMICVALUEBYACTIONCOUNTDOWN__CTOR_OFFSET UNITYSDK_OFFSET(0x176B6800)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByActionCountDown_TypeDefinitionIndex = 21942;
