...
#define RPG_GAMECORE_MONOPOLYTRIGGERMOVETONEXTMAP_METHOD_3_100524A6C5EF0A96_OFFSET UNITYSDK_OFFSET(0x1D1D21B0)
#define RPG_GAMECORE_MONOPOLYTRIGGERMOVETONEXTMAP_METHOD_3_D77ABD3D52FDF1D3_OFFSET UNITYSDK_OFFSET(0x1D1D2280)
#define RPG_GAMECORE_MONOPOLYTRIGGERMOVETONEXTMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1D2270)
