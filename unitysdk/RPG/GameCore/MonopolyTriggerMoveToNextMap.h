...
#define RPG_GAMECORE_MONOPOLYTRIGGERMOVETONEXTMAP_METHOD_3_100524A6C5EF0A96_OFFSET UNITYSDK_OFFSET(0x1D2CBA20)
#define RPG_GAMECORE_MONOPOLYTRIGGERMOVETONEXTMAP_METHOD_3_D77ABD3D52FDF1D3_OFFSET UNITYSDK_OFFSET(0x1D2CBAF0)
#define RPG_GAMECORE_MONOPOLYTRIGGERMOVETONEXTMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2CBAE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonopolyTriggerMoveToNextMap_TypeDefinitionIndex = 20699;
