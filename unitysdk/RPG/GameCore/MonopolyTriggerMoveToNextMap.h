...
#define RPG_GAMECORE_MONOPOLYTRIGGERMOVETONEXTMAP_METHOD_3_0DE4E977057C907F_OFFSET UNITYSDK_OFFSET(0x17448A10)
#define RPG_GAMECORE_MONOPOLYTRIGGERMOVETONEXTMAP_METHOD_3_D77ABD3D52FDF1D3_OFFSET UNITYSDK_OFFSET(0x17448B20)
#define RPG_GAMECORE_MONOPOLYTRIGGERMOVETONEXTMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x17448AF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonopolyTriggerMoveToNextMap_TypeDefinitionIndex = 19267;
