...
#define RPG_GAMECORE_TARGETFETCHLASTSEARCHENTITY_METHOD_4_63BE2E2004A04615_OFFSET UNITYSDK_OFFSET(0x1D5ABC80)
#define RPG_GAMECORE_TARGETFETCHLASTSEARCHENTITY_METHOD_4_91267E0F4290A1F5_OFFSET UNITYSDK_OFFSET(0x1D5ABBA0)
#define RPG_GAMECORE_TARGETFETCHLASTSEARCHENTITY_METHOD_4_CEFEC49CBAB8DA9C_OFFSET UNITYSDK_OFFSET(0x1D5ABCB0)
#define RPG_GAMECORE_TARGETFETCHLASTSEARCHENTITY_METHOD_4_EF51959009FCDFE6_OFFSET UNITYSDK_OFFSET(0x1D5ABBE0)
#define RPG_GAMECORE_TARGETFETCHLASTSEARCHENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5ABBD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchLastSearchEntity_TypeDefinitionIndex = 23611;
