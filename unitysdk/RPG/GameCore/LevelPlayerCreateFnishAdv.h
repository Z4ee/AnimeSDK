...
#define RPG_GAMECORE_LEVELPLAYERCREATEFNISHADV_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xCE4C590)
#define RPG_GAMECORE_LEVELPLAYERCREATEFNISHADV_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xCE4C540)
#define RPG_GAMECORE_LEVELPLAYERCREATEFNISHADV_INIT_OFFSET UNITYSDK_OFFSET(0xCE4C500)
#define RPG_GAMECORE_LEVELPLAYERCREATEFNISHADV__CTOR_OFFSET UNITYSDK_OFFSET(0xCE4C5E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPlayerCreateFnishAdv_TypeDefinitionIndex = 53091;
