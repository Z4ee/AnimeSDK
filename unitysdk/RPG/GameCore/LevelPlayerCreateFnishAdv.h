...
#define RPG_GAMECORE_LEVELPLAYERCREATEFNISHADV_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1BE023A0)
#define RPG_GAMECORE_LEVELPLAYERCREATEFNISHADV_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x1BE02350)
#define RPG_GAMECORE_LEVELPLAYERCREATEFNISHADV_INIT_OFFSET UNITYSDK_OFFSET(0x1BE02310)
#define RPG_GAMECORE_LEVELPLAYERCREATEFNISHADV__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE023F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPlayerCreateFnishAdv_TypeDefinitionIndex = 54305;
