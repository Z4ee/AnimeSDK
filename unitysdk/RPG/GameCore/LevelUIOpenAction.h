...
#define RPG_GAMECORE_LEVELUIOPENACTION_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xCE56D70)
#define RPG_GAMECORE_LEVELUIOPENACTION_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xCE56DC0)
#define RPG_GAMECORE_LEVELUIOPENACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xCE56E10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelUIOpenAction_TypeDefinitionIndex = 52958;
