...
#define RPG_GAMECORE_LEVELUIOPENACTION_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1978A3E0)
#define RPG_GAMECORE_LEVELUIOPENACTION_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x1978A430)
#define RPG_GAMECORE_LEVELUIOPENACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1978A480)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelUIOpenAction_TypeDefinitionIndex = 54171;
