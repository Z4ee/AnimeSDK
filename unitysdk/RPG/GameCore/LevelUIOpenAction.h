...
#define RPG_GAMECORE_LEVELUIOPENACTION_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xA999D60)
#define RPG_GAMECORE_LEVELUIOPENACTION_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xA999DB0)
#define RPG_GAMECORE_LEVELUIOPENACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xA999E00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelUIOpenAction_TypeDefinitionIndex = 45611;
