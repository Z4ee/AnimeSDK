...
#define RPG_GAMECORE_GRIDFIGHTRANKSKILLMODIFYCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D071330)
#define RPG_GAMECORE_GRIDFIGHTRANKSKILLMODIFYCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D071560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightRankSkillModifyConfigRow_TypeDefinitionIndex = 13018;
