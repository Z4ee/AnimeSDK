...
#define RPG_GAMECORE_IDLELIVESPEQUIPSLOTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D214D40)
#define RPG_GAMECORE_IDLELIVESPEQUIPSLOTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D214FF0)
