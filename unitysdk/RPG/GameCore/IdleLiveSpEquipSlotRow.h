...
#define RPG_GAMECORE_IDLELIVESPEQUIPSLOTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B0077A0)
#define RPG_GAMECORE_IDLELIVESPEQUIPSLOTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B007A50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int IdleLiveSpEquipSlotRow_TypeDefinitionIndex = 11354;

	class IdleLiveSpEquipSlotRow : public ::System::Object
	{
	public:
		::System::String* ImagePath; // 0x10
		::System::UInt32 TeamSlot; // 0x18
