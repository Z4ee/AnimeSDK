...
#define RPG_GAMECORE_IDLELIVESPEQUIPSLOTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D1A3710)
#define RPG_GAMECORE_IDLELIVESPEQUIPSLOTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1A39C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int IdleLiveSpEquipSlotRow_TypeDefinitionIndex = 11743;
