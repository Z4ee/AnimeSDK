...
#define RPG_GAMECORE_CHRONICLENODECONFIG_METHOD_2_E307055AE30EFE5F_OFFSET UNITYSDK_OFFSET(0x1CFD6C60)
#define RPG_GAMECORE_CHRONICLENODECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFD72C0)
