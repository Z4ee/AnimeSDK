...
#define RPG_GAMECORE_CHRONICLENODECONFIG_METHOD_2_8F565A14E8ECFF74_OFFSET UNITYSDK_OFFSET(0x1880DBA0)
#define RPG_GAMECORE_CHRONICLENODECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1880E1D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChronicleNodeConfig_TypeDefinitionIndex = 17998;
	...
	public:
		...
		static ::System::Void Method_2_8F565A14E8ECFF74(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::ChronicleNodeConfig*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::ChronicleNodeConfig*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_CHRONICLENODECONFIG_METHOD_2_8F565A14E8ECFF74_OFFSET))(a1, a2);
		}
	};
}
