...
#define RPG_GAMECORE_GRIDFIGHTENEMYDIFFICULTYLVCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D966910)
#define RPG_GAMECORE_GRIDFIGHTENEMYDIFFICULTYLVCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D966CC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightEnemyDifficultyLvConfigRow_TypeDefinitionIndex = 13534;
	...
	public:
		...
		::System::UInt32 EnemyDifficultyLevel; // 0x30
