...
#define RPG_GAMECORE_LEVELANCHORCAMERAPARAMETER_METHOD_3_34E39C421955B303_OFFSET UNITYSDK_OFFSET(0x1B02C920)
#define RPG_GAMECORE_LEVELANCHORCAMERAPARAMETER_METHOD_3_F0F9D3BA42D0D392_OFFSET UNITYSDK_OFFSET(0x1B02C8E0)
#define RPG_GAMECORE_LEVELANCHORCAMERAPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B02C910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelAnchorCameraParameter_TypeDefinitionIndex = 16557;
