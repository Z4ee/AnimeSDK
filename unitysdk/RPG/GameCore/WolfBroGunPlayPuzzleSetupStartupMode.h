...
#define RPG_GAMECORE_WOLFBROGUNPLAYPUZZLESETUPSTARTUPMODE_METHOD_3_55BEE7ECD493A447_OFFSET UNITYSDK_OFFSET(0x1910FCA0)
#define RPG_GAMECORE_WOLFBROGUNPLAYPUZZLESETUPSTARTUPMODE_METHOD_3_B43F89DEA0A5CBC6_OFFSET UNITYSDK_OFFSET(0x1910FD20)
#define RPG_GAMECORE_WOLFBROGUNPLAYPUZZLESETUPSTARTUPMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1910FCF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WolfBroGunPlayPuzzleSetupStartupMode_TypeDefinitionIndex = 19320;
