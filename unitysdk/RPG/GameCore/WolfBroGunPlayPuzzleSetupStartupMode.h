...
#define RPG_GAMECORE_WOLFBROGUNPLAYPUZZLESETUPSTARTUPMODE_METHOD_3_042ED187257DCF5D_OFFSET UNITYSDK_OFFSET(0x1EFA8100)
#define RPG_GAMECORE_WOLFBROGUNPLAYPUZZLESETUPSTARTUPMODE_METHOD_3_B43F89DEA0A5CBC6_OFFSET UNITYSDK_OFFSET(0x1EFA8140)
#define RPG_GAMECORE_WOLFBROGUNPLAYPUZZLESETUPSTARTUPMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFA8130)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WolfBroGunPlayPuzzleSetupStartupMode_TypeDefinitionIndex = 20134;
