...
#define RPG_GAMECORE_GRIDFIGHTGUIDEQUESTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D1569B0)
#define RPG_GAMECORE_GRIDFIGHTGUIDEQUESTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D156B00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightGuideQuestConfigRow_TypeDefinitionIndex = 13472;
