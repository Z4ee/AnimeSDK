...
#define RPG_GAMECORE_GRIDFIGHTGUIDEQUESTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1EE6AD80)
#define RPG_GAMECORE_GRIDFIGHTGUIDEQUESTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1EE6AED0)
