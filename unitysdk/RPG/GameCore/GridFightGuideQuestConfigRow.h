...
#define RPG_GAMECORE_GRIDFIGHTGUIDEQUESTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C5CE840)
#define RPG_GAMECORE_GRIDFIGHTGUIDEQUESTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5CE990)
