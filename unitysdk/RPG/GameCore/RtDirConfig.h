...
#define RPG_GAMECORE_RTDIRCONFIG_METHOD_2_CF8A800990B564A7_OFFSET UNITYSDK_OFFSET(0x18DCFDC0)
#define RPG_GAMECORE_RTDIRCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18DCFFF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtDirConfig_TypeDefinitionIndex = 23278;
