...
#define RPG_GAMECORE_RTDIRCONFIG_METHOD_2_146B2CC044EF2D04_OFFSET UNITYSDK_OFFSET(0x1CCE68D0)
#define RPG_GAMECORE_RTDIRCONFIG_METHOD_2_CF8A800990B564A7_OFFSET UNITYSDK_OFFSET(0x1CCE6630)
#define RPG_GAMECORE_RTDIRCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CCE6860)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtDirConfig_TypeDefinitionIndex = 23992;
