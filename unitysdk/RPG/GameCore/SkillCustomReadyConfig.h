...
#define RPG_GAMECORE_SKILLCUSTOMREADYCONFIG_METHOD_2_7A8790F7015E19A2_OFFSET UNITYSDK_OFFSET(0x1D0A4A50)
#define RPG_GAMECORE_SKILLCUSTOMREADYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0A4D20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SkillCustomReadyConfig_TypeDefinitionIndex = 17971;
