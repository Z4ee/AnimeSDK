...
#define RPG_GAMECORE_SKILLCUSTOMREADYCONFIG_METHOD_2_7A8790F7015E19A2_OFFSET UNITYSDK_OFFSET(0x19C8DA50)
#define RPG_GAMECORE_SKILLCUSTOMREADYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19C8DD20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SkillCustomReadyConfig_TypeDefinitionIndex = 17283;
