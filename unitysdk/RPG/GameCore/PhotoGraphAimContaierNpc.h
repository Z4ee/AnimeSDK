...
#define RPG_GAMECORE_PHOTOGRAPHAIMCONTAIERNPC_METHOD_3_1598172E4DB82115_OFFSET UNITYSDK_OFFSET(0x1D328710)
#define RPG_GAMECORE_PHOTOGRAPHAIMCONTAIERNPC_METHOD_3_A93B84AEE4406A84_OFFSET UNITYSDK_OFFSET(0x1D328650)
#define RPG_GAMECORE_PHOTOGRAPHAIMCONTAIERNPC__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3286D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotoGraphAimContaierNpc_TypeDefinitionIndex = 17319;
