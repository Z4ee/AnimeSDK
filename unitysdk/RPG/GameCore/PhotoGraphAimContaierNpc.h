...
#define RPG_GAMECORE_PHOTOGRAPHAIMCONTAIERNPC_METHOD_3_1598172E4DB82115_OFFSET UNITYSDK_OFFSET(0x18BF1670)
#define RPG_GAMECORE_PHOTOGRAPHAIMCONTAIERNPC_METHOD_3_A93B84AEE4406A84_OFFSET UNITYSDK_OFFSET(0x18BF15B0)
#define RPG_GAMECORE_PHOTOGRAPHAIMCONTAIERNPC__CTOR_OFFSET UNITYSDK_OFFSET(0x18BF1630)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotoGraphAimContaierNpc_TypeDefinitionIndex = 16625;
