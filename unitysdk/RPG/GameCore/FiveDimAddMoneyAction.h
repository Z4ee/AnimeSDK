...
#define RPG_GAMECORE_FIVEDIMADDMONEYACTION_METHOD_3_D08C0B26602BB61C_OFFSET UNITYSDK_OFFSET(0x188EA820)
#define RPG_GAMECORE_FIVEDIMADDMONEYACTION_METHOD_3_DCDDF4D19BD18341_OFFSET UNITYSDK_OFFSET(0x188EA730)
#define RPG_GAMECORE_FIVEDIMADDMONEYACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x188EA800)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimAddMoneyAction_TypeDefinitionIndex = 17788;
