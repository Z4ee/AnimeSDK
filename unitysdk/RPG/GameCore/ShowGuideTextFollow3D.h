...
#define RPG_GAMECORE_SHOWGUIDETEXTFOLLOW3D_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x176FE4D0)
#define RPG_GAMECORE_SHOWGUIDETEXTFOLLOW3D_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x176FE400)
#define RPG_GAMECORE_SHOWGUIDETEXTFOLLOW3D__CTOR_OFFSET UNITYSDK_OFFSET(0x176FE480)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowGuideTextFollow3D_TypeDefinitionIndex = 22384;
