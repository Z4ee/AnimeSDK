...
#define RPG_GAMECORE_FATEMODIFIERDISABLEMASTERROUNDRANDOMAFFIXCONFIG_METHOD_3_2338F6773D59ECC9_OFFSET UNITYSDK_OFFSET(0x19710C50)
#define RPG_GAMECORE_FATEMODIFIERDISABLEMASTERROUNDRANDOMAFFIXCONFIG_METHOD_3_500B8D76AD4673F0_OFFSET UNITYSDK_OFFSET(0x19712470)
#define RPG_GAMECORE_FATEMODIFIERDISABLEMASTERROUNDRANDOMAFFIXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19710C00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateModifierDisableMasterRoundRandomAffixConfig_TypeDefinitionIndex = 18290;
