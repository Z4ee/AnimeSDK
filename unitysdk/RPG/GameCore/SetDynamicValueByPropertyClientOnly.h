...
#define RPG_GAMECORE_SETDYNAMICVALUEBYPROPERTYCLIENTONLY_METHOD_5_2E498F5C884DEBC4_OFFSET UNITYSDK_OFFSET(0x176BEE90)
#define RPG_GAMECORE_SETDYNAMICVALUEBYPROPERTYCLIENTONLY_METHOD_5_D9B3797665D60CA0_OFFSET UNITYSDK_OFFSET(0x176C2FF0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYPROPERTYCLIENTONLY__CTOR_OFFSET UNITYSDK_OFFSET(0x176BEE40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByPropertyClientOnly_TypeDefinitionIndex = 21816;
