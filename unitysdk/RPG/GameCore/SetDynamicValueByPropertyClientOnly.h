...
#define RPG_GAMECORE_SETDYNAMICVALUEBYPROPERTYCLIENTONLY_METHOD_5_2E498F5C884DEBC4_OFFSET UNITYSDK_OFFSET(0x1C2E64B0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYPROPERTYCLIENTONLY_METHOD_5_6244E980ADA7C645_OFFSET UNITYSDK_OFFSET(0x1C2E66B0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYPROPERTYCLIENTONLY__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2E64A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByPropertyClientOnly_TypeDefinitionIndex = 22734;
