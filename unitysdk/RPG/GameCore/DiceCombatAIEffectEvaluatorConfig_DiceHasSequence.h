...
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEHASSEQUENCE_METHOD_3_12D913D9A06F5201_OFFSET UNITYSDK_OFFSET(0x18863F20)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEHASSEQUENCE_METHOD_3_2E9835C47EBEA4AD_OFFSET UNITYSDK_OFFSET(0x188634F0)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEHASSEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x188634E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatAIEffectEvaluatorConfig_DiceHasSequence_TypeDefinitionIndex = 15339;
