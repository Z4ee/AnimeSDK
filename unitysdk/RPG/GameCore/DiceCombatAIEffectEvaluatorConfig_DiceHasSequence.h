...
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEHASSEQUENCE_METHOD_3_12D913D9A06F5201_OFFSET UNITYSDK_OFFSET(0x1C10BFA0)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEHASSEQUENCE_METHOD_3_2E9835C47EBEA4AD_OFFSET UNITYSDK_OFFSET(0x1C10B570)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEHASSEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C10B560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatAIEffectEvaluatorConfig_DiceHasSequence_TypeDefinitionIndex = 15561;
