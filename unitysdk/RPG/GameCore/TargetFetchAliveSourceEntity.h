...
#define RPG_GAMECORE_TARGETFETCHALIVESOURCEENTITY_METHOD_3_665706397F0464D5_OFFSET UNITYSDK_OFFSET(0x19D0ABB0)
#define RPG_GAMECORE_TARGETFETCHALIVESOURCEENTITY_METHOD_3_82F137E52733B8FA_OFFSET UNITYSDK_OFFSET(0x19D0ABF0)
#define RPG_GAMECORE_TARGETFETCHALIVESOURCEENTITY_METHOD_3_C668D31E242F9EB8_OFFSET UNITYSDK_OFFSET(0x19D0AB50)
#define RPG_GAMECORE_TARGETFETCHALIVESOURCEENTITY_METHOD_3_FF6AEC36767BC469_OFFSET UNITYSDK_OFFSET(0x19D0AA90)
#define RPG_GAMECORE_TARGETFETCHALIVESOURCEENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x19D0AB30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchAliveSourceEntity_TypeDefinitionIndex = 22649;
	...
	public:
		...
		static ::System::Void Method_3_665706397F0464D5(::SimpleJSON::JSONNode* a1, ::RPG::GameCore::TargetFetchAliveSourceEntity*& a2)
		{
			return ((::System::Void(*)(::SimpleJSON::JSONNode*, ::RPG::GameCore::TargetFetchAliveSourceEntity*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_TARGETFETCHALIVESOURCEENTITY_METHOD_3_665706397F0464D5_OFFSET))(a1, a2);
		}
