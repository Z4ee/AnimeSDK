...
#define RPG_GAMECORE_TARGETFETCHALIVESOURCEENTITY_METHOD_3_C668D31E242F9EB8_OFFSET UNITYSDK_OFFSET(0x177BCE70)
#define RPG_GAMECORE_TARGETFETCHALIVESOURCEENTITY_METHOD_3_FF6AEC36767BC469_OFFSET UNITYSDK_OFFSET(0x177BCDB0)
#define RPG_GAMECORE_TARGETFETCHALIVESOURCEENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x177BCE50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchAliveSourceEntity_TypeDefinitionIndex = 22244;
