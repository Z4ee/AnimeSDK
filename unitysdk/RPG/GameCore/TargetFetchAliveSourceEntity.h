...
#define RPG_GAMECORE_TARGETFETCHALIVESOURCEENTITY_METHOD_3_16EE6E2A35D8C9C7_OFFSET UNITYSDK_OFFSET(0x1D0B6BD0)
#define RPG_GAMECORE_TARGETFETCHALIVESOURCEENTITY_METHOD_3_16FB87CF2238029D_OFFSET UNITYSDK_OFFSET(0x1D0B6AF0)
#define RPG_GAMECORE_TARGETFETCHALIVESOURCEENTITY_METHOD_3_82F137E52733B8FA_OFFSET UNITYSDK_OFFSET(0x1D0B6BF0)
#define RPG_GAMECORE_TARGETFETCHALIVESOURCEENTITY_METHOD_3_C668D31E242F9EB8_OFFSET UNITYSDK_OFFSET(0x1D0B6B70)
#define RPG_GAMECORE_TARGETFETCHALIVESOURCEENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0B6B60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchAliveSourceEntity_TypeDefinitionIndex = 23112;
