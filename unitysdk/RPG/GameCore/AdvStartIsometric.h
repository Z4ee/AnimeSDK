...
#define RPG_GAMECORE_ADVSTARTISOMETRIC_METHOD_3_4C094023E65500B0_OFFSET UNITYSDK_OFFSET(0x16F44960)
#define RPG_GAMECORE_ADVSTARTISOMETRIC_METHOD_3_CAB696B1A37E8085_OFFSET UNITYSDK_OFFSET(0x16F449E0)
#define RPG_GAMECORE_ADVSTARTISOMETRIC__CTOR_OFFSET UNITYSDK_OFFSET(0x16F449B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvStartIsometric_TypeDefinitionIndex = 20395;
