...
#define RPG_GAMECORE_COMPLEXSKILLAIPOSTPROCESS_METHOD_2_A393DE9346B9C432_OFFSET UNITYSDK_OFFSET(0x1CFF1C90)
#define RPG_GAMECORE_COMPLEXSKILLAIPOSTPROCESS_METHOD_2_CE91773F645B393D_OFFSET UNITYSDK_OFFSET(0x1CFF3850)
#define RPG_GAMECORE_COMPLEXSKILLAIPOSTPROCESS__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFF38B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAIPostProcess_TypeDefinitionIndex = 15388;
