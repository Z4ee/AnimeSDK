...
#define RPG_GAMECORE_COMPLEXSKILLAIPOSTPROCESS_METHOD_2_A393DE9346B9C432_OFFSET UNITYSDK_OFFSET(0x17122CD0)
#define RPG_GAMECORE_COMPLEXSKILLAIPOSTPROCESS_METHOD_2_CE91773F645B393D_OFFSET UNITYSDK_OFFSET(0x17124640)
#define RPG_GAMECORE_COMPLEXSKILLAIPOSTPROCESS__CTOR_OFFSET UNITYSDK_OFFSET(0x171246A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAIPostProcess_TypeDefinitionIndex = 14255;
