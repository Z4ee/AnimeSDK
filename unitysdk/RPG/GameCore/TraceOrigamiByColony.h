...
#define RPG_GAMECORE_TRACEORIGAMIBYCOLONY_METHOD_3_24D14F1C4EC58780_OFFSET UNITYSDK_OFFSET(0x1D5D5840)
#define RPG_GAMECORE_TRACEORIGAMIBYCOLONY_METHOD_3_841086ED0464E6E5_OFFSET UNITYSDK_OFFSET(0x1D5D5880)
#define RPG_GAMECORE_TRACEORIGAMIBYCOLONY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5D5870)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TraceOrigamiByColony_TypeDefinitionIndex = 20926;
