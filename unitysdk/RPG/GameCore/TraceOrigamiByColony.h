...
#define RPG_GAMECORE_TRACEORIGAMIBYCOLONY_METHOD_3_1E378F198A55358C_OFFSET UNITYSDK_OFFSET(0x190A12A0)
#define RPG_GAMECORE_TRACEORIGAMIBYCOLONY_METHOD_3_841086ED0464E6E5_OFFSET UNITYSDK_OFFSET(0x190A1320)
#define RPG_GAMECORE_TRACEORIGAMIBYCOLONY__CTOR_OFFSET UNITYSDK_OFFSET(0x190A12F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TraceOrigamiByColony_TypeDefinitionIndex = 20145;
