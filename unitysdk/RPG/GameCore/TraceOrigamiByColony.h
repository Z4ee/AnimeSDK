...
#define RPG_GAMECORE_TRACEORIGAMIBYCOLONY_METHOD_3_1E378F198A55358C_OFFSET UNITYSDK_OFFSET(0x19DEC000)
#define RPG_GAMECORE_TRACEORIGAMIBYCOLONY_METHOD_3_841086ED0464E6E5_OFFSET UNITYSDK_OFFSET(0x19DEC080)
#define RPG_GAMECORE_TRACEORIGAMIBYCOLONY__CTOR_OFFSET UNITYSDK_OFFSET(0x19DEC050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TraceOrigamiByColony_TypeDefinitionIndex = 20002;
