...
#define RPG_GAMECORE_PROPSTATECONFIG_METHOD_2_000C5DC086D547B8_OFFSET UNITYSDK_OFFSET(0x1D372940)
#define RPG_GAMECORE_PROPSTATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D372D60)
