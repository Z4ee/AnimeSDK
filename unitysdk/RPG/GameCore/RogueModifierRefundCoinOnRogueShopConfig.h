...
#define RPG_GAMECORE_ROGUEMODIFIERREFUNDCOINONROGUESHOPCONFIG_METHOD_3_747F0A49EE659D80_OFFSET UNITYSDK_OFFSET(0x19B9AA50)
#define RPG_GAMECORE_ROGUEMODIFIERREFUNDCOINONROGUESHOPCONFIG_METHOD_3_82C05C7538D305E9_OFFSET UNITYSDK_OFFSET(0x19B9A980)
#define RPG_GAMECORE_ROGUEMODIFIERREFUNDCOINONROGUESHOPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B9AA00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierRefundCoinOnRogueShopConfig_TypeDefinitionIndex = 17105;
