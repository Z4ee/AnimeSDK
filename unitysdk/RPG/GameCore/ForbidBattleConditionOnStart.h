...
#define RPG_GAMECORE_FORBIDBATTLECONDITIONONSTART_METHOD_3_052DD92380D71B57_OFFSET UNITYSDK_OFFSET(0x1BEBE910)
#define RPG_GAMECORE_FORBIDBATTLECONDITIONONSTART_METHOD_3_AE7B1C60F67DCBFA_OFFSET UNITYSDK_OFFSET(0x1BEBE840)
#define RPG_GAMECORE_FORBIDBATTLECONDITIONONSTART__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEBE900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ForbidBattleConditionOnStart_TypeDefinitionIndex = 22513;
