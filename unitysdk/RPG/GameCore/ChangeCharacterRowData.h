...
#define RPG_GAMECORE_CHANGECHARACTERROWDATA_METHOD_3_D9589E00203CC88E_OFFSET UNITYSDK_OFFSET(0x1B7189B0)
#define RPG_GAMECORE_CHANGECHARACTERROWDATA_METHOD_3_EB1A3F8516F4697A_OFFSET UNITYSDK_OFFSET(0x1B7188F0)
#define RPG_GAMECORE_CHANGECHARACTERROWDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B718960)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChangeCharacterRowData_TypeDefinitionIndex = 22827;
