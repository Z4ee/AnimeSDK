...
#define RPG_GAMECORE_LEVELPEDESTRIANMEMBERINFO_METHOD_2_875B81C417367745_OFFSET UNITYSDK_OFFSET(0x1B081DA0)
#define RPG_GAMECORE_LEVELPEDESTRIANMEMBERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B081EF0)
