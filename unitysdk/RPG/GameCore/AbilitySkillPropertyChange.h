...
#define RPG_GAMECORE_ABILITYSKILLPROPERTYCHANGE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xCC7BE50)
#define RPG_GAMECORE_ABILITYSKILLPROPERTYCHANGE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xCC7BE10)
#define RPG_GAMECORE_ABILITYSKILLPROPERTYCHANGE_GET_PROPERTYTYPE_OFFSET UNITYSDK_OFFSET(0xCC7BEA0)
#define RPG_GAMECORE_ABILITYSKILLPROPERTYCHANGE_INIT_OFFSET UNITYSDK_OFFSET(0xCC7BDA0)
#define RPG_GAMECORE_ABILITYSKILLPROPERTYCHANGE_SET_PROPERTYTYPE_OFFSET UNITYSDK_OFFSET(0xCC7BEB0)
#define RPG_GAMECORE_ABILITYSKILLPROPERTYCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0xCC7BEC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AbilitySkillPropertyChange_TypeDefinitionIndex = 52842;
