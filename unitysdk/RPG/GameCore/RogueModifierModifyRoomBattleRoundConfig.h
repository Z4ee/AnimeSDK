...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYROOMBATTLEROUNDCONFIG_METHOD_3_5CF9BF9C9376B645_OFFSET UNITYSDK_OFFSET(0x17635C20)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYROOMBATTLEROUNDCONFIG_METHOD_3_5F13351CF97A1AAC_OFFSET UNITYSDK_OFFSET(0x17635B50)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYROOMBATTLEROUNDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17635BD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyRoomBattleRoundConfig_TypeDefinitionIndex = 16286;
