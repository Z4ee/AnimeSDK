...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYROOMBATTLEROUNDCONFIG_METHOD_3_5CF9BF9C9376B645_OFFSET UNITYSDK_OFFSET(0x1D1646B0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYROOMBATTLEROUNDCONFIG_METHOD_3_FD1B4972F0D1BEE1_OFFSET UNITYSDK_OFFSET(0x1D164660)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYROOMBATTLEROUNDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1646A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyRoomBattleRoundConfig_TypeDefinitionIndex = 17017;
