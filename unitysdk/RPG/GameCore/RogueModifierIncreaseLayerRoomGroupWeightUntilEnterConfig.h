...
#define RPG_GAMECORE_ROGUEMODIFIERINCREASELAYERROOMGROUPWEIGHTUNTILENTERCONFIG_METHOD_3_7C2E24D25D3EA8D1_OFFSET UNITYSDK_OFFSET(0x19B53E60)
#define RPG_GAMECORE_ROGUEMODIFIERINCREASELAYERROOMGROUPWEIGHTUNTILENTERCONFIG_METHOD_3_E63F6716A23E9A38_OFFSET UNITYSDK_OFFSET(0x19B5E320)
#define RPG_GAMECORE_ROGUEMODIFIERINCREASELAYERROOMGROUPWEIGHTUNTILENTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B53E10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierIncreaseLayerRoomGroupWeightUntilEnterConfig_TypeDefinitionIndex = 16864;
