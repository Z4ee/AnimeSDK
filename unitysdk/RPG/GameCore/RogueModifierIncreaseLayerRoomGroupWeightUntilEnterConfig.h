...
#define RPG_GAMECORE_ROGUEMODIFIERINCREASELAYERROOMGROUPWEIGHTUNTILENTERCONFIG_METHOD_3_4B3A8F68CAF2016D_OFFSET UNITYSDK_OFFSET(0x1CFC13A0)
#define RPG_GAMECORE_ROGUEMODIFIERINCREASELAYERROOMGROUPWEIGHTUNTILENTERCONFIG_METHOD_3_7C2E24D25D3EA8D1_OFFSET UNITYSDK_OFFSET(0x1CFC13F0)
#define RPG_GAMECORE_ROGUEMODIFIERINCREASELAYERROOMGROUPWEIGHTUNTILENTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFC13E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierIncreaseLayerRoomGroupWeightUntilEnterConfig_TypeDefinitionIndex = 17026;
