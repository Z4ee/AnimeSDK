...
#define RPG_GAMECORE_CHANGEBATTLEEVENTOWNER_METHOD_3_4F04724771C5CE71_OFFSET UNITYSDK_OFFSET(0x1CF8A0D0)
#define RPG_GAMECORE_CHANGEBATTLEEVENTOWNER_METHOD_3_9E81B179EBB3F950_OFFSET UNITYSDK_OFFSET(0x1CF8A090)
#define RPG_GAMECORE_CHANGEBATTLEEVENTOWNER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF8A0C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChangeBattleEventOwner_TypeDefinitionIndex = 22719;
