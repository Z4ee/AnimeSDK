...
#define RPG_GAMECORE_ACTIVITYHIPPLENGAMEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x193ED7E0)
#define RPG_GAMECORE_ACTIVITYHIPPLENGAMEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x193ED930)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityHipplenGameRow_TypeDefinitionIndex = 11129;
