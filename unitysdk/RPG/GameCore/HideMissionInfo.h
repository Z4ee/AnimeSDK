...
#define RPG_GAMECORE_HIDEMISSIONINFO_METHOD_3_4494C26EA81E8756_OFFSET UNITYSDK_OFFSET(0x172AA430)
#define RPG_GAMECORE_HIDEMISSIONINFO_METHOD_3_480F3B27221459D7_OFFSET UNITYSDK_OFFSET(0x172AA3B0)
#define RPG_GAMECORE_HIDEMISSIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x172AA400)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HideMissionInfo_TypeDefinitionIndex = 22313;
