...
#define RPG_GAMECORE_RTTARGETMAPBELONGGRID_METHOD_3_336EDAEE54CA4B36_OFFSET UNITYSDK_OFFSET(0x1D4B5660)
#define RPG_GAMECORE_RTTARGETMAPBELONGGRID_METHOD_3_9B3CAA5943E71BA7_OFFSET UNITYSDK_OFFSET(0x1D4B55C0)
#define RPG_GAMECORE_RTTARGETMAPBELONGGRID_METHOD_3_EFF85AAD8B422C1C_OFFSET UNITYSDK_OFFSET(0x1D4B56C0)
#define RPG_GAMECORE_RTTARGETMAPBELONGGRID_METHOD_3_FC24B8A231AA7B58_OFFSET UNITYSDK_OFFSET(0x1D4B5700)
#define RPG_GAMECORE_RTTARGETMAPBELONGGRID__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4B5650)
