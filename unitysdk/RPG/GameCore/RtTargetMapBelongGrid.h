...
#define RPG_GAMECORE_RTTARGETMAPBELONGGRID_METHOD_3_336EDAEE54CA4B36_OFFSET UNITYSDK_OFFSET(0x19BF5730)
#define RPG_GAMECORE_RTTARGETMAPBELONGGRID_METHOD_3_5E1BF5CFB6D1ADF4_OFFSET UNITYSDK_OFFSET(0x19BF5650)
#define RPG_GAMECORE_RTTARGETMAPBELONGGRID_METHOD_3_7FE395AAB4DB6858_OFFSET UNITYSDK_OFFSET(0x19BF5790)
#define RPG_GAMECORE_RTTARGETMAPBELONGGRID_METHOD_3_FC24B8A231AA7B58_OFFSET UNITYSDK_OFFSET(0x19BF57F0)
#define RPG_GAMECORE_RTTARGETMAPBELONGGRID__CTOR_OFFSET UNITYSDK_OFFSET(0x19BF5710)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtTargetMapBelongGrid_TypeDefinitionIndex = 22929;
	...
	public:
		...
		static ::System::Void Method_3_7FE395AAB4DB6858(::SimpleJSON::JSONNode* a1, ::RPG::GameCore::RtTargetMapBelongGrid*& a2)
		{
			return ((::System::Void(*)(::SimpleJSON::JSONNode*, ::RPG::GameCore::RtTargetMapBelongGrid*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_RTTARGETMAPBELONGGRID_METHOD_3_7FE395AAB4DB6858_OFFSET))(a1, a2);
		}
