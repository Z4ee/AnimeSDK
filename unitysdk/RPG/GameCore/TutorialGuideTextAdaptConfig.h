...
#define RPG_GAMECORE_TUTORIALGUIDETEXTADAPTCONFIG_METHOD_2_0EFA86A150E2921E_OFFSET UNITYSDK_OFFSET(0x1D2A7720)
#define RPG_GAMECORE_TUTORIALGUIDETEXTADAPTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2A7990)
