...
#define RPG_GAMECORE_TUTORIALGUIDETEXTADAPTCONFIG_METHOD_2_0EFA86A150E2921E_OFFSET UNITYSDK_OFFSET(0x19E2C6E0)
#define RPG_GAMECORE_TUTORIALGUIDETEXTADAPTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19E2C950)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TutorialGuideTextAdaptConfig_TypeDefinitionIndex = 23064;
