...
#define RPG_GAMECORE_ROGUEMAGICCONDSCEPTERFILTERBYSELECTEDSTYLETYPECONFIG_METHOD_7_BCC6383707C2E41D_OFFSET UNITYSDK_OFFSET(0x1CFB5400)
#define RPG_GAMECORE_ROGUEMAGICCONDSCEPTERFILTERBYSELECTEDSTYLETYPECONFIG_METHOD_7_F719DDC3DDD57C59_OFFSET UNITYSDK_OFFSET(0x1CFB53B0)
#define RPG_GAMECORE_ROGUEMAGICCONDSCEPTERFILTERBYSELECTEDSTYLETYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFB53F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueMagicCondScepterFilterBySelectedStyleTypeConfig_TypeDefinitionIndex = 18824;
