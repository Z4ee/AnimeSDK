...
#define RPG_GAMECORE_ADVSKILLADDSERVERCHECKSKILLRESULTCALLBACK_METHOD_3_8E7CB0B4EAA20403_OFFSET UNITYSDK_OFFSET(0x1AE47CB0)
#define RPG_GAMECORE_ADVSKILLADDSERVERCHECKSKILLRESULTCALLBACK_METHOD_3_B09166E33F0A8C9E_OFFSET UNITYSDK_OFFSET(0x1AE47C70)
#define RPG_GAMECORE_ADVSKILLADDSERVERCHECKSKILLRESULTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE47CA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSkillAddServerCheckSkillResultCallback_TypeDefinitionIndex = 19436;
