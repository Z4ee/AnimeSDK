...
#define RPG_GAMECORE_ADVSKILLADDSERVERCHECKSKILLRESULTCALLBACK_METHOD_3_8E7CB0B4EAA20403_OFFSET UNITYSDK_OFFSET(0x1CBA3C30)
#define RPG_GAMECORE_ADVSKILLADDSERVERCHECKSKILLRESULTCALLBACK_METHOD_3_B09166E33F0A8C9E_OFFSET UNITYSDK_OFFSET(0x1CBA3BF0)
#define RPG_GAMECORE_ADVSKILLADDSERVERCHECKSKILLRESULTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1CBA3C20)
