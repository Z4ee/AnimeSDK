...
#define RPG_GAMECORE_ADVSKILLADDSERVERCHECKSKILLRESULTCALLBACK_METHOD_3_B09166E33F0A8C9E_OFFSET UNITYSDK_OFFSET(0x186662E0)
#define RPG_GAMECORE_ADVSKILLADDSERVERCHECKSKILLRESULTCALLBACK_METHOD_3_BD8B6F89F67D33AC_OFFSET UNITYSDK_OFFSET(0x18666360)
#define RPG_GAMECORE_ADVSKILLADDSERVERCHECKSKILLRESULTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18666330)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSkillAddServerCheckSkillResultCallback_TypeDefinitionIndex = 19153;
