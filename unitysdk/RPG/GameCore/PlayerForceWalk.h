...
#define RPG_GAMECORE_PLAYERFORCEWALK_METHOD_3_1DC07F62FD89F39F_OFFSET UNITYSDK_OFFSET(0x18C25E50)
#define RPG_GAMECORE_PLAYERFORCEWALK_METHOD_3_CF4BE6E321C04B6E_OFFSET UNITYSDK_OFFSET(0x18C25DD0)
#define RPG_GAMECORE_PLAYERFORCEWALK__CTOR_OFFSET UNITYSDK_OFFSET(0x18C25E20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayerForceWalk_TypeDefinitionIndex = 18926;
