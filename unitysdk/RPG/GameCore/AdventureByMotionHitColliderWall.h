...
#define RPG_GAMECORE_ADVENTUREBYMOTIONHITCOLLIDERWALL_METHOD_4_00096AD60BC0D212_OFFSET UNITYSDK_OFFSET(0x18670B00)
#define RPG_GAMECORE_ADVENTUREBYMOTIONHITCOLLIDERWALL_METHOD_4_F239707E6AE2789A_OFFSET UNITYSDK_OFFSET(0x18670A30)
#define RPG_GAMECORE_ADVENTUREBYMOTIONHITCOLLIDERWALL__CTOR_OFFSET UNITYSDK_OFFSET(0x18670AB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureByMotionHitColliderWall_TypeDefinitionIndex = 19163;
