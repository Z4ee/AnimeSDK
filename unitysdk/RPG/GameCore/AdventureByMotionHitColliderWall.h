...
#define RPG_GAMECORE_ADVENTUREBYMOTIONHITCOLLIDERWALL_METHOD_4_00096AD60BC0D212_OFFSET UNITYSDK_OFFSET(0x16F4E590)
#define RPG_GAMECORE_ADVENTUREBYMOTIONHITCOLLIDERWALL_METHOD_4_F239707E6AE2789A_OFFSET UNITYSDK_OFFSET(0x16F4E4C0)
#define RPG_GAMECORE_ADVENTUREBYMOTIONHITCOLLIDERWALL__CTOR_OFFSET UNITYSDK_OFFSET(0x16F4E540)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureByMotionHitColliderWall_TypeDefinitionIndex = 18510;
