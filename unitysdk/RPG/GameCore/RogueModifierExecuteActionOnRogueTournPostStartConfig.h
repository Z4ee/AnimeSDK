...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONROGUETOURNPOSTSTARTCONFIG_METHOD_3_22D1A53D9AD018AF_OFFSET UNITYSDK_OFFSET(0x18D3E510)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONROGUETOURNPOSTSTARTCONFIG_METHOD_3_EC1BDFAF9E9E9406_OFFSET UNITYSDK_OFFSET(0x18D3E5E0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONROGUETOURNPOSTSTARTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D3E590)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnRogueTournPostStartConfig_TypeDefinitionIndex = 16876;
