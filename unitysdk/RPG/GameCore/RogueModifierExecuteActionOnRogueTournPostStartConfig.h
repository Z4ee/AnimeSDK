...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONROGUETOURNPOSTSTARTCONFIG_METHOD_3_8C7CC3E5AF8558AA_OFFSET UNITYSDK_OFFSET(0x1CFC0DA0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONROGUETOURNPOSTSTARTCONFIG_METHOD_3_EC1BDFAF9E9E9406_OFFSET UNITYSDK_OFFSET(0x1CFC0DF0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONROGUETOURNPOSTSTARTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFC0DE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnRogueTournPostStartConfig_TypeDefinitionIndex = 17053;
