...
#define RPG_GAMECORE_ROGUEIMMERSELEVELROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D937F50)
#define RPG_GAMECORE_ROGUEIMMERSELEVELROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D938930)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID LevelUpTips1; // 0x48
		::RPG::Client::TextID EffectTitle1; // 0x58
		::RPG::Client::TextID LevelUpTips2; // 0x68
