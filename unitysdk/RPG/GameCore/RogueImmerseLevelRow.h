...
#define RPG_GAMECORE_ROGUEIMMERSELEVELROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CFB3460)
#define RPG_GAMECORE_ROGUEIMMERSELEVELROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFB3E40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueImmerseLevelRow_TypeDefinitionIndex = 14258;
	...
	public:
		...
		::RPG::Client::TextID EffectTitle1; // 0x28
		::RPG::Client::TextID EffectDesc2; // 0x38
		::RPG::Client::TextID LevelUpTips2; // 0x48
		::RPG::Client::TextID LevelUpTips1; // 0x58
		::RPG::Client::TextID EffectTitle2; // 0x68
		::RPG::Client::TextID BGDesc; // 0x78
