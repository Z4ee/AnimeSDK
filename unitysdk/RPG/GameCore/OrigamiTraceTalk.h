...
#define RPG_GAMECORE_ORIGAMITRACETALK_METHOD_2_4F5DA967AC79642A_OFFSET UNITYSDK_OFFSET(0x1BB065A0)
#define RPG_GAMECORE_ORIGAMITRACETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB06700)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OrigamiTraceTalk_TypeDefinitionIndex = 21063;
