...
#define RPG_GAMECORE_CHIMERADUELSWAPPOSITIONNODE_METHOD_3_1F4E42CB5E5B1B1E_OFFSET UNITYSDK_OFFSET(0x18806630)
#define RPG_GAMECORE_CHIMERADUELSWAPPOSITIONNODE_METHOD_3_B658D4E04E2A7F2D_OFFSET UNITYSDK_OFFSET(0x18806710)
#define RPG_GAMECORE_CHIMERADUELSWAPPOSITIONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x188066C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelSwapPositionNode_TypeDefinitionIndex = 15130;
