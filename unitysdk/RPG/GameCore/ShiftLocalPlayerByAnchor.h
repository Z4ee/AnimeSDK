...
#define RPG_GAMECORE_SHIFTLOCALPLAYERBYANCHOR_METHOD_3_3331416DF5C4EDBB_OFFSET UNITYSDK_OFFSET(0x176EF780)
#define RPG_GAMECORE_SHIFTLOCALPLAYERBYANCHOR_METHOD_3_74B49DC8D6FCD00A_OFFSET UNITYSDK_OFFSET(0x176EF700)
#define RPG_GAMECORE_SHIFTLOCALPLAYERBYANCHOR__CTOR_OFFSET UNITYSDK_OFFSET(0x176EF750)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShiftLocalPlayerByAnchor_TypeDefinitionIndex = 19509;
