...
#define RPG_GAMECORE_RESTAURANTEMPLOYEEUPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19AD4FF0)
#define RPG_GAMECORE_RESTAURANTEMPLOYEEUPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19AD5190)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RestaurantEmployeeUpRow_TypeDefinitionIndex = 10905;
