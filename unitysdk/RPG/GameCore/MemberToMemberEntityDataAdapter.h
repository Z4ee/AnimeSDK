...
#define RPG_GAMECORE_MEMBERTOMEMBERENTITYDATAADAPTER_METHOD_3_31A3A637350B2609_OFFSET UNITYSDK_OFFSET(0x173CDD50)
#define RPG_GAMECORE_MEMBERTOMEMBERENTITYDATAADAPTER_METHOD_3_3307833796646AEA_OFFSET UNITYSDK_OFFSET(0x173CDDD0)
#define RPG_GAMECORE_MEMBERTOMEMBERENTITYDATAADAPTER__CTOR_OFFSET UNITYSDK_OFFSET(0x173CDDA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MemberToMemberEntityDataAdapter_TypeDefinitionIndex = 19061;
