...
#define RPG_GAMECORE_SWITCHHANDCATCHABLESTATESYNC_METHOD_3_59182387F5AE454D_OFFSET UNITYSDK_OFFSET(0x17794780)
#define RPG_GAMECORE_SWITCHHANDCATCHABLESTATESYNC_METHOD_3_F140AE5A7F71F2EB_OFFSET UNITYSDK_OFFSET(0x17794800)
#define RPG_GAMECORE_SWITCHHANDCATCHABLESTATESYNC__CTOR_OFFSET UNITYSDK_OFFSET(0x177947D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchHandCatchableStateSync_TypeDefinitionIndex = 19290;
