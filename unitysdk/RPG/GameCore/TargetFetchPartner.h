...
#define RPG_GAMECORE_TARGETFETCHPARTNER_METHOD_4_5E69928AAD604E30_OFFSET UNITYSDK_OFFSET(0x1D0BC160)
#define RPG_GAMECORE_TARGETFETCHPARTNER_METHOD_4_6219CF2F539B9F0B_OFFSET UNITYSDK_OFFSET(0x1D0BC030)
#define RPG_GAMECORE_TARGETFETCHPARTNER_METHOD_4_A22D8A1262A37AFC_OFFSET UNITYSDK_OFFSET(0x1D0BC070)
#define RPG_GAMECORE_TARGETFETCHPARTNER_METHOD_4_A652AA9E18AE14DE_OFFSET UNITYSDK_OFFSET(0x1D0BC190)
#define RPG_GAMECORE_TARGETFETCHPARTNER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0BC060)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchPartner_TypeDefinitionIndex = 23079;
