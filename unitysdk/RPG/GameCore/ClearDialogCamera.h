...
#define RPG_GAMECORE_CLEARDIALOGCAMERA_METHOD_3_B1B1A69AD8AFC38D_OFFSET UNITYSDK_OFFSET(0x170B1B90)
#define RPG_GAMECORE_CLEARDIALOGCAMERA_METHOD_3_FB859E49CA8AF519_OFFSET UNITYSDK_OFFSET(0x170B1A80)
#define RPG_GAMECORE_CLEARDIALOGCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x170B1B60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClearDialogCamera_TypeDefinitionIndex = 19434;
