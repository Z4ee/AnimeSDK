...
#define RPG_GAMECORE_CLEARDIALOGCAMERA_METHOD_3_00BCD54E707BF8D0_OFFSET UNITYSDK_OFFSET(0x1CFD9EA0)
#define RPG_GAMECORE_CLEARDIALOGCAMERA_METHOD_3_B1B1A69AD8AFC38D_OFFSET UNITYSDK_OFFSET(0x1CFD9F70)
#define RPG_GAMECORE_CLEARDIALOGCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFD9F60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClearDialogCamera_TypeDefinitionIndex = 20886;
