...
#define RPG_GAMECORE_ADVNPCRUNAWAYPLAYER_METHOD_3_B6EDC67BC2A2750F_OFFSET UNITYSDK_OFFSET(0x1BE22710)
#define RPG_GAMECORE_ADVNPCRUNAWAYPLAYER_METHOD_3_E3D4E842D53C31E3_OFFSET UNITYSDK_OFFSET(0x1BE227B0)
#define RPG_GAMECORE_ADVNPCRUNAWAYPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE22770)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvNPCRunAwayPlayer_TypeDefinitionIndex = 19206;
