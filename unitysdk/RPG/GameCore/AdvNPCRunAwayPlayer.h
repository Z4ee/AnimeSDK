...
#define RPG_GAMECORE_ADVNPCRUNAWAYPLAYER_METHOD_3_ACEA16218A448C0B_OFFSET UNITYSDK_OFFSET(0x1942AD40)
#define RPG_GAMECORE_ADVNPCRUNAWAYPLAYER_METHOD_3_E3D4E842D53C31E3_OFFSET UNITYSDK_OFFSET(0x1942AE20)
#define RPG_GAMECORE_ADVNPCRUNAWAYPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1942ADC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvNPCRunAwayPlayer_TypeDefinitionIndex = 18856;
	...
	public:
		...
		static ::System::Void Method_3_ACEA16218A448C0B(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::AdvNPCRunAwayPlayer*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::AdvNPCRunAwayPlayer*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_ADVNPCRUNAWAYPLAYER_METHOD_3_ACEA16218A448C0B_OFFSET))(a1, a2);
		}
