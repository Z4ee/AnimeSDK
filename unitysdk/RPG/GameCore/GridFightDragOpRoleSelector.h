...
#define RPG_GAMECORE_GRIDFIGHTDRAGOPROLESELECTOR_METHOD_3_0D6A0AAD6F56CFD2_OFFSET UNITYSDK_OFFSET(0x17259250)
#define RPG_GAMECORE_GRIDFIGHTDRAGOPROLESELECTOR_METHOD_3_527A6A0DCA80CC38_OFFSET UNITYSDK_OFFSET(0x17258FD0)
#define RPG_GAMECORE_GRIDFIGHTDRAGOPROLESELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x17258FC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightDragOpRoleSelector_TypeDefinitionIndex = 18226;
