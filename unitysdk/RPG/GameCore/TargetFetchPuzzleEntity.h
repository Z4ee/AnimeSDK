...
#define RPG_GAMECORE_TARGETFETCHPUZZLEENTITY_METHOD_4_5AC2412134CF577E_OFFSET UNITYSDK_OFFSET(0x18EDF9F0)
#define RPG_GAMECORE_TARGETFETCHPUZZLEENTITY_METHOD_4_7316D8AFB06EC79A_OFFSET UNITYSDK_OFFSET(0x18EE5920)
#define RPG_GAMECORE_TARGETFETCHPUZZLEENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x18EDF9A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchPuzzleEntity_TypeDefinitionIndex = 22883;
