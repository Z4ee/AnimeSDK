...
#define RPG_GAMECORE_LOOPWAITSERVERTIMELINESTATECHANGE_METHOD_3_5E3B2DB1FAB6A43F_OFFSET UNITYSDK_OFFSET(0x1D216190)
#define RPG_GAMECORE_LOOPWAITSERVERTIMELINESTATECHANGE_METHOD_3_BF5EB99733D81043_OFFSET UNITYSDK_OFFSET(0x1D2161E0)
#define RPG_GAMECORE_LOOPWAITSERVERTIMELINESTATECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2161D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoopWaitServerTimelineStateChange_TypeDefinitionIndex = 21987;
