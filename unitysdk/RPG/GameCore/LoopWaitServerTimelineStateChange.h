...
#define RPG_GAMECORE_LOOPWAITSERVERTIMELINESTATECHANGE_METHOD_3_B843055BDB572193_OFFSET UNITYSDK_OFFSET(0x198B24F0)
#define RPG_GAMECORE_LOOPWAITSERVERTIMELINESTATECHANGE_METHOD_3_BF5EB99733D81043_OFFSET UNITYSDK_OFFSET(0x198B2580)
#define RPG_GAMECORE_LOOPWAITSERVERTIMELINESTATECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x198B2550)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoopWaitServerTimelineStateChange_TypeDefinitionIndex = 21011;
