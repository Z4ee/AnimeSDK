...
#define RPG_GAMECORE_EXPTYPEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x171B61C0)
#define RPG_GAMECORE_EXPTYPEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x171B6820)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ExpTypeRow_TypeDefinitionIndex = 11634;
