...
#define RPG_GAMECORE_FATEBUFFGIFTCONFIG_METHOD_2_8BE17946D68D8F3B_OFFSET UNITYSDK_OFFSET(0x1D08C9A0)
#define RPG_GAMECORE_FATEBUFFGIFTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D08C9E0)
