...
#define RPG_GAMECORE_FATEBUFFGIFTCONFIG_METHOD_2_8BE17946D68D8F3B_OFFSET UNITYSDK_OFFSET(0x188D1A40)
#define RPG_GAMECORE_FATEBUFFGIFTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x188D1A80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateBuffGiftConfig_TypeDefinitionIndex = 18291;
