...
#define RPG_GAMECORE_FATEBUFFGIFTCONFIG_METHOD_2_8BE17946D68D8F3B_OFFSET UNITYSDK_OFFSET(0x1E0CCF80)
#define RPG_GAMECORE_FATEBUFFGIFTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0CCFC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateBuffGiftConfig_TypeDefinitionIndex = 19023;
