...
#define RPG_GAMECORE_GRIDFIGHTCONDFALSECONFIG_METHOD_6_0A4BE02C6DF4BA57_OFFSET UNITYSDK_OFFSET(0x1D962EF0)
#define RPG_GAMECORE_GRIDFIGHTCONDFALSECONFIG_METHOD_6_AEBA1E32B940FF3B_OFFSET UNITYSDK_OFFSET(0x1D962F40)
#define RPG_GAMECORE_GRIDFIGHTCONDFALSECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D962F30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightCondFalseConfig_TypeDefinitionIndex = 19097;
