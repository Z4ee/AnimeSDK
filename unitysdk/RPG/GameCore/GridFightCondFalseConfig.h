...
#define RPG_GAMECORE_GRIDFIGHTCONDFALSECONFIG_METHOD_6_664BB540578C07D7_OFFSET UNITYSDK_OFFSET(0x17254BE0)
#define RPG_GAMECORE_GRIDFIGHTCONDFALSECONFIG_METHOD_6_AEBA1E32B940FF3B_OFFSET UNITYSDK_OFFSET(0x17254DA0)
#define RPG_GAMECORE_GRIDFIGHTCONDFALSECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17254CE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightCondFalseConfig_TypeDefinitionIndex = 17747;
