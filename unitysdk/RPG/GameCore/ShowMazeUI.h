...
#define RPG_GAMECORE_SHOWMAZEUI_METHOD_3_0BB1B8472DAC29B2_OFFSET UNITYSDK_OFFSET(0x176FFF20)
#define RPG_GAMECORE_SHOWMAZEUI_METHOD_3_34D4CEACBFC8C05B_OFFSET UNITYSDK_OFFSET(0x176FFEA0)
#define RPG_GAMECORE_SHOWMAZEUI__CTOR_OFFSET UNITYSDK_OFFSET(0x176FFEF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowMazeUI_TypeDefinitionIndex = 18930;
