...
#define RPG_GAMECORE_PASSAGECONFIG_METHOD_2_5CD18212CF80577F_OFFSET UNITYSDK_OFFSET(0x1D30D490)
#define RPG_GAMECORE_PASSAGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D30D610)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PassageConfig_TypeDefinitionIndex = 18930;
