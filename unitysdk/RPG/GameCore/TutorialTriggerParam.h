...
#define RPG_GAMECORE_TUTORIALTRIGGERPARAM_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D61A640)
#define RPG_GAMECORE_TUTORIALTRIGGERPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D61A750)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TutorialTriggerParam_TypeDefinitionIndex = 15208;
