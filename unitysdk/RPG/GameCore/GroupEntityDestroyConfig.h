...
#define RPG_GAMECORE_GROUPENTITYDESTROYCONFIG_METHOD_2_8EC6AA90B0232F57_OFFSET UNITYSDK_OFFSET(0x19812F80)
#define RPG_GAMECORE_GROUPENTITYDESTROYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19813120)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GroupEntityDestroyConfig_TypeDefinitionIndex = 20057;
