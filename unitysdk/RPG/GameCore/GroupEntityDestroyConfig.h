...
#define RPG_GAMECORE_GROUPENTITYDESTROYCONFIG_METHOD_2_8EC6AA90B0232F57_OFFSET UNITYSDK_OFFSET(0x1728B8D0)
#define RPG_GAMECORE_GROUPENTITYDESTROYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1728BA70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GroupEntityDestroyConfig_TypeDefinitionIndex = 19526;
