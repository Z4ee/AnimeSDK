...
#define RPG_GAMECORE_GROUPENTITYDESTROYCONFIG_METHOD_2_8EC6AA90B0232F57_OFFSET UNITYSDK_OFFSET(0x189E0120)
#define RPG_GAMECORE_GROUPENTITYDESTROYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189E02C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GroupEntityDestroyConfig_TypeDefinitionIndex = 20201;
