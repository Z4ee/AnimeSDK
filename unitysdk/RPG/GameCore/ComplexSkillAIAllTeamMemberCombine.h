...
#define RPG_GAMECORE_COMPLEXSKILLAIALLTEAMMEMBERCOMBINE_METHOD_3_C14519925AEF4137_OFFSET UNITYSDK_OFFSET(0x1D9A7A80)
#define RPG_GAMECORE_COMPLEXSKILLAIALLTEAMMEMBERCOMBINE_METHOD_3_F63E7DDC6362BC08_OFFSET UNITYSDK_OFFSET(0x1D9A7AC0)
#define RPG_GAMECORE_COMPLEXSKILLAIALLTEAMMEMBERCOMBINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D9A7AB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAIAllTeamMemberCombine_TypeDefinitionIndex = 15370;
