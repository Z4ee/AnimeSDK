...
#define RPG_GAMECORE_COMPLEXSKILLAIALLTEAMMEMBERCOMBINE_METHOD_3_8038CA6E8FAC01A9_OFFSET UNITYSDK_OFFSET(0x18828670)
#define RPG_GAMECORE_COMPLEXSKILLAIALLTEAMMEMBERCOMBINE_METHOD_3_F63E7DDC6362BC08_OFFSET UNITYSDK_OFFSET(0x188286E0)
#define RPG_GAMECORE_COMPLEXSKILLAIALLTEAMMEMBERCOMBINE__CTOR_OFFSET UNITYSDK_OFFSET(0x188286C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAIAllTeamMemberCombine_TypeDefinitionIndex = 14709;
