...
#define RPG_GAMECORE_PLAYPENACONYENDMOSTSHOWPAGE_METHOD_3_94D2FDC4C4A58D19_OFFSET UNITYSDK_OFFSET(0x174C5410)
#define RPG_GAMECORE_PLAYPENACONYENDMOSTSHOWPAGE_METHOD_3_9D6A08083FCFEBCB_OFFSET UNITYSDK_OFFSET(0x174C5390)
#define RPG_GAMECORE_PLAYPENACONYENDMOSTSHOWPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x174C53E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayPenaconyEndmostShowPage_TypeDefinitionIndex = 19998;
