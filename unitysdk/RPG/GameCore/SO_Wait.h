...
#define RPG_GAMECORE_SO_WAIT_METHOD_4_5098F00D69B27110_OFFSET UNITYSDK_OFFSET(0x18DE0E50)
#define RPG_GAMECORE_SO_WAIT_METHOD_4_A7FC8081E2B3D6C9_OFFSET UNITYSDK_OFFSET(0x18DE0990)
#define RPG_GAMECORE_SO_WAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x18DE0960)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SO_Wait_TypeDefinitionIndex = 18981;
