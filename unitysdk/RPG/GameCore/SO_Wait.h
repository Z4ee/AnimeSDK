...
#define RPG_GAMECORE_SO_WAIT_METHOD_4_76252E520E671B42_OFFSET UNITYSDK_OFFSET(0x1B776910)
#define RPG_GAMECORE_SO_WAIT_METHOD_4_A7FC8081E2B3D6C9_OFFSET UNITYSDK_OFFSET(0x1B776560)
#define RPG_GAMECORE_SO_WAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B776550)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SO_Wait_TypeDefinitionIndex = 19284;
