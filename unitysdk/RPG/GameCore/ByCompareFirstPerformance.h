...
#define RPG_GAMECORE_BYCOMPAREFIRSTPERFORMANCE_METHOD_4_091519BBABE7344F_OFFSET UNITYSDK_OFFSET(0x19CE1650)
#define RPG_GAMECORE_BYCOMPAREFIRSTPERFORMANCE_METHOD_4_393A43275D828BA8_OFFSET UNITYSDK_OFFSET(0x19CE1620)
#define RPG_GAMECORE_BYCOMPAREFIRSTPERFORMANCE_METHOD_4_66981692B9CB2D7B_OFFSET UNITYSDK_OFFSET(0x19CE1470)
#define RPG_GAMECORE_BYCOMPAREFIRSTPERFORMANCE_METHOD_4_BDC165359FE99D16_OFFSET UNITYSDK_OFFSET(0x19CE14B0)
#define RPG_GAMECORE_BYCOMPAREFIRSTPERFORMANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x19CE14A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareFirstPerformance_TypeDefinitionIndex = 20300;
