...
#define RPG_GAMECORE_SHOPGOODSMAP_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x176F22C0)
#define RPG_GAMECORE_SHOPGOODSMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x176F23B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShopGoodsMap_TypeDefinitionIndex = 11490;
