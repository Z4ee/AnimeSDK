...
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEAVATARBASETYPE_METHOD_3_87A7A6434711FC44_OFFSET UNITYSDK_OFFSET(0x1CFF3C30)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEAVATARBASETYPE_METHOD_3_8B252CD7B3E0BE15_OFFSET UNITYSDK_OFFSET(0x1CFF3BC0)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEAVATARBASETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFF3C20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAISourceAvatarBaseType_TypeDefinitionIndex = 15376;
