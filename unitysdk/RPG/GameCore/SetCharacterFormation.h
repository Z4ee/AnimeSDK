...
#define RPG_GAMECORE_SETCHARACTERFORMATION_METHOD_3_0C2FECA127A92F59_OFFSET UNITYSDK_OFFSET(0x176ADA60)
#define RPG_GAMECORE_SETCHARACTERFORMATION_METHOD_3_FED157FC32A60A3A_OFFSET UNITYSDK_OFFSET(0x176AD920)
#define RPG_GAMECORE_SETCHARACTERFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x176AD9D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetCharacterFormation_TypeDefinitionIndex = 20823;
