...
#define RPG_GAMECORE_SETCHARACTERFORMATION_METHOD_3_0C2FECA127A92F59_OFFSET UNITYSDK_OFFSET(0x18E10380)
#define RPG_GAMECORE_SETCHARACTERFORMATION_METHOD_3_FED157FC32A60A3A_OFFSET UNITYSDK_OFFSET(0x18E10240)
#define RPG_GAMECORE_SETCHARACTERFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x18E102F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetCharacterFormation_TypeDefinitionIndex = 21532;
