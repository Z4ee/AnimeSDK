...
#define RPG_GAMECORE_RELICSETCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D39A3E0)
#define RPG_GAMECORE_RELICSETCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D39AC20)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 DisplayItemIDRarity4; // 0x40
