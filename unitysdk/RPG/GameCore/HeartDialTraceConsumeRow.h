...
#define RPG_GAMECORE_HEARTDIALTRACECONSUMEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x198214B0)
#define RPG_GAMECORE_HEARTDIALTRACECONSUMEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19821770)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::HeartDialStepType HeartDialStep; // 0x18
		::System::Int32 MiniMapID; // 0x1C
		::System::UInt32 FloorID; // 0x20
		::System::UInt32 MapInfoID; // 0x24
		::RPG::GameCore::HeartDialEmoType HeartDialEmotion; // 0x28
