...
#define RPG_GAMECORE_TRACKNPCZONECONFIG_METHOD_2_30D414AA1C03A2B1_OFFSET UNITYSDK_OFFSET(0x19DEDDF0)
#define RPG_GAMECORE_TRACKNPCZONECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19DEDF50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrackNpcZoneConfig_TypeDefinitionIndex = 20958;
