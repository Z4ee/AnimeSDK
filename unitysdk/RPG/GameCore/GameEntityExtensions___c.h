...
#define RPG_GAMECORE_GAMEENTITYEXTENSIONS___C__CCTOR_OFFSET UNITYSDK_OFFSET(0xE657800)
#define RPG_GAMECORE_GAMEENTITYEXTENSIONS___C__CTOR_OFFSET UNITYSDK_OFFSET(0xE657830)
#define RPG_GAMECORE_GAMEENTITYEXTENSIONS___C___CCTOR_B__101_0_OFFSET UNITYSDK_OFFSET(0xE657840)
#define RPG_GAMECORE_GAMEENTITYEXTENSIONS___C___CCTOR_B__101_1_OFFSET UNITYSDK_OFFSET(0xE6578F0)
#define RPG_GAMECORE_GAMEENTITYEXTENSIONS___C___CCTOR_B__101_2_OFFSET UNITYSDK_OFFSET(0xE657990)
#define RPG_GAMECORE_GAMEENTITYEXTENSIONS___C___CCTOR_B__101_3_OFFSET UNITYSDK_OFFSET(0xE6579C0)
#define RPG_GAMECORE_GAMEENTITYEXTENSIONS___C___CCTOR_B__101_4_OFFSET UNITYSDK_OFFSET(0xE657A30)
#define RPG_GAMECORE_GAMEENTITYEXTENSIONS___C___CCTOR_B__101_5_OFFSET UNITYSDK_OFFSET(0xE657A60)
#define RPG_GAMECORE_GAMEENTITYEXTENSIONS___C___CCTOR_B__101_6_OFFSET UNITYSDK_OFFSET(0xE657A90)
#define RPG_GAMECORE_GAMEENTITYEXTENSIONS___C___CCTOR_B__101_7_OFFSET UNITYSDK_OFFSET(0xE657B60)
...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::RPG::GameCore::GameEntityExtensions___c**)Il2CppClass::FromTypeDefinitionIndex(GameEntityExtensions___c_TypeDefinitionIndex)->GetStaticField(0x3B40);
		}
