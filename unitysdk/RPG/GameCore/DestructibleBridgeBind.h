...
#define RPG_GAMECORE_DESTRUCTIBLEBRIDGEBIND_METHOD_2_23F371C6BDB54CAC_OFFSET UNITYSDK_OFFSET(0x1969B960)
#define RPG_GAMECORE_DESTRUCTIBLEBRIDGEBIND__CTOR_OFFSET UNITYSDK_OFFSET(0x1969BA80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DestructibleBridgeBind_TypeDefinitionIndex = 16699;
