...
#define RPG_GAMECORE_DESTRUCTIBLEBRIDGEBIND_METHOD_2_23F371C6BDB54CAC_OFFSET UNITYSDK_OFFSET(0x1C1048D0)
#define RPG_GAMECORE_DESTRUCTIBLEBRIDGEBIND__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1049F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DestructibleBridgeBind_TypeDefinitionIndex = 16861;
