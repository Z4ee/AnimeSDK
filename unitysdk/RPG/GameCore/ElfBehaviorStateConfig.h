...
#define RPG_GAMECORE_ELFBEHAVIORSTATECONFIG_METHOD_2_C5251FE71F28AB33_OFFSET UNITYSDK_OFFSET(0x1718C390)
#define RPG_GAMECORE_ELFBEHAVIORSTATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1718C440)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfBehaviorStateConfig_TypeDefinitionIndex = 16974;
