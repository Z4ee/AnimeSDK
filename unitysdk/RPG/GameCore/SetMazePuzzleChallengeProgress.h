...
#define RPG_GAMECORE_SETMAZEPUZZLECHALLENGEPROGRESS_METHOD_3_6270F8A0D8B29C30_OFFSET UNITYSDK_OFFSET(0x1C5FF950)
#define RPG_GAMECORE_SETMAZEPUZZLECHALLENGEPROGRESS_METHOD_3_B91866F18E913CC9_OFFSET UNITYSDK_OFFSET(0x1C5FF9B0)
#define RPG_GAMECORE_SETMAZEPUZZLECHALLENGEPROGRESS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5FF990)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetMazePuzzleChallengeProgress_TypeDefinitionIndex = 21206;
