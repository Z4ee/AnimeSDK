...
#define RPG_GAMECORE_SETMAZEPUZZLECHALLENGEPROGRESS_METHOD_3_B91866F18E913CC9_OFFSET UNITYSDK_OFFSET(0x176D4CD0)
#define RPG_GAMECORE_SETMAZEPUZZLECHALLENGEPROGRESS_METHOD_3_F0FEF25061B7D762_OFFSET UNITYSDK_OFFSET(0x176D4C30)
#define RPG_GAMECORE_SETMAZEPUZZLECHALLENGEPROGRESS__CTOR_OFFSET UNITYSDK_OFFSET(0x176D4C90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetMazePuzzleChallengeProgress_TypeDefinitionIndex = 20190;
