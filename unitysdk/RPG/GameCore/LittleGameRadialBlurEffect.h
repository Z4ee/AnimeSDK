...
#define RPG_GAMECORE_LITTLEGAMERADIALBLUREFFECT_METHOD_3_437083561D49DE1C_OFFSET UNITYSDK_OFFSET(0x198A1990)
#define RPG_GAMECORE_LITTLEGAMERADIALBLUREFFECT_METHOD_3_46F11802D43930B8_OFFSET UNITYSDK_OFFSET(0x198A1A50)
#define RPG_GAMECORE_LITTLEGAMERADIALBLUREFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x198A1A00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameRadialBlurEffect_TypeDefinitionIndex = 20296;
