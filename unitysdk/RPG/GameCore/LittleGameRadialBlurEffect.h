...
#define RPG_GAMECORE_LITTLEGAMERADIALBLUREFFECT_METHOD_3_46F11802D43930B8_OFFSET UNITYSDK_OFFSET(0x1DD6D7C0)
#define RPG_GAMECORE_LITTLEGAMERADIALBLUREFFECT_METHOD_3_EFB99690947A30F4_OFFSET UNITYSDK_OFFSET(0x1DD6D730)
#define RPG_GAMECORE_LITTLEGAMERADIALBLUREFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD6D790)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameRadialBlurEffect_TypeDefinitionIndex = 21245;
