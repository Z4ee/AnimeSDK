...
#define RPG_GAMECORE_LITTLEGAMENAVAUTOGENEXITINFO_METHOD_2_A6F9B2CEA25F2B36_OFFSET UNITYSDK_OFFSET(0x1DD6CC80)
#define RPG_GAMECORE_LITTLEGAMENAVAUTOGENEXITINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD6CCC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameNavAutoGenExitInfo_TypeDefinitionIndex = 17143;
