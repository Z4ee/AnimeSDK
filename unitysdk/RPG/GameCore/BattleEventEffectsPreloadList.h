...
#define RPG_GAMECORE_BATTLEEVENTEFFECTSPRELOADLIST_METHOD_3_1C6D059EA74A55C0_OFFSET UNITYSDK_OFFSET(0x1B2F8CD0)
#define RPG_GAMECORE_BATTLEEVENTEFFECTSPRELOADLIST_METHOD_3_43B9A91760C7B892_OFFSET UNITYSDK_OFFSET(0x1B2F8D10)
#define RPG_GAMECORE_BATTLEEVENTEFFECTSPRELOADLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2F8D00)
