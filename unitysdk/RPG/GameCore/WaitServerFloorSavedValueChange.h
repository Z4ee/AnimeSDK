...
#define RPG_GAMECORE_WAITSERVERFLOORSAVEDVALUECHANGE_METHOD_3_A08E825C521A5BA3_OFFSET UNITYSDK_OFFSET(0x19108550)
#define RPG_GAMECORE_WAITSERVERFLOORSAVEDVALUECHANGE_METHOD_3_D505A0CBD9755EBC_OFFSET UNITYSDK_OFFSET(0x191084E0)
#define RPG_GAMECORE_WAITSERVERFLOORSAVEDVALUECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x19108520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitServerFloorSavedValueChange_TypeDefinitionIndex = 21124;
