...
#define RPG_GAMECORE_WAITSERVERFLOORSAVEDVALUECHANGE_METHOD_3_A08E825C521A5BA3_OFFSET UNITYSDK_OFFSET(0x17904690)
#define RPG_GAMECORE_WAITSERVERFLOORSAVEDVALUECHANGE_METHOD_3_D505A0CBD9755EBC_OFFSET UNITYSDK_OFFSET(0x17904620)
#define RPG_GAMECORE_WAITSERVERFLOORSAVEDVALUECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x17904660)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitServerFloorSavedValueChange_TypeDefinitionIndex = 20442;
