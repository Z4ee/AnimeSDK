...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETITEMNUMCONFIG_METHOD_6_04F871CD1FB5B7CA_OFFSET UNITYSDK_OFFSET(0x197F8790)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETITEMNUMCONFIG_METHOD_6_113EAC5353D28D44_OFFSET UNITYSDK_OFFSET(0x197F8A40)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETITEMNUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197F8910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightParamGetItemNumConfig_TypeDefinitionIndex = 18507;
