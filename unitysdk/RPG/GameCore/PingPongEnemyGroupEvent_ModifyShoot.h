...
#define RPG_GAMECORE_PINGPONGENEMYGROUPEVENT_MODIFYSHOOT_METHOD_3_0703732BD681FE40_OFFSET UNITYSDK_OFFSET(0x19A0D360)
#define RPG_GAMECORE_PINGPONGENEMYGROUPEVENT_MODIFYSHOOT_METHOD_3_D8CC747CE7BC361C_OFFSET UNITYSDK_OFFSET(0x19A0CE90)
#define RPG_GAMECORE_PINGPONGENEMYGROUPEVENT_MODIFYSHOOT__CTOR_OFFSET UNITYSDK_OFFSET(0x19A0CE80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PingPongEnemyGroupEvent_ModifyShoot_TypeDefinitionIndex = 16137;
