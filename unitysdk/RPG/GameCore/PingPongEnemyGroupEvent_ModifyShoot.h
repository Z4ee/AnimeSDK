...
#define RPG_GAMECORE_PINGPONGENEMYGROUPEVENT_MODIFYSHOOT_METHOD_3_0703732BD681FE40_OFFSET UNITYSDK_OFFSET(0x174AFF40)
#define RPG_GAMECORE_PINGPONGENEMYGROUPEVENT_MODIFYSHOOT_METHOD_3_D8CC747CE7BC361C_OFFSET UNITYSDK_OFFSET(0x174AFA80)
#define RPG_GAMECORE_PINGPONGENEMYGROUPEVENT_MODIFYSHOOT__CTOR_OFFSET UNITYSDK_OFFSET(0x174AFA70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PingPongEnemyGroupEvent_ModifyShoot_TypeDefinitionIndex = 15567;
