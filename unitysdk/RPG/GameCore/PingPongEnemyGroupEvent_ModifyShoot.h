...
#define RPG_GAMECORE_PINGPONGENEMYGROUPEVENT_MODIFYSHOOT_METHOD_3_0703732BD681FE40_OFFSET UNITYSDK_OFFSET(0x18BFB510)
#define RPG_GAMECORE_PINGPONGENEMYGROUPEVENT_MODIFYSHOOT_METHOD_3_D8CC747CE7BC361C_OFFSET UNITYSDK_OFFSET(0x18BFB050)
#define RPG_GAMECORE_PINGPONGENEMYGROUPEVENT_MODIFYSHOOT__CTOR_OFFSET UNITYSDK_OFFSET(0x18BFB040)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PingPongEnemyGroupEvent_ModifyShoot_TypeDefinitionIndex = 16087;
