...
#define RPG_GAMECORE_RESIDENTPOSSESSIONINFO_METHOD_2_85915FA24980C2F5_OFFSET UNITYSDK_OFFSET(0x1DB94FC0)
#define RPG_GAMECORE_RESIDENTPOSSESSIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB951B0)
