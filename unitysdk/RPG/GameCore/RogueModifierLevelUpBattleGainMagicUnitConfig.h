...
#define RPG_GAMECORE_ROGUEMODIFIERLEVELUPBATTLEGAINMAGICUNITCONFIG_METHOD_3_3A3BA23DF192BB89_OFFSET UNITYSDK_OFFSET(0x17632B30)
#define RPG_GAMECORE_ROGUEMODIFIERLEVELUPBATTLEGAINMAGICUNITCONFIG_METHOD_3_BA5C8C8E652C5FB0_OFFSET UNITYSDK_OFFSET(0x17632A60)
#define RPG_GAMECORE_ROGUEMODIFIERLEVELUPBATTLEGAINMAGICUNITCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17632AE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierLevelUpBattleGainMagicUnitConfig_TypeDefinitionIndex = 16283;
