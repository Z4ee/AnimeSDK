...
#define RPG_GAMECORE_ROGUEMODIFIERLEVELUPBATTLEGAINMAGICUNITCONFIG_METHOD_3_3A3BA23DF192BB89_OFFSET UNITYSDK_OFFSET(0x1CFC1510)
#define RPG_GAMECORE_ROGUEMODIFIERLEVELUPBATTLEGAINMAGICUNITCONFIG_METHOD_3_9CE5A556A4873205_OFFSET UNITYSDK_OFFSET(0x1CFC14C0)
#define RPG_GAMECORE_ROGUEMODIFIERLEVELUPBATTLEGAINMAGICUNITCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFC1500)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierLevelUpBattleGainMagicUnitConfig_TypeDefinitionIndex = 17014;
