...
#define RPG_GAMECORE_FIVEDIMTRIGGERDASHORBACTION_METHOD_3_2AC8DE8421593215_OFFSET UNITYSDK_OFFSET(0x1D107AC0)
#define RPG_GAMECORE_FIVEDIMTRIGGERDASHORBACTION_METHOD_3_79C38624413A5710_OFFSET UNITYSDK_OFFSET(0x1D107A40)
#define RPG_GAMECORE_FIVEDIMTRIGGERDASHORBACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D107AB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimTriggerDashOrbAction_TypeDefinitionIndex = 18554;
