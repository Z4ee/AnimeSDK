...
#define RPG_GAMECORE_FIVEDIMTRIGGERDASHORBACTION_METHOD_3_2AC8DE8421593215_OFFSET UNITYSDK_OFFSET(0x189229F0)
#define RPG_GAMECORE_FIVEDIMTRIGGERDASHORBACTION_METHOD_3_86A33D6355988930_OFFSET UNITYSDK_OFFSET(0x18922930)
#define RPG_GAMECORE_FIVEDIMTRIGGERDASHORBACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x189229D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimTriggerDashOrbAction_TypeDefinitionIndex = 17827;
