...
#define RPG_GAMECORE_GROUPINITMEMBERENTITYPROPSTATE_METHOD_3_7A4D24A3E51708DF_OFFSET UNITYSDK_OFFSET(0x1728C570)
#define RPG_GAMECORE_GROUPINITMEMBERENTITYPROPSTATE_METHOD_3_EFBC9EBD04853BE1_OFFSET UNITYSDK_OFFSET(0x1728C4F0)
#define RPG_GAMECORE_GROUPINITMEMBERENTITYPROPSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1728C540)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GroupInitMemberEntityPropState_TypeDefinitionIndex = 19052;
