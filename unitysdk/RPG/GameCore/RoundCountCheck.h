...
#define RPG_GAMECORE_ROUNDCOUNTCHECK_METHOD_3_84DFC81722F30E0E_OFFSET UNITYSDK_OFFSET(0x17674F80)
#define RPG_GAMECORE_ROUNDCOUNTCHECK_METHOD_3_BC8E0082199E5059_OFFSET UNITYSDK_OFFSET(0x17675000)
#define RPG_GAMECORE_ROUNDCOUNTCHECK__CTOR_OFFSET UNITYSDK_OFFSET(0x17674FD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RoundCountCheck_TypeDefinitionIndex = 21164;
