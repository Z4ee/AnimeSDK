...
#define RPG_GAMECORE_ROUNDCOUNTCHECK_METHOD_3_750C0645B42DDDDC_OFFSET UNITYSDK_OFFSET(0x1CCD1E20)
#define RPG_GAMECORE_ROUNDCOUNTCHECK_METHOD_3_BC8E0082199E5059_OFFSET UNITYSDK_OFFSET(0x1CCD1E60)
#define RPG_GAMECORE_ROUNDCOUNTCHECK__CTOR_OFFSET UNITYSDK_OFFSET(0x1CCD1E50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RoundCountCheck_TypeDefinitionIndex = 22701;
