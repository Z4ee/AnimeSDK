...
#define RPG_GAMECORE_BASECHENLINGBATTLEINITPOSITIONEVALUATOR_METHOD_2_1DCCCD49592605B6_OFFSET UNITYSDK_OFFSET(0x1A3DD630)
#define RPG_GAMECORE_BASECHENLINGBATTLEINITPOSITIONEVALUATOR_METHOD_2_E03EB03FC1322D92_OFFSET UNITYSDK_OFFSET(0x1A3DD3C0)
#define RPG_GAMECORE_BASECHENLINGBATTLEINITPOSITIONEVALUATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3DD690)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BaseChenLingBattleInitPositionEvaluator_TypeDefinitionIndex = 15142;
