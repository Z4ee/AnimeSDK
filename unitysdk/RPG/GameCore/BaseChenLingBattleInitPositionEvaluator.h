...
#define RPG_GAMECORE_BASECHENLINGBATTLEINITPOSITIONEVALUATOR_METHOD_2_1DCCCD49592605B6_OFFSET UNITYSDK_OFFSET(0x194BB160)
#define RPG_GAMECORE_BASECHENLINGBATTLEINITPOSITIONEVALUATOR_METHOD_2_E03EB03FC1322D92_OFFSET UNITYSDK_OFFSET(0x194BAEF0)
#define RPG_GAMECORE_BASECHENLINGBATTLEINITPOSITIONEVALUATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x194BB1C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BaseChenLingBattleInitPositionEvaluator_TypeDefinitionIndex = 14978;
