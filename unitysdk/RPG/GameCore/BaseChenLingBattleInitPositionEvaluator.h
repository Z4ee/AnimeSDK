...
#define RPG_GAMECORE_BASECHENLINGBATTLEINITPOSITIONEVALUATOR_METHOD_2_1DCCCD49592605B6_OFFSET UNITYSDK_OFFSET(0x16FC4750)
#define RPG_GAMECORE_BASECHENLINGBATTLEINITPOSITIONEVALUATOR_METHOD_2_E03EB03FC1322D92_OFFSET UNITYSDK_OFFSET(0x16FC4510)
#define RPG_GAMECORE_BASECHENLINGBATTLEINITPOSITIONEVALUATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x16FC47B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BaseChenLingBattleInitPositionEvaluator_TypeDefinitionIndex = 14445;
