...
#define RPG_GAMECORE_COMPLEXSKILLAIMAPPERMULTIRANGE_METHOD_3_57B9FDB54547F5FB_OFFSET UNITYSDK_OFFSET(0x17123C60)
#define RPG_GAMECORE_COMPLEXSKILLAIMAPPERMULTIRANGE_METHOD_3_5D8FC888CF177788_OFFSET UNITYSDK_OFFSET(0x17123DF0)
#define RPG_GAMECORE_COMPLEXSKILLAIMAPPERMULTIRANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x17123C50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAIMapperMultiRange_TypeDefinitionIndex = 14253;
