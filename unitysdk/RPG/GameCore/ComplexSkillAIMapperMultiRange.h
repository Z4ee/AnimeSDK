...
#define RPG_GAMECORE_COMPLEXSKILLAIMAPPERMULTIRANGE_METHOD_3_79E227FC1A99BBFE_OFFSET UNITYSDK_OFFSET(0x1BC25990)
#define RPG_GAMECORE_COMPLEXSKILLAIMAPPERMULTIRANGE_METHOD_3_7B6CF723330572AD_OFFSET UNITYSDK_OFFSET(0x1BC25B10)
#define RPG_GAMECORE_COMPLEXSKILLAIMAPPERMULTIRANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC25980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAIMapperMultiRange_TypeDefinitionIndex = 14950;
