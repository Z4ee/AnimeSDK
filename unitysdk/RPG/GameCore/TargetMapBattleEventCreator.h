...
#define RPG_GAMECORE_TARGETMAPBATTLEEVENTCREATOR_METHOD_3_891B19D4DB5C26A5_OFFSET UNITYSDK_OFFSET(0x177C2250)
#define RPG_GAMECORE_TARGETMAPBATTLEEVENTCREATOR_METHOD_3_DE18EA9B955DA4B3_OFFSET UNITYSDK_OFFSET(0x177C2330)
#define RPG_GAMECORE_TARGETMAPBATTLEEVENTCREATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x177C2310)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapBattleEventCreator_TypeDefinitionIndex = 22208;
