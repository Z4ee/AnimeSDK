...
#define RPG_GAMECORE_TARGETMAPBATTLEEVENTCREATOR_METHOD_3_561BA3AAA89CAD35_OFFSET UNITYSDK_OFFSET(0x19D124B0)
#define RPG_GAMECORE_TARGETMAPBATTLEEVENTCREATOR_METHOD_3_891B19D4DB5C26A5_OFFSET UNITYSDK_OFFSET(0x19D12310)
#define RPG_GAMECORE_TARGETMAPBATTLEEVENTCREATOR_METHOD_3_93BE3B01B3309225_OFFSET UNITYSDK_OFFSET(0x19D12450)
#define RPG_GAMECORE_TARGETMAPBATTLEEVENTCREATOR_METHOD_3_DE18EA9B955DA4B3_OFFSET UNITYSDK_OFFSET(0x19D123F0)
#define RPG_GAMECORE_TARGETMAPBATTLEEVENTCREATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x19D123D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapBattleEventCreator_TypeDefinitionIndex = 22613;
	...
	public:
		...
		static ::System::Void Method_3_93BE3B01B3309225(::SimpleJSON::JSONNode* a1, ::RPG::GameCore::TargetMapBattleEventCreator*& a2)
		{
			return ((::System::Void(*)(::SimpleJSON::JSONNode*, ::RPG::GameCore::TargetMapBattleEventCreator*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_TARGETMAPBATTLEEVENTCREATOR_METHOD_3_93BE3B01B3309225_OFFSET))(a1, a2);
		}
