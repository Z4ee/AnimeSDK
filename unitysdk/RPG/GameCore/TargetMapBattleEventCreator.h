...
#define RPG_GAMECORE_TARGETMAPBATTLEEVENTCREATOR_METHOD_3_51DBF00C99C01D11_OFFSET UNITYSDK_OFFSET(0x1D0C1190)
#define RPG_GAMECORE_TARGETMAPBATTLEEVENTCREATOR_METHOD_3_561BA3AAA89CAD35_OFFSET UNITYSDK_OFFSET(0x1D0C11D0)
#define RPG_GAMECORE_TARGETMAPBATTLEEVENTCREATOR_METHOD_3_A75B1182B9E9D532_OFFSET UNITYSDK_OFFSET(0x1D0C1090)
#define RPG_GAMECORE_TARGETMAPBATTLEEVENTCREATOR_METHOD_3_DE18EA9B955DA4B3_OFFSET UNITYSDK_OFFSET(0x1D0C1130)
#define RPG_GAMECORE_TARGETMAPBATTLEEVENTCREATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0C1120)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapBattleEventCreator_TypeDefinitionIndex = 23076;
