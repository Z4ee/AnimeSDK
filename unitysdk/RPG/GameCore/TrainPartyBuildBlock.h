...
#define RPG_GAMECORE_TRAINPARTYBUILDBLOCK_METHOD_2_CCCEAA141AB198FB_OFFSET UNITYSDK_OFFSET(0x178A8560)
#define RPG_GAMECORE_TRAINPARTYBUILDBLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x178A86D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyBuildBlock_TypeDefinitionIndex = 14888;
