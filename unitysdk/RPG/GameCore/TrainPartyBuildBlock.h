...
#define RPG_GAMECORE_TRAINPARTYBUILDBLOCK_METHOD_2_CDA92543DA0FBD72_OFFSET UNITYSDK_OFFSET(0x190A70F0)
#define RPG_GAMECORE_TRAINPARTYBUILDBLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x190A7290)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyBuildBlock_TypeDefinitionIndex = 15395;
