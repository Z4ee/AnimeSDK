...
#define RPG_GAMECORE_ST_MAIN_MOVETOPOSITION_METHOD_4_0098D684E1AC323A_OFFSET UNITYSDK_OFFSET(0x17686E60)
#define RPG_GAMECORE_ST_MAIN_MOVETOPOSITION_METHOD_4_476A666D0C9161AD_OFFSET UNITYSDK_OFFSET(0x17697ED0)
#define RPG_GAMECORE_ST_MAIN_MOVETOPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x17686DE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_MoveToPosition_TypeDefinitionIndex = 18380;
