...
#define RPG_GAMECORE_ST_MAIN_MOVETOPOSITION_METHOD_4_0098D684E1AC323A_OFFSET UNITYSDK_OFFSET(0x1DB3E740)
#define RPG_GAMECORE_ST_MAIN_MOVETOPOSITION_METHOD_4_D0D056259ED91557_OFFSET UNITYSDK_OFFSET(0x1DB3E6B0)
#define RPG_GAMECORE_ST_MAIN_MOVETOPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB3E710)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_MoveToPosition_TypeDefinitionIndex = 19866;
	...
	public:
		...
		static ::System::Void Method_4_D0D056259ED91557(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::ST_Main_MoveToPosition*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::ST_Main_MoveToPosition*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_ST_MAIN_MOVETOPOSITION_METHOD_4_D0D056259ED91557_OFFSET))(a1, a2);
		}
