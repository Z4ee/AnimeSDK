...
#define RPG_GAMECORE_EVOLVEGEARTYPECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D07D710)
#define RPG_GAMECORE_EVOLVEGEARTYPECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D07DEF0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* WeaponToastEffectBg; // 0x30
