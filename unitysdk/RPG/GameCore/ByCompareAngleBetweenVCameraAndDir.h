...
#define RPG_GAMECORE_BYCOMPAREANGLEBETWEENVCAMERAANDDIR_METHOD_4_189258F6C215D3A7_OFFSET UNITYSDK_OFFSET(0x1CEB2340)
#define RPG_GAMECORE_BYCOMPAREANGLEBETWEENVCAMERAANDDIR_METHOD_4_1FA6C8B19A1EC76E_OFFSET UNITYSDK_OFFSET(0x1CEB2380)
#define RPG_GAMECORE_BYCOMPAREANGLEBETWEENVCAMERAANDDIR_METHOD_4_708394C9B05BF381_OFFSET UNITYSDK_OFFSET(0x1CEB2680)
#define RPG_GAMECORE_BYCOMPAREANGLEBETWEENVCAMERAANDDIR_METHOD_4_CCA6D5AC201F9DBE_OFFSET UNITYSDK_OFFSET(0x1CEB2650)
#define RPG_GAMECORE_BYCOMPAREANGLEBETWEENVCAMERAANDDIR__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEB2370)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareAngleBetweenVCameraAndDir_TypeDefinitionIndex = 23061;
