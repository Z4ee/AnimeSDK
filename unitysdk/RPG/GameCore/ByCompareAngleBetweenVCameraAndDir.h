...
#define RPG_GAMECORE_BYCOMPAREANGLEBETWEENVCAMERAANDDIR_METHOD_4_1FA6C8B19A1EC76E_OFFSET UNITYSDK_OFFSET(0x18726E60)
#define RPG_GAMECORE_BYCOMPAREANGLEBETWEENVCAMERAANDDIR_METHOD_4_8989C18200C90A8C_OFFSET UNITYSDK_OFFSET(0x18726D90)
#define RPG_GAMECORE_BYCOMPAREANGLEBETWEENVCAMERAANDDIR__CTOR_OFFSET UNITYSDK_OFFSET(0x18726E10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareAngleBetweenVCameraAndDir_TypeDefinitionIndex = 22300;
