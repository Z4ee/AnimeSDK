...
#define RPG_GAMECORE_SHAREDSTRINGLIST_EQUALS_OFFSET UNITYSDK_OFFSET(0x1BE33760)
#define RPG_GAMECORE_SHAREDSTRINGLIST_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1BE33850)
#define RPG_GAMECORE_SHAREDSTRINGLIST_METHOD_3_65B45DD5E2F906F9_OFFSET UNITYSDK_OFFSET(0x1BE33600)
#define RPG_GAMECORE_SHAREDSTRINGLIST_METHOD_3_85D22C255258C41D_OFFSET UNITYSDK_OFFSET(0x1BE33750)
#define RPG_GAMECORE_SHAREDSTRINGLIST_METHOD_3_C64B875B0C0F570E_OFFSET UNITYSDK_OFFSET(0x1BE33640)
#define RPG_GAMECORE_SHAREDSTRINGLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE33630)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SharedStringList_TypeDefinitionIndex = 17575;
