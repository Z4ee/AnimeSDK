...
#define RPG_GAMECORE_SHAREDSTRINGLIST_EQUALS_OFFSET UNITYSDK_OFFSET(0x176EE930)
#define RPG_GAMECORE_SHAREDSTRINGLIST_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x176EEA30)
#define RPG_GAMECORE_SHAREDSTRINGLIST_METHOD_3_65B45DD5E2F906F9_OFFSET UNITYSDK_OFFSET(0x176EE7D0)
#define RPG_GAMECORE_SHAREDSTRINGLIST_METHOD_3_85D22C255258C41D_OFFSET UNITYSDK_OFFSET(0x176EE920)
#define RPG_GAMECORE_SHAREDSTRINGLIST_METHOD_3_C64B875B0C0F570E_OFFSET UNITYSDK_OFFSET(0x176EE810)
#define RPG_GAMECORE_SHAREDSTRINGLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x176EE800)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SharedStringList_TypeDefinitionIndex = 16803;
