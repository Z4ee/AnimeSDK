...
#define RPG_GAMECORE_LOOPEXECUTETASKLISTWITHINTERVAL_METHOD_4_CE9610C5CBC8C2EE_OFFSET UNITYSDK_OFFSET(0x17370350)
#define RPG_GAMECORE_LOOPEXECUTETASKLISTWITHINTERVAL_METHOD_4_DF1F618BD86E1EFC_OFFSET UNITYSDK_OFFSET(0x17370150)
#define RPG_GAMECORE_LOOPEXECUTETASKLISTWITHINTERVAL__CTOR_OFFSET UNITYSDK_OFFSET(0x173700D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoopExecuteTaskListWithInterval_TypeDefinitionIndex = 20657;
