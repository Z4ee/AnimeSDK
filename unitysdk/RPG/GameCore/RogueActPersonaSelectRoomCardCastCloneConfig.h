...
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTCLONECONFIG_METHOD_7_20580CEC1086A0EC_OFFSET UNITYSDK_OFFSET(0x1D030080)
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTCLONECONFIG_METHOD_7_7868794130058EF0_OFFSET UNITYSDK_OFFSET(0x1D030030)
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTCLONECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D030070)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaSelectRoomCardCastCloneConfig_TypeDefinitionIndex = 18965;
