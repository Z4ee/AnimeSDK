...
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTCLONECONFIG_METHOD_7_05DA4F6E80703A71_OFFSET UNITYSDK_OFFSET(0x18CCD150)
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTCLONECONFIG_METHOD_7_20580CEC1086A0EC_OFFSET UNITYSDK_OFFSET(0x18CCD370)
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTCLONECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CCD290)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaSelectRoomCardCastCloneConfig_TypeDefinitionIndex = 18722;
