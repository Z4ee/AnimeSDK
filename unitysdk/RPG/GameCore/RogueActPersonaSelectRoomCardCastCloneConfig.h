...
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTCLONECONFIG_METHOD_7_20580CEC1086A0EC_OFFSET UNITYSDK_OFFSET(0x1D3B9A90)
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTCLONECONFIG_METHOD_7_7868794130058EF0_OFFSET UNITYSDK_OFFSET(0x1D3B9A40)
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTCLONECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3B9A80)
