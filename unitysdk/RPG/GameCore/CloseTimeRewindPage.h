...
#define RPG_GAMECORE_CLOSETIMEREWINDPAGE_METHOD_3_52C777B0EB104A7B_OFFSET UNITYSDK_OFFSET(0x1BC1EED0)
#define RPG_GAMECORE_CLOSETIMEREWINDPAGE_METHOD_3_74EFA1F7C062107E_OFFSET UNITYSDK_OFFSET(0x1BC1EFA0)
#define RPG_GAMECORE_CLOSETIMEREWINDPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC1EF90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CloseTimeRewindPage_TypeDefinitionIndex = 19866;
