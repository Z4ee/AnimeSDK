...
#define RPG_GAMECORE_CLOSETIMEREWINDPAGE_METHOD_3_53A1F2E0AA6E6EF2_OFFSET UNITYSDK_OFFSET(0x1711D700)
#define RPG_GAMECORE_CLOSETIMEREWINDPAGE_METHOD_3_74EFA1F7C062107E_OFFSET UNITYSDK_OFFSET(0x1711D810)
#define RPG_GAMECORE_CLOSETIMEREWINDPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1711D7E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CloseTimeRewindPage_TypeDefinitionIndex = 18963;
