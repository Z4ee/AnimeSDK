...
#define RPG_GAMECORE_CHIMERADUELEFFECTCONFIGCONTAINER_METHOD_2_DFFB601554DA07DF_OFFSET UNITYSDK_OFFSET(0x1C394960)
#define RPG_GAMECORE_CHIMERADUELEFFECTCONFIGCONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C394A50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelEffectConfigContainer_TypeDefinitionIndex = 15399;
