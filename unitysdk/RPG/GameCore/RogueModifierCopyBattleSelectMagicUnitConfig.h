...
#define RPG_GAMECORE_ROGUEMODIFIERCOPYBATTLESELECTMAGICUNITCONFIG_METHOD_3_BC5BF1014FB69499_OFFSET UNITYSDK_OFFSET(0x19B5BAA0)
#define RPG_GAMECORE_ROGUEMODIFIERCOPYBATTLESELECTMAGICUNITCONFIG_METHOD_3_EDE8C04648D74BF0_OFFSET UNITYSDK_OFFSET(0x19B4F780)
#define RPG_GAMECORE_ROGUEMODIFIERCOPYBATTLESELECTMAGICUNITCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B4F730)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierCopyBattleSelectMagicUnitConfig_TypeDefinitionIndex = 16853;
