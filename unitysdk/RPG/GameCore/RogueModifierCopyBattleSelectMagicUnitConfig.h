...
#define RPG_GAMECORE_ROGUEMODIFIERCOPYBATTLESELECTMAGICUNITCONFIG_METHOD_3_E2A4FE2CDC15C1F4_OFFSET UNITYSDK_OFFSET(0x1CFBF540)
#define RPG_GAMECORE_ROGUEMODIFIERCOPYBATTLESELECTMAGICUNITCONFIG_METHOD_3_EDE8C04648D74BF0_OFFSET UNITYSDK_OFFSET(0x1CFBF590)
#define RPG_GAMECORE_ROGUEMODIFIERCOPYBATTLESELECTMAGICUNITCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFBF580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierCopyBattleSelectMagicUnitConfig_TypeDefinitionIndex = 17015;
