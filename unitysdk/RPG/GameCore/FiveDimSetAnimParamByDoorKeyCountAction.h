...
#define RPG_GAMECORE_FIVEDIMSETANIMPARAMBYDOORKEYCOUNTACTION_METHOD_3_28F0918EFB1C4397_OFFSET UNITYSDK_OFFSET(0x18919AC0)
#define RPG_GAMECORE_FIVEDIMSETANIMPARAMBYDOORKEYCOUNTACTION_METHOD_3_45986B4675C9BFE6_OFFSET UNITYSDK_OFFSET(0x18919A50)
#define RPG_GAMECORE_FIVEDIMSETANIMPARAMBYDOORKEYCOUNTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18919AA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSetAnimParamByDoorKeyCountAction_TypeDefinitionIndex = 17718;
