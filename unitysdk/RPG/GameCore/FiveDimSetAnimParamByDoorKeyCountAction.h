...
#define RPG_GAMECORE_FIVEDIMSETANIMPARAMBYDOORKEYCOUNTACTION_METHOD_3_28F0918EFB1C4397_OFFSET UNITYSDK_OFFSET(0x1BEAF2A0)
#define RPG_GAMECORE_FIVEDIMSETANIMPARAMBYDOORKEYCOUNTACTION_METHOD_3_9D1F9F64ECEE6ADC_OFFSET UNITYSDK_OFFSET(0x1BEAF260)
#define RPG_GAMECORE_FIVEDIMSETANIMPARAMBYDOORKEYCOUNTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEAF290)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSetAnimParamByDoorKeyCountAction_TypeDefinitionIndex = 17919;
