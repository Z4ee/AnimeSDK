...
#define RPG_GAMECORE_IDLELIVESPINEANIMTRIGGERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D1A4040)
#define RPG_GAMECORE_IDLELIVESPINEANIMTRIGGERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1A4190)
