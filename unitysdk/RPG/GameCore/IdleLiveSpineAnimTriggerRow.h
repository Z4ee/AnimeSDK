...
#define RPG_GAMECORE_IDLELIVESPINEANIMTRIGGERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D215670)
#define RPG_GAMECORE_IDLELIVESPINEANIMTRIGGERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2157C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int IdleLiveSpineAnimTriggerRow_TypeDefinitionIndex = 11791;
