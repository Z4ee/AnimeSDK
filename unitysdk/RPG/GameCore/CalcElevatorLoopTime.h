...
#define RPG_GAMECORE_CALCELEVATORLOOPTIME_METHOD_3_3C26800F5DB141A6_OFFSET UNITYSDK_OFFSET(0x1D105C00)
#define RPG_GAMECORE_CALCELEVATORLOOPTIME_METHOD_3_B5C8DD6BE8C89537_OFFSET UNITYSDK_OFFSET(0x1D105C40)
#define RPG_GAMECORE_CALCELEVATORLOOPTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x1D105C30)
