...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERFINISHPRAYQUESTCONFIG_METHOD_3_9D6F4F640F65E0F4_OFFSET UNITYSDK_OFFSET(0x1C5D1040)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERFINISHPRAYQUESTCONFIG_METHOD_3_BC1BB2C87B263178_OFFSET UNITYSDK_OFFSET(0x1C5D0FF0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERFINISHPRAYQUESTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5D1030)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierExecActionAfterFinishPrayQuestConfig_TypeDefinitionIndex = 18744;
