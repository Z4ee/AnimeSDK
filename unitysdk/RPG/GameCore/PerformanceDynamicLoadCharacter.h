...
#define RPG_GAMECORE_PERFORMANCEDYNAMICLOADCHARACTER_METHOD_3_3A502B9172941445_OFFSET UNITYSDK_OFFSET(0x17495500)
#define RPG_GAMECORE_PERFORMANCEDYNAMICLOADCHARACTER_METHOD_3_DD3755E9707EF983_OFFSET UNITYSDK_OFFSET(0x17495580)
#define RPG_GAMECORE_PERFORMANCEDYNAMICLOADCHARACTER__CTOR_OFFSET UNITYSDK_OFFSET(0x17495550)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PerformanceDynamicLoadCharacter_TypeDefinitionIndex = 20027;
