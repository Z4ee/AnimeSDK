...
#define RPG_GAMECORE_FIVEDIMSCROLLAGENTCONFIG_METHOD_3_3376D203E55B1499_OFFSET UNITYSDK_OFFSET(0x1BEAEA90)
#define RPG_GAMECORE_FIVEDIMSCROLLAGENTCONFIG_METHOD_3_E9A2DA54F37FE30D_OFFSET UNITYSDK_OFFSET(0x1BEAEB70)
#define RPG_GAMECORE_FIVEDIMSCROLLAGENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEAEB60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimScrollAgentConfig_TypeDefinitionIndex = 17807;
