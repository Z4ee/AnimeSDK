...
#define RPG_GAMECORE_FIVEDIMSTARTLIMAODROPMOVEACTION_METHOD_3_06379C286EE2B60B_OFFSET UNITYSDK_OFFSET(0x1720D9F0)
#define RPG_GAMECORE_FIVEDIMSTARTLIMAODROPMOVEACTION_METHOD_3_F40F618C75856C0C_OFFSET UNITYSDK_OFFSET(0x1720DA60)
#define RPG_GAMECORE_FIVEDIMSTARTLIMAODROPMOVEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1720DA40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimStartLimaoDropMoveAction_TypeDefinitionIndex = 17155;
