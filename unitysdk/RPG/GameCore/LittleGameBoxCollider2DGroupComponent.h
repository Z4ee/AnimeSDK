...
#define RPG_GAMECORE_LITTLEGAMEBOXCOLLIDER2DGROUPCOMPONENT_METHOD_3_9E9B3B2D96F98CF8_OFFSET UNITYSDK_OFFSET(0x1BCBEB40)
#define RPG_GAMECORE_LITTLEGAMEBOXCOLLIDER2DGROUPCOMPONENT_METHOD_3_C632F9ADBC629828_OFFSET UNITYSDK_OFFSET(0x1BCBEAE0)
#define RPG_GAMECORE_LITTLEGAMEBOXCOLLIDER2DGROUPCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCBEB30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameBoxCollider2DGroupComponent_TypeDefinitionIndex = 18137;
