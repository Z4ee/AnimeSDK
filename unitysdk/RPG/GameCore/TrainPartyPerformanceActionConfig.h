...
#define RPG_GAMECORE_TRAINPARTYPERFORMANCEACTIONCONFIG_METHOD_2_931BB8F454DBB479_OFFSET UNITYSDK_OFFSET(0x178AE440)
#define RPG_GAMECORE_TRAINPARTYPERFORMANCEACTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x178AE540)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyPerformanceActionConfig_TypeDefinitionIndex = 14880;
