...
#define RPG_GAMECORE_PHOTOGRAPHSETSINGLETARGETUNIQUENAME_METHOD_3_02650869D9FACF30_OFFSET UNITYSDK_OFFSET(0x18BF5B00)
#define RPG_GAMECORE_PHOTOGRAPHSETSINGLETARGETUNIQUENAME_METHOD_3_4924C21275E5CE7C_OFFSET UNITYSDK_OFFSET(0x18BF7720)
#define RPG_GAMECORE_PHOTOGRAPHSETSINGLETARGETUNIQUENAME__CTOR_OFFSET UNITYSDK_OFFSET(0x18BF5AF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotoGraphSetSingleTargetUniqueName_TypeDefinitionIndex = 20470;
