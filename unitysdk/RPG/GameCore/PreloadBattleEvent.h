...
#define RPG_GAMECORE_PRELOADBATTLEEVENT_METHOD_3_9022B7CF65F1F8FA_OFFSET UNITYSDK_OFFSET(0x18C60450)
#define RPG_GAMECORE_PRELOADBATTLEEVENT_METHOD_3_F154C3690F4AFF83_OFFSET UNITYSDK_OFFSET(0x18C604D0)
#define RPG_GAMECORE_PRELOADBATTLEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x18C604A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PreloadBattleEvent_TypeDefinitionIndex = 21902;
