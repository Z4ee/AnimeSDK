...
#define RPG_GAMECORE_PAMSKINCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1BB0C3A0)
#define RPG_GAMECORE_PAMSKINCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB0C580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PamSkinConfigRow_TypeDefinitionIndex = 13795;

	class PamSkinConfigRow : public ::System::Object
	{
	public:
		::System::String* JsonPath; // 0x10
		::System::String* SkinIcon; // 0x18
		::System::String* ConfigEntityPath; // 0x20
		::System::String* ManikinPrefab; // 0x28
