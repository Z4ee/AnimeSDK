...
#define RPG_GAMECORE_FIVEDIMACTIONRANDOMBUBBLETALKINFOGROUP_METHOD_2_153B3342BAFE389C_OFFSET UNITYSDK_OFFSET(0x1BA862D0)
#define RPG_GAMECORE_FIVEDIMACTIONRANDOMBUBBLETALKINFOGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA86410)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimActionRandomBubbleTalkInfoGroup_TypeDefinitionIndex = 18042;
