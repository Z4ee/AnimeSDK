...
#define RPG_GAMECORE_GRIDFIGHTACTIONLIST_METHOD_2_0D9901B3119E3398_OFFSET UNITYSDK_OFFSET(0x189A0480)
#define RPG_GAMECORE_GRIDFIGHTACTIONLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x189A04C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightActionList_TypeDefinitionIndex = 18370;
