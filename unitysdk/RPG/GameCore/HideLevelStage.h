...
#define RPG_GAMECORE_HIDELEVELSTAGE_METHOD_3_54C146DB28FF9C01_OFFSET UNITYSDK_OFFSET(0x189FEC50)
#define RPG_GAMECORE_HIDELEVELSTAGE_METHOD_3_AA46E2326F7620CC_OFFSET UNITYSDK_OFFSET(0x189FECF0)
#define RPG_GAMECORE_HIDELEVELSTAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x189FECB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HideLevelStage_TypeDefinitionIndex = 21389;
