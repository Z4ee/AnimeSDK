...
#define RPG_GAMECORE_HIDELEVELSTAGE_METHOD_3_54C146DB28FF9C01_OFFSET UNITYSDK_OFFSET(0x172AA030)
#define RPG_GAMECORE_HIDELEVELSTAGE_METHOD_3_AA46E2326F7620CC_OFFSET UNITYSDK_OFFSET(0x172AA0D0)
#define RPG_GAMECORE_HIDELEVELSTAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x172AA090)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HideLevelStage_TypeDefinitionIndex = 20692;
