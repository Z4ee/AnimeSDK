...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSPECIALCRAFTEQUIPCONFIG_METHOD_3_3496065CEE21EE79_OFFSET UNITYSDK_OFFSET(0x1D06B3F0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSPECIALCRAFTEQUIPCONFIG_METHOD_3_C680AAD647922875_OFFSET UNITYSDK_OFFSET(0x1D06B3A0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSPECIALCRAFTEQUIPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D06B3E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierSpecialCraftEquipConfig_TypeDefinitionIndex = 18641;
