...
#define RPG_GAMECORE_CLEARDYNAMICSKILLBUTTONINPUT_METHOD_3_5C0707B86D95BEEE_OFFSET UNITYSDK_OFFSET(0x170B1CD0)
#define RPG_GAMECORE_CLEARDYNAMICSKILLBUTTONINPUT_METHOD_3_BDFB4BBC338D755D_OFFSET UNITYSDK_OFFSET(0x170B1C50)
#define RPG_GAMECORE_CLEARDYNAMICSKILLBUTTONINPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x170B1CA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClearDynamicSkillButtonInput_TypeDefinitionIndex = 21049;
