...
#define RPG_GAMECORE_LEVELPATHWAYINFO_METHOD_4_658EE803461797FF_OFFSET UNITYSDK_OFFSET(0x1B07EC50)
#define RPG_GAMECORE_LEVELPATHWAYINFO_METHOD_4_8F467125A4E418BB_OFFSET UNITYSDK_OFFSET(0x1B0814E0)
#define RPG_GAMECORE_LEVELPATHWAYINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B07EC40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPathwayInfo_TypeDefinitionIndex = 16565;
