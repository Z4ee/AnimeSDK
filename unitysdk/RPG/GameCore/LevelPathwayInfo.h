...
#define RPG_GAMECORE_LEVELPATHWAYINFO_METHOD_4_658EE803461797FF_OFFSET UNITYSDK_OFFSET(0x19880C90)
#define RPG_GAMECORE_LEVELPATHWAYINFO_METHOD_4_8F467125A4E418BB_OFFSET UNITYSDK_OFFSET(0x19881780)
#define RPG_GAMECORE_LEVELPATHWAYINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19880C80)
