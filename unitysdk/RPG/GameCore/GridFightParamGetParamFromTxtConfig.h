...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETPARAMFROMTXTCONFIG_METHOD_6_214CF6A1FD07AFF0_OFFSET UNITYSDK_OFFSET(0x189C6190)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETPARAMFROMTXTCONFIG_METHOD_6_E2D5FB5743204EE6_OFFSET UNITYSDK_OFFSET(0x189C5EE0)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETPARAMFROMTXTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189C6060)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightParamGetParamFromTxtConfig_TypeDefinitionIndex = 18519;
