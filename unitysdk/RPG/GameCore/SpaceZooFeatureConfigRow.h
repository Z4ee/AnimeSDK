...
#define RPG_GAMECORE_SPACEZOOFEATURECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17752860)
#define RPG_GAMECORE_SPACEZOOFEATURECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17752FE0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 FeatureID; // 0x38
		::System::UInt32 UnlockMissionID; // 0x3C
		::System::UInt32 ResearchPoint; // 0x40
		::RPG::GameCore::SpaceZooChannelType Channel; // 0x44
