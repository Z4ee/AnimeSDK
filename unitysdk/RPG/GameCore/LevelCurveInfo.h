...
#define RPG_GAMECORE_LEVELCURVEINFO_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1C10F680)
#define RPG_GAMECORE_LEVELCURVEINFO_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C10F640)
#define RPG_GAMECORE_LEVELCURVEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1C10F670)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelCurveInfo_TypeDefinitionIndex = 17181;
