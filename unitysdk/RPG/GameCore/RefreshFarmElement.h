...
#define RPG_GAMECORE_REFRESHFARMELEMENT_METHOD_3_938DEA15CF2B0356_OFFSET UNITYSDK_OFFSET(0x1D38FE30)
#define RPG_GAMECORE_REFRESHFARMELEMENT_METHOD_3_945AB9A6BF89E093_OFFSET UNITYSDK_OFFSET(0x1D38FD60)
#define RPG_GAMECORE_REFRESHFARMELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D38FE20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RefreshFarmElement_TypeDefinitionIndex = 21843;
