...
#define RPG_GAMECORE_REFRESHFARMELEMENT_METHOD_3_938DEA15CF2B0356_OFFSET UNITYSDK_OFFSET(0x18C94E70)
#define RPG_GAMECORE_REFRESHFARMELEMENT_METHOD_3_BD13AD59F3EBD58A_OFFSET UNITYSDK_OFFSET(0x18C94D60)
#define RPG_GAMECORE_REFRESHFARMELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x18C94E40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RefreshFarmElement_TypeDefinitionIndex = 20955;
