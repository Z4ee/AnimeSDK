...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDGLOBALHPAFTERFINALBATTLECONFIG_METHOD_3_32682D53ADF65484_OFFSET UNITYSDK_OFFSET(0x17260250)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDGLOBALHPAFTERFINALBATTLECONFIG_METHOD_3_C373E48B0301E10D_OFFSET UNITYSDK_OFFSET(0x17260180)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDGLOBALHPAFTERFINALBATTLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17260200)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierAddGlobalHpAfterFinalBattleConfig_TypeDefinitionIndex = 17797;
