...
#define RPG_GAMECORE_CAKERACEANDPREDICATECONFIG_METHOD_3_059F8BE06544BBFE_OFFSET UNITYSDK_OFFSET(0x1876C9F0)
#define RPG_GAMECORE_CAKERACEANDPREDICATECONFIG_METHOD_3_93757D0173453C8E_OFFSET UNITYSDK_OFFSET(0x1876C990)
#define RPG_GAMECORE_CAKERACEANDPREDICATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1876C9E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceAndPredicateConfig_TypeDefinitionIndex = 17466;
