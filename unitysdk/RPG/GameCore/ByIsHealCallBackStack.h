...
#define RPG_GAMECORE_BYISHEALCALLBACKSTACK_METHOD_4_A34C2405751BD2E0_OFFSET UNITYSDK_OFFSET(0x1CF3D050)
#define RPG_GAMECORE_BYISHEALCALLBACKSTACK_METHOD_4_AAC00323463F8DA0_OFFSET UNITYSDK_OFFSET(0x1CF3CEA0)
#define RPG_GAMECORE_BYISHEALCALLBACKSTACK_METHOD_4_BBB14A4284876633_OFFSET UNITYSDK_OFFSET(0x1CF3CEE0)
#define RPG_GAMECORE_BYISHEALCALLBACKSTACK_METHOD_4_C55DD720A5241369_OFFSET UNITYSDK_OFFSET(0x1CF3D020)
#define RPG_GAMECORE_BYISHEALCALLBACKSTACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF3CED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsHealCallBackStack_TypeDefinitionIndex = 23232;
