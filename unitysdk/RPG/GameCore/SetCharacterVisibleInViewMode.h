...
#define RPG_GAMECORE_SETCHARACTERVISIBLEINVIEWMODE_METHOD_3_77487DB31669C094_OFFSET UNITYSDK_OFFSET(0x1D4E8320)
#define RPG_GAMECORE_SETCHARACTERVISIBLEINVIEWMODE_METHOD_3_CC001798B3A07D62_OFFSET UNITYSDK_OFFSET(0x1D4E8280)
#define RPG_GAMECORE_SETCHARACTERVISIBLEINVIEWMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4E82E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetCharacterVisibleInViewMode_TypeDefinitionIndex = 22928;
