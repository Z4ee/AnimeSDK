...
#define RPG_GAMECORE_CHENLINGBATTLEINITPOSITIONEVALUATOR_ASCEND_METHOD_3_3E0D779ACC19F617_OFFSET UNITYSDK_OFFSET(0x19621A50)
#define RPG_GAMECORE_CHENLINGBATTLEINITPOSITIONEVALUATOR_ASCEND_METHOD_3_A34093599AA068A6_OFFSET UNITYSDK_OFFSET(0x196219B0)
#define RPG_GAMECORE_CHENLINGBATTLEINITPOSITIONEVALUATOR_ASCEND__CTOR_OFFSET UNITYSDK_OFFSET(0x19621A40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleInitPositionEvaluator_Ascend_TypeDefinitionIndex = 14983;
