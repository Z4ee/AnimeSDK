...
#define RPG_GAMECORE_BYSHAREDSUMMONUNITINUSE_METHOD_4_4D522038EE66A25D_OFFSET UNITYSDK_OFFSET(0x1703A670)
#define RPG_GAMECORE_BYSHAREDSUMMONUNITINUSE_METHOD_4_E55F76F93549C733_OFFSET UNITYSDK_OFFSET(0x1703A740)
#define RPG_GAMECORE_BYSHAREDSUMMONUNITINUSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1703A6F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BySharedSummonUnitInUse_TypeDefinitionIndex = 19465;
