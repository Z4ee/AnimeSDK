...
#define RPG_GAMECORE_BYSHAREDSUMMONUNITINUSE_METHOD_4_5C5F7052E52BA38F_OFFSET UNITYSDK_OFFSET(0x1B2B8640)
#define RPG_GAMECORE_BYSHAREDSUMMONUNITINUSE_METHOD_4_89F83B4924ECEC09_OFFSET UNITYSDK_OFFSET(0x1B2B8610)
#define RPG_GAMECORE_BYSHAREDSUMMONUNITINUSE_METHOD_4_E55F76F93549C733_OFFSET UNITYSDK_OFFSET(0x1B2B8490)
#define RPG_GAMECORE_BYSHAREDSUMMONUNITINUSE_METHOD_4_F6E9A0D66960BDBA_OFFSET UNITYSDK_OFFSET(0x1B2B8450)
#define RPG_GAMECORE_BYSHAREDSUMMONUNITINUSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2B8480)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BySharedSummonUnitInUse_TypeDefinitionIndex = 20369;
