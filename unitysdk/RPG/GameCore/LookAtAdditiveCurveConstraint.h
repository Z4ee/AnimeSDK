...
#define RPG_GAMECORE_LOOKATADDITIVECURVECONSTRAINT_METHOD_2_FD21EAFBA5FE720D_OFFSET UNITYSDK_OFFSET(0x1736E710)
#define RPG_GAMECORE_LOOKATADDITIVECURVECONSTRAINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1736EAD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LookAtAdditiveCurveConstraint_TypeDefinitionIndex = 20083;
