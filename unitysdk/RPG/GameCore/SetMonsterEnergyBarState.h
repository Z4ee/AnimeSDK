...
#define RPG_GAMECORE_SETMONSTERENERGYBARSTATE_METHOD_3_5FEB16E4455F21EC_OFFSET UNITYSDK_OFFSET(0x176D6F00)
#define RPG_GAMECORE_SETMONSTERENERGYBARSTATE_METHOD_3_D66400D8AF37A3F8_OFFSET UNITYSDK_OFFSET(0x176D6E00)
#define RPG_GAMECORE_SETMONSTERENERGYBARSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x176D6E90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetMonsterEnergyBarState_TypeDefinitionIndex = 21901;
