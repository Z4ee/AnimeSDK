...
#define RPG_GAMECORE_ROGUETOURNBUILDREFMATCHCONFIG_METHOD_2_5C25481F10944A53_OFFSET UNITYSDK_OFFSET(0x17660F50)
#define RPG_GAMECORE_ROGUETOURNBUILDREFMATCHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x176610D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournBuildRefMatchConfig_TypeDefinitionIndex = 16231;
