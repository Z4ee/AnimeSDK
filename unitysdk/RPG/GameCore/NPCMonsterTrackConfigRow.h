...
#define RPG_GAMECORE_NPCMONSTERTRACKCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18B7A100)
#define RPG_GAMECORE_NPCMONSTERTRACKCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18B7A2C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NPCMonsterTrackConfigRow_TypeDefinitionIndex = 13543;

	class NPCMonsterTrackConfigRow : public ::System::Object
	{
	public:
		::Il2CppArray<::System::Int32>* NPCMonsterMarkList; // 0x10
		::System::UInt32 SortID; // 0x18
