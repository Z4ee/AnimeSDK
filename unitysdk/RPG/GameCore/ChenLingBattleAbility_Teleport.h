...
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_TELEPORT_METHOD_3_C4F4A77FDAA48714_OFFSET UNITYSDK_OFFSET(0x1707BA50)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_TELEPORT_METHOD_3_F7CAB374E93B8F26_OFFSET UNITYSDK_OFFSET(0x1707BAB0)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_TELEPORT__CTOR_OFFSET UNITYSDK_OFFSET(0x1707BAA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleAbility_Teleport_TypeDefinitionIndex = 14426;
