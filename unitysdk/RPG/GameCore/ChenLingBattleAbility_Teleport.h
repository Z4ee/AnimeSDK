...
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_TELEPORT_METHOD_3_C4F4A77FDAA48714_OFFSET UNITYSDK_OFFSET(0x187E0540)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_TELEPORT_METHOD_3_F7CAB374E93B8F26_OFFSET UNITYSDK_OFFSET(0x187E05A0)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_TELEPORT__CTOR_OFFSET UNITYSDK_OFFSET(0x187E0590)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleAbility_Teleport_TypeDefinitionIndex = 14896;
