...
#define RPG_GAMECORE_SETSPECIALVISIONON_METHOD_3_068FEB0405989AD7_OFFSET UNITYSDK_OFFSET(0x176DEE10)
#define RPG_GAMECORE_SETSPECIALVISIONON_METHOD_3_7EAC39CBB429019F_OFFSET UNITYSDK_OFFSET(0x176DEED0)
#define RPG_GAMECORE_SETSPECIALVISIONON__CTOR_OFFSET UNITYSDK_OFFSET(0x176DEE80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetSpecialVisionOn_TypeDefinitionIndex = 18813;
