...
#define RPG_GAMECORE_B51RACINGTEAMROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CE5EBB0)
#define RPG_GAMECORE_B51RACINGTEAMROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE5EDB0)
