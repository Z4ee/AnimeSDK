...
#define RPG_GAMECORE_COMPLEXSKILLAILINEARITEM_METHOD_2_05405AD3DDA01CBF_OFFSET UNITYSDK_OFFSET(0x1966ADC0)
#define RPG_GAMECORE_COMPLEXSKILLAILINEARITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1966B050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAILinearItem_TypeDefinitionIndex = 14787;
