...
#define RPG_GAMECORE_COMPLEXSKILLAILINEARITEM_METHOD_2_05405AD3DDA01CBF_OFFSET UNITYSDK_OFFSET(0x1D9A9410)
#define RPG_GAMECORE_COMPLEXSKILLAILINEARITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D9A96A0)
