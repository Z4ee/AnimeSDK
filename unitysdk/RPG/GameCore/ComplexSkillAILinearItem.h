...
#define RPG_GAMECORE_COMPLEXSKILLAILINEARITEM_METHOD_2_05405AD3DDA01CBF_OFFSET UNITYSDK_OFFSET(0x1882A0E0)
#define RPG_GAMECORE_COMPLEXSKILLAILINEARITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1882A370)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAILinearItem_TypeDefinitionIndex = 14722;
