...
#define RPG_GAMECORE_TRAINPARTYGRIDMOVE_METHOD_3_6DADDCEA8662DE58_OFFSET UNITYSDK_OFFSET(0x190AACA0)
#define RPG_GAMECORE_TRAINPARTYGRIDMOVE_METHOD_3_A639B1AE5855A204_OFFSET UNITYSDK_OFFSET(0x190AADB0)
#define RPG_GAMECORE_TRAINPARTYGRIDMOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x190AAD80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyGridMove_TypeDefinitionIndex = 21242;
