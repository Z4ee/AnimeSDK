...
#define RPG_GAMECORE_SETCHARACTERVISIBLE_METHOD_3_579501D15629D45E_OFFSET UNITYSDK_OFFSET(0x176AF390)
#define RPG_GAMECORE_SETCHARACTERVISIBLE_METHOD_3_A381E1D33CA9B285_OFFSET UNITYSDK_OFFSET(0x176AF410)
#define RPG_GAMECORE_SETCHARACTERVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x176AF3E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetCharacterVisible_TypeDefinitionIndex = 18914;
