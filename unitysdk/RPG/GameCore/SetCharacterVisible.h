...
#define RPG_GAMECORE_SETCHARACTERVISIBLE_METHOD_3_881233AD71608F38_OFFSET UNITYSDK_OFFSET(0x1D4E8010)
#define RPG_GAMECORE_SETCHARACTERVISIBLE_METHOD_3_A381E1D33CA9B285_OFFSET UNITYSDK_OFFSET(0x1D4E8060)
#define RPG_GAMECORE_SETCHARACTERVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4E8050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetCharacterVisible_TypeDefinitionIndex = 20366;
