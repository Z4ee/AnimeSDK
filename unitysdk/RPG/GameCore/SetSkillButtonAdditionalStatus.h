...
#define RPG_GAMECORE_SETSKILLBUTTONADDITIONALSTATUS_METHOD_3_CEA490B1DD4C2143_OFFSET UNITYSDK_OFFSET(0x1C607830)
#define RPG_GAMECORE_SETSKILLBUTTONADDITIONALSTATUS_METHOD_3_FB889FDC6EDEE219_OFFSET UNITYSDK_OFFSET(0x1C6078D0)
#define RPG_GAMECORE_SETSKILLBUTTONADDITIONALSTATUS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C607890)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetSkillButtonAdditionalStatus_TypeDefinitionIndex = 22805;
