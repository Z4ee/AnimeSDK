...
#define RPG_GAMECORE_SETSKILLBUTTONADDITIONALSTATUS_METHOD_3_E78560D1BB79999F_OFFSET UNITYSDK_OFFSET(0x176DDB10)
#define RPG_GAMECORE_SETSKILLBUTTONADDITIONALSTATUS_METHOD_3_FB889FDC6EDEE219_OFFSET UNITYSDK_OFFSET(0x176DDBE0)
#define RPG_GAMECORE_SETSKILLBUTTONADDITIONALSTATUS__CTOR_OFFSET UNITYSDK_OFFSET(0x176DDB90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetSkillButtonAdditionalStatus_TypeDefinitionIndex = 21905;
