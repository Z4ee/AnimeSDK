...
#define RPG_GAMECORE_DEVPLAYPERFORMANCEE_METHOD_3_24DBE72B92445B53_OFFSET UNITYSDK_OFFSET(0x1885C9C0)
#define RPG_GAMECORE_DEVPLAYPERFORMANCEE_METHOD_3_7ACA2B245D4055A0_OFFSET UNITYSDK_OFFSET(0x1885C940)
#define RPG_GAMECORE_DEVPLAYPERFORMANCEE__CTOR_OFFSET UNITYSDK_OFFSET(0x1885C990)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DevPlayPerformanceE_TypeDefinitionIndex = 20110;
