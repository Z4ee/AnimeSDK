...
#define RPG_GAMECORE_SUBMISSIONMULTIFINISHPARAMCONFIG_METHOD_2_AA6A8D776036E9E5_OFFSET UNITYSDK_OFFSET(0x1778A2B0)
#define RPG_GAMECORE_SUBMISSIONMULTIFINISHPARAMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1778A2F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SubMissionMultiFinishParamConfig_TypeDefinitionIndex = 17433;
