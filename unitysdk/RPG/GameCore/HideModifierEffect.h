...
#define RPG_GAMECORE_HIDEMODIFIEREFFECT_METHOD_3_42EFA32977E5E624_OFFSET UNITYSDK_OFFSET(0x172AA530)
#define RPG_GAMECORE_HIDEMODIFIEREFFECT_METHOD_3_A9DD9D6D0E821409_OFFSET UNITYSDK_OFFSET(0x172AA5B0)
#define RPG_GAMECORE_HIDEMODIFIEREFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x172AA580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HideModifierEffect_TypeDefinitionIndex = 21876;
