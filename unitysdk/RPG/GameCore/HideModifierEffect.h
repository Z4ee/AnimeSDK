...
#define RPG_GAMECORE_HIDEMODIFIEREFFECT_METHOD_3_0DD433F4E8F8720C_OFFSET UNITYSDK_OFFSET(0x1D18DC40)
#define RPG_GAMECORE_HIDEMODIFIEREFFECT_METHOD_3_A9DD9D6D0E821409_OFFSET UNITYSDK_OFFSET(0x1D18DC90)
#define RPG_GAMECORE_HIDEMODIFIEREFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D18DC80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HideModifierEffect_TypeDefinitionIndex = 23361;
