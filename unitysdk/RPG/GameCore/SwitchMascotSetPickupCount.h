...
#define RPG_GAMECORE_SWITCHMASCOTSETPICKUPCOUNT_METHOD_3_F34F23710F3C41BE_OFFSET UNITYSDK_OFFSET(0x177974D0)
#define RPG_GAMECORE_SWITCHMASCOTSETPICKUPCOUNT_METHOD_3_FF66718892DE888F_OFFSET UNITYSDK_OFFSET(0x17797450)
#define RPG_GAMECORE_SWITCHMASCOTSETPICKUPCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x177974A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchMascotSetPickupCount_TypeDefinitionIndex = 20172;
