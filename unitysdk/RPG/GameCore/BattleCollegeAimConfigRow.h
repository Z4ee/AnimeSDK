...
#define RPG_GAMECORE_BATTLECOLLEGEAIMCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x186F0C40)
#define RPG_GAMECORE_BATTLECOLLEGEAIMCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x186F0E90)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID AimDesc; // 0x20
