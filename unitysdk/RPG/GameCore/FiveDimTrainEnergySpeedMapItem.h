...
#define RPG_GAMECORE_FIVEDIMTRAINENERGYSPEEDMAPITEM_METHOD_2_F8FA5C9D02BCAA09_OFFSET UNITYSDK_OFFSET(0x1DCA8840)
#define RPG_GAMECORE_FIVEDIMTRAINENERGYSPEEDMAPITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCA8950)
