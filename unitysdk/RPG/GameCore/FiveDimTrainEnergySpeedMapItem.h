...
#define RPG_GAMECORE_FIVEDIMTRAINENERGYSPEEDMAPITEM_METHOD_2_F8FA5C9D02BCAA09_OFFSET UNITYSDK_OFFSET(0x172104C0)
#define RPG_GAMECORE_FIVEDIMTRAINENERGYSPEEDMAPITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x172105D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimTrainEnergySpeedMapItem_TypeDefinitionIndex = 17003;
