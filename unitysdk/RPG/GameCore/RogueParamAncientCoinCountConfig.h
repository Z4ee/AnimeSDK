...
#define RPG_GAMECORE_ROGUEPARAMANCIENTCOINCOUNTCONFIG_METHOD_6_6A9F40ADC8EF3E01_OFFSET UNITYSDK_OFFSET(0x1E545570)
#define RPG_GAMECORE_ROGUEPARAMANCIENTCOINCOUNTCONFIG_METHOD_6_B577B7F7C9DFBB65_OFFSET UNITYSDK_OFFSET(0x1E5455C0)
#define RPG_GAMECORE_ROGUEPARAMANCIENTCOINCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1E5455B0)
