...
#define RPG_GAMECORE_SETMONSTERSTANCEBARSTYLE_METHOD_3_1D0558F10163742D_OFFSET UNITYSDK_OFFSET(0x18E3BB20)
#define RPG_GAMECORE_SETMONSTERSTANCEBARSTYLE_METHOD_3_9A75D13F99772FDA_OFFSET UNITYSDK_OFFSET(0x18E3BBA0)
#define RPG_GAMECORE_SETMONSTERSTANCEBARSTYLE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E3BB70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetMonsterStanceBarStyle_TypeDefinitionIndex = 21860;

	class SetMonsterStanceBarStyle : public ::RPG::GameCore::TaskConfig
	{
	public:
		::RPG::GameCore::TargetEvaluator* TargetType; // 0x18
		::RPG::GameCore::MonsterStanceBarStyle Style; // 0x20
		...
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::SetMonsterStanceBarStyle*))((::PBYTE)hIl2Cpp + RPG_GAMECORE_SETMONSTERSTANCEBARSTYLE_METHOD_3_9A75D13F99772FDA_OFFSET))(a1, a2);
		}
	};
}
