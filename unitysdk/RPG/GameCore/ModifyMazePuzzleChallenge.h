...
#define RPG_GAMECORE_MODIFYMAZEPUZZLECHALLENGE_METHOD_3_36AEFAC3D94EA577_OFFSET UNITYSDK_OFFSET(0x19956FF0)
#define RPG_GAMECORE_MODIFYMAZEPUZZLECHALLENGE_METHOD_3_EEA6BF9E850632D8_OFFSET UNITYSDK_OFFSET(0x19957070)
#define RPG_GAMECORE_MODIFYMAZEPUZZLECHALLENGE__CTOR_OFFSET UNITYSDK_OFFSET(0x19957040)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyMazePuzzleChallenge_TypeDefinitionIndex = 20790;
