...
#define RPG_GAMECORE_MODIFYMAZEPUZZLECHALLENGE_METHOD_3_48BC77A311E2788D_OFFSET UNITYSDK_OFFSET(0x1D2B62A0)
#define RPG_GAMECORE_MODIFYMAZEPUZZLECHALLENGE_METHOD_3_EEA6BF9E850632D8_OFFSET UNITYSDK_OFFSET(0x1D2B62E0)
#define RPG_GAMECORE_MODIFYMAZEPUZZLECHALLENGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2B62D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyMazePuzzleChallenge_TypeDefinitionIndex = 21765;
