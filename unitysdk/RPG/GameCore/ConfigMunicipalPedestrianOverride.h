...
#define RPG_GAMECORE_CONFIGMUNICIPALPEDESTRIANOVERRIDE_METHOD_2_4F8222307DDAA8C5_OFFSET UNITYSDK_OFFSET(0x188348A0)
#define RPG_GAMECORE_CONFIGMUNICIPALPEDESTRIANOVERRIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x18834A00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConfigMunicipalPedestrianOverride_TypeDefinitionIndex = 16007;
