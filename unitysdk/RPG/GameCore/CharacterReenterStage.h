...
#define RPG_GAMECORE_CHARACTERREENTERSTAGE_METHOD_3_22FB3995B9507E01_OFFSET UNITYSDK_OFFSET(0x187D67A0)
#define RPG_GAMECORE_CHARACTERREENTERSTAGE_METHOD_3_BC59F9378146E1AE_OFFSET UNITYSDK_OFFSET(0x187D6820)
#define RPG_GAMECORE_CHARACTERREENTERSTAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x187D67F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterReenterStage_TypeDefinitionIndex = 21652;
