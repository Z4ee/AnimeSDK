...
#define RPG_GAMECORE_DAMAGEPERFORMFINISHONSCEPTER_METHOD_4_18A33010630CCE5B_OFFSET UNITYSDK_OFFSET(0x1968E870)
#define RPG_GAMECORE_DAMAGEPERFORMFINISHONSCEPTER_METHOD_4_406B041D4C16506A_OFFSET UNITYSDK_OFFSET(0x1968E6D0)
#define RPG_GAMECORE_DAMAGEPERFORMFINISHONSCEPTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1968E6A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DamagePerformFinishOnScepter_TypeDefinitionIndex = 21847;
