...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYTITANBLESSSELECTNUMCONFIG_METHOD_3_398F6A9ED839D529_OFFSET UNITYSDK_OFFSET(0x1D164A10)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYTITANBLESSSELECTNUMCONFIG_METHOD_3_617B0432122A2EA5_OFFSET UNITYSDK_OFFSET(0x1D1649C0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYTITANBLESSSELECTNUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D164A00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyTitanBlessSelectNumConfig_TypeDefinitionIndex = 17032;
