...
#define RPG_GAMECORE_ADVENTUREBYINMOTIONSTATE_METHOD_4_0B0B4539AC3ADA4D_OFFSET UNITYSDK_OFFSET(0x16F4C620)
#define RPG_GAMECORE_ADVENTUREBYINMOTIONSTATE_METHOD_4_E5DD4CADB67F3363_OFFSET UNITYSDK_OFFSET(0x16F4C6F0)
#define RPG_GAMECORE_ADVENTUREBYINMOTIONSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F4C6A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureByInMotionState_TypeDefinitionIndex = 18509;
