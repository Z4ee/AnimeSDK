...
#define RPG_GAMECORE_CHIMERAPOSTSOUNDEVENT_METHOD_3_AA8A67339D6E1C38_OFFSET UNITYSDK_OFFSET(0x170AA430)
#define RPG_GAMECORE_CHIMERAPOSTSOUNDEVENT_METHOD_3_F48DA061EB0119F8_OFFSET UNITYSDK_OFFSET(0x170AA3D0)
#define RPG_GAMECORE_CHIMERAPOSTSOUNDEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x170AA420)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraPostSoundEvent_TypeDefinitionIndex = 14557;
