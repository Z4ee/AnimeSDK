...
#define RPG_GAMECORE_CHIMERAPOSTSOUNDEVENT_METHOD_3_AA8A67339D6E1C38_OFFSET UNITYSDK_OFFSET(0x188099E0)
#define RPG_GAMECORE_CHIMERAPOSTSOUNDEVENT_METHOD_3_F48DA061EB0119F8_OFFSET UNITYSDK_OFFSET(0x18809980)
#define RPG_GAMECORE_CHIMERAPOSTSOUNDEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x188099D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraPostSoundEvent_TypeDefinitionIndex = 15027;
