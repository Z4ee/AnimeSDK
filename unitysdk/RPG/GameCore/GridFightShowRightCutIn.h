...
#define RPG_GAMECORE_GRIDFIGHTSHOWRIGHTCUTIN_METHOD_3_191083B57327F901_OFFSET UNITYSDK_OFFSET(0x17283B30)
#define RPG_GAMECORE_GRIDFIGHTSHOWRIGHTCUTIN_METHOD_3_F68FCB8E0A81DCDB_OFFSET UNITYSDK_OFFSET(0x17283AB0)
#define RPG_GAMECORE_GRIDFIGHTSHOWRIGHTCUTIN__CTOR_OFFSET UNITYSDK_OFFSET(0x17283B00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightShowRightCutIn_TypeDefinitionIndex = 21460;
