...
#define RPG_GAMECORE_ADDENTITYTORELATIONGROUP_METHOD_3_148745B4066CE2B5_OFFSET UNITYSDK_OFFSET(0x1BE051E0)
#define RPG_GAMECORE_ADDENTITYTORELATIONGROUP_METHOD_3_72C3ECB9A5533770_OFFSET UNITYSDK_OFFSET(0x1BE051A0)
#define RPG_GAMECORE_ADDENTITYTORELATIONGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE051D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddEntityToRelationGroup_TypeDefinitionIndex = 22006;
