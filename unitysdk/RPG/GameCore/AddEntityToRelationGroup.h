...
#define RPG_GAMECORE_ADDENTITYTORELATIONGROUP_METHOD_3_148745B4066CE2B5_OFFSET UNITYSDK_OFFSET(0x1940CBD0)
#define RPG_GAMECORE_ADDENTITYTORELATIONGROUP_METHOD_3_2624F0AA5E2A96C0_OFFSET UNITYSDK_OFFSET(0x1940CB50)
#define RPG_GAMECORE_ADDENTITYTORELATIONGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1940CBA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddEntityToRelationGroup_TypeDefinitionIndex = 21584;
