...
#define RPG_GAMECORE_WAITUICONTROLLERCLOSE_METHOD_3_7A77FA56466DECAC_OFFSET UNITYSDK_OFFSET(0x1D6AF450)
#define RPG_GAMECORE_WAITUICONTROLLERCLOSE_METHOD_3_F7C8B9A810480DE7_OFFSET UNITYSDK_OFFSET(0x1D6AF490)
#define RPG_GAMECORE_WAITUICONTROLLERCLOSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6AF480)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitUIControllerClose_TypeDefinitionIndex = 20930;
