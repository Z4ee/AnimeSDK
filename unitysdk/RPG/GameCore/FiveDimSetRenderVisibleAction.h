...
#define RPG_GAMECORE_FIVEDIMSETRENDERVISIBLEACTION_METHOD_3_230D09733F3979D5_OFFSET UNITYSDK_OFFSET(0x1720AC60)
#define RPG_GAMECORE_FIVEDIMSETRENDERVISIBLEACTION_METHOD_3_C2AC525044D3D477_OFFSET UNITYSDK_OFFSET(0x1720ABF0)
#define RPG_GAMECORE_FIVEDIMSETRENDERVISIBLEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1720AC40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSetRenderVisibleAction_TypeDefinitionIndex = 17146;
