...
#define RPG_GAMECORE_TRIGGERENTERSAFEUI_METHOD_3_6598FE21E0756C17_OFFSET UNITYSDK_OFFSET(0x190C5200)
#define RPG_GAMECORE_TRIGGERENTERSAFEUI_METHOD_3_8240D7D95B22E866_OFFSET UNITYSDK_OFFSET(0x190C5180)
#define RPG_GAMECORE_TRIGGERENTERSAFEUI__CTOR_OFFSET UNITYSDK_OFFSET(0x190C51D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerEnterSafeUI_TypeDefinitionIndex = 20944;
