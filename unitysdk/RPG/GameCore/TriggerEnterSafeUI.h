...
#define RPG_GAMECORE_TRIGGERENTERSAFEUI_METHOD_3_6598FE21E0756C17_OFFSET UNITYSDK_OFFSET(0x1B055790)
#define RPG_GAMECORE_TRIGGERENTERSAFEUI_METHOD_3_D9C80BF7D247935C_OFFSET UNITYSDK_OFFSET(0x1B055740)
#define RPG_GAMECORE_TRIGGERENTERSAFEUI__CTOR_OFFSET UNITYSDK_OFFSET(0x1B055780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerEnterSafeUI_TypeDefinitionIndex = 21272;
