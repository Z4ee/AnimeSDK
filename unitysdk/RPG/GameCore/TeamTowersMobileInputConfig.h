...
#define RPG_GAMECORE_TEAMTOWERSMOBILEINPUTCONFIG_METHOD_2_8F824FB4FB352647_OFFSET UNITYSDK_OFFSET(0x1D5C5680)
#define RPG_GAMECORE_TEAMTOWERSMOBILEINPUTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5C64F0)
