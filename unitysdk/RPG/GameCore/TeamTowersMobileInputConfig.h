...
#define RPG_GAMECORE_TEAMTOWERSMOBILEINPUTCONFIG_METHOD_2_8F824FB4FB352647_OFFSET UNITYSDK_OFFSET(0x1C148290)
#define RPG_GAMECORE_TEAMTOWERSMOBILEINPUTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C149100)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TeamTowersMobileInputConfig_TypeDefinitionIndex = 18197;
