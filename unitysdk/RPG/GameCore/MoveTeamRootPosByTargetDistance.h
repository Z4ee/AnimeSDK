...
#define RPG_GAMECORE_MOVETEAMROOTPOSBYTARGETDISTANCE_METHOD_3_3F35EEB83E42320D_OFFSET UNITYSDK_OFFSET(0x18B64BA0)
#define RPG_GAMECORE_MOVETEAMROOTPOSBYTARGETDISTANCE_METHOD_3_79CE1D2F7C66B332_OFFSET UNITYSDK_OFFSET(0x18B64B20)
#define RPG_GAMECORE_MOVETEAMROOTPOSBYTARGETDISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x18B64B70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MoveTeamRootPosByTargetDistance_TypeDefinitionIndex = 21524;
