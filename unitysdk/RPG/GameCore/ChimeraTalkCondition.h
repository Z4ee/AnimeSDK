...
#define RPG_GAMECORE_CHIMERATALKCONDITION_METHOD_2_A27D255D892C69D6_OFFSET UNITYSDK_OFFSET(0x1964BA70)
#define RPG_GAMECORE_CHIMERATALKCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1964BBC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraTalkCondition_TypeDefinitionIndex = 15078;
