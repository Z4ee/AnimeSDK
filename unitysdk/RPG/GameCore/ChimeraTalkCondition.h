...
#define RPG_GAMECORE_CHIMERATALKCONDITION_METHOD_2_A27D255D892C69D6_OFFSET UNITYSDK_OFFSET(0x1C24C920)
#define RPG_GAMECORE_CHIMERATALKCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C24CA70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraTalkCondition_TypeDefinitionIndex = 15242;
