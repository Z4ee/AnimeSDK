...
#define RPG_GAMECORE_DAILYACTIVECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D0117E0)
#define RPG_GAMECORE_DAILYACTIVECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D011E10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DailyActiveConfigRow_TypeDefinitionIndex = 13007;

	class DailyActiveConfigRow : public ::System::Object
	{
	public:
		::System::UInt32 DailyActivePoint; // 0x10
		::System::UInt32 DailyActiveReward; // 0x14
