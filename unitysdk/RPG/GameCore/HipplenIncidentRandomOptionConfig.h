...
#define RPG_GAMECORE_HIPPLENINCIDENTRANDOMOPTIONCONFIG_METHOD_3_0EEAD21C6FF35882_OFFSET UNITYSDK_OFFSET(0x1D2034A0)
#define RPG_GAMECORE_HIPPLENINCIDENTRANDOMOPTIONCONFIG_METHOD_3_CC5447A2C10649B0_OFFSET UNITYSDK_OFFSET(0x1D203850)
#define RPG_GAMECORE_HIPPLENINCIDENTRANDOMOPTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D203490)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HipplenIncidentRandomOptionConfig_TypeDefinitionIndex = 16635;
