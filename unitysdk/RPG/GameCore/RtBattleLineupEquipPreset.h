...
#define RPG_GAMECORE_RTBATTLELINEUPEQUIPPRESET_METHOD_2_801A160A54802B02_OFFSET UNITYSDK_OFFSET(0x18DC52C0)
#define RPG_GAMECORE_RTBATTLELINEUPEQUIPPRESET__CTOR_OFFSET UNITYSDK_OFFSET(0x18DC5300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtBattleLineupEquipPreset_TypeDefinitionIndex = 17146;
