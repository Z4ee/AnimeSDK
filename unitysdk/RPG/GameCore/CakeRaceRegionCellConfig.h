...
#define RPG_GAMECORE_CAKERACEREGIONCELLCONFIG_METHOD_2_9C8159AEF5471D24_OFFSET UNITYSDK_OFFSET(0x1B7058A0)
#define RPG_GAMECORE_CAKERACEREGIONCELLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B705AF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceRegionCellConfig_TypeDefinitionIndex = 17686;
