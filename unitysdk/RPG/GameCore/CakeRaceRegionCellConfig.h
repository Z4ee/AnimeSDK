...
#define RPG_GAMECORE_CAKERACEREGIONCELLCONFIG_METHOD_2_B5EA125EFB72256B_OFFSET UNITYSDK_OFFSET(0x1704EC70)
#define RPG_GAMECORE_CAKERACEREGIONCELLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1704EEC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceRegionCellConfig_TypeDefinitionIndex = 16919;
