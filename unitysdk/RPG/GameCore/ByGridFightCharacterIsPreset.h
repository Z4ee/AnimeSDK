...
#define RPG_GAMECORE_BYGRIDFIGHTCHARACTERISPRESET_METHOD_4_6927661C05269674_OFFSET UNITYSDK_OFFSET(0x18746CE0)
#define RPG_GAMECORE_BYGRIDFIGHTCHARACTERISPRESET_METHOD_4_79B4D91A77954336_OFFSET UNITYSDK_OFFSET(0x18746DB0)
#define RPG_GAMECORE_BYGRIDFIGHTCHARACTERISPRESET__CTOR_OFFSET UNITYSDK_OFFSET(0x18746D60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByGridFightCharacterIsPreset_TypeDefinitionIndex = 21405;
