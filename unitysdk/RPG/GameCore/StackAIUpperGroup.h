...
#define RPG_GAMECORE_STACKAIUPPERGROUP_METHOD_3_3A0B447AEBA0AFFF_OFFSET UNITYSDK_OFFSET(0x177606C0)
#define RPG_GAMECORE_STACKAIUPPERGROUP_METHOD_3_A3E141CDEEADBA8B_OFFSET UNITYSDK_OFFSET(0x17760760)
#define RPG_GAMECORE_STACKAIUPPERGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x17760720)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StackAIUpperGroup_TypeDefinitionIndex = 21969;
