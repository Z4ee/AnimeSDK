...
#define RPG_GAMECORE_STACKAIUPPERGROUP_METHOD_3_A3E141CDEEADBA8B_OFFSET UNITYSDK_OFFSET(0x1D0B7B30)
#define RPG_GAMECORE_STACKAIUPPERGROUP_METHOD_3_C9DDD3CEED448644_OFFSET UNITYSDK_OFFSET(0x1D0B7AE0)
#define RPG_GAMECORE_STACKAIUPPERGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0B7B20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StackAIUpperGroup_TypeDefinitionIndex = 23444;
