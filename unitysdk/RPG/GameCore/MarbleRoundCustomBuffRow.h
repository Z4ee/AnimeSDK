...
#define RPG_GAMECORE_MARBLEROUNDCUSTOMBUFFROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x198D8030)
#define RPG_GAMECORE_MARBLEROUNDCUSTOMBUFFROW__CTOR_OFFSET UNITYSDK_OFFSET(0x198D81F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleRoundCustomBuffRow_TypeDefinitionIndex = 11378;
	...
	public:
		...
		::System::UInt32 EnemySelectBuff; // 0x1C
