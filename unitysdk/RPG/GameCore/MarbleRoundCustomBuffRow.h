...
#define RPG_GAMECORE_MARBLEROUNDCUSTOMBUFFROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1BD203E0)
#define RPG_GAMECORE_MARBLEROUNDCUSTOMBUFFROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD205A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleRoundCustomBuffRow_TypeDefinitionIndex = 11478;
