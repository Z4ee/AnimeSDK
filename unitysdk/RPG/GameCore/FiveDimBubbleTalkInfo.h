...
#define RPG_GAMECORE_FIVEDIMBUBBLETALKINFO_METHOD_3_E0E0277B42C1F00B_OFFSET UNITYSDK_OFFSET(0x171EB2C0)
#define RPG_GAMECORE_FIVEDIMBUBBLETALKINFO_METHOD_3_E709C00EA31437F6_OFFSET UNITYSDK_OFFSET(0x171DC1B0)
#define RPG_GAMECORE_FIVEDIMBUBBLETALKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x171DC1A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimBubbleTalkInfo_TypeDefinitionIndex = 19687;
