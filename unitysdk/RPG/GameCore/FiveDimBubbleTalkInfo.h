...
#define RPG_GAMECORE_FIVEDIMBUBBLETALKINFO_METHOD_3_E0E0277B42C1F00B_OFFSET UNITYSDK_OFFSET(0x188F8D90)
#define RPG_GAMECORE_FIVEDIMBUBBLETALKINFO_METHOD_3_E709C00EA31437F6_OFFSET UNITYSDK_OFFSET(0x188E99F0)
#define RPG_GAMECORE_FIVEDIMBUBBLETALKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x188E99E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimBubbleTalkInfo_TypeDefinitionIndex = 20368;
