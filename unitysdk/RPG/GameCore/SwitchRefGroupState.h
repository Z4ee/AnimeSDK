...
#define RPG_GAMECORE_SWITCHREFGROUPSTATE_METHOD_3_8465BD37F16DAE44_OFFSET UNITYSDK_OFFSET(0x1B43AC60)
#define RPG_GAMECORE_SWITCHREFGROUPSTATE_METHOD_3_ED2F251C511A1919_OFFSET UNITYSDK_OFFSET(0x1B43A5A0)
#define RPG_GAMECORE_SWITCHREFGROUPSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B43A590)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchRefGroupState_TypeDefinitionIndex = 16828;
