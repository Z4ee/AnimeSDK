...
#define RPG_GAMECORE_CHANGETRACKVIRTUALCAMERAFOLLOWANDAIM_METHOD_3_6EDE58E399C859A8_OFFSET UNITYSDK_OFFSET(0x187C9A00)
#define RPG_GAMECORE_CHANGETRACKVIRTUALCAMERAFOLLOWANDAIM_METHOD_3_EC95CAC945449637_OFFSET UNITYSDK_OFFSET(0x187C9980)
#define RPG_GAMECORE_CHANGETRACKVIRTUALCAMERAFOLLOWANDAIM__CTOR_OFFSET UNITYSDK_OFFSET(0x187C99D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChangeTrackVirtualCameraFollowAndAim_TypeDefinitionIndex = 20541;
