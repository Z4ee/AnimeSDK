...
#define RPG_GAMECORE_OPENHIPPLENGROWTHPAGE_METHOD_3_765A4697A50A8711_OFFSET UNITYSDK_OFFSET(0x18BC5640)
#define RPG_GAMECORE_OPENHIPPLENGROWTHPAGE_METHOD_3_C310821A421FF865_OFFSET UNITYSDK_OFFSET(0x18BC5750)
#define RPG_GAMECORE_OPENHIPPLENGROWTHPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x18BC5720)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OpenHipplenGrowthPage_TypeDefinitionIndex = 20293;
