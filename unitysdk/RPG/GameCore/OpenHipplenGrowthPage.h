...
#define RPG_GAMECORE_OPENHIPPLENGROWTHPAGE_METHOD_3_765A4697A50A8711_OFFSET UNITYSDK_OFFSET(0x1747C0A0)
#define RPG_GAMECORE_OPENHIPPLENGROWTHPAGE_METHOD_3_C310821A421FF865_OFFSET UNITYSDK_OFFSET(0x1747C1B0)
#define RPG_GAMECORE_OPENHIPPLENGROWTHPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1747C180)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OpenHipplenGrowthPage_TypeDefinitionIndex = 19613;
