...
#define RPG_GAMECORE_ADVNPCFOLLOWBYPLAYER_METHOD_3_70CBE5CCC5CCBC96_OFFSET UNITYSDK_OFFSET(0x1BE24120)
#define RPG_GAMECORE_ADVNPCFOLLOWBYPLAYER_METHOD_3_C7B5B534B7050CAF_OFFSET UNITYSDK_OFFSET(0x1BE24180)
#define RPG_GAMECORE_ADVNPCFOLLOWBYPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE24160)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvNpcFollowByPlayer_TypeDefinitionIndex = 19214;
