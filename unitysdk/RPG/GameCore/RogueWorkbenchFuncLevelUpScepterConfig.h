...
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCLEVELUPSCEPTERCONFIG_METHOD_3_7F8A81E32D42FAA3_OFFSET UNITYSDK_OFFSET(0x19BD4550)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCLEVELUPSCEPTERCONFIG_METHOD_3_A4CB667F92B9F127_OFFSET UNITYSDK_OFFSET(0x19BD4310)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCLEVELUPSCEPTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19BD4300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueWorkbenchFuncLevelUpScepterConfig_TypeDefinitionIndex = 17143;
