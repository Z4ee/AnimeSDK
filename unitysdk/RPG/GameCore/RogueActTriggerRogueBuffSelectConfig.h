...
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEBUFFSELECTCONFIG_METHOD_6_313C38EAF7CF2252_OFFSET UNITYSDK_OFFSET(0x175CB090)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEBUFFSELECTCONFIG_METHOD_6_FC4016487845EEB7_OFFSET UNITYSDK_OFFSET(0x175CB2B0)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEBUFFSELECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175CB1D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActTriggerRogueBuffSelectConfig_TypeDefinitionIndex = 17941;
