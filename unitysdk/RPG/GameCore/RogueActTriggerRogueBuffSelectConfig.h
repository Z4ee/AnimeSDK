...
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEBUFFSELECTCONFIG_METHOD_6_313C38EAF7CF2252_OFFSET UNITYSDK_OFFSET(0x19AFB2E0)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEBUFFSELECTCONFIG_METHOD_6_FC4016487845EEB7_OFFSET UNITYSDK_OFFSET(0x19AFB500)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEBUFFSELECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AFB420)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActTriggerRogueBuffSelectConfig_TypeDefinitionIndex = 18553;
