...
#define RPG_GAMECORE_SDKENVCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18E00DB0)
#define RPG_GAMECORE_SDKENVCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18E00FD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SdkEnvConfig_TypeDefinitionIndex = 18061;
