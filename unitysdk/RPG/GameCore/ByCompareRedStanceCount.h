...
#define RPG_GAMECORE_BYCOMPAREREDSTANCECOUNT_METHOD_4_29D1F5F8ABB6C806_OFFSET UNITYSDK_OFFSET(0x1BBB4A30)
#define RPG_GAMECORE_BYCOMPAREREDSTANCECOUNT_METHOD_4_79DC4D46E4024E30_OFFSET UNITYSDK_OFFSET(0x1BBB4A60)
#define RPG_GAMECORE_BYCOMPAREREDSTANCECOUNT_METHOD_4_BB65EB8857FB3B13_OFFSET UNITYSDK_OFFSET(0x1BBB47C0)
#define RPG_GAMECORE_BYCOMPAREREDSTANCECOUNT_METHOD_4_CADE00AC07AB4576_OFFSET UNITYSDK_OFFSET(0x1BBB4800)
#define RPG_GAMECORE_BYCOMPAREREDSTANCECOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBB47F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareRedStanceCount_TypeDefinitionIndex = 23223;
