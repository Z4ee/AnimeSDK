...
#define RPG_GAMECORE_TARGETFETCHLASTKILLTARGET_METHOD_4_68AC57714A38FDF3_OFFSET UNITYSDK_OFFSET(0x177B5D70)
#define RPG_GAMECORE_TARGETFETCHLASTKILLTARGET_METHOD_4_B4568B8EA59C1FE5_OFFSET UNITYSDK_OFFSET(0x177BEE00)
#define RPG_GAMECORE_TARGETFETCHLASTKILLTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x177B5D20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchLastKillTarget_TypeDefinitionIndex = 22279;
