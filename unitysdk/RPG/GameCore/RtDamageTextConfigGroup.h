...
#define RPG_GAMECORE_RTDAMAGETEXTCONFIGGROUP_METHOD_2_16A8D0100BE6A128_OFFSET UNITYSDK_OFFSET(0x19BE7040)
#define RPG_GAMECORE_RTDAMAGETEXTCONFIGGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x19BE7150)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtDamageTextConfigGroup_TypeDefinitionIndex = 17154;
