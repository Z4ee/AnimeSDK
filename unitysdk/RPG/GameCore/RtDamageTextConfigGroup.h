...
#define RPG_GAMECORE_RTDAMAGETEXTCONFIGGROUP_METHOD_2_16A8D0100BE6A128_OFFSET UNITYSDK_OFFSET(0x18DCD6F0)
#define RPG_GAMECORE_RTDAMAGETEXTCONFIGGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x18DCD800)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtDamageTextConfigGroup_TypeDefinitionIndex = 17144;
