...
#define RPG_GAMECORE_PASSENGERBEHAVIORCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1748C290)
#define RPG_GAMECORE_PASSENGERBEHAVIORCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1748C4A0)
