...
#define RPG_GAMECORE_FIVEDIMSTOPDANMUACTION_METHOD_3_A5751B0289604B6E_OFFSET UNITYSDK_OFFSET(0x189205C0)
#define RPG_GAMECORE_FIVEDIMSTOPDANMUACTION_METHOD_3_E1A69862B663841A_OFFSET UNITYSDK_OFFSET(0x189206C0)
#define RPG_GAMECORE_FIVEDIMSTOPDANMUACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x189206A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimStopDanmuAction_TypeDefinitionIndex = 17770;
