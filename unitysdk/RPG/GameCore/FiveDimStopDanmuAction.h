...
#define RPG_GAMECORE_FIVEDIMSTOPDANMUACTION_METHOD_3_4F4FCF85FA499A77_OFFSET UNITYSDK_OFFSET(0x1D105450)
#define RPG_GAMECORE_FIVEDIMSTOPDANMUACTION_METHOD_3_E1A69862B663841A_OFFSET UNITYSDK_OFFSET(0x1D105510)
#define RPG_GAMECORE_FIVEDIMSTOPDANMUACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D105500)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimStopDanmuAction_TypeDefinitionIndex = 18494;
