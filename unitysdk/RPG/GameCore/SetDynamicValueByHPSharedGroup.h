...
#define RPG_GAMECORE_SETDYNAMICVALUEBYHPSHAREDGROUP_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x18E228C0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYHPSHAREDGROUP_METHOD_4_59071DADB7721540_OFFSET UNITYSDK_OFFSET(0x18E225D0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYHPSHAREDGROUP_METHOD_4_E703BA93BF8D05D4_OFFSET UNITYSDK_OFFSET(0x18E226A0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYHPSHAREDGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x18E22650)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByHPSharedGroup_TypeDefinitionIndex = 22576;
