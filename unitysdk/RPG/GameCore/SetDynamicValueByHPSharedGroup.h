...
#define RPG_GAMECORE_SETDYNAMICVALUEBYHPSHAREDGROUP_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1C2E3880)
#define RPG_GAMECORE_SETDYNAMICVALUEBYHPSHAREDGROUP_METHOD_4_31B15A916E5D6BE9_OFFSET UNITYSDK_OFFSET(0x1C2E3620)
#define RPG_GAMECORE_SETDYNAMICVALUEBYHPSHAREDGROUP_METHOD_4_E703BA93BF8D05D4_OFFSET UNITYSDK_OFFSET(0x1C2E3660)
#define RPG_GAMECORE_SETDYNAMICVALUEBYHPSHAREDGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2E3650)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByHPSharedGroup_TypeDefinitionIndex = 22751;
