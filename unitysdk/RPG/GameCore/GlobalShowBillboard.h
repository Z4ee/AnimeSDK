...
#define RPG_GAMECORE_GLOBALSHOWBILLBOARD_METHOD_3_48D2A9D9888C9BF7_OFFSET UNITYSDK_OFFSET(0x18998770)
#define RPG_GAMECORE_GLOBALSHOWBILLBOARD_METHOD_3_6276077FDAC2A346_OFFSET UNITYSDK_OFFSET(0x189986F0)
#define RPG_GAMECORE_GLOBALSHOWBILLBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x18998740)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GlobalShowBillboard_TypeDefinitionIndex = 19419;
