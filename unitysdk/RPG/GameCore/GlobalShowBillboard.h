...
#define RPG_GAMECORE_GLOBALSHOWBILLBOARD_METHOD_3_48D2A9D9888C9BF7_OFFSET UNITYSDK_OFFSET(0x1D1456C0)
#define RPG_GAMECORE_GLOBALSHOWBILLBOARD_METHOD_3_C32D990F154127BC_OFFSET UNITYSDK_OFFSET(0x1D145680)
#define RPG_GAMECORE_GLOBALSHOWBILLBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1456B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GlobalShowBillboard_TypeDefinitionIndex = 20226;
