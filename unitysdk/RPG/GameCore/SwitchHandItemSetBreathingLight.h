...
#define RPG_GAMECORE_SWITCHHANDITEMSETBREATHINGLIGHT_METHOD_3_887F475FC80EB305_OFFSET UNITYSDK_OFFSET(0x17794FE0)
#define RPG_GAMECORE_SWITCHHANDITEMSETBREATHINGLIGHT_METHOD_3_973169CDB544F910_OFFSET UNITYSDK_OFFSET(0x17794F60)
#define RPG_GAMECORE_SWITCHHANDITEMSETBREATHINGLIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x17794FB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchHandItemSetBreathingLight_TypeDefinitionIndex = 19301;
