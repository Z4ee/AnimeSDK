...
#define RPG_GAMECORE_SWITCHHANDITEMSETBREATHINGLIGHT_METHOD_3_3EA0C46619A63200_OFFSET UNITYSDK_OFFSET(0x1B436510)
#define RPG_GAMECORE_SWITCHHANDITEMSETBREATHINGLIGHT_METHOD_3_887F475FC80EB305_OFFSET UNITYSDK_OFFSET(0x1B436560)
#define RPG_GAMECORE_SWITCHHANDITEMSETBREATHINGLIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B436550)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchHandItemSetBreathingLight_TypeDefinitionIndex = 20183;
