...
#define RPG_GAMECORE_SWITCHHANDITEMSETBREATHINGLIGHT_METHOD_3_887F475FC80EB305_OFFSET UNITYSDK_OFFSET(0x19CDB060)
#define RPG_GAMECORE_SWITCHHANDITEMSETBREATHINGLIGHT_METHOD_3_973169CDB544F910_OFFSET UNITYSDK_OFFSET(0x19CDAFE0)
#define RPG_GAMECORE_SWITCHHANDITEMSETBREATHINGLIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x19CDB030)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchHandItemSetBreathingLight_TypeDefinitionIndex = 19823;
