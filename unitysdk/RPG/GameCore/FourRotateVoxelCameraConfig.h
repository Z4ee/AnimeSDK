...
#define RPG_GAMECORE_FOURROTATEVOXELCAMERACONFIG_METHOD_2_78CD1F0AA49FDD0A_OFFSET UNITYSDK_OFFSET(0x1DCB4A30)
#define RPG_GAMECORE_FOURROTATEVOXELCAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCB4B10)
