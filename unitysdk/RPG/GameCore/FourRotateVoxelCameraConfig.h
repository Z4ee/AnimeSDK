...
#define RPG_GAMECORE_FOURROTATEVOXELCAMERACONFIG_METHOD_2_78CD1F0AA49FDD0A_OFFSET UNITYSDK_OFFSET(0x1721AA50)
#define RPG_GAMECORE_FOURROTATEVOXELCAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1721AB30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FourRotateVoxelCameraConfig_TypeDefinitionIndex = 15337;
