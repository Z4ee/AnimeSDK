...
#define RPG_GAMECORE_SIMULATEAVATARLINEUPCONFIG_METHOD_2_56A038D000092C9B_OFFSET UNITYSDK_OFFSET(0x1D0A02C0)
#define RPG_GAMECORE_SIMULATEAVATARLINEUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0A0750)
