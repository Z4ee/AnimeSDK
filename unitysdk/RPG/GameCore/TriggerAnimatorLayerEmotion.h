...
#define RPG_GAMECORE_TRIGGERANIMATORLAYEREMOTION_METHOD_3_402AD514CD5729E0_OFFSET UNITYSDK_OFFSET(0x190BD870)
#define RPG_GAMECORE_TRIGGERANIMATORLAYEREMOTION_METHOD_3_5B6DDBEE8AA406B3_OFFSET UNITYSDK_OFFSET(0x190BD900)
#define RPG_GAMECORE_TRIGGERANIMATORLAYEREMOTION__CTOR_OFFSET UNITYSDK_OFFSET(0x190BD8D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerAnimatorLayerEmotion_TypeDefinitionIndex = 19565;
