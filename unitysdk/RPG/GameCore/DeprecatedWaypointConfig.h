...
#define RPG_GAMECORE_DEPRECATEDWAYPOINTCONFIG_METHOD_2_4ED160AEE5810492_OFFSET UNITYSDK_OFFSET(0x19699FA0)
#define RPG_GAMECORE_DEPRECATEDWAYPOINTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1969A0F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DeprecatedWaypointConfig_TypeDefinitionIndex = 16630;
