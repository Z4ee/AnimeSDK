...
#define RPG_GAMECORE_RESETCAMERAAXIS_METHOD_3_B56741E51E51439E_OFFSET UNITYSDK_OFFSET(0x18CA9F80)
#define RPG_GAMECORE_RESETCAMERAAXIS_METHOD_3_D9B7DF1E0EAEED0A_OFFSET UNITYSDK_OFFSET(0x18CAA090)
#define RPG_GAMECORE_RESETCAMERAAXIS__CTOR_OFFSET UNITYSDK_OFFSET(0x18CAA060)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetCameraAxis_TypeDefinitionIndex = 19222;
