...
#define RPG_GAMECORE_TOASTPILEIGNORE_METHOD_3_9E712F000A7714BA_OFFSET UNITYSDK_OFFSET(0x1909F810)
#define RPG_GAMECORE_TOASTPILEIGNORE_METHOD_3_A65C15B1B979C243_OFFSET UNITYSDK_OFFSET(0x1909F890)
#define RPG_GAMECORE_TOASTPILEIGNORE__CTOR_OFFSET UNITYSDK_OFFSET(0x1909F860)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ToastPileIgnore_TypeDefinitionIndex = 19245;
