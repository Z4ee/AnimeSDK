...
#define RPG_GAMECORE_ROGUEACTFINISHCHESSROGUECONFIG_METHOD_6_547FC5146A0C128D_OFFSET UNITYSDK_OFFSET(0x175B50C0)
#define RPG_GAMECORE_ROGUEACTFINISHCHESSROGUECONFIG_METHOD_6_70A5ED9B46227C70_OFFSET UNITYSDK_OFFSET(0x175B4EA0)
#define RPG_GAMECORE_ROGUEACTFINISHCHESSROGUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175B4FE0)
