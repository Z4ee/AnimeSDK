...
#define RPG_GAMECORE_ROGUEACTFINISHCHESSROGUECONFIG_METHOD_6_46A8EE3CAA033489_OFFSET UNITYSDK_OFFSET(0x1D3B73F0)
#define RPG_GAMECORE_ROGUEACTFINISHCHESSROGUECONFIG_METHOD_6_547FC5146A0C128D_OFFSET UNITYSDK_OFFSET(0x1D3B7440)
#define RPG_GAMECORE_ROGUEACTFINISHCHESSROGUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3B7430)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActFinishChessRogueConfig_TypeDefinitionIndex = 19408;
