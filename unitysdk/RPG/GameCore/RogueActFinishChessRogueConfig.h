...
#define RPG_GAMECORE_ROGUEACTFINISHCHESSROGUECONFIG_METHOD_6_547FC5146A0C128D_OFFSET UNITYSDK_OFFSET(0x18CC0E30)
#define RPG_GAMECORE_ROGUEACTFINISHCHESSROGUECONFIG_METHOD_6_70A5ED9B46227C70_OFFSET UNITYSDK_OFFSET(0x18CC0C10)
#define RPG_GAMECORE_ROGUEACTFINISHCHESSROGUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CC0D50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActFinishChessRogueConfig_TypeDefinitionIndex = 18638;
