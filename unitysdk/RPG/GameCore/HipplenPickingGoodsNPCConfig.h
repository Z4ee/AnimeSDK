...
#define RPG_GAMECORE_HIPPLENPICKINGGOODSNPCCONFIG_METHOD_2_29392310954A4D9A_OFFSET UNITYSDK_OFFSET(0x1D205270)
#define RPG_GAMECORE_HIPPLENPICKINGGOODSNPCCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2055C0)
