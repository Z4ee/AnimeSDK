...
#define RPG_GAMECORE_CAKERACEBOXCOLLIDERCONFIG_METHOD_3_2B2A142A9BB55F66_OFFSET UNITYSDK_OFFSET(0x17048CF0)
#define RPG_GAMECORE_CAKERACEBOXCOLLIDERCONFIG_METHOD_3_D86CAD8FAD12A99A_OFFSET UNITYSDK_OFFSET(0x17048C60)
#define RPG_GAMECORE_CAKERACEBOXCOLLIDERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17048CD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceBoxColliderConfig_TypeDefinitionIndex = 16923;
