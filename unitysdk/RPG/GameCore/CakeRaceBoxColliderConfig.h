...
#define RPG_GAMECORE_CAKERACEBOXCOLLIDERCONFIG_METHOD_3_2B2A142A9BB55F66_OFFSET UNITYSDK_OFFSET(0x1B2CE790)
#define RPG_GAMECORE_CAKERACEBOXCOLLIDERCONFIG_METHOD_3_80A2F5EAA3C80AC6_OFFSET UNITYSDK_OFFSET(0x1B2CE730)
#define RPG_GAMECORE_CAKERACEBOXCOLLIDERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2CE780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceBoxColliderConfig_TypeDefinitionIndex = 17689;
