...
#define RPG_GAMECORE_TUTORIALGUIDESHOWCONFIG_METHOD_2_33B10A66147B7E7A_OFFSET UNITYSDK_OFFSET(0x1D616DB0)
#define RPG_GAMECORE_TUTORIALGUIDESHOWCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D616FE0)
