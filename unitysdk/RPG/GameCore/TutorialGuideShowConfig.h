...
#define RPG_GAMECORE_TUTORIALGUIDESHOWCONFIG_METHOD_2_66F0C317C5EE65D5_OFFSET UNITYSDK_OFFSET(0x19E2B490)
#define RPG_GAMECORE_TUTORIALGUIDESHOWCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19E2B6A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TutorialGuideShowConfig_TypeDefinitionIndex = 22998;
