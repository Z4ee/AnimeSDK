...
#define RPG_GAMECORE_TUTORIALGUIDESHOWCONFIG_METHOD_2_66F0C317C5EE65D5_OFFSET UNITYSDK_OFFSET(0x1B06CDB0)
#define RPG_GAMECORE_TUTORIALGUIDESHOWCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B06CFC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TutorialGuideShowConfig_TypeDefinitionIndex = 23465;
