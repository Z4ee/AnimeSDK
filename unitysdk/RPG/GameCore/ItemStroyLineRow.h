...
#define RPG_GAMECORE_ITEMSTROYLINEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17325960)
#define RPG_GAMECORE_ITEMSTROYLINEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17325A80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ItemStroyLineRow_TypeDefinitionIndex = 12702;
