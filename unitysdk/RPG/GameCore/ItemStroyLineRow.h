...
#define RPG_GAMECORE_ITEMSTROYLINEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D232230)
#define RPG_GAMECORE_ITEMSTROYLINEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D232340)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ItemStroyLineRow_TypeDefinitionIndex = 13787;
