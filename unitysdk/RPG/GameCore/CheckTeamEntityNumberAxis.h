...
#define RPG_GAMECORE_CHECKTEAMENTITYNUMBERAXIS_METHOD_3_3DFD163CC6FBB79F_OFFSET UNITYSDK_OFFSET(0x1CFA23B0)
#define RPG_GAMECORE_CHECKTEAMENTITYNUMBERAXIS_METHOD_3_83D04FBD2A952056_OFFSET UNITYSDK_OFFSET(0x1CFA2400)
#define RPG_GAMECORE_CHECKTEAMENTITYNUMBERAXIS__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFA23F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CheckTeamEntityNumberAxis_TypeDefinitionIndex = 15338;
