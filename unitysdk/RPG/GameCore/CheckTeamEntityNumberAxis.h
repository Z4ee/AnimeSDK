...
#define RPG_GAMECORE_CHECKTEAMENTITYNUMBERAXIS_METHOD_3_3DFD163CC6FBB79F_OFFSET UNITYSDK_OFFSET(0x187DBCF0)
#define RPG_GAMECORE_CHECKTEAMENTITYNUMBERAXIS_METHOD_3_83D04FBD2A952056_OFFSET UNITYSDK_OFFSET(0x187DBD40)
#define RPG_GAMECORE_CHECKTEAMENTITYNUMBERAXIS__CTOR_OFFSET UNITYSDK_OFFSET(0x187DBD30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CheckTeamEntityNumberAxis_TypeDefinitionIndex = 14676;
