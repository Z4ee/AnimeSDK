...
#define RPG_GAMECORE_EVOLVEBUILDREWARDBOXRANDOMCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x196F9BF0)
#define RPG_GAMECORE_EVOLVEBUILDREWARDBOXRANDOMCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x196F9D30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EvolveBuildRewardBoxRandomConfigRow_TypeDefinitionIndex = 10997;
