...
#define RPG_GAMECORE_PLANETFESEFFECTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D79C2E0)
#define RPG_GAMECORE_PLANETFESEFFECTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D79C4C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlanetFesEffectRow_TypeDefinitionIndex = 12116;
	...
	public:
		...
		::RPG::GameCore::PlanetFesEffectType Type; // 0x20
		::System::UInt32 SourceID; // 0x24
