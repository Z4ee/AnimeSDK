...
#define RPG_GAMECORE_SINGLEHITBOXCONFIG_METHOD_2_4662BCFFDE95E7D9_OFFSET UNITYSDK_OFFSET(0x1D536820)
#define RPG_GAMECORE_SINGLEHITBOXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5369B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SingleHitBoxConfig_TypeDefinitionIndex = 20152;
