...
#define RPG_GAMECORE_SHOWTUTORIALGUIDETALKLISTDIALOG_METHOD_3_F0F5A94DA8503293_OFFSET UNITYSDK_OFFSET(0x18E69BE0)
#define RPG_GAMECORE_SHOWTUTORIALGUIDETALKLISTDIALOG_METHOD_3_F7561AB60963EB28_OFFSET UNITYSDK_OFFSET(0x18E69B60)
#define RPG_GAMECORE_SHOWTUTORIALGUIDETALKLISTDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x18E69BB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowTutorialGuideTalkListDialog_TypeDefinitionIndex = 23360;
