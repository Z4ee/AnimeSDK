...
#define RPG_GAMECORE_SHOWTUTORIALGUIDETALKLISTDIALOG_METHOD_3_D3F09E27CF3F2B88_OFFSET UNITYSDK_OFFSET(0x1D09C9D0)
#define RPG_GAMECORE_SHOWTUTORIALGUIDETALKLISTDIALOG_METHOD_3_F107A4BC29CE1451_OFFSET UNITYSDK_OFFSET(0x1D09C990)
#define RPG_GAMECORE_SHOWTUTORIALGUIDETALKLISTDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D09C9C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowTutorialGuideTalkListDialog_TypeDefinitionIndex = 24067;
