...
#define RPG_GAMECORE_LEVELTURNBEGIN_CLEAR_OFFSET UNITYSDK_OFFSET(0xCE4E8A0)
#define RPG_GAMECORE_LEVELTURNBEGIN_GETACTIVEENTITY_OFFSET UNITYSDK_OFFSET(0xCE4E990)
#define RPG_GAMECORE_LEVELTURNBEGIN_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xCE4E940)
#define RPG_GAMECORE_LEVELTURNBEGIN_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xCE4E8F0)
#define RPG_GAMECORE_LEVELTURNBEGIN_GETTURNCOUNTER_OFFSET UNITYSDK_OFFSET(0xCE4E9D0)
#define RPG_GAMECORE_LEVELTURNBEGIN_INIT_OFFSET UNITYSDK_OFFSET(0xCE4E840)
#define RPG_GAMECORE_LEVELTURNBEGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xCE4EA10)
#define RPG_GAMECORE_LEVELTURNBEGIN___IFIXBASEPROXY_CLEAR_OFFSET UNITYSDK_OFFSET(0xCE4EA20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelTurnBegin_TypeDefinitionIndex = 52945;
