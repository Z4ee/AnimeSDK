...
#define RPG_GAMECORE_LOOPEXECUTETASKLIST_METHOD_3_164F54A8DD3B7AE7_OFFSET UNITYSDK_OFFSET(0x1736FF30)
#define RPG_GAMECORE_LOOPEXECUTETASKLIST_METHOD_3_B605123EC8AED8CD_OFFSET UNITYSDK_OFFSET(0x1736FC50)
#define RPG_GAMECORE_LOOPEXECUTETASKLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1736FEB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoopExecuteTaskList_TypeDefinitionIndex = 21092;
