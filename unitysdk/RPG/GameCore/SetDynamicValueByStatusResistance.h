...
#define RPG_GAMECORE_SETDYNAMICVALUEBYSTATUSRESISTANCE_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1C5F21C0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSTATUSRESISTANCE_METHOD_4_1347CA92EC447F89_OFFSET UNITYSDK_OFFSET(0x1C5F1F90)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSTATUSRESISTANCE_METHOD_4_90D928BC1767DB68_OFFSET UNITYSDK_OFFSET(0x1C5F1FD0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSTATUSRESISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5F1FC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByStatusResistance_TypeDefinitionIndex = 22735;
