...
#define RPG_GAMECORE_SETDYNAMICVALUEBYSTATUSRESISTANCE_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x18E290F0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSTATUSRESISTANCE_METHOD_4_90D928BC1767DB68_OFFSET UNITYSDK_OFFSET(0x18E28F00)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSTATUSRESISTANCE_METHOD_4_A4A0D8B4DB26CD14_OFFSET UNITYSDK_OFFSET(0x18E28E30)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSTATUSRESISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E28EB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByStatusResistance_TypeDefinitionIndex = 22555;
