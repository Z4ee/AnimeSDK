...
#define RPG_GAMECORE_SETDYNAMICVALUEBYSTATUSRESISTANCE_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x176C5E60)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSTATUSRESISTANCE_METHOD_4_90D928BC1767DB68_OFFSET UNITYSDK_OFFSET(0x176C5C70)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSTATUSRESISTANCE_METHOD_4_A4A0D8B4DB26CD14_OFFSET UNITYSDK_OFFSET(0x176C5BA0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSTATUSRESISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x176C5C20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByStatusResistance_TypeDefinitionIndex = 21817;
