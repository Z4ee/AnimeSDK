...
#define RPG_GAMECORE_ADVBYFASTDELIVERFINISH_METHOD_4_1EFD778BA0CA204C_OFFSET UNITYSDK_OFFSET(0x1D6ADDA0)
#define RPG_GAMECORE_ADVBYFASTDELIVERFINISH_METHOD_4_5ADA801AD5EB5382_OFFSET UNITYSDK_OFFSET(0x1D6ADF20)
#define RPG_GAMECORE_ADVBYFASTDELIVERFINISH_METHOD_4_6267AE44EBED7614_OFFSET UNITYSDK_OFFSET(0x1D6ADD20)
#define RPG_GAMECORE_ADVBYFASTDELIVERFINISH_METHOD_4_79E42539BC9110FA_OFFSET UNITYSDK_OFFSET(0x1D6ADF70)
#define RPG_GAMECORE_ADVBYFASTDELIVERFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6ADD70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvByFastDeliverFinish_TypeDefinitionIndex = 21912;
