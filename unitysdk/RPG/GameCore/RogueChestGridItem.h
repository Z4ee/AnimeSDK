...
#define RPG_GAMECORE_ROGUECHESTGRIDITEM_METHOD_2_97E00C3040E47A67_OFFSET UNITYSDK_OFFSET(0x175E9640)
#define RPG_GAMECORE_ROGUECHESTGRIDITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x175E9880)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueChestGridItem_TypeDefinitionIndex = 16450;
