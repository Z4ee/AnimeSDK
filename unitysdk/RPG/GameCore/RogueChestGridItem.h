...
#define RPG_GAMECORE_ROGUECHESTGRIDITEM_METHOD_2_C2566674CAB44A5E_OFFSET UNITYSDK_OFFSET(0x1C4AD1C0)
#define RPG_GAMECORE_ROGUECHESTGRIDITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4AD3B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueChestGridItem_TypeDefinitionIndex = 17181;
