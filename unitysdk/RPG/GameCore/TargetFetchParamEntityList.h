...
#define RPG_GAMECORE_TARGETFETCHPARAMENTITYLIST_METHOD_4_2BA77E645B243D08_OFFSET UNITYSDK_OFFSET(0x19CFB4F0)
#define RPG_GAMECORE_TARGETFETCHPARAMENTITYLIST_METHOD_4_8CFAFF36D4B1839A_OFFSET UNITYSDK_OFFSET(0x19D0E2A0)
#define RPG_GAMECORE_TARGETFETCHPARAMENTITYLIST_METHOD_4_C5915DBC0530F3D0_OFFSET UNITYSDK_OFFSET(0x19D06B30)
#define RPG_GAMECORE_TARGETFETCHPARAMENTITYLIST_METHOD_4_F1E6F5FC5860A770_OFFSET UNITYSDK_OFFSET(0x19D0E360)
#define RPG_GAMECORE_TARGETFETCHPARAMENTITYLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x19CFB4A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchParamEntityList_TypeDefinitionIndex = 22598;
	...
	public:
		...
		static ::System::Void Method_4_C5915DBC0530F3D0(::SimpleJSON::JSONNode* a1, ::RPG::GameCore::TargetFetchParamEntityList*& a2)
		{
			return ((::System::Void(*)(::SimpleJSON::JSONNode*, ::RPG::GameCore::TargetFetchParamEntityList*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_TARGETFETCHPARAMENTITYLIST_METHOD_4_C5915DBC0530F3D0_OFFSET))(a1, a2);
		}
