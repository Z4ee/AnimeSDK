...
#define RPG_GAMECORE_TARGETFETCHPARAMENTITYLIST_METHOD_4_2BA77E645B243D08_OFFSET UNITYSDK_OFFSET(0x18EDF140)
#define RPG_GAMECORE_TARGETFETCHPARAMENTITYLIST_METHOD_4_8CFAFF36D4B1839A_OFFSET UNITYSDK_OFFSET(0x18EE54D0)
#define RPG_GAMECORE_TARGETFETCHPARAMENTITYLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x18EDF0F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchParamEntityList_TypeDefinitionIndex = 22907;
