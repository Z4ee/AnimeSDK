...
#define RPG_GAMECORE_CREATECHARACTER_METHOD_3_1E17D01D4D44B2AE_OFFSET UNITYSDK_OFFSET(0x1713B5C0)
#define RPG_GAMECORE_CREATECHARACTER_METHOD_3_C6EEC9B3A11899CC_OFFSET UNITYSDK_OFFSET(0x1713B520)
#define RPG_GAMECORE_CREATECHARACTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1713B580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CreateCharacter_TypeDefinitionIndex = 19139;
