...
#define RPG_GAMECORE_CREATECHARACTER_METHOD_3_AFB1AAB8CC21D8DC_OFFSET UNITYSDK_OFFSET(0x1D0074C0)
#define RPG_GAMECORE_CREATECHARACTER_METHOD_3_C76A0B7408ED1B01_OFFSET UNITYSDK_OFFSET(0x1D007520)
#define RPG_GAMECORE_CREATECHARACTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D007500)
