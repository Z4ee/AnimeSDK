...
#define RPG_GAMECORE_BATTLELINEUPEQUIPMENTCONFIG_METHOD_2_7D3B139F2D449D3D_OFFSET UNITYSDK_OFFSET(0x186FCD90)
#define RPG_GAMECORE_BATTLELINEUPEQUIPMENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x186FCF00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleLineupEquipmentConfig_TypeDefinitionIndex = 17223;
