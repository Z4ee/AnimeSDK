...
#define RPG_GAMECORE_VP_DIV_METHOD_3_43F749C00776FDA9_OFFSET UNITYSDK_OFFSET(0x1D694BE0)
#define RPG_GAMECORE_VP_DIV_METHOD_3_75CC7125958743EC_OFFSET UNITYSDK_OFFSET(0x1D694B30)
#define RPG_GAMECORE_VP_DIV_METHOD_3_8A8864942A2398AF_OFFSET UNITYSDK_OFFSET(0x1D694C60)
#define RPG_GAMECORE_VP_DIV_METHOD_3_F4944D0B0F9E0D55_OFFSET UNITYSDK_OFFSET(0x1D694C90)
#define RPG_GAMECORE_VP_DIV__CTOR_OFFSET UNITYSDK_OFFSET(0x1D694BD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VP_Div_TypeDefinitionIndex = 23775;
