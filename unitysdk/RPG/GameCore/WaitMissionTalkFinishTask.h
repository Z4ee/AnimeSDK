...
#define RPG_GAMECORE_WAITMISSIONTALKFINISHTASK_DISPOSE_OFFSET UNITYSDK_OFFSET(0xAAFBBE0)
#define RPG_GAMECORE_WAITMISSIONTALKFINISHTASK_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0xAAFB9C0)
#define RPG_GAMECORE_WAITMISSIONTALKFINISHTASK_ONFINISHIMMEDIATELYINPERFORMANCE_OFFSET UNITYSDK_OFFSET(0xAAFBAD0)
#define RPG_GAMECORE_WAITMISSIONTALKFINISHTASK_ONSKIP_OFFSET UNITYSDK_OFFSET(0xAAFB9D0)
#define RPG_GAMECORE_WAITMISSIONTALKFINISHTASK_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xAAFB730)
#define RPG_GAMECORE_WAITMISSIONTALKFINISHTASK_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xAAFBB30)
#define RPG_GAMECORE_WAITMISSIONTALKFINISHTASK_TICK_OFFSET UNITYSDK_OFFSET(0xAAFBB80)
#define RPG_GAMECORE_WAITMISSIONTALKFINISHTASK__CTOR_OFFSET UNITYSDK_OFFSET(0xAAFB720)
#define RPG_GAMECORE_WAITMISSIONTALKFINISHTASK__ONBACKGROUNDTALKFINISH_OFFSET UNITYSDK_OFFSET(0xAAFBC90)
#define RPG_GAMECORE_WAITMISSIONTALKFINISHTASK__ONMISSIONTALKFINISH_OFFSET UNITYSDK_OFFSET(0xAAFBC30)
#define RPG_GAMECORE_WAITMISSIONTALKFINISHTASK__REMOVENOTIFY_OFFSET UNITYSDK_OFFSET(0xAAFBA20)
#define RPG_GAMECORE_WAITMISSIONTALKFINISHTASK__WAITBACKGROUNDTALKFINISH_OFFSET UNITYSDK_OFFSET(0xAAFB8E0)
#define RPG_GAMECORE_WAITMISSIONTALKFINISHTASK__WAITMISSIONTALKFINISH_OFFSET UNITYSDK_OFFSET(0xAAFB950)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitMissionTalkFinishTask_TypeDefinitionIndex = 47571;
