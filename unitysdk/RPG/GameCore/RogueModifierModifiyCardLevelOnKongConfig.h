...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFIYCARDLEVELONKONGCONFIG_METHOD_3_6EFA892614B38301_OFFSET UNITYSDK_OFFSET(0x1CFC1790)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFIYCARDLEVELONKONGCONFIG_METHOD_3_8E9BDE1041CBBEDD_OFFSET UNITYSDK_OFFSET(0x1CFC1740)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFIYCARDLEVELONKONGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFC1780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifiyCardLevelOnKongConfig_TypeDefinitionIndex = 17098;
