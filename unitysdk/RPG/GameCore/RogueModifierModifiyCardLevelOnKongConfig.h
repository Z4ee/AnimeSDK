...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFIYCARDLEVELONKONGCONFIG_METHOD_3_6EFA892614B38301_OFFSET UNITYSDK_OFFSET(0x17633030)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFIYCARDLEVELONKONGCONFIG_METHOD_3_B80390BEABE435A8_OFFSET UNITYSDK_OFFSET(0x17632F60)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFIYCARDLEVELONKONGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17632FE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifiyCardLevelOnKongConfig_TypeDefinitionIndex = 16367;
