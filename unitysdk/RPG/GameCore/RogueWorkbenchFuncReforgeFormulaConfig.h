...
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCREFORGEFORMULACONFIG_METHOD_3_4723B23C309C84D6_OFFSET UNITYSDK_OFFSET(0x17673870)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCREFORGEFORMULACONFIG_METHOD_3_E103B19E5DAD35B2_OFFSET UNITYSDK_OFFSET(0x176735B0)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCREFORGEFORMULACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x176735A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueWorkbenchFuncReforgeFormulaConfig_TypeDefinitionIndex = 16565;
