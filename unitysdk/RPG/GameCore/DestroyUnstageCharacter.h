...
#define RPG_GAMECORE_DESTROYUNSTAGECHARACTER_METHOD_3_45DCFEE5EB1347B6_OFFSET UNITYSDK_OFFSET(0x1C104710)
#define RPG_GAMECORE_DESTROYUNSTAGECHARACTER_METHOD_3_5594AABC38CD51A1_OFFSET UNITYSDK_OFFSET(0x1C1046D0)
#define RPG_GAMECORE_DESTROYUNSTAGECHARACTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C104700)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DestroyUnstageCharacter_TypeDefinitionIndex = 21930;
