...
#define RPG_GAMECORE_DESTROYUNSTAGECHARACTER_METHOD_3_45DCFEE5EB1347B6_OFFSET UNITYSDK_OFFSET(0x1885C3D0)
#define RPG_GAMECORE_DESTROYUNSTAGECHARACTER_METHOD_3_C243B4182E4038EC_OFFSET UNITYSDK_OFFSET(0x1885C350)
#define RPG_GAMECORE_DESTROYUNSTAGECHARACTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1885C3A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DestroyUnstageCharacter_TypeDefinitionIndex = 21653;
