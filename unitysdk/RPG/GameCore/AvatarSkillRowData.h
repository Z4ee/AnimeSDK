...
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_ATTACKDAMAGETYPEOVERRIDE_OFFSET UNITYSDK_OFFSET(0xE522B30)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_ATTACKTYPE_OFFSET UNITYSDK_OFFSET(0xE522B80)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_BPADD_OFFSET UNITYSDK_OFFSET(0xE5221C0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_BPNEED_OFFSET UNITYSDK_OFFSET(0xE521EF0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0xE520B30)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_COOLDOWN_OFFSET UNITYSDK_OFFSET(0xE521490)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_DELAYRATIO_OFFSET UNITYSDK_OFFSET(0xE522490)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_DISPLAYATTACKTYPE_OFFSET UNITYSDK_OFFSET(0xE523B10)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_EXTRAEFFECTIDLIST_OFFSET UNITYSDK_OFFSET(0xE523C70)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_HIDEINUI_OFFSET UNITYSDK_OFFSET(0xE5239C0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_INITCOOLDOWN_OFFSET UNITYSDK_OFFSET(0xE521250)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0xE5249D0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_LEVELUPCOSTLIST_OFFSET UNITYSDK_OFFSET(0xE524630)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_LEVELUPLEVELCOND_OFFSET UNITYSDK_OFFSET(0xE5243D0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_LEVELUPRANKCOND_OFFSET UNITYSDK_OFFSET(0xE524500)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0xE524170)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_MAXLEVEL_OFFSET UNITYSDK_OFFSET(0xE5242A0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_PARAMLIST_OFFSET UNITYSDK_OFFSET(0xE522770)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_PREADDMODIFIERLIST_OFFSET UNITYSDK_OFFSET(0xE524760)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_PRECALEQUALSPLITTARGET_OFFSET UNITYSDK_OFFSET(0xE522F10)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_RATEDRANKID_OFFSET UNITYSDK_OFFSET(0xE5248A0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_RATEDSKILLTREEID_OFFSET UNITYSDK_OFFSET(0xE524770)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_ROW_OFFSET UNITYSDK_OFFSET(0xE520A40)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SHOWDAMAGELIST_OFFSET UNITYSDK_OFFSET(0xE520FF0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SHOWHEALLIST_OFFSET UNITYSDK_OFFSET(0xE521120)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SHOWSTANCELIST_OFFSET UNITYSDK_OFFSET(0xE520EC0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SIMPLEEXTRAEFFECTIDLIST_OFFSET UNITYSDK_OFFSET(0xE523DA0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SIMPLEPARAMLIST_OFFSET UNITYSDK_OFFSET(0xE5228B0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SIMPLESKILLDESC_OFFSET UNITYSDK_OFFSET(0xE523830)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SKILLCOMBOVALUEDELTA_OFFSET UNITYSDK_OFFSET(0xE522DE0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SKILLDESC_OFFSET UNITYSDK_OFFSET(0xE5236A0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SKILLEFFECT_OFFSET UNITYSDK_OFFSET(0xE522CB0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SKILLICON_OFFSET UNITYSDK_OFFSET(0xE523420)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SKILLID_OFFSET UNITYSDK_OFFSET(0xE520B40)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SKILLNAME_OFFSET UNITYSDK_OFFSET(0xE522F70)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SKILLNEED_OFFSET UNITYSDK_OFFSET(0xE523B20)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SKILLTAG_OFFSET UNITYSDK_OFFSET(0xE523100)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SKILLTRIGGERKEY_OFFSET UNITYSDK_OFFSET(0xE520C70)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SKILLTYPEDESC_OFFSET UNITYSDK_OFFSET(0xE523290)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SPADD_OFFSET UNITYSDK_OFFSET(0xE5216D0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SPBASE_OFFSET UNITYSDK_OFFSET(0xE5219A0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SPMULTIPLERATIO_OFFSET UNITYSDK_OFFSET(0xE521DB0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SPNEED_OFFSET UNITYSDK_OFFSET(0xE521AE0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_STANCEDAMAGEDISPLAY_OFFSET UNITYSDK_OFFSET(0xE523ED0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_STANCEDAMAGETYPE_OFFSET UNITYSDK_OFFSET(0xE5229F0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_ULTRASKILLICON_OFFSET UNITYSDK_OFFSET(0xE523560)
#define RPG_GAMECORE_AVATARSKILLROWDATA_OVERRIDEDATA_OFFSET UNITYSDK_OFFSET(0xE524000)
#define RPG_GAMECORE_AVATARSKILLROWDATA_SET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0xE5249E0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_SET_ROW_OFFSET UNITYSDK_OFFSET(0xE520AC0)
#define RPG_GAMECORE_AVATARSKILLROWDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0xE5249F0)
#define RPG_GAMECORE_AVATARSKILLROWDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xE51DDC0)
#define RPG_GAMECORE_AVATARSKILLROWDATA__REFRESHDISPLAYATTACKTYPE_OFFSET UNITYSDK_OFFSET(0xE5207C0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::RPG::GameCore::SkillConfig**)Il2CppClass::FromTypeDefinitionIndex(AvatarSkillRowData_TypeDefinitionIndex)->GetStaticField(0x668C0);
		}
		static ::RPG::GameCore::IAvatarSkillCommonRowWrap** StaticGet__EmptyRow()
		{
			return (::RPG::GameCore::IAvatarSkillCommonRowWrap**)Il2CppClass::FromTypeDefinitionIndex(AvatarSkillRowData_TypeDefinitionIndex)->GetStaticField(0x668C8);
		}
		::RPG::GameCore::IAvatarSkillCommonRowWrap* _Row; // 0x10
		...
		::RPG::GameCore::AttackType _DisplayAttackType; // 0x214
