...
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_ATTACKDAMAGETYPEOVERRIDE_OFFSET UNITYSDK_OFFSET(0x195C9A60)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_ATTACKTYPE_OFFSET UNITYSDK_OFFSET(0x195C9AA0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_BPADD_OFFSET UNITYSDK_OFFSET(0x195C90F0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_BPNEED_OFFSET UNITYSDK_OFFSET(0x195C8E20)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0x195C7A50)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_COOLDOWN_OFFSET UNITYSDK_OFFSET(0x195C83C0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_DELAYRATIO_OFFSET UNITYSDK_OFFSET(0x195C93C0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_DISPLAYATTACKTYPE_OFFSET UNITYSDK_OFFSET(0x195CAA30)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_EXTRAEFFECTIDLIST_OFFSET UNITYSDK_OFFSET(0x195CAB90)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_HIDEINUI_OFFSET UNITYSDK_OFFSET(0x195CA8E0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_INITCOOLDOWN_OFFSET UNITYSDK_OFFSET(0x195C8180)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0x195CB8F0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_LEVELUPCOSTLIST_OFFSET UNITYSDK_OFFSET(0x195CB550)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_LEVELUPLEVELCOND_OFFSET UNITYSDK_OFFSET(0x195CB2F0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_LEVELUPRANKCOND_OFFSET UNITYSDK_OFFSET(0x195CB420)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x195CB090)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_MAXLEVEL_OFFSET UNITYSDK_OFFSET(0x195CB1C0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_PARAMLIST_OFFSET UNITYSDK_OFFSET(0x195C96A0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_PREADDMODIFIERLIST_OFFSET UNITYSDK_OFFSET(0x195CB680)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_PRECALEQUALSPLITTARGET_OFFSET UNITYSDK_OFFSET(0x195C9E30)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_RATEDRANKID_OFFSET UNITYSDK_OFFSET(0x195CB7C0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_RATEDSKILLTREEID_OFFSET UNITYSDK_OFFSET(0x195CB690)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_ROW_OFFSET UNITYSDK_OFFSET(0x195C7940)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SHOWDAMAGELIST_OFFSET UNITYSDK_OFFSET(0x195C7F20)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SHOWHEALLIST_OFFSET UNITYSDK_OFFSET(0x195C8050)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SHOWSTANCELIST_OFFSET UNITYSDK_OFFSET(0x195C7DF0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SIMPLEEXTRAEFFECTIDLIST_OFFSET UNITYSDK_OFFSET(0x195CACC0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SIMPLEPARAMLIST_OFFSET UNITYSDK_OFFSET(0x195C97E0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SIMPLESKILLDESC_OFFSET UNITYSDK_OFFSET(0x195CA750)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SKILLCOMBOVALUEDELTA_OFFSET UNITYSDK_OFFSET(0x195C9D00)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SKILLDESC_OFFSET UNITYSDK_OFFSET(0x195CA5C0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SKILLEFFECT_OFFSET UNITYSDK_OFFSET(0x195C9BD0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SKILLICON_OFFSET UNITYSDK_OFFSET(0x195CA340)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SKILLID_OFFSET UNITYSDK_OFFSET(0x195C7A60)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SKILLNAME_OFFSET UNITYSDK_OFFSET(0x195C9E90)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SKILLNEED_OFFSET UNITYSDK_OFFSET(0x195CAA40)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SKILLTAG_OFFSET UNITYSDK_OFFSET(0x195CA020)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SKILLTRIGGERKEY_OFFSET UNITYSDK_OFFSET(0x195C7B90)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SKILLTYPEDESC_OFFSET UNITYSDK_OFFSET(0x195CA1B0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SPADD_OFFSET UNITYSDK_OFFSET(0x195C8600)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SPBASE_OFFSET UNITYSDK_OFFSET(0x195C88D0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SPMULTIPLERATIO_OFFSET UNITYSDK_OFFSET(0x195C8CE0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SPNEED_OFFSET UNITYSDK_OFFSET(0x195C8A10)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_STANCEDAMAGEDISPLAY_OFFSET UNITYSDK_OFFSET(0x195CADF0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_STANCEDAMAGETYPE_OFFSET UNITYSDK_OFFSET(0x195C9920)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_ULTRASKILLICON_OFFSET UNITYSDK_OFFSET(0x195CA480)
#define RPG_GAMECORE_AVATARSKILLROWDATA_OVERRIDEDATA_OFFSET UNITYSDK_OFFSET(0x195CAF20)
#define RPG_GAMECORE_AVATARSKILLROWDATA_SET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0x195CB900)
#define RPG_GAMECORE_AVATARSKILLROWDATA_SET_ROW_OFFSET UNITYSDK_OFFSET(0x195C79D0)
#define RPG_GAMECORE_AVATARSKILLROWDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x195CB910)
#define RPG_GAMECORE_AVATARSKILLROWDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x195C4CB0)
#define RPG_GAMECORE_AVATARSKILLROWDATA__REFRESHDISPLAYATTACKTYPE_OFFSET UNITYSDK_OFFSET(0x195C76B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AvatarSkillRowData_TypeDefinitionIndex = 55106;
	...
	public:
		...
		{
			return (::RPG::GameCore::SkillConfig**)Il2CppClass::FromTypeDefinitionIndex(AvatarSkillRowData_TypeDefinitionIndex)->GetStaticField(0x5E3A0);
		}
		static ::RPG::GameCore::IAvatarSkillCommonRowWrap** StaticGet__EmptyRow()
		{
			return (::RPG::GameCore::IAvatarSkillCommonRowWrap**)Il2CppClass::FromTypeDefinitionIndex(AvatarSkillRowData_TypeDefinitionIndex)->GetStaticField(0x5E3A8);
		}
		::Struct_2_5CDBC06B233F2791 _OverrideData; // 0x10
		::RPG::GameCore::IAvatarSkillCommonRowWrap* _Row; // 0x108
		::RPG::GameCore::SkillConfig* _Config; // 0x110
		::Struct_2_5CDBC06B233F2791 _DefaultOverrideData; // 0x118
		::RPG::GameCore::AttackType _DisplayAttackType; // 0x210
		::System::Boolean _IsUnlocked_k__BackingField; // 0x214
		...
		::System::Void _RefreshDisplayAttackType()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_GAMECORE_AVATARSKILLROWDATA__REFRESHDISPLAYATTACKTYPE_OFFSET))(this);
		}
		...
		{
			return ((::RPG::GameCore::AttackType(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_GAMECORE_AVATARSKILLROWDATA_GET_DISPLAYATTACKTYPE_OFFSET))(this);
		}
