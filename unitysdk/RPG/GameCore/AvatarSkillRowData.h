...
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_ATTACKDAMAGETYPEOVERRIDE_OFFSET UNITYSDK_OFFSET(0xB5BD2D0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_ATTACKTYPE_OFFSET UNITYSDK_OFFSET(0xB5BD320)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_BPADD_OFFSET UNITYSDK_OFFSET(0xB5BCC70)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_BPNEED_OFFSET UNITYSDK_OFFSET(0xB5BCAC0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0xB5BBCC0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_COOLDOWN_OFFSET UNITYSDK_OFFSET(0xB5BC3C0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_DELAYRATIO_OFFSET UNITYSDK_OFFSET(0xB5BCE20)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_EXTRAEFFECTIDLIST_OFFSET UNITYSDK_OFFSET(0xB5BE0E0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_HIDEINUI_OFFSET UNITYSDK_OFFSET(0xB5BDEE0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_INITCOOLDOWN_OFFSET UNITYSDK_OFFSET(0xB5BC220)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0xB5BEBC0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_LEVELUPCOSTLIST_OFFSET UNITYSDK_OFFSET(0xB5BE8E0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_LEVELUPLEVELCOND_OFFSET UNITYSDK_OFFSET(0xB5BE700)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_LEVELUPRANKCOND_OFFSET UNITYSDK_OFFSET(0xB5BE7F0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0xB5BE520)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_MAXLEVEL_OFFSET UNITYSDK_OFFSET(0xB5BE610)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_PARAMLIST_OFFSET UNITYSDK_OFFSET(0xB5BCFD0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_PREADDMODIFIERLIST_OFFSET UNITYSDK_OFFSET(0xB5BE9D0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_PRECALEQUALSPLITTARGET_OFFSET UNITYSDK_OFFSET(0xB5BD5F0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_RATEDRANKID_OFFSET UNITYSDK_OFFSET(0xB5BEAD0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_RATEDSKILLTREEID_OFFSET UNITYSDK_OFFSET(0xB5BE9E0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_ROW_OFFSET UNITYSDK_OFFSET(0xB5BBC00)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SHOWDAMAGELIST_OFFSET UNITYSDK_OFFSET(0xB5BC040)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SHOWHEALLIST_OFFSET UNITYSDK_OFFSET(0xB5BC130)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SHOWSTANCELIST_OFFSET UNITYSDK_OFFSET(0xB5BBF50)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SIMPLEEXTRAEFFECTIDLIST_OFFSET UNITYSDK_OFFSET(0xB5BE1D0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SIMPLEPARAMLIST_OFFSET UNITYSDK_OFFSET(0xB5BD0D0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SIMPLESKILLDESC_OFFSET UNITYSDK_OFFSET(0xB5BDD90)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SKILLCOMBOVALUEDELTA_OFFSET UNITYSDK_OFFSET(0xB5BD500)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SKILLDESC_OFFSET UNITYSDK_OFFSET(0xB5BDC40)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SKILLEFFECT_OFFSET UNITYSDK_OFFSET(0xB5BD410)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SKILLICON_OFFSET UNITYSDK_OFFSET(0xB5BDA40)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SKILLID_OFFSET UNITYSDK_OFFSET(0xB5BBCD0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SKILLNAME_OFFSET UNITYSDK_OFFSET(0xB5BD650)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SKILLNEED_OFFSET UNITYSDK_OFFSET(0xB5BDFE0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SKILLTAG_OFFSET UNITYSDK_OFFSET(0xB5BD7A0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SKILLTRIGGERKEY_OFFSET UNITYSDK_OFFSET(0xB5BBDB0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SKILLTYPEDESC_OFFSET UNITYSDK_OFFSET(0xB5BD8F0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SPADD_OFFSET UNITYSDK_OFFSET(0xB5BC560)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SPBASE_OFFSET UNITYSDK_OFFSET(0xB5BC710)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SPMULTIPLERATIO_OFFSET UNITYSDK_OFFSET(0xB5BC9C0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SPNEED_OFFSET UNITYSDK_OFFSET(0xB5BC810)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_STANCEDAMAGEDISPLAY_OFFSET UNITYSDK_OFFSET(0xB5BE2C0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_STANCEDAMAGETYPE_OFFSET UNITYSDK_OFFSET(0xB5BD1D0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_ULTRASKILLICON_OFFSET UNITYSDK_OFFSET(0xB5BDB40)
#define RPG_GAMECORE_AVATARSKILLROWDATA_OVERRIDEDATA_OFFSET UNITYSDK_OFFSET(0xB5BE3B0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_SET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0xB5BEBD0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_SET_ROW_OFFSET UNITYSDK_OFFSET(0xB5BBC90)
#define RPG_GAMECORE_AVATARSKILLROWDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0xB5BEBE0)
#define RPG_GAMECORE_AVATARSKILLROWDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB5BB300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AvatarSkillRowData_TypeDefinitionIndex = 53173;
	...
	public:
		...
		{
			return (::RPG::GameCore::IAvatarSkillCommonRowWrap**)Il2CppClass::FromTypeDefinitionIndex(AvatarSkillRowData_TypeDefinitionIndex)->GetStaticField(0x43000);
		}
		static ::RPG::GameCore::SkillConfig** StaticGet__EmptyConfig()
		{
			return (::RPG::GameCore::SkillConfig**)Il2CppClass::FromTypeDefinitionIndex(AvatarSkillRowData_TypeDefinitionIndex)->GetStaticField(0x43008);
		}
