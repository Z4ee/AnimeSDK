...
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_ATTACKDAMAGETYPEOVERRIDE_OFFSET UNITYSDK_OFFSET(0xCD227D0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_ATTACKTYPE_OFFSET UNITYSDK_OFFSET(0xCD22820)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_BPADD_OFFSET UNITYSDK_OFFSET(0xCD22070)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_BPNEED_OFFSET UNITYSDK_OFFSET(0xCD21E40)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0xCD20F40)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_COOLDOWN_OFFSET UNITYSDK_OFFSET(0xCD21640)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_DELAYRATIO_OFFSET UNITYSDK_OFFSET(0xCD222A0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_EXTRAEFFECTIDLIST_OFFSET UNITYSDK_OFFSET(0xCD235E0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_HIDEINUI_OFFSET UNITYSDK_OFFSET(0xCD233E0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_INITCOOLDOWN_OFFSET UNITYSDK_OFFSET(0xCD214A0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0xCD240C0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_LEVELUPCOSTLIST_OFFSET UNITYSDK_OFFSET(0xCD23DE0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_LEVELUPLEVELCOND_OFFSET UNITYSDK_OFFSET(0xCD23C00)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_LEVELUPRANKCOND_OFFSET UNITYSDK_OFFSET(0xCD23CF0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0xCD23A20)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_MAXLEVEL_OFFSET UNITYSDK_OFFSET(0xCD23B10)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_PARAMLIST_OFFSET UNITYSDK_OFFSET(0xCD224D0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_PREADDMODIFIERLIST_OFFSET UNITYSDK_OFFSET(0xCD23ED0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_PRECALEQUALSPLITTARGET_OFFSET UNITYSDK_OFFSET(0xCD22AF0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_RATEDRANKID_OFFSET UNITYSDK_OFFSET(0xCD23FD0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_RATEDSKILLTREEID_OFFSET UNITYSDK_OFFSET(0xCD23EE0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_ROW_OFFSET UNITYSDK_OFFSET(0xCD20E70)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SHOWDAMAGELIST_OFFSET UNITYSDK_OFFSET(0xCD212C0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SHOWHEALLIST_OFFSET UNITYSDK_OFFSET(0xCD213B0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SHOWSTANCELIST_OFFSET UNITYSDK_OFFSET(0xCD211D0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SIMPLEEXTRAEFFECTIDLIST_OFFSET UNITYSDK_OFFSET(0xCD236D0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SIMPLEPARAMLIST_OFFSET UNITYSDK_OFFSET(0xCD225D0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SIMPLESKILLDESC_OFFSET UNITYSDK_OFFSET(0xCD23290)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SKILLCOMBOVALUEDELTA_OFFSET UNITYSDK_OFFSET(0xCD22A00)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SKILLDESC_OFFSET UNITYSDK_OFFSET(0xCD23140)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SKILLEFFECT_OFFSET UNITYSDK_OFFSET(0xCD22910)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SKILLICON_OFFSET UNITYSDK_OFFSET(0xCD22F40)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SKILLID_OFFSET UNITYSDK_OFFSET(0xCD20F50)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SKILLNAME_OFFSET UNITYSDK_OFFSET(0xCD22B50)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SKILLNEED_OFFSET UNITYSDK_OFFSET(0xCD234E0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SKILLTAG_OFFSET UNITYSDK_OFFSET(0xCD22CA0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SKILLTRIGGERKEY_OFFSET UNITYSDK_OFFSET(0xCD21030)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SKILLTYPEDESC_OFFSET UNITYSDK_OFFSET(0xCD22DF0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SPADD_OFFSET UNITYSDK_OFFSET(0xCD217E0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SPBASE_OFFSET UNITYSDK_OFFSET(0xCD21A10)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SPMULTIPLERATIO_OFFSET UNITYSDK_OFFSET(0xCD21D40)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_SPNEED_OFFSET UNITYSDK_OFFSET(0xCD21B10)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_STANCEDAMAGEDISPLAY_OFFSET UNITYSDK_OFFSET(0xCD237C0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_STANCEDAMAGETYPE_OFFSET UNITYSDK_OFFSET(0xCD226D0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_GET_ULTRASKILLICON_OFFSET UNITYSDK_OFFSET(0xCD23040)
#define RPG_GAMECORE_AVATARSKILLROWDATA_OVERRIDEDATA_OFFSET UNITYSDK_OFFSET(0xCD238B0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_SET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0xCD240D0)
#define RPG_GAMECORE_AVATARSKILLROWDATA_SET_ROW_OFFSET UNITYSDK_OFFSET(0xCD20F00)
#define RPG_GAMECORE_AVATARSKILLROWDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0xCD240E0)
#define RPG_GAMECORE_AVATARSKILLROWDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCD1E7E0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::RPG::GameCore::SkillConfig**)Il2CppClass::FromTypeDefinitionIndex(AvatarSkillRowData_TypeDefinitionIndex)->GetStaticField(0x65980);
		}
		static ::RPG::GameCore::IAvatarSkillCommonRowWrap** StaticGet__EmptyRow()
		{
			return (::RPG::GameCore::IAvatarSkillCommonRowWrap**)Il2CppClass::FromTypeDefinitionIndex(AvatarSkillRowData_TypeDefinitionIndex)->GetStaticField(0x65988);
		}
		::Struct_2_5CDBC06B233F2791 _DefaultOverrideData; // 0x10
		::Struct_2_5CDBC06B233F2791 _OverrideData; // 0x108
		::RPG::GameCore::IAvatarSkillCommonRowWrap* _Row; // 0x200
