...
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTSHIELDBOOSTPERCENTCONFIG_METHOD_3_3D2AFC0BB30A4546_OFFSET UNITYSDK_OFFSET(0x19894710)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTSHIELDBOOSTPERCENTCONFIG_METHOD_3_A335003BC812DDB2_OFFSET UNITYSDK_OFFSET(0x198947E0)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTSHIELDBOOSTPERCENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x198947D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityPixAirEffectShieldBoostPercentConfig_TypeDefinitionIndex = 20185;
