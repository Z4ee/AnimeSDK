...
#define RPG_GAMECORE_NOTIFYVERSUSBARQUESTCHANGE_METHOD_3_672D320D8F1FB10D_OFFSET UNITYSDK_OFFSET(0x18BBF4F0)
#define RPG_GAMECORE_NOTIFYVERSUSBARQUESTCHANGE_METHOD_3_A741C8DBEFD7E7FA_OFFSET UNITYSDK_OFFSET(0x18BBF570)
#define RPG_GAMECORE_NOTIFYVERSUSBARQUESTCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x18BBF540)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NotifyVersusBarQuestChange_TypeDefinitionIndex = 22098;
