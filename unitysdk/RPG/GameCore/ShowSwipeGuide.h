...
#define RPG_GAMECORE_SHOWSWIPEGUIDE_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1BE47B70)
#define RPG_GAMECORE_SHOWSWIPEGUIDE_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1BE47B10)
#define RPG_GAMECORE_SHOWSWIPEGUIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE47B50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowSwipeGuide_TypeDefinitionIndex = 23480;
