...
#define RPG_GAMECORE_SHOWSWIPEGUIDE_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1D530BE0)
#define RPG_GAMECORE_SHOWSWIPEGUIDE_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D530B80)
#define RPG_GAMECORE_SHOWSWIPEGUIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D530BC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowSwipeGuide_TypeDefinitionIndex = 24062;
