...
#define RPG_GAMECORE_PROPLOADFASTDELIVERPUZZLE_METHOD_3_65C33BD357B93CF2_OFFSET UNITYSDK_OFFSET(0x18C6F640)
#define RPG_GAMECORE_PROPLOADFASTDELIVERPUZZLE_METHOD_3_FC389FA7CE215FE4_OFFSET UNITYSDK_OFFSET(0x18C6F4F0)
#define RPG_GAMECORE_PROPLOADFASTDELIVERPUZZLE__CTOR_OFFSET UNITYSDK_OFFSET(0x18C6F5B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropLoadFastDeliverPuzzle_TypeDefinitionIndex = 21017;
