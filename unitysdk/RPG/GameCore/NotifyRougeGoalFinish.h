...
#define RPG_GAMECORE_NOTIFYROUGEGOALFINISH_METHOD_3_152725694FFD150C_OFFSET UNITYSDK_OFFSET(0x1BAFB170)
#define RPG_GAMECORE_NOTIFYROUGEGOALFINISH_METHOD_3_5514B8CD80205989_OFFSET UNITYSDK_OFFSET(0x1BAFB130)
#define RPG_GAMECORE_NOTIFYROUGEGOALFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAFB160)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NotifyRougeGoalFinish_TypeDefinitionIndex = 22814;
