...
#define RPG_GAMECORE_NOTIFYROUGEGOALFINISH_METHOD_3_152725694FFD150C_OFFSET UNITYSDK_OFFSET(0x18BBF350)
#define RPG_GAMECORE_NOTIFYROUGEGOALFINISH_METHOD_3_C51CC0E6743E99DD_OFFSET UNITYSDK_OFFSET(0x18BBF2D0)
#define RPG_GAMECORE_NOTIFYROUGEGOALFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x18BBF320)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NotifyRougeGoalFinish_TypeDefinitionIndex = 22652;
