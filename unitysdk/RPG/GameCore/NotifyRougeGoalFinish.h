...
#define RPG_GAMECORE_NOTIFYROUGEGOALFINISH_METHOD_3_152725694FFD150C_OFFSET UNITYSDK_OFFSET(0x17475DB0)
#define RPG_GAMECORE_NOTIFYROUGEGOALFINISH_METHOD_3_C51CC0E6743E99DD_OFFSET UNITYSDK_OFFSET(0x17475D30)
#define RPG_GAMECORE_NOTIFYROUGEGOALFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x17475D80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NotifyRougeGoalFinish_TypeDefinitionIndex = 21914;
