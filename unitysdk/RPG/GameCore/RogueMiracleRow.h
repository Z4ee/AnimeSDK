...
#define RPG_GAMECORE_ROGUEMIRACLEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18D29A60)
#define RPG_GAMECORE_ROGUEMIRACLEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18D2A1B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueMiracleRow_TypeDefinitionIndex = 13928;
