...
#define RPG_GAMECORE_SHOWBILLBOARDINSTORYMODE_METHOD_3_7093FFCF01FD3BA9_OFFSET UNITYSDK_OFFSET(0x176F7120)
#define RPG_GAMECORE_SHOWBILLBOARDINSTORYMODE_METHOD_3_E28DE956F7F0730A_OFFSET UNITYSDK_OFFSET(0x176F6FD0)
#define RPG_GAMECORE_SHOWBILLBOARDINSTORYMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x176F7090)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowBillboardInStoryMode_TypeDefinitionIndex = 18765;
