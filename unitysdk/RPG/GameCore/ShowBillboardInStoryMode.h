...
#define RPG_GAMECORE_SHOWBILLBOARDINSTORYMODE_METHOD_3_7093FFCF01FD3BA9_OFFSET UNITYSDK_OFFSET(0x1BE3BB80)
#define RPG_GAMECORE_SHOWBILLBOARDINSTORYMODE_METHOD_3_D00B0E8D4A7720A3_OFFSET UNITYSDK_OFFSET(0x1BE3BB00)
#define RPG_GAMECORE_SHOWBILLBOARDINSTORYMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE3BB50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowBillboardInStoryMode_TypeDefinitionIndex = 19683;
