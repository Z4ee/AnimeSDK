...
#define RPG_GAMECORE_SWITCHREFFLOORSAVEDVALUE_METHOD_3_8B7BC6F7E23454F2_OFFSET UNITYSDK_OFFSET(0x18EBF510)
#define RPG_GAMECORE_SWITCHREFFLOORSAVEDVALUE_METHOD_3_95FF7E727B62A66F_OFFSET UNITYSDK_OFFSET(0x18EBFD90)
#define RPG_GAMECORE_SWITCHREFFLOORSAVEDVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x18EBF500)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchRefFloorSavedValue_TypeDefinitionIndex = 16635;
