...
#define RPG_GAMECORE_BATTLEMONSTERWAVETEXTINFO_GET_CURRENTWAVECOUNT_OFFSET UNITYSDK_OFFSET(0x1B633E30)
#define RPG_GAMECORE_BATTLEMONSTERWAVETEXTINFO_GET_MAXWAVECOUNT_OFFSET UNITYSDK_OFFSET(0x1B633E90)
#define RPG_GAMECORE_BATTLEMONSTERWAVETEXTINFO_HASOVERRIDEINFO_OFFSET UNITYSDK_OFFSET(0x1B633FB0)
#define RPG_GAMECORE_BATTLEMONSTERWAVETEXTINFO_RESET_OFFSET UNITYSDK_OFFSET(0x1B633F60)
#define RPG_GAMECORE_BATTLEMONSTERWAVETEXTINFO_SETOVERRIDEWAVETEXTINFO_OFFSET UNITYSDK_OFFSET(0x1B633EF0)
#define RPG_GAMECORE_BATTLEMONSTERWAVETEXTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B633E20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleMonsterWaveTextInfo_TypeDefinitionIndex = 56413;
