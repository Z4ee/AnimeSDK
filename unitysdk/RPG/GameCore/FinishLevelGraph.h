...
#define RPG_GAMECORE_FINISHLEVELGRAPH_METHOD_3_77F525CACB6A5E3C_OFFSET UNITYSDK_OFFSET(0x1D09B4D0)
#define RPG_GAMECORE_FINISHLEVELGRAPH_METHOD_3_FD9A36953EB5D277_OFFSET UNITYSDK_OFFSET(0x1D09B510)
#define RPG_GAMECORE_FINISHLEVELGRAPH__CTOR_OFFSET UNITYSDK_OFFSET(0x1D09B500)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FinishLevelGraph_TypeDefinitionIndex = 20386;
