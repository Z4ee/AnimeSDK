...
#define RPG_GAMECORE_FINISHLEVELGRAPH_METHOD_3_173D943B90EBD9C6_OFFSET UNITYSDK_OFFSET(0x171D79A0)
#define RPG_GAMECORE_FINISHLEVELGRAPH_METHOD_3_FD9A36953EB5D277_OFFSET UNITYSDK_OFFSET(0x171D7A20)
#define RPG_GAMECORE_FINISHLEVELGRAPH__CTOR_OFFSET UNITYSDK_OFFSET(0x171D79F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FinishLevelGraph_TypeDefinitionIndex = 18937;
