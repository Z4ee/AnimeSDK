...
#define RPG_GAMECORE_LEVELTURNACTIONPHASEEND_GETACTIONONEMORE_OFFSET UNITYSDK_OFFSET(0x19780C50)
#define RPG_GAMECORE_LEVELTURNACTIONPHASEEND_GETACTIVEENTITY_OFFSET UNITYSDK_OFFSET(0x19780BD0)
#define RPG_GAMECORE_LEVELTURNACTIONPHASEEND_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x19780B80)
#define RPG_GAMECORE_LEVELTURNACTIONPHASEEND_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x19780B30)
#define RPG_GAMECORE_LEVELTURNACTIONPHASEEND_GETTURNCOUNTER_OFFSET UNITYSDK_OFFSET(0x19780C10)
#define RPG_GAMECORE_LEVELTURNACTIONPHASEEND__CTOR_OFFSET UNITYSDK_OFFSET(0x19780B20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelTurnActionPhaseEnd_TypeDefinitionIndex = 54164;
