...
#define RPG_GAMECORE_COMPLEXSKILLAIFACTORGROUPWEIGHTEX_METHOD_3_C10618C21B6B46D8_OFFSET UNITYSDK_OFFSET(0x1D9A90F0)
#define RPG_GAMECORE_COMPLEXSKILLAIFACTORGROUPWEIGHTEX_METHOD_3_F261655D2C7A8441_OFFSET UNITYSDK_OFFSET(0x1D9A8F50)
#define RPG_GAMECORE_COMPLEXSKILLAIFACTORGROUPWEIGHTEX__CTOR_OFFSET UNITYSDK_OFFSET(0x1D9A8F40)
