...
#define RPG_GAMECORE_COMPLEXSKILLAIFACTORGROUPWEIGHTEX_METHOD_3_C10618C21B6B46D8_OFFSET UNITYSDK_OFFSET(0x1BC24FC0)
#define RPG_GAMECORE_COMPLEXSKILLAIFACTORGROUPWEIGHTEX_METHOD_3_F261655D2C7A8441_OFFSET UNITYSDK_OFFSET(0x1BC24E20)
#define RPG_GAMECORE_COMPLEXSKILLAIFACTORGROUPWEIGHTEX__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC24E10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAIFactorGroupWeightEx_TypeDefinitionIndex = 16957;
