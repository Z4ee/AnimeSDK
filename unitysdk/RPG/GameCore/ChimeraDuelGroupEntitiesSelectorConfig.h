...
#define RPG_GAMECORE_CHIMERADUELGROUPENTITIESSELECTORCONFIG_METHOD_3_5FD1F2D5D68582D3_OFFSET UNITYSDK_OFFSET(0x1709DD40)
#define RPG_GAMECORE_CHIMERADUELGROUPENTITIESSELECTORCONFIG_METHOD_3_B831C2366826247D_OFFSET UNITYSDK_OFFSET(0x1709DCE0)
#define RPG_GAMECORE_CHIMERADUELGROUPENTITIESSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1709DD30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelGroupEntitiesSelectorConfig_TypeDefinitionIndex = 14604;
