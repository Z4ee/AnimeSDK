...
#define RPG_GAMECORE_CHIMERADUELGROUPENTITIESSELECTORCONFIG_METHOD_3_5FD1F2D5D68582D3_OFFSET UNITYSDK_OFFSET(0x187FD0B0)
#define RPG_GAMECORE_CHIMERADUELGROUPENTITIESSELECTORCONFIG_METHOD_3_B831C2366826247D_OFFSET UNITYSDK_OFFSET(0x187FD050)
#define RPG_GAMECORE_CHIMERADUELGROUPENTITIESSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x187FD0A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelGroupEntitiesSelectorConfig_TypeDefinitionIndex = 15074;
