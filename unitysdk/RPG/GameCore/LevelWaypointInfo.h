...
#define RPG_GAMECORE_LEVELWAYPOINTINFO_METHOD_3_3FE8EFD692817C25_OFFSET UNITYSDK_OFFSET(0x1988BE60)
#define RPG_GAMECORE_LEVELWAYPOINTINFO_METHOD_3_85E2C203168D1194_OFFSET UNITYSDK_OFFSET(0x1988BE20)
#define RPG_GAMECORE_LEVELWAYPOINTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1988BE50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelWaypointInfo_TypeDefinitionIndex = 16401;
