...
#define RPG_GAMECORE_LEVELWAYPOINTINFO_METHOD_3_3FE8EFD692817C25_OFFSET UNITYSDK_OFFSET(0x18A52700)
#define RPG_GAMECORE_LEVELWAYPOINTINFO_METHOD_3_85E2C203168D1194_OFFSET UNITYSDK_OFFSET(0x18A5B010)
#define RPG_GAMECORE_LEVELWAYPOINTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18A526F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelWaypointInfo_TypeDefinitionIndex = 16370;
