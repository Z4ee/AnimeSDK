...
#define RPG_GAMECORE_BYCOMPARECHARACTERSPEED_METHOD_4_22BFA02F37A9F055_OFFSET UNITYSDK_OFFSET(0x19CD6D10)
#define RPG_GAMECORE_BYCOMPARECHARACTERSPEED_METHOD_4_2773DCAD18C3D795_OFFSET UNITYSDK_OFFSET(0x19CD6FA0)
#define RPG_GAMECORE_BYCOMPARECHARACTERSPEED_METHOD_4_34A9D7385F5B0B00_OFFSET UNITYSDK_OFFSET(0x19CD7000)
#define RPG_GAMECORE_BYCOMPARECHARACTERSPEED_METHOD_4_7E83DE384DC877C4_OFFSET UNITYSDK_OFFSET(0x19CD6C70)
#define RPG_GAMECORE_BYCOMPARECHARACTERSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x19CD6CD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareCharacterSpeed_TypeDefinitionIndex = 19472;
