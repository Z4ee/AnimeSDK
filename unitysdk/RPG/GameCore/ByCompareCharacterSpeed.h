...
#define RPG_GAMECORE_BYCOMPARECHARACTERSPEED_METHOD_4_22BFA02F37A9F055_OFFSET UNITYSDK_OFFSET(0x18728DF0)
#define RPG_GAMECORE_BYCOMPARECHARACTERSPEED_METHOD_4_7E83DE384DC877C4_OFFSET UNITYSDK_OFFSET(0x18728CD0)
#define RPG_GAMECORE_BYCOMPARECHARACTERSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x18728D70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareCharacterSpeed_TypeDefinitionIndex = 19190;
