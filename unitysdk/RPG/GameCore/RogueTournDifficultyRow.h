...
#define RPG_GAMECORE_ROGUETOURNDIFFICULTYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17664850)
#define RPG_GAMECORE_ROGUETOURNDIFFICULTYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x176649A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournDifficultyRow_TypeDefinitionIndex = 13689;
