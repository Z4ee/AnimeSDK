...
#define RPG_GAMECORE_DYNAMICJSON_METHOD_2_DAE7622CF8EB5B02_OFFSET UNITYSDK_OFFSET(0x1DB1C1C0)
#define RPG_GAMECORE_DYNAMICJSON__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB1C310)
