...
#define RPG_GAMECORE_MUSICRHYTHMNOTETEMPLATECONFIG_METHOD_2_96A905891A2253AF_OFFSET UNITYSDK_OFFSET(0x17468B80)
#define RPG_GAMECORE_MUSICRHYTHMNOTETEMPLATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17468BC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MusicRhythmNoteTemplateConfig_TypeDefinitionIndex = 15538;
