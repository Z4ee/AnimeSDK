...
#define RPG_GAMECORE_FORMATIONMOVECONFIG_METHOD_2_A133458F4B0E3BF9_OFFSET UNITYSDK_OFFSET(0x17218680)
#define RPG_GAMECORE_FORMATIONMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17218780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FormationMoveConfig_TypeDefinitionIndex = 14316;
