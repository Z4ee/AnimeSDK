...
#define RPG_GAMECORE_FATERINCASEBOARDEFFECTINFO_METHOD_2_23E4FE2A65689E08_OFFSET UNITYSDK_OFFSET(0x1D090290)
#define RPG_GAMECORE_FATERINCASEBOARDEFFECTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0904A0)
