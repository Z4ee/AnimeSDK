...
#define RPG_GAMECORE_FATERINCASEBOARDEFFECTINFO_METHOD_2_23E4FE2A65689E08_OFFSET UNITYSDK_OFFSET(0x1BA768F0)
#define RPG_GAMECORE_FATERINCASEBOARDEFFECTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA76B00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateRinCaseBoardEffectInfo_TypeDefinitionIndex = 19156;
