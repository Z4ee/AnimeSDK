...
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_MIN_METHOD_3_5B1FCA09765CF92A_OFFSET UNITYSDK_OFFSET(0x196A60A0)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_MIN_METHOD_3_C035FE42D604F00B_OFFSET UNITYSDK_OFFSET(0x196A6E30)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_MIN__CTOR_OFFSET UNITYSDK_OFFSET(0x196A6090)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatDiceSelectorConfig_Min_TypeDefinitionIndex = 15375;
