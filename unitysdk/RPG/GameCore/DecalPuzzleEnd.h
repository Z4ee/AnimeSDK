...
#define RPG_GAMECORE_DECALPUZZLEEND_METHOD_3_20F13A8F72ED8E89_OFFSET UNITYSDK_OFFSET(0x18857170)
#define RPG_GAMECORE_DECALPUZZLEEND_METHOD_3_AD0B6CB254E50815_OFFSET UNITYSDK_OFFSET(0x18857060)
#define RPG_GAMECORE_DECALPUZZLEEND__CTOR_OFFSET UNITYSDK_OFFSET(0x18857140)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DecalPuzzleEnd_TypeDefinitionIndex = 20182;
