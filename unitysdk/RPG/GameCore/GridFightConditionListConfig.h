...
#define RPG_GAMECORE_GRIDFIGHTCONDITIONLISTCONFIG_METHOD_2_EF36F5BCF7F6DB21_OFFSET UNITYSDK_OFFSET(0x189A5C10)
#define RPG_GAMECORE_GRIDFIGHTCONDITIONLISTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189A5C50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightConditionListConfig_TypeDefinitionIndex = 16712;
