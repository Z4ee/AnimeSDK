...
#define RPG_GAMECORE_SWITCHHANDSTATESYNC_METHOD_3_93E6C3F2727BAE7E_OFFSET UNITYSDK_OFFSET(0x17795AE0)
#define RPG_GAMECORE_SWITCHHANDSTATESYNC_METHOD_3_9D2D1C0AE705B36A_OFFSET UNITYSDK_OFFSET(0x17795BF0)
#define RPG_GAMECORE_SWITCHHANDSTATESYNC__CTOR_OFFSET UNITYSDK_OFFSET(0x17795BC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchHandStateSync_TypeDefinitionIndex = 19287;
