...
#define RPG_GAMECORE_SWITCHHANDSTATESYNC_METHOD_3_9D2D1C0AE705B36A_OFFSET UNITYSDK_OFFSET(0x1B436FF0)
#define RPG_GAMECORE_SWITCHHANDSTATESYNC_METHOD_3_B8E45897E6640B07_OFFSET UNITYSDK_OFFSET(0x1B436F20)
#define RPG_GAMECORE_SWITCHHANDSTATESYNC__CTOR_OFFSET UNITYSDK_OFFSET(0x1B436FE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchHandStateSync_TypeDefinitionIndex = 20169;
