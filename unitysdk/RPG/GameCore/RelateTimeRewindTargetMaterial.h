...
#define RPG_GAMECORE_RELATETIMEREWINDTARGETMATERIAL_METHOD_3_B6D4D6C0C45A4AE2_OFFSET UNITYSDK_OFFSET(0x1B9C1D70)
#define RPG_GAMECORE_RELATETIMEREWINDTARGETMATERIAL_METHOD_3_FD48701E6D077869_OFFSET UNITYSDK_OFFSET(0x1B9C1DB0)
#define RPG_GAMECORE_RELATETIMEREWINDTARGETMATERIAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9C1DA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RelateTimeRewindTargetMaterial_TypeDefinitionIndex = 19889;
