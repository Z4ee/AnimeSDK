...
#define RPG_GAMECORE_CHALLENGESTORYTHEMECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x187C47D0)
#define RPG_GAMECORE_CHALLENGESTORYTHEMECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x187C4A30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChallengeStoryThemeConfigRow_TypeDefinitionIndex = 12279;

	class ChallengeStoryThemeConfigRow : public ::System::Object
	{
	public:
		::System::String* ThemeSubColor2; // 0x10
		::System::String* ThemeSubColor1; // 0x18
		::System::String* ThemeEffColor; // 0x20
		::System::String* ThemePanelPrefabPath; // 0x28
		::System::String* ThemeMainColor; // 0x30
