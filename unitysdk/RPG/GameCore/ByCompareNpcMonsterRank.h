...
#define RPG_GAMECORE_BYCOMPARENPCMONSTERRANK_METHOD_4_53FD4634835A9909_OFFSET UNITYSDK_OFFSET(0x17011380)
#define RPG_GAMECORE_BYCOMPARENPCMONSTERRANK_METHOD_4_59040F8C3BA882B6_OFFSET UNITYSDK_OFFSET(0x17011460)
#define RPG_GAMECORE_BYCOMPARENPCMONSTERRANK__CTOR_OFFSET UNITYSDK_OFFSET(0x17011400)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareNpcMonsterRank_TypeDefinitionIndex = 19111;
