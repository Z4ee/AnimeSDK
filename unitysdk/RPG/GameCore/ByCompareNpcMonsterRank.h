...
#define RPG_GAMECORE_BYCOMPARENPCMONSTERRANK_METHOD_4_2378A679F8734943_OFFSET UNITYSDK_OFFSET(0x19CFAD40)
#define RPG_GAMECORE_BYCOMPARENPCMONSTERRANK_METHOD_4_35EE094DB9C5B5E9_OFFSET UNITYSDK_OFFSET(0x19CFAF90)
#define RPG_GAMECORE_BYCOMPARENPCMONSTERRANK_METHOD_4_59040F8C3BA882B6_OFFSET UNITYSDK_OFFSET(0x19CFAD90)
#define RPG_GAMECORE_BYCOMPARENPCMONSTERRANK_METHOD_4_F6BB7EC9A3A5F86F_OFFSET UNITYSDK_OFFSET(0x19CFAFD0)
#define RPG_GAMECORE_BYCOMPARENPCMONSTERRANK__CTOR_OFFSET UNITYSDK_OFFSET(0x19CFAD80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareNpcMonsterRank_TypeDefinitionIndex = 20005;
