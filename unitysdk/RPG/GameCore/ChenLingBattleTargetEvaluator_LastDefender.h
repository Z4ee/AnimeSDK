...
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_LASTDEFENDER_METHOD_3_BD3CA5D54AD401F0_OFFSET UNITYSDK_OFFSET(0x187E6D10)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_LASTDEFENDER_METHOD_3_CB18E8EDE27D4C75_OFFSET UNITYSDK_OFFSET(0x187E6C70)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_LASTDEFENDER__CTOR_OFFSET UNITYSDK_OFFSET(0x187E6D00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleTargetEvaluator_LastDefender_TypeDefinitionIndex = 14932;
