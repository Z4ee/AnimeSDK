...
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_LASTDEFENDER_METHOD_3_BD3CA5D54AD401F0_OFFSET UNITYSDK_OFFSET(0x17081C00)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_LASTDEFENDER_METHOD_3_CB18E8EDE27D4C75_OFFSET UNITYSDK_OFFSET(0x17081B60)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_LASTDEFENDER__CTOR_OFFSET UNITYSDK_OFFSET(0x17081BF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleTargetEvaluator_LastDefender_TypeDefinitionIndex = 14462;
