...
#define RPG_GAMECORE_OPTICALILLUSIONEXITPERFORMANCE_METHOD_3_20422BDD15C10751_OFFSET UNITYSDK_OFFSET(0x1747F1F0)
#define RPG_GAMECORE_OPTICALILLUSIONEXITPERFORMANCE_METHOD_3_595CAC2CAB75965F_OFFSET UNITYSDK_OFFSET(0x1747F0A0)
#define RPG_GAMECORE_OPTICALILLUSIONEXITPERFORMANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1747F160)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OpticalIllusionExitPerformance_TypeDefinitionIndex = 20414;
