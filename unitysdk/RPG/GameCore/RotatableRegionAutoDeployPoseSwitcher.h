...
#define RPG_GAMECORE_ROTATABLEREGIONAUTODEPLOYPOSESWITCHER_METHOD_3_01B3DD63ECC3A621_OFFSET UNITYSDK_OFFSET(0x1BB83300)
#define RPG_GAMECORE_ROTATABLEREGIONAUTODEPLOYPOSESWITCHER_METHOD_3_8845814FD862F7FD_OFFSET UNITYSDK_OFFSET(0x1BB832B0)
#define RPG_GAMECORE_ROTATABLEREGIONAUTODEPLOYPOSESWITCHER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB832F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RotatableRegionAutoDeployPoseSwitcher_TypeDefinitionIndex = 20465;
