...
#define RPG_GAMECORE_ROTATABLEREGIONAUTODEPLOYPOSESWITCHER_METHOD_3_01B3DD63ECC3A621_OFFSET UNITYSDK_OFFSET(0x176747C0)
#define RPG_GAMECORE_ROTATABLEREGIONAUTODEPLOYPOSESWITCHER_METHOD_3_383C4F98F2740871_OFFSET UNITYSDK_OFFSET(0x17674730)
#define RPG_GAMECORE_ROTATABLEREGIONAUTODEPLOYPOSESWITCHER__CTOR_OFFSET UNITYSDK_OFFSET(0x17674790)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RotatableRegionAutoDeployPoseSwitcher_TypeDefinitionIndex = 19561;
