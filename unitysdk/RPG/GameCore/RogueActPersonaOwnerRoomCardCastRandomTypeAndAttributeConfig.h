...
#define RPG_GAMECORE_ROGUEACTPERSONAOWNERROOMCARDCASTRANDOMTYPEANDATTRIBUTECONFIG_METHOD_7_B494C196EA5271D2_OFFSET UNITYSDK_OFFSET(0x19AEE070)
#define RPG_GAMECORE_ROGUEACTPERSONAOWNERROOMCARDCASTRANDOMTYPEANDATTRIBUTECONFIG_METHOD_7_FAD72D1F4DC9F747_OFFSET UNITYSDK_OFFSET(0x19AEE590)
#define RPG_GAMECORE_ROGUEACTPERSONAOWNERROOMCARDCASTRANDOMTYPEANDATTRIBUTECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AEDF90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaOwnerRoomCardCastRandomTypeAndAttributeConfig_TypeDefinitionIndex = 18725;
