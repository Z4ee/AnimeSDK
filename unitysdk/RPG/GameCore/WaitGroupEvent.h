...
#define RPG_GAMECORE_WAITGROUPEVENT_METHOD_4_88885C73CE8EC5EA_OFFSET UNITYSDK_OFFSET(0x190FF530)
#define RPG_GAMECORE_WAITGROUPEVENT_METHOD_4_DA2CE388B41568E0_OFFSET UNITYSDK_OFFSET(0x190FF450)
#define RPG_GAMECORE_WAITGROUPEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x190FF4D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitGroupEvent_TypeDefinitionIndex = 20170;
