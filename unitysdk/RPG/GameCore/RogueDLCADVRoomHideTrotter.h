...
#define RPG_GAMECORE_ROGUEDLCADVROOMHIDETROTTER_METHOD_3_873339EBA2B7E38D_OFFSET UNITYSDK_OFFSET(0x18CFE110)
#define RPG_GAMECORE_ROGUEDLCADVROOMHIDETROTTER_METHOD_3_B2B43234FD1CFF2C_OFFSET UNITYSDK_OFFSET(0x18CFE090)
#define RPG_GAMECORE_ROGUEDLCADVROOMHIDETROTTER__CTOR_OFFSET UNITYSDK_OFFSET(0x18CFE0E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueDLCADVRoomHideTrotter_TypeDefinitionIndex = 21155;
