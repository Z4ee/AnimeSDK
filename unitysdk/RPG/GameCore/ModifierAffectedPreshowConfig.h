...
#define RPG_GAMECORE_MODIFIERAFFECTEDPRESHOWCONFIG_METHOD_2_D2C6137E74341612_OFFSET UNITYSDK_OFFSET(0x1D2A9EA0)
#define RPG_GAMECORE_MODIFIERAFFECTEDPRESHOWCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2AA150)
