...
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_LASTATTACKER_METHOD_3_30E0121D74916F64_OFFSET UNITYSDK_OFFSET(0x1CFAD230)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_LASTATTACKER_METHOD_3_BB77F3891B2EADB9_OFFSET UNITYSDK_OFFSET(0x1CFAD190)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_LASTATTACKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFAD220)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleTargetEvaluator_LastAttacker_TypeDefinitionIndex = 15587;
