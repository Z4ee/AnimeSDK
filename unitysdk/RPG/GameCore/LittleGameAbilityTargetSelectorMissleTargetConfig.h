...
#define RPG_GAMECORE_LITTLEGAMEABILITYTARGETSELECTORMISSLETARGETCONFIG_METHOD_3_3CEDABD6AD3F514A_OFFSET UNITYSDK_OFFSET(0x1D1FC6A0)
#define RPG_GAMECORE_LITTLEGAMEABILITYTARGETSELECTORMISSLETARGETCONFIG_METHOD_3_B4399EFC85A9F7AB_OFFSET UNITYSDK_OFFSET(0x1D1FC600)
#define RPG_GAMECORE_LITTLEGAMEABILITYTARGETSELECTORMISSLETARGETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1FC690)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityTargetSelectorMissleTargetConfig_TypeDefinitionIndex = 21126;
