...
#define RPG_GAMECORE_REMOVEMODIFIERBYBEHAVIORFLAG_METHOD_3_0974556B08999E79_OFFSET UNITYSDK_OFFSET(0x175991F0)
#define RPG_GAMECORE_REMOVEMODIFIERBYBEHAVIORFLAG_METHOD_3_E4C9DC360258772A_OFFSET UNITYSDK_OFFSET(0x17599270)
#define RPG_GAMECORE_REMOVEMODIFIERBYBEHAVIORFLAG__CTOR_OFFSET UNITYSDK_OFFSET(0x17599240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveModifierByBehaviorFlag_TypeDefinitionIndex = 21298;
