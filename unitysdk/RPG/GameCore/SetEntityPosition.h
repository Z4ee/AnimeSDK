...
#define RPG_GAMECORE_SETENTITYPOSITION_METHOD_3_3351536FCE1C3E11_OFFSET UNITYSDK_OFFSET(0x176CBD50)
#define RPG_GAMECORE_SETENTITYPOSITION_METHOD_3_3D44CB3BB23C6241_OFFSET UNITYSDK_OFFSET(0x176CBE30)
#define RPG_GAMECORE_SETENTITYPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x176CBDD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetEntityPosition_TypeDefinitionIndex = 22024;
