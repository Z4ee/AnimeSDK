...
#define RPG_GAMECORE_AIBEHAVIORFLAGSELECTOR_METHOD_3_0FF4BC8DE0259745_OFFSET UNITYSDK_OFFSET(0x16E8E9C0)
#define RPG_GAMECORE_AIBEHAVIORFLAGSELECTOR_METHOD_3_49F6FF36F9279FC2_OFFSET UNITYSDK_OFFSET(0x16E8E980)
#define RPG_GAMECORE_AIBEHAVIORFLAGSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x16E8E9B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AIBehaviorFlagSelector_TypeDefinitionIndex = 14294;
