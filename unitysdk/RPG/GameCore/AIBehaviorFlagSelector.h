...
#define RPG_GAMECORE_AIBEHAVIORFLAGSELECTOR_METHOD_3_0FF4BC8DE0259745_OFFSET UNITYSDK_OFFSET(0x193BFD20)
#define RPG_GAMECORE_AIBEHAVIORFLAGSELECTOR_METHOD_3_49F6FF36F9279FC2_OFFSET UNITYSDK_OFFSET(0x193BFCE0)
#define RPG_GAMECORE_AIBEHAVIORFLAGSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x193BFD10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AIBehaviorFlagSelector_TypeDefinitionIndex = 14829;
