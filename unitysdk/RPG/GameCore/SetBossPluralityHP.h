...
#define RPG_GAMECORE_SETBOSSPLURALITYHP_METHOD_3_BEC26B70E33779F3_OFFSET UNITYSDK_OFFSET(0x1C2D6760)
#define RPG_GAMECORE_SETBOSSPLURALITYHP_METHOD_3_E4584CCF3A8C97E0_OFFSET UNITYSDK_OFFSET(0x1C2D6670)
#define RPG_GAMECORE_SETBOSSPLURALITYHP__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2D6700)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetBossPluralityHP_TypeDefinitionIndex = 22113;
