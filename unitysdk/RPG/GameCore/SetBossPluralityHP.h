...
#define RPG_GAMECORE_SETBOSSPLURALITYHP_METHOD_3_0D839C3ECD9777A9_OFFSET UNITYSDK_OFFSET(0x18E0E560)
#define RPG_GAMECORE_SETBOSSPLURALITYHP_METHOD_3_BEC26B70E33779F3_OFFSET UNITYSDK_OFFSET(0x18E0E680)
#define RPG_GAMECORE_SETBOSSPLURALITYHP__CTOR_OFFSET UNITYSDK_OFFSET(0x18E0E600)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetBossPluralityHP_TypeDefinitionIndex = 21858;
