...
#define RPG_GAMECORE_SCREENTRANSFERSINGLETEXTINFO_METHOD_2_49887C9D43397F2E_OFFSET UNITYSDK_OFFSET(0x1769DC60)
#define RPG_GAMECORE_SCREENTRANSFERSINGLETEXTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1769DD00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ScreenTransferSingleTextInfo_TypeDefinitionIndex = 19183;
