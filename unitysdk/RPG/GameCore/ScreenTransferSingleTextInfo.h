...
#define RPG_GAMECORE_SCREENTRANSFERSINGLETEXTINFO_METHOD_2_49887C9D43397F2E_OFFSET UNITYSDK_OFFSET(0x1D4D7A20)
#define RPG_GAMECORE_SCREENTRANSFERSINGLETEXTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4D7AC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ScreenTransferSingleTextInfo_TypeDefinitionIndex = 20618;
