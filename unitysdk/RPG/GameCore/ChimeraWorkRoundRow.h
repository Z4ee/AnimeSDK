...
#define RPG_GAMECORE_CHIMERAWORKROUNDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1E343440)
#define RPG_GAMECORE_CHIMERAWORKROUNDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1E3437C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraWorkRoundRow_TypeDefinitionIndex = 12917;

	class ChimeraWorkRoundRow : public ::System::Object
	{
	public:
		::Il2CppArray<::System::UInt32>* RecommendedArrangementPresets; // 0x10
		::Il2CppArray<::System::UInt32>* WorkList; // 0x18
