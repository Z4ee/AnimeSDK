...
#define RPG_GAMECORE_SWITCHREFSERVERPROPSTATE_METHOD_3_7F1977E5F5DA26AE_OFFSET UNITYSDK_OFFSET(0x19CE0080)
#define RPG_GAMECORE_SWITCHREFSERVERPROPSTATE_METHOD_3_F9D918A742F56F1B_OFFSET UNITYSDK_OFFSET(0x19CDF980)
#define RPG_GAMECORE_SWITCHREFSERVERPROPSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19CDF970)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchRefServerPropState_TypeDefinitionIndex = 16670;
