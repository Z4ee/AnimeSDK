...
#define RPG_GAMECORE_SWITCHREFSERVERPROPSTATE_METHOD_3_7F1977E5F5DA26AE_OFFSET UNITYSDK_OFFSET(0x17799FD0)
#define RPG_GAMECORE_SWITCHREFSERVERPROPSTATE_METHOD_3_F9D918A742F56F1B_OFFSET UNITYSDK_OFFSET(0x177998D0)
#define RPG_GAMECORE_SWITCHREFSERVERPROPSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x177998C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchRefServerPropState_TypeDefinitionIndex = 16109;
