...
#define RPG_GAMECORE_POLYMERCHILDOBJ_METHOD_3_218C3E658CA1BD77_OFFSET UNITYSDK_OFFSET(0x174EC3F0)
#define RPG_GAMECORE_POLYMERCHILDOBJ_METHOD_3_2C1FACA4F64BF1C1_OFFSET UNITYSDK_OFFSET(0x174EC3B0)
#define RPG_GAMECORE_POLYMERCHILDOBJ__CTOR_OFFSET UNITYSDK_OFFSET(0x174EC3E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PolymerChildObj_TypeDefinitionIndex = 17514;
