...
#define RPG_GAMECORE_ADVNPCGUARDALERTDEVICEACTIVE_METHOD_3_0DA80098E6015B4C_OFFSET UNITYSDK_OFFSET(0x1BE24F20)
#define RPG_GAMECORE_ADVNPCGUARDALERTDEVICEACTIVE_METHOD_3_2117AB2227B0BC99_OFFSET UNITYSDK_OFFSET(0x1BE24EE0)
#define RPG_GAMECORE_ADVNPCGUARDALERTDEVICEACTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE24F10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvNpcGuardAlertDeviceActive_TypeDefinitionIndex = 19218;
