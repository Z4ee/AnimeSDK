...
#define RPG_GAMECORE_ROGUEACTDESTROYMIRACLEANDADDCOINCONFIG_METHOD_6_36256F6C29220974_OFFSET UNITYSDK_OFFSET(0x19AE42F0)
#define RPG_GAMECORE_ROGUEACTDESTROYMIRACLEANDADDCOINCONFIG_METHOD_6_BBE3833491D631D9_OFFSET UNITYSDK_OFFSET(0x19AE40D0)
#define RPG_GAMECORE_ROGUEACTDESTROYMIRACLEANDADDCOINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AE4210)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActDestroyMiracleAndAddCoinConfig_TypeDefinitionIndex = 18669;
