...
#define RPG_GAMECORE_LEVELEVOLVEBUILDEXPSTEPUP_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xE693470)
#define RPG_GAMECORE_LEVELEVOLVEBUILDEXPSTEPUP_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xE693420)
#define RPG_GAMECORE_LEVELEVOLVEBUILDEXPSTEPUP_GET_NEWSTEP_OFFSET UNITYSDK_OFFSET(0xE6934E0)
#define RPG_GAMECORE_LEVELEVOLVEBUILDEXPSTEPUP_GET_OLDSTEP_OFFSET UNITYSDK_OFFSET(0xE6934C0)
#define RPG_GAMECORE_LEVELEVOLVEBUILDEXPSTEPUP_INIT_OFFSET UNITYSDK_OFFSET(0xE6933C0)
#define RPG_GAMECORE_LEVELEVOLVEBUILDEXPSTEPUP_SET_NEWSTEP_OFFSET UNITYSDK_OFFSET(0xE6934F0)
#define RPG_GAMECORE_LEVELEVOLVEBUILDEXPSTEPUP_SET_OLDSTEP_OFFSET UNITYSDK_OFFSET(0xE6934D0)
#define RPG_GAMECORE_LEVELEVOLVEBUILDEXPSTEPUP__CTOR_OFFSET UNITYSDK_OFFSET(0xE693500)
