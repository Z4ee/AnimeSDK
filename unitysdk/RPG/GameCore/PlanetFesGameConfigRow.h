...
#define RPG_GAMECORE_PLANETFESGAMECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D79D370)
#define RPG_GAMECORE_PLANETFESGAMECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D79D580)
