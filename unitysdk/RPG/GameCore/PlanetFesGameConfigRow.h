...
#define RPG_GAMECORE_PLANETFESGAMECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B4D74F0)
#define RPG_GAMECORE_PLANETFESGAMECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4D7700)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlanetFesGameConfigRow_TypeDefinitionIndex = 11772;
