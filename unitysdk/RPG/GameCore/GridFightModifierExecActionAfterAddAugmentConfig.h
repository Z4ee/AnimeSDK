...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERADDAUGMENTCONFIG_METHOD_3_2C5CBBEA1B4FABC5_OFFSET UNITYSDK_OFFSET(0x1C5D0C80)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERADDAUGMENTCONFIG_METHOD_3_CC7E45C078AAB461_OFFSET UNITYSDK_OFFSET(0x1C5D0C30)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERADDAUGMENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5D0C70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierExecActionAfterAddAugmentConfig_TypeDefinitionIndex = 18716;
