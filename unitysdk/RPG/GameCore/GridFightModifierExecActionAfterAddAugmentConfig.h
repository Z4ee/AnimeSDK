...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERADDAUGMENTCONFIG_METHOD_3_2C5CBBEA1B4FABC5_OFFSET UNITYSDK_OFFSET(0x197EB770)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERADDAUGMENTCONFIG_METHOD_3_2E76316A8153102C_OFFSET UNITYSDK_OFFSET(0x197F16A0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERADDAUGMENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197EB720)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierExecActionAfterAddAugmentConfig_TypeDefinitionIndex = 18466;
