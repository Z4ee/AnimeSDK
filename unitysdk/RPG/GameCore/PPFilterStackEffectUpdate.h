...
#define RPG_GAMECORE_PPFILTERSTACKEFFECTUPDATE_METHOD_3_586F8992622F031B_OFFSET UNITYSDK_OFFSET(0x18BCEF70)
#define RPG_GAMECORE_PPFILTERSTACKEFFECTUPDATE_METHOD_3_ADCBE8690F006773_OFFSET UNITYSDK_OFFSET(0x18BCEED0)
#define RPG_GAMECORE_PPFILTERSTACKEFFECTUPDATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18BCEF30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PPFilterStackEffectUpdate_TypeDefinitionIndex = 19200;
