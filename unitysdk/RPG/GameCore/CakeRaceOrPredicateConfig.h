...
#define RPG_GAMECORE_CAKERACEORPREDICATECONFIG_METHOD_3_0E47CAE8301634F0_OFFSET UNITYSDK_OFFSET(0x1B704810)
#define RPG_GAMECORE_CAKERACEORPREDICATECONFIG_METHOD_3_F3B95642F3B5C738_OFFSET UNITYSDK_OFFSET(0x1B7047B0)
#define RPG_GAMECORE_CAKERACEORPREDICATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B704800)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceOrPredicateConfig_TypeDefinitionIndex = 17641;
