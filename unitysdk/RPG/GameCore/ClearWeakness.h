...
#define RPG_GAMECORE_CLEARWEAKNESS_METHOD_3_137B14CF766028DF_OFFSET UNITYSDK_OFFSET(0x170B3CB0)
#define RPG_GAMECORE_CLEARWEAKNESS_METHOD_3_19CFF11432B9D1EC_OFFSET UNITYSDK_OFFSET(0x170B3D30)
#define RPG_GAMECORE_CLEARWEAKNESS__CTOR_OFFSET UNITYSDK_OFFSET(0x170B3D00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClearWeakness_TypeDefinitionIndex = 21291;
