...
#define RPG_GAMECORE_LOADCHARACTERSTATE_METHOD_3_2AD78D88B39F803C_OFFSET UNITYSDK_OFFSET(0x18A71900)
#define RPG_GAMECORE_LOADCHARACTERSTATE_METHOD_3_514857E556AAEC98_OFFSET UNITYSDK_OFFSET(0x18A71810)
#define RPG_GAMECORE_LOADCHARACTERSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18A718A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoadCharacterState_TypeDefinitionIndex = 21662;
