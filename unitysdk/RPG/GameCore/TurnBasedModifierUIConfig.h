...
#define RPG_GAMECORE_TURNBASEDMODIFIERUICONFIG_METHOD_2_8123D29418BDE619_OFFSET UNITYSDK_OFFSET(0x1D60F050)
#define RPG_GAMECORE_TURNBASEDMODIFIERUICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D60FA30)
