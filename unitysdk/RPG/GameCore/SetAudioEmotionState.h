...
#define RPG_GAMECORE_SETAUDIOEMOTIONSTATE_METHOD_3_4EF1C3C3C503D216_OFFSET UNITYSDK_OFFSET(0x176A7AF0)
#define RPG_GAMECORE_SETAUDIOEMOTIONSTATE_METHOD_3_D43243ED791EA3C7_OFFSET UNITYSDK_OFFSET(0x176A7B70)
#define RPG_GAMECORE_SETAUDIOEMOTIONSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x176A7B40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetAudioEmotionState_TypeDefinitionIndex = 19071;
