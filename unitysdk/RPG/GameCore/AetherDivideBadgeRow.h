...
#define RPG_GAMECORE_AETHERDIVIDEBADGEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19458570)
#define RPG_GAMECORE_AETHERDIVIDEBADGEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19458BA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AetherDivideBadgeRow_TypeDefinitionIndex = 10531;
