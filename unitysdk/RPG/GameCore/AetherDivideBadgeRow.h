...
#define RPG_GAMECORE_AETHERDIVIDEBADGEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1AE66C10)
#define RPG_GAMECORE_AETHERDIVIDEBADGEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE67240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AetherDivideBadgeRow_TypeDefinitionIndex = 10579;
	...
	public:
		...
		::System::UInt32 MaxSpiritLevel; // 0x18
