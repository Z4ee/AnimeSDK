...
#define RPG_GAMECORE_AETHERDIVIDEBADGEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CBC2A90)
#define RPG_GAMECORE_AETHERDIVIDEBADGEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CBC30C0)
