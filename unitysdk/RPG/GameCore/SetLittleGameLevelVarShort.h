...
#define RPG_GAMECORE_SETLITTLEGAMELEVELVARSHORT_METHOD_3_8A534834B69B54D5_OFFSET UNITYSDK_OFFSET(0x1D503C30)
#define RPG_GAMECORE_SETLITTLEGAMELEVELVARSHORT_METHOD_3_A6275B8A80C7ABC0_OFFSET UNITYSDK_OFFSET(0x1D503BF0)
#define RPG_GAMECORE_SETLITTLEGAMELEVELVARSHORT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D503C20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetLittleGameLevelVarShort_TypeDefinitionIndex = 21179;
