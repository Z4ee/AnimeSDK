...
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAQINGQUESTYLECONFIG_METHOD_3_7BC9C76041E685BB_OFFSET UNITYSDK_OFFSET(0x19B99FD0)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAQINGQUESTYLECONFIG_METHOD_3_98E7C334B763D9A2_OFFSET UNITYSDK_OFFSET(0x19B99F00)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAQINGQUESTYLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B99F80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierPersonaQingQueStyleConfig_TypeDefinitionIndex = 16939;
