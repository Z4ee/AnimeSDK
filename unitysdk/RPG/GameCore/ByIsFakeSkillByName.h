...
#define RPG_GAMECORE_BYISFAKESKILLBYNAME_METHOD_4_7EB68258E8154814_OFFSET UNITYSDK_OFFSET(0x18752920)
#define RPG_GAMECORE_BYISFAKESKILLBYNAME_METHOD_4_DB436A1AB89C214F_OFFSET UNITYSDK_OFFSET(0x18752A40)
#define RPG_GAMECORE_BYISFAKESKILLBYNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x187529C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsFakeSkillByName_TypeDefinitionIndex = 21931;
