...
#define RPG_GAMECORE_BYISFAKESKILLBYNAME_METHOD_4_4EEB3AB386CEF9F4_OFFSET UNITYSDK_OFFSET(0x1A8E2070)
#define RPG_GAMECORE_BYISFAKESKILLBYNAME_METHOD_4_726EE8F616116C85_OFFSET UNITYSDK_OFFSET(0x1A8E20D0)
#define RPG_GAMECORE_BYISFAKESKILLBYNAME_METHOD_4_DB436A1AB89C214F_OFFSET UNITYSDK_OFFSET(0x1A8E1EB0)
#define RPG_GAMECORE_BYISFAKESKILLBYNAME_METHOD_4_F45B0F7FC9441B02_OFFSET UNITYSDK_OFFSET(0x1A8E1E10)
#define RPG_GAMECORE_BYISFAKESKILLBYNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8E1E70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsFakeSkillByName_TypeDefinitionIndex = 22180;
