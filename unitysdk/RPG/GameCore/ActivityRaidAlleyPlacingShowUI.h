...
#define RPG_GAMECORE_ACTIVITYRAIDALLEYPLACINGSHOWUI_METHOD_3_66492B7F94819920_OFFSET UNITYSDK_OFFSET(0x16F0B7F0)
#define RPG_GAMECORE_ACTIVITYRAIDALLEYPLACINGSHOWUI_METHOD_3_ED7FF784F30CEE33_OFFSET UNITYSDK_OFFSET(0x16F0B870)
#define RPG_GAMECORE_ACTIVITYRAIDALLEYPLACINGSHOWUI__CTOR_OFFSET UNITYSDK_OFFSET(0x16F0B840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityRaidAlleyPlacingShowUI_TypeDefinitionIndex = 19486;
