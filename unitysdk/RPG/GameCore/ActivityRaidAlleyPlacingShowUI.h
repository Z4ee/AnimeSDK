...
#define RPG_GAMECORE_ACTIVITYRAIDALLEYPLACINGSHOWUI_METHOD_3_3CD06B52C326BCEE_OFFSET UNITYSDK_OFFSET(0x1AB04EA0)
#define RPG_GAMECORE_ACTIVITYRAIDALLEYPLACINGSHOWUI_METHOD_3_ED7FF784F30CEE33_OFFSET UNITYSDK_OFFSET(0x1AB04EE0)
#define RPG_GAMECORE_ACTIVITYRAIDALLEYPLACINGSHOWUI__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB04ED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityRaidAlleyPlacingShowUI_TypeDefinitionIndex = 20390;
