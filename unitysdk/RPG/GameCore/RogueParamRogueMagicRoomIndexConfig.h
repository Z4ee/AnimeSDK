...
#define RPG_GAMECORE_ROGUEPARAMROGUEMAGICROOMINDEXCONFIG_METHOD_6_EA95EC22DCEDB261_OFFSET UNITYSDK_OFFSET(0x1D40D250)
#define RPG_GAMECORE_ROGUEPARAMROGUEMAGICROOMINDEXCONFIG_METHOD_6_EA9DF75E46172F3D_OFFSET UNITYSDK_OFFSET(0x1D40D200)
#define RPG_GAMECORE_ROGUEPARAMROGUEMAGICROOMINDEXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D40D240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamRogueMagicRoomIndexConfig_TypeDefinitionIndex = 19607;
