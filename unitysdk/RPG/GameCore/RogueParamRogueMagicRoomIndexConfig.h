...
#define RPG_GAMECORE_ROGUEPARAMROGUEMAGICROOMINDEXCONFIG_METHOD_6_68808FD61ACDA6F7_OFFSET UNITYSDK_OFFSET(0x1764D4B0)
#define RPG_GAMECORE_ROGUEPARAMROGUEMAGICROOMINDEXCONFIG_METHOD_6_EA95EC22DCEDB261_OFFSET UNITYSDK_OFFSET(0x1764D760)
#define RPG_GAMECORE_ROGUEPARAMROGUEMAGICROOMINDEXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1764D630)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamRogueMagicRoomIndexConfig_TypeDefinitionIndex = 18178;
