...
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_RANDOMNSOLDIERS_METHOD_3_0E33905BC1887B77_OFFSET UNITYSDK_OFFSET(0x1CFAD8B0)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_RANDOMNSOLDIERS_METHOD_3_49E0A78AC2D9404B_OFFSET UNITYSDK_OFFSET(0x1CFAD850)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_RANDOMNSOLDIERS__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFAD8A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleTargetEvaluator_RandomNSoldiers_TypeDefinitionIndex = 15594;
