...
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_RANDOMNSOLDIERS_METHOD_3_0E33905BC1887B77_OFFSET UNITYSDK_OFFSET(0x187E7290)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_RANDOMNSOLDIERS_METHOD_3_49E0A78AC2D9404B_OFFSET UNITYSDK_OFFSET(0x187E7230)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_RANDOMNSOLDIERS__CTOR_OFFSET UNITYSDK_OFFSET(0x187E7280)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleTargetEvaluator_RandomNSoldiers_TypeDefinitionIndex = 14930;
