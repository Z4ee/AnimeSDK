...
#define RPG_GAMECORE_TARGETFETCHNORMALPAM_METHOD_4_9DD4F0CBD20A908B_OFFSET UNITYSDK_OFFSET(0x18EDE920)
#define RPG_GAMECORE_TARGETFETCHNORMALPAM_METHOD_4_B9DDACC7A11B543D_OFFSET UNITYSDK_OFFSET(0x18EE50D0)
#define RPG_GAMECORE_TARGETFETCHNORMALPAM__CTOR_OFFSET UNITYSDK_OFFSET(0x18EDE8D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchNormalPam_TypeDefinitionIndex = 22863;
