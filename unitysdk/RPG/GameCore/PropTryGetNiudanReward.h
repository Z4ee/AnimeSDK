...
#define RPG_GAMECORE_PROPTRYGETNIUDANREWARD_METHOD_3_158B6F4B823EB69C_OFFSET UNITYSDK_OFFSET(0x1D189380)
#define RPG_GAMECORE_PROPTRYGETNIUDANREWARD_METHOD_3_F8A99638823AB037_OFFSET UNITYSDK_OFFSET(0x1D1893C0)
#define RPG_GAMECORE_PROPTRYGETNIUDANREWARD__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1893B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropTryGetNiudanReward_TypeDefinitionIndex = 21722;
