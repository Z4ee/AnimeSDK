...
#define RPG_GAMECORE_PROPTRYGETNIUDANREWARD_METHOD_3_A57ED3CE4C2DF419_OFFSET UNITYSDK_OFFSET(0x19A9EE80)
#define RPG_GAMECORE_PROPTRYGETNIUDANREWARD_METHOD_3_F8A99638823AB037_OFFSET UNITYSDK_OFFSET(0x19A9EF00)
#define RPG_GAMECORE_PROPTRYGETNIUDANREWARD__CTOR_OFFSET UNITYSDK_OFFSET(0x19A9EED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropTryGetNiudanReward_TypeDefinitionIndex = 20747;
