...
#define RPG_GAMECORE_ADVENTUREATTACKDETECTBOXCONFIG_METHOD_3_9415467399FD0A2A_OFFSET UNITYSDK_OFFSET(0x1AE4C020)
#define RPG_GAMECORE_ADVENTUREATTACKDETECTBOXCONFIG_METHOD_3_B1DA636E205CE9BD_OFFSET UNITYSDK_OFFSET(0x1AE4C060)
#define RPG_GAMECORE_ADVENTUREATTACKDETECTBOXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE4C050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureAttackDetectBoxConfig_TypeDefinitionIndex = 15632;
