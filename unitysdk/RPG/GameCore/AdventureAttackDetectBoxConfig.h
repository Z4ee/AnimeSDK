...
#define RPG_GAMECORE_ADVENTUREATTACKDETECTBOXCONFIG_METHOD_3_9415467399FD0A2A_OFFSET UNITYSDK_OFFSET(0x1CBA7FA0)
#define RPG_GAMECORE_ADVENTUREATTACKDETECTBOXCONFIG_METHOD_3_B1DA636E205CE9BD_OFFSET UNITYSDK_OFFSET(0x1CBA7FE0)
#define RPG_GAMECORE_ADVENTUREATTACKDETECTBOXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CBA7FD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureAttackDetectBoxConfig_TypeDefinitionIndex = 16101;
