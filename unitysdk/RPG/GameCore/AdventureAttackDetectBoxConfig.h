...
#define RPG_GAMECORE_ADVENTUREATTACKDETECTBOXCONFIG_METHOD_3_9415467399FD0A2A_OFFSET UNITYSDK_OFFSET(0x1866D0D0)
#define RPG_GAMECORE_ADVENTUREATTACKDETECTBOXCONFIG_METHOD_3_B1DA636E205CE9BD_OFFSET UNITYSDK_OFFSET(0x1866D110)
#define RPG_GAMECORE_ADVENTUREATTACKDETECTBOXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1866D100)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureAttackDetectBoxConfig_TypeDefinitionIndex = 15398;
