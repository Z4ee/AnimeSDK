...
#define RPG_GAMECORE_ROGUEACTGETROGUEMIRACLECOUNTBYPARAMCONFIG_METHOD_6_265001131DA47C77_OFFSET UNITYSDK_OFFSET(0x19AE8220)
#define RPG_GAMECORE_ROGUEACTGETROGUEMIRACLECOUNTBYPARAMCONFIG_METHOD_6_88B10FEE9E61A682_OFFSET UNITYSDK_OFFSET(0x19AE8440)
#define RPG_GAMECORE_ROGUEACTGETROGUEMIRACLECOUNTBYPARAMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AE8360)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActGetRogueMiracleCountByParamConfig_TypeDefinitionIndex = 18571;
