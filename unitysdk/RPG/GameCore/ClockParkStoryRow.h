...
#define RPG_GAMECORE_CLOCKPARKSTORYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x170C0DD0)
#define RPG_GAMECORE_CLOCKPARKSTORYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x170C1510)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClockParkStoryRow_TypeDefinitionIndex = 10457;
