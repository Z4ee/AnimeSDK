...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDCOINBYBPINBATTLECONFIG_METHOD_3_13F8F0098AD33CD0_OFFSET UNITYSDK_OFFSET(0x1C5CFAE0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDCOINBYBPINBATTLECONFIG_METHOD_3_F7ACA591D78886D4_OFFSET UNITYSDK_OFFSET(0x1C5CFA90)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDCOINBYBPINBATTLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5CFAD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierAddCoinByBpInBattleConfig_TypeDefinitionIndex = 18708;
