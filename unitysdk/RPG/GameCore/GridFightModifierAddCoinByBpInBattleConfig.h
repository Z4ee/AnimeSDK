...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDCOINBYBPINBATTLECONFIG_METHOD_3_13F8F0098AD33CD0_OFFSET UNITYSDK_OFFSET(0x197E80E0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDCOINBYBPINBATTLECONFIG_METHOD_3_7E000192C2BBAF79_OFFSET UNITYSDK_OFFSET(0x197E8010)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDCOINBYBPINBATTLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197E8090)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierAddCoinByBpInBattleConfig_TypeDefinitionIndex = 18459;
