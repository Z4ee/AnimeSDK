...
#define RPG_GAMECORE_APPLYBATTLEGM_METHOD_3_1CD2B66E083ECEF5_OFFSET UNITYSDK_OFFSET(0x186A7D80)
#define RPG_GAMECORE_APPLYBATTLEGM_METHOD_3_C963822C35859261_OFFSET UNITYSDK_OFFSET(0x186A7C70)
#define RPG_GAMECORE_APPLYBATTLEGM__CTOR_OFFSET UNITYSDK_OFFSET(0x186A7D50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ApplyBattleGM_TypeDefinitionIndex = 22389;
