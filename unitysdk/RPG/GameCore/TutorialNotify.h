...
#define RPG_GAMECORE_TUTORIALNOTIFY_METHOD_3_2063F8F256FBF943_OFFSET UNITYSDK_OFFSET(0x1B06EC50)
#define RPG_GAMECORE_TUTORIALNOTIFY_METHOD_3_369E2A8F7DEFAE1E_OFFSET UNITYSDK_OFFSET(0x1B06EC10)
#define RPG_GAMECORE_TUTORIALNOTIFY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B06EC40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TutorialNotify_TypeDefinitionIndex = 23489;
