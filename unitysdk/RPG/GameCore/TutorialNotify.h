...
#define RPG_GAMECORE_TUTORIALNOTIFY_METHOD_3_2063F8F256FBF943_OFFSET UNITYSDK_OFFSET(0x19E2D430)
#define RPG_GAMECORE_TUTORIALNOTIFY_METHOD_3_39E35993C027B418_OFFSET UNITYSDK_OFFSET(0x19E2D3B0)
#define RPG_GAMECORE_TUTORIALNOTIFY__CTOR_OFFSET UNITYSDK_OFFSET(0x19E2D400)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TutorialNotify_TypeDefinitionIndex = 23022;
