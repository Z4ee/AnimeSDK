...
#define RPG_GAMECORE_TUTORIALNOTIFY_METHOD_3_2063F8F256FBF943_OFFSET UNITYSDK_OFFSET(0x178DDCA0)
#define RPG_GAMECORE_TUTORIALNOTIFY_METHOD_3_39E35993C027B418_OFFSET UNITYSDK_OFFSET(0x178DDC20)
#define RPG_GAMECORE_TUTORIALNOTIFY__CTOR_OFFSET UNITYSDK_OFFSET(0x178DDC70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TutorialNotify_TypeDefinitionIndex = 22394;
