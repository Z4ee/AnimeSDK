...
#define RPG_GAMECORE_STACKSCEPTERPROPERTY_METHOD_3_F822ABC902C6EC96_OFFSET UNITYSDK_OFFSET(0x18E87540)
#define RPG_GAMECORE_STACKSCEPTERPROPERTY_METHOD_3_FA44F7FDBBF3841D_OFFSET UNITYSDK_OFFSET(0x18E875C0)
#define RPG_GAMECORE_STACKSCEPTERPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x18E87590)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StackScepterProperty_TypeDefinitionIndex = 22044;
