...
#define RPG_GAMECORE_STACKSCEPTERPROPERTY_METHOD_3_F822ABC902C6EC96_OFFSET UNITYSDK_OFFSET(0x177623B0)
#define RPG_GAMECORE_STACKSCEPTERPROPERTY_METHOD_3_FA44F7FDBBF3841D_OFFSET UNITYSDK_OFFSET(0x17762430)
#define RPG_GAMECORE_STACKSCEPTERPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x17762400)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StackScepterProperty_TypeDefinitionIndex = 21327;
