...
#define RPG_GAMECORE_FIVEDIMGECKOMOVECONFIG_METHOD_3_4ED652FEDD849A5A_OFFSET UNITYSDK_OFFSET(0x1BA98A40)
#define RPG_GAMECORE_FIVEDIMGECKOMOVECONFIG_METHOD_3_82058E21A7901B8B_OFFSET UNITYSDK_OFFSET(0x1BA98AA0)
#define RPG_GAMECORE_FIVEDIMGECKOMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA98A80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimGeckoMoveConfig_TypeDefinitionIndex = 16039;
