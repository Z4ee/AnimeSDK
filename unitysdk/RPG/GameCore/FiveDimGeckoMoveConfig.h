...
#define RPG_GAMECORE_FIVEDIMGECKOMOVECONFIG_METHOD_3_52167C7D335A04EC_OFFSET UNITYSDK_OFFSET(0x171F49C0)
#define RPG_GAMECORE_FIVEDIMGECKOMOVECONFIG_METHOD_3_5F48839F3E66F321_OFFSET UNITYSDK_OFFSET(0x171F4960)
#define RPG_GAMECORE_FIVEDIMGECKOMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171F49A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimGeckoMoveConfig_TypeDefinitionIndex = 15295;
