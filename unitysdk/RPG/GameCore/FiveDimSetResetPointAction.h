...
#define RPG_GAMECORE_FIVEDIMSETRESETPOINTACTION_METHOD_3_06DD1C4C9DBCCFF7_OFFSET UNITYSDK_OFFSET(0x1D101960)
#define RPG_GAMECORE_FIVEDIMSETRESETPOINTACTION_METHOD_3_FBB874AB0ED2F304_OFFSET UNITYSDK_OFFSET(0x1D101920)
#define RPG_GAMECORE_FIVEDIMSETRESETPOINTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D101950)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSetResetPointAction_TypeDefinitionIndex = 18441;
