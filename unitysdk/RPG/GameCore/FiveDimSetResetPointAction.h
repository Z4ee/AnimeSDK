...
#define RPG_GAMECORE_FIVEDIMSETRESETPOINTACTION_METHOD_3_06DD1C4C9DBCCFF7_OFFSET UNITYSDK_OFFSET(0x1720B0F0)
#define RPG_GAMECORE_FIVEDIMSETRESETPOINTACTION_METHOD_3_1C4A219CE70BE5B6_OFFSET UNITYSDK_OFFSET(0x1720B080)
#define RPG_GAMECORE_FIVEDIMSETRESETPOINTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1720B0D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSetResetPointAction_TypeDefinitionIndex = 17119;
