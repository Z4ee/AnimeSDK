...
#define RPG_GAMECORE_TEXTMAPROW_FROMBINARYWITHOUTNEW_OFFSET UNITYSDK_OFFSET(0x1789B680)
#define RPG_GAMECORE_TEXTMAPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1789B840)
#define RPG_GAMECORE_TEXTMAPROW_FROMTABLEOFFSET_OFFSET UNITYSDK_OFFSET(0x1789C780)
#define RPG_GAMECORE_TEXTMAPROW_RESET_OFFSET UNITYSDK_OFFSET(0x1789C7E0)
#define RPG_GAMECORE_TEXTMAPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1789C800)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TextmapRow_TypeDefinitionIndex = 14015;
