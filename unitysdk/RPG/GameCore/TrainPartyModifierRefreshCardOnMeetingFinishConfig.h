...
#define RPG_GAMECORE_TRAINPARTYMODIFIERREFRESHCARDONMEETINGFINISHCONFIG_METHOD_3_3ABED275C6E31B90_OFFSET UNITYSDK_OFFSET(0x1D5DEF50)
#define RPG_GAMECORE_TRAINPARTYMODIFIERREFRESHCARDONMEETINGFINISHCONFIG_METHOD_3_EB6E9699BC6CC40C_OFFSET UNITYSDK_OFFSET(0x1D5DECB0)
#define RPG_GAMECORE_TRAINPARTYMODIFIERREFRESHCARDONMEETINGFINISHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5DECA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyModifierRefreshCardOnMeetingFinishConfig_TypeDefinitionIndex = 17905;
