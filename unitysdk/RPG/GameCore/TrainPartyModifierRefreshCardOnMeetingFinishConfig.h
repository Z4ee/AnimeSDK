...
#define RPG_GAMECORE_TRAINPARTYMODIFIERREFRESHCARDONMEETINGFINISHCONFIG_METHOD_3_3ABED275C6E31B90_OFFSET UNITYSDK_OFFSET(0x178AD3C0)
#define RPG_GAMECORE_TRAINPARTYMODIFIERREFRESHCARDONMEETINGFINISHCONFIG_METHOD_3_EB6E9699BC6CC40C_OFFSET UNITYSDK_OFFSET(0x178AD120)
#define RPG_GAMECORE_TRAINPARTYMODIFIERREFRESHCARDONMEETINGFINISHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x178AD110)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyModifierRefreshCardOnMeetingFinishConfig_TypeDefinitionIndex = 16626;
