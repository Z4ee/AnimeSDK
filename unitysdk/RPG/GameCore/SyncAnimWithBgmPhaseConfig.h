...
#define RPG_GAMECORE_SYNCANIMWITHBGMPHASECONFIG_METHOD_2_0295ED74B723F060_OFFSET UNITYSDK_OFFSET(0x177A3560)
#define RPG_GAMECORE_SYNCANIMWITHBGMPHASECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x177A36E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SyncAnimWithBgmPhaseConfig_TypeDefinitionIndex = 20587;
