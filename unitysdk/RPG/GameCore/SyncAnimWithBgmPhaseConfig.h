...
#define RPG_GAMECORE_SYNCANIMWITHBGMPHASECONFIG_METHOD_2_0295ED74B723F060_OFFSET UNITYSDK_OFFSET(0x1B443F30)
#define RPG_GAMECORE_SYNCANIMWITHBGMPHASECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4440B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SyncAnimWithBgmPhaseConfig_TypeDefinitionIndex = 21579;
