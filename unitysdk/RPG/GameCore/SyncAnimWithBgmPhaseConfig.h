...
#define RPG_GAMECORE_SYNCANIMWITHBGMPHASECONFIG_METHOD_2_0295ED74B723F060_OFFSET UNITYSDK_OFFSET(0x19CE9410)
#define RPG_GAMECORE_SYNCANIMWITHBGMPHASECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19CE9590)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SyncAnimWithBgmPhaseConfig_TypeDefinitionIndex = 21164;
