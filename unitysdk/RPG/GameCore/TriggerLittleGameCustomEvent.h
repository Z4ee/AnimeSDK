...
#define RPG_GAMECORE_TRIGGERLITTLEGAMECUSTOMEVENT_METHOD_3_7428343FF41DF56A_OFFSET UNITYSDK_OFFSET(0x19E16990)
#define RPG_GAMECORE_TRIGGERLITTLEGAMECUSTOMEVENT_METHOD_3_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x19E16AF0)
#define RPG_GAMECORE_TRIGGERLITTLEGAMECUSTOMEVENT_METHOD_3_F15BEF49B393C7AF_OFFSET UNITYSDK_OFFSET(0x19E16910)
#define RPG_GAMECORE_TRIGGERLITTLEGAMECUSTOMEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19E16960)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerLittleGameCustomEvent_TypeDefinitionIndex = 20231;
