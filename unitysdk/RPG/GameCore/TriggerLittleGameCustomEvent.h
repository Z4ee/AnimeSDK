...
#define RPG_GAMECORE_TRIGGERLITTLEGAMECUSTOMEVENT_METHOD_3_7428343FF41DF56A_OFFSET UNITYSDK_OFFSET(0x178C8DB0)
#define RPG_GAMECORE_TRIGGERLITTLEGAMECUSTOMEVENT_METHOD_3_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x178C8F10)
#define RPG_GAMECORE_TRIGGERLITTLEGAMECUSTOMEVENT_METHOD_3_F15BEF49B393C7AF_OFFSET UNITYSDK_OFFSET(0x178C8D30)
#define RPG_GAMECORE_TRIGGERLITTLEGAMECUSTOMEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x178C8D80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerLittleGameCustomEvent_TypeDefinitionIndex = 19632;
