...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_D837DED66799FBE3_DelegateParseJson_1<::RPG::GameCore::CharacterSomatoType>**)Il2CppClass::FromTypeDefinitionIndex(ByCompareSomatoType___O_TypeDefinitionIndex)->GetStaticField(0x10410);
		}
	};
}
