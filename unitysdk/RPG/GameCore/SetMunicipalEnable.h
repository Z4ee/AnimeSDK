...
#define RPG_GAMECORE_SETMUNICIPALENABLE_METHOD_3_76B5ACE800B903D4_OFFSET UNITYSDK_OFFSET(0x18E3C220)
#define RPG_GAMECORE_SETMUNICIPALENABLE_METHOD_3_89876657E1CA9DC5_OFFSET UNITYSDK_OFFSET(0x18E3C2A0)
#define RPG_GAMECORE_SETMUNICIPALENABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E3C270)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetMunicipalEnable_TypeDefinitionIndex = 19267;
