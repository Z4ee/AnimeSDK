...
#define RPG_GAMECORE_ROGUEMODIFIEREXTRAPERSONAROOMCONTENTCONFIG_METHOD_3_5F7DE683E1EC62C7_OFFSET UNITYSDK_OFFSET(0x19B5E020)
#define RPG_GAMECORE_ROGUEMODIFIEREXTRAPERSONAROOMCONTENTCONFIG_METHOD_3_C3C74386971D375E_OFFSET UNITYSDK_OFFSET(0x19B53920)
#define RPG_GAMECORE_ROGUEMODIFIEREXTRAPERSONAROOMCONTENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B538D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExtraPersonaRoomContentConfig_TypeDefinitionIndex = 16919;
