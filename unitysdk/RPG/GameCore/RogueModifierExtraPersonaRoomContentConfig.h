...
#define RPG_GAMECORE_ROGUEMODIFIEREXTRAPERSONAROOMCONTENTCONFIG_METHOD_3_A17D1E285AE62E42_OFFSET UNITYSDK_OFFSET(0x1CFC1160)
#define RPG_GAMECORE_ROGUEMODIFIEREXTRAPERSONAROOMCONTENTCONFIG_METHOD_3_C3C74386971D375E_OFFSET UNITYSDK_OFFSET(0x1CFC11B0)
#define RPG_GAMECORE_ROGUEMODIFIEREXTRAPERSONAROOMCONTENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFC11A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExtraPersonaRoomContentConfig_TypeDefinitionIndex = 17081;
