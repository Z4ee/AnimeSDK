...
#define RPG_GAMECORE_BYCOMPARESERVERSUBMISSIONSTATE_METHOD_4_3F009EBE5555905F_OFFSET UNITYSDK_OFFSET(0x1873AEA0)
#define RPG_GAMECORE_BYCOMPARESERVERSUBMISSIONSTATE_METHOD_4_FDE24ED8A89D2D76_OFFSET UNITYSDK_OFFSET(0x1873AF70)
#define RPG_GAMECORE_BYCOMPARESERVERSUBMISSIONSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1873AF20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareServerSubMissionState_TypeDefinitionIndex = 19258;
