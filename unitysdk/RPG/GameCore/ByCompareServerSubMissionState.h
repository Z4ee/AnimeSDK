...
#define RPG_GAMECORE_BYCOMPARESERVERSUBMISSIONSTATE_METHOD_4_3F009EBE5555905F_OFFSET UNITYSDK_OFFSET(0x195303A0)
#define RPG_GAMECORE_BYCOMPARESERVERSUBMISSIONSTATE_METHOD_4_FDE24ED8A89D2D76_OFFSET UNITYSDK_OFFSET(0x19530470)
#define RPG_GAMECORE_BYCOMPARESERVERSUBMISSIONSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19530420)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareServerSubMissionState_TypeDefinitionIndex = 19175;
