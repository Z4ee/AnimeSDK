...
#define RPG_GAMECORE_BYCOMPARESERVERSUBMISSIONSTATE_METHOD_4_747E004E6D23241A_OFFSET UNITYSDK_OFFSET(0x1CEFB260)
#define RPG_GAMECORE_BYCOMPARESERVERSUBMISSIONSTATE_METHOD_4_FDE24ED8A89D2D76_OFFSET UNITYSDK_OFFSET(0x1CEFB2B0)
#define RPG_GAMECORE_BYCOMPARESERVERSUBMISSIONSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEFB2A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareServerSubMissionState_TypeDefinitionIndex = 20077;
