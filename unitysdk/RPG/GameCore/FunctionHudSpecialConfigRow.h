...
#define RPG_GAMECORE_FUNCTIONHUDSPECIALCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x189371F0)
#define RPG_GAMECORE_FUNCTIONHUDSPECIALCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18937560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FunctionHudSpecialConfigRow_TypeDefinitionIndex = 12583;
