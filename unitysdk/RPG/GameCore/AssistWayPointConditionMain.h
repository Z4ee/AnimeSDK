...
#define RPG_GAMECORE_ASSISTWAYPOINTCONDITIONMAIN_METHOD_2_5460EBB753DFFE1D_OFFSET UNITYSDK_OFFSET(0x16F88D10)
#define RPG_GAMECORE_ASSISTWAYPOINTCONDITIONMAIN_METHOD_2_CBAA757A6FC4AB90_OFFSET UNITYSDK_OFFSET(0x16F87710)
#define RPG_GAMECORE_ASSISTWAYPOINTCONDITIONMAIN__CTOR_OFFSET UNITYSDK_OFFSET(0x16F88D00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AssistWayPointConditionMain_TypeDefinitionIndex = 17417;
