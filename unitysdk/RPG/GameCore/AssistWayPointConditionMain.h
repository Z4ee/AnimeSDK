...
#define RPG_GAMECORE_ASSISTWAYPOINTCONDITIONMAIN_METHOD_2_0387DE56F252B4D5_OFFSET UNITYSDK_OFFSET(0x1A05DB40)
#define RPG_GAMECORE_ASSISTWAYPOINTCONDITIONMAIN_METHOD_2_1E569F2891CD224D_OFFSET UNITYSDK_OFFSET(0x1A05C560)
#define RPG_GAMECORE_ASSISTWAYPOINTCONDITIONMAIN_METHOD_2_5460EBB753DFFE1D_OFFSET UNITYSDK_OFFSET(0x1A05FC40)
#define RPG_GAMECORE_ASSISTWAYPOINTCONDITIONMAIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1A05FCE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AssistWayPointConditionMain_TypeDefinitionIndex = 14867;
