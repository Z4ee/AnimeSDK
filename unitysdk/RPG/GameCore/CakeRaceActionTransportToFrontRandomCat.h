...
#define RPG_GAMECORE_CAKERACEACTIONTRANSPORTTOFRONTRANDOMCAT_METHOD_3_0479FC38196407E4_OFFSET UNITYSDK_OFFSET(0x1CF70B80)
#define RPG_GAMECORE_CAKERACEACTIONTRANSPORTTOFRONTRANDOMCAT_METHOD_3_8F11DDA3C0014639_OFFSET UNITYSDK_OFFSET(0x1CF70C20)
#define RPG_GAMECORE_CAKERACEACTIONTRANSPORTTOFRONTRANDOMCAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF70C10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionTransportToFrontRandomCat_TypeDefinitionIndex = 18127;
