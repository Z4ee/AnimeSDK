...
#define RPG_GAMECORE_CAKERACEACTIONTRANSPORTTOFRONTRANDOMCAT_METHOD_3_8F11DDA3C0014639_OFFSET UNITYSDK_OFFSET(0x1876B510)
#define RPG_GAMECORE_CAKERACEACTIONTRANSPORTTOFRONTRANDOMCAT_METHOD_3_B8ED97C2A5826417_OFFSET UNITYSDK_OFFSET(0x1876C810)
#define RPG_GAMECORE_CAKERACEACTIONTRANSPORTTOFRONTRANDOMCAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1876B4F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionTransportToFrontRandomCat_TypeDefinitionIndex = 17433;
