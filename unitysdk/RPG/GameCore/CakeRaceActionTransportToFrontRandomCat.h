...
#define RPG_GAMECORE_CAKERACEACTIONTRANSPORTTOFRONTRANDOMCAT_METHOD_3_8F11DDA3C0014639_OFFSET UNITYSDK_OFFSET(0x195E6FB0)
#define RPG_GAMECORE_CAKERACEACTIONTRANSPORTTOFRONTRANDOMCAT_METHOD_3_B8ED97C2A5826417_OFFSET UNITYSDK_OFFSET(0x195E87B0)
#define RPG_GAMECORE_CAKERACEACTIONTRANSPORTTOFRONTRANDOMCAT__CTOR_OFFSET UNITYSDK_OFFSET(0x195E6F90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionTransportToFrontRandomCat_TypeDefinitionIndex = 17436;
