...
#define RPG_GAMECORE_INFECTMODIFIER_METHOD_3_755720E9CF1AA95B_OFFSET UNITYSDK_OFFSET(0x1984E430)
#define RPG_GAMECORE_INFECTMODIFIER_METHOD_3_CBF8DF90BE5DD2D5_OFFSET UNITYSDK_OFFSET(0x1984E310)
#define RPG_GAMECORE_INFECTMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1984E3B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int InfectModifier_TypeDefinitionIndex = 21815;
