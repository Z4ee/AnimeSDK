...
#define RPG_GAMECORE_SETSUMMONERENERGYBARSTATE_METHOD_3_018161101C05D0B8_OFFSET UNITYSDK_OFFSET(0x176E0570)
#define RPG_GAMECORE_SETSUMMONERENERGYBARSTATE_METHOD_3_1FFFE78EF1780D47_OFFSET UNITYSDK_OFFSET(0x176E0450)
#define RPG_GAMECORE_SETSUMMONERENERGYBARSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x176E0490)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetSummonerEnergyBarState_TypeDefinitionIndex = 20923;
