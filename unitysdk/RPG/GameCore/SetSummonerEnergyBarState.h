...
#define RPG_GAMECORE_SETSUMMONERENERGYBARSTATE_METHOD_3_018161101C05D0B8_OFFSET UNITYSDK_OFFSET(0x18E43A80)
#define RPG_GAMECORE_SETSUMMONERENERGYBARSTATE_METHOD_3_1FFFE78EF1780D47_OFFSET UNITYSDK_OFFSET(0x18E43960)
#define RPG_GAMECORE_SETSUMMONERENERGYBARSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E439A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetSummonerEnergyBarState_TypeDefinitionIndex = 21634;
