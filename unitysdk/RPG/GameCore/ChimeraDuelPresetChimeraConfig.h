...
#define RPG_GAMECORE_CHIMERADUELPRESETCHIMERACONFIG_METHOD_2_F58A62B052BFFF17_OFFSET UNITYSDK_OFFSET(0x1C244FC0)
#define RPG_GAMECORE_CHIMERADUELPRESETCHIMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C245230)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelPresetChimeraConfig_TypeDefinitionIndex = 15416;
