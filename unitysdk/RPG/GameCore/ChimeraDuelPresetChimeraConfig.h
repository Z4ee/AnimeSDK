...
#define RPG_GAMECORE_CHIMERADUELPRESETCHIMERACONFIG_METHOD_2_F58A62B052BFFF17_OFFSET UNITYSDK_OFFSET(0x170A29F0)
#define RPG_GAMECORE_CHIMERADUELPRESETCHIMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x170A2C60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelPresetChimeraConfig_TypeDefinitionIndex = 14721;
