...
#define RPG_GAMECORE_CHIMERADUELPRESETCHIMERACONFIG_METHOD_2_F58A62B052BFFF17_OFFSET UNITYSDK_OFFSET(0x18801D30)
#define RPG_GAMECORE_CHIMERADUELPRESETCHIMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18801FA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelPresetChimeraConfig_TypeDefinitionIndex = 15191;
