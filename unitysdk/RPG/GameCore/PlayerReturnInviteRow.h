...
#define RPG_GAMECORE_PLAYERRETURNINVITEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1BA0ECD0)
#define RPG_GAMECORE_PLAYERRETURNINVITEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA0EE70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayerReturnInviteRow_TypeDefinitionIndex = 13957;
