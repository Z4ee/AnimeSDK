...
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIRFIREMISSLE_METHOD_4_556D498305C687AA_OFFSET UNITYSDK_OFFSET(0x1D1FB8A0)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIRFIREMISSLE_METHOD_4_BEFAE6D75EB5BBA9_OFFSET UNITYSDK_OFFSET(0x1D1FB8E0)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIRFIREMISSLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1FB8D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityPixAirFireMissle_TypeDefinitionIndex = 21150;
