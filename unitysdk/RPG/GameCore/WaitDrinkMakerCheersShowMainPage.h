...
#define RPG_GAMECORE_WAITDRINKMAKERCHEERSSHOWMAINPAGE_METHOD_4_189C7B518B3E7D3C_OFFSET UNITYSDK_OFFSET(0x178F7400)
#define RPG_GAMECORE_WAITDRINKMAKERCHEERSSHOWMAINPAGE_METHOD_4_5E18B06224BB44C2_OFFSET UNITYSDK_OFFSET(0x178F74E0)
#define RPG_GAMECORE_WAITDRINKMAKERCHEERSSHOWMAINPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x178F7480)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitDrinkMakerCheersShowMainPage_TypeDefinitionIndex = 19885;
