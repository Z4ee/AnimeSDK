...
#define RPG_GAMECORE_WAITDRINKMAKERCHEERSSHOWMAINPAGE_METHOD_4_189C7B518B3E7D3C_OFFSET UNITYSDK_OFFSET(0x19E53D30)
#define RPG_GAMECORE_WAITDRINKMAKERCHEERSSHOWMAINPAGE_METHOD_4_5E18B06224BB44C2_OFFSET UNITYSDK_OFFSET(0x19E53E10)
#define RPG_GAMECORE_WAITDRINKMAKERCHEERSSHOWMAINPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x19E53DB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitDrinkMakerCheersShowMainPage_TypeDefinitionIndex = 20501;
