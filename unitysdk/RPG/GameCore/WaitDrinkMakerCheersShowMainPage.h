...
#define RPG_GAMECORE_WAITDRINKMAKERCHEERSSHOWMAINPAGE_METHOD_4_53B4F97DF630863B_OFFSET UNITYSDK_OFFSET(0x1B8A2CE0)
#define RPG_GAMECORE_WAITDRINKMAKERCHEERSSHOWMAINPAGE_METHOD_4_5E18B06224BB44C2_OFFSET UNITYSDK_OFFSET(0x1B8A2D30)
#define RPG_GAMECORE_WAITDRINKMAKERCHEERSSHOWMAINPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8A2D20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitDrinkMakerCheersShowMainPage_TypeDefinitionIndex = 20916;
