...
#define RPG_GAMECORE_GRIDFIGHTTRAITLAYERCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19810300)
#define RPG_GAMECORE_GRIDFIGHTTRAITLAYERCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x198106D0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::RPG::GameCore::AvatarPropertyValue*>* AllMemberPropertyList; // 0x20
		::Il2CppArray<::RPG::GameCore::FixPoint>* PropertyParamList; // 0x28
		::System::UInt32 TraitID; // 0x30
		::RPG::GameCore::GridFightPropertyBindType PropertyBindType; // 0x34
