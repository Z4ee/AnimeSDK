...
#define RPG_GAMECORE_SETTEXTJOINVALUE_METHOD_3_BE4C70C796BD237F_OFFSET UNITYSDK_OFFSET(0x19C64570)
#define RPG_GAMECORE_SETTEXTJOINVALUE_METHOD_3_D35CB075C8E7E801_OFFSET UNITYSDK_OFFSET(0x19C645F0)
#define RPG_GAMECORE_SETTEXTJOINVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C645C0)
