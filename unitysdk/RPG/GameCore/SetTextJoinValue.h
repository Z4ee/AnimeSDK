...
#define RPG_GAMECORE_SETTEXTJOINVALUE_METHOD_3_BE4C70C796BD237F_OFFSET UNITYSDK_OFFSET(0x176E4320)
#define RPG_GAMECORE_SETTEXTJOINVALUE_METHOD_3_D35CB075C8E7E801_OFFSET UNITYSDK_OFFSET(0x176E43A0)
#define RPG_GAMECORE_SETTEXTJOINVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x176E4370)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetTextJoinValue_TypeDefinitionIndex = 19207;
