...
#define RPG_GAMECORE_SETTEXTJOINVALUE_METHOD_3_0B50AEAE101E53EA_OFFSET UNITYSDK_OFFSET(0x1E0931B0)
#define RPG_GAMECORE_SETTEXTJOINVALUE_METHOD_3_D35CB075C8E7E801_OFFSET UNITYSDK_OFFSET(0x1E0931F0)
#define RPG_GAMECORE_SETTEXTJOINVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0931E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetTextJoinValue_TypeDefinitionIndex = 20641;
