...
#define RPG_GAMECORE_AETHERDIVIDEQUESTTYPEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CBC91B0)
#define RPG_GAMECORE_AETHERDIVIDEQUESTTYPEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CBC9730)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AetherDivideQuestTypeRow_TypeDefinitionIndex = 10916;
