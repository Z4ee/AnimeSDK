...
#define RPG_GAMECORE_DIALOGUEEVENTSWITCH_METHOD_3_7FA47D86EB468A84_OFFSET UNITYSDK_OFFSET(0x171587D0)
#define RPG_GAMECORE_DIALOGUEEVENTSWITCH_METHOD_3_838F02AA9031DD94_OFFSET UNITYSDK_OFFSET(0x17158850)
#define RPG_GAMECORE_DIALOGUEEVENTSWITCH__CTOR_OFFSET UNITYSDK_OFFSET(0x17158820)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DialogueEventSwitch_TypeDefinitionIndex = 19211;
