...
#define RPG_GAMECORE_WAITSIMPLETALKFINISHTASK_DISPOSE_OFFSET UNITYSDK_OFFSET(0xE7DC340)
#define RPG_GAMECORE_WAITSIMPLETALKFINISHTASK_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0xE7DC450)
#define RPG_GAMECORE_WAITSIMPLETALKFINISHTASK_ONFINISHIMMEDIATELYINPERFORMANCE_OFFSET UNITYSDK_OFFSET(0xE7DC880)
#define RPG_GAMECORE_WAITSIMPLETALKFINISHTASK_ONSKIP_OFFSET UNITYSDK_OFFSET(0xE7DC710)
#define RPG_GAMECORE_WAITSIMPLETALKFINISHTASK_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xE7DC460)
#define RPG_GAMECORE_WAITSIMPLETALKFINISHTASK_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xE7DC660)
#define RPG_GAMECORE_WAITSIMPLETALKFINISHTASK_SETNEXTTASK_OFFSET UNITYSDK_OFFSET(0xE7DC930)
#define RPG_GAMECORE_WAITSIMPLETALKFINISHTASK_TICK_OFFSET UNITYSDK_OFFSET(0xE7DC6B0)
#define RPG_GAMECORE_WAITSIMPLETALKFINISHTASK__CTOR_OFFSET UNITYSDK_OFFSET(0xE7DC330)
#define RPG_GAMECORE_WAITSIMPLETALKFINISHTASK__ONSIMPLETALKFINISH_OFFSET UNITYSDK_OFFSET(0xE7DC8E0)
#define RPG_GAMECORE_WAITSIMPLETALKFINISHTASK__REMOVENOTIFY_OFFSET UNITYSDK_OFFSET(0xE7DC390)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitSimpleTalkFinishTask_TypeDefinitionIndex = 59075;

	class WaitSimpleTalkFinishTask : public ::Class_1_5F51D4049EA87B7B
	{
	public:
		::RPG::GameCore::TaskContext* _TaskContext; // 0x18
		::RPG::GameCore::WaitSimpleTalkFinish* _ConfigRef; // 0x20
