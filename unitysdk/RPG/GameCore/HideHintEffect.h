...
#define RPG_GAMECORE_HIDEHINTEFFECT_METHOD_3_247FDE585B2EB06E_OFFSET UNITYSDK_OFFSET(0x1D3DFAD0)
#define RPG_GAMECORE_HIDEHINTEFFECT_METHOD_3_7101C45C507C76BF_OFFSET UNITYSDK_OFFSET(0x1D3DFA90)
#define RPG_GAMECORE_HIDEHINTEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3DFAC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HideHintEffect_TypeDefinitionIndex = 20327;
