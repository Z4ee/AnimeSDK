...
#define RPG_GAMECORE_SHOPITEMGROUPCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D521370)
#define RPG_GAMECORE_SHOPITEMGROUPCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D521520)
