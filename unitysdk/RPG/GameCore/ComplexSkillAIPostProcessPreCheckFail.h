...
#define RPG_GAMECORE_COMPLEXSKILLAIPOSTPROCESSPRECHECKFAIL_METHOD_3_06AC007CD38B0092_OFFSET UNITYSDK_OFFSET(0x17124720)
#define RPG_GAMECORE_COMPLEXSKILLAIPOSTPROCESSPRECHECKFAIL_METHOD_3_BCF3AD68C05DD2FD_OFFSET UNITYSDK_OFFSET(0x17124370)
#define RPG_GAMECORE_COMPLEXSKILLAIPOSTPROCESSPRECHECKFAIL__CTOR_OFFSET UNITYSDK_OFFSET(0x17124360)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAIPostProcessPreCheckFail_TypeDefinitionIndex = 14258;
