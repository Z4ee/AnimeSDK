...
#define RPG_GAMECORE_COMPLEXSKILLAIPOSTPROCESSPRECHECKFAIL_METHOD_3_06AC007CD38B0092_OFFSET UNITYSDK_OFFSET(0x1CFF3930)
#define RPG_GAMECORE_COMPLEXSKILLAIPOSTPROCESSPRECHECKFAIL_METHOD_3_BCF3AD68C05DD2FD_OFFSET UNITYSDK_OFFSET(0x1CFF3580)
#define RPG_GAMECORE_COMPLEXSKILLAIPOSTPROCESSPRECHECKFAIL__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFF3570)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAIPostProcessPreCheckFail_TypeDefinitionIndex = 15391;
