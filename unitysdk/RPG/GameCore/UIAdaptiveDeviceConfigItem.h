...
#define RPG_GAMECORE_UIADAPTIVEDEVICECONFIGITEM_METHOD_2_2D965FFF1A4711D0_OFFSET UNITYSDK_OFFSET(0x1D2AA6B0)
#define RPG_GAMECORE_UIADAPTIVEDEVICECONFIGITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2AA810)
