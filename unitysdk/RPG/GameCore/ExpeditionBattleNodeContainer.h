...
#define RPG_GAMECORE_EXPEDITIONBATTLENODECONTAINER_METHOD_2_910B45FA6EF5385C_OFFSET UNITYSDK_OFFSET(0x1D7DC6D0)
#define RPG_GAMECORE_EXPEDITIONBATTLENODECONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7DC7C0)
