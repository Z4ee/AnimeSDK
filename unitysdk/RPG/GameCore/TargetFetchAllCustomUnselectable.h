...
#define RPG_GAMECORE_TARGETFETCHALLCUSTOMUNSELECTABLE_METHOD_4_1B2A0A5B47952DF2_OFFSET UNITYSDK_OFFSET(0x1D5A82C0)
#define RPG_GAMECORE_TARGETFETCHALLCUSTOMUNSELECTABLE_METHOD_4_3B1D79A446B1AAF5_OFFSET UNITYSDK_OFFSET(0x1D5A8300)
#define RPG_GAMECORE_TARGETFETCHALLCUSTOMUNSELECTABLE_METHOD_4_4BC600A25FF36778_OFFSET UNITYSDK_OFFSET(0x1D5A8450)
#define RPG_GAMECORE_TARGETFETCHALLCUSTOMUNSELECTABLE_METHOD_4_86344203720E950D_OFFSET UNITYSDK_OFFSET(0x1D5A8420)
#define RPG_GAMECORE_TARGETFETCHALLCUSTOMUNSELECTABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5A82F0)
