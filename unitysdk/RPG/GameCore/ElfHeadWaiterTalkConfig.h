...
#define RPG_GAMECORE_ELFHEADWAITERTALKCONFIG_METHOD_2_50BC829834E3C8D3_OFFSET UNITYSDK_OFFSET(0x1718EF40)
#define RPG_GAMECORE_ELFHEADWAITERTALKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1718F090)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfHeadWaiterTalkConfig_TypeDefinitionIndex = 16938;
