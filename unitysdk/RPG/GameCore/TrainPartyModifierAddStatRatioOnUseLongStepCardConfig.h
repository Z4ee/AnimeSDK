...
#define RPG_GAMECORE_TRAINPARTYMODIFIERADDSTATRATIOONUSELONGSTEPCARDCONFIG_METHOD_3_4161334422B98F86_OFFSET UNITYSDK_OFFSET(0x1C1611F0)
#define RPG_GAMECORE_TRAINPARTYMODIFIERADDSTATRATIOONUSELONGSTEPCARDCONFIG_METHOD_3_79AFF4154CF1FC22_OFFSET UNITYSDK_OFFSET(0x1C161240)
#define RPG_GAMECORE_TRAINPARTYMODIFIERADDSTATRATIOONUSELONGSTEPCARDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C161230)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyModifierAddStatRatioOnUseLongStepCardConfig_TypeDefinitionIndex = 17383;
