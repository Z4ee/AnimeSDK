...
#define RPG_GAMECORE_PHOTOGRAPHFREESTYLECONFIG_METHOD_2_809EA9D54C0FF098_OFFSET UNITYSDK_OFFSET(0x19A07B50)
#define RPG_GAMECORE_PHOTOGRAPHFREESTYLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19A07C10)
