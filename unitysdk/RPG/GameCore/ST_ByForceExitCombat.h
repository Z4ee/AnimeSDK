...
#define RPG_GAMECORE_ST_BYFORCEEXITCOMBAT_METHOD_4_67E9BC6DAE36AB2B_OFFSET UNITYSDK_OFFSET(0x17693060)
#define RPG_GAMECORE_ST_BYFORCEEXITCOMBAT_METHOD_4_BF32453872366031_OFFSET UNITYSDK_OFFSET(0x17692F90)
#define RPG_GAMECORE_ST_BYFORCEEXITCOMBAT__CTOR_OFFSET UNITYSDK_OFFSET(0x17693010)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_ByForceExitCombat_TypeDefinitionIndex = 18369;
