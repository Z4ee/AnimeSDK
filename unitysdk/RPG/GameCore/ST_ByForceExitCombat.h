...
#define RPG_GAMECORE_ST_BYFORCEEXITCOMBAT_METHOD_4_67E9BC6DAE36AB2B_OFFSET UNITYSDK_OFFSET(0x1D4C3030)
#define RPG_GAMECORE_ST_BYFORCEEXITCOMBAT_METHOD_4_B6822279B5B6B008_OFFSET UNITYSDK_OFFSET(0x1D4C31A0)
#define RPG_GAMECORE_ST_BYFORCEEXITCOMBAT_METHOD_4_D399290E104598D1_OFFSET UNITYSDK_OFFSET(0x1D4C3170)
#define RPG_GAMECORE_ST_BYFORCEEXITCOMBAT_METHOD_4_E80947427CCC3198_OFFSET UNITYSDK_OFFSET(0x1D4C2FF0)
#define RPG_GAMECORE_ST_BYFORCEEXITCOMBAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4C3020)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_ByForceExitCombat_TypeDefinitionIndex = 19857;
