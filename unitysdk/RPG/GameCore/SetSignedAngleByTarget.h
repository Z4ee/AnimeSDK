...
#define RPG_GAMECORE_SETSIGNEDANGLEBYTARGET_METHOD_3_D41B5305ABACFA18_OFFSET UNITYSDK_OFFSET(0x1C6074C0)
#define RPG_GAMECORE_SETSIGNEDANGLEBYTARGET_METHOD_3_EDF7BF93CB62158D_OFFSET UNITYSDK_OFFSET(0x1C607500)
#define RPG_GAMECORE_SETSIGNEDANGLEBYTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1C6074F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetSignedAngleByTarget_TypeDefinitionIndex = 21922;
