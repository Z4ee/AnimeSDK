...
#define RPG_GAMECORE_SETSIGNEDANGLEBYTARGET_METHOD_3_35948FB8D65E760E_OFFSET UNITYSDK_OFFSET(0x176DD720)
#define RPG_GAMECORE_SETSIGNEDANGLEBYTARGET_METHOD_3_EDF7BF93CB62158D_OFFSET UNITYSDK_OFFSET(0x176DD7A0)
#define RPG_GAMECORE_SETSIGNEDANGLEBYTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x176DD770)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetSignedAngleByTarget_TypeDefinitionIndex = 20933;
