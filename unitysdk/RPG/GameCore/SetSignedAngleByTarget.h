...
#define RPG_GAMECORE_SETSIGNEDANGLEBYTARGET_METHOD_3_35948FB8D65E760E_OFFSET UNITYSDK_OFFSET(0x18E40C60)
#define RPG_GAMECORE_SETSIGNEDANGLEBYTARGET_METHOD_3_EDF7BF93CB62158D_OFFSET UNITYSDK_OFFSET(0x18E40CE0)
#define RPG_GAMECORE_SETSIGNEDANGLEBYTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x18E40CB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetSignedAngleByTarget_TypeDefinitionIndex = 21644;
