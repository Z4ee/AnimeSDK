...
#define RPG_GAMECORE_SETDYNAMICVALUEBYMAZEBUFFCONFIG_METHOD_3_0FA8291611E9A366_OFFSET UNITYSDK_OFFSET(0x176C2630)
#define RPG_GAMECORE_SETDYNAMICVALUEBYMAZEBUFFCONFIG_METHOD_3_EBA63F379A1E200B_OFFSET UNITYSDK_OFFSET(0x176C25B0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYMAZEBUFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x176C2600)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByMazeBuffConfig_TypeDefinitionIndex = 22108;
