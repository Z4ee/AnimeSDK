...
#define RPG_GAMECORE_PIXAIRSHOPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D7944B0)
#define RPG_GAMECORE_PIXAIRSHOPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7945D0)
