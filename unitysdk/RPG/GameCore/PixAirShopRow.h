...
#define RPG_GAMECORE_PIXAIRSHOPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19A14530)
#define RPG_GAMECORE_PIXAIRSHOPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19A14650)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PixAirShopRow_TypeDefinitionIndex = 11571;
