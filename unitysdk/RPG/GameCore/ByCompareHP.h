...
#define RPG_GAMECORE_BYCOMPAREHP_METHOD_4_315FEC21E4E22B4C_OFFSET UNITYSDK_OFFSET(0x19CE9A70)
#define RPG_GAMECORE_BYCOMPAREHP_METHOD_4_46A5CF1A013E0542_OFFSET UNITYSDK_OFFSET(0x19CE9CD0)
#define RPG_GAMECORE_BYCOMPAREHP_METHOD_4_CFC578177C10651D_OFFSET UNITYSDK_OFFSET(0x19CE9A30)
#define RPG_GAMECORE_BYCOMPAREHP_METHOD_4_D70F30CBEF4A8E24_OFFSET UNITYSDK_OFFSET(0x19CE9CA0)
#define RPG_GAMECORE_BYCOMPAREHP__CTOR_OFFSET UNITYSDK_OFFSET(0x19CE9A60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareHP_TypeDefinitionIndex = 22166;
