...
#define RPG_GAMECORE_BYCOMPAREHP_METHOD_4_315FEC21E4E22B4C_OFFSET UNITYSDK_OFFSET(0x1872F4C0)
#define RPG_GAMECORE_BYCOMPAREHP_METHOD_4_FFA654C1BDA11D82_OFFSET UNITYSDK_OFFSET(0x1872F3F0)
#define RPG_GAMECORE_BYCOMPAREHP__CTOR_OFFSET UNITYSDK_OFFSET(0x1872F470)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareHP_TypeDefinitionIndex = 21917;
