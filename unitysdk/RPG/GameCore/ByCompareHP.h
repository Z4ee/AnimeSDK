...
#define RPG_GAMECORE_BYCOMPAREHP_METHOD_4_315FEC21E4E22B4C_OFFSET UNITYSDK_OFFSET(0x1700B180)
#define RPG_GAMECORE_BYCOMPAREHP_METHOD_4_FFA654C1BDA11D82_OFFSET UNITYSDK_OFFSET(0x1700B0B0)
#define RPG_GAMECORE_BYCOMPAREHP__CTOR_OFFSET UNITYSDK_OFFSET(0x1700B130)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareHP_TypeDefinitionIndex = 21200;
