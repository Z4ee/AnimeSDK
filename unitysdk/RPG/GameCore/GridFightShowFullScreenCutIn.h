...
#define RPG_GAMECORE_GRIDFIGHTSHOWFULLSCREENCUTIN_METHOD_3_E83EB3C3E5EB4AD7_OFFSET UNITYSDK_OFFSET(0x172831D0)
#define RPG_GAMECORE_GRIDFIGHTSHOWFULLSCREENCUTIN_METHOD_3_EA0EC48B19180F5E_OFFSET UNITYSDK_OFFSET(0x17283250)
#define RPG_GAMECORE_GRIDFIGHTSHOWFULLSCREENCUTIN__CTOR_OFFSET UNITYSDK_OFFSET(0x17283220)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightShowFullScreenCutIn_TypeDefinitionIndex = 21458;
