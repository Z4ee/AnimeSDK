...
#define RPG_GAMECORE_SETFIVEDIMENTITYATTACHTARGET_METHOD_3_2822733F27C47B12_OFFSET UNITYSDK_OFFSET(0x18E30A30)
#define RPG_GAMECORE_SETFIVEDIMENTITYATTACHTARGET_METHOD_3_A08757B7740D5B89_OFFSET UNITYSDK_OFFSET(0x18E30AD0)
#define RPG_GAMECORE_SETFIVEDIMENTITYATTACHTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x18E30A90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetFiveDimEntityAttachTarget_TypeDefinitionIndex = 20253;
