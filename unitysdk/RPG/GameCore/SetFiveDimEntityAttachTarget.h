...
#define RPG_GAMECORE_SETFIVEDIMENTITYATTACHTARGET_METHOD_3_1C7CCC8A1D274168_OFFSET UNITYSDK_OFFSET(0x1D4FE4A0)
#define RPG_GAMECORE_SETFIVEDIMENTITYATTACHTARGET_METHOD_3_A08757B7740D5B89_OFFSET UNITYSDK_OFFSET(0x1D4FE4F0)
#define RPG_GAMECORE_SETFIVEDIMENTITYATTACHTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4FE4E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetFiveDimEntityAttachTarget_TypeDefinitionIndex = 21034;
