...
#define RPG_GAMECORE_SETFIVEDIMENTITYATTACHTARGET_METHOD_3_2822733F27C47B12_OFFSET UNITYSDK_OFFSET(0x176CD4F0)
#define RPG_GAMECORE_SETFIVEDIMENTITYATTACHTARGET_METHOD_3_A08757B7740D5B89_OFFSET UNITYSDK_OFFSET(0x176CD590)
#define RPG_GAMECORE_SETFIVEDIMENTITYATTACHTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x176CD550)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetFiveDimEntityAttachTarget_TypeDefinitionIndex = 19578;
