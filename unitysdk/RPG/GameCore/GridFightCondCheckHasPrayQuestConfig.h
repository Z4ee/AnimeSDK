...
#define RPG_GAMECORE_GRIDFIGHTCONDCHECKHASPRAYQUESTCONFIG_METHOD_6_D81EC5DBFC13886A_OFFSET UNITYSDK_OFFSET(0x1D14D280)
#define RPG_GAMECORE_GRIDFIGHTCONDCHECKHASPRAYQUESTCONFIG_METHOD_6_E4D7030791B2E2C6_OFFSET UNITYSDK_OFFSET(0x1D14D2D0)
#define RPG_GAMECORE_GRIDFIGHTCONDCHECKHASPRAYQUESTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D14D2C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightCondCheckHasPrayQuestConfig_TypeDefinitionIndex = 19105;
