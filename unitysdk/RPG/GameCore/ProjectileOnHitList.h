...
#define RPG_GAMECORE_PROJECTILEONHITLIST_METHOD_2_1D51F1CB2BE6E251_OFFSET UNITYSDK_OFFSET(0x175152B0)
#define RPG_GAMECORE_PROJECTILEONHITLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x17515430)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ProjectileOnHitList_TypeDefinitionIndex = 20770;
