...
#define RPG_GAMECORE_ROGUEVALUECHANGEBYPARAMINFO_METHOD_2_47776F64FA72684B_OFFSET UNITYSDK_OFFSET(0x17672B50)
#define RPG_GAMECORE_ROGUEVALUECHANGEBYPARAMINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x17672B90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueValueChangeByParamInfo_TypeDefinitionIndex = 18201;
