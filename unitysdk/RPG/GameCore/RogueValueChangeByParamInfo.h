...
#define RPG_GAMECORE_ROGUEVALUECHANGEBYPARAMINFO_METHOD_2_47776F64FA72684B_OFFSET UNITYSDK_OFFSET(0x19BD38C0)
#define RPG_GAMECORE_ROGUEVALUECHANGEBYPARAMINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19BD3900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueValueChangeByParamInfo_TypeDefinitionIndex = 18813;
