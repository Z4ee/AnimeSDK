...
#define RPG_GAMECORE_BYCOMPARESKILLLEVEL_METHOD_4_274C396221783239_OFFSET UNITYSDK_OFFSET(0x17017050)
#define RPG_GAMECORE_BYCOMPARESKILLLEVEL_METHOD_4_ADB6F07CC92DF2DD_OFFSET UNITYSDK_OFFSET(0x17017170)
#define RPG_GAMECORE_BYCOMPARESKILLLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x170170F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareSkillLevel_TypeDefinitionIndex = 21213;
