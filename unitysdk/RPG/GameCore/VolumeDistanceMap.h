...
#define RPG_GAMECORE_VOLUMEDISTANCEMAP_METHOD_2_5A1D43DEA3B97CCB_OFFSET UNITYSDK_OFFSET(0x1B89F6F0)
#define RPG_GAMECORE_VOLUMEDISTANCEMAP_METHOD_2_E0E95C03951619C1_OFFSET UNITYSDK_OFFSET(0x1B89F840)
#define RPG_GAMECORE_VOLUMEDISTANCEMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B89F830)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VolumeDistanceMap_TypeDefinitionIndex = 18407;
