...
#define RPG_GAMECORE_VOLUMEDISTANCEMAP_METHOD_2_5A1D43DEA3B97CCB_OFFSET UNITYSDK_OFFSET(0x1D69DD30)
#define RPG_GAMECORE_VOLUMEDISTANCEMAP_METHOD_2_E0E95C03951619C1_OFFSET UNITYSDK_OFFSET(0x1D69DE80)
#define RPG_GAMECORE_VOLUMEDISTANCEMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D69DE70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VolumeDistanceMap_TypeDefinitionIndex = 18931;
