...
#define RPG_GAMECORE_PROPSETENTITYLODOFFSET_METHOD_3_BB6DBDA30ABA5553_OFFSET UNITYSDK_OFFSET(0x18C74210)
#define RPG_GAMECORE_PROPSETENTITYLODOFFSET_METHOD_3_C6A9ED10CFD9DE96_OFFSET UNITYSDK_OFFSET(0x18C74360)
#define RPG_GAMECORE_PROPSETENTITYLODOFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x18C742D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropSetEntityLodOffset_TypeDefinitionIndex = 20815;
