...
#define RPG_GAMECORE_PROPSETENTITYLODOFFSET_METHOD_3_BB6DBDA30ABA5553_OFFSET UNITYSDK_OFFSET(0x175247D0)
#define RPG_GAMECORE_PROPSETENTITYLODOFFSET_METHOD_3_C6A9ED10CFD9DE96_OFFSET UNITYSDK_OFFSET(0x17524920)
#define RPG_GAMECORE_PROPSETENTITYLODOFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x17524890)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropSetEntityLodOffset_TypeDefinitionIndex = 20133;
