...
#define RPG_GAMECORE_PROPSETENTITYLODOFFSET_METHOD_3_0FD7FD6625A86FA4_OFFSET UNITYSDK_OFFSET(0x1D181BF0)
#define RPG_GAMECORE_PROPSETENTITYLODOFFSET_METHOD_3_C6A9ED10CFD9DE96_OFFSET UNITYSDK_OFFSET(0x1D181C70)
#define RPG_GAMECORE_PROPSETENTITYLODOFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1D181C40)
