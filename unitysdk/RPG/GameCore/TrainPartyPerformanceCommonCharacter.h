...
#define RPG_GAMECORE_TRAINPARTYPERFORMANCECOMMONCHARACTER_METHOD_3_2B9D6B96C5418EB8_OFFSET UNITYSDK_OFFSET(0x1D538720)
#define RPG_GAMECORE_TRAINPARTYPERFORMANCECOMMONCHARACTER_METHOD_3_F2A7E3D034DE6444_OFFSET UNITYSDK_OFFSET(0x1D538320)
#define RPG_GAMECORE_TRAINPARTYPERFORMANCECOMMONCHARACTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D538310)
