...
#define RPG_GAMECORE_TRAINPARTYPERFORMANCECOMMONCHARACTER_METHOD_3_2B9D6B96C5418EB8_OFFSET UNITYSDK_OFFSET(0x190AD6B0)
#define RPG_GAMECORE_TRAINPARTYPERFORMANCECOMMONCHARACTER_METHOD_3_F2A7E3D034DE6444_OFFSET UNITYSDK_OFFSET(0x190AD270)
#define RPG_GAMECORE_TRAINPARTYPERFORMANCECOMMONCHARACTER__CTOR_OFFSET UNITYSDK_OFFSET(0x190AD260)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyPerformanceCommonCharacter_TypeDefinitionIndex = 15382;
