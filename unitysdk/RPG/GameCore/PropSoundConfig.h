...
#define RPG_GAMECORE_PROPSOUNDCONFIG_METHOD_2_9444E3FB98087576_OFFSET UNITYSDK_OFFSET(0x1D3612E0)
#define RPG_GAMECORE_PROPSOUNDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D371CC0)
