...
#define RPG_GAMECORE_BYCOMPARESOMATOTYPE_METHOD_4_22151552E4BE0339_OFFSET UNITYSDK_OFFSET(0x1BBBC460)
#define RPG_GAMECORE_BYCOMPARESOMATOTYPE_METHOD_4_451C7C694C6B1AA4_OFFSET UNITYSDK_OFFSET(0x1BBBC250)
#define RPG_GAMECORE_BYCOMPARESOMATOTYPE_METHOD_4_94FC18A4F8CB9F99_OFFSET UNITYSDK_OFFSET(0x1BBBC290)
#define RPG_GAMECORE_BYCOMPARESOMATOTYPE_METHOD_4_C933900519FB5BBF_OFFSET UNITYSDK_OFFSET(0x1BBBC490)
#define RPG_GAMECORE_BYCOMPARESOMATOTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBBC280)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareSomatoType_TypeDefinitionIndex = 23461;
