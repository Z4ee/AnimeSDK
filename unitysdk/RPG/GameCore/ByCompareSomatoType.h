...
#define RPG_GAMECORE_BYCOMPARESOMATOTYPE_METHOD_4_94FC18A4F8CB9F99_OFFSET UNITYSDK_OFFSET(0x170178F0)
#define RPG_GAMECORE_BYCOMPARESOMATOTYPE_METHOD_4_D0B886BCD4283765_OFFSET UNITYSDK_OFFSET(0x17017820)
#define RPG_GAMECORE_BYCOMPARESOMATOTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x170178A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareSomatoType_TypeDefinitionIndex = 21979;
