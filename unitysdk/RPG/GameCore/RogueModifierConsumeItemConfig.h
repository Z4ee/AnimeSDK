...
#define RPG_GAMECORE_ROGUEMODIFIERCONSUMEITEMCONFIG_METHOD_3_8DF8911DF129C881_OFFSET UNITYSDK_OFFSET(0x1CFBF530)
#define RPG_GAMECORE_ROGUEMODIFIERCONSUMEITEMCONFIG_METHOD_3_AD99E6081E42045D_OFFSET UNITYSDK_OFFSET(0x1CFBF4E0)
#define RPG_GAMECORE_ROGUEMODIFIERCONSUMEITEMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFBF520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierConsumeItemConfig_TypeDefinitionIndex = 17250;
