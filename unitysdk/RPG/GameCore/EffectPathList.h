...
#define RPG_GAMECORE_EFFECTPATHLIST_METHOD_2_38B1CED65DE889BF_OFFSET UNITYSDK_OFFSET(0x17189D30)
#define RPG_GAMECORE_EFFECTPATHLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x17189E30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EffectPathList_TypeDefinitionIndex = 14963;
