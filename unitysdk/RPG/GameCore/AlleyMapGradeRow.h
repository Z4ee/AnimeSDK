...
#define RPG_GAMECORE_ALLEYMAPGRADEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1AE7BC30)
#define RPG_GAMECORE_ALLEYMAPGRADEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE7C250)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AlleyMapGradeRow_TypeDefinitionIndex = 12157;
