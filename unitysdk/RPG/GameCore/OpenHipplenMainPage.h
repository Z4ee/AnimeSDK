...
#define RPG_GAMECORE_OPENHIPPLENMAINPAGE_METHOD_3_674735837FB98D43_OFFSET UNITYSDK_OFFSET(0x1747C380)
#define RPG_GAMECORE_OPENHIPPLENMAINPAGE_METHOD_3_695C61E62C4C12AF_OFFSET UNITYSDK_OFFSET(0x1747C270)
#define RPG_GAMECORE_OPENHIPPLENMAINPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1747C350)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OpenHipplenMainPage_TypeDefinitionIndex = 19603;
