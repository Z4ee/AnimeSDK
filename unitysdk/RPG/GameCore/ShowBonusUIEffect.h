...
#define RPG_GAMECORE_SHOWBONUSUIEFFECT_METHOD_3_E2A6EB791A728A96_OFFSET UNITYSDK_OFFSET(0x18E5AD90)
#define RPG_GAMECORE_SHOWBONUSUIEFFECT_METHOD_3_FC44263FF04FC997_OFFSET UNITYSDK_OFFSET(0x18E5AD10)
#define RPG_GAMECORE_SHOWBONUSUIEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x18E5AD60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowBonusUIEffect_TypeDefinitionIndex = 22268;
