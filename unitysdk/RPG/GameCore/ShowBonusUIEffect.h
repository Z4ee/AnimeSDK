...
#define RPG_GAMECORE_SHOWBONUSUIEFFECT_METHOD_3_E2A6EB791A728A96_OFFSET UNITYSDK_OFFSET(0x176F7320)
#define RPG_GAMECORE_SHOWBONUSUIEFFECT_METHOD_3_FC44263FF04FC997_OFFSET UNITYSDK_OFFSET(0x176F72A0)
#define RPG_GAMECORE_SHOWBONUSUIEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x176F72F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowBonusUIEffect_TypeDefinitionIndex = 21532;
