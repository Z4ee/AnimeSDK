...
#define RPG_GAMECORE_TARGETEVALUATOR_METHOD_3_02D95B7B722136A6_OFFSET UNITYSDK_OFFSET(0x1B42C300)
#define RPG_GAMECORE_TARGETEVALUATOR_METHOD_3_101794217258AEF8_OFFSET UNITYSDK_OFFSET(0x1B44DF30)
#define RPG_GAMECORE_TARGETEVALUATOR_METHOD_3_1631CC4D79302AD6_OFFSET UNITYSDK_OFFSET(0x1B44DF20)
#define RPG_GAMECORE_TARGETEVALUATOR_METHOD_3_76A6B9467EADE6F3_OFFSET UNITYSDK_OFFSET(0x1B44DEC0)
#define RPG_GAMECORE_TARGETEVALUATOR_METHOD_3_BC6C782BC059E53C_OFFSET UNITYSDK_OFFSET(0x1B44DE60)
#define RPG_GAMECORE_TARGETEVALUATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B44D1F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetEvaluator_TypeDefinitionIndex = 22891;
