...
#define RPG_GAMECORE_TARGETEVALUATOR_METHOD_3_1A48AD11003A8869_OFFSET UNITYSDK_OFFSET(0x1778B0C0)
#define RPG_GAMECORE_TARGETEVALUATOR_METHOD_3_BC6C782BC059E53C_OFFSET UNITYSDK_OFFSET(0x177AD760)
#define RPG_GAMECORE_TARGETEVALUATOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x177AD7C0)
#define RPG_GAMECORE_TARGETEVALUATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x177ACD70)
...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Func_2<::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::TargetEvaluator*>*>**)Il2CppClass::FromTypeDefinitionIndex(TargetEvaluator_TypeDefinitionIndex)->GetStaticField(0x133C0);
		}
