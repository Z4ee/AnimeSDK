...
#define RPG_GAMECORE_FIVEDIMPROPSPAWNERITEM_METHOD_2_69FC4F89D2B4863B_OFFSET UNITYSDK_OFFSET(0x1BEACD80)
#define RPG_GAMECORE_FIVEDIMPROPSPAWNERITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEACEE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimPropSpawnerItem_TypeDefinitionIndex = 17855;
