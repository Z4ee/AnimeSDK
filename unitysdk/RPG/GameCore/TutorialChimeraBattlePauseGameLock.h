...
#define RPG_GAMECORE_TUTORIALCHIMERABATTLEPAUSEGAMELOCK_METHOD_3_13636B29A63070A6_OFFSET UNITYSDK_OFFSET(0x19E26580)
#define RPG_GAMECORE_TUTORIALCHIMERABATTLEPAUSEGAMELOCK_METHOD_3_9D54F9AC979646AF_OFFSET UNITYSDK_OFFSET(0x19E26600)
#define RPG_GAMECORE_TUTORIALCHIMERABATTLEPAUSEGAMELOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x19E265D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TutorialChimeraBattlePauseGameLock_TypeDefinitionIndex = 23055;
