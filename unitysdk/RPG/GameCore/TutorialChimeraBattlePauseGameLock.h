...
#define RPG_GAMECORE_TUTORIALCHIMERABATTLEPAUSEGAMELOCK_METHOD_3_9D54F9AC979646AF_OFFSET UNITYSDK_OFFSET(0x1B0680A0)
#define RPG_GAMECORE_TUTORIALCHIMERABATTLEPAUSEGAMELOCK_METHOD_3_B8CAE36AD9D07D0E_OFFSET UNITYSDK_OFFSET(0x1B068050)
#define RPG_GAMECORE_TUTORIALCHIMERABATTLEPAUSEGAMELOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B068090)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TutorialChimeraBattlePauseGameLock_TypeDefinitionIndex = 23522;
