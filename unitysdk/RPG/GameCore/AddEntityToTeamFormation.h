...
#define RPG_GAMECORE_ADDENTITYTOTEAMFORMATION_METHOD_3_0C387A365781197D_OFFSET UNITYSDK_OFFSET(0x1D69FDC0)
#define RPG_GAMECORE_ADDENTITYTOTEAMFORMATION_METHOD_3_831D25ED39BB3FFE_OFFSET UNITYSDK_OFFSET(0x1D69FD80)
#define RPG_GAMECORE_ADDENTITYTOTEAMFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D69FDB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddEntityToTeamFormation_TypeDefinitionIndex = 22386;
