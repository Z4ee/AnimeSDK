...
#define RPG_GAMECORE_ADDENTITYTOTEAMFORMATION_METHOD_3_0C387A365781197D_OFFSET UNITYSDK_OFFSET(0x1863DE20)
#define RPG_GAMECORE_ADDENTITYTOTEAMFORMATION_METHOD_3_D5B9D6EB323108EC_OFFSET UNITYSDK_OFFSET(0x1863DDA0)
#define RPG_GAMECORE_ADDENTITYTOTEAMFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1863DDF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddEntityToTeamFormation_TypeDefinitionIndex = 21527;
