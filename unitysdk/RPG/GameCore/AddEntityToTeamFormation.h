...
#define RPG_GAMECORE_ADDENTITYTOTEAMFORMATION_METHOD_3_0C387A365781197D_OFFSET UNITYSDK_OFFSET(0x1940CE30)
#define RPG_GAMECORE_ADDENTITYTOTEAMFORMATION_METHOD_3_D5B9D6EB323108EC_OFFSET UNITYSDK_OFFSET(0x1940CDB0)
#define RPG_GAMECORE_ADDENTITYTOTEAMFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1940CE00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddEntityToTeamFormation_TypeDefinitionIndex = 21404;
