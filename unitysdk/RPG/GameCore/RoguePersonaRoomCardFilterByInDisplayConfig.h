...
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYINDISPLAYCONFIG_METHOD_3_44A2D97E0ECFE0CA_OFFSET UNITYSDK_OFFSET(0x1D40E450)
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYINDISPLAYCONFIG_METHOD_3_4A8462AE64ACA126_OFFSET UNITYSDK_OFFSET(0x1D40E1E0)
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYINDISPLAYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D40E1D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RoguePersonaRoomCardFilterByInDisplayConfig_TypeDefinitionIndex = 19642;
