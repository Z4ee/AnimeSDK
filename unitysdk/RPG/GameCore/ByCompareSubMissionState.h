...
#define RPG_GAMECORE_BYCOMPARESUBMISSIONSTATE_METHOD_4_1ED1B0FE2A40338C_OFFSET UNITYSDK_OFFSET(0x1CF02370)
#define RPG_GAMECORE_BYCOMPARESUBMISSIONSTATE_METHOD_4_3C721A22685CD33E_OFFSET UNITYSDK_OFFSET(0x1CF025C0)
#define RPG_GAMECORE_BYCOMPARESUBMISSIONSTATE_METHOD_4_988E2E4551E06201_OFFSET UNITYSDK_OFFSET(0x1CF02330)
#define RPG_GAMECORE_BYCOMPARESUBMISSIONSTATE_METHOD_4_A72DF3F7587E8B71_OFFSET UNITYSDK_OFFSET(0x1CF02590)
#define RPG_GAMECORE_BYCOMPARESUBMISSIONSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF02360)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareSubMissionState_TypeDefinitionIndex = 20075;
