...
#define RPG_GAMECORE_BYCOMPARESUBMISSIONSTATE_METHOD_4_1ED1B0FE2A40338C_OFFSET UNITYSDK_OFFSET(0x17019800)
#define RPG_GAMECORE_BYCOMPARESUBMISSIONSTATE_METHOD_4_2942F15B5EBE8628_OFFSET UNITYSDK_OFFSET(0x17019730)
#define RPG_GAMECORE_BYCOMPARESUBMISSIONSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x170197B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareSubMissionState_TypeDefinitionIndex = 18598;
