...
#define RPG_GAMECORE_EXPEDITIONBATTLELEVELCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D7DBD40)
#define RPG_GAMECORE_EXPEDITIONBATTLELEVELCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7DBE60)
