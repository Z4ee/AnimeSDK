...
#define RPG_GAMECORE_FIVEDIMPLAYSUMMONBOTANIMACTION_METHOD_3_8A30F7249D82E6FE_OFFSET UNITYSDK_OFFSET(0x1D0F8570)
#define RPG_GAMECORE_FIVEDIMPLAYSUMMONBOTANIMACTION_METHOD_3_EE3A2582AFEEA7EF_OFFSET UNITYSDK_OFFSET(0x1D0F85F0)
#define RPG_GAMECORE_FIVEDIMPLAYSUMMONBOTANIMACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0F85E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimPlaySummonBotAnimAction_TypeDefinitionIndex = 18518;
