...
#define RPG_GAMECORE_FIVEDIMPLAYSUMMONBOTANIMACTION_METHOD_3_D625E3A26166A062_OFFSET UNITYSDK_OFFSET(0x17201D10)
#define RPG_GAMECORE_FIVEDIMPLAYSUMMONBOTANIMACTION_METHOD_3_EE3A2582AFEEA7EF_OFFSET UNITYSDK_OFFSET(0x17201DD0)
#define RPG_GAMECORE_FIVEDIMPLAYSUMMONBOTANIMACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x17201DB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimPlaySummonBotAnimAction_TypeDefinitionIndex = 17190;
