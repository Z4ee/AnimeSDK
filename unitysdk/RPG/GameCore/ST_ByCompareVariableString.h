...
#define RPG_GAMECORE_ST_BYCOMPAREVARIABLESTRING_METHOD_4_4451AD2F76E73CD4_OFFSET UNITYSDK_OFFSET(0x17691D90)
#define RPG_GAMECORE_ST_BYCOMPAREVARIABLESTRING_METHOD_4_B65510496ECC4C40_OFFSET UNITYSDK_OFFSET(0x17691CC0)
#define RPG_GAMECORE_ST_BYCOMPAREVARIABLESTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x17691D40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_ByCompareVariableString_TypeDefinitionIndex = 18350;
