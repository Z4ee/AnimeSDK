...
#define RPG_GAMECORE_ST_BYCOMPAREVARIABLESTRING_METHOD_4_4451AD2F76E73CD4_OFFSET UNITYSDK_OFFSET(0x1B778890)
#define RPG_GAMECORE_ST_BYCOMPAREVARIABLESTRING_METHOD_4_8EFF4D2D25B7A2E9_OFFSET UNITYSDK_OFFSET(0x1B778850)
#define RPG_GAMECORE_ST_BYCOMPAREVARIABLESTRING_METHOD_4_BC4AAB076CE81499_OFFSET UNITYSDK_OFFSET(0x1B778A90)
#define RPG_GAMECORE_ST_BYCOMPAREVARIABLESTRING_METHOD_4_D7FDE9861AA1FCB6_OFFSET UNITYSDK_OFFSET(0x1B778AC0)
#define RPG_GAMECORE_ST_BYCOMPAREVARIABLESTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1B778880)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_ByCompareVariableString_TypeDefinitionIndex = 19299;
