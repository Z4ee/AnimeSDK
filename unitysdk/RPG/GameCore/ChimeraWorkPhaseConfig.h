...
#define RPG_GAMECORE_CHIMERAWORKPHASECONFIG_METHOD_2_4228BB14C3B29235_OFFSET UNITYSDK_OFFSET(0x1E342F70)
#define RPG_GAMECORE_CHIMERAWORKPHASECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1E3432C0)
