...
#define RPG_GAMECORE_CHIMERAWORKPHASECONFIG_METHOD_2_3D4D4FBC31ADB060_OFFSET UNITYSDK_OFFSET(0x170AD540)
#define RPG_GAMECORE_CHIMERAWORKPHASECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x170AD8A0)
