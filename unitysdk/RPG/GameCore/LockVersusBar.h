...
#define RPG_GAMECORE_LOCKVERSUSBAR_METHOD_3_4383D0040E087E29_OFFSET UNITYSDK_OFFSET(0x18A7A950)
#define RPG_GAMECORE_LOCKVERSUSBAR_METHOD_3_B313798818AC2870_OFFSET UNITYSDK_OFFSET(0x18A7A9D0)
#define RPG_GAMECORE_LOCKVERSUSBAR__CTOR_OFFSET UNITYSDK_OFFSET(0x18A7A9A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LockVersusBar_TypeDefinitionIndex = 22093;
