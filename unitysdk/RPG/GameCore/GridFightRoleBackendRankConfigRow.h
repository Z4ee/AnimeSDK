...
#define RPG_GAMECORE_GRIDFIGHTROLEBACKENDRANKCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D161BC0)
#define RPG_GAMECORE_GRIDFIGHTROLEBACKENDRANKCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D162230)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::FixPoint ModifyEnergyBar; // 0x68
		::RPG::GameCore::FixPoint ModifyInitialEnergyBar; // 0x70
		::RPG::Client::TextID Name; // 0x78
		::RPG::GameCore::StringHash Trigger; // 0x88
		::System::UInt32 RankID; // 0x8C
