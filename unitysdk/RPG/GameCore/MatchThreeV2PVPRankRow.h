...
#define RPG_GAMECORE_MATCHTHREEV2PVPRANKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1AF406A0)
#define RPG_GAMECORE_MATCHTHREEV2PVPRANKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF409A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MatchThreeV2PVPRankRow_TypeDefinitionIndex = 11538;
