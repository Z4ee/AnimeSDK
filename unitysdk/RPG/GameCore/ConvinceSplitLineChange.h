...
#define RPG_GAMECORE_CONVINCESPLITLINECHANGE_METHOD_3_17A6FCA5F11FFEFE_OFFSET UNITYSDK_OFFSET(0x1883F260)
#define RPG_GAMECORE_CONVINCESPLITLINECHANGE_METHOD_3_53F3197AEBBD416F_OFFSET UNITYSDK_OFFSET(0x1883F2E0)
#define RPG_GAMECORE_CONVINCESPLITLINECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1883F2B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConvinceSplitLineChange_TypeDefinitionIndex = 20683;
