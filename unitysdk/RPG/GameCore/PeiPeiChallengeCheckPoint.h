...
#define RPG_GAMECORE_PEIPEICHALLENGECHECKPOINT_METHOD_2_884724326AC753ED_OFFSET UNITYSDK_OFFSET(0x199EC700)
#define RPG_GAMECORE_PEIPEICHALLENGECHECKPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x199EC7E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PeiPeiChallengeCheckPoint_TypeDefinitionIndex = 20021;
