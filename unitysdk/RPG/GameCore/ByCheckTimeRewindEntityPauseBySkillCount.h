...
#define RPG_GAMECORE_BYCHECKTIMEREWINDENTITYPAUSEBYSKILLCOUNT_METHOD_4_823555678567D9B3_OFFSET UNITYSDK_OFFSET(0x18725250)
#define RPG_GAMECORE_BYCHECKTIMEREWINDENTITYPAUSEBYSKILLCOUNT_METHOD_4_E12977EA412CC121_OFFSET UNITYSDK_OFFSET(0x18725320)
#define RPG_GAMECORE_BYCHECKTIMEREWINDENTITYPAUSEBYSKILLCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x187252D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckTimeRewindEntityPauseBySkillCount_TypeDefinitionIndex = 19643;
