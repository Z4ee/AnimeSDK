...
#define RPG_GAMECORE_CHALLENGEGENERALCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x195FA580)
#define RPG_GAMECORE_CHALLENGEGENERALCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x195FAC30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChallengeGeneralConfigRow_TypeDefinitionIndex = 12313;
