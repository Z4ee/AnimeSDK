...
#define RPG_GAMECORE_BATTLEAREAREFERENCEINFO_METHOD_2_D32310353F5C8363_OFFSET UNITYSDK_OFFSET(0x16FCBC20)
#define RPG_GAMECORE_BATTLEAREAREFERENCEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16FCBD60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleAreaReferenceInfo_TypeDefinitionIndex = 15827;
