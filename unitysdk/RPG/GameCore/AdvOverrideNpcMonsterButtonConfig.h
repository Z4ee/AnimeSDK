...
#define RPG_GAMECORE_ADVOVERRIDENPCMONSTERBUTTONCONFIG_METHOD_3_2AD8B220F4792427_OFFSET UNITYSDK_OFFSET(0x16F3A440)
#define RPG_GAMECORE_ADVOVERRIDENPCMONSTERBUTTONCONFIG_METHOD_3_A08E9B9B06D2D678_OFFSET UNITYSDK_OFFSET(0x16F3A4C0)
#define RPG_GAMECORE_ADVOVERRIDENPCMONSTERBUTTONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16F3A490)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvOverrideNpcMonsterButtonConfig_TypeDefinitionIndex = 20406;
