...
#define RPG_GAMECORE_SWITCHHANDCANCELLIFT_METHOD_3_10C4E8080BD99498_OFFSET UNITYSDK_OFFSET(0x1E14E0E0)
#define RPG_GAMECORE_SWITCHHANDCANCELLIFT_METHOD_3_C66D751A40A88AD5_OFFSET UNITYSDK_OFFSET(0x1E14E1B0)
#define RPG_GAMECORE_SWITCHHANDCANCELLIFT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E14E1A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchHandCancelLift_TypeDefinitionIndex = 20726;
