...
#define RPG_GAMECORE_SWITCHHANDCANCELLIFT_METHOD_3_3A8BF88266B135C1_OFFSET UNITYSDK_OFFSET(0x177941C0)
#define RPG_GAMECORE_SWITCHHANDCANCELLIFT_METHOD_3_C66D751A40A88AD5_OFFSET UNITYSDK_OFFSET(0x177942D0)
#define RPG_GAMECORE_SWITCHHANDCANCELLIFT__CTOR_OFFSET UNITYSDK_OFFSET(0x177942A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchHandCancelLift_TypeDefinitionIndex = 19294;
