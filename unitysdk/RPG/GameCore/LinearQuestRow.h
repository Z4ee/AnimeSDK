...
#define RPG_GAMECORE_LINEARQUESTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D1F6130)
#define RPG_GAMECORE_LINEARQUESTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1F67B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LinearQuestRow_TypeDefinitionIndex = 14407;
