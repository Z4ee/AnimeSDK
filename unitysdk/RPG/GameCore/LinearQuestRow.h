...
#define RPG_GAMECORE_LINEARQUESTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1DD5E330)
#define RPG_GAMECORE_LINEARQUESTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD5E9B0)
