...
#define RPG_GAMECORE_LINEARQUESTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B08FA50)
#define RPG_GAMECORE_LINEARQUESTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0900D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LinearQuestRow_TypeDefinitionIndex = 13989;

	class LinearQuestRow : public ::System::Object
	{
	public:
		::Il2CppArray<::System::UInt32>* QuestList; // 0x10
		::System::UInt32 MinLevel; // 0x18
		::System::UInt32 LinearID; // 0x1C
