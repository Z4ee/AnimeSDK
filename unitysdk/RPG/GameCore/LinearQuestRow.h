...
#define RPG_GAMECORE_LINEARQUESTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17351390)
#define RPG_GAMECORE_LINEARQUESTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x173519F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LinearQuestRow_TypeDefinitionIndex = 13298;
