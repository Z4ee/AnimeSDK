...
#define RPG_GAMECORE_ILBATTLESTAGECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D20C320)
#define RPG_GAMECORE_ILBATTLESTAGECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D20C670)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ILBattleStageConfigRow_TypeDefinitionIndex = 13690;
	...
	public:
		...
		::System::UInt64 CombatValue; // 0x28
		::System::UInt32 EliteGroup; // 0x30
		::System::UInt16 RecommendDungeonFloor; // 0x34
		::System::UInt32 ID; // 0x38
		::System::UInt32 HardLevelGroup; // 0x3C
