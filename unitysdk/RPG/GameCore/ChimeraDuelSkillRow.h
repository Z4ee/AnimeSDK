...
#define RPG_GAMECORE_CHIMERADUELSKILLROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1E33C250)
#define RPG_GAMECORE_CHIMERADUELSKILLROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1E33C710)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID PlainDescription; // 0x30
		::System::Boolean HasDisplay; // 0x40
		::System::Boolean IsImmediate; // 0x41
		::RPG::GameCore::ChimeraDuelSkillEffectScope Type; // 0x44
		::RPG::Client::TextID Description; // 0x48
		::System::UInt32 Priority; // 0x58
		::System::UInt32 SkillCD; // 0x5C
