...
#define RPG_GAMECORE_ANIMATIONMOVERANGE_METHOD_2_E2D535E84611179A_OFFSET UNITYSDK_OFFSET(0x16F829C0)
#define RPG_GAMECORE_ANIMATIONMOVERANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F83160)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AnimationMoveRange_TypeDefinitionIndex = 20647;
