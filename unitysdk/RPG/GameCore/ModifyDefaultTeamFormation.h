...
#define RPG_GAMECORE_MODIFYDEFAULTTEAMFORMATION_METHOD_3_290B0C8EAA125B1E_OFFSET UNITYSDK_OFFSET(0x1B1AA3F0)
#define RPG_GAMECORE_MODIFYDEFAULTTEAMFORMATION_METHOD_3_9227538EE359B3B1_OFFSET UNITYSDK_OFFSET(0x1B1AA2A0)
#define RPG_GAMECORE_MODIFYDEFAULTTEAMFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1AA360)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyDefaultTeamFormation_TypeDefinitionIndex = 21677;
