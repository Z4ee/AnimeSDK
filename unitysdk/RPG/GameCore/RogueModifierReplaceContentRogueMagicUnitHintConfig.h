...
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEMAGICUNITHINTCONFIG_METHOD_3_46519AA30CE66949_OFFSET UNITYSDK_OFFSET(0x1D165A40)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEMAGICUNITHINTCONFIG_METHOD_3_965370C5F1A6A54D_OFFSET UNITYSDK_OFFSET(0x1D165A90)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEMAGICUNITHINTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D165A80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierReplaceContentRogueMagicUnitHintConfig_TypeDefinitionIndex = 17000;
