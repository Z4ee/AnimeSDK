...
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEMAGICUNITHINTCONFIG_METHOD_3_823B284D24044BD4_OFFSET UNITYSDK_OFFSET(0x19B9B4E0)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEMAGICUNITHINTCONFIG_METHOD_3_965370C5F1A6A54D_OFFSET UNITYSDK_OFFSET(0x19B9B5B0)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEMAGICUNITHINTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B9B560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierReplaceContentRogueMagicUnitHintConfig_TypeDefinitionIndex = 16838;
