...
#define RPG_GAMECORE_BATTLESINGLECLICKQTECONFIG_METHOD_3_040DF01F8B602825_OFFSET UNITYSDK_OFFSET(0x1B3044E0)
#define RPG_GAMECORE_BATTLESINGLECLICKQTECONFIG_METHOD_3_B3972B4F140B1124_OFFSET UNITYSDK_OFFSET(0x1B306660)
#define RPG_GAMECORE_BATTLESINGLECLICKQTECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3044D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleSingleClickQTEConfig_TypeDefinitionIndex = 23079;
