...
#define RPG_GAMECORE_BATTLESINGLECLICKQTECONFIG_METHOD_3_461578501E15FF77_OFFSET UNITYSDK_OFFSET(0x18703330)
#define RPG_GAMECORE_BATTLESINGLECLICKQTECONFIG_METHOD_3_572D539EBE2CD7CF_OFFSET UNITYSDK_OFFSET(0x187055F0)
#define RPG_GAMECORE_BATTLESINGLECLICKQTECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18703320)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleSingleClickQTEConfig_TypeDefinitionIndex = 22314;
