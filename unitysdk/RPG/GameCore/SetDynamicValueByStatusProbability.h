...
#define RPG_GAMECORE_SETDYNAMICVALUEBYSTATUSPROBABILITY_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x18E28E20)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSTATUSPROBABILITY_METHOD_4_8CFCF349DB68D634_OFFSET UNITYSDK_OFFSET(0x18E28C30)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSTATUSPROBABILITY_METHOD_4_97C3D9DABA1FD510_OFFSET UNITYSDK_OFFSET(0x18E28B60)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSTATUSPROBABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x18E28BE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByStatusProbability_TypeDefinitionIndex = 22556;
