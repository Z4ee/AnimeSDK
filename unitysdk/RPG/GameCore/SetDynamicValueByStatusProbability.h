...
#define RPG_GAMECORE_SETDYNAMICVALUEBYSTATUSPROBABILITY_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1C5F1F80)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSTATUSPROBABILITY_METHOD_4_8CFCF349DB68D634_OFFSET UNITYSDK_OFFSET(0x1C5F1D90)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSTATUSPROBABILITY_METHOD_4_F9476E49AC54B635_OFFSET UNITYSDK_OFFSET(0x1C5F1D50)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSTATUSPROBABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5F1D80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByStatusProbability_TypeDefinitionIndex = 22736;
