...
#define RPG_GAMECORE_SETDYNAMICVALUEBYSTATUSPROBABILITY_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x19C45B40)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSTATUSPROBABILITY_METHOD_4_8CFCF349DB68D634_OFFSET UNITYSDK_OFFSET(0x19C45950)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSTATUSPROBABILITY_METHOD_4_97C3D9DABA1FD510_OFFSET UNITYSDK_OFFSET(0x19C45880)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSTATUSPROBABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x19C45900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByStatusProbability_TypeDefinitionIndex = 22295;
