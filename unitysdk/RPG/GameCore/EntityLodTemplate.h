...
#define RPG_GAMECORE_ENTITYLODTEMPLATE_METHOD_3_A716431842D8A527_OFFSET UNITYSDK_OFFSET(0x1C055C80)
#define RPG_GAMECORE_ENTITYLODTEMPLATE_METHOD_3_B9B8DBC32781E371_OFFSET UNITYSDK_OFFSET(0x1C055C40)
#define RPG_GAMECORE_ENTITYLODTEMPLATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C055C70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EntityLodTemplate_TypeDefinitionIndex = 18458;
