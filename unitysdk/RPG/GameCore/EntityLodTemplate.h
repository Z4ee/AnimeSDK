...
#define RPG_GAMECORE_ENTITYLODTEMPLATE_METHOD_3_A35ECDAF9C1B5006_OFFSET UNITYSDK_OFFSET(0x188AEEC0)
#define RPG_GAMECORE_ENTITYLODTEMPLATE_METHOD_3_BB987BB6EB30049F_OFFSET UNITYSDK_OFFSET(0x188AEF00)
#define RPG_GAMECORE_ENTITYLODTEMPLATE__CTOR_OFFSET UNITYSDK_OFFSET(0x188AEEF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EntityLodTemplate_TypeDefinitionIndex = 18251;
