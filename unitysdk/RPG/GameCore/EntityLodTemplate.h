...
#define RPG_GAMECORE_ENTITYLODTEMPLATE_METHOD_3_A716431842D8A527_OFFSET UNITYSDK_OFFSET(0x196ECF20)
#define RPG_GAMECORE_ENTITYLODTEMPLATE_METHOD_3_B9B8DBC32781E371_OFFSET UNITYSDK_OFFSET(0x196ECEE0)
#define RPG_GAMECORE_ENTITYLODTEMPLATE__CTOR_OFFSET UNITYSDK_OFFSET(0x196ECF10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EntityLodTemplate_TypeDefinitionIndex = 18224;
