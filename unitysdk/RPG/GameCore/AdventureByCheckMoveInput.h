...
#define RPG_GAMECORE_ADVENTUREBYCHECKMOVEINPUT_METHOD_4_0D1B265559100449_OFFSET UNITYSDK_OFFSET(0x1CBA8CE0)
#define RPG_GAMECORE_ADVENTUREBYCHECKMOVEINPUT_METHOD_4_6C650B4435E54EA6_OFFSET UNITYSDK_OFFSET(0x1CBA8E50)
#define RPG_GAMECORE_ADVENTUREBYCHECKMOVEINPUT_METHOD_4_90640F4DAA0343F3_OFFSET UNITYSDK_OFFSET(0x1CBA8E20)
#define RPG_GAMECORE_ADVENTUREBYCHECKMOVEINPUT_METHOD_4_DB43D42584C348C2_OFFSET UNITYSDK_OFFSET(0x1CBA8CA0)
#define RPG_GAMECORE_ADVENTUREBYCHECKMOVEINPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CBA8CD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureByCheckMoveInput_TypeDefinitionIndex = 20004;
