...
#define RPG_GAMECORE_ADVENTUREBYCHECKMOVEINPUT_METHOD_4_0D1B265559100449_OFFSET UNITYSDK_OFFSET(0x16F4B940)
#define RPG_GAMECORE_ADVENTUREBYCHECKMOVEINPUT_METHOD_4_3C5F0F0A1D565443_OFFSET UNITYSDK_OFFSET(0x16F4B870)
#define RPG_GAMECORE_ADVENTUREBYCHECKMOVEINPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x16F4B8F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureByCheckMoveInput_TypeDefinitionIndex = 18524;
