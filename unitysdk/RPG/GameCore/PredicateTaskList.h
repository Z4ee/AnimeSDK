...
#define RPG_GAMECORE_PREDICATETASKLIST_METHOD_3_8A8481413F886A70_OFFSET UNITYSDK_OFFSET(0x18C5F700)
#define RPG_GAMECORE_PREDICATETASKLIST_METHOD_3_A0726820766CD54D_OFFSET UNITYSDK_OFFSET(0x18C5FB90)
#define RPG_GAMECORE_PREDICATETASKLIST_METHOD_3_A512D5B3FB39DA25_OFFSET UNITYSDK_OFFSET(0x18C5F780)
#define RPG_GAMECORE_PREDICATETASKLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x18C5F750)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PredicateTaskList_TypeDefinitionIndex = 22808;
	...
	public:
		...
		static ::System::Void Method_3_A512D5B3FB39DA25(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::PredicateTaskList* a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::PredicateTaskList*))((::PBYTE)hIl2Cpp + RPG_GAMECORE_PREDICATETASKLIST_METHOD_3_A512D5B3FB39DA25_OFFSET))(a1, a2);
		}
