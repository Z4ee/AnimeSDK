...
#define RPG_GAMECORE_PREDICATETASKLIST_METHOD_3_8A8481413F886A70_OFFSET UNITYSDK_OFFSET(0x17510350)
#define RPG_GAMECORE_PREDICATETASKLIST_METHOD_3_A0726820766CD54D_OFFSET UNITYSDK_OFFSET(0x175107E0)
#define RPG_GAMECORE_PREDICATETASKLIST_METHOD_3_A512D5B3FB39DA25_OFFSET UNITYSDK_OFFSET(0x175103D0)
#define RPG_GAMECORE_PREDICATETASKLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x175103A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PredicateTaskList_TypeDefinitionIndex = 22091;
