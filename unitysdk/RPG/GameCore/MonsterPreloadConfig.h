...
#define RPG_GAMECORE_MONSTERPRELOADCONFIG_METHOD_3_A1D88C8A3C097CF9_OFFSET UNITYSDK_OFFSET(0x17451540)
#define RPG_GAMECORE_MONSTERPRELOADCONFIG_METHOD_3_B1B884D0EA65DC3A_OFFSET UNITYSDK_OFFSET(0x17451500)
#define RPG_GAMECORE_MONSTERPRELOADCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17451530)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonsterPreloadConfig_TypeDefinitionIndex = 14956;
