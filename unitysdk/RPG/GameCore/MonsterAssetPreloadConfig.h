...
#define RPG_GAMECORE_MONSTERASSETPRELOADCONFIG_METHOD_3_DA6D5D3DD89E4227_OFFSET UNITYSDK_OFFSET(0x199A5670)
#define RPG_GAMECORE_MONSTERASSETPRELOADCONFIG_METHOD_3_E14F076DE95C2190_OFFSET UNITYSDK_OFFSET(0x199A5630)
#define RPG_GAMECORE_MONSTERASSETPRELOADCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x199A5660)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonsterAssetPreloadConfig_TypeDefinitionIndex = 15651;
