...
#define RPG_GAMECORE_ROGUEMAGICUNITROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CFB9990)
#define RPG_GAMECORE_ROGUEMAGICUNITROW_GETMAZEBUFF_OFFSET UNITYSDK_OFFSET(0x1CFB9FA0)
#define RPG_GAMECORE_ROGUEMAGICUNITROW_GET_ISACTIVEUNIT_OFFSET UNITYSDK_OFFSET(0x1CFBA0B0)
#define RPG_GAMECORE_ROGUEMAGICUNITROW_GET_ISPASSIVEUNIT_OFFSET UNITYSDK_OFFSET(0x1CFBA0A0)
#define RPG_GAMECORE_ROGUEMAGICUNITROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFB9F90)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::RogueMagicSpecialType SpecialType; // 0x40
		::RPG::GameCore::RogueMagicStyleType StyleType; // 0x44
		::RPG::GameCore::RogueMagicScepterFuncType FuncType; // 0x48
		::RPG::GameCore::RogueMagicMountType MagicUnitType; // 0x4C
		::RPG::GameCore::FixPoint UnitBasicPower; // 0x50
		::RPG::Client::TextID MagicUnitDesc; // 0x58
		::System::UInt32 MagicUnitMazeBuffID; // 0x68
		::System::UInt32 MagicUnitID; // 0x6C
		::System::UInt32 MagicUnitLevel; // 0x70
