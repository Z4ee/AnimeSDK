...
#define RPG_GAMECORE_QTECATCHGHOSTSENDNOTIFY_METHOD_3_612513333AE261EE_OFFSET UNITYSDK_OFFSET(0x18C803A0)
#define RPG_GAMECORE_QTECATCHGHOSTSENDNOTIFY_METHOD_3_C319573700DA185D_OFFSET UNITYSDK_OFFSET(0x18C80320)
#define RPG_GAMECORE_QTECATCHGHOSTSENDNOTIFY__CTOR_OFFSET UNITYSDK_OFFSET(0x18C80370)

namespace RPG::GameCore
{
	inline static constexpr unsigned int QteCatchGhostSendNotify_TypeDefinitionIndex = 20909;
