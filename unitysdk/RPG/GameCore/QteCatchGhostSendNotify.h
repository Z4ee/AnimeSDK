...
#define RPG_GAMECORE_QTECATCHGHOSTSENDNOTIFY_METHOD_3_574E0B8F39DB4505_OFFSET UNITYSDK_OFFSET(0x1B9A9F20)
#define RPG_GAMECORE_QTECATCHGHOSTSENDNOTIFY_METHOD_3_612513333AE261EE_OFFSET UNITYSDK_OFFSET(0x1B9A9F60)
#define RPG_GAMECORE_QTECATCHGHOSTSENDNOTIFY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9A9F50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int QteCatchGhostSendNotify_TypeDefinitionIndex = 21240;
