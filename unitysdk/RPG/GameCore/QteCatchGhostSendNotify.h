...
#define RPG_GAMECORE_QTECATCHGHOSTSENDNOTIFY_METHOD_3_612513333AE261EE_OFFSET UNITYSDK_OFFSET(0x19AA2CB0)
#define RPG_GAMECORE_QTECATCHGHOSTSENDNOTIFY_METHOD_3_C319573700DA185D_OFFSET UNITYSDK_OFFSET(0x19AA2C30)
#define RPG_GAMECORE_QTECATCHGHOSTSENDNOTIFY__CTOR_OFFSET UNITYSDK_OFFSET(0x19AA2C80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int QteCatchGhostSendNotify_TypeDefinitionIndex = 20825;
