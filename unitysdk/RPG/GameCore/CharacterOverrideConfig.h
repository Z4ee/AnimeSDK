...
#define RPG_GAMECORE_CHARACTEROVERRIDECONFIG_METHOD_3_14EC74BA8FE5D0ED_OFFSET UNITYSDK_OFFSET(0x1B726F10)
#define RPG_GAMECORE_CHARACTEROVERRIDECONFIG_METHOD_3_2814500FC2096A12_OFFSET UNITYSDK_OFFSET(0x1B7281D0)
#define RPG_GAMECORE_CHARACTEROVERRIDECONFIG_METHOD_3_53216CC327ED0939_OFFSET UNITYSDK_OFFSET(0x1B7279F0)
#define RPG_GAMECORE_CHARACTEROVERRIDECONFIG_METHOD_3_64D48032FAFF8ED5_OFFSET UNITYSDK_OFFSET(0x1B727020)
#define RPG_GAMECORE_CHARACTEROVERRIDECONFIG_METHOD_3_929DB29232C80A02_OFFSET UNITYSDK_OFFSET(0x1B7282A0)
#define RPG_GAMECORE_CHARACTEROVERRIDECONFIG_METHOD_3_B2525A63B6135506_OFFSET UNITYSDK_OFFSET(0x1B720170)
#define RPG_GAMECORE_CHARACTEROVERRIDECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B720080)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterOverrideConfig_TypeDefinitionIndex = 15869;

	class CharacterOverrideConfig : public ::RPG::GameCore::CharacterConfig
	{
	public:
		::System::String* ParentConfigPath; // 0x220
		::Il2CppArray<::System::String*>* DLCPathList; // 0x228
		::Il2CppArray<::System::String*>* InheritSkillList; // 0x230
		::Il2CppArray<::System::String*>* ReplacedSkillList; // 0x238
		::Class_1_1C30CE192ABE4C54* AdditiveDynamicValues; // 0x240
