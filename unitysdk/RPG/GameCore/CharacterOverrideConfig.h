...
#define RPG_GAMECORE_CHARACTEROVERRIDECONFIG_METHOD_3_2C01EA1AF3BDA280_OFFSET UNITYSDK_OFFSET(0x187D4DD0)
#define RPG_GAMECORE_CHARACTEROVERRIDECONFIG_METHOD_3_B2525A63B6135506_OFFSET UNITYSDK_OFFSET(0x187CDF00)
#define RPG_GAMECORE_CHARACTEROVERRIDECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x187CDEF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterOverrideConfig_TypeDefinitionIndex = 15637;

	class CharacterOverrideConfig : public ::RPG::GameCore::CharacterConfig
	{
	public:
		::System::String* ParentConfigPath; // 0x208
		::Il2CppArray<::System::String*>* InheritSkillList; // 0x210
		::Il2CppArray<::System::String*>* ReplacedSkillList; // 0x218
		::Class_1_2CAAA2FDF9170110* AdditiveDynamicValues; // 0x220
