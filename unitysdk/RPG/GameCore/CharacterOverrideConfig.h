...
#define RPG_GAMECORE_CHARACTEROVERRIDECONFIG_METHOD_3_14EC74BA8FE5D0ED_OFFSET UNITYSDK_OFFSET(0x1D125060)
#define RPG_GAMECORE_CHARACTEROVERRIDECONFIG_METHOD_3_2814500FC2096A12_OFFSET UNITYSDK_OFFSET(0x1D126320)
#define RPG_GAMECORE_CHARACTEROVERRIDECONFIG_METHOD_3_53216CC327ED0939_OFFSET UNITYSDK_OFFSET(0x1D125B40)
#define RPG_GAMECORE_CHARACTEROVERRIDECONFIG_METHOD_3_64D48032FAFF8ED5_OFFSET UNITYSDK_OFFSET(0x1D125170)
#define RPG_GAMECORE_CHARACTEROVERRIDECONFIG_METHOD_3_929DB29232C80A02_OFFSET UNITYSDK_OFFSET(0x1D1263F0)
#define RPG_GAMECORE_CHARACTEROVERRIDECONFIG_METHOD_3_B2525A63B6135506_OFFSET UNITYSDK_OFFSET(0x1D11E1B0)
#define RPG_GAMECORE_CHARACTEROVERRIDECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D11E0C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterOverrideConfig_TypeDefinitionIndex = 16345;
