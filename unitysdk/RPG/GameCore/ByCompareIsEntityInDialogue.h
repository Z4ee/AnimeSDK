...
#define RPG_GAMECORE_BYCOMPAREISENTITYINDIALOGUE_METHOD_4_89EFB39455EF7E96_OFFSET UNITYSDK_OFFSET(0x18730A70)
#define RPG_GAMECORE_BYCOMPAREISENTITYINDIALOGUE_METHOD_4_B522C25022764568_OFFSET UNITYSDK_OFFSET(0x187309A0)
#define RPG_GAMECORE_BYCOMPAREISENTITYINDIALOGUE__CTOR_OFFSET UNITYSDK_OFFSET(0x18730A20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareIsEntityInDialogue_TypeDefinitionIndex = 19868;
