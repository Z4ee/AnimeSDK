...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYROGUELAYERROOMGROUPWEIGHTCONFIG_METHOD_3_0E03E80EA144A004_OFFSET UNITYSDK_OFFSET(0x18D424E0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYROGUELAYERROOMGROUPWEIGHTCONFIG_METHOD_3_50EE166A0D6F197D_OFFSET UNITYSDK_OFFSET(0x18D425B0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYROGUELAYERROOMGROUPWEIGHTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D42560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyRogueLayerRoomGroupWeightConfig_TypeDefinitionIndex = 16848;
