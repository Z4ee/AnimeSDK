...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYROGUELAYERROOMGROUPWEIGHTCONFIG_METHOD_3_35D71EF53F2D9E39_OFFSET UNITYSDK_OFFSET(0x1D1645A0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYROGUELAYERROOMGROUPWEIGHTCONFIG_METHOD_3_50EE166A0D6F197D_OFFSET UNITYSDK_OFFSET(0x1D1645F0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYROGUELAYERROOMGROUPWEIGHTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1645E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyRogueLayerRoomGroupWeightConfig_TypeDefinitionIndex = 17025;
