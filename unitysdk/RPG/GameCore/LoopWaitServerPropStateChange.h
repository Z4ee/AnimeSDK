...
#define RPG_GAMECORE_LOOPWAITSERVERPROPSTATECHANGE_METHOD_3_2C89BDBAC7A2FAA0_OFFSET UNITYSDK_OFFSET(0x1BCD4E30)
#define RPG_GAMECORE_LOOPWAITSERVERPROPSTATECHANGE_METHOD_3_5F248E84D1F751ED_OFFSET UNITYSDK_OFFSET(0x1BCD4E70)
#define RPG_GAMECORE_LOOPWAITSERVERPROPSTATECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCD4E60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoopWaitServerPropStateChange_TypeDefinitionIndex = 21425;
