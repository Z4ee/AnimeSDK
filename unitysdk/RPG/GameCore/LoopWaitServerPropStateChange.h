...
#define RPG_GAMECORE_LOOPWAITSERVERPROPSTATECHANGE_METHOD_3_5F248E84D1F751ED_OFFSET UNITYSDK_OFFSET(0x18A7F0C0)
#define RPG_GAMECORE_LOOPWAITSERVERPROPSTATECHANGE_METHOD_3_E642D2ED9159FD62_OFFSET UNITYSDK_OFFSET(0x18A7F050)
#define RPG_GAMECORE_LOOPWAITSERVERPROPSTATECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x18A7F090)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoopWaitServerPropStateChange_TypeDefinitionIndex = 21107;
