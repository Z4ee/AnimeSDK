...
#define RPG_GAMECORE_PROPERTYFORMATIONVALUE_METHOD_2_C5134D4F75D7D61B_OFFSET UNITYSDK_OFFSET(0x1B9A7740)
#define RPG_GAMECORE_PROPERTYFORMATIONVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9A7880)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropertyFormationValue_TypeDefinitionIndex = 14918;
