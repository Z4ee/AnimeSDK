...
#define RPG_GAMECORE_RANDOMSELECTOR_METHOD_3_BBC4D439DCEEB561_OFFSET UNITYSDK_OFFSET(0x1B9B78A0)
#define RPG_GAMECORE_RANDOMSELECTOR_METHOD_3_FE5FE7575939BADE_OFFSET UNITYSDK_OFFSET(0x1B9B7860)
#define RPG_GAMECORE_RANDOMSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9B7890)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RandomSelector_TypeDefinitionIndex = 22923;
