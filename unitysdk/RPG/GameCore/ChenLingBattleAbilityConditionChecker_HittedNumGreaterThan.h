...
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_HITTEDNUMGREATERTHAN_METHOD_3_7EFFD6226D364F21_OFFSET UNITYSDK_OFFSET(0x1B7305A0)
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_HITTEDNUMGREATERTHAN_METHOD_3_899691572045C62D_OFFSET UNITYSDK_OFFSET(0x1B7304E0)
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_HITTEDNUMGREATERTHAN__CTOR_OFFSET UNITYSDK_OFFSET(0x1C374F70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleAbilityConditionChecker_HittedNumGreaterThan_TypeDefinitionIndex = 15111;
