...
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_HITTEDNUMGREATERTHAN_METHOD_3_7EFFD6226D364F21_OFFSET UNITYSDK_OFFSET(0x1961AC00)
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_HITTEDNUMGREATERTHAN_METHOD_3_899691572045C62D_OFFSET UNITYSDK_OFFSET(0x1961AB30)
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_HITTEDNUMGREATERTHAN__CTOR_OFFSET UNITYSDK_OFFSET(0x1961ABF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleAbilityConditionChecker_HittedNumGreaterThan_TypeDefinitionIndex = 14947;
