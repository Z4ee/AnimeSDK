...
#define RPG_GAMECORE_TRAINVISITORDIALOGUEEND_METHOD_3_C27005E61FB51500_OFFSET UNITYSDK_OFFSET(0x19DFC780)
#define RPG_GAMECORE_TRAINVISITORDIALOGUEEND_METHOD_3_EA3498B933C26EB4_OFFSET UNITYSDK_OFFSET(0x19DFC670)
#define RPG_GAMECORE_TRAINVISITORDIALOGUEEND__CTOR_OFFSET UNITYSDK_OFFSET(0x19DFC750)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainVisitorDialogueEnd_TypeDefinitionIndex = 20378;
