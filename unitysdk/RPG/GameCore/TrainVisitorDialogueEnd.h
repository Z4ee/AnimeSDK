...
#define RPG_GAMECORE_TRAINVISITORDIALOGUEEND_METHOD_3_69DB0EBC903AEBBD_OFFSET UNITYSDK_OFFSET(0x1B03AA50)
#define RPG_GAMECORE_TRAINVISITORDIALOGUEEND_METHOD_3_C27005E61FB51500_OFFSET UNITYSDK_OFFSET(0x1B03AB20)
#define RPG_GAMECORE_TRAINVISITORDIALOGUEEND__CTOR_OFFSET UNITYSDK_OFFSET(0x1B03AB10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainVisitorDialogueEnd_TypeDefinitionIndex = 20793;
