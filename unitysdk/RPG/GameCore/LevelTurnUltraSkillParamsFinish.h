...
#define RPG_GAMECORE_LEVELTURNULTRASKILLPARAMSFINISH_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xB6E1EB0)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPARAMSFINISH_GETINSERTULTRASKILLPARAMS_OFFSET UNITYSDK_OFFSET(0xB6E1F00)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPARAMSFINISH_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xB6E1E60)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPARAMSFINISH_INIT_OFFSET UNITYSDK_OFFSET(0xB6E1E10)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPARAMSFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0xB6E1F40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelTurnUltraSkillParamsFinish_TypeDefinitionIndex = 52268;
