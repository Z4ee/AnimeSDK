...
#define RPG_GAMECORE_SHOWHINTNOTIFYCONFIG_METHOD_2_81296F3272A5F40A_OFFSET UNITYSDK_OFFSET(0x176FF270)
#define RPG_GAMECORE_SHOWHINTNOTIFYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x176FF370)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowHintNotifyConfig_TypeDefinitionIndex = 15529;
