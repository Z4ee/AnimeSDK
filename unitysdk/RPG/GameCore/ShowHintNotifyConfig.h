...
#define RPG_GAMECORE_SHOWHINTNOTIFYCONFIG_METHOD_2_81296F3272A5F40A_OFFSET UNITYSDK_OFFSET(0x1D52C250)
#define RPG_GAMECORE_SHOWHINTNOTIFYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D52C350)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowHintNotifyConfig_TypeDefinitionIndex = 16767;
