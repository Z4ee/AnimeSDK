...
#define RPG_GAMECORE_CHENLINGSOLDIERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1962FE60)
#define RPG_GAMECORE_CHENLINGSOLDIERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x196303E0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Boolean IsOnlyForEnemy; // 0x78
		::System::UInt32 InitialMaxLevel; // 0x7C
