...
#define RPG_GAMECORE_CHENLINGSOLDIERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1E01ADE0)
#define RPG_GAMECORE_CHENLINGSOLDIERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1E01B360)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::System::String* SmallIconOutlinePath; // 0x10
		::System::String* SmallIconPath; // 0x18
		::System::String* ModelPath; // 0x20
		...
		::System::UInt32 InitialMaxLevel; // 0x40
		::RPG::GameCore::ChenLingBattleInitPosition Position; // 0x44
		::RPG::Client::TextID PromotionSkillDesc; // 0x48
		::RPG::Client::TextID SkillDesc; // 0x58
		::RPG::Client::TextID Name; // 0x68
		::System::UInt32 PromotionEffectID; // 0x78
		::System::Boolean IsOnlyForEnemy; // 0x7C
