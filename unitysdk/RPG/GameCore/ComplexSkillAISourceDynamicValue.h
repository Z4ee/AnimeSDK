...
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEDYNAMICVALUE_METHOD_3_682D26F747658A3A_OFFSET UNITYSDK_OFFSET(0x171264B0)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEDYNAMICVALUE_METHOD_3_E6F07B9686AFF661_OFFSET UNITYSDK_OFFSET(0x17128C90)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEDYNAMICVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x17126490)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAISourceDynamicValue_TypeDefinitionIndex = 14241;
