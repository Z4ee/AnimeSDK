...
#define RPG_GAMECORE_SAVEMODELWHENDEAD_METHOD_3_4E50E57C8C875E6A_OFFSET UNITYSDK_OFFSET(0x19C1C4F0)
#define RPG_GAMECORE_SAVEMODELWHENDEAD_METHOD_3_9DF5292D19AA2133_OFFSET UNITYSDK_OFFSET(0x19C1C470)
#define RPG_GAMECORE_SAVEMODELWHENDEAD__CTOR_OFFSET UNITYSDK_OFFSET(0x19C1C4C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SaveModelWhenDead_TypeDefinitionIndex = 21880;
