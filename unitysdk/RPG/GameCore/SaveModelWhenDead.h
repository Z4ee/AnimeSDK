...
#define RPG_GAMECORE_SAVEMODELWHENDEAD_METHOD_3_4E50E57C8C875E6A_OFFSET UNITYSDK_OFFSET(0x18DFD3D0)
#define RPG_GAMECORE_SAVEMODELWHENDEAD_METHOD_3_9DF5292D19AA2133_OFFSET UNITYSDK_OFFSET(0x18DFD350)
#define RPG_GAMECORE_SAVEMODELWHENDEAD__CTOR_OFFSET UNITYSDK_OFFSET(0x18DFD3A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SaveModelWhenDead_TypeDefinitionIndex = 22080;
