...
#define RPG_GAMECORE_SHOWSPACEZOOMAINPAGE_METHOD_3_96044B4DADE250A6_OFFSET UNITYSDK_OFFSET(0x18E67AD0)
#define RPG_GAMECORE_SHOWSPACEZOOMAINPAGE_METHOD_3_B8E6A9AB5619356F_OFFSET UNITYSDK_OFFSET(0x18E67A50)
#define RPG_GAMECORE_SHOWSPACEZOOMAINPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E67AA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowSpaceZooMainPage_TypeDefinitionIndex = 19894;
