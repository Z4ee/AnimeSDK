...
#define RPG_GAMECORE_ENABLEHUGEMONSTERHALFDITHER_METHOD_3_B737A8D406F1D6F4_OFFSET UNITYSDK_OFFSET(0x188A5E40)
#define RPG_GAMECORE_ENABLEHUGEMONSTERHALFDITHER_METHOD_3_F9EEE9669172F565_OFFSET UNITYSDK_OFFSET(0x188A5EC0)
#define RPG_GAMECORE_ENABLEHUGEMONSTERHALFDITHER__CTOR_OFFSET UNITYSDK_OFFSET(0x188A5E90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnableHugeMonsterHalfDither_TypeDefinitionIndex = 21570;
