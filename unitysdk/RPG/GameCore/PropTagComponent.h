...
#define RPG_GAMECORE_PROPTAGCOMPONENT_METHOD_2_40545298EF9C5F67_OFFSET UNITYSDK_OFFSET(0x17570930)
#define RPG_GAMECORE_PROPTAGCOMPONENT_METHOD_2_C6CC1D298EF0A2CA_OFFSET UNITYSDK_OFFSET(0x17570BC0)
#define RPG_GAMECORE_PROPTAGCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1756DD40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropTagComponent_TypeDefinitionIndex = 16129;
