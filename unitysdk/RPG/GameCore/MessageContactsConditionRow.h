...
#define RPG_GAMECORE_MESSAGECONTACTSCONDITIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x173D1780)
#define RPG_GAMECORE_MESSAGECONTACTSCONDITIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x173D18C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MessageContactsConditionRow_TypeDefinitionIndex = 13213;

	class MessageContactsConditionRow : public ::System::Object
	{
	public:
		::System::UInt32 ID; // 0x10
		::System::UInt32 FakeContactID; // 0x14
