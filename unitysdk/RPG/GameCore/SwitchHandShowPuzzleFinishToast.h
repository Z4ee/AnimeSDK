...
#define RPG_GAMECORE_SWITCHHANDSHOWPUZZLEFINISHTOAST_METHOD_3_2EB42EC9DA4505FB_OFFSET UNITYSDK_OFFSET(0x1B436DA0)
#define RPG_GAMECORE_SWITCHHANDSHOWPUZZLEFINISHTOAST_METHOD_3_DD3292AB9EE17558_OFFSET UNITYSDK_OFFSET(0x1B436DE0)
#define RPG_GAMECORE_SWITCHHANDSHOWPUZZLEFINISHTOAST__CTOR_OFFSET UNITYSDK_OFFSET(0x1B436DD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchHandShowPuzzleFinishToast_TypeDefinitionIndex = 20181;
