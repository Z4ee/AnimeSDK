...
#define RPG_GAMECORE_SWITCHHANDSHOWPUZZLEFINISHTOAST_METHOD_3_9737C0C66921E131_OFFSET UNITYSDK_OFFSET(0x18EBBB80)
#define RPG_GAMECORE_SWITCHHANDSHOWPUZZLEFINISHTOAST_METHOD_3_DD3292AB9EE17558_OFFSET UNITYSDK_OFFSET(0x18EBBC00)
#define RPG_GAMECORE_SWITCHHANDSHOWPUZZLEFINISHTOAST__CTOR_OFFSET UNITYSDK_OFFSET(0x18EBBBD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchHandShowPuzzleFinishToast_TypeDefinitionIndex = 19958;
