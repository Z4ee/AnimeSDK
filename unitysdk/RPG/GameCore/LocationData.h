...
#define RPG_GAMECORE_LOCATIONDATA_METHOD_2_D715B3CDEAA0073A_OFFSET UNITYSDK_OFFSET(0x1BCCDA30)
#define RPG_GAMECORE_LOCATIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCCDCA0)
