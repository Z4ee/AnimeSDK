...
#define RPG_GAMECORE_DYNAMICSTRING_METHOD_2_84F01E2593882111_OFFSET UNITYSDK_OFFSET(0x17183480)
#define RPG_GAMECORE_DYNAMICSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x171858B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DynamicString_TypeDefinitionIndex = 15087;
