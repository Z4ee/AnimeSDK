...
#define RPG_GAMECORE_DYNAMICSTRING_METHOD_2_84F01E2593882111_OFFSET UNITYSDK_OFFSET(0x1D04AC90)
#define RPG_GAMECORE_DYNAMICSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1D04D2A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DynamicString_TypeDefinitionIndex = 16306;
