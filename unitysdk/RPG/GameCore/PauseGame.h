...
#define RPG_GAMECORE_PAUSEGAME_METHOD_3_EBD2FF225EAB2B3B_OFFSET UNITYSDK_OFFSET(0x18BD8B70)
#define RPG_GAMECORE_PAUSEGAME_METHOD_3_F287DEE5C07943CA_OFFSET UNITYSDK_OFFSET(0x18BD8AF0)
#define RPG_GAMECORE_PAUSEGAME__CTOR_OFFSET UNITYSDK_OFFSET(0x18BD8B40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PauseGame_TypeDefinitionIndex = 23326;
