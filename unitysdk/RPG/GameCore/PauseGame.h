...
#define RPG_GAMECORE_PAUSEGAME_METHOD_3_B30BD80AF5E88242_OFFSET UNITYSDK_OFFSET(0x1D4186D0)
#define RPG_GAMECORE_PAUSEGAME_METHOD_3_EBD2FF225EAB2B3B_OFFSET UNITYSDK_OFFSET(0x1D418710)
#define RPG_GAMECORE_PAUSEGAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1D418700)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PauseGame_TypeDefinitionIndex = 24042;
