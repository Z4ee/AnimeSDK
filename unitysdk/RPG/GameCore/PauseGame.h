...
#define RPG_GAMECORE_PAUSEGAME_METHOD_3_EBD2FF225EAB2B3B_OFFSET UNITYSDK_OFFSET(0x199EA800)
#define RPG_GAMECORE_PAUSEGAME_METHOD_3_F287DEE5C07943CA_OFFSET UNITYSDK_OFFSET(0x199EA780)
#define RPG_GAMECORE_PAUSEGAME__CTOR_OFFSET UNITYSDK_OFFSET(0x199EA7D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PauseGame_TypeDefinitionIndex = 22993;
