...
#define RPG_GAMECORE_MAZECHESTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18ACDF00)
#define RPG_GAMECORE_MAZECHESTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18ACE0D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MazeChestRow_TypeDefinitionIndex = 13639;
