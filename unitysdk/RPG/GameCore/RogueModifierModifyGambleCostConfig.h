...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYGAMBLECOSTCONFIG_METHOD_3_650D314BAE0E81DD_OFFSET UNITYSDK_OFFSET(0x1D163C90)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYGAMBLECOSTCONFIG_METHOD_3_FE39354CB45D9219_OFFSET UNITYSDK_OFFSET(0x1D163C40)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYGAMBLECOSTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D163C80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyGambleCostConfig_TypeDefinitionIndex = 17028;
