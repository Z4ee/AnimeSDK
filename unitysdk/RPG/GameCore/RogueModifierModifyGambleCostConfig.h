...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYGAMBLECOSTCONFIG_METHOD_3_4AD7A8A680DC5164_OFFSET UNITYSDK_OFFSET(0x176343B0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYGAMBLECOSTCONFIG_METHOD_3_650D314BAE0E81DD_OFFSET UNITYSDK_OFFSET(0x17634480)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYGAMBLECOSTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17634430)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyGambleCostConfig_TypeDefinitionIndex = 16297;
