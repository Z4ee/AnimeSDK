...
#define RPG_GAMECORE_FATESHOPGOODSGROUPCONFIG_METHOD_2_003AB6C9919F2EA1_OFFSET UNITYSDK_OFFSET(0x1BA77490)
#define RPG_GAMECORE_FATESHOPGOODSGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA774D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateShopGoodsGroupConfig_TypeDefinitionIndex = 18506;
