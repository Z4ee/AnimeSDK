...
#define RPG_GAMECORE_FATESHOPGOODSGROUPCONFIG_METHOD_2_003AB6C9919F2EA1_OFFSET UNITYSDK_OFFSET(0x188DB3B0)
#define RPG_GAMECORE_FATESHOPGOODSGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x188DB3F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateShopGoodsGroupConfig_TypeDefinitionIndex = 18299;
