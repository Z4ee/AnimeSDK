...
#define RPG_GAMECORE_SETENTITYUNSELECTABLE_METHOD_3_0C8A65CC46CCB8D6_OFFSET UNITYSDK_OFFSET(0x176CC6D0)
#define RPG_GAMECORE_SETENTITYUNSELECTABLE_METHOD_3_44F9714F8AB7C50C_OFFSET UNITYSDK_OFFSET(0x176CC650)
#define RPG_GAMECORE_SETENTITYUNSELECTABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x176CC6A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetEntityUnselectable_TypeDefinitionIndex = 20906;
