...
#define RPG_GAMECORE_WAITENTITYSERVEREVENT_METHOD_3_6E4E4EA1CD2B3AAC_OFFSET UNITYSDK_OFFSET(0x1DEB74B0)
#define RPG_GAMECORE_WAITENTITYSERVEREVENT_METHOD_3_DF3CA708204D14B0_OFFSET UNITYSDK_OFFSET(0x1DEB7460)
#define RPG_GAMECORE_WAITENTITYSERVEREVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEB74A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitEntityServerEvent_TypeDefinitionIndex = 21883;
