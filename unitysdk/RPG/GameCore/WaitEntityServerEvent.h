...
#define RPG_GAMECORE_WAITENTITYSERVEREVENT_METHOD_3_6E4E4EA1CD2B3AAC_OFFSET UNITYSDK_OFFSET(0x178F86B0)
#define RPG_GAMECORE_WAITENTITYSERVEREVENT_METHOD_3_7ADC3817CF8CFAE3_OFFSET UNITYSDK_OFFSET(0x178F8640)
#define RPG_GAMECORE_WAITENTITYSERVEREVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x178F8680)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitEntityServerEvent_TypeDefinitionIndex = 20313;
