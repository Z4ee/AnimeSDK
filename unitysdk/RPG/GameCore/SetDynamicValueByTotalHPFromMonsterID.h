...
#define RPG_GAMECORE_SETDYNAMICVALUEBYTOTALHPFROMMONSTERID_METHOD_3_27E023B9D22CE487_OFFSET UNITYSDK_OFFSET(0x1C5F26A0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYTOTALHPFROMMONSTERID_METHOD_3_FBEE9758FE6F0C83_OFFSET UNITYSDK_OFFSET(0x1C5F2820)
#define RPG_GAMECORE_SETDYNAMICVALUEBYTOTALHPFROMMONSTERID__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5F2770)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByTotalHPFromMonsterID_TypeDefinitionIndex = 21950;
