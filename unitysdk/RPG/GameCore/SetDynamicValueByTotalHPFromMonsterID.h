...
#define RPG_GAMECORE_SETDYNAMICVALUEBYTOTALHPFROMMONSTERID_METHOD_3_27E023B9D22CE487_OFFSET UNITYSDK_OFFSET(0x1E824400)
#define RPG_GAMECORE_SETDYNAMICVALUEBYTOTALHPFROMMONSTERID_METHOD_3_FBEE9758FE6F0C83_OFFSET UNITYSDK_OFFSET(0x1E824580)
#define RPG_GAMECORE_SETDYNAMICVALUEBYTOTALHPFROMMONSTERID__CTOR_OFFSET UNITYSDK_OFFSET(0x1E8244D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByTotalHPFromMonsterID_TypeDefinitionIndex = 22514;
