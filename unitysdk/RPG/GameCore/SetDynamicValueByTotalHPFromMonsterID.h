...
#define RPG_GAMECORE_SETDYNAMICVALUEBYTOTALHPFROMMONSTERID_METHOD_3_27E023B9D22CE487_OFFSET UNITYSDK_OFFSET(0x18E296F0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYTOTALHPFROMMONSTERID_METHOD_3_FBEE9758FE6F0C83_OFFSET UNITYSDK_OFFSET(0x18E298A0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYTOTALHPFROMMONSTERID__CTOR_OFFSET UNITYSDK_OFFSET(0x18E297E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByTotalHPFromMonsterID_TypeDefinitionIndex = 21675;
