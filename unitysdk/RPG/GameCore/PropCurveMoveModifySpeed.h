...
#define RPG_GAMECORE_PROPCURVEMOVEMODIFYSPEED_METHOD_3_6B7B78099502B3FA_OFFSET UNITYSDK_OFFSET(0x1BA1C480)
#define RPG_GAMECORE_PROPCURVEMOVEMODIFYSPEED_METHOD_3_B97BBCA278C314DD_OFFSET UNITYSDK_OFFSET(0x1BA1C3E0)
#define RPG_GAMECORE_PROPCURVEMOVEMODIFYSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA1C440)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropCurveMoveModifySpeed_TypeDefinitionIndex = 20225;
