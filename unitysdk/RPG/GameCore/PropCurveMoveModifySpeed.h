...
#define RPG_GAMECORE_PROPCURVEMOVEMODIFYSPEED_METHOD_3_1B058AC875EAB4C6_OFFSET UNITYSDK_OFFSET(0x18C66EF0)
#define RPG_GAMECORE_PROPCURVEMOVEMODIFYSPEED_METHOD_3_6B7B78099502B3FA_OFFSET UNITYSDK_OFFSET(0x18C66FC0)
#define RPG_GAMECORE_PROPCURVEMOVEMODIFYSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x18C66F70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropCurveMoveModifySpeed_TypeDefinitionIndex = 19999;
