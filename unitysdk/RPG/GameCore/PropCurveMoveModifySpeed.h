...
#define RPG_GAMECORE_PROPCURVEMOVEMODIFYSPEED_METHOD_3_6B7B78099502B3FA_OFFSET UNITYSDK_OFFSET(0x1D3617C0)
#define RPG_GAMECORE_PROPCURVEMOVEMODIFYSPEED_METHOD_3_B97BBCA278C314DD_OFFSET UNITYSDK_OFFSET(0x1D361720)
#define RPG_GAMECORE_PROPCURVEMOVEMODIFYSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x1D361780)
