...
#define RPG_GAMECORE_PROPCURVEMOVEMODIFYSPEED_METHOD_3_1B058AC875EAB4C6_OFFSET UNITYSDK_OFFSET(0x19A88CD0)
#define RPG_GAMECORE_PROPCURVEMOVEMODIFYSPEED_METHOD_3_6B7B78099502B3FA_OFFSET UNITYSDK_OFFSET(0x19A88DA0)
#define RPG_GAMECORE_PROPCURVEMOVEMODIFYSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x19A88D50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropCurveMoveModifySpeed_TypeDefinitionIndex = 19861;
