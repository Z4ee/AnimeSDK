...
#define RPG_GAMECORE_DESTROYBATTLECHARACTER_METHOD_3_09E3EF4D1AE75B21_OFFSET UNITYSDK_OFFSET(0x17153D80)
#define RPG_GAMECORE_DESTROYBATTLECHARACTER_METHOD_3_F091D30AB0E7F804_OFFSET UNITYSDK_OFFSET(0x17153CB0)
#define RPG_GAMECORE_DESTROYBATTLECHARACTER__CTOR_OFFSET UNITYSDK_OFFSET(0x17153D30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DestroyBattleCharacter_TypeDefinitionIndex = 20948;
