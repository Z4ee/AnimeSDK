...
#define RPG_GAMECORE_PINGPONGENEMYSHOOTOVERRIDECMPTCONFIG_METHOD_3_2B9B7ECEF5FF37B8_OFFSET UNITYSDK_OFFSET(0x1D78DAF0)
#define RPG_GAMECORE_PINGPONGENEMYSHOOTOVERRIDECMPTCONFIG_METHOD_3_9F17382756DC78C8_OFFSET UNITYSDK_OFFSET(0x1D78DB50)
#define RPG_GAMECORE_PINGPONGENEMYSHOOTOVERRIDECMPTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D78DB40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PingPongEnemyShootOverrideCmptConfig_TypeDefinitionIndex = 18716;
