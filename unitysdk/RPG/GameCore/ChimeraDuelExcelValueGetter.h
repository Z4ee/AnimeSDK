...
#define RPG_GAMECORE_CHIMERADUELEXCELVALUEGETTER_METHOD_3_4325527A68A21CC0_OFFSET UNITYSDK_OFFSET(0x1709BDC0)
#define RPG_GAMECORE_CHIMERADUELEXCELVALUEGETTER_METHOD_3_702E46222B296855_OFFSET UNITYSDK_OFFSET(0x1709BE90)
#define RPG_GAMECORE_CHIMERADUELEXCELVALUEGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1709BE80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelExcelValueGetter_TypeDefinitionIndex = 14691;
