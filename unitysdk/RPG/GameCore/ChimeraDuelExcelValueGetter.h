...
#define RPG_GAMECORE_CHIMERADUELEXCELVALUEGETTER_METHOD_3_4325527A68A21CC0_OFFSET UNITYSDK_OFFSET(0x187FB170)
#define RPG_GAMECORE_CHIMERADUELEXCELVALUEGETTER_METHOD_3_702E46222B296855_OFFSET UNITYSDK_OFFSET(0x187FB240)
#define RPG_GAMECORE_CHIMERADUELEXCELVALUEGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x187FB230)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelExcelValueGetter_TypeDefinitionIndex = 15161;
