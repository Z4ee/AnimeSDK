...
#define RPG_GAMECORE_ROTATERUBIKCUBE_METHOD_3_86692DEE3E8759B0_OFFSET UNITYSDK_OFFSET(0x18D82560)
#define RPG_GAMECORE_ROTATERUBIKCUBE_METHOD_3_ADB4E86F69813BC2_OFFSET UNITYSDK_OFFSET(0x18D824E0)
#define RPG_GAMECORE_ROTATERUBIKCUBE__CTOR_OFFSET UNITYSDK_OFFSET(0x18D82530)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RotateRubikCube_TypeDefinitionIndex = 21010;
