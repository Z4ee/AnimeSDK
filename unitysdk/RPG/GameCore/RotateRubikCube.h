...
#define RPG_GAMECORE_ROTATERUBIKCUBE_METHOD_3_86692DEE3E8759B0_OFFSET UNITYSDK_OFFSET(0x17674D20)
#define RPG_GAMECORE_ROTATERUBIKCUBE_METHOD_3_ADB4E86F69813BC2_OFFSET UNITYSDK_OFFSET(0x17674CA0)
#define RPG_GAMECORE_ROTATERUBIKCUBE__CTOR_OFFSET UNITYSDK_OFFSET(0x17674CF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RotateRubikCube_TypeDefinitionIndex = 20328;
