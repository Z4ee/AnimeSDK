...
#define RPG_GAMECORE_CAKERACEPATHFINDFRONTNEARESTCATSELECTORCONFIG_METHOD_3_0A8FC143E3B22A0D_OFFSET UNITYSDK_OFFSET(0x1CF72A90)
#define RPG_GAMECORE_CAKERACEPATHFINDFRONTNEARESTCATSELECTORCONFIG_METHOD_3_771B794AF0106AA8_OFFSET UNITYSDK_OFFSET(0x1CF781E0)
#define RPG_GAMECORE_CAKERACEPATHFINDFRONTNEARESTCATSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF72A80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRacePathFindFrontNearestCatSelectorConfig_TypeDefinitionIndex = 18176;
