...
#define RPG_GAMECORE_CAKERACEPATHFINDFRONTNEARESTCATSELECTORCONFIG_METHOD_3_0A8FC143E3B22A0D_OFFSET UNITYSDK_OFFSET(0x1876E4C0)
#define RPG_GAMECORE_CAKERACEPATHFINDFRONTNEARESTCATSELECTORCONFIG_METHOD_3_771B794AF0106AA8_OFFSET UNITYSDK_OFFSET(0x18773A50)
#define RPG_GAMECORE_CAKERACEPATHFINDFRONTNEARESTCATSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1876E4B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRacePathFindFrontNearestCatSelectorConfig_TypeDefinitionIndex = 17483;
