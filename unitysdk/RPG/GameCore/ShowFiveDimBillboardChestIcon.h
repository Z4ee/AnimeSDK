...
#define RPG_GAMECORE_SHOWFIVEDIMBILLBOARDCHESTICON_METHOD_3_1E23DA6FC68E18D6_OFFSET UNITYSDK_OFFSET(0x1BE3F0B0)
#define RPG_GAMECORE_SHOWFIVEDIMBILLBOARDCHESTICON_METHOD_3_8C41B876BB9AF7C1_OFFSET UNITYSDK_OFFSET(0x1BE3F060)
#define RPG_GAMECORE_SHOWFIVEDIMBILLBOARDCHESTICON__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE3F0A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowFiveDimBillboardChestIcon_TypeDefinitionIndex = 20496;
