...
#define RPG_GAMECORE_SHOWFIVEDIMBILLBOARDCHESTICON_METHOD_3_1E23DA6FC68E18D6_OFFSET UNITYSDK_OFFSET(0x19C7A8B0)
#define RPG_GAMECORE_SHOWFIVEDIMBILLBOARDCHESTICON_METHOD_3_EE1AA321A04DE50C_OFFSET UNITYSDK_OFFSET(0x19C7A830)
#define RPG_GAMECORE_SHOWFIVEDIMBILLBOARDCHESTICON__CTOR_OFFSET UNITYSDK_OFFSET(0x19C7A880)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowFiveDimBillboardChestIcon_TypeDefinitionIndex = 20124;
