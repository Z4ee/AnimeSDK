...
#define RPG_GAMECORE_ADDACTIVITYMAZEBUFFBINDING_METHOD_3_3E92011DEB8E7153_OFFSET UNITYSDK_OFFSET(0x1AB13B60)
#define RPG_GAMECORE_ADDACTIVITYMAZEBUFFBINDING_METHOD_3_771C68875E7F8A16_OFFSET UNITYSDK_OFFSET(0x1AB13C30)
#define RPG_GAMECORE_ADDACTIVITYMAZEBUFFBINDING__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB13C20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddActivityMazeBuffBinding_TypeDefinitionIndex = 22578;
