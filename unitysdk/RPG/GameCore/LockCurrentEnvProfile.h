...
#define RPG_GAMECORE_LOCKCURRENTENVPROFILE_METHOD_3_25B94F7D989CF6CE_OFFSET UNITYSDK_OFFSET(0x1736A5C0)
#define RPG_GAMECORE_LOCKCURRENTENVPROFILE_METHOD_3_417C1C8A3D43DF1F_OFFSET UNITYSDK_OFFSET(0x1736A540)
#define RPG_GAMECORE_LOCKCURRENTENVPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x1736A590)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LockCurrentEnvProfile_TypeDefinitionIndex = 19076;
