...
#define RPG_GAMECORE_GRIDFIGHTWAITDRAGEQUIP_METHOD_3_1AEA5F294596E65B_OFFSET UNITYSDK_OFFSET(0x1D3C0F70)
#define RPG_GAMECORE_GRIDFIGHTWAITDRAGEQUIP_METHOD_3_20AE246A6B389530_OFFSET UNITYSDK_OFFSET(0x1D3C0F30)
#define RPG_GAMECORE_GRIDFIGHTWAITDRAGEQUIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3C0F60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightWaitDragEquip_TypeDefinitionIndex = 19731;
