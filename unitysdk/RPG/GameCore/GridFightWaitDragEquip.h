...
#define RPG_GAMECORE_GRIDFIGHTWAITDRAGEQUIP_METHOD_3_1AEA5F294596E65B_OFFSET UNITYSDK_OFFSET(0x198121E0)
#define RPG_GAMECORE_GRIDFIGHTWAITDRAGEQUIP_METHOD_3_4C206EDBAF81F7E2_OFFSET UNITYSDK_OFFSET(0x19812160)
#define RPG_GAMECORE_GRIDFIGHTWAITDRAGEQUIP__CTOR_OFFSET UNITYSDK_OFFSET(0x198121B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightWaitDragEquip_TypeDefinitionIndex = 18840;
