...
#define RPG_GAMECORE_FIVEDIMNAVMAPSURFACECONNECTCONFIG_METHOD_3_8F91AF656AD36A7A_OFFSET UNITYSDK_OFFSET(0x1D0F6BD0)
#define RPG_GAMECORE_FIVEDIMNAVMAPSURFACECONNECTCONFIG_METHOD_3_97DC2FE1FA7ADAA3_OFFSET UNITYSDK_OFFSET(0x1D0F6B90)
#define RPG_GAMECORE_FIVEDIMNAVMAPSURFACECONNECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0F6BC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimNavMapSurfaceConnectConfig_TypeDefinitionIndex = 18622;
