...
#define RPG_GAMECORE_FIVEDIMNAVMAPSURFACECONNECTCONFIG_METHOD_3_4F7D18970A1B338D_OFFSET UNITYSDK_OFFSET(0x18911060)
#define RPG_GAMECORE_FIVEDIMNAVMAPSURFACECONNECTCONFIG_METHOD_3_8F91AF656AD36A7A_OFFSET UNITYSDK_OFFSET(0x189110D0)
#define RPG_GAMECORE_FIVEDIMNAVMAPSURFACECONNECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189110B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimNavMapSurfaceConnectConfig_TypeDefinitionIndex = 17890;
