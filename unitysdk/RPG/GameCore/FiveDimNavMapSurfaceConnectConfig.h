...
#define RPG_GAMECORE_FIVEDIMNAVMAPSURFACECONNECTCONFIG_METHOD_3_8F91AF656AD36A7A_OFFSET UNITYSDK_OFFSET(0x1BEA6D70)
#define RPG_GAMECORE_FIVEDIMNAVMAPSURFACECONNECTCONFIG_METHOD_3_97DC2FE1FA7ADAA3_OFFSET UNITYSDK_OFFSET(0x1BEA6D30)
#define RPG_GAMECORE_FIVEDIMNAVMAPSURFACECONNECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEA6D60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimNavMapSurfaceConnectConfig_TypeDefinitionIndex = 18098;
	...
	public:
		...
		static ::System::Void Method_3_97DC2FE1FA7ADAA3(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::FiveDimNavMapSurfaceConnectConfig*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::FiveDimNavMapSurfaceConnectConfig*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_FIVEDIMNAVMAPSURFACECONNECTCONFIG_METHOD_3_97DC2FE1FA7ADAA3_OFFSET))(a1, a2);
		}
