...
#define RPG_GAMECORE_BYCOMPAREITEMPAIR_METHOD_2_9ABC19BD93FF9C73_OFFSET UNITYSDK_OFFSET(0x1C3272F0)
#define RPG_GAMECORE_BYCOMPAREITEMPAIR_METHOD_2_ED80A333B12D7CB3_OFFSET UNITYSDK_OFFSET(0x1C3271C0)
#define RPG_GAMECORE_BYCOMPAREITEMPAIR__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3272E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareItemPair_TypeDefinitionIndex = 20846;
