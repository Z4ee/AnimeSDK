...
#define RPG_GAMECORE_FLOATINGSPIRITBLOCK_METHOD_2_76F73BA0F24720AC_OFFSET UNITYSDK_OFFSET(0x17213D30)
#define RPG_GAMECORE_FLOATINGSPIRITBLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x17213E50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FloatingSpiritBlock_TypeDefinitionIndex = 17051;
