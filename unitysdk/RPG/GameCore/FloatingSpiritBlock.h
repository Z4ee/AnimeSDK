...
#define RPG_GAMECORE_FLOATINGSPIRITBLOCK_METHOD_2_896FD22F6545C277_OFFSET UNITYSDK_OFFSET(0x18925F70)
#define RPG_GAMECORE_FLOATINGSPIRITBLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x18926070)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FloatingSpiritBlock_TypeDefinitionIndex = 17646;
