...
#define RPG_GAMECORE_LOOPWAITROGUETOURNPERMANANTTALENTSTATECHANGE_METHOD_3_E49B3D2204D816B7_OFFSET UNITYSDK_OFFSET(0x1D215E00)
#define RPG_GAMECORE_LOOPWAITROGUETOURNPERMANANTTALENTSTATECHANGE_METHOD_3_FE5113700AA98D6A_OFFSET UNITYSDK_OFFSET(0x1D215DC0)
#define RPG_GAMECORE_LOOPWAITROGUETOURNPERMANANTTALENTSTATECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D215DF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoopWaitRogueTournPermanantTalentStateChange_TypeDefinitionIndex = 20989;
