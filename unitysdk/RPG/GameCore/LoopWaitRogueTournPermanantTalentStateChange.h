...
#define RPG_GAMECORE_LOOPWAITROGUETOURNPERMANANTTALENTSTATECHANGE_METHOD_3_BCD848A32CCEB580_OFFSET UNITYSDK_OFFSET(0x18A7EB30)
#define RPG_GAMECORE_LOOPWAITROGUETOURNPERMANANTTALENTSTATECHANGE_METHOD_3_E49B3D2204D816B7_OFFSET UNITYSDK_OFFSET(0x18A7EBA0)
#define RPG_GAMECORE_LOOPWAITROGUETOURNPERMANANTTALENTSTATECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x18A7EB70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoopWaitRogueTournPermanantTalentStateChange_TypeDefinitionIndex = 20209;
