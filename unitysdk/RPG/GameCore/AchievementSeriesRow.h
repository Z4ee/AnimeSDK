...
#define RPG_GAMECORE_ACHIEVEMENTSERIESROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x193C8B80)
#define RPG_GAMECORE_ACHIEVEMENTSERIESROW__CTOR_OFFSET UNITYSDK_OFFSET(0x193C93B0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* CopperIconPath; // 0x30
		::System::UInt32 Priority; // 0x38
		::RPG::GameCore::ShowType ShowType; // 0x3C
		::System::UInt32 ShowParamInt1; // 0x40
