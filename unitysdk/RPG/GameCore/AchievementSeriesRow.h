...
#define RPG_GAMECORE_ACHIEVEMENTSERIESROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16E97760)
#define RPG_GAMECORE_ACHIEVEMENTSERIESROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16E97F70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AchievementSeriesRow_TypeDefinitionIndex = 10220;
	...
	public:
		...
		::System::UInt32 SeriesID; // 0x38
		::RPG::GameCore::ShowType ShowType; // 0x3C
		::System::UInt32 Priority; // 0x40
		::System::UInt32 ShowParamInt1; // 0x44
		::RPG::Client::TextID SeriesTitle; // 0x48
