...
#define RPG_GAMECORE_SHOWBATTLEMESSAGE_METHOD_3_A4A6265D80E12AC4_OFFSET UNITYSDK_OFFSET(0x176F5830)
#define RPG_GAMECORE_SHOWBATTLEMESSAGE_METHOD_3_BED9F9313AEBDB57_OFFSET UNITYSDK_OFFSET(0x176F58D0)
#define RPG_GAMECORE_SHOWBATTLEMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x176F5890)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowBattleMessage_TypeDefinitionIndex = 20669;
