...
#define RPG_GAMECORE_PHOTOGRAPHAIMCONTAIERTARGET_METHOD_3_1231DACA80ADEE46_OFFSET UNITYSDK_OFFSET(0x1D431C20)
#define RPG_GAMECORE_PHOTOGRAPHAIMCONTAIERTARGET_METHOD_3_98DEB3F65623508B_OFFSET UNITYSDK_OFFSET(0x1D431CE0)
#define RPG_GAMECORE_PHOTOGRAPHAIMCONTAIERTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1D431CA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotoGraphAimContaierTarget_TypeDefinitionIndex = 17318;
