...
#define RPG_GAMECORE_PHOTOGRAPHAIMCONTAIERTARGET_METHOD_3_1231DACA80ADEE46_OFFSET UNITYSDK_OFFSET(0x19A03D10)
#define RPG_GAMECORE_PHOTOGRAPHAIMCONTAIERTARGET_METHOD_3_98DEB3F65623508B_OFFSET UNITYSDK_OFFSET(0x19A03DD0)
#define RPG_GAMECORE_PHOTOGRAPHAIMCONTAIERTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x19A03D90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotoGraphAimContaierTarget_TypeDefinitionIndex = 16654;
