...
#define RPG_GAMECORE_PHOTOGRAPHAIMCONTAIERTARGET_METHOD_3_1231DACA80ADEE46_OFFSET UNITYSDK_OFFSET(0x18BF1EB0)
#define RPG_GAMECORE_PHOTOGRAPHAIMCONTAIERTARGET_METHOD_3_98DEB3F65623508B_OFFSET UNITYSDK_OFFSET(0x18BF1F70)
#define RPG_GAMECORE_PHOTOGRAPHAIMCONTAIERTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x18BF1F30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotoGraphAimContaierTarget_TypeDefinitionIndex = 16624;
