...
#define RPG_GAMECORE_GAMEOBJECTPOOLCONFIGTEMPLATE_METHOD_2_573E27F21737D51D_OFFSET UNITYSDK_OFFSET(0x172415C0)
#define RPG_GAMECORE_GAMEOBJECTPOOLCONFIGTEMPLATE__CTOR_OFFSET UNITYSDK_OFFSET(0x172418A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GameObjectPoolConfigTemplate_TypeDefinitionIndex = 16760;
