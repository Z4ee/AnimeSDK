...
#define RPG_GAMECORE_CLOCKPARKSTORYCONFIG_METHOD_2_3A679A348B61B316_OFFSET UNITYSDK_OFFSET(0x19660970)
#define RPG_GAMECORE_CLOCKPARKSTORYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19660BB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClockParkStoryConfig_TypeDefinitionIndex = 15257;
