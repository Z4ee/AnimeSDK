...
#define RPG_GAMECORE_LITTLEGAMEABILITYTARGETSELECTORPLANECONFIG_METHOD_3_21619E68A89A6AE3_OFFSET UNITYSDK_OFFSET(0x19896610)
#define RPG_GAMECORE_LITTLEGAMEABILITYTARGETSELECTORPLANECONFIG_METHOD_3_E746DC4680E047CF_OFFSET UNITYSDK_OFFSET(0x19896500)
#define RPG_GAMECORE_LITTLEGAMEABILITYTARGETSELECTORPLANECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19896600)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityTargetSelectorPlaneConfig_TypeDefinitionIndex = 20202;
