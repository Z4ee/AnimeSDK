...
#define RPG_GAMECORE_MONOPOLYMAPGROUNDLAYER_METHOD_3_4B4CD97E29F6148E_OFFSET UNITYSDK_OFFSET(0x1B1B6CD0)
#define RPG_GAMECORE_MONOPOLYMAPGROUNDLAYER_METHOD_3_672839ACB18C3BB0_OFFSET UNITYSDK_OFFSET(0x1B1B66D0)
#define RPG_GAMECORE_MONOPOLYMAPGROUNDLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1B66C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonopolyMapGroundLayer_TypeDefinitionIndex = 15597;
