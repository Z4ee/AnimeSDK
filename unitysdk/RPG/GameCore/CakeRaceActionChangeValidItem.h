...
#define RPG_GAMECORE_CAKERACEACTIONCHANGEVALIDITEM_METHOD_3_8D0ED5FE68AAFE47_OFFSET UNITYSDK_OFFSET(0x187694E0)
#define RPG_GAMECORE_CAKERACEACTIONCHANGEVALIDITEM_METHOD_3_BC448428DA8D6E34_OFFSET UNITYSDK_OFFSET(0x1876BB30)
#define RPG_GAMECORE_CAKERACEACTIONCHANGEVALIDITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x187694C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionChangeValidItem_TypeDefinitionIndex = 17447;
