...
#define RPG_GAMECORE_CAKERACEACTIONCHANGEVALIDITEM_METHOD_3_1240D536C3B3AC74_OFFSET UNITYSDK_OFFSET(0x1B2CAC00)
#define RPG_GAMECORE_CAKERACEACTIONCHANGEVALIDITEM_METHOD_3_8D0ED5FE68AAFE47_OFFSET UNITYSDK_OFFSET(0x1B2CAC40)
#define RPG_GAMECORE_CAKERACEACTIONCHANGEVALIDITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2CAC30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionChangeValidItem_TypeDefinitionIndex = 17623;
