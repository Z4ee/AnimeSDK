...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERROLESTARUPBEFOREBATTLEBEGINCONFIG_METHOD_3_0D2B76F0B4340721_OFFSET UNITYSDK_OFFSET(0x197EEF70)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERROLESTARUPBEFOREBATTLEBEGINCONFIG_METHOD_3_F0E7E3483EE79E48_OFFSET UNITYSDK_OFFSET(0x197F36F0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERROLESTARUPBEFOREBATTLEBEGINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197EEF20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierRoleStarUpBeforeBattleBeginConfig_TypeDefinitionIndex = 18359;
