...
#define RPG_GAMECORE_BYISALLLIGHTTEAMDIED_METHOD_4_12851161AA5C6B7F_OFFSET UNITYSDK_OFFSET(0x1874DA40)
#define RPG_GAMECORE_BYISALLLIGHTTEAMDIED_METHOD_4_698BC807EEFA6A89_OFFSET UNITYSDK_OFFSET(0x1874DB10)
#define RPG_GAMECORE_BYISALLLIGHTTEAMDIED__CTOR_OFFSET UNITYSDK_OFFSET(0x1874DAC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsAllLightTeamDied_TypeDefinitionIndex = 21951;
