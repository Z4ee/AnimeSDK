...
#define RPG_GAMECORE_BYISALLLIGHTTEAMDIED_METHOD_4_257288C8C01C3283_OFFSET UNITYSDK_OFFSET(0x1A8D54E0)
#define RPG_GAMECORE_BYISALLLIGHTTEAMDIED_METHOD_4_37ADD0F81AC6D74C_OFFSET UNITYSDK_OFFSET(0x1A8D5510)
#define RPG_GAMECORE_BYISALLLIGHTTEAMDIED_METHOD_4_698BC807EEFA6A89_OFFSET UNITYSDK_OFFSET(0x1A8D5360)
#define RPG_GAMECORE_BYISALLLIGHTTEAMDIED_METHOD_4_ED0CA8D325D622CC_OFFSET UNITYSDK_OFFSET(0x1A8D5320)
#define RPG_GAMECORE_BYISALLLIGHTTEAMDIED__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8D5350)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsAllLightTeamDied_TypeDefinitionIndex = 22200;
