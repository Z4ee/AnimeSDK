...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERRETURNPREPARATIONCONFIG_METHOD_3_0D4CE59CCD283D70_OFFSET UNITYSDK_OFFSET(0x189BC370)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERRETURNPREPARATIONCONFIG_METHOD_3_DBC01657D4078619_OFFSET UNITYSDK_OFFSET(0x189BC2A0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERRETURNPREPARATIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189BC320)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierExecActionAfterReturnPreparationConfig_TypeDefinitionIndex = 18376;
