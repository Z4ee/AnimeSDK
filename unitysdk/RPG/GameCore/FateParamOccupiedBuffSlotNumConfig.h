...
#define RPG_GAMECORE_FATEPARAMOCCUPIEDBUFFSLOTNUMCONFIG_METHOD_6_E38F1C61E66B2614_OFFSET UNITYSDK_OFFSET(0x188D8960)
#define RPG_GAMECORE_FATEPARAMOCCUPIEDBUFFSLOTNUMCONFIG_METHOD_6_F1DBACCD8AB3C590_OFFSET UNITYSDK_OFFSET(0x188D8B20)
#define RPG_GAMECORE_FATEPARAMOCCUPIEDBUFFSLOTNUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x188D8A60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateParamOccupiedBuffSlotNumConfig_TypeDefinitionIndex = 15752;
