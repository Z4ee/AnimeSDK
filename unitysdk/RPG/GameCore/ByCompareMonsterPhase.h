...
#define RPG_GAMECORE_BYCOMPAREMONSTERPHASE_METHOD_4_1ACFDC2ECBA252AF_OFFSET UNITYSDK_OFFSET(0x19CF6AF0)
#define RPG_GAMECORE_BYCOMPAREMONSTERPHASE_METHOD_4_358A9082585CCE79_OFFSET UNITYSDK_OFFSET(0x19CF67C0)
#define RPG_GAMECORE_BYCOMPAREMONSTERPHASE_METHOD_4_731192DED050722A_OFFSET UNITYSDK_OFFSET(0x19CF6A90)
#define RPG_GAMECORE_BYCOMPAREMONSTERPHASE_METHOD_4_8302E96295AE8DDF_OFFSET UNITYSDK_OFFSET(0x19CF6860)
#define RPG_GAMECORE_BYCOMPAREMONSTERPHASE__CTOR_OFFSET UNITYSDK_OFFSET(0x19CF6820)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareMonsterPhase_TypeDefinitionIndex = 21753;
