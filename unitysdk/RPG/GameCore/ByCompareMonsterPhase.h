...
#define RPG_GAMECORE_BYCOMPAREMONSTERPHASE_METHOD_4_358A9082585CCE79_OFFSET UNITYSDK_OFFSET(0x18733DC0)
#define RPG_GAMECORE_BYCOMPAREMONSTERPHASE_METHOD_4_8302E96295AE8DDF_OFFSET UNITYSDK_OFFSET(0x18733EE0)
#define RPG_GAMECORE_BYCOMPAREMONSTERPHASE__CTOR_OFFSET UNITYSDK_OFFSET(0x18733E60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareMonsterPhase_TypeDefinitionIndex = 21452;
