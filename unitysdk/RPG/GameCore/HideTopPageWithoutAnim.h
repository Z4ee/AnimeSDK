...
#define RPG_GAMECORE_HIDETOPPAGEWITHOUTANIM_METHOD_3_07C8CE545474F345_OFFSET UNITYSDK_OFFSET(0x172AB0F0)
#define RPG_GAMECORE_HIDETOPPAGEWITHOUTANIM_METHOD_3_3272A20418164634_OFFSET UNITYSDK_OFFSET(0x172AB170)
#define RPG_GAMECORE_HIDETOPPAGEWITHOUTANIM__CTOR_OFFSET UNITYSDK_OFFSET(0x172AB140)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HideTopPageWithoutAnim_TypeDefinitionIndex = 19226;
