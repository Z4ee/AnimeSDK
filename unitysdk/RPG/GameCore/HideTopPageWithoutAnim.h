...
#define RPG_GAMECORE_HIDETOPPAGEWITHOUTANIM_METHOD_3_3272A20418164634_OFFSET UNITYSDK_OFFSET(0x1B684CD0)
#define RPG_GAMECORE_HIDETOPPAGEWITHOUTANIM_METHOD_3_607C904883B06F31_OFFSET UNITYSDK_OFFSET(0x1B684C90)
#define RPG_GAMECORE_HIDETOPPAGEWITHOUTANIM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B684CC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HideTopPageWithoutAnim_TypeDefinitionIndex = 20114;
