...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYSHOPREFRESHCOSTCONFIG_METHOD_3_5D71A0217AAD4C1C_OFFSET UNITYSDK_OFFSET(0x18D42CB0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYSHOPREFRESHCOSTCONFIG_METHOD_3_78FBFFD8B7D22925_OFFSET UNITYSDK_OFFSET(0x18D42BE0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYSHOPREFRESHCOSTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D42C60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyShopRefreshCostConfig_TypeDefinitionIndex = 16858;
