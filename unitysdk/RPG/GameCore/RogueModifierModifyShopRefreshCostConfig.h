...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYSHOPREFRESHCOSTCONFIG_METHOD_3_5AC9C16E54FF25A0_OFFSET UNITYSDK_OFFSET(0x1D1648A0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYSHOPREFRESHCOSTCONFIG_METHOD_3_5D71A0217AAD4C1C_OFFSET UNITYSDK_OFFSET(0x1D1648F0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYSHOPREFRESHCOSTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1648E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyShopRefreshCostConfig_TypeDefinitionIndex = 17035;
