...
#define RPG_GAMECORE_AVATARCUTINCHANGECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19491160)
#define RPG_GAMECORE_AVATARCUTINCHANGECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x194912F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AvatarCutinChangeConfigRow_TypeDefinitionIndex = 12117;
