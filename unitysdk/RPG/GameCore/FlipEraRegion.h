...
#define RPG_GAMECORE_FLIPERAREGION_METHOD_3_9892581B20FBC428_OFFSET UNITYSDK_OFFSET(0x17212DB0)
#define RPG_GAMECORE_FLIPERAREGION_METHOD_3_ED59EEBA3639F714_OFFSET UNITYSDK_OFFSET(0x17212EC0)
#define RPG_GAMECORE_FLIPERAREGION__CTOR_OFFSET UNITYSDK_OFFSET(0x17212E90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FlipEraRegion_TypeDefinitionIndex = 20525;
