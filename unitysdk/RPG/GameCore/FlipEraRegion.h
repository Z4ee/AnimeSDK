...
#define RPG_GAMECORE_FLIPERAREGION_METHOD_3_9243E2214165ED51_OFFSET UNITYSDK_OFFSET(0x1D10A400)
#define RPG_GAMECORE_FLIPERAREGION_METHOD_3_ED59EEBA3639F714_OFFSET UNITYSDK_OFFSET(0x1D10A4D0)
#define RPG_GAMECORE_FLIPERAREGION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D10A4C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FlipEraRegion_TypeDefinitionIndex = 22081;
