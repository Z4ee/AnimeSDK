...
#define RPG_GAMECORE_PSOBJECTMISSIONMAPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x199E0E10)
#define RPG_GAMECORE_PSOBJECTMISSIONMAPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x199E0F50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PSObjectMissionMapRow_TypeDefinitionIndex = 12447;
