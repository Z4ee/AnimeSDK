...
#define RPG_GAMECORE_LITTLEGAMELEVELSETTINGS_METHOD_2_21FF5356770E242C_OFFSET UNITYSDK_OFFSET(0x1989FD10)
#define RPG_GAMECORE_LITTLEGAMELEVELSETTINGS_METHOD_2_633221B80708D735_OFFSET UNITYSDK_OFFSET(0x1989F9B0)
#define RPG_GAMECORE_LITTLEGAMELEVELSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1989FD00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameLevelSettings_TypeDefinitionIndex = 17927;
