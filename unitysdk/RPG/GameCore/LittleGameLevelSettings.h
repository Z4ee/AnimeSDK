...
#define RPG_GAMECORE_LITTLEGAMELEVELSETTINGS_METHOD_2_21FF5356770E242C_OFFSET UNITYSDK_OFFSET(0x18A6C5B0)
#define RPG_GAMECORE_LITTLEGAMELEVELSETTINGS_METHOD_2_5B868B3B0D7E8D18_OFFSET UNITYSDK_OFFSET(0x18A6C2C0)
#define RPG_GAMECORE_LITTLEGAMELEVELSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x18A6C5A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameLevelSettings_TypeDefinitionIndex = 17899;
