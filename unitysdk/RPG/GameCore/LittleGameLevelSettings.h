...
#define RPG_GAMECORE_LITTLEGAMELEVELSETTINGS_METHOD_2_21FF5356770E242C_OFFSET UNITYSDK_OFFSET(0x1BCC2740)
#define RPG_GAMECORE_LITTLEGAMELEVELSETTINGS_METHOD_2_633221B80708D735_OFFSET UNITYSDK_OFFSET(0x1BCC2370)
#define RPG_GAMECORE_LITTLEGAMELEVELSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCC2730)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameLevelSettings_TypeDefinitionIndex = 18106;
