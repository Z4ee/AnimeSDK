...
#define RPG_GAMECORE_GAMELEVELHEARTDIALNPCCONFIG_METHOD_2_33BD625E2E822DB2_OFFSET UNITYSDK_OFFSET(0x1D952FD0)
#define RPG_GAMECORE_GAMELEVELHEARTDIALNPCCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D953110)
