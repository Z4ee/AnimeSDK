...
#define RPG_GAMECORE_GAMELEVELHEARTDIALNPCCONFIG_METHOD_2_33BD625E2E822DB2_OFFSET UNITYSDK_OFFSET(0x18953990)
#define RPG_GAMECORE_GAMELEVELHEARTDIALNPCCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18953AD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GameLevelHeartDialNPCConfig_TypeDefinitionIndex = 16529;
