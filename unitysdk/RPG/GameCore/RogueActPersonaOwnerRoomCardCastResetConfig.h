...
#define RPG_GAMECORE_ROGUEACTPERSONAOWNERROOMCARDCASTRESETCONFIG_METHOD_7_1A47D04FD1A24C37_OFFSET UNITYSDK_OFFSET(0x1EE86E30)
#define RPG_GAMECORE_ROGUEACTPERSONAOWNERROOMCARDCASTRESETCONFIG_METHOD_7_600C4C5465A547F3_OFFSET UNITYSDK_OFFSET(0x1EE86F90)
#define RPG_GAMECORE_ROGUEACTPERSONAOWNERROOMCARDCASTRESETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EE86E20)
