...
#define RPG_GAMECORE_ROGUEMODIFIERREPLACEROGUEWORKBENCHGROUPCONFIG_METHOD_3_2F14CC630F272310_OFFSET UNITYSDK_OFFSET(0x1762C770)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACEROGUEWORKBENCHGROUPCONFIG_METHOD_3_60395EFEF0F87BB9_OFFSET UNITYSDK_OFFSET(0x17639090)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACEROGUEWORKBENCHGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1762C720)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierReplaceRogueWorkbenchGroupConfig_TypeDefinitionIndex = 16419;
