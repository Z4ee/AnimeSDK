...
#define RPG_GAMECORE_OVERRIDEMONOEFFECTCONFIG_METHOD_2_CD86C284D8078C20_OFFSET UNITYSDK_OFFSET(0x18BCCE40)
#define RPG_GAMECORE_OVERRIDEMONOEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18BCCFC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OverrideMonoEffectConfig_TypeDefinitionIndex = 19209;
