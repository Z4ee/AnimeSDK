...
#define RPG_GAMECORE_OVERRIDEMONOEFFECTCONFIG_METHOD_2_55A30537E64F0E87_OFFSET UNITYSDK_OFFSET(0x1BB08290)
#define RPG_GAMECORE_OVERRIDEMONOEFFECTCONFIG_METHOD_2_CD86C284D8078C20_OFFSET UNITYSDK_OFFSET(0x1BB080F0)
#define RPG_GAMECORE_OVERRIDEMONOEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB08270)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OverrideMonoEffectConfig_TypeDefinitionIndex = 19487;
