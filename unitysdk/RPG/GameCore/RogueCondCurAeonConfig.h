...
#define RPG_GAMECORE_ROGUECONDCURAEONCONFIG_METHOD_6_BB5C8A6D20865F69_OFFSET UNITYSDK_OFFSET(0x1C4AEA60)
#define RPG_GAMECORE_ROGUECONDCURAEONCONFIG_METHOD_6_C4CC0BC797CFD6ED_OFFSET UNITYSDK_OFFSET(0x1C4AEAB0)
#define RPG_GAMECORE_ROGUECONDCURAEONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4AEAA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueCondCurAeonConfig_TypeDefinitionIndex = 19028;
