...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TRIGGERSKILLHINT_METHOD_3_07B8E77E360BD566_OFFSET UNITYSDK_OFFSET(0x196BA560)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TRIGGERSKILLHINT_METHOD_3_86ED0FF82D4A8C31_OFFSET UNITYSDK_OFFSET(0x196B65D0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TRIGGERSKILLHINT__CTOR_OFFSET UNITYSDK_OFFSET(0x196B6580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_TriggerSkillHint_TypeDefinitionIndex = 15265;
