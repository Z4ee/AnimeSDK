...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TRIGGERSKILLHINT_METHOD_3_86ED0FF82D4A8C31_OFFSET UNITYSDK_OFFSET(0x1DB07ED0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TRIGGERSKILLHINT_METHOD_3_904EF8B1B97D33DC_OFFSET UNITYSDK_OFFSET(0x1DB07E30)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TRIGGERSKILLHINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB07EC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_TriggerSkillHint_TypeDefinitionIndex = 15866;
