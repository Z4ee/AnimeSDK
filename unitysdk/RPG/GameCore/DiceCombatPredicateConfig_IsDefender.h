...
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_ISDEFENDER_METHOD_4_216922426D199FF4_OFFSET UNITYSDK_OFFSET(0x17165E00)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_ISDEFENDER_METHOD_4_9D139EC5C98FBDD2_OFFSET UNITYSDK_OFFSET(0x17167410)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_ISDEFENDER__CTOR_OFFSET UNITYSDK_OFFSET(0x17165DB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatPredicateConfig_IsDefender_TypeDefinitionIndex = 14791;
