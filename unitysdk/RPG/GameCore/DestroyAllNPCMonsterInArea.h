...
#define RPG_GAMECORE_DESTROYALLNPCMONSTERINAREA_METHOD_3_5F2353BA163B9002_OFFSET UNITYSDK_OFFSET(0x17153BA0)
#define RPG_GAMECORE_DESTROYALLNPCMONSTERINAREA_METHOD_3_FB2D6BADFD44812B_OFFSET UNITYSDK_OFFSET(0x17153B20)
#define RPG_GAMECORE_DESTROYALLNPCMONSTERINAREA__CTOR_OFFSET UNITYSDK_OFFSET(0x17153B70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DestroyAllNPCMonsterInArea_TypeDefinitionIndex = 18606;
