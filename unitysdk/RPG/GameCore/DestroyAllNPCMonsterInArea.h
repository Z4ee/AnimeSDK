...
#define RPG_GAMECORE_DESTROYALLNPCMONSTERINAREA_METHOD_3_19FF8E10A67F34F9_OFFSET UNITYSDK_OFFSET(0x1C103480)
#define RPG_GAMECORE_DESTROYALLNPCMONSTERINAREA_METHOD_3_5F2353BA163B9002_OFFSET UNITYSDK_OFFSET(0x1C1034C0)
#define RPG_GAMECORE_DESTROYALLNPCMONSTERINAREA__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1034B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DestroyAllNPCMonsterInArea_TypeDefinitionIndex = 19536;
