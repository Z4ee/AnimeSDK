...
#define RPG_GAMECORE_DESTROYALLNPCMONSTERINAREA_METHOD_3_5F2353BA163B9002_OFFSET UNITYSDK_OFFSET(0x1969A180)
#define RPG_GAMECORE_DESTROYALLNPCMONSTERINAREA_METHOD_3_FB2D6BADFD44812B_OFFSET UNITYSDK_OFFSET(0x1969A100)
#define RPG_GAMECORE_DESTROYALLNPCMONSTERINAREA__CTOR_OFFSET UNITYSDK_OFFSET(0x1969A150)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DestroyAllNPCMonsterInArea_TypeDefinitionIndex = 19180;
