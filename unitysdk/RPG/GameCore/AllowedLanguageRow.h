...
#define RPG_GAMECORE_ALLOWEDLANGUAGEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CE19570)
#define RPG_GAMECORE_ALLOWEDLANGUAGEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE19C10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AllowedLanguageRow_TypeDefinitionIndex = 12560;
