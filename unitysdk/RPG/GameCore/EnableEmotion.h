...
#define RPG_GAMECORE_ENABLEEMOTION_METHOD_3_448BF841545CC7FB_OFFSET UNITYSDK_OFFSET(0x188A52E0)
#define RPG_GAMECORE_ENABLEEMOTION_METHOD_3_BDCA8F784546FD1C_OFFSET UNITYSDK_OFFSET(0x188A5370)
#define RPG_GAMECORE_ENABLEEMOTION__CTOR_OFFSET UNITYSDK_OFFSET(0x188A5340)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnableEmotion_TypeDefinitionIndex = 21288;
