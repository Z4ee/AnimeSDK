...
#define RPG_GAMECORE_ENABLEEMOTION_METHOD_3_0A22B158EC94CDD1_OFFSET UNITYSDK_OFFSET(0x1D0622F0)
#define RPG_GAMECORE_ENABLEEMOTION_METHOD_3_BDCA8F784546FD1C_OFFSET UNITYSDK_OFFSET(0x1D062340)
#define RPG_GAMECORE_ENABLEEMOTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D062330)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnableEmotion_TypeDefinitionIndex = 22161;
