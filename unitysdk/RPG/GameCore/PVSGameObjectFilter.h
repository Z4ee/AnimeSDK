...
#define RPG_GAMECORE_PVSGAMEOBJECTFILTER_METHOD_2_685CF69E9A722CC4_OFFSET UNITYSDK_OFFSET(0x1D307130)
#define RPG_GAMECORE_PVSGAMEOBJECTFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3072F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PVSGameObjectFilter_TypeDefinitionIndex = 18949;
