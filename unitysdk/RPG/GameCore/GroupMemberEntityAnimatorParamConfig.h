...
#define RPG_GAMECORE_GROUPMEMBERENTITYANIMATORPARAMCONFIG_METHOD_2_10FA7D19B6D28272_OFFSET UNITYSDK_OFFSET(0x1D080E20)
#define RPG_GAMECORE_GROUPMEMBERENTITYANIMATORPARAMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D081030)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GroupMemberEntityAnimatorParamConfig_TypeDefinitionIndex = 19952;
