...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONMERGEROLECONFIG_METHOD_3_01032E76032D1A7D_OFFSET UNITYSDK_OFFSET(0x1C5D1580)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONMERGEROLECONFIG_METHOD_3_E5EC370134EB9F39_OFFSET UNITYSDK_OFFSET(0x1C5D1530)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONMERGEROLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5D1570)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierExecActionMergeRoleConfig_TypeDefinitionIndex = 18614;
