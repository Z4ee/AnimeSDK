...
#define RPG_GAMECORE_WAITFRAME_METHOD_3_5FD3031503DE9CCD_OFFSET UNITYSDK_OFFSET(0x178FA9D0)
#define RPG_GAMECORE_WAITFRAME_METHOD_3_622B9B2708997D6B_OFFSET UNITYSDK_OFFSET(0x178FAA60)
#define RPG_GAMECORE_WAITFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x178FAA30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitFrame_TypeDefinitionIndex = 22060;
