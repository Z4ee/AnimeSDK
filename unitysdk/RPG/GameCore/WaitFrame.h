...
#define RPG_GAMECORE_WAITFRAME_METHOD_3_622B9B2708997D6B_OFFSET UNITYSDK_OFFSET(0x1B8A5AE0)
#define RPG_GAMECORE_WAITFRAME_METHOD_3_7E9364849DBF2748_OFFSET UNITYSDK_OFFSET(0x1B8A5A90)
#define RPG_GAMECORE_WAITFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8A5AD0)
