...
#define RPG_GAMECORE_CHENLINGGAMEBOYCHALLENGEPACKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C387750)
#define RPG_GAMECORE_CHENLINGGAMEBOYCHALLENGEPACKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C387900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingGameBoyChallengePackRow_TypeDefinitionIndex = 13579;
