...
#define RPG_GAMECORE_CHENLINGGAMEBOYCHALLENGEPACKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CFB6070)
#define RPG_GAMECORE_CHENLINGGAMEBOYCHALLENGEPACKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFB6220)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingGameBoyChallengePackRow_TypeDefinitionIndex = 13996;
