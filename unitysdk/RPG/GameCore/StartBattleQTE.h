...
#define RPG_GAMECORE_STARTBATTLEQTE_METHOD_3_36F0EBD9EEA947F5_OFFSET UNITYSDK_OFFSET(0x17773D40)
#define RPG_GAMECORE_STARTBATTLEQTE_METHOD_3_4967394980B0C4C4_OFFSET UNITYSDK_OFFSET(0x17773DC0)
#define RPG_GAMECORE_STARTBATTLEQTE__CTOR_OFFSET UNITYSDK_OFFSET(0x17773D90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StartBattleQTE_TypeDefinitionIndex = 21574;
