...
#define RPG_GAMECORE_CHIMERABATTLECONDITIONEVALUATOR_METHOD_2_F785F9F259F5F99E_OFFSET UNITYSDK_OFFSET(0x19631E30)
#define RPG_GAMECORE_CHIMERABATTLECONDITIONEVALUATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x19635640)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraBattleConditionEvaluator_TypeDefinitionIndex = 15062;
