...
#define RPG_GAMECORE_CHIMERABATTLECONDITIONEVALUATOR_METHOD_2_F785F9F259F5F99E_OFFSET UNITYSDK_OFFSET(0x1C38C090)
#define RPG_GAMECORE_CHIMERABATTLECONDITIONEVALUATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1C38F8A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraBattleConditionEvaluator_TypeDefinitionIndex = 15226;
