...
#define RPG_GAMECORE_MAPROTATIONGROUPCONFIG_METHOD_2_4561D7CD54A976A0_OFFSET UNITYSDK_OFFSET(0x18A8EB50)
#define RPG_GAMECORE_MAPROTATIONGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18A8ED10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MapRotationGroupConfig_TypeDefinitionIndex = 16128;
