...
#define RPG_GAMECORE_MAPROTATIONGROUPCONFIG_METHOD_2_4561D7CD54A976A0_OFFSET UNITYSDK_OFFSET(0x17380A20)
#define RPG_GAMECORE_MAPROTATIONGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17380BE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MapRotationGroupConfig_TypeDefinitionIndex = 15608;
