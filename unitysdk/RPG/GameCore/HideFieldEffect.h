...
#define RPG_GAMECORE_HIDEFIELDEFFECT_METHOD_3_73287E50E02900D9_OFFSET UNITYSDK_OFFSET(0x189FE870)
#define RPG_GAMECORE_HIDEFIELDEFFECT_METHOD_3_F41DFC966CDF4850_OFFSET UNITYSDK_OFFSET(0x189FE910)
#define RPG_GAMECORE_HIDEFIELDEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x189FE8D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HideFieldEffect_TypeDefinitionIndex = 21607;
