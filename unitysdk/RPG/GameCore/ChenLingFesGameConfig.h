...
#define RPG_GAMECORE_CHENLINGFESGAMECONFIG_METHOD_3_71567336DD5FB76E_OFFSET UNITYSDK_OFFSET(0x1E014B30)
#define RPG_GAMECORE_CHENLINGFESGAMECONFIG_METHOD_3_CEBD39260D75E547_OFFSET UNITYSDK_OFFSET(0x1E014B70)
#define RPG_GAMECORE_CHENLINGFESGAMECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1E014B60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingFesGameConfig_TypeDefinitionIndex = 18212;
