...
#define RPG_GAMECORE_EVOLVETALKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xCDF0F50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EvolveTalkConfig_TypeDefinitionIndex = 54800;
