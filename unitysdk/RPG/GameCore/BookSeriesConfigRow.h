...
#define RPG_GAMECORE_BOOKSERIESCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A401C30)
#define RPG_GAMECORE_BOOKSERIESCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A402380)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::RPG::Client::TextID BookSeries; // 0x10
		::RPG::Client::TextID BookSeriesComments; // 0x20
		::System::Boolean IsShowInBookshelf; // 0x30
		::System::UInt32 BookSeriesWorld; // 0x34
