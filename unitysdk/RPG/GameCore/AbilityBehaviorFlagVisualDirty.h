...
#define RPG_GAMECORE_ABILITYBEHAVIORFLAGVISUALDIRTY_CLEAR_OFFSET UNITYSDK_OFFSET(0xCC70B90)
#define RPG_GAMECORE_ABILITYBEHAVIORFLAGVISUALDIRTY_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xCC70C30)
#define RPG_GAMECORE_ABILITYBEHAVIORFLAGVISUALDIRTY_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xCC70BE0)
#define RPG_GAMECORE_ABILITYBEHAVIORFLAGVISUALDIRTY_INIT_OFFSET UNITYSDK_OFFSET(0xCC70B40)
#define RPG_GAMECORE_ABILITYBEHAVIORFLAGVISUALDIRTY__CTOR_OFFSET UNITYSDK_OFFSET(0xCC70C80)
#define RPG_GAMECORE_ABILITYBEHAVIORFLAGVISUALDIRTY___IFIXBASEPROXY_CLEAR_OFFSET UNITYSDK_OFFSET(0xCC70C90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AbilityBehaviorFlagVisualDirty_TypeDefinitionIndex = 52838;
