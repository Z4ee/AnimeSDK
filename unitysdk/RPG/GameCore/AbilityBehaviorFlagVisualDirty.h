...
#define RPG_GAMECORE_ABILITYBEHAVIORFLAGVISUALDIRTY_CLEAR_OFFSET UNITYSDK_OFFSET(0x1120FC90)
#define RPG_GAMECORE_ABILITYBEHAVIORFLAGVISUALDIRTY_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1120FD30)
#define RPG_GAMECORE_ABILITYBEHAVIORFLAGVISUALDIRTY_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x1120FCE0)
#define RPG_GAMECORE_ABILITYBEHAVIORFLAGVISUALDIRTY_INIT_OFFSET UNITYSDK_OFFSET(0x1684A610)
#define RPG_GAMECORE_ABILITYBEHAVIORFLAGVISUALDIRTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1120FD80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AbilityBehaviorFlagVisualDirty_TypeDefinitionIndex = 56771;
