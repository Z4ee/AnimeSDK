...
#define RPG_GAMECORE_DRINKMAKERFORMULAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x196C3700)
#define RPG_GAMECORE_DRINKMAKERFORMULAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x196C3C30)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Boolean IsChallengeMode; // 0x58
		::System::Boolean IsMission; // 0x59
		::RPG::GameCore::DrinkMakerFormulaUnlockType UnlockType; // 0x5C
		::System::UInt32 UnlockParam; // 0x60
		::System::UInt32 IceID; // 0x64
