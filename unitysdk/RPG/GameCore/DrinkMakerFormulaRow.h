...
#define RPG_GAMECORE_DRINKMAKERFORMULAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D041800)
#define RPG_GAMECORE_DRINKMAKERFORMULAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D041D30)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 IceID; // 0x2C
		::System::UInt32 MixRate; // 0x30
		::RPG::GameCore::DrinkMakerFormulaUnlockType UnlockType; // 0x34
