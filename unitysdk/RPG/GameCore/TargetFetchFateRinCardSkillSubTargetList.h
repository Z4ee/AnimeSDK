...
#define RPG_GAMECORE_TARGETFETCHFATERINCARDSKILLSUBTARGETLIST_METHOD_4_65C8D6EB7A23751C_OFFSET UNITYSDK_OFFSET(0x1D0B9EB0)
#define RPG_GAMECORE_TARGETFETCHFATERINCARDSKILLSUBTARGETLIST_METHOD_4_8C4C47A7E7802E69_OFFSET UNITYSDK_OFFSET(0x1D0B9ED0)
#define RPG_GAMECORE_TARGETFETCHFATERINCARDSKILLSUBTARGETLIST_METHOD_4_C670167750EC98EC_OFFSET UNITYSDK_OFFSET(0x1D0B9DD0)
#define RPG_GAMECORE_TARGETFETCHFATERINCARDSKILLSUBTARGETLIST_METHOD_4_CBBF4B6BA7995701_OFFSET UNITYSDK_OFFSET(0x1D0B9E50)
#define RPG_GAMECORE_TARGETFETCHFATERINCARDSKILLSUBTARGETLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0B9E40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchFateRinCardSkillSubTargetList_TypeDefinitionIndex = 23160;
