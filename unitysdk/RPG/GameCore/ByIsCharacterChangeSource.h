...
#define RPG_GAMECORE_BYISCHARACTERCHANGESOURCE_METHOD_4_96A21EF68DE02CD9_OFFSET UNITYSDK_OFFSET(0x1702A670)
#define RPG_GAMECORE_BYISCHARACTERCHANGESOURCE_METHOD_4_D8F011662CED1885_OFFSET UNITYSDK_OFFSET(0x1702A750)
#define RPG_GAMECORE_BYISCHARACTERCHANGESOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1702A6F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsCharacterChangeSource_TypeDefinitionIndex = 21852;
