...
#define RPG_GAMECORE_SETUPTRAINVISITORBUBBLE_METHOD_3_0930CBE4834E1E6C_OFFSET UNITYSDK_OFFSET(0x19C66470)
#define RPG_GAMECORE_SETUPTRAINVISITORBUBBLE_METHOD_3_9ABD81BAEC3245F8_OFFSET UNITYSDK_OFFSET(0x19C66580)
#define RPG_GAMECORE_SETUPTRAINVISITORBUBBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C66550)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetUpTrainVisitorBubble_TypeDefinitionIndex = 20379;
