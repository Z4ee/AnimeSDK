...
#define RPG_GAMECORE_CHIMERABATTLESHOWBUBBLETALK_METHOD_3_6504539A644013FD_OFFSET UNITYSDK_OFFSET(0x170946B0)
#define RPG_GAMECORE_CHIMERABATTLESHOWBUBBLETALK_METHOD_3_D454468BA59521EF_OFFSET UNITYSDK_OFFSET(0x170931A0)
#define RPG_GAMECORE_CHIMERABATTLESHOWBUBBLETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x17093190)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraBattleShowBubbleTalk_TypeDefinitionIndex = 14574;
