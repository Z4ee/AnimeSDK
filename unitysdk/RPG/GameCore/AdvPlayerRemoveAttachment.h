...
#define RPG_GAMECORE_ADVPLAYERREMOVEATTACHMENT_METHOD_3_0C29FF75D3E0CFB2_OFFSET UNITYSDK_OFFSET(0x16F3BE80)
#define RPG_GAMECORE_ADVPLAYERREMOVEATTACHMENT_METHOD_3_AF6814BA5128241B_OFFSET UNITYSDK_OFFSET(0x16F3BF00)
#define RPG_GAMECORE_ADVPLAYERREMOVEATTACHMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x16F3BED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvPlayerRemoveAttachment_TypeDefinitionIndex = 19379;
