...
#define RPG_GAMECORE_ADVPLAYERREMOVEATTACHMENT_METHOD_3_20A46914C7F4BE48_OFFSET UNITYSDK_OFFSET(0x1BE28970)
#define RPG_GAMECORE_ADVPLAYERREMOVEATTACHMENT_METHOD_3_AF6814BA5128241B_OFFSET UNITYSDK_OFFSET(0x1BE289B0)
#define RPG_GAMECORE_ADVPLAYERREMOVEATTACHMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE289A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvPlayerRemoveAttachment_TypeDefinitionIndex = 20262;
