...
#define RPG_GAMECORE_PROPPUZZLECUSTOMEVENTSENDER_METHOD_3_613A3DC13917524F_OFFSET UNITYSDK_OFFSET(0x17522460)
#define RPG_GAMECORE_PROPPUZZLECUSTOMEVENTSENDER_METHOD_3_C706522968AD039C_OFFSET UNITYSDK_OFFSET(0x175224E0)
#define RPG_GAMECORE_PROPPUZZLECUSTOMEVENTSENDER__CTOR_OFFSET UNITYSDK_OFFSET(0x175224B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropPuzzleCustomEventSender_TypeDefinitionIndex = 20160;
