...
#define RPG_GAMECORE_PROPPUZZLECUSTOMEVENTSENDER_METHOD_3_61AEB9DFCACA200F_OFFSET UNITYSDK_OFFSET(0x1BA26EE0)
#define RPG_GAMECORE_PROPPUZZLECUSTOMEVENTSENDER_METHOD_3_C706522968AD039C_OFFSET UNITYSDK_OFFSET(0x1BA26F20)
#define RPG_GAMECORE_PROPPUZZLECUSTOMEVENTSENDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA26F10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropPuzzleCustomEventSender_TypeDefinitionIndex = 21178;
