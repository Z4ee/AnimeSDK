...
#define RPG_GAMECORE_ELFCUSTOMERCONFIG_METHOD_2_03E1DAFBE690FD08_OFFSET UNITYSDK_OFFSET(0x1D057EB0)
#define RPG_GAMECORE_ELFCUSTOMERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D058210)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfCustomerConfig_TypeDefinitionIndex = 18254;
