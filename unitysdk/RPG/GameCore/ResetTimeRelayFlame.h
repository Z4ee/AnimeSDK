...
#define RPG_GAMECORE_RESETTIMERELAYFLAME_METHOD_3_2E3D9A0982A466D8_OFFSET UNITYSDK_OFFSET(0x1DB942B0)
#define RPG_GAMECORE_RESETTIMERELAYFLAME_METHOD_3_428D35C0AB0A6315_OFFSET UNITYSDK_OFFSET(0x1DB94380)
#define RPG_GAMECORE_RESETTIMERELAYFLAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB94370)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetTimeRelayFlame_TypeDefinitionIndex = 21789;
