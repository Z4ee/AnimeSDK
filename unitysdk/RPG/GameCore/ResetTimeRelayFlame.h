...
#define RPG_GAMECORE_RESETTIMERELAYFLAME_METHOD_3_428D35C0AB0A6315_OFFSET UNITYSDK_OFFSET(0x1759FC50)
#define RPG_GAMECORE_RESETTIMERELAYFLAME_METHOD_3_5804AA83DD7C0801_OFFSET UNITYSDK_OFFSET(0x1759FB40)
#define RPG_GAMECORE_RESETTIMERELAYFLAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1759FC20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetTimeRelayFlame_TypeDefinitionIndex = 20214;
