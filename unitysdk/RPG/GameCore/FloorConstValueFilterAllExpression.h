...
#define RPG_GAMECORE_FLOORCONSTVALUEFILTERALLEXPRESSION_METHOD_3_C1710868AB6F29EE_OFFSET UNITYSDK_OFFSET(0x19760560)
#define RPG_GAMECORE_FLOORCONSTVALUEFILTERALLEXPRESSION_METHOD_3_C5BD305458CC49AA_OFFSET UNITYSDK_OFFSET(0x197605B0)
#define RPG_GAMECORE_FLOORCONSTVALUEFILTERALLEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x197605A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FloorConstValueFilterAllExpression_TypeDefinitionIndex = 16547;
