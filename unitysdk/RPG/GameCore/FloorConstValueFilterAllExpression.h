...
#define RPG_GAMECORE_FLOORCONSTVALUEFILTERALLEXPRESSION_METHOD_3_C1710868AB6F29EE_OFFSET UNITYSDK_OFFSET(0x189260D0)
#define RPG_GAMECORE_FLOORCONSTVALUEFILTERALLEXPRESSION_METHOD_3_C5BD305458CC49AA_OFFSET UNITYSDK_OFFSET(0x18926120)
#define RPG_GAMECORE_FLOORCONSTVALUEFILTERALLEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x18926110)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FloorConstValueFilterAllExpression_TypeDefinitionIndex = 16516;
