...
#define RPG_GAMECORE_ROGUEACTLOSEALLCOINTHENGETCOINCONFIG_METHOD_6_45140A48DCB4D082_OFFSET UNITYSDK_OFFSET(0x18CC4DB0)
#define RPG_GAMECORE_ROGUEACTLOSEALLCOINTHENGETCOINCONFIG_METHOD_6_F5B11E79DF5C9DA7_OFFSET UNITYSDK_OFFSET(0x18CC4FD0)
#define RPG_GAMECORE_ROGUEACTLOSEALLCOINTHENGETCOINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CC4EF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActLoseAllCoinThenGetCoinConfig_TypeDefinitionIndex = 18623;
