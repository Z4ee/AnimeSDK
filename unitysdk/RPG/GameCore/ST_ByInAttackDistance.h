...
#define RPG_GAMECORE_ST_BYINATTACKDISTANCE_METHOD_4_301990978E85906C_OFFSET UNITYSDK_OFFSET(0x17694400)
#define RPG_GAMECORE_ST_BYINATTACKDISTANCE_METHOD_4_CE9321DFFBDC3826_OFFSET UNITYSDK_OFFSET(0x176944D0)
#define RPG_GAMECORE_ST_BYINATTACKDISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x17694480)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_ByInAttackDistance_TypeDefinitionIndex = 18351;
