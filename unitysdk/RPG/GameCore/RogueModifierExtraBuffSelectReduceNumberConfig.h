...
#define RPG_GAMECORE_ROGUEMODIFIEREXTRABUFFSELECTREDUCENUMBERCONFIG_METHOD_3_D7FE32833B1EFA85_OFFSET UNITYSDK_OFFSET(0x18D3EC10)
#define RPG_GAMECORE_ROGUEMODIFIEREXTRABUFFSELECTREDUCENUMBERCONFIG_METHOD_3_FD0A07912EBC6E7C_OFFSET UNITYSDK_OFFSET(0x18D3ECE0)
#define RPG_GAMECORE_ROGUEMODIFIEREXTRABUFFSELECTREDUCENUMBERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D3EC90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExtraBuffSelectReduceNumberConfig_TypeDefinitionIndex = 17070;
