...
#define RPG_GAMECORE_PLAYMONSTERHPBARTWEEN_METHOD_3_5E7673BF07DDDA7F_OFFSET UNITYSDK_OFFSET(0x174C2C30)
#define RPG_GAMECORE_PLAYMONSTERHPBARTWEEN_METHOD_3_9E11C1BC7FDF4770_OFFSET UNITYSDK_OFFSET(0x174C2CB0)
#define RPG_GAMECORE_PLAYMONSTERHPBARTWEEN__CTOR_OFFSET UNITYSDK_OFFSET(0x174C2C80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayMonsterHPBarTween_TypeDefinitionIndex = 21020;
