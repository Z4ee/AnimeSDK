...
#define RPG_GAMECORE_PLAYMONSTERHPBARTWEEN_METHOD_3_141468104449734D_OFFSET UNITYSDK_OFFSET(0x1BA04070)
#define RPG_GAMECORE_PLAYMONSTERHPBARTWEEN_METHOD_3_9E11C1BC7FDF4770_OFFSET UNITYSDK_OFFSET(0x1BA040B0)
#define RPG_GAMECORE_PLAYMONSTERHPBARTWEEN__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA040A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayMonsterHPBarTween_TypeDefinitionIndex = 22000;
