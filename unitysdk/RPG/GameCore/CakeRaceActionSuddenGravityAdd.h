...
#define RPG_GAMECORE_CAKERACEACTIONSUDDENGRAVITYADD_METHOD_3_8F0B20440AD9858C_OFFSET UNITYSDK_OFFSET(0x1B2CC800)
#define RPG_GAMECORE_CAKERACEACTIONSUDDENGRAVITYADD_METHOD_3_EC011528FBB96521_OFFSET UNITYSDK_OFFSET(0x1B2CC880)
#define RPG_GAMECORE_CAKERACEACTIONSUDDENGRAVITYADD__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2CC870)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionSuddenGravityAdd_TypeDefinitionIndex = 17629;
