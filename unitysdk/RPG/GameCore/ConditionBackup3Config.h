...
#define RPG_GAMECORE_CONDITIONBACKUP3CONFIG_METHOD_4_116F11B377EBBC9A_OFFSET UNITYSDK_OFFSET(0x1712B590)
#define RPG_GAMECORE_CONDITIONBACKUP3CONFIG_METHOD_4_47F719A9E2A59FC8_OFFSET UNITYSDK_OFFSET(0x1712B6C0)
#define RPG_GAMECORE_CONDITIONBACKUP3CONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1712B640)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConditionBackup3Config_TypeDefinitionIndex = 15627;
