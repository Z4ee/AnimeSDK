...
#define RPG_GAMECORE_CONDITIONBACKUP3CONFIG_METHOD_4_116F11B377EBBC9A_OFFSET UNITYSDK_OFFSET(0x196721B0)
#define RPG_GAMECORE_CONDITIONBACKUP3CONFIG_METHOD_4_47F719A9E2A59FC8_OFFSET UNITYSDK_OFFSET(0x196722E0)
#define RPG_GAMECORE_CONDITIONBACKUP3CONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19672260)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConditionBackup3Config_TypeDefinitionIndex = 16198;
