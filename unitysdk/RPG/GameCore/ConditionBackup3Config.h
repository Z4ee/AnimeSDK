...
#define RPG_GAMECORE_CONDITIONBACKUP3CONFIG_METHOD_4_47F719A9E2A59FC8_OFFSET UNITYSDK_OFFSET(0x1BC2AB50)
#define RPG_GAMECORE_CONDITIONBACKUP3CONFIG_METHOD_4_D344A70764F0864C_OFFSET UNITYSDK_OFFSET(0x1BC2AB00)
#define RPG_GAMECORE_CONDITIONBACKUP3CONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC2AB40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConditionBackup3Config_TypeDefinitionIndex = 16382;
