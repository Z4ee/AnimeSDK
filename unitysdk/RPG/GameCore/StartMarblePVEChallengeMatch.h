...
#define RPG_GAMECORE_STARTMARBLEPVECHALLENGEMATCH_METHOD_3_4112E1487E6220B8_OFFSET UNITYSDK_OFFSET(0x18E9A9B0)
#define RPG_GAMECORE_STARTMARBLEPVECHALLENGEMATCH_METHOD_3_82914627142BE141_OFFSET UNITYSDK_OFFSET(0x18E9AA30)
#define RPG_GAMECORE_STARTMARBLEPVECHALLENGEMATCH__CTOR_OFFSET UNITYSDK_OFFSET(0x18E9AA00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StartMarblePVEChallengeMatch_TypeDefinitionIndex = 20246;
