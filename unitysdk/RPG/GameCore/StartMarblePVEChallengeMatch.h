...
#define RPG_GAMECORE_STARTMARBLEPVECHALLENGEMATCH_METHOD_3_6E4FC183DFAC163A_OFFSET UNITYSDK_OFFSET(0x1B0BDA40)
#define RPG_GAMECORE_STARTMARBLEPVECHALLENGEMATCH_METHOD_3_EF77D8683F3DC38B_OFFSET UNITYSDK_OFFSET(0x1B0BDA80)
#define RPG_GAMECORE_STARTMARBLEPVECHALLENGEMATCH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0BDA70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StartMarblePVEChallengeMatch_TypeDefinitionIndex = 20475;
