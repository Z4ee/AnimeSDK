...
#define RPG_GAMECORE_WAITFLOORCUSTOMVALUECHANGE_METHOD_4_1D0EA36B25BB50CE_OFFSET UNITYSDK_OFFSET(0x1B8A47B0)
#define RPG_GAMECORE_WAITFLOORCUSTOMVALUECHANGE_METHOD_4_8CE828D272E073E3_OFFSET UNITYSDK_OFFSET(0x1B8A4760)
#define RPG_GAMECORE_WAITFLOORCUSTOMVALUECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8A47A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitFloorCustomValueChange_TypeDefinitionIndex = 19911;
