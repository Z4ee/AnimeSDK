...
#define RPG_GAMECORE_GRIDFIGHTROLECONFIG_METHOD_2_022F94E94F2B1ED8_OFFSET UNITYSDK_OFFSET(0x198057D0)
#define RPG_GAMECORE_GRIDFIGHTROLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x198058F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightRoleConfig_TypeDefinitionIndex = 10180;
