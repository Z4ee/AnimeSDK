...
#define RPG_GAMECORE_REMOVEBEHAVIORFLAGFORMODIFIER_METHOD_3_B0D519095451861E_OFFSET UNITYSDK_OFFSET(0x17596C10)
#define RPG_GAMECORE_REMOVEBEHAVIORFLAGFORMODIFIER_METHOD_3_D8203BD38BDA8361_OFFSET UNITYSDK_OFFSET(0x17596B90)
#define RPG_GAMECORE_REMOVEBEHAVIORFLAGFORMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x17596BE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveBehaviorFlagForModifier_TypeDefinitionIndex = 21345;
