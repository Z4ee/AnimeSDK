...
#define RPG_GAMECORE_FIVEDIMEDITORLOADSTAGECONFIG_METHOD_2_2B6091C022170865_OFFSET UNITYSDK_OFFSET(0x1BA92AD0)
#define RPG_GAMECORE_FIVEDIMEDITORLOADSTAGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA92B10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimEditorLoadStageConfig_TypeDefinitionIndex = 18101;
