...
#define RPG_GAMECORE_FIVEDIMEDITORLOADSTAGECONFIG_METHOD_2_2B6091C022170865_OFFSET UNITYSDK_OFFSET(0x171F0880)
#define RPG_GAMECORE_FIVEDIMEDITORLOADSTAGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171F08C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimEditorLoadStageConfig_TypeDefinitionIndex = 17285;
