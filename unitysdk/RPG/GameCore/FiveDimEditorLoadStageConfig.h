...
#define RPG_GAMECORE_FIVEDIMEDITORLOADSTAGECONFIG_METHOD_2_2B6091C022170865_OFFSET UNITYSDK_OFFSET(0x1D0E2350)
#define RPG_GAMECORE_FIVEDIMEDITORLOADSTAGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0E2390)
