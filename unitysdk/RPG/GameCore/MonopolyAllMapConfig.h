...
#define RPG_GAMECORE_MONOPOLYALLMAPCONFIG_METHOD_2_2C71B38A8ED1ED2D_OFFSET UNITYSDK_OFFSET(0x1D2B9B10)
#define RPG_GAMECORE_MONOPOLYALLMAPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2B9C10)
