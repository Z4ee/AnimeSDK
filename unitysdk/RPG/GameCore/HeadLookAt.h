...
#define RPG_GAMECORE_HEADLOOKAT_METHOD_3_46BB0CDE63E0237F_OFFSET UNITYSDK_OFFSET(0x17295F90)
#define RPG_GAMECORE_HEADLOOKAT_METHOD_3_97F3B0EBA9621CCE_OFFSET UNITYSDK_OFFSET(0x17295EF0)
#define RPG_GAMECORE_HEADLOOKAT__CTOR_OFFSET UNITYSDK_OFFSET(0x17295F50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HeadLookAt_TypeDefinitionIndex = 19846;
