...
#define RPG_GAMECORE_CHIMERADUELENTITYBRANCHVALUEGETTER_METHOD_3_2C3B0C53557309E4_OFFSET UNITYSDK_OFFSET(0x1C23D8F0)
#define RPG_GAMECORE_CHIMERADUELENTITYBRANCHVALUEGETTER_METHOD_3_84764288F9F22056_OFFSET UNITYSDK_OFFSET(0x1C3958A0)
#define RPG_GAMECORE_CHIMERADUELENTITYBRANCHVALUEGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C23DBB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelEntityBranchValueGetter_TypeDefinitionIndex = 15312;
