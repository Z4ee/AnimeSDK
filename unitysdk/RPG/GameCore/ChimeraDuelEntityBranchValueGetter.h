...
#define RPG_GAMECORE_CHIMERADUELENTITYBRANCHVALUEGETTER_METHOD_3_2C3B0C53557309E4_OFFSET UNITYSDK_OFFSET(0x1963C310)
#define RPG_GAMECORE_CHIMERADUELENTITYBRANCHVALUEGETTER_METHOD_3_84764288F9F22056_OFFSET UNITYSDK_OFFSET(0x1963C2B0)
#define RPG_GAMECORE_CHIMERADUELENTITYBRANCHVALUEGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1963C300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelEntityBranchValueGetter_TypeDefinitionIndex = 15148;
