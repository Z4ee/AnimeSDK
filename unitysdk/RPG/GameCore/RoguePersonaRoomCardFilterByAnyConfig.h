...
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYANYCONFIG_METHOD_3_CF392BA7A16835D3_OFFSET UNITYSDK_OFFSET(0x19BB9BD0)
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYANYCONFIG_METHOD_3_D8026FA21552B60F_OFFSET UNITYSDK_OFFSET(0x19BB9D80)
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYANYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19BB9BC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RoguePersonaRoomCardFilterByAnyConfig_TypeDefinitionIndex = 18828;
