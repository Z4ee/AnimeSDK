...
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYANYCONFIG_METHOD_3_CF392BA7A16835D3_OFFSET UNITYSDK_OFFSET(0x17657C60)
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYANYCONFIG_METHOD_3_D8026FA21552B60F_OFFSET UNITYSDK_OFFSET(0x17657E10)
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYANYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17657C50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RoguePersonaRoomCardFilterByAnyConfig_TypeDefinitionIndex = 18216;
