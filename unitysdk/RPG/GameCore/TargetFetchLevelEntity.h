...
#define RPG_GAMECORE_TARGETFETCHLEVELENTITY_METHOD_4_6F641939F6AA0A6C_OFFSET UNITYSDK_OFFSET(0x1E16F7A0)
#define RPG_GAMECORE_TARGETFETCHLEVELENTITY_METHOD_4_74B34E2E4D56C881_OFFSET UNITYSDK_OFFSET(0x1E16F820)
#define RPG_GAMECORE_TARGETFETCHLEVELENTITY_METHOD_4_980D4E2A7E2A769C_OFFSET UNITYSDK_OFFSET(0x1E16F880)
#define RPG_GAMECORE_TARGETFETCHLEVELENTITY_METHOD_4_BE90BEE6EB872FE9_OFFSET UNITYSDK_OFFSET(0x1E16F8A0)
#define RPG_GAMECORE_TARGETFETCHLEVELENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1E16F810)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchLevelEntity_TypeDefinitionIndex = 23650;
