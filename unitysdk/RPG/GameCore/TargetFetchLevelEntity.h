...
#define RPG_GAMECORE_TARGETFETCHLEVELENTITY_METHOD_4_74B34E2E4D56C881_OFFSET UNITYSDK_OFFSET(0x177B6350)
#define RPG_GAMECORE_TARGETFETCHLEVELENTITY_METHOD_4_A45AF61F26C38A5F_OFFSET UNITYSDK_OFFSET(0x177BF140)
#define RPG_GAMECORE_TARGETFETCHLEVELENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x177B6300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchLevelEntity_TypeDefinitionIndex = 22202;
