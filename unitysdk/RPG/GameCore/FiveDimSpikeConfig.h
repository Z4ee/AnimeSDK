...
#define RPG_GAMECORE_FIVEDIMSPIKECONFIG_METHOD_3_A6AA8B55D3B0AAAA_OFFSET UNITYSDK_OFFSET(0x1720C750)
#define RPG_GAMECORE_FIVEDIMSPIKECONFIG_METHOD_3_F2723B93DC5C2D72_OFFSET UNITYSDK_OFFSET(0x1720C6E0)
#define RPG_GAMECORE_FIVEDIMSPIKECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1720C730)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSpikeConfig_TypeDefinitionIndex = 17058;
	...
	public:
		...
		static ::System::Void Method_3_A6AA8B55D3B0AAAA(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::FiveDimSpikeConfig* a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::FiveDimSpikeConfig*))((::PBYTE)hIl2Cpp + RPG_GAMECORE_FIVEDIMSPIKECONFIG_METHOD_3_A6AA8B55D3B0AAAA_OFFSET))(a1, a2);
		}
	};
}
