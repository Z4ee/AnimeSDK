...
#define RPG_GAMECORE_ADVNPCMOVEALONGPATH_METHOD_3_8C7663B45BC9D2C6_OFFSET UNITYSDK_OFFSET(0x1CDD2710)
#define RPG_GAMECORE_ADVNPCMOVEALONGPATH_METHOD_3_ED7227A7FDA245BF_OFFSET UNITYSDK_OFFSET(0x1CDD26C0)
#define RPG_GAMECORE_ADVNPCMOVEALONGPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDD2700)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvNpcMoveAlongPath_TypeDefinitionIndex = 20095;
