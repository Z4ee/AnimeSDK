...
#define RPG_GAMECORE_ITEMCOMPOSECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D226D60)
#define RPG_GAMECORE_ITEMCOMPOSECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D227880)
