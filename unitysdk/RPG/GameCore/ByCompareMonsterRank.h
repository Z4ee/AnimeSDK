...
#define RPG_GAMECORE_BYCOMPAREMONSTERRANK_METHOD_4_1BB8E6C2AF39A92C_OFFSET UNITYSDK_OFFSET(0x1CEE9110)
#define RPG_GAMECORE_BYCOMPAREMONSTERRANK_METHOD_4_A8AADFA3790F2F3A_OFFSET UNITYSDK_OFFSET(0x1CEE9150)
#define RPG_GAMECORE_BYCOMPAREMONSTERRANK_METHOD_4_AB030E40884CC6F5_OFFSET UNITYSDK_OFFSET(0x1CEE8E60)
#define RPG_GAMECORE_BYCOMPAREMONSTERRANK_METHOD_4_C9091CDE88048324_OFFSET UNITYSDK_OFFSET(0x1CEE8EB0)
#define RPG_GAMECORE_BYCOMPAREMONSTERRANK__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEE8EA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareMonsterRank_TypeDefinitionIndex = 22779;
