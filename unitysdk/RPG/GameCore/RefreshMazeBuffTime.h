...
#define RPG_GAMECORE_REFRESHMAZEBUFFTIME_METHOD_3_7612EDDB74E08EE7_OFFSET UNITYSDK_OFFSET(0x18C95690)
#define RPG_GAMECORE_REFRESHMAZEBUFFTIME_METHOD_3_C76A6A1F3AB1C236_OFFSET UNITYSDK_OFFSET(0x18C95610)
#define RPG_GAMECORE_REFRESHMAZEBUFFTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x18C95660)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RefreshMazeBuffTime_TypeDefinitionIndex = 19121;
