...
#define RPG_GAMECORE_TRAINPARTYMODIFIERREFRESHCARDSTEPONROUNDFINISHCONFIG_METHOD_3_0C9CE99EF94D1513_OFFSET UNITYSDK_OFFSET(0x1D536F40)
#define RPG_GAMECORE_TRAINPARTYMODIFIERREFRESHCARDSTEPONROUNDFINISHCONFIG_METHOD_3_501E7401C2F9CD57_OFFSET UNITYSDK_OFFSET(0x1D536C80)
#define RPG_GAMECORE_TRAINPARTYMODIFIERREFRESHCARDSTEPONROUNDFINISHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D536C70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyModifierRefreshCardStepOnRoundFinishConfig_TypeDefinitionIndex = 17896;
