...
#define RPG_GAMECORE_TRAINPARTYMODIFIERREFRESHCARDSTEPONROUNDFINISHCONFIG_METHOD_3_0C9CE99EF94D1513_OFFSET UNITYSDK_OFFSET(0x178AD400)
#define RPG_GAMECORE_TRAINPARTYMODIFIERREFRESHCARDSTEPONROUNDFINISHCONFIG_METHOD_3_501E7401C2F9CD57_OFFSET UNITYSDK_OFFSET(0x178AD140)
#define RPG_GAMECORE_TRAINPARTYMODIFIERREFRESHCARDSTEPONROUNDFINISHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x178AD130)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyModifierRefreshCardStepOnRoundFinishConfig_TypeDefinitionIndex = 16617;
