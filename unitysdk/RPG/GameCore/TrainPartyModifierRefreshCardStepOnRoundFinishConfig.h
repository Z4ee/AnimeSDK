...
#define RPG_GAMECORE_TRAINPARTYMODIFIERREFRESHCARDSTEPONROUNDFINISHCONFIG_METHOD_3_0C9CE99EF94D1513_OFFSET UNITYSDK_OFFSET(0x19DF6B50)
#define RPG_GAMECORE_TRAINPARTYMODIFIERREFRESHCARDSTEPONROUNDFINISHCONFIG_METHOD_3_501E7401C2F9CD57_OFFSET UNITYSDK_OFFSET(0x19DF6890)
#define RPG_GAMECORE_TRAINPARTYMODIFIERREFRESHCARDSTEPONROUNDFINISHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19DF6880)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyModifierRefreshCardStepOnRoundFinishConfig_TypeDefinitionIndex = 17217;
