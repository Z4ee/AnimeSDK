...
#define RPG_GAMECORE_STAGEHARMONYPLAYERPOSSIGNALMONOSERIALIZATION_METHOD_2_BA59B3F76F4302B7_OFFSET UNITYSDK_OFFSET(0x18E8D560)
#define RPG_GAMECORE_STAGEHARMONYPLAYERPOSSIGNALMONOSERIALIZATION__CTOR_OFFSET UNITYSDK_OFFSET(0x18E8D670)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StageHarmonyPlayerPosSignalMonoSerialization_TypeDefinitionIndex = 18230;
