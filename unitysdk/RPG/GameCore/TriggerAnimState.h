...
#define RPG_GAMECORE_TRIGGERANIMSTATE_METHOD_3_3B1D629349725B87_OFFSET UNITYSDK_OFFSET(0x1B0454A0)
#define RPG_GAMECORE_TRIGGERANIMSTATE_METHOD_3_54D77F5BB0010A8F_OFFSET UNITYSDK_OFFSET(0x1B0452F0)
#define RPG_GAMECORE_TRIGGERANIMSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B045330)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerAnimState_TypeDefinitionIndex = 22050;
