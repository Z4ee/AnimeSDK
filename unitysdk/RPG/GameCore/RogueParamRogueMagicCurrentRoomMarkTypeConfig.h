...
#define RPG_GAMECORE_ROGUEPARAMROGUEMAGICCURRENTROOMMARKTYPECONFIG_METHOD_6_35CF6D5A7ADABD73_OFFSET UNITYSDK_OFFSET(0x19BAFD30)
#define RPG_GAMECORE_ROGUEPARAMROGUEMAGICCURRENTROOMMARKTYPECONFIG_METHOD_6_998F9D104D51F17D_OFFSET UNITYSDK_OFFSET(0x19BAFA80)
#define RPG_GAMECORE_ROGUEPARAMROGUEMAGICCURRENTROOMMARKTYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19BAFC00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamRogueMagicCurrentRoomMarkTypeConfig_TypeDefinitionIndex = 18793;
