...
#define RPG_GAMECORE_MODIFYCURVEPROPGROUPOBJECTSTATE_METHOD_3_7316629718E9B424_OFFSET UNITYSDK_OFFSET(0x18B38290)
#define RPG_GAMECORE_MODIFYCURVEPROPGROUPOBJECTSTATE_METHOD_3_78CF5A1320174147_OFFSET UNITYSDK_OFFSET(0x18B38310)
#define RPG_GAMECORE_MODIFYCURVEPROPGROUPOBJECTSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18B382E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyCurvePropGroupObjectState_TypeDefinitionIndex = 21132;
