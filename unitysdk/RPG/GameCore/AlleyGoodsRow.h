...
#define RPG_GAMECORE_ALLEYGOODSROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1946A900)
#define RPG_GAMECORE_ALLEYGOODSROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1946AFD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AlleyGoodsRow_TypeDefinitionIndex = 12007;
