...
#define RPG_GAMECORE_TRIGGERPARALLELTASKLISTTEMPLATE_METHOD_3_028648D9E6964C35_OFFSET UNITYSDK_OFFSET(0x1B05A190)
#define RPG_GAMECORE_TRIGGERPARALLELTASKLISTTEMPLATE_METHOD_3_E1AF5C322BDD12B2_OFFSET UNITYSDK_OFFSET(0x1B05A150)
#define RPG_GAMECORE_TRIGGERPARALLELTASKLISTTEMPLATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B05A180)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerParallelTaskListTemplate_TypeDefinitionIndex = 22472;
