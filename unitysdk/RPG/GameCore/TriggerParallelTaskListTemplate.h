...
#define RPG_GAMECORE_TRIGGERPARALLELTASKLISTTEMPLATE_METHOD_3_1771F226EB3E0DAF_OFFSET UNITYSDK_OFFSET(0x190CA5D0)
#define RPG_GAMECORE_TRIGGERPARALLELTASKLISTTEMPLATE_METHOD_3_2EABDAB0E1913D1A_OFFSET UNITYSDK_OFFSET(0x190CA550)
#define RPG_GAMECORE_TRIGGERPARALLELTASKLISTTEMPLATE__CTOR_OFFSET UNITYSDK_OFFSET(0x190CA5A0)
