...
#define RPG_GAMECORE_ROGUEDIALOGUEEVENTOPTIONDYNAMICCONFIG_METHOD_2_34ACF28790BF5BD4_OFFSET UNITYSDK_OFFSET(0x1CFA9EE0)
#define RPG_GAMECORE_ROGUEDIALOGUEEVENTOPTIONDYNAMICCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFAA000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueDialogueEventOptionDynamicConfig_TypeDefinitionIndex = 17187;
