...
#define RPG_GAMECORE_ROGUEDIALOGUEEVENTOPTIONDYNAMICCONFIG_METHOD_2_34ACF28790BF5BD4_OFFSET UNITYSDK_OFFSET(0x1D92E9D0)
#define RPG_GAMECORE_ROGUEDIALOGUEEVENTOPTIONDYNAMICCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D92EAF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueDialogueEventOptionDynamicConfig_TypeDefinitionIndex = 17703;
