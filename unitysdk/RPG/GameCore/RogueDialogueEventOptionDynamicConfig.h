...
#define RPG_GAMECORE_ROGUEDIALOGUEEVENTOPTIONDYNAMICCONFIG_METHOD_2_34ACF28790BF5BD4_OFFSET UNITYSDK_OFFSET(0x1D3E1B00)
#define RPG_GAMECORE_ROGUEDIALOGUEEVENTOPTIONDYNAMICCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3E1C20)
