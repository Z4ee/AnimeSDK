...
#define RPG_GAMECORE_SHAREDUINT_EQUALS_OFFSET UNITYSDK_OFFSET(0x19C6E6E0)
#define RPG_GAMECORE_SHAREDUINT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19C6E720)
#define RPG_GAMECORE_SHAREDUINT_METHOD_3_3C21746C1F5C045E_OFFSET UNITYSDK_OFFSET(0x19C6E5B0)
#define RPG_GAMECORE_SHAREDUINT_METHOD_3_85D22C255258C41D_OFFSET UNITYSDK_OFFSET(0x19C6E6D0)
#define RPG_GAMECORE_SHAREDUINT_METHOD_3_85DECB076B86A2D9_OFFSET UNITYSDK_OFFSET(0x19C6E5F0)
#define RPG_GAMECORE_SHAREDUINT__CTOR_OFFSET UNITYSDK_OFFSET(0x19C6E5E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SharedUint_TypeDefinitionIndex = 17398;
