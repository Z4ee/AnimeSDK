...
#define RPG_GAMECORE_SHAREDUINT_EQUALS_OFFSET UNITYSDK_OFFSET(0x1BE33A20)
#define RPG_GAMECORE_SHAREDUINT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1BE33A60)
#define RPG_GAMECORE_SHAREDUINT_METHOD_3_3C21746C1F5C045E_OFFSET UNITYSDK_OFFSET(0x1BE338F0)
#define RPG_GAMECORE_SHAREDUINT_METHOD_3_85D22C255258C41D_OFFSET UNITYSDK_OFFSET(0x1BE33A10)
#define RPG_GAMECORE_SHAREDUINT_METHOD_3_85DECB076B86A2D9_OFFSET UNITYSDK_OFFSET(0x1BE33930)
#define RPG_GAMECORE_SHAREDUINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE33920)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SharedUint_TypeDefinitionIndex = 17571;
