...
#define RPG_GAMECORE_LEVELFINISHEXTERNALAPPLYOPEVENT_CLEAR_OFFSET UNITYSDK_OFFSET(0x1BDFCA50)
#define RPG_GAMECORE_LEVELFINISHEXTERNALAPPLYOPEVENT_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1BDFCAF0)
#define RPG_GAMECORE_LEVELFINISHEXTERNALAPPLYOPEVENT_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x1BDFCAA0)
#define RPG_GAMECORE_LEVELFINISHEXTERNALAPPLYOPEVENT_INIT_OFFSET UNITYSDK_OFFSET(0x1BDFC9D0)
#define RPG_GAMECORE_LEVELFINISHEXTERNALAPPLYOPEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDFCB40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelFinishExternalApplyOpEvent_TypeDefinitionIndex = 54269;
