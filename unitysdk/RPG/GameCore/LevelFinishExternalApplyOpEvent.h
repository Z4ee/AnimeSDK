...
#define RPG_GAMECORE_LEVELFINISHEXTERNALAPPLYOPEVENT_CLEAR_OFFSET UNITYSDK_OFFSET(0xE693920)
#define RPG_GAMECORE_LEVELFINISHEXTERNALAPPLYOPEVENT_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xE6939C0)
#define RPG_GAMECORE_LEVELFINISHEXTERNALAPPLYOPEVENT_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xE693970)
#define RPG_GAMECORE_LEVELFINISHEXTERNALAPPLYOPEVENT_INIT_OFFSET UNITYSDK_OFFSET(0xE6938A0)
#define RPG_GAMECORE_LEVELFINISHEXTERNALAPPLYOPEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0xE693A10)
