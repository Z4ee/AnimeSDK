...
#define RPG_GAMECORE_SPACEZOOINTERACTIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17753F90)
#define RPG_GAMECORE_SPACEZOOINTERACTIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17754220)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SpaceZooInteractionRow_TypeDefinitionIndex = 11308;
