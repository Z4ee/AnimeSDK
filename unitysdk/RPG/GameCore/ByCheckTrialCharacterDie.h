...
#define RPG_GAMECORE_BYCHECKTRIALCHARACTERDIE_METHOD_4_A6D25909D8706D7A_OFFSET UNITYSDK_OFFSET(0x18725700)
#define RPG_GAMECORE_BYCHECKTRIALCHARACTERDIE_METHOD_4_D2DC705C7257DFD8_OFFSET UNITYSDK_OFFSET(0x18725780)
#define RPG_GAMECORE_BYCHECKTRIALCHARACTERDIE__CTOR_OFFSET UNITYSDK_OFFSET(0x187258F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckTrialCharacterDie_TypeDefinitionIndex = 22407;
