...
#define RPG_GAMECORE_RANDOMSELECTORCASE_METHOD_2_F6DA3C8A7D5A9F32_OFFSET UNITYSDK_OFFSET(0x1D19A690)
#define RPG_GAMECORE_RANDOMSELECTORCASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D19A7F0)
