...
#define RPG_GAMECORE_BYCHECKCHARACTERFLY_METHOD_4_64379C35FAB3885E_OFFSET UNITYSDK_OFFSET(0x16FFD380)
#define RPG_GAMECORE_BYCHECKCHARACTERFLY_METHOD_4_73486363B3F9D0F1_OFFSET UNITYSDK_OFFSET(0x16FFD4A0)
#define RPG_GAMECORE_BYCHECKCHARACTERFLY__CTOR_OFFSET UNITYSDK_OFFSET(0x16FFD420)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckCharacterFly_TypeDefinitionIndex = 21747;
