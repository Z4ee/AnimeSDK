...
#define RPG_GAMECORE_BYCHECKCHARACTERFLY_METHOD_4_64379C35FAB3885E_OFFSET UNITYSDK_OFFSET(0x18721600)
#define RPG_GAMECORE_BYCHECKCHARACTERFLY_METHOD_4_73486363B3F9D0F1_OFFSET UNITYSDK_OFFSET(0x18721720)
#define RPG_GAMECORE_BYCHECKCHARACTERFLY__CTOR_OFFSET UNITYSDK_OFFSET(0x187216A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckCharacterFly_TypeDefinitionIndex = 22485;
