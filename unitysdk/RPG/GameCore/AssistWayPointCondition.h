...
#define RPG_GAMECORE_ASSISTWAYPOINTCONDITION_METHOD_2_3E3F0CAE554016C5_OFFSET UNITYSDK_OFFSET(0x1A05DCB0)
#define RPG_GAMECORE_ASSISTWAYPOINTCONDITION_METHOD_2_69A05622E8D3A6CC_OFFSET UNITYSDK_OFFSET(0x1A05F1F0)
#define RPG_GAMECORE_ASSISTWAYPOINTCONDITION_METHOD_2_D28994F7F9AA9124_OFFSET UNITYSDK_OFFSET(0x1A05F710)
#define RPG_GAMECORE_ASSISTWAYPOINTCONDITION_METHOD_2_FC1B6B2B93097560_OFFSET UNITYSDK_OFFSET(0x1A05E010)
#define RPG_GAMECORE_ASSISTWAYPOINTCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A05E000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AssistWayPointCondition_TypeDefinitionIndex = 18247;
