...
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_POINT_METHOD_3_45EDDBBD81213DF3_OFFSET UNITYSDK_OFFSET(0x1C10F1A0)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_POINT_METHOD_3_B5CC2BC55299C657_OFFSET UNITYSDK_OFFSET(0x1C10FF80)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_POINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C10F140)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatDiceSelectorConfig_Point_TypeDefinitionIndex = 15529;
