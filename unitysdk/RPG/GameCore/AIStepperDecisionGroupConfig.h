...
#define RPG_GAMECORE_AISTEPPERDECISIONGROUPCONFIG_METHOD_4_9BC4B801EB811E9E_OFFSET UNITYSDK_OFFSET(0x16E92030)
#define RPG_GAMECORE_AISTEPPERDECISIONGROUPCONFIG_METHOD_4_BD4C279166180CFB_OFFSET UNITYSDK_OFFSET(0x16E8FA90)
#define RPG_GAMECORE_AISTEPPERDECISIONGROUPCONFIG_METHOD_4_C66FCDCC115993CF_OFFSET UNITYSDK_OFFSET(0x16E92070)
#define RPG_GAMECORE_AISTEPPERDECISIONGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16E8FA80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AIStepperDecisionGroupConfig_TypeDefinitionIndex = 14181;
