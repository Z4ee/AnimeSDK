...
#define RPG_GAMECORE_AISTEPPERDECISIONGROUPCONFIG_METHOD_4_A1643CBA9CAD5328_OFFSET UNITYSDK_OFFSET(0x1B9F3B10)
#define RPG_GAMECORE_AISTEPPERDECISIONGROUPCONFIG_METHOD_4_D0F92E420860DE31_OFFSET UNITYSDK_OFFSET(0x1B9F60C0)
#define RPG_GAMECORE_AISTEPPERDECISIONGROUPCONFIG_METHOD_4_F272A3020D47B99A_OFFSET UNITYSDK_OFFSET(0x1B9F6100)
#define RPG_GAMECORE_AISTEPPERDECISIONGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9F3B00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AIStepperDecisionGroupConfig_TypeDefinitionIndex = 14876;
