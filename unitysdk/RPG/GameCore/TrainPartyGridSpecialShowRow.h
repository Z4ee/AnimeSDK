...
#define RPG_GAMECORE_TRAINPARTYGRIDSPECIALSHOWROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x178AC400)
#define RPG_GAMECORE_TRAINPARTYGRIDSPECIALSHOWROW__CTOR_OFFSET UNITYSDK_OFFSET(0x178AC530)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyGridSpecialShowRow_TypeDefinitionIndex = 14040;
