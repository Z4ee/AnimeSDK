...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONAFTERROGUEONEBATTLECONFIG_METHOD_3_9E0419140C5B9F4B_OFFSET UNITYSDK_OFFSET(0x1CFBFB40)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONAFTERROGUEONEBATTLECONFIG_METHOD_3_F276C2F7E5084B4F_OFFSET UNITYSDK_OFFSET(0x1CFBFB90)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONAFTERROGUEONEBATTLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFBFB80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionAfterRogueOneBattleConfig_TypeDefinitionIndex = 17214;
