...
#define RPG_GAMECORE_MAPROTATIONCONFIG_METHOD_2_739FBD52C9B8E66F_OFFSET UNITYSDK_OFFSET(0x1D49B430)
#define RPG_GAMECORE_MAPROTATIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D49B4F0)
