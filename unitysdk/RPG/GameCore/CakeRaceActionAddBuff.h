...
#define RPG_GAMECORE_CAKERACEACTIONADDBUFF_METHOD_3_7448DEC7FE9A8429_OFFSET UNITYSDK_OFFSET(0x1B2C9EA0)
#define RPG_GAMECORE_CAKERACEACTIONADDBUFF_METHOD_3_92FEF29ACB880746_OFFSET UNITYSDK_OFFSET(0x1B2C9EE0)
#define RPG_GAMECORE_CAKERACEACTIONADDBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2C9ED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionAddBuff_TypeDefinitionIndex = 17601;
