...
#define RPG_GAMECORE_CAKERACEACTIONADDBUFF_METHOD_3_069E463CB945D13F_OFFSET UNITYSDK_OFFSET(0x17041BC0)
#define RPG_GAMECORE_CAKERACEACTIONADDBUFF_METHOD_3_0DD263E1E877734C_OFFSET UNITYSDK_OFFSET(0x17041C30)
#define RPG_GAMECORE_CAKERACEACTIONADDBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x17041C10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionAddBuff_TypeDefinitionIndex = 16830;
