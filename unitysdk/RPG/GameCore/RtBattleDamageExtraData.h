...
#define RPG_GAMECORE_RTBATTLEDAMAGEEXTRADATA_METHOD_3_0590B5B643E121B7_OFFSET UNITYSDK_OFFSET(0x1BB887D0)
#define RPG_GAMECORE_RTBATTLEDAMAGEEXTRADATA_METHOD_3_99FD997239B2E03D_OFFSET UNITYSDK_OFFSET(0x1BB889A0)
#define RPG_GAMECORE_RTBATTLEDAMAGEEXTRADATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB88930)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtBattleDamageExtraData_TypeDefinitionIndex = 23307;
