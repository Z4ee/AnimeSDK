...
#define RPG_GAMECORE_LITTLEGAMETRIGGERCONFIG_METHOD_3_225374DA18C20100_OFFSET UNITYSDK_OFFSET(0x1BCC5B80)
#define RPG_GAMECORE_LITTLEGAMETRIGGERCONFIG_METHOD_3_66D1FC4D97A4F5AB_OFFSET UNITYSDK_OFFSET(0x1BCC5B40)
#define RPG_GAMECORE_LITTLEGAMETRIGGERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCC5B70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameTriggerConfig_TypeDefinitionIndex = 18113;
