...
#define RPG_GAMECORE_LITTLEGAMETRIGGERCONFIG_METHOD_3_225374DA18C20100_OFFSET UNITYSDK_OFFSET(0x1989BE60)
#define RPG_GAMECORE_LITTLEGAMETRIGGERCONFIG_METHOD_3_DB6A9C56786B1891_OFFSET UNITYSDK_OFFSET(0x198A2990)
#define RPG_GAMECORE_LITTLEGAMETRIGGERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1989BE40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameTriggerConfig_TypeDefinitionIndex = 17934;
