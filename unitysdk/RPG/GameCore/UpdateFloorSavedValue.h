...
#define RPG_GAMECORE_UPDATEFLOORSAVEDVALUE_METHOD_3_1A787CBD54186202_OFFSET UNITYSDK_OFFSET(0x190E6250)
#define RPG_GAMECORE_UPDATEFLOORSAVEDVALUE_METHOD_3_76BE4E8005202442_OFFSET UNITYSDK_OFFSET(0x190E61C0)
#define RPG_GAMECORE_UPDATEFLOORSAVEDVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x190E6220)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UpdateFloorSavedValue_TypeDefinitionIndex = 19681;
