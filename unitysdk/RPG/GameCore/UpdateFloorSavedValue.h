...
#define RPG_GAMECORE_UPDATEFLOORSAVEDVALUE_METHOD_3_1A787CBD54186202_OFFSET UNITYSDK_OFFSET(0x1B8855E0)
#define RPG_GAMECORE_UPDATEFLOORSAVEDVALUE_METHOD_3_9879CAAF2AD566E6_OFFSET UNITYSDK_OFFSET(0x1B885590)
#define RPG_GAMECORE_UPDATEFLOORSAVEDVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8855D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UpdateFloorSavedValue_TypeDefinitionIndex = 19920;
