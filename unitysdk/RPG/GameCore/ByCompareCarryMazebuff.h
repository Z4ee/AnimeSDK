...
#define RPG_GAMECORE_BYCOMPARECARRYMAZEBUFF_METHOD_4_670AEEE6D79F2D58_OFFSET UNITYSDK_OFFSET(0x17003860)
#define RPG_GAMECORE_BYCOMPARECARRYMAZEBUFF_METHOD_4_8F5972F05556A933_OFFSET UNITYSDK_OFFSET(0x17003980)
#define RPG_GAMECORE_BYCOMPARECARRYMAZEBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x17003900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareCarryMazebuff_TypeDefinitionIndex = 18313;
