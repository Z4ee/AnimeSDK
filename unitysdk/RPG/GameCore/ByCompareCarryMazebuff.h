...
#define RPG_GAMECORE_BYCOMPARECARRYMAZEBUFF_METHOD_4_7315DACCD711F652_OFFSET UNITYSDK_OFFSET(0x19CD3940)
#define RPG_GAMECORE_BYCOMPARECARRYMAZEBUFF_METHOD_4_8F5972F05556A933_OFFSET UNITYSDK_OFFSET(0x19CD39E0)
#define RPG_GAMECORE_BYCOMPARECARRYMAZEBUFF_METHOD_4_CFECF0893025D242_OFFSET UNITYSDK_OFFSET(0x19CD3B90)
#define RPG_GAMECORE_BYCOMPARECARRYMAZEBUFF_METHOD_4_ECF5CFBC52077457_OFFSET UNITYSDK_OFFSET(0x19CD3BF0)
#define RPG_GAMECORE_BYCOMPARECARRYMAZEBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x19CD39A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareCarryMazebuff_TypeDefinitionIndex = 19264;
