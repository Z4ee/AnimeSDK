...
#define RPG_GAMECORE_ROGUEACTREMOVEROGUEMIRACLEBYIDCONFIG_METHOD_6_8E53CEDA16540D21_OFFSET UNITYSDK_OFFSET(0x175C6850)
#define RPG_GAMECORE_ROGUEACTREMOVEROGUEMIRACLEBYIDCONFIG_METHOD_6_DB545CF7E61F0AEC_OFFSET UNITYSDK_OFFSET(0x175C6630)
#define RPG_GAMECORE_ROGUEACTREMOVEROGUEMIRACLEBYIDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175C6770)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActRemoveRogueMiracleByIdConfig_TypeDefinitionIndex = 17965;
