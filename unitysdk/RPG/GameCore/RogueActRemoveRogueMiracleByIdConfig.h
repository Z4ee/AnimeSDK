...
#define RPG_GAMECORE_ROGUEACTREMOVEROGUEMIRACLEBYIDCONFIG_METHOD_6_14E572C601F35EFD_OFFSET UNITYSDK_OFFSET(0x1D3BAA70)
#define RPG_GAMECORE_ROGUEACTREMOVEROGUEMIRACLEBYIDCONFIG_METHOD_6_8E53CEDA16540D21_OFFSET UNITYSDK_OFFSET(0x1D3BAAC0)
#define RPG_GAMECORE_ROGUEACTREMOVEROGUEMIRACLEBYIDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3BAAB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActRemoveRogueMiracleByIdConfig_TypeDefinitionIndex = 19379;
