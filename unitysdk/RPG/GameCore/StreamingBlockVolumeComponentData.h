...
#define RPG_GAMECORE_STREAMINGBLOCKVOLUMECOMPONENTDATA_METHOD_3_2335E1EF4EA471D4_OFFSET UNITYSDK_OFFSET(0x1B0C9A50)
#define RPG_GAMECORE_STREAMINGBLOCKVOLUMECOMPONENTDATA_METHOD_3_2EA65B95C0E827BD_OFFSET UNITYSDK_OFFSET(0x1B0B5DB0)
#define RPG_GAMECORE_STREAMINGBLOCKVOLUMECOMPONENTDATA_METHOD_3_42C92D0210A91ABB_OFFSET UNITYSDK_OFFSET(0x1B0C9B30)
#define RPG_GAMECORE_STREAMINGBLOCKVOLUMECOMPONENTDATA_METHOD_3_B16F2CFD1A55046C_OFFSET UNITYSDK_OFFSET(0x1B0B6910)
#define RPG_GAMECORE_STREAMINGBLOCKVOLUMECOMPONENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0B5DA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StreamingBlockVolumeComponentData_TypeDefinitionIndex = 18371;
