...
#define RPG_GAMECORE_PINGPONGENEMYGROUPEVENT_MODIFYENEMYROTATE_METHOD_3_43D5012FE8A65087_OFFSET UNITYSDK_OFFSET(0x18BFAF30)
#define RPG_GAMECORE_PINGPONGENEMYGROUPEVENT_MODIFYENEMYROTATE_METHOD_3_9BD73920681D6195_OFFSET UNITYSDK_OFFSET(0x18BFB4C0)
#define RPG_GAMECORE_PINGPONGENEMYGROUPEVENT_MODIFYENEMYROTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18BFAF20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PingPongEnemyGroupEvent_ModifyEnemyRotate_TypeDefinitionIndex = 16088;
