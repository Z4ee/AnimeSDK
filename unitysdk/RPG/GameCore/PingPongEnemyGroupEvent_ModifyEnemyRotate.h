...
#define RPG_GAMECORE_PINGPONGENEMYGROUPEVENT_MODIFYENEMYROTATE_METHOD_3_43D5012FE8A65087_OFFSET UNITYSDK_OFFSET(0x1B4C7030)
#define RPG_GAMECORE_PINGPONGENEMYGROUPEVENT_MODIFYENEMYROTATE_METHOD_3_9BD73920681D6195_OFFSET UNITYSDK_OFFSET(0x1B4C75D0)
#define RPG_GAMECORE_PINGPONGENEMYGROUPEVENT_MODIFYENEMYROTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4C7020)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PingPongEnemyGroupEvent_ModifyEnemyRotate_TypeDefinitionIndex = 16322;
