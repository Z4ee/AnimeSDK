...
#define RPG_GAMECORE_MONSTERTEXTGUIDECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x199B30F0)
#define RPG_GAMECORE_MONSTERTEXTGUIDECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x199B37D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonsterTextGuideConfigRow_TypeDefinitionIndex = 13538;
