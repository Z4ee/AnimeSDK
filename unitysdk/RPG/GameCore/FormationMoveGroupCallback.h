...
#define RPG_GAMECORE_FORMATIONMOVEGROUPCALLBACK_METHOD_3_18AF65CB4D789D0A_OFFSET UNITYSDK_OFFSET(0x17218790)
#define RPG_GAMECORE_FORMATIONMOVEGROUPCALLBACK_METHOD_3_EE8D7F91F3BF65A3_OFFSET UNITYSDK_OFFSET(0x17218810)
#define RPG_GAMECORE_FORMATIONMOVEGROUPCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x172187E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FormationMoveGroupCallback_TypeDefinitionIndex = 19560;
