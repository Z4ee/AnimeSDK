...
#define RPG_GAMECORE_FORMATIONMOVEGROUPCALLBACK_METHOD_3_10CC7EC0EA5A30F4_OFFSET UNITYSDK_OFFSET(0x1BEC0D80)
#define RPG_GAMECORE_FORMATIONMOVEGROUPCALLBACK_METHOD_3_370B6673F6A0DA59_OFFSET UNITYSDK_OFFSET(0x1BEC0DC0)
#define RPG_GAMECORE_FORMATIONMOVEGROUPCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEC0DB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FormationMoveGroupCallback_TypeDefinitionIndex = 20464;
