...
#define RPG_GAMECORE_LEVELNPCSPAWNCONFIG_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x19873570)
#define RPG_GAMECORE_LEVELNPCSPAWNCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1987D0B0)
#define RPG_GAMECORE_LEVELNPCSPAWNCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19873560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelNPCSpawnConfig_TypeDefinitionIndex = 16422;
