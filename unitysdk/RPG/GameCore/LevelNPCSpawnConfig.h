...
#define RPG_GAMECORE_LEVELNPCSPAWNCONFIG_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1C113D20)
#define RPG_GAMECORE_LEVELNPCSPAWNCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C11DC60)
#define RPG_GAMECORE_LEVELNPCSPAWNCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C113D10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelNPCSpawnConfig_TypeDefinitionIndex = 17076;
