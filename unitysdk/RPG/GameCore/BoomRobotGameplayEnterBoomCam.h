...
#define RPG_GAMECORE_BOOMROBOTGAMEPLAYENTERBOOMCAM_METHOD_3_0CE6A0E1BC8282B2_OFFSET UNITYSDK_OFFSET(0x16FEF690)
#define RPG_GAMECORE_BOOMROBOTGAMEPLAYENTERBOOMCAM_METHOD_3_B024B62639C9D71B_OFFSET UNITYSDK_OFFSET(0x16FEF710)
#define RPG_GAMECORE_BOOMROBOTGAMEPLAYENTERBOOMCAM__CTOR_OFFSET UNITYSDK_OFFSET(0x16FEF6E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BoomRobotGameplayEnterBoomCam_TypeDefinitionIndex = 19488;
