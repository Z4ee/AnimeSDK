...
#define RPG_GAMECORE_BOOMROBOTGAMEPLAYENTERBOOMCAM_METHOD_3_21610A80B0967148_OFFSET UNITYSDK_OFFSET(0x1A406AC0)
#define RPG_GAMECORE_BOOMROBOTGAMEPLAYENTERBOOMCAM_METHOD_3_B024B62639C9D71B_OFFSET UNITYSDK_OFFSET(0x1A406B00)
#define RPG_GAMECORE_BOOMROBOTGAMEPLAYENTERBOOMCAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A406AF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BoomRobotGameplayEnterBoomCam_TypeDefinitionIndex = 20392;
