...
#define RPG_GAMECORE_SERVANTDATACOMPONENT_DISPOSE_OFFSET UNITYSDK_OFFSET(0xAA22500)
#define RPG_GAMECORE_SERVANTDATACOMPONENT_GET_AVATARSERVANTROW_OFFSET UNITYSDK_OFFSET(0xAA22C40)
#define RPG_GAMECORE_SERVANTDATACOMPONENT_GET_CREATEPARAMS_OFFSET UNITYSDK_OFFSET(0xAA22C60)
#define RPG_GAMECORE_SERVANTDATACOMPONENT_GET_HASLIFE_OFFSET UNITYSDK_OFFSET(0xAA22B90)
#define RPG_GAMECORE_SERVANTDATACOMPONENT_GET_SERVANTCONFIG_OFFSET UNITYSDK_OFFSET(0xAA22420)
#define RPG_GAMECORE_SERVANTDATACOMPONENT_GET_SERVANTROWDATA_OFFSET UNITYSDK_OFFSET(0xAA22C30)
#define RPG_GAMECORE_SERVANTDATACOMPONENT_INITBATTLECHARACTERDATA_OFFSET UNITYSDK_OFFSET(0xAA21FF0)
#define RPG_GAMECORE_SERVANTDATACOMPONENT_ONABILITYCHARACTERINITIALIZED_OFFSET UNITYSDK_OFFSET(0xAA22690)
#define RPG_GAMECORE_SERVANTDATACOMPONENT_RESETSERVANTPROPERTY_OFFSET UNITYSDK_OFFSET(0xAA22710)
#define RPG_GAMECORE_SERVANTDATACOMPONENT_SET_ROWDATA_OFFSET UNITYSDK_OFFSET(0xAA22BA0)
#define RPG_GAMECORE_SERVANTDATACOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0xAA22C70)
#define RPG_GAMECORE_SERVANTDATACOMPONENT__INITEVENT_OFFSET UNITYSDK_OFFSET(0xAA22450)
#define RPG_GAMECORE_SERVANTDATACOMPONENT__ISLIFEBINDINGTARGET_OFFSET UNITYSDK_OFFSET(0xAA22A50)
#define RPG_GAMECORE_SERVANTDATACOMPONENT__ONCHARACTERSTAGESTATECHANGE_OFFSET UNITYSDK_OFFSET(0xAA22AE0)
#define RPG_GAMECORE_SERVANTDATACOMPONENT__ONPREABILITYADD_OFFSET UNITYSDK_OFFSET(0xAA229B0)
#define RPG_GAMECORE_SERVANTDATACOMPONENT__UNINITEVENT_OFFSET UNITYSDK_OFFSET(0xAA225E0)
#define RPG_GAMECORE_SERVANTDATACOMPONENT___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xAA22CF0)
#define RPG_GAMECORE_SERVANTDATACOMPONENT___IFIXBASEPROXY_INITBATTLECHARACTERDATA_OFFSET UNITYSDK_OFFSET(0xAA22C80)
#define RPG_GAMECORE_SERVANTDATACOMPONENT___IFIXBASEPROXY_ONABILITYCHARACTERINITIALIZED_OFFSET UNITYSDK_OFFSET(0xAA22D70)
#define RPG_GAMECORE_SERVANTDATACOMPONENT___IFIXBASEPROXY_SET_ROWDATA_OFFSET UNITYSDK_OFFSET(0xAA22DE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ServantDataComponent_TypeDefinitionIndex = 46473;
	...
	public:
		...
		::RPG::GameCore::ServantRowData* _ServantRowData; // 0x110
		::Class_2_897CE1512E86E87A* _CreateParams; // 0x118
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_375*))((::PBYTE)hIl2Cpp + RPG_GAMECORE_SERVANTDATACOMPONENT__ONPREABILITYADD_OFFSET))(this, pEvtRef);
		}
