...
#define RPG_GAMECORE_MIATOMBACKUPPARAMCONFIG_METHOD_2_DA49EC08056FED98_OFFSET UNITYSDK_OFFSET(0x173EC5D0)
#define RPG_GAMECORE_MIATOMBACKUPPARAMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x173EC610)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MiAtomBackupParamConfig_TypeDefinitionIndex = 15621;
