...
#define RPG_GAMECORE_FATEACTADDMASTERHPCONFIG_METHOD_6_5F5327D544AA61E1_OFFSET UNITYSDK_OFFSET(0x1E0CBF60)
#define RPG_GAMECORE_FATEACTADDMASTERHPCONFIG_METHOD_6_BF319DFEE74F5945_OFFSET UNITYSDK_OFFSET(0x1E0CBFB0)
#define RPG_GAMECORE_FATEACTADDMASTERHPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0CBFA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateActAddMasterHpConfig_TypeDefinitionIndex = 18998;
