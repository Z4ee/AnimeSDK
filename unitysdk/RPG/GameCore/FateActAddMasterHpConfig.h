...
#define RPG_GAMECORE_FATEACTADDMASTERHPCONFIG_METHOD_6_A3DAB09ADDB0ACC6_OFFSET UNITYSDK_OFFSET(0x171C0C50)
#define RPG_GAMECORE_FATEACTADDMASTERHPCONFIG_METHOD_6_BF319DFEE74F5945_OFFSET UNITYSDK_OFFSET(0x171C0DC0)
#define RPG_GAMECORE_FATEACTADDMASTERHPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171C0D20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateActAddMasterHpConfig_TypeDefinitionIndex = 17653;
