...
#define RPG_GAMECORE_FATEACTADDMASTERHPCONFIG_METHOD_6_A3DAB09ADDB0ACC6_OFFSET UNITYSDK_OFFSET(0x188CE420)
#define RPG_GAMECORE_FATEACTADDMASTERHPCONFIG_METHOD_6_BF319DFEE74F5945_OFFSET UNITYSDK_OFFSET(0x188CE590)
#define RPG_GAMECORE_FATEACTADDMASTERHPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x188CE4F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateActAddMasterHpConfig_TypeDefinitionIndex = 18266;
