...
#define RPG_GAMECORE_LITTLEGAMELEVELVARIABLE_METHOD_2_688982FF086F6D20_OFFSET UNITYSDK_OFFSET(0x1BCC2C10)
#define RPG_GAMECORE_LITTLEGAMELEVELVARIABLE_METHOD_2_D7B4F51914957431_OFFSET UNITYSDK_OFFSET(0x1BCC3750)
#define RPG_GAMECORE_LITTLEGAMELEVELVARIABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCC3870)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameLevelVariable_TypeDefinitionIndex = 18150;
