...
#define RPG_GAMECORE_MODIFYFATECONTENTPARAM_METHOD_3_18768114BEAE6DDE_OFFSET UNITYSDK_OFFSET(0x18B3DCD0)
#define RPG_GAMECORE_MODIFYFATECONTENTPARAM_METHOD_3_6E997984BB7CC821_OFFSET UNITYSDK_OFFSET(0x18B3DC40)
#define RPG_GAMECORE_MODIFYFATECONTENTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x18B3DCA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyFateContentParam_TypeDefinitionIndex = 22259;
