...
#define RPG_GAMECORE_FIVEDIMPORTALTARGET_METHOD_2_4B9FDFD8AA8B7216_OFFSET UNITYSDK_OFFSET(0x172019D0)
#define RPG_GAMECORE_FIVEDIMPORTALTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x17203970)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimPortalTarget_TypeDefinitionIndex = 17044;
