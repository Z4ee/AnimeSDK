...
#define RPG_GAMECORE_FIVEDIMSPLINEMOVEPOINT_METHOD_2_9362A82156713A28_OFFSET UNITYSDK_OFFSET(0x1BEB46D0)
#define RPG_GAMECORE_FIVEDIMSPLINEMOVEPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEB4870)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSplineMovePoint_TypeDefinitionIndex = 17829;
