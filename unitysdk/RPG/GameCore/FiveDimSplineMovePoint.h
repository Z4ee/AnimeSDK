...
#define RPG_GAMECORE_FIVEDIMSPLINEMOVEPOINT_METHOD_2_9362A82156713A28_OFFSET UNITYSDK_OFFSET(0x1D87CD30)
#define RPG_GAMECORE_FIVEDIMSPLINEMOVEPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D87CED0)
