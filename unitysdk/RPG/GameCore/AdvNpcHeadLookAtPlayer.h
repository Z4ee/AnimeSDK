...
#define RPG_GAMECORE_ADVNPCHEADLOOKATPLAYER_METHOD_3_C1471F4729292102_OFFSET UNITYSDK_OFFSET(0x16F37FA0)
#define RPG_GAMECORE_ADVNPCHEADLOOKATPLAYER_METHOD_3_D0230A1F627BA26B_OFFSET UNITYSDK_OFFSET(0x16F38020)
#define RPG_GAMECORE_ADVNPCHEADLOOKATPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x16F37FF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvNpcHeadLookAtPlayer_TypeDefinitionIndex = 19914;
