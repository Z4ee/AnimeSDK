...
#define RPG_GAMECORE_ADVNPCHEADLOOKATPLAYER_METHOD_3_D0230A1F627BA26B_OFFSET UNITYSDK_OFFSET(0x1BE25310)
#define RPG_GAMECORE_ADVNPCHEADLOOKATPLAYER_METHOD_3_F29074B40C19F3D8_OFFSET UNITYSDK_OFFSET(0x1BE252D0)
#define RPG_GAMECORE_ADVNPCHEADLOOKATPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE25300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvNpcHeadLookAtPlayer_TypeDefinitionIndex = 20943;
