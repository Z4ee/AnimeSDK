...
#define RPG_GAMECORE_AVATARINDEX_EQUALS_OFFSET UNITYSDK_OFFSET(0x3B7A7B0)
#define RPG_GAMECORE_AVATARINDEX_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x7843F0)
#define RPG_GAMECORE_AVATARINDEX_METHOD_2_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0xF390B0)
#define RPG_GAMECORE_AVATARINDEX_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3B94030)
#define RPG_GAMECORE_AVATARINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0x6B4C20)
