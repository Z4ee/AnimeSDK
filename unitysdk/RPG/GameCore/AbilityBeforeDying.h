...
#define RPG_GAMECORE_ABILITYBEFOREDYING_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xE467120)
#define RPG_GAMECORE_ABILITYBEFOREDYING_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xE4670E0)
#define RPG_GAMECORE_ABILITYBEFOREDYING_INIT_OFFSET UNITYSDK_OFFSET(0xE467090)
#define RPG_GAMECORE_ABILITYBEFOREDYING__CTOR_OFFSET UNITYSDK_OFFSET(0xE467170)
