...
#define RPG_GAMECORE_FATEMODIFIERADDREIJUREROLLCOUNTCONFIG_METHOD_3_920370B01FDA8851_OFFSET UNITYSDK_OFFSET(0x19710010)
#define RPG_GAMECORE_FATEMODIFIERADDREIJUREROLLCOUNTCONFIG_METHOD_3_FC14B2F464DA79B8_OFFSET UNITYSDK_OFFSET(0x1970FF40)
#define RPG_GAMECORE_FATEMODIFIERADDREIJUREROLLCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1970FFC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateModifierAddReijuRerollCountConfig_TypeDefinitionIndex = 18281;
