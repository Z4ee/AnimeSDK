...
#define RPG_GAMECORE_FATEMODIFIERADDREIJUREROLLCOUNTCONFIG_METHOD_3_920370B01FDA8851_OFFSET UNITYSDK_OFFSET(0x188D2F40)
#define RPG_GAMECORE_FATEMODIFIERADDREIJUREROLLCOUNTCONFIG_METHOD_3_FC14B2F464DA79B8_OFFSET UNITYSDK_OFFSET(0x188D2E70)
#define RPG_GAMECORE_FATEMODIFIERADDREIJUREROLLCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x188D2EF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateModifierAddReijuRerollCountConfig_TypeDefinitionIndex = 18309;
