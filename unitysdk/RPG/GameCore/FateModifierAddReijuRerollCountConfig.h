...
#define RPG_GAMECORE_FATEMODIFIERADDREIJUREROLLCOUNTCONFIG_METHOD_3_610FDB468D8DE0ED_OFFSET UNITYSDK_OFFSET(0x1E0CD7A0)
#define RPG_GAMECORE_FATEMODIFIERADDREIJUREROLLCOUNTCONFIG_METHOD_3_920370B01FDA8851_OFFSET UNITYSDK_OFFSET(0x1E0CD7F0)
#define RPG_GAMECORE_FATEMODIFIERADDREIJUREROLLCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0CD7E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateModifierAddReijuRerollCountConfig_TypeDefinitionIndex = 19041;
