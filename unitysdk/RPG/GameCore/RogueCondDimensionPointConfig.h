...
#define RPG_GAMECORE_ROGUECONDDIMENSIONPOINTCONFIG_METHOD_6_4191DAEE9273C754_OFFSET UNITYSDK_OFFSET(0x19B1BCD0)
#define RPG_GAMECORE_ROGUECONDDIMENSIONPOINTCONFIG_METHOD_6_4C6A43311E58A71A_OFFSET UNITYSDK_OFFSET(0x19B1BF80)
#define RPG_GAMECORE_ROGUECONDDIMENSIONPOINTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B1BE50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueCondDimensionPointConfig_TypeDefinitionIndex = 18754;
