...
#define RPG_GAMECORE_PLANETFESRAISECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19A21950)
#define RPG_GAMECORE_PLANETFESRAISECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19A21A90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlanetFesRaiseConfigRow_TypeDefinitionIndex = 11676;
