...
#define RPG_GAMECORE_IDLELIVEQUESTROUNDICONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19845DC0)
#define RPG_GAMECORE_IDLELIVEQUESTROUNDICONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19845EF0)
