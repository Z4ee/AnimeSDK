...
#define RPG_GAMECORE_CURVEPROPGROUPPUZZLEFINISHLISTENER_METHOD_3_2A2C8B9FBAAEF828_OFFSET UNITYSDK_OFFSET(0x18847810)
#define RPG_GAMECORE_CURVEPROPGROUPPUZZLEFINISHLISTENER_METHOD_3_F7C41823419043C1_OFFSET UNITYSDK_OFFSET(0x18847790)
#define RPG_GAMECORE_CURVEPROPGROUPPUZZLEFINISHLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x188477E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CurvePropGroupPuzzleFinishListener_TypeDefinitionIndex = 21131;
