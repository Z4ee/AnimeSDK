...
#define RPG_GAMECORE_FIVEDIMMAPSURFACEDEFINITIONCONFIG_METHOD_2_79AB125D8B5184E8_OFFSET UNITYSDK_OFFSET(0x1890AEE0)
#define RPG_GAMECORE_FIVEDIMMAPSURFACEDEFINITIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1890AF20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimMapSurfaceDefinitionConfig_TypeDefinitionIndex = 17588;
