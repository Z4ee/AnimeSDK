...
#define RPG_GAMECORE_ROGUEACTPERSONAOWNERROOMCARDCASTREMOVEOWNERATTRIBUTECONFIG_METHOD_7_723B6442DFADE59B_OFFSET UNITYSDK_OFFSET(0x175BE050)
#define RPG_GAMECORE_ROGUEACTPERSONAOWNERROOMCARDCASTREMOVEOWNERATTRIBUTECONFIG_METHOD_7_A6068A15B5797BAE_OFFSET UNITYSDK_OFFSET(0x175BE610)
#define RPG_GAMECORE_ROGUEACTPERSONAOWNERROOMCARDCASTREMOVEOWNERATTRIBUTECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175BDF70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaOwnerRoomCardCastRemoveOwnerAttributeConfig_TypeDefinitionIndex = 18111;
