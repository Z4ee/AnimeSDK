...
#define RPG_GAMECORE_ROGUEACTPERSONAOWNERROOMCARDCASTREMOVEOWNERATTRIBUTECONFIG_METHOD_7_723B6442DFADE59B_OFFSET UNITYSDK_OFFSET(0x1D02F680)
#define RPG_GAMECORE_ROGUEACTPERSONAOWNERROOMCARDCASTREMOVEOWNERATTRIBUTECONFIG_METHOD_7_F7C745317E54F837_OFFSET UNITYSDK_OFFSET(0x1D02F7A0)
#define RPG_GAMECORE_ROGUEACTPERSONAOWNERROOMCARDCASTREMOVEOWNERATTRIBUTECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D02F670)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaOwnerRoomCardCastRemoveOwnerAttributeConfig_TypeDefinitionIndex = 18999;
