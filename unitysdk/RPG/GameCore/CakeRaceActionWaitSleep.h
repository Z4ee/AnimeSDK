...
#define RPG_GAMECORE_CAKERACEACTIONWAITSLEEP_METHOD_3_35035B103A57B7A6_OFFSET UNITYSDK_OFFSET(0x1B2CCD80)
#define RPG_GAMECORE_CAKERACEACTIONWAITSLEEP_METHOD_3_5A4E78D65011ACE6_OFFSET UNITYSDK_OFFSET(0x1B2CCD20)
#define RPG_GAMECORE_CAKERACEACTIONWAITSLEEP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2CCD70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionWaitSleep_TypeDefinitionIndex = 17617;
