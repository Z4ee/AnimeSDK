...
#define RPG_GAMECORE_FINISHACTIONCONFIG_METHOD_2_BA4AB032F01B3ABE_OFFSET UNITYSDK_OFFSET(0x1BA81400)
#define RPG_GAMECORE_FINISHACTIONCONFIG_METHOD_2_CD7DBDD509ADD030_OFFSET UNITYSDK_OFFSET(0x1BA81590)
#define RPG_GAMECORE_FINISHACTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA81580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FinishActionConfig_TypeDefinitionIndex = 18266;
