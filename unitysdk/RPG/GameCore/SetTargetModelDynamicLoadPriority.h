...
#define RPG_GAMECORE_SETTARGETMODELDYNAMICLOADPRIORITY_METHOD_3_0B659CC3BCE64D62_OFFSET UNITYSDK_OFFSET(0x18E45C90)
#define RPG_GAMECORE_SETTARGETMODELDYNAMICLOADPRIORITY_METHOD_3_BD63B536175EDB71_OFFSET UNITYSDK_OFFSET(0x18E45D10)
#define RPG_GAMECORE_SETTARGETMODELDYNAMICLOADPRIORITY__CTOR_OFFSET UNITYSDK_OFFSET(0x18E45CE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetTargetModelDynamicLoadPriority_TypeDefinitionIndex = 21903;
