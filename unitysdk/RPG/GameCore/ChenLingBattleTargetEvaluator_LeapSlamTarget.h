...
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_LEAPSLAMTARGET_METHOD_3_86376D488D8DD5BD_OFFSET UNITYSDK_OFFSET(0x1E00F6F0)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_LEAPSLAMTARGET_METHOD_3_B5CC814241005665_OFFSET UNITYSDK_OFFSET(0x1E00F690)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_LEAPSLAMTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1E00F6E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleTargetEvaluator_LeapSlamTarget_TypeDefinitionIndex = 15602;
