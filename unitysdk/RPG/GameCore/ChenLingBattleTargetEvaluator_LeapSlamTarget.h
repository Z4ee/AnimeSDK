...
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_LEAPSLAMTARGET_METHOD_3_86376D488D8DD5BD_OFFSET UNITYSDK_OFFSET(0x187E6DD0)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_LEAPSLAMTARGET_METHOD_3_B5CC814241005665_OFFSET UNITYSDK_OFFSET(0x187E6D70)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_LEAPSLAMTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x187E6DC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleTargetEvaluator_LeapSlamTarget_TypeDefinitionIndex = 14938;
