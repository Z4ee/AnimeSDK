...
#define RPG_GAMECORE_FIELDEFFECTADAPTIONCONFIG_METHOD_2_CF89422EEF640C75_OFFSET UNITYSDK_OFFSET(0x1E0D2E80)
#define RPG_GAMECORE_FIELDEFFECTADAPTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0D2FE0)
