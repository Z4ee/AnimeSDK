...
#define RPG_GAMECORE_TUTORIALGUIDEHINTADAPTCONFIG_METHOD_2_137099894272D18B_OFFSET UNITYSDK_OFFSET(0x1D2A6270)
#define RPG_GAMECORE_TUTORIALGUIDEHINTADAPTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2A63F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TutorialGuideHintAdaptConfig_TypeDefinitionIndex = 24115;
