...
#define RPG_GAMECORE_ROGUETOURNENTRANCESHOWUI_METHOD_3_69C89C12D29C0E41_OFFSET UNITYSDK_OFFSET(0x1E5537E0)
#define RPG_GAMECORE_ROGUETOURNENTRANCESHOWUI_METHOD_3_88B4ADEB2BD3E6C4_OFFSET UNITYSDK_OFFSET(0x1E5538B0)
#define RPG_GAMECORE_ROGUETOURNENTRANCESHOWUI__CTOR_OFFSET UNITYSDK_OFFSET(0x1E5538A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournEntranceShowUI_TypeDefinitionIndex = 21849;
