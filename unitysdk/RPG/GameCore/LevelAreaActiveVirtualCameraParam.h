...
#define RPG_GAMECORE_LEVELAREAACTIVEVIRTUALCAMERAPARAM_RESET_OFFSET UNITYSDK_OFFSET(0xB6C5020)
#define RPG_GAMECORE_LEVELAREAACTIVEVIRTUALCAMERAPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xB6C5080)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelAreaActiveVirtualCameraParam_TypeDefinitionIndex = 53332;
	...
	public:
		...
		::System::Boolean LookAtLocalPlayer; // 0x18
		::System::Boolean KeepVCamNearClipPlane; // 0x19
