...
#define RPG_GAMECORE_SWITCHCASEBYDYNAMICVALUE_METHOD_3_321F7518A773B81E_OFFSET UNITYSDK_OFFSET(0x17792990)
#define RPG_GAMECORE_SWITCHCASEBYDYNAMICVALUE_METHOD_3_713B8CEE03D928A8_OFFSET UNITYSDK_OFFSET(0x177928F0)
#define RPG_GAMECORE_SWITCHCASEBYDYNAMICVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x17792950)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchCaseByDynamicValue_TypeDefinitionIndex = 22045;
