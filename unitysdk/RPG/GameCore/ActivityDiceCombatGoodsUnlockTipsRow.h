...
#define RPG_GAMECORE_ACTIVITYDICECOMBATGOODSUNLOCKTIPSROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C9F32B0)
#define RPG_GAMECORE_ACTIVITYDICECOMBATGOODSUNLOCKTIPSROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9F3430)
