...
#define RPG_GAMECORE_ACTIVITYDICECOMBATGOODSUNLOCKTIPSROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CD7D6B0)
#define RPG_GAMECORE_ACTIVITYDICECOMBATGOODSUNLOCKTIPSROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD7D830)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityDiceCombatGoodsUnlockTipsRow_TypeDefinitionIndex = 11233;
