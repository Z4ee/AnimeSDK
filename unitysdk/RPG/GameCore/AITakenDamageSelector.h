...
#define RPG_GAMECORE_AITAKENDAMAGESELECTOR_METHOD_3_807850A358715380_OFFSET UNITYSDK_OFFSET(0x1B9F6490)
#define RPG_GAMECORE_AITAKENDAMAGESELECTOR_METHOD_3_CB16FD9557B17117_OFFSET UNITYSDK_OFFSET(0x1B9F5B10)
#define RPG_GAMECORE_AITAKENDAMAGESELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9F5B00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AITakenDamageSelector_TypeDefinitionIndex = 14992;
