...
#define RPG_GAMECORE_CONSTRUCTBODYPART_METHOD_3_6CEB49911DA8D837_OFFSET UNITYSDK_OFFSET(0x1BC31D30)
#define RPG_GAMECORE_CONSTRUCTBODYPART_METHOD_3_8C6756B82D0014BA_OFFSET UNITYSDK_OFFSET(0x1BC31CD0)
#define RPG_GAMECORE_CONSTRUCTBODYPART__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC31D10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConstructBodyPart_TypeDefinitionIndex = 21880;
