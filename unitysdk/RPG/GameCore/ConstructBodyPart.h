...
#define RPG_GAMECORE_CONSTRUCTBODYPART_METHOD_3_308E3119A8D302C9_OFFSET UNITYSDK_OFFSET(0x17132FD0)
#define RPG_GAMECORE_CONSTRUCTBODYPART_METHOD_3_6CEB49911DA8D837_OFFSET UNITYSDK_OFFSET(0x17133070)
#define RPG_GAMECORE_CONSTRUCTBODYPART__CTOR_OFFSET UNITYSDK_OFFSET(0x17133030)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConstructBodyPart_TypeDefinitionIndex = 20886;
