...
#define RPG_GAMECORE_PROPPUZZLEEVENTSENDER_METHOD_3_4D25964ACACE3775_OFFSET UNITYSDK_OFFSET(0x17522BC0)
#define RPG_GAMECORE_PROPPUZZLEEVENTSENDER_METHOD_3_B56A0DD98AE22F26_OFFSET UNITYSDK_OFFSET(0x17522B40)
#define RPG_GAMECORE_PROPPUZZLEEVENTSENDER__CTOR_OFFSET UNITYSDK_OFFSET(0x17522B90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropPuzzleEventSender_TypeDefinitionIndex = 19744;
