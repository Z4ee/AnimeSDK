...
#define RPG_GAMECORE_PROPPUZZLEEVENTSENDER_METHOD_3_4D25964ACACE3775_OFFSET UNITYSDK_OFFSET(0x19A94970)
#define RPG_GAMECORE_PROPPUZZLEEVENTSENDER_METHOD_3_B56A0DD98AE22F26_OFFSET UNITYSDK_OFFSET(0x19A948F0)
#define RPG_GAMECORE_PROPPUZZLEEVENTSENDER__CTOR_OFFSET UNITYSDK_OFFSET(0x19A94940)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropPuzzleEventSender_TypeDefinitionIndex = 20367;
