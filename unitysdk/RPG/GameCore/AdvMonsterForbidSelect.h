...
#define RPG_GAMECORE_ADVMONSTERFORBIDSELECT_METHOD_3_2826DDAAFAC35CCD_OFFSET UNITYSDK_OFFSET(0x16F33C00)
#define RPG_GAMECORE_ADVMONSTERFORBIDSELECT_METHOD_3_8F7844DD5FBF4FE1_OFFSET UNITYSDK_OFFSET(0x16F33C80)
#define RPG_GAMECORE_ADVMONSTERFORBIDSELECT__CTOR_OFFSET UNITYSDK_OFFSET(0x16F33C50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvMonsterForbidSelect_TypeDefinitionIndex = 19975;
