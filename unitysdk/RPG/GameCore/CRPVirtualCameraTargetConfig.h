...
#define RPG_GAMECORE_CRPVIRTUALCAMERATARGETCONFIG_METHOD_2_44A12B82E7D13EE4_OFFSET UNITYSDK_OFFSET(0x1B2C70B0)
#define RPG_GAMECORE_CRPVIRTUALCAMERATARGETCONFIG_METHOD_2_F70FCBEA5B35EFC2_OFFSET UNITYSDK_OFFSET(0x1B2C6E80)
#define RPG_GAMECORE_CRPVIRTUALCAMERATARGETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2C70A0)
