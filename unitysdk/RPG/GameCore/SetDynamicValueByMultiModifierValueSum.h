...
#define RPG_GAMECORE_SETDYNAMICVALUEBYMULTIMODIFIERVALUESUM_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x19C42930)
#define RPG_GAMECORE_SETDYNAMICVALUEBYMULTIMODIFIERVALUESUM_METHOD_4_62AB6AE478816282_OFFSET UNITYSDK_OFFSET(0x19C3CEE0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYMULTIMODIFIERVALUESUM_METHOD_4_A722DB70554466F9_OFFSET UNITYSDK_OFFSET(0x19C42890)
#define RPG_GAMECORE_SETDYNAMICVALUEBYMULTIMODIFIERVALUESUM__CTOR_OFFSET UNITYSDK_OFFSET(0x19C3CE60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByMultiModifierValueSum_TypeDefinitionIndex = 22291;
