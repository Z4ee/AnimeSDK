...
#define RPG_GAMECORE_STOPWINDOWSTAGE_METHOD_3_0141049C4E853747_OFFSET UNITYSDK_OFFSET(0x1CAFE500)
#define RPG_GAMECORE_STOPWINDOWSTAGE_METHOD_3_24527129CDD6508C_OFFSET UNITYSDK_OFFSET(0x1CAFE540)
#define RPG_GAMECORE_STOPWINDOWSTAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CAFE530)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StopWindowStage_TypeDefinitionIndex = 21040;
