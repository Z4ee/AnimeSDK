...
#define RPG_GAMECORE_HELIOBUSPHASEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x172A0A50)
#define RPG_GAMECORE_HELIOBUSPHASEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x172A1340)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID Heliobus_UpMissionDesc; // 0x20
		...
		::System::UInt32 PhaseFans; // 0x60
		::System::UInt32 UnlockMissionID; // 0x64
		::System::UInt32 HeliobusPhaseID; // 0x68
		::System::UInt32 ReceiveMissionID; // 0x6C
