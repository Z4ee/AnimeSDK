...
#define RPG_GAMECORE_NAMEDLEVELOBJECTINFO_METHOD_3_380C7B02C85DEF89_OFFSET UNITYSDK_OFFSET(0x1BAF3070)
#define RPG_GAMECORE_NAMEDLEVELOBJECTINFO_METHOD_3_D91781AC58D8D5D0_OFFSET UNITYSDK_OFFSET(0x1BAF3940)
#define RPG_GAMECORE_NAMEDLEVELOBJECTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAF3930)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NamedLevelObjectInfo_TypeDefinitionIndex = 16554;
