...
#define RPG_GAMECORE_NAMEDLEVELOBJECTINFO_METHOD_3_380C7B02C85DEF89_OFFSET UNITYSDK_OFFSET(0x1746DCA0)
#define RPG_GAMECORE_NAMEDLEVELOBJECTINFO_METHOD_3_D91781AC58D8D5D0_OFFSET UNITYSDK_OFFSET(0x1746E530)
#define RPG_GAMECORE_NAMEDLEVELOBJECTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1746E520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NamedLevelObjectInfo_TypeDefinitionIndex = 15834;
