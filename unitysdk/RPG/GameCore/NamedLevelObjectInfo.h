...
#define RPG_GAMECORE_NAMEDLEVELOBJECTINFO_METHOD_3_380C7B02C85DEF89_OFFSET UNITYSDK_OFFSET(0x199C96D0)
#define RPG_GAMECORE_NAMEDLEVELOBJECTINFO_METHOD_3_D91781AC58D8D5D0_OFFSET UNITYSDK_OFFSET(0x199C9FA0)
#define RPG_GAMECORE_NAMEDLEVELOBJECTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x199C9F90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NamedLevelObjectInfo_TypeDefinitionIndex = 16392;
