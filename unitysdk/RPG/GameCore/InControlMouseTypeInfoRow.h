...
#define RPG_GAMECORE_INCONTROLMOUSETYPEINFOROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B00D840)
#define RPG_GAMECORE_INCONTROLMOUSETYPEINFOROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B00DE20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int InControlMouseTypeInfoRow_TypeDefinitionIndex = 13321;
