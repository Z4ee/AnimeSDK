...
#define RPG_GAMECORE_INCONTROLMOUSETYPEINFOROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1984D340)
#define RPG_GAMECORE_INCONTROLMOUSETYPEINFOROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1984D920)

namespace RPG::GameCore
{
	inline static constexpr unsigned int InControlMouseTypeInfoRow_TypeDefinitionIndex = 13173;
