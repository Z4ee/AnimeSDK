...
#define RPG_GAMECORE_ADVSETLOOPHITFEATUREPARAM_METHOD_3_3E843A5DC6F3EA67_OFFSET UNITYSDK_OFFSET(0x1CDDA2D0)
#define RPG_GAMECORE_ADVSETLOOPHITFEATUREPARAM_METHOD_3_57433113977ACC7F_OFFSET UNITYSDK_OFFSET(0x1CDDA310)
#define RPG_GAMECORE_ADVSETLOOPHITFEATUREPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDDA300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSetLoopHitFeatureParam_TypeDefinitionIndex = 21568;
