...
#define RPG_GAMECORE_ADVSETLOOPHITFEATUREPARAM_METHOD_3_57433113977ACC7F_OFFSET UNITYSDK_OFFSET(0x18663560)
#define RPG_GAMECORE_ADVSETLOOPHITFEATUREPARAM_METHOD_3_712674993A71D23B_OFFSET UNITYSDK_OFFSET(0x186634E0)
#define RPG_GAMECORE_ADVSETLOOPHITFEATUREPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x18663530)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSetLoopHitFeatureParam_TypeDefinitionIndex = 20663;
