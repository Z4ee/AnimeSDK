...
#define RPG_GAMECORE_MAZEBUFFTOASTCONFIGLOOKUP_METHOD_2_9D8F1DBCD45673B0_OFFSET UNITYSDK_OFFSET(0x1D258100)
#define RPG_GAMECORE_MAZEBUFFTOASTCONFIGLOOKUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2581C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MazeBuffToastConfigLookup_TypeDefinitionIndex = 17423;
