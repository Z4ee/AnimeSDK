...
#define RPG_GAMECORE_TRAVELSHIPHIDEUI_METHOD_3_CCB6A3C1686A92DE_OFFSET UNITYSDK_OFFSET(0x190B5D00)
#define RPG_GAMECORE_TRAVELSHIPHIDEUI_METHOD_3_EA05B305363A18AF_OFFSET UNITYSDK_OFFSET(0x190B5C80)
#define RPG_GAMECORE_TRAVELSHIPHIDEUI__CTOR_OFFSET UNITYSDK_OFFSET(0x190B5CD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TravelShipHideUI_TypeDefinitionIndex = 19968;
