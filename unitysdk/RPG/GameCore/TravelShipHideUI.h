...
#define RPG_GAMECORE_TRAVELSHIPHIDEUI_METHOD_3_CCB6A3C1686A92DE_OFFSET UNITYSDK_OFFSET(0x19E00B20)
#define RPG_GAMECORE_TRAVELSHIPHIDEUI_METHOD_3_EA05B305363A18AF_OFFSET UNITYSDK_OFFSET(0x19E00AA0)
#define RPG_GAMECORE_TRAVELSHIPHIDEUI__CTOR_OFFSET UNITYSDK_OFFSET(0x19E00AF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TravelShipHideUI_TypeDefinitionIndex = 19831;
