...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERUSEORBCONFIG_METHOD_3_563CD751B347F5DA_OFFSET UNITYSDK_OFFSET(0x189BC540)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERUSEORBCONFIG_METHOD_3_9378F86AD5093393_OFFSET UNITYSDK_OFFSET(0x189BC610)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERUSEORBCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189BC5C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierExecActionAfterUseOrbConfig_TypeDefinitionIndex = 18486;
