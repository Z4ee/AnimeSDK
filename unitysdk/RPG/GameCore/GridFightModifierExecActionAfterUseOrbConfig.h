...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERUSEORBCONFIG_METHOD_3_9378F86AD5093393_OFFSET UNITYSDK_OFFSET(0x1D159510)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERUSEORBCONFIG_METHOD_3_F7828B5057AF5ACF_OFFSET UNITYSDK_OFFSET(0x1D1594C0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERUSEORBCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D159500)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierExecActionAfterUseOrbConfig_TypeDefinitionIndex = 19232;
