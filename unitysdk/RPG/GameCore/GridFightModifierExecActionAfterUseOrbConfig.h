...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERUSEORBCONFIG_METHOD_3_563CD751B347F5DA_OFFSET UNITYSDK_OFFSET(0x1726AA70)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERUSEORBCONFIG_METHOD_3_9378F86AD5093393_OFFSET UNITYSDK_OFFSET(0x17266D80)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERUSEORBCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17266D30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierExecActionAfterUseOrbConfig_TypeDefinitionIndex = 17863;
