...
#define RPG_GAMECORE_REFRESHALLTUTORIALNODE_METHOD_3_2ED74DD05038CA6B_OFFSET UNITYSDK_OFFSET(0x17588830)
#define RPG_GAMECORE_REFRESHALLTUTORIALNODE_METHOD_3_DC86820D1181BBDF_OFFSET UNITYSDK_OFFSET(0x17588940)
#define RPG_GAMECORE_REFRESHALLTUTORIALNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x17588910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RefreshAllTutorialNode_TypeDefinitionIndex = 22375;
