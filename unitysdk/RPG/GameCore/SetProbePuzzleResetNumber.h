...
#define RPG_GAMECORE_SETPROBEPUZZLERESETNUMBER_METHOD_3_0794DFF2A1E87725_OFFSET UNITYSDK_OFFSET(0x1C6058A0)
#define RPG_GAMECORE_SETPROBEPUZZLERESETNUMBER_METHOD_3_91B8BB197E5CD886_OFFSET UNITYSDK_OFFSET(0x1C605860)
#define RPG_GAMECORE_SETPROBEPUZZLERESETNUMBER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C605890)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetProbePuzzleResetNumber_TypeDefinitionIndex = 21209;
