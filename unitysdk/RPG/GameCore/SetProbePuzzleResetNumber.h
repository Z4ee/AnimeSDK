...
#define RPG_GAMECORE_SETPROBEPUZZLERESETNUMBER_METHOD_3_0794DFF2A1E87725_OFFSET UNITYSDK_OFFSET(0x176DB7C0)
#define RPG_GAMECORE_SETPROBEPUZZLERESETNUMBER_METHOD_3_E20E7A178FC4FB23_OFFSET UNITYSDK_OFFSET(0x176DB740)
#define RPG_GAMECORE_SETPROBEPUZZLERESETNUMBER__CTOR_OFFSET UNITYSDK_OFFSET(0x176DB790)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetProbePuzzleResetNumber_TypeDefinitionIndex = 20193;
