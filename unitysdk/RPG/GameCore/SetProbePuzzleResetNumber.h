...
#define RPG_GAMECORE_SETPROBEPUZZLERESETNUMBER_METHOD_3_0794DFF2A1E87725_OFFSET UNITYSDK_OFFSET(0x19C5BA40)
#define RPG_GAMECORE_SETPROBEPUZZLERESETNUMBER_METHOD_3_E20E7A178FC4FB23_OFFSET UNITYSDK_OFFSET(0x19C5B9C0)
#define RPG_GAMECORE_SETPROBEPUZZLERESETNUMBER__CTOR_OFFSET UNITYSDK_OFFSET(0x19C5BA10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetProbePuzzleResetNumber_TypeDefinitionIndex = 20794;
