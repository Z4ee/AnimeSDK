...
#define RPG_GAMECORE_PUNKLORDRARECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B9A84B0)
#define RPG_GAMECORE_PUNKLORDRARECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9A8630)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PunkLordRareConfigRow_TypeDefinitionIndex = 11831;
