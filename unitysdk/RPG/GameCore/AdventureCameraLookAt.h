...
#define RPG_GAMECORE_ADVENTURECAMERALOOKAT_METHOD_4_07A653F13457A58E_OFFSET UNITYSDK_OFFSET(0x18671DE0)
#define RPG_GAMECORE_ADVENTURECAMERALOOKAT_METHOD_4_F654B9D118832DD9_OFFSET UNITYSDK_OFFSET(0x18671D40)
#define RPG_GAMECORE_ADVENTURECAMERALOOKAT__CTOR_OFFSET UNITYSDK_OFFSET(0x18671DA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureCameraLookAt_TypeDefinitionIndex = 19465;
