...
#define RPG_GAMECORE_CHENLINGFESTAGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1E0177F0)
#define RPG_GAMECORE_CHENLINGFESTAGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0179C0)
