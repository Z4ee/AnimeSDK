...
#define RPG_GAMECORE_SETDYNAMICVALUEBYELATIONTIMESKILLCOUNT_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x176C10A0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYELATIONTIMESKILLCOUNT_METHOD_4_AB7B466C90B9FA2C_OFFSET UNITYSDK_OFFSET(0x176C1020)
#define RPG_GAMECORE_SETDYNAMICVALUEBYELATIONTIMESKILLCOUNT_METHOD_4_FC256F2E9E0A7CA9_OFFSET UNITYSDK_OFFSET(0x176BA530)
#define RPG_GAMECORE_SETDYNAMICVALUEBYELATIONTIMESKILLCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x176BA4E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByElationTimeSkillCount_TypeDefinitionIndex = 20798;
