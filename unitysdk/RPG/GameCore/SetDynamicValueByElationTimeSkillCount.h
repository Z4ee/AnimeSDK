...
#define RPG_GAMECORE_SETDYNAMICVALUEBYELATIONTIMESKILLCOUNT_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x18E1FE60)
#define RPG_GAMECORE_SETDYNAMICVALUEBYELATIONTIMESKILLCOUNT_METHOD_4_AB7B466C90B9FA2C_OFFSET UNITYSDK_OFFSET(0x18E1FC20)
#define RPG_GAMECORE_SETDYNAMICVALUEBYELATIONTIMESKILLCOUNT_METHOD_4_FC256F2E9E0A7CA9_OFFSET UNITYSDK_OFFSET(0x18E1FCF0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYELATIONTIMESKILLCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x18E1FCA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByElationTimeSkillCount_TypeDefinitionIndex = 21505;
