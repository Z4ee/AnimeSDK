...
#define RPG_GAMECORE_FATEMODIFIERADDTRAITCOUNTBYLINEUPAVATARCONFIG_METHOD_3_6B827B61F0BB1062_OFFSET UNITYSDK_OFFSET(0x197101E0)
#define RPG_GAMECORE_FATEMODIFIERADDTRAITCOUNTBYLINEUPAVATARCONFIG_METHOD_3_FD18768773F2467B_OFFSET UNITYSDK_OFFSET(0x197102B0)
#define RPG_GAMECORE_FATEMODIFIERADDTRAITCOUNTBYLINEUPAVATARCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19710260)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateModifierAddTraitCountByLineupAvatarConfig_TypeDefinitionIndex = 18294;
