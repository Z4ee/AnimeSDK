...
#define RPG_GAMECORE_FATEMODIFIERADDTRAITCOUNTBYLINEUPAVATARCONFIG_METHOD_3_6B827B61F0BB1062_OFFSET UNITYSDK_OFFSET(0x171C5940)
#define RPG_GAMECORE_FATEMODIFIERADDTRAITCOUNTBYLINEUPAVATARCONFIG_METHOD_3_FD18768773F2467B_OFFSET UNITYSDK_OFFSET(0x171C5A10)
#define RPG_GAMECORE_FATEMODIFIERADDTRAITCOUNTBYLINEUPAVATARCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171C59C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateModifierAddTraitCountByLineupAvatarConfig_TypeDefinitionIndex = 17709;
