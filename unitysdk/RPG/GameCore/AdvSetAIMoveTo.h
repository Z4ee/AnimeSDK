...
#define RPG_GAMECORE_ADVSETAIMOVETO_METHOD_3_0EC027BCFBEBBEEB_OFFSET UNITYSDK_OFFSET(0x1CDD8B10)
#define RPG_GAMECORE_ADVSETAIMOVETO_METHOD_3_6D7531C53DA2368A_OFFSET UNITYSDK_OFFSET(0x1CDD8B60)
#define RPG_GAMECORE_ADVSETAIMOVETO__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDD8B50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSetAIMoveTo_TypeDefinitionIndex = 21951;
