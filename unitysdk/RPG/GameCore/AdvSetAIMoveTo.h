...
#define RPG_GAMECORE_ADVSETAIMOVETO_METHOD_3_0EC027BCFBEBBEEB_OFFSET UNITYSDK_OFFSET(0x18661AB0)
#define RPG_GAMECORE_ADVSETAIMOVETO_METHOD_3_B7A004F1CB05CD21_OFFSET UNITYSDK_OFFSET(0x18661B40)
#define RPG_GAMECORE_ADVSETAIMOVETO__CTOR_OFFSET UNITYSDK_OFFSET(0x18661B10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSetAIMoveTo_TypeDefinitionIndex = 21068;
