...
#define RPG_GAMECORE_MODIFIERDESTROYTEXTINFO_METHOD_2_139511CE81B3AB53_OFFSET UNITYSDK_OFFSET(0x1D2ABED0)
#define RPG_GAMECORE_MODIFIERDESTROYTEXTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2AC0A0)
