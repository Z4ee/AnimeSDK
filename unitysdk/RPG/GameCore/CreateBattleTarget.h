...
#define RPG_GAMECORE_CREATEBATTLETARGET_METHOD_3_847C54109A37DF66_OFFSET UNITYSDK_OFFSET(0x18842570)
#define RPG_GAMECORE_CREATEBATTLETARGET_METHOD_3_CE8740B6AD3BED22_OFFSET UNITYSDK_OFFSET(0x188425F0)
#define RPG_GAMECORE_CREATEBATTLETARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x188425C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CreateBattleTarget_TypeDefinitionIndex = 22137;
