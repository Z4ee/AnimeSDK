...
#define RPG_GAMECORE_FINISHROGUEAEONTALK_METHOD_3_14626B99F3DE0749_OFFSET UNITYSDK_OFFSET(0x188E5980)
#define RPG_GAMECORE_FINISHROGUEAEONTALK_METHOD_3_8E3A8FC49C30B43D_OFFSET UNITYSDK_OFFSET(0x188E5A90)
#define RPG_GAMECORE_FINISHROGUEAEONTALK__CTOR_OFFSET UNITYSDK_OFFSET(0x188E5A60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FinishRogueAeonTalk_TypeDefinitionIndex = 20762;
