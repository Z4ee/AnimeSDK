...
#define RPG_GAMECORE_FINISHROGUEAEONTALK_METHOD_3_8E3A8FC49C30B43D_OFFSET UNITYSDK_OFFSET(0x1BA824B0)
#define RPG_GAMECORE_FINISHROGUEAEONTALK_METHOD_3_E6CF86EE2BAADD80_OFFSET UNITYSDK_OFFSET(0x1BA823E0)
#define RPG_GAMECORE_FINISHROGUEAEONTALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA824A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FinishRogueAeonTalk_TypeDefinitionIndex = 21105;
