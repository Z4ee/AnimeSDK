...
#define RPG_GAMECORE_CHIMERADUELSAVEDENTITIESSELECTORCONFIG_METHOD_3_1FCD3A050384B36D_OFFSET UNITYSDK_OFFSET(0x196462F0)
#define RPG_GAMECORE_CHIMERADUELSAVEDENTITIESSELECTORCONFIG_METHOD_3_409D0E93EF1AFDF9_OFFSET UNITYSDK_OFFSET(0x19646210)
#define RPG_GAMECORE_CHIMERADUELSAVEDENTITIESSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x196462E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelSavedEntitiesSelectorConfig_TypeDefinitionIndex = 15128;
