...
#define RPG_GAMECORE_CHIMERADUELSAVEDENTITIESSELECTORCONFIG_METHOD_3_1FCD3A050384B36D_OFFSET UNITYSDK_OFFSET(0x1C247750)
#define RPG_GAMECORE_CHIMERADUELSAVEDENTITIESSELECTORCONFIG_METHOD_3_409D0E93EF1AFDF9_OFFSET UNITYSDK_OFFSET(0x1C247670)
#define RPG_GAMECORE_CHIMERADUELSAVEDENTITIESSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C247740)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelSavedEntitiesSelectorConfig_TypeDefinitionIndex = 15292;
