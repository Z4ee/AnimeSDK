...
#define RPG_GAMECORE_FIVEDIMADDDELAYEDSEQUENCEACTION_METHOD_3_C98F0F4138BCC812_OFFSET UNITYSDK_OFFSET(0x188E9E00)
#define RPG_GAMECORE_FIVEDIMADDDELAYEDSEQUENCEACTION_METHOD_3_E9F4416AD84FC045_OFFSET UNITYSDK_OFFSET(0x188E9D60)
#define RPG_GAMECORE_FIVEDIMADDDELAYEDSEQUENCEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x188E9DC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimAddDelayedSequenceAction_TypeDefinitionIndex = 17758;
