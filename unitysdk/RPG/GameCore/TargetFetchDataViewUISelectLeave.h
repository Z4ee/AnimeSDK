...
#define RPG_GAMECORE_TARGETFETCHDATAVIEWUISELECTLEAVE_METHOD_4_95F94F6E5A6202C4_OFFSET UNITYSDK_OFFSET(0x177B4CB0)
#define RPG_GAMECORE_TARGETFETCHDATAVIEWUISELECTLEAVE_METHOD_4_B14E66FDC1D4AE06_OFFSET UNITYSDK_OFFSET(0x177BE500)
#define RPG_GAMECORE_TARGETFETCHDATAVIEWUISELECTLEAVE__CTOR_OFFSET UNITYSDK_OFFSET(0x177B4C60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchDataViewUISelectLeave_TypeDefinitionIndex = 22238;
