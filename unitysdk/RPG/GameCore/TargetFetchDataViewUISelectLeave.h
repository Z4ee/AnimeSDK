...
#define RPG_GAMECORE_TARGETFETCHDATAVIEWUISELECTLEAVE_METHOD_4_2E71548444E0FB04_OFFSET UNITYSDK_OFFSET(0x1D5AAD50)
#define RPG_GAMECORE_TARGETFETCHDATAVIEWUISELECTLEAVE_METHOD_4_8CF08C86B50E0671_OFFSET UNITYSDK_OFFSET(0x1D5AAD30)
#define RPG_GAMECORE_TARGETFETCHDATAVIEWUISELECTLEAVE_METHOD_4_95F94F6E5A6202C4_OFFSET UNITYSDK_OFFSET(0x1D5AACD0)
#define RPG_GAMECORE_TARGETFETCHDATAVIEWUISELECTLEAVE_METHOD_4_FEC2B752BA0E6D99_OFFSET UNITYSDK_OFFSET(0x1D5AAC50)
#define RPG_GAMECORE_TARGETFETCHDATAVIEWUISELECTLEAVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5AACC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchDataViewUISelectLeave_TypeDefinitionIndex = 23686;
