...
#define RPG_GAMECORE_PROPPLAYGACHAMACHINE_METHOD_3_75578C5706F8DA9B_OFFSET UNITYSDK_OFFSET(0x1BA25FC0)
#define RPG_GAMECORE_PROPPLAYGACHAMACHINE_METHOD_3_83BB6BAD6E9A1E15_OFFSET UNITYSDK_OFFSET(0x1BA25F30)
#define RPG_GAMECORE_PROPPLAYGACHAMACHINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA25F90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropPlayGachaMachine_TypeDefinitionIndex = 21161;
