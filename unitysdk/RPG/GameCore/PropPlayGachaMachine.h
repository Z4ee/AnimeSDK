...
#define RPG_GAMECORE_PROPPLAYGACHAMACHINE_METHOD_3_449E1C33196F4D5B_OFFSET UNITYSDK_OFFSET(0x17521C40)
#define RPG_GAMECORE_PROPPLAYGACHAMACHINE_METHOD_3_D8E97B551A003F4C_OFFSET UNITYSDK_OFFSET(0x17521B00)
#define RPG_GAMECORE_PROPPLAYGACHAMACHINE__CTOR_OFFSET UNITYSDK_OFFSET(0x17521BB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropPlayGachaMachine_TypeDefinitionIndex = 20140;
