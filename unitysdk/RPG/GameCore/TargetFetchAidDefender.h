...
#define RPG_GAMECORE_TARGETFETCHAIDDEFENDER_METHOD_4_484EBBE6EEB848FB_OFFSET UNITYSDK_OFFSET(0x177BCBB0)
#define RPG_GAMECORE_TARGETFETCHAIDDEFENDER_METHOD_4_74792FF03F7E792D_OFFSET UNITYSDK_OFFSET(0x177B2010)
#define RPG_GAMECORE_TARGETFETCHAIDDEFENDER__CTOR_OFFSET UNITYSDK_OFFSET(0x177B1FC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchAidDefender_TypeDefinitionIndex = 22283;
