...
#define RPG_GAMECORE_TARGETFETCHAIDDEFENDER_METHOD_4_2980415C3A86FEED_OFFSET UNITYSDK_OFFSET(0x1D0B6750)
#define RPG_GAMECORE_TARGETFETCHAIDDEFENDER_METHOD_4_74792FF03F7E792D_OFFSET UNITYSDK_OFFSET(0x1D0B66D0)
#define RPG_GAMECORE_TARGETFETCHAIDDEFENDER_METHOD_4_DFF728019F1AFB48_OFFSET UNITYSDK_OFFSET(0x1D0B6650)
#define RPG_GAMECORE_TARGETFETCHAIDDEFENDER_METHOD_4_F6E570923032A7A0_OFFSET UNITYSDK_OFFSET(0x1D0B6730)
#define RPG_GAMECORE_TARGETFETCHAIDDEFENDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0B66C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchAidDefender_TypeDefinitionIndex = 23153;
