...
#define RPG_GAMECORE_GMACCOUNTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17224DE0)
#define RPG_GAMECORE_GMACCOUNTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x172251C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GMAccountConfigRow_TypeDefinitionIndex = 12181;

	class GMAccountConfigRow : public ::System::Object
	{
	public:
		::Il2CppArray<::Class_1_3745C69C00F04B7D_2*>* AvatarList; // 0x10
		::Il2CppArray<::System::UInt32>* RelicGroupIDList; // 0x18
		::System::String* Name; // 0x20
		::Il2CppArray<::System::UInt32>* FinishMainMissionList; // 0x28
		::Il2CppArray<::System::UInt32>* ItemGroupIDList; // 0x30
		::Il2CppArray<::System::UInt32>* EquipmentGroupIDList; // 0x38
		::System::Boolean IsFinishTutorial; // 0x40
