...
#define RPG_GAMECORE_GMACCOUNTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1DCC0550)
#define RPG_GAMECORE_GMACCOUNTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCC0910)
