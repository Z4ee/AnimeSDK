...
#define RPG_GAMECORE_FIVEDIMCHILDPRESETCONFIG_METHOD_2_E146ABBCB5A04144_OFFSET UNITYSDK_OFFSET(0x1E0E5FF0)
#define RPG_GAMECORE_FIVEDIMCHILDPRESETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0E60B0)
