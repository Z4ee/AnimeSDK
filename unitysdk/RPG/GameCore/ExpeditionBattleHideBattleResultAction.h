...
#define RPG_GAMECORE_EXPEDITIONBATTLEHIDEBATTLERESULTACTION_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1D0812A0)
#define RPG_GAMECORE_EXPEDITIONBATTLEHIDEBATTLERESULTACTION_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D081200)
#define RPG_GAMECORE_EXPEDITIONBATTLEHIDEBATTLERESULTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D081290)
