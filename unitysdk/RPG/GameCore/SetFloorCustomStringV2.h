...
#define RPG_GAMECORE_SETFLOORCUSTOMSTRINGV2_METHOD_3_522FF3C6347D869A_OFFSET UNITYSDK_OFFSET(0x19C4F550)
#define RPG_GAMECORE_SETFLOORCUSTOMSTRINGV2_METHOD_3_83E0998B92EA3D03_OFFSET UNITYSDK_OFFSET(0x19C4F5D0)
#define RPG_GAMECORE_SETFLOORCUSTOMSTRINGV2__CTOR_OFFSET UNITYSDK_OFFSET(0x19C4F5A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetFloorCustomStringV2_TypeDefinitionIndex = 19555;
