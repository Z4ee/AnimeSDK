...
#define RPG_GAMECORE_SETFLOORCUSTOMSTRINGV2_METHOD_3_522FF3C6347D869A_OFFSET UNITYSDK_OFFSET(0x176CF210)
#define RPG_GAMECORE_SETFLOORCUSTOMSTRINGV2_METHOD_3_83E0998B92EA3D03_OFFSET UNITYSDK_OFFSET(0x176CF290)
#define RPG_GAMECORE_SETFLOORCUSTOMSTRINGV2__CTOR_OFFSET UNITYSDK_OFFSET(0x176CF260)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetFloorCustomStringV2_TypeDefinitionIndex = 19017;
