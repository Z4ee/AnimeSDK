...
#define RPG_GAMECORE_RTCOMPLEXSKILLAISOURCE_METHOD_3_3D20AD1DBB393454_OFFSET UNITYSDK_OFFSET(0x18DCCB60)
#define RPG_GAMECORE_RTCOMPLEXSKILLAISOURCE_METHOD_3_E543EC69AD8F653E_OFFSET UNITYSDK_OFFSET(0x18DCCBB0)
#define RPG_GAMECORE_RTCOMPLEXSKILLAISOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x18DCCC10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtComplexSkillAISource_TypeDefinitionIndex = 16743;
