...
#define RPG_GAMECORE_SETFACEDIRECTIONLOCKED_METHOD_3_65565061BF5D6C0C_OFFSET UNITYSDK_OFFSET(0x1C5F8AD0)
#define RPG_GAMECORE_SETFACEDIRECTIONLOCKED_METHOD_3_A6DE2B1D9A690559_OFFSET UNITYSDK_OFFSET(0x1C5F8A80)
#define RPG_GAMECORE_SETFACEDIRECTIONLOCKED__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5F8AC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetFaceDirectionLocked_TypeDefinitionIndex = 21886;
