...
#define RPG_GAMECORE_SETFACEDIRECTIONLOCKED_METHOD_3_642697B89BD9593B_OFFSET UNITYSDK_OFFSET(0x19C4D410)
#define RPG_GAMECORE_SETFACEDIRECTIONLOCKED_METHOD_3_65565061BF5D6C0C_OFFSET UNITYSDK_OFFSET(0x19C4D490)
#define RPG_GAMECORE_SETFACEDIRECTIONLOCKED__CTOR_OFFSET UNITYSDK_OFFSET(0x19C4D460)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetFaceDirectionLocked_TypeDefinitionIndex = 21467;
