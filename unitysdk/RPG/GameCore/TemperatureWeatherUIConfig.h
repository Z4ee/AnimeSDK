...
#define RPG_GAMECORE_TEMPERATUREWEATHERUICONFIG_METHOD_3_C12FC62AAD525DF6_OFFSET UNITYSDK_OFFSET(0x1C14B2C0)
#define RPG_GAMECORE_TEMPERATUREWEATHERUICONFIG_METHOD_3_E91FC7F9EA65335A_OFFSET UNITYSDK_OFFSET(0x1C14B320)
#define RPG_GAMECORE_TEMPERATUREWEATHERUICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C14B310)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TemperatureWeatherUIConfig_TypeDefinitionIndex = 21970;
