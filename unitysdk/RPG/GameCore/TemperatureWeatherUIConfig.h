...
#define RPG_GAMECORE_TEMPERATUREWEATHERUICONFIG_METHOD_3_C12FC62AAD525DF6_OFFSET UNITYSDK_OFFSET(0x19094110)
#define RPG_GAMECORE_TEMPERATUREWEATHERUICONFIG_METHOD_3_E91FC7F9EA65335A_OFFSET UNITYSDK_OFFSET(0x19094170)
#define RPG_GAMECORE_TEMPERATUREWEATHERUICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19094160)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TemperatureWeatherUIConfig_TypeDefinitionIndex = 21697;
