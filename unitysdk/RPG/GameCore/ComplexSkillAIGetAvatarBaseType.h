...
#define RPG_GAMECORE_COMPLEXSKILLAIGETAVATARBASETYPE_METHOD_3_EBF60C546B0C1125_OFFSET UNITYSDK_OFFSET(0x18829D90)
#define RPG_GAMECORE_COMPLEXSKILLAIGETAVATARBASETYPE_METHOD_3_F3E704BAB96BC99A_OFFSET UNITYSDK_OFFSET(0x18829E00)
#define RPG_GAMECORE_COMPLEXSKILLAIGETAVATARBASETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x18829DE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAIGetAvatarBaseType_TypeDefinitionIndex = 14738;
