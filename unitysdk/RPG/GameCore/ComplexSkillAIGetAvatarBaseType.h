...
#define RPG_GAMECORE_COMPLEXSKILLAIGETAVATARBASETYPE_METHOD_3_EBF60C546B0C1125_OFFSET UNITYSDK_OFFSET(0x1966AA80)
#define RPG_GAMECORE_COMPLEXSKILLAIGETAVATARBASETYPE_METHOD_3_F3E704BAB96BC99A_OFFSET UNITYSDK_OFFSET(0x1966AAF0)
#define RPG_GAMECORE_COMPLEXSKILLAIGETAVATARBASETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1966AAD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAIGetAvatarBaseType_TypeDefinitionIndex = 14803;
