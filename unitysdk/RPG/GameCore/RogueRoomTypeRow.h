...
#define RPG_GAMECORE_ROGUEROOMTYPEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19BBAE90)
#define RPG_GAMECORE_ROGUEROOMTYPEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19BBB740)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueRoomTypeRow_TypeDefinitionIndex = 13982;
	...
	public:
		...
		::System::Boolean IsSuper; // 0x20
		::System::Boolean MapShowType; // 0x21
		::System::UInt32 RogueRoomType; // 0x24
		::RPG::Client::TextID RoomTypeDescTextmapID; // 0x28
