...
#define RPG_GAMECORE_ROGUEROOMTYPEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1E547E50)
#define RPG_GAMECORE_ROGUEROOMTYPEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1E548700)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID RoomTypeDescTextmapID; // 0x40
