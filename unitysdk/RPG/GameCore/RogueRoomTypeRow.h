...
#define RPG_GAMECORE_ROGUEROOMTYPEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D40F420)
#define RPG_GAMECORE_ROGUEROOMTYPEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D40FCD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueRoomTypeRow_TypeDefinitionIndex = 14550;
