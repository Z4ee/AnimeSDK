...
#define RPG_GAMECORE_ROGUEMODIFIERWORKBENCHREFORGESETCOSTCOUNTCONFIG_METHOD_3_5581143DB5CBB6F9_OFFSET UNITYSDK_OFFSET(0x1E535960)
#define RPG_GAMECORE_ROGUEMODIFIERWORKBENCHREFORGESETCOSTCOUNTCONFIG_METHOD_3_E76BB8B70F3BF0F5_OFFSET UNITYSDK_OFFSET(0x1E535910)
#define RPG_GAMECORE_ROGUEMODIFIERWORKBENCHREFORGESETCOSTCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1E535950)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierWorkbenchReforgeSetCostCountConfig_TypeDefinitionIndex = 17668;
