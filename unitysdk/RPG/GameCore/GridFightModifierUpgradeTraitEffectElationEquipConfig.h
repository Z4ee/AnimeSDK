...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERUPGRADETRAITEFFECTELATIONEQUIPCONFIG_METHOD_3_6FCA6CE199755B91_OFFSET UNITYSDK_OFFSET(0x1D15B4F0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERUPGRADETRAITEFFECTELATIONEQUIPCONFIG_METHOD_3_740A207FA851EBB5_OFFSET UNITYSDK_OFFSET(0x1D15B540)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERUPGRADETRAITEFFECTELATIONEQUIPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D15B530)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierUpgradeTraitEffectElationEquipConfig_TypeDefinitionIndex = 19255;
