...
#define RPG_GAMECORE_MISSIONCUSTOMVALUEREWARDCONFIG_METHOD_2_93AE016657D20715_OFFSET UNITYSDK_OFFSET(0x174209B0)
#define RPG_GAMECORE_MISSIONCUSTOMVALUEREWARDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17420B30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MissionCustomValueRewardConfig_TypeDefinitionIndex = 17404;
