...
#define RPG_GAMECORE_VERIFYINTERACTINGENTITY_METHOD_3_BD178069C3DAAAC0_OFFSET UNITYSDK_OFFSET(0x190F1F60)
#define RPG_GAMECORE_VERIFYINTERACTINGENTITY_METHOD_3_CB95EE76AADE8C18_OFFSET UNITYSDK_OFFSET(0x190F1EE0)
#define RPG_GAMECORE_VERIFYINTERACTINGENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x190F1F30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VerifyInteractingEntity_TypeDefinitionIndex = 19839;
