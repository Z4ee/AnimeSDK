...
#define RPG_GAMECORE_CREATETEAMFORMATIONSNAPSHOT_METHOD_3_59C5688F42F30A5E_OFFSET UNITYSDK_OFFSET(0x1713F550)
#define RPG_GAMECORE_CREATETEAMFORMATIONSNAPSHOT_METHOD_3_89BDFFDC46474BD4_OFFSET UNITYSDK_OFFSET(0x1713F4B0)
#define RPG_GAMECORE_CREATETEAMFORMATIONSNAPSHOT__CTOR_OFFSET UNITYSDK_OFFSET(0x1713F510)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CreateTeamFormationSnapshot_TypeDefinitionIndex = 20672;
