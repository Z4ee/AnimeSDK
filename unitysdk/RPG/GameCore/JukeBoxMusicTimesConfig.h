...
#define RPG_GAMECORE_JUKEBOXMUSICTIMESCONFIG_METHOD_2_0EFFBEBCB0EDF255_OFFSET UNITYSDK_OFFSET(0x1732C0B0)
#define RPG_GAMECORE_JUKEBOXMUSICTIMESCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1732C180)

namespace RPG::GameCore
{
	inline static constexpr unsigned int JukeBoxMusicTimesConfig_TypeDefinitionIndex = 15012;
