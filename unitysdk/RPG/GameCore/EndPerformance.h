...
#define RPG_GAMECORE_ENDPERFORMANCE_METHOD_3_9AD2305CA26BD1FF_OFFSET UNITYSDK_OFFSET(0x1D7BF7C0)
#define RPG_GAMECORE_ENDPERFORMANCE_METHOD_3_C09B7CD0D9E59CC2_OFFSET UNITYSDK_OFFSET(0x1D7BF890)
#define RPG_GAMECORE_ENDPERFORMANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7BF880)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EndPerformance_TypeDefinitionIndex = 21599;
