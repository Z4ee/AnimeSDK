...
#define RPG_GAMECORE_ENDPERFORMANCE_METHOD_3_9CF26B8C62DE4C16_OFFSET UNITYSDK_OFFSET(0x196E6830)
#define RPG_GAMECORE_ENDPERFORMANCE_METHOD_3_C09B7CD0D9E59CC2_OFFSET UNITYSDK_OFFSET(0x196E6940)
#define RPG_GAMECORE_ENDPERFORMANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x196E6910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EndPerformance_TypeDefinitionIndex = 20626;
