...
#define RPG_GAMECORE_TRIGGERCONFIRMDIALOG_METHOD_3_55A3946D286CAD7F_OFFSET UNITYSDK_OFFSET(0x1B0478A0)
#define RPG_GAMECORE_TRIGGERCONFIRMDIALOG_METHOD_3_80D53BBC0CA2CA9C_OFFSET UNITYSDK_OFFSET(0x1B0478E0)
#define RPG_GAMECORE_TRIGGERCONFIRMDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0478D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerConfirmDialog_TypeDefinitionIndex = 20775;
