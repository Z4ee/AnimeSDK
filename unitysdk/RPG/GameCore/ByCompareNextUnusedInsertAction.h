...
#define RPG_GAMECORE_BYCOMPARENEXTUNUSEDINSERTACTION_METHOD_4_23420A8723CFAB87_OFFSET UNITYSDK_OFFSET(0x1BBAAF50)
#define RPG_GAMECORE_BYCOMPARENEXTUNUSEDINSERTACTION_METHOD_4_33FF3E3E36DDE6EA_OFFSET UNITYSDK_OFFSET(0x1BBAB220)
#define RPG_GAMECORE_BYCOMPARENEXTUNUSEDINSERTACTION_METHOD_4_662E9065505C0B5C_OFFSET UNITYSDK_OFFSET(0x1BBAB1E0)
#define RPG_GAMECORE_BYCOMPARENEXTUNUSEDINSERTACTION_METHOD_4_77C499E5E03A2626_OFFSET UNITYSDK_OFFSET(0x1BBAAFA0)
#define RPG_GAMECORE_BYCOMPARENEXTUNUSEDINSERTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBAAF90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareNextUnusedInsertAction_TypeDefinitionIndex = 22795;
