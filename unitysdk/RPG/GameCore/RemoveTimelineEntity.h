...
#define RPG_GAMECORE_REMOVETIMELINEENTITY_METHOD_3_0DFE8F94387A0838_OFFSET UNITYSDK_OFFSET(0x17599F20)
#define RPG_GAMECORE_REMOVETIMELINEENTITY_METHOD_3_DCBC6272DBD7D41B_OFFSET UNITYSDK_OFFSET(0x17599FA0)
#define RPG_GAMECORE_REMOVETIMELINEENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x17599F70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveTimelineEntity_TypeDefinitionIndex = 18945;
