...
#define RPG_GAMECORE_CAMERASHAKETEMPLATECONFIG_METHOD_2_5BCD8A29929F2A67_OFFSET UNITYSDK_OFFSET(0x170526E0)
#define RPG_GAMECORE_CAMERASHAKETEMPLATECONFIG_METHOD_2_80A29442A2186008_OFFSET UNITYSDK_OFFSET(0x170527C0)
#define RPG_GAMECORE_CAMERASHAKETEMPLATECONFIG_METHOD_2_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x17052AC0)
#define RPG_GAMECORE_CAMERASHAKETEMPLATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x170527B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CameraShakeTemplateConfig_TypeDefinitionIndex = 15049;
