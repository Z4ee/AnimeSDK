...
#define RPG_GAMECORE_CAMERASHAKETEMPLATECONFIG_METHOD_2_4BCCEAA8ABD0E2AF_OFFSET UNITYSDK_OFFSET(0x195F3A10)
#define RPG_GAMECORE_CAMERASHAKETEMPLATECONFIG_METHOD_2_A239DF324AF4215D_OFFSET UNITYSDK_OFFSET(0x195F3CB0)
#define RPG_GAMECORE_CAMERASHAKETEMPLATECONFIG_METHOD_2_E24554BA31F36DCA_OFFSET UNITYSDK_OFFSET(0x195F3940)
#define RPG_GAMECORE_CAMERASHAKETEMPLATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x195F3A00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CameraShakeTemplateConfig_TypeDefinitionIndex = 15619;
