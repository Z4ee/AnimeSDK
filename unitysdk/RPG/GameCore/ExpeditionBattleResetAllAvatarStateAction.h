...
#define RPG_GAMECORE_EXPEDITIONBATTLERESETALLAVATARSTATEACTION_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1D082370)
#define RPG_GAMECORE_EXPEDITIONBATTLERESETALLAVATARSTATEACTION_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D0822D0)
#define RPG_GAMECORE_EXPEDITIONBATTLERESETALLAVATARSTATEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D082360)
