...
#define RPG_GAMECORE_FIVEDIMCAMERALENSCONFIG_METHOD_2_F35648C0B8A6D68A_OFFSET UNITYSDK_OFFSET(0x1E0E3750)
#define RPG_GAMECORE_FIVEDIMCAMERALENSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0E56C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimCameraLensConfig_TypeDefinitionIndex = 18407;
