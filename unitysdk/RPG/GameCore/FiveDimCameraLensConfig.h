...
#define RPG_GAMECORE_FIVEDIMCAMERALENSCONFIG_METHOD_2_F35648C0B8A6D68A_OFFSET UNITYSDK_OFFSET(0x1972AC70)
#define RPG_GAMECORE_FIVEDIMCAMERALENSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19734970)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimCameraLensConfig_TypeDefinitionIndex = 17713;
