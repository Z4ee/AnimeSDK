...
#define RPG_GAMECORE_FIVEDIMCAMERALENSCONFIG_METHOD_2_393D71BD4B31B773_OFFSET UNITYSDK_OFFSET(0x171E05C0)
#define RPG_GAMECORE_FIVEDIMCAMERALENSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171EB700)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimCameraLensConfig_TypeDefinitionIndex = 17086;
