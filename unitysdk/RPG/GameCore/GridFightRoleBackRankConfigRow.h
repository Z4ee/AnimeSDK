...
#define RPG_GAMECORE_GRIDFIGHTROLEBACKRANKCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D0719E0)
#define RPG_GAMECORE_GRIDFIGHTROLEBACKRANKCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D071EE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightRoleBackRankConfigRow_TypeDefinitionIndex = 13013;
	...
	public:
		...
		::Il2CppArray<::RPG::GameCore::FixPoint>* Star1ParamList; // 0x30
		::System::String* CharacterAbilityName; // 0x38
		::Il2CppArray<::RPG::GameCore::FixPoint>* Star3ParamList; // 0x40
		::RPG::GameCore::StringHash Trigger; // 0x48
		::System::UInt32 Rank; // 0x4C
		::RPG::Client::TextID Name; // 0x50
		::RPG::Client::TextID Desc; // 0x60
		::System::UInt32 RankID; // 0x70
