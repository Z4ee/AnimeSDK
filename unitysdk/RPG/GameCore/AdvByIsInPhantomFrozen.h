...
#define RPG_GAMECORE_ADVBYISINPHANTOMFROZEN_METHOD_4_20723FE107E10DA0_OFFSET UNITYSDK_OFFSET(0x1D6B0020)
#define RPG_GAMECORE_ADVBYISINPHANTOMFROZEN_METHOD_4_62CA5A5B965F0053_OFFSET UNITYSDK_OFFSET(0x1D6AFE30)
#define RPG_GAMECORE_ADVBYISINPHANTOMFROZEN_METHOD_4_88DFF3A54E5DC81A_OFFSET UNITYSDK_OFFSET(0x1D6AFE70)
#define RPG_GAMECORE_ADVBYISINPHANTOMFROZEN_METHOD_4_A7249BB191FE91F6_OFFSET UNITYSDK_OFFSET(0x1D6AFFF0)
#define RPG_GAMECORE_ADVBYISINPHANTOMFROZEN__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6AFE60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvByIsInPhantomFrozen_TypeDefinitionIndex = 20355;
