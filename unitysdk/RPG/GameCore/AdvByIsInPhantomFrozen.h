...
#define RPG_GAMECORE_ADVBYISINPHANTOMFROZEN_METHOD_4_88DFF3A54E5DC81A_OFFSET UNITYSDK_OFFSET(0x18649850)
#define RPG_GAMECORE_ADVBYISINPHANTOMFROZEN_METHOD_4_D9DD872FC9DD16D4_OFFSET UNITYSDK_OFFSET(0x18649780)
#define RPG_GAMECORE_ADVBYISINPHANTOMFROZEN__CTOR_OFFSET UNITYSDK_OFFSET(0x18649800)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvByIsInPhantomFrozen_TypeDefinitionIndex = 19559;
