...
#define RPG_GAMECORE_CHIMERATALKCONTENTWITHWEIGHT_METHOD_3_58620A7110170606_OFFSET UNITYSDK_OFFSET(0x170AB230)
#define RPG_GAMECORE_CHIMERATALKCONTENTWITHWEIGHT_METHOD_3_FC55740E80DC99DC_OFFSET UNITYSDK_OFFSET(0x170AB100)
#define RPG_GAMECORE_CHIMERATALKCONTENTWITHWEIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x170AB0F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraTalkContentWithWeight_TypeDefinitionIndex = 14547;
