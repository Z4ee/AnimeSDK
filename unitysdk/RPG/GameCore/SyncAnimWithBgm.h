...
#define RPG_GAMECORE_SYNCANIMWITHBGM_METHOD_3_24816393E1FEC5C1_OFFSET UNITYSDK_OFFSET(0x177A31B0)
#define RPG_GAMECORE_SYNCANIMWITHBGM_METHOD_3_6F5806A55307A664_OFFSET UNITYSDK_OFFSET(0x177A3130)
#define RPG_GAMECORE_SYNCANIMWITHBGM__CTOR_OFFSET UNITYSDK_OFFSET(0x177A3180)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SyncAnimWithBgm_TypeDefinitionIndex = 20589;
