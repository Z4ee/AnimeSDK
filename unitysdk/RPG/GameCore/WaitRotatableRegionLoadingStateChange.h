...
#define RPG_GAMECORE_WAITROTATABLEREGIONLOADINGSTATECHANGE_METHOD_3_1CD1DC13E3F9B528_OFFSET UNITYSDK_OFFSET(0x1D1BBC10)
#define RPG_GAMECORE_WAITROTATABLEREGIONLOADINGSTATECHANGE_METHOD_3_CEE93226425A098B_OFFSET UNITYSDK_OFFSET(0x1D1BBBD0)
#define RPG_GAMECORE_WAITROTATABLEREGIONLOADINGSTATECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1BBC00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitRotatableRegionLoadingStateChange_TypeDefinitionIndex = 20129;
