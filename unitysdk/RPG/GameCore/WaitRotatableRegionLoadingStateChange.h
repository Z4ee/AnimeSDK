...
#define RPG_GAMECORE_WAITROTATABLEREGIONLOADINGSTATECHANGE_METHOD_3_1CD1DC13E3F9B528_OFFSET UNITYSDK_OFFSET(0x17903F40)
#define RPG_GAMECORE_WAITROTATABLEREGIONLOADINGSTATECHANGE_METHOD_3_EA6968976ADB00C1_OFFSET UNITYSDK_OFFSET(0x17903EC0)
#define RPG_GAMECORE_WAITROTATABLEREGIONLOADINGSTATECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x17903F10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitRotatableRegionLoadingStateChange_TypeDefinitionIndex = 19245;
