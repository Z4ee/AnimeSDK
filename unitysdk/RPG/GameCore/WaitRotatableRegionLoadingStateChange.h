...
#define RPG_GAMECORE_WAITROTATABLEREGIONLOADINGSTATECHANGE_METHOD_3_1CD1DC13E3F9B528_OFFSET UNITYSDK_OFFSET(0x19107E00)
#define RPG_GAMECORE_WAITROTATABLEREGIONLOADINGSTATECHANGE_METHOD_3_EA6968976ADB00C1_OFFSET UNITYSDK_OFFSET(0x19107D80)
#define RPG_GAMECORE_WAITROTATABLEREGIONLOADINGSTATECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x19107DD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitRotatableRegionLoadingStateChange_TypeDefinitionIndex = 19904;
