...
#define RPG_GAMECORE_SETTRIGGEREDFORMATIONASSETAUTOCENTER_METHOD_3_2BB729B0EBF8134C_OFFSET UNITYSDK_OFFSET(0x18E48EE0)
#define RPG_GAMECORE_SETTRIGGEREDFORMATIONASSETAUTOCENTER_METHOD_3_8761B2A26BFE6DDD_OFFSET UNITYSDK_OFFSET(0x18E48E50)
#define RPG_GAMECORE_SETTRIGGEREDFORMATIONASSETAUTOCENTER__CTOR_OFFSET UNITYSDK_OFFSET(0x18E48EB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetTriggeredFormationAssetAutoCenter_TypeDefinitionIndex = 21537;
