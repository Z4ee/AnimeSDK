...
#define RPG_GAMECORE_SETTRIGGEREDFORMATIONASSETAUTOCENTER_METHOD_3_1511E81D040EA407_OFFSET UNITYSDK_OFFSET(0x1C60ED00)
#define RPG_GAMECORE_SETTRIGGEREDFORMATIONASSETAUTOCENTER_METHOD_3_2BB729B0EBF8134C_OFFSET UNITYSDK_OFFSET(0x1C60ED50)
#define RPG_GAMECORE_SETTRIGGEREDFORMATIONASSETAUTOCENTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C60ED40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetTriggeredFormationAssetAutoCenter_TypeDefinitionIndex = 21831;
