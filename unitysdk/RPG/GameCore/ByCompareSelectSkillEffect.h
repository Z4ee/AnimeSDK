...
#define RPG_GAMECORE_BYCOMPARESELECTSKILLEFFECT_METHOD_4_5EC265C2023AEE4F_OFFSET UNITYSDK_OFFSET(0x170166E0)
#define RPG_GAMECORE_BYCOMPARESELECTSKILLEFFECT_METHOD_4_77FE2ADB05E43A31_OFFSET UNITYSDK_OFFSET(0x170167B0)
#define RPG_GAMECORE_BYCOMPARESELECTSKILLEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x17016760)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareSelectSkillEffect_TypeDefinitionIndex = 21228;
