...
#define RPG_GAMECORE_PROPSTATEITEM_METHOD_2_19B7F005AC2C531F_OFFSET UNITYSDK_OFFSET(0x1D186F60)
#define RPG_GAMECORE_PROPSTATEITEM_METHOD_2_6F11A4C72F237863_OFFSET UNITYSDK_OFFSET(0x1D186D50)
#define RPG_GAMECORE_PROPSTATEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D186F50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropStateItem_TypeDefinitionIndex = 20957;
