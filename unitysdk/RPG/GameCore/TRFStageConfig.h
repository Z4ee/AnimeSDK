...
#define RPG_GAMECORE_TRFSTAGECONFIG_METHOD_2_3CE5115C94D09D65_OFFSET UNITYSDK_OFFSET(0x1B4477C0)
#define RPG_GAMECORE_TRFSTAGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B447900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TRFStageConfig_TypeDefinitionIndex = 18159;
