...
#define RPG_GAMECORE_BYISGENDERTYPE_METHOD_4_D2C301A67DE6BA68_OFFSET UNITYSDK_OFFSET(0x1702E8C0)
#define RPG_GAMECORE_BYISGENDERTYPE_METHOD_4_DC9F15406B4100C6_OFFSET UNITYSDK_OFFSET(0x1702E7F0)
#define RPG_GAMECORE_BYISGENDERTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1702E870)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsGenderType_TypeDefinitionIndex = 19126;
