...
#define RPG_GAMECORE_BYISGENDERTYPE_METHOD_4_49ED4755CAE23118_OFFSET UNITYSDK_OFFSET(0x1A8E3890)
#define RPG_GAMECORE_BYISGENDERTYPE_METHOD_4_A90BFCB4BD61243F_OFFSET UNITYSDK_OFFSET(0x1A8E38C0)
#define RPG_GAMECORE_BYISGENDERTYPE_METHOD_4_BC730A8BB92EA21D_OFFSET UNITYSDK_OFFSET(0x1A8E36D0)
#define RPG_GAMECORE_BYISGENDERTYPE_METHOD_4_D2C301A67DE6BA68_OFFSET UNITYSDK_OFFSET(0x1A8E3710)
#define RPG_GAMECORE_BYISGENDERTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8E3700)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsGenderType_TypeDefinitionIndex = 20020;
