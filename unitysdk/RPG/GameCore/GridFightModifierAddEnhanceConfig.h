...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDENHANCECONFIG_METHOD_3_D2A150140DBA3155_OFFSET UNITYSDK_OFFSET(0x197E82A0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDENHANCECONFIG_METHOD_3_E9A3DB1C5B02347C_OFFSET UNITYSDK_OFFSET(0x197E81D0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDENHANCECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197E8250)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierAddEnhanceConfig_TypeDefinitionIndex = 18409;
