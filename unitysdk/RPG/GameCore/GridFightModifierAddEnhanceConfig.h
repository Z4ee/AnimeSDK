...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDENHANCECONFIG_METHOD_3_86480E0AC395ED31_OFFSET UNITYSDK_OFFSET(0x1D157CC0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDENHANCECONFIG_METHOD_3_D2A150140DBA3155_OFFSET UNITYSDK_OFFSET(0x1D157D10)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDENHANCECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D157D00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierAddEnhanceConfig_TypeDefinitionIndex = 19182;
