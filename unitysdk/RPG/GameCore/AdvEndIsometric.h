...
#define RPG_GAMECORE_ADVENDISOMETRIC_METHOD_3_8FE5649592E2167C_OFFSET UNITYSDK_OFFSET(0x1864EBC0)
#define RPG_GAMECORE_ADVENDISOMETRIC_METHOD_3_902AE7AF0D5FA7B0_OFFSET UNITYSDK_OFFSET(0x1864EAB0)
#define RPG_GAMECORE_ADVENDISOMETRIC__CTOR_OFFSET UNITYSDK_OFFSET(0x1864EB90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvEndIsometric_TypeDefinitionIndex = 21080;
