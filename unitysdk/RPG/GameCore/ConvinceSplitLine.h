...
#define RPG_GAMECORE_CONVINCESPLITLINE_METHOD_3_19DDA9977D547F3B_OFFSET UNITYSDK_OFFSET(0x1D004330)
#define RPG_GAMECORE_CONVINCESPLITLINE_METHOD_3_6EB264BA1FDBC068_OFFSET UNITYSDK_OFFSET(0x1D0042F0)
#define RPG_GAMECORE_CONVINCESPLITLINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D004320)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConvinceSplitLine_TypeDefinitionIndex = 21585;
