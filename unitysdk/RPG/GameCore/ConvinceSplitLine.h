...
#define RPG_GAMECORE_CONVINCESPLITLINE_METHOD_3_19DDA9977D547F3B_OFFSET UNITYSDK_OFFSET(0x1883F150)
#define RPG_GAMECORE_CONVINCESPLITLINE_METHOD_3_912035860BAD02D2_OFFSET UNITYSDK_OFFSET(0x1883F0D0)
#define RPG_GAMECORE_CONVINCESPLITLINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1883F120)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConvinceSplitLine_TypeDefinitionIndex = 20682;
