...
#define RPG_GAMECORE_COMPLEXSKILLAISOURCECONTAINBEHAVIORFLAG_METHOD_3_0A7FB7A0A19BC7BC_OFFSET UNITYSDK_OFFSET(0x1BC26C00)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCECONTAINBEHAVIORFLAG_METHOD_3_B980D1AFC6A1551B_OFFSET UNITYSDK_OFFSET(0x1BC26BB0)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCECONTAINBEHAVIORFLAG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC26BF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAISourceContainBehaviorFlag_TypeDefinitionIndex = 14916;
