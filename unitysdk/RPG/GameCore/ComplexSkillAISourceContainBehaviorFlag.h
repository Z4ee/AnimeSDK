...
#define RPG_GAMECORE_COMPLEXSKILLAISOURCECONTAINBEHAVIORFLAG_METHOD_3_0A7FB7A0A19BC7BC_OFFSET UNITYSDK_OFFSET(0x1966C930)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCECONTAINBEHAVIORFLAG_METHOD_3_2CD0CF8DC64C644A_OFFSET UNITYSDK_OFFSET(0x1966F880)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCECONTAINBEHAVIORFLAG__CTOR_OFFSET UNITYSDK_OFFSET(0x1966C900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAISourceContainBehaviorFlag_TypeDefinitionIndex = 14756;
