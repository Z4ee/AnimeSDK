...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUESPECIFICCATEGORYMIRACLENUMPARAM_METHOD_4_81E130CF9E2EB6C9_OFFSET UNITYSDK_OFFSET(0x1C5F0840)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUESPECIFICCATEGORYMIRACLENUMPARAM_METHOD_4_D1E306F282EEF2CD_OFFSET UNITYSDK_OFFSET(0x1C5F0890)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUESPECIFICCATEGORYMIRACLENUMPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5F0880)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRogueSpecificCategoryMiracleNumParam_TypeDefinitionIndex = 20993;
