...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUESPECIFICCATEGORYMIRACLENUMPARAM_METHOD_4_3BB3CDEBBC573B5D_OFFSET UNITYSDK_OFFSET(0x18E274D0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUESPECIFICCATEGORYMIRACLENUMPARAM_METHOD_4_D1E306F282EEF2CD_OFFSET UNITYSDK_OFFSET(0x18E27560)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUESPECIFICCATEGORYMIRACLENUMPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x18E27530)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRogueSpecificCategoryMiracleNumParam_TypeDefinitionIndex = 20645;
