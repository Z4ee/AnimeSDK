...
#define RPG_GAMECORE_RTBATTLETRIGGERCAMERAABILITY_METHOD_3_504DFF4CE4471434_OFFSET UNITYSDK_OFFSET(0x18DC6A90)
#define RPG_GAMECORE_RTBATTLETRIGGERCAMERAABILITY_METHOD_3_A1BE10D6A54D9C11_OFFSET UNITYSDK_OFFSET(0x18DC6B60)
#define RPG_GAMECORE_RTBATTLETRIGGERCAMERAABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x18DC6B10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtBattleTriggerCameraAbility_TypeDefinitionIndex = 23091;
