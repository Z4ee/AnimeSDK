...
#define RPG_GAMECORE_ROBOTEMOTIONNOTIFYCONFIG_METHOD_2_278ECB742C8D1295_OFFSET UNITYSDK_OFFSET(0x1D3B67B0)
#define RPG_GAMECORE_ROBOTEMOTIONNOTIFYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3B6890)
