...
#define RPG_GAMECORE_ROBOTEMOTIONNOTIFYCONFIG_METHOD_2_278ECB742C8D1295_OFFSET UNITYSDK_OFFSET(0x1EE84600)
#define RPG_GAMECORE_ROBOTEMOTIONNOTIFYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EE846E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RobotEmotionNotifyConfig_TypeDefinitionIndex = 16766;
