...
#define RPG_GAMECORE_ROBOTEMOTIONNOTIFYCONFIG_METHOD_2_278ECB742C8D1295_OFFSET UNITYSDK_OFFSET(0x175B0C10)
#define RPG_GAMECORE_ROBOTEMOTIONNOTIFYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175B0CF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RobotEmotionNotifyConfig_TypeDefinitionIndex = 15528;
