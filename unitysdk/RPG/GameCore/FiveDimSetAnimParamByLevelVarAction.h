...
#define RPG_GAMECORE_FIVEDIMSETANIMPARAMBYLEVELVARACTION_METHOD_3_195B390C15DBC7AB_OFFSET UNITYSDK_OFFSET(0x1D0FECA0)
#define RPG_GAMECORE_FIVEDIMSETANIMPARAMBYLEVELVARACTION_METHOD_3_D04FB08CC0720D7E_OFFSET UNITYSDK_OFFSET(0x1D0FEC60)
#define RPG_GAMECORE_FIVEDIMSETANIMPARAMBYLEVELVARACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0FEC90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSetAnimParamByLevelVarAction_TypeDefinitionIndex = 18437;
