...
#define RPG_GAMECORE_FIVEDIMSETANIMPARAMBYLEVELVARACTION_METHOD_3_195B390C15DBC7AB_OFFSET UNITYSDK_OFFSET(0x18919C40)
#define RPG_GAMECORE_FIVEDIMSETANIMPARAMBYLEVELVARACTION_METHOD_3_6CBAACCEB0C9D4CA_OFFSET UNITYSDK_OFFSET(0x18919BD0)
#define RPG_GAMECORE_FIVEDIMSETANIMPARAMBYLEVELVARACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18919C20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSetAnimParamByLevelVarAction_TypeDefinitionIndex = 17716;
