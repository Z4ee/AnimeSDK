...
#define RPG_GAMECORE_FIVEDIMSETANIMPARAMBYLEVELVARACTION_METHOD_3_195B390C15DBC7AB_OFFSET UNITYSDK_OFFSET(0x19753350)
#define RPG_GAMECORE_FIVEDIMSETANIMPARAMBYLEVELVARACTION_METHOD_3_6CBAACCEB0C9D4CA_OFFSET UNITYSDK_OFFSET(0x197532E0)
#define RPG_GAMECORE_FIVEDIMSETANIMPARAMBYLEVELVARACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19753330)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSetAnimParamByLevelVarAction_TypeDefinitionIndex = 17743;
