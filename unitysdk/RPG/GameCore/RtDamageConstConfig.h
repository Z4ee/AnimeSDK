...
#define RPG_GAMECORE_RTDAMAGECONSTCONFIG_METHOD_2_20DF1D782C684035_OFFSET UNITYSDK_OFFSET(0x1D49A410)
#define RPG_GAMECORE_RTDAMAGECONSTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4A6F50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtDamageConstConfig_TypeDefinitionIndex = 17432;
