...
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_ONSELFDEADWITHPROBABILITY_METHOD_3_68DD6D34F225A1E4_OFFSET UNITYSDK_OFFSET(0x17078920)
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_ONSELFDEADWITHPROBABILITY_METHOD_3_8E0A7D98C44FA530_OFFSET UNITYSDK_OFFSET(0x170789F0)
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_ONSELFDEADWITHPROBABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x170789E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleAbilityConditionChecker_OnSelfDeadWithProbability_TypeDefinitionIndex = 14419;
