...
#define RPG_GAMECORE_FIVEDIMEXTRALEVELGRAPHCONFIG_METHOD_2_721581941BBD4EBD_OFFSET UNITYSDK_OFFSET(0x1D85DC80)
#define RPG_GAMECORE_FIVEDIMEXTRALEVELGRAPHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D85DD60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimExtraLevelGraphConfig_TypeDefinitionIndex = 18300;
