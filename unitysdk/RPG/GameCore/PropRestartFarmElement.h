...
#define RPG_GAMECORE_PROPRESTARTFARMELEMENT_METHOD_3_91B3D61E8CD89C0A_OFFSET UNITYSDK_OFFSET(0x1BA284E0)
#define RPG_GAMECORE_PROPRESTARTFARMELEMENT_METHOD_3_EA8EB41EDB4214A7_OFFSET UNITYSDK_OFFSET(0x1BA285B0)
#define RPG_GAMECORE_PROPRESTARTFARMELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA285A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropRestartFarmElement_TypeDefinitionIndex = 21281;
