...
#define RPG_GAMECORE_PROPRESTARTFARMELEMENT_METHOD_3_68FAE26B5876A713_OFFSET UNITYSDK_OFFSET(0x19A95C30)
#define RPG_GAMECORE_PROPRESTARTFARMELEMENT_METHOD_3_EA8EB41EDB4214A7_OFFSET UNITYSDK_OFFSET(0x19A95D40)
#define RPG_GAMECORE_PROPRESTARTFARMELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19A95D10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropRestartFarmElement_TypeDefinitionIndex = 20866;
