...
#define RPG_GAMECORE_PERFORMANCEVIDEOROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D324F30)
#define RPG_GAMECORE_PERFORMANCEVIDEOROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3256B0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::PerformanceSkipType IsSkip; // 0x18
		::RPG::GameCore::StoryBlackType StartBlack; // 0x1C
