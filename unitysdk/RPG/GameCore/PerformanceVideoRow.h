...
#define RPG_GAMECORE_PERFORMANCEVIDEOROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x199FFD10)
#define RPG_GAMECORE_PERFORMANCEVIDEOROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19A00490)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PerformanceVideoRow_TypeDefinitionIndex = 13652;
