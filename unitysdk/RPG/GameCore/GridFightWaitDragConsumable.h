...
#define RPG_GAMECORE_GRIDFIGHTWAITDRAGCONSUMABLE_METHOD_3_AE0D6320120CA57B_OFFSET UNITYSDK_OFFSET(0x1728A8C0)
#define RPG_GAMECORE_GRIDFIGHTWAITDRAGCONSUMABLE_METHOD_3_DAB03EB361ACDF14_OFFSET UNITYSDK_OFFSET(0x1728A940)
#define RPG_GAMECORE_GRIDFIGHTWAITDRAGCONSUMABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1728A910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightWaitDragConsumable_TypeDefinitionIndex = 18232;
