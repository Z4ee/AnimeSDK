...
#define RPG_GAMECORE_GRIDFIGHTWAITDRAGCONSUMABLE_METHOD_3_AE0D6320120CA57B_OFFSET UNITYSDK_OFFSET(0x19811F70)
#define RPG_GAMECORE_GRIDFIGHTWAITDRAGCONSUMABLE_METHOD_3_DAB03EB361ACDF14_OFFSET UNITYSDK_OFFSET(0x19811FF0)
#define RPG_GAMECORE_GRIDFIGHTWAITDRAGCONSUMABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x19811FC0)
