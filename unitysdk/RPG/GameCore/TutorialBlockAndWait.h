...
#define RPG_GAMECORE_TUTORIALBLOCKANDWAIT_METHOD_3_C4BAD00CA5B3E883_OFFSET UNITYSDK_OFFSET(0x190D4AC0)
#define RPG_GAMECORE_TUTORIALBLOCKANDWAIT_METHOD_3_DC54E1276EF1A4A7_OFFSET UNITYSDK_OFFSET(0x190D4B60)
#define RPG_GAMECORE_TUTORIALBLOCKANDWAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x190D4B20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TutorialBlockAndWait_TypeDefinitionIndex = 23394;
