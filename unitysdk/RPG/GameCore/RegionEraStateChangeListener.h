...
#define RPG_GAMECORE_REGIONERASTATECHANGELISTENER_METHOD_3_220F7E3F7E1FDBF2_OFFSET UNITYSDK_OFFSET(0x1B9C1620)
#define RPG_GAMECORE_REGIONERASTATECHANGELISTENER_METHOD_3_60ABFEB71BB6593B_OFFSET UNITYSDK_OFFSET(0x1B9C15D0)
#define RPG_GAMECORE_REGIONERASTATECHANGELISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9C1610)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RegionEraStateChangeListener_TypeDefinitionIndex = 21534;
