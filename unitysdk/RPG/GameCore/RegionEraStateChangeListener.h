...
#define RPG_GAMECORE_REGIONERASTATECHANGELISTENER_METHOD_3_9FA85A74C45250A5_OFFSET UNITYSDK_OFFSET(0x17589DD0)
#define RPG_GAMECORE_REGIONERASTATECHANGELISTENER_METHOD_3_E811E9A10293FB74_OFFSET UNITYSDK_OFFSET(0x17589E50)
#define RPG_GAMECORE_REGIONERASTATECHANGELISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x17589E20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RegionEraStateChangeListener_TypeDefinitionIndex = 20541;
