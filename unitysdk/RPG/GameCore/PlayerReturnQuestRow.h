...
#define RPG_GAMECORE_PLAYERRETURNQUESTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1BA10A40)
#define RPG_GAMECORE_PLAYERRETURNQUESTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA111E0)
