...
#define RPG_GAMECORE_SHOWBOSSHPVALUE_METHOD_3_A42E522639A48D17_OFFSET UNITYSDK_OFFSET(0x18E5B000)
#define RPG_GAMECORE_SHOWBOSSHPVALUE_METHOD_3_C0D62BDDB4520966_OFFSET UNITYSDK_OFFSET(0x18E5AF80)
#define RPG_GAMECORE_SHOWBOSSHPVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E5AFD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowBossHPValue_TypeDefinitionIndex = 21857;
