...
#define RPG_GAMECORE_SHOWBOSSHPVALUE_METHOD_3_A42E522639A48D17_OFFSET UNITYSDK_OFFSET(0x176F7590)
#define RPG_GAMECORE_SHOWBOSSHPVALUE_METHOD_3_C0D62BDDB4520966_OFFSET UNITYSDK_OFFSET(0x176F7510)
#define RPG_GAMECORE_SHOWBOSSHPVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x176F7560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowBossHPValue_TypeDefinitionIndex = 21140;
