...
#define RPG_GAMECORE_SHOWBOSSHPVALUE_METHOD_3_185D5FFC2B76B45C_OFFSET UNITYSDK_OFFSET(0x1BE3BF30)
#define RPG_GAMECORE_SHOWBOSSHPVALUE_METHOD_3_A42E522639A48D17_OFFSET UNITYSDK_OFFSET(0x1BE3BF70)
#define RPG_GAMECORE_SHOWBOSSHPVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE3BF60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowBossHPValue_TypeDefinitionIndex = 22112;
