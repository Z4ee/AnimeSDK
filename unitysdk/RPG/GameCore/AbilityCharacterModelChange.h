...
#define RPG_GAMECORE_ABILITYCHARACTERMODELCHANGE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xA7C71E0)
#define RPG_GAMECORE_ABILITYCHARACTERMODELCHANGE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xA7C71A0)
#define RPG_GAMECORE_ABILITYCHARACTERMODELCHANGE_INIT_OFFSET UNITYSDK_OFFSET(0xA7C7150)
#define RPG_GAMECORE_ABILITYCHARACTERMODELCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0xA7C7230)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AbilityCharacterModelChange_TypeDefinitionIndex = 45472;
