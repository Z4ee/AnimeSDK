...
#define RPG_GAMECORE_FIVEDIMCAMERASHAKEACTION_METHOD_3_2D1766F763AA615E_OFFSET UNITYSDK_OFFSET(0x171EB730)
#define RPG_GAMECORE_FIVEDIMCAMERASHAKEACTION_METHOD_3_621D56C7974A4B5F_OFFSET UNITYSDK_OFFSET(0x171E5CD0)
#define RPG_GAMECORE_FIVEDIMCAMERASHAKEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x171E5CB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimCameraShakeAction_TypeDefinitionIndex = 17178;
