...
#define RPG_GAMECORE_SETTEAMLOCKTARGET_METHOD_3_287B754919770E7D_OFFSET UNITYSDK_OFFSET(0x18E47020)
#define RPG_GAMECORE_SETTEAMLOCKTARGET_METHOD_3_E140920797034C41_OFFSET UNITYSDK_OFFSET(0x18E46FA0)
#define RPG_GAMECORE_SETTEAMLOCKTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x18E46FF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetTeamLockTarget_TypeDefinitionIndex = 21605;
