...
#define RPG_GAMECORE_ST_MAIN_ELFENTITYDESTORY_METHOD_4_7F2EFE5EBE2A0071_OFFSET UNITYSDK_OFFSET(0x17696BF0)
#define RPG_GAMECORE_ST_MAIN_ELFENTITYDESTORY_METHOD_4_DB1B186147A74626_OFFSET UNITYSDK_OFFSET(0x176832A0)
#define RPG_GAMECORE_ST_MAIN_ELFENTITYDESTORY__CTOR_OFFSET UNITYSDK_OFFSET(0x17683250)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_ElfEntityDestory_TypeDefinitionIndex = 19725;
