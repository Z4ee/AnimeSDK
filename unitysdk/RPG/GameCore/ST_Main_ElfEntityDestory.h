...
#define RPG_GAMECORE_ST_MAIN_ELFENTITYDESTORY_METHOD_4_7F2EFE5EBE2A0071_OFFSET UNITYSDK_OFFSET(0x19C17DA0)
#define RPG_GAMECORE_ST_MAIN_ELFENTITYDESTORY_METHOD_4_DB1B186147A74626_OFFSET UNITYSDK_OFFSET(0x19C00280)
#define RPG_GAMECORE_ST_MAIN_ELFENTITYDESTORY__CTOR_OFFSET UNITYSDK_OFFSET(0x19C00230)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_ElfEntityDestory_TypeDefinitionIndex = 20351;
