...
#define RPG_GAMECORE_ST_MAIN_ELFENTITYDESTORY_METHOD_4_5FA2B132F4A01D23_OFFSET UNITYSDK_OFFSET(0x1D4C9220)
#define RPG_GAMECORE_ST_MAIN_ELFENTITYDESTORY_METHOD_4_DB1B186147A74626_OFFSET UNITYSDK_OFFSET(0x1D4C92F0)
#define RPG_GAMECORE_ST_MAIN_ELFENTITYDESTORY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4C92E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_ElfEntityDestory_TypeDefinitionIndex = 21301;
