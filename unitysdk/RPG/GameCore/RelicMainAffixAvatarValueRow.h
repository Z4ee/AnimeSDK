...
#define RPG_GAMECORE_RELICMAINAFFIXAVATARVALUEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17590EB0)
#define RPG_GAMECORE_RELICMAINAFFIXAVATARVALUEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17591290)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RelicMainAffixAvatarValueRow_TypeDefinitionIndex = 10208;

	class RelicMainAffixAvatarValueRow : public ::System::Object
	{
	public:
		::System::Single SPRatio; // 0x10
		::System::Single HealRatio; // 0x14
		::System::UInt32 AvatarID; // 0x18
		::System::Single Speed; // 0x1C
		::System::Single BreakDamage; // 0x20
		::System::Single CriticalDamage; // 0x24
		...
		::System::Single CriticalChance; // 0x3C
