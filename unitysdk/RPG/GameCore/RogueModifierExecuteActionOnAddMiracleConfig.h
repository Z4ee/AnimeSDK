...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONADDMIRACLECONFIG_METHOD_3_752E1565FB4FCBD2_OFFSET UNITYSDK_OFFSET(0x1CFBFE40)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONADDMIRACLECONFIG_METHOD_3_996A65446909436E_OFFSET UNITYSDK_OFFSET(0x1CFBFE90)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONADDMIRACLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFBFE80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnAddMiracleConfig_TypeDefinitionIndex = 17255;
