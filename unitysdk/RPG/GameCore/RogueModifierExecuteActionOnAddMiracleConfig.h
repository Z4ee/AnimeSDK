...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONADDMIRACLECONFIG_METHOD_3_996A65446909436E_OFFSET UNITYSDK_OFFSET(0x1762F6B0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONADDMIRACLECONFIG_METHOD_3_D3FCB7D2AD84F797_OFFSET UNITYSDK_OFFSET(0x1762F5E0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONADDMIRACLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1762F660)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnAddMiracleConfig_TypeDefinitionIndex = 16526;
