...
#define RPG_GAMECORE_IDLELIVEAVATARUPGRADELIMITROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D20DD60)
#define RPG_GAMECORE_IDLELIVEAVATARUPGRADELIMITROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D20DE80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int IdleLiveAvatarUpgradeLimitRow_TypeDefinitionIndex = 11693;
