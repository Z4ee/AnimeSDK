...
#define RPG_GAMECORE_FIVEDIMAVATARMOVEABILITYCONFIG_METHOD_2_9CC942FD0650A0F0_OFFSET UNITYSDK_OFFSET(0x1BA88520)
#define RPG_GAMECORE_FIVEDIMAVATARMOVEABILITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA88950)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimAvatarMoveAbilityConfig_TypeDefinitionIndex = 16056;
