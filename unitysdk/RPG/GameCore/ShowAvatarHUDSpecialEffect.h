...
#define RPG_GAMECORE_SHOWAVATARHUDSPECIALEFFECT_METHOD_3_3E7D1A0EE49DE803_OFFSET UNITYSDK_OFFSET(0x19C744B0)
#define RPG_GAMECORE_SHOWAVATARHUDSPECIALEFFECT_METHOD_3_A6B690297DC1E930_OFFSET UNITYSDK_OFFSET(0x19C74430)
#define RPG_GAMECORE_SHOWAVATARHUDSPECIALEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x19C74480)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowAvatarHUDSpecialEffect_TypeDefinitionIndex = 21678;
