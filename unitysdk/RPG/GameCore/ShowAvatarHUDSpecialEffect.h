...
#define RPG_GAMECORE_SHOWAVATARHUDSPECIALEFFECT_METHOD_3_3E7D1A0EE49DE803_OFFSET UNITYSDK_OFFSET(0x176F4830)
#define RPG_GAMECORE_SHOWAVATARHUDSPECIALEFFECT_METHOD_3_A6B690297DC1E930_OFFSET UNITYSDK_OFFSET(0x176F47B0)
#define RPG_GAMECORE_SHOWAVATARHUDSPECIALEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x176F4800)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowAvatarHUDSpecialEffect_TypeDefinitionIndex = 21131;
