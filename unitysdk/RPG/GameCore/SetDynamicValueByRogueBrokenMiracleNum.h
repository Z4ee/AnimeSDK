...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEBROKENMIRACLENUM_METHOD_3_14972FE75897DD88_OFFSET UNITYSDK_OFFSET(0x19C432B0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEBROKENMIRACLENUM_METHOD_3_2674FAEDDDD2066F_OFFSET UNITYSDK_OFFSET(0x19C43240)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEBROKENMIRACLENUM__CTOR_OFFSET UNITYSDK_OFFSET(0x19C43280)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRogueBrokenMiracleNum_TypeDefinitionIndex = 20553;
