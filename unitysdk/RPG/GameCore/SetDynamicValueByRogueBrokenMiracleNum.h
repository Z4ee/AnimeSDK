...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEBROKENMIRACLENUM_METHOD_3_14972FE75897DD88_OFFSET UNITYSDK_OFFSET(0x18E265C0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEBROKENMIRACLENUM_METHOD_3_2674FAEDDDD2066F_OFFSET UNITYSDK_OFFSET(0x18E26550)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEBROKENMIRACLENUM__CTOR_OFFSET UNITYSDK_OFFSET(0x18E26590)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRogueBrokenMiracleNum_TypeDefinitionIndex = 20620;
