...
#define RPG_GAMECORE_SUBMODIFIERDATA_METHOD_2_79C1B9100150437E_OFFSET UNITYSDK_OFFSET(0x1778ACC0)
#define RPG_GAMECORE_SUBMODIFIERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1778B0B0)
