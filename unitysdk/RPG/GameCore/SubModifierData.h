...
#define RPG_GAMECORE_SUBMODIFIERDATA_METHOD_2_8F202E16CFAA9C78_OFFSET UNITYSDK_OFFSET(0x1CB0ECD0)
#define RPG_GAMECORE_SUBMODIFIERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1CB0F130)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SubModifierData_TypeDefinitionIndex = 18020;
