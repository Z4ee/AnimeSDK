...
#define RPG_GAMECORE_UNITHINTTRIGGERCONFIG_METHOD_2_CF3CBC968202C5C4_OFFSET UNITYSDK_OFFSET(0x1D2AEF60)
#define RPG_GAMECORE_UNITHINTTRIGGERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2AF130)
