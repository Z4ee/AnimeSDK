...
#define RPG_GAMECORE_ACTIONBARSTYLESIZESETTING_METHOD_2_0864A1CB29B85CAD_OFFSET UNITYSDK_OFFSET(0x193C9B80)
#define RPG_GAMECORE_ACTIONBARSTYLESIZESETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x193CA610)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActionBarStyleSizeSetting_TypeDefinitionIndex = 16283;
