...
#define RPG_GAMECORE_RTCHARACTERMOTIONPARAM_METHOD_2_D4205F33CDE91B9B_OFFSET UNITYSDK_OFFSET(0x18DC3990)
#define RPG_GAMECORE_RTCHARACTERMOTIONPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x18DCC610)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtCharacterMotionParam_TypeDefinitionIndex = 16758;
