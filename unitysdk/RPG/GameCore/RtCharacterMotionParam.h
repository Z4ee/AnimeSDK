...
#define RPG_GAMECORE_RTCHARACTERMOTIONPARAM_METHOD_2_D4205F33CDE91B9B_OFFSET UNITYSDK_OFFSET(0x1CCD6490)
#define RPG_GAMECORE_RTCHARACTERMOTIONPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1CCE2690)
