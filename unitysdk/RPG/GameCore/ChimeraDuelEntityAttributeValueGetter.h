...
#define RPG_GAMECORE_CHIMERADUELENTITYATTRIBUTEVALUEGETTER_METHOD_3_8A551AB7E14F89A0_OFFSET UNITYSDK_OFFSET(0x1963C1C0)
#define RPG_GAMECORE_CHIMERADUELENTITYATTRIBUTEVALUEGETTER_METHOD_3_DCCAB2C7B6325510_OFFSET UNITYSDK_OFFSET(0x1963C160)
#define RPG_GAMECORE_CHIMERADUELENTITYATTRIBUTEVALUEGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1963C1B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelEntityAttributeValueGetter_TypeDefinitionIndex = 15149;
