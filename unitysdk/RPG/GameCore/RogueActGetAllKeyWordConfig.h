...
#define RPG_GAMECORE_ROGUEACTGETALLKEYWORDCONFIG_METHOD_6_A4DCE7A6145E70CA_OFFSET UNITYSDK_OFFSET(0x1EE852A0)
#define RPG_GAMECORE_ROGUEACTGETALLKEYWORDCONFIG_METHOD_6_AABE70D66A3B3126_OFFSET UNITYSDK_OFFSET(0x1EE852F0)
#define RPG_GAMECORE_ROGUEACTGETALLKEYWORDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EE852E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActGetAllKeyWordConfig_TypeDefinitionIndex = 19435;
