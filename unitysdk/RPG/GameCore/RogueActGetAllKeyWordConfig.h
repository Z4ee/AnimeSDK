...
#define RPG_GAMECORE_ROGUEACTGETALLKEYWORDCONFIG_METHOD_6_AABE70D66A3B3126_OFFSET UNITYSDK_OFFSET(0x18CC1060)
#define RPG_GAMECORE_ROGUEACTGETALLKEYWORDCONFIG_METHOD_6_BCB4FF724A5F4983_OFFSET UNITYSDK_OFFSET(0x18CC0E40)
#define RPG_GAMECORE_ROGUEACTGETALLKEYWORDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CC0F80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActGetAllKeyWordConfig_TypeDefinitionIndex = 18665;
