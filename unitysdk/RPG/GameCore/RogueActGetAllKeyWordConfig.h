...
#define RPG_GAMECORE_ROGUEACTGETALLKEYWORDCONFIG_METHOD_6_AABE70D66A3B3126_OFFSET UNITYSDK_OFFSET(0x175B52F0)
#define RPG_GAMECORE_ROGUEACTGETALLKEYWORDCONFIG_METHOD_6_BCB4FF724A5F4983_OFFSET UNITYSDK_OFFSET(0x175B50D0)
#define RPG_GAMECORE_ROGUEACTGETALLKEYWORDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175B5210)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActGetAllKeyWordConfig_TypeDefinitionIndex = 18020;
