...
#define RPG_GAMECORE_BYCHECKDARKTEAMDESTROY_METHOD_4_1D2116F31E9B2AB5_OFFSET UNITYSDK_OFFSET(0x19CC43E0)
#define RPG_GAMECORE_BYCHECKDARKTEAMDESTROY_METHOD_4_224323311859B0E7_OFFSET UNITYSDK_OFFSET(0x19CC45F0)
#define RPG_GAMECORE_BYCHECKDARKTEAMDESTROY_METHOD_4_8CEC8A729DC1AED0_OFFSET UNITYSDK_OFFSET(0x19CC45C0)
#define RPG_GAMECORE_BYCHECKDARKTEAMDESTROY_METHOD_4_8D391E2E464F2820_OFFSET UNITYSDK_OFFSET(0x19CC4420)
#define RPG_GAMECORE_BYCHECKDARKTEAMDESTROY__CTOR_OFFSET UNITYSDK_OFFSET(0x19CC4410)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckDarkTeamDestroy_TypeDefinitionIndex = 22600;
