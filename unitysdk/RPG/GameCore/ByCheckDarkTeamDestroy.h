...
#define RPG_GAMECORE_BYCHECKDARKTEAMDESTROY_METHOD_4_77889DDB469C151E_OFFSET UNITYSDK_OFFSET(0x16FFDD60)
#define RPG_GAMECORE_BYCHECKDARKTEAMDESTROY_METHOD_4_8D391E2E464F2820_OFFSET UNITYSDK_OFFSET(0x16FFDE30)
#define RPG_GAMECORE_BYCHECKDARKTEAMDESTROY__CTOR_OFFSET UNITYSDK_OFFSET(0x16FFDDE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckDarkTeamDestroy_TypeDefinitionIndex = 21671;
