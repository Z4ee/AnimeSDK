...
#define RPG_GAMECORE_BLOCKCAMERADITHERUPDATE_METHOD_3_C3B0DC248D54DD8D_OFFSET UNITYSDK_OFFSET(0x16FE7A90)
#define RPG_GAMECORE_BLOCKCAMERADITHERUPDATE_METHOD_3_CE5A69633C5DF8FC_OFFSET UNITYSDK_OFFSET(0x16FE7A10)
#define RPG_GAMECORE_BLOCKCAMERADITHERUPDATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16FE7A60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BlockCameraDitherUpdate_TypeDefinitionIndex = 20962;
