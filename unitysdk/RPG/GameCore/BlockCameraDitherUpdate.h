...
#define RPG_GAMECORE_BLOCKCAMERADITHERUPDATE_METHOD_3_5285E0B393A9B9CE_OFFSET UNITYSDK_OFFSET(0x1CE86470)
#define RPG_GAMECORE_BLOCKCAMERADITHERUPDATE_METHOD_3_C3B0DC248D54DD8D_OFFSET UNITYSDK_OFFSET(0x1CE864B0)
#define RPG_GAMECORE_BLOCKCAMERADITHERUPDATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE864A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BlockCameraDitherUpdate_TypeDefinitionIndex = 22512;
