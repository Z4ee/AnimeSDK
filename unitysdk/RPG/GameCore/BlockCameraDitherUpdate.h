...
#define RPG_GAMECORE_BLOCKCAMERADITHERUPDATE_METHOD_3_C3B0DC248D54DD8D_OFFSET UNITYSDK_OFFSET(0x1870B6A0)
#define RPG_GAMECORE_BLOCKCAMERADITHERUPDATE_METHOD_3_CE5A69633C5DF8FC_OFFSET UNITYSDK_OFFSET(0x1870B620)
#define RPG_GAMECORE_BLOCKCAMERADITHERUPDATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1870B670)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BlockCameraDitherUpdate_TypeDefinitionIndex = 21673;
