...
#define RPG_GAMECORE_RESETLOCALPLAYERLOOKATTARGETS_METHOD_3_9BFF259FC4212C56_OFFSET UNITYSDK_OFFSET(0x1D01BD30)
#define RPG_GAMECORE_RESETLOCALPLAYERLOOKATTARGETS_METHOD_3_9CCBF530B4800993_OFFSET UNITYSDK_OFFSET(0x1D01BC60)
#define RPG_GAMECORE_RESETLOCALPLAYERLOOKATTARGETS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D01BD20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetLocalPlayerLookAtTargets_TypeDefinitionIndex = 21109;
