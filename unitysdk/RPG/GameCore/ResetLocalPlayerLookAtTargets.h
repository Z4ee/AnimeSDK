...
#define RPG_GAMECORE_RESETLOCALPLAYERLOOKATTARGETS_METHOD_3_9BFF259FC4212C56_OFFSET UNITYSDK_OFFSET(0x18CAAA00)
#define RPG_GAMECORE_RESETLOCALPLAYERLOOKATTARGETS_METHOD_3_C584E8E3E8E1FE8A_OFFSET UNITYSDK_OFFSET(0x18CAA8F0)
#define RPG_GAMECORE_RESETLOCALPLAYERLOOKATTARGETS__CTOR_OFFSET UNITYSDK_OFFSET(0x18CAA9D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetLocalPlayerLookAtTargets_TypeDefinitionIndex = 20766;
