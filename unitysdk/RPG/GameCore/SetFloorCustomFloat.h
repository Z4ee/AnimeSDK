...
#define RPG_GAMECORE_SETFLOORCUSTOMFLOAT_METHOD_3_939F97F1592F9EFB_OFFSET UNITYSDK_OFFSET(0x176CEB10)
#define RPG_GAMECORE_SETFLOORCUSTOMFLOAT_METHOD_3_D7FDC0C14521E232_OFFSET UNITYSDK_OFFSET(0x176CEB90)
#define RPG_GAMECORE_SETFLOORCUSTOMFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x176CEB60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetFloorCustomFloat_TypeDefinitionIndex = 19008;
