...
#define RPG_GAMECORE_SETFLOORCUSTOMFLOAT_METHOD_3_939F97F1592F9EFB_OFFSET UNITYSDK_OFFSET(0x19C4EE50)
#define RPG_GAMECORE_SETFLOORCUSTOMFLOAT_METHOD_3_D7FDC0C14521E232_OFFSET UNITYSDK_OFFSET(0x19C4EED0)
#define RPG_GAMECORE_SETFLOORCUSTOMFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x19C4EEA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetFloorCustomFloat_TypeDefinitionIndex = 19546;
	...
	public:
		...
		static ::System::Void Method_3_939F97F1592F9EFB(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::SetFloorCustomFloat*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::SetFloorCustomFloat*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_SETFLOORCUSTOMFLOAT_METHOD_3_939F97F1592F9EFB_OFFSET))(a1, a2);
		}
