...
#define RPG_GAMECORE_SETFLOORCUSTOMFLOAT_METHOD_3_B98A6F11CE70042F_OFFSET UNITYSDK_OFFSET(0x1C5FA280)
#define RPG_GAMECORE_SETFLOORCUSTOMFLOAT_METHOD_3_D7FDC0C14521E232_OFFSET UNITYSDK_OFFSET(0x1C5FA2C0)
#define RPG_GAMECORE_SETFLOORCUSTOMFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5FA2B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetFloorCustomFloat_TypeDefinitionIndex = 19905;
