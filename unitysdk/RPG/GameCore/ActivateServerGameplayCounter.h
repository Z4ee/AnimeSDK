...
#define RPG_GAMECORE_ACTIVATESERVERGAMEPLAYCOUNTER_METHOD_3_0C8C831A5DB27871_OFFSET UNITYSDK_OFFSET(0x1C9EAEC0)
#define RPG_GAMECORE_ACTIVATESERVERGAMEPLAYCOUNTER_METHOD_3_EFDFFAF2B99A7295_OFFSET UNITYSDK_OFFSET(0x1C9EAF10)
#define RPG_GAMECORE_ACTIVATESERVERGAMEPLAYCOUNTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9EAF00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivateServerGameplayCounter_TypeDefinitionIndex = 20316;
