...
#define RPG_GAMECORE_ACTIVATESERVERGAMEPLAYCOUNTER_METHOD_3_3ECD3A4822037805_OFFSET UNITYSDK_OFFSET(0x193D0550)
#define RPG_GAMECORE_ACTIVATESERVERGAMEPLAYCOUNTER_METHOD_3_EFDFFAF2B99A7295_OFFSET UNITYSDK_OFFSET(0x193D05E0)
#define RPG_GAMECORE_ACTIVATESERVERGAMEPLAYCOUNTER__CTOR_OFFSET UNITYSDK_OFFSET(0x193D05B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivateServerGameplayCounter_TypeDefinitionIndex = 19412;
