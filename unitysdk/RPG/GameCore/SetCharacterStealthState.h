...
#define RPG_GAMECORE_SETCHARACTERSTEALTHSTATE_METHOD_3_44EDD5E8D15BE189_OFFSET UNITYSDK_OFFSET(0x176AEFD0)
#define RPG_GAMECORE_SETCHARACTERSTEALTHSTATE_METHOD_3_FC8C1D164FC0AED5_OFFSET UNITYSDK_OFFSET(0x176AEF50)
#define RPG_GAMECORE_SETCHARACTERSTEALTHSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x176AEFA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetCharacterStealthState_TypeDefinitionIndex = 21160;
