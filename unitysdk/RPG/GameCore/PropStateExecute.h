...
#define RPG_GAMECORE_PROPSTATEEXECUTE_METHOD_3_2E8BC4BD9B0D10A7_OFFSET UNITYSDK_OFFSET(0x18C79E40)
#define RPG_GAMECORE_PROPSTATEEXECUTE_METHOD_3_ADB244A01FB4DC73_OFFSET UNITYSDK_OFFSET(0x18C79CF0)
#define RPG_GAMECORE_PROPSTATEEXECUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x18C79DB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropStateExecute_TypeDefinitionIndex = 19388;
