...
#define RPG_GAMECORE_PROPSTATEEXECUTE_METHOD_3_2E8BC4BD9B0D10A7_OFFSET UNITYSDK_OFFSET(0x1D1869F0)
#define RPG_GAMECORE_PROPSTATEEXECUTE_METHOD_3_B47B1E41119A210D_OFFSET UNITYSDK_OFFSET(0x1D186970)
#define RPG_GAMECORE_PROPSTATEEXECUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1869C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropStateExecute_TypeDefinitionIndex = 20196;
