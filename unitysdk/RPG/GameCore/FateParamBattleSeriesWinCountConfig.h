...
#define RPG_GAMECORE_FATEPARAMBATTLESERIESWINCOUNTCONFIG_METHOD_6_75CF3E7DA5D5A763_OFFSET UNITYSDK_OFFSET(0x171C98E0)
#define RPG_GAMECORE_FATEPARAMBATTLESERIESWINCOUNTCONFIG_METHOD_6_E4F9EB737152113F_OFFSET UNITYSDK_OFFSET(0x171C9720)
#define RPG_GAMECORE_FATEPARAMBATTLESERIESWINCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171C9820)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateParamBattleSeriesWinCountConfig_TypeDefinitionIndex = 15236;
