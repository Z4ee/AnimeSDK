...
#define RPG_GAMECORE_FATEPARAMBATTLESERIESWINCOUNTCONFIG_METHOD_6_75CF3E7DA5D5A763_OFFSET UNITYSDK_OFFSET(0x19713560)
#define RPG_GAMECORE_FATEPARAMBATTLESERIESWINCOUNTCONFIG_METHOD_6_E4F9EB737152113F_OFFSET UNITYSDK_OFFSET(0x197133A0)
#define RPG_GAMECORE_FATEPARAMBATTLESERIESWINCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197134A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateParamBattleSeriesWinCountConfig_TypeDefinitionIndex = 15805;
