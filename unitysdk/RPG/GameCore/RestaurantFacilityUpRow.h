...
#define RPG_GAMECORE_RESTAURANTFACILITYUPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19AD5810)
#define RPG_GAMECORE_RESTAURANTFACILITYUPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19AD59D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RestaurantFacilityUpRow_TypeDefinitionIndex = 10898;
