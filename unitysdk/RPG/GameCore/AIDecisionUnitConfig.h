...
#define RPG_GAMECORE_AIDECISIONUNITCONFIG_METHOD_2_8041018F8B09F88A_OFFSET UNITYSDK_OFFSET(0x16E90560)
#define RPG_GAMECORE_AIDECISIONUNITCONFIG_METHOD_2_8BF179249F8F388F_OFFSET UNITYSDK_OFFSET(0x16E90340)
#define RPG_GAMECORE_AIDECISIONUNITCONFIG_METHOD_2_A8688DF3C9A1BF17_OFFSET UNITYSDK_OFFSET(0x16E90500)
#define RPG_GAMECORE_AIDECISIONUNITCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16E90170)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AIDecisionUnitConfig_TypeDefinitionIndex = 14178;
