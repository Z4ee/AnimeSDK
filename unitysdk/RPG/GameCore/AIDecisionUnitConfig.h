...
#define RPG_GAMECORE_AIDECISIONUNITCONFIG_METHOD_2_8041018F8B09F88A_OFFSET UNITYSDK_OFFSET(0x1B9F4630)
#define RPG_GAMECORE_AIDECISIONUNITCONFIG_METHOD_2_A8688DF3C9A1BF17_OFFSET UNITYSDK_OFFSET(0x1B9F45D0)
#define RPG_GAMECORE_AIDECISIONUNITCONFIG_METHOD_2_D236E48755858A70_OFFSET UNITYSDK_OFFSET(0x1B9F4400)
#define RPG_GAMECORE_AIDECISIONUNITCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9F41F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AIDecisionUnitConfig_TypeDefinitionIndex = 14873;
