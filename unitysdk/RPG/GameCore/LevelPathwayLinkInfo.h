...
#define RPG_GAMECORE_LEVELPATHWAYLINKINFO_METHOD_2_1E24738387669A54_OFFSET UNITYSDK_OFFSET(0x1D1E5710)
#define RPG_GAMECORE_LEVELPATHWAYLINKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1E5800)
