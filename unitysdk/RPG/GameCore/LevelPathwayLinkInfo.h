...
#define RPG_GAMECORE_LEVELPATHWAYLINKINFO_METHOD_2_1E24738387669A54_OFFSET UNITYSDK_OFFSET(0x1C128CB0)
#define RPG_GAMECORE_LEVELPATHWAYLINKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1C128DA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPathwayLinkInfo_TypeDefinitionIndex = 17056;
