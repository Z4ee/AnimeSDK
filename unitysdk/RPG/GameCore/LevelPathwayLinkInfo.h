...
#define RPG_GAMECORE_LEVELPATHWAYLINKINFO_METHOD_2_1E24738387669A54_OFFSET UNITYSDK_OFFSET(0x198817B0)
#define RPG_GAMECORE_LEVELPATHWAYLINKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x198818A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPathwayLinkInfo_TypeDefinitionIndex = 16402;
