...
#define RPG_GAMECORE_CONDITIONLOOPEXECUTETASKLIST_METHOD_3_35FC7B3FA7A88C54_OFFSET UNITYSDK_OFFSET(0x1712B6D0)
#define RPG_GAMECORE_CONDITIONLOOPEXECUTETASKLIST_METHOD_3_B0507D29BC589620_OFFSET UNITYSDK_OFFSET(0x1712B990)
#define RPG_GAMECORE_CONDITIONLOOPEXECUTETASKLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1712B910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConditionLoopExecuteTaskList_TypeDefinitionIndex = 21700;
