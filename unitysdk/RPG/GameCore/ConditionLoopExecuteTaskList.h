...
#define RPG_GAMECORE_CONDITIONLOOPEXECUTETASKLIST_METHOD_3_B0507D29BC589620_OFFSET UNITYSDK_OFFSET(0x1BC2ADD0)
#define RPG_GAMECORE_CONDITIONLOOPEXECUTETASKLIST_METHOD_3_B3E58AB1AEB32E5D_OFFSET UNITYSDK_OFFSET(0x1BC2AB60)
#define RPG_GAMECORE_CONDITIONLOOPEXECUTETASKLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC2AD70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConditionLoopExecuteTaskList_TypeDefinitionIndex = 22627;
