...
#define RPG_GAMECORE_CHENLINGENEMYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19628100)
#define RPG_GAMECORE_CHENLINGENEMYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x196285F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingEnemyRow_TypeDefinitionIndex = 10641;
	...
	public:
		...
		::System::UInt32 SoldierID; // 0x18
		::System::Boolean IsPromotion; // 0x1C
		::System::UInt32 ID; // 0x20
		::System::UInt32 GridIndex; // 0x24
		::System::UInt32 Level; // 0x28
		::RPG::GameCore::FixPoint AtkSpdRatio; // 0x30
		::RPG::GameCore::FixPoint CrtRatio; // 0x38
		::RPG::GameCore::FixPoint AtkRatio; // 0x40
		::RPG::GameCore::FixPoint CrtDMGRatio; // 0x48
		::RPG::GameCore::FixPoint HpRatio; // 0x50
