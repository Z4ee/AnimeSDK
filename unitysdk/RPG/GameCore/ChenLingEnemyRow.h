...
#define RPG_GAMECORE_CHENLINGENEMYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17085780)
#define RPG_GAMECORE_CHENLINGENEMYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17085C80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingEnemyRow_TypeDefinitionIndex = 10378;
	...
	public:
		...
		::RPG::GameCore::FixPoint AtkSpdRatio; // 0x20
		::System::UInt32 ID; // 0x28
		::System::Boolean IsPromotion; // 0x2C
		::System::UInt32 SoldierID; // 0x30
		::RPG::GameCore::FixPoint AtkRatio; // 0x38
		::RPG::GameCore::FixPoint HpRatio; // 0x40
		::System::UInt32 GridIndex; // 0x48
