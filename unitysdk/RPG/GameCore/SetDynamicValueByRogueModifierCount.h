...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEMODIFIERCOUNT_METHOD_3_5A5AA031A54FE7C5_OFFSET UNITYSDK_OFFSET(0x19C43C70)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEMODIFIERCOUNT_METHOD_3_ACFB775851E8DE6A_OFFSET UNITYSDK_OFFSET(0x19C43CE0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEMODIFIERCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x19C43CB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRogueModifierCount_TypeDefinitionIndex = 20576;
