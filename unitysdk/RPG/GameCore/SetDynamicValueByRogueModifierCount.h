...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEMODIFIERCOUNT_METHOD_3_9345A10A4C1767B7_OFFSET UNITYSDK_OFFSET(0x1E822240)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEMODIFIERCOUNT_METHOD_3_ACFB775851E8DE6A_OFFSET UNITYSDK_OFFSET(0x1E822280)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEMODIFIERCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E822270)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRogueModifierCount_TypeDefinitionIndex = 21549;
