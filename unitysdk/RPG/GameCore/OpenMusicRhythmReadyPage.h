...
#define RPG_GAMECORE_OPENMUSICRHYTHMREADYPAGE_METHOD_3_C03C9C9F26695C71_OFFSET UNITYSDK_OFFSET(0x1BB01930)
#define RPG_GAMECORE_OPENMUSICRHYTHMREADYPAGE_METHOD_3_F83897564E362D04_OFFSET UNITYSDK_OFFSET(0x1BB01970)
#define RPG_GAMECORE_OPENMUSICRHYTHMREADYPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB01960)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OpenMusicRhythmReadyPage_TypeDefinitionIndex = 21247;
