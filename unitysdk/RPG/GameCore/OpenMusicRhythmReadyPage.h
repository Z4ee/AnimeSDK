...
#define RPG_GAMECORE_OPENMUSICRHYTHMREADYPAGE_METHOD_3_0D24A1B75981465B_OFFSET UNITYSDK_OFFSET(0x1747C6D0)
#define RPG_GAMECORE_OPENMUSICRHYTHMREADYPAGE_METHOD_3_6D7096C1AB6C9148_OFFSET UNITYSDK_OFFSET(0x1747C650)
#define RPG_GAMECORE_OPENMUSICRHYTHMREADYPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1747C6A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OpenMusicRhythmReadyPage_TypeDefinitionIndex = 20237;
