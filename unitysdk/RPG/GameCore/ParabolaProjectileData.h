...
#define RPG_GAMECORE_PARABOLAPROJECTILEDATA_METHOD_3_36EE5E8D949764CA_OFFSET UNITYSDK_OFFSET(0x1D308C90)
#define RPG_GAMECORE_PARABOLAPROJECTILEDATA_METHOD_3_5462F205E5EBE9E9_OFFSET UNITYSDK_OFFSET(0x1D308CE0)
#define RPG_GAMECORE_PARABOLAPROJECTILEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1D308CD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ParabolaProjectileData_TypeDefinitionIndex = 15494;
