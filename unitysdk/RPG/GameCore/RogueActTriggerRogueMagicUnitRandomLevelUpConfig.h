...
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMAGICUNITRANDOMLEVELUPCONFIG_METHOD_6_88F86DB99EA651A3_OFFSET UNITYSDK_OFFSET(0x1C49EA40)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMAGICUNITRANDOMLEVELUPCONFIG_METHOD_6_AE395256041D4827_OFFSET UNITYSDK_OFFSET(0x1C49EA90)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMAGICUNITRANDOMLEVELUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C49EA80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActTriggerRogueMagicUnitRandomLevelUpConfig_TypeDefinitionIndex = 18926;
