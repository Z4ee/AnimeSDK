...
#define RPG_GAMECORE_CHENLINGWAVEEXPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x187EEFC0)
#define RPG_GAMECORE_CHENLINGWAVEEXPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x187EF0E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingWaveExpRow_TypeDefinitionIndex = 10607;
