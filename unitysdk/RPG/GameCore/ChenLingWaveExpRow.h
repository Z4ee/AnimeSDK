...
#define RPG_GAMECORE_CHENLINGWAVEEXPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19630F50)
#define RPG_GAMECORE_CHENLINGWAVEEXPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19631070)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingWaveExpRow_TypeDefinitionIndex = 10645;
