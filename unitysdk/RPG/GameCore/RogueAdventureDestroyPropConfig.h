...
#define RPG_GAMECORE_ROGUEADVENTUREDESTROYPROPCONFIG_METHOD_3_97D22BDB99681BE4_OFFSET UNITYSDK_OFFSET(0x175DC160)
#define RPG_GAMECORE_ROGUEADVENTUREDESTROYPROPCONFIG_METHOD_3_D0E437E4310F06A8_OFFSET UNITYSDK_OFFSET(0x175DC1D0)
#define RPG_GAMECORE_ROGUEADVENTUREDESTROYPROPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175DC150)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueAdventureDestroyPropConfig_TypeDefinitionIndex = 16433;
