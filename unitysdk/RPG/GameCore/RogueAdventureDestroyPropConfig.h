...
#define RPG_GAMECORE_ROGUEADVENTUREDESTROYPROPCONFIG_METHOD_3_97D22BDB99681BE4_OFFSET UNITYSDK_OFFSET(0x19B0CB00)
#define RPG_GAMECORE_ROGUEADVENTUREDESTROYPROPCONFIG_METHOD_3_D0E437E4310F06A8_OFFSET UNITYSDK_OFFSET(0x19B0CB70)
#define RPG_GAMECORE_ROGUEADVENTUREDESTROYPROPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B0CAF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueAdventureDestroyPropConfig_TypeDefinitionIndex = 17002;
