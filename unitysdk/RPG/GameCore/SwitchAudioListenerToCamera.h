...
#define RPG_GAMECORE_SWITCHAUDIOLISTENERTOCAMERA_METHOD_3_3359703AC7FF383E_OFFSET UNITYSDK_OFFSET(0x17791550)
#define RPG_GAMECORE_SWITCHAUDIOLISTENERTOCAMERA_METHOD_3_3F70BE524BA17F0F_OFFSET UNITYSDK_OFFSET(0x177914D0)
#define RPG_GAMECORE_SWITCHAUDIOLISTENERTOCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x17791520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchAudioListenerToCamera_TypeDefinitionIndex = 20444;
