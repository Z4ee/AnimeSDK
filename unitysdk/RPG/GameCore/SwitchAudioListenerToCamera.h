...
#define RPG_GAMECORE_SWITCHAUDIOLISTENERTOCAMERA_METHOD_3_3359703AC7FF383E_OFFSET UNITYSDK_OFFSET(0x1B433130)
#define RPG_GAMECORE_SWITCHAUDIOLISTENERTOCAMERA_METHOD_3_B58DA49E2AD1CDFD_OFFSET UNITYSDK_OFFSET(0x1B4330F0)
#define RPG_GAMECORE_SWITCHAUDIOLISTENERTOCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B433120)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchAudioListenerToCamera_TypeDefinitionIndex = 21441;
