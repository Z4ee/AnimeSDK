...
#define RPG_GAMECORE_SWITCHAUDIOLISTENERTOCAMERA_METHOD_3_3359703AC7FF383E_OFFSET UNITYSDK_OFFSET(0x18EB7990)
#define RPG_GAMECORE_SWITCHAUDIOLISTENERTOCAMERA_METHOD_3_3F70BE524BA17F0F_OFFSET UNITYSDK_OFFSET(0x18EB7910)
#define RPG_GAMECORE_SWITCHAUDIOLISTENERTOCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x18EB7960)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchAudioListenerToCamera_TypeDefinitionIndex = 21126;
