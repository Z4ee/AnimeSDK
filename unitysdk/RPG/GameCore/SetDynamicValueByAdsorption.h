...
#define RPG_GAMECORE_SETDYNAMICVALUEBYADSORPTION_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1C2DE710)
#define RPG_GAMECORE_SETDYNAMICVALUEBYADSORPTION_METHOD_4_D2ECB7F547235812_OFFSET UNITYSDK_OFFSET(0x1C2DE4D0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYADSORPTION_METHOD_4_FEB84096FF7BE1A3_OFFSET UNITYSDK_OFFSET(0x1C2DE510)
#define RPG_GAMECORE_SETDYNAMICVALUEBYADSORPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2DE500)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByAdsorption_TypeDefinitionIndex = 22982;
