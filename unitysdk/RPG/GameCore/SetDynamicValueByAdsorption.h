...
#define RPG_GAMECORE_SETDYNAMICVALUEBYADSORPTION_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1D4ED190)
#define RPG_GAMECORE_SETDYNAMICVALUEBYADSORPTION_METHOD_4_D2ECB7F547235812_OFFSET UNITYSDK_OFFSET(0x1D4ECF50)
#define RPG_GAMECORE_SETDYNAMICVALUEBYADSORPTION_METHOD_4_FEB84096FF7BE1A3_OFFSET UNITYSDK_OFFSET(0x1D4ECF90)
#define RPG_GAMECORE_SETDYNAMICVALUEBYADSORPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4ECF80)
