...
#define RPG_GAMECORE_MARBLEIMMUNEATTACKBACK_METHOD_3_82C3A20302CAF206_OFFSET UNITYSDK_OFFSET(0x18A9DD00)
#define RPG_GAMECORE_MARBLEIMMUNEATTACKBACK_METHOD_3_FE3B6A08AA2CF94D_OFFSET UNITYSDK_OFFSET(0x18A9DDE0)
#define RPG_GAMECORE_MARBLEIMMUNEATTACKBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18A9DD90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleImmuneAttackBack_TypeDefinitionIndex = 15962;
