...
#define RPG_GAMECORE_HIGHLIGHTENTITYACTIONBAR_METHOD_3_ED87F0319DC35E75_OFFSET UNITYSDK_OFFSET(0x18A00480)
#define RPG_GAMECORE_HIGHLIGHTENTITYACTIONBAR_METHOD_3_FFFE3DA12FCADB44_OFFSET UNITYSDK_OFFSET(0x18A00500)
#define RPG_GAMECORE_HIGHLIGHTENTITYACTIONBAR__CTOR_OFFSET UNITYSDK_OFFSET(0x18A004D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HighlightEntityActionBar_TypeDefinitionIndex = 22688;
