...
#define RPG_GAMECORE_HIGHLIGHTENTITYACTIONBAR_METHOD_3_C93C9E074B08201F_OFFSET UNITYSDK_OFFSET(0x1D18EDC0)
#define RPG_GAMECORE_HIGHLIGHTENTITYACTIONBAR_METHOD_3_FFFE3DA12FCADB44_OFFSET UNITYSDK_OFFSET(0x1D18EE00)
#define RPG_GAMECORE_HIGHLIGHTENTITYACTIONBAR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D18EDF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HighlightEntityActionBar_TypeDefinitionIndex = 23424;
