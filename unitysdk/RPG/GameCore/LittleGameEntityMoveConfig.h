...
#define RPG_GAMECORE_LITTLEGAMEENTITYMOVECONFIG_METHOD_2_8F1CE4421F1867F5_OFFSET UNITYSDK_OFFSET(0x1989E4B0)
#define RPG_GAMECORE_LITTLEGAMEENTITYMOVECONFIG_METHOD_2_F21F6AF1249DAA41_OFFSET UNITYSDK_OFFSET(0x1989E6C0)
#define RPG_GAMECORE_LITTLEGAMEENTITYMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1989E6B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameEntityMoveConfig_TypeDefinitionIndex = 17957;
