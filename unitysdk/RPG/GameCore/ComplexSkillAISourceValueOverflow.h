...
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEVALUEOVERFLOW_METHOD_3_5BF47B069F90D2CF_OFFSET UNITYSDK_OFFSET(0x1BC29370)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEVALUEOVERFLOW_METHOD_3_B7B37BDB5B2AF4EF_OFFSET UNITYSDK_OFFSET(0x1BC293D0)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEVALUEOVERFLOW__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC293C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAISourceValueOverflow_TypeDefinitionIndex = 14921;
