...
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEVALUEOVERFLOW_METHOD_3_9250060A6E6A14EB_OFFSET UNITYSDK_OFFSET(0x18830600)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEVALUEOVERFLOW_METHOD_3_B7B37BDB5B2AF4EF_OFFSET UNITYSDK_OFFSET(0x1882F6E0)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEVALUEOVERFLOW__CTOR_OFFSET UNITYSDK_OFFSET(0x1882F6C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAISourceValueOverflow_TypeDefinitionIndex = 14696;
