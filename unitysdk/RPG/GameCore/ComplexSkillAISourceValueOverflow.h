...
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEVALUEOVERFLOW_METHOD_3_9250060A6E6A14EB_OFFSET UNITYSDK_OFFSET(0x17129720)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEVALUEOVERFLOW_METHOD_3_B7B37BDB5B2AF4EF_OFFSET UNITYSDK_OFFSET(0x17128910)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEVALUEOVERFLOW__CTOR_OFFSET UNITYSDK_OFFSET(0x171288F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAISourceValueOverflow_TypeDefinitionIndex = 14226;
