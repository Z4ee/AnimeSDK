...
#define RPG_GAMECORE_LEVELROTATABLEREGIONPOSEBAKEDINFO_DISPOSE_OFFSET UNITYSDK_OFFSET(0x82F250)
#define RPG_GAMECORE_LEVELROTATABLEREGIONPOSEBAKEDINFO_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x3C0BEB0)
#define RPG_GAMECORE_LEVELROTATABLEREGIONPOSEBAKEDINFO_EQUALS_OFFSET UNITYSDK_OFFSET(0x125C0)
#define RPG_GAMECORE_LEVELROTATABLEREGIONPOSEBAKEDINFO_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x860F00)
#define RPG_GAMECORE_LEVELROTATABLEREGIONPOSEBAKEDINFO_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x860E40)
#define RPG_GAMECORE_LEVELROTATABLEREGIONPOSEBAKEDINFO_GET_NAVMESHLARGEMONSTER_OFFSET UNITYSDK_OFFSET(0x3C0BF30)
#define RPG_GAMECORE_LEVELROTATABLEREGIONPOSEBAKEDINFO_GET_NAVMESH_OFFSET UNITYSDK_OFFSET(0x3C0BEC0)
#define RPG_GAMECORE_LEVELROTATABLEREGIONPOSEBAKEDINFO_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0x12370)
#define RPG_GAMECORE_LEVELROTATABLEREGIONPOSEBAKEDINFO_GET_POOL_OFFSET UNITYSDK_OFFSET(0x161E0)
#define RPG_GAMECORE_LEVELROTATABLEREGIONPOSEBAKEDINFO_INIT_OFFSET UNITYSDK_OFFSET(0x6B82D0)
#define RPG_GAMECORE_LEVELROTATABLEREGIONPOSEBAKEDINFO_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1DD57660)
#define RPG_GAMECORE_LEVELROTATABLEREGIONPOSEBAKEDINFO_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1DD578A0)
#define RPG_GAMECORE_LEVELROTATABLEREGIONPOSEBAKEDINFO_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1DD57770)
#define RPG_GAMECORE_LEVELROTATABLEREGIONPOSEBAKEDINFO_OP_LOGICALNOT_OFFSET UNITYSDK_OFFSET(0x1DD57950)
#define RPG_GAMECORE_LEVELROTATABLEREGIONPOSEBAKEDINFO_SET_NAVMESHLARGEMONSTER_OFFSET UNITYSDK_OFFSET(0x3C0BF50)
#define RPG_GAMECORE_LEVELROTATABLEREGIONPOSEBAKEDINFO_SET_NAVMESH_OFFSET UNITYSDK_OFFSET(0x3C0BEE0)
