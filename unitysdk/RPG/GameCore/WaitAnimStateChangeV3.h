...
#define RPG_GAMECORE_WAITANIMSTATECHANGEV3_METHOD_4_CC8325DC55F33A8F_OFFSET UNITYSDK_OFFSET(0x1B8A0920)
#define RPG_GAMECORE_WAITANIMSTATECHANGEV3_METHOD_4_FACD0A6E4828D2F3_OFFSET UNITYSDK_OFFSET(0x1B8A0970)
#define RPG_GAMECORE_WAITANIMSTATECHANGEV3__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8A0960)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitAnimStateChangeV3_TypeDefinitionIndex = 21487;
