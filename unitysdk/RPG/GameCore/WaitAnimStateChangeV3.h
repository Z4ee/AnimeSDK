...
#define RPG_GAMECORE_WAITANIMSTATECHANGEV3_METHOD_4_B2CBBDEED6E14E74_OFFSET UNITYSDK_OFFSET(0x190F8AA0)
#define RPG_GAMECORE_WAITANIMSTATECHANGEV3_METHOD_4_FACD0A6E4828D2F3_OFFSET UNITYSDK_OFFSET(0x190F8B80)
#define RPG_GAMECORE_WAITANIMSTATECHANGEV3__CTOR_OFFSET UNITYSDK_OFFSET(0x190F8B20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitAnimStateChangeV3_TypeDefinitionIndex = 21175;
