...
#define RPG_GAMECORE_FIVEDIMSETPLAYERINVINCIBLEACTION_METHOD_3_78BF4E00A274154D_OFFSET UNITYSDK_OFFSET(0x1BEB1060)
#define RPG_GAMECORE_FIVEDIMSETPLAYERINVINCIBLEACTION_METHOD_3_8C2936CFBC469A08_OFFSET UNITYSDK_OFFSET(0x1BEB1010)
#define RPG_GAMECORE_FIVEDIMSETPLAYERINVINCIBLEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEB1050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSetPlayerInvincibleAction_TypeDefinitionIndex = 17977;
