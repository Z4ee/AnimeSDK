...
#define RPG_GAMECORE_TUTORIALSETMONOPOLYPAUSESTATE_METHOD_3_53610D296C27B10A_OFFSET UNITYSDK_OFFSET(0x178DF2F0)
#define RPG_GAMECORE_TUTORIALSETMONOPOLYPAUSESTATE_METHOD_3_8D88FC75419F5053_OFFSET UNITYSDK_OFFSET(0x178DF270)
#define RPG_GAMECORE_TUTORIALSETMONOPOLYPAUSESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x178DF2C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TutorialSetMonopolyPauseState_TypeDefinitionIndex = 22408;
