...
#define RPG_GAMECORE_ELFWAVECONFIG_METHOD_2_0680375E610F94B8_OFFSET UNITYSDK_OFFSET(0x1BB3AB00)
#define RPG_GAMECORE_ELFWAVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB3AD10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfWaveConfig_TypeDefinitionIndex = 17744;
