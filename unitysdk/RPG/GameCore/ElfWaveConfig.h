...
#define RPG_GAMECORE_ELFWAVECONFIG_METHOD_2_0680375E610F94B8_OFFSET UNITYSDK_OFFSET(0x1D7B7D10)
#define RPG_GAMECORE_ELFWAVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7B7F20)
