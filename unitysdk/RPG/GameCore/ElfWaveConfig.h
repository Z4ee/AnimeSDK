...
#define RPG_GAMECORE_ELFWAVECONFIG_METHOD_2_0680375E610F94B8_OFFSET UNITYSDK_OFFSET(0x196DE680)
#define RPG_GAMECORE_ELFWAVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x196DE890)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfWaveConfig_TypeDefinitionIndex = 17571;
