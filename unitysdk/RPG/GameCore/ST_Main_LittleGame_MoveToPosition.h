...
#define RPG_GAMECORE_ST_MAIN_LITTLEGAME_MOVETOPOSITION_METHOD_4_05D2253AFA090F13_OFFSET UNITYSDK_OFFSET(0x1B784C20)
#define RPG_GAMECORE_ST_MAIN_LITTLEGAME_MOVETOPOSITION_METHOD_4_E3B5DFD1B82095AE_OFFSET UNITYSDK_OFFSET(0x1B784BE0)
#define RPG_GAMECORE_ST_MAIN_LITTLEGAME_MOVETOPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B784C10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_LittleGame_MoveToPosition_TypeDefinitionIndex = 20529;
