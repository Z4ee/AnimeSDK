...
#define RPG_GAMECORE_TRAINPARTYSTATUSRANKCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D5E1EB0)
#define RPG_GAMECORE_TRAINPARTYSTATUSRANKCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5E2020)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyStatusRankConfigRow_TypeDefinitionIndex = 15143;
