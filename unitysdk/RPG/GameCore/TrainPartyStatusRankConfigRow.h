...
#define RPG_GAMECORE_TRAINPARTYSTATUSRANKCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19DF9B30)
#define RPG_GAMECORE_TRAINPARTYSTATUSRANKCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19DF9CA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyStatusRankConfigRow_TypeDefinitionIndex = 14549;
