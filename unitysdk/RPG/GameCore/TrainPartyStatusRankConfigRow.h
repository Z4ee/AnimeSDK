...
#define RPG_GAMECORE_TRAINPARTYSTATUSRANKCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x190AEEA0)
#define RPG_GAMECORE_TRAINPARTYSTATUSRANKCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x190AF010)
