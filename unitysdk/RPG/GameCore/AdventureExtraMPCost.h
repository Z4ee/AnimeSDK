...
#define RPG_GAMECORE_ADVENTUREEXTRAMPCOST_METHOD_3_4DF6BFC4AC8D6CC1_OFFSET UNITYSDK_OFFSET(0x1CBB8A20)
#define RPG_GAMECORE_ADVENTUREEXTRAMPCOST_METHOD_3_6A7B67DEE3A1C974_OFFSET UNITYSDK_OFFSET(0x1CBB8A60)
#define RPG_GAMECORE_ADVENTUREEXTRAMPCOST__CTOR_OFFSET UNITYSDK_OFFSET(0x1CBB8A50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureExtraMPCost_TypeDefinitionIndex = 21558;
