...
#define RPG_GAMECORE_ADVENTUREEXTRAMPCOST_METHOD_3_37075FB98627E0DB_OFFSET UNITYSDK_OFFSET(0x16F538E0)
#define RPG_GAMECORE_ADVENTUREEXTRAMPCOST_METHOD_3_6A7B67DEE3A1C974_OFFSET UNITYSDK_OFFSET(0x16F53960)
#define RPG_GAMECORE_ADVENTUREEXTRAMPCOST__CTOR_OFFSET UNITYSDK_OFFSET(0x16F53930)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureExtraMPCost_TypeDefinitionIndex = 19972;
