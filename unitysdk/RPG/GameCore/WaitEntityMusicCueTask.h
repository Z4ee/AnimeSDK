...
#define RPG_GAMECORE_WAITENTITYMUSICCUETASK_DISPOSE_OFFSET UNITYSDK_OFFSET(0xE7DAB10)
#define RPG_GAMECORE_WAITENTITYMUSICCUETASK_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0xE7DACA0)
#define RPG_GAMECORE_WAITENTITYMUSICCUETASK_ONMUSICCUE_OFFSET UNITYSDK_OFFSET(0xE7DAF90)
#define RPG_GAMECORE_WAITENTITYMUSICCUETASK_ONSKIP_OFFSET UNITYSDK_OFFSET(0xE7DAF40)
#define RPG_GAMECORE_WAITENTITYMUSICCUETASK_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xE7DACB0)
#define RPG_GAMECORE_WAITENTITYMUSICCUETASK_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xE7DADC0)
#define RPG_GAMECORE_WAITENTITYMUSICCUETASK_TICK_OFFSET UNITYSDK_OFFSET(0xE7DAE50)
#define RPG_GAMECORE_WAITENTITYMUSICCUETASK__CTOR_OFFSET UNITYSDK_OFFSET(0xE7DAA80)
#define RPG_GAMECORE_WAITENTITYMUSICCUETASK__REGIST_OFFSET UNITYSDK_OFFSET(0xE7DAD00)
#define RPG_GAMECORE_WAITENTITYMUSICCUETASK__UNREGIST_OFFSET UNITYSDK_OFFSET(0xE7DABF0)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::Class_3_07C3C4D2990C49EE* _OnCueHitSeq; // 0x18
