...
#define RPG_GAMECORE_MARBLECONVERTBUFF_METHOD_3_6119D693D1F853EA_OFFSET UNITYSDK_OFFSET(0x18A9ADC0)
#define RPG_GAMECORE_MARBLECONVERTBUFF_METHOD_3_E275F49EEBB31610_OFFSET UNITYSDK_OFFSET(0x18A9ACE0)
#define RPG_GAMECORE_MARBLECONVERTBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x18A9AD70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleConvertBuff_TypeDefinitionIndex = 15937;
