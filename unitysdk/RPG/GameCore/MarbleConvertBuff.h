...
#define RPG_GAMECORE_MARBLECONVERTBUFF_METHOD_3_6119D693D1F853EA_OFFSET UNITYSDK_OFFSET(0x1D4A7260)
#define RPG_GAMECORE_MARBLECONVERTBUFF_METHOD_3_72126B4789BC8F4A_OFFSET UNITYSDK_OFFSET(0x1D4A7200)
#define RPG_GAMECORE_MARBLECONVERTBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4A7250)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleConvertBuff_TypeDefinitionIndex = 16657;
