...
#define RPG_GAMECORE_SETMISSIONWAYPOINT_METHOD_3_24AE18F9EDC60A25_OFFSET UNITYSDK_OFFSET(0x18E38E40)
#define RPG_GAMECORE_SETMISSIONWAYPOINT_METHOD_3_5071B28D5979FD1E_OFFSET UNITYSDK_OFFSET(0x18E38DC0)
#define RPG_GAMECORE_SETMISSIONWAYPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x18E38E10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetMissionWayPoint_TypeDefinitionIndex = 19739;
