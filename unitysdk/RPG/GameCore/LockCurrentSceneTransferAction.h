...
#define RPG_GAMECORE_LOCKCURRENTSCENETRANSFERACTION_METHOD_3_6715D7B0F9C4241B_OFFSET UNITYSDK_OFFSET(0x1736A700)
#define RPG_GAMECORE_LOCKCURRENTSCENETRANSFERACTION_METHOD_3_773669F5B8F7C352_OFFSET UNITYSDK_OFFSET(0x1736A780)
#define RPG_GAMECORE_LOCKCURRENTSCENETRANSFERACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1736A750)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LockCurrentSceneTransferAction_TypeDefinitionIndex = 19841;
