...
#define RPG_GAMECORE_LOCKCURRENTSCENETRANSFERACTION_METHOD_3_49AFBD0849705BCF_OFFSET UNITYSDK_OFFSET(0x1D20FB10)
#define RPG_GAMECORE_LOCKCURRENTSCENETRANSFERACTION_METHOD_3_773669F5B8F7C352_OFFSET UNITYSDK_OFFSET(0x1D20FB50)
#define RPG_GAMECORE_LOCKCURRENTSCENETRANSFERACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D20FB40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LockCurrentSceneTransferAction_TypeDefinitionIndex = 21429;
