...
#define RPG_GAMECORE_LOCKCURRENTSCENETRANSFERACTION_METHOD_3_6715D7B0F9C4241B_OFFSET UNITYSDK_OFFSET(0x18A78310)
#define RPG_GAMECORE_LOCKCURRENTSCENETRANSFERACTION_METHOD_3_773669F5B8F7C352_OFFSET UNITYSDK_OFFSET(0x18A78390)
#define RPG_GAMECORE_LOCKCURRENTSCENETRANSFERACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18A78360)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LockCurrentSceneTransferAction_TypeDefinitionIndex = 20522;
