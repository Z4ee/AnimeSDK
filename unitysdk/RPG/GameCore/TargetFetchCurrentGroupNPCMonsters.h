...
#define RPG_GAMECORE_TARGETFETCHCURRENTGROUPNPCMONSTERS_METHOD_4_25760FD1A0312A66_OFFSET UNITYSDK_OFFSET(0x177B4860)
#define RPG_GAMECORE_TARGETFETCHCURRENTGROUPNPCMONSTERS_METHOD_4_56BAB6EF1577BFA4_OFFSET UNITYSDK_OFFSET(0x177BE2C0)
#define RPG_GAMECORE_TARGETFETCHCURRENTGROUPNPCMONSTERS__CTOR_OFFSET UNITYSDK_OFFSET(0x177B4810)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchCurrentGroupNPCMonsters_TypeDefinitionIndex = 22133;
