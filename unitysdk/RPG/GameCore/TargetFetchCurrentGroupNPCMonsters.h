...
#define RPG_GAMECORE_TARGETFETCHCURRENTGROUPNPCMONSTERS_METHOD_4_25760FD1A0312A66_OFFSET UNITYSDK_OFFSET(0x1D0B91E0)
#define RPG_GAMECORE_TARGETFETCHCURRENTGROUPNPCMONSTERS_METHOD_4_2F6D5308EB922E66_OFFSET UNITYSDK_OFFSET(0x1D0B9260)
#define RPG_GAMECORE_TARGETFETCHCURRENTGROUPNPCMONSTERS_METHOD_4_8B7FDA2052AAD3D7_OFFSET UNITYSDK_OFFSET(0x1D0B9160)
#define RPG_GAMECORE_TARGETFETCHCURRENTGROUPNPCMONSTERS_METHOD_4_A03E8F9088546313_OFFSET UNITYSDK_OFFSET(0x1D0B9240)
#define RPG_GAMECORE_TARGETFETCHCURRENTGROUPNPCMONSTERS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0B91D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchCurrentGroupNPCMonsters_TypeDefinitionIndex = 23014;
