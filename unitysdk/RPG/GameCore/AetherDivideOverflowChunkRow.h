...
#define RPG_GAMECORE_AETHERDIVIDEOVERFLOWCHUNKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16F63D60)
#define RPG_GAMECORE_AETHERDIVIDEOVERFLOWCHUNKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16F63F80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AetherDivideOverflowChunkRow_TypeDefinitionIndex = 10250;
