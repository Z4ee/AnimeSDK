...
#define RPG_GAMECORE_DEACTIVEFARMELEMENT_METHOD_3_7706044986DEBDB0_OFFSET UNITYSDK_OFFSET(0x188535A0)
#define RPG_GAMECORE_DEACTIVEFARMELEMENT_METHOD_3_F26E4C9C1C088BE9_OFFSET UNITYSDK_OFFSET(0x18853620)
#define RPG_GAMECORE_DEACTIVEFARMELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x188535F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DeactiveFarmElement_TypeDefinitionIndex = 20951;
