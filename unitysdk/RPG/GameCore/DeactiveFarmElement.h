...
#define RPG_GAMECORE_DEACTIVEFARMELEMENT_METHOD_3_ABFAB33E735B5E62_OFFSET UNITYSDK_OFFSET(0x1D80FB10)
#define RPG_GAMECORE_DEACTIVEFARMELEMENT_METHOD_3_F26E4C9C1C088BE9_OFFSET UNITYSDK_OFFSET(0x1D80FB50)
#define RPG_GAMECORE_DEACTIVEFARMELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D80FB40)
