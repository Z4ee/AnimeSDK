...
#define RPG_GAMECORE_BYCOMPAREMATCHTHREEBIRDLOCATION_METHOD_4_50A89E2182EADD97_OFFSET UNITYSDK_OFFSET(0x1700E570)
#define RPG_GAMECORE_BYCOMPAREMATCHTHREEBIRDLOCATION_METHOD_4_94599E0E08FF9385_OFFSET UNITYSDK_OFFSET(0x1700E4A0)
#define RPG_GAMECORE_BYCOMPAREMATCHTHREEBIRDLOCATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1700E520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareMatchThreeBirdLocation_TypeDefinitionIndex = 19313;
