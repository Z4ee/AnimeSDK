...
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_ADDBUFF_METHOD_3_32CB6CD7CFBDD673_OFFSET UNITYSDK_OFFSET(0x1961FFF0)
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_ADDBUFF_METHOD_3_BA3DED6B6923F49D_OFFSET UNITYSDK_OFFSET(0x1961FF90)
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_ADDBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x1961FFE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleEffect_AddBuff_TypeDefinitionIndex = 15022;
