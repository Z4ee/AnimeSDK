...
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_ADDBUFF_METHOD_3_32CB6CD7CFBDD673_OFFSET UNITYSDK_OFFSET(0x187E2340)
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_ADDBUFF_METHOD_3_BA3DED6B6923F49D_OFFSET UNITYSDK_OFFSET(0x187E22E0)
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_ADDBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x187E2330)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleEffect_AddBuff_TypeDefinitionIndex = 14959;
