...
#define RPG_GAMECORE_ST_SIDE_ELFCHANGEANIMSTATE_METHOD_4_619117BBE6B7F6B8_OFFSET UNITYSDK_OFFSET(0x18DF6A00)
#define RPG_GAMECORE_ST_SIDE_ELFCHANGEANIMSTATE_METHOD_4_7F104796C36C2204_OFFSET UNITYSDK_OFFSET(0x18DF6930)
#define RPG_GAMECORE_ST_SIDE_ELFCHANGEANIMSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18DF69B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_ElfChangeAnimState_TypeDefinitionIndex = 20400;
