...
#define RPG_GAMECORE_CONFIGMUNICIPAL_METHOD_2_38B4767EF89DF362_OFFSET UNITYSDK_OFFSET(0x1CFF9F20)
#define RPG_GAMECORE_CONFIGMUNICIPAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFFA150)
