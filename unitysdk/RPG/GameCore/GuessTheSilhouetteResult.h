...
#define RPG_GAMECORE_GUESSTHESILHOUETTERESULT_METHOD_3_C74B0655A9FB0B42_OFFSET UNITYSDK_OFFSET(0x1B668480)
#define RPG_GAMECORE_GUESSTHESILHOUETTERESULT_METHOD_3_F2BF947F5EC763E9_OFFSET UNITYSDK_OFFSET(0x1B668440)
#define RPG_GAMECORE_GUESSTHESILHOUETTERESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B668470)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GuessTheSilhouetteResult_TypeDefinitionIndex = 20377;
