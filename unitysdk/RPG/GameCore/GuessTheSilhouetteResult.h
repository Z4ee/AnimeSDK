...
#define RPG_GAMECORE_GUESSTHESILHOUETTERESULT_METHOD_3_12D8D67AF20D8406_OFFSET UNITYSDK_OFFSET(0x19815670)
#define RPG_GAMECORE_GUESSTHESILHOUETTERESULT_METHOD_3_C74B0655A9FB0B42_OFFSET UNITYSDK_OFFSET(0x198156F0)
#define RPG_GAMECORE_GUESSTHESILHOUETTERESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x198156C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GuessTheSilhouetteResult_TypeDefinitionIndex = 20005;
