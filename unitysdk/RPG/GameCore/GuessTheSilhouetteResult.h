...
#define RPG_GAMECORE_GUESSTHESILHOUETTERESULT_METHOD_3_12D8D67AF20D8406_OFFSET UNITYSDK_OFFSET(0x189E2230)
#define RPG_GAMECORE_GUESSTHESILHOUETTERESULT_METHOD_3_C74B0655A9FB0B42_OFFSET UNITYSDK_OFFSET(0x189E22B0)
#define RPG_GAMECORE_GUESSTHESILHOUETTERESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x189E2280)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GuessTheSilhouetteResult_TypeDefinitionIndex = 20148;
