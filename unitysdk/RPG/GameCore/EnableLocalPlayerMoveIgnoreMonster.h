...
#define RPG_GAMECORE_ENABLELOCALPLAYERMOVEIGNOREMONSTER_METHOD_3_911F05D7A5E07D3B_OFFSET UNITYSDK_OFFSET(0x1BB40A90)
#define RPG_GAMECORE_ENABLELOCALPLAYERMOVEIGNOREMONSTER_METHOD_3_C1698F7C2925BD98_OFFSET UNITYSDK_OFFSET(0x1BB40AD0)
#define RPG_GAMECORE_ENABLELOCALPLAYERMOVEIGNOREMONSTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB40AC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnableLocalPlayerMoveIgnoreMonster_TypeDefinitionIndex = 19410;
