...
#define RPG_GAMECORE_FIVEDIMRTPCCONFIG_METHOD_2_BDD4A582CCB26203_OFFSET UNITYSDK_OFFSET(0x1BEADC30)
#define RPG_GAMECORE_FIVEDIMRTPCCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEADEA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimRTPCConfig_TypeDefinitionIndex = 16061;
