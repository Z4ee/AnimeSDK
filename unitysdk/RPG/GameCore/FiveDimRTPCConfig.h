...
#define RPG_GAMECORE_FIVEDIMRTPCCONFIG_METHOD_2_BDD4A582CCB26203_OFFSET UNITYSDK_OFFSET(0x17206B30)
#define RPG_GAMECORE_FIVEDIMRTPCCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17206DA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimRTPCConfig_TypeDefinitionIndex = 15313;
