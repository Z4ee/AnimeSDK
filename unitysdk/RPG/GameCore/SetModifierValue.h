...
#define RPG_GAMECORE_SETMODIFIERVALUE_METHOD_3_05EC4C4921479655_OFFSET UNITYSDK_OFFSET(0x176D67D0)
#define RPG_GAMECORE_SETMODIFIERVALUE_METHOD_3_A58B952626E1F0F7_OFFSET UNITYSDK_OFFSET(0x176D66E0)
#define RPG_GAMECORE_SETMODIFIERVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x176D6720)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetModifierValue_TypeDefinitionIndex = 20851;
