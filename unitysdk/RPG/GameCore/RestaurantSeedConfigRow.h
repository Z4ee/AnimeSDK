...
#define RPG_GAMECORE_RESTAURANTSEEDCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D026720)
#define RPG_GAMECORE_RESTAURANTSEEDCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D026AE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RestaurantSeedConfigRow_TypeDefinitionIndex = 10984;

	class RestaurantSeedConfigRow : public ::System::Object
	{
	public:
		::System::String* CropsModelPath; // 0x10
		::Il2CppArray<::Class_1_A88C3AAF0DD46F4C_5*>* SpecialProductList; // 0x18
		::System::String* BigCropsModelPath; // 0x20
		::System::UInt32 SortID; // 0x28
		::System::UInt32 GrowTime; // 0x2C
		::System::UInt32 ProductCount; // 0x30
		::System::UInt32 Price; // 0x34
		::System::UInt32 ItemID; // 0x38
		::System::UInt32 ProductID; // 0x3C
