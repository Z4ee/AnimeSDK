...
#define RPG_GAMECORE_ROGUETOURNFINISH_METHOD_3_02A9EB52E264B5FE_OFFSET UNITYSDK_OFFSET(0x1D41B6D0)
#define RPG_GAMECORE_ROGUETOURNFINISH_METHOD_3_E081C10C0D12EFFB_OFFSET UNITYSDK_OFFSET(0x1D41B600)
#define RPG_GAMECORE_ROGUETOURNFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1D41B6C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournFinish_TypeDefinitionIndex = 21850;
