...
#define RPG_GAMECORE_ROGUETOURNFINISH_METHOD_3_02A9EB52E264B5FE_OFFSET UNITYSDK_OFFSET(0x19BC7390)
#define RPG_GAMECORE_ROGUETOURNFINISH_METHOD_3_E15C3C3BCC711472_OFFSET UNITYSDK_OFFSET(0x19BC7280)
#define RPG_GAMECORE_ROGUETOURNFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x19BC7360)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournFinish_TypeDefinitionIndex = 20875;
