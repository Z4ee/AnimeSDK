...
#define RPG_GAMECORE_ATTACHPRESHOWDAMAGETYPEFORSKILL_METHOD_3_3210CDD26D2E0B8D_OFFSET UNITYSDK_OFFSET(0x1A065AA0)
#define RPG_GAMECORE_ATTACHPRESHOWDAMAGETYPEFORSKILL_METHOD_3_654B89873B53FBE0_OFFSET UNITYSDK_OFFSET(0x1A065A60)
#define RPG_GAMECORE_ATTACHPRESHOWDAMAGETYPEFORSKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A065A90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AttachPreshowDamageTypeForSkill_TypeDefinitionIndex = 22014;
