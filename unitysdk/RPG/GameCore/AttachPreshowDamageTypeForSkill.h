...
#define RPG_GAMECORE_ATTACHPRESHOWDAMAGETYPEFORSKILL_METHOD_3_8069F71B6DD0B6E6_OFFSET UNITYSDK_OFFSET(0x16F8AB70)
#define RPG_GAMECORE_ATTACHPRESHOWDAMAGETYPEFORSKILL_METHOD_3_8E76D8F6CE5EDBA9_OFFSET UNITYSDK_OFFSET(0x16F8AAF0)
#define RPG_GAMECORE_ATTACHPRESHOWDAMAGETYPEFORSKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x16F8AB40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AttachPreshowDamageTypeForSkill_TypeDefinitionIndex = 21036;
