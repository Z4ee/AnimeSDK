...
#define RPG_GAMECORE_DYNAMICLOADBLOCKDATALIST_METHOD_2_2C5F0BD657755360_OFFSET UNITYSDK_OFFSET(0x196CEC20)
#define RPG_GAMECORE_DYNAMICLOADBLOCKDATALIST_METHOD_2_46C5975ED0ABCD5F_OFFSET UNITYSDK_OFFSET(0x196CED60)
#define RPG_GAMECORE_DYNAMICLOADBLOCKDATALIST__CTOR_OFFSET UNITYSDK_OFFSET(0x196CEB40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DynamicLoadBlockDataList_TypeDefinitionIndex = 18177;
