...
#define RPG_GAMECORE_VE_TARGETCOUNT_METHOD_3_1BC4003B40DE696C_OFFSET UNITYSDK_OFFSET(0x1DEA8670)
#define RPG_GAMECORE_VE_TARGETCOUNT_METHOD_3_384D7790067CB991_OFFSET UNITYSDK_OFFSET(0x1DEA86B0)
#define RPG_GAMECORE_VE_TARGETCOUNT_METHOD_3_A5B6C0B293E26748_OFFSET UNITYSDK_OFFSET(0x1DEA8870)
#define RPG_GAMECORE_VE_TARGETCOUNT_METHOD_3_B818790A5CE945C7_OFFSET UNITYSDK_OFFSET(0x1DEA88A0)
#define RPG_GAMECORE_VE_TARGETCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEA86A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VE_TargetCount_TypeDefinitionIndex = 23770;
