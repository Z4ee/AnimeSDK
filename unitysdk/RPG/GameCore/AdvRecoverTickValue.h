...
#define RPG_GAMECORE_ADVRECOVERTICKVALUE_METHOD_3_A98B49D3C435101C_OFFSET UNITYSDK_OFFSET(0x19432B50)
#define RPG_GAMECORE_ADVRECOVERTICKVALUE_METHOD_3_FD23F7C422AF9B99_OFFSET UNITYSDK_OFFSET(0x19432C20)
#define RPG_GAMECORE_ADVRECOVERTICKVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x19432BD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvRecoverTickValue_TypeDefinitionIndex = 19874;
