...
#define RPG_GAMECORE_ADVRECOVERTICKVALUE_METHOD_3_2A572F8CC6657DE5_OFFSET UNITYSDK_OFFSET(0x1BE29860)
#define RPG_GAMECORE_ADVRECOVERTICKVALUE_METHOD_3_FD23F7C422AF9B99_OFFSET UNITYSDK_OFFSET(0x1BE29900)
#define RPG_GAMECORE_ADVRECOVERTICKVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE298C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvRecoverTickValue_TypeDefinitionIndex = 20238;
