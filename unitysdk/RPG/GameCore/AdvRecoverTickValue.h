...
#define RPG_GAMECORE_ADVRECOVERTICKVALUE_METHOD_3_A98B49D3C435101C_OFFSET UNITYSDK_OFFSET(0x1865F150)
#define RPG_GAMECORE_ADVRECOVERTICKVALUE_METHOD_3_FD23F7C422AF9B99_OFFSET UNITYSDK_OFFSET(0x1865F220)
#define RPG_GAMECORE_ADVRECOVERTICKVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1865F1D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvRecoverTickValue_TypeDefinitionIndex = 20012;
