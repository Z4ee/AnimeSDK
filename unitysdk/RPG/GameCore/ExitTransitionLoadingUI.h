...
#define RPG_GAMECORE_EXITTRANSITIONLOADINGUI_METHOD_3_6E15D35AC5BF59F4_OFFSET UNITYSDK_OFFSET(0x1D7D8D60)
#define RPG_GAMECORE_EXITTRANSITIONLOADINGUI_METHOD_3_ED7C0D849DC4D031_OFFSET UNITYSDK_OFFSET(0x1D7D8C90)
#define RPG_GAMECORE_EXITTRANSITIONLOADINGUI__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7D8D50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ExitTransitionLoadingUI_TypeDefinitionIndex = 21464;
