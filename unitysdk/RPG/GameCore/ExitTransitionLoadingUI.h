...
#define RPG_GAMECORE_EXITTRANSITIONLOADINGUI_METHOD_3_6E15D35AC5BF59F4_OFFSET UNITYSDK_OFFSET(0x197005F0)
#define RPG_GAMECORE_EXITTRANSITIONLOADINGUI_METHOD_3_9547DD2EBB5C4D08_OFFSET UNITYSDK_OFFSET(0x197004E0)
#define RPG_GAMECORE_EXITTRANSITIONLOADINGUI__CTOR_OFFSET UNITYSDK_OFFSET(0x197005C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ExitTransitionLoadingUI_TypeDefinitionIndex = 20493;
