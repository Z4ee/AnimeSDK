...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONAFTERTITANBLESSINTERACTCONFIG_METHOD_3_8142B5CEE9FA1ED4_OFFSET UNITYSDK_OFFSET(0x1CFBFCB0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONAFTERTITANBLESSINTERACTCONFIG_METHOD_3_B5C35FDC6914E3D8_OFFSET UNITYSDK_OFFSET(0x1CFBFC60)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONAFTERTITANBLESSINTERACTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFBFCA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionAfterTitanBlessInteractConfig_TypeDefinitionIndex = 17074;
