...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONAFTERTITANBLESSINTERACTCONFIG_METHOD_3_51C91DFB8F67619D_OFFSET UNITYSDK_OFFSET(0x18D3C870)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONAFTERTITANBLESSINTERACTCONFIG_METHOD_3_8142B5CEE9FA1ED4_OFFSET UNITYSDK_OFFSET(0x18D34AA0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONAFTERTITANBLESSINTERACTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D34A50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionAfterTitanBlessInteractConfig_TypeDefinitionIndex = 16897;
