...
#define RPG_GAMECORE_PARAMETERBACKUP3CONFIG_METHOD_4_DFE471CD6AA10BCA_OFFSET UNITYSDK_OFFSET(0x1BB0E550)
#define RPG_GAMECORE_PARAMETERBACKUP3CONFIG_METHOD_4_E5C5FAFDC07DCC26_OFFSET UNITYSDK_OFFSET(0x1BB0E5A0)
#define RPG_GAMECORE_PARAMETERBACKUP3CONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB0E590)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ParameterBackup3Config_TypeDefinitionIndex = 16385;
