...
#define RPG_GAMECORE_WAITLEVELREWARDPAGESHOW_METHOD_3_A5C5993090FE2276_OFFSET UNITYSDK_OFFSET(0x178FCBC0)
#define RPG_GAMECORE_WAITLEVELREWARDPAGESHOW_METHOD_3_D92FB26AC9461F47_OFFSET UNITYSDK_OFFSET(0x178FCB40)
#define RPG_GAMECORE_WAITLEVELREWARDPAGESHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x178FCB90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitLevelRewardPageShow_TypeDefinitionIndex = 19545;
