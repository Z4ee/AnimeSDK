...
#define RPG_GAMECORE_WAITLEVELREWARDPAGESHOW_METHOD_3_2B608EAF98213575_OFFSET UNITYSDK_OFFSET(0x1B8A7600)
#define RPG_GAMECORE_WAITLEVELREWARDPAGESHOW_METHOD_3_A5C5993090FE2276_OFFSET UNITYSDK_OFFSET(0x1B8A7640)
#define RPG_GAMECORE_WAITLEVELREWARDPAGESHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8A7630)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitLevelRewardPageShow_TypeDefinitionIndex = 20448;
