...
#define RPG_GAMECORE_IDLELIVEEVENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18A10D60)
#define RPG_GAMECORE_IDLELIVEEVENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18A10FD0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Boolean ChangeTeam; // 0x24
