...
#define RPG_GAMECORE_IDLELIVEEVENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D19F350)
#define RPG_GAMECORE_IDLELIVEEVENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D19F5C0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 SentenceSectionID; // 0x20
