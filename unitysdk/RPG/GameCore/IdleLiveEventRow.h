...
#define RPG_GAMECORE_IDLELIVEEVENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19843020)
#define RPG_GAMECORE_IDLELIVEEVENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19843290)

namespace RPG::GameCore
{
	inline static constexpr unsigned int IdleLiveEventRow_TypeDefinitionIndex = 11193;
	...
	public:
		...
		::System::UInt32 SentenceSectionID; // 0x2C
