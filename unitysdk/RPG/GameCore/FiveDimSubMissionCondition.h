...
#define RPG_GAMECORE_FIVEDIMSUBMISSIONCONDITION_METHOD_2_2CA39FE4B3B9F556_OFFSET UNITYSDK_OFFSET(0x18920AC0)
#define RPG_GAMECORE_FIVEDIMSUBMISSIONCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x18920BE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSubMissionCondition_TypeDefinitionIndex = 17674;
