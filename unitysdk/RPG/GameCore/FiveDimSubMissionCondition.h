...
#define RPG_GAMECORE_FIVEDIMSUBMISSIONCONDITION_METHOD_2_2CA39FE4B3B9F556_OFFSET UNITYSDK_OFFSET(0x1D87E2E0)
#define RPG_GAMECORE_FIVEDIMSUBMISSIONCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D87E400)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSubMissionCondition_TypeDefinitionIndex = 18396;
