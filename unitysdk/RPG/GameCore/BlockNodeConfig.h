...
#define RPG_GAMECORE_BLOCKNODECONFIG_METHOD_2_37D3DE6D8A866A73_OFFSET UNITYSDK_OFFSET(0x1CE86920)
#define RPG_GAMECORE_BLOCKNODECONFIG_METHOD_2_AE3CBB691880A973_OFFSET UNITYSDK_OFFSET(0x1CE87010)
#define RPG_GAMECORE_BLOCKNODECONFIG_METHOD_2_F0E307B84478A272_OFFSET UNITYSDK_OFFSET(0x1CE888A0)
#define RPG_GAMECORE_BLOCKNODECONFIG_METHOD_2_F24A112B56A2E4B4_OFFSET UNITYSDK_OFFSET(0x1CE88880)
#define RPG_GAMECORE_BLOCKNODECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE87000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BlockNodeConfig_TypeDefinitionIndex = 18891;
