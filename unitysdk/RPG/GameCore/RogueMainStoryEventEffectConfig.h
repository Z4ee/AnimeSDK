...
#define RPG_GAMECORE_ROGUEMAINSTORYEVENTEFFECTCONFIG_METHOD_2_4C79CB63886C4E0B_OFFSET UNITYSDK_OFFSET(0x1EEF2CF0)
#define RPG_GAMECORE_ROGUEMAINSTORYEVENTEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEF2D30)
