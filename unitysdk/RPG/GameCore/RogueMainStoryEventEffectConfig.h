...
#define RPG_GAMECORE_ROGUEMAINSTORYEVENTEFFECTCONFIG_METHOD_2_4C79CB63886C4E0B_OFFSET UNITYSDK_OFFSET(0x17617F00)
#define RPG_GAMECORE_ROGUEMAINSTORYEVENTEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17617F40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueMainStoryEventEffectConfig_TypeDefinitionIndex = 16548;
