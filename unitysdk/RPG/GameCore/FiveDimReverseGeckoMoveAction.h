...
#define RPG_GAMECORE_FIVEDIMREVERSEGECKOMOVEACTION_METHOD_3_23CFBB0F6EF74B5E_OFFSET UNITYSDK_OFFSET(0x189191C0)
#define RPG_GAMECORE_FIVEDIMREVERSEGECKOMOVEACTION_METHOD_3_2E906BD1B9D882E7_OFFSET UNITYSDK_OFFSET(0x18919100)
#define RPG_GAMECORE_FIVEDIMREVERSEGECKOMOVEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x189191A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimReverseGeckoMoveAction_TypeDefinitionIndex = 17796;
