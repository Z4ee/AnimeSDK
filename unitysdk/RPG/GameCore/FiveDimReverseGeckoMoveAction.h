...
#define RPG_GAMECORE_FIVEDIMREVERSEGECKOMOVEACTION_METHOD_3_23CFBB0F6EF74B5E_OFFSET UNITYSDK_OFFSET(0x1D0FE4B0)
#define RPG_GAMECORE_FIVEDIMREVERSEGECKOMOVEACTION_METHOD_3_ED4459EC33CE83CF_OFFSET UNITYSDK_OFFSET(0x1D0FE430)
#define RPG_GAMECORE_FIVEDIMREVERSEGECKOMOVEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0FE4A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimReverseGeckoMoveAction_TypeDefinitionIndex = 18523;
