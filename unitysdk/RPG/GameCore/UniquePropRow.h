...
#define RPG_GAMECORE_UNIQUEPROPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x190E2720)
#define RPG_GAMECORE_UNIQUEPROPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x190E2850)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UniquePropRow_TypeDefinitionIndex = 12387;
