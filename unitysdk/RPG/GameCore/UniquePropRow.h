...
#define RPG_GAMECORE_UNIQUEPROPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D2AE150)
#define RPG_GAMECORE_UNIQUEPROPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2AE280)
