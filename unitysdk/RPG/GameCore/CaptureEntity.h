...
#define RPG_GAMECORE_CAPTUREENTITY_METHOD_3_BB8FB5BC258A2E09_OFFSET UNITYSDK_OFFSET(0x17053320)
#define RPG_GAMECORE_CAPTUREENTITY_METHOD_3_CD69CDD12E863B00_OFFSET UNITYSDK_OFFSET(0x170532A0)
#define RPG_GAMECORE_CAPTUREENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x170532F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CaptureEntity_TypeDefinitionIndex = 19140;
