...
#define RPG_GAMECORE_CAPTUREENTITY_METHOD_3_BB8FB5BC258A2E09_OFFSET UNITYSDK_OFFSET(0x195F4500)
#define RPG_GAMECORE_CAPTUREENTITY_METHOD_3_CD69CDD12E863B00_OFFSET UNITYSDK_OFFSET(0x195F4480)
#define RPG_GAMECORE_CAPTUREENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x195F44D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CaptureEntity_TypeDefinitionIndex = 19675;
