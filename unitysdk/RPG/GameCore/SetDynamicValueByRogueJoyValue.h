...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEJOYVALUE_METHOD_3_7F100ED4CBBD02BA_OFFSET UNITYSDK_OFFSET(0x1C2E7090)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEJOYVALUE_METHOD_3_9D05CD8FA15ECB87_OFFSET UNITYSDK_OFFSET(0x1C2E70D0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEJOYVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2E70C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRogueJoyValue_TypeDefinitionIndex = 20987;
