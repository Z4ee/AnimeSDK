...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEJOYVALUE_METHOD_3_9D05CD8FA15ECB87_OFFSET UNITYSDK_OFFSET(0x176C3970)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEJOYVALUE_METHOD_3_E8EB66A195330250_OFFSET UNITYSDK_OFFSET(0x176C3900)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEJOYVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x176C3940)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRogueJoyValue_TypeDefinitionIndex = 19958;
