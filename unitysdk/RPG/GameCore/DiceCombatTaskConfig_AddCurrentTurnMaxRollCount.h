...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_ADDCURRENTTURNMAXROLLCOUNT_METHOD_3_0B59E379165F6D69_OFFSET UNITYSDK_OFFSET(0x1C117730)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_ADDCURRENTTURNMAXROLLCOUNT_METHOD_3_4655EAEEDFF3E1F0_OFFSET UNITYSDK_OFFSET(0x1C117790)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_ADDCURRENTTURNMAXROLLCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C117780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_AddCurrentTurnMaxRollCount_TypeDefinitionIndex = 15482;
