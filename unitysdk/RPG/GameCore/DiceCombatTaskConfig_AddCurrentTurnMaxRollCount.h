...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_ADDCURRENTTURNMAXROLLCOUNT_METHOD_3_4655EAEEDFF3E1F0_OFFSET UNITYSDK_OFFSET(0x196B14B0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_ADDCURRENTTURNMAXROLLCOUNT_METHOD_3_C4DF1EBE22527468_OFFSET UNITYSDK_OFFSET(0x196B84F0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_ADDCURRENTTURNMAXROLLCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x196B1460)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_AddCurrentTurnMaxRollCount_TypeDefinitionIndex = 15318;
