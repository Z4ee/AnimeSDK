...
#define RPG_GAMECORE_ST_SIDE_ATTACHAISTATUS_METHOD_4_561B7EBCBC0C9E1E_OFFSET UNITYSDK_OFFSET(0x17689900)
#define RPG_GAMECORE_ST_SIDE_ATTACHAISTATUS_METHOD_4_C14AB33BDE12ED14_OFFSET UNITYSDK_OFFSET(0x17698640)
#define RPG_GAMECORE_ST_SIDE_ATTACHAISTATUS__CTOR_OFFSET UNITYSDK_OFFSET(0x176898B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_AttachAIStatus_TypeDefinitionIndex = 18401;
