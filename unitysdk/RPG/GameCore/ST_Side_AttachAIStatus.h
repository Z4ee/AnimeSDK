...
#define RPG_GAMECORE_ST_SIDE_ATTACHAISTATUS_METHOD_4_561B7EBCBC0C9E1E_OFFSET UNITYSDK_OFFSET(0x18DF5F50)
#define RPG_GAMECORE_ST_SIDE_ATTACHAISTATUS_METHOD_4_C14AB33BDE12ED14_OFFSET UNITYSDK_OFFSET(0x18DF5E80)
#define RPG_GAMECORE_ST_SIDE_ATTACHAISTATUS__CTOR_OFFSET UNITYSDK_OFFSET(0x18DF5F00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_AttachAIStatus_TypeDefinitionIndex = 19046;
