...
#define RPG_GAMECORE_ST_SIDE_ATTACHAISTATUS_METHOD_4_561B7EBCBC0C9E1E_OFFSET UNITYSDK_OFFSET(0x1B787CD0)
#define RPG_GAMECORE_ST_SIDE_ATTACHAISTATUS_METHOD_4_7C4A0B5365AA36DD_OFFSET UNITYSDK_OFFSET(0x1B787C90)
#define RPG_GAMECORE_ST_SIDE_ATTACHAISTATUS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B787CC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_AttachAIStatus_TypeDefinitionIndex = 19339;
