...
#define RPG_GAMECORE_LOOPWAITSERVERGROUPSTATECHANGE_METHOD_3_13442E33135309E0_OFFSET UNITYSDK_OFFSET(0x198B22B0)
#define RPG_GAMECORE_LOOPWAITSERVERGROUPSTATECHANGE_METHOD_3_289B47E6DDBE6397_OFFSET UNITYSDK_OFFSET(0x198B2320)
#define RPG_GAMECORE_LOOPWAITSERVERGROUPSTATECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x198B22F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoopWaitServerGroupStateChange_TypeDefinitionIndex = 20010;
