...
#define RPG_GAMECORE_LOOPWAITSERVERGROUPSTATECHANGE_METHOD_3_289B47E6DDBE6397_OFFSET UNITYSDK_OFFSET(0x1BCD4DC0)
#define RPG_GAMECORE_LOOPWAITSERVERGROUPSTATECHANGE_METHOD_3_B424284CB269924A_OFFSET UNITYSDK_OFFSET(0x1BCD4D80)
#define RPG_GAMECORE_LOOPWAITSERVERGROUPSTATECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCD4DB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoopWaitServerGroupStateChange_TypeDefinitionIndex = 20382;
