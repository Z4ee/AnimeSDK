...
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEGAMBLEMACHGROUPCONFIG_METHOD_3_7A87F39E63FA5F8D_OFFSET UNITYSDK_OFFSET(0x1D165920)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEGAMBLEMACHGROUPCONFIG_METHOD_3_D8EAAAFBAFD56C71_OFFSET UNITYSDK_OFFSET(0x1D165970)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEGAMBLEMACHGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D165960)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierReplaceContentRogueGambleMachGroupConfig_TypeDefinitionIndex = 16994;
