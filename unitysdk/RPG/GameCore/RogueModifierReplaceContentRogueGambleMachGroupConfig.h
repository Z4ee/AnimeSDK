...
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEGAMBLEMACHGROUPCONFIG_METHOD_3_D2CED4C79E6F2B58_OFFSET UNITYSDK_OFFSET(0x17638710)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEGAMBLEMACHGROUPCONFIG_METHOD_3_D8EAAAFBAFD56C71_OFFSET UNITYSDK_OFFSET(0x176387E0)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEGAMBLEMACHGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17638790)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierReplaceContentRogueGambleMachGroupConfig_TypeDefinitionIndex = 16263;
