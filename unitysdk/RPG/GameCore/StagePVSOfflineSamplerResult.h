...
#define RPG_GAMECORE_STAGEPVSOFFLINESAMPLERRESULT_METHOD_3_71C1C57FEE39926D_OFFSET UNITYSDK_OFFSET(0x1D55B440)
#define RPG_GAMECORE_STAGEPVSOFFLINESAMPLERRESULT_METHOD_3_CEDE3ACC4E089DF5_OFFSET UNITYSDK_OFFSET(0x1D55B260)
#define RPG_GAMECORE_STAGEPVSOFFLINESAMPLERRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D55B250)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StagePVSOfflineSamplerResult_TypeDefinitionIndex = 18956;
