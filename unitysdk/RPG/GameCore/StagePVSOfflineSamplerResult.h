...
#define RPG_GAMECORE_STAGEPVSOFFLINESAMPLERRESULT_METHOD_3_71C1C57FEE39926D_OFFSET UNITYSDK_OFFSET(0x1CAE8FF0)
#define RPG_GAMECORE_STAGEPVSOFFLINESAMPLERRESULT_METHOD_3_CEDE3ACC4E089DF5_OFFSET UNITYSDK_OFFSET(0x1CAE8E10)
#define RPG_GAMECORE_STAGEPVSOFFLINESAMPLERRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CAE8E00)
