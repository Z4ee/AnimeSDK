...
#define RPG_GAMECORE_SETFLOORCUSTOMFLOATV2_METHOD_3_0C129CD1F9DF8C63_OFFSET UNITYSDK_OFFSET(0x1C5FA4B0)
#define RPG_GAMECORE_SETFLOORCUSTOMFLOATV2_METHOD_3_BC4EB378196F434E_OFFSET UNITYSDK_OFFSET(0x1C5FA4F0)
#define RPG_GAMECORE_SETFLOORCUSTOMFLOATV2__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5FA4E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetFloorCustomFloatV2_TypeDefinitionIndex = 19912;
