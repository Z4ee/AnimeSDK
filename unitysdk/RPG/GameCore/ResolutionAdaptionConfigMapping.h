...
#define RPG_GAMECORE_RESOLUTIONADAPTIONCONFIGMAPPING_METHOD_2_08EFB221D70FADBA_OFFSET UNITYSDK_OFFSET(0x175A0FB0)
#define RPG_GAMECORE_RESOLUTIONADAPTIONCONFIGMAPPING__CTOR_OFFSET UNITYSDK_OFFSET(0x175A1080)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResolutionAdaptionConfigMapping_TypeDefinitionIndex = 15708;
