...
#define RPG_GAMECORE_TRACKNPCALERTCONFIG_METHOD_2_4128180D10E9FBA4_OFFSET UNITYSDK_OFFSET(0x178A38D0)
#define RPG_GAMECORE_TRACKNPCALERTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x178A39B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrackNpcAlertConfig_TypeDefinitionIndex = 20365;
