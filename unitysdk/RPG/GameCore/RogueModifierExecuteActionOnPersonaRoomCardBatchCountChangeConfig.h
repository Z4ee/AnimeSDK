...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONAROOMCARDBATCHCOUNTCHANGECONFIG_METHOD_3_226E7FAAB0D8FAC5_OFFSET UNITYSDK_OFFSET(0x19B5D620)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONAROOMCARDBATCHCOUNTCHANGECONFIG_METHOD_3_B2877A97B5B933BC_OFFSET UNITYSDK_OFFSET(0x19B527A0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONAROOMCARDBATCHCOUNTCHANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B52750)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnPersonaRoomCardBatchCountChangeConfig_TypeDefinitionIndex = 16915;
