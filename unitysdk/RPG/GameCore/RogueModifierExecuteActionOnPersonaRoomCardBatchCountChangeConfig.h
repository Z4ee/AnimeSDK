...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONAROOMCARDBATCHCOUNTCHANGECONFIG_METHOD_3_B2877A97B5B933BC_OFFSET UNITYSDK_OFFSET(0x1CFC0A30)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONAROOMCARDBATCHCOUNTCHANGECONFIG_METHOD_3_F9A611EEA35853C0_OFFSET UNITYSDK_OFFSET(0x1CFC09E0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONAROOMCARDBATCHCOUNTCHANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFC0A20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnPersonaRoomCardBatchCountChangeConfig_TypeDefinitionIndex = 17077;
