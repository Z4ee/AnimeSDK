...
#define RPG_GAMECORE_SWITCHREFGROUPPROPERTY_METHOD_3_2BC45E8A6A80D6D6_OFFSET UNITYSDK_OFFSET(0x17799540)
#define RPG_GAMECORE_SWITCHREFGROUPPROPERTY_METHOD_3_2C912E1B5ADFB413_OFFSET UNITYSDK_OFFSET(0x17799C30)
#define RPG_GAMECORE_SWITCHREFGROUPPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x17799530)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchRefGroupProperty_TypeDefinitionIndex = 16106;
