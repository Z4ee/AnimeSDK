...
#define RPG_GAMECORE_CHALLENGEACTIVITYREWARDCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CF80D80)
#define RPG_GAMECORE_CHALLENGEACTIVITYREWARDCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF813F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChallengeActivityRewardConfigRow_TypeDefinitionIndex = 12844;
