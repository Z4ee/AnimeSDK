...
#define RPG_GAMECORE_COMMENTCONTAINER_METHOD_3_4B3D723D1C5B0420_OFFSET UNITYSDK_OFFSET(0x1711FF80)
#define RPG_GAMECORE_COMMENTCONTAINER_METHOD_3_9AA95889A6E8251E_OFFSET UNITYSDK_OFFSET(0x17120040)
#define RPG_GAMECORE_COMMENTCONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x17120000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CommentContainer_TypeDefinitionIndex = 20452;
