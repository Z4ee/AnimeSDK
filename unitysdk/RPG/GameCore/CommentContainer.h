...
#define RPG_GAMECORE_COMMENTCONTAINER_METHOD_3_9AA95889A6E8251E_OFFSET UNITYSDK_OFFSET(0x1BC21CE0)
#define RPG_GAMECORE_COMMENTCONTAINER_METHOD_3_D12FAF5B461A2788_OFFSET UNITYSDK_OFFSET(0x1BC21C60)
#define RPG_GAMECORE_COMMENTCONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC21CC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CommentContainer_TypeDefinitionIndex = 21449;
