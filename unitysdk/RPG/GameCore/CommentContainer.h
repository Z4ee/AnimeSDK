...
#define RPG_GAMECORE_COMMENTCONTAINER_METHOD_3_9AA95889A6E8251E_OFFSET UNITYSDK_OFFSET(0x1D9A5E10)
#define RPG_GAMECORE_COMMENTCONTAINER_METHOD_3_D12FAF5B461A2788_OFFSET UNITYSDK_OFFSET(0x1D9A5D90)
#define RPG_GAMECORE_COMMENTCONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D9A5DF0)
