...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYENHANCEBUFFCOSTCONFIG_METHOD_3_90CCDC0EB85D72F4_OFFSET UNITYSDK_OFFSET(0x19B55440)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYENHANCEBUFFCOSTCONFIG_METHOD_3_FCAECB26B92D5C3D_OFFSET UNITYSDK_OFFSET(0x19B5F240)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYENHANCEBUFFCOSTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B553F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyEnhanceBuffCostConfig_TypeDefinitionIndex = 17070;
