...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYENHANCEBUFFCOSTCONFIG_METHOD_3_90CCDC0EB85D72F4_OFFSET UNITYSDK_OFFSET(0x17634100)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYENHANCEBUFFCOSTCONFIG_METHOD_3_FCAECB26B92D5C3D_OFFSET UNITYSDK_OFFSET(0x17634030)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYENHANCEBUFFCOSTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x176340B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyEnhanceBuffCostConfig_TypeDefinitionIndex = 16503;
