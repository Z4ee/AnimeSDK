...
#define RPG_GAMECORE_TARGETMAPSKILLSUBTARGET_METHOD_3_2E55F38823849978_OFFSET UNITYSDK_OFFSET(0x1D5B4EC0)
#define RPG_GAMECORE_TARGETMAPSKILLSUBTARGET_METHOD_3_35BD0D3AC78C5412_OFFSET UNITYSDK_OFFSET(0x1D5B4FA0)
#define RPG_GAMECORE_TARGETMAPSKILLSUBTARGET_METHOD_3_56D0FA57948E7E9F_OFFSET UNITYSDK_OFFSET(0x1D5B4FC0)
#define RPG_GAMECORE_TARGETMAPSKILLSUBTARGET_METHOD_3_D7F09573111D055D_OFFSET UNITYSDK_OFFSET(0x1D5B4F40)
#define RPG_GAMECORE_TARGETMAPSKILLSUBTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5B4F30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapSkillSubTarget_TypeDefinitionIndex = 23752;
