...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TRIGGEREFFECT_METHOD_3_2190576FB863C057_OFFSET UNITYSDK_OFFSET(0x196BA3B0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TRIGGEREFFECT_METHOD_3_40430CE3115C3A81_OFFSET UNITYSDK_OFFSET(0x196B5EC0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TRIGGEREFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x196B5E70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_TriggerEffect_TypeDefinitionIndex = 15262;
