...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TRIGGEREFFECT_METHOD_3_40430CE3115C3A81_OFFSET UNITYSDK_OFFSET(0x1DB07950)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TRIGGEREFFECT_METHOD_3_BF4BA382483E67C7_OFFSET UNITYSDK_OFFSET(0x1DB078F0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TRIGGEREFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB07940)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_TriggerEffect_TypeDefinitionIndex = 15863;
