...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_BOSSCHANGEPHASE_METHOD_3_324F58B889D29C43_OFFSET UNITYSDK_OFFSET(0x18876050)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_BOSSCHANGEPHASE_METHOD_3_5F771EA334D02B2C_OFFSET UNITYSDK_OFFSET(0x1887BDD0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_BOSSCHANGEPHASE__CTOR_OFFSET UNITYSDK_OFFSET(0x18876000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_BossChangePhase_TypeDefinitionIndex = 15245;
