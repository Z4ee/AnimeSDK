...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_BOSSCHANGEPHASE_METHOD_3_324F58B889D29C43_OFFSET UNITYSDK_OFFSET(0x1C118300)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_BOSSCHANGEPHASE_METHOD_3_985837FA027891C2_OFFSET UNITYSDK_OFFSET(0x1C118260)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_BOSSCHANGEPHASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1182F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_BossChangePhase_TypeDefinitionIndex = 15468;
