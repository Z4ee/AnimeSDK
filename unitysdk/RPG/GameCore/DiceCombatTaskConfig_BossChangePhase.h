...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_BOSSCHANGEPHASE_METHOD_3_324F58B889D29C43_OFFSET UNITYSDK_OFFSET(0x196B2450)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_BOSSCHANGEPHASE_METHOD_3_5F771EA334D02B2C_OFFSET UNITYSDK_OFFSET(0x196B8C20)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_BOSSCHANGEPHASE__CTOR_OFFSET UNITYSDK_OFFSET(0x196B2400)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_BossChangePhase_TypeDefinitionIndex = 15304;
