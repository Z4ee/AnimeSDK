...
#define RPG_GAMECORE_CHARACTERATLASFACESET_METHOD_2_B5348D1B7C36E62E_OFFSET UNITYSDK_OFFSET(0x1B71C720)
#define RPG_GAMECORE_CHARACTERATLASFACESET__CTOR_OFFSET UNITYSDK_OFFSET(0x1B71C8D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterAtlasFaceSet_TypeDefinitionIndex = 16758;
