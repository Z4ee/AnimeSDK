...
#define RPG_GAMECORE_TITANATLASROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D5D2690)
#define RPG_GAMECORE_TITANATLASROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5D2940)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TitanAtlasRow_TypeDefinitionIndex = 15127;

	class TitanAtlasRow : public ::System::Object
	{
	public:
		::System::UInt32 TitanVoicePoolID; // 0x10
		::System::UInt32 ChangeUnlockID; // 0x14
