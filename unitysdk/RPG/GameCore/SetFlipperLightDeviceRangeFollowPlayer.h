...
#define RPG_GAMECORE_SETFLIPPERLIGHTDEVICERANGEFOLLOWPLAYER_METHOD_3_2E1E9604E6380ED0_OFFSET UNITYSDK_OFFSET(0x1C5F9760)
#define RPG_GAMECORE_SETFLIPPERLIGHTDEVICERANGEFOLLOWPLAYER_METHOD_3_5318001A1371084F_OFFSET UNITYSDK_OFFSET(0x1C5F96A0)
#define RPG_GAMECORE_SETFLIPPERLIGHTDEVICERANGEFOLLOWPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5F9710)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetFlipperLightDeviceRangeFollowPlayer_TypeDefinitionIndex = 21531;
