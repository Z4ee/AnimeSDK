...
#define RPG_GAMECORE_ADVDISTRICTSETUPTRIGGER_METHOD_3_96A2F565C056FA35_OFFSET UNITYSDK_OFFSET(0x16F2AF90)
#define RPG_GAMECORE_ADVDISTRICTSETUPTRIGGER_METHOD_3_CFED1F9F4842ECD2_OFFSET UNITYSDK_OFFSET(0x16F2B160)
#define RPG_GAMECORE_ADVDISTRICTSETUPTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x16F2B090)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvDistrictSetupTrigger_TypeDefinitionIndex = 19492;
