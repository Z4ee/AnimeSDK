...
#define RPG_GAMECORE_ADVDISTRICTSETUPTRIGGER_METHOD_3_1338A9E3BC9119CC_OFFSET UNITYSDK_OFFSET(0x1CDC6160)
#define RPG_GAMECORE_ADVDISTRICTSETUPTRIGGER_METHOD_3_A94FA31A45A59D40_OFFSET UNITYSDK_OFFSET(0x1CDC62F0)
#define RPG_GAMECORE_ADVDISTRICTSETUPTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDC6240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvDistrictSetupTrigger_TypeDefinitionIndex = 20948;
