...
#define RPG_GAMECORE_EXPEDITIONBATTLESHOWFUNTITLEACTION_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1D082970)
#define RPG_GAMECORE_EXPEDITIONBATTLESHOWFUNTITLEACTION_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D0828D0)
#define RPG_GAMECORE_EXPEDITIONBATTLESHOWFUNTITLEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D082960)
