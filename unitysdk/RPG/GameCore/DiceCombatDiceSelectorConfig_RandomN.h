...
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_RANDOMN_METHOD_3_738A0083905935F5_OFFSET UNITYSDK_OFFSET(0x1D02CCB0)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_RANDOMN_METHOD_3_EE79265D3EB72B97_OFFSET UNITYSDK_OFFSET(0x1D02C060)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_RANDOMN__CTOR_OFFSET UNITYSDK_OFFSET(0x1D02C000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatDiceSelectorConfig_RandomN_TypeDefinitionIndex = 15977;
