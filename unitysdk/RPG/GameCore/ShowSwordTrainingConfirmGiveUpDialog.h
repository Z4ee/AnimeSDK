...
#define RPG_GAMECORE_SHOWSWORDTRAININGCONFIRMGIVEUPDIALOG_METHOD_3_4DD0D4EAE9B88B7F_OFFSET UNITYSDK_OFFSET(0x1D530FB0)
#define RPG_GAMECORE_SHOWSWORDTRAININGCONFIRMGIVEUPDIALOG_METHOD_3_739A215F21325642_OFFSET UNITYSDK_OFFSET(0x1D530EE0)
#define RPG_GAMECORE_SHOWSWORDTRAININGCONFIRMGIVEUPDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D530FA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowSwordTrainingConfirmGiveUpDialog_TypeDefinitionIndex = 20611;
