...
#define RPG_GAMECORE_SPECIALNPCDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18E829B0)
#define RPG_GAMECORE_SPECIALNPCDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18E83210)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SpecialNPCDataRow_TypeDefinitionIndex = 14345;
