...
#define RPG_GAMECORE_ST_MAIN_FEARESCAPE_METHOD_4_1876D1A219E0DFF6_OFFSET UNITYSDK_OFFSET(0x17697930)
#define RPG_GAMECORE_ST_MAIN_FEARESCAPE_METHOD_4_D18533BAE0D73C99_OFFSET UNITYSDK_OFFSET(0x176854F0)
#define RPG_GAMECORE_ST_MAIN_FEARESCAPE__CTOR_OFFSET UNITYSDK_OFFSET(0x176854A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_FearEscape_TypeDefinitionIndex = 18425;
