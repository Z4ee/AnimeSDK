...
#define RPG_GAMECORE_ST_MAIN_FEARESCAPE_METHOD_4_B012D8D3A8D16E9C_OFFSET UNITYSDK_OFFSET(0x1DB3CFE0)
#define RPG_GAMECORE_ST_MAIN_FEARESCAPE_METHOD_4_D18533BAE0D73C99_OFFSET UNITYSDK_OFFSET(0x1DB3D0B0)
#define RPG_GAMECORE_ST_MAIN_FEARESCAPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB3D0A0)
