...
#define RPG_GAMECORE_ADDPAMMENUITEM_METHOD_3_B4910DBB7C0BA808_OFFSET UNITYSDK_OFFSET(0x18642340)
#define RPG_GAMECORE_ADDPAMMENUITEM_METHOD_3_D2D9751BEBDA023C_OFFSET UNITYSDK_OFFSET(0x18642230)
#define RPG_GAMECORE_ADDPAMMENUITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x18642310)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddPamMenuItem_TypeDefinitionIndex = 20083;
