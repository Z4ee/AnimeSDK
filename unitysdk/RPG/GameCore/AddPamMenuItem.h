...
#define RPG_GAMECORE_ADDPAMMENUITEM_METHOD_3_B4910DBB7C0BA808_OFFSET UNITYSDK_OFFSET(0x16F20170)
#define RPG_GAMECORE_ADDPAMMENUITEM_METHOD_3_D2D9751BEBDA023C_OFFSET UNITYSDK_OFFSET(0x16F20060)
#define RPG_GAMECORE_ADDPAMMENUITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x16F20140)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddPamMenuItem_TypeDefinitionIndex = 19410;
