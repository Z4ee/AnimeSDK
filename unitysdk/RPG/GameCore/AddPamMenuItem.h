...
#define RPG_GAMECORE_ADDPAMMENUITEM_METHOD_3_A4CCC9BEED350A85_OFFSET UNITYSDK_OFFSET(0x1CDB56B0)
#define RPG_GAMECORE_ADDPAMMENUITEM_METHOD_3_B4910DBB7C0BA808_OFFSET UNITYSDK_OFFSET(0x1CDB5780)
#define RPG_GAMECORE_ADDPAMMENUITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDB5770)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddPamMenuItem_TypeDefinitionIndex = 20863;
