...
#define RPG_GAMECORE_ADDPAMMENUITEM_METHOD_3_A4CCC9BEED350A85_OFFSET UNITYSDK_OFFSET(0x1D6A3DA0)
#define RPG_GAMECORE_ADDPAMMENUITEM_METHOD_3_B4910DBB7C0BA808_OFFSET UNITYSDK_OFFSET(0x1D6A3E70)
#define RPG_GAMECORE_ADDPAMMENUITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6A3E60)
