...
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCENHANCEBUFFCONFIG_METHOD_3_C2036D6AE1F3CC95_OFFSET UNITYSDK_OFFSET(0x176734F0)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCENHANCEBUFFCONFIG_METHOD_3_DEAFF592860BD271_OFFSET UNITYSDK_OFFSET(0x176736F0)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCENHANCEBUFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x176734E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueWorkbenchFuncEnhanceBuffConfig_TypeDefinitionIndex = 16560;
