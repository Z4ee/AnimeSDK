...
#define RPG_GAMECORE_ROGUEACTTRIGGERDIALOGUEBATTLECONFIG_METHOD_6_12BB98DE0D95BEB8_OFFSET UNITYSDK_OFFSET(0x1C49E260)
#define RPG_GAMECORE_ROGUEACTTRIGGERDIALOGUEBATTLECONFIG_METHOD_6_B5D3AD7F5AD61134_OFFSET UNITYSDK_OFFSET(0x1C49E2B0)
#define RPG_GAMECORE_ROGUEACTTRIGGERDIALOGUEBATTLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C49E2A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActTriggerDialogueBattleConfig_TypeDefinitionIndex = 18880;
