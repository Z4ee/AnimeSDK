...
#define RPG_GAMECORE_ROGUEACTTRIGGERDIALOGUEBATTLECONFIG_METHOD_6_B5D3AD7F5AD61134_OFFSET UNITYSDK_OFFSET(0x175C9640)
#define RPG_GAMECORE_ROGUEACTTRIGGERDIALOGUEBATTLECONFIG_METHOD_6_FB0D6A0853446399_OFFSET UNITYSDK_OFFSET(0x175C9420)
#define RPG_GAMECORE_ROGUEACTTRIGGERDIALOGUEBATTLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175C9560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActTriggerDialogueBattleConfig_TypeDefinitionIndex = 17992;
