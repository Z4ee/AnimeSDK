...
#define RPG_GAMECORE_TARGETFETCHSNAPSHOTENTITYLIST_METHOD_4_27371183311D8C1D_OFFSET UNITYSDK_OFFSET(0x1E1B6CC0)
#define RPG_GAMECORE_TARGETFETCHSNAPSHOTENTITYLIST_METHOD_4_8148AC2761DCBD98_OFFSET UNITYSDK_OFFSET(0x1E1B6BC0)
#define RPG_GAMECORE_TARGETFETCHSNAPSHOTENTITYLIST_METHOD_4_9016E0792E305DFD_OFFSET UNITYSDK_OFFSET(0x1E1B6C40)
#define RPG_GAMECORE_TARGETFETCHSNAPSHOTENTITYLIST_METHOD_4_B28ACBED93735610_OFFSET UNITYSDK_OFFSET(0x1E1B6CA0)
#define RPG_GAMECORE_TARGETFETCHSNAPSHOTENTITYLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1B6C30)
