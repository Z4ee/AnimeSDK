...
#define RPG_GAMECORE_TARGETFETCHSNAPSHOTENTITYLIST_METHOD_4_27371183311D8C1D_OFFSET UNITYSDK_OFFSET(0x1D0BCC60)
#define RPG_GAMECORE_TARGETFETCHSNAPSHOTENTITYLIST_METHOD_4_8148AC2761DCBD98_OFFSET UNITYSDK_OFFSET(0x1D0BCB60)
#define RPG_GAMECORE_TARGETFETCHSNAPSHOTENTITYLIST_METHOD_4_9016E0792E305DFD_OFFSET UNITYSDK_OFFSET(0x1D0BCBE0)
#define RPG_GAMECORE_TARGETFETCHSNAPSHOTENTITYLIST_METHOD_4_B28ACBED93735610_OFFSET UNITYSDK_OFFSET(0x1D0BCC40)
#define RPG_GAMECORE_TARGETFETCHSNAPSHOTENTITYLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0BCBD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchSnapshotEntityList_TypeDefinitionIndex = 23157;
