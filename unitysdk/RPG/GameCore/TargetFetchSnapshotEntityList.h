...
#define RPG_GAMECORE_TARGETFETCHSNAPSHOTENTITYLIST_METHOD_4_9016E0792E305DFD_OFFSET UNITYSDK_OFFSET(0x18EDFD10)
#define RPG_GAMECORE_TARGETFETCHSNAPSHOTENTITYLIST_METHOD_4_B862A03C82C56A4B_OFFSET UNITYSDK_OFFSET(0x18EE5A50)
#define RPG_GAMECORE_TARGETFETCHSNAPSHOTENTITYLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x18EDFCC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchSnapshotEntityList_TypeDefinitionIndex = 23003;
