...
#define RPG_GAMECORE_CLOCKPARKSTORYCHARACTER_METHOD_2_D3FE65BB30C4DE16_OFFSET UNITYSDK_OFFSET(0x1881F310)
#define RPG_GAMECORE_CLOCKPARKSTORYCHARACTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1881F4D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClockParkStoryCharacter_TypeDefinitionIndex = 15195;
