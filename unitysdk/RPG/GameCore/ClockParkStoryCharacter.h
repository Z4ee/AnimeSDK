...
#define RPG_GAMECORE_CLOCKPARKSTORYCHARACTER_METHOD_2_D3FE65BB30C4DE16_OFFSET UNITYSDK_OFFSET(0x170BFBF0)
#define RPG_GAMECORE_CLOCKPARKSTORYCHARACTER__CTOR_OFFSET UNITYSDK_OFFSET(0x170BFDB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClockParkStoryCharacter_TypeDefinitionIndex = 14725;
