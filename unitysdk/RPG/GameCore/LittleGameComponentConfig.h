...
#define RPG_GAMECORE_LITTLEGAMECOMPONENTCONFIG_METHOD_2_8DFA775FEB4C2DC0_OFFSET UNITYSDK_OFFSET(0x1DD68CA0)
#define RPG_GAMECORE_LITTLEGAMECOMPONENTCONFIG_METHOD_2_EEF854FCE3DA42CE_OFFSET UNITYSDK_OFFSET(0x1DD68CE0)
#define RPG_GAMECORE_LITTLEGAMECOMPONENTCONFIG_METHOD_2_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1DD68D40)
#define RPG_GAMECORE_LITTLEGAMECOMPONENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD66E10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameComponentConfig_TypeDefinitionIndex = 18628;
