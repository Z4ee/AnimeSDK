...
#define RPG_GAMECORE_SUMMONUNITCHILDEFFECTCONFIG_METHOD_2_5141F28796E81DBC_OFFSET UNITYSDK_OFFSET(0x18EB4490)
#define RPG_GAMECORE_SUMMONUNITCHILDEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18EB4710)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SummonUnitChildEffectConfig_TypeDefinitionIndex = 20045;
