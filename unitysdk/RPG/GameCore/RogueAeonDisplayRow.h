...
#define RPG_GAMECORE_ROGUEAEONDISPLAYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1EE8C730)
#define RPG_GAMECORE_ROGUEAEONDISPLAYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1EE8CFA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueAeonDisplayRow_TypeDefinitionIndex = 14661;
	...
	public:
		...
		::System::String* AeonBuffIcon; // 0x20
		::System::String* AeonIcon; // 0x28
		::RPG::Client::TextID RogueAeonPathName2; // 0x30
		::RPG::Client::TextID RogueAeonPathName; // 0x40
