...
#define RPG_GAMECORE_CHENLINGBATTLESCORESOLDIERCONFIG_METHOD_2_02A4002F7EFD4AFC_OFFSET UNITYSDK_OFFSET(0x187E3DA0)
#define RPG_GAMECORE_CHENLINGBATTLESCORESOLDIERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x187E6300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleScoreSoldierConfig_TypeDefinitionIndex = 14851;
