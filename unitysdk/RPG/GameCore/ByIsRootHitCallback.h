...
#define RPG_GAMECORE_BYISROOTHITCALLBACK_METHOD_4_237726AA6455864A_OFFSET UNITYSDK_OFFSET(0x18756F80)
#define RPG_GAMECORE_BYISROOTHITCALLBACK_METHOD_4_F4D37F4B18AAC7A0_OFFSET UNITYSDK_OFFSET(0x18756EB0)
#define RPG_GAMECORE_BYISROOTHITCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18756F30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsRootHitCallback_TypeDefinitionIndex = 22470;
