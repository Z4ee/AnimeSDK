...
#define RPG_GAMECORE_TRIGGERHITVIBRATION_METHOD_3_415F4A3BA98B96A5_OFFSET UNITYSDK_OFFSET(0x1B057260)
#define RPG_GAMECORE_TRIGGERHITVIBRATION_METHOD_3_F0E8856B32367FA4_OFFSET UNITYSDK_OFFSET(0x1B057210)
#define RPG_GAMECORE_TRIGGERHITVIBRATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B057250)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerHitVibration_TypeDefinitionIndex = 21578;
