...
#define RPG_GAMECORE_TRIGGERHITVIBRATION_METHOD_3_246AF841A55E5E4E_OFFSET UNITYSDK_OFFSET(0x19E16480)
#define RPG_GAMECORE_TRIGGERHITVIBRATION_METHOD_3_415F4A3BA98B96A5_OFFSET UNITYSDK_OFFSET(0x19E16510)
#define RPG_GAMECORE_TRIGGERHITVIBRATION__CTOR_OFFSET UNITYSDK_OFFSET(0x19E164E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerHitVibration_TypeDefinitionIndex = 21163;
