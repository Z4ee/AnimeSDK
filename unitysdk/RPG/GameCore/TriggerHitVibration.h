...
#define RPG_GAMECORE_TRIGGERHITVIBRATION_METHOD_3_246AF841A55E5E4E_OFFSET UNITYSDK_OFFSET(0x190C6FC0)
#define RPG_GAMECORE_TRIGGERHITVIBRATION_METHOD_3_415F4A3BA98B96A5_OFFSET UNITYSDK_OFFSET(0x190C7050)
#define RPG_GAMECORE_TRIGGERHITVIBRATION__CTOR_OFFSET UNITYSDK_OFFSET(0x190C7020)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerHitVibration_TypeDefinitionIndex = 21270;
