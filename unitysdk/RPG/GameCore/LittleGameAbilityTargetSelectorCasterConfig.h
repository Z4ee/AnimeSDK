...
#define RPG_GAMECORE_LITTLEGAMEABILITYTARGETSELECTORCASTERCONFIG_METHOD_3_23A5EA90A704FF6D_OFFSET UNITYSDK_OFFSET(0x19895CC0)
#define RPG_GAMECORE_LITTLEGAMEABILITYTARGETSELECTORCASTERCONFIG_METHOD_3_6F15808783828188_OFFSET UNITYSDK_OFFSET(0x19895D60)
#define RPG_GAMECORE_LITTLEGAMEABILITYTARGETSELECTORCASTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19895D50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityTargetSelectorCasterConfig_TypeDefinitionIndex = 20195;
