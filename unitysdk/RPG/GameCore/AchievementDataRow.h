...
#define RPG_GAMECORE_ACHIEVEMENTDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B9FA750)
#define RPG_GAMECORE_ACHIEVEMENTDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9FAEA0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID AchievementTitlePS; // 0x28
		::RPG::Client::TextID AchievementDescPS; // 0x38
		::RPG::Client::TextID AchievementTitle; // 0x48
		::System::UInt32 Priority; // 0x58
		::System::UInt32 AchievementID; // 0x5C
		::RPG::Client::TextID HideAchievementDesc; // 0x60
		::RPG::GameCore::ShowType ShowType; // 0x70
		::System::UInt32 SeriesID; // 0x74
		::RPG::GameCore::RecordType RecordType; // 0x78
		::System::UInt32 QuestID; // 0x7C
		::System::UInt32 Advance; // 0x80
		::System::UInt32 LinearQuestID; // 0x84
		::RPG::Client::TextID RecordText; // 0x88
		::System::UInt32 ShowParamInt1; // 0x98
