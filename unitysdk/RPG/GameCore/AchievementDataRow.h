...
#define RPG_GAMECORE_ACHIEVEMENTDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C9E1CE0)
#define RPG_GAMECORE_ACHIEVEMENTDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9E2430)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 Advance; // 0x28
		::RPG::Client::TextID AchievementTitle; // 0x30
		::RPG::Client::TextID HideAchievementDesc; // 0x40
		::System::UInt32 LinearQuestID; // 0x50
		::System::UInt32 ShowParamInt1; // 0x54
		::RPG::Client::TextID AchievementTitlePS; // 0x58
		::RPG::Client::TextID AchievementDesc; // 0x68
		::RPG::Client::TextID AchievementDescPS; // 0x78
		::RPG::Client::TextID RecordText; // 0x88
		::RPG::GameCore::RecordType RecordType; // 0x98
		::System::UInt32 SeriesID; // 0x9C
		::System::UInt32 Priority; // 0xA0
		::RPG::GameCore::ShowType ShowType; // 0xA4
		::System::UInt32 QuestID; // 0xA8
		::System::UInt32 AchievementID; // 0xAC
