...
#define RPG_GAMECORE_TRFTRIGGERCOMPONENTCONFIG_METHOD_3_94DB4582C1F38915_OFFSET UNITYSDK_OFFSET(0x1E160470)
#define RPG_GAMECORE_TRFTRIGGERCOMPONENTCONFIG_METHOD_3_EA9E2D631A876923_OFFSET UNITYSDK_OFFSET(0x1E1604D0)
#define RPG_GAMECORE_TRFTRIGGERCOMPONENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1604C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TRFTriggerComponentConfig_TypeDefinitionIndex = 18688;
