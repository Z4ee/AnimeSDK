...
#define RPG_GAMECORE_TRFTRIGGERCOMPONENTCONFIG_METHOD_3_47274F553540E3D8_OFFSET UNITYSDK_OFFSET(0x177A74A0)
#define RPG_GAMECORE_TRFTRIGGERCOMPONENTCONFIG_METHOD_3_DB6A12516A134BF1_OFFSET UNITYSDK_OFFSET(0x177A7530)
#define RPG_GAMECORE_TRFTRIGGERCOMPONENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x177A7510)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TRFTriggerComponentConfig_TypeDefinitionIndex = 17345;
