...
#define RPG_GAMECORE_ADVENABLEOWNERIDLESHOW_METHOD_3_6FD465F625C3897E_OFFSET UNITYSDK_OFFSET(0x1864E0D0)
#define RPG_GAMECORE_ADVENABLEOWNERIDLESHOW_METHOD_3_F694572AC15F1A88_OFFSET UNITYSDK_OFFSET(0x1864E150)
#define RPG_GAMECORE_ADVENABLEOWNERIDLESHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x1864E120)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvEnableOwnerIdleShow_TypeDefinitionIndex = 19527;
