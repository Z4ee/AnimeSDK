...
#define RPG_GAMECORE_TEAMBLOCKMODIFIERCONSTKEYS_METHOD_2_87597CE948D7E8B1_OFFSET UNITYSDK_OFFSET(0x1D5C1F10)
#define RPG_GAMECORE_TEAMBLOCKMODIFIERCONSTKEYS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5C2090)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TeamBlockModifierConstKeys_TypeDefinitionIndex = 16910;
