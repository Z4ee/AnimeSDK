...
#define RPG_GAMECORE_CONDITIONLOOPEXECUTETASKLISTWITHINTERVAL_METHOD_4_5F31400169E49685_OFFSET UNITYSDK_OFFSET(0x1712BE30)
#define RPG_GAMECORE_CONDITIONLOOPEXECUTETASKLISTWITHINTERVAL_METHOD_4_EA6F8544520E6CE5_OFFSET UNITYSDK_OFFSET(0x1712BBF0)
#define RPG_GAMECORE_CONDITIONLOOPEXECUTETASKLISTWITHINTERVAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1712BB70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConditionLoopExecuteTaskListWithInterval_TypeDefinitionIndex = 20658;
