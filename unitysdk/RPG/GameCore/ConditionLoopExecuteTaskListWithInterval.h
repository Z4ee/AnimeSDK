...
#define RPG_GAMECORE_CONDITIONLOOPEXECUTETASKLISTWITHINTERVAL_METHOD_4_563AB3167C08E447_OFFSET UNITYSDK_OFFSET(0x1BC2B250)
#define RPG_GAMECORE_CONDITIONLOOPEXECUTETASKLISTWITHINTERVAL_METHOD_4_E841E6E450DD567E_OFFSET UNITYSDK_OFFSET(0x1BC2B010)
#define RPG_GAMECORE_CONDITIONLOOPEXECUTETASKLISTWITHINTERVAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC2AFB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConditionLoopExecuteTaskListWithInterval_TypeDefinitionIndex = 21662;
