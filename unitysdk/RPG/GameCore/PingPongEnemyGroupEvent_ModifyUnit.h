...
#define RPG_GAMECORE_PINGPONGENEMYGROUPEVENT_MODIFYUNIT_METHOD_3_6581437210E25E78_OFFSET UNITYSDK_OFFSET(0x1B4C7670)
#define RPG_GAMECORE_PINGPONGENEMYGROUPEVENT_MODIFYUNIT_METHOD_3_E33D878E0364DDD2_OFFSET UNITYSDK_OFFSET(0x1B4C7250)
#define RPG_GAMECORE_PINGPONGENEMYGROUPEVENT_MODIFYUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4C7240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PingPongEnemyGroupEvent_ModifyUnit_TypeDefinitionIndex = 16320;
