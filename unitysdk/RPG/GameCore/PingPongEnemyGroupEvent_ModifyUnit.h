...
#define RPG_GAMECORE_PINGPONGENEMYGROUPEVENT_MODIFYUNIT_METHOD_3_327B81CCCA46CAE8_OFFSET UNITYSDK_OFFSET(0x174AFB80)
#define RPG_GAMECORE_PINGPONGENEMYGROUPEVENT_MODIFYUNIT_METHOD_3_8AB12B950B430942_OFFSET UNITYSDK_OFFSET(0x174AFF90)
#define RPG_GAMECORE_PINGPONGENEMYGROUPEVENT_MODIFYUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0x174AFB70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PingPongEnemyGroupEvent_ModifyUnit_TypeDefinitionIndex = 15566;
