...
#define RPG_GAMECORE_AIVARIABLEBOOL_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1B9F7B80)
#define RPG_GAMECORE_AIVARIABLEBOOL_EQUALS_2_OFFSET UNITYSDK_OFFSET(0x1B9F7AF0)
#define RPG_GAMECORE_AIVARIABLEBOOL_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B9F7A30)
#define RPG_GAMECORE_AIVARIABLEBOOL_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B9F7CB0)
#define RPG_GAMECORE_AIVARIABLEBOOL_METHOD_3_3B0FEA62A777480E_OFFSET UNITYSDK_OFFSET(0x1B9F7EB0)
#define RPG_GAMECORE_AIVARIABLEBOOL_METHOD_3_56950E5F6703F137_OFFSET UNITYSDK_OFFSET(0x1B9F7A00)
#define RPG_GAMECORE_AIVARIABLEBOOL_METHOD_3_AAB430F0C614C608_OFFSET UNITYSDK_OFFSET(0x1B9F6C20)
#define RPG_GAMECORE_AIVARIABLEBOOL_METHOD_3_C620B405B25D520F_OFFSET UNITYSDK_OFFSET(0x1B9F7D60)
#define RPG_GAMECORE_AIVARIABLEBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9F6C10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AIVariableBool_TypeDefinitionIndex = 14999;
