...
#define RPG_GAMECORE_AIVARIABLEBOOL_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1D326590)
#define RPG_GAMECORE_AIVARIABLEBOOL_EQUALS_2_OFFSET UNITYSDK_OFFSET(0x1D3264D0)
#define RPG_GAMECORE_AIVARIABLEBOOL_EQUALS_OFFSET UNITYSDK_OFFSET(0x1D326480)
#define RPG_GAMECORE_AIVARIABLEBOOL_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1D326680)
#define RPG_GAMECORE_AIVARIABLEBOOL_METHOD_3_3B0FEA62A777480E_OFFSET UNITYSDK_OFFSET(0x1D326880)
#define RPG_GAMECORE_AIVARIABLEBOOL_METHOD_3_56950E5F6703F137_OFFSET UNITYSDK_OFFSET(0x1D326450)
#define RPG_GAMECORE_AIVARIABLEBOOL_METHOD_3_AAB430F0C614C608_OFFSET UNITYSDK_OFFSET(0x1D325640)
#define RPG_GAMECORE_AIVARIABLEBOOL_METHOD_3_C620B405B25D520F_OFFSET UNITYSDK_OFFSET(0x1D326730)
#define RPG_GAMECORE_AIVARIABLEBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D325630)
