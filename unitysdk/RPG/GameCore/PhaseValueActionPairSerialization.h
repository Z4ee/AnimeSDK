...
#define RPG_GAMECORE_PHASEVALUEACTIONPAIRSERIALIZATION_METHOD_2_104C5DCA44A4D120_OFFSET UNITYSDK_OFFSET(0x18BEF5C0)
#define RPG_GAMECORE_PHASEVALUEACTIONPAIRSERIALIZATION__CTOR_OFFSET UNITYSDK_OFFSET(0x18BEF680)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhaseValueActionPairSerialization_TypeDefinitionIndex = 18226;
