...
#define RPG_GAMECORE_WAITLEVELGRAPHFINISH_METHOD_3_6C8578269E41A10A_OFFSET UNITYSDK_OFFSET(0x19100880)
#define RPG_GAMECORE_WAITLEVELGRAPHFINISH_METHOD_3_CEA3541F965C655D_OFFSET UNITYSDK_OFFSET(0x19100800)
#define RPG_GAMECORE_WAITLEVELGRAPHFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x19100850)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitLevelGraphFinish_TypeDefinitionIndex = 22358;
