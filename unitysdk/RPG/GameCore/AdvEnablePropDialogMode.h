...
#define RPG_GAMECORE_ADVENABLEPROPDIALOGMODE_METHOD_3_4E199948EE87BCA7_OFFSET UNITYSDK_OFFSET(0x1864E440)
#define RPG_GAMECORE_ADVENABLEPROPDIALOGMODE_METHOD_3_C5C9008075A158C2_OFFSET UNITYSDK_OFFSET(0x1864E2D0)
#define RPG_GAMECORE_ADVENABLEPROPDIALOGMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1864E3A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvEnablePropDialogMode_TypeDefinitionIndex = 19284;
