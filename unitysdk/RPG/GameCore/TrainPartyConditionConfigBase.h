...
#define RPG_GAMECORE_TRAINPARTYCONDITIONCONFIGBASE_METHOD_4_333F89C8A58DBB83_OFFSET UNITYSDK_OFFSET(0x190A9100)
#define RPG_GAMECORE_TRAINPARTYCONDITIONCONFIGBASE_METHOD_4_79223D57267C82BA_OFFSET UNITYSDK_OFFSET(0x190A9630)
#define RPG_GAMECORE_TRAINPARTYCONDITIONCONFIGBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x190A8B80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyConditionConfigBase_TypeDefinitionIndex = 17186;
