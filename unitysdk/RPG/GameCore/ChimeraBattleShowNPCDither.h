...
#define RPG_GAMECORE_CHIMERABATTLESHOWNPCDITHER_METHOD_3_5F0096CD591C1E03_OFFSET UNITYSDK_OFFSET(0x1C38FB70)
#define RPG_GAMECORE_CHIMERABATTLESHOWNPCDITHER_METHOD_3_710E99850A513409_OFFSET UNITYSDK_OFFSET(0x1C38E9C0)
#define RPG_GAMECORE_CHIMERABATTLESHOWNPCDITHER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C38E9B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraBattleShowNPCDither_TypeDefinitionIndex = 15265;
