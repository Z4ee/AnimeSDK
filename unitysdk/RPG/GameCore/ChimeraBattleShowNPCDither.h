...
#define RPG_GAMECORE_CHIMERABATTLESHOWNPCDITHER_METHOD_3_5F0096CD591C1E03_OFFSET UNITYSDK_OFFSET(0x187F3B00)
#define RPG_GAMECORE_CHIMERABATTLESHOWNPCDITHER_METHOD_3_710E99850A513409_OFFSET UNITYSDK_OFFSET(0x187F2960)
#define RPG_GAMECORE_CHIMERABATTLESHOWNPCDITHER__CTOR_OFFSET UNITYSDK_OFFSET(0x187F2950)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraBattleShowNPCDither_TypeDefinitionIndex = 15038;
