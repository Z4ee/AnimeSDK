...
#define RPG_GAMECORE_PHOTOGRAPHTRIPODMODECONFIG_METHOD_2_60349FCC21256537_OFFSET UNITYSDK_OFFSET(0x1D437930)
#define RPG_GAMECORE_PHOTOGRAPHTRIPODMODECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D437A90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotoGraphTripodModeConfig_TypeDefinitionIndex = 21412;
