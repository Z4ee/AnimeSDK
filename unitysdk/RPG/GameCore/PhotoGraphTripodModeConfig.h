...
#define RPG_GAMECORE_PHOTOGRAPHTRIPODMODECONFIG_METHOD_2_60349FCC21256537_OFFSET UNITYSDK_OFFSET(0x19A0A9E0)
#define RPG_GAMECORE_PHOTOGRAPHTRIPODMODECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19A0AB40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotoGraphTripodModeConfig_TypeDefinitionIndex = 20441;
