...
#define RPG_GAMECORE_PHOTOGRAPHTRIPODMODECONFIG_METHOD_2_60349FCC21256537_OFFSET UNITYSDK_OFFSET(0x18BF8B80)
#define RPG_GAMECORE_PHOTOGRAPHTRIPODMODECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18BF8CE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotoGraphTripodModeConfig_TypeDefinitionIndex = 20505;
