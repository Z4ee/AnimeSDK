...
#define RPG_GAMECORE_WAITSELECTWHEELITEM_METHOD_3_0EA01971DF9E0B60_OFFSET UNITYSDK_OFFSET(0x17904400)
#define RPG_GAMECORE_WAITSELECTWHEELITEM_METHOD_3_E10B459EB601228B_OFFSET UNITYSDK_OFFSET(0x17904480)
#define RPG_GAMECORE_WAITSELECTWHEELITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x17904450)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitSelectWheelItem_TypeDefinitionIndex = 22321;
