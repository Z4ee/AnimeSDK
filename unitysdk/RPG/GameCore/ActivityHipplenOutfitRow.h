...
#define RPG_GAMECORE_ACTIVITYHIPPLENOUTFITROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x193EE660)
#define RPG_GAMECORE_ACTIVITYHIPPLENOUTFITROW__CTOR_OFFSET UNITYSDK_OFFSET(0x193EE8A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityHipplenOutfitRow_TypeDefinitionIndex = 11157;
