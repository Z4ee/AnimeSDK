...
#define RPG_GAMECORE_BYAND_METHOD_4_2704611B9211D230_OFFSET UNITYSDK_OFFSET(0x16FF9BA0)
#define RPG_GAMECORE_BYAND_METHOD_4_4D3F2CCB29EF729E_OFFSET UNITYSDK_OFFSET(0x16FF9C70)
#define RPG_GAMECORE_BYAND__CTOR_OFFSET UNITYSDK_OFFSET(0x16FF9C20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByAnd_TypeDefinitionIndex = 22069;
