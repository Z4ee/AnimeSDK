...
#define RPG_GAMECORE_BYAND_METHOD_4_4D3F2CCB29EF729E_OFFSET UNITYSDK_OFFSET(0x19CB8F80)
#define RPG_GAMECORE_BYAND_METHOD_4_8DAD6296F3DA3DEF_OFFSET UNITYSDK_OFFSET(0x19CB8F40)
#define RPG_GAMECORE_BYAND_METHOD_4_96529E2BA4FAA28A_OFFSET UNITYSDK_OFFSET(0x19CB9110)
#define RPG_GAMECORE_BYAND_METHOD_4_9B547978CD85A3AD_OFFSET UNITYSDK_OFFSET(0x19CB9140)
#define RPG_GAMECORE_BYAND__CTOR_OFFSET UNITYSDK_OFFSET(0x19CB8F70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByAnd_TypeDefinitionIndex = 22942;
