...
#define RPG_GAMECORE_CHENLINGBATTLEPRESETENHANCEMENTCONFIG_METHOD_2_5065267F724C2823_OFFSET UNITYSDK_OFFSET(0x19623130)
#define RPG_GAMECORE_CHENLINGBATTLEPRESETENHANCEMENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19623250)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattlePresetEnhancementConfig_TypeDefinitionIndex = 14918;
