...
#define RPG_GAMECORE_CHENLINGBATTLEPRESETENHANCEMENTCONFIG_METHOD_2_5065267F724C2823_OFFSET UNITYSDK_OFFSET(0x17080C60)
#define RPG_GAMECORE_CHENLINGBATTLEPRESETENHANCEMENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17080D80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattlePresetEnhancementConfig_TypeDefinitionIndex = 14384;
