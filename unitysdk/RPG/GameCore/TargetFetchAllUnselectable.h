...
#define RPG_GAMECORE_TARGETFETCHALLUNSELECTABLE_METHOD_4_3B632F7263A2ADEE_OFFSET UNITYSDK_OFFSET(0x1D5A8820)
#define RPG_GAMECORE_TARGETFETCHALLUNSELECTABLE_METHOD_4_7E20E33FADF5E63A_OFFSET UNITYSDK_OFFSET(0x1D5A8940)
#define RPG_GAMECORE_TARGETFETCHALLUNSELECTABLE_METHOD_4_BB613B1828A52ED9_OFFSET UNITYSDK_OFFSET(0x1D5A87E0)
#define RPG_GAMECORE_TARGETFETCHALLUNSELECTABLE_METHOD_4_E5C4A1CA6523014B_OFFSET UNITYSDK_OFFSET(0x1D5A8970)
#define RPG_GAMECORE_TARGETFETCHALLUNSELECTABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5A8810)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchAllUnselectable_TypeDefinitionIndex = 23662;
