...
#define RPG_GAMECORE_ROGUECHESTEFFECTCONFIG_METHOD_2_E9EE83B825C7A914_OFFSET UNITYSDK_OFFSET(0x1C4AD120)
#define RPG_GAMECORE_ROGUECHESTEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4AD160)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueChestEffectConfig_TypeDefinitionIndex = 17177;
