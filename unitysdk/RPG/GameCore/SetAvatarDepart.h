...
#define RPG_GAMECORE_SETAVATARDEPART_METHOD_3_A0AC6C8334553848_OFFSET UNITYSDK_OFFSET(0x18E0ACD0)
#define RPG_GAMECORE_SETAVATARDEPART_METHOD_3_A8D0DA75C448B4AD_OFFSET UNITYSDK_OFFSET(0x18E0ADA0)
#define RPG_GAMECORE_SETAVATARDEPART__CTOR_OFFSET UNITYSDK_OFFSET(0x18E0AD50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetAvatarDepart_TypeDefinitionIndex = 21648;
