...
#define RPG_GAMECORE_SETAVATARDEPART_METHOD_3_A8D0DA75C448B4AD_OFFSET UNITYSDK_OFFSET(0x1D4E1BC0)
#define RPG_GAMECORE_SETAVATARDEPART_METHOD_3_F3787260AF520371_OFFSET UNITYSDK_OFFSET(0x1D4E1B20)
#define RPG_GAMECORE_SETAVATARDEPART__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4E1B80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetAvatarDepart_TypeDefinitionIndex = 22489;
