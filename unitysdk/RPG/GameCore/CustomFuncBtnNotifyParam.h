...
#define RPG_GAMECORE_CUSTOMFUNCBTNNOTIFYPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1226A840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CustomFuncBtnNotifyParam_TypeDefinitionIndex = 53536;
