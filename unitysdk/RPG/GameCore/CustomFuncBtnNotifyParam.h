...
#define RPG_GAMECORE_CUSTOMFUNCBTNNOTIFYPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xCD90AA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CustomFuncBtnNotifyParam_TypeDefinitionIndex = 49798;
