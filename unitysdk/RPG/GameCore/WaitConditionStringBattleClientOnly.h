...
#define RPG_GAMECORE_WAITCONDITIONSTRINGBATTLECLIENTONLY_METHOD_4_81DEE13FFFCBF643_OFFSET UNITYSDK_OFFSET(0x1D6A04F0)
#define RPG_GAMECORE_WAITCONDITIONSTRINGBATTLECLIENTONLY_METHOD_4_CB8A9BEA08F80DF0_OFFSET UNITYSDK_OFFSET(0x1D6A0370)
#define RPG_GAMECORE_WAITCONDITIONSTRINGBATTLECLIENTONLY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6A0360)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitConditionStringBattleClientOnly_TypeDefinitionIndex = 23792;
