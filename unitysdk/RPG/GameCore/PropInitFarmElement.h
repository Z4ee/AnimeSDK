...
#define RPG_GAMECORE_PROPINITFARMELEMENT_METHOD_3_E9677AFA6BA8302E_OFFSET UNITYSDK_OFFSET(0x18C6E4E0)
#define RPG_GAMECORE_PROPINITFARMELEMENT_METHOD_3_F5814C40A04A2D6F_OFFSET UNITYSDK_OFFSET(0x18C6E560)
#define RPG_GAMECORE_PROPINITFARMELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x18C6E530)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropInitFarmElement_TypeDefinitionIndex = 20954;
