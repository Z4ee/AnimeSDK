...
#define RPG_GAMECORE_PROPINITFARMELEMENT_METHOD_3_6FA9C10371A10BA7_OFFSET UNITYSDK_OFFSET(0x1D17C280)
#define RPG_GAMECORE_PROPINITFARMELEMENT_METHOD_3_DE6F7308C8C5F90B_OFFSET UNITYSDK_OFFSET(0x1D17C2C0)
#define RPG_GAMECORE_PROPINITFARMELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D17C2B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropInitFarmElement_TypeDefinitionIndex = 21842;
