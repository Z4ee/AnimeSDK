...
#define RPG_GAMECORE_ROGUEMODIFIERSETCOUNTBYOPENROGUECHESTCONFIG_METHOD_3_0C73D9D67792FD5B_OFFSET UNITYSDK_OFFSET(0x18D467A0)
#define RPG_GAMECORE_ROGUEMODIFIERSETCOUNTBYOPENROGUECHESTCONFIG_METHOD_3_521E526961665EC2_OFFSET UNITYSDK_OFFSET(0x18D466D0)
#define RPG_GAMECORE_ROGUEMODIFIERSETCOUNTBYOPENROGUECHESTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D46750)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierSetCountByOpenRogueChestConfig_TypeDefinitionIndex = 16827;
