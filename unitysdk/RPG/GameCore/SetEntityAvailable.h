...
#define RPG_GAMECORE_SETENTITYAVAILABLE_METHOD_3_2C687F6EC48F2DD2_OFFSET UNITYSDK_OFFSET(0x18E2E7D0)
#define RPG_GAMECORE_SETENTITYAVAILABLE_METHOD_3_F747590225868747_OFFSET UNITYSDK_OFFSET(0x18E2E850)
#define RPG_GAMECORE_SETENTITYAVAILABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E2E820)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetEntityAvailable_TypeDefinitionIndex = 19571;
