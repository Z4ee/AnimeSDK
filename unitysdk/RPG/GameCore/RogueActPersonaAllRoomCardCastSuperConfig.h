...
#define RPG_GAMECORE_ROGUEACTPERSONAALLROOMCARDCASTSUPERCONFIG_METHOD_7_5862169F8109AD22_OFFSET UNITYSDK_OFFSET(0x18CC7370)
#define RPG_GAMECORE_ROGUEACTPERSONAALLROOMCARDCASTSUPERCONFIG_METHOD_7_7FFA15B887C55EC7_OFFSET UNITYSDK_OFFSET(0x18CC6E50)
#define RPG_GAMECORE_ROGUEACTPERSONAALLROOMCARDCASTSUPERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CC6D70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaAllRoomCardCastSuperConfig_TypeDefinitionIndex = 18744;
