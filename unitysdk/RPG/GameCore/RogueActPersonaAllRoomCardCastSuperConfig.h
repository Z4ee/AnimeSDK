...
#define RPG_GAMECORE_ROGUEACTPERSONAALLROOMCARDCASTSUPERCONFIG_METHOD_7_5862169F8109AD22_OFFSET UNITYSDK_OFFSET(0x19AEB780)
#define RPG_GAMECORE_ROGUEACTPERSONAALLROOMCARDCASTSUPERCONFIG_METHOD_7_7FFA15B887C55EC7_OFFSET UNITYSDK_OFFSET(0x19AEB260)
#define RPG_GAMECORE_ROGUEACTPERSONAALLROOMCARDCASTSUPERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AEB180)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaAllRoomCardCastSuperConfig_TypeDefinitionIndex = 18711;
