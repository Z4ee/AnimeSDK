...
#define RPG_GAMECORE_BYCOMPARESTANCERATIO_METHOD_4_29B60B545947C1E7_OFFSET UNITYSDK_OFFSET(0x1A8A8770)
#define RPG_GAMECORE_BYCOMPARESTANCERATIO_METHOD_4_65C53DF28F8EE139_OFFSET UNITYSDK_OFFSET(0x1A8A87A0)
#define RPG_GAMECORE_BYCOMPARESTANCERATIO_METHOD_4_66AED444F681573C_OFFSET UNITYSDK_OFFSET(0x1A8A84A0)
#define RPG_GAMECORE_BYCOMPARESTANCERATIO_METHOD_4_756D64010A051C35_OFFSET UNITYSDK_OFFSET(0x1A8A84E0)
#define RPG_GAMECORE_BYCOMPARESTANCERATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8A84D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareStanceRatio_TypeDefinitionIndex = 22170;
