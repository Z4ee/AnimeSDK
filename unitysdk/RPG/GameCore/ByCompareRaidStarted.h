...
#define RPG_GAMECORE_BYCOMPARERAIDSTARTED_METHOD_4_60FD2D45359FC923_OFFSET UNITYSDK_OFFSET(0x1BBB47B0)
#define RPG_GAMECORE_BYCOMPARERAIDSTARTED_METHOD_4_A44F1A3D92250B1F_OFFSET UNITYSDK_OFFSET(0x1BBB4760)
#define RPG_GAMECORE_BYCOMPARERAIDSTARTED__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBB47A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareRaidStarted_TypeDefinitionIndex = 20987;
