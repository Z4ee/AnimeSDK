...
#define RPG_GAMECORE_BYCOMPARERAIDSTARTED_METHOD_4_5FD698DE1229616A_OFFSET UNITYSDK_OFFSET(0x17014830)
#define RPG_GAMECORE_BYCOMPARERAIDSTARTED_METHOD_4_60FD2D45359FC923_OFFSET UNITYSDK_OFFSET(0x17014900)
#define RPG_GAMECORE_BYCOMPARERAIDSTARTED__CTOR_OFFSET UNITYSDK_OFFSET(0x170148B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareRaidStarted_TypeDefinitionIndex = 19532;
