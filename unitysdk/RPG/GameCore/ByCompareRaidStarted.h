...
#define RPG_GAMECORE_BYCOMPARERAIDSTARTED_METHOD_4_5FD698DE1229616A_OFFSET UNITYSDK_OFFSET(0x1952BFA0)
#define RPG_GAMECORE_BYCOMPARERAIDSTARTED_METHOD_4_60FD2D45359FC923_OFFSET UNITYSDK_OFFSET(0x1952C070)
#define RPG_GAMECORE_BYCOMPARERAIDSTARTED__CTOR_OFFSET UNITYSDK_OFFSET(0x1952C020)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareRaidStarted_TypeDefinitionIndex = 20063;
