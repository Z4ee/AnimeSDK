...
#define RPG_GAMECORE_FOURROTATEVOXELFINISHPOINTCONFIG_METHOD_3_A0677714A1F91588_OFFSET UNITYSDK_OFFSET(0x1892DB30)
#define RPG_GAMECORE_FOURROTATEVOXELFINISHPOINTCONFIG_METHOD_3_B792DCD4C8ADDA5F_OFFSET UNITYSDK_OFFSET(0x1892DAC0)
#define RPG_GAMECORE_FOURROTATEVOXELFINISHPOINTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1892DB10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FourRotateVoxelFinishPointConfig_TypeDefinitionIndex = 15878;
