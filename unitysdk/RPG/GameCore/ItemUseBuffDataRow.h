...
#define RPG_GAMECORE_ITEMUSEBUFFDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D1C15B0)
#define RPG_GAMECORE_ITEMUSEBUFFDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1C20D0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Single PreviewSkillPoint; // 0x38
		::System::UInt32 ConsumeType; // 0x3C
		::System::Single PreviewHPRecoveryValue; // 0x40
		::System::Single PreviewHPRecoveryPercent; // 0x44
		::System::Single PreviewPowerPercent; // 0x48
		::System::UInt32 UseMultipleMax; // 0x4C
		::RPG::GameCore::ItemFoodTargetType UseTargetType; // 0x50
		::System::Int32 SatietyValue; // 0x54
		::System::Boolean IsShowUseMultipleSlider; // 0x58
		::System::Boolean IsShowItemDesc; // 0x59
		::System::Boolean IsCheckHP; // 0x5A
		::System::UInt32 UseDataID; // 0x5C
