...
#define RPG_GAMECORE_FATEVALUECHANGEINFO_METHOD_2_129F7217A30C0E13_OFFSET UNITYSDK_OFFSET(0x188DBA60)
#define RPG_GAMECORE_FATEVALUECHANGEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x188DBAA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateValueChangeInfo_TypeDefinitionIndex = 18297;
