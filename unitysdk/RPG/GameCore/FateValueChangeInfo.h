...
#define RPG_GAMECORE_FATEVALUECHANGEINFO_METHOD_2_129F7217A30C0E13_OFFSET UNITYSDK_OFFSET(0x1BA77D30)
#define RPG_GAMECORE_FATEVALUECHANGEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA77D70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateValueChangeInfo_TypeDefinitionIndex = 18504;
