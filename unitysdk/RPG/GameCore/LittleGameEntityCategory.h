...
#define RPG_GAMECORE_LITTLEGAMEENTITYCATEGORY_METHOD_2_5CCA191067F76AAD_OFFSET UNITYSDK_OFFSET(0x1989E090)
#define RPG_GAMECORE_LITTLEGAMEENTITYCATEGORY__CTOR_OFFSET UNITYSDK_OFFSET(0x1989E0D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameEntityCategory_TypeDefinitionIndex = 17987;
