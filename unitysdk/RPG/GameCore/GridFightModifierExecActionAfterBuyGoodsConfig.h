...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERBUYGOODSCONFIG_METHOD_3_0B97C7A2EE6B4D54_OFFSET UNITYSDK_OFFSET(0x189BBC00)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERBUYGOODSCONFIG_METHOD_3_1FB0101BBC0DA6CD_OFFSET UNITYSDK_OFFSET(0x189B85D0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERBUYGOODSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189B8580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierExecActionAfterBuyGoodsConfig_TypeDefinitionIndex = 18390;
