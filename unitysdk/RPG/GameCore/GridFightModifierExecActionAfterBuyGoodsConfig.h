...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERBUYGOODSCONFIG_METHOD_3_1FB0101BBC0DA6CD_OFFSET UNITYSDK_OFFSET(0x1D158F70)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERBUYGOODSCONFIG_METHOD_3_CFAE39F8D74D6AC9_OFFSET UNITYSDK_OFFSET(0x1D158F20)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERBUYGOODSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D158F60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierExecActionAfterBuyGoodsConfig_TypeDefinitionIndex = 19132;
