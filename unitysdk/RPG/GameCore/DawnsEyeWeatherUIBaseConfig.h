...
#define RPG_GAMECORE_DAWNSEYEWEATHERUIBASECONFIG_METHOD_2_0828B4DED9916068_OFFSET UNITYSDK_OFFSET(0x1D80FA50)
#define RPG_GAMECORE_DAWNSEYEWEATHERUIBASECONFIG_METHOD_2_810A967DD655739D_OFFSET UNITYSDK_OFFSET(0x1D80F6C0)
#define RPG_GAMECORE_DAWNSEYEWEATHERUIBASECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D80F1B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DawnsEyeWeatherUIBaseConfig_TypeDefinitionIndex = 22539;
