...
#define RPG_GAMECORE_DAWNSEYEWEATHERUIBASECONFIG_METHOD_2_0828B4DED9916068_OFFSET UNITYSDK_OFFSET(0x196925F0)
#define RPG_GAMECORE_DAWNSEYEWEATHERUIBASECONFIG_METHOD_2_810A967DD655739D_OFFSET UNITYSDK_OFFSET(0x19692260)
#define RPG_GAMECORE_DAWNSEYEWEATHERUIBASECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19691D50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DawnsEyeWeatherUIBaseConfig_TypeDefinitionIndex = 21552;
