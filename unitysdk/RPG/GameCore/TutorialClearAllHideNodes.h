...
#define RPG_GAMECORE_TUTORIALCLEARALLHIDENODES_METHOD_3_238A9BFD2CEF910C_OFFSET UNITYSDK_OFFSET(0x178D6D90)
#define RPG_GAMECORE_TUTORIALCLEARALLHIDENODES_METHOD_3_69D0D4C5FD501698_OFFSET UNITYSDK_OFFSET(0x178D6EA0)
#define RPG_GAMECORE_TUTORIALCLEARALLHIDENODES__CTOR_OFFSET UNITYSDK_OFFSET(0x178D6E70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TutorialClearAllHideNodes_TypeDefinitionIndex = 22423;
