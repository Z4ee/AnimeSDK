...
#define RPG_GAMECORE_TUTORIALCLEARALLHIDENODES_METHOD_3_1F7961D8321F0CD5_OFFSET UNITYSDK_OFFSET(0x1B068470)
#define RPG_GAMECORE_TUTORIALCLEARALLHIDENODES_METHOD_3_69D0D4C5FD501698_OFFSET UNITYSDK_OFFSET(0x1B068540)
#define RPG_GAMECORE_TUTORIALCLEARALLHIDENODES__CTOR_OFFSET UNITYSDK_OFFSET(0x1B068530)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TutorialClearAllHideNodes_TypeDefinitionIndex = 23518;
