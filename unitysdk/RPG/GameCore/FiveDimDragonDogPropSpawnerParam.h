...
#define RPG_GAMECORE_FIVEDIMDRAGONDOGPROPSPAWNERPARAM_METHOD_3_A414F16B7A0C1067_OFFSET UNITYSDK_OFFSET(0x1973A170)
#define RPG_GAMECORE_FIVEDIMDRAGONDOGPROPSPAWNERPARAM_METHOD_3_BC19A0CF4C651BB1_OFFSET UNITYSDK_OFFSET(0x1973A130)
#define RPG_GAMECORE_FIVEDIMDRAGONDOGPROPSPAWNERPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1973A160)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimDragonDogPropSpawnerParam_TypeDefinitionIndex = 17674;
