...
#define RPG_GAMECORE_FIVEDIMDRAGONDOGPROPSPAWNERPARAM_METHOD_3_A414F16B7A0C1067_OFFSET UNITYSDK_OFFSET(0x1BA92510)
#define RPG_GAMECORE_FIVEDIMDRAGONDOGPROPSPAWNERPARAM_METHOD_3_BC19A0CF4C651BB1_OFFSET UNITYSDK_OFFSET(0x1BA924D0)
#define RPG_GAMECORE_FIVEDIMDRAGONDOGPROPSPAWNERPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA92500)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimDragonDogPropSpawnerParam_TypeDefinitionIndex = 17848;
