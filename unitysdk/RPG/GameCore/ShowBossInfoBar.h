...
#define RPG_GAMECORE_SHOWBOSSINFOBAR_METHOD_3_0572F70B5E00B9AC_OFFSET UNITYSDK_OFFSET(0x1BE3C0B0)
#define RPG_GAMECORE_SHOWBOSSINFOBAR_METHOD_3_60129D44EAF51953_OFFSET UNITYSDK_OFFSET(0x1BE3C0F0)
#define RPG_GAMECORE_SHOWBOSSINFOBAR__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE3C0E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowBossInfoBar_TypeDefinitionIndex = 22111;
