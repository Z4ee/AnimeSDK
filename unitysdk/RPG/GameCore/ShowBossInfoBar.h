...
#define RPG_GAMECORE_SHOWBOSSINFOBAR_METHOD_3_008F311B38678707_OFFSET UNITYSDK_OFFSET(0x176F76D0)
#define RPG_GAMECORE_SHOWBOSSINFOBAR_METHOD_3_60129D44EAF51953_OFFSET UNITYSDK_OFFSET(0x176F7750)
#define RPG_GAMECORE_SHOWBOSSINFOBAR__CTOR_OFFSET UNITYSDK_OFFSET(0x176F7720)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowBossInfoBar_TypeDefinitionIndex = 21139;
