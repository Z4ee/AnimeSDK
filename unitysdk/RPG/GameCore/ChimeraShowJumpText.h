...
#define RPG_GAMECORE_CHIMERASHOWJUMPTEXT_METHOD_3_13EDD82A4752B58B_OFFSET UNITYSDK_OFFSET(0x170AAA20)
#define RPG_GAMECORE_CHIMERASHOWJUMPTEXT_METHOD_3_48226B2D0DA22DE9_OFFSET UNITYSDK_OFFSET(0x170AA9C0)
#define RPG_GAMECORE_CHIMERASHOWJUMPTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x170AAA10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraShowJumpText_TypeDefinitionIndex = 14563;
