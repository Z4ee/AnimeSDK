...
#define RPG_GAMECORE_CHIMERASHOWJUMPTEXT_METHOD_3_13EDD82A4752B58B_OFFSET UNITYSDK_OFFSET(0x18809FD0)
#define RPG_GAMECORE_CHIMERASHOWJUMPTEXT_METHOD_3_48226B2D0DA22DE9_OFFSET UNITYSDK_OFFSET(0x18809F70)
#define RPG_GAMECORE_CHIMERASHOWJUMPTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x18809FC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraShowJumpText_TypeDefinitionIndex = 15033;
