...
#define RPG_GAMECORE_TRAINPARTYMODIFIERLISTCONFIG_METHOD_2_E628521DD0260EED_OFFSET UNITYSDK_OFFSET(0x190ABD60)
#define RPG_GAMECORE_TRAINPARTYMODIFIERLISTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x190ABDA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyModifierListConfig_TypeDefinitionIndex = 17196;
