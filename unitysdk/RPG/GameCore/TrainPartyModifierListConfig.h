...
#define RPG_GAMECORE_TRAINPARTYMODIFIERLISTCONFIG_METHOD_2_E628521DD0260EED_OFFSET UNITYSDK_OFFSET(0x19DF6A40)
#define RPG_GAMECORE_TRAINPARTYMODIFIERLISTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19DF6A80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyModifierListConfig_TypeDefinitionIndex = 17204;
