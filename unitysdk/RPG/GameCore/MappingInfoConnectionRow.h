...
#define RPG_GAMECORE_MAPPINGINFOCONNECTIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x198C5820)
#define RPG_GAMECORE_MAPPINGINFOCONNECTIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x198C5ED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MappingInfoConnectionRow_TypeDefinitionIndex = 11963;
