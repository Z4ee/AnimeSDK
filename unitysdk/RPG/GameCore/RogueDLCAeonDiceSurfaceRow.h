...
#define RPG_GAMECORE_ROGUEDLCAEONDICESURFACEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D3CF990)
#define RPG_GAMECORE_ROGUEDLCAEONDICESURFACEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3D02D0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 AeonSurfaceDiceID; // 0x38
		::System::UInt32 Sort; // 0x3C
		::RPG::Client::TextID DiceSurfaceDesc; // 0x40
		::RPG::GameCore::ModifierEffectType DiceEffectType; // 0x50
		::System::UInt32 DiceActiveStage; // 0x54
