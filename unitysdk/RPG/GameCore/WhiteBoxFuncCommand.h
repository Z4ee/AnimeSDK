...
#define RPG_GAMECORE_WHITEBOXFUNCCOMMAND_METHOD_3_2C7491EE56329EB6_OFFSET UNITYSDK_OFFSET(0x1910EA80)
#define RPG_GAMECORE_WHITEBOXFUNCCOMMAND_METHOD_3_7E9C36990B4F70D6_OFFSET UNITYSDK_OFFSET(0x1910EB60)
#define RPG_GAMECORE_WHITEBOXFUNCCOMMAND__CTOR_OFFSET UNITYSDK_OFFSET(0x1910EB00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WhiteBoxFuncCommand_TypeDefinitionIndex = 21720;
