...
#define RPG_GAMECORE_BATTLEBGMCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x194C3640)
#define RPG_GAMECORE_BATTLEBGMCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x194C3790)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleBGMConfigRow_TypeDefinitionIndex = 12211;
