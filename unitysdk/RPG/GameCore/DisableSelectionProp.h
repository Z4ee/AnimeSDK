...
#define RPG_GAMECORE_DISABLESELECTIONPROP_METHOD_3_015B6A38CC85D217_OFFSET UNITYSDK_OFFSET(0x171730D0)
#define RPG_GAMECORE_DISABLESELECTIONPROP_METHOD_3_7769F819DE2D2659_OFFSET UNITYSDK_OFFSET(0x17173220)
#define RPG_GAMECORE_DISABLESELECTIONPROP__CTOR_OFFSET UNITYSDK_OFFSET(0x17173190)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DisableSelectionProp_TypeDefinitionIndex = 20200;
