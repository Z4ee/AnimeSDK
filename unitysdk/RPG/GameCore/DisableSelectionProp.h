...
#define RPG_GAMECORE_DISABLESELECTIONPROP_METHOD_3_12AD64254C02E129_OFFSET UNITYSDK_OFFSET(0x1BB18ED0)
#define RPG_GAMECORE_DISABLESELECTIONPROP_METHOD_3_7769F819DE2D2659_OFFSET UNITYSDK_OFFSET(0x1BB18F50)
#define RPG_GAMECORE_DISABLESELECTIONPROP__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB18F20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DisableSelectionProp_TypeDefinitionIndex = 21216;
