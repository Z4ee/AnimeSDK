...
#define RPG_GAMECORE_DISABLESELECTIONPROP_METHOD_3_015B6A38CC85D217_OFFSET UNITYSDK_OFFSET(0x18880120)
#define RPG_GAMECORE_DISABLESELECTIONPROP_METHOD_3_7769F819DE2D2659_OFFSET UNITYSDK_OFFSET(0x18880270)
#define RPG_GAMECORE_DISABLESELECTIONPROP__CTOR_OFFSET UNITYSDK_OFFSET(0x188801E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DisableSelectionProp_TypeDefinitionIndex = 20882;
