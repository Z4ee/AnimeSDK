...
#define RPG_GAMECORE_MAINMISSIONPARTIALINFOCONFIG_METHOD_2_1429B03F01407020_OFFSET UNITYSDK_OFFSET(0x1D48F9A0)
#define RPG_GAMECORE_MAINMISSIONPARTIALINFOCONFIG_METHOD_2_B4F358BEF945AA01_OFFSET UNITYSDK_OFFSET(0x1D48FAA0)
#define RPG_GAMECORE_MAINMISSIONPARTIALINFOCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D48FA90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MainMissionPartialInfoConfig_TypeDefinitionIndex = 18798;
