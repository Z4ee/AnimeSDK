...
#define RPG_GAMECORE_MODIFYFMCHANNELSOURCESIGNAL_METHOD_3_120D82CE4949ECE0_OFFSET UNITYSDK_OFFSET(0x19955A80)
#define RPG_GAMECORE_MODIFYFMCHANNELSOURCESIGNAL_METHOD_3_34471060C7EC2D97_OFFSET UNITYSDK_OFFSET(0x19955B00)
#define RPG_GAMECORE_MODIFYFMCHANNELSOURCESIGNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x19955AD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyFMChannelSourceSignal_TypeDefinitionIndex = 19434;
