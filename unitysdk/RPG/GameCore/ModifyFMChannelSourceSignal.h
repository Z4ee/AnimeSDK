...
#define RPG_GAMECORE_MODIFYFMCHANNELSOURCESIGNAL_METHOD_3_120D82CE4949ECE0_OFFSET UNITYSDK_OFFSET(0x17430E80)
#define RPG_GAMECORE_MODIFYFMCHANNELSOURCESIGNAL_METHOD_3_34471060C7EC2D97_OFFSET UNITYSDK_OFFSET(0x17430F00)
#define RPG_GAMECORE_MODIFYFMCHANNELSOURCESIGNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x17430ED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyFMChannelSourceSignal_TypeDefinitionIndex = 18884;
