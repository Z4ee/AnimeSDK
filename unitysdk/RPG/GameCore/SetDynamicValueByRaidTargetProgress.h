...
#define RPG_GAMECORE_SETDYNAMICVALUEBYRAIDTARGETPROGRESS_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x18E260D0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYRAIDTARGETPROGRESS_METHOD_4_6BF546781508933C_OFFSET UNITYSDK_OFFSET(0x18E25EC0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYRAIDTARGETPROGRESS_METHOD_4_926610D4B813FF98_OFFSET UNITYSDK_OFFSET(0x18E25DF0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYRAIDTARGETPROGRESS__CTOR_OFFSET UNITYSDK_OFFSET(0x18E25E70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRaidTargetProgress_TypeDefinitionIndex = 22649;
