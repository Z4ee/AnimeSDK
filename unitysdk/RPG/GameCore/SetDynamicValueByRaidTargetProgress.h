...
#define RPG_GAMECORE_SETDYNAMICVALUEBYRAIDTARGETPROGRESS_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x19C430A0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYRAIDTARGETPROGRESS_METHOD_4_6BF546781508933C_OFFSET UNITYSDK_OFFSET(0x19C3E370)
#define RPG_GAMECORE_SETDYNAMICVALUEBYRAIDTARGETPROGRESS_METHOD_4_926610D4B813FF98_OFFSET UNITYSDK_OFFSET(0x19C43020)
#define RPG_GAMECORE_SETDYNAMICVALUEBYRAIDTARGETPROGRESS__CTOR_OFFSET UNITYSDK_OFFSET(0x19C3E320)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRaidTargetProgress_TypeDefinitionIndex = 22369;
