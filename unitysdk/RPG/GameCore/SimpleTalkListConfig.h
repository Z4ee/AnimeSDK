...
#define RPG_GAMECORE_SIMPLETALKLISTCONFIG_METHOD_3_B64C74A655E34688_OFFSET UNITYSDK_OFFSET(0x18E6D4C0)
#define RPG_GAMECORE_SIMPLETALKLISTCONFIG_METHOD_3_C91FC9402021A12C_OFFSET UNITYSDK_OFFSET(0x18E6D0B0)
#define RPG_GAMECORE_SIMPLETALKLISTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18E6D490)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SimpleTalkListConfig_TypeDefinitionIndex = 19827;
