...
#define RPG_GAMECORE_SIMPLETALKLISTCONFIG_METHOD_3_44CF1788BE3E7FE9_OFFSET UNITYSDK_OFFSET(0x1BE4C290)
#define RPG_GAMECORE_SIMPLETALKLISTCONFIG_METHOD_3_B64C74A655E34688_OFFSET UNITYSDK_OFFSET(0x1BE4C5B0)
#define RPG_GAMECORE_SIMPLETALKLISTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE4C5A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SimpleTalkListConfig_TypeDefinitionIndex = 20057;
