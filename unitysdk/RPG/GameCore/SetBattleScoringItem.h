...
#define RPG_GAMECORE_SETBATTLESCORINGITEM_METHOD_3_86E0A7CF65552535_OFFSET UNITYSDK_OFFSET(0x176AA2D0)
#define RPG_GAMECORE_SETBATTLESCORINGITEM_METHOD_3_B19BA63EE6BF60C1_OFFSET UNITYSDK_OFFSET(0x176AA240)
#define RPG_GAMECORE_SETBATTLESCORINGITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x176AA2A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetBattleScoringItem_TypeDefinitionIndex = 21398;
