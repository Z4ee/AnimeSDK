...
#define RPG_GAMECORE_SETBATTLESCORINGITEM_METHOD_3_07CA2814C4000F3F_OFFSET UNITYSDK_OFFSET(0x1D4E3870)
#define RPG_GAMECORE_SETBATTLESCORINGITEM_METHOD_3_86E0A7CF65552535_OFFSET UNITYSDK_OFFSET(0x1D4E38C0)
#define RPG_GAMECORE_SETBATTLESCORINGITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4E38B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetBattleScoringItem_TypeDefinitionIndex = 22915;
	...
	public:
		...
		static ::System::Void Method_3_07CA2814C4000F3F(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::SetBattleScoringItem*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::SetBattleScoringItem*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_SETBATTLESCORINGITEM_METHOD_3_07CA2814C4000F3F_OFFSET))(a1, a2);
		}
