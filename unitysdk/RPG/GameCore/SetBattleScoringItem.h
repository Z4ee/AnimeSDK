...
#define RPG_GAMECORE_SETBATTLESCORINGITEM_METHOD_3_86E0A7CF65552535_OFFSET UNITYSDK_OFFSET(0x18E0CDD0)
#define RPG_GAMECORE_SETBATTLESCORINGITEM_METHOD_3_B19BA63EE6BF60C1_OFFSET UNITYSDK_OFFSET(0x18E0CD40)
#define RPG_GAMECORE_SETBATTLESCORINGITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x18E0CDA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetBattleScoringItem_TypeDefinitionIndex = 22131;
