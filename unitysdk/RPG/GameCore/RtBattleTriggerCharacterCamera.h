...
#define RPG_GAMECORE_RTBATTLETRIGGERCHARACTERCAMERA_METHOD_3_2E47F52435499BB6_OFFSET UNITYSDK_OFFSET(0x18DC6D90)
#define RPG_GAMECORE_RTBATTLETRIGGERCHARACTERCAMERA_METHOD_3_90331473B97AB0B5_OFFSET UNITYSDK_OFFSET(0x18DC6CC0)
#define RPG_GAMECORE_RTBATTLETRIGGERCHARACTERCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x18DC6D40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtBattleTriggerCharacterCamera_TypeDefinitionIndex = 23092;
