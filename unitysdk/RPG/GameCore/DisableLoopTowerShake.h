...
#define RPG_GAMECORE_DISABLELOOPTOWERSHAKE_METHOD_3_7295B2E47476DDD0_OFFSET UNITYSDK_OFFSET(0x17172950)
#define RPG_GAMECORE_DISABLELOOPTOWERSHAKE_METHOD_3_7BB980DBED906B89_OFFSET UNITYSDK_OFFSET(0x171729D0)
#define RPG_GAMECORE_DISABLELOOPTOWERSHAKE__CTOR_OFFSET UNITYSDK_OFFSET(0x171729A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DisableLoopTowerShake_TypeDefinitionIndex = 21101;
