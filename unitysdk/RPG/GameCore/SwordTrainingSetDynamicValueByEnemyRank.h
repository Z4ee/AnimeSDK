...
#define RPG_GAMECORE_SWORDTRAININGSETDYNAMICVALUEBYENEMYRANK_METHOD_3_95E50C58A8A15F45_OFFSET UNITYSDK_OFFSET(0x1B440B30)
#define RPG_GAMECORE_SWORDTRAININGSETDYNAMICVALUEBYENEMYRANK_METHOD_3_C44B6FA3DF567BCA_OFFSET UNITYSDK_OFFSET(0x1B440B70)
#define RPG_GAMECORE_SWORDTRAININGSETDYNAMICVALUEBYENEMYRANK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B440B60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwordTrainingSetDynamicValueByEnemyRank_TypeDefinitionIndex = 21782;
