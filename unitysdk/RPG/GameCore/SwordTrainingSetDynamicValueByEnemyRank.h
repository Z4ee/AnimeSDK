...
#define RPG_GAMECORE_SWORDTRAININGSETDYNAMICVALUEBYENEMYRANK_METHOD_3_0E672D454E07F5C8_OFFSET UNITYSDK_OFFSET(0x18EC6150)
#define RPG_GAMECORE_SWORDTRAININGSETDYNAMICVALUEBYENEMYRANK_METHOD_3_C44B6FA3DF567BCA_OFFSET UNITYSDK_OFFSET(0x18EC61D0)
#define RPG_GAMECORE_SWORDTRAININGSETDYNAMICVALUEBYENEMYRANK__CTOR_OFFSET UNITYSDK_OFFSET(0x18EC61A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwordTrainingSetDynamicValueByEnemyRank_TypeDefinitionIndex = 21483;
