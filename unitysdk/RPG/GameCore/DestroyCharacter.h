...
#define RPG_GAMECORE_DESTROYCHARACTER_METHOD_3_6808519CC2358B02_OFFSET UNITYSDK_OFFSET(0x17153EE0)
#define RPG_GAMECORE_DESTROYCHARACTER_METHOD_3_76E43C74FB880C6B_OFFSET UNITYSDK_OFFSET(0x17153F60)
#define RPG_GAMECORE_DESTROYCHARACTER__CTOR_OFFSET UNITYSDK_OFFSET(0x17153F30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DestroyCharacter_TypeDefinitionIndex = 19859;
