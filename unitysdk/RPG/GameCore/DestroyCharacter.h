...
#define RPG_GAMECORE_DESTROYCHARACTER_METHOD_3_76E43C74FB880C6B_OFFSET UNITYSDK_OFFSET(0x1C103810)
#define RPG_GAMECORE_DESTROYCHARACTER_METHOD_3_9951A709A5265DD8_OFFSET UNITYSDK_OFFSET(0x1C1037D0)
#define RPG_GAMECORE_DESTROYCHARACTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C103800)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DestroyCharacter_TypeDefinitionIndex = 20891;
