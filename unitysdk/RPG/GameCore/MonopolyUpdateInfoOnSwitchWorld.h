...
#define RPG_GAMECORE_MONOPOLYUPDATEINFOONSWITCHWORLD_METHOD_3_6DE3DC73F77F63D5_OFFSET UNITYSDK_OFFSET(0x1B1C17D0)
#define RPG_GAMECORE_MONOPOLYUPDATEINFOONSWITCHWORLD_METHOD_3_B83B4F61C2B06D98_OFFSET UNITYSDK_OFFSET(0x1B1C18A0)
#define RPG_GAMECORE_MONOPOLYUPDATEINFOONSWITCHWORLD__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1C1890)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonopolyUpdateInfoOnSwitchWorld_TypeDefinitionIndex = 20147;
