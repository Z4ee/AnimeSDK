...
#define RPG_GAMECORE_MONOPOLYUPDATEINFOONSWITCHWORLD_METHOD_3_71F51698F24FE80C_OFFSET UNITYSDK_OFFSET(0x17448BE0)
#define RPG_GAMECORE_MONOPOLYUPDATEINFOONSWITCHWORLD_METHOD_3_B83B4F61C2B06D98_OFFSET UNITYSDK_OFFSET(0x17448CF0)
#define RPG_GAMECORE_MONOPOLYUPDATEINFOONSWITCHWORLD__CTOR_OFFSET UNITYSDK_OFFSET(0x17448CC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonopolyUpdateInfoOnSwitchWorld_TypeDefinitionIndex = 19265;
