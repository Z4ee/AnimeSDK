...
#define RPG_GAMECORE_BYCOMPAREPROPPUZZLECREATED_METHOD_4_E17451B8364A12A6_OFFSET UNITYSDK_OFFSET(0x18737820)
#define RPG_GAMECORE_BYCOMPAREPROPPUZZLECREATED_METHOD_4_FAC6159B44E3BB0D_OFFSET UNITYSDK_OFFSET(0x187379C0)
#define RPG_GAMECORE_BYCOMPAREPROPPUZZLECREATED__CTOR_OFFSET UNITYSDK_OFFSET(0x18737900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByComparePropPuzzleCreated_TypeDefinitionIndex = 19539;
