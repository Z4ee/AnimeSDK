...
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEPROPERTYCOMPAREEX_METHOD_3_343BE46B8DDF36A9_OFFSET UNITYSDK_OFFSET(0x171276D0)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEPROPERTYCOMPAREEX_METHOD_3_5D5185E2DA3A2291_OFFSET UNITYSDK_OFFSET(0x17129210)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEPROPERTYCOMPAREEX__CTOR_OFFSET UNITYSDK_OFFSET(0x171276B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAISourcePropertyCompareEX_TypeDefinitionIndex = 14218;
