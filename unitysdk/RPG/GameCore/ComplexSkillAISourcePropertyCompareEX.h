...
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEPROPERTYCOMPAREEX_METHOD_3_343BE46B8DDF36A9_OFFSET UNITYSDK_OFFSET(0x1966DD30)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEPROPERTYCOMPAREEX_METHOD_3_5D5185E2DA3A2291_OFFSET UNITYSDK_OFFSET(0x1966FE40)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEPROPERTYCOMPAREEX__CTOR_OFFSET UNITYSDK_OFFSET(0x1966DD10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAISourcePropertyCompareEX_TypeDefinitionIndex = 14753;
	...
	public:
		...
		static ::System::Void Method_3_5D5185E2DA3A2291(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::ComplexSkillAISourcePropertyCompareEX*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::ComplexSkillAISourcePropertyCompareEX*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_COMPLEXSKILLAISOURCEPROPERTYCOMPAREEX_METHOD_3_5D5185E2DA3A2291_OFFSET))(a1, a2);
		}
