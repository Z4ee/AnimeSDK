...
#define RPG_GAMECORE_TARGETFILTER_METHOD_3_286016954AC6746C_OFFSET UNITYSDK_OFFSET(0x177C0C20)
#define RPG_GAMECORE_TARGETFILTER_METHOD_3_B9ECCC6BB3AA9BF8_OFFSET UNITYSDK_OFFSET(0x177C0D20)
#define RPG_GAMECORE_TARGETFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x177C0D00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFilter_TypeDefinitionIndex = 22176;
