...
#define RPG_GAMECORE_TARGETFILTER_METHOD_3_B9ECCC6BB3AA9BF8_OFFSET UNITYSDK_OFFSET(0x1D0BE390)
#define RPG_GAMECORE_TARGETFILTER_METHOD_3_D23B0B18BBB03035_OFFSET UNITYSDK_OFFSET(0x1D0BE2D0)
#define RPG_GAMECORE_TARGETFILTER_METHOD_3_D622FF9914E7984E_OFFSET UNITYSDK_OFFSET(0x1D0BE430)
#define RPG_GAMECORE_TARGETFILTER_METHOD_3_E4943BCBD1B69713_OFFSET UNITYSDK_OFFSET(0x1D0BE460)
#define RPG_GAMECORE_TARGETFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0BE380)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFilter_TypeDefinitionIndex = 23045;
