...
#define RPG_GAMECORE_ELFTRIGGERSHOWUI_METHOD_3_9871D9225D0BE6A3_OFFSET UNITYSDK_OFFSET(0x1D7B79F0)
#define RPG_GAMECORE_ELFTRIGGERSHOWUI_METHOD_3_A39FD4E3B4A7CB2E_OFFSET UNITYSDK_OFFSET(0x1D7B79B0)
#define RPG_GAMECORE_ELFTRIGGERSHOWUI__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7B79E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfTriggerShowUI_TypeDefinitionIndex = 21492;
