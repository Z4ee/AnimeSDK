...
#define RPG_GAMECORE_ELFTRIGGERSHOWUI_METHOD_3_957CF080C32C8412_OFFSET UNITYSDK_OFFSET(0x1889FD90)
#define RPG_GAMECORE_ELFTRIGGERSHOWUI_METHOD_3_9871D9225D0BE6A3_OFFSET UNITYSDK_OFFSET(0x1889FE10)
#define RPG_GAMECORE_ELFTRIGGERSHOWUI__CTOR_OFFSET UNITYSDK_OFFSET(0x1889FDE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfTriggerShowUI_TypeDefinitionIndex = 20586;
