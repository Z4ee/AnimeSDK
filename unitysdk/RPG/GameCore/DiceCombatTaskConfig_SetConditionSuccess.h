...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_SETCONDITIONSUCCESS_METHOD_3_9FB0D36A88A1E1CB_OFFSET UNITYSDK_OFFSET(0x18878790)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_SETCONDITIONSUCCESS_METHOD_3_A4B46ACB6A6EB974_OFFSET UNITYSDK_OFFSET(0x1887CD30)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_SETCONDITIONSUCCESS__CTOR_OFFSET UNITYSDK_OFFSET(0x18878740)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_SetConditionSuccess_TypeDefinitionIndex = 15296;
