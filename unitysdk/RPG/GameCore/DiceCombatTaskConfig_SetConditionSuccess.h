...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_SETCONDITIONSUCCESS_METHOD_3_355B947C9E8820EA_OFFSET UNITYSDK_OFFSET(0x1C119F40)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_SETCONDITIONSUCCESS_METHOD_3_9FB0D36A88A1E1CB_OFFSET UNITYSDK_OFFSET(0x1C119FE0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_SETCONDITIONSUCCESS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C119FD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_SetConditionSuccess_TypeDefinitionIndex = 15519;
