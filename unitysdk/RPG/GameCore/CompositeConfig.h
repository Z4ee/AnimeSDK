...
#define RPG_GAMECORE_COMPOSITECONFIG_METHOD_3_6F24BD63836F0306_OFFSET UNITYSDK_OFFSET(0x17129E50)
#define RPG_GAMECORE_COMPOSITECONFIG_METHOD_3_E20A401761F3DC72_OFFSET UNITYSDK_OFFSET(0x1712A310)
#define RPG_GAMECORE_COMPOSITECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1712A2E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CompositeConfig_TypeDefinitionIndex = 22051;
