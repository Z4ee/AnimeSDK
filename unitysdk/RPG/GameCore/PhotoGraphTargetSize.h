...
#define RPG_GAMECORE_PHOTOGRAPHTARGETSIZE_METHOD_2_183CDDB08970E2FA_OFFSET UNITYSDK_OFFSET(0x1D4372F0)
#define RPG_GAMECORE_PHOTOGRAPHTARGETSIZE_METHOD_2_2718462ABEA87C89_OFFSET UNITYSDK_OFFSET(0x1D437430)
#define RPG_GAMECORE_PHOTOGRAPHTARGETSIZE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D437420)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotoGraphTargetSize_TypeDefinitionIndex = 21404;
