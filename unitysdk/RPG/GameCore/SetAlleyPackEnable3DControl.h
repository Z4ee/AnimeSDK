...
#define RPG_GAMECORE_SETALLEYPACKENABLE3DCONTROL_METHOD_3_9C998B9765FA8AA3_OFFSET UNITYSDK_OFFSET(0x18E08DB0)
#define RPG_GAMECORE_SETALLEYPACKENABLE3DCONTROL_METHOD_3_DF585F09B042749A_OFFSET UNITYSDK_OFFSET(0x18E08D30)
#define RPG_GAMECORE_SETALLEYPACKENABLE3DCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x18E08D80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetAlleyPackEnable3DControl_TypeDefinitionIndex = 23377;
