...
#define RPG_GAMECORE_SETALLEYPACKENABLE3DCONTROL_METHOD_3_9C998B9765FA8AA3_OFFSET UNITYSDK_OFFSET(0x1C2D1920)
#define RPG_GAMECORE_SETALLEYPACKENABLE3DCONTROL_METHOD_3_F0E0DE986E3ED890_OFFSET UNITYSDK_OFFSET(0x1C2D18D0)
#define RPG_GAMECORE_SETALLEYPACKENABLE3DCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2D1910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetAlleyPackEnable3DControl_TypeDefinitionIndex = 23502;
