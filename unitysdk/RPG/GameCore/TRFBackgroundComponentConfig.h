...
#define RPG_GAMECORE_TRFBACKGROUNDCOMPONENTCONFIG_METHOD_3_5173DBE284E09D02_OFFSET UNITYSDK_OFFSET(0x1B447060)
#define RPG_GAMECORE_TRFBACKGROUNDCOMPONENTCONFIG_METHOD_3_B95987FF8FF09E50_OFFSET UNITYSDK_OFFSET(0x1B447000)
#define RPG_GAMECORE_TRFBACKGROUNDCOMPONENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B447050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TRFBackgroundComponentConfig_TypeDefinitionIndex = 18165;
