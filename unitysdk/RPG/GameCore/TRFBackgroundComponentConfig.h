...
#define RPG_GAMECORE_TRFBACKGROUNDCOMPONENTCONFIG_METHOD_3_5173DBE284E09D02_OFFSET UNITYSDK_OFFSET(0x1D59C1B0)
#define RPG_GAMECORE_TRFBACKGROUNDCOMPONENTCONFIG_METHOD_3_B95987FF8FF09E50_OFFSET UNITYSDK_OFFSET(0x1D59C150)
#define RPG_GAMECORE_TRFBACKGROUNDCOMPONENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D59C1A0)
