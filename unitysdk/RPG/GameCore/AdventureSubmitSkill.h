...
#define RPG_GAMECORE_ADVENTURESUBMITSKILL_METHOD_3_2E404C68A577BDEF_OFFSET UNITYSDK_OFFSET(0x1CDF7C30)
#define RPG_GAMECORE_ADVENTURESUBMITSKILL_METHOD_3_F1F42F93AADA7B7E_OFFSET UNITYSDK_OFFSET(0x1CDF7B90)
#define RPG_GAMECORE_ADVENTURESUBMITSKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDF7BF0)
