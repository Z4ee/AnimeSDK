...
#define RPG_GAMECORE_ADVENTURESUBMITSKILL_METHOD_3_2E404C68A577BDEF_OFFSET UNITYSDK_OFFSET(0x1AE62DF0)
#define RPG_GAMECORE_ADVENTURESUBMITSKILL_METHOD_3_F1F42F93AADA7B7E_OFFSET UNITYSDK_OFFSET(0x1AE62D50)
#define RPG_GAMECORE_ADVENTURESUBMITSKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE62DB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureSubmitSkill_TypeDefinitionIndex = 19439;
