...
#define RPG_GAMECORE_ADVENTURESUBMITSKILL_METHOD_3_2E404C68A577BDEF_OFFSET UNITYSDK_OFFSET(0x16F5B010)
#define RPG_GAMECORE_ADVENTURESUBMITSKILL_METHOD_3_B0072F5823873BC5_OFFSET UNITYSDK_OFFSET(0x16F5AF40)
#define RPG_GAMECORE_ADVENTURESUBMITSKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x16F5AFC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureSubmitSkill_TypeDefinitionIndex = 18504;
