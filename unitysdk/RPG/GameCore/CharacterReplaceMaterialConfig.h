...
#define RPG_GAMECORE_CHARACTERREPLACEMATERIALCONFIG_METHOD_2_F52E50EA21BDA1E3_OFFSET UNITYSDK_OFFSET(0x1CF9D1A0)
#define RPG_GAMECORE_CHARACTERREPLACEMATERIALCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF9D2F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterReplaceMaterialConfig_TypeDefinitionIndex = 17246;
