...
#define RPG_GAMECORE_ANIMATORCLIPZONENEWCONFIG_METHOD_2_900EB439B8CF7903_OFFSET UNITYSDK_OFFSET(0x1947B0C0)
#define RPG_GAMECORE_ANIMATORCLIPZONENEWCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1947B1B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AnimatorClipZoneNewConfig_TypeDefinitionIndex = 15519;
