...
#define RPG_GAMECORE_UNLOADLEVELGROUP_METHOD_3_B09BA640822CFE60_OFFSET UNITYSDK_OFFSET(0x1D623BF0)
#define RPG_GAMECORE_UNLOADLEVELGROUP_METHOD_3_E0BD81BF395B3123_OFFSET UNITYSDK_OFFSET(0x1D623BB0)
#define RPG_GAMECORE_UNLOADLEVELGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D623BE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UnloadLevelGroup_TypeDefinitionIndex = 20190;
