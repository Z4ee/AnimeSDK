...
#define RPG_GAMECORE_UNLOADLEVELGROUP_METHOD_3_8DC48189F4267519_OFFSET UNITYSDK_OFFSET(0x178E6E40)
#define RPG_GAMECORE_UNLOADLEVELGROUP_METHOD_3_B09BA640822CFE60_OFFSET UNITYSDK_OFFSET(0x178E6EC0)
#define RPG_GAMECORE_UNLOADLEVELGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x178E6E90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UnloadLevelGroup_TypeDefinitionIndex = 18725;
