...
#define RPG_GAMECORE_FIVEDIMCAMERALOOKAHEADCONFIG_METHOD_2_F645A691B20C642B_OFFSET UNITYSDK_OFFSET(0x1D0A4D10)
#define RPG_GAMECORE_FIVEDIMCAMERALOOKAHEADCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0A5100)
