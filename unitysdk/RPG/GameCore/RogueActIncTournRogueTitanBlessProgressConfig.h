...
#define RPG_GAMECORE_ROGUEACTINCTOURNROGUETITANBLESSPROGRESSCONFIG_METHOD_6_B589F318955809F0_OFFSET UNITYSDK_OFFSET(0x18CC4940)
#define RPG_GAMECORE_ROGUEACTINCTOURNROGUETITANBLESSPROGRESSCONFIG_METHOD_6_C27F29A56BBC217D_OFFSET UNITYSDK_OFFSET(0x18CC4720)
#define RPG_GAMECORE_ROGUEACTINCTOURNROGUETITANBLESSPROGRESSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CC4860)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActIncTournRogueTitanBlessProgressConfig_TypeDefinitionIndex = 18704;
