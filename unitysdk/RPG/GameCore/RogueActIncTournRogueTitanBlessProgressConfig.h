...
#define RPG_GAMECORE_ROGUEACTINCTOURNROGUETITANBLESSPROGRESSCONFIG_METHOD_6_AA4630FF28967FF4_OFFSET UNITYSDK_OFFSET(0x1D3B7E10)
#define RPG_GAMECORE_ROGUEACTINCTOURNROGUETITANBLESSPROGRESSCONFIG_METHOD_6_B589F318955809F0_OFFSET UNITYSDK_OFFSET(0x1D3B7E60)
#define RPG_GAMECORE_ROGUEACTINCTOURNROGUETITANBLESSPROGRESSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3B7E50)
