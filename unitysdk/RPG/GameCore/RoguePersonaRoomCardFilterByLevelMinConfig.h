...
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYLEVELMINCONFIG_METHOD_3_A8A7F5142DA3AA03_OFFSET UNITYSDK_OFFSET(0x18D657D0)
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYLEVELMINCONFIG_METHOD_3_E8F18D589E1380FF_OFFSET UNITYSDK_OFFSET(0x18D65A40)
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYLEVELMINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D657C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RoguePersonaRoomCardFilterByLevelMinConfig_TypeDefinitionIndex = 18858;
