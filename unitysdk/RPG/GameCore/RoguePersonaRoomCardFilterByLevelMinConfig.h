...
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYLEVELMINCONFIG_METHOD_3_A8A7F5142DA3AA03_OFFSET UNITYSDK_OFFSET(0x19BB9C90)
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYLEVELMINCONFIG_METHOD_3_E8F18D589E1380FF_OFFSET UNITYSDK_OFFSET(0x19BB9F00)
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYLEVELMINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19BB9C80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RoguePersonaRoomCardFilterByLevelMinConfig_TypeDefinitionIndex = 18823;
