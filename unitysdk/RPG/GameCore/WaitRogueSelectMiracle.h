...
#define RPG_GAMECORE_WAITROGUESELECTMIRACLE_METHOD_3_11A19154C24B677F_OFFSET UNITYSDK_OFFSET(0x1D1BAEF0)
#define RPG_GAMECORE_WAITROGUESELECTMIRACLE_METHOD_3_D157F91051DB9083_OFFSET UNITYSDK_OFFSET(0x1D1BAF40)
#define RPG_GAMECORE_WAITROGUESELECTMIRACLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1BAF30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitRogueSelectMiracle_TypeDefinitionIndex = 19703;
