...
#define RPG_GAMECORE_WAITROGUESELECTMIRACLE_METHOD_3_577888128C9BDBD3_OFFSET UNITYSDK_OFFSET(0x17902EB0)
#define RPG_GAMECORE_WAITROGUESELECTMIRACLE_METHOD_3_D157F91051DB9083_OFFSET UNITYSDK_OFFSET(0x17902F40)
#define RPG_GAMECORE_WAITROGUESELECTMIRACLE__CTOR_OFFSET UNITYSDK_OFFSET(0x17902F10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitRogueSelectMiracle_TypeDefinitionIndex = 18785;
