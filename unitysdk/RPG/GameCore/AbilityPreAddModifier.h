...
#define RPG_GAMECORE_ABILITYPREADDMODIFIER_CLEAR_OFFSET UNITYSDK_OFFSET(0xCC7B950)
#define RPG_GAMECORE_ABILITYPREADDMODIFIER_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xCC7BA20)
#define RPG_GAMECORE_ABILITYPREADDMODIFIER_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xCC7B9A0)
#define RPG_GAMECORE_ABILITYPREADDMODIFIER_INIT_OFFSET UNITYSDK_OFFSET(0xCC7B900)
#define RPG_GAMECORE_ABILITYPREADDMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0xCC7BA70)
#define RPG_GAMECORE_ABILITYPREADDMODIFIER___IFIXBASEPROXY_CLEAR_OFFSET UNITYSDK_OFFSET(0xCC7BA80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AbilityPreAddModifier_TypeDefinitionIndex = 52835;
