...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYDICESURFACEWEIGHTBYRARITYCONFIG_METHOD_3_2E5C277B61DD45FE_OFFSET UNITYSDK_OFFSET(0x17633F40)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYDICESURFACEWEIGHTBYRARITYCONFIG_METHOD_3_846E69EE159681E7_OFFSET UNITYSDK_OFFSET(0x17633E70)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYDICESURFACEWEIGHTBYRARITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17633EF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyDiceSurfaceWeightByRarityConfig_TypeDefinitionIndex = 16480;
