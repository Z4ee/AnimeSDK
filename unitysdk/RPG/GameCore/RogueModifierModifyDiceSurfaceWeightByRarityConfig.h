...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYDICESURFACEWEIGHTBYRARITYCONFIG_METHOD_3_2E5C277B61DD45FE_OFFSET UNITYSDK_OFFSET(0x1D163A50)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYDICESURFACEWEIGHTBYRARITYCONFIG_METHOD_3_F3EA8CC3EC5FE6E2_OFFSET UNITYSDK_OFFSET(0x1D163A00)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYDICESURFACEWEIGHTBYRARITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D163A40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyDiceSurfaceWeightByRarityConfig_TypeDefinitionIndex = 17209;
