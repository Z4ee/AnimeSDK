...
#define RPG_GAMECORE_RESETADVENTURECHARACTERCOLLIDER_METHOD_3_CCC6A04664D5EC56_OFFSET UNITYSDK_OFFSET(0x1D01AAF0)
#define RPG_GAMECORE_RESETADVENTURECHARACTERCOLLIDER_METHOD_3_CD936FD75534C993_OFFSET UNITYSDK_OFFSET(0x1D01ABC0)
#define RPG_GAMECORE_RESETADVENTURECHARACTERCOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D01ABB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetAdventureCharacterCollider_TypeDefinitionIndex = 21603;
