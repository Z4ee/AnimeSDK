...
#define RPG_GAMECORE_RESETADVENTURECHARACTERCOLLIDER_METHOD_3_79898F93F3CDD53F_OFFSET UNITYSDK_OFFSET(0x19ACDEF0)
#define RPG_GAMECORE_RESETADVENTURECHARACTERCOLLIDER_METHOD_3_CD936FD75534C993_OFFSET UNITYSDK_OFFSET(0x19ACE000)
#define RPG_GAMECORE_RESETADVENTURECHARACTERCOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x19ACDFD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetAdventureCharacterCollider_TypeDefinitionIndex = 21188;
