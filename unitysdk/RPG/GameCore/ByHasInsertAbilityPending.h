...
#define RPG_GAMECORE_BYHASINSERTABILITYPENDING_METHOD_4_1E995031DDCC6C63_OFFSET UNITYSDK_OFFSET(0x1A8C6F80)
#define RPG_GAMECORE_BYHASINSERTABILITYPENDING_METHOD_4_9B3DFC5CEB06886B_OFFSET UNITYSDK_OFFSET(0x1A8C7130)
#define RPG_GAMECORE_BYHASINSERTABILITYPENDING_METHOD_4_9CEB163A7F796DA0_OFFSET UNITYSDK_OFFSET(0x1A8C6FC0)
#define RPG_GAMECORE_BYHASINSERTABILITYPENDING_METHOD_4_FE8A9FEB2BAE82F6_OFFSET UNITYSDK_OFFSET(0x1A8C7100)
#define RPG_GAMECORE_BYHASINSERTABILITYPENDING__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8C6FB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByHasInsertAbilityPending_TypeDefinitionIndex = 22690;
