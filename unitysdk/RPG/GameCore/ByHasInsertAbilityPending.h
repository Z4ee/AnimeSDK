...
#define RPG_GAMECORE_BYHASINSERTABILITYPENDING_METHOD_4_606916E40CB3357A_OFFSET UNITYSDK_OFFSET(0x18748780)
#define RPG_GAMECORE_BYHASINSERTABILITYPENDING_METHOD_4_9CEB163A7F796DA0_OFFSET UNITYSDK_OFFSET(0x18748850)
#define RPG_GAMECORE_BYHASINSERTABILITYPENDING__CTOR_OFFSET UNITYSDK_OFFSET(0x18748800)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByHasInsertAbilityPending_TypeDefinitionIndex = 22501;
