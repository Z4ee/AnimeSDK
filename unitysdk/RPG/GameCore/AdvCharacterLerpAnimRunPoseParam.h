...
#define RPG_GAMECORE_ADVCHARACTERLERPANIMRUNPOSEPARAM_METHOD_3_204391CF46B44B54_OFFSET UNITYSDK_OFFSET(0x1864AB10)
#define RPG_GAMECORE_ADVCHARACTERLERPANIMRUNPOSEPARAM_METHOD_3_CD094E279CFDF2A8_OFFSET UNITYSDK_OFFSET(0x1864ABE0)
#define RPG_GAMECORE_ADVCHARACTERLERPANIMRUNPOSEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1864AB90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvCharacterLerpAnimRunPoseParam_TypeDefinitionIndex = 19575;
