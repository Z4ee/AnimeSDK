...
#define RPG_GAMECORE_CHIMERADUELNORMALEFFECTPARAM_METHOD_3_0168E2E28520C2C5_OFFSET UNITYSDK_OFFSET(0x1C243CF0)
#define RPG_GAMECORE_CHIMERADUELNORMALEFFECTPARAM_METHOD_3_C7EE8492F165C34D_OFFSET UNITYSDK_OFFSET(0x1C243C90)
#define RPG_GAMECORE_CHIMERADUELNORMALEFFECTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1C243CE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelNormalEffectParam_TypeDefinitionIndex = 15402;
