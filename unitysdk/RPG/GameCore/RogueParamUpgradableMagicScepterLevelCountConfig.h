...
#define RPG_GAMECORE_ROGUEPARAMUPGRADABLEMAGICSCEPTERLEVELCOUNTCONFIG_METHOD_6_0086BA23DC14E856_OFFSET UNITYSDK_OFFSET(0x1BB67780)
#define RPG_GAMECORE_ROGUEPARAMUPGRADABLEMAGICSCEPTERLEVELCOUNTCONFIG_METHOD_6_9A66B98609259932_OFFSET UNITYSDK_OFFSET(0x1BB677D0)
#define RPG_GAMECORE_ROGUEPARAMUPGRADABLEMAGICSCEPTERLEVELCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB677C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamUpgradableMagicScepterLevelCountConfig_TypeDefinitionIndex = 19064;
