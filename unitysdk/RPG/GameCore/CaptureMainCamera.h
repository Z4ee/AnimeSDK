...
#define RPG_GAMECORE_CAPTUREMAINCAMERA_METHOD_3_25C46B96D91B52BA_OFFSET UNITYSDK_OFFSET(0x17053660)
#define RPG_GAMECORE_CAPTUREMAINCAMERA_METHOD_3_A20C1751DE045538_OFFSET UNITYSDK_OFFSET(0x170535E0)
#define RPG_GAMECORE_CAPTUREMAINCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x17053630)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CaptureMainCamera_TypeDefinitionIndex = 19144;
