...
#define RPG_GAMECORE_CAPTUREMAINCAMERA_METHOD_3_183206C4A3540575_OFFSET UNITYSDK_OFFSET(0x1D108980)
#define RPG_GAMECORE_CAPTUREMAINCAMERA_METHOD_3_25C46B96D91B52BA_OFFSET UNITYSDK_OFFSET(0x1D1089C0)
#define RPG_GAMECORE_CAPTUREMAINCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1089B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CaptureMainCamera_TypeDefinitionIndex = 20585;
