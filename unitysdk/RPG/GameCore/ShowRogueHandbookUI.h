...
#define RPG_GAMECORE_SHOWROGUEHANDBOOKUI_METHOD_3_146C90A561B4663E_OFFSET UNITYSDK_OFFSET(0x19C81BB0)
#define RPG_GAMECORE_SHOWROGUEHANDBOOKUI_METHOD_3_1566CB95C1FAD752_OFFSET UNITYSDK_OFFSET(0x19C81B30)
#define RPG_GAMECORE_SHOWROGUEHANDBOOKUI__CTOR_OFFSET UNITYSDK_OFFSET(0x19C81B80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowRogueHandbookUI_TypeDefinitionIndex = 20871;
