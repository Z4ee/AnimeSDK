...
#define RPG_GAMECORE_SHOWROGUEHANDBOOKUI_METHOD_3_09ED2C8504C2E4DD_OFFSET UNITYSDK_OFFSET(0x1D52E9E0)
#define RPG_GAMECORE_SHOWROGUEHANDBOOKUI_METHOD_3_146C90A561B4663E_OFFSET UNITYSDK_OFFSET(0x1D52EA20)
#define RPG_GAMECORE_SHOWROGUEHANDBOOKUI__CTOR_OFFSET UNITYSDK_OFFSET(0x1D52EA10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowRogueHandbookUI_TypeDefinitionIndex = 21846;
