...
#define RPG_GAMECORE_TRIGGERDRINKMAKERBARTEND_METHOD_3_BE306024692CB6E0_OFFSET UNITYSDK_OFFSET(0x1B048720)
#define RPG_GAMECORE_TRIGGERDRINKMAKERBARTEND_METHOD_3_EE523BA3205AE9A3_OFFSET UNITYSDK_OFFSET(0x1B0486E0)
#define RPG_GAMECORE_TRIGGERDRINKMAKERBARTEND__CTOR_OFFSET UNITYSDK_OFFSET(0x1B048710)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerDrinkMakerBartend_TypeDefinitionIndex = 20910;
