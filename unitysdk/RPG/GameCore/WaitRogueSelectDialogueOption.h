...
#define RPG_GAMECORE_WAITROGUESELECTDIALOGUEOPTION_METHOD_3_7BE676803410C2C1_OFFSET UNITYSDK_OFFSET(0x1D6AAF70)
#define RPG_GAMECORE_WAITROGUESELECTDIALOGUEOPTION_METHOD_3_DF78D0BD58DE2C9D_OFFSET UNITYSDK_OFFSET(0x1D6AAF20)
#define RPG_GAMECORE_WAITROGUESELECTDIALOGUEOPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6AAF60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitRogueSelectDialogueOption_TypeDefinitionIndex = 20252;
