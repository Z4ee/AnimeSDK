...
#define RPG_GAMECORE_WAITROGUESELECTDIALOGUEOPTION_METHOD_3_7BE676803410C2C1_OFFSET UNITYSDK_OFFSET(0x19E5F5C0)
#define RPG_GAMECORE_WAITROGUESELECTDIALOGUEOPTION_METHOD_3_B38572E55414D491_OFFSET UNITYSDK_OFFSET(0x19E5F530)
#define RPG_GAMECORE_WAITROGUESELECTDIALOGUEOPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19E5F590)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitRogueSelectDialogueOption_TypeDefinitionIndex = 19350;
