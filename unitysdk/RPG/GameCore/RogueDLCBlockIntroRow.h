...
#define RPG_GAMECORE_ROGUEDLCBLOCKINTROROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D921440)
#define RPG_GAMECORE_ROGUEDLCBLOCKINTROROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D921C70)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID BlockIntroDesc; // 0x30
		::RPG::Client::TextID BlockIntroName; // 0x40
