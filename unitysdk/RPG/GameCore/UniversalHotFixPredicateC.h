...
#define RPG_GAMECORE_UNIVERSALHOTFIXPREDICATEC_METHOD_5_01782926F36D8F24_OFFSET UNITYSDK_OFFSET(0x1D2B0900)
#define RPG_GAMECORE_UNIVERSALHOTFIXPREDICATEC_METHOD_5_710EC77505610642_OFFSET UNITYSDK_OFFSET(0x1D2B28A0)
#define RPG_GAMECORE_UNIVERSALHOTFIXPREDICATEC_METHOD_5_EF0D16657D89F9A6_OFFSET UNITYSDK_OFFSET(0x1D2B2870)
#define RPG_GAMECORE_UNIVERSALHOTFIXPREDICATEC_METHOD_5_EFCB24E4A3C9E61B_OFFSET UNITYSDK_OFFSET(0x1D2AF9D0)
#define RPG_GAMECORE_UNIVERSALHOTFIXPREDICATEC__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2AF9C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UniversalHotFixPredicateC_TypeDefinitionIndex = 23098;
