...
#define RPG_GAMECORE_AIVARIABLEINT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x16E941D0)
#define RPG_GAMECORE_AIVARIABLEINT_EQUALS_2_OFFSET UNITYSDK_OFFSET(0x16E94140)
#define RPG_GAMECORE_AIVARIABLEINT_EQUALS_OFFSET UNITYSDK_OFFSET(0x16E940F0)
#define RPG_GAMECORE_AIVARIABLEINT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x16E94290)
#define RPG_GAMECORE_AIVARIABLEINT_METHOD_3_4A36F66A17625501_1_OFFSET UNITYSDK_OFFSET(0x16E94380)
#define RPG_GAMECORE_AIVARIABLEINT_METHOD_3_4A36F66A17625501_OFFSET UNITYSDK_OFFSET(0x16E94340)
#define RPG_GAMECORE_AIVARIABLEINT_METHOD_3_8CA41CC098D6F426_OFFSET UNITYSDK_OFFSET(0x16E93110)
#define RPG_GAMECORE_AIVARIABLEINT_METHOD_3_9A3D7F22E23EA6A3_OFFSET UNITYSDK_OFFSET(0x16E940C0)
#define RPG_GAMECORE_AIVARIABLEINT__CTOR_OFFSET UNITYSDK_OFFSET(0x16E93100)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AIVariableInt_TypeDefinitionIndex = 14304;
