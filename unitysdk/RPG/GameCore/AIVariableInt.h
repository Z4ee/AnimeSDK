...
#define RPG_GAMECORE_AIVARIABLEINT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1CD6A740)
#define RPG_GAMECORE_AIVARIABLEINT_EQUALS_2_OFFSET UNITYSDK_OFFSET(0x1CD6A680)
#define RPG_GAMECORE_AIVARIABLEINT_EQUALS_OFFSET UNITYSDK_OFFSET(0x1CD6A630)
#define RPG_GAMECORE_AIVARIABLEINT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1CD6A830)
#define RPG_GAMECORE_AIVARIABLEINT_METHOD_3_5F5ECAD68BA36F5E_OFFSET UNITYSDK_OFFSET(0x1CD6A8E0)
#define RPG_GAMECORE_AIVARIABLEINT_METHOD_3_8CA41CC098D6F426_OFFSET UNITYSDK_OFFSET(0x1CD68B00)
#define RPG_GAMECORE_AIVARIABLEINT_METHOD_3_9A3D7F22E23EA6A3_OFFSET UNITYSDK_OFFSET(0x1CD6A600)
#define RPG_GAMECORE_AIVARIABLEINT_METHOD_3_DAB77CFB9863299F_OFFSET UNITYSDK_OFFSET(0x1CD6AA30)
#define RPG_GAMECORE_AIVARIABLEINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD68AF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AIVariableInt_TypeDefinitionIndex = 15436;
