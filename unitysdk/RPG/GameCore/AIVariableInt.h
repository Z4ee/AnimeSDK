...
#define RPG_GAMECORE_AIVARIABLEINT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1D3278B0)
#define RPG_GAMECORE_AIVARIABLEINT_EQUALS_2_OFFSET UNITYSDK_OFFSET(0x1D3277F0)
#define RPG_GAMECORE_AIVARIABLEINT_EQUALS_OFFSET UNITYSDK_OFFSET(0x1D3277A0)
#define RPG_GAMECORE_AIVARIABLEINT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1D3279A0)
#define RPG_GAMECORE_AIVARIABLEINT_METHOD_3_5F5ECAD68BA36F5E_OFFSET UNITYSDK_OFFSET(0x1D327A50)
#define RPG_GAMECORE_AIVARIABLEINT_METHOD_3_8CA41CC098D6F426_OFFSET UNITYSDK_OFFSET(0x1D325C70)
#define RPG_GAMECORE_AIVARIABLEINT_METHOD_3_9A3D7F22E23EA6A3_OFFSET UNITYSDK_OFFSET(0x1D327770)
#define RPG_GAMECORE_AIVARIABLEINT_METHOD_3_DAB77CFB9863299F_OFFSET UNITYSDK_OFFSET(0x1D327BA0)
#define RPG_GAMECORE_AIVARIABLEINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D325C60)
