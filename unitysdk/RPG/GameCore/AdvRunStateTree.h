...
#define RPG_GAMECORE_ADVRUNSTATETREE_METHOD_3_931F2F5A9AE86961_OFFSET UNITYSDK_OFFSET(0x18660080)
#define RPG_GAMECORE_ADVRUNSTATETREE_METHOD_3_A91ADF6A9D44E2D0_OFFSET UNITYSDK_OFFSET(0x18660100)
#define RPG_GAMECORE_ADVRUNSTATETREE__CTOR_OFFSET UNITYSDK_OFFSET(0x186600D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvRunStateTree_TypeDefinitionIndex = 18930;
