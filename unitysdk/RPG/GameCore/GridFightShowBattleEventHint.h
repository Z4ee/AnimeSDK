...
#define RPG_GAMECORE_GRIDFIGHTSHOWBATTLEEVENTHINT_METHOD_3_9CFD50408E4DA2B5_OFFSET UNITYSDK_OFFSET(0x1D3B9400)
#define RPG_GAMECORE_GRIDFIGHTSHOWBATTLEEVENTHINT_METHOD_3_ED47131FF80E09EC_OFFSET UNITYSDK_OFFSET(0x1D3B9440)
#define RPG_GAMECORE_GRIDFIGHTSHOWBATTLEEVENTHINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3B9430)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightShowBattleEventHint_TypeDefinitionIndex = 22970;
