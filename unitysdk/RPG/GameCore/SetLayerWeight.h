...
#define RPG_GAMECORE_SETLAYERWEIGHT_METHOD_3_6B1DE705D2D6C718_OFFSET UNITYSDK_OFFSET(0x1E083420)
#define RPG_GAMECORE_SETLAYERWEIGHT_METHOD_3_CD6BF8F0F380EC33_OFFSET UNITYSDK_OFFSET(0x1E083520)
#define RPG_GAMECORE_SETLAYERWEIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0834B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetLayerWeight_TypeDefinitionIndex = 22831;
