...
#define RPG_GAMECORE_SETLAYERWEIGHT_METHOD_3_20C0D395DE9B131B_OFFSET UNITYSDK_OFFSET(0x18E36140)
#define RPG_GAMECORE_SETLAYERWEIGHT_METHOD_3_CD6BF8F0F380EC33_OFFSET UNITYSDK_OFFSET(0x18E36260)
#define RPG_GAMECORE_SETLAYERWEIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x18E361E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetLayerWeight_TypeDefinitionIndex = 22025;
