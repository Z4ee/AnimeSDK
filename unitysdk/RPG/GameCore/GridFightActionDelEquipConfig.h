...
#define RPG_GAMECORE_GRIDFIGHTACTIONDELEQUIPCONFIG_METHOD_6_62AD735DD9AF2EE1_OFFSET UNITYSDK_OFFSET(0x1C5C1E20)
#define RPG_GAMECORE_GRIDFIGHTACTIONDELEQUIPCONFIG_METHOD_6_C28BE9877C542645_OFFSET UNITYSDK_OFFSET(0x1C5C1B30)
#define RPG_GAMECORE_GRIDFIGHTACTIONDELEQUIPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5C1B20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightActionDelEquipConfig_TypeDefinitionIndex = 18569;
