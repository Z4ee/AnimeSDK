...
#define RPG_GAMECORE_FIVEDIMKILLEFFECTACTION_METHOD_3_6F4F70C55A92EB76_OFFSET UNITYSDK_OFFSET(0x18907B00)
#define RPG_GAMECORE_FIVEDIMKILLEFFECTACTION_METHOD_3_C955AEBFCEDFE0AA_OFFSET UNITYSDK_OFFSET(0x18907A20)
#define RPG_GAMECORE_FIVEDIMKILLEFFECTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18907AE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimKillEffectAction_TypeDefinitionIndex = 17803;
