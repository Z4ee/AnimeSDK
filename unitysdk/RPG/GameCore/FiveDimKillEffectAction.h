...
#define RPG_GAMECORE_FIVEDIMKILLEFFECTACTION_METHOD_3_6F4F70C55A92EB76_OFFSET UNITYSDK_OFFSET(0x1BA9C7D0)
#define RPG_GAMECORE_FIVEDIMKILLEFFECTACTION_METHOD_3_EFFC29FDF5A5ADB3_OFFSET UNITYSDK_OFFSET(0x1BA9C720)
#define RPG_GAMECORE_FIVEDIMKILLEFFECTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA9C7C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimKillEffectAction_TypeDefinitionIndex = 18007;
