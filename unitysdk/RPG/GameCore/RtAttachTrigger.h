...
#define RPG_GAMECORE_RTATTACHTRIGGER_METHOD_3_6BFFC3498DFFAA0F_OFFSET UNITYSDK_OFFSET(0x1BB84D00)
#define RPG_GAMECORE_RTATTACHTRIGGER_METHOD_3_D608554727096ABA_OFFSET UNITYSDK_OFFSET(0x1BB84E00)
#define RPG_GAMECORE_RTATTACHTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB84D40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtAttachTrigger_TypeDefinitionIndex = 23275;
