...
#define RPG_GAMECORE_STREAMINGGROUPVOLUMECOMPONENTDATA_METHOD_3_7A523BEE0904FFC4_OFFSET UNITYSDK_OFFSET(0x17781E50)
#define RPG_GAMECORE_STREAMINGGROUPVOLUMECOMPONENTDATA_METHOD_3_99C0230C56212B7F_OFFSET UNITYSDK_OFFSET(0x17781E90)
#define RPG_GAMECORE_STREAMINGGROUPVOLUMECOMPONENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17781E80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StreamingGroupVolumeComponentData_TypeDefinitionIndex = 17531;
