...
#define RPG_GAMECORE_STREAMINGGROUPVOLUMECOMPONENTDATA_METHOD_3_01E9D8687F4BCB09_OFFSET UNITYSDK_OFFSET(0x1B0CA2A0)
#define RPG_GAMECORE_STREAMINGGROUPVOLUMECOMPONENTDATA_METHOD_3_2A17435B120EDACA_OFFSET UNITYSDK_OFFSET(0x1B0CA2D0)
#define RPG_GAMECORE_STREAMINGGROUPVOLUMECOMPONENTDATA_METHOD_3_47765121E61C1EE3_OFFSET UNITYSDK_OFFSET(0x1B0B6980)
#define RPG_GAMECORE_STREAMINGGROUPVOLUMECOMPONENTDATA_METHOD_3_BF896F808D9AF642_OFFSET UNITYSDK_OFFSET(0x1B0B6050)
#define RPG_GAMECORE_STREAMINGGROUPVOLUMECOMPONENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0B6040)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StreamingGroupVolumeComponentData_TypeDefinitionIndex = 18370;
