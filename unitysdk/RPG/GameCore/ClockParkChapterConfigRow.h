...
#define RPG_GAMECORE_CLOCKPARKCHAPTERCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x170B7CD0)
#define RPG_GAMECORE_CLOCKPARKCHAPTERCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x170B8580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClockParkChapterConfigRow_TypeDefinitionIndex = 10444;
	...
	public:
		...
		::Il2CppArray<::System::UInt32>* CheckPointList; // 0x20
		...
		::System::UInt32 RewardProgress; // 0x54
