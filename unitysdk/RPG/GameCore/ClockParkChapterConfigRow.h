...
#define RPG_GAMECORE_CLOCKPARKCHAPTERCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CFE0710)
#define RPG_GAMECORE_CLOCKPARKCHAPTERCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFE0FC0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::System::UInt32>* NextChapterID; // 0x18
		::Il2CppArray<::System::UInt32>* ChapterRoundIDList; // 0x20
		::Il2CppArray<::System::UInt32>* CheckPointList; // 0x28
		::Il2CppArray<::System::UInt32>* ChapterGamePlayRoundRandomList; // 0x30
		::RPG::Client::TextID ChapterTitle; // 0x38
		::System::UInt32 SuccessToRoundID; // 0x48
		::System::UInt32 RewardID; // 0x4C
		::RPG::GameCore::ClockParkChapterType ChapterType; // 0x50
		::System::UInt32 ChapterAutoUnlock; // 0x54
