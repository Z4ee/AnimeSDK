...
#define RPG_GAMECORE_CHALLENGEMAZEREWARDLINEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x195FE7C0)
#define RPG_GAMECORE_CHALLENGEMAZEREWARDLINEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x195FE900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChallengeMazeRewardLineRow_TypeDefinitionIndex = 12345;
