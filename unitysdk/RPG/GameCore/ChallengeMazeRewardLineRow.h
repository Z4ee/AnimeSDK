...
#define RPG_GAMECORE_CHALLENGEMAZEREWARDLINEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B714910)
#define RPG_GAMECORE_CHALLENGEMAZEREWARDLINEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B714A50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChallengeMazeRewardLineRow_TypeDefinitionIndex = 12478;
