...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERREPLACETRAITEFFECTELATIONTEMPLATECONFIG_METHOD_3_8AF0A89B4FDE685A_OFFSET UNITYSDK_OFFSET(0x197F35F0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERREPLACETRAITEFFECTELATIONTEMPLATECONFIG_METHOD_3_C82CC9B4719FA613_OFFSET UNITYSDK_OFFSET(0x197EEDB0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERREPLACETRAITEFFECTELATIONTEMPLATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197EED60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierReplaceTraitEffectElationTemplateConfig_TypeDefinitionIndex = 18484;
