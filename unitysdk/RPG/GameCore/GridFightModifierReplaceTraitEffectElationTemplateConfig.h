...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERREPLACETRAITEFFECTELATIONTEMPLATECONFIG_METHOD_3_2C365C99F445CD4F_OFFSET UNITYSDK_OFFSET(0x1D06AAA0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERREPLACETRAITEFFECTELATIONTEMPLATECONFIG_METHOD_3_C82CC9B4719FA613_OFFSET UNITYSDK_OFFSET(0x1D06AAF0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERREPLACETRAITEFFECTELATIONTEMPLATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D06AAE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierReplaceTraitEffectElationTemplateConfig_TypeDefinitionIndex = 18734;
