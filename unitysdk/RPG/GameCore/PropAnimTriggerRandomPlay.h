...
#define RPG_GAMECORE_PROPANIMTRIGGERRANDOMPLAY_METHOD_3_B1B3533AC46901C2_OFFSET UNITYSDK_OFFSET(0x1D35F610)
#define RPG_GAMECORE_PROPANIMTRIGGERRANDOMPLAY_METHOD_3_F629FCB0AA59E57A_OFFSET UNITYSDK_OFFSET(0x1D35F690)
#define RPG_GAMECORE_PROPANIMTRIGGERRANDOMPLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D35F660)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropAnimTriggerRandomPlay_TypeDefinitionIndex = 21996;
