...
#define RPG_GAMECORE_PROPANIMTRIGGERRANDOMPLAY_METHOD_3_996AC7CCE23F15E8_OFFSET UNITYSDK_OFFSET(0x18C64BB0)
#define RPG_GAMECORE_PROPANIMTRIGGERRANDOMPLAY_METHOD_3_EB3462AAE55C026D_OFFSET UNITYSDK_OFFSET(0x18C64A60)
#define RPG_GAMECORE_PROPANIMTRIGGERRANDOMPLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x18C64B20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropAnimTriggerRandomPlay_TypeDefinitionIndex = 21120;
