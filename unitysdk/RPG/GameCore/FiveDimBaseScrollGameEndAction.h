...
#define RPG_GAMECORE_FIVEDIMBASESCROLLGAMEENDACTION_METHOD_3_25BB06C441D9AB5E_OFFSET UNITYSDK_OFFSET(0x1BA8B5E0)
#define RPG_GAMECORE_FIVEDIMBASESCROLLGAMEENDACTION_METHOD_3_EF2FA5A106B0E3CF_OFFSET UNITYSDK_OFFSET(0x1BA8B660)
#define RPG_GAMECORE_FIVEDIMBASESCROLLGAMEENDACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA8B650)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimBaseScrollGameEndAction_TypeDefinitionIndex = 18028;
