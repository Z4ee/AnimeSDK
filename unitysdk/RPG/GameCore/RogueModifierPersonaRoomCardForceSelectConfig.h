...
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAROOMCARDFORCESELECTCONFIG_METHOD_3_2F5785A37C3A188A_OFFSET UNITYSDK_OFFSET(0x19B9A430)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAROOMCARDFORCESELECTCONFIG_METHOD_3_BCFCED74BD795153_OFFSET UNITYSDK_OFFSET(0x19B9A360)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAROOMCARDFORCESELECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B9A3E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierPersonaRoomCardForceSelectConfig_TypeDefinitionIndex = 16926;
