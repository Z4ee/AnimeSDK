...
#define RPG_GAMECORE_CHIMERADUELENTITYATTRIBUTECOMPARER_METHOD_4_A5742A1A2BBF4D41_OFFSET UNITYSDK_OFFSET(0x1C393BB0)
#define RPG_GAMECORE_CHIMERADUELENTITYATTRIBUTECOMPARER_METHOD_4_B86C096D33D94DE1_OFFSET UNITYSDK_OFFSET(0x1C395710)
#define RPG_GAMECORE_CHIMERADUELENTITYATTRIBUTECOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C393BA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelEntityAttributeComparer_TypeDefinitionIndex = 15322;
