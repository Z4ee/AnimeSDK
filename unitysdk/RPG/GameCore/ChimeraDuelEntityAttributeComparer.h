...
#define RPG_GAMECORE_CHIMERADUELENTITYATTRIBUTECOMPARER_METHOD_4_A5742A1A2BBF4D41_OFFSET UNITYSDK_OFFSET(0x170989E0)
#define RPG_GAMECORE_CHIMERADUELENTITYATTRIBUTECOMPARER_METHOD_4_B86C096D33D94DE1_OFFSET UNITYSDK_OFFSET(0x1709A800)
#define RPG_GAMECORE_CHIMERADUELENTITYATTRIBUTECOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x170989D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelEntityAttributeComparer_TypeDefinitionIndex = 14625;
