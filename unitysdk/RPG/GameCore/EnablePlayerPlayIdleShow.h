...
#define RPG_GAMECORE_ENABLEPLAYERPLAYIDLESHOW_METHOD_3_225DA68250E8CFB6_OFFSET UNITYSDK_OFFSET(0x1D063B80)
#define RPG_GAMECORE_ENABLEPLAYERPLAYIDLESHOW_METHOD_3_935470EBFC1A2E75_OFFSET UNITYSDK_OFFSET(0x1D063BD0)
#define RPG_GAMECORE_ENABLEPLAYERPLAYIDLESHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D063BC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnablePlayerPlayIdleShow_TypeDefinitionIndex = 21998;
