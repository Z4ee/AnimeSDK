...
#define RPG_GAMECORE_PERFORMANCEBACKUPCONFIG_METHOD_2_35B6B26CB69DB3D4_OFFSET UNITYSDK_OFFSET(0x1D313900)
#define RPG_GAMECORE_PERFORMANCEBACKUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D313B40)
