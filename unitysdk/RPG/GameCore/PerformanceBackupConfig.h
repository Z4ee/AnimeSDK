...
#define RPG_GAMECORE_PERFORMANCEBACKUPCONFIG_METHOD_2_35B6B26CB69DB3D4_OFFSET UNITYSDK_OFFSET(0x1D41C5D0)
#define RPG_GAMECORE_PERFORMANCEBACKUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D41C810)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PerformanceBackupConfig_TypeDefinitionIndex = 18810;
