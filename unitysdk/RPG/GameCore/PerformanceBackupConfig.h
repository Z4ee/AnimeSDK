...
#define RPG_GAMECORE_PERFORMANCEBACKUPCONFIG_METHOD_2_774E6EC19B37663B_OFFSET UNITYSDK_OFFSET(0x17492060)
#define RPG_GAMECORE_PERFORMANCEBACKUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x174922A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PerformanceBackupConfig_TypeDefinitionIndex = 17449;
