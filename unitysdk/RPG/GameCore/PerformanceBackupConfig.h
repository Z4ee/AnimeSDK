...
#define RPG_GAMECORE_PERFORMANCEBACKUPCONFIG_METHOD_2_35B6B26CB69DB3D4_OFFSET UNITYSDK_OFFSET(0x1BB166B0)
#define RPG_GAMECORE_PERFORMANCEBACKUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB168F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PerformanceBackupConfig_TypeDefinitionIndex = 18286;
