...
#define RPG_GAMECORE_CAKERACEOWLBERTANIMCONFIG_METHOD_2_BD854603E796B065_OFFSET UNITYSDK_OFFSET(0x195EFB00)
#define RPG_GAMECORE_CAKERACEOWLBERTANIMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x195EFBE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceOwlbertAnimConfig_TypeDefinitionIndex = 17466;
