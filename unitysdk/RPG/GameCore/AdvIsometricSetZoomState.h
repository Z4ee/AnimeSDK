...
#define RPG_GAMECORE_ADVISOMETRICSETZOOMSTATE_METHOD_3_0F03CFA9FAC9C2BC_OFFSET UNITYSDK_OFFSET(0x1BE1FE20)
#define RPG_GAMECORE_ADVISOMETRICSETZOOMSTATE_METHOD_3_DD7B4282ACBBB037_OFFSET UNITYSDK_OFFSET(0x1BE1FDE0)
#define RPG_GAMECORE_ADVISOMETRICSETZOOMSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE1FE10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvIsometricSetZoomState_TypeDefinitionIndex = 21404;
