...
#define RPG_GAMECORE_ADVISOMETRICSETZOOMSTATE_METHOD_3_0F03CFA9FAC9C2BC_OFFSET UNITYSDK_OFFSET(0x19427F80)
#define RPG_GAMECORE_ADVISOMETRICSETZOOMSTATE_METHOD_3_A6C886A518863B4D_OFFSET UNITYSDK_OFFSET(0x19427F00)
#define RPG_GAMECORE_ADVISOMETRICSETZOOMSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19427F50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvIsometricSetZoomState_TypeDefinitionIndex = 20989;
