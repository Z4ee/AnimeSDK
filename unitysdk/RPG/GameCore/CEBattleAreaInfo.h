...
#define RPG_GAMECORE_CEBATTLEAREAINFO_METHOD_2_4A955310D4F05E36_OFFSET UNITYSDK_OFFSET(0x18763FA0)
#define RPG_GAMECORE_CEBATTLEAREAINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18764150)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CEBattleAreaInfo_TypeDefinitionIndex = 17240;
