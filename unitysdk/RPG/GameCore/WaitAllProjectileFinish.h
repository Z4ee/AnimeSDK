...
#define RPG_GAMECORE_WAITALLPROJECTILEFINISH_METHOD_3_5DEE8A5C0BD1D577_OFFSET UNITYSDK_OFFSET(0x1D69E230)
#define RPG_GAMECORE_WAITALLPROJECTILEFINISH_METHOD_3_F0455338C7EBBF1A_OFFSET UNITYSDK_OFFSET(0x1D69E160)
#define RPG_GAMECORE_WAITALLPROJECTILEFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1D69E220)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitAllProjectileFinish_TypeDefinitionIndex = 23284;
