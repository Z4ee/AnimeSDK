...
#define RPG_GAMECORE_WAITALLPROJECTILEFINISH_METHOD_3_5DEE8A5C0BD1D577_OFFSET UNITYSDK_OFFSET(0x190F7BD0)
#define RPG_GAMECORE_WAITALLPROJECTILEFINISH_METHOD_3_EEDE14E8B23CF263_OFFSET UNITYSDK_OFFSET(0x190F7AC0)
#define RPG_GAMECORE_WAITALLPROJECTILEFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x190F7BA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitAllProjectileFinish_TypeDefinitionIndex = 22518;
