...
#define RPG_GAMECORE_SHOWBATTLEFEVERTIMESCREENFIRE_METHOD_3_259274731140E75D_OFFSET UNITYSDK_OFFSET(0x19C75310)
#define RPG_GAMECORE_SHOWBATTLEFEVERTIMESCREENFIRE_METHOD_3_C9E7EB81913A8CCC_OFFSET UNITYSDK_OFFSET(0x19C75390)
#define RPG_GAMECORE_SHOWBATTLEFEVERTIMESCREENFIRE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C75360)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowBattleFeverTimeScreenFire_TypeDefinitionIndex = 22031;
