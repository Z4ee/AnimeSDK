...
#define RPG_GAMECORE_CHIMERADUELSTORAGEEFFECTPARAM_METHOD_3_54881AA75555D7AB_OFFSET UNITYSDK_OFFSET(0x18805E90)
#define RPG_GAMECORE_CHIMERADUELSTORAGEEFFECTPARAM_METHOD_3_581BE94589A0DD55_OFFSET UNITYSDK_OFFSET(0x18805E30)
#define RPG_GAMECORE_CHIMERADUELSTORAGEEFFECTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x18805E80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelStorageEffectParam_TypeDefinitionIndex = 15178;
