...
#define RPG_GAMECORE_CHIMERADUELSTORAGEEFFECTPARAM_METHOD_3_54881AA75555D7AB_OFFSET UNITYSDK_OFFSET(0x170A68E0)
#define RPG_GAMECORE_CHIMERADUELSTORAGEEFFECTPARAM_METHOD_3_581BE94589A0DD55_OFFSET UNITYSDK_OFFSET(0x170A6880)
#define RPG_GAMECORE_CHIMERADUELSTORAGEEFFECTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x170A68D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelStorageEffectParam_TypeDefinitionIndex = 14708;
