...
#define RPG_GAMECORE_ROGUEAEONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C4A2960)
#define RPG_GAMECORE_ROGUEAEONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4A4570)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueAeonRow_TypeDefinitionIndex = 14239;

	class RogueAeonRow : public ::System::Object
	{
	public:
		::RPG::Client::TextID EffectDesc1; // 0x10
		::System::UInt32 ArrivedTalkDialogueGroupID; // 0x20
