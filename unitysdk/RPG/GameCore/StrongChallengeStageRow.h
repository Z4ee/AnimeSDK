...
#define RPG_GAMECORE_STRONGCHALLENGESTAGEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19CC7EC0)
#define RPG_GAMECORE_STRONGCHALLENGESTAGEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19CC8A90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StrongChallengeStageRow_TypeDefinitionIndex = 11822;

	class StrongChallengeStageRow : public ::System::Object
	{
	public:
		::Il2CppArray<::System::UInt32>* BossDetailList; // 0x10
		...
		::System::String* MonsterGrayFigurePath; // 0x38
		...
		::Il2CppArray<::System::UInt32>* ScoreInterval; // 0x58
		::System::UInt32 StrongChallengeStageID; // 0x60
		::System::UInt32 BattleAreaID; // 0x64
		::RPG::Client::TextID Name; // 0x68
		::System::UInt32 BattleAreaGroupID; // 0x78
		::System::UInt32 ActivityModuleID; // 0x7C
		::System::UInt32 PreStageID; // 0x80
		::System::UInt32 ClearScoreLine; // 0x84
