...
#define RPG_GAMECORE_GRIDFIGHTEQUIPCATEGORYINFOROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D151590)
#define RPG_GAMECORE_GRIDFIGHTEQUIPCATEGORYINFOROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D151760)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightEquipCategoryInfoRow_TypeDefinitionIndex = 13346;

	class GridFightEquipCategoryInfoRow : public ::System::Object
	{
	public:
		::System::UInt32 EquipCount; // 0x10
		::RPG::GameCore::GridFightEquipCategory EquipCategory; // 0x14
