...
#define RPG_GAMECORE_PREAVATARLEVELINGTEMPLATEDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D358D50)
#define RPG_GAMECORE_PREAVATARLEVELINGTEMPLATEDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D359140)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 WorldMaterialLargeAmount; // 0x14
		::System::UInt32 SkillMaterialLargeAmount; // 0x18
		::System::UInt32 TemplateID; // 0x1C
		::System::UInt32 CoinAmount; // 0x20
		::System::UInt32 PromotionMaterialAmount; // 0x24
		::System::UInt32 ExpAmount; // 0x28
		::System::UInt32 SkillMaterialSmallAmount; // 0x2C
