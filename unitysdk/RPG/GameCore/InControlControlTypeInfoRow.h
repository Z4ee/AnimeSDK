...
#define RPG_GAMECORE_INCONTROLCONTROLTYPEINFOROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D218F60)
#define RPG_GAMECORE_INCONTROLCONTROLTYPEINFOROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2195D0)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::System::String* iconForXBox; // 0x10
