...
#define RPG_GAMECORE_INCONTROLCONTROLTYPEINFOROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B00B9C0)
#define RPG_GAMECORE_INCONTROLCONTROLTYPEINFOROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B00C030)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* iconForSony; // 0x18
		::System::String* controlType; // 0x20
