...
#define RPG_GAMECORE_INCONTROLCONTROLTYPEINFOROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1984B4C0)
#define RPG_GAMECORE_INCONTROLCONTROLTYPEINFOROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1984BB30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int InControlControlTypeInfoRow_TypeDefinitionIndex = 13175;

	class InControlControlTypeInfoRow : public ::System::Object
	{
	public:
		::System::String* iconForSwitch; // 0x10
		::System::String* controlType; // 0x18
		::System::String* iconForXBox; // 0x20
		::System::String* iconForSony; // 0x28
