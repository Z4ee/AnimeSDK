...
#define RPG_GAMECORE_MARBLEDEBUG_METHOD_3_41A4F2B9983A0D76_OFFSET UNITYSDK_OFFSET(0x1738D0B0)
#define RPG_GAMECORE_MARBLEDEBUG_METHOD_3_901F8BF97475293D_OFFSET UNITYSDK_OFFSET(0x1738CF70)
#define RPG_GAMECORE_MARBLEDEBUG__CTOR_OFFSET UNITYSDK_OFFSET(0x1738D060)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleDebug_TypeDefinitionIndex = 15443;
