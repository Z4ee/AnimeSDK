...
#define RPG_GAMECORE_DYNAMICLOADBATTLEAREACONFIG_METHOD_3_5BA641472350F671_OFFSET UNITYSDK_OFFSET(0x17184F80)
#define RPG_GAMECORE_DYNAMICLOADBATTLEAREACONFIG_METHOD_3_E71AC4FF05BCC114_OFFSET UNITYSDK_OFFSET(0x17184F20)
#define RPG_GAMECORE_DYNAMICLOADBATTLEAREACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17184F60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DynamicLoadBattleAreaConfig_TypeDefinitionIndex = 17573;
