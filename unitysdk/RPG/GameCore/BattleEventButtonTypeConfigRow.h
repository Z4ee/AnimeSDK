...
#define RPG_GAMECORE_BATTLEEVENTBUTTONTYPECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CE703A0)
#define RPG_GAMECORE_BATTLEEVENTBUTTONTYPECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE70580)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* SkillButtonEffPath; // 0x20
