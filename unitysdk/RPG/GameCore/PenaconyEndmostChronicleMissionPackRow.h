...
#define RPG_GAMECORE_PENACONYENDMOSTCHRONICLEMISSIONPACKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1BB14B10)
#define RPG_GAMECORE_PENACONYENDMOSTCHRONICLEMISSIONPACKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB14C20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PenaconyEndmostChronicleMissionPackRow_TypeDefinitionIndex = 13605;
