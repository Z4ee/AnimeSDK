...
#define RPG_GAMECORE_SETDYNAMICVALUEBYGRIDFIGHTDROPCOUNT_METHOD_3_79AA379A17A0B48F_OFFSET UNITYSDK_OFFSET(0x18E20F70)
#define RPG_GAMECORE_SETDYNAMICVALUEBYGRIDFIGHTDROPCOUNT_METHOD_3_C15AAEBF3C8B2594_OFFSET UNITYSDK_OFFSET(0x18E20EF0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYGRIDFIGHTDROPCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x18E20F40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByGridFightDropCount_TypeDefinitionIndex = 21414;
