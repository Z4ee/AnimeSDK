...
#define RPG_GAMECORE_SETDYNAMICVALUEBYGRIDFIGHTDROPCOUNT_METHOD_3_79AA379A17A0B48F_OFFSET UNITYSDK_OFFSET(0x1C2E2320)
#define RPG_GAMECORE_SETDYNAMICVALUEBYGRIDFIGHTDROPCOUNT_METHOD_3_81D44423DFE6D67E_OFFSET UNITYSDK_OFFSET(0x1C2E22E0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYGRIDFIGHTDROPCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2E2310)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByGridFightDropCount_TypeDefinitionIndex = 21714;
