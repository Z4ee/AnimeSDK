...
#define RPG_GAMECORE_SETDYNAMICVALUEBYGRIDFIGHTDROPCOUNT_METHOD_3_79AA379A17A0B48F_OFFSET UNITYSDK_OFFSET(0x19C41420)
#define RPG_GAMECORE_SETDYNAMICVALUEBYGRIDFIGHTDROPCOUNT_METHOD_3_C15AAEBF3C8B2594_OFFSET UNITYSDK_OFFSET(0x19C413A0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYGRIDFIGHTDROPCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x19C413F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByGridFightDropCount_TypeDefinitionIndex = 21299;
