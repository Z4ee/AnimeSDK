...
#define RPG_GAMECORE_TRIGGERTEAMEDITUI_METHOD_3_632B40777C0C6C1D_OFFSET UNITYSDK_OFFSET(0x1B060C30)
#define RPG_GAMECORE_TRIGGERTEAMEDITUI_METHOD_3_C09E1CA193542060_OFFSET UNITYSDK_OFFSET(0x1B060D00)
#define RPG_GAMECORE_TRIGGERTEAMEDITUI__CTOR_OFFSET UNITYSDK_OFFSET(0x1B060CF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerTeamEditUI_TypeDefinitionIndex = 19632;
