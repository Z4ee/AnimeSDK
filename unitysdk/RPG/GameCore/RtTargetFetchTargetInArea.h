...
#define RPG_GAMECORE_RTTARGETFETCHTARGETINAREA_METHOD_4_352EF45F01E406B8_OFFSET UNITYSDK_OFFSET(0x1B76CFC0)
#define RPG_GAMECORE_RTTARGETFETCHTARGETINAREA_METHOD_4_B7A3FBC3AA2B5F25_OFFSET UNITYSDK_OFFSET(0x1B76CEE0)
#define RPG_GAMECORE_RTTARGETFETCHTARGETINAREA_METHOD_4_CD8444DCF48CFF0F_OFFSET UNITYSDK_OFFSET(0x1B76D2E0)
#define RPG_GAMECORE_RTTARGETFETCHTARGETINAREA_METHOD_4_F94401C46D72CD21_OFFSET UNITYSDK_OFFSET(0x1B76D360)
#define RPG_GAMECORE_RTTARGETFETCHTARGETINAREA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B76CF60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtTargetFetchTargetInArea_TypeDefinitionIndex = 23385;
