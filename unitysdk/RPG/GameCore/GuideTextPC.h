...
#define RPG_GAMECORE_GUIDETEXTPC_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17291A10)
#define RPG_GAMECORE_GUIDETEXTPC__CTOR_OFFSET UNITYSDK_OFFSET(0x17291EA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GuideTextPC_TypeDefinitionIndex = 22377;
	...
	public:
		...
		static ::System::Void FromBinary(::Class_1_7A22A3DBEEDD1F80* array, ::RPG::GameCore::GuideTextPC*& val)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::GuideTextPC*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_GUIDETEXTPC_FROMBINARY_OFFSET))(array, val);
		}
	};
}
