...
#define RPG_GAMECORE_DESTROYSUMMONUNIT_METHOD_3_3F284C2C2133A36A_OFFSET UNITYSDK_OFFSET(0x1885C010)
#define RPG_GAMECORE_DESTROYSUMMONUNIT_METHOD_3_DDE39ACCC4274351_OFFSET UNITYSDK_OFFSET(0x1885C090)
#define RPG_GAMECORE_DESTROYSUMMONUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1885C060)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DestroySummonUnit_TypeDefinitionIndex = 19308;
