...
#define RPG_GAMECORE_DESTROYSUMMONUNIT_METHOD_3_AA2778B6E37F7884_OFFSET UNITYSDK_OFFSET(0x1D021110)
#define RPG_GAMECORE_DESTROYSUMMONUNIT_METHOD_3_DDE39ACCC4274351_OFFSET UNITYSDK_OFFSET(0x1D021150)
#define RPG_GAMECORE_DESTROYSUMMONUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D021140)
