...
#define RPG_GAMECORE_REVERTACTIONENTITYTOOBSERVESTATE_METHOD_3_67ADC89AF98B2AA1_OFFSET UNITYSDK_OFFSET(0x18CB96D0)
#define RPG_GAMECORE_REVERTACTIONENTITYTOOBSERVESTATE_METHOD_3_D936C9E6891E0B48_OFFSET UNITYSDK_OFFSET(0x18CB9650)
#define RPG_GAMECORE_REVERTACTIONENTITYTOOBSERVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18CB96A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RevertActionEntityToObserveState_TypeDefinitionIndex = 22420;
