...
#define RPG_GAMECORE_REVERTACTIONENTITYTOOBSERVESTATE_METHOD_3_4318610568E94BBA_OFFSET UNITYSDK_OFFSET(0x1D029ED0)
#define RPG_GAMECORE_REVERTACTIONENTITYTOOBSERVESTATE_METHOD_3_67ADC89AF98B2AA1_OFFSET UNITYSDK_OFFSET(0x1D029F10)
#define RPG_GAMECORE_REVERTACTIONENTITYTOOBSERVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D029F00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RevertActionEntityToObserveState_TypeDefinitionIndex = 22611;
