...
#define RPG_GAMECORE_HIPPLENGAMECHARACTERATTACHTOMINI_METHOD_3_140540ACF5B57E59_OFFSET UNITYSDK_OFFSET(0x1D18FF90)
#define RPG_GAMECORE_HIPPLENGAMECHARACTERATTACHTOMINI_METHOD_3_99372F6CA5F8FB04_OFFSET UNITYSDK_OFFSET(0x1D18FFC0)
#define RPG_GAMECORE_HIPPLENGAMECHARACTERATTACHTOMINI__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1901C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HipplenGameCharacterAttachToMini_TypeDefinitionIndex = 21072;
