...
#define RPG_GAMECORE_HIPPLENGAMECHARACTERATTACHTOMINI_METHOD_3_99372F6CA5F8FB04_OFFSET UNITYSDK_OFFSET(0x172ACAD0)
#define RPG_GAMECORE_HIPPLENGAMECHARACTERATTACHTOMINI_METHOD_3_E6A98C616F9F56A3_OFFSET UNITYSDK_OFFSET(0x172ACA50)
#define RPG_GAMECORE_HIPPLENGAMECHARACTERATTACHTOMINI__CTOR_OFFSET UNITYSDK_OFFSET(0x172ACAA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HipplenGameCharacterAttachToMini_TypeDefinitionIndex = 19618;
