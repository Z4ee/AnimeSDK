...
#define RPG_GAMECORE_ROGUECONDPERSONACURROOMHASATTRIBUTECONFIG_METHOD_6_39FC354C8BDBF041_OFFSET UNITYSDK_OFFSET(0x1C4AED50)
#define RPG_GAMECORE_ROGUECONDPERSONACURROOMHASATTRIBUTECONFIG_METHOD_6_9D8E8F89B0A95A1D_OFFSET UNITYSDK_OFFSET(0x1C4AED00)
#define RPG_GAMECORE_ROGUECONDPERSONACURROOMHASATTRIBUTECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4AED40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueCondPersonaCurRoomHasAttributeConfig_TypeDefinitionIndex = 19044;
