...
#define RPG_GAMECORE_CHIMERADUELMOVETOSTARTOFTEAMNODE_METHOD_3_08C9B8C912BF75DD_OFFSET UNITYSDK_OFFSET(0x1C2436A0)
#define RPG_GAMECORE_CHIMERADUELMOVETOSTARTOFTEAMNODE_METHOD_3_0B105768ECF5AA1F_OFFSET UNITYSDK_OFFSET(0x1C243640)
#define RPG_GAMECORE_CHIMERADUELMOVETOSTARTOFTEAMNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C243690)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelMoveToStartOfTeamNode_TypeDefinitionIndex = 15410;
