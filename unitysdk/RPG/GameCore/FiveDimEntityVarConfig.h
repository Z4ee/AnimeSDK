...
#define RPG_GAMECORE_FIVEDIMENTITYVARCONFIG_METHOD_3_03D814C66BC4F954_OFFSET UNITYSDK_OFFSET(0x1D0E3770)
#define RPG_GAMECORE_FIVEDIMENTITYVARCONFIG_METHOD_3_F671EC868488775B_OFFSET UNITYSDK_OFFSET(0x1D0E37B0)
#define RPG_GAMECORE_FIVEDIMENTITYVARCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0E37A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimEntityVarConfig_TypeDefinitionIndex = 18422;
