...
#define RPG_GAMECORE_BYTARGETLISTALL_METHOD_4_0DF9EE681003664F_OFFSET UNITYSDK_OFFSET(0x1703CD20)
#define RPG_GAMECORE_BYTARGETLISTALL_METHOD_4_257B07483E2414CB_OFFSET UNITYSDK_OFFSET(0x1703CC50)
#define RPG_GAMECORE_BYTARGETLISTALL__CTOR_OFFSET UNITYSDK_OFFSET(0x1703CCD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByTargetListAll_TypeDefinitionIndex = 22072;
