...
#define RPG_GAMECORE_BYTARGETLISTALL_METHOD_4_0DF9EE681003664F_OFFSET UNITYSDK_OFFSET(0x1B2BFA60)
#define RPG_GAMECORE_BYTARGETLISTALL_METHOD_4_923A04971001C573_OFFSET UNITYSDK_OFFSET(0x1B2BFC20)
#define RPG_GAMECORE_BYTARGETLISTALL_METHOD_4_D16A088D7B21E4E6_OFFSET UNITYSDK_OFFSET(0x1B2BFA20)
#define RPG_GAMECORE_BYTARGETLISTALL_METHOD_4_F907E371DCF94B85_OFFSET UNITYSDK_OFFSET(0x1B2BFC50)
#define RPG_GAMECORE_BYTARGETLISTALL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2BFA50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByTargetListAll_TypeDefinitionIndex = 22945;
