...
#define RPG_GAMECORE_BYISFIRSTINSERTABILITYINQUEUE_METHOD_4_03EA222221C52AA3_OFFSET UNITYSDK_OFFSET(0x1702E6B0)
#define RPG_GAMECORE_BYISFIRSTINSERTABILITYINQUEUE_METHOD_4_16322D6633B179F9_OFFSET UNITYSDK_OFFSET(0x1702E5E0)
#define RPG_GAMECORE_BYISFIRSTINSERTABILITYINQUEUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1702E660)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsFirstInsertAbilityInQueue_TypeDefinitionIndex = 21764;
