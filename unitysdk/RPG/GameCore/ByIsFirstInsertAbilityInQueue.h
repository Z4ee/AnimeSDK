...
#define RPG_GAMECORE_BYISFIRSTINSERTABILITYINQUEUE_METHOD_4_03EA222221C52AA3_OFFSET UNITYSDK_OFFSET(0x1A8E3250)
#define RPG_GAMECORE_BYISFIRSTINSERTABILITYINQUEUE_METHOD_4_583175232A097890_OFFSET UNITYSDK_OFFSET(0x1A8E3210)
#define RPG_GAMECORE_BYISFIRSTINSERTABILITYINQUEUE_METHOD_4_64EE4929BB323379_OFFSET UNITYSDK_OFFSET(0x1A8E3390)
#define RPG_GAMECORE_BYISFIRSTINSERTABILITYINQUEUE_METHOD_4_68CBAE0069BCE8B0_OFFSET UNITYSDK_OFFSET(0x1A8E33C0)
#define RPG_GAMECORE_BYISFIRSTINSERTABILITYINQUEUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8E3240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsFirstInsertAbilityInQueue_TypeDefinitionIndex = 22692;
