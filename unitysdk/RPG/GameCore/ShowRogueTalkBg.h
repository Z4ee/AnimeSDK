...
#define RPG_GAMECORE_SHOWROGUETALKBG_METHOD_3_134CE06222EB946C_OFFSET UNITYSDK_OFFSET(0x177027C0)
#define RPG_GAMECORE_SHOWROGUETALKBG_METHOD_3_857B436DFB72426D_OFFSET UNITYSDK_OFFSET(0x17702740)
#define RPG_GAMECORE_SHOWROGUETALKBG__CTOR_OFFSET UNITYSDK_OFFSET(0x17702790)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowRogueTalkBg_TypeDefinitionIndex = 19419;
