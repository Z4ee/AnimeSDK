...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_WRITECUSTOMVALUE_GLOBALDATA_METHOD_3_399C69546859CD00_OFFSET UNITYSDK_OFFSET(0x1D038AA0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_WRITECUSTOMVALUE_GLOBALDATA_METHOD_3_C7A799AF2C424AB9_OFFSET UNITYSDK_OFFSET(0x1D038A40)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_WRITECUSTOMVALUE_GLOBALDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1D038A90)
