...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_WRITECUSTOMVALUE_GLOBALDATA_METHOD_3_399C69546859CD00_OFFSET UNITYSDK_OFFSET(0x1887AF50)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_WRITECUSTOMVALUE_GLOBALDATA_METHOD_3_486237A8DF5084B8_OFFSET UNITYSDK_OFFSET(0x1887DC40)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_WRITECUSTOMVALUE_GLOBALDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1887AF00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_WriteCustomValue_GlobalData_TypeDefinitionIndex = 15242;
