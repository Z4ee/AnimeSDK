...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_WRITECUSTOMVALUE_GLOBALDATA_METHOD_3_399C69546859CD00_OFFSET UNITYSDK_OFFSET(0x1DB088F0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_WRITECUSTOMVALUE_GLOBALDATA_METHOD_3_C7A799AF2C424AB9_OFFSET UNITYSDK_OFFSET(0x1DB08890)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_WRITECUSTOMVALUE_GLOBALDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB088E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_WriteCustomValue_GlobalData_TypeDefinitionIndex = 15902;
