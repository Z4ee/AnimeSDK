...
#define RPG_GAMECORE_ELFSUPEREVENTTYPECONFIG_METHOD_2_E8833C5F72D50A33_OFFSET UNITYSDK_OFFSET(0x171920A0)
#define RPG_GAMECORE_ELFSUPEREVENTTYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171924A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfSuperEventTypeConfig_TypeDefinitionIndex = 16941;
