...
#define RPG_GAMECORE_GRIDFIGHTPREPTUTORIALOP_METHOD_3_ACD371A999B1B7B7_OFFSET UNITYSDK_OFFSET(0x1D15F740)
#define RPG_GAMECORE_GRIDFIGHTPREPTUTORIALOP_METHOD_3_B5D1B10894A84B0D_OFFSET UNITYSDK_OFFSET(0x1D15F780)
#define RPG_GAMECORE_GRIDFIGHTPREPTUTORIALOP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D15F770)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightPrepTutorialOP_TypeDefinitionIndex = 19741;
