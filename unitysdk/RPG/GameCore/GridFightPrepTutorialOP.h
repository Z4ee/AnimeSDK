...
#define RPG_GAMECORE_GRIDFIGHTPREPTUTORIALOP_METHOD_3_3467D788080562B9_OFFSET UNITYSDK_OFFSET(0x189CF990)
#define RPG_GAMECORE_GRIDFIGHTPREPTUTORIALOP_METHOD_3_B5D1B10894A84B0D_OFFSET UNITYSDK_OFFSET(0x189CFA10)
#define RPG_GAMECORE_GRIDFIGHTPREPTUTORIALOP__CTOR_OFFSET UNITYSDK_OFFSET(0x189CF9E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightPrepTutorialOP_TypeDefinitionIndex = 18890;
