...
#define RPG_GAMECORE_WAITSTARTMARBLEGAME_METHOD_3_3525050CA83ED32F_OFFSET UNITYSDK_OFFSET(0x17905690)
#define RPG_GAMECORE_WAITSTARTMARBLEGAME_METHOD_3_526BC2826A6E863E_OFFSET UNITYSDK_OFFSET(0x17905610)
#define RPG_GAMECORE_WAITSTARTMARBLEGAME__CTOR_OFFSET UNITYSDK_OFFSET(0x17905660)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitStartMarbleGame_TypeDefinitionIndex = 20218;
