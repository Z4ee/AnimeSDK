...
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEVALUE_METHOD_3_6B5B2BBA448ECAB5_OFFSET UNITYSDK_OFFSET(0x171284D0)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEVALUE_METHOD_3_E1B31863A9FD3D00_OFFSET UNITYSDK_OFFSET(0x17129670)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x171284B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAISourceValue_TypeDefinitionIndex = 14227;
