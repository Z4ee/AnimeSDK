...
#define RPG_GAMECORE_CONDLOGICANDCONFIG_METHOD_4_4E7DEF042F4E2956_OFFSET UNITYSDK_OFFSET(0x18831640)
#define RPG_GAMECORE_CONDLOGICANDCONFIG_METHOD_4_AFD6BB7B485F071B_OFFSET UNITYSDK_OFFSET(0x18831780)
#define RPG_GAMECORE_CONDLOGICANDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18831700)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CondLogicAndConfig_TypeDefinitionIndex = 16162;
