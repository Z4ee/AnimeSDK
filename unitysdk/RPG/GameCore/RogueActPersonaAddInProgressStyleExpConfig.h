...
#define RPG_GAMECORE_ROGUEACTPERSONAADDINPROGRESSSTYLEEXPCONFIG_METHOD_6_8FC65DD058CDF543_OFFSET UNITYSDK_OFFSET(0x18CC5430)
#define RPG_GAMECORE_ROGUEACTPERSONAADDINPROGRESSSTYLEEXPCONFIG_METHOD_6_9CD78D5EE9C04F36_OFFSET UNITYSDK_OFFSET(0x18CC5210)
#define RPG_GAMECORE_ROGUEACTPERSONAADDINPROGRESSSTYLEEXPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CC5350)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaAddInProgressStyleExpConfig_TypeDefinitionIndex = 18711;
