...
#define RPG_GAMECORE_CHIMERADUELNPCDITHERINNODE_METHOD_3_1607D27E31BF9D89_OFFSET UNITYSDK_OFFSET(0x1E338580)
#define RPG_GAMECORE_CHIMERADUELNPCDITHERINNODE_METHOD_3_DC6970A0088059D5_OFFSET UNITYSDK_OFFSET(0x1E338520)
#define RPG_GAMECORE_CHIMERADUELNPCDITHERINNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E338570)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelNpcDitherInNode_TypeDefinitionIndex = 15778;
