...
#define RPG_GAMECORE_CHIMERADUELNPCDITHERINNODE_METHOD_3_1607D27E31BF9D89_OFFSET UNITYSDK_OFFSET(0x188007E0)
#define RPG_GAMECORE_CHIMERADUELNPCDITHERINNODE_METHOD_3_89736B7751093BE7_OFFSET UNITYSDK_OFFSET(0x18800740)
#define RPG_GAMECORE_CHIMERADUELNPCDITHERINNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x18800920)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelNpcDitherInNode_TypeDefinitionIndex = 15115;
