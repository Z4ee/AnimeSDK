...
#define RPG_GAMECORE_CHIMERADUELNPCDITHERINNODE_METHOD_3_1607D27E31BF9D89_OFFSET UNITYSDK_OFFSET(0x19642970)
#define RPG_GAMECORE_CHIMERADUELNPCDITHERINNODE_METHOD_3_89736B7751093BE7_OFFSET UNITYSDK_OFFSET(0x19642870)
#define RPG_GAMECORE_CHIMERADUELNPCDITHERINNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x19642910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelNpcDitherInNode_TypeDefinitionIndex = 15177;
