...
#define RPG_GAMECORE_WAITFIVEDIMCONTAINERDYNAMICVALUECHANGE_METHOD_4_0237B88CDA9CC979_OFFSET UNITYSDK_OFFSET(0x190FC7A0)
#define RPG_GAMECORE_WAITFIVEDIMCONTAINERDYNAMICVALUECHANGE_METHOD_4_95E5D7F7EC62C681_OFFSET UNITYSDK_OFFSET(0x190FC880)
#define RPG_GAMECORE_WAITFIVEDIMCONTAINERDYNAMICVALUECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x190FC820)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitFiveDimContainerDynamicValueChange_TypeDefinitionIndex = 20327;
