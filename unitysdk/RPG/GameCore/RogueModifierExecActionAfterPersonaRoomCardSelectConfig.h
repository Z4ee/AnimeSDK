...
#define RPG_GAMECORE_ROGUEMODIFIEREXECACTIONAFTERPERSONAROOMCARDSELECTCONFIG_METHOD_3_2100775FC6C41546_OFFSET UNITYSDK_OFFSET(0x18D34100)
#define RPG_GAMECORE_ROGUEMODIFIEREXECACTIONAFTERPERSONAROOMCARDSELECTCONFIG_METHOD_3_B867A8352294F1EF_OFFSET UNITYSDK_OFFSET(0x18D3C2F0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECACTIONAFTERPERSONAROOMCARDSELECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D340B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecActionAfterPersonaRoomCardSelectConfig_TypeDefinitionIndex = 16932;
