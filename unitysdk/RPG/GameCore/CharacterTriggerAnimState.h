...
#define RPG_GAMECORE_CHARACTERTRIGGERANIMSTATE_METHOD_3_1F4A83A04314F356_OFFSET UNITYSDK_OFFSET(0x17073700)
#define RPG_GAMECORE_CHARACTERTRIGGERANIMSTATE_METHOD_3_6506ED4B38DBB0C0_OFFSET UNITYSDK_OFFSET(0x170737A0)
#define RPG_GAMECORE_CHARACTERTRIGGERANIMSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x17073760)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterTriggerAnimState_TypeDefinitionIndex = 19146;
