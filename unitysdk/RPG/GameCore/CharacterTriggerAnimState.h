...
#define RPG_GAMECORE_CHARACTERTRIGGERANIMSTATE_METHOD_3_525A3F96B38D0DB5_OFFSET UNITYSDK_OFFSET(0x1CF9EC50)
#define RPG_GAMECORE_CHARACTERTRIGGERANIMSTATE_METHOD_3_6506ED4B38DBB0C0_OFFSET UNITYSDK_OFFSET(0x1CF9ECA0)
#define RPG_GAMECORE_CHARACTERTRIGGERANIMSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF9EC90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterTriggerAnimState_TypeDefinitionIndex = 20587;
