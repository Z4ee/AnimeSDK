...
#define RPG_GAMECORE_CHARACTERTRIGGERANIMSTATE_METHOD_3_1F4A83A04314F356_OFFSET UNITYSDK_OFFSET(0x187D87D0)
#define RPG_GAMECORE_CHARACTERTRIGGERANIMSTATE_METHOD_3_6506ED4B38DBB0C0_OFFSET UNITYSDK_OFFSET(0x187D8870)
#define RPG_GAMECORE_CHARACTERTRIGGERANIMSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x187D8830)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterTriggerAnimState_TypeDefinitionIndex = 19805;
