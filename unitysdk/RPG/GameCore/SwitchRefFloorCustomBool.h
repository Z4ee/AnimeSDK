...
#define RPG_GAMECORE_SWITCHREFFLOORCUSTOMBOOL_METHOD_3_C652A11D521619F9_OFFSET UNITYSDK_OFFSET(0x17799100)
#define RPG_GAMECORE_SWITCHREFFLOORCUSTOMBOOL_METHOD_3_C89A59339867D4FC_OFFSET UNITYSDK_OFFSET(0x17799950)
#define RPG_GAMECORE_SWITCHREFFLOORCUSTOMBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x177990F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchRefFloorCustomBool_TypeDefinitionIndex = 16103;
