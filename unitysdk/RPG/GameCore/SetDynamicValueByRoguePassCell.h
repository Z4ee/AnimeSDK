...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEPASSCELL_METHOD_3_3C35A3834468CF91_OFFSET UNITYSDK_OFFSET(0x1E8222F0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEPASSCELL_METHOD_3_4075572153455FB5_OFFSET UNITYSDK_OFFSET(0x1E822340)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEPASSCELL__CTOR_OFFSET UNITYSDK_OFFSET(0x1E822330)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRoguePassCell_TypeDefinitionIndex = 21544;
