...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEPASSCELL_METHOD_3_4075572153455FB5_OFFSET UNITYSDK_OFFSET(0x19C43E20)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEPASSCELL_METHOD_3_7E17EE785DD944A5_OFFSET UNITYSDK_OFFSET(0x19C43D90)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEPASSCELL__CTOR_OFFSET UNITYSDK_OFFSET(0x19C43DF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRoguePassCell_TypeDefinitionIndex = 20571;
