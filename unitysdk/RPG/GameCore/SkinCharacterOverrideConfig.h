...
#define RPG_GAMECORE_SKINCHARACTEROVERRIDECONFIG_METHOD_2_0C4BB4EBBCE268F5_OFFSET UNITYSDK_OFFSET(0x1770FC00)
#define RPG_GAMECORE_SKINCHARACTEROVERRIDECONFIG_METHOD_2_D25FD22724C3016D_OFFSET UNITYSDK_OFFSET(0x1770F910)
#define RPG_GAMECORE_SKINCHARACTEROVERRIDECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1770FBF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SkinCharacterOverrideConfig_TypeDefinitionIndex = 16039;
