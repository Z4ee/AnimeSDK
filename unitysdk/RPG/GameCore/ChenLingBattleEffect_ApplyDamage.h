...
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_APPLYDAMAGE_METHOD_3_1125DEA31F2C2880_OFFSET UNITYSDK_OFFSET(0x196207C0)
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_APPLYDAMAGE_METHOD_3_F83AC5BAA072DE8C_OFFSET UNITYSDK_OFFSET(0x19620760)
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_APPLYDAMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x196207B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleEffect_ApplyDamage_TypeDefinitionIndex = 15010;
