...
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_APPLYDAMAGE_METHOD_3_1125DEA31F2C2880_OFFSET UNITYSDK_OFFSET(0x1E00B6E0)
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_APPLYDAMAGE_METHOD_3_F83AC5BAA072DE8C_OFFSET UNITYSDK_OFFSET(0x1E00B680)
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_APPLYDAMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E00B6D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleEffect_ApplyDamage_TypeDefinitionIndex = 15611;
