...
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_APPLYDAMAGE_METHOD_3_1125DEA31F2C2880_OFFSET UNITYSDK_OFFSET(0x187E2B10)
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_APPLYDAMAGE_METHOD_3_F83AC5BAA072DE8C_OFFSET UNITYSDK_OFFSET(0x187E2AB0)
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_APPLYDAMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x187E2B00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleEffect_ApplyDamage_TypeDefinitionIndex = 14947;
