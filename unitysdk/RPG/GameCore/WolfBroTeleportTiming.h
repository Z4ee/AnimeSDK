...
#define RPG_GAMECORE_WOLFBROTELEPORTTIMING_METHOD_3_19C5603254BC6D73_OFFSET UNITYSDK_OFFSET(0x1790D070)
#define RPG_GAMECORE_WOLFBROTELEPORTTIMING_METHOD_3_57BE46D63138ACAA_OFFSET UNITYSDK_OFFSET(0x1790D0F0)
#define RPG_GAMECORE_WOLFBROTELEPORTTIMING__CTOR_OFFSET UNITYSDK_OFFSET(0x1790D0C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WolfBroTeleportTiming_TypeDefinitionIndex = 20168;
