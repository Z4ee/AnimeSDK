...
#define RPG_GAMECORE_WOLFBROTELEPORTTIMING_METHOD_3_3B5D491E69CC98E1_OFFSET UNITYSDK_OFFSET(0x1EFA9150)
#define RPG_GAMECORE_WOLFBROTELEPORTTIMING_METHOD_3_57BE46D63138ACAA_OFFSET UNITYSDK_OFFSET(0x1EFA91A0)
#define RPG_GAMECORE_WOLFBROTELEPORTTIMING__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFA9190)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WolfBroTeleportTiming_TypeDefinitionIndex = 21745;
