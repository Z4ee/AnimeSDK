...
#define RPG_GAMECORE_OVERRIDEENDTRANSFERTYPE_METHOD_3_5AC1963ADCEB0998_OFFSET UNITYSDK_OFFSET(0x199DD480)
#define RPG_GAMECORE_OVERRIDEENDTRANSFERTYPE_METHOD_3_E3B4CCC538AA4471_OFFSET UNITYSDK_OFFSET(0x199DD3F0)
#define RPG_GAMECORE_OVERRIDEENDTRANSFERTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x199DD450)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OverrideEndTransferType_TypeDefinitionIndex = 20700;
