...
#define RPG_GAMECORE_STAGECAPTUREALIASLOOKUP_METHOD_2_43E4EECF562C8920_OFFSET UNITYSDK_OFFSET(0x17764640)
#define RPG_GAMECORE_STAGECAPTUREALIASLOOKUP__CTOR_OFFSET UNITYSDK_OFFSET(0x17764710)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StageCaptureAliasLookup_TypeDefinitionIndex = 17577;
