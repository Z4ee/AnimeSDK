...
#define RPG_GAMECORE_CHENLINGFESVISITORCONFIG_METHOD_3_2666332B2033A6C1_OFFSET UNITYSDK_OFFSET(0x1C387020)
#define RPG_GAMECORE_CHENLINGFESVISITORCONFIG_METHOD_3_6757A085E89DB2A1_OFFSET UNITYSDK_OFFSET(0x1C387080)
#define RPG_GAMECORE_CHENLINGFESVISITORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C387070)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingFesVisitorConfig_TypeDefinitionIndex = 17706;
