...
#define RPG_GAMECORE_MODIFYGLOBALVISIONPARAMS_METHOD_3_83F9D9D571F5501A_OFFSET UNITYSDK_OFFSET(0x1B1AB290)
#define RPG_GAMECORE_MODIFYGLOBALVISIONPARAMS_METHOD_3_9B75E516A297B90F_OFFSET UNITYSDK_OFFSET(0x1B1AB230)
#define RPG_GAMECORE_MODIFYGLOBALVISIONPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1AB270)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyGlobalVisionParams_TypeDefinitionIndex = 19769;
