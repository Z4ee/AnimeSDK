...
#define RPG_GAMECORE_MODIFYGLOBALVISIONPARAMS_METHOD_3_5EA3EE501DD73F57_OFFSET UNITYSDK_OFFSET(0x17431580)
#define RPG_GAMECORE_MODIFYGLOBALVISIONPARAMS_METHOD_3_83F9D9D571F5501A_OFFSET UNITYSDK_OFFSET(0x17431620)
#define RPG_GAMECORE_MODIFYGLOBALVISIONPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x174315E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyGlobalVisionParams_TypeDefinitionIndex = 18859;
