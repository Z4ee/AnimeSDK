...
#define RPG_GAMECORE_FIVEDIMTRYMUTEPLAYERMOVEONSURFACEDESTROYACTION_METHOD_3_BC7D2BA320F55A24_OFFSET UNITYSDK_OFFSET(0x17211570)
#define RPG_GAMECORE_FIVEDIMTRYMUTEPLAYERMOVEONSURFACEDESTROYACTION_METHOD_3_D6A4B65D3BFA3D7D_OFFSET UNITYSDK_OFFSET(0x172114B0)
#define RPG_GAMECORE_FIVEDIMTRYMUTEPLAYERMOVEONSURFACEDESTROYACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x17211550)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimTryMutePlayerMoveOnSurfaceDestroyAction_TypeDefinitionIndex = 17145;
