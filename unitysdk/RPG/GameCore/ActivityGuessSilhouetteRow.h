...
#define RPG_GAMECORE_ACTIVITYGUESSSILHOUETTEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CD916A0)
#define RPG_GAMECORE_ACTIVITYGUESSSILHOUETTEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD91C00)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::System::String* Unlock; // 0x10
		::System::String* KeyIconPath2; // 0x18
		::System::String* KeyIconPath; // 0x20
		::System::String* Aim01; // 0x28
		::System::String* Aim02; // 0x30
		::System::String* Title; // 0x38
		::System::String* Daily; // 0x40
		::System::String* Tab; // 0x48
		::System::String* SilhouetteIconPath; // 0x50
