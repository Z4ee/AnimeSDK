...
#define RPG_GAMECORE_ACTIVITYGUESSSILHOUETTEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16EFBB50)
#define RPG_GAMECORE_ACTIVITYGUESSSILHOUETTEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16EFC0B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityGuessSilhouetteRow_TypeDefinitionIndex = 10808;

	class ActivityGuessSilhouetteRow : public ::System::Object
	{
	public:
		::System::String* SilhouetteIconPath; // 0x10
		::System::String* KeyIconPath2; // 0x18
		::System::String* Aim01; // 0x20
		::System::String* Tab; // 0x28
		::System::String* KeyIconPath; // 0x30
		...
		::System::UInt32 SilhouetteID; // 0x68
		::System::UInt32 Order; // 0x6C
		::System::UInt32 ActivityID; // 0x70
		::System::UInt32 Day; // 0x74
