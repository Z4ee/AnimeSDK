...
#define RPG_GAMECORE_MAZEMONSTERALERTCONFIG_METHOD_2_B875C83290658C47_OFFSET UNITYSDK_OFFSET(0x173C3360)
#define RPG_GAMECORE_MAZEMONSTERALERTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x173C3690)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MazeMonsterAlertConfig_TypeDefinitionIndex = 15010;
