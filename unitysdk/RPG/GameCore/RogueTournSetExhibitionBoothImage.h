...
#define RPG_GAMECORE_ROGUETOURNSETEXHIBITIONBOOTHIMAGE_METHOD_3_2CF96140937B1BA3_OFFSET UNITYSDK_OFFSET(0x18D7BE40)
#define RPG_GAMECORE_ROGUETOURNSETEXHIBITIONBOOTHIMAGE_METHOD_3_2FD8C2AE972524E5_OFFSET UNITYSDK_OFFSET(0x18D7BDC0)
#define RPG_GAMECORE_ROGUETOURNSETEXHIBITIONBOOTHIMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x18D7BE10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournSetExhibitionBoothImage_TypeDefinitionIndex = 20982;
