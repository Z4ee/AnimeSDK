...
#define RPG_GAMECORE_ROGUETOURNSETEXHIBITIONBOOTHIMAGE_METHOD_3_2CF96140937B1BA3_OFFSET UNITYSDK_OFFSET(0x1BB7D490)
#define RPG_GAMECORE_ROGUETOURNSETEXHIBITIONBOOTHIMAGE_METHOD_3_AD31CC0D25DB52C0_OFFSET UNITYSDK_OFFSET(0x1BB7D450)
#define RPG_GAMECORE_ROGUETOURNSETEXHIBITIONBOOTHIMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB7D480)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournSetExhibitionBoothImage_TypeDefinitionIndex = 21309;
