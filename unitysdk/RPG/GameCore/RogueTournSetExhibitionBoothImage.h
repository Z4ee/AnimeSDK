...
#define RPG_GAMECORE_ROGUETOURNSETEXHIBITIONBOOTHIMAGE_METHOD_3_2CF96140937B1BA3_OFFSET UNITYSDK_OFFSET(0x1766E600)
#define RPG_GAMECORE_ROGUETOURNSETEXHIBITIONBOOTHIMAGE_METHOD_3_2FD8C2AE972524E5_OFFSET UNITYSDK_OFFSET(0x1766E580)
#define RPG_GAMECORE_ROGUETOURNSETEXHIBITIONBOOTHIMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1766E5D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournSetExhibitionBoothImage_TypeDefinitionIndex = 20300;
