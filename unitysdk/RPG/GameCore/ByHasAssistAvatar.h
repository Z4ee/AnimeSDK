...
#define RPG_GAMECORE_BYHASASSISTAVATAR_METHOD_4_7450135CE2471DA6_OFFSET UNITYSDK_OFFSET(0x17023380)
#define RPG_GAMECORE_BYHASASSISTAVATAR_METHOD_4_D5D6821474F075EC_OFFSET UNITYSDK_OFFSET(0x170232B0)
#define RPG_GAMECORE_BYHASASSISTAVATAR__CTOR_OFFSET UNITYSDK_OFFSET(0x17023330)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByHasAssistAvatar_TypeDefinitionIndex = 19125;
