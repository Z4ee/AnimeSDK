...
#define RPG_GAMECORE_STOPEFFECTFOLLOW_METHOD_3_6A6D17DFD5365363_OFFSET UNITYSDK_OFFSET(0x1D56F5E0)
#define RPG_GAMECORE_STOPEFFECTFOLLOW_METHOD_3_EA08D71A27E2FE32_OFFSET UNITYSDK_OFFSET(0x1D56F590)
#define RPG_GAMECORE_STOPEFFECTFOLLOW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D56F5D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StopEffectFollow_TypeDefinitionIndex = 22124;
