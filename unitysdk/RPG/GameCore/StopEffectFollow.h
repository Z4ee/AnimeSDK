...
#define RPG_GAMECORE_STOPEFFECTFOLLOW_METHOD_3_98118667B7EF3CBB_OFFSET UNITYSDK_OFFSET(0x18EA3060)
#define RPG_GAMECORE_STOPEFFECTFOLLOW_METHOD_3_99413F10DB734F8C_OFFSET UNITYSDK_OFFSET(0x18EA30E0)
#define RPG_GAMECORE_STOPEFFECTFOLLOW__CTOR_OFFSET UNITYSDK_OFFSET(0x18EA30B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StopEffectFollow_TypeDefinitionIndex = 21253;
