...
#define RPG_GAMECORE_DISPLAYITEMCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17173A30)
#define RPG_GAMECORE_DISPLAYITEMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17173B20)
