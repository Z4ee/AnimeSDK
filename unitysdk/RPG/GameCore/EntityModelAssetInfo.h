...
#define RPG_GAMECORE_ENTITYMODELASSETINFO_METHOD_2_7B001AC17ECBAF98_OFFSET UNITYSDK_OFFSET(0x188AF280)
#define RPG_GAMECORE_ENTITYMODELASSETINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x188AF2C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EntityModelAssetInfo_TypeDefinitionIndex = 18253;
