...
#define RPG_GAMECORE_FIVEDIMRESUMEMUSICACTION_METHOD_3_553BA8C7B27049C4_OFFSET UNITYSDK_OFFSET(0x19752790)
#define RPG_GAMECORE_FIVEDIMRESUMEMUSICACTION_METHOD_3_658BF22C34BCAA1D_OFFSET UNITYSDK_OFFSET(0x197526D0)
#define RPG_GAMECORE_FIVEDIMRESUMEMUSICACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19752770)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimResumeMusicAction_TypeDefinitionIndex = 17794;
