...
#define RPG_GAMECORE_FIVEDIMRESUMEMUSICACTION_METHOD_3_553BA8C7B27049C4_OFFSET UNITYSDK_OFFSET(0x1D0FE3D0)
#define RPG_GAMECORE_FIVEDIMRESUMEMUSICACTION_METHOD_3_BE0510AC121CB499_OFFSET UNITYSDK_OFFSET(0x1D0FE350)
#define RPG_GAMECORE_FIVEDIMRESUMEMUSICACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0FE3C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimResumeMusicAction_TypeDefinitionIndex = 18491;
