...
#define RPG_GAMECORE_PLAYTRAINPARTYSIMPLETALK_METHOD_3_002E5480C279B869_OFFSET UNITYSDK_OFFSET(0x1D7A95B0)
#define RPG_GAMECORE_PLAYTRAINPARTYSIMPLETALK_METHOD_3_49D97B453AC6A5D8_OFFSET UNITYSDK_OFFSET(0x1D7A9570)
#define RPG_GAMECORE_PLAYTRAINPARTYSIMPLETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7A95A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayTrainPartySimpleTalk_TypeDefinitionIndex = 22113;
