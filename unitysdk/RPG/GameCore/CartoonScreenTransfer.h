...
#define RPG_GAMECORE_CARTOONSCREENTRANSFER_METHOD_3_2436847688D48795_OFFSET UNITYSDK_OFFSET(0x187B82D0)
#define RPG_GAMECORE_CARTOONSCREENTRANSFER_METHOD_3_5ACB55342087AC3E_OFFSET UNITYSDK_OFFSET(0x187B8240)
#define RPG_GAMECORE_CARTOONSCREENTRANSFER__CTOR_OFFSET UNITYSDK_OFFSET(0x187B82A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CartoonScreenTransfer_TypeDefinitionIndex = 21177;
