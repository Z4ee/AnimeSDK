...
#define RPG_GAMECORE_CHARACTERNAVIGATETO_METHOD_3_7F2971819BE0FDA2_OFFSET UNITYSDK_OFFSET(0x1706F060)
#define RPG_GAMECORE_CHARACTERNAVIGATETO_METHOD_3_A54CBBDA62B0D51D_OFFSET UNITYSDK_OFFSET(0x1706F100)
#define RPG_GAMECORE_CHARACTERNAVIGATETO__CTOR_OFFSET UNITYSDK_OFFSET(0x1706F0C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterNavigateTo_TypeDefinitionIndex = 19181;
