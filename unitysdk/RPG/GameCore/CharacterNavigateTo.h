...
#define RPG_GAMECORE_CHARACTERNAVIGATETO_METHOD_3_7F2971819BE0FDA2_OFFSET UNITYSDK_OFFSET(0x187D4130)
#define RPG_GAMECORE_CHARACTERNAVIGATETO_METHOD_3_A54CBBDA62B0D51D_OFFSET UNITYSDK_OFFSET(0x187D41D0)
#define RPG_GAMECORE_CHARACTERNAVIGATETO__CTOR_OFFSET UNITYSDK_OFFSET(0x187D4190)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterNavigateTo_TypeDefinitionIndex = 19840;
