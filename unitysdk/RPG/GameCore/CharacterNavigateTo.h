...
#define RPG_GAMECORE_CHARACTERNAVIGATETO_METHOD_3_4123BE2F556D8301_OFFSET UNITYSDK_OFFSET(0x1CF99170)
#define RPG_GAMECORE_CHARACTERNAVIGATETO_METHOD_3_A54CBBDA62B0D51D_OFFSET UNITYSDK_OFFSET(0x1CF991C0)
#define RPG_GAMECORE_CHARACTERNAVIGATETO__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF991B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterNavigateTo_TypeDefinitionIndex = 20616;
