...
#define RPG_GAMECORE_RTBYHASSELECTSKILL_METHOD_4_AC8BEDD3D87A10D6_OFFSET UNITYSDK_OFFSET(0x18DC8E50)
#define RPG_GAMECORE_RTBYHASSELECTSKILL_METHOD_4_C3D54E2E3F186BA8_OFFSET UNITYSDK_OFFSET(0x18DC8D80)
#define RPG_GAMECORE_RTBYHASSELECTSKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x18DC8E00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtByHasSelectSkill_TypeDefinitionIndex = 23240;
