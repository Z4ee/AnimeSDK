...
#define RPG_GAMECORE_LEVELENTITYENERGYCHANGE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1DD22940)
#define RPG_GAMECORE_LEVELENTITYENERGYCHANGE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x1DD228F0)
#define RPG_GAMECORE_LEVELENTITYENERGYCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD22990)
