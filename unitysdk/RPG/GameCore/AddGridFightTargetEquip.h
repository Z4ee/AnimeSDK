...
#define RPG_GAMECORE_ADDGRIDFIGHTTARGETEQUIP_METHOD_3_6BECA9AFE0F9C18C_OFFSET UNITYSDK_OFFSET(0x16F1D660)
#define RPG_GAMECORE_ADDGRIDFIGHTTARGETEQUIP_METHOD_3_EE829B4A30965EED_OFFSET UNITYSDK_OFFSET(0x16F1D6E0)
#define RPG_GAMECORE_ADDGRIDFIGHTTARGETEQUIP__CTOR_OFFSET UNITYSDK_OFFSET(0x16F1D6B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddGridFightTargetEquip_TypeDefinitionIndex = 20725;
