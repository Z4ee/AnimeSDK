...
#define RPG_GAMECORE_SHOWEVOLVEBUILDTREASUREINBATTLEFORTRIAL_METHOD_3_AA9EB64CFD97332C_OFFSET UNITYSDK_OFFSET(0x1D091F50)
#define RPG_GAMECORE_SHOWEVOLVEBUILDTREASUREINBATTLEFORTRIAL_METHOD_3_D6DBE684CAA14F4D_OFFSET UNITYSDK_OFFSET(0x1D091F10)
#define RPG_GAMECORE_SHOWEVOLVEBUILDTREASUREINBATTLEFORTRIAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D091F40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowEvolveBuildTreasureInBattleForTrial_TypeDefinitionIndex = 22266;
