...
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEMONSTERGROUPCONFIG_METHOD_3_0270DD63C1512014_OFFSET UNITYSDK_OFFSET(0x17638E00)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEMONSTERGROUPCONFIG_METHOD_3_218826A9E4A6E7DD_OFFSET UNITYSDK_OFFSET(0x17638D30)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEMONSTERGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17638DB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierReplaceContentRogueMonsterGroupConfig_TypeDefinitionIndex = 16255;
