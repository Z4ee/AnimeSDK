...
#define RPG_GAMECORE_PARAMCONSTANTCONFIG_METHOD_4_364D9E8592E55E99_OFFSET UNITYSDK_OFFSET(0x17488FE0)
#define RPG_GAMECORE_PARAMCONSTANTCONFIG_METHOD_4_5C2D597F6C0BD738_OFFSET UNITYSDK_OFFSET(0x17488DE0)
#define RPG_GAMECORE_PARAMCONSTANTCONFIG__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17489080)
#define RPG_GAMECORE_PARAMCONSTANTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17488F60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ParamConstantConfig_TypeDefinitionIndex = 15646;
