...
#define RPG_GAMECORE_CHIMERATRIGGERPERFORMANCEBYPHASE_METHOD_3_A15A6FF2330F11F4_OFFSET UNITYSDK_OFFSET(0x1CFD4BA0)
#define RPG_GAMECORE_CHIMERATRIGGERPERFORMANCEBYPHASE_METHOD_3_DBDE979F899AE3E1_OFFSET UNITYSDK_OFFSET(0x1CFD4B60)
#define RPG_GAMECORE_CHIMERATRIGGERPERFORMANCEBYPHASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFD4B90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraTriggerPerformanceByPhase_TypeDefinitionIndex = 21477;
