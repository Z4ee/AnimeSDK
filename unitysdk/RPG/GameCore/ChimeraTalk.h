...
#define RPG_GAMECORE_CHIMERATALK_METHOD_2_22BD114E9F4D79BE_OFFSET UNITYSDK_OFFSET(0x170AAB00)
#define RPG_GAMECORE_CHIMERATALK_METHOD_2_B9749D744FD7ADF1_OFFSET UNITYSDK_OFFSET(0x170AAC50)
#define RPG_GAMECORE_CHIMERATALK__CTOR_OFFSET UNITYSDK_OFFSET(0x170A9ED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraTalk_TypeDefinitionIndex = 14543;
