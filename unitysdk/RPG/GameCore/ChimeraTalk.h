...
#define RPG_GAMECORE_CHIMERATALK_METHOD_2_22BD114E9F4D79BE_OFFSET UNITYSDK_OFFSET(0x1964B7F0)
#define RPG_GAMECORE_CHIMERATALK_METHOD_2_B9749D744FD7ADF1_OFFSET UNITYSDK_OFFSET(0x1964B950)
#define RPG_GAMECORE_CHIMERATALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1964ABE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraTalk_TypeDefinitionIndex = 15076;
