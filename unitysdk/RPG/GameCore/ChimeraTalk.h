...
#define RPG_GAMECORE_CHIMERATALK_METHOD_2_22BD114E9F4D79BE_OFFSET UNITYSDK_OFFSET(0x1C24C6A0)
#define RPG_GAMECORE_CHIMERATALK_METHOD_2_B9749D744FD7ADF1_OFFSET UNITYSDK_OFFSET(0x1C24C800)
#define RPG_GAMECORE_CHIMERATALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C24BA90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraTalk_TypeDefinitionIndex = 15240;
