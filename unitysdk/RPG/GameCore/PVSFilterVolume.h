...
#define RPG_GAMECORE_PVSFILTERVOLUME_METHOD_3_250BB37977A3892D_OFFSET UNITYSDK_OFFSET(0x1BB0A9F0)
#define RPG_GAMECORE_PVSFILTERVOLUME_METHOD_3_3A746B57A5FA63E0_OFFSET UNITYSDK_OFFSET(0x1BB0AA20)
#define RPG_GAMECORE_PVSFILTERVOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB0AA10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PVSFilterVolume_TypeDefinitionIndex = 18395;
