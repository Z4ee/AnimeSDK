...
#define RPG_GAMECORE_CAKERACECORERECTTRAPSELECTORCONFIG_METHOD_3_0AA7B3D3B380C957_OFFSET UNITYSDK_OFFSET(0x1B2CE0C0)
#define RPG_GAMECORE_CAKERACECORERECTTRAPSELECTORCONFIG_METHOD_3_EF5256252E4FBAB6_OFFSET UNITYSDK_OFFSET(0x1B2D01C0)
#define RPG_GAMECORE_CAKERACECORERECTTRAPSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2CE0B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceCoreRectTrapSelectorConfig_TypeDefinitionIndex = 17659;
