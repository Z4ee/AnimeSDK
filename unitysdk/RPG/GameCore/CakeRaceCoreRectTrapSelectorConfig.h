...
#define RPG_GAMECORE_CAKERACECORERECTTRAPSELECTORCONFIG_METHOD_3_0AA7B3D3B380C957_OFFSET UNITYSDK_OFFSET(0x1876E0E0)
#define RPG_GAMECORE_CAKERACECORERECTTRAPSELECTORCONFIG_METHOD_3_EF5256252E4FBAB6_OFFSET UNITYSDK_OFFSET(0x18770550)
#define RPG_GAMECORE_CAKERACECORERECTTRAPSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1876E0D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceCoreRectTrapSelectorConfig_TypeDefinitionIndex = 17484;
