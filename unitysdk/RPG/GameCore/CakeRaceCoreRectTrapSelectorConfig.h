...
#define RPG_GAMECORE_CAKERACECORERECTTRAPSELECTORCONFIG_METHOD_3_0AA7B3D3B380C957_OFFSET UNITYSDK_OFFSET(0x1CF726B0)
#define RPG_GAMECORE_CAKERACECORERECTTRAPSELECTORCONFIG_METHOD_3_EF5256252E4FBAB6_OFFSET UNITYSDK_OFFSET(0x1CF74A90)
#define RPG_GAMECORE_CAKERACECORERECTTRAPSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF726A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceCoreRectTrapSelectorConfig_TypeDefinitionIndex = 18177;
