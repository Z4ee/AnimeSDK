...
#define RPG_GAMECORE_CAKERACECORERECTTRAPSELECTORCONFIG_METHOD_3_0AA7B3D3B380C957_OFFSET UNITYSDK_OFFSET(0x170485F0)
#define RPG_GAMECORE_CAKERACECORERECTTRAPSELECTORCONFIG_METHOD_3_EF5256252E4FBAB6_OFFSET UNITYSDK_OFFSET(0x1704A890)
#define RPG_GAMECORE_CAKERACECORERECTTRAPSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x170485E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceCoreRectTrapSelectorConfig_TypeDefinitionIndex = 16890;
