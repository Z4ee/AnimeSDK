...
#define RPG_GAMECORE_MONOPOLYSHOWPLAYERBUBBLETALK_METHOD_3_5E11CBC456D203F2_OFFSET UNITYSDK_OFFSET(0x18B54DB0)
#define RPG_GAMECORE_MONOPOLYSHOWPLAYERBUBBLETALK_METHOD_3_B5DB89854E13815B_OFFSET UNITYSDK_OFFSET(0x18B54E30)
#define RPG_GAMECORE_MONOPOLYSHOWPLAYERBUBBLETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x18B54E00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonopolyShowPlayerBubbleTalk_TypeDefinitionIndex = 19917;
