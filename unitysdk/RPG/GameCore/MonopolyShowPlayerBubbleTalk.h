...
#define RPG_GAMECORE_MONOPOLYSHOWPLAYERBUBBLETALK_METHOD_3_6D86B23B43E83788_OFFSET UNITYSDK_OFFSET(0x1B1C0EC0)
#define RPG_GAMECORE_MONOPOLYSHOWPLAYERBUBBLETALK_METHOD_3_B5DB89854E13815B_OFFSET UNITYSDK_OFFSET(0x1B1C0F00)
#define RPG_GAMECORE_MONOPOLYSHOWPLAYERBUBBLETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1C0EF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonopolyShowPlayerBubbleTalk_TypeDefinitionIndex = 20140;
