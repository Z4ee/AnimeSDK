...
#define RPG_GAMECORE_MONOPOLYSHOWPLAYERBUBBLETALK_METHOD_3_5E11CBC456D203F2_OFFSET UNITYSDK_OFFSET(0x17448150)
#define RPG_GAMECORE_MONOPOLYSHOWPLAYERBUBBLETALK_METHOD_3_B5DB89854E13815B_OFFSET UNITYSDK_OFFSET(0x174481D0)
#define RPG_GAMECORE_MONOPOLYSHOWPLAYERBUBBLETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x174481A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonopolyShowPlayerBubbleTalk_TypeDefinitionIndex = 19258;
