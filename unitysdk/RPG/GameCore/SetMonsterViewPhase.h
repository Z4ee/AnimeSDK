...
#define RPG_GAMECORE_SETMONSTERVIEWPHASE_METHOD_3_1E701FAEFBCCA000_OFFSET UNITYSDK_OFFSET(0x18E3C010)
#define RPG_GAMECORE_SETMONSTERVIEWPHASE_METHOD_3_77D02E6125E1D74B_OFFSET UNITYSDK_OFFSET(0x18E3BF40)
#define RPG_GAMECORE_SETMONSTERVIEWPHASE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E3BFC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetMonsterViewPhase_TypeDefinitionIndex = 21630;
