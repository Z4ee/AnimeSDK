...
#define RPG_GAMECORE_SETMONSTERVIEWPHASE_METHOD_3_1E701FAEFBCCA000_OFFSET UNITYSDK_OFFSET(0x19C58D50)
#define RPG_GAMECORE_SETMONSTERVIEWPHASE_METHOD_3_77D02E6125E1D74B_OFFSET UNITYSDK_OFFSET(0x19C58C80)
#define RPG_GAMECORE_SETMONSTERVIEWPHASE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C58D00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetMonsterViewPhase_TypeDefinitionIndex = 21491;
