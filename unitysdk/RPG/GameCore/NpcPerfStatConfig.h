...
#define RPG_GAMECORE_NPCPERFSTATCONFIG_METHOD_2_E07B17868FCF22D0_OFFSET UNITYSDK_OFFSET(0x1CE93480)
#define RPG_GAMECORE_NPCPERFSTATCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE934C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NpcPerfStatConfig_TypeDefinitionIndex = 18885;
