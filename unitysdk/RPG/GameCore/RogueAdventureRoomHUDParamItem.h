...
#define RPG_GAMECORE_ROGUEADVENTUREROOMHUDPARAMITEM_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0xAA1D680)
#define RPG_GAMECORE_ROGUEADVENTUREROOMHUDPARAMITEM_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xAA1D660)
#define RPG_GAMECORE_ROGUEADVENTUREROOMHUDPARAMITEM_SET_GROUPID_OFFSET UNITYSDK_OFFSET(0xAA1D690)
#define RPG_GAMECORE_ROGUEADVENTUREROOMHUDPARAMITEM_SET_TYPE_OFFSET UNITYSDK_OFFSET(0xAA1D670)
#define RPG_GAMECORE_ROGUEADVENTUREROOMHUDPARAMITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xAA1D6A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueAdventureRoomHUDParamItem_TypeDefinitionIndex = 47153;
