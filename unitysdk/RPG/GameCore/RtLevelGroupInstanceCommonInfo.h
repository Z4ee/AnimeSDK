...
#define RPG_GAMECORE_RTLEVELGROUPINSTANCECOMMONINFO_METHOD_2_5937CFCEE1B52CDF_OFFSET UNITYSDK_OFFSET(0x1D4AD920)
#define RPG_GAMECORE_RTLEVELGROUPINSTANCECOMMONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4ADC60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtLevelGroupInstanceCommonInfo_TypeDefinitionIndex = 17151;
