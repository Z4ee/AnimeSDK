...
#define RPG_GAMECORE_GRIDFIGHTROLEWITHEQUIPCONFIG_METHOD_2_AA0A0BB00168C8DC_OFFSET UNITYSDK_OFFSET(0x189D54F0)
#define RPG_GAMECORE_GRIDFIGHTROLEWITHEQUIPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189D5530)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightRoleWithEquipConfig_TypeDefinitionIndex = 10348;
