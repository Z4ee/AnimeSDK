...
#define RPG_GAMECORE_GRIDFIGHTROLEWITHEQUIPCONFIG_METHOD_2_AA0A0BB00168C8DC_OFFSET UNITYSDK_OFFSET(0x1D0756D0)
#define RPG_GAMECORE_GRIDFIGHTROLEWITHEQUIPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D075710)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightRoleWithEquipConfig_TypeDefinitionIndex = 10201;
