...
#define RPG_GAMECORE_STACKADDITIONALTEAMBOOSTPOINT_METHOD_3_75490B573ABE4700_OFFSET UNITYSDK_OFFSET(0x1D0B7ED0)
#define RPG_GAMECORE_STACKADDITIONALTEAMBOOSTPOINT_METHOD_3_B073C84272901AAD_OFFSET UNITYSDK_OFFSET(0x1D0B7E80)
#define RPG_GAMECORE_STACKADDITIONALTEAMBOOSTPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0B7EC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StackAdditionalTeamBoostPoint_TypeDefinitionIndex = 23286;
