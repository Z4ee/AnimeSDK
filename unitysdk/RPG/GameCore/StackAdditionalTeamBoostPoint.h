...
#define RPG_GAMECORE_STACKADDITIONALTEAMBOOSTPOINT_METHOD_3_75490B573ABE4700_OFFSET UNITYSDK_OFFSET(0x17760B90)
#define RPG_GAMECORE_STACKADDITIONALTEAMBOOSTPOINT_METHOD_3_8DF6C79F742DB611_OFFSET UNITYSDK_OFFSET(0x17760B00)
#define RPG_GAMECORE_STACKADDITIONALTEAMBOOSTPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x17760B60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StackAdditionalTeamBoostPoint_TypeDefinitionIndex = 21783;
