...
#define RPG_GAMECORE_SHOWPLAYGOSUBPACKAGEDIALOG_METHOD_3_1BCBFEAABDDED5A4_OFFSET UNITYSDK_OFFSET(0x18E64CF0)
#define RPG_GAMECORE_SHOWPLAYGOSUBPACKAGEDIALOG_METHOD_3_8F21D563437C4578_OFFSET UNITYSDK_OFFSET(0x18E64BE0)
#define RPG_GAMECORE_SHOWPLAYGOSUBPACKAGEDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x18E64CC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowPlayGOSubPackageDialog_TypeDefinitionIndex = 20556;
