...
#define RPG_GAMECORE_SHOWPLAYGOSUBPACKAGEDIALOG_METHOD_3_1BCBFEAABDDED5A4_OFFSET UNITYSDK_OFFSET(0x1BE44E50)
#define RPG_GAMECORE_SHOWPLAYGOSUBPACKAGEDIALOG_METHOD_3_BC9476EEB5BABF21_OFFSET UNITYSDK_OFFSET(0x1BE44D80)
#define RPG_GAMECORE_SHOWPLAYGOSUBPACKAGEDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE44E40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowPlayGOSubPackageDialog_TypeDefinitionIndex = 20906;
