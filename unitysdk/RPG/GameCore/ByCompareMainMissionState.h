...
#define RPG_GAMECORE_BYCOMPAREMAINMISSIONSTATE_METHOD_4_3771C9D992A84AD1_OFFSET UNITYSDK_OFFSET(0x187325C0)
#define RPG_GAMECORE_BYCOMPAREMAINMISSIONSTATE_METHOD_4_95B5D7115B39CE49_OFFSET UNITYSDK_OFFSET(0x187324E0)
#define RPG_GAMECORE_BYCOMPAREMAINMISSIONSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18732560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareMainMissionState_TypeDefinitionIndex = 19257;
