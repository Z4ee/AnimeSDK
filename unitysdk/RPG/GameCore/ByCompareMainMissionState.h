...
#define RPG_GAMECORE_BYCOMPAREMAINMISSIONSTATE_METHOD_4_03B5A7C3B2008004_OFFSET UNITYSDK_OFFSET(0x1CED2E40)
#define RPG_GAMECORE_BYCOMPAREMAINMISSIONSTATE_METHOD_4_3771C9D992A84AD1_OFFSET UNITYSDK_OFFSET(0x1CED2E90)
#define RPG_GAMECORE_BYCOMPAREMAINMISSIONSTATE_METHOD_4_5DFB2EA4490E523D_OFFSET UNITYSDK_OFFSET(0x1CED30F0)
#define RPG_GAMECORE_BYCOMPAREMAINMISSIONSTATE_METHOD_4_6756FED1A145C75A_OFFSET UNITYSDK_OFFSET(0x1CED30B0)
#define RPG_GAMECORE_BYCOMPAREMAINMISSIONSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CED2E80)
