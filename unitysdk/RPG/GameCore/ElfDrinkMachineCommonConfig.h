...
#define RPG_GAMECORE_ELFDRINKMACHINECOMMONCONFIG_METHOD_2_E367CC55E758B12D_OFFSET UNITYSDK_OFFSET(0x1718DC10)
#define RPG_GAMECORE_ELFDRINKMACHINECOMMONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1718DD30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfDrinkMachineCommonConfig_TypeDefinitionIndex = 16947;
