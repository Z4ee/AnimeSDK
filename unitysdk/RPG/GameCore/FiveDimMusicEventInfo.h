...
#define RPG_GAMECORE_FIVEDIMMUSICEVENTINFO_METHOD_2_D1AFAFB5B5F7AF39_OFFSET UNITYSDK_OFFSET(0x1974AFA0)
#define RPG_GAMECORE_FIVEDIMMUSICEVENTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1974B0F0)
