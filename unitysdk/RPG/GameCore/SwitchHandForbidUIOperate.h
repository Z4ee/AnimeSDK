...
#define RPG_GAMECORE_SWITCHHANDFORBIDUIOPERATE_METHOD_3_19937FE6B5AA36DE_OFFSET UNITYSDK_OFFSET(0x1E14EB90)
#define RPG_GAMECORE_SWITCHHANDFORBIDUIOPERATE_METHOD_3_9E5E06D843C7DBDD_OFFSET UNITYSDK_OFFSET(0x1E14EBD0)
#define RPG_GAMECORE_SWITCHHANDFORBIDUIOPERATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E14EBC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchHandForbidUIOperate_TypeDefinitionIndex = 20725;
