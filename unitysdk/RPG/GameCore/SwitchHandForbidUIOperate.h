...
#define RPG_GAMECORE_SWITCHHANDFORBIDUIOPERATE_METHOD_3_063F2B448F31F24C_OFFSET UNITYSDK_OFFSET(0x18EBB000)
#define RPG_GAMECORE_SWITCHHANDFORBIDUIOPERATE_METHOD_3_9E5E06D843C7DBDD_OFFSET UNITYSDK_OFFSET(0x18EBB080)
#define RPG_GAMECORE_SWITCHHANDFORBIDUIOPERATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18EBB050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchHandForbidUIOperate_TypeDefinitionIndex = 19952;
