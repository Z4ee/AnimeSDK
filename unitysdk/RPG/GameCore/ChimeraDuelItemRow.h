...
#define RPG_GAMECORE_CHIMERADUELITEMROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1E335650)
#define RPG_GAMECORE_CHIMERADUELITEMROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1E3359E0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::ChimeraDuelItemVendor Vendor; // 0x4C
