...
#define RPG_GAMECORE_CHIMERADUELITEMROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1709E330)
#define RPG_GAMECORE_CHIMERADUELITEMROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1709E6D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelItemRow_TypeDefinitionIndex = 10406;
	...
	public:
		...
		::RPG::GameCore::ChimeraDuelItemVendor Vendor; // 0x44
		::System::UInt32 ItemID; // 0x48
		::System::UInt32 Price; // 0x4C
