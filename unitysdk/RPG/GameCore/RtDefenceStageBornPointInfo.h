...
#define RPG_GAMECORE_RTDEFENCESTAGEBORNPOINTINFO_METHOD_2_07EDF8A6223F5A95_OFFSET UNITYSDK_OFFSET(0x19BE84B0)
#define RPG_GAMECORE_RTDEFENCESTAGEBORNPOINTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19BE8600)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtDefenceStageBornPointInfo_TypeDefinitionIndex = 17172;
