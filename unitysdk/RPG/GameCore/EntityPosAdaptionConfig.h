...
#define RPG_GAMECORE_ENTITYPOSADAPTIONCONFIG_METHOD_2_D410D89432233A56_OFFSET UNITYSDK_OFFSET(0x196ED6C0)
#define RPG_GAMECORE_ENTITYPOSADAPTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x196EDAB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EntityPosAdaptionConfig_TypeDefinitionIndex = 19219;
