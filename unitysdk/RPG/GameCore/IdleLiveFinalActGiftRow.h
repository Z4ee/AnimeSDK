...
#define RPG_GAMECORE_IDLELIVEFINALACTGIFTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B695D60)
#define RPG_GAMECORE_IDLELIVEFINALACTGIFTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B695ED0)
