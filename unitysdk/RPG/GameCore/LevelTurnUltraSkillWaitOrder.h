...
#define RPG_GAMECORE_LEVELTURNULTRASKILLWAITORDER_GETACTIVEENTITY_OFFSET UNITYSDK_OFFSET(0xCE505D0)
#define RPG_GAMECORE_LEVELTURNULTRASKILLWAITORDER_GETDISABLEREADYCAMERA_OFFSET UNITYSDK_OFFSET(0xCE506A0)
#define RPG_GAMECORE_LEVELTURNULTRASKILLWAITORDER_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xCE50540)
#define RPG_GAMECORE_LEVELTURNULTRASKILLWAITORDER_GETINSERTULTRASKILLPARAMS_OFFSET UNITYSDK_OFFSET(0xCE50590)
#define RPG_GAMECORE_LEVELTURNULTRASKILLWAITORDER_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xCE504F0)
#define RPG_GAMECORE_LEVELTURNULTRASKILLWAITORDER_GETTURNCOUNTER_OFFSET UNITYSDK_OFFSET(0xCE50620)
#define RPG_GAMECORE_LEVELTURNULTRASKILLWAITORDER_GETTURNSTATE_OFFSET UNITYSDK_OFFSET(0xCE50660)
#define RPG_GAMECORE_LEVELTURNULTRASKILLWAITORDER_GET_ACTIONTYPE_OFFSET UNITYSDK_OFFSET(0xCE506E0)
#define RPG_GAMECORE_LEVELTURNULTRASKILLWAITORDER_INIT_OFFSET UNITYSDK_OFFSET(0xCE50470)
#define RPG_GAMECORE_LEVELTURNULTRASKILLWAITORDER__CTOR_OFFSET UNITYSDK_OFFSET(0xCE50700)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelTurnUltraSkillWaitOrder_TypeDefinitionIndex = 52967;
	...
	public:
		...
		::RPG::GameCore::TurnState _TurnState; // 0x28
