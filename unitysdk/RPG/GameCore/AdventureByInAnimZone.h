...
#define RPG_GAMECORE_ADVENTUREBYINANIMZONE_METHOD_4_0366A9ED22B1FEC5_OFFSET UNITYSDK_OFFSET(0x16F4C380)
#define RPG_GAMECORE_ADVENTUREBYINANIMZONE_METHOD_4_4793040AF776D0F9_OFFSET UNITYSDK_OFFSET(0x16F4C450)
#define RPG_GAMECORE_ADVENTUREBYINANIMZONE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F4C400)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureByInAnimZone_TypeDefinitionIndex = 18281;
