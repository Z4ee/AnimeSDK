...
#define RPG_GAMECORE_GRIDFIGHTEQUIPADDITIONALPROPERTYRULE_METHOD_2_91A150FAD420B5D4_OFFSET UNITYSDK_OFFSET(0x1C5C9400)
#define RPG_GAMECORE_GRIDFIGHTEQUIPADDITIONALPROPERTYRULE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5C9440)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightEquipAdditionalPropertyRule_TypeDefinitionIndex = 18627;
