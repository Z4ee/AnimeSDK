...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONENTERROOMCOUNTCONFIG_METHOD_3_0BF4040BC83554D8_OFFSET UNITYSDK_OFFSET(0x19B51A80)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONENTERROOMCOUNTCONFIG_METHOD_3_B979F18EA63DE301_OFFSET UNITYSDK_OFFSET(0x19B5CEA0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONENTERROOMCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B51A30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnEnterRoomCountConfig_TypeDefinitionIndex = 16904;
