...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONENTERROOMCOUNTCONFIG_METHOD_3_0BF4040BC83554D8_OFFSET UNITYSDK_OFFSET(0x1CFC0490)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONENTERROOMCOUNTCONFIG_METHOD_3_FFC7A61721CD059C_OFFSET UNITYSDK_OFFSET(0x1CFC0440)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONENTERROOMCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFC0480)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnEnterRoomCountConfig_TypeDefinitionIndex = 17066;
