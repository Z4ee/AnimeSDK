...
#define RPG_GAMECORE_CHIMERADUELSAVEDREPEATENTITIESSELECTORCONFIG_METHOD_3_848B755EE2213234_OFFSET UNITYSDK_OFFSET(0x18804AB0)
#define RPG_GAMECORE_CHIMERADUELSAVEDREPEATENTITIESSELECTORCONFIG_METHOD_3_944D63DB01AD6C89_OFFSET UNITYSDK_OFFSET(0x18804B50)
#define RPG_GAMECORE_CHIMERADUELSAVEDREPEATENTITIESSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18804B40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelSavedRepeatEntitiesSelectorConfig_TypeDefinitionIndex = 15096;
