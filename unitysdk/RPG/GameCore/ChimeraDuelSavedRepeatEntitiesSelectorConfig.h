...
#define RPG_GAMECORE_CHIMERADUELSAVEDREPEATENTITIESSELECTORCONFIG_METHOD_3_848B755EE2213234_OFFSET UNITYSDK_OFFSET(0x1E33BB00)
#define RPG_GAMECORE_CHIMERADUELSAVEDREPEATENTITIESSELECTORCONFIG_METHOD_3_944D63DB01AD6C89_OFFSET UNITYSDK_OFFSET(0x1E33BBA0)
#define RPG_GAMECORE_CHIMERADUELSAVEDREPEATENTITIESSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1E33BB90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelSavedRepeatEntitiesSelectorConfig_TypeDefinitionIndex = 15760;
