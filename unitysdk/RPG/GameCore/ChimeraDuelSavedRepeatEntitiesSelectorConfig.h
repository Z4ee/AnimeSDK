...
#define RPG_GAMECORE_CHIMERADUELSAVEDREPEATENTITIESSELECTORCONFIG_METHOD_3_848B755EE2213234_OFFSET UNITYSDK_OFFSET(0x19646390)
#define RPG_GAMECORE_CHIMERADUELSAVEDREPEATENTITIESSELECTORCONFIG_METHOD_3_944D63DB01AD6C89_OFFSET UNITYSDK_OFFSET(0x19646430)
#define RPG_GAMECORE_CHIMERADUELSAVEDREPEATENTITIESSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19646420)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelSavedRepeatEntitiesSelectorConfig_TypeDefinitionIndex = 15159;
