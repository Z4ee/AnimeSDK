...
#define RPG_GAMECORE_STORYLINECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19CC2A00)
#define RPG_GAMECORE_STORYLINECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19CC2C90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StoryLineConfigRow_TypeDefinitionIndex = 14434;
	...
	public:
		...
		::RPG::GameCore::ConditionParam* BeginCondition; // 0x28
		::System::UInt32 EarlyAccessContentID; // 0x30
		::System::UInt32 InitEntranceID; // 0x34
		::System::UInt32 InitAnchorID; // 0x38
		::System::UInt32 StoryLineID; // 0x3C
