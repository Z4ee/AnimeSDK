...
#define RPG_GAMECORE_STORYLINECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18EA5C10)
#define RPG_GAMECORE_STORYLINECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18EA5EA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StoryLineConfigRow_TypeDefinitionIndex = 14392;

	class StoryLineConfigRow : public ::System::Object
	{
	public:
		::RPG::GameCore::ConditionParam* BeginCondition; // 0x10
		::System::String* PerformanceStoryAvatar; // 0x18
