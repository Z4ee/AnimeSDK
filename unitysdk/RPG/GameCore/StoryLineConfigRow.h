...
#define RPG_GAMECORE_STORYLINECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B0C7F20)
#define RPG_GAMECORE_STORYLINECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0C81B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StoryLineConfigRow_TypeDefinitionIndex = 14592;
	...
	public:
		...
		::System::String* PerformanceStoryAvatar; // 0x20
		::RPG::GameCore::ConditionParam* EndCondition; // 0x28
		::System::UInt32 InitAnchorID; // 0x30
		::System::UInt32 InitEntranceID; // 0x34
		::System::UInt32 InitGroupID; // 0x38
		::System::UInt32 EarlyAccessContentID; // 0x3C
