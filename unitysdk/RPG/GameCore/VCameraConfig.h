...
#define RPG_GAMECORE_VCAMERACONFIG_METHOD_2_F5582A0539F76621_OFFSET UNITYSDK_OFFSET(0x1D6267E0)
#define RPG_GAMECORE_VCAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D626C40)
