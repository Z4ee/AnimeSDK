...
#define RPG_GAMECORE_ADVPUZZLECOLLECTITEM_METHOD_3_15E344992C5651E9_OFFSET UNITYSDK_OFFSET(0x1865EE90)
#define RPG_GAMECORE_ADVPUZZLECOLLECTITEM_METHOD_3_960826E85A1C9C2F_OFFSET UNITYSDK_OFFSET(0x1865EF10)
#define RPG_GAMECORE_ADVPUZZLECOLLECTITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1865EEE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvPuzzleCollectItem_TypeDefinitionIndex = 21009;
