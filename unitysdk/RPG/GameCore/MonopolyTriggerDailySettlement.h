...
#define RPG_GAMECORE_MONOPOLYTRIGGERDAILYSETTLEMENT_METHOD_3_D561203621B2EB00_OFFSET UNITYSDK_OFFSET(0x17448950)
#define RPG_GAMECORE_MONOPOLYTRIGGERDAILYSETTLEMENT_METHOD_3_FD25B30935C044B4_OFFSET UNITYSDK_OFFSET(0x17448840)
#define RPG_GAMECORE_MONOPOLYTRIGGERDAILYSETTLEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x17448920)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonopolyTriggerDailySettlement_TypeDefinitionIndex = 19257;
