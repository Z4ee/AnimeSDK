...
#define RPG_GAMECORE_MONOPOLYTRIGGERDAILYSETTLEMENT_METHOD_3_7CCC290C9238C1BD_OFFSET UNITYSDK_OFFSET(0x1D1D2020)
#define RPG_GAMECORE_MONOPOLYTRIGGERDAILYSETTLEMENT_METHOD_3_D561203621B2EB00_OFFSET UNITYSDK_OFFSET(0x1D1D20F0)
#define RPG_GAMECORE_MONOPOLYTRIGGERDAILYSETTLEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1D20E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonopolyTriggerDailySettlement_TypeDefinitionIndex = 20689;
