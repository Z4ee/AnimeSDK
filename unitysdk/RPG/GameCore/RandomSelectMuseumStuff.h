...
#define RPG_GAMECORE_RANDOMSELECTMUSEUMSTUFF_METHOD_3_12C6224F4B468EA8_OFFSET UNITYSDK_OFFSET(0x17580CB0)
#define RPG_GAMECORE_RANDOMSELECTMUSEUMSTUFF_METHOD_3_FB7CC1F4E4A833D6_OFFSET UNITYSDK_OFFSET(0x17580DD0)
#define RPG_GAMECORE_RANDOMSELECTMUSEUMSTUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x17580D50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RandomSelectMuseumStuff_TypeDefinitionIndex = 19390;
