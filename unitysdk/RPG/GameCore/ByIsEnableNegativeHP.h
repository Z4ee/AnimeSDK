...
#define RPG_GAMECORE_BYISENABLENEGATIVEHP_METHOD_4_5346EA3B7DB2F439_OFFSET UNITYSDK_OFFSET(0x18751B80)
#define RPG_GAMECORE_BYISENABLENEGATIVEHP_METHOD_4_B9C5056E6E0F4C77_OFFSET UNITYSDK_OFFSET(0x18751C50)
#define RPG_GAMECORE_BYISENABLENEGATIVEHP__CTOR_OFFSET UNITYSDK_OFFSET(0x18751C00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsEnableNegativeHP_TypeDefinitionIndex = 22705;
