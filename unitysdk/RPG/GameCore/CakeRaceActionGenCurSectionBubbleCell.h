...
#define RPG_GAMECORE_CAKERACEACTIONGENCURSECTIONBUBBLECELL_METHOD_3_194077F48C663574_OFFSET UNITYSDK_OFFSET(0x195E7D90)
#define RPG_GAMECORE_CAKERACEACTIONGENCURSECTIONBUBBLECELL_METHOD_3_2E1D12AB820F3A87_OFFSET UNITYSDK_OFFSET(0x195E5AC0)
#define RPG_GAMECORE_CAKERACEACTIONGENCURSECTIONBUBBLECELL__CTOR_OFFSET UNITYSDK_OFFSET(0x195E5AA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionGenCurSectionBubbleCell_TypeDefinitionIndex = 17433;
