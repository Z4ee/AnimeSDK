...
#define RPG_GAMECORE_CAKERACEACTIONGENCURSECTIONBUBBLECELL_METHOD_3_194077F48C663574_OFFSET UNITYSDK_OFFSET(0x17046680)
#define RPG_GAMECORE_CAKERACEACTIONGENCURSECTIONBUBBLECELL_METHOD_3_2E1D12AB820F3A87_OFFSET UNITYSDK_OFFSET(0x17044860)
#define RPG_GAMECORE_CAKERACEACTIONGENCURSECTIONBUBBLECELL__CTOR_OFFSET UNITYSDK_OFFSET(0x17044840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionGenCurSectionBubbleCell_TypeDefinitionIndex = 16836;
