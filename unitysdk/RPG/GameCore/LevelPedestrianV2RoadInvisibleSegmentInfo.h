...
#define RPG_GAMECORE_LEVELPEDESTRIANV2ROADINVISIBLESEGMENTINFO_METHOD_2_800E07D3EBAA2F0A_OFFSET UNITYSDK_OFFSET(0x17349550)
#define RPG_GAMECORE_LEVELPEDESTRIANV2ROADINVISIBLESEGMENTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x17349640)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPedestrianV2RoadInvisibleSegmentInfo_TypeDefinitionIndex = 15881;
