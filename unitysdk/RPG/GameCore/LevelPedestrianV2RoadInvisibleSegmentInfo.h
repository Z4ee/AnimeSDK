...
#define RPG_GAMECORE_LEVELPEDESTRIANV2ROADINVISIBLESEGMENTINFO_METHOD_2_800E07D3EBAA2F0A_OFFSET UNITYSDK_OFFSET(0x1C12E040)
#define RPG_GAMECORE_LEVELPEDESTRIANV2ROADINVISIBLESEGMENTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1C12E130)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPedestrianV2RoadInvisibleSegmentInfo_TypeDefinitionIndex = 17095;
