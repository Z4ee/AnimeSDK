...
#define RPG_GAMECORE_CHIMERATEAMROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x170AC220)
#define RPG_GAMECORE_CHIMERATEAMROW__CTOR_OFFSET UNITYSDK_OFFSET(0x170AC490)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraTeamRow_TypeDefinitionIndex = 11882;
	...
	public:
		...
		::System::String* TeamAvatarIcon; // 0x28
