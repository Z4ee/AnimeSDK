...
#define RPG_GAMECORE_FOURROTATEVOXELLEVELUICONFIG_METHOD_2_60AAE946E7233B6C_OFFSET UNITYSDK_OFFSET(0x1DCB6820)
#define RPG_GAMECORE_FOURROTATEVOXELLEVELUICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCB79F0)
