...
#define RPG_GAMECORE_BYCOMPARELINEUPAVATARHPRATIO_METHOD_4_AEB756966A409C43_OFFSET UNITYSDK_OFFSET(0x1700D950)
#define RPG_GAMECORE_BYCOMPARELINEUPAVATARHPRATIO_METHOD_4_F73344DDC5E03EB5_OFFSET UNITYSDK_OFFSET(0x1700D870)
#define RPG_GAMECORE_BYCOMPARELINEUPAVATARHPRATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x1700D8F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareLineupAvatarHpRatio_TypeDefinitionIndex = 19118;
