...
#define RPG_GAMECORE_PLAYORIGAMITRACETALK_METHOD_3_6DD1C4C46E121274_OFFSET UNITYSDK_OFFSET(0x18C0FED0)
#define RPG_GAMECORE_PLAYORIGAMITRACETALK_METHOD_3_AC3213DE03C86F03_OFFSET UNITYSDK_OFFSET(0x18C0FF50)
#define RPG_GAMECORE_PLAYORIGAMITRACETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x18C0FF20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayOrigamiTraceTalk_TypeDefinitionIndex = 20720;
