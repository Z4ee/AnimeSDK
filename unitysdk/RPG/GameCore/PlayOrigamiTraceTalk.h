...
#define RPG_GAMECORE_PLAYORIGAMITRACETALK_METHOD_3_6B33563FF74DE26A_OFFSET UNITYSDK_OFFSET(0x1D34A740)
#define RPG_GAMECORE_PLAYORIGAMITRACETALK_METHOD_3_AC3213DE03C86F03_OFFSET UNITYSDK_OFFSET(0x1D34A780)
#define RPG_GAMECORE_PLAYORIGAMITRACETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D34A770)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayOrigamiTraceTalk_TypeDefinitionIndex = 21622;
