...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSHOPUPROLESTARWITHORIGINALCOSTCONFIG_METHOD_3_B11BA75EAD3E6649_OFFSET UNITYSDK_OFFSET(0x197F4300)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSHOPUPROLESTARWITHORIGINALCOSTCONFIG_METHOD_3_DDEE3E5E1D2AED70_OFFSET UNITYSDK_OFFSET(0x197F4230)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSHOPUPROLESTARWITHORIGINALCOSTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197F42B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierShopUpRoleStarWithOriginalCostConfig_TypeDefinitionIndex = 18352;
