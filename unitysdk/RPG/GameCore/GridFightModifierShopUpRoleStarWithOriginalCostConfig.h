...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSHOPUPROLESTARWITHORIGINALCOSTCONFIG_METHOD_3_B11BA75EAD3E6649_OFFSET UNITYSDK_OFFSET(0x1726C9D0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSHOPUPROLESTARWITHORIGINALCOSTCONFIG_METHOD_3_DDEE3E5E1D2AED70_OFFSET UNITYSDK_OFFSET(0x1726C900)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSHOPUPROLESTARWITHORIGINALCOSTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1726C980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierShopUpRoleStarWithOriginalCostConfig_TypeDefinitionIndex = 17765;
