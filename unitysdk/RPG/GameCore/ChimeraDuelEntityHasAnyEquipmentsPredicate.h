...
#define RPG_GAMECORE_CHIMERADUELENTITYHASANYEQUIPMENTSPREDICATE_METHOD_3_5F4E712DE836A11A_OFFSET UNITYSDK_OFFSET(0x1CFC50C0)
#define RPG_GAMECORE_CHIMERADUELENTITYHASANYEQUIPMENTSPREDICATE_METHOD_3_B29F6B8038C89818_OFFSET UNITYSDK_OFFSET(0x1CFC5060)
#define RPG_GAMECORE_CHIMERADUELENTITYHASANYEQUIPMENTSPREDICATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFC50B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelEntityHasAnyEquipmentsPredicate_TypeDefinitionIndex = 15747;
