...
#define RPG_GAMECORE_WAITFORWITHDURATION_METHOD_3_3AA556121B268660_OFFSET UNITYSDK_OFFSET(0x178FA530)
#define RPG_GAMECORE_WAITFORWITHDURATION_METHOD_3_99A7552C98D72D8C_OFFSET UNITYSDK_OFFSET(0x178FA650)
#define RPG_GAMECORE_WAITFORWITHDURATION__CTOR_OFFSET UNITYSDK_OFFSET(0x178FA5D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitForWithDuration_TypeDefinitionIndex = 22066;
