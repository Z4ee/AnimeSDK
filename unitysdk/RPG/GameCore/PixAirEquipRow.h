...
#define RPG_GAMECORE_PIXAIREQUIPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19A119D0)
#define RPG_GAMECORE_PIXAIREQUIPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19A128C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PixAirEquipRow_TypeDefinitionIndex = 11585;
