...
#define RPG_GAMECORE_SETRAIDTARGETPROGRESS_METHOD_3_141FD328E2EB0384_OFFSET UNITYSDK_OFFSET(0x18E3FB80)
#define RPG_GAMECORE_SETRAIDTARGETPROGRESS_METHOD_3_C5E406D3A022C9B5_OFFSET UNITYSDK_OFFSET(0x18E3FC10)
#define RPG_GAMECORE_SETRAIDTARGETPROGRESS__CTOR_OFFSET UNITYSDK_OFFSET(0x18E3FBE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetRaidTargetProgress_TypeDefinitionIndex = 22648;
