...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERUPGRADEEQUIPCONFIG_METHOD_3_6A592E55E2007AAB_OFFSET UNITYSDK_OFFSET(0x1726CE40)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERUPGRADEEQUIPCONFIG_METHOD_3_ACE8B3F1DCDE87A2_OFFSET UNITYSDK_OFFSET(0x1726CF10)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERUPGRADEEQUIPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1726CEC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierUpgradeEquipConfig_TypeDefinitionIndex = 17833;
