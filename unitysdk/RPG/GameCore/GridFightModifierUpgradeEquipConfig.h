...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERUPGRADEEQUIPCONFIG_METHOD_3_7499F320B2A61B06_OFFSET UNITYSDK_OFFSET(0x1D06B6A0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERUPGRADEEQUIPCONFIG_METHOD_3_ACE8B3F1DCDE87A2_OFFSET UNITYSDK_OFFSET(0x1D06B6F0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERUPGRADEEQUIPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D06B6E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierUpgradeEquipConfig_TypeDefinitionIndex = 18675;
