...
#define RPG_GAMECORE_BYCOMPARETEAMLEADERBODYSIZE_METHOD_4_0C73B4ECF56635D6_OFFSET UNITYSDK_OFFSET(0x1A8AFDB0)
#define RPG_GAMECORE_BYCOMPARETEAMLEADERBODYSIZE_METHOD_4_121829884F20C639_OFFSET UNITYSDK_OFFSET(0x1A8AFD80)
#define RPG_GAMECORE_BYCOMPARETEAMLEADERBODYSIZE_METHOD_4_948AF340B74934C3_OFFSET UNITYSDK_OFFSET(0x1A8AFC00)
#define RPG_GAMECORE_BYCOMPARETEAMLEADERBODYSIZE_METHOD_4_F10341A4E453E3CA_OFFSET UNITYSDK_OFFSET(0x1A8AFBC0)
#define RPG_GAMECORE_BYCOMPARETEAMLEADERBODYSIZE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8AFBF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareTeamLeaderBodySize_TypeDefinitionIndex = 20309;
