...
#define RPG_GAMECORE_BYCOMPARETEAMLEADERBODYSIZE_METHOD_4_3A5B2F9C4760CC2D_OFFSET UNITYSDK_OFFSET(0x1701BA60)
#define RPG_GAMECORE_BYCOMPARETEAMLEADERBODYSIZE_METHOD_4_948AF340B74934C3_OFFSET UNITYSDK_OFFSET(0x1701BB30)
#define RPG_GAMECORE_BYCOMPARETEAMLEADERBODYSIZE__CTOR_OFFSET UNITYSDK_OFFSET(0x1701BAE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareTeamLeaderBodySize_TypeDefinitionIndex = 19406;
