...
#define RPG_GAMECORE_SETDYNAMICVALUEBYBOSSTOTALHP_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x176C0AF0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBOSSTOTALHP_METHOD_4_1FC70F2CD80EBE8C_OFFSET UNITYSDK_OFFSET(0x176B8AE0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBOSSTOTALHP_METHOD_4_F18A5745EC119AC2_OFFSET UNITYSDK_OFFSET(0x176C0A70)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBOSSTOTALHP__CTOR_OFFSET UNITYSDK_OFFSET(0x176B8A80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByBossTotalHP_TypeDefinitionIndex = 20965;
