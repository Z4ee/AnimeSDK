...
#define RPG_GAMECORE_SETDYNAMICVALUEBYBOSSTOTALHP_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x18E1E2B0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBOSSTOTALHP_METHOD_4_1FC70F2CD80EBE8C_OFFSET UNITYSDK_OFFSET(0x18E1E060)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBOSSTOTALHP_METHOD_4_F18A5745EC119AC2_OFFSET UNITYSDK_OFFSET(0x18E1DF80)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBOSSTOTALHP__CTOR_OFFSET UNITYSDK_OFFSET(0x18E1E000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByBossTotalHP_TypeDefinitionIndex = 21676;
