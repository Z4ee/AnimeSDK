...
#define RPG_GAMECORE_SETDYNAMICVALUEBYBOSSTOTALHP_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1C2DFF60)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBOSSTOTALHP_METHOD_4_1FC70F2CD80EBE8C_OFFSET UNITYSDK_OFFSET(0x1C2DFD10)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBOSSTOTALHP_METHOD_4_EAB6ABE7F7E6995D_OFFSET UNITYSDK_OFFSET(0x1C2DFCC0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBOSSTOTALHP__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2DFD00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByBossTotalHP_TypeDefinitionIndex = 21951;
