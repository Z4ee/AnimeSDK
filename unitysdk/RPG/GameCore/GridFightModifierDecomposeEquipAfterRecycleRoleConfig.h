...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERDECOMPOSEEQUIPAFTERRECYCLEROLECONFIG_METHOD_3_5B1AE0A4D110E303_OFFSET UNITYSDK_OFFSET(0x189BB700)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERDECOMPOSEEQUIPAFTERRECYCLEROLECONFIG_METHOD_3_A0FD943351FFAA3A_OFFSET UNITYSDK_OFFSET(0x189B7D10)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERDECOMPOSEEQUIPAFTERRECYCLEROLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189B7CC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierDecomposeEquipAfterRecycleRoleConfig_TypeDefinitionIndex = 18450;
