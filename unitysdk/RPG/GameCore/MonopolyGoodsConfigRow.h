...
#define RPG_GAMECORE_MONOPOLYGOODSCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19960280)
#define RPG_GAMECORE_MONOPOLYGOODSCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x199605E0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 TextDisplayParam1; // 0x3C
		::System::UInt32 GoodsID; // 0x40
		::System::UInt32 Cost; // 0x44
		::RPG::GameCore::MonopolyGoodsType GoodsType; // 0x48
