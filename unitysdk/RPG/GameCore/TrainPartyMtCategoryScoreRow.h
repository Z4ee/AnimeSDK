...
#define RPG_GAMECORE_TRAINPARTYMTCATEGORYSCOREROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19DF7080)
#define RPG_GAMECORE_TRAINPARTYMTCATEGORYSCOREROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19DF71F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyMtCategoryScoreRow_TypeDefinitionIndex = 14567;

	class TrainPartyMtCategoryScoreRow : public ::System::Object
	{
	public:
		::System::UInt32 CategoryID; // 0x10
		::System::UInt32 Ratio; // 0x14
