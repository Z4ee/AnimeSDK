...
#define RPG_GAMECORE_TRAINPARTYMTCATEGORYSCOREROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D5DF4C0)
#define RPG_GAMECORE_TRAINPARTYMTCATEGORYSCOREROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5DF630)
