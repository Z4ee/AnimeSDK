...
#define RPG_GAMECORE_PROPCOMPONENT___C__DISPLAYCLASS98_0__CTOR_OFFSET UNITYSDK_OFFSET(0x127C1780)
#define RPG_GAMECORE_PROPCOMPONENT___C__DISPLAYCLASS98_0___ONDOGACHAINROLLSHOPSCRSP_B__0_OFFSET UNITYSDK_OFFSET(0x127C1790)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::Class_1_C821CB457FB5EBC6_5* rsp; // 0x10
