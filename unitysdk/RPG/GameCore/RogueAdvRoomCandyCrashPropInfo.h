...
#define RPG_GAMECORE_ROGUEADVROOMCANDYCRASHPROPINFO_METHOD_2_3F0F567355260DA1_OFFSET UNITYSDK_OFFSET(0x1D3BCFF0)
#define RPG_GAMECORE_ROGUEADVROOMCANDYCRASHPROPINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3BD140)
