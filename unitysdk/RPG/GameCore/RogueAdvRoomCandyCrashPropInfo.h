...
#define RPG_GAMECORE_ROGUEADVROOMCANDYCRASHPROPINFO_METHOD_2_3F0F567355260DA1_OFFSET UNITYSDK_OFFSET(0x19B0C700)
#define RPG_GAMECORE_ROGUEADVROOMCANDYCRASHPROPINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19B0C850)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueAdvRoomCandyCrashPropInfo_TypeDefinitionIndex = 16999;
