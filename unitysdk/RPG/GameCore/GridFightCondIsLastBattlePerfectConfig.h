...
#define RPG_GAMECORE_GRIDFIGHTCONDISLASTBATTLEPERFECTCONFIG_METHOD_6_38B65B0B04145377_OFFSET UNITYSDK_OFFSET(0x1C5C5370)
#define RPG_GAMECORE_GRIDFIGHTCONDISLASTBATTLEPERFECTCONFIG_METHOD_6_B9CE49B1674DF133_OFFSET UNITYSDK_OFFSET(0x1C5C5320)
#define RPG_GAMECORE_GRIDFIGHTCONDISLASTBATTLEPERFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5C5360)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightCondIsLastBattlePerfectConfig_TypeDefinitionIndex = 18575;
