...
#define RPG_GAMECORE_FINISHTAROTBOOKTALK_METHOD_3_259852AB4C10F6A4_OFFSET UNITYSDK_OFFSET(0x1BA82570)
#define RPG_GAMECORE_FINISHTAROTBOOKTALK_METHOD_3_C660CAEF43ECE021_OFFSET UNITYSDK_OFFSET(0x1BA82640)
#define RPG_GAMECORE_FINISHTAROTBOOKTALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA82630)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FinishTarotBookTalk_TypeDefinitionIndex = 20344;
