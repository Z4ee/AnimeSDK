...
#define RPG_GAMECORE_MUNICIPALCHATACTIONEMOJI_METHOD_3_109139A4EDA7C9E0_OFFSET UNITYSDK_OFFSET(0x1D2DDD70)
#define RPG_GAMECORE_MUNICIPALCHATACTIONEMOJI_METHOD_3_82BC65BD5711027A_OFFSET UNITYSDK_OFFSET(0x1D2DE8F0)
#define RPG_GAMECORE_MUNICIPALCHATACTIONEMOJI__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2DDD50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MunicipalChatActionEmoji_TypeDefinitionIndex = 16732;
