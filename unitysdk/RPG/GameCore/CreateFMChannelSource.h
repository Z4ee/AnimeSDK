...
#define RPG_GAMECORE_CREATEFMCHANNELSOURCE_METHOD_3_53C605B4165971EF_OFFSET UNITYSDK_OFFSET(0x1D008000)
#define RPG_GAMECORE_CREATEFMCHANNELSOURCE_METHOD_3_C07DC1DE057247E2_OFFSET UNITYSDK_OFFSET(0x1D007FC0)
#define RPG_GAMECORE_CREATEFMCHANNELSOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D007FF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CreateFMChannelSource_TypeDefinitionIndex = 20337;
