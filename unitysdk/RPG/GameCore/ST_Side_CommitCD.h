...
#define RPG_GAMECORE_ST_SIDE_COMMITCD_METHOD_4_0252DC9640A9BF89_OFFSET UNITYSDK_OFFSET(0x18DF6180)
#define RPG_GAMECORE_ST_SIDE_COMMITCD_METHOD_4_51F960D2A82DCCF1_OFFSET UNITYSDK_OFFSET(0x18DF60B0)
#define RPG_GAMECORE_ST_SIDE_COMMITCD__CTOR_OFFSET UNITYSDK_OFFSET(0x18DF6130)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_CommitCD_TypeDefinitionIndex = 19071;
