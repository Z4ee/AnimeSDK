...
#define RPG_GAMECORE_ST_SIDE_DISABLEPLAYERLOCK_METHOD_4_22248F963B8F612C_OFFSET UNITYSDK_OFFSET(0x1768A450)
#define RPG_GAMECORE_ST_SIDE_DISABLEPLAYERLOCK_METHOD_4_28EBA20D1BA7007B_OFFSET UNITYSDK_OFFSET(0x176987F0)
#define RPG_GAMECORE_ST_SIDE_DISABLEPLAYERLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x1768A400)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_DisablePlayerLock_TypeDefinitionIndex = 18424;
