...
#define RPG_GAMECORE_ST_SIDE_DISABLEPLAYERLOCK_METHOD_4_22248F963B8F612C_OFFSET UNITYSDK_OFFSET(0x1B788400)
#define RPG_GAMECORE_ST_SIDE_DISABLEPLAYERLOCK_METHOD_4_9DD3DDDED9AC3FE9_OFFSET UNITYSDK_OFFSET(0x1B788330)
#define RPG_GAMECORE_ST_SIDE_DISABLEPLAYERLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7883F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_DisablePlayerLock_TypeDefinitionIndex = 19363;
