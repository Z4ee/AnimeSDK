...
#define RPG_GAMECORE_CAKERACEACTIONPROPERTYMODIFIER_METHOD_3_20DB41523030D4FD_OFFSET UNITYSDK_OFFSET(0x1CF6F690)
#define RPG_GAMECORE_CAKERACEACTIONPROPERTYMODIFIER_METHOD_3_4D0D5D49B536EC4A_OFFSET UNITYSDK_OFFSET(0x1CF6F6D0)
#define RPG_GAMECORE_CAKERACEACTIONPROPERTYMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF6F6C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionPropertyModifier_TypeDefinitionIndex = 18118;
