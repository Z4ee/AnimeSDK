...
#define RPG_GAMECORE_CAKERACEACTIONPROPERTYMODIFIER_METHOD_3_1F8F9C41C3D4E2EB_OFFSET UNITYSDK_OFFSET(0x1876C1B0)
#define RPG_GAMECORE_CAKERACEACTIONPROPERTYMODIFIER_METHOD_3_78F4C3B6089F9118_OFFSET UNITYSDK_OFFSET(0x1876AA20)
#define RPG_GAMECORE_CAKERACEACTIONPROPERTYMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1876AA00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionPropertyModifier_TypeDefinitionIndex = 17423;
