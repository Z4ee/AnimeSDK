...
#define RPG_GAMECORE_TARGETFETCHMODIFIEROWNER_METHOD_4_4D15A10B7139F3D3_OFFSET UNITYSDK_OFFSET(0x1E1B4F30)
#define RPG_GAMECORE_TARGETFETCHMODIFIEROWNER_METHOD_4_5153A48FE10D1E17_OFFSET UNITYSDK_OFFSET(0x1E1B4E50)
#define RPG_GAMECORE_TARGETFETCHMODIFIEROWNER_METHOD_4_B686C04EAF9390A6_OFFSET UNITYSDK_OFFSET(0x1E1B4ED0)
#define RPG_GAMECORE_TARGETFETCHMODIFIEROWNER_METHOD_4_D7891593DDBD6D26_OFFSET UNITYSDK_OFFSET(0x1E1B4F50)
#define RPG_GAMECORE_TARGETFETCHMODIFIEROWNER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1B4EC0)
