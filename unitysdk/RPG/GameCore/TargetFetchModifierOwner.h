...
#define RPG_GAMECORE_TARGETFETCHMODIFIEROWNER_METHOD_4_4D15A10B7139F3D3_OFFSET UNITYSDK_OFFSET(0x1D0BAF10)
#define RPG_GAMECORE_TARGETFETCHMODIFIEROWNER_METHOD_4_5153A48FE10D1E17_OFFSET UNITYSDK_OFFSET(0x1D0BAE30)
#define RPG_GAMECORE_TARGETFETCHMODIFIEROWNER_METHOD_4_B686C04EAF9390A6_OFFSET UNITYSDK_OFFSET(0x1D0BAEB0)
#define RPG_GAMECORE_TARGETFETCHMODIFIEROWNER_METHOD_4_D7891593DDBD6D26_OFFSET UNITYSDK_OFFSET(0x1D0BAF30)
#define RPG_GAMECORE_TARGETFETCHMODIFIEROWNER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0BAEA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchModifierOwner_TypeDefinitionIndex = 23053;
