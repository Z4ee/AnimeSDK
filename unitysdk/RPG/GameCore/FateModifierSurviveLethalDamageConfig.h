...
#define RPG_GAMECORE_FATEMODIFIERSURVIVELETHALDAMAGECONFIG_METHOD_3_520F9F63643A7779_OFFSET UNITYSDK_OFFSET(0x1C0755E0)
#define RPG_GAMECORE_FATEMODIFIERSURVIVELETHALDAMAGECONFIG_METHOD_3_E3FA43DCBDAAB175_OFFSET UNITYSDK_OFFSET(0x1C075590)
#define RPG_GAMECORE_FATEMODIFIERSURVIVELETHALDAMAGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0755D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateModifierSurviveLethalDamageConfig_TypeDefinitionIndex = 18523;
