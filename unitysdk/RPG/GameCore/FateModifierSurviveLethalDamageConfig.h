...
#define RPG_GAMECORE_FATEMODIFIERSURVIVELETHALDAMAGECONFIG_METHOD_3_22540663F8271BA0_OFFSET UNITYSDK_OFFSET(0x171C9200)
#define RPG_GAMECORE_FATEMODIFIERSURVIVELETHALDAMAGECONFIG_METHOD_3_520F9F63643A7779_OFFSET UNITYSDK_OFFSET(0x171C85E0)
#define RPG_GAMECORE_FATEMODIFIERSURVIVELETHALDAMAGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171C8590)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateModifierSurviveLethalDamageConfig_TypeDefinitionIndex = 17703;
