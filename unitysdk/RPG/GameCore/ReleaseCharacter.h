...
#define RPG_GAMECORE_RELEASECHARACTER_METHOD_3_248D8ECB6514001A_OFFSET UNITYSDK_OFFSET(0x1DB7FDE0)
#define RPG_GAMECORE_RELEASECHARACTER_METHOD_3_5F9BABB5C21A7A91_OFFSET UNITYSDK_OFFSET(0x1DB7FDA0)
#define RPG_GAMECORE_RELEASECHARACTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB7FDD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ReleaseCharacter_TypeDefinitionIndex = 20582;
