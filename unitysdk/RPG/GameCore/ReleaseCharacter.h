...
#define RPG_GAMECORE_RELEASECHARACTER_METHOD_3_248D8ECB6514001A_OFFSET UNITYSDK_OFFSET(0x1758AA00)
#define RPG_GAMECORE_RELEASECHARACTER_METHOD_3_8A6EC2537344FB23_OFFSET UNITYSDK_OFFSET(0x1758A980)
#define RPG_GAMECORE_RELEASECHARACTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1758A9D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ReleaseCharacter_TypeDefinitionIndex = 19141;
