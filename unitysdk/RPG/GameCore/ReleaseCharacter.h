...
#define RPG_GAMECORE_RELEASECHARACTER_METHOD_3_248D8ECB6514001A_OFFSET UNITYSDK_OFFSET(0x18C969C0)
#define RPG_GAMECORE_RELEASECHARACTER_METHOD_3_8A6EC2537344FB23_OFFSET UNITYSDK_OFFSET(0x18C96940)
#define RPG_GAMECORE_RELEASECHARACTER__CTOR_OFFSET UNITYSDK_OFFSET(0x18C96990)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ReleaseCharacter_TypeDefinitionIndex = 19800;
