...
#define RPG_GAMECORE_MAINSTORYACTVIEWROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D21D630)
#define RPG_GAMECORE_MAINSTORYACTVIEWROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D21DE00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MainStoryActViewRow_TypeDefinitionIndex = 13890;
	...
	public:
		...
		::RPG::Client::TextID ChronicleChapterName; // 0x28
		::System::UInt32 IsCompleted; // 0x38
		::System::UInt32 SortID; // 0x3C
		::System::UInt32 ID; // 0x40
		::System::UInt32 IsCompletionOverride; // 0x44
