...
#define RPG_GAMECORE_CLOCKPARKSTORYTRIGGERASIDEDIALOG_METHOD_3_CFAEE72EB100DED9_OFFSET UNITYSDK_OFFSET(0x1711B020)
#define RPG_GAMECORE_CLOCKPARKSTORYTRIGGERASIDEDIALOG_METHOD_3_E07008660ECC0B40_OFFSET UNITYSDK_OFFSET(0x1711B0A0)
#define RPG_GAMECORE_CLOCKPARKSTORYTRIGGERASIDEDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1711B070)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClockParkStoryTriggerAsideDialog_TypeDefinitionIndex = 19276;
