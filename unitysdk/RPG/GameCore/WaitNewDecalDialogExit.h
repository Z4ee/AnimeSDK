...
#define RPG_GAMECORE_WAITNEWDECALDIALOGEXIT_METHOD_3_635D4B5AF42016B5_OFFSET UNITYSDK_OFFSET(0x19102B50)
#define RPG_GAMECORE_WAITNEWDECALDIALOGEXIT_METHOD_3_C7EC7BCBF98C7184_OFFSET UNITYSDK_OFFSET(0x19102BD0)
#define RPG_GAMECORE_WAITNEWDECALDIALOGEXIT__CTOR_OFFSET UNITYSDK_OFFSET(0x19102BA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitNewDecalDialogExit_TypeDefinitionIndex = 20529;
