...
#define RPG_GAMECORE_WAITNEWDECALDIALOGEXIT_METHOD_3_74D7EC9C22E3FC5F_OFFSET UNITYSDK_OFFSET(0x1D1B7710)
#define RPG_GAMECORE_WAITNEWDECALDIALOGEXIT_METHOD_3_C7EC7BCBF98C7184_OFFSET UNITYSDK_OFFSET(0x1D1B7750)
#define RPG_GAMECORE_WAITNEWDECALDIALOGEXIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1B7740)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitNewDecalDialogExit_TypeDefinitionIndex = 20880;
