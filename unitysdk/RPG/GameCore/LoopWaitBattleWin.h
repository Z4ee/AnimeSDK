...
#define RPG_GAMECORE_LOOPWAITBATTLEWIN_METHOD_3_57154503742D0EBA_OFFSET UNITYSDK_OFFSET(0x17370B70)
#define RPG_GAMECORE_LOOPWAITBATTLEWIN_METHOD_3_BED34B97789DE23A_OFFSET UNITYSDK_OFFSET(0x17370AE0)
#define RPG_GAMECORE_LOOPWAITBATTLEWIN__CTOR_OFFSET UNITYSDK_OFFSET(0x17370B40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoopWaitBattleWin_TypeDefinitionIndex = 19475;
