...
#define RPG_GAMECORE_PLANETFESAVATARANIMCONFIG_METHOD_2_B77E3CE308E168AC_OFFSET UNITYSDK_OFFSET(0x19A177E0)
#define RPG_GAMECORE_PLANETFESAVATARANIMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19A17930)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlanetFesAvatarAnimConfig_TypeDefinitionIndex = 15441;
