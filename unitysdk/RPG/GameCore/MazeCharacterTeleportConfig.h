...
#define RPG_GAMECORE_MAZECHARACTERTELEPORTCONFIG_METHOD_2_F1836C58FBCBBB24_OFFSET UNITYSDK_OFFSET(0x1D259580)
#define RPG_GAMECORE_MAZECHARACTERTELEPORTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D259770)
