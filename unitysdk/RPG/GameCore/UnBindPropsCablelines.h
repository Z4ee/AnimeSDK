...
#define RPG_GAMECORE_UNBINDPROPSCABLELINES_METHOD_3_8EF36C241B57F89E_OFFSET UNITYSDK_OFFSET(0x1B87F0E0)
#define RPG_GAMECORE_UNBINDPROPSCABLELINES_METHOD_3_9E29BC34EE348D15_OFFSET UNITYSDK_OFFSET(0x1B87F0A0)
#define RPG_GAMECORE_UNBINDPROPSCABLELINES__CTOR_OFFSET UNITYSDK_OFFSET(0x1B87F0D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UnBindPropsCablelines_TypeDefinitionIndex = 20472;
