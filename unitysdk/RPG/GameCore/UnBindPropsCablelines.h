...
#define RPG_GAMECORE_UNBINDPROPSCABLELINES_METHOD_3_3428E5F242F88B3F_OFFSET UNITYSDK_OFFSET(0x178E32C0)
#define RPG_GAMECORE_UNBINDPROPSCABLELINES_METHOD_3_8EF36C241B57F89E_OFFSET UNITYSDK_OFFSET(0x178E3340)
#define RPG_GAMECORE_UNBINDPROPSCABLELINES__CTOR_OFFSET UNITYSDK_OFFSET(0x178E3310)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UnBindPropsCablelines_TypeDefinitionIndex = 19568;
