...
#define RPG_GAMECORE_LEVELGROUPINFO_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1D1D3AC0)
#define RPG_GAMECORE_LEVELGROUPINFO_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D1D3A50)
#define RPG_GAMECORE_LEVELGROUPINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1D3AA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelGroupInfo_TypeDefinitionIndex = 17155;
