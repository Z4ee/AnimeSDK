...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYREROLLBUFFCOSTCONFIG_METHOD_3_A2B699DAD3C8B5C6_OFFSET UNITYSDK_OFFSET(0x1D1643C0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYREROLLBUFFCOSTCONFIG_METHOD_3_A64240B97F013E62_OFFSET UNITYSDK_OFFSET(0x1D164410)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYREROLLBUFFCOSTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D164400)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyReRollBuffCostConfig_TypeDefinitionIndex = 17233;
