...
#define RPG_GAMECORE_SETEFFECTANIMATORSTATE_METHOD_3_012C3FC00FA16698_OFFSET UNITYSDK_OFFSET(0x176C95F0)
#define RPG_GAMECORE_SETEFFECTANIMATORSTATE_METHOD_3_0FC791D78057ED6B_OFFSET UNITYSDK_OFFSET(0x176C9670)
#define RPG_GAMECORE_SETEFFECTANIMATORSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x176C9640)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetEffectAnimatorState_TypeDefinitionIndex = 22021;
