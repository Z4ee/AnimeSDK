...
#define RPG_GAMECORE_SETEFFECTANIMATORSTATE_METHOD_3_CF8883875D7E62B1_OFFSET UNITYSDK_OFFSET(0x1C5F5290)
#define RPG_GAMECORE_SETEFFECTANIMATORSTATE_METHOD_3_DA0CDE5BB133AA90_OFFSET UNITYSDK_OFFSET(0x1C5F52E0)
#define RPG_GAMECORE_SETEFFECTANIMATORSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5F52D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetEffectAnimatorState_TypeDefinitionIndex = 22895;
