...
#define RPG_GAMECORE_GRIDFIGHTASSISTANTMESSAGECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C5C2AC0)
#define RPG_GAMECORE_GRIDFIGHTASSISTANTMESSAGECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5C2E40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightAssistantMessageConfigRow_TypeDefinitionIndex = 12937;
	...
	public:
		...
		::System::Int32 ExclusiveID; // 0x24
		::RPG::Client::TextID Description; // 0x28
		::System::UInt32 EndDivisionID; // 0x38
