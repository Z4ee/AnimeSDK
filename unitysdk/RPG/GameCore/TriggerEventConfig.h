...
#define RPG_GAMECORE_TRIGGEREVENTCONFIG_METHOD_2_580C714DA002B6E7_OFFSET UNITYSDK_OFFSET(0x1D28E0D0)
#define RPG_GAMECORE_TRIGGEREVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D28E260)
