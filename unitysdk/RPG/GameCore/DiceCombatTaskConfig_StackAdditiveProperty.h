...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_STACKADDITIVEPROPERTY_METHOD_3_681A4D8C89A8DFA5_OFFSET UNITYSDK_OFFSET(0x196B9E90)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_STACKADDITIVEPROPERTY_METHOD_3_C7B6D31A62E2ED84_OFFSET UNITYSDK_OFFSET(0x196B5200)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_STACKADDITIVEPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x196B51A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_StackAdditiveProperty_TypeDefinitionIndex = 15314;
