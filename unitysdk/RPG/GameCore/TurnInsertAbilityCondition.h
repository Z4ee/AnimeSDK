...
#define RPG_GAMECORE_TURNINSERTABILITYCONDITION_METHOD_3_244014E57B96B86A_OFFSET UNITYSDK_OFFSET(0x190D3400)
#define RPG_GAMECORE_TURNINSERTABILITYCONDITION_METHOD_3_983FEC11F18F0115_OFFSET UNITYSDK_OFFSET(0x190D33C0)
#define RPG_GAMECORE_TURNINSERTABILITYCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x190D33F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TurnInsertAbilityCondition_TypeDefinitionIndex = 17341;
