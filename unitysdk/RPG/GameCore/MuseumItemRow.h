...
#define RPG_GAMECORE_MUSEUMITEMROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B1D8ED0)
#define RPG_GAMECORE_MUSEUMITEMROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1D9470)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MuseumItemRow_TypeDefinitionIndex = 13703;
	...
	public:
		...
		::System::Boolean HideGetHint; // 0x30
		::System::Boolean IsInitial; // 0x31
		...
		::System::UInt32 UnlockPhase; // 0x48
		::System::UInt32 DisplayOrder; // 0x4C
		::RPG::Client::TextID MuseumItemDesc; // 0x50
		::System::UInt32 AreaID; // 0x60
		::System::UInt32 StatsB; // 0x64
