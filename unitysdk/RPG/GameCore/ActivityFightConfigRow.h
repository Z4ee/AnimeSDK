...
#define RPG_GAMECORE_ACTIVITYFIGHTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CD8E930)
#define RPG_GAMECORE_ACTIVITYFIGHTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD8F150)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::System::UInt32 TotalWave; // 0x10
		::System::UInt32 RewardQuest; // 0x14
		::System::UInt32 RoundsLimit; // 0x18
		::RPG::GameCore::LevelDifficulty DifficultyLevel; // 0x1C
		::System::UInt32 RewardID; // 0x20
		::System::UInt32 RewardWave2; // 0x24
