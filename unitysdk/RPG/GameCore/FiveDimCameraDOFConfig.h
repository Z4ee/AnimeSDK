...
#define RPG_GAMECORE_FIVEDIMCAMERADOFCONFIG_METHOD_2_4F22FC7EAFD5F733_OFFSET UNITYSDK_OFFSET(0x171E1110)
#define RPG_GAMECORE_FIVEDIMCAMERADOFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171EB2F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimCameraDOFConfig_TypeDefinitionIndex = 17087;
