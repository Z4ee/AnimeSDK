...
#define RPG_GAMECORE_FIVEDIMCAMERADOFCONFIG_METHOD_2_4F22FC7EAFD5F733_OFFSET UNITYSDK_OFFSET(0x1D0A3DA0)
#define RPG_GAMECORE_FIVEDIMCAMERADOFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0A4CE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimCameraDOFConfig_TypeDefinitionIndex = 18408;
