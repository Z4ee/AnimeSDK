...
#define RPG_GAMECORE_ELFRESTAURANTGAMECONFIG_METHOD_3_826B515FCD9AF002_OFFSET UNITYSDK_OFFSET(0x1889DC90)
#define RPG_GAMECORE_ELFRESTAURANTGAMECONFIG_METHOD_3_912A6E3EC2B14747_OFFSET UNITYSDK_OFFSET(0x1889DCD0)
#define RPG_GAMECORE_ELFRESTAURANTGAMECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1889DCC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfRestaurantGameConfig_TypeDefinitionIndex = 17523;
