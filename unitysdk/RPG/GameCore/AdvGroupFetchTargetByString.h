...
#define RPG_GAMECORE_ADVGROUPFETCHTARGETBYSTRING_METHOD_4_22EC16A4865BC2F7_OFFSET UNITYSDK_OFFSET(0x1CDCBA60)
#define RPG_GAMECORE_ADVGROUPFETCHTARGETBYSTRING_METHOD_4_B18828A6657ACEA8_OFFSET UNITYSDK_OFFSET(0x1CDCBB10)
#define RPG_GAMECORE_ADVGROUPFETCHTARGETBYSTRING_METHOD_4_B542DF814275AC9A_OFFSET UNITYSDK_OFFSET(0x1CDCB9B0)
#define RPG_GAMECORE_ADVGROUPFETCHTARGETBYSTRING_METHOD_4_FBD1146AD75BEFFE_OFFSET UNITYSDK_OFFSET(0x1CDCBAE0)
#define RPG_GAMECORE_ADVGROUPFETCHTARGETBYSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDCBA50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvGroupFetchTargetByString_TypeDefinitionIndex = 20913;
