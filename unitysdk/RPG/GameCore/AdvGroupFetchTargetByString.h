...
#define RPG_GAMECORE_ADVGROUPFETCHTARGETBYSTRING_METHOD_4_22EC16A4865BC2F7_OFFSET UNITYSDK_OFFSET(0x16F311C0)
#define RPG_GAMECORE_ADVGROUPFETCHTARGETBYSTRING_METHOD_4_809BE87F7B53F808_OFFSET UNITYSDK_OFFSET(0x16F31080)
#define RPG_GAMECORE_ADVGROUPFETCHTARGETBYSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x16F31170)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvGroupFetchTargetByString_TypeDefinitionIndex = 19457;
