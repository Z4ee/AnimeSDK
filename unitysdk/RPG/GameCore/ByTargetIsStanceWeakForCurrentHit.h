...
#define RPG_GAMECORE_BYTARGETISSTANCEWEAKFORCURRENTHIT_METHOD_4_B725FE5956ABA819_OFFSET UNITYSDK_OFFSET(0x187612F0)
#define RPG_GAMECORE_BYTARGETISSTANCEWEAKFORCURRENTHIT_METHOD_4_F2E26C7132083FE5_OFFSET UNITYSDK_OFFSET(0x18761220)
#define RPG_GAMECORE_BYTARGETISSTANCEWEAKFORCURRENTHIT__CTOR_OFFSET UNITYSDK_OFFSET(0x187612A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByTargetIsStanceWeakForCurrentHit_TypeDefinitionIndex = 22484;
