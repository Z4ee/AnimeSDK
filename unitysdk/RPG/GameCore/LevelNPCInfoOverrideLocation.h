...
#define RPG_GAMECORE_LEVELNPCINFOOVERRIDELOCATION_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B0769D0)
#define RPG_GAMECORE_LEVELNPCINFOOVERRIDELOCATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B076E30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelNPCInfoOverrideLocation_TypeDefinitionIndex = 16666;
