...
#define RPG_GAMECORE_LOOPWAITSERVERERAFLIPPERREGIONCHANGE_METHOD_3_5A759AF4578EA4EB_OFFSET UNITYSDK_OFFSET(0x18A7ED80)
#define RPG_GAMECORE_LOOPWAITSERVERERAFLIPPERREGIONCHANGE_METHOD_3_B34B87D1BABBDB9B_OFFSET UNITYSDK_OFFSET(0x18A7ECF0)
#define RPG_GAMECORE_LOOPWAITSERVERERAFLIPPERREGIONCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x18A7ED50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoopWaitServerEraFlipperRegionChange_TypeDefinitionIndex = 21225;
