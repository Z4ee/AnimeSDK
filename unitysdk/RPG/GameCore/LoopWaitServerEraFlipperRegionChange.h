...
#define RPG_GAMECORE_LOOPWAITSERVERERAFLIPPERREGIONCHANGE_METHOD_3_5A759AF4578EA4EB_OFFSET UNITYSDK_OFFSET(0x17371170)
#define RPG_GAMECORE_LOOPWAITSERVERERAFLIPPERREGIONCHANGE_METHOD_3_B34B87D1BABBDB9B_OFFSET UNITYSDK_OFFSET(0x173710E0)
#define RPG_GAMECORE_LOOPWAITSERVERERAFLIPPERREGIONCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x17371140)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoopWaitServerEraFlipperRegionChange_TypeDefinitionIndex = 20542;
