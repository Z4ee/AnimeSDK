...
#define RPG_GAMECORE_SHOWREADING_METHOD_3_2E0F76BD1A1A9192_OFFSET UNITYSDK_OFFSET(0x17701BB0)
#define RPG_GAMECORE_SHOWREADING_METHOD_3_987B0F0F0DE22AEB_OFFSET UNITYSDK_OFFSET(0x17701B30)
#define RPG_GAMECORE_SHOWREADING__CTOR_OFFSET UNITYSDK_OFFSET(0x17701B80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowReading_TypeDefinitionIndex = 19217;
