...
#define RPG_GAMECORE_COMPLEXSKILLAIMAPPERBINARY_METHOD_3_9C1396B76C4F8A68_OFFSET UNITYSDK_OFFSET(0x1966B070)
#define RPG_GAMECORE_COMPLEXSKILLAIMAPPERBINARY_METHOD_3_F4790E4C075AFB73_OFFSET UNITYSDK_OFFSET(0x1966B590)
#define RPG_GAMECORE_COMPLEXSKILLAIMAPPERBINARY__CTOR_OFFSET UNITYSDK_OFFSET(0x1966B060)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAIMapperBinary_TypeDefinitionIndex = 14786;
