...
#define RPG_GAMECORE_FATEACTADDMASTERAFFIXBYROUNDCONFIG_METHOD_6_5E7290C5F59FE890_OFFSET UNITYSDK_OFFSET(0x1970B1E0)
#define RPG_GAMECORE_FATEACTADDMASTERAFFIXBYROUNDCONFIG_METHOD_6_C43400FC4FFED0CB_OFFSET UNITYSDK_OFFSET(0x1970B070)
#define RPG_GAMECORE_FATEACTADDMASTERAFFIXBYROUNDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1970B140)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateActAddMasterAffixByRoundConfig_TypeDefinitionIndex = 18250;
