...
#define RPG_GAMECORE_BYENTITYCREATED_METHOD_4_01173AA443286B0E_OFFSET UNITYSDK_OFFSET(0x1A8C0560)
#define RPG_GAMECORE_BYENTITYCREATED_METHOD_4_11612723C649E99F_OFFSET UNITYSDK_OFFSET(0x1A8C0520)
#define RPG_GAMECORE_BYENTITYCREATED_METHOD_4_96A6C328835FC39A_OFFSET UNITYSDK_OFFSET(0x1A8C06F0)
#define RPG_GAMECORE_BYENTITYCREATED_METHOD_4_E283ECEA894AC17D_OFFSET UNITYSDK_OFFSET(0x1A8C0720)
#define RPG_GAMECORE_BYENTITYCREATED__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8C0550)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByEntityCreated_TypeDefinitionIndex = 19942;
