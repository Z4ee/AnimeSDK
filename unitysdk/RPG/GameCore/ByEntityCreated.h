...
#define RPG_GAMECORE_BYENTITYCREATED_METHOD_4_01173AA443286B0E_OFFSET UNITYSDK_OFFSET(0x18746010)
#define RPG_GAMECORE_BYENTITYCREATED_METHOD_4_87C232EA572851E0_OFFSET UNITYSDK_OFFSET(0x18745F40)
#define RPG_GAMECORE_BYENTITYCREATED__CTOR_OFFSET UNITYSDK_OFFSET(0x18745FC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByEntityCreated_TypeDefinitionIndex = 19703;
