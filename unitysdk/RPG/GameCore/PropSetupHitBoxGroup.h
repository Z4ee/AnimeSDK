...
#define RPG_GAMECORE_PROPSETUPHITBOXGROUP_METHOD_3_097B2A4F7E08FE37_OFFSET UNITYSDK_OFFSET(0x18C75E90)
#define RPG_GAMECORE_PROPSETUPHITBOXGROUP_METHOD_3_5207093BA1AB6923_OFFSET UNITYSDK_OFFSET(0x18C75D40)
#define RPG_GAMECORE_PROPSETUPHITBOXGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x18C75E00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropSetupHitBoxGroup_TypeDefinitionIndex = 19341;
