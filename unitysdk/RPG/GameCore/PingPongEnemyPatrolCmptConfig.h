...
#define RPG_GAMECORE_PINGPONGENEMYPATROLCMPTCONFIG_METHOD_3_6C6DDD2755F02F2F_OFFSET UNITYSDK_OFFSET(0x174B0030)
#define RPG_GAMECORE_PINGPONGENEMYPATROLCMPTCONFIG_METHOD_3_7D37B8C78512C910_OFFSET UNITYSDK_OFFSET(0x174B00C0)
#define RPG_GAMECORE_PINGPONGENEMYPATROLCMPTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x174B00A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PingPongEnemyPatrolCmptConfig_TypeDefinitionIndex = 17370;
