...
#define RPG_GAMECORE_PINGPONGENEMYPATROLCMPTCONFIG_METHOD_3_7D37B8C78512C910_OFFSET UNITYSDK_OFFSET(0x1B4C7770)
#define RPG_GAMECORE_PINGPONGENEMYPATROLCMPTCONFIG_METHOD_3_9B06402E974DFC89_OFFSET UNITYSDK_OFFSET(0x1B4C7710)
#define RPG_GAMECORE_PINGPONGENEMYPATROLCMPTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4C7760)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PingPongEnemyPatrolCmptConfig_TypeDefinitionIndex = 18189;
