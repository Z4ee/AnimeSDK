...
#define RPG_GAMECORE_BATTLEPERFORMACTORINIT_METHOD_2_283862E83CB8B530_OFFSET UNITYSDK_OFFSET(0x1B302510)
#define RPG_GAMECORE_BATTLEPERFORMACTORINIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B302660)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattlePerformActorInit_TypeDefinitionIndex = 17933;
