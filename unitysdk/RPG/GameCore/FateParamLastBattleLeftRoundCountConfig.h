...
#define RPG_GAMECORE_FATEPARAMLASTBATTLELEFTROUNDCOUNTCONFIG_METHOD_6_0E08964ED7BCFBFD_OFFSET UNITYSDK_OFFSET(0x1BA74C80)
#define RPG_GAMECORE_FATEPARAMLASTBATTLELEFTROUNDCOUNTCONFIG_METHOD_6_F2F19EDA097B80B9_OFFSET UNITYSDK_OFFSET(0x1BA74C30)
#define RPG_GAMECORE_FATEPARAMLASTBATTLELEFTROUNDCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA74C70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateParamLastBattleLeftRoundCountConfig_TypeDefinitionIndex = 15975;
