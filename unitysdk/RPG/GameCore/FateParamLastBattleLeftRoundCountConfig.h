...
#define RPG_GAMECORE_FATEPARAMLASTBATTLELEFTROUNDCOUNTCONFIG_METHOD_6_0E08964ED7BCFBFD_OFFSET UNITYSDK_OFFSET(0x188D8110)
#define RPG_GAMECORE_FATEPARAMLASTBATTLELEFTROUNDCOUNTCONFIG_METHOD_6_61F6C6D24ACD1AE9_OFFSET UNITYSDK_OFFSET(0x188D7F50)
#define RPG_GAMECORE_FATEPARAMLASTBATTLELEFTROUNDCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x188D8050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateParamLastBattleLeftRoundCountConfig_TypeDefinitionIndex = 15746;
