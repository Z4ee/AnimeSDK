...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEBUFFTYPENUMPARAM_METHOD_4_B24B79FA74F0EA2D_OFFSET UNITYSDK_OFFSET(0x18E269C0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEBUFFTYPENUMPARAM_METHOD_4_D64B2D3F1633E93D_OFFSET UNITYSDK_OFFSET(0x18E26930)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEBUFFTYPENUMPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x18E26990)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRogueBuffTypeNumParam_TypeDefinitionIndex = 20622;
