...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_INITCONSUMNHPUNLIMITEDROLL_METHOD_3_EF60833E159D0CFC_OFFSET UNITYSDK_OFFSET(0x1C118C90)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_INITCONSUMNHPUNLIMITEDROLL_METHOD_3_F365269EB204F283_OFFSET UNITYSDK_OFFSET(0x1C118D90)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_INITCONSUMNHPUNLIMITEDROLL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C118D30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_InitConsumnHPUnlimitedRoll_TypeDefinitionIndex = 15445;
