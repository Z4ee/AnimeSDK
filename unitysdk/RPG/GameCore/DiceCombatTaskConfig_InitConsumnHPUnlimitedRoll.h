...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_INITCONSUMNHPUNLIMITEDROLL_METHOD_3_68A5FAE4BA36052A_OFFSET UNITYSDK_OFFSET(0x196B9130)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_INITCONSUMNHPUNLIMITEDROLL_METHOD_3_F365269EB204F283_OFFSET UNITYSDK_OFFSET(0x196B3280)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_INITCONSUMNHPUNLIMITEDROLL__CTOR_OFFSET UNITYSDK_OFFSET(0x196B31E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_InitConsumnHPUnlimitedRoll_TypeDefinitionIndex = 15281;
