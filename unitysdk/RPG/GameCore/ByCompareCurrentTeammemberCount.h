...
#define RPG_GAMECORE_BYCOMPARECURRENTTEAMMEMBERCOUNT_METHOD_4_3C1541952325B676_OFFSET UNITYSDK_OFFSET(0x1C313030)
#define RPG_GAMECORE_BYCOMPARECURRENTTEAMMEMBERCOUNT_METHOD_4_41D2C302E74A911E_OFFSET UNITYSDK_OFFSET(0x1C313260)
#define RPG_GAMECORE_BYCOMPARECURRENTTEAMMEMBERCOUNT_METHOD_4_7CD3BF9E8802CFA3_OFFSET UNITYSDK_OFFSET(0x1C313070)
#define RPG_GAMECORE_BYCOMPARECURRENTTEAMMEMBERCOUNT_METHOD_4_9E4BF39F0F5B6451_OFFSET UNITYSDK_OFFSET(0x1C313230)
#define RPG_GAMECORE_BYCOMPARECURRENTTEAMMEMBERCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C313060)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareCurrentTeammemberCount_TypeDefinitionIndex = 21432;
