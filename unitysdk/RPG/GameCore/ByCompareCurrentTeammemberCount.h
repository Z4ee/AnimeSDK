...
#define RPG_GAMECORE_BYCOMPARECURRENTTEAMMEMBERCOUNT_METHOD_4_7CD3BF9E8802CFA3_OFFSET UNITYSDK_OFFSET(0x170064D0)
#define RPG_GAMECORE_BYCOMPARECURRENTTEAMMEMBERCOUNT_METHOD_4_E0F4D6F85200C20B_OFFSET UNITYSDK_OFFSET(0x17006400)
#define RPG_GAMECORE_BYCOMPARECURRENTTEAMMEMBERCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x17006480)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareCurrentTeammemberCount_TypeDefinitionIndex = 19844;
