...
#define RPG_GAMECORE_AVATARROWWRAPPEREXTRAPARAM_CREATEGRIDFIGHTDEFAULTPARAM_OFFSET UNITYSDK_OFFSET(0xCD1F180)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AvatarRowWrapperExtraParam_TypeDefinitionIndex = 52789;
