...
#define RPG_GAMECORE_OVERRIDETIMEREWINDSPECULARMATSTYLE_METHOD_3_411DE49520BC0562_OFFSET UNITYSDK_OFFSET(0x17484A00)
#define RPG_GAMECORE_OVERRIDETIMEREWINDSPECULARMATSTYLE_METHOD_3_9947835E4E039C15_OFFSET UNITYSDK_OFFSET(0x17484980)
#define RPG_GAMECORE_OVERRIDETIMEREWINDSPECULARMATSTYLE__CTOR_OFFSET UNITYSDK_OFFSET(0x174849D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OverrideTimeRewindSpecularMatStyle_TypeDefinitionIndex = 18977;
