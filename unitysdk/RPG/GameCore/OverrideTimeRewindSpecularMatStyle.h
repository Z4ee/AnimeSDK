...
#define RPG_GAMECORE_OVERRIDETIMEREWINDSPECULARMATSTYLE_METHOD_3_411DE49520BC0562_OFFSET UNITYSDK_OFFSET(0x199DFD50)
#define RPG_GAMECORE_OVERRIDETIMEREWINDSPECULARMATSTYLE_METHOD_3_9947835E4E039C15_OFFSET UNITYSDK_OFFSET(0x199DFCD0)
#define RPG_GAMECORE_OVERRIDETIMEREWINDSPECULARMATSTYLE__CTOR_OFFSET UNITYSDK_OFFSET(0x199DFD20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OverrideTimeRewindSpecularMatStyle_TypeDefinitionIndex = 19520;
