...
#define RPG_GAMECORE_OVERRIDETIMEREWINDSPECULARMATSTYLE_METHOD_3_411DE49520BC0562_OFFSET UNITYSDK_OFFSET(0x1D305C70)
#define RPG_GAMECORE_OVERRIDETIMEREWINDSPECULARMATSTYLE_METHOD_3_A9CF965C699433DF_OFFSET UNITYSDK_OFFSET(0x1D305C30)
#define RPG_GAMECORE_OVERRIDETIMEREWINDSPECULARMATSTYLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D305C60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OverrideTimeRewindSpecularMatStyle_TypeDefinitionIndex = 20424;
