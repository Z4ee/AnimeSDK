...
#define RPG_GAMECORE_STATETREESTATEBASECONFIG_METHOD_2_B45ADF5E7AE99BA7_OFFSET UNITYSDK_OFFSET(0x1B0BFEE0)
#define RPG_GAMECORE_STATETREESTATEBASECONFIG_METHOD_2_B802D3F6E31D64C9_OFFSET UNITYSDK_OFFSET(0x1B0C0530)
#define RPG_GAMECORE_STATETREESTATEBASECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0BFBA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StateTreeStateBaseConfig_TypeDefinitionIndex = 14886;
