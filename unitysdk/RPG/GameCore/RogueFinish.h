...
#define RPG_GAMECORE_ROGUEFINISH_METHOD_3_7EE8F97E03CF487E_OFFSET UNITYSDK_OFFSET(0x1760A0E0)
#define RPG_GAMECORE_ROGUEFINISH_METHOD_3_882F519678594D6A_OFFSET UNITYSDK_OFFSET(0x1760A1F0)
#define RPG_GAMECORE_ROGUEFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1760A1C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueFinish_TypeDefinitionIndex = 19858;
