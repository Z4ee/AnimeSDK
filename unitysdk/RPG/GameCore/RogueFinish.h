...
#define RPG_GAMECORE_ROGUEFINISH_METHOD_3_882F519678594D6A_OFFSET UNITYSDK_OFFSET(0x1CFAE070)
#define RPG_GAMECORE_ROGUEFINISH_METHOD_3_A3E68E2377B7A507_OFFSET UNITYSDK_OFFSET(0x1CFADFA0)
#define RPG_GAMECORE_ROGUEFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFAE060)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueFinish_TypeDefinitionIndex = 20890;
