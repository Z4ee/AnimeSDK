...
#define RPG_GAMECORE_ROGUEFINISH_METHOD_3_7EE8F97E03CF487E_OFFSET UNITYSDK_OFFSET(0x18D17390)
#define RPG_GAMECORE_ROGUEFINISH_METHOD_3_882F519678594D6A_OFFSET UNITYSDK_OFFSET(0x18D174A0)
#define RPG_GAMECORE_ROGUEFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x18D17470)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueFinish_TypeDefinitionIndex = 20539;
