...
#define RPG_GAMECORE_LEVELCROWDMEMBERINFO_METHOD_2_EA12CEE7070A5564_OFFSET UNITYSDK_OFFSET(0x1D1CB650)
#define RPG_GAMECORE_LEVELCROWDMEMBERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1CBC70)
