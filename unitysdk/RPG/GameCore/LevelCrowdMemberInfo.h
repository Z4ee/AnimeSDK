...
#define RPG_GAMECORE_LEVELCROWDMEMBERINFO_METHOD_2_EA12CEE7070A5564_OFFSET UNITYSDK_OFFSET(0x1B02F6B0)
#define RPG_GAMECORE_LEVELCROWDMEMBERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B02FB50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelCrowdMemberInfo_TypeDefinitionIndex = 16592;
	...
	public:
		...
		::System::Single LocalRotationY; // 0x64
		::RPG::GameCore::LevelNPCPossessionInfo* PossessionConfig; // 0x68
		::Il2CppArray<::RPG::GameCore::LevelNPCPossessionInfo*>* AdditivePossessionInfos; // 0x70
		::RPG::GameCore::LevelNPCUseAnimationType DefaultAnimationType; // 0x78
		::System::UInt32 DefaultIdleFreeStyleMotionID; // 0x7C
		::System::String* DefaultFreeStyleGraph; // 0x80
