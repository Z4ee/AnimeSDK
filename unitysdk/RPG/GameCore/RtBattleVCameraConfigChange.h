...
#define RPG_GAMECORE_RTBATTLEVCAMERACONFIGCHANGE_METHOD_4_86153E941EC50869_OFFSET UNITYSDK_OFFSET(0x19BDE170)
#define RPG_GAMECORE_RTBATTLEVCAMERACONFIGCHANGE_METHOD_4_BAB73C2A8F17EFEF_OFFSET UNITYSDK_OFFSET(0x19BDE0F0)
#define RPG_GAMECORE_RTBATTLEVCAMERACONFIGCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x19BDE140)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtBattleVCameraConfigChange_TypeDefinitionIndex = 22776;
