...
#define RPG_GAMECORE_GLOBALMODIFYINSERTABILITYPRIORITY_METHOD_3_5D68C384ACDB2B19_OFFSET UNITYSDK_OFFSET(0x17248900)
#define RPG_GAMECORE_GLOBALMODIFYINSERTABILITYPRIORITY_METHOD_3_B9F9E929A0771D37_OFFSET UNITYSDK_OFFSET(0x17248980)
#define RPG_GAMECORE_GLOBALMODIFYINSERTABILITYPRIORITY__CTOR_OFFSET UNITYSDK_OFFSET(0x17248950)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GlobalModifyInsertAbilityPriority_TypeDefinitionIndex = 20849;
