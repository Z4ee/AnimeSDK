...
#define RPG_GAMECORE_GLOBALMODIFYINSERTABILITYPRIORITY_METHOD_3_368DF7C41557FED5_OFFSET UNITYSDK_OFFSET(0x1D95AA60)
#define RPG_GAMECORE_GLOBALMODIFYINSERTABILITYPRIORITY_METHOD_3_9FF3B8B8B07C3E22_OFFSET UNITYSDK_OFFSET(0x1D95AA20)
#define RPG_GAMECORE_GLOBALMODIFYINSERTABILITYPRIORITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D95AA50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GlobalModifyInsertAbilityPriority_TypeDefinitionIndex = 22414;
