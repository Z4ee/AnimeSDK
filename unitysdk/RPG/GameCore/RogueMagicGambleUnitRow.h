...
#define RPG_GAMECORE_ROGUEMAGICGAMBLEUNITROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17613A90)
#define RPG_GAMECORE_ROGUEMAGICGAMBLEUNITROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17613C50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueMagicGambleUnitRow_TypeDefinitionIndex = 13623;
