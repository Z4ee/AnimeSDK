...
#define RPG_GAMECORE_ROGUEMAGICGAMBLEUNITROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D3EDF10)
#define RPG_GAMECORE_ROGUEMAGICGAMBLEUNITROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3EE0D0)
