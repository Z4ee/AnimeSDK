...
#define RPG_GAMECORE_CAKERACEMOVESTATECONFIG_METHOD_2_E87AF73473763774_OFFSET UNITYSDK_OFFSET(0x1CF77850)
#define RPG_GAMECORE_CAKERACEMOVESTATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF77B30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceMoveStateConfig_TypeDefinitionIndex = 18198;
