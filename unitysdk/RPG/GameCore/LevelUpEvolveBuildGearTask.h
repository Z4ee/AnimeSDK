...
#define RPG_GAMECORE_LEVELUPEVOLVEBUILDGEARTASK_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x18FEFFE0)
#define RPG_GAMECORE_LEVELUPEVOLVEBUILDGEARTASK__CTOR_OFFSET UNITYSDK_OFFSET(0x18FEFFB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelUpEvolveBuildGearTask_TypeDefinitionIndex = 55341;
