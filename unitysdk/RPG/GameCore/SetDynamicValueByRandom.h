...
#define RPG_GAMECORE_SETDYNAMICVALUEBYRANDOM_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x176C3180)
#define RPG_GAMECORE_SETDYNAMICVALUEBYRANDOM_METHOD_4_90F561B106F30766_OFFSET UNITYSDK_OFFSET(0x176C3100)
#define RPG_GAMECORE_SETDYNAMICVALUEBYRANDOM_METHOD_4_C2DB25C86BAFAF87_OFFSET UNITYSDK_OFFSET(0x176BF410)
#define RPG_GAMECORE_SETDYNAMICVALUEBYRANDOM__CTOR_OFFSET UNITYSDK_OFFSET(0x176BF3C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRandom_TypeDefinitionIndex = 22107;
