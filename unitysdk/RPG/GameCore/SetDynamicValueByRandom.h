...
#define RPG_GAMECORE_SETDYNAMICVALUEBYRANDOM_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x19C43130)
#define RPG_GAMECORE_SETDYNAMICVALUEBYRANDOM_METHOD_4_90F561B106F30766_OFFSET UNITYSDK_OFFSET(0x19C430B0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYRANDOM_METHOD_4_C2DB25C86BAFAF87_OFFSET UNITYSDK_OFFSET(0x19C3E640)
#define RPG_GAMECORE_SETDYNAMICVALUEBYRANDOM__CTOR_OFFSET UNITYSDK_OFFSET(0x19C3E5F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRandom_TypeDefinitionIndex = 22528;
