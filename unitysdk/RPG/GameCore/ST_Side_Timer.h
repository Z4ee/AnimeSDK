...
#define RPG_GAMECORE_ST_SIDE_TIMER_METHOD_4_382EAB24255812C8_OFFSET UNITYSDK_OFFSET(0x18DFC0F0)
#define RPG_GAMECORE_ST_SIDE_TIMER_METHOD_4_F6A121ACB11FCD22_OFFSET UNITYSDK_OFFSET(0x18DFC1C0)
#define RPG_GAMECORE_ST_SIDE_TIMER__CTOR_OFFSET UNITYSDK_OFFSET(0x18DFC170)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_Timer_TypeDefinitionIndex = 19085;
