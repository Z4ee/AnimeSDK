...
#define RPG_GAMECORE_LEVELGROUPMAINMISSIONISSUEPATCH_METHOD_2_55D8A31A8598B6A5_OFFSET UNITYSDK_OFFSET(0x1C118680)
#define RPG_GAMECORE_LEVELGROUPMAINMISSIONISSUEPATCH__CTOR_OFFSET UNITYSDK_OFFSET(0x1C118820)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelGroupMainMissionIssuePatch_TypeDefinitionIndex = 17170;
