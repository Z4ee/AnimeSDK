...
#define RPG_GAMECORE_GRIDFIGHTSEASONCRAFTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x172815D0)
#define RPG_GAMECORE_GRIDFIGHTSEASONCRAFTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x172816F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightSeasonCraftConfigRow_TypeDefinitionIndex = 12306;
