...
#define RPG_GAMECORE_CHIMERABATTLECHECKWORKFINISH_METHOD_3_21F860E34BDA1993_OFFSET UNITYSDK_OFFSET(0x17094430)
#define RPG_GAMECORE_CHIMERABATTLECHECKWORKFINISH_METHOD_3_8DC9719876A59831_OFFSET UNITYSDK_OFFSET(0x17092990)
#define RPG_GAMECORE_CHIMERABATTLECHECKWORKFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x17092980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraBattleCheckWorkFinish_TypeDefinitionIndex = 14566;
