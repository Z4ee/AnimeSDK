...
#define RPG_GAMECORE_CHIMERABATTLECHECKWORKFINISH_METHOD_3_21F860E34BDA1993_OFFSET UNITYSDK_OFFSET(0x187F37E0)
#define RPG_GAMECORE_CHIMERABATTLECHECKWORKFINISH_METHOD_3_8DC9719876A59831_OFFSET UNITYSDK_OFFSET(0x187F1D40)
#define RPG_GAMECORE_CHIMERABATTLECHECKWORKFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x187F1D30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraBattleCheckWorkFinish_TypeDefinitionIndex = 15036;
