...
#define RPG_GAMECORE_COMPLEXSKILLAICONFIGEX_METHOD_2_FE4342EBEB1159F2_OFFSET UNITYSDK_OFFSET(0x18828BB0)
#define RPG_GAMECORE_COMPLEXSKILLAICONFIGEX__CTOR_OFFSET UNITYSDK_OFFSET(0x18828D50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAIConfigEx_TypeDefinitionIndex = 16780;
