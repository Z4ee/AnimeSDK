...
#define RPG_GAMECORE_COMPLEXSKILLAICONFIGEX_METHOD_2_FE4342EBEB1159F2_OFFSET UNITYSDK_OFFSET(0x1CFF13B0)
#define RPG_GAMECORE_COMPLEXSKILLAICONFIGEX__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFF1550)
