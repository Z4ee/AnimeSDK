...
#define RPG_GAMECORE_NOTIFYDEADPARTSELECTED_METHOD_3_990292D7301A0589_OFFSET UNITYSDK_OFFSET(0x18BBE890)
#define RPG_GAMECORE_NOTIFYDEADPARTSELECTED_METHOD_3_99ED26214CD7DAD5_OFFSET UNITYSDK_OFFSET(0x18BBE810)
#define RPG_GAMECORE_NOTIFYDEADPARTSELECTED__CTOR_OFFSET UNITYSDK_OFFSET(0x18BBE860)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NotifyDeadPartSelected_TypeDefinitionIndex = 22220;
