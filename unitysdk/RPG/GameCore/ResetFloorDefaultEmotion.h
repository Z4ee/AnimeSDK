...
#define RPG_GAMECORE_RESETFLOORDEFAULTEMOTION_METHOD_3_CC5F3F63D2C95D7F_OFFSET UNITYSDK_OFFSET(0x1D01B910)
#define RPG_GAMECORE_RESETFLOORDEFAULTEMOTION_METHOD_3_F2288BD80A432842_OFFSET UNITYSDK_OFFSET(0x1D01B9E0)
#define RPG_GAMECORE_RESETFLOORDEFAULTEMOTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D01B9D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetFloorDefaultEmotion_TypeDefinitionIndex = 20478;
