...
#define RPG_GAMECORE_RESETFLOORDEFAULTEMOTION_METHOD_3_CE7F7A93933BD796_OFFSET UNITYSDK_OFFSET(0x19ACEF10)
#define RPG_GAMECORE_RESETFLOORDEFAULTEMOTION_METHOD_3_F2288BD80A432842_OFFSET UNITYSDK_OFFSET(0x19ACF020)
#define RPG_GAMECORE_RESETFLOORDEFAULTEMOTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19ACEFF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetFloorDefaultEmotion_TypeDefinitionIndex = 20106;
