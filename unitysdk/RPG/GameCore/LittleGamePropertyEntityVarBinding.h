...
#define RPG_GAMECORE_LITTLEGAMEPROPERTYENTITYVARBINDING_METHOD_2_162A310CD7E59D32_OFFSET UNITYSDK_OFFSET(0x1DD6D520)
#define RPG_GAMECORE_LITTLEGAMEPROPERTYENTITYVARBINDING__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD6D560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGamePropertyEntityVarBinding_TypeDefinitionIndex = 18703;
