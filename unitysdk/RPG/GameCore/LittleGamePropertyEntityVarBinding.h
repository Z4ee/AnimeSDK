...
#define RPG_GAMECORE_LITTLEGAMEPROPERTYENTITYVARBINDING_METHOD_2_162A310CD7E59D32_OFFSET UNITYSDK_OFFSET(0x198A1780)
#define RPG_GAMECORE_LITTLEGAMEPROPERTYENTITYVARBINDING__CTOR_OFFSET UNITYSDK_OFFSET(0x198A17C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGamePropertyEntityVarBinding_TypeDefinitionIndex = 17995;
