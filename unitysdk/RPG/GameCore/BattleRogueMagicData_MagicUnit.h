...
#define RPG_GAMECORE_BATTLEROGUEMAGICDATA_MAGICUNIT_DEEPCLONE_OFFSET UNITYSDK_OFFSET(0x12173250)
#define RPG_GAMECORE_BATTLEROGUEMAGICDATA_MAGICUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0x12173330)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleRogueMagicData_MagicUnit_TypeDefinitionIndex = 53784;
