...
#define RPG_GAMECORE_BATTLEROGUEMAGICDATA_MAGICUNIT_DEEPCLONE_OFFSET UNITYSDK_OFFSET(0x1B6349C0)
#define RPG_GAMECORE_BATTLEROGUEMAGICDATA_MAGICUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B634AA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleRogueMagicData_MagicUnit_TypeDefinitionIndex = 56504;
