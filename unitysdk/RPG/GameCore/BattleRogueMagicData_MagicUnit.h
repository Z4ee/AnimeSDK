...
#define RPG_GAMECORE_BATTLEROGUEMAGICDATA_MAGICUNIT_DEEPCLONE_OFFSET UNITYSDK_OFFSET(0xCD383C0)
#define RPG_GAMECORE_BATTLEROGUEMAGICDATA_MAGICUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0xCD384A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleRogueMagicData_MagicUnit_TypeDefinitionIndex = 52580;
	...
	public:
		...
		::System::UInt32 MagicUnitID; // 0x20
		::System::Boolean Locked; // 0x24
