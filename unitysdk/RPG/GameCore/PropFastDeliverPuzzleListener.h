...
#define RPG_GAMECORE_PROPFASTDELIVERPUZZLELISTENER_METHOD_3_2EF7F0CDED577361_OFFSET UNITYSDK_OFFSET(0x1D17B8F0)
#define RPG_GAMECORE_PROPFASTDELIVERPUZZLELISTENER_METHOD_3_732E49F1C267C9A2_OFFSET UNITYSDK_OFFSET(0x1D17B870)
#define RPG_GAMECORE_PROPFASTDELIVERPUZZLELISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D17B8C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropFastDeliverPuzzleListener_TypeDefinitionIndex = 21900;
