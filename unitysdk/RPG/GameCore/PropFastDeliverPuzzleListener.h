...
#define RPG_GAMECORE_PROPFASTDELIVERPUZZLELISTENER_METHOD_3_5FC9989F26B920C6_OFFSET UNITYSDK_OFFSET(0x1751DF50)
#define RPG_GAMECORE_PROPFASTDELIVERPUZZLELISTENER_METHOD_3_732E49F1C267C9A2_OFFSET UNITYSDK_OFFSET(0x1751DE00)
#define RPG_GAMECORE_PROPFASTDELIVERPUZZLELISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1751DEC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropFastDeliverPuzzleListener_TypeDefinitionIndex = 20333;
