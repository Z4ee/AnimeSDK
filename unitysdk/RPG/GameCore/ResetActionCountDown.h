...
#define RPG_GAMECORE_RESETACTIONCOUNTDOWN_METHOD_3_9A2CFD15D6F8BE73_OFFSET UNITYSDK_OFFSET(0x19ACDAF0)
#define RPG_GAMECORE_RESETACTIONCOUNTDOWN_METHOD_3_D8BBB7998043DCB5_OFFSET UNITYSDK_OFFSET(0x19ACDB70)
#define RPG_GAMECORE_RESETACTIONCOUNTDOWN__CTOR_OFFSET UNITYSDK_OFFSET(0x19ACDB40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetActionCountDown_TypeDefinitionIndex = 22401;
