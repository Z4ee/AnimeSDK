...
#define RPG_GAMECORE_RESETACTIONCOUNTDOWN_METHOD_3_D0DC186D7D594916_OFFSET UNITYSDK_OFFSET(0x1D01A770)
#define RPG_GAMECORE_RESETACTIONCOUNTDOWN_METHOD_3_D8BBB7998043DCB5_OFFSET UNITYSDK_OFFSET(0x1D01A7B0)
#define RPG_GAMECORE_RESETACTIONCOUNTDOWN__CTOR_OFFSET UNITYSDK_OFFSET(0x1D01A7A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetActionCountDown_TypeDefinitionIndex = 22843;
