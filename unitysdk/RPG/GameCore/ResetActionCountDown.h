...
#define RPG_GAMECORE_RESETACTIONCOUNTDOWN_METHOD_3_9A2CFD15D6F8BE73_OFFSET UNITYSDK_OFFSET(0x18CA90F0)
#define RPG_GAMECORE_RESETACTIONCOUNTDOWN_METHOD_3_D8BBB7998043DCB5_OFFSET UNITYSDK_OFFSET(0x18CA9170)
#define RPG_GAMECORE_RESETACTIONCOUNTDOWN__CTOR_OFFSET UNITYSDK_OFFSET(0x18CA9140)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetActionCountDown_TypeDefinitionIndex = 22686;
