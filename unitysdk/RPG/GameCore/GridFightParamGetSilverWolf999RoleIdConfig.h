...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETSILVERWOLF999ROLEIDCONFIG_METHOD_6_1FE55AF2A7755C5A_OFFSET UNITYSDK_OFFSET(0x1D15DCA0)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETSILVERWOLF999ROLEIDCONFIG_METHOD_6_B0B0514E735954B6_OFFSET UNITYSDK_OFFSET(0x1D15DCF0)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETSILVERWOLF999ROLEIDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D15DCE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightParamGetSilverWolf999RoleIdConfig_TypeDefinitionIndex = 19321;
