...
#define RPG_GAMECORE_TARGETFETCHADVLINEUP_METHOD_4_1D16703FADC2ED58_OFFSET UNITYSDK_OFFSET(0x1E167600)
#define RPG_GAMECORE_TARGETFETCHADVLINEUP_METHOD_4_7B8B6759E625362D_OFFSET UNITYSDK_OFFSET(0x1E167660)
#define RPG_GAMECORE_TARGETFETCHADVLINEUP_METHOD_4_90F41F38147C10E0_OFFSET UNITYSDK_OFFSET(0x1E167680)
#define RPG_GAMECORE_TARGETFETCHADVLINEUP_METHOD_4_F4BB4FC9958C5ABD_OFFSET UNITYSDK_OFFSET(0x1E167580)
#define RPG_GAMECORE_TARGETFETCHADVLINEUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1675F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchAdvLineup_TypeDefinitionIndex = 23651;
