...
#define RPG_GAMECORE_TARGETFETCHADVLINEUP_METHOD_4_1D16703FADC2ED58_OFFSET UNITYSDK_OFFSET(0x18ED8890)
#define RPG_GAMECORE_TARGETFETCHADVLINEUP_METHOD_4_739C5F9466D3A02A_OFFSET UNITYSDK_OFFSET(0x18EE1DF0)
#define RPG_GAMECORE_TARGETFETCHADVLINEUP__CTOR_OFFSET UNITYSDK_OFFSET(0x18ED8840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchAdvLineup_TypeDefinitionIndex = 22917;
