...
#define RPG_GAMECORE_ITEMUSEDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x198673D0)
#define RPG_GAMECORE_ITEMUSEDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19867A80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ItemUseDataRow_TypeDefinitionIndex = 13225;
