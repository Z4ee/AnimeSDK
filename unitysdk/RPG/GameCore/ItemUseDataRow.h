...
#define RPG_GAMECORE_ITEMUSEDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17328760)
#define RPG_GAMECORE_ITEMUSEDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17328DF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ItemUseDataRow_TypeDefinitionIndex = 12678;
