...
#define RPG_GAMECORE_TARGETSORTBYDEATHORDER_METHOD_3_40854B8CE02E2A76_OFFSET UNITYSDK_OFFSET(0x18EF9070)
#define RPG_GAMECORE_TARGETSORTBYDEATHORDER_METHOD_3_F993ADA5A7248719_OFFSET UNITYSDK_OFFSET(0x18EF7100)
#define RPG_GAMECORE_TARGETSORTBYDEATHORDER__CTOR_OFFSET UNITYSDK_OFFSET(0x18EF70E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetSortByDeathOrder_TypeDefinitionIndex = 22976;
