...
#define RPG_GAMECORE_TARGETSORTBYDEATHORDER_METHOD_3_58ED3877714F26E5_OFFSET UNITYSDK_OFFSET(0x1D0C6AA0)
#define RPG_GAMECORE_TARGETSORTBYDEATHORDER_METHOD_3_D1BFBC38EC16F879_OFFSET UNITYSDK_OFFSET(0x1D0C6C70)
#define RPG_GAMECORE_TARGETSORTBYDEATHORDER_METHOD_3_E88D38283B98E861_OFFSET UNITYSDK_OFFSET(0x1D0C6CC0)
#define RPG_GAMECORE_TARGETSORTBYDEATHORDER_METHOD_3_F993ADA5A7248719_OFFSET UNITYSDK_OFFSET(0x1D0C6BB0)
#define RPG_GAMECORE_TARGETSORTBYDEATHORDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0C6BA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetSortByDeathOrder_TypeDefinitionIndex = 23130;
