...
#define RPG_GAMECORE_GROUPINITMEMBERENTITYDYNAMICVALUES_METHOD_3_AED621599B58995E_OFFSET UNITYSDK_OFFSET(0x189E0C10)
#define RPG_GAMECORE_GROUPINITMEMBERENTITYDYNAMICVALUES_METHOD_3_F3F307980CE84272_OFFSET UNITYSDK_OFFSET(0x189E0B90)
#define RPG_GAMECORE_GROUPINITMEMBERENTITYDYNAMICVALUES__CTOR_OFFSET UNITYSDK_OFFSET(0x189E0BE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GroupInitMemberEntityDynamicValues_TypeDefinitionIndex = 19712;
