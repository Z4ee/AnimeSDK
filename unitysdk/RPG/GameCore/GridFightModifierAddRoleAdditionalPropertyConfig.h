...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDROLEADDITIONALPROPERTYCONFIG_METHOD_3_A6FEA2F646093703_OFFSET UNITYSDK_OFFSET(0x189B1370)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDROLEADDITIONALPROPERTYCONFIG_METHOD_3_B1B11D5097703B4A_OFFSET UNITYSDK_OFFSET(0x189B12A0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDROLEADDITIONALPROPERTYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189B1320)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierAddRoleAdditionalPropertyConfig_TypeDefinitionIndex = 18409;
