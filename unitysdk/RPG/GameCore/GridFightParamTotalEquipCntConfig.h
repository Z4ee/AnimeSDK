...
#define RPG_GAMECORE_GRIDFIGHTPARAMTOTALEQUIPCNTCONFIG_METHOD_6_085C62BC458ADDC6_OFFSET UNITYSDK_OFFSET(0x1D06E320)
#define RPG_GAMECORE_GRIDFIGHTPARAMTOTALEQUIPCNTCONFIG_METHOD_6_FBA42590AFEB836A_OFFSET UNITYSDK_OFFSET(0x1D06E2D0)
#define RPG_GAMECORE_GRIDFIGHTPARAMTOTALEQUIPCNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D06E310)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightParamTotalEquipCntConfig_TypeDefinitionIndex = 18761;
