...
#define RPG_GAMECORE_BYCHECKMODIFIERCALLBACKBEHAVIORFLAG_METHOD_4_6A5A35211FE4EA76_OFFSET UNITYSDK_OFFSET(0x16FFF320)
#define RPG_GAMECORE_BYCHECKMODIFIERCALLBACKBEHAVIORFLAG_METHOD_4_EA607033C6FD974D_OFFSET UNITYSDK_OFFSET(0x16FFF440)
#define RPG_GAMECORE_BYCHECKMODIFIERCALLBACKBEHAVIORFLAG__CTOR_OFFSET UNITYSDK_OFFSET(0x16FFF3C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckModifierCallBackBehaviorFlag_TypeDefinitionIndex = 21729;
