...
#define RPG_GAMECORE_BYCHECKMODIFIERCALLBACKBEHAVIORFLAG_METHOD_4_6A5A35211FE4EA76_OFFSET UNITYSDK_OFFSET(0x187235A0)
#define RPG_GAMECORE_BYCHECKMODIFIERCALLBACKBEHAVIORFLAG_METHOD_4_EA607033C6FD974D_OFFSET UNITYSDK_OFFSET(0x187236C0)
#define RPG_GAMECORE_BYCHECKMODIFIERCALLBACKBEHAVIORFLAG__CTOR_OFFSET UNITYSDK_OFFSET(0x18723640)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckModifierCallBackBehaviorFlag_TypeDefinitionIndex = 22467;
