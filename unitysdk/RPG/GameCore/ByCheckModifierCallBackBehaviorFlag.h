...
#define RPG_GAMECORE_BYCHECKMODIFIERCALLBACKBEHAVIORFLAG_METHOD_4_49485233C001BFB8_OFFSET UNITYSDK_OFFSET(0x1CEA89A0)
#define RPG_GAMECORE_BYCHECKMODIFIERCALLBACKBEHAVIORFLAG_METHOD_4_A688583EDE874B86_OFFSET UNITYSDK_OFFSET(0x1CEA8C10)
#define RPG_GAMECORE_BYCHECKMODIFIERCALLBACKBEHAVIORFLAG_METHOD_4_C505EF9BD15D22CB_OFFSET UNITYSDK_OFFSET(0x1CEA8C70)
#define RPG_GAMECORE_BYCHECKMODIFIERCALLBACKBEHAVIORFLAG_METHOD_4_EA607033C6FD974D_OFFSET UNITYSDK_OFFSET(0x1CEA8A40)
#define RPG_GAMECORE_BYCHECKMODIFIERCALLBACKBEHAVIORFLAG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEA8A00)
