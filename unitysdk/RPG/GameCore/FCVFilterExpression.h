...
#define RPG_GAMECORE_FCVFILTEREXPRESSION_METHOD_2_0BC3BDAA6F437B8C_OFFSET UNITYSDK_OFFSET(0x171BBE70)
#define RPG_GAMECORE_FCVFILTEREXPRESSION_METHOD_2_5C3E85EEFDF5174F_OFFSET UNITYSDK_OFFSET(0x171BBFB0)
#define RPG_GAMECORE_FCVFILTEREXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x171BBFA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FCVFilterExpression_TypeDefinitionIndex = 15983;
