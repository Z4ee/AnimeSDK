...
#define RPG_GAMECORE_WAITROGUEROOMCONTENTUPDATEFINISH_METHOD_3_08DD46527C11EEFE_OFFSET UNITYSDK_OFFSET(0x1D1BADD0)
#define RPG_GAMECORE_WAITROGUEROOMCONTENTUPDATEFINISH_METHOD_3_0FE51C3D1A5882BA_OFFSET UNITYSDK_OFFSET(0x1D1BAE20)
#define RPG_GAMECORE_WAITROGUEROOMCONTENTUPDATEFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1BAE10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitRogueRoomContentUpdateFinish_TypeDefinitionIndex = 20029;
