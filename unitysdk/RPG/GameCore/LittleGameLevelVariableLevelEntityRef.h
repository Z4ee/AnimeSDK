...
#define RPG_GAMECORE_LITTLEGAMELEVELVARIABLELEVELENTITYREF_METHOD_3_01715A719B23DBFF_OFFSET UNITYSDK_OFFSET(0x1735F8B0)
#define RPG_GAMECORE_LITTLEGAMELEVELVARIABLELEVELENTITYREF_METHOD_3_9169AB88CCC9B710_OFFSET UNITYSDK_OFFSET(0x1735F1C0)
#define RPG_GAMECORE_LITTLEGAMELEVELVARIABLELEVELENTITYREF__CTOR_OFFSET UNITYSDK_OFFSET(0x1735F1B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameLevelVariableLevelEntityRef_TypeDefinitionIndex = 17336;
