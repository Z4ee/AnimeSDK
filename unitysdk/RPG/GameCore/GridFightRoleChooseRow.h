...
#define RPG_GAMECORE_GRIDFIGHTROLECHOOSEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D162240)
#define RPG_GAMECORE_GRIDFIGHTROLECHOOSEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D162480)
