...
#define RPG_GAMECORE_GRIDFIGHTACTIONROLLNPCDRESSEDEQUIPCONFIG_METHOD_6_1452E3AAB6AA8E12_OFFSET UNITYSDK_OFFSET(0x1C5C1BD0)
#define RPG_GAMECORE_GRIDFIGHTACTIONROLLNPCDRESSEDEQUIPCONFIG_METHOD_6_DAB7E5A7839347B6_OFFSET UNITYSDK_OFFSET(0x1C5C1FB0)
#define RPG_GAMECORE_GRIDFIGHTACTIONROLLNPCDRESSEDEQUIPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5C1BC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightActionRollNpcDressedEquipConfig_TypeDefinitionIndex = 18562;
