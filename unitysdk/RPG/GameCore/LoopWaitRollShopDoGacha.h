...
#define RPG_GAMECORE_LOOPWAITROLLSHOPDOGACHA_METHOD_3_BACD8976E7A6F946_OFFSET UNITYSDK_OFFSET(0x18A7EC40)
#define RPG_GAMECORE_LOOPWAITROLLSHOPDOGACHA_METHOD_3_D4CB801DCBC4AB06_OFFSET UNITYSDK_OFFSET(0x18A7EBB0)
#define RPG_GAMECORE_LOOPWAITROLLSHOPDOGACHA__CTOR_OFFSET UNITYSDK_OFFSET(0x18A7EC10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoopWaitRollShopDoGacha_TypeDefinitionIndex = 20187;
