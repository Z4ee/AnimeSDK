...
#define RPG_GAMECORE_HELIOBUSTEMPLATEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B681270)
#define RPG_GAMECORE_HELIOBUSTEMPLATEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B681A30)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 PostImgID; // 0x24
		::RPG::Client::TextID HeliobusTemplateContent; // 0x28
		::System::UInt32 HeliobusTemplateID; // 0x38
