...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDNPCANDUNDRESSEQUIPCONFIG_METHOD_3_09A5FFFB6EF75C08_OFFSET UNITYSDK_OFFSET(0x197E8C50)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDNPCANDUNDRESSEQUIPCONFIG_METHOD_3_B10747706E5463E1_OFFSET UNITYSDK_OFFSET(0x197E8D20)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDNPCANDUNDRESSEQUIPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197E8CD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierAddNpcAndUnDressEquipConfig_TypeDefinitionIndex = 18426;
