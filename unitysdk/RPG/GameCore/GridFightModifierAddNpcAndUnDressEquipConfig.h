...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDNPCANDUNDRESSEQUIPCONFIG_METHOD_3_B10747706E5463E1_OFFSET UNITYSDK_OFFSET(0x1EE6C560)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDNPCANDUNDRESSEQUIPCONFIG_METHOD_3_B10F52ABD77DE0BD_OFFSET UNITYSDK_OFFSET(0x1EE6C510)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDNPCANDUNDRESSEQUIPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EE6C550)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierAddNpcAndUnDressEquipConfig_TypeDefinitionIndex = 19199;
