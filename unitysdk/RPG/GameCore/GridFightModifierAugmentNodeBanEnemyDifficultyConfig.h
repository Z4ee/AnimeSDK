...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERAUGMENTNODEBANENEMYDIFFICULTYCONFIG_METHOD_3_61AA773987A237A0_OFFSET UNITYSDK_OFFSET(0x189B1A80)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERAUGMENTNODEBANENEMYDIFFICULTYCONFIG_METHOD_3_91661038F3B59379_OFFSET UNITYSDK_OFFSET(0x189B1B50)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERAUGMENTNODEBANENEMYDIFFICULTYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189B1B00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierAugmentNodeBanEnemyDifficultyConfig_TypeDefinitionIndex = 18509;
