...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERAUGMENTNODEBANENEMYDIFFICULTYCONFIG_METHOD_3_2350B4B24D25CD75_OFFSET UNITYSDK_OFFSET(0x1C5D0450)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERAUGMENTNODEBANENEMYDIFFICULTYCONFIG_METHOD_3_91661038F3B59379_OFFSET UNITYSDK_OFFSET(0x1C5D04A0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERAUGMENTNODEBANENEMYDIFFICULTYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5D0490)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierAugmentNodeBanEnemyDifficultyConfig_TypeDefinitionIndex = 18731;
