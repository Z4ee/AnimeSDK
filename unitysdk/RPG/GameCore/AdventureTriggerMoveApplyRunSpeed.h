...
#define RPG_GAMECORE_ADVENTURETRIGGERMOVEAPPLYRUNSPEED_METHOD_4_2099DCC5F78CA267_OFFSET UNITYSDK_OFFSET(0x19456800)
#define RPG_GAMECORE_ADVENTURETRIGGERMOVEAPPLYRUNSPEED_METHOD_4_342A376F07FCCBEF_OFFSET UNITYSDK_OFFSET(0x19456D90)
#define RPG_GAMECORE_ADVENTURETRIGGERMOVEAPPLYRUNSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x19456780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureTriggerMoveApplyRunSpeed_TypeDefinitionIndex = 19052;
