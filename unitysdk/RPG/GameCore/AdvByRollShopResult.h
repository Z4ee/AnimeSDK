...
#define RPG_GAMECORE_ADVBYROLLSHOPRESULT_METHOD_4_5FC216021C221283_OFFSET UNITYSDK_OFFSET(0x16F27EF0)
#define RPG_GAMECORE_ADVBYROLLSHOPRESULT_METHOD_4_9D89A1907B04791F_OFFSET UNITYSDK_OFFSET(0x16F27FC0)
#define RPG_GAMECORE_ADVBYROLLSHOPRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x16F27F70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvByRollShopResult_TypeDefinitionIndex = 18882;
