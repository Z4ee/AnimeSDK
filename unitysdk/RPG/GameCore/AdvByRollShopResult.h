...
#define RPG_GAMECORE_ADVBYROLLSHOPRESULT_METHOD_4_2208EF868517E282_OFFSET UNITYSDK_OFFSET(0x1CDC2D50)
#define RPG_GAMECORE_ADVBYROLLSHOPRESULT_METHOD_4_85110813AA8261E4_OFFSET UNITYSDK_OFFSET(0x1CDC2FC0)
#define RPG_GAMECORE_ADVBYROLLSHOPRESULT_METHOD_4_9D89A1907B04791F_OFFSET UNITYSDK_OFFSET(0x1CDC2D90)
#define RPG_GAMECORE_ADVBYROLLSHOPRESULT_METHOD_4_DC5F3D5F3A007D4A_OFFSET UNITYSDK_OFFSET(0x1CDC2F90)
#define RPG_GAMECORE_ADVBYROLLSHOPRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDC2D80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvByRollShopResult_TypeDefinitionIndex = 20336;
