...
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEWEAKNESSCOMPARE_METHOD_3_1DBE99E1EC4EBCF3_OFFSET UNITYSDK_OFFSET(0x1966F280)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEWEAKNESSCOMPARE_METHOD_3_23AF7C186943A0FC_OFFSET UNITYSDK_OFFSET(0x196704B0)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEWEAKNESSCOMPARE__CTOR_OFFSET UNITYSDK_OFFSET(0x1966F260)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAISourceWeaknessCompare_TypeDefinitionIndex = 14755;
