...
#define RPG_GAMECORE_FIVEDIMSTATISTICGETTRAINENERGYACTION_METHOD_3_333D9934F8A04E12_OFFSET UNITYSDK_OFFSET(0x1BEB5740)
#define RPG_GAMECORE_FIVEDIMSTATISTICGETTRAINENERGYACTION_METHOD_3_4A6E36A13DC06813_OFFSET UNITYSDK_OFFSET(0x1BEB56C0)
#define RPG_GAMECORE_FIVEDIMSTATISTICGETTRAINENERGYACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEB5730)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimStatisticGetTrainEnergyAction_TypeDefinitionIndex = 18025;
