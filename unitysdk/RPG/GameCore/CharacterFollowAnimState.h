...
#define RPG_GAMECORE_CHARACTERFOLLOWANIMSTATE_METHOD_3_6E86EF8079227C5A_OFFSET UNITYSDK_OFFSET(0x1CF96940)
#define RPG_GAMECORE_CHARACTERFOLLOWANIMSTATE_METHOD_3_CAB4D293BCDBDF56_OFFSET UNITYSDK_OFFSET(0x1CF968F0)
#define RPG_GAMECORE_CHARACTERFOLLOWANIMSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF96930)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterFollowAnimState_TypeDefinitionIndex = 22177;
