...
#define RPG_GAMECORE_CHARACTERFOLLOWANIMSTATE_METHOD_3_2149400B6E9319C1_OFFSET UNITYSDK_OFFSET(0x187D1600)
#define RPG_GAMECORE_CHARACTERFOLLOWANIMSTATE_METHOD_3_6E86EF8079227C5A_OFFSET UNITYSDK_OFFSET(0x187D1690)
#define RPG_GAMECORE_CHARACTERFOLLOWANIMSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x187D1660)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterFollowAnimState_TypeDefinitionIndex = 21303;
