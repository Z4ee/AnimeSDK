...
#define RPG_GAMECORE_FIVEDIMFLOATINGSPIRITBAKEDMOVECONFIG_METHOD_3_29F7CC2D03F1111B_OFFSET UNITYSDK_OFFSET(0x171F1FD0)
#define RPG_GAMECORE_FIVEDIMFLOATINGSPIRITBAKEDMOVECONFIG_METHOD_3_5C6F160E4A5A76BE_OFFSET UNITYSDK_OFFSET(0x171F1F90)
#define RPG_GAMECORE_FIVEDIMFLOATINGSPIRITBAKEDMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171F1FC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimFloatingSpiritBakedMoveConfig_TypeDefinitionIndex = 15285;
