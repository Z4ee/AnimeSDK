...
#define RPG_GAMECORE_FIVEDIMFLOATINGSPIRITBAKEDMOVECONFIG_METHOD_3_29F7CC2D03F1111B_OFFSET UNITYSDK_OFFSET(0x1D0E5A70)
#define RPG_GAMECORE_FIVEDIMFLOATINGSPIRITBAKEDMOVECONFIG_METHOD_3_5C6F160E4A5A76BE_OFFSET UNITYSDK_OFFSET(0x1D0E5A30)
#define RPG_GAMECORE_FIVEDIMFLOATINGSPIRITBAKEDMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0E5A60)
