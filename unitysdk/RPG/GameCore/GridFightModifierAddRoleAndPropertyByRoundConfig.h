...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDROLEANDPROPERTYBYROUNDCONFIG_METHOD_3_32BD01B5E5E60E0C_OFFSET UNITYSDK_OFFSET(0x197E90A0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDROLEANDPROPERTYBYROUNDCONFIG_METHOD_3_7E85B1EE44B7C555_OFFSET UNITYSDK_OFFSET(0x197E8FD0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDROLEANDPROPERTYBYROUNDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197E9050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierAddRoleAndPropertyByRoundConfig_TypeDefinitionIndex = 18386;
