...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDROLEANDPROPERTYBYROUNDCONFIG_METHOD_3_32BD01B5E5E60E0C_OFFSET UNITYSDK_OFFSET(0x189B1450)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDROLEANDPROPERTYBYROUNDCONFIG_METHOD_3_7E85B1EE44B7C555_OFFSET UNITYSDK_OFFSET(0x189B1380)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDROLEANDPROPERTYBYROUNDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189B1400)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierAddRoleAndPropertyByRoundConfig_TypeDefinitionIndex = 18414;
