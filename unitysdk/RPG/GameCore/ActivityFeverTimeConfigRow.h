...
#define RPG_GAMECORE_ACTIVITYFEVERTIMECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CD8A750)
#define RPG_GAMECORE_ACTIVITYFEVERTIMECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD8B4A0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::System::UInt32>* P3MazeBuffID; // 0x20
		::Il2CppArray<::System::UInt32>* P2AvailableBuffList; // 0x28
		::Il2CppArray<::System::UInt32>* P1AvailableBuffList; // 0x30
		...
		::Il2CppArray<::System::UInt32>* SpecialAvatarList; // 0x58
		...
		::System::UInt32 FeverTimeID; // 0x80
		::System::UInt32 EventID; // 0x84
		::RPG::Client::TextID LevelSPDes; // 0x88
		::System::UInt32 UnlockID; // 0x98
		::System::UInt32 ExtraEffectID; // 0x9C
