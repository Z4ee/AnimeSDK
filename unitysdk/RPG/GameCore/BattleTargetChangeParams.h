...
#define RPG_GAMECORE_BATTLETARGETCHANGEPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0xA88D980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleTargetChangeParams_TypeDefinitionIndex = 47221;
