...
#define RPG_GAMECORE_BATTLETARGETCHANGEPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0xB5D2D80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleTargetChangeParams_TypeDefinitionIndex = 53953;
