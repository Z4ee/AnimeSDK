...
#define RPG_GAMECORE_RESTARTTRACKPHOTO_METHOD_3_289DF554D6D763ED_OFFSET UNITYSDK_OFFSET(0x18CAE100)
#define RPG_GAMECORE_RESTARTTRACKPHOTO_METHOD_3_496DC9E3C26DAE79_OFFSET UNITYSDK_OFFSET(0x18CADFF0)
#define RPG_GAMECORE_RESTARTTRACKPHOTO__CTOR_OFFSET UNITYSDK_OFFSET(0x18CAE0D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RestartTrackPhoto_TypeDefinitionIndex = 20492;
