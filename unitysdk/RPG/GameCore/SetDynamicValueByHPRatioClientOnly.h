...
#define RPG_GAMECORE_SETDYNAMICVALUEBYHPRATIOCLIENTONLY_METHOD_5_722CFC93A1916C9B_OFFSET UNITYSDK_OFFSET(0x176C1E10)
#define RPG_GAMECORE_SETDYNAMICVALUEBYHPRATIOCLIENTONLY_METHOD_5_A29DC4029F26C3D3_OFFSET UNITYSDK_OFFSET(0x176BC3A0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYHPRATIOCLIENTONLY__CTOR_OFFSET UNITYSDK_OFFSET(0x176BC350)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByHPRatioClientOnly_TypeDefinitionIndex = 21819;
