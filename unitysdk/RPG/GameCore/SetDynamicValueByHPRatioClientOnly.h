...
#define RPG_GAMECORE_SETDYNAMICVALUEBYHPRATIOCLIENTONLY_METHOD_5_A29DC4029F26C3D3_OFFSET UNITYSDK_OFFSET(0x1C2E3430)
#define RPG_GAMECORE_SETDYNAMICVALUEBYHPRATIOCLIENTONLY_METHOD_5_AFD3B4DEDC0F3162_OFFSET UNITYSDK_OFFSET(0x1C2E35F0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYHPRATIOCLIENTONLY__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2E3420)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByHPRatioClientOnly_TypeDefinitionIndex = 22737;
