...
#define RPG_GAMECORE_MUNICIPALCHATACTIONPROPANIMATION_METHOD_3_BA7AF52CAB06723C_OFFSET UNITYSDK_OFFSET(0x1CE77EE0)
#define RPG_GAMECORE_MUNICIPALCHATACTIONPROPANIMATION_METHOD_3_CA4C16177C13BD1D_OFFSET UNITYSDK_OFFSET(0x1CE78330)
#define RPG_GAMECORE_MUNICIPALCHATACTIONPROPANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE77ED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MunicipalChatActionPropAnimation_TypeDefinitionIndex = 16733;
