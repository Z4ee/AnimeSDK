...
#define RPG_GAMECORE_LEVELFLOOREDITORSYNCOPTIONS_METHOD_2_7BAF21312E9F4D24_OFFSET UNITYSDK_OFFSET(0x19874380)
#define RPG_GAMECORE_LEVELFLOOREDITORSYNCOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x198743C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelFloorEditorSyncOptions_TypeDefinitionIndex = 16556;
