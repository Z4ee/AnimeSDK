...
#define RPG_GAMECORE_LEVELFLOOREDITORSYNCOPTIONS_METHOD_2_7BAF21312E9F4D24_OFFSET UNITYSDK_OFFSET(0x1B034920)
#define RPG_GAMECORE_LEVELFLOOREDITORSYNCOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B034960)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelFloorEditorSyncOptions_TypeDefinitionIndex = 16718;
