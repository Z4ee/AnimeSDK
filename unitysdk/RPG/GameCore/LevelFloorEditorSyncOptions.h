...
#define RPG_GAMECORE_LEVELFLOOREDITORSYNCOPTIONS_METHOD_2_7BAF21312E9F4D24_OFFSET UNITYSDK_OFFSET(0x1D1D1410)
#define RPG_GAMECORE_LEVELFLOOREDITORSYNCOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1D1450)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelFloorEditorSyncOptions_TypeDefinitionIndex = 17220;
