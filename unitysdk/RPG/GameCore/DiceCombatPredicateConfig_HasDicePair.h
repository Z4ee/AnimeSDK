...
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_HASDICEPAIR_METHOD_4_D1B9825CB2CC9110_OFFSET UNITYSDK_OFFSET(0x1886FFB0)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_HASDICEPAIR_METHOD_4_E3FC1BD266E78D76_OFFSET UNITYSDK_OFFSET(0x1886D7A0)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_HASDICEPAIR__CTOR_OFFSET UNITYSDK_OFFSET(0x1886D700)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatPredicateConfig_HasDicePair_TypeDefinitionIndex = 15263;
