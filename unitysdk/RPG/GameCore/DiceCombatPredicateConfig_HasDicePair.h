...
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_HASDICEPAIR_METHOD_4_68D9959B3F3132FB_OFFSET UNITYSDK_OFFSET(0x1D033200)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_HASDICEPAIR_METHOD_4_C7990E7E12677755_OFFSET UNITYSDK_OFFSET(0x1D031180)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_HASDICEPAIR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D031120)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatPredicateConfig_HasDicePair_TypeDefinitionIndex = 15923;
