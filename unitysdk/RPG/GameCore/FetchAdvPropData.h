...
#define RPG_GAMECORE_FETCHADVPROPDATA_METHOD_2_1AD64DEA13BFCA7F_OFFSET UNITYSDK_OFFSET(0x1D092390)
#define RPG_GAMECORE_FETCHADVPROPDATA_METHOD_2_E3F5F84184119E16_OFFSET UNITYSDK_OFFSET(0x1D0925D0)
#define RPG_GAMECORE_FETCHADVPROPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1D092560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FetchAdvPropData_TypeDefinitionIndex = 23597;
