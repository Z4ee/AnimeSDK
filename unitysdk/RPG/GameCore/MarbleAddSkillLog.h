...
#define RPG_GAMECORE_MARBLEADDSKILLLOG_METHOD_3_35473BCC0A8C0EB4_OFFSET UNITYSDK_OFFSET(0x1D4A2F70)
#define RPG_GAMECORE_MARBLEADDSKILLLOG_METHOD_3_E2212AFEA6C50032_OFFSET UNITYSDK_OFFSET(0x1D4A2FD0)
#define RPG_GAMECORE_MARBLEADDSKILLLOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4A2FC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleAddSkillLog_TypeDefinitionIndex = 16681;
