...
#define RPG_GAMECORE_STTASKCONFIG_METHOD_3_A92D01A7216B76BB_OFFSET UNITYSDK_OFFSET(0x18DE1070)
#define RPG_GAMECORE_STTASKCONFIG_METHOD_3_CC4DA5CB5998AC1F_OFFSET UNITYSDK_OFFSET(0x18DE0EF0)
#define RPG_GAMECORE_STTASKCONFIG__CCTOR_OFFSET UNITYSDK_OFFSET(0x18DE1160)
#define RPG_GAMECORE_STTASKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18DE1130)

namespace RPG::GameCore
{
	inline static constexpr unsigned int STTaskConfig_TypeDefinitionIndex = 19019;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Func_2<::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::STTaskConfig*>*>**)Il2CppClass::FromTypeDefinitionIndex(STTaskConfig_TypeDefinitionIndex)->GetStaticField(0x4B330);
		}
