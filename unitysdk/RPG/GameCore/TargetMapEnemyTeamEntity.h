...
#define RPG_GAMECORE_TARGETMAPENEMYTEAMENTITY_METHOD_3_1159BD79279C8730_OFFSET UNITYSDK_OFFSET(0x18EE8B60)
#define RPG_GAMECORE_TARGETMAPENEMYTEAMENTITY_METHOD_3_B57F5E99F35D3015_OFFSET UNITYSDK_OFFSET(0x18EE8C20)
#define RPG_GAMECORE_TARGETMAPENEMYTEAMENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x18EE8C00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapEnemyTeamEntity_TypeDefinitionIndex = 22937;
