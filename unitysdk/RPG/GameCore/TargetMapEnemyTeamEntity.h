...
#define RPG_GAMECORE_TARGETMAPENEMYTEAMENTITY_METHOD_3_1159BD79279C8730_OFFSET UNITYSDK_OFFSET(0x177C3270)
#define RPG_GAMECORE_TARGETMAPENEMYTEAMENTITY_METHOD_3_B57F5E99F35D3015_OFFSET UNITYSDK_OFFSET(0x177C3330)
#define RPG_GAMECORE_TARGETMAPENEMYTEAMENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x177C3310)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapEnemyTeamEntity_TypeDefinitionIndex = 22223;
