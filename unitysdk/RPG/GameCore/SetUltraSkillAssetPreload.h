...
#define RPG_GAMECORE_SETULTRASKILLASSETPRELOAD_METHOD_3_5654CD8CB3F1A609_OFFSET UNITYSDK_OFFSET(0x1E0947D0)
#define RPG_GAMECORE_SETULTRASKILLASSETPRELOAD_METHOD_3_9C88328A43D717C1_OFFSET UNITYSDK_OFFSET(0x1E094690)
#define RPG_GAMECORE_SETULTRASKILLASSETPRELOAD__CTOR_OFFSET UNITYSDK_OFFSET(0x1E094740)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetUltraSkillAssetPreload_TypeDefinitionIndex = 22549;
