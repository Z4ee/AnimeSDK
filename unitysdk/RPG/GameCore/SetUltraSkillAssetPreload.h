...
#define RPG_GAMECORE_SETULTRASKILLASSETPRELOAD_METHOD_3_5654CD8CB3F1A609_OFFSET UNITYSDK_OFFSET(0x176E5BD0)
#define RPG_GAMECORE_SETULTRASKILLASSETPRELOAD_METHOD_3_EBCDDAE1154636BF_OFFSET UNITYSDK_OFFSET(0x176E5AF0)
#define RPG_GAMECORE_SETULTRASKILLASSETPRELOAD__CTOR_OFFSET UNITYSDK_OFFSET(0x176E5B30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetUltraSkillAssetPreload_TypeDefinitionIndex = 21000;
