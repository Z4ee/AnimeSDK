...
#define RPG_GAMECORE_BYCOMPAREHEARTDIALTRACINGNPC_METHOD_4_6F13D7BD8E6209CE_OFFSET UNITYSDK_OFFSET(0x19CEBBF0)
#define RPG_GAMECORE_BYCOMPAREHEARTDIALTRACINGNPC_METHOD_4_72685F474725500B_OFFSET UNITYSDK_OFFSET(0x19CEBA70)
#define RPG_GAMECORE_BYCOMPAREHEARTDIALTRACINGNPC_METHOD_4_C0510934E8C4FBA8_OFFSET UNITYSDK_OFFSET(0x19CEBAB0)
#define RPG_GAMECORE_BYCOMPAREHEARTDIALTRACINGNPC_METHOD_4_EF7FE9954EF54DA3_OFFSET UNITYSDK_OFFSET(0x19CEBC20)
#define RPG_GAMECORE_BYCOMPAREHEARTDIALTRACINGNPC__CTOR_OFFSET UNITYSDK_OFFSET(0x19CEBAA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareHeartDialTracingNPC_TypeDefinitionIndex = 21092;
