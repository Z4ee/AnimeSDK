...
#define RPG_GAMECORE_SYNCDITHERWITHTARGET_METHOD_3_0CB0FE25B4995FDF_OFFSET UNITYSDK_OFFSET(0x177A3A40)
#define RPG_GAMECORE_SYNCDITHERWITHTARGET_METHOD_3_D74219A5F4CC8C80_OFFSET UNITYSDK_OFFSET(0x177A3B10)
#define RPG_GAMECORE_SYNCDITHERWITHTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x177A3AC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SyncDitherWithTarget_TypeDefinitionIndex = 18512;
