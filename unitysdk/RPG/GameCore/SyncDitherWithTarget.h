...
#define RPG_GAMECORE_SYNCDITHERWITHTARGET_METHOD_3_0CB0FE25B4995FDF_OFFSET UNITYSDK_OFFSET(0x18EC9E20)
#define RPG_GAMECORE_SYNCDITHERWITHTARGET_METHOD_3_D74219A5F4CC8C80_OFFSET UNITYSDK_OFFSET(0x18EC9EF0)
#define RPG_GAMECORE_SYNCDITHERWITHTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x18EC9EA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SyncDitherWithTarget_TypeDefinitionIndex = 19165;
