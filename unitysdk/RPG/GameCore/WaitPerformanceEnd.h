...
#define RPG_GAMECORE_WAITPERFORMANCEEND_METHOD_3_C5A2AFD131E740DD_OFFSET UNITYSDK_OFFSET(0x191034D0)
#define RPG_GAMECORE_WAITPERFORMANCEEND_METHOD_3_EC7E803495F8FAE9_OFFSET UNITYSDK_OFFSET(0x191033C0)
#define RPG_GAMECORE_WAITPERFORMANCEEND__CTOR_OFFSET UNITYSDK_OFFSET(0x191034A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitPerformanceEnd_TypeDefinitionIndex = 20699;
