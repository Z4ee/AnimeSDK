...
#define RPG_GAMECORE_WAITPERFORMANCEEND_METHOD_3_C35330C502EE1B20_OFFSET UNITYSDK_OFFSET(0x1D6A7F50)
#define RPG_GAMECORE_WAITPERFORMANCEEND_METHOD_3_C5A2AFD131E740DD_OFFSET UNITYSDK_OFFSET(0x1D6A8020)
#define RPG_GAMECORE_WAITPERFORMANCEEND__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6A8010)
