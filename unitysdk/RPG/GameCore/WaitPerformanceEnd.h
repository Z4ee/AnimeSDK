...
#define RPG_GAMECORE_WAITPERFORMANCEEND_METHOD_3_C5A2AFD131E740DD_OFFSET UNITYSDK_OFFSET(0x19E5BDB0)
#define RPG_GAMECORE_WAITPERFORMANCEEND_METHOD_3_EC7E803495F8FAE9_OFFSET UNITYSDK_OFFSET(0x19E5BCA0)
#define RPG_GAMECORE_WAITPERFORMANCEEND__CTOR_OFFSET UNITYSDK_OFFSET(0x19E5BD80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitPerformanceEnd_TypeDefinitionIndex = 20627;
