...
#define RPG_GAMECORE_WAITPERFORMANCEEND_METHOD_3_C35330C502EE1B20_OFFSET UNITYSDK_OFFSET(0x1D1B7EF0)
#define RPG_GAMECORE_WAITPERFORMANCEEND_METHOD_3_C5A2AFD131E740DD_OFFSET UNITYSDK_OFFSET(0x1D1B7FC0)
#define RPG_GAMECORE_WAITPERFORMANCEEND__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1B7FB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitPerformanceEnd_TypeDefinitionIndex = 21042;
