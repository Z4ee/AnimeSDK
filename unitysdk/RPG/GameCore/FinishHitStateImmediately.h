...
#define RPG_GAMECORE_FINISHHITSTATEIMMEDIATELY_METHOD_3_19765CAD45C06517_OFFSET UNITYSDK_OFFSET(0x188E5080)
#define RPG_GAMECORE_FINISHHITSTATEIMMEDIATELY_METHOD_3_361E3664C06DE166_OFFSET UNITYSDK_OFFSET(0x188E5000)
#define RPG_GAMECORE_FINISHHITSTATEIMMEDIATELY__CTOR_OFFSET UNITYSDK_OFFSET(0x188E5050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FinishHitStateImmediately_TypeDefinitionIndex = 22424;
