...
#define RPG_GAMECORE_TARGETFETCHLOCKTARGET_METHOD_3_01642F4B17DBD7C2_OFFSET UNITYSDK_OFFSET(0x1D0BABA0)
#define RPG_GAMECORE_TARGETFETCHLOCKTARGET_METHOD_3_3751D283C38F8FC8_OFFSET UNITYSDK_OFFSET(0x1D0BAAC0)
#define RPG_GAMECORE_TARGETFETCHLOCKTARGET_METHOD_3_58DC7C0961F7F58F_OFFSET UNITYSDK_OFFSET(0x1D0BABC0)
#define RPG_GAMECORE_TARGETFETCHLOCKTARGET_METHOD_3_CBD3DA7263F30DAD_OFFSET UNITYSDK_OFFSET(0x1D0BAB40)
#define RPG_GAMECORE_TARGETFETCHLOCKTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0BAB30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchLockTarget_TypeDefinitionIndex = 23109;
