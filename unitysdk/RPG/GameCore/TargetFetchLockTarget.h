...
#define RPG_GAMECORE_TARGETFETCHLOCKTARGET_METHOD_3_CBD3DA7263F30DAD_OFFSET UNITYSDK_OFFSET(0x177BF2C0)
#define RPG_GAMECORE_TARGETFETCHLOCKTARGET_METHOD_3_E4A868C7EE90FDF8_OFFSET UNITYSDK_OFFSET(0x177BF200)
#define RPG_GAMECORE_TARGETFETCHLOCKTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x177BF2A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchLockTarget_TypeDefinitionIndex = 22241;
