...
#define RPG_GAMECORE_FIVEDIMMINIGAMEREWARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19746BC0)
#define RPG_GAMECORE_FIVEDIMMINIGAMEREWARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19746D70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimMiniGameRewardRow_TypeDefinitionIndex = 13441;
