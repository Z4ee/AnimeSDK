...
#define RPG_GAMECORE_TARGETMAPDUMMYENTITY_METHOD_3_0E92A3CA73FDA2CA_OFFSET UNITYSDK_OFFSET(0x177C2FB0)
#define RPG_GAMECORE_TARGETMAPDUMMYENTITY_METHOD_3_B4B4F337E8EFF897_OFFSET UNITYSDK_OFFSET(0x177C2F40)
#define RPG_GAMECORE_TARGETMAPDUMMYENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x177C2F90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapDummyEntity_TypeDefinitionIndex = 22308;
