...
#define RPG_GAMECORE_TARGETMAPDUMMYENTITY_METHOD_3_0E92A3CA73FDA2CA_OFFSET UNITYSDK_OFFSET(0x1E1BC2E0)
#define RPG_GAMECORE_TARGETMAPDUMMYENTITY_METHOD_3_1B4DD42217238D08_OFFSET UNITYSDK_OFFSET(0x1E1BC430)
#define RPG_GAMECORE_TARGETMAPDUMMYENTITY_METHOD_3_627856C01D5E9B6D_OFFSET UNITYSDK_OFFSET(0x1E1BC400)
#define RPG_GAMECORE_TARGETMAPDUMMYENTITY_METHOD_3_9EAF4775263B4C25_OFFSET UNITYSDK_OFFSET(0x1E1BC2A0)
#define RPG_GAMECORE_TARGETMAPDUMMYENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1BC2D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapDummyEntity_TypeDefinitionIndex = 23760;
