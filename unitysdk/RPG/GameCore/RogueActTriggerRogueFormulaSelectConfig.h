...
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEFORMULASELECTCONFIG_METHOD_6_AD64875BE70E0141_OFFSET UNITYSDK_OFFSET(0x19AFB740)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEFORMULASELECTCONFIG_METHOD_6_FB12A411A4A8FDBC_OFFSET UNITYSDK_OFFSET(0x19AFB960)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEFORMULASELECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AFB880)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActTriggerRogueFormulaSelectConfig_TypeDefinitionIndex = 18619;
