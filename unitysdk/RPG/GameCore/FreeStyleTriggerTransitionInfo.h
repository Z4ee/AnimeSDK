...
#define RPG_GAMECORE_FREESTYLETRIGGERTRANSITIONINFO_METHOD_2_85E2EB731A15303F_OFFSET UNITYSDK_OFFSET(0x17221930)
#define RPG_GAMECORE_FREESTYLETRIGGERTRANSITIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x17221A40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FreeStyleTriggerTransitionInfo_TypeDefinitionIndex = 15508;
