...
#define RPG_GAMECORE_ADVRESTARTGATHEREDREGION_METHOD_3_791814B4F7CBA720_OFFSET UNITYSDK_OFFSET(0x1BE2A2A0)
#define RPG_GAMECORE_ADVRESTARTGATHEREDREGION_METHOD_3_FAC64EAC561EA5E3_OFFSET UNITYSDK_OFFSET(0x1BE2A260)
#define RPG_GAMECORE_ADVRESTARTGATHEREDREGION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE2A290)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvRestartGatheredRegion_TypeDefinitionIndex = 20212;
