...
#define RPG_GAMECORE_ADVRESTARTGATHEREDREGION_METHOD_3_791814B4F7CBA720_OFFSET UNITYSDK_OFFSET(0x1865FDE0)
#define RPG_GAMECORE_ADVRESTARTGATHEREDREGION_METHOD_3_BCB5F7AD9D86A4D9_OFFSET UNITYSDK_OFFSET(0x1865FD60)
#define RPG_GAMECORE_ADVRESTARTGATHEREDREGION__CTOR_OFFSET UNITYSDK_OFFSET(0x1865FDB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvRestartGatheredRegion_TypeDefinitionIndex = 19985;
