...
#define RPG_GAMECORE_SETENTITYRELATIONGROUP_METHOD_3_174E7015DDE0DB5B_OFFSET UNITYSDK_OFFSET(0x176CC270)
#define RPG_GAMECORE_SETENTITYRELATIONGROUP_METHOD_3_9FFE570A538BD616_OFFSET UNITYSDK_OFFSET(0x176CC1F0)
#define RPG_GAMECORE_SETENTITYRELATIONGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x176CC240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetEntityRelationGroup_TypeDefinitionIndex = 21026;
