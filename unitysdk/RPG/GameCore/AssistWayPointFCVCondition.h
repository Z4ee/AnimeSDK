...
#define RPG_GAMECORE_ASSISTWAYPOINTFCVCONDITION_METHOD_3_1202C705E6D02328_OFFSET UNITYSDK_OFFSET(0x1C575C10)
#define RPG_GAMECORE_ASSISTWAYPOINTFCVCONDITION_METHOD_3_2C16222D1E0AECED_OFFSET UNITYSDK_OFFSET(0x1C5738A0)
#define RPG_GAMECORE_ASSISTWAYPOINTFCVCONDITION_METHOD_3_A60AF6ABE57E2230_OFFSET UNITYSDK_OFFSET(0x1C575C40)
#define RPG_GAMECORE_ASSISTWAYPOINTFCVCONDITION_METHOD_3_F09386DE332C149E_OFFSET UNITYSDK_OFFSET(0x1C574FC0)
#define RPG_GAMECORE_ASSISTWAYPOINTFCVCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C573890)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AssistWayPointFCVCondition_TypeDefinitionIndex = 18774;
