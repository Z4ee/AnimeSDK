...
#define RPG_GAMECORE_ASSISTWAYPOINTFCVCONDITION_METHOD_3_1202C705E6D02328_OFFSET UNITYSDK_OFFSET(0x16F88EF0)
#define RPG_GAMECORE_ASSISTWAYPOINTFCVCONDITION_METHOD_3_2C16222D1E0AECED_OFFSET UNITYSDK_OFFSET(0x16F87F10)
#define RPG_GAMECORE_ASSISTWAYPOINTFCVCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x16F87F00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AssistWayPointFCVCondition_TypeDefinitionIndex = 17411;
