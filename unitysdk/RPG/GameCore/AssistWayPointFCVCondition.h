...
#define RPG_GAMECORE_ASSISTWAYPOINTFCVCONDITION_METHOD_3_1202C705E6D02328_OFFSET UNITYSDK_OFFSET(0x19482310)
#define RPG_GAMECORE_ASSISTWAYPOINTFCVCONDITION_METHOD_3_2C16222D1E0AECED_OFFSET UNITYSDK_OFFSET(0x194807E0)
#define RPG_GAMECORE_ASSISTWAYPOINTFCVCONDITION_METHOD_3_C49977D0D325B877_OFFSET UNITYSDK_OFFSET(0x19482340)
#define RPG_GAMECORE_ASSISTWAYPOINTFCVCONDITION_METHOD_3_F09386DE332C149E_OFFSET UNITYSDK_OFFSET(0x19481B90)
#define RPG_GAMECORE_ASSISTWAYPOINTFCVCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x194807D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AssistWayPointFCVCondition_TypeDefinitionIndex = 18046;
	...
	public:
		...
		static ::System::Void Method_3_C49977D0D325B877(::SimpleJSON::JSONNode* a1, ::RPG::GameCore::AssistWayPointFCVCondition* a2)
		{
			return ((::System::Void(*)(::SimpleJSON::JSONNode*, ::RPG::GameCore::AssistWayPointFCVCondition*))((::PBYTE)hIl2Cpp + RPG_GAMECORE_ASSISTWAYPOINTFCVCONDITION_METHOD_3_C49977D0D325B877_OFFSET))(a1, a2);
		}
	};
}
