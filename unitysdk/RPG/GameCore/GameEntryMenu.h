...
#define RPG_GAMECORE_GAMEENTRYMENU_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D13C860)
#define RPG_GAMECORE_GAMEENTRYMENU__CTOR_OFFSET UNITYSDK_OFFSET(0x1D13CAB0)
