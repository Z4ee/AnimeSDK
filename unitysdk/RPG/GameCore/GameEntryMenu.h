...
#define RPG_GAMECORE_GAMEENTRYMENU_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B98D300)
#define RPG_GAMECORE_GAMEENTRYMENU__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9A1160)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GameEntryMenu_TypeDefinitionIndex = 15809;
