...
#define RPG_GAMECORE_WOLFBROUSEBULLET_METHOD_3_1E2289F7B25C2FFB_OFFSET UNITYSDK_OFFSET(0x19E69890)
#define RPG_GAMECORE_WOLFBROUSEBULLET_METHOD_3_654848E3FB965287_OFFSET UNITYSDK_OFFSET(0x19E69780)
#define RPG_GAMECORE_WOLFBROUSEBULLET__CTOR_OFFSET UNITYSDK_OFFSET(0x19E69860)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WolfBroUseBullet_TypeDefinitionIndex = 20371;
