...
#define RPG_GAMECORE_WOLFBROUSEBULLET_METHOD_3_1E2289F7B25C2FFB_OFFSET UNITYSDK_OFFSET(0x1790D340)
#define RPG_GAMECORE_WOLFBROUSEBULLET_METHOD_3_654848E3FB965287_OFFSET UNITYSDK_OFFSET(0x1790D230)
#define RPG_GAMECORE_WOLFBROUSEBULLET__CTOR_OFFSET UNITYSDK_OFFSET(0x1790D310)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WolfBroUseBullet_TypeDefinitionIndex = 19748;
