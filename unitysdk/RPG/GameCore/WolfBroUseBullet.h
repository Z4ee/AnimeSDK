...
#define RPG_GAMECORE_WOLFBROUSEBULLET_METHOD_3_1E2289F7B25C2FFB_OFFSET UNITYSDK_OFFSET(0x1D6B4370)
#define RPG_GAMECORE_WOLFBROUSEBULLET_METHOD_3_404AB43E87ADF5FE_OFFSET UNITYSDK_OFFSET(0x1D6B42A0)
#define RPG_GAMECORE_WOLFBROUSEBULLET__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6B4360)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WolfBroUseBullet_TypeDefinitionIndex = 21342;
