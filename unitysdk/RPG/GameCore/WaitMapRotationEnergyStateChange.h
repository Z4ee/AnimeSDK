...
#define RPG_GAMECORE_WAITMAPROTATIONENERGYSTATECHANGE_METHOD_4_480DFD091E0771B4_OFFSET UNITYSDK_OFFSET(0x19101460)
#define RPG_GAMECORE_WAITMAPROTATIONENERGYSTATECHANGE_METHOD_4_80101A708DCE02FE_OFFSET UNITYSDK_OFFSET(0x19101540)
#define RPG_GAMECORE_WAITMAPROTATIONENERGYSTATECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x191014E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitMapRotationEnergyStateChange_TypeDefinitionIndex = 19912;
