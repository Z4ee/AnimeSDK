...
#define RPG_GAMECORE_WAITMAPROTATIONENERGYSTATECHANGE_METHOD_4_3E231A35067AC345_OFFSET UNITYSDK_OFFSET(0x1B8A7EA0)
#define RPG_GAMECORE_WAITMAPROTATIONENERGYSTATECHANGE_METHOD_4_614853E399E89588_OFFSET UNITYSDK_OFFSET(0x1B8A7E50)
#define RPG_GAMECORE_WAITMAPROTATIONENERGYSTATECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8A7E90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitMapRotationEnergyStateChange_TypeDefinitionIndex = 20136;
