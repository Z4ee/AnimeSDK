...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYPERSONAROOMCONTENTCOUNTBYPARAMCONFIG_METHOD_3_53B2FEBD18DC65BB_OFFSET UNITYSDK_OFFSET(0x1D164120)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYPERSONAROOMCONTENTCOUNTBYPARAMCONFIG_METHOD_3_B88D3F5AEAB75F3F_OFFSET UNITYSDK_OFFSET(0x1D164170)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYPERSONAROOMCONTENTCOUNTBYPARAMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D164160)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyPersonaRoomContentCountByParamConfig_TypeDefinitionIndex = 17079;
