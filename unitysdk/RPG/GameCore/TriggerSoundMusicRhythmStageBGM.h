...
#define RPG_GAMECORE_TRIGGERSOUNDMUSICRHYTHMSTAGEBGM_METHOD_4_0C9C628A192E0188_OFFSET UNITYSDK_OFFSET(0x178CF100)
#define RPG_GAMECORE_TRIGGERSOUNDMUSICRHYTHMSTAGEBGM_METHOD_4_AF0C7BC5A54ACBA4_OFFSET UNITYSDK_OFFSET(0x178CE8D0)
#define RPG_GAMECORE_TRIGGERSOUNDMUSICRHYTHMSTAGEBGM__CTOR_OFFSET UNITYSDK_OFFSET(0x178CE8A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerSoundMusicRhythmStageBGM_TypeDefinitionIndex = 18921;
