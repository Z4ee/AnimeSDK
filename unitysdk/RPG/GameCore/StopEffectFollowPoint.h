...
#define RPG_GAMECORE_STOPEFFECTFOLLOWPOINT_METHOD_3_08D739B7F12C29AD_OFFSET UNITYSDK_OFFSET(0x1777D580)
#define RPG_GAMECORE_STOPEFFECTFOLLOWPOINT_METHOD_3_C3B6D0D544765383_OFFSET UNITYSDK_OFFSET(0x1777D4E0)
#define RPG_GAMECORE_STOPEFFECTFOLLOWPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1777D540)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StopEffectFollowPoint_TypeDefinitionIndex = 18561;
