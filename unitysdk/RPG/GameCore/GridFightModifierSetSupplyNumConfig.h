...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETSUPPLYNUMCONFIG_METHOD_3_3488EEFE700ED867_OFFSET UNITYSDK_OFFSET(0x197EF3D0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETSUPPLYNUMCONFIG_METHOD_3_91489D7226C229EE_OFFSET UNITYSDK_OFFSET(0x197F3970)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETSUPPLYNUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197EF380)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierSetSupplyNumConfig_TypeDefinitionIndex = 18448;
