...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETSUPPLYNUMCONFIG_METHOD_3_3488EEFE700ED867_OFFSET UNITYSDK_OFFSET(0x1D15AAC0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETSUPPLYNUMCONFIG_METHOD_3_B83461E05943C8E3_OFFSET UNITYSDK_OFFSET(0x1D15AA70)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETSUPPLYNUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D15AAB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierSetSupplyNumConfig_TypeDefinitionIndex = 19221;
