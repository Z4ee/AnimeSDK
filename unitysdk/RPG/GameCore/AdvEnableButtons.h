...
#define RPG_GAMECORE_ADVENABLEBUTTONS_METHOD_3_33C2AC6AB402EF2F_OFFSET UNITYSDK_OFFSET(0x16F2B860)
#define RPG_GAMECORE_ADVENABLEBUTTONS_METHOD_3_ADF9FAD9A9C842F2_OFFSET UNITYSDK_OFFSET(0x16F2B8E0)
#define RPG_GAMECORE_ADVENABLEBUTTONS__CTOR_OFFSET UNITYSDK_OFFSET(0x16F2B8B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvEnableButtons_TypeDefinitionIndex = 18845;
