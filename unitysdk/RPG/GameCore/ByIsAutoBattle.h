...
#define RPG_GAMECORE_BYISAUTOBATTLE_METHOD_4_1F4FC1D4539A28E5_OFFSET UNITYSDK_OFFSET(0x1A8D6800)
#define RPG_GAMECORE_BYISAUTOBATTLE_METHOD_4_36AC0F843718E960_OFFSET UNITYSDK_OFFSET(0x1A8D69D0)
#define RPG_GAMECORE_BYISAUTOBATTLE_METHOD_4_6A8E20DFA72D4737_OFFSET UNITYSDK_OFFSET(0x1A8D6A10)
#define RPG_GAMECORE_BYISAUTOBATTLE_METHOD_4_EF98E74910E89850_OFFSET UNITYSDK_OFFSET(0x1A8D6850)
#define RPG_GAMECORE_BYISAUTOBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8D6840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsAutoBattle_TypeDefinitionIndex = 21752;
