...
#define RPG_GAMECORE_PHOTOGRAPHONSHOTCONDITION_METHOD_2_EC49ABD0665ED4A0_OFFSET UNITYSDK_OFFSET(0x1B4C2B60)
#define RPG_GAMECORE_PHOTOGRAPHONSHOTCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4C2BF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotoGraphOnShotCondition_TypeDefinitionIndex = 20847;
