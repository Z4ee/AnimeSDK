...
#define RPG_GAMECORE_PHOTOGRAPHONSHOTCONDITION_METHOD_2_EC49ABD0665ED4A0_OFFSET UNITYSDK_OFFSET(0x1D32C980)
#define RPG_GAMECORE_PHOTOGRAPHONSHOTCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D32CA10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotoGraphOnShotCondition_TypeDefinitionIndex = 21403;
