...
#define RPG_GAMECORE_PHOTOGRAPHONSHOTCONDITION_METHOD_2_EC49ABD0665ED4A0_OFFSET UNITYSDK_OFFSET(0x174AB560)
#define RPG_GAMECORE_PHOTOGRAPHONSHOTCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x174AB5F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotoGraphOnShotCondition_TypeDefinitionIndex = 19814;
