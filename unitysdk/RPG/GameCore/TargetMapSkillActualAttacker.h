...
#define RPG_GAMECORE_TARGETMAPSKILLACTUALATTACKER_METHOD_3_619A10B54563F4CF_OFFSET UNITYSDK_OFFSET(0x18EE9200)
#define RPG_GAMECORE_TARGETMAPSKILLACTUALATTACKER_METHOD_3_97B20532A9D3B542_OFFSET UNITYSDK_OFFSET(0x18EE9140)
#define RPG_GAMECORE_TARGETMAPSKILLACTUALATTACKER__CTOR_OFFSET UNITYSDK_OFFSET(0x18EE91E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapSkillActualAttacker_TypeDefinitionIndex = 22942;
