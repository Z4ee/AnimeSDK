...
#define RPG_GAMECORE_TARGETMAPSKILLACTUALATTACKER_METHOD_3_5821F87443352FAE_OFFSET UNITYSDK_OFFSET(0x19D14590)
#define RPG_GAMECORE_TARGETMAPSKILLACTUALATTACKER_METHOD_3_5E3D6A511F215349_OFFSET UNITYSDK_OFFSET(0x19D145D0)
#define RPG_GAMECORE_TARGETMAPSKILLACTUALATTACKER_METHOD_3_619A10B54563F4CF_OFFSET UNITYSDK_OFFSET(0x19D14530)
#define RPG_GAMECORE_TARGETMAPSKILLACTUALATTACKER_METHOD_3_97B20532A9D3B542_OFFSET UNITYSDK_OFFSET(0x19D14470)
#define RPG_GAMECORE_TARGETMAPSKILLACTUALATTACKER__CTOR_OFFSET UNITYSDK_OFFSET(0x19D14510)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapSkillActualAttacker_TypeDefinitionIndex = 22633;
	...
	public:
		...
		static ::System::Void Method_3_5821F87443352FAE(::SimpleJSON::JSONNode* a1, ::RPG::GameCore::TargetMapSkillActualAttacker*& a2)
		{
			return ((::System::Void(*)(::SimpleJSON::JSONNode*, ::RPG::GameCore::TargetMapSkillActualAttacker*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_TARGETMAPSKILLACTUALATTACKER_METHOD_3_5821F87443352FAE_OFFSET))(a1, a2);
		}
