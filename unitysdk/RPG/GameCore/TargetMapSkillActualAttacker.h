...
#define RPG_GAMECORE_TARGETMAPSKILLACTUALATTACKER_METHOD_3_5E3D6A511F215349_OFFSET UNITYSDK_OFFSET(0x1D0C3320)
#define RPG_GAMECORE_TARGETMAPSKILLACTUALATTACKER_METHOD_3_619A10B54563F4CF_OFFSET UNITYSDK_OFFSET(0x1D0C32A0)
#define RPG_GAMECORE_TARGETMAPSKILLACTUALATTACKER_METHOD_3_982571D8808CBC5E_OFFSET UNITYSDK_OFFSET(0x1D0C3220)
#define RPG_GAMECORE_TARGETMAPSKILLACTUALATTACKER_METHOD_3_9EC02CF9D492E87C_OFFSET UNITYSDK_OFFSET(0x1D0C3300)
#define RPG_GAMECORE_TARGETMAPSKILLACTUALATTACKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0C3290)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapSkillActualAttacker_TypeDefinitionIndex = 23096;
