...
#define RPG_GAMECORE_MARBLEBYDEFENDERFACTION_METHOD_4_11E8DB0D283FEB54_OFFSET UNITYSDK_OFFSET(0x1738A890)
#define RPG_GAMECORE_MARBLEBYDEFENDERFACTION_METHOD_4_9878885BC41F5FB1_OFFSET UNITYSDK_OFFSET(0x1738A7B0)
#define RPG_GAMECORE_MARBLEBYDEFENDERFACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1738A840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleByDefenderFaction_TypeDefinitionIndex = 15449;
