...
#define RPG_GAMECORE_EFFECTSURFACEOVERRIDE_METHOD_2_1B12FC3E381EF97D_OFFSET UNITYSDK_OFFSET(0x1BB32510)
#define RPG_GAMECORE_EFFECTSURFACEOVERRIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB32640)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EffectSurfaceOverride_TypeDefinitionIndex = 15836;
