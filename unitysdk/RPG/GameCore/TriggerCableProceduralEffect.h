...
#define RPG_GAMECORE_TRIGGERCABLEPROCEDURALEFFECT_METHOD_3_1D211165B4BC8610_OFFSET UNITYSDK_OFFSET(0x190BEA50)
#define RPG_GAMECORE_TRIGGERCABLEPROCEDURALEFFECT_METHOD_3_C845E7175ED4E2DA_OFFSET UNITYSDK_OFFSET(0x190BEAD0)
#define RPG_GAMECORE_TRIGGERCABLEPROCEDURALEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x190BEAA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerCableProceduralEffect_TypeDefinitionIndex = 22617;
