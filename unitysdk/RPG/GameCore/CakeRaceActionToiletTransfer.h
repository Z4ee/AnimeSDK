...
#define RPG_GAMECORE_CAKERACEACTIONTOILETTRANSFER_METHOD_3_27424DEFF4A80787_OFFSET UNITYSDK_OFFSET(0x1876C750)
#define RPG_GAMECORE_CAKERACEACTIONTOILETTRANSFER_METHOD_3_3E5860E7847E9929_OFFSET UNITYSDK_OFFSET(0x1876B3E0)
#define RPG_GAMECORE_CAKERACEACTIONTOILETTRANSFER__CTOR_OFFSET UNITYSDK_OFFSET(0x1876B3C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionToiletTransfer_TypeDefinitionIndex = 17435;
