...
#define RPG_GAMECORE_CAKERACEACTIONTOILETTRANSFER_METHOD_3_3E5860E7847E9929_OFFSET UNITYSDK_OFFSET(0x1B2CC980)
#define RPG_GAMECORE_CAKERACEACTIONTOILETTRANSFER_METHOD_3_6513AE5AA7B88754_OFFSET UNITYSDK_OFFSET(0x1B2CC8E0)
#define RPG_GAMECORE_CAKERACEACTIONTOILETTRANSFER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2CC970)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionToiletTransfer_TypeDefinitionIndex = 17611;
