...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::RootMotion::FinalIK::GroundPhysicsHelper_CapsuleCastDelegate**)Il2CppClass::FromTypeDefinitionIndex(TurnBasedGameMode___O_TypeDefinitionIndex)->GetStaticField(0x63550);
		}
		static ::RootMotion::FinalIK::GroundPhysicsHelper_SphereCastDelegate** StaticGet__0___BattleSphereCast()
		{
			return (::RootMotion::FinalIK::GroundPhysicsHelper_SphereCastDelegate**)Il2CppClass::FromTypeDefinitionIndex(TurnBasedGameMode___O_TypeDefinitionIndex)->GetStaticField(0x63558);
		}
	};
}
