...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEROVERRIDEEFFECTPARAMCONFIG_METHOD_3_2AF41FCF5C540907_OFFSET UNITYSDK_OFFSET(0x1726B7C0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEROVERRIDEEFFECTPARAMCONFIG_METHOD_3_49F81602E5483B9E_OFFSET UNITYSDK_OFFSET(0x17268440)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEROVERRIDEEFFECTPARAMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x172683F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierOverrideEffectParamConfig_TypeDefinitionIndex = 17859;
