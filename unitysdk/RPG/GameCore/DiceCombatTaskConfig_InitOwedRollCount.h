...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_INITOWEDROLLCOUNT_METHOD_3_A106B38CB3AFE0BE_OFFSET UNITYSDK_OFFSET(0x1716CD20)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_INITOWEDROLLCOUNT_METHOD_3_D0C56F91C6813346_OFFSET UNITYSDK_OFFSET(0x17170AA0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_INITOWEDROLLCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1716CCD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_InitOwedRollCount_TypeDefinitionIndex = 14748;
