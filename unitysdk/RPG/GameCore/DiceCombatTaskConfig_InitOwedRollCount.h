...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_INITOWEDROLLCOUNT_METHOD_3_A106B38CB3AFE0BE_OFFSET UNITYSDK_OFFSET(0x1DB05C80)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_INITOWEDROLLCOUNT_METHOD_3_F15291F9C24EF154_OFFSET UNITYSDK_OFFSET(0x1DB05B80)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_INITOWEDROLLCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB05C70)
