...
#define RPG_GAMECORE_FATEPARAMSHOPREFRESHCOUNTCONFIG_METHOD_6_17D9AC8A94EB68FF_OFFSET UNITYSDK_OFFSET(0x171CBE10)
#define RPG_GAMECORE_FATEPARAMSHOPREFRESHCOUNTCONFIG_METHOD_6_8526DD625AECBA23_OFFSET UNITYSDK_OFFSET(0x171CBFD0)
#define RPG_GAMECORE_FATEPARAMSHOPREFRESHCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171CBF10)
