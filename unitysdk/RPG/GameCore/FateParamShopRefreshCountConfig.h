...
#define RPG_GAMECORE_FATEPARAMSHOPREFRESHCOUNTCONFIG_METHOD_6_8526DD625AECBA23_OFFSET UNITYSDK_OFFSET(0x1E0CF110)
#define RPG_GAMECORE_FATEPARAMSHOPREFRESHCOUNTCONFIG_METHOD_6_C878CA5AB771FC1F_OFFSET UNITYSDK_OFFSET(0x1E0CF0C0)
#define RPG_GAMECORE_FATEPARAMSHOPREFRESHCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0CF100)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateParamShopRefreshCountConfig_TypeDefinitionIndex = 16449;
