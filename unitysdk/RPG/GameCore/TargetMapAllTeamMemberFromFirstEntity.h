...
#define RPG_GAMECORE_TARGETMAPALLTEAMMEMBERFROMFIRSTENTITY_METHOD_3_206061BDD2876D3A_OFFSET UNITYSDK_OFFSET(0x1D0C0AF0)
#define RPG_GAMECORE_TARGETMAPALLTEAMMEMBERFROMFIRSTENTITY_METHOD_3_245AD0DC6BED970D_OFFSET UNITYSDK_OFFSET(0x1D0C0970)
#define RPG_GAMECORE_TARGETMAPALLTEAMMEMBERFROMFIRSTENTITY_METHOD_3_529AD20B83CE76CE_OFFSET UNITYSDK_OFFSET(0x1D0C09B0)
#define RPG_GAMECORE_TARGETMAPALLTEAMMEMBERFROMFIRSTENTITY_METHOD_3_9766DF78F2BF7C8F_OFFSET UNITYSDK_OFFSET(0x1D0C0B20)
#define RPG_GAMECORE_TARGETMAPALLTEAMMEMBERFROMFIRSTENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0C09A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapAllTeamMemberFromFirstEntity_TypeDefinitionIndex = 23093;
