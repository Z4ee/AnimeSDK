...
#define RPG_GAMECORE_TARGETMAPALLTEAMMEMBERFROMFIRSTENTITY_METHOD_3_529AD20B83CE76CE_OFFSET UNITYSDK_OFFSET(0x18EE77A0)
#define RPG_GAMECORE_TARGETMAPALLTEAMMEMBERFROMFIRSTENTITY_METHOD_3_6E5D9F1828755F1F_OFFSET UNITYSDK_OFFSET(0x18EE7730)
#define RPG_GAMECORE_TARGETMAPALLTEAMMEMBERFROMFIRSTENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x18EE7780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapAllTeamMemberFromFirstEntity_TypeDefinitionIndex = 22939;
