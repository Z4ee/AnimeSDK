...
#define RPG_GAMECORE_TOGGLETOTALDAMAGEFINISHNOTIFY_METHOD_3_02CB9CAD9CFD4D64_OFFSET UNITYSDK_OFFSET(0x1788B3A0)
#define RPG_GAMECORE_TOGGLETOTALDAMAGEFINISHNOTIFY_METHOD_3_21D8B96B204DF8F5_OFFSET UNITYSDK_OFFSET(0x178A25E0)
#define RPG_GAMECORE_TOGGLETOTALDAMAGEFINISHNOTIFY__CTOR_OFFSET UNITYSDK_OFFSET(0x1788B370)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ToggleTotalDamageFinishNotify_TypeDefinitionIndex = 21445;
