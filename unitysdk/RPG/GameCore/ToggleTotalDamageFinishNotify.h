...
#define RPG_GAMECORE_TOGGLETOTALDAMAGEFINISHNOTIFY_METHOD_3_02CB9CAD9CFD4D64_OFFSET UNITYSDK_OFFSET(0x1D5D4C10)
#define RPG_GAMECORE_TOGGLETOTALDAMAGEFINISHNOTIFY_METHOD_3_9F9EDA3F4AD586E1_OFFSET UNITYSDK_OFFSET(0x1D5D4BD0)
#define RPG_GAMECORE_TOGGLETOTALDAMAGEFINISHNOTIFY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5D4C00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ToggleTotalDamageFinishNotify_TypeDefinitionIndex = 22963;
