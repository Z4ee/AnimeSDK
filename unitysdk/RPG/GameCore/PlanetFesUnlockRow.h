...
#define RPG_GAMECORE_PLANETFESUNLOCKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x174C04A0)
#define RPG_GAMECORE_PLANETFESUNLOCKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x174C0660)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlanetFesUnlockRow_TypeDefinitionIndex = 11159;
