...
#define RPG_GAMECORE_REQUESTSETSERVERGROUPPROPERTY_METHOD_3_8CDE6AFECBE3211A_OFFSET UNITYSDK_OFFSET(0x18CA8970)
#define RPG_GAMECORE_REQUESTSETSERVERGROUPPROPERTY_METHOD_3_E5C4DBC489C330E1_OFFSET UNITYSDK_OFFSET(0x18CA88F0)
#define RPG_GAMECORE_REQUESTSETSERVERGROUPPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x18CA8940)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RequestSetServerGroupProperty_TypeDefinitionIndex = 19707;
