...
#define RPG_GAMECORE_PLAYERHPRATIOCHECK_METHOD_3_01775AE8039C59C5_OFFSET UNITYSDK_OFFSET(0x174DBAC0)
#define RPG_GAMECORE_PLAYERHPRATIOCHECK_METHOD_3_256651F8B89CFAC2_OFFSET UNITYSDK_OFFSET(0x174DBB40)
#define RPG_GAMECORE_PLAYERHPRATIOCHECK__CTOR_OFFSET UNITYSDK_OFFSET(0x174DBB10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayerHPRatioCheck_TypeDefinitionIndex = 21165;
