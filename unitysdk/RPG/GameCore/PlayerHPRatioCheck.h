...
#define RPG_GAMECORE_PLAYERHPRATIOCHECK_METHOD_3_256651F8B89CFAC2_OFFSET UNITYSDK_OFFSET(0x1D34EBA0)
#define RPG_GAMECORE_PLAYERHPRATIOCHECK_METHOD_3_C322DD3AAEB83DE7_OFFSET UNITYSDK_OFFSET(0x1D34EB60)
#define RPG_GAMECORE_PLAYERHPRATIOCHECK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D34EB90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayerHPRatioCheck_TypeDefinitionIndex = 22702;
