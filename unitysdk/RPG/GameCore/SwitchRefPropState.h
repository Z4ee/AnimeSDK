...
#define RPG_GAMECORE_SWITCHREFPROPSTATE_METHOD_3_95C4C2C38FED2288_OFFSET UNITYSDK_OFFSET(0x1E1530E0)
#define RPG_GAMECORE_SWITCHREFPROPSTATE_METHOD_3_A6A2294FBB2C9ADD_OFFSET UNITYSDK_OFFSET(0x1E1537A0)
#define RPG_GAMECORE_SWITCHREFPROPSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1530D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchRefPropState_TypeDefinitionIndex = 17333;
