...
#define RPG_GAMECORE_SWITCHREFPROPSTATE_METHOD_3_95C4C2C38FED2288_OFFSET UNITYSDK_OFFSET(0x17799710)
#define RPG_GAMECORE_SWITCHREFPROPSTATE_METHOD_3_A6A2294FBB2C9ADD_OFFSET UNITYSDK_OFFSET(0x17799E10)
#define RPG_GAMECORE_SWITCHREFPROPSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x17799700)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchRefPropState_TypeDefinitionIndex = 16108;
