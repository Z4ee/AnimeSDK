...
#define RPG_GAMECORE_GETGAPSECONDSFORSYNCWITHBGM_METHOD_3_32D735CC9CB56F7E_OFFSET UNITYSDK_OFFSET(0x197CFAF0)
#define RPG_GAMECORE_GETGAPSECONDSFORSYNCWITHBGM_METHOD_3_761FA8CC22AD826B_OFFSET UNITYSDK_OFFSET(0x197CFB70)
#define RPG_GAMECORE_GETGAPSECONDSFORSYNCWITHBGM__CTOR_OFFSET UNITYSDK_OFFSET(0x197CFB40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GetGapSecondsForSyncWithBgm_TypeDefinitionIndex = 21590;
	...
	public:
		...
		static ::System::Void Method_3_32D735CC9CB56F7E(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::GetGapSecondsForSyncWithBgm*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::GetGapSecondsForSyncWithBgm*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_GETGAPSECONDSFORSYNCWITHBGM_METHOD_3_32D735CC9CB56F7E_OFFSET))(a1, a2);
		}
