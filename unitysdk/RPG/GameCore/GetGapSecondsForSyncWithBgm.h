...
#define RPG_GAMECORE_GETGAPSECONDSFORSYNCWITHBGM_METHOD_3_761FA8CC22AD826B_OFFSET UNITYSDK_OFFSET(0x1D959A60)
#define RPG_GAMECORE_GETGAPSECONDSFORSYNCWITHBGM_METHOD_3_F7A1D71D3B452B01_OFFSET UNITYSDK_OFFSET(0x1D959A20)
#define RPG_GAMECORE_GETGAPSECONDSFORSYNCWITHBGM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D959A50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GetGapSecondsForSyncWithBgm_TypeDefinitionIndex = 22578;
