...
#define RPG_GAMECORE_GETGAPSECONDSFORSYNCWITHBGM_METHOD_3_32D735CC9CB56F7E_OFFSET UNITYSDK_OFFSET(0x17247B30)
#define RPG_GAMECORE_GETGAPSECONDSFORSYNCWITHBGM_METHOD_3_761FA8CC22AD826B_OFFSET UNITYSDK_OFFSET(0x17247BB0)
#define RPG_GAMECORE_GETGAPSECONDSFORSYNCWITHBGM__CTOR_OFFSET UNITYSDK_OFFSET(0x17247B80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GetGapSecondsForSyncWithBgm_TypeDefinitionIndex = 21034;
