...
#define RPG_GAMECORE_TRIGGERVALIDGUESTSINGLETARGETCONFIG_METHOD_2_2756706129041735_OFFSET UNITYSDK_OFFSET(0x1D29B390)
#define RPG_GAMECORE_TRIGGERVALIDGUESTSINGLETARGETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D29B580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerValidGuestSingleTargetConfig_TypeDefinitionIndex = 23618;
