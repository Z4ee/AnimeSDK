...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXTRABINARYNODERULECONFIG_METHOD_3_B20FEC724D35E1D8_OFFSET UNITYSDK_OFFSET(0x1726AE70)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXTRABINARYNODERULECONFIG_METHOD_3_B82BC2A65E9C22F1_OFFSET UNITYSDK_OFFSET(0x17267480)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXTRABINARYNODERULECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17267430)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierExtraBinaryNodeRuleConfig_TypeDefinitionIndex = 17850;
