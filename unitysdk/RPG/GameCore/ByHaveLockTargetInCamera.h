...
#define RPG_GAMECORE_BYHAVELOCKTARGETINCAMERA_METHOD_4_0802E2A22724B1FD_OFFSET UNITYSDK_OFFSET(0x1A8CEAB0)
#define RPG_GAMECORE_BYHAVELOCKTARGETINCAMERA_METHOD_4_13E8DEB4CBAB4382_OFFSET UNITYSDK_OFFSET(0x1A8CE940)
#define RPG_GAMECORE_BYHAVELOCKTARGETINCAMERA_METHOD_4_85BB37E2F5D96F3C_OFFSET UNITYSDK_OFFSET(0x1A8CEA80)
#define RPG_GAMECORE_BYHAVELOCKTARGETINCAMERA_METHOD_4_CEC5190B5BEEE879_OFFSET UNITYSDK_OFFSET(0x1A8CE900)
#define RPG_GAMECORE_BYHAVELOCKTARGETINCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8CE930)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByHaveLockTargetInCamera_TypeDefinitionIndex = 20000;
