...
#define RPG_GAMECORE_BYHAVELOCKTARGETINCAMERA_METHOD_4_13E8DEB4CBAB4382_OFFSET UNITYSDK_OFFSET(0x1874B530)
#define RPG_GAMECORE_BYHAVELOCKTARGETINCAMERA_METHOD_4_24FD661479F1A8A8_OFFSET UNITYSDK_OFFSET(0x1874B460)
#define RPG_GAMECORE_BYHAVELOCKTARGETINCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x1874B4E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByHaveLockTargetInCamera_TypeDefinitionIndex = 19765;
