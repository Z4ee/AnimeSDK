...
#define RPG_GAMECORE_GRIDFIGHTLEVELCONFIGROW_CLEARWEIGHTLIST_OFFSET UNITYSDK_OFFSET(0x1EE6BAC0)
#define RPG_GAMECORE_GRIDFIGHTLEVELCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1EE6B5A0)
#define RPG_GAMECORE_GRIDFIGHTLEVELCONFIGROW_GETLOTTERYRARITYWEIGHTLIST_OFFSET UNITYSDK_OFFSET(0x1EE6B940)
#define RPG_GAMECORE_GRIDFIGHTLEVELCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1EE6B8E0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 Rarity3Weight; // 0x28
		::System::UInt32 Rarity5Weight; // 0x2C
		::System::UInt32 Rarity2Weight; // 0x30
		::System::UInt32 LevelUpExp; // 0x34
		::System::UInt32 Rarity4Weight; // 0x38
		::System::UInt32 Rarity1Weight; // 0x3C
