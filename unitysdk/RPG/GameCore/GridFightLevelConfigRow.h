...
#define RPG_GAMECORE_GRIDFIGHTLEVELCONFIGROW_CLEARWEIGHTLIST_OFFSET UNITYSDK_OFFSET(0x1D1576F0)
#define RPG_GAMECORE_GRIDFIGHTLEVELCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D1571D0)
#define RPG_GAMECORE_GRIDFIGHTLEVELCONFIGROW_GETLOTTERYRARITYWEIGHTLIST_OFFSET UNITYSDK_OFFSET(0x1D157570)
#define RPG_GAMECORE_GRIDFIGHTLEVELCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D157510)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightLevelConfigRow_TypeDefinitionIndex = 13366;
	...
	public:
		...
		::System::UInt32 AvatarMaxNumber; // 0x2C
		::System::UInt32 GridFightLevel; // 0x30
		::System::UInt32 Rarity2Weight; // 0x34
		::System::UInt32 Rarity1Weight; // 0x38
		::System::UInt32 Rarity3Weight; // 0x3C
