...
#define RPG_GAMECORE_GRIDFIGHTLEVELCONFIGROW_CLEARWEIGHTLIST_OFFSET UNITYSDK_OFFSET(0x197E79E0)
#define RPG_GAMECORE_GRIDFIGHTLEVELCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x197E74D0)
#define RPG_GAMECORE_GRIDFIGHTLEVELCONFIGROW_GETLOTTERYRARITYWEIGHTLIST_OFFSET UNITYSDK_OFFSET(0x197E7860)
#define RPG_GAMECORE_GRIDFIGHTLEVELCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x197E7800)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightLevelConfigRow_TypeDefinitionIndex = 12839;
	...
	public:
		...
		::System::UInt32 AvatarMaxNumber; // 0x24
		::System::UInt32 Rarity5Weight; // 0x28
		::System::UInt32 Rarity2Weight; // 0x2C
		::System::UInt32 LevelUpExp; // 0x30
		::System::UInt32 Rarity1Weight; // 0x34
		::System::UInt32 GridFightLevel; // 0x38
		::System::UInt32 Rarity4Weight; // 0x3C
