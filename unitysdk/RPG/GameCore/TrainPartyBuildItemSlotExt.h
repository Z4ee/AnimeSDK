...
#define RPG_GAMECORE_TRAINPARTYBUILDITEMSLOTEXT_METHOD_2_5DC72E5593BCF730_OFFSET UNITYSDK_OFFSET(0x178A9190)
#define RPG_GAMECORE_TRAINPARTYBUILDITEMSLOTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x178A92E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyBuildItemSlotExt_TypeDefinitionIndex = 14881;
