...
#define RPG_GAMECORE_TRAINPARTYBUILDITEMSLOTEXT_METHOD_2_5B39F325D2EDAAF9_OFFSET UNITYSDK_OFFSET(0x1C15E400)
#define RPG_GAMECORE_TRAINPARTYBUILDITEMSLOTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C15E580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyBuildItemSlotExt_TypeDefinitionIndex = 15622;
