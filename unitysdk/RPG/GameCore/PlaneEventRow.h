...
#define RPG_GAMECORE_PLANEEVENTROW_FROMBINARYWITHOUTNEW_OFFSET UNITYSDK_OFFSET(0x1B4D0130)
#define RPG_GAMECORE_PLANEEVENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B4D0470)
#define RPG_GAMECORE_PLANEEVENTROW_FROMTABLEOFFSET_OFFSET UNITYSDK_OFFSET(0x1B4D1060)
#define RPG_GAMECORE_PLANEEVENTROW_RESET_OFFSET UNITYSDK_OFFSET(0x1B4D10C0)
#define RPG_GAMECORE_PLANEEVENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4D10E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlaneEventRow_TypeDefinitionIndex = 13544;
	...
	public:
		...
		::System::UInt32 AvatarExpReward; // 0x24
