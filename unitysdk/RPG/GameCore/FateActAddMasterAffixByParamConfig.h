...
#define RPG_GAMECORE_FATEACTADDMASTERAFFIXBYPARAMCONFIG_METHOD_6_0EB5B523593B0F02_OFFSET UNITYSDK_OFFSET(0x1970AD70)
#define RPG_GAMECORE_FATEACTADDMASTERAFFIXBYPARAMCONFIG_METHOD_6_FF59C4B6FF9E9649_OFFSET UNITYSDK_OFFSET(0x1970AEE0)
#define RPG_GAMECORE_FATEACTADDMASTERAFFIXBYPARAMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1970AE40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateActAddMasterAffixByParamConfig_TypeDefinitionIndex = 18249;
