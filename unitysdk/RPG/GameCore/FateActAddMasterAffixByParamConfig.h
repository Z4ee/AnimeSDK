...
#define RPG_GAMECORE_FATEACTADDMASTERAFFIXBYPARAMCONFIG_METHOD_6_C09ED3B168AD4DC5_OFFSET UNITYSDK_OFFSET(0x1C073270)
#define RPG_GAMECORE_FATEACTADDMASTERAFFIXBYPARAMCONFIG_METHOD_6_FF59C4B6FF9E9649_OFFSET UNITYSDK_OFFSET(0x1C0732C0)
#define RPG_GAMECORE_FATEACTADDMASTERAFFIXBYPARAMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0732B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateActAddMasterAffixByParamConfig_TypeDefinitionIndex = 18483;
