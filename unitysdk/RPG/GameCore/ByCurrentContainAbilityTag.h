...
#define RPG_GAMECORE_BYCURRENTCONTAINABILITYTAG_METHOD_4_3E606EBE6796AAEB_OFFSET UNITYSDK_OFFSET(0x1CF11590)
#define RPG_GAMECORE_BYCURRENTCONTAINABILITYTAG_METHOD_4_4D56FDA5D7994384_OFFSET UNITYSDK_OFFSET(0x1CF11560)
#define RPG_GAMECORE_BYCURRENTCONTAINABILITYTAG_METHOD_4_77D040ADE0724516_OFFSET UNITYSDK_OFFSET(0x1CF11380)
#define RPG_GAMECORE_BYCURRENTCONTAINABILITYTAG_METHOD_4_BBE265858387C0FB_OFFSET UNITYSDK_OFFSET(0x1CF113C0)
#define RPG_GAMECORE_BYCURRENTCONTAINABILITYTAG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF113B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCurrentContainAbilityTag_TypeDefinitionIndex = 23242;
