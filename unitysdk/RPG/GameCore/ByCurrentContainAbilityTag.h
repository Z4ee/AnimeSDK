...
#define RPG_GAMECORE_BYCURRENTCONTAINABILITYTAG_METHOD_4_380C8106CFED5251_OFFSET UNITYSDK_OFFSET(0x18742E80)
#define RPG_GAMECORE_BYCURRENTCONTAINABILITYTAG_METHOD_4_BBE265858387C0FB_OFFSET UNITYSDK_OFFSET(0x18742F50)
#define RPG_GAMECORE_BYCURRENTCONTAINABILITYTAG__CTOR_OFFSET UNITYSDK_OFFSET(0x18742F00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCurrentContainAbilityTag_TypeDefinitionIndex = 22476;
