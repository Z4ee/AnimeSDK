...
#define RPG_GAMECORE_BYCOMPARERAIDFINISHED_METHOD_4_BA84894764BD1DE4_OFFSET UNITYSDK_OFFSET(0x1A89CBE0)
#define RPG_GAMECORE_BYCOMPARERAIDFINISHED_METHOD_4_F396954FFC6408A8_OFFSET UNITYSDK_OFFSET(0x1A89CB90)
#define RPG_GAMECORE_BYCOMPARERAIDFINISHED__CTOR_OFFSET UNITYSDK_OFFSET(0x1A89CBD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareRaidFinished_TypeDefinitionIndex = 20011;
