...
#define RPG_GAMECORE_FIVEDIMCONTACTEVENTEMITTERCONFIG_METHOD_3_59E6911323879FF4_OFFSET UNITYSDK_OFFSET(0x1BA8E100)
#define RPG_GAMECORE_FIVEDIMCONTACTEVENTEMITTERCONFIG_METHOD_3_5DCCF9E188611963_OFFSET UNITYSDK_OFFSET(0x1BA8E0C0)
#define RPG_GAMECORE_FIVEDIMCONTACTEVENTEMITTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA8E0F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimContactEventEmitterConfig_TypeDefinitionIndex = 17911;
