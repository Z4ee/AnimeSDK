...
#define RPG_GAMECORE_FIVEDIMCONTACTEVENTEMITTERCONFIG_METHOD_3_59E6911323879FF4_OFFSET UNITYSDK_OFFSET(0x188FACF0)
#define RPG_GAMECORE_FIVEDIMCONTACTEVENTEMITTERCONFIG_METHOD_3_FDBE152E4FCD6AD1_OFFSET UNITYSDK_OFFSET(0x188FAC80)
#define RPG_GAMECORE_FIVEDIMCONTACTEVENTEMITTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x188FACD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimContactEventEmitterConfig_TypeDefinitionIndex = 17709;
