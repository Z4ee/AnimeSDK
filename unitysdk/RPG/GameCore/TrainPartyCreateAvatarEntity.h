...
#define RPG_GAMECORE_TRAINPARTYCREATEAVATARENTITY_METHOD_3_3AF55DC6707AEA4E_OFFSET UNITYSDK_OFFSET(0x178AAA10)
#define RPG_GAMECORE_TRAINPARTYCREATEAVATARENTITY_METHOD_3_DCC8BC18A2E3EA28_OFFSET UNITYSDK_OFFSET(0x178AA950)
#define RPG_GAMECORE_TRAINPARTYCREATEAVATARENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x178AA9C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyCreateAvatarEntity_TypeDefinitionIndex = 20562;
