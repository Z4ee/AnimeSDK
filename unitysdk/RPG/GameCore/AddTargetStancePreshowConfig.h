...
#define RPG_GAMECORE_ADDTARGETSTANCEPRESHOWCONFIG_METHOD_3_7F3FC16313942795_OFFSET UNITYSDK_OFFSET(0x1BE0A6B0)
#define RPG_GAMECORE_ADDTARGETSTANCEPRESHOWCONFIG_METHOD_3_88F8505E00C6C24D_OFFSET UNITYSDK_OFFSET(0x1BE0A970)
#define RPG_GAMECORE_ADDTARGETSTANCEPRESHOWCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE0A6F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddTargetStancePreshowConfig_TypeDefinitionIndex = 22834;
