...
#define RPG_GAMECORE_ADDTARGETSTANCEPRESHOWCONFIG_METHOD_3_7F3FC16313942795_OFFSET UNITYSDK_OFFSET(0x18643A00)
#define RPG_GAMECORE_ADDTARGETSTANCEPRESHOWCONFIG_METHOD_3_88F8505E00C6C24D_OFFSET UNITYSDK_OFFSET(0x18643CB0)
#define RPG_GAMECORE_ADDTARGETSTANCEPRESHOWCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18643A40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddTargetStancePreshowConfig_TypeDefinitionIndex = 22675;
