...
#define RPG_GAMECORE_WAITWOLFBROPUZZLESTARTUP_METHOD_3_C83AC6124C722FF7_OFFSET UNITYSDK_OFFSET(0x1D1BFD10)
#define RPG_GAMECORE_WAITWOLFBROPUZZLESTARTUP_METHOD_3_FDFA7FF0D59EB8CE_OFFSET UNITYSDK_OFFSET(0x1D1BFD60)
#define RPG_GAMECORE_WAITWOLFBROPUZZLESTARTUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1BFD50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitWolfBroPuzzleStartup_TypeDefinitionIndex = 21186;
