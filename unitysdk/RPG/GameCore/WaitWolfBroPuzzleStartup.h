...
#define RPG_GAMECORE_WAITWOLFBROPUZZLESTARTUP_METHOD_3_1E60118EDB88E0EE_OFFSET UNITYSDK_OFFSET(0x1910C770)
#define RPG_GAMECORE_WAITWOLFBROPUZZLESTARTUP_METHOD_3_FFFDD2D9CB6F36ED_OFFSET UNITYSDK_OFFSET(0x1910C800)
#define RPG_GAMECORE_WAITWOLFBROPUZZLESTARTUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1910C7D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitWolfBroPuzzleStartup_TypeDefinitionIndex = 20851;
