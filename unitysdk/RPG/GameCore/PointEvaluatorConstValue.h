...
#define RPG_GAMECORE_POINTEVALUATORCONSTVALUE_METHOD_2_E2AB6B457551DEDF_OFFSET UNITYSDK_OFFSET(0x1BA13540)
#define RPG_GAMECORE_POINTEVALUATORCONSTVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA13620)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PointEvaluatorConstValue_TypeDefinitionIndex = 15024;
