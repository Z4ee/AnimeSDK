...
#define RPG_GAMECORE_TRACEENTITYMAPPINGINFO_METHOD_3_680A24B0C7982357_OFFSET UNITYSDK_OFFSET(0x190A0DB0)
#define RPG_GAMECORE_TRACEENTITYMAPPINGINFO_METHOD_3_E96D1775893488C6_OFFSET UNITYSDK_OFFSET(0x190A0E30)
#define RPG_GAMECORE_TRACEENTITYMAPPINGINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x190A0E00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TraceEntityMappingInfo_TypeDefinitionIndex = 19659;
