...
#define RPG_GAMECORE_TRACEENTITYMAPPINGINFO_METHOD_3_635E495759DE4F45_OFFSET UNITYSDK_OFFSET(0x1C157FF0)
#define RPG_GAMECORE_TRACEENTITYMAPPINGINFO_METHOD_3_E96D1775893488C6_OFFSET UNITYSDK_OFFSET(0x1C158030)
#define RPG_GAMECORE_TRACEENTITYMAPPINGINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1C158020)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TraceEntityMappingInfo_TypeDefinitionIndex = 19899;
