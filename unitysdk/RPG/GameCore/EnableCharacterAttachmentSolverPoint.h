...
#define RPG_GAMECORE_ENABLECHARACTERATTACHMENTSOLVERPOINT_METHOD_3_657EE5DE06E79386_OFFSET UNITYSDK_OFFSET(0x188A4C60)
#define RPG_GAMECORE_ENABLECHARACTERATTACHMENTSOLVERPOINT_METHOD_3_F98881DF0E34F14B_OFFSET UNITYSDK_OFFSET(0x188A4CE0)
#define RPG_GAMECORE_ENABLECHARACTERATTACHMENTSOLVERPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x188A4CB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnableCharacterAttachmentSolverPoint_TypeDefinitionIndex = 21306;
