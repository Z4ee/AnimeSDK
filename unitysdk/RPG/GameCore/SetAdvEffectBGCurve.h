...
#define RPG_GAMECORE_SETADVEFFECTBGCURVE_METHOD_3_0DEE85CFF2A6FE66_OFFSET UNITYSDK_OFFSET(0x1C2D0D20)
#define RPG_GAMECORE_SETADVEFFECTBGCURVE_METHOD_3_7B143ECF9C9634CF_OFFSET UNITYSDK_OFFSET(0x1C2D0CE0)
#define RPG_GAMECORE_SETADVEFFECTBGCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2D0D10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetAdvEffectBGCurve_TypeDefinitionIndex = 21511;
