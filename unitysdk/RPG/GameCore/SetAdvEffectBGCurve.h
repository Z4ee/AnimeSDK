...
#define RPG_GAMECORE_SETADVEFFECTBGCURVE_METHOD_3_0DEE85CFF2A6FE66_OFFSET UNITYSDK_OFFSET(0x18E07FA0)
#define RPG_GAMECORE_SETADVEFFECTBGCURVE_METHOD_3_C5AD9082C7A27939_OFFSET UNITYSDK_OFFSET(0x18E07F20)
#define RPG_GAMECORE_SETADVEFFECTBGCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E07F70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetAdvEffectBGCurve_TypeDefinitionIndex = 21200;
