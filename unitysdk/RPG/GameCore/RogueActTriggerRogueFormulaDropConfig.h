...
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEFORMULADROPCONFIG_METHOD_6_033D93BA0361B239_OFFSET UNITYSDK_OFFSET(0x18CD71B0)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEFORMULADROPCONFIG_METHOD_6_3224103E220103C4_OFFSET UNITYSDK_OFFSET(0x18CD6F90)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEFORMULADROPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CD70D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActTriggerRogueFormulaDropConfig_TypeDefinitionIndex = 18654;
