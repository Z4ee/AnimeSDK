...
#define RPG_GAMECORE_LEVELTURNAVATARCHANGEBEGIN_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x19780DD0)
#define RPG_GAMECORE_LEVELTURNAVATARCHANGEBEGIN_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x19780E20)
#define RPG_GAMECORE_LEVELTURNAVATARCHANGEBEGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x19780DC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelTurnAvatarChangeBegin_TypeDefinitionIndex = 54172;
