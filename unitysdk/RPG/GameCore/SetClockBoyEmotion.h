...
#define RPG_GAMECORE_SETCLOCKBOYEMOTION_METHOD_3_87BA799B3E845615_OFFSET UNITYSDK_OFFSET(0x1D4E86B0)
#define RPG_GAMECORE_SETCLOCKBOYEMOTION_METHOD_3_F58F6AD0D18ADC50_OFFSET UNITYSDK_OFFSET(0x1D4E8670)
#define RPG_GAMECORE_SETCLOCKBOYEMOTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4E86A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetClockBoyEmotion_TypeDefinitionIndex = 21646;
