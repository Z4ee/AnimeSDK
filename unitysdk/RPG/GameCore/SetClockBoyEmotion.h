...
#define RPG_GAMECORE_SETCLOCKBOYEMOTION_METHOD_3_25F626A2D66BB02B_OFFSET UNITYSDK_OFFSET(0x176AFA90)
#define RPG_GAMECORE_SETCLOCKBOYEMOTION_METHOD_3_9E12C3FB0BE884DA_OFFSET UNITYSDK_OFFSET(0x176AFB10)
#define RPG_GAMECORE_SETCLOCKBOYEMOTION__CTOR_OFFSET UNITYSDK_OFFSET(0x176AFAE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetClockBoyEmotion_TypeDefinitionIndex = 20064;
