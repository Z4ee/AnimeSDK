...
#define RPG_GAMECORE_VCAMERADOFFOCUSENTITY_METHOD_2_D7061E4723EC8564_OFFSET UNITYSDK_OFFSET(0x190EB0D0)
#define RPG_GAMECORE_VCAMERADOFFOCUSENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x190EB930)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VCameraDOFFocusEntity_TypeDefinitionIndex = 15540;
