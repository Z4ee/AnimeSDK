...
#define RPG_GAMECORE_BYLOCALWIN_METHOD_4_A953868FB7B40733_OFFSET UNITYSDK_OFFSET(0x1875B260)
#define RPG_GAMECORE_BYLOCALWIN_METHOD_4_BDF9891C50790BB9_OFFSET UNITYSDK_OFFSET(0x1875B330)
#define RPG_GAMECORE_BYLOCALWIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1875B2E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByLocalWin_TypeDefinitionIndex = 22500;
