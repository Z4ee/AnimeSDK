...
#define RPG_GAMECORE_CHIMERADUELCHIMERADYNAMICVALUEGETTER_METHOD_3_1BB79544D109A892_OFFSET UNITYSDK_OFFSET(0x19638580)
#define RPG_GAMECORE_CHIMERADUELCHIMERADYNAMICVALUEGETTER_METHOD_3_FF4E9954F43E5EF4_OFFSET UNITYSDK_OFFSET(0x196385E0)
#define RPG_GAMECORE_CHIMERADUELCHIMERADYNAMICVALUEGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x196385D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelChimeraDynamicValueGetter_TypeDefinitionIndex = 15225;
