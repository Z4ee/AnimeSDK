...
#define RPG_GAMECORE_ACTIVEMARBLEVIRTUALCAMERA_METHOD_4_D7DDA170B7F90816_OFFSET UNITYSDK_OFFSET(0x16E9FB10)
#define RPG_GAMECORE_ACTIVEMARBLEVIRTUALCAMERA_METHOD_4_EF3DE278BF422031_OFFSET UNITYSDK_OFFSET(0x16E9FA50)
#define RPG_GAMECORE_ACTIVEMARBLEVIRTUALCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x16E9FAC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActiveMarbleVirtualCamera_TypeDefinitionIndex = 20223;
