...
#define RPG_GAMECORE_AETHERDIVIDETRIGGERATTACK_METHOD_4_99AF1A8AE3653ACB_OFFSET UNITYSDK_OFFSET(0x1AE63EB0)
#define RPG_GAMECORE_AETHERDIVIDETRIGGERATTACK_METHOD_4_C9310BCB76509618_OFFSET UNITYSDK_OFFSET(0x1AE71D50)
#define RPG_GAMECORE_AETHERDIVIDETRIGGERATTACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE63E50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AetherDivideTriggerAttack_TypeDefinitionIndex = 19428;
