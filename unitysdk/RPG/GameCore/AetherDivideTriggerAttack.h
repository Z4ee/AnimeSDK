...
#define RPG_GAMECORE_AETHERDIVIDETRIGGERATTACK_METHOD_4_1EE9BB2804C8B954_OFFSET UNITYSDK_OFFSET(0x1868D820)
#define RPG_GAMECORE_AETHERDIVIDETRIGGERATTACK_METHOD_4_FC74CF860EB0C530_OFFSET UNITYSDK_OFFSET(0x1868D920)
#define RPG_GAMECORE_AETHERDIVIDETRIGGERATTACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1868D8B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AetherDivideTriggerAttack_TypeDefinitionIndex = 19144;
