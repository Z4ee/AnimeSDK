...
#define RPG_GAMECORE_AETHERDIVIDETRIGGERATTACK_METHOD_4_99AF1A8AE3653ACB_OFFSET UNITYSDK_OFFSET(0x1CDF8CF0)
#define RPG_GAMECORE_AETHERDIVIDETRIGGERATTACK_METHOD_4_C9310BCB76509618_OFFSET UNITYSDK_OFFSET(0x1CE06C50)
#define RPG_GAMECORE_AETHERDIVIDETRIGGERATTACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDF8C90)
