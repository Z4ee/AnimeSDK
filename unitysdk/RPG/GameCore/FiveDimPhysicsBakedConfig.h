...
#define RPG_GAMECORE_FIVEDIMPHYSICSBAKEDCONFIG_METHOD_2_9AB856C646928E60_OFFSET UNITYSDK_OFFSET(0x1D0F1EE0)
#define RPG_GAMECORE_FIVEDIMPHYSICSBAKEDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0F7460)
