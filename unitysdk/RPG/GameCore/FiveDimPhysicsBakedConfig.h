...
#define RPG_GAMECORE_FIVEDIMPHYSICSBAKEDCONFIG_METHOD_2_9AB856C646928E60_OFFSET UNITYSDK_OFFSET(0x171FC1C0)
#define RPG_GAMECORE_FIVEDIMPHYSICSBAKEDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17200930)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimPhysicsBakedConfig_TypeDefinitionIndex = 15256;
