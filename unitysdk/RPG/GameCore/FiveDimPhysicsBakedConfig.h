...
#define RPG_GAMECORE_FIVEDIMPHYSICSBAKEDCONFIG_METHOD_2_9AB856C646928E60_OFFSET UNITYSDK_OFFSET(0x19747D50)
#define RPG_GAMECORE_FIVEDIMPHYSICSBAKEDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1974BE80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimPhysicsBakedConfig_TypeDefinitionIndex = 15825;
