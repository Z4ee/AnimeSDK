...
#define RPG_GAMECORE_FIVEDIMPHYSICSBAKEDCONFIG_METHOD_2_9AB856C646928E60_OFFSET UNITYSDK_OFFSET(0x1BEA2890)
#define RPG_GAMECORE_FIVEDIMPHYSICSBAKEDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEA7740)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimPhysicsBakedConfig_TypeDefinitionIndex = 15999;
