...
#define RPG_GAMECORE_BATTLEQTEBASECONFIG_METHOD_2_454B3E92A821C610_OFFSET UNITYSDK_OFFSET(0x16FDF720)
#define RPG_GAMECORE_BATTLEQTEBASECONFIG_METHOD_2_6A4FB82806DB8594_OFFSET UNITYSDK_OFFSET(0x16FE00D0)
#define RPG_GAMECORE_BATTLEQTEBASECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16FE0310)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleQTEBaseConfig_TypeDefinitionIndex = 21575;
