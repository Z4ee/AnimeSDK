...
#define RPG_GAMECORE_BATTLEQTEBASECONFIG_METHOD_2_AE3B0306477AA916_OFFSET UNITYSDK_OFFSET(0x1CE7ED10)
#define RPG_GAMECORE_BATTLEQTEBASECONFIG_METHOD_2_EEA3D02CCC577E76_OFFSET UNITYSDK_OFFSET(0x1CE7E370)
#define RPG_GAMECORE_BATTLEQTEBASECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE7EF50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleQTEBaseConfig_TypeDefinitionIndex = 23078;
	...
	public:
		...
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::BattleQTEBaseConfig*))((::PBYTE)hIl2Cpp + RPG_GAMECORE_BATTLEQTEBASECONFIG_METHOD_2_AE3B0306477AA916_OFFSET))(a1, a2);
		}
	};
}
