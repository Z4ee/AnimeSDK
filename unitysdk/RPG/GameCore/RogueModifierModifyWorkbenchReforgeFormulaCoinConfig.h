...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYWORKBENCHREFORGEFORMULACOINCONFIG_METHOD_3_7A0E2DFD1BA559FD_OFFSET UNITYSDK_OFFSET(0x17636CD0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYWORKBENCHREFORGEFORMULACOINCONFIG_METHOD_3_F6526BA253B238B4_OFFSET UNITYSDK_OFFSET(0x17636DA0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYWORKBENCHREFORGEFORMULACOINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17636D50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyWorkbenchReforgeFormulaCoinConfig_TypeDefinitionIndex = 16423;
