...
#define RPG_GAMECORE_RESTAURANTPRODUCTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D023060)
#define RPG_GAMECORE_RESTAURANTPRODUCTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0232B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RestaurantProductConfigRow_TypeDefinitionIndex = 10986;
