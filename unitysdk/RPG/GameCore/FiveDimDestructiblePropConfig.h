...
#define RPG_GAMECORE_FIVEDIMDESTRUCTIBLEPROPCONFIG_METHOD_3_A057B6CB50B128DF_OFFSET UNITYSDK_OFFSET(0x1D0E0520)
#define RPG_GAMECORE_FIVEDIMDESTRUCTIBLEPROPCONFIG_METHOD_3_D596F24D78A575E6_OFFSET UNITYSDK_OFFSET(0x1D0E0560)
#define RPG_GAMECORE_FIVEDIMDESTRUCTIBLEPROPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0E0550)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimDestructiblePropConfig_TypeDefinitionIndex = 18332;
