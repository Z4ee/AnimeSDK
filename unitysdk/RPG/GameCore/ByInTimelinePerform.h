...
#define RPG_GAMECORE_BYINTIMELINEPERFORM_METHOD_4_30D96221BE09F8C6_OFFSET UNITYSDK_OFFSET(0x1A8D1F70)
#define RPG_GAMECORE_BYINTIMELINEPERFORM_METHOD_4_8F32B9F609B767B7_OFFSET UNITYSDK_OFFSET(0x1A8D1F20)
#define RPG_GAMECORE_BYINTIMELINEPERFORM_METHOD_4_F10D6FBB06FF0492_OFFSET UNITYSDK_OFFSET(0x1A8D2110)
#define RPG_GAMECORE_BYINTIMELINEPERFORM_METHOD_4_F7BECA12349658E5_OFFSET UNITYSDK_OFFSET(0x1A8D2150)
#define RPG_GAMECORE_BYINTIMELINEPERFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8D1F60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByInTimelinePerform_TypeDefinitionIndex = 22469;
