...
#define RPG_GAMECORE_BYINTIMELINEPERFORM_METHOD_4_30D96221BE09F8C6_OFFSET UNITYSDK_OFFSET(0x17027D10)
#define RPG_GAMECORE_BYINTIMELINEPERFORM_METHOD_4_FE43C45240E2DD98_OFFSET UNITYSDK_OFFSET(0x17027C30)
#define RPG_GAMECORE_BYINTIMELINEPERFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x17027CB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByInTimelinePerform_TypeDefinitionIndex = 21539;
