...
#define RPG_GAMECORE_FATERINCASEBOARDHOUGUINFO_METHOD_2_4E45B7E421561919_OFFSET UNITYSDK_OFFSET(0x1E0D0710)
#define RPG_GAMECORE_FATERINCASEBOARDHOUGUINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0D0A90)
