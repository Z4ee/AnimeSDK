...
#define RPG_GAMECORE_SETSWITCHMASCOTLOCKDISTANCE_METHOD_3_2047B2CA654F55DD_OFFSET UNITYSDK_OFFSET(0x176E0940)
#define RPG_GAMECORE_SETSWITCHMASCOTLOCKDISTANCE_METHOD_3_695166BA7B89FC56_OFFSET UNITYSDK_OFFSET(0x176E08C0)
#define RPG_GAMECORE_SETSWITCHMASCOTLOCKDISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x176E0910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetSwitchMascotLockDistance_TypeDefinitionIndex = 20178;
