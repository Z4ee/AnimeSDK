...
#define RPG_GAMECORE_PERFORMANCESUBMISSIONLINKROW_FROMBINARYWITHOUTNEW_OFFSET UNITYSDK_OFFSET(0x1B4B8D50)
#define RPG_GAMECORE_PERFORMANCESUBMISSIONLINKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B4B8EF0)
#define RPG_GAMECORE_PERFORMANCESUBMISSIONLINKROW_FROMTABLEOFFSET_OFFSET UNITYSDK_OFFSET(0x1B4B8CD0)
#define RPG_GAMECORE_PERFORMANCESUBMISSIONLINKROW_RESET_OFFSET UNITYSDK_OFFSET(0x1B4B8D30)
#define RPG_GAMECORE_PERFORMANCESUBMISSIONLINKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4B90D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PerformanceSubMissionLinkRow_TypeDefinitionIndex = 13825;
