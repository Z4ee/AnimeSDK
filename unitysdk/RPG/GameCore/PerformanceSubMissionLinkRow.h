...
#define RPG_GAMECORE_PERFORMANCESUBMISSIONLINKROW_FROMBINARYWITHOUTNEW_OFFSET UNITYSDK_OFFSET(0x174A22A0)
#define RPG_GAMECORE_PERFORMANCESUBMISSIONLINKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x174A2440)
#define RPG_GAMECORE_PERFORMANCESUBMISSIONLINKROW_FROMTABLEOFFSET_OFFSET UNITYSDK_OFFSET(0x174A2220)
#define RPG_GAMECORE_PERFORMANCESUBMISSIONLINKROW_RESET_OFFSET UNITYSDK_OFFSET(0x174A2280)
#define RPG_GAMECORE_PERFORMANCESUBMISSIONLINKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x174A2620)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PerformanceSubMissionLinkRow_TypeDefinitionIndex = 13145;
