...
#define RPG_GAMECORE_RTBYHASLOCKTARGET_METHOD_4_07FAD046819A39E1_OFFSET UNITYSDK_OFFSET(0x1BB8DA30)
#define RPG_GAMECORE_RTBYHASLOCKTARGET_METHOD_4_3130CE4B5A43767D_OFFSET UNITYSDK_OFFSET(0x1BB8DBE0)
#define RPG_GAMECORE_RTBYHASLOCKTARGET_METHOD_4_AE5270B06B0F67E4_OFFSET UNITYSDK_OFFSET(0x1BB8D9F0)
#define RPG_GAMECORE_RTBYHASLOCKTARGET_METHOD_4_D33649BE8A8F6C9B_OFFSET UNITYSDK_OFFSET(0x1BB8DBB0)
#define RPG_GAMECORE_RTBYHASLOCKTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB8DA20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtByHasLockTarget_TypeDefinitionIndex = 23378;
