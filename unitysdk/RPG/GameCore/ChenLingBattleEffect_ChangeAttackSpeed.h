...
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_CHANGEATTACKSPEED_METHOD_3_1B9119D2DAE3A25C_OFFSET UNITYSDK_OFFSET(0x196208D0)
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_CHANGEATTACKSPEED_METHOD_3_ABCD5E75C6E464A8_OFFSET UNITYSDK_OFFSET(0x196209A0)
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_CHANGEATTACKSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x19620990)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleEffect_ChangeAttackSpeed_TypeDefinitionIndex = 15018;
