...
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_CHANGEATTACKSPEED_METHOD_3_1B9119D2DAE3A25C_OFFSET UNITYSDK_OFFSET(0x1C37ABD0)
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_CHANGEATTACKSPEED_METHOD_3_ABCD5E75C6E464A8_OFFSET UNITYSDK_OFFSET(0x1C37ACA0)
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_CHANGEATTACKSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x1C37AC90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleEffect_ChangeAttackSpeed_TypeDefinitionIndex = 15182;
