...
#define RPG_GAMECORE_BYCOMPAREMODIFIERCUSTOMEVENT_METHOD_4_CB3CEE0FC00186DB_OFFSET UNITYSDK_OFFSET(0x187333B0)
#define RPG_GAMECORE_BYCOMPAREMODIFIERCUSTOMEVENT_METHOD_4_EFFEAE04FBFE50B9_OFFSET UNITYSDK_OFFSET(0x18733480)
#define RPG_GAMECORE_BYCOMPAREMODIFIERCUSTOMEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x18733430)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareModifierCustomEvent_TypeDefinitionIndex = 21972;
