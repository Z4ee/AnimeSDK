...
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUENPCGROUPCONFIG_METHOD_3_5117CECCC355EEBE_OFFSET UNITYSDK_OFFSET(0x17638E10)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUENPCGROUPCONFIG_METHOD_3_ADAC5D405A9BF9B7_OFFSET UNITYSDK_OFFSET(0x1762C310)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUENPCGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1762C2C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierReplaceContentRogueNPCGroupConfig_TypeDefinitionIndex = 16256;
