...
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUENPCGROUPCONFIG_METHOD_3_ADAC5D405A9BF9B7_OFFSET UNITYSDK_OFFSET(0x1D165C70)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUENPCGROUPCONFIG_METHOD_3_F370D944EE9EF573_OFFSET UNITYSDK_OFFSET(0x1D165C20)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUENPCGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D165C60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierReplaceContentRogueNPCGroupConfig_TypeDefinitionIndex = 16987;
