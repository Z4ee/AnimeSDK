...
#define RPG_GAMECORE_MODIFYAIVISIONEXCLUDETAGRUNTIME_METHOD_3_63A50D62F8406B77_OFFSET UNITYSDK_OFFSET(0x1D1B52B0)
#define RPG_GAMECORE_MODIFYAIVISIONEXCLUDETAGRUNTIME_METHOD_3_FA28B6C6F056AAEE_OFFSET UNITYSDK_OFFSET(0x1D1B5300)
#define RPG_GAMECORE_MODIFYAIVISIONEXCLUDETAGRUNTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1B52F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyAiVisionExcludeTagRuntime_TypeDefinitionIndex = 21499;
