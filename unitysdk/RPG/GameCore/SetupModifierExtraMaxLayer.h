...
#define RPG_GAMECORE_SETUPMODIFIEREXTRAMAXLAYER_METHOD_3_0948C4EF066D6C89_OFFSET UNITYSDK_OFFSET(0x1BE30240)
#define RPG_GAMECORE_SETUPMODIFIEREXTRAMAXLAYER_METHOD_3_CE715D07205757B5_OFFSET UNITYSDK_OFFSET(0x1BE30200)
#define RPG_GAMECORE_SETUPMODIFIEREXTRAMAXLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE30230)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetupModifierExtraMaxLayer_TypeDefinitionIndex = 22427;
