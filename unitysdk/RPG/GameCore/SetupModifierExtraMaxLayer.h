...
#define RPG_GAMECORE_SETUPMODIFIEREXTRAMAXLAYER_METHOD_3_0948C4EF066D6C89_OFFSET UNITYSDK_OFFSET(0x176EAC80)
#define RPG_GAMECORE_SETUPMODIFIEREXTRAMAXLAYER_METHOD_3_9B61A110AFDF3D56_OFFSET UNITYSDK_OFFSET(0x176EAC00)
#define RPG_GAMECORE_SETUPMODIFIEREXTRAMAXLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x176EAC50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetupModifierExtraMaxLayer_TypeDefinitionIndex = 21492;
