...
#define RPG_GAMECORE_ROGUEPARAMFORMULACATEGORYCOUNTCONFIG_METHOD_6_905A1819997000F4_OFFSET UNITYSDK_OFFSET(0x1764AE20)
#define RPG_GAMECORE_ROGUEPARAMFORMULACATEGORYCOUNTCONFIG_METHOD_6_95F84992E9A2F37A_OFFSET UNITYSDK_OFFSET(0x1764AB70)
#define RPG_GAMECORE_ROGUEPARAMFORMULACATEGORYCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1764ACF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamFormulaCategoryCountConfig_TypeDefinitionIndex = 18167;
