...
#define RPG_GAMECORE_CHIMERADUELRELATIVEPOSITIONSELECTORCONFIG_METHOD_3_A7E58F01CCC4F9BA_OFFSET UNITYSDK_OFFSET(0x170A46E0)
#define RPG_GAMECORE_CHIMERADUELRELATIVEPOSITIONSELECTORCONFIG_METHOD_3_EBE2437591073136_OFFSET UNITYSDK_OFFSET(0x170A45E0)
#define RPG_GAMECORE_CHIMERADUELRELATIVEPOSITIONSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x170A46D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelRelativePositionSelectorConfig_TypeDefinitionIndex = 14596;
