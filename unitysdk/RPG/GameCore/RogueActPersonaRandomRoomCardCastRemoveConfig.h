...
#define RPG_GAMECORE_ROGUEACTPERSONARANDOMROOMCARDCASTREMOVECONFIG_METHOD_7_12EB539606EF860B_OFFSET UNITYSDK_OFFSET(0x18CCC0D0)
#define RPG_GAMECORE_ROGUEACTPERSONARANDOMROOMCARDCASTREMOVECONFIG_METHOD_7_B5CA4D9E24AF55CE_OFFSET UNITYSDK_OFFSET(0x18CCBC00)
#define RPG_GAMECORE_ROGUEACTPERSONARANDOMROOMCARDCASTREMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CCBB20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaRandomRoomCardCastRemoveConfig_TypeDefinitionIndex = 18733;
