...
#define RPG_GAMECORE_ELATIONACTIONBARABILITYCHANGE_METHOD_3_6030A8BD0415313F_OFFSET UNITYSDK_OFFSET(0x1DB24C80)
#define RPG_GAMECORE_ELATIONACTIONBARABILITYCHANGE_METHOD_3_D5434E9DC65D2F9E_OFFSET UNITYSDK_OFFSET(0x1DB24CD0)
#define RPG_GAMECORE_ELATIONACTIONBARABILITYCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB24CC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElationActionBarAbilityChange_TypeDefinitionIndex = 22575;
