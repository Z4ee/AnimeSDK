...
#define RPG_GAMECORE_ELATIONACTIONBARABILITYCHANGE_METHOD_3_902BA481967CB9E7_OFFSET UNITYSDK_OFFSET(0x1718A300)
#define RPG_GAMECORE_ELATIONACTIONBARABILITYCHANGE_METHOD_3_D5434E9DC65D2F9E_OFFSET UNITYSDK_OFFSET(0x1718A380)
#define RPG_GAMECORE_ELATIONACTIONBARABILITYCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1718A350)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElationActionBarAbilityChange_TypeDefinitionIndex = 21031;
