...
#define RPG_GAMECORE_ACTIVITYFEVERTIMEUNDERLINEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16EF7D80)
#define RPG_GAMECORE_ACTIVITYFEVERTIMEUNDERLINEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16EF8340)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityFeverTimeUnderlineRow_TypeDefinitionIndex = 10791;
