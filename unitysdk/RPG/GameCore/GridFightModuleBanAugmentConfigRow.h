...
#define RPG_GAMECORE_GRIDFIGHTMODULEBANAUGMENTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x197F4E70)
#define RPG_GAMECORE_GRIDFIGHTMODULEBANAUGMENTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x197F4F90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModuleBanAugmentConfigRow_TypeDefinitionIndex = 12843;
