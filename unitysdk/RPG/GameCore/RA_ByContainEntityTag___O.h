...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_D837DED66799FBE3_DelegateParseJson_1<::RPG::GameCore::EntityTag>**)Il2CppClass::FromTypeDefinitionIndex(RA_ByContainEntityTag___O_TypeDefinitionIndex)->GetStaticField(0x4840);
		}
	};
}
