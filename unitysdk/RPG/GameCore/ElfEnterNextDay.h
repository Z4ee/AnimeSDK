...
#define RPG_GAMECORE_ELFENTERNEXTDAY_METHOD_3_88DA98DBFB01D335_OFFSET UNITYSDK_OFFSET(0x1889B6F0)
#define RPG_GAMECORE_ELFENTERNEXTDAY_METHOD_3_9DFEFBBA653AB8A1_OFFSET UNITYSDK_OFFSET(0x1889B5E0)
#define RPG_GAMECORE_ELFENTERNEXTDAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1889B6C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfEnterNextDay_TypeDefinitionIndex = 20581;
