...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERDRESSEQUIPCONFIG_METHOD_3_8ACE5A9EE19772F3_OFFSET UNITYSDK_OFFSET(0x189BBE80)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERDRESSEQUIPCONFIG_METHOD_3_FCC79826EA52F5AA_OFFSET UNITYSDK_OFFSET(0x189B8A30)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERDRESSEQUIPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189B89E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierExecActionAfterDressEquipConfig_TypeDefinitionIndex = 18499;
