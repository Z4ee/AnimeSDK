...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERDRESSEQUIPCONFIG_METHOD_3_F87B703B3CF5D5EE_OFFSET UNITYSDK_OFFSET(0x1C5D0F90)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERDRESSEQUIPCONFIG_METHOD_3_FCC79826EA52F5AA_OFFSET UNITYSDK_OFFSET(0x1C5D0FE0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERDRESSEQUIPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5D0FD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierExecActionAfterDressEquipConfig_TypeDefinitionIndex = 18721;
