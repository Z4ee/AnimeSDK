...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERDRESSEQUIPCONFIG_METHOD_3_8ACE5A9EE19772F3_OFFSET UNITYSDK_OFFSET(0x1726A5F0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERDRESSEQUIPCONFIG_METHOD_3_FCC79826EA52F5AA_OFFSET UNITYSDK_OFFSET(0x172665A0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERDRESSEQUIPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17266550)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierExecActionAfterDressEquipConfig_TypeDefinitionIndex = 17873;
