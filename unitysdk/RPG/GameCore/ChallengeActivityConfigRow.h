...
#define RPG_GAMECORE_CHALLENGEACTIVITYCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x187B9D40)
#define RPG_GAMECORE_CHALLENGEACTIVITYCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x187B9F40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChallengeActivityConfigRow_TypeDefinitionIndex = 12231;
	...
	public:
		...
		::Il2CppArray<::System::UInt32>* MarkScoreList; // 0x20
