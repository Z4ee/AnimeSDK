...
#define RPG_GAMECORE_RANGECONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19AB1000)
#define RPG_GAMECORE_RANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AB1120)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RangeConfig_TypeDefinitionIndex = 12438;
