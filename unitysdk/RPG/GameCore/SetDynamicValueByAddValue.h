...
#define RPG_GAMECORE_SETDYNAMICVALUEBYADDVALUE_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1C2DE4C0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYADDVALUE_METHOD_4_BB2BA99D870B607E_OFFSET UNITYSDK_OFFSET(0x1C2DE1F0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYADDVALUE_METHOD_4_F9B70757488C580E_OFFSET UNITYSDK_OFFSET(0x1C2DE1B0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYADDVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2DE1E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByAddValue_TypeDefinitionIndex = 22074;
