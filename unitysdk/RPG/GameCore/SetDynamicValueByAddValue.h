...
#define RPG_GAMECORE_SETDYNAMICVALUEBYADDVALUE_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x19C400F0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYADDVALUE_METHOD_4_2F971818F4DB2272_OFFSET UNITYSDK_OFFSET(0x19C40070)
#define RPG_GAMECORE_SETDYNAMICVALUEBYADDVALUE_METHOD_4_BB2BA99D870B607E_OFFSET UNITYSDK_OFFSET(0x19C35D40)
#define RPG_GAMECORE_SETDYNAMICVALUEBYADDVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C35CF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByAddValue_TypeDefinitionIndex = 21648;
