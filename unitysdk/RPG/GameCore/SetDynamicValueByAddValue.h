...
#define RPG_GAMECORE_SETDYNAMICVALUEBYADDVALUE_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x176C02A0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYADDVALUE_METHOD_4_2F971818F4DB2272_OFFSET UNITYSDK_OFFSET(0x176C0220)
#define RPG_GAMECORE_SETDYNAMICVALUEBYADDVALUE_METHOD_4_BB2BA99D870B607E_OFFSET UNITYSDK_OFFSET(0x176B6CB0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYADDVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x176B6C60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByAddValue_TypeDefinitionIndex = 21094;
