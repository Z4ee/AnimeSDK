...
#define RPG_GAMECORE_ROGUEMODIFIEREXTRABUFFONBATTLEFIRSTSELECTCONFIG_METHOD_3_5487DB754D5C25C0_OFFSET UNITYSDK_OFFSET(0x176320B0)
#define RPG_GAMECORE_ROGUEMODIFIEREXTRABUFFONBATTLEFIRSTSELECTCONFIG_METHOD_3_6EA09C541C228929_OFFSET UNITYSDK_OFFSET(0x17631FE0)
#define RPG_GAMECORE_ROGUEMODIFIEREXTRABUFFONBATTLEFIRSTSELECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17632060)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExtraBuffOnBattleFirstSelectConfig_TypeDefinitionIndex = 16520;
