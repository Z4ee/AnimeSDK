...
#define RPG_GAMECORE_ADVENTITYENABLEROOTDAMPER_METHOD_3_902FF591D4E44E88_OFFSET UNITYSDK_OFFSET(0x1D6B60E0)
#define RPG_GAMECORE_ADVENTITYENABLEROOTDAMPER_METHOD_3_FFBBBBDCCD06F60A_OFFSET UNITYSDK_OFFSET(0x1D6B6180)
#define RPG_GAMECORE_ADVENTITYENABLEROOTDAMPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6B6140)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvEntityEnableRootDamper_TypeDefinitionIndex = 20814;
