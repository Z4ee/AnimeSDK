...
#define RPG_GAMECORE_ADVENTITYENABLEROOTDAMPER_METHOD_3_E86425E7B74CD1B1_OFFSET UNITYSDK_OFFSET(0x16F2CAB0)
#define RPG_GAMECORE_ADVENTITYENABLEROOTDAMPER_METHOD_3_FFBBBBDCCD06F60A_OFFSET UNITYSDK_OFFSET(0x16F2CB80)
#define RPG_GAMECORE_ADVENTITYENABLEROOTDAMPER__CTOR_OFFSET UNITYSDK_OFFSET(0x16F2CB30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvEntityEnableRootDamper_TypeDefinitionIndex = 19381;
