...
#define RPG_GAMECORE_CHENLINGBATTLEBUFFTYPEEXTRACONFIG_METHOD_2_80EB83DBE0C73CCC_OFFSET UNITYSDK_OFFSET(0x1707C5B0)
#define RPG_GAMECORE_CHENLINGBATTLEBUFFTYPEEXTRACONFIG_METHOD_2_C3329CBD1B7B2FB3_OFFSET UNITYSDK_OFFSET(0x1707C450)
#define RPG_GAMECORE_CHENLINGBATTLEBUFFTYPEEXTRACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1707C5A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleBuffTypeExtraConfig_TypeDefinitionIndex = 14490;
