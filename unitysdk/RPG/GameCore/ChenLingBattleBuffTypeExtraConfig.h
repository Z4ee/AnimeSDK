...
#define RPG_GAMECORE_CHENLINGBATTLEBUFFTYPEEXTRACONFIG_METHOD_2_4134E8F767D2C081_OFFSET UNITYSDK_OFFSET(0x1961F0E0)
#define RPG_GAMECORE_CHENLINGBATTLEBUFFTYPEEXTRACONFIG_METHOD_2_FB16DA14828A572E_OFFSET UNITYSDK_OFFSET(0x1961EF70)
#define RPG_GAMECORE_CHENLINGBATTLEBUFFTYPEEXTRACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1961F0D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleBuffTypeExtraConfig_TypeDefinitionIndex = 15023;
