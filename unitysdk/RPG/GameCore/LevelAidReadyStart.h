...
#define RPG_GAMECORE_LEVELAIDREADYSTART_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xCE329E0)
#define RPG_GAMECORE_LEVELAIDREADYSTART_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xCE32990)
#define RPG_GAMECORE_LEVELAIDREADYSTART__CTOR_OFFSET UNITYSDK_OFFSET(0xCE32980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelAidReadyStart_TypeDefinitionIndex = 53050;
