...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_INSERTABILITY_METHOD_3_52A28A9EE010B9DF_OFFSET UNITYSDK_OFFSET(0x196B9470)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_INSERTABILITY_METHOD_3_BBBE23B9D89CCC99_OFFSET UNITYSDK_OFFSET(0x196B3960)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_INSERTABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x196B3910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_InsertAbility_TypeDefinitionIndex = 15289;
