...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_INSERTABILITY_METHOD_3_1B17AE8BA2C76C65_OFFSET UNITYSDK_OFFSET(0x1D035EF0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_INSERTABILITY_METHOD_3_BBBE23B9D89CCC99_OFFSET UNITYSDK_OFFSET(0x1D035FD0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_INSERTABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D035FC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_InsertAbility_TypeDefinitionIndex = 15890;
