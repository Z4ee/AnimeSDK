...
#define RPG_GAMECORE_ROGUEMAGICFINISH_METHOD_3_138EBE36D59461A9_OFFSET UNITYSDK_OFFSET(0x176136E0)
#define RPG_GAMECORE_ROGUEMAGICFINISH_METHOD_3_8CF0929D2B41CD9D_OFFSET UNITYSDK_OFFSET(0x176137F0)
#define RPG_GAMECORE_ROGUEMAGICFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x176137C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueMagicFinish_TypeDefinitionIndex = 20305;
