...
#define RPG_GAMECORE_ROGUEMAGICFINISH_METHOD_3_8CF0929D2B41CD9D_OFFSET UNITYSDK_OFFSET(0x1CFB6050)
#define RPG_GAMECORE_ROGUEMAGICFINISH_METHOD_3_EA636EC7428981E0_OFFSET UNITYSDK_OFFSET(0x1CFB5F80)
#define RPG_GAMECORE_ROGUEMAGICFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFB6040)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueMagicFinish_TypeDefinitionIndex = 21314;
