...
#define RPG_GAMECORE_VE_RTANGLEBETWEEN_METHOD_3_38A6689AD015F774_OFFSET UNITYSDK_OFFSET(0x1DEA3150)
#define RPG_GAMECORE_VE_RTANGLEBETWEEN_METHOD_3_59BE755F21326139_OFFSET UNITYSDK_OFFSET(0x1DEA2F40)
#define RPG_GAMECORE_VE_RTANGLEBETWEEN_METHOD_3_79BF78ECAD8883C4_OFFSET UNITYSDK_OFFSET(0x1DEA2F00)
#define RPG_GAMECORE_VE_RTANGLEBETWEEN_METHOD_3_BE12A9647E1A48E3_OFFSET UNITYSDK_OFFSET(0x1DEA3120)
#define RPG_GAMECORE_VE_RTANGLEBETWEEN__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEA2F30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VE_RtAngleBetween_TypeDefinitionIndex = 23993;
