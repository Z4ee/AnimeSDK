...
#define RPG_GAMECORE_BYCHECKROGUEEXPLOREWIN_METHOD_4_1A712FF116335065_OFFSET UNITYSDK_OFFSET(0x17000960)
#define RPG_GAMECORE_BYCHECKROGUEEXPLOREWIN_METHOD_4_71C4263E1613F38F_OFFSET UNITYSDK_OFFSET(0x17000A30)
#define RPG_GAMECORE_BYCHECKROGUEEXPLOREWIN__CTOR_OFFSET UNITYSDK_OFFSET(0x170009E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckRogueExploreWin_TypeDefinitionIndex = 19857;
