...
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMERPROCESSBILL_METHOD_4_4154471550CDC31A_OFFSET UNITYSDK_OFFSET(0x1B781800)
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMERPROCESSBILL_METHOD_4_7C6263FFADD43D91_OFFSET UNITYSDK_OFFSET(0x1B7817C0)
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMERPROCESSBILL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7817F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_ElfCustomerProcessBill_TypeDefinitionIndex = 20734;
