...
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMERPROCESSBILL_METHOD_4_4154471550CDC31A_OFFSET UNITYSDK_OFFSET(0x19BFF510)
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMERPROCESSBILL_METHOD_4_CBD00171ADB6D970_OFFSET UNITYSDK_OFFSET(0x19C17780)
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMERPROCESSBILL__CTOR_OFFSET UNITYSDK_OFFSET(0x19BFF4C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_ElfCustomerProcessBill_TypeDefinitionIndex = 20340;
