...
#define RPG_GAMECORE_CHIMERADUELNPCLEAVENODE_METHOD_3_35DBC84190ABE729_OFFSET UNITYSDK_OFFSET(0x19642DF0)
#define RPG_GAMECORE_CHIMERADUELNPCLEAVENODE_METHOD_3_F4545A477B83DE07_OFFSET UNITYSDK_OFFSET(0x19642D10)
#define RPG_GAMECORE_CHIMERADUELNPCLEAVENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x19642DA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelNpcLeaveNode_TypeDefinitionIndex = 15187;
