...
#define RPG_GAMECORE_CHIMERADUELNPCLEAVENODE_METHOD_3_35DBC84190ABE729_OFFSET UNITYSDK_OFFSET(0x1CFCB2A0)
#define RPG_GAMECORE_CHIMERADUELNPCLEAVENODE_METHOD_3_5CAAB1C3A1044E75_OFFSET UNITYSDK_OFFSET(0x1CFCB240)
#define RPG_GAMECORE_CHIMERADUELNPCLEAVENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFCB290)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelNpcLeaveNode_TypeDefinitionIndex = 15788;
