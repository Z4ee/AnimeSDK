...
#define RPG_GAMECORE_ADVNPCSETHIDDEN_METHOD_3_B6F514041B8A9F79_OFFSET UNITYSDK_OFFSET(0x1BE22DB0)
#define RPG_GAMECORE_ADVNPCSETHIDDEN_METHOD_3_FC18D9AD8B46FA82_OFFSET UNITYSDK_OFFSET(0x1BE22DF0)
#define RPG_GAMECORE_ADVNPCSETHIDDEN__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE22DE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvNPCSetHidden_TypeDefinitionIndex = 19452;
