...
#define RPG_GAMECORE_ADVNPCSETHIDDEN_METHOD_3_9822F1A1724FEBAB_OFFSET UNITYSDK_OFFSET(0x18657970)
#define RPG_GAMECORE_ADVNPCSETHIDDEN_METHOD_3_FC18D9AD8B46FA82_OFFSET UNITYSDK_OFFSET(0x186579F0)
#define RPG_GAMECORE_ADVNPCSETHIDDEN__CTOR_OFFSET UNITYSDK_OFFSET(0x186579C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvNPCSetHidden_TypeDefinitionIndex = 19170;
