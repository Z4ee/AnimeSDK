...
#define RPG_GAMECORE_GRIDFIGHTLEVELBASEVALUECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1725F2A0)
#define RPG_GAMECORE_GRIDFIGHTLEVELBASEVALUECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1725F450)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightLevelBaseValueConfigRow_TypeDefinitionIndex = 12459;
