...
#define RPG_GAMECORE_GRIDFIGHTLEVELBASEVALUECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1EE6B3E0)
#define RPG_GAMECORE_GRIDFIGHTLEVELBASEVALUECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1EE6B590)
