...
#define RPG_GAMECORE_UITRIGGERMONOPOLYMODIFIER_METHOD_3_672CED75576CFD85_OFFSET UNITYSDK_OFFSET(0x1D61DF50)
#define RPG_GAMECORE_UITRIGGERMONOPOLYMODIFIER_METHOD_3_76F13171E6439B08_OFFSET UNITYSDK_OFFSET(0x1D61DE80)
#define RPG_GAMECORE_UITRIGGERMONOPOLYMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D61DF40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UITriggerMonopolyModifier_TypeDefinitionIndex = 21479;
