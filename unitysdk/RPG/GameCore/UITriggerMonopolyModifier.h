...
#define RPG_GAMECORE_UITRIGGERMONOPOLYMODIFIER_METHOD_3_672CED75576CFD85_OFFSET UNITYSDK_OFFSET(0x178E3200)
#define RPG_GAMECORE_UITRIGGERMONOPOLYMODIFIER_METHOD_3_CF2561C7C8AC1E31_OFFSET UNITYSDK_OFFSET(0x178E30F0)
#define RPG_GAMECORE_UITRIGGERMONOPOLYMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x178E31D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UITriggerMonopolyModifier_TypeDefinitionIndex = 19892;
