...
#define RPG_GAMECORE_TRAINPARTYPERFORMANCECONFIG_METHOD_2_EECFEEE9D5AEFB4C_OFFSET UNITYSDK_OFFSET(0x178AEC90)
#define RPG_GAMECORE_TRAINPARTYPERFORMANCECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x178AEEF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyPerformanceConfig_TypeDefinitionIndex = 14878;
