...
#define RPG_GAMECORE_EXPEDITIONBATTLEMONSTERNORMALATKACTION_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1D081B30)
#define RPG_GAMECORE_EXPEDITIONBATTLEMONSTERNORMALATKACTION_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D081A90)
#define RPG_GAMECORE_EXPEDITIONBATTLEMONSTERNORMALATKACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D081B20)
