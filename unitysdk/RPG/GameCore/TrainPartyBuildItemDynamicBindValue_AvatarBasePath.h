...
#define RPG_GAMECORE_TRAINPARTYBUILDITEMDYNAMICBINDVALUE_AVATARBASEPATH_METHOD_3_102EAB629F8014AD_OFFSET UNITYSDK_OFFSET(0x190A7780)
#define RPG_GAMECORE_TRAINPARTYBUILDITEMDYNAMICBINDVALUE_AVATARBASEPATH_METHOD_3_F46F8977C130C201_OFFSET UNITYSDK_OFFSET(0x190A7A30)
#define RPG_GAMECORE_TRAINPARTYBUILDITEMDYNAMICBINDVALUE_AVATARBASEPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x190A7770)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyBuildItemDynamicBindValue_AvatarBasePath_TypeDefinitionIndex = 15393;
