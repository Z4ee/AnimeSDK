...
#define RPG_GAMECORE_TRAINPARTYBUILDITEMDYNAMICBINDVALUE_AVATARBASEPATH_METHOD_3_102EAB629F8014AD_OFFSET UNITYSDK_OFFSET(0x178A8B60)
#define RPG_GAMECORE_TRAINPARTYBUILDITEMDYNAMICBINDVALUE_AVATARBASEPATH_METHOD_3_CAA878FD665920D8_OFFSET UNITYSDK_OFFSET(0x178A8E10)
#define RPG_GAMECORE_TRAINPARTYBUILDITEMDYNAMICBINDVALUE_AVATARBASEPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x178A8B50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyBuildItemDynamicBindValue_AvatarBasePath_TypeDefinitionIndex = 14886;
