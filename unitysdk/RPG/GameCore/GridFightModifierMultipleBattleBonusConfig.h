...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERMULTIPLEBATTLEBONUSCONFIG_METHOD_3_16469D2829F9819C_OFFSET UNITYSDK_OFFSET(0x197F2E70)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERMULTIPLEBATTLEBONUSCONFIG_METHOD_3_579FD09ADBAB2375_OFFSET UNITYSDK_OFFSET(0x197EE090)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERMULTIPLEBATTLEBONUSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197EE040)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierMultipleBattleBonusConfig_TypeDefinitionIndex = 18400;
