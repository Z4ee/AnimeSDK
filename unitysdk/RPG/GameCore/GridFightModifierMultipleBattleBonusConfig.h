...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERMULTIPLEBATTLEBONUSCONFIG_METHOD_3_1A0EF9C1E33A8851_OFFSET UNITYSDK_OFFSET(0x1D06A500)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERMULTIPLEBATTLEBONUSCONFIG_METHOD_3_579FD09ADBAB2375_OFFSET UNITYSDK_OFFSET(0x1D06A550)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERMULTIPLEBATTLEBONUSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D06A540)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierMultipleBattleBonusConfig_TypeDefinitionIndex = 18648;
