...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERMULTIPLEBATTLEBONUSCONFIG_METHOD_3_16469D2829F9819C_OFFSET UNITYSDK_OFFSET(0x189BDEF0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERMULTIPLEBATTLEBONUSCONFIG_METHOD_3_579FD09ADBAB2375_OFFSET UNITYSDK_OFFSET(0x189BDFC0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERMULTIPLEBATTLEBONUSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189BDF70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierMultipleBattleBonusConfig_TypeDefinitionIndex = 18428;
