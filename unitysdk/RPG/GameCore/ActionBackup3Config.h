...
#define RPG_GAMECORE_ACTIONBACKUP3CONFIG_METHOD_4_591CCF7440C03BF9_OFFSET UNITYSDK_OFFSET(0x1B9FD070)
#define RPG_GAMECORE_ACTIONBACKUP3CONFIG_METHOD_4_EB0773ED9A3075F5_OFFSET UNITYSDK_OFFSET(0x1B9FD020)
#define RPG_GAMECORE_ACTIONBACKUP3CONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9FD060)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActionBackup3Config_TypeDefinitionIndex = 16379;
