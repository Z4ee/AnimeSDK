...
#define RPG_GAMECORE_SETDYNAMICVALUEBYVARIATETYPE_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x19C47230)
#define RPG_GAMECORE_SETDYNAMICVALUEBYVARIATETYPE_METHOD_4_025A2A8720D8D091_OFFSET UNITYSDK_OFFSET(0x19C46F30)
#define RPG_GAMECORE_SETDYNAMICVALUEBYVARIATETYPE_METHOD_4_7C7D1A6299C83C8E_OFFSET UNITYSDK_OFFSET(0x19C47000)
#define RPG_GAMECORE_SETDYNAMICVALUEBYVARIATETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C46FB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByVariateType_TypeDefinitionIndex = 21436;
