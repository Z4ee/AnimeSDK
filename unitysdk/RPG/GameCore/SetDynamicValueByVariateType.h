...
#define RPG_GAMECORE_SETDYNAMICVALUEBYVARIATETYPE_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1E825050)
#define RPG_GAMECORE_SETDYNAMICVALUEBYVARIATETYPE_METHOD_4_5AE02E0A4B6D781B_OFFSET UNITYSDK_OFFSET(0x1E824DE0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYVARIATETYPE_METHOD_4_7C7D1A6299C83C8E_OFFSET UNITYSDK_OFFSET(0x1E824E20)
#define RPG_GAMECORE_SETDYNAMICVALUEBYVARIATETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E824E10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByVariateType_TypeDefinitionIndex = 22420;
