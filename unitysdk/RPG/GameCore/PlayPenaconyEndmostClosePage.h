...
#define RPG_GAMECORE_PLAYPENACONYENDMOSTCLOSEPAGE_METHOD_3_89FB40F6B6B8E849_OFFSET UNITYSDK_OFFSET(0x19A273F0)
#define RPG_GAMECORE_PLAYPENACONYENDMOSTCLOSEPAGE_METHOD_3_F12AD1121042B6D5_OFFSET UNITYSDK_OFFSET(0x19A272E0)
#define RPG_GAMECORE_PLAYPENACONYENDMOSTCLOSEPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x19A273C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayPenaconyEndmostClosePage_TypeDefinitionIndex = 20608;
