...
#define RPG_GAMECORE_PLAYPENACONYENDMOSTCLOSEPAGE_METHOD_3_89FB40F6B6B8E849_OFFSET UNITYSDK_OFFSET(0x174C4E50)
#define RPG_GAMECORE_PLAYPENACONYENDMOSTCLOSEPAGE_METHOD_3_F12AD1121042B6D5_OFFSET UNITYSDK_OFFSET(0x174C4D40)
#define RPG_GAMECORE_PLAYPENACONYENDMOSTCLOSEPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x174C4E20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayPenaconyEndmostClosePage_TypeDefinitionIndex = 19995;
