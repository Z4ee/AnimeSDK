...
#define RPG_GAMECORE_SWITCHCHALLENGETURNLIMITTYPE_METHOD_3_54A41B6145012593_OFFSET UNITYSDK_OFFSET(0x1B434D20)
#define RPG_GAMECORE_SWITCHCHALLENGETURNLIMITTYPE_METHOD_3_DAC5B47D015C8E26_OFFSET UNITYSDK_OFFSET(0x1B434CE0)
#define RPG_GAMECORE_SWITCHCHALLENGETURNLIMITTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B434D10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchChallengeTurnLimitType_TypeDefinitionIndex = 22609;
