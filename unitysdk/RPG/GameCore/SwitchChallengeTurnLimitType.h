...
#define RPG_GAMECORE_SWITCHCHALLENGETURNLIMITTYPE_METHOD_3_3795D78A936A4932_OFFSET UNITYSDK_OFFSET(0x177933E0)
#define RPG_GAMECORE_SWITCHCHALLENGETURNLIMITTYPE_METHOD_3_FCFDA9135545C80D_OFFSET UNITYSDK_OFFSET(0x17793460)
#define RPG_GAMECORE_SWITCHCHALLENGETURNLIMITTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x17793430)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchChallengeTurnLimitType_TypeDefinitionIndex = 21680;
