...
#define RPG_GAMECORE_SETWAYPOINTIGNORELOCK_METHOD_3_1CBA36527B0FDC60_OFFSET UNITYSDK_OFFSET(0x18E4A3E0)
#define RPG_GAMECORE_SETWAYPOINTIGNORELOCK_METHOD_3_F9E3119BED095319_OFFSET UNITYSDK_OFFSET(0x18E4A360)
#define RPG_GAMECORE_SETWAYPOINTIGNORELOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x18E4A3B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetWaypointIgnoreLock_TypeDefinitionIndex = 19861;
