...
#define RPG_GAMECORE_SYNCANIMWITHBGMCHAPTERCONFIG_METHOD_2_C3F83F803B4B404F_OFFSET UNITYSDK_OFFSET(0x1B443D80)
#define RPG_GAMECORE_SYNCANIMWITHBGMCHAPTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B443F20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SyncAnimWithBgmChapterConfig_TypeDefinitionIndex = 21580;
