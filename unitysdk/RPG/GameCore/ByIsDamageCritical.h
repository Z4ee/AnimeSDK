...
#define RPG_GAMECORE_BYISDAMAGECRITICAL_METHOD_4_33EC9A8074130CF8_OFFSET UNITYSDK_OFFSET(0x1A8DD720)
#define RPG_GAMECORE_BYISDAMAGECRITICAL_METHOD_4_60BA0FA3FB3EEAFD_OFFSET UNITYSDK_OFFSET(0x1A8DD5A0)
#define RPG_GAMECORE_BYISDAMAGECRITICAL_METHOD_4_8D79F9D27F8F0799_OFFSET UNITYSDK_OFFSET(0x1A8DD750)
#define RPG_GAMECORE_BYISDAMAGECRITICAL_METHOD_4_DE85DB40986C553E_OFFSET UNITYSDK_OFFSET(0x1A8DD5E0)
#define RPG_GAMECORE_BYISDAMAGECRITICAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8DD5D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsDamageCritical_TypeDefinitionIndex = 22649;
