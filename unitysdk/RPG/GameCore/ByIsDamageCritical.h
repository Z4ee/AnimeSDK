...
#define RPG_GAMECORE_BYISDAMAGECRITICAL_METHOD_4_380D15BA487A90B4_OFFSET UNITYSDK_OFFSET(0x1702C0C0)
#define RPG_GAMECORE_BYISDAMAGECRITICAL_METHOD_4_DE85DB40986C553E_OFFSET UNITYSDK_OFFSET(0x1702C190)
#define RPG_GAMECORE_BYISDAMAGECRITICAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1702C140)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsDamageCritical_TypeDefinitionIndex = 21724;
