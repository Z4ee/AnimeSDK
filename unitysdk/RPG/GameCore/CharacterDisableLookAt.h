...
#define RPG_GAMECORE_CHARACTERDISABLELOOKAT_METHOD_3_2CF84E3D3FD8F8A2_OFFSET UNITYSDK_OFFSET(0x1706B290)
#define RPG_GAMECORE_CHARACTERDISABLELOOKAT_METHOD_3_7823915566E3CD29_OFFSET UNITYSDK_OFFSET(0x1706B310)
#define RPG_GAMECORE_CHARACTERDISABLELOOKAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1706B2E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterDisableLookAt_TypeDefinitionIndex = 19193;
