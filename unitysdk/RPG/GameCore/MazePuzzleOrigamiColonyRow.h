...
#define RPG_GAMECORE_MAZEPUZZLEORIGAMICOLONYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18AD73A0)
#define RPG_GAMECORE_MAZEPUZZLEORIGAMICOLONYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18AD75C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MazePuzzleOrigamiColonyRow_TypeDefinitionIndex = 13328;

	class MazePuzzleOrigamiColonyRow : public ::System::Object
	{
	public:
		::Il2CppArray<::RPG::GameCore::ItemConfig*>* MaterialCost; // 0x10
		::System::UInt32 FinishQuestID; // 0x18
		::System::UInt32 OrigamiColonyID; // 0x1C
		::System::UInt32 FloorID; // 0x20
		::System::UInt32 TalkSentenceID; // 0x24
		::System::UInt32 MirrorFloorID; // 0x28
