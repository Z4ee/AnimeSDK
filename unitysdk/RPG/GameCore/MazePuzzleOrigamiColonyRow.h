...
#define RPG_GAMECORE_MAZEPUZZLEORIGAMICOLONYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D280150)
#define RPG_GAMECORE_MAZEPUZZLEORIGAMICOLONYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D280370)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MazePuzzleOrigamiColonyRow_TypeDefinitionIndex = 13967;
	...
	public:
		...
		::System::UInt32 OrigamiColonyID; // 0x24
