...
#define RPG_GAMECORE_MAZEPUZZLEORIGAMICOLONYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19906EA0)
#define RPG_GAMECORE_MAZEPUZZLEORIGAMICOLONYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x199070C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MazePuzzleOrigamiColonyRow_TypeDefinitionIndex = 13402;
	...
	public:
		...
		::System::UInt32 FinishQuestID; // 0x1C
		::System::UInt32 TalkSentenceID; // 0x20
		::System::UInt32 MirrorFloorID; // 0x24
