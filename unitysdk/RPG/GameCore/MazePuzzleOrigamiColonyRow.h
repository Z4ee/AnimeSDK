...
#define RPG_GAMECORE_MAZEPUZZLEORIGAMICOLONYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D262820)
#define RPG_GAMECORE_MAZEPUZZLEORIGAMICOLONYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D262A40)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 OrigamiColonyID; // 0x20
