...
#define RPG_GAMECORE_FATEMODIFIERMASTERJINGLIUCONFIG_METHOD_3_9A3E21459A625A5E_OFFSET UNITYSDK_OFFSET(0x1E0CDD40)
#define RPG_GAMECORE_FATEMODIFIERMASTERJINGLIUCONFIG_METHOD_3_F4DA78330F76479A_OFFSET UNITYSDK_OFFSET(0x1E0CDD90)
#define RPG_GAMECORE_FATEMODIFIERMASTERJINGLIUCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0CDD80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateModifierMasterJingliuConfig_TypeDefinitionIndex = 19060;
