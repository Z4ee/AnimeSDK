...
#define RPG_GAMECORE_CHARACTERREACTIONANIMCONFIG_METHOD_2_1AF38C60F098DE3A_OFFSET UNITYSDK_OFFSET(0x1B729950)
#define RPG_GAMECORE_CHARACTERREACTIONANIMCONFIG_METHOD_2_35425D3280C3975B_OFFSET UNITYSDK_OFFSET(0x1B729820)
#define RPG_GAMECORE_CHARACTERREACTIONANIMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7287C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterReactionAnimConfig_TypeDefinitionIndex = 17469;
