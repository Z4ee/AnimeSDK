...
#define RPG_GAMECORE_CHARACTERREACTIONANIMCONFIG_METHOD_2_1AF38C60F098DE3A_OFFSET UNITYSDK_OFFSET(0x19613D00)
#define RPG_GAMECORE_CHARACTERREACTIONANIMCONFIG_METHOD_2_35425D3280C3975B_OFFSET UNITYSDK_OFFSET(0x19613BD0)
#define RPG_GAMECORE_CHARACTERREACTIONANIMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19612B30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterReactionAnimConfig_TypeDefinitionIndex = 17296;
