...
#define RPG_GAMECORE_ROGUEMODIFIERBACKUP1CONFIG_METHOD_3_1CE7793880FC3100_OFFSET UNITYSDK_OFFSET(0x18D2AB70)
#define RPG_GAMECORE_ROGUEMODIFIERBACKUP1CONFIG_METHOD_3_643164C5C21A97D9_OFFSET UNITYSDK_OFFSET(0x18D2AC40)
#define RPG_GAMECORE_ROGUEMODIFIERBACKUP1CONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D2ABF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierBackup1Config_TypeDefinitionIndex = 17093;
