...
#define RPG_GAMECORE_BYCONTAINSREDSTANCE_METHOD_4_3B5639C642EB37EF_OFFSET UNITYSDK_OFFSET(0x187429E0)
#define RPG_GAMECORE_BYCONTAINSREDSTANCE_METHOD_4_CA48AD5BFC6BFFF9_OFFSET UNITYSDK_OFFSET(0x18742AB0)
#define RPG_GAMECORE_BYCONTAINSREDSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x18742A60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByContainsRedStance_TypeDefinitionIndex = 21521;
