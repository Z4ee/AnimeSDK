...
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_NEARESTNSOLDIERS_METHOD_3_1751DE410019168B_OFFSET UNITYSDK_OFFSET(0x1C37EC10)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_NEARESTNSOLDIERS_METHOD_3_21C80D36979FB235_OFFSET UNITYSDK_OFFSET(0x1C37EBB0)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_NEARESTNSOLDIERS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C37EC00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleTargetEvaluator_NearestNSoldiers_TypeDefinitionIndex = 15156;
