...
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_NEARESTNSOLDIERS_METHOD_3_1751DE410019168B_OFFSET UNITYSDK_OFFSET(0x187E6F10)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_NEARESTNSOLDIERS_METHOD_3_21C80D36979FB235_OFFSET UNITYSDK_OFFSET(0x187E6EB0)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_NEARESTNSOLDIERS__CTOR_OFFSET UNITYSDK_OFFSET(0x187E6F00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleTargetEvaluator_NearestNSoldiers_TypeDefinitionIndex = 14929;
