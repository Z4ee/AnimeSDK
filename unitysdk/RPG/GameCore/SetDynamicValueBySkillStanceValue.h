...
#define RPG_GAMECORE_SETDYNAMICVALUEBYSKILLSTANCEVALUE_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1C5F1860)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSKILLSTANCEVALUE_METHOD_4_16944F0D98EABC72_OFFSET UNITYSDK_OFFSET(0x1C5F1570)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSKILLSTANCEVALUE_METHOD_4_356BCD520E1AECA3_OFFSET UNITYSDK_OFFSET(0x1C5F15B0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSKILLSTANCEVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5F15A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueBySkillStanceValue_TypeDefinitionIndex = 21955;
