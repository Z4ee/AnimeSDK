...
#define RPG_GAMECORE_CHIMERAABILITYBASE_METHOD_2_98471EAB1E5A1381_OFFSET UNITYSDK_OFFSET(0x19632170)
#define RPG_GAMECORE_CHIMERAABILITYBASE_METHOD_2_9A233AB41528AB57_OFFSET UNITYSDK_OFFSET(0x19632320)
#define RPG_GAMECORE_CHIMERAABILITYBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x19632160)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraAbilityBase_TypeDefinitionIndex = 15066;
