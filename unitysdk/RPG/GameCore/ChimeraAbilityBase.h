...
#define RPG_GAMECORE_CHIMERAABILITYBASE_METHOD_2_98471EAB1E5A1381_OFFSET UNITYSDK_OFFSET(0x1C38C3D0)
#define RPG_GAMECORE_CHIMERAABILITYBASE_METHOD_2_9A233AB41528AB57_OFFSET UNITYSDK_OFFSET(0x1C38C580)
#define RPG_GAMECORE_CHIMERAABILITYBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C38C3C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraAbilityBase_TypeDefinitionIndex = 15230;
