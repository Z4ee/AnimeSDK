...
#define RPG_GAMECORE_TEXTDYNAMICPARAMEXPR_METHOD_3_D7C41288B2185D35_OFFSET UNITYSDK_OFFSET(0x1C14CA90)
#define RPG_GAMECORE_TEXTDYNAMICPARAMEXPR_METHOD_3_ECE875671C5142A1_OFFSET UNITYSDK_OFFSET(0x1C14CB60)
#define RPG_GAMECORE_TEXTDYNAMICPARAMEXPR__CTOR_OFFSET UNITYSDK_OFFSET(0x1C14CA80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TextDynamicParamExpr_TypeDefinitionIndex = 16329;
