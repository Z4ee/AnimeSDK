...
#define RPG_GAMECORE_TEXTDYNAMICPARAMEXPR_METHOD_3_2DE91E05412EA16C_OFFSET UNITYSDK_OFFSET(0x19095650)
#define RPG_GAMECORE_TEXTDYNAMICPARAMEXPR_METHOD_3_D1B3530EA207779C_OFFSET UNITYSDK_OFFSET(0x19095720)
#define RPG_GAMECORE_TEXTDYNAMICPARAMEXPR__CTOR_OFFSET UNITYSDK_OFFSET(0x19095640)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TextDynamicParamExpr_TypeDefinitionIndex = 16095;
