...
#define RPG_GAMECORE_ADDREGARDASSKILLTYPE_METHOD_3_008167DC10171BE7_OFFSET UNITYSDK_OFFSET(0x16F20F90)
#define RPG_GAMECORE_ADDREGARDASSKILLTYPE_METHOD_3_A8C5EDB31D7742C4_OFFSET UNITYSDK_OFFSET(0x16F20F10)
#define RPG_GAMECORE_ADDREGARDASSKILLTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F20F60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddRegardAsSkillType_TypeDefinitionIndex = 21918;
