...
#define RPG_GAMECORE_ADDREGARDASSKILLTYPE_METHOD_3_008167DC10171BE7_OFFSET UNITYSDK_OFFSET(0x18643160)
#define RPG_GAMECORE_ADDREGARDASSKILLTYPE_METHOD_3_A8C5EDB31D7742C4_OFFSET UNITYSDK_OFFSET(0x186430E0)
#define RPG_GAMECORE_ADDREGARDASSKILLTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x18643130)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddRegardAsSkillType_TypeDefinitionIndex = 22656;
