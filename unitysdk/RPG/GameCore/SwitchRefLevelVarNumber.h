...
#define RPG_GAMECORE_SWITCHREFLEVELVARNUMBER_METHOD_3_142FFF7ED6A11A12_OFFSET UNITYSDK_OFFSET(0x17799D40)
#define RPG_GAMECORE_SWITCHREFLEVELVARNUMBER_METHOD_3_1D8087E2BB8D854F_OFFSET UNITYSDK_OFFSET(0x17799640)
#define RPG_GAMECORE_SWITCHREFLEVELVARNUMBER__CTOR_OFFSET UNITYSDK_OFFSET(0x17799630)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchRefLevelVarNumber_TypeDefinitionIndex = 16111;
