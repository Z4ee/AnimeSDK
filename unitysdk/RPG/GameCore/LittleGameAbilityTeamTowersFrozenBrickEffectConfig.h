...
#define RPG_GAMECORE_LITTLEGAMEABILITYTEAMTOWERSFROZENBRICKEFFECTCONFIG_METHOD_3_4A2F4D5988D25E86_OFFSET UNITYSDK_OFFSET(0x1B096C10)
#define RPG_GAMECORE_LITTLEGAMEABILITYTEAMTOWERSFROZENBRICKEFFECTCONFIG_METHOD_3_BD14D00D675737F2_OFFSET UNITYSDK_OFFSET(0x1B096CE0)
#define RPG_GAMECORE_LITTLEGAMEABILITYTEAMTOWERSFROZENBRICKEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B096CD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityTeamTowersFrozenBrickEffectConfig_TypeDefinitionIndex = 20612;
