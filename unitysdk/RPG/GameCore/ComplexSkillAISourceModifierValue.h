...
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEMODIFIERVALUE_METHOD_3_849F7CDC47B58589_OFFSET UNITYSDK_OFFSET(0x1882FE10)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEMODIFIERVALUE_METHOD_3_E4553154001CE01F_OFFSET UNITYSDK_OFFSET(0x1882DAE0)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEMODIFIERVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1882DAC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAISourceModifierValue_TypeDefinitionIndex = 14702;
