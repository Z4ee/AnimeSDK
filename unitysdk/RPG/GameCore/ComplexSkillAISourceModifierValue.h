...
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEMODIFIERVALUE_METHOD_3_200810F14A8058B9_OFFSET UNITYSDK_OFFSET(0x1966FC90)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEMODIFIERVALUE_METHOD_3_E4553154001CE01F_OFFSET UNITYSDK_OFFSET(0x1966D590)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEMODIFIERVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1966D570)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAISourceModifierValue_TypeDefinitionIndex = 14767;
	...
	public:
		...
		static ::System::Void Method_3_200810F14A8058B9(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::ComplexSkillAISourceModifierValue*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::ComplexSkillAISourceModifierValue*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_COMPLEXSKILLAISOURCEMODIFIERVALUE_METHOD_3_200810F14A8058B9_OFFSET))(a1, a2);
		}
