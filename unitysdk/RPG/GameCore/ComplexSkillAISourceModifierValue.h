...
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEMODIFIERVALUE_METHOD_3_A70B67009B9768BE_OFFSET UNITYSDK_OFFSET(0x1BC279C0)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEMODIFIERVALUE_METHOD_3_E4553154001CE01F_OFFSET UNITYSDK_OFFSET(0x1BC27A20)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEMODIFIERVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC27A10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAISourceModifierValue_TypeDefinitionIndex = 14927;
