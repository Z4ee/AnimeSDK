...
#define RPG_GAMECORE_ADVENTUREPLAYERONSTAGE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x15413BA0)
#define RPG_GAMECORE_ADVENTUREPLAYERONSTAGE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x15413BF0)
#define RPG_GAMECORE_ADVENTUREPLAYERONSTAGE_GET_ENTITYID_OFFSET UNITYSDK_OFFSET(0x15413C30)
#define RPG_GAMECORE_ADVENTUREPLAYERONSTAGE_INIT_OFFSET UNITYSDK_OFFSET(0x15413B50)
#define RPG_GAMECORE_ADVENTUREPLAYERONSTAGE_SET_ENTITYID_OFFSET UNITYSDK_OFFSET(0x15413C40)
#define RPG_GAMECORE_ADVENTUREPLAYERONSTAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x15413C50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventurePlayerOnStage_TypeDefinitionIndex = 54063;
