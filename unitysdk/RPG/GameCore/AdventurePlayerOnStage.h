...
#define RPG_GAMECORE_ADVENTUREPLAYERONSTAGE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xE4ECA00)
#define RPG_GAMECORE_ADVENTUREPLAYERONSTAGE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xE4ECA50)
#define RPG_GAMECORE_ADVENTUREPLAYERONSTAGE_GET_ENTITYID_OFFSET UNITYSDK_OFFSET(0xE4ECA90)
#define RPG_GAMECORE_ADVENTUREPLAYERONSTAGE_INIT_OFFSET UNITYSDK_OFFSET(0xE4EC9B0)
#define RPG_GAMECORE_ADVENTUREPLAYERONSTAGE_SET_ENTITYID_OFFSET UNITYSDK_OFFSET(0xE4ECAA0)
#define RPG_GAMECORE_ADVENTUREPLAYERONSTAGE__CTOR_OFFSET UNITYSDK_OFFSET(0xE4ECAB0)
