...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEDIFFICULTYCOMPMAPPINGPARAM_METHOD_4_A54F7E7D58BF0CA8_OFFSET UNITYSDK_OFFSET(0x19C43770)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEDIFFICULTYCOMPMAPPINGPARAM_METHOD_4_F730FDF3CBFBE4E8_OFFSET UNITYSDK_OFFSET(0x19C43800)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEDIFFICULTYCOMPMAPPINGPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x19C437D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRogueDifficultyCompMappingParam_TypeDefinitionIndex = 20580;
