...
#define RPG_GAMECORE_WAITDRINKMAKERCHEERSINITFINISH_METHOD_4_127719E025AB6F8E_OFFSET UNITYSDK_OFFSET(0x190FB0A0)
#define RPG_GAMECORE_WAITDRINKMAKERCHEERSINITFINISH_METHOD_4_9B256728A899E390_OFFSET UNITYSDK_OFFSET(0x190FB180)
#define RPG_GAMECORE_WAITDRINKMAKERCHEERSINITFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x190FB120)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitDrinkMakerCheersInitFinish_TypeDefinitionIndex = 20567;
