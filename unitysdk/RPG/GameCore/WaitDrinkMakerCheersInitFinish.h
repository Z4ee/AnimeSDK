...
#define RPG_GAMECORE_WAITDRINKMAKERCHEERSINITFINISH_METHOD_4_9B256728A899E390_OFFSET UNITYSDK_OFFSET(0x1B8A2B50)
#define RPG_GAMECORE_WAITDRINKMAKERCHEERSINITFINISH_METHOD_4_D48C134A69AC4A25_OFFSET UNITYSDK_OFFSET(0x1B8A2B00)
#define RPG_GAMECORE_WAITDRINKMAKERCHEERSINITFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8A2B40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitDrinkMakerCheersInitFinish_TypeDefinitionIndex = 20917;
