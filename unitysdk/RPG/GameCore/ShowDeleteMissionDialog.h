...
#define RPG_GAMECORE_SHOWDELETEMISSIONDIALOG_METHOD_3_14CD5723381355B9_OFFSET UNITYSDK_OFFSET(0x1BE3CB20)
#define RPG_GAMECORE_SHOWDELETEMISSIONDIALOG_METHOD_3_847C122F50986458_OFFSET UNITYSDK_OFFSET(0x1BE3CB60)
#define RPG_GAMECORE_SHOWDELETEMISSIONDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE3CB50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowDeleteMissionDialog_TypeDefinitionIndex = 20885;
