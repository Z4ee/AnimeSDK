...
#define RPG_GAMECORE_CONVINCEINITIALIZE_METHOD_3_04E492E1A894BE44_OFFSET UNITYSDK_OFFSET(0x1967D190)
#define RPG_GAMECORE_CONVINCEINITIALIZE_METHOD_3_67245169F4C63460_OFFSET UNITYSDK_OFFSET(0x1967D290)
#define RPG_GAMECORE_CONVINCEINITIALIZE__CTOR_OFFSET UNITYSDK_OFFSET(0x1967D220)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConvinceInitialize_TypeDefinitionIndex = 20611;
