...
#define RPG_GAMECORE_PHOTOGRAPHAIMCONTAINERGIANTTARGET_METHOD_3_683AF9015B51F909_OFFSET UNITYSDK_OFFSET(0x19A04B90)
#define RPG_GAMECORE_PHOTOGRAPHAIMCONTAINERGIANTTARGET_METHOD_3_7811DCE9F74636A4_OFFSET UNITYSDK_OFFSET(0x19A04C50)
#define RPG_GAMECORE_PHOTOGRAPHAIMCONTAINERGIANTTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x19A04C10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotoGraphAimContainerGiantTarget_TypeDefinitionIndex = 16659;
