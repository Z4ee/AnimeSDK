...
#define RPG_GAMECORE_BOXINGCLUBACTIVITYQUESTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16FF2150)
#define RPG_GAMECORE_BOXINGCLUBACTIVITYQUESTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16FF2300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BoxingClubActivityQuestConfigRow_TypeDefinitionIndex = 11794;
