...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETLASTGAMEPLAYCHAPTERCONFIG_METHOD_6_73EA2BF6DEC68E5E_OFFSET UNITYSDK_OFFSET(0x17270A70)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETLASTGAMEPLAYCHAPTERCONFIG_METHOD_6_E46B8544E00B1B78_OFFSET UNITYSDK_OFFSET(0x17270D20)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETLASTGAMEPLAYCHAPTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17270BF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightParamGetLastGamePlayChapterConfig_TypeDefinitionIndex = 17908;
