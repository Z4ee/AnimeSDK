...
#define RPG_GAMECORE_MARBLENPCCONFIG_METHOD_2_4F880ECBD859B453_OFFSET UNITYSDK_OFFSET(0x1D4A9A90)
#define RPG_GAMECORE_MARBLENPCCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4AD3A0)
