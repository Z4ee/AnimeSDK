...
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTSUPERCONFIG_METHOD_7_76212C7432D2163E_OFFSET UNITYSDK_OFFSET(0x1D0305A0)
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTSUPERCONFIG_METHOD_7_F2D7FBA4018DDF22_OFFSET UNITYSDK_OFFSET(0x1D030840)
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTSUPERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D030590)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaSelectRoomCardCastSuperConfig_TypeDefinitionIndex = 18968;
