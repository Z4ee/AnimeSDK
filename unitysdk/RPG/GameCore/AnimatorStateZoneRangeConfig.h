...
#define RPG_GAMECORE_ANIMATORSTATEZONERANGECONFIG_METHOD_2_DADA70613716CE1B_OFFSET UNITYSDK_OFFSET(0x1C56DED0)
#define RPG_GAMECORE_ANIMATORSTATEZONERANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C56E0F0)
