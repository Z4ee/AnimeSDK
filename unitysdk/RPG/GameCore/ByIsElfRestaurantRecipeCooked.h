...
#define RPG_GAMECORE_BYISELFRESTAURANTRECIPECOOKED_METHOD_4_4A618C00DAF7D062_OFFSET UNITYSDK_OFFSET(0x1702CE20)
#define RPG_GAMECORE_BYISELFRESTAURANTRECIPECOOKED_METHOD_4_8CA52B3C7F57DB80_OFFSET UNITYSDK_OFFSET(0x1702CEF0)
#define RPG_GAMECORE_BYISELFRESTAURANTRECIPECOOKED__CTOR_OFFSET UNITYSDK_OFFSET(0x1702CEA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsElfRestaurantRecipeCooked_TypeDefinitionIndex = 22413;
