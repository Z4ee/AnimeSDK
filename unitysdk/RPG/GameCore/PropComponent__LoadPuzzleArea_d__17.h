...
#define RPG_GAMECORE_PROPCOMPONENT__LOADPUZZLEAREA_D__17_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x190228D0)
#define RPG_GAMECORE_PROPCOMPONENT__LOADPUZZLEAREA_D__17_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19022CD0)
#define RPG_GAMECORE_PROPCOMPONENT__LOADPUZZLEAREA_D__17_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19022D30)
#define RPG_GAMECORE_PROPCOMPONENT__LOADPUZZLEAREA_D__17_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19022CE0)
#define RPG_GAMECORE_PROPCOMPONENT__LOADPUZZLEAREA_D__17_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x190228C0)
#define RPG_GAMECORE_PROPCOMPONENT__LOADPUZZLEAREA_D__17__CTOR_OFFSET UNITYSDK_OFFSET(0x1900FCB0)
