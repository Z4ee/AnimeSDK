...
#define RPG_GAMECORE_CLEARENTITYDAMAGETEXT_METHOD_3_146577BE06A515F2_OFFSET UNITYSDK_OFFSET(0x1CFDA1D0)
#define RPG_GAMECORE_CLEARENTITYDAMAGETEXT_METHOD_3_BE4910CD81A95D6D_OFFSET UNITYSDK_OFFSET(0x1CFDA190)
#define RPG_GAMECORE_CLEARENTITYDAMAGETEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFDA1C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClearEntityDamageText_TypeDefinitionIndex = 22951;
