...
#define RPG_GAMECORE_PROPRUNTIMEREPLACEARTPREFAB_METHOD_3_D612920DA94DF269_OFFSET UNITYSDK_OFFSET(0x18C73ED0)
#define RPG_GAMECORE_PROPRUNTIMEREPLACEARTPREFAB_METHOD_3_F3B09E4B14605154_OFFSET UNITYSDK_OFFSET(0x18C73D80)
#define RPG_GAMECORE_PROPRUNTIMEREPLACEARTPREFAB__CTOR_OFFSET UNITYSDK_OFFSET(0x18C73E40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropRuntimeReplaceArtPrefab_TypeDefinitionIndex = 21035;
