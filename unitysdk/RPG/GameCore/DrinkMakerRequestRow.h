...
#define RPG_GAMECORE_DRINKMAKERREQUESTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D048BE0)
#define RPG_GAMECORE_DRINKMAKERREQUESTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0493B0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID RequestDesc; // 0x20
		::RPG::Client::TextID RequestShortDesc; // 0x30
		::System::UInt32 RequestID; // 0x40
		::System::UInt32 SuccessTip; // 0x44
