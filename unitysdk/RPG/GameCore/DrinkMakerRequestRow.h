...
#define RPG_GAMECORE_DRINKMAKERREQUESTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x171812C0)
#define RPG_GAMECORE_DRINKMAKERREQUESTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17181A70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DrinkMakerRequestRow_TypeDefinitionIndex = 11995;
	...
	public:
		...
		::System::UInt32 FailTip; // 0x34
		::System::UInt32 SuccessTip; // 0x38
		::RPG::Client::TextID RequestShortDesc; // 0x40
