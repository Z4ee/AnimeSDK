...
#define RPG_GAMECORE_PLANETFESGACHABASICROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D79CE20)
#define RPG_GAMECORE_PLANETFESGACHABASICROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D79D090)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 MultiGachaCount; // 0x28
