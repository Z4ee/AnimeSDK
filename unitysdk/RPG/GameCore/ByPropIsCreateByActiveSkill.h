...
#define RPG_GAMECORE_BYPROPISCREATEBYACTIVESKILL_METHOD_4_575D78A2E938E78D_OFFSET UNITYSDK_OFFSET(0x1B2B5700)
#define RPG_GAMECORE_BYPROPISCREATEBYACTIVESKILL_METHOD_4_796323C3EA80CF4C_OFFSET UNITYSDK_OFFSET(0x1B2B5580)
#define RPG_GAMECORE_BYPROPISCREATEBYACTIVESKILL_METHOD_4_A051875F80E491A4_OFFSET UNITYSDK_OFFSET(0x1B2B5730)
#define RPG_GAMECORE_BYPROPISCREATEBYACTIVESKILL_METHOD_4_CC32DC2BBFA39D07_OFFSET UNITYSDK_OFFSET(0x1B2B55C0)
#define RPG_GAMECORE_BYPROPISCREATEBYACTIVESKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2B55B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByPropIsCreateByActiveSkill_TypeDefinitionIndex = 19528;
