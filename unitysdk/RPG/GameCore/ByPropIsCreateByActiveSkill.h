...
#define RPG_GAMECORE_BYPROPISCREATEBYACTIVESKILL_METHOD_4_9DF974EAE7378AAD_OFFSET UNITYSDK_OFFSET(0x1875DEF0)
#define RPG_GAMECORE_BYPROPISCREATEBYACTIVESKILL_METHOD_4_CC32DC2BBFA39D07_OFFSET UNITYSDK_OFFSET(0x1875DFC0)
#define RPG_GAMECORE_BYPROPISCREATEBYACTIVESKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x1875DF70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByPropIsCreateByActiveSkill_TypeDefinitionIndex = 19253;
