...
#define RPG_GAMECORE_ASSISTWAYPOINTPROPSTATECONDITION_METHOD_3_18ADC697CA3F92EB_OFFSET UNITYSDK_OFFSET(0x19483B30)
#define RPG_GAMECORE_ASSISTWAYPOINTPROPSTATECONDITION_METHOD_3_30496A545DFDD1DE_OFFSET UNITYSDK_OFFSET(0x19480EB0)
#define RPG_GAMECORE_ASSISTWAYPOINTPROPSTATECONDITION_METHOD_3_DED9D67F1564BA58_OFFSET UNITYSDK_OFFSET(0x19483B60)
#define RPG_GAMECORE_ASSISTWAYPOINTPROPSTATECONDITION_METHOD_3_F5AD1D6CD9F51981_OFFSET UNITYSDK_OFFSET(0x19481C20)
#define RPG_GAMECORE_ASSISTWAYPOINTPROPSTATECONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x19480EA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AssistWayPointPropStateCondition_TypeDefinitionIndex = 18045;
	...
	public:
		...
		static ::System::Void Method_3_DED9D67F1564BA58(::SimpleJSON::JSONNode* a1, ::RPG::GameCore::AssistWayPointPropStateCondition* a2)
		{
			return ((::System::Void(*)(::SimpleJSON::JSONNode*, ::RPG::GameCore::AssistWayPointPropStateCondition*))((::PBYTE)hIl2Cpp + RPG_GAMECORE_ASSISTWAYPOINTPROPSTATECONDITION_METHOD_3_DED9D67F1564BA58_OFFSET))(a1, a2);
		}
	};
}
