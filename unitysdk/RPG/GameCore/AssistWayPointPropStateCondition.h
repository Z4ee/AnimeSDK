...
#define RPG_GAMECORE_ASSISTWAYPOINTPROPSTATECONDITION_METHOD_3_18ADC697CA3F92EB_OFFSET UNITYSDK_OFFSET(0x1A062FC0)
#define RPG_GAMECORE_ASSISTWAYPOINTPROPSTATECONDITION_METHOD_3_30496A545DFDD1DE_OFFSET UNITYSDK_OFFSET(0x1A05EAD0)
#define RPG_GAMECORE_ASSISTWAYPOINTPROPSTATECONDITION_METHOD_3_529297A677680B7F_OFFSET UNITYSDK_OFFSET(0x1A062FF0)
#define RPG_GAMECORE_ASSISTWAYPOINTPROPSTATECONDITION_METHOD_3_F5AD1D6CD9F51981_OFFSET UNITYSDK_OFFSET(0x1A05FBB0)
#define RPG_GAMECORE_ASSISTWAYPOINTPROPSTATECONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A05EAC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AssistWayPointPropStateCondition_TypeDefinitionIndex = 18249;
