...
#define RPG_GAMECORE_AUDIENCEGROUPMEMBERINFO_METHOD_3_109984F2F7F57804_OFFSET UNITYSDK_OFFSET(0x186B0060)
#define RPG_GAMECORE_AUDIENCEGROUPMEMBERINFO_METHOD_3_A0CDBA81ECA78857_OFFSET UNITYSDK_OFFSET(0x186B0020)
#define RPG_GAMECORE_AUDIENCEGROUPMEMBERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x186B0050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AudienceGroupMemberInfo_TypeDefinitionIndex = 20729;
