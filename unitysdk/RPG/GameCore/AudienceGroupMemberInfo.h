...
#define RPG_GAMECORE_AUDIENCEGROUPMEMBERINFO_METHOD_3_109984F2F7F57804_OFFSET UNITYSDK_OFFSET(0x194880F0)
#define RPG_GAMECORE_AUDIENCEGROUPMEMBERINFO_METHOD_3_A0CDBA81ECA78857_OFFSET UNITYSDK_OFFSET(0x194880B0)
#define RPG_GAMECORE_AUDIENCEGROUPMEMBERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x194880E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AudienceGroupMemberInfo_TypeDefinitionIndex = 20658;
