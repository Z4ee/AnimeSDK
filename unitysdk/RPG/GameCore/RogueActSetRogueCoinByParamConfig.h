...
#define RPG_GAMECORE_ROGUEACTSETROGUECOINBYPARAMCONFIG_METHOD_6_00B458059A7DF927_OFFSET UNITYSDK_OFFSET(0x1D3BB070)
#define RPG_GAMECORE_ROGUEACTSETROGUECOINBYPARAMCONFIG_METHOD_6_F8A47AB36FE437CB_OFFSET UNITYSDK_OFFSET(0x1D3BB0C0)
#define RPG_GAMECORE_ROGUEACTSETROGUECOINBYPARAMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3BB0B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActSetRogueCoinByParamConfig_TypeDefinitionIndex = 19390;
