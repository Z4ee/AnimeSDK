...
#define RPG_GAMECORE_ROGUEACTSETROGUECOINBYPARAMCONFIG_METHOD_6_DDCF60B031404F5E_OFFSET UNITYSDK_OFFSET(0x19AF8950)
#define RPG_GAMECORE_ROGUEACTSETROGUECOINBYPARAMCONFIG_METHOD_6_F8A47AB36FE437CB_OFFSET UNITYSDK_OFFSET(0x19AF8B70)
#define RPG_GAMECORE_ROGUEACTSETROGUECOINBYPARAMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AF8A90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActSetRogueCoinByParamConfig_TypeDefinitionIndex = 18588;
