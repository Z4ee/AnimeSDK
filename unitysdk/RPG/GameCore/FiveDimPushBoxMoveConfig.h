...
#define RPG_GAMECORE_FIVEDIMPUSHBOXMOVECONFIG_METHOD_3_2086E56A1A232E17_OFFSET UNITYSDK_OFFSET(0x1D875820)
#define RPG_GAMECORE_FIVEDIMPUSHBOXMOVECONFIG_METHOD_3_57E087CAE7935EE4_OFFSET UNITYSDK_OFFSET(0x1D873FA0)
#define RPG_GAMECORE_FIVEDIMPUSHBOXMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D873F90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimPushBoxMoveConfig_TypeDefinitionIndex = 16513;
