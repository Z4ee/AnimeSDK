...
#define RPG_GAMECORE_FIVEDIMPUSHBOXMOVECONFIG_METHOD_3_2086E56A1A232E17_OFFSET UNITYSDK_OFFSET(0x19750F80)
#define RPG_GAMECORE_FIVEDIMPUSHBOXMOVECONFIG_METHOD_3_57E087CAE7935EE4_OFFSET UNITYSDK_OFFSET(0x1974F740)
#define RPG_GAMECORE_FIVEDIMPUSHBOXMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1974F730)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimPushBoxMoveConfig_TypeDefinitionIndex = 15863;
