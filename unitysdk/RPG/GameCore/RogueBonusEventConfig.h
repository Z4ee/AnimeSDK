...
#define RPG_GAMECORE_ROGUEBONUSEVENTCONFIG_METHOD_2_79ACCB5B16BFC955_OFFSET UNITYSDK_OFFSET(0x1D911C50)
#define RPG_GAMECORE_ROGUEBONUSEVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D911C90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueBonusEventConfig_TypeDefinitionIndex = 17692;
