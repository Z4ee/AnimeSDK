...
#define RPG_GAMECORE_ROGUEBONUSEVENTCONFIG_METHOD_2_79ACCB5B16BFC955_OFFSET UNITYSDK_OFFSET(0x175E4020)
#define RPG_GAMECORE_ROGUEBONUSEVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175E4060)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueBonusEventConfig_TypeDefinitionIndex = 16445;
