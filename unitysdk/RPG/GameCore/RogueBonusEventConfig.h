...
#define RPG_GAMECORE_ROGUEBONUSEVENTCONFIG_METHOD_2_79ACCB5B16BFC955_OFFSET UNITYSDK_OFFSET(0x1C4A7E70)
#define RPG_GAMECORE_ROGUEBONUSEVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4A7EB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueBonusEventConfig_TypeDefinitionIndex = 17176;
