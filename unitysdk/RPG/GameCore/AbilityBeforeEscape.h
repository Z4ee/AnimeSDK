...
#define RPG_GAMECORE_ABILITYBEFOREESCAPE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x106C3650)
#define RPG_GAMECORE_ABILITYBEFOREESCAPE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x106C3610)
#define RPG_GAMECORE_ABILITYBEFOREESCAPE_INIT_OFFSET UNITYSDK_OFFSET(0x106C35C0)
#define RPG_GAMECORE_ABILITYBEFOREESCAPE__CTOR_OFFSET UNITYSDK_OFFSET(0x106C36A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AbilityBeforeEscape_TypeDefinitionIndex = 54041;
