...
#define RPG_GAMECORE_ABILITYBEFOREESCAPE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xE467210)
#define RPG_GAMECORE_ABILITYBEFOREESCAPE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xE4671D0)
#define RPG_GAMECORE_ABILITYBEFOREESCAPE_INIT_OFFSET UNITYSDK_OFFSET(0xE467180)
#define RPG_GAMECORE_ABILITYBEFOREESCAPE__CTOR_OFFSET UNITYSDK_OFFSET(0xE467260)
