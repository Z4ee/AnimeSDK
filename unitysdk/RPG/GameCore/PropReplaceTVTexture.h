...
#define RPG_GAMECORE_PROPREPLACETVTEXTURE_METHOD_3_00A147880B452789_OFFSET UNITYSDK_OFFSET(0x1D36CF90)
#define RPG_GAMECORE_PROPREPLACETVTEXTURE_METHOD_3_E836447938B0E30C_OFFSET UNITYSDK_OFFSET(0x1D36CED0)
#define RPG_GAMECORE_PROPREPLACETVTEXTURE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D36CF40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropReplaceTVTexture_TypeDefinitionIndex = 21824;
