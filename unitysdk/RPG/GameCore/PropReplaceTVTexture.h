...
#define RPG_GAMECORE_PROPREPLACETVTEXTURE_METHOD_3_00A147880B452789_OFFSET UNITYSDK_OFFSET(0x17523410)
#define RPG_GAMECORE_PROPREPLACETVTEXTURE_METHOD_3_6FD20E8E07683532_OFFSET UNITYSDK_OFFSET(0x17523290)
#define RPG_GAMECORE_PROPREPLACETVTEXTURE__CTOR_OFFSET UNITYSDK_OFFSET(0x17523360)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropReplaceTVTexture_TypeDefinitionIndex = 20254;
