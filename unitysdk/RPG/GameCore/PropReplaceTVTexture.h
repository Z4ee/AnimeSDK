...
#define RPG_GAMECORE_PROPREPLACETVTEXTURE_METHOD_3_00A147880B452789_OFFSET UNITYSDK_OFFSET(0x18C72E50)
#define RPG_GAMECORE_PROPREPLACETVTEXTURE_METHOD_3_6FD20E8E07683532_OFFSET UNITYSDK_OFFSET(0x18C72CD0)
#define RPG_GAMECORE_PROPREPLACETVTEXTURE__CTOR_OFFSET UNITYSDK_OFFSET(0x18C72DA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropReplaceTVTexture_TypeDefinitionIndex = 20936;
