...
#define RPG_GAMECORE_ROGUEMODIFIERKONGONSAMEPERSONAROOMCARDNUMANDCONTINUALNOTKONGCONFIG_METHOD_3_4C9695FF81FC0FEB_OFFSET UNITYSDK_OFFSET(0x1EEF9E30)
#define RPG_GAMECORE_ROGUEMODIFIERKONGONSAMEPERSONAROOMCARDNUMANDCONTINUALNOTKONGCONFIG_METHOD_3_91944EB7AB2462EF_OFFSET UNITYSDK_OFFSET(0x1EEF9E80)
#define RPG_GAMECORE_ROGUEMODIFIERKONGONSAMEPERSONAROOMCARDNUMANDCONTINUALNOTKONGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEF9E70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierKongOnSamePersonaRoomCardNumAndContinualNotKongConfig_TypeDefinitionIndex = 17610;
