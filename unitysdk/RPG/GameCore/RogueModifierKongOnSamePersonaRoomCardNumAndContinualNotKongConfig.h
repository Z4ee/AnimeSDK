...
#define RPG_GAMECORE_ROGUEMODIFIERKONGONSAMEPERSONAROOMCARDNUMANDCONTINUALNOTKONGCONFIG_METHOD_3_7FDC002F8983EE36_OFFSET UNITYSDK_OFFSET(0x18D3F3F0)
#define RPG_GAMECORE_ROGUEMODIFIERKONGONSAMEPERSONAROOMCARDNUMANDCONTINUALNOTKONGCONFIG_METHOD_3_91944EB7AB2462EF_OFFSET UNITYSDK_OFFSET(0x18D3F4C0)
#define RPG_GAMECORE_ROGUEMODIFIERKONGONSAMEPERSONAROOMCARDNUMANDCONTINUALNOTKONGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D3F470)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierKongOnSamePersonaRoomCardNumAndContinualNotKongConfig_TypeDefinitionIndex = 16919;
