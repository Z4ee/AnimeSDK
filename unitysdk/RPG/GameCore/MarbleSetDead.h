...
#define RPG_GAMECORE_MARBLESETDEAD_METHOD_3_6B2A874D916EF730_OFFSET UNITYSDK_OFFSET(0x1D4B2B00)
#define RPG_GAMECORE_MARBLESETDEAD_METHOD_3_B395FF5B78AC85B5_OFFSET UNITYSDK_OFFSET(0x1D4B2BA0)
#define RPG_GAMECORE_MARBLESETDEAD__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4B2B90)
