...
#define RPG_GAMECORE_ROGUEGENDYNAMICCONFIG_METHOD_2_C12FEC38A34A4427_OFFSET UNITYSDK_OFFSET(0x1D3E6300)
#define RPG_GAMECORE_ROGUEGENDYNAMICCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3E6340)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueGenDynamicConfig_TypeDefinitionIndex = 19585;
