...
#define RPG_GAMECORE_HIPPLENINTERACTWORKCONFIG_METHOD_2_8EA9AB74A8AFB5F6_OFFSET UNITYSDK_OFFSET(0x19836700)
#define RPG_GAMECORE_HIPPLENINTERACTWORKCONFIG_METHOD_2_8F389F5F240F0299_OFFSET UNITYSDK_OFFSET(0x19836860)
#define RPG_GAMECORE_HIPPLENINTERACTWORKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19833360)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HipplenInteractWorkConfig_TypeDefinitionIndex = 15942;
