...
#define RPG_GAMECORE_HIPPLENINTERACTWORKCONFIG_METHOD_2_8EA9AB74A8AFB5F6_OFFSET UNITYSDK_OFFSET(0x1D203FF0)
#define RPG_GAMECORE_HIPPLENINTERACTWORKCONFIG_METHOD_2_8F389F5F240F0299_OFFSET UNITYSDK_OFFSET(0x1D204160)
#define RPG_GAMECORE_HIPPLENINTERACTWORKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D204150)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HipplenInteractWorkConfig_TypeDefinitionIndex = 16608;
