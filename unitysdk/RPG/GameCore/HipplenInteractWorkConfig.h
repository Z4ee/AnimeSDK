...
#define RPG_GAMECORE_HIPPLENINTERACTWORKCONFIG_METHOD_2_8EA9AB74A8AFB5F6_OFFSET UNITYSDK_OFFSET(0x172AF680)
#define RPG_GAMECORE_HIPPLENINTERACTWORKCONFIG_METHOD_2_8F389F5F240F0299_OFFSET UNITYSDK_OFFSET(0x172AF7D0)
#define RPG_GAMECORE_HIPPLENINTERACTWORKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x172AC1E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HipplenInteractWorkConfig_TypeDefinitionIndex = 15369;
