...
#define RPG_GAMECORE_ROGUETOURNMIRACLEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1BB7AF50)
#define RPG_GAMECORE_ROGUETOURNMIRACLEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB7B700)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournMiracleRow_TypeDefinitionIndex = 14438;
