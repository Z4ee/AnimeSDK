...
#define RPG_GAMECORE_ROGUETOURNMIRACLEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CCC9240)
#define RPG_GAMECORE_ROGUETOURNMIRACLEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CCC99B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournMiracleRow_TypeDefinitionIndex = 14858;
	...
	public:
		...
		::RPG::GameCore::RogueMiracleCategory MiracleCategory; // 0x24
