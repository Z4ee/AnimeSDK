...
#define RPG_GAMECORE_GRIDFIGHTCONDCHECKHASAUGMENTCONFIG_METHOD_6_D28B78D76521C04B_OFFSET UNITYSDK_OFFSET(0x1C5C50D0)
#define RPG_GAMECORE_GRIDFIGHTCONDCHECKHASAUGMENTCONFIG_METHOD_6_DA9B56298FBB81A7_OFFSET UNITYSDK_OFFSET(0x1C5C5080)
#define RPG_GAMECORE_GRIDFIGHTCONDCHECKHASAUGMENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5C50C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightCondCheckHasAugmentConfig_TypeDefinitionIndex = 18578;
