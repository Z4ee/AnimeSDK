...
#define RPG_GAMECORE_STAGEPVSOFFLINEBAKESAMPLERDATA_METHOD_2_E73237E37779ECDD_OFFSET UNITYSDK_OFFSET(0x17769BF0)
#define RPG_GAMECORE_STAGEPVSOFFLINEBAKESAMPLERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17769D60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StagePVSOfflineBakeSamplerData_TypeDefinitionIndex = 17591;
