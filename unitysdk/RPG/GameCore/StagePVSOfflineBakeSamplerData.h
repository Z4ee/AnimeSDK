...
#define RPG_GAMECORE_STAGEPVSOFFLINEBAKESAMPLERDATA_METHOD_2_E73237E37779ECDD_OFFSET UNITYSDK_OFFSET(0x1B0B2550)
#define RPG_GAMECORE_STAGEPVSOFFLINEBAKESAMPLERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0B26C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StagePVSOfflineBakeSamplerData_TypeDefinitionIndex = 18430;
