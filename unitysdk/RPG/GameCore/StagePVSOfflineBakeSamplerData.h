...
#define RPG_GAMECORE_STAGEPVSOFFLINEBAKESAMPLERDATA_METHOD_2_E73237E37779ECDD_OFFSET UNITYSDK_OFFSET(0x18E8F780)
#define RPG_GAMECORE_STAGEPVSOFFLINEBAKESAMPLERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18E8F8F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StagePVSOfflineBakeSamplerData_TypeDefinitionIndex = 18204;
