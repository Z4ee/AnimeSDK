...
#define RPG_GAMECORE_WAITSERVERPROPSTATECHANGE_METHOD_3_720D4A2AB78F602E_OFFSET UNITYSDK_OFFSET(0x1D1BC430)
#define RPG_GAMECORE_WAITSERVERPROPSTATECHANGE_METHOD_3_ECCCEAEC04AAA89B_OFFSET UNITYSDK_OFFSET(0x1D1BC470)
#define RPG_GAMECORE_WAITSERVERPROPSTATECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1BC460)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitServerPropStateChange_TypeDefinitionIndex = 20433;
