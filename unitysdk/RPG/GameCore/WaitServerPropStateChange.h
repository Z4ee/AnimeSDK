...
#define RPG_GAMECORE_WAITSERVERPROPSTATECHANGE_METHOD_3_C06AE5E12ED00814_OFFSET UNITYSDK_OFFSET(0x19E60FE0)
#define RPG_GAMECORE_WAITSERVERPROPSTATECHANGE_METHOD_3_ECCCEAEC04AAA89B_OFFSET UNITYSDK_OFFSET(0x19E61050)
#define RPG_GAMECORE_WAITSERVERPROPSTATECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x19E61020)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitServerPropStateChange_TypeDefinitionIndex = 20061;
