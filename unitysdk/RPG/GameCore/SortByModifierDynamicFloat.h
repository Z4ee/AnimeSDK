...
#define RPG_GAMECORE_SORTBYMODIFIERDYNAMICFLOAT_METHOD_3_A4A183812FCEAB30_OFFSET UNITYSDK_OFFSET(0x1D53C680)
#define RPG_GAMECORE_SORTBYMODIFIERDYNAMICFLOAT_METHOD_3_EE157DAECBF6D6A6_OFFSET UNITYSDK_OFFSET(0x1D53C620)
#define RPG_GAMECORE_SORTBYMODIFIERDYNAMICFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D53C670)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SortByModifierDynamicFloat_TypeDefinitionIndex = 18044;
