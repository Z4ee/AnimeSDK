...
#define RPG_GAMECORE_CONDCOMPARECONFIG_METHOD_4_124A061733564D99_OFFSET UNITYSDK_OFFSET(0x1D9AE1E0)
#define RPG_GAMECORE_CONDCOMPARECONFIG_METHOD_4_3800BD344252F9A7_OFFSET UNITYSDK_OFFSET(0x1D9AE180)
#define RPG_GAMECORE_CONDCOMPARECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D9AE1D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CondCompareConfig_TypeDefinitionIndex = 16882;
