...
#define RPG_GAMECORE_CONDCOMPARECONFIG_METHOD_4_0A19E3E33F9B618D_OFFSET UNITYSDK_OFFSET(0x188312C0)
#define RPG_GAMECORE_CONDCOMPARECONFIG_METHOD_4_17813D1BD9475150_OFFSET UNITYSDK_OFFSET(0x18831420)
#define RPG_GAMECORE_CONDCOMPARECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18831390)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CondCompareConfig_TypeDefinitionIndex = 16165;
