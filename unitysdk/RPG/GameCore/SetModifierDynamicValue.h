...
#define RPG_GAMECORE_SETMODIFIERDYNAMICVALUE_METHOD_3_763FDB0E0C20CFEF_OFFSET UNITYSDK_OFFSET(0x176D6050)
#define RPG_GAMECORE_SETMODIFIERDYNAMICVALUE_METHOD_3_C0549A53A635AD30_OFFSET UNITYSDK_OFFSET(0x176D5F70)
#define RPG_GAMECORE_SETMODIFIERDYNAMICVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x176D5FF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetModifierDynamicValue_TypeDefinitionIndex = 20860;
