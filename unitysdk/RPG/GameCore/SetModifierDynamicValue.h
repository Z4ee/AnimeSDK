...
#define RPG_GAMECORE_SETMODIFIERDYNAMICVALUE_METHOD_3_763FDB0E0C20CFEF_OFFSET UNITYSDK_OFFSET(0x1E086340)
#define RPG_GAMECORE_SETMODIFIERDYNAMICVALUE_METHOD_3_C0549A53A635AD30_OFFSET UNITYSDK_OFFSET(0x1E086290)
#define RPG_GAMECORE_SETMODIFIERDYNAMICVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E086300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetModifierDynamicValue_TypeDefinitionIndex = 22425;
