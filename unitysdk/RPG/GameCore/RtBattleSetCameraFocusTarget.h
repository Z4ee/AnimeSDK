...
#define RPG_GAMECORE_RTBATTLESETCAMERAFOCUSTARGET_METHOD_3_A50D6F4715ACBC4E_OFFSET UNITYSDK_OFFSET(0x1BB88EB0)
#define RPG_GAMECORE_RTBATTLESETCAMERAFOCUSTARGET_METHOD_3_C0D03C53BA53A49F_OFFSET UNITYSDK_OFFSET(0x1BB88E10)
#define RPG_GAMECORE_RTBATTLESETCAMERAFOCUSTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB88E70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtBattleSetCameraFocusTarget_TypeDefinitionIndex = 23239;
