...
#define RPG_GAMECORE_RTBATTLESETCAMERAFOCUSTARGET_METHOD_3_A50D6F4715ACBC4E_OFFSET UNITYSDK_OFFSET(0x18DC56E0)
#define RPG_GAMECORE_RTBATTLESETCAMERAFOCUSTARGET_METHOD_3_DE2048DA5DBD8F84_OFFSET UNITYSDK_OFFSET(0x18DC5610)
#define RPG_GAMECORE_RTBATTLESETCAMERAFOCUSTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x18DC5690)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtBattleSetCameraFocusTarget_TypeDefinitionIndex = 23090;
