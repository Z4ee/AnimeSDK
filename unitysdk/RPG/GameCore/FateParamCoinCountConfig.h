...
#define RPG_GAMECORE_FATEPARAMCOINCOUNTCONFIG_METHOD_6_4410DC20F5C7B0A1_OFFSET UNITYSDK_OFFSET(0x19713570)
#define RPG_GAMECORE_FATEPARAMCOINCOUNTCONFIG_METHOD_6_F147A9002D79D12A_OFFSET UNITYSDK_OFFSET(0x197137C0)
#define RPG_GAMECORE_FATEPARAMCOINCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19713700)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateParamCoinCountConfig_TypeDefinitionIndex = 15815;
