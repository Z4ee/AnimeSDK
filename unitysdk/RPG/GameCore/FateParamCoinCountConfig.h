...
#define RPG_GAMECORE_FATEPARAMCOINCOUNTCONFIG_METHOD_6_565DDD398D21C80B_OFFSET UNITYSDK_OFFSET(0x1C0757D0)
#define RPG_GAMECORE_FATEPARAMCOINCOUNTCONFIG_METHOD_6_F147A9002D79D12A_OFFSET UNITYSDK_OFFSET(0x1C075870)
#define RPG_GAMECORE_FATEPARAMCOINCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C075860)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateParamCoinCountConfig_TypeDefinitionIndex = 15989;
