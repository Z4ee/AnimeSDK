...
#define RPG_GAMECORE_LEVELCHARACTERAFTERATTACKEND_CLEAR_OFFSET UNITYSDK_OFFSET(0xA97D4C0)
#define RPG_GAMECORE_LEVELCHARACTERAFTERATTACKEND_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xA97D560)
#define RPG_GAMECORE_LEVELCHARACTERAFTERATTACKEND_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xA97D510)
#define RPG_GAMECORE_LEVELCHARACTERAFTERATTACKEND_INIT_OFFSET UNITYSDK_OFFSET(0xA97D470)
#define RPG_GAMECORE_LEVELCHARACTERAFTERATTACKEND__CTOR_OFFSET UNITYSDK_OFFSET(0xA97D5B0)
#define RPG_GAMECORE_LEVELCHARACTERAFTERATTACKEND___IFIXBASEPROXY_CLEAR_OFFSET UNITYSDK_OFFSET(0xA97D5C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelCharacterAfterAttackEnd_TypeDefinitionIndex = 45683;
