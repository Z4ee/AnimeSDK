...
#define RPG_GAMECORE_LEVELCHARACTERAFTERATTACKEND_CLEAR_OFFSET UNITYSDK_OFFSET(0xE6868F0)
#define RPG_GAMECORE_LEVELCHARACTERAFTERATTACKEND_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xE686990)
#define RPG_GAMECORE_LEVELCHARACTERAFTERATTACKEND_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xE686940)
#define RPG_GAMECORE_LEVELCHARACTERAFTERATTACKEND_INIT_OFFSET UNITYSDK_OFFSET(0xE6868A0)
#define RPG_GAMECORE_LEVELCHARACTERAFTERATTACKEND__CTOR_OFFSET UNITYSDK_OFFSET(0xE6869E0)
