...
#define RPG_GAMECORE_TARGETFETCHMAINMONSTER_METHOD_4_368BEF7021140038_OFFSET UNITYSDK_OFFSET(0x1D5AC350)
#define RPG_GAMECORE_TARGETFETCHMAINMONSTER_METHOD_4_57A84FB8D5A4BEF0_OFFSET UNITYSDK_OFFSET(0x1D5AC280)
#define RPG_GAMECORE_TARGETFETCHMAINMONSTER_METHOD_4_658492D16D4E0975_OFFSET UNITYSDK_OFFSET(0x1D5AC2F0)
#define RPG_GAMECORE_TARGETFETCHMAINMONSTER_METHOD_4_B920E50304484A45_OFFSET UNITYSDK_OFFSET(0x1D5AC380)
#define RPG_GAMECORE_TARGETFETCHMAINMONSTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5AC370)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchMainMonster_TypeDefinitionIndex = 23654;
