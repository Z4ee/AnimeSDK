...
#define RPG_GAMECORE_FIVEDIMCONVEYORBAKEDCONFIG_METHOD_2_3B2DFD6F904E65F9_OFFSET UNITYSDK_OFFSET(0x1D0A7000)
#define RPG_GAMECORE_FIVEDIMCONVEYORBAKEDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0A7110)
