...
#define RPG_GAMECORE_FIVEDIMCONVEYORBAKEDCONFIG_METHOD_2_3B2DFD6F904E65F9_OFFSET UNITYSDK_OFFSET(0x188FAF10)
#define RPG_GAMECORE_FIVEDIMCONVEYORBAKEDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x188FB020)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimConveyorBakedConfig_TypeDefinitionIndex = 15776;
