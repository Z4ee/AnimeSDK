...
#define RPG_GAMECORE_MATCHTHREEVSTALKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x173B95A0)
#define RPG_GAMECORE_MATCHTHREEVSTALKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x173B97B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MatchThreeVsTalkRow_TypeDefinitionIndex = 10960;
