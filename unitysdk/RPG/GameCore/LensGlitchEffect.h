...
#define RPG_GAMECORE_LENSGLITCHEFFECT_METHOD_3_1D87B081ACB017BB_OFFSET UNITYSDK_OFFSET(0x1D1C7E20)
#define RPG_GAMECORE_LENSGLITCHEFFECT_METHOD_3_DD2DCA8FDC6DCFFF_OFFSET UNITYSDK_OFFSET(0x1D1C7EB0)
#define RPG_GAMECORE_LENSGLITCHEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1C7E80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LensGlitchEffect_TypeDefinitionIndex = 22145;
