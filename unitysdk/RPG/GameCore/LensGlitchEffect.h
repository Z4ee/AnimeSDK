...
#define RPG_GAMECORE_LENSGLITCHEFFECT_METHOD_3_2DCC22DAE115DD8B_OFFSET UNITYSDK_OFFSET(0x1732CE80)
#define RPG_GAMECORE_LENSGLITCHEFFECT_METHOD_3_DD2DCA8FDC6DCFFF_OFFSET UNITYSDK_OFFSET(0x1732CF40)
#define RPG_GAMECORE_LENSGLITCHEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1732CEF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LensGlitchEffect_TypeDefinitionIndex = 20590;
