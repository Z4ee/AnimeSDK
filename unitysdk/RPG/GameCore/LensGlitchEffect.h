...
#define RPG_GAMECORE_LENSGLITCHEFFECT_METHOD_3_2DCC22DAE115DD8B_OFFSET UNITYSDK_OFFSET(0x18A3A730)
#define RPG_GAMECORE_LENSGLITCHEFFECT_METHOD_3_DD2DCA8FDC6DCFFF_OFFSET UNITYSDK_OFFSET(0x18A3A7F0)
#define RPG_GAMECORE_LENSGLITCHEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x18A3A7A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LensGlitchEffect_TypeDefinitionIndex = 21274;
