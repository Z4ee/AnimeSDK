...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERLOCKDATACONFIG_METHOD_3_42F76368C5F4E8F1_OFFSET UNITYSDK_OFFSET(0x1D06A2B0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERLOCKDATACONFIG_METHOD_3_E494AC0B7A19DC0D_OFFSET UNITYSDK_OFFSET(0x1D06A260)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERLOCKDATACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D06A2A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierLockDataConfig_TypeDefinitionIndex = 18593;
