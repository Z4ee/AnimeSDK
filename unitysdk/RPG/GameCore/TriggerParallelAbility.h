...
#define RPG_GAMECORE_TRIGGERPARALLELABILITY_METHOD_3_16C5F9343292749F_OFFSET UNITYSDK_OFFSET(0x178CBC80)
#define RPG_GAMECORE_TRIGGERPARALLELABILITY_METHOD_3_94317235762B4C2C_OFFSET UNITYSDK_OFFSET(0x178CBD00)
#define RPG_GAMECORE_TRIGGERPARALLELABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x178CBCD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerParallelAbility_TypeDefinitionIndex = 20876;
