...
#define RPG_GAMECORE_SKILLNAVIGATIONCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D4BADB0)
#define RPG_GAMECORE_SKILLNAVIGATIONCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4BB4D0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::AvatarBaseType AvatarBaseType; // 0x14
		::System::UInt32 Right; // 0x18
		::System::UInt32 Down; // 0x1C
