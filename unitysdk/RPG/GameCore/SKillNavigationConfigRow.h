...
#define RPG_GAMECORE_SKILLNAVIGATIONCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1767A330)
#define RPG_GAMECORE_SKILLNAVIGATIONCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1767AA50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SKillNavigationConfigRow_TypeDefinitionIndex = 12627;
	...
	public:
		...
		::System::UInt32 Down; // 0x20
		::System::UInt32 PointID; // 0x24
