...
#define RPG_GAMECORE_LITTLEGAMESMARTOBJECTSLOTDATA_METHOD_2_6DF4151C4CD65A0D_OFFSET UNITYSDK_OFFSET(0x1D205E00)
#define RPG_GAMECORE_LITTLEGAMESMARTOBJECTSLOTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1D205FD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameSmartObjectSlotData_TypeDefinitionIndex = 18652;
