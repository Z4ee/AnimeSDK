...
#define RPG_GAMECORE_LITTLEGAMESMARTOBJECTSLOTDATA_METHOD_2_6DF4151C4CD65A0D_OFFSET UNITYSDK_OFFSET(0x18A6E590)
#define RPG_GAMECORE_LITTLEGAMESMARTOBJECTSLOTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18A6E760)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameSmartObjectSlotData_TypeDefinitionIndex = 17922;
