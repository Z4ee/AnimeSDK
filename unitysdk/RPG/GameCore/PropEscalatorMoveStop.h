...
#define RPG_GAMECORE_PROPESCALATORMOVESTOP_METHOD_3_0B5950FDA3194282_OFFSET UNITYSDK_OFFSET(0x1751B320)
#define RPG_GAMECORE_PROPESCALATORMOVESTOP_METHOD_3_9ACE875DD87BDE18_OFFSET UNITYSDK_OFFSET(0x1751B3F0)
#define RPG_GAMECORE_PROPESCALATORMOVESTOP__CTOR_OFFSET UNITYSDK_OFFSET(0x1751B3A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropEscalatorMoveStop_TypeDefinitionIndex = 19345;
