...
#define RPG_GAMECORE_CHIMERADUELUIMOVETOSUMMONQUEUENODE_METHOD_3_0BA96FE7885A1370_OFFSET UNITYSDK_OFFSET(0x18806F40)
#define RPG_GAMECORE_CHIMERADUELUIMOVETOSUMMONQUEUENODE_METHOD_3_A71EE3BA1BD149CE_OFFSET UNITYSDK_OFFSET(0x188070C0)
#define RPG_GAMECORE_CHIMERADUELUIMOVETOSUMMONQUEUENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x18807070)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelUIMoveToSummonQueueNode_TypeDefinitionIndex = 15133;
