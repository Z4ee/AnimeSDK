...
#define RPG_GAMECORE_ABILITYBEINGLIMBO_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1120FE20)
#define RPG_GAMECORE_ABILITYBEINGLIMBO_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x1120FDE0)
#define RPG_GAMECORE_ABILITYBEINGLIMBO_INIT_OFFSET UNITYSDK_OFFSET(0x1120FD90)
#define RPG_GAMECORE_ABILITYBEINGLIMBO__CTOR_OFFSET UNITYSDK_OFFSET(0x1120FE70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AbilityBeingLimbo_TypeDefinitionIndex = 56760;
