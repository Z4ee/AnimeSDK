...
#define RPG_GAMECORE_ACTIVITYEXPEDITIONGROUPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1AAECA60)
#define RPG_GAMECORE_ACTIVITYEXPEDITIONGROUPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAECBE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityExpeditionGroupRow_TypeDefinitionIndex = 11052;
