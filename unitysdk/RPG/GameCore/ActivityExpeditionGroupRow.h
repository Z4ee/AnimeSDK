...
#define RPG_GAMECORE_ACTIVITYEXPEDITIONGROUPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x193E3F80)
#define RPG_GAMECORE_ACTIVITYEXPEDITIONGROUPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x193E4100)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityExpeditionGroupRow_TypeDefinitionIndex = 11002;
