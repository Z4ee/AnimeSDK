...
#define RPG_GAMECORE_BYPAMNORMALACTIONSWITCH_METHOD_4_E71FC503138E632F_OFFSET UNITYSDK_OFFSET(0x17037E50)
#define RPG_GAMECORE_BYPAMNORMALACTIONSWITCH_METHOD_4_FDB6515367220805_OFFSET UNITYSDK_OFFSET(0x17037D80)
#define RPG_GAMECORE_BYPAMNORMALACTIONSWITCH__CTOR_OFFSET UNITYSDK_OFFSET(0x17037E00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByPamNormalActionSwitch_TypeDefinitionIndex = 18288;
