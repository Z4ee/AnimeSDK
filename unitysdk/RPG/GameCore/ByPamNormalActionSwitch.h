...
#define RPG_GAMECORE_BYPAMNORMALACTIONSWITCH_METHOD_4_9EED02718F45D745_OFFSET UNITYSDK_OFFSET(0x1B2B1CD0)
#define RPG_GAMECORE_BYPAMNORMALACTIONSWITCH_METHOD_4_C378A24C434BA33C_OFFSET UNITYSDK_OFFSET(0x1B2B1D00)
#define RPG_GAMECORE_BYPAMNORMALACTIONSWITCH_METHOD_4_C671880CB07CD014_OFFSET UNITYSDK_OFFSET(0x1B2B1B50)
#define RPG_GAMECORE_BYPAMNORMALACTIONSWITCH_METHOD_4_E71FC503138E632F_OFFSET UNITYSDK_OFFSET(0x1B2B1B90)
#define RPG_GAMECORE_BYPAMNORMALACTIONSWITCH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2B1B80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByPamNormalActionSwitch_TypeDefinitionIndex = 19239;
