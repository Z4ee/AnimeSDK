...
#define RPG_GAMECORE_ROGUEACTGETRANDOMCOUNTROGUEBUFFCONFIG_METHOD_6_25E4DABE7E60FCE1_OFFSET UNITYSDK_OFFSET(0x1D3B7740)
#define RPG_GAMECORE_ROGUEACTGETRANDOMCOUNTROGUEBUFFCONFIG_METHOD_6_25ECE5F9E78A79BD_OFFSET UNITYSDK_OFFSET(0x1D3B76F0)
#define RPG_GAMECORE_ROGUEACTGETRANDOMCOUNTROGUEBUFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3B7730)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActGetRandomCountRogueBuffConfig_TypeDefinitionIndex = 19358;
