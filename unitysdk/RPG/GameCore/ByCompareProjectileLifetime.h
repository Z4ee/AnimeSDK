...
#define RPG_GAMECORE_BYCOMPAREPROJECTILELIFETIME_METHOD_4_3C63735B33A34D37_OFFSET UNITYSDK_OFFSET(0x17012700)
#define RPG_GAMECORE_BYCOMPAREPROJECTILELIFETIME_METHOD_4_A0A0760DF542A0C7_OFFSET UNITYSDK_OFFSET(0x170127D0)
#define RPG_GAMECORE_BYCOMPAREPROJECTILELIFETIME__CTOR_OFFSET UNITYSDK_OFFSET(0x17012780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareProjectileLifetime_TypeDefinitionIndex = 18529;
