...
#define RPG_GAMECORE_AIMONSTERRANKSELECTOR_METHOD_3_08D433266696ECC3_OFFSET UNITYSDK_OFFSET(0x1B9F5400)
#define RPG_GAMECORE_AIMONSTERRANKSELECTOR_METHOD_3_1F0E64C38D8AA19E_OFFSET UNITYSDK_OFFSET(0x1B9F53C0)
#define RPG_GAMECORE_AIMONSTERRANKSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9F53F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AIMonsterRankSelector_TypeDefinitionIndex = 14995;
