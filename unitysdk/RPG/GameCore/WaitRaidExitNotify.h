...
#define RPG_GAMECORE_WAITRAIDEXITNOTIFY_METHOD_3_A13D9750107246FB_OFFSET UNITYSDK_OFFSET(0x179023E0)
#define RPG_GAMECORE_WAITRAIDEXITNOTIFY_METHOD_3_F8DC904A8602E752_OFFSET UNITYSDK_OFFSET(0x17902460)
#define RPG_GAMECORE_WAITRAIDEXITNOTIFY__CTOR_OFFSET UNITYSDK_OFFSET(0x17902430)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitRaidExitNotify_TypeDefinitionIndex = 19237;
