...
#define RPG_GAMECORE_WAITRAIDEXITNOTIFY_METHOD_3_A13D9750107246FB_OFFSET UNITYSDK_OFFSET(0x191062A0)
#define RPG_GAMECORE_WAITRAIDEXITNOTIFY_METHOD_3_F8DC904A8602E752_OFFSET UNITYSDK_OFFSET(0x19106320)
#define RPG_GAMECORE_WAITRAIDEXITNOTIFY__CTOR_OFFSET UNITYSDK_OFFSET(0x191062F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitRaidExitNotify_TypeDefinitionIndex = 19896;
