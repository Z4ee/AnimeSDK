...
#define RPG_GAMECORE_PROPMOVETOV2TARGETANCHOR_METHOD_3_358ECDB6E391D24B_OFFSET UNITYSDK_OFFSET(0x17521820)
#define RPG_GAMECORE_PROPMOVETOV2TARGETANCHOR_METHOD_3_F01174A16FE0624E_OFFSET UNITYSDK_OFFSET(0x175218D0)
#define RPG_GAMECORE_PROPMOVETOV2TARGETANCHOR__CTOR_OFFSET UNITYSDK_OFFSET(0x175218C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropMoveToV2TargetAnchor_TypeDefinitionIndex = 16092;
