...
#define RPG_GAMECORE_BYCOMPAREALIVEENEMYNUMBER_METHOD_4_3FA2165BE2FC0B58_OFFSET UNITYSDK_OFFSET(0x17002580)
#define RPG_GAMECORE_BYCOMPAREALIVEENEMYNUMBER_METHOD_4_6BE9488387CCC58A_OFFSET UNITYSDK_OFFSET(0x17002650)
#define RPG_GAMECORE_BYCOMPAREALIVEENEMYNUMBER__CTOR_OFFSET UNITYSDK_OFFSET(0x17002600)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareAliveEnemyNumber_TypeDefinitionIndex = 21193;
