...
#define RPG_GAMECORE_BYCOMPAREALIVEENEMYNUMBER_METHOD_4_03E30B7BF3CC5907_OFFSET UNITYSDK_OFFSET(0x1C308060)
#define RPG_GAMECORE_BYCOMPAREALIVEENEMYNUMBER_METHOD_4_6BE9488387CCC58A_OFFSET UNITYSDK_OFFSET(0x1C3080A0)
#define RPG_GAMECORE_BYCOMPAREALIVEENEMYNUMBER_METHOD_4_80689759B120E29C_OFFSET UNITYSDK_OFFSET(0x1C308300)
#define RPG_GAMECORE_BYCOMPAREALIVEENEMYNUMBER_METHOD_4_FA8322BB85B9FC12_OFFSET UNITYSDK_OFFSET(0x1C3082D0)
#define RPG_GAMECORE_BYCOMPAREALIVEENEMYNUMBER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C308090)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareAliveEnemyNumber_TypeDefinitionIndex = 22729;
