...
#define RPG_GAMECORE_ROGUEPARAMPERSONAROOMCARDREDRAWCOUNTCONFIG_METHOD_6_5536C5BCF42E305E_OFFSET UNITYSDK_OFFSET(0x1764BEB0)
#define RPG_GAMECORE_ROGUEPARAMPERSONAROOMCARDREDRAWCOUNTCONFIG_METHOD_6_C5B81F0AF572BD78_OFFSET UNITYSDK_OFFSET(0x1764C160)
#define RPG_GAMECORE_ROGUEPARAMPERSONAROOMCARDREDRAWCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1764C030)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamPersonaRoomCardReDrawCountConfig_TypeDefinitionIndex = 18205;
