...
#define RPG_GAMECORE_HOYOTAGCONTAINER_ADDTAG_OFFSET UNITYSDK_OFFSET(0x1B68C580)
#define RPG_GAMECORE_HOYOTAGCONTAINER_APPLYCONTAINEROVERRIDECONFIG_OFFSET UNITYSDK_OFFSET(0x1B68D8E0)
#define RPG_GAMECORE_HOYOTAGCONTAINER_CLONE_OFFSET UNITYSDK_OFFSET(0x1B68C270)
#define RPG_GAMECORE_HOYOTAGCONTAINER_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1B68C500)
#define RPG_GAMECORE_HOYOTAGCONTAINER_FINDTAG_OFFSET UNITYSDK_OFFSET(0x1B68C680)
#define RPG_GAMECORE_HOYOTAGCONTAINER_FIND_OFFSET UNITYSDK_OFFSET(0x1B68C7A0)
#define RPG_GAMECORE_HOYOTAGCONTAINER_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B68C030)
#define RPG_GAMECORE_HOYOTAGCONTAINER_FROMJSON_OFFSET UNITYSDK_OFFSET(0x1B68C100)
#define RPG_GAMECORE_HOYOTAGCONTAINER_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B68C380)
#define RPG_GAMECORE_HOYOTAGCONTAINER_GETHOYOTAGNODEINFO_OFFSET UNITYSDK_OFFSET(0x1B68C8C0)
#define RPG_GAMECORE_HOYOTAGCONTAINER_GETHOYOTAGNODEINFO_RUNTIME_OFFSET UNITYSDK_OFFSET(0x1B68C9B0)
#define RPG_GAMECORE_HOYOTAGCONTAINER_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1B68C550)
#define RPG_GAMECORE_HOYOTAGCONTAINER_HASALLEXACT_OFFSET UNITYSDK_OFFSET(0x1B68D6D0)
#define RPG_GAMECORE_HOYOTAGCONTAINER_HASALL_OFFSET UNITYSDK_OFFSET(0x1B68D5E0)
#define RPG_GAMECORE_HOYOTAGCONTAINER_HASANYEXACT_OFFSET UNITYSDK_OFFSET(0x1B68D3E0)
#define RPG_GAMECORE_HOYOTAGCONTAINER_HASANY_1_OFFSET UNITYSDK_OFFSET(0x1B68CE90)
#define RPG_GAMECORE_HOYOTAGCONTAINER_HASANY_2_OFFSET UNITYSDK_OFFSET(0x1B68D360)
#define RPG_GAMECORE_HOYOTAGCONTAINER_HASANY_OFFSET UNITYSDK_OFFSET(0x1B68CDB0)
#define RPG_GAMECORE_HOYOTAGCONTAINER_HASTAGEXACT_OFFSET UNITYSDK_OFFSET(0x1B68CC90)
#define RPG_GAMECORE_HOYOTAGCONTAINER_HASTAG_OFFSET UNITYSDK_OFFSET(0x1B68CAA0)
#define RPG_GAMECORE_HOYOTAGCONTAINER_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x1B68C560)
#define RPG_GAMECORE_HOYOTAGCONTAINER_REMOVETAG_OFFSET UNITYSDK_OFFSET(0x1B68C6D0)
#define RPG_GAMECORE_HOYOTAGCONTAINER_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B68C4F0)
#define RPG_GAMECORE_HOYOTAGCONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B68C0F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HoyoTagContainer_TypeDefinitionIndex = 17586;
