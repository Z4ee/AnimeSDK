...
#define RPG_GAMECORE_LEVELEVENTSNAPSHOTCHECKAHEAD_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1BDFC490)
#define RPG_GAMECORE_LEVELEVENTSNAPSHOTCHECKAHEAD_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x1BDFC440)
#define RPG_GAMECORE_LEVELEVENTSNAPSHOTCHECKAHEAD__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDFC4E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelEventSnapshotCheckAhead_TypeDefinitionIndex = 54265;
