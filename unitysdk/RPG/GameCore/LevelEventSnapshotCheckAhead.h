...
#define RPG_GAMECORE_LEVELEVENTSNAPSHOTCHECKAHEAD_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xB6D8410)
#define RPG_GAMECORE_LEVELEVENTSNAPSHOTCHECKAHEAD_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xB6D83C0)
#define RPG_GAMECORE_LEVELEVENTSNAPSHOTCHECKAHEAD__CTOR_OFFSET UNITYSDK_OFFSET(0xB6D8460)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelEventSnapshotCheckAhead_TypeDefinitionIndex = 52355;
