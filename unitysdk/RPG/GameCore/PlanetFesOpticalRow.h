...
#define RPG_GAMECORE_PLANETFESOPTICALROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x174BEB70)
#define RPG_GAMECORE_PLANETFESOPTICALROW__CTOR_OFFSET UNITYSDK_OFFSET(0x174BEE10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlanetFesOpticalRow_TypeDefinitionIndex = 11210;

	class PlanetFesOpticalRow : public ::System::Object
	{
	public:
		::System::UInt32 GotoConfig; // 0x10
		::System::UInt32 ActivityModuleID; // 0x14
		::RPG::Client::TextID Progress; // 0x18
		::System::UInt32 Type; // 0x28
		::System::UInt32 RealProgress; // 0x2C
