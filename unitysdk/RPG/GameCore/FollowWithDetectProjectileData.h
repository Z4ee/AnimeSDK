...
#define RPG_GAMECORE_FOLLOWWITHDETECTPROJECTILEDATA_METHOD_3_E80637E2BF7E07BA_OFFSET UNITYSDK_OFFSET(0x1BEBDC70)
#define RPG_GAMECORE_FOLLOWWITHDETECTPROJECTILEDATA_METHOD_3_F0371D2C01DF7559_OFFSET UNITYSDK_OFFSET(0x1BEBDCD0)
#define RPG_GAMECORE_FOLLOWWITHDETECTPROJECTILEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEBDCC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FollowWithDetectProjectileData_TypeDefinitionIndex = 15055;
