...
#define RPG_GAMECORE_B51RACINGDEVELOPMENTACTIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CE5D1F0)
#define RPG_GAMECORE_B51RACINGDEVELOPMENTACTIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE5D3D0)
