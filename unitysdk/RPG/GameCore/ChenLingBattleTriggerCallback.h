...
#define RPG_GAMECORE_CHENLINGBATTLETRIGGERCALLBACK_METHOD_2_1BBC235BA78FAEB4_OFFSET UNITYSDK_OFFSET(0x187E4F50)
#define RPG_GAMECORE_CHENLINGBATTLETRIGGERCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x187E7C40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleTriggerCallback_TypeDefinitionIndex = 14870;
