...
#define RPG_GAMECORE_BYTARGETTEAM_METHOD_4_658A59B374066D91_OFFSET UNITYSDK_OFFSET(0x187627C0)
#define RPG_GAMECORE_BYTARGETTEAM_METHOD_4_F3624CEC2FCA443D_OFFSET UNITYSDK_OFFSET(0x18762890)
#define RPG_GAMECORE_BYTARGETTEAM__CTOR_OFFSET UNITYSDK_OFFSET(0x18762840)
