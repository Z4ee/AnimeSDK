...
#define RPG_GAMECORE_ROGUEACTGETMAGICUNITBYMAXSTYLECONFIG_METHOD_6_001C2E6C8EDBDB1B_OFFSET UNITYSDK_OFFSET(0x19AE5D30)
#define RPG_GAMECORE_ROGUEACTGETMAGICUNITBYMAXSTYLECONFIG_METHOD_6_33E7543F64A7712E_OFFSET UNITYSDK_OFFSET(0x19AE5B10)
#define RPG_GAMECORE_ROGUEACTGETMAGICUNITBYMAXSTYLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AE5C50)
