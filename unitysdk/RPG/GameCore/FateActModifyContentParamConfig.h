...
#define RPG_GAMECORE_FATEACTMODIFYCONTENTPARAMCONFIG_METHOD_6_58218579F99925E0_OFFSET UNITYSDK_OFFSET(0x171C1CC0)
#define RPG_GAMECORE_FATEACTMODIFYCONTENTPARAMCONFIG_METHOD_6_CB0CBA4DC74F435B_OFFSET UNITYSDK_OFFSET(0x171C1B50)
#define RPG_GAMECORE_FATEACTMODIFYCONTENTPARAMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171C1C20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateActModifyContentParamConfig_TypeDefinitionIndex = 17655;
