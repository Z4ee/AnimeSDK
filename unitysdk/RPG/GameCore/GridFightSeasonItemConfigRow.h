...
#define RPG_GAMECORE_GRIDFIGHTSEASONITEMCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x189D5B90)
#define RPG_GAMECORE_GRIDFIGHTSEASONITEMCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x189D5CB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightSeasonItemConfigRow_TypeDefinitionIndex = 12735;
