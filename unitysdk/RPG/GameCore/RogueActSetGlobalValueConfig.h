...
#define RPG_GAMECORE_ROGUEACTSETGLOBALVALUECONFIG_METHOD_6_9445E8248516A660_OFFSET UNITYSDK_OFFSET(0x18CD43C0)
#define RPG_GAMECORE_ROGUEACTSETGLOBALVALUECONFIG_METHOD_6_E45C655423A5226D_OFFSET UNITYSDK_OFFSET(0x18CD41A0)
#define RPG_GAMECORE_ROGUEACTSETGLOBALVALUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CD42E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActSetGlobalValueConfig_TypeDefinitionIndex = 18710;
