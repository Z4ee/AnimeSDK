...
#define RPG_GAMECORE_CAKERACEPERFORMANCEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1704E310)
#define RPG_GAMECORE_CAKERACEPERFORMANCEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1704E5A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRacePerformanceRow_TypeDefinitionIndex = 10319;
