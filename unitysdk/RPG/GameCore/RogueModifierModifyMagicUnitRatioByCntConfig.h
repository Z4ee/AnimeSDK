...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYMAGICUNITRATIOBYCNTCONFIG_METHOD_3_A06595649527DE07_OFFSET UNITYSDK_OFFSET(0x19B5F6C0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYMAGICUNITRATIOBYCNTCONFIG_METHOD_3_BF698B981E1C109E_OFFSET UNITYSDK_OFFSET(0x19B55C20)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYMAGICUNITRATIOBYCNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B55BD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyMagicUnitRatioByCntConfig_TypeDefinitionIndex = 16860;
