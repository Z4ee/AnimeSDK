...
#define RPG_GAMECORE_HIPPLENINCIDENTRANDOMSETTLEMENTCONFIG_METHOD_3_A0F99B48A8D4224D_OFFSET UNITYSDK_OFFSET(0x18A03B50)
#define RPG_GAMECORE_HIPPLENINCIDENTRANDOMSETTLEMENTCONFIG_METHOD_3_AC403B2704E56C7F_OFFSET UNITYSDK_OFFSET(0x18A03BB0)
#define RPG_GAMECORE_HIPPLENINCIDENTRANDOMSETTLEMENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18A03BA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HipplenIncidentRandomSettlementConfig_TypeDefinitionIndex = 15907;
