...
#define RPG_GAMECORE_HIPPLENINCIDENTRANDOMSETTLEMENTCONFIG_METHOD_3_A0F99B48A8D4224D_OFFSET UNITYSDK_OFFSET(0x1B688810)
#define RPG_GAMECORE_HIPPLENINCIDENTRANDOMSETTLEMENTCONFIG_METHOD_3_AC403B2704E56C7F_OFFSET UNITYSDK_OFFSET(0x1B688870)
#define RPG_GAMECORE_HIPPLENINCIDENTRANDOMSETTLEMENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B688860)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HipplenIncidentRandomSettlementConfig_TypeDefinitionIndex = 16142;
