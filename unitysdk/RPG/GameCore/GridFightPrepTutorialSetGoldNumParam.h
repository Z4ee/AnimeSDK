...
#define RPG_GAMECORE_GRIDFIGHTPREPTUTORIALSETGOLDNUMPARAM_METHOD_2_95599F5F0732F94D_OFFSET UNITYSDK_OFFSET(0x189D0380)
#define RPG_GAMECORE_GRIDFIGHTPREPTUTORIALSETGOLDNUMPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x189D0640)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightPrepTutorialSetGoldNumParam_TypeDefinitionIndex = 18888;
