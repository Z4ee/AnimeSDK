...
#define RPG_GAMECORE_GRIDFIGHTPREPTUTORIALSETGOLDNUMPARAM_METHOD_2_95599F5F0732F94D_OFFSET UNITYSDK_OFFSET(0x1D070420)
#define RPG_GAMECORE_GRIDFIGHTPREPTUTORIALSETGOLDNUMPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0706E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightPrepTutorialSetGoldNumParam_TypeDefinitionIndex = 19198;
