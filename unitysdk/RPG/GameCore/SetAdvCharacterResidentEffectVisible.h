...
#define RPG_GAMECORE_SETADVCHARACTERRESIDENTEFFECTVISIBLE_METHOD_3_5EB6A83232F04A93_OFFSET UNITYSDK_OFFSET(0x1D4DF2F0)
#define RPG_GAMECORE_SETADVCHARACTERRESIDENTEFFECTVISIBLE_METHOD_3_B654E780C00F9FEC_OFFSET UNITYSDK_OFFSET(0x1D4DF2B0)
#define RPG_GAMECORE_SETADVCHARACTERRESIDENTEFFECTVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4DF2E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetAdvCharacterResidentEffectVisible_TypeDefinitionIndex = 22152;
