...
#define RPG_GAMECORE_SETADVCHARACTERRESIDENTEFFECTVISIBLE_METHOD_3_5EB6A83232F04A93_OFFSET UNITYSDK_OFFSET(0x19C26E90)
#define RPG_GAMECORE_SETADVCHARACTERRESIDENTEFFECTVISIBLE_METHOD_3_F5340CB139B4BEC7_OFFSET UNITYSDK_OFFSET(0x19C26E10)
#define RPG_GAMECORE_SETADVCHARACTERRESIDENTEFFECTVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C26E60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetAdvCharacterResidentEffectVisible_TypeDefinitionIndex = 21174;
