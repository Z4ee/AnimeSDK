...
#define RPG_GAMECORE_CHIMEPUZZLEDIMALLBOARD_METHOD_3_69F5A1271ABD70A4_OFFSET UNITYSDK_OFFSET(0x19631730)
#define RPG_GAMECORE_CHIMEPUZZLEDIMALLBOARD_METHOD_3_EAEFC9E68C221CF0_OFFSET UNITYSDK_OFFSET(0x19631840)
#define RPG_GAMECORE_CHIMEPUZZLEDIMALLBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x19631810)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimePuzzleDimAllBoard_TypeDefinitionIndex = 20753;
