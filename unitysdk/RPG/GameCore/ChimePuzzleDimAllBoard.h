...
#define RPG_GAMECORE_CHIMEPUZZLEDIMALLBOARD_METHOD_3_1554D49FC5A8D12D_OFFSET UNITYSDK_OFFSET(0x1E01C670)
#define RPG_GAMECORE_CHIMEPUZZLEDIMALLBOARD_METHOD_3_EAEFC9E68C221CF0_OFFSET UNITYSDK_OFFSET(0x1E01C740)
#define RPG_GAMECORE_CHIMEPUZZLEDIMALLBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x1E01C730)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimePuzzleDimAllBoard_TypeDefinitionIndex = 21728;
