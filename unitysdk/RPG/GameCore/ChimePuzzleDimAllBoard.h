...
#define RPG_GAMECORE_CHIMEPUZZLEDIMALLBOARD_METHOD_3_69F5A1271ABD70A4_OFFSET UNITYSDK_OFFSET(0x170903F0)
#define RPG_GAMECORE_CHIMEPUZZLEDIMALLBOARD_METHOD_3_EAEFC9E68C221CF0_OFFSET UNITYSDK_OFFSET(0x17090500)
#define RPG_GAMECORE_CHIMEPUZZLEDIMALLBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x170904D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimePuzzleDimAllBoard_TypeDefinitionIndex = 20148;
