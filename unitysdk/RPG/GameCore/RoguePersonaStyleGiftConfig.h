...
#define RPG_GAMECORE_ROGUEPERSONASTYLEGIFTCONFIG_METHOD_2_77313293B8640703_OFFSET UNITYSDK_OFFSET(0x19BBA090)
#define RPG_GAMECORE_ROGUEPERSONASTYLEGIFTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19BBA0D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RoguePersonaStyleGiftConfig_TypeDefinitionIndex = 17114;
