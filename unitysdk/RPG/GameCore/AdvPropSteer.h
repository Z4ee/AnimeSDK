...
#define RPG_GAMECORE_ADVPROPSTEER_METHOD_3_04FDEF433B81EFAA_OFFSET UNITYSDK_OFFSET(0x1CDD5910)
#define RPG_GAMECORE_ADVPROPSTEER_METHOD_3_1638D92EF43D021A_OFFSET UNITYSDK_OFFSET(0x1CDD5990)
#define RPG_GAMECORE_ADVPROPSTEER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDD5960)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvPropSteer_TypeDefinitionIndex = 21802;
