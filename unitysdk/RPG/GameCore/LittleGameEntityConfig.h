...
#define RPG_GAMECORE_LITTLEGAMEENTITYCONFIG_METHOD_2_4DCC79EFF41C6A36_OFFSET UNITYSDK_OFFSET(0x1BCC08C0)
#define RPG_GAMECORE_LITTLEGAMEENTITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCC0A70)
