...
#define RPG_GAMECORE_CHENLINGBATTLEBULLETVIEW_METHOD_2_CDDE3AD77B5A7F7E_OFFSET UNITYSDK_OFFSET(0x1707C910)
#define RPG_GAMECORE_CHENLINGBATTLEBULLETVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x1707D060)
