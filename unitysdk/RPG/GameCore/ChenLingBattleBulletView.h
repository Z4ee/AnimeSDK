...
#define RPG_GAMECORE_CHENLINGBATTLEBULLETVIEW_METHOD_2_054357962548EC53_OFFSET UNITYSDK_OFFSET(0x1C379740)
#define RPG_GAMECORE_CHENLINGBATTLEBULLETVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C379E80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleBulletView_TypeDefinitionIndex = 15102;
