...
#define RPG_GAMECORE_GMACCOUNTRELICCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B985170)
#define RPG_GAMECORE_GMACCOUNTRELICCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B985360)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 ItemRelicID; // 0x1C
