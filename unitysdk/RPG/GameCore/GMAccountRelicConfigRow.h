...
#define RPG_GAMECORE_GMACCOUNTRELICCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x197AC6F0)
#define RPG_GAMECORE_GMACCOUNTRELICCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x197AC8E0)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::System::UInt32 ItemRelicNum; // 0x10
		::System::UInt32 ID; // 0x14
		::System::UInt32 ItemRelicID; // 0x18
		::System::UInt32 ItemRelicLevel; // 0x1C
