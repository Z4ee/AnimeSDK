...
#define RPG_GAMECORE_GMACCOUNTRELICCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17225590)
#define RPG_GAMECORE_GMACCOUNTRELICCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17225780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GMAccountRelicConfigRow_TypeDefinitionIndex = 12185;

	class GMAccountRelicConfigRow : public ::System::Object
	{
	public:
		::System::UInt32 ItemRelicID; // 0x10
		::System::UInt32 ItemRelicLevel; // 0x14
