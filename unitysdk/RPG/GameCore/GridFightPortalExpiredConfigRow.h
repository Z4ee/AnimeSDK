...
#define RPG_GAMECORE_GRIDFIGHTPORTALEXPIREDCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x189CF510)
#define RPG_GAMECORE_GRIDFIGHTPORTALEXPIREDCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x189CF680)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightPortalExpiredConfigRow_TypeDefinitionIndex = 12923;
