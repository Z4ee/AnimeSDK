...
#define RPG_GAMECORE_WAITPHOTOGRAPHCONDITIONRESULT_METHOD_3_2A5B9466335EF6D5_OFFSET UNITYSDK_OFFSET(0x1D1B81E0)
#define RPG_GAMECORE_WAITPHOTOGRAPHCONDITIONRESULT_METHOD_3_C22C9927811BE18C_OFFSET UNITYSDK_OFFSET(0x1D1B8230)
#define RPG_GAMECORE_WAITPHOTOGRAPHCONDITIONRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1B8220)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitPhotoGraphConditionResult_TypeDefinitionIndex = 20828;
