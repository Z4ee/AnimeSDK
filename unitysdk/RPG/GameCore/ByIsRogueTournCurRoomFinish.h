...
#define RPG_GAMECORE_BYISROGUETOURNCURROOMFINISH_METHOD_4_86773FAC16C8579C_OFFSET UNITYSDK_OFFSET(0x170320A0)
#define RPG_GAMECORE_BYISROGUETOURNCURROOMFINISH_METHOD_4_EB2816B774EF9FD6_OFFSET UNITYSDK_OFFSET(0x17031FD0)
#define RPG_GAMECORE_BYISROGUETOURNCURROOMFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x17032050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsRogueTournCurRoomFinish_TypeDefinitionIndex = 20304;
