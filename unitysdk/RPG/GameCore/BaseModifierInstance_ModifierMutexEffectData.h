...
#define RPG_GAMECORE_BASEMODIFIERINSTANCE_MODIFIERMUTEXEFFECTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x195CEB00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BaseModifierInstance_ModifierMutexEffectData_TypeDefinitionIndex = 51961;
	...
	public:
		...
		::System::Int32 MaxMutexCount; // 0x2C
		::RPG::GameCore::EffectMutexType MutexType; // 0x30
