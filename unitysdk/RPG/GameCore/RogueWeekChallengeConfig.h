...
#define RPG_GAMECORE_ROGUEWEEKCHALLENGECONFIG_METHOD_2_5B7EEFF88A395C7D_OFFSET UNITYSDK_OFFSET(0x18D80580)
#define RPG_GAMECORE_ROGUEWEEKCHALLENGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D805C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueWeekChallengeConfig_TypeDefinitionIndex = 17112;
