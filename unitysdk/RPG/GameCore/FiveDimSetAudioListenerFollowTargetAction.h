...
#define RPG_GAMECORE_FIVEDIMSETAUDIOLISTENERFOLLOWTARGETACTION_METHOD_3_43B3367F905377CA_OFFSET UNITYSDK_OFFSET(0x1D877F30)
#define RPG_GAMECORE_FIVEDIMSETAUDIOLISTENERFOLLOWTARGETACTION_METHOD_3_EB2961ED9BEBF32F_OFFSET UNITYSDK_OFFSET(0x1D877FE0)
#define RPG_GAMECORE_FIVEDIMSETAUDIOLISTENERFOLLOWTARGETACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D877FD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSetAudioListenerFollowTargetAction_TypeDefinitionIndex = 18511;
