...
#define RPG_GAMECORE_IDLELIVECHAPTERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B6932E0)
#define RPG_GAMECORE_IDLELIVECHAPTERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6937A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int IdleLiveChapterRow_TypeDefinitionIndex = 11278;
	...
	public:
		...
		::System::Boolean IsHardMode; // 0x2C
		::System::Boolean ReturntoMaze; // 0x2D
		::RPG::Client::TextID Number; // 0x30
		::RPG::Client::TextID Name; // 0x40
		::System::UInt32 ActivityModuleID; // 0x50
		::System::UInt32 ChapterIndex; // 0x54
		::System::UInt32 BossID; // 0x58
		::System::UInt32 FinalAct; // 0x5C
