...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERRANDOMPORTALEFFECTCONFIG_METHOD_3_E04DF58CA8B76A7E_OFFSET UNITYSDK_OFFSET(0x1D06A740)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERRANDOMPORTALEFFECTCONFIG_METHOD_3_E755CB7746FDFE3A_OFFSET UNITYSDK_OFFSET(0x1D06A790)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERRANDOMPORTALEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D06A780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierRandomPortalEffectConfig_TypeDefinitionIndex = 18694;
