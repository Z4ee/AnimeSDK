...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERRANDOMPORTALEFFECTCONFIG_METHOD_3_A17317E8C60F3703_OFFSET UNITYSDK_OFFSET(0x197F3170)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERRANDOMPORTALEFFECTCONFIG_METHOD_3_E755CB7746FDFE3A_OFFSET UNITYSDK_OFFSET(0x197EE5D0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERRANDOMPORTALEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197EE580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierRandomPortalEffectConfig_TypeDefinitionIndex = 18446;
