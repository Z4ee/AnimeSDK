...
#define RPG_GAMECORE_RTUNSTACKINVISIBLE_METHOD_3_3E77E18DD2C48824_OFFSET UNITYSDK_OFFSET(0x1B771D10)
#define RPG_GAMECORE_RTUNSTACKINVISIBLE_METHOD_3_DF4059D1CAA071A1_OFFSET UNITYSDK_OFFSET(0x1B771DE0)
#define RPG_GAMECORE_RTUNSTACKINVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B771DD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtUnstackInvisible_TypeDefinitionIndex = 23266;
