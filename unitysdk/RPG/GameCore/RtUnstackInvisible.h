...
#define RPG_GAMECORE_RTUNSTACKINVISIBLE_METHOD_3_DF4059D1CAA071A1_OFFSET UNITYSDK_OFFSET(0x18DDBE50)
#define RPG_GAMECORE_RTUNSTACKINVISIBLE_METHOD_3_E9D715067DAFE8AD_OFFSET UNITYSDK_OFFSET(0x18DDBD40)
#define RPG_GAMECORE_RTUNSTACKINVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x18DDBE20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtUnstackInvisible_TypeDefinitionIndex = 23118;
