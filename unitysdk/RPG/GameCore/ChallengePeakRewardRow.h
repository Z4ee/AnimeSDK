...
#define RPG_GAMECORE_CHALLENGEPEAKREWARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CF88420)
#define RPG_GAMECORE_CHALLENGEPEAKREWARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF885F0)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::System::UInt32 RewardGroupID; // 0x10
		::System::UInt32 TypeValue; // 0x14
