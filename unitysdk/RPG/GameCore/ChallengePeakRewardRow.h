...
#define RPG_GAMECORE_CHALLENGEPEAKREWARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D113680)
#define RPG_GAMECORE_CHALLENGEPEAKREWARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D113850)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChallengePeakRewardRow_TypeDefinitionIndex = 12878;
	...
	public:
		...
		::System::UInt32 RewardGroupID; // 0x18
		::System::UInt32 TypeValue; // 0x1C
		::RPG::GameCore::ChallengePeakRewardType RewardType; // 0x20
