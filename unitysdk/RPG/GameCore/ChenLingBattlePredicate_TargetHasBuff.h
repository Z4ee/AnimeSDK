...
#define RPG_GAMECORE_CHENLINGBATTLEPREDICATE_TARGETHASBUFF_METHOD_3_4B95A9B1CA825AE9_OFFSET UNITYSDK_OFFSET(0x17080580)
#define RPG_GAMECORE_CHENLINGBATTLEPREDICATE_TARGETHASBUFF_METHOD_3_B27C278E43D0100F_OFFSET UNITYSDK_OFFSET(0x17080520)
#define RPG_GAMECORE_CHENLINGBATTLEPREDICATE_TARGETHASBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x17080570)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattlePredicate_TargetHasBuff_TypeDefinitionIndex = 14505;
