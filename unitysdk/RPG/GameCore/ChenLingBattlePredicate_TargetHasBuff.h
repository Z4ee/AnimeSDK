...
#define RPG_GAMECORE_CHENLINGBATTLEPREDICATE_TARGETHASBUFF_METHOD_3_4B95A9B1CA825AE9_OFFSET UNITYSDK_OFFSET(0x187E5640)
#define RPG_GAMECORE_CHENLINGBATTLEPREDICATE_TARGETHASBUFF_METHOD_3_B27C278E43D0100F_OFFSET UNITYSDK_OFFSET(0x187E55E0)
#define RPG_GAMECORE_CHENLINGBATTLEPREDICATE_TARGETHASBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x187E5630)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattlePredicate_TargetHasBuff_TypeDefinitionIndex = 14975;
