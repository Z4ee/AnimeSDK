...
#define RPG_GAMECORE_ENTERMARBLEPVEMATCH_METHOD_3_3D7C2C93380FBE7C_OFFSET UNITYSDK_OFFSET(0x196EA780)
#define RPG_GAMECORE_ENTERMARBLEPVEMATCH_METHOD_3_88A950E283CFD55F_OFFSET UNITYSDK_OFFSET(0x196EA800)
#define RPG_GAMECORE_ENTERMARBLEPVEMATCH__CTOR_OFFSET UNITYSDK_OFFSET(0x196EA7D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnterMarblePVEMatch_TypeDefinitionIndex = 20513;
