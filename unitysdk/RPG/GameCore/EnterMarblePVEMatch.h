...
#define RPG_GAMECORE_ENTERMARBLEPVEMATCH_METHOD_3_3D7C2C93380FBE7C_OFFSET UNITYSDK_OFFSET(0x1719EF60)
#define RPG_GAMECORE_ENTERMARBLEPVEMATCH_METHOD_3_88A950E283CFD55F_OFFSET UNITYSDK_OFFSET(0x1719EFE0)
#define RPG_GAMECORE_ENTERMARBLEPVEMATCH__CTOR_OFFSET UNITYSDK_OFFSET(0x1719EFB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnterMarblePVEMatch_TypeDefinitionIndex = 19897;
