...
#define RPG_GAMECORE_SWITCHREFFLOORCUSTOMFLOAT_METHOD_3_1D6E923E5A5A5477_OFFSET UNITYSDK_OFFSET(0x18EBF3F0)
#define RPG_GAMECORE_SWITCHREFFLOORCUSTOMFLOAT_METHOD_3_AFC55B1B16743E1A_OFFSET UNITYSDK_OFFSET(0x18EBFC50)
#define RPG_GAMECORE_SWITCHREFFLOORCUSTOMFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x18EBF3E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchRefFloorCustomFloat_TypeDefinitionIndex = 16632;
