...
#define RPG_GAMECORE_SWITCHREFFLOORCUSTOMFLOAT_METHOD_3_1D6E923E5A5A5477_OFFSET UNITYSDK_OFFSET(0x1E152B60)
#define RPG_GAMECORE_SWITCHREFFLOORCUSTOMFLOAT_METHOD_3_AFC55B1B16743E1A_OFFSET UNITYSDK_OFFSET(0x1E153380)
#define RPG_GAMECORE_SWITCHREFFLOORCUSTOMFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E152B50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchRefFloorCustomFloat_TypeDefinitionIndex = 17326;
