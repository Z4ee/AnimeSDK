...
#define RPG_GAMECORE_ROGUETOURNLAYERROOMROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1766B3F0)
#define RPG_GAMECORE_ROGUETOURNLAYERROOMROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1766B640)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournLayerRoomRow_TypeDefinitionIndex = 13693;
