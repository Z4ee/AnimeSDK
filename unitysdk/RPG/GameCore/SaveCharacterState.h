...
#define RPG_GAMECORE_SAVECHARACTERSTATE_METHOD_3_300B3941BA02CE6B_OFFSET UNITYSDK_OFFSET(0x1769A3C0)
#define RPG_GAMECORE_SAVECHARACTERSTATE_METHOD_3_A13C35EEB63D5243_OFFSET UNITYSDK_OFFSET(0x1769A2C0)
#define RPG_GAMECORE_SAVECHARACTERSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1769A350)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SaveCharacterState_TypeDefinitionIndex = 20950;
