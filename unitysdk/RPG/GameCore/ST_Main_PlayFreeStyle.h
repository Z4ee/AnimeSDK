...
#define RPG_GAMECORE_ST_MAIN_PLAYFREESTYLE_METHOD_4_3654DF1D0F8F706B_OFFSET UNITYSDK_OFFSET(0x18DF3B90)
#define RPG_GAMECORE_ST_MAIN_PLAYFREESTYLE_METHOD_4_FC376FD8A71B0431_OFFSET UNITYSDK_OFFSET(0x18DF3C90)
#define RPG_GAMECORE_ST_MAIN_PLAYFREESTYLE__CTOR_OFFSET UNITYSDK_OFFSET(0x18DF3C20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_PlayFreeStyle_TypeDefinitionIndex = 19052;
