...
#define RPG_GAMECORE_ST_MAIN_PLAYFREESTYLE_METHOD_4_3654DF1D0F8F706B_OFFSET UNITYSDK_OFFSET(0x17698190)
#define RPG_GAMECORE_ST_MAIN_PLAYFREESTYLE_METHOD_4_FC376FD8A71B0431_OFFSET UNITYSDK_OFFSET(0x17687FC0)
#define RPG_GAMECORE_ST_MAIN_PLAYFREESTYLE__CTOR_OFFSET UNITYSDK_OFFSET(0x17687F50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_PlayFreeStyle_TypeDefinitionIndex = 18407;
