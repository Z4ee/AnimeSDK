...
#define RPG_GAMECORE_ROGUEMODIFIERCHANGEPROPDESTRUCTGENERATENUMBERCONFIG_METHOD_3_07AF2EEA168D27CB_OFFSET UNITYSDK_OFFSET(0x1D3F7110)
#define RPG_GAMECORE_ROGUEMODIFIERCHANGEPROPDESTRUCTGENERATENUMBERCONFIG_METHOD_3_5C21D8CDEF39D3CF_OFFSET UNITYSDK_OFFSET(0x1D3F7160)
#define RPG_GAMECORE_ROGUEMODIFIERCHANGEPROPDESTRUCTGENERATENUMBERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3F7150)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierChangePropDestructGenerateNumberConfig_TypeDefinitionIndex = 17761;
