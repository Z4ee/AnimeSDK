...
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMAGICSCEPTERSELECTCONFIG_METHOD_6_7AC6AE0D8F703369_OFFSET UNITYSDK_OFFSET(0x1C49E8C0)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMAGICSCEPTERSELECTCONFIG_METHOD_6_84362F6806B9AAED_OFFSET UNITYSDK_OFFSET(0x1C49E910)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMAGICSCEPTERSELECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C49E900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActTriggerRogueMagicScepterSelectConfig_TypeDefinitionIndex = 18930;
