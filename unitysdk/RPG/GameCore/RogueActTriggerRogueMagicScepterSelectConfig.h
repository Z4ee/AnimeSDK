...
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMAGICSCEPTERSELECTCONFIG_METHOD_6_84362F6806B9AAED_OFFSET UNITYSDK_OFFSET(0x18CD7840)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMAGICSCEPTERSELECTCONFIG_METHOD_6_8499AB776AB4E1D0_OFFSET UNITYSDK_OFFSET(0x18CD7620)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMAGICSCEPTERSELECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CD7760)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActTriggerRogueMagicScepterSelectConfig_TypeDefinitionIndex = 18687;
