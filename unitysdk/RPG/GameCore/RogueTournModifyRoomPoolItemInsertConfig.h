...
#define RPG_GAMECORE_ROGUETOURNMODIFYROOMPOOLITEMINSERTCONFIG_METHOD_3_398E30F399C851A6_OFFSET UNITYSDK_OFFSET(0x1BB7C730)
#define RPG_GAMECORE_ROGUETOURNMODIFYROOMPOOLITEMINSERTCONFIG_METHOD_3_606BB3A757133AC2_OFFSET UNITYSDK_OFFSET(0x1BB7C700)
#define RPG_GAMECORE_ROGUETOURNMODIFYROOMPOOLITEMINSERTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB7C6F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournModifyRoomPoolItemInsertConfig_TypeDefinitionIndex = 17280;
