...
#define RPG_GAMECORE_ROGUETOURNMODIFYROOMPOOLITEMINSERTCONFIG_METHOD_3_398E30F399C851A6_OFFSET UNITYSDK_OFFSET(0x19BCE810)
#define RPG_GAMECORE_ROGUETOURNMODIFYROOMPOOLITEMINSERTCONFIG_METHOD_3_606BB3A757133AC2_OFFSET UNITYSDK_OFFSET(0x19BCE7E0)
#define RPG_GAMECORE_ROGUETOURNMODIFYROOMPOOLITEMINSERTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19BCE7D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournModifyRoomPoolItemInsertConfig_TypeDefinitionIndex = 17118;
