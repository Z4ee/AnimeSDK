...
#define RPG_GAMECORE_ROGUETOURNMODIFYROOMPOOLITEMINSERTCONFIG_METHOD_3_398E30F399C851A6_OFFSET UNITYSDK_OFFSET(0x1D48DB30)
#define RPG_GAMECORE_ROGUETOURNMODIFYROOMPOOLITEMINSERTCONFIG_METHOD_3_606BB3A757133AC2_OFFSET UNITYSDK_OFFSET(0x1D48DB00)
#define RPG_GAMECORE_ROGUETOURNMODIFYROOMPOOLITEMINSERTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D48DAF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournModifyRoomPoolItemInsertConfig_TypeDefinitionIndex = 17797;
