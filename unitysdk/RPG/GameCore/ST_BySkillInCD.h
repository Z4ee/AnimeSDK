...
#define RPG_GAMECORE_ST_BYSKILLINCD_METHOD_4_72E2390255B5DB26_OFFSET UNITYSDK_OFFSET(0x176948F0)
#define RPG_GAMECORE_ST_BYSKILLINCD_METHOD_4_CCB822FFB0D7EE78_OFFSET UNITYSDK_OFFSET(0x17694820)
#define RPG_GAMECORE_ST_BYSKILLINCD__CTOR_OFFSET UNITYSDK_OFFSET(0x176948A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_BySkillInCD_TypeDefinitionIndex = 18343;
