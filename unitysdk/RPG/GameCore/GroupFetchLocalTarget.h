...
#define RPG_GAMECORE_GROUPFETCHLOCALTARGET_METHOD_4_1E2052D63AB8A012_OFFSET UNITYSDK_OFFSET(0x1728BD20)
#define RPG_GAMECORE_GROUPFETCHLOCALTARGET_METHOD_4_2E55DDAD0AC699DE_OFFSET UNITYSDK_OFFSET(0x1728BDE0)
#define RPG_GAMECORE_GROUPFETCHLOCALTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1728BD90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GroupFetchLocalTarget_TypeDefinitionIndex = 19455;
