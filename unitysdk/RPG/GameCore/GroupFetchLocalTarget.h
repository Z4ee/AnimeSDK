...
#define RPG_GAMECORE_GROUPFETCHLOCALTARGET_METHOD_4_01347C146E95CF88_OFFSET UNITYSDK_OFFSET(0x1D080120)
#define RPG_GAMECORE_GROUPFETCHLOCALTARGET_METHOD_4_2E55DDAD0AC699DE_OFFSET UNITYSDK_OFFSET(0x1D080010)
#define RPG_GAMECORE_GROUPFETCHLOCALTARGET_METHOD_4_3DC26DD11BFD6BFA_OFFSET UNITYSDK_OFFSET(0x1D080150)
#define RPG_GAMECORE_GROUPFETCHLOCALTARGET_METHOD_4_EE35B7AAC2C674C9_OFFSET UNITYSDK_OFFSET(0x1D07FFD0)
#define RPG_GAMECORE_GROUPFETCHLOCALTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1D080000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GroupFetchLocalTarget_TypeDefinitionIndex = 20359;
