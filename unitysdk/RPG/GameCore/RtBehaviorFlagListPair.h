...
#define RPG_GAMECORE_RTBEHAVIORFLAGLISTPAIR_METHOD_2_941353DBFAB69BBB_OFFSET UNITYSDK_OFFSET(0x1CCDA4B0)
#define RPG_GAMECORE_RTBEHAVIORFLAGLISTPAIR__CTOR_OFFSET UNITYSDK_OFFSET(0x1CCDA5D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtBehaviorFlagListPair_TypeDefinitionIndex = 17434;
