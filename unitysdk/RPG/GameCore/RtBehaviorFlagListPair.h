...
#define RPG_GAMECORE_RTBEHAVIORFLAGLISTPAIR_METHOD_2_941353DBFAB69BBB_OFFSET UNITYSDK_OFFSET(0x1BB8B260)
#define RPG_GAMECORE_RTBEHAVIORFLAGLISTPAIR__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB8B380)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtBehaviorFlagListPair_TypeDefinitionIndex = 16932;
