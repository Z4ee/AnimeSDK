...
#define RPG_GAMECORE_CHIMERADUELGAMEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1963E8A0)
#define RPG_GAMECORE_CHIMERADUELGAMEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1963EFB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelGameRow_TypeDefinitionIndex = 10694;
