...
#define RPG_GAMECORE_STRINGCASECONTAINER_METHOD_3_3AC806E1BD3C4917_OFFSET UNITYSDK_OFFSET(0x1B41FE30)
#define RPG_GAMECORE_STRINGCASECONTAINER_METHOD_3_6099B8615EB4EDE0_OFFSET UNITYSDK_OFFSET(0x1B41FDF0)
#define RPG_GAMECORE_STRINGCASECONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B41FE20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StringCaseContainer_TypeDefinitionIndex = 16836;
