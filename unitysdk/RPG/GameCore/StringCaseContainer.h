...
#define RPG_GAMECORE_STRINGCASECONTAINER_METHOD_3_9E9E7B3A2E1924A6_OFFSET UNITYSDK_OFFSET(0x177830F0)
#define RPG_GAMECORE_STRINGCASECONTAINER_METHOD_3_A22FC063629C9975_OFFSET UNITYSDK_OFFSET(0x17783130)
#define RPG_GAMECORE_STRINGCASECONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x17783120)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StringCaseContainer_TypeDefinitionIndex = 16113;
