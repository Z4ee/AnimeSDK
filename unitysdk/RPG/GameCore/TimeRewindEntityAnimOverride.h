...
#define RPG_GAMECORE_TIMEREWINDENTITYANIMOVERRIDE_METHOD_2_1D6C3813E775F569_OFFSET UNITYSDK_OFFSET(0x19DE64C0)
#define RPG_GAMECORE_TIMEREWINDENTITYANIMOVERRIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x19DE6660)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TimeRewindEntityAnimOverride_TypeDefinitionIndex = 16707;
