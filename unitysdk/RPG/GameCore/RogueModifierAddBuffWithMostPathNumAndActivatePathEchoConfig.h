...
#define RPG_GAMECORE_ROGUEMODIFIERADDBUFFWITHMOSTPATHNUMANDACTIVATEPATHECHOCONFIG_METHOD_3_014EC9CDCB233420_OFFSET UNITYSDK_OFFSET(0x19B4DDE0)
#define RPG_GAMECORE_ROGUEMODIFIERADDBUFFWITHMOSTPATHNUMANDACTIVATEPATHECHOCONFIG_METHOD_3_A3A6D63178199789_OFFSET UNITYSDK_OFFSET(0x19B4DD10)
#define RPG_GAMECORE_ROGUEMODIFIERADDBUFFWITHMOSTPATHNUMANDACTIVATEPATHECHOCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B4DD90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierAddBuffWithMostPathNumAndActivatePathEchoConfig_TypeDefinitionIndex = 16940;
