...
#define RPG_GAMECORE_SETNPCWAYPATH_METHOD_3_C0931672B72D53A1_OFFSET UNITYSDK_OFFSET(0x1C604B40)
#define RPG_GAMECORE_SETNPCWAYPATH_METHOD_3_DC214FE941B4EF13_OFFSET UNITYSDK_OFFSET(0x1C604BC0)
#define RPG_GAMECORE_SETNPCWAYPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1C604B90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetNpcWaypath_TypeDefinitionIndex = 19558;
