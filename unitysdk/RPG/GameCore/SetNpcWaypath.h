...
#define RPG_GAMECORE_SETNPCWAYPATH_METHOD_3_CE6FAE50E9ADDBFF_OFFSET UNITYSDK_OFFSET(0x176DA790)
#define RPG_GAMECORE_SETNPCWAYPATH_METHOD_3_DC214FE941B4EF13_OFFSET UNITYSDK_OFFSET(0x176DA8E0)
#define RPG_GAMECORE_SETNPCWAYPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x176DA850)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetNpcWaypath_TypeDefinitionIndex = 18629;
