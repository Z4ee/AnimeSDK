...
#define RPG_GAMECORE_SETNPCWAYPATH_METHOD_3_CE6FAE50E9ADDBFF_OFFSET UNITYSDK_OFFSET(0x18E3DCD0)
#define RPG_GAMECORE_SETNPCWAYPATH_METHOD_3_DC214FE941B4EF13_OFFSET UNITYSDK_OFFSET(0x18E3DE20)
#define RPG_GAMECORE_SETNPCWAYPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x18E3DD90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetNpcWaypath_TypeDefinitionIndex = 19286;
