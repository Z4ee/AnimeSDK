...
#define RPG_GAMECORE_WHITELISTINTERACTREPORTITEM_METHOD_2_5653EEC451F9F990_OFFSET UNITYSDK_OFFSET(0x1910EDA0)
#define RPG_GAMECORE_WHITELISTINTERACTREPORTITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1910EF10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WhiteListInteractReportItem_TypeDefinitionIndex = 16739;
