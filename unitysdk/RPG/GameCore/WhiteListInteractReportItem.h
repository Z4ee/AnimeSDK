...
#define RPG_GAMECORE_WHITELISTINTERACTREPORTITEM_METHOD_2_5653EEC451F9F990_OFFSET UNITYSDK_OFFSET(0x19E67430)
#define RPG_GAMECORE_WHITELISTINTERACTREPORTITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x19E675A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WhiteListInteractReportItem_TypeDefinitionIndex = 16760;
