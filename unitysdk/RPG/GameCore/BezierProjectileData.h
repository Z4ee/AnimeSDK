...
#define RPG_GAMECORE_BEZIERPROJECTILEDATA_METHOD_3_00325C41EEAE0DE9_OFFSET UNITYSDK_OFFSET(0x1CE83670)
#define RPG_GAMECORE_BEZIERPROJECTILEDATA_METHOD_3_5AC24180A8CA2C1C_OFFSET UNITYSDK_OFFSET(0x1CE83620)
#define RPG_GAMECORE_BEZIERPROJECTILEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE83660)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BezierProjectileData_TypeDefinitionIndex = 15495;
