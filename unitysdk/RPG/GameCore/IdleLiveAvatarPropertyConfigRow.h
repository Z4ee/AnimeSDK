...
#define RPG_GAMECORE_IDLELIVEAVATARPROPERTYCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1983FC00)
#define RPG_GAMECORE_IDLELIVEAVATARPROPERTYCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19840130)

namespace RPG::GameCore
{
	inline static constexpr unsigned int IdleLiveAvatarPropertyConfigRow_TypeDefinitionIndex = 11200;
	...
	public:
		...
		::RPG::GameCore::IdleLiveAvatarPropertyType BaseProperty; // 0x1C
		...
		::RPG::GameCore::FixPoint FrontPowerFactor; // 0x40
		::RPG::GameCore::FixPoint CaptainPowerFactor; // 0x48
