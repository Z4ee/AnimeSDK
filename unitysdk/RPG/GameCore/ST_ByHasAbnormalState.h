...
#define RPG_GAMECORE_ST_BYHASABNORMALSTATE_METHOD_4_2DB162E74DFC7EA2_OFFSET UNITYSDK_OFFSET(0x18DED490)
#define RPG_GAMECORE_ST_BYHASABNORMALSTATE_METHOD_4_D7DF28FB497C3CEC_OFFSET UNITYSDK_OFFSET(0x18DED560)
#define RPG_GAMECORE_ST_BYHASABNORMALSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18DED510)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_ByHasAbnormalState_TypeDefinitionIndex = 19006;
