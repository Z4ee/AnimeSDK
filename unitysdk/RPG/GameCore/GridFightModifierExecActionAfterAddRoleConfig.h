...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERADDROLECONFIG_METHOD_3_0491617E6351DB34_OFFSET UNITYSDK_OFFSET(0x17265F80)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERADDROLECONFIG_METHOD_3_884D23D92B44FC7D_OFFSET UNITYSDK_OFFSET(0x1726A270)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERADDROLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17265F30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierExecActionAfterAddRoleConfig_TypeDefinitionIndex = 17781;
