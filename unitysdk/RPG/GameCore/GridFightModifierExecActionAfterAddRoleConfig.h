...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERADDROLECONFIG_METHOD_3_0491617E6351DB34_OFFSET UNITYSDK_OFFSET(0x1D158EB0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERADDROLECONFIG_METHOD_3_61794CDD161188B8_OFFSET UNITYSDK_OFFSET(0x1D158E60)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERADDROLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D158EA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierExecActionAfterAddRoleConfig_TypeDefinitionIndex = 19140;
