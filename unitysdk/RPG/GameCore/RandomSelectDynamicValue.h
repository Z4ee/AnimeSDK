...
#define RPG_GAMECORE_RANDOMSELECTDYNAMICVALUE_METHOD_3_5CCBA9B82A6C5F41_OFFSET UNITYSDK_OFFSET(0x1B9B6BD0)
#define RPG_GAMECORE_RANDOMSELECTDYNAMICVALUE_METHOD_3_61B0D6F8461F7754_OFFSET UNITYSDK_OFFSET(0x1B9B6C10)
#define RPG_GAMECORE_RANDOMSELECTDYNAMICVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9B6C00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RandomSelectDynamicValue_TypeDefinitionIndex = 22078;
