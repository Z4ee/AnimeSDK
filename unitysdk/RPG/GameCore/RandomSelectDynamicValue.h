...
#define RPG_GAMECORE_RANDOMSELECTDYNAMICVALUE_METHOD_3_3304993DCF94BE18_OFFSET UNITYSDK_OFFSET(0x18C8A050)
#define RPG_GAMECORE_RANDOMSELECTDYNAMICVALUE_METHOD_3_419FEB55404B44EB_OFFSET UNITYSDK_OFFSET(0x18C8A0D0)
#define RPG_GAMECORE_RANDOMSELECTDYNAMICVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x18C8A0A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RandomSelectDynamicValue_TypeDefinitionIndex = 21814;
