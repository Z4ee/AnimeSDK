...
#define RPG_GAMECORE_TRAVELSHIPNAVIGATETO_METHOD_3_406B948B0389097C_OFFSET UNITYSDK_OFFSET(0x190B5E40)
#define RPG_GAMECORE_TRAVELSHIPNAVIGATETO_METHOD_3_A72BCFE3EBB727A5_OFFSET UNITYSDK_OFFSET(0x190B5EE0)
#define RPG_GAMECORE_TRAVELSHIPNAVIGATETO__CTOR_OFFSET UNITYSDK_OFFSET(0x190B5EA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TravelShipNavigateTo_TypeDefinitionIndex = 19964;
