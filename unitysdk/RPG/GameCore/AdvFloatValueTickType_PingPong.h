...
#define RPG_GAMECORE_ADVFLOATVALUETICKTYPE_PINGPONG_METHOD_3_616E1B98A29C9760_OFFSET UNITYSDK_OFFSET(0x16F2F680)
#define RPG_GAMECORE_ADVFLOATVALUETICKTYPE_PINGPONG_METHOD_3_6E36DA3B54D4A145_OFFSET UNITYSDK_OFFSET(0x16F2F1D0)
#define RPG_GAMECORE_ADVFLOATVALUETICKTYPE_PINGPONG__CTOR_OFFSET UNITYSDK_OFFSET(0x16F2F1C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvFloatValueTickType_PingPong_TypeDefinitionIndex = 19349;
