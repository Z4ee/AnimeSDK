...
#define RPG_GAMECORE_CALCULATEMISSIONCUSTOMVALUE_METHOD_3_0266B18C4DE46FEF_OFFSET UNITYSDK_OFFSET(0x17051CA0)
#define RPG_GAMECORE_CALCULATEMISSIONCUSTOMVALUE_METHOD_3_29A11CFB89905436_OFFSET UNITYSDK_OFFSET(0x17051C20)
#define RPG_GAMECORE_CALCULATEMISSIONCUSTOMVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x17051C70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CalculateMissionCustomValue_TypeDefinitionIndex = 18741;
