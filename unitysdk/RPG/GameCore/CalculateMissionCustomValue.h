...
#define RPG_GAMECORE_CALCULATEMISSIONCUSTOMVALUE_METHOD_3_0266B18C4DE46FEF_OFFSET UNITYSDK_OFFSET(0x1CF7B250)
#define RPG_GAMECORE_CALCULATEMISSIONCUSTOMVALUE_METHOD_3_EF91EA69ED0D1BE2_OFFSET UNITYSDK_OFFSET(0x1CF7B210)
#define RPG_GAMECORE_CALCULATEMISSIONCUSTOMVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF7B240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CalculateMissionCustomValue_TypeDefinitionIndex = 20205;
