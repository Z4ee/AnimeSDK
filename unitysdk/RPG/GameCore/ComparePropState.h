...
#define RPG_GAMECORE_COMPAREPROPSTATE_METHOD_3_244AF7C281CD090C_OFFSET UNITYSDK_OFFSET(0x17121860)
#define RPG_GAMECORE_COMPAREPROPSTATE_METHOD_3_D4710D65282ACD8C_OFFSET UNITYSDK_OFFSET(0x171218F0)
#define RPG_GAMECORE_COMPAREPROPSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x171218C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComparePropState_TypeDefinitionIndex = 19780;
