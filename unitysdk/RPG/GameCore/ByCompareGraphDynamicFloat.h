...
#define RPG_GAMECORE_BYCOMPAREGRAPHDYNAMICFLOAT_METHOD_4_086F9DBA54861C6D_OFFSET UNITYSDK_OFFSET(0x1872E340)
#define RPG_GAMECORE_BYCOMPAREGRAPHDYNAMICFLOAT_METHOD_4_E906790AFC469F99_OFFSET UNITYSDK_OFFSET(0x1872E260)
#define RPG_GAMECORE_BYCOMPAREGRAPHDYNAMICFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1872E2E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareGraphDynamicFloat_TypeDefinitionIndex = 19688;
