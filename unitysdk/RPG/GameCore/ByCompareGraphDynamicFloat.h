...
#define RPG_GAMECORE_BYCOMPAREGRAPHDYNAMICFLOAT_METHOD_4_086F9DBA54861C6D_OFFSET UNITYSDK_OFFSET(0x19CE6C50)
#define RPG_GAMECORE_BYCOMPAREGRAPHDYNAMICFLOAT_METHOD_4_3EA7D02B99CB7366_OFFSET UNITYSDK_OFFSET(0x19CE6EC0)
#define RPG_GAMECORE_BYCOMPAREGRAPHDYNAMICFLOAT_METHOD_4_7C5D8814FF50A270_OFFSET UNITYSDK_OFFSET(0x19CE6C00)
#define RPG_GAMECORE_BYCOMPAREGRAPHDYNAMICFLOAT_METHOD_4_83E2F2CE8E1F8AC9_OFFSET UNITYSDK_OFFSET(0x19CE6E80)
#define RPG_GAMECORE_BYCOMPAREGRAPHDYNAMICFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x19CE6C40)
