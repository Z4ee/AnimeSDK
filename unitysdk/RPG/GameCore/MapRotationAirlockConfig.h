...
#define RPG_GAMECORE_MAPROTATIONAIRLOCKCONFIG_METHOD_2_CCB7A9EC72C245DA_OFFSET UNITYSDK_OFFSET(0x1737F270)
#define RPG_GAMECORE_MAPROTATIONAIRLOCKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1737F5A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MapRotationAirlockConfig_TypeDefinitionIndex = 15589;
