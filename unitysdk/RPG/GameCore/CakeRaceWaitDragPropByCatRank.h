...
#define RPG_GAMECORE_CAKERACEWAITDRAGPROPBYCATRANK_METHOD_3_0357E246EBB0AF40_OFFSET UNITYSDK_OFFSET(0x1B707740)
#define RPG_GAMECORE_CAKERACEWAITDRAGPROPBYCATRANK_METHOD_3_CF44DB7B58D2D0FD_OFFSET UNITYSDK_OFFSET(0x1B707780)
#define RPG_GAMECORE_CAKERACEWAITDRAGPROPBYCATRANK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B707770)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceWaitDragPropByCatRank_TypeDefinitionIndex = 23447;
