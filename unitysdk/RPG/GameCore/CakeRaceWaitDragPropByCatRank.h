...
#define RPG_GAMECORE_CAKERACEWAITDRAGPROPBYCATRANK_METHOD_3_CF44DB7B58D2D0FD_OFFSET UNITYSDK_OFFSET(0x17050D10)
#define RPG_GAMECORE_CAKERACEWAITDRAGPROPBYCATRANK_METHOD_3_EAE0336F73D24EE0_OFFSET UNITYSDK_OFFSET(0x17050C90)
#define RPG_GAMECORE_CAKERACEWAITDRAGPROPBYCATRANK__CTOR_OFFSET UNITYSDK_OFFSET(0x17050CE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceWaitDragPropByCatRank_TypeDefinitionIndex = 22346;
