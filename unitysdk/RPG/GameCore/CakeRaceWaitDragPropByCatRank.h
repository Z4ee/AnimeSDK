...
#define RPG_GAMECORE_CAKERACEWAITDRAGPROPBYCATRANK_METHOD_3_CF44DB7B58D2D0FD_OFFSET UNITYSDK_OFFSET(0x195F1F80)
#define RPG_GAMECORE_CAKERACEWAITDRAGPROPBYCATRANK_METHOD_3_EAE0336F73D24EE0_OFFSET UNITYSDK_OFFSET(0x195F1F00)
#define RPG_GAMECORE_CAKERACEWAITDRAGPROPBYCATRANK__CTOR_OFFSET UNITYSDK_OFFSET(0x195F1F50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceWaitDragPropByCatRank_TypeDefinitionIndex = 22980;
