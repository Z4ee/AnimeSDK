...
#define RPG_GAMECORE_SHOWBATTLECONDITIONUI_METHOD_3_5510E9FD4BE23955_OFFSET UNITYSDK_OFFSET(0x19C74E60)
#define RPG_GAMECORE_SHOWBATTLECONDITIONUI_METHOD_3_C92F6D6571EAE441_OFFSET UNITYSDK_OFFSET(0x19C74D50)
#define RPG_GAMECORE_SHOWBATTLECONDITIONUI__CTOR_OFFSET UNITYSDK_OFFSET(0x19C74E30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowBattleConditionUI_TypeDefinitionIndex = 22091;
