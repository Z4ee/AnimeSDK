...
#define RPG_GAMECORE_BUILDTIMELINEENTITYSTATE_METHOD_3_2F71B2B277E96AF3_OFFSET UNITYSDK_OFFSET(0x194EF7E0)
#define RPG_GAMECORE_BUILDTIMELINEENTITYSTATE_METHOD_3_4C50DE6F2E42FA17_OFFSET UNITYSDK_OFFSET(0x194EF860)
#define RPG_GAMECORE_BUILDTIMELINEENTITYSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x194EF830)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BuildTimelineEntityState_TypeDefinitionIndex = 19495;
