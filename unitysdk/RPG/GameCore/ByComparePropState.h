...
#define RPG_GAMECORE_BYCOMPAREPROPSTATE_METHOD_4_458338C3E0EEBCC2_OFFSET UNITYSDK_OFFSET(0x19D014C0)
#define RPG_GAMECORE_BYCOMPAREPROPSTATE_METHOD_4_98C0BA4F82016391_OFFSET UNITYSDK_OFFSET(0x19D012B0)
#define RPG_GAMECORE_BYCOMPAREPROPSTATE_METHOD_4_B49301AA19D74ECC_OFFSET UNITYSDK_OFFSET(0x19D014F0)
#define RPG_GAMECORE_BYCOMPAREPROPSTATE_METHOD_4_CF9C2590852AA014_OFFSET UNITYSDK_OFFSET(0x19D012F0)
#define RPG_GAMECORE_BYCOMPAREPROPSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19D012E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByComparePropState_TypeDefinitionIndex = 19535;
