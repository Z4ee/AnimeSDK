...
#define RPG_GAMECORE_CONSUMEORIGAMIITEM_METHOD_3_01F557D9C53AAE91_OFFSET UNITYSDK_OFFSET(0x17133D80)
#define RPG_GAMECORE_CONSUMEORIGAMIITEM_METHOD_3_DE946FC641107ACA_OFFSET UNITYSDK_OFFSET(0x17133E00)
#define RPG_GAMECORE_CONSUMEORIGAMIITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x17133DD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConsumeOrigamiItem_TypeDefinitionIndex = 20035;
