...
#define RPG_GAMECORE_ST_BYENTERCOMBAT_METHOD_4_471A5980B0F9EFD4_OFFSET UNITYSDK_OFFSET(0x17692B70)
#define RPG_GAMECORE_ST_BYENTERCOMBAT_METHOD_4_DF058C859678E4DE_OFFSET UNITYSDK_OFFSET(0x17692C40)
#define RPG_GAMECORE_ST_BYENTERCOMBAT__CTOR_OFFSET UNITYSDK_OFFSET(0x17692BF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_ByEnterCombat_TypeDefinitionIndex = 18370;
