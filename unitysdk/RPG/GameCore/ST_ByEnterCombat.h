...
#define RPG_GAMECORE_ST_BYENTERCOMBAT_METHOD_4_25C3F5D23C7869B9_OFFSET UNITYSDK_OFFSET(0x1D4C2820)
#define RPG_GAMECORE_ST_BYENTERCOMBAT_METHOD_4_6E2E1379F517CB18_OFFSET UNITYSDK_OFFSET(0x1D4C27F0)
#define RPG_GAMECORE_ST_BYENTERCOMBAT_METHOD_4_78062A5994BC399D_OFFSET UNITYSDK_OFFSET(0x1D4C2670)
#define RPG_GAMECORE_ST_BYENTERCOMBAT_METHOD_4_DF058C859678E4DE_OFFSET UNITYSDK_OFFSET(0x1D4C26B0)
#define RPG_GAMECORE_ST_BYENTERCOMBAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4C26A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_ByEnterCombat_TypeDefinitionIndex = 19858;
