...
#define RPG_GAMECORE_LEVELNAVNODEINNERGRAPHEDITORINFO_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1987EDB0)
#define RPG_GAMECORE_LEVELNAVNODEINNERGRAPHEDITORINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1987EDF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelNavNodeInnerGraphEditorInfo_TypeDefinitionIndex = 16530;
