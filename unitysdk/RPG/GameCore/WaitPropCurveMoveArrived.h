...
#define RPG_GAMECORE_WAITPROPCURVEMOVEARRIVED_METHOD_3_05EE43C7DCDC2727_OFFSET UNITYSDK_OFFSET(0x19104A70)
#define RPG_GAMECORE_WAITPROPCURVEMOVEARRIVED_METHOD_3_FF145B16F0F72D78_OFFSET UNITYSDK_OFFSET(0x19104990)
#define RPG_GAMECORE_WAITPROPCURVEMOVEARRIVED__CTOR_OFFSET UNITYSDK_OFFSET(0x19104A10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitPropCurveMoveArrived_TypeDefinitionIndex = 20000;
