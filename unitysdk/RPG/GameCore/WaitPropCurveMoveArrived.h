...
#define RPG_GAMECORE_WAITPROPCURVEMOVEARRIVED_METHOD_3_05EE43C7DCDC2727_OFFSET UNITYSDK_OFFSET(0x19E5D310)
#define RPG_GAMECORE_WAITPROPCURVEMOVEARRIVED_METHOD_3_FF145B16F0F72D78_OFFSET UNITYSDK_OFFSET(0x19E5D230)
#define RPG_GAMECORE_WAITPROPCURVEMOVEARRIVED__CTOR_OFFSET UNITYSDK_OFFSET(0x19E5D2B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitPropCurveMoveArrived_TypeDefinitionIndex = 19862;
