...
#define RPG_GAMECORE_LIGHTCONECUSTOMPOSITIONSCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D1F1B90)
#define RPG_GAMECORE_LIGHTCONECUSTOMPOSITIONSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1F1C90)
