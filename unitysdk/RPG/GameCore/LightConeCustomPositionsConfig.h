...
#define RPG_GAMECORE_LIGHTCONECUSTOMPOSITIONSCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B08B4B0)
#define RPG_GAMECORE_LIGHTCONECUSTOMPOSITIONSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B08B5B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LightConeCustomPositionsConfig_TypeDefinitionIndex = 16794;
