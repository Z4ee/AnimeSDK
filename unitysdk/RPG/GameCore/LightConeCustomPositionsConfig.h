...
#define RPG_GAMECORE_LIGHTCONECUSTOMPOSITIONSCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1734D360)
#define RPG_GAMECORE_LIGHTCONECUSTOMPOSITIONSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1734D470)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LightConeCustomPositionsConfig_TypeDefinitionIndex = 16069;
