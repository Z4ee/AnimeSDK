...
#define RPG_GAMECORE_SPECIALAVATARRELICSUBVALUEROW_FROMBINARYWITHOUTNEW_OFFSET UNITYSDK_OFFSET(0x1B09FE80)
#define RPG_GAMECORE_SPECIALAVATARRELICSUBVALUEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B09FF80)
#define RPG_GAMECORE_SPECIALAVATARRELICSUBVALUEROW_FROMTABLEOFFSET_OFFSET UNITYSDK_OFFSET(0x1B0A00B0)
#define RPG_GAMECORE_SPECIALAVATARRELICSUBVALUEROW_RESET_OFFSET UNITYSDK_OFFSET(0x1B0A0110)
#define RPG_GAMECORE_SPECIALAVATARRELICSUBVALUEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0A00A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SpecialAvatarRelicSubValueRow_TypeDefinitionIndex = 14531;
