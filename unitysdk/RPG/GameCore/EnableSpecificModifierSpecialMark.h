...
#define RPG_GAMECORE_ENABLESPECIFICMODIFIERSPECIALMARK_METHOD_3_23CCFDA1CCB7EA2F_OFFSET UNITYSDK_OFFSET(0x1D7BF200)
#define RPG_GAMECORE_ENABLESPECIFICMODIFIERSPECIALMARK_METHOD_3_EE1B305C57C43DF8_OFFSET UNITYSDK_OFFSET(0x1D7BF1C0)
#define RPG_GAMECORE_ENABLESPECIFICMODIFIERSPECIALMARK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7BF1F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnableSpecificModifierSpecialMark_TypeDefinitionIndex = 22914;
