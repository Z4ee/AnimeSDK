...
#define RPG_GAMECORE_GRIDFIGHTBACKSERVANTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x197DA5A0)
#define RPG_GAMECORE_GRIDFIGHTBACKSERVANTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x197DA760)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightBackServantConfigRow_TypeDefinitionIndex = 12863;
