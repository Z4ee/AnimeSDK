...
#define RPG_GAMECORE_SETDYNAMICVALUEBYBATTLETARGETID_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x18E1D500)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBATTLETARGETID_METHOD_4_3A7B6D66754472C0_OFFSET UNITYSDK_OFFSET(0x18E1D350)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBATTLETARGETID_METHOD_4_4A3B248B0377A00C_OFFSET UNITYSDK_OFFSET(0x18E1D280)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBATTLETARGETID__CTOR_OFFSET UNITYSDK_OFFSET(0x18E1D300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByBattleTargetID_TypeDefinitionIndex = 22135;
