...
#define RPG_GAMECORE_SETDYNAMICVALUEBYBATTLETARGETID_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x176C0690)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBATTLETARGETID_METHOD_4_3A7B6D66754472C0_OFFSET UNITYSDK_OFFSET(0x176B8060)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBATTLETARGETID_METHOD_4_4A3B248B0377A00C_OFFSET UNITYSDK_OFFSET(0x176C0610)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBATTLETARGETID__CTOR_OFFSET UNITYSDK_OFFSET(0x176B8010)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByBattleTargetID_TypeDefinitionIndex = 21402;
