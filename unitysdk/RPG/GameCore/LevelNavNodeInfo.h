...
#define RPG_GAMECORE_LEVELNAVNODEINFO_DISPOSE_OFFSET UNITYSDK_OFFSET(0x7B0860)
#define RPG_GAMECORE_LEVELNAVNODEINFO_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x3A1A820)
#define RPG_GAMECORE_LEVELNAVNODEINFO_EQUALS_OFFSET UNITYSDK_OFFSET(0x7C5660)
#define RPG_GAMECORE_LEVELNAVNODEINFO_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8817F0)
#define RPG_GAMECORE_LEVELNAVNODEINFO_GET_ID_OFFSET UNITYSDK_OFFSET(0x3A1A830)
#define RPG_GAMECORE_LEVELNAVNODEINFO_GET_INNERGRAPH_OFFSET UNITYSDK_OFFSET(0x3A1A890)
#define RPG_GAMECORE_LEVELNAVNODEINFO_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x881730)
#define RPG_GAMECORE_LEVELNAVNODEINFO_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0x676EB0)
#define RPG_GAMECORE_LEVELNAVNODEINFO_GET_POOL_OFFSET UNITYSDK_OFFSET(0x1651A0)
#define RPG_GAMECORE_LEVELNAVNODEINFO_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x3A1A900)
#define RPG_GAMECORE_LEVELNAVNODEINFO_GET_TRANSITLIST_OFFSET UNITYSDK_OFFSET(0x3A1A960)
#define RPG_GAMECORE_LEVELNAVNODEINFO_GET_VOLUMELIST_OFFSET UNITYSDK_OFFSET(0x3A1A9D0)
#define RPG_GAMECORE_LEVELNAVNODEINFO_INIT_OFFSET UNITYSDK_OFFSET(0x6E35A0)
#define RPG_GAMECORE_LEVELNAVNODEINFO_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1B0786C0)
#define RPG_GAMECORE_LEVELNAVNODEINFO_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1B078A10)
#define RPG_GAMECORE_LEVELNAVNODEINFO_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1B0787B0)
#define RPG_GAMECORE_LEVELNAVNODEINFO_OP_LOGICALNOT_OFFSET UNITYSDK_OFFSET(0x1B078AC0)
#define RPG_GAMECORE_LEVELNAVNODEINFO_SET_ID_OFFSET UNITYSDK_OFFSET(0x3A1A840)
#define RPG_GAMECORE_LEVELNAVNODEINFO_SET_INNERGRAPH_OFFSET UNITYSDK_OFFSET(0x3A1A8B0)
#define RPG_GAMECORE_LEVELNAVNODEINFO_SET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x3A1A910)
#define RPG_GAMECORE_LEVELNAVNODEINFO_SET_TRANSITLIST_OFFSET UNITYSDK_OFFSET(0x3A1A980)
#define RPG_GAMECORE_LEVELNAVNODEINFO_SET_VOLUMELIST_OFFSET UNITYSDK_OFFSET(0x3A1A9E0)
