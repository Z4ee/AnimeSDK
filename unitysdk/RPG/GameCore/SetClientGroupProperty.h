...
#define RPG_GAMECORE_SETCLIENTGROUPPROPERTY_METHOD_3_23929BE0BB4AB4FD_OFFSET UNITYSDK_OFFSET(0x176AF900)
#define RPG_GAMECORE_SETCLIENTGROUPPROPERTY_METHOD_3_94377F4940052DB6_OFFSET UNITYSDK_OFFSET(0x176AF880)
#define RPG_GAMECORE_SETCLIENTGROUPPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x176AF8D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetClientGroupProperty_TypeDefinitionIndex = 19047;
