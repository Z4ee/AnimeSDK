...
#define RPG_GAMECORE_HELIOBUSREWARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x189F9AE0)
#define RPG_GAMECORE_HELIOBUSREWARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x189FA0B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HeliobusRewardRow_TypeDefinitionIndex = 13024;
