...
#define RPG_GAMECORE_HELIOBUSREWARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1982C210)
#define RPG_GAMECORE_HELIOBUSREWARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1982C7C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HeliobusRewardRow_TypeDefinitionIndex = 13107;
