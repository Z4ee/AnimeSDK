...
#define RPG_GAMECORE_FIVEDIMMINIGAMECOLLECTCOINTEMPLATE_METHOD_2_A89A5FEA17BD3456_OFFSET UNITYSDK_OFFSET(0x171FA5C0)
#define RPG_GAMECORE_FIVEDIMMINIGAMECOLLECTCOINTEMPLATE__CTOR_OFFSET UNITYSDK_OFFSET(0x171FA6E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimMiniGameCollectCoinTemplate_TypeDefinitionIndex = 17255;
