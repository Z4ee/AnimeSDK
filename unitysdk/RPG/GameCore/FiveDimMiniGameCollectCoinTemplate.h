...
#define RPG_GAMECORE_FIVEDIMMINIGAMECOLLECTCOINTEMPLATE_METHOD_2_2BD744A2105EFF53_OFFSET UNITYSDK_OFFSET(0x1D869290)
#define RPG_GAMECORE_FIVEDIMMINIGAMECOLLECTCOINTEMPLATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D8693E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimMiniGameCollectCoinTemplate_TypeDefinitionIndex = 18594;
