...
#define RPG_GAMECORE_FIVEDIMMINIGAMECOLLECTCOINTEMPLATE_METHOD_2_2BD744A2105EFF53_OFFSET UNITYSDK_OFFSET(0x19746850)
#define RPG_GAMECORE_FIVEDIMMINIGAMECOLLECTCOINTEMPLATE__CTOR_OFFSET UNITYSDK_OFFSET(0x197469A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimMiniGameCollectCoinTemplate_TypeDefinitionIndex = 17892;
