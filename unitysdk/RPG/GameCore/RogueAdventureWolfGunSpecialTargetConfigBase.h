...
#define RPG_GAMECORE_ROGUEADVENTUREWOLFGUNSPECIALTARGETCONFIGBASE_METHOD_2_34661C25CBF181B5_OFFSET UNITYSDK_OFFSET(0x1C4A0E40)
#define RPG_GAMECORE_ROGUEADVENTUREWOLFGUNSPECIALTARGETCONFIGBASE_METHOD_2_A01FF84123BF5BDC_OFFSET UNITYSDK_OFFSET(0x1C4A0C70)
#define RPG_GAMECORE_ROGUEADVENTUREWOLFGUNSPECIALTARGETCONFIGBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4A0C60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueAdventureWolfGunSpecialTargetConfigBase_TypeDefinitionIndex = 17168;
