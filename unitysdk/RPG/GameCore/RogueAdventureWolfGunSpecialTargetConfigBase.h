...
#define RPG_GAMECORE_ROGUEADVENTUREWOLFGUNSPECIALTARGETCONFIGBASE_METHOD_2_34661C25CBF181B5_OFFSET UNITYSDK_OFFSET(0x19B0D630)
#define RPG_GAMECORE_ROGUEADVENTUREWOLFGUNSPECIALTARGETCONFIGBASE_METHOD_2_A01FF84123BF5BDC_OFFSET UNITYSDK_OFFSET(0x19B0D460)
#define RPG_GAMECORE_ROGUEADVENTUREWOLFGUNSPECIALTARGETCONFIGBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x19B0D450)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueAdventureWolfGunSpecialTargetConfigBase_TypeDefinitionIndex = 17006;
