...
#define RPG_GAMECORE_BYISFIRSTCHALLENGEBATTLE_METHOD_4_65681BD6565BE029_OFFSET UNITYSDK_OFFSET(0x1A8E2ED0)
#define RPG_GAMECORE_BYISFIRSTCHALLENGEBATTLE_METHOD_4_8B1063C577C937E0_OFFSET UNITYSDK_OFFSET(0x1A8E2D50)
#define RPG_GAMECORE_BYISFIRSTCHALLENGEBATTLE_METHOD_4_D5067D9BA9721973_OFFSET UNITYSDK_OFFSET(0x1A8E2D90)
#define RPG_GAMECORE_BYISFIRSTCHALLENGEBATTLE_METHOD_4_E95879087FB799A0_OFFSET UNITYSDK_OFFSET(0x1A8E2F00)
#define RPG_GAMECORE_BYISFIRSTCHALLENGEBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8E2D80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsFirstChallengeBattle_TypeDefinitionIndex = 21760;
