...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEPASSEMPTYCELL_METHOD_3_227035012D28EFD0_OFFSET UNITYSDK_OFFSET(0x19C43EA0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEPASSEMPTYCELL_METHOD_3_AD9302DF138844F7_OFFSET UNITYSDK_OFFSET(0x19C43E30)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEPASSEMPTYCELL__CTOR_OFFSET UNITYSDK_OFFSET(0x19C43E70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRoguePassEmptyCell_TypeDefinitionIndex = 20567;
