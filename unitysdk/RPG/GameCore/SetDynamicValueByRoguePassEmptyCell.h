...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEPASSEMPTYCELL_METHOD_3_227035012D28EFD0_OFFSET UNITYSDK_OFFSET(0x1C5F0630)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEPASSEMPTYCELL_METHOD_3_840CF9FB80E8DBDD_OFFSET UNITYSDK_OFFSET(0x1C5F05F0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEPASSEMPTYCELL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5F0620)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRoguePassEmptyCell_TypeDefinitionIndex = 20982;
