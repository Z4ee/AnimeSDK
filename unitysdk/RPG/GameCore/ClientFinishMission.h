...
#define RPG_GAMECORE_CLIENTFINISHMISSION_METHOD_3_3DA1BB40A2958885_OFFSET UNITYSDK_OFFSET(0x170B3F70)
#define RPG_GAMECORE_CLIENTFINISHMISSION_METHOD_3_72C371832ABA297E_OFFSET UNITYSDK_OFFSET(0x170B3FF0)
#define RPG_GAMECORE_CLIENTFINISHMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x170B3FC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClientFinishMission_TypeDefinitionIndex = 18646;
