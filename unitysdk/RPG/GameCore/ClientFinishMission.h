...
#define RPG_GAMECORE_CLIENTFINISHMISSION_METHOD_3_3DA1BB40A2958885_OFFSET UNITYSDK_OFFSET(0x19654BA0)
#define RPG_GAMECORE_CLIENTFINISHMISSION_METHOD_3_72C371832ABA297E_OFFSET UNITYSDK_OFFSET(0x19654C20)
#define RPG_GAMECORE_CLIENTFINISHMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x19654BF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClientFinishMission_TypeDefinitionIndex = 19217;
