...
#define RPG_GAMECORE_CLIENTFINISHMISSION_METHOD_3_6E632C4BED1F4003_OFFSET UNITYSDK_OFFSET(0x1E349410)
#define RPG_GAMECORE_CLIENTFINISHMISSION_METHOD_3_72C371832ABA297E_OFFSET UNITYSDK_OFFSET(0x1E349450)
#define RPG_GAMECORE_CLIENTFINISHMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1E349440)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClientFinishMission_TypeDefinitionIndex = 20119;
