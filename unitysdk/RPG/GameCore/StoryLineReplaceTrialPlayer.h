...
#define RPG_GAMECORE_STORYLINEREPLACETRIALPLAYER_METHOD_3_202679E5F7870EB9_OFFSET UNITYSDK_OFFSET(0x1B0C8460)
#define RPG_GAMECORE_STORYLINEREPLACETRIALPLAYER_METHOD_3_C59B12C6BA56C5B5_OFFSET UNITYSDK_OFFSET(0x1B0C8410)
#define RPG_GAMECORE_STORYLINEREPLACETRIALPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0C8450)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StoryLineReplaceTrialPlayer_TypeDefinitionIndex = 20870;
