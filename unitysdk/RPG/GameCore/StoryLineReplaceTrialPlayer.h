...
#define RPG_GAMECORE_STORYLINEREPLACETRIALPLAYER_METHOD_3_202679E5F7870EB9_OFFSET UNITYSDK_OFFSET(0x17780430)
#define RPG_GAMECORE_STORYLINEREPLACETRIALPLAYER_METHOD_3_E5E55548F560F8A9_OFFSET UNITYSDK_OFFSET(0x177803A0)
#define RPG_GAMECORE_STORYLINEREPLACETRIALPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x17780400)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StoryLineReplaceTrialPlayer_TypeDefinitionIndex = 19838;
