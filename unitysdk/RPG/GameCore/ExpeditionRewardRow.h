...
#define RPG_GAMECORE_EXPEDITIONREWARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D7E0900)
#define RPG_GAMECORE_EXPEDITIONREWARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7E1010)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ExpeditionRewardRow_TypeDefinitionIndex = 13157;

	class ExpeditionRewardRow : public ::System::Object
	{
	public:
		::System::UInt32 Duration; // 0x10
