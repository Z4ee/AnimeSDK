...
#define RPG_GAMECORE_EXPEDITIONREWARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19705050)
#define RPG_GAMECORE_EXPEDITIONREWARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19705760)
