...
#define RPG_GAMECORE_GUIDECHALLENGETABEXCELTABLE_INDEXKEY_EQUALS_OFFSET UNITYSDK_OFFSET(0x2E960)
#define RPG_GAMECORE_GUIDECHALLENGETABEXCELTABLE_INDEXKEY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x5F00)
#define RPG_GAMECORE_GUIDECHALLENGETABEXCELTABLE_INDEXKEY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3B81680)
#define RPG_GAMECORE_GUIDECHALLENGETABEXCELTABLE_INDEXKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x2E950)
