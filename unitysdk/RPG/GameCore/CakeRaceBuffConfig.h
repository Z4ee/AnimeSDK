...
#define RPG_GAMECORE_CAKERACEBUFFCONFIG_METHOD_2_867837F8BCC35FDE_OFFSET UNITYSDK_OFFSET(0x1876EAA0)
#define RPG_GAMECORE_CAKERACEBUFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1876ED40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceBuffConfig_TypeDefinitionIndex = 17460;
	...
	public:
		...
		static ::System::Void Method_2_867837F8BCC35FDE(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::CakeRaceBuffConfig*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::CakeRaceBuffConfig*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_CAKERACEBUFFCONFIG_METHOD_2_867837F8BCC35FDE_OFFSET))(a1, a2);
		}
	};
}
