...
#define RPG_GAMECORE_CAKERACEBUFFCONFIG_METHOD_2_B6D0FE43E2FFB509_OFFSET UNITYSDK_OFFSET(0x1B2CE880)
#define RPG_GAMECORE_CAKERACEBUFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2CEB10)
