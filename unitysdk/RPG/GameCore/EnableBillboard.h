...
#define RPG_GAMECORE_ENABLEBILLBOARD_METHOD_3_749016EB8896BE68_OFFSET UNITYSDK_OFFSET(0x188A4AE0)
#define RPG_GAMECORE_ENABLEBILLBOARD_METHOD_3_8F5B428A5B05BFC5_OFFSET UNITYSDK_OFFSET(0x188A4990)
#define RPG_GAMECORE_ENABLEBILLBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x188A4A50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnableBillboard_TypeDefinitionIndex = 19417;
