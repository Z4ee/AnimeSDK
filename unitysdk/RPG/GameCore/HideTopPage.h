...
#define RPG_GAMECORE_HIDETOPPAGE_METHOD_3_213876FB57DCE2BF_OFFSET UNITYSDK_OFFSET(0x172AAF30)
#define RPG_GAMECORE_HIDETOPPAGE_METHOD_3_D154B29B7B91AAEE_OFFSET UNITYSDK_OFFSET(0x172AAFB0)
#define RPG_GAMECORE_HIDETOPPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x172AAF80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HideTopPage_TypeDefinitionIndex = 19225;
