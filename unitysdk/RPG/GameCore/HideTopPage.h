...
#define RPG_GAMECORE_HIDETOPPAGE_METHOD_3_3CF681114B5177AD_OFFSET UNITYSDK_OFFSET(0x1D18E580)
#define RPG_GAMECORE_HIDETOPPAGE_METHOD_3_D154B29B7B91AAEE_OFFSET UNITYSDK_OFFSET(0x1D18E5C0)
#define RPG_GAMECORE_HIDETOPPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D18E5B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HideTopPage_TypeDefinitionIndex = 20660;
