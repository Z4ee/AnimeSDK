...
#define RPG_GAMECORE_SETFLOORCUSTOMBOOL_METHOD_3_B6C414C0FA66B6B4_OFFSET UNITYSDK_OFFSET(0x18E31AD0)
#define RPG_GAMECORE_SETFLOORCUSTOMBOOL_METHOD_3_DEED5FC6CA5C68FD_OFFSET UNITYSDK_OFFSET(0x18E31A50)
#define RPG_GAMECORE_SETFLOORCUSTOMBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x18E31AA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetFloorCustomBool_TypeDefinitionIndex = 19667;
