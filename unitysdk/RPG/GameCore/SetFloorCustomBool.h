...
#define RPG_GAMECORE_SETFLOORCUSTOMBOOL_METHOD_3_72CD4A82AB0E99A1_OFFSET UNITYSDK_OFFSET(0x1E82B7E0)
#define RPG_GAMECORE_SETFLOORCUSTOMBOOL_METHOD_3_B6C414C0FA66B6B4_OFFSET UNITYSDK_OFFSET(0x1E82B820)
#define RPG_GAMECORE_SETFLOORCUSTOMBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1E82B810)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetFloorCustomBool_TypeDefinitionIndex = 20452;
	...
	public:
		...
		static ::System::Void Method_3_72CD4A82AB0E99A1(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::SetFloorCustomBool*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::SetFloorCustomBool*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_SETFLOORCUSTOMBOOL_METHOD_3_72CD4A82AB0E99A1_OFFSET))(a1, a2);
		}
