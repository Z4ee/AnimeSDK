...
#define RPG_GAMECORE_SETFLOORCUSTOMBOOL_METHOD_3_B6C414C0FA66B6B4_OFFSET UNITYSDK_OFFSET(0x19C4E8D0)
#define RPG_GAMECORE_SETFLOORCUSTOMBOOL_METHOD_3_DEED5FC6CA5C68FD_OFFSET UNITYSDK_OFFSET(0x19C4E850)
#define RPG_GAMECORE_SETFLOORCUSTOMBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x19C4E8A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetFloorCustomBool_TypeDefinitionIndex = 19547;
