...
#define RPG_GAMECORE_TRAVELSHIPWAITNAVIGATIONARRIVE_METHOD_3_A688AD229480E996_OFFSET UNITYSDK_OFFSET(0x1B03F2F0)
#define RPG_GAMECORE_TRAVELSHIPWAITNAVIGATIONARRIVE_METHOD_3_EB3DDBA0DB87B62D_OFFSET UNITYSDK_OFFSET(0x1B03F2B0)
#define RPG_GAMECORE_TRAVELSHIPWAITNAVIGATIONARRIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B03F2E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TravelShipWaitNavigationArrive_TypeDefinitionIndex = 20192;
