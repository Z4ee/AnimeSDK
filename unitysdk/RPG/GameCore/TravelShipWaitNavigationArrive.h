...
#define RPG_GAMECORE_TRAVELSHIPWAITNAVIGATIONARRIVE_METHOD_3_2B342535E0AE1417_OFFSET UNITYSDK_OFFSET(0x190B6510)
#define RPG_GAMECORE_TRAVELSHIPWAITNAVIGATIONARRIVE_METHOD_3_A688AD229480E996_OFFSET UNITYSDK_OFFSET(0x190B6590)
#define RPG_GAMECORE_TRAVELSHIPWAITNAVIGATIONARRIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x190B6560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TravelShipWaitNavigationArrive_TypeDefinitionIndex = 19969;
