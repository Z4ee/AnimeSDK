...
#define RPG_GAMECORE_PLAYERRETURNRECOMMENDCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18C34D40)
#define RPG_GAMECORE_PLAYERRETURNRECOMMENDCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18C35080)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayerReturnRecommendConfigRow_TypeDefinitionIndex = 13724;
	...
	public:
		...
		::RPG::GameCore::PlayerReturnRecommendType Type; // 0x20
		::System::UInt32 RecommendID; // 0x24
