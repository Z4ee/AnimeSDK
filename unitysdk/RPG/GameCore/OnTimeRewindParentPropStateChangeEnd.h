...
#define RPG_GAMECORE_ONTIMEREWINDPARENTPROPSTATECHANGEEND_METHOD_3_37E4C4BA8EBF3CF8_OFFSET UNITYSDK_OFFSET(0x1747B4C0)
#define RPG_GAMECORE_ONTIMEREWINDPARENTPROPSTATECHANGEEND_METHOD_3_C22EDB407C658AA7_OFFSET UNITYSDK_OFFSET(0x1747B440)
#define RPG_GAMECORE_ONTIMEREWINDPARENTPROPSTATECHANGEEND__CTOR_OFFSET UNITYSDK_OFFSET(0x1747B490)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OnTimeRewindParentPropStateChangeEnd_TypeDefinitionIndex = 18965;
