...
#define RPG_GAMECORE_LOSEHPBYRATIO_METHOD_3_4CA05222F25EE503_OFFSET UNITYSDK_OFFSET(0x17371DA0)
#define RPG_GAMECORE_LOSEHPBYRATIO_METHOD_3_FDF7C82583C3A810_OFFSET UNITYSDK_OFFSET(0x17371C60)
#define RPG_GAMECORE_LOSEHPBYRATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x17371D10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoseHPByRatio_TypeDefinitionIndex = 20884;
