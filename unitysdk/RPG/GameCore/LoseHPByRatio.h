...
#define RPG_GAMECORE_LOSEHPBYRATIO_METHOD_3_4CA05222F25EE503_OFFSET UNITYSDK_OFFSET(0x18A7F9B0)
#define RPG_GAMECORE_LOSEHPBYRATIO_METHOD_3_FDF7C82583C3A810_OFFSET UNITYSDK_OFFSET(0x18A7F870)
#define RPG_GAMECORE_LOSEHPBYRATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x18A7F920)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoseHPByRatio_TypeDefinitionIndex = 21595;
