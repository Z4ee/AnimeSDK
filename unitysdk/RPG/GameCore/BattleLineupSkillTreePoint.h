...
#define RPG_GAMECORE_BATTLELINEUPSKILLTREEPOINT_METHOD_2_848EE3494CD469C0_OFFSET UNITYSDK_OFFSET(0x1A3F07C0)
#define RPG_GAMECORE_BATTLELINEUPSKILLTREEPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3F0910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleLineupSkillTreePoint_TypeDefinitionIndex = 17392;
