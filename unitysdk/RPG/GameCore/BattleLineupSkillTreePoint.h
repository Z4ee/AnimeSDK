...
#define RPG_GAMECORE_BATTLELINEUPSKILLTREEPOINT_METHOD_2_848EE3494CD469C0_OFFSET UNITYSDK_OFFSET(0x16FD9530)
#define RPG_GAMECORE_BATTLELINEUPSKILLTREEPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x16FD9680)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleLineupSkillTreePoint_TypeDefinitionIndex = 16630;
