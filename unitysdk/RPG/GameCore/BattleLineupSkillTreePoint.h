...
#define RPG_GAMECORE_BATTLELINEUPSKILLTREEPOINT_METHOD_2_848EE3494CD469C0_OFFSET UNITYSDK_OFFSET(0x194D0460)
#define RPG_GAMECORE_BATTLELINEUPSKILLTREEPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x194D05B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleLineupSkillTreePoint_TypeDefinitionIndex = 17230;
