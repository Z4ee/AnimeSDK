...
#define RPG_GAMECORE_PEIPEICHALLENGECONTROLLERINIT_METHOD_3_0B1E01C0557AB31C_OFFSET UNITYSDK_OFFSET(0x199EC870)
#define RPG_GAMECORE_PEIPEICHALLENGECONTROLLERINIT_METHOD_3_6C0A5BE6E32AA5CD_OFFSET UNITYSDK_OFFSET(0x199EC7F0)
#define RPG_GAMECORE_PEIPEICHALLENGECONTROLLERINIT__CTOR_OFFSET UNITYSDK_OFFSET(0x199EC840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PeiPeiChallengeControllerInit_TypeDefinitionIndex = 20022;
