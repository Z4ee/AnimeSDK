...
#define RPG_GAMECORE_PEIPEICHALLENGECONTROLLERINIT_METHOD_3_07F0B989C1555615_OFFSET UNITYSDK_OFFSET(0x1BB147E0)
#define RPG_GAMECORE_PEIPEICHALLENGECONTROLLERINIT_METHOD_3_0B1E01C0557AB31C_OFFSET UNITYSDK_OFFSET(0x1BB14820)
#define RPG_GAMECORE_PEIPEICHALLENGECONTROLLERINIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB14810)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PeiPeiChallengeControllerInit_TypeDefinitionIndex = 20394;
