...
#define RPG_GAMECORE_TARGETFETCHUNSTAGETARGET_METHOD_4_0F76D30B5DD42ED1_OFFSET UNITYSDK_OFFSET(0x18EE0FD0)
#define RPG_GAMECORE_TARGETFETCHUNSTAGETARGET_METHOD_4_CABA0A81FE4E6F2E_OFFSET UNITYSDK_OFFSET(0x18EE6320)
#define RPG_GAMECORE_TARGETFETCHUNSTAGETARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x18EE0F80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchUnstageTarget_TypeDefinitionIndex = 22964;
