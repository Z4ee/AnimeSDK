...
#define RPG_GAMECORE_TARGETFETCHUNSTAGETARGET_METHOD_4_0F76D30B5DD42ED1_OFFSET UNITYSDK_OFFSET(0x1D0BE0C0)
#define RPG_GAMECORE_TARGETFETCHUNSTAGETARGET_METHOD_4_6A8CDFA452A83894_OFFSET UNITYSDK_OFFSET(0x1D0BE000)
#define RPG_GAMECORE_TARGETFETCHUNSTAGETARGET_METHOD_4_828CBD1C55A7DFEF_OFFSET UNITYSDK_OFFSET(0x1D0BE190)
#define RPG_GAMECORE_TARGETFETCHUNSTAGETARGET_METHOD_4_91AD260443483890_OFFSET UNITYSDK_OFFSET(0x1D0BE160)
#define RPG_GAMECORE_TARGETFETCHUNSTAGETARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0BE0B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchUnstageTarget_TypeDefinitionIndex = 23118;
