...
#define RPG_GAMECORE_ENTITYVISIABLEINFO_METHOD_2_92512B14B844A479_OFFSET UNITYSDK_OFFSET(0x171A3950)
#define RPG_GAMECORE_ENTITYVISIABLEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x171A3A40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EntityVisiableInfo_TypeDefinitionIndex = 20022;
