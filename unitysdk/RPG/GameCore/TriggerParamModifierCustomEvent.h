...
#define RPG_GAMECORE_TRIGGERPARAMMODIFIERCUSTOMEVENT_METHOD_3_AD558FD3033603F8_OFFSET UNITYSDK_OFFSET(0x178CC220)
#define RPG_GAMECORE_TRIGGERPARAMMODIFIERCUSTOMEVENT_METHOD_3_EB976C1C80FA0427_OFFSET UNITYSDK_OFFSET(0x178CC1A0)
#define RPG_GAMECORE_TRIGGERPARAMMODIFIERCUSTOMEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x178CC1F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerParamModifierCustomEvent_TypeDefinitionIndex = 21875;
