...
#define RPG_GAMECORE_PROPPREDICATEWITHENTITY_METHOD_4_63C942FC0A67226C_OFFSET UNITYSDK_OFFSET(0x1750E660)
#define RPG_GAMECORE_PROPPREDICATEWITHENTITY_METHOD_4_E9E6315FF8E6FE74_OFFSET UNITYSDK_OFFSET(0x175220F0)
#define RPG_GAMECORE_PROPPREDICATEWITHENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1750E5A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropPredicateWithEntity_TypeDefinitionIndex = 20194;
