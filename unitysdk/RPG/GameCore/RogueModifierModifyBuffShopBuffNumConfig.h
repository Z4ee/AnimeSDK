...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYBUFFSHOPBUFFNUMCONFIG_METHOD_3_21AF0A473A31F097_OFFSET UNITYSDK_OFFSET(0x17633A10)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYBUFFSHOPBUFFNUMCONFIG_METHOD_3_E71CB7B8F5B63C6E_OFFSET UNITYSDK_OFFSET(0x17633AE0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYBUFFSHOPBUFFNUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17633A90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyBuffShopBuffNumConfig_TypeDefinitionIndex = 16476;
