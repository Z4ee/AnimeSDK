...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYBUFFSHOPBUFFNUMCONFIG_METHOD_3_C2E067DA87FCC4D2_OFFSET UNITYSDK_OFFSET(0x1D163820)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYBUFFSHOPBUFFNUMCONFIG_METHOD_3_E71CB7B8F5B63C6E_OFFSET UNITYSDK_OFFSET(0x1D163870)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYBUFFSHOPBUFFNUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D163860)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyBuffShopBuffNumConfig_TypeDefinitionIndex = 17205;
