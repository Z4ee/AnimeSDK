...
#define RPG_GAMECORE_LEVELPEDESTRIANV2INTERSECTIONROADPATHINFO_METHOD_2_103C81DA41C639C6_OFFSET UNITYSDK_OFFSET(0x1B085180)
#define RPG_GAMECORE_LEVELPEDESTRIANV2INTERSECTIONROADPATHINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B085290)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPedestrianV2IntersectionRoadPathInfo_TypeDefinitionIndex = 16608;
