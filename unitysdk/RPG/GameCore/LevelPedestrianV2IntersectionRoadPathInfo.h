...
#define RPG_GAMECORE_LEVELPEDESTRIANV2INTERSECTIONROADPATHINFO_METHOD_2_103C81DA41C639C6_OFFSET UNITYSDK_OFFSET(0x19885550)
#define RPG_GAMECORE_LEVELPEDESTRIANV2INTERSECTIONROADPATHINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19885660)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPedestrianV2IntersectionRoadPathInfo_TypeDefinitionIndex = 16446;
