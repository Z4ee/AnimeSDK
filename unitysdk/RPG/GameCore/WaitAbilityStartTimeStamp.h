...
#define RPG_GAMECORE_WAITABILITYSTARTTIMESTAMP_METHOD_3_2580D19FB44E2B6C_OFFSET UNITYSDK_OFFSET(0x190F7980)
#define RPG_GAMECORE_WAITABILITYSTARTTIMESTAMP_METHOD_3_69428F16486A2DC5_OFFSET UNITYSDK_OFFSET(0x190F7860)
#define RPG_GAMECORE_WAITABILITYSTARTTIMESTAMP__CTOR_OFFSET UNITYSDK_OFFSET(0x190F7900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitAbilityStartTimeStamp_TypeDefinitionIndex = 21589;
