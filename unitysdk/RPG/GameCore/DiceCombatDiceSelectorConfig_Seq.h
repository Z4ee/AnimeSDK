...
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_SEQ_METHOD_3_6B351C9BB1A26F97_OFFSET UNITYSDK_OFFSET(0x1D822FE0)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_SEQ_METHOD_3_F045F6C2034479F5_OFFSET UNITYSDK_OFFSET(0x1D823B50)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_SEQ__CTOR_OFFSET UNITYSDK_OFFSET(0x1D822F80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatDiceSelectorConfig_Seq_TypeDefinitionIndex = 15970;
