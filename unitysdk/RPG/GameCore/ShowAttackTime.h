...
#define RPG_GAMECORE_SHOWATTACKTIME_METHOD_3_0D55A05F6FF14F27_OFFSET UNITYSDK_OFFSET(0x1BE39200)
#define RPG_GAMECORE_SHOWATTACKTIME_METHOD_3_CC98F3A758BFD9D7_OFFSET UNITYSDK_OFFSET(0x1BE39240)
#define RPG_GAMECORE_SHOWATTACKTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE39230)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowAttackTime_TypeDefinitionIndex = 22104;
