...
#define RPG_GAMECORE_SHOWATTACKTIME_METHOD_3_CC98F3A758BFD9D7_OFFSET UNITYSDK_OFFSET(0x18E57EE0)
#define RPG_GAMECORE_SHOWATTACKTIME_METHOD_3_E6397EECEF83B3E9_OFFSET UNITYSDK_OFFSET(0x18E57E60)
#define RPG_GAMECORE_SHOWATTACKTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x18E57EB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowAttackTime_TypeDefinitionIndex = 21847;
