...
#define RPG_GAMECORE_FREESTYLECONTROLLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB6913C0)
#define RPG_GAMECORE_FREESTYLECONTROLLER_GET_INFO_OFFSET UNITYSDK_OFFSET(0xB690FB0)
#define RPG_GAMECORE_FREESTYLECONTROLLER_GET_ISPLAYING_OFFSET UNITYSDK_OFFSET(0xB690FC0)
#define RPG_GAMECORE_FREESTYLECONTROLLER_METHOD_1_1779A83FFA83BA8F_OFFSET UNITYSDK_OFFSET(0xB691170)
#define RPG_GAMECORE_FREESTYLECONTROLLER_METHOD_1_2685B6183E614529_1_OFFSET UNITYSDK_OFFSET(0xB691080)
#define RPG_GAMECORE_FREESTYLECONTROLLER_METHOD_1_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0xB691020)
#define RPG_GAMECORE_FREESTYLECONTROLLER_METHOD_1_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0xB691330)
#define RPG_GAMECORE_FREESTYLECONTROLLER_METHOD_1_4120FFA8338789EF_OFFSET UNITYSDK_OFFSET(0xB691200)
#define RPG_GAMECORE_FREESTYLECONTROLLER_METHOD_1_53C2CF710DB7E6D5_OFFSET UNITYSDK_OFFSET(0xB6910E0)
#define RPG_GAMECORE_FREESTYLECONTROLLER_METHOD_1_6D0DBA549ECE8225_OFFSET UNITYSDK_OFFSET(0xB6912C0)
#define RPG_GAMECORE_FREESTYLECONTROLLER_METHOD_1_7EFDB9F1D6E62586_OFFSET UNITYSDK_OFFSET(0xB68F950)
#define RPG_GAMECORE_FREESTYLECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB690F70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FreeStyleController_TypeDefinitionIndex = 52787;
