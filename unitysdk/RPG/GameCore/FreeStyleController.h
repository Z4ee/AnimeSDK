...
#define RPG_GAMECORE_FREESTYLECONTROLLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1158F5A0)
#define RPG_GAMECORE_FREESTYLECONTROLLER_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1158F190)
#define RPG_GAMECORE_FREESTYLECONTROLLER_GET_ISPLAYING_OFFSET UNITYSDK_OFFSET(0x1158F1A0)
#define RPG_GAMECORE_FREESTYLECONTROLLER_METHOD_1_2685B6183E614529_1_OFFSET UNITYSDK_OFFSET(0x1158F260)
#define RPG_GAMECORE_FREESTYLECONTROLLER_METHOD_1_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0x1158F200)
#define RPG_GAMECORE_FREESTYLECONTROLLER_METHOD_1_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x1158F510)
#define RPG_GAMECORE_FREESTYLECONTROLLER_METHOD_1_4120FFA8338789EF_OFFSET UNITYSDK_OFFSET(0x1158F3E0)
#define RPG_GAMECORE_FREESTYLECONTROLLER_METHOD_1_75259065C990E6D4_1_OFFSET UNITYSDK_OFFSET(0x1158F350)
#define RPG_GAMECORE_FREESTYLECONTROLLER_METHOD_1_75259065C990E6D4_OFFSET UNITYSDK_OFFSET(0x1158F2C0)
#define RPG_GAMECORE_FREESTYLECONTROLLER_METHOD_1_7EFDB9F1D6E62586_OFFSET UNITYSDK_OFFSET(0x1158D830)
#define RPG_GAMECORE_FREESTYLECONTROLLER_METHOD_1_EB1BA1DE308975DE_OFFSET UNITYSDK_OFFSET(0x1158F4A0)
#define RPG_GAMECORE_FREESTYLECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1158F150)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FreeStyleController_TypeDefinitionIndex = 57430;

	class FreeStyleController : public ::System::Object
	{
	public:
		::Class_1_C3183153408A386B* _Info_k__BackingField; // 0x10
