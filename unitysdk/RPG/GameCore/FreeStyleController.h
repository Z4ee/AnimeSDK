...
#define RPG_GAMECORE_FREESTYLECONTROLLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x154EC610)
#define RPG_GAMECORE_FREESTYLECONTROLLER_GET_INFO_OFFSET UNITYSDK_OFFSET(0x154EC200)
#define RPG_GAMECORE_FREESTYLECONTROLLER_GET_ISPLAYING_OFFSET UNITYSDK_OFFSET(0x154EC210)
#define RPG_GAMECORE_FREESTYLECONTROLLER_METHOD_1_2685B6183E614529_1_OFFSET UNITYSDK_OFFSET(0x154EC2D0)
#define RPG_GAMECORE_FREESTYLECONTROLLER_METHOD_1_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0x154EC270)
#define RPG_GAMECORE_FREESTYLECONTROLLER_METHOD_1_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x154EC580)
#define RPG_GAMECORE_FREESTYLECONTROLLER_METHOD_1_4120FFA8338789EF_OFFSET UNITYSDK_OFFSET(0x154EC450)
#define RPG_GAMECORE_FREESTYLECONTROLLER_METHOD_1_75259065C990E6D4_1_OFFSET UNITYSDK_OFFSET(0x154EC3C0)
#define RPG_GAMECORE_FREESTYLECONTROLLER_METHOD_1_75259065C990E6D4_OFFSET UNITYSDK_OFFSET(0x154EC330)
#define RPG_GAMECORE_FREESTYLECONTROLLER_METHOD_1_7EFDB9F1D6E62586_OFFSET UNITYSDK_OFFSET(0x154EA930)
#define RPG_GAMECORE_FREESTYLECONTROLLER_METHOD_1_EB1BA1DE308975DE_OFFSET UNITYSDK_OFFSET(0x154EC510)
#define RPG_GAMECORE_FREESTYLECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x154EC1C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FreeStyleController_TypeDefinitionIndex = 54709;
	...
	public:
		...
		::RPG::GameCore::FreeStyleComponent* _Component; // 0x20
