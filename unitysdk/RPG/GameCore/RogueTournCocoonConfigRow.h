...
#define RPG_GAMECORE_ROGUETOURNCOCOONCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19BC3120)
#define RPG_GAMECORE_ROGUETOURNCOCOONCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19BC3610)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournCocoonConfigRow_TypeDefinitionIndex = 14254;
	...
	public:
		...
		::Il2CppArray<::Class_1_A88C3AAF0DD46F4C_7*>* DisplayMonsterMap; // 0x30
		::System::UInt32 FuncUnlockID; // 0x38
		::System::UInt32 Difficulty; // 0x3C
		::System::UInt32 ID; // 0x40
		::System::UInt32 MaxChallengeCnt; // 0x44
		::System::UInt32 RecommendLevel; // 0x48
		::System::UInt32 RogueKeyCost; // 0x4C
		::System::UInt32 NpcMonsterID; // 0x50
		::System::UInt32 StaminaCost; // 0x54
		::System::UInt32 WorldLevel; // 0x58
		::System::UInt32 DisplayID; // 0x5C
