...
#define RPG_GAMECORE_ADVENTUREBYISINPOSITION_METHOD_4_553A6054008BBE46_OFFSET UNITYSDK_OFFSET(0x1866F360)
#define RPG_GAMECORE_ADVENTUREBYISINPOSITION_METHOD_4_F6B97091CCEADA81_OFFSET UNITYSDK_OFFSET(0x1866F280)
#define RPG_GAMECORE_ADVENTUREBYISINPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1866F300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureByIsInPosition_TypeDefinitionIndex = 19761;
