...
#define RPG_GAMECORE_ROGUEDIALOGUEBASECONFIG_METHOD_2_A14CFAF226F8759E_OFFSET UNITYSDK_OFFSET(0x1CFA96A0)
#define RPG_GAMECORE_ROGUEDIALOGUEBASECONFIG_METHOD_2_D4B5295697587545_OFFSET UNITYSDK_OFFSET(0x1CFA9530)
#define RPG_GAMECORE_ROGUEDIALOGUEBASECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFA9690)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueDialogueBaseConfig_TypeDefinitionIndex = 17271;
