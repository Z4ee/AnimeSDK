...
#define RPG_GAMECORE_ILCOMBATADVANTAGEGROUPCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D20C680)
#define RPG_GAMECORE_ILCOMBATADVANTAGEGROUPCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D20C8D0)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::System::Int64 CombatAdvantage; // 0x10
		::System::UInt32 CombatAdvantageGroup; // 0x18
		::RPG::GameCore::FixPoint DamageTakenRatio; // 0x20
