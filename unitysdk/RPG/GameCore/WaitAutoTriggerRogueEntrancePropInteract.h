...
#define RPG_GAMECORE_WAITAUTOTRIGGERROGUEENTRANCEPROPINTERACT_METHOD_3_00B243FAB326A679_OFFSET UNITYSDK_OFFSET(0x1B8A0C40)
#define RPG_GAMECORE_WAITAUTOTRIGGERROGUEENTRANCEPROPINTERACT_METHOD_3_10923C41618305BA_OFFSET UNITYSDK_OFFSET(0x1B8A0C00)
#define RPG_GAMECORE_WAITAUTOTRIGGERROGUEENTRANCEPROPINTERACT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8A0C30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitAutoTriggerRogueEntrancePropInteract_TypeDefinitionIndex = 21273;
