...
#define RPG_GAMECORE_WAITAUTOTRIGGERROGUEENTRANCEPROPINTERACT_METHOD_3_00B243FAB326A679_OFFSET UNITYSDK_OFFSET(0x190F8EA0)
#define RPG_GAMECORE_WAITAUTOTRIGGERROGUEENTRANCEPROPINTERACT_METHOD_3_540E8372F44340F0_OFFSET UNITYSDK_OFFSET(0x190F8E20)
#define RPG_GAMECORE_WAITAUTOTRIGGERROGUEENTRANCEPROPINTERACT__CTOR_OFFSET UNITYSDK_OFFSET(0x190F8E70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitAutoTriggerRogueEntrancePropInteract_TypeDefinitionIndex = 20945;
