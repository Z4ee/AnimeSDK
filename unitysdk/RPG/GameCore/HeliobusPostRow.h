...
#define RPG_GAMECORE_HELIOBUSPOSTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x172A1BF0)
#define RPG_GAMECORE_HELIOBUSPOSTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x172A3580)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::Il2CppArray<::Class_1_A88C3AAF0DD46F4C_8*>* Likes; // 0x10
		...
		::Il2CppArray<::System::UInt32>* PostUnlockSubMissionIDList; // 0x28
		::System::UInt32 PostTypeParameter; // 0x30
		::System::Boolean IsClosePanel; // 0x34
		::System::UInt32 ReplyIncomeReward; // 0x38
		::System::UInt32 HeliobusPostID; // 0x3C
		::RPG::Client::TextID HeliobusPostContent; // 0x40
		::RPG::GameCore::HeliobusPostType PostType; // 0x50
		::System::UInt32 HeliobusUserID; // 0x54
		::System::UInt32 PostUnlockPhase; // 0x58
		::RPG::Client::TextID PostFansPreview; // 0x60
		::System::UInt32 PostImgID; // 0x70
		::System::UInt32 PostIncomeReward; // 0x74
