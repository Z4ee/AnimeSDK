...
#define RPG_GAMECORE_NEWPROJECTILEDATALIST_METHOD_2_568EEE53FC74949D_OFFSET UNITYSDK_OFFSET(0x1CE8F110)
#define RPG_GAMECORE_NEWPROJECTILEDATALIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE8F290)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NewProjectileDataList_TypeDefinitionIndex = 22335;
