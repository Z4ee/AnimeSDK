...
#define RPG_GAMECORE_BYCHECKCOLONYMIRRORTAKENDIFF_METHOD_4_23DA4797A4DD9CAF_OFFSET UNITYSDK_OFFSET(0x19CC3330)
#define RPG_GAMECORE_BYCHECKCOLONYMIRRORTAKENDIFF_METHOD_4_70E2DB72E29C8626_OFFSET UNITYSDK_OFFSET(0x19CC31B0)
#define RPG_GAMECORE_BYCHECKCOLONYMIRRORTAKENDIFF_METHOD_4_8D769CC35060A1C2_OFFSET UNITYSDK_OFFSET(0x19CC3360)
#define RPG_GAMECORE_BYCHECKCOLONYMIRRORTAKENDIFF_METHOD_4_D55C28E78A16DE65_OFFSET UNITYSDK_OFFSET(0x19CC31F0)
#define RPG_GAMECORE_BYCHECKCOLONYMIRRORTAKENDIFF__CTOR_OFFSET UNITYSDK_OFFSET(0x19CC31E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckColonyMirrorTakenDiff_TypeDefinitionIndex = 21065;
