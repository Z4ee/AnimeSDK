...
#define RPG_GAMECORE_BYCHECKCOLONYMIRRORTAKENDIFF_METHOD_4_D55C28E78A16DE65_OFFSET UNITYSDK_OFFSET(0x16FFD6F0)
#define RPG_GAMECORE_BYCHECKCOLONYMIRRORTAKENDIFF_METHOD_4_EEC42EC65850BF4F_OFFSET UNITYSDK_OFFSET(0x16FFD620)
#define RPG_GAMECORE_BYCHECKCOLONYMIRRORTAKENDIFF__CTOR_OFFSET UNITYSDK_OFFSET(0x16FFD6A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckColonyMirrorTakenDiff_TypeDefinitionIndex = 20040;
