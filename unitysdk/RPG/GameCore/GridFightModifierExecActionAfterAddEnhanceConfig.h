...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERADDENHANCECONFIG_METHOD_3_28ADE70705BB48BC_OFFSET UNITYSDK_OFFSET(0x189B8330)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERADDENHANCECONFIG_METHOD_3_9894EC1A00DB0FC5_OFFSET UNITYSDK_OFFSET(0x189BBA80)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERADDENHANCECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189B82E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierExecActionAfterAddEnhanceConfig_TypeDefinitionIndex = 18438;
