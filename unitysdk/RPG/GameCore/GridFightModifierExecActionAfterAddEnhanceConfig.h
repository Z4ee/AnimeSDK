...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERADDENHANCECONFIG_METHOD_3_28ADE70705BB48BC_OFFSET UNITYSDK_OFFSET(0x1C5D0CE0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERADDENHANCECONFIG_METHOD_3_6FCC7E5DF35A68C0_OFFSET UNITYSDK_OFFSET(0x1C5D0C90)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERADDENHANCECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5D0CD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierExecActionAfterAddEnhanceConfig_TypeDefinitionIndex = 18658;
