...
#define RPG_GAMECORE_MODIFYCOOLDOWN_METHOD_3_81E244CB03357C2C_OFFSET UNITYSDK_OFFSET(0x1D2AF420)
#define RPG_GAMECORE_MODIFYCOOLDOWN_METHOD_3_9D0365CDCBFEB991_OFFSET UNITYSDK_OFFSET(0x1D2AF3E0)
#define RPG_GAMECORE_MODIFYCOOLDOWN__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2AF410)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyCoolDown_TypeDefinitionIndex = 22348;
