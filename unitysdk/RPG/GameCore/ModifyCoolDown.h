...
#define RPG_GAMECORE_MODIFYCOOLDOWN_METHOD_3_106E2F22E509B8D5_OFFSET UNITYSDK_OFFSET(0x1742B2D0)
#define RPG_GAMECORE_MODIFYCOOLDOWN_METHOD_3_81E244CB03357C2C_OFFSET UNITYSDK_OFFSET(0x1742B350)
#define RPG_GAMECORE_MODIFYCOOLDOWN__CTOR_OFFSET UNITYSDK_OFFSET(0x1742B320)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyCoolDown_TypeDefinitionIndex = 20783;
