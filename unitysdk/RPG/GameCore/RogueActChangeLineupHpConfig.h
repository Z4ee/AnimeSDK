...
#define RPG_GAMECORE_ROGUEACTCHANGELINEUPHPCONFIG_METHOD_6_651F22DBFDC38ACE_OFFSET UNITYSDK_OFFSET(0x19AE2690)
#define RPG_GAMECORE_ROGUEACTCHANGELINEUPHPCONFIG_METHOD_6_AED03C292983B7BB_OFFSET UNITYSDK_OFFSET(0x19AE28B0)
#define RPG_GAMECORE_ROGUEACTCHANGELINEUPHPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AE27D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActChangeLineupHpConfig_TypeDefinitionIndex = 18592;
