...
#define RPG_GAMECORE_ROGUEACTCHANGELINEUPHPCONFIG_METHOD_6_0A61FE22DE3772D7_OFFSET UNITYSDK_OFFSET(0x1D3B6CD0)
#define RPG_GAMECORE_ROGUEACTCHANGELINEUPHPCONFIG_METHOD_6_AED03C292983B7BB_OFFSET UNITYSDK_OFFSET(0x1D3B6D20)
#define RPG_GAMECORE_ROGUEACTCHANGELINEUPHPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3B6D10)
