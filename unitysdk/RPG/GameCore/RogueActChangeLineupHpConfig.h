...
#define RPG_GAMECORE_ROGUEACTCHANGELINEUPHPCONFIG_METHOD_6_651F22DBFDC38ACE_OFFSET UNITYSDK_OFFSET(0x18CBE280)
#define RPG_GAMECORE_ROGUEACTCHANGELINEUPHPCONFIG_METHOD_6_AED03C292983B7BB_OFFSET UNITYSDK_OFFSET(0x18CBE4A0)
#define RPG_GAMECORE_ROGUEACTCHANGELINEUPHPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CBE3C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActChangeLineupHpConfig_TypeDefinitionIndex = 18625;
