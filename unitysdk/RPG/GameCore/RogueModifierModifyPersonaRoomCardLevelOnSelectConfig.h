...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYPERSONAROOMCARDLEVELONSELECTCONFIG_METHOD_3_20927B31A9676558_OFFSET UNITYSDK_OFFSET(0x18D41970)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYPERSONAROOMCARDLEVELONSELECTCONFIG_METHOD_3_CE1868B4876FF381_OFFSET UNITYSDK_OFFSET(0x18D418A0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYPERSONAROOMCARDLEVELONSELECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D41920)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyPersonaRoomCardLevelOnSelectConfig_TypeDefinitionIndex = 16946;
