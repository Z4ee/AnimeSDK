...
#define RPG_GAMECORE_FATEMODIFIERSECKILLCONFIG_METHOD_3_1EAFCA2C5F19CBDD_OFFSET UNITYSDK_OFFSET(0x1D08DB70)
#define RPG_GAMECORE_FATEMODIFIERSECKILLCONFIG_METHOD_3_B7DBCE2D6568DC19_OFFSET UNITYSDK_OFFSET(0x1D08DB20)
#define RPG_GAMECORE_FATEMODIFIERSECKILLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D08DB60)
