...
#define RPG_GAMECORE_FATEMODIFIERSECKILLCONFIG_METHOD_3_047A418731E79B64_OFFSET UNITYSDK_OFFSET(0x171C9000)
#define RPG_GAMECORE_FATEMODIFIERSECKILLCONFIG_METHOD_3_1EAFCA2C5F19CBDD_OFFSET UNITYSDK_OFFSET(0x171C8260)
#define RPG_GAMECORE_FATEMODIFIERSECKILLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171C8210)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateModifierSeckillConfig_TypeDefinitionIndex = 17702;
