...
#define RPG_GAMECORE_TARGETFETCHANCHOR_METHOD_4_45490C5B35D7AC63_OFFSET UNITYSDK_OFFSET(0x1D5A8BF0)
#define RPG_GAMECORE_TARGETFETCHANCHOR_METHOD_4_57F7E1633B2877D8_OFFSET UNITYSDK_OFFSET(0x1D5A8C30)
#define RPG_GAMECORE_TARGETFETCHANCHOR_METHOD_4_5DF85947CF2521C1_OFFSET UNITYSDK_OFFSET(0x1D5A8D10)
#define RPG_GAMECORE_TARGETFETCHANCHOR_METHOD_4_E25061A1A89060AB_OFFSET UNITYSDK_OFFSET(0x1D5A8D40)
#define RPG_GAMECORE_TARGETFETCHANCHOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5A8C20)
