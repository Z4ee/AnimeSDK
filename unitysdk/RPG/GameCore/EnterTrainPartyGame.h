...
#define RPG_GAMECORE_ENTERTRAINPARTYGAME_METHOD_3_3E5182C3A6D4DE00_OFFSET UNITYSDK_OFFSET(0x1D068C60)
#define RPG_GAMECORE_ENTERTRAINPARTYGAME_METHOD_3_E5BC8B9A175AB4BD_OFFSET UNITYSDK_OFFSET(0x1D068D30)
#define RPG_GAMECORE_ENTERTRAINPARTYGAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1D068D20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnterTrainPartyGame_TypeDefinitionIndex = 22106;
