...
#define RPG_GAMECORE_ENTERTRAINPARTYGAME_METHOD_3_3E5182C3A6D4DE00_OFFSET UNITYSDK_OFFSET(0x1D7C3730)
#define RPG_GAMECORE_ENTERTRAINPARTYGAME_METHOD_3_E5BC8B9A175AB4BD_OFFSET UNITYSDK_OFFSET(0x1D7C3800)
#define RPG_GAMECORE_ENTERTRAINPARTYGAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7C37F0)
