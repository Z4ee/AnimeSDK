...
#define RPG_GAMECORE_AETHERDIVIDECHALLENGELISTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CBC30D0)
#define RPG_GAMECORE_AETHERDIVIDECHALLENGELISTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CBC3620)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::AetherDivideChallengeType ChallengeType; // 0x4C
		::System::UInt32 BattleAreaID; // 0x50
		::System::UInt32 MissionID; // 0x54
		::RPG::Client::TextID Signature; // 0x58
