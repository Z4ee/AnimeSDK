...
#define RPG_GAMECORE_AETHERDIVIDECHALLENGELISTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CDFC090)
#define RPG_GAMECORE_AETHERDIVIDECHALLENGELISTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDFC5E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AetherDivideChallengeListRow_TypeDefinitionIndex = 10898;
	...
	public:
		...
		::System::String* OpponentPrefabPath; // 0x20
		::System::String* VersusImagePath; // 0x28
		::RPG::GameCore::AetherDivideChallengeType ChallengeType; // 0x30
		::System::UInt32 Rank; // 0x34
		::System::UInt32 OpponentStrength; // 0x38
		::System::UInt32 ID; // 0x3C
		::System::UInt32 EventID; // 0x40
		::System::UInt32 MazeBuffID; // 0x44
		::RPG::Client::TextID OpponentName; // 0x48
		::System::UInt32 BattleAreaID; // 0x58
		::System::UInt32 RewardID; // 0x5C
		::System::UInt32 MissionID; // 0x60
		::System::UInt32 GroupID; // 0x64
		::RPG::Client::TextID Signature; // 0x68
