...
#define RPG_GAMECORE_BYCOMPAREDAMAGECUSTOMNAME_METHOD_4_0080AFBAC3676109_OFFSET UNITYSDK_OFFSET(0x17006980)
#define RPG_GAMECORE_BYCOMPAREDAMAGECUSTOMNAME_METHOD_4_0115E19352855FC7_OFFSET UNITYSDK_OFFSET(0x17006A50)
#define RPG_GAMECORE_BYCOMPAREDAMAGECUSTOMNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x17006A00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareDamageCustomName_TypeDefinitionIndex = 21808;
