...
#define RPG_GAMECORE_DRINKMAKERCONTROLLER_METHOD_3_5D3BBE2FDF6F00C3_OFFSET UNITYSDK_OFFSET(0x1DB10060)
#define RPG_GAMECORE_DRINKMAKERCONTROLLER_METHOD_3_B9AE0F20709A0FE0_OFFSET UNITYSDK_OFFSET(0x1DB10020)
#define RPG_GAMECORE_DRINKMAKERCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB10050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DrinkMakerController_TypeDefinitionIndex = 20857;
