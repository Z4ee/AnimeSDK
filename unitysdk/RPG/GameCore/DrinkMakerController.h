...
#define RPG_GAMECORE_DRINKMAKERCONTROLLER_METHOD_3_5D3BBE2FDF6F00C3_OFFSET UNITYSDK_OFFSET(0x196C2110)
#define RPG_GAMECORE_DRINKMAKERCONTROLLER_METHOD_3_6E3091430C46CF05_OFFSET UNITYSDK_OFFSET(0x196C2090)
#define RPG_GAMECORE_DRINKMAKERCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x196C20E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DrinkMakerController_TypeDefinitionIndex = 19936;
