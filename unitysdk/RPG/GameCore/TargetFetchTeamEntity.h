...
#define RPG_GAMECORE_TARGETFETCHTEAMENTITY_METHOD_4_63AC109185A678FF_OFFSET UNITYSDK_OFFSET(0x18EE5DC0)
#define RPG_GAMECORE_TARGETFETCHTEAMENTITY_METHOD_4_DF28F6B6D53B0833_OFFSET UNITYSDK_OFFSET(0x18EE04A0)
#define RPG_GAMECORE_TARGETFETCHTEAMENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x18EE0450)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchTeamEntity_TypeDefinitionIndex = 22904;
