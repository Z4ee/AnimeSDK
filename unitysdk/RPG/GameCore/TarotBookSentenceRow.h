...
#define RPG_GAMECORE_TAROTBOOKSENTENCEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C142B80)
#define RPG_GAMECORE_TAROTBOOKSENTENCEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C142D40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TarotBookSentenceRow_TypeDefinitionIndex = 14628;
