...
#define RPG_GAMECORE_GRIDFIGHTCONDRANDOMCONFIG_METHOD_6_4EDE78F3DC1D302B_OFFSET UNITYSDK_OFFSET(0x189A4CF0)
#define RPG_GAMECORE_GRIDFIGHTCONDRANDOMCONFIG_METHOD_6_D292240FE3682587_OFFSET UNITYSDK_OFFSET(0x189A4EB0)
#define RPG_GAMECORE_GRIDFIGHTCONDRANDOMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189A4DF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightCondRandomConfig_TypeDefinitionIndex = 18361;
