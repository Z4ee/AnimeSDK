...
#define RPG_GAMECORE_GRIDFIGHTCONDRANDOMCONFIG_METHOD_6_06FBAB328866C203_OFFSET UNITYSDK_OFFSET(0x1C5C53E0)
#define RPG_GAMECORE_GRIDFIGHTCONDRANDOMCONFIG_METHOD_6_D292240FE3682587_OFFSET UNITYSDK_OFFSET(0x1C5C5430)
#define RPG_GAMECORE_GRIDFIGHTCONDRANDOMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5C5420)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightCondRandomConfig_TypeDefinitionIndex = 18573;
