...
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONAROOMDISPLAYCARDATTRIBUTENUMCONFIG_METHOD_6_16FB6D02E0414538_OFFSET UNITYSDK_OFFSET(0x1D176EB0)
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONAROOMDISPLAYCARDATTRIBUTENUMCONFIG_METHOD_6_BA1381A42D8197B4_OFFSET UNITYSDK_OFFSET(0x1D176F00)
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONAROOMDISPLAYCARDATTRIBUTENUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D176EF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamRoguePersonaRoomDisplayCardAttributeNumConfig_TypeDefinitionIndex = 19092;
