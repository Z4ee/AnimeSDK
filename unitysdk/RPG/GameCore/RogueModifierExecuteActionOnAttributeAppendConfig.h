...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONATTRIBUTEAPPENDCONFIG_METHOD_3_73C8842C588EAC16_OFFSET UNITYSDK_OFFSET(0x19B50D60)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONATTRIBUTEAPPENDCONFIG_METHOD_3_EDE96BF414EB44FF_OFFSET UNITYSDK_OFFSET(0x19B5C720)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONATTRIBUTEAPPENDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B50D10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnAttributeAppendConfig_TypeDefinitionIndex = 16965;
