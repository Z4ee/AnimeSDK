...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONATTRIBUTEAPPENDCONFIG_METHOD_3_73C8842C588EAC16_OFFSET UNITYSDK_OFFSET(0x1762F790)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONATTRIBUTEAPPENDCONFIG_METHOD_3_EDE96BF414EB44FF_OFFSET UNITYSDK_OFFSET(0x1762F6C0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONATTRIBUTEAPPENDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1762F740)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnAttributeAppendConfig_TypeDefinitionIndex = 16396;
