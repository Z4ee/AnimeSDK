...
#define RPG_GAMECORE_MAZEBATTLETRANSITIONCLIENTCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x198F94F0)
#define RPG_GAMECORE_MAZEBATTLETRANSITIONCLIENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x198F9760)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MazeBattleTransitionClientConfig_TypeDefinitionIndex = 16745;
