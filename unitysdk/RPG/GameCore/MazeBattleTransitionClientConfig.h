...
#define RPG_GAMECORE_MAZEBATTLETRANSITIONCLIENTCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1AF43390)
#define RPG_GAMECORE_MAZEBATTLETRANSITIONCLIENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF43600)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MazeBattleTransitionClientConfig_TypeDefinitionIndex = 16907;
