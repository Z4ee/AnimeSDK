...
#define RPG_GAMECORE_BASEADVENTURECAMERALOOKAT_METHOD_3_788438D614F85474_OFFSET UNITYSDK_OFFSET(0x1CE62150)
#define RPG_GAMECORE_BASEADVENTURECAMERALOOKAT_METHOD_3_FC5EC25EFB6A1DE9_OFFSET UNITYSDK_OFFSET(0x1CE61FD0)
#define RPG_GAMECORE_BASEADVENTURECAMERALOOKAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE62140)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BaseAdventureCameraLookAt_TypeDefinitionIndex = 23457;
