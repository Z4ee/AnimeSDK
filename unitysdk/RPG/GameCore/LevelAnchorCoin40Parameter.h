...
#define RPG_GAMECORE_LEVELANCHORCOIN40PARAMETER_METHOD_3_9D3AEEDA46093791_OFFSET UNITYSDK_OFFSET(0x1C10C150)
#define RPG_GAMECORE_LEVELANCHORCOIN40PARAMETER_METHOD_3_EC74D83CD95DBCB2_OFFSET UNITYSDK_OFFSET(0x1C10C190)
#define RPG_GAMECORE_LEVELANCHORCOIN40PARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C10C180)
