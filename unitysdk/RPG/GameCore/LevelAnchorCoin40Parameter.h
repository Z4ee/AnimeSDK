...
#define RPG_GAMECORE_LEVELANCHORCOIN40PARAMETER_METHOD_3_9D3AEEDA46093791_OFFSET UNITYSDK_OFFSET(0x1D1C8BB0)
#define RPG_GAMECORE_LEVELANCHORCOIN40PARAMETER_METHOD_3_EC74D83CD95DBCB2_OFFSET UNITYSDK_OFFSET(0x1D1C8BF0)
#define RPG_GAMECORE_LEVELANCHORCOIN40PARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1C8BE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelAnchorCoin40Parameter_TypeDefinitionIndex = 17050;
