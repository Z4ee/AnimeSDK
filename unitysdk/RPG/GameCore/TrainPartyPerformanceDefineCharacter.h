...
#define RPG_GAMECORE_TRAINPARTYPERFORMANCEDEFINECHARACTER_METHOD_3_A2B16FA177305A19_OFFSET UNITYSDK_OFFSET(0x178AE8F0)
#define RPG_GAMECORE_TRAINPARTYPERFORMANCEDEFINECHARACTER_METHOD_3_BA3E354EC6844DBF_OFFSET UNITYSDK_OFFSET(0x178AEF00)
#define RPG_GAMECORE_TRAINPARTYPERFORMANCEDEFINECHARACTER__CTOR_OFFSET UNITYSDK_OFFSET(0x178AE8E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyPerformanceDefineCharacter_TypeDefinitionIndex = 14876;
