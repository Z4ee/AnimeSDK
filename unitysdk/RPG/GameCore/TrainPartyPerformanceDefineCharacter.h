...
#define RPG_GAMECORE_TRAINPARTYPERFORMANCEDEFINECHARACTER_METHOD_3_A2B16FA177305A19_OFFSET UNITYSDK_OFFSET(0x1D5E0460)
#define RPG_GAMECORE_TRAINPARTYPERFORMANCEDEFINECHARACTER_METHOD_3_BA3E354EC6844DBF_OFFSET UNITYSDK_OFFSET(0x1D5E0A20)
#define RPG_GAMECORE_TRAINPARTYPERFORMANCEDEFINECHARACTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5E0450)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyPerformanceDefineCharacter_TypeDefinitionIndex = 16086;
