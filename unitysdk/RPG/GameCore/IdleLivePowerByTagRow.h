...
#define RPG_GAMECORE_IDLELIVEPOWERBYTAGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18A13620)
#define RPG_GAMECORE_IDLELIVEPOWERBYTAGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18A13860)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 Num; // 0x20
		::RPG::GameCore::ILBattleAvatarTag AvatarTag; // 0x24
