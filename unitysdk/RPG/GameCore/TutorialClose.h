...
#define RPG_GAMECORE_TUTORIALCLOSE_METHOD_3_50AD60D58F0954C9_OFFSET UNITYSDK_OFFSET(0x19E26D60)
#define RPG_GAMECORE_TUTORIALCLOSE_METHOD_3_CA858500375C01BD_OFFSET UNITYSDK_OFFSET(0x19E26E70)
#define RPG_GAMECORE_TUTORIALCLOSE__CTOR_OFFSET UNITYSDK_OFFSET(0x19E26E40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TutorialClose_TypeDefinitionIndex = 23029;
