...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEACTIONPOINT_METHOD_3_39513B51341790F2_OFFSET UNITYSDK_OFFSET(0x1C2E6C60)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEACTIONPOINT_METHOD_3_51B38977E394A0FF_OFFSET UNITYSDK_OFFSET(0x1C2E6C20)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEACTIONPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2E6C50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRogueActionPoint_TypeDefinitionIndex = 20978;
