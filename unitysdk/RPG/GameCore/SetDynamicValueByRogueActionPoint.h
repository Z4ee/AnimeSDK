...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEACTIONPOINT_METHOD_3_39513B51341790F2_OFFSET UNITYSDK_OFFSET(0x18E264C0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEACTIONPOINT_METHOD_3_85B3E727471C840D_OFFSET UNITYSDK_OFFSET(0x18E26450)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEACTIONPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x18E26490)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRogueActionPoint_TypeDefinitionIndex = 20630;
