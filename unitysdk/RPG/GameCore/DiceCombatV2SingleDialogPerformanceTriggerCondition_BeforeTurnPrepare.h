...
#define RPG_GAMECORE_DICECOMBATV2SINGLEDIALOGPERFORMANCETRIGGERCONDITION_BEFORETURNPREPARE_METHOD_3_85E0B5493BA97E37_OFFSET UNITYSDK_OFFSET(0x196BB740)
#define RPG_GAMECORE_DICECOMBATV2SINGLEDIALOGPERFORMANCETRIGGERCONDITION_BEFORETURNPREPARE_METHOD_3_AC6E958F98C06F83_OFFSET UNITYSDK_OFFSET(0x196BB450)
#define RPG_GAMECORE_DICECOMBATV2SINGLEDIALOGPERFORMANCETRIGGERCONDITION_BEFORETURNPREPARE__CTOR_OFFSET UNITYSDK_OFFSET(0x196BB440)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatV2SingleDialogPerformanceTriggerCondition_BeforeTurnPrepare_TypeDefinitionIndex = 15411;
