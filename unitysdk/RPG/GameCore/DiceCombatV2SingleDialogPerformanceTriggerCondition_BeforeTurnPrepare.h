...
#define RPG_GAMECORE_DICECOMBATV2SINGLEDIALOGPERFORMANCETRIGGERCONDITION_BEFORETURNPREPARE_METHOD_3_85E0B5493BA97E37_OFFSET UNITYSDK_OFFSET(0x1C11CE00)
#define RPG_GAMECORE_DICECOMBATV2SINGLEDIALOGPERFORMANCETRIGGERCONDITION_BEFORETURNPREPARE_METHOD_3_AC6E958F98C06F83_OFFSET UNITYSDK_OFFSET(0x1C11CB10)
#define RPG_GAMECORE_DICECOMBATV2SINGLEDIALOGPERFORMANCETRIGGERCONDITION_BEFORETURNPREPARE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C11CB00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatV2SingleDialogPerformanceTriggerCondition_BeforeTurnPrepare_TypeDefinitionIndex = 15575;
