...
#define RPG_GAMECORE_WAITBATTLEWINWITHTARGETCOUNT_METHOD_3_143066BDA4059FB1_OFFSET UNITYSDK_OFFSET(0x19E52680)
#define RPG_GAMECORE_WAITBATTLEWINWITHTARGETCOUNT_METHOD_3_5070C73FCF241A86_OFFSET UNITYSDK_OFFSET(0x19E526F0)
#define RPG_GAMECORE_WAITBATTLEWINWITHTARGETCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x19E526C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitBattleWinWithTargetCount_TypeDefinitionIndex = 20097;
