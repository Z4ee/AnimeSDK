...
#define RPG_GAMECORE_CAKERACEWAITCATGOTOPOSZ_METHOD_3_80875BED6952D463_OFFSET UNITYSDK_OFFSET(0x17050860)
#define RPG_GAMECORE_CAKERACEWAITCATGOTOPOSZ_METHOD_3_D2EC2DC7FA80EFD4_OFFSET UNITYSDK_OFFSET(0x170507E0)
#define RPG_GAMECORE_CAKERACEWAITCATGOTOPOSZ__CTOR_OFFSET UNITYSDK_OFFSET(0x17050830)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceWaitCatGotoPosZ_TypeDefinitionIndex = 22341;
