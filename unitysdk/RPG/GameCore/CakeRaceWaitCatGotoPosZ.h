...
#define RPG_GAMECORE_CAKERACEWAITCATGOTOPOSZ_METHOD_3_80875BED6952D463_OFFSET UNITYSDK_OFFSET(0x1B707350)
#define RPG_GAMECORE_CAKERACEWAITCATGOTOPOSZ_METHOD_3_E06AEC4BDDA9924A_OFFSET UNITYSDK_OFFSET(0x1B707310)
#define RPG_GAMECORE_CAKERACEWAITCATGOTOPOSZ__CTOR_OFFSET UNITYSDK_OFFSET(0x1B707340)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceWaitCatGotoPosZ_TypeDefinitionIndex = 23442;
