...
#define RPG_GAMECORE_BYISPROJECTILEHITTARGET_METHOD_4_59977953AECFA14E_OFFSET UNITYSDK_OFFSET(0x170312E0)
#define RPG_GAMECORE_BYISPROJECTILEHITTARGET_METHOD_4_7F861B3B4A27A120_OFFSET UNITYSDK_OFFSET(0x17031210)
#define RPG_GAMECORE_BYISPROJECTILEHITTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x17031290)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsProjectileHitTarget_TypeDefinitionIndex = 21217;
