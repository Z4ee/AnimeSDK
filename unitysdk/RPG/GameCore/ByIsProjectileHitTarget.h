...
#define RPG_GAMECORE_BYISPROJECTILEHITTARGET_METHOD_4_1F12B8DFABA1E8DA_OFFSET UNITYSDK_OFFSET(0x1B2A0A30)
#define RPG_GAMECORE_BYISPROJECTILEHITTARGET_METHOD_4_59977953AECFA14E_OFFSET UNITYSDK_OFFSET(0x1B2A08B0)
#define RPG_GAMECORE_BYISPROJECTILEHITTARGET_METHOD_4_961072AEF6F1F6B4_OFFSET UNITYSDK_OFFSET(0x1B2A0A60)
#define RPG_GAMECORE_BYISPROJECTILEHITTARGET_METHOD_4_D094DD9884C557DF_OFFSET UNITYSDK_OFFSET(0x1B2A0870)
#define RPG_GAMECORE_BYISPROJECTILEHITTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2A08A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsProjectileHitTarget_TypeDefinitionIndex = 22183;
