...
#define RPG_GAMECORE_SHOWBATTLEUI_METHOD_3_F3396D9868AF6EA8_OFFSET UNITYSDK_OFFSET(0x1BE3B240)
#define RPG_GAMECORE_SHOWBATTLEUI_METHOD_3_F5E2FC103D9BB35D_OFFSET UNITYSDK_OFFSET(0x1BE3B1F0)
#define RPG_GAMECORE_SHOWBATTLEUI__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE3B230)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowBattleUI_TypeDefinitionIndex = 21690;
