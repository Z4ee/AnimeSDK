...
#define RPG_GAMECORE_SHOWBATTLEUI_METHOD_3_623E72097950A971_OFFSET UNITYSDK_OFFSET(0x18E59F80)
#define RPG_GAMECORE_SHOWBATTLEUI_METHOD_3_F3396D9868AF6EA8_OFFSET UNITYSDK_OFFSET(0x18E5A010)
#define RPG_GAMECORE_SHOWBATTLEUI__CTOR_OFFSET UNITYSDK_OFFSET(0x18E59FE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowBattleUI_TypeDefinitionIndex = 21385;
