...
#define RPG_GAMECORE_TRIGGERMAGICUNITONSCEPTER_METHOD_3_342BAF41E2C2C9AD_OFFSET UNITYSDK_OFFSET(0x19E17030)
#define RPG_GAMECORE_TRIGGERMAGICUNITONSCEPTER_METHOD_3_49EB4AFA90B381D4_OFFSET UNITYSDK_OFFSET(0x19E16FB0)
#define RPG_GAMECORE_TRIGGERMAGICUNITONSCEPTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19E17000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerMagicUnitOnScepter_TypeDefinitionIndex = 21846;
