...
#define RPG_GAMECORE_SETLOOPREWINDSNAPSECTION_METHOD_3_1C6E65CE8D74C61B_OFFSET UNITYSDK_OFFSET(0x1D5046C0)
#define RPG_GAMECORE_SETLOOPREWINDSNAPSECTION_METHOD_3_3BFCD4F2613EDD8A_OFFSET UNITYSDK_OFFSET(0x1D504680)
#define RPG_GAMECORE_SETLOOPREWINDSNAPSECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5046B0)
