...
#define RPG_GAMECORE_CREATEPROPINTARGETFRONT_METHOD_3_7823DF2BE303CF00_OFFSET UNITYSDK_OFFSET(0x1D800170)
#define RPG_GAMECORE_CREATEPROPINTARGETFRONT_METHOD_3_E87B6F2F5B08E054_OFFSET UNITYSDK_OFFSET(0x1D800340)
#define RPG_GAMECORE_CREATEPROPINTARGETFRONT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D800270)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CreatePropInTargetFront_TypeDefinitionIndex = 19925;
	...
	public:
		...
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::CreatePropInTargetFront*))((::PBYTE)hIl2Cpp + RPG_GAMECORE_CREATEPROPINTARGETFRONT_METHOD_3_E87B6F2F5B08E054_OFFSET))(a1, a2);
		}
	};
}
