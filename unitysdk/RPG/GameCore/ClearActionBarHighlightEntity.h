...
#define RPG_GAMECORE_CLEARACTIONBARHIGHLIGHTENTITY_METHOD_3_ADDB0D0726F41EB5_OFFSET UNITYSDK_OFFSET(0x188109B0)
#define RPG_GAMECORE_CLEARACTIONBARHIGHLIGHTENTITY_METHOD_3_C79C01BEDB139444_OFFSET UNITYSDK_OFFSET(0x18810930)
#define RPG_GAMECORE_CLEARACTIONBARHIGHLIGHTENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x18810980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClearActionBarHighlightEntity_TypeDefinitionIndex = 22222;
