...
#define RPG_GAMECORE_SETACTIVITYTELEVISIONBUFFINFO_METHOD_3_6E99B8A12CD5A5D6_OFFSET UNITYSDK_OFFSET(0x18E07810)
#define RPG_GAMECORE_SETACTIVITYTELEVISIONBUFFINFO_METHOD_3_CF05392FA4E06924_OFFSET UNITYSDK_OFFSET(0x18E07930)
#define RPG_GAMECORE_SETACTIVITYTELEVISIONBUFFINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18E078B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetActivityTelevisionBuffInfo_TypeDefinitionIndex = 22208;
