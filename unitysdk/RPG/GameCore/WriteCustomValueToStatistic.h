...
#define RPG_GAMECORE_WRITECUSTOMVALUETOSTATISTIC_METHOD_3_38581A4D5E864A9B_OFFSET UNITYSDK_OFFSET(0x1D6B8C10)
#define RPG_GAMECORE_WRITECUSTOMVALUETOSTATISTIC_METHOD_3_852ADB526A6D52D2_OFFSET UNITYSDK_OFFSET(0x1D6B8C50)
#define RPG_GAMECORE_WRITECUSTOMVALUETOSTATISTIC__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6B8C40)
