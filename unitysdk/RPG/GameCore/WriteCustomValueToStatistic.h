...
#define RPG_GAMECORE_WRITECUSTOMVALUETOSTATISTIC_METHOD_3_38581A4D5E864A9B_OFFSET UNITYSDK_OFFSET(0x1D1C7A90)
#define RPG_GAMECORE_WRITECUSTOMVALUETOSTATISTIC_METHOD_3_852ADB526A6D52D2_OFFSET UNITYSDK_OFFSET(0x1D1C7AD0)
#define RPG_GAMECORE_WRITECUSTOMVALUETOSTATISTIC__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1C7AC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WriteCustomValueToStatistic_TypeDefinitionIndex = 22808;
