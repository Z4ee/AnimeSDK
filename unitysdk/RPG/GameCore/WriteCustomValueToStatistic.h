...
#define RPG_GAMECORE_WRITECUSTOMVALUETOSTATISTIC_METHOD_3_2E725623E21A6B05_OFFSET UNITYSDK_OFFSET(0x19114DB0)
#define RPG_GAMECORE_WRITECUSTOMVALUETOSTATISTIC_METHOD_3_852ADB526A6D52D2_OFFSET UNITYSDK_OFFSET(0x19114E30)
#define RPG_GAMECORE_WRITECUSTOMVALUETOSTATISTIC__CTOR_OFFSET UNITYSDK_OFFSET(0x19114E00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WriteCustomValueToStatistic_TypeDefinitionIndex = 22646;
