...
#define RPG_GAMECORE_WRITECUSTOMVALUETOSTATISTIC_METHOD_3_2E725623E21A6B05_OFFSET UNITYSDK_OFFSET(0x17910EB0)
#define RPG_GAMECORE_WRITECUSTOMVALUETOSTATISTIC_METHOD_3_852ADB526A6D52D2_OFFSET UNITYSDK_OFFSET(0x17910F30)
#define RPG_GAMECORE_WRITECUSTOMVALUETOSTATISTIC__CTOR_OFFSET UNITYSDK_OFFSET(0x17910F00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WriteCustomValueToStatistic_TypeDefinitionIndex = 21908;
