...
#define RPG_GAMECORE_STOPTIMELINE_METHOD_3_068A44B628BAA65C_OFFSET UNITYSDK_OFFSET(0x18EA4510)
#define RPG_GAMECORE_STOPTIMELINE_METHOD_3_515903F8FCB84DED_OFFSET UNITYSDK_OFFSET(0x18EA4590)
#define RPG_GAMECORE_STOPTIMELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x18EA4560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StopTimeline_TypeDefinitionIndex = 19594;
