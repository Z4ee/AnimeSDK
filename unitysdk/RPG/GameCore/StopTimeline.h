...
#define RPG_GAMECORE_STOPTIMELINE_METHOD_3_515903F8FCB84DED_OFFSET UNITYSDK_OFFSET(0x1B0C6990)
#define RPG_GAMECORE_STOPTIMELINE_METHOD_3_B21D5A73996DBD2E_OFFSET UNITYSDK_OFFSET(0x1B0C6950)
#define RPG_GAMECORE_STOPTIMELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0C6980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StopTimeline_TypeDefinitionIndex = 19839;
