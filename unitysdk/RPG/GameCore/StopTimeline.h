...
#define RPG_GAMECORE_STOPTIMELINE_METHOD_3_068A44B628BAA65C_OFFSET UNITYSDK_OFFSET(0x1777E730)
#define RPG_GAMECORE_STOPTIMELINE_METHOD_3_515903F8FCB84DED_OFFSET UNITYSDK_OFFSET(0x1777E7B0)
#define RPG_GAMECORE_STOPTIMELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1777E780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StopTimeline_TypeDefinitionIndex = 18936;
