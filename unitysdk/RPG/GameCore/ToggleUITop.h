...
#define RPG_GAMECORE_TOGGLEUITOP_METHOD_3_23B9F6B3375735B6_OFFSET UNITYSDK_OFFSET(0x178A2630)
#define RPG_GAMECORE_TOGGLEUITOP_METHOD_3_41CE313E932D932D_OFFSET UNITYSDK_OFFSET(0x1788B600)
#define RPG_GAMECORE_TOGGLEUITOP__CTOR_OFFSET UNITYSDK_OFFSET(0x1788B5B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ToggleUITop_TypeDefinitionIndex = 21387;
