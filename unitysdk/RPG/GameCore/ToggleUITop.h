...
#define RPG_GAMECORE_TOGGLEUITOP_METHOD_3_1D42A66ED10B6672_OFFSET UNITYSDK_OFFSET(0x1C157A70)
#define RPG_GAMECORE_TOGGLEUITOP_METHOD_3_F5A5E7C4631539C2_OFFSET UNITYSDK_OFFSET(0x1C1579D0)
#define RPG_GAMECORE_TOGGLEUITOP__CTOR_OFFSET UNITYSDK_OFFSET(0x1C157A30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ToggleUITop_TypeDefinitionIndex = 22325;
