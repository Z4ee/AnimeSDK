...
#define RPG_GAMECORE_ROGUEACTPERSONAOWNERROOMCARDCASTLEVELCHANGECONFIG_METHOD_7_D67999CFABD507CA_OFFSET UNITYSDK_OFFSET(0x1D02F6E0)
#define RPG_GAMECORE_ROGUEACTPERSONAOWNERROOMCARDCASTLEVELCHANGECONFIG_METHOD_7_DC5B230001B1C826_OFFSET UNITYSDK_OFFSET(0x1D02F620)
#define RPG_GAMECORE_ROGUEACTPERSONAOWNERROOMCARDCASTLEVELCHANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D02F610)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaOwnerRoomCardCastLevelChangeConfig_TypeDefinitionIndex = 18995;
