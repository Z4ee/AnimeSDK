...
#define RPG_GAMECORE_ROGUEACTPERSONAOWNERROOMCARDCASTLEVELCHANGECONFIG_METHOD_7_DC5B230001B1C826_OFFSET UNITYSDK_OFFSET(0x175BDD80)
#define RPG_GAMECORE_ROGUEACTPERSONAOWNERROOMCARDCASTLEVELCHANGECONFIG_METHOD_7_EE51B19BE1D5E083_OFFSET UNITYSDK_OFFSET(0x175BE250)
#define RPG_GAMECORE_ROGUEACTPERSONAOWNERROOMCARDCASTLEVELCHANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175BDCA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaOwnerRoomCardCastLevelChangeConfig_TypeDefinitionIndex = 18107;
