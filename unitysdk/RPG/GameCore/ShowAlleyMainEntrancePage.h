...
#define RPG_GAMECORE_SHOWALLEYMAINENTRANCEPAGE_METHOD_3_0BC5D5DC144CE6B5_OFFSET UNITYSDK_OFFSET(0x176F3E90)
#define RPG_GAMECORE_SHOWALLEYMAINENTRANCEPAGE_METHOD_3_ED689718DD457AB3_OFFSET UNITYSDK_OFFSET(0x176F3F10)
#define RPG_GAMECORE_SHOWALLEYMAINENTRANCEPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x176F3EE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowAlleyMainEntrancePage_TypeDefinitionIndex = 19440;
