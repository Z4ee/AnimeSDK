...
#define RPG_GAMECORE_LITTLEGAMEWAYPOINTGRAPHCONFIG_METHOD_3_72BE9C5E1D7E7202_OFFSET UNITYSDK_OFFSET(0x1D206ED0)
#define RPG_GAMECORE_LITTLEGAMEWAYPOINTGRAPHCONFIG_METHOD_3_789A7BC8B046F2BE_OFFSET UNITYSDK_OFFSET(0x1D206F40)
#define RPG_GAMECORE_LITTLEGAMEWAYPOINTGRAPHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D206F30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameWayPointGraphConfig_TypeDefinitionIndex = 18656;
