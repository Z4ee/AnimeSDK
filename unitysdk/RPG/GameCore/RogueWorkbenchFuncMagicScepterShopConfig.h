...
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCMAGICSCEPTERSHOPCONFIG_METHOD_3_07885B1F7B6F446B_OFFSET UNITYSDK_OFFSET(0x19BD4330)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCMAGICSCEPTERSHOPCONFIG_METHOD_3_B5065799C68CDBC7_OFFSET UNITYSDK_OFFSET(0x19BD4590)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCMAGICSCEPTERSHOPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19BD4320)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueWorkbenchFuncMagicScepterShopConfig_TypeDefinitionIndex = 17136;
