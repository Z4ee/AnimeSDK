...
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCMAGICSCEPTERSHOPCONFIG_METHOD_3_07885B1F7B6F446B_OFFSET UNITYSDK_OFFSET(0x1CCD0440)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCMAGICSCEPTERSHOPCONFIG_METHOD_3_B5065799C68CDBC7_OFFSET UNITYSDK_OFFSET(0x1CCD06A0)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCMAGICSCEPTERSHOPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CCD0430)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueWorkbenchFuncMagicScepterShopConfig_TypeDefinitionIndex = 17815;
