...
#define RPG_GAMECORE_RTDEFENCEBACKGROUNDUNITINFO_METHOD_2_37F1BB344FD337CB_OFFSET UNITYSDK_OFFSET(0x1B75F560)
#define RPG_GAMECORE_RTDEFENCEBACKGROUNDUNITINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B75F760)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtDefenceBackgroundUnitInfo_TypeDefinitionIndex = 17336;
