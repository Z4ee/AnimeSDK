...
#define RPG_GAMECORE_SHOWUIPAGE_METHOD_3_CF802499BF115A7D_OFFSET UNITYSDK_OFFSET(0x18E6AD80)
#define RPG_GAMECORE_SHOWUIPAGE_METHOD_3_F7D9A1BCA0F8AA59_OFFSET UNITYSDK_OFFSET(0x18E6AD00)
#define RPG_GAMECORE_SHOWUIPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E6AD50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowUIPage_TypeDefinitionIndex = 22834;
