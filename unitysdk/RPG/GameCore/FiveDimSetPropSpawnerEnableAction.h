...
#define RPG_GAMECORE_FIVEDIMSETPROPSPAWNERENABLEACTION_METHOD_3_505FDDF2550B811A_OFFSET UNITYSDK_OFFSET(0x1D879C50)
#define RPG_GAMECORE_FIVEDIMSETPROPSPAWNERENABLEACTION_METHOD_3_8B6DFADCB211FB91_OFFSET UNITYSDK_OFFSET(0x1D879C10)
#define RPG_GAMECORE_FIVEDIMSETPROPSPAWNERENABLEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D879C40)
