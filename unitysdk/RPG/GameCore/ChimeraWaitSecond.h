...
#define RPG_GAMECORE_CHIMERAWAITSECOND_METHOD_3_48189F71CA6B8A14_OFFSET UNITYSDK_OFFSET(0x1880C230)
#define RPG_GAMECORE_CHIMERAWAITSECOND_METHOD_3_EFDA6EC0796B956E_OFFSET UNITYSDK_OFFSET(0x1880C1D0)
#define RPG_GAMECORE_CHIMERAWAITSECOND__CTOR_OFFSET UNITYSDK_OFFSET(0x1880C220)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraWaitSecond_TypeDefinitionIndex = 15023;
