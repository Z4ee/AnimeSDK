...
#define RPG_GAMECORE_ACTIVITYDICECOMBATSHOPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18609720)
#define RPG_GAMECORE_ACTIVITYDICECOMBATSHOPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18609970)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityDiceCombatShopRow_TypeDefinitionIndex = 10749;
	...
	public:
		...
		::System::UInt32 DiceShopID; // 0x20
		::System::UInt32 ShopSortID; // 0x24
