...
#define RPG_GAMECORE_INFINITEWAVENEXTMONSTERID_METHOD_3_0D1F0B4DB709D303_OFFSET UNITYSDK_OFFSET(0x1984EF20)
#define RPG_GAMECORE_INFINITEWAVENEXTMONSTERID_METHOD_3_F037ABBC15D2C8B6_OFFSET UNITYSDK_OFFSET(0x1984EFA0)
#define RPG_GAMECORE_INFINITEWAVENEXTMONSTERID__CTOR_OFFSET UNITYSDK_OFFSET(0x1984EF70)
