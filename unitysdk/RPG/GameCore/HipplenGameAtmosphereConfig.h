...
#define RPG_GAMECORE_HIPPLENGAMEATMOSPHERECONFIG_METHOD_2_016FC56D324233D2_OFFSET UNITYSDK_OFFSET(0x1B6861B0)
#define RPG_GAMECORE_HIPPLENGAMEATMOSPHERECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B686520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HipplenGameAtmosphereConfig_TypeDefinitionIndex = 16123;
