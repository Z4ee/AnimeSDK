...
#define RPG_GAMECORE_HIPPLENGAMEATMOSPHERECONFIG_METHOD_2_11E56DBDAF9DB277_OFFSET UNITYSDK_OFFSET(0x172AC690)
#define RPG_GAMECORE_HIPPLENGAMEATMOSPHERECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x172ACA40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HipplenGameAtmosphereConfig_TypeDefinitionIndex = 15368;
