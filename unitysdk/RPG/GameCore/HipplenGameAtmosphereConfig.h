...
#define RPG_GAMECORE_HIPPLENGAMEATMOSPHERECONFIG_METHOD_2_016FC56D324233D2_OFFSET UNITYSDK_OFFSET(0x1D18FC10)
#define RPG_GAMECORE_HIPPLENGAMEATMOSPHERECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D18FF80)
