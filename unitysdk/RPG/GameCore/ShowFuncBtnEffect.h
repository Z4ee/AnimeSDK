...
#define RPG_GAMECORE_SHOWFUNCBTNEFFECT_METHOD_3_5E90A06F0BCB4AD2_OFFSET UNITYSDK_OFFSET(0x1D093390)
#define RPG_GAMECORE_SHOWFUNCBTNEFFECT_METHOD_3_B1401F1419EBB249_OFFSET UNITYSDK_OFFSET(0x1D093340)
#define RPG_GAMECORE_SHOWFUNCBTNEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D093380)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowFuncBtnEffect_TypeDefinitionIndex = 20260;
