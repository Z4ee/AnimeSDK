...
#define RPG_GAMECORE_SHOWFUNCBTNEFFECT_METHOD_3_06F1A774963AAA7B_OFFSET UNITYSDK_OFFSET(0x176FB670)
#define RPG_GAMECORE_SHOWFUNCBTNEFFECT_METHOD_3_5E90A06F0BCB4AD2_OFFSET UNITYSDK_OFFSET(0x176FB6F0)
#define RPG_GAMECORE_SHOWFUNCBTNEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x176FB6C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowFuncBtnEffect_TypeDefinitionIndex = 18796;
