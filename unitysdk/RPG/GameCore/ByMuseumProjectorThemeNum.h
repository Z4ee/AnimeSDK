...
#define RPG_GAMECORE_BYMUSEUMPROJECTORTHEMENUM_METHOD_4_217730BDDA66FFFE_OFFSET UNITYSDK_OFFSET(0x1CDB7BB0)
#define RPG_GAMECORE_BYMUSEUMPROJECTORTHEMENUM_METHOD_4_25B874263C7A1DAC_OFFSET UNITYSDK_OFFSET(0x1CDB79D0)
#define RPG_GAMECORE_BYMUSEUMPROJECTORTHEMENUM_METHOD_4_C4927A9BE1AE9AF0_OFFSET UNITYSDK_OFFSET(0x1CDB7B80)
#define RPG_GAMECORE_BYMUSEUMPROJECTORTHEMENUM_METHOD_4_C8E7C089C86DD9ED_OFFSET UNITYSDK_OFFSET(0x1CDB7990)
#define RPG_GAMECORE_BYMUSEUMPROJECTORTHEMENUM__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDB79C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByMuseumProjectorThemeNum_TypeDefinitionIndex = 20314;
