...
#define RPG_GAMECORE_SHOWBATTLEWHITEBOXIMAGE_METHOD_3_98EF2789A9D22F20_OFFSET UNITYSDK_OFFSET(0x1E0A4880)
#define RPG_GAMECORE_SHOWBATTLEWHITEBOXIMAGE_METHOD_3_B8B945CCA5D2DD05_OFFSET UNITYSDK_OFFSET(0x1E0A48C0)
#define RPG_GAMECORE_SHOWBATTLEWHITEBOXIMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0A48B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowBattleWhiteboxImage_TypeDefinitionIndex = 23034;
