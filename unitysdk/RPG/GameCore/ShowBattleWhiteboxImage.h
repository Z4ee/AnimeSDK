...
#define RPG_GAMECORE_SHOWBATTLEWHITEBOXIMAGE_METHOD_3_09F544D5628DAD54_OFFSET UNITYSDK_OFFSET(0x19C767B0)
#define RPG_GAMECORE_SHOWBATTLEWHITEBOXIMAGE_METHOD_3_B8B945CCA5D2DD05_OFFSET UNITYSDK_OFFSET(0x19C76830)
#define RPG_GAMECORE_SHOWBATTLEWHITEBOXIMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C76800)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowBattleWhiteboxImage_TypeDefinitionIndex = 22026;
