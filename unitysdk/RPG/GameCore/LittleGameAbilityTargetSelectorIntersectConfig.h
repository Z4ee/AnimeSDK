...
#define RPG_GAMECORE_LITTLEGAMEABILITYTARGETSELECTORINTERSECTCONFIG_METHOD_3_63BE27A756B87CB8_OFFSET UNITYSDK_OFFSET(0x1B095A20)
#define RPG_GAMECORE_LITTLEGAMEABILITYTARGETSELECTORINTERSECTCONFIG_METHOD_3_D739E0FFB795BDC8_OFFSET UNITYSDK_OFFSET(0x1B095A80)
#define RPG_GAMECORE_LITTLEGAMEABILITYTARGETSELECTORINTERSECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B095A70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityTargetSelectorIntersectConfig_TypeDefinitionIndex = 20571;
