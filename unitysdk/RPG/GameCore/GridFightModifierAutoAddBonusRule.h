...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERAUTOADDBONUSRULE_METHOD_2_11D22C4DC16F1298_OFFSET UNITYSDK_OFFSET(0x189B1C40)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERAUTOADDBONUSRULE__CTOR_OFFSET UNITYSDK_OFFSET(0x189B1C80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierAutoAddBonusRule_TypeDefinitionIndex = 18421;
