...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERAUTOADDBONUSRULE_METHOD_2_11D22C4DC16F1298_OFFSET UNITYSDK_OFFSET(0x1EE6CA50)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERAUTOADDBONUSRULE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EE6CA90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierAutoAddBonusRule_TypeDefinitionIndex = 19163;
