...
#define RPG_GAMECORE_LEVELEVOLVEBUILDFORGE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xA98A5A0)
#define RPG_GAMECORE_LEVELEVOLVEBUILDFORGE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xA98A550)
#define RPG_GAMECORE_LEVELEVOLVEBUILDFORGE_INIT_OFFSET UNITYSDK_OFFSET(0xA98A510)
#define RPG_GAMECORE_LEVELEVOLVEBUILDFORGE__CTOR_OFFSET UNITYSDK_OFFSET(0xA98A5F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelEvolveBuildForge_TypeDefinitionIndex = 45725;
