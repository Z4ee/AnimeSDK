...
#define RPG_GAMECORE_BYCOMPAREMISSIONCUSTOMVALUE_METHOD_4_7605545FDCA9D7BA_OFFSET UNITYSDK_OFFSET(0x1700EA70)
#define RPG_GAMECORE_BYCOMPAREMISSIONCUSTOMVALUE_METHOD_4_79BC103FE8AF0010_OFFSET UNITYSDK_OFFSET(0x1700E990)
#define RPG_GAMECORE_BYCOMPAREMISSIONCUSTOMVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1700EA10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareMissionCustomValue_TypeDefinitionIndex = 18735;
