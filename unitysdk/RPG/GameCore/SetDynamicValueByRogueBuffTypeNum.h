...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEBUFFTYPENUM_METHOD_3_2F53D63F69446965_OFFSET UNITYSDK_OFFSET(0x1C2E6F10)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEBUFFTYPENUM_METHOD_3_BAB44E7B0D7C4AD8_OFFSET UNITYSDK_OFFSET(0x1C2E6ED0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEBUFFTYPENUM__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2E6F00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRogueBuffTypeNum_TypeDefinitionIndex = 20969;
