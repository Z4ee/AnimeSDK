...
#define RPG_GAMECORE_BASECHIMERADUELNODE_METHOD_2_1EEB6A366F108747_OFFSET UNITYSDK_OFFSET(0x1A3DF5E0)
#define RPG_GAMECORE_BASECHIMERADUELNODE_METHOD_2_DD6E5709256402FE_OFFSET UNITYSDK_OFFSET(0x1A3DF580)
#define RPG_GAMECORE_BASECHIMERADUELNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3DF640)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BaseChimeraDuelNode_TypeDefinitionIndex = 15335;
