...
#define RPG_GAMECORE_SWITCHCHALLENGEBOSSINFOPANELSTATE_METHOD_3_062806601C361078_OFFSET UNITYSDK_OFFSET(0x1B434AC0)
#define RPG_GAMECORE_SWITCHCHALLENGEBOSSINFOPANELSTATE_METHOD_3_FA41FC885F08D0ED_OFFSET UNITYSDK_OFFSET(0x1B434B00)
#define RPG_GAMECORE_SWITCHCHALLENGEBOSSINFOPANELSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B434AF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchChallengeBossInfoPanelState_TypeDefinitionIndex = 22385;
