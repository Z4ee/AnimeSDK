...
#define RPG_GAMECORE_SWITCHCHALLENGEBOSSINFOPANELSTATE_METHOD_3_18A43B3D6F227AEE_OFFSET UNITYSDK_OFFSET(0x19CD9210)
#define RPG_GAMECORE_SWITCHCHALLENGEBOSSINFOPANELSTATE_METHOD_3_FA41FC885F08D0ED_OFFSET UNITYSDK_OFFSET(0x19CD9290)
#define RPG_GAMECORE_SWITCHCHALLENGEBOSSINFOPANELSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19CD9260)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchChallengeBossInfoPanelState_TypeDefinitionIndex = 21951;
