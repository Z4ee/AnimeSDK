...
#define RPG_GAMECORE_SWITCHCHALLENGEBOSSINFOPANELSTATE_METHOD_3_18A43B3D6F227AEE_OFFSET UNITYSDK_OFFSET(0x17793180)
#define RPG_GAMECORE_SWITCHCHALLENGEBOSSINFOPANELSTATE_METHOD_3_FA41FC885F08D0ED_OFFSET UNITYSDK_OFFSET(0x17793200)
#define RPG_GAMECORE_SWITCHCHALLENGEBOSSINFOPANELSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x177931D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchChallengeBossInfoPanelState_TypeDefinitionIndex = 21436;
