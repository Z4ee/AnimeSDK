...
#define RPG_GAMECORE_CHENLINGCARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C380D40)
#define RPG_GAMECORE_CHENLINGCARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3810B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingCardRow_TypeDefinitionIndex = 10651;
	...
	public:
		...
		::System::Boolean IsSpecialCard; // 0x34
		::System::UInt32 ID; // 0x38
		::System::UInt32 ShopCost; // 0x3C
		::System::UInt32 Weight; // 0x40
		::RPG::GameCore::ChenLingCardType Type; // 0x44
