...
#define RPG_GAMECORE_RTRECTSHAPECONFIG_METHOD_3_2C1BB56590FB1A60_OFFSET UNITYSDK_OFFSET(0x1B768440)
#define RPG_GAMECORE_RTRECTSHAPECONFIG_METHOD_3_3FE7DB56596427A7_OFFSET UNITYSDK_OFFSET(0x1B7684F0)
#define RPG_GAMECORE_RTRECTSHAPECONFIG_METHOD_3_5638064EFEFB10A2_OFFSET UNITYSDK_OFFSET(0x1B75D840)
#define RPG_GAMECORE_RTRECTSHAPECONFIG_METHOD_3_EC72B2FDEFF21D74_OFFSET UNITYSDK_OFFSET(0x1B75DEB0)
#define RPG_GAMECORE_RTRECTSHAPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B75D7B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtRectShapeConfig_TypeDefinitionIndex = 16942;
