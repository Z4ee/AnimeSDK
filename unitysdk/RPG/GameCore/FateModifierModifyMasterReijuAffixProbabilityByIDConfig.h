...
#define RPG_GAMECORE_FATEMODIFIERMODIFYMASTERREIJUAFFIXPROBABILITYBYIDCONFIG_METHOD_3_26667A81BBDA7F35_OFFSET UNITYSDK_OFFSET(0x171C8E00)
#define RPG_GAMECORE_FATEMODIFIERMODIFYMASTERREIJUAFFIXPROBABILITYBYIDCONFIG_METHOD_3_8091279310EC8E6C_OFFSET UNITYSDK_OFFSET(0x171C7EE0)
#define RPG_GAMECORE_FATEMODIFIERMODIFYMASTERREIJUAFFIXPROBABILITYBYIDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171C7E90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateModifierModifyMasterReijuAffixProbabilityByIDConfig_TypeDefinitionIndex = 17701;
