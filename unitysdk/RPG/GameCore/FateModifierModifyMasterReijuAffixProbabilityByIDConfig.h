...
#define RPG_GAMECORE_FATEMODIFIERMODIFYMASTERREIJUAFFIXPROBABILITYBYIDCONFIG_METHOD_3_8091279310EC8E6C_OFFSET UNITYSDK_OFFSET(0x1C0752E0)
#define RPG_GAMECORE_FATEMODIFIERMODIFYMASTERREIJUAFFIXPROBABILITYBYIDCONFIG_METHOD_3_D8A193E8306B7C70_OFFSET UNITYSDK_OFFSET(0x1C075290)
#define RPG_GAMECORE_FATEMODIFIERMODIFYMASTERREIJUAFFIXPROBABILITYBYIDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0752D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateModifierModifyMasterReijuAffixProbabilityByIDConfig_TypeDefinitionIndex = 18521;
