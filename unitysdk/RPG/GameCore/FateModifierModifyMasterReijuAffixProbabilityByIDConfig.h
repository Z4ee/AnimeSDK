...
#define RPG_GAMECORE_FATEMODIFIERMODIFYMASTERREIJUAFFIXPROBABILITYBYIDCONFIG_METHOD_3_26667A81BBDA7F35_OFFSET UNITYSDK_OFFSET(0x188D65D0)
#define RPG_GAMECORE_FATEMODIFIERMODIFYMASTERREIJUAFFIXPROBABILITYBYIDCONFIG_METHOD_3_8091279310EC8E6C_OFFSET UNITYSDK_OFFSET(0x188D56B0)
#define RPG_GAMECORE_FATEMODIFIERMODIFYMASTERREIJUAFFIXPROBABILITYBYIDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x188D5660)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateModifierModifyMasterReijuAffixProbabilityByIDConfig_TypeDefinitionIndex = 18314;
