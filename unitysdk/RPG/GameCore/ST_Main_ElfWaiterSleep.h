...
#define RPG_GAMECORE_ST_MAIN_ELFWAITERSLEEP_METHOD_4_3740BC2DAD52ADBF_OFFSET UNITYSDK_OFFSET(0x18DE8470)
#define RPG_GAMECORE_ST_MAIN_ELFWAITERSLEEP_METHOD_4_65F23FDF5A4ADB95_OFFSET UNITYSDK_OFFSET(0x18DF0750)
#define RPG_GAMECORE_ST_MAIN_ELFWAITERSLEEP__CTOR_OFFSET UNITYSDK_OFFSET(0x18DE8420)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_ElfWaiterSleep_TypeDefinitionIndex = 20386;
