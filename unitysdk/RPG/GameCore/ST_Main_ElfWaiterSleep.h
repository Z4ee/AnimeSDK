...
#define RPG_GAMECORE_ST_MAIN_ELFWAITERSLEEP_METHOD_4_3740BC2DAD52ADBF_OFFSET UNITYSDK_OFFSET(0x1DB3C870)
#define RPG_GAMECORE_ST_MAIN_ELFWAITERSLEEP_METHOD_4_6FBBDCB71BE51BA4_OFFSET UNITYSDK_OFFSET(0x1DB3C830)
#define RPG_GAMECORE_ST_MAIN_ELFWAITERSLEEP__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB3C860)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_ElfWaiterSleep_TypeDefinitionIndex = 21281;
