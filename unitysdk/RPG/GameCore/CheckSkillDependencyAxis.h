...
#define RPG_GAMECORE_CHECKSKILLDEPENDENCYAXIS_METHOD_3_0B226F08DEA992BF_OFFSET UNITYSDK_OFFSET(0x1B72EA80)
#define RPG_GAMECORE_CHECKSKILLDEPENDENCYAXIS_METHOD_3_D13E192B2084BE1A_OFFSET UNITYSDK_OFFSET(0x1B72EA40)
#define RPG_GAMECORE_CHECKSKILLDEPENDENCYAXIS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B72EA70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CheckSkillDependencyAxis_TypeDefinitionIndex = 14900;
