...
#define RPG_GAMECORE_TIMEREWINDFORBIDSELECT_METHOD_3_1B814A44AFC840E6_OFFSET UNITYSDK_OFFSET(0x1D5D0580)
#define RPG_GAMECORE_TIMEREWINDFORBIDSELECT_METHOD_3_96EA2A0BCBF5B8C7_OFFSET UNITYSDK_OFFSET(0x1D5D05C0)
#define RPG_GAMECORE_TIMEREWINDFORBIDSELECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5D05B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TimeRewindForbidSelect_TypeDefinitionIndex = 20428;
