...
#define RPG_GAMECORE_TIMEREWINDFORBIDSELECT_METHOD_3_96EA2A0BCBF5B8C7_OFFSET UNITYSDK_OFFSET(0x178890E0)
#define RPG_GAMECORE_TIMEREWINDFORBIDSELECT_METHOD_3_E8279BB9CF15B87E_OFFSET UNITYSDK_OFFSET(0x1789F830)
#define RPG_GAMECORE_TIMEREWINDFORBIDSELECT__CTOR_OFFSET UNITYSDK_OFFSET(0x178890B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TimeRewindForbidSelect_TypeDefinitionIndex = 18982;
