...
#define RPG_GAMECORE_LEVELTURNULTRASKILLEND_GETCASTENTITY_OFFSET UNITYSDK_OFFSET(0xCE4FB70)
#define RPG_GAMECORE_LEVELTURNULTRASKILLEND_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xCE4FB20)
#define RPG_GAMECORE_LEVELTURNULTRASKILLEND_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xCE4FAD0)
#define RPG_GAMECORE_LEVELTURNULTRASKILLEND_GETTURNCOUNTER_OFFSET UNITYSDK_OFFSET(0xCE4FBB0)
#define RPG_GAMECORE_LEVELTURNULTRASKILLEND_GET_TURNINSERTULTRASKILLPARAMS_OFFSET UNITYSDK_OFFSET(0xCE4FBF0)
#define RPG_GAMECORE_LEVELTURNULTRASKILLEND_SET_TURNINSERTULTRASKILLPARAMS_OFFSET UNITYSDK_OFFSET(0xCE4FC00)
#define RPG_GAMECORE_LEVELTURNULTRASKILLEND__CTOR_OFFSET UNITYSDK_OFFSET(0xCE4FAC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelTurnUltraSkillEnd_TypeDefinitionIndex = 52970;
