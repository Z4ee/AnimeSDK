...
#define RPG_GAMECORE_PINGPONGRACKETCONFIG_METHOD_2_34510EEC971BE1F9_OFFSET UNITYSDK_OFFSET(0x174B11C0)
#define RPG_GAMECORE_PINGPONGRACKETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x174B25C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PingPongRacketConfig_TypeDefinitionIndex = 15546;
