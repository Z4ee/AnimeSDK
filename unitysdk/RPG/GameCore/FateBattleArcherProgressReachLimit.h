...
#define RPG_GAMECORE_FATEBATTLEARCHERPROGRESSREACHLIMIT_METHOD_3_471D4ACA8A3D9ABD_OFFSET UNITYSDK_OFFSET(0x188D14A0)
#define RPG_GAMECORE_FATEBATTLEARCHERPROGRESSREACHLIMIT_METHOD_3_9320DFB44E1B62AC_OFFSET UNITYSDK_OFFSET(0x188D1520)
#define RPG_GAMECORE_FATEBATTLEARCHERPROGRESSREACHLIMIT__CTOR_OFFSET UNITYSDK_OFFSET(0x188D14F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateBattleArcherProgressReachLimit_TypeDefinitionIndex = 22267;
