...
#define RPG_GAMECORE_UNLOADLITTLEGAMEAREA_METHOD_3_94FC5B64EBD94EF0_OFFSET UNITYSDK_OFFSET(0x178E6FE0)
#define RPG_GAMECORE_UNLOADLITTLEGAMEAREA_METHOD_3_B624C2FE75A1A29E_OFFSET UNITYSDK_OFFSET(0x178E7130)
#define RPG_GAMECORE_UNLOADLITTLEGAMEAREA__CTOR_OFFSET UNITYSDK_OFFSET(0x178E70A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UnloadLittleGameArea_TypeDefinitionIndex = 19322;
