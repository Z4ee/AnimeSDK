...
#define RPG_GAMECORE_PROPFASTDELIVERSTARTAIM_METHOD_3_3917215826F7A2FB_OFFSET UNITYSDK_OFFSET(0x1BA22DA0)
#define RPG_GAMECORE_PROPFASTDELIVERSTARTAIM_METHOD_3_91BB5A48DD9744DB_OFFSET UNITYSDK_OFFSET(0x1BA22E20)
#define RPG_GAMECORE_PROPFASTDELIVERSTARTAIM__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA22DF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropFastDeliverStartAim_TypeDefinitionIndex = 21354;
