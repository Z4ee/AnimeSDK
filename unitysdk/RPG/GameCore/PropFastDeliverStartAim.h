...
#define RPG_GAMECORE_PROPFASTDELIVERSTARTAIM_METHOD_3_91BB5A48DD9744DB_OFFSET UNITYSDK_OFFSET(0x18C6DF20)
#define RPG_GAMECORE_PROPFASTDELIVERSTARTAIM_METHOD_3_9E2199BE99BE22E5_OFFSET UNITYSDK_OFFSET(0x18C6DDD0)
#define RPG_GAMECORE_PROPFASTDELIVERSTARTAIM__CTOR_OFFSET UNITYSDK_OFFSET(0x18C6DE90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropFastDeliverStartAim_TypeDefinitionIndex = 21030;
