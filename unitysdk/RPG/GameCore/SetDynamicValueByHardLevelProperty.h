...
#define RPG_GAMECORE_SETDYNAMICVALUEBYHARDLEVELPROPERTY_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1C2E3AC0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYHARDLEVELPROPERTY_METHOD_4_18010F47A3F270CE_OFFSET UNITYSDK_OFFSET(0x1C2E3890)
#define RPG_GAMECORE_SETDYNAMICVALUEBYHARDLEVELPROPERTY_METHOD_4_9F542E81DF93BDFB_OFFSET UNITYSDK_OFFSET(0x1C2E38D0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYHARDLEVELPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2E38C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByHardLevelProperty_TypeDefinitionIndex = 22747;
