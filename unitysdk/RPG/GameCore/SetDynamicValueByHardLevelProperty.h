...
#define RPG_GAMECORE_SETDYNAMICVALUEBYHARDLEVELPROPERTY_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x176C1FA0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYHARDLEVELPROPERTY_METHOD_4_9F542E81DF93BDFB_OFFSET UNITYSDK_OFFSET(0x176BC8F0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYHARDLEVELPROPERTY_METHOD_4_CAD668698804C0A3_OFFSET UNITYSDK_OFFSET(0x176C1F20)
#define RPG_GAMECORE_SETDYNAMICVALUEBYHARDLEVELPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x176BC8A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByHardLevelProperty_TypeDefinitionIndex = 21831;
