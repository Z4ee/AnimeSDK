...
#define RPG_GAMECORE_LEVELNAVGRAPHINFO_DISPOSE_OFFSET UNITYSDK_OFFSET(0x3B78740)
#define RPG_GAMECORE_LEVELNAVGRAPHINFO_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x3B8A4B0)
#define RPG_GAMECORE_LEVELNAVGRAPHINFO_EQUALS_OFFSET UNITYSDK_OFFSET(0x2F10A00)
#define RPG_GAMECORE_LEVELNAVGRAPHINFO_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x2F3A950)
#define RPG_GAMECORE_LEVELNAVGRAPHINFO_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x2F3A750)
#define RPG_GAMECORE_LEVELNAVGRAPHINFO_GET_NAVNODELIST_OFFSET UNITYSDK_OFFSET(0x3B8A4C0)
#define RPG_GAMECORE_LEVELNAVGRAPHINFO_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0xDAB0)
#define RPG_GAMECORE_LEVELNAVGRAPHINFO_GET_POOL_OFFSET UNITYSDK_OFFSET(0x5AB0)
#define RPG_GAMECORE_LEVELNAVGRAPHINFO_INIT_OFFSET UNITYSDK_OFFSET(0x8EB60)
#define RPG_GAMECORE_LEVELNAVGRAPHINFO_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1D1DBB40)
#define RPG_GAMECORE_LEVELNAVGRAPHINFO_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1D1DBE90)
#define RPG_GAMECORE_LEVELNAVGRAPHINFO_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1D1DBC30)
#define RPG_GAMECORE_LEVELNAVGRAPHINFO_OP_LOGICALNOT_OFFSET UNITYSDK_OFFSET(0x1D1DBF40)
#define RPG_GAMECORE_LEVELNAVGRAPHINFO_SET_NAVNODELIST_OFFSET UNITYSDK_OFFSET(0x3B8A4E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelNavGraphInfo_TypeDefinitionIndex = 10700;
