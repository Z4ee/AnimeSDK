...
#define RPG_GAMECORE_REFRESHFORMATIONCENTER_METHOD_3_46854D0971EFD666_OFFSET UNITYSDK_OFFSET(0x1D38FEF0)
#define RPG_GAMECORE_REFRESHFORMATIONCENTER_METHOD_3_6BD2E44E52A5ABA5_OFFSET UNITYSDK_OFFSET(0x1D38FF30)
#define RPG_GAMECORE_REFRESHFORMATIONCENTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D38FF20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RefreshFormationCenter_TypeDefinitionIndex = 22658;
