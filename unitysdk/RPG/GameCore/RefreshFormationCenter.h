...
#define RPG_GAMECORE_REFRESHFORMATIONCENTER_METHOD_3_02D88F0894B9EF34_OFFSET UNITYSDK_OFFSET(0x19AB93A0)
#define RPG_GAMECORE_REFRESHFORMATIONCENTER_METHOD_3_6BD2E44E52A5ABA5_OFFSET UNITYSDK_OFFSET(0x19AB9420)
#define RPG_GAMECORE_REFRESHFORMATIONCENTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19AB93F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RefreshFormationCenter_TypeDefinitionIndex = 21664;
