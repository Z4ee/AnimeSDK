...
#define RPG_GAMECORE_SHOWHEARTDIALTOAST_METHOD_3_591A50D4BD740FF6_OFFSET UNITYSDK_OFFSET(0x1BE42D10)
#define RPG_GAMECORE_SHOWHEARTDIALTOAST_METHOD_3_7DE2252DE27F85E1_OFFSET UNITYSDK_OFFSET(0x1BE42CD0)
#define RPG_GAMECORE_SHOWHEARTDIALTOAST__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE42D00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowHeartDialToast_TypeDefinitionIndex = 20125;
