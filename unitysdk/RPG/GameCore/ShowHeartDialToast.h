...
#define RPG_GAMECORE_SHOWHEARTDIALTOAST_METHOD_3_591A50D4BD740FF6_OFFSET UNITYSDK_OFFSET(0x18E62770)
#define RPG_GAMECORE_SHOWHEARTDIALTOAST_METHOD_3_67FEF87E91C18DAC_OFFSET UNITYSDK_OFFSET(0x18E626F0)
#define RPG_GAMECORE_SHOWHEARTDIALTOAST__CTOR_OFFSET UNITYSDK_OFFSET(0x18E62740)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowHeartDialToast_TypeDefinitionIndex = 19899;
