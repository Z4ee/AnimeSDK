...
#define RPG_GAMECORE_SHOWHEARTDIALTOAST_METHOD_3_591A50D4BD740FF6_OFFSET UNITYSDK_OFFSET(0x176FED20)
#define RPG_GAMECORE_SHOWHEARTDIALTOAST_METHOD_3_67FEF87E91C18DAC_OFFSET UNITYSDK_OFFSET(0x176FECA0)
#define RPG_GAMECORE_SHOWHEARTDIALTOAST__CTOR_OFFSET UNITYSDK_OFFSET(0x176FECF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowHeartDialToast_TypeDefinitionIndex = 19240;
