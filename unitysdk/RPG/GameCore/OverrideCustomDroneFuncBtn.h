...
#define RPG_GAMECORE_OVERRIDECUSTOMDRONEFUNCBTN_METHOD_3_3D98E941BE56214D_OFFSET UNITYSDK_OFFSET(0x18BCB5F0)
#define RPG_GAMECORE_OVERRIDECUSTOMDRONEFUNCBTN_METHOD_3_AEBBAF0943C20C9A_OFFSET UNITYSDK_OFFSET(0x18BCB570)
#define RPG_GAMECORE_OVERRIDECUSTOMDRONEFUNCBTN__CTOR_OFFSET UNITYSDK_OFFSET(0x18BCB5C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OverrideCustomDroneFuncBtn_TypeDefinitionIndex = 21000;
