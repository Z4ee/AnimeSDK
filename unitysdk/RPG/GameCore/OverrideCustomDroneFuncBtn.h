...
#define RPG_GAMECORE_OVERRIDECUSTOMDRONEFUNCBTN_METHOD_3_3D98E941BE56214D_OFFSET UNITYSDK_OFFSET(0x1D40BDC0)
#define RPG_GAMECORE_OVERRIDECUSTOMDRONEFUNCBTN_METHOD_3_5C1FE8F0AF15DB64_OFFSET UNITYSDK_OFFSET(0x1D40BD80)
#define RPG_GAMECORE_OVERRIDECUSTOMDRONEFUNCBTN__CTOR_OFFSET UNITYSDK_OFFSET(0x1D40BDB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OverrideCustomDroneFuncBtn_TypeDefinitionIndex = 21888;
