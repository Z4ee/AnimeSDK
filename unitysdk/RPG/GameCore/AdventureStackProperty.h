...
#define RPG_GAMECORE_ADVENTURESTACKPROPERTY_METHOD_3_64CDBC4F3CE6D4AC_OFFSET UNITYSDK_OFFSET(0x16F5AD70)
#define RPG_GAMECORE_ADVENTURESTACKPROPERTY_METHOD_3_F444F0C9609E5CB1_OFFSET UNITYSDK_OFFSET(0x16F5ACF0)
#define RPG_GAMECORE_ADVENTURESTACKPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x16F5AD40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureStackProperty_TypeDefinitionIndex = 19928;
