...
#define RPG_GAMECORE_ADVENTURESTACKPROPERTY_METHOD_3_07FD08B2C8DA90ED_OFFSET UNITYSDK_OFFSET(0x1AE62B40)
#define RPG_GAMECORE_ADVENTURESTACKPROPERTY_METHOD_3_64CDBC4F3CE6D4AC_OFFSET UNITYSDK_OFFSET(0x1AE62B80)
#define RPG_GAMECORE_ADVENTURESTACKPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE62B70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureStackProperty_TypeDefinitionIndex = 20957;
