...
#define RPG_GAMECORE_ADVENTURESTACKPROPERTY_METHOD_3_64CDBC4F3CE6D4AC_OFFSET UNITYSDK_OFFSET(0x1867D570)
#define RPG_GAMECORE_ADVENTURESTACKPROPERTY_METHOD_3_F444F0C9609E5CB1_OFFSET UNITYSDK_OFFSET(0x1867D4F0)
#define RPG_GAMECORE_ADVENTURESTACKPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1867D540)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureStackProperty_TypeDefinitionIndex = 20609;
