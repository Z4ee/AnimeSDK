...
#define RPG_GAMECORE_PROPRELOADPUZZLE_METHOD_3_0D96D846EE06921F_OFFSET UNITYSDK_OFFSET(0x1D36CE10)
#define RPG_GAMECORE_PROPRELOADPUZZLE_METHOD_3_934A493D1DBB6B62_OFFSET UNITYSDK_OFFSET(0x1D36CD40)
#define RPG_GAMECORE_PROPRELOADPUZZLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D36CE00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropReloadPuzzle_TypeDefinitionIndex = 20131;
