...
#define RPG_GAMECORE_PROPRELOADPUZZLE_METHOD_3_0D96D846EE06921F_OFFSET UNITYSDK_OFFSET(0x175231D0)
#define RPG_GAMECORE_PROPRELOADPUZZLE_METHOD_3_3CF63CB5C734CAAB_OFFSET UNITYSDK_OFFSET(0x175230C0)
#define RPG_GAMECORE_PROPRELOADPUZZLE__CTOR_OFFSET UNITYSDK_OFFSET(0x175231A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropReloadPuzzle_TypeDefinitionIndex = 18660;
