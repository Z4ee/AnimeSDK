...
#define RPG_GAMECORE_PROPRELOADPUZZLE_METHOD_3_0D96D846EE06921F_OFFSET UNITYSDK_OFFSET(0x18C72C10)
#define RPG_GAMECORE_PROPRELOADPUZZLE_METHOD_3_3CF63CB5C734CAAB_OFFSET UNITYSDK_OFFSET(0x18C72B00)
#define RPG_GAMECORE_PROPRELOADPUZZLE__CTOR_OFFSET UNITYSDK_OFFSET(0x18C72BE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropReloadPuzzle_TypeDefinitionIndex = 19317;
