...
#define RPG_GAMECORE_FOURROTATEVOXELCAMERACOMPONENTCONFIG_METHOD_3_07762468080494A5_OFFSET UNITYSDK_OFFSET(0x1892CF50)
#define RPG_GAMECORE_FOURROTATEVOXELCAMERACOMPONENTCONFIG_METHOD_3_9E7BCF224A18D834_OFFSET UNITYSDK_OFFSET(0x1892CEE0)
#define RPG_GAMECORE_FOURROTATEVOXELCAMERACOMPONENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1892CF30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FourRotateVoxelCameraComponentConfig_TypeDefinitionIndex = 15870;
