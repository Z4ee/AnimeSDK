...
#define RPG_GAMECORE_FOURROTATEVOXELCAMERACOMPONENTCONFIG_METHOD_3_07762468080494A5_OFFSET UNITYSDK_OFFSET(0x197682D0)
#define RPG_GAMECORE_FOURROTATEVOXELCAMERACOMPONENTCONFIG_METHOD_3_9E7BCF224A18D834_OFFSET UNITYSDK_OFFSET(0x19768260)
#define RPG_GAMECORE_FOURROTATEVOXELCAMERACOMPONENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197682B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FourRotateVoxelCameraComponentConfig_TypeDefinitionIndex = 15923;
