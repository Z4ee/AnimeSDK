...
#define RPG_GAMECORE_ROGUEPARAMROGUETOURNCURRENTROOMMARKTYPECONFIG_METHOD_6_A90BC6616D59A9A6_OFFSET UNITYSDK_OFFSET(0x1D177150)
#define RPG_GAMECORE_ROGUEPARAMROGUETOURNCURRENTROOMMARKTYPECONFIG_METHOD_6_CFE949152AA492C2_OFFSET UNITYSDK_OFFSET(0x1D1771A0)
#define RPG_GAMECORE_ROGUEPARAMROGUETOURNCURRENTROOMMARKTYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D177190)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamRogueTournCurrentRoomMarkTypeConfig_TypeDefinitionIndex = 19055;
