...
#define RPG_GAMECORE_PERFORMANCEENDBLACKTEXT_METHOD_3_8D15C26E367C2907_OFFSET UNITYSDK_OFFSET(0x1B4ADF70)
#define RPG_GAMECORE_PERFORMANCEENDBLACKTEXT_METHOD_3_9F07040753EF1DFA_OFFSET UNITYSDK_OFFSET(0x1B4ADFC0)
#define RPG_GAMECORE_PERFORMANCEENDBLACKTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4ADFB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PerformanceEndBlackText_TypeDefinitionIndex = 21116;
