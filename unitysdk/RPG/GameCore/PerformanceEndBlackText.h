...
#define RPG_GAMECORE_PERFORMANCEENDBLACKTEXT_METHOD_3_81C67B34E654630B_OFFSET UNITYSDK_OFFSET(0x18BE1A70)
#define RPG_GAMECORE_PERFORMANCEENDBLACKTEXT_METHOD_3_9F07040753EF1DFA_OFFSET UNITYSDK_OFFSET(0x18BE1AF0)
#define RPG_GAMECORE_PERFORMANCEENDBLACKTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x18BE1AC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PerformanceEndBlackText_TypeDefinitionIndex = 20773;
