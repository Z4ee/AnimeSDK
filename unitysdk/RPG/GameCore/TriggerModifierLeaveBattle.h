...
#define RPG_GAMECORE_TRIGGERMODIFIERLEAVEBATTLE_METHOD_3_43D10300CFF52705_OFFSET UNITYSDK_OFFSET(0x190C9290)
#define RPG_GAMECORE_TRIGGERMODIFIERLEAVEBATTLE_METHOD_3_ABC97753413447B1_OFFSET UNITYSDK_OFFSET(0x190C9180)
#define RPG_GAMECORE_TRIGGERMODIFIERLEAVEBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x190C9260)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerModifierLeaveBattle_TypeDefinitionIndex = 22417;
