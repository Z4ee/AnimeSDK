...
#define RPG_GAMECORE_TRIGGERMODIFIERLEAVEBATTLE_METHOD_3_43D10300CFF52705_OFFSET UNITYSDK_OFFSET(0x1B059120)
#define RPG_GAMECORE_TRIGGERMODIFIERLEAVEBATTLE_METHOD_3_539546FD5ECBC488_OFFSET UNITYSDK_OFFSET(0x1B059050)
#define RPG_GAMECORE_TRIGGERMODIFIERLEAVEBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B059110)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerModifierLeaveBattle_TypeDefinitionIndex = 22608;
