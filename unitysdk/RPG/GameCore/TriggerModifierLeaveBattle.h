...
#define RPG_GAMECORE_TRIGGERMODIFIERLEAVEBATTLE_METHOD_3_43D10300CFF52705_OFFSET UNITYSDK_OFFSET(0x178CAB70)
#define RPG_GAMECORE_TRIGGERMODIFIERLEAVEBATTLE_METHOD_3_ABC97753413447B1_OFFSET UNITYSDK_OFFSET(0x178CAA60)
#define RPG_GAMECORE_TRIGGERMODIFIERLEAVEBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x178CAB40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerModifierLeaveBattle_TypeDefinitionIndex = 21679;
