...
#define RPG_GAMECORE_ST_MAIN_ELFWAITERCLEANOBSTACLE_METHOD_4_7F086B4821A6BFA9_OFFSET UNITYSDK_OFFSET(0x18DE7AF0)
#define RPG_GAMECORE_ST_MAIN_ELFWAITERCLEANOBSTACLE_METHOD_4_EBCB5A4B777E0306_OFFSET UNITYSDK_OFFSET(0x18DF02F0)
#define RPG_GAMECORE_ST_MAIN_ELFWAITERCLEANOBSTACLE__CTOR_OFFSET UNITYSDK_OFFSET(0x18DE7AA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_ElfWaiterCleanObstacle_TypeDefinitionIndex = 20381;
