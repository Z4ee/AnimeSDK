...
#define RPG_GAMECORE_ADVENTUREBUFFEVENT_GETBUFFID_OFFSET UNITYSDK_OFFSET(0x153E2A10)
#define RPG_GAMECORE_ADVENTUREBUFFEVENT_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x153E29D0)
#define RPG_GAMECORE_ADVENTUREBUFFEVENT_GETISBUFFCREATE_OFFSET UNITYSDK_OFFSET(0x153E2A50)
#define RPG_GAMECORE_ADVENTUREBUFFEVENT_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x153E2990)
#define RPG_GAMECORE_ADVENTUREBUFFEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x153DFDA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureBuffEvent_TypeDefinitionIndex = 54076;
