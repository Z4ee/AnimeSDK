...
#define RPG_GAMECORE_ADVNPCSEARCHPROP_METHOD_3_6CA52367EF33A472_OFFSET UNITYSDK_OFFSET(0x1CDD36A0)
#define RPG_GAMECORE_ADVNPCSEARCHPROP_METHOD_3_7728DAE28861F5EF_OFFSET UNITYSDK_OFFSET(0x1CDD35D0)
#define RPG_GAMECORE_ADVNPCSEARCHPROP__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDD3690)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvNpcSearchProp_TypeDefinitionIndex = 19762;
