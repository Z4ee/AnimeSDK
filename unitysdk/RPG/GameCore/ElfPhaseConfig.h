...
#define RPG_GAMECORE_ELFPHASECONFIG_METHOD_2_FE972F13A59C4676_OFFSET UNITYSDK_OFFSET(0x1D05A8F0)
#define RPG_GAMECORE_ELFPHASECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D05A9E0)
