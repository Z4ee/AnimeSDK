...
#define RPG_GAMECORE_ELFPHASECONFIG_METHOD_2_FE972F13A59C4676_OFFSET UNITYSDK_OFFSET(0x1DB2A740)
#define RPG_GAMECORE_ELFPHASECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB2A830)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfPhaseConfig_TypeDefinitionIndex = 18242;
