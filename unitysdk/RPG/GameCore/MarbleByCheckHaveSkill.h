...
#define RPG_GAMECORE_MARBLEBYCHECKHAVESKILL_METHOD_4_009A7D9655C93644_OFFSET UNITYSDK_OFFSET(0x17389050)
#define RPG_GAMECORE_MARBLEBYCHECKHAVESKILL_METHOD_4_CB8C3CEC19B63116_OFFSET UNITYSDK_OFFSET(0x17388F70)
#define RPG_GAMECORE_MARBLEBYCHECKHAVESKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x17389000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleByCheckHaveSkill_TypeDefinitionIndex = 15461;
