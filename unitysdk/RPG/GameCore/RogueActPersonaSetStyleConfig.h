...
#define RPG_GAMECORE_ROGUEACTPERSONASETSTYLECONFIG_METHOD_6_41D263727864849D_OFFSET UNITYSDK_OFFSET(0x19AF47A0)
#define RPG_GAMECORE_ROGUEACTPERSONASETSTYLECONFIG_METHOD_6_936F4144CB4F1640_OFFSET UNITYSDK_OFFSET(0x19AF4580)
#define RPG_GAMECORE_ROGUEACTPERSONASETSTYLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AF46C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaSetStyleConfig_TypeDefinitionIndex = 18680;
