...
#define RPG_GAMECORE_BYCOMPAREGROUPPROPERTY_METHOD_4_456639A9F315CF12_OFFSET UNITYSDK_OFFSET(0x1700ABD0)
#define RPG_GAMECORE_BYCOMPAREGROUPPROPERTY_METHOD_4_7E2080CEA49D282C_OFFSET UNITYSDK_OFFSET(0x1700AAF0)
#define RPG_GAMECORE_BYCOMPAREGROUPPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1700AB70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareGroupProperty_TypeDefinitionIndex = 19048;
