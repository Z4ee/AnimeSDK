...
#define RPG_GAMECORE_BYCOMPAREGROUPPROPERTY_METHOD_4_456639A9F315CF12_OFFSET UNITYSDK_OFFSET(0x1872EF10)
#define RPG_GAMECORE_BYCOMPAREGROUPPROPERTY_METHOD_4_7E2080CEA49D282C_OFFSET UNITYSDK_OFFSET(0x1872EE30)
#define RPG_GAMECORE_BYCOMPAREGROUPPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1872EEB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareGroupProperty_TypeDefinitionIndex = 19706;
