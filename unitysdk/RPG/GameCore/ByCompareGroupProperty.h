...
#define RPG_GAMECORE_BYCOMPAREGROUPPROPERTY_METHOD_4_36805A5C805CEEF1_OFFSET UNITYSDK_OFFSET(0x19CE8B80)
#define RPG_GAMECORE_BYCOMPAREGROUPPROPERTY_METHOD_4_456639A9F315CF12_OFFSET UNITYSDK_OFFSET(0x19CE8900)
#define RPG_GAMECORE_BYCOMPAREGROUPPROPERTY_METHOD_4_61B78DF61E9DAFEE_OFFSET UNITYSDK_OFFSET(0x19CE8B40)
#define RPG_GAMECORE_BYCOMPAREGROUPPROPERTY_METHOD_4_FF5B0DFF8AD19A37_OFFSET UNITYSDK_OFFSET(0x19CE88B0)
#define RPG_GAMECORE_BYCOMPAREGROUPPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x19CE88F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareGroupProperty_TypeDefinitionIndex = 19945;
