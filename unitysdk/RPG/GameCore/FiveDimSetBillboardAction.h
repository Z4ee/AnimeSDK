...
#define RPG_GAMECORE_FIVEDIMSETBILLBOARDACTION_METHOD_3_39D181CA47819778_OFFSET UNITYSDK_OFFSET(0x1D878120)
#define RPG_GAMECORE_FIVEDIMSETBILLBOARDACTION_METHOD_3_521FC0774F872BB5_OFFSET UNITYSDK_OFFSET(0x1D878070)
#define RPG_GAMECORE_FIVEDIMSETBILLBOARDACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D878110)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSetBillboardAction_TypeDefinitionIndex = 18567;
