...
#define RPG_GAMECORE_FIVEDIMSETBILLBOARDACTION_METHOD_3_39D181CA47819778_OFFSET UNITYSDK_OFFSET(0x1891A5F0)
#define RPG_GAMECORE_FIVEDIMSETBILLBOARDACTION_METHOD_3_A844CBF3DE9D6FEC_OFFSET UNITYSDK_OFFSET(0x1891A510)
#define RPG_GAMECORE_FIVEDIMSETBILLBOARDACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1891A5D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSetBillboardAction_TypeDefinitionIndex = 17840;
