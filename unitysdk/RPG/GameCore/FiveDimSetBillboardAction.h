...
#define RPG_GAMECORE_FIVEDIMSETBILLBOARDACTION_METHOD_3_39D181CA47819778_OFFSET UNITYSDK_OFFSET(0x17208E90)
#define RPG_GAMECORE_FIVEDIMSETBILLBOARDACTION_METHOD_3_A844CBF3DE9D6FEC_OFFSET UNITYSDK_OFFSET(0x17208DB0)
#define RPG_GAMECORE_FIVEDIMSETBILLBOARDACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x17208E70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSetBillboardAction_TypeDefinitionIndex = 17235;
