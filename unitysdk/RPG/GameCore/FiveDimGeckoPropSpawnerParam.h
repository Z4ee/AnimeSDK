...
#define RPG_GAMECORE_FIVEDIMGECKOPROPSPAWNERPARAM_METHOD_3_72773E856C64A18D_OFFSET UNITYSDK_OFFSET(0x18904520)
#define RPG_GAMECORE_FIVEDIMGECKOPROPSPAWNERPARAM_METHOD_3_759B33392CF0A058_OFFSET UNITYSDK_OFFSET(0x18904560)
#define RPG_GAMECORE_FIVEDIMGECKOPROPSPAWNERPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x18904550)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimGeckoPropSpawnerParam_TypeDefinitionIndex = 17644;
