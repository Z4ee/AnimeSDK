...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETDRESSEDEQUIPNUMCONFIG_METHOD_6_1394B34365BF0FB3_OFFSET UNITYSDK_OFFSET(0x1D06D550)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETDRESSEDEQUIPNUMCONFIG_METHOD_6_927CC49D028571F7_OFFSET UNITYSDK_OFFSET(0x1D06D5A0)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETDRESSEDEQUIPNUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D06D590)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightParamGetDressedEquipNumConfig_TypeDefinitionIndex = 18769;
