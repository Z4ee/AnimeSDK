...
#define RPG_GAMECORE_SETCHARACTERMATERIALEFFECTENABLE_METHOD_3_07883F4E58019D39_OFFSET UNITYSDK_OFFSET(0x1C2D85B0)
#define RPG_GAMECORE_SETCHARACTERMATERIALEFFECTENABLE_METHOD_3_3529F5EC1DF122EE_OFFSET UNITYSDK_OFFSET(0x1C2D8600)
#define RPG_GAMECORE_SETCHARACTERMATERIALEFFECTENABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2D85F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetCharacterMaterialEffectEnable_TypeDefinitionIndex = 22127;
