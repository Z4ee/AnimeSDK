...
#define RPG_GAMECORE_SETCHARACTERMATERIALEFFECTENABLE_METHOD_3_3529F5EC1DF122EE_OFFSET UNITYSDK_OFFSET(0x19C2F710)
#define RPG_GAMECORE_SETCHARACTERMATERIALEFFECTENABLE_METHOD_3_745AA2D9948D50A4_OFFSET UNITYSDK_OFFSET(0x19C2F690)
#define RPG_GAMECORE_SETCHARACTERMATERIALEFFECTENABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C2F6E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetCharacterMaterialEffectEnable_TypeDefinitionIndex = 21700;
