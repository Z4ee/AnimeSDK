...
#define RPG_GAMECORE_PIXAIRRECOMMENDCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D794230)
#define RPG_GAMECORE_PIXAIRRECOMMENDCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7944A0)
