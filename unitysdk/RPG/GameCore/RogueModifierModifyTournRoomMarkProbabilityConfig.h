...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYTOURNROOMMARKPROBABILITYCONFIG_METHOD_3_A0BB4F717454F11C_OFFSET UNITYSDK_OFFSET(0x18D43040)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYTOURNROOMMARKPROBABILITYCONFIG_METHOD_3_E21482E4260692F5_OFFSET UNITYSDK_OFFSET(0x18D43110)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYTOURNROOMMARKPROBABILITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D430C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyTournRoomMarkProbabilityConfig_TypeDefinitionIndex = 16879;
