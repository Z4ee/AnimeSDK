...
#define RPG_GAMECORE_LINEUPCONTEXT_DEEPCLONE_OFFSET UNITYSDK_OFFSET(0xE6A5FD0)
#define RPG_GAMECORE_LINEUPCONTEXT_GETBATTLEACHIEVEMENTDATA_OFFSET UNITYSDK_OFFSET(0xE6A58E0)
#define RPG_GAMECORE_LINEUPCONTEXT_GETBATTLERAIDTARGETDATA_OFFSET UNITYSDK_OFFSET(0xE6A5AD0)
#define RPG_GAMECORE_LINEUPCONTEXT_GETMONSTERWAVELIST_OFFSET UNITYSDK_OFFSET(0xE6A5750)
#define RPG_GAMECORE_LINEUPCONTEXT_GETMONSTERWAVESTAGECOUNT_OFFSET UNITYSDK_OFFSET(0xE6A5790)
#define RPG_GAMECORE_LINEUPCONTEXT_GETROGUEGOALDATA_OFFSET UNITYSDK_OFFSET(0xE6A5CD0)
#define RPG_GAMECORE_LINEUPCONTEXT_GET_MAXWAVEOVERRIDE_OFFSET UNITYSDK_OFFSET(0xE6A6FE0)
#define RPG_GAMECORE_LINEUPCONTEXT_GET_STAGEBINDINGMAZEBUFFDATALIST_OFFSET UNITYSDK_OFFSET(0xE6A6F70)
#define RPG_GAMECORE_LINEUPCONTEXT_GET_STAGECONFIG_OFFSET UNITYSDK_OFFSET(0xE6A6BD0)
#define RPG_GAMECORE_LINEUPCONTEXT_GET_STAGEID_OFFSET UNITYSDK_OFFSET(0xE6A6910)
#define RPG_GAMECORE_LINEUPCONTEXT_GET_STAGETYPE_OFFSET UNITYSDK_OFFSET(0xE6A6BB0)
#define RPG_GAMECORE_LINEUPCONTEXT_GET_TREATWAVESASINFINITE_OFFSET UNITYSDK_OFFSET(0xE6A6FF0)
#define RPG_GAMECORE_LINEUPCONTEXT_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xE6A68F0)
#define RPG_GAMECORE_LINEUPCONTEXT_GET_WAVECOUNT_OFFSET UNITYSDK_OFFSET(0xE6A6F80)
#define RPG_GAMECORE_LINEUPCONTEXT_HASMAZEBUFFDATA_OFFSET UNITYSDK_OFFSET(0xE6A6EE0)
#define RPG_GAMECORE_LINEUPCONTEXT_RESET_OFFSET UNITYSDK_OFFSET(0xE6A5620)
#define RPG_GAMECORE_LINEUPCONTEXT_SETWAVESBYOVERRIDE_OFFSET UNITYSDK_OFFSET(0xE6A5EF0)
#define RPG_GAMECORE_LINEUPCONTEXT_SET_STAGEID_OFFSET UNITYSDK_OFFSET(0xE6A56F0)
#define RPG_GAMECORE_LINEUPCONTEXT_SET_STAGETYPE_OFFSET UNITYSDK_OFFSET(0xE6A6BC0)
#define RPG_GAMECORE_LINEUPCONTEXT_SET_TYPE_OFFSET UNITYSDK_OFFSET(0xE6A6900)
#define RPG_GAMECORE_LINEUPCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xE6A68B0)
#define RPG_GAMECORE_LINEUPCONTEXT__ONSTAGEIDCHANGED_OFFSET UNITYSDK_OFFSET(0xE6A6920)
#define RPG_GAMECORE_LINEUPCONTEXT__SETUPSTAGEBINDINGMAZEBUFFDATA_OFFSET UNITYSDK_OFFSET(0xE6A6C30)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::Il2CppArray<::Class_1_07A210D994F284D8_7*>* BattleAchievementList; // 0x10
		::Class_1_22B8FDC4E33ACC56* BattleGridFightData; // 0x18
		...
		::Il2CppArray<::Class_1_7AB88D713F5121B3_46*>* BattleRougeGoalList; // 0x30
		::Class_1_CC0B29182510F813* BattleFateRinData; // 0x38
		::Class_1_9D50B47B40CEFD84* BattleFateData; // 0x40
		::Class_1_B66FD2332404CEBB* BattleEvolveBuildData; // 0x48
		::Class_1_08B5ACC5F83BB932* BattleSwordTrainingData; // 0x50
		::Il2CppArray<::Class_1_7AB88D713F5121B3_47*>* BattleRaidTargetList; // 0x58
		::System::Collections::Generic::List_1<::Class_1_3F916053B9BB8D97*>* _MonsterWaves; // 0x60
		::Il2CppArray<::Class_1_7AB88D713F5121B3_45*>* BattleScoreList; // 0x68
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_1_7AB88D713F5121B3_47*>* _BattleRaidTargetDataMap; // 0x70
		::Il2CppArray<::System::String*>* AdditionBattleLoseConditions; // 0x78
		::Il2CppArray<::Class_1_5F0CB4974A75F258*>* AvatarExtraAbilityList; // 0x80
		::RPG::GameCore::BattleRogueData* BattleRogueData; // 0x88
		::Il2CppArray<::Class_1_7AB88D713F5121B3_45*>* BattleTargetList; // 0x90
		::Il2CppArray<::RPG::GameCore::MazeBuffData*>* MazeBuffDataList; // 0x98
		::Il2CppArray<::System::String*>* AdditionBattleWinConditions; // 0xA0
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_1_7AB88D713F5121B3_46*>* _BattleChallengeScoreDataMap; // 0xA8
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_1_07A210D994F284D8_7*>* _BattleAchievementDataMap; // 0xB0
		::System::Collections::Generic::List_1<::RPG::GameCore::MazeBuffData*>* GeneratedBindingBuffList; // 0xB8
		...
		::RPG::GameCore::RogueMode BattleRogueMode; // 0xD4
