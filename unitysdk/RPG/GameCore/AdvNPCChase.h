...
#define RPG_GAMECORE_ADVNPCCHASE_METHOD_3_7C5EA4D0B6671437_OFFSET UNITYSDK_OFFSET(0x19429CE0)
#define RPG_GAMECORE_ADVNPCCHASE_METHOD_3_F858BCF12B5500D1_OFFSET UNITYSDK_OFFSET(0x19429D60)
#define RPG_GAMECORE_ADVNPCCHASE__CTOR_OFFSET UNITYSDK_OFFSET(0x19429D30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvNPCChase_TypeDefinitionIndex = 18855;
