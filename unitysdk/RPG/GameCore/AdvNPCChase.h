...
#define RPG_GAMECORE_ADVNPCCHASE_METHOD_3_7C5EA4D0B6671437_OFFSET UNITYSDK_OFFSET(0x16F33FA0)
#define RPG_GAMECORE_ADVNPCCHASE_METHOD_3_F858BCF12B5500D1_OFFSET UNITYSDK_OFFSET(0x16F34020)
#define RPG_GAMECORE_ADVNPCCHASE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F33FF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvNPCChase_TypeDefinitionIndex = 18251;
