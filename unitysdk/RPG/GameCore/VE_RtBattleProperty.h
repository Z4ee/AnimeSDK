...
#define RPG_GAMECORE_VE_RTBATTLEPROPERTY_METHOD_3_553F367656B943EE_OFFSET UNITYSDK_OFFSET(0x1B890B80)
#define RPG_GAMECORE_VE_RTBATTLEPROPERTY_METHOD_3_DEEDFCB2D02F8B73_OFFSET UNITYSDK_OFFSET(0x1B890940)
#define RPG_GAMECORE_VE_RTBATTLEPROPERTY_METHOD_3_F0D60687BED61AE9_OFFSET UNITYSDK_OFFSET(0x1B890B50)
#define RPG_GAMECORE_VE_RTBATTLEPROPERTY_METHOD_3_FFFD9742EE3B720A_OFFSET UNITYSDK_OFFSET(0x1B890980)
#define RPG_GAMECORE_VE_RTBATTLEPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B890970)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VE_RtBattleProperty_TypeDefinitionIndex = 23414;
