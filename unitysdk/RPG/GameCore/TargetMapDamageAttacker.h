...
#define RPG_GAMECORE_TARGETMAPDAMAGEATTACKER_METHOD_3_1B08C89D625DF99E_OFFSET UNITYSDK_OFFSET(0x18EE84B0)
#define RPG_GAMECORE_TARGETMAPDAMAGEATTACKER_METHOD_3_E3EC2DAE43ACA6F3_OFFSET UNITYSDK_OFFSET(0x18EE8570)
#define RPG_GAMECORE_TARGETMAPDAMAGEATTACKER__CTOR_OFFSET UNITYSDK_OFFSET(0x18EE8550)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapDamageAttacker_TypeDefinitionIndex = 23008;
