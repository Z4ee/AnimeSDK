...
#define RPG_GAMECORE_IDLELIVEBOSSDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19840680)
#define RPG_GAMECORE_IDLELIVEBOSSDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19840920)

namespace RPG::GameCore
{
	inline static constexpr unsigned int IdleLiveBossDataRow_TypeDefinitionIndex = 11191;
