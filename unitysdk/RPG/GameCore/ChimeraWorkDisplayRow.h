...
#define RPG_GAMECORE_CHIMERAWORKDISPLAYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1964DE60)
#define RPG_GAMECORE_CHIMERAWORKDISPLAYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1964DFE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraWorkDisplayRow_TypeDefinitionIndex = 12412;
