...
#define RPG_GAMECORE_ST_SIDE_STEERTOTARGET_METHOD_4_63D27154DBA92A89_OFFSET UNITYSDK_OFFSET(0x1DB45C60)
#define RPG_GAMECORE_ST_SIDE_STEERTOTARGET_METHOD_4_B49823B0156D6F12_OFFSET UNITYSDK_OFFSET(0x1DB45CA0)
#define RPG_GAMECORE_ST_SIDE_STEERTOTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB45C90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_SteerToTarget_TypeDefinitionIndex = 19875;
