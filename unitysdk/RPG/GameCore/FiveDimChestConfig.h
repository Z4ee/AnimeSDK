...
#define RPG_GAMECORE_FIVEDIMCHESTCONFIG_METHOD_3_92011626DCD17226_OFFSET UNITYSDK_OFFSET(0x188F94A0)
#define RPG_GAMECORE_FIVEDIMCHESTCONFIG_METHOD_3_CB6AF8F00DEC6993_OFFSET UNITYSDK_OFFSET(0x188F9430)
#define RPG_GAMECORE_FIVEDIMCHESTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x188F9480)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimChestConfig_TypeDefinitionIndex = 17622;
