...
#define RPG_GAMECORE_FIVEDIMCHESTCONFIG_METHOD_3_3DEFB08F23F9C189_OFFSET UNITYSDK_OFFSET(0x1D0A55A0)
#define RPG_GAMECORE_FIVEDIMCHESTCONFIG_METHOD_3_92011626DCD17226_OFFSET UNITYSDK_OFFSET(0x1D0A55F0)
#define RPG_GAMECORE_FIVEDIMCHESTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0A55E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimChestConfig_TypeDefinitionIndex = 18341;
