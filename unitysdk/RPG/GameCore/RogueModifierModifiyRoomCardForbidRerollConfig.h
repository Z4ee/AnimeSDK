...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFIYROOMCARDFORBIDREROLLCONFIG_METHOD_3_8E08AC6F6A1DCB9C_OFFSET UNITYSDK_OFFSET(0x19B54720)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFIYROOMCARDFORBIDREROLLCONFIG_METHOD_3_A9930C26A742A8A5_OFFSET UNITYSDK_OFFSET(0x19B5E8C0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFIYROOMCARDFORBIDREROLLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B546D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifiyRoomCardForbidRerollConfig_TypeDefinitionIndex = 16948;
