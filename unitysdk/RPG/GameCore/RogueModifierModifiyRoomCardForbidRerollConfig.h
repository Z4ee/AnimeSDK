...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFIYROOMCARDFORBIDREROLLCONFIG_METHOD_3_8B60CDBC446FA520_OFFSET UNITYSDK_OFFSET(0x1D163400)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFIYROOMCARDFORBIDREROLLCONFIG_METHOD_3_8E08AC6F6A1DCB9C_OFFSET UNITYSDK_OFFSET(0x1D163450)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFIYROOMCARDFORBIDREROLLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D163440)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifiyRoomCardForbidRerollConfig_TypeDefinitionIndex = 17110;
