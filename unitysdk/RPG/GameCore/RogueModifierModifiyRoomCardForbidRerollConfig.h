...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFIYROOMCARDFORBIDREROLLCONFIG_METHOD_3_8E08AC6F6A1DCB9C_OFFSET UNITYSDK_OFFSET(0x18D3FD40)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFIYROOMCARDFORBIDREROLLCONFIG_METHOD_3_A9930C26A742A8A5_OFFSET UNITYSDK_OFFSET(0x18D3FC70)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFIYROOMCARDFORBIDREROLLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D3FCF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifiyRoomCardForbidRerollConfig_TypeDefinitionIndex = 16933;
