...
#define RPG_GAMECORE_NEWADVENTUREFIREPROJECTILE_METHOD_4_41C2FA3B57765CCC_OFFSET UNITYSDK_OFFSET(0x18B7DD00)
#define RPG_GAMECORE_NEWADVENTUREFIREPROJECTILE_METHOD_4_EC3D5EE410FFD801_OFFSET UNITYSDK_OFFSET(0x18B7DC80)
#define RPG_GAMECORE_NEWADVENTUREFIREPROJECTILE__CTOR_OFFSET UNITYSDK_OFFSET(0x18B7DCD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NewAdventureFireProjectile_TypeDefinitionIndex = 19147;
