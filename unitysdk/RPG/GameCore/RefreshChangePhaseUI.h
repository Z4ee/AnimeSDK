...
#define RPG_GAMECORE_REFRESHCHANGEPHASEUI_METHOD_3_21E09E0E77937F57_OFFSET UNITYSDK_OFFSET(0x18C94CA0)
#define RPG_GAMECORE_REFRESHCHANGEPHASEUI_METHOD_3_22F551A1CF464D43_OFFSET UNITYSDK_OFFSET(0x18C94B90)
#define RPG_GAMECORE_REFRESHCHANGEPHASEUI__CTOR_OFFSET UNITYSDK_OFFSET(0x18C94C70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RefreshChangePhaseUI_TypeDefinitionIndex = 22159;
