...
#define RPG_GAMECORE_MISSIONSUBTYPECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19948410)
#define RPG_GAMECORE_MISSIONSUBTYPECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19948A50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MissionSubTypeConfigRow_TypeDefinitionIndex = 13479;
