...
#define RPG_GAMECORE_FIVEDIMMISSIONTALKACTION_METHOD_3_94BA3D35A8D82850_OFFSET UNITYSDK_OFFSET(0x19730310)
#define RPG_GAMECORE_FIVEDIMMISSIONTALKACTION_METHOD_3_DA6A9A7F51324A61_OFFSET UNITYSDK_OFFSET(0x19747910)
#define RPG_GAMECORE_FIVEDIMMISSIONTALKACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x197302F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimMissionTalkAction_TypeDefinitionIndex = 17849;
