...
#define RPG_GAMECORE_STOPCURRENTLITTLEGAME_METHOD_3_2E358668E41A6F88_OFFSET UNITYSDK_OFFSET(0x19CBFC80)
#define RPG_GAMECORE_STOPCURRENTLITTLEGAME_METHOD_3_4C7DEDC953E8C9BC_OFFSET UNITYSDK_OFFSET(0x19CBFB70)
#define RPG_GAMECORE_STOPCURRENTLITTLEGAME__CTOR_OFFSET UNITYSDK_OFFSET(0x19CBFC50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StopCurrentLittleGame_TypeDefinitionIndex = 19842;
