...
#define RPG_GAMECORE_MONSTERROW_FROMBINARYWITHOUTNEW_OFFSET UNITYSDK_OFFSET(0x1744CD70)
#define RPG_GAMECORE_MONSTERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1744DB80)
#define RPG_GAMECORE_MONSTERROW_FROMTABLEOFFSET_OFFSET UNITYSDK_OFFSET(0x17451CD0)
#define RPG_GAMECORE_MONSTERROW_GETMONSTERRANK_OFFSET UNITYSDK_OFFSET(0x1744EFC0)
#define RPG_GAMECORE_MONSTERROW_GET_AETHERDIVIDETYPE_OFFSET UNITYSDK_OFFSET(0x17451DB0)
#define RPG_GAMECORE_MONSTERROW_GET_MONSTERUNIQUEID_OFFSET UNITYSDK_OFFSET(0x17451E60)
#define RPG_GAMECORE_MONSTERROW_GET__EXPANDEDDATAROW_OFFSET UNITYSDK_OFFSET(0x17451E10)
#define RPG_GAMECORE_MONSTERROW_RESET_OFFSET UNITYSDK_OFFSET(0x17451D30)
#define RPG_GAMECORE_MONSTERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17451DA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonsterRow_TypeDefinitionIndex = 12974;

	class MonsterRow : public ::System::Object
	{
	public:
		::RPG::GameCore::AetherDivideMonsterRow* _ExpandedDataRowCache; // 0x10
		::Il2CppArray<::Class_1_7E522A732F80B93C*>* OverrideSkillParams; // 0x18
		::Il2CppArray<::RPG::Client::TextID>* MonsterStrategy; // 0x20
		::Il2CppArray<::System::String*>* CustomValueTags; // 0x28
		::System::String* OverrideAIPath; // 0x30
		::Il2CppArray<::RPG::GameCore::AttackDamageType>* StanceWeakList; // 0x38
		::Il2CppArray<::RPG::GameCore::MonsterResistEntry*>* DebuffResist; // 0x40
		::Il2CppArray<::System::String*>* AbilityNameList; // 0x48
		::Il2CppArray<::Class_1_D4EDD67361CB4C7A*>* DynamicValues; // 0x50
		::Il2CppArray<::Class_1_EDD10E908F1C4623*>* CustomValues; // 0x58
		::Il2CppArray<::Class_1_2EC0EF10CE4B8713*>* OverrideAISkillSequence; // 0x60
		::Il2CppArray<::RPG::GameCore::ElementResistanceConfig*>* DamageTypeResistance; // 0x68
		...
		::System::UInt32 Level; // 0x88
		::System::UInt32 MonsterTemplateID; // 0x8C
		::RPG::GameCore::FixPoint DefenceModifyValue; // 0x90
		::RPG::Client::TextID MonsterBattleIntroduction; // 0x98
		::RPG::GameCore::FixPoint DefenceModifyRatio; // 0xA8
		::System::Int32 StanceCountDelta; // 0xB0
		::System::UInt32 HardLevelGroup; // 0xB4
		::RPG::GameCore::FixPoint HPModifyValue; // 0xB8
		::System::Boolean _IsCached; // 0xC0
		::System::UInt32 MonsterID; // 0xC4
		::System::UInt32 MonsterType; // 0xC8
		::System::UInt32 EliteGroup; // 0xCC
		::RPG::GameCore::FixPoint AttackModifyValue; // 0xD0
		::RPG::GameCore::FixPoint AttackModifyRatio; // 0xD8
		::RPG::Client::TextID MonsterIntroduction; // 0xE0
		::RPG::GameCore::FixPoint StanceModifyValue; // 0xF0
		::RPG::GameCore::FixPoint SpeedModifyRatio; // 0xF8
		::RPG::Client::TextID MonsterName; // 0x100
		::RPG::GameCore::FixPoint HPModifyRatio; // 0x110
