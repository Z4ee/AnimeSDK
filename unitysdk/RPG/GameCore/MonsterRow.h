...
#define RPG_GAMECORE_MONSTERROW_FROMBINARYWITHOUTNEW_OFFSET UNITYSDK_OFFSET(0x199A93E0)
#define RPG_GAMECORE_MONSTERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x199AA170)
#define RPG_GAMECORE_MONSTERROW_FROMTABLEOFFSET_OFFSET UNITYSDK_OFFSET(0x199AE0F0)
#define RPG_GAMECORE_MONSTERROW_GETMONSTERRANK_OFFSET UNITYSDK_OFFSET(0x199AB520)
#define RPG_GAMECORE_MONSTERROW_GET_AETHERDIVIDETYPE_OFFSET UNITYSDK_OFFSET(0x199AE1E0)
#define RPG_GAMECORE_MONSTERROW_GET_MONSTERUNIQUEID_OFFSET UNITYSDK_OFFSET(0x199AE290)
#define RPG_GAMECORE_MONSTERROW_GET__EXPANDEDDATAROW_OFFSET UNITYSDK_OFFSET(0x199AE240)
#define RPG_GAMECORE_MONSTERROW_RESET_OFFSET UNITYSDK_OFFSET(0x199AE150)
#define RPG_GAMECORE_MONSTERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x199AE1D0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::System::UInt32>* SummonIDList; // 0x20
		...
		::Il2CppArray<::Class_1_B7B6A11029867830*>* OverrideSkillParams; // 0x50
		::Il2CppArray<::RPG::Client::TextID>* MonsterStrategy; // 0x58
		::Il2CppArray<::RPG::GameCore::MonsterResistEntry*>* DebuffResist; // 0x60
		::RPG::GameCore::AetherDivideMonsterRow* _ExpandedDataRowCache; // 0x68
		::Il2CppArray<::Class_1_B34BC0DFAA62C487*>* DynamicValues; // 0x70
		::Il2CppArray<::System::String*>* AbilityNameList; // 0x78
		::RPG::GameCore::FixPoint StanceModifyValue; // 0x80
		::RPG::GameCore::FixPoint SpeedModifyRatio; // 0x88
		::RPG::GameCore::FixPoint SpeedModifyValue; // 0x90
		::RPG::GameCore::FixPoint AttackModifyRatio; // 0x98
		::System::UInt32 EliteGroup; // 0xA0
		::System::Int32 StanceCountDelta; // 0xA4
		::System::Boolean _IsCached; // 0xA8
		::System::UInt32 Level; // 0xAC
		::RPG::GameCore::FixPoint AttackModifyValue; // 0xB0
		::RPG::GameCore::FixPoint HPModifyRatio; // 0xB8
		::RPG::Client::TextID MonsterName; // 0xC0
		::RPG::GameCore::FixPoint DefenceModifyRatio; // 0xD0
		::RPG::Client::TextID MonsterIntroduction; // 0xD8
		::System::UInt32 MonsterID; // 0xE8
		::System::UInt32 MonsterType; // 0xEC
		::RPG::GameCore::FixPoint StanceModifyRatio; // 0xF0
		::RPG::GameCore::FixPoint DefenceModifyValue; // 0xF8
		::RPG::Client::TextID MonsterBattleIntroduction; // 0x100
		::RPG::GameCore::FixPoint HPModifyValue; // 0x110
		::System::UInt32 HardLevelGroup; // 0x118
		::System::UInt32 MonsterTemplateID; // 0x11C
