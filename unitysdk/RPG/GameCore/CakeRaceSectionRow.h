...
#define RPG_GAMECORE_CAKERACESECTIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D1044D0)
#define RPG_GAMECORE_CAKERACESECTIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D104640)
