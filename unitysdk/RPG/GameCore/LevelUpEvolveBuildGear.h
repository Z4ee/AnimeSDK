...
#define RPG_GAMECORE_LEVELUPEVOLVEBUILDGEAR_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x18A5AD70)
#define RPG_GAMECORE_LEVELUPEVOLVEBUILDGEAR_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18A5ACF0)
#define RPG_GAMECORE_LEVELUPEVOLVEBUILDGEAR__CTOR_OFFSET UNITYSDK_OFFSET(0x18A5AD40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelUpEvolveBuildGear_TypeDefinitionIndex = 22040;
