...
#define RPG_GAMECORE_LEVELUPEVOLVEBUILDGEAR_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1DD598D0)
#define RPG_GAMECORE_LEVELUPEVOLVEBUILDGEAR_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1DD59890)
#define RPG_GAMECORE_LEVELUPEVOLVEBUILDGEAR__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD598C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelUpEvolveBuildGear_TypeDefinitionIndex = 22841;
