...
#define RPG_GAMECORE_DRIVECURVEPROPGROUPOBJECT_METHOD_3_18D05503664B3D5D_OFFSET UNITYSDK_OFFSET(0x17182DE0)
#define RPG_GAMECORE_DRIVECURVEPROPGROUPOBJECT_METHOD_3_A233BD525D381491_OFFSET UNITYSDK_OFFSET(0x17182EF0)
#define RPG_GAMECORE_DRIVECURVEPROPGROUPOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x17182EC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DriveCurvePropGroupObject_TypeDefinitionIndex = 20451;
