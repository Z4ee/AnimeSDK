...
#define RPG_GAMECORE_CLOCKPARKCARDTIPSTYPEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D996400)
#define RPG_GAMECORE_CLOCKPARKCARDTIPSTYPEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D996AE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClockParkCardTipsTypeRow_TypeDefinitionIndex = 11158;

	class ClockParkCardTipsTypeRow : public ::System::Object
	{
	public:
		::RPG::Client::TextID CardTips_Detail; // 0x10
		::RPG::Client::TextID CardTips; // 0x20
