...
#define RPG_GAMECORE_ADVSETNPCALERTCONFIG_METHOD_3_105A136F9C4B35AC_OFFSET UNITYSDK_OFFSET(0x16F41C90)
#define RPG_GAMECORE_ADVSETNPCALERTCONFIG_METHOD_3_BE9D76154476F829_OFFSET UNITYSDK_OFFSET(0x16F41DE0)
#define RPG_GAMECORE_ADVSETNPCALERTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16F41D50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSetNpcAlertConfig_TypeDefinitionIndex = 18631;
