...
#define RPG_GAMECORE_FIVEDIMBORDERPLATCONFIG_METHOD_3_1FBDB84418617AE1_OFFSET UNITYSDK_OFFSET(0x19734260)
#define RPG_GAMECORE_FIVEDIMBORDERPLATCONFIG_METHOD_3_CFDD4A442F649452_OFFSET UNITYSDK_OFFSET(0x197341F0)
#define RPG_GAMECORE_FIVEDIMBORDERPLATCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19734240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimBorderPlatConfig_TypeDefinitionIndex = 17684;
