...
#define RPG_GAMECORE_CHENLINGENCHANTLEVELROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C381FC0)
#define RPG_GAMECORE_CHENLINGENCHANTLEVELROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C382170)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingEnchantLevelRow_TypeDefinitionIndex = 10676;
