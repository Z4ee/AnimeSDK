...
#define RPG_GAMECORE_CHENLINGENCHANTLEVELROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19627B70)
#define RPG_GAMECORE_CHENLINGENCHANTLEVELROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19627D20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingEnchantLevelRow_TypeDefinitionIndex = 10626;
