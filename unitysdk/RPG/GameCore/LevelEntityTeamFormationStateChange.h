...
#define RPG_GAMECORE_LEVELENTITYTEAMFORMATIONSTATECHANGE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xCE45970)
#define RPG_GAMECORE_LEVELENTITYTEAMFORMATIONSTATECHANGE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xCE45920)
#define RPG_GAMECORE_LEVELENTITYTEAMFORMATIONSTATECHANGE_GET_ISFOLLOWER_OFFSET UNITYSDK_OFFSET(0xCE459F0)
#define RPG_GAMECORE_LEVELENTITYTEAMFORMATIONSTATECHANGE_GET_ISINTEAM_OFFSET UNITYSDK_OFFSET(0xCE459E0)
#define RPG_GAMECORE_LEVELENTITYTEAMFORMATIONSTATECHANGE_GET_SOURCEENTITY_OFFSET UNITYSDK_OFFSET(0xCE459C0)
#define RPG_GAMECORE_LEVELENTITYTEAMFORMATIONSTATECHANGE_GET_TEAM_OFFSET UNITYSDK_OFFSET(0xCE459D0)
#define RPG_GAMECORE_LEVELENTITYTEAMFORMATIONSTATECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0xCE45900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelEntityTeamFormationStateChange_TypeDefinitionIndex = 53042;
	...
	public:
		...
		::System::Boolean _IsFollower; // 0x1C
		::System::Boolean _IsInTeam; // 0x1D
