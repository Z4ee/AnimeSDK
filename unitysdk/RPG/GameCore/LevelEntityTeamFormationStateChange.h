...
#define RPG_GAMECORE_LEVELENTITYTEAMFORMATIONSTATECHANGE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1DD23910)
#define RPG_GAMECORE_LEVELENTITYTEAMFORMATIONSTATECHANGE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x1DD238C0)
#define RPG_GAMECORE_LEVELENTITYTEAMFORMATIONSTATECHANGE_GET_ISFOLLOWER_OFFSET UNITYSDK_OFFSET(0x1DD23990)
#define RPG_GAMECORE_LEVELENTITYTEAMFORMATIONSTATECHANGE_GET_ISINTEAM_OFFSET UNITYSDK_OFFSET(0x1DD23980)
#define RPG_GAMECORE_LEVELENTITYTEAMFORMATIONSTATECHANGE_GET_SOURCEENTITY_OFFSET UNITYSDK_OFFSET(0x1DD23960)
#define RPG_GAMECORE_LEVELENTITYTEAMFORMATIONSTATECHANGE_GET_TEAM_OFFSET UNITYSDK_OFFSET(0x1DD23970)
#define RPG_GAMECORE_LEVELENTITYTEAMFORMATIONSTATECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD238A0)
