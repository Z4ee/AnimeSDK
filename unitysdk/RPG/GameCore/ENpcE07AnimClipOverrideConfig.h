...
#define RPG_GAMECORE_ENPCE07ANIMCLIPOVERRIDECONFIG_METHOD_2_7D4E5E5876D55247_OFFSET UNITYSDK_OFFSET(0x1BB2EC80)
#define RPG_GAMECORE_ENPCE07ANIMCLIPOVERRIDECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB2EDB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ENpcE07AnimClipOverrideConfig_TypeDefinitionIndex = 15872;
