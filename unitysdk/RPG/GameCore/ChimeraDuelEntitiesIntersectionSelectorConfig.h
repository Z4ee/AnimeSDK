...
#define RPG_GAMECORE_CHIMERADUELENTITIESINTERSECTIONSELECTORCONFIG_METHOD_3_1B4E3A63F788679C_OFFSET UNITYSDK_OFFSET(0x1709A3A0)
#define RPG_GAMECORE_CHIMERADUELENTITIESINTERSECTIONSELECTORCONFIG_METHOD_3_7784055A96AF916C_OFFSET UNITYSDK_OFFSET(0x1709A400)
#define RPG_GAMECORE_CHIMERADUELENTITIESINTERSECTIONSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1709A3F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelEntitiesIntersectionSelectorConfig_TypeDefinitionIndex = 14609;
