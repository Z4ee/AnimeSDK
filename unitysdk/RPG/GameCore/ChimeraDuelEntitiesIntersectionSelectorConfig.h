...
#define RPG_GAMECORE_CHIMERADUELENTITIESINTERSECTIONSELECTORCONFIG_METHOD_3_36835CBC71D232A1_OFFSET UNITYSDK_OFFSET(0x1C395310)
#define RPG_GAMECORE_CHIMERADUELENTITIESINTERSECTIONSELECTORCONFIG_METHOD_3_7B6DE5D55825B6D9_OFFSET UNITYSDK_OFFSET(0x1C3952B0)
#define RPG_GAMECORE_CHIMERADUELENTITIESINTERSECTIONSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C395300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelEntitiesIntersectionSelectorConfig_TypeDefinitionIndex = 15306;
