...
#define RPG_GAMECORE_ADVNPCRIDE_METHOD_3_2722FE1BF6EC2E09_OFFSET UNITYSDK_OFFSET(0x1865B990)
#define RPG_GAMECORE_ADVNPCRIDE_METHOD_3_333D30310F769E8B_OFFSET UNITYSDK_OFFSET(0x1865B8C0)
#define RPG_GAMECORE_ADVNPCRIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x1865B940)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvNpcRide_TypeDefinitionIndex = 20022;
