...
#define RPG_GAMECORE_ADVNPCRIDE_METHOD_3_2722FE1BF6EC2E09_OFFSET UNITYSDK_OFFSET(0x1BE26730)
#define RPG_GAMECORE_ADVNPCRIDE_METHOD_3_75A6B09F5B7D109F_OFFSET UNITYSDK_OFFSET(0x1BE26690)
#define RPG_GAMECORE_ADVNPCRIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE266F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvNpcRide_TypeDefinitionIndex = 20246;
