...
#define RPG_GAMECORE_ADVSETDYNAMICVALUEBYTARGETDISTANCE_METHOD_3_0A89A9F2257FAFBF_OFFSET UNITYSDK_OFFSET(0x18662B50)
#define RPG_GAMECORE_ADVSETDYNAMICVALUEBYTARGETDISTANCE_METHOD_3_227E3B007FAFD2F7_OFFSET UNITYSDK_OFFSET(0x18662C30)
#define RPG_GAMECORE_ADVSETDYNAMICVALUEBYTARGETDISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x18662BD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSetDynamicValueByTargetDistance_TypeDefinitionIndex = 19749;
