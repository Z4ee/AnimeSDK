...
#define RPG_GAMECORE_ADVSETDYNAMICVALUEBYTARGETDISTANCE_METHOD_3_0A89A9F2257FAFBF_OFFSET UNITYSDK_OFFSET(0x1CBA0A80)
#define RPG_GAMECORE_ADVSETDYNAMICVALUEBYTARGETDISTANCE_METHOD_3_227E3B007FAFD2F7_OFFSET UNITYSDK_OFFSET(0x1CBA0B20)
#define RPG_GAMECORE_ADVSETDYNAMICVALUEBYTARGETDISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CBA0AE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSetDynamicValueByTargetDistance_TypeDefinitionIndex = 20532;
