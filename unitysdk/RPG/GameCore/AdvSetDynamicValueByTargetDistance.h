...
#define RPG_GAMECORE_ADVSETDYNAMICVALUEBYTARGETDISTANCE_METHOD_3_0A89A9F2257FAFBF_OFFSET UNITYSDK_OFFSET(0x194364A0)
#define RPG_GAMECORE_ADVSETDYNAMICVALUEBYTARGETDISTANCE_METHOD_3_227E3B007FAFD2F7_OFFSET UNITYSDK_OFFSET(0x19436580)
#define RPG_GAMECORE_ADVSETDYNAMICVALUEBYTARGETDISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x19436520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSetDynamicValueByTargetDistance_TypeDefinitionIndex = 19626;
