...
#define RPG_GAMECORE_CAMERAFOLLOWENTITYTIMESCALE_METHOD_3_1A561E66EC9EB480_OFFSET UNITYSDK_OFFSET(0x1B708B70)
#define RPG_GAMECORE_CAMERAFOLLOWENTITYTIMESCALE_METHOD_3_BA67CCE879352643_OFFSET UNITYSDK_OFFSET(0x1B708B20)
#define RPG_GAMECORE_CAMERAFOLLOWENTITYTIMESCALE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B708B60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CameraFollowEntityTimeScale_TypeDefinitionIndex = 21859;
