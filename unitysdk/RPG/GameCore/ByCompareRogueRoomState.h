...
#define RPG_GAMECORE_BYCOMPAREROGUEROOMSTATE_METHOD_4_EC848F924E419344_OFFSET UNITYSDK_OFFSET(0x187396E0)
#define RPG_GAMECORE_BYCOMPAREROGUEROOMSTATE_METHOD_4_ED5CF0421C325FCD_OFFSET UNITYSDK_OFFSET(0x18739610)
#define RPG_GAMECORE_BYCOMPAREROGUEROOMSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18739690)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareRogueRoomState_TypeDefinitionIndex = 19781;
