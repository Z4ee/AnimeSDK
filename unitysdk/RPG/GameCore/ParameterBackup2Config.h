...
#define RPG_GAMECORE_PARAMETERBACKUP2CONFIG_METHOD_4_BE793D4672609589_OFFSET UNITYSDK_OFFSET(0x18BD47E0)
#define RPG_GAMECORE_PARAMETERBACKUP2CONFIG_METHOD_4_C72EC9FCB5B9D20B_OFFSET UNITYSDK_OFFSET(0x18BD46B0)
#define RPG_GAMECORE_PARAMETERBACKUP2CONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18BD4760)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ParameterBackup2Config_TypeDefinitionIndex = 16151;
