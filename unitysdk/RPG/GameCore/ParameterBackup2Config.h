...
#define RPG_GAMECORE_PARAMETERBACKUP2CONFIG_METHOD_4_BE793D4672609589_OFFSET UNITYSDK_OFFSET(0x1748A2C0)
#define RPG_GAMECORE_PARAMETERBACKUP2CONFIG_METHOD_4_C72EC9FCB5B9D20B_OFFSET UNITYSDK_OFFSET(0x1748A190)
#define RPG_GAMECORE_PARAMETERBACKUP2CONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1748A240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ParameterBackup2Config_TypeDefinitionIndex = 15629;
