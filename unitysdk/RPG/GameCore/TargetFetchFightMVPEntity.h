...
#define RPG_GAMECORE_TARGETFETCHFIGHTMVPENTITY_METHOD_4_930D0B5E7803B3B6_OFFSET UNITYSDK_OFFSET(0x177BEB80)
#define RPG_GAMECORE_TARGETFETCHFIGHTMVPENTITY_METHOD_4_BDBA263FDA0B1674_OFFSET UNITYSDK_OFFSET(0x177B58C0)
#define RPG_GAMECORE_TARGETFETCHFIGHTMVPENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x177B5870)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchFightMVPEntity_TypeDefinitionIndex = 22280;
