...
#define RPG_GAMECORE_TARGETFETCHFIGHTMVPENTITY_METHOD_4_547B6833E0352D14_OFFSET UNITYSDK_OFFSET(0x1D0BA0F0)
#define RPG_GAMECORE_TARGETFETCHFIGHTMVPENTITY_METHOD_4_9D0C3252C4C05DC9_OFFSET UNITYSDK_OFFSET(0x1D0B9FF0)
#define RPG_GAMECORE_TARGETFETCHFIGHTMVPENTITY_METHOD_4_BDBA263FDA0B1674_OFFSET UNITYSDK_OFFSET(0x1D0BA070)
#define RPG_GAMECORE_TARGETFETCHFIGHTMVPENTITY_METHOD_4_C5571D63DA73BA41_OFFSET UNITYSDK_OFFSET(0x1D0BA0D0)
#define RPG_GAMECORE_TARGETFETCHFIGHTMVPENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0BA060)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchFightMVPEntity_TypeDefinitionIndex = 23150;
