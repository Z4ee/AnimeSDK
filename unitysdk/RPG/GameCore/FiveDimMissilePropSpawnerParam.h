...
#define RPG_GAMECORE_FIVEDIMMISSILEPROPSPAWNERPARAM_METHOD_3_95BDCC77143B5528_OFFSET UNITYSDK_OFFSET(0x171FBAC0)
#define RPG_GAMECORE_FIVEDIMMISSILEPROPSPAWNERPARAM_METHOD_3_CC0A394F38CF710D_OFFSET UNITYSDK_OFFSET(0x171FBB00)
#define RPG_GAMECORE_FIVEDIMMISSILEPROPSPAWNERPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x171FBAF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimMissilePropSpawnerParam_TypeDefinitionIndex = 17052;
