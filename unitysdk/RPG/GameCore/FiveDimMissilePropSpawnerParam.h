...
#define RPG_GAMECORE_FIVEDIMMISSILEPROPSPAWNERPARAM_METHOD_3_95BDCC77143B5528_OFFSET UNITYSDK_OFFSET(0x19747750)
#define RPG_GAMECORE_FIVEDIMMISSILEPROPSPAWNERPARAM_METHOD_3_CC0A394F38CF710D_OFFSET UNITYSDK_OFFSET(0x19747790)
#define RPG_GAMECORE_FIVEDIMMISSILEPROPSPAWNERPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x19747780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimMissilePropSpawnerParam_TypeDefinitionIndex = 17673;
