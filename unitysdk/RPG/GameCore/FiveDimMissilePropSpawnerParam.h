...
#define RPG_GAMECORE_FIVEDIMMISSILEPROPSPAWNERPARAM_METHOD_3_95BDCC77143B5528_OFFSET UNITYSDK_OFFSET(0x1890C600)
#define RPG_GAMECORE_FIVEDIMMISSILEPROPSPAWNERPARAM_METHOD_3_CC0A394F38CF710D_OFFSET UNITYSDK_OFFSET(0x1890C640)
#define RPG_GAMECORE_FIVEDIMMISSILEPROPSPAWNERPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1890C630)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimMissilePropSpawnerParam_TypeDefinitionIndex = 17647;
