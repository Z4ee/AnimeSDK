...
#define RPG_GAMECORE_ANIMPARAMRANGEENTRY_METHOD_2_910B3835D294ADF5_OFFSET UNITYSDK_OFFSET(0x16F819E0)
#define RPG_GAMECORE_ANIMPARAMRANGEENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x16F81B30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AnimParamRangeEntry_TypeDefinitionIndex = 14906;
