...
#define RPG_GAMECORE_ANIMPARAMRANGEENTRY_METHOD_2_910B3835D294ADF5_OFFSET UNITYSDK_OFFSET(0x1A0562D0)
#define RPG_GAMECORE_ANIMPARAMRANGEENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A056420)
