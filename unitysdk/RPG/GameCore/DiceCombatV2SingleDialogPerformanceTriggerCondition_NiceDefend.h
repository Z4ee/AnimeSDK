...
#define RPG_GAMECORE_DICECOMBATV2SINGLEDIALOGPERFORMANCETRIGGERCONDITION_NICEDEFEND_METHOD_3_A908C534FE7E2613_OFFSET UNITYSDK_OFFSET(0x196BBA10)
#define RPG_GAMECORE_DICECOMBATV2SINGLEDIALOGPERFORMANCETRIGGERCONDITION_NICEDEFEND_METHOD_3_C2EE12075EA4446F_OFFSET UNITYSDK_OFFSET(0x196BB690)
#define RPG_GAMECORE_DICECOMBATV2SINGLEDIALOGPERFORMANCETRIGGERCONDITION_NICEDEFEND__CTOR_OFFSET UNITYSDK_OFFSET(0x196BB680)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatV2SingleDialogPerformanceTriggerCondition_NiceDefend_TypeDefinitionIndex = 15410;
