...
#define RPG_GAMECORE_CHIMERADUELCUSTOMTALKNODE_METHOD_3_D940FF54A397E9E1_OFFSET UNITYSDK_OFFSET(0x187F88D0)
#define RPG_GAMECORE_CHIMERADUELCUSTOMTALKNODE_METHOD_3_F70DAF0F635A99DD_OFFSET UNITYSDK_OFFSET(0x187F87D0)
#define RPG_GAMECORE_CHIMERADUELCUSTOMTALKNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x187F8870)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelCustomTalkNode_TypeDefinitionIndex = 15137;
