...
#define RPG_GAMECORE_CHIMERADUELCUSTOMTALKNODE_METHOD_3_D940FF54A397E9E1_OFFSET UNITYSDK_OFFSET(0x170991A0)
#define RPG_GAMECORE_CHIMERADUELCUSTOMTALKNODE_METHOD_3_F70DAF0F635A99DD_OFFSET UNITYSDK_OFFSET(0x170990A0)
#define RPG_GAMECORE_CHIMERADUELCUSTOMTALKNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x17099140)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelCustomTalkNode_TypeDefinitionIndex = 14667;
