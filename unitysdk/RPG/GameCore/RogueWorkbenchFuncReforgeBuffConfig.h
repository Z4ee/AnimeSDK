...
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCREFORGEBUFFCONFIG_METHOD_3_079563B4A08B74F3_OFFSET UNITYSDK_OFFSET(0x18D81070)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCREFORGEBUFFCONFIG_METHOD_3_C1D0E7B00C887937_OFFSET UNITYSDK_OFFSET(0x18D80DD0)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCREFORGEBUFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D80DC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueWorkbenchFuncReforgeBuffConfig_TypeDefinitionIndex = 17117;
