...
#define RPG_GAMECORE_SETHUDTEMPLATE_METHOD_3_21C5F4774A346A06_OFFSET UNITYSDK_OFFSET(0x176D1830)
#define RPG_GAMECORE_SETHUDTEMPLATE_METHOD_3_2783C47DAC898D42_OFFSET UNITYSDK_OFFSET(0x176D18B0)
#define RPG_GAMECORE_SETHUDTEMPLATE__CTOR_OFFSET UNITYSDK_OFFSET(0x176D1880)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetHudTemplate_TypeDefinitionIndex = 19228;
