...
#define RPG_GAMECORE_RAIDCONFIGEXCELTABLE_INDEXKEY_EQUALS_OFFSET UNITYSDK_OFFSET(0x3B814A0)
#define RPG_GAMECORE_RAIDCONFIGEXCELTABLE_INDEXKEY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3B814C0)
#define RPG_GAMECORE_RAIDCONFIGEXCELTABLE_INDEXKEY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3B8B390)
#define RPG_GAMECORE_RAIDCONFIGEXCELTABLE_INDEXKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x7DC40)
