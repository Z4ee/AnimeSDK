...
#define RPG_GAMECORE_REFRESHBATTLEAVATARPANEL_METHOD_3_3FB3184A14DF4C49_OFFSET UNITYSDK_OFFSET(0x17588A00)
#define RPG_GAMECORE_REFRESHBATTLEAVATARPANEL_METHOD_3_B98B3C74BD31F93D_OFFSET UNITYSDK_OFFSET(0x17588B10)
#define RPG_GAMECORE_REFRESHBATTLEAVATARPANEL__CTOR_OFFSET UNITYSDK_OFFSET(0x17588AE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RefreshBattleAvatarPanel_TypeDefinitionIndex = 21014;
