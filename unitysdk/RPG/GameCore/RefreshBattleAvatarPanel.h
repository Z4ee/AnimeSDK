...
#define RPG_GAMECORE_REFRESHBATTLEAVATARPANEL_METHOD_3_3FB3184A14DF4C49_OFFSET UNITYSDK_OFFSET(0x19AB8E30)
#define RPG_GAMECORE_REFRESHBATTLEAVATARPANEL_METHOD_3_B98B3C74BD31F93D_OFFSET UNITYSDK_OFFSET(0x19AB8F40)
#define RPG_GAMECORE_REFRESHBATTLEAVATARPANEL__CTOR_OFFSET UNITYSDK_OFFSET(0x19AB8F10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RefreshBattleAvatarPanel_TypeDefinitionIndex = 21573;
