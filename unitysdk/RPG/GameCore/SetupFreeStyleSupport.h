...
#define RPG_GAMECORE_SETUPFREESTYLESUPPORT_METHOD_3_00E52D42D7394866_OFFSET UNITYSDK_OFFSET(0x176EA4A0)
#define RPG_GAMECORE_SETUPFREESTYLESUPPORT_METHOD_3_136DF6F08785C6EA_OFFSET UNITYSDK_OFFSET(0x176EA3D0)
#define RPG_GAMECORE_SETUPFREESTYLESUPPORT__CTOR_OFFSET UNITYSDK_OFFSET(0x176EA450)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetupFreeStyleSupport_TypeDefinitionIndex = 20076;
