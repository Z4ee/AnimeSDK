...
#define RPG_GAMECORE_SETUPFREESTYLESUPPORT_METHOD_3_00E52D42D7394866_OFFSET UNITYSDK_OFFSET(0x1D518BB0)
#define RPG_GAMECORE_SETUPFREESTYLESUPPORT_METHOD_3_3F7C9CA715B74BF3_OFFSET UNITYSDK_OFFSET(0x1D518B10)
#define RPG_GAMECORE_SETUPFREESTYLESUPPORT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D518B70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetupFreeStyleSupport_TypeDefinitionIndex = 21658;
