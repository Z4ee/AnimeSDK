...
#define RPG_GAMECORE_OPTIONALLOADBLOCKSCONFIG_METHOD_2_75F792D6443E47DC_OFFSET UNITYSDK_OFFSET(0x199DB950)
#define RPG_GAMECORE_OPTIONALLOADBLOCKSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x199DBA30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OptionalLoadBlocksConfig_TypeDefinitionIndex = 18178;
