...
#define RPG_GAMECORE_TARGETFETCHROGUEMAGICSCEPTERLIST_METHOD_4_12AA02846034D02B_OFFSET UNITYSDK_OFFSET(0x18EE5990)
#define RPG_GAMECORE_TARGETFETCHROGUEMAGICSCEPTERLIST_METHOD_4_AA68E72878A0F3DD_OFFSET UNITYSDK_OFFSET(0x18EDFBA0)
#define RPG_GAMECORE_TARGETFETCHROGUEMAGICSCEPTERLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x18EDFB50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchRogueMagicScepterList_TypeDefinitionIndex = 23004;
