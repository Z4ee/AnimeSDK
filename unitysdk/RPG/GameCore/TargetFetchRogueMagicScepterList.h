...
#define RPG_GAMECORE_TARGETFETCHROGUEMAGICSCEPTERLIST_METHOD_4_00CE453D8B0887F8_OFFSET UNITYSDK_OFFSET(0x1E1B6AB0)
#define RPG_GAMECORE_TARGETFETCHROGUEMAGICSCEPTERLIST_METHOD_4_AA68E72878A0F3DD_OFFSET UNITYSDK_OFFSET(0x1E1B6B30)
#define RPG_GAMECORE_TARGETFETCHROGUEMAGICSCEPTERLIST_METHOD_4_C6101C684AD1B2FD_OFFSET UNITYSDK_OFFSET(0x1E1B6BB0)
#define RPG_GAMECORE_TARGETFETCHROGUEMAGICSCEPTERLIST_METHOD_4_FEA335A5EDF520F0_OFFSET UNITYSDK_OFFSET(0x1E1B6B90)
#define RPG_GAMECORE_TARGETFETCHROGUEMAGICSCEPTERLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1B6B20)
