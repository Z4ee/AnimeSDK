...
#define RPG_GAMECORE_CHIMERATRIGGERWORKPERFORMANCE_METHOD_3_AF3C2410C9B8925F_OFFSET UNITYSDK_OFFSET(0x170ACAD0)
#define RPG_GAMECORE_CHIMERATRIGGERWORKPERFORMANCE_METHOD_3_DFF6144B96610AB3_OFFSET UNITYSDK_OFFSET(0x170ACBA0)
#define RPG_GAMECORE_CHIMERATRIGGERWORKPERFORMANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x170ACB90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraTriggerWorkPerformance_TypeDefinitionIndex = 14562;
