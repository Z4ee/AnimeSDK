...
#define RPG_GAMECORE_EXPEDITIONBATTLENEWLEVELSTARTACTION_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1D7DC670)
#define RPG_GAMECORE_EXPEDITIONBATTLENEWLEVELSTARTACTION_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D7DC5D0)
#define RPG_GAMECORE_EXPEDITIONBATTLENEWLEVELSTARTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7DC660)
