...
#define RPG_GAMECORE_CHIMERADUELENTITIESFILTERSELECTORCONFIG_METHOD_3_B94D27BDE53F5253_OFFSET UNITYSDK_OFFSET(0x1709A2D0)
#define RPG_GAMECORE_CHIMERADUELENTITIESFILTERSELECTORCONFIG_METHOD_3_C633EDBDDEDF8A89_OFFSET UNITYSDK_OFFSET(0x1709A270)
#define RPG_GAMECORE_CHIMERADUELENTITIESFILTERSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1709A2C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelEntitiesFilterSelectorConfig_TypeDefinitionIndex = 14610;
