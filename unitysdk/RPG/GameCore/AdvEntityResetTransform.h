...
#define RPG_GAMECORE_ADVENTITYRESETTRANSFORM_METHOD_3_76976F8DC428D25C_OFFSET UNITYSDK_OFFSET(0x1864FDB0)
#define RPG_GAMECORE_ADVENTITYRESETTRANSFORM_METHOD_3_D207189FDB92A915_OFFSET UNITYSDK_OFFSET(0x1864FD30)
#define RPG_GAMECORE_ADVENTITYRESETTRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1864FD80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvEntityResetTransform_TypeDefinitionIndex = 19513;
