...
#define RPG_GAMECORE_TARGETFETCHTEMPLATEENTITYLIST_METHOD_4_2655B0A13392E6B9_OFFSET UNITYSDK_OFFSET(0x177C0620)
#define RPG_GAMECORE_TARGETFETCHTEMPLATEENTITYLIST_METHOD_4_50316AC019140497_OFFSET UNITYSDK_OFFSET(0x177B8CB0)
#define RPG_GAMECORE_TARGETFETCHTEMPLATEENTITYLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x177B8C60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchTemplateEntityList_TypeDefinitionIndex = 22221;
