...
#define RPG_GAMECORE_TARGETFETCHTEMPLATEENTITYLIST_METHOD_4_0EF47C3794C40C47_OFFSET UNITYSDK_OFFSET(0x1D0BD8C0)
#define RPG_GAMECORE_TARGETFETCHTEMPLATEENTITYLIST_METHOD_4_50316AC019140497_OFFSET UNITYSDK_OFFSET(0x1D0BD840)
#define RPG_GAMECORE_TARGETFETCHTEMPLATEENTITYLIST_METHOD_4_7AF745F2861EFB7A_OFFSET UNITYSDK_OFFSET(0x1D0BD8A0)
#define RPG_GAMECORE_TARGETFETCHTEMPLATEENTITYLIST_METHOD_4_B564867EE79A7726_OFFSET UNITYSDK_OFFSET(0x1D0BD7C0)
#define RPG_GAMECORE_TARGETFETCHTEMPLATEENTITYLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0BD830)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchTemplateEntityList_TypeDefinitionIndex = 23089;
