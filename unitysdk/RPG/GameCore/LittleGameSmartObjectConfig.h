...
#define RPG_GAMECORE_LITTLEGAMESMARTOBJECTCONFIG_METHOD_3_303B7A9D8197DB87_OFFSET UNITYSDK_OFFSET(0x173608A0)
#define RPG_GAMECORE_LITTLEGAMESMARTOBJECTCONFIG_METHOD_3_E9C286C7BC8DEC27_OFFSET UNITYSDK_OFFSET(0x1735AFF0)
#define RPG_GAMECORE_LITTLEGAMESMARTOBJECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1735AFD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameSmartObjectConfig_TypeDefinitionIndex = 17313;
