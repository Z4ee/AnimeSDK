...
#define RPG_GAMECORE_LITTLEGAMESMARTOBJECTCONFIG_METHOD_3_303B7A9D8197DB87_OFFSET UNITYSDK_OFFSET(0x198A1EA0)
#define RPG_GAMECORE_LITTLEGAMESMARTOBJECTCONFIG_METHOD_3_E9C286C7BC8DEC27_OFFSET UNITYSDK_OFFSET(0x1989B7D0)
#define RPG_GAMECORE_LITTLEGAMESMARTOBJECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1989B7B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameSmartObjectConfig_TypeDefinitionIndex = 17948;
