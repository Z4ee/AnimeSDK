...
#define RPG_GAMECORE_LITTLEGAMESMARTOBJECTCONFIG_METHOD_3_1ED29ACF72CDB9A1_OFFSET UNITYSDK_OFFSET(0x1D205C50)
#define RPG_GAMECORE_LITTLEGAMESMARTOBJECTCONFIG_METHOD_3_E9C286C7BC8DEC27_OFFSET UNITYSDK_OFFSET(0x1D205CB0)
#define RPG_GAMECORE_LITTLEGAMESMARTOBJECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D205CA0)
