...
#define RPG_GAMECORE_LITTLEGAMESMARTOBJECTCONFIG_METHOD_3_1ED29ACF72CDB9A1_OFFSET UNITYSDK_OFFSET(0x1BCC4C80)
#define RPG_GAMECORE_LITTLEGAMESMARTOBJECTCONFIG_METHOD_3_E9C286C7BC8DEC27_OFFSET UNITYSDK_OFFSET(0x1BCC4CE0)
#define RPG_GAMECORE_LITTLEGAMESMARTOBJECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCC4CD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameSmartObjectConfig_TypeDefinitionIndex = 18127;
