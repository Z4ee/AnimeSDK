...
#define RPG_GAMECORE_UI3DMONSTERDATACOMPONENT_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB861310)
#define RPG_GAMECORE_UI3DMONSTERDATACOMPONENT_ENABLEABILITY_OFFSET UNITYSDK_OFFSET(0xB8611B0)
#define RPG_GAMECORE_UI3DMONSTERDATACOMPONENT_ENABLEALLABLITY_OFFSET UNITYSDK_OFFSET(0xB861230)
#define RPG_GAMECORE_UI3DMONSTERDATACOMPONENT_FIREEFFECTBYPATH_OFFSET UNITYSDK_OFFSET(0xB861030)
#define RPG_GAMECORE_UI3DMONSTERDATACOMPONENT_GETALLRENDERERS_OFFSET UNITYSDK_OFFSET(0xB860E20)
#define RPG_GAMECORE_UI3DMONSTERDATACOMPONENT_GET_JSONCONFIGREF_OFFSET UNITYSDK_OFFSET(0xB861350)
#define RPG_GAMECORE_UI3DMONSTERDATACOMPONENT_INITCOMPONENT_OFFSET UNITYSDK_OFFSET(0xB860CB0)
#define RPG_GAMECORE_UI3DMONSTERDATACOMPONENT_REMOVEEFFECTBYPATH_OFFSET UNITYSDK_OFFSET(0xB861110)
#define RPG_GAMECORE_UI3DMONSTERDATACOMPONENT_SETOUTLINEWIDTH_OFFSET UNITYSDK_OFFSET(0xB860EB0)
#define RPG_GAMECORE_UI3DMONSTERDATACOMPONENT_SET_JSONCONFIGREF_OFFSET UNITYSDK_OFFSET(0xB861360)
#define RPG_GAMECORE_UI3DMONSTERDATACOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0xB861370)
#define RPG_GAMECORE_UI3DMONSTERDATACOMPONENT__ONINITOWNERREF_OFFSET UNITYSDK_OFFSET(0xB860C40)
#define RPG_GAMECORE_UI3DMONSTERDATACOMPONENT__TRYENABLEABILITY_OFFSET UNITYSDK_OFFSET(0xB860D00)
#define RPG_GAMECORE_UI3DMONSTERDATACOMPONENT___IFIXBASEPROXY__ONINITOWNERREF_OFFSET UNITYSDK_OFFSET(0xB861380)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UI3DMonsterDataComponent_TypeDefinitionIndex = 53051;
