...
#define RPG_GAMECORE_CHIMERADUELHIGHESTATKALLYSELECTORCONFIG_METHOD_3_7544F02419A60E4F_OFFSET UNITYSDK_OFFSET(0x1C240B90)
#define RPG_GAMECORE_CHIMERADUELHIGHESTATKALLYSELECTORCONFIG_METHOD_3_ABD0514754CED5DE_OFFSET UNITYSDK_OFFSET(0x1C240C30)
#define RPG_GAMECORE_CHIMERADUELHIGHESTATKALLYSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C240C20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelHighestAtkAllySelectorConfig_TypeDefinitionIndex = 15328;
