...
#define RPG_GAMECORE_CHIMERADUELHIGHESTATKALLYSELECTORCONFIG_METHOD_3_7544F02419A60E4F_OFFSET UNITYSDK_OFFSET(0x1963F320)
#define RPG_GAMECORE_CHIMERADUELHIGHESTATKALLYSELECTORCONFIG_METHOD_3_ABD0514754CED5DE_OFFSET UNITYSDK_OFFSET(0x1963F3C0)
#define RPG_GAMECORE_CHIMERADUELHIGHESTATKALLYSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1963F3B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelHighestAtkAllySelectorConfig_TypeDefinitionIndex = 15164;
