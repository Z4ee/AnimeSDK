...
#define RPG_GAMECORE_CHIMERADUELHIGHESTATKALLYSELECTORCONFIG_METHOD_3_7544F02419A60E4F_OFFSET UNITYSDK_OFFSET(0x187FD210)
#define RPG_GAMECORE_CHIMERADUELHIGHESTATKALLYSELECTORCONFIG_METHOD_3_ABD0514754CED5DE_OFFSET UNITYSDK_OFFSET(0x187FD2B0)
#define RPG_GAMECORE_CHIMERADUELHIGHESTATKALLYSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x187FD2A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelHighestAtkAllySelectorConfig_TypeDefinitionIndex = 15101;
