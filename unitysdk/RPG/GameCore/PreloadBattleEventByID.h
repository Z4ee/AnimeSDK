...
#define RPG_GAMECORE_PRELOADBATTLEEVENTBYID_METHOD_3_E9EF96BF6744C302_OFFSET UNITYSDK_OFFSET(0x18C605E0)
#define RPG_GAMECORE_PRELOADBATTLEEVENTBYID_METHOD_3_F8CB8197A097446B_OFFSET UNITYSDK_OFFSET(0x18C60660)
#define RPG_GAMECORE_PRELOADBATTLEEVENTBYID__CTOR_OFFSET UNITYSDK_OFFSET(0x18C60630)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PreloadBattleEventByID_TypeDefinitionIndex = 21901;
