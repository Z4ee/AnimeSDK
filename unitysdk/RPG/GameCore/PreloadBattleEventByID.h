...
#define RPG_GAMECORE_PRELOADBATTLEEVENTBYID_METHOD_3_1B38EC2C4A3595D8_OFFSET UNITYSDK_OFFSET(0x1BA15570)
#define RPG_GAMECORE_PRELOADBATTLEEVENTBYID_METHOD_3_F8CB8197A097446B_OFFSET UNITYSDK_OFFSET(0x1BA155B0)
#define RPG_GAMECORE_PRELOADBATTLEEVENTBYID__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA155A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PreloadBattleEventByID_TypeDefinitionIndex = 22152;
