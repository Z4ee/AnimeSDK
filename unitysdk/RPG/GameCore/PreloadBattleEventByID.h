...
#define RPG_GAMECORE_PRELOADBATTLEEVENTBYID_METHOD_3_E9EF96BF6744C302_OFFSET UNITYSDK_OFFSET(0x19A817C0)
#define RPG_GAMECORE_PRELOADBATTLEEVENTBYID_METHOD_3_F8CB8197A097446B_OFFSET UNITYSDK_OFFSET(0x19A81840)
#define RPG_GAMECORE_PRELOADBATTLEEVENTBYID__CTOR_OFFSET UNITYSDK_OFFSET(0x19A81810)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PreloadBattleEventByID_TypeDefinitionIndex = 21725;
