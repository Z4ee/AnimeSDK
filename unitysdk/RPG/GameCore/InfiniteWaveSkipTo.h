...
#define RPG_GAMECORE_INFINITEWAVESKIPTO_METHOD_3_7877202168B91357_OFFSET UNITYSDK_OFFSET(0x1984F190)
#define RPG_GAMECORE_INFINITEWAVESKIPTO_METHOD_3_E223FC2559A6F1FE_OFFSET UNITYSDK_OFFSET(0x1984F210)
#define RPG_GAMECORE_INFINITEWAVESKIPTO__CTOR_OFFSET UNITYSDK_OFFSET(0x1984F1E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int InfiniteWaveSkipTo_TypeDefinitionIndex = 22404;
