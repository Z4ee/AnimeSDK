...
#define RPG_GAMECORE_INFINITEWAVESKIPTO_METHOD_3_33C90B6740DF1F4F_OFFSET UNITYSDK_OFFSET(0x1B00F490)
#define RPG_GAMECORE_INFINITEWAVESKIPTO_METHOD_3_E223FC2559A6F1FE_OFFSET UNITYSDK_OFFSET(0x1B00F4E0)
#define RPG_GAMECORE_INFINITEWAVESKIPTO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B00F4D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int InfiniteWaveSkipTo_TypeDefinitionIndex = 22846;
