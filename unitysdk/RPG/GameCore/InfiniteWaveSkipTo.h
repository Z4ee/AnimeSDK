...
#define RPG_GAMECORE_INFINITEWAVESKIPTO_METHOD_3_7877202168B91357_OFFSET UNITYSDK_OFFSET(0x172BACD0)
#define RPG_GAMECORE_INFINITEWAVESKIPTO_METHOD_3_E223FC2559A6F1FE_OFFSET UNITYSDK_OFFSET(0x172BAD50)
#define RPG_GAMECORE_INFINITEWAVESKIPTO__CTOR_OFFSET UNITYSDK_OFFSET(0x172BAD20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int InfiniteWaveSkipTo_TypeDefinitionIndex = 21949;
