...
#define RPG_GAMECORE_ROGUEMODIFIERTOURNGETFORMULAONBUFFTYPEMATCHREQUIREDNUMCONFIG_METHOD_3_038B4C3E4DEA08FF_OFFSET UNITYSDK_OFFSET(0x18D47280)
#define RPG_GAMECORE_ROGUEMODIFIERTOURNGETFORMULAONBUFFTYPEMATCHREQUIREDNUMCONFIG_METHOD_3_896A6476918D7016_OFFSET UNITYSDK_OFFSET(0x18D47350)
#define RPG_GAMECORE_ROGUEMODIFIERTOURNGETFORMULAONBUFFTYPEMATCHREQUIREDNUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D47300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierTournGetFormulaOnBuffTypeMatchRequiredNumConfig_TypeDefinitionIndex = 16882;
