...
#define RPG_GAMECORE_ROGUEMODIFIERTOURNGETFORMULAONBUFFTYPEMATCHREQUIREDNUMCONFIG_METHOD_3_038B4C3E4DEA08FF_OFFSET UNITYSDK_OFFSET(0x19B9D260)
#define RPG_GAMECORE_ROGUEMODIFIERTOURNGETFORMULAONBUFFTYPEMATCHREQUIREDNUMCONFIG_METHOD_3_896A6476918D7016_OFFSET UNITYSDK_OFFSET(0x19B9D330)
#define RPG_GAMECORE_ROGUEMODIFIERTOURNGETFORMULAONBUFFTYPEMATCHREQUIREDNUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B9D2E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierTournGetFormulaOnBuffTypeMatchRequiredNumConfig_TypeDefinitionIndex = 16897;
