...
#define RPG_GAMECORE_ROGUEMODIFIERTOURNGETFORMULAONBUFFTYPEMATCHREQUIREDNUMCONFIG_METHOD_3_896A6476918D7016_OFFSET UNITYSDK_OFFSET(0x1D166790)
#define RPG_GAMECORE_ROGUEMODIFIERTOURNGETFORMULAONBUFFTYPEMATCHREQUIREDNUMCONFIG_METHOD_3_F4A14B24E60AB9BA_OFFSET UNITYSDK_OFFSET(0x1D166740)
#define RPG_GAMECORE_ROGUEMODIFIERTOURNGETFORMULAONBUFFTYPEMATCHREQUIREDNUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D166780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierTournGetFormulaOnBuffTypeMatchRequiredNumConfig_TypeDefinitionIndex = 17059;
