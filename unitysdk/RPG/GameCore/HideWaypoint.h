...
#define RPG_GAMECORE_HIDEWAYPOINT_METHOD_3_254B9C2203D3A74D_OFFSET UNITYSDK_OFFSET(0x189FFFB0)
#define RPG_GAMECORE_HIDEWAYPOINT_METHOD_3_9B933442F1BD1491_OFFSET UNITYSDK_OFFSET(0x189FFF30)
#define RPG_GAMECORE_HIDEWAYPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x189FFF80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HideWaypoint_TypeDefinitionIndex = 19856;
