...
#define RPG_GAMECORE_NPCLODDETAIL_METHOD_3_5170ABD7599572F7_OFFSET UNITYSDK_OFFSET(0x17476950)
#define RPG_GAMECORE_NPCLODDETAIL_METHOD_3_A081879910A33027_OFFSET UNITYSDK_OFFSET(0x17476900)
#define RPG_GAMECORE_NPCLODDETAIL__CTOR_OFFSET UNITYSDK_OFFSET(0x17476940)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NpcLodDetail_TypeDefinitionIndex = 17493;
