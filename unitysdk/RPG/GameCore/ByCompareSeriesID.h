...
#define RPG_GAMECORE_BYCOMPARESERIESID_METHOD_4_23E4D6026F3795F1_OFFSET UNITYSDK_OFFSET(0x1CEFAF20)
#define RPG_GAMECORE_BYCOMPARESERIESID_METHOD_4_458E4AF41258B428_OFFSET UNITYSDK_OFFSET(0x1CEFAF50)
#define RPG_GAMECORE_BYCOMPARESERIESID_METHOD_4_9DA5B2261FE062CB_OFFSET UNITYSDK_OFFSET(0x1CEFADE0)
#define RPG_GAMECORE_BYCOMPARESERIESID_METHOD_4_F0AAF64821A379B8_OFFSET UNITYSDK_OFFSET(0x1CEFADA0)
#define RPG_GAMECORE_BYCOMPARESERIESID__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEFADD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareSeriesID_TypeDefinitionIndex = 20849;
