...
#define RPG_GAMECORE_BYCOMPARESERIESID_METHOD_4_12AE3D8EA59562D1_OFFSET UNITYSDK_OFFSET(0x1873AC90)
#define RPG_GAMECORE_BYCOMPARESERIESID_METHOD_4_9DA5B2261FE062CB_OFFSET UNITYSDK_OFFSET(0x1873AD60)
#define RPG_GAMECORE_BYCOMPARESERIESID__CTOR_OFFSET UNITYSDK_OFFSET(0x1873AD10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareSeriesID_TypeDefinitionIndex = 20069;
