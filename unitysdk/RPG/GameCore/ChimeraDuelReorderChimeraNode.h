...
#define RPG_GAMECORE_CHIMERADUELREORDERCHIMERANODE_METHOD_3_35143B3CEB6472A3_OFFSET UNITYSDK_OFFSET(0x1C246CD0)
#define RPG_GAMECORE_CHIMERADUELREORDERCHIMERANODE_METHOD_3_79E11C7AEE610B22_OFFSET UNITYSDK_OFFSET(0x1C246C30)
#define RPG_GAMECORE_CHIMERADUELREORDERCHIMERANODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C246CC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelReorderChimeraNode_TypeDefinitionIndex = 15358;
