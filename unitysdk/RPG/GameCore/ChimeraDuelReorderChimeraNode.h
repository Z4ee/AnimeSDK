...
#define RPG_GAMECORE_CHIMERADUELREORDERCHIMERANODE_METHOD_3_35143B3CEB6472A3_OFFSET UNITYSDK_OFFSET(0x19645770)
#define RPG_GAMECORE_CHIMERADUELREORDERCHIMERANODE_METHOD_3_659E048475A24F0C_OFFSET UNITYSDK_OFFSET(0x19645630)
#define RPG_GAMECORE_CHIMERADUELREORDERCHIMERANODE__CTOR_OFFSET UNITYSDK_OFFSET(0x19645720)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelReorderChimeraNode_TypeDefinitionIndex = 15194;
