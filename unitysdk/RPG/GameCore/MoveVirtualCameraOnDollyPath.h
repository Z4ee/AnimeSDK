...
#define RPG_GAMECORE_MOVEVIRTUALCAMERAONDOLLYPATH_METHOD_3_46C8677378DA12F1_OFFSET UNITYSDK_OFFSET(0x1CE755B0)
#define RPG_GAMECORE_MOVEVIRTUALCAMERAONDOLLYPATH_METHOD_3_915D9B70A7E2DF39_OFFSET UNITYSDK_OFFSET(0x1CE75560)
#define RPG_GAMECORE_MOVEVIRTUALCAMERAONDOLLYPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE755A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MoveVirtualCameraOnDollyPath_TypeDefinitionIndex = 21661;
