...
#define RPG_GAMECORE_MOVEVIRTUALCAMERAONDOLLYPATH_METHOD_3_097DB3E24DCCD92E_OFFSET UNITYSDK_OFFSET(0x199B5020)
#define RPG_GAMECORE_MOVEVIRTUALCAMERAONDOLLYPATH_METHOD_3_46C8677378DA12F1_OFFSET UNITYSDK_OFFSET(0x199B50B0)
#define RPG_GAMECORE_MOVEVIRTUALCAMERAONDOLLYPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x199B5080)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MoveVirtualCameraOnDollyPath_TypeDefinitionIndex = 20688;
