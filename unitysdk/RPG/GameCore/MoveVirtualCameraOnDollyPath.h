...
#define RPG_GAMECORE_MOVEVIRTUALCAMERAONDOLLYPATH_METHOD_3_097DB3E24DCCD92E_OFFSET UNITYSDK_OFFSET(0x17458EA0)
#define RPG_GAMECORE_MOVEVIRTUALCAMERAONDOLLYPATH_METHOD_3_46C8677378DA12F1_OFFSET UNITYSDK_OFFSET(0x17458F30)
#define RPG_GAMECORE_MOVEVIRTUALCAMERAONDOLLYPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x17458F00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MoveVirtualCameraOnDollyPath_TypeDefinitionIndex = 20079;
