...
#define RPG_GAMECORE_RESIDENTPOSSESSIONCONFIGITEM_METHOD_2_5768D85EF6A6C533_OFFSET UNITYSDK_OFFSET(0x1D3A66C0)
#define RPG_GAMECORE_RESIDENTPOSSESSIONCONFIGITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3A67F0)
