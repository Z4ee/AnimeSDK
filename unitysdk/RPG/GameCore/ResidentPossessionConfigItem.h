...
#define RPG_GAMECORE_RESIDENTPOSSESSIONCONFIGITEM_METHOD_2_5768D85EF6A6C533_OFFSET UNITYSDK_OFFSET(0x1D01D7F0)
#define RPG_GAMECORE_RESIDENTPOSSESSIONCONFIGITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D01D920)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResidentPossessionConfigItem_TypeDefinitionIndex = 15889;
