...
#define RPG_GAMECORE_RESIDENTPOSSESSIONCONFIGITEM_METHOD_2_5768D85EF6A6C533_OFFSET UNITYSDK_OFFSET(0x19AD11C0)
#define RPG_GAMECORE_RESIDENTPOSSESSIONCONFIGITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x19AD12F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResidentPossessionConfigItem_TypeDefinitionIndex = 15715;
