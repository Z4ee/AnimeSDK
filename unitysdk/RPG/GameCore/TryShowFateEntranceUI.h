...
#define RPG_GAMECORE_TRYSHOWFATEENTRANCEUI_METHOD_3_3169BCC6475D4B45_OFFSET UNITYSDK_OFFSET(0x19E21410)
#define RPG_GAMECORE_TRYSHOWFATEENTRANCEUI_METHOD_3_3826205E9590C3F1_OFFSET UNITYSDK_OFFSET(0x19E21300)
#define RPG_GAMECORE_TRYSHOWFATEENTRANCEUI__CTOR_OFFSET UNITYSDK_OFFSET(0x19E213E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TryShowFateEntranceUI_TypeDefinitionIndex = 20902;
