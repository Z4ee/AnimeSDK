...
#define RPG_GAMECORE_PHOTOGRAPHSTEALCONFIG_METHOD_2_4F6517BBFF4D83D1_OFFSET UNITYSDK_OFFSET(0x174AC690)
#define RPG_GAMECORE_PHOTOGRAPHSTEALCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x174AD290)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotoGraphStealConfig_TypeDefinitionIndex = 17472;
