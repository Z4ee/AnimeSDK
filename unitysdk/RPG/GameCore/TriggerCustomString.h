...
#define RPG_GAMECORE_TRIGGERCUSTOMSTRING_GET_ISCLIENTONLY_OFFSET UNITYSDK_OFFSET(0x1B048180)
#define RPG_GAMECORE_TRIGGERCUSTOMSTRING_METHOD_3_27FB5D031377ECC0_OFFSET UNITYSDK_OFFSET(0x1B047E10)
#define RPG_GAMECORE_TRIGGERCUSTOMSTRING_METHOD_3_84236F4B2910CEA0_OFFSET UNITYSDK_OFFSET(0x1B047F70)
#define RPG_GAMECORE_TRIGGERCUSTOMSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1B047F60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerCustomString_TypeDefinitionIndex = 22935;
	...
	public:
		...
		static ::System::Void Method_3_27FB5D031377ECC0(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::TriggerCustomString*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::TriggerCustomString*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_TRIGGERCUSTOMSTRING_METHOD_3_27FB5D031377ECC0_OFFSET))(a1, a2);
		}
