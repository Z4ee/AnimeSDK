...
#define RPG_GAMECORE_TRIGGERCUSTOMSTRING_GET_ISCLIENTONLY_OFFSET UNITYSDK_OFFSET(0x1D54A0B0)
#define RPG_GAMECORE_TRIGGERCUSTOMSTRING_METHOD_3_27FB5D031377ECC0_OFFSET UNITYSDK_OFFSET(0x1D549D40)
#define RPG_GAMECORE_TRIGGERCUSTOMSTRING_METHOD_3_84236F4B2910CEA0_OFFSET UNITYSDK_OFFSET(0x1D549EA0)
#define RPG_GAMECORE_TRIGGERCUSTOMSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1D549E90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerCustomString_TypeDefinitionIndex = 23515;
