...
#define RPG_GAMECORE_TRIGGERCUSTOMSTRING_GET_ISCLIENTONLY_OFFSET UNITYSDK_OFFSET(0x19E0A760)
#define RPG_GAMECORE_TRIGGERCUSTOMSTRING_METHOD_3_0580BEEFC66C2ECC_OFFSET UNITYSDK_OFFSET(0x19E0A360)
#define RPG_GAMECORE_TRIGGERCUSTOMSTRING_METHOD_3_84236F4B2910CEA0_OFFSET UNITYSDK_OFFSET(0x19E0A530)
#define RPG_GAMECORE_TRIGGERCUSTOMSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x19E0A500)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerCustomString_TypeDefinitionIndex = 22485;
