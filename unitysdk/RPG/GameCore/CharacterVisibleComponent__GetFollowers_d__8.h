...
#define RPG_GAMECORE_CHARACTERVISIBLECOMPONENT__GETFOLLOWERS_D__8_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xFBBE480)
#define RPG_GAMECORE_CHARACTERVISIBLECOMPONENT__GETFOLLOWERS_D__8_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_RPG_GAMECORE_CHARACTERVISIBLECOMPONENT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xFBBE530)
#define RPG_GAMECORE_CHARACTERVISIBLECOMPONENT__GETFOLLOWERS_D__8_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xFBBE590)
#define RPG_GAMECORE_CHARACTERVISIBLECOMPONENT__GETFOLLOWERS_D__8_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xFBBE540)
#define RPG_GAMECORE_CHARACTERVISIBLECOMPONENT__GETFOLLOWERS_D__8_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xFBBE470)
#define RPG_GAMECORE_CHARACTERVISIBLECOMPONENT__GETFOLLOWERS_D__8__CTOR_OFFSET UNITYSDK_OFFSET(0xFBBE460)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterVisibleComponent__GetFollowers_d__8_TypeDefinitionIndex = 54663;
