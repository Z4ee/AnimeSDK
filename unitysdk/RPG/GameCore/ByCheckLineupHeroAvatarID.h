...
#define RPG_GAMECORE_BYCHECKLINEUPHEROAVATARID_METHOD_4_F1CECD2975A7DB92_OFFSET UNITYSDK_OFFSET(0x18723310)
#define RPG_GAMECORE_BYCHECKLINEUPHEROAVATARID_METHOD_4_FC1B658F8E8D2D1B_OFFSET UNITYSDK_OFFSET(0x18723240)
#define RPG_GAMECORE_BYCHECKLINEUPHEROAVATARID__CTOR_OFFSET UNITYSDK_OFFSET(0x187232C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckLineupHeroAvatarID_TypeDefinitionIndex = 19774;
