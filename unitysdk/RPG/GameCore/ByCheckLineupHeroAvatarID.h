...
#define RPG_GAMECORE_BYCHECKLINEUPHEROAVATARID_METHOD_4_B833CF2642909536_OFFSET UNITYSDK_OFFSET(0x19CC71B0)
#define RPG_GAMECORE_BYCHECKLINEUPHEROAVATARID_METHOD_4_F1CECD2975A7DB92_OFFSET UNITYSDK_OFFSET(0x19CC7200)
#define RPG_GAMECORE_BYCHECKLINEUPHEROAVATARID__CTOR_OFFSET UNITYSDK_OFFSET(0x19CC71F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckLineupHeroAvatarID_TypeDefinitionIndex = 20009;
