...
#define RPG_GAMECORE_TIMEREWINDPRELOADCONFIG_METHOD_2_BBCF7B323B3A8579_OFFSET UNITYSDK_OFFSET(0x19DE7840)
#define RPG_GAMECORE_TIMEREWINDPRELOADCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19DE7990)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TimeRewindPreloadConfig_TypeDefinitionIndex = 15766;
