...
#define RPG_GAMECORE_TIMEREWINDPRELOADCONFIG_METHOD_2_BBCF7B323B3A8579_OFFSET UNITYSDK_OFFSET(0x1909C900)
#define RPG_GAMECORE_TIMEREWINDPRELOADCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1909CA50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TimeRewindPreloadConfig_TypeDefinitionIndex = 15710;
