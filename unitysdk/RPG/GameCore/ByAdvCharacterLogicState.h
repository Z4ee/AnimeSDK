...
#define RPG_GAMECORE_BYADVCHARACTERLOGICSTATE_METHOD_4_617FEEEDED33F674_OFFSET UNITYSDK_OFFSET(0x16FF91C0)
#define RPG_GAMECORE_BYADVCHARACTERLOGICSTATE_METHOD_4_EB72CF09F9EC135B_OFFSET UNITYSDK_OFFSET(0x16FF90A0)
#define RPG_GAMECORE_BYADVCHARACTERLOGICSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16FF9140)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByAdvCharacterLogicState_TypeDefinitionIndex = 18475;
