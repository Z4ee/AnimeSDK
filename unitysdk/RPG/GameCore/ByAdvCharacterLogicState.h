...
#define RPG_GAMECORE_BYADVCHARACTERLOGICSTATE_METHOD_4_617FEEEDED33F674_OFFSET UNITYSDK_OFFSET(0x1871D230)
#define RPG_GAMECORE_BYADVCHARACTERLOGICSTATE_METHOD_4_EB72CF09F9EC135B_OFFSET UNITYSDK_OFFSET(0x1871D110)
#define RPG_GAMECORE_BYADVCHARACTERLOGICSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1871D1B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByAdvCharacterLogicState_TypeDefinitionIndex = 19127;
