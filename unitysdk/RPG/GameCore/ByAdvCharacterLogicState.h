...
#define RPG_GAMECORE_BYADVCHARACTERLOGICSTATE_METHOD_4_3D93273F0628E22C_OFFSET UNITYSDK_OFFSET(0x19CB7170)
#define RPG_GAMECORE_BYADVCHARACTERLOGICSTATE_METHOD_4_617FEEEDED33F674_OFFSET UNITYSDK_OFFSET(0x19CB6F40)
#define RPG_GAMECORE_BYADVCHARACTERLOGICSTATE_METHOD_4_8BA3757B826582E1_OFFSET UNITYSDK_OFFSET(0x19CB7110)
#define RPG_GAMECORE_BYADVCHARACTERLOGICSTATE_METHOD_4_C89E1765CAC471ED_OFFSET UNITYSDK_OFFSET(0x19CB6EA0)
#define RPG_GAMECORE_BYADVCHARACTERLOGICSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19CB6F00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByAdvCharacterLogicState_TypeDefinitionIndex = 19413;
