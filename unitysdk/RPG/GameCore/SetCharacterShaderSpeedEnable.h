...
#define RPG_GAMECORE_SETCHARACTERSHADERSPEEDENABLE_METHOD_3_D5A02BBF1E8728DC_OFFSET UNITYSDK_OFFSET(0x18E11260)
#define RPG_GAMECORE_SETCHARACTERSHADERSPEEDENABLE_METHOD_3_E6D49E67FDC8DD6A_OFFSET UNITYSDK_OFFSET(0x18E111E0)
#define RPG_GAMECORE_SETCHARACTERSHADERSPEEDENABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E11230)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetCharacterShaderSpeedEnable_TypeDefinitionIndex = 21875;
