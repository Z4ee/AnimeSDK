...
#define RPG_GAMECORE_SETCHARACTERSHADERSPEEDENABLE_METHOD_3_D5A02BBF1E8728DC_OFFSET UNITYSDK_OFFSET(0x19C30060)
#define RPG_GAMECORE_SETCHARACTERSHADERSPEEDENABLE_METHOD_3_E6D49E67FDC8DD6A_OFFSET UNITYSDK_OFFSET(0x19C2FFE0)
#define RPG_GAMECORE_SETCHARACTERSHADERSPEEDENABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C30030)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetCharacterShaderSpeedEnable_TypeDefinitionIndex = 21699;
