...
#define RPG_GAMECORE_ST_SIDE_TRIGGERLITTLEGAMECUSTOMEVENT_METHOD_4_A1DF893D506171EF_OFFSET UNITYSDK_OFFSET(0x18DFC9E0)
#define RPG_GAMECORE_ST_SIDE_TRIGGERLITTLEGAMECUSTOMEVENT_METHOD_4_C23B7CC9FE836EA0_OFFSET UNITYSDK_OFFSET(0x18DFCAC0)
#define RPG_GAMECORE_ST_SIDE_TRIGGERLITTLEGAMECUSTOMEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x18DFCA60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_TriggerLittleGameCustomEvent_TypeDefinitionIndex = 20305;
