...
#define RPG_GAMECORE_ELFENTRANCEANCHORCONFIG_METHOD_2_D1872123B98FB2F0_OFFSET UNITYSDK_OFFSET(0x1D058C50)
#define RPG_GAMECORE_ELFENTRANCEANCHORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D058D70)
