...
#define RPG_GAMECORE_ELFENTRANCEANCHORCONFIG_METHOD_2_D1872123B98FB2F0_OFFSET UNITYSDK_OFFSET(0x1DB28AA0)
#define RPG_GAMECORE_ELFENTRANCEANCHORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB28BC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfEntranceAnchorConfig_TypeDefinitionIndex = 16018;
