...
#define RPG_GAMECORE_SETCOLLIDERCENTERFOLLOWATTACHPOINT_METHOD_3_31A1821062F58928_OFFSET UNITYSDK_OFFSET(0x1D4E8920)
#define RPG_GAMECORE_SETCOLLIDERCENTERFOLLOWATTACHPOINT_METHOD_3_FEA3773D50C1954A_OFFSET UNITYSDK_OFFSET(0x1D4E8880)
#define RPG_GAMECORE_SETCOLLIDERCENTERFOLLOWATTACHPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4E88E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetColliderCenterFollowAttachPoint_TypeDefinitionIndex = 22934;
