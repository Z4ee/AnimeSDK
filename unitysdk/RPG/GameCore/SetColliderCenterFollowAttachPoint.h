...
#define RPG_GAMECORE_SETCOLLIDERCENTERFOLLOWATTACHPOINT_METHOD_3_31A1821062F58928_OFFSET UNITYSDK_OFFSET(0x19C314E0)
#define RPG_GAMECORE_SETCOLLIDERCENTERFOLLOWATTACHPOINT_METHOD_3_FEA3773D50C1954A_OFFSET UNITYSDK_OFFSET(0x19C31400)
#define RPG_GAMECORE_SETCOLLIDERCENTERFOLLOWATTACHPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x19C31480)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetColliderCenterFollowAttachPoint_TypeDefinitionIndex = 21935;
