...
#define RPG_GAMECORE_LITTLEGAMEABILITYTEAMTOWERSWINDEFFECTCONFIG_METHOD_3_2781750CD4257C9E_OFFSET UNITYSDK_OFFSET(0x1BCBCDE0)
#define RPG_GAMECORE_LITTLEGAMEABILITYTEAMTOWERSWINDEFFECTCONFIG_METHOD_3_E26DB8DBB3A58AEC_OFFSET UNITYSDK_OFFSET(0x1BCBCE40)
#define RPG_GAMECORE_LITTLEGAMEABILITYTEAMTOWERSWINDEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCBCE30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityTeamTowersWindEffectConfig_TypeDefinitionIndex = 20615;
