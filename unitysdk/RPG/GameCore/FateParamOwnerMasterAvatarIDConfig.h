...
#define RPG_GAMECORE_FATEPARAMOWNERMASTERAVATARIDCONFIG_METHOD_6_F5ABBFCE6EECD076_OFFSET UNITYSDK_OFFSET(0x1BA74FB0)
#define RPG_GAMECORE_FATEPARAMOWNERMASTERAVATARIDCONFIG_METHOD_6_FFE80165B70C7AD2_OFFSET UNITYSDK_OFFSET(0x1BA75000)
#define RPG_GAMECORE_FATEPARAMOWNERMASTERAVATARIDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA74FF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateParamOwnerMasterAvatarIDConfig_TypeDefinitionIndex = 15977;
