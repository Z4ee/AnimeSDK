...
#define RPG_GAMECORE_FATEPARAMOWNERMASTERAVATARIDCONFIG_METHOD_6_1BD8E09EDC5834BE_OFFSET UNITYSDK_OFFSET(0x197151A0)
#define RPG_GAMECORE_FATEPARAMOWNERMASTERAVATARIDCONFIG_METHOD_6_FFE80165B70C7AD2_OFFSET UNITYSDK_OFFSET(0x19715360)
#define RPG_GAMECORE_FATEPARAMOWNERMASTERAVATARIDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197152A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateParamOwnerMasterAvatarIDConfig_TypeDefinitionIndex = 15803;
