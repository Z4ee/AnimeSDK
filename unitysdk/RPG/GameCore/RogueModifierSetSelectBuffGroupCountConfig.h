...
#define RPG_GAMECORE_ROGUEMODIFIERSETSELECTBUFFGROUPCOUNTCONFIG_METHOD_3_2866AD7D95FCEBD7_OFFSET UNITYSDK_OFFSET(0x1762D490)
#define RPG_GAMECORE_ROGUEMODIFIERSETSELECTBUFFGROUPCOUNTCONFIG_METHOD_3_C3D3F9AB4313A6DE_OFFSET UNITYSDK_OFFSET(0x176398B0)
#define RPG_GAMECORE_ROGUEMODIFIERSETSELECTBUFFGROUPCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1762D440)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierSetSelectBuffGroupCountConfig_TypeDefinitionIndex = 16512;
