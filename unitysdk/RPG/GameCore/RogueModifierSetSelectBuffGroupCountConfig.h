...
#define RPG_GAMECORE_ROGUEMODIFIERSETSELECTBUFFGROUPCOUNTCONFIG_METHOD_3_2866AD7D95FCEBD7_OFFSET UNITYSDK_OFFSET(0x18D46C50)
#define RPG_GAMECORE_ROGUEMODIFIERSETSELECTBUFFGROUPCOUNTCONFIG_METHOD_3_C3D3F9AB4313A6DE_OFFSET UNITYSDK_OFFSET(0x18D46B80)
#define RPG_GAMECORE_ROGUEMODIFIERSETSELECTBUFFGROUPCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D46C00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierSetSelectBuffGroupCountConfig_TypeDefinitionIndex = 17066;
