...
#define RPG_GAMECORE_MONOPOLYSHOWSWITCHSPETRANSITION_METHOD_3_DF071E30EAD072DB_OFFSET UNITYSDK_OFFSET(0x1D2CB580)
#define RPG_GAMECORE_MONOPOLYSHOWSWITCHSPETRANSITION_METHOD_3_FE4AE2642E11E7DE_OFFSET UNITYSDK_OFFSET(0x1D2CB650)
#define RPG_GAMECORE_MONOPOLYSHOWSWITCHSPETRANSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2CB640)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonopolyShowSwitchSpeTransition_TypeDefinitionIndex = 20700;
