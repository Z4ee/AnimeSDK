...
#define RPG_GAMECORE_MONOPOLYSHOWSWITCHSPETRANSITION_METHOD_3_3006F30E771337D2_OFFSET UNITYSDK_OFFSET(0x174484B0)
#define RPG_GAMECORE_MONOPOLYSHOWSWITCHSPETRANSITION_METHOD_3_FE4AE2642E11E7DE_OFFSET UNITYSDK_OFFSET(0x174485C0)
#define RPG_GAMECORE_MONOPOLYSHOWSWITCHSPETRANSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x17448590)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonopolyShowSwitchSpeTransition_TypeDefinitionIndex = 19268;
