...
#define RPG_GAMECORE_MONOPOLYSHOWSWITCHSPETRANSITION_METHOD_3_3006F30E771337D2_OFFSET UNITYSDK_OFFSET(0x18B55110)
#define RPG_GAMECORE_MONOPOLYSHOWSWITCHSPETRANSITION_METHOD_3_FE4AE2642E11E7DE_OFFSET UNITYSDK_OFFSET(0x18B55220)
#define RPG_GAMECORE_MONOPOLYSHOWSWITCHSPETRANSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x18B551F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonopolyShowSwitchSpeTransition_TypeDefinitionIndex = 19927;
