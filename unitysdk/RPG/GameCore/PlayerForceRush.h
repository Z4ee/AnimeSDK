...
#define RPG_GAMECORE_PLAYERFORCERUSH_METHOD_3_6D2F0D8FA00DE9FC_OFFSET UNITYSDK_OFFSET(0x174DB7C0)
#define RPG_GAMECORE_PLAYERFORCERUSH_METHOD_3_7EE4A192377F088D_OFFSET UNITYSDK_OFFSET(0x174DB740)
#define RPG_GAMECORE_PLAYERFORCERUSH__CTOR_OFFSET UNITYSDK_OFFSET(0x174DB790)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayerForceRush_TypeDefinitionIndex = 18280;
