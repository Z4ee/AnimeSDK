...
#define RPG_GAMECORE_GRIDFIGHTWAVEMONSTERINFO_METHOD_2_8F5B80DE79F17F9F_OFFSET UNITYSDK_OFFSET(0x1728B320)
#define RPG_GAMECORE_GRIDFIGHTWAVEMONSTERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1728B530)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightWaveMonsterInfo_TypeDefinitionIndex = 16665;
