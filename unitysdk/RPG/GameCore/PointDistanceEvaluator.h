...
#define RPG_GAMECORE_POINTDISTANCEEVALUATOR_METHOD_4_9AD68440421D46B6_OFFSET UNITYSDK_OFFSET(0x1D7B3970)
#define RPG_GAMECORE_POINTDISTANCEEVALUATOR_METHOD_4_9DB589771B0AE169_OFFSET UNITYSDK_OFFSET(0x1D7B39C0)
#define RPG_GAMECORE_POINTDISTANCEEVALUATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7B39B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PointDistanceEvaluator_TypeDefinitionIndex = 15458;
