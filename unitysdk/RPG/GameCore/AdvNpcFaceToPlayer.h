...
#define RPG_GAMECORE_ADVNPCFACETOPLAYER_METHOD_3_23607FD499CBD3DE_OFFSET UNITYSDK_OFFSET(0x16F36580)
#define RPG_GAMECORE_ADVNPCFACETOPLAYER_METHOD_3_5661A0069DE296B6_OFFSET UNITYSDK_OFFSET(0x16F36640)
#define RPG_GAMECORE_ADVNPCFACETOPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x16F365F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvNpcFaceToPlayer_TypeDefinitionIndex = 18625;
