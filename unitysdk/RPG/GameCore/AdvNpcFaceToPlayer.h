...
#define RPG_GAMECORE_ADVNPCFACETOPLAYER_METHOD_3_5661A0069DE296B6_OFFSET UNITYSDK_OFFSET(0x1CDD06F0)
#define RPG_GAMECORE_ADVNPCFACETOPLAYER_METHOD_3_97DB44DB402C42CD_OFFSET UNITYSDK_OFFSET(0x1CDD0680)
#define RPG_GAMECORE_ADVNPCFACETOPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDD06D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvNpcFaceToPlayer_TypeDefinitionIndex = 20100;
