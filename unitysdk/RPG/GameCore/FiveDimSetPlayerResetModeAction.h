...
#define RPG_GAMECORE_FIVEDIMSETPLAYERRESETMODEACTION_METHOD_3_ABDB99FC03D6C702_OFFSET UNITYSDK_OFFSET(0x1891BB90)
#define RPG_GAMECORE_FIVEDIMSETPLAYERRESETMODEACTION_METHOD_3_B8FF5D0F39567367_OFFSET UNITYSDK_OFFSET(0x1891BB00)
#define RPG_GAMECORE_FIVEDIMSETPLAYERRESETMODEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1891BB60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSetPlayerResetModeAction_TypeDefinitionIndex = 17797;
