...
#define RPG_GAMECORE_FIVEDIMSETPLAYERRESETMODEACTION_METHOD_3_1D8A2E3A843B3D0F_OFFSET UNITYSDK_OFFSET(0x1BEB1220)
#define RPG_GAMECORE_FIVEDIMSETPLAYERRESETMODEACTION_METHOD_3_ABDB99FC03D6C702_OFFSET UNITYSDK_OFFSET(0x1BEB1270)
#define RPG_GAMECORE_FIVEDIMSETPLAYERRESETMODEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEB1260)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSetPlayerResetModeAction_TypeDefinitionIndex = 18001;
