...
#define RPG_GAMECORE_RTDEFENCEVALUEINCREASEMENT_METHOD_2_C29214F3D1761D4E_OFFSET UNITYSDK_OFFSET(0x1D4A7BA0)
#define RPG_GAMECORE_RTDEFENCEVALUEINCREASEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4A95D0)
