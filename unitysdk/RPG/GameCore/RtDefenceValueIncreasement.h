...
#define RPG_GAMECORE_RTDEFENCEVALUEINCREASEMENT_METHOD_2_C29214F3D1761D4E_OFFSET UNITYSDK_OFFSET(0x1CCE4A50)
#define RPG_GAMECORE_RTDEFENCEVALUEINCREASEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CCE6480)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtDefenceValueIncreasement_TypeDefinitionIndex = 17849;
