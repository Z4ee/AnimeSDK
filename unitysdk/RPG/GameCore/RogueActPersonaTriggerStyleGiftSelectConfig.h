...
#define RPG_GAMECORE_ROGUEACTPERSONATRIGGERSTYLEGIFTSELECTCONFIG_METHOD_6_44445E5B97875386_OFFSET UNITYSDK_OFFSET(0x19AF4C10)
#define RPG_GAMECORE_ROGUEACTPERSONATRIGGERSTYLEGIFTSELECTCONFIG_METHOD_6_68665A3EEE64EE13_OFFSET UNITYSDK_OFFSET(0x19AF4E30)
#define RPG_GAMECORE_ROGUEACTPERSONATRIGGERSTYLEGIFTSELECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AF4D50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaTriggerStyleGiftSelectConfig_TypeDefinitionIndex = 18682;
