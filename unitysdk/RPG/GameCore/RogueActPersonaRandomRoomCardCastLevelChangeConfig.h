...
#define RPG_GAMECORE_ROGUEACTPERSONARANDOMROOMCARDCASTLEVELCHANGECONFIG_METHOD_7_49ED0B54FF0580A6_OFFSET UNITYSDK_OFFSET(0x175BFCB0)
#define RPG_GAMECORE_ROGUEACTPERSONARANDOMROOMCARDCASTLEVELCHANGECONFIG_METHOD_7_5BE399F0DF299903_OFFSET UNITYSDK_OFFSET(0x175C00E0)
#define RPG_GAMECORE_ROGUEACTPERSONARANDOMROOMCARDCASTLEVELCHANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175BFBD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaRandomRoomCardCastLevelChangeConfig_TypeDefinitionIndex = 18087;
