...
#define RPG_GAMECORE_ROTATELASERPUZZLERING_METHOD_3_7A80BBC3D61D4FB8_OFFSET UNITYSDK_OFFSET(0x18D82270)
#define RPG_GAMECORE_ROTATELASERPUZZLERING_METHOD_3_C5DFAD580894F6A9_OFFSET UNITYSDK_OFFSET(0x18D822F0)
#define RPG_GAMECORE_ROTATELASERPUZZLERING__CTOR_OFFSET UNITYSDK_OFFSET(0x18D822C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RotateLaserPuzzleRing_TypeDefinitionIndex = 21013;
