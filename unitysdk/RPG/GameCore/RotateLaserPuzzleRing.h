...
#define RPG_GAMECORE_ROTATELASERPUZZLERING_METHOD_3_7A80BBC3D61D4FB8_OFFSET UNITYSDK_OFFSET(0x17674A30)
#define RPG_GAMECORE_ROTATELASERPUZZLERING_METHOD_3_C5DFAD580894F6A9_OFFSET UNITYSDK_OFFSET(0x17674AB0)
#define RPG_GAMECORE_ROTATELASERPUZZLERING__CTOR_OFFSET UNITYSDK_OFFSET(0x17674A80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RotateLaserPuzzleRing_TypeDefinitionIndex = 20331;
