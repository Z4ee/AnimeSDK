...
#define RPG_GAMECORE_MODIFYAIVARIABLEINT_METHOD_3_8AC62E127C49795D_OFFSET UNITYSDK_OFFSET(0x1D1B4100)
#define RPG_GAMECORE_MODIFYAIVARIABLEINT_METHOD_3_A7E21FFBAB61401C_OFFSET UNITYSDK_OFFSET(0x1D1B4140)
#define RPG_GAMECORE_MODIFYAIVARIABLEINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1B4130)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyAIVariableInt_TypeDefinitionIndex = 19789;
