...
#define RPG_GAMECORE_MODIFYAIVARIABLEINT_METHOD_3_A7E21FFBAB61401C_OFFSET UNITYSDK_OFFSET(0x17429590)
#define RPG_GAMECORE_MODIFYAIVARIABLEINT_METHOD_3_E3041E04EFFAEA61_OFFSET UNITYSDK_OFFSET(0x17429510)
#define RPG_GAMECORE_MODIFYAIVARIABLEINT__CTOR_OFFSET UNITYSDK_OFFSET(0x17429560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyAIVariableInt_TypeDefinitionIndex = 18297;
