...
#define RPG_GAMECORE_CAKERACEBASEPREDICATECONFIG_METHOD_2_ACD2BFF9F4EA8C9B_OFFSET UNITYSDK_OFFSET(0x195E8F70)
#define RPG_GAMECORE_CAKERACEBASEPREDICATECONFIG_METHOD_2_EF0BDD094E731BA7_OFFSET UNITYSDK_OFFSET(0x195E39D0)
#define RPG_GAMECORE_CAKERACEBASEPREDICATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x195E8AF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceBasePredicateConfig_TypeDefinitionIndex = 17467;
