...
#define RPG_GAMECORE_CAKERACEBASEPREDICATECONFIG_METHOD_2_ACD2BFF9F4EA8C9B_OFFSET UNITYSDK_OFFSET(0x17047880)
#define RPG_GAMECORE_CAKERACEBASEPREDICATECONFIG_METHOD_2_EF0BDD094E731BA7_OFFSET UNITYSDK_OFFSET(0x170415E0)
#define RPG_GAMECORE_CAKERACEBASEPREDICATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17047400)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceBasePredicateConfig_TypeDefinitionIndex = 16870;
