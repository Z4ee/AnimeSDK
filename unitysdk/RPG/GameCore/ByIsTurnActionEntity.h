...
#define RPG_GAMECORE_BYISTURNACTIONENTITY_METHOD_4_18BE1406EF5D374D_OFFSET UNITYSDK_OFFSET(0x1CF4F2F0)
#define RPG_GAMECORE_BYISTURNACTIONENTITY_METHOD_4_5487B853AA0A77E7_OFFSET UNITYSDK_OFFSET(0x1CF4F470)
#define RPG_GAMECORE_BYISTURNACTIONENTITY_METHOD_4_6A43A69B7439DB68_OFFSET UNITYSDK_OFFSET(0x1CF4F2B0)
#define RPG_GAMECORE_BYISTURNACTIONENTITY_METHOD_4_9096EAF1E0519739_OFFSET UNITYSDK_OFFSET(0x1CF4F4A0)
#define RPG_GAMECORE_BYISTURNACTIONENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF4F2E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsTurnActionEntity_TypeDefinitionIndex = 22296;
