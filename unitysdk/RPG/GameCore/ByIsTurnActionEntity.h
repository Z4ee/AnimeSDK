...
#define RPG_GAMECORE_BYISTURNACTIONENTITY_METHOD_4_18BE1406EF5D374D_OFFSET UNITYSDK_OFFSET(0x1875A170)
#define RPG_GAMECORE_BYISTURNACTIONENTITY_METHOD_4_ED99CE0F686B6DAB_OFFSET UNITYSDK_OFFSET(0x1875A0A0)
#define RPG_GAMECORE_BYISTURNACTIONENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1875A120)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsTurnActionEntity_TypeDefinitionIndex = 21430;
