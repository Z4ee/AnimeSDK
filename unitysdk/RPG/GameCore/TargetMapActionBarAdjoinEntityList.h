...
#define RPG_GAMECORE_TARGETMAPACTIONBARADJOINENTITYLIST_METHOD_3_24A45C489545A966_OFFSET UNITYSDK_OFFSET(0x1D5B0B40)
#define RPG_GAMECORE_TARGETMAPACTIONBARADJOINENTITYLIST_METHOD_3_AF358AD86F0C73AE_OFFSET UNITYSDK_OFFSET(0x1D5B09E0)
#define RPG_GAMECORE_TARGETMAPACTIONBARADJOINENTITYLIST_METHOD_3_D8BC194B4077EE2F_OFFSET UNITYSDK_OFFSET(0x1D5B0E00)
#define RPG_GAMECORE_TARGETMAPACTIONBARADJOINENTITYLIST_METHOD_3_EAF003633F604BA5_OFFSET UNITYSDK_OFFSET(0x1D5B0D30)
#define RPG_GAMECORE_TARGETMAPACTIONBARADJOINENTITYLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5B0AB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapActionBarAdjoinEntityList_TypeDefinitionIndex = 23744;
