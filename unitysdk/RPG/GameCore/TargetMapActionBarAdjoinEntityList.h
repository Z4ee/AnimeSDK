...
#define RPG_GAMECORE_TARGETMAPACTIONBARADJOINENTITYLIST_METHOD_3_24A45C489545A966_OFFSET UNITYSDK_OFFSET(0x18EE6F80)
#define RPG_GAMECORE_TARGETMAPACTIONBARADJOINENTITYLIST_METHOD_3_AF358AD86F0C73AE_OFFSET UNITYSDK_OFFSET(0x18EE6DE0)
#define RPG_GAMECORE_TARGETMAPACTIONBARADJOINENTITYLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x18EE6ED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapActionBarAdjoinEntityList_TypeDefinitionIndex = 23007;
