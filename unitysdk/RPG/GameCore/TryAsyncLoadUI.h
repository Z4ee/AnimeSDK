...
#define RPG_GAMECORE_TRYASYNCLOADUI_METHOD_3_84F5658840E71AC3_OFFSET UNITYSDK_OFFSET(0x1B0626B0)
#define RPG_GAMECORE_TRYASYNCLOADUI_METHOD_3_B1432D3A3E5D6746_OFFSET UNITYSDK_OFFSET(0x1B062780)
#define RPG_GAMECORE_TRYASYNCLOADUI__CTOR_OFFSET UNITYSDK_OFFSET(0x1B062770)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TryAsyncLoadUI_TypeDefinitionIndex = 19786;
