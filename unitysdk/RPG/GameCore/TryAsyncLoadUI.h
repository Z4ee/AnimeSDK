...
#define RPG_GAMECORE_TRYASYNCLOADUI_METHOD_3_2D2DF5325EDAFD7A_OFFSET UNITYSDK_OFFSET(0x190CF630)
#define RPG_GAMECORE_TRYASYNCLOADUI_METHOD_3_B1432D3A3E5D6746_OFFSET UNITYSDK_OFFSET(0x190CF740)
#define RPG_GAMECORE_TRYASYNCLOADUI__CTOR_OFFSET UNITYSDK_OFFSET(0x190CF710)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TryAsyncLoadUI_TypeDefinitionIndex = 19536;
