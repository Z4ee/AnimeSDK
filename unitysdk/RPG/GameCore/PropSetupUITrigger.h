...
#define RPG_GAMECORE_PROPSETUPUITRIGGER_METHOD_3_77D0AB6BD96A31EF_OFFSET UNITYSDK_OFFSET(0x17528200)
#define RPG_GAMECORE_PROPSETUPUITRIGGER_METHOD_3_895B3E23A8ABBD65_OFFSET UNITYSDK_OFFSET(0x17528050)
#define RPG_GAMECORE_PROPSETUPUITRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x17528140)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropSetupUITrigger_TypeDefinitionIndex = 18676;
