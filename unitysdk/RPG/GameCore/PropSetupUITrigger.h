...
#define RPG_GAMECORE_PROPSETUPUITRIGGER_METHOD_3_075D24740D54102A_OFFSET UNITYSDK_OFFSET(0x1D184B60)
#define RPG_GAMECORE_PROPSETUPUITRIGGER_METHOD_3_895B3E23A8ABBD65_OFFSET UNITYSDK_OFFSET(0x1D184A80)
#define RPG_GAMECORE_PROPSETUPUITRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D184B00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropSetupUITrigger_TypeDefinitionIndex = 20146;
