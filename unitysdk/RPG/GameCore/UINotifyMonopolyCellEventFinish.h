...
#define RPG_GAMECORE_UINOTIFYMONOPOLYCELLEVENTFINISH_METHOD_3_58BD4E0F59BA7FB6_OFFSET UNITYSDK_OFFSET(0x190DF120)
#define RPG_GAMECORE_UINOTIFYMONOPOLYCELLEVENTFINISH_METHOD_3_830127DD0C400CEA_OFFSET UNITYSDK_OFFSET(0x190DF010)
#define RPG_GAMECORE_UINOTIFYMONOPOLYCELLEVENTFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x190DF0F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UINotifyMonopolyCellEventFinish_TypeDefinitionIndex = 20574;
