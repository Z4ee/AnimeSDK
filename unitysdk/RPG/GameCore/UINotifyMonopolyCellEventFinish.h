...
#define RPG_GAMECORE_UINOTIFYMONOPOLYCELLEVENTFINISH_METHOD_3_58BD4E0F59BA7FB6_OFFSET UNITYSDK_OFFSET(0x1B87C920)
#define RPG_GAMECORE_UINOTIFYMONOPOLYCELLEVENTFINISH_METHOD_3_AF0FCD939A7191F3_OFFSET UNITYSDK_OFFSET(0x1B87C850)
#define RPG_GAMECORE_UINOTIFYMONOPOLYCELLEVENTFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B87C910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UINotifyMonopolyCellEventFinish_TypeDefinitionIndex = 20924;
