...
#define RPG_GAMECORE_UINOTIFYMONOPOLYCELLEVENTFINISH_METHOD_3_58BD4E0F59BA7FB6_OFFSET UNITYSDK_OFFSET(0x178E0900)
#define RPG_GAMECORE_UINOTIFYMONOPOLYCELLEVENTFINISH_METHOD_3_830127DD0C400CEA_OFFSET UNITYSDK_OFFSET(0x178E07F0)
#define RPG_GAMECORE_UINOTIFYMONOPOLYCELLEVENTFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x178E08D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UINotifyMonopolyCellEventFinish_TypeDefinitionIndex = 19893;
