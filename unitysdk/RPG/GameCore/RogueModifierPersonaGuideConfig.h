...
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAGUIDECONFIG_METHOD_3_46FC3CA0259C1CDB_OFFSET UNITYSDK_OFFSET(0x19B99E20)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAGUIDECONFIG_METHOD_3_EA7A812E75C3E952_OFFSET UNITYSDK_OFFSET(0x19B99EF0)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAGUIDECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B99EA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierPersonaGuideConfig_TypeDefinitionIndex = 16970;
