...
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAGUIDECONFIG_METHOD_3_46FC3CA0259C1CDB_OFFSET UNITYSDK_OFFSET(0x176372F0)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAGUIDECONFIG_METHOD_3_EA7A812E75C3E952_OFFSET UNITYSDK_OFFSET(0x176373C0)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAGUIDECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17637370)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierPersonaGuideConfig_TypeDefinitionIndex = 16401;
