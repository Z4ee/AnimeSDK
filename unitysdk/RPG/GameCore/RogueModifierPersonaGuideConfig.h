...
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAGUIDECONFIG_METHOD_3_E03E3F972DA43EF6_OFFSET UNITYSDK_OFFSET(0x1D3FB400)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAGUIDECONFIG_METHOD_3_EA7A812E75C3E952_OFFSET UNITYSDK_OFFSET(0x1D3FB450)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAGUIDECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3FB440)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierPersonaGuideConfig_TypeDefinitionIndex = 17646;
