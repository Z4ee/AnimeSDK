...
#define RPG_GAMECORE_ADVFORCESETNPCALERTVALUE_METHOD_3_BB18B5DA110760EF_OFFSET UNITYSDK_OFFSET(0x1BE1D9C0)
#define RPG_GAMECORE_ADVFORCESETNPCALERTVALUE_METHOD_3_ED62A903CB0D3B02_OFFSET UNITYSDK_OFFSET(0x1BE1D980)
#define RPG_GAMECORE_ADVFORCESETNPCALERTVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE1D9B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvForceSetNpcAlertValue_TypeDefinitionIndex = 19561;
