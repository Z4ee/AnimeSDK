...
#define RPG_GAMECORE_FIVEDIMGECKOBAKEDMOVECONFIG_METHOD_3_599F9B494EF8CC76_OFFSET UNITYSDK_OFFSET(0x18903E50)
#define RPG_GAMECORE_FIVEDIMGECKOBAKEDMOVECONFIG_METHOD_3_ADCBA031FB1CE42B_OFFSET UNITYSDK_OFFSET(0x18903E10)
#define RPG_GAMECORE_FIVEDIMGECKOBAKEDMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18903E40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimGeckoBakedMoveConfig_TypeDefinitionIndex = 15798;
