...
#define RPG_GAMECORE_SETCURRENTTURNACTIONENTITY_METHOD_3_0B6BDA2DC7B96C6D_OFFSET UNITYSDK_OFFSET(0x176B1050)
#define RPG_GAMECORE_SETCURRENTTURNACTIONENTITY_METHOD_3_4E2DEB0A15BCC167_OFFSET UNITYSDK_OFFSET(0x176B0F80)
#define RPG_GAMECORE_SETCURRENTTURNACTIONENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x176B1000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetCurrentTurnActionEntity_TypeDefinitionIndex = 21917;
