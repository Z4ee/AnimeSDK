...
#define RPG_GAMECORE_SETCURRENTTURNACTIONENTITY_METHOD_3_0B6BDA2DC7B96C6D_OFFSET UNITYSDK_OFFSET(0x1E815ED0)
#define RPG_GAMECORE_SETCURRENTTURNACTIONENTITY_METHOD_3_C09D1AEAF3BBC4DC_OFFSET UNITYSDK_OFFSET(0x1E815E30)
#define RPG_GAMECORE_SETCURRENTTURNACTIONENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1E815E90)
