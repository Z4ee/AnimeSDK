...
#define RPG_GAMECORE_FATERINCASEBOARDSIMPLETALKDATA_METHOD_2_92BEBE2D40199FBB_OFFSET UNITYSDK_OFFSET(0x1BA76CB0)
#define RPG_GAMECORE_FATERINCASEBOARDSIMPLETALKDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA76DE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateRinCaseBoardSimpleTalkData_TypeDefinitionIndex = 19161;
