...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_ATTACKEFFECT_CUTIN_METHOD_3_00E14183551FB199_OFFSET UNITYSDK_OFFSET(0x17170090)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_ATTACKEFFECT_CUTIN_METHOD_3_B46AAAF70C6E31A2_OFFSET UNITYSDK_OFFSET(0x1716B770)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_ATTACKEFFECT_CUTIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1716B720)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_AttackEffect_Cutin_TypeDefinitionIndex = 14733;
