...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_ATTACKEFFECT_CUTIN_METHOD_3_00E14183551FB199_OFFSET UNITYSDK_OFFSET(0x1887B990)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_ATTACKEFFECT_CUTIN_METHOD_3_B46AAAF70C6E31A2_OFFSET UNITYSDK_OFFSET(0x18875920)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_ATTACKEFFECT_CUTIN__CTOR_OFFSET UNITYSDK_OFFSET(0x188758D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_AttackEffect_Cutin_TypeDefinitionIndex = 15203;
