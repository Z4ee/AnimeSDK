...
#define RPG_GAMECORE_STAGEREGIONLAYERCONFIG_METHOD_2_3FC7238912D0CAF9_OFFSET UNITYSDK_OFFSET(0x1D55CDF0)
#define RPG_GAMECORE_STAGEREGIONLAYERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D55CE30)
