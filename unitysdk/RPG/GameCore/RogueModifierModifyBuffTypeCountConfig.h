...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYBUFFTYPECOUNTCONFIG_METHOD_3_5ADE737C76E1E262_OFFSET UNITYSDK_OFFSET(0x1D3F9C00)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYBUFFTYPECOUNTCONFIG_METHOD_3_95500E33EC5F417E_OFFSET UNITYSDK_OFFSET(0x1D3F9C50)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYBUFFTYPECOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3F9C40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyBuffTypeCountConfig_TypeDefinitionIndex = 17723;
