...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYBUFFTYPECOUNTCONFIG_METHOD_3_95500E33EC5F417E_OFFSET UNITYSDK_OFFSET(0x17633BC0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYBUFFTYPECOUNTCONFIG_METHOD_3_EB6250A6A0187D67_OFFSET UNITYSDK_OFFSET(0x17633AF0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYBUFFTYPECOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17633B70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyBuffTypeCountConfig_TypeDefinitionIndex = 16478;
