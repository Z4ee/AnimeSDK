...
#define RPG_GAMECORE_CHALLENGEGROUPCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1705A150)
#define RPG_GAMECORE_CHALLENGEGROUPCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1705AAC0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 PreMissionID; // 0x34
		...
		::RPG::GameCore::ChallengeGroupType ChallengeGroupType; // 0x54
		::System::UInt32 RewardLineGroupID; // 0x58
		::System::UInt32 GlobalScheduleID; // 0x5C
