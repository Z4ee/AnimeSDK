...
#define RPG_GAMECORE_ADVONTARGETLOST_METHOD_3_BD2A879A1816D020_OFFSET UNITYSDK_OFFSET(0x16F39F60)
#define RPG_GAMECORE_ADVONTARGETLOST_METHOD_3_CBE2834239258519_OFFSET UNITYSDK_OFFSET(0x16F39FE0)
#define RPG_GAMECORE_ADVONTARGETLOST__CTOR_OFFSET UNITYSDK_OFFSET(0x16F39FB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvOnTargetLost_TypeDefinitionIndex = 18634;
