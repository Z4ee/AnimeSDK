...
#define RPG_GAMECORE_GLOBALSETBILLBOARDSHOWTYPE_METHOD_3_0683B15416710FE3_OFFSET UNITYSDK_OFFSET(0x197D0F20)
#define RPG_GAMECORE_GLOBALSETBILLBOARDSHOWTYPE_METHOD_3_5E0DEB9676B099DA_OFFSET UNITYSDK_OFFSET(0x197D0EA0)
#define RPG_GAMECORE_GLOBALSETBILLBOARDSHOWTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x197D0EF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GlobalSetBillboardShowType_TypeDefinitionIndex = 19325;
