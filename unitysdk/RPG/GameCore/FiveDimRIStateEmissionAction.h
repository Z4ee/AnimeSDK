...
#define RPG_GAMECORE_FIVEDIMRISTATEEMISSIONACTION_METHOD_3_0DEB56EA691156C1_OFFSET UNITYSDK_OFFSET(0x172068E0)
#define RPG_GAMECORE_FIVEDIMRISTATEEMISSIONACTION_METHOD_3_A68665766385157C_OFFSET UNITYSDK_OFFSET(0x17206950)
#define RPG_GAMECORE_FIVEDIMRISTATEEMISSIONACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x17206930)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimRIStateEmissionAction_TypeDefinitionIndex = 17159;
