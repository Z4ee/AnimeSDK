...
#define RPG_GAMECORE_FIVEDIMRISTATEEMISSIONACTION_METHOD_3_0DEB56EA691156C1_OFFSET UNITYSDK_OFFSET(0x18917F20)
#define RPG_GAMECORE_FIVEDIMRISTATEEMISSIONACTION_METHOD_3_A68665766385157C_OFFSET UNITYSDK_OFFSET(0x18917F90)
#define RPG_GAMECORE_FIVEDIMRISTATEEMISSIONACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18917F70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimRIStateEmissionAction_TypeDefinitionIndex = 17761;
