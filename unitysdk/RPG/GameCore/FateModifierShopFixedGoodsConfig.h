...
#define RPG_GAMECORE_FATEMODIFIERSHOPFIXEDGOODSCONFIG_METHOD_3_9B09B3BE8EAA3D86_OFFSET UNITYSDK_OFFSET(0x1C075470)
#define RPG_GAMECORE_FATEMODIFIERSHOPFIXEDGOODSCONFIG_METHOD_3_D358748FB8E2AA22_OFFSET UNITYSDK_OFFSET(0x1C0754C0)
#define RPG_GAMECORE_FATEMODIFIERSHOPFIXEDGOODSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0754B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateModifierShopFixedGoodsConfig_TypeDefinitionIndex = 18508;
