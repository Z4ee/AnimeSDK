...
#define RPG_GAMECORE_LEVELCIRCLEPOINTINFO_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1D1CA460)
#define RPG_GAMECORE_LEVELCIRCLEPOINTINFO_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D1CB0F0)
#define RPG_GAMECORE_LEVELCIRCLEPOINTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1CA450)
