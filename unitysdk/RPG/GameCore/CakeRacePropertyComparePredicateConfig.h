...
#define RPG_GAMECORE_CAKERACEPROPERTYCOMPAREPREDICATECONFIG_METHOD_3_8D4089929A9F64A1_OFFSET UNITYSDK_OFFSET(0x1704E8E0)
#define RPG_GAMECORE_CAKERACEPROPERTYCOMPAREPREDICATECONFIG_METHOD_3_DC26FE26846A6CFF_OFFSET UNITYSDK_OFFSET(0x1704E880)
#define RPG_GAMECORE_CAKERACEPROPERTYCOMPAREPREDICATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1704E8D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRacePropertyComparePredicateConfig_TypeDefinitionIndex = 16876;
