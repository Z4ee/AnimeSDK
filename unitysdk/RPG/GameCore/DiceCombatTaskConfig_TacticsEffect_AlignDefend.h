...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TACTICSEFFECT_ALIGNDEFEND_METHOD_3_CC9FAE086139B1F9_OFFSET UNITYSDK_OFFSET(0x1C11AA60)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TACTICSEFFECT_ALIGNDEFEND_METHOD_3_CD6AE73F0B2B3CA4_OFFSET UNITYSDK_OFFSET(0x1C11A9C0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TACTICSEFFECT_ALIGNDEFEND__CTOR_OFFSET UNITYSDK_OFFSET(0x1C11AA50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_TacticsEffect_AlignDefend_TypeDefinitionIndex = 15552;
