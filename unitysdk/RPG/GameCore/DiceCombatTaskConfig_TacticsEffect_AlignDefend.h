...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TACTICSEFFECT_ALIGNDEFEND_METHOD_3_00ED5A157E531B4E_OFFSET UNITYSDK_OFFSET(0x1887D350)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TACTICSEFFECT_ALIGNDEFEND_METHOD_3_CC9FAE086139B1F9_OFFSET UNITYSDK_OFFSET(0x18879600)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TACTICSEFFECT_ALIGNDEFEND__CTOR_OFFSET UNITYSDK_OFFSET(0x188795B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_TacticsEffect_AlignDefend_TypeDefinitionIndex = 15330;
