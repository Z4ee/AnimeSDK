...
#define RPG_GAMECORE_FIVEDIMENTITYROTATECONFIG_METHOD_2_88B5B136A0669761_OFFSET UNITYSDK_OFFSET(0x1D0E3120)
#define RPG_GAMECORE_FIVEDIMENTITYROTATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0E32F0)
