...
#define RPG_GAMECORE_FIVEDIMENTITYROTATECONFIG_METHOD_2_88B5B136A0669761_OFFSET UNITYSDK_OFFSET(0x171F0DA0)
#define RPG_GAMECORE_FIVEDIMENTITYROTATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171F0F70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimEntityRotateConfig_TypeDefinitionIndex = 17213;
