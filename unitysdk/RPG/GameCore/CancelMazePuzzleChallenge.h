...
#define RPG_GAMECORE_CANCELMAZEPUZZLECHALLENGE_METHOD_3_1B5CF87C0670873C_OFFSET UNITYSDK_OFFSET(0x187B7610)
#define RPG_GAMECORE_CANCELMAZEPUZZLECHALLENGE_METHOD_3_B321AF77242CFFCD_OFFSET UNITYSDK_OFFSET(0x187B7590)
#define RPG_GAMECORE_CANCELMAZEPUZZLECHALLENGE__CTOR_OFFSET UNITYSDK_OFFSET(0x187B75E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CancelMazePuzzleChallenge_TypeDefinitionIndex = 19324;
