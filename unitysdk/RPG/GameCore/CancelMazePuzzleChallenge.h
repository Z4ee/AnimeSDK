...
#define RPG_GAMECORE_CANCELMAZEPUZZLECHALLENGE_METHOD_3_1B5CF87C0670873C_OFFSET UNITYSDK_OFFSET(0x1CF7D0C0)
#define RPG_GAMECORE_CANCELMAZEPUZZLECHALLENGE_METHOD_3_E9D46B54B86274B7_OFFSET UNITYSDK_OFFSET(0x1CF7D080)
#define RPG_GAMECORE_CANCELMAZEPUZZLECHALLENGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF7D0B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CancelMazePuzzleChallenge_TypeDefinitionIndex = 20138;
