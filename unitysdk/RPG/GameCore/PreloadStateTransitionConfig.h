...
#define RPG_GAMECORE_PRELOADSTATETRANSITIONCONFIG_METHOD_2_70C3DE4C6B9AB9EA_OFFSET UNITYSDK_OFFSET(0x1D16EC60)
#define RPG_GAMECORE_PRELOADSTATETRANSITIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D16EE00)
