...
#define RPG_GAMECORE_CHIMERAWORKDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CFD5110)
#define RPG_GAMECORE_CHIMERAWORKDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFD53F0)
