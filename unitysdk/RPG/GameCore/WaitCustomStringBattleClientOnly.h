...
#define RPG_GAMECORE_WAITCUSTOMSTRINGBATTLECLIENTONLY_METHOD_4_02B37CAC17E3DAF6_OFFSET UNITYSDK_OFFSET(0x1B8A22A0)
#define RPG_GAMECORE_WAITCUSTOMSTRINGBATTLECLIENTONLY_METHOD_4_9382D69E5F11E0AB_OFFSET UNITYSDK_OFFSET(0x1B8A25C0)
#define RPG_GAMECORE_WAITCUSTOMSTRINGBATTLECLIENTONLY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8A2290)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitCustomStringBattleClientOnly_TypeDefinitionIndex = 22082;
