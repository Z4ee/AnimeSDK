...
#define RPG_GAMECORE_WAITCUSTOMSTRINGBATTLECLIENTONLY_METHOD_4_02B37CAC17E3DAF6_OFFSET UNITYSDK_OFFSET(0x178F6930)
#define RPG_GAMECORE_WAITCUSTOMSTRINGBATTLECLIENTONLY_METHOD_4_8A8637499F7F2987_OFFSET UNITYSDK_OFFSET(0x178F6BC0)
#define RPG_GAMECORE_WAITCUSTOMSTRINGBATTLECLIENTONLY__CTOR_OFFSET UNITYSDK_OFFSET(0x178F6900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitCustomStringBattleClientOnly_TypeDefinitionIndex = 21102;
