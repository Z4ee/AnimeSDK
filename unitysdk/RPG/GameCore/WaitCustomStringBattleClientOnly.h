...
#define RPG_GAMECORE_WAITCUSTOMSTRINGBATTLECLIENTONLY_METHOD_4_02B37CAC17E3DAF6_OFFSET UNITYSDK_OFFSET(0x190FA7F0)
#define RPG_GAMECORE_WAITCUSTOMSTRINGBATTLECLIENTONLY_METHOD_4_8A8637499F7F2987_OFFSET UNITYSDK_OFFSET(0x190FAAD0)
#define RPG_GAMECORE_WAITCUSTOMSTRINGBATTLECLIENTONLY__CTOR_OFFSET UNITYSDK_OFFSET(0x190FA7C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitCustomStringBattleClientOnly_TypeDefinitionIndex = 21819;
