...
#define RPG_GAMECORE_SETMONSTERHUDVISIBLETYPE_METHOD_3_46AD088A5AB14C12_OFFSET UNITYSDK_OFFSET(0x1E087BD0)
#define RPG_GAMECORE_SETMONSTERHUDVISIBLETYPE_METHOD_3_DE5EB9C9342219C7_OFFSET UNITYSDK_OFFSET(0x1E087C10)
#define RPG_GAMECORE_SETMONSTERHUDVISIBLETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E087C00)
