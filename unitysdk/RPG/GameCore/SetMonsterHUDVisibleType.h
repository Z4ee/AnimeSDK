...
#define RPG_GAMECORE_SETMONSTERHUDVISIBLETYPE_METHOD_3_BDDEA7FAD7E9D30C_OFFSET UNITYSDK_OFFSET(0x176D7A50)
#define RPG_GAMECORE_SETMONSTERHUDVISIBLETYPE_METHOD_3_DE5EB9C9342219C7_OFFSET UNITYSDK_OFFSET(0x176D7AD0)
#define RPG_GAMECORE_SETMONSTERHUDVISIBLETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x176D7AA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetMonsterHUDVisibleType_TypeDefinitionIndex = 21018;
