...
#define RPG_GAMECORE_UNLOADBATTLEEVENT_METHOD_3_15D8E5668D71AFC9_OFFSET UNITYSDK_OFFSET(0x190E5550)
#define RPG_GAMECORE_UNLOADBATTLEEVENT_METHOD_3_BE7554F214704A10_OFFSET UNITYSDK_OFFSET(0x190E54D0)
#define RPG_GAMECORE_UNLOADBATTLEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x190E5520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UnloadBattleEvent_TypeDefinitionIndex = 21900;
