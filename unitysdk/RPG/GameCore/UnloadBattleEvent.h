...
#define RPG_GAMECORE_UNLOADBATTLEEVENT_METHOD_3_15D8E5668D71AFC9_OFFSET UNITYSDK_OFFSET(0x1D2B30F0)
#define RPG_GAMECORE_UNLOADBATTLEEVENT_METHOD_3_E4019336B924F442_OFFSET UNITYSDK_OFFSET(0x1D2B30B0)
#define RPG_GAMECORE_UNLOADBATTLEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2B30E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UnloadBattleEvent_TypeDefinitionIndex = 22720;
