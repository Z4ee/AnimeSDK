...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONCELLDICESURFACEREPEATCONFIG_METHOD_3_2D1F20BE7A1309D7_OFFSET UNITYSDK_OFFSET(0x19B50F20)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONCELLDICESURFACEREPEATCONFIG_METHOD_3_C88C6CEC2729C4DE_OFFSET UNITYSDK_OFFSET(0x19B5C820)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONCELLDICESURFACEREPEATCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B50ED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnCellDiceSurfaceRepeatConfig_TypeDefinitionIndex = 17055;
