...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONCELLDICESURFACEREPEATCONFIG_METHOD_3_2D1F20BE7A1309D7_OFFSET UNITYSDK_OFFSET(0x1D3F7D10)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONCELLDICESURFACEREPEATCONFIG_METHOD_3_E99D965BB0665193_OFFSET UNITYSDK_OFFSET(0x1D3F7CC0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONCELLDICESURFACEREPEATCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3F7D00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnCellDiceSurfaceRepeatConfig_TypeDefinitionIndex = 17733;
