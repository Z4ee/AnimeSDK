...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONCELLDICESURFACEREPEATCONFIG_METHOD_3_2D1F20BE7A1309D7_OFFSET UNITYSDK_OFFSET(0x18D351A0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONCELLDICESURFACEREPEATCONFIG_METHOD_3_C88C6CEC2729C4DE_OFFSET UNITYSDK_OFFSET(0x18D3CC70)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONCELLDICESURFACEREPEATCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D35150)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnCellDiceSurfaceRepeatConfig_TypeDefinitionIndex = 17042;
