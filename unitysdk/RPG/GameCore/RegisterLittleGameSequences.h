...
#define RPG_GAMECORE_REGISTERLITTLEGAMESEQUENCES_METHOD_3_75BA56BD80EC0E32_OFFSET UNITYSDK_OFFSET(0x1B9C1850)
#define RPG_GAMECORE_REGISTERLITTLEGAMESEQUENCES_METHOD_3_A6A96F3E9EFD567B_OFFSET UNITYSDK_OFFSET(0x1B9C1810)
#define RPG_GAMECORE_REGISTERLITTLEGAMESEQUENCES__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9C1840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RegisterLittleGameSequences_TypeDefinitionIndex = 20625;
