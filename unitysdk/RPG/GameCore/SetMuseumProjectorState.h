...
#define RPG_GAMECORE_SETMUSEUMPROJECTORSTATE_METHOD_3_361FD9F4B46FD620_OFFSET UNITYSDK_OFFSET(0x19C592E0)
#define RPG_GAMECORE_SETMUSEUMPROJECTORSTATE_METHOD_3_DCD786DC07DEC433_OFFSET UNITYSDK_OFFSET(0x19C59370)
#define RPG_GAMECORE_SETMUSEUMPROJECTORSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C59340)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetMuseumProjectorState_TypeDefinitionIndex = 20973;
