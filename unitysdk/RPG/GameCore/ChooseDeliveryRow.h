...
#define RPG_GAMECORE_CHOOSEDELIVERYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C24F9A0)
#define RPG_GAMECORE_CHOOSEDELIVERYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C24FB40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChooseDeliveryRow_TypeDefinitionIndex = 12559;
