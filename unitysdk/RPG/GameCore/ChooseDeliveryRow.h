...
#define RPG_GAMECORE_CHOOSEDELIVERYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1E343920)
#define RPG_GAMECORE_CHOOSEDELIVERYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1E343AC0)
