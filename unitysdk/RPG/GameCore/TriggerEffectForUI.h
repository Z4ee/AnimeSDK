...
#define RPG_GAMECORE_TRIGGEREFFECTFORUI_METHOD_4_444477965FA88C33_OFFSET UNITYSDK_OFFSET(0x178C5B60)
#define RPG_GAMECORE_TRIGGEREFFECTFORUI_METHOD_4_47BA0C7E37299F55_OFFSET UNITYSDK_OFFSET(0x178C3670)
#define RPG_GAMECORE_TRIGGEREFFECTFORUI__CTOR_OFFSET UNITYSDK_OFFSET(0x178C3600)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerEffectForUI_TypeDefinitionIndex = 18436;
