...
#define RPG_GAMECORE_APPLYSWORDTRAININGOPTIONSTRATEGY_METHOD_3_147EF097F3114BC8_OFFSET UNITYSDK_OFFSET(0x186A8470)
#define RPG_GAMECORE_APPLYSWORDTRAININGOPTIONSTRATEGY_METHOD_3_DFCC468B6C3D7BFC_OFFSET UNITYSDK_OFFSET(0x186A8360)
#define RPG_GAMECORE_APPLYSWORDTRAININGOPTIONSTRATEGY__CTOR_OFFSET UNITYSDK_OFFSET(0x186A8440)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ApplySwordTrainingOptionStrategy_TypeDefinitionIndex = 19834;
