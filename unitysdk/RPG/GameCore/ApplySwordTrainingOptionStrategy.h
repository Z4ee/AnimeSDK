...
#define RPG_GAMECORE_APPLYSWORDTRAININGOPTIONSTRATEGY_METHOD_3_147EF097F3114BC8_OFFSET UNITYSDK_OFFSET(0x1A059F00)
#define RPG_GAMECORE_APPLYSWORDTRAININGOPTIONSTRATEGY_METHOD_3_608E92DD1FDA9E45_OFFSET UNITYSDK_OFFSET(0x1A059E30)
#define RPG_GAMECORE_APPLYSWORDTRAININGOPTIONSTRATEGY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A059EF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ApplySwordTrainingOptionStrategy_TypeDefinitionIndex = 20063;
