...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERREVIVEGLOBALHPCONFIG_METHOD_3_B1BB0162A4B3B99C_OFFSET UNITYSDK_OFFSET(0x1D15A7D0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERREVIVEGLOBALHPCONFIG_METHOD_3_BDE75F574B1C08D8_OFFSET UNITYSDK_OFFSET(0x1D15A820)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERREVIVEGLOBALHPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D15A810)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierReviveGlobalHpConfig_TypeDefinitionIndex = 19159;
