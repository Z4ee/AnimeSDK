...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERREVIVEGLOBALHPCONFIG_METHOD_3_6B6D4CDA29249701_OFFSET UNITYSDK_OFFSET(0x1726BDC0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERREVIVEGLOBALHPCONFIG_METHOD_3_BDE75F574B1C08D8_OFFSET UNITYSDK_OFFSET(0x17268EC0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERREVIVEGLOBALHPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17268E70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierReviveGlobalHpConfig_TypeDefinitionIndex = 17799;
