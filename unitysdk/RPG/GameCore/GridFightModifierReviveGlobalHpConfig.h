...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERREVIVEGLOBALHPCONFIG_METHOD_3_6B6D4CDA29249701_OFFSET UNITYSDK_OFFSET(0x189BECF0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERREVIVEGLOBALHPCONFIG_METHOD_3_BDE75F574B1C08D8_OFFSET UNITYSDK_OFFSET(0x189BEDC0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERREVIVEGLOBALHPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189BED70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierReviveGlobalHpConfig_TypeDefinitionIndex = 18417;
