...
#define RPG_GAMECORE_GRIDFIGHTMODULESWITCHTRAITCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D15BA60)
#define RPG_GAMECORE_GRIDFIGHTMODULESWITCHTRAITCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D15BBD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModuleSwitchTraitConfigRow_TypeDefinitionIndex = 13374;

	class GridFightModuleSwitchTraitConfigRow : public ::System::Object
	{
	public:
		::System::UInt32 TraitID; // 0x10
		::System::UInt32 OverrideTraitID; // 0x14
