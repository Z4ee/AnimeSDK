...
#define RPG_GAMECORE_PROPOVERRIDECOLLIDERCONFIG_METHOD_2_03DAEB89B05256C9_OFFSET UNITYSDK_OFFSET(0x1751AB00)
#define RPG_GAMECORE_PROPOVERRIDECOLLIDERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17521AE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropOverrideColliderConfig_TypeDefinitionIndex = 16153;
