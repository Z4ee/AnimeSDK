...
#define RPG_GAMECORE_ST_MAIN_LITTLEGAME_SELFDESTORY_METHOD_4_6A68DBA9115CE7A6_OFFSET UNITYSDK_OFFSET(0x1B784DC0)
#define RPG_GAMECORE_ST_MAIN_LITTLEGAME_SELFDESTORY_METHOD_4_EEF0747ABE55BEA3_OFFSET UNITYSDK_OFFSET(0x1B784E90)
#define RPG_GAMECORE_ST_MAIN_LITTLEGAME_SELFDESTORY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B784E80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_LittleGame_SelfDestory_TypeDefinitionIndex = 20530;
