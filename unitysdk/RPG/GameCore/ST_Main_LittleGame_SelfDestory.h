...
#define RPG_GAMECORE_ST_MAIN_LITTLEGAME_SELFDESTORY_METHOD_4_6A68DBA9115CE7A6_OFFSET UNITYSDK_OFFSET(0x1D4CBF00)
#define RPG_GAMECORE_ST_MAIN_LITTLEGAME_SELFDESTORY_METHOD_4_EEF0747ABE55BEA3_OFFSET UNITYSDK_OFFSET(0x1D4CBFD0)
#define RPG_GAMECORE_ST_MAIN_LITTLEGAME_SELFDESTORY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4CBFC0)
