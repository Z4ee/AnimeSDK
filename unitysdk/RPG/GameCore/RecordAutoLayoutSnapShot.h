...
#define RPG_GAMECORE_RECORDAUTOLAYOUTSNAPSHOT_METHOD_3_84B10ECA008E0CEE_OFFSET UNITYSDK_OFFSET(0x19AB6A70)
#define RPG_GAMECORE_RECORDAUTOLAYOUTSNAPSHOT_METHOD_3_D494D329DCD944BF_OFFSET UNITYSDK_OFFSET(0x19AB69F0)
#define RPG_GAMECORE_RECORDAUTOLAYOUTSNAPSHOT__CTOR_OFFSET UNITYSDK_OFFSET(0x19AB6A40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RecordAutoLayoutSnapShot_TypeDefinitionIndex = 21871;
