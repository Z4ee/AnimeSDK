...
#define RPG_GAMECORE_RECORDAUTOLAYOUTSNAPSHOT_METHOD_3_84B10ECA008E0CEE_OFFSET UNITYSDK_OFFSET(0x1B9BE270)
#define RPG_GAMECORE_RECORDAUTOLAYOUTSNAPSHOT_METHOD_3_F052DD3FD04DD9AD_OFFSET UNITYSDK_OFFSET(0x1B9BE230)
#define RPG_GAMECORE_RECORDAUTOLAYOUTSNAPSHOT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9BE260)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RecordAutoLayoutSnapShot_TypeDefinitionIndex = 22298;
