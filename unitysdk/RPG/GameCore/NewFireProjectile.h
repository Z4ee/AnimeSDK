...
#define RPG_GAMECORE_NEWFIREPROJECTILE_METHOD_4_276C2C77A253A714_OFFSET UNITYSDK_OFFSET(0x18B7EBF0)
#define RPG_GAMECORE_NEWFIREPROJECTILE_METHOD_4_B8F11FA84BE31C58_OFFSET UNITYSDK_OFFSET(0x18B7EC90)
#define RPG_GAMECORE_NEWFIREPROJECTILE__CTOR_OFFSET UNITYSDK_OFFSET(0x18B7EC50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NewFireProjectile_TypeDefinitionIndex = 21466;
