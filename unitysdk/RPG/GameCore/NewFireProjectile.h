...
#define RPG_GAMECORE_NEWFIREPROJECTILE_METHOD_4_2188B7BB7146C7EA_OFFSET UNITYSDK_OFFSET(0x1D2F4530)
#define RPG_GAMECORE_NEWFIREPROJECTILE_METHOD_4_FBDA3BE4C15F9E1D_OFFSET UNITYSDK_OFFSET(0x1D2F44D0)
#define RPG_GAMECORE_NEWFIREPROJECTILE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2F4510)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NewFireProjectile_TypeDefinitionIndex = 22330;
