...
#define RPG_GAMECORE_NEWFIREPROJECTILE_METHOD_4_2188B7BB7146C7EA_OFFSET UNITYSDK_OFFSET(0x1CE8DE30)
#define RPG_GAMECORE_NEWFIREPROJECTILE_METHOD_4_FBDA3BE4C15F9E1D_OFFSET UNITYSDK_OFFSET(0x1CE8DDD0)
#define RPG_GAMECORE_NEWFIREPROJECTILE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE8DE10)
