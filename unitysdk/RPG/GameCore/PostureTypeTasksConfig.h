...
#define RPG_GAMECORE_POSTURETYPETASKSCONFIG_METHOD_2_D196DDAD021EA795_OFFSET UNITYSDK_OFFSET(0x1D7B4C90)
#define RPG_GAMECORE_POSTURETYPETASKSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7B4DB0)
