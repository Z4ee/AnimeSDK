...
#define RPG_GAMECORE_HIPPLENINCIDENTCOMMITOPTIONCONFIG_METHOD_3_F86649996E9CCC17_OFFSET UNITYSDK_OFFSET(0x1B687C70)
#define RPG_GAMECORE_HIPPLENINCIDENTCOMMITOPTIONCONFIG_METHOD_3_F9A0C8B7EC4E2793_OFFSET UNITYSDK_OFFSET(0x1B687C10)
#define RPG_GAMECORE_HIPPLENINCIDENTCOMMITOPTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B687C60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HipplenIncidentCommitOptionConfig_TypeDefinitionIndex = 16150;
