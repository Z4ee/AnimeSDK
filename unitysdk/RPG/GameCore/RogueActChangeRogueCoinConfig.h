...
#define RPG_GAMECORE_ROGUEACTCHANGEROGUECOINCONFIG_METHOD_6_7D0575C7C96D8C3B_OFFSET UNITYSDK_OFFSET(0x1D02D6E0)
#define RPG_GAMECORE_ROGUEACTCHANGEROGUECOINCONFIG_METHOD_6_E1DFB6659B4885BF_OFFSET UNITYSDK_OFFSET(0x1D02D730)
#define RPG_GAMECORE_ROGUEACTCHANGEROGUECOINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D02D720)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActChangeRogueCoinConfig_TypeDefinitionIndex = 18862;
