...
#define RPG_GAMECORE_ROGUEACTCHANGEROGUECOINCONFIG_METHOD_6_510A1A5F6C66461A_OFFSET UNITYSDK_OFFSET(0x19AE33B0)
#define RPG_GAMECORE_ROGUEACTCHANGEROGUECOINCONFIG_METHOD_6_E1DFB6659B4885BF_OFFSET UNITYSDK_OFFSET(0x19AE35D0)
#define RPG_GAMECORE_ROGUEACTCHANGEROGUECOINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AE34F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActChangeRogueCoinConfig_TypeDefinitionIndex = 18586;
