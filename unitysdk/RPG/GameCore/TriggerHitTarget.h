...
#define RPG_GAMECORE_TRIGGERHITTARGET_METHOD_3_1A419D080CA4B90F_OFFSET UNITYSDK_OFFSET(0x178C8700)
#define RPG_GAMECORE_TRIGGERHITTARGET_METHOD_3_905B2FD520DF3D0E_OFFSET UNITYSDK_OFFSET(0x178C8680)
#define RPG_GAMECORE_TRIGGERHITTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x178C86D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerHitTarget_TypeDefinitionIndex = 18497;
