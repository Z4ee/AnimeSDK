...
#define RPG_GAMECORE_GRIDFIGHTCRAFTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D963CB0)
#define RPG_GAMECORE_GRIDFIGHTCRAFTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D963E50)
