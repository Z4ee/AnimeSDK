...
#define RPG_GAMECORE_GETRUANMADECAKEPERFORMANCEID_METHOD_3_2A361B0DAED867B8_OFFSET UNITYSDK_OFFSET(0x1D1441D0)
#define RPG_GAMECORE_GETRUANMADECAKEPERFORMANCEID_METHOD_3_C5D09739983A649B_OFFSET UNITYSDK_OFFSET(0x1D144210)
#define RPG_GAMECORE_GETRUANMADECAKEPERFORMANCEID__CTOR_OFFSET UNITYSDK_OFFSET(0x1D144200)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GetRuanMadeCakePerformanceID_TypeDefinitionIndex = 20858;
