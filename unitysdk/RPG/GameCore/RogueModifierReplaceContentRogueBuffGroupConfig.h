...
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEBUFFGROUPCONFIG_METHOD_3_1CFD036C0136D889_OFFSET UNITYSDK_OFFSET(0x18D44DF0)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEBUFFGROUPCONFIG_METHOD_3_9D1DEDBC74D07CB0_OFFSET UNITYSDK_OFFSET(0x18D44D20)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEBUFFGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D44DA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierReplaceContentRogueBuffGroupConfig_TypeDefinitionIndex = 16807;
