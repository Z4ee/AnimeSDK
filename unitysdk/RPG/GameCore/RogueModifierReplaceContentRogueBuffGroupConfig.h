...
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEBUFFGROUPCONFIG_METHOD_3_1CFD036C0136D889_OFFSET UNITYSDK_OFFSET(0x1EEFC7E0)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEBUFFGROUPCONFIG_METHOD_3_7FA70684B42B4F05_OFFSET UNITYSDK_OFFSET(0x1EEFC790)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEBUFFGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEFC7D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierReplaceContentRogueBuffGroupConfig_TypeDefinitionIndex = 17487;
