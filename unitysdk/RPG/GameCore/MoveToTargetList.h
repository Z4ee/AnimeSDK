...
#define RPG_GAMECORE_MOVETOTARGETLIST_METHOD_3_513BE0D63C05C07A_OFFSET UNITYSDK_OFFSET(0x1D2DAFF0)
#define RPG_GAMECORE_MOVETOTARGETLIST_METHOD_3_9F563A4666989320_OFFSET UNITYSDK_OFFSET(0x1D2DAD30)
#define RPG_GAMECORE_MOVETOTARGETLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2DAEA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MoveToTargetList_TypeDefinitionIndex = 22214;
