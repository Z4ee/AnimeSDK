...
#define RPG_GAMECORE_MOVETOTARGETLIST_METHOD_3_439FB2BC651E184E_OFFSET UNITYSDK_OFFSET(0x18B64DC0)
#define RPG_GAMECORE_MOVETOTARGETLIST_METHOD_3_513BE0D63C05C07A_OFFSET UNITYSDK_OFFSET(0x18B64F70)
#define RPG_GAMECORE_MOVETOTARGETLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x18B64E00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MoveToTargetList_TypeDefinitionIndex = 21342;
