...
#define RPG_GAMECORE_SHOWROGUELOADINGPAGE_METHOD_3_3B602943029EE417_OFFSET UNITYSDK_OFFSET(0x177021B0)
#define RPG_GAMECORE_SHOWROGUELOADINGPAGE_METHOD_3_7C9B6B2E5E4D6A8B_OFFSET UNITYSDK_OFFSET(0x177022C0)
#define RPG_GAMECORE_SHOWROGUELOADINGPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x17702290)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowRogueLoadingPage_TypeDefinitionIndex = 19129;
