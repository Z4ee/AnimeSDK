...
#define RPG_GAMECORE_RTMODIFIERCALLBACKCONFIG_METHOD_2_DE2053214280CB82_OFFSET UNITYSDK_OFFSET(0x18DD4460)
#define RPG_GAMECORE_RTMODIFIERCALLBACKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18DD45F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtModifierCallbackConfig_TypeDefinitionIndex = 16767;
