...
#define RPG_GAMECORE_NODEGRAPHRANGECONFIG_METHOD_2_9651E7521C8EB67F_OFFSET UNITYSDK_OFFSET(0x1D2F59F0)
#define RPG_GAMECORE_NODEGRAPHRANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2F5A30)
