...
#define RPG_GAMECORE_NODEGRAPHRANGECONFIG_METHOD_2_9651E7521C8EB67F_OFFSET UNITYSDK_OFFSET(0x199CEDB0)
#define RPG_GAMECORE_NODEGRAPHRANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x199CEDF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NodeGraphRangeConfig_TypeDefinitionIndex = 15627;
