...
#define RPG_GAMECORE_NODEGRAPHRANGECONFIG_METHOD_2_9651E7521C8EB67F_OFFSET UNITYSDK_OFFSET(0x18B80130)
#define RPG_GAMECORE_NODEGRAPHRANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18B80170)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NodeGraphRangeConfig_TypeDefinitionIndex = 15565;
