...
#define RPG_GAMECORE_CHIMERADUELWAITREPLACEEFFECTNODE_METHOD_3_63DABA5147D8619C_OFFSET UNITYSDK_OFFSET(0x1CFD0A20)
#define RPG_GAMECORE_CHIMERADUELWAITREPLACEEFFECTNODE_METHOD_3_EC294DFD3D49235C_OFFSET UNITYSDK_OFFSET(0x1CFD09A0)
#define RPG_GAMECORE_CHIMERADUELWAITREPLACEEFFECTNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFD0A00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelWaitReplaceEffectNode_TypeDefinitionIndex = 15783;
