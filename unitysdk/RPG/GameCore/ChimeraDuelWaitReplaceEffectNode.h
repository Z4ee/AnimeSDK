...
#define RPG_GAMECORE_CHIMERADUELWAITREPLACEEFFECTNODE_METHOD_3_03666CF8123FE44C_OFFSET UNITYSDK_OFFSET(0x170A7FD0)
#define RPG_GAMECORE_CHIMERADUELWAITREPLACEEFFECTNODE_METHOD_3_AD78BA7045AE7647_OFFSET UNITYSDK_OFFSET(0x170A80D0)
#define RPG_GAMECORE_CHIMERADUELWAITREPLACEEFFECTNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x170A8070)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelWaitReplaceEffectNode_TypeDefinitionIndex = 14650;
