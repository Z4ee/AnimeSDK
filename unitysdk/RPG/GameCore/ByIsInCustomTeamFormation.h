...
#define RPG_GAMECORE_BYISINCUSTOMTEAMFORMATION_METHOD_4_6BB02E9638D5A212_OFFSET UNITYSDK_OFFSET(0x187540C0)
#define RPG_GAMECORE_BYISINCUSTOMTEAMFORMATION_METHOD_4_E63C9A04E450ECFE_OFFSET UNITYSDK_OFFSET(0x18754190)
#define RPG_GAMECORE_BYISINCUSTOMTEAMFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x18754140)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsInCustomTeamFormation_TypeDefinitionIndex = 21529;
