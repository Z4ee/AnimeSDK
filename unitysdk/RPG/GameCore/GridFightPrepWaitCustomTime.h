...
#define RPG_GAMECORE_GRIDFIGHTPREPWAITCUSTOMTIME_METHOD_3_27ADDF7F6BE244E9_OFFSET UNITYSDK_OFFSET(0x1D070760)
#define RPG_GAMECORE_GRIDFIGHTPREPWAITCUSTOMTIME_METHOD_3_819808574CD9309A_OFFSET UNITYSDK_OFFSET(0x1D070720)
#define RPG_GAMECORE_GRIDFIGHTPREPWAITCUSTOMTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x1D070750)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightPrepWaitCustomTime_TypeDefinitionIndex = 19202;
