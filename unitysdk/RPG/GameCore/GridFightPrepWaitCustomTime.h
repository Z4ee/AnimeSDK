...
#define RPG_GAMECORE_GRIDFIGHTPREPWAITCUSTOMTIME_METHOD_3_27ADDF7F6BE244E9_OFFSET UNITYSDK_OFFSET(0x189D0700)
#define RPG_GAMECORE_GRIDFIGHTPREPWAITCUSTOMTIME_METHOD_3_C20090B966112CFA_OFFSET UNITYSDK_OFFSET(0x189D0680)
#define RPG_GAMECORE_GRIDFIGHTPREPWAITCUSTOMTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x189D06D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightPrepWaitCustomTime_TypeDefinitionIndex = 18893;
