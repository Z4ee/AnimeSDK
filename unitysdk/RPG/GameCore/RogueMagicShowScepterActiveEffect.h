...
#define RPG_GAMECORE_ROGUEMAGICSHOWSCEPTERACTIVEEFFECT_METHOD_3_87E1233BED894235_OFFSET UNITYSDK_OFFSET(0x1D93C810)
#define RPG_GAMECORE_ROGUEMAGICSHOWSCEPTERACTIVEEFFECT_METHOD_3_A3724E4BC50811D0_OFFSET UNITYSDK_OFFSET(0x1D93C850)
#define RPG_GAMECORE_ROGUEMAGICSHOWSCEPTERACTIVEEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D93C840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueMagicShowScepterActiveEffect_TypeDefinitionIndex = 23051;
