...
#define RPG_GAMECORE_ROGUEMAGICSHOWSCEPTERACTIVEEFFECT_METHOD_3_81BB0C155C44A681_OFFSET UNITYSDK_OFFSET(0x18D22DC0)
#define RPG_GAMECORE_ROGUEMAGICSHOWSCEPTERACTIVEEFFECT_METHOD_3_A3724E4BC50811D0_OFFSET UNITYSDK_OFFSET(0x18D22E40)
#define RPG_GAMECORE_ROGUEMAGICSHOWSCEPTERACTIVEEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x18D22E10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueMagicShowScepterActiveEffect_TypeDefinitionIndex = 22288;
