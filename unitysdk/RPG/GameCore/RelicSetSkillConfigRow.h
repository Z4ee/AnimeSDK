...
#define RPG_GAMECORE_RELICSETSKILLCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B9CBEF0)
#define RPG_GAMECORE_RELICSETSKILLCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9CC620)
