...
#define RPG_GAMECORE_RELICSETSKILLCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1DB89C70)
#define RPG_GAMECORE_RELICSETSKILLCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB8A360)
