...
#define RPG_GAMECORE_ALLEYEVENTEFFECTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CE0B7C0)
#define RPG_GAMECORE_ALLEYEVENTEFFECTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE0BE90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AlleyEventEffectRow_TypeDefinitionIndex = 12522;

	class AlleyEventEffectRow : public ::System::Object
	{
	public:
		::System::Single Param1; // 0x10
		::System::UInt32 EventEffectID; // 0x14
