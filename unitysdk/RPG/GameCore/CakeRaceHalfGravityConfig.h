...
#define RPG_GAMECORE_CAKERACEHALFGRAVITYCONFIG_METHOD_2_FBE18B5D84CABBC3_OFFSET UNITYSDK_OFFSET(0x1704C740)
#define RPG_GAMECORE_CAKERACEHALFGRAVITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1704C9D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceHalfGravityConfig_TypeDefinitionIndex = 16905;
