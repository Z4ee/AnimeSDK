...
#define RPG_GAMECORE_SETABILITYTAGMAPPING_METHOD_3_476C7E6C2BE4AF44_OFFSET UNITYSDK_OFFSET(0x18E06B90)
#define RPG_GAMECORE_SETABILITYTAGMAPPING_METHOD_3_A27F0B3DEF9A31A1_OFFSET UNITYSDK_OFFSET(0x18E06C10)
#define RPG_GAMECORE_SETABILITYTAGMAPPING__CTOR_OFFSET UNITYSDK_OFFSET(0x18E06BE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetAbilityTagMapping_TypeDefinitionIndex = 21611;
