...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_ADDMODIFIER_METHOD_3_5A01598E34DD80FF_OFFSET UNITYSDK_OFFSET(0x1716B270)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_ADDMODIFIER_METHOD_3_7A72BF8A3700476E_OFFSET UNITYSDK_OFFSET(0x1716FE30)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_ADDMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1716B190)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_AddModifier_TypeDefinitionIndex = 14754;
