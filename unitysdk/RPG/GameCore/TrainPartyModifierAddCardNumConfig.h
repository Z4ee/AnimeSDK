...
#define RPG_GAMECORE_TRAINPARTYMODIFIERADDCARDNUMCONFIG_METHOD_3_4D00E349036BAA05_OFFSET UNITYSDK_OFFSET(0x1D5DE3E0)
#define RPG_GAMECORE_TRAINPARTYMODIFIERADDCARDNUMCONFIG_METHOD_3_EA56E03050773389_OFFSET UNITYSDK_OFFSET(0x1D5DE430)
#define RPG_GAMECORE_TRAINPARTYMODIFIERADDCARDNUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5DE420)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyModifierAddCardNumConfig_TypeDefinitionIndex = 17895;
