...
#define RPG_GAMECORE_TRAINPARTYMODIFIERADDCARDNUMCONFIG_METHOD_3_4D00E349036BAA05_OFFSET UNITYSDK_OFFSET(0x19DF5FA0)
#define RPG_GAMECORE_TRAINPARTYMODIFIERADDCARDNUMCONFIG_METHOD_3_EA56E03050773389_OFFSET UNITYSDK_OFFSET(0x19DF5FF0)
#define RPG_GAMECORE_TRAINPARTYMODIFIERADDCARDNUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19DF5FE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyModifierAddCardNumConfig_TypeDefinitionIndex = 17216;
