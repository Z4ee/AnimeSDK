...
#define RPG_GAMECORE_TREASUREDUNGEONFLOORCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D5EC130)
#define RPG_GAMECORE_TREASUREDUNGEONFLOORCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5EC410)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 AddExploreValue; // 0x38
