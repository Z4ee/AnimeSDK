...
#define RPG_GAMECORE_TREASUREDUNGEONFLOORCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B042210)
#define RPG_GAMECORE_TREASUREDUNGEONFLOORCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0424F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TreasureDungeonFloorConfigRow_TypeDefinitionIndex = 12049;
