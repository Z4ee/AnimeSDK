...
#define RPG_GAMECORE_ADVHIDEMAZEBTN_METHOD_3_450730003F6DDAEB_OFFSET UNITYSDK_OFFSET(0x1CDCBEF0)
#define RPG_GAMECORE_ADVHIDEMAZEBTN_METHOD_3_6B6473CDF47A4A0C_OFFSET UNITYSDK_OFFSET(0x1CDCBF40)
#define RPG_GAMECORE_ADVHIDEMAZEBTN__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDCBF30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvHideMazeBtn_TypeDefinitionIndex = 23568;
