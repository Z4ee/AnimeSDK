...
#define RPG_GAMECORE_ADVHIDEMAZEBTN_METHOD_3_2BD129A5BA042A9A_OFFSET UNITYSDK_OFFSET(0x186535F0)
#define RPG_GAMECORE_ADVHIDEMAZEBTN_METHOD_3_6B6473CDF47A4A0C_OFFSET UNITYSDK_OFFSET(0x18653670)
#define RPG_GAMECORE_ADVHIDEMAZEBTN__CTOR_OFFSET UNITYSDK_OFFSET(0x18653640)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvHideMazeBtn_TypeDefinitionIndex = 22836;
