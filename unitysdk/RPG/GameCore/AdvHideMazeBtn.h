...
#define RPG_GAMECORE_ADVHIDEMAZEBTN_METHOD_3_2BD129A5BA042A9A_OFFSET UNITYSDK_OFFSET(0x16F31420)
#define RPG_GAMECORE_ADVHIDEMAZEBTN_METHOD_3_6B6473CDF47A4A0C_OFFSET UNITYSDK_OFFSET(0x16F314A0)
#define RPG_GAMECORE_ADVHIDEMAZEBTN__CTOR_OFFSET UNITYSDK_OFFSET(0x16F31470)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvHideMazeBtn_TypeDefinitionIndex = 22116;
