...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONFORMULAEVENTCONFIG_METHOD_3_59A7EB82DC499432_OFFSET UNITYSDK_OFFSET(0x18D35FA0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONFORMULAEVENTCONFIG_METHOD_3_B083ED9947DDF8BB_OFFSET UNITYSDK_OFFSET(0x18D3D470)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONFORMULAEVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D35F50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnFormulaEventConfig_TypeDefinitionIndex = 16896;
