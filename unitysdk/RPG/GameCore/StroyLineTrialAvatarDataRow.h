...
#define RPG_GAMECORE_STROYLINETRIALAVATARDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D577B90)
#define RPG_GAMECORE_STROYLINETRIALAVATARDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D577DC0)
