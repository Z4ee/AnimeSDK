...
#define RPG_GAMECORE_STROYLINETRIALAVATARDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17785BC0)
#define RPG_GAMECORE_STROYLINETRIALAVATARDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17785DE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StroyLineTrialAvatarDataRow_TypeDefinitionIndex = 13919;
