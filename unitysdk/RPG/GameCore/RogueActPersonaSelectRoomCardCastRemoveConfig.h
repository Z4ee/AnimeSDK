...
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTREMOVECONFIG_METHOD_7_876E5CB63D99AAD4_OFFSET UNITYSDK_OFFSET(0x18CCF790)
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTREMOVECONFIG_METHOD_7_F81AC84BC32B6509_OFFSET UNITYSDK_OFFSET(0x18CCEC30)
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTREMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CCEB50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaSelectRoomCardCastRemoveConfig_TypeDefinitionIndex = 18719;
