...
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTREMOVECONFIG_METHOD_7_876E5CB63D99AAD4_OFFSET UNITYSDK_OFFSET(0x175C3A20)
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTREMOVECONFIG_METHOD_7_F81AC84BC32B6509_OFFSET UNITYSDK_OFFSET(0x175C2EC0)
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTREMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175C2DE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaSelectRoomCardCastRemoveConfig_TypeDefinitionIndex = 18074;
