...
#define RPG_GAMECORE_GRIDFIGHTPLAYERLEVELCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19801F30)
#define RPG_GAMECORE_GRIDFIGHTPLAYERLEVELCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19802230)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightPlayerLevelConfigRow_TypeDefinitionIndex = 12776;
	...
	public:
		...
		::System::UInt32 Rarity3Weight; // 0x18
		::System::UInt32 PlayerLevel; // 0x1C
		::System::UInt32 Rarity5Weight; // 0x20
		::System::UInt32 AvatarMaxNumber; // 0x24
		::System::UInt32 Rarity2Weight; // 0x28
		::System::UInt32 LevelUpExp; // 0x2C
		::System::UInt32 Rarity1Weight; // 0x30
