...
#define RPG_GAMECORE_GRIDFIGHTPLAYERLEVELCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D06E800)
#define RPG_GAMECORE_GRIDFIGHTPLAYERLEVELCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D06EB00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightPlayerLevelConfigRow_TypeDefinitionIndex = 12913;
