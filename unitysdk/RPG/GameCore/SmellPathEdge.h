...
#define RPG_GAMECORE_SMELLPATHEDGE_METHOD_2_E6DA00F7CCF0F720_OFFSET UNITYSDK_OFFSET(0x177100F0)
#define RPG_GAMECORE_SMELLPATHEDGE__CTOR_OFFSET UNITYSDK_OFFSET(0x177102C0)
