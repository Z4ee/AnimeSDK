...
#define RPG_GAMECORE_GROUPVALUELOOKUPCONFIG_METHOD_2_67B54FBE4200AF31_OFFSET UNITYSDK_OFFSET(0x189E1F60)
#define RPG_GAMECORE_GROUPVALUELOOKUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189E20F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GroupValueLookUpConfig_TypeDefinitionIndex = 15505;
