...
#define RPG_GAMECORE_GROUPVALUELOOKUPCONFIG_METHOD_2_67B54FBE4200AF31_OFFSET UNITYSDK_OFFSET(0x198153A0)
#define RPG_GAMECORE_GROUPVALUELOOKUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19815530)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GroupValueLookUpConfig_TypeDefinitionIndex = 15566;
