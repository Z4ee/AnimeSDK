...
#define RPG_GAMECORE_PROPRESETPUZZLE_METHOD_3_D51B6A81FC1E9F87_OFFSET UNITYSDK_OFFSET(0x18C73800)
#define RPG_GAMECORE_PROPRESETPUZZLE_METHOD_3_E572D3AB8AF1CCF3_OFFSET UNITYSDK_OFFSET(0x18C736F0)
#define RPG_GAMECORE_PROPRESETPUZZLE__CTOR_OFFSET UNITYSDK_OFFSET(0x18C737D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropResetPuzzle_TypeDefinitionIndex = 20840;
