...
#define RPG_GAMECORE_PROPRESETPUZZLE_METHOD_3_D51B6A81FC1E9F87_OFFSET UNITYSDK_OFFSET(0x17523DC0)
#define RPG_GAMECORE_PROPRESETPUZZLE_METHOD_3_E572D3AB8AF1CCF3_OFFSET UNITYSDK_OFFSET(0x17523CB0)
#define RPG_GAMECORE_PROPRESETPUZZLE__CTOR_OFFSET UNITYSDK_OFFSET(0x17523D90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropResetPuzzle_TypeDefinitionIndex = 20158;
