...
#define RPG_GAMECORE_CHENLINGFESVCAMERACONFIG_METHOD_2_0B5278971023681C_OFFSET UNITYSDK_OFFSET(0x1E014EC0)
#define RPG_GAMECORE_CHENLINGFESVCAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1E017C30)
