...
#define RPG_GAMECORE_CHENLINGFESVCAMERACONFIG_METHOD_2_0B5278971023681C_OFFSET UNITYSDK_OFFSET(0x1C3842A0)
#define RPG_GAMECORE_CHENLINGFESVCAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C387010)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingFesVCameraConfig_TypeDefinitionIndex = 17695;
