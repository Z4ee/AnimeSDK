...
#define RPG_GAMECORE_CHENLINGFESVCAMERACONFIG_METHOD_2_0B5278971023681C_OFFSET UNITYSDK_OFFSET(0x19629E80)
#define RPG_GAMECORE_CHENLINGFESVCAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1962CB30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingFesVCameraConfig_TypeDefinitionIndex = 17522;
