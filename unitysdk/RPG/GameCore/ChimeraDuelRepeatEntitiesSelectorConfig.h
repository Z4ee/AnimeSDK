...
#define RPG_GAMECORE_CHIMERADUELREPEATENTITIESSELECTORCONFIG_METHOD_3_120EE5ECA9880F36_OFFSET UNITYSDK_OFFSET(0x19645870)
#define RPG_GAMECORE_CHIMERADUELREPEATENTITIESSELECTORCONFIG_METHOD_3_79DCB55798A4DFA7_OFFSET UNITYSDK_OFFSET(0x196457D0)
#define RPG_GAMECORE_CHIMERADUELREPEATENTITIESSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19645860)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelRepeatEntitiesSelectorConfig_TypeDefinitionIndex = 15160;
