...
#define RPG_GAMECORE_ACHIEVEMENTLEVELROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B9FB720)
#define RPG_GAMECORE_ACHIEVEMENTLEVELROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9FBD90)
