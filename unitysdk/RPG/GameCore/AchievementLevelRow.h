...
#define RPG_GAMECORE_ACHIEVEMENTLEVELROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x193C7CD0)
#define RPG_GAMECORE_ACHIEVEMENTLEVELROW__CTOR_OFFSET UNITYSDK_OFFSET(0x193C8340)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AchievementLevelRow_TypeDefinitionIndex = 10488;
