...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERGRANTBONUSEXTRABONUSCONFIG_METHOD_3_0160EE7CDE9EC9EF_OFFSET UNITYSDK_OFFSET(0x197F2920)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERGRANTBONUSEXTRABONUSCONFIG_METHOD_3_69F9BDA782CDED46_OFFSET UNITYSDK_OFFSET(0x197ED7D0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERGRANTBONUSEXTRABONUSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197ED780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierGrantBonusExtraBonusConfig_TypeDefinitionIndex = 18405;
