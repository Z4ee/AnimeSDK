...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERGRANTBONUSEXTRABONUSCONFIG_METHOD_3_5D41807BED2E92EA_OFFSET UNITYSDK_OFFSET(0x1EE6E130)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERGRANTBONUSEXTRABONUSCONFIG_METHOD_3_69F9BDA782CDED46_OFFSET UNITYSDK_OFFSET(0x1EE6E180)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERGRANTBONUSEXTRABONUSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EE6E170)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierGrantBonusExtraBonusConfig_TypeDefinitionIndex = 19178;
