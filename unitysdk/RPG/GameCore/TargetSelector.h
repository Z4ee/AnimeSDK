...
#define RPG_GAMECORE_TARGETSELECTOR_METHOD_4_38016205646F6A8A_OFFSET UNITYSDK_OFFSET(0x177B9AD0)
#define RPG_GAMECORE_TARGETSELECTOR_METHOD_4_EFC128BD1419043E_OFFSET UNITYSDK_OFFSET(0x177C4C60)
#define RPG_GAMECORE_TARGETSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x177B9A80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetSelector_TypeDefinitionIndex = 22175;
