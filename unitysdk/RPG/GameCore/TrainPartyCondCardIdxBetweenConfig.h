...
#define RPG_GAMECORE_TRAINPARTYCONDCARDIDXBETWEENCONFIG_METHOD_5_CAF938C4D11A8FC2_OFFSET UNITYSDK_OFFSET(0x19DF3730)
#define RPG_GAMECORE_TRAINPARTYCONDCARDIDXBETWEENCONFIG_METHOD_5_EEE37B0193B66A70_OFFSET UNITYSDK_OFFSET(0x19DF3600)
#define RPG_GAMECORE_TRAINPARTYCONDCARDIDXBETWEENCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19DF36B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyCondCardIdxBetweenConfig_TypeDefinitionIndex = 17199;
