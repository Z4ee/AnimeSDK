...
#define RPG_GAMECORE_TRAINPARTYCONDCARDIDXBETWEENCONFIG_METHOD_5_A41BB61113CFA6A6_OFFSET UNITYSDK_OFFSET(0x1C15F010)
#define RPG_GAMECORE_TRAINPARTYCONDCARDIDXBETWEENCONFIG_METHOD_5_CAF938C4D11A8FC2_OFFSET UNITYSDK_OFFSET(0x1C15F060)
#define RPG_GAMECORE_TRAINPARTYCONDCARDIDXBETWEENCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C15F050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyCondCardIdxBetweenConfig_TypeDefinitionIndex = 17361;
