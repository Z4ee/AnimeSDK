...
#define RPG_GAMECORE_SETENTITYTALKENABLE_METHOD_3_69B4FF9771DB715C_OFFSET UNITYSDK_OFFSET(0x176CC4D0)
#define RPG_GAMECORE_SETENTITYTALKENABLE_METHOD_3_DA8116FD96000EEA_OFFSET UNITYSDK_OFFSET(0x176CC450)
#define RPG_GAMECORE_SETENTITYTALKENABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x176CC4A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetEntityTalkEnable_TypeDefinitionIndex = 19084;
