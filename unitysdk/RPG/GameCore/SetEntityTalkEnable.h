...
#define RPG_GAMECORE_SETENTITYTALKENABLE_METHOD_3_69B4FF9771DB715C_OFFSET UNITYSDK_OFFSET(0x18E2FA10)
#define RPG_GAMECORE_SETENTITYTALKENABLE_METHOD_3_DA8116FD96000EEA_OFFSET UNITYSDK_OFFSET(0x18E2F990)
#define RPG_GAMECORE_SETENTITYTALKENABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E2F9E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetEntityTalkEnable_TypeDefinitionIndex = 19742;
