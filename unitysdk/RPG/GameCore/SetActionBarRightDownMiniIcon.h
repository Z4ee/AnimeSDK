...
#define RPG_GAMECORE_SETACTIONBARRIGHTDOWNMINIICON_METHOD_3_7DB8AC1A728905BA_OFFSET UNITYSDK_OFFSET(0x1D4DE600)
#define RPG_GAMECORE_SETACTIONBARRIGHTDOWNMINIICON_METHOD_3_FEE0C2FED21AB30B_OFFSET UNITYSDK_OFFSET(0x1D4DE650)
#define RPG_GAMECORE_SETACTIONBARRIGHTDOWNMINIICON__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4DE640)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetActionBarRightDownMiniIcon_TypeDefinitionIndex = 23015;
