...
#define RPG_GAMECORE_SETACTIONBARRIGHTDOWNMINIICON_METHOD_3_507BCBDF113F1038_OFFSET UNITYSDK_OFFSET(0x18E06FE0)
#define RPG_GAMECORE_SETACTIONBARRIGHTDOWNMINIICON_METHOD_3_FEE0C2FED21AB30B_OFFSET UNITYSDK_OFFSET(0x18E07060)
#define RPG_GAMECORE_SETACTIONBARRIGHTDOWNMINIICON__CTOR_OFFSET UNITYSDK_OFFSET(0x18E07030)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetActionBarRightDownMiniIcon_TypeDefinitionIndex = 22254;
