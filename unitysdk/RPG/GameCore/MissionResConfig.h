...
#define RPG_GAMECORE_MISSIONRESCONFIG_METHOD_2_7165980DB1194D7B_OFFSET UNITYSDK_OFFSET(0x1D1AC500)
#define RPG_GAMECORE_MISSIONRESCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1AC680)
