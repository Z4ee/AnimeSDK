...
#define RPG_GAMECORE_ROGUEMODIFIERREPLACEMAGICUNITAUTOCOMPOSERANDOMCONFIG_METHOD_3_05C43C0511AD7255_OFFSET UNITYSDK_OFFSET(0x1762C690)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACEMAGICUNITAUTOCOMPOSERANDOMCONFIG_METHOD_3_1CC6C70D5EF5757C_OFFSET UNITYSDK_OFFSET(0x17639010)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACEMAGICUNITAUTOCOMPOSERANDOMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1762C640)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierReplaceMagicUnitAutoComposeRandomConfig_TypeDefinitionIndex = 16288;
