...
#define RPG_GAMECORE_ROGUEMODIFIERREPLACEMAGICUNITAUTOCOMPOSERANDOMCONFIG_METHOD_3_05C43C0511AD7255_OFFSET UNITYSDK_OFFSET(0x19B9BD90)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACEMAGICUNITAUTOCOMPOSERANDOMCONFIG_METHOD_3_1CC6C70D5EF5757C_OFFSET UNITYSDK_OFFSET(0x19B9BCC0)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACEMAGICUNITAUTOCOMPOSERANDOMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B9BD40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierReplaceMagicUnitAutoComposeRandomConfig_TypeDefinitionIndex = 16857;
