...
#define RPG_GAMECORE_DEBATECOSTCHANGCE_METHOD_3_B212E94EB3E52C9C_OFFSET UNITYSDK_OFFSET(0x18853730)
#define RPG_GAMECORE_DEBATECOSTCHANGCE_METHOD_3_DAEC9597FB341A0C_OFFSET UNITYSDK_OFFSET(0x188537D0)
#define RPG_GAMECORE_DEBATECOSTCHANGCE__CTOR_OFFSET UNITYSDK_OFFSET(0x18853790)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DebateCostChangce_TypeDefinitionIndex = 20785;
