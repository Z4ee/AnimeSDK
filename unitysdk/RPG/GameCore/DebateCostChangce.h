...
#define RPG_GAMECORE_DEBATECOSTCHANGCE_METHOD_3_B212E94EB3E52C9C_OFFSET UNITYSDK_OFFSET(0x1714C4B0)
#define RPG_GAMECORE_DEBATECOSTCHANGCE_METHOD_3_DAEC9597FB341A0C_OFFSET UNITYSDK_OFFSET(0x1714C550)
#define RPG_GAMECORE_DEBATECOSTCHANGCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1714C510)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DebateCostChangce_TypeDefinitionIndex = 20103;
