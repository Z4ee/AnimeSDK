...
#define RPG_GAMECORE_ROGUEADVENTUREWOLFGUNSPECIALTARGETWEIGHTMAPCONFIG_METHOD_2_E745382E1704FA1E_OFFSET UNITYSDK_OFFSET(0x1D3BE020)
#define RPG_GAMECORE_ROGUEADVENTUREWOLFGUNSPECIALTARGETWEIGHTMAPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3BE060)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueAdventureWolfGunSpecialTargetWeightMapConfig_TypeDefinitionIndex = 17689;
