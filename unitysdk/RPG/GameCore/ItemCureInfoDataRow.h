...
#define RPG_GAMECORE_ITEMCUREINFODATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D1B9900)
#define RPG_GAMECORE_ITEMCUREINFODATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1BA080)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Boolean SyncServerOnUse; // 0x28
