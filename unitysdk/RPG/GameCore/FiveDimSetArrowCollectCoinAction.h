...
#define RPG_GAMECORE_FIVEDIMSETARROWCOLLECTCOINACTION_METHOD_3_9373E30E206BF907_OFFSET UNITYSDK_OFFSET(0x1BEAFB10)
#define RPG_GAMECORE_FIVEDIMSETARROWCOLLECTCOINACTION_METHOD_3_E2042654B2CC6196_OFFSET UNITYSDK_OFFSET(0x1BEAFB90)
#define RPG_GAMECORE_FIVEDIMSETARROWCOLLECTCOINACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEAFB80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSetArrowCollectCoinAction_TypeDefinitionIndex = 18048;
