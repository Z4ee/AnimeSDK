...
#define RPG_GAMECORE_BYCOMPAREFLOORCUSTOMSTRINGV2_METHOD_4_7F64F9E5859523F3_OFFSET UNITYSDK_OFFSET(0x19CE4180)
#define RPG_GAMECORE_BYCOMPAREFLOORCUSTOMSTRINGV2_METHOD_4_8585A65610E1C35C_OFFSET UNITYSDK_OFFSET(0x19CE4140)
#define RPG_GAMECORE_BYCOMPAREFLOORCUSTOMSTRINGV2_METHOD_4_87309496852D89B4_OFFSET UNITYSDK_OFFSET(0x19CE3F10)
#define RPG_GAMECORE_BYCOMPAREFLOORCUSTOMSTRINGV2_METHOD_4_FFFDB48299B47745_OFFSET UNITYSDK_OFFSET(0x19CE3EC0)
#define RPG_GAMECORE_BYCOMPAREFLOORCUSTOMSTRINGV2__CTOR_OFFSET UNITYSDK_OFFSET(0x19CE3F00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareFloorCustomStringV2_TypeDefinitionIndex = 19916;
