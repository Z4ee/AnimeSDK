...
#define RPG_GAMECORE_ST_SIDE_PLAYFREESTYLE_METHOD_4_3DEA35E801CB9D8A_OFFSET UNITYSDK_OFFSET(0x1C2C44F0)
#define RPG_GAMECORE_ST_SIDE_PLAYFREESTYLE_METHOD_4_F8FC78F4F51C3D07_OFFSET UNITYSDK_OFFSET(0x1C2C4580)
#define RPG_GAMECORE_ST_SIDE_PLAYFREESTYLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2C4550)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_PlayFreeStyle_TypeDefinitionIndex = 19344;
