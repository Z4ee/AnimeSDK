...
#define RPG_GAMECORE_ST_SIDE_PLAYFREESTYLE_METHOD_4_87B5F9D3E3770089_OFFSET UNITYSDK_OFFSET(0x17699950)
#define RPG_GAMECORE_ST_SIDE_PLAYFREESTYLE_METHOD_4_F8FC78F4F51C3D07_OFFSET UNITYSDK_OFFSET(0x1768E6F0)
#define RPG_GAMECORE_ST_SIDE_PLAYFREESTYLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1768E670)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_PlayFreeStyle_TypeDefinitionIndex = 18408;
