...
#define RPG_GAMECORE_PROPCURVEMOVESTARTMODE_CIRCLE_METHOD_3_9DB5B83664B0F9AB_OFFSET UNITYSDK_OFFSET(0x1BA1D870)
#define RPG_GAMECORE_PROPCURVEMOVESTARTMODE_CIRCLE_METHOD_3_AC3EDB92E0AEB42E_OFFSET UNITYSDK_OFFSET(0x1BA1D4C0)
#define RPG_GAMECORE_PROPCURVEMOVESTARTMODE_CIRCLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA1D4B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropCurveMoveStartMode_Circle_TypeDefinitionIndex = 20218;
