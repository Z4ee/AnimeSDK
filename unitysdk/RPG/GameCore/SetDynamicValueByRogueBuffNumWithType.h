...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEBUFFNUMWITHTYPE_METHOD_3_2681482AA1B8502D_OFFSET UNITYSDK_OFFSET(0x1E821DC0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEBUFFNUMWITHTYPE_METHOD_3_3BEA0008D00F2AE0_OFFSET UNITYSDK_OFFSET(0x1E821D80)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEBUFFNUMWITHTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E821DB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRogueBuffNumWithType_TypeDefinitionIndex = 21529;
