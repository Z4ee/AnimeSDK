...
#define RPG_GAMECORE_CHARACTERCAMPCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B71D270)
#define RPG_GAMECORE_CHARACTERCAMPCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B71D9C0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::CharacterCampType CampType; // 0x18
