...
#define RPG_GAMECORE_MAPPINGINFOROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18A94330)
#define RPG_GAMECORE_MAPPINGINFOROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18A94C80)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Boolean IsShowInFog; // 0x4D
		::System::Boolean IsShowMonsterSummon; // 0x4E
		::RPG::GameCore::MappingInfoType Type; // 0x50
