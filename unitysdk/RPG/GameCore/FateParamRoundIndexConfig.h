...
#define RPG_GAMECORE_FATEPARAMROUNDINDEXCONFIG_METHOD_6_9F1FD203E85FE4AD_OFFSET UNITYSDK_OFFSET(0x171CBE00)
#define RPG_GAMECORE_FATEPARAMROUNDINDEXCONFIG_METHOD_6_DCFBA9F8F18722D9_OFFSET UNITYSDK_OFFSET(0x171CBC40)
#define RPG_GAMECORE_FATEPARAMROUNDINDEXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171CBD40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateParamRoundIndexConfig_TypeDefinitionIndex = 15231;
