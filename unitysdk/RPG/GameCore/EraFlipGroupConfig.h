...
#define RPG_GAMECORE_ERAFLIPGROUPCONFIG_METHOD_2_780220646BAABBAD_OFFSET UNITYSDK_OFFSET(0x171A9BB0)
#define RPG_GAMECORE_ERAFLIPGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171A9C70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EraFlipGroupConfig_TypeDefinitionIndex = 15220;
