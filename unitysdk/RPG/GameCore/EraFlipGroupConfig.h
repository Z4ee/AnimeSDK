...
#define RPG_GAMECORE_ERAFLIPGROUPCONFIG_METHOD_2_780220646BAABBAD_OFFSET UNITYSDK_OFFSET(0x196F4D60)
#define RPG_GAMECORE_ERAFLIPGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x196F4E20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EraFlipGroupConfig_TypeDefinitionIndex = 15789;
