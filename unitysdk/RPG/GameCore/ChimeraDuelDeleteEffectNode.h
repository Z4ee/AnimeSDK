...
#define RPG_GAMECORE_CHIMERADUELDELETEEFFECTNODE_METHOD_3_8B36ECAFF1A00CAB_OFFSET UNITYSDK_OFFSET(0x1CFC3680)
#define RPG_GAMECORE_CHIMERADUELDELETEEFFECTNODE_METHOD_3_FB35BF8D821C5CBD_OFFSET UNITYSDK_OFFSET(0x1CFC36E0)
#define RPG_GAMECORE_CHIMERADUELDELETEEFFECTNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFC36D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelDeleteEffectNode_TypeDefinitionIndex = 15782;
