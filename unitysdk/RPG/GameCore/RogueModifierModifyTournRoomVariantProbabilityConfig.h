...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYTOURNROOMVARIANTPROBABILITYCONFIG_METHOD_3_2F2BE0CD0C14E7BC_OFFSET UNITYSDK_OFFSET(0x18D433C0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYTOURNROOMVARIANTPROBABILITYCONFIG_METHOD_3_B231F61AA506EA95_OFFSET UNITYSDK_OFFSET(0x18D43490)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYTOURNROOMVARIANTPROBABILITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D43440)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyTournRoomVariantProbabilityConfig_TypeDefinitionIndex = 16880;
