...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYTOURNROOMVARIANTPROBABILITYCONFIG_METHOD_3_2F2BE0CD0C14E7BC_OFFSET UNITYSDK_OFFSET(0x19B993A0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYTOURNROOMVARIANTPROBABILITYCONFIG_METHOD_3_B231F61AA506EA95_OFFSET UNITYSDK_OFFSET(0x19B99470)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYTOURNROOMVARIANTPROBABILITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B99420)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyTournRoomVariantProbabilityConfig_TypeDefinitionIndex = 16895;
