...
#define RPG_GAMECORE_DESTROYCURVEPROPGROUPPUZZLE_METHOD_3_780EBC3ACF46B38A_OFFSET UNITYSDK_OFFSET(0x1D8172B0)
#define RPG_GAMECORE_DESTROYCURVEPROPGROUPPUZZLE_METHOD_3_BB26D93CC5B03D31_OFFSET UNITYSDK_OFFSET(0x1D8172F0)
#define RPG_GAMECORE_DESTROYCURVEPROPGROUPPUZZLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D8172E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DestroyCurvePropGroupPuzzle_TypeDefinitionIndex = 21439;
