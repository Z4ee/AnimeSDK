...
#define RPG_GAMECORE_DESTROYCURVEPROPGROUPPUZZLE_METHOD_3_A3A08746ADAC72D8_OFFSET UNITYSDK_OFFSET(0x1969A650)
#define RPG_GAMECORE_DESTROYCURVEPROPGROUPPUZZLE_METHOD_3_BB26D93CC5B03D31_OFFSET UNITYSDK_OFFSET(0x1969A6D0)
#define RPG_GAMECORE_DESTROYCURVEPROPGROUPPUZZLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1969A6A0)
