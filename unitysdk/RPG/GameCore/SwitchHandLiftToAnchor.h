...
#define RPG_GAMECORE_SWITCHHANDLIFTTOANCHOR_METHOD_3_10AB6AE4EE6B1B3A_OFFSET UNITYSDK_OFFSET(0x19CDB4A0)
#define RPG_GAMECORE_SWITCHHANDLIFTTOANCHOR_METHOD_3_18586900149606B8_OFFSET UNITYSDK_OFFSET(0x19CDB420)
#define RPG_GAMECORE_SWITCHHANDLIFTTOANCHOR__CTOR_OFFSET UNITYSDK_OFFSET(0x19CDB470)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchHandLiftToAnchor_TypeDefinitionIndex = 19814;
