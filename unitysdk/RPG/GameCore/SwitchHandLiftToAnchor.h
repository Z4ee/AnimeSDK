...
#define RPG_GAMECORE_SWITCHHANDLIFTTOANCHOR_METHOD_3_03190612B8A3CDF5_OFFSET UNITYSDK_OFFSET(0x1E14F0E0)
#define RPG_GAMECORE_SWITCHHANDLIFTTOANCHOR_METHOD_3_10AB6AE4EE6B1B3A_OFFSET UNITYSDK_OFFSET(0x1E14F120)
#define RPG_GAMECORE_SWITCHHANDLIFTTOANCHOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1E14F110)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchHandLiftToAnchor_TypeDefinitionIndex = 20724;
