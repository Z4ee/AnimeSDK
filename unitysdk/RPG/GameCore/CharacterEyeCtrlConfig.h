...
#define RPG_GAMECORE_CHARACTEREYECTRLCONFIG_METHOD_2_9971E5FA12C1D8E2_OFFSET UNITYSDK_OFFSET(0x1706BC60)
#define RPG_GAMECORE_CHARACTEREYECTRLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1706BFF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterEyeCtrlConfig_TypeDefinitionIndex = 16029;
