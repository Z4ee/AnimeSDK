...
#define RPG_GAMECORE_ROGUEACTREMOVEALLROGUEMIRACLECONFIG_METHOD_6_74D79F41CFC8B1D2_OFFSET UNITYSDK_OFFSET(0x175C5630)
#define RPG_GAMECORE_ROGUEACTREMOVEALLROGUEMIRACLECONFIG_METHOD_6_BB1A0ACA33403747_OFFSET UNITYSDK_OFFSET(0x175C5410)
#define RPG_GAMECORE_ROGUEACTREMOVEALLROGUEMIRACLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175C5550)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActRemoveAllRogueMiracleConfig_TypeDefinitionIndex = 18021;
