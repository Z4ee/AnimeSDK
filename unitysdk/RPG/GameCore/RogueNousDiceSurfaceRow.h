...
#define RPG_GAMECORE_ROGUENOUSDICESURFACEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D402C30)
#define RPG_GAMECORE_ROGUENOUSDICESURFACEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D403600)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID SurfaceName; // 0x50
		::RPG::Client::TextID SurfaceDesc; // 0x60
		::System::UInt32 SurfaceID; // 0x70
		::System::UInt32 UnlockDisplayID; // 0x74
