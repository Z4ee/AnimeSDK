...
#define RPG_GAMECORE_TALKTRIGGER_DIALOGUEGROUPINFO_RESET_OFFSET UNITYSDK_OFFSET(0xE25D0)
#define RPG_GAMECORE_TALKTRIGGER_DIALOGUEGROUPINFO_TOSTRING_OFFSET UNITYSDK_OFFSET(0xE2620)
#define RPG_GAMECORE_TALKTRIGGER_DIALOGUEGROUPINFO___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0xE2630)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TalkTrigger_DialogueGroupInfo_TypeDefinitionIndex = 53033;
