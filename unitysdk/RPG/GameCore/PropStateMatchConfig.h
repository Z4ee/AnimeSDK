...
#define RPG_GAMECORE_PROPSTATEMATCHCONFIG_METHOD_2_0C394121D7B478D3_OFFSET UNITYSDK_OFFSET(0x1756FC20)
#define RPG_GAMECORE_PROPSTATEMATCHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1756FD80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropStateMatchConfig_TypeDefinitionIndex = 20210;
