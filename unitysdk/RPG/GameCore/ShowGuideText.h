...
#define RPG_GAMECORE_SHOWGUIDETEXT_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1D52AF90)
#define RPG_GAMECORE_SHOWGUIDETEXT_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D52AEF0)
#define RPG_GAMECORE_SHOWGUIDETEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D52AF50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowGuideText_TypeDefinitionIndex = 24055;
