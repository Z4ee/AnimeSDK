...
#define RPG_GAMECORE_SHOWGUIDETEXT_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1BE41F20)
#define RPG_GAMECORE_SHOWGUIDETEXT_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1BE41E80)
#define RPG_GAMECORE_SHOWGUIDETEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE41EE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowGuideText_TypeDefinitionIndex = 23473;
