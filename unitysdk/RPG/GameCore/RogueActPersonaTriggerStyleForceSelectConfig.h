...
#define RPG_GAMECORE_ROGUEACTPERSONATRIGGERSTYLEFORCESELECTCONFIG_METHOD_6_60913DE0057BCB68_OFFSET UNITYSDK_OFFSET(0x19AF4C00)
#define RPG_GAMECORE_ROGUEACTPERSONATRIGGERSTYLEFORCESELECTCONFIG_METHOD_6_CB5E54B0D2CF2B15_OFFSET UNITYSDK_OFFSET(0x19AF49E0)
#define RPG_GAMECORE_ROGUEACTPERSONATRIGGERSTYLEFORCESELECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AF4B20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaTriggerStyleForceSelectConfig_TypeDefinitionIndex = 18681;
