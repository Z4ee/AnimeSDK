...
#define RPG_GAMECORE_FIVEDIMLADDERCONFIG_METHOD_3_48CE3C2E278825DE_OFFSET UNITYSDK_OFFSET(0x171F8450)
#define RPG_GAMECORE_FIVEDIMLADDERCONFIG_METHOD_3_661D4B71F557ABAF_OFFSET UNITYSDK_OFFSET(0x171F83E0)
#define RPG_GAMECORE_FIVEDIMLADDERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171F8430)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimLadderConfig_TypeDefinitionIndex = 17015;
