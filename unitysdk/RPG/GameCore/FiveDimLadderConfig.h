...
#define RPG_GAMECORE_FIVEDIMLADDERCONFIG_METHOD_3_48CE3C2E278825DE_OFFSET UNITYSDK_OFFSET(0x18907E20)
#define RPG_GAMECORE_FIVEDIMLADDERCONFIG_METHOD_3_661D4B71F557ABAF_OFFSET UNITYSDK_OFFSET(0x18907DB0)
#define RPG_GAMECORE_FIVEDIMLADDERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18907E00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimLadderConfig_TypeDefinitionIndex = 17609;
