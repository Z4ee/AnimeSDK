...
#define RPG_GAMECORE_INVENTORYSORTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18A22210)
#define RPG_GAMECORE_INVENTORYSORTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18A22830)

namespace RPG::GameCore
{
	inline static constexpr unsigned int InventorySortRow_TypeDefinitionIndex = 13104;
