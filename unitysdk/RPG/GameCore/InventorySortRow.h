...
#define RPG_GAMECORE_INVENTORYSORTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B013D80)
#define RPG_GAMECORE_INVENTORYSORTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0143C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int InventorySortRow_TypeDefinitionIndex = 13333;
