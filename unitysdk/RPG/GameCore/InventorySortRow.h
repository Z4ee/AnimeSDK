...
#define RPG_GAMECORE_INVENTORYSORTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19853E30)
#define RPG_GAMECORE_INVENTORYSORTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19854470)

namespace RPG::GameCore
{
	inline static constexpr unsigned int InventorySortRow_TypeDefinitionIndex = 13185;
