...
#define RPG_GAMECORE_LEVELNPCTRAINPASSENGERPARAM_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1733FC30)
#define RPG_GAMECORE_LEVELNPCTRAINPASSENGERPARAM_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1733FCE0)
#define RPG_GAMECORE_LEVELNPCTRAINPASSENGERPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1733FC20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelNPCTrainPassengerParam_TypeDefinitionIndex = 15862;
