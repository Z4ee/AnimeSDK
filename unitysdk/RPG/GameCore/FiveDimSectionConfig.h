...
#define RPG_GAMECORE_FIVEDIMSECTIONCONFIG_METHOD_2_6EAFC17C956680DA_OFFSET UNITYSDK_OFFSET(0x1BEAF140)
#define RPG_GAMECORE_FIVEDIMSECTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEAF250)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSectionConfig_TypeDefinitionIndex = 17792;
