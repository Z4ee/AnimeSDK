...
#define RPG_GAMECORE_FIVEDIMSECTIONCONFIG_METHOD_2_6EAFC17C956680DA_OFFSET UNITYSDK_OFFSET(0x1D0FE8B0)
#define RPG_GAMECORE_FIVEDIMSECTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0FE9C0)
