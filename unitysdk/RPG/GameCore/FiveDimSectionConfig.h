...
#define RPG_GAMECORE_FIVEDIMSECTIONCONFIG_METHOD_2_6EAFC17C956680DA_OFFSET UNITYSDK_OFFSET(0x172081C0)
#define RPG_GAMECORE_FIVEDIMSECTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x172082E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSectionConfig_TypeDefinitionIndex = 16998;
