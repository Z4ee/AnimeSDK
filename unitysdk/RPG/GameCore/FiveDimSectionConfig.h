...
#define RPG_GAMECORE_FIVEDIMSECTIONCONFIG_METHOD_2_6EAFC17C956680DA_OFFSET UNITYSDK_OFFSET(0x19753040)
#define RPG_GAMECORE_FIVEDIMSECTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19753150)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSectionConfig_TypeDefinitionIndex = 17618;
