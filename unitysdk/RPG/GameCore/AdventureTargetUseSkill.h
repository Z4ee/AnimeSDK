...
#define RPG_GAMECORE_ADVENTURETARGETUSESKILL_METHOD_3_4BB6B2DF536A0F70_OFFSET UNITYSDK_OFFSET(0x1867D9F0)
#define RPG_GAMECORE_ADVENTURETARGETUSESKILL_METHOD_3_C199754DA00B575C_OFFSET UNITYSDK_OFFSET(0x1867D920)
#define RPG_GAMECORE_ADVENTURETARGETUSESKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x1867D9A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureTargetUseSkill_TypeDefinitionIndex = 19142;
