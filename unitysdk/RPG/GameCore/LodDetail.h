...
#define RPG_GAMECORE_LODDETAIL_METHOD_2_665A2E82F1B1D82D_OFFSET UNITYSDK_OFFSET(0x18A7B0E0)
#define RPG_GAMECORE_LODDETAIL_METHOD_2_91FCB9F9F5ADEC73_OFFSET UNITYSDK_OFFSET(0x18A7ADE0)
#define RPG_GAMECORE_LODDETAIL__CTOR_OFFSET UNITYSDK_OFFSET(0x18A7B0D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LodDetail_TypeDefinitionIndex = 18237;
