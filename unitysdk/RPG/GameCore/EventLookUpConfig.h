...
#define RPG_GAMECORE_EVENTLOOKUPCONFIG_METHOD_2_852115C8ED56D350_OFFSET UNITYSDK_OFFSET(0x1D7CE360)
#define RPG_GAMECORE_EVENTLOOKUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7CE500)
