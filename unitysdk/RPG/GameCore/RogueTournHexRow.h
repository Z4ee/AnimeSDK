...
#define RPG_GAMECORE_ROGUETOURNHEXROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1BB79180)
#define RPG_GAMECORE_ROGUETOURNHEXROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB79420)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournHexRow_TypeDefinitionIndex = 14440;
