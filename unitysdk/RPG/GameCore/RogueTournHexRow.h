...
#define RPG_GAMECORE_ROGUETOURNHEXROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19BCB260)
#define RPG_GAMECORE_ROGUETOURNHEXROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19BCB500)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournHexRow_TypeDefinitionIndex = 14292;
