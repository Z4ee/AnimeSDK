...
#define RPG_GAMECORE_ROGUETOURNHEXROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17669FD0)
#define RPG_GAMECORE_ROGUETOURNHEXROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1766A300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournHexRow_TypeDefinitionIndex = 13762;
