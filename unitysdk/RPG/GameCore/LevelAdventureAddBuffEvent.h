...
#define RPG_GAMECORE_LEVELADVENTUREADDBUFFEVENT_GETBUFFID_OFFSET UNITYSDK_OFFSET(0xE67F7F0)
#define RPG_GAMECORE_LEVELADVENTUREADDBUFFEVENT_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xE67F7A0)
#define RPG_GAMECORE_LEVELADVENTUREADDBUFFEVENT_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xE67F750)
#define RPG_GAMECORE_LEVELADVENTUREADDBUFFEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0xE67F740)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelAdventureAddBuffEvent_TypeDefinitionIndex = 56798;
