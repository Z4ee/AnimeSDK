...
#define RPG_GAMECORE_LEVELADVENTUREADDBUFFEVENT_GETBUFFID_OFFSET UNITYSDK_OFFSET(0x1BDE8630)
#define RPG_GAMECORE_LEVELADVENTUREADDBUFFEVENT_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1BDE85E0)
#define RPG_GAMECORE_LEVELADVENTUREADDBUFFEVENT_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x1BDE8590)
#define RPG_GAMECORE_LEVELADVENTUREADDBUFFEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDE8580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelAdventureAddBuffEvent_TypeDefinitionIndex = 54077;

	class LevelAdventureAddBuffEvent : public ::System::Object
	{
	public:
		::System::UInt32 _BuffID; // 0x10
		::System::UInt32 _EntityRuntimeID; // 0x14
