...
#define RPG_GAMECORE_ST_SIDE_LISTENFINDTREASURESTATE_METHOD_4_AF741CAD25A79E7C_OFFSET UNITYSDK_OFFSET(0x1768D020)
#define RPG_GAMECORE_ST_SIDE_LISTENFINDTREASURESTATE_METHOD_4_D3C431E1AD8077EC_OFFSET UNITYSDK_OFFSET(0x17699390)
#define RPG_GAMECORE_ST_SIDE_LISTENFINDTREASURESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1768CFC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_ListenFindTreasureState_TypeDefinitionIndex = 18419;
