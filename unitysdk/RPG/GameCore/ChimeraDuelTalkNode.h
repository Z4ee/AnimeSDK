...
#define RPG_GAMECORE_CHIMERADUELTALKNODE_METHOD_3_12EDFA6FDC1A917F_OFFSET UNITYSDK_OFFSET(0x170A7250)
#define RPG_GAMECORE_CHIMERADUELTALKNODE_METHOD_3_D03E6B265D9017B1_OFFSET UNITYSDK_OFFSET(0x170A7350)
#define RPG_GAMECORE_CHIMERADUELTALKNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x170A72F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelTalkNode_TypeDefinitionIndex = 14666;
