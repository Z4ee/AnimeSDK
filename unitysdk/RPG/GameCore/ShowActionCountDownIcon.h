...
#define RPG_GAMECORE_SHOWACTIONCOUNTDOWNICON_METHOD_3_C0764E11C7AFAF25_OFFSET UNITYSDK_OFFSET(0x1BE387A0)
#define RPG_GAMECORE_SHOWACTIONCOUNTDOWNICON_METHOD_3_DE2037151DF4A5EC_OFFSET UNITYSDK_OFFSET(0x1BE387E0)
#define RPG_GAMECORE_SHOWACTIONCOUNTDOWNICON__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE387D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowActionCountDownIcon_TypeDefinitionIndex = 22844;
