...
#define RPG_GAMECORE_SHOWACTIONCOUNTDOWNICON_METHOD_3_95190318CE71599D_OFFSET UNITYSDK_OFFSET(0x19C734D0)
#define RPG_GAMECORE_SHOWACTIONCOUNTDOWNICON_METHOD_3_DE2037151DF4A5EC_OFFSET UNITYSDK_OFFSET(0x19C73550)
#define RPG_GAMECORE_SHOWACTIONCOUNTDOWNICON__CTOR_OFFSET UNITYSDK_OFFSET(0x19C73520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowActionCountDownIcon_TypeDefinitionIndex = 22402;
