...
#define RPG_GAMECORE_SHOWACTIONCOUNTDOWNICON_METHOD_3_95190318CE71599D_OFFSET UNITYSDK_OFFSET(0x176F3850)
#define RPG_GAMECORE_SHOWACTIONCOUNTDOWNICON_METHOD_3_DE2037151DF4A5EC_OFFSET UNITYSDK_OFFSET(0x176F38D0)
#define RPG_GAMECORE_SHOWACTIONCOUNTDOWNICON__CTOR_OFFSET UNITYSDK_OFFSET(0x176F38A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowActionCountDownIcon_TypeDefinitionIndex = 21947;
