...
#define RPG_GAMECORE_TRAINPARTYBUILDITEMDYNAMICBINDVALUE_METHOD_2_295E1E09D0427FCE_OFFSET UNITYSDK_OFFSET(0x190A73B0)
#define RPG_GAMECORE_TRAINPARTYBUILDITEMDYNAMICBINDVALUE_METHOD_2_8D8A7B4759EB9165_OFFSET UNITYSDK_OFFSET(0x190A7710)
#define RPG_GAMECORE_TRAINPARTYBUILDITEMDYNAMICBINDVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x190A7700)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyBuildItemDynamicBindValue_TypeDefinitionIndex = 15390;
