...
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMERWAITEVENT_METHOD_4_DAB3E1386D3B8D98_OFFSET UNITYSDK_OFFSET(0x19BFFE20)
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMERWAITEVENT_METHOD_4_F64A10D21850218F_OFFSET UNITYSDK_OFFSET(0x19C17B60)
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMERWAITEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19BFFDD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_ElfCustomerWaitEvent_TypeDefinitionIndex = 20337;
