...
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMERWAITEVENT_METHOD_4_905C6E4AA20A83D5_OFFSET UNITYSDK_OFFSET(0x1D4C8F00)
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMERWAITEVENT_METHOD_4_DAB3E1386D3B8D98_OFFSET UNITYSDK_OFFSET(0x1D4C8FD0)
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMERWAITEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4C8FC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_ElfCustomerWaitEvent_TypeDefinitionIndex = 21287;
