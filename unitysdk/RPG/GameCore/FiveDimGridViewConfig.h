...
#define RPG_GAMECORE_FIVEDIMGRIDVIEWCONFIG_METHOD_3_6E67FEE663289395_OFFSET UNITYSDK_OFFSET(0x197433B0)
#define RPG_GAMECORE_FIVEDIMGRIDVIEWCONFIG_METHOD_3_7CA4D26E3AE0DD82_OFFSET UNITYSDK_OFFSET(0x19743340)
#define RPG_GAMECORE_FIVEDIMGRIDVIEWCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19743390)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimGridViewConfig_TypeDefinitionIndex = 17641;
