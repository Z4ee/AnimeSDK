...
#define RPG_GAMECORE_FIVEDIMGRIDVIEWCONFIG_METHOD_3_6E67FEE663289395_OFFSET UNITYSDK_OFFSET(0x171F7120)
#define RPG_GAMECORE_FIVEDIMGRIDVIEWCONFIG_METHOD_3_7CA4D26E3AE0DD82_OFFSET UNITYSDK_OFFSET(0x171F70B0)
#define RPG_GAMECORE_FIVEDIMGRIDVIEWCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171F7100)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimGridViewConfig_TypeDefinitionIndex = 17021;
