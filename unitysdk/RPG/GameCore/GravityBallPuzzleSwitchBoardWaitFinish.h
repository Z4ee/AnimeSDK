...
#define RPG_GAMECORE_GRAVITYBALLPUZZLESWITCHBOARDWAITFINISH_METHOD_3_7095419498AB5E9C_OFFSET UNITYSDK_OFFSET(0x1724D510)
#define RPG_GAMECORE_GRAVITYBALLPUZZLESWITCHBOARDWAITFINISH_METHOD_3_973ED38076A23050_OFFSET UNITYSDK_OFFSET(0x1724D400)
#define RPG_GAMECORE_GRAVITYBALLPUZZLESWITCHBOARDWAITFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1724D4E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GravityBallPuzzleSwitchBoardWaitFinish_TypeDefinitionIndex = 18672;
