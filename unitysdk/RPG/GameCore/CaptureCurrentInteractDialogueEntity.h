...
#define RPG_GAMECORE_CAPTURECURRENTINTERACTDIALOGUEENTITY_METHOD_3_3EE98E0BC8C9437B_OFFSET UNITYSDK_OFFSET(0x187B7710)
#define RPG_GAMECORE_CAPTURECURRENTINTERACTDIALOGUEENTITY_METHOD_3_968887063E59E3D2_OFFSET UNITYSDK_OFFSET(0x187B7790)
#define RPG_GAMECORE_CAPTURECURRENTINTERACTDIALOGUEENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x187B7760)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CaptureCurrentInteractDialogueEntity_TypeDefinitionIndex = 21169;
