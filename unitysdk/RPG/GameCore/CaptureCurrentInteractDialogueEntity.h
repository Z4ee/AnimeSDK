...
#define RPG_GAMECORE_CAPTURECURRENTINTERACTDIALOGUEENTITY_METHOD_3_3EE98E0BC8C9437B_OFFSET UNITYSDK_OFFSET(0x17052F80)
#define RPG_GAMECORE_CAPTURECURRENTINTERACTDIALOGUEENTITY_METHOD_3_968887063E59E3D2_OFFSET UNITYSDK_OFFSET(0x17053000)
#define RPG_GAMECORE_CAPTURECURRENTINTERACTDIALOGUEENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x17052FD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CaptureCurrentInteractDialogueEntity_TypeDefinitionIndex = 20487;
