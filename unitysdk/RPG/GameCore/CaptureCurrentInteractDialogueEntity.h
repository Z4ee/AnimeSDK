...
#define RPG_GAMECORE_CAPTURECURRENTINTERACTDIALOGUEENTITY_METHOD_3_968887063E59E3D2_OFFSET UNITYSDK_OFFSET(0x1B70A4B0)
#define RPG_GAMECORE_CAPTURECURRENTINTERACTDIALOGUEENTITY_METHOD_3_E93805AB4C7A4B49_OFFSET UNITYSDK_OFFSET(0x1B70A470)
#define RPG_GAMECORE_CAPTURECURRENTINTERACTDIALOGUEENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B70A4A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CaptureCurrentInteractDialogueEntity_TypeDefinitionIndex = 21481;
