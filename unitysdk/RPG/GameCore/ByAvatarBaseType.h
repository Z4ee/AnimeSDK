...
#define RPG_GAMECORE_BYAVATARBASETYPE_METHOD_4_D013E7ABFD926BDF_OFFSET UNITYSDK_OFFSET(0x16FFB400)
#define RPG_GAMECORE_BYAVATARBASETYPE_METHOD_4_F62EBC277D2B9FEE_OFFSET UNITYSDK_OFFSET(0x16FFB4E0)
#define RPG_GAMECORE_BYAVATARBASETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x16FFB480)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByAvatarBaseType_TypeDefinitionIndex = 20743;
