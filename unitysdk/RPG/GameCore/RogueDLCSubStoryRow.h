...
#define RPG_GAMECORE_ROGUEDLCSUBSTORYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x176041B0)
#define RPG_GAMECORE_ROGUEDLCSUBSTORYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17604440)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueDLCSubStoryRow_TypeDefinitionIndex = 13529;
