...
#define RPG_GAMECORE_RTSKILLABORT_METHOD_3_F5464CA47C0C26F1_OFFSET UNITYSDK_OFFSET(0x1CCECF50)
#define RPG_GAMECORE_RTSKILLABORT_METHOD_3_F83638D41561432D_OFFSET UNITYSDK_OFFSET(0x1CCECFF0)
#define RPG_GAMECORE_RTSKILLABORT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CCECFB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtSkillAbort_TypeDefinitionIndex = 23942;
