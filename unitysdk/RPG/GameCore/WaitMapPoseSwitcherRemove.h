...
#define RPG_GAMECORE_WAITMAPPOSESWITCHERREMOVE_METHOD_4_26B6D3C242A20877_OFFSET UNITYSDK_OFFSET(0x178FD3C0)
#define RPG_GAMECORE_WAITMAPPOSESWITCHERREMOVE_METHOD_4_682C968F0C19F1B5_OFFSET UNITYSDK_OFFSET(0x178FD2E0)
#define RPG_GAMECORE_WAITMAPPOSESWITCHERREMOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x178FD360)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitMapPoseSwitcherRemove_TypeDefinitionIndex = 19562;
