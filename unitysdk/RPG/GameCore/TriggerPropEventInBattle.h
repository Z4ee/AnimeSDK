...
#define RPG_GAMECORE_TRIGGERPROPEVENTINBATTLE_METHOD_3_66AEE85EEB8DC8B9_OFFSET UNITYSDK_OFFSET(0x178CCF00)
#define RPG_GAMECORE_TRIGGERPROPEVENTINBATTLE_METHOD_3_A2D28BC1335A8B57_OFFSET UNITYSDK_OFFSET(0x178CCF80)
#define RPG_GAMECORE_TRIGGERPROPEVENTINBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x178CCF50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerPropEventInBattle_TypeDefinitionIndex = 21357;
