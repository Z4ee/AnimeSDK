...
#define RPG_GAMECORE_TRIGGERPROPEVENTINBATTLE_METHOD_3_66AEE85EEB8DC8B9_OFFSET UNITYSDK_OFFSET(0x19E1AB20)
#define RPG_GAMECORE_TRIGGERPROPEVENTINBATTLE_METHOD_3_A2D28BC1335A8B57_OFFSET UNITYSDK_OFFSET(0x19E1ABA0)
#define RPG_GAMECORE_TRIGGERPROPEVENTINBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x19E1AB70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerPropEventInBattle_TypeDefinitionIndex = 21875;
