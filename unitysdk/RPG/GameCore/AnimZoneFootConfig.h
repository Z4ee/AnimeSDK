...
#define RPG_GAMECORE_ANIMZONEFOOTCONFIG_METHOD_3_12F08FC795DDFE97_OFFSET UNITYSDK_OFFSET(0x16F82690)
#define RPG_GAMECORE_ANIMZONEFOOTCONFIG_METHOD_3_82FF33A42A444127_OFFSET UNITYSDK_OFFSET(0x16F82970)
#define RPG_GAMECORE_ANIMZONEFOOTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16F82680)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AnimZoneFootConfig_TypeDefinitionIndex = 14939;
