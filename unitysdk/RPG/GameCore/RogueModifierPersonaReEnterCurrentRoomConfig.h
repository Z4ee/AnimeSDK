...
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAREENTERCURRENTROOMCONFIG_METHOD_3_72A12C88CE7E310D_OFFSET UNITYSDK_OFFSET(0x18D440D0)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAREENTERCURRENTROOMCONFIG_METHOD_3_FBAC2155B315B994_OFFSET UNITYSDK_OFFSET(0x18D44000)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAREENTERCURRENTROOMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D44080)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierPersonaReEnterCurrentRoomConfig_TypeDefinitionIndex = 16971;
