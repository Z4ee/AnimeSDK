...
#define RPG_GAMECORE_FATEPARAMAFFIXCOUNTCONFIG_METHOD_6_926E8308865DD088_OFFSET UNITYSDK_OFFSET(0x188D6B50)
#define RPG_GAMECORE_FATEPARAMAFFIXCOUNTCONFIG_METHOD_6_B9205244356EF82C_OFFSET UNITYSDK_OFFSET(0x188D6D10)
#define RPG_GAMECORE_FATEPARAMAFFIXCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x188D6C50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateParamAffixCountConfig_TypeDefinitionIndex = 15749;
