...
#define RPG_GAMECORE_FATEPARAMAFFIXCOUNTCONFIG_METHOD_6_2A0EAAAA8890D230_OFFSET UNITYSDK_OFFSET(0x1D08DDC0)
#define RPG_GAMECORE_FATEPARAMAFFIXCOUNTCONFIG_METHOD_6_B9205244356EF82C_OFFSET UNITYSDK_OFFSET(0x1D08DE10)
#define RPG_GAMECORE_FATEPARAMAFFIXCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D08DE00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateParamAffixCountConfig_TypeDefinitionIndex = 16454;
