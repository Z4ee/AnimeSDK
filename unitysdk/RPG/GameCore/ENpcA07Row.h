...
#define RPG_GAMECORE_ENPCA07ROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1BB2EA20)
#define RPG_GAMECORE_ENPCA07ROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB2EC70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ENpcA07Row_TypeDefinitionIndex = 12751;

	class ENpcA07Row : public ::System::Object
	{
	public:
		::System::String* BattleJsonOverride; // 0x10
		::System::String* ResMapConfigPath; // 0x18
