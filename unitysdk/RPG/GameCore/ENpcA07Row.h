...
#define RPG_GAMECORE_ENPCA07ROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x196D28B0)
#define RPG_GAMECORE_ENPCA07ROW__CTOR_OFFSET UNITYSDK_OFFSET(0x196D2B00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ENpcA07Row_TypeDefinitionIndex = 12614;

	class ENpcA07Row : public ::System::Object
	{
	public:
		::Il2CppArray<::System::UInt32>* AddList; // 0x10
		::System::String* BattleJsonOverride; // 0x18
		::System::String* AdvJsonOverride; // 0x20
		::System::String* ResMapConfigPath; // 0x28
