...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERUPGRADEROLERARITYCONFIG_METHOD_3_1C880226EFB34F27_OFFSET UNITYSDK_OFFSET(0x1EE6F8B0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERUPGRADEROLERARITYCONFIG_METHOD_3_F7471D8A8A3C58A3_OFFSET UNITYSDK_OFFSET(0x1EE6F860)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERUPGRADEROLERARITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EE6F8A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierUpgradeRoleRarityConfig_TypeDefinitionIndex = 19247;
