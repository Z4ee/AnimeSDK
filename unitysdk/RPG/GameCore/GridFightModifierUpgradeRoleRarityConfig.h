...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERUPGRADEROLERARITYCONFIG_METHOD_3_1C880226EFB34F27_OFFSET UNITYSDK_OFFSET(0x189C08E0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERUPGRADEROLERARITYCONFIG_METHOD_3_56738BACB782E5AE_OFFSET UNITYSDK_OFFSET(0x189C0810)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERUPGRADEROLERARITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189C0890)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierUpgradeRoleRarityConfig_TypeDefinitionIndex = 18500;
