...
#define RPG_GAMECORE_PARAMCONDITIONCONFIG_METHOD_4_5612703F4C3B9E13_OFFSET UNITYSDK_OFFSET(0x18BD3190)
#define RPG_GAMECORE_PARAMCONDITIONCONFIG_METHOD_4_9BFC8898B5C47F80_OFFSET UNITYSDK_OFFSET(0x18BD3050)
#define RPG_GAMECORE_PARAMCONDITIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18BD3110)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ParamConditionConfig_TypeDefinitionIndex = 16180;
