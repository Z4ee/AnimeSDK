...
#define RPG_GAMECORE_PARAMCONDITIONCONFIG_METHOD_4_5612703F4C3B9E13_OFFSET UNITYSDK_OFFSET(0x17488C70)
#define RPG_GAMECORE_PARAMCONDITIONCONFIG_METHOD_4_9BFC8898B5C47F80_OFFSET UNITYSDK_OFFSET(0x17488B30)
#define RPG_GAMECORE_PARAMCONDITIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17488BF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ParamConditionConfig_TypeDefinitionIndex = 15658;
