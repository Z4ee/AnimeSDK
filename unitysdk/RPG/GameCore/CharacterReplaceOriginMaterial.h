...
#define RPG_GAMECORE_CHARACTERREPLACEORIGINMATERIAL_METHOD_3_507719630675AB86_OFFSET UNITYSDK_OFFSET(0x187D7930)
#define RPG_GAMECORE_CHARACTERREPLACEORIGINMATERIAL_METHOD_3_81CD33F5F24A2AD0_OFFSET UNITYSDK_OFFSET(0x187D79B0)
#define RPG_GAMECORE_CHARACTERREPLACEORIGINMATERIAL__CTOR_OFFSET UNITYSDK_OFFSET(0x187D7980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterReplaceOriginMaterial_TypeDefinitionIndex = 22838;
