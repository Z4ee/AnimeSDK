...
#define RPG_GAMECORE_CHARACTERREPLACEORIGINMATERIAL_METHOD_3_81CD33F5F24A2AD0_OFFSET UNITYSDK_OFFSET(0x1B72AE20)
#define RPG_GAMECORE_CHARACTERREPLACEORIGINMATERIAL_METHOD_3_9422C29E9BAD1ABF_OFFSET UNITYSDK_OFFSET(0x1B72ADE0)
#define RPG_GAMECORE_CHARACTERREPLACEORIGINMATERIAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B72AE10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterReplaceOriginMaterial_TypeDefinitionIndex = 22990;
