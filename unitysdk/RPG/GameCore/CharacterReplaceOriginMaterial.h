...
#define RPG_GAMECORE_CHARACTERREPLACEORIGINMATERIAL_METHOD_3_507719630675AB86_OFFSET UNITYSDK_OFFSET(0x196151F0)
#define RPG_GAMECORE_CHARACTERREPLACEORIGINMATERIAL_METHOD_3_81CD33F5F24A2AD0_OFFSET UNITYSDK_OFFSET(0x19615270)
#define RPG_GAMECORE_CHARACTERREPLACEORIGINMATERIAL__CTOR_OFFSET UNITYSDK_OFFSET(0x19615240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterReplaceOriginMaterial_TypeDefinitionIndex = 22539;
