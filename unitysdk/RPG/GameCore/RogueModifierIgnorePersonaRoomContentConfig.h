...
#define RPG_GAMECORE_ROGUEMODIFIERIGNOREPERSONAROOMCONTENTCONFIG_METHOD_3_513F177408FE7B6C_OFFSET UNITYSDK_OFFSET(0x18D3F300)
#define RPG_GAMECORE_ROGUEMODIFIERIGNOREPERSONAROOMCONTENTCONFIG_METHOD_3_F7146A62B3EC6C35_OFFSET UNITYSDK_OFFSET(0x18D3F230)
#define RPG_GAMECORE_ROGUEMODIFIERIGNOREPERSONAROOMCONTENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D3F2B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierIgnorePersonaRoomContentConfig_TypeDefinitionIndex = 16905;
