...
#define RPG_GAMECORE_BYINTRACKCAMERA_METHOD_4_4804F6B120FACF29_OFFSET UNITYSDK_OFFSET(0x17027F80)
#define RPG_GAMECORE_BYINTRACKCAMERA_METHOD_4_84F8D7719F1FC30B_OFFSET UNITYSDK_OFFSET(0x17027EB0)
#define RPG_GAMECORE_BYINTRACKCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x17027F30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByInTrackCamera_TypeDefinitionIndex = 19158;
