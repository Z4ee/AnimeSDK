...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETTUTORIALAUGMENTCONFIG_METHOD_3_023D0D9785049A53_OFFSET UNITYSDK_OFFSET(0x1EE6EEA0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETTUTORIALAUGMENTCONFIG_METHOD_3_FB461889C7002497_OFFSET UNITYSDK_OFFSET(0x1EE6EEF0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETTUTORIALAUGMENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EE6EEE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierSetTutorialAugmentConfig_TypeDefinitionIndex = 19213;
