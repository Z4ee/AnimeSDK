...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETTUTORIALAUGMENTCONFIG_METHOD_3_B30075F9B0BB469E_OFFSET UNITYSDK_OFFSET(0x197F39F0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETTUTORIALAUGMENTCONFIG_METHOD_3_FB461889C7002497_OFFSET UNITYSDK_OFFSET(0x197EF4B0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETTUTORIALAUGMENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197EF460)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierSetTutorialAugmentConfig_TypeDefinitionIndex = 18440;
