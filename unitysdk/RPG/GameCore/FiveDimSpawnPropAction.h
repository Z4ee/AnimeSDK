...
#define RPG_GAMECORE_FIVEDIMSPAWNPROPACTION_METHOD_3_738FC8A942BE22B1_OFFSET UNITYSDK_OFFSET(0x1720C5C0)
#define RPG_GAMECORE_FIVEDIMSPAWNPROPACTION_METHOD_3_B8DCC95A55C89EF0_OFFSET UNITYSDK_OFFSET(0x1720C680)
#define RPG_GAMECORE_FIVEDIMSPAWNPROPACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1720C660)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSpawnPropAction_TypeDefinitionIndex = 17137;
