...
#define RPG_GAMECORE_FIVEDIMSPAWNPROPACTION_METHOD_3_B8DCC95A55C89EF0_OFFSET UNITYSDK_OFFSET(0x1BEB3C70)
#define RPG_GAMECORE_FIVEDIMSPAWNPROPACTION_METHOD_3_C6B90C72ED71E975_OFFSET UNITYSDK_OFFSET(0x1BEB3BF0)
#define RPG_GAMECORE_FIVEDIMSPAWNPROPACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEB3C60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSpawnPropAction_TypeDefinitionIndex = 17941;
