...
#define RPG_GAMECORE_ROGUEDLCAEONDICEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18CFF340)
#define RPG_GAMECORE_ROGUEDLCAEONDICEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18CFFCD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueDLCAeonDiceRow_TypeDefinitionIndex = 13942;

	class RogueDLCAeonDiceRow : public ::System::Object
	{
	public:
		::System::String* SoundSuspensionStart; // 0x10
		::Il2CppArray<::System::UInt32>* ExtraEffect; // 0x18
		::Il2CppArray<::System::UInt32>* StartDescParam; // 0x20
