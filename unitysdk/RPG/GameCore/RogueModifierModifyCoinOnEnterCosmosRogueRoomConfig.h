...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYCOINONENTERCOSMOSROGUEROOMCONFIG_METHOD_3_99D701CB0F7B5693_OFFSET UNITYSDK_OFFSET(0x1D3F9CC0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYCOINONENTERCOSMOSROGUEROOMCONFIG_METHOD_3_DD588C2DD9280ED7_OFFSET UNITYSDK_OFFSET(0x1D3F9D10)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYCOINONENTERCOSMOSROGUEROOMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3F9D00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyCoinOnEnterCosmosRogueRoomConfig_TypeDefinitionIndex = 17776;
