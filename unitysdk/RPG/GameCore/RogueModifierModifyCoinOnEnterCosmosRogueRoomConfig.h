...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYCOINONENTERCOSMOSROGUEROOMCONFIG_METHOD_3_78C5D85B863EC9DE_OFFSET UNITYSDK_OFFSET(0x17633CB0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYCOINONENTERCOSMOSROGUEROOMCONFIG_METHOD_3_DD588C2DD9280ED7_OFFSET UNITYSDK_OFFSET(0x17633D80)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYCOINONENTERCOSMOSROGUEROOMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17633D30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyCoinOnEnterCosmosRogueRoomConfig_TypeDefinitionIndex = 16530;
