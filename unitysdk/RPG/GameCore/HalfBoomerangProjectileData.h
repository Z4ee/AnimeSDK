...
#define RPG_GAMECORE_HALFBOOMERANGPROJECTILEDATA_METHOD_3_D64C167A4B585F96_OFFSET UNITYSDK_OFFSET(0x1D3C9B10)
#define RPG_GAMECORE_HALFBOOMERANGPROJECTILEDATA_METHOD_3_EDAC578252A177B1_OFFSET UNITYSDK_OFFSET(0x1D3C9990)
#define RPG_GAMECORE_HALFBOOMERANGPROJECTILEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3C9A60)
