...
#define RPG_GAMECORE_HALFBOOMERANGPROJECTILEDATA_METHOD_3_D64C167A4B585F96_OFFSET UNITYSDK_OFFSET(0x1B66D9D0)
#define RPG_GAMECORE_HALFBOOMERANGPROJECTILEDATA_METHOD_3_EDAC578252A177B1_OFFSET UNITYSDK_OFFSET(0x1B66D850)
#define RPG_GAMECORE_HALFBOOMERANGPROJECTILEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B66D920)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HalfBoomerangProjectileData_TypeDefinitionIndex = 15049;
