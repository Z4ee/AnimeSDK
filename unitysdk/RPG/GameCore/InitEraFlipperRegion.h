...
#define RPG_GAMECORE_INITERAFLIPPERREGION_METHOD_3_1B2E1B16386B3E5B_OFFSET UNITYSDK_OFFSET(0x172BB9D0)
#define RPG_GAMECORE_INITERAFLIPPERREGION_METHOD_3_3E11595DBB3014FD_OFFSET UNITYSDK_OFFSET(0x172BB950)
#define RPG_GAMECORE_INITERAFLIPPERREGION__CTOR_OFFSET UNITYSDK_OFFSET(0x172BB9A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int InitEraFlipperRegion_TypeDefinitionIndex = 20524;
