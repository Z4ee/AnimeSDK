...
#define RPG_GAMECORE_INITERAFLIPPERREGION_METHOD_3_1B2E1B16386B3E5B_OFFSET UNITYSDK_OFFSET(0x1D1ABFC0)
#define RPG_GAMECORE_INITERAFLIPPERREGION_METHOD_3_F6A3A28ADC02EB78_OFFSET UNITYSDK_OFFSET(0x1D1ABF80)
#define RPG_GAMECORE_INITERAFLIPPERREGION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1ABFB0)
