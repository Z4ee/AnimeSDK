...
#define RPG_GAMECORE_SWORDTRAININGSETDYNAMICVALUEBYALLYRANK_METHOD_3_2B0020C073F2A92C_OFFSET UNITYSDK_OFFSET(0x18EC5FE0)
#define RPG_GAMECORE_SWORDTRAININGSETDYNAMICVALUEBYALLYRANK_METHOD_3_A75E8D278DC26FBA_OFFSET UNITYSDK_OFFSET(0x18EC5F60)
#define RPG_GAMECORE_SWORDTRAININGSETDYNAMICVALUEBYALLYRANK__CTOR_OFFSET UNITYSDK_OFFSET(0x18EC5FB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwordTrainingSetDynamicValueByAllyRank_TypeDefinitionIndex = 21482;
