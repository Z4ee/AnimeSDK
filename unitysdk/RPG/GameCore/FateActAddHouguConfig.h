...
#define RPG_GAMECORE_FATEACTADDHOUGUCONFIG_METHOD_6_0D9D6A15C706F376_OFFSET UNITYSDK_OFFSET(0x1970ABF0)
#define RPG_GAMECORE_FATEACTADDHOUGUCONFIG_METHOD_6_E692A4BA07A923F5_OFFSET UNITYSDK_OFFSET(0x1970AD60)
#define RPG_GAMECORE_FATEACTADDHOUGUCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1970ACC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateActAddHouguConfig_TypeDefinitionIndex = 18257;
