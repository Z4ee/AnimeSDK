...
#define RPG_GAMECORE_AVATARENHANCEDRANKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19495EC0)
#define RPG_GAMECORE_AVATARENHANCEDRANKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19496270)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID Comment02; // 0x18
		::RPG::Client::TextID RankDescBefore; // 0x28
		::RPG::Client::TextID Comment01; // 0x38
		::System::UInt32 CommentIndex; // 0x48
		::RPG::Client::TextID RankDescAfter; // 0x50
