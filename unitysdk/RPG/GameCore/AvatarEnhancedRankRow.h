...
#define RPG_GAMECORE_AVATARENHANCEDRANKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C58B440)
#define RPG_GAMECORE_AVATARENHANCEDRANKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C58B7F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AvatarEnhancedRankRow_TypeDefinitionIndex = 12701;

	class AvatarEnhancedRankRow : public ::System::Object
	{
	public:
		::RPG::Client::TextID RankDescBefore; // 0x10
		::RPG::Client::TextID Comment02; // 0x20
		::System::UInt32 AvatarID; // 0x30
		::RPG::Client::TextID RankDescAfter; // 0x38
