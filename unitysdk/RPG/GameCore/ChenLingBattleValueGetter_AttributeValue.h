...
#define RPG_GAMECORE_CHENLINGBATTLEVALUEGETTER_ATTRIBUTEVALUE_METHOD_3_D9DEB8FA63E3840E_OFFSET UNITYSDK_OFFSET(0x1C37FAF0)
#define RPG_GAMECORE_CHENLINGBATTLEVALUEGETTER_ATTRIBUTEVALUE_METHOD_3_E3B8E314AD5922D6_OFFSET UNITYSDK_OFFSET(0x1C37FA90)
#define RPG_GAMECORE_CHENLINGBATTLEVALUEGETTER_ATTRIBUTEVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C37FAE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleValueGetter_AttributeValue_TypeDefinitionIndex = 15192;
