...
#define RPG_GAMECORE_CONFIRMCHECKPOINTRECOVER_METHOD_3_301468328E22D0DD_OFFSET UNITYSDK_OFFSET(0x18834A20)
#define RPG_GAMECORE_CONFIRMCHECKPOINTRECOVER_METHOD_3_D469DF410E1C764C_OFFSET UNITYSDK_OFFSET(0x18834AA0)
#define RPG_GAMECORE_CONFIRMCHECKPOINTRECOVER__CTOR_OFFSET UNITYSDK_OFFSET(0x18834A70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConfirmCheckpointRecover_TypeDefinitionIndex = 20442;
