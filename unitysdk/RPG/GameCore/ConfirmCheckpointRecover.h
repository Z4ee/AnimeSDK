...
#define RPG_GAMECORE_CONFIRMCHECKPOINTRECOVER_METHOD_3_BDC49DAD26330707_OFFSET UNITYSDK_OFFSET(0x1D9B0F80)
#define RPG_GAMECORE_CONFIRMCHECKPOINTRECOVER_METHOD_3_D469DF410E1C764C_OFFSET UNITYSDK_OFFSET(0x1D9B0FC0)
#define RPG_GAMECORE_CONFIRMCHECKPOINTRECOVER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D9B0FB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConfirmCheckpointRecover_TypeDefinitionIndex = 21355;
