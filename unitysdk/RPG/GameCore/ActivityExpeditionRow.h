...
#define RPG_GAMECORE_ACTIVITYEXPEDITIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16EB1F20)
#define RPG_GAMECORE_ACTIVITYEXPEDITIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16EB31E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityExpeditionRow_TypeDefinitionIndex = 10700;
	...
	public:
		...
		::RPG::GameCore::ActivityExpeditionRank ExpeditionRank; // 0x34
		::RPG::Client::TextID AssignDesc; // 0x38
		::System::UInt32 RewardID; // 0x48
		::System::UInt32 AvatarNumMax; // 0x4C
		::System::UInt32 Grade3ExtraRewardID; // 0x50
		::System::UInt32 Grade2ExtraRewardID; // 0x54
		::System::UInt32 AvatarNumMin; // 0x58
		::System::UInt32 Grade1ExtraRewardID; // 0x5C
