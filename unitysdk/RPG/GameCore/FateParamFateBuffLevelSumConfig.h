...
#define RPG_GAMECORE_FATEPARAMFATEBUFFLEVELSUMCONFIG_METHOD_6_66310D3B77CEB5D1_OFFSET UNITYSDK_OFFSET(0x19713D80)
#define RPG_GAMECORE_FATEPARAMFATEBUFFLEVELSUMCONFIG_METHOD_6_787672ABA87187B7_OFFSET UNITYSDK_OFFSET(0x19713AF0)
#define RPG_GAMECORE_FATEPARAMFATEBUFFLEVELSUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19713CC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateParamFateBuffLevelSumConfig_TypeDefinitionIndex = 15816;
