...
#define RPG_GAMECORE_BYCOMPAREAIVARIABLEINT_METHOD_4_0C7D55FCF5096503_OFFSET UNITYSDK_OFFSET(0x19CCE6C0)
#define RPG_GAMECORE_BYCOMPAREAIVARIABLEINT_METHOD_4_1EB89E2C4FB409CC_OFFSET UNITYSDK_OFFSET(0x19CCE6F0)
#define RPG_GAMECORE_BYCOMPAREAIVARIABLEINT_METHOD_4_2CCFBEBAA7AE5E40_OFFSET UNITYSDK_OFFSET(0x19CCE4A0)
#define RPG_GAMECORE_BYCOMPAREAIVARIABLEINT_METHOD_4_52CE6745B9A9EBC9_OFFSET UNITYSDK_OFFSET(0x19CCE460)
#define RPG_GAMECORE_BYCOMPAREAIVARIABLEINT__CTOR_OFFSET UNITYSDK_OFFSET(0x19CCE490)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareAIVariableInt_TypeDefinitionIndex = 19265;
