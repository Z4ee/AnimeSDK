...
#define RPG_GAMECORE_BYCOMPAREAIVARIABLEINT_METHOD_4_2CCFBEBAA7AE5E40_OFFSET UNITYSDK_OFFSET(0x17001CA0)
#define RPG_GAMECORE_BYCOMPAREAIVARIABLEINT_METHOD_4_6114AB032100408B_OFFSET UNITYSDK_OFFSET(0x17001BD0)
#define RPG_GAMECORE_BYCOMPAREAIVARIABLEINT__CTOR_OFFSET UNITYSDK_OFFSET(0x17001C50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareAIVariableInt_TypeDefinitionIndex = 18314;
