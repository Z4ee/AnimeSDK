...
#define RPG_GAMECORE_VE_PREDICATE_METHOD_3_12C840EF41BBCCC5_OFFSET UNITYSDK_OFFSET(0x1D2BC190)
#define RPG_GAMECORE_VE_PREDICATE_METHOD_3_3975ADFDB634B4AC_OFFSET UNITYSDK_OFFSET(0x1D2BBF90)
#define RPG_GAMECORE_VE_PREDICATE_METHOD_3_AA985068CBF1EE13_OFFSET UNITYSDK_OFFSET(0x1DEA13B0)
#define RPG_GAMECORE_VE_PREDICATE_METHOD_3_CB20DFA7C15E2D81_OFFSET UNITYSDK_OFFSET(0x1D2BBFC0)
#define RPG_GAMECORE_VE_PREDICATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEA1E50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VE_Predicate_TypeDefinitionIndex = 23768;
