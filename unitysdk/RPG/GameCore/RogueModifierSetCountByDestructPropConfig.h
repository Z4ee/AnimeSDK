...
#define RPG_GAMECORE_ROGUEMODIFIERSETCOUNTBYDESTRUCTPROPCONFIG_METHOD_3_B7A7293E9EBC1A83_OFFSET UNITYSDK_OFFSET(0x1D3FC5E0)
#define RPG_GAMECORE_ROGUEMODIFIERSETCOUNTBYDESTRUCTPROPCONFIG_METHOD_3_F7F0C1830F2BF17F_OFFSET UNITYSDK_OFFSET(0x1D3FC590)
#define RPG_GAMECORE_ROGUEMODIFIERSETCOUNTBYDESTRUCTPROPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3FC5D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierSetCountByDestructPropConfig_TypeDefinitionIndex = 17504;
