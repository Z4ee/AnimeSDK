...
#define RPG_GAMECORE_ROGUEMODIFIERSETCOUNTBYDESTRUCTPROPCONFIG_METHOD_3_B7A7293E9EBC1A83_OFFSET UNITYSDK_OFFSET(0x1762CCB0)
#define RPG_GAMECORE_ROGUEMODIFIERSETCOUNTBYDESTRUCTPROPCONFIG_METHOD_3_C259A398F0231ECA_OFFSET UNITYSDK_OFFSET(0x176393E0)
#define RPG_GAMECORE_ROGUEMODIFIERSETCOUNTBYDESTRUCTPROPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1762CC60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierSetCountByDestructPropConfig_TypeDefinitionIndex = 16270;
