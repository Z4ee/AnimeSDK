...
#define RPG_GAMECORE_SETLUAACTIONQUEUEPAUSE_METHOD_3_016E70F684AA9B94_OFFSET UNITYSDK_OFFSET(0x19C54990)
#define RPG_GAMECORE_SETLUAACTIONQUEUEPAUSE_METHOD_3_9A4F4D5EEC078F85_OFFSET UNITYSDK_OFFSET(0x19C54A10)
#define RPG_GAMECORE_SETLUAACTIONQUEUEPAUSE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C549E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetLuaActionQueuePause_TypeDefinitionIndex = 22961;
