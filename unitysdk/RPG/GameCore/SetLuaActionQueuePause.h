...
#define RPG_GAMECORE_SETLUAACTIONQUEUEPAUSE_METHOD_3_84638D22C4268AC6_OFFSET UNITYSDK_OFFSET(0x1C5FF440)
#define RPG_GAMECORE_SETLUAACTIONQUEUEPAUSE_METHOD_3_9A4F4D5EEC078F85_OFFSET UNITYSDK_OFFSET(0x1C5FF490)
#define RPG_GAMECORE_SETLUAACTIONQUEUEPAUSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5FF480)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetLuaActionQueuePause_TypeDefinitionIndex = 23428;
