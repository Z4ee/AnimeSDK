...
#define RPG_GAMECORE_ROGUEACTUSEROGUEMIRACLECONFIG_METHOD_6_61BC501128BDE607_OFFSET UNITYSDK_OFFSET(0x18CD9920)
#define RPG_GAMECORE_ROGUEACTUSEROGUEMIRACLECONFIG_METHOD_6_BECBDD170CCEDF92_OFFSET UNITYSDK_OFFSET(0x18CD9B40)
#define RPG_GAMECORE_ROGUEACTUSEROGUEMIRACLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CD9A60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActUseRogueMiracleConfig_TypeDefinitionIndex = 18646;
