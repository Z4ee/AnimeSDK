...
#define RPG_GAMECORE_ROGUEACTUSEROGUEMIRACLECONFIG_METHOD_6_8530DF13D9B79936_OFFSET UNITYSDK_OFFSET(0x1C49EEC0)
#define RPG_GAMECORE_ROGUEACTUSEROGUEMIRACLECONFIG_METHOD_6_BECBDD170CCEDF92_OFFSET UNITYSDK_OFFSET(0x1C49EF10)
#define RPG_GAMECORE_ROGUEACTUSEROGUEMIRACLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C49EF00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActUseRogueMiracleConfig_TypeDefinitionIndex = 18889;
