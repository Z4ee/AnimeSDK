...
#define RPG_GAMECORE_FATEBATTLEMANAGER___C__DISPLAYCLASS32_0__CTOR_OFFSET UNITYSDK_OFFSET(0xB68C5A0)
#define RPG_GAMECORE_FATEBATTLEMANAGER___C__DISPLAYCLASS32_0___APPLYFATEBUFF_B__0_OFFSET UNITYSDK_OFFSET(0xB68E3C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateBattleManager___c__DisplayClass32_0_TypeDefinitionIndex = 51683;

	class FateBattleManager___c__DisplayClass32_0 : public ::System::Object
	{
	public:
		::Class_1_A64CC8A9B1CC56C5* pFateBuffData; // 0x10
