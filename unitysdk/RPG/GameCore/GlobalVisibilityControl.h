...
#define RPG_GAMECORE_GLOBALVISIBILITYCONTROL_METHOD_3_8F919A33E7132401_OFFSET UNITYSDK_OFFSET(0x17249910)
#define RPG_GAMECORE_GLOBALVISIBILITYCONTROL_METHOD_3_F082D0C12E25B64F_OFFSET UNITYSDK_OFFSET(0x172499B0)
#define RPG_GAMECORE_GLOBALVISIBILITYCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x17249970)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GlobalVisibilityControl_TypeDefinitionIndex = 18559;
