...
#define RPG_GAMECORE_CLEARFORMATIONFACEDELTA_METHOD_3_4E74BA0020C53D2D_OFFSET UNITYSDK_OFFSET(0x1CFDA7E0)
#define RPG_GAMECORE_CLEARFORMATIONFACEDELTA_METHOD_3_BB64BB56ED7E78F8_OFFSET UNITYSDK_OFFSET(0x1CFDA820)
#define RPG_GAMECORE_CLEARFORMATIONFACEDELTA__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFDA810)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClearFormationFaceDelta_TypeDefinitionIndex = 23124;
