...
#define RPG_GAMECORE_CLEARFORMATIONFACEDELTA_METHOD_3_A9BD65259531A481_OFFSET UNITYSDK_OFFSET(0x170B25F0)
#define RPG_GAMECORE_CLEARFORMATIONFACEDELTA_METHOD_3_BB64BB56ED7E78F8_OFFSET UNITYSDK_OFFSET(0x170B2670)
#define RPG_GAMECORE_CLEARFORMATIONFACEDELTA__CTOR_OFFSET UNITYSDK_OFFSET(0x170B2640)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClearFormationFaceDelta_TypeDefinitionIndex = 21614;
