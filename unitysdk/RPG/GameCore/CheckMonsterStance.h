...
#define RPG_GAMECORE_CHECKMONSTERSTANCE_METHOD_3_0632A0E8D2A3BA22_OFFSET UNITYSDK_OFFSET(0x187DAE60)
#define RPG_GAMECORE_CHECKMONSTERSTANCE_METHOD_3_1DE3C1202F104BD4_OFFSET UNITYSDK_OFFSET(0x187DAEE0)
#define RPG_GAMECORE_CHECKMONSTERSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x187DAEB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CheckMonsterStance_TypeDefinitionIndex = 21892;
