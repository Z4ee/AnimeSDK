...
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMERDRINK_METHOD_4_533361F3D420D974_OFFSET UNITYSDK_OFFSET(0x1B781310)
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMERDRINK_METHOD_4_D2999C1DAC264FB1_OFFSET UNITYSDK_OFFSET(0x1B7813E0)
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMERDRINK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7813D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_ElfCustomerDrink_TypeDefinitionIndex = 20733;
