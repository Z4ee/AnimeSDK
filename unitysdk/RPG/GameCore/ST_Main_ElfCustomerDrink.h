...
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMERDRINK_METHOD_4_5F8F22129B7ABD0E_OFFSET UNITYSDK_OFFSET(0x18DEF350)
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMERDRINK_METHOD_4_D2999C1DAC264FB1_OFFSET UNITYSDK_OFFSET(0x18DE5950)
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMERDRINK__CTOR_OFFSET UNITYSDK_OFFSET(0x18DE5900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_ElfCustomerDrink_TypeDefinitionIndex = 20394;
