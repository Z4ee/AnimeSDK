...
#define RPG_GAMECORE_MAPROTATIONGLOBALCONFIG_METHOD_2_7043A8210F0F0D77_OFFSET UNITYSDK_OFFSET(0x17380300)
#define RPG_GAMECORE_MAPROTATIONGLOBALCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17380630)
