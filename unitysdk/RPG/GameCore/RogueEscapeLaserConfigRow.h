...
#define RPG_GAMECORE_ROGUEESCAPELASERCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17608B10)
#define RPG_GAMECORE_ROGUEESCAPELASERCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17609250)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueEscapeLaserConfigRow_TypeDefinitionIndex = 13399;
