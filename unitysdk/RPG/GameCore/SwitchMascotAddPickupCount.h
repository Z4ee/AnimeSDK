...
#define RPG_GAMECORE_SWITCHMASCOTADDPICKUPCOUNT_METHOD_3_8A04627268CEE2A0_OFFSET UNITYSDK_OFFSET(0x1E14FBA0)
#define RPG_GAMECORE_SWITCHMASCOTADDPICKUPCOUNT_METHOD_3_9AF5A991A716BB33_OFFSET UNITYSDK_OFFSET(0x1E14FBE0)
#define RPG_GAMECORE_SWITCHMASCOTADDPICKUPCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E14FBD0)
