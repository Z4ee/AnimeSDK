...
#define RPG_GAMECORE_SWITCHMASCOTADDPICKUPCOUNT_METHOD_3_9AF5A991A716BB33_OFFSET UNITYSDK_OFFSET(0x17796050)
#define RPG_GAMECORE_SWITCHMASCOTADDPICKUPCOUNT_METHOD_3_AE54009BEA146CEA_OFFSET UNITYSDK_OFFSET(0x17795FD0)
#define RPG_GAMECORE_SWITCHMASCOTADDPICKUPCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x17796020)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchMascotAddPickupCount_TypeDefinitionIndex = 20173;
