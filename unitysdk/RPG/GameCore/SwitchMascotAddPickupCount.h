...
#define RPG_GAMECORE_SWITCHMASCOTADDPICKUPCOUNT_METHOD_3_8A04627268CEE2A0_OFFSET UNITYSDK_OFFSET(0x1B4373A0)
#define RPG_GAMECORE_SWITCHMASCOTADDPICKUPCOUNT_METHOD_3_9AF5A991A716BB33_OFFSET UNITYSDK_OFFSET(0x1B4373E0)
#define RPG_GAMECORE_SWITCHMASCOTADDPICKUPCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4373D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchMascotAddPickupCount_TypeDefinitionIndex = 21190;
