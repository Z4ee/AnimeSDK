...
#define RPG_GAMECORE_PINGPONGGRIDINDEX_METHOD_2_5323F2DF46A044DA_1_OFFSET UNITYSDK_OFFSET(0x1B4C8F20)
#define RPG_GAMECORE_PINGPONGGRIDINDEX_METHOD_2_5323F2DF46A044DA_OFFSET UNITYSDK_OFFSET(0x1B4C8F10)
#define RPG_GAMECORE_PINGPONGGRIDINDEX_METHOD_2_DBC7377967355536_OFFSET UNITYSDK_OFFSET(0x1B4C8D90)
#define RPG_GAMECORE_PINGPONGGRIDINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4C8F00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PingPongGridIndex_TypeDefinitionIndex = 16324;
