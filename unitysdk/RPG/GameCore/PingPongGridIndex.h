...
#define RPG_GAMECORE_PINGPONGGRIDINDEX_METHOD_2_5323F2DF46A044DA_1_OFFSET UNITYSDK_OFFSET(0x19A0ED40)
#define RPG_GAMECORE_PINGPONGGRIDINDEX_METHOD_2_5323F2DF46A044DA_OFFSET UNITYSDK_OFFSET(0x19A0ED30)
#define RPG_GAMECORE_PINGPONGGRIDINDEX_METHOD_2_DBC7377967355536_OFFSET UNITYSDK_OFFSET(0x19A0EBB0)
#define RPG_GAMECORE_PINGPONGGRIDINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0x19A0ED20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PingPongGridIndex_TypeDefinitionIndex = 16140;
