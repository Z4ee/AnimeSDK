...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_MODIFYPREVIEWVALUE_METHOD_3_52399EB291391AC9_OFFSET UNITYSDK_OFFSET(0x1C119BF0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_MODIFYPREVIEWVALUE_METHOD_3_83AFC2CE6CA289F9_OFFSET UNITYSDK_OFFSET(0x1C119C50)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_MODIFYPREVIEWVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C119C40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_ModifyPreviewValue_TypeDefinitionIndex = 15548;
