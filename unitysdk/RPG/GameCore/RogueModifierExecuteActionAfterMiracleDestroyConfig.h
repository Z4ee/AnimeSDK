...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONAFTERMIRACLEDESTROYCONFIG_METHOD_3_7A63E4B5BE0D111C_OFFSET UNITYSDK_OFFSET(0x1762ED10)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONAFTERMIRACLEDESTROYCONFIG_METHOD_3_95EE446CFB31EE25_OFFSET UNITYSDK_OFFSET(0x1762EC40)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONAFTERMIRACLEDESTROYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1762ECC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionAfterMiracleDestroyConfig_TypeDefinitionIndex = 16524;
