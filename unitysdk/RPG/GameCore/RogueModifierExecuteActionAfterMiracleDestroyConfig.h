...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONAFTERMIRACLEDESTROYCONFIG_METHOD_3_77BC0602985EEAA0_OFFSET UNITYSDK_OFFSET(0x1D3F7780)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONAFTERMIRACLEDESTROYCONFIG_METHOD_3_7A63E4B5BE0D111C_OFFSET UNITYSDK_OFFSET(0x1D3F77D0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONAFTERMIRACLEDESTROYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3F77C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionAfterMiracleDestroyConfig_TypeDefinitionIndex = 17770;
