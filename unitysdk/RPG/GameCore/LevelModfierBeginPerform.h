...
#define RPG_GAMECORE_LEVELMODFIERBEGINPERFORM_CLEAR_OFFSET UNITYSDK_OFFSET(0xA98FA90)
#define RPG_GAMECORE_LEVELMODFIERBEGINPERFORM_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xA98FB30)
#define RPG_GAMECORE_LEVELMODFIERBEGINPERFORM_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xA98FAE0)
#define RPG_GAMECORE_LEVELMODFIERBEGINPERFORM_INIT_OFFSET UNITYSDK_OFFSET(0xA98FA40)
#define RPG_GAMECORE_LEVELMODFIERBEGINPERFORM__CTOR_OFFSET UNITYSDK_OFFSET(0xA98FB80)
#define RPG_GAMECORE_LEVELMODFIERBEGINPERFORM___IFIXBASEPROXY_CLEAR_OFFSET UNITYSDK_OFFSET(0xA98FB90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelModfierBeginPerform_TypeDefinitionIndex = 45676;
