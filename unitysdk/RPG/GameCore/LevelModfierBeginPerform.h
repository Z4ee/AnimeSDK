...
#define RPG_GAMECORE_LEVELMODFIERBEGINPERFORM_CLEAR_OFFSET UNITYSDK_OFFSET(0xCE4BE50)
#define RPG_GAMECORE_LEVELMODFIERBEGINPERFORM_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xCE4BEF0)
#define RPG_GAMECORE_LEVELMODFIERBEGINPERFORM_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xCE4BEA0)
#define RPG_GAMECORE_LEVELMODFIERBEGINPERFORM_INIT_OFFSET UNITYSDK_OFFSET(0xCE4BE00)
#define RPG_GAMECORE_LEVELMODFIERBEGINPERFORM__CTOR_OFFSET UNITYSDK_OFFSET(0xCE4BF40)
#define RPG_GAMECORE_LEVELMODFIERBEGINPERFORM___IFIXBASEPROXY_CLEAR_OFFSET UNITYSDK_OFFSET(0xCE4BF50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelModfierBeginPerform_TypeDefinitionIndex = 53025;
