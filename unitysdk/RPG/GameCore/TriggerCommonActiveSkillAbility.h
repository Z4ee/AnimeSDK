...
#define RPG_GAMECORE_TRIGGERCOMMONACTIVESKILLABILITY_METHOD_3_F66A0BACF26821D1_OFFSET UNITYSDK_OFFSET(0x190BF000)
#define RPG_GAMECORE_TRIGGERCOMMONACTIVESKILLABILITY_METHOD_3_FD422308C2686178_OFFSET UNITYSDK_OFFSET(0x190BF080)
#define RPG_GAMECORE_TRIGGERCOMMONACTIVESKILLABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x190BF050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerCommonActiveSkillAbility_TypeDefinitionIndex = 21598;
