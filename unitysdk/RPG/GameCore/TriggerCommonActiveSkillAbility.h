...
#define RPG_GAMECORE_TRIGGERCOMMONACTIVESKILLABILITY_METHOD_3_F66A0BACF26821D1_OFFSET UNITYSDK_OFFSET(0x19E09BE0)
#define RPG_GAMECORE_TRIGGERCOMMONACTIVESKILLABILITY_METHOD_3_FD422308C2686178_OFFSET UNITYSDK_OFFSET(0x19E09C60)
#define RPG_GAMECORE_TRIGGERCOMMONACTIVESKILLABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x19E09C30)
