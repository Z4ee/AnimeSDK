...
#define RPG_GAMECORE_TRIGGERCOMMONACTIVESKILLABILITY_METHOD_3_759F334F1D297A1B_OFFSET UNITYSDK_OFFSET(0x1D5F16D0)
#define RPG_GAMECORE_TRIGGERCOMMONACTIVESKILLABILITY_METHOD_3_FD422308C2686178_OFFSET UNITYSDK_OFFSET(0x1D5F1710)
#define RPG_GAMECORE_TRIGGERCOMMONACTIVESKILLABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5F1700)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerCommonActiveSkillAbility_TypeDefinitionIndex = 22445;
