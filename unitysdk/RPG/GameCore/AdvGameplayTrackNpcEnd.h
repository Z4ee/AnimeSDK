...
#define RPG_GAMECORE_ADVGAMEPLAYTRACKNPCEND_METHOD_3_4A66C9E8C9B25A1B_OFFSET UNITYSDK_OFFSET(0x194260E0)
#define RPG_GAMECORE_ADVGAMEPLAYTRACKNPCEND_METHOD_3_D706484C9E9B2B8F_OFFSET UNITYSDK_OFFSET(0x194261F0)
#define RPG_GAMECORE_ADVGAMEPLAYTRACKNPCEND__CTOR_OFFSET UNITYSDK_OFFSET(0x194261C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvGameplayTrackNpcEnd_TypeDefinitionIndex = 20964;
