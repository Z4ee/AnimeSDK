...
#define RPG_GAMECORE_LOCKSTANCE_METHOD_3_70BAF3ED155CFB89_OFFSET UNITYSDK_OFFSET(0x18A798E0)
#define RPG_GAMECORE_LOCKSTANCE_METHOD_3_BE89E0DBB231D1EB_OFFSET UNITYSDK_OFFSET(0x18A797C0)
#define RPG_GAMECORE_LOCKSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x18A79860)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LockStance_TypeDefinitionIndex = 22602;
