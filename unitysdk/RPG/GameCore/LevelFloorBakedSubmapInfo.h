...
#define RPG_GAMECORE_LEVELFLOORBAKEDSUBMAPINFO_METHOD_2_FD543A47F11708BD_OFFSET UNITYSDK_OFFSET(0x1D1D0B80)
#define RPG_GAMECORE_LEVELFLOORBAKEDSUBMAPINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1D0E10)
