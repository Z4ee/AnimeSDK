...
#define RPG_GAMECORE_LEVELFLOORBAKEDSUBMAPINFO_METHOD_2_92F1B9CCEAD59391_OFFSET UNITYSDK_OFFSET(0x173351D0)
#define RPG_GAMECORE_LEVELFLOORBAKEDSUBMAPINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x17335430)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelFloorBakedSubmapInfo_TypeDefinitionIndex = 15756;
