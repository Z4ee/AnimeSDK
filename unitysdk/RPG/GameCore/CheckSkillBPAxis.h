...
#define RPG_GAMECORE_CHECKSKILLBPAXIS_METHOD_3_6B5C712AAD937302_OFFSET UNITYSDK_OFFSET(0x1E003E80)
#define RPG_GAMECORE_CHECKSKILLBPAXIS_METHOD_3_D635DAF99E7F1675_OFFSET UNITYSDK_OFFSET(0x1E003E40)
#define RPG_GAMECORE_CHECKSKILLBPAXIS__CTOR_OFFSET UNITYSDK_OFFSET(0x1E003E70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CheckSkillBPAxis_TypeDefinitionIndex = 15335;
