...
#define RPG_GAMECORE_FREESTYLEMOTIONIDTOLAYERLISTCONFIG_METHOD_2_53A603F8AA8661FC_OFFSET UNITYSDK_OFFSET(0x1DCBBCE0)
#define RPG_GAMECORE_FREESTYLEMOTIONIDTOLAYERLISTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCBBD20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FreeStyleMotionIDToLayerListConfig_TypeDefinitionIndex = 16147;
