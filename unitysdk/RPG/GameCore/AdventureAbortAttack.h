...
#define RPG_GAMECORE_ADVENTUREABORTATTACK_METHOD_3_366090A8E0064C3D_OFFSET UNITYSDK_OFFSET(0x1943F510)
#define RPG_GAMECORE_ADVENTUREABORTATTACK_METHOD_3_4D2618B5C2E58F71_OFFSET UNITYSDK_OFFSET(0x1943F620)
#define RPG_GAMECORE_ADVENTUREABORTATTACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1943F5F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureAbortAttack_TypeDefinitionIndex = 19065;
