...
#define RPG_GAMECORE_ADVENTUREABORTATTACK_METHOD_3_4D2618B5C2E58F71_OFFSET UNITYSDK_OFFSET(0x1CBA78F0)
#define RPG_GAMECORE_ADVENTUREABORTATTACK_METHOD_3_B6BA1AA5838DCF34_OFFSET UNITYSDK_OFFSET(0x1CBA7820)
#define RPG_GAMECORE_ADVENTUREABORTATTACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1CBA78E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureAbortAttack_TypeDefinitionIndex = 19963;
