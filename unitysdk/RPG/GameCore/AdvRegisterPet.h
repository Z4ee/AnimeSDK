...
#define RPG_GAMECORE_ADVREGISTERPET_METHOD_3_487D7F683FD16BEB_OFFSET UNITYSDK_OFFSET(0x1CDD6700)
#define RPG_GAMECORE_ADVREGISTERPET_METHOD_3_6AEAE9FCE96FBD58_OFFSET UNITYSDK_OFFSET(0x1CDD66C0)
#define RPG_GAMECORE_ADVREGISTERPET__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDD66F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvRegisterPet_TypeDefinitionIndex = 20703;
