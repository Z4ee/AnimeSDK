...
#define RPG_GAMECORE_ADVREGISTERPET_METHOD_3_39A19490067EEA82_OFFSET UNITYSDK_OFFSET(0x1865F360)
#define RPG_GAMECORE_ADVREGISTERPET_METHOD_3_487D7F683FD16BEB_OFFSET UNITYSDK_OFFSET(0x1865F3E0)
#define RPG_GAMECORE_ADVREGISTERPET__CTOR_OFFSET UNITYSDK_OFFSET(0x1865F3B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvRegisterPet_TypeDefinitionIndex = 19930;
