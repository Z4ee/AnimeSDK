...
#define RPG_GAMECORE_TARGETFETCHCALLBACKMODIFIERCASTER_METHOD_4_8CEAF60DC65EB4E2_OFFSET UNITYSDK_OFFSET(0x18EDBAB0)
#define RPG_GAMECORE_TARGETFETCHCALLBACKMODIFIERCASTER_METHOD_4_F17D451F28FB4790_OFFSET UNITYSDK_OFFSET(0x18EE3720)
#define RPG_GAMECORE_TARGETFETCHCALLBACKMODIFIERCASTER__CTOR_OFFSET UNITYSDK_OFFSET(0x18EDBA60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchCallBackModifierCaster_TypeDefinitionIndex = 22910;
