...
#define RPG_GAMECORE_ROGUEACTGETDESTROYEDROGUEMIRACLECONFIG_METHOD_6_4DE681D9872D319E_OFFSET UNITYSDK_OFFSET(0x175B5980)
#define RPG_GAMECORE_ROGUEACTGETDESTROYEDROGUEMIRACLECONFIG_METHOD_6_963EB111FB2F4A1B_OFFSET UNITYSDK_OFFSET(0x175B5760)
#define RPG_GAMECORE_ROGUEACTGETDESTROYEDROGUEMIRACLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175B58A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActGetDestroyedRogueMiracleConfig_TypeDefinitionIndex = 17967;
