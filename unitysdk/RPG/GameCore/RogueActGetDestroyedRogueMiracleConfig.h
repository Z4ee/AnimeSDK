...
#define RPG_GAMECORE_ROGUEACTGETDESTROYEDROGUEMIRACLECONFIG_METHOD_6_4DE681D9872D319E_OFFSET UNITYSDK_OFFSET(0x1D3B75C0)
#define RPG_GAMECORE_ROGUEACTGETDESTROYEDROGUEMIRACLECONFIG_METHOD_6_C498AC457DE1DD82_OFFSET UNITYSDK_OFFSET(0x1D3B7570)
#define RPG_GAMECORE_ROGUEACTGETDESTROYEDROGUEMIRACLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3B75B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActGetDestroyedRogueMiracleConfig_TypeDefinitionIndex = 19381;
