...
#define RPG_GAMECORE_ROGUEACTGETROGUEBUFFBYMOSTBUFFAEONCONFIG_METHOD_6_144345369DF1DE2B_OFFSET UNITYSDK_OFFSET(0x18CC2CD0)
#define RPG_GAMECORE_ROGUEACTGETROGUEBUFFBYMOSTBUFFAEONCONFIG_METHOD_6_C5BCE8C0D9B0FB3E_OFFSET UNITYSDK_OFFSET(0x18CC2AB0)
#define RPG_GAMECORE_ROGUEACTGETROGUEBUFFBYMOSTBUFFAEONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CC2BF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActGetRogueBuffByMostBuffAeonConfig_TypeDefinitionIndex = 18662;
