...
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTBOOSTJAMCONFIG_METHOD_3_CF7FAA60D4FFAE62_OFFSET UNITYSDK_OFFSET(0x1D1F9F10)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTBOOSTJAMCONFIG_METHOD_3_EF1D4E4AA5316436_OFFSET UNITYSDK_OFFSET(0x1D1F9E40)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTBOOSTJAMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1F9F00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityPixAirEffectBoostJamConfig_TypeDefinitionIndex = 21107;
