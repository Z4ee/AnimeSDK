...
#define RPG_GAMECORE_ADVNPCGUARDALERTDEVICEINACTIVE_METHOD_3_719C8C130B9FB8F1_OFFSET UNITYSDK_OFFSET(0x16F37D90)
#define RPG_GAMECORE_ADVNPCGUARDALERTDEVICEINACTIVE_METHOD_3_73D63B50449284AF_OFFSET UNITYSDK_OFFSET(0x16F37E10)
#define RPG_GAMECORE_ADVNPCGUARDALERTDEVICEINACTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F37DE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvNpcGuardAlertDeviceInactive_TypeDefinitionIndex = 18264;
