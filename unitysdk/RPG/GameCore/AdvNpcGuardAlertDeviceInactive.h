...
#define RPG_GAMECORE_ADVNPCGUARDALERTDEVICEINACTIVE_METHOD_3_A8311199EC4EFF7A_OFFSET UNITYSDK_OFFSET(0x1CDD1D80)
#define RPG_GAMECORE_ADVNPCGUARDALERTDEVICEINACTIVE_METHOD_3_E5BC83204142692D_OFFSET UNITYSDK_OFFSET(0x1CDD1DC0)
#define RPG_GAMECORE_ADVNPCGUARDALERTDEVICEINACTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDD1DB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvNpcGuardAlertDeviceInactive_TypeDefinitionIndex = 19758;
