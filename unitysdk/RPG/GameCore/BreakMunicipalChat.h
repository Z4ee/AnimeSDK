...
#define RPG_GAMECORE_BREAKMUNICIPALCHAT_METHOD_3_184DF2C147AC1120_OFFSET UNITYSDK_OFFSET(0x1871C460)
#define RPG_GAMECORE_BREAKMUNICIPALCHAT_METHOD_3_E03E0D0FBEFA82B1_OFFSET UNITYSDK_OFFSET(0x1871C3E0)
#define RPG_GAMECORE_BREAKMUNICIPALCHAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1871C430)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BreakMunicipalChat_TypeDefinitionIndex = 20064;
