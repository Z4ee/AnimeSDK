...
#define RPG_GAMECORE_MICONDITIONENTRYCONFIG_METHOD_2_301726C19AA96963_OFFSET UNITYSDK_OFFSET(0x1AF62E20)
#define RPG_GAMECORE_MICONDITIONENTRYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF62E60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MiConditionEntryConfig_TypeDefinitionIndex = 16390;
