...
#define RPG_GAMECORE_MICONDITIONENTRYCONFIG_METHOD_2_301726C19AA96963_OFFSET UNITYSDK_OFFSET(0x18B1F500)
#define RPG_GAMECORE_MICONDITIONENTRYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18B1F540)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MiConditionEntryConfig_TypeDefinitionIndex = 16161;
