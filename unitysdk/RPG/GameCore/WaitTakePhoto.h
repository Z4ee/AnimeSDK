...
#define RPG_GAMECORE_WAITTAKEPHOTO_METHOD_3_67B3EB7F1BB7E8C5_OFFSET UNITYSDK_OFFSET(0x1D6ADB40)
#define RPG_GAMECORE_WAITTAKEPHOTO_METHOD_3_A6B72822741B4A12_OFFSET UNITYSDK_OFFSET(0x1D6ADAF0)
#define RPG_GAMECORE_WAITTAKEPHOTO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6ADB30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitTakePhoto_TypeDefinitionIndex = 21923;
