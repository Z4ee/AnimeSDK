...
#define RPG_GAMECORE_TRAVELSHIPPOWERSPRINT_METHOD_3_009CE9131FFEE4C7_OFFSET UNITYSDK_OFFSET(0x190B6180)
#define RPG_GAMECORE_TRAVELSHIPPOWERSPRINT_METHOD_3_421E8F23A1484350_OFFSET UNITYSDK_OFFSET(0x190B6100)
#define RPG_GAMECORE_TRAVELSHIPPOWERSPRINT__CTOR_OFFSET UNITYSDK_OFFSET(0x190B6150)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TravelShipPowerSprint_TypeDefinitionIndex = 19961;
