...
#define RPG_GAMECORE_FATEPARAMGETMAPVALUECONFIG_METHOD_6_4D1480D58C5D18D4_OFFSET UNITYSDK_OFFSET(0x1E0CE8D0)
#define RPG_GAMECORE_FATEPARAMGETMAPVALUECONFIG_METHOD_6_ED8662264F00DD6A_OFFSET UNITYSDK_OFFSET(0x1E0CE870)
#define RPG_GAMECORE_FATEPARAMGETMAPVALUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0CE8C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateParamGetMapValueConfig_TypeDefinitionIndex = 16467;
