...
#define RPG_GAMECORE_FATEPARAMGETMAPVALUECONFIG_METHOD_6_4D1480D58C5D18D4_OFFSET UNITYSDK_OFFSET(0x188D7B50)
#define RPG_GAMECORE_FATEPARAMGETMAPVALUECONFIG_METHOD_6_B08999DDC038DBA5_OFFSET UNITYSDK_OFFSET(0x188D7960)
#define RPG_GAMECORE_FATEPARAMGETMAPVALUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x188D7A90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateParamGetMapValueConfig_TypeDefinitionIndex = 15762;
