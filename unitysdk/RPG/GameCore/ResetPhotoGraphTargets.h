...
#define RPG_GAMECORE_RESETPHOTOGRAPHTARGETS_METHOD_3_7CF91E1ADBF31718_OFFSET UNITYSDK_OFFSET(0x18CAAE60)
#define RPG_GAMECORE_RESETPHOTOGRAPHTARGETS_METHOD_3_D2465DB21DC23B71_OFFSET UNITYSDK_OFFSET(0x18CAAEE0)
#define RPG_GAMECORE_RESETPHOTOGRAPHTARGETS__CTOR_OFFSET UNITYSDK_OFFSET(0x18CAAEB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetPhotoGraphTargets_TypeDefinitionIndex = 20487;
