...
#define RPG_GAMECORE_TRAINPARTYBUILDITEMDYNAMICBINDVALUE_FSV_METHOD_3_AA722626F35EEB4D_OFFSET UNITYSDK_OFFSET(0x178A8C00)
#define RPG_GAMECORE_TRAINPARTYBUILDITEMDYNAMICBINDVALUE_FSV_METHOD_3_ECEB80A28DEBE07A_OFFSET UNITYSDK_OFFSET(0x178A8EB0)
#define RPG_GAMECORE_TRAINPARTYBUILDITEMDYNAMICBINDVALUE_FSV__CTOR_OFFSET UNITYSDK_OFFSET(0x178A8BF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyBuildItemDynamicBindValue_FSV_TypeDefinitionIndex = 14884;
