...
#define RPG_GAMECORE_TRAINPARTYBUILDITEMDYNAMICBINDVALUE_FSV_METHOD_3_44B2F0F86FF7FDC3_OFFSET UNITYSDK_OFFSET(0x1C15E0D0)
#define RPG_GAMECORE_TRAINPARTYBUILDITEMDYNAMICBINDVALUE_FSV_METHOD_3_AA722626F35EEB4D_OFFSET UNITYSDK_OFFSET(0x1C15DE00)
#define RPG_GAMECORE_TRAINPARTYBUILDITEMDYNAMICBINDVALUE_FSV__CTOR_OFFSET UNITYSDK_OFFSET(0x1C15DDF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyBuildItemDynamicBindValue_FSV_TypeDefinitionIndex = 15625;
