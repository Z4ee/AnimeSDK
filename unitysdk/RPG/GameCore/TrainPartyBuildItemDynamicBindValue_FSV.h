...
#define RPG_GAMECORE_TRAINPARTYBUILDITEMDYNAMICBINDVALUE_FSV_METHOD_3_44B2F0F86FF7FDC3_OFFSET UNITYSDK_OFFSET(0x190A7AF0)
#define RPG_GAMECORE_TRAINPARTYBUILDITEMDYNAMICBINDVALUE_FSV_METHOD_3_AA722626F35EEB4D_OFFSET UNITYSDK_OFFSET(0x190A7820)
#define RPG_GAMECORE_TRAINPARTYBUILDITEMDYNAMICBINDVALUE_FSV__CTOR_OFFSET UNITYSDK_OFFSET(0x190A7810)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyBuildItemDynamicBindValue_FSV_TypeDefinitionIndex = 15391;
