...
#define RPG_GAMECORE_CHIMERADUELSETCHIMERALIGHTWEIGHTACTIVENODE_METHOD_3_250721E2E4E8F572_OFFSET UNITYSDK_OFFSET(0x1E33BD50)
#define RPG_GAMECORE_CHIMERADUELSETCHIMERALIGHTWEIGHTACTIVENODE_METHOD_3_61CA27C536F3FF90_OFFSET UNITYSDK_OFFSET(0x1E33BDB0)
#define RPG_GAMECORE_CHIMERADUELSETCHIMERALIGHTWEIGHTACTIVENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E33BDA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelSetChimeraLightWeightActiveNode_TypeDefinitionIndex = 15797;
