...
#define RPG_GAMECORE_CHIMERADUELSETCHIMERALIGHTWEIGHTACTIVENODE_METHOD_3_4C5BD286E52F3E9F_OFFSET UNITYSDK_OFFSET(0x170A5750)
#define RPG_GAMECORE_CHIMERADUELSETCHIMERALIGHTWEIGHTACTIVENODE_METHOD_3_61CA27C536F3FF90_OFFSET UNITYSDK_OFFSET(0x170A5850)
#define RPG_GAMECORE_CHIMERADUELSETCHIMERALIGHTWEIGHTACTIVENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x170A57F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelSetChimeraLightWeightActiveNode_TypeDefinitionIndex = 14664;
