...
#define RPG_GAMECORE_CHIMERADUELSETCHIMERALIGHTWEIGHTACTIVENODE_METHOD_3_4C5BD286E52F3E9F_OFFSET UNITYSDK_OFFSET(0x18804D00)
#define RPG_GAMECORE_CHIMERADUELSETCHIMERALIGHTWEIGHTACTIVENODE_METHOD_3_61CA27C536F3FF90_OFFSET UNITYSDK_OFFSET(0x18804E00)
#define RPG_GAMECORE_CHIMERADUELSETCHIMERALIGHTWEIGHTACTIVENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x18804DA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelSetChimeraLightWeightActiveNode_TypeDefinitionIndex = 15134;
