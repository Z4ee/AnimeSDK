...
#define RPG_GAMECORE_CAKERACECATIDLISTSELECTORCONFIG_METHOD_3_8BEF3CA76438DBCE_OFFSET UNITYSDK_OFFSET(0x1876DE20)
#define RPG_GAMECORE_CAKERACECATIDLISTSELECTORCONFIG_METHOD_3_DBBB3D635C7AFBFD_OFFSET UNITYSDK_OFFSET(0x1876F840)
#define RPG_GAMECORE_CAKERACECATIDLISTSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1876DE10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceCatIdListSelectorConfig_TypeDefinitionIndex = 17488;
