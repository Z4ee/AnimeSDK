...
#define RPG_GAMECORE_CAKERACECATIDLISTSELECTORCONFIG_METHOD_3_356A2F8BA195DE18_OFFSET UNITYSDK_OFFSET(0x195EB750)
#define RPG_GAMECORE_CAKERACECATIDLISTSELECTORCONFIG_METHOD_3_D16C95BCD7EA4BCB_OFFSET UNITYSDK_OFFSET(0x195E9D60)
#define RPG_GAMECORE_CAKERACECATIDLISTSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x195E9D50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceCatIdListSelectorConfig_TypeDefinitionIndex = 17490;
