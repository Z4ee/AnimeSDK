...
#define RPG_GAMECORE_LEVELCHARACTERCREATE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xCE3A140)
#define RPG_GAMECORE_LEVELCHARACTERCREATE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xCE3A0F0)
#define RPG_GAMECORE_LEVELCHARACTERCREATE_GET_CHARACTERNAME_OFFSET UNITYSDK_OFFSET(0xCE3A190)
#define RPG_GAMECORE_LEVELCHARACTERCREATE__CTOR_OFFSET UNITYSDK_OFFSET(0xCE3A0E0)
