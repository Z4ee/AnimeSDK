...
#define RPG_GAMECORE_PARKOURGAMESETCAMERAFOV_METHOD_3_70A51FEFE5CF01A2_OFFSET UNITYSDK_OFFSET(0x18BD4C20)
#define RPG_GAMECORE_PARKOURGAMESETCAMERAFOV_METHOD_3_BCCA35A5CA792654_OFFSET UNITYSDK_OFFSET(0x18BD4CA0)
#define RPG_GAMECORE_PARKOURGAMESETCAMERAFOV__CTOR_OFFSET UNITYSDK_OFFSET(0x18BD4C70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ParkourGameSetCameraFOV_TypeDefinitionIndex = 19970;
