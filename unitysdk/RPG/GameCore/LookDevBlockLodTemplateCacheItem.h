...
#define RPG_GAMECORE_LOOKDEVBLOCKLODTEMPLATECACHEITEM_METHOD_2_D1633386120149C7_OFFSET UNITYSDK_OFFSET(0x1D213C20)
#define RPG_GAMECORE_LOOKDEVBLOCKLODTEMPLATECACHEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D213D10)
