...
#define RPG_GAMECORE_TRIGGERVALIDGUESTCONFIG_METHOD_2_2F05C136FAF6EF53_OFFSET UNITYSDK_OFFSET(0x1D60BA10)
#define RPG_GAMECORE_TRIGGERVALIDGUESTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D60BD30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerValidGuestConfig_TypeDefinitionIndex = 23619;
