...
#define RPG_GAMECORE_COMPLEXSKILLAIGLOBALGROUPLOOKUP_METHOD_2_535D5DD3096BDC36_OFFSET UNITYSDK_OFFSET(0x17123490)
#define RPG_GAMECORE_COMPLEXSKILLAIGLOBALGROUPLOOKUP__CTOR_OFFSET UNITYSDK_OFFSET(0x171235A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAIGlobalGroupLookup_TypeDefinitionIndex = 14264;
