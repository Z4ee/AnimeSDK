...
#define RPG_GAMECORE_FATEACTDEBUGLOGCONFIG_METHOD_6_000F76E947E859FB_OFFSET UNITYSDK_OFFSET(0x188CF010)
#define RPG_GAMECORE_FATEACTDEBUGLOGCONFIG_METHOD_6_E7BEB36A6949AF50_OFFSET UNITYSDK_OFFSET(0x188CEEA0)
#define RPG_GAMECORE_FATEACTDEBUGLOGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x188CEF70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateActDebugLogConfig_TypeDefinitionIndex = 18261;
