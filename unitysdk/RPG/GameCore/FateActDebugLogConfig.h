...
#define RPG_GAMECORE_FATEACTDEBUGLOGCONFIG_METHOD_6_000F76E947E859FB_OFFSET UNITYSDK_OFFSET(0x171C1840)
#define RPG_GAMECORE_FATEACTDEBUGLOGCONFIG_METHOD_6_E7BEB36A6949AF50_OFFSET UNITYSDK_OFFSET(0x171C16D0)
#define RPG_GAMECORE_FATEACTDEBUGLOGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171C17A0)
