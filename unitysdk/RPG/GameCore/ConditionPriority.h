...
#define RPG_GAMECORE_CONDITIONPRIORITY_METHOD_2_AC98736F767718EC_OFFSET UNITYSDK_OFFSET(0x19672C20)
#define RPG_GAMECORE_CONDITIONPRIORITY__CTOR_OFFSET UNITYSDK_OFFSET(0x19672D30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConditionPriority_TypeDefinitionIndex = 21426;
