...
#define RPG_GAMECORE_CHIMERADUELBUFFDISPLAYCONFIG_METHOD_2_E00313D7CA8F819A_OFFSET UNITYSDK_OFFSET(0x1CFC0930)
#define RPG_GAMECORE_CHIMERADUELBUFFDISPLAYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFC0B60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelBuffDisplayConfig_TypeDefinitionIndex = 15832;
