...
#define RPG_GAMECORE_MODIFYGRIDFIGHTCUSTOMPROPERTY_METHOD_3_935082945CA60222_OFFSET UNITYSDK_OFFSET(0x18B3E470)
#define RPG_GAMECORE_MODIFYGRIDFIGHTCUSTOMPROPERTY_METHOD_3_CFBD91B041AF2A25_OFFSET UNITYSDK_OFFSET(0x18B3E3E0)
#define RPG_GAMECORE_MODIFYGRIDFIGHTCUSTOMPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x18B3E440)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyGridFightCustomProperty_TypeDefinitionIndex = 21422;
