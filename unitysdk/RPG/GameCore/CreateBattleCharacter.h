...
#define RPG_GAMECORE_CREATEBATTLECHARACTER_METHOD_3_C646574CB357AF53_OFFSET UNITYSDK_OFFSET(0x1D005480)
#define RPG_GAMECORE_CREATEBATTLECHARACTER_METHOD_3_F4A92C1EB78C4FD0_OFFSET UNITYSDK_OFFSET(0x1D005520)
#define RPG_GAMECORE_CREATEBATTLECHARACTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0054E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CreateBattleCharacter_TypeDefinitionIndex = 22499;
