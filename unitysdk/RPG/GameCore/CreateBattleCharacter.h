...
#define RPG_GAMECORE_CREATEBATTLECHARACTER_METHOD_3_C646574CB357AF53_OFFSET UNITYSDK_OFFSET(0x1BC37F30)
#define RPG_GAMECORE_CREATEBATTLECHARACTER_METHOD_3_F4A92C1EB78C4FD0_OFFSET UNITYSDK_OFFSET(0x1BC37FD0)
#define RPG_GAMECORE_CREATEBATTLECHARACTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC37F90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CreateBattleCharacter_TypeDefinitionIndex = 21935;
