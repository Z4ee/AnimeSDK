...
#define RPG_GAMECORE_CREATEBATTLECHARACTER_METHOD_3_40182E6C28174453_OFFSET UNITYSDK_OFFSET(0x17139390)
#define RPG_GAMECORE_CREATEBATTLECHARACTER_METHOD_3_5465755261F61A67_OFFSET UNITYSDK_OFFSET(0x171392C0)
#define RPG_GAMECORE_CREATEBATTLECHARACTER__CTOR_OFFSET UNITYSDK_OFFSET(0x17139340)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CreateBattleCharacter_TypeDefinitionIndex = 20947;
