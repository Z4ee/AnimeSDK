...
#define RPG_GAMECORE_BYCHECKMODIFIERCALLBACKNAME_METHOD_4_677CCFB5331CFA80_OFFSET UNITYSDK_OFFSET(0x16FFFD30)
#define RPG_GAMECORE_BYCHECKMODIFIERCALLBACKNAME_METHOD_4_F165D56D331D2338_OFFSET UNITYSDK_OFFSET(0x16FFFE00)
#define RPG_GAMECORE_BYCHECKMODIFIERCALLBACKNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x16FFFDB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckModifierCallBackName_TypeDefinitionIndex = 21250;
