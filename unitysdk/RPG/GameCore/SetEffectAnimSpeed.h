...
#define RPG_GAMECORE_SETEFFECTANIMSPEED_METHOD_3_2A46242B0C8A8F15_OFFSET UNITYSDK_OFFSET(0x18E2C420)
#define RPG_GAMECORE_SETEFFECTANIMSPEED_METHOD_3_30B69F64DEA1AA49_OFFSET UNITYSDK_OFFSET(0x18E2C4A0)
#define RPG_GAMECORE_SETEFFECTANIMSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x18E2C470)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetEffectAnimSpeed_TypeDefinitionIndex = 21799;
