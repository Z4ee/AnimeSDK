...
#define RPG_GAMECORE_GRIDFIGHTFORGECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x189AE320)
#define RPG_GAMECORE_GRIDFIGHTFORGECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x189AE660)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID ForgeDesc; // 0x18
