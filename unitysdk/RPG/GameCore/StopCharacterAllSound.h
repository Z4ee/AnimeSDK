...
#define RPG_GAMECORE_STOPCHARACTERALLSOUND_METHOD_3_0937B74430F24020_OFFSET UNITYSDK_OFFSET(0x1CAFCCE0)
#define RPG_GAMECORE_STOPCHARACTERALLSOUND_METHOD_3_1A28FE636F3A18B3_OFFSET UNITYSDK_OFFSET(0x1CAFCD20)
#define RPG_GAMECORE_STOPCHARACTERALLSOUND__CTOR_OFFSET UNITYSDK_OFFSET(0x1CAFCD10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StopCharacterAllSound_TypeDefinitionIndex = 22252;
