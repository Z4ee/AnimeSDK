...
#define RPG_GAMECORE_STOPCHARACTERALLSOUND_METHOD_3_1A28FE636F3A18B3_OFFSET UNITYSDK_OFFSET(0x1777CDE0)
#define RPG_GAMECORE_STOPCHARACTERALLSOUND_METHOD_3_2D87556DB237CA6A_OFFSET UNITYSDK_OFFSET(0x1777CD60)
#define RPG_GAMECORE_STOPCHARACTERALLSOUND__CTOR_OFFSET UNITYSDK_OFFSET(0x1777CDB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StopCharacterAllSound_TypeDefinitionIndex = 20687;
