...
#define RPG_GAMECORE_RADIALBLURCURVEEFFECT_METHOD_3_438FBF522498970F_OFFSET UNITYSDK_OFFSET(0x19AA9560)
#define RPG_GAMECORE_RADIALBLURCURVEEFFECT_METHOD_3_4EC1D9D1A1AFCD93_OFFSET UNITYSDK_OFFSET(0x19AA9680)
#define RPG_GAMECORE_RADIALBLURCURVEEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x19AA9600)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RadialBlurCurveEffect_TypeDefinitionIndex = 19120;
