...
#define RPG_GAMECORE_RADIALBLURCURVEEFFECT_METHOD_3_438FBF522498970F_OFFSET UNITYSDK_OFFSET(0x1B9B1360)
#define RPG_GAMECORE_RADIALBLURCURVEEFFECT_METHOD_3_4EC1D9D1A1AFCD93_OFFSET UNITYSDK_OFFSET(0x1B9B1460)
#define RPG_GAMECORE_RADIALBLURCURVEEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9B13F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RadialBlurCurveEffect_TypeDefinitionIndex = 19476;
