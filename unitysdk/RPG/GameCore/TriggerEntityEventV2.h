...
#define RPG_GAMECORE_TRIGGERENTITYEVENTV2_METHOD_3_5308A41AD9DF701C_OFFSET UNITYSDK_OFFSET(0x178C6FE0)
#define RPG_GAMECORE_TRIGGERENTITYEVENTV2_METHOD_3_F83DE28664D4F2BD_OFFSET UNITYSDK_OFFSET(0x178C7060)
#define RPG_GAMECORE_TRIGGERENTITYEVENTV2__CTOR_OFFSET UNITYSDK_OFFSET(0x178C7030)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerEntityEventV2_TypeDefinitionIndex = 19041;
