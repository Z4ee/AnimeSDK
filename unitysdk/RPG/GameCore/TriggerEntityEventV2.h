...
#define RPG_GAMECORE_TRIGGERENTITYEVENTV2_METHOD_3_D21CCE74EA436F66_OFFSET UNITYSDK_OFFSET(0x1D28DF10)
#define RPG_GAMECORE_TRIGGERENTITYEVENTV2_METHOD_3_F83DE28664D4F2BD_OFFSET UNITYSDK_OFFSET(0x1D28DF50)
#define RPG_GAMECORE_TRIGGERENTITYEVENTV2__CTOR_OFFSET UNITYSDK_OFFSET(0x1D28DF40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerEntityEventV2_TypeDefinitionIndex = 20484;
