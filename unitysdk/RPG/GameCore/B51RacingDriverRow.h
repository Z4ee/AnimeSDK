...
#define RPG_GAMECORE_B51RACINGDRIVERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CE5D3E0)
#define RPG_GAMECORE_B51RACINGDRIVERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE5D6D0)
