...
#define RPG_GAMECORE_GRIDFIGHTPENALTYRULECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D15E130)
#define RPG_GAMECORE_GRIDFIGHTPENALTYRULECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D15E4C0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 ThresholdPassBasicPlayerHPPenalty; // 0x30
