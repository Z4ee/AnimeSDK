...
#define RPG_GAMECORE_WOLFBROCONFIG_METHOD_2_703A3283302E8C6F_OFFSET UNITYSDK_OFFSET(0x1790B460)
#define RPG_GAMECORE_WOLFBROCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1790B630)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WolfBroConfig_TypeDefinitionIndex = 15585;
