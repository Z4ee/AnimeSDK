...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_INITEXTRACOLORDICE_METHOD_3_A0C11C1732EA7698_OFFSET UNITYSDK_OFFSET(0x1C118ED0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_INITEXTRACOLORDICE_METHOD_3_AF8F5068FF3E16FD_OFFSET UNITYSDK_OFFSET(0x1C118F70)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_INITEXTRACOLORDICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C118F60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_InitExtraColorDice_TypeDefinitionIndex = 15446;
