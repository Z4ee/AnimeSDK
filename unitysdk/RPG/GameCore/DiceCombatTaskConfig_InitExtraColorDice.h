...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_INITEXTRACOLORDICE_METHOD_3_AF8F5068FF3E16FD_OFFSET UNITYSDK_OFFSET(0x196B34F0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_INITEXTRACOLORDICE_METHOD_3_D9719CB1365A6E82_OFFSET UNITYSDK_OFFSET(0x196B9210)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_INITEXTRACOLORDICE__CTOR_OFFSET UNITYSDK_OFFSET(0x196B34A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_InitExtraColorDice_TypeDefinitionIndex = 15282;
