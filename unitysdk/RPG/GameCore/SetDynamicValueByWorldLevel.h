...
#define RPG_GAMECORE_SETDYNAMICVALUEBYWORLDLEVEL_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1C5F4060)
#define RPG_GAMECORE_SETDYNAMICVALUEBYWORLDLEVEL_METHOD_4_3FCC275BB5E44B3A_OFFSET UNITYSDK_OFFSET(0x1C5F3E30)
#define RPG_GAMECORE_SETDYNAMICVALUEBYWORLDLEVEL_METHOD_4_DD060CA840C8B7C7_OFFSET UNITYSDK_OFFSET(0x1C5F3E70)
#define RPG_GAMECORE_SETDYNAMICVALUEBYWORLDLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5F3E60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByWorldLevel_TypeDefinitionIndex = 21943;
