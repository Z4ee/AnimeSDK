...
#define RPG_GAMECORE_SETMUNICIPALSTREAMCENTER_METHOD_3_88FA5BDC658E816E_OFFSET UNITYSDK_OFFSET(0x176D8EA0)
#define RPG_GAMECORE_SETMUNICIPALSTREAMCENTER_METHOD_3_D76EF45C4158299F_OFFSET UNITYSDK_OFFSET(0x176D8F20)
#define RPG_GAMECORE_SETMUNICIPALSTREAMCENTER__CTOR_OFFSET UNITYSDK_OFFSET(0x176D8EF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetMunicipalStreamCenter_TypeDefinitionIndex = 20453;
