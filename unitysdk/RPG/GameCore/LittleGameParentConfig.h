...
#define RPG_GAMECORE_LITTLEGAMEPARENTCONFIG_METHOD_3_90010129E71B1FEC_OFFSET UNITYSDK_OFFSET(0x1BCC3F50)
#define RPG_GAMECORE_LITTLEGAMEPARENTCONFIG_METHOD_3_99DF50D858C26FD1_OFFSET UNITYSDK_OFFSET(0x1BCC4000)
#define RPG_GAMECORE_LITTLEGAMEPARENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCC3FF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameParentConfig_TypeDefinitionIndex = 18112;
