...
#define RPG_GAMECORE_LITTLEGAMEPARENTCONFIG_METHOD_3_39DBF5AD5804DBB5_OFFSET UNITYSDK_OFFSET(0x1735FDE0)
#define RPG_GAMECORE_LITTLEGAMEPARENTCONFIG_METHOD_3_99DF50D858C26FD1_OFFSET UNITYSDK_OFFSET(0x1735AEE0)
#define RPG_GAMECORE_LITTLEGAMEPARENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1735AEC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameParentConfig_TypeDefinitionIndex = 17298;
