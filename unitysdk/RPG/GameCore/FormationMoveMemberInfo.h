...
#define RPG_GAMECORE_FORMATIONMOVEMEMBERINFO_METHOD_2_015CE73AB4EA966E_OFFSET UNITYSDK_OFFSET(0x1BEC0F80)
#define RPG_GAMECORE_FORMATIONMOVEMEMBERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEC1110)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FormationMoveMemberInfo_TypeDefinitionIndex = 20457;
