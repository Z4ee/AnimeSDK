...
#define RPG_GAMECORE_FORMATIONMOVEMEMBERINFO_METHOD_2_015CE73AB4EA966E_OFFSET UNITYSDK_OFFSET(0x172189E0)
#define RPG_GAMECORE_FORMATIONMOVEMEMBERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x17218B70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FormationMoveMemberInfo_TypeDefinitionIndex = 19553;
