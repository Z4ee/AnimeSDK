...
#define RPG_GAMECORE_TEAMTOWERSBOSSBRICKENTRYCONFIG_METHOD_2_E43B2EA901F3A5DE_OFFSET UNITYSDK_OFFSET(0x1C147520)
#define RPG_GAMECORE_TEAMTOWERSBOSSBRICKENTRYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1476A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TeamTowersBossBrickEntryConfig_TypeDefinitionIndex = 18209;
