...
#define RPG_GAMECORE_GROUPFILTERHOYOTAGEXPRESSION_METHOD_3_38663F4D52FEFF05_OFFSET UNITYSDK_OFFSET(0x1D3C2690)
#define RPG_GAMECORE_GROUPFILTERHOYOTAGEXPRESSION_METHOD_3_D5BC3C34A00A8889_OFFSET UNITYSDK_OFFSET(0x1D3C2680)
#define RPG_GAMECORE_GROUPFILTERHOYOTAGEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3C2670)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GroupFilterHoyoTagExpression_TypeDefinitionIndex = 17200;
