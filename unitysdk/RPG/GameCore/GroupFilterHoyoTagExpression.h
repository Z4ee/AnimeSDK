...
#define RPG_GAMECORE_GROUPFILTERHOYOTAGEXPRESSION_METHOD_3_38663F4D52FEFF05_OFFSET UNITYSDK_OFFSET(0x1D0805A0)
#define RPG_GAMECORE_GROUPFILTERHOYOTAGEXPRESSION_METHOD_3_D5BC3C34A00A8889_OFFSET UNITYSDK_OFFSET(0x1D080590)
#define RPG_GAMECORE_GROUPFILTERHOYOTAGEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D080580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GroupFilterHoyoTagExpression_TypeDefinitionIndex = 16698;
