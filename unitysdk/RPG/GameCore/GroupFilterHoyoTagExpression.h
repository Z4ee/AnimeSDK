...
#define RPG_GAMECORE_GROUPFILTERHOYOTAGEXPRESSION_METHOD_3_38663F4D52FEFF05_OFFSET UNITYSDK_OFFSET(0x1728C0E0)
#define RPG_GAMECORE_GROUPFILTERHOYOTAGEXPRESSION_METHOD_3_D5BC3C34A00A8889_OFFSET UNITYSDK_OFFSET(0x1728C0D0)
#define RPG_GAMECORE_GROUPFILTERHOYOTAGEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1728C0C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GroupFilterHoyoTagExpression_TypeDefinitionIndex = 15979;
