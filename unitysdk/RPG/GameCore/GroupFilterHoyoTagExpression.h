...
#define RPG_GAMECORE_GROUPFILTERHOYOTAGEXPRESSION_METHOD_3_38663F4D52FEFF05_OFFSET UNITYSDK_OFFSET(0x19813990)
#define RPG_GAMECORE_GROUPFILTERHOYOTAGEXPRESSION_METHOD_3_D5BC3C34A00A8889_OFFSET UNITYSDK_OFFSET(0x19813980)
#define RPG_GAMECORE_GROUPFILTERHOYOTAGEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x19813970)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GroupFilterHoyoTagExpression_TypeDefinitionIndex = 16536;
