...
#define RPG_GAMECORE_SHOWPUZZLEHUDWOLFBROINBOX_METHOD_3_388C9D23147CECDB_OFFSET UNITYSDK_OFFSET(0x18E652C0)
#define RPG_GAMECORE_SHOWPUZZLEHUDWOLFBROINBOX_METHOD_3_E0C2DF621D3B6F72_OFFSET UNITYSDK_OFFSET(0x18E65240)
#define RPG_GAMECORE_SHOWPUZZLEHUDWOLFBROINBOX__CTOR_OFFSET UNITYSDK_OFFSET(0x18E65290)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowPuzzleHudWolfBroInBox_TypeDefinitionIndex = 21179;
