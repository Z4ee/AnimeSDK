...
#define RPG_GAMECORE_PAUSEMUSICVISUALEFFECT_METHOD_3_14E44F1002B830BE_OFFSET UNITYSDK_OFFSET(0x199EABB0)
#define RPG_GAMECORE_PAUSEMUSICVISUALEFFECT_METHOD_3_5455548857FFD59E_OFFSET UNITYSDK_OFFSET(0x199EAD00)
#define RPG_GAMECORE_PAUSEMUSICVISUALEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x199EAC70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PauseMusicVisualEffect_TypeDefinitionIndex = 21086;
