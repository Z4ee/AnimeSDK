...
#define RPG_GAMECORE_PAUSEMUSICVISUALEFFECT_METHOD_3_4EC5421605E31908_OFFSET UNITYSDK_OFFSET(0x1D30FDB0)
#define RPG_GAMECORE_PAUSEMUSICVISUALEFFECT_METHOD_3_5455548857FFD59E_OFFSET UNITYSDK_OFFSET(0x1D30FE30)
#define RPG_GAMECORE_PAUSEMUSICVISUALEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D30FE00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PauseMusicVisualEffect_TypeDefinitionIndex = 22063;
