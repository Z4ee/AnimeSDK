...
#define RPG_GAMECORE_PAUSEMUSICVISUALEFFECT_METHOD_3_14E44F1002B830BE_OFFSET UNITYSDK_OFFSET(0x18BD8F20)
#define RPG_GAMECORE_PAUSEMUSICVISUALEFFECT_METHOD_3_5455548857FFD59E_OFFSET UNITYSDK_OFFSET(0x18BD9070)
#define RPG_GAMECORE_PAUSEMUSICVISUALEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x18BD8FE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PauseMusicVisualEffect_TypeDefinitionIndex = 21190;
