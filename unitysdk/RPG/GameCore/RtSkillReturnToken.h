...
#define RPG_GAMECORE_RTSKILLRETURNTOKEN_METHOD_3_45114EB408989551_OFFSET UNITYSDK_OFFSET(0x18DD7490)
#define RPG_GAMECORE_RTSKILLRETURNTOKEN_METHOD_3_482FD4EAD1B2CB0F_OFFSET UNITYSDK_OFFSET(0x18DD7510)
#define RPG_GAMECORE_RTSKILLRETURNTOKEN__CTOR_OFFSET UNITYSDK_OFFSET(0x18DD74E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtSkillReturnToken_TypeDefinitionIndex = 23223;
