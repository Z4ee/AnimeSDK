...
#define RPG_GAMECORE_ENABLELOCALPLAYERIGNORETIMEREWINDCOLLISION_METHOD_3_0EB2FC4E3311BC6F_OFFSET UNITYSDK_OFFSET(0x196E4970)
#define RPG_GAMECORE_ENABLELOCALPLAYERIGNORETIMEREWINDCOLLISION_METHOD_3_D266DF79387479FE_OFFSET UNITYSDK_OFFSET(0x196E48F0)
#define RPG_GAMECORE_ENABLELOCALPLAYERIGNORETIMEREWINDCOLLISION__CTOR_OFFSET UNITYSDK_OFFSET(0x196E4940)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnableLocalPlayerIgnoreTimeRewindCollision_TypeDefinitionIndex = 19804;
