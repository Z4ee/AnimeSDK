...
#define RPG_GAMECORE_ST_SIDE_ELFPLAYENTITYBEHAVIOR_METHOD_4_50060BC866C6F5C7_OFFSET UNITYSDK_OFFSET(0x18DF6E30)
#define RPG_GAMECORE_ST_SIDE_ELFPLAYENTITYBEHAVIOR_METHOD_4_AFDCB327197242CD_OFFSET UNITYSDK_OFFSET(0x18DF6F00)
#define RPG_GAMECORE_ST_SIDE_ELFPLAYENTITYBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x18DF6EB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_ElfPlayEntityBehavior_TypeDefinitionIndex = 20401;
