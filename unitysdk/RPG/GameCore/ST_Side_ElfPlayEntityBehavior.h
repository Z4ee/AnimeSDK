...
#define RPG_GAMECORE_ST_SIDE_ELFPLAYENTITYBEHAVIOR_METHOD_4_50060BC866C6F5C7_OFFSET UNITYSDK_OFFSET(0x19C19E50)
#define RPG_GAMECORE_ST_SIDE_ELFPLAYENTITYBEHAVIOR_METHOD_4_AFDCB327197242CD_OFFSET UNITYSDK_OFFSET(0x19C08AF0)
#define RPG_GAMECORE_ST_SIDE_ELFPLAYENTITYBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x19C08AA0)
