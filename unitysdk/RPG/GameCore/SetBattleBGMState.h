...
#define RPG_GAMECORE_SETBATTLEBGMSTATE_METHOD_3_0AEDD7381191F0A9_OFFSET UNITYSDK_OFFSET(0x19C2AA10)
#define RPG_GAMECORE_SETBATTLEBGMSTATE_METHOD_3_F319618B76782726_OFFSET UNITYSDK_OFFSET(0x19C2A990)
#define RPG_GAMECORE_SETBATTLEBGMSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C2A9E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetBattleBGMState_TypeDefinitionIndex = 21712;
