...
#define RPG_GAMECORE_SETBATTLEBGMSTATE_METHOD_3_0AEDD7381191F0A9_OFFSET UNITYSDK_OFFSET(0x1DB54C90)
#define RPG_GAMECORE_SETBATTLEBGMSTATE_METHOD_3_5DC462D52124F97C_OFFSET UNITYSDK_OFFSET(0x1DB54C50)
#define RPG_GAMECORE_SETBATTLEBGMSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB54C80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetBattleBGMState_TypeDefinitionIndex = 22708;
