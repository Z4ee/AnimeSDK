...
#define RPG_GAMECORE_SHOWRUBBINGUI_METHOD_3_111172B90AE9F92D_OFFSET UNITYSDK_OFFSET(0x17702B90)
#define RPG_GAMECORE_SHOWRUBBINGUI_METHOD_3_9302574D5FFE5BB9_OFFSET UNITYSDK_OFFSET(0x17702A80)
#define RPG_GAMECORE_SHOWRUBBINGUI__CTOR_OFFSET UNITYSDK_OFFSET(0x17702B60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowRubbingUI_TypeDefinitionIndex = 20357;
