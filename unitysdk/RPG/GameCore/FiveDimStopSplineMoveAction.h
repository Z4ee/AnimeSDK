...
#define RPG_GAMECORE_FIVEDIMSTOPSPLINEMOVEACTION_METHOD_3_CD6DF8C18994B7DA_OFFSET UNITYSDK_OFFSET(0x1720E8D0)
#define RPG_GAMECORE_FIVEDIMSTOPSPLINEMOVEACTION_METHOD_3_FD0449727199B5CB_OFFSET UNITYSDK_OFFSET(0x1720E810)
#define RPG_GAMECORE_FIVEDIMSTOPSPLINEMOVEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1720E8B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimStopSplineMoveAction_TypeDefinitionIndex = 17125;
