...
#define RPG_GAMECORE_PARAMGETBLACKBOARDVALUECONFIG_METHOD_4_2F453A2B930008BB_OFFSET UNITYSDK_OFFSET(0x174898A0)
#define RPG_GAMECORE_PARAMGETBLACKBOARDVALUECONFIG_METHOD_4_EC9BF41640BBDD52_OFFSET UNITYSDK_OFFSET(0x174896A0)
#define RPG_GAMECORE_PARAMGETBLACKBOARDVALUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17489820)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ParamGetBlackboardValueConfig_TypeDefinitionIndex = 15655;
