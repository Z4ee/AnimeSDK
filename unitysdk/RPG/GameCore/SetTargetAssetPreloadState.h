...
#define RPG_GAMECORE_SETTARGETASSETPRELOADSTATE_METHOD_3_59E466552D15230E_OFFSET UNITYSDK_OFFSET(0x1E090170)
#define RPG_GAMECORE_SETTARGETASSETPRELOADSTATE_METHOD_3_748C7C2133C7497D_OFFSET UNITYSDK_OFFSET(0x1E0902B0)
#define RPG_GAMECORE_SETTARGETASSETPRELOADSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E090220)
