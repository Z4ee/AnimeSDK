...
#define RPG_GAMECORE_SETTARGETASSETPRELOADSTATE_METHOD_3_59E466552D15230E_OFFSET UNITYSDK_OFFSET(0x1C60A9C0)
#define RPG_GAMECORE_SETTARGETASSETPRELOADSTATE_METHOD_3_748C7C2133C7497D_OFFSET UNITYSDK_OFFSET(0x1C60AB00)
#define RPG_GAMECORE_SETTARGETASSETPRELOADSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C60AA70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetTargetAssetPreloadState_TypeDefinitionIndex = 21985;
