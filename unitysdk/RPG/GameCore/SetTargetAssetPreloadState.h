...
#define RPG_GAMECORE_SETTARGETASSETPRELOADSTATE_METHOD_3_28AF525F2DDC4B9A_OFFSET UNITYSDK_OFFSET(0x176E1040)
#define RPG_GAMECORE_SETTARGETASSETPRELOADSTATE_METHOD_3_F58C7E8B644B2C5F_OFFSET UNITYSDK_OFFSET(0x176E1120)
#define RPG_GAMECORE_SETTARGETASSETPRELOADSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x176E1080)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetTargetAssetPreloadState_TypeDefinitionIndex = 21001;
