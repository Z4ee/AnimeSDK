...
#define RPG_GAMECORE_WAITTIMELINE_METHOD_3_2824A39D1CC5F8FB_OFFSET UNITYSDK_OFFSET(0x1D6AE200)
#define RPG_GAMECORE_WAITTIMELINE_METHOD_3_7C1C6BBBAFE3051C_OFFSET UNITYSDK_OFFSET(0x1D6AE250)
#define RPG_GAMECORE_WAITTIMELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6AE240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitTimeline_TypeDefinitionIndex = 22255;
