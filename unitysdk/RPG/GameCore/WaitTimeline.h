...
#define RPG_GAMECORE_WAITTIMELINE_METHOD_3_444713DCF914282A_OFFSET UNITYSDK_OFFSET(0x17906820)
#define RPG_GAMECORE_WAITTIMELINE_METHOD_3_7C1C6BBBAFE3051C_OFFSET UNITYSDK_OFFSET(0x179068B0)
#define RPG_GAMECORE_WAITTIMELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x17906880)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitTimeline_TypeDefinitionIndex = 20690;
