...
#define RPG_GAMECORE_FOURROTATEVOXELMUTEPLAYERINPUTACTION_METHOD_3_67661EE2651DFCCA_OFFSET UNITYSDK_OFFSET(0x1DCB81C0)
#define RPG_GAMECORE_FOURROTATEVOXELMUTEPLAYERINPUTACTION_METHOD_3_E0EE5451C5C9B967_OFFSET UNITYSDK_OFFSET(0x1DCB80E0)
#define RPG_GAMECORE_FOURROTATEVOXELMUTEPLAYERINPUTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCB81B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FourRotateVoxelMutePlayerInputAction_TypeDefinitionIndex = 16592;
