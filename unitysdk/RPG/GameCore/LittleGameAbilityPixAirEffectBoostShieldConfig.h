...
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTBOOSTSHIELDCONFIG_METHOD_3_0C6655B6D72FAD35_OFFSET UNITYSDK_OFFSET(0x1B093850)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTBOOSTSHIELDCONFIG_METHOD_3_30B639CDD835AB29_OFFSET UNITYSDK_OFFSET(0x1B093920)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTBOOSTSHIELDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B093910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityPixAirEffectBoostShieldConfig_TypeDefinitionIndex = 20553;
