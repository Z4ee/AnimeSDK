...
#define RPG_GAMECORE_ADVBYCHECKGAMEMODE_METHOD_4_44B8B82B63FE72CD_OFFSET UNITYSDK_OFFSET(0x1D6A8220)
#define RPG_GAMECORE_ADVBYCHECKGAMEMODE_METHOD_4_4C4DDF99F66D9236_OFFSET UNITYSDK_OFFSET(0x1D6A8050)
#define RPG_GAMECORE_ADVBYCHECKGAMEMODE_METHOD_4_67A33D487B9EA0D7_OFFSET UNITYSDK_OFFSET(0x1D6A8090)
#define RPG_GAMECORE_ADVBYCHECKGAMEMODE_METHOD_4_E6C521979C4A03DA_OFFSET UNITYSDK_OFFSET(0x1D6A8250)
#define RPG_GAMECORE_ADVBYCHECKGAMEMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6A8080)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvByCheckGameMode_TypeDefinitionIndex = 20540;
