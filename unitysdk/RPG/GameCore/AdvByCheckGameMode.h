...
#define RPG_GAMECORE_ADVBYCHECKGAMEMODE_METHOD_4_67A33D487B9EA0D7_OFFSET UNITYSDK_OFFSET(0x18646AF0)
#define RPG_GAMECORE_ADVBYCHECKGAMEMODE_METHOD_4_A8312EC6C9139A99_OFFSET UNITYSDK_OFFSET(0x18646A20)
#define RPG_GAMECORE_ADVBYCHECKGAMEMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x18646AA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvByCheckGameMode_TypeDefinitionIndex = 19758;
