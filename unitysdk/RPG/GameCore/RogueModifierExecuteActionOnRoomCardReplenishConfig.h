...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONROOMCARDREPLENISHCONFIG_METHOD_3_91FE6AD754CBA833_OFFSET UNITYSDK_OFFSET(0x17631C50)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONROOMCARDREPLENISHCONFIG_METHOD_3_A7D034388AB1F87A_OFFSET UNITYSDK_OFFSET(0x17631B80)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONROOMCARDREPLENISHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17631C00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnRoomCardReplenishConfig_TypeDefinitionIndex = 16386;
