...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONROOMCARDREPLENISHCONFIG_METHOD_3_91FE6AD754CBA833_OFFSET UNITYSDK_OFFSET(0x19B53220)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONROOMCARDREPLENISHCONFIG_METHOD_3_A7D034388AB1F87A_OFFSET UNITYSDK_OFFSET(0x19B5DC20)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONROOMCARDREPLENISHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B531D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnRoomCardReplenishConfig_TypeDefinitionIndex = 16955;
