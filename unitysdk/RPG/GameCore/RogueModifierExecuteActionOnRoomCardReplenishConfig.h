...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONROOMCARDREPLENISHCONFIG_METHOD_3_4860459194D2416F_OFFSET UNITYSDK_OFFSET(0x1CFC0E60)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONROOMCARDREPLENISHCONFIG_METHOD_3_91FE6AD754CBA833_OFFSET UNITYSDK_OFFSET(0x1CFC0EB0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONROOMCARDREPLENISHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFC0EA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnRoomCardReplenishConfig_TypeDefinitionIndex = 17117;
