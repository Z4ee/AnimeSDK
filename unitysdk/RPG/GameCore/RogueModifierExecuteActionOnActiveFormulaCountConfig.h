...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONACTIVEFORMULACOUNTCONFIG_METHOD_3_59C61AF77CB8BABB_OFFSET UNITYSDK_OFFSET(0x1D3F7B90)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONACTIVEFORMULACOUNTCONFIG_METHOD_3_B557DCF1316C75D7_OFFSET UNITYSDK_OFFSET(0x1D3F7B40)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONACTIVEFORMULACOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3F7B80)
