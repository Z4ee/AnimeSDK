...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONACTIVEFORMULACOUNTCONFIG_METHOD_3_59C61AF77CB8BABB_OFFSET UNITYSDK_OFFSET(0x18D34E20)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONACTIVEFORMULACOUNTCONFIG_METHOD_3_76E416CBF2360EA2_OFFSET UNITYSDK_OFFSET(0x18D3CA70)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONACTIVEFORMULACOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D34DD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnActiveFormulaCountConfig_TypeDefinitionIndex = 17077;
