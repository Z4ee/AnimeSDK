...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONACTIVEFORMULACOUNTCONFIG_METHOD_3_59C61AF77CB8BABB_OFFSET UNITYSDK_OFFSET(0x1EEF8740)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONACTIVEFORMULACOUNTCONFIG_METHOD_3_B557DCF1316C75D7_OFFSET UNITYSDK_OFFSET(0x1EEF86F0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONACTIVEFORMULACOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEF8730)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnActiveFormulaCountConfig_TypeDefinitionIndex = 17769;
