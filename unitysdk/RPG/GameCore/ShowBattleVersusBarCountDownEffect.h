...
#define RPG_GAMECORE_SHOWBATTLEVERSUSBARCOUNTDOWNEFFECT_METHOD_3_5B29A9901A836962_OFFSET UNITYSDK_OFFSET(0x19C76670)
#define RPG_GAMECORE_SHOWBATTLEVERSUSBARCOUNTDOWNEFFECT_METHOD_3_DBD666B0137F728B_OFFSET UNITYSDK_OFFSET(0x19C765F0)
#define RPG_GAMECORE_SHOWBATTLEVERSUSBARCOUNTDOWNEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x19C76640)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowBattleVersusBarCountDownEffect_TypeDefinitionIndex = 22075;
