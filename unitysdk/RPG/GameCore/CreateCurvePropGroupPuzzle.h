...
#define RPG_GAMECORE_CREATECURVEPROPGROUPPUZZLE_METHOD_3_A0DC18EB86818222_OFFSET UNITYSDK_OFFSET(0x1713BBE0)
#define RPG_GAMECORE_CREATECURVEPROPGROUPPUZZLE_METHOD_3_DFD0217B2832625C_OFFSET UNITYSDK_OFFSET(0x1713BC60)
#define RPG_GAMECORE_CREATECURVEPROPGROUPPUZZLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1713BC30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CreateCurvePropGroupPuzzle_TypeDefinitionIndex = 20448;
