...
#define RPG_GAMECORE_LOCKSTEPSTATUS_METHOD_3_061A55C95EE417B9_OFFSET UNITYSDK_OFFSET(0x1D211090)
#define RPG_GAMECORE_LOCKSTEPSTATUS_METHOD_3_6E9819B3D2C962F6_OFFSET UNITYSDK_OFFSET(0x1D211040)
#define RPG_GAMECORE_LOCKSTEPSTATUS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D211080)
