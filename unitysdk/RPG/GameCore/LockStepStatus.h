...
#define RPG_GAMECORE_LOCKSTEPSTATUS_METHOD_3_C58273A23D38FB37_OFFSET UNITYSDK_OFFSET(0x1736BF10)
#define RPG_GAMECORE_LOCKSTEPSTATUS_METHOD_3_D6F99E649899A33C_OFFSET UNITYSDK_OFFSET(0x1736BE80)
#define RPG_GAMECORE_LOCKSTEPSTATUS__CTOR_OFFSET UNITYSDK_OFFSET(0x1736BEE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LockStepStatus_TypeDefinitionIndex = 21840;
