...
#define RPG_GAMECORE_OPTIONTRIGGERINFO_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D40A500)
#define RPG_GAMECORE_OPTIONTRIGGERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D40A6D0)
