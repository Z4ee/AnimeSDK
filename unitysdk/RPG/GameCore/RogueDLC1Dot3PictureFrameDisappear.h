...
#define RPG_GAMECORE_ROGUEDLC1DOT3PICTUREFRAMEDISAPPEAR_METHOD_3_75AB15D4C7695BCD_OFFSET UNITYSDK_OFFSET(0x175F0730)
#define RPG_GAMECORE_ROGUEDLC1DOT3PICTUREFRAMEDISAPPEAR_METHOD_3_AD135083C4B890C1_OFFSET UNITYSDK_OFFSET(0x175F0840)
#define RPG_GAMECORE_ROGUEDLC1DOT3PICTUREFRAMEDISAPPEAR__CTOR_OFFSET UNITYSDK_OFFSET(0x175F0810)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueDLC1Dot3PictureFrameDisappear_TypeDefinitionIndex = 19128;
