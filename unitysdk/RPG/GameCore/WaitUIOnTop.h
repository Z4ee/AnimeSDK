...
#define RPG_GAMECORE_WAITUIONTOP_METHOD_3_2633D076D54ABB8B_OFFSET UNITYSDK_OFFSET(0x1D1BF7F0)
#define RPG_GAMECORE_WAITUIONTOP_METHOD_3_B140B82F8DA3FF78_OFFSET UNITYSDK_OFFSET(0x1D1BF7B0)
#define RPG_GAMECORE_WAITUIONTOP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1BF7E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitUIOnTop_TypeDefinitionIndex = 23520;
