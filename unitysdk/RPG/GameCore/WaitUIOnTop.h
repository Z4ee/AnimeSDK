...
#define RPG_GAMECORE_WAITUIONTOP_METHOD_3_2633D076D54ABB8B_OFFSET UNITYSDK_OFFSET(0x17908320)
#define RPG_GAMECORE_WAITUIONTOP_METHOD_3_D5DEA1CD37045E22_OFFSET UNITYSDK_OFFSET(0x179082A0)
#define RPG_GAMECORE_WAITUIONTOP__CTOR_OFFSET UNITYSDK_OFFSET(0x179082F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitUIOnTop_TypeDefinitionIndex = 22425;
