...
#define RPG_GAMECORE_WAITUIONTOP_METHOD_3_2633D076D54ABB8B_OFFSET UNITYSDK_OFFSET(0x19E649B0)
#define RPG_GAMECORE_WAITUIONTOP_METHOD_3_D5DEA1CD37045E22_OFFSET UNITYSDK_OFFSET(0x19E64930)
#define RPG_GAMECORE_WAITUIONTOP__CTOR_OFFSET UNITYSDK_OFFSET(0x19E64980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitUIOnTop_TypeDefinitionIndex = 23053;
