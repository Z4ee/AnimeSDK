...
#define RPG_GAMECORE_PREVIEWCELLPERFORMCONFIG_METHOD_2_4AD9CE90249A19E5_OFFSET UNITYSDK_OFFSET(0x1BA166A0)
#define RPG_GAMECORE_PREVIEWCELLPERFORMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA168E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PreviewCellPerformConfig_TypeDefinitionIndex = 17705;
