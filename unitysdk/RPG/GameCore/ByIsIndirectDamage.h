...
#define RPG_GAMECORE_BYISINDIRECTDAMAGE_METHOD_4_F006FA43339F5C07_OFFSET UNITYSDK_OFFSET(0x18754D80)
#define RPG_GAMECORE_BYISINDIRECTDAMAGE_METHOD_4_FDB08BD1D5BD820D_OFFSET UNITYSDK_OFFSET(0x18754E50)
#define RPG_GAMECORE_BYISINDIRECTDAMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x18754E00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsIndirectDamage_TypeDefinitionIndex = 22463;
