...
#define RPG_GAMECORE_BYISINDIRECTDAMAGE_METHOD_4_32E32D93404A207A_OFFSET UNITYSDK_OFFSET(0x1CF41E80)
#define RPG_GAMECORE_BYISINDIRECTDAMAGE_METHOD_4_3DBB2CEA387AA667_OFFSET UNITYSDK_OFFSET(0x1CF41E50)
#define RPG_GAMECORE_BYISINDIRECTDAMAGE_METHOD_4_8C859060DC125E4E_OFFSET UNITYSDK_OFFSET(0x1CF41CD0)
#define RPG_GAMECORE_BYISINDIRECTDAMAGE_METHOD_4_FDB08BD1D5BD820D_OFFSET UNITYSDK_OFFSET(0x1CF41D10)
#define RPG_GAMECORE_BYISINDIRECTDAMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF41D00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsIndirectDamage_TypeDefinitionIndex = 23227;
