...
#define RPG_GAMECORE_WAITFIVEDIMTELEPORTFINISH_METHOD_3_032FC6AF61BDC9FA_OFFSET UNITYSDK_OFFSET(0x178F8F70)
#define RPG_GAMECORE_WAITFIVEDIMTELEPORTFINISH_METHOD_3_8744FEB7414033C6_OFFSET UNITYSDK_OFFSET(0x178F9080)
#define RPG_GAMECORE_WAITFIVEDIMTELEPORTFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x178F9050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitFiveDimTeleportFinish_TypeDefinitionIndex = 19582;
