...
#define RPG_GAMECORE_WAITFIVEDIMTELEPORTFINISH_METHOD_3_032FC6AF61BDC9FA_OFFSET UNITYSDK_OFFSET(0x190FCE60)
#define RPG_GAMECORE_WAITFIVEDIMTELEPORTFINISH_METHOD_3_8744FEB7414033C6_OFFSET UNITYSDK_OFFSET(0x190FCF70)
#define RPG_GAMECORE_WAITFIVEDIMTELEPORTFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x190FCF40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitFiveDimTeleportFinish_TypeDefinitionIndex = 20257;
