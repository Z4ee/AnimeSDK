...
#define RPG_GAMECORE_WAITFIVEDIMTELEPORTFINISH_METHOD_3_5AF7370543C9E743_OFFSET UNITYSDK_OFFSET(0x1B8A4440)
#define RPG_GAMECORE_WAITFIVEDIMTELEPORTFINISH_METHOD_3_8744FEB7414033C6_OFFSET UNITYSDK_OFFSET(0x1B8A4510)
#define RPG_GAMECORE_WAITFIVEDIMTELEPORTFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8A4500)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitFiveDimTeleportFinish_TypeDefinitionIndex = 20485;
