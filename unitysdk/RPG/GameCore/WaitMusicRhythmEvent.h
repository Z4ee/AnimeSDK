...
#define RPG_GAMECORE_WAITMUSICRHYTHMEVENT_METHOD_3_028DA997C1ED97F1_OFFSET UNITYSDK_OFFSET(0x19102630)
#define RPG_GAMECORE_WAITMUSICRHYTHMEVENT_METHOD_3_9833BC05DC53AF6F_OFFSET UNITYSDK_OFFSET(0x191025B0)
#define RPG_GAMECORE_WAITMUSICRHYTHMEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19102600)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitMusicRhythmEvent_TypeDefinitionIndex = 20921;
