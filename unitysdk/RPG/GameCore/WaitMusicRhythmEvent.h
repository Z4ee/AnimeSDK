...
#define RPG_GAMECORE_WAITMUSICRHYTHMEVENT_METHOD_3_028DA997C1ED97F1_OFFSET UNITYSDK_OFFSET(0x178FE740)
#define RPG_GAMECORE_WAITMUSICRHYTHMEVENT_METHOD_3_9833BC05DC53AF6F_OFFSET UNITYSDK_OFFSET(0x178FE6C0)
#define RPG_GAMECORE_WAITMUSICRHYTHMEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x178FE710)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitMusicRhythmEvent_TypeDefinitionIndex = 20239;
