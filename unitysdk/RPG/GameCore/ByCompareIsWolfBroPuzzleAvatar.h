...
#define RPG_GAMECORE_BYCOMPAREISWOLFBROPUZZLEAVATAR_METHOD_4_1B849C81FD466AB5_OFFSET UNITYSDK_OFFSET(0x1700CAC0)
#define RPG_GAMECORE_BYCOMPAREISWOLFBROPUZZLEAVATAR_METHOD_4_721442199BE8E7DF_OFFSET UNITYSDK_OFFSET(0x1700CB90)
#define RPG_GAMECORE_BYCOMPAREISWOLFBROPUZZLEAVATAR__CTOR_OFFSET UNITYSDK_OFFSET(0x1700CB40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareIsWolfBroPuzzleAvatar_TypeDefinitionIndex = 20164;
