...
#define RPG_GAMECORE_SETDYNAMICVALUEBYBPCHANGE_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1E819C70)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBPCHANGE_METHOD_4_22FD030F20E61339_OFFSET UNITYSDK_OFFSET(0x1E819A80)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBPCHANGE_METHOD_4_6E8F7838827AEBEC_OFFSET UNITYSDK_OFFSET(0x1E819AC0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBPCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E819AB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByBPChange_TypeDefinitionIndex = 22834;
