...
#define RPG_GAMECORE_RTBATTLELINEUPCHARACTERPRESET_METHOD_2_E6CF881FAEFCD7ED_OFFSET UNITYSDK_OFFSET(0x19BDBB30)
#define RPG_GAMECORE_RTBATTLELINEUPCHARACTERPRESET__CTOR_OFFSET UNITYSDK_OFFSET(0x19BDBB70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtBattleLineupCharacterPreset_TypeDefinitionIndex = 17157;
