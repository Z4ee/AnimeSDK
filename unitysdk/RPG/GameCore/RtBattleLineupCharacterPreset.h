...
#define RPG_GAMECORE_RTBATTLELINEUPCHARACTERPRESET_METHOD_2_E6CF881FAEFCD7ED_OFFSET UNITYSDK_OFFSET(0x18DC5270)
#define RPG_GAMECORE_RTBATTLELINEUPCHARACTERPRESET__CTOR_OFFSET UNITYSDK_OFFSET(0x18DC52B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtBattleLineupCharacterPreset_TypeDefinitionIndex = 17147;
