...
#define RPG_GAMECORE_STREAMINGITEMHLODEXPANDCONDITION_METHOD_2_F26432F3E32C1DC0_OFFSET UNITYSDK_OFFSET(0x17781F50)
#define RPG_GAMECORE_STREAMINGITEMHLODEXPANDCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x17782060)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StreamingItemHLODExpandCondition_TypeDefinitionIndex = 17519;
