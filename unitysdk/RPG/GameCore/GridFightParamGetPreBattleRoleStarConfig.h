...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETPREBATTLEROLESTARCONFIG_METHOD_6_37F7080C7C9F9C08_OFFSET UNITYSDK_OFFSET(0x197FAB50)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETPREBATTLEROLESTARCONFIG_METHOD_6_6A280E7DB9B46A4E_OFFSET UNITYSDK_OFFSET(0x197FAE00)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETPREBATTLEROLESTARCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197FACD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightParamGetPreBattleRoleStarConfig_TypeDefinitionIndex = 18510;
