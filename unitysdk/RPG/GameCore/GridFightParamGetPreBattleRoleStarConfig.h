...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETPREBATTLEROLESTARCONFIG_METHOD_6_61D04D913EFFA632_OFFSET UNITYSDK_OFFSET(0x1D06DCD0)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETPREBATTLEROLESTARCONFIG_METHOD_6_6A280E7DB9B46A4E_OFFSET UNITYSDK_OFFSET(0x1D06DD20)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETPREBATTLEROLESTARCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D06DD10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightParamGetPreBattleRoleStarConfig_TypeDefinitionIndex = 18773;
