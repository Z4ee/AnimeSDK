...
#define RPG_GAMECORE_VCAMERANOISECHANGE_METHOD_3_E814C3E1C32FD187_OFFSET UNITYSDK_OFFSET(0x178EDBB0)
#define RPG_GAMECORE_VCAMERANOISECHANGE_METHOD_3_F3BC34BA4AEF9B32_OFFSET UNITYSDK_OFFSET(0x178ECB70)
#define RPG_GAMECORE_VCAMERANOISECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x178EDB80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VCameraNoiseChange_TypeDefinitionIndex = 21972;
