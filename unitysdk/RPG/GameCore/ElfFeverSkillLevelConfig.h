...
#define RPG_GAMECORE_ELFFEVERSKILLLEVELCONFIG_METHOD_2_00CA52A8CE793C54_OFFSET UNITYSDK_OFFSET(0x1BB37000)
#define RPG_GAMECORE_ELFFEVERSKILLLEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB37170)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfFeverSkillLevelConfig_TypeDefinitionIndex = 17728;
