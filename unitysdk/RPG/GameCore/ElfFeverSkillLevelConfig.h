...
#define RPG_GAMECORE_ELFFEVERSKILLLEVELCONFIG_METHOD_2_00CA52A8CE793C54_OFFSET UNITYSDK_OFFSET(0x1718EAF0)
#define RPG_GAMECORE_ELFFEVERSKILLLEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1718EC60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfFeverSkillLevelConfig_TypeDefinitionIndex = 16935;
