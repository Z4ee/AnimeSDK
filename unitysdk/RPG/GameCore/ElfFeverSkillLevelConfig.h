...
#define RPG_GAMECORE_ELFFEVERSKILLLEVELCONFIG_METHOD_2_00CA52A8CE793C54_OFFSET UNITYSDK_OFFSET(0x1D059650)
#define RPG_GAMECORE_ELFFEVERSKILLLEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0597C0)
