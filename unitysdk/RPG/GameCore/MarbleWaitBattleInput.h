...
#define RPG_GAMECORE_MARBLEWAITBATTLEINPUT_METHOD_3_4C0C2B54F374E935_OFFSET UNITYSDK_OFFSET(0x18AACF00)
#define RPG_GAMECORE_MARBLEWAITBATTLEINPUT_METHOD_3_72BF26F53426D382_OFFSET UNITYSDK_OFFSET(0x18AACF90)
#define RPG_GAMECORE_MARBLEWAITBATTLEINPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x18AACF60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleWaitBattleInput_TypeDefinitionIndex = 23304;
