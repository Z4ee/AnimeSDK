...
#define RPG_GAMECORE_SETCUSTOMLOCATIONCONFIG_METHOD_3_A0DA3E521BE6366D_OFFSET UNITYSDK_OFFSET(0x1C2DB3D0)
#define RPG_GAMECORE_SETCUSTOMLOCATIONCONFIG_METHOD_3_FF10492A58C24AA4_OFFSET UNITYSDK_OFFSET(0x1C2DB380)
#define RPG_GAMECORE_SETCUSTOMLOCATIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2DB3C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetCustomLocationConfig_TypeDefinitionIndex = 21679;
