...
#define RPG_GAMECORE_SETCUSTOMLOCATIONCONFIG_METHOD_3_A0DA3E521BE6366D_OFFSET UNITYSDK_OFFSET(0x18E13B00)
#define RPG_GAMECORE_SETCUSTOMLOCATIONCONFIG_METHOD_3_EC02F1024DA2ACBC_OFFSET UNITYSDK_OFFSET(0x18E13A80)
#define RPG_GAMECORE_SETCUSTOMLOCATIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18E13AD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetCustomLocationConfig_TypeDefinitionIndex = 21374;
