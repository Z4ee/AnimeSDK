...
#define RPG_GAMECORE_LEVELGRAPHCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C1151B0)
#define RPG_GAMECORE_LEVELGRAPHCONFIG_GETALLTASK_OFFSET UNITYSDK_OFFSET(0x1C1153C0)
#define RPG_GAMECORE_LEVELGRAPHCONFIG_GETOBJECTCHILDTASK_OFFSET UNITYSDK_OFFSET(0x1C115410)
#define RPG_GAMECORE_LEVELGRAPHCONFIG_TRYADDSHAREDVALUE_OFFSET UNITYSDK_OFFSET(0x1C115A30)
#define RPG_GAMECORE_LEVELGRAPHCONFIG_TRYREMOVESHAREDVALUE_OFFSET UNITYSDK_OFFSET(0x1C115BF0)
#define RPG_GAMECORE_LEVELGRAPHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1153B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelGraphConfig_TypeDefinitionIndex = 18099;
