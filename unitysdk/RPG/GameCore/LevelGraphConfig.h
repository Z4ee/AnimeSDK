...
#define RPG_GAMECORE_LEVELGRAPHCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17336310)
#define RPG_GAMECORE_LEVELGRAPHCONFIG_GETALLTASK_OFFSET UNITYSDK_OFFSET(0x17336530)
#define RPG_GAMECORE_LEVELGRAPHCONFIG_GETOBJECTCHILDTASK_OFFSET UNITYSDK_OFFSET(0x17336580)
#define RPG_GAMECORE_LEVELGRAPHCONFIG_TRYADDSHAREDVALUE_OFFSET UNITYSDK_OFFSET(0x173368D0)
#define RPG_GAMECORE_LEVELGRAPHCONFIG_TRYREMOVESHAREDVALUE_OFFSET UNITYSDK_OFFSET(0x17336A90)
#define RPG_GAMECORE_LEVELGRAPHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17336520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelGraphConfig_TypeDefinitionIndex = 16809;
