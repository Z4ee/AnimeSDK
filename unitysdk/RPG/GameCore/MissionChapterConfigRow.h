...
#define RPG_GAMECORE_MISSIONCHAPTERCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D2A1AA0)
#define RPG_GAMECORE_MISSIONCHAPTERCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2A2340)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* ChapterIconPath; // 0x18
