...
#define RPG_GAMECORE_MISSIONCHAPTERCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1741F570)
#define RPG_GAMECORE_MISSIONCHAPTERCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1741FD70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MissionChapterConfigRow_TypeDefinitionIndex = 12948;
	...
	public:
		...
		::Il2CppArray<::System::UInt32>* LinkChapterList; // 0x20
		::System::String* ChapterDesc; // 0x28
		::System::String* ChapterIconPath; // 0x30
		::System::String* StageName; // 0x38
		::System::UInt32 ID; // 0x40
		::RPG::GameCore::MissionChapterType ChapterType; // 0x44
		::System::UInt32 OriginMainMission; // 0x48
		::System::UInt32 ChapterDisplayPriority; // 0x4C
