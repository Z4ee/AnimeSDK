...
#define RPG_GAMECORE_BYANGLE_METHOD_4_5E04DB5671B246CA_OFFSET UNITYSDK_OFFSET(0x19CB95B0)
#define RPG_GAMECORE_BYANGLE_METHOD_4_8F4C6CC360E9A88D_OFFSET UNITYSDK_OFFSET(0x19CB9560)
#define RPG_GAMECORE_BYANGLE_METHOD_4_CBB22071F6830F22_OFFSET UNITYSDK_OFFSET(0x19CB9860)
#define RPG_GAMECORE_BYANGLE_METHOD_4_DAC56FFE8AD81304_OFFSET UNITYSDK_OFFSET(0x19CB9820)
#define RPG_GAMECORE_BYANGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x19CB95A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByAngle_TypeDefinitionIndex = 19990;
