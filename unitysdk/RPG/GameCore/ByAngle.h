...
#define RPG_GAMECORE_BYANGLE_METHOD_4_5E04DB5671B246CA_OFFSET UNITYSDK_OFFSET(0x16FF9EE0)
#define RPG_GAMECORE_BYANGLE_METHOD_4_7E0EE14F1076A8E2_OFFSET UNITYSDK_OFFSET(0x16FF9E00)
#define RPG_GAMECORE_BYANGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x16FF9E80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByAngle_TypeDefinitionIndex = 19096;
