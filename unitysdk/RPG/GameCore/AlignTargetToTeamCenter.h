...
#define RPG_GAMECORE_ALIGNTARGETTOTEAMCENTER_METHOD_3_6884BA27D3B1A01A_OFFSET UNITYSDK_OFFSET(0x1AE742B0)
#define RPG_GAMECORE_ALIGNTARGETTOTEAMCENTER_METHOD_3_94C1EA5FA0BBBCBB_OFFSET UNITYSDK_OFFSET(0x1AE74270)
#define RPG_GAMECORE_ALIGNTARGETTOTEAMCENTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE742A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AlignTargetToTeamCenter_TypeDefinitionIndex = 21687;
