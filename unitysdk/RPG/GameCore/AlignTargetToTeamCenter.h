...
#define RPG_GAMECORE_ALIGNTARGETTOTEAMCENTER_METHOD_3_5E34461DFAB2DD6B_OFFSET UNITYSDK_OFFSET(0x19465C20)
#define RPG_GAMECORE_ALIGNTARGETTOTEAMCENTER_METHOD_3_6884BA27D3B1A01A_OFFSET UNITYSDK_OFFSET(0x19465CA0)
#define RPG_GAMECORE_ALIGNTARGETTOTEAMCENTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19465C70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AlignTargetToTeamCenter_TypeDefinitionIndex = 21272;
