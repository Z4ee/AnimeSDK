...
#define RPG_GAMECORE_FIVEDIMMISCMOVEBAKEDCONFIG_METHOD_2_F665E9D73B27B6FA_OFFSET UNITYSDK_OFFSET(0x19746F00)
#define RPG_GAMECORE_FIVEDIMMISCMOVEBAKEDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197470A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimMiscMoveBakedConfig_TypeDefinitionIndex = 15832;
