...
#define RPG_GAMECORE_FIVEDIMMISCMOVEBAKEDCONFIG_METHOD_2_F665E9D73B27B6FA_OFFSET UNITYSDK_OFFSET(0x1D869AD0)
#define RPG_GAMECORE_FIVEDIMMISCMOVEBAKEDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D869C70)
