...
#define RPG_GAMECORE_FIVEDIMMISCMOVEBAKEDCONFIG_METHOD_2_F665E9D73B27B6FA_OFFSET UNITYSDK_OFFSET(0x1BEA1990)
#define RPG_GAMECORE_FIVEDIMMISCMOVEBAKEDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEA1B30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimMiscMoveBakedConfig_TypeDefinitionIndex = 16006;
