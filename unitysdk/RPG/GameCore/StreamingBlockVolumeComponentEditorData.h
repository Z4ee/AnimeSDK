...
#define RPG_GAMECORE_STREAMINGBLOCKVOLUMECOMPONENTEDITORDATA_GET_EFFECTBLOCKSHIDEORHLODTAG_OFFSET UNITYSDK_OFFSET(0xB75A970)
#define RPG_GAMECORE_STREAMINGBLOCKVOLUMECOMPONENTEDITORDATA_SET_EFFECTBLOCKSHIDEORHLODTAG_OFFSET UNITYSDK_OFFSET(0xB75A980)
#define RPG_GAMECORE_STREAMINGBLOCKVOLUMECOMPONENTEDITORDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB75A9E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StreamingBlockVolumeComponentEditorData_TypeDefinitionIndex = 49379;
