...
#define RPG_GAMECORE_STREAMINGBLOCKVOLUMECOMPONENTEDITORDATA_GET_EFFECTBLOCKSHIDEORHLODTAG_OFFSET UNITYSDK_OFFSET(0xAA50E40)
#define RPG_GAMECORE_STREAMINGBLOCKVOLUMECOMPONENTEDITORDATA_SET_EFFECTBLOCKSHIDEORHLODTAG_OFFSET UNITYSDK_OFFSET(0xAA50E50)
#define RPG_GAMECORE_STREAMINGBLOCKVOLUMECOMPONENTEDITORDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xAA50EB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StreamingBlockVolumeComponentEditorData_TypeDefinitionIndex = 43380;
