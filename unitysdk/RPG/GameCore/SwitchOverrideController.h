...
#define RPG_GAMECORE_SWITCHOVERRIDECONTROLLER_METHOD_3_A7D50C8CA9209F66_OFFSET UNITYSDK_OFFSET(0x18EBDE10)
#define RPG_GAMECORE_SWITCHOVERRIDECONTROLLER_METHOD_3_B109BFD407E4A86F_OFFSET UNITYSDK_OFFSET(0x18EBDE90)
#define RPG_GAMECORE_SWITCHOVERRIDECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18EBDE60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchOverrideController_TypeDefinitionIndex = 21668;
