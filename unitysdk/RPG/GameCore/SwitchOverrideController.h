...
#define RPG_GAMECORE_SWITCHOVERRIDECONTROLLER_METHOD_3_B109BFD407E4A86F_OFFSET UNITYSDK_OFFSET(0x1E151780)
#define RPG_GAMECORE_SWITCHOVERRIDECONTROLLER_METHOD_3_C01B40592657B9CE_OFFSET UNITYSDK_OFFSET(0x1E151740)
#define RPG_GAMECORE_SWITCHOVERRIDECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E151770)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchOverrideController_TypeDefinitionIndex = 22508;
