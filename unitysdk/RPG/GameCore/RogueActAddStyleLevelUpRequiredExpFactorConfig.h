...
#define RPG_GAMECORE_ROGUEACTADDSTYLELEVELUPREQUIREDEXPFACTORCONFIG_METHOD_6_3936126BB97C2427_OFFSET UNITYSDK_OFFSET(0x175B1390)
#define RPG_GAMECORE_ROGUEACTADDSTYLELEVELUPREQUIREDEXPFACTORCONFIG_METHOD_6_F5EF6469B526B632_OFFSET UNITYSDK_OFFSET(0x175B15B0)
#define RPG_GAMECORE_ROGUEACTADDSTYLELEVELUPREQUIREDEXPFACTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175B14D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActAddStyleLevelUpRequiredExpFactorConfig_TypeDefinitionIndex = 18133;
