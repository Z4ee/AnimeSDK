...
#define RPG_GAMECORE_ROGUEACTADDSTYLELEVELUPREQUIREDEXPFACTORCONFIG_METHOD_6_3936126BB97C2427_OFFSET UNITYSDK_OFFSET(0x18CBD100)
#define RPG_GAMECORE_ROGUEACTADDSTYLELEVELUPREQUIREDEXPFACTORCONFIG_METHOD_6_F5EF6469B526B632_OFFSET UNITYSDK_OFFSET(0x18CBD320)
#define RPG_GAMECORE_ROGUEACTADDSTYLELEVELUPREQUIREDEXPFACTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CBD240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActAddStyleLevelUpRequiredExpFactorConfig_TypeDefinitionIndex = 18778;
