...
#define RPG_GAMECORE_FIVEDIMBEATBACKPLAYERACTION_METHOD_3_4C7F8C58C8BDC5AD_OFFSET UNITYSDK_OFFSET(0x19734040)
#define RPG_GAMECORE_FIVEDIMBEATBACKPLAYERACTION_METHOD_3_DD4EA1C3B6F0FF94_OFFSET UNITYSDK_OFFSET(0x1972C080)
#define RPG_GAMECORE_FIVEDIMBEATBACKPLAYERACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1972C060)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimBeatBackPlayerAction_TypeDefinitionIndex = 17780;
