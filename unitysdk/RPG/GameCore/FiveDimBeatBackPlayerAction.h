...
#define RPG_GAMECORE_FIVEDIMBEATBACKPLAYERACTION_METHOD_3_37069262025FCE69_OFFSET UNITYSDK_OFFSET(0x1BA8B6C0)
#define RPG_GAMECORE_FIVEDIMBEATBACKPLAYERACTION_METHOD_3_DD4EA1C3B6F0FF94_OFFSET UNITYSDK_OFFSET(0x1BA8B740)
#define RPG_GAMECORE_FIVEDIMBEATBACKPLAYERACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA8B730)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimBeatBackPlayerAction_TypeDefinitionIndex = 17956;
