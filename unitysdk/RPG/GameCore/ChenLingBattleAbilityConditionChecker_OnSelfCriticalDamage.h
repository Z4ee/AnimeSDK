...
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_ONSELFCRITICALDAMAGE_METHOD_3_3BF24F56A84384C0_OFFSET UNITYSDK_OFFSET(0x170787C0)
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_ONSELFCRITICALDAMAGE_METHOD_3_CBE3790A72600F85_OFFSET UNITYSDK_OFFSET(0x17078720)
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_ONSELFCRITICALDAMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x170787B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleAbilityConditionChecker_OnSelfCriticalDamage_TypeDefinitionIndex = 14418;
