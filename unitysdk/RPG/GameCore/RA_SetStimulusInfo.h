...
#define RPG_GAMECORE_RA_SETSTIMULUSINFO_METHOD_4_6133DBAE926E18DA_OFFSET UNITYSDK_OFFSET(0x1B9B03F0)
#define RPG_GAMECORE_RA_SETSTIMULUSINFO_METHOD_4_994887E9E26CBF13_OFFSET UNITYSDK_OFFSET(0x1B9B03B0)
#define RPG_GAMECORE_RA_SETSTIMULUSINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9B03E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RA_SetStimulusInfo_TypeDefinitionIndex = 19269;
