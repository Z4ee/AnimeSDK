...
#define RPG_GAMECORE_RA_SETSTIMULUSINFO_METHOD_4_6133DBAE926E18DA_OFFSET UNITYSDK_OFFSET(0x17579F00)
#define RPG_GAMECORE_RA_SETSTIMULUSINFO_METHOD_4_95F8F67F25A3034B_OFFSET UNITYSDK_OFFSET(0x17579E80)
#define RPG_GAMECORE_RA_SETSTIMULUSINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x17579ED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RA_SetStimulusInfo_TypeDefinitionIndex = 18318;
