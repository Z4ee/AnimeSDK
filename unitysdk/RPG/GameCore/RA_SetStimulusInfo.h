...
#define RPG_GAMECORE_RA_SETSTIMULUSINFO_METHOD_4_6133DBAE926E18DA_OFFSET UNITYSDK_OFFSET(0x18C83480)
#define RPG_GAMECORE_RA_SETSTIMULUSINFO_METHOD_4_95F8F67F25A3034B_OFFSET UNITYSDK_OFFSET(0x18C83400)
#define RPG_GAMECORE_RA_SETSTIMULUSINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18C83450)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RA_SetStimulusInfo_TypeDefinitionIndex = 18965;
