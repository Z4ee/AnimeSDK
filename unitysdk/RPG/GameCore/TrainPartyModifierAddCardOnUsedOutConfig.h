...
#define RPG_GAMECORE_TRAINPARTYMODIFIERADDCARDONUSEDOUTCONFIG_METHOD_3_6F57B9A142B6C581_OFFSET UNITYSDK_OFFSET(0x1D5DE450)
#define RPG_GAMECORE_TRAINPARTYMODIFIERADDCARDONUSEDOUTCONFIG_METHOD_3_BA3030EB43A742E5_OFFSET UNITYSDK_OFFSET(0x1D5DE4A0)
#define RPG_GAMECORE_TRAINPARTYMODIFIERADDCARDONUSEDOUTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5DE490)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyModifierAddCardOnUsedOutConfig_TypeDefinitionIndex = 17904;
