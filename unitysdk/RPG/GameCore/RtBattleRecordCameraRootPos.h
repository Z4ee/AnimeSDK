...
#define RPG_GAMECORE_RTBATTLERECORDCAMERAROOTPOS_METHOD_3_A655450F3BCD76C1_OFFSET UNITYSDK_OFFSET(0x19BDBC70)
#define RPG_GAMECORE_RTBATTLERECORDCAMERAROOTPOS_METHOD_3_B14D4A871359181A_OFFSET UNITYSDK_OFFSET(0x19BDBD50)
#define RPG_GAMECORE_RTBATTLERECORDCAMERAROOTPOS__CTOR_OFFSET UNITYSDK_OFFSET(0x19BDBCF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtBattleRecordCameraRootPos_TypeDefinitionIndex = 22775;
