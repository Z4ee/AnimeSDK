...
#define RPG_GAMECORE_RTBATTLERECORDCAMERAROOTPOS_METHOD_3_7C8E3494E0F5D598_OFFSET UNITYSDK_OFFSET(0x1D49AF80)
#define RPG_GAMECORE_RTBATTLERECORDCAMERAROOTPOS_METHOD_3_B14D4A871359181A_OFFSET UNITYSDK_OFFSET(0x1D49B020)
#define RPG_GAMECORE_RTBATTLERECORDCAMERAROOTPOS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D49AFE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtBattleRecordCameraRootPos_TypeDefinitionIndex = 23822;
