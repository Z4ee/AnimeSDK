...
#define RPG_GAMECORE_LITTLEGAMECURVEINFOCONFIG_METHOD_3_A0949AEE208F04F0_OFFSET UNITYSDK_OFFSET(0x1735C8D0)
#define RPG_GAMECORE_LITTLEGAMECURVEINFOCONFIG_METHOD_3_BD459CE6711B96BC_OFFSET UNITYSDK_OFFSET(0x1735A890)
#define RPG_GAMECORE_LITTLEGAMECURVEINFOCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1735A870)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameCurveInfoConfig_TypeDefinitionIndex = 17305;
