...
#define RPG_GAMECORE_FATERINCASEBOARDTEAMRELATIONINFO_METHOD_2_98AC07BC7F967BC5_OFFSET UNITYSDK_OFFSET(0x1BA76E40)
#define RPG_GAMECORE_FATERINCASEBOARDTEAMRELATIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA76FD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateRinCaseBoardTeamRelationInfo_TypeDefinitionIndex = 15591;
