...
#define RPG_GAMECORE_FIVEDIMDOORCONFIG__DOORKEYDROPDOWN_D__11_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1BA91880)
#define RPG_GAMECORE_FIVEDIMDOORCONFIG__DOORKEYDROPDOWN_D__11_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SIRENIX_ODININSPECTOR_VALUEDROPDOWNITEM_SYSTEM_UINT32___GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1BA91A10)
#define RPG_GAMECORE_FIVEDIMDOORCONFIG__DOORKEYDROPDOWN_D__11_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SIRENIX_ODININSPECTOR_VALUEDROPDOWNITEM_SYSTEM_UINT32___GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BA91960)
#define RPG_GAMECORE_FIVEDIMDOORCONFIG__DOORKEYDROPDOWN_D__11_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1BA91A80)
#define RPG_GAMECORE_FIVEDIMDOORCONFIG__DOORKEYDROPDOWN_D__11_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BA919C0)
#define RPG_GAMECORE_FIVEDIMDOORCONFIG__DOORKEYDROPDOWN_D__11_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1BA91970)
#define RPG_GAMECORE_FIVEDIMDOORCONFIG__DOORKEYDROPDOWN_D__11_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1BA91870)
#define RPG_GAMECORE_FIVEDIMDOORCONFIG__DOORKEYDROPDOWN_D__11__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA916D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimDoorConfig__DoorKeyDropdown_d__11_TypeDefinitionIndex = 17864;
