...
#define RPG_GAMECORE_FIVEDIMDOORCONFIG__DOORKEYDROPDOWN_D__11_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x188FDDC0)
#define RPG_GAMECORE_FIVEDIMDOORCONFIG__DOORKEYDROPDOWN_D__11_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SIRENIX_ODININSPECTOR_VALUEDROPDOWNITEM_SYSTEM_UINT32___GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x188FDF50)
#define RPG_GAMECORE_FIVEDIMDOORCONFIG__DOORKEYDROPDOWN_D__11_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SIRENIX_ODININSPECTOR_VALUEDROPDOWNITEM_SYSTEM_UINT32___GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x188FDEA0)
#define RPG_GAMECORE_FIVEDIMDOORCONFIG__DOORKEYDROPDOWN_D__11_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x188FDFC0)
#define RPG_GAMECORE_FIVEDIMDOORCONFIG__DOORKEYDROPDOWN_D__11_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x188FDF00)
#define RPG_GAMECORE_FIVEDIMDOORCONFIG__DOORKEYDROPDOWN_D__11_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x188FDEB0)
#define RPG_GAMECORE_FIVEDIMDOORCONFIG__DOORKEYDROPDOWN_D__11_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x188FDDB0)
#define RPG_GAMECORE_FIVEDIMDOORCONFIG__DOORKEYDROPDOWN_D__11__CTOR_OFFSET UNITYSDK_OFFSET(0x188FDBF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimDoorConfig__DoorKeyDropdown_d__11_TypeDefinitionIndex = 17664;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32))((::PBYTE)hIl2Cpp + RPG_GAMECORE_FIVEDIMDOORCONFIG__DOORKEYDROPDOWN_D__11__CTOR_OFFSET))(this, __1__state);
		}
