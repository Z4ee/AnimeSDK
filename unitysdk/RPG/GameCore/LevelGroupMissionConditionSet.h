...
#define RPG_GAMECORE_LEVELGROUPMISSIONCONDITIONSET_METHOD_2_4149F00E3412603B_OFFSET UNITYSDK_OFFSET(0x1C10FB30)
#define RPG_GAMECORE_LEVELGROUPMISSIONCONDITIONSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1C118A60)
