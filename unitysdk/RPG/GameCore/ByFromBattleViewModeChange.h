...
#define RPG_GAMECORE_BYFROMBATTLEVIEWMODECHANGE_METHOD_4_A82066871243E6A0_OFFSET UNITYSDK_OFFSET(0x18746640)
#define RPG_GAMECORE_BYFROMBATTLEVIEWMODECHANGE_METHOD_4_D6C40DE65DEEA54A_OFFSET UNITYSDK_OFFSET(0x18746710)
#define RPG_GAMECORE_BYFROMBATTLEVIEWMODECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x187466C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByFromBattleViewModeChange_TypeDefinitionIndex = 21301;
