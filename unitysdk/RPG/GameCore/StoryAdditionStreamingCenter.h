...
#define RPG_GAMECORE_STORYADDITIONSTREAMINGCENTER_METHOD_2_C91B2F96C8D2F79F_OFFSET UNITYSDK_OFFSET(0x1777EA50)
#define RPG_GAMECORE_STORYADDITIONSTREAMINGCENTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1777EBD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StoryAdditionStreamingCenter_TypeDefinitionIndex = 19539;
