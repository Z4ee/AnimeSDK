...
#define RPG_GAMECORE_SHARECHANNELCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1BE31EF0)
#define RPG_GAMECORE_SHARECHANNELCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE32750)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShareChannelConfigRow_TypeDefinitionIndex = 13910;

	class ShareChannelConfigRow : public ::System::Object
	{
	public:
		::System::String* Content; // 0x10
		::Il2CppArray<::System::String*>* Topics; // 0x18
		::System::String* UrlTitle; // 0x20
