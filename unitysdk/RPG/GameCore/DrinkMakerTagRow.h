...
#define RPG_GAMECORE_DRINKMAKERTAGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x196CBDC0)
#define RPG_GAMECORE_DRINKMAKERTAGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x196CC5F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DrinkMakerTagRow_TypeDefinitionIndex = 12524;
	...
	public:
		...
		::System::UInt32 CounterTag; // 0x3C
		::RPG::GameCore::DrinkMakerTagType Type; // 0x40
		::RPG::GameCore::DrinkMakerTagMixType MixType; // 0x44
