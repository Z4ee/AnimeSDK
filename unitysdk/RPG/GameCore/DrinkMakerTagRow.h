...
#define RPG_GAMECORE_DRINKMAKERTAGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1BB27B50)
#define RPG_GAMECORE_DRINKMAKERTAGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB28380)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DrinkMakerTagRow_TypeDefinitionIndex = 12661;

	class DrinkMakerTagRow : public ::System::Object
	{
	public:
		::Il2CppArray<::System::UInt32>* MixParam; // 0x10
		::RPG::GameCore::DrinkMakerTagMixType MixType; // 0x18
		::System::UInt32 Priority; // 0x1C
		::System::Boolean IsShow; // 0x20
		::System::UInt32 TagID; // 0x24
		::RPG::GameCore::DrinkMakerTagSourceType SourceType; // 0x28
		::RPG::Client::TextID TagName; // 0x30
		::System::UInt32 CounterTag; // 0x40
		::RPG::GameCore::DrinkMakerTagType Type; // 0x44
