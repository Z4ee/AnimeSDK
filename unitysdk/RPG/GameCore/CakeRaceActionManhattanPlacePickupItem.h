...
#define RPG_GAMECORE_CAKERACEACTIONMANHATTANPLACEPICKUPITEM_METHOD_3_98B181198CE368C4_OFFSET UNITYSDK_OFFSET(0x1B2CBBC0)
#define RPG_GAMECORE_CAKERACEACTIONMANHATTANPLACEPICKUPITEM_METHOD_3_B567B03FAF8858DE_OFFSET UNITYSDK_OFFSET(0x1B2CBC20)
#define RPG_GAMECORE_CAKERACEACTIONMANHATTANPLACEPICKUPITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2CBC10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionManhattanPlacePickupItem_TypeDefinitionIndex = 17615;
