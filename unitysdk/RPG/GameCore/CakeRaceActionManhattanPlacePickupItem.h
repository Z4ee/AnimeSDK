...
#define RPG_GAMECORE_CAKERACEACTIONMANHATTANPLACEPICKUPITEM_METHOD_3_B567B03FAF8858DE_OFFSET UNITYSDK_OFFSET(0x195E6180)
#define RPG_GAMECORE_CAKERACEACTIONMANHATTANPLACEPICKUPITEM_METHOD_3_E51744988ED28E1A_OFFSET UNITYSDK_OFFSET(0x195E8080)
#define RPG_GAMECORE_CAKERACEACTIONMANHATTANPLACEPICKUPITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x195E6160)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionManhattanPlacePickupItem_TypeDefinitionIndex = 17442;
