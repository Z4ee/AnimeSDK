...
#define RPG_GAMECORE_CAKERACEACTIONMANHATTANPLACEPICKUPITEM_METHOD_3_B567B03FAF8858DE_OFFSET UNITYSDK_OFFSET(0x1876A680)
#define RPG_GAMECORE_CAKERACEACTIONMANHATTANPLACEPICKUPITEM_METHOD_3_E51744988ED28E1A_OFFSET UNITYSDK_OFFSET(0x1876C0D0)
#define RPG_GAMECORE_CAKERACEACTIONMANHATTANPLACEPICKUPITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1876A660)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionManhattanPlacePickupItem_TypeDefinitionIndex = 17439;
