...
#define RPG_GAMECORE_RTSKILLPROPERTYCONFIG_METHOD_3_3B17BC4F83EB7980_OFFSET UNITYSDK_OFFSET(0x19BF1540)
#define RPG_GAMECORE_RTSKILLPROPERTYCONFIG_METHOD_3_DB3E9E46882A0D7C_OFFSET UNITYSDK_OFFSET(0x19BF1030)
#define RPG_GAMECORE_RTSKILLPROPERTYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19BF1020)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtSkillPropertyConfig_TypeDefinitionIndex = 16794;
