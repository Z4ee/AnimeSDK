...
#define RPG_GAMECORE_SYNCBATTLEEVENTPROPERTYVALUES_METHOD_3_46D25371642EB622_OFFSET UNITYSDK_OFFSET(0x177A3770)
#define RPG_GAMECORE_SYNCBATTLEEVENTPROPERTYVALUES_METHOD_3_C12CE956DFBAA54B_OFFSET UNITYSDK_OFFSET(0x177A36F0)
#define RPG_GAMECORE_SYNCBATTLEEVENTPROPERTYVALUES__CTOR_OFFSET UNITYSDK_OFFSET(0x177A3740)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SyncBattleEventPropertyValues_TypeDefinitionIndex = 20694;
