...
#define RPG_GAMECORE_SYNCBATTLEEVENTPROPERTYVALUES_METHOD_3_46D25371642EB622_OFFSET UNITYSDK_OFFSET(0x1B444100)
#define RPG_GAMECORE_SYNCBATTLEEVENTPROPERTYVALUES_METHOD_3_F14D3939EBAE8699_OFFSET UNITYSDK_OFFSET(0x1B4440C0)
#define RPG_GAMECORE_SYNCBATTLEEVENTPROPERTYVALUES__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4440F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SyncBattleEventPropertyValues_TypeDefinitionIndex = 21696;
