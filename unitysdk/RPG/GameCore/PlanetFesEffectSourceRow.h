...
#define RPG_GAMECORE_PLANETFESEFFECTSOURCEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19A1C5B0)
#define RPG_GAMECORE_PLANETFESEFFECTSOURCEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19A1C7A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlanetFesEffectSourceRow_TypeDefinitionIndex = 11629;
