...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDEXPCONVERTTOCOINCONFIG_METHOD_3_C3C90536A1F8C41D_OFFSET UNITYSDK_OFFSET(0x1EE6C140)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDEXPCONVERTTOCOINCONFIG_METHOD_3_FE1CAAC3780B5C59_OFFSET UNITYSDK_OFFSET(0x1EE6C0F0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDEXPCONVERTTOCOINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EE6C130)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierAddExpConvertToCoinConfig_TypeDefinitionIndex = 19251;
