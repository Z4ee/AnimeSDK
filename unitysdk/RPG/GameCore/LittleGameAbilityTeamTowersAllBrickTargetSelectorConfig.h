...
#define RPG_GAMECORE_LITTLEGAMEABILITYTEAMTOWERSALLBRICKTARGETSELECTORCONFIG_METHOD_3_162CA2936B6D1664_OFFSET UNITYSDK_OFFSET(0x1B096660)
#define RPG_GAMECORE_LITTLEGAMEABILITYTEAMTOWERSALLBRICKTARGETSELECTORCONFIG_METHOD_3_A0C483FF120A54B9_OFFSET UNITYSDK_OFFSET(0x1B096700)
#define RPG_GAMECORE_LITTLEGAMEABILITYTEAMTOWERSALLBRICKTARGETSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0966F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityTeamTowersAllBrickTargetSelectorConfig_TypeDefinitionIndex = 20621;
