...
#define RPG_GAMECORE_CAKERACEACTIONCHANGEROBINRADIUSBYVOTE_METHOD_3_AC5A8ACA06D174E9_OFFSET UNITYSDK_OFFSET(0x1B2CAA70)
#define RPG_GAMECORE_CAKERACEACTIONCHANGEROBINRADIUSBYVOTE_METHOD_3_D82BF4AADB4E6675_OFFSET UNITYSDK_OFFSET(0x1B2CAA10)
#define RPG_GAMECORE_CAKERACEACTIONCHANGEROBINRADIUSBYVOTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2CAA60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionChangeRobinRadiusByVote_TypeDefinitionIndex = 17612;
