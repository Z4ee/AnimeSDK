...
#define RPG_GAMECORE_SWORDTRAININGEFFECTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19CE2520)
#define RPG_GAMECORE_SWORDTRAININGEFFECTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19CE2780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwordTrainingEffectRow_TypeDefinitionIndex = 11849;
