...
#define RPG_GAMECORE_SWORDTRAININGEFFECTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B43D2C0)
#define RPG_GAMECORE_SWORDTRAININGEFFECTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B43D520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwordTrainingEffectRow_TypeDefinitionIndex = 11949;
	...
	public:
		...
		::System::UInt32 Condition; // 0x20
		::RPG::GameCore::SwordTrainingEffectType EffectType; // 0x24
