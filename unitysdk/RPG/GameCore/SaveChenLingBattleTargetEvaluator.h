...
#define RPG_GAMECORE_SAVECHENLINGBATTLETARGETEVALUATOR_METHOD_3_29FE4DBB8E709AD3_OFFSET UNITYSDK_OFFSET(0x19C1C230)
#define RPG_GAMECORE_SAVECHENLINGBATTLETARGETEVALUATOR_METHOD_3_5CFD35E935E43011_OFFSET UNITYSDK_OFFSET(0x19C1C1D0)
#define RPG_GAMECORE_SAVECHENLINGBATTLETARGETEVALUATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x19C1C220)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SaveChenLingBattleTargetEvaluator_TypeDefinitionIndex = 15002;
