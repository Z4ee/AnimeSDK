...
#define RPG_GAMECORE_SETDYNAMICVALUEBYCUSTOMNAME_METHOD_3_69ACC753346F8C64_OFFSET UNITYSDK_OFFSET(0x1C2E0FF0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYCUSTOMNAME_METHOD_3_9C705D61EC80A051_OFFSET UNITYSDK_OFFSET(0x1C2E0FB0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYCUSTOMNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2E0FE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByCustomName_TypeDefinitionIndex = 20997;
