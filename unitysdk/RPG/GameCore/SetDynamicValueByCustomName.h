...
#define RPG_GAMECORE_SETDYNAMICVALUEBYCUSTOMNAME_METHOD_3_69ACC753346F8C64_OFFSET UNITYSDK_OFFSET(0x176C0EF0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYCUSTOMNAME_METHOD_3_E0CFEF4D4D40A1DB_OFFSET UNITYSDK_OFFSET(0x176C0E80)
#define RPG_GAMECORE_SETDYNAMICVALUEBYCUSTOMNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x176C0EC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByCustomName_TypeDefinitionIndex = 19969;
