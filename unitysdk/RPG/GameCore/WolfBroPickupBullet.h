...
#define RPG_GAMECORE_WOLFBROPICKUPBULLET_METHOD_3_8584C94687BA448E_OFFSET UNITYSDK_OFFSET(0x19110460)
#define RPG_GAMECORE_WOLFBROPICKUPBULLET_METHOD_3_C4455067C5B7DCC2_OFFSET UNITYSDK_OFFSET(0x19110350)
#define RPG_GAMECORE_WOLFBROPICKUPBULLET__CTOR_OFFSET UNITYSDK_OFFSET(0x19110430)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WolfBroPickupBullet_TypeDefinitionIndex = 20430;
