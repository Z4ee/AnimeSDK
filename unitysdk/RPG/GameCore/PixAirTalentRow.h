...
#define RPG_GAMECORE_PIXAIRTALENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B4CF190)
#define RPG_GAMECORE_PIXAIRTALENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4CF430)
