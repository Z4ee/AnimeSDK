...
#define RPG_GAMECORE_CHIMERADUELENTITYCOMPOSITECOMPARER_METHOD_4_2789D15426BC0952_OFFSET UNITYSDK_OFFSET(0x1963C630)
#define RPG_GAMECORE_CHIMERADUELENTITYCOMPOSITECOMPARER_METHOD_4_F8F4BA34595883A2_OFFSET UNITYSDK_OFFSET(0x1963A130)
#define RPG_GAMECORE_CHIMERADUELENTITYCOMPOSITECOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x1963A120)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelEntityCompositeComparer_TypeDefinitionIndex = 15157;
