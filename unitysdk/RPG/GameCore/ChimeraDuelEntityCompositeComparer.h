...
#define RPG_GAMECORE_CHIMERADUELENTITYCOMPOSITECOMPARER_METHOD_4_2789D15426BC0952_OFFSET UNITYSDK_OFFSET(0x1C23DFA0)
#define RPG_GAMECORE_CHIMERADUELENTITYCOMPOSITECOMPARER_METHOD_4_F8F4BA34595883A2_OFFSET UNITYSDK_OFFSET(0x1C23DD70)
#define RPG_GAMECORE_CHIMERADUELENTITYCOMPOSITECOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C23DD60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelEntityCompositeComparer_TypeDefinitionIndex = 15321;
