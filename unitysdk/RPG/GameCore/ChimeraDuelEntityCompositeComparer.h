...
#define RPG_GAMECORE_CHIMERADUELENTITYCOMPOSITECOMPARER_METHOD_4_2789D15426BC0952_OFFSET UNITYSDK_OFFSET(0x1709AE90)
#define RPG_GAMECORE_CHIMERADUELENTITYCOMPOSITECOMPARER_METHOD_4_F8F4BA34595883A2_OFFSET UNITYSDK_OFFSET(0x1709AC50)
#define RPG_GAMECORE_CHIMERADUELENTITYCOMPOSITECOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x1709AC40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelEntityCompositeComparer_TypeDefinitionIndex = 14624;
