...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERUPGRADEROLECONFIG_METHOD_3_D34C2B1F864B1994_OFFSET UNITYSDK_OFFSET(0x197F4CA0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERUPGRADEROLECONFIG_METHOD_3_F2637465A9A0E15D_OFFSET UNITYSDK_OFFSET(0x197F4BD0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERUPGRADEROLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197F4C50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierUpgradeRoleConfig_TypeDefinitionIndex = 18451;
