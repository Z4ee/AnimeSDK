...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERUPGRADEROLECONFIG_METHOD_3_1A60CFD525B20598_OFFSET UNITYSDK_OFFSET(0x1D06B760)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERUPGRADEROLECONFIG_METHOD_3_D34C2B1F864B1994_OFFSET UNITYSDK_OFFSET(0x1D06B7B0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERUPGRADEROLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D06B7A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierUpgradeRoleConfig_TypeDefinitionIndex = 18699;
