...
#define RPG_GAMECORE_WAITSTREAMINGJOBFINISHED_METHOD_3_39967D9E9082E406_OFFSET UNITYSDK_OFFSET(0x191097D0)
#define RPG_GAMECORE_WAITSTREAMINGJOBFINISHED_METHOD_3_C4D6C64268301497_OFFSET UNITYSDK_OFFSET(0x19109750)
#define RPG_GAMECORE_WAITSTREAMINGJOBFINISHED__CTOR_OFFSET UNITYSDK_OFFSET(0x191097A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitStreamingJobFinished_TypeDefinitionIndex = 19735;
