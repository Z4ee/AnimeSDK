...
#define RPG_GAMECORE_WAITSERVERFUNCUNLOCK_METHOD_3_42DFAD3392D02513_OFFSET UNITYSDK_OFFSET(0x1D6AC4E0)
#define RPG_GAMECORE_WAITSERVERFUNCUNLOCK_METHOD_3_866137965C7CDD57_OFFSET UNITYSDK_OFFSET(0x1D6AC530)
#define RPG_GAMECORE_WAITSERVERFUNCUNLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6AC520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitServerFuncUnlock_TypeDefinitionIndex = 20256;
