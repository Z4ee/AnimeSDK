...
#define RPG_GAMECORE_WAITSERVERFUNCUNLOCK_METHOD_3_866137965C7CDD57_OFFSET UNITYSDK_OFFSET(0x17904730)
#define RPG_GAMECORE_WAITSERVERFUNCUNLOCK_METHOD_3_F758297F7FC3C867_OFFSET UNITYSDK_OFFSET(0x179046A0)
#define RPG_GAMECORE_WAITSERVERFUNCUNLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x17904700)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitServerFuncUnlock_TypeDefinitionIndex = 18792;
