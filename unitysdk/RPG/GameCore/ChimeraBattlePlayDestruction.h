...
#define RPG_GAMECORE_CHIMERABATTLEPLAYDESTRUCTION_METHOD_3_94531CF00F7BCF73_OFFSET UNITYSDK_OFFSET(0x1C38F9E0)
#define RPG_GAMECORE_CHIMERABATTLEPLAYDESTRUCTION_METHOD_3_9A7791980B4CF39F_OFFSET UNITYSDK_OFFSET(0x1C38E000)
#define RPG_GAMECORE_CHIMERABATTLEPLAYDESTRUCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C38DFF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraBattlePlayDestruction_TypeDefinitionIndex = 15272;
