...
#define RPG_GAMECORE_MAPROTATIONPERFORMANCEID_METHOD_2_8C75D67775879CAF_OFFSET UNITYSDK_OFFSET(0x1D49C4E0)
#define RPG_GAMECORE_MAPROTATIONPERFORMANCEID__CTOR_OFFSET UNITYSDK_OFFSET(0x1D49C610)
