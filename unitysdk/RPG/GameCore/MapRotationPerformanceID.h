...
#define RPG_GAMECORE_MAPROTATIONPERFORMANCEID_METHOD_2_8C75D67775879CAF_OFFSET UNITYSDK_OFFSET(0x1D227230)
#define RPG_GAMECORE_MAPROTATIONPERFORMANCEID__CTOR_OFFSET UNITYSDK_OFFSET(0x1D227360)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MapRotationPerformanceID_TypeDefinitionIndex = 16844;
