...
#define RPG_GAMECORE_FOURROTATEVOXELFIREEFFECTACTION_METHOD_4_22822F2C65719189_OFFSET UNITYSDK_OFFSET(0x197690C0)
#define RPG_GAMECORE_FOURROTATEVOXELFIREEFFECTACTION_METHOD_4_954FCAEAF09ABED5_OFFSET UNITYSDK_OFFSET(0x19769050)
#define RPG_GAMECORE_FOURROTATEVOXELFIREEFFECTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x197690A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FourRotateVoxelFireEffectAction_TypeDefinitionIndex = 17881;
