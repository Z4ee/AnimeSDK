...
#define RPG_GAMECORE_FOURROTATEVOXELFIREEFFECTACTION_METHOD_4_22822F2C65719189_OFFSET UNITYSDK_OFFSET(0x1721B750)
#define RPG_GAMECORE_FOURROTATEVOXELFIREEFFECTACTION_METHOD_4_954FCAEAF09ABED5_OFFSET UNITYSDK_OFFSET(0x1721B6E0)
#define RPG_GAMECORE_FOURROTATEVOXELFIREEFFECTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1721B730)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FourRotateVoxelFireEffectAction_TypeDefinitionIndex = 17244;
