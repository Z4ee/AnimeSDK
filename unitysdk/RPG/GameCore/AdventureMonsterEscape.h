...
#define RPG_GAMECORE_ADVENTUREMONSTERESCAPE_METHOD_3_7B2AAAD3405DB4BD_OFFSET UNITYSDK_OFFSET(0x19450EB0)
#define RPG_GAMECORE_ADVENTUREMONSTERESCAPE_METHOD_3_CCAFF0B6DDAC0262_OFFSET UNITYSDK_OFFSET(0x19450F20)
#define RPG_GAMECORE_ADVENTUREMONSTERESCAPE__CTOR_OFFSET UNITYSDK_OFFSET(0x19450EF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureMonsterEscape_TypeDefinitionIndex = 19085;
