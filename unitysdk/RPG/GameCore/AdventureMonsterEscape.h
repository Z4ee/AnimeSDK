...
#define RPG_GAMECORE_ADVENTUREMONSTERESCAPE_METHOD_3_7B2AAAD3405DB4BD_OFFSET UNITYSDK_OFFSET(0x16F565A0)
#define RPG_GAMECORE_ADVENTUREMONSTERESCAPE_METHOD_3_CCAFF0B6DDAC0262_OFFSET UNITYSDK_OFFSET(0x16F56610)
#define RPG_GAMECORE_ADVENTUREMONSTERESCAPE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F565E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureMonsterEscape_TypeDefinitionIndex = 18505;
