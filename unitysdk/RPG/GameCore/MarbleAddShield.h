...
#define RPG_GAMECORE_MARBLEADDSHIELD_METHOD_3_2695C56F422933B3_OFFSET UNITYSDK_OFFSET(0x198C8CA0)
#define RPG_GAMECORE_MARBLEADDSHIELD_METHOD_3_DBFE962FBA4A3588_OFFSET UNITYSDK_OFFSET(0x198C8BC0)
#define RPG_GAMECORE_MARBLEADDSHIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x198C8C50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleAddShield_TypeDefinitionIndex = 16000;
