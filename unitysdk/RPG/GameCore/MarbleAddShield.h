...
#define RPG_GAMECORE_MARBLEADDSHIELD_METHOD_3_22303DC4BCC89043_OFFSET UNITYSDK_OFFSET(0x1D22D9F0)
#define RPG_GAMECORE_MARBLEADDSHIELD_METHOD_3_2695C56F422933B3_OFFSET UNITYSDK_OFFSET(0x1D22DA50)
#define RPG_GAMECORE_MARBLEADDSHIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x1D22DA40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleAddShield_TypeDefinitionIndex = 16668;
