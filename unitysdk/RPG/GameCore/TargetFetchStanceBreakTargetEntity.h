...
#define RPG_GAMECORE_TARGETFETCHSTANCEBREAKTARGETENTITY_METHOD_4_468DFFD258397608_OFFSET UNITYSDK_OFFSET(0x1D0BCD50)
#define RPG_GAMECORE_TARGETFETCHSTANCEBREAKTARGETENTITY_METHOD_4_B86577EED52942E0_OFFSET UNITYSDK_OFFSET(0x1D0BCC70)
#define RPG_GAMECORE_TARGETFETCHSTANCEBREAKTARGETENTITY_METHOD_4_D3195A111679F8A5_OFFSET UNITYSDK_OFFSET(0x1D0BCCF0)
#define RPG_GAMECORE_TARGETFETCHSTANCEBREAKTARGETENTITY_METHOD_4_EB1B723184C63D55_OFFSET UNITYSDK_OFFSET(0x1D0BCD70)
#define RPG_GAMECORE_TARGETFETCHSTANCEBREAKTARGETENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0BCCE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchStanceBreakTargetEntity_TypeDefinitionIndex = 23145;
