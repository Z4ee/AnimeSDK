...
#define RPG_GAMECORE_HIPPLENGAMESWITCHCAMERA_METHOD_3_ADCFA2662C7537A3_OFFSET UNITYSDK_OFFSET(0x1D201FA0)
#define RPG_GAMECORE_HIPPLENGAMESWITCHCAMERA_METHOD_3_B042469FB748F930_OFFSET UNITYSDK_OFFSET(0x1D201FE0)
#define RPG_GAMECORE_HIPPLENGAMESWITCHCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x1D201FD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HipplenGameSwitchCamera_TypeDefinitionIndex = 21070;
