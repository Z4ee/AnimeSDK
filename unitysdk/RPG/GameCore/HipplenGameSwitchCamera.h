...
#define RPG_GAMECORE_HIPPLENGAMESWITCHCAMERA_METHOD_3_50F3D35B0ED03FC8_OFFSET UNITYSDK_OFFSET(0x198345B0)
#define RPG_GAMECORE_HIPPLENGAMESWITCHCAMERA_METHOD_3_B042469FB748F930_OFFSET UNITYSDK_OFFSET(0x19834630)
#define RPG_GAMECORE_HIPPLENGAMESWITCHCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x19834600)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HipplenGameSwitchCamera_TypeDefinitionIndex = 20146;
