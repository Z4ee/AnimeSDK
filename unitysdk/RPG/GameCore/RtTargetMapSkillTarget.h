...
#define RPG_GAMECORE_RTTARGETMAPSKILLTARGET_METHOD_3_1D1DA2F919F64148_OFFSET UNITYSDK_OFFSET(0x1D4B8670)
#define RPG_GAMECORE_RTTARGETMAPSKILLTARGET_METHOD_3_57E463234AA0370F_OFFSET UNITYSDK_OFFSET(0x1D4B87B0)
#define RPG_GAMECORE_RTTARGETMAPSKILLTARGET_METHOD_3_ABCB5707B0D72F0B_OFFSET UNITYSDK_OFFSET(0x1D4B8770)
#define RPG_GAMECORE_RTTARGETMAPSKILLTARGET_METHOD_3_B19FAAE7BA59BF2D_OFFSET UNITYSDK_OFFSET(0x1D4B8710)
#define RPG_GAMECORE_RTTARGETMAPSKILLTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4B8700)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtTargetMapSkillTarget_TypeDefinitionIndex = 23973;
