...
#define RPG_GAMECORE_FIVEDIMDESTROYCLEANERBOTACTION_METHOD_3_0177DBF484F2A0A7_OFFSET UNITYSDK_OFFSET(0x1BA909F0)
#define RPG_GAMECORE_FIVEDIMDESTROYCLEANERBOTACTION_METHOD_3_FAD37642CEFC8DB0_OFFSET UNITYSDK_OFFSET(0x1BA90980)
#define RPG_GAMECORE_FIVEDIMDESTROYCLEANERBOTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA909D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimDestroyCleanerBotAction_TypeDefinitionIndex = 17999;
