...
#define RPG_GAMECORE_CAKERACEREGIONCONFIG_METHOD_3_A69316D3C2E4FBA8_OFFSET UNITYSDK_OFFSET(0x1704EED0)
#define RPG_GAMECORE_CAKERACEREGIONCONFIG_METHOD_3_ED91A9EFF797BA3E_OFFSET UNITYSDK_OFFSET(0x1704EF60)
#define RPG_GAMECORE_CAKERACEREGIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1704EF40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceRegionConfig_TypeDefinitionIndex = 16925;
