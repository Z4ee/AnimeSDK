...
#define RPG_GAMECORE_MECHANISMBAREFFECTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D284A30)
#define RPG_GAMECORE_MECHANISMBAREFFECTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D284CE0)
