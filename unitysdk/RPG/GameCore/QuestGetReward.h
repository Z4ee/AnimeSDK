...
#define RPG_GAMECORE_QUESTGETREWARD_METHOD_3_737C45B40060A617_OFFSET UNITYSDK_OFFSET(0x1B9AB9E0)
#define RPG_GAMECORE_QUESTGETREWARD_METHOD_3_E7AB5389F232CD5C_OFFSET UNITYSDK_OFFSET(0x1B9AB9A0)
#define RPG_GAMECORE_QUESTGETREWARD__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9AB9D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int QuestGetReward_TypeDefinitionIndex = 21078;
