...
#define RPG_GAMECORE_QUESTGETREWARD_METHOD_3_737C45B40060A617_OFFSET UNITYSDK_OFFSET(0x19AA4600)
#define RPG_GAMECORE_QUESTGETREWARD_METHOD_3_90241F6B7B0E2266_OFFSET UNITYSDK_OFFSET(0x19AA4580)
#define RPG_GAMECORE_QUESTGETREWARD__CTOR_OFFSET UNITYSDK_OFFSET(0x19AA45D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int QuestGetReward_TypeDefinitionIndex = 20663;
