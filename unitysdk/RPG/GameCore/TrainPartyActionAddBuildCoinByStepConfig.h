...
#define RPG_GAMECORE_TRAINPARTYACTIONADDBUILDCOINBYSTEPCONFIG_METHOD_5_573A02DE81AB0F1B_OFFSET UNITYSDK_OFFSET(0x1D5D94D0)
#define RPG_GAMECORE_TRAINPARTYACTIONADDBUILDCOINBYSTEPCONFIG_METHOD_5_995BB45344B7BE47_OFFSET UNITYSDK_OFFSET(0x1D5D9470)
#define RPG_GAMECORE_TRAINPARTYACTIONADDBUILDCOINBYSTEPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5D94C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyActionAddBuildCoinByStepConfig_TypeDefinitionIndex = 17864;
