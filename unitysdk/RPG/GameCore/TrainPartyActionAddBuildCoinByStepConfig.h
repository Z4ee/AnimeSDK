...
#define RPG_GAMECORE_TRAINPARTYACTIONADDBUILDCOINBYSTEPCONFIG_METHOD_5_573A02DE81AB0F1B_OFFSET UNITYSDK_OFFSET(0x19DEFE50)
#define RPG_GAMECORE_TRAINPARTYACTIONADDBUILDCOINBYSTEPCONFIG_METHOD_5_B18DBF0E99E1BB2D_OFFSET UNITYSDK_OFFSET(0x19DEFD70)
#define RPG_GAMECORE_TRAINPARTYACTIONADDBUILDCOINBYSTEPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19DEFE00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyActionAddBuildCoinByStepConfig_TypeDefinitionIndex = 17185;
