...
#define RPG_GAMECORE_LEVELGROUPATMOSPHEREMAINMISSIONCOMPLETECONDITION_METHOD_3_1281D7B07F8C1F4F_OFFSET UNITYSDK_OFFSET(0x19875F00)
#define RPG_GAMECORE_LEVELGROUPATMOSPHEREMAINMISSIONCOMPLETECONDITION_METHOD_3_7D77EEB3AFB22EEA_OFFSET UNITYSDK_OFFSET(0x198764B0)
#define RPG_GAMECORE_LEVELGROUPATMOSPHEREMAINMISSIONCOMPLETECONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x19875EF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelGroupAtmosphereMainMissionCompleteCondition_TypeDefinitionIndex = 16367;
