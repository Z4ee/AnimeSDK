...
#define RPG_GAMECORE_LEVELGROUPATMOSPHEREMAINMISSIONCOMPLETECONDITION_METHOD_3_1281D7B07F8C1F4F_OFFSET UNITYSDK_OFFSET(0x18A43FC0)
#define RPG_GAMECORE_LEVELGROUPATMOSPHEREMAINMISSIONCOMPLETECONDITION_METHOD_3_7D77EEB3AFB22EEA_OFFSET UNITYSDK_OFFSET(0x18A44370)
#define RPG_GAMECORE_LEVELGROUPATMOSPHEREMAINMISSIONCOMPLETECONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x18A43FB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelGroupAtmosphereMainMissionCompleteCondition_TypeDefinitionIndex = 16335;
