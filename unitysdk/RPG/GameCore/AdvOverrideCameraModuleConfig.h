...
#define RPG_GAMECORE_ADVOVERRIDECAMERAMODULECONFIG_METHOD_3_589733C0044C1DC0_OFFSET UNITYSDK_OFFSET(0x1865C340)
#define RPG_GAMECORE_ADVOVERRIDECAMERAMODULECONFIG_METHOD_3_FA7920B91F921C55_OFFSET UNITYSDK_OFFSET(0x1865C2C0)
#define RPG_GAMECORE_ADVOVERRIDECAMERAMODULECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1865C310)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvOverrideCameraModuleConfig_TypeDefinitionIndex = 21063;
