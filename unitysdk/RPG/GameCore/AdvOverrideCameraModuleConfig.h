...
#define RPG_GAMECORE_ADVOVERRIDECAMERAMODULECONFIG_METHOD_3_589733C0044C1DC0_OFFSET UNITYSDK_OFFSET(0x16F3A170)
#define RPG_GAMECORE_ADVOVERRIDECAMERAMODULECONFIG_METHOD_3_FA7920B91F921C55_OFFSET UNITYSDK_OFFSET(0x16F3A0F0)
#define RPG_GAMECORE_ADVOVERRIDECAMERAMODULECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16F3A140)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvOverrideCameraModuleConfig_TypeDefinitionIndex = 20381;
	...
	public:
		...
		static ::System::Void Method_3_589733C0044C1DC0(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::AdvOverrideCameraModuleConfig* a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::AdvOverrideCameraModuleConfig*))((::PBYTE)hIl2Cpp + RPG_GAMECORE_ADVOVERRIDECAMERAMODULECONFIG_METHOD_3_589733C0044C1DC0_OFFSET))(a1, a2);
		}
	};
}
