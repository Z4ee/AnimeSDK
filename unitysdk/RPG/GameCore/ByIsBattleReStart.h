...
#define RPG_GAMECORE_BYISBATTLERESTART_METHOD_4_DA16FE4BEBEB98B3_OFFSET UNITYSDK_OFFSET(0x17029C00)
#define RPG_GAMECORE_BYISBATTLERESTART_METHOD_4_EEBD00D884B09D39_OFFSET UNITYSDK_OFFSET(0x17029CD0)
#define RPG_GAMECORE_BYISBATTLERESTART__CTOR_OFFSET UNITYSDK_OFFSET(0x17029C80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsBattleReStart_TypeDefinitionIndex = 21248;
