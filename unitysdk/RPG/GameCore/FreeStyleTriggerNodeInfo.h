...
#define RPG_GAMECORE_FREESTYLETRIGGERNODEINFO_METHOD_3_5049A62DF571554F_OFFSET UNITYSDK_OFFSET(0x1B981190)
#define RPG_GAMECORE_FREESTYLETRIGGERNODEINFO_METHOD_3_C9577264B3F9F9EA_OFFSET UNITYSDK_OFFSET(0x1B981110)
#define RPG_GAMECORE_FREESTYLETRIGGERNODEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B981160)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FreeStyleTriggerNodeInfo_TypeDefinitionIndex = 16264;
