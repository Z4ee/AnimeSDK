...
#define RPG_GAMECORE_FREESTYLETRIGGERNODEINFO_METHOD_3_8B6511E48B1DECCE_OFFSET UNITYSDK_OFFSET(0x172213E0)
#define RPG_GAMECORE_FREESTYLETRIGGERNODEINFO_METHOD_3_EDADC79DB17BDB4C_OFFSET UNITYSDK_OFFSET(0x17221460)
#define RPG_GAMECORE_FREESTYLETRIGGERNODEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x17221430)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FreeStyleTriggerNodeInfo_TypeDefinitionIndex = 15510;
