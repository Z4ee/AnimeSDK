...
#define RPG_GAMECORE_CRPVIRTUALCAMERACONFIGLIST_METHOD_2_1E7140015760E706_OFFSET UNITYSDK_OFFSET(0x195E1730)
#define RPG_GAMECORE_CRPVIRTUALCAMERACONFIGLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x195E17F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CRPVirtualCameraConfigList_TypeDefinitionIndex = 15606;
