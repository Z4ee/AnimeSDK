...
#define RPG_GAMECORE_CRPVIRTUALCAMERACONFIGLIST_METHOD_2_1E7140015760E706_OFFSET UNITYSDK_OFFSET(0x1CDCFCC0)
#define RPG_GAMECORE_CRPVIRTUALCAMERACONFIGLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDCFD80)
