...
#define RPG_GAMECORE_BYRANDOM_METHOD_4_77CFDBACF938C128_OFFSET UNITYSDK_OFFSET(0x17039610)
#define RPG_GAMECORE_BYRANDOM_METHOD_4_C9B15B236C759968_OFFSET UNITYSDK_OFFSET(0x170396D0)
#define RPG_GAMECORE_BYRANDOM__CTOR_OFFSET UNITYSDK_OFFSET(0x17039680)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByRandom_TypeDefinitionIndex = 19377;
