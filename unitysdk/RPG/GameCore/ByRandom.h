...
#define RPG_GAMECORE_BYRANDOM_METHOD_4_77CFDBACF938C128_OFFSET UNITYSDK_OFFSET(0x1875E100)
#define RPG_GAMECORE_BYRANDOM_METHOD_4_C9B15B236C759968_OFFSET UNITYSDK_OFFSET(0x1875E1C0)
#define RPG_GAMECORE_BYRANDOM__CTOR_OFFSET UNITYSDK_OFFSET(0x1875E170)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByRandom_TypeDefinitionIndex = 20036;
