...
#define RPG_GAMECORE_SHAREDJSONCONFIGLIST_METHOD_3_139A26E62378A0B7_OFFSET UNITYSDK_OFFSET(0x18E51A20)
#define RPG_GAMECORE_SHAREDJSONCONFIGLIST_METHOD_3_85D22C255258C41D_OFFSET UNITYSDK_OFFSET(0x18E51B30)
#define RPG_GAMECORE_SHAREDJSONCONFIGLIST_METHOD_3_A99C79153FAE2D80_OFFSET UNITYSDK_OFFSET(0x18E519E0)
#define RPG_GAMECORE_SHAREDJSONCONFIGLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x18E51A10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SharedJsonConfigList_TypeDefinitionIndex = 17398;
