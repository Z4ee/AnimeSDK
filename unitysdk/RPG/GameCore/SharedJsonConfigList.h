...
#define RPG_GAMECORE_SHAREDJSONCONFIGLIST_METHOD_3_139A26E62378A0B7_OFFSET UNITYSDK_OFFSET(0x19C6DFD0)
#define RPG_GAMECORE_SHAREDJSONCONFIGLIST_METHOD_3_85D22C255258C41D_OFFSET UNITYSDK_OFFSET(0x19C6E0E0)
#define RPG_GAMECORE_SHAREDJSONCONFIGLIST_METHOD_3_A99C79153FAE2D80_OFFSET UNITYSDK_OFFSET(0x19C6DF90)
#define RPG_GAMECORE_SHAREDJSONCONFIGLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x19C6DFC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SharedJsonConfigList_TypeDefinitionIndex = 17403;
