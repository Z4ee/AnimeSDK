...
#define RPG_GAMECORE_MUSEUMTARGETROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x199C1630)
#define RPG_GAMECORE_MUSEUMTARGETROW__CTOR_OFFSET UNITYSDK_OFFSET(0x199C1D70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MuseumTargetRow_TypeDefinitionIndex = 13568;
	...
	public:
		...
		::System::UInt32 TriggerTurns; // 0x1C
		::System::UInt32 TargetID; // 0x20
		::System::UInt32 TriggerPhase; // 0x24
