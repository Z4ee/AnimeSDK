...
#define RPG_GAMECORE_MUSEUMTARGETROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18B726D0)
#define RPG_GAMECORE_MUSEUMTARGETROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18B72E00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MuseumTargetRow_TypeDefinitionIndex = 13497;
	...
	public:
		...
		::RPG::GameCore::MuseumTargetRewardType RewardType; // 0x20
