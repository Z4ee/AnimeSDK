...
#define RPG_GAMECORE_ENTITYMOVETRACK_METHOD_2_004C3C22D43C6725_OFFSET UNITYSDK_OFFSET(0x196ED2F0)
#define RPG_GAMECORE_ENTITYMOVETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x196ED3A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EntityMoveTrack_TypeDefinitionIndex = 19037;
