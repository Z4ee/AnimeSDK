...
#define RPG_GAMECORE_STORYSTATECONFIG_METHOD_2_097E85F76FCBDA62_OFFSET UNITYSDK_OFFSET(0x1D573580)
#define RPG_GAMECORE_STORYSTATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D573720)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StoryStateConfig_TypeDefinitionIndex = 16211;
