...
#define RPG_GAMECORE_AVATARABILITYSTATISTICSROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CE349A0)
#define RPG_GAMECORE_AVATARABILITYSTATISTICSROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE34AC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AvatarAbilityStatisticsRow_TypeDefinitionIndex = 12756;
