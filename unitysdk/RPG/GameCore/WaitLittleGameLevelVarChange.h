...
#define RPG_GAMECORE_WAITLITTLEGAMELEVELVARCHANGE_METHOD_4_768EF5E9EBB3E0DB_OFFSET UNITYSDK_OFFSET(0x178FD010)
#define RPG_GAMECORE_WAITLITTLEGAMELEVELVARCHANGE_METHOD_4_C59B48179BB839AD_OFFSET UNITYSDK_OFFSET(0x178FD0F0)
#define RPG_GAMECORE_WAITLITTLEGAMELEVELVARCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x178FD090)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitLittleGameLevelVarChange_TypeDefinitionIndex = 19636;
