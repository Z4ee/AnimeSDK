...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERTRASHAUTOADDBONUSCONFIG_METHOD_3_83FD8D91FC2ABC7B_OFFSET UNITYSDK_OFFSET(0x1D06B510)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERTRASHAUTOADDBONUSCONFIG_METHOD_3_CD0F85C651055197_OFFSET UNITYSDK_OFFSET(0x1D06B4C0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERTRASHAUTOADDBONUSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D06B500)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierTrashAutoAddBonusConfig_TypeDefinitionIndex = 18640;
