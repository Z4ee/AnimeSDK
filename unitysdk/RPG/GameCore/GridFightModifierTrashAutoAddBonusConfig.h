...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERTRASHAUTOADDBONUSCONFIG_METHOD_3_83FD8D91FC2ABC7B_OFFSET UNITYSDK_OFFSET(0x1726CD50)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERTRASHAUTOADDBONUSCONFIG_METHOD_3_F267926C78F38662_OFFSET UNITYSDK_OFFSET(0x1726CC80)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERTRASHAUTOADDBONUSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1726CD00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierTrashAutoAddBonusConfig_TypeDefinitionIndex = 17805;
