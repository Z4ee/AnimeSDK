...
#define RPG_GAMECORE_EFFECTINSTANCECONFIG_METHOD_2_F5D9A00FC5925067_OFFSET UNITYSDK_OFFSET(0x1DB233F0)
#define RPG_GAMECORE_EFFECTINSTANCECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB23680)
