...
#define RPG_GAMECORE_SETADVACHIEVEMENT_METHOD_3_0D4D94F399DA3899_OFFSET UNITYSDK_OFFSET(0x1D4DF0B0)
#define RPG_GAMECORE_SETADVACHIEVEMENT_METHOD_3_8F37A776CD80AB80_OFFSET UNITYSDK_OFFSET(0x1D4DF0F0)
#define RPG_GAMECORE_SETADVACHIEVEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4DF0E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetAdvAchievement_TypeDefinitionIndex = 20325;
