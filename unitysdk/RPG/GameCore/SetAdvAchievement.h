...
#define RPG_GAMECORE_SETADVACHIEVEMENT_METHOD_3_51AC3CD5979E84DB_OFFSET UNITYSDK_OFFSET(0x18E07AE0)
#define RPG_GAMECORE_SETADVACHIEVEMENT_METHOD_3_8F37A776CD80AB80_OFFSET UNITYSDK_OFFSET(0x18E07B60)
#define RPG_GAMECORE_SETADVACHIEVEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x18E07B30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetAdvAchievement_TypeDefinitionIndex = 19529;
