...
#define RPG_GAMECORE_SPEEDLINEEFFECT_METHOD_3_36EB6499B889FE37_OFFSET UNITYSDK_OFFSET(0x1B0A3AC0)
#define RPG_GAMECORE_SPEEDLINEEFFECT_METHOD_3_8D8C99BB0A24037B_OFFSET UNITYSDK_OFFSET(0x1B0A3BE0)
#define RPG_GAMECORE_SPEEDLINEEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0A3B60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SpeedLineEffect_TypeDefinitionIndex = 19479;
