...
#define RPG_GAMECORE_BYCURRENTROGUESHOPHASSTAGE_METHOD_4_25B1A6241A3EF879_OFFSET UNITYSDK_OFFSET(0x1A8B9200)
#define RPG_GAMECORE_BYCURRENTROGUESHOPHASSTAGE_METHOD_4_793CF6DCBBF5A4C3_OFFSET UNITYSDK_OFFSET(0x1A8B9340)
#define RPG_GAMECORE_BYCURRENTROGUESHOPHASSTAGE_METHOD_4_AEC85FEEFF2ADE36_OFFSET UNITYSDK_OFFSET(0x1A8B9370)
#define RPG_GAMECORE_BYCURRENTROGUESHOPHASSTAGE_METHOD_4_D3EFB26EA3F1F2F2_OFFSET UNITYSDK_OFFSET(0x1A8B91C0)
#define RPG_GAMECORE_BYCURRENTROGUESHOPHASSTAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8B91F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCurrentRogueShopHasStage_TypeDefinitionIndex = 20258;
