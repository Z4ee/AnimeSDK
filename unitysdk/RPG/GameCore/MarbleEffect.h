...
#define RPG_GAMECORE_MARBLEEFFECT_METHOD_2_A45D17AD26C6E668_OFFSET UNITYSDK_OFFSET(0x1BD17470)
#define RPG_GAMECORE_MARBLEEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD179D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleEffect_TypeDefinitionIndex = 16230;
