...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYWORKBENCHMAGICUNITSHOPCONFIG_METHOD_3_7F8CCEE644E20153_OFFSET UNITYSDK_OFFSET(0x18D43660)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYWORKBENCHMAGICUNITSHOPCONFIG_METHOD_3_F1E7671503A2C88A_OFFSET UNITYSDK_OFFSET(0x18D43730)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYWORKBENCHMAGICUNITSHOPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D436E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyWorkbenchMagicUnitShopConfig_TypeDefinitionIndex = 16980;
