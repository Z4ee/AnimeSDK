...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYWORKBENCHMAGICUNITSHOPCONFIG_METHOD_3_7F8CCEE644E20153_OFFSET UNITYSDK_OFFSET(0x19B99640)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYWORKBENCHMAGICUNITSHOPCONFIG_METHOD_3_F1E7671503A2C88A_OFFSET UNITYSDK_OFFSET(0x19B99710)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYWORKBENCHMAGICUNITSHOPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B996C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyWorkbenchMagicUnitShopConfig_TypeDefinitionIndex = 16995;
