...
#define RPG_GAMECORE_WOLFBROPUZZLEFUNCBTNLISTENER_METHOD_3_7FB4B5D89ACDECAC_OFFSET UNITYSDK_OFFSET(0x1D1C35F0)
#define RPG_GAMECORE_WOLFBROPUZZLEFUNCBTNLISTENER_METHOD_3_FD05752A64A80DE7_OFFSET UNITYSDK_OFFSET(0x1D1C3630)
#define RPG_GAMECORE_WOLFBROPUZZLEFUNCBTNLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1C3620)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WolfBroPuzzleFuncBtnListener_TypeDefinitionIndex = 20370;
