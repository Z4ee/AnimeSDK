...
#define RPG_GAMECORE_WOLFBROPUZZLEFUNCBTNLISTENER_METHOD_3_01063A3E33BC0536_OFFSET UNITYSDK_OFFSET(0x19110520)
#define RPG_GAMECORE_WOLFBROPUZZLEFUNCBTNLISTENER_METHOD_3_FD05752A64A80DE7_OFFSET UNITYSDK_OFFSET(0x191105A0)
#define RPG_GAMECORE_WOLFBROPUZZLEFUNCBTNLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x19110570)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WolfBroPuzzleFuncBtnListener_TypeDefinitionIndex = 20141;
