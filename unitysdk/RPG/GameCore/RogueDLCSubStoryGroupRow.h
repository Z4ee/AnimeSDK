...
#define RPG_GAMECORE_ROGUEDLCSUBSTORYGROUPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D3DFD30)
#define RPG_GAMECORE_ROGUEDLCSUBSTORYGROUPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3DFFA0)
