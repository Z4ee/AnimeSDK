...
#define RPG_GAMECORE_ADVENTURECHARACTERFOOTIKCONFIG_GET_DEFAULT_OFFSET UNITYSDK_OFFSET(0x1AE5C510)
#define RPG_GAMECORE_ADVENTURECHARACTERFOOTIKCONFIG_METHOD_2_2EF6BEEE437C6169_OFFSET UNITYSDK_OFFSET(0x1AE5B8F0)
#define RPG_GAMECORE_ADVENTURECHARACTERFOOTIKCONFIG__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AE5C540)
#define RPG_GAMECORE_ADVENTURECHARACTERFOOTIKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE5C500)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureCharacterFootIKConfig_TypeDefinitionIndex = 16737;
	...
	public:
		...
		{
			return (::RPG::GameCore::AdventureCharacterFootIKConfig**)Il2CppClass::FromTypeDefinitionIndex(AdventureCharacterFootIKConfig_TypeDefinitionIndex)->GetStaticField(0x1D800);
		}
