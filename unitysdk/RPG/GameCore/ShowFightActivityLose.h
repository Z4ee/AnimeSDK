...
#define RPG_GAMECORE_SHOWFIGHTACTIVITYLOSE_METHOD_3_035EE27F3E5A91C6_OFFSET UNITYSDK_OFFSET(0x19C7A320)
#define RPG_GAMECORE_SHOWFIGHTACTIVITYLOSE_METHOD_3_7F49AA775ED827FA_OFFSET UNITYSDK_OFFSET(0x19C7A210)
#define RPG_GAMECORE_SHOWFIGHTACTIVITYLOSE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C7A2F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowFightActivityLose_TypeDefinitionIndex = 22183;
