...
#define RPG_GAMECORE_SHOWFIGHTACTIVITYLOSE_METHOD_3_035EE27F3E5A91C6_OFFSET UNITYSDK_OFFSET(0x1BE3EBE0)
#define RPG_GAMECORE_SHOWFIGHTACTIVITYLOSE_METHOD_3_D7111ACD40E44543_OFFSET UNITYSDK_OFFSET(0x1BE3EB10)
#define RPG_GAMECORE_SHOWFIGHTACTIVITYLOSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE3EBD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowFightActivityLose_TypeDefinitionIndex = 22620;
