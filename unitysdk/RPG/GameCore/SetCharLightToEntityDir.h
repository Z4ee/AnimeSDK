...
#define RPG_GAMECORE_SETCHARLIGHTTOENTITYDIR_METHOD_3_3CF43F9A08D31714_OFFSET UNITYSDK_OFFSET(0x176AC8C0)
#define RPG_GAMECORE_SETCHARLIGHTTOENTITYDIR_METHOD_3_8890CDB15035954B_OFFSET UNITYSDK_OFFSET(0x176ACA10)
#define RPG_GAMECORE_SETCHARLIGHTTOENTITYDIR__CTOR_OFFSET UNITYSDK_OFFSET(0x176AC980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetCharLightToEntityDir_TypeDefinitionIndex = 20043;
