...
#define RPG_GAMECORE_BYALERTVALUEINRANGE_METHOD_4_661BCDFF6B4561DD_OFFSET UNITYSDK_OFFSET(0x1871D400)
#define RPG_GAMECORE_BYALERTVALUEINRANGE_METHOD_4_F4F631AD510D0F8D_OFFSET UNITYSDK_OFFSET(0x1871D4D0)
#define RPG_GAMECORE_BYALERTVALUEINRANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1871D480)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByAlertValueInRange_TypeDefinitionIndex = 18956;
