...
#define RPG_GAMECORE_BYALERTVALUEINRANGE_METHOD_4_1028FE37E2E5A7F0_OFFSET UNITYSDK_OFFSET(0x19CB78C0)
#define RPG_GAMECORE_BYALERTVALUEINRANGE_METHOD_4_2830ED621F32FFE0_OFFSET UNITYSDK_OFFSET(0x19CB7650)
#define RPG_GAMECORE_BYALERTVALUEINRANGE_METHOD_4_55C949550FA40EC6_OFFSET UNITYSDK_OFFSET(0x19CB7890)
#define RPG_GAMECORE_BYALERTVALUEINRANGE_METHOD_4_F4F631AD510D0F8D_OFFSET UNITYSDK_OFFSET(0x19CB7690)
#define RPG_GAMECORE_BYALERTVALUEINRANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x19CB7680)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByAlertValueInRange_TypeDefinitionIndex = 19260;
