...
#define RPG_GAMECORE_DISTRICTAREASOUNDCONFIG_METHOD_2_367E62EC66A1DB1F_OFFSET UNITYSDK_OFFSET(0x196BDB60)
#define RPG_GAMECORE_DISTRICTAREASOUNDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x196BDD50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DistrictAreaSoundConfig_TypeDefinitionIndex = 16415;
