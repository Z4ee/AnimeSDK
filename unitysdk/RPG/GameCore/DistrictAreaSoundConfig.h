...
#define RPG_GAMECORE_DISTRICTAREASOUNDCONFIG_METHOD_2_367E62EC66A1DB1F_OFFSET UNITYSDK_OFFSET(0x1BB199D0)
#define RPG_GAMECORE_DISTRICTAREASOUNDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB19BC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DistrictAreaSoundConfig_TypeDefinitionIndex = 16577;
