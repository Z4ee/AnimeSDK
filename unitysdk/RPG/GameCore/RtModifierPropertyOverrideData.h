...
#define RPG_GAMECORE_RTMODIFIERPROPERTYOVERRIDEDATA_METHOD_2_EF0947BA2994508B_OFFSET UNITYSDK_OFFSET(0x1B767D30)
#define RPG_GAMECORE_RTMODIFIERPROPERTYOVERRIDEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B767EE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtModifierPropertyOverrideData_TypeDefinitionIndex = 23329;
