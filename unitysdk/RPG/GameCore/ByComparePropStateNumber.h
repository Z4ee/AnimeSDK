...
#define RPG_GAMECORE_BYCOMPAREPROPSTATENUMBER_METHOD_4_2716ECF2CB1C354B_OFFSET UNITYSDK_OFFSET(0x1CEF3780)
#define RPG_GAMECORE_BYCOMPAREPROPSTATENUMBER_METHOD_4_27902ED612432387_OFFSET UNITYSDK_OFFSET(0x1CEF3A80)
#define RPG_GAMECORE_BYCOMPAREPROPSTATENUMBER_METHOD_4_3630FDCB3FF92690_OFFSET UNITYSDK_OFFSET(0x1CEF3AB0)
#define RPG_GAMECORE_BYCOMPAREPROPSTATENUMBER_METHOD_4_C18CC9D627BC6B6D_OFFSET UNITYSDK_OFFSET(0x1CEF37C0)
#define RPG_GAMECORE_BYCOMPAREPROPSTATENUMBER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEF37B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByComparePropStateNumber_TypeDefinitionIndex = 21444;
