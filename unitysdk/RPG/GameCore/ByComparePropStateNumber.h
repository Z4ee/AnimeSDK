...
#define RPG_GAMECORE_BYCOMPAREPROPSTATENUMBER_METHOD_4_1A9620254B567FF7_OFFSET UNITYSDK_OFFSET(0x17013B00)
#define RPG_GAMECORE_BYCOMPAREPROPSTATENUMBER_METHOD_4_C2B5ED2957453D91_OFFSET UNITYSDK_OFFSET(0x17013BD0)
#define RPG_GAMECORE_BYCOMPAREPROPSTATENUMBER__CTOR_OFFSET UNITYSDK_OFFSET(0x17013B80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByComparePropStateNumber_TypeDefinitionIndex = 19856;
