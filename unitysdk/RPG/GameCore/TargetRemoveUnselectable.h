...
#define RPG_GAMECORE_TARGETREMOVEUNSELECTABLE_METHOD_3_37993F1E318B082C_OFFSET UNITYSDK_OFFSET(0x1D0C4F90)
#define RPG_GAMECORE_TARGETREMOVEUNSELECTABLE_METHOD_3_3F93DE41B5B6B853_OFFSET UNITYSDK_OFFSET(0x1D0C4FF0)
#define RPG_GAMECORE_TARGETREMOVEUNSELECTABLE_METHOD_3_9AE7877D22D31241_OFFSET UNITYSDK_OFFSET(0x1D0C4F10)
#define RPG_GAMECORE_TARGETREMOVEUNSELECTABLE_METHOD_3_CA0752CA223A31A6_OFFSET UNITYSDK_OFFSET(0x1D0C5010)
#define RPG_GAMECORE_TARGETREMOVEUNSELECTABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0C4F80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetRemoveUnselectable_TypeDefinitionIndex = 23049;
