...
#define RPG_GAMECORE_TARGETREMOVEUNSELECTABLE_METHOD_3_37993F1E318B082C_OFFSET UNITYSDK_OFFSET(0x18EEA3B0)
#define RPG_GAMECORE_TARGETREMOVEUNSELECTABLE_METHOD_3_61F362D73B8DE975_OFFSET UNITYSDK_OFFSET(0x18EEA2F0)
#define RPG_GAMECORE_TARGETREMOVEUNSELECTABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x18EEA390)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetRemoveUnselectable_TypeDefinitionIndex = 22895;
