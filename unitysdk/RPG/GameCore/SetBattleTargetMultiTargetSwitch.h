...
#define RPG_GAMECORE_SETBATTLETARGETMULTITARGETSWITCH_METHOD_3_16BD004E14000737_OFFSET UNITYSDK_OFFSET(0x1C2D5540)
#define RPG_GAMECORE_SETBATTLETARGETMULTITARGETSWITCH_METHOD_3_F4E9D422A4DFD1FC_OFFSET UNITYSDK_OFFSET(0x1C2D5500)
#define RPG_GAMECORE_SETBATTLETARGETMULTITARGETSWITCH__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2D5530)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetBattleTargetMultiTargetSwitch_TypeDefinitionIndex = 22352;
