...
#define RPG_GAMECORE_SETBATTLETARGETMULTITARGETSWITCH_METHOD_3_16BD004E14000737_OFFSET UNITYSDK_OFFSET(0x18E0D260)
#define RPG_GAMECORE_SETBATTLETARGETMULTITARGETSWITCH_METHOD_3_EEC9FD3B64888686_OFFSET UNITYSDK_OFFSET(0x18E0D1E0)
#define RPG_GAMECORE_SETBATTLETARGETMULTITARGETSWITCH__CTOR_OFFSET UNITYSDK_OFFSET(0x18E0D230)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetBattleTargetMultiTargetSwitch_TypeDefinitionIndex = 22138;
