...
#define RPG_GAMECORE_TRAINPARTYAREACONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D5DA550)
#define RPG_GAMECORE_TRAINPARTYAREACONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5DA920)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyAreaConfigRow_TypeDefinitionIndex = 15154;

	class TrainPartyAreaConfigRow : public ::System::Object
	{
	public:
		::Il2CppArray<::System::String*>* HiddenBlockList; // 0x10
		...
		::System::Boolean IsShowInActivity; // 0x38
		::RPG::Client::TextID Name; // 0x40
		::System::UInt32 FirstStep; // 0x50
