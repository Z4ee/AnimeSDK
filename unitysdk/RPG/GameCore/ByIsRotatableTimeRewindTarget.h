...
#define RPG_GAMECORE_BYISROTATABLETIMEREWINDTARGET_METHOD_4_49657812382DAA58_OFFSET UNITYSDK_OFFSET(0x170326D0)
#define RPG_GAMECORE_BYISROTATABLETIMEREWINDTARGET_METHOD_4_F0EA30E74198AA76_OFFSET UNITYSDK_OFFSET(0x17032600)
#define RPG_GAMECORE_BYISROTATABLETIMEREWINDTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x17032680)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsRotatableTimeRewindTarget_TypeDefinitionIndex = 18988;
