...
#define RPG_GAMECORE_GAMEMODEFUNCENTRANCEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x197C92B0)
#define RPG_GAMECORE_GAMEMODEFUNCENTRANCEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x197C93F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GameModeFuncEntranceRow_TypeDefinitionIndex = 12678;
	...
	public:
		...
		::System::UInt32 BranchLineFuncEntranceListID; // 0x18
