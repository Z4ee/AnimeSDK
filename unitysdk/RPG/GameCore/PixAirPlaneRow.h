...
#define RPG_GAMECORE_PIXAIRPLANEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D337C10)
#define RPG_GAMECORE_PIXAIRPLANEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3381B0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* LargePlaneIconPath; // 0x28
		::System::String* PlaneIconPath; // 0x30
		...
		::System::UInt32 UnlockScore; // 0x64
		::System::UInt32 GrantBySubmissionID; // 0x68
		::System::Boolean IsSelectable; // 0x6C
		::System::UInt32 BaseLife; // 0x70
		::System::UInt32 BaseHP; // 0x74
