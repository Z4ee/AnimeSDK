...
#define RPG_GAMECORE_FORMATSTRING_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x22ACE50)
#define RPG_GAMECORE_FORMATSTRING_EQUALS_2_OFFSET UNITYSDK_OFFSET(0x22BB780)
#define RPG_GAMECORE_FORMATSTRING_EQUALS_OFFSET UNITYSDK_OFFSET(0x22ACE50)
#define RPG_GAMECORE_FORMATSTRING_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x22BB800)
#define RPG_GAMECORE_FORMATSTRING_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x22BB740)
#define RPG_GAMECORE_FORMATSTRING_GET_RAWSTRING_OFFSET UNITYSDK_OFFSET(0x5580)
#define RPG_GAMECORE_FORMATSTRING_METHOD_2_188EEAAB5C523CC8_OFFSET UNITYSDK_OFFSET(0x1892A1A0)
#define RPG_GAMECORE_FORMATSTRING_METHOD_2_2ED2786CBF32344F_OFFSET UNITYSDK_OFFSET(0x1892A210)
#define RPG_GAMECORE_FORMATSTRING_METHOD_2_553F65DA53A86C11_OFFSET UNITYSDK_OFFSET(0x1892A280)
#define RPG_GAMECORE_FORMATSTRING_METHOD_2_737FB5FD0C118D8F_OFFSET UNITYSDK_OFFSET(0x1892A2B0)
#define RPG_GAMECORE_FORMATSTRING_METHOD_2_D964DB46312B7B08_OFFSET UNITYSDK_OFFSET(0x1892A1D0)
#define RPG_GAMECORE_FORMATSTRING_METHOD_2_E6ABB66B71544341_OFFSET UNITYSDK_OFFSET(0x1892A240)
#define RPG_GAMECORE_FORMATSTRING_TOSTRING_OFFSET UNITYSDK_OFFSET(0x5580)
#define RPG_GAMECORE_FORMATSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x22BB760)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FormatString_TypeDefinitionIndex = 23581;
