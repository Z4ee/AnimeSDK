...
#define RPG_GAMECORE_FORMATSTRING_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x397D250)
#define RPG_GAMECORE_FORMATSTRING_EQUALS_2_OFFSET UNITYSDK_OFFSET(0x3A660D0)
#define RPG_GAMECORE_FORMATSTRING_EQUALS_OFFSET UNITYSDK_OFFSET(0x397D250)
#define RPG_GAMECORE_FORMATSTRING_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3A66150)
#define RPG_GAMECORE_FORMATSTRING_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x3A66090)
#define RPG_GAMECORE_FORMATSTRING_GET_RAWSTRING_OFFSET UNITYSDK_OFFSET(0x1651A0)
#define RPG_GAMECORE_FORMATSTRING_METHOD_2_188EEAAB5C523CC8_OFFSET UNITYSDK_OFFSET(0x1BEC0220)
#define RPG_GAMECORE_FORMATSTRING_METHOD_2_2ED2786CBF32344F_OFFSET UNITYSDK_OFFSET(0x1BEC0290)
#define RPG_GAMECORE_FORMATSTRING_METHOD_2_553F65DA53A86C11_OFFSET UNITYSDK_OFFSET(0x1BEC0300)
#define RPG_GAMECORE_FORMATSTRING_METHOD_2_737FB5FD0C118D8F_OFFSET UNITYSDK_OFFSET(0x1BEC0330)
#define RPG_GAMECORE_FORMATSTRING_METHOD_2_D964DB46312B7B08_OFFSET UNITYSDK_OFFSET(0x1BEC0250)
#define RPG_GAMECORE_FORMATSTRING_METHOD_2_E6ABB66B71544341_OFFSET UNITYSDK_OFFSET(0x1BEC02C0)
#define RPG_GAMECORE_FORMATSTRING_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1651A0)
#define RPG_GAMECORE_FORMATSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x3A660B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FormatString_TypeDefinitionIndex = 10507;
