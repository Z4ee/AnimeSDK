...
#define RPG_GAMECORE_SHOWUINODES_METHOD_3_4412D9AC8C7B0047_OFFSET UNITYSDK_OFFSET(0x177070A0)
#define RPG_GAMECORE_SHOWUINODES_METHOD_3_B7BDEEEC40FEC349_OFFSET UNITYSDK_OFFSET(0x17707120)
#define RPG_GAMECORE_SHOWUINODES__CTOR_OFFSET UNITYSDK_OFFSET(0x177070F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowUINodes_TypeDefinitionIndex = 22376;
