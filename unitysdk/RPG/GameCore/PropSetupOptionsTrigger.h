...
#define RPG_GAMECORE_PROPSETUPOPTIONSTRIGGER_METHOD_3_9B809C0656BB438D_OFFSET UNITYSDK_OFFSET(0x17526600)
#define RPG_GAMECORE_PROPSETUPOPTIONSTRIGGER_METHOD_3_A368E1FED7E71A57_OFFSET UNITYSDK_OFFSET(0x17526750)
#define RPG_GAMECORE_PROPSETUPOPTIONSTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x175266C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropSetupOptionsTrigger_TypeDefinitionIndex = 19753;
