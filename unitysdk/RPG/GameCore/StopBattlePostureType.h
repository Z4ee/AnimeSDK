...
#define RPG_GAMECORE_STOPBATTLEPOSTURETYPE_METHOD_3_4A0DD9E230B05D41_OFFSET UNITYSDK_OFFSET(0x1777C9A0)
#define RPG_GAMECORE_STOPBATTLEPOSTURETYPE_METHOD_3_D5EF567A0AA7B255_OFFSET UNITYSDK_OFFSET(0x1777CAB0)
#define RPG_GAMECORE_STOPBATTLEPOSTURETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1777CA80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StopBattlePostureType_TypeDefinitionIndex = 18749;
