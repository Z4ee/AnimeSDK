...
#define RPG_GAMECORE_ROGUENOUSSUBSTORYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D408D80)
#define RPG_GAMECORE_ROGUENOUSSUBSTORYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D409640)
