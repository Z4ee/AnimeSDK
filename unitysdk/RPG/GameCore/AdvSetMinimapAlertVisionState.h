...
#define RPG_GAMECORE_ADVSETMINIMAPALERTVISIONSTATE_METHOD_3_52B45BE3A3531C68_OFFSET UNITYSDK_OFFSET(0x18663B80)
#define RPG_GAMECORE_ADVSETMINIMAPALERTVISIONSTATE_METHOD_3_B8941B45AD77DFEF_OFFSET UNITYSDK_OFFSET(0x18663CD0)
#define RPG_GAMECORE_ADVSETMINIMAPALERTVISIONSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18663C40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSetMinimapAlertVisionState_TypeDefinitionIndex = 19507;
