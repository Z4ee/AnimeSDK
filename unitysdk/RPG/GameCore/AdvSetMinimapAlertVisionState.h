...
#define RPG_GAMECORE_ADVSETMINIMAPALERTVISIONSTATE_METHOD_3_4EA832862FE4BC25_OFFSET UNITYSDK_OFFSET(0x1BE2D9F0)
#define RPG_GAMECORE_ADVSETMINIMAPALERTVISIONSTATE_METHOD_3_B8941B45AD77DFEF_OFFSET UNITYSDK_OFFSET(0x1BE2DA70)
#define RPG_GAMECORE_ADVSETMINIMAPALERTVISIONSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE2DA40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSetMinimapAlertVisionState_TypeDefinitionIndex = 19760;
