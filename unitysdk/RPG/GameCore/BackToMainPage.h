...
#define RPG_GAMECORE_BACKTOMAINPAGE_METHOD_3_9CF19AE80304114E_OFFSET UNITYSDK_OFFSET(0x186E5900)
#define RPG_GAMECORE_BACKTOMAINPAGE_METHOD_3_B8B467F4A7AAF99F_OFFSET UNITYSDK_OFFSET(0x186E5880)
#define RPG_GAMECORE_BACKTOMAINPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x186E58D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BackToMainPage_TypeDefinitionIndex = 23386;
