...
#define RPG_GAMECORE_BACKTOMAINPAGE_METHOD_3_6EB199B8EB23318D_OFFSET UNITYSDK_OFFSET(0x1A3DB4C0)
#define RPG_GAMECORE_BACKTOMAINPAGE_METHOD_3_9CF19AE80304114E_OFFSET UNITYSDK_OFFSET(0x1A3DB500)
#define RPG_GAMECORE_BACKTOMAINPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3DB4F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BackToMainPage_TypeDefinitionIndex = 23511;
