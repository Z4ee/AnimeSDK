...
#define RPG_GAMECORE_BACKTOMAINPAGE_METHOD_3_9CF19AE80304114E_OFFSET UNITYSDK_OFFSET(0x194B8FC0)
#define RPG_GAMECORE_BACKTOMAINPAGE_METHOD_3_B8B467F4A7AAF99F_OFFSET UNITYSDK_OFFSET(0x194B8F40)
#define RPG_GAMECORE_BACKTOMAINPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x194B8F90)
