...
#define RPG_GAMECORE_EVOLVEBUILDGEARMANAGER_EARLYACCESSSTRATEGY_GET_GEARMGR_OFFSET UNITYSDK_OFFSET(0x1157B1E0)
#define RPG_GAMECORE_EVOLVEBUILDGEARMANAGER_EARLYACCESSSTRATEGY_GET_GEARSELECTPAGEFILENAME_OFFSET UNITYSDK_OFFSET(0x1157B550)
#define RPG_GAMECORE_EVOLVEBUILDGEARMANAGER_EARLYACCESSSTRATEGY_GET_GEARSELECTPAGEPATH_OFFSET UNITYSDK_OFFSET(0x1157B510)
#define RPG_GAMECORE_EVOLVEBUILDGEARMANAGER_EARLYACCESSSTRATEGY_GET_PAUSECONFIG_OFFSET UNITYSDK_OFFSET(0x1157B680)
#define RPG_GAMECORE_EVOLVEBUILDGEARMANAGER_EARLYACCESSSTRATEGY_GET_PROGRESSPAGEPATH_OFFSET UNITYSDK_OFFSET(0x1157B640)
#define RPG_GAMECORE_EVOLVEBUILDGEARMANAGER_EARLYACCESSSTRATEGY_GET_SEASON_OFFSET UNITYSDK_OFFSET(0x1157B6C0)
#define RPG_GAMECORE_EVOLVEBUILDGEARMANAGER_EARLYACCESSSTRATEGY_GET_SORTVISITOR_OFFSET UNITYSDK_OFFSET(0x1157B6E0)
#define RPG_GAMECORE_EVOLVEBUILDGEARMANAGER_EARLYACCESSSTRATEGY_GET_TREASURESTRATEGY_OFFSET UNITYSDK_OFFSET(0x1157B6B0)
#define RPG_GAMECORE_EVOLVEBUILDGEARMANAGER_EARLYACCESSSTRATEGY_SET_GEARMGR_OFFSET UNITYSDK_OFFSET(0x1157B1F0)
#define RPG_GAMECORE_EVOLVEBUILDGEARMANAGER_EARLYACCESSSTRATEGY_SET_PAUSECONFIG_OFFSET UNITYSDK_OFFSET(0x1157B6A0)
#define RPG_GAMECORE_EVOLVEBUILDGEARMANAGER_EARLYACCESSSTRATEGY_SHOWCARDSELECTDIALOG_OFFSET UNITYSDK_OFFSET(0x1157B200)
#define RPG_GAMECORE_EVOLVEBUILDGEARMANAGER_EARLYACCESSSTRATEGY_SHOWPHASERESULTUI_OFFSET UNITYSDK_OFFSET(0x1157B4C0)
#define RPG_GAMECORE_EVOLVEBUILDGEARMANAGER_EARLYACCESSSTRATEGY__CONVERTWEIGHTINDEXTOSELECTPRIORITY_OFFSET UNITYSDK_OFFSET(0x1157A760)
#define RPG_GAMECORE_EVOLVEBUILDGEARMANAGER_EARLYACCESSSTRATEGY__CTOR_OFFSET UNITYSDK_OFFSET(0x1156E880)
#define RPG_GAMECORE_EVOLVEBUILDGEARMANAGER_EARLYACCESSSTRATEGY__FILLCARDSELECTINFO_OFFSET UNITYSDK_OFFSET(0x1157A7C0)
#define RPG_GAMECORE_EVOLVEBUILDGEARMANAGER_EARLYACCESSSTRATEGY__GENGEARWEIGHTDICT_OFFSET UNITYSDK_OFFSET(0x11579EA0)
#define RPG_GAMECORE_EVOLVEBUILDGEARMANAGER_EARLYACCESSSTRATEGY__GETGEARWEIGHTINDEX_OFFSET UNITYSDK_OFFSET(0x1157A2F0)
#define RPG_GAMECORE_EVOLVEBUILDGEARMANAGER_EARLYACCESSSTRATEGY__GETGEARWEIGHT_1_OFFSET UNITYSDK_OFFSET(0x1157A6F0)
#define RPG_GAMECORE_EVOLVEBUILDGEARMANAGER_EARLYACCESSSTRATEGY__GETGEARWEIGHT_OFFSET UNITYSDK_OFFSET(0x1157A230)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Class_0_16E4307DCC419505_466* _SortVisitor; // 0x38
