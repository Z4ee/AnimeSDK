...
#define RPG_GAMECORE_EVOLVEBUILDGEARMANAGER_EARLYACCESSSTRATEGY_GET_GEARMGR_OFFSET UNITYSDK_OFFSET(0xA9325B0)
#define RPG_GAMECORE_EVOLVEBUILDGEARMANAGER_EARLYACCESSSTRATEGY_GET_GEARSELECTPAGEFILENAME_OFFSET UNITYSDK_OFFSET(0xA9328F0)
#define RPG_GAMECORE_EVOLVEBUILDGEARMANAGER_EARLYACCESSSTRATEGY_GET_GEARSELECTPAGEPATH_OFFSET UNITYSDK_OFFSET(0xA9328B0)
#define RPG_GAMECORE_EVOLVEBUILDGEARMANAGER_EARLYACCESSSTRATEGY_GET_PAUSECONFIG_OFFSET UNITYSDK_OFFSET(0xA932A40)
#define RPG_GAMECORE_EVOLVEBUILDGEARMANAGER_EARLYACCESSSTRATEGY_GET_PROGRESSPAGEPATH_OFFSET UNITYSDK_OFFSET(0xA932A00)
#define RPG_GAMECORE_EVOLVEBUILDGEARMANAGER_EARLYACCESSSTRATEGY_GET_SEASON_OFFSET UNITYSDK_OFFSET(0xA932A80)
#define RPG_GAMECORE_EVOLVEBUILDGEARMANAGER_EARLYACCESSSTRATEGY_GET_SORTVISITOR_OFFSET UNITYSDK_OFFSET(0xA932AA0)
#define RPG_GAMECORE_EVOLVEBUILDGEARMANAGER_EARLYACCESSSTRATEGY_GET_TREASURESTRATEGY_OFFSET UNITYSDK_OFFSET(0xA932A70)
#define RPG_GAMECORE_EVOLVEBUILDGEARMANAGER_EARLYACCESSSTRATEGY_SET_GEARMGR_OFFSET UNITYSDK_OFFSET(0xA9325C0)
#define RPG_GAMECORE_EVOLVEBUILDGEARMANAGER_EARLYACCESSSTRATEGY_SET_PAUSECONFIG_OFFSET UNITYSDK_OFFSET(0xA932A60)
#define RPG_GAMECORE_EVOLVEBUILDGEARMANAGER_EARLYACCESSSTRATEGY_SHOWCARDSELECTDIALOG_OFFSET UNITYSDK_OFFSET(0xA9325D0)
#define RPG_GAMECORE_EVOLVEBUILDGEARMANAGER_EARLYACCESSSTRATEGY_SHOWPHASERESULTUI_OFFSET UNITYSDK_OFFSET(0xA932860)
#define RPG_GAMECORE_EVOLVEBUILDGEARMANAGER_EARLYACCESSSTRATEGY__CONVERTWEIGHTINDEXTOSELECTPRIORITY_OFFSET UNITYSDK_OFFSET(0xA931F20)
#define RPG_GAMECORE_EVOLVEBUILDGEARMANAGER_EARLYACCESSSTRATEGY__CTOR_OFFSET UNITYSDK_OFFSET(0xA927000)
#define RPG_GAMECORE_EVOLVEBUILDGEARMANAGER_EARLYACCESSSTRATEGY__FILLCARDSELECTINFO_OFFSET UNITYSDK_OFFSET(0xA931F80)
#define RPG_GAMECORE_EVOLVEBUILDGEARMANAGER_EARLYACCESSSTRATEGY__GENGEARWEIGHTDICT_OFFSET UNITYSDK_OFFSET(0xA931790)
#define RPG_GAMECORE_EVOLVEBUILDGEARMANAGER_EARLYACCESSSTRATEGY__GETGEARWEIGHTINDEX_OFFSET UNITYSDK_OFFSET(0xA931AA0)
#define RPG_GAMECORE_EVOLVEBUILDGEARMANAGER_EARLYACCESSSTRATEGY__GETGEARWEIGHT_1_OFFSET UNITYSDK_OFFSET(0xA931EB0)
#define RPG_GAMECORE_EVOLVEBUILDGEARMANAGER_EARLYACCESSSTRATEGY__GETGEARWEIGHT_OFFSET UNITYSDK_OFFSET(0xA9319E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EvolveBuildGearManager_EarlyAccessStrategy_TypeDefinitionIndex = 44911;
	...
	public:
		...
		::Class_0_16E4307DCC419505_381* _SortVisitor; // 0x38
		...
		{
			return ((::RPG::Client::UIController*(*)(::PVOID, ::Class_1_C9DFE5EE7107C629_4*))((::PBYTE)hIl2Cpp + RPG_GAMECORE_EVOLVEBUILDGEARMANAGER_EARLYACCESSSTRATEGY_SHOWPHASERESULTUI_OFFSET))(this, levelInfo);
		}
		...
		{
			return ((::Class_0_16E4307DCC419505_381*(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_GAMECORE_EVOLVEBUILDGEARMANAGER_EARLYACCESSSTRATEGY_GET_SORTVISITOR_OFFSET))(this);
		}
	};
}
