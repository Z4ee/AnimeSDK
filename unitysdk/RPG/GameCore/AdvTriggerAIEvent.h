...
#define RPG_GAMECORE_ADVTRIGGERAIEVENT_METHOD_3_46DB1183C99BC81A_OFFSET UNITYSDK_OFFSET(0x16F45840)
#define RPG_GAMECORE_ADVTRIGGERAIEVENT_METHOD_3_AA1268C0A3062A81_OFFSET UNITYSDK_OFFSET(0x16F458C0)
#define RPG_GAMECORE_ADVTRIGGERAIEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x16F45890)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvTriggerAIEvent_TypeDefinitionIndex = 21616;
