...
#define RPG_GAMECORE_ADVTRIGGERAIEVENT_METHOD_3_46DB1183C99BC81A_OFFSET UNITYSDK_OFFSET(0x18667A00)
#define RPG_GAMECORE_ADVTRIGGERAIEVENT_METHOD_3_AA1268C0A3062A81_OFFSET UNITYSDK_OFFSET(0x18667A80)
#define RPG_GAMECORE_ADVTRIGGERAIEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x18667A50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvTriggerAIEvent_TypeDefinitionIndex = 22354;
