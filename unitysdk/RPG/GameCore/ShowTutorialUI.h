...
#define RPG_GAMECORE_SHOWTUTORIALUI_METHOD_3_592AA79B315CA72A_OFFSET UNITYSDK_OFFSET(0x18E6A1A0)
#define RPG_GAMECORE_SHOWTUTORIALUI_METHOD_3_8D5C898FD9B9267B_OFFSET UNITYSDK_OFFSET(0x18E6A120)
#define RPG_GAMECORE_SHOWTUTORIALUI__CTOR_OFFSET UNITYSDK_OFFSET(0x18E6A170)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowTutorialUI_TypeDefinitionIndex = 19879;
