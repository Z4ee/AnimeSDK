...
#define RPG_GAMECORE_DYNAMICVALUERANGECALLBACK_METHOD_2_4985D1D9745312B6_OFFSET UNITYSDK_OFFSET(0x1DB1FCF0)
#define RPG_GAMECORE_DYNAMICVALUERANGECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB20180)
