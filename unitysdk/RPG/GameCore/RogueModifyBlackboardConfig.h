...
#define RPG_GAMECORE_ROGUEMODIFYBLACKBOARDCONFIG_METHOD_2_DBC13D0961A21C97_OFFSET UNITYSDK_OFFSET(0x18D477C0)
#define RPG_GAMECORE_ROGUEMODIFYBLACKBOARDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D47800)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifyBlackboardConfig_TypeDefinitionIndex = 18780;
