...
#define RPG_GAMECORE_CHARACTERATLASFACEEYESHAPEGROUP_METHOD_2_58785B5A8BFEE495_OFFSET UNITYSDK_OFFSET(0x1D11A510)
#define RPG_GAMECORE_CHARACTERATLASFACEEYESHAPEGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D11A5D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterAtlasFaceEyeShapeGroup_TypeDefinitionIndex = 17258;
