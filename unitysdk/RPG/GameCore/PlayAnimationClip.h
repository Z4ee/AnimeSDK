...
#define RPG_GAMECORE_PLAYANIMATIONCLIP_METHOD_3_30210606B87C53CC_OFFSET UNITYSDK_OFFSET(0x18C0C8A0)
#define RPG_GAMECORE_PLAYANIMATIONCLIP_METHOD_3_49EA3C5581A120DA_OFFSET UNITYSDK_OFFSET(0x18C0C820)
#define RPG_GAMECORE_PLAYANIMATIONCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x18C0C870)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayAnimationClip_TypeDefinitionIndex = 19223;
