...
#define RPG_GAMECORE_PLAYANIMATIONCLIP_METHOD_3_30210606B87C53CC_OFFSET UNITYSDK_OFFSET(0x1D7A3680)
#define RPG_GAMECORE_PLAYANIMATIONCLIP_METHOD_3_4E368E6CFE56A4AB_OFFSET UNITYSDK_OFFSET(0x1D7A3640)
#define RPG_GAMECORE_PLAYANIMATIONCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7A3670)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayAnimationClip_TypeDefinitionIndex = 20046;
