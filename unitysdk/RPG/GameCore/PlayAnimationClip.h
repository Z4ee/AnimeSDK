...
#define RPG_GAMECORE_PLAYANIMATIONCLIP_METHOD_3_30210606B87C53CC_OFFSET UNITYSDK_OFFSET(0x19A23870)
#define RPG_GAMECORE_PLAYANIMATIONCLIP_METHOD_3_49EA3C5581A120DA_OFFSET UNITYSDK_OFFSET(0x19A237F0)
#define RPG_GAMECORE_PLAYANIMATIONCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x19A23840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayAnimationClip_TypeDefinitionIndex = 19144;
