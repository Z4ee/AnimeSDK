...
#define RPG_GAMECORE_SETAVATARGLOBALBUFFSTATE_METHOD_3_80EEA91EA1AC25F7_OFFSET UNITYSDK_OFFSET(0x176A8700)
#define RPG_GAMECORE_SETAVATARGLOBALBUFFSTATE_METHOD_3_8438FE30B97B73AF_OFFSET UNITYSDK_OFFSET(0x176A85E0)
#define RPG_GAMECORE_SETAVATARGLOBALBUFFSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x176A8680)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetAvatarGlobalBuffState_TypeDefinitionIndex = 20930;
