...
#define RPG_GAMECORE_SETAVATARGLOBALBUFFSTATE_METHOD_3_80EEA91EA1AC25F7_OFFSET UNITYSDK_OFFSET(0x18E0B200)
#define RPG_GAMECORE_SETAVATARGLOBALBUFFSTATE_METHOD_3_8438FE30B97B73AF_OFFSET UNITYSDK_OFFSET(0x18E0B0E0)
#define RPG_GAMECORE_SETAVATARGLOBALBUFFSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E0B180)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetAvatarGlobalBuffState_TypeDefinitionIndex = 21641;
