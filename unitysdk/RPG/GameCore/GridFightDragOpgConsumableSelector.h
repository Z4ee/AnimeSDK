...
#define RPG_GAMECORE_GRIDFIGHTDRAGOPGCONSUMABLESELECTOR_METHOD_3_C5BCBAE1CD2436B7_OFFSET UNITYSDK_OFFSET(0x189A8C80)
#define RPG_GAMECORE_GRIDFIGHTDRAGOPGCONSUMABLESELECTOR_METHOD_3_F4F7405CC63BE4BB_OFFSET UNITYSDK_OFFSET(0x189A8DC0)
#define RPG_GAMECORE_GRIDFIGHTDRAGOPGCONSUMABLESELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x189A8C70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightDragOpgConsumableSelector_TypeDefinitionIndex = 18876;
