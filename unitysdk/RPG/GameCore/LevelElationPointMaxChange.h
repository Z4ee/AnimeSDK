...
#define RPG_GAMECORE_LEVELELATIONPOINTMAXCHANGE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xB6D59D0)
#define RPG_GAMECORE_LEVELELATIONPOINTMAXCHANGE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xB6D5980)
#define RPG_GAMECORE_LEVELELATIONPOINTMAXCHANGE_INIT_OFFSET UNITYSDK_OFFSET(0xB6D5900)
#define RPG_GAMECORE_LEVELELATIONPOINTMAXCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0xB6D5A20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelElationPointMaxChange_TypeDefinitionIndex = 52307;
