...
#define RPG_GAMECORE_LEVELELATIONPOINTMAXCHANGE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1BDFA000)
#define RPG_GAMECORE_LEVELELATIONPOINTMAXCHANGE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x1BDF9FB0)
#define RPG_GAMECORE_LEVELELATIONPOINTMAXCHANGE_INIT_OFFSET UNITYSDK_OFFSET(0x1BDF9F30)
#define RPG_GAMECORE_LEVELELATIONPOINTMAXCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDFA050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelElationPointMaxChange_TypeDefinitionIndex = 54217;
