...
#define RPG_GAMECORE_FIVEDIMSETRENDERINGITEMSTATEACTION_METHOD_3_5FD7B047132C7181_OFFSET UNITYSDK_OFFSET(0x1BEB1F10)
#define RPG_GAMECORE_FIVEDIMSETRENDERINGITEMSTATEACTION_METHOD_3_8999D03DFD421236_OFFSET UNITYSDK_OFFSET(0x1BEB1F50)
#define RPG_GAMECORE_FIVEDIMSETRENDERINGITEMSTATEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEB1F40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSetRenderingItemStateAction_TypeDefinitionIndex = 17963;
