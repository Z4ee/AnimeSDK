...
#define RPG_GAMECORE_FIVEDIMSETRENDERINGITEMSTATEACTION_METHOD_3_449B007783556A73_OFFSET UNITYSDK_OFFSET(0x197560D0)
#define RPG_GAMECORE_FIVEDIMSETRENDERINGITEMSTATEACTION_METHOD_3_8999D03DFD421236_OFFSET UNITYSDK_OFFSET(0x19756140)
#define RPG_GAMECORE_FIVEDIMSETRENDERINGITEMSTATEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19756120)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSetRenderingItemStateAction_TypeDefinitionIndex = 17787;
