...
#define RPG_GAMECORE_NOTIFYSHOWFUNCBTNPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xE6B7610)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Boolean ShowBtnFuncHint; // 0x2C
		::System::Boolean ShowBtnEffect; // 0x2D
		::System::Single CDDuration; // 0x30
