...
#define RPG_GAMECORE_GRIDFIGHTACTIONADDPOSCNTCONFIG_METHOD_6_619700563B8CD398_OFFSET UNITYSDK_OFFSET(0x1899DA60)
#define RPG_GAMECORE_GRIDFIGHTACTIONADDPOSCNTCONFIG_METHOD_6_621EE1C5E7A75233_OFFSET UNITYSDK_OFFSET(0x1899D8F0)
#define RPG_GAMECORE_GRIDFIGHTACTIONADDPOSCNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1899D9C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightActionAddPosCntConfig_TypeDefinitionIndex = 18347;
