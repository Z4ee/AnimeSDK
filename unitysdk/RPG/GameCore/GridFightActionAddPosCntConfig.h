...
#define RPG_GAMECORE_GRIDFIGHTACTIONADDPOSCNTCONFIG_METHOD_6_619700563B8CD398_OFFSET UNITYSDK_OFFSET(0x1724E2B0)
#define RPG_GAMECORE_GRIDFIGHTACTIONADDPOSCNTCONFIG_METHOD_6_621EE1C5E7A75233_OFFSET UNITYSDK_OFFSET(0x1724E140)
#define RPG_GAMECORE_GRIDFIGHTACTIONADDPOSCNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1724E210)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightActionAddPosCntConfig_TypeDefinitionIndex = 17734;
