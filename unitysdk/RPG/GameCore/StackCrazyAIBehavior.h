...
#define RPG_GAMECORE_STACKCRAZYAIBEHAVIOR_METHOD_3_7A109694F3AECAD8_OFFSET UNITYSDK_OFFSET(0x1B0A5350)
#define RPG_GAMECORE_STACKCRAZYAIBEHAVIOR_METHOD_3_C76A6F5115B00235_OFFSET UNITYSDK_OFFSET(0x1B0A5310)
#define RPG_GAMECORE_STACKCRAZYAIBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0A5340)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StackCrazyAIBehavior_TypeDefinitionIndex = 22791;
