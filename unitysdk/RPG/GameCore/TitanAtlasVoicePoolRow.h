...
#define RPG_GAMECORE_TITANATLASVOICEPOOLROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D52A900)
#define RPG_GAMECORE_TITANATLASVOICEPOOLROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D52AA90)
