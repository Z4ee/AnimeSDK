...
#define RPG_GAMECORE_SPRITEPRESETRECORD_METHOD_2_491D3F7FADDC2F1E_OFFSET UNITYSDK_OFFSET(0x1D0B7750)
#define RPG_GAMECORE_SPRITEPRESETRECORD_METHOD_2_FCB4408EFD8703A6_OFFSET UNITYSDK_OFFSET(0x1D0B75A0)
#define RPG_GAMECORE_SPRITEPRESETRECORD__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0B7740)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SpritePresetRecord_TypeDefinitionIndex = 24140;
