...
#define RPG_GAMECORE_SPRITEPRESETRECORD_METHOD_2_491D3F7FADDC2F1E_OFFSET UNITYSDK_OFFSET(0x1B0A4600)
#define RPG_GAMECORE_SPRITEPRESETRECORD_METHOD_2_FCB4408EFD8703A6_OFFSET UNITYSDK_OFFSET(0x1B0A4480)
#define RPG_GAMECORE_SPRITEPRESETRECORD__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0A45F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SpritePresetRecord_TypeDefinitionIndex = 23555;
