...
#define RPG_GAMECORE_SPRITEPRESETRECORD_METHOD_2_491D3F7FADDC2F1E_OFFSET UNITYSDK_OFFSET(0x19CA0810)
#define RPG_GAMECORE_SPRITEPRESETRECORD_METHOD_2_FCB4408EFD8703A6_OFFSET UNITYSDK_OFFSET(0x19CA0660)
#define RPG_GAMECORE_SPRITEPRESETRECORD__CTOR_OFFSET UNITYSDK_OFFSET(0x19CA0800)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SpritePresetRecord_TypeDefinitionIndex = 23088;
