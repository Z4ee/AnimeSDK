...
#define RPG_GAMECORE_LEVELGROUPRANDOMINITCONTROL_METHOD_2_9E0CC66326787510_OFFSET UNITYSDK_OFFSET(0x17339FD0)
#define RPG_GAMECORE_LEVELGROUPRANDOMINITCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1733A1F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelGroupRandomInitControl_TypeDefinitionIndex = 15910;
