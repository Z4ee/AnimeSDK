...
#define RPG_GAMECORE_ROGUETALKINFO_METHOD_2_EA8FA1687D32DA4F_OFFSET UNITYSDK_OFFSET(0x1765B3F0)
#define RPG_GAMECORE_ROGUETALKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1765B530)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTalkInfo_TypeDefinitionIndex = 19412;
