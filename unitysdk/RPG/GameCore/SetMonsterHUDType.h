...
#define RPG_GAMECORE_SETMONSTERHUDTYPE_METHOD_3_413959577DD5D5AB_OFFSET UNITYSDK_OFFSET(0x19C57B10)
#define RPG_GAMECORE_SETMONSTERHUDTYPE_METHOD_3_AB4C3F23F74160D8_OFFSET UNITYSDK_OFFSET(0x19C57B90)
#define RPG_GAMECORE_SETMONSTERHUDTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C57B60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetMonsterHUDType_TypeDefinitionIndex = 21525;
