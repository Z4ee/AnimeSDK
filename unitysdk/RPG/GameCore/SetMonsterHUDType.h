...
#define RPG_GAMECORE_SETMONSTERHUDTYPE_METHOD_3_413959577DD5D5AB_OFFSET UNITYSDK_OFFSET(0x176D7880)
#define RPG_GAMECORE_SETMONSTERHUDTYPE_METHOD_3_AB4C3F23F74160D8_OFFSET UNITYSDK_OFFSET(0x176D7900)
#define RPG_GAMECORE_SETMONSTERHUDTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x176D78D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetMonsterHUDType_TypeDefinitionIndex = 20960;
