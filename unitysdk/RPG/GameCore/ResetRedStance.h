...
#define RPG_GAMECORE_RESETREDSTANCE_METHOD_3_19E21C8491ADCDCD_OFFSET UNITYSDK_OFFSET(0x18CAAFE0)
#define RPG_GAMECORE_RESETREDSTANCE_METHOD_3_3A0351ED28D494BA_OFFSET UNITYSDK_OFFSET(0x18CAB070)
#define RPG_GAMECORE_RESETREDSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x18CAB040)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetRedStance_TypeDefinitionIndex = 21517;
