...
#define RPG_GAMECORE_CHIMERAABILITYDISPLAYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19632560)
#define RPG_GAMECORE_CHIMERAABILITYDISPLAYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19632770)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraAbilityDisplayRow_TypeDefinitionIndex = 12391;
