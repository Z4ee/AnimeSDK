...
#define RPG_GAMECORE_WOLFBROINTERRUPTALLPROJECTILES_METHOD_3_25674C7B01D8EFEC_OFFSET UNITYSDK_OFFSET(0x1790BF20)
#define RPG_GAMECORE_WOLFBROINTERRUPTALLPROJECTILES_METHOD_3_25D1E696116528DF_OFFSET UNITYSDK_OFFSET(0x1790C040)
#define RPG_GAMECORE_WOLFBROINTERRUPTALLPROJECTILES__CTOR_OFFSET UNITYSDK_OFFSET(0x1790BFC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WolfBroInterruptAllProjectiles_TypeDefinitionIndex = 19750;
