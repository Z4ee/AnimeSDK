...
#define RPG_GAMECORE_WOLFBROINTERRUPTALLPROJECTILES_METHOD_3_25674C7B01D8EFEC_OFFSET UNITYSDK_OFFSET(0x1910FE20)
#define RPG_GAMECORE_WOLFBROINTERRUPTALLPROJECTILES_METHOD_3_25D1E696116528DF_OFFSET UNITYSDK_OFFSET(0x1910FF40)
#define RPG_GAMECORE_WOLFBROINTERRUPTALLPROJECTILES__CTOR_OFFSET UNITYSDK_OFFSET(0x1910FEC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WolfBroInterruptAllProjectiles_TypeDefinitionIndex = 20431;
