...
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_ADDBOUNSATTACKRESOURCE_METHOD_3_7BE592FD120E3847_OFFSET UNITYSDK_OFFSET(0x1707D370)
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_ADDBOUNSATTACKRESOURCE_METHOD_3_DD6916D4CACAE6D6_OFFSET UNITYSDK_OFFSET(0x1707D410)
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_ADDBOUNSATTACKRESOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1707D400)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleEffect_AddBounsAttackResource_TypeDefinitionIndex = 14478;
