...
#define RPG_GAMECORE_ACTIVITYRAIDSPECIALORDERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19401A60)
#define RPG_GAMECORE_ACTIVITYRAIDSPECIALORDERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19401CD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityRaidSpecialOrderRow_TypeDefinitionIndex = 12033;
