...
#define RPG_GAMECORE_ACTIVITYRAIDSPECIALORDERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CDA6580)
#define RPG_GAMECORE_ACTIVITYRAIDSPECIALORDERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDA67F0)
