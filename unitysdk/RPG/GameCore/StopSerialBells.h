...
#define RPG_GAMECORE_STOPSERIALBELLS_METHOD_3_07CFE74849AB282D_OFFSET UNITYSDK_OFFSET(0x1D570310)
#define RPG_GAMECORE_STOPSERIALBELLS_METHOD_3_DD6ADC8F102473F0_OFFSET UNITYSDK_OFFSET(0x1D570240)
#define RPG_GAMECORE_STOPSERIALBELLS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D570300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StopSerialBells_TypeDefinitionIndex = 20313;
