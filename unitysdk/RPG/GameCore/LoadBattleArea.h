...
#define RPG_GAMECORE_LOADBATTLEAREA_METHOD_3_088E1855D0A6C7B4_OFFSET UNITYSDK_OFFSET(0x173639D0)
#define RPG_GAMECORE_LOADBATTLEAREA_METHOD_3_71886D9B8E928425_OFFSET UNITYSDK_OFFSET(0x17363A50)
#define RPG_GAMECORE_LOADBATTLEAREA__CTOR_OFFSET UNITYSDK_OFFSET(0x17363A20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoadBattleArea_TypeDefinitionIndex = 21554;
