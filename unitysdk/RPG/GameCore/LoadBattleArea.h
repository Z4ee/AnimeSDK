...
#define RPG_GAMECORE_LOADBATTLEAREA_METHOD_3_088E1855D0A6C7B4_OFFSET UNITYSDK_OFFSET(0x198A4E80)
#define RPG_GAMECORE_LOADBATTLEAREA_METHOD_3_71886D9B8E928425_OFFSET UNITYSDK_OFFSET(0x198A4F00)
#define RPG_GAMECORE_LOADBATTLEAREA__CTOR_OFFSET UNITYSDK_OFFSET(0x198A4ED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoadBattleArea_TypeDefinitionIndex = 22047;
