...
#define RPG_GAMECORE_LOADBATTLEAREA_METHOD_3_4C3AD656ADDCAEE6_OFFSET UNITYSDK_OFFSET(0x1D209400)
#define RPG_GAMECORE_LOADBATTLEAREA_METHOD_3_71886D9B8E928425_OFFSET UNITYSDK_OFFSET(0x1D209440)
#define RPG_GAMECORE_LOADBATTLEAREA__CTOR_OFFSET UNITYSDK_OFFSET(0x1D209430)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoadBattleArea_TypeDefinitionIndex = 23055;
