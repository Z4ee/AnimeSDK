...
#define RPG_GAMECORE_ACTIVITYFEVERTIMETUTORIALROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1AAF0BC0)
#define RPG_GAMECORE_ACTIVITYFEVERTIMETUTORIALROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAF1200)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityFeverTimeTutorialRow_TypeDefinitionIndex = 11186;
