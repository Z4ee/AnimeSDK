...
#define RPG_GAMECORE_HITDAMAGESPLIT_METHOD_3_5CD20063E4571FCD_OFFSET UNITYSDK_OFFSET(0x18A06270)
#define RPG_GAMECORE_HITDAMAGESPLIT_METHOD_3_B4D5534D92A33713_OFFSET UNITYSDK_OFFSET(0x18A06300)
#define RPG_GAMECORE_HITDAMAGESPLIT__CTOR_OFFSET UNITYSDK_OFFSET(0x18A062D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HitDamageSplit_TypeDefinitionIndex = 22549;
