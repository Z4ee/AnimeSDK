...
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_ISCHALLENGER_METHOD_4_06594E726F5C31B0_OFFSET UNITYSDK_OFFSET(0x1D032060)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_ISCHALLENGER_METHOD_4_32AE96DEC86109A9_OFFSET UNITYSDK_OFFSET(0x1D0334D0)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_ISCHALLENGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D032050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatPredicateConfig_IsChallenger_TypeDefinitionIndex = 15936;
