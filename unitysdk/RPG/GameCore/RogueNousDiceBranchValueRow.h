...
#define RPG_GAMECORE_ROGUENOUSDICEBRANCHVALUEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D16B4A0)
#define RPG_GAMECORE_ROGUENOUSDICEBRANCHVALUEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D16BBB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueNousDiceBranchValueRow_TypeDefinitionIndex = 14316;
