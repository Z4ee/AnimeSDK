...
#define RPG_GAMECORE_ROGUENOUSDICEBRANCHVALUEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19BA22C0)
#define RPG_GAMECORE_ROGUENOUSDICEBRANCHVALUEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19BA29E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueNousDiceBranchValueRow_TypeDefinitionIndex = 14168;
