...
#define RPG_GAMECORE_SIMPLEFREESTYLECONFIG_METHOD_2_E86703846AF790DF_OFFSET UNITYSDK_OFFSET(0x1D09F670)
#define RPG_GAMECORE_SIMPLEFREESTYLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D09F840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SimpleFreeStyleConfig_TypeDefinitionIndex = 21377;
