...
#define RPG_GAMECORE_ROGUEACTCHANGEROGUEMIRACLETOROGUEMIRACLECONFIG_METHOD_6_B531DAABC539CB30_OFFSET UNITYSDK_OFFSET(0x18CBF860)
#define RPG_GAMECORE_ROGUEACTCHANGEROGUEMIRACLETOROGUEMIRACLECONFIG_METHOD_6_D87CCD3E99B0C64D_OFFSET UNITYSDK_OFFSET(0x18CBFA80)
#define RPG_GAMECORE_ROGUEACTCHANGEROGUEMIRACLETOROGUEMIRACLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CBF9A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActChangeRogueMiracleToRogueMiracleConfig_TypeDefinitionIndex = 18615;
