...
#define RPG_GAMECORE_PLAYEROUTFITSLOTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D351490)
#define RPG_GAMECORE_PLAYEROUTFITSLOTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D351750)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 DefaultOutfitID; // 0x20
		::System::UInt32 SlotTipsIntroID; // 0x24
