...
#define RPG_GAMECORE_FIELDEFFECTBUDGETCONFIG_METHOD_2_C0964BF304E25208_OFFSET UNITYSDK_OFFSET(0x1E0D30C0)
#define RPG_GAMECORE_FIELDEFFECTBUDGETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0D3350)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FieldEffectBudgetConfig_TypeDefinitionIndex = 16317;
