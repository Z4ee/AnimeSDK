...
#define RPG_GAMECORE_ROGUEACTCHANGEROGUEMIRACLETOROGUEBUFFCONFIG_METHOD_6_5FC4B62A515DBBC3_OFFSET UNITYSDK_OFFSET(0x19AE3A30)
#define RPG_GAMECORE_ROGUEACTCHANGEROGUEMIRACLETOROGUEBUFFCONFIG_METHOD_6_6CD5E5B8E25015B6_OFFSET UNITYSDK_OFFSET(0x19AE3810)
#define RPG_GAMECORE_ROGUEACTCHANGEROGUEMIRACLETOROGUEBUFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AE3950)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActChangeRogueMiracleToRogueBuffConfig_TypeDefinitionIndex = 18581;
