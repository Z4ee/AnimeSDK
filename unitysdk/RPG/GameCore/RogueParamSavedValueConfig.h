...
#define RPG_GAMECORE_ROGUEPARAMSAVEDVALUECONFIG_METHOD_6_439D157767CD1755_OFFSET UNITYSDK_OFFSET(0x1BB67720)
#define RPG_GAMECORE_ROGUEPARAMSAVEDVALUECONFIG_METHOD_6_45FE769AE0D0C159_OFFSET UNITYSDK_OFFSET(0x1BB67770)
#define RPG_GAMECORE_ROGUEPARAMSAVEDVALUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB67760)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamSavedValueConfig_TypeDefinitionIndex = 19066;
