...
#define RPG_GAMECORE_ROGUEPARAMSAVEDVALUECONFIG_METHOD_6_45FE769AE0D0C159_OFFSET UNITYSDK_OFFSET(0x19BB4A30)
#define RPG_GAMECORE_ROGUEPARAMSAVEDVALUECONFIG_METHOD_6_C321777059D5777F_OFFSET UNITYSDK_OFFSET(0x19BB4780)
#define RPG_GAMECORE_ROGUEPARAMSAVEDVALUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19BB4900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamSavedValueConfig_TypeDefinitionIndex = 18785;
