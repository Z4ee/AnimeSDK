...
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_METHOD_2_BD35E0748722E7E6_OFFSET UNITYSDK_OFFSET(0x196A2CD0)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_METHOD_2_D9E754DF168FB9D7_OFFSET UNITYSDK_OFFSET(0x196A1A10)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x196A2D30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatAIEffectEvaluatorConfig_TypeDefinitionIndex = 15390;
