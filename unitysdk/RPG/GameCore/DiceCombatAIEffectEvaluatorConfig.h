...
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_METHOD_2_BD35E0748722E7E6_OFFSET UNITYSDK_OFFSET(0x1C10BB70)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_METHOD_2_D9E754DF168FB9D7_OFFSET UNITYSDK_OFFSET(0x1C10A8B0)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C10BBD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatAIEffectEvaluatorConfig_TypeDefinitionIndex = 15554;
