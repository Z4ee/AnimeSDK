...
#define RPG_GAMECORE_BYCOMPAREEVOLVEBUILDGEARLEVEL_METHOD_4_313ED20035504CBC_OFFSET UNITYSDK_OFFSET(0x1872BC00)
#define RPG_GAMECORE_BYCOMPAREEVOLVEBUILDGEARLEVEL_METHOD_4_C91F2E3C66268AB2_OFFSET UNITYSDK_OFFSET(0x1872BCD0)
#define RPG_GAMECORE_BYCOMPAREEVOLVEBUILDGEARLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1872BC80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareEvolveBuildGearLevel_TypeDefinitionIndex = 21401;
