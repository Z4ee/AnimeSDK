...
#define RPG_GAMECORE_BYCOMPAREEVOLVEBUILDGEARLEVEL_METHOD_4_17CA82C94D8D8FD7_OFFSET UNITYSDK_OFFSET(0x19CDF030)
#define RPG_GAMECORE_BYCOMPAREEVOLVEBUILDGEARLEVEL_METHOD_4_6F17FB5F629DD811_OFFSET UNITYSDK_OFFSET(0x19CDF330)
#define RPG_GAMECORE_BYCOMPAREEVOLVEBUILDGEARLEVEL_METHOD_4_6FFEAB40DFD2820E_OFFSET UNITYSDK_OFFSET(0x19CDF300)
#define RPG_GAMECORE_BYCOMPAREEVOLVEBUILDGEARLEVEL_METHOD_4_C91F2E3C66268AB2_OFFSET UNITYSDK_OFFSET(0x19CDF070)
#define RPG_GAMECORE_BYCOMPAREEVOLVEBUILDGEARLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x19CDF060)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareEvolveBuildGearLevel_TypeDefinitionIndex = 21705;
