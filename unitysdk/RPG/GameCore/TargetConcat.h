...
#define RPG_GAMECORE_TARGETCONCAT_METHOD_4_4C0D9FF96DA62EA7_OFFSET UNITYSDK_OFFSET(0x18ED3A60)
#define RPG_GAMECORE_TARGETCONCAT_METHOD_4_C8151DD4FBD16C23_OFFSET UNITYSDK_OFFSET(0x18ED39A0)
#define RPG_GAMECORE_TARGETCONCAT__CTOR_OFFSET UNITYSDK_OFFSET(0x18ED3A10)
