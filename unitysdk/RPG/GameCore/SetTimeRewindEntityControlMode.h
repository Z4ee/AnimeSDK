...
#define RPG_GAMECORE_SETTIMEREWINDENTITYCONTROLMODE_METHOD_3_1C66369469DBC064_OFFSET UNITYSDK_OFFSET(0x1D513620)
#define RPG_GAMECORE_SETTIMEREWINDENTITYCONTROLMODE_METHOD_3_469985BB0F5D6715_OFFSET UNITYSDK_OFFSET(0x1D513660)
#define RPG_GAMECORE_SETTIMEREWINDENTITYCONTROLMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D513650)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetTimeRewindEntityControlMode_TypeDefinitionIndex = 20437;
