...
#define RPG_GAMECORE_SWITCHREFGRAPHDYNAMICSTRING_METHOD_3_DB8429442197E274_OFFSET UNITYSDK_OFFSET(0x1D58FE50)
#define RPG_GAMECORE_SWITCHREFGRAPHDYNAMICSTRING_METHOD_3_E969C6D2344C5CBB_OFFSET UNITYSDK_OFFSET(0x1D58F6D0)
#define RPG_GAMECORE_SWITCHREFGRAPHDYNAMICSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1D58F6C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchRefGraphDynamicString_TypeDefinitionIndex = 17325;
