...
#define RPG_GAMECORE_MODIFYACTIVITYELATIONPOWER_METHOD_3_306CAEE0EA376786_OFFSET UNITYSDK_OFFSET(0x18B365C0)
#define RPG_GAMECORE_MODIFYACTIVITYELATIONPOWER_METHOD_3_34ACC63A1AE3D2B7_OFFSET UNITYSDK_OFFSET(0x18B36640)
#define RPG_GAMECORE_MODIFYACTIVITYELATIONPOWER__CTOR_OFFSET UNITYSDK_OFFSET(0x18B36610)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyActivityElationPower_TypeDefinitionIndex = 22099;
