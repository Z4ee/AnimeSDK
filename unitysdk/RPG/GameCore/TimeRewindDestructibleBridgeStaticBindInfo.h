...
#define RPG_GAMECORE_TIMEREWINDDESTRUCTIBLEBRIDGESTATICBINDINFO_METHOD_2_CFEDE5BE7CA1D7A8_OFFSET UNITYSDK_OFFSET(0x1C1527E0)
#define RPG_GAMECORE_TIMEREWINDDESTRUCTIBLEBRIDGESTATICBINDINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1C152A00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TimeRewindDestructibleBridgeStaticBindInfo_TypeDefinitionIndex = 15944;
