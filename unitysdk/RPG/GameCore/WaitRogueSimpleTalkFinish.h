...
#define RPG_GAMECORE_WAITROGUESIMPLETALKFINISH_METHOD_3_00B505ECED9D2288_OFFSET UNITYSDK_OFFSET(0x1D1BAF50)
#define RPG_GAMECORE_WAITROGUESIMPLETALKFINISH_METHOD_3_F0F0C1F05EC68505_OFFSET UNITYSDK_OFFSET(0x1D1BB020)
#define RPG_GAMECORE_WAITROGUESIMPLETALKFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1BB010)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitRogueSimpleTalkFinish_TypeDefinitionIndex = 20317;
