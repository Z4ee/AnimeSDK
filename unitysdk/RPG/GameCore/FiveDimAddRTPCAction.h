...
#define RPG_GAMECORE_FIVEDIMADDRTPCACTION_METHOD_3_09FEFB752C4B848A_OFFSET UNITYSDK_OFFSET(0x19727080)
#define RPG_GAMECORE_FIVEDIMADDRTPCACTION_METHOD_3_7FFDFF9F0918AA57_OFFSET UNITYSDK_OFFSET(0x19727010)
#define RPG_GAMECORE_FIVEDIMADDRTPCACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19727060)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimAddRTPCAction_TypeDefinitionIndex = 17808;
