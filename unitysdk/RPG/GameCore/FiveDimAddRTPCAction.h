...
#define RPG_GAMECORE_FIVEDIMADDRTPCACTION_METHOD_3_09FEFB752C4B848A_OFFSET UNITYSDK_OFFSET(0x188EA920)
#define RPG_GAMECORE_FIVEDIMADDRTPCACTION_METHOD_3_7FFDFF9F0918AA57_OFFSET UNITYSDK_OFFSET(0x188EA8B0)
#define RPG_GAMECORE_FIVEDIMADDRTPCACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x188EA900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimAddRTPCAction_TypeDefinitionIndex = 17781;
