...
#define RPG_GAMECORE_LEVELPROPDECALPARAM_METHOD_3_6E9B6F0866B7E69B_OFFSET UNITYSDK_OFFSET(0x1B086DA0)
#define RPG_GAMECORE_LEVELPROPDECALPARAM_METHOD_3_ADE3670F539B8828_OFFSET UNITYSDK_OFFSET(0x1B086DF0)
#define RPG_GAMECORE_LEVELPROPDECALPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B086DE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPropDecalParam_TypeDefinitionIndex = 16568;
