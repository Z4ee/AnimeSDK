...
#define RPG_GAMECORE_ST_MAIN_TELEPORTTOBORNPOS_METHOD_4_08A27CC76901B038_OFFSET UNITYSDK_OFFSET(0x1D4CE0E0)
#define RPG_GAMECORE_ST_MAIN_TELEPORTTOBORNPOS_METHOD_4_7EC830727C4A3F75_OFFSET UNITYSDK_OFFSET(0x1D4CE1B0)
#define RPG_GAMECORE_ST_MAIN_TELEPORTTOBORNPOS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4CE1A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_TeleportToBornPos_TypeDefinitionIndex = 19865;
