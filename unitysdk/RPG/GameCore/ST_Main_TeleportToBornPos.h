...
#define RPG_GAMECORE_ST_MAIN_TELEPORTTOBORNPOS_METHOD_4_7EC830727C4A3F75_OFFSET UNITYSDK_OFFSET(0x17689160)
#define RPG_GAMECORE_ST_MAIN_TELEPORTTOBORNPOS_METHOD_4_8F5D4520C469244A_OFFSET UNITYSDK_OFFSET(0x17698420)
#define RPG_GAMECORE_ST_MAIN_TELEPORTTOBORNPOS__CTOR_OFFSET UNITYSDK_OFFSET(0x17689110)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_TeleportToBornPos_TypeDefinitionIndex = 18379;
