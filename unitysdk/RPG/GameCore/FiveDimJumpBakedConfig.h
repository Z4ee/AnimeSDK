...
#define RPG_GAMECORE_FIVEDIMJUMPBAKEDCONFIG_METHOD_2_7E13B71461BF9501_OFFSET UNITYSDK_OFFSET(0x19743890)
#define RPG_GAMECORE_FIVEDIMJUMPBAKEDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197440B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimJumpBakedConfig_TypeDefinitionIndex = 15827;
