...
#define RPG_GAMECORE_SWITCHBOSSHEADEFFTYPE_METHOD_3_38376206338F1FAE_OFFSET UNITYSDK_OFFSET(0x18EB8070)
#define RPG_GAMECORE_SWITCHBOSSHEADEFFTYPE_METHOD_3_8B15F2BC5EFC430D_OFFSET UNITYSDK_OFFSET(0x18EB80F0)
#define RPG_GAMECORE_SWITCHBOSSHEADEFFTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x18EB80C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchBossHeadEffType_TypeDefinitionIndex = 22169;
