...
#define RPG_GAMECORE_HIPPLENINCIDENTSTEPCONFIG_METHOD_2_233A01F779A7A39C_OFFSET UNITYSDK_OFFSET(0x198355A0)
#define RPG_GAMECORE_HIPPLENINCIDENTSTEPCONFIG_METHOD_2_A716088A2B7F810F_OFFSET UNITYSDK_OFFSET(0x19836650)
#define RPG_GAMECORE_HIPPLENINCIDENTSTEPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x198353A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HipplenIncidentStepConfig_TypeDefinitionIndex = 15961;
