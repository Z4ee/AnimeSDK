...
#define RPG_GAMECORE_HIPPLENINCIDENTSTEPCONFIG_METHOD_2_233A01F779A7A39C_OFFSET UNITYSDK_OFFSET(0x172AE490)
#define RPG_GAMECORE_HIPPLENINCIDENTSTEPCONFIG_METHOD_2_A716088A2B7F810F_OFFSET UNITYSDK_OFFSET(0x172AF5D0)
#define RPG_GAMECORE_HIPPLENINCIDENTSTEPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x172AE290)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HipplenIncidentStepConfig_TypeDefinitionIndex = 15388;
