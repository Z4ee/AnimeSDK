...
#define RPG_GAMECORE_HIPPLENINCIDENTSTEPCONFIG_METHOD_2_233A01F779A7A39C_OFFSET UNITYSDK_OFFSET(0x1D202E90)
#define RPG_GAMECORE_HIPPLENINCIDENTSTEPCONFIG_METHOD_2_A716088A2B7F810F_OFFSET UNITYSDK_OFFSET(0x1D203F40)
#define RPG_GAMECORE_HIPPLENINCIDENTSTEPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D202C90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HipplenIncidentStepConfig_TypeDefinitionIndex = 16627;
