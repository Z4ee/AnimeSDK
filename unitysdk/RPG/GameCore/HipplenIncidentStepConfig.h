...
#define RPG_GAMECORE_HIPPLENINCIDENTSTEPCONFIG_METHOD_2_233A01F779A7A39C_OFFSET UNITYSDK_OFFSET(0x1B687E00)
#define RPG_GAMECORE_HIPPLENINCIDENTSTEPCONFIG_METHOD_2_A716088A2B7F810F_OFFSET UNITYSDK_OFFSET(0x1B688EB0)
#define RPG_GAMECORE_HIPPLENINCIDENTSTEPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B687C00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HipplenIncidentStepConfig_TypeDefinitionIndex = 16143;
