...
#define RPG_GAMECORE_GAMEOBJECTPOOLCONFIG_METHOD_2_0D832C8EAE5623F5_OFFSET UNITYSDK_OFFSET(0x1D136550)
#define RPG_GAMECORE_GAMEOBJECTPOOLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D13D9B0)
