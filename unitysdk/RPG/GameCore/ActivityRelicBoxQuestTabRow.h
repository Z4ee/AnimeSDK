...
#define RPG_GAMECORE_ACTIVITYRELICBOXQUESTTABROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CDA78D0)
#define RPG_GAMECORE_ACTIVITYRELICBOXQUESTTABROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDA7A30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityRelicBoxQuestTabRow_TypeDefinitionIndex = 12247;
