...
#define RPG_GAMECORE_ADVENTUREONSETTARGETATTACKRESULT_CLEAR_OFFSET UNITYSDK_OFFSET(0xA84B190)
#define RPG_GAMECORE_ADVENTUREONSETTARGETATTACKRESULT_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xA84B230)
#define RPG_GAMECORE_ADVENTUREONSETTARGETATTACKRESULT_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xA84B1E0)
#define RPG_GAMECORE_ADVENTUREONSETTARGETATTACKRESULT_INIT_OFFSET UNITYSDK_OFFSET(0xA84B130)
#define RPG_GAMECORE_ADVENTUREONSETTARGETATTACKRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0xA84B280)
#define RPG_GAMECORE_ADVENTUREONSETTARGETATTACKRESULT___IFIXBASEPROXY_CLEAR_OFFSET UNITYSDK_OFFSET(0xA84B290)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureOnSetTargetAttackResult_TypeDefinitionIndex = 45551;
