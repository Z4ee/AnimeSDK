...
#define RPG_GAMECORE_REDDOTNODECONFIG_METHOD_2_E2F8E4E924FCE758_OFFSET UNITYSDK_OFFSET(0x1D38F0B0)
#define RPG_GAMECORE_REDDOTNODECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D38F360)
