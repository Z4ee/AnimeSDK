...
#define RPG_GAMECORE_LEVELGROUPSTATEDEFINE_METHOD_2_8219782B8DABDFA9_OFFSET UNITYSDK_OFFSET(0x1C118EF0)
#define RPG_GAMECORE_LEVELGROUPSTATEDEFINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C118F30)
