...
#define RPG_GAMECORE_LEVELGROUPSTATEDEFINE_METHOD_2_8219782B8DABDFA9_OFFSET UNITYSDK_OFFSET(0x1B070FA0)
#define RPG_GAMECORE_LEVELGROUPSTATEDEFINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B070FE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelGroupStateDefine_TypeDefinitionIndex = 16634;
