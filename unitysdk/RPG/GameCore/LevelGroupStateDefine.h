...
#define RPG_GAMECORE_LEVELGROUPSTATEDEFINE_METHOD_2_8219782B8DABDFA9_OFFSET UNITYSDK_OFFSET(0x18A47070)
#define RPG_GAMECORE_LEVELGROUPSTATEDEFINE__CTOR_OFFSET UNITYSDK_OFFSET(0x18A470B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelGroupStateDefine_TypeDefinitionIndex = 16438;
