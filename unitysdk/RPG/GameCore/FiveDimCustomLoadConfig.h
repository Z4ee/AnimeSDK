...
#define RPG_GAMECORE_FIVEDIMCUSTOMLOADCONFIG_METHOD_3_017A381125033987_OFFSET UNITYSDK_OFFSET(0x1E0E85C0)
#define RPG_GAMECORE_FIVEDIMCUSTOMLOADCONFIG_METHOD_3_2EBDC5072485975B_OFFSET UNITYSDK_OFFSET(0x1E0E8520)
#define RPG_GAMECORE_FIVEDIMCUSTOMLOADCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0E8580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimCustomLoadConfig_TypeDefinitionIndex = 18397;
