...
#define RPG_GAMECORE_FIVEDIMCUSTOMLOADCONFIG_METHOD_3_2BEDDC9746FD8EB9_OFFSET UNITYSDK_OFFSET(0x171EDE60)
#define RPG_GAMECORE_FIVEDIMCUSTOMLOADCONFIG_METHOD_3_8B2E1B5245FB7E31_OFFSET UNITYSDK_OFFSET(0x171EDF20)
#define RPG_GAMECORE_FIVEDIMCUSTOMLOADCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171EDED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimCustomLoadConfig_TypeDefinitionIndex = 17076;
