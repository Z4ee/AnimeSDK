...
#define RPG_GAMECORE_ST_BYHASADVBEHAVIORFLAG_METHOD_4_1832BEB7CA9060C0_OFFSET UNITYSDK_OFFSET(0x1B77CEF0)
#define RPG_GAMECORE_ST_BYHASADVBEHAVIORFLAG_METHOD_4_5E3711823738BBF0_OFFSET UNITYSDK_OFFSET(0x1B77D080)
#define RPG_GAMECORE_ST_BYHASADVBEHAVIORFLAG_METHOD_4_9BA6BABE2C239055_OFFSET UNITYSDK_OFFSET(0x1B77CEB0)
#define RPG_GAMECORE_ST_BYHASADVBEHAVIORFLAG_METHOD_4_E0195C49A3D97D87_OFFSET UNITYSDK_OFFSET(0x1B77D0B0)
#define RPG_GAMECORE_ST_BYHASADVBEHAVIORFLAG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B77CEE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_ByHasAdvBehaviorFlag_TypeDefinitionIndex = 19308;
