...
#define RPG_GAMECORE_SHOWBATTLETALKBGUI_METHOD_3_51C05D79A72FBB96_OFFSET UNITYSDK_OFFSET(0x1BE3AFF0)
#define RPG_GAMECORE_SHOWBATTLETALKBGUI_METHOD_3_8538857E525BECDB_OFFSET UNITYSDK_OFFSET(0x1BE3AFA0)
#define RPG_GAMECORE_SHOWBATTLETALKBGUI__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE3AFE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowBattleTalkBGUI_TypeDefinitionIndex = 22512;
