...
#define RPG_GAMECORE_GRIDFIGHTVICTORYBONUSCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x189DEF90)
#define RPG_GAMECORE_GRIDFIGHTVICTORYBONUSCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x189DF100)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightVictoryBonusConfigRow_TypeDefinitionIndex = 12688;
