...
#define RPG_GAMECORE_GRIDFIGHTVICTORYBONUSCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19811DF0)
#define RPG_GAMECORE_GRIDFIGHTVICTORYBONUSCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19811F60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightVictoryBonusConfigRow_TypeDefinitionIndex = 12778;

	class GridFightVictoryBonusConfigRow : public ::System::Object
	{
	public:
		::System::UInt32 ExtraGroupID; // 0x10
		::System::UInt32 GoldBonus; // 0x14
