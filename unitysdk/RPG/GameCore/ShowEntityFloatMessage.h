...
#define RPG_GAMECORE_SHOWENTITYFLOATMESSAGE_METHOD_3_02CA125AF13260CE_OFFSET UNITYSDK_OFFSET(0x176F9010)
#define RPG_GAMECORE_SHOWENTITYFLOATMESSAGE_METHOD_3_7140768CD1E446E3_OFFSET UNITYSDK_OFFSET(0x176F90B0)
#define RPG_GAMECORE_SHOWENTITYFLOATMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x176F9070)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowEntityFloatMessage_TypeDefinitionIndex = 20671;
	...
	public:
		...
		static ::System::Void Method_3_02CA125AF13260CE(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::ShowEntityFloatMessage*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::ShowEntityFloatMessage*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_SHOWENTITYFLOATMESSAGE_METHOD_3_02CA125AF13260CE_OFFSET))(a1, a2);
		}
