...
#define RPG_GAMECORE_PROPINTERACTWHITELISTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1751FA00)
#define RPG_GAMECORE_PROPINTERACTWHITELISTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1751FAA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropInteractWhiteListRow_TypeDefinitionIndex = 12079;
