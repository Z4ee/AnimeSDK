...
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEACTLISTCONFIG_METHOD_6_03CE19AA1E2F0B57_OFFSET UNITYSDK_OFFSET(0x175CA5A0)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEACTLISTCONFIG_METHOD_6_1A6597EFF3B65BE2_OFFSET UNITYSDK_OFFSET(0x175CA7C0)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEACTLISTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175CA6E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActTriggerRogueActListConfig_TypeDefinitionIndex = 17999;
