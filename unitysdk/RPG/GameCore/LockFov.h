...
#define RPG_GAMECORE_LOCKFOV_METHOD_3_708738909936C110_OFFSET UNITYSDK_OFFSET(0x1736AF10)
#define RPG_GAMECORE_LOCKFOV_METHOD_3_77C4B3EB03F0C0C9_OFFSET UNITYSDK_OFFSET(0x1736AE90)
#define RPG_GAMECORE_LOCKFOV__CTOR_OFFSET UNITYSDK_OFFSET(0x1736AEE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LockFov_TypeDefinitionIndex = 19162;
