...
#define RPG_GAMECORE_LOCKFOV_METHOD_3_186D5EFE9AECEE30_OFFSET UNITYSDK_OFFSET(0x1BCCF190)
#define RPG_GAMECORE_LOCKFOV_METHOD_3_FD388F4EB8966695_OFFSET UNITYSDK_OFFSET(0x1BCCF1E0)
#define RPG_GAMECORE_LOCKFOV__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCCF1D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LockFov_TypeDefinitionIndex = 20053;
