...
#define RPG_GAMECORE_FIVEDIMREMOVEGLOBALTIMESCALE_METHOD_3_864E8044F820137D_OFFSET UNITYSDK_OFFSET(0x19752140)
#define RPG_GAMECORE_FIVEDIMREMOVEGLOBALTIMESCALE_METHOD_3_E2F8B46CFC6F486C_OFFSET UNITYSDK_OFFSET(0x197521C0)
#define RPG_GAMECORE_FIVEDIMREMOVEGLOBALTIMESCALE__CTOR_OFFSET UNITYSDK_OFFSET(0x19752190)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimRemoveGlobalTimeScale_TypeDefinitionIndex = 20254;
