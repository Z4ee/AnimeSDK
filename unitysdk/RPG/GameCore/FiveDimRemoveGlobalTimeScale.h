...
#define RPG_GAMECORE_FIVEDIMREMOVEGLOBALTIMESCALE_METHOD_3_A537EBD75BB65C27_OFFSET UNITYSDK_OFFSET(0x1BEAE400)
#define RPG_GAMECORE_FIVEDIMREMOVEGLOBALTIMESCALE_METHOD_3_E2F8B46CFC6F486C_OFFSET UNITYSDK_OFFSET(0x1BEAE440)
#define RPG_GAMECORE_FIVEDIMREMOVEGLOBALTIMESCALE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEAE430)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimRemoveGlobalTimeScale_TypeDefinitionIndex = 20647;
