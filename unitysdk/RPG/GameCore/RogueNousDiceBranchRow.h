...
#define RPG_GAMECORE_ROGUENOUSDICEBRANCHROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D4003A0)
#define RPG_GAMECORE_ROGUENOUSDICEBRANCHROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D400FD0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* DiceLightColor; // 0x18
		::System::String* SoundSuspensionStart; // 0x20
		::Il2CppArray<::RPG::GameCore::FixPoint>* ParamValue3; // 0x28
		::System::String* SoundSuspensionStop; // 0x30
		::Il2CppArray<::RPG::GameCore::FixPoint>* ParamValue2; // 0x38
		::System::String* BranchEditCorePrefab; // 0x40
		::System::String* BranchPrefab; // 0x48
		::System::String* SoundRoll; // 0x50
		::Il2CppArray<::System::UInt32>* DefaultCommonSurfaceList; // 0x58
		::System::String* SoundReRoll; // 0x60
		::System::String* BranchIcon; // 0x68
		::System::String* BranchCorePrefab; // 0x70
		::Il2CppArray<::System::UInt32>* RecommendSurfaceList; // 0x78
		::Il2CppArray<::RPG::GameCore::FixPoint>* ParamValue1; // 0x80
		::Il2CppArray<::System::UInt32>* EffectExtraDesc; // 0x88
		::System::String* DiceIcon; // 0x90
		::Il2CppArray<::System::UInt32>* SuggestiveSurfaceList; // 0x98
		::Il2CppArray<::System::UInt32>* PassiveEffectExtraDesc; // 0xA0
		::RPG::Client::TextID BranchIntroduction; // 0xA8
		::RPG::Client::TextID StartingEffectDescToast; // 0xB8
		::RPG::Client::TextID PassiveEffectDesc; // 0xC8
		::RPG::Client::TextID EffectDescParam2; // 0xD8
		::RPG::Client::TextID BranchName; // 0xE8
		::System::UInt32 BranchID; // 0xF8
		::System::UInt32 DefaultUltraSurface; // 0xFC
		::System::UInt32 UnlockID; // 0x100
		::System::UInt32 BranchTag; // 0x104
		::RPG::Client::TextID EffectDesc; // 0x108
