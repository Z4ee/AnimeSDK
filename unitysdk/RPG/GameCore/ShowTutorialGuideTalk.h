...
#define RPG_GAMECORE_SHOWTUTORIALGUIDETALK_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1D531E10)
#define RPG_GAMECORE_SHOWTUTORIALGUIDETALK_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D531DD0)
#define RPG_GAMECORE_SHOWTUTORIALGUIDETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D531E00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowTutorialGuideTalk_TypeDefinitionIndex = 24066;
