...
#define RPG_GAMECORE_SHOWTUTORIALGUIDETALK_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1BE48DA0)
#define RPG_GAMECORE_SHOWTUTORIALGUIDETALK_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1BE48D60)
#define RPG_GAMECORE_SHOWTUTORIALGUIDETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE48D90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowTutorialGuideTalk_TypeDefinitionIndex = 23484;
