...
#define RPG_GAMECORE_ROGUEACTGETMAGICUNITBYPARAMCONFIG_METHOD_6_51AFB42020479A35_OFFSET UNITYSDK_OFFSET(0x1D3B7630)
#define RPG_GAMECORE_ROGUEACTGETMAGICUNITBYPARAMCONFIG_METHOD_6_AC3B1B3F5D77E339_OFFSET UNITYSDK_OFFSET(0x1D3B7680)
#define RPG_GAMECORE_ROGUEACTGETMAGICUNITBYPARAMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3B7670)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActGetMagicUnitByParamConfig_TypeDefinitionIndex = 19462;
