...
#define RPG_GAMECORE_ROGUEACTGETMAGICUNITBYPARAMCONFIG_METHOD_6_AC3B1B3F5D77E339_OFFSET UNITYSDK_OFFSET(0x175B5DE0)
#define RPG_GAMECORE_ROGUEACTGETMAGICUNITBYPARAMCONFIG_METHOD_6_DB2197C37C1734C4_OFFSET UNITYSDK_OFFSET(0x175B5BC0)
#define RPG_GAMECORE_ROGUEACTGETMAGICUNITBYPARAMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175B5D00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActGetMagicUnitByParamConfig_TypeDefinitionIndex = 18047;
