...
#define RPG_GAMECORE_WAITGROUPSTATECHANGE_METHOD_4_6A4BC8747647FF94_OFFSET UNITYSDK_OFFSET(0x178FBB00)
#define RPG_GAMECORE_WAITGROUPSTATECHANGE_METHOD_4_FBD0BBA51FD774D8_OFFSET UNITYSDK_OFFSET(0x178FBBF0)
#define RPG_GAMECORE_WAITGROUPSTATECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x178FBB90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitGroupStateChange_TypeDefinitionIndex = 19043;
