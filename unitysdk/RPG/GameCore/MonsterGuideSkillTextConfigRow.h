...
#define RPG_GAMECORE_MONSTERGUIDESKILLTEXTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D2D37C0)
#define RPG_GAMECORE_MONSTERGUIDESKILLTEXTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2D3A40)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 SkillTextID; // 0x34
