...
#define RPG_GAMECORE_MONSTERGUIDESKILLTEXTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17450A80)
#define RPG_GAMECORE_MONSTERGUIDESKILLTEXTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17450D10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonsterGuideSkillTextConfigRow_TypeDefinitionIndex = 13002;
	...
	public:
		...
		::System::UInt32 SkillTextID; // 0x38
