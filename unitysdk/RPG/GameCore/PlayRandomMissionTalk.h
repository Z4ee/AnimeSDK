...
#define RPG_GAMECORE_PLAYRANDOMMISSIONTALK_METHOD_4_3D02EFB04E5B9DCF_OFFSET UNITYSDK_OFFSET(0x174C5930)
#define RPG_GAMECORE_PLAYRANDOMMISSIONTALK_METHOD_4_4930DF5DEBFA4891_OFFSET UNITYSDK_OFFSET(0x174C58B0)
#define RPG_GAMECORE_PLAYRANDOMMISSIONTALK__CTOR_OFFSET UNITYSDK_OFFSET(0x174C5900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayRandomMissionTalk_TypeDefinitionIndex = 21675;
