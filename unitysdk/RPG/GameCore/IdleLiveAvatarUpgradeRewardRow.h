...
#define RPG_GAMECORE_IDLELIVEAVATARUPGRADEREWARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D20DE90)
#define RPG_GAMECORE_IDLELIVEAVATARUPGRADEREWARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D20DFD0)
