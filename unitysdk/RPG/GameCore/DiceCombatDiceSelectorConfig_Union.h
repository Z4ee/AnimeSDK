...
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_UNION_METHOD_3_B49B3025F5ED2613_OFFSET UNITYSDK_OFFSET(0x1715FF30)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_UNION_METHOD_3_C8FF7988C5507851_OFFSET UNITYSDK_OFFSET(0x17160940)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_UNION__CTOR_OFFSET UNITYSDK_OFFSET(0x1715FF20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatDiceSelectorConfig_Union_TypeDefinitionIndex = 14830;
