...
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_UNION_METHOD_3_B49B3025F5ED2613_OFFSET UNITYSDK_OFFSET(0x196A6A10)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_UNION_METHOD_3_C8FF7988C5507851_OFFSET UNITYSDK_OFFSET(0x196A7650)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_UNION__CTOR_OFFSET UNITYSDK_OFFSET(0x196A6A00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatDiceSelectorConfig_Union_TypeDefinitionIndex = 15377;
