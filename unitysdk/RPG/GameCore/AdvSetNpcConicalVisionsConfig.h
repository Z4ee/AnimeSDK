...
#define RPG_GAMECORE_ADVSETNPCCONICALVISIONSCONFIG_METHOD_3_0E19A36C6AF2459D_OFFSET UNITYSDK_OFFSET(0x1BE2E020)
#define RPG_GAMECORE_ADVSETNPCCONICALVISIONSCONFIG_METHOD_3_20BC040E56BE3E06_OFFSET UNITYSDK_OFFSET(0x1BE2DFE0)
#define RPG_GAMECORE_ADVSETNPCCONICALVISIONSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE2E010)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSetNpcConicalVisionsConfig_TypeDefinitionIndex = 19225;
