...
#define RPG_GAMECORE_ADVBYCHECKWINDOWPERMCODES_METHOD_4_1832781DF3867706_OFFSET UNITYSDK_OFFSET(0x1D6A9770)
#define RPG_GAMECORE_ADVBYCHECKWINDOWPERMCODES_METHOD_4_1A816B1836FE4006_OFFSET UNITYSDK_OFFSET(0x1D6A9500)
#define RPG_GAMECORE_ADVBYCHECKWINDOWPERMCODES_METHOD_4_2550AC7A27BD3EC8_OFFSET UNITYSDK_OFFSET(0x1D6A9740)
#define RPG_GAMECORE_ADVBYCHECKWINDOWPERMCODES_METHOD_4_B27BE0FFD600B053_OFFSET UNITYSDK_OFFSET(0x1D6A94C0)
#define RPG_GAMECORE_ADVBYCHECKWINDOWPERMCODES__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6A94F0)
