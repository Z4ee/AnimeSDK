...
#define RPG_GAMECORE_ADVBYCHECKWINDOWPERMCODES_METHOD_4_370DCC57ECA7694A_OFFSET UNITYSDK_OFFSET(0x16F24FE0)
#define RPG_GAMECORE_ADVBYCHECKWINDOWPERMCODES_METHOD_4_CEB3F36967968EA1_OFFSET UNITYSDK_OFFSET(0x16F250B0)
#define RPG_GAMECORE_ADVBYCHECKWINDOWPERMCODES__CTOR_OFFSET UNITYSDK_OFFSET(0x16F25060)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvByCheckWindowPermCodes_TypeDefinitionIndex = 19588;
