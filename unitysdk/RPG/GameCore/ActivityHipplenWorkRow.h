...
#define RPG_GAMECORE_ACTIVITYHIPPLENWORKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CD948A0)
#define RPG_GAMECORE_ACTIVITYHIPPLENWORKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD94C10)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 Cost; // 0x24
		::System::UInt32 Param; // 0x28
		::System::UInt32 ID; // 0x2C
		::RPG::Client::TextID WorkDesc; // 0x30
