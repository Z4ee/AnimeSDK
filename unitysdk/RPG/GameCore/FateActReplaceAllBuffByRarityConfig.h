...
#define RPG_GAMECORE_FATEACTREPLACEALLBUFFBYRARITYCONFIG_METHOD_6_27EDB41DECAD3EEB_OFFSET UNITYSDK_OFFSET(0x188CF920)
#define RPG_GAMECORE_FATEACTREPLACEALLBUFFBYRARITYCONFIG_METHOD_6_958E41E9399DEAB0_OFFSET UNITYSDK_OFFSET(0x188CFA90)
#define RPG_GAMECORE_FATEACTREPLACEALLBUFFBYRARITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x188CF9F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateActReplaceAllBuffByRarityConfig_TypeDefinitionIndex = 18282;
