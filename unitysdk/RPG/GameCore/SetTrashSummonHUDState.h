...
#define RPG_GAMECORE_SETTRASHSUMMONHUDSTATE_METHOD_3_A2FE12F554B878C3_OFFSET UNITYSDK_OFFSET(0x1C60EB40)
#define RPG_GAMECORE_SETTRASHSUMMONHUDSTATE_METHOD_3_B93844927BAC2D9E_OFFSET UNITYSDK_OFFSET(0x1C60EB00)
#define RPG_GAMECORE_SETTRASHSUMMONHUDSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C60EB30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetTrashSummonHUDState_TypeDefinitionIndex = 22394;
