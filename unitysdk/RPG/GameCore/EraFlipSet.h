...
#define RPG_GAMECORE_ERAFLIPSET_METHOD_2_647A3D62B7DAAA99_OFFSET UNITYSDK_OFFSET(0x1D072F00)
#define RPG_GAMECORE_ERAFLIPSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1D073050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EraFlipSet_TypeDefinitionIndex = 16440;
