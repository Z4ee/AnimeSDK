...
#define RPG_GAMECORE_SWITCHUIMENUBGM_METHOD_3_17A6D5636725895F_OFFSET UNITYSDK_OFFSET(0x19CE0330)
#define RPG_GAMECORE_SWITCHUIMENUBGM_METHOD_3_48E2681717C447BB_OFFSET UNITYSDK_OFFSET(0x19CE02B0)
#define RPG_GAMECORE_SWITCHUIMENUBGM__CTOR_OFFSET UNITYSDK_OFFSET(0x19CE0300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchUIMenuBGM_TypeDefinitionIndex = 20678;
