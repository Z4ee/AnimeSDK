...
#define RPG_GAMECORE_SWITCHUIMENUBGM_METHOD_3_17A6D5636725895F_OFFSET UNITYSDK_OFFSET(0x18EC04E0)
#define RPG_GAMECORE_SWITCHUIMENUBGM_METHOD_3_48E2681717C447BB_OFFSET UNITYSDK_OFFSET(0x18EC0460)
#define RPG_GAMECORE_SWITCHUIMENUBGM__CTOR_OFFSET UNITYSDK_OFFSET(0x18EC04B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchUIMenuBGM_TypeDefinitionIndex = 20750;
