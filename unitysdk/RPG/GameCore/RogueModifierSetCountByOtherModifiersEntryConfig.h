...
#define RPG_GAMECORE_ROGUEMODIFIERSETCOUNTBYOTHERMODIFIERSENTRYCONFIG_METHOD_2_6B70C3D3AF662335_OFFSET UNITYSDK_OFFSET(0x19B9C870)
#define RPG_GAMECORE_ROGUEMODIFIERSETCOUNTBYOTHERMODIFIERSENTRYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B9C8B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierSetCountByOtherModifiersEntryConfig_TypeDefinitionIndex = 16845;
