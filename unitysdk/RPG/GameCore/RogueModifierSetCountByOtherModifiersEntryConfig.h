...
#define RPG_GAMECORE_ROGUEMODIFIERSETCOUNTBYOTHERMODIFIERSENTRYCONFIG_METHOD_2_6B70C3D3AF662335_OFFSET UNITYSDK_OFFSET(0x18D46890)
#define RPG_GAMECORE_ROGUEMODIFIERSETCOUNTBYOTHERMODIFIERSENTRYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D468D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierSetCountByOtherModifiersEntryConfig_TypeDefinitionIndex = 16830;
