...
#define RPG_GAMECORE_ROGUEMODIFIERSETCOUNTBYOTHERMODIFIERSENTRYCONFIG_METHOD_2_6B70C3D3AF662335_OFFSET UNITYSDK_OFFSET(0x1D1662D0)
#define RPG_GAMECORE_ROGUEMODIFIERSETCOUNTBYOTHERMODIFIERSENTRYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D166310)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierSetCountByOtherModifiersEntryConfig_TypeDefinitionIndex = 17007;
