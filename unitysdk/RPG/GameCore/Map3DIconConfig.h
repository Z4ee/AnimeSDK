...
#define RPG_GAMECORE_MAP3DICONCONFIG_METHOD_2_0D9E6A2D6F64F87B_OFFSET UNITYSDK_OFFSET(0x1D495A90)
#define RPG_GAMECORE_MAP3DICONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D495C20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int Map3DIconConfig_TypeDefinitionIndex = 16846;
