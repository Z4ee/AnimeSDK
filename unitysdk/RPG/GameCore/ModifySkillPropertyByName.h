...
#define RPG_GAMECORE_MODIFYSKILLPROPERTYBYNAME_METHOD_3_46509CB1AF0DAC63_OFFSET UNITYSDK_OFFSET(0x17433E90)
#define RPG_GAMECORE_MODIFYSKILLPROPERTYBYNAME_METHOD_3_69D1DED6A6EF15CB_OFFSET UNITYSDK_OFFSET(0x17433DC0)
#define RPG_GAMECORE_MODIFYSKILLPROPERTYBYNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x17433E40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifySkillPropertyByName_TypeDefinitionIndex = 21789;
