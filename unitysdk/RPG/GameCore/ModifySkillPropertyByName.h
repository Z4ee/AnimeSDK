...
#define RPG_GAMECORE_MODIFYSKILLPROPERTYBYNAME_METHOD_3_65737B02DECE7ED3_OFFSET UNITYSDK_OFFSET(0x1D2B7AD0)
#define RPG_GAMECORE_MODIFYSKILLPROPERTYBYNAME_METHOD_3_DDE150CC7175EDDC_OFFSET UNITYSDK_OFFSET(0x1D2B7B70)
#define RPG_GAMECORE_MODIFYSKILLPROPERTYBYNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2B7B30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifySkillPropertyByName_TypeDefinitionIndex = 23290;
