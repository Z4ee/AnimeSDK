...
#define RPG_GAMECORE_MONOPOLYMAPBASELAYER_METHOD_2_012A5D9D150ACA52_OFFSET UNITYSDK_OFFSET(0x19961940)
#define RPG_GAMECORE_MONOPOLYMAPBASELAYER_METHOD_2_FE11A3E199F97F1E_OFFSET UNITYSDK_OFFSET(0x19961AF0)
#define RPG_GAMECORE_MONOPOLYMAPBASELAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x19961930)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonopolyMapBaseLayer_TypeDefinitionIndex = 15425;
