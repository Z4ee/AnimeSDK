...
#define RPG_GAMECORE_MONOPOLYMAPBASELAYER_METHOD_2_012A5D9D150ACA52_OFFSET UNITYSDK_OFFSET(0x1743CFC0)
#define RPG_GAMECORE_MONOPOLYMAPBASELAYER_METHOD_2_FE11A3E199F97F1E_OFFSET UNITYSDK_OFFSET(0x1743D170)
#define RPG_GAMECORE_MONOPOLYMAPBASELAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1743CFB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonopolyMapBaseLayer_TypeDefinitionIndex = 14860;
