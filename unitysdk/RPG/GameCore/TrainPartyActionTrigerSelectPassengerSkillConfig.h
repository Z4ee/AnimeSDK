...
#define RPG_GAMECORE_TRAINPARTYACTIONTRIGERSELECTPASSENGERSKILLCONFIG_METHOD_5_12FC527702259D13_OFFSET UNITYSDK_OFFSET(0x19DF13A0)
#define RPG_GAMECORE_TRAINPARTYACTIONTRIGERSELECTPASSENGERSKILLCONFIG_METHOD_5_D5C0315DE0645F5A_OFFSET UNITYSDK_OFFSET(0x19DF16B0)
#define RPG_GAMECORE_TRAINPARTYACTIONTRIGERSELECTPASSENGERSKILLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19DF1350)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyActionTrigerSelectPassengerSkillConfig_TypeDefinitionIndex = 17188;
