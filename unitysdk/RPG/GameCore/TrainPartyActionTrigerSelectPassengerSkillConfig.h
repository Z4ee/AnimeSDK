...
#define RPG_GAMECORE_TRAINPARTYACTIONTRIGERSELECTPASSENGERSKILLCONFIG_METHOD_5_12FC527702259D13_OFFSET UNITYSDK_OFFSET(0x1C15CE50)
#define RPG_GAMECORE_TRAINPARTYACTIONTRIGERSELECTPASSENGERSKILLCONFIG_METHOD_5_7705E55C84CBC44F_OFFSET UNITYSDK_OFFSET(0x1C15CFE0)
#define RPG_GAMECORE_TRAINPARTYACTIONTRIGERSELECTPASSENGERSKILLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C15CE40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyActionTrigerSelectPassengerSkillConfig_TypeDefinitionIndex = 17350;
