...
#define RPG_GAMECORE_LITTLEGAMEABILITYTEAMTOWERSMAKEBRICKSTONEEFFECTCONFIG_METHOD_3_2630968E48C74F43_OFFSET UNITYSDK_OFFSET(0x1BCBCA30)
#define RPG_GAMECORE_LITTLEGAMEABILITYTEAMTOWERSMAKEBRICKSTONEEFFECTCONFIG_METHOD_3_8C3975CFC16D44C2_OFFSET UNITYSDK_OFFSET(0x1BCBCAD0)
#define RPG_GAMECORE_LITTLEGAMEABILITYTEAMTOWERSMAKEBRICKSTONEEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCBCAC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityTeamTowersMakeBrickStoneEffectConfig_TypeDefinitionIndex = 20610;
