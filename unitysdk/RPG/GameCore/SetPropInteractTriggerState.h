...
#define RPG_GAMECORE_SETPROPINTERACTTRIGGERSTATE_METHOD_3_CD527B8E330BAF79_OFFSET UNITYSDK_OFFSET(0x1D50B6C0)
#define RPG_GAMECORE_SETPROPINTERACTTRIGGERSTATE_METHOD_3_D715CA6CAF98FB04_OFFSET UNITYSDK_OFFSET(0x1D50B700)
#define RPG_GAMECORE_SETPROPINTERACTTRIGGERSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D50B6F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetPropInteractTriggerState_TypeDefinitionIndex = 20147;
