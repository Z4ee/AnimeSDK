...
#define RPG_GAMECORE_SETPROPINTERACTTRIGGERSTATE_METHOD_3_90E0905E510AA7DB_OFFSET UNITYSDK_OFFSET(0x176DC020)
#define RPG_GAMECORE_SETPROPINTERACTTRIGGERSTATE_METHOD_3_D715CA6CAF98FB04_OFFSET UNITYSDK_OFFSET(0x176DC0A0)
#define RPG_GAMECORE_SETPROPINTERACTTRIGGERSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x176DC070)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetPropInteractTriggerState_TypeDefinitionIndex = 18678;
