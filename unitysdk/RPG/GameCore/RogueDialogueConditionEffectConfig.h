...
#define RPG_GAMECORE_ROGUEDIALOGUECONDITIONEFFECTCONFIG_METHOD_2_42BFDC2BC7EE1A66_OFFSET UNITYSDK_OFFSET(0x19B375E0)
#define RPG_GAMECORE_ROGUEDIALOGUECONDITIONEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B37620)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueDialogueConditionEffectConfig_TypeDefinitionIndex = 18599;
