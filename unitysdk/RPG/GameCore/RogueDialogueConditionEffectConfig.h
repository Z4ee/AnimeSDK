...
#define RPG_GAMECORE_ROGUEDIALOGUECONDITIONEFFECTCONFIG_METHOD_2_42BFDC2BC7EE1A66_OFFSET UNITYSDK_OFFSET(0x1CFA9790)
#define RPG_GAMECORE_ROGUEDIALOGUECONDITIONEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFA97D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueDialogueConditionEffectConfig_TypeDefinitionIndex = 18875;
