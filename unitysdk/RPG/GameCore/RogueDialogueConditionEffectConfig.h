...
#define RPG_GAMECORE_ROGUEDIALOGUECONDITIONEFFECTCONFIG_METHOD_2_42BFDC2BC7EE1A66_OFFSET UNITYSDK_OFFSET(0x17605640)
#define RPG_GAMECORE_ROGUEDIALOGUECONDITIONEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17605680)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueDialogueConditionEffectConfig_TypeDefinitionIndex = 17987;
