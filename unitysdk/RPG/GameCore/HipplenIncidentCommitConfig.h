...
#define RPG_GAMECORE_HIPPLENINCIDENTCOMMITCONFIG_METHOD_3_8FE97D121DEC0C88_OFFSET UNITYSDK_OFFSET(0x18A02CE0)
#define RPG_GAMECORE_HIPPLENINCIDENTCOMMITCONFIG_METHOD_3_AE31E4728DBA66BC_OFFSET UNITYSDK_OFFSET(0x18A02C10)
#define RPG_GAMECORE_HIPPLENINCIDENTCOMMITCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18A02CD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HipplenIncidentCommitConfig_TypeDefinitionIndex = 15910;
