...
#define RPG_GAMECORE_HIPPLENINCIDENTCOMMITCONFIG_METHOD_3_8FE97D121DEC0C88_OFFSET UNITYSDK_OFFSET(0x1B687A20)
#define RPG_GAMECORE_HIPPLENINCIDENTCOMMITCONFIG_METHOD_3_AE31E4728DBA66BC_OFFSET UNITYSDK_OFFSET(0x1B687950)
#define RPG_GAMECORE_HIPPLENINCIDENTCOMMITCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B687A10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HipplenIncidentCommitConfig_TypeDefinitionIndex = 16145;
