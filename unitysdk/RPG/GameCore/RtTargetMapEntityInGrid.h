...
#define RPG_GAMECORE_RTTARGETMAPENTITYINGRID_METHOD_3_0B691A46FC7E6B9B_OFFSET UNITYSDK_OFFSET(0x1D4B6560)
#define RPG_GAMECORE_RTTARGETMAPENTITYINGRID_METHOD_3_76C05291B0A2FF7D_OFFSET UNITYSDK_OFFSET(0x1D4B6500)
#define RPG_GAMECORE_RTTARGETMAPENTITYINGRID_METHOD_3_9979BEFBAB552974_OFFSET UNITYSDK_OFFSET(0x1D4B63C0)
#define RPG_GAMECORE_RTTARGETMAPENTITYINGRID_METHOD_3_B912AD69B2B52B0A_OFFSET UNITYSDK_OFFSET(0x1D4B6350)
#define RPG_GAMECORE_RTTARGETMAPENTITYINGRID__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4B63B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtTargetMapEntityInGrid_TypeDefinitionIndex = 23982;
