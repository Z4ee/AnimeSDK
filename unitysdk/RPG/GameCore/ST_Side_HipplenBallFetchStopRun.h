...
#define RPG_GAMECORE_ST_SIDE_HIPPLENBALLFETCHSTOPRUN_METHOD_4_5C14FE3AC74F1762_OFFSET UNITYSDK_OFFSET(0x1B789100)
#define RPG_GAMECORE_ST_SIDE_HIPPLENBALLFETCHSTOPRUN_METHOD_4_A28897986FFC44E9_OFFSET UNITYSDK_OFFSET(0x1B789140)
#define RPG_GAMECORE_ST_SIDE_HIPPLENBALLFETCHSTOPRUN__CTOR_OFFSET UNITYSDK_OFFSET(0x1B789130)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_HipplenBallFetchStopRun_TypeDefinitionIndex = 20513;
