...
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIRTRIGGERPLANEANIM_METHOD_4_23153931A8C47971_OFFSET UNITYSDK_OFFSET(0x1B095370)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIRTRIGGERPLANEANIM_METHOD_4_63BFDA8E012AA0B2_OFFSET UNITYSDK_OFFSET(0x1B095330)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIRTRIGGERPLANEANIM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B095360)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityPixAirTriggerPlaneAnim_TypeDefinitionIndex = 20602;
