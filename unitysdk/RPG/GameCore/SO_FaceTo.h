...
#define RPG_GAMECORE_SO_FACETO_METHOD_4_1529856C796B88E9_OFFSET UNITYSDK_OFFSET(0x1DB2FC80)
#define RPG_GAMECORE_SO_FACETO_METHOD_4_F317D25149634860_OFFSET UNITYSDK_OFFSET(0x1DB2E930)
#define RPG_GAMECORE_SO_FACETO__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB2E920)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SO_FaceTo_TypeDefinitionIndex = 19827;
