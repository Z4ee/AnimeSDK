...
#define RPG_GAMECORE_SO_FACETO_METHOD_4_0B78D8D02807DDBF_OFFSET UNITYSDK_OFFSET(0x18DE0B60)
#define RPG_GAMECORE_SO_FACETO_METHOD_4_F317D25149634860_OFFSET UNITYSDK_OFFSET(0x18DDF760)
#define RPG_GAMECORE_SO_FACETO__CTOR_OFFSET UNITYSDK_OFFSET(0x18DDF730)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SO_FaceTo_TypeDefinitionIndex = 18984;
