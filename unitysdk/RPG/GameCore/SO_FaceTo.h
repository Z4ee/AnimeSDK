...
#define RPG_GAMECORE_SO_FACETO_METHOD_4_0B78D8D02807DDBF_OFFSET UNITYSDK_OFFSET(0x1767D180)
#define RPG_GAMECORE_SO_FACETO_METHOD_4_F317D25149634860_OFFSET UNITYSDK_OFFSET(0x1767BD20)
#define RPG_GAMECORE_SO_FACETO__CTOR_OFFSET UNITYSDK_OFFSET(0x1767BCF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SO_FaceTo_TypeDefinitionIndex = 18337;
