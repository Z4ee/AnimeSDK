...
#define RPG_GAMECORE_ENTERFLOOR_METHOD_3_0157EBAF621AC9A9_OFFSET UNITYSDK_OFFSET(0x196E9B20)
#define RPG_GAMECORE_ENTERFLOOR_METHOD_3_1972C19BE2F191A0_OFFSET UNITYSDK_OFFSET(0x196E9BA0)
#define RPG_GAMECORE_ENTERFLOOR__CTOR_OFFSET UNITYSDK_OFFSET(0x196E9B70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnterFloor_TypeDefinitionIndex = 20355;
