...
#define RPG_GAMECORE_ENTERFLOOR_METHOD_3_1972C19BE2F191A0_OFFSET UNITYSDK_OFFSET(0x1C052AC0)
#define RPG_GAMECORE_ENTERFLOOR_METHOD_3_DF1322DF5CB97D1B_OFFSET UNITYSDK_OFFSET(0x1C052A80)
#define RPG_GAMECORE_ENTERFLOOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1C052AB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnterFloor_TypeDefinitionIndex = 20770;
