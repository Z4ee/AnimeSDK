...
#define RPG_GAMECORE_BYCASTERALIVEORLIMBO_METHOD_4_BF213933AEEFBB70_OFFSET UNITYSDK_OFFSET(0x16FFBEE0)
#define RPG_GAMECORE_BYCASTERALIVEORLIMBO_METHOD_4_CC86FE61A137416E_OFFSET UNITYSDK_OFFSET(0x16FFBE10)
#define RPG_GAMECORE_BYCASTERALIVEORLIMBO__CTOR_OFFSET UNITYSDK_OFFSET(0x16FFBE90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCasterAliveOrLimbo_TypeDefinitionIndex = 21720;
