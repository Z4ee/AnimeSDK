...
#define RPG_GAMECORE_BYCASTERALIVEORLIMBO_METHOD_4_54E0377365185D05_OFFSET UNITYSDK_OFFSET(0x19CBF3B0)
#define RPG_GAMECORE_BYCASTERALIVEORLIMBO_METHOD_4_6E37C832712EAC57_OFFSET UNITYSDK_OFFSET(0x19CBF5A0)
#define RPG_GAMECORE_BYCASTERALIVEORLIMBO_METHOD_4_BF213933AEEFBB70_OFFSET UNITYSDK_OFFSET(0x19CBF3F0)
#define RPG_GAMECORE_BYCASTERALIVEORLIMBO_METHOD_4_E6C8789FF13F3A00_OFFSET UNITYSDK_OFFSET(0x19CBF570)
#define RPG_GAMECORE_BYCASTERALIVEORLIMBO__CTOR_OFFSET UNITYSDK_OFFSET(0x19CBF3E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCasterAliveOrLimbo_TypeDefinitionIndex = 22644;
