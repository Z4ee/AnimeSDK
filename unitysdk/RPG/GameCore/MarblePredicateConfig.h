...
#define RPG_GAMECORE_MARBLEPREDICATECONFIG_METHOD_3_03B3E2F3E296DE5B_OFFSET UNITYSDK_OFFSET(0x18AA2E10)
#define RPG_GAMECORE_MARBLEPREDICATECONFIG_METHOD_3_301930FD20218805_OFFSET UNITYSDK_OFFSET(0x18AA3E40)
#define RPG_GAMECORE_MARBLEPREDICATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18AA4000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarblePredicateConfig_TypeDefinitionIndex = 15932;
