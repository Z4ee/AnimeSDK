...
#define RPG_GAMECORE_FARMSTAGEUNLOCKCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x171BF2E0)
#define RPG_GAMECORE_FARMSTAGEUNLOCKCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x171C0120)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FarmStageUnlockConfigRow_TypeDefinitionIndex = 11458;
	...
	public:
		...
		::System::UInt32 UIEnterBattleArea; // 0x28
		::System::UInt32 OpenInAdvanceLimitUnlockID; // 0x2C
		...
		::System::UInt32 UIEntranceParam; // 0x44
