...
#define RPG_GAMECORE_FORMATIONASSETCONFIG_METHOD_2_68F8E1EA5D323F32_OFFSET UNITYSDK_OFFSET(0x1BEC0370)
#define RPG_GAMECORE_FORMATIONASSETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEC0430)
