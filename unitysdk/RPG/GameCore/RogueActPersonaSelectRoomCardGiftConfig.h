...
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDGIFTCONFIG_METHOD_6_6C6DA6C318280F5A_OFFSET UNITYSDK_OFFSET(0x19AF4350)
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDGIFTCONFIG_METHOD_6_A1BED365A1C729FF_OFFSET UNITYSDK_OFFSET(0x19AF4570)
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDGIFTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AF4490)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaSelectRoomCardGiftConfig_TypeDefinitionIndex = 18743;
