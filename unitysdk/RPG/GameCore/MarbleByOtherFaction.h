...
#define RPG_GAMECORE_MARBLEBYOTHERFACTION_METHOD_4_660BD7690044EF45_OFFSET UNITYSDK_OFFSET(0x1D2311E0)
#define RPG_GAMECORE_MARBLEBYOTHERFACTION_METHOD_4_9F097322B7E777FF_OFFSET UNITYSDK_OFFSET(0x1D231240)
#define RPG_GAMECORE_MARBLEBYOTHERFACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D231230)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleByOtherFaction_TypeDefinitionIndex = 16690;
