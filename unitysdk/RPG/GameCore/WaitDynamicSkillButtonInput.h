...
#define RPG_GAMECORE_WAITDYNAMICSKILLBUTTONINPUT_METHOD_3_47676393FB122213_OFFSET UNITYSDK_OFFSET(0x178F7790)
#define RPG_GAMECORE_WAITDYNAMICSKILLBUTTONINPUT_METHOD_3_4F2AC23CF543E2BB_OFFSET UNITYSDK_OFFSET(0x178F7670)
#define RPG_GAMECORE_WAITDYNAMICSKILLBUTTONINPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x178F7710)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitDynamicSkillButtonInput_TypeDefinitionIndex = 21046;
