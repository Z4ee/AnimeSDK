...
#define RPG_GAMECORE_CHIMERAABILITYENDS_METHOD_3_40BCBA39779C7F10_OFFSET UNITYSDK_OFFSET(0x1C38C9E0)
#define RPG_GAMECORE_CHIMERAABILITYENDS_METHOD_3_83D1CB042BA2515C_OFFSET UNITYSDK_OFFSET(0x1C38CAB0)
#define RPG_GAMECORE_CHIMERAABILITYENDS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C38CAA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraAbilityEnds_TypeDefinitionIndex = 15249;
