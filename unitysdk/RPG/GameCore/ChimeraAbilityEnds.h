...
#define RPG_GAMECORE_CHIMERAABILITYENDS_METHOD_3_40BCBA39779C7F10_OFFSET UNITYSDK_OFFSET(0x17091460)
#define RPG_GAMECORE_CHIMERAABILITYENDS_METHOD_3_83D1CB042BA2515C_OFFSET UNITYSDK_OFFSET(0x17091530)
#define RPG_GAMECORE_CHIMERAABILITYENDS__CTOR_OFFSET UNITYSDK_OFFSET(0x17091520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraAbilityEnds_TypeDefinitionIndex = 14552;
