...
#define RPG_GAMECORE_TRIGGERMODIFIERPHASE1PERFORM_METHOD_3_C93145C385367C07_OFFSET UNITYSDK_OFFSET(0x178CAD40)
#define RPG_GAMECORE_TRIGGERMODIFIERPHASE1PERFORM_METHOD_3_D988AEED1409A973_OFFSET UNITYSDK_OFFSET(0x178CAC30)
#define RPG_GAMECORE_TRIGGERMODIFIERPHASE1PERFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x178CAD10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerModifierPhase1Perform_TypeDefinitionIndex = 21676;
