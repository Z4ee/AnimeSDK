...
#define RPG_GAMECORE_NUMBERCASECONTAINER_METHOD_3_748F142DC5C73C17_OFFSET UNITYSDK_OFFSET(0x174793A0)
#define RPG_GAMECORE_NUMBERCASECONTAINER_METHOD_3_AC84ADEF1784E364_OFFSET UNITYSDK_OFFSET(0x174793E0)
#define RPG_GAMECORE_NUMBERCASECONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x174793D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NumberCaseContainer_TypeDefinitionIndex = 16112;
