...
#define RPG_GAMECORE_NUMBERCASECONTAINER_METHOD_3_29BB0D7CF7379E86_OFFSET UNITYSDK_OFFSET(0x1BAFE520)
#define RPG_GAMECORE_NUMBERCASECONTAINER_METHOD_3_F0E5223BF31F96E1_OFFSET UNITYSDK_OFFSET(0x1BAFE4E0)
#define RPG_GAMECORE_NUMBERCASECONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAFE510)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NumberCaseContainer_TypeDefinitionIndex = 16835;
