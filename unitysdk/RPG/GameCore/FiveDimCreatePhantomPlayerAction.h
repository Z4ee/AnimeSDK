...
#define RPG_GAMECORE_FIVEDIMCREATEPHANTOMPLAYERACTION_METHOD_3_A3E99A16AB256A74_OFFSET UNITYSDK_OFFSET(0x1BA8ECC0)
#define RPG_GAMECORE_FIVEDIMCREATEPHANTOMPLAYERACTION_METHOD_3_DE6DC1C401B13C61_OFFSET UNITYSDK_OFFSET(0x1BA8EC80)
#define RPG_GAMECORE_FIVEDIMCREATEPHANTOMPLAYERACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA8ECB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimCreatePhantomPlayerAction_TypeDefinitionIndex = 17937;
