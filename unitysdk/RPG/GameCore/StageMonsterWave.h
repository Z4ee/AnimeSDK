...
#define RPG_GAMECORE_STAGEMONSTERWAVE_FROMARRAY_OFFSET UNITYSDK_OFFSET(0x18E8EC10)
#define RPG_GAMECORE_STAGEMONSTERWAVE_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18E8E990)
#define RPG_GAMECORE_STAGEMONSTERWAVE_TOLIST_OFFSET UNITYSDK_OFFSET(0x18E8ECD0)
#define RPG_GAMECORE_STAGEMONSTERWAVE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E8EBB0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 Monster1; // 0x18
		::System::UInt32 Monster0; // 0x1C
		::System::UInt32 Monster3; // 0x20
