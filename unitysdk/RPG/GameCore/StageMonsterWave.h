...
#define RPG_GAMECORE_STAGEMONSTERWAVE_FROMARRAY_OFFSET UNITYSDK_OFFSET(0x1D55A060)
#define RPG_GAMECORE_STAGEMONSTERWAVE_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D559DE0)
#define RPG_GAMECORE_STAGEMONSTERWAVE_TOLIST_OFFSET UNITYSDK_OFFSET(0x1D55A110)
#define RPG_GAMECORE_STAGEMONSTERWAVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D55A000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StageMonsterWave_TypeDefinitionIndex = 14968;
	...
	public:
		...
		::System::UInt32 Monster2; // 0x20
		::System::UInt32 Monster4; // 0x24
