...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYROGUELAYERROOMGROUPWEIGHTBYSAVEDVALUECONFIG_METHOD_3_9F71C9D9307CFC64_OFFSET UNITYSDK_OFFSET(0x1D164590)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYROGUELAYERROOMGROUPWEIGHTBYSAVEDVALUECONFIG_METHOD_3_D883D5E1C823E728_OFFSET UNITYSDK_OFFSET(0x1D164540)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYROGUELAYERROOMGROUPWEIGHTBYSAVEDVALUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D164580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyRogueLayerRoomGroupWeightBySavedValueConfig_TypeDefinitionIndex = 17027;
