...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYROGUELAYERROOMGROUPWEIGHTBYSAVEDVALUECONFIG_METHOD_3_9F71C9D9307CFC64_OFFSET UNITYSDK_OFFSET(0x18D424D0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYROGUELAYERROOMGROUPWEIGHTBYSAVEDVALUECONFIG_METHOD_3_F3C03A2F1A26706D_OFFSET UNITYSDK_OFFSET(0x18D42400)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYROGUELAYERROOMGROUPWEIGHTBYSAVEDVALUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D42480)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyRogueLayerRoomGroupWeightBySavedValueConfig_TypeDefinitionIndex = 16850;
