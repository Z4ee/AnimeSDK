...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYROGUELAYERROOMGROUPWEIGHTBYSAVEDVALUECONFIG_METHOD_3_9F71C9D9307CFC64_OFFSET UNITYSDK_OFFSET(0x17635980)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYROGUELAYERROOMGROUPWEIGHTBYSAVEDVALUECONFIG_METHOD_3_F3C03A2F1A26706D_OFFSET UNITYSDK_OFFSET(0x176358B0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYROGUELAYERROOMGROUPWEIGHTBYSAVEDVALUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17635930)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyRogueLayerRoomGroupWeightBySavedValueConfig_TypeDefinitionIndex = 16296;
