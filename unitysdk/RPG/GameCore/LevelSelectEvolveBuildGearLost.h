...
#define RPG_GAMECORE_LEVELSELECTEVOLVEBUILDGEARLOST_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xE69A1E0)
#define RPG_GAMECORE_LEVELSELECTEVOLVEBUILDGEARLOST_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xE69A190)
#define RPG_GAMECORE_LEVELSELECTEVOLVEBUILDGEARLOST_INIT_OFFSET UNITYSDK_OFFSET(0xE69A140)
#define RPG_GAMECORE_LEVELSELECTEVOLVEBUILDGEARLOST__CTOR_OFFSET UNITYSDK_OFFSET(0xE69A230)
