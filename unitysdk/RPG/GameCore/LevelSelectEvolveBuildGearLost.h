...
#define RPG_GAMECORE_LEVELSELECTEVOLVEBUILDGEARLOST_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1DD2B080)
#define RPG_GAMECORE_LEVELSELECTEVOLVEBUILDGEARLOST_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x1DD2B030)
#define RPG_GAMECORE_LEVELSELECTEVOLVEBUILDGEARLOST_INIT_OFFSET UNITYSDK_OFFSET(0x1DD2AFE0)
#define RPG_GAMECORE_LEVELSELECTEVOLVEBUILDGEARLOST__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD2B0D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelSelectEvolveBuildGearLost_TypeDefinitionIndex = 57002;
