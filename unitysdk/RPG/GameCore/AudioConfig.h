...
#define RPG_GAMECORE_AUDIOCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16F8DBC0)
#define RPG_GAMECORE_AUDIOCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16F91320)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AudioConfig_TypeDefinitionIndex = 14990;
