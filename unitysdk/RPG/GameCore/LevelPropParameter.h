...
#define RPG_GAMECORE_LEVELPROPPARAMETER_METHOD_2_7316772C7CE8A717_OFFSET UNITYSDK_OFFSET(0x19889120)
#define RPG_GAMECORE_LEVELPROPPARAMETER_METHOD_2_BCDD42E36CBCCDA5_OFFSET UNITYSDK_OFFSET(0x19889570)
#define RPG_GAMECORE_LEVELPROPPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x198874A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPropParameter_TypeDefinitionIndex = 16404;
