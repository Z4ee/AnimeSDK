...
#define RPG_GAMECORE_LEVELPROPPARAMETER_METHOD_2_7316772C7CE8A717_OFFSET UNITYSDK_OFFSET(0x1734AC10)
#define RPG_GAMECORE_LEVELPROPPARAMETER_METHOD_2_BCDD42E36CBCCDA5_OFFSET UNITYSDK_OFFSET(0x1734B050)
#define RPG_GAMECORE_LEVELPROPPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1734AB10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPropParameter_TypeDefinitionIndex = 15847;
