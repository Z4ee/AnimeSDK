...
#define RPG_GAMECORE_CHIMERADATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1E32C0D0)
#define RPG_GAMECORE_CHIMERADATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1E32C4F0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::ChimeraMemberType Type; // 0x2C
		::System::UInt32 DisplayID; // 0x30
		::RPG::GameCore::ChimeraHornsPartType Horn; // 0x34
		::System::UInt32 ChimeraID; // 0x38
		::RPG::GameCore::ChimeraWingsPartType Wing; // 0x3C
		::RPG::GameCore::ChimeraEyeDetailType Eye; // 0x40
