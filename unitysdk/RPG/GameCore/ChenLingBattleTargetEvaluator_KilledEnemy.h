...
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_KILLEDENEMY_METHOD_3_1D6DF2D29B0E0CE2_OFFSET UNITYSDK_OFFSET(0x19623ED0)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_KILLEDENEMY_METHOD_3_BB6247D173E65363_OFFSET UNITYSDK_OFFSET(0x19623E30)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_KILLEDENEMY__CTOR_OFFSET UNITYSDK_OFFSET(0x19623EC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleTargetEvaluator_KilledEnemy_TypeDefinitionIndex = 14996;
