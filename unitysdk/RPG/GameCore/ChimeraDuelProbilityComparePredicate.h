...
#define RPG_GAMECORE_CHIMERADUELPROBILITYCOMPAREPREDICATE_METHOD_2_EEC130A68813D901_OFFSET UNITYSDK_OFFSET(0x18802430)
#define RPG_GAMECORE_CHIMERADUELPROBILITYCOMPAREPREDICATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18802560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelProbilityComparePredicate_TypeDefinitionIndex = 15142;
