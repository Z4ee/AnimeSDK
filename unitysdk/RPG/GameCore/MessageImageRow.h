...
#define RPG_GAMECORE_MESSAGEIMAGEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x173D4640)
#define RPG_GAMECORE_MESSAGEIMAGEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x173D4BE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MessageImageRow_TypeDefinitionIndex = 13202;
