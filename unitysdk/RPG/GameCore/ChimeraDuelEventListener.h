...
#define RPG_GAMECORE_CHIMERADUELEVENTLISTENER_METHOD_2_FCC9381C9B733BFD_OFFSET UNITYSDK_OFFSET(0x1CFC5940)
#define RPG_GAMECORE_CHIMERADUELEVENTLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFC5AF0)
