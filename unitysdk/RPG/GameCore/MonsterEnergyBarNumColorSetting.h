...
#define RPG_GAMECORE_MONSTERENERGYBARNUMCOLORSETTING_METHOD_2_AA98E4B1C8285579_OFFSET UNITYSDK_OFFSET(0x1D2CEF80)
#define RPG_GAMECORE_MONSTERENERGYBARNUMCOLORSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2CF090)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonsterEnergyBarNumColorSetting_TypeDefinitionIndex = 16956;
