...
#define RPG_GAMECORE_PRELOADMAP_METHOD_3_1D2970ED930FF42F_OFFSET UNITYSDK_OFFSET(0x18C611B0)
#define RPG_GAMECORE_PRELOADMAP_METHOD_3_8B4762048E06EEA6_OFFSET UNITYSDK_OFFSET(0x18C61230)
#define RPG_GAMECORE_PRELOADMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x18C61200)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PreloadMap_TypeDefinitionIndex = 20723;
