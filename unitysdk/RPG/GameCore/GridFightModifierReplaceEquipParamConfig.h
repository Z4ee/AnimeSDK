...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERREPLACEEQUIPPARAMCONFIG_METHOD_3_5332420CD254EFA0_OFFSET UNITYSDK_OFFSET(0x197F33F0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERREPLACEEQUIPPARAMCONFIG_METHOD_3_82EDDB0C3E684B79_OFFSET UNITYSDK_OFFSET(0x197EEA30)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERREPLACEEQUIPPARAMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197EE9E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierReplaceEquipParamConfig_TypeDefinitionIndex = 18384;
