...
#define RPG_GAMECORE_RESTAURANTTRADEORDERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19ADB270)
#define RPG_GAMECORE_RESTAURANTTRADEORDERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19ADB570)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RestaurantTradeOrderRow_TypeDefinitionIndex = 10915;

	class RestaurantTradeOrderRow : public ::System::Object
	{
	public:
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::UInt32>* CostProductMap; // 0x10
		...
		::System::UInt32 DurationDays; // 0x28
