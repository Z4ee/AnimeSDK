...
#define RPG_GAMECORE_ROGUEACTPERSONAOWNERROOMCARDCASTREPLACEOWNERATTRIBUTECONFIG_METHOD_7_BB87D717072EB845_OFFSET UNITYSDK_OFFSET(0x1D02F7E0)
#define RPG_GAMECORE_ROGUEACTPERSONAOWNERROOMCARDCASTREPLACEOWNERATTRIBUTECONFIG_METHOD_7_FA42C81C9E2000C9_OFFSET UNITYSDK_OFFSET(0x1D02F6A0)
#define RPG_GAMECORE_ROGUEACTPERSONAOWNERROOMCARDCASTREPLACEOWNERATTRIBUTECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D02F690)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaOwnerRoomCardCastReplaceOwnerAttributeConfig_TypeDefinitionIndex = 19000;
