...
#define RPG_GAMECORE_ROGUEACTPERSONAOWNERROOMCARDCASTREPLACEOWNERATTRIBUTECONFIG_METHOD_7_93FA2B62168DA694_OFFSET UNITYSDK_OFFSET(0x175BE750)
#define RPG_GAMECORE_ROGUEACTPERSONAOWNERROOMCARDCASTREPLACEOWNERATTRIBUTECONFIG_METHOD_7_FA42C81C9E2000C9_OFFSET UNITYSDK_OFFSET(0x175BE140)
#define RPG_GAMECORE_ROGUEACTPERSONAOWNERROOMCARDCASTREPLACEOWNERATTRIBUTECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175BE060)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaOwnerRoomCardCastReplaceOwnerAttributeConfig_TypeDefinitionIndex = 18112;
