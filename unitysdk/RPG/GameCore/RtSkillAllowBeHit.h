...
#define RPG_GAMECORE_RTSKILLALLOWBEHIT_METHOD_3_2DD195540723E895_OFFSET UNITYSDK_OFFSET(0x18DD62E0)
#define RPG_GAMECORE_RTSKILLALLOWBEHIT_METHOD_3_A1B76331252C6F09_OFFSET UNITYSDK_OFFSET(0x18DD63F0)
#define RPG_GAMECORE_RTSKILLALLOWBEHIT__CTOR_OFFSET UNITYSDK_OFFSET(0x18DD63C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtSkillAllowBeHit_TypeDefinitionIndex = 23220;
