...
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_SETEMOTION_METHOD_4_92E5F86395E0D76E_OFFSET UNITYSDK_OFFSET(0x18DF8C40)
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_SETEMOTION_METHOD_4_E794791DDAA61341_OFFSET UNITYSDK_OFFSET(0x18DF8B20)
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_SETEMOTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18DF8BC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_Hipplen_SetEmotion_TypeDefinitionIndex = 20289;
