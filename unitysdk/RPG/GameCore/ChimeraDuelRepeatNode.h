...
#define RPG_GAMECORE_CHIMERADUELREPEATNODE_METHOD_3_4D0FF560C8B2059C_OFFSET UNITYSDK_OFFSET(0x170A4B40)
#define RPG_GAMECORE_CHIMERADUELREPEATNODE_METHOD_3_B3310FEF4F689997_OFFSET UNITYSDK_OFFSET(0x170A4C20)
#define RPG_GAMECORE_CHIMERADUELREPEATNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x170A4BD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelRepeatNode_TypeDefinitionIndex = 14676;
