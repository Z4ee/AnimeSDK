...
#define RPG_GAMECORE_ST_SIDE_ELFINTERACTCURRENTSLOT_METHOD_4_6B711B79EE3DF280_OFFSET UNITYSDK_OFFSET(0x1DB41C40)
#define RPG_GAMECORE_ST_SIDE_ELFINTERACTCURRENTSLOT_METHOD_4_77E6900AC58C81A1_OFFSET UNITYSDK_OFFSET(0x1DB41BF0)
#define RPG_GAMECORE_ST_SIDE_ELFINTERACTCURRENTSLOT__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB41C30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_ElfInteractCurrentSlot_TypeDefinitionIndex = 21294;
