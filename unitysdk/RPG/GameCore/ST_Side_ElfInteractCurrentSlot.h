...
#define RPG_GAMECORE_ST_SIDE_ELFINTERACTCURRENTSLOT_METHOD_4_40C0748E509073EC_OFFSET UNITYSDK_OFFSET(0x19C19DD0)
#define RPG_GAMECORE_ST_SIDE_ELFINTERACTCURRENTSLOT_METHOD_4_6B711B79EE3DF280_OFFSET UNITYSDK_OFFSET(0x19C08880)
#define RPG_GAMECORE_ST_SIDE_ELFINTERACTCURRENTSLOT__CTOR_OFFSET UNITYSDK_OFFSET(0x19C08820)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_ElfInteractCurrentSlot_TypeDefinitionIndex = 20344;
