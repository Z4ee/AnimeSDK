...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETMAXROLENUMCONFIG_METHOD_6_2338B16E4D9B0DF3_OFFSET UNITYSDK_OFFSET(0x17271830)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETMAXROLENUMCONFIG_METHOD_6_C7E69584065174DD_OFFSET UNITYSDK_OFFSET(0x17271AE0)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETMAXROLENUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x172719B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightParamGetMaxRoleNumConfig_TypeDefinitionIndex = 17881;
