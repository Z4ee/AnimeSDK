...
#define RPG_GAMECORE_LITTLEGAMEREQUIREMISSIONINFO_METHOD_2_BD7DF0D6BB9F5798_OFFSET UNITYSDK_OFFSET(0x1BCC4970)
#define RPG_GAMECORE_LITTLEGAMEREQUIREMISSIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCC4A30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameRequireMissionInfo_TypeDefinitionIndex = 16643;
