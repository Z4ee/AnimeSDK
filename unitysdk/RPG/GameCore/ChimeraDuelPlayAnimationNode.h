...
#define RPG_GAMECORE_CHIMERADUELPLAYANIMATIONNODE_METHOD_3_2782CAFB9302087C_OFFSET UNITYSDK_OFFSET(0x18801370)
#define RPG_GAMECORE_CHIMERADUELPLAYANIMATIONNODE_METHOD_3_B19A607B64C22A9D_OFFSET UNITYSDK_OFFSET(0x18801290)
#define RPG_GAMECORE_CHIMERADUELPLAYANIMATIONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x18801320)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelPlayAnimationNode_TypeDefinitionIndex = 15110;
