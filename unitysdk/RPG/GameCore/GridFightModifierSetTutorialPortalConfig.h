...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETTUTORIALPORTALCONFIG_METHOD_3_36B23D8515C954B4_OFFSET UNITYSDK_OFFSET(0x189BF680)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETTUTORIALPORTALCONFIG_METHOD_3_BA6DFFDFDDBC75FD_OFFSET UNITYSDK_OFFSET(0x189BF5B0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETTUTORIALPORTALCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189BF630)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierSetTutorialPortalConfig_TypeDefinitionIndex = 18467;
