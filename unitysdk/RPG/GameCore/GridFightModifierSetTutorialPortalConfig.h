...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETTUTORIALPORTALCONFIG_METHOD_3_36B23D8515C954B4_OFFSET UNITYSDK_OFFSET(0x17269780)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETTUTORIALPORTALCONFIG_METHOD_3_BA6DFFDFDDBC75FD_OFFSET UNITYSDK_OFFSET(0x1726C2C0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETTUTORIALPORTALCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17269730)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierSetTutorialPortalConfig_TypeDefinitionIndex = 17845;
