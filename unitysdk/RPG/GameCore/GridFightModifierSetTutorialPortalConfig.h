...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETTUTORIALPORTALCONFIG_METHOD_3_36B23D8515C954B4_OFFSET UNITYSDK_OFFSET(0x1D06AF70)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETTUTORIALPORTALCONFIG_METHOD_3_939A28E3C8890238_OFFSET UNITYSDK_OFFSET(0x1D06AF20)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETTUTORIALPORTALCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D06AF60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierSetTutorialPortalConfig_TypeDefinitionIndex = 18687;
