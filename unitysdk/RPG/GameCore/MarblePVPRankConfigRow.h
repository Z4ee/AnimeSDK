...
#define RPG_GAMECORE_MARBLEPVPRANKCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D2386E0)
#define RPG_GAMECORE_MARBLEPVPRANKCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D238AB0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::MultiPlayerGameMode GameMode; // 0x5C
