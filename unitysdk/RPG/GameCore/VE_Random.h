...
#define RPG_GAMECORE_VE_RANDOM_METHOD_3_258C5F8635893DE3_OFFSET UNITYSDK_OFFSET(0x1DEA2970)
#define RPG_GAMECORE_VE_RANDOM_METHOD_3_3C789168D44C7839_OFFSET UNITYSDK_OFFSET(0x1DEA1EB0)
#define RPG_GAMECORE_VE_RANDOM_METHOD_3_5C7994F660A29AC4_OFFSET UNITYSDK_OFFSET(0x1DEA1E70)
#define RPG_GAMECORE_VE_RANDOM_METHOD_3_A0201EBC8784EC74_OFFSET UNITYSDK_OFFSET(0x1DEA29A0)
#define RPG_GAMECORE_VE_RANDOM__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEA1EA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VE_Random_TypeDefinitionIndex = 23769;
