...
#define RPG_GAMECORE_RESIDENTPOSSESSIONCONFIG_METHOD_2_77CB37C830722391_OFFSET UNITYSDK_OFFSET(0x1D3A6520)
#define RPG_GAMECORE_RESIDENTPOSSESSIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3A66B0)
