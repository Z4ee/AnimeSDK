...
#define RPG_GAMECORE_MATCHTHREEDRAGTUTORIAL_METHOD_3_48814FEB1C1D5764_OFFSET UNITYSDK_OFFSET(0x173AFFD0)
#define RPG_GAMECORE_MATCHTHREEDRAGTUTORIAL_METHOD_3_9CF3AD81804B8CF5_OFFSET UNITYSDK_OFFSET(0x173B0050)
#define RPG_GAMECORE_MATCHTHREEDRAGTUTORIAL__CTOR_OFFSET UNITYSDK_OFFSET(0x173B0020)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MatchThreeDragTutorial_TypeDefinitionIndex = 19316;
