...
#define RPG_GAMECORE_DEVTALKINFO_METHOD_2_1BD0C0DC0C858228_OFFSET UNITYSDK_OFFSET(0x1969BEE0)
#define RPG_GAMECORE_DEVTALKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1969C060)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DevTalkInfo_TypeDefinitionIndex = 19967;
