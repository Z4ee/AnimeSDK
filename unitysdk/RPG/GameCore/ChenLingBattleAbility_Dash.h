...
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_DASH_METHOD_3_021E73698F5D7F68_OFFSET UNITYSDK_OFFSET(0x1CFA55C0)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_DASH_METHOD_3_4D64A6869448CD1B_OFFSET UNITYSDK_OFFSET(0x1CFA5560)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_DASH__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFA55B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleAbility_Dash_TypeDefinitionIndex = 15559;
