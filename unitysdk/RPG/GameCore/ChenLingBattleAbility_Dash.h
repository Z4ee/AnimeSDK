...
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_DASH_METHOD_3_94798A74CF4D3DC3_OFFSET UNITYSDK_OFFSET(0x17079E80)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_DASH_METHOD_3_DA1005979443DEF4_OFFSET UNITYSDK_OFFSET(0x17079E20)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_DASH__CTOR_OFFSET UNITYSDK_OFFSET(0x17079E70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleAbility_Dash_TypeDefinitionIndex = 14425;
