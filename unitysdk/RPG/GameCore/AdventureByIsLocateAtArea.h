...
#define RPG_GAMECORE_ADVENTUREBYISLOCATEATAREA_METHOD_4_9764DCFD542A3144_OFFSET UNITYSDK_OFFSET(0x1866FB40)
#define RPG_GAMECORE_ADVENTUREBYISLOCATEATAREA_METHOD_4_F5C2609161ED58FF_OFFSET UNITYSDK_OFFSET(0x1866FC60)
#define RPG_GAMECORE_ADVENTUREBYISLOCATEATAREA__CTOR_OFFSET UNITYSDK_OFFSET(0x1866FBE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureByIsLocateAtArea_TypeDefinitionIndex = 19760;
