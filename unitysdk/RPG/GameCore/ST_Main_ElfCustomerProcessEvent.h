...
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMERPROCESSEVENT_METHOD_4_4518ACDA1F4D8056_OFFSET UNITYSDK_OFFSET(0x1B7819E0)
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMERPROCESSEVENT_METHOD_4_45E57C6B0FAC5D93_OFFSET UNITYSDK_OFFSET(0x1B781910)
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMERPROCESSEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7819D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_ElfCustomerProcessEvent_TypeDefinitionIndex = 20730;
