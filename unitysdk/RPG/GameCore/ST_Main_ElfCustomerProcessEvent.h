...
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMERPROCESSEVENT_METHOD_4_4518ACDA1F4D8056_OFFSET UNITYSDK_OFFSET(0x19BFF790)
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMERPROCESSEVENT_METHOD_4_66731ED30B7AF521_OFFSET UNITYSDK_OFFSET(0x19C17800)
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMERPROCESSEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19BFF740)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_ElfCustomerProcessEvent_TypeDefinitionIndex = 20336;
