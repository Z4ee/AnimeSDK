...
#define RPG_GAMECORE_PROPWATERWHEELSTOPROTATE_METHOD_3_231C5BB02AD4BBC2_OFFSET UNITYSDK_OFFSET(0x17572900)
#define RPG_GAMECORE_PROPWATERWHEELSTOPROTATE_METHOD_3_E05690554F380F99_OFFSET UNITYSDK_OFFSET(0x17572B10)
#define RPG_GAMECORE_PROPWATERWHEELSTOPROTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x17572A20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropWaterWheelStopRotate_TypeDefinitionIndex = 20339;
