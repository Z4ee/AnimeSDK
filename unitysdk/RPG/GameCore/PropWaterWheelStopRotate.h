...
#define RPG_GAMECORE_PROPWATERWHEELSTOPROTATE_METHOD_3_9B4718B42864399C_OFFSET UNITYSDK_OFFSET(0x1D376010)
#define RPG_GAMECORE_PROPWATERWHEELSTOPROTATE_METHOD_3_E05690554F380F99_OFFSET UNITYSDK_OFFSET(0x1D376130)
#define RPG_GAMECORE_PROPWATERWHEELSTOPROTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3760B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropWaterWheelStopRotate_TypeDefinitionIndex = 21906;
