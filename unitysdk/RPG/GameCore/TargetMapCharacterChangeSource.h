...
#define RPG_GAMECORE_TARGETMAPCHARACTERCHANGESOURCE_METHOD_3_018062C2DA2CD7D7_OFFSET UNITYSDK_OFFSET(0x1D5B2A30)
#define RPG_GAMECORE_TARGETMAPCHARACTERCHANGESOURCE_METHOD_3_AACDA6004FD3887A_OFFSET UNITYSDK_OFFSET(0x1D5B2B10)
#define RPG_GAMECORE_TARGETMAPCHARACTERCHANGESOURCE_METHOD_3_BFD2CDFFC8FF7CAB_OFFSET UNITYSDK_OFFSET(0x1D5B2BD0)
#define RPG_GAMECORE_TARGETMAPCHARACTERCHANGESOURCE_METHOD_3_F9D3429DF9E2ED1E_OFFSET UNITYSDK_OFFSET(0x1D5B2C00)
#define RPG_GAMECORE_TARGETMAPCHARACTERCHANGESOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5B2B00)
