...
#define RPG_GAMECORE_TARGETMAPCHARACTERCHANGESOURCE_METHOD_3_003DB2681021A24E_OFFSET UNITYSDK_OFFSET(0x18EE7DC0)
#define RPG_GAMECORE_TARGETMAPCHARACTERCHANGESOURCE_METHOD_3_AACDA6004FD3887A_OFFSET UNITYSDK_OFFSET(0x18EE7EF0)
#define RPG_GAMECORE_TARGETMAPCHARACTERCHANGESOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x18EE7ED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapCharacterChangeSource_TypeDefinitionIndex = 22968;
