...
#define RPG_GAMECORE_HIPPLENREQUIRESTATGRADE_METHOD_2_E0425783447AA390_OFFSET UNITYSDK_OFFSET(0x172ADEA0)
#define RPG_GAMECORE_HIPPLENREQUIRESTATGRADE__CTOR_OFFSET UNITYSDK_OFFSET(0x172B0EE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HipplenRequireStatGrade_TypeDefinitionIndex = 15372;
