...
#define RPG_GAMECORE_SETDYNAMICVALUEBYATTACKDAMAGEDATA_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1C2DE980)
#define RPG_GAMECORE_SETDYNAMICVALUEBYATTACKDAMAGEDATA_METHOD_4_46AA7ECDD53029DC_OFFSET UNITYSDK_OFFSET(0x1C2DE720)
#define RPG_GAMECORE_SETDYNAMICVALUEBYATTACKDAMAGEDATA_METHOD_4_BC02C2C1238B0549_OFFSET UNITYSDK_OFFSET(0x1C2DE760)
#define RPG_GAMECORE_SETDYNAMICVALUEBYATTACKDAMAGEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2DE750)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByAttackDamageData_TypeDefinitionIndex = 22749;
