...
#define RPG_GAMECORE_SETDYNAMICVALUEBYATTACKDAMAGEDATA_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x18E1CB80)
#define RPG_GAMECORE_SETDYNAMICVALUEBYATTACKDAMAGEDATA_METHOD_4_727FA11B1DAE89B1_OFFSET UNITYSDK_OFFSET(0x18E1CB00)
#define RPG_GAMECORE_SETDYNAMICVALUEBYATTACKDAMAGEDATA_METHOD_4_BC02C2C1238B0549_OFFSET UNITYSDK_OFFSET(0x18E1A210)
#define RPG_GAMECORE_SETDYNAMICVALUEBYATTACKDAMAGEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18E1A1C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByAttackDamageData_TypeDefinitionIndex = 22573;
