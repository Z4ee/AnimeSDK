...
#define RPG_GAMECORE_DRINKMAKERCHEERSGUESTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17177750)
#define RPG_GAMECORE_DRINKMAKERCHEERSGUESTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17177B00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DrinkMakerCheersGuestRow_TypeDefinitionIndex = 12058;
	...
	public:
		...
		::System::UInt32 FinishSettlementPerformanceID; // 0x28
		::System::UInt32 GroupID; // 0x2C
		::RPG::Client::TextID SurpriseRequest; // 0x30
		::System::UInt32 ID; // 0x40
		::System::UInt32 OneMoreDrinkPerformanceID; // 0x44
