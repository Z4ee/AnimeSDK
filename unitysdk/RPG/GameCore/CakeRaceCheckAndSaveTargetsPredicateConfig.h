...
#define RPG_GAMECORE_CAKERACECHECKANDSAVETARGETSPREDICATECONFIG_METHOD_3_765222DF2DC6A623_OFFSET UNITYSDK_OFFSET(0x195EC3B0)
#define RPG_GAMECORE_CAKERACECHECKANDSAVETARGETSPREDICATECONFIG_METHOD_3_7EFC688FAB9BB97B_OFFSET UNITYSDK_OFFSET(0x195E9040)
#define RPG_GAMECORE_CAKERACECHECKANDSAVETARGETSPREDICATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x195E9030)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceCheckAndSaveTargetsPredicateConfig_TypeDefinitionIndex = 17476;
