...
#define RPG_GAMECORE_PROPESCALATORMOVESTART_METHOD_3_14635948DA1A68F6_OFFSET UNITYSDK_OFFSET(0x1BA20030)
#define RPG_GAMECORE_PROPESCALATORMOVESTART_METHOD_3_C1F7128735689589_OFFSET UNITYSDK_OFFSET(0x1BA1FF90)
#define RPG_GAMECORE_PROPESCALATORMOVESTART__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA1FFF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropEscalatorMoveStart_TypeDefinitionIndex = 20229;
