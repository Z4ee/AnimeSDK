...
#define RPG_GAMECORE_PROPESCALATORMOVESTART_METHOD_3_14635948DA1A68F6_OFFSET UNITYSDK_OFFSET(0x18C6ABE0)
#define RPG_GAMECORE_PROPESCALATORMOVESTART_METHOD_3_A55A6723DE75D292_OFFSET UNITYSDK_OFFSET(0x18C6AB10)
#define RPG_GAMECORE_PROPESCALATORMOVESTART__CTOR_OFFSET UNITYSDK_OFFSET(0x18C6AB90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropEscalatorMoveStart_TypeDefinitionIndex = 20003;
