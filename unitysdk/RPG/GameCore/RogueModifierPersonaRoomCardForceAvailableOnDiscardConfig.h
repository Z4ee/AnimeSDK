...
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAROOMCARDFORCEAVAILABLEONDISCARDCONFIG_METHOD_3_021EB156A7B6FDA2_OFFSET UNITYSDK_OFFSET(0x1D165250)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAROOMCARDFORCEAVAILABLEONDISCARDCONFIG_METHOD_3_C9CFF0857D7E9106_OFFSET UNITYSDK_OFFSET(0x1D165200)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAROOMCARDFORCEAVAILABLEONDISCARDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D165240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierPersonaRoomCardForceAvailableOnDiscardConfig_TypeDefinitionIndex = 17086;
