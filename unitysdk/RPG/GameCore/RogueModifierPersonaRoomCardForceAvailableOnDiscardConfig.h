...
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAROOMCARDFORCEAVAILABLEONDISCARDCONFIG_METHOD_3_021EB156A7B6FDA2_OFFSET UNITYSDK_OFFSET(0x19B9A270)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAROOMCARDFORCEAVAILABLEONDISCARDCONFIG_METHOD_3_BF8F2BBAACD8F0AB_OFFSET UNITYSDK_OFFSET(0x19B9A1A0)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAROOMCARDFORCEAVAILABLEONDISCARDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B9A220)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierPersonaRoomCardForceAvailableOnDiscardConfig_TypeDefinitionIndex = 16924;
