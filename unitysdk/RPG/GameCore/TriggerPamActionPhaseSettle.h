...
#define RPG_GAMECORE_TRIGGERPAMACTIONPHASESETTLE_METHOD_3_0B0AACFD3204AE8B_OFFSET UNITYSDK_OFFSET(0x19E18F40)
#define RPG_GAMECORE_TRIGGERPAMACTIONPHASESETTLE_METHOD_3_39E21FE64A37CDFF_OFFSET UNITYSDK_OFFSET(0x19E19050)
#define RPG_GAMECORE_TRIGGERPAMACTIONPHASESETTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x19E19020)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerPamActionPhaseSettle_TypeDefinitionIndex = 18907;
