...
#define RPG_GAMECORE_TRIGGERPAMACTIONPHASESETTLE_METHOD_3_0B0AACFD3204AE8B_OFFSET UNITYSDK_OFFSET(0x178CB370)
#define RPG_GAMECORE_TRIGGERPAMACTIONPHASESETTLE_METHOD_3_39E21FE64A37CDFF_OFFSET UNITYSDK_OFFSET(0x178CB480)
#define RPG_GAMECORE_TRIGGERPAMACTIONPHASESETTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x178CB450)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerPamActionPhaseSettle_TypeDefinitionIndex = 18306;
