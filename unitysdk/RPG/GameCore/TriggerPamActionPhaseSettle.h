...
#define RPG_GAMECORE_TRIGGERPAMACTIONPHASESETTLE_METHOD_3_39E21FE64A37CDFF_OFFSET UNITYSDK_OFFSET(0x1D6025A0)
#define RPG_GAMECORE_TRIGGERPAMACTIONPHASESETTLE_METHOD_3_5FAB6C5A81B198C2_OFFSET UNITYSDK_OFFSET(0x1D6024D0)
#define RPG_GAMECORE_TRIGGERPAMACTIONPHASESETTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D602590)
