...
#define RPG_GAMECORE_ALLEYCONDITIONEXTENDPARAM_METHOD_2_0D26B86779257F3C_OFFSET UNITYSDK_OFFSET(0x19466C90)
#define RPG_GAMECORE_ALLEYCONDITIONEXTENDPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x19466D90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AlleyConditionExtendParam_TypeDefinitionIndex = 14903;
