...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYWORKBENCHMAGICSCEPTERSHOPCONFIG_METHOD_3_7BEC950BFA48B828_OFFSET UNITYSDK_OFFSET(0x1D164D10)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYWORKBENCHMAGICSCEPTERSHOPCONFIG_METHOD_3_B2E3343B2760B4AC_OFFSET UNITYSDK_OFFSET(0x1D164CC0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYWORKBENCHMAGICSCEPTERSHOPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D164D00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyWorkbenchMagicScepterShopConfig_TypeDefinitionIndex = 17156;
