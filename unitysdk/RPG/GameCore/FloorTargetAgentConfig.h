...
#define RPG_GAMECORE_FLOORTARGETAGENTCONFIG_METHOD_3_667523E56EBF73E3_OFFSET UNITYSDK_OFFSET(0x1BEBD280)
#define RPG_GAMECORE_FLOORTARGETAGENTCONFIG_METHOD_3_67F6D74BF3FD5E04_OFFSET UNITYSDK_OFFSET(0x1BEBCC10)
#define RPG_GAMECORE_FLOORTARGETAGENTCONFIG_METHOD_3_692C8BDC7229A99A_OFFSET UNITYSDK_OFFSET(0x1BEBC4A0)
#define RPG_GAMECORE_FLOORTARGETAGENTCONFIG_METHOD_3_E3ED40292774A19A_OFFSET UNITYSDK_OFFSET(0x1BEBD2B0)
#define RPG_GAMECORE_FLOORTARGETAGENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEBC490)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FloorTargetAgentConfig_TypeDefinitionIndex = 17552;
