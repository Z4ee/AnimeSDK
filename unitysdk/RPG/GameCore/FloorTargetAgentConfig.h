...
#define RPG_GAMECORE_FLOORTARGETAGENTCONFIG_METHOD_3_667523E56EBF73E3_OFFSET UNITYSDK_OFFSET(0x17214F00)
#define RPG_GAMECORE_FLOORTARGETAGENTCONFIG_METHOD_3_692C8BDC7229A99A_OFFSET UNITYSDK_OFFSET(0x17214870)
#define RPG_GAMECORE_FLOORTARGETAGENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17214860)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FloorTargetAgentConfig_TypeDefinitionIndex = 16780;
