...
#define RPG_GAMECORE_REDDOTGRAPHCONFIG_METHOD_2_CCDAC0D6CEB90D6D_OFFSET UNITYSDK_OFFSET(0x1DB7D5D0)
#define RPG_GAMECORE_REDDOTGRAPHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB7D690)
