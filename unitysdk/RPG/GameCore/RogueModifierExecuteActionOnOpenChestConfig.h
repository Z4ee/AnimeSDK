...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONOPENCHESTCONFIG_METHOD_3_F57AAAE97BB5EF53_OFFSET UNITYSDK_OFFSET(0x1CFC08B0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONOPENCHESTCONFIG_METHOD_3_FE43EEE3EFA06F8F_OFFSET UNITYSDK_OFFSET(0x1CFC0860)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONOPENCHESTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFC08A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnOpenChestConfig_TypeDefinitionIndex = 16979;
