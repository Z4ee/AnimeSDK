...
#define RPG_GAMECORE_ADVDISABLEPLAYERLOCKTARGET_METHOD_3_1429C3FF32348E7A_OFFSET UNITYSDK_OFFSET(0x1CDC5CC0)
#define RPG_GAMECORE_ADVDISABLEPLAYERLOCKTARGET_METHOD_3_2D7FBEBEB8263D71_OFFSET UNITYSDK_OFFSET(0x1CDC5C80)
#define RPG_GAMECORE_ADVDISABLEPLAYERLOCKTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDC5CB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvDisablePlayerLockTarget_TypeDefinitionIndex = 20322;
