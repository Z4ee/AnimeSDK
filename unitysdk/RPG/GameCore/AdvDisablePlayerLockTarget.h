...
#define RPG_GAMECORE_ADVDISABLEPLAYERLOCKTARGET_METHOD_3_1429C3FF32348E7A_OFFSET UNITYSDK_OFFSET(0x1864CC90)
#define RPG_GAMECORE_ADVDISABLEPLAYERLOCKTARGET_METHOD_3_96F495DD97951803_OFFSET UNITYSDK_OFFSET(0x1864CC10)
#define RPG_GAMECORE_ADVDISABLEPLAYERLOCKTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1864CC60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvDisablePlayerLockTarget_TypeDefinitionIndex = 19526;
