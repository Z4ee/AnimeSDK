...
#define RPG_GAMECORE_TOGGLEHITCOUNTUITOP_METHOD_3_579A2E3EADF5CE17_OFFSET UNITYSDK_OFFSET(0x1909FAA0)
#define RPG_GAMECORE_TOGGLEHITCOUNTUITOP_METHOD_3_FEC5E0E7D69183C7_OFFSET UNITYSDK_OFFSET(0x1909F9D0)
#define RPG_GAMECORE_TOGGLEHITCOUNTUITOP__CTOR_OFFSET UNITYSDK_OFFSET(0x1909FA50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ToggleHitCountUITop_TypeDefinitionIndex = 22105;
