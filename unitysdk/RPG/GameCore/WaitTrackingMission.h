...
#define RPG_GAMECORE_WAITTRACKINGMISSION_METHOD_3_435F991BB1F935F6_OFFSET UNITYSDK_OFFSET(0x17906C70)
#define RPG_GAMECORE_WAITTRACKINGMISSION_METHOD_3_475152BF63673DAF_OFFSET UNITYSDK_OFFSET(0x17906CF0)
#define RPG_GAMECORE_WAITTRACKINGMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x17906CC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitTrackingMission_TypeDefinitionIndex = 19458;
