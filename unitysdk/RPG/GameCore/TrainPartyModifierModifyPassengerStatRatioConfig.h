...
#define RPG_GAMECORE_TRAINPARTYMODIFIERMODIFYPASSENGERSTATRATIOCONFIG_METHOD_3_A44A26093E9F91E9_OFFSET UNITYSDK_OFFSET(0x190ABDF0)
#define RPG_GAMECORE_TRAINPARTYMODIFIERMODIFYPASSENGERSTATRATIOCONFIG_METHOD_3_ADB9A763B5E9096D_OFFSET UNITYSDK_OFFSET(0x190ABB70)
#define RPG_GAMECORE_TRAINPARTYMODIFIERMODIFYPASSENGERSTATRATIOCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x190ABB60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyModifierModifyPassengerStatRatioConfig_TypeDefinitionIndex = 17210;
