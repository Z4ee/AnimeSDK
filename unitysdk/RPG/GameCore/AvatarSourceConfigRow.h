...
#define RPG_GAMECORE_AVATARSOURCECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B2DFF50)
#define RPG_GAMECORE_AVATARSOURCECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2E0040)
