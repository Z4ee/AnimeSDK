...
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTINFECTCONFIG_METHOD_7_6EB84EDFEB5C0254_OFFSET UNITYSDK_OFFSET(0x1D0305C0)
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTINFECTCONFIG_METHOD_7_8B0499579EA6B850_OFFSET UNITYSDK_OFFSET(0x1D030460)
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTINFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D030450)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaSelectRoomCardCastInfectConfig_TypeDefinitionIndex = 18966;
