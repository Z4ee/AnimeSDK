...
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTINFECTCONFIG_METHOD_7_84B49F9CA53DBADD_OFFSET UNITYSDK_OFFSET(0x175C32A0)
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTINFECTCONFIG_METHOD_7_8B0499579EA6B850_OFFSET UNITYSDK_OFFSET(0x175C2920)
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTINFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175C2840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaSelectRoomCardCastInfectConfig_TypeDefinitionIndex = 18078;
