...
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTINFECTCONFIG_METHOD_7_84B49F9CA53DBADD_OFFSET UNITYSDK_OFFSET(0x18CCF010)
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTINFECTCONFIG_METHOD_7_8B0499579EA6B850_OFFSET UNITYSDK_OFFSET(0x18CCE690)
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTINFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CCE5B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaSelectRoomCardCastInfectConfig_TypeDefinitionIndex = 18723;
