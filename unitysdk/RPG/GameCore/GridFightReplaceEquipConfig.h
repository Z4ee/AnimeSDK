...
#define RPG_GAMECORE_GRIDFIGHTREPLACEEQUIPCONFIG_METHOD_2_9E9871DC4C4B73EC_OFFSET UNITYSDK_OFFSET(0x189D1780)
#define RPG_GAMECORE_GRIDFIGHTREPLACEEQUIPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189D17C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightReplaceEquipConfig_TypeDefinitionIndex = 18495;
