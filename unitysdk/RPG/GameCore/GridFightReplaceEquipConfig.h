...
#define RPG_GAMECORE_GRIDFIGHTREPLACEEQUIPCONFIG_METHOD_2_9E9871DC4C4B73EC_OFFSET UNITYSDK_OFFSET(0x1D0717A0)
#define RPG_GAMECORE_GRIDFIGHTREPLACEEQUIPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0717E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightReplaceEquipConfig_TypeDefinitionIndex = 18717;
