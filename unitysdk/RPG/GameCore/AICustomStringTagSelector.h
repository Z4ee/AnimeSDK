...
#define RPG_GAMECORE_AICUSTOMSTRINGTAGSELECTOR_METHOD_3_17CEE27A01772414_OFFSET UNITYSDK_OFFSET(0x193C0830)
#define RPG_GAMECORE_AICUSTOMSTRINGTAGSELECTOR_METHOD_3_89E1FE26047591DB_OFFSET UNITYSDK_OFFSET(0x193C0870)
#define RPG_GAMECORE_AICUSTOMSTRINGTAGSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x193C0860)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AICustomStringTagSelector_TypeDefinitionIndex = 14826;
