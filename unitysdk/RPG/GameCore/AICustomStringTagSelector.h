...
#define RPG_GAMECORE_AICUSTOMSTRINGTAGSELECTOR_METHOD_3_17CEE27A01772414_OFFSET UNITYSDK_OFFSET(0x185EFAE0)
#define RPG_GAMECORE_AICUSTOMSTRINGTAGSELECTOR_METHOD_3_89E1FE26047591DB_OFFSET UNITYSDK_OFFSET(0x185EFB20)
#define RPG_GAMECORE_AICUSTOMSTRINGTAGSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x185EFB10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AICustomStringTagSelector_TypeDefinitionIndex = 14761;
