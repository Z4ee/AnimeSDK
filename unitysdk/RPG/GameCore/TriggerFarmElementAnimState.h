...
#define RPG_GAMECORE_TRIGGERFARMELEMENTANIMSTATE_METHOD_3_A0521901D492545F_OFFSET UNITYSDK_OFFSET(0x178C7600)
#define RPG_GAMECORE_TRIGGERFARMELEMENTANIMSTATE_METHOD_3_E0FE990A761437C9_OFFSET UNITYSDK_OFFSET(0x178C76A0)
#define RPG_GAMECORE_TRIGGERFARMELEMENTANIMSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x178C7660)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerFarmElementAnimState_TypeDefinitionIndex = 20274;
