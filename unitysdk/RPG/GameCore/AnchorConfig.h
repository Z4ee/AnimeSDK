...
#define RPG_GAMECORE_ANCHORCONFIG_METHOD_2_8E79BBCF1255750F_OFFSET UNITYSDK_OFFSET(0x19478AD0)
#define RPG_GAMECORE_ANCHORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19478B10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AnchorConfig_TypeDefinitionIndex = 10256;
