...
#define RPG_GAMECORE_VE_VALUE_METHOD_3_04470492C3FB332E_OFFSET UNITYSDK_OFFSET(0x1B895590)
#define RPG_GAMECORE_VE_VALUE_METHOD_3_2D3179C5FA9905D7_OFFSET UNITYSDK_OFFSET(0x1B895550)
#define RPG_GAMECORE_VE_VALUE_METHOD_3_43B52C1C1A31F803_OFFSET UNITYSDK_OFFSET(0x1B895760)
#define RPG_GAMECORE_VE_VALUE_METHOD_3_64AFAF0DC17ED475_OFFSET UNITYSDK_OFFSET(0x1B895730)
#define RPG_GAMECORE_VE_VALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B895580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VE_Value_TypeDefinitionIndex = 23186;
