...
#define RPG_GAMECORE_ROGUEMODIFIERREFRESHBUFFSELECTGUARANTEEDAEONCONFIG_METHOD_3_6B87E95E17621B96_OFFSET UNITYSDK_OFFSET(0x18D448C0)
#define RPG_GAMECORE_ROGUEMODIFIERREFRESHBUFFSELECTGUARANTEEDAEONCONFIG_METHOD_3_85C7463ED3870ACF_OFFSET UNITYSDK_OFFSET(0x18D44990)
#define RPG_GAMECORE_ROGUEMODIFIERREFRESHBUFFSELECTGUARANTEEDAEONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D44940)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierRefreshBuffSelectGuaranteedAeonConfig_TypeDefinitionIndex = 17051;
