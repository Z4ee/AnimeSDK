...
#define RPG_GAMECORE_GROUPSTATE_METHOD_2_9792F54AA0062613_OFFSET UNITYSDK_OFFSET(0x1728D110)
#define RPG_GAMECORE_GROUPSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1728D250)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GroupState_TypeDefinitionIndex = 15913;
