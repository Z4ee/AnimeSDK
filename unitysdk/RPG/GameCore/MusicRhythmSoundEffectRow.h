...
#define RPG_GAMECORE_MUSICRHYTHMSOUNDEFFECTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CE85910)
#define RPG_GAMECORE_MUSICRHYTHMSOUNDEFFECTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE85A40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MusicRhythmSoundEffectRow_TypeDefinitionIndex = 14162;
