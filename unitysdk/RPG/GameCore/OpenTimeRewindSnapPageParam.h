...
#define RPG_GAMECORE_OPENTIMEREWINDSNAPPAGEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xCE6A400)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OpenTimeRewindSnapPageParam_TypeDefinitionIndex = 49874;
