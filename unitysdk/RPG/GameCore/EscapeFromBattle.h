...
#define RPG_GAMECORE_ESCAPEFROMBATTLE_METHOD_3_5F4FCA62293D37BE_OFFSET UNITYSDK_OFFSET(0x171AA4A0)
#define RPG_GAMECORE_ESCAPEFROMBATTLE_METHOD_3_B5AF68539DC0B62F_OFFSET UNITYSDK_OFFSET(0x171AA520)
#define RPG_GAMECORE_ESCAPEFROMBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x171AA4F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EscapeFromBattle_TypeDefinitionIndex = 21370;
