...
#define RPG_GAMECORE_ESCAPEFROMBATTLE_METHOD_3_95012B5D3AAF2314_OFFSET UNITYSDK_OFFSET(0x1D7CE1E0)
#define RPG_GAMECORE_ESCAPEFROMBATTLE_METHOD_3_B5AF68539DC0B62F_OFFSET UNITYSDK_OFFSET(0x1D7CE220)
#define RPG_GAMECORE_ESCAPEFROMBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7CE210)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EscapeFromBattle_TypeDefinitionIndex = 22882;
