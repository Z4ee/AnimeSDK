...
#define RPG_GAMECORE_ADVBYCOMPARECHARACTERID_METHOD_4_065F1AE3E2762901_OFFSET UNITYSDK_OFFSET(0x1BE0F740)
#define RPG_GAMECORE_ADVBYCOMPARECHARACTERID_METHOD_4_2140CF8E59527506_OFFSET UNITYSDK_OFFSET(0x1BE0F4E0)
#define RPG_GAMECORE_ADVBYCOMPARECHARACTERID_METHOD_4_CCECF0C0A284CE40_OFFSET UNITYSDK_OFFSET(0x1BE0F6C0)
#define RPG_GAMECORE_ADVBYCOMPARECHARACTERID_METHOD_4_EA4FF37965B100C9_OFFSET UNITYSDK_OFFSET(0x1BE0F400)
#define RPG_GAMECORE_ADVBYCOMPARECHARACTERID__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE0F480)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvByCompareCharacterID_TypeDefinitionIndex = 19807;
