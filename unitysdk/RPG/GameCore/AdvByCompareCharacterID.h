...
#define RPG_GAMECORE_ADVBYCOMPARECHARACTERID_METHOD_4_195F3D57885D6273_OFFSET UNITYSDK_OFFSET(0x16F25300)
#define RPG_GAMECORE_ADVBYCOMPARECHARACTERID_METHOD_4_2140CF8E59527506_OFFSET UNITYSDK_OFFSET(0x16F25460)
#define RPG_GAMECORE_ADVBYCOMPARECHARACTERID__CTOR_OFFSET UNITYSDK_OFFSET(0x16F253C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvByCompareCharacterID_TypeDefinitionIndex = 18899;
