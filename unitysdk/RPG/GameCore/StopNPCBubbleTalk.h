...
#define RPG_GAMECORE_STOPNPCBUBBLETALK_METHOD_3_544A6BB423A19E42_OFFSET UNITYSDK_OFFSET(0x1B0C5F00)
#define RPG_GAMECORE_STOPNPCBUBBLETALK_METHOD_3_8621BDE3F7EE59C9_OFFSET UNITYSDK_OFFSET(0x1B0C5F40)
#define RPG_GAMECORE_STOPNPCBUBBLETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0C5F30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StopNPCBubbleTalk_TypeDefinitionIndex = 20796;
