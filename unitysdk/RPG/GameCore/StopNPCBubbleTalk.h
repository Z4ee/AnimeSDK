...
#define RPG_GAMECORE_STOPNPCBUBBLETALK_METHOD_3_2EBE2D6F7EECF410_OFFSET UNITYSDK_OFFSET(0x18EA3940)
#define RPG_GAMECORE_STOPNPCBUBBLETALK_METHOD_3_8621BDE3F7EE59C9_OFFSET UNITYSDK_OFFSET(0x18EA39C0)
#define RPG_GAMECORE_STOPNPCBUBBLETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x18EA3990)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StopNPCBubbleTalk_TypeDefinitionIndex = 20439;
