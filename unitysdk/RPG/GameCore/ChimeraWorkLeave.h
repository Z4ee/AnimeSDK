...
#define RPG_GAMECORE_CHIMERAWORKLEAVE_METHOD_3_500279D05C50F12E_OFFSET UNITYSDK_OFFSET(0x1880CBF0)
#define RPG_GAMECORE_CHIMERAWORKLEAVE_METHOD_3_6312AFD77B05E852_OFFSET UNITYSDK_OFFSET(0x1880CC50)
#define RPG_GAMECORE_CHIMERAWORKLEAVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1880CC40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraWorkLeave_TypeDefinitionIndex = 15030;
