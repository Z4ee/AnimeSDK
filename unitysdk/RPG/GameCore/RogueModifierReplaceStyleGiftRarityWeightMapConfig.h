...
#define RPG_GAMECORE_ROGUEMODIFIERREPLACESTYLEGIFTRARITYWEIGHTMAPCONFIG_METHOD_3_7090F6B5B6536C6F_OFFSET UNITYSDK_OFFSET(0x18D45EA0)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACESTYLEGIFTRARITYWEIGHTMAPCONFIG_METHOD_3_D929C5E05A828FC6_OFFSET UNITYSDK_OFFSET(0x18D45F70)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACESTYLEGIFTRARITYWEIGHTMAPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D45F20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierReplaceStyleGiftRarityWeightMapConfig_TypeDefinitionIndex = 16908;
