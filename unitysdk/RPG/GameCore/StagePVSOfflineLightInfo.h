...
#define RPG_GAMECORE_STAGEPVSOFFLINELIGHTINFO_METHOD_2_9FF3D63697DFE5CA_OFFSET UNITYSDK_OFFSET(0x1CAE8980)
#define RPG_GAMECORE_STAGEPVSOFFLINELIGHTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1CAE8AE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StagePVSOfflineLightInfo_TypeDefinitionIndex = 18958;
