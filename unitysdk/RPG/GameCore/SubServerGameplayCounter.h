...
#define RPG_GAMECORE_SUBSERVERGAMEPLAYCOUNTER_METHOD_3_CB39168FDC2331F4_OFFSET UNITYSDK_OFFSET(0x1D5826A0)
#define RPG_GAMECORE_SUBSERVERGAMEPLAYCOUNTER_METHOD_3_E9E579F447E38278_OFFSET UNITYSDK_OFFSET(0x1D582650)
#define RPG_GAMECORE_SUBSERVERGAMEPLAYCOUNTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D582690)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SubServerGameplayCounter_TypeDefinitionIndex = 20319;
