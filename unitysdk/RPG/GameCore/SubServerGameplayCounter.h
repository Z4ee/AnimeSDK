...
#define RPG_GAMECORE_SUBSERVERGAMEPLAYCOUNTER_METHOD_3_B7748FA4807A9E34_OFFSET UNITYSDK_OFFSET(0x18EB1D90)
#define RPG_GAMECORE_SUBSERVERGAMEPLAYCOUNTER_METHOD_3_CB39168FDC2331F4_OFFSET UNITYSDK_OFFSET(0x18EB1E20)
#define RPG_GAMECORE_SUBSERVERGAMEPLAYCOUNTER__CTOR_OFFSET UNITYSDK_OFFSET(0x18EB1DF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SubServerGameplayCounter_TypeDefinitionIndex = 19521;
