...
#define RPG_GAMECORE_MOVETOTARGETPOSITION_METHOD_3_CD797DB27855DE97_OFFSET UNITYSDK_OFFSET(0x17458620)
#define RPG_GAMECORE_MOVETOTARGETPOSITION_METHOD_3_FD73D47ADB95011C_OFFSET UNITYSDK_OFFSET(0x17458700)
#define RPG_GAMECORE_MOVETOTARGETPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x17458660)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MoveToTargetPosition_TypeDefinitionIndex = 20646;
