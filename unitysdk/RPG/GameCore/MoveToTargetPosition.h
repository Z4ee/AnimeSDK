...
#define RPG_GAMECORE_MOVETOTARGETPOSITION_METHOD_3_CD797DB27855DE97_OFFSET UNITYSDK_OFFSET(0x1D2DB390)
#define RPG_GAMECORE_MOVETOTARGETPOSITION_METHOD_3_FD73D47ADB95011C_OFFSET UNITYSDK_OFFSET(0x1D2DB4D0)
#define RPG_GAMECORE_MOVETOTARGETPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2DB440)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MoveToTargetPosition_TypeDefinitionIndex = 22212;
