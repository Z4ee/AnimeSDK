...
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTDAMAGEFROMSHIELDPERCENTCONFIG_METHOD_3_17C29547A49E413E_OFFSET UNITYSDK_OFFSET(0x19894690)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTDAMAGEFROMSHIELDPERCENTCONFIG_METHOD_3_3DF3DD257DA56CB2_OFFSET UNITYSDK_OFFSET(0x198945C0)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTDAMAGEFROMSHIELDPERCENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19894680)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityPixAirEffectDamageFromShieldPercentConfig_TypeDefinitionIndex = 20187;
