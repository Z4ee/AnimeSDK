...
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTDAMAGEFROMSHIELDPERCENTCONFIG_METHOD_3_17C29547A49E413E_OFFSET UNITYSDK_OFFSET(0x1DD62B90)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTDAMAGEFROMSHIELDPERCENTCONFIG_METHOD_3_3DF3DD257DA56CB2_OFFSET UNITYSDK_OFFSET(0x1DD62AC0)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTDAMAGEFROMSHIELDPERCENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD62B80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityPixAirEffectDamageFromShieldPercentConfig_TypeDefinitionIndex = 21112;
