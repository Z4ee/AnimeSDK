...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXTRAVICTORYBONUSCONFIG_METHOD_3_55B7E976A774E3CE_OFFSET UNITYSDK_OFFSET(0x1726AEF0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXTRAVICTORYBONUSCONFIG_METHOD_3_E41EFDB14F6E1647_OFFSET UNITYSDK_OFFSET(0x17267560)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXTRAVICTORYBONUSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17267510)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierExtraVictoryBonusConfig_TypeDefinitionIndex = 17851;
