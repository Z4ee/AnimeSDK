...
#define RPG_GAMECORE_CHARACTERDATACOMPONENTCONFIG_METHOD_3_9165BF0F2D71E302_OFFSET UNITYSDK_OFFSET(0x187D0300)
#define RPG_GAMECORE_CHARACTERDATACOMPONENTCONFIG_METHOD_3_E6FA44FF6DB9BF83_OFFSET UNITYSDK_OFFSET(0x187D0260)
#define RPG_GAMECORE_CHARACTERDATACOMPONENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x187D02F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterDataComponentConfig_TypeDefinitionIndex = 15683;
