...
#define RPG_GAMECORE_PROPSTARTPUZZLE_METHOD_3_42F11ABCDDB38EE2_OFFSET UNITYSDK_OFFSET(0x1756E8E0)
#define RPG_GAMECORE_PROPSTARTPUZZLE_METHOD_3_D57A6FB1FC6CB6D1_OFFSET UNITYSDK_OFFSET(0x1756EA30)
#define RPG_GAMECORE_PROPSTARTPUZZLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1756E9A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropStartPuzzle_TypeDefinitionIndex = 20157;
