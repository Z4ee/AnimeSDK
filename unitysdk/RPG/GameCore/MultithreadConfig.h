...
#define RPG_GAMECORE_MULTITHREADCONFIG_METHOD_2_994D32FD8876D21E_OFFSET UNITYSDK_OFFSET(0x1B1D2DD0)
#define RPG_GAMECORE_MULTITHREADCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1D2E90)
