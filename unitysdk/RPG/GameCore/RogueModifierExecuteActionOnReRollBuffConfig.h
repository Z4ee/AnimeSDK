...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONREROLLBUFFCONFIG_METHOD_3_45F83CBABA8ABFF3_OFFSET UNITYSDK_OFFSET(0x19B52DC0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONREROLLBUFFCONFIG_METHOD_3_9F4DA676BEA9C13A_OFFSET UNITYSDK_OFFSET(0x19B5D9A0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONREROLLBUFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B52D70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnReRollBuffConfig_TypeDefinitionIndex = 17058;
