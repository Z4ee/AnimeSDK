...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONREROLLBUFFCONFIG_METHOD_3_45F83CBABA8ABFF3_OFFSET UNITYSDK_OFFSET(0x176317F0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONREROLLBUFFCONFIG_METHOD_3_9F4DA676BEA9C13A_OFFSET UNITYSDK_OFFSET(0x17631720)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONREROLLBUFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x176317A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnReRollBuffConfig_TypeDefinitionIndex = 16491;
