...
#define RPG_GAMECORE_SETLOCALWINFLAG_METHOD_3_1C5B1D6DE6B6E526_OFFSET UNITYSDK_OFFSET(0x19C54200)
#define RPG_GAMECORE_SETLOCALWINFLAG_METHOD_3_F8BAC1BC243794DA_OFFSET UNITYSDK_OFFSET(0x19C540F0)
#define RPG_GAMECORE_SETLOCALWINFLAG__CTOR_OFFSET UNITYSDK_OFFSET(0x19C541D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetLocalWinFlag_TypeDefinitionIndex = 22127;
