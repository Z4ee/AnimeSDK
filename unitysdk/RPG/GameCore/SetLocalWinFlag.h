...
#define RPG_GAMECORE_SETLOCALWINFLAG_METHOD_3_1C5B1D6DE6B6E526_OFFSET UNITYSDK_OFFSET(0x18E37410)
#define RPG_GAMECORE_SETLOCALWINFLAG_METHOD_3_F8BAC1BC243794DA_OFFSET UNITYSDK_OFFSET(0x18E37300)
#define RPG_GAMECORE_SETLOCALWINFLAG__CTOR_OFFSET UNITYSDK_OFFSET(0x18E373E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetLocalWinFlag_TypeDefinitionIndex = 22371;
