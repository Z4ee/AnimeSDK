...
#define RPG_GAMECORE_BYSKILLPOINTACTIVATED_METHOD_4_6E85A211DF8102DB_OFFSET UNITYSDK_OFFSET(0x1703ACE0)
#define RPG_GAMECORE_BYSKILLPOINTACTIVATED_METHOD_4_EACC984DC5FF091F_OFFSET UNITYSDK_OFFSET(0x1703ADB0)
#define RPG_GAMECORE_BYSKILLPOINTACTIVATED__CTOR_OFFSET UNITYSDK_OFFSET(0x1703AD60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BySkillPointActivated_TypeDefinitionIndex = 21778;
