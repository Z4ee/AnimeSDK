...
#define RPG_GAMECORE_EXPEDITIONBATTLETUTORIALTASKUNLOCKACTION_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1D083030)
#define RPG_GAMECORE_EXPEDITIONBATTLETUTORIALTASKUNLOCKACTION_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D082F50)
#define RPG_GAMECORE_EXPEDITIONBATTLETUTORIALTASKUNLOCKACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D083020)
