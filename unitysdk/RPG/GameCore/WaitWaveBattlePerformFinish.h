...
#define RPG_GAMECORE_WAITWAVEBATTLEPERFORMFINISH_METHOD_3_331B102A591E26E7_OFFSET UNITYSDK_OFFSET(0x1DEC5010)
#define RPG_GAMECORE_WAITWAVEBATTLEPERFORMFINISH_METHOD_3_B992DABAF8726A4A_OFFSET UNITYSDK_OFFSET(0x1DEC4F40)
#define RPG_GAMECORE_WAITWAVEBATTLEPERFORMFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEC5000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitWaveBattlePerformFinish_TypeDefinitionIndex = 23054;
