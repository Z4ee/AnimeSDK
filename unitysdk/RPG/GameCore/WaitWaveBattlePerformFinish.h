...
#define RPG_GAMECORE_WAITWAVEBATTLEPERFORMFINISH_METHOD_3_331B102A591E26E7_OFFSET UNITYSDK_OFFSET(0x19E64E80)
#define RPG_GAMECORE_WAITWAVEBATTLEPERFORMFINISH_METHOD_3_3500EF62E1CBB153_OFFSET UNITYSDK_OFFSET(0x19E64D70)
#define RPG_GAMECORE_WAITWAVEBATTLEPERFORMFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x19E64E50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitWaveBattlePerformFinish_TypeDefinitionIndex = 22046;
