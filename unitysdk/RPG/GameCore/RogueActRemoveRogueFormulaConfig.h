...
#define RPG_GAMECORE_ROGUEACTREMOVEROGUEFORMULACONFIG_METHOD_6_05AF587C231D8D10_OFFSET UNITYSDK_OFFSET(0x18CD1C60)
#define RPG_GAMECORE_ROGUEACTREMOVEROGUEFORMULACONFIG_METHOD_6_CBD0D77D9DE0E49D_OFFSET UNITYSDK_OFFSET(0x18CD1A40)
#define RPG_GAMECORE_ROGUEACTREMOVEROGUEFORMULACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CD1B80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActRemoveRogueFormulaConfig_TypeDefinitionIndex = 18656;
