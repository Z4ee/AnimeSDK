...
#define RPG_GAMECORE_ROGUEACTREMOVEROGUEFORMULACONFIG_METHOD_6_05AF587C231D8D10_OFFSET UNITYSDK_OFFSET(0x1C49D950)
#define RPG_GAMECORE_ROGUEACTREMOVEROGUEFORMULACONFIG_METHOD_6_A5ED8EA4A1BBCC14_OFFSET UNITYSDK_OFFSET(0x1C49D900)
#define RPG_GAMECORE_ROGUEACTREMOVEROGUEFORMULACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C49D940)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActRemoveRogueFormulaConfig_TypeDefinitionIndex = 18899;
