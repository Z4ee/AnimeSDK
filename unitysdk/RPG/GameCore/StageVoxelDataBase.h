...
#define RPG_GAMECORE_STAGEVOXELDATABASE_METHOD_2_66F0F69E5876226A_OFFSET UNITYSDK_OFFSET(0x1B0B7E40)
#define RPG_GAMECORE_STAGEVOXELDATABASE_METHOD_2_D2DCC21125172E82_OFFSET UNITYSDK_OFFSET(0x1B0B7C90)
#define RPG_GAMECORE_STAGEVOXELDATABASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0B7E30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StageVoxelDataBase_TypeDefinitionIndex = 18404;
