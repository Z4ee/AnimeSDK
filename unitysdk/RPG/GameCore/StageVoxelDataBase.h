...
#define RPG_GAMECORE_STAGEVOXELDATABASE_METHOD_2_66F0F69E5876226A_OFFSET UNITYSDK_OFFSET(0x19CB1DC0)
#define RPG_GAMECORE_STAGEVOXELDATABASE_METHOD_2_D2DCC21125172E82_OFFSET UNITYSDK_OFFSET(0x19CB1C10)
#define RPG_GAMECORE_STAGEVOXELDATABASE__CTOR_OFFSET UNITYSDK_OFFSET(0x19CB1DB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StageVoxelDataBase_TypeDefinitionIndex = 18171;
