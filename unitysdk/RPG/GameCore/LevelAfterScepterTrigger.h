...
#define RPG_GAMECORE_LEVELAFTERSCEPTERTRIGGER_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1BDE8950)
#define RPG_GAMECORE_LEVELAFTERSCEPTERTRIGGER_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x1BDE8900)
#define RPG_GAMECORE_LEVELAFTERSCEPTERTRIGGER_GET_SCEPTER_OFFSET UNITYSDK_OFFSET(0x1BDE89A0)
#define RPG_GAMECORE_LEVELAFTERSCEPTERTRIGGER_INIT_OFFSET UNITYSDK_OFFSET(0x1BDE88B0)
#define RPG_GAMECORE_LEVELAFTERSCEPTERTRIGGER_SET_SCEPTER_OFFSET UNITYSDK_OFFSET(0x1BDE89B0)
#define RPG_GAMECORE_LEVELAFTERSCEPTERTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDE89C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelAfterScepterTrigger_TypeDefinitionIndex = 54290;
