...
#define RPG_GAMECORE_ADVBYINCUSTOMZONE_METHOD_4_1856C8264679E592_OFFSET UNITYSDK_OFFSET(0x1BE13E30)
#define RPG_GAMECORE_ADVBYINCUSTOMZONE_METHOD_4_776462EC844B1AFC_OFFSET UNITYSDK_OFFSET(0x1BE13BD0)
#define RPG_GAMECORE_ADVBYINCUSTOMZONE_METHOD_4_9E3C3CC471E0CC1C_OFFSET UNITYSDK_OFFSET(0x1BE13E60)
#define RPG_GAMECORE_ADVBYINCUSTOMZONE_METHOD_4_C162C7C2FEF38DE9_OFFSET UNITYSDK_OFFSET(0x1BE13C10)
#define RPG_GAMECORE_ADVBYINCUSTOMZONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE13C00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvByInCustomZone_TypeDefinitionIndex = 19247;
