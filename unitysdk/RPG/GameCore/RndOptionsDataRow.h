...
#define RPG_GAMECORE_RNDOPTIONSDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D02CCA0)
#define RPG_GAMECORE_RNDOPTIONSDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D02CF80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RndOptionsDataRow_TypeDefinitionIndex = 14079;
	...
	public:
		...
		::System::UInt32 DialogShowOrder; // 0x28
