...
#define RPG_GAMECORE_RNDOPTIONSDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x175B0920)
#define RPG_GAMECORE_RNDOPTIONSDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x175B0C00)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::RndGroupType GroupID; // 0x28
