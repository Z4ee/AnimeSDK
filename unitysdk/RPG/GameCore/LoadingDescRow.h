...
#define RPG_GAMECORE_LOADINGDESCROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18A72BE0)
#define RPG_GAMECORE_LOADINGDESCROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18A735E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoadingDescRow_TypeDefinitionIndex = 13237;

	class LoadingDescRow : public ::System::Object
	{
	public:
		::Il2CppArray<::Class_1_0F724F8EDC601A3C*>* ForceParam; // 0x10
		::Il2CppArray<::Class_1_0F724F8EDC601A3C*>* LockParam; // 0x18
		...
		::System::UInt32 MinLevel; // 0x4C
		::System::UInt32 ImageID; // 0x50
		::RPG::Client::TextID DescTextmapID; // 0x58
		::RPG::Client::TextID TitleTextmapID; // 0x68
		::System::UInt32 Weight; // 0x78
