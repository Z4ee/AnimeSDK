...
#define RPG_GAMECORE_TRAINPARTYMODIFIERSPECIFYRARITYONREFRESHCARDCONFIG_METHOD_3_3308207B90924CC8_OFFSET UNITYSDK_OFFSET(0x178AD240)
#define RPG_GAMECORE_TRAINPARTYMODIFIERSPECIFYRARITYONREFRESHCARDCONFIG_METHOD_3_BE55ADD912DD334C_OFFSET UNITYSDK_OFFSET(0x178AD600)
#define RPG_GAMECORE_TRAINPARTYMODIFIERSPECIFYRARITYONREFRESHCARDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x178AD230)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyModifierSpecifyRarityOnRefreshCardConfig_TypeDefinitionIndex = 16620;
