...
#define RPG_GAMECORE_TRAINPARTYMODIFIERSPECIFYRARITYONREFRESHCARDCONFIG_METHOD_3_3308207B90924CC8_OFFSET UNITYSDK_OFFSET(0x1C1619F0)
#define RPG_GAMECORE_TRAINPARTYMODIFIERSPECIFYRARITYONREFRESHCARDCONFIG_METHOD_3_BE55ADD912DD334C_OFFSET UNITYSDK_OFFSET(0x1C161DB0)
#define RPG_GAMECORE_TRAINPARTYMODIFIERSPECIFYRARITYONREFRESHCARDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1619E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyModifierSpecifyRarityOnRefreshCardConfig_TypeDefinitionIndex = 17382;
