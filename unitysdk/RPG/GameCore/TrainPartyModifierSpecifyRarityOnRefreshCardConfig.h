...
#define RPG_GAMECORE_TRAINPARTYMODIFIERSPECIFYRARITYONREFRESHCARDCONFIG_METHOD_3_3308207B90924CC8_OFFSET UNITYSDK_OFFSET(0x1D5DEDD0)
#define RPG_GAMECORE_TRAINPARTYMODIFIERSPECIFYRARITYONREFRESHCARDCONFIG_METHOD_3_BE55ADD912DD334C_OFFSET UNITYSDK_OFFSET(0x1D5DF190)
#define RPG_GAMECORE_TRAINPARTYMODIFIERSPECIFYRARITYONREFRESHCARDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5DEDC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyModifierSpecifyRarityOnRefreshCardConfig_TypeDefinitionIndex = 17899;
