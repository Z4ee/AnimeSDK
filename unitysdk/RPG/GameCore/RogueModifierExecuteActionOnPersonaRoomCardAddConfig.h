...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONAROOMCARDADDCONFIG_METHOD_3_58257694D52C6688_OFFSET UNITYSDK_OFFSET(0x1CFC0980)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONAROOMCARDADDCONFIG_METHOD_3_961BC5E72E813A44_OFFSET UNITYSDK_OFFSET(0x1CFC09D0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONAROOMCARDADDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFC09C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnPersonaRoomCardAddConfig_TypeDefinitionIndex = 17075;
