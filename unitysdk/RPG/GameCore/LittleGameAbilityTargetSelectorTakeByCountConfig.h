...
#define RPG_GAMECORE_LITTLEGAMEABILITYTARGETSELECTORTAKEBYCOUNTCONFIG_METHOD_3_5444ED2F16C312B1_OFFSET UNITYSDK_OFFSET(0x1B0960A0)
#define RPG_GAMECORE_LITTLEGAMEABILITYTARGETSELECTORTAKEBYCOUNTCONFIG_METHOD_3_E873DC79EBF79413_OFFSET UNITYSDK_OFFSET(0x1B096040)
#define RPG_GAMECORE_LITTLEGAMEABILITYTARGETSELECTORTAKEBYCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B096090)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityTargetSelectorTakeByCountConfig_TypeDefinitionIndex = 20584;
