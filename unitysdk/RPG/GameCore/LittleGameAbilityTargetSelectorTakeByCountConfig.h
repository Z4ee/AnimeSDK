...
#define RPG_GAMECORE_LITTLEGAMEABILITYTARGETSELECTORTAKEBYCOUNTCONFIG_METHOD_3_5444ED2F16C312B1_OFFSET UNITYSDK_OFFSET(0x1D1FC930)
#define RPG_GAMECORE_LITTLEGAMEABILITYTARGETSELECTORTAKEBYCOUNTCONFIG_METHOD_3_E873DC79EBF79413_OFFSET UNITYSDK_OFFSET(0x1D1FC8D0)
#define RPG_GAMECORE_LITTLEGAMEABILITYTARGETSELECTORTAKEBYCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1FC920)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityTargetSelectorTakeByCountConfig_TypeDefinitionIndex = 21136;
