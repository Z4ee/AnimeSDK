...
#define RPG_GAMECORE_AREATITANBLESSWEIGHTMODIFYCONFIG_METHOD_2_F6B119FA1B433918_OFFSET UNITYSDK_OFFSET(0x1C5712B0)
#define RPG_GAMECORE_AREATITANBLESSWEIGHTMODIFYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5712F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AreaTitanBlessWeightModifyConfig_TypeDefinitionIndex = 17801;
