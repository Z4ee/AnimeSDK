...
#define RPG_GAMECORE_AREATITANBLESSWEIGHTMODIFYCONFIG_METHOD_2_F6B119FA1B433918_OFFSET UNITYSDK_OFFSET(0x186AA410)
#define RPG_GAMECORE_AREATITANBLESSWEIGHTMODIFYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x186AA450)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AreaTitanBlessWeightModifyConfig_TypeDefinitionIndex = 17109;
