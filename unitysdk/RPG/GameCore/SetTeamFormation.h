...
#define RPG_GAMECORE_SETTEAMFORMATION_METHOD_3_BC22AC9C3E41FEEC_OFFSET UNITYSDK_OFFSET(0x19C63710)
#define RPG_GAMECORE_SETTEAMFORMATION_METHOD_3_CEB77850EAD950FB_OFFSET UNITYSDK_OFFSET(0x19C637F0)
#define RPG_GAMECORE_SETTEAMFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x19C63790)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetTeamFormation_TypeDefinitionIndex = 21663;
