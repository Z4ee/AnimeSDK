...
#define RPG_GAMECORE_CHECKAIVARIABLEINTAXIS_METHOD_3_6CE74C73D13E08A6_OFFSET UNITYSDK_OFFSET(0x196177B0)
#define RPG_GAMECORE_CHECKAIVARIABLEINTAXIS_METHOD_3_7EFCE6822B91760F_OFFSET UNITYSDK_OFFSET(0x196177F0)
#define RPG_GAMECORE_CHECKAIVARIABLEINTAXIS__CTOR_OFFSET UNITYSDK_OFFSET(0x196177E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CheckAIVariableIntAxis_TypeDefinitionIndex = 14744;
