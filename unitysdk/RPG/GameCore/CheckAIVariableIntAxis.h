...
#define RPG_GAMECORE_CHECKAIVARIABLEINTAXIS_METHOD_3_6CE74C73D13E08A6_OFFSET UNITYSDK_OFFSET(0x187D9EF0)
#define RPG_GAMECORE_CHECKAIVARIABLEINTAXIS_METHOD_3_7EFCE6822B91760F_OFFSET UNITYSDK_OFFSET(0x187D9F30)
#define RPG_GAMECORE_CHECKAIVARIABLEINTAXIS__CTOR_OFFSET UNITYSDK_OFFSET(0x187D9F20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CheckAIVariableIntAxis_TypeDefinitionIndex = 14678;
