...
#define RPG_GAMECORE_CHECKAIVARIABLEINTAXIS_METHOD_3_6CE74C73D13E08A6_OFFSET UNITYSDK_OFFSET(0x17074E10)
#define RPG_GAMECORE_CHECKAIVARIABLEINTAXIS_METHOD_3_7EFCE6822B91760F_OFFSET UNITYSDK_OFFSET(0x17074E50)
#define RPG_GAMECORE_CHECKAIVARIABLEINTAXIS__CTOR_OFFSET UNITYSDK_OFFSET(0x17074E40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CheckAIVariableIntAxis_TypeDefinitionIndex = 14209;
