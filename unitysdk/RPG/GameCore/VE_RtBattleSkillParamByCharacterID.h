...
#define RPG_GAMECORE_VE_RTBATTLESKILLPARAMBYCHARACTERID_METHOD_3_1A2598079F2701C8_OFFSET UNITYSDK_OFFSET(0x1B892210)
#define RPG_GAMECORE_VE_RTBATTLESKILLPARAMBYCHARACTERID_METHOD_3_7F92496B6DD55218_OFFSET UNITYSDK_OFFSET(0x1B892470)
#define RPG_GAMECORE_VE_RTBATTLESKILLPARAMBYCHARACTERID_METHOD_3_9EA132584BD81E99_OFFSET UNITYSDK_OFFSET(0x1B892250)
#define RPG_GAMECORE_VE_RTBATTLESKILLPARAMBYCHARACTERID_METHOD_3_E1FEFD8AAA94DD07_OFFSET UNITYSDK_OFFSET(0x1B892440)
#define RPG_GAMECORE_VE_RTBATTLESKILLPARAMBYCHARACTERID__CTOR_OFFSET UNITYSDK_OFFSET(0x1B892240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VE_RtBattleSkillParamByCharacterID_TypeDefinitionIndex = 23407;
