...
#define RPG_GAMECORE_MODIFYSP_METHOD_3_0D77EEA27686BDFE_OFFSET UNITYSDK_OFFSET(0x174328E0)
#define RPG_GAMECORE_MODIFYSP_METHOD_3_B37C2DE6482AA758_OFFSET UNITYSDK_OFFSET(0x17432980)
#define RPG_GAMECORE_MODIFYSP__CTOR_OFFSET UNITYSDK_OFFSET(0x17432940)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifySP_TypeDefinitionIndex = 21802;
