...
#define RPG_GAMECORE_MODIFYSP_METHOD_3_5D6BCECA4985B0C9_OFFSET UNITYSDK_OFFSET(0x1D1BCEA0)
#define RPG_GAMECORE_MODIFYSP_METHOD_3_B37C2DE6482AA758_OFFSET UNITYSDK_OFFSET(0x1D1BCEF0)
#define RPG_GAMECORE_MODIFYSP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1BCEE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifySP_TypeDefinitionIndex = 23298;
