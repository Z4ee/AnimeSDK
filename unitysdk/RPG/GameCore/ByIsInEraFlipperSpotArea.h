...
#define RPG_GAMECORE_BYISINERAFLIPPERSPOTAREA_METHOD_4_4FF1D693A26A4C37_OFFSET UNITYSDK_OFFSET(0x1CDA50F0)
#define RPG_GAMECORE_BYISINERAFLIPPERSPOTAREA_METHOD_4_9E98F447CC501E98_OFFSET UNITYSDK_OFFSET(0x1CDA4F30)
#define RPG_GAMECORE_BYISINERAFLIPPERSPOTAREA_METHOD_4_B79555B827DA387D_OFFSET UNITYSDK_OFFSET(0x1CDA4F70)
#define RPG_GAMECORE_BYISINERAFLIPPERSPOTAREA_METHOD_4_F3A3FF2FEF194640_OFFSET UNITYSDK_OFFSET(0x1CDA5120)
#define RPG_GAMECORE_BYISINERAFLIPPERSPOTAREA__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDA4F60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsInEraFlipperSpotArea_TypeDefinitionIndex = 22084;
