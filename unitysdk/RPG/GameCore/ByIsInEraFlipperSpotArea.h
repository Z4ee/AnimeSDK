...
#define RPG_GAMECORE_BYISINERAFLIPPERSPOTAREA_METHOD_4_B170A4B700C233DB_OFFSET UNITYSDK_OFFSET(0x18754850)
#define RPG_GAMECORE_BYISINERAFLIPPERSPOTAREA_METHOD_4_B79555B827DA387D_OFFSET UNITYSDK_OFFSET(0x18754920)
#define RPG_GAMECORE_BYISINERAFLIPPERSPOTAREA__CTOR_OFFSET UNITYSDK_OFFSET(0x187548D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsInEraFlipperSpotArea_TypeDefinitionIndex = 21211;
