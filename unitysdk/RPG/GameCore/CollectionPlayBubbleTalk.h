...
#define RPG_GAMECORE_COLLECTIONPLAYBUBBLETALK_METHOD_3_0936BEABD4EE33B0_OFFSET UNITYSDK_OFFSET(0x19666840)
#define RPG_GAMECORE_COLLECTIONPLAYBUBBLETALK_METHOD_3_3F115DEB7BB5F4A3_OFFSET UNITYSDK_OFFSET(0x196667A0)
#define RPG_GAMECORE_COLLECTIONPLAYBUBBLETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x19666800)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CollectionPlayBubbleTalk_TypeDefinitionIndex = 19270;
