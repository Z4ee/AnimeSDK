...
#define RPG_GAMECORE_COLLECTIONPLAYBUBBLETALK_METHOD_3_0936BEABD4EE33B0_OFFSET UNITYSDK_OFFSET(0x1711F3D0)
#define RPG_GAMECORE_COLLECTIONPLAYBUBBLETALK_METHOD_3_3F115DEB7BB5F4A3_OFFSET UNITYSDK_OFFSET(0x1711F330)
#define RPG_GAMECORE_COLLECTIONPLAYBUBBLETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1711F390)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CollectionPlayBubbleTalk_TypeDefinitionIndex = 18705;
