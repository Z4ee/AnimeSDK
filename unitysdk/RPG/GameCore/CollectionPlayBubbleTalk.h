...
#define RPG_GAMECORE_COLLECTIONPLAYBUBBLETALK_METHOD_3_0936BEABD4EE33B0_OFFSET UNITYSDK_OFFSET(0x1BC21170)
#define RPG_GAMECORE_COLLECTIONPLAYBUBBLETALK_METHOD_3_EEB938451F0CEF84_OFFSET UNITYSDK_OFFSET(0x1BC21100)
#define RPG_GAMECORE_COLLECTIONPLAYBUBBLETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC21150)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CollectionPlayBubbleTalk_TypeDefinitionIndex = 19626;
