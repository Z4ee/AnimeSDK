...
#define RPG_GAMECORE_ADVENTURETRIGGERTARGETABILITY_METHOD_3_2B60DF0544976F34_OFFSET UNITYSDK_OFFSET(0x1CDFA920)
#define RPG_GAMECORE_ADVENTURETRIGGERTARGETABILITY_METHOD_3_E527B0B8970B3C59_OFFSET UNITYSDK_OFFSET(0x1CDFA880)
#define RPG_GAMECORE_ADVENTURETRIGGERTARGETABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDFA8E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureTriggerTargetAbility_TypeDefinitionIndex = 19968;
