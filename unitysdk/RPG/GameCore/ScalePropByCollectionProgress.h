...
#define RPG_GAMECORE_SCALEPROPBYCOLLECTIONPROGRESS_METHOD_3_6B6614D9C7D13AAF_OFFSET UNITYSDK_OFFSET(0x18DFDD00)
#define RPG_GAMECORE_SCALEPROPBYCOLLECTIONPROGRESS_METHOD_3_DE8F228A58A47DA6_OFFSET UNITYSDK_OFFSET(0x18DFDB80)
#define RPG_GAMECORE_SCALEPROPBYCOLLECTIONPROGRESS__CTOR_OFFSET UNITYSDK_OFFSET(0x18DFDC50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ScalePropByCollectionProgress_TypeDefinitionIndex = 19367;
