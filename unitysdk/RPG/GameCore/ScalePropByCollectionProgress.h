...
#define RPG_GAMECORE_SCALEPROPBYCOLLECTIONPROGRESS_METHOD_3_5CE4F1FC600B848F_OFFSET UNITYSDK_OFFSET(0x1D4D5130)
#define RPG_GAMECORE_SCALEPROPBYCOLLECTIONPROGRESS_METHOD_3_6B6614D9C7D13AAF_OFFSET UNITYSDK_OFFSET(0x1D4D5290)
#define RPG_GAMECORE_SCALEPROPBYCOLLECTIONPROGRESS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4D51F0)
