...
#define RPG_GAMECORE_MODIFIERDETACHEFFECT_METHOD_3_AA31FFD7C02F8334_OFFSET UNITYSDK_OFFSET(0x1D1B2840)
#define RPG_GAMECORE_MODIFIERDETACHEFFECT_METHOD_3_F10DA050C5AE6E99_OFFSET UNITYSDK_OFFSET(0x1D1B2890)
#define RPG_GAMECORE_MODIFIERDETACHEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1B2880)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifierDetachEffect_TypeDefinitionIndex = 23202;
