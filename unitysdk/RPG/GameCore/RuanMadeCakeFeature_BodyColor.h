...
#define RPG_GAMECORE_RUANMADECAKEFEATURE_BODYCOLOR_METHOD_3_A72BF51FAC87BB06_OFFSET UNITYSDK_OFFSET(0x19BF9AA0)
#define RPG_GAMECORE_RUANMADECAKEFEATURE_BODYCOLOR_METHOD_3_F27B24C66DFE4DB9_OFFSET UNITYSDK_OFFSET(0x19BF8F50)
#define RPG_GAMECORE_RUANMADECAKEFEATURE_BODYCOLOR__CTOR_OFFSET UNITYSDK_OFFSET(0x19BF8F40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RuanMadeCakeFeature_BodyColor_TypeDefinitionIndex = 16603;
