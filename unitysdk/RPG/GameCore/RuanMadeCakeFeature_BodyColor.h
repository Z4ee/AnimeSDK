...
#define RPG_GAMECORE_RUANMADECAKEFEATURE_BODYCOLOR_METHOD_3_A72BF51FAC87BB06_OFFSET UNITYSDK_OFFSET(0x18DDCD70)
#define RPG_GAMECORE_RUANMADECAKEFEATURE_BODYCOLOR_METHOD_3_F27B24C66DFE4DB9_OFFSET UNITYSDK_OFFSET(0x18DDC230)
#define RPG_GAMECORE_RUANMADECAKEFEATURE_BODYCOLOR__CTOR_OFFSET UNITYSDK_OFFSET(0x18DDC220)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RuanMadeCakeFeature_BodyColor_TypeDefinitionIndex = 16573;
