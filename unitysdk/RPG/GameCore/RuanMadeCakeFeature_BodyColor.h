...
#define RPG_GAMECORE_RUANMADECAKEFEATURE_BODYCOLOR_METHOD_3_A72BF51FAC87BB06_OFFSET UNITYSDK_OFFSET(0x176792D0)
#define RPG_GAMECORE_RUANMADECAKEFEATURE_BODYCOLOR_METHOD_3_F27B24C66DFE4DB9_OFFSET UNITYSDK_OFFSET(0x17678790)
#define RPG_GAMECORE_RUANMADECAKEFEATURE_BODYCOLOR__CTOR_OFFSET UNITYSDK_OFFSET(0x17678780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RuanMadeCakeFeature_BodyColor_TypeDefinitionIndex = 16044;
