...
#define RPG_GAMECORE_ROGUEMODIFIERDROPTHENREGETMIRACLECONFIG_METHOD_3_2B2C70FC97DEBC8E_OFFSET UNITYSDK_OFFSET(0x1CFBF6B0)
#define RPG_GAMECORE_ROGUEMODIFIERDROPTHENREGETMIRACLECONFIG_METHOD_3_8BD979D095047372_OFFSET UNITYSDK_OFFSET(0x1CFBF660)
#define RPG_GAMECORE_ROGUEMODIFIERDROPTHENREGETMIRACLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFBF6A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierDropThenReGetMiracleConfig_TypeDefinitionIndex = 17261;
