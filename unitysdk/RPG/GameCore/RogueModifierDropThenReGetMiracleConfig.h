...
#define RPG_GAMECORE_ROGUEMODIFIERDROPTHENREGETMIRACLECONFIG_METHOD_3_2B2C70FC97DEBC8E_OFFSET UNITYSDK_OFFSET(0x1762E450)
#define RPG_GAMECORE_ROGUEMODIFIERDROPTHENREGETMIRACLECONFIG_METHOD_3_B1E99C0063A88DB7_OFFSET UNITYSDK_OFFSET(0x1762E380)
#define RPG_GAMECORE_ROGUEMODIFIERDROPTHENREGETMIRACLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1762E400)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierDropThenReGetMiracleConfig_TypeDefinitionIndex = 16532;
