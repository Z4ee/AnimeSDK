...
#define RPG_GAMECORE_ROGUEFORMULACONDITIONCONFIGBASE_METHOD_6_79F6C218CBBA130F_OFFSET UNITYSDK_OFFSET(0x1760A2B0)
#define RPG_GAMECORE_ROGUEFORMULACONDITIONCONFIGBASE_METHOD_6_A46B7B8686D2C4E6_OFFSET UNITYSDK_OFFSET(0x1760A890)
#define RPG_GAMECORE_ROGUEFORMULACONDITIONCONFIGBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1760A7D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueFormulaConditionConfigBase_TypeDefinitionIndex = 17928;
