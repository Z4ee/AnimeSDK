...
#define RPG_GAMECORE_LITTLEGAMELEVELVARIABLEENTITYREF_METHOD_3_A2F7FA22840EDDA6_OFFSET UNITYSDK_OFFSET(0x18A6CCD0)
#define RPG_GAMECORE_LITTLEGAMELEVELVARIABLEENTITYREF_METHOD_3_ED21528E6B85A351_OFFSET UNITYSDK_OFFSET(0x18A6D660)
#define RPG_GAMECORE_LITTLEGAMELEVELVARIABLEENTITYREF__CTOR_OFFSET UNITYSDK_OFFSET(0x18A6CCC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameLevelVariableEntityRef_TypeDefinitionIndex = 17943;
