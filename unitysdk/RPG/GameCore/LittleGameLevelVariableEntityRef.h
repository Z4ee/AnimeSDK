...
#define RPG_GAMECORE_LITTLEGAMELEVELVARIABLEENTITYREF_METHOD_3_A2F7FA22840EDDA6_OFFSET UNITYSDK_OFFSET(0x1BCC2F00)
#define RPG_GAMECORE_LITTLEGAMELEVELVARIABLEENTITYREF_METHOD_3_ED21528E6B85A351_OFFSET UNITYSDK_OFFSET(0x1BCC3890)
#define RPG_GAMECORE_LITTLEGAMELEVELVARIABLEENTITYREF__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCC2EF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameLevelVariableEntityRef_TypeDefinitionIndex = 18154;
