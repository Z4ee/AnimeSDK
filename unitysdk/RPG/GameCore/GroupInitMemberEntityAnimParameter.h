...
#define RPG_GAMECORE_GROUPINITMEMBERENTITYANIMPARAMETER_METHOD_3_331E945FE52AF953_OFFSET UNITYSDK_OFFSET(0x1D1702C0)
#define RPG_GAMECORE_GROUPINITMEMBERENTITYANIMPARAMETER_METHOD_3_FB7BEE8E2008D1DA_OFFSET UNITYSDK_OFFSET(0x1D170280)
#define RPG_GAMECORE_GROUPINITMEMBERENTITYANIMPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1702B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GroupInitMemberEntityAnimParameter_TypeDefinitionIndex = 20500;
