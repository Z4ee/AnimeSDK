...
#define RPG_GAMECORE_GROUPINITMEMBERENTITYANIMPARAMETER_METHOD_3_05D7C2EB8DBC5962_OFFSET UNITYSDK_OFFSET(0x1728C120)
#define RPG_GAMECORE_GROUPINITMEMBERENTITYANIMPARAMETER_METHOD_3_331E945FE52AF953_OFFSET UNITYSDK_OFFSET(0x1728C1A0)
#define RPG_GAMECORE_GROUPINITMEMBERENTITYANIMPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1728C170)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GroupInitMemberEntityAnimParameter_TypeDefinitionIndex = 19056;
