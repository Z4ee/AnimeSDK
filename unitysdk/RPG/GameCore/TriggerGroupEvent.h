...
#define RPG_GAMECORE_TRIGGERGROUPEVENT_METHOD_3_4D127035B522AE51_OFFSET UNITYSDK_OFFSET(0x1D28EDB0)
#define RPG_GAMECORE_TRIGGERGROUPEVENT_METHOD_3_758C198758DC8A57_OFFSET UNITYSDK_OFFSET(0x1D28EF10)
#define RPG_GAMECORE_TRIGGERGROUPEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D28EF00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerGroupEvent_TypeDefinitionIndex = 20950;
