...
#define RPG_GAMECORE_TRIGGERGROUPEVENT_METHOD_3_758C198758DC8A57_OFFSET UNITYSDK_OFFSET(0x190C6910)
#define RPG_GAMECORE_TRIGGERGROUPEVENT_METHOD_3_8F3B3BCA0004D265_OFFSET UNITYSDK_OFFSET(0x190C6750)
#define RPG_GAMECORE_TRIGGERGROUPEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x190C68E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerGroupEvent_TypeDefinitionIndex = 20169;
