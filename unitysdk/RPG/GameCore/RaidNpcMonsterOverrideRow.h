...
#define RPG_GAMECORE_RAIDNPCMONSTEROVERRIDEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D383A80)
#define RPG_GAMECORE_RAIDNPCMONSTEROVERRIDEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D383CF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RaidNpcMonsterOverrideRow_TypeDefinitionIndex = 14438;

	class RaidNpcMonsterOverrideRow : public ::System::Object
	{
	public:
		::Il2CppArray<::System::UInt32>* NpcMonsterIDList; // 0x10
		::Il2CppArray<::System::UInt32>* ConfigIDList; // 0x18
