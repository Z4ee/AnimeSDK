...
#define RPG_GAMECORE_MUNICIPALQUALITYSETTING_METHOD_2_98BB791B74E0FD02_OFFSET UNITYSDK_OFFSET(0x1B1D4880)
#define RPG_GAMECORE_MUNICIPALQUALITYSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1D4AD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MunicipalQualitySetting_TypeDefinitionIndex = 16240;
