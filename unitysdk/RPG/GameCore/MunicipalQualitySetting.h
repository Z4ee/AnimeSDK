...
#define RPG_GAMECORE_MUNICIPALQUALITYSETTING_METHOD_2_1AD312E3323F776D_OFFSET UNITYSDK_OFFSET(0x1745C600)
#define RPG_GAMECORE_MUNICIPALQUALITYSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x1745C870)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MunicipalQualitySetting_TypeDefinitionIndex = 15486;
