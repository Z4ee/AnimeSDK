...
#define RPG_GAMECORE_GRIDFIGHTACTIONADDBONUSCONFIG_METHOD_6_4A2EE79ABE7698A8_OFFSET UNITYSDK_OFFSET(0x1724D960)
#define RPG_GAMECORE_GRIDFIGHTACTIONADDBONUSCONFIG_METHOD_6_50F66100A9CAD543_OFFSET UNITYSDK_OFFSET(0x1724D7F0)
#define RPG_GAMECORE_GRIDFIGHTACTIONADDBONUSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1724D8C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightActionAddBonusConfig_TypeDefinitionIndex = 17721;
