...
#define RPG_GAMECORE_SETDYNAMICVALUEBYMODIFIERVALUE_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1C2E4C20)
#define RPG_GAMECORE_SETDYNAMICVALUEBYMODIFIERVALUE_METHOD_4_0EA53782C015F58E_OFFSET UNITYSDK_OFFSET(0x1C2E48E0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYMODIFIERVALUE_METHOD_4_CC4FA0C828A8762F_OFFSET UNITYSDK_OFFSET(0x1C2E4840)
#define RPG_GAMECORE_SETDYNAMICVALUEBYMODIFIERVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2E48A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByModifierValue_TypeDefinitionIndex = 22254;
