...
#define RPG_GAMECORE_SETDYNAMICVALUEBYMODIFIERVALUE_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x176C2850)
#define RPG_GAMECORE_SETDYNAMICVALUEBYMODIFIERVALUE_METHOD_4_7160C3A4C31F3BE1_OFFSET UNITYSDK_OFFSET(0x176BD660)
#define RPG_GAMECORE_SETDYNAMICVALUEBYMODIFIERVALUE_METHOD_4_76FF9BB2F2A6241B_OFFSET UNITYSDK_OFFSET(0x176C27B0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYMODIFIERVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x176BD5E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByModifierValue_TypeDefinitionIndex = 21300;
