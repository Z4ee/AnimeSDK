...
#define RPG_GAMECORE_SETFUNCBTN_METHOD_3_32D955E55BAF1E0C_OFFSET UNITYSDK_OFFSET(0x176CF840)
#define RPG_GAMECORE_SETFUNCBTN_METHOD_3_8035AA36AD215ABD_OFFSET UNITYSDK_OFFSET(0x176CF8C0)
#define RPG_GAMECORE_SETFUNCBTN__CTOR_OFFSET UNITYSDK_OFFSET(0x176CF890)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetFuncBtn_TypeDefinitionIndex = 19781;
