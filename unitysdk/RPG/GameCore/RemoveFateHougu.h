...
#define RPG_GAMECORE_REMOVEFATEHOUGU_METHOD_3_48C4AAFA75698B14_OFFSET UNITYSDK_OFFSET(0x18CA4100)
#define RPG_GAMECORE_REMOVEFATEHOUGU_METHOD_3_97E876498DF6DD56_OFFSET UNITYSDK_OFFSET(0x18CA4220)
#define RPG_GAMECORE_REMOVEFATEHOUGU__CTOR_OFFSET UNITYSDK_OFFSET(0x18CA41A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveFateHougu_TypeDefinitionIndex = 22261;
