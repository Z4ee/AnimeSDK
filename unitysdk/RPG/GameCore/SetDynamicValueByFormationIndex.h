...
#define RPG_GAMECORE_SETDYNAMICVALUEBYFORMATIONINDEX_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1D4F0B30)
#define RPG_GAMECORE_SETDYNAMICVALUEBYFORMATIONINDEX_METHOD_4_124881ECF9E0C8CB_OFFSET UNITYSDK_OFFSET(0x1D4F0900)
#define RPG_GAMECORE_SETDYNAMICVALUEBYFORMATIONINDEX_METHOD_4_34B0D55BD23B39B6_OFFSET UNITYSDK_OFFSET(0x1D4F0940)
#define RPG_GAMECORE_SETDYNAMICVALUEBYFORMATIONINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4F0930)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByFormationIndex_TypeDefinitionIndex = 23000;
