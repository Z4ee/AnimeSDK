...
#define RPG_GAMECORE_ONMUSEUMPERFORMANCEEND_METHOD_3_05974A3FC6A28351_OFFSET UNITYSDK_OFFSET(0x1747B270)
#define RPG_GAMECORE_ONMUSEUMPERFORMANCEEND_METHOD_3_4D9236D26CFDA2A5_OFFSET UNITYSDK_OFFSET(0x1747B380)
#define RPG_GAMECORE_ONMUSEUMPERFORMANCEEND__CTOR_OFFSET UNITYSDK_OFFSET(0x1747B350)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OnMuseumPerformanceEnd_TypeDefinitionIndex = 19233;
