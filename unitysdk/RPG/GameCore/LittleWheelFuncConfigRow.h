...
#define RPG_GAMECORE_LITTLEWHEELFUNCCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x198A3590)
#define RPG_GAMECORE_LITTLEWHEELFUNCCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x198A3BE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleWheelFuncConfigRow_TypeDefinitionIndex = 12691;
