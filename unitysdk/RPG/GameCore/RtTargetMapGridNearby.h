...
#define RPG_GAMECORE_RTTARGETMAPGRIDNEARBY_METHOD_3_1E14F88753C23D3D_OFFSET UNITYSDK_OFFSET(0x1B76F780)
#define RPG_GAMECORE_RTTARGETMAPGRIDNEARBY_METHOD_3_DA84216489C95BD9_OFFSET UNITYSDK_OFFSET(0x1B76F8F0)
#define RPG_GAMECORE_RTTARGETMAPGRIDNEARBY_METHOD_3_DF6B2FA767B69C69_OFFSET UNITYSDK_OFFSET(0x1B76FBF0)
#define RPG_GAMECORE_RTTARGETMAPGRIDNEARBY_METHOD_3_E149D78A030C0661_OFFSET UNITYSDK_OFFSET(0x1B76FB10)
#define RPG_GAMECORE_RTTARGETMAPGRIDNEARBY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B76F860)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtTargetMapGridNearby_TypeDefinitionIndex = 23399;
