...
#define RPG_GAMECORE_SWIPEROTATIONCAMERAPARAM_METHOD_2_E4A7B00964C32BFF_OFFSET UNITYSDK_OFFSET(0x19CD6F60)
#define RPG_GAMECORE_SWIPEROTATIONCAMERAPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x19CD7230)
