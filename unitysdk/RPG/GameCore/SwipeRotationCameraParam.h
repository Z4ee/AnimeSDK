...
#define RPG_GAMECORE_SWIPEROTATIONCAMERAPARAM_METHOD_2_E4A7B00964C32BFF_OFFSET UNITYSDK_OFFSET(0x17790F20)
#define RPG_GAMECORE_SWIPEROTATIONCAMERAPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x177911F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwipeRotationCameraParam_TypeDefinitionIndex = 19151;
