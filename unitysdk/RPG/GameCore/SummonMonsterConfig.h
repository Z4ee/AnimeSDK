...
#define RPG_GAMECORE_SUMMONMONSTERCONFIG_METHOD_2_85AB3E37885635D0_OFFSET UNITYSDK_OFFSET(0x1D583B90)
#define RPG_GAMECORE_SUMMONMONSTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D583C50)
