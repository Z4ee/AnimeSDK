...
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_ALL_METHOD_3_08C9ADE3B4B31852_OFFSET UNITYSDK_OFFSET(0x18867AC0)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_ALL_METHOD_3_99D027A2B9FA4853_OFFSET UNITYSDK_OFFSET(0x18866B90)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_ALL__CTOR_OFFSET UNITYSDK_OFFSET(0x18866B80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatDiceSelectorConfig_All_TypeDefinitionIndex = 15305;
