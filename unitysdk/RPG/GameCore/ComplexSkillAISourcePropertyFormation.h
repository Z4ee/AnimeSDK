...
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEPROPERTYFORMATION_METHOD_3_1288D8677A2E7D65_OFFSET UNITYSDK_OFFSET(0x1D9AC6F0)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEPROPERTYFORMATION_METHOD_3_DE0178A644CD88E6_OFFSET UNITYSDK_OFFSET(0x1D9AC690)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEPROPERTYFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D9AC6E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAISourcePropertyFormation_TypeDefinitionIndex = 15355;
