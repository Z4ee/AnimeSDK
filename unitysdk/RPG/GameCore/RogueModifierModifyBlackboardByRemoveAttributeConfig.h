...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYBLACKBOARDBYREMOVEATTRIBUTECONFIG_METHOD_4_98A4945ACDE3BC2B_OFFSET UNITYSDK_OFFSET(0x19B54D40)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYBLACKBOARDBYREMOVEATTRIBUTECONFIG_METHOD_4_DBAEE8FB207217D2_OFFSET UNITYSDK_OFFSET(0x19B5EE40)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYBLACKBOARDBYREMOVEATTRIBUTECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B54CF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyBlackboardByRemoveAttributeConfig_TypeDefinitionIndex = 16821;
