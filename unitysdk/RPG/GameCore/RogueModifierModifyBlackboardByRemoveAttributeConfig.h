...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYBLACKBOARDBYREMOVEATTRIBUTECONFIG_METHOD_4_4E67D03F0DD01887_OFFSET UNITYSDK_OFFSET(0x1D1637E0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYBLACKBOARDBYREMOVEATTRIBUTECONFIG_METHOD_4_98A4945ACDE3BC2B_OFFSET UNITYSDK_OFFSET(0x1D163790)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYBLACKBOARDBYREMOVEATTRIBUTECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D163780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyBlackboardByRemoveAttributeConfig_TypeDefinitionIndex = 16983;
