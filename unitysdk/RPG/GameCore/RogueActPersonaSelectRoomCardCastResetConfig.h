...
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTRESETCONFIG_METHOD_7_CDB10AA36623F337_OFFSET UNITYSDK_OFFSET(0x19AF3F90)
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTRESETCONFIG_METHOD_7_DC694F93039E6842_OFFSET UNITYSDK_OFFSET(0x19AF3390)
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTRESETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AF32B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaSelectRoomCardCastResetConfig_TypeDefinitionIndex = 18695;
