...
#define RPG_GAMECORE_SETWAYPOINTSAFEZONE_METHOD_3_A5D3A46C4BEC37B7_OFFSET UNITYSDK_OFFSET(0x176E70B0)
#define RPG_GAMECORE_SETWAYPOINTSAFEZONE_METHOD_3_E0DEE00AEA5BE331_OFFSET UNITYSDK_OFFSET(0x176E7010)
#define RPG_GAMECORE_SETWAYPOINTSAFEZONE__CTOR_OFFSET UNITYSDK_OFFSET(0x176E7070)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetWaypointSafeZone_TypeDefinitionIndex = 19198;
