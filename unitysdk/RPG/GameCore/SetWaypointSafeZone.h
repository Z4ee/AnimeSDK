...
#define RPG_GAMECORE_SETWAYPOINTSAFEZONE_METHOD_3_59AF9A7762D65A32_OFFSET UNITYSDK_OFFSET(0x1E0959B0)
#define RPG_GAMECORE_SETWAYPOINTSAFEZONE_METHOD_3_A5D3A46C4BEC37B7_OFFSET UNITYSDK_OFFSET(0x1E095A00)
#define RPG_GAMECORE_SETWAYPOINTSAFEZONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0959F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetWaypointSafeZone_TypeDefinitionIndex = 20633;
