...
#define RPG_GAMECORE_SETWAYPOINTSAFEZONE_METHOD_3_A5D3A46C4BEC37B7_OFFSET UNITYSDK_OFFSET(0x18E4A5C0)
#define RPG_GAMECORE_SETWAYPOINTSAFEZONE_METHOD_3_E0DEE00AEA5BE331_OFFSET UNITYSDK_OFFSET(0x18E4A520)
#define RPG_GAMECORE_SETWAYPOINTSAFEZONE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E4A580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetWaypointSafeZone_TypeDefinitionIndex = 19857;
