...
#define RPG_GAMECORE_BYCOMPARECHESSROGUEEXISTAEONROOM_METHOD_4_4C288916971C88DE_OFFSET UNITYSDK_OFFSET(0x17004E00)
#define RPG_GAMECORE_BYCOMPARECHESSROGUEEXISTAEONROOM_METHOD_4_B0BB3CE8EA05CDD7_OFFSET UNITYSDK_OFFSET(0x17004ED0)
#define RPG_GAMECORE_BYCOMPARECHESSROGUEEXISTAEONROOM__CTOR_OFFSET UNITYSDK_OFFSET(0x17004E80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareChessRogueExistAeonRoom_TypeDefinitionIndex = 19119;
