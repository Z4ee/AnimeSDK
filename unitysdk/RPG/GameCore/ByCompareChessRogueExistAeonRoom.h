...
#define RPG_GAMECORE_BYCOMPARECHESSROGUEEXISTAEONROOM_METHOD_4_6D39B28620591593_OFFSET UNITYSDK_OFFSET(0x1C30F4B0)
#define RPG_GAMECORE_BYCOMPARECHESSROGUEEXISTAEONROOM_METHOD_4_B0BB3CE8EA05CDD7_OFFSET UNITYSDK_OFFSET(0x1C30F500)
#define RPG_GAMECORE_BYCOMPARECHESSROGUEEXISTAEONROOM__CTOR_OFFSET UNITYSDK_OFFSET(0x1C30F4F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareChessRogueExistAeonRoom_TypeDefinitionIndex = 20560;
