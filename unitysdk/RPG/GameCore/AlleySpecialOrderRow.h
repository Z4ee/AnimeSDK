...
#define RPG_GAMECORE_ALLEYSPECIALORDERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A04FB40)
#define RPG_GAMECORE_ALLEYSPECIALORDERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0505B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AlleySpecialOrderRow_TypeDefinitionIndex = 12144;
	...
	public:
		...
		::Il2CppArray<::System::UInt32>* SpecialOrderContent; // 0x30
		::Il2CppArray<::RPG::GameCore::GoodsClass*>* SpecialOrderGoods; // 0x38
		::System::UInt32 UnlockMission; // 0x40
		::System::UInt32 SpecialOrderShopID; // 0x44
