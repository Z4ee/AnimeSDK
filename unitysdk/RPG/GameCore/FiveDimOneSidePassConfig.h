...
#define RPG_GAMECORE_FIVEDIMONESIDEPASSCONFIG_METHOD_2_C67A0DDAE3F614E5_OFFSET UNITYSDK_OFFSET(0x1974BAF0)
#define RPG_GAMECORE_FIVEDIMONESIDEPASSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1974BC00)
