...
#define RPG_GAMECORE_ILBATTLEAVATARPROMOTIONCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D20A900)
#define RPG_GAMECORE_ILBATTLEAVATARPROMOTIONCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D20AD40)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 UnlockStar; // 0x24
		::System::UInt32 ID; // 0x28
		::RPG::GameCore::IdleLiveAvatarPropertyTargetType PropertyTarget; // 0x2C
		::RPG::GameCore::IdleLiveAvatarPropertyType PropertyType; // 0x30
		::RPG::Client::TextID PromotionDesc; // 0x38
