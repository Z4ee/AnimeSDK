...
#define RPG_GAMECORE_AICOMPOSESELECTOR_METHOD_3_13E768942A8B1625_OFFSET UNITYSDK_OFFSET(0x193C01A0)
#define RPG_GAMECORE_AICOMPOSESELECTOR_METHOD_3_C6ECFC54CB4EA422_OFFSET UNITYSDK_OFFSET(0x193C0160)
#define RPG_GAMECORE_AICOMPOSESELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x193C0190)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AIComposeSelector_TypeDefinitionIndex = 14823;
