...
#define RPG_GAMECORE_ADDCLIENTMAZEBUFF_METHOD_4_5F13EE78D95072C9_OFFSET UNITYSDK_OFFSET(0x1863D4F0)
#define RPG_GAMECORE_ADDCLIENTMAZEBUFF_METHOD_4_C54A77845BD73C9C_OFFSET UNITYSDK_OFFSET(0x1863D570)
#define RPG_GAMECORE_ADDCLIENTMAZEBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x1863D540)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddClientMazeBuff_TypeDefinitionIndex = 20600;
