...
#define RPG_GAMECORE_ADDCLIENTMAZEBUFF_METHOD_4_2CE2FCCC7CF7CFD4_OFFSET UNITYSDK_OFFSET(0x1BE04C30)
#define RPG_GAMECORE_ADDCLIENTMAZEBUFF_METHOD_4_5F13EE78D95072C9_OFFSET UNITYSDK_OFFSET(0x1BE04BF0)
#define RPG_GAMECORE_ADDCLIENTMAZEBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE04C20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddClientMazeBuff_TypeDefinitionIndex = 20948;
