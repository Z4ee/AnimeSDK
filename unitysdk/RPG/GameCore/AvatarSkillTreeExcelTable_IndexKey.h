...
#define RPG_GAMECORE_AVATARSKILLTREEEXCELTABLE_INDEXKEY_EQUALS_OFFSET UNITYSDK_OFFSET(0x39E7D30)
#define RPG_GAMECORE_AVATARSKILLTREEEXCELTABLE_INDEXKEY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x39EB180)
#define RPG_GAMECORE_AVATARSKILLTREEEXCELTABLE_INDEXKEY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x39EB230)
#define RPG_GAMECORE_AVATARSKILLTREEEXCELTABLE_INDEXKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x6E5720)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AvatarSkillTreeExcelTable_IndexKey_TypeDefinitionIndex = 12248;
