...
#define RPG_GAMECORE_STAGELODEDITORCONFIG_METHOD_2_9EE9587EB386AF1F_OFFSET UNITYSDK_OFFSET(0x1CAE73A0)
#define RPG_GAMECORE_STAGELODEDITORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CAE7510)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StageLodEditorConfig_TypeDefinitionIndex = 18979;
