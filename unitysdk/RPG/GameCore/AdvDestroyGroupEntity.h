...
#define RPG_GAMECORE_ADVDESTROYGROUPENTITY_METHOD_3_6734656274AFE3CC_OFFSET UNITYSDK_OFFSET(0x16F2A6A0)
#define RPG_GAMECORE_ADVDESTROYGROUPENTITY_METHOD_3_FF5340F62945CD5D_OFFSET UNITYSDK_OFFSET(0x16F2A720)
#define RPG_GAMECORE_ADVDESTROYGROUPENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x16F2A6F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvDestroyGroupEntity_TypeDefinitionIndex = 18572;
