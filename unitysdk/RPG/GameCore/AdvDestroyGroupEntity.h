...
#define RPG_GAMECORE_ADVDESTROYGROUPENTITY_METHOD_3_6734656274AFE3CC_OFFSET UNITYSDK_OFFSET(0x1864C870)
#define RPG_GAMECORE_ADVDESTROYGROUPENTITY_METHOD_3_FF5340F62945CD5D_OFFSET UNITYSDK_OFFSET(0x1864C8F0)
#define RPG_GAMECORE_ADVDESTROYGROUPENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1864C8C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvDestroyGroupEntity_TypeDefinitionIndex = 19227;
