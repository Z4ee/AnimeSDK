...
#define RPG_GAMECORE_LITTLEGAMETEMPLATECONFIGS_METHOD_2_513DF7E17444C5D7_OFFSET UNITYSDK_OFFSET(0x1DD6EB20)
#define RPG_GAMECORE_LITTLEGAMETEMPLATECONFIGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD6EB60)
