...
#define RPG_GAMECORE_LITTLEGAMETEMPLATECONFIGS_METHOD_2_513DF7E17444C5D7_OFFSET UNITYSDK_OFFSET(0x173612E0)
#define RPG_GAMECORE_LITTLEGAMETEMPLATECONFIGS__CTOR_OFFSET UNITYSDK_OFFSET(0x17361320)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameTemplateConfigs_TypeDefinitionIndex = 17351;
