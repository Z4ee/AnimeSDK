...
#define RPG_GAMECORE_LITTLEGAMETEMPLATECONFIGS_METHOD_2_513DF7E17444C5D7_OFFSET UNITYSDK_OFFSET(0x198A28E0)
#define RPG_GAMECORE_LITTLEGAMETEMPLATECONFIGS__CTOR_OFFSET UNITYSDK_OFFSET(0x198A2920)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameTemplateConfigs_TypeDefinitionIndex = 17986;
