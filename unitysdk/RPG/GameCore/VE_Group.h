...
#define RPG_GAMECORE_VE_GROUP_METHOD_3_20EB88CDB4310F3C_OFFSET UNITYSDK_OFFSET(0x1B88D360)
#define RPG_GAMECORE_VE_GROUP_METHOD_3_5A3FFA54DD350DA7_OFFSET UNITYSDK_OFFSET(0x1B88D540)
#define RPG_GAMECORE_VE_GROUP_METHOD_3_803E74E170314A61_OFFSET UNITYSDK_OFFSET(0x1B88D570)
#define RPG_GAMECORE_VE_GROUP_METHOD_3_D6933F22CF56C049_OFFSET UNITYSDK_OFFSET(0x1B88D320)
#define RPG_GAMECORE_VE_GROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B88D350)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VE_Group_TypeDefinitionIndex = 23187;
