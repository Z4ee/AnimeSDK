...
#define RPG_GAMECORE_CREATEBATTLEEVENTFROMGRIDFIGHTBACKEND_METHOD_4_1064A55224404902_OFFSET UNITYSDK_OFFSET(0x18841C60)
#define RPG_GAMECORE_CREATEBATTLEEVENTFROMGRIDFIGHTBACKEND_METHOD_4_72086B7FCC7551F4_OFFSET UNITYSDK_OFFSET(0x188415E0)
#define RPG_GAMECORE_CREATEBATTLEEVENTFROMGRIDFIGHTBACKEND__CTOR_OFFSET UNITYSDK_OFFSET(0x188415A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CreateBattleEventFromGridFightBackend_TypeDefinitionIndex = 22394;
