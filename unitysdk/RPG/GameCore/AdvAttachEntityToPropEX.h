...
#define RPG_GAMECORE_ADVATTACHENTITYTOPROPEX_METHOD_3_67C7EEE2696906E2_OFFSET UNITYSDK_OFFSET(0x16F24140)
#define RPG_GAMECORE_ADVATTACHENTITYTOPROPEX_METHOD_3_CBD840F6FDA264F7_OFFSET UNITYSDK_OFFSET(0x16F241C0)
#define RPG_GAMECORE_ADVATTACHENTITYTOPROPEX__CTOR_OFFSET UNITYSDK_OFFSET(0x16F24190)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvAttachEntityToPropEX_TypeDefinitionIndex = 20139;
