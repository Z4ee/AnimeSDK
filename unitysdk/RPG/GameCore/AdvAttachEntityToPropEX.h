...
#define RPG_GAMECORE_ADVATTACHENTITYTOPROPEX_METHOD_3_CBD840F6FDA264F7_OFFSET UNITYSDK_OFFSET(0x1BE0CC20)
#define RPG_GAMECORE_ADVATTACHENTITYTOPROPEX_METHOD_3_EEAD5B9873281349_OFFSET UNITYSDK_OFFSET(0x1BE0CBE0)
#define RPG_GAMECORE_ADVATTACHENTITYTOPROPEX__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE0CC10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvAttachEntityToPropEX_TypeDefinitionIndex = 21160;
