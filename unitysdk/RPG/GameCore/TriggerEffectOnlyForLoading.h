...
#define RPG_GAMECORE_TRIGGEREFFECTONLYFORLOADING_METHOD_3_72E7DE47D4C24AB9_OFFSET UNITYSDK_OFFSET(0x19E14170)
#define RPG_GAMECORE_TRIGGEREFFECTONLYFORLOADING_METHOD_3_BB28D394FFC6CFE6_OFFSET UNITYSDK_OFFSET(0x19E141F0)
#define RPG_GAMECORE_TRIGGEREFFECTONLYFORLOADING__CTOR_OFFSET UNITYSDK_OFFSET(0x19E141C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerEffectOnlyForLoading_TypeDefinitionIndex = 19132;
