...
#define RPG_GAMECORE_ADVBYCOMPAREDIMENSIONID_METHOD_4_8C035312B409C1F4_OFFSET UNITYSDK_OFFSET(0x186478F0)
#define RPG_GAMECORE_ADVBYCOMPAREDIMENSIONID_METHOD_4_97D4663178FC5FD0_OFFSET UNITYSDK_OFFSET(0x18647810)
#define RPG_GAMECORE_ADVBYCOMPAREDIMENSIONID__CTOR_OFFSET UNITYSDK_OFFSET(0x18647890)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvByCompareDimensionID_TypeDefinitionIndex = 19538;
