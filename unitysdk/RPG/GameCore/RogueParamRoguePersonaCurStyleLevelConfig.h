...
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONACURSTYLELEVELCONFIG_METHOD_6_9BB415E1A5793CC2_OFFSET UNITYSDK_OFFSET(0x18D5B790)
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONACURSTYLELEVELCONFIG_METHOD_6_D1083A5EAD017AEC_OFFSET UNITYSDK_OFFSET(0x18D5B4E0)
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONACURSTYLELEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D5B660)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamRoguePersonaCurStyleLevelConfig_TypeDefinitionIndex = 18844;
