...
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONACURSTYLELEVELCONFIG_METHOD_6_9BB415E1A5793CC2_OFFSET UNITYSDK_OFFSET(0x1764DCE0)
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONACURSTYLELEVELCONFIG_METHOD_6_D1083A5EAD017AEC_OFFSET UNITYSDK_OFFSET(0x1764DA30)
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONACURSTYLELEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1764DBB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamRoguePersonaCurStyleLevelConfig_TypeDefinitionIndex = 18197;
