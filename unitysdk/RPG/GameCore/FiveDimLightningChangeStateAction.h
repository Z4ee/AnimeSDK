...
#define RPG_GAMECORE_FIVEDIMLIGHTNINGCHANGESTATEACTION_METHOD_3_15098C46CEC614E3_OFFSET UNITYSDK_OFFSET(0x1BE9FFF0)
#define RPG_GAMECORE_FIVEDIMLIGHTNINGCHANGESTATEACTION_METHOD_3_370E27C9EAE8EFB0_OFFSET UNITYSDK_OFFSET(0x1BEA0030)
#define RPG_GAMECORE_FIVEDIMLIGHTNINGCHANGESTATEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEA0020)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimLightningChangeStateAction_TypeDefinitionIndex = 18050;
