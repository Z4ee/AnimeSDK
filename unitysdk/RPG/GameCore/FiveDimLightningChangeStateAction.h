...
#define RPG_GAMECORE_FIVEDIMLIGHTNINGCHANGESTATEACTION_METHOD_3_3480EC9A2A19A379_OFFSET UNITYSDK_OFFSET(0x171F98F0)
#define RPG_GAMECORE_FIVEDIMLIGHTNINGCHANGESTATEACTION_METHOD_3_587F683E7DA9B7D4_OFFSET UNITYSDK_OFFSET(0x171F9880)
#define RPG_GAMECORE_FIVEDIMLIGHTNINGCHANGESTATEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x171F98D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimLightningChangeStateAction_TypeDefinitionIndex = 17241;
