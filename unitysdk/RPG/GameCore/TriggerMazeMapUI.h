...
#define RPG_GAMECORE_TRIGGERMAZEMAPUI_METHOD_3_8AD7E358FC0F78AE_OFFSET UNITYSDK_OFFSET(0x178C9BA0)
#define RPG_GAMECORE_TRIGGERMAZEMAPUI_METHOD_3_D2A2CC83D6985EE2_OFFSET UNITYSDK_OFFSET(0x178C9A90)
#define RPG_GAMECORE_TRIGGERMAZEMAPUI__CTOR_OFFSET UNITYSDK_OFFSET(0x178C9B70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerMazeMapUI_TypeDefinitionIndex = 20260;
