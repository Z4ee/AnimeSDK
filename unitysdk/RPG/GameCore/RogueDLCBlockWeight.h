...
#define RPG_GAMECORE_ROGUEDLCBLOCKWEIGHT_METHOD_2_EB041128467ADAA0_OFFSET UNITYSDK_OFFSET(0x1C4B8EF0)
#define RPG_GAMECORE_ROGUEDLCBLOCKWEIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4B9010)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueDLCBlockWeight_TypeDefinitionIndex = 17183;
