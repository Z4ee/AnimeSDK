...
#define RPG_GAMECORE_ROGUEDLCBLOCKWEIGHT_METHOD_2_EB041128467ADAA0_OFFSET UNITYSDK_OFFSET(0x19B2BFA0)
#define RPG_GAMECORE_ROGUEDLCBLOCKWEIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x19B2C0C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueDLCBlockWeight_TypeDefinitionIndex = 17021;
