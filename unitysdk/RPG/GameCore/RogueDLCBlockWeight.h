...
#define RPG_GAMECORE_ROGUEDLCBLOCKWEIGHT_METHOD_2_EB041128467ADAA0_OFFSET UNITYSDK_OFFSET(0x18D06DB0)
#define RPG_GAMECORE_ROGUEDLCBLOCKWEIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x18D06ED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueDLCBlockWeight_TypeDefinitionIndex = 17007;
