...
#define RPG_GAMECORE_DAWNSEYEDISASTERUICONFIG_METHOD_3_42CCB787F86EA64B_OFFSET UNITYSDK_OFFSET(0x1714B7D0)
#define RPG_GAMECORE_DAWNSEYEDISASTERUICONFIG_METHOD_3_A6A74C8ECE278D46_OFFSET UNITYSDK_OFFSET(0x1714B830)
#define RPG_GAMECORE_DAWNSEYEDISASTERUICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1714B820)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DawnsEyeDisasterUIConfig_TypeDefinitionIndex = 20993;
