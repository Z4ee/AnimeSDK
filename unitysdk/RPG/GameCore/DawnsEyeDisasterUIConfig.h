...
#define RPG_GAMECORE_DAWNSEYEDISASTERUICONFIG_METHOD_3_42CCB787F86EA64B_OFFSET UNITYSDK_OFFSET(0x1C0FB680)
#define RPG_GAMECORE_DAWNSEYEDISASTERUICONFIG_METHOD_3_A6A74C8ECE278D46_OFFSET UNITYSDK_OFFSET(0x1C0FB6E0)
#define RPG_GAMECORE_DAWNSEYEDISASTERUICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0FB6D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DawnsEyeDisasterUIConfig_TypeDefinitionIndex = 21978;
