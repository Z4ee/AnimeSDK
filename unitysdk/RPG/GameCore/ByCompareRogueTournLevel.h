...
#define RPG_GAMECORE_BYCOMPAREROGUETOURNLEVEL_METHOD_4_78EEF634CF91C0EE_OFFSET UNITYSDK_OFFSET(0x1A89EB40)
#define RPG_GAMECORE_BYCOMPAREROGUETOURNLEVEL_METHOD_4_7D3B1E207CEEE0AA_OFFSET UNITYSDK_OFFSET(0x1A89EB90)
#define RPG_GAMECORE_BYCOMPAREROGUETOURNLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A89EB80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareRogueTournLevel_TypeDefinitionIndex = 20438;
