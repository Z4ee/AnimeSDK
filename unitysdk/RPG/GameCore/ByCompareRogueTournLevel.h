...
#define RPG_GAMECORE_BYCOMPAREROGUETOURNLEVEL_METHOD_4_0B41E09874335DF3_OFFSET UNITYSDK_OFFSET(0x187396F0)
#define RPG_GAMECORE_BYCOMPAREROGUETOURNLEVEL_METHOD_4_7D3B1E207CEEE0AA_OFFSET UNITYSDK_OFFSET(0x187397C0)
#define RPG_GAMECORE_BYCOMPAREROGUETOURNLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x18739770)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareRogueTournLevel_TypeDefinitionIndex = 20210;
