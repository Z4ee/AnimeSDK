...
#define RPG_GAMECORE_STOPANIMATORLAYEREMOTION_METHOD_3_34F10874F020884D_OFFSET UNITYSDK_OFFSET(0x19CBF430)
#define RPG_GAMECORE_STOPANIMATORLAYEREMOTION_METHOD_3_8990A079CAD4B661_OFFSET UNITYSDK_OFFSET(0x19CBF4C0)
#define RPG_GAMECORE_STOPANIMATORLAYEREMOTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19CBF490)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StopAnimatorLayerEmotion_TypeDefinitionIndex = 19457;
