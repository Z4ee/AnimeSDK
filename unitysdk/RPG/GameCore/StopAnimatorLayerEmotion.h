...
#define RPG_GAMECORE_STOPANIMATORLAYEREMOTION_METHOD_3_34F10874F020884D_OFFSET UNITYSDK_OFFSET(0x18EA2590)
#define RPG_GAMECORE_STOPANIMATORLAYEREMOTION_METHOD_3_8990A079CAD4B661_OFFSET UNITYSDK_OFFSET(0x18EA2620)
#define RPG_GAMECORE_STOPANIMATORLAYEREMOTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18EA25F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StopAnimatorLayerEmotion_TypeDefinitionIndex = 19566;
