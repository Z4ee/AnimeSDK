...
#define RPG_GAMECORE_SETDYNAMICVALUEBYMAGICUNITCOUNTER_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x19C422A0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYMAGICUNITCOUNTER_METHOD_4_A4415565A886D4EB_OFFSET UNITYSDK_OFFSET(0x19C42220)
#define RPG_GAMECORE_SETDYNAMICVALUEBYMAGICUNITCOUNTER_METHOD_4_E2E0F950C900DFC3_OFFSET UNITYSDK_OFFSET(0x19C3C470)
#define RPG_GAMECORE_SETDYNAMICVALUEBYMAGICUNITCOUNTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19C3C420)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByMagicUnitCounter_TypeDefinitionIndex = 21851;
