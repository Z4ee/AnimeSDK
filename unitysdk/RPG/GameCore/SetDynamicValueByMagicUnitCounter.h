...
#define RPG_GAMECORE_SETDYNAMICVALUEBYMAGICUNITCOUNTER_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1E81F340)
#define RPG_GAMECORE_SETDYNAMICVALUEBYMAGICUNITCOUNTER_METHOD_4_150E5991E6FD63B2_OFFSET UNITYSDK_OFFSET(0x1E81F0E0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYMAGICUNITCOUNTER_METHOD_4_E2E0F950C900DFC3_OFFSET UNITYSDK_OFFSET(0x1E81F120)
#define RPG_GAMECORE_SETDYNAMICVALUEBYMAGICUNITCOUNTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E81F110)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByMagicUnitCounter_TypeDefinitionIndex = 22847;
