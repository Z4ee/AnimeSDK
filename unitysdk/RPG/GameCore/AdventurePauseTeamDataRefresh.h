...
#define RPG_GAMECORE_ADVENTUREPAUSETEAMDATAREFRESH_METHOD_3_41A700F1FAD9C77C_OFFSET UNITYSDK_OFFSET(0x18679670)
#define RPG_GAMECORE_ADVENTUREPAUSETEAMDATAREFRESH_METHOD_3_535C94F4924AE60D_OFFSET UNITYSDK_OFFSET(0x186795E0)
#define RPG_GAMECORE_ADVENTUREPAUSETEAMDATAREFRESH__CTOR_OFFSET UNITYSDK_OFFSET(0x18679640)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventurePauseTeamDataRefresh_TypeDefinitionIndex = 19355;
