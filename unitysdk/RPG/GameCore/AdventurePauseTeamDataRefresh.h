...
#define RPG_GAMECORE_ADVENTUREPAUSETEAMDATAREFRESH_METHOD_3_41A700F1FAD9C77C_OFFSET UNITYSDK_OFFSET(0x1CBBBF80)
#define RPG_GAMECORE_ADVENTUREPAUSETEAMDATAREFRESH_METHOD_3_78639669267822F7_OFFSET UNITYSDK_OFFSET(0x1CBBBF30)
#define RPG_GAMECORE_ADVENTUREPAUSETEAMDATAREFRESH__CTOR_OFFSET UNITYSDK_OFFSET(0x1CBBBF70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventurePauseTeamDataRefresh_TypeDefinitionIndex = 20165;
