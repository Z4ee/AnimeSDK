...
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCREFORGEMAGICUNITCONFIG_METHOD_3_7726350A4C269BE1_OFFSET UNITYSDK_OFFSET(0x176738B0)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCREFORGEMAGICUNITCONFIG_METHOD_3_D704AB33EECB9345_OFFSET UNITYSDK_OFFSET(0x176735D0)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCREFORGEMAGICUNITCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x176735C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueWorkbenchFuncReforgeMagicUnitConfig_TypeDefinitionIndex = 16575;
