...
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCREFORGEMAGICUNITCONFIG_METHOD_3_7726350A4C269BE1_OFFSET UNITYSDK_OFFSET(0x1BB82460)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCREFORGEMAGICUNITCONFIG_METHOD_3_D704AB33EECB9345_OFFSET UNITYSDK_OFFSET(0x1BB82180)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCREFORGEMAGICUNITCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB82170)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueWorkbenchFuncReforgeMagicUnitConfig_TypeDefinitionIndex = 17304;
