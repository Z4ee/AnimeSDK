...
#define RPG_GAMECORE_ROGUEDLCBOSSDECAYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D3D6720)
#define RPG_GAMECORE_ROGUEDLCBOSSDECAYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3D70B0)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::Il2CppArray<::System::UInt32>* EffectParamList; // 0x10
		::Il2CppArray<::RPG::GameCore::FixPoint>* DescParam; // 0x18
		::System::String* DecayIcon; // 0x20
		::System::String* BossEffectIcon; // 0x28
		::Il2CppArray<::System::UInt32>* ExtraDesc; // 0x30
		::RPG::Client::TextID BossDecayName; // 0x38
		::System::Boolean IsBuff; // 0x48
		::RPG::Client::TextID BossDecayDesc; // 0x50
		::System::UInt32 BossDecayID; // 0x60
		::RPG::GameCore::ChessRogueDecayEffectType EffectType; // 0x64
