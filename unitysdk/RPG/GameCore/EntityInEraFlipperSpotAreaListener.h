...
#define RPG_GAMECORE_ENTITYINERAFLIPPERSPOTAREALISTENER_METHOD_3_034FD32887F69155_OFFSET UNITYSDK_OFFSET(0x1D7C4120)
#define RPG_GAMECORE_ENTITYINERAFLIPPERSPOTAREALISTENER_METHOD_3_8967B17D24D0661A_OFFSET UNITYSDK_OFFSET(0x1D7C4170)
#define RPG_GAMECORE_ENTITYINERAFLIPPERSPOTAREALISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7C4160)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EntityInEraFlipperSpotAreaListener_TypeDefinitionIndex = 22100;
