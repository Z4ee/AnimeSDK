...
#define RPG_GAMECORE_LITTLEGAMENAVMAPICONCONFIG_METHOD_3_85D7530ADC4F48D2_OFFSET UNITYSDK_OFFSET(0x1BCC3E10)
#define RPG_GAMECORE_LITTLEGAMENAVMAPICONCONFIG_METHOD_3_DCCC1C3CFBE818AB_OFFSET UNITYSDK_OFFSET(0x1BCC3DD0)
#define RPG_GAMECORE_LITTLEGAMENAVMAPICONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCC3E00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameNavMapIconConfig_TypeDefinitionIndex = 18097;
