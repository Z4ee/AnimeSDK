...
#define RPG_GAMECORE_LITTLEGAMENAVMAPICONCONFIG_METHOD_3_17F21F518C653705_OFFSET UNITYSDK_OFFSET(0x18A6DAD0)
#define RPG_GAMECORE_LITTLEGAMENAVMAPICONCONFIG_METHOD_3_85D7530ADC4F48D2_OFFSET UNITYSDK_OFFSET(0x18A68B80)
#define RPG_GAMECORE_LITTLEGAMENAVMAPICONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18A68B60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameNavMapIconConfig_TypeDefinitionIndex = 17889;
