...
#define RPG_GAMECORE_BATTLETARGETDETAILDATA_GET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0x38BC8A0)
#define RPG_GAMECORE_BATTLETARGETDETAILDATA_GET_TOTALPROGRESS_OFFSET UNITYSDK_OFFSET(0x38BC830)
#define RPG_GAMECORE_BATTLETARGETDETAILDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x2F01D90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleTargetDetailData_TypeDefinitionIndex = 55030;
