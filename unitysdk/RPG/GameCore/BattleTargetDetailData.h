...
#define RPG_GAMECORE_BATTLETARGETDETAILDATA_GET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0x88260)
#define RPG_GAMECORE_BATTLETARGETDETAILDATA_GET_TOTALPROGRESS_OFFSET UNITYSDK_OFFSET(0x88200)
#define RPG_GAMECORE_BATTLETARGETDETAILDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x29380)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleTargetDetailData_TypeDefinitionIndex = 46414;
