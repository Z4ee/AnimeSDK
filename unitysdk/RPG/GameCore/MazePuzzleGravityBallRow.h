...
#define RPG_GAMECORE_MAZEPUZZLEGRAVITYBALLROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19904C30)
#define RPG_GAMECORE_MAZEPUZZLEGRAVITYBALLROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19904E00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MazePuzzleGravityBallRow_TypeDefinitionIndex = 13424;
