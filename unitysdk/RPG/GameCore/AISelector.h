...
#define RPG_GAMECORE_AISELECTOR_METHOD_2_1499B2CFC36F7F2A_OFFSET UNITYSDK_OFFSET(0x185F1FF0)
#define RPG_GAMECORE_AISELECTOR_METHOD_2_C77873DCB48381B2_OFFSET UNITYSDK_OFFSET(0x185F0CB0)
#define RPG_GAMECORE_AISELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x185EEF50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AISelector_TypeDefinitionIndex = 14757;
