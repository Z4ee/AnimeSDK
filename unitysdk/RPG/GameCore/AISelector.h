...
#define RPG_GAMECORE_AISELECTOR_METHOD_2_1499B2CFC36F7F2A_OFFSET UNITYSDK_OFFSET(0x16E91A10)
#define RPG_GAMECORE_AISELECTOR_METHOD_2_C77873DCB48381B2_OFFSET UNITYSDK_OFFSET(0x16E906D0)
#define RPG_GAMECORE_AISELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x16E8E970)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AISelector_TypeDefinitionIndex = 14287;
