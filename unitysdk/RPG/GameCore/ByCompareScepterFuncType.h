...
#define RPG_GAMECORE_BYCOMPARESCEPTERFUNCTYPE_METHOD_4_09D2C9D48E4787C6_OFFSET UNITYSDK_OFFSET(0x1873A1D0)
#define RPG_GAMECORE_BYCOMPARESCEPTERFUNCTYPE_METHOD_4_BFBC711682BA2846_OFFSET UNITYSDK_OFFSET(0x1873A2A0)
#define RPG_GAMECORE_BYCOMPARESCEPTERFUNCTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1873A250)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareScepterFuncType_TypeDefinitionIndex = 22047;
