...
#define RPG_GAMECORE_PHONETHEMEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B4BC370)
#define RPG_GAMECORE_PHONETHEMEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4BCA70)
