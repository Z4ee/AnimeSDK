...
#define RPG_GAMECORE_VISIONBASECONFIG_METHOD_2_BA507DEA0274B1FE_OFFSET UNITYSDK_OFFSET(0x190F49E0)
#define RPG_GAMECORE_VISIONBASECONFIG_METHOD_2_D349B65F483C2B0F_OFFSET UNITYSDK_OFFSET(0x190F4C60)
#define RPG_GAMECORE_VISIONBASECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x190F4C50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VisionBaseConfig_TypeDefinitionIndex = 18916;
