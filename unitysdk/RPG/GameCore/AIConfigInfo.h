...
#define RPG_GAMECORE_AICONFIGINFO_METHOD_2_DF21448CDB60F750_OFFSET UNITYSDK_OFFSET(0x1D321CF0)
#define RPG_GAMECORE_AICONFIGINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D321F80)
