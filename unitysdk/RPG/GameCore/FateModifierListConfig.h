...
#define RPG_GAMECORE_FATEMODIFIERLISTCONFIG_METHOD_2_D8D869902EEF52ED_OFFSET UNITYSDK_OFFSET(0x19712570)
#define RPG_GAMECORE_FATEMODIFIERLISTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197125B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateModifierListConfig_TypeDefinitionIndex = 18267;
