...
#define RPG_GAMECORE_TRIGGERPAMMOVEPHASETALKWAIT_METHOD_3_D2E349BD7DD31F5A_OFFSET UNITYSDK_OFFSET(0x178CB9F0)
#define RPG_GAMECORE_TRIGGERPAMMOVEPHASETALKWAIT_METHOD_3_D6320ACE549608AE_OFFSET UNITYSDK_OFFSET(0x178CB8E0)
#define RPG_GAMECORE_TRIGGERPAMMOVEPHASETALKWAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x178CB9C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerPamMovePhaseTalkWait_TypeDefinitionIndex = 18302;
