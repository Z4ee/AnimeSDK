...
#define RPG_GAMECORE_BATTLESCORINGCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CE7FCF0)
#define RPG_GAMECORE_BATTLESCORINGCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE80590)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 BonusScore; // 0x38
		::System::UInt32 GameModeGroup; // 0x3C
		::RPG::Client::TextID ScoreRuleDesc; // 0x40
		::System::UInt32 ScoringID; // 0x50
		::RPG::GameCore::BattleScoringType ScoringType; // 0x54
