...
#define RPG_GAMECORE_TARGETFETCHTASKACTIONTARGET_METHOD_4_0975F12C965F123C_OFFSET UNITYSDK_OFFSET(0x177C04F0)
#define RPG_GAMECORE_TARGETFETCHTASKACTIONTARGET_METHOD_4_BB7BC79E918F2D3E_OFFSET UNITYSDK_OFFSET(0x177B89E0)
#define RPG_GAMECORE_TARGETFETCHTASKACTIONTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x177B8990)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchTaskActionTarget_TypeDefinitionIndex = 22200;
