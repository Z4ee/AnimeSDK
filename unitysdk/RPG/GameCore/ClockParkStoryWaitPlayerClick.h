...
#define RPG_GAMECORE_CLOCKPARKSTORYWAITPLAYERCLICK_METHOD_3_87B15D77F4333BFA_OFFSET UNITYSDK_OFFSET(0x1711B260)
#define RPG_GAMECORE_CLOCKPARKSTORYWAITPLAYERCLICK_METHOD_3_E8E369119D8C4283_OFFSET UNITYSDK_OFFSET(0x1711B2E0)
#define RPG_GAMECORE_CLOCKPARKSTORYWAITPLAYERCLICK__CTOR_OFFSET UNITYSDK_OFFSET(0x1711B2B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClockParkStoryWaitPlayerClick_TypeDefinitionIndex = 19277;
