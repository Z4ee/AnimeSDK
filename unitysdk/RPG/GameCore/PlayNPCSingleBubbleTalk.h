...
#define RPG_GAMECORE_PLAYNPCSINGLEBUBBLETALK_METHOD_3_9902D67DA8CAACEE_OFFSET UNITYSDK_OFFSET(0x18C0F4E0)
#define RPG_GAMECORE_PLAYNPCSINGLEBUBBLETALK_METHOD_3_FF3195682057F645_OFFSET UNITYSDK_OFFSET(0x18C0F6C0)
#define RPG_GAMECORE_PLAYNPCSINGLEBUBBLETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x18C0F5E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayNPCSingleBubbleTalk_TypeDefinitionIndex = 20438;
