...
#define RPG_GAMECORE_PLAYNPCSINGLEBUBBLETALK_METHOD_3_C60EFD1E9410B8FA_OFFSET UNITYSDK_OFFSET(0x1D7A5F00)
#define RPG_GAMECORE_PLAYNPCSINGLEBUBBLETALK_METHOD_3_FF3195682057F645_OFFSET UNITYSDK_OFFSET(0x1D7A6020)
#define RPG_GAMECORE_PLAYNPCSINGLEBUBBLETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7A5FA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayNPCSingleBubbleTalk_TypeDefinitionIndex = 21351;
