...
#define RPG_GAMECORE_ADVONBUTTONPRESSED_METHOD_3_241511C486366CA3_OFFSET UNITYSDK_OFFSET(0x1BE26C40)
#define RPG_GAMECORE_ADVONBUTTONPRESSED_METHOD_3_CBA7E34C1344B324_OFFSET UNITYSDK_OFFSET(0x1BE26C80)
#define RPG_GAMECORE_ADVONBUTTONPRESSED__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE26C70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvOnButtonPressed_TypeDefinitionIndex = 19755;
