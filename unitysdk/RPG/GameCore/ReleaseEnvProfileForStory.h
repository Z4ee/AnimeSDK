...
#define RPG_GAMECORE_RELEASEENVPROFILEFORSTORY_METHOD_3_4240564C8455DD72_OFFSET UNITYSDK_OFFSET(0x18C96F00)
#define RPG_GAMECORE_RELEASEENVPROFILEFORSTORY_METHOD_3_CF5AD398A5D10406_OFFSET UNITYSDK_OFFSET(0x18C96DF0)
#define RPG_GAMECORE_RELEASEENVPROFILEFORSTORY__CTOR_OFFSET UNITYSDK_OFFSET(0x18C96ED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ReleaseEnvProfileForStory_TypeDefinitionIndex = 20753;
