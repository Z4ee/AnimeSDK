...
#define RPG_GAMECORE_RELEASEENVPROFILEFORSTORY_METHOD_3_4240564C8455DD72_OFFSET UNITYSDK_OFFSET(0x1B9C24D0)
#define RPG_GAMECORE_RELEASEENVPROFILEFORSTORY_METHOD_3_4CC40DC71D842EEF_OFFSET UNITYSDK_OFFSET(0x1B9C2400)
#define RPG_GAMECORE_RELEASEENVPROFILEFORSTORY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9C24C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ReleaseEnvProfileForStory_TypeDefinitionIndex = 21096;
