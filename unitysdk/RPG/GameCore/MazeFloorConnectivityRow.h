...
#define RPG_GAMECORE_MAZEFLOORCONNECTIVITYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x173C17D0)
#define RPG_GAMECORE_MAZEFLOORCONNECTIVITYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x173C1E30)
