...
#define RPG_GAMECORE_SETNAVIGATIONTARGET_METHOD_3_33926BDD4A112554_OFFSET UNITYSDK_OFFSET(0x176D9EF0)
#define RPG_GAMECORE_SETNAVIGATIONTARGET_METHOD_3_4664254D2B22BF45_OFFSET UNITYSDK_OFFSET(0x176D9F70)
#define RPG_GAMECORE_SETNAVIGATIONTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x176D9F40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetNavigationTarget_TypeDefinitionIndex = 22406;
