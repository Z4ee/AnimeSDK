...
#define RPG_GAMECORE_PINGPONGENEMYSHOOTOVERRIDECONFIG_METHOD_2_CD2C58674EAFEDD6_OFFSET UNITYSDK_OFFSET(0x174B0750)
#define RPG_GAMECORE_PINGPONGENEMYSHOOTOVERRIDECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x174B08D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PingPongEnemyShootOverrideConfig_TypeDefinitionIndex = 17372;
