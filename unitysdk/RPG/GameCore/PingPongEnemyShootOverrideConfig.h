...
#define RPG_GAMECORE_PINGPONGENEMYSHOOTOVERRIDECONFIG_METHOD_2_CD2C58674EAFEDD6_OFFSET UNITYSDK_OFFSET(0x19A0DB70)
#define RPG_GAMECORE_PINGPONGENEMYSHOOTOVERRIDECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19A0DCF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PingPongEnemyShootOverrideConfig_TypeDefinitionIndex = 18007;
