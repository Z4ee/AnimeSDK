...
#define RPG_GAMECORE_PINGPONGENEMYSHOOTOVERRIDECONFIG_METHOD_2_CD2C58674EAFEDD6_OFFSET UNITYSDK_OFFSET(0x1D78DC40)
#define RPG_GAMECORE_PINGPONGENEMYSHOOTOVERRIDECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D78DDC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PingPongEnemyShootOverrideConfig_TypeDefinitionIndex = 18715;
