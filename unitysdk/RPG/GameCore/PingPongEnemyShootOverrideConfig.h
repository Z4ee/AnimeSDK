...
#define RPG_GAMECORE_PINGPONGENEMYSHOOTOVERRIDECONFIG_METHOD_2_CD2C58674EAFEDD6_OFFSET UNITYSDK_OFFSET(0x1B4C7DA0)
#define RPG_GAMECORE_PINGPONGENEMYSHOOTOVERRIDECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4C7F20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PingPongEnemyShootOverrideConfig_TypeDefinitionIndex = 18191;
