...
#define RPG_GAMECORE_ELFSPECIALEVENTEFFECT_METHOD_2_3380F9C49780A535_OFFSET UNITYSDK_OFFSET(0x196DD8C0)
#define RPG_GAMECORE_ELFSPECIALEVENTEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x196DDAB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfSpecialEventEffect_TypeDefinitionIndex = 17590;
