...
#define RPG_GAMECORE_ELFSPECIALEVENTEFFECT_METHOD_2_3380F9C49780A535_OFFSET UNITYSDK_OFFSET(0x1BB39DD0)
#define RPG_GAMECORE_ELFSPECIALEVENTEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB39FC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfSpecialEventEffect_TypeDefinitionIndex = 17763;
