...
#define RPG_GAMECORE_DEPLOYPUZZLECHANGELINEINTENSITY_METHOD_3_151E4C41CB28E87B_OFFSET UNITYSDK_OFFSET(0x17152ED0)
#define RPG_GAMECORE_DEPLOYPUZZLECHANGELINEINTENSITY_METHOD_3_7297CD96B64313A5_OFFSET UNITYSDK_OFFSET(0x17153010)
#define RPG_GAMECORE_DEPLOYPUZZLECHANGELINEINTENSITY__CTOR_OFFSET UNITYSDK_OFFSET(0x17152F80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DeployPuzzleChangeLineIntensity_TypeDefinitionIndex = 20156;
