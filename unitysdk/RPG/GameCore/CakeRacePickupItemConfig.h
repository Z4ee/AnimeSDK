...
#define RPG_GAMECORE_CAKERACEPICKUPITEMCONFIG_METHOD_2_DF9660E98932E60C_OFFSET UNITYSDK_OFFSET(0x1D1038C0)
#define RPG_GAMECORE_CAKERACEPICKUPITEMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D103B30)
