...
#define RPG_GAMECORE_SIMULATELINEUPCONFIG_METHOD_2_FF24423F7227C39E_OFFSET UNITYSDK_OFFSET(0x1770A2C0)
#define RPG_GAMECORE_SIMULATELINEUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1770A3C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SimulateLineupConfig_TypeDefinitionIndex = 16651;
