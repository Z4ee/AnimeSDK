...
#define RPG_GAMECORE_BATTLECHANGEAVATAR_BEGIN_METHOD_3_19BC27478A940D3B_OFFSET UNITYSDK_OFFSET(0x16FCC8D0)
#define RPG_GAMECORE_BATTLECHANGEAVATAR_BEGIN_METHOD_3_B6A5BBBE236312F3_OFFSET UNITYSDK_OFFSET(0x16FCC9F0)
#define RPG_GAMECORE_BATTLECHANGEAVATAR_BEGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x16FCC970)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleChangeAvatar_Begin_TypeDefinitionIndex = 20969;
