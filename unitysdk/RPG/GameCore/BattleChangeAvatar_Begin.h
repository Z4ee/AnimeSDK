...
#define RPG_GAMECORE_BATTLECHANGEAVATAR_BEGIN_METHOD_3_B6A5BBBE236312F3_OFFSET UNITYSDK_OFFSET(0x1B2F18B0)
#define RPG_GAMECORE_BATTLECHANGEAVATAR_BEGIN_METHOD_3_BBE9E0D6306778E0_OFFSET UNITYSDK_OFFSET(0x1B2F17B0)
#define RPG_GAMECORE_BATTLECHANGEAVATAR_BEGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2F1840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleChangeAvatar_Begin_TypeDefinitionIndex = 22520;
