...
#define RPG_GAMECORE_SAVEDVALUEDIMENSIONCONFIG_METHOD_2_E3A81CECF017F530_OFFSET UNITYSDK_OFFSET(0x19C1C630)
#define RPG_GAMECORE_SAVEDVALUEDIMENSIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19C1C800)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SavedValueDimensionConfig_TypeDefinitionIndex = 16488;
