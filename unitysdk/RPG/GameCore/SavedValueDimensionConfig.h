...
#define RPG_GAMECORE_SAVEDVALUEDIMENSIONCONFIG_METHOD_2_E3A81CECF017F530_OFFSET UNITYSDK_OFFSET(0x1D4D4B00)
#define RPG_GAMECORE_SAVEDVALUEDIMENSIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4D4CD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SavedValueDimensionConfig_TypeDefinitionIndex = 17152;
