...
#define RPG_GAMECORE_SAVEDVALUEDIMENSIONCONFIG_METHOD_2_E3A81CECF017F530_OFFSET UNITYSDK_OFFSET(0x1769AA90)
#define RPG_GAMECORE_SAVEDVALUEDIMENSIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1769AC60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SavedValueDimensionConfig_TypeDefinitionIndex = 15928;
