...
#define RPG_GAMECORE_ADVCREATEENTITYASYNC_METHOD_3_3E7AC06319369B81_OFFSET UNITYSDK_OFFSET(0x16F29C90)
#define RPG_GAMECORE_ADVCREATEENTITYASYNC_METHOD_3_D669BF51E37E67FF_OFFSET UNITYSDK_OFFSET(0x16F29D10)
#define RPG_GAMECORE_ADVCREATEENTITYASYNC__CTOR_OFFSET UNITYSDK_OFFSET(0x16F29CE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvCreateEntityAsync_TypeDefinitionIndex = 19525;
