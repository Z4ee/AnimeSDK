...
#define RPG_GAMECORE_FATEPARAMPHASEIDCONFIG_METHOD_6_0C668BB03A6D35D5_OFFSET UNITYSDK_OFFSET(0x1BA75010)
#define RPG_GAMECORE_FATEPARAMPHASEIDCONFIG_METHOD_6_7668AB5C9C9EF9D0_OFFSET UNITYSDK_OFFSET(0x1BA750B0)
#define RPG_GAMECORE_FATEPARAMPHASEIDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA750A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateParamPhaseIDConfig_TypeDefinitionIndex = 15992;
