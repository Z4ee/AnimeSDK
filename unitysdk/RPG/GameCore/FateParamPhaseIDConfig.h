...
#define RPG_GAMECORE_FATEPARAMPHASEIDCONFIG_METHOD_6_175FD5CE6ED90897_OFFSET UNITYSDK_OFFSET(0x188D8ED0)
#define RPG_GAMECORE_FATEPARAMPHASEIDCONFIG_METHOD_6_7668AB5C9C9EF9D0_OFFSET UNITYSDK_OFFSET(0x188D9120)
#define RPG_GAMECORE_FATEPARAMPHASEIDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x188D9060)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateParamPhaseIDConfig_TypeDefinitionIndex = 15763;
