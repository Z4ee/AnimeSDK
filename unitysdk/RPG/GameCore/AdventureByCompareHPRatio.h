...
#define RPG_GAMECORE_ADVENTUREBYCOMPAREHPRATIO_METHOD_4_A0D9337066444AEA_OFFSET UNITYSDK_OFFSET(0x16F4BA80)
#define RPG_GAMECORE_ADVENTUREBYCOMPAREHPRATIO_METHOD_4_D4C96B5DC56AE286_OFFSET UNITYSDK_OFFSET(0x16F4BBA0)
#define RPG_GAMECORE_ADVENTUREBYCOMPAREHPRATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x16F4BB20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureByCompareHPRatio_TypeDefinitionIndex = 19097;
