...
#define RPG_GAMECORE_AVATARSERVANTSKILLEXCELTABLE_INDEXKEY_EQUALS_OFFSET UNITYSDK_OFFSET(0x384B490)
#define RPG_GAMECORE_AVATARSERVANTSKILLEXCELTABLE_INDEXKEY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x384B4B0)
#define RPG_GAMECORE_AVATARSERVANTSKILLEXCELTABLE_INDEXKEY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3851960)
#define RPG_GAMECORE_AVATARSERVANTSKILLEXCELTABLE_INDEXKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x7BBE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AvatarServantSkillExcelTable_IndexKey_TypeDefinitionIndex = 12196;
