...
#define RPG_GAMECORE_LEVELCHARACTERBREAKSTATECHANGE_CLEAR_OFFSET UNITYSDK_OFFSET(0xCE39F80)
#define RPG_GAMECORE_LEVELCHARACTERBREAKSTATECHANGE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xCE3A020)
#define RPG_GAMECORE_LEVELCHARACTERBREAKSTATECHANGE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xCE39FD0)
#define RPG_GAMECORE_LEVELCHARACTERBREAKSTATECHANGE_INIT_1_OFFSET UNITYSDK_OFFSET(0xCE39F00)
#define RPG_GAMECORE_LEVELCHARACTERBREAKSTATECHANGE_INIT_OFFSET UNITYSDK_OFFSET(0xCE39E70)
#define RPG_GAMECORE_LEVELCHARACTERBREAKSTATECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0xCE3A070)
#define RPG_GAMECORE_LEVELCHARACTERBREAKSTATECHANGE___IFIXBASEPROXY_CLEAR_OFFSET UNITYSDK_OFFSET(0xCE3A080)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelCharacterBreakStateChange_TypeDefinitionIndex = 53045;
