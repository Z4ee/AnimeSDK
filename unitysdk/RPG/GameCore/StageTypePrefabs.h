...
#define RPG_GAMECORE_STAGETYPEPREFABS_METHOD_2_E342C7A74A5DAE21_OFFSET UNITYSDK_OFFSET(0x1B0B5880)
#define RPG_GAMECORE_STAGETYPEPREFABS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0B5970)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StageTypePrefabs_TypeDefinitionIndex = 15709;
