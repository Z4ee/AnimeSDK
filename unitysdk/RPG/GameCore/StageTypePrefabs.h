...
#define RPG_GAMECORE_STAGETYPEPREFABS_METHOD_2_E342C7A74A5DAE21_OFFSET UNITYSDK_OFFSET(0x1D55EF10)
#define RPG_GAMECORE_STAGETYPEPREFABS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D55F000)
