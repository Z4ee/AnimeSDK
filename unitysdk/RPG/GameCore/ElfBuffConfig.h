...
#define RPG_GAMECORE_ELFBUFFCONFIG_METHOD_2_BF55DB325F9D2759_OFFSET UNITYSDK_OFFSET(0x1718CEC0)
#define RPG_GAMECORE_ELFBUFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1718CFD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfBuffConfig_TypeDefinitionIndex = 16963;
