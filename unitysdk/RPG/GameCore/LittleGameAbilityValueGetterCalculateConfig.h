...
#define RPG_GAMECORE_LITTLEGAMEABILITYVALUEGETTERCALCULATECONFIG_METHOD_3_026937E415C6AE31_OFFSET UNITYSDK_OFFSET(0x1DD661F0)
#define RPG_GAMECORE_LITTLEGAMEABILITYVALUEGETTERCALCULATECONFIG_METHOD_3_597B4E5A08A8C8EF_OFFSET UNITYSDK_OFFSET(0x1DD66250)
#define RPG_GAMECORE_LITTLEGAMEABILITYVALUEGETTERCALCULATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD66240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityValueGetterCalculateConfig_TypeDefinitionIndex = 21142;
