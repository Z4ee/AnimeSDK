...
#define RPG_GAMECORE_LITTLEGAMEABILITYVALUEGETTERCALCULATECONFIG_METHOD_3_026937E415C6AE31_OFFSET UNITYSDK_OFFSET(0x1BCBD090)
#define RPG_GAMECORE_LITTLEGAMEABILITYVALUEGETTERCALCULATECONFIG_METHOD_3_597B4E5A08A8C8EF_OFFSET UNITYSDK_OFFSET(0x1BCBD0F0)
#define RPG_GAMECORE_LITTLEGAMEABILITYVALUEGETTERCALCULATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCBD0E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityValueGetterCalculateConfig_TypeDefinitionIndex = 20590;
