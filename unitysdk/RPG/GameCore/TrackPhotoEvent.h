...
#define RPG_GAMECORE_TRACKPHOTOEVENT_METHOD_2_B97469133E0706F1_OFFSET UNITYSDK_OFFSET(0x1C15A380)
#define RPG_GAMECORE_TRACKPHOTOEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C15A4D0)
