...
#define RPG_GAMECORE_MARBLEBYEXTRAROUND_METHOD_4_29E6C94AF86B2192_OFFSET UNITYSDK_OFFSET(0x18A98F70)
#define RPG_GAMECORE_MARBLEBYEXTRAROUND_METHOD_4_610DB39EF786CA98_OFFSET UNITYSDK_OFFSET(0x18A98E90)
#define RPG_GAMECORE_MARBLEBYEXTRAROUND__CTOR_OFFSET UNITYSDK_OFFSET(0x18A98F20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleByExtraRound_TypeDefinitionIndex = 15984;
