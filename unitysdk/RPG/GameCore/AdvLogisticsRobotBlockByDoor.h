...
#define RPG_GAMECORE_ADVLOGISTICSROBOTBLOCKBYDOOR_METHOD_3_8E2A5AB9145890CD_OFFSET UNITYSDK_OFFSET(0x1BE204D0)
#define RPG_GAMECORE_ADVLOGISTICSROBOTBLOCKBYDOOR_METHOD_3_941EEB165F66888E_OFFSET UNITYSDK_OFFSET(0x1BE20510)
#define RPG_GAMECORE_ADVLOGISTICSROBOTBLOCKBYDOOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE20500)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvLogisticsRobotBlockByDoor_TypeDefinitionIndex = 20402;
