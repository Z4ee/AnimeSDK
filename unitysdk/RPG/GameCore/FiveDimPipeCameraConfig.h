...
#define RPG_GAMECORE_FIVEDIMPIPECAMERACONFIG_METHOD_4_2E0A01364A6D4DE3_OFFSET UNITYSDK_OFFSET(0x1974BEA0)
#define RPG_GAMECORE_FIVEDIMPIPECAMERACONFIG_METHOD_4_4E543997BDF828B9_OFFSET UNITYSDK_OFFSET(0x1972A6E0)
#define RPG_GAMECORE_FIVEDIMPIPECAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1972A6A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimPipeCameraConfig_TypeDefinitionIndex = 17723;
