...
#define RPG_GAMECORE_FIVEDIMPIPECAMERACONFIG_METHOD_4_2E0A01364A6D4DE3_OFFSET UNITYSDK_OFFSET(0x18911AF0)
#define RPG_GAMECORE_FIVEDIMPIPECAMERACONFIG_METHOD_4_4E543997BDF828B9_OFFSET UNITYSDK_OFFSET(0x18911BA0)
#define RPG_GAMECORE_FIVEDIMPIPECAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18911B60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimPipeCameraConfig_TypeDefinitionIndex = 17695;
