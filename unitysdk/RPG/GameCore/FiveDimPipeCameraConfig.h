...
#define RPG_GAMECORE_FIVEDIMPIPECAMERACONFIG_METHOD_4_4E543997BDF828B9_OFFSET UNITYSDK_OFFSET(0x1BEA7890)
#define RPG_GAMECORE_FIVEDIMPIPECAMERACONFIG_METHOD_4_A5B7AB63B3CCF6C4_OFFSET UNITYSDK_OFFSET(0x1BEA7810)
#define RPG_GAMECORE_FIVEDIMPIPECAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEA7860)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimPipeCameraConfig_TypeDefinitionIndex = 17897;
