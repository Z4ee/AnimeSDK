...
#define RPG_GAMECORE_TARGETSORTBYVALUEEVALUATOR_METHOD_3_1833629C0ACDAC9F_OFFSET UNITYSDK_OFFSET(0x1D0CA630)
#define RPG_GAMECORE_TARGETSORTBYVALUEEVALUATOR_METHOD_3_B700F9739D9B80BB_OFFSET UNITYSDK_OFFSET(0x1D0CA4C0)
#define RPG_GAMECORE_TARGETSORTBYVALUEEVALUATOR_METHOD_3_DD314C2A7CE3C679_OFFSET UNITYSDK_OFFSET(0x1D0CA600)
#define RPG_GAMECORE_TARGETSORTBYVALUEEVALUATOR_METHOD_3_E74B831820E0C118_OFFSET UNITYSDK_OFFSET(0x1D0CA500)
#define RPG_GAMECORE_TARGETSORTBYVALUEEVALUATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0CA4F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetSortByValueEvaluator_TypeDefinitionIndex = 23125;
