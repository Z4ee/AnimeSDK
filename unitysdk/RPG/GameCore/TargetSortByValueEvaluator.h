...
#define RPG_GAMECORE_TARGETSORTBYVALUEEVALUATOR_METHOD_3_1833629C0ACDAC9F_OFFSET UNITYSDK_OFFSET(0x1E1C46B0)
#define RPG_GAMECORE_TARGETSORTBYVALUEEVALUATOR_METHOD_3_B700F9739D9B80BB_OFFSET UNITYSDK_OFFSET(0x1E1C4540)
#define RPG_GAMECORE_TARGETSORTBYVALUEEVALUATOR_METHOD_3_DD314C2A7CE3C679_OFFSET UNITYSDK_OFFSET(0x1E1C4680)
#define RPG_GAMECORE_TARGETSORTBYVALUEEVALUATOR_METHOD_3_E74B831820E0C118_OFFSET UNITYSDK_OFFSET(0x1E1C4580)
#define RPG_GAMECORE_TARGETSORTBYVALUEEVALUATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1C4570)
