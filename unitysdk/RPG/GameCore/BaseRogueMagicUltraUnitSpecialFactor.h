...
#define RPG_GAMECORE_BASEROGUEMAGICULTRAUNITSPECIALFACTOR_METHOD_2_7F7AF1E0BE356C7B_OFFSET UNITYSDK_OFFSET(0x16FCA2C0)
#define RPG_GAMECORE_BASEROGUEMAGICULTRAUNITSPECIALFACTOR_METHOD_2_C8820E3BFD5EF1A3_OFFSET UNITYSDK_OFFSET(0x16FCA0A0)
#define RPG_GAMECORE_BASEROGUEMAGICULTRAUNITSPECIALFACTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x16FCA2B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BaseRogueMagicUltraUnitSpecialFactor_TypeDefinitionIndex = 16467;
