...
#define RPG_GAMECORE_BASEROGUEMAGICULTRAUNITSPECIALFACTOR_METHOD_2_7F7AF1E0BE356C7B_OFFSET UNITYSDK_OFFSET(0x1A3E13F0)
#define RPG_GAMECORE_BASEROGUEMAGICULTRAUNITSPECIALFACTOR_METHOD_2_C8820E3BFD5EF1A3_OFFSET UNITYSDK_OFFSET(0x1A3E11E0)
#define RPG_GAMECORE_BASEROGUEMAGICULTRAUNITSPECIALFACTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3E13E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BaseRogueMagicUltraUnitSpecialFactor_TypeDefinitionIndex = 17197;
