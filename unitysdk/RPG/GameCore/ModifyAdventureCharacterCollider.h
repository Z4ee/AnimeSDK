...
#define RPG_GAMECORE_MODIFYADVENTURECHARACTERCOLLIDER_METHOD_3_2B003E1D0497C98A_OFFSET UNITYSDK_OFFSET(0x1D1B4DF0)
#define RPG_GAMECORE_MODIFYADVENTURECHARACTERCOLLIDER_METHOD_3_45B0736739235757_OFFSET UNITYSDK_OFFSET(0x1D1B4DB0)
#define RPG_GAMECORE_MODIFYADVENTURECHARACTERCOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1B4DE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyAdventureCharacterCollider_TypeDefinitionIndex = 22165;
