...
#define RPG_GAMECORE_MODIFYADVENTURECHARACTERCOLLIDER_METHOD_3_2B003E1D0497C98A_OFFSET UNITYSDK_OFFSET(0x1742A3B0)
#define RPG_GAMECORE_MODIFYADVENTURECHARACTERCOLLIDER_METHOD_3_C7A2990F90FB4DDB_OFFSET UNITYSDK_OFFSET(0x1742A330)
#define RPG_GAMECORE_MODIFYADVENTURECHARACTERCOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1742A380)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyAdventureCharacterCollider_TypeDefinitionIndex = 20607;
