...
#define RPG_GAMECORE_CHIMERADUELFIREBULLETNODE_METHOD_3_279A175D2E344640_OFFSET UNITYSDK_OFFSET(0x1E3336F0)
#define RPG_GAMECORE_CHIMERADUELFIREBULLETNODE_METHOD_3_8249B05689292CD5_OFFSET UNITYSDK_OFFSET(0x1E3337F0)
#define RPG_GAMECORE_CHIMERADUELFIREBULLETNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E333790)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelFireBulletNode_TypeDefinitionIndex = 15792;
