...
#define RPG_GAMECORE_BYGRIDFIGHTHASSAMETRAIT_METHOD_4_1D30321658AD8041_OFFSET UNITYSDK_OFFSET(0x170227E0)
#define RPG_GAMECORE_BYGRIDFIGHTHASSAMETRAIT_METHOD_4_C4AEBCD6D270CE33_OFFSET UNITYSDK_OFFSET(0x17022700)
#define RPG_GAMECORE_BYGRIDFIGHTHASSAMETRAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x17022780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByGridFightHasSameTrait_TypeDefinitionIndex = 20711;
