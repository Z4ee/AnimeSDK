...
#define RPG_GAMECORE_BYGRIDFIGHTHASSAMETRAIT_METHOD_4_0958868D9AC2B44D_OFFSET UNITYSDK_OFFSET(0x1A8C39E0)
#define RPG_GAMECORE_BYGRIDFIGHTHASSAMETRAIT_METHOD_4_0D57250E379DAC18_OFFSET UNITYSDK_OFFSET(0x1A8C36D0)
#define RPG_GAMECORE_BYGRIDFIGHTHASSAMETRAIT_METHOD_4_1D30321658AD8041_OFFSET UNITYSDK_OFFSET(0x1A8C3720)
#define RPG_GAMECORE_BYGRIDFIGHTHASSAMETRAIT_METHOD_4_2A779F28A034942B_OFFSET UNITYSDK_OFFSET(0x1A8C39A0)
#define RPG_GAMECORE_BYGRIDFIGHTHASSAMETRAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8C3710)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByGridFightHasSameTrait_TypeDefinitionIndex = 21712;
