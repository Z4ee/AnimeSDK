...
#define RPG_GAMECORE_BYGRIDFIGHTHASSAMETRAIT_METHOD_4_1D30321658AD8041_OFFSET UNITYSDK_OFFSET(0x18747360)
#define RPG_GAMECORE_BYGRIDFIGHTHASSAMETRAIT_METHOD_4_C4AEBCD6D270CE33_OFFSET UNITYSDK_OFFSET(0x18747280)
#define RPG_GAMECORE_BYGRIDFIGHTHASSAMETRAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x18747300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByGridFightHasSameTrait_TypeDefinitionIndex = 21410;
