...
#define RPG_GAMECORE_PHASESKILLINFOMAPPINGLIST_METHOD_2_F0B7E641956ED287_OFFSET UNITYSDK_OFFSET(0x1D42F3D0)
#define RPG_GAMECORE_PHASESKILLINFOMAPPINGLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1D42F490)
