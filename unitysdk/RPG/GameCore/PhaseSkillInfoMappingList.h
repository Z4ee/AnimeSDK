...
#define RPG_GAMECORE_PHASESKILLINFOMAPPINGLIST_METHOD_2_F0B7E641956ED287_OFFSET UNITYSDK_OFFSET(0x1D326700)
#define RPG_GAMECORE_PHASESKILLINFOMAPPINGLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3267C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhaseSkillInfoMappingList_TypeDefinitionIndex = 16360;
