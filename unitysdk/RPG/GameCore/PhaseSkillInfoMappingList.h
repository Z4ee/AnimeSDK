...
#define RPG_GAMECORE_PHASESKILLINFOMAPPINGLIST_METHOD_2_D500A9B496107AEA_OFFSET UNITYSDK_OFFSET(0x174A4100)
#define RPG_GAMECORE_PHASESKILLINFOMAPPINGLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x174A41C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhaseSkillInfoMappingList_TypeDefinitionIndex = 15143;
