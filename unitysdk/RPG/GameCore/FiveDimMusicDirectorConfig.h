...
#define RPG_GAMECORE_FIVEDIMMUSICDIRECTORCONFIG_METHOD_2_418A0938EF72B667_OFFSET UNITYSDK_OFFSET(0x1D0F5FA0)
#define RPG_GAMECORE_FIVEDIMMUSICDIRECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0F6090)
