...
#define RPG_GAMECORE_FIVEDIMMUSICDIRECTORCONFIG_METHOD_2_418A0938EF72B667_OFFSET UNITYSDK_OFFSET(0x1974AEA0)
#define RPG_GAMECORE_FIVEDIMMUSICDIRECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1974AF90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimMusicDirectorConfig_TypeDefinitionIndex = 17908;
