...
#define RPG_GAMECORE_PLAYMUSICRHYTHMTALK_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x174C33B0)
#define RPG_GAMECORE_PLAYMUSICRHYTHMTALK_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x174C3330)
#define RPG_GAMECORE_PLAYMUSICRHYTHMTALK__CTOR_OFFSET UNITYSDK_OFFSET(0x174C3380)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayMusicRhythmTalk_TypeDefinitionIndex = 20245;
