...
#define RPG_GAMECORE_PLAYMUSICRHYTHMTALK_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1BA04700)
#define RPG_GAMECORE_PLAYMUSICRHYTHMTALK_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1BA046C0)
#define RPG_GAMECORE_PLAYMUSICRHYTHMTALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA046F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayMusicRhythmTalk_TypeDefinitionIndex = 21255;
