...
#define RPG_GAMECORE_PLAYMUSICRHYTHMTALK_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1D3494C0)
#define RPG_GAMECORE_PLAYMUSICRHYTHMTALK_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D349480)
#define RPG_GAMECORE_PLAYMUSICRHYTHMTALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3494B0)
