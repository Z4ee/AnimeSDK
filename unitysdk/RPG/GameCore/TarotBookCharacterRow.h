...
#define RPG_GAMECORE_TAROTBOOKCHARACTERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x177D4A30)
#define RPG_GAMECORE_TAROTBOOKCHARACTERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x177D4F70)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID MainCatalogTitle; // 0x38
		::System::UInt32 Tag; // 0x48
		::System::UInt32 MaxLevel; // 0x4C
		::System::UInt32 ID; // 0x50
		::System::UInt32 Position; // 0x54
		::RPG::Client::TextID SubCatalogTitle; // 0x58
		::RPG::Client::TextID StarUnlockToast; // 0x68
