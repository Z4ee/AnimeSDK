...
#define RPG_GAMECORE_LISTENSTEPONTARGET_METHOD_3_1E67DC4EE7DB9393_OFFSET UNITYSDK_OFFSET(0x1B091BE0)
#define RPG_GAMECORE_LISTENSTEPONTARGET_METHOD_3_6EC62F7FB2750A12_OFFSET UNITYSDK_OFFSET(0x1B091C30)
#define RPG_GAMECORE_LISTENSTEPONTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1B091C20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ListenStepOnTarget_TypeDefinitionIndex = 19860;
