...
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYANDCONFIG_METHOD_3_774B333111682004_OFFSET UNITYSDK_OFFSET(0x19BB9BB0)
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYANDCONFIG_METHOD_3_82FE655606986048_OFFSET UNITYSDK_OFFSET(0x19BB9D40)
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYANDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19BB9BA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RoguePersonaRoomCardFilterByAndConfig_TypeDefinitionIndex = 18827;
