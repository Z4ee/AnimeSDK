...
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYANDCONFIG_METHOD_3_774B333111682004_OFFSET UNITYSDK_OFFSET(0x17657C40)
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYANDCONFIG_METHOD_3_82FE655606986048_OFFSET UNITYSDK_OFFSET(0x17657DD0)
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYANDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17657C30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RoguePersonaRoomCardFilterByAndConfig_TypeDefinitionIndex = 18215;
