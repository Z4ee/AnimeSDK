...
#define RPG_GAMECORE_BYCOMPARETURNACTIONENTITYTEAMTYPE_METHOD_4_5374579D5AD86885_OFFSET UNITYSDK_OFFSET(0x18740530)
#define RPG_GAMECORE_BYCOMPARETURNACTIONENTITYTEAMTYPE_METHOD_4_723DB1B30F22F4E3_OFFSET UNITYSDK_OFFSET(0x18740460)
#define RPG_GAMECORE_BYCOMPARETURNACTIONENTITYTEAMTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x187404E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareTurnActionEntityTeamType_TypeDefinitionIndex = 22456;
