...
#define RPG_GAMECORE_ROGUEPARAMROGUECOINCOUNTCONFIG_METHOD_6_9FB9E28037B43BE7_OFFSET UNITYSDK_OFFSET(0x19BAFA70)
#define RPG_GAMECORE_ROGUEPARAMROGUECOINCOUNTCONFIG_METHOD_6_D93C8AA5047C6331_OFFSET UNITYSDK_OFFSET(0x19BAF7C0)
#define RPG_GAMECORE_ROGUEPARAMROGUECOINCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19BAF940)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamRogueCoinCountConfig_TypeDefinitionIndex = 18781;
