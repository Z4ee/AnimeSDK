...
#define RPG_GAMECORE_FLOORCUSTOMBOOLCONFIG_METHOD_3_87574FA4538422F7_OFFSET UNITYSDK_OFFSET(0x17213EB0)
#define RPG_GAMECORE_FLOORCUSTOMBOOLCONFIG_METHOD_3_DC6F62D6D4E71DC8_OFFSET UNITYSDK_OFFSET(0x17213EF0)
#define RPG_GAMECORE_FLOORCUSTOMBOOLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17213EE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FloorCustomBoolConfig_TypeDefinitionIndex = 16778;
