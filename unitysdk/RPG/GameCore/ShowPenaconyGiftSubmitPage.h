...
#define RPG_GAMECORE_SHOWPENACONYGIFTSUBMITPAGE_METHOD_3_4D855E2DBC2FC379_OFFSET UNITYSDK_OFFSET(0x1BE44870)
#define RPG_GAMECORE_SHOWPENACONYGIFTSUBMITPAGE_METHOD_3_5D6556746A8C22BA_OFFSET UNITYSDK_OFFSET(0x1BE44830)
#define RPG_GAMECORE_SHOWPENACONYGIFTSUBMITPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE44860)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowPenaconyGiftSubmitPage_TypeDefinitionIndex = 20450;
