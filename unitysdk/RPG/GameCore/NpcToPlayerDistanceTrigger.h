...
#define RPG_GAMECORE_NPCTOPLAYERDISTANCETRIGGER_METHOD_3_185378D501F8DCC2_OFFSET UNITYSDK_OFFSET(0x1BAFDEC0)
#define RPG_GAMECORE_NPCTOPLAYERDISTANCETRIGGER_METHOD_3_49BA912FF52B7BE0_OFFSET UNITYSDK_OFFSET(0x1BAFDE50)
#define RPG_GAMECORE_NPCTOPLAYERDISTANCETRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAFDEA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NpcToPlayerDistanceTrigger_TypeDefinitionIndex = 19551;
