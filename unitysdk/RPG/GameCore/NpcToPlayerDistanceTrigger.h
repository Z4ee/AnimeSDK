...
#define RPG_GAMECORE_NPCTOPLAYERDISTANCETRIGGER_METHOD_3_12660BEE758A1371_OFFSET UNITYSDK_OFFSET(0x17478CD0)
#define RPG_GAMECORE_NPCTOPLAYERDISTANCETRIGGER_METHOD_3_EDD0B9E136C1253F_OFFSET UNITYSDK_OFFSET(0x17478D80)
#define RPG_GAMECORE_NPCTOPLAYERDISTANCETRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x17478D40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NpcToPlayerDistanceTrigger_TypeDefinitionIndex = 18622;
