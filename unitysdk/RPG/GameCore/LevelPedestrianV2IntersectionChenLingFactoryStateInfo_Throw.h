...
#define RPG_GAMECORE_LEVELPEDESTRIANV2INTERSECTIONCHENLINGFACTORYSTATEINFO_THROW_METHOD_3_0B84E24EE6D5E6C4_OFFSET UNITYSDK_OFFSET(0x1C12AD50)
#define RPG_GAMECORE_LEVELPEDESTRIANV2INTERSECTIONCHENLINGFACTORYSTATEINFO_THROW_METHOD_3_DA3406FCC7AD419C_OFFSET UNITYSDK_OFFSET(0x1C12AE90)
#define RPG_GAMECORE_LEVELPEDESTRIANV2INTERSECTIONCHENLINGFACTORYSTATEINFO_THROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C12AD40)
