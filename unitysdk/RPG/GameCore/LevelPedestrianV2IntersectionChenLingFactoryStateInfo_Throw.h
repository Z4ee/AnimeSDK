...
#define RPG_GAMECORE_LEVELPEDESTRIANV2INTERSECTIONCHENLINGFACTORYSTATEINFO_THROW_METHOD_3_0B84E24EE6D5E6C4_OFFSET UNITYSDK_OFFSET(0x17346BC0)
#define RPG_GAMECORE_LEVELPEDESTRIANV2INTERSECTIONCHENLINGFACTORYSTATEINFO_THROW_METHOD_3_23AEF9DF1D9A4353_OFFSET UNITYSDK_OFFSET(0x17346CE0)
#define RPG_GAMECORE_LEVELPEDESTRIANV2INTERSECTIONCHENLINGFACTORYSTATEINFO_THROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17346BB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPedestrianV2IntersectionChenLingFactoryStateInfo_Throw_TypeDefinitionIndex = 15896;
