...
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTAPPLYPERCENTDAMAGECONFIG_METHOD_3_8127FD4DC7B2B363_OFFSET UNITYSDK_OFFSET(0x1B0931C0)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTAPPLYPERCENTDAMAGECONFIG_METHOD_3_F03872C121479677_OFFSET UNITYSDK_OFFSET(0x1B093290)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTAPPLYPERCENTDAMAGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B093280)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityPixAirEffectApplyPercentDamageConfig_TypeDefinitionIndex = 20549;
