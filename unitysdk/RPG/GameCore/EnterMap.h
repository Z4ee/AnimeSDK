...
#define RPG_GAMECORE_ENTERMAP_METHOD_3_2B7488304C0C859C_OFFSET UNITYSDK_OFFSET(0x1719EA50)
#define RPG_GAMECORE_ENTERMAP_METHOD_3_99481595515AAD78_OFFSET UNITYSDK_OFFSET(0x1719EAD0)
#define RPG_GAMECORE_ENTERMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1719EAA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnterMap_TypeDefinitionIndex = 19727;
