...
#define RPG_GAMECORE_ENTERMAP_METHOD_3_2B7488304C0C859C_OFFSET UNITYSDK_OFFSET(0x188AC210)
#define RPG_GAMECORE_ENTERMAP_METHOD_3_99481595515AAD78_OFFSET UNITYSDK_OFFSET(0x188AC290)
#define RPG_GAMECORE_ENTERMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x188AC260)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnterMap_TypeDefinitionIndex = 20408;
