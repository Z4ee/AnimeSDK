...
#define RPG_GAMECORE_BYFUNCUNLOCKCHECK_METHOD_4_4B697906E3FFE90D_OFFSET UNITYSDK_OFFSET(0x18746920)
#define RPG_GAMECORE_BYFUNCUNLOCKCHECK_METHOD_4_B5CB0B4D13D4509F_OFFSET UNITYSDK_OFFSET(0x18746850)
#define RPG_GAMECORE_BYFUNCUNLOCKCHECK__CTOR_OFFSET UNITYSDK_OFFSET(0x187468D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByFuncUnlockCheck_TypeDefinitionIndex = 19771;
