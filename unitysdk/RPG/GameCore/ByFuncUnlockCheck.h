...
#define RPG_GAMECORE_BYFUNCUNLOCKCHECK_METHOD_4_1BFACEF27F42B791_OFFSET UNITYSDK_OFFSET(0x1A8C1D90)
#define RPG_GAMECORE_BYFUNCUNLOCKCHECK_METHOD_4_4B697906E3FFE90D_OFFSET UNITYSDK_OFFSET(0x1A8C1C20)
#define RPG_GAMECORE_BYFUNCUNLOCKCHECK_METHOD_4_61C15D1B3219095E_OFFSET UNITYSDK_OFFSET(0x1A8C1DC0)
#define RPG_GAMECORE_BYFUNCUNLOCKCHECK_METHOD_4_CF91AA566ED65394_OFFSET UNITYSDK_OFFSET(0x1A8C1BE0)
#define RPG_GAMECORE_BYFUNCUNLOCKCHECK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8C1C10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByFuncUnlockCheck_TypeDefinitionIndex = 20006;
