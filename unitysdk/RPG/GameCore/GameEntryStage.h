...
#define RPG_GAMECORE_GAMEENTRYSTAGE_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1722D350)
#define RPG_GAMECORE_GAMEENTRYSTAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x172409F0)
