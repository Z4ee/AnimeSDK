...
#define RPG_GAMECORE_GRIDFIGHTWAVEMONSTERENTRY_METHOD_2_F4061F3ABC0F36D1_OFFSET UNITYSDK_OFFSET(0x1D07F490)
#define RPG_GAMECORE_GRIDFIGHTWAVEMONSTERENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D07F5B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightWaveMonsterEntry_TypeDefinitionIndex = 17435;
