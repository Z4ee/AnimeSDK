...
#define RPG_GAMECORE_GRIDFIGHTWAVEMONSTERENTRY_METHOD_2_F4061F3ABC0F36D1_OFFSET UNITYSDK_OFFSET(0x189DFA40)
#define RPG_GAMECORE_GRIDFIGHTWAVEMONSTERENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x189DFB60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightWaveMonsterEntry_TypeDefinitionIndex = 17256;
