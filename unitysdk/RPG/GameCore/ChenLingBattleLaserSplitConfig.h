...
#define RPG_GAMECORE_CHENLINGBATTLELASERSPLITCONFIG_METHOD_2_24AB87C09051853D_OFFSET UNITYSDK_OFFSET(0x1C37C800)
#define RPG_GAMECORE_CHENLINGBATTLELASERSPLITCONFIG_METHOD_2_FB88A8E0017E2709_OFFSET UNITYSDK_OFFSET(0x1C376AE0)
#define RPG_GAMECORE_CHENLINGBATTLELASERSPLITCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C37C7F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleLaserSplitConfig_TypeDefinitionIndex = 15132;
