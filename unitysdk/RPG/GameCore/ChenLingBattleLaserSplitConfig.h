...
#define RPG_GAMECORE_CHENLINGBATTLELASERSPLITCONFIG_METHOD_2_009604BC04E9FC8A_OFFSET UNITYSDK_OFFSET(0x1707F9E0)
#define RPG_GAMECORE_CHENLINGBATTLELASERSPLITCONFIG_METHOD_2_527787B3F166A15A_OFFSET UNITYSDK_OFFSET(0x17079CD0)
#define RPG_GAMECORE_CHENLINGBATTLELASERSPLITCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1707F9D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleLaserSplitConfig_TypeDefinitionIndex = 14435;
