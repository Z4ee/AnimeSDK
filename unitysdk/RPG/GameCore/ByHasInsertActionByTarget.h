...
#define RPG_GAMECORE_BYHASINSERTACTIONBYTARGET_METHOD_4_55243860A8251F75_OFFSET UNITYSDK_OFFSET(0x18748990)
#define RPG_GAMECORE_BYHASINSERTACTIONBYTARGET_METHOD_4_847C13705A240B12_OFFSET UNITYSDK_OFFSET(0x18748AB0)
#define RPG_GAMECORE_BYHASINSERTACTIONBYTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x18748A30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByHasInsertActionByTarget_TypeDefinitionIndex = 21453;
