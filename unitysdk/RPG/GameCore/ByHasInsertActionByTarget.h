...
#define RPG_GAMECORE_BYHASINSERTACTIONBYTARGET_METHOD_4_0BFDEF8772369FD2_OFFSET UNITYSDK_OFFSET(0x1A8C7720)
#define RPG_GAMECORE_BYHASINSERTACTIONBYTARGET_METHOD_4_7544DAC8A396E4E3_OFFSET UNITYSDK_OFFSET(0x1A8C7440)
#define RPG_GAMECORE_BYHASINSERTACTIONBYTARGET_METHOD_4_847C13705A240B12_OFFSET UNITYSDK_OFFSET(0x1A8C74E0)
#define RPG_GAMECORE_BYHASINSERTACTIONBYTARGET_METHOD_4_C16622B126F48433_OFFSET UNITYSDK_OFFSET(0x1A8C76C0)
#define RPG_GAMECORE_BYHASINSERTACTIONBYTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8C74A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByHasInsertActionByTarget_TypeDefinitionIndex = 21754;
