...
#define RPG_GAMECORE_ELFRESTAURANTPAUSEGAME_METHOD_3_3DDF1D576293E67F_OFFSET UNITYSDK_OFFSET(0x1D05B2D0)
#define RPG_GAMECORE_ELFRESTAURANTPAUSEGAME_METHOD_3_CCB271A451746324_OFFSET UNITYSDK_OFFSET(0x1D05B310)
#define RPG_GAMECORE_ELFRESTAURANTPAUSEGAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1D05B300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfRestaurantPauseGame_TypeDefinitionIndex = 24020;
