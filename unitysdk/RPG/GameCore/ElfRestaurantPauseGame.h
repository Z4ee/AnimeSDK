...
#define RPG_GAMECORE_ELFRESTAURANTPAUSEGAME_METHOD_3_41ADBB6A08AAFE55_OFFSET UNITYSDK_OFFSET(0x196DCD80)
#define RPG_GAMECORE_ELFRESTAURANTPAUSEGAME_METHOD_3_CCB271A451746324_OFFSET UNITYSDK_OFFSET(0x196DCE00)
#define RPG_GAMECORE_ELFRESTAURANTPAUSEGAME__CTOR_OFFSET UNITYSDK_OFFSET(0x196DCDD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfRestaurantPauseGame_TypeDefinitionIndex = 22973;
