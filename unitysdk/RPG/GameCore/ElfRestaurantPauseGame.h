...
#define RPG_GAMECORE_ELFRESTAURANTPAUSEGAME_METHOD_3_41ADBB6A08AAFE55_OFFSET UNITYSDK_OFFSET(0x1889E630)
#define RPG_GAMECORE_ELFRESTAURANTPAUSEGAME_METHOD_3_CCB271A451746324_OFFSET UNITYSDK_OFFSET(0x1889E6B0)
#define RPG_GAMECORE_ELFRESTAURANTPAUSEGAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1889E680)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfRestaurantPauseGame_TypeDefinitionIndex = 23307;
