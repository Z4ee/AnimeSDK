...
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREXCELVALUEGETTERCONFIG_METHOD_3_6975B5BB7736B947_OFFSET UNITYSDK_OFFSET(0x198952A0)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREXCELVALUEGETTERCONFIG_METHOD_3_A78F92FEEC981253_OFFSET UNITYSDK_OFFSET(0x198953A0)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREXCELVALUEGETTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19895390)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityPixAirExcelValueGetterConfig_TypeDefinitionIndex = 20219;
