...
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREXCELVALUEGETTERCONFIG_METHOD_3_6975B5BB7736B947_OFFSET UNITYSDK_OFFSET(0x1B094D10)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREXCELVALUEGETTERCONFIG_METHOD_3_A78F92FEEC981253_OFFSET UNITYSDK_OFFSET(0x1B094E10)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREXCELVALUEGETTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B094E00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityPixAirExcelValueGetterConfig_TypeDefinitionIndex = 20593;
