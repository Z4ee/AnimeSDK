...
#define RPG_GAMECORE_ADDTRIALPLAYER_METHOD_3_1A604D14CB7A6A3F_OFFSET UNITYSDK_OFFSET(0x18644C20)
#define RPG_GAMECORE_ADDTRIALPLAYER_METHOD_3_20E82DC97ECBE28F_OFFSET UNITYSDK_OFFSET(0x18644CB0)
#define RPG_GAMECORE_ADDTRIALPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x18644C80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddTrialPlayer_TypeDefinitionIndex = 20443;
