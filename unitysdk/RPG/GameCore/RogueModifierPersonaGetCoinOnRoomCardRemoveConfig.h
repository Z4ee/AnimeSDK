...
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAGETCOINONROOMCARDREMOVECONFIG_METHOD_3_2EBFAE99DADC44BF_OFFSET UNITYSDK_OFFSET(0x18D43E30)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAGETCOINONROOMCARDREMOVECONFIG_METHOD_3_5EA60D473F749A46_OFFSET UNITYSDK_OFFSET(0x18D43D60)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAGETCOINONROOMCARDREMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D43DE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierPersonaGetCoinOnRoomCardRemoveConfig_TypeDefinitionIndex = 16963;
