...
#define RPG_GAMECORE_STAGEPVSOFFLINEVISIBLITYINFO_METHOD_2_CAE35A46A25C51B5_OFFSET UNITYSDK_OFFSET(0x1CAE9040)
#define RPG_GAMECORE_STAGEPVSOFFLINEVISIBLITYINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1CAE94A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StagePVSOfflineVisiblityInfo_TypeDefinitionIndex = 18955;
