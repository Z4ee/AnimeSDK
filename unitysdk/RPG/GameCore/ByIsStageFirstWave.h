...
#define RPG_GAMECORE_BYISSTAGEFIRSTWAVE_METHOD_4_609E1AB46B18B65B_OFFSET UNITYSDK_OFFSET(0x17033500)
#define RPG_GAMECORE_BYISSTAGEFIRSTWAVE_METHOD_4_7A6B85AE021BAEA1_OFFSET UNITYSDK_OFFSET(0x17033430)
#define RPG_GAMECORE_BYISSTAGEFIRSTWAVE__CTOR_OFFSET UNITYSDK_OFFSET(0x170334B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsStageFirstWave_TypeDefinitionIndex = 21753;
