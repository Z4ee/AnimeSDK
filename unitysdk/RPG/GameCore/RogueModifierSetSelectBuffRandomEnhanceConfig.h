...
#define RPG_GAMECORE_ROGUEMODIFIERSETSELECTBUFFRANDOMENHANCECONFIG_METHOD_3_45FE90391C090D72_OFFSET UNITYSDK_OFFSET(0x1D3FCA00)
#define RPG_GAMECORE_ROGUEMODIFIERSETSELECTBUFFRANDOMENHANCECONFIG_METHOD_3_E55187651EE3568E_OFFSET UNITYSDK_OFFSET(0x1D3FCA50)
#define RPG_GAMECORE_ROGUEMODIFIERSETSELECTBUFFRANDOMENHANCECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3FCA40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierSetSelectBuffRandomEnhanceConfig_TypeDefinitionIndex = 17760;
