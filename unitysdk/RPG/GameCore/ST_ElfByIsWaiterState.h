...
#define RPG_GAMECORE_ST_ELFBYISWAITERSTATE_METHOD_4_7079C2EC98FFE86E_OFFSET UNITYSDK_OFFSET(0x17695F70)
#define RPG_GAMECORE_ST_ELFBYISWAITERSTATE_METHOD_4_D24C3C4AB5A0C4D8_OFFSET UNITYSDK_OFFSET(0x17696040)
#define RPG_GAMECORE_ST_ELFBYISWAITERSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x17695FF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_ElfByIsWaiterState_TypeDefinitionIndex = 19724;
