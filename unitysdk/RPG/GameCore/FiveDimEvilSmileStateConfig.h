...
#define RPG_GAMECORE_FIVEDIMEVILSMILESTATECONFIG_METHOD_2_E27E35F7182B477B_OFFSET UNITYSDK_OFFSET(0x1D0E4D90)
#define RPG_GAMECORE_FIVEDIMEVILSMILESTATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0E4F50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimEvilSmileStateConfig_TypeDefinitionIndex = 16524;
