...
#define RPG_GAMECORE_BYCHECKLASTBATTLESKILLDROP_METHOD_4_26635392C024E4B3_OFFSET UNITYSDK_OFFSET(0x1C2FE1C0)
#define RPG_GAMECORE_BYCHECKLASTBATTLESKILLDROP_METHOD_4_738B6B88F908F570_OFFSET UNITYSDK_OFFSET(0x1C2FE200)
#define RPG_GAMECORE_BYCHECKLASTBATTLESKILLDROP_METHOD_4_833F7A3BB8CC7326_OFFSET UNITYSDK_OFFSET(0x1C2FE340)
#define RPG_GAMECORE_BYCHECKLASTBATTLESKILLDROP_METHOD_4_83FD88BADF0C5F9B_OFFSET UNITYSDK_OFFSET(0x1C2FE370)
#define RPG_GAMECORE_BYCHECKLASTBATTLESKILLDROP__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2FE1F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckLastBattleSkillDrop_TypeDefinitionIndex = 21517;
