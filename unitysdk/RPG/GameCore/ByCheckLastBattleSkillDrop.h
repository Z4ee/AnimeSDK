...
#define RPG_GAMECORE_BYCHECKLASTBATTLESKILLDROP_METHOD_4_09B07B68B696034A_OFFSET UNITYSDK_OFFSET(0x18722CE0)
#define RPG_GAMECORE_BYCHECKLASTBATTLESKILLDROP_METHOD_4_738B6B88F908F570_OFFSET UNITYSDK_OFFSET(0x18722DB0)
#define RPG_GAMECORE_BYCHECKLASTBATTLESKILLDROP__CTOR_OFFSET UNITYSDK_OFFSET(0x18722D60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckLastBattleSkillDrop_TypeDefinitionIndex = 20611;
