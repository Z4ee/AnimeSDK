...
#define RPG_GAMECORE_WAITFIVEDIMPLAYERENTEROREXIT_METHOD_3_1E18B81D81A96C1C_OFFSET UNITYSDK_OFFSET(0x178F8C30)
#define RPG_GAMECORE_WAITFIVEDIMPLAYERENTEROREXIT_METHOD_3_4E645A73339E1B23_OFFSET UNITYSDK_OFFSET(0x178F8BB0)
#define RPG_GAMECORE_WAITFIVEDIMPLAYERENTEROREXIT__CTOR_OFFSET UNITYSDK_OFFSET(0x178F8C00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitFiveDimPlayerEnterOrExit_TypeDefinitionIndex = 19589;
