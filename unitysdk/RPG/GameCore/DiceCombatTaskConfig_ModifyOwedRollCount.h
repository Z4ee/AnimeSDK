...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_MODIFYOWEDROLLCOUNT_METHOD_3_4850C0E7E7D93A0C_OFFSET UNITYSDK_OFFSET(0x196B44B0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_MODIFYOWEDROLLCOUNT_METHOD_3_CE748A564772A0AC_OFFSET UNITYSDK_OFFSET(0x196B99D0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_MODIFYOWEDROLLCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x196B4460)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_ModifyOwedRollCount_TypeDefinitionIndex = 15283;
