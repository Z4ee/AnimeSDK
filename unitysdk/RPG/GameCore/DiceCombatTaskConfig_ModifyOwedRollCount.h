...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_MODIFYOWEDROLLCOUNT_METHOD_3_4850C0E7E7D93A0C_OFFSET UNITYSDK_OFFSET(0x188780B0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_MODIFYOWEDROLLCOUNT_METHOD_3_CE748A564772A0AC_OFFSET UNITYSDK_OFFSET(0x1887CB80)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_MODIFYOWEDROLLCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x18878060)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_ModifyOwedRollCount_TypeDefinitionIndex = 15223;
