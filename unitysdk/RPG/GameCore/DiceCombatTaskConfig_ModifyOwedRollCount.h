...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_MODIFYOWEDROLLCOUNT_METHOD_3_4850C0E7E7D93A0C_OFFSET UNITYSDK_OFFSET(0x1716D760)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_MODIFYOWEDROLLCOUNT_METHOD_3_CE748A564772A0AC_OFFSET UNITYSDK_OFFSET(0x17170FF0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_MODIFYOWEDROLLCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1716D710)
