...
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_FIREVISUALEFFECT_METHOD_3_E0D3226175C0EFD6_OFFSET UNITYSDK_OFFSET(0x1961D180)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_FIREVISUALEFFECT_METHOD_3_F6332C8A489CCB0C_OFFSET UNITYSDK_OFFSET(0x1961D120)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_FIREVISUALEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1961D170)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleAbility_FireVisualEffect_TypeDefinitionIndex = 14962;
