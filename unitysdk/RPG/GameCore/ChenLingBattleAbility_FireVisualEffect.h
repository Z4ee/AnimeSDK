...
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_FIREVISUALEFFECT_METHOD_3_E0D3226175C0EFD6_OFFSET UNITYSDK_OFFSET(0x1C377480)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_FIREVISUALEFFECT_METHOD_3_F6332C8A489CCB0C_OFFSET UNITYSDK_OFFSET(0x1C377420)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_FIREVISUALEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C377470)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleAbility_FireVisualEffect_TypeDefinitionIndex = 15126;
