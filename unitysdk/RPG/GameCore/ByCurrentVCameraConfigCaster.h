...
#define RPG_GAMECORE_BYCURRENTVCAMERACONFIGCASTER_METHOD_4_4CBA0C5C17D1D227_OFFSET UNITYSDK_OFFSET(0x17020040)
#define RPG_GAMECORE_BYCURRENTVCAMERACONFIGCASTER_METHOD_4_A94DFA45E1886EE9_OFFSET UNITYSDK_OFFSET(0x1701FF70)
#define RPG_GAMECORE_BYCURRENTVCAMERACONFIGCASTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1701FFF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCurrentVCameraConfigCaster_TypeDefinitionIndex = 21974;
