...
#define RPG_GAMECORE_ADVENTUREMODIFYTEAMPLAYERSP_METHOD_3_01D56E4FDA8882A6_OFFSET UNITYSDK_OFFSET(0x18678A40)
#define RPG_GAMECORE_ADVENTUREMODIFYTEAMPLAYERSP_METHOD_3_4B7084AA398A4D00_OFFSET UNITYSDK_OFFSET(0x18678AD0)
#define RPG_GAMECORE_ADVENTUREMODIFYTEAMPLAYERSP__CTOR_OFFSET UNITYSDK_OFFSET(0x18678AA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureModifyTeamPlayerSP_TypeDefinitionIndex = 19114;
