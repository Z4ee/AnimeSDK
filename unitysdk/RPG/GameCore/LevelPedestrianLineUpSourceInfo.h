...
#define RPG_GAMECORE_LEVELPEDESTRIANLINEUPSOURCEINFO_METHOD_2_0E37E3A62C176468_OFFSET UNITYSDK_OFFSET(0x18A53150)
#define RPG_GAMECORE_LEVELPEDESTRIANLINEUPSOURCEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18A532F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPedestrianLineUpSourceInfo_TypeDefinitionIndex = 16401;
