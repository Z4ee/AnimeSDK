...
#define RPG_GAMECORE_LEVELPEDESTRIANLINEUPSOURCEINFO_METHOD_2_0E37E3A62C176468_OFFSET UNITYSDK_OFFSET(0x1B081BF0)
#define RPG_GAMECORE_LEVELPEDESTRIANLINEUPSOURCEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B081D90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPedestrianLineUpSourceInfo_TypeDefinitionIndex = 16597;
