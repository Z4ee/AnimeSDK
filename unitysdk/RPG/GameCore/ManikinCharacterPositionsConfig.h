...
#define RPG_GAMECORE_MANIKINCHARACTERPOSITIONSCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18A86530)
#define RPG_GAMECORE_MANIKINCHARACTERPOSITIONSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18A86960)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ManikinCharacterPositionsConfig_TypeDefinitionIndex = 16584;
	...
	public:
		...
		static ::System::Void FromBinary(::Class_1_7A22A3DBEEDD1F80* array, ::RPG::GameCore::ManikinCharacterPositionsConfig*& val)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::ManikinCharacterPositionsConfig*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_MANIKINCHARACTERPOSITIONSCONFIG_FROMBINARY_OFFSET))(array, val);
		}
	};
}
