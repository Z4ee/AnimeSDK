...
#define RPG_GAMECORE_MANIKINCHARACTERPOSITIONSCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x198B9C90)
#define RPG_GAMECORE_MANIKINCHARACTERPOSITIONSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x198BA0C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ManikinCharacterPositionsConfig_TypeDefinitionIndex = 16614;
