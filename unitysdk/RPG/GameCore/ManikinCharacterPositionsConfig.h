...
#define RPG_GAMECORE_MANIKINCHARACTERPOSITIONSCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D4940E0)
#define RPG_GAMECORE_MANIKINCHARACTERPOSITIONSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D494510)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ManikinCharacterPositionsConfig_TypeDefinitionIndex = 17278;
