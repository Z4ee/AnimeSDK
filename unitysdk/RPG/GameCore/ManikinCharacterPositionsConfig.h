...
#define RPG_GAMECORE_MANIKINCHARACTERPOSITIONSCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17378920)
#define RPG_GAMECORE_MANIKINCHARACTERPOSITIONSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17378D70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ManikinCharacterPositionsConfig_TypeDefinitionIndex = 16055;
