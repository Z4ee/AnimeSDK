...
#define RPG_GAMECORE_GRIDFIGHTELATIONEQUIPDESCCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x197E0D80)
#define RPG_GAMECORE_GRIDFIGHTELATIONEQUIPDESCCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x197E0F60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightElationEquipDescConfigRow_TypeDefinitionIndex = 12835;
