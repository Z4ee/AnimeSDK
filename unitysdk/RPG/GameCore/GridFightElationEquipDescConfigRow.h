...
#define RPG_GAMECORE_GRIDFIGHTELATIONEQUIPDESCCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D9665E0)
#define RPG_GAMECORE_GRIDFIGHTELATIONEQUIPDESCCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D9667C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightElationEquipDescConfigRow_TypeDefinitionIndex = 13362;
