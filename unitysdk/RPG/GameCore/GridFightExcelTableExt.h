...
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_BUILDEFFECTIVELEVELABILITYPARAM_OFFSET UNITYSDK_OFFSET(0x1D154830)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_COMPARETRAITSEARCHKEY_OFFSET UNITYSDK_OFFSET(0x1D1553E0)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_CREATECOMMONCONSTDATA_OFFSET UNITYSDK_OFFSET(0x1D152DD0)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_FORCEGETTRAITSEARCHKEY_OFFSET UNITYSDK_OFFSET(0x1D1554D0)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_FULLAFFIXMAZEBUFFS_OFFSET UNITYSDK_OFFSET(0x1D1559D0)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_GETACTIVETRAITINFOSTR_OFFSET UNITYSDK_OFFSET(0x1D155590)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_GETAUGMENTKEY_OFFSET UNITYSDK_OFFSET(0x1D155380)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_GETAVATARTRAITINFO_OFFSET UNITYSDK_OFFSET(0x1D155770)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_GETEQUIPMERGEID_OFFSET UNITYSDK_OFFSET(0x1D154500)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_GETHIGHESTTRAITLAYERCONFIG_OFFSET UNITYSDK_OFFSET(0x1D154ED0)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_GETHIGHESTTRAITLAYER_OFFSET UNITYSDK_OFFSET(0x1D1549A0)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_GETINTEGRATEDTRAITLAYERS_OFFSET UNITYSDK_OFFSET(0x1D154C70)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_GETLAYERTRAITMAZEBUFFENHANCELIST_OFFSET UNITYSDK_OFFSET(0x1D154FF0)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_GETTRAITBONUSLAYER_OFFSET UNITYSDK_OFFSET(0x1D155140)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_GETTRAITBONUSSUBPARAMLIST_OFFSET UNITYSDK_OFFSET(0x1D155050)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_GETTRAITEFFECTIDBYEFFECTTYPE_OFFSET UNITYSDK_OFFSET(0x1D154F10)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_GETTRAITKEY_OFFSET UNITYSDK_OFFSET(0x1D1552E0)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_GETTRAITLVBYACTIVELAYER_OFFSET UNITYSDK_OFFSET(0x1D154910)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_GETVALIDBACKENDAVATARSTARROW_OFFSET UNITYSDK_OFFSET(0x1D155560)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_HASTRAITBINDING_OFFSET UNITYSDK_OFFSET(0x1D154890)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_ISVALID_OFFSET UNITYSDK_OFFSET(0x1D1548D0)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_TRYLEVELUP_OFFSET UNITYSDK_OFFSET(0x1D1548F0)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT__CHECKLAYERACTVATION_OFFSET UNITYSDK_OFFSET(0x1D154BB0)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT__CONSTMAPTOABILITYDATA_OFFSET UNITYSDK_OFFSET(0x1D154110)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT__GETCONSTARRAY_OFFSET UNITYSDK_OFFSET(0x1D153F40)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT__GETCONSTFIXPOINT_OFFSET UNITYSDK_OFFSET(0x1D1540B0)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT__GETCONSTINT_OFFSET UNITYSDK_OFFSET(0x1D154030)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT__GETCONSTUINT_OFFSET UNITYSDK_OFFSET(0x1D153FB0)
