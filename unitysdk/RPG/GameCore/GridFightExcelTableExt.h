...
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_BUILDEFFECTIVELEVELABILITYPARAM_OFFSET UNITYSDK_OFFSET(0x197E4B40)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_COMPARETRAITSEARCHKEY_OFFSET UNITYSDK_OFFSET(0x197E56E0)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_CREATECOMMONCONSTDATA_OFFSET UNITYSDK_OFFSET(0x197E30E0)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_FORCEGETTRAITSEARCHKEY_OFFSET UNITYSDK_OFFSET(0x197E57D0)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_FULLAFFIXMAZEBUFFS_OFFSET UNITYSDK_OFFSET(0x197E5CD0)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_GETACTIVETRAITINFOSTR_OFFSET UNITYSDK_OFFSET(0x197E5890)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_GETAUGMENTKEY_OFFSET UNITYSDK_OFFSET(0x197E5680)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_GETAVATARTRAITINFO_OFFSET UNITYSDK_OFFSET(0x197E5A70)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_GETEQUIPMERGEID_OFFSET UNITYSDK_OFFSET(0x197E4810)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_GETHIGHESTTRAITLAYERCONFIG_OFFSET UNITYSDK_OFFSET(0x197E51E0)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_GETHIGHESTTRAITLAYER_OFFSET UNITYSDK_OFFSET(0x197E4CB0)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_GETINTEGRATEDTRAITLAYERS_OFFSET UNITYSDK_OFFSET(0x197E4F80)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_GETLAYERTRAITMAZEBUFFENHANCELIST_OFFSET UNITYSDK_OFFSET(0x197E5300)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_GETTRAITBONUSLAYER_OFFSET UNITYSDK_OFFSET(0x197E5440)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_GETTRAITBONUSSUBPARAMLIST_OFFSET UNITYSDK_OFFSET(0x197E5350)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_GETTRAITEFFECTIDBYEFFECTTYPE_OFFSET UNITYSDK_OFFSET(0x197E5220)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_GETTRAITKEY_OFFSET UNITYSDK_OFFSET(0x197E55E0)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_GETTRAITLVBYACTIVELAYER_OFFSET UNITYSDK_OFFSET(0x197E4C20)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_GETVALIDBACKENDAVATARSTARROW_OFFSET UNITYSDK_OFFSET(0x197E5860)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_HASTRAITBINDING_OFFSET UNITYSDK_OFFSET(0x197E4BA0)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_ISVALID_OFFSET UNITYSDK_OFFSET(0x197E4BE0)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT_TRYLEVELUP_OFFSET UNITYSDK_OFFSET(0x197E4C00)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT__CHECKLAYERACTVATION_OFFSET UNITYSDK_OFFSET(0x197E4EC0)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT__CONSTMAPTOABILITYDATA_OFFSET UNITYSDK_OFFSET(0x197E4420)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT__GETCONSTARRAY_OFFSET UNITYSDK_OFFSET(0x197E4250)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT__GETCONSTFIXPOINT_OFFSET UNITYSDK_OFFSET(0x197E43C0)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT__GETCONSTINT_OFFSET UNITYSDK_OFFSET(0x197E4340)
#define RPG_GAMECORE_GRIDFIGHTEXCELTABLEEXT__GETCONSTUINT_OFFSET UNITYSDK_OFFSET(0x197E42C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightExcelTableExt_TypeDefinitionIndex = 14704;
