...
#define RPG_GAMECORE_CHENLINGFESITEMABILITYCONFIG_METHOD_3_35E9E444541C4974_OFFSET UNITYSDK_OFFSET(0x19628930)
#define RPG_GAMECORE_CHENLINGFESITEMABILITYCONFIG_METHOD_3_D3445AFCF4B46B4D_OFFSET UNITYSDK_OFFSET(0x1962A000)
#define RPG_GAMECORE_CHENLINGFESITEMABILITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19628920)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingFesItemAbilityConfig_TypeDefinitionIndex = 17540;
