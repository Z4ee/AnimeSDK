...
#define RPG_GAMECORE_FIVEDIMANIMATORSTATELISTENERCONFIG_METHOD_3_A167659DAB2888AE_OFFSET UNITYSDK_OFFSET(0x171DD450)
#define RPG_GAMECORE_FIVEDIMANIMATORSTATELISTENERCONFIG_METHOD_3_F445F653D695AC0D_OFFSET UNITYSDK_OFFSET(0x171DD4C0)
#define RPG_GAMECORE_FIVEDIMANIMATORSTATELISTENERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171DD4A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimAnimatorStateListenerConfig_TypeDefinitionIndex = 17109;
