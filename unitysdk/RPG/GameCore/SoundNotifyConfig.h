...
#define RPG_GAMECORE_SOUNDNOTIFYCONFIG_METHOD_2_67E7D90C0AB969F9_OFFSET UNITYSDK_OFFSET(0x1BE53B50)
#define RPG_GAMECORE_SOUNDNOTIFYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE53C20)
