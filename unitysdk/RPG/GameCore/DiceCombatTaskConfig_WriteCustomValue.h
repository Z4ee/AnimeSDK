...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_WRITECUSTOMVALUE_METHOD_3_7C4377F1BD6BE935_OFFSET UNITYSDK_OFFSET(0x196BA8E0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_WRITECUSTOMVALUE_METHOD_3_BC9ECCD43B670BA0_OFFSET UNITYSDK_OFFSET(0x196B6B50)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_WRITECUSTOMVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x196B6B00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_WriteCustomValue_TypeDefinitionIndex = 15293;
