...
#define RPG_GAMECORE_SETDYNAMICVALUEBYCOPYINGBATCHITEM_METHOD_2_23962C9CB970A44B_OFFSET UNITYSDK_OFFSET(0x19C40BB0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYCOPYINGBATCHITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x19C40CE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByCopyingBatchItem_TypeDefinitionIndex = 22521;
