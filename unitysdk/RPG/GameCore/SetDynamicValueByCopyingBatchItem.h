...
#define RPG_GAMECORE_SETDYNAMICVALUEBYCOPYINGBATCHITEM_METHOD_2_23962C9CB970A44B_OFFSET UNITYSDK_OFFSET(0x18E1EE40)
#define RPG_GAMECORE_SETDYNAMICVALUEBYCOPYINGBATCHITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x18E1EF70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByCopyingBatchItem_TypeDefinitionIndex = 22820;
