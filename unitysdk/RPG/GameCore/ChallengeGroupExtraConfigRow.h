...
#define RPG_GAMECORE_CHALLENGEGROUPEXTRACONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x195FC600)
#define RPG_GAMECORE_CHALLENGEGROUPEXTRACONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x195FCBF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChallengeGroupExtraConfigRow_TypeDefinitionIndex = 12337;
