...
#define RPG_GAMECORE_CHALLENGEGROUPEXTRACONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B712760)
#define RPG_GAMECORE_CHALLENGEGROUPEXTRACONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B712D50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChallengeGroupExtraConfigRow_TypeDefinitionIndex = 12470;
