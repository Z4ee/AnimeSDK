...
#define RPG_GAMECORE_ITEMCOMPOSETYPEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18A29860)
#define RPG_GAMECORE_ITEMCOMPOSETYPEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18A29FB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ItemComposeTypeRow_TypeDefinitionIndex = 13114;
	...
	public:
		...
		::System::UInt32 MainTypeID; // 0x2C
		::System::UInt32 MainTypeOrder; // 0x30
