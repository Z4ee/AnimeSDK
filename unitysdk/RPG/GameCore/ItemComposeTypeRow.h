...
#define RPG_GAMECORE_ITEMCOMPOSETYPEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B01B970)
#define RPG_GAMECORE_ITEMCOMPOSETYPEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B01C0A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ItemComposeTypeRow_TypeDefinitionIndex = 13342;

	class ItemComposeTypeRow : public ::System::Object
	{
	public:
		::System::String* UnlockDescribe; // 0x10
		::System::String* TypeTextmapID; // 0x18
		::System::String* TypeIconPath; // 0x20
		::System::UInt32 MainTypeID; // 0x28
		::System::UInt32 MainTypeOrder; // 0x2C
		::System::UInt32 TypeID; // 0x30
		::System::Boolean IsMainType; // 0x34
