...
#define RPG_GAMECORE_ROGUEACTTRIGGERACTIONRANDOMCOUNTCONFIG_METHOD_6_545AC452D0A28549_OFFSET UNITYSDK_OFFSET(0x18CD4A60)
#define RPG_GAMECORE_ROGUEACTTRIGGERACTIONRANDOMCOUNTCONFIG_METHOD_6_BB63F9F0BAEE15E4_OFFSET UNITYSDK_OFFSET(0x18CD4C80)
#define RPG_GAMECORE_ROGUEACTTRIGGERACTIONRANDOMCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CD4BA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActTriggerActionRandomCountConfig_TypeDefinitionIndex = 18643;
