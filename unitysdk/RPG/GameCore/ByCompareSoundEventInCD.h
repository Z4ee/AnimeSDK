...
#define RPG_GAMECORE_BYCOMPARESOUNDEVENTINCD_METHOD_4_0F07B4036AAFD799_OFFSET UNITYSDK_OFFSET(0x17017B00)
#define RPG_GAMECORE_BYCOMPARESOUNDEVENTINCD_METHOD_4_CE79C2851D3ADDD7_OFFSET UNITYSDK_OFFSET(0x17017BD0)
#define RPG_GAMECORE_BYCOMPARESOUNDEVENTINCD__CTOR_OFFSET UNITYSDK_OFFSET(0x17017B80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareSoundEventInCD_TypeDefinitionIndex = 18925;
