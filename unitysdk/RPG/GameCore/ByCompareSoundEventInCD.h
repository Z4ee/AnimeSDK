...
#define RPG_GAMECORE_BYCOMPARESOUNDEVENTINCD_METHOD_4_6E4ACB246CCA4ADA_OFFSET UNITYSDK_OFFSET(0x1BBBCBD0)
#define RPG_GAMECORE_BYCOMPARESOUNDEVENTINCD_METHOD_4_B32464D69809CF36_OFFSET UNITYSDK_OFFSET(0x1BBBC9E0)
#define RPG_GAMECORE_BYCOMPARESOUNDEVENTINCD_METHOD_4_CC3E61B8347EB9CD_OFFSET UNITYSDK_OFFSET(0x1BBBCBA0)
#define RPG_GAMECORE_BYCOMPARESOUNDEVENTINCD_METHOD_4_CE79C2851D3ADDD7_OFFSET UNITYSDK_OFFSET(0x1BBBCA20)
#define RPG_GAMECORE_BYCOMPARESOUNDEVENTINCD__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBBCA10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareSoundEventInCD_TypeDefinitionIndex = 20376;
