...
#define RPG_GAMECORE_SKILLPERFORMFINISH_METHOD_3_82CDFA063A7031FB_OFFSET UNITYSDK_OFFSET(0x19C8E960)
#define RPG_GAMECORE_SKILLPERFORMFINISH_METHOD_3_D4FE64A0F5A65992_OFFSET UNITYSDK_OFFSET(0x19C8E8E0)
#define RPG_GAMECORE_SKILLPERFORMFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x19C8E930)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SkillPerformFinish_TypeDefinitionIndex = 21388;
