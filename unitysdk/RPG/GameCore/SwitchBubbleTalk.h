...
#define RPG_GAMECORE_SWITCHBUBBLETALK_METHOD_3_9039C7676C21521A_OFFSET UNITYSDK_OFFSET(0x17791E50)
#define RPG_GAMECORE_SWITCHBUBBLETALK_METHOD_3_F61AFAEF7A524D23_OFFSET UNITYSDK_OFFSET(0x17791DD0)
#define RPG_GAMECORE_SWITCHBUBBLETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x17791E20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchBubbleTalk_TypeDefinitionIndex = 20490;
