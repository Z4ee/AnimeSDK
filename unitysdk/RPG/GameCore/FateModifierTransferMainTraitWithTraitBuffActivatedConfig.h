...
#define RPG_GAMECORE_FATEMODIFIERTRANSFERMAINTRAITWITHTRAITBUFFACTIVATEDCONFIG_METHOD_3_07B5B05231007E17_OFFSET UNITYSDK_OFFSET(0x171C9280)
#define RPG_GAMECORE_FATEMODIFIERTRANSFERMAINTRAITWITHTRAITBUFFACTIVATEDCONFIG_METHOD_3_CD235DC3EC84C9EE_OFFSET UNITYSDK_OFFSET(0x171C86C0)
#define RPG_GAMECORE_FATEMODIFIERTRANSFERMAINTRAITWITHTRAITBUFFACTIVATEDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171C8670)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateModifierTransferMainTraitWithTraitBuffActivatedConfig_TypeDefinitionIndex = 17712;
