...
#define RPG_GAMECORE_FATEMODIFIERTRANSFERMAINTRAITWITHTRAITBUFFACTIVATEDCONFIG_METHOD_3_A8E70DE57ECB5252_OFFSET UNITYSDK_OFFSET(0x1C0755F0)
#define RPG_GAMECORE_FATEMODIFIERTRANSFERMAINTRAITWITHTRAITBUFFACTIVATEDCONFIG_METHOD_3_CD235DC3EC84C9EE_OFFSET UNITYSDK_OFFSET(0x1C075640)
#define RPG_GAMECORE_FATEMODIFIERTRANSFERMAINTRAITWITHTRAITBUFFACTIVATEDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C075630)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateModifierTransferMainTraitWithTraitBuffActivatedConfig_TypeDefinitionIndex = 18532;
