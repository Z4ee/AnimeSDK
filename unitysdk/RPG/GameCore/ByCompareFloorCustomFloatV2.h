...
#define RPG_GAMECORE_BYCOMPAREFLOORCUSTOMFLOATV2_METHOD_4_10E2416C2EE85552_OFFSET UNITYSDK_OFFSET(0x19CE2C40)
#define RPG_GAMECORE_BYCOMPAREFLOORCUSTOMFLOATV2_METHOD_4_216640FAD1D4AA1D_OFFSET UNITYSDK_OFFSET(0x19CE2E50)
#define RPG_GAMECORE_BYCOMPAREFLOORCUSTOMFLOATV2_METHOD_4_4714BCD181BBD3EA_OFFSET UNITYSDK_OFFSET(0x19CE2E90)
#define RPG_GAMECORE_BYCOMPAREFLOORCUSTOMFLOATV2_METHOD_4_66D62400EBEAD5FF_OFFSET UNITYSDK_OFFSET(0x19CE2BF0)
#define RPG_GAMECORE_BYCOMPAREFLOORCUSTOMFLOATV2__CTOR_OFFSET UNITYSDK_OFFSET(0x19CE2C30)
