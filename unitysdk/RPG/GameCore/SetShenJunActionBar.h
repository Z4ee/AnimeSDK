...
#define RPG_GAMECORE_SETSHENJUNACTIONBAR_METHOD_3_46393CC2A5BF6A2E_OFFSET UNITYSDK_OFFSET(0x176DD5E0)
#define RPG_GAMECORE_SETSHENJUNACTIONBAR_METHOD_3_9679308B6CC9BDF9_OFFSET UNITYSDK_OFFSET(0x176DD560)
#define RPG_GAMECORE_SETSHENJUNACTIONBAR__CTOR_OFFSET UNITYSDK_OFFSET(0x176DD5B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetShenJunActionBar_TypeDefinitionIndex = 21132;
