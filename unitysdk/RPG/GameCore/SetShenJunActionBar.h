...
#define RPG_GAMECORE_SETSHENJUNACTIONBAR_METHOD_3_11D527C72B71757F_OFFSET UNITYSDK_OFFSET(0x1D50C9F0)
#define RPG_GAMECORE_SETSHENJUNACTIONBAR_METHOD_3_46393CC2A5BF6A2E_OFFSET UNITYSDK_OFFSET(0x1D50CA30)
#define RPG_GAMECORE_SETSHENJUNACTIONBAR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D50CA20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetShenJunActionBar_TypeDefinitionIndex = 22675;
