...
#define RPG_GAMECORE_FINDANCHORCONFIG_METHOD_2_EF8EBFAB8D9D2A1A_OFFSET UNITYSDK_OFFSET(0x1BA7FF40)
#define RPG_GAMECORE_FINDANCHORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA80020)
