...
#define RPG_GAMECORE_TARGETFETCHCURRENTDAMAGEDEFENDER_METHOD_4_B283A6EC3AE66323_OFFSET UNITYSDK_OFFSET(0x177B46F0)
#define RPG_GAMECORE_TARGETFETCHCURRENTDAMAGEDEFENDER_METHOD_4_DEFC360ECA53BB55_OFFSET UNITYSDK_OFFSET(0x177BE1E0)
#define RPG_GAMECORE_TARGETFETCHCURRENTDAMAGEDEFENDER__CTOR_OFFSET UNITYSDK_OFFSET(0x177B46A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchCurrentDamageDefender_TypeDefinitionIndex = 22286;
