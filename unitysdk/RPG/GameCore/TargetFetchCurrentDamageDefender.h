...
#define RPG_GAMECORE_TARGETFETCHCURRENTDAMAGEDEFENDER_METHOD_4_25DCE92F15A36C9B_OFFSET UNITYSDK_OFFSET(0x1D0B9150)
#define RPG_GAMECORE_TARGETFETCHCURRENTDAMAGEDEFENDER_METHOD_4_AB68CA1DB44A7F37_OFFSET UNITYSDK_OFFSET(0x1D0B9110)
#define RPG_GAMECORE_TARGETFETCHCURRENTDAMAGEDEFENDER_METHOD_4_B283A6EC3AE66323_OFFSET UNITYSDK_OFFSET(0x1D0B90B0)
#define RPG_GAMECORE_TARGETFETCHCURRENTDAMAGEDEFENDER_METHOD_4_F750882A3DE2FBA2_OFFSET UNITYSDK_OFFSET(0x1D0B9010)
#define RPG_GAMECORE_TARGETFETCHCURRENTDAMAGEDEFENDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0B90A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchCurrentDamageDefender_TypeDefinitionIndex = 23156;
