...
#define RPG_GAMECORE_CHANGECHARACTERSOMATOTYPE_METHOD_3_76AC682A0D53C0DE_OFFSET UNITYSDK_OFFSET(0x1B718FF0)
#define RPG_GAMECORE_CHANGECHARACTERSOMATOTYPE_METHOD_3_9278CD33DC2848E8_OFFSET UNITYSDK_OFFSET(0x1B719090)
#define RPG_GAMECORE_CHANGECHARACTERSOMATOTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B719050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChangeCharacterSomatoType_TypeDefinitionIndex = 22828;
