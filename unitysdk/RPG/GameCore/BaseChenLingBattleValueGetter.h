...
#define RPG_GAMECORE_BASECHENLINGBATTLEVALUEGETTER_METHOD_2_D5B80FAB7297D182_OFFSET UNITYSDK_OFFSET(0x1B2EAB00)
#define RPG_GAMECORE_BASECHENLINGBATTLEVALUEGETTER_METHOD_2_D8F7CEB9B788FDE6_OFFSET UNITYSDK_OFFSET(0x1B2EAF10)
#define RPG_GAMECORE_BASECHENLINGBATTLEVALUEGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2EAF70)
