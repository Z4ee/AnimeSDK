...
#define RPG_GAMECORE_BASECHENLINGBATTLEVALUEGETTER_METHOD_2_8FE6DA6BE66A4BD7_OFFSET UNITYSDK_OFFSET(0x186E8E50)
#define RPG_GAMECORE_BASECHENLINGBATTLEVALUEGETTER_METHOD_2_D8F7CEB9B788FDE6_OFFSET UNITYSDK_OFFSET(0x186E9430)
#define RPG_GAMECORE_BASECHENLINGBATTLEVALUEGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x186E9490)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BaseChenLingBattleValueGetter_TypeDefinitionIndex = 14962;
