...
#define RPG_GAMECORE_BASECHENLINGBATTLEVALUEGETTER_METHOD_2_D5B80FAB7297D182_OFFSET UNITYSDK_OFFSET(0x1CE64B90)
#define RPG_GAMECORE_BASECHENLINGBATTLEVALUEGETTER_METHOD_2_D8F7CEB9B788FDE6_OFFSET UNITYSDK_OFFSET(0x1CE64FA0)
#define RPG_GAMECORE_BASECHENLINGBATTLEVALUEGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE65000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BaseChenLingBattleValueGetter_TypeDefinitionIndex = 15626;
