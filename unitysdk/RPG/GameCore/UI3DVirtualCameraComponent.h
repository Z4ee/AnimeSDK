...
#define RPG_GAMECORE_UI3DVIRTUALCAMERACOMPONENT_ACTIVEVIRTUALCAMERA_OFFSET UNITYSDK_OFFSET(0xAAED7A0)
#define RPG_GAMECORE_UI3DVIRTUALCAMERACOMPONENT_CREATECAMERASTATE_1_OFFSET UNITYSDK_OFFSET(0xAAF7380)
#define RPG_GAMECORE_UI3DVIRTUALCAMERACOMPONENT_CREATECAMERASTATE_OFFSET UNITYSDK_OFFSET(0xAAF7280)
#define RPG_GAMECORE_UI3DVIRTUALCAMERACOMPONENT_DISPOSE_OFFSET UNITYSDK_OFFSET(0xAAF6E30)
#define RPG_GAMECORE_UI3DVIRTUALCAMERACOMPONENT_ENABLEMAINLIGHTCHANGE_OFFSET UNITYSDK_OFFSET(0xAAF7740)
#define RPG_GAMECORE_UI3DVIRTUALCAMERACOMPONENT_GET_AREACONFIG_OFFSET UNITYSDK_OFFSET(0xAAF7C80)
#define RPG_GAMECORE_UI3DVIRTUALCAMERACOMPONENT_GET_AREAROOTTRANS_OFFSET UNITYSDK_OFFSET(0xAAF7CA0)
#define RPG_GAMECORE_UI3DVIRTUALCAMERACOMPONENT_GET_BRAIN_OFFSET UNITYSDK_OFFSET(0xAAF7C60)
#define RPG_GAMECORE_UI3DVIRTUALCAMERACOMPONENT_GET_CAMERA_OFFSET UNITYSDK_OFFSET(0xAAF7C00)
#define RPG_GAMECORE_UI3DVIRTUALCAMERACOMPONENT_GET_INPUTDATA_OFFSET UNITYSDK_OFFSET(0xAAEBE80)
#define RPG_GAMECORE_UI3DVIRTUALCAMERACOMPONENT_GET_ISENABLEMAINLIGHTCHANGE_OFFSET UNITYSDK_OFFSET(0xAAF7C20)
#define RPG_GAMECORE_UI3DVIRTUALCAMERACOMPONENT_GET_TARGETENTITY_OFFSET UNITYSDK_OFFSET(0xAAF7C40)
#define RPG_GAMECORE_UI3DVIRTUALCAMERACOMPONENT_INITCOMPONENT_OFFSET UNITYSDK_OFFSET(0xAAF6FE0)
#define RPG_GAMECORE_UI3DVIRTUALCAMERACOMPONENT_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xAAF79F0)
#define RPG_GAMECORE_UI3DVIRTUALCAMERACOMPONENT_RESETINPUTCONTROLLER_OFFSET UNITYSDK_OFFSET(0xAAF7870)
#define RPG_GAMECORE_UI3DVIRTUALCAMERACOMPONENT_RESETMAINLIGHTDIR_OFFSET UNITYSDK_OFFSET(0xAAF6F70)
#define RPG_GAMECORE_UI3DVIRTUALCAMERACOMPONENT_SETBLEND_OFFSET UNITYSDK_OFFSET(0xAAF7530)
#define RPG_GAMECORE_UI3DVIRTUALCAMERACOMPONENT_SETMAINLIGHTDIROFFSET_OFFSET UNITYSDK_OFFSET(0xAAF7490)
#define RPG_GAMECORE_UI3DVIRTUALCAMERACOMPONENT_SETTARGETENTITY_OFFSET UNITYSDK_OFFSET(0xAAF74E0)
#define RPG_GAMECORE_UI3DVIRTUALCAMERACOMPONENT_SET_AREACONFIG_OFFSET UNITYSDK_OFFSET(0xAAF7C90)
#define RPG_GAMECORE_UI3DVIRTUALCAMERACOMPONENT_SET_AREAROOTTRANS_OFFSET UNITYSDK_OFFSET(0xAAF7CB0)
#define RPG_GAMECORE_UI3DVIRTUALCAMERACOMPONENT_SET_BRAIN_OFFSET UNITYSDK_OFFSET(0xAAF7C70)
#define RPG_GAMECORE_UI3DVIRTUALCAMERACOMPONENT_SET_CAMERA_OFFSET UNITYSDK_OFFSET(0xAAF7C10)
#define RPG_GAMECORE_UI3DVIRTUALCAMERACOMPONENT_SET_ISENABLEMAINLIGHTCHANGE_OFFSET UNITYSDK_OFFSET(0xAAF7C30)
#define RPG_GAMECORE_UI3DVIRTUALCAMERACOMPONENT_SET_TARGETENTITY_OFFSET UNITYSDK_OFFSET(0xAAF7C50)
#define RPG_GAMECORE_UI3DVIRTUALCAMERACOMPONENT_TICK_OFFSET UNITYSDK_OFFSET(0xAAF7970)
#define RPG_GAMECORE_UI3DVIRTUALCAMERACOMPONENT_UPDATECINEMACHINEBRAIN_OFFSET UNITYSDK_OFFSET(0xAAF7910)
#define RPG_GAMECORE_UI3DVIRTUALCAMERACOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0xAAF7E60)
#define RPG_GAMECORE_UI3DVIRTUALCAMERACOMPONENT__GETACTIVECAMERASTATE_OFFSET UNITYSDK_OFFSET(0xAAF78D0)
#define RPG_GAMECORE_UI3DVIRTUALCAMERACOMPONENT__SETUPBLEND_OFFSET UNITYSDK_OFFSET(0xAAF76C0)
#define RPG_GAMECORE_UI3DVIRTUALCAMERACOMPONENT__TICKENVIROMENT_OFFSET UNITYSDK_OFFSET(0xAAF7AF0)
#define RPG_GAMECORE_UI3DVIRTUALCAMERACOMPONENT__UPDATEMAINLIGHTDIR_OFFSET UNITYSDK_OFFSET(0xAAF7CC0)
#define RPG_GAMECORE_UI3DVIRTUALCAMERACOMPONENT__UPDATEUI3DCAMERASTATE_OFFSET UNITYSDK_OFFSET(0xAAF7B70)
#define RPG_GAMECORE_UI3DVIRTUALCAMERACOMPONENT___IFIXBASEPROXY_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xAAF7E80)
#define RPG_GAMECORE_UI3DVIRTUALCAMERACOMPONENT___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0xAAF7E70)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Cinemachine::CinemachineBrain* _Brain_k__BackingField; // 0x18
		::UnityEngine::Transform* _CameraTrans; // 0x20
		::RPG::GameCore::ManikinAreaConfig* _AreaConfig_k__BackingField; // 0x28
		::RPG::Client::EnvironmentSystem* _EnvironmentSystemRef; // 0x30
		::System::Collections::Generic::List_1<::RPG::GameCore::UI3DCameraStateBase*>* _CameraStates; // 0x38
		::UnityEngine::Camera* _Camera_k__BackingField; // 0x40
		::RPG::GameCore::GameEntity* _TargetEntity_k__BackingField; // 0x48
		::RPG::Client::BlendDefinition* _BlendConfig; // 0x50
		::RPG::Client::InputDataController* _InputControllerRef; // 0x58
		::UnityEngine::Transform* _AreaRootTrans_k__BackingField; // 0x60
		::RPG::GameCore::UI3DCameraStateBase* _ActiveCameraState; // 0x68
		::UnityEngine::Vector2 _DEFAULT_MAIN_LIGHT_DIR; // 0x70
		::UnityEngine::Vector2 _MainLightDirOffset; // 0x78
		::UnityEngine::Vector4 _MainLightDir; // 0x80
		::System::Boolean _IsEnableMainLightChange_k__BackingField; // 0x90
		::System::Boolean _IsEnviromentProfileActive; // 0x91
