...
#define RPG_GAMECORE_DOFEFFECT_METHOD_3_772F293D4D6D8848_OFFSET UNITYSDK_OFFSET(0x17143FF0)
#define RPG_GAMECORE_DOFEFFECT_METHOD_3_92F30A2DBD4FE77C_OFFSET UNITYSDK_OFFSET(0x17144110)
#define RPG_GAMECORE_DOFEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x17144090)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DOFEffect_TypeDefinitionIndex = 18542;
