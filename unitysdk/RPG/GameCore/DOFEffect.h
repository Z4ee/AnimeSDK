...
#define RPG_GAMECORE_DOFEFFECT_METHOD_3_92F30A2DBD4FE77C_OFFSET UNITYSDK_OFFSET(0x1D8077F0)
#define RPG_GAMECORE_DOFEFFECT_METHOD_3_AFFC35AB54C131CB_OFFSET UNITYSDK_OFFSET(0x1D807700)
#define RPG_GAMECORE_DOFEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D807790)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DOFEffect_TypeDefinitionIndex = 20024;
