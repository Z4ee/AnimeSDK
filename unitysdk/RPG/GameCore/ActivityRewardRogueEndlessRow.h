...
#define RPG_GAMECORE_ACTIVITYREWARDROGUEENDLESSROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1AB0C6B0)
#define RPG_GAMECORE_ACTIVITYREWARDROGUEENDLESSROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB0CCF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityRewardRogueEndlessRow_TypeDefinitionIndex = 11864;
