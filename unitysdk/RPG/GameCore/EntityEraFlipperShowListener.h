...
#define RPG_GAMECORE_ENTITYERAFLIPPERSHOWLISTENER_METHOD_3_85699B1EEFF1989E_OFFSET UNITYSDK_OFFSET(0x1719FA80)
#define RPG_GAMECORE_ENTITYERAFLIPPERSHOWLISTENER_METHOD_3_C0D0D27D00E551AF_OFFSET UNITYSDK_OFFSET(0x1719FB00)
#define RPG_GAMECORE_ENTITYERAFLIPPERSHOWLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1719FAD0)
