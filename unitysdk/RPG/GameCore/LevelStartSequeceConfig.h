...
#define RPG_GAMECORE_LEVELSTARTSEQUECECONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1734CCF0)
#define RPG_GAMECORE_LEVELSTARTSEQUECECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1734CEA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelStartSequeceConfig_TypeDefinitionIndex = 16795;
