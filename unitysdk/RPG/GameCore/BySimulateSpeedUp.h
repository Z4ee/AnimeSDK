...
#define RPG_GAMECORE_BYSIMULATESPEEDUP_METHOD_4_12C1839BEA098814_OFFSET UNITYSDK_OFFSET(0x1875F690)
#define RPG_GAMECORE_BYSIMULATESPEEDUP_METHOD_4_C2A1171F702924FE_OFFSET UNITYSDK_OFFSET(0x1875F5C0)
#define RPG_GAMECORE_BYSIMULATESPEEDUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1875F640)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BySimulateSpeedUp_TypeDefinitionIndex = 22274;
