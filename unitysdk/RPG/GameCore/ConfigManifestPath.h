...
#define RPG_GAMECORE_CONFIGMANIFESTPATH_METHOD_2_E6048DD50E1B3CCC_OFFSET UNITYSDK_OFFSET(0x1D9B04D0)
#define RPG_GAMECORE_CONFIGMANIFESTPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1D9B0B20)
