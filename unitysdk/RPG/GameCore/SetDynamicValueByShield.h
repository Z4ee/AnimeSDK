...
#define RPG_GAMECORE_SETDYNAMICVALUEBYSHIELD_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1E822D20)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSHIELD_METHOD_4_32EE14C2CD4DE1FE_OFFSET UNITYSDK_OFFSET(0x1E822B30)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSHIELD_METHOD_4_65099969AE2C34D3_OFFSET UNITYSDK_OFFSET(0x1E822AF0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSHIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x1E822B20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByShield_TypeDefinitionIndex = 22836;
