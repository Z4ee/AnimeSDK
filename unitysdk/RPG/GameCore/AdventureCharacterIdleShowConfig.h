...
#define RPG_GAMECORE_ADVENTURECHARACTERIDLESHOWCONFIG_GET_DEFAULT_OFFSET UNITYSDK_OFFSET(0x1CBB8760)
#define RPG_GAMECORE_ADVENTURECHARACTERIDLESHOWCONFIG_METHOD_2_1FBA55993C232EC9_OFFSET UNITYSDK_OFFSET(0x1CBB7AD0)
#define RPG_GAMECORE_ADVENTURECHARACTERIDLESHOWCONFIG__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CBB8790)
#define RPG_GAMECORE_ADVENTURECHARACTERIDLESHOWCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CBB8620)
...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::RPG::GameCore::AdventureCharacterIdleShowConfig**)Il2CppClass::FromTypeDefinitionIndex(AdventureCharacterIdleShowConfig_TypeDefinitionIndex)->GetStaticField(0x23330);
		}
