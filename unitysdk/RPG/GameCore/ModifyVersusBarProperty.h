...
#define RPG_GAMECORE_MODIFYVERSUSBARPROPERTY_METHOD_3_1A4469B4285A2608_OFFSET UNITYSDK_OFFSET(0x1D2B94D0)
#define RPG_GAMECORE_MODIFYVERSUSBARPROPERTY_METHOD_3_66EFBF7424798294_OFFSET UNITYSDK_OFFSET(0x1D2B9490)
#define RPG_GAMECORE_MODIFYVERSUSBARPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2B94C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyVersusBarProperty_TypeDefinitionIndex = 22888;
