...
#define RPG_GAMECORE_GRIDFIGHTPREPTUTORIALPOPUPPANELVISIBLEPARAM_METHOD_2_256A1032F10B7042_OFFSET UNITYSDK_OFFSET(0x198034D0)
#define RPG_GAMECORE_GRIDFIGHTPREPTUTORIALPOPUPPANELVISIBLEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x198038D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightPrepTutorialPopupPanelVisibleParam_TypeDefinitionIndex = 18847;
