...
#define RPG_GAMECORE_GRIDFIGHTPREPTUTORIALPOPUPPANELVISIBLEPARAM_METHOD_2_256A1032F10B7042_OFFSET UNITYSDK_OFFSET(0x1727BFC0)
#define RPG_GAMECORE_GRIDFIGHTPREPTUTORIALPOPUPPANELVISIBLEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1727C3C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightPrepTutorialPopupPanelVisibleParam_TypeDefinitionIndex = 18240;
