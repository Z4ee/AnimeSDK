...
#define RPG_GAMECORE_GRIDFIGHTPREPTUTORIALPOPUPPANELVISIBLEPARAM_METHOD_2_256A1032F10B7042_OFFSET UNITYSDK_OFFSET(0x1D0702C0)
#define RPG_GAMECORE_GRIDFIGHTPREPTUTORIALPOPUPPANELVISIBLEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0706C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightPrepTutorialPopupPanelVisibleParam_TypeDefinitionIndex = 19197;
