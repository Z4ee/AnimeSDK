...
#define RPG_GAMECORE_MARBLEBYISATTACKER_METHOD_4_48DF30B15A40B92D_OFFSET UNITYSDK_OFFSET(0x1D4A60B0)
#define RPG_GAMECORE_MARBLEBYISATTACKER_METHOD_4_A963C18ED999C84E_OFFSET UNITYSDK_OFFSET(0x1D4A6050)
#define RPG_GAMECORE_MARBLEBYISATTACKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4A60A0)
