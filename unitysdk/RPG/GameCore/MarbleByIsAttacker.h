...
#define RPG_GAMECORE_MARBLEBYISATTACKER_METHOD_4_B2A897558D566C6F_OFFSET UNITYSDK_OFFSET(0x1738B620)
#define RPG_GAMECORE_MARBLEBYISATTACKER_METHOD_4_D6F8E8E15D90D4AF_OFFSET UNITYSDK_OFFSET(0x1738B700)
#define RPG_GAMECORE_MARBLEBYISATTACKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1738B6B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleByIsAttacker_TypeDefinitionIndex = 15446;
