...
#define RPG_GAMECORE_CHIMERADUELBUFFEFFECTPARAM_METHOD_3_3D113EAE12DB986A_OFFSET UNITYSDK_OFFSET(0x17096870)
#define RPG_GAMECORE_CHIMERADUELBUFFEFFECTPARAM_METHOD_3_B6FAE2ED62BD63C2_OFFSET UNITYSDK_OFFSET(0x170968D0)
#define RPG_GAMECORE_CHIMERADUELBUFFEFFECTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x170968C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelBuffEffectParam_TypeDefinitionIndex = 14709;
