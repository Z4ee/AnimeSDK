...
#define RPG_GAMECORE_CHIMERADUELBUFFEFFECTPARAM_METHOD_3_0BD20A5DD06B82D7_OFFSET UNITYSDK_OFFSET(0x1C391AD0)
#define RPG_GAMECORE_CHIMERADUELBUFFEFFECTPARAM_METHOD_3_211EE1A4B761F317_OFFSET UNITYSDK_OFFSET(0x1C391B30)
#define RPG_GAMECORE_CHIMERADUELBUFFEFFECTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1C391B20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelBuffEffectParam_TypeDefinitionIndex = 15404;
