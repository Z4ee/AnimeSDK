...
#define RPG_GAMECORE_SETDYNAMICVALUEBYACTIVITYELATION_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x19C40060)
#define RPG_GAMECORE_SETDYNAMICVALUEBYACTIVITYELATION_METHOD_4_BC195C6FBC4D22CE_OFFSET UNITYSDK_OFFSET(0x19C3FFE0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYACTIVITYELATION_METHOD_4_F272D784FB962E23_OFFSET UNITYSDK_OFFSET(0x19C35B10)
#define RPG_GAMECORE_SETDYNAMICVALUEBYACTIVITYELATION__CTOR_OFFSET UNITYSDK_OFFSET(0x19C35AC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByActivityElation_TypeDefinitionIndex = 21895;
