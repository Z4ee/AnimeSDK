...
#define RPG_GAMECORE_SETDYNAMICVALUEBYACTIVITYELATION_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x18E1C9D0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYACTIVITYELATION_METHOD_4_BC195C6FBC4D22CE_OFFSET UNITYSDK_OFFSET(0x18E1C950)
#define RPG_GAMECORE_SETDYNAMICVALUEBYACTIVITYELATION_METHOD_4_F272D784FB962E23_OFFSET UNITYSDK_OFFSET(0x18E199C0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYACTIVITYELATION__CTOR_OFFSET UNITYSDK_OFFSET(0x18E19970)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByActivityElation_TypeDefinitionIndex = 22100;
