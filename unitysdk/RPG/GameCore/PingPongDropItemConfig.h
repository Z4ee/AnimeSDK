...
#define RPG_GAMECORE_PINGPONGDROPITEMCONFIG_METHOD_2_BFE7295BA77FC4D6_OFFSET UNITYSDK_OFFSET(0x1B4C6370)
#define RPG_GAMECORE_PINGPONGDROPITEMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4C6520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PingPongDropItemConfig_TypeDefinitionIndex = 16312;
