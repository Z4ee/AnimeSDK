...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONCHESSROLLDICECONFIG_METHOD_3_2B0D0BF0FC74FD96_OFFSET UNITYSDK_OFFSET(0x18D35280)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONCHESSROLLDICECONFIG_METHOD_3_A52DF3B8B8D1967F_OFFSET UNITYSDK_OFFSET(0x18D3CCF0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONCHESSROLLDICECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D35230)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnChessRollDiceConfig_TypeDefinitionIndex = 17044;
