...
#define RPG_GAMECORE_MARBLEBUFFTEXT_METHOD_3_801751DAE0E58958_OFFSET UNITYSDK_OFFSET(0x18A968A0)
#define RPG_GAMECORE_MARBLEBUFFTEXT_METHOD_3_A73D56702C562A34_OFFSET UNITYSDK_OFFSET(0x18A96980)
#define RPG_GAMECORE_MARBLEBUFFTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x18A96930)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleBuffText_TypeDefinitionIndex = 15940;
