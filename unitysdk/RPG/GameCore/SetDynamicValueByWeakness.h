...
#define RPG_GAMECORE_SETDYNAMICVALUEBYWEAKNESS_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1C5F3B40)
#define RPG_GAMECORE_SETDYNAMICVALUEBYWEAKNESS_METHOD_4_11BD17AF33A44AE9_OFFSET UNITYSDK_OFFSET(0x1C5F3900)
#define RPG_GAMECORE_SETDYNAMICVALUEBYWEAKNESS_METHOD_4_4C34D1504D2F4348_OFFSET UNITYSDK_OFFSET(0x1C5F3950)
#define RPG_GAMECORE_SETDYNAMICVALUEBYWEAKNESS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5F3940)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByWeakness_TypeDefinitionIndex = 22288;
