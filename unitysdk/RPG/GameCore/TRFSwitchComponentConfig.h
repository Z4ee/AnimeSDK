...
#define RPG_GAMECORE_TRFSWITCHCOMPONENTCONFIG_METHOD_3_7F5C6007E715476B_OFFSET UNITYSDK_OFFSET(0x18ECD710)
#define RPG_GAMECORE_TRFSWITCHCOMPONENTCONFIG_METHOD_3_9016A03EEA1B45E8_OFFSET UNITYSDK_OFFSET(0x18ECD830)
#define RPG_GAMECORE_TRFSWITCHCOMPONENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18ECD810)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TRFSwitchComponentConfig_TypeDefinitionIndex = 17955;
