...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERBANROLEINSHOPBEFORESTAGENODECONFIG_METHOD_3_3070F24B7D743397_OFFSET UNITYSDK_OFFSET(0x1C5D0680)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERBANROLEINSHOPBEFORESTAGENODECONFIG_METHOD_3_E75EFA1728999E7B_OFFSET UNITYSDK_OFFSET(0x1C5D06D0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERBANROLEINSHOPBEFORESTAGENODECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5D06C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierBanRoleInShopBeforeStageNodeConfig_TypeDefinitionIndex = 18691;
