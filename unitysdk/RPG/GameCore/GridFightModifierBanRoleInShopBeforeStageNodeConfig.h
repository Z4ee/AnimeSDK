...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERBANROLEINSHOPBEFORESTAGENODECONFIG_METHOD_3_55C8FEF1A5626862_OFFSET UNITYSDK_OFFSET(0x189B1E50)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERBANROLEINSHOPBEFORESTAGENODECONFIG_METHOD_3_E75EFA1728999E7B_OFFSET UNITYSDK_OFFSET(0x189B1F20)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERBANROLEINSHOPBEFORESTAGENODECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189B1ED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierBanRoleInShopBeforeStageNodeConfig_TypeDefinitionIndex = 18471;
