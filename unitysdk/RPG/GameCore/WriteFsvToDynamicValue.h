...
#define RPG_GAMECORE_WRITEFSVTODYNAMICVALUE_METHOD_3_9E46DA249B8C8BF9_OFFSET UNITYSDK_OFFSET(0x19115030)
#define RPG_GAMECORE_WRITEFSVTODYNAMICVALUE_METHOD_3_F1A3199CDCA92670_OFFSET UNITYSDK_OFFSET(0x19114FB0)
#define RPG_GAMECORE_WRITEFSVTODYNAMICVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x19115000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WriteFsvToDynamicValue_TypeDefinitionIndex = 20895;
