...
#define RPG_GAMECORE_WRITEFSVTODYNAMICVALUE_METHOD_3_9E46DA249B8C8BF9_OFFSET UNITYSDK_OFFSET(0x1EFADE50)
#define RPG_GAMECORE_WRITEFSVTODYNAMICVALUE_METHOD_3_AE26D26B49E8EB3A_OFFSET UNITYSDK_OFFSET(0x1EFADE10)
#define RPG_GAMECORE_WRITEFSVTODYNAMICVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFADE40)
