...
#define RPG_GAMECORE_WRITEFSVTODYNAMICVALUE_METHOD_3_9E46DA249B8C8BF9_OFFSET UNITYSDK_OFFSET(0x17911130)
#define RPG_GAMECORE_WRITEFSVTODYNAMICVALUE_METHOD_3_F1A3199CDCA92670_OFFSET UNITYSDK_OFFSET(0x179110B0)
#define RPG_GAMECORE_WRITEFSVTODYNAMICVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x17911100)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WriteFsvToDynamicValue_TypeDefinitionIndex = 20213;
