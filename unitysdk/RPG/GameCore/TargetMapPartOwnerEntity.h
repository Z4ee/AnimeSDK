...
#define RPG_GAMECORE_TARGETMAPPARTOWNERENTITY_METHOD_3_1D583101E07D74E3_OFFSET UNITYSDK_OFFSET(0x1D0C2DA0)
#define RPG_GAMECORE_TARGETMAPPARTOWNERENTITY_METHOD_3_2DCF552AEDD8DA59_OFFSET UNITYSDK_OFFSET(0x1D0C2E80)
#define RPG_GAMECORE_TARGETMAPPARTOWNERENTITY_METHOD_3_2F7F2E2C6FA5B48C_OFFSET UNITYSDK_OFFSET(0x1D0C2EA0)
#define RPG_GAMECORE_TARGETMAPPARTOWNERENTITY_METHOD_3_7F63DC0307A52E62_OFFSET UNITYSDK_OFFSET(0x1D0C2E20)
#define RPG_GAMECORE_TARGETMAPPARTOWNERENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0C2E10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapPartOwnerEntity_TypeDefinitionIndex = 23170;
