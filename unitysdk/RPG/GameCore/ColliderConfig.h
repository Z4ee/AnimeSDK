...
#define RPG_GAMECORE_COLLIDERCONFIG_METHOD_2_DB1183BA0272677E_OFFSET UNITYSDK_OFFSET(0x1BC21810)
#define RPG_GAMECORE_COLLIDERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC21980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ColliderConfig_TypeDefinitionIndex = 16788;
