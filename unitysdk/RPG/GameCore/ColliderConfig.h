...
#define RPG_GAMECORE_COLLIDERCONFIG_METHOD_2_DB1183BA0272677E_OFFSET UNITYSDK_OFFSET(0x1CFEED30)
#define RPG_GAMECORE_COLLIDERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFEEEA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ColliderConfig_TypeDefinitionIndex = 17290;
