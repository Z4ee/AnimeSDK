...
#define RPG_GAMECORE_TAROTWIKIDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x177D7E00)
#define RPG_GAMECORE_TAROTWIKIDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x177D8110)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TarotWikiDataRow_TypeDefinitionIndex = 13982;
