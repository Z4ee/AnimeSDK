...
#define RPG_GAMECORE_FIVEDIMTELEPORTACTION_METHOD_3_3B313E75D5516570_OFFSET UNITYSDK_OFFSET(0x189223A0)
#define RPG_GAMECORE_FIVEDIMTELEPORTACTION_METHOD_3_BA3715B663ECB924_OFFSET UNITYSDK_OFFSET(0x189222C0)
#define RPG_GAMECORE_FIVEDIMTELEPORTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18922380)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimTeleportAction_TypeDefinitionIndex = 17724;
