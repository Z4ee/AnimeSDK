...
#define RPG_GAMECORE_ROGUETOURNBUILDREFFALLBACKLANGCONFIG_GET_GAMELANGCODE2PLATFORM_OFFSET UNITYSDK_OFFSET(0x17660D60)
#define RPG_GAMECORE_ROGUETOURNBUILDREFFALLBACKLANGCONFIG_METHOD_2_633628DB9E197472_OFFSET UNITYSDK_OFFSET(0x17660BE0)
#define RPG_GAMECORE_ROGUETOURNBUILDREFFALLBACKLANGCONFIG_METHOD_2_A5058F1AD6A80A4F_OFFSET UNITYSDK_OFFSET(0x17660D80)
#define RPG_GAMECORE_ROGUETOURNBUILDREFFALLBACKLANGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17660D50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournBuildRefFallbackLangConfig_TypeDefinitionIndex = 16230;
