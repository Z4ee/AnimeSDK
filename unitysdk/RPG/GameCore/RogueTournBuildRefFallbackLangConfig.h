...
#define RPG_GAMECORE_ROGUETOURNBUILDREFFALLBACKLANGCONFIG_GET_GAMELANGCODE2PLATFORM_OFFSET UNITYSDK_OFFSET(0x1D416DA0)
#define RPG_GAMECORE_ROGUETOURNBUILDREFFALLBACKLANGCONFIG_METHOD_2_633628DB9E197472_OFFSET UNITYSDK_OFFSET(0x1D416C20)
#define RPG_GAMECORE_ROGUETOURNBUILDREFFALLBACKLANGCONFIG_METHOD_2_A5058F1AD6A80A4F_OFFSET UNITYSDK_OFFSET(0x1D416DC0)
#define RPG_GAMECORE_ROGUETOURNBUILDREFFALLBACKLANGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D416D90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournBuildRefFallbackLangConfig_TypeDefinitionIndex = 17464;
