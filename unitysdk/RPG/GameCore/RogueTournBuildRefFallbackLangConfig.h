...
#define RPG_GAMECORE_ROGUETOURNBUILDREFFALLBACKLANGCONFIG_GET_GAMELANGCODE2PLATFORM_OFFSET UNITYSDK_OFFSET(0x19BC28E0)
#define RPG_GAMECORE_ROGUETOURNBUILDREFFALLBACKLANGCONFIG_METHOD_2_633628DB9E197472_OFFSET UNITYSDK_OFFSET(0x19BC2760)
#define RPG_GAMECORE_ROGUETOURNBUILDREFFALLBACKLANGCONFIG_METHOD_2_A5058F1AD6A80A4F_OFFSET UNITYSDK_OFFSET(0x19BC2900)
#define RPG_GAMECORE_ROGUETOURNBUILDREFFALLBACKLANGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19BC28D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournBuildRefFallbackLangConfig_TypeDefinitionIndex = 16800;
