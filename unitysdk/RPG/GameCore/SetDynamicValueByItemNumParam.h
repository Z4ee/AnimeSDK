...
#define RPG_GAMECORE_SETDYNAMICVALUEBYITEMNUMPARAM_METHOD_4_5EF29EC0E840D29B_OFFSET UNITYSDK_OFFSET(0x1C2E4150)
#define RPG_GAMECORE_SETDYNAMICVALUEBYITEMNUMPARAM_METHOD_4_853D82E25B33941F_OFFSET UNITYSDK_OFFSET(0x1C2E41A0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYITEMNUMPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2E4190)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByItemNumParam_TypeDefinitionIndex = 20963;
