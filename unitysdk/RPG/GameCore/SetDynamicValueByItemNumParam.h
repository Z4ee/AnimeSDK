...
#define RPG_GAMECORE_SETDYNAMICVALUEBYITEMNUMPARAM_METHOD_4_853D82E25B33941F_OFFSET UNITYSDK_OFFSET(0x176C2270)
#define RPG_GAMECORE_SETDYNAMICVALUEBYITEMNUMPARAM_METHOD_4_FB15AC8F7BFF8C8F_OFFSET UNITYSDK_OFFSET(0x176C21E0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYITEMNUMPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x176C2240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByItemNumParam_TypeDefinitionIndex = 19934;
