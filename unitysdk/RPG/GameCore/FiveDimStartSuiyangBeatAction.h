...
#define RPG_GAMECORE_FIVEDIMSTARTSUIYANGBEATACTION_METHOD_3_21F366CE44399BA9_OFFSET UNITYSDK_OFFSET(0x19759B60)
#define RPG_GAMECORE_FIVEDIMSTARTSUIYANGBEATACTION_METHOD_3_FDA382B743339DB5_OFFSET UNITYSDK_OFFSET(0x19759A60)
#define RPG_GAMECORE_FIVEDIMSTARTSUIYANGBEATACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19759B40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimStartSuiyangBeatAction_TypeDefinitionIndex = 17803;
