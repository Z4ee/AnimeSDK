...
#define RPG_GAMECORE_FREESTYLELAYERLIST_METHOD_2_3AADCAA69D633B88_OFFSET UNITYSDK_OFFSET(0x1721FEA0)
#define RPG_GAMECORE_FREESTYLELAYERLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1721FEE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FreeStyleLayerList_TypeDefinitionIndex = 14936;
