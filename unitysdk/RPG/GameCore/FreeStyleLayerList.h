...
#define RPG_GAMECORE_FREESTYLELAYERLIST_METHOD_2_3AADCAA69D633B88_OFFSET UNITYSDK_OFFSET(0x1DCBB760)
#define RPG_GAMECORE_FREESTYLELAYERLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCBB7A0)
