...
#define RPG_GAMECORE_MATCHTHREEBIRDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x198EE160)
#define RPG_GAMECORE_MATCHTHREEBIRDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x198EE690)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MatchThreeBirdRow_TypeDefinitionIndex = 11391;
	...
	public:
		...
		::System::UInt32 BirdID; // 0x30
		::System::UInt32 DefaultEmo; // 0x34
		::System::UInt32 SkillID; // 0x38
		::System::UInt32 UnlockLevel; // 0x3C
		::System::UInt32 GuideID; // 0x40
		::RPG::Client::TextID BirdDesc; // 0x48
		::System::UInt32 LoseEmo; // 0x58
		::System::UInt32 WinEmo; // 0x5C
		::RPG::Client::TextID BirdName; // 0x60
		::System::UInt32 DrawEmo; // 0x70
		::System::Boolean IsShow; // 0x74
