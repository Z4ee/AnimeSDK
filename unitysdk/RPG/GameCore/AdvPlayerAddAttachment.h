...
#define RPG_GAMECORE_ADVPLAYERADDATTACHMENT_METHOD_3_3AB8C8D3118DE658_OFFSET UNITYSDK_OFFSET(0x1865D2B0)
#define RPG_GAMECORE_ADVPLAYERADDATTACHMENT_METHOD_3_49B5809DBB3C10C9_OFFSET UNITYSDK_OFFSET(0x1865D330)
#define RPG_GAMECORE_ADVPLAYERADDATTACHMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1865D300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvPlayerAddAttachment_TypeDefinitionIndex = 20037;
