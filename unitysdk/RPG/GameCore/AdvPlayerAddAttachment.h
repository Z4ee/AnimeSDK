...
#define RPG_GAMECORE_ADVPLAYERADDATTACHMENT_METHOD_3_3AB8C8D3118DE658_OFFSET UNITYSDK_OFFSET(0x16F3B120)
#define RPG_GAMECORE_ADVPLAYERADDATTACHMENT_METHOD_3_49B5809DBB3C10C9_OFFSET UNITYSDK_OFFSET(0x16F3B1A0)
#define RPG_GAMECORE_ADVPLAYERADDATTACHMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x16F3B170)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvPlayerAddAttachment_TypeDefinitionIndex = 19378;
