...
#define RPG_GAMECORE_CAPTURELOCALPLAYER_METHOD_3_58414FBA3B7A8AE9_OFFSET UNITYSDK_OFFSET(0x1D108830)
#define RPG_GAMECORE_CAPTURELOCALPLAYER_METHOD_3_C52474EB95839A72_OFFSET UNITYSDK_OFFSET(0x1D108870)
#define RPG_GAMECORE_CAPTURELOCALPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D108860)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CaptureLocalPlayer_TypeDefinitionIndex = 20056;
