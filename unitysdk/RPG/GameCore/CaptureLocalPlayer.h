...
#define RPG_GAMECORE_CAPTURELOCALPLAYER_METHOD_3_34D77234FD3C801B_OFFSET UNITYSDK_OFFSET(0x17053450)
#define RPG_GAMECORE_CAPTURELOCALPLAYER_METHOD_3_C52474EB95839A72_OFFSET UNITYSDK_OFFSET(0x170534D0)
#define RPG_GAMECORE_CAPTURELOCALPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x170534A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CaptureLocalPlayer_TypeDefinitionIndex = 18578;
