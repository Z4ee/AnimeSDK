...
#define RPG_GAMECORE_ADVSETSKILLSLOTDATA_METHOD_3_5C9A2E60612CC682_OFFSET UNITYSDK_OFFSET(0x16F42950)
#define RPG_GAMECORE_ADVSETSKILLSLOTDATA_METHOD_3_B6EA4DCEE4C9C329_OFFSET UNITYSDK_OFFSET(0x16F42880)
#define RPG_GAMECORE_ADVSETSKILLSLOTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x16F42900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSetSkillSlotData_TypeDefinitionIndex = 18485;
