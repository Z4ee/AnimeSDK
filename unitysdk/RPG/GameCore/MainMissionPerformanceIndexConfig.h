...
#define RPG_GAMECORE_MAINMISSIONPERFORMANCEINDEXCONFIG_METHOD_2_034F158A11D9D52C_OFFSET UNITYSDK_OFFSET(0x18A82DC0)
#define RPG_GAMECORE_MAINMISSIONPERFORMANCEINDEXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18A82EA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MainMissionPerformanceIndexConfig_TypeDefinitionIndex = 18054;
