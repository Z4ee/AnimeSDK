...
#define RPG_GAMECORE_MAINMISSIONPERFORMANCEINDEXCONFIG_METHOD_2_B02BA2F82AE36061_OFFSET UNITYSDK_OFFSET(0x1BCD96F0)
#define RPG_GAMECORE_MAINMISSIONPERFORMANCEINDEXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCD97E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MainMissionPerformanceIndexConfig_TypeDefinitionIndex = 18282;
