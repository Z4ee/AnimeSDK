...
#define RPG_GAMECORE_FIVEDIMLEDGEBAKEDCONFIG_METHOD_2_1E0F23A694BAFE4D_OFFSET UNITYSDK_OFFSET(0x1D8667B0)
#define RPG_GAMECORE_FIVEDIMLEDGEBAKEDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D8668C0)
