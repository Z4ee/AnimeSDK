...
#define RPG_GAMECORE_FIVEDIMLEDGEBAKEDCONFIG_METHOD_2_1E0F23A694BAFE4D_OFFSET UNITYSDK_OFFSET(0x18907F40)
#define RPG_GAMECORE_FIVEDIMLEDGEBAKEDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18908050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimLedgeBakedConfig_TypeDefinitionIndex = 15775;
