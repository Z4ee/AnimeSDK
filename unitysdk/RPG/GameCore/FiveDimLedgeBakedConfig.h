...
#define RPG_GAMECORE_FIVEDIMLEDGEBAKEDCONFIG_METHOD_2_1E0F23A694BAFE4D_OFFSET UNITYSDK_OFFSET(0x1D0EDD20)
#define RPG_GAMECORE_FIVEDIMLEDGEBAKEDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0EDE30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimLedgeBakedConfig_TypeDefinitionIndex = 16480;
