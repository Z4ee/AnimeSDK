...
#define RPG_GAMECORE_FIVEDIMSETJUMPENERGYVISIBLEACTION_METHOD_3_221E8A9B05D319F1_OFFSET UNITYSDK_OFFSET(0x19754910)
#define RPG_GAMECORE_FIVEDIMSETJUMPENERGYVISIBLEACTION_METHOD_3_499FDCF1125A1030_OFFSET UNITYSDK_OFFSET(0x197549D0)
#define RPG_GAMECORE_FIVEDIMSETJUMPENERGYVISIBLEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x197549B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSetJumpEnergyVisibleAction_TypeDefinitionIndex = 17778;
