...
#define RPG_GAMECORE_FIVEDIMSETJUMPENERGYVISIBLEACTION_METHOD_3_499FDCF1125A1030_OFFSET UNITYSDK_OFFSET(0x1D878E20)
#define RPG_GAMECORE_FIVEDIMSETJUMPENERGYVISIBLEACTION_METHOD_3_920B54FEF9979EB5_OFFSET UNITYSDK_OFFSET(0x1D878DA0)
#define RPG_GAMECORE_FIVEDIMSETJUMPENERGYVISIBLEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D878E10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSetJumpEnergyVisibleAction_TypeDefinitionIndex = 18475;
