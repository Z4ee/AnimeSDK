...
#define RPG_GAMECORE_ADVWAITINGEVENTBASE_METHOD_3_89027FBB497168C7_OFFSET UNITYSDK_OFFSET(0x16F46B40)
#define RPG_GAMECORE_ADVWAITINGEVENTBASE_METHOD_3_DA370B14F7FBDB2B_OFFSET UNITYSDK_OFFSET(0x16F46980)
#define RPG_GAMECORE_ADVWAITINGEVENTBASE__CCTOR_OFFSET UNITYSDK_OFFSET(0x16F46CB0)
#define RPG_GAMECORE_ADVWAITINGEVENTBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F46C80)
...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Func_2<::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::AdvWaitingEventBase*>*>**)Il2CppClass::FromTypeDefinitionIndex(AdvWaitingEventBase_TypeDefinitionIndex)->GetStaticField(0x1E560);
		}
