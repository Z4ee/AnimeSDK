...
#define RPG_GAMECORE_ADVWAITINGEVENTBASE_METHOD_3_89027FBB497168C7_OFFSET UNITYSDK_OFFSET(0x1CDDF390)
#define RPG_GAMECORE_ADVWAITINGEVENTBASE_METHOD_3_DDAA44F280DF770C_OFFSET UNITYSDK_OFFSET(0x1CDDF330)
#define RPG_GAMECORE_ADVWAITINGEVENTBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDDF4D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvWaitingEventBase_TypeDefinitionIndex = 20449;
