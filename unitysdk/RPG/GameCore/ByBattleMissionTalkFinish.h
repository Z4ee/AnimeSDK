...
#define RPG_GAMECORE_BYBATTLEMISSIONTALKFINISH_METHOD_4_26B844E6F6CB7485_OFFSET UNITYSDK_OFFSET(0x16FFBA30)
#define RPG_GAMECORE_BYBATTLEMISSIONTALKFINISH_METHOD_4_EAB380450B53ED6F_OFFSET UNITYSDK_OFFSET(0x16FFB960)
#define RPG_GAMECORE_BYBATTLEMISSIONTALKFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x16FFB9E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByBattleMissionTalkFinish_TypeDefinitionIndex = 22084;
