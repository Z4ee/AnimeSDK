...
#define RPG_GAMECORE_PLANETFESRECOMMENDTEAMROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1BA00B90)
#define RPG_GAMECORE_PLANETFESRECOMMENDTEAMROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA00DC0)
