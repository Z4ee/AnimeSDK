...
#define RPG_GAMECORE_PLANETFESRECOMMENDTEAMROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19A21AA0)
#define RPG_GAMECORE_PLANETFESRECOMMENDTEAMROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19A21CD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlanetFesRecommendTeamRow_TypeDefinitionIndex = 11694;
