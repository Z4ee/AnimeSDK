...
#define RPG_GAMECORE_ROGUEMODIFIERROGUEMAGICUNITRANDOMLISTCONFIG_METHOD_2_0FC02A23C567CABD_OFFSET UNITYSDK_OFFSET(0x19B9BF60)
#define RPG_GAMECORE_ROGUEMODIFIERROGUEMAGICUNITRANDOMLISTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B9BFA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierRogueMagicUnitRandomListConfig_TypeDefinitionIndex = 16836;
