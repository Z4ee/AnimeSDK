...
#define RPG_GAMECORE_ROGUEMODIFIERROGUEMAGICUNITRANDOMLISTCONFIG_METHOD_2_0FC02A23C567CABD_OFFSET UNITYSDK_OFFSET(0x1D3FC3C0)
#define RPG_GAMECORE_ROGUEMODIFIERROGUEMAGICUNITRANDOMLISTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3FC400)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierRogueMagicUnitRandomListConfig_TypeDefinitionIndex = 17501;
