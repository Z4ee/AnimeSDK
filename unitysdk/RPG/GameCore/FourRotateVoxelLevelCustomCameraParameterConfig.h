...
#define RPG_GAMECORE_FOURROTATEVOXELLEVELCUSTOMCAMERAPARAMETERCONFIG_METHOD_2_E18AF69F8AFC46C4_OFFSET UNITYSDK_OFFSET(0x1976A3A0)
#define RPG_GAMECORE_FOURROTATEVOXELLEVELCUSTOMCAMERAPARAMETERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1976A510)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FourRotateVoxelLevelCustomCameraParameterConfig_TypeDefinitionIndex = 15921;
