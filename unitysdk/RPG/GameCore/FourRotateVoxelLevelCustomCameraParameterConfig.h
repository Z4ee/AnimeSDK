...
#define RPG_GAMECORE_FOURROTATEVOXELLEVELCUSTOMCAMERAPARAMETERCONFIG_METHOD_2_E18AF69F8AFC46C4_OFFSET UNITYSDK_OFFSET(0x1D115CF0)
#define RPG_GAMECORE_FOURROTATEVOXELLEVELCUSTOMCAMERAPARAMETERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D115E60)
