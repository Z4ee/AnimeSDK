...
#define RPG_GAMECORE_FLOORSYNCTEMPLATECONFIGS_METHOD_2_81DD3101D40FD946_OFFSET UNITYSDK_OFFSET(0x1DCAEDE0)
#define RPG_GAMECORE_FLOORSYNCTEMPLATECONFIGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCAEE20)
