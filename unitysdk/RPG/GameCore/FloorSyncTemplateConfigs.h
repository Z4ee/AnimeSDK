...
#define RPG_GAMECORE_FLOORSYNCTEMPLATECONFIGS_METHOD_2_81DD3101D40FD946_OFFSET UNITYSDK_OFFSET(0x18927430)
#define RPG_GAMECORE_FLOORSYNCTEMPLATECONFIGS__CTOR_OFFSET UNITYSDK_OFFSET(0x18927470)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FloorSyncTemplateConfigs_TypeDefinitionIndex = 16522;
