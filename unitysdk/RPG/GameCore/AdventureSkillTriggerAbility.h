...
#define RPG_GAMECORE_ADVENTURESKILLTRIGGERABILITY_METHOD_3_0A3C2CE0B882C601_OFFSET UNITYSDK_OFFSET(0x1CDF7870)
#define RPG_GAMECORE_ADVENTURESKILLTRIGGERABILITY_METHOD_3_CF2D85AE6E09261A_OFFSET UNITYSDK_OFFSET(0x1CDF7830)
#define RPG_GAMECORE_ADVENTURESKILLTRIGGERABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDF7860)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureSkillTriggerAbility_TypeDefinitionIndex = 19991;
