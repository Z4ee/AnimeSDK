...
#define RPG_GAMECORE_ADVENTURESKILLTRIGGERABILITY_METHOD_3_0A3C2CE0B882C601_OFFSET UNITYSDK_OFFSET(0x1867D3E0)
#define RPG_GAMECORE_ADVENTURESKILLTRIGGERABILITY_METHOD_3_EB6CA605AB7D0DA8_OFFSET UNITYSDK_OFFSET(0x1867D360)
#define RPG_GAMECORE_ADVENTURESKILLTRIGGERABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1867D3B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureSkillTriggerAbility_TypeDefinitionIndex = 19166;
