...
#define RPG_GAMECORE_GRIDFIGHTSEASONMODULECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D165B70)
#define RPG_GAMECORE_GRIDFIGHTSEASONMODULECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D165DB0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 GirlHeroSpecialAvatarId; // 0x14
		::System::UInt32 SeasonID; // 0x18
		::System::UInt32 MaxRewardExp; // 0x1C
		::System::UInt32 ActivityModuleID; // 0x20
		::System::UInt32 ActivityQuestConfigID; // 0x24
		::System::UInt32 SubSeasonID; // 0x28
