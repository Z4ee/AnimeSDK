...
#define RPG_GAMECORE_GRIDFIGHTSEASONMODULECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D075EA0)
#define RPG_GAMECORE_GRIDFIGHTSEASONMODULECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0760E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightSeasonModuleConfigRow_TypeDefinitionIndex = 13092;

	class GridFightSeasonModuleConfigRow : public ::System::Object
	{
	public:
		::System::UInt32 OfferingID; // 0x10
		::System::UInt32 ActivityQuestConfigID; // 0x14
		::System::UInt32 SeasonID; // 0x18
		::System::UInt32 GirlHeroSpecialAvatarId; // 0x1C
