...
#define RPG_GAMECORE_AVATARENERGYBARSTATE_COPYDATAFROM_OFFSET UNITYSDK_OFFSET(0x1B612300)
#define RPG_GAMECORE_AVATARENERGYBARSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B612390)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Int32 CurrCount; // 0x30
		::RPG::GameCore::EnergyBarState CurrentStatus; // 0x34
		::System::Int32 CoolDown; // 0x38
		::System::Boolean ShowEnhancedTextColor; // 0x3C
		::System::Boolean IsActive; // 0x3D
