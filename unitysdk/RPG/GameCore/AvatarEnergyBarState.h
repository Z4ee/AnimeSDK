...
#define RPG_GAMECORE_AVATARENERGYBARSTATE_COPYDATAFROM_OFFSET UNITYSDK_OFFSET(0xA8721F0)
#define RPG_GAMECORE_AVATARENERGYBARSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0xA86A990)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AvatarEnergyBarState_TypeDefinitionIndex = 45764;
	...
	public:
		...
		::System::Int32 CoolDown; // 0x30
		::System::Int32 CurrCount; // 0x34
		::System::Int32 ActiveCount; // 0x38
		::System::Int32 MaxCount; // 0x3C
		::System::Int32 CounterType; // 0x40
		::RPG::GameCore::EnergyBarState CurrentStatus; // 0x44
