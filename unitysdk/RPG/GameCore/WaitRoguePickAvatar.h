...
#define RPG_GAMECORE_WAITROGUEPICKAVATAR_METHOD_3_47A308AB74F2D956_OFFSET UNITYSDK_OFFSET(0x1D1BAD70)
#define RPG_GAMECORE_WAITROGUEPICKAVATAR_METHOD_3_E183080DA2038A32_OFFSET UNITYSDK_OFFSET(0x1D1BADC0)
#define RPG_GAMECORE_WAITROGUEPICKAVATAR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1BADB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitRoguePickAvatar_TypeDefinitionIndex = 19704;
