...
#define RPG_GAMECORE_TIMEREWINDSETSPECULARMAT_METHOD_3_1578C07DD4CC866E_OFFSET UNITYSDK_OFFSET(0x1909CDF0)
#define RPG_GAMECORE_TIMEREWINDSETSPECULARMAT_METHOD_3_C19CA4B012FF8815_OFFSET UNITYSDK_OFFSET(0x1909CE70)
#define RPG_GAMECORE_TIMEREWINDSETSPECULARMAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1909CE40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TimeRewindSetSpecularMat_TypeDefinitionIndex = 19616;
