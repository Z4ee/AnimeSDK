...
#define RPG_GAMECORE_BYCOMPAREGROUPMONSTERNUMBYSTATE_METHOD_4_BF42AABF1BFD0B53_OFFSET UNITYSDK_OFFSET(0x1872ED40)
#define RPG_GAMECORE_BYCOMPAREGROUPMONSTERNUMBYSTATE_METHOD_4_D8A8CC0788E23D9A_OFFSET UNITYSDK_OFFSET(0x1872EC70)
#define RPG_GAMECORE_BYCOMPAREGROUPMONSTERNUMBYSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1872ECF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareGroupMonsterNumByState_TypeDefinitionIndex = 20134;
