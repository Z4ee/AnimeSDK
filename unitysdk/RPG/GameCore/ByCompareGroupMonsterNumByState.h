...
#define RPG_GAMECORE_BYCOMPAREGROUPMONSTERNUMBYSTATE_METHOD_4_BF42AABF1BFD0B53_OFFSET UNITYSDK_OFFSET(0x19CE8840)
#define RPG_GAMECORE_BYCOMPAREGROUPMONSTERNUMBYSTATE_METHOD_4_C80BEEB98FE78B8F_OFFSET UNITYSDK_OFFSET(0x19CE87F0)
#define RPG_GAMECORE_BYCOMPAREGROUPMONSTERNUMBYSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19CE8830)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareGroupMonsterNumByState_TypeDefinitionIndex = 20363;
