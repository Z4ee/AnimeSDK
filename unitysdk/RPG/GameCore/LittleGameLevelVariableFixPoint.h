...
#define RPG_GAMECORE_LITTLEGAMELEVELVARIABLEFIXPOINT_METHOD_3_0C47CFA1EBF050A7_OFFSET UNITYSDK_OFFSET(0x1735F880)
#define RPG_GAMECORE_LITTLEGAMELEVELVARIABLEFIXPOINT_METHOD_3_211AB275A4295C7A_OFFSET UNITYSDK_OFFSET(0x1735F010)
#define RPG_GAMECORE_LITTLEGAMELEVELVARIABLEFIXPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1735F000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameLevelVariableFixPoint_TypeDefinitionIndex = 17337;
