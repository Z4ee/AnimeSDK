...
#define RPG_GAMECORE_LEVELLOCKFEATURE_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1B071C20)
#define RPG_GAMECORE_LEVELLOCKFEATURE_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B071BE0)
#define RPG_GAMECORE_LEVELLOCKFEATURE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B071C10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelLockFeature_TypeDefinitionIndex = 22561;
