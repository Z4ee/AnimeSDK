...
#define RPG_GAMECORE_CASECONTAINERBASE_METHOD_2_B58BB1E8444FB843_OFFSET UNITYSDK_OFFSET(0x1B70B340)
#define RPG_GAMECORE_CASECONTAINERBASE_METHOD_2_E1D9799A41C604C6_OFFSET UNITYSDK_OFFSET(0x1B70B0C0)
#define RPG_GAMECORE_CASECONTAINERBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B70B3F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CaseContainerBase_TypeDefinitionIndex = 22915;
