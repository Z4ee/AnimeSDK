...
#define RPG_GAMECORE_CASECONTAINERBASE_METHOD_2_E1D9799A41C604C6_1_OFFSET UNITYSDK_OFFSET(0x17054020)
#define RPG_GAMECORE_CASECONTAINERBASE_METHOD_2_E1D9799A41C604C6_OFFSET UNITYSDK_OFFSET(0x17053D80)
#define RPG_GAMECORE_CASECONTAINERBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x170540E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CaseContainerBase_TypeDefinitionIndex = 22042;
