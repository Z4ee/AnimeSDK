...
#define RPG_GAMECORE_ROGUEMODIFIERLEVELUPROOMCARDONATTRIBUTEAPPENDCONFIG_METHOD_3_86AEFE0E5DD0CD0E_OFFSET UNITYSDK_OFFSET(0x17632B40)
#define RPG_GAMECORE_ROGUEMODIFIERLEVELUPROOMCARDONATTRIBUTEAPPENDCONFIG_METHOD_3_C7D37EEC42AD0387_OFFSET UNITYSDK_OFFSET(0x17632C10)
#define RPG_GAMECORE_ROGUEMODIFIERLEVELUPROOMCARDONATTRIBUTEAPPENDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17632BC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierLevelUpRoomCardOnAttributeAppendConfig_TypeDefinitionIndex = 16397;
