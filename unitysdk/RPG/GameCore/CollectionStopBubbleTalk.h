...
#define RPG_GAMECORE_COLLECTIONSTOPBUBBLETALK_METHOD_3_8D9F529A7ED90C99_OFFSET UNITYSDK_OFFSET(0x1BC216C0)
#define RPG_GAMECORE_COLLECTIONSTOPBUBBLETALK_METHOD_3_E3246CD1F7593C22_OFFSET UNITYSDK_OFFSET(0x1BC21700)
#define RPG_GAMECORE_COLLECTIONSTOPBUBBLETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC216F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CollectionStopBubbleTalk_TypeDefinitionIndex = 19627;
