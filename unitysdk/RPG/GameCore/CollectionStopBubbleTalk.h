...
#define RPG_GAMECORE_COLLECTIONSTOPBUBBLETALK_METHOD_3_8D9F529A7ED90C99_OFFSET UNITYSDK_OFFSET(0x1D9A57F0)
#define RPG_GAMECORE_COLLECTIONSTOPBUBBLETALK_METHOD_3_E3246CD1F7593C22_OFFSET UNITYSDK_OFFSET(0x1D9A5830)
#define RPG_GAMECORE_COLLECTIONSTOPBUBBLETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D9A5820)
