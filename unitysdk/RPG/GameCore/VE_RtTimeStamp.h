...
#define RPG_GAMECORE_VE_RTTIMESTAMP_METHOD_3_2CD6EE2FDCDC4582_OFFSET UNITYSDK_OFFSET(0x1B894830)
#define RPG_GAMECORE_VE_RTTIMESTAMP_METHOD_3_9552EA1BB2F6AA20_OFFSET UNITYSDK_OFFSET(0x1B894A90)
#define RPG_GAMECORE_VE_RTTIMESTAMP_METHOD_3_ACA65C7FB85D2921_OFFSET UNITYSDK_OFFSET(0x1B894790)
#define RPG_GAMECORE_VE_RTTIMESTAMP_METHOD_3_C05CE16DE156F3E1_OFFSET UNITYSDK_OFFSET(0x1B894A30)
#define RPG_GAMECORE_VE_RTTIMESTAMP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8947F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VE_RtTimeStamp_TypeDefinitionIndex = 23419;
