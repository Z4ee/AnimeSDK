...
#define RPG_GAMECORE_HIPPLENINCIDENTOPTIONCONFIG_METHOD_2_A013EE34B62CF2D5_OFFSET UNITYSDK_OFFSET(0x19835A10)
#define RPG_GAMECORE_HIPPLENINCIDENTOPTIONCONFIG_METHOD_2_B9D536A79D8CFEAD_OFFSET UNITYSDK_OFFSET(0x19835CF0)
#define RPG_GAMECORE_HIPPLENINCIDENTOPTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x198354D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HipplenIncidentOptionConfig_TypeDefinitionIndex = 15967;
