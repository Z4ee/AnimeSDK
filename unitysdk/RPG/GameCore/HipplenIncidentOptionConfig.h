...
#define RPG_GAMECORE_HIPPLENINCIDENTOPTIONCONFIG_METHOD_2_A013EE34B62CF2D5_OFFSET UNITYSDK_OFFSET(0x1B688270)
#define RPG_GAMECORE_HIPPLENINCIDENTOPTIONCONFIG_METHOD_2_B9D536A79D8CFEAD_OFFSET UNITYSDK_OFFSET(0x1B688550)
#define RPG_GAMECORE_HIPPLENINCIDENTOPTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B687D30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HipplenIncidentOptionConfig_TypeDefinitionIndex = 16149;
