...
#define RPG_GAMECORE_TRIGGERDRINKMAKERBARTENDINMAINMISSION_METHOD_3_1ACED399C7B30420_OFFSET UNITYSDK_OFFSET(0x1B048840)
#define RPG_GAMECORE_TRIGGERDRINKMAKERBARTENDINMAINMISSION_METHOD_3_85204C638CC58F03_OFFSET UNITYSDK_OFFSET(0x1B048880)
#define RPG_GAMECORE_TRIGGERDRINKMAKERBARTENDINMAINMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B048870)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerDrinkMakerBartendInMainMission_TypeDefinitionIndex = 20913;
