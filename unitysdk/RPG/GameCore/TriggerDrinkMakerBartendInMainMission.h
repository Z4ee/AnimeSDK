...
#define RPG_GAMECORE_TRIGGERDRINKMAKERBARTENDINMAINMISSION_METHOD_3_85204C638CC58F03_OFFSET UNITYSDK_OFFSET(0x178C1CF0)
#define RPG_GAMECORE_TRIGGERDRINKMAKERBARTENDINMAINMISSION_METHOD_3_D1C07D0F7E841CC5_OFFSET UNITYSDK_OFFSET(0x178C1C70)
#define RPG_GAMECORE_TRIGGERDRINKMAKERBARTENDINMAINMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x178C1CC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerDrinkMakerBartendInMainMission_TypeDefinitionIndex = 19882;
