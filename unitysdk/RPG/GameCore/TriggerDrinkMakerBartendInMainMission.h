...
#define RPG_GAMECORE_TRIGGERDRINKMAKERBARTENDINMAINMISSION_METHOD_3_85204C638CC58F03_OFFSET UNITYSDK_OFFSET(0x19E0AF30)
#define RPG_GAMECORE_TRIGGERDRINKMAKERBARTENDINMAINMISSION_METHOD_3_D1C07D0F7E841CC5_OFFSET UNITYSDK_OFFSET(0x19E0AEB0)
#define RPG_GAMECORE_TRIGGERDRINKMAKERBARTENDINMAINMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x19E0AF00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerDrinkMakerBartendInMainMission_TypeDefinitionIndex = 20498;
