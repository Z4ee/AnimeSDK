...
#define RPG_GAMECORE_BYISBODYPARTCLIENTONLY_METHOD_5_6FCCA23DB96CDE5E_OFFSET UNITYSDK_OFFSET(0x1702A220)
#define RPG_GAMECORE_BYISBODYPARTCLIENTONLY_METHOD_5_DF3C78F986992AF0_OFFSET UNITYSDK_OFFSET(0x1702A3A0)
#define RPG_GAMECORE_BYISBODYPARTCLIENTONLY__CTOR_OFFSET UNITYSDK_OFFSET(0x1702A1D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsBodyPartClientOnly_TypeDefinitionIndex = 21547;
