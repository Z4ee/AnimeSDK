...
#define RPG_GAMECORE_OVERRIDEFINISHACTIONAUTOTRANSFER_METHOD_3_465E036BB405B90C_OFFSET UNITYSDK_OFFSET(0x199DD800)
#define RPG_GAMECORE_OVERRIDEFINISHACTIONAUTOTRANSFER_METHOD_3_CAFB93ED15CD6E3C_OFFSET UNITYSDK_OFFSET(0x199DD880)
#define RPG_GAMECORE_OVERRIDEFINISHACTIONAUTOTRANSFER__CTOR_OFFSET UNITYSDK_OFFSET(0x199DD850)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OverrideFinishActionAutoTransfer_TypeDefinitionIndex = 19218;
