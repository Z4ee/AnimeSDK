...
#define RPG_GAMECORE_OVERRIDEFINISHACTIONAUTOTRANSFER_METHOD_3_B5BFD1C05BB53B57_OFFSET UNITYSDK_OFFSET(0x1BB07160)
#define RPG_GAMECORE_OVERRIDEFINISHACTIONAUTOTRANSFER_METHOD_3_CAFB93ED15CD6E3C_OFFSET UNITYSDK_OFFSET(0x1BB071A0)
#define RPG_GAMECORE_OVERRIDEFINISHACTIONAUTOTRANSFER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB07190)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OverrideFinishActionAutoTransfer_TypeDefinitionIndex = 19574;
