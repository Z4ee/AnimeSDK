...
#define RPG_GAMECORE_STREAMINGRATIOVOLUMEDATA_METHOD_4_787A36F7661802AA_OFFSET UNITYSDK_OFFSET(0x17782610)
#define RPG_GAMECORE_STREAMINGRATIOVOLUMEDATA_METHOD_4_97326DA6C61AF005_OFFSET UNITYSDK_OFFSET(0x17781CE0)
#define RPG_GAMECORE_STREAMINGRATIOVOLUMEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17782600)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StreamingRatioVolumeData_TypeDefinitionIndex = 17535;
