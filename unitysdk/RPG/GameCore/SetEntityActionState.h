...
#define RPG_GAMECORE_SETENTITYACTIONSTATE_METHOD_3_21493D3F5D2F5796_OFFSET UNITYSDK_OFFSET(0x1D4FBE60)
#define RPG_GAMECORE_SETENTITYACTIONSTATE_METHOD_3_F10DAA8D1183F1DF_OFFSET UNITYSDK_OFFSET(0x1D4FBE10)
#define RPG_GAMECORE_SETENTITYACTIONSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4FBE50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetEntityActionState_TypeDefinitionIndex = 22400;
