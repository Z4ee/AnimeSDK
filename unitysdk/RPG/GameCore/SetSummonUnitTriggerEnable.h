...
#define RPG_GAMECORE_SETSUMMONUNITTRIGGERENABLE_METHOD_3_639D179EE8925F37_OFFSET UNITYSDK_OFFSET(0x1C609BF0)
#define RPG_GAMECORE_SETSUMMONUNITTRIGGERENABLE_METHOD_3_CE8D414AD6B0F466_OFFSET UNITYSDK_OFFSET(0x1C609BB0)
#define RPG_GAMECORE_SETSUMMONUNITTRIGGERENABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C609BE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetSummonUnitTriggerEnable_TypeDefinitionIndex = 19386;
