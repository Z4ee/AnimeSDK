...
#define RPG_GAMECORE_DICECOMBATV2SINGLEDIALOGPERFORMANCETRIGGERCONDITION_BOSSCHANGEPHASE_METHOD_3_5A6DB1817D0A4B20_OFFSET UNITYSDK_OFFSET(0x1C11CBD0)
#define RPG_GAMECORE_DICECOMBATV2SINGLEDIALOGPERFORMANCETRIGGERCONDITION_BOSSCHANGEPHASE_METHOD_3_61B7F5FD6B22396C_OFFSET UNITYSDK_OFFSET(0x1C11CEF0)
#define RPG_GAMECORE_DICECOMBATV2SINGLEDIALOGPERFORMANCETRIGGERCONDITION_BOSSCHANGEPHASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C11CBC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatV2SingleDialogPerformanceTriggerCondition_BossChangePhase_TypeDefinitionIndex = 15572;
