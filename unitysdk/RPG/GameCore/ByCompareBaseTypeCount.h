...
#define RPG_GAMECORE_BYCOMPAREBASETYPECOUNT_METHOD_4_4E1DC7F86DB0C326_OFFSET UNITYSDK_OFFSET(0x19CD2A20)
#define RPG_GAMECORE_BYCOMPAREBASETYPECOUNT_METHOD_4_5302C01C8526E668_OFFSET UNITYSDK_OFFSET(0x19CD29E0)
#define RPG_GAMECORE_BYCOMPAREBASETYPECOUNT_METHOD_4_F095EC5EC6008739_OFFSET UNITYSDK_OFFSET(0x19CD2720)
#define RPG_GAMECORE_BYCOMPAREBASETYPECOUNT_METHOD_4_F7669BE828D95386_OFFSET UNITYSDK_OFFSET(0x19CD2770)
#define RPG_GAMECORE_BYCOMPAREBASETYPECOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x19CD2760)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareBaseTypeCount_TypeDefinitionIndex = 22742;
