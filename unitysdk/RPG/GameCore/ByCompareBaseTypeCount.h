...
#define RPG_GAMECORE_BYCOMPAREBASETYPECOUNT_METHOD_4_F6B2E257D0EBDEEA_OFFSET UNITYSDK_OFFSET(0x18727450)
#define RPG_GAMECORE_BYCOMPAREBASETYPECOUNT_METHOD_4_F7669BE828D95386_OFFSET UNITYSDK_OFFSET(0x18727530)
#define RPG_GAMECORE_BYCOMPAREBASETYPECOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x187274D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareBaseTypeCount_TypeDefinitionIndex = 22563;
