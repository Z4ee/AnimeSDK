...
#define RPG_GAMECORE_TRIGGERWAVEEFFECT_METHOD_3_06FF1423D1FAE3CE_OFFSET UNITYSDK_OFFSET(0x178D0BE0)
#define RPG_GAMECORE_TRIGGERWAVEEFFECT_METHOD_3_22C1E13076A1CC1F_OFFSET UNITYSDK_OFFSET(0x178D0B60)
#define RPG_GAMECORE_TRIGGERWAVEEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x178D0BB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerWaveEffect_TypeDefinitionIndex = 21661;
