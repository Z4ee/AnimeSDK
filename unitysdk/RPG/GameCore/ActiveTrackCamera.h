...
#define RPG_GAMECORE_ACTIVETRACKCAMERA_METHOD_3_C5B6DE6D65EEB69F_OFFSET UNITYSDK_OFFSET(0x1C9ECB10)
#define RPG_GAMECORE_ACTIVETRACKCAMERA_METHOD_3_D213521C70FAEE77_OFFSET UNITYSDK_OFFSET(0x1C9ECA80)
#define RPG_GAMECORE_ACTIVETRACKCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9ECAE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActiveTrackCamera_TypeDefinitionIndex = 20595;
