...
#define RPG_GAMECORE_GENERICSWITCHCASE_METHOD_3_21ABD1DF4508A05B_OFFSET UNITYSDK_OFFSET(0x1D143CC0)
#define RPG_GAMECORE_GENERICSWITCHCASE_METHOD_3_2D3130CBABD03FE6_OFFSET UNITYSDK_OFFSET(0x1D143C80)
#define RPG_GAMECORE_GENERICSWITCHCASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D143CB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GenericSwitchCase_TypeDefinitionIndex = 23496;
