...
#define RPG_GAMECORE_GENERICSWITCHCASE_METHOD_3_951C26F30F462CFD_OFFSET UNITYSDK_OFFSET(0x17247980)
#define RPG_GAMECORE_GENERICSWITCHCASE_METHOD_3_F032630D26A58FEA_OFFSET UNITYSDK_OFFSET(0x17247900)
#define RPG_GAMECORE_GENERICSWITCHCASE__CTOR_OFFSET UNITYSDK_OFFSET(0x17247950)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GenericSwitchCase_TypeDefinitionIndex = 22043;
