...
#define RPG_GAMECORE_GENERICSWITCHCASE_METHOD_3_21ABD1DF4508A05B_OFFSET UNITYSDK_OFFSET(0x197CF940)
#define RPG_GAMECORE_GENERICSWITCHCASE_METHOD_3_DC93D4AF9EF008A4_OFFSET UNITYSDK_OFFSET(0x197CF8C0)
#define RPG_GAMECORE_GENERICSWITCHCASE__CTOR_OFFSET UNITYSDK_OFFSET(0x197CF910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GenericSwitchCase_TypeDefinitionIndex = 22466;
	...
	public:
		...
		static ::System::Void Method_3_DC93D4AF9EF008A4(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::GenericSwitchCase*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::GenericSwitchCase*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_GENERICSWITCHCASE_METHOD_3_DC93D4AF9EF008A4_OFFSET))(a1, a2);
		}
