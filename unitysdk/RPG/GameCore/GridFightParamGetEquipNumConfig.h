...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETEQUIPNUMCONFIG_METHOD_6_A027751BE29FAD1B_OFFSET UNITYSDK_OFFSET(0x189C3B10)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETEQUIPNUMCONFIG_METHOD_6_C2257A8EBA1A0D35_OFFSET UNITYSDK_OFFSET(0x189C3860)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETEQUIPNUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189C39E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightParamGetEquipNumConfig_TypeDefinitionIndex = 18535;
