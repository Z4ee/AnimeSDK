...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETEQUIPNUMCONFIG_METHOD_6_25B3560A8146BFB7_OFFSET UNITYSDK_OFFSET(0x1D15D280)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETEQUIPNUMCONFIG_METHOD_6_A027751BE29FAD1B_OFFSET UNITYSDK_OFFSET(0x1D15D2D0)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETEQUIPNUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D15D2C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightParamGetEquipNumConfig_TypeDefinitionIndex = 19293;
