...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERRANDOMALLEQUIPSCONFIG_METHOD_3_03CB29F0F8B3575A_OFFSET UNITYSDK_OFFSET(0x189BE350)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERRANDOMALLEQUIPSCONFIG_METHOD_3_41074B0A1A749513_OFFSET UNITYSDK_OFFSET(0x189BE420)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERRANDOMALLEQUIPSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189BE3D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierRandomAllEquipsConfig_TypeDefinitionIndex = 18456;
