...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERRANDOMALLEQUIPSCONFIG_METHOD_3_03CB29F0F8B3575A_OFFSET UNITYSDK_OFFSET(0x197F30F0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERRANDOMALLEQUIPSCONFIG_METHOD_3_41074B0A1A749513_OFFSET UNITYSDK_OFFSET(0x197EE4F0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERRANDOMALLEQUIPSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197EE4A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierRandomAllEquipsConfig_TypeDefinitionIndex = 18428;
