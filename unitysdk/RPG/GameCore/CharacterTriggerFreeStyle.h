...
#define RPG_GAMECORE_CHARACTERTRIGGERFREESTYLE_METHOD_3_868F6DDBBF7DB280_OFFSET UNITYSDK_OFFSET(0x17073B60)
#define RPG_GAMECORE_CHARACTERTRIGGERFREESTYLE_METHOD_3_AA045AC38F2454B5_OFFSET UNITYSDK_OFFSET(0x17073AC0)
#define RPG_GAMECORE_CHARACTERTRIGGERFREESTYLE_METHOD_3_CE18697B63E52504_OFFSET UNITYSDK_OFFSET(0x17073FD0)
#define RPG_GAMECORE_CHARACTERTRIGGERFREESTYLE__CTOR_OFFSET UNITYSDK_OFFSET(0x17073B20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterTriggerFreeStyle_TypeDefinitionIndex = 20077;
