...
#define RPG_GAMECORE_CHARACTERTRIGGERFREESTYLE_METHOD_3_868F6DDBBF7DB280_OFFSET UNITYSDK_OFFSET(0x196164E0)
#define RPG_GAMECORE_CHARACTERTRIGGERFREESTYLE_METHOD_3_AA045AC38F2454B5_OFFSET UNITYSDK_OFFSET(0x19616440)
#define RPG_GAMECORE_CHARACTERTRIGGERFREESTYLE_METHOD_3_CE18697B63E52504_OFFSET UNITYSDK_OFFSET(0x19616950)
#define RPG_GAMECORE_CHARACTERTRIGGERFREESTYLE__CTOR_OFFSET UNITYSDK_OFFSET(0x196164A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterTriggerFreeStyle_TypeDefinitionIndex = 20686;
