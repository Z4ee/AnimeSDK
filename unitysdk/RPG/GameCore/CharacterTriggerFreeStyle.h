...
#define RPG_GAMECORE_CHARACTERTRIGGERFREESTYLE_METHOD_3_76F49ECD1EAC3A56_OFFSET UNITYSDK_OFFSET(0x1B72BF20)
#define RPG_GAMECORE_CHARACTERTRIGGERFREESTYLE_METHOD_3_868F6DDBBF7DB280_OFFSET UNITYSDK_OFFSET(0x1B72BF70)
#define RPG_GAMECORE_CHARACTERTRIGGERFREESTYLE_METHOD_3_CE18697B63E52504_OFFSET UNITYSDK_OFFSET(0x1B72C3E0)
#define RPG_GAMECORE_CHARACTERTRIGGERFREESTYLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B72BF60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterTriggerFreeStyle_TypeDefinitionIndex = 21101;
