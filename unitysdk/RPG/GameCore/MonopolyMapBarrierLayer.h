...
#define RPG_GAMECORE_MONOPOLYMAPBARRIERLAYER_METHOD_3_CC7B17EEC39912A0_OFFSET UNITYSDK_OFFSET(0x1743CD60)
#define RPG_GAMECORE_MONOPOLYMAPBARRIERLAYER_METHOD_3_E103A8A2F0FB2A12_OFFSET UNITYSDK_OFFSET(0x1743CDC0)
#define RPG_GAMECORE_MONOPOLYMAPBARRIERLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1743CDB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonopolyMapBarrierLayer_TypeDefinitionIndex = 14862;
