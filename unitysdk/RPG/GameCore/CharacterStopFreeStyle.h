...
#define RPG_GAMECORE_CHARACTERSTOPFREESTYLE_METHOD_3_3087A48B3C2CD3F5_OFFSET UNITYSDK_OFFSET(0x170734A0)
#define RPG_GAMECORE_CHARACTERSTOPFREESTYLE_METHOD_3_CE18697B63E52504_OFFSET UNITYSDK_OFFSET(0x170736E0)
#define RPG_GAMECORE_CHARACTERSTOPFREESTYLE_METHOD_3_D41DDEED6565FA0B_OFFSET UNITYSDK_OFFSET(0x17073410)
#define RPG_GAMECORE_CHARACTERSTOPFREESTYLE__CTOR_OFFSET UNITYSDK_OFFSET(0x17073470)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterStopFreeStyle_TypeDefinitionIndex = 20078;
