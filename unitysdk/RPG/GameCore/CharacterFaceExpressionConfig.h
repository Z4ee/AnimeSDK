...
#define RPG_GAMECORE_CHARACTERFACEEXPRESSIONCONFIG_METHOD_2_AC854EA64A62D4D2_OFFSET UNITYSDK_OFFSET(0x1CF964E0)
#define RPG_GAMECORE_CHARACTERFACEEXPRESSIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF967F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterFaceExpressionConfig_TypeDefinitionIndex = 17254;
