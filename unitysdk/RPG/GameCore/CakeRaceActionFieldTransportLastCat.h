...
#define RPG_GAMECORE_CAKERACEACTIONFIELDTRANSPORTLASTCAT_METHOD_3_1174D4B1EF443029_OFFSET UNITYSDK_OFFSET(0x1B2CB510)
#define RPG_GAMECORE_CAKERACEACTIONFIELDTRANSPORTLASTCAT_METHOD_3_70436C3DA3EF5BDA_OFFSET UNITYSDK_OFFSET(0x1B2CB4D0)
#define RPG_GAMECORE_CAKERACEACTIONFIELDTRANSPORTLASTCAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2CB500)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionFieldTransportLastCat_TypeDefinitionIndex = 17608;
