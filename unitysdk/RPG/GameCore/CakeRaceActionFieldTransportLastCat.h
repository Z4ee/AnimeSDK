...
#define RPG_GAMECORE_CAKERACEACTIONFIELDTRANSPORTLASTCAT_METHOD_3_1174D4B1EF443029_OFFSET UNITYSDK_OFFSET(0x1CDD3C90)
#define RPG_GAMECORE_CAKERACEACTIONFIELDTRANSPORTLASTCAT_METHOD_3_70436C3DA3EF5BDA_OFFSET UNITYSDK_OFFSET(0x1CDD3C50)
#define RPG_GAMECORE_CAKERACEACTIONFIELDTRANSPORTLASTCAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDD3C80)
