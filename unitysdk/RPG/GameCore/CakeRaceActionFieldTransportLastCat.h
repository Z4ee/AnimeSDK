...
#define RPG_GAMECORE_CAKERACEACTIONFIELDTRANSPORTLASTCAT_METHOD_3_1174D4B1EF443029_OFFSET UNITYSDK_OFFSET(0x18769E70)
#define RPG_GAMECORE_CAKERACEACTIONFIELDTRANSPORTLASTCAT_METHOD_3_F989A063CF5F633A_OFFSET UNITYSDK_OFFSET(0x1876BD90)
#define RPG_GAMECORE_CAKERACEACTIONFIELDTRANSPORTLASTCAT__CTOR_OFFSET UNITYSDK_OFFSET(0x18769E50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionFieldTransportLastCat_TypeDefinitionIndex = 17432;
