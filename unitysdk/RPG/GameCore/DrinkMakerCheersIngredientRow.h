...
#define RPG_GAMECORE_DRINKMAKERCHEERSINGREDIENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D03F980)
#define RPG_GAMECORE_DRINKMAKERCHEERSINGREDIENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D03FD40)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID IngredientDesc; // 0x50
