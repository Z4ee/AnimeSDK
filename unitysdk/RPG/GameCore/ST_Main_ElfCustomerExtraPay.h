...
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMEREXTRAPAY_METHOD_4_02CF18D4E70413DD_OFFSET UNITYSDK_OFFSET(0x18DE5DB0)
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMEREXTRAPAY_METHOD_4_B59D28964C6EB2F2_OFFSET UNITYSDK_OFFSET(0x18DEF590)
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMEREXTRAPAY__CTOR_OFFSET UNITYSDK_OFFSET(0x18DE5D60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_ElfCustomerExtraPay_TypeDefinitionIndex = 20393;
