...
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMEREXTRAPAY_METHOD_4_007F99C8B80AEE20_OFFSET UNITYSDK_OFFSET(0x1B781630)
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMEREXTRAPAY_METHOD_4_02CF18D4E70413DD_OFFSET UNITYSDK_OFFSET(0x1B781700)
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMEREXTRAPAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7816F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_ElfCustomerExtraPay_TypeDefinitionIndex = 20732;
