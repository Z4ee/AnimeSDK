...
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMEREXTRAPAY_METHOD_4_02CF18D4E70413DD_OFFSET UNITYSDK_OFFSET(0x176823B0)
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMEREXTRAPAY_METHOD_4_B59D28964C6EB2F2_OFFSET UNITYSDK_OFFSET(0x176964B0)
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMEREXTRAPAY__CTOR_OFFSET UNITYSDK_OFFSET(0x17682360)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_ElfCustomerExtraPay_TypeDefinitionIndex = 19712;
