...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_ATTACKEFFECT_IGNOREDEFENDPOINT_METHOD_3_801384CF7852BC53_OFFSET UNITYSDK_OFFSET(0x1887BC60)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_ATTACKEFFECT_IGNOREDEFENDPOINT_METHOD_3_F4D2952B3E22E36B_OFFSET UNITYSDK_OFFSET(0x18875E60)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_ATTACKEFFECT_IGNOREDEFENDPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x18875E10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_AttackEffect_IgnoreDefendPoint_TypeDefinitionIndex = 15209;
