...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_ATTACKEFFECT_IGNOREDEFENDPOINT_METHOD_3_801384CF7852BC53_OFFSET UNITYSDK_OFFSET(0x196B8AB0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_ATTACKEFFECT_IGNOREDEFENDPOINT_METHOD_3_F4D2952B3E22E36B_OFFSET UNITYSDK_OFFSET(0x196B2260)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_ATTACKEFFECT_IGNOREDEFENDPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x196B2210)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_AttackEffect_IgnoreDefendPoint_TypeDefinitionIndex = 15269;
