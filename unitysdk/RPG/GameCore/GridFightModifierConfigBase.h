...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERCONFIGBASE_METHOD_2_7196B4677E4B9452_OFFSET UNITYSDK_OFFSET(0x1EE6CDA0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERCONFIGBASE_METHOD_2_80DC45303115E084_OFFSET UNITYSDK_OFFSET(0x1EE6CE00)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERCONFIGBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EE6BEA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierConfigBase_TypeDefinitionIndex = 19109;
