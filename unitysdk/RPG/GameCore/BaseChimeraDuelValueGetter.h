...
#define RPG_GAMECORE_BASECHIMERADUELVALUEGETTER_METHOD_2_1640675461B59552_OFFSET UNITYSDK_OFFSET(0x16FC9780)
#define RPG_GAMECORE_BASECHIMERADUELVALUEGETTER_METHOD_2_CD5713756667F409_OFFSET UNITYSDK_OFFSET(0x16FCA030)
#define RPG_GAMECORE_BASECHIMERADUELVALUEGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x16FCA090)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BaseChimeraDuelValueGetter_TypeDefinitionIndex = 14683;
