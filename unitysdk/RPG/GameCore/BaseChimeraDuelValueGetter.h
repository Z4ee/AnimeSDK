...
#define RPG_GAMECORE_BASECHIMERADUELVALUEGETTER_METHOD_2_1640675461B59552_OFFSET UNITYSDK_OFFSET(0x194BEE20)
#define RPG_GAMECORE_BASECHIMERADUELVALUEGETTER_METHOD_2_CD5713756667F409_OFFSET UNITYSDK_OFFSET(0x194BF510)
#define RPG_GAMECORE_BASECHIMERADUELVALUEGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x194BF570)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BaseChimeraDuelValueGetter_TypeDefinitionIndex = 15215;
