...
#define RPG_GAMECORE_BASECHIMERADUELVALUEGETTER_METHOD_2_1640675461B59552_OFFSET UNITYSDK_OFFSET(0x1A3DF850)
#define RPG_GAMECORE_BASECHIMERADUELVALUEGETTER_METHOD_2_CD5713756667F409_OFFSET UNITYSDK_OFFSET(0x1A3DFF40)
#define RPG_GAMECORE_BASECHIMERADUELVALUEGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3DFFA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BaseChimeraDuelValueGetter_TypeDefinitionIndex = 15379;
