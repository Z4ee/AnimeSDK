...
#define RPG_GAMECORE_SHOWFRAMECAPTUREUI_METHOD_3_831EA25C7B8281DF_OFFSET UNITYSDK_OFFSET(0x18E5E860)
#define RPG_GAMECORE_SHOWFRAMECAPTUREUI_METHOD_3_C3CB22651D046549_OFFSET UNITYSDK_OFFSET(0x18E5E900)
#define RPG_GAMECORE_SHOWFRAMECAPTUREUI__CTOR_OFFSET UNITYSDK_OFFSET(0x18E5E8C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowFrameCaptureUI_TypeDefinitionIndex = 22187;
