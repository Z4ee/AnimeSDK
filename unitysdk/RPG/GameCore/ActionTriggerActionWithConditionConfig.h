...
#define RPG_GAMECORE_ACTIONTRIGGERACTIONWITHCONDITIONCONFIG_METHOD_4_55830174BA5E80BC_OFFSET UNITYSDK_OFFSET(0x16E9E940)
#define RPG_GAMECORE_ACTIONTRIGGERACTIONWITHCONDITIONCONFIG_METHOD_4_B7A5B6BEA7B0CE5C_OFFSET UNITYSDK_OFFSET(0x16E9EA20)
#define RPG_GAMECORE_ACTIONTRIGGERACTIONWITHCONDITIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16E9E9D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActionTriggerActionWithConditionConfig_TypeDefinitionIndex = 15614;
