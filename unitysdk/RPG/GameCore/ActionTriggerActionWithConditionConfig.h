...
#define RPG_GAMECORE_ACTIONTRIGGERACTIONWITHCONDITIONCONFIG_METHOD_4_13EF8D1570697F2D_OFFSET UNITYSDK_OFFSET(0x1CD74BE0)
#define RPG_GAMECORE_ACTIONTRIGGERACTIONWITHCONDITIONCONFIG_METHOD_4_B7A5B6BEA7B0CE5C_OFFSET UNITYSDK_OFFSET(0x1CD74C40)
#define RPG_GAMECORE_ACTIONTRIGGERACTIONWITHCONDITIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD74C30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActionTriggerActionWithConditionConfig_TypeDefinitionIndex = 16856;
