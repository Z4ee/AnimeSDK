...
#define RPG_GAMECORE_FEVERTIMEINFOCHANGEPARAM_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xE643A80)
#define RPG_GAMECORE_FEVERTIMEINFOCHANGEPARAM_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xE643A30)
#define RPG_GAMECORE_FEVERTIMEINFOCHANGEPARAM_GET_FILLAMOUNT_OFFSET UNITYSDK_OFFSET(0xE643AD0)
#define RPG_GAMECORE_FEVERTIMEINFOCHANGEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xE643BD0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Boolean IsLimitReached; // 0x20
		::RPG::GameCore::FixPoint MaxProgress; // 0x28
		::RPG::GameCore::FixPoint ExtraCount; // 0x30
