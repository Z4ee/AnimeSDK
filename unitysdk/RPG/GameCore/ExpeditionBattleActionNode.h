...
#define RPG_GAMECORE_EXPEDITIONBATTLEACTIONNODE_METHOD_3_2B819C845B1C5B40_OFFSET UNITYSDK_OFFSET(0x1D0801C0)
#define RPG_GAMECORE_EXPEDITIONBATTLEACTIONNODE_METHOD_3_34F49882494167CC_OFFSET UNITYSDK_OFFSET(0x1D080290)
#define RPG_GAMECORE_EXPEDITIONBATTLEACTIONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D080280)
