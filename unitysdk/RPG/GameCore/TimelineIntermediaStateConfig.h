...
#define RPG_GAMECORE_TIMELINEINTERMEDIASTATECONFIG_METHOD_2_C936433390528A9A_OFFSET UNITYSDK_OFFSET(0x178A0750)
#define RPG_GAMECORE_TIMELINEINTERMEDIASTATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x178A0880)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TimelineIntermediaStateConfig_TypeDefinitionIndex = 15215;
