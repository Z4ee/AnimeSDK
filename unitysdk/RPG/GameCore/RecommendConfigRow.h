...
#define RPG_GAMECORE_RECOMMENDCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18C91BD0)
#define RPG_GAMECORE_RECOMMENDCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18C92460)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RecommendConfigRow_TypeDefinitionIndex = 13817;
	...
	public:
		...
		::System::UInt32 OrderAfterSell; // 0x28
		::System::UInt32 ID; // 0x2C
		::System::UInt32 Schedule; // 0x30
