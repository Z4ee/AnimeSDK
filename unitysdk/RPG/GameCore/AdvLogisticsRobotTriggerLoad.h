...
#define RPG_GAMECORE_ADVLOGISTICSROBOTTRIGGERLOAD_METHOD_3_AF0092D266DCC1AB_OFFSET UNITYSDK_OFFSET(0x1BE209D0)
#define RPG_GAMECORE_ADVLOGISTICSROBOTTRIGGERLOAD_METHOD_3_BD89B62EE2DA7C2E_OFFSET UNITYSDK_OFFSET(0x1BE20900)
#define RPG_GAMECORE_ADVLOGISTICSROBOTTRIGGERLOAD__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE209C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvLogisticsRobotTriggerLoad_TypeDefinitionIndex = 20401;
