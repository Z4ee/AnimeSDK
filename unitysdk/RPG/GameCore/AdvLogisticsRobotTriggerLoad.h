...
#define RPG_GAMECORE_ADVLOGISTICSROBOTTRIGGERLOAD_METHOD_3_AF0092D266DCC1AB_OFFSET UNITYSDK_OFFSET(0x18655180)
#define RPG_GAMECORE_ADVLOGISTICSROBOTTRIGGERLOAD_METHOD_3_BDD537DECE9CD737_OFFSET UNITYSDK_OFFSET(0x18655070)
#define RPG_GAMECORE_ADVLOGISTICSROBOTTRIGGERLOAD__CTOR_OFFSET UNITYSDK_OFFSET(0x18655150)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvLogisticsRobotTriggerLoad_TypeDefinitionIndex = 20172;
