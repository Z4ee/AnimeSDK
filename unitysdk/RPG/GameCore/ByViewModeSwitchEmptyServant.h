...
#define RPG_GAMECORE_BYVIEWMODESWITCHEMPTYSERVANT_METHOD_4_7325FC452131FD85_OFFSET UNITYSDK_OFFSET(0x1703F030)
#define RPG_GAMECORE_BYVIEWMODESWITCHEMPTYSERVANT_METHOD_4_900B5B20E4D94A5B_OFFSET UNITYSDK_OFFSET(0x1703F100)
#define RPG_GAMECORE_BYVIEWMODESWITCHEMPTYSERVANT__CTOR_OFFSET UNITYSDK_OFFSET(0x1703F0B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByViewModeSwitchEmptyServant_TypeDefinitionIndex = 21115;
