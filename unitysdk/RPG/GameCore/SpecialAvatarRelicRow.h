...
#define RPG_GAMECORE_SPECIALAVATARRELICROW_FROMBINARYWITHOUTNEW_OFFSET UNITYSDK_OFFSET(0x1B09FB50)
#define RPG_GAMECORE_SPECIALAVATARRELICROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B09FCA0)
#define RPG_GAMECORE_SPECIALAVATARRELICROW_FROMTABLEOFFSET_OFFSET UNITYSDK_OFFSET(0x1B09FE10)
#define RPG_GAMECORE_SPECIALAVATARRELICROW_RESET_OFFSET UNITYSDK_OFFSET(0x1B09FE70)
#define RPG_GAMECORE_SPECIALAVATARRELICROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B09FE00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SpecialAvatarRelicRow_TypeDefinitionIndex = 14529;

	class SpecialAvatarRelicRow : public ::System::Object
	{
	public:
		::System::String* Comment2; // 0x10
		::Il2CppArray<::Class_1_A88C3AAF0DD46F4C_3*>* RelicIDList; // 0x18
