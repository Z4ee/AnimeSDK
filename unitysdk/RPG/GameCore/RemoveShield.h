...
#define RPG_GAMECORE_REMOVESHIELD_METHOD_3_C433C03D0519ADA7_OFFSET UNITYSDK_OFFSET(0x1D017480)
#define RPG_GAMECORE_REMOVESHIELD_METHOD_3_CB156A6D15D78D10_OFFSET UNITYSDK_OFFSET(0x1D017440)
#define RPG_GAMECORE_REMOVESHIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x1D017470)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveShield_TypeDefinitionIndex = 22754;
