...
#define RPG_GAMECORE_MIPARAMETERCONFIGBASE_METHOD_3_68101C41E397F668_OFFSET UNITYSDK_OFFSET(0x1D1A3CE0)
#define RPG_GAMECORE_MIPARAMETERCONFIGBASE_METHOD_3_CBC634FC429CFFE5_OFFSET UNITYSDK_OFFSET(0x1D1A3C80)
#define RPG_GAMECORE_MIPARAMETERCONFIGBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1A3D40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MiParameterConfigBase_TypeDefinitionIndex = 16877;
