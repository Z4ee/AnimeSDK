...
#define RPG_GAMECORE_SETCHARACTERPARTSVISIBILITY_METHOD_3_3062B4CA3F173456_OFFSET UNITYSDK_OFFSET(0x1D4E6FC0)
#define RPG_GAMECORE_SETCHARACTERPARTSVISIBILITY_METHOD_3_7E06EEB8DB902A18_OFFSET UNITYSDK_OFFSET(0x1D4E6F70)
#define RPG_GAMECORE_SETCHARACTERPARTSVISIBILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4E6FB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetCharacterPartsVisibility_TypeDefinitionIndex = 22158;
