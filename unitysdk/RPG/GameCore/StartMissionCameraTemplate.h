...
#define RPG_GAMECORE_STARTMISSIONCAMERATEMPLATE_METHOD_3_4524C848BB6BF5FC_OFFSET UNITYSDK_OFFSET(0x17775250)
#define RPG_GAMECORE_STARTMISSIONCAMERATEMPLATE_METHOD_3_4F71963F42DE6EDB_OFFSET UNITYSDK_OFFSET(0x17775020)
#define RPG_GAMECORE_STARTMISSIONCAMERATEMPLATE__CTOR_OFFSET UNITYSDK_OFFSET(0x17775150)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StartMissionCameraTemplate_TypeDefinitionIndex = 22082;
