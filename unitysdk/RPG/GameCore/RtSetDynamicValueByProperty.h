...
#define RPG_GAMECORE_RTSETDYNAMICVALUEBYPROPERTY_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x18DD60A0)
#define RPG_GAMECORE_RTSETDYNAMICVALUEBYPROPERTY_METHOD_4_351FE7D0C9C2BA78_OFFSET UNITYSDK_OFFSET(0x18DD5EB0)
#define RPG_GAMECORE_RTSETDYNAMICVALUEBYPROPERTY_METHOD_4_D5940B1A0C0C3164_OFFSET UNITYSDK_OFFSET(0x18DD5DE0)
#define RPG_GAMECORE_RTSETDYNAMICVALUEBYPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x18DD5E60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtSetDynamicValueByProperty_TypeDefinitionIndex = 23215;
