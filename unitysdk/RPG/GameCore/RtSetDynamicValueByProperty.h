...
#define RPG_GAMECORE_RTSETDYNAMICVALUEBYPROPERTY_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1CCECF40)
#define RPG_GAMECORE_RTSETDYNAMICVALUEBYPROPERTY_METHOD_4_351FE7D0C9C2BA78_OFFSET UNITYSDK_OFFSET(0x1CCECD50)
#define RPG_GAMECORE_RTSETDYNAMICVALUEBYPROPERTY_METHOD_4_F60A11A9A50404D9_OFFSET UNITYSDK_OFFSET(0x1CCECD10)
#define RPG_GAMECORE_RTSETDYNAMICVALUEBYPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1CCECD40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtSetDynamicValueByProperty_TypeDefinitionIndex = 23936;
