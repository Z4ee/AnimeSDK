...
#define RPG_GAMECORE_TARGETFETCHABILITYGROUP_METHOD_4_53302C24C51CF703_OFFSET UNITYSDK_OFFSET(0x177B9EA0)
#define RPG_GAMECORE_TARGETFETCHABILITYGROUP_METHOD_4_85F0DD8309BB75B5_OFFSET UNITYSDK_OFFSET(0x177B9D90)
#define RPG_GAMECORE_TARGETFETCHABILITYGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x177B9E50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchAbilityGroup_TypeDefinitionIndex = 22188;
