...
#define RPG_GAMECORE_IVEC2_EQUALS_OFFSET UNITYSDK_OFFSET(0x22C9100)
#define RPG_GAMECORE_IVEC2_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x22C90F0)
#define RPG_GAMECORE_IVEC2_GET_DOWN_OFFSET UNITYSDK_OFFSET(0x19224530)
#define RPG_GAMECORE_IVEC2_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x22C8EB0)
#define RPG_GAMECORE_IVEC2_GET_LEFT_OFFSET UNITYSDK_OFFSET(0x19224540)
#define RPG_GAMECORE_IVEC2_GET_ONE_OFFSET UNITYSDK_OFFSET(0x19224510)
#define RPG_GAMECORE_IVEC2_GET_RIGHT_OFFSET UNITYSDK_OFFSET(0x19224550)
#define RPG_GAMECORE_IVEC2_GET_UP_OFFSET UNITYSDK_OFFSET(0x19224520)
#define RPG_GAMECORE_IVEC2_GET_ZERO_OFFSET UNITYSDK_OFFSET(0x19224500)
#define RPG_GAMECORE_IVEC2_METHOD_2_024C03B35BA7E8CB_1_OFFSET UNITYSDK_OFFSET(0x192244C0)
#define RPG_GAMECORE_IVEC2_METHOD_2_024C03B35BA7E8CB_OFFSET UNITYSDK_OFFSET(0x192244B0)
#define RPG_GAMECORE_IVEC2_METHOD_2_11C163D56F5D9DA9_1_OFFSET UNITYSDK_OFFSET(0x19224370)
#define RPG_GAMECORE_IVEC2_METHOD_2_11C163D56F5D9DA9_2_OFFSET UNITYSDK_OFFSET(0x192243E0)
#define RPG_GAMECORE_IVEC2_METHOD_2_11C163D56F5D9DA9_3_OFFSET UNITYSDK_OFFSET(0x19224400)
#define RPG_GAMECORE_IVEC2_METHOD_2_11C163D56F5D9DA9_OFFSET UNITYSDK_OFFSET(0x19224330)
#define RPG_GAMECORE_IVEC2_METHOD_2_3051A2902CE8D9BA_OFFSET UNITYSDK_OFFSET(0x192244D0)
#define RPG_GAMECORE_IVEC2_METHOD_2_3F8D159D821A0AF1_1_OFFSET UNITYSDK_OFFSET(0x19224460)
#define RPG_GAMECORE_IVEC2_METHOD_2_3F8D159D821A0AF1_2_OFFSET UNITYSDK_OFFSET(0x19224480)
#define RPG_GAMECORE_IVEC2_METHOD_2_3F8D159D821A0AF1_OFFSET UNITYSDK_OFFSET(0x19224440)
#define RPG_GAMECORE_IVEC2_METHOD_2_66B1445F39DF8265_1_OFFSET UNITYSDK_OFFSET(0x19224420)
#define RPG_GAMECORE_IVEC2_METHOD_2_66B1445F39DF8265_OFFSET UNITYSDK_OFFSET(0x192243B0)
#define RPG_GAMECORE_IVEC2_METHOD_2_970B895AF1841F3E_OFFSET UNITYSDK_OFFSET(0x73E20)
#define RPG_GAMECORE_IVEC2_METHOD_2_D0F004595ECA8F03_OFFSET UNITYSDK_OFFSET(0x192244E0)
#define RPG_GAMECORE_IVEC2_METHOD_2_F12688DACEC2651B_OFFSET UNITYSDK_OFFSET(0x22C9050)
#define RPG_GAMECORE_IVEC2_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x22C8F30)
#define RPG_GAMECORE_IVEC2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x22C8FB0)
#define RPG_GAMECORE_IVEC2__CCTOR_OFFSET UNITYSDK_OFFSET(0x19224560)
#define RPG_GAMECORE_IVEC2__CTOR_OFFSET UNITYSDK_OFFSET(0x73E20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int IVec2_TypeDefinitionIndex = 9059;

	struct alignas(4) IVec2
	{
		static ::RPG::GameCore::IVec2* StaticGet_downVector()
		{
			return (::RPG::GameCore::IVec2*)Il2CppClass::FromTypeDefinitionIndex(IVec2_TypeDefinitionIndex)->GetStaticField(0xE790);
		}
		static ::RPG::GameCore::IVec2* StaticGet_leftVector()
		{
			return (::RPG::GameCore::IVec2*)Il2CppClass::FromTypeDefinitionIndex(IVec2_TypeDefinitionIndex)->GetStaticField(0xE798);
		}
		static ::RPG::GameCore::IVec2* StaticGet_rightVector()
		{
			return (::RPG::GameCore::IVec2*)Il2CppClass::FromTypeDefinitionIndex(IVec2_TypeDefinitionIndex)->GetStaticField(0xE7A0);
		}
		static ::RPG::GameCore::IVec2* StaticGet_oneVector()
		{
			return (::RPG::GameCore::IVec2*)Il2CppClass::FromTypeDefinitionIndex(IVec2_TypeDefinitionIndex)->GetStaticField(0xE7A8);
		}
		static ::RPG::GameCore::IVec2* StaticGet_upVector()
		{
			return (::RPG::GameCore::IVec2*)Il2CppClass::FromTypeDefinitionIndex(IVec2_TypeDefinitionIndex)->GetStaticField(0xE7B0);
		}
		static ::RPG::GameCore::IVec2* StaticGet_zeroVector()
		{
			return (::RPG::GameCore::IVec2*)Il2CppClass::FromTypeDefinitionIndex(IVec2_TypeDefinitionIndex)->GetStaticField(0xE7B8);
		}
		::System::Int32 x; // 0x10
		::System::Int32 y; // 0x14
