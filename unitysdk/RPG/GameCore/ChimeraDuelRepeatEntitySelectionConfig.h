...
#define RPG_GAMECORE_CHIMERADUELREPEATENTITYSELECTIONCONFIG_METHOD_3_11C56FE8C62799F7_OFFSET UNITYSDK_OFFSET(0x18803FE0)
#define RPG_GAMECORE_CHIMERADUELREPEATENTITYSELECTIONCONFIG_METHOD_3_1F796C676422C4D5_OFFSET UNITYSDK_OFFSET(0x18804040)
#define RPG_GAMECORE_CHIMERADUELREPEATENTITYSELECTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18804030)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelRepeatEntitySelectionConfig_TypeDefinitionIndex = 15064;
