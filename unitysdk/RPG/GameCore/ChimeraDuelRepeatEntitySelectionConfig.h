...
#define RPG_GAMECORE_CHIMERADUELREPEATENTITYSELECTIONCONFIG_METHOD_3_11C56FE8C62799F7_OFFSET UNITYSDK_OFFSET(0x170A4A30)
#define RPG_GAMECORE_CHIMERADUELREPEATENTITYSELECTIONCONFIG_METHOD_3_1F796C676422C4D5_OFFSET UNITYSDK_OFFSET(0x170A4A90)
#define RPG_GAMECORE_CHIMERADUELREPEATENTITYSELECTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x170A4A80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelRepeatEntitySelectionConfig_TypeDefinitionIndex = 14594;
