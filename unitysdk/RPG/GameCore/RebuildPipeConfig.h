...
#define RPG_GAMECORE_REBUILDPIPECONFIG_METHOD_3_4A927ECEDF044FF0_OFFSET UNITYSDK_OFFSET(0x18C8EC50)
#define RPG_GAMECORE_REBUILDPIPECONFIG_METHOD_3_F7363F569DE7B579_OFFSET UNITYSDK_OFFSET(0x18C8ECC0)
#define RPG_GAMECORE_REBUILDPIPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18C8ECA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RebuildPipeConfig_TypeDefinitionIndex = 17698;
