...
#define RPG_GAMECORE_REBUILDPIPECONFIG_METHOD_3_0716379D4C4414BA_OFFSET UNITYSDK_OFFSET(0x1D19DD00)
#define RPG_GAMECORE_REBUILDPIPECONFIG_METHOD_3_F7363F569DE7B579_OFFSET UNITYSDK_OFFSET(0x1D19DD40)
#define RPG_GAMECORE_REBUILDPIPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D19DD30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RebuildPipeConfig_TypeDefinitionIndex = 18420;
