...
#define RPG_GAMECORE_REBUILDPIPECONFIG_METHOD_3_4A927ECEDF044FF0_OFFSET UNITYSDK_OFFSET(0x17583F20)
#define RPG_GAMECORE_REBUILDPIPECONFIG_METHOD_3_F7363F569DE7B579_OFFSET UNITYSDK_OFFSET(0x17583F90)
#define RPG_GAMECORE_REBUILDPIPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17583F70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RebuildPipeConfig_TypeDefinitionIndex = 17099;
