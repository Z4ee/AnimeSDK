...
#define RPG_GAMECORE_HIDEEFFECTBYCHARACTERTYPE_METHOD_3_117FF63320A010CD_OFFSET UNITYSDK_OFFSET(0x189FDED0)
#define RPG_GAMECORE_HIDEEFFECTBYCHARACTERTYPE_METHOD_3_C4F1BF56E1145911_OFFSET UNITYSDK_OFFSET(0x189FDE50)
#define RPG_GAMECORE_HIDEEFFECTBYCHARACTERTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x189FDEA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HideEffectByCharacterType_TypeDefinitionIndex = 21336;
