...
#define RPG_GAMECORE_TARGETMAPTEAMENTITY_METHOD_3_8A8E39DE2173D4F3_OFFSET UNITYSDK_OFFSET(0x18EE9D50)
#define RPG_GAMECORE_TARGETMAPTEAMENTITY_METHOD_3_C1AAD4CD4025279E_OFFSET UNITYSDK_OFFSET(0x18EE9C90)
#define RPG_GAMECORE_TARGETMAPTEAMENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x18EE9D30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapTeamEntity_TypeDefinitionIndex = 22936;
