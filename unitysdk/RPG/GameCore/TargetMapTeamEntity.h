...
#define RPG_GAMECORE_TARGETMAPTEAMENTITY_METHOD_3_1066E12C64BCCDA8_OFFSET UNITYSDK_OFFSET(0x1D0C42C0)
#define RPG_GAMECORE_TARGETMAPTEAMENTITY_METHOD_3_47A9420B7D9791F5_OFFSET UNITYSDK_OFFSET(0x1D0C42E0)
#define RPG_GAMECORE_TARGETMAPTEAMENTITY_METHOD_3_8A8E39DE2173D4F3_OFFSET UNITYSDK_OFFSET(0x1D0C4260)
#define RPG_GAMECORE_TARGETMAPTEAMENTITY_METHOD_3_B7F0B12C9F785072_OFFSET UNITYSDK_OFFSET(0x1D0C41E0)
#define RPG_GAMECORE_TARGETMAPTEAMENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0C4250)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapTeamEntity_TypeDefinitionIndex = 23090;
