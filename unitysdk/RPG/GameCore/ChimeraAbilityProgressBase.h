...
#define RPG_GAMECORE_CHIMERAABILITYPROGRESSBASE_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1CFBC5A0)
#define RPG_GAMECORE_CHIMERAABILITYPROGRESSBASE_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CFBB450)
#define RPG_GAMECORE_CHIMERAABILITYPROGRESSBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFBC040)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraAbilityProgressBase_TypeDefinitionIndex = 15684;
