...
#define RPG_GAMECORE_TASKCONFIG_GET_ISCLIENTONLY_OFFSET UNITYSDK_OFFSET(0x18EFE7D0)
#define RPG_GAMECORE_TASKCONFIG_METHOD_2_1ED259C7ABF370D3_OFFSET UNITYSDK_OFFSET(0x18EFE580)
#define RPG_GAMECORE_TASKCONFIG_METHOD_2_577BAC1DE9DE59A7_OFFSET UNITYSDK_OFFSET(0x18EFE700)
#define RPG_GAMECORE_TASKCONFIG_METHOD_2_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x18EFE7C0)
#define RPG_GAMECORE_TASKCONFIG__CCTOR_OFFSET UNITYSDK_OFFSET(0x18EFE850)
#define RPG_GAMECORE_TASKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18EFA030)
...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Func_2<::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::TaskConfig*>*>**)Il2CppClass::FromTypeDefinitionIndex(TaskConfig_TypeDefinitionIndex)->GetStaticField(0x5C20);
		}
