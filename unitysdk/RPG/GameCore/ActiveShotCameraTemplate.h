...
#define RPG_GAMECORE_ACTIVESHOTCAMERATEMPLATE_METHOD_3_812B30A261FD3B0A_OFFSET UNITYSDK_OFFSET(0x1C9EC400)
#define RPG_GAMECORE_ACTIVESHOTCAMERATEMPLATE_METHOD_3_B7DD1B10ABB59A5F_OFFSET UNITYSDK_OFFSET(0x1C9EC450)
#define RPG_GAMECORE_ACTIVESHOTCAMERATEMPLATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9EC440)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActiveShotCameraTemplate_TypeDefinitionIndex = 20589;
