...
#define RPG_GAMECORE_ACTIVESHOTCAMERATEMPLATE_METHOD_3_B7DD1B10ABB59A5F_OFFSET UNITYSDK_OFFSET(0x186010E0)
#define RPG_GAMECORE_ACTIVESHOTCAMERATEMPLATE_METHOD_3_BE99036A267CCA14_OFFSET UNITYSDK_OFFSET(0x18601060)
#define RPG_GAMECORE_ACTIVESHOTCAMERATEMPLATE__CTOR_OFFSET UNITYSDK_OFFSET(0x186010B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActiveShotCameraTemplate_TypeDefinitionIndex = 19807;
