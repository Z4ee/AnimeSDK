...
#define RPG_GAMECORE_ROGUEACTIONCONFIGBASE_METHOD_5_0CB351963D3DE5D8_OFFSET UNITYSDK_OFFSET(0x1D3BBFD0)
#define RPG_GAMECORE_ROGUEACTIONCONFIGBASE_METHOD_5_A05A1EDB0B641ADA_OFFSET UNITYSDK_OFFSET(0x1D3BC030)
#define RPG_GAMECORE_ROGUEACTIONCONFIGBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3B6900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActionConfigBase_TypeDefinitionIndex = 19352;
