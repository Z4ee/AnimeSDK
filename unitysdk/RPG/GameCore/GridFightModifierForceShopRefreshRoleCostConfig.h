...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERFORCESHOPREFRESHROLECOSTCONFIG_METHOD_3_72CD4C7045B6B7F9_OFFSET UNITYSDK_OFFSET(0x1D159B20)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERFORCESHOPREFRESHROLECOSTCONFIG_METHOD_3_C322E1DEDFE0F23D_OFFSET UNITYSDK_OFFSET(0x1D159B70)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERFORCESHOPREFRESHROLECOSTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D159B60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierForceShopRefreshRoleCostConfig_TypeDefinitionIndex = 19119;
