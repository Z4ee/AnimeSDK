...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERFORCESHOPREFRESHROLECOSTCONFIG_METHOD_3_7AFFBC8E630099C4_OFFSET UNITYSDK_OFFSET(0x197F2620)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERFORCESHOPREFRESHROLECOSTCONFIG_METHOD_3_C322E1DEDFE0F23D_OFFSET UNITYSDK_OFFSET(0x197ED290)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERFORCESHOPREFRESHROLECOSTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197ED240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierForceShopRefreshRoleCostConfig_TypeDefinitionIndex = 18350;
