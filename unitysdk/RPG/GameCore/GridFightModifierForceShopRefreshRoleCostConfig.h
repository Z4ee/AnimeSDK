...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERFORCESHOPREFRESHROLECOSTCONFIG_METHOD_3_7AFFBC8E630099C4_OFFSET UNITYSDK_OFFSET(0x189BD0A0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERFORCESHOPREFRESHROLECOSTCONFIG_METHOD_3_C322E1DEDFE0F23D_OFFSET UNITYSDK_OFFSET(0x189BD170)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERFORCESHOPREFRESHROLECOSTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189BD120)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierForceShopRefreshRoleCostConfig_TypeDefinitionIndex = 18378;
