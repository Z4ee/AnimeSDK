...
#define RPG_GAMECORE_ADVENTURESETATTACKTARGETMONSTERDIE_METHOD_3_8C50EB2515FF24EF_OFFSET UNITYSDK_OFFSET(0x1AE61FA0)
#define RPG_GAMECORE_ADVENTURESETATTACKTARGETMONSTERDIE_METHOD_3_CADBF022D0B71D4E_OFFSET UNITYSDK_OFFSET(0x1AE61FF0)
#define RPG_GAMECORE_ADVENTURESETATTACKTARGETMONSTERDIE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE61FE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureSetAttackTargetMonsterDie_TypeDefinitionIndex = 19438;
