...
#define RPG_GAMECORE_MARKTARGETFORFUTUREREVIVEABILITY_METHOD_3_7973221F4DB92A3F_OFFSET UNITYSDK_OFFSET(0x1739F3F0)
#define RPG_GAMECORE_MARKTARGETFORFUTUREREVIVEABILITY_METHOD_3_B8FACA5C15526B0E_OFFSET UNITYSDK_OFFSET(0x1739F370)
#define RPG_GAMECORE_MARKTARGETFORFUTUREREVIVEABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1739F3C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarkTargetForFutureReviveAbility_TypeDefinitionIndex = 21968;
