...
#define RPG_GAMECORE_MARKTARGETFORFUTUREREVIVEABILITY_METHOD_3_7973221F4DB92A3F_OFFSET UNITYSDK_OFFSET(0x18AAD490)
#define RPG_GAMECORE_MARKTARGETFORFUTUREREVIVEABILITY_METHOD_3_B8FACA5C15526B0E_OFFSET UNITYSDK_OFFSET(0x18AAD410)
#define RPG_GAMECORE_MARKTARGETFORFUTUREREVIVEABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x18AAD460)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarkTargetForFutureReviveAbility_TypeDefinitionIndex = 22708;
