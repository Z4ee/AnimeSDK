...
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEALLSAME_METHOD_3_4FF9A94A9C94541D_OFFSET UNITYSDK_OFFSET(0x1715BE00)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEALLSAME_METHOD_3_A01E45598B6DB4F1_OFFSET UNITYSDK_OFFSET(0x1715C710)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEALLSAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1715BDF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatAIEffectEvaluatorConfig_DiceAllSame_TypeDefinitionIndex = 14843;
