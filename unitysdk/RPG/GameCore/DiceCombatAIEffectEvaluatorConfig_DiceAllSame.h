...
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEALLSAME_METHOD_3_4FF9A94A9C94541D_OFFSET UNITYSDK_OFFSET(0x18863240)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEALLSAME_METHOD_3_A01E45598B6DB4F1_OFFSET UNITYSDK_OFFSET(0x18863CF0)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEALLSAME__CTOR_OFFSET UNITYSDK_OFFSET(0x18863230)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatAIEffectEvaluatorConfig_DiceAllSame_TypeDefinitionIndex = 15336;
