...
#define RPG_GAMECORE_LEVELCHARACTERBEGINATTACK_CLEAR_OFFSET UNITYSDK_OFFSET(0x1BDF0190)
#define RPG_GAMECORE_LEVELCHARACTERBEGINATTACK_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1BDF0230)
#define RPG_GAMECORE_LEVELCHARACTERBEGINATTACK_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x1BDF01E0)
#define RPG_GAMECORE_LEVELCHARACTERBEGINATTACK_INIT_OFFSET UNITYSDK_OFFSET(0x1BDF0120)
#define RPG_GAMECORE_LEVELCHARACTERBEGINATTACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDF0280)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelCharacterBeginAttack_TypeDefinitionIndex = 54243;

	class LevelCharacterBeginAttack : public ::Class_1_BF7A075734D15E98
	{
	public:
		::RPG::GameCore::GameEntity* Defender; // 0x18
		::Class_1_843DD6330B22E422* DamageData; // 0x20
		::RPG::GameCore::GameEntity* Attacker; // 0x28
