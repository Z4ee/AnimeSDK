...
#define RPG_GAMECORE_VE_RTBATTLEPROPERTYRATIO_METHOD_3_88AA6DB648D96BDB_OFFSET UNITYSDK_OFFSET(0x1B8911F0)
#define RPG_GAMECORE_VE_RTBATTLEPROPERTYRATIO_METHOD_3_B59FC1A98E42E518_OFFSET UNITYSDK_OFFSET(0x1B890FB0)
#define RPG_GAMECORE_VE_RTBATTLEPROPERTYRATIO_METHOD_3_C19711F853CD008C_OFFSET UNITYSDK_OFFSET(0x1B8911C0)
#define RPG_GAMECORE_VE_RTBATTLEPROPERTYRATIO_METHOD_3_CF7C2E37ADF8008D_OFFSET UNITYSDK_OFFSET(0x1B890FF0)
#define RPG_GAMECORE_VE_RTBATTLEPROPERTYRATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B890FE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VE_RtBattlePropertyRatio_TypeDefinitionIndex = 23415;
