...
#define RPG_GAMECORE_RESIDENTEFFECTCONFIG_METHOD_2_BFBA0DF1AC90765A_OFFSET UNITYSDK_OFFSET(0x1D3A6240)
#define RPG_GAMECORE_RESIDENTEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3A63D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResidentEffectConfig_TypeDefinitionIndex = 16363;
