...
#define RPG_GAMECORE_BYCOMPAREUNUSEDULTRASKILLCOUNT_METHOD_4_18E76DA5A8A53EDE_OFFSET UNITYSDK_OFFSET(0x1CF0AFE0)
#define RPG_GAMECORE_BYCOMPAREUNUSEDULTRASKILLCOUNT_METHOD_4_591A7AA2A43D6CD0_OFFSET UNITYSDK_OFFSET(0x1CF0AFB0)
#define RPG_GAMECORE_BYCOMPAREUNUSEDULTRASKILLCOUNT_METHOD_4_598F7421234C0481_OFFSET UNITYSDK_OFFSET(0x1CF0ACE0)
#define RPG_GAMECORE_BYCOMPAREUNUSEDULTRASKILLCOUNT_METHOD_4_7C659619090240F0_OFFSET UNITYSDK_OFFSET(0x1CF0AD20)
#define RPG_GAMECORE_BYCOMPAREUNUSEDULTRASKILLCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF0AD10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareUnusedUltraSkillCount_TypeDefinitionIndex = 22794;
