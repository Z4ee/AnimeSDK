...
#define RPG_GAMECORE_GRIDFIGHTACTIONCOPYNPCCONFIG_METHOD_6_CD747DC922583276_OFFSET UNITYSDK_OFFSET(0x1899F6A0)
#define RPG_GAMECORE_GRIDFIGHTACTIONCOPYNPCCONFIG_METHOD_6_D707F19B91C747E5_OFFSET UNITYSDK_OFFSET(0x189A0070)
#define RPG_GAMECORE_GRIDFIGHTACTIONCOPYNPCCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1899F600)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightActionCopyNpcConfig_TypeDefinitionIndex = 18336;
