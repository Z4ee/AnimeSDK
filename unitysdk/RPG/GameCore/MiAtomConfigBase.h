...
#define RPG_GAMECORE_MIATOMCONFIGBASE_METHOD_2_2D24AF303372A1DB_OFFSET UNITYSDK_OFFSET(0x1AF62C90)
#define RPG_GAMECORE_MIATOMCONFIGBASE_METHOD_2_74B806AC3706CDE2_OFFSET UNITYSDK_OFFSET(0x1AF62C30)
#define RPG_GAMECORE_MIATOMCONFIGBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF62BD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MiAtomConfigBase_TypeDefinitionIndex = 16386;
