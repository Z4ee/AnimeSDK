...
#define RPG_GAMECORE_CHANGEHEROBASICTYPE_METHOD_3_647648FD1F2CA112_OFFSET UNITYSDK_OFFSET(0x170632A0)
#define RPG_GAMECORE_CHANGEHEROBASICTYPE_METHOD_3_FF7D736561D83CD1_OFFSET UNITYSDK_OFFSET(0x17063320)
#define RPG_GAMECORE_CHANGEHEROBASICTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x170632F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChangeHeroBasicType_TypeDefinitionIndex = 19206;
