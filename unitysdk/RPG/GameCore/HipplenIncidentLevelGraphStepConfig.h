...
#define RPG_GAMECORE_HIPPLENINCIDENTLEVELGRAPHSTEPCONFIG_METHOD_3_105FC3801429951C_OFFSET UNITYSDK_OFFSET(0x18A03470)
#define RPG_GAMECORE_HIPPLENINCIDENTLEVELGRAPHSTEPCONFIG_METHOD_3_41B09ED233523A44_OFFSET UNITYSDK_OFFSET(0x18A034D0)
#define RPG_GAMECORE_HIPPLENINCIDENTLEVELGRAPHSTEPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18A034C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HipplenIncidentLevelGraphStepConfig_TypeDefinitionIndex = 15913;
