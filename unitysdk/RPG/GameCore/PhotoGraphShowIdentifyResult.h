...
#define RPG_GAMECORE_PHOTOGRAPHSHOWIDENTIFYRESULT_METHOD_3_267BB3982C9C1610_OFFSET UNITYSDK_OFFSET(0x174ACF00)
#define RPG_GAMECORE_PHOTOGRAPHSHOWIDENTIFYRESULT_METHOD_3_AD222197BE71947D_OFFSET UNITYSDK_OFFSET(0x174ACF80)
#define RPG_GAMECORE_PHOTOGRAPHSHOWIDENTIFYRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x174ACF50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotoGraphShowIdentifyResult_TypeDefinitionIndex = 19828;
