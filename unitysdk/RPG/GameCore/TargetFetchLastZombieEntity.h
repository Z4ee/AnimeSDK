...
#define RPG_GAMECORE_TARGETFETCHLASTZOMBIEENTITY_METHOD_4_47B927A482F43FA7_OFFSET UNITYSDK_OFFSET(0x18EDDA10)
#define RPG_GAMECORE_TARGETFETCHLASTZOMBIEENTITY_METHOD_4_E9EA7F2DE0941949_OFFSET UNITYSDK_OFFSET(0x18EE47B0)
#define RPG_GAMECORE_TARGETFETCHLASTZOMBIEENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x18EDD9C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchLastZombieEntity_TypeDefinitionIndex = 22993;
