...
#define RPG_GAMECORE_COMPLEXSKILLAISOURCENEEDCHAOSTARGETING_METHOD_3_5768AD4A05ADB5BA_OFFSET UNITYSDK_OFFSET(0x1BC27D60)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCENEEDCHAOSTARGETING_METHOD_3_75606A6B84A49C17_OFFSET UNITYSDK_OFFSET(0x1BC27C90)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCENEEDCHAOSTARGETING__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC27D50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAISourceNeedChaosTargeting_TypeDefinitionIndex = 14917;
