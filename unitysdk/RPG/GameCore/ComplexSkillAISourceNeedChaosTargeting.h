...
#define RPG_GAMECORE_COMPLEXSKILLAISOURCENEEDCHAOSTARGETING_METHOD_3_5768AD4A05ADB5BA_OFFSET UNITYSDK_OFFSET(0x1966D900)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCENEEDCHAOSTARGETING_METHOD_3_CC7BE492F202748E_OFFSET UNITYSDK_OFFSET(0x1966FCE0)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCENEEDCHAOSTARGETING__CTOR_OFFSET UNITYSDK_OFFSET(0x1966D8E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAISourceNeedChaosTargeting_TypeDefinitionIndex = 14757;
