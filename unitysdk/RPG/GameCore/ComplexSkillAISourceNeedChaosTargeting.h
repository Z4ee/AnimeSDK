...
#define RPG_GAMECORE_COMPLEXSKILLAISOURCENEEDCHAOSTARGETING_METHOD_3_5768AD4A05ADB5BA_OFFSET UNITYSDK_OFFSET(0x171272A0)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCENEEDCHAOSTARGETING_METHOD_3_CC7BE492F202748E_OFFSET UNITYSDK_OFFSET(0x171290B0)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCENEEDCHAOSTARGETING__CTOR_OFFSET UNITYSDK_OFFSET(0x17127280)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAISourceNeedChaosTargeting_TypeDefinitionIndex = 14222;
