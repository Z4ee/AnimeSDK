...
#define RPG_GAMECORE_PRIORITYCONFIG_METHOD_2_011FAD9D6E19C54C_OFFSET UNITYSDK_OFFSET(0x17512500)
#define RPG_GAMECORE_PRIORITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175125D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PriorityConfig_TypeDefinitionIndex = 15691;
