...
#define RPG_GAMECORE_PRIORITYCONFIG_METHOD_2_26B4D0CE3176D42E_OFFSET UNITYSDK_OFFSET(0x1D16F330)
#define RPG_GAMECORE_PRIORITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D16F410)
