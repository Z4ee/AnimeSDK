...
#define RPG_GAMECORE_AVDMONITORPLAYERRUN_METHOD_3_3DF68FDBF17EC5BD_OFFSET UNITYSDK_OFFSET(0x16FBF2C0)
#define RPG_GAMECORE_AVDMONITORPLAYERRUN_METHOD_3_F47E82E3D6994403_OFFSET UNITYSDK_OFFSET(0x16FBF340)
#define RPG_GAMECORE_AVDMONITORPLAYERRUN__CTOR_OFFSET UNITYSDK_OFFSET(0x16FBF310)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AvdMonitorPlayerRun_TypeDefinitionIndex = 19357;
