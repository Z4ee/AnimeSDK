...
#define RPG_GAMECORE_AVDMONITORPLAYERRUN_METHOD_3_2A8D055FB8D1E74C_OFFSET UNITYSDK_OFFSET(0x1B2E2510)
#define RPG_GAMECORE_AVDMONITORPLAYERRUN_METHOD_3_BB7D3C797FE95542_OFFSET UNITYSDK_OFFSET(0x1B2E24D0)
#define RPG_GAMECORE_AVDMONITORPLAYERRUN__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2E2500)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AvdMonitorPlayerRun_TypeDefinitionIndex = 20792;
	...
	public:
		...
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::AvdMonitorPlayerRun*))((::PBYTE)hIl2Cpp + RPG_GAMECORE_AVDMONITORPLAYERRUN_METHOD_3_2A8D055FB8D1E74C_OFFSET))(a1, a2);
		}
	};
}
