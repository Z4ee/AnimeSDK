...
#define RPG_GAMECORE_MUSICRHYTHMEVENTLISTENER_METHOD_3_4D6A6D15249F2093_OFFSET UNITYSDK_OFFSET(0x18B72F20)
#define RPG_GAMECORE_MUSICRHYTHMEVENTLISTENER_METHOD_3_6F6CD1488DA8FC02_OFFSET UNITYSDK_OFFSET(0x18B72FA0)
#define RPG_GAMECORE_MUSICRHYTHMEVENTLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x18B72F70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MusicRhythmEventListener_TypeDefinitionIndex = 20929;
