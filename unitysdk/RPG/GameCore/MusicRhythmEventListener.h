...
#define RPG_GAMECORE_MUSICRHYTHMEVENTLISTENER_METHOD_3_2059D817E1570EF1_OFFSET UNITYSDK_OFFSET(0x1D2E8A40)
#define RPG_GAMECORE_MUSICRHYTHMEVENTLISTENER_METHOD_3_5855D2CF0923DF84_OFFSET UNITYSDK_OFFSET(0x1D2E8A80)
#define RPG_GAMECORE_MUSICRHYTHMEVENTLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2E8A70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MusicRhythmEventListener_TypeDefinitionIndex = 21817;
