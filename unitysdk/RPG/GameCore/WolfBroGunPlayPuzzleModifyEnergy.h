...
#define RPG_GAMECORE_WOLFBROGUNPLAYPUZZLEMODIFYENERGY_METHOD_3_3B9E57707B806160_OFFSET UNITYSDK_OFFSET(0x1D1C2D60)
#define RPG_GAMECORE_WOLFBROGUNPLAYPUZZLEMODIFYENERGY_METHOD_3_85947146AD2942F3_OFFSET UNITYSDK_OFFSET(0x1D1C2DA0)
#define RPG_GAMECORE_WOLFBROGUNPLAYPUZZLEMODIFYENERGY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1C2D90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WolfBroGunPlayPuzzleModifyEnergy_TypeDefinitionIndex = 19587;
