...
#define RPG_GAMECORE_MAPDEFAULTENTRANCEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x198BB8F0)
#define RPG_GAMECORE_MAPDEFAULTENTRANCEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x198BB9E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MapDefaultEntranceRow_TypeDefinitionIndex = 13348;
