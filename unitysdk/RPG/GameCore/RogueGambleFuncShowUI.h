...
#define RPG_GAMECORE_ROGUEGAMBLEFUNCSHOWUI_METHOD_3_6CF09FACDC35FBCC_OFFSET UNITYSDK_OFFSET(0x1CFAE2F0)
#define RPG_GAMECORE_ROGUEGAMBLEFUNCSHOWUI_METHOD_3_7F77A672A6490015_OFFSET UNITYSDK_OFFSET(0x1CFAE330)
#define RPG_GAMECORE_ROGUEGAMBLEFUNCSHOWUI__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFAE320)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueGambleFuncShowUI_TypeDefinitionIndex = 21294;
