...
#define RPG_GAMECORE_MUNICIPALCHATACTIONBASE_METHOD_2_19E99EBB281CA339_OFFSET UNITYSDK_OFFSET(0x1B1D2EA0)
#define RPG_GAMECORE_MUNICIPALCHATACTIONBASE_METHOD_2_1F4943C81EF80B74_OFFSET UNITYSDK_OFFSET(0x1B1D31D0)
#define RPG_GAMECORE_MUNICIPALCHATACTIONBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1D31C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MunicipalChatActionBase_TypeDefinitionIndex = 16246;
