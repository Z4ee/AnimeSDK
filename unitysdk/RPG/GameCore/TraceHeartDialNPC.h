...
#define RPG_GAMECORE_TRACEHEARTDIALNPC_METHOD_3_8A9C487207F5FAEC_OFFSET UNITYSDK_OFFSET(0x178A2960)
#define RPG_GAMECORE_TRACEHEARTDIALNPC_METHOD_3_9630BFAE6A3C553B_OFFSET UNITYSDK_OFFSET(0x1788BF80)
#define RPG_GAMECORE_TRACEHEARTDIALNPC__CTOR_OFFSET UNITYSDK_OFFSET(0x1788BF50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TraceHeartDialNPC_TypeDefinitionIndex = 19520;
