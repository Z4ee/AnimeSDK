...
#define RPG_GAMECORE_TRACEHEARTDIALNPC_METHOD_3_6CE0E7D614699061_OFFSET UNITYSDK_OFFSET(0x1D5D5560)
#define RPG_GAMECORE_TRACEHEARTDIALNPC_METHOD_3_7B759D3324BDB52E_OFFSET UNITYSDK_OFFSET(0x1D5D5520)
#define RPG_GAMECORE_TRACEHEARTDIALNPC__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5D5550)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TraceHeartDialNPC_TypeDefinitionIndex = 20976;
