...
#define RPG_GAMECORE_DISTANCETOSCOREWEIGHTMAPPING_METHOD_2_7631C3E72153F352_OFFSET UNITYSDK_OFFSET(0x17173C50)
#define RPG_GAMECORE_DISTANCETOSCOREWEIGHTMAPPING__CTOR_OFFSET UNITYSDK_OFFSET(0x17173D20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DistanceToScoreWeightMapping_TypeDefinitionIndex = 14329;
