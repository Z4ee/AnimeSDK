...
#define RPG_GAMECORE_LENSDISTORTIONCURVEEFFECT_METHOD_3_C08309155974930C_OFFSET UNITYSDK_OFFSET(0x1732CA50)
#define RPG_GAMECORE_LENSDISTORTIONCURVEEFFECT_METHOD_3_EC7E856D8A43F95E_OFFSET UNITYSDK_OFFSET(0x1732CAF0)
#define RPG_GAMECORE_LENSDISTORTIONCURVEEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1732CAB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LensDistortionCurveEffect_TypeDefinitionIndex = 18541;
