...
#define RPG_GAMECORE_LENSDISTORTIONCURVEEFFECT_METHOD_3_C08309155974930C_OFFSET UNITYSDK_OFFSET(0x18A3A300)
#define RPG_GAMECORE_LENSDISTORTIONCURVEEFFECT_METHOD_3_EC7E856D8A43F95E_OFFSET UNITYSDK_OFFSET(0x18A3A3A0)
#define RPG_GAMECORE_LENSDISTORTIONCURVEEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x18A3A360)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LensDistortionCurveEffect_TypeDefinitionIndex = 19194;
