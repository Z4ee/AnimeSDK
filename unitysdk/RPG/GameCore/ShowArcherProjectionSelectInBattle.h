...
#define RPG_GAMECORE_SHOWARCHERPROJECTIONSELECTINBATTLE_METHOD_3_A04EE639F9EFD732_OFFSET UNITYSDK_OFFSET(0x18E57C90)
#define RPG_GAMECORE_SHOWARCHERPROJECTIONSELECTINBATTLE_METHOD_3_F22454B377229371_OFFSET UNITYSDK_OFFSET(0x18E57D10)
#define RPG_GAMECORE_SHOWARCHERPROJECTIONSELECTINBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E57CE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowArcherProjectionSelectInBattle_TypeDefinitionIndex = 22264;
