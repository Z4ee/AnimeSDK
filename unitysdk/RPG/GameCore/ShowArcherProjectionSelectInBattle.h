...
#define RPG_GAMECORE_SHOWARCHERPROJECTIONSELECTINBATTLE_METHOD_3_A04EE639F9EFD732_OFFSET UNITYSDK_OFFSET(0x176F4260)
#define RPG_GAMECORE_SHOWARCHERPROJECTIONSELECTINBATTLE_METHOD_3_F22454B377229371_OFFSET UNITYSDK_OFFSET(0x176F42E0)
#define RPG_GAMECORE_SHOWARCHERPROJECTIONSELECTINBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x176F42B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowArcherProjectionSelectInBattle_TypeDefinitionIndex = 21528;
