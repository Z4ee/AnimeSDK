...
#define RPG_GAMECORE_BYPHOTOGRAPHCONDITIONSUCCESS_METHOD_4_0CF89C403BDFC8C9_OFFSET UNITYSDK_OFFSET(0x1B2B2D20)
#define RPG_GAMECORE_BYPHOTOGRAPHCONDITIONSUCCESS_METHOD_4_93B5D70F6E495666_OFFSET UNITYSDK_OFFSET(0x1B2B2F10)
#define RPG_GAMECORE_BYPHOTOGRAPHCONDITIONSUCCESS_METHOD_4_A922F8D4C3207214_OFFSET UNITYSDK_OFFSET(0x1B2B2CE0)
#define RPG_GAMECORE_BYPHOTOGRAPHCONDITIONSUCCESS_METHOD_4_D8F0F9B2629D6DC9_OFFSET UNITYSDK_OFFSET(0x1B2B2EE0)
#define RPG_GAMECORE_BYPHOTOGRAPHCONDITIONSUCCESS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2B2D10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByPhotoGraphConditionSuccess_TypeDefinitionIndex = 20832;
