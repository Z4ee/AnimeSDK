...
#define RPG_GAMECORE_LOCKMAINSTREAMSOURCETOSWITCHANCHORPOS_METHOD_3_17113080BFFFADC9_OFFSET UNITYSDK_OFFSET(0x1BCCF730)
#define RPG_GAMECORE_LOCKMAINSTREAMSOURCETOSWITCHANCHORPOS_METHOD_3_E539DE50EBB2F242_OFFSET UNITYSDK_OFFSET(0x1BCCF6F0)
#define RPG_GAMECORE_LOCKMAINSTREAMSOURCETOSWITCHANCHORPOS__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCCF720)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LockMainStreamSourceToSwitchAnchorPos_TypeDefinitionIndex = 19718;
