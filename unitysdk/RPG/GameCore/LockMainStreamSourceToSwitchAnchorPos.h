...
#define RPG_GAMECORE_LOCKMAINSTREAMSOURCETOSWITCHANCHORPOS_METHOD_3_17113080BFFFADC9_OFFSET UNITYSDK_OFFSET(0x18A790D0)
#define RPG_GAMECORE_LOCKMAINSTREAMSOURCETOSWITCHANCHORPOS_METHOD_3_BFADA00C46FE4810_OFFSET UNITYSDK_OFFSET(0x18A79050)
#define RPG_GAMECORE_LOCKMAINSTREAMSOURCETOSWITCHANCHORPOS__CTOR_OFFSET UNITYSDK_OFFSET(0x18A790A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LockMainStreamSourceToSwitchAnchorPos_TypeDefinitionIndex = 19457;
