...
#define RPG_GAMECORE_ROGUETOURNUSEBUFFTYPEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19BD0FE0)
#define RPG_GAMECORE_ROGUETOURNUSEBUFFTYPEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19BD1100)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournUseBuffTypeRow_TypeDefinitionIndex = 14286;
