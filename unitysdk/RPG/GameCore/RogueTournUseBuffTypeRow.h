...
#define RPG_GAMECORE_ROGUETOURNUSEBUFFTYPEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18D7D910)
#define RPG_GAMECORE_ROGUETOURNUSEBUFFTYPEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18D7DA40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournUseBuffTypeRow_TypeDefinitionIndex = 14227;
