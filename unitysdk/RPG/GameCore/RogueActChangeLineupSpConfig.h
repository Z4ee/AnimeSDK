...
#define RPG_GAMECORE_ROGUEACTCHANGELINEUPSPCONFIG_METHOD_6_30092C52AD80F218_OFFSET UNITYSDK_OFFSET(0x1D3B6DE0)
#define RPG_GAMECORE_ROGUEACTCHANGELINEUPSPCONFIG_METHOD_6_B3A4D284E541A4DC_OFFSET UNITYSDK_OFFSET(0x1D3B6D90)
#define RPG_GAMECORE_ROGUEACTCHANGELINEUPSPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3B6DD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActChangeLineupSpConfig_TypeDefinitionIndex = 19396;
