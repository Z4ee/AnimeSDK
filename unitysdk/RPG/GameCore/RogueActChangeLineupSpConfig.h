...
#define RPG_GAMECORE_ROGUEACTCHANGELINEUPSPCONFIG_METHOD_6_1167672F41D9CDC5_OFFSET UNITYSDK_OFFSET(0x18CBE6E0)
#define RPG_GAMECORE_ROGUEACTCHANGELINEUPSPCONFIG_METHOD_6_30092C52AD80F218_OFFSET UNITYSDK_OFFSET(0x18CBE900)
#define RPG_GAMECORE_ROGUEACTCHANGELINEUPSPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CBE820)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActChangeLineupSpConfig_TypeDefinitionIndex = 18626;
