...
#define RPG_GAMECORE_CHENLINGFESLEVELCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C3853A0)
#define RPG_GAMECORE_CHENLINGFESLEVELCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C385990)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::System::UInt32>* RequiredScoreList; // 0x20
		::Il2CppArray<::System::UInt32>* InitItemNumList; // 0x28
		::Il2CppArray<::System::UInt32>* ItemRuleGroupID; // 0x30
		::Il2CppArray<::System::UInt32>* LevelDayDuration; // 0x38
		::Il2CppArray<::System::UInt32>* VisitorRuleGroupID; // 0x40
		::Il2CppArray<::System::UInt32>* VisitorTimeInterval; // 0x48
		::System::String* LevelName; // 0x50
		::Il2CppArray<::System::UInt32>* AwardListID; // 0x58
		...
		::System::UInt32 UnlockSubMission; // 0x74
