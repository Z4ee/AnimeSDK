...
#define RPG_GAMECORE_BYRANDOMCHANCECLIENTONLY_METHOD_4_0F80AE7351D8B765_OFFSET UNITYSDK_OFFSET(0x17039A60)
#define RPG_GAMECORE_BYRANDOMCHANCECLIENTONLY_METHOD_4_A770B67B8371DEEB_OFFSET UNITYSDK_OFFSET(0x17039990)
#define RPG_GAMECORE_BYRANDOMCHANCECLIENTONLY__CTOR_OFFSET UNITYSDK_OFFSET(0x17039A10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByRandomChanceClientOnly_TypeDefinitionIndex = 21196;
