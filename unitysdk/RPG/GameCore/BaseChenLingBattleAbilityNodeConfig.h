...
#define RPG_GAMECORE_BASECHENLINGBATTLEABILITYNODECONFIG_METHOD_2_01722AB5C1B1D7F0_OFFSET UNITYSDK_OFFSET(0x1A3DC480)
#define RPG_GAMECORE_BASECHENLINGBATTLEABILITYNODECONFIG_METHOD_2_B02D10049B0F6C90_OFFSET UNITYSDK_OFFSET(0x1A3DCD30)
#define RPG_GAMECORE_BASECHENLINGBATTLEABILITYNODECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3DCD90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BaseChenLingBattleAbilityNodeConfig_TypeDefinitionIndex = 15121;
