...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYHEXEQUIPMENTCOUNTCONFIG_METHOD_3_461A2B46BC6BA63D_OFFSET UNITYSDK_OFFSET(0x18D40FE0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYHEXEQUIPMENTCOUNTCONFIG_METHOD_3_DA383C2EBB9BBCF4_OFFSET UNITYSDK_OFFSET(0x18D410B0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYHEXEQUIPMENTCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D41060)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyHexEquipmentCountConfig_TypeDefinitionIndex = 16860;
