...
#define RPG_GAMECORE_MONOEFFECTLODCONFIG_METHOD_2_53EEEEE2D9054922_OFFSET UNITYSDK_OFFSET(0x1D1C0040)
#define RPG_GAMECORE_MONOEFFECTLODCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1C0140)
