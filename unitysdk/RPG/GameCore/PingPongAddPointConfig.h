...
#define RPG_GAMECORE_PINGPONGADDPOINTCONFIG_METHOD_2_1804AFE00E906986_OFFSET UNITYSDK_OFFSET(0x1D32FAF0)
#define RPG_GAMECORE_PINGPONGADDPOINTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D32FC80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PingPongAddPointConfig_TypeDefinitionIndex = 16783;
