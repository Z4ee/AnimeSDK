...
#define RPG_GAMECORE_ROGUEMODIFIERADDBATTLEBUFFCONFIG_METHOD_3_2556A3875F759BCC_OFFSET UNITYSDK_OFFSET(0x1761CB70)
#define RPG_GAMECORE_ROGUEMODIFIERADDBATTLEBUFFCONFIG_METHOD_3_686A8D4BAF9EA715_OFFSET UNITYSDK_OFFSET(0x1761CAA0)
#define RPG_GAMECORE_ROGUEMODIFIERADDBATTLEBUFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1761CB20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierAddBattleBuffConfig_TypeDefinitionIndex = 16494;
