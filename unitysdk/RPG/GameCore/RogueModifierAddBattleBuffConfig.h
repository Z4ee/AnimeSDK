...
#define RPG_GAMECORE_ROGUEMODIFIERADDBATTLEBUFFCONFIG_METHOD_3_2556A3875F759BCC_OFFSET UNITYSDK_OFFSET(0x1CFBEE00)
#define RPG_GAMECORE_ROGUEMODIFIERADDBATTLEBUFFCONFIG_METHOD_3_9F062C66C7A1BF50_OFFSET UNITYSDK_OFFSET(0x1CFBEDB0)
#define RPG_GAMECORE_ROGUEMODIFIERADDBATTLEBUFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFBEDF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierAddBattleBuffConfig_TypeDefinitionIndex = 17223;
