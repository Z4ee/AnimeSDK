...
#define RPG_GAMECORE_ROGUEMODIFIERADDBATTLEBUFFCONFIG_METHOD_3_2556A3875F759BCC_OFFSET UNITYSDK_OFFSET(0x18D2A380)
#define RPG_GAMECORE_ROGUEMODIFIERADDBATTLEBUFFCONFIG_METHOD_3_686A8D4BAF9EA715_OFFSET UNITYSDK_OFFSET(0x18D2A2B0)
#define RPG_GAMECORE_ROGUEMODIFIERADDBATTLEBUFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D2A330)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierAddBattleBuffConfig_TypeDefinitionIndex = 17048;
