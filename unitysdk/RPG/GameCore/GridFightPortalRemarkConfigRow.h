...
#define RPG_GAMECORE_GRIDFIGHTPORTALREMARKCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1727B430)
#define RPG_GAMECORE_GRIDFIGHTPORTALREMARKCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1727B5B0)
