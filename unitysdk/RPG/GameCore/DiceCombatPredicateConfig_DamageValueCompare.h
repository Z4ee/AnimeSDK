...
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_DAMAGEVALUECOMPARE_METHOD_4_2C58F60EFBF0CDAF_OFFSET UNITYSDK_OFFSET(0x1D829C20)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_DAMAGEVALUECOMPARE_METHOD_4_837F687D89576C51_OFFSET UNITYSDK_OFFSET(0x1D826C30)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_DAMAGEVALUECOMPARE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D826C20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatPredicateConfig_DamageValueCompare_TypeDefinitionIndex = 15939;
