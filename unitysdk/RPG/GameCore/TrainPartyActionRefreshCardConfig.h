...
#define RPG_GAMECORE_TRAINPARTYACTIONREFRESHCARDCONFIG_METHOD_5_129C1C071DF9A7A2_OFFSET UNITYSDK_OFFSET(0x178A7A00)
#define RPG_GAMECORE_TRAINPARTYACTIONREFRESHCARDCONFIG_METHOD_5_D00C966B231B9AAB_OFFSET UNITYSDK_OFFSET(0x178A7BF0)
#define RPG_GAMECORE_TRAINPARTYACTIONREFRESHCARDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x178A79B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyActionRefreshCardConfig_TypeDefinitionIndex = 16580;
