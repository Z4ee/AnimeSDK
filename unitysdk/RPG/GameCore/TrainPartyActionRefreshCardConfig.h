...
#define RPG_GAMECORE_TRAINPARTYACTIONREFRESHCARDCONFIG_METHOD_5_129C1C071DF9A7A2_OFFSET UNITYSDK_OFFSET(0x19DF1280)
#define RPG_GAMECORE_TRAINPARTYACTIONREFRESHCARDCONFIG_METHOD_5_D00C966B231B9AAB_OFFSET UNITYSDK_OFFSET(0x19DF1530)
#define RPG_GAMECORE_TRAINPARTYACTIONREFRESHCARDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19DF1230)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyActionRefreshCardConfig_TypeDefinitionIndex = 17181;
