...
#define RPG_GAMECORE_PLAYPENACONYENDMOSTSIMPLETALK_METHOD_3_09F201307237FC54_OFFSET UNITYSDK_OFFSET(0x18C10D50)
#define RPG_GAMECORE_PLAYPENACONYENDMOSTSIMPLETALK_METHOD_3_5448CFCAC689CE17_OFFSET UNITYSDK_OFFSET(0x18C10CD0)
#define RPG_GAMECORE_PLAYPENACONYENDMOSTSIMPLETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x18C10D20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayPenaconyEndmostSimpleTalk_TypeDefinitionIndex = 20673;
