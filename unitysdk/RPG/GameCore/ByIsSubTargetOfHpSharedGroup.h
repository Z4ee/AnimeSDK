...
#define RPG_GAMECORE_BYISSUBTARGETOFHPSHAREDGROUP_METHOD_4_0D7054043E9DE45B_OFFSET UNITYSDK_OFFSET(0x1B2A6690)
#define RPG_GAMECORE_BYISSUBTARGETOFHPSHAREDGROUP_METHOD_4_50E51B83B687E0A1_OFFSET UNITYSDK_OFFSET(0x1B2A6510)
#define RPG_GAMECORE_BYISSUBTARGETOFHPSHAREDGROUP_METHOD_4_5A13321B4A62253D_OFFSET UNITYSDK_OFFSET(0x1B2A66C0)
#define RPG_GAMECORE_BYISSUBTARGETOFHPSHAREDGROUP_METHOD_4_9357453AA16553A4_OFFSET UNITYSDK_OFFSET(0x1B2A64D0)
#define RPG_GAMECORE_BYISSUBTARGETOFHPSHAREDGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2A6500)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsSubTargetOfHpSharedGroup_TypeDefinitionIndex = 22685;
