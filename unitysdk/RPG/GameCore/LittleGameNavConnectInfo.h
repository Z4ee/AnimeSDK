...
#define RPG_GAMECORE_LITTLEGAMENAVCONNECTINFO_METHOD_2_CAFCEEF925C1CF02_OFFSET UNITYSDK_OFFSET(0x1DD6CCD0)
#define RPG_GAMECORE_LITTLEGAMENAVCONNECTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD6CEC0)
