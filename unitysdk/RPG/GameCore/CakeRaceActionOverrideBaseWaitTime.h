...
#define RPG_GAMECORE_CAKERACEACTIONOVERRIDEBASEWAITTIME_METHOD_3_690B58B131793C45_OFFSET UNITYSDK_OFFSET(0x17045110)
#define RPG_GAMECORE_CAKERACEACTIONOVERRIDEBASEWAITTIME_METHOD_3_F23E432A1DE224A3_OFFSET UNITYSDK_OFFSET(0x170469E0)
#define RPG_GAMECORE_CAKERACEACTIONOVERRIDEBASEWAITTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x170450F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionOverrideBaseWaitTime_TypeDefinitionIndex = 16840;
