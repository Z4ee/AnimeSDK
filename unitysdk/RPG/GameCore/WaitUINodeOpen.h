...
#define RPG_GAMECORE_WAITUINODEOPEN_METHOD_3_0A5C1425CC565074_OFFSET UNITYSDK_OFFSET(0x19E64650)
#define RPG_GAMECORE_WAITUINODEOPEN_METHOD_3_19CDAE212FA62D56_OFFSET UNITYSDK_OFFSET(0x19E646D0)
#define RPG_GAMECORE_WAITUINODEOPEN__CTOR_OFFSET UNITYSDK_OFFSET(0x19E646A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitUINodeOpen_TypeDefinitionIndex = 23026;
