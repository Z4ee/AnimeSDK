...
#define RPG_GAMECORE_PAUSETOASTQUEUE_METHOD_3_9E1194DCD2698313_OFFSET UNITYSDK_OFFSET(0x199EB990)
#define RPG_GAMECORE_PAUSETOASTQUEUE_METHOD_3_C68E271BF73A9ECA_OFFSET UNITYSDK_OFFSET(0x199EBA10)
#define RPG_GAMECORE_PAUSETOASTQUEUE__CTOR_OFFSET UNITYSDK_OFFSET(0x199EB9E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PauseToastQueue_TypeDefinitionIndex = 19168;
