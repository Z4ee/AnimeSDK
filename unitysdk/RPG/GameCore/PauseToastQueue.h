...
#define RPG_GAMECORE_PAUSETOASTQUEUE_METHOD_3_9E1194DCD2698313_OFFSET UNITYSDK_OFFSET(0x18BD9D00)
#define RPG_GAMECORE_PAUSETOASTQUEUE_METHOD_3_C68E271BF73A9ECA_OFFSET UNITYSDK_OFFSET(0x18BD9D80)
#define RPG_GAMECORE_PAUSETOASTQUEUE__CTOR_OFFSET UNITYSDK_OFFSET(0x18BD9D50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PauseToastQueue_TypeDefinitionIndex = 19249;
