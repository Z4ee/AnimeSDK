...
#define RPG_GAMECORE_STACKBOOSTPOINTDIRTY_METHOD_3_102F57A8ED2DDBD0_OFFSET UNITYSDK_OFFSET(0x19CA1590)
#define RPG_GAMECORE_STACKBOOSTPOINTDIRTY_METHOD_3_69181983F917D120_OFFSET UNITYSDK_OFFSET(0x19CA1510)
#define RPG_GAMECORE_STACKBOOSTPOINTDIRTY__CTOR_OFFSET UNITYSDK_OFFSET(0x19CA1560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StackBoostPointDirty_TypeDefinitionIndex = 22270;
