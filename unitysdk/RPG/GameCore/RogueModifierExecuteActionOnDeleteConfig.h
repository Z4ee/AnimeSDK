...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONDELETECONFIG_METHOD_3_65EF88C39A31BB7E_OFFSET UNITYSDK_OFFSET(0x19B5C920)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONDELETECONFIG_METHOD_3_B2CC50B26934F777_OFFSET UNITYSDK_OFFSET(0x19B510E0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONDELETECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B51090)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnDeleteConfig_TypeDefinitionIndex = 16816;
