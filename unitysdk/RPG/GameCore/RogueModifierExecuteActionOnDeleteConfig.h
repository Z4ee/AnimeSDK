...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONDELETECONFIG_METHOD_3_65EF88C39A31BB7E_OFFSET UNITYSDK_OFFSET(0x1762FA40)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONDELETECONFIG_METHOD_3_B2CC50B26934F777_OFFSET UNITYSDK_OFFSET(0x1762FB10)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONDELETECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1762FAC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnDeleteConfig_TypeDefinitionIndex = 16247;
