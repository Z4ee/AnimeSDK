...
#define RPG_GAMECORE_PLAYROGUESIMPLETALK_METHOD_3_ECB34843F1771D06_OFFSET UNITYSDK_OFFSET(0x1D34B870)
#define RPG_GAMECORE_PLAYROGUESIMPLETALK_METHOD_3_F8D832BA4B30C5CA_OFFSET UNITYSDK_OFFSET(0x1D34B9C0)
#define RPG_GAMECORE_PLAYROGUESIMPLETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D346F40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayRogueSimpleTalk_TypeDefinitionIndex = 20866;
