...
#define RPG_GAMECORE_PLAYROGUESIMPLETALK_METHOD_3_4B2DCCB17419519E_OFFSET UNITYSDK_OFFSET(0x174C5C50)
#define RPG_GAMECORE_PLAYROGUESIMPLETALK_METHOD_3_F8D832BA4B30C5CA_OFFSET UNITYSDK_OFFSET(0x174C5DE0)
#define RPG_GAMECORE_PLAYROGUESIMPLETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x174C0AD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayRogueSimpleTalk_TypeDefinitionIndex = 19413;
