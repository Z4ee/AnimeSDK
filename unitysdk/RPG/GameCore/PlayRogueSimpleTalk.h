...
#define RPG_GAMECORE_PLAYROGUESIMPLETALK_METHOD_3_4B2DCCB17419519E_OFFSET UNITYSDK_OFFSET(0x18C11260)
#define RPG_GAMECORE_PLAYROGUESIMPLETALK_METHOD_3_F8D832BA4B30C5CA_OFFSET UNITYSDK_OFFSET(0x18C113F0)
#define RPG_GAMECORE_PLAYROGUESIMPLETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x18C0C0E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayRogueSimpleTalk_TypeDefinitionIndex = 20086;
