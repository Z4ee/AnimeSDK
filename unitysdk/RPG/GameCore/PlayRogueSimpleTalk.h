...
#define RPG_GAMECORE_PLAYROGUESIMPLETALK_METHOD_3_ECB34843F1771D06_OFFSET UNITYSDK_OFFSET(0x1D7A78E0)
#define RPG_GAMECORE_PLAYROGUESIMPLETALK_METHOD_3_F8D832BA4B30C5CA_OFFSET UNITYSDK_OFFSET(0x1D7A7A30)
#define RPG_GAMECORE_PLAYROGUESIMPLETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7A2FB0)
