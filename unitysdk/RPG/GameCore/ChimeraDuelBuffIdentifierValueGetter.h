...
#define RPG_GAMECORE_CHIMERADUELBUFFIDENTIFIERVALUEGETTER_METHOD_3_405DCDC48FE21512_OFFSET UNITYSDK_OFFSET(0x1C391D00)
#define RPG_GAMECORE_CHIMERADUELBUFFIDENTIFIERVALUEGETTER_METHOD_3_497085B1B77348A6_OFFSET UNITYSDK_OFFSET(0x1C391C20)
#define RPG_GAMECORE_CHIMERADUELBUFFIDENTIFIERVALUEGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C391CF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelBuffIdentifierValueGetter_TypeDefinitionIndex = 15391;
