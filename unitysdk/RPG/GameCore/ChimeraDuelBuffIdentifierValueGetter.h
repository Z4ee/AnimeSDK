...
#define RPG_GAMECORE_CHIMERADUELBUFFIDENTIFIERVALUEGETTER_METHOD_3_405DCDC48FE21512_OFFSET UNITYSDK_OFFSET(0x17096AA0)
#define RPG_GAMECORE_CHIMERADUELBUFFIDENTIFIERVALUEGETTER_METHOD_3_497085B1B77348A6_OFFSET UNITYSDK_OFFSET(0x170969C0)
#define RPG_GAMECORE_CHIMERADUELBUFFIDENTIFIERVALUEGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x17096A90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelBuffIdentifierValueGetter_TypeDefinitionIndex = 14696;
