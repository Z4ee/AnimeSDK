...
#define RPG_GAMECORE_ROGUEACTPERSONACURROOMCARDCASTCLEARLEVELATTRIBUTEANDGETCOINCONFIG_METHOD_7_6FB9DE422607E45B_OFFSET UNITYSDK_OFFSET(0x175BB740)
#define RPG_GAMECORE_ROGUEACTPERSONACURROOMCARDCASTCLEARLEVELATTRIBUTEANDGETCOINCONFIG_METHOD_7_BDC3EB5B8ED80ADE_OFFSET UNITYSDK_OFFSET(0x175BB960)
#define RPG_GAMECORE_ROGUEACTPERSONACURROOMCARDCASTCLEARLEVELATTRIBUTEANDGETCOINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175BB880)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaCurRoomCardCastClearLevelAttributeAndGetCoinConfig_TypeDefinitionIndex = 18119;
