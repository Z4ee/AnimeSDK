...
#define RPG_GAMECORE_EQUIPMENTEXPTYPEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x171A7130)
#define RPG_GAMECORE_EQUIPMENTEXPTYPEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x171A7790)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EquipmentExpTypeRow_TypeDefinitionIndex = 12087;
