...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONBEFOREENTERROGUETOURNROOMCONFIG_METHOD_3_69E2E4C39E90C2A7_OFFSET UNITYSDK_OFFSET(0x1762F330)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONBEFOREENTERROGUETOURNROOMCONFIG_METHOD_3_A3CE6E496660592E_OFFSET UNITYSDK_OFFSET(0x1762F260)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONBEFOREENTERROGUETOURNROOMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1762F2E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionBeforeEnterRogueTournRoomConfig_TypeDefinitionIndex = 16319;
