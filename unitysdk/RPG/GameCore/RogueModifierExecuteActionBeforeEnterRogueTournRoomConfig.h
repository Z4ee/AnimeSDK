...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONBEFOREENTERROGUETOURNROOMCONFIG_METHOD_3_44A200273919CC23_OFFSET UNITYSDK_OFFSET(0x1CFBFCC0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONBEFOREENTERROGUETOURNROOMCONFIG_METHOD_3_69E2E4C39E90C2A7_OFFSET UNITYSDK_OFFSET(0x1CFBFD10)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONBEFOREENTERROGUETOURNROOMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFBFD00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionBeforeEnterRogueTournRoomConfig_TypeDefinitionIndex = 17050;
