...
#define RPG_GAMECORE_ENTERGAMEFLOWIMMEDIATELY_METHOD_3_6F7430BD1D6A4B94_OFFSET UNITYSDK_OFFSET(0x1719E680)
#define RPG_GAMECORE_ENTERGAMEFLOWIMMEDIATELY_METHOD_3_77F2384CC5147965_OFFSET UNITYSDK_OFFSET(0x1719E700)
#define RPG_GAMECORE_ENTERGAMEFLOWIMMEDIATELY__CTOR_OFFSET UNITYSDK_OFFSET(0x1719E6D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnterGameFlowImmediately_TypeDefinitionIndex = 22310;
