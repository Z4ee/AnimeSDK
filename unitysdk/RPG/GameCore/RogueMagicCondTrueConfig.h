...
#define RPG_GAMECORE_ROGUEMAGICCONDTRUECONFIG_METHOD_7_0E1A6CAE2445CC80_OFFSET UNITYSDK_OFFSET(0x1CFB5470)
#define RPG_GAMECORE_ROGUEMAGICCONDTRUECONFIG_METHOD_7_7C301402A1EA8B7C_OFFSET UNITYSDK_OFFSET(0x1CFB54C0)
#define RPG_GAMECORE_ROGUEMAGICCONDTRUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFB54B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueMagicCondTrueConfig_TypeDefinitionIndex = 18825;
