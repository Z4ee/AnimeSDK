...
#define RPG_GAMECORE_ROGUEACTGETROGUEBUFFBYGROUPSCONFIG_METHOD_6_5D14D3ACF4B22197_OFFSET UNITYSDK_OFFSET(0x175B68E0)
#define RPG_GAMECORE_ROGUEACTGETROGUEBUFFBYGROUPSCONFIG_METHOD_6_B430A9323A7F4822_OFFSET UNITYSDK_OFFSET(0x175B6B00)
#define RPG_GAMECORE_ROGUEACTGETROGUEBUFFBYGROUPSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175B6A20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActGetRogueBuffByGroupsConfig_TypeDefinitionIndex = 18016;
