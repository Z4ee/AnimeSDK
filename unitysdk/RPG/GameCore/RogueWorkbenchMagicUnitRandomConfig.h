...
#define RPG_GAMECORE_ROGUEWORKBENCHMAGICUNITRANDOMCONFIG_METHOD_2_F48DF5CF93BD3769_OFFSET UNITYSDK_OFFSET(0x18D811B0)
#define RPG_GAMECORE_ROGUEWORKBENCHMAGICUNITRANDOMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D811F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueWorkbenchMagicUnitRandomConfig_TypeDefinitionIndex = 17126;
