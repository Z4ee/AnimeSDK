...
#define RPG_GAMECORE_ROGUEWORKBENCHMAGICUNITRANDOMCONFIG_METHOD_2_F48DF5CF93BD3769_OFFSET UNITYSDK_OFFSET(0x19BD4750)
#define RPG_GAMECORE_ROGUEWORKBENCHMAGICUNITRANDOMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19BD4790)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueWorkbenchMagicUnitRandomConfig_TypeDefinitionIndex = 17139;
