...
#define RPG_GAMECORE_GRIDFIGHTEXPERTRESTRICTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x197E5CE0)
#define RPG_GAMECORE_GRIDFIGHTEXPERTRESTRICTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x197E5ED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightExpertRestrictConfigRow_TypeDefinitionIndex = 12837;

	class GridFightExpertRestrictConfigRow : public ::System::Object
	{
	public:
		::System::UInt32 Section; // 0x10
