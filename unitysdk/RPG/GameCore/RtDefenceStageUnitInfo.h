...
#define RPG_GAMECORE_RTDEFENCESTAGEUNITINFO_METHOD_2_57CA38BB8BDF8C12_OFFSET UNITYSDK_OFFSET(0x1D4A8BE0)
#define RPG_GAMECORE_RTDEFENCESTAGEUNITINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4A8E20)
