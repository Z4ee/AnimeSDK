...
#define RPG_GAMECORE_RTDEFENCESTAGEUNITINFO_METHOD_2_57CA38BB8BDF8C12_OFFSET UNITYSDK_OFFSET(0x19BE8B80)
#define RPG_GAMECORE_RTDEFENCESTAGEUNITINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19BE8DC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtDefenceStageUnitInfo_TypeDefinitionIndex = 17173;
