...
#define RPG_GAMECORE_RTDEFENCESTAGEUNITINFO_METHOD_2_57CA38BB8BDF8C12_OFFSET UNITYSDK_OFFSET(0x1CCE5A90)
#define RPG_GAMECORE_RTDEFENCESTAGEUNITINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1CCE5CD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtDefenceStageUnitInfo_TypeDefinitionIndex = 17852;
