...
#define RPG_GAMECORE_SYNCSUBPROPSTATE_METHOD_3_CC1A88A29A8CBAB4_OFFSET UNITYSDK_OFFSET(0x177A3E30)
#define RPG_GAMECORE_SYNCSUBPROPSTATE_METHOD_3_DFDF0F8DF6354E74_OFFSET UNITYSDK_OFFSET(0x177A3EC0)
#define RPG_GAMECORE_SYNCSUBPROPSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x177A3E90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SyncSubPropState_TypeDefinitionIndex = 20310;
