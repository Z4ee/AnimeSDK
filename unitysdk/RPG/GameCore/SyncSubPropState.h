...
#define RPG_GAMECORE_SYNCSUBPROPSTATE_METHOD_3_DFDF0F8DF6354E74_OFFSET UNITYSDK_OFFSET(0x1E15D180)
#define RPG_GAMECORE_SYNCSUBPROPSTATE_METHOD_3_FE8B72F261F59EF8_OFFSET UNITYSDK_OFFSET(0x1E15D130)
#define RPG_GAMECORE_SYNCSUBPROPSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E15D170)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SyncSubPropState_TypeDefinitionIndex = 21880;
