...
#define RPG_GAMECORE_AIVARIABLEFIXPOINT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x193C4F30)
#define RPG_GAMECORE_AIVARIABLEFIXPOINT_EQUALS_2_OFFSET UNITYSDK_OFFSET(0x193C4E20)
#define RPG_GAMECORE_AIVARIABLEFIXPOINT_EQUALS_OFFSET UNITYSDK_OFFSET(0x193C4DD0)
#define RPG_GAMECORE_AIVARIABLEFIXPOINT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x193C4FF0)
#define RPG_GAMECORE_AIVARIABLEFIXPOINT_METHOD_3_03174FDB36F50989_OFFSET UNITYSDK_OFFSET(0x193C4DA0)
#define RPG_GAMECORE_AIVARIABLEFIXPOINT_METHOD_3_6F8BF55838C3F6C5_1_OFFSET UNITYSDK_OFFSET(0x193C5120)
#define RPG_GAMECORE_AIVARIABLEFIXPOINT_METHOD_3_6F8BF55838C3F6C5_OFFSET UNITYSDK_OFFSET(0x193C50E0)
#define RPG_GAMECORE_AIVARIABLEFIXPOINT_METHOD_3_DF067467E6E7E848_OFFSET UNITYSDK_OFFSET(0x193C4160)
#define RPG_GAMECORE_AIVARIABLEFIXPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x193C4150)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AIVariableFixPoint_TypeDefinitionIndex = 14840;
