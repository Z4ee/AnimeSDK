...
#define RPG_GAMECORE_AIVARIABLEFIXPOINT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x16E93A80)
#define RPG_GAMECORE_AIVARIABLEFIXPOINT_EQUALS_2_OFFSET UNITYSDK_OFFSET(0x16E939E0)
#define RPG_GAMECORE_AIVARIABLEFIXPOINT_EQUALS_OFFSET UNITYSDK_OFFSET(0x16E93990)
#define RPG_GAMECORE_AIVARIABLEFIXPOINT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x16E93B40)
#define RPG_GAMECORE_AIVARIABLEFIXPOINT_METHOD_3_03174FDB36F50989_OFFSET UNITYSDK_OFFSET(0x16E93960)
#define RPG_GAMECORE_AIVARIABLEFIXPOINT_METHOD_3_6F8BF55838C3F6C5_1_OFFSET UNITYSDK_OFFSET(0x16E93C40)
#define RPG_GAMECORE_AIVARIABLEFIXPOINT_METHOD_3_6F8BF55838C3F6C5_OFFSET UNITYSDK_OFFSET(0x16E93C00)
#define RPG_GAMECORE_AIVARIABLEFIXPOINT_METHOD_3_DF067467E6E7E848_OFFSET UNITYSDK_OFFSET(0x16E92DF0)
#define RPG_GAMECORE_AIVARIABLEFIXPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x16E92DE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AIVariableFixPoint_TypeDefinitionIndex = 14306;
