...
#define RPG_GAMECORE_SETBATTLEUIPAUSEENVIRONMENTINFO_METHOD_3_003A0AAB8FB0EC48_OFFSET UNITYSDK_OFFSET(0x18E0D9D0)
#define RPG_GAMECORE_SETBATTLEUIPAUSEENVIRONMENTINFO_METHOD_3_CE71B7B143B5435F_OFFSET UNITYSDK_OFFSET(0x18E0DA50)
#define RPG_GAMECORE_SETBATTLEUIPAUSEENVIRONMENTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18E0DA20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetBattleUIPauseEnvironmentInfo_TypeDefinitionIndex = 21706;
