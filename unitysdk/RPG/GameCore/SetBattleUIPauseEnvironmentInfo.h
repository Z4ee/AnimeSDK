...
#define RPG_GAMECORE_SETBATTLEUIPAUSEENVIRONMENTINFO_METHOD_3_02E6787D1F31849E_OFFSET UNITYSDK_OFFSET(0x1E8107F0)
#define RPG_GAMECORE_SETBATTLEUIPAUSEENVIRONMENTINFO_METHOD_3_CE71B7B143B5435F_OFFSET UNITYSDK_OFFSET(0x1E810840)
#define RPG_GAMECORE_SETBATTLEUIPAUSEENVIRONMENTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1E810830)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetBattleUIPauseEnvironmentInfo_TypeDefinitionIndex = 22544;
