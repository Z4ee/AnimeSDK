...
#define RPG_GAMECORE_TARGETFETCHAIDPROTECTOR_METHOD_4_3928B57501EE2350_OFFSET UNITYSDK_OFFSET(0x1D5A7F20)
#define RPG_GAMECORE_TARGETFETCHAIDPROTECTOR_METHOD_4_9AC57A6F55AE0F5D_OFFSET UNITYSDK_OFFSET(0x1D5A7F00)
#define RPG_GAMECORE_TARGETFETCHAIDPROTECTOR_METHOD_4_B0F89AA3BF27A84D_OFFSET UNITYSDK_OFFSET(0x1D5A7E20)
#define RPG_GAMECORE_TARGETFETCHAIDPROTECTOR_METHOD_4_F2E2EE31F3B1AFE8_OFFSET UNITYSDK_OFFSET(0x1D5A7EA0)
#define RPG_GAMECORE_TARGETFETCHAIDPROTECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5A7E90)
