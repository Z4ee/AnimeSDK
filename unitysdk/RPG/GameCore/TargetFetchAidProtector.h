...
#define RPG_GAMECORE_TARGETFETCHAIDPROTECTOR_METHOD_4_23214774A509F57A_OFFSET UNITYSDK_OFFSET(0x177BCC70)
#define RPG_GAMECORE_TARGETFETCHAIDPROTECTOR_METHOD_4_F2E2EE31F3B1AFE8_OFFSET UNITYSDK_OFFSET(0x177B2180)
#define RPG_GAMECORE_TARGETFETCHAIDPROTECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x177B2130)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchAidProtector_TypeDefinitionIndex = 22284;
