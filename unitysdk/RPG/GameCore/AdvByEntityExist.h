...
#define RPG_GAMECORE_ADVBYENTITYEXIST_METHOD_4_75ED997B58287AB0_OFFSET UNITYSDK_OFFSET(0x18648760)
#define RPG_GAMECORE_ADVBYENTITYEXIST_METHOD_4_9C28652AF0061B1E_OFFSET UNITYSDK_OFFSET(0x18648830)
#define RPG_GAMECORE_ADVBYENTITYEXIST__CTOR_OFFSET UNITYSDK_OFFSET(0x186487E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvByEntityExist_TypeDefinitionIndex = 21118;
