...
#define RPG_GAMECORE_DEVICESETTINGGROUP_METHOD_2_ED1C112F1A61C362_OFFSET UNITYSDK_OFFSET(0x1D81AD80)
#define RPG_GAMECORE_DEVICESETTINGGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D81AFC0)
