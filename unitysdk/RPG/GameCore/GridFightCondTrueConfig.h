...
#define RPG_GAMECORE_GRIDFIGHTCONDTRUECONFIG_METHOD_6_537F70CEC5857840_OFFSET UNITYSDK_OFFSET(0x172556B0)
#define RPG_GAMECORE_GRIDFIGHTCONDTRUECONFIG_METHOD_6_D6BFD2CEB5114344_OFFSET UNITYSDK_OFFSET(0x172554F0)
#define RPG_GAMECORE_GRIDFIGHTCONDTRUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x172555F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightCondTrueConfig_TypeDefinitionIndex = 17746;
