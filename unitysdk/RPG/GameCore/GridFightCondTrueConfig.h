...
#define RPG_GAMECORE_GRIDFIGHTCONDTRUECONFIG_METHOD_6_537F70CEC5857840_OFFSET UNITYSDK_OFFSET(0x197DCFA0)
#define RPG_GAMECORE_GRIDFIGHTCONDTRUECONFIG_METHOD_6_D6BFD2CEB5114344_OFFSET UNITYSDK_OFFSET(0x197DCDE0)
#define RPG_GAMECORE_GRIDFIGHTCONDTRUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197DCEE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightCondTrueConfig_TypeDefinitionIndex = 18331;
