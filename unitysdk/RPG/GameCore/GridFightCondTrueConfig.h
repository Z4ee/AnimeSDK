...
#define RPG_GAMECORE_GRIDFIGHTCONDTRUECONFIG_METHOD_6_537F70CEC5857840_OFFSET UNITYSDK_OFFSET(0x1C5C5490)
#define RPG_GAMECORE_GRIDFIGHTCONDTRUECONFIG_METHOD_6_89648134C203C984_OFFSET UNITYSDK_OFFSET(0x1C5C5440)
#define RPG_GAMECORE_GRIDFIGHTCONDTRUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5C5480)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightCondTrueConfig_TypeDefinitionIndex = 18571;
