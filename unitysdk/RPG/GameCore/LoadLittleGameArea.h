...
#define RPG_GAMECORE_LOADLITTLEGAMEAREA_METHOD_3_51A4604A229CD756_OFFSET UNITYSDK_OFFSET(0x17364040)
#define RPG_GAMECORE_LOADLITTLEGAMEAREA_METHOD_3_E219E7BDC1551695_OFFSET UNITYSDK_OFFSET(0x17364190)
#define RPG_GAMECORE_LOADLITTLEGAMEAREA__CTOR_OFFSET UNITYSDK_OFFSET(0x17364100)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoadLittleGameArea_TypeDefinitionIndex = 19321;
