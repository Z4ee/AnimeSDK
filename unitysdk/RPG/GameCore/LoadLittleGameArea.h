...
#define RPG_GAMECORE_LOADLITTLEGAMEAREA_METHOD_3_9C1066DDDC4B6A8F_OFFSET UNITYSDK_OFFSET(0x1DD71BC0)
#define RPG_GAMECORE_LOADLITTLEGAMEAREA_METHOD_3_E219E7BDC1551695_OFFSET UNITYSDK_OFFSET(0x1DD71C40)
#define RPG_GAMECORE_LOADLITTLEGAMEAREA__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD71C10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoadLittleGameArea_TypeDefinitionIndex = 20757;
