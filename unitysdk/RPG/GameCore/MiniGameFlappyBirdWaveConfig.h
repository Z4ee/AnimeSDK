...
#define RPG_GAMECORE_MINIGAMEFLAPPYBIRDWAVECONFIG_METHOD_3_09F6C938873109F9_OFFSET UNITYSDK_OFFSET(0x1741CD50)
#define RPG_GAMECORE_MINIGAMEFLAPPYBIRDWAVECONFIG_METHOD_3_8A81B2542910F0A8_OFFSET UNITYSDK_OFFSET(0x1741CD00)
#define RPG_GAMECORE_MINIGAMEFLAPPYBIRDWAVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1741CD40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MiniGameFlappyBirdWaveConfig_TypeDefinitionIndex = 17262;
