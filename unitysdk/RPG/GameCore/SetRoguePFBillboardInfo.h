...
#define RPG_GAMECORE_SETROGUEPFBILLBOARDINFO_METHOD_4_A6C66B004CAC9FFA_OFFSET UNITYSDK_OFFSET(0x1C606C50)
#define RPG_GAMECORE_SETROGUEPFBILLBOARDINFO_METHOD_4_A966325A85A56BC3_OFFSET UNITYSDK_OFFSET(0x1C606C10)
#define RPG_GAMECORE_SETROGUEPFBILLBOARDINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1C606C40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetRoguePFBillboardInfo_TypeDefinitionIndex = 21275;
