...
#define RPG_GAMECORE_SETROGUEPFBILLBOARDINFO_METHOD_4_14CC4756E6BCFB7D_OFFSET UNITYSDK_OFFSET(0x176DCDC0)
#define RPG_GAMECORE_SETROGUEPFBILLBOARDINFO_METHOD_4_519EC204A3994E7A_OFFSET UNITYSDK_OFFSET(0x176DCD40)
#define RPG_GAMECORE_SETROGUEPFBILLBOARDINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x176DCD90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetRoguePFBillboardInfo_TypeDefinitionIndex = 20265;
