...
#define RPG_GAMECORE_SETROGUEPFBILLBOARDINFO_METHOD_4_A6C66B004CAC9FFA_OFFSET UNITYSDK_OFFSET(0x19C5D050)
#define RPG_GAMECORE_SETROGUEPFBILLBOARDINFO_METHOD_4_EA4FC2929367BC27_OFFSET UNITYSDK_OFFSET(0x19C5CFD0)
#define RPG_GAMECORE_SETROGUEPFBILLBOARDINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19C5D020)
