...
#define RPG_GAMECORE_FLOORSAVEDVALUEOVERRIDE_METHOD_2_E13950717E34196E_OFFSET UNITYSDK_OFFSET(0x18927280)
#define RPG_GAMECORE_FLOORSAVEDVALUEOVERRIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x189273D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FloorSavedValueOverride_TypeDefinitionIndex = 19242;
