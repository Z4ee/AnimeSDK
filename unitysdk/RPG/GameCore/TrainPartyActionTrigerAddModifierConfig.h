...
#define RPG_GAMECORE_TRAINPARTYACTIONTRIGERADDMODIFIERCONFIG_METHOD_5_14B467EBC7510812_OFFSET UNITYSDK_OFFSET(0x178A7A60)
#define RPG_GAMECORE_TRAINPARTYACTIONTRIGERADDMODIFIERCONFIG_METHOD_5_1F010051E036599B_OFFSET UNITYSDK_OFFSET(0x178A7C70)
#define RPG_GAMECORE_TRAINPARTYACTIONTRIGERADDMODIFIERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x178A7A10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyActionTrigerAddModifierConfig_TypeDefinitionIndex = 16589;
