...
#define RPG_GAMECORE_VISITORBEHAVIORCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B89D3A0)
#define RPG_GAMECORE_VISITORBEHAVIORCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B89D6F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VisitorBehaviorConfigRow_TypeDefinitionIndex = 14760;
	...
	public:
		...
		::System::UInt32 NpcBubbleTalkSentenceID; // 0x24
		::System::UInt32 RewardID; // 0x28
		::System::UInt32 VisitorID; // 0x2C
		::System::UInt32 NPCID; // 0x30
		::System::UInt32 DefaultPerformanceID; // 0x34
