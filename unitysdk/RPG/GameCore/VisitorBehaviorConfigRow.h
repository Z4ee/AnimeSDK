...
#define RPG_GAMECORE_VISITORBEHAVIORCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1DEB0B80)
#define RPG_GAMECORE_VISITORBEHAVIORCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEB0ED0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 DefaultIdleFreeStyleMotionID; // 0x18
		::System::UInt32 DefaultPerformanceID; // 0x1C
		::System::UInt32 VisitorID; // 0x20
		::System::Single NPCRotationYInfo; // 0x24
		::System::UInt32 PerformanceID; // 0x28
		::System::UInt32 NpcBubbleTalkSentenceID; // 0x2C
		::System::UInt32 NPCID; // 0x30
		::System::UInt32 AnchorID; // 0x34
		::System::UInt32 NPCGroupID; // 0x38
