...
#define RPG_GAMECORE_CHIMERATEAMWORKINCREASEROUNDCONFIG_METHOD_2_0B5822AB1669D0ED_OFFSET UNITYSDK_OFFSET(0x1CFD4AC0)
#define RPG_GAMECORE_CHIMERATEAMWORKINCREASEROUNDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFD4B00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraTeamWorkIncreaseRoundConfig_TypeDefinitionIndex = 15717;
