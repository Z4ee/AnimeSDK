...
#define RPG_GAMECORE_ROGUEMODIFIERCAVITYSYSTEMMODELCONFIG_METHOD_3_09BEE4EE18EDE670_OFFSET UNITYSDK_OFFSET(0x1CFBF340)
#define RPG_GAMECORE_ROGUEMODIFIERCAVITYSYSTEMMODELCONFIG_METHOD_3_FE7B22D4AC2C5C74_OFFSET UNITYSDK_OFFSET(0x1CFBF2F0)
#define RPG_GAMECORE_ROGUEMODIFIERCAVITYSYSTEMMODELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFBF330)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierCavitySystemModelConfig_TypeDefinitionIndex = 17038;
