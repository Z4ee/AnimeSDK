...
#define RPG_GAMECORE_HEARTDIALCONDITIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1981F5C0)
#define RPG_GAMECORE_HEARTDIALCONDITIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1981F7B0)
