...
#define RPG_GAMECORE_HEARTDIALCONDITIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x189EC480)
#define RPG_GAMECORE_HEARTDIALCONDITIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x189EC670)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HeartDialConditionRow_TypeDefinitionIndex = 12991;
	...
	public:
		...
		::RPG::GameCore::HeartDialFinishType FinishType; // 0x18
		::System::UInt32 ParamUint1; // 0x1C
