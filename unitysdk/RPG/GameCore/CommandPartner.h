...
#define RPG_GAMECORE_COMMANDPARTNER_METHOD_3_6E6CE316600633A4_OFFSET UNITYSDK_OFFSET(0x1D9A5BE0)
#define RPG_GAMECORE_COMMANDPARTNER_METHOD_3_C70F11EC73D4C6EB_OFFSET UNITYSDK_OFFSET(0x1D9A5C20)
#define RPG_GAMECORE_COMMANDPARTNER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D9A5C10)
