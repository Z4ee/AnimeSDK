...
#define RPG_GAMECORE_COMMANDPARTNER_METHOD_3_3BAB360B61A771DF_OFFSET UNITYSDK_OFFSET(0x1711FD80)
#define RPG_GAMECORE_COMMANDPARTNER_METHOD_3_C70F11EC73D4C6EB_OFFSET UNITYSDK_OFFSET(0x1711FE00)
#define RPG_GAMECORE_COMMANDPARTNER__CTOR_OFFSET UNITYSDK_OFFSET(0x1711FDD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CommandPartner_TypeDefinitionIndex = 20882;
