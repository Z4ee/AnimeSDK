...
#define RPG_GAMECORE_FREESTYLEMOTIONCONFIGROW_FROMBINARYWITHOUTNEW_OFFSET UNITYSDK_OFFSET(0x1B97FCC0)
#define RPG_GAMECORE_FREESTYLEMOTIONCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B97FF00)
#define RPG_GAMECORE_FREESTYLEMOTIONCONFIGROW_FROMTABLEOFFSET_OFFSET UNITYSDK_OFFSET(0x1B97FC40)
#define RPG_GAMECORE_FREESTYLEMOTIONCONFIGROW_RESET_OFFSET UNITYSDK_OFFSET(0x1B97FCA0)
#define RPG_GAMECORE_FREESTYLEMOTIONCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B980160)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FreeStyleMotionConfigRow_TypeDefinitionIndex = 12801;

	class FreeStyleMotionConfigRow : public ::System::Object
	{
	public:
		::System::String* StartMotionRibbonPath; // 0x10
		::System::String* LoopMotionPath; // 0x18
