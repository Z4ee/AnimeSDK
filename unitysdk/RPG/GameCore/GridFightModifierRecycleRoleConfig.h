...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERRECYCLEROLECONFIG_METHOD_3_05A05683AE6166E4_OFFSET UNITYSDK_OFFSET(0x189BE5F0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERRECYCLEROLECONFIG_METHOD_3_1FD5DF28DB93975D_OFFSET UNITYSDK_OFFSET(0x189BE6C0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERRECYCLEROLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189BE670)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierRecycleRoleConfig_TypeDefinitionIndex = 18478;
