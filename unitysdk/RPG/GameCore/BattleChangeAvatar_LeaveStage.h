...
#define RPG_GAMECORE_BATTLECHANGEAVATAR_LEAVESTAGE_METHOD_3_A47C5585530D801C_OFFSET UNITYSDK_OFFSET(0x16FCD020)
#define RPG_GAMECORE_BATTLECHANGEAVATAR_LEAVESTAGE_METHOD_3_CB25E771310451D0_OFFSET UNITYSDK_OFFSET(0x16FCCF10)
#define RPG_GAMECORE_BATTLECHANGEAVATAR_LEAVESTAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x16FCCFF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleChangeAvatar_LeaveStage_TypeDefinitionIndex = 20970;
