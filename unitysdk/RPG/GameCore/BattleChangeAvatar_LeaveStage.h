...
#define RPG_GAMECORE_BATTLECHANGEAVATAR_LEAVESTAGE_METHOD_3_A47C5585530D801C_OFFSET UNITYSDK_OFFSET(0x1A3E44E0)
#define RPG_GAMECORE_BATTLECHANGEAVATAR_LEAVESTAGE_METHOD_3_C5EEB06C8B134E19_OFFSET UNITYSDK_OFFSET(0x1A3E4410)
#define RPG_GAMECORE_BATTLECHANGEAVATAR_LEAVESTAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3E44D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleChangeAvatar_LeaveStage_TypeDefinitionIndex = 21957;
