...
#define RPG_GAMECORE_BATTLECHANGEAVATAR_LEAVESTAGE_METHOD_3_A47C5585530D801C_OFFSET UNITYSDK_OFFSET(0x194C41C0)
#define RPG_GAMECORE_BATTLECHANGEAVATAR_LEAVESTAGE_METHOD_3_CB25E771310451D0_OFFSET UNITYSDK_OFFSET(0x194C40B0)
#define RPG_GAMECORE_BATTLECHANGEAVATAR_LEAVESTAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x194C4190)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleChangeAvatar_LeaveStage_TypeDefinitionIndex = 21535;
