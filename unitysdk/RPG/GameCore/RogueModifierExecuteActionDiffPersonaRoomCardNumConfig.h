...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONDIFFPERSONAROOMCARDNUMCONFIG_METHOD_3_184914A34F13CC15_OFFSET UNITYSDK_OFFSET(0x18D34C60)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONDIFFPERSONAROOMCARDNUMCONFIG_METHOD_3_9542FF55B621C93C_OFFSET UNITYSDK_OFFSET(0x18D3C970)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONDIFFPERSONAROOMCARDNUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D34C10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionDiffPersonaRoomCardNumConfig_TypeDefinitionIndex = 16916;
