...
#define RPG_GAMECORE_BYNPCSTATUS_METHOD_4_977051FB2530E9BB_OFFSET UNITYSDK_OFFSET(0x1875B930)
#define RPG_GAMECORE_BYNPCSTATUS_METHOD_4_A2031675BF4F6A77_OFFSET UNITYSDK_OFFSET(0x1875BA00)
#define RPG_GAMECORE_BYNPCSTATUS__CTOR_OFFSET UNITYSDK_OFFSET(0x1875B9B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByNPCStatus_TypeDefinitionIndex = 18958;
