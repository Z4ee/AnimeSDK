...
#define RPG_GAMECORE_TICKLODTEMPLATE_METHOD_3_3D22330C3BA79CA9_OFFSET UNITYSDK_OFFSET(0x19098810)
#define RPG_GAMECORE_TICKLODTEMPLATE_METHOD_3_BF92BFE4E0A156F4_OFFSET UNITYSDK_OFFSET(0x190987D0)
#define RPG_GAMECORE_TICKLODTEMPLATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19098800)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TickLodTemplate_TypeDefinitionIndex = 18258;
