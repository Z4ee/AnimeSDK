...
#define RPG_GAMECORE_TICKLODTEMPLATE_METHOD_3_9F870A6B854B442F_OFFSET UNITYSDK_OFFSET(0x1C1501B0)
#define RPG_GAMECORE_TICKLODTEMPLATE_METHOD_3_AE8CECB56EBA93A5_OFFSET UNITYSDK_OFFSET(0x1C1501F0)
#define RPG_GAMECORE_TICKLODTEMPLATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1501E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TickLodTemplate_TypeDefinitionIndex = 18465;
