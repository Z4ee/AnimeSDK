...
#define RPG_GAMECORE_ENABLENEGATIVEHP_METHOD_3_8D6DD034BC24894E_OFFSET UNITYSDK_OFFSET(0x188A6B30)
#define RPG_GAMECORE_ENABLENEGATIVEHP_METHOD_3_A9309D4160CB719F_OFFSET UNITYSDK_OFFSET(0x188A6AB0)
#define RPG_GAMECORE_ENABLENEGATIVEHP__CTOR_OFFSET UNITYSDK_OFFSET(0x188A6B00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnableNegativeHP_TypeDefinitionIndex = 22704;
