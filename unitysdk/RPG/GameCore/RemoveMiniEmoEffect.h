...
#define RPG_GAMECORE_REMOVEMINIEMOEFFECT_METHOD_3_5236D6B96D867145_OFFSET UNITYSDK_OFFSET(0x17598D50)
#define RPG_GAMECORE_REMOVEMINIEMOEFFECT_METHOD_3_81103B3332A73D40_OFFSET UNITYSDK_OFFSET(0x17598C80)
#define RPG_GAMECORE_REMOVEMINIEMOEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x17598D00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveMiniEmoEffect_TypeDefinitionIndex = 20033;
