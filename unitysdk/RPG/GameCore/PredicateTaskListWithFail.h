...
#define RPG_GAMECORE_PREDICATETASKLISTWITHFAIL_METHOD_3_072AD0E25B0A6EB2_OFFSET UNITYSDK_OFFSET(0x175108B0)
#define RPG_GAMECORE_PREDICATETASKLISTWITHFAIL_METHOD_3_7A28C3E53CFDB510_OFFSET UNITYSDK_OFFSET(0x17510830)
#define RPG_GAMECORE_PREDICATETASKLISTWITHFAIL__CTOR_OFFSET UNITYSDK_OFFSET(0x17510880)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PredicateTaskListWithFail_TypeDefinitionIndex = 22092;
