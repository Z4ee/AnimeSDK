...
#define RPG_GAMECORE_PREDICATETASKLISTWITHFAIL_METHOD_3_072AD0E25B0A6EB2_OFFSET UNITYSDK_OFFSET(0x1BA15010)
#define RPG_GAMECORE_PREDICATETASKLISTWITHFAIL_METHOD_3_720609E7FFAB392D_OFFSET UNITYSDK_OFFSET(0x1BA14FD0)
#define RPG_GAMECORE_PREDICATETASKLISTWITHFAIL__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA15000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PredicateTaskListWithFail_TypeDefinitionIndex = 22962;
