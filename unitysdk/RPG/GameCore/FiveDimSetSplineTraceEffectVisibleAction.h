...
#define RPG_GAMECORE_FIVEDIMSETSPLINETRACEEFFECTVISIBLEACTION_METHOD_3_6E0A96578D8F459C_OFFSET UNITYSDK_OFFSET(0x1720B300)
#define RPG_GAMECORE_FIVEDIMSETSPLINETRACEEFFECTVISIBLEACTION_METHOD_3_F4379460B89246E8_OFFSET UNITYSDK_OFFSET(0x1720B430)
#define RPG_GAMECORE_FIVEDIMSETSPLINETRACEEFFECTVISIBLEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1720B410)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSetSplineTraceEffectVisibleAction_TypeDefinitionIndex = 17215;
