...
#define RPG_GAMECORE_FIVEDIMSETSPLINETRACEEFFECTVISIBLEACTION_METHOD_3_6E0A96578D8F459C_OFFSET UNITYSDK_OFFSET(0x197564E0)
#define RPG_GAMECORE_FIVEDIMSETSPLINETRACEEFFECTVISIBLEACTION_METHOD_3_F4379460B89246E8_OFFSET UNITYSDK_OFFSET(0x19756610)
#define RPG_GAMECORE_FIVEDIMSETSPLINETRACEEFFECTVISIBLEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x197565F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSetSplineTraceEffectVisibleAction_TypeDefinitionIndex = 17844;
