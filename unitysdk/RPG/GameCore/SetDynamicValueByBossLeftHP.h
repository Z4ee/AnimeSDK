...
#define RPG_GAMECORE_SETDYNAMICVALUEBYBOSSLEFTHP_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x18E1DF70)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBOSSLEFTHP_METHOD_4_77C6C3F63EA63FC2_OFFSET UNITYSDK_OFFSET(0x18E1DCF0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBOSSLEFTHP_METHOD_4_F48462ED69AA1E26_OFFSET UNITYSDK_OFFSET(0x18E1DDC0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBOSSLEFTHP__CTOR_OFFSET UNITYSDK_OFFSET(0x18E1DD70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByBossLeftHP_TypeDefinitionIndex = 21677;
