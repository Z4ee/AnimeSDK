...
#define RPG_GAMECORE_SETDYNAMICVALUEBYBOSSLEFTHP_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1E81ABA0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBOSSLEFTHP_METHOD_4_DF1A67C31E24BE8F_OFFSET UNITYSDK_OFFSET(0x1E81A9B0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBOSSLEFTHP_METHOD_4_F48462ED69AA1E26_OFFSET UNITYSDK_OFFSET(0x1E81A9F0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBOSSLEFTHP__CTOR_OFFSET UNITYSDK_OFFSET(0x1E81A9E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByBossLeftHP_TypeDefinitionIndex = 22516;
