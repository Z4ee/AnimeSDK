...
#define RPG_GAMECORE_BYCOMPARESWITCHHANDGESTURETYPE_METHOD_4_716E189235F6C131_OFFSET UNITYSDK_OFFSET(0x1A8AB390)
#define RPG_GAMECORE_BYCOMPARESWITCHHANDGESTURETYPE_METHOD_4_C7FF4DBE28B3B838_OFFSET UNITYSDK_OFFSET(0x1A8AB540)
#define RPG_GAMECORE_BYCOMPARESWITCHHANDGESTURETYPE_METHOD_4_DED45653BA1C9534_OFFSET UNITYSDK_OFFSET(0x1A8AB350)
#define RPG_GAMECORE_BYCOMPARESWITCHHANDGESTURETYPE_METHOD_4_DF0AD549DD47F15F_OFFSET UNITYSDK_OFFSET(0x1A8AB570)
#define RPG_GAMECORE_BYCOMPARESWITCHHANDGESTURETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8AB380)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareSwitchHandGestureType_TypeDefinitionIndex = 20166;
