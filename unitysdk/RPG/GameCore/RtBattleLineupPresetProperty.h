...
#define RPG_GAMECORE_RTBATTLELINEUPPRESETPROPERTY_METHOD_2_369F7384FA700429_OFFSET UNITYSDK_OFFSET(0x19BDBC20)
#define RPG_GAMECORE_RTBATTLELINEUPPRESETPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x19BDBC60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtBattleLineupPresetProperty_TypeDefinitionIndex = 17155;
