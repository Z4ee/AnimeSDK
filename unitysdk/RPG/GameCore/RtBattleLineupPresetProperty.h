...
#define RPG_GAMECORE_RTBATTLELINEUPPRESETPROPERTY_METHOD_2_369F7384FA700429_OFFSET UNITYSDK_OFFSET(0x1D49AF30)
#define RPG_GAMECORE_RTBATTLELINEUPPRESETPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D49AF70)
