...
#define RPG_GAMECORE_RTBATTLELINEUPPRESETPROPERTY_METHOD_2_369F7384FA700429_OFFSET UNITYSDK_OFFSET(0x18DC5360)
#define RPG_GAMECORE_RTBATTLELINEUPPRESETPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x18DC53A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtBattleLineupPresetProperty_TypeDefinitionIndex = 17145;
