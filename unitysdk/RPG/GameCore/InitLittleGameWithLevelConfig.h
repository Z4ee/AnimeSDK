...
#define RPG_GAMECORE_INITLITTLEGAMEWITHLEVELCONFIG_METHOD_3_67991288636D2BFA_OFFSET UNITYSDK_OFFSET(0x1D1ACAF0)
#define RPG_GAMECORE_INITLITTLEGAMEWITHLEVELCONFIG_METHOD_3_FB5EE21C63298C48_OFFSET UNITYSDK_OFFSET(0x1D1ACA70)
#define RPG_GAMECORE_INITLITTLEGAMEWITHLEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1ACAC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int InitLittleGameWithLevelConfig_TypeDefinitionIndex = 20749;
