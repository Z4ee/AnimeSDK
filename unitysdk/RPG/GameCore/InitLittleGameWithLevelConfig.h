...
#define RPG_GAMECORE_INITLITTLEGAMEWITHLEVELCONFIG_METHOD_3_67991288636D2BFA_OFFSET UNITYSDK_OFFSET(0x172BC6B0)
#define RPG_GAMECORE_INITLITTLEGAMEWITHLEVELCONFIG_METHOD_3_FC60A0992DC10937_OFFSET UNITYSDK_OFFSET(0x172BC560)
#define RPG_GAMECORE_INITLITTLEGAMEWITHLEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x172BC620)

namespace RPG::GameCore
{
	inline static constexpr unsigned int InitLittleGameWithLevelConfig_TypeDefinitionIndex = 19317;
