...
#define RPG_GAMECORE_HIDEWAYPOINTBYPROP_METHOD_3_7E0AE979613413F1_OFFSET UNITYSDK_OFFSET(0x18A001B0)
#define RPG_GAMECORE_HIDEWAYPOINTBYPROP_METHOD_3_BA31BD3AF1D67AD9_OFFSET UNITYSDK_OFFSET(0x18A00130)
#define RPG_GAMECORE_HIDEWAYPOINTBYPROP__CTOR_OFFSET UNITYSDK_OFFSET(0x18A00180)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HideWaypointByProp_TypeDefinitionIndex = 19860;
