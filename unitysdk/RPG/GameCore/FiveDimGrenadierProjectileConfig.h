...
#define RPG_GAMECORE_FIVEDIMGRENADIERPROJECTILECONFIG_METHOD_2_D667AAA6908C3DBF_OFFSET UNITYSDK_OFFSET(0x1D0EBE50)
#define RPG_GAMECORE_FIVEDIMGRENADIERPROJECTILECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0EBF20)
