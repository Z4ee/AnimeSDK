...
#define RPG_GAMECORE_ROGUEMODIFIERTITANBLESSANAXAEXCONFIG_METHOD_3_107DE74940CF5B73_OFFSET UNITYSDK_OFFSET(0x19B9D170)
#define RPG_GAMECORE_ROGUEMODIFIERTITANBLESSANAXAEXCONFIG_METHOD_3_69D3510544EE5CBA_OFFSET UNITYSDK_OFFSET(0x19B9D0A0)
#define RPG_GAMECORE_ROGUEMODIFIERTITANBLESSANAXAEXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B9D120)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierTitanBlessAnaxaExConfig_TypeDefinitionIndex = 16884;
