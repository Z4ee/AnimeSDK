...
#define RPG_GAMECORE_ROGUEMODIFIERTITANBLESSANAXAEXCONFIG_METHOD_3_107DE74940CF5B73_OFFSET UNITYSDK_OFFSET(0x1762D9D0)
#define RPG_GAMECORE_ROGUEMODIFIERTITANBLESSANAXAEXCONFIG_METHOD_3_69D3510544EE5CBA_OFFSET UNITYSDK_OFFSET(0x17639BB0)
#define RPG_GAMECORE_ROGUEMODIFIERTITANBLESSANAXAEXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1762D980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierTitanBlessAnaxaExConfig_TypeDefinitionIndex = 16315;
