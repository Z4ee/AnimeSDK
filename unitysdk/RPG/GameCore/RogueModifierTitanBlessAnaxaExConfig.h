...
#define RPG_GAMECORE_ROGUEMODIFIERTITANBLESSANAXAEXCONFIG_METHOD_3_107DE74940CF5B73_OFFSET UNITYSDK_OFFSET(0x1D1666D0)
#define RPG_GAMECORE_ROGUEMODIFIERTITANBLESSANAXAEXCONFIG_METHOD_3_C6EEE36EF75969AF_OFFSET UNITYSDK_OFFSET(0x1D166680)
#define RPG_GAMECORE_ROGUEMODIFIERTITANBLESSANAXAEXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1666C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierTitanBlessAnaxaExConfig_TypeDefinitionIndex = 17046;
