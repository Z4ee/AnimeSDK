...
#define RPG_GAMECORE_FATECONDLASTBATTLEWINCONFIG_METHOD_6_D2EB1E671CE2E420_OFFSET UNITYSDK_OFFSET(0x171C4550)
#define RPG_GAMECORE_FATECONDLASTBATTLEWINCONFIG_METHOD_6_D44ED8659FF99D84_OFFSET UNITYSDK_OFFSET(0x171C4710)
#define RPG_GAMECORE_FATECONDLASTBATTLEWINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171C4650)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateCondLastBattleWinConfig_TypeDefinitionIndex = 17676;
