...
#define RPG_GAMECORE_FATECONDLASTBATTLEWINCONFIG_METHOD_6_D44ED8659FF99D84_OFFSET UNITYSDK_OFFSET(0x1C074520)
#define RPG_GAMECORE_FATECONDLASTBATTLEWINCONFIG_METHOD_6_E0020A8A9529DDC8_OFFSET UNITYSDK_OFFSET(0x1C0744D0)
#define RPG_GAMECORE_FATECONDLASTBATTLEWINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C074510)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateCondLastBattleWinConfig_TypeDefinitionIndex = 18496;
