...
#define RPG_GAMECORE_PLAYERCONDCONFIGBASE_METHOD_4_9B6FEDE9E4474E79_OFFSET UNITYSDK_OFFSET(0x18C21CF0)
#define RPG_GAMECORE_PLAYERCONDCONFIGBASE_METHOD_4_DCABBC680DD0F634_OFFSET UNITYSDK_OFFSET(0x18C21EB0)
#define RPG_GAMECORE_PLAYERCONDCONFIGBASE__CCTOR_OFFSET UNITYSDK_OFFSET(0x18C21F40)
#define RPG_GAMECORE_PLAYERCONDCONFIGBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x18C21EC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayerCondConfigBase_TypeDefinitionIndex = 18563;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Func_2<::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::PlayerCondConfigBase*>*>**)Il2CppClass::FromTypeDefinitionIndex(PlayerCondConfigBase_TypeDefinitionIndex)->GetStaticField(0x45B60);
		}
