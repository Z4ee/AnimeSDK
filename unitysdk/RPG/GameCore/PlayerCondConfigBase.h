...
#define RPG_GAMECORE_PLAYERCONDCONFIGBASE_METHOD_4_CBC61A8A9CF53D82_OFFSET UNITYSDK_OFFSET(0x1BA09700)
#define RPG_GAMECORE_PLAYERCONDCONFIGBASE_METHOD_4_DCABBC680DD0F634_OFFSET UNITYSDK_OFFSET(0x1BA09760)
#define RPG_GAMECORE_PLAYERCONDCONFIGBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA09770)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayerCondConfigBase_TypeDefinitionIndex = 18804;
