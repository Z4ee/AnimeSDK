...
#define RPG_GAMECORE_ADVENTUREAICONTROLLERCONFIG_METHOD_2_FBE0A6606F965EBA_OFFSET UNITYSDK_OFFSET(0x16F497F0)
#define RPG_GAMECORE_ADVENTUREAICONTROLLERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16F49B70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureAIControllerConfig_TypeDefinitionIndex = 16015;
