...
#define RPG_GAMECORE_SETTARGETCOLLIDERLAYER_METHOD_3_864C0C23D43EB61F_OFFSET UNITYSDK_OFFSET(0x1D5104A0)
#define RPG_GAMECORE_SETTARGETCOLLIDERLAYER_METHOD_3_DCD2EEC32B6CD459_OFFSET UNITYSDK_OFFSET(0x1D510520)
#define RPG_GAMECORE_SETTARGETCOLLIDERLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5104F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetTargetColliderLayer_TypeDefinitionIndex = 21928;
