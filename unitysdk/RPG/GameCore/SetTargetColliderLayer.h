...
#define RPG_GAMECORE_SETTARGETCOLLIDERLAYER_METHOD_3_54533BB757908E07_OFFSET UNITYSDK_OFFSET(0x176E1410)
#define RPG_GAMECORE_SETTARGETCOLLIDERLAYER_METHOD_3_DCD2EEC32B6CD459_OFFSET UNITYSDK_OFFSET(0x176E1560)
#define RPG_GAMECORE_SETTARGETCOLLIDERLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x176E14D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetTargetColliderLayer_TypeDefinitionIndex = 20361;
