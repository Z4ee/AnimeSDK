...
#define RPG_GAMECORE_CHENLINGRAGEMODECONFIG_METHOD_2_DD176627956ED3B5_OFFSET UNITYSDK_OFFSET(0x1C37C0A0)
#define RPG_GAMECORE_CHENLINGRAGEMODECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C389CC0)
