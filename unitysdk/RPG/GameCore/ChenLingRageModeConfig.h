...
#define RPG_GAMECORE_CHENLINGRAGEMODECONFIG_METHOD_2_DD176627956ED3B5_OFFSET UNITYSDK_OFFSET(0x187E40F0)
#define RPG_GAMECORE_CHENLINGRAGEMODECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x187ED9B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingRageModeConfig_TypeDefinitionIndex = 14850;
