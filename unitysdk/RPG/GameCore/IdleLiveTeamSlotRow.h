...
#define RPG_GAMECORE_IDLELIVETEAMSLOTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B009150)
#define RPG_GAMECORE_IDLELIVETEAMSLOTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B009440)

namespace RPG::GameCore
{
	inline static constexpr unsigned int IdleLiveTeamSlotRow_TypeDefinitionIndex = 11275;
	...
	public:
		...
		::RPG::GameCore::FixPoint SlotPowerFactor; // 0x28
		::RPG::GameCore::ILBattleCharacterLocation Type; // 0x30
