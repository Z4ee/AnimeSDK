...
#define RPG_GAMECORE_IDLELIVETEAMSLOTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D2166F0)
#define RPG_GAMECORE_IDLELIVETEAMSLOTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2169E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int IdleLiveTeamSlotRow_TypeDefinitionIndex = 11664;

	class IdleLiveTeamSlotRow : public ::System::Object
	{
	public:
		::System::UInt32 UnlockID; // 0x10
		::RPG::GameCore::ILBattleCharacterLocation Type; // 0x14
		::RPG::Client::TextID Name; // 0x18
		::RPG::Client::TextID UnlockHint; // 0x28
		::RPG::GameCore::FixPoint SlotPowerFactor; // 0x38
		::System::UInt32 Slot; // 0x40
