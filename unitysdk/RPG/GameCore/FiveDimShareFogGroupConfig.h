...
#define RPG_GAMECORE_FIVEDIMSHAREFOGGROUPCONFIG_METHOD_2_CB7FDB2FF1F6593C_OFFSET UNITYSDK_OFFSET(0x197569C0)
#define RPG_GAMECORE_FIVEDIMSHAREFOGGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19756A00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimShareFogGroupConfig_TypeDefinitionIndex = 17620;
