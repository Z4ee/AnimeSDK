...
#define RPG_GAMECORE_FIVEDIMSHAREFOGGROUPCONFIG_METHOD_2_CB7FDB2FF1F6593C_OFFSET UNITYSDK_OFFSET(0x1D87AB50)
#define RPG_GAMECORE_FIVEDIMSHAREFOGGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D87AB90)
