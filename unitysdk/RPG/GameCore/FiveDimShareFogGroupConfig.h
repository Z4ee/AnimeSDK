...
#define RPG_GAMECORE_FIVEDIMSHAREFOGGROUPCONFIG_METHOD_2_CB7FDB2FF1F6593C_OFFSET UNITYSDK_OFFSET(0x1720B850)
#define RPG_GAMECORE_FIVEDIMSHAREFOGGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1720B890)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimShareFogGroupConfig_TypeDefinitionIndex = 17000;
