...
#define RPG_GAMECORE_ADVSETUPTRAINCOLLECTIONSYSTEM_METHOD_3_1F94FCE9B4CD6087_OFFSET UNITYSDK_OFFSET(0x16F43EA0)
#define RPG_GAMECORE_ADVSETUPTRAINCOLLECTIONSYSTEM_METHOD_3_78FDB2165125FA4E_OFFSET UNITYSDK_OFFSET(0x16F43F20)
#define RPG_GAMECORE_ADVSETUPTRAINCOLLECTIONSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x16F43EF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSetupTrainCollectionSystem_TypeDefinitionIndex = 19369;
