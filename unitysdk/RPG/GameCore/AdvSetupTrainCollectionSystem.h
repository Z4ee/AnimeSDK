...
#define RPG_GAMECORE_ADVSETUPTRAINCOLLECTIONSYSTEM_METHOD_3_37E81BB705F4A1FC_OFFSET UNITYSDK_OFFSET(0x1CBA39B0)
#define RPG_GAMECORE_ADVSETUPTRAINCOLLECTIONSYSTEM_METHOD_3_EE3A8E3654E62AF9_OFFSET UNITYSDK_OFFSET(0x1CBA39F0)
#define RPG_GAMECORE_ADVSETUPTRAINCOLLECTIONSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1CBA39E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSetupTrainCollectionSystem_TypeDefinitionIndex = 20802;
