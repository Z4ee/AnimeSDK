...
#define RPG_GAMECORE_ROGUEMAGICOPTIONALLAYERGATE_METHOD_3_430FC500E0012916_OFFSET UNITYSDK_OFFSET(0x19B45A00)
#define RPG_GAMECORE_ROGUEMAGICOPTIONALLAYERGATE_METHOD_3_8F1748EF83B6C94A_OFFSET UNITYSDK_OFFSET(0x19B458F0)
#define RPG_GAMECORE_ROGUEMAGICOPTIONALLAYERGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19B459D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueMagicOptionalLayerGate_TypeDefinitionIndex = 20901;
