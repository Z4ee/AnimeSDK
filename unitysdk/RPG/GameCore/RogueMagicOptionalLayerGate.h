...
#define RPG_GAMECORE_ROGUEMAGICOPTIONALLAYERGATE_METHOD_3_430FC500E0012916_OFFSET UNITYSDK_OFFSET(0x18D21BF0)
#define RPG_GAMECORE_ROGUEMAGICOPTIONALLAYERGATE_METHOD_3_8F1748EF83B6C94A_OFFSET UNITYSDK_OFFSET(0x18D21AE0)
#define RPG_GAMECORE_ROGUEMAGICOPTIONALLAYERGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18D21BC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueMagicOptionalLayerGate_TypeDefinitionIndex = 20989;
