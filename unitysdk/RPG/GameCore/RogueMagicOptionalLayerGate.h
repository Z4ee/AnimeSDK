...
#define RPG_GAMECORE_ROGUEMAGICOPTIONALLAYERGATE_METHOD_3_0A855D976D101053_OFFSET UNITYSDK_OFFSET(0x1CFB6B30)
#define RPG_GAMECORE_ROGUEMAGICOPTIONALLAYERGATE_METHOD_3_430FC500E0012916_OFFSET UNITYSDK_OFFSET(0x1CFB6C00)
#define RPG_GAMECORE_ROGUEMAGICOPTIONALLAYERGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFB6BF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueMagicOptionalLayerGate_TypeDefinitionIndex = 21316;
