...
#define RPG_GAMECORE_POINTGENERATORCONFIG_METHOD_2_70F563C723732728_OFFSET UNITYSDK_OFFSET(0x18C37540)
#define RPG_GAMECORE_POINTGENERATORCONFIG_METHOD_2_E1940CD1E943E023_OFFSET UNITYSDK_OFFSET(0x18C37270)
#define RPG_GAMECORE_POINTGENERATORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18C37530)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PointGeneratorConfig_TypeDefinitionIndex = 14790;
