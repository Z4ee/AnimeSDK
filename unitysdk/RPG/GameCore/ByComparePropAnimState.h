...
#define RPG_GAMECORE_BYCOMPAREPROPANIMSTATE_METHOD_4_2DAC096B4DD86DF5_OFFSET UNITYSDK_OFFSET(0x1CEF0BF0)
#define RPG_GAMECORE_BYCOMPAREPROPANIMSTATE_METHOD_4_438EE335EE4BFADB_OFFSET UNITYSDK_OFFSET(0x1CEF0B70)
#define RPG_GAMECORE_BYCOMPAREPROPANIMSTATE_METHOD_4_9717C8451459CCBA_OFFSET UNITYSDK_OFFSET(0x1CEF0E00)
#define RPG_GAMECORE_BYCOMPAREPROPANIMSTATE_METHOD_4_BE7F8B4014E01C57_OFFSET UNITYSDK_OFFSET(0x1CEF0DB0)
#define RPG_GAMECORE_BYCOMPAREPROPANIMSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEF0BC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByComparePropAnimState_TypeDefinitionIndex = 21711;
