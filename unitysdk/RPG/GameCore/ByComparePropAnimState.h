...
#define RPG_GAMECORE_BYCOMPAREPROPANIMSTATE_METHOD_4_2DAC096B4DD86DF5_OFFSET UNITYSDK_OFFSET(0x18736E40)
#define RPG_GAMECORE_BYCOMPAREPROPANIMSTATE_METHOD_4_C94FF5F5C7AFDBBE_OFFSET UNITYSDK_OFFSET(0x18736CA0)
#define RPG_GAMECORE_BYCOMPAREPROPANIMSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18736D80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByComparePropAnimState_TypeDefinitionIndex = 20812;
