...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERBACKROLEDISPLAYCHANGEBEFOREBATTLECONFIG_METHOD_3_7F33BF6BB0890062_OFFSET UNITYSDK_OFFSET(0x197E9A90)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERBACKROLEDISPLAYCHANGEBEFOREBATTLECONFIG_METHOD_3_CE456691D686666B_OFFSET UNITYSDK_OFFSET(0x197E99C0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERBACKROLEDISPLAYCHANGEBEFOREBATTLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197E9A40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierBackRoleDisplayChangeBeforeBattleConfig_TypeDefinitionIndex = 18488;
