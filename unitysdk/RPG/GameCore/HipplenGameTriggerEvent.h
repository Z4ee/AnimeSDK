...
#define RPG_GAMECORE_HIPPLENGAMETRIGGEREVENT_METHOD_3_08A1D262F1233F7A_OFFSET UNITYSDK_OFFSET(0x172AD820)
#define RPG_GAMECORE_HIPPLENGAMETRIGGEREVENT_METHOD_3_8B6CA4415683C903_OFFSET UNITYSDK_OFFSET(0x172AD7A0)
#define RPG_GAMECORE_HIPPLENGAMETRIGGEREVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x172AD7F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HipplenGameTriggerEvent_TypeDefinitionIndex = 19621;
