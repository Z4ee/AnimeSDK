...
#define RPG_GAMECORE_HIPPLENGAMETRIGGEREVENT_METHOD_3_08A1D262F1233F7A_OFFSET UNITYSDK_OFFSET(0x18A02440)
#define RPG_GAMECORE_HIPPLENGAMETRIGGEREVENT_METHOD_3_8B6CA4415683C903_OFFSET UNITYSDK_OFFSET(0x18A023C0)
#define RPG_GAMECORE_HIPPLENGAMETRIGGEREVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x18A02410)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HipplenGameTriggerEvent_TypeDefinitionIndex = 20301;
