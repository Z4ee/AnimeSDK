...
#define RPG_GAMECORE_DEVICERELATEDFLOAT_METHOD_3_B2C753CAD7FC4A97_OFFSET UNITYSDK_OFFSET(0x1C105F50)
#define RPG_GAMECORE_DEVICERELATEDFLOAT_METHOD_3_ED35481A76A4682D_OFFSET UNITYSDK_OFFSET(0x1C1068E0)
#define RPG_GAMECORE_DEVICERELATEDFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C105F40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DeviceRelatedFloat_TypeDefinitionIndex = 15819;
