...
#define RPG_GAMECORE_CHIMERABATTLESHOWNPCTALKBUBBLE_METHOD_3_6A3EC3280202065A_OFFSET UNITYSDK_OFFSET(0x1C38EB60)
#define RPG_GAMECORE_CHIMERABATTLESHOWNPCTALKBUBBLE_METHOD_3_D1A839A20C9D1476_OFFSET UNITYSDK_OFFSET(0x1C38FC10)
#define RPG_GAMECORE_CHIMERABATTLESHOWNPCTALKBUBBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C38EB50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraBattleShowNPCTalkBubble_TypeDefinitionIndex = 15262;
