...
#define RPG_GAMECORE_FOURROTATEVOXELANIMALATTACHBILLBOARDCONFIG_METHOD_3_44E258685273316C_OFFSET UNITYSDK_OFFSET(0x1721A2D0)
#define RPG_GAMECORE_FOURROTATEVOXELANIMALATTACHBILLBOARDCONFIG_METHOD_3_795170A1E9531471_OFFSET UNITYSDK_OFFSET(0x1721A260)
#define RPG_GAMECORE_FOURROTATEVOXELANIMALATTACHBILLBOARDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1721A2B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FourRotateVoxelAnimalAttachBillboardConfig_TypeDefinitionIndex = 15365;
