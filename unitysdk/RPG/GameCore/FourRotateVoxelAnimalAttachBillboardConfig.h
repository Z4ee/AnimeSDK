...
#define RPG_GAMECORE_FOURROTATEVOXELANIMALATTACHBILLBOARDCONFIG_METHOD_3_CAB754287B34AD06_OFFSET UNITYSDK_OFFSET(0x1B9793E0)
#define RPG_GAMECORE_FOURROTATEVOXELANIMALATTACHBILLBOARDCONFIG_METHOD_3_F838ABA09515F3F3_OFFSET UNITYSDK_OFFSET(0x1B979420)
#define RPG_GAMECORE_FOURROTATEVOXELANIMALATTACHBILLBOARDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B979410)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FourRotateVoxelAnimalAttachBillboardConfig_TypeDefinitionIndex = 16117;
