...
#define RPG_GAMECORE_SETDYNAMICVALUEBYPROPERTY_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1C2E66A0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYPROPERTY_METHOD_4_79592DE3421A5CF6_OFFSET UNITYSDK_OFFSET(0x1C2E62B0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYPROPERTY_METHOD_4_AF07DF4CCC2B992F_OFFSET UNITYSDK_OFFSET(0x1C2E6150)
#define RPG_GAMECORE_SETDYNAMICVALUEBYPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2E62A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByProperty_TypeDefinitionIndex = 22255;
