...
#define RPG_GAMECORE_SETDYNAMICVALUEBYPROPERTY_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x19C42F90)
#define RPG_GAMECORE_SETDYNAMICVALUEBYPROPERTY_METHOD_4_79592DE3421A5CF6_OFFSET UNITYSDK_OFFSET(0x19C3DE10)
#define RPG_GAMECORE_SETDYNAMICVALUEBYPROPERTY_METHOD_4_93D217AC25BD61F0_OFFSET UNITYSDK_OFFSET(0x19C42D90)
#define RPG_GAMECORE_SETDYNAMICVALUEBYPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x19C3DDC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByProperty_TypeDefinitionIndex = 21829;
