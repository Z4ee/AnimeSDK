...
#define RPG_GAMECORE_CHIMERADUELMASTERIDVALUEGETTER_METHOD_3_501C7D920EC04CD8_OFFSET UNITYSDK_OFFSET(0x196417E0)
#define RPG_GAMECORE_CHIMERADUELMASTERIDVALUEGETTER_METHOD_3_CC3169581E016068_OFFSET UNITYSDK_OFFSET(0x19641840)
#define RPG_GAMECORE_CHIMERADUELMASTERIDVALUEGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19641830)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelMasterIDValueGetter_TypeDefinitionIndex = 15220;
