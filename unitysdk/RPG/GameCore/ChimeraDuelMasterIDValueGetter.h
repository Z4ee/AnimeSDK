...
#define RPG_GAMECORE_CHIMERADUELMASTERIDVALUEGETTER_METHOD_3_501C7D920EC04CD8_OFFSET UNITYSDK_OFFSET(0x170A0490)
#define RPG_GAMECORE_CHIMERADUELMASTERIDVALUEGETTER_METHOD_3_CC3169581E016068_OFFSET UNITYSDK_OFFSET(0x170A04F0)
#define RPG_GAMECORE_CHIMERADUELMASTERIDVALUEGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x170A04E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelMasterIDValueGetter_TypeDefinitionIndex = 14689;
