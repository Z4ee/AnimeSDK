...
#define RPG_GAMECORE_CHIMERADUELMASTERIDVALUEGETTER_METHOD_3_501C7D920EC04CD8_OFFSET UNITYSDK_OFFSET(0x1CFC9FB0)
#define RPG_GAMECORE_CHIMERADUELMASTERIDVALUEGETTER_METHOD_3_CC3169581E016068_OFFSET UNITYSDK_OFFSET(0x1CFCA010)
#define RPG_GAMECORE_CHIMERADUELMASTERIDVALUEGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFCA000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelMasterIDValueGetter_TypeDefinitionIndex = 15821;
