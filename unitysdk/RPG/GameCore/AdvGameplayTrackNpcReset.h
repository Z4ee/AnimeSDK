...
#define RPG_GAMECORE_ADVGAMEPLAYTRACKNPCRESET_METHOD_3_7A903F4CC8FBE9B1_OFFSET UNITYSDK_OFFSET(0x19426590)
#define RPG_GAMECORE_ADVGAMEPLAYTRACKNPCRESET_METHOD_3_CDDAADFEBA948F7D_OFFSET UNITYSDK_OFFSET(0x19426480)
#define RPG_GAMECORE_ADVGAMEPLAYTRACKNPCRESET__CTOR_OFFSET UNITYSDK_OFFSET(0x19426560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvGameplayTrackNpcReset_TypeDefinitionIndex = 20961;
