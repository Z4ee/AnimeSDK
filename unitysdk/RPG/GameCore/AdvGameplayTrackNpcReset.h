...
#define RPG_GAMECORE_ADVGAMEPLAYTRACKNPCRESET_METHOD_3_7A903F4CC8FBE9B1_OFFSET UNITYSDK_OFFSET(0x16F30BF0)
#define RPG_GAMECORE_ADVGAMEPLAYTRACKNPCRESET_METHOD_3_CDDAADFEBA948F7D_OFFSET UNITYSDK_OFFSET(0x16F30AE0)
#define RPG_GAMECORE_ADVGAMEPLAYTRACKNPCRESET__CTOR_OFFSET UNITYSDK_OFFSET(0x16F30BC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvGameplayTrackNpcReset_TypeDefinitionIndex = 20371;
