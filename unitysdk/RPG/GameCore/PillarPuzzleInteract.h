...
#define RPG_GAMECORE_PILLARPUZZLEINTERACT_METHOD_3_265D1B8112A42D65_OFFSET UNITYSDK_OFFSET(0x18BF96C0)
#define RPG_GAMECORE_PILLARPUZZLEINTERACT_METHOD_3_D9A6DFFE758EBC11_OFFSET UNITYSDK_OFFSET(0x18BF95B0)
#define RPG_GAMECORE_PILLARPUZZLEINTERACT__CTOR_OFFSET UNITYSDK_OFFSET(0x18BF9690)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PillarPuzzleInteract_TypeDefinitionIndex = 19325;
