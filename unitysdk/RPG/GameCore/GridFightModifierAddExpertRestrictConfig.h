...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDEXPERTRESTRICTCONFIG_METHOD_3_6308F2F2586A6347_OFFSET UNITYSDK_OFFSET(0x1C5CFC10)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDEXPERTRESTRICTCONFIG_METHOD_3_B58AF6780D4CCBEB_OFFSET UNITYSDK_OFFSET(0x1C5CFC60)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDEXPERTRESTRICTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5CFC50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierAddExpertRestrictConfig_TypeDefinitionIndex = 18714;
