...
#define RPG_GAMECORE_SETDYNAMICVALUEBYWAITULTRACOUNT_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x18E2AA70)
#define RPG_GAMECORE_SETDYNAMICVALUEBYWAITULTRACOUNT_METHOD_4_3577E5C3D0EEFE0C_OFFSET UNITYSDK_OFFSET(0x18E2A900)
#define RPG_GAMECORE_SETDYNAMICVALUEBYWAITULTRACOUNT_METHOD_4_FE28901B3EA339E3_OFFSET UNITYSDK_OFFSET(0x18E2A830)
#define RPG_GAMECORE_SETDYNAMICVALUEBYWAITULTRACOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x18E2A8B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByWaitUltraCount_TypeDefinitionIndex = 22692;
