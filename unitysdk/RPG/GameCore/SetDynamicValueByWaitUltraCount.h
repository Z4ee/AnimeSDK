...
#define RPG_GAMECORE_SETDYNAMICVALUEBYWAITULTRACOUNT_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1C5F3730)
#define RPG_GAMECORE_SETDYNAMICVALUEBYWAITULTRACOUNT_METHOD_4_0F1AA1F61BE28EEB_OFFSET UNITYSDK_OFFSET(0x1C5F3580)
#define RPG_GAMECORE_SETDYNAMICVALUEBYWAITULTRACOUNT_METHOD_4_3577E5C3D0EEFE0C_OFFSET UNITYSDK_OFFSET(0x1C5F35C0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYWAITULTRACOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5F35B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByWaitUltraCount_TypeDefinitionIndex = 22849;
