...
#define RPG_GAMECORE_ST_ELFBYISCUSTOMERSTATE_METHOD_4_37115905C1023B5A_OFFSET UNITYSDK_OFFSET(0x1D4C7190)
#define RPG_GAMECORE_ST_ELFBYISCUSTOMERSTATE_METHOD_4_5624341840F4A5CE_OFFSET UNITYSDK_OFFSET(0x1D4C6FB0)
#define RPG_GAMECORE_ST_ELFBYISCUSTOMERSTATE_METHOD_4_9504EF9988B6AA4D_OFFSET UNITYSDK_OFFSET(0x1D4C7160)
#define RPG_GAMECORE_ST_ELFBYISCUSTOMERSTATE_METHOD_4_96C071E485E83D9F_OFFSET UNITYSDK_OFFSET(0x1D4C6F70)
#define RPG_GAMECORE_ST_ELFBYISCUSTOMERSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4C6FA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_ElfByIsCustomerState_TypeDefinitionIndex = 21298;
