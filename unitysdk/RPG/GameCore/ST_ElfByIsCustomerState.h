...
#define RPG_GAMECORE_ST_ELFBYISCUSTOMERSTATE_METHOD_4_5624341840F4A5CE_OFFSET UNITYSDK_OFFSET(0x18DEEC20)
#define RPG_GAMECORE_ST_ELFBYISCUSTOMERSTATE_METHOD_4_9D2C0CF5FE65D8D0_OFFSET UNITYSDK_OFFSET(0x18DEEB50)
#define RPG_GAMECORE_ST_ELFBYISCUSTOMERSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18DEEBD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_ElfByIsCustomerState_TypeDefinitionIndex = 20403;
