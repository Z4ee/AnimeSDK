...
#define RPG_GAMECORE_MAZEPUZZLEWOLFBROROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x173CB130)
#define RPG_GAMECORE_MAZEPUZZLEWOLFBROROW__CTOR_OFFSET UNITYSDK_OFFSET(0x173CB3E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MazePuzzleWolfBroRow_TypeDefinitionIndex = 12873;
	...
	public:
		...
		::System::UInt32 ControlGroupID; // 0x24
		::System::UInt32 FloorID; // 0x28
		::System::UInt32 WolfBroID; // 0x2C
		::System::UInt32 CloseState; // 0x30
		::System::UInt32 StartState; // 0x34
