...
#define RPG_GAMECORE_MAZEPUZZLEWOLFBROROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D2648F0)
#define RPG_GAMECORE_MAZEPUZZLEWOLFBROROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D264BA0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 WolfBroID; // 0x28
		::System::UInt32 StartState; // 0x2C
