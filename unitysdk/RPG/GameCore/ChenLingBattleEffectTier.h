...
#define RPG_GAMECORE_CHENLINGBATTLEEFFECTTIER_METHOD_2_413F3CF43D5EB852_OFFSET UNITYSDK_OFFSET(0x1707D0D0)
#define RPG_GAMECORE_CHENLINGBATTLEEFFECTTIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1707D250)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleEffectTier_TypeDefinitionIndex = 14398;
