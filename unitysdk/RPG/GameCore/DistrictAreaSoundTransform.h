...
#define RPG_GAMECORE_DISTRICTAREASOUNDTRANSFORM_METHOD_2_C657B8AD93CF3436_OFFSET UNITYSDK_OFFSET(0x196BDD60)
#define RPG_GAMECORE_DISTRICTAREASOUNDTRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x196BDEB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DistrictAreaSoundTransform_TypeDefinitionIndex = 16414;
