...
#define RPG_GAMECORE_DISTRICTAREASOUNDTRANSFORM_METHOD_2_C657B8AD93CF3436_OFFSET UNITYSDK_OFFSET(0x1BB19BD0)
#define RPG_GAMECORE_DISTRICTAREASOUNDTRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB19D20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DistrictAreaSoundTransform_TypeDefinitionIndex = 16576;
