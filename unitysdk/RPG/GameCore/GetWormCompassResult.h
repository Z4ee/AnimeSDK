...
#define RPG_GAMECORE_GETWORMCOMPASSRESULT_METHOD_3_78CBB22F6524E5CD_OFFSET UNITYSDK_OFFSET(0x18997010)
#define RPG_GAMECORE_GETWORMCOMPASSRESULT_METHOD_3_F436166FDBFF4F07_OFFSET UNITYSDK_OFFSET(0x18997160)
#define RPG_GAMECORE_GETWORMCOMPASSRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x189970D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GetWormCompassResult_TypeDefinitionIndex = 21032;
