...
#define RPG_GAMECORE_GETWORMCOMPASSRESULT_METHOD_3_78CBB22F6524E5CD_OFFSET UNITYSDK_OFFSET(0x172480A0)
#define RPG_GAMECORE_GETWORMCOMPASSRESULT_METHOD_3_F436166FDBFF4F07_OFFSET UNITYSDK_OFFSET(0x172481F0)
#define RPG_GAMECORE_GETWORMCOMPASSRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x17248160)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GetWormCompassResult_TypeDefinitionIndex = 20350;
