...
#define RPG_GAMECORE_CONVINCEGAMEPLAYSKILLCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17136230)
#define RPG_GAMECORE_CONVINCEGAMEPLAYSKILLCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17136930)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID SkillNameText; // 0x28
