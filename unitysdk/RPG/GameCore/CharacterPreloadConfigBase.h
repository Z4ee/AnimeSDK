...
#define RPG_GAMECORE_CHARACTERPRELOADCONFIGBASE_METHOD_2_1C69A7E6203BF7AF_OFFSET UNITYSDK_OFFSET(0x196137F0)
#define RPG_GAMECORE_CHARACTERPRELOADCONFIGBASE_METHOD_2_CE29BC0BA6A51BC0_OFFSET UNITYSDK_OFFSET(0x19613A30)
#define RPG_GAMECORE_CHARACTERPRELOADCONFIGBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x196137E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterPreloadConfigBase_TypeDefinitionIndex = 15525;
