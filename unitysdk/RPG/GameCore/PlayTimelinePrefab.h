...
#define RPG_GAMECORE_PLAYTIMELINEPREFAB_METHOD_3_13D938A48A1A9B06_OFFSET UNITYSDK_OFFSET(0x174C7A60)
#define RPG_GAMECORE_PLAYTIMELINEPREFAB_METHOD_3_BA2130244739D3AB_OFFSET UNITYSDK_OFFSET(0x174C79E0)
#define RPG_GAMECORE_PLAYTIMELINEPREFAB__CTOR_OFFSET UNITYSDK_OFFSET(0x174C7A30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayTimelinePrefab_TypeDefinitionIndex = 20094;
