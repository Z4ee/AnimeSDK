...
#define RPG_GAMECORE_INFINITEWAVEINSERTMONSTER_METHOD_3_2D92CFFEAF99049D_OFFSET UNITYSDK_OFFSET(0x1D21C4B0)
#define RPG_GAMECORE_INFINITEWAVEINSERTMONSTER_METHOD_3_C9B2E853D025EAA8_OFFSET UNITYSDK_OFFSET(0x1D21C4F0)
#define RPG_GAMECORE_INFINITEWAVEINSERTMONSTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D21C4E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int InfiniteWaveInsertMonster_TypeDefinitionIndex = 22995;
