...
#define RPG_GAMECORE_INFINITEWAVEINSERTMONSTER_METHOD_3_7DFDC224EF9CC547_OFFSET UNITYSDK_OFFSET(0x1984EB20)
#define RPG_GAMECORE_INFINITEWAVEINSERTMONSTER_METHOD_3_C9B2E853D025EAA8_OFFSET UNITYSDK_OFFSET(0x1984EBA0)
#define RPG_GAMECORE_INFINITEWAVEINSERTMONSTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1984EB70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int InfiniteWaveInsertMonster_TypeDefinitionIndex = 21991;
