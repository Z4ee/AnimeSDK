...
#define RPG_GAMECORE_BATTLECHANGEAVATAR_END_METHOD_3_BECEB47B6BA86EDE_OFFSET UNITYSDK_OFFSET(0x16FCCC80)
#define RPG_GAMECORE_BATTLECHANGEAVATAR_END_METHOD_3_F08AC525B4A9BED2_OFFSET UNITYSDK_OFFSET(0x16FCCB70)
#define RPG_GAMECORE_BATTLECHANGEAVATAR_END__CTOR_OFFSET UNITYSDK_OFFSET(0x16FCCC50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleChangeAvatar_End_TypeDefinitionIndex = 20973;
