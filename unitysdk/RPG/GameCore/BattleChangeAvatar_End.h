...
#define RPG_GAMECORE_BATTLECHANGEAVATAR_END_METHOD_3_9F8AF0482866F9DB_OFFSET UNITYSDK_OFFSET(0x1B2F1A30)
#define RPG_GAMECORE_BATTLECHANGEAVATAR_END_METHOD_3_BECEB47B6BA86EDE_OFFSET UNITYSDK_OFFSET(0x1B2F1B00)
#define RPG_GAMECORE_BATTLECHANGEAVATAR_END__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2F1AF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleChangeAvatar_End_TypeDefinitionIndex = 22524;
