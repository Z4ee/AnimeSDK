...
#define RPG_GAMECORE_ADDHITBYTIMEREWINDLISTENER_METHOD_3_11A85A97407282BD_OFFSET UNITYSDK_OFFSET(0x1863FA60)
#define RPG_GAMECORE_ADDHITBYTIMEREWINDLISTENER_METHOD_3_14ECA85137D72491_OFFSET UNITYSDK_OFFSET(0x1863FAE0)
#define RPG_GAMECORE_ADDHITBYTIMEREWINDLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1863FAB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddHitByTimeRewindListener_TypeDefinitionIndex = 19617;
