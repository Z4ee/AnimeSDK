...
#define RPG_GAMECORE_ADDHITBYTIMEREWINDLISTENER_METHOD_3_14ECA85137D72491_OFFSET UNITYSDK_OFFSET(0x1BE06ED0)
#define RPG_GAMECORE_ADDHITBYTIMEREWINDLISTENER_METHOD_3_DE239EEFB576A50E_OFFSET UNITYSDK_OFFSET(0x1BE06E90)
#define RPG_GAMECORE_ADDHITBYTIMEREWINDLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE06EC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddHitByTimeRewindListener_TypeDefinitionIndex = 19862;
