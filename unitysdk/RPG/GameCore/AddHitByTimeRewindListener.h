...
#define RPG_GAMECORE_ADDHITBYTIMEREWINDLISTENER_METHOD_3_11A85A97407282BD_OFFSET UNITYSDK_OFFSET(0x1940EA90)
#define RPG_GAMECORE_ADDHITBYTIMEREWINDLISTENER_METHOD_3_14ECA85137D72491_OFFSET UNITYSDK_OFFSET(0x1940EB10)
#define RPG_GAMECORE_ADDHITBYTIMEREWINDLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1940EAE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddHitByTimeRewindListener_TypeDefinitionIndex = 19504;
