...
#define RPG_GAMECORE_COMPLEXSKILLAIPOSTPROCESSBREAK_METHOD_3_E5B90EF1E2DADED9_OFFSET UNITYSDK_OFFSET(0x17123F60)
#define RPG_GAMECORE_COMPLEXSKILLAIPOSTPROCESSBREAK_METHOD_3_E7E9A69000161838_OFFSET UNITYSDK_OFFSET(0x171246B0)
#define RPG_GAMECORE_COMPLEXSKILLAIPOSTPROCESSBREAK__CTOR_OFFSET UNITYSDK_OFFSET(0x17123F50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAIPostProcessBreak_TypeDefinitionIndex = 14257;
