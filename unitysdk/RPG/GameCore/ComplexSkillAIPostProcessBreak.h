...
#define RPG_GAMECORE_COMPLEXSKILLAIPOSTPROCESSBREAK_METHOD_3_E5B90EF1E2DADED9_OFFSET UNITYSDK_OFFSET(0x1BC25C50)
#define RPG_GAMECORE_COMPLEXSKILLAIPOSTPROCESSBREAK_METHOD_3_E7E9A69000161838_OFFSET UNITYSDK_OFFSET(0x1BC263A0)
#define RPG_GAMECORE_COMPLEXSKILLAIPOSTPROCESSBREAK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC25C40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAIPostProcessBreak_TypeDefinitionIndex = 14954;
