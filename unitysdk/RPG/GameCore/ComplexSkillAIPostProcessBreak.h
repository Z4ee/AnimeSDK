...
#define RPG_GAMECORE_COMPLEXSKILLAIPOSTPROCESSBREAK_METHOD_3_E5B90EF1E2DADED9_OFFSET UNITYSDK_OFFSET(0x1966B740)
#define RPG_GAMECORE_COMPLEXSKILLAIPOSTPROCESSBREAK_METHOD_3_E7E9A69000161838_OFFSET UNITYSDK_OFFSET(0x1966BE90)
#define RPG_GAMECORE_COMPLEXSKILLAIPOSTPROCESSBREAK__CTOR_OFFSET UNITYSDK_OFFSET(0x1966B730)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAIPostProcessBreak_TypeDefinitionIndex = 14792;
