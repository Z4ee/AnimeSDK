...
#define RPG_GAMECORE_ROGUEPARAMROGUETOURNROOMINDEXCONFIG_METHOD_6_5D89C8C044CFB806_OFFSET UNITYSDK_OFFSET(0x17650E70)
#define RPG_GAMECORE_ROGUEPARAMROGUETOURNROOMINDEXCONFIG_METHOD_6_8C637B93E4E61590_OFFSET UNITYSDK_OFFSET(0x17651120)
#define RPG_GAMECORE_ROGUEPARAMROGUETOURNROOMINDEXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17650FF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamRogueTournRoomIndexConfig_TypeDefinitionIndex = 18176;
