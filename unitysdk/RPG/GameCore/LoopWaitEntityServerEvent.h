...
#define RPG_GAMECORE_LOOPWAITENTITYSERVEREVENT_METHOD_3_31FEC89E38633222_OFFSET UNITYSDK_OFFSET(0x198B1CC0)
#define RPG_GAMECORE_LOOPWAITENTITYSERVEREVENT_METHOD_3_F85355FD62381C7D_OFFSET UNITYSDK_OFFSET(0x198B1C50)
#define RPG_GAMECORE_LOOPWAITENTITYSERVEREVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x198B1C90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoopWaitEntityServerEvent_TypeDefinitionIndex = 20908;
