...
#define RPG_GAMECORE_LOOPWAITENTITYSERVEREVENT_METHOD_3_31FEC89E38633222_OFFSET UNITYSDK_OFFSET(0x18A7E940)
#define RPG_GAMECORE_LOOPWAITENTITYSERVEREVENT_METHOD_3_F85355FD62381C7D_OFFSET UNITYSDK_OFFSET(0x18A7E8D0)
#define RPG_GAMECORE_LOOPWAITENTITYSERVEREVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x18A7E910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoopWaitEntityServerEvent_TypeDefinitionIndex = 20996;
