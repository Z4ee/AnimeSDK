...
#define RPG_GAMECORE_LOOPWAITENTITYSERVEREVENT_METHOD_3_31FEC89E38633222_OFFSET UNITYSDK_OFFSET(0x1BCD49E0)
#define RPG_GAMECORE_LOOPWAITENTITYSERVEREVENT_METHOD_3_771941FB85DDF06F_OFFSET UNITYSDK_OFFSET(0x1BCD49A0)
#define RPG_GAMECORE_LOOPWAITENTITYSERVEREVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCD49D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoopWaitEntityServerEvent_TypeDefinitionIndex = 21323;
