...
#define RPG_GAMECORE_ROGUEROOMROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19BBA3D0)
#define RPG_GAMECORE_ROGUEROOMROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19BBA610)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueRoomRow_TypeDefinitionIndex = 13976;
	...
	public:
		...
		::System::UInt32 RogueRoomID; // 0x2C
