...
#define RPG_GAMECORE_ROGUEROOMROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17658450)
#define RPG_GAMECORE_ROGUEROOMROW__CTOR_OFFSET UNITYSDK_OFFSET(0x176586A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueRoomRow_TypeDefinitionIndex = 13437;
