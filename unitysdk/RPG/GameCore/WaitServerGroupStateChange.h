...
#define RPG_GAMECORE_WAITSERVERGROUPSTATECHANGE_METHOD_3_A40EF486C07A2DB5_OFFSET UNITYSDK_OFFSET(0x179048F0)
#define RPG_GAMECORE_WAITSERVERGROUPSTATECHANGE_METHOD_3_E1B18BDDCB0E12A5_OFFSET UNITYSDK_OFFSET(0x17904860)
#define RPG_GAMECORE_WAITSERVERGROUPSTATECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x179048C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitServerGroupStateChange_TypeDefinitionIndex = 19477;
