...
#define RPG_GAMECORE_TARGETMAPPARTTOOWNER_METHOD_3_192DFC5B0D9188D7_OFFSET UNITYSDK_OFFSET(0x1E1BCFF0)
#define RPG_GAMECORE_TARGETMAPPARTTOOWNER_METHOD_3_8A365F916148033A_OFFSET UNITYSDK_OFFSET(0x1E1BD0B0)
#define RPG_GAMECORE_TARGETMAPPARTTOOWNER_METHOD_3_9D11038456F5936F_OFFSET UNITYSDK_OFFSET(0x1E1BD0E0)
#define RPG_GAMECORE_TARGETMAPPARTTOOWNER_METHOD_3_C27B3F988338397A_OFFSET UNITYSDK_OFFSET(0x1E1BCF20)
#define RPG_GAMECORE_TARGETMAPPARTTOOWNER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1BCFE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapPartToOwner_TypeDefinitionIndex = 23682;
