...
#define RPG_GAMECORE_DAWNSEYETHUNDERCHARGINGUICONFIG_METHOD_3_77522EFB768F2347_OFFSET UNITYSDK_OFFSET(0x1C0FB9D0)
#define RPG_GAMECORE_DAWNSEYETHUNDERCHARGINGUICONFIG_METHOD_3_CA9167AC61961E8D_OFFSET UNITYSDK_OFFSET(0x1C0FBAD0)
#define RPG_GAMECORE_DAWNSEYETHUNDERCHARGINGUICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0FBAC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DawnsEyeThunderChargingUIConfig_TypeDefinitionIndex = 21976;
