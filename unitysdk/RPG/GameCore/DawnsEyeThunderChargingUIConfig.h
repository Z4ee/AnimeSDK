...
#define RPG_GAMECORE_DAWNSEYETHUNDERCHARGINGUICONFIG_METHOD_3_77522EFB768F2347_OFFSET UNITYSDK_OFFSET(0x1714BB20)
#define RPG_GAMECORE_DAWNSEYETHUNDERCHARGINGUICONFIG_METHOD_3_CA9167AC61961E8D_OFFSET UNITYSDK_OFFSET(0x1714BC20)
#define RPG_GAMECORE_DAWNSEYETHUNDERCHARGINGUICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1714BC10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DawnsEyeThunderChargingUIConfig_TypeDefinitionIndex = 20991;
