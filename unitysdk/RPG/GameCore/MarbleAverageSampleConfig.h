...
#define RPG_GAMECORE_MARBLEAVERAGESAMPLECONFIG_METHOD_2_9EFF187677222B01_OFFSET UNITYSDK_OFFSET(0x198C91C0)
#define RPG_GAMECORE_MARBLEAVERAGESAMPLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x198C9330)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleAverageSampleConfig_TypeDefinitionIndex = 16050;
