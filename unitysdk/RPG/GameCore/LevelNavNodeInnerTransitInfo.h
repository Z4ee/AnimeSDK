...
#define RPG_GAMECORE_LEVELNAVNODEINNERTRANSITINFO_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x18A4E5D0)
#define RPG_GAMECORE_LEVELNAVNODEINNERTRANSITINFO_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18A4E490)
#define RPG_GAMECORE_LEVELNAVNODEINNERTRANSITINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18A4E480)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelNavNodeInnerTransitInfo_TypeDefinitionIndex = 16272;
