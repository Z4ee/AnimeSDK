...
#define RPG_GAMECORE_WAITGETLEVELREWARD_METHOD_3_60831042F2ED0202_OFFSET UNITYSDK_OFFSET(0x1B8A5E00)
#define RPG_GAMECORE_WAITGETLEVELREWARD_METHOD_3_AAFFE0A2DD6BDB3F_OFFSET UNITYSDK_OFFSET(0x1B8A5ED0)
#define RPG_GAMECORE_WAITGETLEVELREWARD__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8A5EC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitGetLevelReward_TypeDefinitionIndex = 20447;
