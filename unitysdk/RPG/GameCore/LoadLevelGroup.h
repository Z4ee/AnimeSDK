...
#define RPG_GAMECORE_LOADLEVELGROUP_METHOD_3_02B342015DCC8D5B_OFFSET UNITYSDK_OFFSET(0x17363F20)
#define RPG_GAMECORE_LOADLEVELGROUP_METHOD_3_AAE98440668B0FF2_OFFSET UNITYSDK_OFFSET(0x17363EA0)
#define RPG_GAMECORE_LOADLEVELGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x17363EF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoadLevelGroup_TypeDefinitionIndex = 20253;
