...
#define RPG_GAMECORE_LOADLEVELGROUP_METHOD_3_02B342015DCC8D5B_OFFSET UNITYSDK_OFFSET(0x1D2098A0)
#define RPG_GAMECORE_LOADLEVELGROUP_METHOD_3_BA5E6AB753A14388_OFFSET UNITYSDK_OFFSET(0x1D209860)
#define RPG_GAMECORE_LOADLEVELGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D209890)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoadLevelGroup_TypeDefinitionIndex = 21823;
