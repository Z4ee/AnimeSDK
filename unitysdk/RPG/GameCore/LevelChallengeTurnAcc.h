...
#define RPG_GAMECORE_LEVELCHALLENGETURNACC_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1B02EF90)
#define RPG_GAMECORE_LEVELCHALLENGETURNACC_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B02EEC0)
#define RPG_GAMECORE_LEVELCHALLENGETURNACC__CTOR_OFFSET UNITYSDK_OFFSET(0x1B02EF80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelChallengeTurnAcc_TypeDefinitionIndex = 22793;
