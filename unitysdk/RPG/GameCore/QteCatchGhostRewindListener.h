...
#define RPG_GAMECORE_QTECATCHGHOSTREWINDLISTENER_METHOD_3_300D57C3CA754DFF_OFFSET UNITYSDK_OFFSET(0x1B9A9C50)
#define RPG_GAMECORE_QTECATCHGHOSTREWINDLISTENER_METHOD_3_DD41BD97F9C9633C_OFFSET UNITYSDK_OFFSET(0x1B9A9C10)
#define RPG_GAMECORE_QTECATCHGHOSTREWINDLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9A9C40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int QteCatchGhostRewindListener_TypeDefinitionIndex = 21239;
