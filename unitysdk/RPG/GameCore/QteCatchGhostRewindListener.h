...
#define RPG_GAMECORE_QTECATCHGHOSTREWINDLISTENER_METHOD_3_2ACFA36BBEE28794_OFFSET UNITYSDK_OFFSET(0x17575900)
#define RPG_GAMECORE_QTECATCHGHOSTREWINDLISTENER_METHOD_3_A2BB98A2E2FC709C_OFFSET UNITYSDK_OFFSET(0x17575980)
#define RPG_GAMECORE_QTECATCHGHOSTREWINDLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x17575950)

namespace RPG::GameCore
{
	inline static constexpr unsigned int QteCatchGhostRewindListener_TypeDefinitionIndex = 20225;
