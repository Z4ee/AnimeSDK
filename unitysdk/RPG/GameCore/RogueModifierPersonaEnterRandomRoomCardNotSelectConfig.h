...
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAENTERRANDOMROOMCARDNOTSELECTCONFIG_METHOD_3_06AF325CD8AAF4D1_OFFSET UNITYSDK_OFFSET(0x17637120)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAENTERRANDOMROOMCARDNOTSELECTCONFIG_METHOD_3_70C074A11DAAE638_OFFSET UNITYSDK_OFFSET(0x17637050)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAENTERRANDOMROOMCARDNOTSELECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x176370D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierPersonaEnterRandomRoomCardNotSelectConfig_TypeDefinitionIndex = 16382;
