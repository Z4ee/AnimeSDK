...
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAENTERRANDOMROOMCARDNOTSELECTCONFIG_METHOD_3_06AF325CD8AAF4D1_OFFSET UNITYSDK_OFFSET(0x18D43C70)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAENTERRANDOMROOMCARDNOTSELECTCONFIG_METHOD_3_70C074A11DAAE638_OFFSET UNITYSDK_OFFSET(0x18D43BA0)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAENTERRANDOMROOMCARDNOTSELECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D43C20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierPersonaEnterRandomRoomCardNotSelectConfig_TypeDefinitionIndex = 16936;
