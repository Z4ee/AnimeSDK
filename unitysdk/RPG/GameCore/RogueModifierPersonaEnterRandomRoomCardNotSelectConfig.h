...
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAENTERRANDOMROOMCARDNOTSELECTCONFIG_METHOD_3_06AF325CD8AAF4D1_OFFSET UNITYSDK_OFFSET(0x1EEFBEE0)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAENTERRANDOMROOMCARDNOTSELECTCONFIG_METHOD_3_D5BB9CF3465E4D6D_OFFSET UNITYSDK_OFFSET(0x1EEFBE90)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAENTERRANDOMROOMCARDNOTSELECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEFBED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierPersonaEnterRandomRoomCardNotSelectConfig_TypeDefinitionIndex = 17627;
