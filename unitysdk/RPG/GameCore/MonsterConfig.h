...
#define RPG_GAMECORE_MONSTERCONFIG_METHOD_2_B8F2C23F109192E7_OFFSET UNITYSDK_OFFSET(0x1B1C2110)
#define RPG_GAMECORE_MONSTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1C2550)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonsterConfig_TypeDefinitionIndex = 15867;
