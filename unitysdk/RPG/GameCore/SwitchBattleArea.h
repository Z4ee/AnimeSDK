...
#define RPG_GAMECORE_SWITCHBATTLEAREA_METHOD_3_26F83C64318FB697_OFFSET UNITYSDK_OFFSET(0x17791910)
#define RPG_GAMECORE_SWITCHBATTLEAREA_METHOD_3_777E7BBDBDE3B375_OFFSET UNITYSDK_OFFSET(0x17791890)
#define RPG_GAMECORE_SWITCHBATTLEAREA__CTOR_OFFSET UNITYSDK_OFFSET(0x177918E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchBattleArea_TypeDefinitionIndex = 21556;
