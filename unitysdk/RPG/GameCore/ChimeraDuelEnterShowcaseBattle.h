...
#define RPG_GAMECORE_CHIMERADUELENTERSHOWCASEBATTLE_METHOD_3_AABE39ECAC05C65B_OFFSET UNITYSDK_OFFSET(0x1CFC41E0)
#define RPG_GAMECORE_CHIMERADUELENTERSHOWCASEBATTLE_METHOD_3_CA01FE1FEF473B5E_OFFSET UNITYSDK_OFFSET(0x1CFC4110)
#define RPG_GAMECORE_CHIMERADUELENTERSHOWCASEBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFC41D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelEnterShowcaseBattle_TypeDefinitionIndex = 21493;
