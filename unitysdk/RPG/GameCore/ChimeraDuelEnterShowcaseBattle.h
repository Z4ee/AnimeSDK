...
#define RPG_GAMECORE_CHIMERADUELENTERSHOWCASEBATTLE_METHOD_3_9F8BA3DB65776B67_OFFSET UNITYSDK_OFFSET(0x17099DC0)
#define RPG_GAMECORE_CHIMERADUELENTERSHOWCASEBATTLE_METHOD_3_AABE39ECAC05C65B_OFFSET UNITYSDK_OFFSET(0x17099ED0)
#define RPG_GAMECORE_CHIMERADUELENTERSHOWCASEBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x17099EA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelEnterShowcaseBattle_TypeDefinitionIndex = 19906;
