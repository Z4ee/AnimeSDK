...
#define RPG_GAMECORE_BYCOMPAREPARAMSTRING_METHOD_4_4859A6FC96774BA0_OFFSET UNITYSDK_OFFSET(0x17011740)
#define RPG_GAMECORE_BYCOMPAREPARAMSTRING_METHOD_4_6573A3E7F32FC919_OFFSET UNITYSDK_OFFSET(0x17011660)
#define RPG_GAMECORE_BYCOMPAREPARAMSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x170116E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareParamString_TypeDefinitionIndex = 21766;
