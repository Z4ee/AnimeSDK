...
#define RPG_GAMECORE_ALLEYSPECIALORDERFINISHROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1869E5F0)
#define RPG_GAMECORE_ALLEYSPECIALORDERFINISHROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1869E850)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AlleySpecialOrderFinishRow_TypeDefinitionIndex = 11922;

	class AlleySpecialOrderFinishRow : public ::System::Object
	{
	public:
		::System::UInt32 SpecialOrderFinishID; // 0x10
		::RPG::GameCore::SpecialOrderFinishTypeEnum SpecialOrderFinishType; // 0x14
		::System::UInt32 Param1; // 0x18
		::System::UInt32 Param3; // 0x1C
		::RPG::Client::TextID SpecialOrderFinishDesc; // 0x20
		::System::UInt32 Param2; // 0x30
