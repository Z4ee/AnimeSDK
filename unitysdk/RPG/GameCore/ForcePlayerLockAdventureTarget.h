...
#define RPG_GAMECORE_FORCEPLAYERLOCKADVENTURETARGET_METHOD_3_3B1A87164EDFBAB8_OFFSET UNITYSDK_OFFSET(0x17216D30)
#define RPG_GAMECORE_FORCEPLAYERLOCKADVENTURETARGET_METHOD_3_7097C77D41494A0F_OFFSET UNITYSDK_OFFSET(0x17216CB0)
#define RPG_GAMECORE_FORCEPLAYERLOCKADVENTURETARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x17216D00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ForcePlayerLockAdventureTarget_TypeDefinitionIndex = 22323;
