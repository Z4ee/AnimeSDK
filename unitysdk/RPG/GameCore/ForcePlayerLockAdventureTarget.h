...
#define RPG_GAMECORE_FORCEPLAYERLOCKADVENTURETARGET_METHOD_3_3B1A87164EDFBAB8_OFFSET UNITYSDK_OFFSET(0x1BEBF520)
#define RPG_GAMECORE_FORCEPLAYERLOCKADVENTURETARGET_METHOD_3_FE3FA9BD266CB0ED_OFFSET UNITYSDK_OFFSET(0x1BEBF4E0)
#define RPG_GAMECORE_FORCEPLAYERLOCKADVENTURETARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEBF510)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ForcePlayerLockAdventureTarget_TypeDefinitionIndex = 23424;
