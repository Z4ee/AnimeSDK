...
#define RPG_GAMECORE_ADVENTUREWAITCAMERALOOKATTRANSITION_METHOD_3_2422339310790645_OFFSET UNITYSDK_OFFSET(0x19457710)
#define RPG_GAMECORE_ADVENTUREWAITCAMERALOOKATTRANSITION_METHOD_3_EAF4851BCC657307_OFFSET UNITYSDK_OFFSET(0x194575F0)
#define RPG_GAMECORE_ADVENTUREWAITCAMERALOOKATTRANSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x19457690)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureWaitCameraLookAtTransition_TypeDefinitionIndex = 20915;
