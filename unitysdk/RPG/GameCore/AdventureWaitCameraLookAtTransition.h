...
#define RPG_GAMECORE_ADVENTUREWAITCAMERALOOKATTRANSITION_METHOD_3_2422339310790645_OFFSET UNITYSDK_OFFSET(0x1AE65DB0)
#define RPG_GAMECORE_ADVENTUREWAITCAMERALOOKATTRANSITION_METHOD_3_C5F6F076587D167E_OFFSET UNITYSDK_OFFSET(0x1AE65CD0)
#define RPG_GAMECORE_ADVENTUREWAITCAMERALOOKATTRANSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE65D50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureWaitCameraLookAtTransition_TypeDefinitionIndex = 21330;
