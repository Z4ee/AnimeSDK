...
#define RPG_GAMECORE_BATTLESELECTEVOLVEBUILDGEARDIALOGINITPARAM_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB5D2C80)
#define RPG_GAMECORE_BATTLESELECTEVOLVEBUILDGEARDIALOGINITPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xB5D2CF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleSelectEvolveBuildGearDialogInitParam_TypeDefinitionIndex = 54063;
