...
#define RPG_GAMECORE_BATTLESELECTEVOLVEBUILDGEARDIALOGINITPARAM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B634CC0)
#define RPG_GAMECORE_BATTLESELECTEVOLVEBUILDGEARDIALOGINITPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B634D50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleSelectEvolveBuildGearDialogInitParam_TypeDefinitionIndex = 58791;
	...
	public:
		...
		::System::UInt32 OpenLevel; // 0x18
		::System::UInt32 MaxCount; // 0x1C
		::System::UInt32 CurCount; // 0x20
