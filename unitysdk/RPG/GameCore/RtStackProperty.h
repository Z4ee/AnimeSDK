...
#define RPG_GAMECORE_RTSTACKPROPERTY_METHOD_3_66E5A3E868B1F6DC_OFFSET UNITYSDK_OFFSET(0x18DD7E10)
#define RPG_GAMECORE_RTSTACKPROPERTY_METHOD_3_C2554CFA801BCD95_OFFSET UNITYSDK_OFFSET(0x18DD7D90)
#define RPG_GAMECORE_RTSTACKPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x18DD7DE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtStackProperty_TypeDefinitionIndex = 23214;
