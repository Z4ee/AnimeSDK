...
#define RPG_GAMECORE_RTSTACKPROPERTY_METHOD_3_66E5A3E868B1F6DC_OFFSET UNITYSDK_OFFSET(0x1D4B1C70)
#define RPG_GAMECORE_RTSTACKPROPERTY_METHOD_3_6D88498B572A40B9_OFFSET UNITYSDK_OFFSET(0x1D4B1C30)
#define RPG_GAMECORE_RTSTACKPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4B1C60)
