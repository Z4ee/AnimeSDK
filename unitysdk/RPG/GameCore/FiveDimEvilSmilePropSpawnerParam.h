...
#define RPG_GAMECORE_FIVEDIMEVILSMILEPROPSPAWNERPARAM_METHOD_3_26EDF54951703B8B_OFFSET UNITYSDK_OFFSET(0x1D85D520)
#define RPG_GAMECORE_FIVEDIMEVILSMILEPROPSPAWNERPARAM_METHOD_3_A5C5DE64F1DE8E3A_OFFSET UNITYSDK_OFFSET(0x1D85D4D0)
#define RPG_GAMECORE_FIVEDIMEVILSMILEPROPSPAWNERPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D85D510)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimEvilSmilePropSpawnerParam_TypeDefinitionIndex = 18370;
