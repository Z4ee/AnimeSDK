...
#define RPG_GAMECORE_CHECKSKILLSPAXIS_METHOD_3_A1117912C80D3523_OFFSET UNITYSDK_OFFSET(0x19619290)
#define RPG_GAMECORE_CHECKSKILLSPAXIS_METHOD_3_A39B80486D5EAB44_OFFSET UNITYSDK_OFFSET(0x19619250)
#define RPG_GAMECORE_CHECKSKILLSPAXIS__CTOR_OFFSET UNITYSDK_OFFSET(0x19619280)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CheckSkillSPAxis_TypeDefinitionIndex = 14738;
