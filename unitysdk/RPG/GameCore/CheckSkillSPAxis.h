...
#define RPG_GAMECORE_CHECKSKILLSPAXIS_METHOD_3_A1117912C80D3523_OFFSET UNITYSDK_OFFSET(0x17076720)
#define RPG_GAMECORE_CHECKSKILLSPAXIS_METHOD_3_A39B80486D5EAB44_OFFSET UNITYSDK_OFFSET(0x170766E0)
#define RPG_GAMECORE_CHECKSKILLSPAXIS__CTOR_OFFSET UNITYSDK_OFFSET(0x17076710)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CheckSkillSPAxis_TypeDefinitionIndex = 14203;
