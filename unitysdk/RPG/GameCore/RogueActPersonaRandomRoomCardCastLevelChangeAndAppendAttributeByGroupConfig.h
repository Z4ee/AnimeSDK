...
#define RPG_GAMECORE_ROGUEACTPERSONARANDOMROOMCARDCASTLEVELCHANGEANDAPPENDATTRIBUTEBYGROUPCONFIG_METHOD_7_09D319CBD5C6BB6D_OFFSET UNITYSDK_OFFSET(0x19AEFE10)
#define RPG_GAMECORE_ROGUEACTPERSONARANDOMROOMCARDCASTLEVELCHANGEANDAPPENDATTRIBUTEBYGROUPCONFIG_METHOD_7_0A3695DB39C1F250_OFFSET UNITYSDK_OFFSET(0x19AF01F0)
#define RPG_GAMECORE_ROGUEACTPERSONARANDOMROOMCARDCASTLEVELCHANGEANDAPPENDATTRIBUTEBYGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AEFD30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaRandomRoomCardCastLevelChangeAndAppendAttributeByGroupConfig_TypeDefinitionIndex = 18703;
