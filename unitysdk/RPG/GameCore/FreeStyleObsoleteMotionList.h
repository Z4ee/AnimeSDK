...
#define RPG_GAMECORE_FREESTYLEOBSOLETEMOTIONLIST_METHOD_2_F12A719CED8265AE_OFFSET UNITYSDK_OFFSET(0x18932DB0)
#define RPG_GAMECORE_FREESTYLEOBSOLETEMOTIONLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x18932DF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FreeStyleObsoleteMotionList_TypeDefinitionIndex = 15441;
