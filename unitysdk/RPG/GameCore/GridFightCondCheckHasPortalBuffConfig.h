...
#define RPG_GAMECORE_GRIDFIGHTCONDCHECKHASPORTALBUFFCONFIG_METHOD_6_25E8B5807A696C5B_OFFSET UNITYSDK_OFFSET(0x197DC2F0)
#define RPG_GAMECORE_GRIDFIGHTCONDCHECKHASPORTALBUFFCONFIG_METHOD_6_ACEC4D753277E177_OFFSET UNITYSDK_OFFSET(0x197DC130)
#define RPG_GAMECORE_GRIDFIGHTCONDCHECKHASPORTALBUFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197DC230)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightCondCheckHasPortalBuffConfig_TypeDefinitionIndex = 18337;
