...
#define RPG_GAMECORE_BATTLEENTITYSKILLWHITEBOXDATA_METHOD_2_0B452163E3FA3877_OFFSET UNITYSDK_OFFSET(0x1B2F5160)
#define RPG_GAMECORE_BATTLEENTITYSKILLWHITEBOXDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2F5DF0)
