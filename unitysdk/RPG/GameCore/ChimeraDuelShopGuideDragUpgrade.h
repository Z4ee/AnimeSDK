...
#define RPG_GAMECORE_CHIMERADUELSHOPGUIDEDRAGUPGRADE_METHOD_3_14253460BFECB852_OFFSET UNITYSDK_OFFSET(0x18805070)
#define RPG_GAMECORE_CHIMERADUELSHOPGUIDEDRAGUPGRADE_METHOD_3_DDAE665F5D805663_OFFSET UNITYSDK_OFFSET(0x18804FF0)
#define RPG_GAMECORE_CHIMERADUELSHOPGUIDEDRAGUPGRADE__CTOR_OFFSET UNITYSDK_OFFSET(0x18805040)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelShopGuideDragUpgrade_TypeDefinitionIndex = 23319;
