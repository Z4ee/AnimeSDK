...
#define RPG_GAMECORE_FIVEDIMTRIGGERSELFEVENTACTION_METHOD_3_EE396846DFF3D721_OFFSET UNITYSDK_OFFSET(0x1975D3E0)
#define RPG_GAMECORE_FIVEDIMTRIGGERSELFEVENTACTION_METHOD_3_F8D0237B93034E2D_OFFSET UNITYSDK_OFFSET(0x1975D300)
#define RPG_GAMECORE_FIVEDIMTRIGGERSELFEVENTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1975D3C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimTriggerSelfEventAction_TypeDefinitionIndex = 17748;
