...
#define RPG_GAMECORE_FIVEDIMTRIGGERSELFEVENTACTION_METHOD_3_4D70F002E817EDA4_OFFSET UNITYSDK_OFFSET(0x1DCA97C0)
#define RPG_GAMECORE_FIVEDIMTRIGGERSELFEVENTACTION_METHOD_3_EE396846DFF3D721_OFFSET UNITYSDK_OFFSET(0x1DCA9870)
#define RPG_GAMECORE_FIVEDIMTRIGGERSELFEVENTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCA9860)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimTriggerSelfEventAction_TypeDefinitionIndex = 18442;
