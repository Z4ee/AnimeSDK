...
#define RPG_GAMECORE_CLOCKFACEEMOTION_METHOD_2_5C35BAA97E9CD479_OFFSET UNITYSDK_OFFSET(0x19654FE0)
#define RPG_GAMECORE_CLOCKFACEEMOTION__CTOR_OFFSET UNITYSDK_OFFSET(0x196551B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClockFaceEmotion_TypeDefinitionIndex = 20672;
