...
#define RPG_GAMECORE_DAMAGETEXTPOOLMAXSIZEOFGRAPHICSQUALITY_METHOD_2_6C111494942E0D7B_OFFSET UNITYSDK_OFFSET(0x18850C50)
#define RPG_GAMECORE_DAMAGETEXTPOOLMAXSIZEOFGRAPHICSQUALITY__CTOR_OFFSET UNITYSDK_OFFSET(0x18850D10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DamageTextPoolMaxSizeOfGraphicsQuality_TypeDefinitionIndex = 16237;
