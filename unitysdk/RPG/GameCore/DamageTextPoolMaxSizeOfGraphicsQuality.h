...
#define RPG_GAMECORE_DAMAGETEXTPOOLMAXSIZEOFGRAPHICSQUALITY_METHOD_2_6C111494942E0D7B_OFFSET UNITYSDK_OFFSET(0x1C0F96A0)
#define RPG_GAMECORE_DAMAGETEXTPOOLMAXSIZEOFGRAPHICSQUALITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0F9760)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DamageTextPoolMaxSizeOfGraphicsQuality_TypeDefinitionIndex = 16457;
