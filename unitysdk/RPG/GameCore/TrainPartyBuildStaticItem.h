...
#define RPG_GAMECORE_TRAINPARTYBUILDSTATICITEM_METHOD_2_20EC186DBF8E8E62_OFFSET UNITYSDK_OFFSET(0x1D533920)
#define RPG_GAMECORE_TRAINPARTYBUILDSTATICITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D533CC0)
