...
#define RPG_GAMECORE_BOOMERANGPROJECTILEDATA_METHOD_3_C5F10A8159AC3068_OFFSET UNITYSDK_OFFSET(0x1C2E5700)
#define RPG_GAMECORE_BOOMERANGPROJECTILEDATA_METHOD_3_D65D46D7FD9AC52B_OFFSET UNITYSDK_OFFSET(0x1C2E5880)
#define RPG_GAMECORE_BOOMERANGPROJECTILEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2E57D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BoomerangProjectileData_TypeDefinitionIndex = 15484;
