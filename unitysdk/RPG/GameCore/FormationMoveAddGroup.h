...
#define RPG_GAMECORE_FORMATIONMOVEADDGROUP_METHOD_3_3FB73780301277BD_OFFSET UNITYSDK_OFFSET(0x1D110FA0)
#define RPG_GAMECORE_FORMATIONMOVEADDGROUP_METHOD_3_93509CD8352229F8_OFFSET UNITYSDK_OFFSET(0x1D110F60)
#define RPG_GAMECORE_FORMATIONMOVEADDGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D110F90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FormationMoveAddGroup_TypeDefinitionIndex = 21010;
