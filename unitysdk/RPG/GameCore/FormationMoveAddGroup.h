...
#define RPG_GAMECORE_FORMATIONMOVEADDGROUP_METHOD_3_03F6981A3A36A5E8_OFFSET UNITYSDK_OFFSET(0x172180C0)
#define RPG_GAMECORE_FORMATIONMOVEADDGROUP_METHOD_3_3FB73780301277BD_OFFSET UNITYSDK_OFFSET(0x17218140)
#define RPG_GAMECORE_FORMATIONMOVEADDGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x17218110)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FormationMoveAddGroup_TypeDefinitionIndex = 19554;
