...
#define RPG_GAMECORE_FORMATIONMOVEADDGROUP_METHOD_3_03F6981A3A36A5E8_OFFSET UNITYSDK_OFFSET(0x19765AA0)
#define RPG_GAMECORE_FORMATIONMOVEADDGROUP_METHOD_3_3FB73780301277BD_OFFSET UNITYSDK_OFFSET(0x19765B20)
#define RPG_GAMECORE_FORMATIONMOVEADDGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x19765AF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FormationMoveAddGroup_TypeDefinitionIndex = 20086;
