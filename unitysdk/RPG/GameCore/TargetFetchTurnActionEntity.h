...
#define RPG_GAMECORE_TARGETFETCHTURNACTIONENTITY_METHOD_4_B95471B175C55B48_OFFSET UNITYSDK_OFFSET(0x177C0880)
#define RPG_GAMECORE_TARGETFETCHTURNACTIONENTITY_METHOD_4_C28B2D6E951406DA_OFFSET UNITYSDK_OFFSET(0x177B9120)
#define RPG_GAMECORE_TARGETFETCHTURNACTIONENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x177B90D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchTurnActionEntity_TypeDefinitionIndex = 22273;
