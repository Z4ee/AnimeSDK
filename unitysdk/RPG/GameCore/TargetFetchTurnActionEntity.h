...
#define RPG_GAMECORE_TARGETFETCHTURNACTIONENTITY_METHOD_4_21AC0596C562A8FB_OFFSET UNITYSDK_OFFSET(0x1E1B7B90)
#define RPG_GAMECORE_TARGETFETCHTURNACTIONENTITY_METHOD_4_A11B81032D874802_OFFSET UNITYSDK_OFFSET(0x1E1B7C90)
#define RPG_GAMECORE_TARGETFETCHTURNACTIONENTITY_METHOD_4_C28B2D6E951406DA_OFFSET UNITYSDK_OFFSET(0x1E1B7C10)
#define RPG_GAMECORE_TARGETFETCHTURNACTIONENTITY_METHOD_4_F3F79E6223ACA8CF_OFFSET UNITYSDK_OFFSET(0x1E1B7C70)
#define RPG_GAMECORE_TARGETFETCHTURNACTIONENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1B7C00)
