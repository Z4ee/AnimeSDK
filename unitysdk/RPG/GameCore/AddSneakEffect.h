...
#define RPG_GAMECORE_ADDSNEAKEFFECT_METHOD_3_97632CAEA94EC64E_OFFSET UNITYSDK_OFFSET(0x186434D0)
#define RPG_GAMECORE_ADDSNEAKEFFECT_METHOD_3_B325F9BB4DF5AE9F_OFFSET UNITYSDK_OFFSET(0x18643450)
#define RPG_GAMECORE_ADDSNEAKEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x186434A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddSneakEffect_TypeDefinitionIndex = 21105;
