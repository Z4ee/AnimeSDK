...
#define RPG_GAMECORE_UPDATEMONSTERFOOTIKMODE_METHOD_3_08A25BE316AA0B29_OFFSET UNITYSDK_OFFSET(0x178E7AC0)
#define RPG_GAMECORE_UPDATEMONSTERFOOTIKMODE_METHOD_3_492EBC691431CAF8_OFFSET UNITYSDK_OFFSET(0x178E7A40)
#define RPG_GAMECORE_UPDATEMONSTERFOOTIKMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x178E7A90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UpdateMonsterFootIKMode_TypeDefinitionIndex = 20613;
