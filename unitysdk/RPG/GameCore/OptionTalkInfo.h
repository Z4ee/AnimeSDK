...
#define RPG_GAMECORE_OPTIONTALKINFO_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x199DB240)
#define RPG_GAMECORE_OPTIONTALKINFO_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x199DAFF0)
#define RPG_GAMECORE_OPTIONTALKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x199DB200)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OptionTalkInfo_TypeDefinitionIndex = 14710;
