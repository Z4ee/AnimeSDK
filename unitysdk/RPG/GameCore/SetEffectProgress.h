...
#define RPG_GAMECORE_SETEFFECTPROGRESS_METHOD_3_0C2D611C08AF3533_OFFSET UNITYSDK_OFFSET(0x18E2D5A0)
#define RPG_GAMECORE_SETEFFECTPROGRESS_METHOD_3_64AED65B8EEBE741_OFFSET UNITYSDK_OFFSET(0x18E2D620)
#define RPG_GAMECORE_SETEFFECTPROGRESS__CTOR_OFFSET UNITYSDK_OFFSET(0x18E2D5F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetEffectProgress_TypeDefinitionIndex = 22735;
