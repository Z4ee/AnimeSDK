...
#define RPG_GAMECORE_ENTITYSCORECONFIG_METHOD_2_F7C1AA3DF7C157FC_OFFSET UNITYSDK_OFFSET(0x196EDC60)
#define RPG_GAMECORE_ENTITYSCORECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x196EDDD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EntityScoreConfig_TypeDefinitionIndex = 15747;
