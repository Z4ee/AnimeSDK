...
#define RPG_GAMECORE_ENTITYSCORECONFIG_METHOD_2_F7C1AA3DF7C157FC_OFFSET UNITYSDK_OFFSET(0x1D06BD70)
#define RPG_GAMECORE_ENTITYSCORECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D06BEE0)
