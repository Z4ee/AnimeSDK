...
#define RPG_GAMECORE_SETDRONEFUNCBTN_METHOD_3_4B442DD64E95471D_OFFSET UNITYSDK_OFFSET(0x18E14F80)
#define RPG_GAMECORE_SETDRONEFUNCBTN_METHOD_3_77C9A7193987753B_OFFSET UNITYSDK_OFFSET(0x18E14F00)
#define RPG_GAMECORE_SETDRONEFUNCBTN__CTOR_OFFSET UNITYSDK_OFFSET(0x18E14F50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDroneFuncBtn_TypeDefinitionIndex = 20999;
