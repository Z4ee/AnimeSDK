...
#define RPG_GAMECORE_SETDRONEFUNCBTN_METHOD_3_4B442DD64E95471D_OFFSET UNITYSDK_OFFSET(0x176B2660)
#define RPG_GAMECORE_SETDRONEFUNCBTN_METHOD_3_77C9A7193987753B_OFFSET UNITYSDK_OFFSET(0x176B25E0)
#define RPG_GAMECORE_SETDRONEFUNCBTN__CTOR_OFFSET UNITYSDK_OFFSET(0x176B2630)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDroneFuncBtn_TypeDefinitionIndex = 20317;
