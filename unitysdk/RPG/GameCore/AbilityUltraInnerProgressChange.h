...
#define RPG_GAMECORE_ABILITYULTRAINNERPROGRESSCHANGE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xA8118D0)
#define RPG_GAMECORE_ABILITYULTRAINNERPROGRESSCHANGE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xA811880)
#define RPG_GAMECORE_ABILITYULTRAINNERPROGRESSCHANGE_GET_FILLAMOUNT_OFFSET UNITYSDK_OFFSET(0xA811940)
#define RPG_GAMECORE_ABILITYULTRAINNERPROGRESSCHANGE_GET_TARGETRUNTIMEID_OFFSET UNITYSDK_OFFSET(0xA811920)
#define RPG_GAMECORE_ABILITYULTRAINNERPROGRESSCHANGE_INIT_OFFSET UNITYSDK_OFFSET(0xA811820)
#define RPG_GAMECORE_ABILITYULTRAINNERPROGRESSCHANGE_SET_FILLAMOUNT_OFFSET UNITYSDK_OFFSET(0xA811950)
#define RPG_GAMECORE_ABILITYULTRAINNERPROGRESSCHANGE_SET_TARGETRUNTIMEID_OFFSET UNITYSDK_OFFSET(0xA811930)
#define RPG_GAMECORE_ABILITYULTRAINNERPROGRESSCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0xA811960)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AbilityUltraInnerProgressChange_TypeDefinitionIndex = 45463;
