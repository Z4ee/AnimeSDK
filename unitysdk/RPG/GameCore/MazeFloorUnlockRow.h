...
#define RPG_GAMECORE_MAZEFLOORUNLOCKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D27A5A0)
#define RPG_GAMECORE_MAZEFLOORUNLOCKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D27A6D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MazeFloorUnlockRow_TypeDefinitionIndex = 13957;
