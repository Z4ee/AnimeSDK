...
#define RPG_GAMECORE_MODIFIERHINT_METHOD_2_E3137EF7A7D88B71_OFFSET UNITYSDK_OFFSET(0x1D1B2CC0)
#define RPG_GAMECORE_MODIFIERHINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1B2E80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifierHint_TypeDefinitionIndex = 18029;
