...
#define RPG_GAMECORE_MODIFIERHINT_METHOD_2_E3137EF7A7D88B71_OFFSET UNITYSDK_OFFSET(0x1D2AC530)
#define RPG_GAMECORE_MODIFIERHINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2AC6F0)
