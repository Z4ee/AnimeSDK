...
#define RPG_GAMECORE_ALLEYPACKANCHORSCONFIG_METHOD_2_2BFF5B9A530EC02F_OFFSET UNITYSDK_OFFSET(0x1C5624E0)
#define RPG_GAMECORE_ALLEYPACKANCHORSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5626A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AlleyPackAnchorsConfig_TypeDefinitionIndex = 15511;
