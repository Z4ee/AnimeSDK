...
#define RPG_GAMECORE_ROGUETOURNLAYERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1766AEB0)
#define RPG_GAMECORE_ROGUETOURNLAYERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1766B650)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournLayerRow_TypeDefinitionIndex = 13691;
