...
#define RPG_GAMECORE_MEMORYVISIONPUZZLEINIT_METHOD_3_036C121232C8F7C4_OFFSET UNITYSDK_OFFSET(0x1D285020)
#define RPG_GAMECORE_MEMORYVISIONPUZZLEINIT_METHOD_3_4ED02B48D73ECBB1_OFFSET UNITYSDK_OFFSET(0x1D285070)
#define RPG_GAMECORE_MEMORYVISIONPUZZLEINIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D285060)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MemoryVisionPuzzleInit_TypeDefinitionIndex = 20831;
