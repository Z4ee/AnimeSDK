...
#define RPG_GAMECORE_MEMORYVISIONPUZZLEINIT_METHOD_3_4ED02B48D73ECBB1_OFFSET UNITYSDK_OFFSET(0x18ADC760)
#define RPG_GAMECORE_MEMORYVISIONPUZZLEINIT_METHOD_3_9CDEE3880690CA0E_OFFSET UNITYSDK_OFFSET(0x18ADC6D0)
#define RPG_GAMECORE_MEMORYVISIONPUZZLEINIT__CTOR_OFFSET UNITYSDK_OFFSET(0x18ADC730)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MemoryVisionPuzzleInit_TypeDefinitionIndex = 20056;
