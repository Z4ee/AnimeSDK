...
#define RPG_GAMECORE_MEMORYVISIONPUZZLEINIT_METHOD_3_4ED02B48D73ECBB1_OFFSET UNITYSDK_OFFSET(0x1990BEB0)
#define RPG_GAMECORE_MEMORYVISIONPUZZLEINIT_METHOD_3_9CDEE3880690CA0E_OFFSET UNITYSDK_OFFSET(0x1990BE20)
#define RPG_GAMECORE_MEMORYVISIONPUZZLEINIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1990BE80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MemoryVisionPuzzleInit_TypeDefinitionIndex = 19916;
