...
#define RPG_GAMECORE_STAGEPRELOADCONFIG_METHOD_2_7201E095BFB49FD8_OFFSET UNITYSDK_OFFSET(0x1776B920)
#define RPG_GAMECORE_STAGEPRELOADCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1776BA00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StagePreloadConfig_TypeDefinitionIndex = 14967;
