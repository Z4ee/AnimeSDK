...
#define RPG_GAMECORE_STAGEPRELOADCONFIG_METHOD_2_AAAA35FEB5F9620D_OFFSET UNITYSDK_OFFSET(0x1CAE9C30)
#define RPG_GAMECORE_STAGEPRELOADCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CAE9D20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StagePreloadConfig_TypeDefinitionIndex = 16184;
