...
#define RPG_GAMECORE_STAGEPRELOADCONFIG_METHOD_2_AAAA35FEB5F9620D_OFFSET UNITYSDK_OFFSET(0x1D55C080)
#define RPG_GAMECORE_STAGEPRELOADCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D55C170)
