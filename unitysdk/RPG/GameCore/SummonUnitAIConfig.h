...
#define RPG_GAMECORE_SUMMONUNITAICONFIG_METHOD_2_8F8D0CA524F02EAC_OFFSET UNITYSDK_OFFSET(0x19CD3160)
#define RPG_GAMECORE_SUMMONUNITAICONFIG_RPG_GAMECORE_IADVENTURECHARACTERAICONFIG_GET_ADVAICONFIG_OFFSET UNITYSDK_OFFSET(0x19CD3360)
#define RPG_GAMECORE_SUMMONUNITAICONFIG_RPG_GAMECORE_IADVENTURECHARACTERAICONFIG_GET_AICONFIGOVERRIDELIST_OFFSET UNITYSDK_OFFSET(0x19CD3350)
#define RPG_GAMECORE_SUMMONUNITAICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19CD3340)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SummonUnitAIConfig_TypeDefinitionIndex = 16721;
