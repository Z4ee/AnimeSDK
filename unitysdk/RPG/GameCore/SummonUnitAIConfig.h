...
#define RPG_GAMECORE_SUMMONUNITAICONFIG_METHOD_2_8F8D0CA524F02EAC_OFFSET UNITYSDK_OFFSET(0x1B42EDB0)
#define RPG_GAMECORE_SUMMONUNITAICONFIG_RPG_GAMECORE_IADVENTURECHARACTERAICONFIG_GET_ADVAICONFIG_OFFSET UNITYSDK_OFFSET(0x1B42EFB0)
#define RPG_GAMECORE_SUMMONUNITAICONFIG_RPG_GAMECORE_IADVENTURECHARACTERAICONFIG_GET_AICONFIGOVERRIDELIST_OFFSET UNITYSDK_OFFSET(0x1B42EFA0)
#define RPG_GAMECORE_SUMMONUNITAICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B42EF90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SummonUnitAIConfig_TypeDefinitionIndex = 16883;
