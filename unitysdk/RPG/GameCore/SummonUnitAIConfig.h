...
#define RPG_GAMECORE_SUMMONUNITAICONFIG_METHOD_2_62FFE88976928A1F_OFFSET UNITYSDK_OFFSET(0x1778D820)
#define RPG_GAMECORE_SUMMONUNITAICONFIG_RPG_GAMECORE_IADVENTURECHARACTERAICONFIG_GET_ADVAICONFIG_OFFSET UNITYSDK_OFFSET(0x1778DA20)
#define RPG_GAMECORE_SUMMONUNITAICONFIG_RPG_GAMECORE_IADVENTURECHARACTERAICONFIG_GET_AICONFIGOVERRIDELIST_OFFSET UNITYSDK_OFFSET(0x1778DA10)
#define RPG_GAMECORE_SUMMONUNITAICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1778DA00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SummonUnitAIConfig_TypeDefinitionIndex = 16164;
