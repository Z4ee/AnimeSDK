...
#define RPG_GAMECORE_SETDYNAMICVALUEBYTARGETTOTEAMCENTERDISTANCE_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x18E293F0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYTARGETTOTEAMCENTERDISTANCE_METHOD_4_1B75B905B4A9C4DC_OFFSET UNITYSDK_OFFSET(0x18E29100)
#define RPG_GAMECORE_SETDYNAMICVALUEBYTARGETTOTEAMCENTERDISTANCE_METHOD_4_A592F69768087CF0_OFFSET UNITYSDK_OFFSET(0x18E291E0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYTARGETTOTEAMCENTERDISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E29180)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByTargetToTeamCenterDistance_TypeDefinitionIndex = 21679;
