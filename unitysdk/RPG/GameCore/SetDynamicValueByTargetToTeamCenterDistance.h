...
#define RPG_GAMECORE_SETDYNAMICVALUEBYTARGETTOTEAMCENTERDISTANCE_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1C5F2430)
#define RPG_GAMECORE_SETDYNAMICVALUEBYTARGETTOTEAMCENTERDISTANCE_METHOD_4_769A5433D3535B91_OFFSET UNITYSDK_OFFSET(0x1C5F21D0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYTARGETTOTEAMCENTERDISTANCE_METHOD_4_A592F69768087CF0_OFFSET UNITYSDK_OFFSET(0x1C5F2220)
#define RPG_GAMECORE_SETDYNAMICVALUEBYTARGETTOTEAMCENTERDISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5F2210)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByTargetToTeamCenterDistance_TypeDefinitionIndex = 21954;
