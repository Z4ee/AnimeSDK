...
#define RPG_GAMECORE_LEVELCHARACTERBEFOREBREAK_CLEAR_OFFSET UNITYSDK_OFFSET(0xE686A60)
#define RPG_GAMECORE_LEVELCHARACTERBEFOREBREAK_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xE686B00)
#define RPG_GAMECORE_LEVELCHARACTERBEFOREBREAK_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xE686AB0)
#define RPG_GAMECORE_LEVELCHARACTERBEFOREBREAK_INIT_OFFSET UNITYSDK_OFFSET(0xE6869F0)
#define RPG_GAMECORE_LEVELCHARACTERBEFOREBREAK__CTOR_OFFSET UNITYSDK_OFFSET(0xE686B50)
