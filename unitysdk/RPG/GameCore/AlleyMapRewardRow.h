...
#define RPG_GAMECORE_ALLEYMAPREWARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1AE7C5D0)
#define RPG_GAMECORE_ALLEYMAPREWARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE7C780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AlleyMapRewardRow_TypeDefinitionIndex = 12161;
