...
#define RPG_GAMECORE_ALLEYMAPREWARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C5604D0)
#define RPG_GAMECORE_ALLEYMAPREWARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C560680)
