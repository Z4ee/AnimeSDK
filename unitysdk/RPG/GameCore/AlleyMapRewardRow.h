...
#define RPG_GAMECORE_ALLEYMAPREWARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1946E230)
#define RPG_GAMECORE_ALLEYMAPREWARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1946E3E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AlleyMapRewardRow_TypeDefinitionIndex = 12029;
	...
	public:
		...
		::RPG::GameCore::AlleyFloorType LayerID; // 0x1C
