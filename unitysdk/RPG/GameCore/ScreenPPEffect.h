...
#define RPG_GAMECORE_SCREENPPEFFECT_METHOD_3_EC26F7AFC2B47568_OFFSET UNITYSDK_OFFSET(0x1D4D73F0)
#define RPG_GAMECORE_SCREENPPEFFECT_METHOD_3_EDE72BB3FD2A7779_OFFSET UNITYSDK_OFFSET(0x1D4D7440)
#define RPG_GAMECORE_SCREENPPEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4D7430)
