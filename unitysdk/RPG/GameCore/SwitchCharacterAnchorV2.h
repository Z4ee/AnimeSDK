...
#define RPG_GAMECORE_SWITCHCHARACTERANCHORV2_METHOD_3_AAE2B4189626A5E9_OFFSET UNITYSDK_OFFSET(0x17793B30)
#define RPG_GAMECORE_SWITCHCHARACTERANCHORV2_METHOD_3_D709BDF68C1F2F30_OFFSET UNITYSDK_OFFSET(0x17793BB0)
#define RPG_GAMECORE_SWITCHCHARACTERANCHORV2__CTOR_OFFSET UNITYSDK_OFFSET(0x17793B80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchCharacterAnchorV2_TypeDefinitionIndex = 18879;
