...
#define RPG_GAMECORE_RTBATTLELINEUPPRESET_METHOD_2_DE2CF5C715B1E580_OFFSET UNITYSDK_OFFSET(0x19BDBBD0)
#define RPG_GAMECORE_RTBATTLELINEUPPRESET__CTOR_OFFSET UNITYSDK_OFFSET(0x19BDBC10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtBattleLineupPreset_TypeDefinitionIndex = 17159;
