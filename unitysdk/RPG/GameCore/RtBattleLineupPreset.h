...
#define RPG_GAMECORE_RTBATTLELINEUPPRESET_METHOD_2_DE2CF5C715B1E580_OFFSET UNITYSDK_OFFSET(0x1D49AEE0)
#define RPG_GAMECORE_RTBATTLELINEUPPRESET__CTOR_OFFSET UNITYSDK_OFFSET(0x1D49AF20)
