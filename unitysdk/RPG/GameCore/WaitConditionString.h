...
#define RPG_GAMECORE_WAITCONDITIONSTRING_METHOD_3_89EAEA962FBAD69E_OFFSET UNITYSDK_OFFSET(0x190F9E20)
#define RPG_GAMECORE_WAITCONDITIONSTRING_METHOD_3_EF88A1D09BD35B1E_OFFSET UNITYSDK_OFFSET(0x190F9FE0)
#define RPG_GAMECORE_WAITCONDITIONSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x190F9FB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitConditionString_TypeDefinitionIndex = 19407;
