...
#define RPG_GAMECORE_WAITCONDITIONSTRING_METHOD_3_E9EC84C6626E664C_OFFSET UNITYSDK_OFFSET(0x1DEB5220)
#define RPG_GAMECORE_WAITCONDITIONSTRING_METHOD_3_EF88A1D09BD35B1E_OFFSET UNITYSDK_OFFSET(0x1DEB5380)
#define RPG_GAMECORE_WAITCONDITIONSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEB5370)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitConditionString_TypeDefinitionIndex = 20214;
