...
#define RPG_GAMECORE_CHARACTERLEAVESTAGE_METHOD_3_7252727F89E7D08C_OFFSET UNITYSDK_OFFSET(0x1D122A60)
#define RPG_GAMECORE_CHARACTERLEAVESTAGE_METHOD_3_EC0EEFC6B187FF01_OFFSET UNITYSDK_OFFSET(0x1D122A10)
#define RPG_GAMECORE_CHARACTERLEAVESTAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D122A50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterLeaveStage_TypeDefinitionIndex = 22492;
