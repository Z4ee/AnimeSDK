...
#define RPG_GAMECORE_BYPAMMOVEPHASETALK_METHOD_4_67B27AD8B91878A2_OFFSET UNITYSDK_OFFSET(0x17037A30)
#define RPG_GAMECORE_BYPAMMOVEPHASETALK_METHOD_4_A94004502D50BE48_OFFSET UNITYSDK_OFFSET(0x17037960)
#define RPG_GAMECORE_BYPAMMOVEPHASETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x170379E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByPamMovePhaseTalk_TypeDefinitionIndex = 18285;
