...
#define RPG_GAMECORE_ELATIONUICONFIG_METHOD_2_0CAE43A34B87BB44_OFFSET UNITYSDK_OFFSET(0x1BB33560)
#define RPG_GAMECORE_ELATIONUICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB347D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElationUIConfig_TypeDefinitionIndex = 15897;
