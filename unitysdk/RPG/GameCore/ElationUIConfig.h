...
#define RPG_GAMECORE_ELATIONUICONFIG_METHOD_2_0CAE43A34B87BB44_OFFSET UNITYSDK_OFFSET(0x1DB258B0)
#define RPG_GAMECORE_ELATIONUICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB26C70)
