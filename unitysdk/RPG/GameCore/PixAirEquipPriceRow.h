...
#define RPG_GAMECORE_PIXAIREQUIPPRICEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D336640)
#define RPG_GAMECORE_PIXAIREQUIPPRICEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3367F0)
