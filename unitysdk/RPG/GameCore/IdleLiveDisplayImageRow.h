...
#define RPG_GAMECORE_IDLELIVEDISPLAYIMAGEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19841660)
#define RPG_GAMECORE_IDLELIVEDISPLAYIMAGEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19841790)

namespace RPG::GameCore
{
	inline static constexpr unsigned int IdleLiveDisplayImageRow_TypeDefinitionIndex = 11284;
