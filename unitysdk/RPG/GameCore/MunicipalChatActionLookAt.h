...
#define RPG_GAMECORE_MUNICIPALCHATACTIONLOOKAT_METHOD_3_5279208BF00EA2F0_OFFSET UNITYSDK_OFFSET(0x199B7DF0)
#define RPG_GAMECORE_MUNICIPALCHATACTIONLOOKAT_METHOD_3_C46BF9929BF23D99_OFFSET UNITYSDK_OFFSET(0x199B7830)
#define RPG_GAMECORE_MUNICIPALCHATACTIONLOOKAT__CTOR_OFFSET UNITYSDK_OFFSET(0x199B7820)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MunicipalChatActionLookAt_TypeDefinitionIndex = 16068;
