...
#define RPG_GAMECORE_MUNICIPALCHATACTIONLOOKAT_METHOD_3_5279208BF00EA2F0_OFFSET UNITYSDK_OFFSET(0x1745BCF0)
#define RPG_GAMECORE_MUNICIPALCHATACTIONLOOKAT_METHOD_3_C46BF9929BF23D99_OFFSET UNITYSDK_OFFSET(0x1745B730)
#define RPG_GAMECORE_MUNICIPALCHATACTIONLOOKAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1745B720)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MunicipalChatActionLookAt_TypeDefinitionIndex = 15498;
