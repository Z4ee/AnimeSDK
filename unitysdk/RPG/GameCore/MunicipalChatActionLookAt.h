...
#define RPG_GAMECORE_MUNICIPALCHATACTIONLOOKAT_METHOD_3_5279208BF00EA2F0_OFFSET UNITYSDK_OFFSET(0x18B689F0)
#define RPG_GAMECORE_MUNICIPALCHATACTIONLOOKAT_METHOD_3_C46BF9929BF23D99_OFFSET UNITYSDK_OFFSET(0x18B68430)
#define RPG_GAMECORE_MUNICIPALCHATACTIONLOOKAT__CTOR_OFFSET UNITYSDK_OFFSET(0x18B68420)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MunicipalChatActionLookAt_TypeDefinitionIndex = 16018;
