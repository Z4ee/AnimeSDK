...
#define RPG_GAMECORE_ROGUEGAMBLELOADSHOWTEX_METHOD_3_376F93D6D568172B_OFFSET UNITYSDK_OFFSET(0x19B3C6B0)
#define RPG_GAMECORE_ROGUEGAMBLELOADSHOWTEX_METHOD_3_464438E33D282CB7_OFFSET UNITYSDK_OFFSET(0x19B3C5A0)
#define RPG_GAMECORE_ROGUEGAMBLELOADSHOWTEX__CTOR_OFFSET UNITYSDK_OFFSET(0x19B3C680)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueGambleLoadShowTex_TypeDefinitionIndex = 20880;
