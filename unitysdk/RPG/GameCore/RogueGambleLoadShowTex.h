...
#define RPG_GAMECORE_ROGUEGAMBLELOADSHOWTEX_METHOD_3_376F93D6D568172B_OFFSET UNITYSDK_OFFSET(0x1760AC60)
#define RPG_GAMECORE_ROGUEGAMBLELOADSHOWTEX_METHOD_3_464438E33D282CB7_OFFSET UNITYSDK_OFFSET(0x1760AB50)
#define RPG_GAMECORE_ROGUEGAMBLELOADSHOWTEX__CTOR_OFFSET UNITYSDK_OFFSET(0x1760AC30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueGambleLoadShowTex_TypeDefinitionIndex = 20285;
