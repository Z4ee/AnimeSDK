...
#define RPG_GAMECORE_ROGUEGAMBLELOADSHOWTEX_METHOD_3_376F93D6D568172B_OFFSET UNITYSDK_OFFSET(0x1D933110)
#define RPG_GAMECORE_ROGUEGAMBLELOADSHOWTEX_METHOD_3_45F8B7335165D1AE_OFFSET UNITYSDK_OFFSET(0x1D933040)
#define RPG_GAMECORE_ROGUEGAMBLELOADSHOWTEX__CTOR_OFFSET UNITYSDK_OFFSET(0x1D933100)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueGambleLoadShowTex_TypeDefinitionIndex = 21855;
