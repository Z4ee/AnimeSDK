...
#define RPG_GAMECORE_BYDYNAMICSKILLBUTTONINPUTSLOT_METHOD_4_98F4499802C9B465_OFFSET UNITYSDK_OFFSET(0x18745870)
#define RPG_GAMECORE_BYDYNAMICSKILLBUTTONINPUTSLOT_METHOD_4_DF8062560B5EE8BB_OFFSET UNITYSDK_OFFSET(0x18745940)
#define RPG_GAMECORE_BYDYNAMICSKILLBUTTONINPUTSLOT__CTOR_OFFSET UNITYSDK_OFFSET(0x187458F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByDynamicSkillButtonInputSlot_TypeDefinitionIndex = 21760;
