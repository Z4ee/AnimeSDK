...
#define RPG_GAMECORE_BYDYNAMICSKILLBUTTONINPUTSLOT_METHOD_4_36E3BC990138A0D1_OFFSET UNITYSDK_OFFSET(0x1A8BF540)
#define RPG_GAMECORE_BYDYNAMICSKILLBUTTONINPUTSLOT_METHOD_4_A6B93B3EA29C3FC2_OFFSET UNITYSDK_OFFSET(0x1A8BF380)
#define RPG_GAMECORE_BYDYNAMICSKILLBUTTONINPUTSLOT_METHOD_4_DA6A8BFCD927CD9E_OFFSET UNITYSDK_OFFSET(0x1A8BF570)
#define RPG_GAMECORE_BYDYNAMICSKILLBUTTONINPUTSLOT_METHOD_4_DF8062560B5EE8BB_OFFSET UNITYSDK_OFFSET(0x1A8BF3C0)
#define RPG_GAMECORE_BYDYNAMICSKILLBUTTONINPUTSLOT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8BF3B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByDynamicSkillButtonInputSlot_TypeDefinitionIndex = 22023;
