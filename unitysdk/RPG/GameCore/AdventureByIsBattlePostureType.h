...
#define RPG_GAMECORE_ADVENTUREBYISBATTLEPOSTURETYPE_METHOD_4_050CA87CD8D77AFE_OFFSET UNITYSDK_OFFSET(0x1CDE48E0)
#define RPG_GAMECORE_ADVENTUREBYISBATTLEPOSTURETYPE_METHOD_4_244930E141B0B0B5_OFFSET UNITYSDK_OFFSET(0x1CDE4AA0)
#define RPG_GAMECORE_ADVENTUREBYISBATTLEPOSTURETYPE_METHOD_4_5DBF8D15370ECCB2_OFFSET UNITYSDK_OFFSET(0x1CDE4AD0)
#define RPG_GAMECORE_ADVENTUREBYISBATTLEPOSTURETYPE_METHOD_4_A5D82A43A570235F_OFFSET UNITYSDK_OFFSET(0x1CDE4920)
#define RPG_GAMECORE_ADVENTUREBYISBATTLEPOSTURETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDE4910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureByIsBattlePostureType_TypeDefinitionIndex = 21572;
