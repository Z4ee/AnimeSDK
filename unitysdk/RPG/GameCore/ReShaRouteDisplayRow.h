...
#define RPG_GAMECORE_RESHAROUTEDISPLAYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18C8CEE0)
#define RPG_GAMECORE_RESHAROUTEDISPLAYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18C8D780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ReShaRouteDisplayRow_TypeDefinitionIndex = 13100;

	class ReShaRouteDisplayRow : public ::System::Object
	{
	public:
		::System::String* RoutePanelPrefab; // 0x10
		...
		::System::UInt32 AssistantItemID; // 0x40
