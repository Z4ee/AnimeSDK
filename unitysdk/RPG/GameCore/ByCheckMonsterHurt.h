...
#define RPG_GAMECORE_BYCHECKMONSTERHURT_METHOD_4_31675C6D34F789F1_OFFSET UNITYSDK_OFFSET(0x18724A20)
#define RPG_GAMECORE_BYCHECKMONSTERHURT_METHOD_4_6A8FB5FF143BD1F3_OFFSET UNITYSDK_OFFSET(0x18724950)
#define RPG_GAMECORE_BYCHECKMONSTERHURT__CTOR_OFFSET UNITYSDK_OFFSET(0x187249D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckMonsterHurt_TypeDefinitionIndex = 22405;
