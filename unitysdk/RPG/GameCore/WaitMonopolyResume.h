...
#define RPG_GAMECORE_WAITMONOPOLYRESUME_METHOD_3_B5847AC975E18AF9_OFFSET UNITYSDK_OFFSET(0x1B8A8950)
#define RPG_GAMECORE_WAITMONOPOLYRESUME_METHOD_3_B7CC32DFBC3345FC_OFFSET UNITYSDK_OFFSET(0x1B8A8A20)
#define RPG_GAMECORE_WAITMONOPOLYRESUME__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8A8A10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitMonopolyResume_TypeDefinitionIndex = 20137;
