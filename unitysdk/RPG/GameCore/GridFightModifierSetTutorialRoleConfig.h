...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETTUTORIALROLECONFIG_METHOD_3_0EDC8CD01154D72B_OFFSET UNITYSDK_OFFSET(0x1726C340)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETTUTORIALROLECONFIG_METHOD_3_516C126C0C32E422_OFFSET UNITYSDK_OFFSET(0x17269860)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETTUTORIALROLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17269810)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierSetTutorialRoleConfig_TypeDefinitionIndex = 17842;
