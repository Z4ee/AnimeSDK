...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETTUTORIALROLECONFIG_METHOD_3_0EDC8CD01154D72B_OFFSET UNITYSDK_OFFSET(0x197F3BF0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETTUTORIALROLECONFIG_METHOD_3_516C126C0C32E422_OFFSET UNITYSDK_OFFSET(0x197EF830)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETTUTORIALROLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197EF7E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierSetTutorialRoleConfig_TypeDefinitionIndex = 18436;
