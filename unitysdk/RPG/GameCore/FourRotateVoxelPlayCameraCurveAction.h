...
#define RPG_GAMECORE_FOURROTATEVOXELPLAYCAMERACURVEACTION_METHOD_3_B420ED1E7C60502E_OFFSET UNITYSDK_OFFSET(0x1721D7F0)
#define RPG_GAMECORE_FOURROTATEVOXELPLAYCAMERACURVEACTION_METHOD_3_FBEBD64956E93662_OFFSET UNITYSDK_OFFSET(0x1721D6F0)
#define RPG_GAMECORE_FOURROTATEVOXELPLAYCAMERACURVEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1721D7D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FourRotateVoxelPlayCameraCurveAction_TypeDefinitionIndex = 15363;
