...
#define RPG_GAMECORE_ENTITYMANAGEREXTENSION___C__DISPLAYCLASS26_0__CLIENTCREATESTORYNPCENTITY_B__0_OFFSET UNITYSDK_OFFSET(0x11553F20)
#define RPG_GAMECORE_ENTITYMANAGEREXTENSION___C__DISPLAYCLASS26_0__CLIENTCREATESTORYNPCENTITY_B__1_OFFSET UNITYSDK_OFFSET(0x11554160)
#define RPG_GAMECORE_ENTITYMANAGEREXTENSION___C__DISPLAYCLASS26_0__CLIENTCREATESTORYNPCENTITY_B__2_OFFSET UNITYSDK_OFFSET(0x115541B0)
#define RPG_GAMECORE_ENTITYMANAGEREXTENSION___C__DISPLAYCLASS26_0__CTOR_OFFSET UNITYSDK_OFFSET(0x11537230)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EntityManagerExtension___c__DisplayClass26_0_TypeDefinitionIndex = 57929;

	class EntityManagerExtension___c__DisplayClass26_0 : public ::System::Object
	{
	public:
		::RPG::GameCore::EntityManager* pManager; // 0x10
		::System::String* appearancePreset; // 0x18
