...
#define RPG_GAMECORE_COMPLEXSKILLAISOURCESPNEEDRATIO_METHOD_3_033ABB0B4FB581DE_OFFSET UNITYSDK_OFFSET(0x1882ED60)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCESPNEEDRATIO_METHOD_3_0DFB6BCD9A96B967_OFFSET UNITYSDK_OFFSET(0x18830270)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCESPNEEDRATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x1882ED40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAISourceSPNeedRatio_TypeDefinitionIndex = 14698;
