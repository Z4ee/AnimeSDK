...
#define RPG_GAMECORE_DAMAGEBEHAVIORTEMPLATELISTCONFIG_METHOD_2_A375176172C657A9_OFFSET UNITYSDK_OFFSET(0x1968D460)
#define RPG_GAMECORE_DAMAGEBEHAVIORTEMPLATELISTCONFIG_METHOD_2_CBF4DDF5E2F7867F_OFFSET UNITYSDK_OFFSET(0x1968D540)
#define RPG_GAMECORE_DAMAGEBEHAVIORTEMPLATELISTCONFIG_METHOD_2_FCE39163DF7C033F_OFFSET UNITYSDK_OFFSET(0x1968D370)
#define RPG_GAMECORE_DAMAGEBEHAVIORTEMPLATELISTCONFIG__CCTOR_OFFSET UNITYSDK_OFFSET(0x1968D5B0)
#define RPG_GAMECORE_DAMAGEBEHAVIORTEMPLATELISTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1968D450)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DamageBehaviorTemplateListConfig_TypeDefinitionIndex = 14876;
	...
	public:
		...
		{
			return (::RPG::GameCore::DamageBehaviorTemplate**)Il2CppClass::FromTypeDefinitionIndex(DamageBehaviorTemplateListConfig_TypeDefinitionIndex)->GetStaticField(0x11530);
		}
