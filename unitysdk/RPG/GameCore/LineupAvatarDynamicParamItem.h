...
#define RPG_GAMECORE_LINEUPAVATARDYNAMICPARAMITEM_METHOD_2_DE324ECF67CEB45D_OFFSET UNITYSDK_OFFSET(0x18A604A0)
#define RPG_GAMECORE_LINEUPAVATARDYNAMICPARAMITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x18A60600)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LineupAvatarDynamicParamItem_TypeDefinitionIndex = 17226;
