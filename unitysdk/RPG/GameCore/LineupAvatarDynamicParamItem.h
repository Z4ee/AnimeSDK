...
#define RPG_GAMECORE_LINEUPAVATARDYNAMICPARAMITEM_METHOD_2_DE324ECF67CEB45D_OFFSET UNITYSDK_OFFSET(0x17352740)
#define RPG_GAMECORE_LINEUPAVATARDYNAMICPARAMITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x173528A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LineupAvatarDynamicParamItem_TypeDefinitionIndex = 16634;
