...
#define RPG_GAMECORE_AETHERDIVIDETRIGGERATTACKSIMPLIFIED_METHOD_3_D91FB4518FB3A140_OFFSET UNITYSDK_OFFSET(0x1868E010)
#define RPG_GAMECORE_AETHERDIVIDETRIGGERATTACKSIMPLIFIED_METHOD_3_E6DC7E90C49EC7F9_OFFSET UNITYSDK_OFFSET(0x1868DF90)
#define RPG_GAMECORE_AETHERDIVIDETRIGGERATTACKSIMPLIFIED__CTOR_OFFSET UNITYSDK_OFFSET(0x1868DFE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AetherDivideTriggerAttackSimplified_TypeDefinitionIndex = 23058;
