...
#define RPG_GAMECORE_FLOORCONSTVALUEFILTEREXPRESSION_METHOD_2_51E4FABF7407A9DA_OFFSET UNITYSDK_OFFSET(0x18926270)
#define RPG_GAMECORE_FLOORCONSTVALUEFILTEREXPRESSION_METHOD_2_66F0AAD0F6C13DA1_OFFSET UNITYSDK_OFFSET(0x18926140)
#define RPG_GAMECORE_FLOORCONSTVALUEFILTEREXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x18926130)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FloorConstValueFilterExpression_TypeDefinitionIndex = 16515;
