...
#define RPG_GAMECORE_FLOORCONSTVALUEFILTEREXPRESSION_METHOD_2_51E4FABF7407A9DA_OFFSET UNITYSDK_OFFSET(0x1BEBAFD0)
#define RPG_GAMECORE_FLOORCONSTVALUEFILTEREXPRESSION_METHOD_2_66F0AAD0F6C13DA1_OFFSET UNITYSDK_OFFSET(0x1BEBAE90)
#define RPG_GAMECORE_FLOORCONSTVALUEFILTEREXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEBAE80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FloorConstValueFilterExpression_TypeDefinitionIndex = 16708;
