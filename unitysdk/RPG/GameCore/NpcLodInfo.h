...
#define RPG_GAMECORE_NPCLODINFO_METHOD_2_7F190D6E74173A2F_OFFSET UNITYSDK_OFFSET(0x1BAFC030)
#define RPG_GAMECORE_NPCLODINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAFC2D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NpcLodInfo_TypeDefinitionIndex = 18360;
