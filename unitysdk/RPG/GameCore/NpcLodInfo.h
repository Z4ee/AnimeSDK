...
#define RPG_GAMECORE_NPCLODINFO_METHOD_2_7F190D6E74173A2F_OFFSET UNITYSDK_OFFSET(0x1CE91F50)
#define RPG_GAMECORE_NPCLODINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE921F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NpcLodInfo_TypeDefinitionIndex = 18884;
