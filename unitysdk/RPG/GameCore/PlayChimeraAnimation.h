...
#define RPG_GAMECORE_PLAYCHIMERAANIMATION_METHOD_3_0517CDC2790729BA_OFFSET UNITYSDK_OFFSET(0x18C0CBD0)
#define RPG_GAMECORE_PLAYCHIMERAANIMATION_METHOD_3_44D7A2E9C5BFCCE4_OFFSET UNITYSDK_OFFSET(0x18C0CC30)
#define RPG_GAMECORE_PLAYCHIMERAANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x18C0CC20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayChimeraAnimation_TypeDefinitionIndex = 15025;
