...
#define RPG_GAMECORE_FATEPARAMMASTERMAXHPCONFIG_METHOD_6_052EACEF838C36F7_OFFSET UNITYSDK_OFFSET(0x19714C20)
#define RPG_GAMECORE_FATEPARAMMASTERMAXHPCONFIG_METHOD_6_44AB9F122567A29B_OFFSET UNITYSDK_OFFSET(0x19714A60)
#define RPG_GAMECORE_FATEPARAMMASTERMAXHPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19714B60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateParamMasterMaxHpConfig_TypeDefinitionIndex = 15808;
