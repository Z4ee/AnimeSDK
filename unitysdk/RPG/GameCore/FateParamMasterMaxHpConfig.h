...
#define RPG_GAMECORE_FATEPARAMMASTERMAXHPCONFIG_METHOD_6_052EACEF838C36F7_OFFSET UNITYSDK_OFFSET(0x188D8780)
#define RPG_GAMECORE_FATEPARAMMASTERMAXHPCONFIG_METHOD_6_44AB9F122567A29B_OFFSET UNITYSDK_OFFSET(0x188D85C0)
#define RPG_GAMECORE_FATEPARAMMASTERMAXHPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x188D86C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateParamMasterMaxHpConfig_TypeDefinitionIndex = 15753;
