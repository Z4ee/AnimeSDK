...
#define RPG_GAMECORE_RTINSERTSKILL_METHOD_3_94B163D988F9F903_OFFSET UNITYSDK_OFFSET(0x1D4AAAE0)
#define RPG_GAMECORE_RTINSERTSKILL_METHOD_3_C981899358B251FD_OFFSET UNITYSDK_OFFSET(0x1D4AAA40)
#define RPG_GAMECORE_RTINSERTSKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4AAAA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtInsertSkill_TypeDefinitionIndex = 23943;
