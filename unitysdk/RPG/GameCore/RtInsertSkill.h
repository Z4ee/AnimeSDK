...
#define RPG_GAMECORE_RTINSERTSKILL_METHOD_3_060ABBF019720B8D_OFFSET UNITYSDK_OFFSET(0x18DD0C90)
#define RPG_GAMECORE_RTINSERTSKILL_METHOD_3_94B163D988F9F903_OFFSET UNITYSDK_OFFSET(0x18DD0D60)
#define RPG_GAMECORE_RTINSERTSKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x18DD0D10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtInsertSkill_TypeDefinitionIndex = 23222;
