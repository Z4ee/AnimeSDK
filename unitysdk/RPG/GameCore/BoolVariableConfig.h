...
#define RPG_GAMECORE_BOOLVARIABLECONFIG_METHOD_2_5502569308AEC2E4_OFFSET UNITYSDK_OFFSET(0x1A405FD0)
#define RPG_GAMECORE_BOOLVARIABLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A406130)
