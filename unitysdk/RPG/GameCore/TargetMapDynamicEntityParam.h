...
#define RPG_GAMECORE_TARGETMAPDYNAMICENTITYPARAM_METHOD_3_28AD7662C9671FD9_OFFSET UNITYSDK_OFFSET(0x18EE89C0)
#define RPG_GAMECORE_TARGETMAPDYNAMICENTITYPARAM_METHOD_3_CC59B4EE77B2C84D_OFFSET UNITYSDK_OFFSET(0x18EE8AC0)
#define RPG_GAMECORE_TARGETMAPDYNAMICENTITYPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x18EE8AA0)
