...
#define RPG_GAMECORE_TARGETMAPDYNAMICENTITYPARAM_METHOD_3_67585A8E2A8DCC82_OFFSET UNITYSDK_OFFSET(0x1D5B3EC0)
#define RPG_GAMECORE_TARGETMAPDYNAMICENTITYPARAM_METHOD_3_79AD8B4055AA5190_OFFSET UNITYSDK_OFFSET(0x1D5B3D60)
#define RPG_GAMECORE_TARGETMAPDYNAMICENTITYPARAM_METHOD_3_CC59B4EE77B2C84D_OFFSET UNITYSDK_OFFSET(0x1D5B3E20)
#define RPG_GAMECORE_TARGETMAPDYNAMICENTITYPARAM_METHOD_3_FD4B795A666EC691_OFFSET UNITYSDK_OFFSET(0x1D5B3EF0)
#define RPG_GAMECORE_TARGETMAPDYNAMICENTITYPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5B3E10)
