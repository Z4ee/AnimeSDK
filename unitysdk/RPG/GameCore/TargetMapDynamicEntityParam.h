...
#define RPG_GAMECORE_TARGETMAPDYNAMICENTITYPARAM_METHOD_3_67585A8E2A8DCC82_OFFSET UNITYSDK_OFFSET(0x1D0C27C0)
#define RPG_GAMECORE_TARGETMAPDYNAMICENTITYPARAM_METHOD_3_79AD8B4055AA5190_OFFSET UNITYSDK_OFFSET(0x1D0C2660)
#define RPG_GAMECORE_TARGETMAPDYNAMICENTITYPARAM_METHOD_3_CC59B4EE77B2C84D_OFFSET UNITYSDK_OFFSET(0x1D0C2720)
#define RPG_GAMECORE_TARGETMAPDYNAMICENTITYPARAM_METHOD_3_FD4B795A666EC691_OFFSET UNITYSDK_OFFSET(0x1D0C27F0)
#define RPG_GAMECORE_TARGETMAPDYNAMICENTITYPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0C2710)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapDynamicEntityParam_TypeDefinitionIndex = 23115;
