...
#define RPG_GAMECORE_LITTLEGAMEWAYPOINTGRAPHEDGE_METHOD_2_B46D092D17357DDA_OFFSET UNITYSDK_OFFSET(0x1BCC61D0)
#define RPG_GAMECORE_LITTLEGAMEWAYPOINTGRAPHEDGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCC62F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameWayPointGraphEdge_TypeDefinitionIndex = 18131;
