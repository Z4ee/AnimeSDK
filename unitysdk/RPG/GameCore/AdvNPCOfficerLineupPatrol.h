...
#define RPG_GAMECORE_ADVNPCOFFICERLINEUPPATROL_METHOD_3_3773C08236E86A40_OFFSET UNITYSDK_OFFSET(0x16F34900)
#define RPG_GAMECORE_ADVNPCOFFICERLINEUPPATROL_METHOD_3_BCF7D6823E77EF16_OFFSET UNITYSDK_OFFSET(0x16F34990)
#define RPG_GAMECORE_ADVNPCOFFICERLINEUPPATROL__CTOR_OFFSET UNITYSDK_OFFSET(0x16F34960)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvNPCOfficerLineupPatrol_TypeDefinitionIndex = 18274;
