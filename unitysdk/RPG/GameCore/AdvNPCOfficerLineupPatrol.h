...
#define RPG_GAMECORE_ADVNPCOFFICERLINEUPPATROL_METHOD_3_BCF7D6823E77EF16_OFFSET UNITYSDK_OFFSET(0x1CDCED60)
#define RPG_GAMECORE_ADVNPCOFFICERLINEUPPATROL_METHOD_3_D0FB31FAC6CB4CDF_OFFSET UNITYSDK_OFFSET(0x1CDCED10)
#define RPG_GAMECORE_ADVNPCOFFICERLINEUPPATROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDCED50)
