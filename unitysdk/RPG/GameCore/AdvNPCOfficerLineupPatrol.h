...
#define RPG_GAMECORE_ADVNPCOFFICERLINEUPPATROL_METHOD_3_3773C08236E86A40_OFFSET UNITYSDK_OFFSET(0x1942A640)
#define RPG_GAMECORE_ADVNPCOFFICERLINEUPPATROL_METHOD_3_BCF7D6823E77EF16_OFFSET UNITYSDK_OFFSET(0x1942A6D0)
#define RPG_GAMECORE_ADVNPCOFFICERLINEUPPATROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1942A6A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvNPCOfficerLineupPatrol_TypeDefinitionIndex = 18876;
