...
#define RPG_GAMECORE_MAPROTATIONMONSTEREFFECTCONFIG_METHOD_3_51717C95712572EE_OFFSET UNITYSDK_OFFSET(0x1BD0BD70)
#define RPG_GAMECORE_MAPROTATIONMONSTEREFFECTCONFIG_METHOD_3_C3C9F529B0051BB3_OFFSET UNITYSDK_OFFSET(0x1BD0BD30)
#define RPG_GAMECORE_MAPROTATIONMONSTEREFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD0BD60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MapRotationMonsterEffectConfig_TypeDefinitionIndex = 16348;
