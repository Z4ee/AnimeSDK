...
#define RPG_GAMECORE_REWINDTIMEREWINDTARGETINRANGE_METHOD_3_220E0D3821047C67_OFFSET UNITYSDK_OFFSET(0x18CBC320)
#define RPG_GAMECORE_REWINDTIMEREWINDTARGETINRANGE_METHOD_3_B524E4EFDC289D96_OFFSET UNITYSDK_OFFSET(0x18CBC3A0)
#define RPG_GAMECORE_REWINDTIMEREWINDTARGETINRANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x18CBC370)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RewindTimeRewindTargetInRange_TypeDefinitionIndex = 19628;
