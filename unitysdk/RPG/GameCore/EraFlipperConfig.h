...
#define RPG_GAMECORE_ERAFLIPPERCONFIG_METHOD_2_8ACF04680296B79E_OFFSET UNITYSDK_OFFSET(0x1D7CDCA0)
#define RPG_GAMECORE_ERAFLIPPERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7CDE60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EraFlipperConfig_TypeDefinitionIndex = 16443;
