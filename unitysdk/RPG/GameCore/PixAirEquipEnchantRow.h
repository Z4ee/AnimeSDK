...
#define RPG_GAMECORE_PIXAIREQUIPENCHANTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D334FC0)
#define RPG_GAMECORE_PIXAIREQUIPENCHANTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D335150)
