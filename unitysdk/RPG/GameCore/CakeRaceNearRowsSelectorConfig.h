...
#define RPG_GAMECORE_CAKERACENEARROWSSELECTORCONFIG_METHOD_3_5410C84A0150FA56_OFFSET UNITYSDK_OFFSET(0x1704DA00)
#define RPG_GAMECORE_CAKERACENEARROWSSELECTORCONFIG_METHOD_3_E4AE0B99A9C6B1AD_OFFSET UNITYSDK_OFFSET(0x1704D9C0)
#define RPG_GAMECORE_CAKERACENEARROWSSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1704D9F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceNearRowsSelectorConfig_TypeDefinitionIndex = 16893;
