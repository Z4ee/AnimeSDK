...
#define RPG_GAMECORE_CAKERACENEARROWSSELECTORCONFIG_METHOD_3_5410C84A0150FA56_OFFSET UNITYSDK_OFFSET(0x1876E360)
#define RPG_GAMECORE_CAKERACENEARROWSSELECTORCONFIG_METHOD_3_E4AE0B99A9C6B1AD_OFFSET UNITYSDK_OFFSET(0x18773680)
#define RPG_GAMECORE_CAKERACENEARROWSSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1876E350)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceNearRowsSelectorConfig_TypeDefinitionIndex = 17487;
