...
#define RPG_GAMECORE_CAKERACENEARROWSSELECTORCONFIG_METHOD_3_5410C84A0150FA56_OFFSET UNITYSDK_OFFSET(0x195EA2A0)
#define RPG_GAMECORE_CAKERACENEARROWSSELECTORCONFIG_METHOD_3_E4AE0B99A9C6B1AD_OFFSET UNITYSDK_OFFSET(0x195EF810)
#define RPG_GAMECORE_CAKERACENEARROWSSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x195EA290)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceNearRowsSelectorConfig_TypeDefinitionIndex = 17489;
