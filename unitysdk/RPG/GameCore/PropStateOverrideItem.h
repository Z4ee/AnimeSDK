...
#define RPG_GAMECORE_PROPSTATEOVERRIDEITEM_METHOD_2_0002226D54DE06D4_OFFSET UNITYSDK_OFFSET(0x19A9CCF0)
#define RPG_GAMECORE_PROPSTATEOVERRIDEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x19A9CE70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropStateOverrideItem_TypeDefinitionIndex = 18088;
