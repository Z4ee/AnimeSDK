...
#define RPG_GAMECORE_PROPSTATEOVERRIDEITEM_METHOD_2_0002226D54DE06D4_OFFSET UNITYSDK_OFFSET(0x1756FD90)
#define RPG_GAMECORE_PROPSTATEOVERRIDEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1756FF10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropStateOverrideItem_TypeDefinitionIndex = 17455;
