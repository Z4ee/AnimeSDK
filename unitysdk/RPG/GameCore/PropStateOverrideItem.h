...
#define RPG_GAMECORE_PROPSTATEOVERRIDEITEM_METHOD_2_0002226D54DE06D4_OFFSET UNITYSDK_OFFSET(0x1B9A4850)
#define RPG_GAMECORE_PROPSTATEOVERRIDEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9A49D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropStateOverrideItem_TypeDefinitionIndex = 18292;
