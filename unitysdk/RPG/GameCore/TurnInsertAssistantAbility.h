...
#define RPG_GAMECORE_TURNINSERTASSISTANTABILITY_METHOD_3_AADAC172CA47B4F0_OFFSET UNITYSDK_OFFSET(0x1D2A0CB0)
#define RPG_GAMECORE_TURNINSERTASSISTANTABILITY_METHOD_3_BBD86DD485F877EC_OFFSET UNITYSDK_OFFSET(0x1D2A0C10)
#define RPG_GAMECORE_TURNINSERTASSISTANTABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2A0C70)
