...
#define RPG_GAMECORE_TURNINSERTASSISTANTABILITY_METHOD_3_AADAC172CA47B4F0_OFFSET UNITYSDK_OFFSET(0x1B067660)
#define RPG_GAMECORE_TURNINSERTASSISTANTABILITY_METHOD_3_BBD86DD485F877EC_OFFSET UNITYSDK_OFFSET(0x1B0675C0)
#define RPG_GAMECORE_TURNINSERTASSISTANTABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B067620)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TurnInsertAssistantAbility_TypeDefinitionIndex = 22731;
