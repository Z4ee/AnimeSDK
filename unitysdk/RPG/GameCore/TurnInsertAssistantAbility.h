...
#define RPG_GAMECORE_TURNINSERTASSISTANTABILITY_METHOD_3_8D641ADFB3F7A682_OFFSET UNITYSDK_OFFSET(0x178D5E00)
#define RPG_GAMECORE_TURNINSERTASSISTANTABILITY_METHOD_3_BBD86DD485F877EC_OFFSET UNITYSDK_OFFSET(0x178D5D30)
#define RPG_GAMECORE_TURNINSERTASSISTANTABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x178D5DB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TurnInsertAssistantAbility_TypeDefinitionIndex = 21812;
