...
#define RPG_GAMECORE_LITTLEGAMECONSTCONFIG_METHOD_2_1A134D468F1A1A32_OFFSET UNITYSDK_OFFSET(0x1BCC01D0)
#define RPG_GAMECORE_LITTLEGAMECONSTCONFIG_METHOD_2_50ADBD3FBC9F9117_OFFSET UNITYSDK_OFFSET(0x1BCBFC50)
#define RPG_GAMECORE_LITTLEGAMECONSTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCC01C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameConstConfig_TypeDefinitionIndex = 18108;
