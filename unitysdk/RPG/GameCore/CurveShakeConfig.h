...
#define RPG_GAMECORE_CURVESHAKECONFIG_METHOD_2_8AEE028FC6E06C5E_OFFSET UNITYSDK_OFFSET(0x1D803DD0)
#define RPG_GAMECORE_CURVESHAKECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D803F90)
