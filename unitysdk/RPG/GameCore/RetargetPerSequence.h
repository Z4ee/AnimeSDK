...
#define RPG_GAMECORE_RETARGETPERSEQUENCE_METHOD_3_509201181B3F2507_OFFSET UNITYSDK_OFFSET(0x18CB8F00)
#define RPG_GAMECORE_RETARGETPERSEQUENCE_METHOD_3_DECF24C818849F8A_OFFSET UNITYSDK_OFFSET(0x18CB8F80)
#define RPG_GAMECORE_RETARGETPERSEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x18CB8F50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RetargetPerSequence_TypeDefinitionIndex = 21327;
