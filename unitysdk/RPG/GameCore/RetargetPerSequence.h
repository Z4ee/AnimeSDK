...
#define RPG_GAMECORE_RETARGETPERSEQUENCE_METHOD_3_509201181B3F2507_OFFSET UNITYSDK_OFFSET(0x175AD240)
#define RPG_GAMECORE_RETARGETPERSEQUENCE_METHOD_3_DECF24C818849F8A_OFFSET UNITYSDK_OFFSET(0x175AD2C0)
#define RPG_GAMECORE_RETARGETPERSEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x175AD290)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RetargetPerSequence_TypeDefinitionIndex = 20633;
