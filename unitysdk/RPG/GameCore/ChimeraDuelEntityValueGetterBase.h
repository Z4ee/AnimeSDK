...
#define RPG_GAMECORE_CHIMERADUELENTITYVALUEGETTERBASE_METHOD_2_96724FB55C83BCA3_OFFSET UNITYSDK_OFFSET(0x1C23E300)
#define RPG_GAMECORE_CHIMERADUELENTITYVALUEGETTERBASE_METHOD_2_EA83D007EF3D678A_OFFSET UNITYSDK_OFFSET(0x1C23E5F0)
#define RPG_GAMECORE_CHIMERADUELENTITYVALUEGETTERBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C23DBC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelEntityValueGetterBase_TypeDefinitionIndex = 15311;
