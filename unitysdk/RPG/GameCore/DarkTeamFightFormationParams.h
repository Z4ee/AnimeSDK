...
#define RPG_GAMECORE_DARKTEAMFIGHTFORMATIONPARAMS_METHOD_2_A6500252E7AF07C5_OFFSET UNITYSDK_OFFSET(0x1D018110)
#define RPG_GAMECORE_DARKTEAMFIGHTFORMATIONPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D018300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DarkTeamFightFormationParams_TypeDefinitionIndex = 16402;
