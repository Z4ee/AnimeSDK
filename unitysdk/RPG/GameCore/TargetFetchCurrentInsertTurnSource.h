...
#define RPG_GAMECORE_TARGETFETCHCURRENTINSERTTURNSOURCE_METHOD_4_8282431C7543F54D_OFFSET UNITYSDK_OFFSET(0x1D0B9270)
#define RPG_GAMECORE_TARGETFETCHCURRENTINSERTTURNSOURCE_METHOD_4_8CA0371C76095050_OFFSET UNITYSDK_OFFSET(0x1D0B9370)
#define RPG_GAMECORE_TARGETFETCHCURRENTINSERTTURNSOURCE_METHOD_4_C46C96AAA9CDFCE8_OFFSET UNITYSDK_OFFSET(0x1D0B92F0)
#define RPG_GAMECORE_TARGETFETCHCURRENTINSERTTURNSOURCE_METHOD_4_EE3CFC16C9C93C5D_OFFSET UNITYSDK_OFFSET(0x1D0B9350)
#define RPG_GAMECORE_TARGETFETCHCURRENTINSERTTURNSOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0B92E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchCurrentInsertTurnSource_TypeDefinitionIndex = 23177;
