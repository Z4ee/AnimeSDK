...
#define RPG_GAMECORE_TARGETFETCHCURRENTINSERTTURNSOURCE_METHOD_4_8CA0371C76095050_OFFSET UNITYSDK_OFFSET(0x19D0C6A0)
#define RPG_GAMECORE_TARGETFETCHCURRENTINSERTTURNSOURCE_METHOD_4_C46C96AAA9CDFCE8_OFFSET UNITYSDK_OFFSET(0x19CF8A40)
#define RPG_GAMECORE_TARGETFETCHCURRENTINSERTTURNSOURCE_METHOD_4_F4AAEFED5B26427A_OFFSET UNITYSDK_OFFSET(0x19D0C5E0)
#define RPG_GAMECORE_TARGETFETCHCURRENTINSERTTURNSOURCE_METHOD_4_F93483D56EC10F30_OFFSET UNITYSDK_OFFSET(0x19D052B0)
#define RPG_GAMECORE_TARGETFETCHCURRENTINSERTTURNSOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x19CF89F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchCurrentInsertTurnSource_TypeDefinitionIndex = 22710;
	...
	public:
		...
		static ::System::Void Method_4_F93483D56EC10F30(::SimpleJSON::JSONNode* a1, ::RPG::GameCore::TargetFetchCurrentInsertTurnSource*& a2)
		{
			return ((::System::Void(*)(::SimpleJSON::JSONNode*, ::RPG::GameCore::TargetFetchCurrentInsertTurnSource*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_TARGETFETCHCURRENTINSERTTURNSOURCE_METHOD_4_F93483D56EC10F30_OFFSET))(a1, a2);
		}
