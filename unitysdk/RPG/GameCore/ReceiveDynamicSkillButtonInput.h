...
#define RPG_GAMECORE_RECEIVEDYNAMICSKILLBUTTONINPUT_METHOD_3_2CAF6F342C8E4CF5_OFFSET UNITYSDK_OFFSET(0x19AB3A80)
#define RPG_GAMECORE_RECEIVEDYNAMICSKILLBUTTONINPUT_METHOD_3_C75F873EF6EB9684_OFFSET UNITYSDK_OFFSET(0x19AB3B10)
#define RPG_GAMECORE_RECEIVEDYNAMICSKILLBUTTONINPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x19AB3AE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ReceiveDynamicSkillButtonInput_TypeDefinitionIndex = 21599;
