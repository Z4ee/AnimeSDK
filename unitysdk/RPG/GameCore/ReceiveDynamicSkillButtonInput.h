...
#define RPG_GAMECORE_RECEIVEDYNAMICSKILLBUTTONINPUT_METHOD_3_2CAF6F342C8E4CF5_OFFSET UNITYSDK_OFFSET(0x17584220)
#define RPG_GAMECORE_RECEIVEDYNAMICSKILLBUTTONINPUT_METHOD_3_C77C07E41B3D950D_OFFSET UNITYSDK_OFFSET(0x175842B0)
#define RPG_GAMECORE_RECEIVEDYNAMICSKILLBUTTONINPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x17584280)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ReceiveDynamicSkillButtonInput_TypeDefinitionIndex = 21044;
