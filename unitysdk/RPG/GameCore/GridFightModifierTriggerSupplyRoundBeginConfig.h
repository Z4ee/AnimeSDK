...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERTRIGGERSUPPLYROUNDBEGINCONFIG_METHOD_3_16A3C79BF42FBB96_OFFSET UNITYSDK_OFFSET(0x1D06B570)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERTRIGGERSUPPLYROUNDBEGINCONFIG_METHOD_3_81DAAE4A48AD053A_OFFSET UNITYSDK_OFFSET(0x1D06B520)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERTRIGGERSUPPLYROUNDBEGINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D06B560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierTriggerSupplyRoundBeginConfig_TypeDefinitionIndex = 18705;
