...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERTRIGGERSUPPLYROUNDBEGINCONFIG_METHOD_3_16A3C79BF42FBB96_OFFSET UNITYSDK_OFFSET(0x189C0480)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERTRIGGERSUPPLYROUNDBEGINCONFIG_METHOD_3_90C4AF63B08C547F_OFFSET UNITYSDK_OFFSET(0x189C03B0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERTRIGGERSUPPLYROUNDBEGINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189C0430)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierTriggerSupplyRoundBeginConfig_TypeDefinitionIndex = 18484;
