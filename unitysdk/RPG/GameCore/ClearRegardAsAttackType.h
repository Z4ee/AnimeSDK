...
#define RPG_GAMECORE_CLEARREGARDASATTACKTYPE_METHOD_3_0A0373E5E86373C6_OFFSET UNITYSDK_OFFSET(0x188126C0)
#define RPG_GAMECORE_CLEARREGARDASATTACKTYPE_METHOD_3_F3F1457C24437A19_OFFSET UNITYSDK_OFFSET(0x18812640)
#define RPG_GAMECORE_CLEARREGARDASATTACKTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x18812690)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClearRegardAsAttackType_TypeDefinitionIndex = 22161;
