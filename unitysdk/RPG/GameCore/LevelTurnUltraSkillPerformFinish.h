...
#define RPG_GAMECORE_LEVELTURNULTRASKILLPERFORMFINISH_GETACTIVEENTITY_OFFSET UNITYSDK_OFFSET(0xB6E2090)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPERFORMFINISH_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xB6E2000)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPERFORMFINISH_GETINSERTULTRASKILLPARAMS_OFFSET UNITYSDK_OFFSET(0xB6E2050)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPERFORMFINISH_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xB6E1FB0)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPERFORMFINISH_INIT_OFFSET UNITYSDK_OFFSET(0xB6E1F50)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPERFORMFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0xB6E20E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelTurnUltraSkillPerformFinish_TypeDefinitionIndex = 52269;
