...
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_DEFENDER_METHOD_3_65EA1D82E3D2BC40_OFFSET UNITYSDK_OFFSET(0x1E00F130)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_DEFENDER_METHOD_3_F5DB4736ADEF4705_OFFSET UNITYSDK_OFFSET(0x1E00F090)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_DEFENDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E00F120)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleTargetEvaluator_Defender_TypeDefinitionIndex = 15599;
