...
#define RPG_GAMECORE_STARTPROPINTERACTMODE_METHOD_3_2887BFAFA512FE24_OFFSET UNITYSDK_OFFSET(0x18E9B700)
#define RPG_GAMECORE_STARTPROPINTERACTMODE_METHOD_3_9D6A12818703D061_OFFSET UNITYSDK_OFFSET(0x18E9B5C0)
#define RPG_GAMECORE_STARTPROPINTERACTMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E9B670)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StartPropInteractMode_TypeDefinitionIndex = 19338;
