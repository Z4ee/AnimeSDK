...
#define RPG_GAMECORE_STARTPROPINTERACTMODE_METHOD_3_2887BFAFA512FE24_OFFSET UNITYSDK_OFFSET(0x1D568320)
#define RPG_GAMECORE_STARTPROPINTERACTMODE_METHOD_3_C36B2CD695C5F1FA_OFFSET UNITYSDK_OFFSET(0x1D5682A0)
#define RPG_GAMECORE_STARTPROPINTERACTMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5682F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StartPropInteractMode_TypeDefinitionIndex = 20150;
