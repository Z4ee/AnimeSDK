...
#define RPG_GAMECORE_STARTPROPINTERACTMODE_METHOD_3_2887BFAFA512FE24_OFFSET UNITYSDK_OFFSET(0x19CB8A00)
#define RPG_GAMECORE_STARTPROPINTERACTMODE_METHOD_3_9D6A12818703D061_OFFSET UNITYSDK_OFFSET(0x19CB88C0)
#define RPG_GAMECORE_STARTPROPINTERACTMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x19CB8970)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StartPropInteractMode_TypeDefinitionIndex = 19248;
