...
#define RPG_GAMECORE_INFINITEWAVESORTBYACTIVITY340_METHOD_3_4BA5441474302F39_OFFSET UNITYSDK_OFFSET(0x18A1D460)
#define RPG_GAMECORE_INFINITEWAVESORTBYACTIVITY340_METHOD_3_C9B45F801F1BCCAD_OFFSET UNITYSDK_OFFSET(0x18A1D570)
#define RPG_GAMECORE_INFINITEWAVESORTBYACTIVITY340__CTOR_OFFSET UNITYSDK_OFFSET(0x18A1D540)

namespace RPG::GameCore
{
	inline static constexpr unsigned int InfiniteWaveSortByActivity340_TypeDefinitionIndex = 22227;
