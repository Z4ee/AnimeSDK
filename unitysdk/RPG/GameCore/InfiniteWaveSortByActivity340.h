...
#define RPG_GAMECORE_INFINITEWAVESORTBYACTIVITY340_METHOD_3_4BA5441474302F39_OFFSET UNITYSDK_OFFSET(0x172BAEF0)
#define RPG_GAMECORE_INFINITEWAVESORTBYACTIVITY340_METHOD_3_C9B45F801F1BCCAD_OFFSET UNITYSDK_OFFSET(0x172BB000)
#define RPG_GAMECORE_INFINITEWAVESORTBYACTIVITY340__CTOR_OFFSET UNITYSDK_OFFSET(0x172BAFD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int InfiniteWaveSortByActivity340_TypeDefinitionIndex = 21491;
