...
#define RPG_GAMECORE_ABORTMODIFIERPHASEPERFORM_METHOD_3_92DBCA80B3BA4678_OFFSET UNITYSDK_OFFSET(0x1B9FA4D0)
#define RPG_GAMECORE_ABORTMODIFIERPHASEPERFORM_METHOD_3_AB2A092DBBBFDAB5_OFFSET UNITYSDK_OFFSET(0x1B9FA400)
#define RPG_GAMECORE_ABORTMODIFIERPHASEPERFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9FA4C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AbortModifierPhasePerform_TypeDefinitionIndex = 22779;
