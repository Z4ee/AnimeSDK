...
#define RPG_GAMECORE_ABORTMODIFIERPHASEPERFORM_METHOD_3_014F14AA4AD61EEC_OFFSET UNITYSDK_OFFSET(0x185F59C0)
#define RPG_GAMECORE_ABORTMODIFIERPHASEPERFORM_METHOD_3_92DBCA80B3BA4678_OFFSET UNITYSDK_OFFSET(0x185F5AD0)
#define RPG_GAMECORE_ABORTMODIFIERPHASEPERFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x185F5AA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AbortModifierPhasePerform_TypeDefinitionIndex = 22608;
