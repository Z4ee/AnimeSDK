...
#define RPG_GAMECORE_ABORTMODIFIERPHASEPERFORM_METHOD_3_92DBCA80B3BA4678_OFFSET UNITYSDK_OFFSET(0x1C9E1A60)
#define RPG_GAMECORE_ABORTMODIFIERPHASEPERFORM_METHOD_3_AB2A092DBBBFDAB5_OFFSET UNITYSDK_OFFSET(0x1C9E1990)
#define RPG_GAMECORE_ABORTMODIFIERPHASEPERFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9E1A50)
