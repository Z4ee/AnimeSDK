...
#define RPG_GAMECORE_EXPEDITIONBATTLEDEATHACTION_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1D7DB350)
#define RPG_GAMECORE_EXPEDITIONBATTLEDEATHACTION_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D7DB2B0)
#define RPG_GAMECORE_EXPEDITIONBATTLEDEATHACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7DB340)
