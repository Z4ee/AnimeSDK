...
#define RPG_GAMECORE_SKILLDATA_ADDTAGS_OFFSET UNITYSDK_OFFSET(0x119B10C0)
#define RPG_GAMECORE_SKILLDATA_GETAUTOSELECTPRIORITY_OFFSET UNITYSDK_OFFSET(0x119B11E0)
#define RPG_GAMECORE_SKILLDATA_GETCUSTOMREADYCONFIG_OFFSET UNITYSDK_OFFSET(0x119B1310)
#define RPG_GAMECORE_SKILLDATA_GETPROPERTYVALUEIGNORESLOT_OFFSET UNITYSDK_OFFSET(0x119B1000)
#define RPG_GAMECORE_SKILLDATA_GETPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x119A63F0)
#define RPG_GAMECORE_SKILLDATA_GETREADCAMERACONFIG_OFFSET UNITYSDK_OFFSET(0x119B1490)
#define RPG_GAMECORE_SKILLDATA_GETREADYANIMSTATE_OFFSET UNITYSDK_OFFSET(0x119B0860)
#define RPG_GAMECORE_SKILLDATA_GETREADYCUSTOMFORMATIONCONFIG_OFFSET UNITYSDK_OFFSET(0x119B1420)
#define RPG_GAMECORE_SKILLDATA_GETUNUSABLECONDITIONRESULT_OFFSET UNITYSDK_OFFSET(0x119AA3E0)
#define RPG_GAMECORE_SKILLDATA_GET_ASSISTSKILLUICONFIG_OFFSET UNITYSDK_OFFSET(0x119B0B10)
#define RPG_GAMECORE_SKILLDATA_GET_ATTACKTYPE_OFFSET UNITYSDK_OFFSET(0x119B0650)
#define RPG_GAMECORE_SKILLDATA_GET_BPADD_OFFSET UNITYSDK_OFFSET(0x119AFDB0)
#define RPG_GAMECORE_SKILLDATA_GET_BPNEED_OFFSET UNITYSDK_OFFSET(0x119ABFA0)
#define RPG_GAMECORE_SKILLDATA_GET_CANTRAVERSALBYCOMPLEXSKILLAI_OFFSET UNITYSDK_OFFSET(0x119B0EB0)
#define RPG_GAMECORE_SKILLDATA_GET_CHILDSKILLCOUNT_OFFSET UNITYSDK_OFFSET(0x119AAD50)
#define RPG_GAMECORE_SKILLDATA_GET_CURRENTCTRLTYPE_OFFSET UNITYSDK_OFFSET(0x119A18F0)
#define RPG_GAMECORE_SKILLDATA_GET_CUSTOMSKILLBUTTONPREFABPATH_OFFSET UNITYSDK_OFFSET(0x119B09E0)
#define RPG_GAMECORE_SKILLDATA_GET_DELAYRATIO_OFFSET UNITYSDK_OFFSET(0x119B0540)
#define RPG_GAMECORE_SKILLDATA_GET_FINALAIULTRASKILLPRIORITY_OFFSET UNITYSDK_OFFSET(0x119B0F20)
#define RPG_GAMECORE_SKILLDATA_GET_FORBIDENHANCEEFFECT_OFFSET UNITYSDK_OFFSET(0x119B0A80)
#define RPG_GAMECORE_SKILLDATA_GET_ISINSERTCONDTIONMEET_OFFSET UNITYSDK_OFFSET(0x119AA710)
#define RPG_GAMECORE_SKILLDATA_GET_ISUSABLECONDITIONMEET_OFFSET UNITYSDK_OFFSET(0x119AA2A0)
#define RPG_GAMECORE_SKILLDATA_GET_ISVISABLECONDTIONMEET_OFFSET UNITYSDK_OFFSET(0x119B0DD0)
#define RPG_GAMECORE_SKILLDATA_GET_LAYERTYPE_OFFSET UNITYSDK_OFFSET(0x119A83A0)
#define RPG_GAMECORE_SKILLDATA_GET_PROGRESSDISPLAYTYPE_OFFSET UNITYSDK_OFFSET(0x119B0BA0)
#define RPG_GAMECORE_SKILLDATA_GET_READYANIMSTATE_OFFSET UNITYSDK_OFFSET(0x119B0850)
#define RPG_GAMECORE_SKILLDATA_GET_ROOTSKILLDATA_OFFSET UNITYSDK_OFFSET(0x119B0E50)
#define RPG_GAMECORE_SKILLDATA_GET_SHOWASMENU_OFFSET UNITYSDK_OFFSET(0x119B02F0)
#define RPG_GAMECORE_SKILLDATA_GET_SKILLCOMBOVALUEDELTA_OFFSET UNITYSDK_OFFSET(0x119B0750)
#define RPG_GAMECORE_SKILLDATA_GET_SKILLEFFECT_OFFSET UNITYSDK_OFFSET(0x1199EDC0)
#define RPG_GAMECORE_SKILLDATA_GET_SKILLLAYOUTKEY_OFFSET UNITYSDK_OFFSET(0x119B03D0)
#define RPG_GAMECORE_SKILLDATA_GET_SLOT_OFFSET UNITYSDK_OFFSET(0x119B0D50)
#define RPG_GAMECORE_SKILLDATA_GET_SPADD_OFFSET UNITYSDK_OFFSET(0x119AFD60)
#define RPG_GAMECORE_SKILLDATA_GET_SPBASE_OFFSET UNITYSDK_OFFSET(0x119B04F0)
#define RPG_GAMECORE_SKILLDATA_GET_SPECIALBUTTONTYPE_OFFSET UNITYSDK_OFFSET(0x119B08F0)
#define RPG_GAMECORE_SKILLDATA_GET_SPMULTIPLERATIO_OFFSET UNITYSDK_OFFSET(0x119B04A0)
#define RPG_GAMECORE_SKILLDATA_GET_SPNEED_OFFSET UNITYSDK_OFFSET(0x119B0450)
#define RPG_GAMECORE_SKILLDATA_GET_TARGETINFO_OFFSET UNITYSDK_OFFSET(0x1199ED70)
#define RPG_GAMECORE_SKILLDATA_GET_TARGETTEAMTYPE_OFFSET UNITYSDK_OFFSET(0x119B0590)
#define RPG_GAMECORE_SKILLDATA_GET_UISKILLINDEX_OFFSET UNITYSDK_OFFSET(0x119B0250)
#define RPG_GAMECORE_SKILLDATA_GET__UICONFIG_OFFSET UNITYSDK_OFFSET(0x119B0980)
#define RPG_GAMECORE_SKILLDATA_HASMULTITARGETGROUP_OFFSET UNITYSDK_OFFSET(0x119B15F0)
#define RPG_GAMECORE_SKILLDATA_MODIFYPROPERTY_OFFSET UNITYSDK_OFFSET(0x119A9390)
#define RPG_GAMECORE_SKILLDATA_OVERRIDEPROGRESSDISPLAYTYPE_OFFSET UNITYSDK_OFFSET(0x119B0C10)
#define RPG_GAMECORE_SKILLDATA_REMOVETAGS_OFFSET UNITYSDK_OFFSET(0x119B1150)
#define RPG_GAMECORE_SKILLDATA_SETDEFAULTPROPERTY_OFFSET UNITYSDK_OFFSET(0x119A4EF0)
#define RPG_GAMECORE_SKILLDATA_SETOVERRIDEPROPERTY_OFFSET UNITYSDK_OFFSET(0x119B0F80)
#define RPG_GAMECORE_SKILLDATA_SET_SLOT_OFFSET UNITYSDK_OFFSET(0x119B0DC0)
#define RPG_GAMECORE_SKILLDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x119A4E20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SkillData_TypeDefinitionIndex = 57821;

	class SkillData : public ::System::Object
	{
	public:
		::RPG::GameCore::VCameraConfig* OverrideCameraConfigAdded; // 0x10
		::RPG::GameCore::ICharacterSkillRowData* RowData; // 0x18
		::RPG::GameCore::SkillData* ParentSkillData; // 0x20
		::Class_1_5F51D4049EA87B7B* VisibleCondTask; // 0x28
		::Struct_2_165AEDBFDC2B5511 ComplexAI; // 0x30
		::RPG::GameCore::SkillCharacterComponent* SkillCom; // 0x58
		::RPG::GameCore::SkillTargetConfig* DefaultTargetInfo; // 0x60
		::System::Collections::Generic::HashSet_1<::RPG::GameCore::JsonEnum*>* Tags; // 0x68
		::RPG::GameCore::SkillTargetConfig* OverrideTargetInfo; // 0x70
		::Il2CppArray<::Class_1_5F51D4049EA87B7B*>* CustomReadyConfigConditions; // 0x78
		::System::String* SkillTriggerKey; // 0x80
		::Il2CppArray<::Class_1_5F51D4049EA87B7B*>* PreshowConditions; // 0x88
		::RPG::GameCore::SkillData* AssitLinkSourceSkill; // 0x90
		::RPG::GameCore::SkillConfig* Config; // 0x98
		::Class_1_BCDC191CF05491FA* _Slot; // 0xA0
		::Il2CppArray<::Struct_2_1DBF01015A93DAF5>* _SkillProperties; // 0xA8
		::System::Collections::Generic::List_1<::Class_1_0BF70B7AEC57376C*>* UsableConditionDatas; // 0xB0
		::Class_1_DD56E792A2635894* SkillTypeOverride; // 0xB8
		::System::Collections::Generic::List_1<::RPG::GameCore::SkillData*>* AllChildSkillDatas; // 0xC0
		::Class_1_5F51D4049EA87B7B* InsertCondTask; // 0xC8
		::RPG::GameCore::VCameraConfig* OverrideCameraConfig; // 0xD0
		::System::String* OverrideAnimState; // 0xD8
		::System::Int32 ChildIndex; // 0xE0
		::System::Boolean IgnoreDisableAction; // 0xE4
		::System::UInt32 SkillConfigID; // 0xE8
		::System::Nullable_1<::RPG::GameCore::SkillSPProgressType> _OverrideProgressDisplayType; // 0xEC
		::System::Nullable_1<::System::Int32> OverrideAIUltraSkillPriority; // 0xF4
		::System::Int32 CurrentCoolDown; // 0xFC
		::System::Int32 DefaultCoolDown; // 0x100
		::System::Int32 LeftCastTimes; // 0x104
		::System::Int32 SkillIndex; // 0x108
		::RPG::GameCore::AttackDamageType AttackDamageTypePreshowAttach; // 0x10C
		::System::Int32 MaxCastTimes; // 0x110
		::System::UInt32 CommonActiveSkillID; // 0x114
		...
		::RPG::GameCore::SkillSPProgressType get_ProgressDisplayType()
		{
			return ((::RPG::GameCore::SkillSPProgressType(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_GAMECORE_SKILLDATA_GET_PROGRESSDISPLAYTYPE_OFFSET))(this);
		}

		::System::Void OverrideProgressDisplayType(::System::Nullable_1<::RPG::GameCore::SkillSPProgressType> a1)
		{
			return ((::System::Void(*)(::PVOID, ::System::Nullable_1<::RPG::GameCore::SkillSPProgressType>))((::PBYTE)hIl2Cpp + RPG_GAMECORE_SKILLDATA_OVERRIDEPROGRESSDISPLAYTYPE_OFFSET))(this, a1);
		}
