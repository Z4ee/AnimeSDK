...
#define RPG_GAMECORE_TARGETFETCHELATIONTIMESOURCE_METHOD_4_4B12DA7AE76FE0CD_OFFSET UNITYSDK_OFFSET(0x1D0B9910)
#define RPG_GAMECORE_TARGETFETCHELATIONTIMESOURCE_METHOD_4_5897A32B4225D5D4_OFFSET UNITYSDK_OFFSET(0x1D0B9A10)
#define RPG_GAMECORE_TARGETFETCHELATIONTIMESOURCE_METHOD_4_74E3EDA2F5708BD0_OFFSET UNITYSDK_OFFSET(0x1D0B9A50)
#define RPG_GAMECORE_TARGETFETCHELATIONTIMESOURCE_METHOD_4_8CFD2E091BF9E868_OFFSET UNITYSDK_OFFSET(0x1D0B99B0)
#define RPG_GAMECORE_TARGETFETCHELATIONTIMESOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0B99A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchElationTimeSource_TypeDefinitionIndex = 23087;
