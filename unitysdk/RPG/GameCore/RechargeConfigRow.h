...
#define RPG_GAMECORE_RECHARGECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B9BBB60)
#define RPG_GAMECORE_RECHARGECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9BBF90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RechargeConfigRow_TypeDefinitionIndex = 14029;

	class RechargeConfigRow : public ::System::Object
	{
	public:
		::System::String* ProductID; // 0x10
		::System::String* GiftImage; // 0x18
		::System::String* TierID; // 0x20
		::RPG::Client::TextID NormalRechargeConfirm; // 0x28
		::RPG::Client::TextID GiftName; // 0x38
		::RPG::Client::TextID FirstRechangeConfirm; // 0x48
		::System::UInt32 FirstCharge; // 0x58
		::System::UInt32 ListOrder; // 0x5C
		::System::UInt32 GiftType; // 0x60
