...
#define RPG_GAMECORE_TARGETSORTBYMULTIMODIFIERVALUESUM_METHOD_3_1D916C1BAC442397_OFFSET UNITYSDK_OFFSET(0x18EF7F60)
#define RPG_GAMECORE_TARGETSORTBYMULTIMODIFIERVALUESUM_METHOD_3_5177D4C27D495544_OFFSET UNITYSDK_OFFSET(0x18EF96A0)
#define RPG_GAMECORE_TARGETSORTBYMULTIMODIFIERVALUESUM__CTOR_OFFSET UNITYSDK_OFFSET(0x18EF7F40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetSortByMultiModifierValueSum_TypeDefinitionIndex = 22980;
