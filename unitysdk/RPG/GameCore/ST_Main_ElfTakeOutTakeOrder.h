...
#define RPG_GAMECORE_ST_MAIN_ELFTAKEOUTTAKEORDER_METHOD_4_41946CB3B694E9AF_OFFSET UNITYSDK_OFFSET(0x1D4C98F0)
#define RPG_GAMECORE_ST_MAIN_ELFTAKEOUTTAKEORDER_METHOD_4_D1D70C331C814932_OFFSET UNITYSDK_OFFSET(0x1D4C9820)
#define RPG_GAMECORE_ST_MAIN_ELFTAKEOUTTAKEORDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4C98E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_ElfTakeOutTakeOrder_TypeDefinitionIndex = 21291;
