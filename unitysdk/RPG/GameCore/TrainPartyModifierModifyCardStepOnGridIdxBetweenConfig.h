...
#define RPG_GAMECORE_TRAINPARTYMODIFIERMODIFYCARDSTEPONGRIDIDXBETWEENCONFIG_METHOD_3_6BEC3EB5BC9C0BF8_OFFSET UNITYSDK_OFFSET(0x178AD0E0)
#define RPG_GAMECORE_TRAINPARTYMODIFIERMODIFYCARDSTEPONGRIDIDXBETWEENCONFIG_METHOD_3_ECDFAE4779D62EBC_OFFSET UNITYSDK_OFFSET(0x178AD340)
#define RPG_GAMECORE_TRAINPARTYMODIFIERMODIFYCARDSTEPONGRIDIDXBETWEENCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x178AD0D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyModifierModifyCardStepOnGridIdxBetweenConfig_TypeDefinitionIndex = 16622;
