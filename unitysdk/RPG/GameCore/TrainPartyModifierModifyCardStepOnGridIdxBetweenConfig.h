...
#define RPG_GAMECORE_TRAINPARTYMODIFIERMODIFYCARDSTEPONGRIDIDXBETWEENCONFIG_METHOD_3_6BEC3EB5BC9C0BF8_OFFSET UNITYSDK_OFFSET(0x1D536C20)
#define RPG_GAMECORE_TRAINPARTYMODIFIERMODIFYCARDSTEPONGRIDIDXBETWEENCONFIG_METHOD_3_ECDFAE4779D62EBC_OFFSET UNITYSDK_OFFSET(0x1D536E80)
#define RPG_GAMECORE_TRAINPARTYMODIFIERMODIFYCARDSTEPONGRIDIDXBETWEENCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D536C10)
