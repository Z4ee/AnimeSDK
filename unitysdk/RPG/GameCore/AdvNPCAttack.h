...
#define RPG_GAMECORE_ADVNPCATTACK_METHOD_3_2B9D38811822BCD7_OFFSET UNITYSDK_OFFSET(0x16F33E00)
#define RPG_GAMECORE_ADVNPCATTACK_METHOD_3_AD002B45D9BF2246_OFFSET UNITYSDK_OFFSET(0x16F33E90)
#define RPG_GAMECORE_ADVNPCATTACK__CTOR_OFFSET UNITYSDK_OFFSET(0x16F33E60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvNPCAttack_TypeDefinitionIndex = 18254;
