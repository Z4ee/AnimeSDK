...
#define RPG_GAMECORE_BYCOMPAREPERFORMANCERESULT_METHOD_4_228CD69F1FED04A9_OFFSET UNITYSDK_OFFSET(0x187362C0)
#define RPG_GAMECORE_BYCOMPAREPERFORMANCERESULT_METHOD_4_EDBE211D78919DE1_OFFSET UNITYSDK_OFFSET(0x187361F0)
#define RPG_GAMECORE_BYCOMPAREPERFORMANCERESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x18736270)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByComparePerformanceResult_TypeDefinitionIndex = 20789;
