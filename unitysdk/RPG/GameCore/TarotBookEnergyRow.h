...
#define RPG_GAMECORE_TAROTBOOKENERGYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1E1C7130)
#define RPG_GAMECORE_TAROTBOOKENERGYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1C7370)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Boolean IsRepetitive; // 0x20
		::System::Boolean IsSilence; // 0x21
