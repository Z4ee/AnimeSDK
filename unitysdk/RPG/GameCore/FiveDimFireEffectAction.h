...
#define RPG_GAMECORE_FIVEDIMFIREEFFECTACTION_METHOD_3_4C93557B2F8E15D1_OFFSET UNITYSDK_OFFSET(0x1973CE50)
#define RPG_GAMECORE_FIVEDIMFIREEFFECTACTION_METHOD_3_58254C7A042E779B_OFFSET UNITYSDK_OFFSET(0x1972F0C0)
#define RPG_GAMECORE_FIVEDIMFIREEFFECTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1972F0A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimFireEffectAction_TypeDefinitionIndex = 17828;
