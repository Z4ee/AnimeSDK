...
#define RPG_GAMECORE_FIVEDIMFIREEFFECTACTION_METHOD_3_4C93557B2F8E15D1_OFFSET UNITYSDK_OFFSET(0x171F1CB0)
#define RPG_GAMECORE_FIVEDIMFIREEFFECTACTION_METHOD_3_58254C7A042E779B_OFFSET UNITYSDK_OFFSET(0x171E7F80)
#define RPG_GAMECORE_FIVEDIMFIREEFFECTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x171E7F60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimFireEffectAction_TypeDefinitionIndex = 17199;
