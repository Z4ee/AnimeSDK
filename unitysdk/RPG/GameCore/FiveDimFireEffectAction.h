...
#define RPG_GAMECORE_FIVEDIMFIREEFFECTACTION_METHOD_3_58254C7A042E779B_OFFSET UNITYSDK_OFFSET(0x1BA95C90)
#define RPG_GAMECORE_FIVEDIMFIREEFFECTACTION_METHOD_3_76728577DFFDF03D_OFFSET UNITYSDK_OFFSET(0x1BA95B20)
#define RPG_GAMECORE_FIVEDIMFIREEFFECTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA95C80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimFireEffectAction_TypeDefinitionIndex = 18005;
