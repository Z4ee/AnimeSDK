...
#define RPG_GAMECORE_RA_BYCOMPAREVARIABLEFLOAT_METHOD_4_0060350ECFA9D32E_OFFSET UNITYSDK_OFFSET(0x1B9AE480)
#define RPG_GAMECORE_RA_BYCOMPAREVARIABLEFLOAT_METHOD_4_0EFEB70C014BE9C3_OFFSET UNITYSDK_OFFSET(0x1B9AE700)
#define RPG_GAMECORE_RA_BYCOMPAREVARIABLEFLOAT_METHOD_4_76A7E4624C96AE6C_OFFSET UNITYSDK_OFFSET(0x1B9AE6D0)
#define RPG_GAMECORE_RA_BYCOMPAREVARIABLEFLOAT_METHOD_4_C30BA96C24A5F47F_OFFSET UNITYSDK_OFFSET(0x1B9AE4C0)
#define RPG_GAMECORE_RA_BYCOMPAREVARIABLEFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9AE4B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RA_ByCompareVariableFloat_TypeDefinitionIndex = 19278;
