...
#define RPG_GAMECORE_RA_BYCOMPAREVARIABLEFLOAT_METHOD_4_79AEFD109088615F_OFFSET UNITYSDK_OFFSET(0x17579120)
#define RPG_GAMECORE_RA_BYCOMPAREVARIABLEFLOAT_METHOD_4_C30BA96C24A5F47F_OFFSET UNITYSDK_OFFSET(0x175791F0)
#define RPG_GAMECORE_RA_BYCOMPAREVARIABLEFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x175791A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RA_ByCompareVariableFloat_TypeDefinitionIndex = 18327;
