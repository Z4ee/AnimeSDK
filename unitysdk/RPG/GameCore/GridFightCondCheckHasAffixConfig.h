...
#define RPG_GAMECORE_GRIDFIGHTCONDCHECKHASAFFIXCONFIG_METHOD_6_97D40177D648D5C6_OFFSET UNITYSDK_OFFSET(0x1C5C5010)
#define RPG_GAMECORE_GRIDFIGHTCONDCHECKHASAFFIXCONFIG_METHOD_6_9B5FA85681815E62_OFFSET UNITYSDK_OFFSET(0x1C5C5060)
#define RPG_GAMECORE_GRIDFIGHTCONDCHECKHASAFFIXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5C5050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightCondCheckHasAffixConfig_TypeDefinitionIndex = 18579;
