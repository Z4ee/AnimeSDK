...
#define RPG_GAMECORE_GRIDFIGHTCONDCHECKHASAFFIXCONFIG_METHOD_6_838579B5E1EED84E_OFFSET UNITYSDK_OFFSET(0x197DBCD0)
#define RPG_GAMECORE_GRIDFIGHTCONDCHECKHASAFFIXCONFIG_METHOD_6_9B5FA85681815E62_OFFSET UNITYSDK_OFFSET(0x197DBE90)
#define RPG_GAMECORE_GRIDFIGHTCONDCHECKHASAFFIXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197DBDD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightCondCheckHasAffixConfig_TypeDefinitionIndex = 18339;
