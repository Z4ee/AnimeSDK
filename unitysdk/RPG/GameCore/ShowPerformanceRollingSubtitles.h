...
#define RPG_GAMECORE_SHOWPERFORMANCEROLLINGSUBTITLES_METHOD_3_5722C0EE10E94A98_OFFSET UNITYSDK_OFFSET(0x1D52D9E0)
#define RPG_GAMECORE_SHOWPERFORMANCEROLLINGSUBTITLES_METHOD_3_8EB6AE516F4A8EE5_OFFSET UNITYSDK_OFFSET(0x1D52DA30)
#define RPG_GAMECORE_SHOWPERFORMANCEROLLINGSUBTITLES__CTOR_OFFSET UNITYSDK_OFFSET(0x1D52DA20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowPerformanceRollingSubtitles_TypeDefinitionIndex = 21695;
