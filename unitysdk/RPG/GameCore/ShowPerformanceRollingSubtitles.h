...
#define RPG_GAMECORE_SHOWPERFORMANCEROLLINGSUBTITLES_METHOD_3_8EB6AE516F4A8EE5_OFFSET UNITYSDK_OFFSET(0x18E647E0)
#define RPG_GAMECORE_SHOWPERFORMANCEROLLINGSUBTITLES_METHOD_3_96823ECCBF09953E_OFFSET UNITYSDK_OFFSET(0x18E64740)
#define RPG_GAMECORE_SHOWPERFORMANCEROLLINGSUBTITLES__CTOR_OFFSET UNITYSDK_OFFSET(0x18E647A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowPerformanceRollingSubtitles_TypeDefinitionIndex = 20797;
