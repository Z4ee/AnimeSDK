...
#define RPG_GAMECORE_ROGUETOURNBUFFROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19BBFED0)
#define RPG_GAMECORE_ROGUETOURNBUFFROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19BC0830)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournBuffRow_TypeDefinitionIndex = 14280;
	...
	public:
		...
		::System::UInt32 MazeBuffLevel; // 0x1C
		::System::UInt32 RogueBuffTag; // 0x20
		::System::UInt32 MazeBuffID; // 0x24
		::System::UInt32 UnlockDisplay; // 0x28
		::System::UInt32 RogueBuffType; // 0x2C
		::System::Boolean IsInHandbook; // 0x30
		::RPG::GameCore::RogueBuffCategory RogueBuffCategory; // 0x34
