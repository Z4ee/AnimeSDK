...
#define RPG_GAMECORE_ROGUETOURNBUFFROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1BB6DF60)
#define RPG_GAMECORE_ROGUETOURNBUFFROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB6E8C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournBuffRow_TypeDefinitionIndex = 14428;
	...
	public:
		...
		::System::UInt32 UnlockDisplay; // 0x1C
