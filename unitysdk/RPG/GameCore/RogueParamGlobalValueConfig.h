...
#define RPG_GAMECORE_ROGUEPARAMGLOBALVALUECONFIG_METHOD_6_7779E3F109231B5B_OFFSET UNITYSDK_OFFSET(0x18D58E50)
#define RPG_GAMECORE_ROGUEPARAMGLOBALVALUECONFIG_METHOD_6_EC50A70739F5B675_OFFSET UNITYSDK_OFFSET(0x18D58BA0)
#define RPG_GAMECORE_ROGUEPARAMGLOBALVALUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D58D20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamGlobalValueConfig_TypeDefinitionIndex = 18821;
