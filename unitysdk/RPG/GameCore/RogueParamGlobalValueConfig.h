...
#define RPG_GAMECORE_ROGUEPARAMGLOBALVALUECONFIG_METHOD_6_7779E3F109231B5B_OFFSET UNITYSDK_OFFSET(0x19BAE470)
#define RPG_GAMECORE_ROGUEPARAMGLOBALVALUECONFIG_METHOD_6_EC50A70739F5B675_OFFSET UNITYSDK_OFFSET(0x19BAE1C0)
#define RPG_GAMECORE_ROGUEPARAMGLOBALVALUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19BAE340)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamGlobalValueConfig_TypeDefinitionIndex = 18786;
