...
#define RPG_GAMECORE_ROGUEPARAMGLOBALVALUECONFIG_METHOD_6_7779E3F109231B5B_OFFSET UNITYSDK_OFFSET(0x1D176780)
#define RPG_GAMECORE_ROGUEPARAMGLOBALVALUECONFIG_METHOD_6_9690BD307408A6F7_OFFSET UNITYSDK_OFFSET(0x1D176730)
#define RPG_GAMECORE_ROGUEPARAMGLOBALVALUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D176770)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamGlobalValueConfig_TypeDefinitionIndex = 19067;
