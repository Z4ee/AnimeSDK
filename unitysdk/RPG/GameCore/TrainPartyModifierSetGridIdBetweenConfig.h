...
#define RPG_GAMECORE_TRAINPARTYMODIFIERSETGRIDIDBETWEENCONFIG_METHOD_3_787AA22114D35FCD_OFFSET UNITYSDK_OFFSET(0x19DF6C50)
#define RPG_GAMECORE_TRAINPARTYMODIFIERSETGRIDIDBETWEENCONFIG_METHOD_3_E90CCFABF46E1CB1_OFFSET UNITYSDK_OFFSET(0x19DF6910)
#define RPG_GAMECORE_TRAINPARTYMODIFIERSETGRIDIDBETWEENCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19DF6900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyModifierSetGridIdBetweenConfig_TypeDefinitionIndex = 17205;
