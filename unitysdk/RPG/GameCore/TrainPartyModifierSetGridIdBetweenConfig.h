...
#define RPG_GAMECORE_TRAINPARTYMODIFIERSETGRIDIDBETWEENCONFIG_METHOD_3_787AA22114D35FCD_OFFSET UNITYSDK_OFFSET(0x1C161CB0)
#define RPG_GAMECORE_TRAINPARTYMODIFIERSETGRIDIDBETWEENCONFIG_METHOD_3_E90CCFABF46E1CB1_OFFSET UNITYSDK_OFFSET(0x1C161970)
#define RPG_GAMECORE_TRAINPARTYMODIFIERSETGRIDIDBETWEENCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C161960)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyModifierSetGridIdBetweenConfig_TypeDefinitionIndex = 17367;
