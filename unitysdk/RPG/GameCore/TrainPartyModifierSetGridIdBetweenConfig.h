...
#define RPG_GAMECORE_TRAINPARTYMODIFIERSETGRIDIDBETWEENCONFIG_METHOD_3_787AA22114D35FCD_OFFSET UNITYSDK_OFFSET(0x178AD500)
#define RPG_GAMECORE_TRAINPARTYMODIFIERSETGRIDIDBETWEENCONFIG_METHOD_3_E90CCFABF46E1CB1_OFFSET UNITYSDK_OFFSET(0x178AD1C0)
#define RPG_GAMECORE_TRAINPARTYMODIFIERSETGRIDIDBETWEENCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x178AD1B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyModifierSetGridIdBetweenConfig_TypeDefinitionIndex = 16605;
