...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONASTYLELEVELUPCONFIG_METHOD_3_C6C242BC6CBB957A_OFFSET UNITYSDK_OFFSET(0x19B52C00)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONASTYLELEVELUPCONFIG_METHOD_3_CEAFC8B4F5257743_OFFSET UNITYSDK_OFFSET(0x19B5D8A0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONASTYLELEVELUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B52BB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnPersonaStyleLevelUpConfig_TypeDefinitionIndex = 16963;
