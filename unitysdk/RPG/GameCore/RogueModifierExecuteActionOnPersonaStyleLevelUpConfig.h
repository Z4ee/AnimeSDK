...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONASTYLELEVELUPCONFIG_METHOD_3_306DECB23D34DABE_OFFSET UNITYSDK_OFFSET(0x1CFC0BC0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONASTYLELEVELUPCONFIG_METHOD_3_C6C242BC6CBB957A_OFFSET UNITYSDK_OFFSET(0x1CFC0C10)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONASTYLELEVELUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFC0C00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnPersonaStyleLevelUpConfig_TypeDefinitionIndex = 17125;
