...
#define RPG_GAMECORE_TARGETMAPDAMAGEDEFENDER_METHOD_3_12C73044BC9F8E48_OFFSET UNITYSDK_OFFSET(0x1D5B3900)
#define RPG_GAMECORE_TARGETMAPDAMAGEDEFENDER_METHOD_3_48E6ADFA93845395_OFFSET UNITYSDK_OFFSET(0x1D5B3920)
#define RPG_GAMECORE_TARGETMAPDAMAGEDEFENDER_METHOD_3_4C24DFA278F9AF12_OFFSET UNITYSDK_OFFSET(0x1D5B3820)
#define RPG_GAMECORE_TARGETMAPDAMAGEDEFENDER_METHOD_3_63557D0EBE19C913_OFFSET UNITYSDK_OFFSET(0x1D5B38A0)
#define RPG_GAMECORE_TARGETMAPDAMAGEDEFENDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5B3890)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapDamageDefender_TypeDefinitionIndex = 23746;
