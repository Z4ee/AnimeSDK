...
#define RPG_GAMECORE_TARGETMAPDAMAGEDEFENDER_METHOD_3_63557D0EBE19C913_OFFSET UNITYSDK_OFFSET(0x177C2EE0)
#define RPG_GAMECORE_TARGETMAPDAMAGEDEFENDER_METHOD_3_D0AA79EC756516BE_OFFSET UNITYSDK_OFFSET(0x177C2E20)
#define RPG_GAMECORE_TARGETMAPDAMAGEDEFENDER__CTOR_OFFSET UNITYSDK_OFFSET(0x177C2EC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapDamageDefender_TypeDefinitionIndex = 22293;
