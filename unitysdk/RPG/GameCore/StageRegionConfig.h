...
#define RPG_GAMECORE_STAGEREGIONCONFIG_METHOD_2_B0AFA0334A1CB41D_OFFSET UNITYSDK_OFFSET(0x1776BD10)
#define RPG_GAMECORE_STAGEREGIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1776C1A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StageRegionConfig_TypeDefinitionIndex = 17609;
