...
#define RPG_GAMECORE_BYTRAINVISITORISMEET_METHOD_4_84CBAA5A2A140879_OFFSET UNITYSDK_OFFSET(0x187631D0)
#define RPG_GAMECORE_BYTRAINVISITORISMEET_METHOD_4_C159910D9C7847B2_OFFSET UNITYSDK_OFFSET(0x18763370)
#define RPG_GAMECORE_BYTRAINVISITORISMEET__CTOR_OFFSET UNITYSDK_OFFSET(0x187632B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByTrainVisitorIsMeet_TypeDefinitionIndex = 20526;
