...
#define RPG_GAMECORE_IDLELIVEFUNCUNLOCKHINTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D19FA00)
#define RPG_GAMECORE_IDLELIVEFUNCUNLOCKHINTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D19FC50)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::IdleLiveFuncUnlockType FuncUnlockType; // 0x18
