...
#define RPG_GAMECORE_PROPREWARDPREVIEW_METHOD_3_0E9D5F2810DD604A_OFFSET UNITYSDK_OFFSET(0x18C73A90)
#define RPG_GAMECORE_PROPREWARDPREVIEW_METHOD_3_8C194FB138FB7FFB_OFFSET UNITYSDK_OFFSET(0x18C73B10)
#define RPG_GAMECORE_PROPREWARDPREVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x18C73AE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropRewardPreview_TypeDefinitionIndex = 20932;
