...
#define RPG_GAMECORE_LOCKTARGETSHIELD_METHOD_3_6CC22598BF4C0FF1_OFFSET UNITYSDK_OFFSET(0x1736C620)
#define RPG_GAMECORE_LOCKTARGETSHIELD_METHOD_3_FD131076F05BFA9D_OFFSET UNITYSDK_OFFSET(0x1736C5A0)
#define RPG_GAMECORE_LOCKTARGETSHIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x1736C5F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LockTargetShield_TypeDefinitionIndex = 21862;
