...
#define RPG_GAMECORE_LOCKTARGETSHIELD_METHOD_3_6CC22598BF4C0FF1_OFFSET UNITYSDK_OFFSET(0x18A7A230)
#define RPG_GAMECORE_LOCKTARGETSHIELD_METHOD_3_FD131076F05BFA9D_OFFSET UNITYSDK_OFFSET(0x18A7A1B0)
#define RPG_GAMECORE_LOCKTARGETSHIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x18A7A200)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LockTargetShield_TypeDefinitionIndex = 22600;
