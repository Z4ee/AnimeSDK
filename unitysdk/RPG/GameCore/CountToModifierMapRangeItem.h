...
#define RPG_GAMECORE_COUNTTOMODIFIERMAPRANGEITEM_METHOD_2_0BE6D4350F150E1B_OFFSET UNITYSDK_OFFSET(0x1883FB50)
#define RPG_GAMECORE_COUNTTOMODIFIERMAPRANGEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1883FCC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CountToModifierMapRangeItem_TypeDefinitionIndex = 15231;
