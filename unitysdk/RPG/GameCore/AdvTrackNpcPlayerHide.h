...
#define RPG_GAMECORE_ADVTRACKNPCPLAYERHIDE_METHOD_3_342A7EC9D3299658_OFFSET UNITYSDK_OFFSET(0x1943AE40)
#define RPG_GAMECORE_ADVTRACKNPCPLAYERHIDE_METHOD_3_34D232189AB271CE_OFFSET UNITYSDK_OFFSET(0x1943ADC0)
#define RPG_GAMECORE_ADVTRACKNPCPLAYERHIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x1943AE10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvTrackNpcPlayerHide_TypeDefinitionIndex = 20966;
