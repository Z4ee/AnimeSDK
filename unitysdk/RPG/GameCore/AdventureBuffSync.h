...
#define RPG_GAMECORE_ADVENTUREBUFFSYNC_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xCCC1010)
#define RPG_GAMECORE_ADVENTUREBUFFSYNC_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xCCC1060)
#define RPG_GAMECORE_ADVENTUREBUFFSYNC__CTOR_OFFSET UNITYSDK_OFFSET(0xCCC1000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureBuffSync_TypeDefinitionIndex = 52891;
