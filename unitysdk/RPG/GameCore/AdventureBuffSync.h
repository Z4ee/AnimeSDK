...
#define RPG_GAMECORE_ADVENTUREBUFFSYNC_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x153E2AA0)
#define RPG_GAMECORE_ADVENTUREBUFFSYNC_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x153E2AF0)
#define RPG_GAMECORE_ADVENTUREBUFFSYNC__CTOR_OFFSET UNITYSDK_OFFSET(0x153E2A90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureBuffSync_TypeDefinitionIndex = 54103;
