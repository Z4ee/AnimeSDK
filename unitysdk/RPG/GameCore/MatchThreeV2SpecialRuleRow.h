...
#define RPG_GAMECORE_MATCHTHREEV2SPECIALRULEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x173B8D90)
#define RPG_GAMECORE_MATCHTHREEV2SPECIALRULEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x173B8F50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MatchThreeV2SpecialRuleRow_TypeDefinitionIndex = 10971;

	class MatchThreeV2SpecialRuleRow : public ::System::Object
	{
	public:
		::System::String* Icon; // 0x10
		::System::UInt32 SpecialRuleID; // 0x18
