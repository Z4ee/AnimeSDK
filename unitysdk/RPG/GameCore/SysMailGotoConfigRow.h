...
#define RPG_GAMECORE_SYSMAILGOTOCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x177A5DA0)
#define RPG_GAMECORE_SYSMAILGOTOCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x177A6390)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SysMailGotoConfigRow_TypeDefinitionIndex = 13932;
