...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYCOINONSTARTCONFIG_METHOD_3_21849E633B82C6E7_OFFSET UNITYSDK_OFFSET(0x17633D90)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYCOINONSTARTCONFIG_METHOD_3_CB725BF087C98AFE_OFFSET UNITYSDK_OFFSET(0x17633E60)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYCOINONSTARTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17633E10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyCoinOnStartConfig_TypeDefinitionIndex = 16519;
