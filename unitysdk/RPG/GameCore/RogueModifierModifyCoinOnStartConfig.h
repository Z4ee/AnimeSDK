...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYCOINONSTARTCONFIG_METHOD_3_21849E633B82C6E7_OFFSET UNITYSDK_OFFSET(0x19B5F0C0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYCOINONSTARTCONFIG_METHOD_3_CB725BF087C98AFE_OFFSET UNITYSDK_OFFSET(0x19B551A0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYCOINONSTARTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B55150)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyCoinOnStartConfig_TypeDefinitionIndex = 17086;
