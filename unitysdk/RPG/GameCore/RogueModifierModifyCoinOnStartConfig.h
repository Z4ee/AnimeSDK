...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYCOINONSTARTCONFIG_METHOD_3_9100C139124C2BE2_OFFSET UNITYSDK_OFFSET(0x1EEFA8D0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYCOINONSTARTCONFIG_METHOD_3_CB725BF087C98AFE_OFFSET UNITYSDK_OFFSET(0x1EEFA920)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYCOINONSTARTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEFA910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyCoinOnStartConfig_TypeDefinitionIndex = 17765;
