...
#define RPG_GAMECORE_LITTLEGAMEABILITYEFFECTAPPLYBURNCONFIG_METHOD_3_368CE4E7594F140F_OFFSET UNITYSDK_OFFSET(0x19892950)
#define RPG_GAMECORE_LITTLEGAMEABILITYEFFECTAPPLYBURNCONFIG_METHOD_3_3CBEAE46FEE0E423_OFFSET UNITYSDK_OFFSET(0x19892A20)
#define RPG_GAMECORE_LITTLEGAMEABILITYEFFECTAPPLYBURNCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19892A10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityEffectApplyBurnConfig_TypeDefinitionIndex = 20168;
