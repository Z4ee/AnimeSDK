...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONAROOMCARDREMOVECONFIG_METHOD_3_5938F297F077F65F_OFFSET UNITYSDK_OFFSET(0x1CFC0BB0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONAROOMCARDREMOVECONFIG_METHOD_3_C2829653DDEA91DB_OFFSET UNITYSDK_OFFSET(0x1CFC0B60)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONAROOMCARDREMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFC0BA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnPersonaRoomCardRemoveConfig_TypeDefinitionIndex = 17076;
