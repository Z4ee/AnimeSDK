...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONAROOMCARDREMOVECONFIG_METHOD_3_5938F297F077F65F_OFFSET UNITYSDK_OFFSET(0x17631550)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONAROOMCARDREMOVECONFIG_METHOD_3_CCDEEC1A29EA71E6_OFFSET UNITYSDK_OFFSET(0x17631480)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONAROOMCARDREMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17631500)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnPersonaRoomCardRemoveConfig_TypeDefinitionIndex = 16345;
