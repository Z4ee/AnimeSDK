...
#define RPG_GAMECORE_FATEMODIFIERADDTRAITCOUNTCONFIG_METHOD_3_5DDC298154A9FFC9_OFFSET UNITYSDK_OFFSET(0x188D32D0)
#define RPG_GAMECORE_FATEMODIFIERADDTRAITCOUNTCONFIG_METHOD_3_C91D52458A108860_OFFSET UNITYSDK_OFFSET(0x188D33A0)
#define RPG_GAMECORE_FATEMODIFIERADDTRAITCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x188D3350)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateModifierAddTraitCountConfig_TypeDefinitionIndex = 18320;
