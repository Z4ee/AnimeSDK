...
#define RPG_GAMECORE_FATEMODIFIERADDTRAITCOUNTCONFIG_METHOD_3_085566EEB0CE4D24_OFFSET UNITYSDK_OFFSET(0x1C074C90)
#define RPG_GAMECORE_FATEMODIFIERADDTRAITCOUNTCONFIG_METHOD_3_C91D52458A108860_OFFSET UNITYSDK_OFFSET(0x1C074CE0)
#define RPG_GAMECORE_FATEMODIFIERADDTRAITCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C074CD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateModifierAddTraitCountConfig_TypeDefinitionIndex = 18527;
