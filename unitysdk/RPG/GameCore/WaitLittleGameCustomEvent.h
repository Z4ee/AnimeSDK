...
#define RPG_GAMECORE_WAITLITTLEGAMECUSTOMEVENT_METHOD_4_02AED061E88FA6E3_OFFSET UNITYSDK_OFFSET(0x1DEBAF60)
#define RPG_GAMECORE_WAITLITTLEGAMECUSTOMEVENT_METHOD_4_7EE788FB89F45EE2_OFFSET UNITYSDK_OFFSET(0x1DEBAFB0)
#define RPG_GAMECORE_WAITLITTLEGAMECUSTOMEVENT_METHOD_4_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x1DEBB1D0)
#define RPG_GAMECORE_WAITLITTLEGAMECUSTOMEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEBAFA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitLittleGameCustomEvent_TypeDefinitionIndex = 21175;
