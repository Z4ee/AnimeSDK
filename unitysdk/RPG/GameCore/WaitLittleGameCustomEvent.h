...
#define RPG_GAMECORE_WAITLITTLEGAMECUSTOMEVENT_METHOD_4_7EE788FB89F45EE2_OFFSET UNITYSDK_OFFSET(0x19E59670)
#define RPG_GAMECORE_WAITLITTLEGAMECUSTOMEVENT_METHOD_4_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x19E59890)
#define RPG_GAMECORE_WAITLITTLEGAMECUSTOMEVENT_METHOD_4_99780285AEB0CFBA_OFFSET UNITYSDK_OFFSET(0x19E59590)
#define RPG_GAMECORE_WAITLITTLEGAMECUSTOMEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19E59610)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitLittleGameCustomEvent_TypeDefinitionIndex = 20230;
