...
#define RPG_GAMECORE_WAITLITTLEGAMECUSTOMEVENT_METHOD_4_7EE788FB89F45EE2_OFFSET UNITYSDK_OFFSET(0x19100CD0)
#define RPG_GAMECORE_WAITLITTLEGAMECUSTOMEVENT_METHOD_4_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x19100EF0)
#define RPG_GAMECORE_WAITLITTLEGAMECUSTOMEVENT_METHOD_4_99780285AEB0CFBA_OFFSET UNITYSDK_OFFSET(0x19100BF0)
#define RPG_GAMECORE_WAITLITTLEGAMECUSTOMEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19100C70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitLittleGameCustomEvent_TypeDefinitionIndex = 20311;
