...
#define RPG_GAMECORE_WOLFBROACTIVATEBULLET_METHOD_3_25295E5054A2505F_OFFSET UNITYSDK_OFFSET(0x1790B130)
#define RPG_GAMECORE_WOLFBROACTIVATEBULLET_METHOD_3_777A2A1393595EEB_OFFSET UNITYSDK_OFFSET(0x1790B020)
#define RPG_GAMECORE_WOLFBROACTIVATEBULLET__CTOR_OFFSET UNITYSDK_OFFSET(0x1790B100)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WolfBroActivateBullet_TypeDefinitionIndex = 19747;
