...
#define RPG_GAMECORE_WOLFBROACTIVATEBULLET_METHOD_3_25295E5054A2505F_OFFSET UNITYSDK_OFFSET(0x1D1C2360)
#define RPG_GAMECORE_WOLFBROACTIVATEBULLET_METHOD_3_775D696E6F06F3A2_OFFSET UNITYSDK_OFFSET(0x1D1C2290)
#define RPG_GAMECORE_WOLFBROACTIVATEBULLET__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1C2350)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WolfBroActivateBullet_TypeDefinitionIndex = 20785;
