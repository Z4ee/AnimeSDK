...
#define RPG_GAMECORE_WOLFBROACTIVATEBULLET_METHOD_3_25295E5054A2505F_OFFSET UNITYSDK_OFFSET(0x19E676C0)
#define RPG_GAMECORE_WOLFBROACTIVATEBULLET_METHOD_3_777A2A1393595EEB_OFFSET UNITYSDK_OFFSET(0x19E675B0)
#define RPG_GAMECORE_WOLFBROACTIVATEBULLET__CTOR_OFFSET UNITYSDK_OFFSET(0x19E67690)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WolfBroActivateBullet_TypeDefinitionIndex = 20370;
