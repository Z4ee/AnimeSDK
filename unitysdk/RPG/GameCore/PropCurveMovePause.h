...
#define RPG_GAMECORE_PROPCURVEMOVEPAUSE_METHOD_3_66440961E3EB5823_OFFSET UNITYSDK_OFFSET(0x18C671B0)
#define RPG_GAMECORE_PROPCURVEMOVEPAUSE_METHOD_3_D2B85BA5E08D255B_OFFSET UNITYSDK_OFFSET(0x18C67280)
#define RPG_GAMECORE_PROPCURVEMOVEPAUSE__CTOR_OFFSET UNITYSDK_OFFSET(0x18C67230)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropCurveMovePause_TypeDefinitionIndex = 19995;
