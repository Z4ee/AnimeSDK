...
#define RPG_GAMECORE_CHARACTERSTEERTO_METHOD_3_0E31B757DD6200F1_OFFSET UNITYSDK_OFFSET(0x1CF9E720)
#define RPG_GAMECORE_CHARACTERSTEERTO_METHOD_3_58C6EB550C6ACD39_OFFSET UNITYSDK_OFFSET(0x1CF9E6D0)
#define RPG_GAMECORE_CHARACTERSTEERTO__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF9E710)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterSteerTo_TypeDefinitionIndex = 20630;
