...
#define RPG_GAMECORE_CHARACTERSTEERTO_METHOD_3_0E31B757DD6200F1_OFFSET UNITYSDK_OFFSET(0x17073190)
#define RPG_GAMECORE_CHARACTERSTEERTO_METHOD_3_D0E703C6B254C72E_OFFSET UNITYSDK_OFFSET(0x17073100)
#define RPG_GAMECORE_CHARACTERSTEERTO__CTOR_OFFSET UNITYSDK_OFFSET(0x17073160)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterSteerTo_TypeDefinitionIndex = 19195;
