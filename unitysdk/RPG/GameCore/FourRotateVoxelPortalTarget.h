...
#define RPG_GAMECORE_FOURROTATEVOXELPORTALTARGET_METHOD_2_BC8642D9925B0F08_OFFSET UNITYSDK_OFFSET(0x18930280)
#define RPG_GAMECORE_FOURROTATEVOXELPORTALTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x18930320)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FourRotateVoxelPortalTarget_TypeDefinitionIndex = 15872;
