...
#define RPG_GAMECORE_GRIDFIGHTTUTORIALSTAGECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17289C70)
#define RPG_GAMECORE_GRIDFIGHTTUTORIALSTAGECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1728A180)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::Il2CppArray<::Class_1_3745C69C00F04B7D_4*>* ForbiddenAutoOpenShopNodeList; // 0x10
		::Il2CppArray<::Class_1_3745C69C00F04B7D_3*>* ForbiddenSellRoleList; // 0x18
		::System::UInt32 IsEquipRecommendShow; // 0x20
		::System::UInt32 DivisionID; // 0x24
		::System::UInt32 ForbiddenSellRoleBeforeSectionId; // 0x28
		::System::UInt32 RewardQuest; // 0x2C
		::System::UInt32 IsInitialSupply; // 0x30
		::System::UInt32 IsBossToastShow; // 0x34
		::System::UInt32 IsAlltrial; // 0x38
		::System::UInt32 ForbiddenSellRoleBeforeChapterId; // 0x3C
		::System::UInt32 ForbiddenBattleFail; // 0x40
