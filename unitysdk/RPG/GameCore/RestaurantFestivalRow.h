...
#define RPG_GAMECORE_RESTAURANTFESTIVALROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19AD5C70)
#define RPG_GAMECORE_RESTAURANTFESTIVALROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19AD6160)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID Toast; // 0x30
		::RPG::Client::TextID Title; // 0x40
		::RPG::Client::TextID Detail; // 0x50
		::RPG::Client::TextID Name; // 0x60
		::System::Boolean IsShowToast; // 0x70
		::System::UInt32 CustomerUpNumber; // 0x74
