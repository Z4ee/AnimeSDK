...
#define RPG_GAMECORE_BILLBOARDCOMPONENT_NOTIFYPARAM_COPYTO_OFFSET UNITYSDK_OFFSET(0xE53E890)
#define RPG_GAMECORE_BILLBOARDCOMPONENT_NOTIFYPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xE53EA20)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Collections::Generic::Dictionary_2<::RPG::Client::BillboardShowType, ::System::Single>* TypeToShowDistance; // 0x18
		::RPG::Client::Billboard::IBillboardHost* Host; // 0x20
		::System::Tuple_2<::System::String*, ::System::String*>* FiveDimSidePuzzlePanelPaths; // 0x28
		::RPG::GameCore::GameEntity* Entity; // 0x30
		::RPG::Client::TextID TextTitle; // 0x38
		::RPG::Client::TextID TextIDName; // 0x48
		::RPG::GameCore::InwardBubbleTalkType InwardType; // 0x58
		::System::UInt32 NPCID; // 0x5C
		::System::Boolean IsShowFiveDimSidePuzzleChest; // 0x60
		::System::Boolean ShowTop; // 0x61
		::System::Boolean ShowInStoryMode; // 0x62
		::System::Single ZOffset; // 0x64
		::System::Single YOffset; // 0x68
		::System::Single XOffset; // 0x6C
