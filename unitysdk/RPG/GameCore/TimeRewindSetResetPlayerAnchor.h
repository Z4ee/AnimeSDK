...
#define RPG_GAMECORE_TIMEREWINDSETRESETPLAYERANCHOR_METHOD_3_243787FF977EA3B3_OFFSET UNITYSDK_OFFSET(0x19DE7BA0)
#define RPG_GAMECORE_TIMEREWINDSETRESETPLAYERANCHOR_METHOD_3_C02ED1E249B6C167_OFFSET UNITYSDK_OFFSET(0x19DE7B20)
#define RPG_GAMECORE_TIMEREWINDSETRESETPLAYERANCHOR__CTOR_OFFSET UNITYSDK_OFFSET(0x19DE7B70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TimeRewindSetResetPlayerAnchor_TypeDefinitionIndex = 19500;
