...
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_COLLIDETARGET_METHOD_3_8E5B1B827502EDC7_OFFSET UNITYSDK_OFFSET(0x1C37E370)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_COLLIDETARGET_METHOD_3_EFDE9F5A2DBF9C56_OFFSET UNITYSDK_OFFSET(0x1C37E410)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_COLLIDETARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1C37E400)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleTargetEvaluator_CollideTarget_TypeDefinitionIndex = 15153;
