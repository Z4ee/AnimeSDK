...
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_COLLIDETARGET_METHOD_3_8E5B1B827502EDC7_OFFSET UNITYSDK_OFFSET(0x19623A30)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_COLLIDETARGET_METHOD_3_EFDE9F5A2DBF9C56_OFFSET UNITYSDK_OFFSET(0x19623AD0)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_COLLIDETARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x19623AC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleTargetEvaluator_CollideTarget_TypeDefinitionIndex = 14989;
