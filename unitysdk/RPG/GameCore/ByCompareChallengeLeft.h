...
#define RPG_GAMECORE_BYCOMPARECHALLENGELEFT_METHOD_4_09AA9500D6671338_OFFSET UNITYSDK_OFFSET(0x17003E50)
#define RPG_GAMECORE_BYCOMPARECHALLENGELEFT_METHOD_4_1296E9EEAAEB2D24_OFFSET UNITYSDK_OFFSET(0x17003D80)
#define RPG_GAMECORE_BYCOMPARECHALLENGELEFT__CTOR_OFFSET UNITYSDK_OFFSET(0x17003E00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareChallengeLeft_TypeDefinitionIndex = 21754;
