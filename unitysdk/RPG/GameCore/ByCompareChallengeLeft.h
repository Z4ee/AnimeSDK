...
#define RPG_GAMECORE_BYCOMPARECHALLENGELEFT_METHOD_4_09AA9500D6671338_OFFSET UNITYSDK_OFFSET(0x19CD4700)
#define RPG_GAMECORE_BYCOMPARECHALLENGELEFT_METHOD_4_136964C71B3D38CC_OFFSET UNITYSDK_OFFSET(0x19CD48C0)
#define RPG_GAMECORE_BYCOMPARECHALLENGELEFT_METHOD_4_3BFA518E1C1991A3_OFFSET UNITYSDK_OFFSET(0x19CD48F0)
#define RPG_GAMECORE_BYCOMPARECHALLENGELEFT_METHOD_4_8D17638056B7C399_OFFSET UNITYSDK_OFFSET(0x19CD46C0)
#define RPG_GAMECORE_BYCOMPARECHALLENGELEFT__CTOR_OFFSET UNITYSDK_OFFSET(0x19CD46F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareChallengeLeft_TypeDefinitionIndex = 22681;
