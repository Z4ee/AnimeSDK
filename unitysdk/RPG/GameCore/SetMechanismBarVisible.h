...
#define RPG_GAMECORE_SETMECHANISMBARVISIBLE_METHOD_3_99FD824A61E7BC41_OFFSET UNITYSDK_OFFSET(0x176D51B0)
#define RPG_GAMECORE_SETMECHANISMBARVISIBLE_METHOD_3_F71BA915C3B8323F_OFFSET UNITYSDK_OFFSET(0x176D5130)
#define RPG_GAMECORE_SETMECHANISMBARVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x176D5180)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetMechanismBarVisible_TypeDefinitionIndex = 18823;
