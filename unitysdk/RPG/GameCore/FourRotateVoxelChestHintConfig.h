...
#define RPG_GAMECORE_FOURROTATEVOXELCHESTHINTCONFIG_METHOD_3_6BC684C0B9337775_OFFSET UNITYSDK_OFFSET(0x1721AB40)
#define RPG_GAMECORE_FOURROTATEVOXELCHESTHINTCONFIG_METHOD_3_AE691D0393D3BF8C_OFFSET UNITYSDK_OFFSET(0x1721ABB0)
#define RPG_GAMECORE_FOURROTATEVOXELCHESTHINTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1721AB90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FourRotateVoxelChestHintConfig_TypeDefinitionIndex = 15366;
