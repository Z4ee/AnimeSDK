...
#define RPG_GAMECORE_FOURROTATEVOXELCHESTHINTCONFIG_METHOD_3_98E1691212CA4139_OFFSET UNITYSDK_OFFSET(0x1D113780)
#define RPG_GAMECORE_FOURROTATEVOXELCHESTHINTCONFIG_METHOD_3_AE691D0393D3BF8C_OFFSET UNITYSDK_OFFSET(0x1D1137C0)
#define RPG_GAMECORE_FOURROTATEVOXELCHESTHINTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1137B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FourRotateVoxelChestHintConfig_TypeDefinitionIndex = 16605;
