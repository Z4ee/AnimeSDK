...
#define RPG_GAMECORE_ACTIVITYACTIVECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x193D42C0)
#define RPG_GAMECORE_ACTIVITYACTIVECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x193D4540)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityActiveConfigRow_TypeDefinitionIndex = 10490;
	...
	public:
		...
		::System::UInt32 ActiveItemID; // 0x20
		::System::UInt32 PowerConsume; // 0x24
