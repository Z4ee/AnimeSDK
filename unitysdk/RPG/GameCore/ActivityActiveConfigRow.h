...
#define RPG_GAMECORE_ACTIVITYACTIVECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18603700)
#define RPG_GAMECORE_ACTIVITYACTIVECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18603980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityActiveConfigRow_TypeDefinitionIndex = 10449;
