...
#define RPG_GAMECORE_ACTIVITYACTIVECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CD78D30)
#define RPG_GAMECORE_ACTIVITYACTIVECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD78FB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityActiveConfigRow_TypeDefinitionIndex = 10879;

	class ActivityActiveConfigRow : public ::System::Object
	{
	public:
		::Il2CppArray<::RPG::GameCore::DisplayItemConfig*>* GiftShowList; // 0x10
		::Il2CppArray<::System::UInt32>* BenefitIDList; // 0x18
		::System::UInt32 PowerConsume; // 0x20
		::System::UInt32 ActivityModuleID; // 0x24
		::System::UInt32 ActiveItemID; // 0x28
		::System::UInt32 ID; // 0x2C
		::System::UInt32 ItemLimit; // 0x30
