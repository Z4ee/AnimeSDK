...
#define RPG_GAMECORE_TRIGGERAFTERIMAGEEFFECT_METHOD_3_C0BDFBDE6FF7D5E2_OFFSET UNITYSDK_OFFSET(0x190BC4E0)
#define RPG_GAMECORE_TRIGGERAFTERIMAGEEFFECT_METHOD_3_C37B86C1F5E3C614_OFFSET UNITYSDK_OFFSET(0x190BC560)
#define RPG_GAMECORE_TRIGGERAFTERIMAGEEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x190BC530)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerAfterImageEffect_TypeDefinitionIndex = 19179;
