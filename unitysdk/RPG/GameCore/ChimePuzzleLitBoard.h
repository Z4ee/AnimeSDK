...
#define RPG_GAMECORE_CHIMEPUZZLELITBOARD_METHOD_3_36E99F86866ED823_OFFSET UNITYSDK_OFFSET(0x187EF9F0)
#define RPG_GAMECORE_CHIMEPUZZLELITBOARD_METHOD_3_CC8D97DDA43738AA_OFFSET UNITYSDK_OFFSET(0x187EF970)
#define RPG_GAMECORE_CHIMEPUZZLELITBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x187EF9C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimePuzzleLitBoard_TypeDefinitionIndex = 20831;
