...
#define RPG_GAMECORE_CHIMEPUZZLELITBOARD_METHOD_3_36E99F86866ED823_OFFSET UNITYSDK_OFFSET(0x1C38BC20)
#define RPG_GAMECORE_CHIMEPUZZLELITBOARD_METHOD_3_40F5B1B598C685B8_OFFSET UNITYSDK_OFFSET(0x1C38BBE0)
#define RPG_GAMECORE_CHIMEPUZZLELITBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x1C38BC10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimePuzzleLitBoard_TypeDefinitionIndex = 21169;
