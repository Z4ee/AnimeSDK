...
#define RPG_GAMECORE_STANCELEVELEFFECTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B0BA6B0)
#define RPG_GAMECORE_STANCELEVELEFFECTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0BB0B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StanceLevelEffectRow_TypeDefinitionIndex = 14573;
