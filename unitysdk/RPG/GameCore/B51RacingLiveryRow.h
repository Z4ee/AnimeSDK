...
#define RPG_GAMECORE_B51RACINGLIVERYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CE5D6E0)
#define RPG_GAMECORE_B51RACINGLIVERYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE5D8F0)
