...
#define RPG_GAMECORE_CHARACTERPRELOADCONFIG_METHOD_3_B2E8A12BEC2C251D_OFFSET UNITYSDK_OFFSET(0x187D5D40)
#define RPG_GAMECORE_CHARACTERPRELOADCONFIG_METHOD_3_B64FDCDFCAACC286_OFFSET UNITYSDK_OFFSET(0x187D5D80)
#define RPG_GAMECORE_CHARACTERPRELOADCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x187D5D70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterPreloadConfig_TypeDefinitionIndex = 15464;
