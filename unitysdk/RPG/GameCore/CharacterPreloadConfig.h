...
#define RPG_GAMECORE_CHARACTERPRELOADCONFIG_METHOD_3_D22621BB0528DB79_OFFSET UNITYSDK_OFFSET(0x19613600)
#define RPG_GAMECORE_CHARACTERPRELOADCONFIG_METHOD_3_FB94E5661557FC12_OFFSET UNITYSDK_OFFSET(0x19613640)
#define RPG_GAMECORE_CHARACTERPRELOADCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19613630)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterPreloadConfig_TypeDefinitionIndex = 15527;
