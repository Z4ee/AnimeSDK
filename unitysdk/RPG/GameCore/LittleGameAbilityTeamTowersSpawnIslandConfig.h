...
#define RPG_GAMECORE_LITTLEGAMEABILITYTEAMTOWERSSPAWNISLANDCONFIG_METHOD_3_3C69F07C29C4A53B_OFFSET UNITYSDK_OFFSET(0x1BCBCB30)
#define RPG_GAMECORE_LITTLEGAMEABILITYTEAMTOWERSSPAWNISLANDCONFIG_METHOD_3_76E478390E88D4CB_OFFSET UNITYSDK_OFFSET(0x1BCBCB90)
#define RPG_GAMECORE_LITTLEGAMEABILITYTEAMTOWERSSPAWNISLANDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCBCB80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityTeamTowersSpawnIslandConfig_TypeDefinitionIndex = 20618;
