...
#define RPG_GAMECORE_FATEPARAMOTHERCONTENTPARAMCONFIG_METHOD_6_2D33881833CB8EAB_OFFSET UNITYSDK_OFFSET(0x1BA74F50)
#define RPG_GAMECORE_FATEPARAMOTHERCONTENTPARAMCONFIG_METHOD_6_55C352718E35DFAF_OFFSET UNITYSDK_OFFSET(0x1BA74FA0)
#define RPG_GAMECORE_FATEPARAMOTHERCONTENTPARAMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA74F90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateParamOtherContentParamConfig_TypeDefinitionIndex = 15976;
