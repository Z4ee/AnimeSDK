...
#define RPG_GAMECORE_CHIMERAWORKJSONCONFIG_METHOD_2_337BB6FCD821A54F_OFFSET UNITYSDK_OFFSET(0x1C24EE40)
#define RPG_GAMECORE_CHIMERAWORKJSONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C24EFE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraWorkJsonConfig_TypeDefinitionIndex = 15273;
