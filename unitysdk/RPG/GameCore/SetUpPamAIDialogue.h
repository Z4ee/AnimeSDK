...
#define RPG_GAMECORE_SETUPPAMAIDIALOGUE_METHOD_3_14421D5CABE283AA_OFFSET UNITYSDK_OFFSET(0x1C60F4D0)
#define RPG_GAMECORE_SETUPPAMAIDIALOGUE_METHOD_3_2266F0BC0893EE47_OFFSET UNITYSDK_OFFSET(0x1C60F400)
#define RPG_GAMECORE_SETUPPAMAIDIALOGUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C60F4C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetUpPamAIDialogue_TypeDefinitionIndex = 20312;
