...
#define RPG_GAMECORE_SETUPPAMAIDIALOGUE_METHOD_3_14421D5CABE283AA_OFFSET UNITYSDK_OFFSET(0x19C663B0)
#define RPG_GAMECORE_SETUPPAMAIDIALOGUE_METHOD_3_F815646CCA6822BE_OFFSET UNITYSDK_OFFSET(0x19C662A0)
#define RPG_GAMECORE_SETUPPAMAIDIALOGUE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C66380)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetUpPamAIDialogue_TypeDefinitionIndex = 19941;
