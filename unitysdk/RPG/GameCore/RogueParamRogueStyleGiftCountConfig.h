...
#define RPG_GAMECORE_ROGUEPARAMROGUESTYLEGIFTCOUNTCONFIG_METHOD_6_755621183930E1E7_OFFSET UNITYSDK_OFFSET(0x19BB2670)
#define RPG_GAMECORE_ROGUEPARAMROGUESTYLEGIFTCOUNTCONFIG_METHOD_6_AED8C93D05F90931_OFFSET UNITYSDK_OFFSET(0x19BB23C0)
#define RPG_GAMECORE_ROGUEPARAMROGUESTYLEGIFTCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19BB2540)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamRogueStyleGiftCountConfig_TypeDefinitionIndex = 18808;
