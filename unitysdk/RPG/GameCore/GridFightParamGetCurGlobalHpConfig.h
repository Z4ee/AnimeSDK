...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETCURGLOBALHPCONFIG_METHOD_6_0EC05896EC555FD4_OFFSET UNITYSDK_OFFSET(0x189C3010)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETCURGLOBALHPCONFIG_METHOD_6_D13169B8AC054A5A_OFFSET UNITYSDK_OFFSET(0x189C2D60)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETCURGLOBALHPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189C2EE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightParamGetCurGlobalHpConfig_TypeDefinitionIndex = 18545;
