...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETCURGLOBALHPCONFIG_METHOD_6_0EC05896EC555FD4_OFFSET UNITYSDK_OFFSET(0x197F7440)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETCURGLOBALHPCONFIG_METHOD_6_D13169B8AC054A5A_OFFSET UNITYSDK_OFFSET(0x197F7190)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETCURGLOBALHPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197F7310)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightParamGetCurGlobalHpConfig_TypeDefinitionIndex = 18516;
