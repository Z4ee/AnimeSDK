...
#define RPG_GAMECORE_STAGEHARMONYSIGNALDYNAMICDIALOGMONOSERIALIZATION_METHOD_2_CBFA81D75AE7689A_OFFSET UNITYSDK_OFFSET(0x18E8D7B0)
#define RPG_GAMECORE_STAGEHARMONYSIGNALDYNAMICDIALOGMONOSERIALIZATION__CTOR_OFFSET UNITYSDK_OFFSET(0x18E8D900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StageHarmonySignalDynamicDialogMonoSerialization_TypeDefinitionIndex = 18232;
