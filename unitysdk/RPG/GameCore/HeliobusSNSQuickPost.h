...
#define RPG_GAMECORE_HELIOBUSSNSQUICKPOST_METHOD_3_4EA42E57E1C6E10E_OFFSET UNITYSDK_OFFSET(0x1D3DB530)
#define RPG_GAMECORE_HELIOBUSSNSQUICKPOST_METHOD_3_61ED5CE65485E042_OFFSET UNITYSDK_OFFSET(0x1D3DB4F0)
#define RPG_GAMECORE_HELIOBUSSNSQUICKPOST__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3DB520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HeliobusSNSQuickPost_TypeDefinitionIndex = 20211;
