...
#define RPG_GAMECORE_HELIOBUSSNSQUICKPOST_METHOD_3_290C438F86DD79AC_OFFSET UNITYSDK_OFFSET(0x172A5440)
#define RPG_GAMECORE_HELIOBUSSNSQUICKPOST_METHOD_3_E4CCEDE781054E7C_OFFSET UNITYSDK_OFFSET(0x172A54C0)
#define RPG_GAMECORE_HELIOBUSSNSQUICKPOST__CTOR_OFFSET UNITYSDK_OFFSET(0x172A5490)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HeliobusSNSQuickPost_TypeDefinitionIndex = 18747;
