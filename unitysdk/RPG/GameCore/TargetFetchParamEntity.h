...
#define RPG_GAMECORE_TARGETFETCHPARAMENTITY_METHOD_4_5BF02158D87A5956_OFFSET UNITYSDK_OFFSET(0x177BFAD0)
#define RPG_GAMECORE_TARGETFETCHPARAMENTITY_METHOD_4_B8ABCCA46D671E94_OFFSET UNITYSDK_OFFSET(0x177B7410)
#define RPG_GAMECORE_TARGETFETCHPARAMENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x177B73C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchParamEntity_TypeDefinitionIndex = 22191;
