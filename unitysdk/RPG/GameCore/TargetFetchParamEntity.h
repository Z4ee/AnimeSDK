...
#define RPG_GAMECORE_TARGETFETCHPARAMENTITY_METHOD_4_1263BD42B8D5ED69_OFFSET UNITYSDK_OFFSET(0x1D0BBAD0)
#define RPG_GAMECORE_TARGETFETCHPARAMENTITY_METHOD_4_7E97654CA20283B4_OFFSET UNITYSDK_OFFSET(0x1D0BBBD0)
#define RPG_GAMECORE_TARGETFETCHPARAMENTITY_METHOD_4_B8ABCCA46D671E94_OFFSET UNITYSDK_OFFSET(0x1D0BBB50)
#define RPG_GAMECORE_TARGETFETCHPARAMENTITY_METHOD_4_FE35D014955183E1_OFFSET UNITYSDK_OFFSET(0x1D0BBBB0)
#define RPG_GAMECORE_TARGETFETCHPARAMENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0BBB40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchParamEntity_TypeDefinitionIndex = 23059;
