...
#define RPG_GAMECORE_GRIDFIGHTACTIONCOSTALLCOINCONFIG_METHOD_6_9C07141658A0F113_OFFSET UNITYSDK_OFFSET(0x1D95FC80)
#define RPG_GAMECORE_GRIDFIGHTACTIONCOSTALLCOINCONFIG_METHOD_6_DF889E79224DA957_OFFSET UNITYSDK_OFFSET(0x1D95F9F0)
#define RPG_GAMECORE_GRIDFIGHTACTIONCOSTALLCOINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D95F9E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightActionCostAllCoinConfig_TypeDefinitionIndex = 19091;
