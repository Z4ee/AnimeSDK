...
#define RPG_GAMECORE_GRIDFIGHTACTIONCOSTALLCOINCONFIG_METHOD_6_98958E9606773E04_OFFSET UNITYSDK_OFFSET(0x17250990)
#define RPG_GAMECORE_GRIDFIGHTACTIONCOSTALLCOINCONFIG_METHOD_6_DF889E79224DA957_OFFSET UNITYSDK_OFFSET(0x1724FFA0)
#define RPG_GAMECORE_GRIDFIGHTACTIONCOSTALLCOINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1724FF00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightActionCostAllCoinConfig_TypeDefinitionIndex = 17742;
