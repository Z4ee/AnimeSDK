...
#define RPG_GAMECORE_FIVEDIMSIMPLEHITBOXCONFIG_METHOD_3_332D5771B9D4A964_OFFSET UNITYSDK_OFFSET(0x1D87AF60)
#define RPG_GAMECORE_FIVEDIMSIMPLEHITBOXCONFIG_METHOD_3_52EF2F3859C2510E_OFFSET UNITYSDK_OFFSET(0x1D87AF20)
#define RPG_GAMECORE_FIVEDIMSIMPLEHITBOXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D87AF50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSimpleHitBoxConfig_TypeDefinitionIndex = 18390;
