...
#define RPG_GAMECORE_FATECONDITIONCONFIGBASE_METHOD_5_054DB0B656719538_OFFSET UNITYSDK_OFFSET(0x171C4C90)
#define RPG_GAMECORE_FATECONDITIONCONFIGBASE_METHOD_5_9B3C6E721171A3D1_OFFSET UNITYSDK_OFFSET(0x171C53D0)
#define RPG_GAMECORE_FATECONDITIONCONFIGBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x171C4490)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateConditionConfigBase_TypeDefinitionIndex = 17672;
