...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERREMOVEAFFIXCONFIG_METHOD_3_32A04FFBB23A012E_OFFSET UNITYSDK_OFFSET(0x1D06A860)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERREMOVEAFFIXCONFIG_METHOD_3_4CA1A7F9A3CDD2EA_OFFSET UNITYSDK_OFFSET(0x1D06A8B0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERREMOVEAFFIXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D06A8A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierRemoveAffixConfig_TypeDefinitionIndex = 18728;
