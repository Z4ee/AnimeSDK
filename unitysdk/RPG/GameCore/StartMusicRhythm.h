...
#define RPG_GAMECORE_STARTMUSICRHYTHM_METHOD_3_4190EFB85C39C946_OFFSET UNITYSDK_OFFSET(0x17775760)
#define RPG_GAMECORE_STARTMUSICRHYTHM_METHOD_3_D5D3C4D00444B8BF_OFFSET UNITYSDK_OFFSET(0x177756E0)
#define RPG_GAMECORE_STARTMUSICRHYTHM__CTOR_OFFSET UNITYSDK_OFFSET(0x17775730)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StartMusicRhythm_TypeDefinitionIndex = 20236;
