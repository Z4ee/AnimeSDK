...
#define RPG_GAMECORE_STARTMUSICRHYTHM_METHOD_3_BD72BE5125A02360_OFFSET UNITYSDK_OFFSET(0x1B0BE2F0)
#define RPG_GAMECORE_STARTMUSICRHYTHM_METHOD_3_DF84716C55A863E9_OFFSET UNITYSDK_OFFSET(0x1B0BE2B0)
#define RPG_GAMECORE_STARTMUSICRHYTHM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0BE2E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StartMusicRhythm_TypeDefinitionIndex = 21246;
