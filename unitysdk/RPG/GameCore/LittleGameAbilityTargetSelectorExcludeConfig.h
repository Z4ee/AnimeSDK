...
#define RPG_GAMECORE_LITTLEGAMEABILITYTARGETSELECTOREXCLUDECONFIG_METHOD_3_5D5B0C415C8A3D84_OFFSET UNITYSDK_OFFSET(0x19895E20)
#define RPG_GAMECORE_LITTLEGAMEABILITYTARGETSELECTOREXCLUDECONFIG_METHOD_3_5ECA827ECCC7395E_OFFSET UNITYSDK_OFFSET(0x19895DC0)
#define RPG_GAMECORE_LITTLEGAMEABILITYTARGETSELECTOREXCLUDECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19895E10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityTargetSelectorExcludeConfig_TypeDefinitionIndex = 20198;
