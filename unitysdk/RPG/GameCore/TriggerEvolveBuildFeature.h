...
#define RPG_GAMECORE_TRIGGEREVOLVEBUILDFEATURE_METHOD_3_07252C0DD45CC917_OFFSET UNITYSDK_OFFSET(0x1B055FB0)
#define RPG_GAMECORE_TRIGGEREVOLVEBUILDFEATURE_METHOD_3_BF588B0F6A6CE522_OFFSET UNITYSDK_OFFSET(0x1B055F70)
#define RPG_GAMECORE_TRIGGEREVOLVEBUILDFEATURE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B055FA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerEvolveBuildFeature_TypeDefinitionIndex = 21707;
