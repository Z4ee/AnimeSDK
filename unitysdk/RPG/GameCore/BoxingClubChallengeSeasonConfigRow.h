...
#define RPG_GAMECORE_BOXINGCLUBCHALLENGESEASONCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x194EAA40)
#define RPG_GAMECORE_BOXINGCLUBCHALLENGESEASONCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x194EBA30)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::Il2CppArray<::System::UInt32>* ChallengeIDList; // 0x10
		::Il2CppArray<::System::UInt32>* ActivityQuestID; // 0x18
		::System::String* SeasonIconPath; // 0x20
