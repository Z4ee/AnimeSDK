...
#define RPG_GAMECORE_SO_TRIGGERCUSTOMSTRING_METHOD_4_9D8D60DA3F811BB1_OFFSET UNITYSDK_OFFSET(0x18DE0DB0)
#define RPG_GAMECORE_SO_TRIGGERCUSTOMSTRING_METHOD_4_E38832BF7540AFD8_OFFSET UNITYSDK_OFFSET(0x18DE0720)
#define RPG_GAMECORE_SO_TRIGGERCUSTOMSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x18DE06F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SO_TriggerCustomString_TypeDefinitionIndex = 18985;
