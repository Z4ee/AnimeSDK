...
#define RPG_GAMECORE_SO_TRIGGERCUSTOMSTRING_METHOD_4_3509CEDDB0A4407B_OFFSET UNITYSDK_OFFSET(0x1B7768B0)
#define RPG_GAMECORE_SO_TRIGGERCUSTOMSTRING_METHOD_4_E38832BF7540AFD8_OFFSET UNITYSDK_OFFSET(0x1B776330)
#define RPG_GAMECORE_SO_TRIGGERCUSTOMSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1B776320)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SO_TriggerCustomString_TypeDefinitionIndex = 19287;
