...
#define RPG_GAMECORE_SO_TRIGGERCUSTOMSTRING_METHOD_4_9D8D60DA3F811BB1_OFFSET UNITYSDK_OFFSET(0x19BFE1C0)
#define RPG_GAMECORE_SO_TRIGGERCUSTOMSTRING_METHOD_4_E38832BF7540AFD8_OFFSET UNITYSDK_OFFSET(0x19BFDB30)
#define RPG_GAMECORE_SO_TRIGGERCUSTOMSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x19BFDB00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SO_TriggerCustomString_TypeDefinitionIndex = 18937;
