...
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_WITHINRADIUS_METHOD_3_8398B2BD6C1253F6_OFFSET UNITYSDK_OFFSET(0x1E010370)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_WITHINRADIUS_METHOD_3_A1F542D149D2FC48_OFFSET UNITYSDK_OFFSET(0x1E010300)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_WITHINRADIUS__CTOR_OFFSET UNITYSDK_OFFSET(0x1E010360)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleTargetEvaluator_WithinRadius_TypeDefinitionIndex = 15591;
