...
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEHIMOKENOVAASSIST_METHOD_3_3E86CD747946789C_OFFSET UNITYSDK_OFFSET(0x1BC26F30)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEHIMOKENOVAASSIST_METHOD_3_6B687CD09FA1444B_OFFSET UNITYSDK_OFFSET(0x1BC26F70)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEHIMOKENOVAASSIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC26F60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAISourceHimokeNovaAssist_TypeDefinitionIndex = 14945;
