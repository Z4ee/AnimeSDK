...
#define RPG_GAMECORE_PRELOADITEMSCORERECORDCHILDTASK_METHOD_2_BFE1D6F30F26580A_OFFSET UNITYSDK_OFFSET(0x1BA15C30)
#define RPG_GAMECORE_PRELOADITEMSCORERECORDCHILDTASK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA15D80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PreloadItemScoreRecordChildTask_TypeDefinitionIndex = 15725;
