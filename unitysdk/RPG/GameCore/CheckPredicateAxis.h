...
#define RPG_GAMECORE_CHECKPREDICATEAXIS_METHOD_3_6914687B9E3F5717_OFFSET UNITYSDK_OFFSET(0x19618AC0)
#define RPG_GAMECORE_CHECKPREDICATEAXIS_METHOD_3_AC2552AB9FD42F3A_OFFSET UNITYSDK_OFFSET(0x19618B00)
#define RPG_GAMECORE_CHECKPREDICATEAXIS__CTOR_OFFSET UNITYSDK_OFFSET(0x19618AF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CheckPredicateAxis_TypeDefinitionIndex = 14745;
