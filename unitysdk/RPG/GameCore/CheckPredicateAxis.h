...
#define RPG_GAMECORE_CHECKPREDICATEAXIS_METHOD_3_6914687B9E3F5717_OFFSET UNITYSDK_OFFSET(0x17075F50)
#define RPG_GAMECORE_CHECKPREDICATEAXIS_METHOD_3_AC2552AB9FD42F3A_OFFSET UNITYSDK_OFFSET(0x17075F90)
#define RPG_GAMECORE_CHECKPREDICATEAXIS__CTOR_OFFSET UNITYSDK_OFFSET(0x17075F80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CheckPredicateAxis_TypeDefinitionIndex = 14210;
