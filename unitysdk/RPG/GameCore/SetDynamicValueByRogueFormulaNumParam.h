...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEFORMULANUMPARAM_METHOD_4_474B9A07830832C8_OFFSET UNITYSDK_OFFSET(0x18E26AF0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEFORMULANUMPARAM_METHOD_4_5708F293825F9888_OFFSET UNITYSDK_OFFSET(0x18E26B80)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEFORMULANUMPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x18E26B50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRogueFormulaNumParam_TypeDefinitionIndex = 20628;
