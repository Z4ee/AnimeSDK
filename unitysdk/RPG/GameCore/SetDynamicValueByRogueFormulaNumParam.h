...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEFORMULANUMPARAM_METHOD_4_474B9A07830832C8_OFFSET UNITYSDK_OFFSET(0x19C43810)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEFORMULANUMPARAM_METHOD_4_5708F293825F9888_OFFSET UNITYSDK_OFFSET(0x19C438A0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEFORMULANUMPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x19C43870)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRogueFormulaNumParam_TypeDefinitionIndex = 20561;
