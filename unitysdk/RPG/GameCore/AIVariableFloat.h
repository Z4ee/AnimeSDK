...
#define RPG_GAMECORE_AIVARIABLEFLOAT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x16E93E30)
#define RPG_GAMECORE_AIVARIABLEFLOAT_EQUALS_2_OFFSET UNITYSDK_OFFSET(0x16E93D80)
#define RPG_GAMECORE_AIVARIABLEFLOAT_EQUALS_OFFSET UNITYSDK_OFFSET(0x16E93CB0)
#define RPG_GAMECORE_AIVARIABLEFLOAT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x16E93F70)
#define RPG_GAMECORE_AIVARIABLEFLOAT_METHOD_3_2742D7137C9CCDB6_OFFSET UNITYSDK_OFFSET(0x16E92FA0)
#define RPG_GAMECORE_AIVARIABLEFLOAT_METHOD_3_36FA82E9CA56D7A1_OFFSET UNITYSDK_OFFSET(0x16E93C80)
#define RPG_GAMECORE_AIVARIABLEFLOAT_METHOD_3_F51FEF81E82409C8_1_OFFSET UNITYSDK_OFFSET(0x16E94080)
#define RPG_GAMECORE_AIVARIABLEFLOAT_METHOD_3_F51FEF81E82409C8_OFFSET UNITYSDK_OFFSET(0x16E94040)
#define RPG_GAMECORE_AIVARIABLEFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x16E92F90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AIVariableFloat_TypeDefinitionIndex = 14305;
