...
#define RPG_GAMECORE_AIVARIABLEFLOAT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1CD6A0D0)
#define RPG_GAMECORE_AIVARIABLEFLOAT_EQUALS_2_OFFSET UNITYSDK_OFFSET(0x1CD6A000)
#define RPG_GAMECORE_AIVARIABLEFLOAT_EQUALS_OFFSET UNITYSDK_OFFSET(0x1CD69F00)
#define RPG_GAMECORE_AIVARIABLEFLOAT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1CD6A290)
#define RPG_GAMECORE_AIVARIABLEFLOAT_METHOD_3_2742D7137C9CCDB6_OFFSET UNITYSDK_OFFSET(0x1CD68990)
#define RPG_GAMECORE_AIVARIABLEFLOAT_METHOD_3_36FA82E9CA56D7A1_OFFSET UNITYSDK_OFFSET(0x1CD69ED0)
#define RPG_GAMECORE_AIVARIABLEFLOAT_METHOD_3_40DBA39A57B32EBE_OFFSET UNITYSDK_OFFSET(0x1CD6A4B0)
#define RPG_GAMECORE_AIVARIABLEFLOAT_METHOD_3_FD8B53BCEC16B1FF_OFFSET UNITYSDK_OFFSET(0x1CD6A360)
#define RPG_GAMECORE_AIVARIABLEFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD68980)
