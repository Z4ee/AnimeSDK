...
#define RPG_GAMECORE_AIVARIABLEFLOAT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x185F4410)
#define RPG_GAMECORE_AIVARIABLEFLOAT_EQUALS_2_OFFSET UNITYSDK_OFFSET(0x185F4360)
#define RPG_GAMECORE_AIVARIABLEFLOAT_EQUALS_OFFSET UNITYSDK_OFFSET(0x185F4290)
#define RPG_GAMECORE_AIVARIABLEFLOAT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x185F4550)
#define RPG_GAMECORE_AIVARIABLEFLOAT_METHOD_3_2742D7137C9CCDB6_OFFSET UNITYSDK_OFFSET(0x185F3580)
#define RPG_GAMECORE_AIVARIABLEFLOAT_METHOD_3_36FA82E9CA56D7A1_OFFSET UNITYSDK_OFFSET(0x185F4260)
#define RPG_GAMECORE_AIVARIABLEFLOAT_METHOD_3_F51FEF81E82409C8_1_OFFSET UNITYSDK_OFFSET(0x185F4660)
#define RPG_GAMECORE_AIVARIABLEFLOAT_METHOD_3_F51FEF81E82409C8_OFFSET UNITYSDK_OFFSET(0x185F4620)
#define RPG_GAMECORE_AIVARIABLEFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x185F3570)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AIVariableFloat_TypeDefinitionIndex = 14775;
