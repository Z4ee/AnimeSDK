...
#define RPG_GAMECORE_GRIDFIGHTTRAITBONUSADDRULECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D3BE170)
#define RPG_GAMECORE_GRIDFIGHTTRAITBONUSADDRULECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3BE300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightTraitBonusAddRuleConfigRow_TypeDefinitionIndex = 13571;
