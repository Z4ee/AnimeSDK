...
#define RPG_GAMECORE_GRIDFIGHTTRAITBONUSADDRULECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17287D80)
#define RPG_GAMECORE_GRIDFIGHTTRAITBONUSADDRULECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17287F10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightTraitBonusAddRuleConfigRow_TypeDefinitionIndex = 12515;
