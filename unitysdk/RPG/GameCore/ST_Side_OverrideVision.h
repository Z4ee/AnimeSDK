...
#define RPG_GAMECORE_ST_SIDE_OVERRIDEVISION_METHOD_4_071E93ED4315636F_OFFSET UNITYSDK_OFFSET(0x1768E080)
#define RPG_GAMECORE_ST_SIDE_OVERRIDEVISION_METHOD_4_44F18418FE0E4C82_OFFSET UNITYSDK_OFFSET(0x17699850)
#define RPG_GAMECORE_ST_SIDE_OVERRIDEVISION__CTOR_OFFSET UNITYSDK_OFFSET(0x1768E030)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_OverrideVision_TypeDefinitionIndex = 18386;
