...
#define RPG_GAMECORE_ST_SIDE_OVERRIDEVISION_METHOD_4_071E93ED4315636F_OFFSET UNITYSDK_OFFSET(0x1D4D23F0)
#define RPG_GAMECORE_ST_SIDE_OVERRIDEVISION_METHOD_4_2E28EF1486BADE38_OFFSET UNITYSDK_OFFSET(0x1D4D23B0)
#define RPG_GAMECORE_ST_SIDE_OVERRIDEVISION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4D23E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_OverrideVision_TypeDefinitionIndex = 19872;
