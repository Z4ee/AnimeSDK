...
#define RPG_GAMECORE_FIVEDIMPROPBAKEDMOVECONFIG_METHOD_2_981B249362B99BF0_OFFSET UNITYSDK_OFFSET(0x1BEAB270)
#define RPG_GAMECORE_FIVEDIMPROPBAKEDMOVECONFIG_METHOD_2_CE8B26C14DE27B59_OFFSET UNITYSDK_OFFSET(0x1BEAA9F0)
#define RPG_GAMECORE_FIVEDIMPROPBAKEDMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEA1DA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimPropBakedMoveConfig_TypeDefinitionIndex = 16023;
