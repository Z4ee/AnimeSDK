...
#define RPG_GAMECORE_FIVEDIMPROPBAKEDMOVECONFIG_METHOD_2_981B249362B99BF0_OFFSET UNITYSDK_OFFSET(0x1D0FACC0)
#define RPG_GAMECORE_FIVEDIMPROPBAKEDMOVECONFIG_METHOD_2_CE8B26C14DE27B59_OFFSET UNITYSDK_OFFSET(0x1D0FA440)
#define RPG_GAMECORE_FIVEDIMPROPBAKEDMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0E1440)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimPropBakedMoveConfig_TypeDefinitionIndex = 16499;
