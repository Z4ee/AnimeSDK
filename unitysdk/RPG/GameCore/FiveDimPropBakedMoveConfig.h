...
#define RPG_GAMECORE_FIVEDIMPROPBAKEDMOVECONFIG_METHOD_2_981B249362B99BF0_OFFSET UNITYSDK_OFFSET(0x17204630)
#define RPG_GAMECORE_FIVEDIMPROPBAKEDMOVECONFIG_METHOD_2_CE8B26C14DE27B59_OFFSET UNITYSDK_OFFSET(0x17203E40)
#define RPG_GAMECORE_FIVEDIMPROPBAKEDMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171FB650)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimPropBakedMoveConfig_TypeDefinitionIndex = 15280;
