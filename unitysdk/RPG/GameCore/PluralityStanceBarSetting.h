...
#define RPG_GAMECORE_PLURALITYSTANCEBARSETTING_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D3576D0)
#define RPG_GAMECORE_PLURALITYSTANCEBARSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3578F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PluralityStanceBarSetting_TypeDefinitionIndex = 16955;
