...
#define RPG_GAMECORE_SETTIMEREWINDENTITYACTIVE_METHOD_3_1975C5DAE9BE3B75_OFFSET UNITYSDK_OFFSET(0x1D5134A0)
#define RPG_GAMECORE_SETTIMEREWINDENTITYACTIVE_METHOD_3_FC308DDFCB99CE42_OFFSET UNITYSDK_OFFSET(0x1D513460)
#define RPG_GAMECORE_SETTIMEREWINDENTITYACTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D513490)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetTimeRewindEntityActive_TypeDefinitionIndex = 20440;
