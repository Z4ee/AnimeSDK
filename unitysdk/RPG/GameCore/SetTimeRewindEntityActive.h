...
#define RPG_GAMECORE_SETTIMEREWINDENTITYACTIVE_METHOD_3_1975C5DAE9BE3B75_OFFSET UNITYSDK_OFFSET(0x19C64A20)
#define RPG_GAMECORE_SETTIMEREWINDENTITYACTIVE_METHOD_3_CBE79FEED89D21B9_OFFSET UNITYSDK_OFFSET(0x19C649A0)
#define RPG_GAMECORE_SETTIMEREWINDENTITYACTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C649F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetTimeRewindEntityActive_TypeDefinitionIndex = 19536;
