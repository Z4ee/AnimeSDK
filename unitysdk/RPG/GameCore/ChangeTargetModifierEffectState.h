...
#define RPG_GAMECORE_CHANGETARGETMODIFIEREFFECTSTATE_METHOD_3_5A978C4B9A5F455B_OFFSET UNITYSDK_OFFSET(0x187C9700)
#define RPG_GAMECORE_CHANGETARGETMODIFIEREFFECTSTATE_METHOD_3_E3477340100A4016_OFFSET UNITYSDK_OFFSET(0x187C9680)
#define RPG_GAMECORE_CHANGETARGETMODIFIEREFFECTSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x187C96D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChangeTargetModifierEffectState_TypeDefinitionIndex = 21334;
