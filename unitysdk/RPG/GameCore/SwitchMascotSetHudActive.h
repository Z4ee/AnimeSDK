...
#define RPG_GAMECORE_SWITCHMASCOTSETHUDACTIVE_METHOD_3_423A361F938C5ED7_OFFSET UNITYSDK_OFFSET(0x18EBD4F0)
#define RPG_GAMECORE_SWITCHMASCOTSETHUDACTIVE_METHOD_3_C39D28E45528C446_OFFSET UNITYSDK_OFFSET(0x18EBD570)
#define RPG_GAMECORE_SWITCHMASCOTSETHUDACTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x18EBD540)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchMascotSetHudActive_TypeDefinitionIndex = 20863;
