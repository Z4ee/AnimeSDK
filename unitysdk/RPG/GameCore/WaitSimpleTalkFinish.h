...
#define RPG_GAMECORE_WAITSIMPLETALKFINISH_METHOD_3_61135BAD6E3BB0D5_OFFSET UNITYSDK_OFFSET(0x19108C00)
#define RPG_GAMECORE_WAITSIMPLETALKFINISH_METHOD_3_D531DF1594445BC1_OFFSET UNITYSDK_OFFSET(0x19108AF0)
#define RPG_GAMECORE_WAITSIMPLETALKFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x19108BD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitSimpleTalkFinish_TypeDefinitionIndex = 19829;
