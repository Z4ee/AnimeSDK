...
#define RPG_GAMECORE_SETDYNAMICVALUEBYMAXBP_METHOD_3_89CE83E6F058368D_OFFSET UNITYSDK_OFFSET(0x176C2310)
#define RPG_GAMECORE_SETDYNAMICVALUEBYMAXBP_METHOD_3_9790E6C24050D718_OFFSET UNITYSDK_OFFSET(0x176C23A0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYMAXBP__CTOR_OFFSET UNITYSDK_OFFSET(0x176C2370)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByMaxBP_TypeDefinitionIndex = 21820;
