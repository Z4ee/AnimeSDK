...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYBATTLEGAINCOINCONFIG_METHOD_3_66C286E798AC97E4_OFFSET UNITYSDK_OFFSET(0x1D1635D0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYBATTLEGAINCOINCONFIG_METHOD_3_9FD492F0305382A8_OFFSET UNITYSDK_OFFSET(0x1D163580)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYBATTLEGAINCOINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1635C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyBattleGainCoinConfig_TypeDefinitionIndex = 17235;
