...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYBATTLEGAINCOINCONFIG_METHOD_3_66C286E798AC97E4_OFFSET UNITYSDK_OFFSET(0x19B54AA0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYBATTLEGAINCOINCONFIG_METHOD_3_BB10F73D82560BED_OFFSET UNITYSDK_OFFSET(0x19B5EAC0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYBATTLEGAINCOINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B54A50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyBattleGainCoinConfig_TypeDefinitionIndex = 17073;
