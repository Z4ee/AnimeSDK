...
#define RPG_GAMECORE_REQUESTCHANGEMATCHTHREEBIRDLOCATION_METHOD_3_437C9D7856208EFF_OFFSET UNITYSDK_OFFSET(0x1D3A2910)
#define RPG_GAMECORE_REQUESTCHANGEMATCHTHREEBIRDLOCATION_METHOD_3_4C87B1ED3D3B0272_OFFSET UNITYSDK_OFFSET(0x1D3A28D0)
#define RPG_GAMECORE_REQUESTCHANGEMATCHTHREEBIRDLOCATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3A2900)
