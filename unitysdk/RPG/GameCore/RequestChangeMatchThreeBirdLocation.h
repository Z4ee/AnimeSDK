...
#define RPG_GAMECORE_REQUESTCHANGEMATCHTHREEBIRDLOCATION_METHOD_3_437C9D7856208EFF_OFFSET UNITYSDK_OFFSET(0x18CA82B0)
#define RPG_GAMECORE_REQUESTCHANGEMATCHTHREEBIRDLOCATION_METHOD_3_6DF162F2D77C616E_OFFSET UNITYSDK_OFFSET(0x18CA8230)
#define RPG_GAMECORE_REQUESTCHANGEMATCHTHREEBIRDLOCATION__CTOR_OFFSET UNITYSDK_OFFSET(0x18CA8280)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RequestChangeMatchThreeBirdLocation_TypeDefinitionIndex = 19973;
