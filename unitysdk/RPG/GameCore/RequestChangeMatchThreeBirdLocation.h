...
#define RPG_GAMECORE_REQUESTCHANGEMATCHTHREEBIRDLOCATION_METHOD_3_437C9D7856208EFF_OFFSET UNITYSDK_OFFSET(0x1D019A40)
#define RPG_GAMECORE_REQUESTCHANGEMATCHTHREEBIRDLOCATION_METHOD_3_4C87B1ED3D3B0272_OFFSET UNITYSDK_OFFSET(0x1D019A00)
#define RPG_GAMECORE_REQUESTCHANGEMATCHTHREEBIRDLOCATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D019A30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RequestChangeMatchThreeBirdLocation_TypeDefinitionIndex = 20196;
