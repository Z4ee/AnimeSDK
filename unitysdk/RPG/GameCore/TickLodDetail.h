...
#define RPG_GAMECORE_TICKLODDETAIL_METHOD_3_67D0A2D2D82618C3_OFFSET UNITYSDK_OFFSET(0x19DE32F0)
#define RPG_GAMECORE_TICKLODDETAIL_METHOD_3_C8697E74CEC4167C_OFFSET UNITYSDK_OFFSET(0x19DE3380)
#define RPG_GAMECORE_TICKLODDETAIL__CCTOR_OFFSET UNITYSDK_OFFSET(0x19DE37B0)
#define RPG_GAMECORE_TICKLODDETAIL__CTOR_OFFSET UNITYSDK_OFFSET(0x19DE3360)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TickLodDetail_TypeDefinitionIndex = 18232;
	...
	public:
		...
		{
			return (::RPG::GameCore::TickLodDetail**)Il2CppClass::FromTypeDefinitionIndex(TickLodDetail_TypeDefinitionIndex)->GetStaticField(0x5FB0);
		}
