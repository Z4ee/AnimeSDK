...
#define RPG_GAMECORE_TICKLODDETAIL_METHOD_3_67D0A2D2D82618C3_OFFSET UNITYSDK_OFFSET(0x1789CC20)
#define RPG_GAMECORE_TICKLODDETAIL_METHOD_3_C8697E74CEC4167C_OFFSET UNITYSDK_OFFSET(0x1789CCB0)
#define RPG_GAMECORE_TICKLODDETAIL__CCTOR_OFFSET UNITYSDK_OFFSET(0x1789D0E0)
#define RPG_GAMECORE_TICKLODDETAIL__CTOR_OFFSET UNITYSDK_OFFSET(0x1789CC90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TickLodDetail_TypeDefinitionIndex = 17646;
	...
	public:
		...
		{
			return (::RPG::GameCore::TickLodDetail**)Il2CppClass::FromTypeDefinitionIndex(TickLodDetail_TypeDefinitionIndex)->GetStaticField(0x1A5E0);
		}
