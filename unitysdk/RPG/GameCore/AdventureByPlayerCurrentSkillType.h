...
#define RPG_GAMECORE_ADVENTUREBYPLAYERCURRENTSKILLTYPE_METHOD_4_98CDFE7105C45880_OFFSET UNITYSDK_OFFSET(0x18671440)
#define RPG_GAMECORE_ADVENTUREBYPLAYERCURRENTSKILLTYPE_METHOD_4_EA0B0880329D30AE_OFFSET UNITYSDK_OFFSET(0x18671510)
#define RPG_GAMECORE_ADVENTUREBYPLAYERCURRENTSKILLTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x186714C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureByPlayerCurrentSkillType_TypeDefinitionIndex = 20612;
