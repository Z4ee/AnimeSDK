...
#define RPG_GAMECORE_ADVENTUREBYPLAYERCURRENTSKILLTYPE_METHOD_4_03E28CA5EAEF6D1D_OFFSET UNITYSDK_OFFSET(0x1AE56C50)
#define RPG_GAMECORE_ADVENTUREBYPLAYERCURRENTSKILLTYPE_METHOD_4_3B90D46A0B72463F_OFFSET UNITYSDK_OFFSET(0x1AE56A60)
#define RPG_GAMECORE_ADVENTUREBYPLAYERCURRENTSKILLTYPE_METHOD_4_AF6936ED72A3443A_OFFSET UNITYSDK_OFFSET(0x1AE56C20)
#define RPG_GAMECORE_ADVENTUREBYPLAYERCURRENTSKILLTYPE_METHOD_4_EA0B0880329D30AE_OFFSET UNITYSDK_OFFSET(0x1AE56AA0)
#define RPG_GAMECORE_ADVENTUREBYPLAYERCURRENTSKILLTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE56A90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureByPlayerCurrentSkillType_TypeDefinitionIndex = 20960;
