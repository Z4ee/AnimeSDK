...
#define RPG_GAMECORE_FIVEDIMEVILSMILESTATEEVENTCONFIG_METHOD_2_9A92DC066F89ECF7_OFFSET UNITYSDK_OFFSET(0x1D0E4F60)
#define RPG_GAMECORE_FIVEDIMEVILSMILESTATEEVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0E5090)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimEvilSmileStateEventConfig_TypeDefinitionIndex = 16523;
