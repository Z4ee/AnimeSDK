...
#define RPG_GAMECORE_FIVEDIMEVILSMILESTATEEVENTCONFIG_METHOD_2_7C045AE181E256B0_OFFSET UNITYSDK_OFFSET(0x1BA95430)
#define RPG_GAMECORE_FIVEDIMEVILSMILESTATEEVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA95540)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimEvilSmileStateEventConfig_TypeDefinitionIndex = 16047;
