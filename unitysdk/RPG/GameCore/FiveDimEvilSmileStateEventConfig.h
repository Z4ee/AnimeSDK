...
#define RPG_GAMECORE_FIVEDIMEVILSMILESTATEEVENTCONFIG_METHOD_2_9A92DC066F89ECF7_OFFSET UNITYSDK_OFFSET(0x1D85D9F0)
#define RPG_GAMECORE_FIVEDIMEVILSMILESTATEEVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D85DB20)
