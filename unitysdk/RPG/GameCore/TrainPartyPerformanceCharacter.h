...
#define RPG_GAMECORE_TRAINPARTYPERFORMANCECHARACTER_METHOD_2_47FBB1E0DAD85FB8_OFFSET UNITYSDK_OFFSET(0x1D538230)
#define RPG_GAMECORE_TRAINPARTYPERFORMANCECHARACTER_METHOD_2_E797777778018645_OFFSET UNITYSDK_OFFSET(0x1D538070)
#define RPG_GAMECORE_TRAINPARTYPERFORMANCECHARACTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D538220)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyPerformanceCharacter_TypeDefinitionIndex = 16084;
