...
#define RPG_GAMECORE_TRAINPARTYPERFORMANCECHARACTER_METHOD_2_47FBB1E0DAD85FB8_OFFSET UNITYSDK_OFFSET(0x1C162EA0)
#define RPG_GAMECORE_TRAINPARTYPERFORMANCECHARACTER_METHOD_2_E797777778018645_OFFSET UNITYSDK_OFFSET(0x1C162CE0)
#define RPG_GAMECORE_TRAINPARTYPERFORMANCECHARACTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C162E90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyPerformanceCharacter_TypeDefinitionIndex = 15615;
