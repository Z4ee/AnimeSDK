...
#define RPG_GAMECORE_MODIFYDAMAGEDISPLAYDATA_METHOD_3_01F104D8A4E53611_OFFSET UNITYSDK_OFFSET(0x18B3CE20)
#define RPG_GAMECORE_MODIFYDAMAGEDISPLAYDATA_METHOD_3_6BF42959DAD931F6_OFFSET UNITYSDK_OFFSET(0x18B3CD80)
#define RPG_GAMECORE_MODIFYDAMAGEDISPLAYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18B3CDE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyDamageDisplayData_TypeDefinitionIndex = 22012;
