...
#define RPG_GAMECORE_MODIFYDAMAGEDISPLAYDATA_METHOD_3_01F104D8A4E53611_OFFSET UNITYSDK_OFFSET(0x1D2B4350)
#define RPG_GAMECORE_MODIFYDAMAGEDISPLAYDATA_METHOD_3_5BFCFE10C01DBEC8_OFFSET UNITYSDK_OFFSET(0x1D2B42F0)
#define RPG_GAMECORE_MODIFYDAMAGEDISPLAYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2B4330)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyDamageDisplayData_TypeDefinitionIndex = 22820;
