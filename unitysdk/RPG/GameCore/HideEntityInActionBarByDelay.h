...
#define RPG_GAMECORE_HIDEENTITYINACTIONBARBYDELAY_METHOD_3_89CF2336C66B7ECE_OFFSET UNITYSDK_OFFSET(0x1B683600)
#define RPG_GAMECORE_HIDEENTITYINACTIONBARBYDELAY_METHOD_3_DC9725C11B7BF93F_OFFSET UNITYSDK_OFFSET(0x1B683640)
#define RPG_GAMECORE_HIDEENTITYINACTIONBARBYDELAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B683630)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HideEntityInActionBarByDelay_TypeDefinitionIndex = 22123;
