...
#define RPG_GAMECORE_PARALLELCONFIG_METHOD_4_66389981FB5DCE1B_OFFSET UNITYSDK_OFFSET(0x18BD2430)
#define RPG_GAMECORE_PARALLELCONFIG_METHOD_4_F6859C3893A4E872_OFFSET UNITYSDK_OFFSET(0x18BD24B0)
#define RPG_GAMECORE_PARALLELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18BD2480)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ParallelConfig_TypeDefinitionIndex = 22770;
