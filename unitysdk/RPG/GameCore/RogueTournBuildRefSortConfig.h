...
#define RPG_GAMECORE_ROGUETOURNBUILDREFSORTCONFIG_METHOD_2_36BF0A513C5A1059_OFFSET UNITYSDK_OFFSET(0x1D4173D0)
#define RPG_GAMECORE_ROGUETOURNBUILDREFSORTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4175D0)
