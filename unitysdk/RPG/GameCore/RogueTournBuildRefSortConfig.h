...
#define RPG_GAMECORE_ROGUETOURNBUILDREFSORTCONFIG_METHOD_2_36BF0A513C5A1059_OFFSET UNITYSDK_OFFSET(0x1BB70FE0)
#define RPG_GAMECORE_ROGUETOURNBUILDREFSORTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB711E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournBuildRefSortConfig_TypeDefinitionIndex = 16966;
