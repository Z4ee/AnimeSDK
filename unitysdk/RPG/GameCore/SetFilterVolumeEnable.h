...
#define RPG_GAMECORE_SETFILTERVOLUMEENABLE_METHOD_3_2E5DB2CAF24C3A43_OFFSET UNITYSDK_OFFSET(0x19C4D6D0)
#define RPG_GAMECORE_SETFILTERVOLUMEENABLE_METHOD_3_F7AE4A335EC7C5CA_OFFSET UNITYSDK_OFFSET(0x19C4D650)
#define RPG_GAMECORE_SETFILTERVOLUMEENABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C4D6A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetFilterVolumeEnable_TypeDefinitionIndex = 21029;
