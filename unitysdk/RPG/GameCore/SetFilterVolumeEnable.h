...
#define RPG_GAMECORE_SETFILTERVOLUMEENABLE_METHOD_3_2E5DB2CAF24C3A43_OFFSET UNITYSDK_OFFSET(0x18E308D0)
#define RPG_GAMECORE_SETFILTERVOLUMEENABLE_METHOD_3_F7AE4A335EC7C5CA_OFFSET UNITYSDK_OFFSET(0x18E30850)
#define RPG_GAMECORE_SETFILTERVOLUMEENABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E308A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetFilterVolumeEnable_TypeDefinitionIndex = 21129;
