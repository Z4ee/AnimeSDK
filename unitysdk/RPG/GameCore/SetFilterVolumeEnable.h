...
#define RPG_GAMECORE_SETFILTERVOLUMEENABLE_METHOD_3_2E5DB2CAF24C3A43_OFFSET UNITYSDK_OFFSET(0x1C5F8CD0)
#define RPG_GAMECORE_SETFILTERVOLUMEENABLE_METHOD_3_4C249B2E36FDD7D8_OFFSET UNITYSDK_OFFSET(0x1C5F8C90)
#define RPG_GAMECORE_SETFILTERVOLUMEENABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5F8CC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetFilterVolumeEnable_TypeDefinitionIndex = 21444;
