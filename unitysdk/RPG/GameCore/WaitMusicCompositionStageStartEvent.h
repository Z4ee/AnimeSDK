...
#define RPG_GAMECORE_WAITMUSICCOMPOSITIONSTAGESTARTEVENT_METHOD_3_069FA155AF1EE24A_OFFSET UNITYSDK_OFFSET(0x178FE590)
#define RPG_GAMECORE_WAITMUSICCOMPOSITIONSTAGESTARTEVENT_METHOD_3_DE230F168A4DC693_OFFSET UNITYSDK_OFFSET(0x178FE510)
#define RPG_GAMECORE_WAITMUSICCOMPOSITIONSTAGESTARTEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x178FE560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitMusicCompositionStageStartEvent_TypeDefinitionIndex = 20241;
