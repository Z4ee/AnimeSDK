...
#define RPG_GAMECORE_DESTROYPROPTRIGGER_METHOD_3_AF52E6EEB6CAF9B6_OFFSET UNITYSDK_OFFSET(0x1885BE50)
#define RPG_GAMECORE_DESTROYPROPTRIGGER_METHOD_3_B021FF24319142E4_OFFSET UNITYSDK_OFFSET(0x1885BD00)
#define RPG_GAMECORE_DESTROYPROPTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1885BDC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DestroyPropTrigger_TypeDefinitionIndex = 20423;
