...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONBATTLECOUNTCONFIG_METHOD_3_33BEC7301AA7004E_OFFSET UNITYSDK_OFFSET(0x1762F7A0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONBATTLECOUNTCONFIG_METHOD_3_C225DB6AC2A032C7_OFFSET UNITYSDK_OFFSET(0x1762F870)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONBATTLECOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1762F820)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnBattleCountConfig_TypeDefinitionIndex = 16527;
