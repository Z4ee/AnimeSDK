...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONBATTLECOUNTCONFIG_METHOD_3_85F0157B96073F43_OFFSET UNITYSDK_OFFSET(0x1CFBFF00)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONBATTLECOUNTCONFIG_METHOD_3_C225DB6AC2A032C7_OFFSET UNITYSDK_OFFSET(0x1CFBFF50)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONBATTLECOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFBFF40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnBattleCountConfig_TypeDefinitionIndex = 17256;
