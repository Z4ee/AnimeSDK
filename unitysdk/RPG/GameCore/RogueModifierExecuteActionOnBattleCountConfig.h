...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONBATTLECOUNTCONFIG_METHOD_3_33BEC7301AA7004E_OFFSET UNITYSDK_OFFSET(0x19B5C7A0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONBATTLECOUNTCONFIG_METHOD_3_C225DB6AC2A032C7_OFFSET UNITYSDK_OFFSET(0x19B50E40)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONBATTLECOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B50DF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnBattleCountConfig_TypeDefinitionIndex = 17094;
