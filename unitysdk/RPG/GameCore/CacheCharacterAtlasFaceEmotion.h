...
#define RPG_GAMECORE_CACHECHARACTERATLASFACEEMOTION_METHOD_3_357A7AFD47614978_OFFSET UNITYSDK_OFFSET(0x1B2C8840)
#define RPG_GAMECORE_CACHECHARACTERATLASFACEEMOTION_METHOD_3_ADD78B43A222621B_OFFSET UNITYSDK_OFFSET(0x1B2C8800)
#define RPG_GAMECORE_CACHECHARACTERATLASFACEEMOTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2C8830)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CacheCharacterAtlasFaceEmotion_TypeDefinitionIndex = 19842;
