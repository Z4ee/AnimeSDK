...
#define RPG_GAMECORE_BATTLEROGUEMAGICDATA_SCEPTER_DEEPCLONE_OFFSET UNITYSDK_OFFSET(0xA88D430)
#define RPG_GAMECORE_BATTLEROGUEMAGICDATA_SCEPTER__CTOR_OFFSET UNITYSDK_OFFSET(0xA88D850)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleRogueMagicData_Scepter_TypeDefinitionIndex = 45148;
