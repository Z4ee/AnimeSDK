...
#define RPG_GAMECORE_BATTLEROGUEMAGICDATA_SCEPTER_DEEPCLONE_OFFSET UNITYSDK_OFFSET(0xE538A80)
#define RPG_GAMECORE_BATTLEROGUEMAGICDATA_SCEPTER__CTOR_OFFSET UNITYSDK_OFFSET(0xE538EC0)
