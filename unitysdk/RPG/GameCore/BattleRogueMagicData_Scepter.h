...
#define RPG_GAMECORE_BATTLEROGUEMAGICDATA_SCEPTER_DEEPCLONE_OFFSET UNITYSDK_OFFSET(0xB5D2720)
#define RPG_GAMECORE_BATTLEROGUEMAGICDATA_SCEPTER__CTOR_OFFSET UNITYSDK_OFFSET(0xB5D2B40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleRogueMagicData_Scepter_TypeDefinitionIndex = 51905;
