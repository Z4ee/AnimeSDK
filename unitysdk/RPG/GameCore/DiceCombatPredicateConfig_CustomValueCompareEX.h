...
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_CUSTOMVALUECOMPAREEX_METHOD_4_04D4D83A2377F3BF_OFFSET UNITYSDK_OFFSET(0x1C112FA0)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_CUSTOMVALUECOMPAREEX_METHOD_4_C24DC972EB6FC809_OFFSET UNITYSDK_OFFSET(0x1C116250)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_CUSTOMVALUECOMPAREEX__CTOR_OFFSET UNITYSDK_OFFSET(0x1C112F90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatPredicateConfig_CustomValueCompareEX_TypeDefinitionIndex = 15472;
