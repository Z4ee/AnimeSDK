...
#define RPG_GAMECORE_CONSIDERATIONAXISCONFIG_METHOD_2_6742F877DA5782D6_OFFSET UNITYSDK_OFFSET(0x1BC2D9D0)
#define RPG_GAMECORE_CONSIDERATIONAXISCONFIG_METHOD_2_D2527DCD7B60DF3B_OFFSET UNITYSDK_OFFSET(0x1BC2D370)
#define RPG_GAMECORE_CONSIDERATIONAXISCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC23BC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConsiderationAxisConfig_TypeDefinitionIndex = 14894;
