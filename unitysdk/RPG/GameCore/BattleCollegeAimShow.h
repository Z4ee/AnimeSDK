...
#define RPG_GAMECORE_BATTLECOLLEGEAIMSHOW_METHOD_3_49453E63681160D7_OFFSET UNITYSDK_OFFSET(0x194C46B0)
#define RPG_GAMECORE_BATTLECOLLEGEAIMSHOW_METHOD_3_93ED30DC028A6786_OFFSET UNITYSDK_OFFSET(0x194C4730)
#define RPG_GAMECORE_BATTLECOLLEGEAIMSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x194C4700)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleCollegeAimShow_TypeDefinitionIndex = 22409;
