...
#define RPG_GAMECORE_BYTARGETISSTANCEWEAK_METHOD_4_64D2AD02130A675E_OFFSET UNITYSDK_OFFSET(0x18760F90)
#define RPG_GAMECORE_BYTARGETISSTANCEWEAK_METHOD_4_7F73FCD9B91B0D1E_OFFSET UNITYSDK_OFFSET(0x18761060)
#define RPG_GAMECORE_BYTARGETISSTANCEWEAK__CTOR_OFFSET UNITYSDK_OFFSET(0x18761010)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByTargetIsStanceWeak_TypeDefinitionIndex = 22482;
