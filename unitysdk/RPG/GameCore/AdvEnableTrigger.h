...
#define RPG_GAMECORE_ADVENABLETRIGGER_METHOD_3_7895DA176D765DBF_OFFSET UNITYSDK_OFFSET(0x16F2C610)
#define RPG_GAMECORE_ADVENABLETRIGGER_METHOD_3_8960230821DCA829_OFFSET UNITYSDK_OFFSET(0x16F2C690)
#define RPG_GAMECORE_ADVENABLETRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x16F2C660)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvEnableTrigger_TypeDefinitionIndex = 18843;
