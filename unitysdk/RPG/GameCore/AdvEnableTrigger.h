...
#define RPG_GAMECORE_ADVENABLETRIGGER_METHOD_3_591B37442BCF2920_OFFSET UNITYSDK_OFFSET(0x1D6B5CC0)
#define RPG_GAMECORE_ADVENABLETRIGGER_METHOD_3_8960230821DCA829_OFFSET UNITYSDK_OFFSET(0x1D6B5D00)
#define RPG_GAMECORE_ADVENABLETRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6B5CF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvEnableTrigger_TypeDefinitionIndex = 20300;
