...
#define RPG_GAMECORE_BINDPROPSCABLELINES_METHOD_3_06E45BCC8C5BBD73_OFFSET UNITYSDK_OFFSET(0x16FE6490)
#define RPG_GAMECORE_BINDPROPSCABLELINES_METHOD_3_3CF002D54AEC4335_OFFSET UNITYSDK_OFFSET(0x16FE65B0)
#define RPG_GAMECORE_BINDPROPSCABLELINES__CTOR_OFFSET UNITYSDK_OFFSET(0x16FE6530)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BindPropsCablelines_TypeDefinitionIndex = 19567;
