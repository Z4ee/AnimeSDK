...
#define RPG_GAMECORE_GMACCOUNTITEMCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B984FB0)
#define RPG_GAMECORE_GMACCOUNTITEMCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B985160)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GMAccountItemConfigRow_TypeDefinitionIndex = 12847;
