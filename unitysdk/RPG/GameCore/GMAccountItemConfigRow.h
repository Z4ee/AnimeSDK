...
#define RPG_GAMECORE_GMACCOUNTITEMCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x172253D0)
#define RPG_GAMECORE_GMACCOUNTITEMCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17225580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GMAccountItemConfigRow_TypeDefinitionIndex = 12187;
