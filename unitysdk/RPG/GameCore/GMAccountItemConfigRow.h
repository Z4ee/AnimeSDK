...
#define RPG_GAMECORE_GMACCOUNTITEMCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x197AC530)
#define RPG_GAMECORE_GMACCOUNTITEMCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x197AC6E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GMAccountItemConfigRow_TypeDefinitionIndex = 12710;
