...
#define RPG_GAMECORE_FETCHADVNPCDATAEX_METHOD_2_7FD8FE0FFF2202AA_OFFSET UNITYSDK_OFFSET(0x1BA78880)
#define RPG_GAMECORE_FETCHADVNPCDATAEX_METHOD_2_FF05F57C78A41894_OFFSET UNITYSDK_OFFSET(0x1BA78640)
#define RPG_GAMECORE_FETCHADVNPCDATAEX__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA78810)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FetchAdvNPCDataEx_TypeDefinitionIndex = 23022;
