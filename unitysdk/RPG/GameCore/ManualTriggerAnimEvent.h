...
#define RPG_GAMECORE_MANUALTRIGGERANIMEVENT_METHOD_3_3E8888F579D1FF43_OFFSET UNITYSDK_OFFSET(0x1D2202B0)
#define RPG_GAMECORE_MANUALTRIGGERANIMEVENT_METHOD_3_7DE3FCF333B06897_OFFSET UNITYSDK_OFFSET(0x1D220420)
#define RPG_GAMECORE_MANUALTRIGGERANIMEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2202F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ManualTriggerAnimEvent_TypeDefinitionIndex = 22622;
