...
#define RPG_GAMECORE_ADVLOGISTICSROBOTDOOROPEN_METHOD_3_12C6D2083989409E_OFFSET UNITYSDK_OFFSET(0x18654D90)
#define RPG_GAMECORE_ADVLOGISTICSROBOTDOOROPEN_METHOD_3_DAD21E4DD774FC6F_OFFSET UNITYSDK_OFFSET(0x18654D10)
#define RPG_GAMECORE_ADVLOGISTICSROBOTDOOROPEN__CTOR_OFFSET UNITYSDK_OFFSET(0x18654D60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvLogisticsRobotDoorOpen_TypeDefinitionIndex = 20174;
