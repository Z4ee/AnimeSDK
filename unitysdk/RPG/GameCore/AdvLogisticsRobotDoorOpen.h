...
#define RPG_GAMECORE_ADVLOGISTICSROBOTDOOROPEN_METHOD_3_12C6D2083989409E_OFFSET UNITYSDK_OFFSET(0x1BE20660)
#define RPG_GAMECORE_ADVLOGISTICSROBOTDOOROPEN_METHOD_3_38F55E9EE326D95D_OFFSET UNITYSDK_OFFSET(0x1BE20620)
#define RPG_GAMECORE_ADVLOGISTICSROBOTDOOROPEN__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE20650)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvLogisticsRobotDoorOpen_TypeDefinitionIndex = 20403;
