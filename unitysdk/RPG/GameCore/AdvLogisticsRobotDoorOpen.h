...
#define RPG_GAMECORE_ADVLOGISTICSROBOTDOOROPEN_METHOD_3_12C6D2083989409E_OFFSET UNITYSDK_OFFSET(0x16F32BC0)
#define RPG_GAMECORE_ADVLOGISTICSROBOTDOOROPEN_METHOD_3_DAD21E4DD774FC6F_OFFSET UNITYSDK_OFFSET(0x16F32B40)
#define RPG_GAMECORE_ADVLOGISTICSROBOTDOOROPEN__CTOR_OFFSET UNITYSDK_OFFSET(0x16F32B90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvLogisticsRobotDoorOpen_TypeDefinitionIndex = 19499;
