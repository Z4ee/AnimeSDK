...
#define RPG_GAMECORE_WAITFRAMEFORBATTLESERVER_METHOD_3_BCF9AB2A0F1C68B4_OFFSET UNITYSDK_OFFSET(0x19E57550)
#define RPG_GAMECORE_WAITFRAMEFORBATTLESERVER_METHOD_3_FC955290DEDC8135_OFFSET UNITYSDK_OFFSET(0x19E574C0)
#define RPG_GAMECORE_WAITFRAMEFORBATTLESERVER__CTOR_OFFSET UNITYSDK_OFFSET(0x19E57520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitFrameForBattleServer_TypeDefinitionIndex = 22484;
