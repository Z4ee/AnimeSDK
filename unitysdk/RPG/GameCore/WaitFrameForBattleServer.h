...
#define RPG_GAMECORE_WAITFRAMEFORBATTLESERVER_METHOD_3_BCF9AB2A0F1C68B4_OFFSET UNITYSDK_OFFSET(0x1D6A4310)
#define RPG_GAMECORE_WAITFRAMEFORBATTLESERVER_METHOD_3_F0602D528E7B9CE7_OFFSET UNITYSDK_OFFSET(0x1D6A42C0)
#define RPG_GAMECORE_WAITFRAMEFORBATTLESERVER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6A4300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitFrameForBattleServer_TypeDefinitionIndex = 23514;
