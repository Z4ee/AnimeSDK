...
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_WAITTIME_METHOD_3_70267D2FCB45807E_OFFSET UNITYSDK_OFFSET(0x187E0650)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_WAITTIME_METHOD_3_796CD5483FCF856A_OFFSET UNITYSDK_OFFSET(0x187E0720)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_WAITTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x187E0710)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleAbility_WaitTime_TypeDefinitionIndex = 14902;
