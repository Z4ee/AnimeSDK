...
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_WAITTIME_METHOD_3_70267D2FCB45807E_OFFSET UNITYSDK_OFFSET(0x1C378970)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_WAITTIME_METHOD_3_796CD5483FCF856A_OFFSET UNITYSDK_OFFSET(0x1C378A40)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_WAITTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x1C378A30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleAbility_WaitTime_TypeDefinitionIndex = 15129;
