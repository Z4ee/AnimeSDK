...
#define RPG_GAMECORE_CHARACTERENABLEEMPTYMODEL_METHOD_3_851B5FFC9C08DE6F_OFFSET UNITYSDK_OFFSET(0x187D0820)
#define RPG_GAMECORE_CHARACTERENABLEEMPTYMODEL_METHOD_3_EB641690619602D0_OFFSET UNITYSDK_OFFSET(0x187D08F0)
#define RPG_GAMECORE_CHARACTERENABLEEMPTYMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x187D08A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterEnableEmptyModel_TypeDefinitionIndex = 22155;
