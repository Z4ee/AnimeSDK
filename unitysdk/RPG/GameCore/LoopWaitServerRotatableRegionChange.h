...
#define RPG_GAMECORE_LOOPWAITSERVERROTATABLEREGIONCHANGE_METHOD_3_0190D6A78DCA526F_OFFSET UNITYSDK_OFFSET(0x1BCD4ED0)
#define RPG_GAMECORE_LOOPWAITSERVERROTATABLEREGIONCHANGE_METHOD_3_BC931DEF64A1FF6B_OFFSET UNITYSDK_OFFSET(0x1BCD4E80)
#define RPG_GAMECORE_LOOPWAITSERVERROTATABLEREGIONCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCD4EC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoopWaitServerRotatableRegionChange_TypeDefinitionIndex = 20455;
