...
#define RPG_GAMECORE_ROGUEMAGICSCEPTERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19B46440)
#define RPG_GAMECORE_ROGUEMAGICSCEPTERROW_GETMAZEBUFF_OFFSET UNITYSDK_OFFSET(0x19B46860)
#define RPG_GAMECORE_ROGUEMAGICSCEPTERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19B46850)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::Class_1_A88C3AAF0DD46F4C_13*>* LockMagicUnit; // 0x18
		...
		::System::UInt32 StaffMazeBuffID; // 0x38
		::RPG::GameCore::RogueMagicRangeType LimitRangeType; // 0x3C
