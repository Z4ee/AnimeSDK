...
#define RPG_GAMECORE_ROGUEMAGICSCEPTERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17614E30)
#define RPG_GAMECORE_ROGUEMAGICSCEPTERROW_GETMAZEBUFF_OFFSET UNITYSDK_OFFSET(0x176152F0)
#define RPG_GAMECORE_ROGUEMAGICSCEPTERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x176152E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueMagicScepterRow_TypeDefinitionIndex = 13611;

	class RogueMagicScepterRow : public ::System::Object
	{
	public:
		::Il2CppArray<::Class_1_A88C3AAF0DD46F4C_12*>* LockMagicUnit; // 0x10
