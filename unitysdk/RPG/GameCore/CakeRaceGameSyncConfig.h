...
#define RPG_GAMECORE_CAKERACEGAMESYNCCONFIG_METHOD_2_C0256E18DCD037AA_OFFSET UNITYSDK_OFFSET(0x1704C210)
#define RPG_GAMECORE_CAKERACEGAMESYNCCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1704C950)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceGameSyncConfig_TypeDefinitionIndex = 16897;
