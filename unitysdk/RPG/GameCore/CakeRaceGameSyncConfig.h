...
#define RPG_GAMECORE_CAKERACEGAMESYNCCONFIG_METHOD_2_C0256E18DCD037AA_OFFSET UNITYSDK_OFFSET(0x195EDC30)
#define RPG_GAMECORE_CAKERACEGAMESYNCCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x195EE7C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceGameSyncConfig_TypeDefinitionIndex = 17492;
