...
#define RPG_GAMECORE_CAKERACEGAMESYNCCONFIG_METHOD_2_C0256E18DCD037AA_OFFSET UNITYSDK_OFFSET(0x18771ED0)
#define RPG_GAMECORE_CAKERACEGAMESYNCCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18772610)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceGameSyncConfig_TypeDefinitionIndex = 17491;
