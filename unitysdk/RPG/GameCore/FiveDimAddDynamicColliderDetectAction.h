...
#define RPG_GAMECORE_FIVEDIMADDDYNAMICCOLLIDERDETECTACTION_METHOD_3_0B36A2F53958A998_OFFSET UNITYSDK_OFFSET(0x171DC8C0)
#define RPG_GAMECORE_FIVEDIMADDDYNAMICCOLLIDERDETECTACTION_METHOD_3_C4F06A2C68F8240C_OFFSET UNITYSDK_OFFSET(0x171DC790)
#define RPG_GAMECORE_FIVEDIMADDDYNAMICCOLLIDERDETECTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x171DC8A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimAddDynamicColliderDetectAction_TypeDefinitionIndex = 17224;
