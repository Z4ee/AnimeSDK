...
#define RPG_GAMECORE_FIVEDIMADDDYNAMICCOLLIDERDETECTACTION_METHOD_3_0B36A2F53958A998_OFFSET UNITYSDK_OFFSET(0x19726860)
#define RPG_GAMECORE_FIVEDIMADDDYNAMICCOLLIDERDETECTACTION_METHOD_3_C4F06A2C68F8240C_OFFSET UNITYSDK_OFFSET(0x19726730)
#define RPG_GAMECORE_FIVEDIMADDDYNAMICCOLLIDERDETECTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19726840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimAddDynamicColliderDetectAction_TypeDefinitionIndex = 17853;
