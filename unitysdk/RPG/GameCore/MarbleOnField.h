...
#define RPG_GAMECORE_MARBLEONFIELD_METHOD_3_103F44BF468FE4F9_OFFSET UNITYSDK_OFFSET(0x17393780)
#define RPG_GAMECORE_MARBLEONFIELD_METHOD_3_87B6914A5B4C89E2_OFFSET UNITYSDK_OFFSET(0x17393860)
#define RPG_GAMECORE_MARBLEONFIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x17393810)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleOnField_TypeDefinitionIndex = 15426;
