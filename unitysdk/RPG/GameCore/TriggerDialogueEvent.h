...
#define RPG_GAMECORE_TRIGGERDIALOGUEEVENT_METHOD_3_423129201CC278BD_OFFSET UNITYSDK_OFFSET(0x1B0485A0)
#define RPG_GAMECORE_TRIGGERDIALOGUEEVENT_METHOD_3_E7EAAB6675C356A6_OFFSET UNITYSDK_OFFSET(0x1B0485E0)
#define RPG_GAMECORE_TRIGGERDIALOGUEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0485D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerDialogueEvent_TypeDefinitionIndex = 20066;
