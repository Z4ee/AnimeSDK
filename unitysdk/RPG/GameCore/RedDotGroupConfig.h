...
#define RPG_GAMECORE_REDDOTGROUPCONFIG_METHOD_2_D8C7268EDE905A9A_OFFSET UNITYSDK_OFFSET(0x175880A0)
#define RPG_GAMECORE_REDDOTGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17588260)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RedDotGroupConfig_TypeDefinitionIndex = 22465;
