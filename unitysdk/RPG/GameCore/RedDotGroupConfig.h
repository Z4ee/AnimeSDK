...
#define RPG_GAMECORE_REDDOTGROUPCONFIG_METHOD_2_D8C7268EDE905A9A_OFFSET UNITYSDK_OFFSET(0x1B9BFBD0)
#define RPG_GAMECORE_REDDOTGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9BFD90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RedDotGroupConfig_TypeDefinitionIndex = 23550;
