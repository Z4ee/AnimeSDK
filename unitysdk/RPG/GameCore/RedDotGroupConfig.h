...
#define RPG_GAMECORE_REDDOTGROUPCONFIG_METHOD_2_D8C7268EDE905A9A_OFFSET UNITYSDK_OFFSET(0x18C94060)
#define RPG_GAMECORE_REDDOTGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18C94220)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RedDotGroupConfig_TypeDefinitionIndex = 23437;
