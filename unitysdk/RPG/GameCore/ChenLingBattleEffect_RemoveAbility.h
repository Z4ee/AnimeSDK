...
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_REMOVEABILITY_METHOD_3_564890ED3A6396ED_OFFSET UNITYSDK_OFFSET(0x19620CC0)
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_REMOVEABILITY_METHOD_3_A1B826E416E11908_OFFSET UNITYSDK_OFFSET(0x19620D60)
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_REMOVEABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x19620D50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleEffect_RemoveAbility_TypeDefinitionIndex = 15012;
