...
#define RPG_GAMECORE_ADVBYPLAYERINVISIONZONE_METHOD_4_70DD4C1A4C0E3B65_OFFSET UNITYSDK_OFFSET(0x1BE15A20)
#define RPG_GAMECORE_ADVBYPLAYERINVISIONZONE_METHOD_4_B8DDFD4FFD3A70D0_OFFSET UNITYSDK_OFFSET(0x1BE159E0)
#define RPG_GAMECORE_ADVBYPLAYERINVISIONZONE_METHOD_4_CFFEA4F393B5B1F3_OFFSET UNITYSDK_OFFSET(0x1BE15C10)
#define RPG_GAMECORE_ADVBYPLAYERINVISIONZONE_METHOD_4_D61F51641F02515C_OFFSET UNITYSDK_OFFSET(0x1BE15BE0)
#define RPG_GAMECORE_ADVBYPLAYERINVISIONZONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE15A10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvByPlayerInVisionZone_TypeDefinitionIndex = 19243;
