...
#define RPG_GAMECORE_ADVBYPLAYERINVISIONZONE_METHOD_4_47A43F393F7ED89B_OFFSET UNITYSDK_OFFSET(0x18649DF0)
#define RPG_GAMECORE_ADVBYPLAYERINVISIONZONE_METHOD_4_70DD4C1A4C0E3B65_OFFSET UNITYSDK_OFFSET(0x18649EC0)
#define RPG_GAMECORE_ADVBYPLAYERINVISIONZONE__CTOR_OFFSET UNITYSDK_OFFSET(0x18649E70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvByPlayerInVisionZone_TypeDefinitionIndex = 18939;
