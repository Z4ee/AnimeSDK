...
#define RPG_GAMECORE_WAITROGUEFINISHDIALOGUE_METHOD_3_037A20EB4FA1DF7F_OFFSET UNITYSDK_OFFSET(0x19106A40)
#define RPG_GAMECORE_WAITROGUEFINISHDIALOGUE_METHOD_3_64AC53AD089992EF_OFFSET UNITYSDK_OFFSET(0x191069B0)
#define RPG_GAMECORE_WAITROGUEFINISHDIALOGUE__CTOR_OFFSET UNITYSDK_OFFSET(0x19106A10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitRogueFinishDialogue_TypeDefinitionIndex = 19444;
