...
#define RPG_GAMECORE_WAITROGUEFINISHDIALOGUE_METHOD_3_037A20EB4FA1DF7F_OFFSET UNITYSDK_OFFSET(0x1D1BAD00)
#define RPG_GAMECORE_WAITROGUEFINISHDIALOGUE_METHOD_3_EA3D5794E0C6AAFB_OFFSET UNITYSDK_OFFSET(0x1D1BACB0)
#define RPG_GAMECORE_WAITROGUEFINISHDIALOGUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1BACF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitRogueFinishDialogue_TypeDefinitionIndex = 19705;
