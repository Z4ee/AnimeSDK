...
#define RPG_GAMECORE_SETDYNAMICVALUEBYEVOLVEBUILD_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1C2E17E0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYEVOLVEBUILD_METHOD_4_17ABB5A258C74744_OFFSET UNITYSDK_OFFSET(0x1C2E1600)
#define RPG_GAMECORE_SETDYNAMICVALUEBYEVOLVEBUILD_METHOD_4_3B8337CD3B308981_OFFSET UNITYSDK_OFFSET(0x1C2E15C0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYEVOLVEBUILD__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2E15F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByEvolveBuild_TypeDefinitionIndex = 22270;
