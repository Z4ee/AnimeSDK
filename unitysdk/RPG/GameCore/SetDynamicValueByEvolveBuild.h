...
#define RPG_GAMECORE_SETDYNAMICVALUEBYEVOLVEBUILD_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x176C1130)
#define RPG_GAMECORE_SETDYNAMICVALUEBYEVOLVEBUILD_METHOD_4_17ABB5A258C74744_OFFSET UNITYSDK_OFFSET(0x176BA760)
#define RPG_GAMECORE_SETDYNAMICVALUEBYEVOLVEBUILD_METHOD_4_43382F01158545B4_OFFSET UNITYSDK_OFFSET(0x176C10B0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYEVOLVEBUILD__CTOR_OFFSET UNITYSDK_OFFSET(0x176BA710)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByEvolveBuild_TypeDefinitionIndex = 21321;
