...
#define RPG_GAMECORE_PROGRESSBARTYPECONFIG_METHOD_2_6A64A33F24836CCB_OFFSET UNITYSDK_OFFSET(0x17513B00)
#define RPG_GAMECORE_PROGRESSBARTYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17513BD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ProgressBarTypeConfig_TypeDefinitionIndex = 20925;
