...
#define RPG_GAMECORE_TRIGGERPAMACTIONPHASEACTION_METHOD_3_0C94945F7FE712FA_OFFSET UNITYSDK_OFFSET(0x19E18AE0)
#define RPG_GAMECORE_TRIGGERPAMACTIONPHASEACTION_METHOD_3_6204A0C740352CCE_OFFSET UNITYSDK_OFFSET(0x19E189D0)
#define RPG_GAMECORE_TRIGGERPAMACTIONPHASEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19E18AB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerPamActionPhaseAction_TypeDefinitionIndex = 18906;
