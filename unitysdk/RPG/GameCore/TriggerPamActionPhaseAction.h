...
#define RPG_GAMECORE_TRIGGERPAMACTIONPHASEACTION_METHOD_3_0C94945F7FE712FA_OFFSET UNITYSDK_OFFSET(0x178CAF10)
#define RPG_GAMECORE_TRIGGERPAMACTIONPHASEACTION_METHOD_3_6204A0C740352CCE_OFFSET UNITYSDK_OFFSET(0x178CAE00)
#define RPG_GAMECORE_TRIGGERPAMACTIONPHASEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x178CAEE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerPamActionPhaseAction_TypeDefinitionIndex = 18305;
