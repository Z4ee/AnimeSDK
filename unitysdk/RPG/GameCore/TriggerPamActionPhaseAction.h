...
#define RPG_GAMECORE_TRIGGERPAMACTIONPHASEACTION_METHOD_3_0C94945F7FE712FA_OFFSET UNITYSDK_OFFSET(0x1D291740)
#define RPG_GAMECORE_TRIGGERPAMACTIONPHASEACTION_METHOD_3_634751220A406257_OFFSET UNITYSDK_OFFSET(0x1D291670)
#define RPG_GAMECORE_TRIGGERPAMACTIONPHASEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D291730)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerPamActionPhaseAction_TypeDefinitionIndex = 19797;
