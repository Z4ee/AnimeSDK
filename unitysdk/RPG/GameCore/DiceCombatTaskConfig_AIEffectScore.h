...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_AIEFFECTSCORE_METHOD_3_6540EA182E45775B_OFFSET UNITYSDK_OFFSET(0x1716AF80)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_AIEFFECTSCORE_METHOD_3_D3AFBC467687C0FF_OFFSET UNITYSDK_OFFSET(0x1716FDA0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_AIEFFECTSCORE__CTOR_OFFSET UNITYSDK_OFFSET(0x1716AF30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_AIEffectScore_TypeDefinitionIndex = 14851;
