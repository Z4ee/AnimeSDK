...
#define RPG_GAMECORE_FIVEDIMSINGLETRIGGEREVENTEMITTERCONFIG_METHOD_4_16784C73E94A0C91_OFFSET UNITYSDK_OFFSET(0x1BEB2E90)
#define RPG_GAMECORE_FIVEDIMSINGLETRIGGEREVENTEMITTERCONFIG_METHOD_4_E20077949F22F50F_OFFSET UNITYSDK_OFFSET(0x1BEB2EE0)
#define RPG_GAMECORE_FIVEDIMSINGLETRIGGEREVENTEMITTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEB2ED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSingleTriggerEventEmitterConfig_TypeDefinitionIndex = 17909;
