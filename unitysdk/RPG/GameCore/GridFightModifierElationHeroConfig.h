...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERELATIONHEROCONFIG_METHOD_3_EB30EDEBDDFEBC4A_OFFSET UNITYSDK_OFFSET(0x1C5D0AB0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERELATIONHEROCONFIG_METHOD_3_F112771C33DB7CA6_OFFSET UNITYSDK_OFFSET(0x1C5D0B00)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERELATIONHEROCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5D0AF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierElationHeroConfig_TypeDefinitionIndex = 18725;
