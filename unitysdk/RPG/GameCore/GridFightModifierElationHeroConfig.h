...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERELATIONHEROCONFIG_METHOD_3_EB30EDEBDDFEBC4A_OFFSET UNITYSDK_OFFSET(0x1D158C20)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERELATIONHEROCONFIG_METHOD_3_F112771C33DB7CA6_OFFSET UNITYSDK_OFFSET(0x1D158C70)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERELATIONHEROCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D158C60)
