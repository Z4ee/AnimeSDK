...
#define RPG_GAMECORE_REPLACECHARACTEREMOTION_METHOD_3_10FCC374DC1D0542_OFFSET UNITYSDK_OFFSET(0x1D018940)
#define RPG_GAMECORE_REPLACECHARACTEREMOTION_METHOD_3_AB7027DF4DC1543D_OFFSET UNITYSDK_OFFSET(0x1D018900)
#define RPG_GAMECORE_REPLACECHARACTEREMOTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D018930)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ReplaceCharacterEmotion_TypeDefinitionIndex = 21601;
