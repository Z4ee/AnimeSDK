...
#define RPG_GAMECORE_ROGUEACTCHANGEPERSONASTYLELEVELCONFIG_METHOD_6_3CF2605ADE774B55_OFFSET UNITYSDK_OFFSET(0x175B2DC0)
#define RPG_GAMECORE_ROGUEACTCHANGEPERSONASTYLELEVELCONFIG_METHOD_6_ED5B0571CBCA0C18_OFFSET UNITYSDK_OFFSET(0x175B2BA0)
#define RPG_GAMECORE_ROGUEACTCHANGEPERSONASTYLELEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175B2CE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActChangePersonaStyleLevelConfig_TypeDefinitionIndex = 18123;
