...
#define RPG_GAMECORE_ROGUEACTCHANGEPERSONASTYLELEVELCONFIG_METHOD_6_3CF2605ADE774B55_OFFSET UNITYSDK_OFFSET(0x1D02D610)
#define RPG_GAMECORE_ROGUEACTCHANGEPERSONASTYLELEVELCONFIG_METHOD_6_F0991E5194530731_OFFSET UNITYSDK_OFFSET(0x1D02D5C0)
#define RPG_GAMECORE_ROGUEACTCHANGEPERSONASTYLELEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D02D600)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActChangePersonaStyleLevelConfig_TypeDefinitionIndex = 19011;
