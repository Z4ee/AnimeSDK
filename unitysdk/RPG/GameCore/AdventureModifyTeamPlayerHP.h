...
#define RPG_GAMECORE_ADVENTUREMODIFYTEAMPLAYERHP_METHOD_3_DA05908785907371_OFFSET UNITYSDK_OFFSET(0x1CBBB0D0)
#define RPG_GAMECORE_ADVENTUREMODIFYTEAMPLAYERHP_METHOD_3_DE7BF09658ADB6AA_OFFSET UNITYSDK_OFFSET(0x1CBBB120)
#define RPG_GAMECORE_ADVENTUREMODIFYTEAMPLAYERHP__CTOR_OFFSET UNITYSDK_OFFSET(0x1CBBB110)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureModifyTeamPlayerHP_TypeDefinitionIndex = 19943;
	...
	public:
		...
		static ::System::Void Method_3_DA05908785907371(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::AdventureModifyTeamPlayerHP*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::AdventureModifyTeamPlayerHP*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_ADVENTUREMODIFYTEAMPLAYERHP_METHOD_3_DA05908785907371_OFFSET))(a1, a2);
		}
