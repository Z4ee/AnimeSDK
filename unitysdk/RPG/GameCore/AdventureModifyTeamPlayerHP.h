...
#define RPG_GAMECORE_ADVENTUREMODIFYTEAMPLAYERHP_METHOD_3_DA05908785907371_OFFSET UNITYSDK_OFFSET(0x1AE5F290)
#define RPG_GAMECORE_ADVENTUREMODIFYTEAMPLAYERHP_METHOD_3_DE7BF09658ADB6AA_OFFSET UNITYSDK_OFFSET(0x1AE5F2E0)
#define RPG_GAMECORE_ADVENTUREMODIFYTEAMPLAYERHP__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE5F2D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureModifyTeamPlayerHP_TypeDefinitionIndex = 19400;
