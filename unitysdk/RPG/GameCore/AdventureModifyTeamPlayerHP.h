...
#define RPG_GAMECORE_ADVENTUREMODIFYTEAMPLAYERHP_METHOD_3_A93BB2FB01F49E2A_OFFSET UNITYSDK_OFFSET(0x18678640)
#define RPG_GAMECORE_ADVENTUREMODIFYTEAMPLAYERHP_METHOD_3_DE7BF09658ADB6AA_OFFSET UNITYSDK_OFFSET(0x186786E0)
#define RPG_GAMECORE_ADVENTUREMODIFYTEAMPLAYERHP__CTOR_OFFSET UNITYSDK_OFFSET(0x186786A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureModifyTeamPlayerHP_TypeDefinitionIndex = 19113;
