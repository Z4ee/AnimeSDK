...
#define RPG_GAMECORE_ROGUEADVENTURECONFIGBASE_METHOD_2_18AAF0612A135261_OFFSET UNITYSDK_OFFSET(0x19B0CAE0)
#define RPG_GAMECORE_ROGUEADVENTURECONFIGBASE_METHOD_2_7149A8EC2AB64A88_OFFSET UNITYSDK_OFFSET(0x19B0C8D0)
#define RPG_GAMECORE_ROGUEADVENTURECONFIGBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x19B0C8C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueAdventureConfigBase_TypeDefinitionIndex = 17001;
