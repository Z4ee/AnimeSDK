...
#define RPG_GAMECORE_ROGUEADVENTURECONFIGBASE_METHOD_2_18AAF0612A135261_OFFSET UNITYSDK_OFFSET(0x18CE70F0)
#define RPG_GAMECORE_ROGUEADVENTURECONFIGBASE_METHOD_2_7149A8EC2AB64A88_OFFSET UNITYSDK_OFFSET(0x18CE6F20)
#define RPG_GAMECORE_ROGUEADVENTURECONFIGBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x18CE6F10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueAdventureConfigBase_TypeDefinitionIndex = 16986;
