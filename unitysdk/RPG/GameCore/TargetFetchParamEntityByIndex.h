...
#define RPG_GAMECORE_TARGETFETCHPARAMENTITYBYINDEX_METHOD_4_1DA8DDBB5213D997_OFFSET UNITYSDK_OFFSET(0x1D0BBBE0)
#define RPG_GAMECORE_TARGETFETCHPARAMENTITYBYINDEX_METHOD_4_548B85F97FD63192_OFFSET UNITYSDK_OFFSET(0x1D0BBCB0)
#define RPG_GAMECORE_TARGETFETCHPARAMENTITYBYINDEX_METHOD_4_64B97FA6C87CB365_OFFSET UNITYSDK_OFFSET(0x1D0BBD60)
#define RPG_GAMECORE_TARGETFETCHPARAMENTITYBYINDEX_METHOD_4_DA3ED8F7000B24EA_OFFSET UNITYSDK_OFFSET(0x1D0BBD90)
#define RPG_GAMECORE_TARGETFETCHPARAMENTITYBYINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0BBCA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchParamEntityByIndex_TypeDefinitionIndex = 23065;
