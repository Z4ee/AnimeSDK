...
#define RPG_GAMECORE_TARGETFETCHPARAMENTITYBYINDEX_METHOD_4_548B85F97FD63192_OFFSET UNITYSDK_OFFSET(0x18EDEF80)
#define RPG_GAMECORE_TARGETFETCHPARAMENTITYBYINDEX_METHOD_4_FC973ACDF2311B99_OFFSET UNITYSDK_OFFSET(0x18EE53A0)
#define RPG_GAMECORE_TARGETFETCHPARAMENTITYBYINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0x18EDEF30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchParamEntityByIndex_TypeDefinitionIndex = 22911;
