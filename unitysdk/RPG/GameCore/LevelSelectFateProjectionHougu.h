...
#define RPG_GAMECORE_LEVELSELECTFATEPROJECTIONHOUGU_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1BE033A0)
#define RPG_GAMECORE_LEVELSELECTFATEPROJECTIONHOUGU_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x1BE03350)
#define RPG_GAMECORE_LEVELSELECTFATEPROJECTIONHOUGU_INIT_OFFSET UNITYSDK_OFFSET(0x1BE03300)
#define RPG_GAMECORE_LEVELSELECTFATEPROJECTIONHOUGU__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE033F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelSelectFateProjectionHougu_TypeDefinitionIndex = 54279;
