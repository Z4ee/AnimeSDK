...
#define RPG_GAMECORE_LEVELNAVMAPCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D1E1990)
#define RPG_GAMECORE_LEVELNAVMAPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1E1E40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelNavmapConfig_TypeDefinitionIndex = 17031;
	...
	public:
		...
		static ::System::Void FromBinary(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::LevelNavmapConfig*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::LevelNavmapConfig*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_LEVELNAVMAPCONFIG_FROMBINARY_OFFSET))(a1, a2);
		}
	};
}
