...
#define RPG_GAMECORE_LEVELNAVMAPCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C124F30)
#define RPG_GAMECORE_LEVELNAVMAPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1253E0)
