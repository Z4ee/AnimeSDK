...
#define RPG_GAMECORE_GRIDFIGHTNODETEMPLATECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x197F5560)
#define RPG_GAMECORE_GRIDFIGHTNODETEMPLATECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x197F57A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightNodeTemplateConfigRow_TypeDefinitionIndex = 12969;
