...
#define RPG_GAMECORE_GRIDFIGHTNODETEMPLATECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D15C0C0)
#define RPG_GAMECORE_GRIDFIGHTNODETEMPLATECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D15C340)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 PenaltyBonusRuleID; // 0x2C
