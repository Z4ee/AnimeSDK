...
#define RPG_GAMECORE_GRIDFIGHTNODETEMPLATECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x189C10C0)
#define RPG_GAMECORE_GRIDFIGHTNODETEMPLATECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x189C1310)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightNodeTemplateConfigRow_TypeDefinitionIndex = 12884;
	...
	public:
		...
		::System::UInt32 BasicGoldRewardNum; // 0x1C
		::System::UInt32 NodeTemplateID; // 0x20
