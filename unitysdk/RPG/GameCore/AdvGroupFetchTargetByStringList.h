...
#define RPG_GAMECORE_ADVGROUPFETCHTARGETBYSTRINGLIST_METHOD_4_57BBBB0ACCFC992F_OFFSET UNITYSDK_OFFSET(0x18653570)
#define RPG_GAMECORE_ADVGROUPFETCHTARGETBYSTRINGLIST_METHOD_4_616012D5FBD382A9_OFFSET UNITYSDK_OFFSET(0x18653410)
#define RPG_GAMECORE_ADVGROUPFETCHTARGETBYSTRINGLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x18653520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvGroupFetchTargetByStringList_TypeDefinitionIndex = 20131;
