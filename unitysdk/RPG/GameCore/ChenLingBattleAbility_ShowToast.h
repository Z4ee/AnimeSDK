...
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_SHOWTOAST_METHOD_3_0765325EB420E3F3_OFFSET UNITYSDK_OFFSET(0x1C378110)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_SHOWTOAST_METHOD_3_4EA4609A9E0E096F_OFFSET UNITYSDK_OFFSET(0x1C3780B0)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_SHOWTOAST__CTOR_OFFSET UNITYSDK_OFFSET(0x1C378100)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleAbility_ShowToast_TypeDefinitionIndex = 15127;
