...
#define RPG_GAMECORE_PEIPEICHALLENGEUPDATECHECKPOINT_METHOD_3_65DE90A7152F3969_OFFSET UNITYSDK_OFFSET(0x174902D0)
#define RPG_GAMECORE_PEIPEICHALLENGEUPDATECHECKPOINT_METHOD_3_EA7B040E62D52275_OFFSET UNITYSDK_OFFSET(0x174901C0)
#define RPG_GAMECORE_PEIPEICHALLENGEUPDATECHECKPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x174902A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PeiPeiChallengeUpdateCheckPoint_TypeDefinitionIndex = 19491;
