...
#define RPG_GAMECORE_FATEMODIFIERMODIFYMASTERAFFIXRARITYPROBABILITYCONFIG_METHOD_3_B4650C5223FAD777_OFFSET UNITYSDK_OFFSET(0x171C8D00)
#define RPG_GAMECORE_FATEMODIFIERMODIFYMASTERAFFIXRARITYPROBABILITYCONFIG_METHOD_3_C14A279B23D2A94E_OFFSET UNITYSDK_OFFSET(0x171C7D20)
#define RPG_GAMECORE_FATEMODIFIERMODIFYMASTERAFFIXRARITYPROBABILITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171C7CD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateModifierModifyMasterAffixRarityProbabilityConfig_TypeDefinitionIndex = 17700;
