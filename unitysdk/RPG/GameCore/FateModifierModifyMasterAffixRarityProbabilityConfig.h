...
#define RPG_GAMECORE_FATEMODIFIERMODIFYMASTERAFFIXRARITYPROBABILITYCONFIG_METHOD_3_B4650C5223FAD777_OFFSET UNITYSDK_OFFSET(0x188D64D0)
#define RPG_GAMECORE_FATEMODIFIERMODIFYMASTERAFFIXRARITYPROBABILITYCONFIG_METHOD_3_C14A279B23D2A94E_OFFSET UNITYSDK_OFFSET(0x188D54F0)
#define RPG_GAMECORE_FATEMODIFIERMODIFYMASTERAFFIXRARITYPROBABILITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x188D54A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateModifierModifyMasterAffixRarityProbabilityConfig_TypeDefinitionIndex = 18313;
