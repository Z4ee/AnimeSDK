...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEPASSSWARMCELL_METHOD_3_90340126E426FA39_OFFSET UNITYSDK_OFFSET(0x19C43FA0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEPASSSWARMCELL_METHOD_3_F9D9043E031C801E_OFFSET UNITYSDK_OFFSET(0x19C43F30)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEPASSSWARMCELL__CTOR_OFFSET UNITYSDK_OFFSET(0x19C43F70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRoguePassSwarmCell_TypeDefinitionIndex = 20570;
