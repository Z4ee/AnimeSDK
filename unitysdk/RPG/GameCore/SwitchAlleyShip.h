...
#define RPG_GAMECORE_SWITCHALLEYSHIP_METHOD_3_34F80054F85A682F_OFFSET UNITYSDK_OFFSET(0x1D588110)
#define RPG_GAMECORE_SWITCHALLEYSHIP_METHOD_3_6080C54B36F99846_OFFSET UNITYSDK_OFFSET(0x1D588150)
#define RPG_GAMECORE_SWITCHALLEYSHIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D588140)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchAlleyShip_TypeDefinitionIndex = 23794;
