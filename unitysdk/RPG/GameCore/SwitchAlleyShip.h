...
#define RPG_GAMECORE_SWITCHALLEYSHIP_METHOD_3_18A4357B18922200_OFFSET UNITYSDK_OFFSET(0x177912F0)
#define RPG_GAMECORE_SWITCHALLEYSHIP_METHOD_3_4A6E96E172D99E99_OFFSET UNITYSDK_OFFSET(0x17791270)
#define RPG_GAMECORE_SWITCHALLEYSHIP__CTOR_OFFSET UNITYSDK_OFFSET(0x177912C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchAlleyShip_TypeDefinitionIndex = 22317;
