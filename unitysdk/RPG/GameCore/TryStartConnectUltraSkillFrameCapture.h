...
#define RPG_GAMECORE_TRYSTARTCONNECTULTRASKILLFRAMECAPTURE_METHOD_3_47E34213435AAA3E_OFFSET UNITYSDK_OFFSET(0x19E217B0)
#define RPG_GAMECORE_TRYSTARTCONNECTULTRASKILLFRAMECAPTURE_METHOD_3_6E1489F11C61D5B2_OFFSET UNITYSDK_OFFSET(0x19E216A0)
#define RPG_GAMECORE_TRYSTARTCONNECTULTRASKILLFRAMECAPTURE__CTOR_OFFSET UNITYSDK_OFFSET(0x19E21780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TryStartConnectUltraSkillFrameCapture_TypeDefinitionIndex = 21486;
