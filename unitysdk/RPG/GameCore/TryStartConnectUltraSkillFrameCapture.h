...
#define RPG_GAMECORE_TRYSTARTCONNECTULTRASKILLFRAMECAPTURE_METHOD_3_47E34213435AAA3E_OFFSET UNITYSDK_OFFSET(0x178D1B80)
#define RPG_GAMECORE_TRYSTARTCONNECTULTRASKILLFRAMECAPTURE_METHOD_3_6E1489F11C61D5B2_OFFSET UNITYSDK_OFFSET(0x178D1A70)
#define RPG_GAMECORE_TRYSTARTCONNECTULTRASKILLFRAMECAPTURE__CTOR_OFFSET UNITYSDK_OFFSET(0x178D1B50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TryStartConnectUltraSkillFrameCapture_TypeDefinitionIndex = 20912;
