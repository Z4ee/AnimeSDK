...
#define RPG_GAMECORE_FIVEDIMPUZZLECHALLENGEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D875860)
#define RPG_GAMECORE_FIVEDIMPUZZLECHALLENGEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D875F10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimPuzzleChallengeRow_TypeDefinitionIndex = 14004;
	...
	public:
		...
		::RPG::Client::TextID FinishDescText; // 0x38
		::RPG::Client::TextID ActiveNameText; // 0x48
		::RPG::Client::TextID DescText; // 0x58
		::RPG::Client::TextID NameText; // 0x68
		::RPG::Client::TextID FinishNameText; // 0x78
		::System::UInt32 FloorID; // 0x88
		::System::UInt32 PuzzleID; // 0x8C
		::System::Int16 ProgressLimit; // 0x90
		::RPG::Client::TextID ActiveDescText; // 0x98
