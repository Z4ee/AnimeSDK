...
#define RPG_GAMECORE_FIVEDIMPUZZLECHALLENGEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D0FCDD0)
#define RPG_GAMECORE_FIVEDIMPUZZLECHALLENGEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0FD480)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID ActiveDescText; // 0x40
		...
		::RPG::Client::TextID NameText; // 0x78
		::System::UInt32 PuzzleID; // 0x88
		::System::Int16 ProgressLimit; // 0x8C
