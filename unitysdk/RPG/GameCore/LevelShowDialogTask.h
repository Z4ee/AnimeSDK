...
#define RPG_GAMECORE_LEVELSHOWDIALOGTASK_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1BE034D0)
#define RPG_GAMECORE_LEVELSHOWDIALOGTASK_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1BE03510)
#define RPG_GAMECORE_LEVELSHOWDIALOGTASK_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1BE03590)
#define RPG_GAMECORE_LEVELSHOWDIALOGTASK_TICK_OFFSET UNITYSDK_OFFSET(0x1BE035E0)
#define RPG_GAMECORE_LEVELSHOWDIALOGTASK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE034C0)
#define RPG_GAMECORE_LEVELSHOWDIALOGTASK__ONDIALOGUECLOSED_OFFSET UNITYSDK_OFFSET(0x1BE03640)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelShowDialogTask_TypeDefinitionIndex = 55608;
