...
#define RPG_GAMECORE_SETCHARACTERVISIBILITYFOLLOW_METHOD_3_342111117C916ACE_OFFSET UNITYSDK_OFFSET(0x176AF1E0)
#define RPG_GAMECORE_SETCHARACTERVISIBILITYFOLLOW_METHOD_3_6F7D0F5DA1CDA221_OFFSET UNITYSDK_OFFSET(0x176AF150)
#define RPG_GAMECORE_SETCHARACTERVISIBILITYFOLLOW__CTOR_OFFSET UNITYSDK_OFFSET(0x176AF1B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetCharacterVisibilityFollow_TypeDefinitionIndex = 20831;
