...
#define RPG_GAMECORE_FORMATIONDATA_METHOD_2_E359314CE645F3C6_OFFSET UNITYSDK_OFFSET(0x1BEC0440)
#define RPG_GAMECORE_FORMATIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEC0730)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FormationData_TypeDefinitionIndex = 16448;
