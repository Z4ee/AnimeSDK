...
#define RPG_GAMECORE_CHARACTERHEADSTOPLOOKAT_METHOD_3_552FC41D6E8FB3E5_OFFSET UNITYSDK_OFFSET(0x1B7245D0)
#define RPG_GAMECORE_CHARACTERHEADSTOPLOOKAT_METHOD_3_AE099C39AD5CD730_OFFSET UNITYSDK_OFFSET(0x1B724580)
#define RPG_GAMECORE_CHARACTERHEADSTOPLOOKAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7245C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterHeadStopLookAt_TypeDefinitionIndex = 20080;
