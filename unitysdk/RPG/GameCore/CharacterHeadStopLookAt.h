...
#define RPG_GAMECORE_CHARACTERHEADSTOPLOOKAT_METHOD_3_552FC41D6E8FB3E5_OFFSET UNITYSDK_OFFSET(0x187D2300)
#define RPG_GAMECORE_CHARACTERHEADSTOPLOOKAT_METHOD_3_743CD257A4E0D1A6_OFFSET UNITYSDK_OFFSET(0x187D2270)
#define RPG_GAMECORE_CHARACTERHEADSTOPLOOKAT__CTOR_OFFSET UNITYSDK_OFFSET(0x187D22D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterHeadStopLookAt_TypeDefinitionIndex = 19851;
