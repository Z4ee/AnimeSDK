...
#define RPG_GAMECORE_WAITTURNCOUNT_METHOD_3_84B56CCD64415B0A_OFFSET UNITYSDK_OFFSET(0x17907410)
#define RPG_GAMECORE_WAITTURNCOUNT_METHOD_3_CED716E9171354F2_OFFSET UNITYSDK_OFFSET(0x179072F0)
#define RPG_GAMECORE_WAITTURNCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x17907390)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitTurnCount_TypeDefinitionIndex = 21639;
