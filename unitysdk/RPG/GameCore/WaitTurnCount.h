...
#define RPG_GAMECORE_WAITTURNCOUNT_METHOD_3_18F0E26295C0F629_OFFSET UNITYSDK_OFFSET(0x1D1BE960)
#define RPG_GAMECORE_WAITTURNCOUNT_METHOD_3_D1881D97049BBDD4_OFFSET UNITYSDK_OFFSET(0x1D1BEA40)
#define RPG_GAMECORE_WAITTURNCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1BE9E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitTurnCount_TypeDefinitionIndex = 22570;
