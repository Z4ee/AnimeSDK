...
#define RPG_GAMECORE_RTPROPERTYMODIFYDATA_EQUALS_OFFSET UNITYSDK_OFFSET(0xE2390)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtPropertyModifyData_TypeDefinitionIndex = 49513;
