...
#define RPG_GAMECORE_BYCOMPAREHIPPLENENERGY_METHOD_4_8E8B6646498E3CD3_OFFSET UNITYSDK_OFFSET(0x1700BF10)
#define RPG_GAMECORE_BYCOMPAREHIPPLENENERGY_METHOD_4_A5FCCD8A81512DCD_OFFSET UNITYSDK_OFFSET(0x1700BE40)
#define RPG_GAMECORE_BYCOMPAREHIPPLENENERGY__CTOR_OFFSET UNITYSDK_OFFSET(0x1700BEC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareHipplenEnergy_TypeDefinitionIndex = 19624;
