...
#define RPG_GAMECORE_BYCOMPAREHIPPLENENERGY_METHOD_4_0C486D3EA7EDDAB9_OFFSET UNITYSDK_OFFSET(0x1C323E60)
#define RPG_GAMECORE_BYCOMPAREHIPPLENENERGY_METHOD_4_0EA3727BAE08F6BA_OFFSET UNITYSDK_OFFSET(0x1C323C40)
#define RPG_GAMECORE_BYCOMPAREHIPPLENENERGY_METHOD_4_8E8B6646498E3CD3_OFFSET UNITYSDK_OFFSET(0x1C323C80)
#define RPG_GAMECORE_BYCOMPAREHIPPLENENERGY_METHOD_4_A592C90E46112AC6_OFFSET UNITYSDK_OFFSET(0x1C323E30)
#define RPG_GAMECORE_BYCOMPAREHIPPLENENERGY__CTOR_OFFSET UNITYSDK_OFFSET(0x1C323C70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareHipplenEnergy_TypeDefinitionIndex = 21078;
