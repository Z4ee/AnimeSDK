...
#define RPG_GAMECORE_ELFBEHAVIORSTATEITEM_METHOD_2_29351A80DE952F3E_OFFSET UNITYSDK_OFFSET(0x1DB275A0)
#define RPG_GAMECORE_ELFBEHAVIORSTATEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB27760)
