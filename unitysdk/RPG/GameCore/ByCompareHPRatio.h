...
#define RPG_GAMECORE_BYCOMPAREHPRATIO_METHOD_4_5BAAA37E5C859879_OFFSET UNITYSDK_OFFSET(0x19CEA300)
#define RPG_GAMECORE_BYCOMPAREHPRATIO_METHOD_4_5CE7B5072F997BB0_OFFSET UNITYSDK_OFFSET(0x19CEA2C0)
#define RPG_GAMECORE_BYCOMPAREHPRATIO_METHOD_4_637C8FF4D1E08CE5_OFFSET UNITYSDK_OFFSET(0x19CEA560)
#define RPG_GAMECORE_BYCOMPAREHPRATIO_METHOD_4_A26551549B5D42D3_OFFSET UNITYSDK_OFFSET(0x19CEA530)
#define RPG_GAMECORE_BYCOMPAREHPRATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x19CEA2F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareHPRatio_TypeDefinitionIndex = 22167;
