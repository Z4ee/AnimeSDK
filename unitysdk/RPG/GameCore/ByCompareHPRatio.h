...
#define RPG_GAMECORE_BYCOMPAREHPRATIO_METHOD_4_1576F02E1FFDD53B_OFFSET UNITYSDK_OFFSET(0x1700B3B0)
#define RPG_GAMECORE_BYCOMPAREHPRATIO_METHOD_4_5BAAA37E5C859879_OFFSET UNITYSDK_OFFSET(0x1700B480)
#define RPG_GAMECORE_BYCOMPAREHPRATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x1700B430)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareHPRatio_TypeDefinitionIndex = 21201;
