...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_SHOWBOSSPERSISTENTTIPSVIEW_METHOD_3_75C8E7FD74013926_OFFSET UNITYSDK_OFFSET(0x1C11A200)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_SHOWBOSSPERSISTENTTIPSVIEW_METHOD_3_F41EB76F7B68400F_OFFSET UNITYSDK_OFFSET(0x1C11A340)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_SHOWBOSSPERSISTENTTIPSVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C11A330)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_ShowBossPersistentTipsView_TypeDefinitionIndex = 15580;
