...
#define RPG_GAMECORE_GROUPEDCOLLIDERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xA9725C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GroupedColliderConfig_TypeDefinitionIndex = 46085;
