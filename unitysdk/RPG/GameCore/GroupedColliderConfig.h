...
#define RPG_GAMECORE_GROUPEDCOLLIDERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xB6C06B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GroupedColliderConfig_TypeDefinitionIndex = 52750;
