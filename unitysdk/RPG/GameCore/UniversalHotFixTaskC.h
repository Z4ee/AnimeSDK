...
#define RPG_GAMECORE_UNIVERSALHOTFIXTASKC_METHOD_4_5F014F05327EAC77_OFFSET UNITYSDK_OFFSET(0x190E52B0)
#define RPG_GAMECORE_UNIVERSALHOTFIXTASKC_METHOD_4_962EFA6CE9315676_OFFSET UNITYSDK_OFFSET(0x190E4F40)
#define RPG_GAMECORE_UNIVERSALHOTFIXTASKC__CTOR_OFFSET UNITYSDK_OFFSET(0x190E4F10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UniversalHotFixTaskC_TypeDefinitionIndex = 22328;
