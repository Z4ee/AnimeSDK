...
#define RPG_GAMECORE_UNIVERSALHOTFIXTASKC_METHOD_4_45F5B52820437D8D_OFFSET UNITYSDK_OFFSET(0x1B884930)
#define RPG_GAMECORE_UNIVERSALHOTFIXTASKC_METHOD_4_962EFA6CE9315676_OFFSET UNITYSDK_OFFSET(0x1B883520)
#define RPG_GAMECORE_UNIVERSALHOTFIXTASKC__CTOR_OFFSET UNITYSDK_OFFSET(0x1B883510)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UniversalHotFixTaskC_TypeDefinitionIndex = 22523;
