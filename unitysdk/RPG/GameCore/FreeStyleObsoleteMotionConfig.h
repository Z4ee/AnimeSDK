...
#define RPG_GAMECORE_FREESTYLEOBSOLETEMOTIONCONFIG_METHOD_2_BB0767FE64D78528_OFFSET UNITYSDK_OFFSET(0x1DCBBE90)
#define RPG_GAMECORE_FREESTYLEOBSOLETEMOTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCBBED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FreeStyleObsoleteMotionConfig_TypeDefinitionIndex = 16145;
