...
#define RPG_GAMECORE_TRIGGERBREAK_METHOD_3_2A174A0DEDEBF1B1_OFFSET UNITYSDK_OFFSET(0x178C0270)
#define RPG_GAMECORE_TRIGGERBREAK_METHOD_3_C5210B5A7832D7DD_OFFSET UNITYSDK_OFFSET(0x178C01E0)
#define RPG_GAMECORE_TRIGGERBREAK__CTOR_OFFSET UNITYSDK_OFFSET(0x178C0240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerBreak_TypeDefinitionIndex = 20902;
