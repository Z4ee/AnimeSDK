...
#define RPG_GAMECORE_ROGUEADVENTUREROOMRAYPROCESS_METHOD_3_1BA60A4C034DB41C_OFFSET UNITYSDK_OFFSET(0x1EE8B330)
#define RPG_GAMECORE_ROGUEADVENTUREROOMRAYPROCESS_METHOD_3_ADF004088BF565EC_OFFSET UNITYSDK_OFFSET(0x1EE8B3E0)
#define RPG_GAMECORE_ROGUEADVENTUREROOMRAYPROCESS__CTOR_OFFSET UNITYSDK_OFFSET(0x1EE8B3A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueAdventureRoomRayProcess_TypeDefinitionIndex = 22033;
