...
#define RPG_GAMECORE_CHRONICLELOGICCONNECTIONNODECONFIG_METHOD_2_0C14E553D0F4ED9A_OFFSET UNITYSDK_OFFSET(0x1880D990)
#define RPG_GAMECORE_CHRONICLELOGICCONNECTIONNODECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1880DAB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChronicleLogicConnectionNodeConfig_TypeDefinitionIndex = 17999;
