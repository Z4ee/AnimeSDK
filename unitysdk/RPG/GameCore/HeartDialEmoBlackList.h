...
#define RPG_GAMECORE_HEARTDIALEMOBLACKLIST_METHOD_3_10DD8A4DD499BB5A_OFFSET UNITYSDK_OFFSET(0x17297CC0)
#define RPG_GAMECORE_HEARTDIALEMOBLACKLIST_METHOD_3_21ADAD514C2F805D_OFFSET UNITYSDK_OFFSET(0x17297C40)
#define RPG_GAMECORE_HEARTDIALEMOBLACKLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x17297C90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HeartDialEmoBlackList_TypeDefinitionIndex = 19522;
