...
#define RPG_GAMECORE_HEARTDIALEMOBLACKLIST_METHOD_3_0FE307F96E25581C_OFFSET UNITYSDK_OFFSET(0x1D17C4B0)
#define RPG_GAMECORE_HEARTDIALEMOBLACKLIST_METHOD_3_D891CBFD0D9BC5F1_OFFSET UNITYSDK_OFFSET(0x1D17C4F0)
#define RPG_GAMECORE_HEARTDIALEMOBLACKLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1D17C4E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HeartDialEmoBlackList_TypeDefinitionIndex = 20978;
