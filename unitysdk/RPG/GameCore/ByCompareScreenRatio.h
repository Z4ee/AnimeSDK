...
#define RPG_GAMECORE_BYCOMPARESCREENRATIO_METHOD_4_9BEF9B85DD88872B_OFFSET UNITYSDK_OFFSET(0x1873A7F0)
#define RPG_GAMECORE_BYCOMPARESCREENRATIO_METHOD_4_C71C2B3D6551204F_OFFSET UNITYSDK_OFFSET(0x1873A710)
#define RPG_GAMECORE_BYCOMPARESCREENRATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x1873A790)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareScreenRatio_TypeDefinitionIndex = 21139;
