...
#define RPG_GAMECORE_WAITBATTLEWINWITHSCORE_METHOD_3_119F015C9D308578_OFFSET UNITYSDK_OFFSET(0x178F5D80)
#define RPG_GAMECORE_WAITBATTLEWINWITHSCORE_METHOD_3_25AC7169CF984B78_OFFSET UNITYSDK_OFFSET(0x178F5CF0)
#define RPG_GAMECORE_WAITBATTLEWINWITHSCORE__CTOR_OFFSET UNITYSDK_OFFSET(0x178F5D50)
