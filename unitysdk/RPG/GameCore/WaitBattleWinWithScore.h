...
#define RPG_GAMECORE_WAITBATTLEWINWITHSCORE_METHOD_3_119F015C9D308578_OFFSET UNITYSDK_OFFSET(0x190F9C10)
#define RPG_GAMECORE_WAITBATTLEWINWITHSCORE_METHOD_3_25AC7169CF984B78_OFFSET UNITYSDK_OFFSET(0x190F9B80)
#define RPG_GAMECORE_WAITBATTLEWINWITHSCORE__CTOR_OFFSET UNITYSDK_OFFSET(0x190F9BE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitBattleWinWithScore_TypeDefinitionIndex = 20239;
