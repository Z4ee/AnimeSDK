...
#define RPG_GAMECORE_PROPSERVERATTACHDELAYMOVE_METHOD_3_21F22EA09030F2F8_OFFSET UNITYSDK_OFFSET(0x1BA28C40)
#define RPG_GAMECORE_PROPSERVERATTACHDELAYMOVE_METHOD_3_A2E59E324D6B15BC_OFFSET UNITYSDK_OFFSET(0x1BA28BF0)
#define RPG_GAMECORE_PROPSERVERATTACHDELAYMOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA28C30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropServerAttachDelayMove_TypeDefinitionIndex = 19569;
