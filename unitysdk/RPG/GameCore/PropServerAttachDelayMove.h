...
#define RPG_GAMECORE_PROPSERVERATTACHDELAYMOVE_METHOD_3_21F22EA09030F2F8_OFFSET UNITYSDK_OFFSET(0x17524770)
#define RPG_GAMECORE_PROPSERVERATTACHDELAYMOVE_METHOD_3_35FF9EADC298B8F8_OFFSET UNITYSDK_OFFSET(0x175246E0)
#define RPG_GAMECORE_PROPSERVERATTACHDELAYMOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x17524740)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropServerAttachDelayMove_TypeDefinitionIndex = 18640;
