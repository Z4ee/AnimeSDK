...
#define RPG_GAMECORE_VP_MAX_METHOD_3_6AB2EB1D537051D8_OFFSET UNITYSDK_OFFSET(0x190F0A40)
#define RPG_GAMECORE_VP_MAX_METHOD_3_7F0286D47BD64E15_OFFSET UNITYSDK_OFFSET(0x190F0990)
#define RPG_GAMECORE_VP_MAX__CTOR_OFFSET UNITYSDK_OFFSET(0x190F0A30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VP_Max_TypeDefinitionIndex = 23046;
