...
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEMIRACLEHINTCONFIG_METHOD_3_2814F9756B4E284E_OFFSET UNITYSDK_OFFSET(0x18D457A0)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEMIRACLEHINTCONFIG_METHOD_3_B67C0DB013475AC7_OFFSET UNITYSDK_OFFSET(0x18D45870)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEMIRACLEHINTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D45820)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierReplaceContentRogueMiracleHintConfig_TypeDefinitionIndex = 16813;
