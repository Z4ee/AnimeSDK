...
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEMIRACLEHINTCONFIG_METHOD_3_7A4647C0E6AE6743_OFFSET UNITYSDK_OFFSET(0x1D3FC060)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEMIRACLEHINTCONFIG_METHOD_3_B67C0DB013475AC7_OFFSET UNITYSDK_OFFSET(0x1D3FC0B0)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEMIRACLEHINTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3FC0A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierReplaceContentRogueMiracleHintConfig_TypeDefinitionIndex = 17493;
