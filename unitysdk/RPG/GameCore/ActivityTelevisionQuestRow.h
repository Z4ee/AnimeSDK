...
#define RPG_GAMECORE_ACTIVITYTELEVISIONQUESTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CDAD6F0)
#define RPG_GAMECORE_ACTIVITYTELEVISIONQUESTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDADDA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityTelevisionQuestRow_TypeDefinitionIndex = 12420;
	...
	public:
		...
		::RPG::Client::TextID OriginalTabName; // 0x30
