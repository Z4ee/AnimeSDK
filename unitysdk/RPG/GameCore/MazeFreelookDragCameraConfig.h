...
#define RPG_GAMECORE_MAZEFREELOOKDRAGCAMERACONFIG_METHOD_2_CB2D905488FF5CFD_OFFSET UNITYSDK_OFFSET(0x1D278010)
#define RPG_GAMECORE_MAZEFREELOOKDRAGCAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D27A6E0)
