...
#define RPG_GAMECORE_MAZEFREELOOKDRAGCAMERACONFIG_METHOD_2_CB2D905488FF5CFD_OFFSET UNITYSDK_OFFSET(0x198FEF10)
#define RPG_GAMECORE_MAZEFREELOOKDRAGCAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x199014A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MazeFreelookDragCameraConfig_TypeDefinitionIndex = 16753;
