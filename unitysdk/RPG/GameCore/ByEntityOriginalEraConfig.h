...
#define RPG_GAMECORE_BYENTITYORIGINALERACONFIG_METHOD_4_1765F9201E875351_OFFSET UNITYSDK_OFFSET(0x1BBD8900)
#define RPG_GAMECORE_BYENTITYORIGINALERACONFIG_METHOD_4_4CB63D77556D47EB_OFFSET UNITYSDK_OFFSET(0x1BBD8A80)
#define RPG_GAMECORE_BYENTITYORIGINALERACONFIG_METHOD_4_81F18523203E6084_OFFSET UNITYSDK_OFFSET(0x1BBD8AB0)
#define RPG_GAMECORE_BYENTITYORIGINALERACONFIG_METHOD_4_AD264757BE844D14_OFFSET UNITYSDK_OFFSET(0x1BBD88C0)
#define RPG_GAMECORE_BYENTITYORIGINALERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBD88F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByEntityOriginalEraConfig_TypeDefinitionIndex = 22086;
