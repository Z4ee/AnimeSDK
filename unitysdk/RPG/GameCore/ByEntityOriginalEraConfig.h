...
#define RPG_GAMECORE_BYENTITYORIGINALERACONFIG_METHOD_4_1765F9201E875351_OFFSET UNITYSDK_OFFSET(0x17021A20)
#define RPG_GAMECORE_BYENTITYORIGINALERACONFIG_METHOD_4_D1FF48EB1D9404C7_OFFSET UNITYSDK_OFFSET(0x17021950)
#define RPG_GAMECORE_BYENTITYORIGINALERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x170219D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByEntityOriginalEraConfig_TypeDefinitionIndex = 20530;
