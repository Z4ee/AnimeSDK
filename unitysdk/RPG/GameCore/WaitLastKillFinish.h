...
#define RPG_GAMECORE_WAITLASTKILLFINISH_METHOD_3_2A15689696DD1B3D_OFFSET UNITYSDK_OFFSET(0x178FC850)
#define RPG_GAMECORE_WAITLASTKILLFINISH_METHOD_3_B03D446BEE8A6E49_OFFSET UNITYSDK_OFFSET(0x178FC740)
#define RPG_GAMECORE_WAITLASTKILLFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x178FC820)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitLastKillFinish_TypeDefinitionIndex = 21641;
