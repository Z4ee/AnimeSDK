...
#define RPG_GAMECORE_WAITLASTKILLFINISH_METHOD_3_2A15689696DD1B3D_OFFSET UNITYSDK_OFFSET(0x1D6A5990)
#define RPG_GAMECORE_WAITLASTKILLFINISH_METHOD_3_82AA5FC026574480_OFFSET UNITYSDK_OFFSET(0x1D6A58C0)
#define RPG_GAMECORE_WAITLASTKILLFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6A5980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitLastKillFinish_TypeDefinitionIndex = 23149;
