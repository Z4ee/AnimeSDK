...
#define RPG_GAMECORE_TRIGGERROGUEBUFFSELECT_METHOD_3_65574B95C1FD16D0_OFFSET UNITYSDK_OFFSET(0x178CD580)
#define RPG_GAMECORE_TRIGGERROGUEBUFFSELECT_METHOD_3_91ACE3D6152CCA70_OFFSET UNITYSDK_OFFSET(0x178CD610)
#define RPG_GAMECORE_TRIGGERROGUEBUFFSELECT__CTOR_OFFSET UNITYSDK_OFFSET(0x178CD5E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerRogueBuffSelect_TypeDefinitionIndex = 18777;
