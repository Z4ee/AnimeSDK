...
#define RPG_GAMECORE_SUMMONUNITMOVECONFIG_METHOD_2_6F92C3EC0C18F601_OFFSET UNITYSDK_OFFSET(0x19CD5050)
#define RPG_GAMECORE_SUMMONUNITMOVECONFIG_RPG_GAMECORE_IADVENTURECHARACTERMOVECONFIG_GET_ADVENTURESOMATOTYPE_OFFSET UNITYSDK_OFFSET(0x19CD6EA0)
#define RPG_GAMECORE_SUMMONUNITMOVECONFIG_RPG_GAMECORE_IADVENTURECHARACTERMOVECONFIG_GET_NAVMOVINGSTEERTURNBACKTURNSPEED_OFFSET UNITYSDK_OFFSET(0x19CD6EE0)
#define RPG_GAMECORE_SUMMONUNITMOVECONFIG_RPG_GAMECORE_IADVENTURECHARACTERMOVECONFIG_GET_NAVMOVINGSTEERTURNSPEED_OFFSET UNITYSDK_OFFSET(0x19CD6ED0)
#define RPG_GAMECORE_SUMMONUNITMOVECONFIG_RPG_GAMECORE_IADVENTURECHARACTERMOVECONFIG_GET_NAVTURNBACKTURNSPEED_OFFSET UNITYSDK_OFFSET(0x19CD6EC0)
#define RPG_GAMECORE_SUMMONUNITMOVECONFIG_RPG_GAMECORE_IADVENTURECHARACTERMOVECONFIG_GET_NAVTURNSPEED_OFFSET UNITYSDK_OFFSET(0x19CD6EB0)
#define RPG_GAMECORE_SUMMONUNITMOVECONFIG_RPG_GAMECORE_IADVENTURECHARACTERMOVECONFIG_GET_USENAVJUMPLAYER_OFFSET UNITYSDK_OFFSET(0x19CD6EF0)
#define RPG_GAMECORE_SUMMONUNITMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19CD6E80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SummonUnitMoveConfig_TypeDefinitionIndex = 16719;
