...
#define RPG_GAMECORE_SUMMONUNITMOVECONFIG_METHOD_2_6F92C3EC0C18F601_OFFSET UNITYSDK_OFFSET(0x1B430CA0)
#define RPG_GAMECORE_SUMMONUNITMOVECONFIG_RPG_GAMECORE_IADVENTURECHARACTERMOVECONFIG_GET_ADVENTURESOMATOTYPE_OFFSET UNITYSDK_OFFSET(0x1B432AC0)
#define RPG_GAMECORE_SUMMONUNITMOVECONFIG_RPG_GAMECORE_IADVENTURECHARACTERMOVECONFIG_GET_NAVMOVINGSTEERTURNBACKTURNSPEED_OFFSET UNITYSDK_OFFSET(0x1B432B00)
#define RPG_GAMECORE_SUMMONUNITMOVECONFIG_RPG_GAMECORE_IADVENTURECHARACTERMOVECONFIG_GET_NAVMOVINGSTEERTURNSPEED_OFFSET UNITYSDK_OFFSET(0x1B432AF0)
#define RPG_GAMECORE_SUMMONUNITMOVECONFIG_RPG_GAMECORE_IADVENTURECHARACTERMOVECONFIG_GET_NAVTURNBACKTURNSPEED_OFFSET UNITYSDK_OFFSET(0x1B432AE0)
#define RPG_GAMECORE_SUMMONUNITMOVECONFIG_RPG_GAMECORE_IADVENTURECHARACTERMOVECONFIG_GET_NAVTURNSPEED_OFFSET UNITYSDK_OFFSET(0x1B432AD0)
#define RPG_GAMECORE_SUMMONUNITMOVECONFIG_RPG_GAMECORE_IADVENTURECHARACTERMOVECONFIG_GET_USENAVJUMPLAYER_OFFSET UNITYSDK_OFFSET(0x1B432B10)
#define RPG_GAMECORE_SUMMONUNITMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B432AA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SummonUnitMoveConfig_TypeDefinitionIndex = 16881;
