...
#define RPG_GAMECORE_SETDYNAMICVALUECURRENTSKILLUSEPARAM_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1D4F9B70)
#define RPG_GAMECORE_SETDYNAMICVALUECURRENTSKILLUSEPARAM_METHOD_4_1D607E84D7477DFB_OFFSET UNITYSDK_OFFSET(0x1D4F9A00)
#define RPG_GAMECORE_SETDYNAMICVALUECURRENTSKILLUSEPARAM_METHOD_4_C8A5E51EF86162F4_OFFSET UNITYSDK_OFFSET(0x1D4F99C0)
#define RPG_GAMECORE_SETDYNAMICVALUECURRENTSKILLUSEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4F99F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueCurrentSkillUseParam_TypeDefinitionIndex = 22517;
