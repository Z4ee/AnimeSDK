...
#define RPG_GAMECORE_SETDYNAMICVALUECURRENTSKILLUSEPARAM_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x18E2BBA0)
#define RPG_GAMECORE_SETDYNAMICVALUECURRENTSKILLUSEPARAM_METHOD_4_1D607E84D7477DFB_OFFSET UNITYSDK_OFFSET(0x18E2BA30)
#define RPG_GAMECORE_SETDYNAMICVALUECURRENTSKILLUSEPARAM_METHOD_4_1F0FE68C76115F86_OFFSET UNITYSDK_OFFSET(0x18E2B960)
#define RPG_GAMECORE_SETDYNAMICVALUECURRENTSKILLUSEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x18E2B9E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueCurrentSkillUseParam_TypeDefinitionIndex = 21678;
