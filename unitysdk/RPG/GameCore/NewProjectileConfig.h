...
#define RPG_GAMECORE_NEWPROJECTILECONFIG_METHOD_2_1FDD6AE005C7BFF6_OFFSET UNITYSDK_OFFSET(0x199CCBA0)
#define RPG_GAMECORE_NEWPROJECTILECONFIG_METHOD_2_9CDE6A8A9A441772_OFFSET UNITYSDK_OFFSET(0x199CE0F0)
#define RPG_GAMECORE_NEWPROJECTILECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x199CE050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NewProjectileConfig_TypeDefinitionIndex = 14885;
