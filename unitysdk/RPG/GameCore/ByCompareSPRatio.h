...
#define RPG_GAMECORE_BYCOMPARESPRATIO_METHOD_4_6C537CDD615403F4_OFFSET UNITYSDK_OFFSET(0x18739ED0)
#define RPG_GAMECORE_BYCOMPARESPRATIO_METHOD_4_F375440F2DC42FF6_OFFSET UNITYSDK_OFFSET(0x18739FA0)
#define RPG_GAMECORE_BYCOMPARESPRATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x18739F50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareSPRatio_TypeDefinitionIndex = 21919;
