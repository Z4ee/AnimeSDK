...
#define RPG_GAMECORE_SAVEMESSAGE_METHOD_3_5126076E00495685_OFFSET UNITYSDK_OFFSET(0x19C1C2F0)
#define RPG_GAMECORE_SAVEMESSAGE_METHOD_3_A4331D6A922EFAC4_OFFSET UNITYSDK_OFFSET(0x19C1C370)
#define RPG_GAMECORE_SAVEMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C1C340)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SaveMessage_TypeDefinitionIndex = 19695;
