...
#define RPG_GAMECORE_SAVEMESSAGE_METHOD_3_5126076E00495685_OFFSET UNITYSDK_OFFSET(0x18DFD1D0)
#define RPG_GAMECORE_SAVEMESSAGE_METHOD_3_A4331D6A922EFAC4_OFFSET UNITYSDK_OFFSET(0x18DFD250)
#define RPG_GAMECORE_SAVEMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x18DFD220)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SaveMessage_TypeDefinitionIndex = 19822;
