...
#define RPG_GAMECORE_MARBLESIMULATELISTENER_METHOD_3_2F63CF2D4E6FB58A_OFFSET UNITYSDK_OFFSET(0x1739A330)
#define RPG_GAMECORE_MARBLESIMULATELISTENER_METHOD_3_750E9825D909BCE3_OFFSET UNITYSDK_OFFSET(0x1739A2B0)
#define RPG_GAMECORE_MARBLESIMULATELISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1739A300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleSimulateListener_TypeDefinitionIndex = 22337;
