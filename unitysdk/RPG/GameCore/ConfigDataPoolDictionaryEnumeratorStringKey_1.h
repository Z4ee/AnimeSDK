...
{
	inline static constexpr unsigned int ConfigDataPoolDictionaryEnumeratorStringKey_1_TypeDefinitionIndex = 10398;

	template <typename TValue>
	struct ConfigDataPoolDictionaryEnumeratorStringKey_1
	{
