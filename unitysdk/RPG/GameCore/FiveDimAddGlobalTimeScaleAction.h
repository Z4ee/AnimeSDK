...
#define RPG_GAMECORE_FIVEDIMADDGLOBALTIMESCALEACTION_METHOD_3_02A4BD48335192B3_OFFSET UNITYSDK_OFFSET(0x188EA510)
#define RPG_GAMECORE_FIVEDIMADDGLOBALTIMESCALEACTION_METHOD_3_A056AB5D12A76D98_OFFSET UNITYSDK_OFFSET(0x188EA4A0)
#define RPG_GAMECORE_FIVEDIMADDGLOBALTIMESCALEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x188EA4F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimAddGlobalTimeScaleAction_TypeDefinitionIndex = 17736;
