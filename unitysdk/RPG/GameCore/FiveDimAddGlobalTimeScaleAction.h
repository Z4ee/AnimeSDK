...
#define RPG_GAMECORE_FIVEDIMADDGLOBALTIMESCALEACTION_METHOD_3_02A4BD48335192B3_OFFSET UNITYSDK_OFFSET(0x1BA86B50)
#define RPG_GAMECORE_FIVEDIMADDGLOBALTIMESCALEACTION_METHOD_3_8932AFDA807151A2_OFFSET UNITYSDK_OFFSET(0x1BA86B10)
#define RPG_GAMECORE_FIVEDIMADDGLOBALTIMESCALEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA86B40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimAddGlobalTimeScaleAction_TypeDefinitionIndex = 17939;
