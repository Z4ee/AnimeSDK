...
#define RPG_GAMECORE_BGCURVEWITHDETECTPROJECTILEDATA_METHOD_3_24A4CEF664331574_OFFSET UNITYSDK_OFFSET(0x1A3D9740)
#define RPG_GAMECORE_BGCURVEWITHDETECTPROJECTILEDATA_METHOD_3_623907DCD0CE9BCB_OFFSET UNITYSDK_OFFSET(0x1A3D9620)
#define RPG_GAMECORE_BGCURVEWITHDETECTPROJECTILEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3D96C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BGCurveWithDetectProjectileData_TypeDefinitionIndex = 15061;
