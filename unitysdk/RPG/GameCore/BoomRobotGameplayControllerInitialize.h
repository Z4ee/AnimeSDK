...
#define RPG_GAMECORE_BOOMROBOTGAMEPLAYCONTROLLERINITIALIZE_METHOD_3_94A0B25051E74901_OFFSET UNITYSDK_OFFSET(0x16FEF180)
#define RPG_GAMECORE_BOOMROBOTGAMEPLAYCONTROLLERINITIALIZE_METHOD_3_E2EAC38A6877A52F_OFFSET UNITYSDK_OFFSET(0x16FEF200)
#define RPG_GAMECORE_BOOMROBOTGAMEPLAYCONTROLLERINITIALIZE__CTOR_OFFSET UNITYSDK_OFFSET(0x16FEF1D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BoomRobotGameplayControllerInitialize_TypeDefinitionIndex = 19485;
