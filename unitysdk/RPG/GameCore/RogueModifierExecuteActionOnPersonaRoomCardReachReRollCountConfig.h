...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONAROOMCARDREACHREROLLCOUNTCONFIG_METHOD_3_6CC095AA50FF0D1B_OFFSET UNITYSDK_OFFSET(0x1CFC0B50)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONAROOMCARDREACHREROLLCOUNTCONFIG_METHOD_3_F24C7698EFA61FB7_OFFSET UNITYSDK_OFFSET(0x1CFC0B00)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONAROOMCARDREACHREROLLCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFC0B40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnPersonaRoomCardReachReRollCountConfig_TypeDefinitionIndex = 17135;
