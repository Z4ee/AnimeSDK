...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONAROOMCARDREACHREROLLCOUNTCONFIG_METHOD_3_6CC095AA50FF0D1B_OFFSET UNITYSDK_OFFSET(0x18D3DFC0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONAROOMCARDREACHREROLLCOUNTCONFIG_METHOD_3_B6031DC65C533F82_OFFSET UNITYSDK_OFFSET(0x18D3DEF0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONAROOMCARDREACHREROLLCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D3DF70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnPersonaRoomCardReachReRollCountConfig_TypeDefinitionIndex = 16958;
