...
#define RPG_GAMECORE_ROGUEMODIFIERENABLEADVENTUREROOMEXTRAGROUPCONFIG_METHOD_3_7D16C04C2CECF45B_OFFSET UNITYSDK_OFFSET(0x18D33E60)
#define RPG_GAMECORE_ROGUEMODIFIERENABLEADVENTUREROOMEXTRAGROUPCONFIG_METHOD_3_C2C138DF16C055C2_OFFSET UNITYSDK_OFFSET(0x18D3C170)
#define RPG_GAMECORE_ROGUEMODIFIERENABLEADVENTUREROOMEXTRAGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D33E10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierEnableAdventureRoomExtraGroupConfig_TypeDefinitionIndex = 17050;
