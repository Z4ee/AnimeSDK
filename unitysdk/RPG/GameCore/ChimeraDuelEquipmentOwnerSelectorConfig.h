...
#define RPG_GAMECORE_CHIMERADUELEQUIPMENTOWNERSELECTORCONFIG_METHOD_3_0B277CA1945401A6_OFFSET UNITYSDK_OFFSET(0x1709B7B0)
#define RPG_GAMECORE_CHIMERADUELEQUIPMENTOWNERSELECTORCONFIG_METHOD_3_A5F460E2C5CD8F17_OFFSET UNITYSDK_OFFSET(0x1709B850)
#define RPG_GAMECORE_CHIMERADUELEQUIPMENTOWNERSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1709B840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelEquipmentOwnerSelectorConfig_TypeDefinitionIndex = 14607;
