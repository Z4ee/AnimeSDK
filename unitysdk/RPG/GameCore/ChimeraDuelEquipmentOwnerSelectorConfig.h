...
#define RPG_GAMECORE_CHIMERADUELEQUIPMENTOWNERSELECTORCONFIG_METHOD_3_0B277CA1945401A6_OFFSET UNITYSDK_OFFSET(0x1C23E6A0)
#define RPG_GAMECORE_CHIMERADUELEQUIPMENTOWNERSELECTORCONFIG_METHOD_3_A5F460E2C5CD8F17_OFFSET UNITYSDK_OFFSET(0x1C23E740)
#define RPG_GAMECORE_CHIMERADUELEQUIPMENTOWNERSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C23E730)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelEquipmentOwnerSelectorConfig_TypeDefinitionIndex = 15304;
