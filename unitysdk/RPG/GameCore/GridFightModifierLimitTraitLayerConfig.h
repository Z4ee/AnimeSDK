...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERLIMITTRAITLAYERCONFIG_METHOD_3_6896955A23187E46_OFFSET UNITYSDK_OFFSET(0x189BD870)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERLIMITTRAITLAYERCONFIG_METHOD_3_FFFDC62F7EE95AEF_OFFSET UNITYSDK_OFFSET(0x189BD7A0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERLIMITTRAITLAYERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189BD820)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierLimitTraitLayerConfig_TypeDefinitionIndex = 18389;
