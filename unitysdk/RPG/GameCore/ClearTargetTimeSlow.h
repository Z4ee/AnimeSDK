...
#define RPG_GAMECORE_CLEARTARGETTIMESLOW_METHOD_3_2BD7189D5797747F_OFFSET UNITYSDK_OFFSET(0x18812C80)
#define RPG_GAMECORE_CLEARTARGETTIMESLOW_METHOD_3_6B72669ACF98E170_OFFSET UNITYSDK_OFFSET(0x18812D00)
#define RPG_GAMECORE_CLEARTARGETTIMESLOW__CTOR_OFFSET UNITYSDK_OFFSET(0x18812CD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClearTargetTimeSlow_TypeDefinitionIndex = 21568;
