...
#define RPG_GAMECORE_CLEARTARGETTIMESLOW_METHOD_3_2BD7189D5797747F_OFFSET UNITYSDK_OFFSET(0x170B3700)
#define RPG_GAMECORE_CLEARTARGETTIMESLOW_METHOD_3_6B72669ACF98E170_OFFSET UNITYSDK_OFFSET(0x170B3780)
#define RPG_GAMECORE_CLEARTARGETTIMESLOW__CTOR_OFFSET UNITYSDK_OFFSET(0x170B3750)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClearTargetTimeSlow_TypeDefinitionIndex = 20857;
