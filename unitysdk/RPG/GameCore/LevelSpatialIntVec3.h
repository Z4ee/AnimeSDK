...
#define RPG_GAMECORE_LEVELSPATIALINTVEC3_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1DD587D0)
#define RPG_GAMECORE_LEVELSPATIALINTVEC3__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD589B0)
