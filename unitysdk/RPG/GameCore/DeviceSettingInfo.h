...
#define RPG_GAMECORE_DEVICESETTINGINFO_METHOD_2_BB2755C35E17CDD0_OFFSET UNITYSDK_OFFSET(0x1D81AFD0)
#define RPG_GAMECORE_DEVICESETTINGINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D81B1D0)
