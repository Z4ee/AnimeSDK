...
#define RPG_GAMECORE_SHOWOFFERINGCLOCKIEUPGRADEHINT_METHOD_3_28004F8D694353BB_OFFSET UNITYSDK_OFFSET(0x177009B0)
#define RPG_GAMECORE_SHOWOFFERINGCLOCKIEUPGRADEHINT_METHOD_3_FC36E18F5E0E2154_OFFSET UNITYSDK_OFFSET(0x17700A30)
#define RPG_GAMECORE_SHOWOFFERINGCLOCKIEUPGRADEHINT__CTOR_OFFSET UNITYSDK_OFFSET(0x17700A00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowOfferingClockieUpgradeHint_TypeDefinitionIndex = 20113;
