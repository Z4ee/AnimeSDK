...
#define RPG_GAMECORE_REBUILDTIMEREWINDENTITY_METHOD_3_6E03D5179536C275_OFFSET UNITYSDK_OFFSET(0x17584090)
#define RPG_GAMECORE_REBUILDTIMEREWINDENTITY_METHOD_3_807A2287273E3F44_OFFSET UNITYSDK_OFFSET(0x17584110)
#define RPG_GAMECORE_REBUILDTIMEREWINDENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x175840E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RebuildTimeRewindEntity_TypeDefinitionIndex = 18954;
