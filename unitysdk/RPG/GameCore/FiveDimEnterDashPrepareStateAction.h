...
#define RPG_GAMECORE_FIVEDIMENTERDASHPREPARESTATEACTION_METHOD_3_36EF6A85E206F204_OFFSET UNITYSDK_OFFSET(0x1972E450)
#define RPG_GAMECORE_FIVEDIMENTERDASHPREPARESTATEACTION_METHOD_3_72F4CFDDC773D75D_OFFSET UNITYSDK_OFFSET(0x1973ABA0)
#define RPG_GAMECORE_FIVEDIMENTERDASHPREPARESTATEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1972E430)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimEnterDashPrepareStateAction_TypeDefinitionIndex = 17829;
