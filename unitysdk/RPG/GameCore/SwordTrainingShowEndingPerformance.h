...
#define RPG_GAMECORE_SWORDTRAININGSHOWENDINGPERFORMANCE_METHOD_3_5BC0F045C29EB814_OFFSET UNITYSDK_OFFSET(0x177A02D0)
#define RPG_GAMECORE_SWORDTRAININGSHOWENDINGPERFORMANCE_METHOD_3_FBE8C980CD34B0A4_OFFSET UNITYSDK_OFFSET(0x177A0350)
#define RPG_GAMECORE_SWORDTRAININGSHOWENDINGPERFORMANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x177A0320)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwordTrainingShowEndingPerformance_TypeDefinitionIndex = 18613;
