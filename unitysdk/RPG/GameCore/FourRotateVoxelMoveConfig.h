...
#define RPG_GAMECORE_FOURROTATEVOXELMOVECONFIG_METHOD_2_6A9E1BD291041AAF_OFFSET UNITYSDK_OFFSET(0x1892E4D0)
#define RPG_GAMECORE_FOURROTATEVOXELMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1892FC80)
