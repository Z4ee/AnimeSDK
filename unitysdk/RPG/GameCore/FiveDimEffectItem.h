...
#define RPG_GAMECORE_FIVEDIMEFFECTITEM_METHOD_2_85C8FED0123D1481_OFFSET UNITYSDK_OFFSET(0x1BA8EB70)
#define RPG_GAMECORE_FIVEDIMEFFECTITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA92B20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimEffectItem_TypeDefinitionIndex = 16011;
