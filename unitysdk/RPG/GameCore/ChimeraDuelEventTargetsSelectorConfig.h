...
#define RPG_GAMECORE_CHIMERADUELEVENTTARGETSSELECTORCONFIG_METHOD_3_7977F2CD06ECDD5D_OFFSET UNITYSDK_OFFSET(0x1709BBC0)
#define RPG_GAMECORE_CHIMERADUELEVENTTARGETSSELECTORCONFIG_METHOD_3_CFDD50E219547178_OFFSET UNITYSDK_OFFSET(0x1709BC60)
#define RPG_GAMECORE_CHIMERADUELEVENTTARGETSSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1709BC50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelEventTargetsSelectorConfig_TypeDefinitionIndex = 14602;
