...
#define RPG_GAMECORE_CHIMERADUELEVENTTARGETSSELECTORCONFIG_METHOD_3_7977F2CD06ECDD5D_OFFSET UNITYSDK_OFFSET(0x1C23EAA0)
#define RPG_GAMECORE_CHIMERADUELEVENTTARGETSSELECTORCONFIG_METHOD_3_CFDD50E219547178_OFFSET UNITYSDK_OFFSET(0x1C23EB40)
#define RPG_GAMECORE_CHIMERADUELEVENTTARGETSSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C23EB30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelEventTargetsSelectorConfig_TypeDefinitionIndex = 15299;
