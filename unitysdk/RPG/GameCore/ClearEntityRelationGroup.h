...
#define RPG_GAMECORE_CLEARENTITYRELATIONGROUP_METHOD_3_4D39AF54D2C868D1_OFFSET UNITYSDK_OFFSET(0x1C253DA0)
#define RPG_GAMECORE_CLEARENTITYRELATIONGROUP_METHOD_3_804FDE90A7A254F2_OFFSET UNITYSDK_OFFSET(0x1C253DE0)
#define RPG_GAMECORE_CLEARENTITYRELATIONGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1C253DD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClearEntityRelationGroup_TypeDefinitionIndex = 22005;
