...
#define RPG_GAMECORE_CLEARENTITYRELATIONGROUP_METHOD_3_4092FAE14C9D1641_OFFSET UNITYSDK_OFFSET(0x188119A0)
#define RPG_GAMECORE_CLEARENTITYRELATIONGROUP_METHOD_3_804FDE90A7A254F2_OFFSET UNITYSDK_OFFSET(0x18811A20)
#define RPG_GAMECORE_CLEARENTITYRELATIONGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x188119F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClearEntityRelationGroup_TypeDefinitionIndex = 21739;
