...
#define RPG_GAMECORE_FOURROTATEVOXELENTITYSTATECONFIG_METHOD_3_2D7F45CD66CF8A38_OFFSET UNITYSDK_OFFSET(0x1721B000)
#define RPG_GAMECORE_FOURROTATEVOXELENTITYSTATECONFIG_METHOD_3_38127E644AB1C265_OFFSET UNITYSDK_OFFSET(0x1721AF90)
#define RPG_GAMECORE_FOURROTATEVOXELENTITYSTATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1721AFE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FourRotateVoxelEntityStateConfig_TypeDefinitionIndex = 15364;
