...
#define RPG_GAMECORE_FOURROTATEVOXELENTITYSTATECONFIG_METHOD_3_2D7F45CD66CF8A38_OFFSET UNITYSDK_OFFSET(0x1892D610)
#define RPG_GAMECORE_FOURROTATEVOXELENTITYSTATECONFIG_METHOD_3_38127E644AB1C265_OFFSET UNITYSDK_OFFSET(0x1892D5A0)
#define RPG_GAMECORE_FOURROTATEVOXELENTITYSTATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1892D5F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FourRotateVoxelEntityStateConfig_TypeDefinitionIndex = 15884;
