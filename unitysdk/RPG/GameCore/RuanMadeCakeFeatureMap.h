...
#define RPG_GAMECORE_RUANMADECAKEFEATUREMAP_METHOD_2_979ED58C3E9AD8AB_OFFSET UNITYSDK_OFFSET(0x1D4B9370)
#define RPG_GAMECORE_RUANMADECAKEFEATUREMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4B9450)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RuanMadeCakeFeatureMap_TypeDefinitionIndex = 17272;
