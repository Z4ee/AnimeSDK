...
#define RPG_GAMECORE_ACHIEVEMENTWAITTIME_METHOD_3_819F2AA6F1D6F72F_OFFSET UNITYSDK_OFFSET(0x16E97F80)
#define RPG_GAMECORE_ACHIEVEMENTWAITTIME_METHOD_3_8F7DB410C408A8B6_OFFSET UNITYSDK_OFFSET(0x16E98000)
#define RPG_GAMECORE_ACHIEVEMENTWAITTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x16E97FD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AchievementWaitTime_TypeDefinitionIndex = 19366;
