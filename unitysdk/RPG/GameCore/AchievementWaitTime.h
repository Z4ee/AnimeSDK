...
#define RPG_GAMECORE_ACHIEVEMENTWAITTIME_METHOD_3_7ABF897FB14CEEE7_OFFSET UNITYSDK_OFFSET(0x1C9E4360)
#define RPG_GAMECORE_ACHIEVEMENTWAITTIME_METHOD_3_8F7DB410C408A8B6_OFFSET UNITYSDK_OFFSET(0x1C9E43A0)
#define RPG_GAMECORE_ACHIEVEMENTWAITTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9E4390)
