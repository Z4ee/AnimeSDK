...
#define RPG_GAMECORE_FOURROTATEVOXELMOVEABLEPLATFORMCONFIG_METHOD_3_46B598551014C244_OFFSET UNITYSDK_OFFSET(0x1892FD10)
#define RPG_GAMECORE_FOURROTATEVOXELMOVEABLEPLATFORMCONFIG_METHOD_3_F67317016B65DDB4_OFFSET UNITYSDK_OFFSET(0x1892FCA0)
#define RPG_GAMECORE_FOURROTATEVOXELMOVEABLEPLATFORMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1892FCF0)
