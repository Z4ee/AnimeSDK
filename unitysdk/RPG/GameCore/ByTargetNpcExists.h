...
#define RPG_GAMECORE_BYTARGETNPCEXISTS_METHOD_4_05B2DD96C586534C_OFFSET UNITYSDK_OFFSET(0x1CDCAD90)
#define RPG_GAMECORE_BYTARGETNPCEXISTS_METHOD_4_453AF4C31EAEB7EB_OFFSET UNITYSDK_OFFSET(0x1CDCAF40)
#define RPG_GAMECORE_BYTARGETNPCEXISTS_METHOD_4_7A763C6EE97FD084_OFFSET UNITYSDK_OFFSET(0x1CDCAF70)
#define RPG_GAMECORE_BYTARGETNPCEXISTS_METHOD_4_C2B932ED20111539_OFFSET UNITYSDK_OFFSET(0x1CDCAD50)
#define RPG_GAMECORE_BYTARGETNPCEXISTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDCAD80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByTargetNpcExists_TypeDefinitionIndex = 21431;
