...
#define RPG_GAMECORE_BYTARGETNPCEXISTS_METHOD_4_05B2DD96C586534C_OFFSET UNITYSDK_OFFSET(0x1703DB20)
#define RPG_GAMECORE_BYTARGETNPCEXISTS_METHOD_4_0F60363FD1AA47D2_OFFSET UNITYSDK_OFFSET(0x1703DA50)
#define RPG_GAMECORE_BYTARGETNPCEXISTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1703DAD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByTargetNpcExists_TypeDefinitionIndex = 19843;
