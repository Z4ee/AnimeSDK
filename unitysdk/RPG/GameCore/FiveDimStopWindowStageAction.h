...
#define RPG_GAMECORE_FIVEDIMSTOPWINDOWSTAGEACTION_METHOD_3_3DD2AC4EC7A8E101_OFFSET UNITYSDK_OFFSET(0x189209A0)
#define RPG_GAMECORE_FIVEDIMSTOPWINDOWSTAGEACTION_METHOD_3_C8C2A75393B0DE00_OFFSET UNITYSDK_OFFSET(0x18920A60)
#define RPG_GAMECORE_FIVEDIMSTOPWINDOWSTAGEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18920A40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimStopWindowStageAction_TypeDefinitionIndex = 17787;
