...
#define RPG_GAMECORE_TRIGGERSKIPDEADHANDLER_METHOD_3_146D805F58D71A08_OFFSET UNITYSDK_OFFSET(0x178CE200)
#define RPG_GAMECORE_TRIGGERSKIPDEADHANDLER_METHOD_3_32B5E7BFC8A5743C_OFFSET UNITYSDK_OFFSET(0x178CE0F0)
#define RPG_GAMECORE_TRIGGERSKIPDEADHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x178CE1D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerSkipDeadHandler_TypeDefinitionIndex = 20686;
