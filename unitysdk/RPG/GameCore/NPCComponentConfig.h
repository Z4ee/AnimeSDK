...
#define RPG_GAMECORE_NPCCOMPONENTCONFIG_METHOD_3_1F55C4449312A662_OFFSET UNITYSDK_OFFSET(0x1746AFB0)
#define RPG_GAMECORE_NPCCOMPONENTCONFIG_METHOD_3_BD4A19436BEAECE3_OFFSET UNITYSDK_OFFSET(0x1746AF10)
#define RPG_GAMECORE_NPCCOMPONENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1746AFA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NPCComponentConfig_TypeDefinitionIndex = 15171;
