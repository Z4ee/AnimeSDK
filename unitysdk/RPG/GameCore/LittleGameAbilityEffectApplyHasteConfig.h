...
#define RPG_GAMECORE_LITTLEGAMEABILITYEFFECTAPPLYHASTECONFIG_METHOD_3_13BB9B9D225F45E7_OFFSET UNITYSDK_OFFSET(0x1D1F8EF0)
#define RPG_GAMECORE_LITTLEGAMEABILITYEFFECTAPPLYHASTECONFIG_METHOD_3_1EEE31AE68EDA0DB_OFFSET UNITYSDK_OFFSET(0x1D1F8FC0)
#define RPG_GAMECORE_LITTLEGAMEABILITYEFFECTAPPLYHASTECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1F8FB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityEffectApplyHasteConfig_TypeDefinitionIndex = 21095;
