...
#define RPG_GAMECORE_ADVENTUREAIDEFAULTPARAMETER_METHOD_2_715822110F6185CE_OFFSET UNITYSDK_OFFSET(0x1AE4B0B0)
#define RPG_GAMECORE_ADVENTUREAIDEFAULTPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE4B330)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureAIDefaultParameter_TypeDefinitionIndex = 14872;
