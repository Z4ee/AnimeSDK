...
#define RPG_GAMECORE_CHIMERAABILITYMODIFIERPARAM_METHOD_2_B97CD17491174947_OFFSET UNITYSDK_OFFSET(0x187F1A60)
#define RPG_GAMECORE_CHIMERAABILITYMODIFIERPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x187F1BC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraAbilityModifierParam_TypeDefinitionIndex = 15007;
