...
#define RPG_GAMECORE_CHIMERAABILITYMODIFIERPARAM_METHOD_2_B97CD17491174947_OFFSET UNITYSDK_OFFSET(0x1CFBC3F0)
#define RPG_GAMECORE_CHIMERAABILITYMODIFIERPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFBC540)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraAbilityModifierParam_TypeDefinitionIndex = 15671;
