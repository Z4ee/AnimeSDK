...
#define RPG_GAMECORE_REDUCESTANCERATIO_METHOD_3_329734278FBD467C_OFFSET UNITYSDK_OFFSET(0x18C94620)
#define RPG_GAMECORE_REDUCESTANCERATIO_METHOD_3_99FC259B954987C1_OFFSET UNITYSDK_OFFSET(0x18C94590)
#define RPG_GAMECORE_REDUCESTANCERATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x18C945F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ReduceStanceRatio_TypeDefinitionIndex = 22542;
