...
#define RPG_GAMECORE_THREADTASKCONFIG_METHOD_2_183B1B91442726DB_OFFSET UNITYSDK_OFFSET(0x1D5CCC50)
#define RPG_GAMECORE_THREADTASKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5CCE10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ThreadTaskConfig_TypeDefinitionIndex = 24123;
