...
#define RPG_GAMECORE_THREADTASKCONFIG_METHOD_2_183B1B91442726DB_OFFSET UNITYSDK_OFFSET(0x1E1D55A0)
#define RPG_GAMECORE_THREADTASKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1D5760)
