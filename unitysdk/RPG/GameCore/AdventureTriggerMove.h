...
#define RPG_GAMECORE_ADVENTURETRIGGERMOVE_METHOD_3_6BAF0F94EFFC1CDA_OFFSET UNITYSDK_OFFSET(0x194561F0)
#define RPG_GAMECORE_ADVENTURETRIGGERMOVE_METHOD_3_F6189DB2FDF0EDAE_OFFSET UNITYSDK_OFFSET(0x19455F20)
#define RPG_GAMECORE_ADVENTURETRIGGERMOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x19456170)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureTriggerMove_TypeDefinitionIndex = 19051;
