...
#define RPG_GAMECORE_BASECHENLINGBATTLEPREDICATE_METHOD_2_94B0A900FA9DBA4F_OFFSET UNITYSDK_OFFSET(0x194BB480)
#define RPG_GAMECORE_BASECHENLINGBATTLEPREDICATE_METHOD_2_B1DCF49F679F5BD1_OFFSET UNITYSDK_OFFSET(0x194BB1D0)
#define RPG_GAMECORE_BASECHENLINGBATTLEPREDICATE__CTOR_OFFSET UNITYSDK_OFFSET(0x194BB4E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BaseChenLingBattlePredicate_TypeDefinitionIndex = 15036;
