...
#define RPG_GAMECORE_BASECHENLINGBATTLEPREDICATE_METHOD_2_94B0A900FA9DBA4F_OFFSET UNITYSDK_OFFSET(0x16FC4B50)
#define RPG_GAMECORE_BASECHENLINGBATTLEPREDICATE_METHOD_2_B1DCF49F679F5BD1_OFFSET UNITYSDK_OFFSET(0x16FC47C0)
#define RPG_GAMECORE_BASECHENLINGBATTLEPREDICATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16FC4BB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BaseChenLingBattlePredicate_TypeDefinitionIndex = 14503;
