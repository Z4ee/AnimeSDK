...
#define RPG_GAMECORE_BASECHENLINGBATTLEPREDICATE_METHOD_2_94B0A900FA9DBA4F_OFFSET UNITYSDK_OFFSET(0x1A3DD950)
#define RPG_GAMECORE_BASECHENLINGBATTLEPREDICATE_METHOD_2_B1DCF49F679F5BD1_OFFSET UNITYSDK_OFFSET(0x1A3DD6A0)
#define RPG_GAMECORE_BASECHENLINGBATTLEPREDICATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3DD9B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BaseChenLingBattlePredicate_TypeDefinitionIndex = 15200;
