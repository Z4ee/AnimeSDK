...
#define RPG_GAMECORE_WOLFBROUSEBULLETHITTARGET_METHOD_3_6F8A5DCCD8F3DC3C_OFFSET UNITYSDK_OFFSET(0x1790D500)
#define RPG_GAMECORE_WOLFBROUSEBULLETHITTARGET_METHOD_3_95FB28297BFF4898_OFFSET UNITYSDK_OFFSET(0x1790D400)
#define RPG_GAMECORE_WOLFBROUSEBULLETHITTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1790D490)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WolfBroUseBulletHitTarget_TypeDefinitionIndex = 18453;
