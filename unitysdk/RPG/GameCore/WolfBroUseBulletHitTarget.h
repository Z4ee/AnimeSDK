...
#define RPG_GAMECORE_WOLFBROUSEBULLETHITTARGET_METHOD_3_4B9E14B987C3949B_OFFSET UNITYSDK_OFFSET(0x1EFA9470)
#define RPG_GAMECORE_WOLFBROUSEBULLETHITTARGET_METHOD_3_6F8A5DCCD8F3DC3C_OFFSET UNITYSDK_OFFSET(0x1EFA9530)
#define RPG_GAMECORE_WOLFBROUSEBULLETHITTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFA94E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WolfBroUseBulletHitTarget_TypeDefinitionIndex = 19936;
