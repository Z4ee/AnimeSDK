...
#define RPG_GAMECORE_ROGUEACTADDMAZEBUFFCONFIG_METHOD_6_82F1520AE10EF939_OFFSET UNITYSDK_OFFSET(0x19AE12D0)
#define RPG_GAMECORE_ROGUEACTADDMAZEBUFFCONFIG_METHOD_6_B1D7CE8EFFAE4AC4_OFFSET UNITYSDK_OFFSET(0x19AE10B0)
#define RPG_GAMECORE_ROGUEACTADDMAZEBUFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AE11F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActAddMazeBuffConfig_TypeDefinitionIndex = 18595;
