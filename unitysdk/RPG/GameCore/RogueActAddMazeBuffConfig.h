...
#define RPG_GAMECORE_ROGUEACTADDMAZEBUFFCONFIG_METHOD_6_82F1520AE10EF939_OFFSET UNITYSDK_OFFSET(0x18CBCEC0)
#define RPG_GAMECORE_ROGUEACTADDMAZEBUFFCONFIG_METHOD_6_B1D7CE8EFFAE4AC4_OFFSET UNITYSDK_OFFSET(0x18CBCCA0)
#define RPG_GAMECORE_ROGUEACTADDMAZEBUFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CBCDE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActAddMazeBuffConfig_TypeDefinitionIndex = 18628;
