...
#define RPG_GAMECORE_FIVEDIMPLAYUSEPROPANIMACTION_METHOD_3_76E22DFB2C696660_OFFSET UNITYSDK_OFFSET(0x1974C8B0)
#define RPG_GAMECORE_FIVEDIMPLAYUSEPROPANIMACTION_METHOD_3_A72E54BFA138F245_OFFSET UNITYSDK_OFFSET(0x197311B0)
#define RPG_GAMECORE_FIVEDIMPLAYUSEPROPANIMACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19731190)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimPlayUsePropAnimAction_TypeDefinitionIndex = 17819;
