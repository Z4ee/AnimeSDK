...
#define RPG_GAMECORE_ENABLESTORYWIN_METHOD_3_4AB0694A947F62E4_OFFSET UNITYSDK_OFFSET(0x1719A720)
#define RPG_GAMECORE_ENABLESTORYWIN_METHOD_3_F513D492379B2815_OFFSET UNITYSDK_OFFSET(0x1719A6A0)
#define RPG_GAMECORE_ENABLESTORYWIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1719A6F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnableStoryWin_TypeDefinitionIndex = 21549;
