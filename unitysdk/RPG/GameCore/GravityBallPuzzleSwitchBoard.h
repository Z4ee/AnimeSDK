...
#define RPG_GAMECORE_GRAVITYBALLPUZZLESWITCHBOARD_METHOD_3_DFD79327ACC713ED_OFFSET UNITYSDK_OFFSET(0x1724D1A0)
#define RPG_GAMECORE_GRAVITYBALLPUZZLESWITCHBOARD_METHOD_3_FABD99BA6A85B174_OFFSET UNITYSDK_OFFSET(0x1724D2C0)
#define RPG_GAMECORE_GRAVITYBALLPUZZLESWITCHBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x1724D240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GravityBallPuzzleSwitchBoard_TypeDefinitionIndex = 18671;
