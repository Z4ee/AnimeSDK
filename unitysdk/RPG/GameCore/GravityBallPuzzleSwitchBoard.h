...
#define RPG_GAMECORE_GRAVITYBALLPUZZLESWITCHBOARD_METHOD_3_DFD79327ACC713ED_OFFSET UNITYSDK_OFFSET(0x1899C950)
#define RPG_GAMECORE_GRAVITYBALLPUZZLESWITCHBOARD_METHOD_3_FABD99BA6A85B174_OFFSET UNITYSDK_OFFSET(0x1899CA70)
#define RPG_GAMECORE_GRAVITYBALLPUZZLESWITCHBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x1899C9F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GravityBallPuzzleSwitchBoard_TypeDefinitionIndex = 19328;
