...
#define RPG_GAMECORE_GRAVITYBALLPUZZLESWITCHBOARD_METHOD_3_DE0792828702A764_OFFSET UNITYSDK_OFFSET(0x1D149050)
#define RPG_GAMECORE_GRAVITYBALLPUZZLESWITCHBOARD_METHOD_3_FABD99BA6A85B174_OFFSET UNITYSDK_OFFSET(0x1D149150)
#define RPG_GAMECORE_GRAVITYBALLPUZZLESWITCHBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1490E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GravityBallPuzzleSwitchBoard_TypeDefinitionIndex = 20141;
