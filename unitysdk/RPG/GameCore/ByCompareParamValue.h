...
#define RPG_GAMECORE_BYCOMPAREPARAMVALUE_METHOD_4_103A45A504D4ED46_OFFSET UNITYSDK_OFFSET(0x18735D40)
#define RPG_GAMECORE_BYCOMPAREPARAMVALUE_METHOD_4_25EADCE4363C9E04_OFFSET UNITYSDK_OFFSET(0x18735C60)
#define RPG_GAMECORE_BYCOMPAREPARAMVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x18735CE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareParamValue_TypeDefinitionIndex = 22503;
