...
#define RPG_GAMECORE_FIVEDIMSETPLAYERSKILLMOVEACTION_METHOD_3_46EB146A57643508_OFFSET UNITYSDK_OFFSET(0x1720A630)
#define RPG_GAMECORE_FIVEDIMSETPLAYERSKILLMOVEACTION_METHOD_3_65337BCAC7328F3C_OFFSET UNITYSDK_OFFSET(0x1720A500)
#define RPG_GAMECORE_FIVEDIMSETPLAYERSKILLMOVEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1720A610)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSetPlayerSkillMoveAction_TypeDefinitionIndex = 17217;
