...
#define RPG_GAMECORE_FIVEDIMSETPLAYERSKILLMOVEACTION_METHOD_3_46EB146A57643508_OFFSET UNITYSDK_OFFSET(0x19755580)
#define RPG_GAMECORE_FIVEDIMSETPLAYERSKILLMOVEACTION_METHOD_3_65337BCAC7328F3C_OFFSET UNITYSDK_OFFSET(0x19755450)
#define RPG_GAMECORE_FIVEDIMSETPLAYERSKILLMOVEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19755560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSetPlayerSkillMoveAction_TypeDefinitionIndex = 17846;
