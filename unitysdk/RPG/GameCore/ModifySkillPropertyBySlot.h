...
#define RPG_GAMECORE_MODIFYSKILLPROPERTYBYSLOT_METHOD_3_288A74FE15143C3A_OFFSET UNITYSDK_OFFSET(0x1B1ADAB0)
#define RPG_GAMECORE_MODIFYSKILLPROPERTYBYSLOT_METHOD_3_7AE2F18BE876FE89_OFFSET UNITYSDK_OFFSET(0x1B1ADB50)
#define RPG_GAMECORE_MODIFYSKILLPROPERTYBYSLOT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1ADB10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifySkillPropertyBySlot_TypeDefinitionIndex = 22714;
