...
#define RPG_GAMECORE_MODIFYSKILLPROPERTYBYSLOT_METHOD_3_7AE2F18BE876FE89_OFFSET UNITYSDK_OFFSET(0x18B40D70)
#define RPG_GAMECORE_MODIFYSKILLPROPERTYBYSLOT_METHOD_3_98CD216EA66114D1_OFFSET UNITYSDK_OFFSET(0x18B40CA0)
#define RPG_GAMECORE_MODIFYSKILLPROPERTYBYSLOT__CTOR_OFFSET UNITYSDK_OFFSET(0x18B40D20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifySkillPropertyBySlot_TypeDefinitionIndex = 22530;
