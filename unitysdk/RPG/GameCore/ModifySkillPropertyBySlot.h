...
#define RPG_GAMECORE_MODIFYSKILLPROPERTYBYSLOT_METHOD_3_7AE2F18BE876FE89_OFFSET UNITYSDK_OFFSET(0x19958D90)
#define RPG_GAMECORE_MODIFYSKILLPROPERTYBYSLOT_METHOD_3_98CD216EA66114D1_OFFSET UNITYSDK_OFFSET(0x19958CC0)
#define RPG_GAMECORE_MODIFYSKILLPROPERTYBYSLOT__CTOR_OFFSET UNITYSDK_OFFSET(0x19958D40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifySkillPropertyBySlot_TypeDefinitionIndex = 22273;
