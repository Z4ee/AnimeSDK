...
#define RPG_GAMECORE_ADVCLIENTCHANGEPROPSTATE_METHOD_3_59BA1BE9BD6269CF_OFFSET UNITYSDK_OFFSET(0x1D6B3510)
#define RPG_GAMECORE_ADVCLIENTCHANGEPROPSTATE_METHOD_3_EBE6D64849450460_OFFSET UNITYSDK_OFFSET(0x1D6B3490)
#define RPG_GAMECORE_ADVCLIENTCHANGEPROPSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6B34E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvClientChangePropState_TypeDefinitionIndex = 20219;
