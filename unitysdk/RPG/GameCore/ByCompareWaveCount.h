...
#define RPG_GAMECORE_BYCOMPAREWAVECOUNT_METHOD_4_B6340B6507636704_OFFSET UNITYSDK_OFFSET(0x18741360)
#define RPG_GAMECORE_BYCOMPAREWAVECOUNT_METHOD_4_CB9B4E2E19D2B9B6_OFFSET UNITYSDK_OFFSET(0x18741290)
#define RPG_GAMECORE_BYCOMPAREWAVECOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x18741310)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareWaveCount_TypeDefinitionIndex = 22401;
