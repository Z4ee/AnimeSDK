...
#define RPG_GAMECORE_ACTIONSWITCHCASEITEMCONFIG_METHOD_2_F6C1338D6D38D129_OFFSET UNITYSDK_OFFSET(0x16E9E1E0)
#define RPG_GAMECORE_ACTIONSWITCHCASEITEMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16E9E310)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActionSwitchCaseItemConfig_TypeDefinitionIndex = 15619;
