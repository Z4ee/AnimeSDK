...
#define RPG_GAMECORE_ROGUEMODIFIERTITANBLESSCIPHERCONFIG_METHOD_3_1E0B2D4B06C58A9C_OFFSET UNITYSDK_OFFSET(0x1762DAB0)
#define RPG_GAMECORE_ROGUEMODIFIERTITANBLESSCIPHERCONFIG_METHOD_3_39958D0243EA67A5_OFFSET UNITYSDK_OFFSET(0x17639C30)
#define RPG_GAMECORE_ROGUEMODIFIERTITANBLESSCIPHERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1762DA60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierTitanBlessCipherConfig_TypeDefinitionIndex = 16313;
