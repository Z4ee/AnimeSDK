...
#define RPG_GAMECORE_CHIMERABATTLEEXTRACONDITIONEVALUATOR_METHOD_2_EB41C6758B65C8FF_OFFSET UNITYSDK_OFFSET(0x187F00A0)
#define RPG_GAMECORE_CHIMERABATTLEEXTRACONDITIONEVALUATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x187F3910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraBattleExtraConditionEvaluator_TypeDefinitionIndex = 15000;
