...
#define RPG_GAMECORE_CHIMERABATTLEEXTRACONDITIONEVALUATOR_METHOD_2_EB41C6758B65C8FF_OFFSET UNITYSDK_OFFSET(0x17090CF0)
#define RPG_GAMECORE_CHIMERABATTLEEXTRACONDITIONEVALUATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x17094560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraBattleExtraConditionEvaluator_TypeDefinitionIndex = 14530;
