...
#define RPG_GAMECORE_CHIMERABATTLEEXTRACONDITIONEVALUATOR_METHOD_2_EB41C6758B65C8FF_OFFSET UNITYSDK_OFFSET(0x1E01CE90)
#define RPG_GAMECORE_CHIMERABATTLEEXTRACONDITIONEVALUATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1E020400)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraBattleExtraConditionEvaluator_TypeDefinitionIndex = 15664;
