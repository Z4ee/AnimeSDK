...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONMIRACLEEVENTCONFIG_METHOD_3_D6A94533DCA74590_OFFSET UNITYSDK_OFFSET(0x18D3D6F0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONMIRACLEEVENTCONFIG_METHOD_3_F6A0223F73AAFEE9_OFFSET UNITYSDK_OFFSET(0x18D36400)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONMIRACLEEVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D363B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnMiracleEventConfig_TypeDefinitionIndex = 16794;
