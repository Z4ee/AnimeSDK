...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONMIRACLEEVENTCONFIG_METHOD_3_50E8973C087EB365_OFFSET UNITYSDK_OFFSET(0x1CFC0740)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONMIRACLEEVENTCONFIG_METHOD_3_F6A0223F73AAFEE9_OFFSET UNITYSDK_OFFSET(0x1CFC0790)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONMIRACLEEVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFC0780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnMiracleEventConfig_TypeDefinitionIndex = 16971;
