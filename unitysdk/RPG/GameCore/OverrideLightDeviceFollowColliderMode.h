...
#define RPG_GAMECORE_OVERRIDELIGHTDEVICEFOLLOWCOLLIDERMODE_METHOD_3_54B302CE941E94A5_OFFSET UNITYSDK_OFFSET(0x1D40CAC0)
#define RPG_GAMECORE_OVERRIDELIGHTDEVICEFOLLOWCOLLIDERMODE_METHOD_3_CA00509555E30130_OFFSET UNITYSDK_OFFSET(0x1D40CA20)
#define RPG_GAMECORE_OVERRIDELIGHTDEVICEFOLLOWCOLLIDERMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D40CA80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OverrideLightDeviceFollowColliderMode_TypeDefinitionIndex = 22095;
