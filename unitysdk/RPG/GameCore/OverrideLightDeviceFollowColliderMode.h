...
#define RPG_GAMECORE_OVERRIDELIGHTDEVICEFOLLOWCOLLIDERMODE_METHOD_3_54B302CE941E94A5_OFFSET UNITYSDK_OFFSET(0x199DDDF0)
#define RPG_GAMECORE_OVERRIDELIGHTDEVICEFOLLOWCOLLIDERMODE_METHOD_3_C77315659513B4F9_OFFSET UNITYSDK_OFFSET(0x199DDD10)
#define RPG_GAMECORE_OVERRIDELIGHTDEVICEFOLLOWCOLLIDERMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x199DDD90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OverrideLightDeviceFollowColliderMode_TypeDefinitionIndex = 21117;
