...
#define RPG_GAMECORE_TALKSENTENCEIMAGEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D5A05F0)
#define RPG_GAMECORE_TALKSENTENCEIMAGEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5A1020)
