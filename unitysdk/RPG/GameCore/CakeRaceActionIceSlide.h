...
#define RPG_GAMECORE_CAKERACEACTIONICESLIDE_METHOD_3_69FE9A17A3527A82_OFFSET UNITYSDK_OFFSET(0x1B2CBAC0)
#define RPG_GAMECORE_CAKERACEACTIONICESLIDE_METHOD_3_BF932007E39A5703_OFFSET UNITYSDK_OFFSET(0x1B2CBB60)
#define RPG_GAMECORE_CAKERACEACTIONICESLIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2CBB50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionIceSlide_TypeDefinitionIndex = 17619;
