...
#define RPG_GAMECORE_CAKERACEACTIONICESLIDE_METHOD_3_BF932007E39A5703_OFFSET UNITYSDK_OFFSET(0x195E60A0)
#define RPG_GAMECORE_CAKERACEACTIONICESLIDE_METHOD_3_F253D1662838D5B5_OFFSET UNITYSDK_OFFSET(0x195E7FC0)
#define RPG_GAMECORE_CAKERACEACTIONICESLIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x195E6080)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionIceSlide_TypeDefinitionIndex = 17446;
