...
#define RPG_GAMECORE_CAKERACEACTIONICESLIDE_METHOD_3_BF932007E39A5703_OFFSET UNITYSDK_OFFSET(0x1876A5A0)
#define RPG_GAMECORE_CAKERACEACTIONICESLIDE_METHOD_3_F253D1662838D5B5_OFFSET UNITYSDK_OFFSET(0x1876C010)
#define RPG_GAMECORE_CAKERACEACTIONICESLIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x1876A580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionIceSlide_TypeDefinitionIndex = 17443;
