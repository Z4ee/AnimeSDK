...
#define RPG_GAMECORE_BATTLEPERFORMCREATEACTOR_METHOD_2_5B15045B99203C1C_OFFSET UNITYSDK_OFFSET(0x1B3029B0)
#define RPG_GAMECORE_BATTLEPERFORMCREATEACTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B302CC0)
