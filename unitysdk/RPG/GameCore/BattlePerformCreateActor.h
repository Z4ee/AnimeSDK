...
#define RPG_GAMECORE_BATTLEPERFORMCREATEACTOR_METHOD_2_5B15045B99203C1C_OFFSET UNITYSDK_OFFSET(0x194D4AD0)
#define RPG_GAMECORE_BATTLEPERFORMCREATEACTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x194D4DE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattlePerformCreateActor_TypeDefinitionIndex = 22107;
