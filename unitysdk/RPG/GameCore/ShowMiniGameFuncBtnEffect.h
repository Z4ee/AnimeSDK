...
#define RPG_GAMECORE_SHOWMINIGAMEFUNCBTNEFFECT_METHOD_3_1E72AAF57604AF97_OFFSET UNITYSDK_OFFSET(0x17700220)
#define RPG_GAMECORE_SHOWMINIGAMEFUNCBTNEFFECT_METHOD_3_96C50CACFC9DCB3E_OFFSET UNITYSDK_OFFSET(0x177002A0)
#define RPG_GAMECORE_SHOWMINIGAMEFUNCBTNEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x17700270)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowMiniGameFuncBtnEffect_TypeDefinitionIndex = 18797;
