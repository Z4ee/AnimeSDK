...
#define RPG_GAMECORE_SHOWMINIGAMEFUNCBTNEFFECT_METHOD_3_4E7C7C4DB729828F_OFFSET UNITYSDK_OFFSET(0x1BE44010)
#define RPG_GAMECORE_SHOWMINIGAMEFUNCBTNEFFECT_METHOD_3_96C50CACFC9DCB3E_OFFSET UNITYSDK_OFFSET(0x1BE44060)
#define RPG_GAMECORE_SHOWMINIGAMEFUNCBTNEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE44050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowMiniGameFuncBtnEffect_TypeDefinitionIndex = 19715;
