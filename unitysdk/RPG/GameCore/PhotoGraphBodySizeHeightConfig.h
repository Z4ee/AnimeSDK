...
#define RPG_GAMECORE_PHOTOGRAPHBODYSIZEHEIGHTCONFIG_METHOD_2_BFEF9988F62FE8D1_OFFSET UNITYSDK_OFFSET(0x174A8990)
#define RPG_GAMECORE_PHOTOGRAPHBODYSIZEHEIGHTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x174A8AA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotoGraphBodySizeHeightConfig_TypeDefinitionIndex = 17469;
