...
#define RPG_GAMECORE_SETDYNAMICVALUEBYFATELEVEL_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1E81CD60)
#define RPG_GAMECORE_SETDYNAMICVALUEBYFATELEVEL_METHOD_4_330A83399330B0D8_OFFSET UNITYSDK_OFFSET(0x1E81CB40)
#define RPG_GAMECORE_SETDYNAMICVALUEBYFATELEVEL_METHOD_4_EDBDD14CC42B8D1D_OFFSET UNITYSDK_OFFSET(0x1E81CB80)
#define RPG_GAMECORE_SETDYNAMICVALUEBYFATELEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1E81CB70)
