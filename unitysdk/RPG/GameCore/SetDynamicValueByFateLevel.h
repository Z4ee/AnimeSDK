...
#define RPG_GAMECORE_SETDYNAMICVALUEBYFATELEVEL_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1C2E1E70)
#define RPG_GAMECORE_SETDYNAMICVALUEBYFATELEVEL_METHOD_4_330A83399330B0D8_OFFSET UNITYSDK_OFFSET(0x1C2E1C50)
#define RPG_GAMECORE_SETDYNAMICVALUEBYFATELEVEL_METHOD_4_EDBDD14CC42B8D1D_OFFSET UNITYSDK_OFFSET(0x1C2E1C90)
#define RPG_GAMECORE_SETDYNAMICVALUEBYFATELEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2E1C80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByFateLevel_TypeDefinitionIndex = 22452;
