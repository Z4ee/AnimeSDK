...
#define RPG_GAMECORE_BLOCKSETVISIBILITY_METHOD_3_3295AC0BC820463B_OFFSET UNITYSDK_OFFSET(0x16FE9490)
#define RPG_GAMECORE_BLOCKSETVISIBILITY_METHOD_3_61DD4F9D8E0BACE2_OFFSET UNITYSDK_OFFSET(0x16FE9510)
#define RPG_GAMECORE_BLOCKSETVISIBILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x16FE94E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BlockSetVisibility_TypeDefinitionIndex = 19484;
