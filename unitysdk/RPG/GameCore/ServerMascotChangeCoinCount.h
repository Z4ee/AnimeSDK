...
#define RPG_GAMECORE_SERVERMASCOTCHANGECOINCOUNT_METHOD_3_11A96AF3651E9E5F_OFFSET UNITYSDK_OFFSET(0x1C2CF7E0)
#define RPG_GAMECORE_SERVERMASCOTCHANGECOINCOUNT_METHOD_3_7AF30EAF529139DB_OFFSET UNITYSDK_OFFSET(0x1C2CF790)
#define RPG_GAMECORE_SERVERMASCOTCHANGECOINCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2CF7D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ServerMascotChangeCoinCount_TypeDefinitionIndex = 20470;
