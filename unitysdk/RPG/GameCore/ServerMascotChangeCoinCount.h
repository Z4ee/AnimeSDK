...
#define RPG_GAMECORE_SERVERMASCOTCHANGECOINCOUNT_METHOD_3_11A96AF3651E9E5F_OFFSET UNITYSDK_OFFSET(0x176A3C40)
#define RPG_GAMECORE_SERVERMASCOTCHANGECOINCOUNT_METHOD_3_5A2A33E2BDF975CF_OFFSET UNITYSDK_OFFSET(0x176A3BB0)
#define RPG_GAMECORE_SERVERMASCOTCHANGECOINCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x176A3C10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ServerMascotChangeCoinCount_TypeDefinitionIndex = 19566;
