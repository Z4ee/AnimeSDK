...
#define RPG_GAMECORE_SERVERMASCOTCHANGECOINCOUNT_METHOD_3_11A96AF3651E9E5F_OFFSET UNITYSDK_OFFSET(0x19C25890)
#define RPG_GAMECORE_SERVERMASCOTCHANGECOINCOUNT_METHOD_3_5A2A33E2BDF975CF_OFFSET UNITYSDK_OFFSET(0x19C25800)
#define RPG_GAMECORE_SERVERMASCOTCHANGECOINCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x19C25860)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ServerMascotChangeCoinCount_TypeDefinitionIndex = 20098;
