...
#define RPG_GAMECORE_MONOEFFECTLODDETAIL_METHOD_2_5EF287C519F3996A_OFFSET UNITYSDK_OFFSET(0x17435F60)
#define RPG_GAMECORE_MONOEFFECTLODDETAIL__CTOR_OFFSET UNITYSDK_OFFSET(0x174360A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonoEffectLodDetail_TypeDefinitionIndex = 17489;
