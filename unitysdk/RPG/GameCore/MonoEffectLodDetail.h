...
#define RPG_GAMECORE_MONOEFFECTLODDETAIL_METHOD_2_5EF287C519F3996A_OFFSET UNITYSDK_OFFSET(0x1D1C0150)
#define RPG_GAMECORE_MONOEFFECTLODDETAIL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1C0290)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonoEffectLodDetail_TypeDefinitionIndex = 18878;
