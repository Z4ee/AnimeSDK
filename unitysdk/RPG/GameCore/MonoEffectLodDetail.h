...
#define RPG_GAMECORE_MONOEFFECTLODDETAIL_METHOD_2_5EF287C519F3996A_OFFSET UNITYSDK_OFFSET(0x1995AAD0)
#define RPG_GAMECORE_MONOEFFECTLODDETAIL__CTOR_OFFSET UNITYSDK_OFFSET(0x1995AC10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonoEffectLodDetail_TypeDefinitionIndex = 18120;
