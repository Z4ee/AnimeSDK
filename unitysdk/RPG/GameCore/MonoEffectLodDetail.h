...
#define RPG_GAMECORE_MONOEFFECTLODDETAIL_METHOD_2_5EF287C519F3996A_OFFSET UNITYSDK_OFFSET(0x1D2B99C0)
#define RPG_GAMECORE_MONOEFFECTLODDETAIL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2B9B00)
