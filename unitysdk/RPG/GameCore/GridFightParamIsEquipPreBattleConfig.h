...
#define RPG_GAMECORE_GRIDFIGHTPARAMISEQUIPPREBATTLECONFIG_METHOD_6_2A66BE7F8B196C22_OFFSET UNITYSDK_OFFSET(0x1D06E200)
#define RPG_GAMECORE_GRIDFIGHTPARAMISEQUIPPREBATTLECONFIG_METHOD_6_F217FDAE60E0FF86_OFFSET UNITYSDK_OFFSET(0x1D06E1B0)
#define RPG_GAMECORE_GRIDFIGHTPARAMISEQUIPPREBATTLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D06E1F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightParamIsEquipPreBattleConfig_TypeDefinitionIndex = 18760;
