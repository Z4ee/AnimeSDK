...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONENTERROGUETOURNLAYERCONFIG_METHOD_3_C7E2BF61DE45BD6D_OFFSET UNITYSDK_OFFSET(0x1EEF8C30)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONENTERROGUETOURNLAYERCONFIG_METHOD_3_F8D654CB709264D1_OFFSET UNITYSDK_OFFSET(0x1EEF8C80)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONENTERROGUETOURNLAYERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEF8C70)
