...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYEXTRABATTLEROUNDCONFIG_METHOD_3_37A87A9CC42EB634_OFFSET UNITYSDK_OFFSET(0x18D40D30)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYEXTRABATTLEROUNDCONFIG_METHOD_3_BB643CF78C21D77D_OFFSET UNITYSDK_OFFSET(0x18D40C60)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYEXTRABATTLEROUNDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D40CE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyExtraBattleRoundConfig_TypeDefinitionIndex = 16839;
