...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYEXTRABATTLEROUNDCONFIG_METHOD_3_37A87A9CC42EB634_OFFSET UNITYSDK_OFFSET(0x1D163B70)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYEXTRABATTLEROUNDCONFIG_METHOD_3_949065FB76EE63B8_OFFSET UNITYSDK_OFFSET(0x1D163B20)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYEXTRABATTLEROUNDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D163B60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyExtraBattleRoundConfig_TypeDefinitionIndex = 17016;
