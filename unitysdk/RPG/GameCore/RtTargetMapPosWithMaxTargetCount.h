...
#define RPG_GAMECORE_RTTARGETMAPPOSWITHMAXTARGETCOUNT_METHOD_3_72128C761A899A2D_OFFSET UNITYSDK_OFFSET(0x1D4B79B0)
#define RPG_GAMECORE_RTTARGETMAPPOSWITHMAXTARGETCOUNT_METHOD_3_7DA0426B6A44D003_OFFSET UNITYSDK_OFFSET(0x1D4B7A50)
#define RPG_GAMECORE_RTTARGETMAPPOSWITHMAXTARGETCOUNT_METHOD_3_D24A7A1962274922_OFFSET UNITYSDK_OFFSET(0x1D4B7700)
#define RPG_GAMECORE_RTTARGETMAPPOSWITHMAXTARGETCOUNT_METHOD_3_DCB7AEC85F78771A_OFFSET UNITYSDK_OFFSET(0x1D4B7800)
#define RPG_GAMECORE_RTTARGETMAPPOSWITHMAXTARGETCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4B77A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtTargetMapPosWithMaxTargetCount_TypeDefinitionIndex = 23983;
