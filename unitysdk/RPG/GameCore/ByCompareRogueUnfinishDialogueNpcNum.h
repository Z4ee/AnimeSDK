...
#define RPG_GAMECORE_BYCOMPAREROGUEUNFINISHDIALOGUENPCNUM_METHOD_4_4C1AB6D0C424A2AB_OFFSET UNITYSDK_OFFSET(0x17015690)
#define RPG_GAMECORE_BYCOMPAREROGUEUNFINISHDIALOGUENPCNUM_METHOD_4_8F250B7116B2FE52_OFFSET UNITYSDK_OFFSET(0x170155C0)
#define RPG_GAMECORE_BYCOMPAREROGUEUNFINISHDIALOGUENPCNUM__CTOR_OFFSET UNITYSDK_OFFSET(0x17015640)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareRogueUnfinishDialogueNpcNum_TypeDefinitionIndex = 19120;
