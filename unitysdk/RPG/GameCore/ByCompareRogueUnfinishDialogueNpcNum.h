...
#define RPG_GAMECORE_BYCOMPAREROGUEUNFINISHDIALOGUENPCNUM_METHOD_4_01DDF2B50410FF07_OFFSET UNITYSDK_OFFSET(0x1CEF7A30)
#define RPG_GAMECORE_BYCOMPAREROGUEUNFINISHDIALOGUENPCNUM_METHOD_4_4C1AB6D0C424A2AB_OFFSET UNITYSDK_OFFSET(0x1CEF7A80)
#define RPG_GAMECORE_BYCOMPAREROGUEUNFINISHDIALOGUENPCNUM__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEF7A70)
