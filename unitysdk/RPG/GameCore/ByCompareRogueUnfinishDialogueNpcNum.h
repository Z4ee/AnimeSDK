...
#define RPG_GAMECORE_BYCOMPAREROGUEUNFINISHDIALOGUENPCNUM_METHOD_4_4C1AB6D0C424A2AB_OFFSET UNITYSDK_OFFSET(0x18739970)
#define RPG_GAMECORE_BYCOMPAREROGUEUNFINISHDIALOGUENPCNUM_METHOD_4_8F250B7116B2FE52_OFFSET UNITYSDK_OFFSET(0x187398A0)
#define RPG_GAMECORE_BYCOMPAREROGUEUNFINISHDIALOGUENPCNUM__CTOR_OFFSET UNITYSDK_OFFSET(0x18739920)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareRogueUnfinishDialogueNpcNum_TypeDefinitionIndex = 19779;
