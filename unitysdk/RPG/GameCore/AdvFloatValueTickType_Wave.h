...
#define RPG_GAMECORE_ADVFLOATVALUETICKTYPE_WAVE_METHOD_3_7644CB9DDC69AF1A_OFFSET UNITYSDK_OFFSET(0x1BE1D620)
#define RPG_GAMECORE_ADVFLOATVALUETICKTYPE_WAVE_METHOD_3_C5AED7EABE7FA327_OFFSET UNITYSDK_OFFSET(0x1BE1D370)
#define RPG_GAMECORE_ADVFLOATVALUETICKTYPE_WAVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE1D360)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvFloatValueTickType_Wave_TypeDefinitionIndex = 20235;
