...
#define RPG_GAMECORE_ADVFLOATVALUETICKTYPE_WAVE_METHOD_3_7644CB9DDC69AF1A_OFFSET UNITYSDK_OFFSET(0x16F2F6B0)
#define RPG_GAMECORE_ADVFLOATVALUETICKTYPE_WAVE_METHOD_3_C5AED7EABE7FA327_OFFSET UNITYSDK_OFFSET(0x16F2F400)
#define RPG_GAMECORE_ADVFLOATVALUETICKTYPE_WAVE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F2F3F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvFloatValueTickType_Wave_TypeDefinitionIndex = 19350;
