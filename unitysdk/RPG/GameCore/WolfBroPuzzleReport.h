...
#define RPG_GAMECORE_WOLFBROPUZZLEREPORT_METHOD_3_447C60975DB5690E_OFFSET UNITYSDK_OFFSET(0x19110960)
#define RPG_GAMECORE_WOLFBROPUZZLEREPORT_METHOD_3_8B5D36E8D0571EB6_OFFSET UNITYSDK_OFFSET(0x191108E0)
#define RPG_GAMECORE_WOLFBROPUZZLEREPORT__CTOR_OFFSET UNITYSDK_OFFSET(0x19110930)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WolfBroPuzzleReport_TypeDefinitionIndex = 19318;
