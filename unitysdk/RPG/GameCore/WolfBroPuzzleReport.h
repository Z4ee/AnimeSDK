...
#define RPG_GAMECORE_WOLFBROPUZZLEREPORT_METHOD_3_447C60975DB5690E_OFFSET UNITYSDK_OFFSET(0x1790CA60)
#define RPG_GAMECORE_WOLFBROPUZZLEREPORT_METHOD_3_8B5D36E8D0571EB6_OFFSET UNITYSDK_OFFSET(0x1790C9E0)
#define RPG_GAMECORE_WOLFBROPUZZLEREPORT__CTOR_OFFSET UNITYSDK_OFFSET(0x1790CA30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WolfBroPuzzleReport_TypeDefinitionIndex = 18661;
