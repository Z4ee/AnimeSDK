...
#define RPG_GAMECORE_FIVEDIMSETPLAYERINTERACTENABLEACTION_METHOD_3_8AA375814A900D0B_OFFSET UNITYSDK_OFFSET(0x19754DC0)
#define RPG_GAMECORE_FIVEDIMSETPLAYERINTERACTENABLEACTION_METHOD_3_B97AE86A62C32C7F_OFFSET UNITYSDK_OFFSET(0x19754EF0)
#define RPG_GAMECORE_FIVEDIMSETPLAYERINTERACTENABLEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19754ED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSetPlayerInteractEnableAction_TypeDefinitionIndex = 17860;
