...
#define RPG_GAMECORE_ST_RTMAIN_TRANSMITTOTARGET_METHOD_4_B3EF8C2F846C181F_OFFSET UNITYSDK_OFFSET(0x1DB40C50)
#define RPG_GAMECORE_ST_RTMAIN_TRANSMITTOTARGET_METHOD_4_EA322619610C8384_OFFSET UNITYSDK_OFFSET(0x1DB40C10)
#define RPG_GAMECORE_ST_RTMAIN_TRANSMITTOTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB40C40)
