...
#define RPG_GAMECORE_ROGUEMODIFIERENABLEDICEREROLLFREECONFIG_METHOD_3_92E6833FDF64B70A_OFFSET UNITYSDK_OFFSET(0x1EEF80E0)
#define RPG_GAMECORE_ROGUEMODIFIERENABLEDICEREROLLFREECONFIG_METHOD_3_AC6C6994AAA444CE_OFFSET UNITYSDK_OFFSET(0x1EEF8090)
#define RPG_GAMECORE_ROGUEMODIFIERENABLEDICEREROLLFREECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEF80D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierEnableDiceReRollFreeConfig_TypeDefinitionIndex = 17744;
