...
#define RPG_GAMECORE_ROGUEMODIFIERENABLEDICEREROLLFREECONFIG_METHOD_3_208BEB1120A3EFD3_OFFSET UNITYSDK_OFFSET(0x1762E620)
#define RPG_GAMECORE_ROGUEMODIFIERENABLEDICEREROLLFREECONFIG_METHOD_3_92E6833FDF64B70A_OFFSET UNITYSDK_OFFSET(0x1762E6F0)
#define RPG_GAMECORE_ROGUEMODIFIERENABLEDICEREROLLFREECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1762E6A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierEnableDiceReRollFreeConfig_TypeDefinitionIndex = 16499;
