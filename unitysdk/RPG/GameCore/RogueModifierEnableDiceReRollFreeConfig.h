...
#define RPG_GAMECORE_ROGUEMODIFIERENABLEDICEREROLLFREECONFIG_METHOD_3_208BEB1120A3EFD3_OFFSET UNITYSDK_OFFSET(0x19B5BDA0)
#define RPG_GAMECORE_ROGUEMODIFIERENABLEDICEREROLLFREECONFIG_METHOD_3_92E6833FDF64B70A_OFFSET UNITYSDK_OFFSET(0x19B4FCC0)
#define RPG_GAMECORE_ROGUEMODIFIERENABLEDICEREROLLFREECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B4FC70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierEnableDiceReRollFreeConfig_TypeDefinitionIndex = 17066;
