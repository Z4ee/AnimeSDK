...
#define RPG_GAMECORE_PLAYROGUEOPTIONTALK_METHOD_3_35F83E3DD7A8F894_OFFSET UNITYSDK_OFFSET(0x174C5AA0)
#define RPG_GAMECORE_PLAYROGUEOPTIONTALK_METHOD_3_CED91AA63F05EC85_OFFSET UNITYSDK_OFFSET(0x174C5B20)
#define RPG_GAMECORE_PLAYROGUEOPTIONTALK__CTOR_OFFSET UNITYSDK_OFFSET(0x174C5AF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayRogueOptionTalk_TypeDefinitionIndex = 19418;
