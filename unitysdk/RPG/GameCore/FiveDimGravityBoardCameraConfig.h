...
#define RPG_GAMECORE_FIVEDIMGRAVITYBOARDCAMERACONFIG_METHOD_4_272FFBA9ADFDEE97_OFFSET UNITYSDK_OFFSET(0x19729AB0)
#define RPG_GAMECORE_FIVEDIMGRAVITYBOARDCAMERACONFIG_METHOD_4_6CF9DBB0FF874F59_OFFSET UNITYSDK_OFFSET(0x19740DB0)
#define RPG_GAMECORE_FIVEDIMGRAVITYBOARDCAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19729A70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimGravityBoardCameraConfig_TypeDefinitionIndex = 17722;
