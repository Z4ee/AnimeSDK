...
#define RPG_GAMECORE_FIVEDIMGRAVITYBOARDCAMERACONFIG_METHOD_4_272FFBA9ADFDEE97_OFFSET UNITYSDK_OFFSET(0x1BA89790)
#define RPG_GAMECORE_FIVEDIMGRAVITYBOARDCAMERACONFIG_METHOD_4_958833392845CEDE_OFFSET UNITYSDK_OFFSET(0x1BA990E0)
#define RPG_GAMECORE_FIVEDIMGRAVITYBOARDCAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA89760)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimGravityBoardCameraConfig_TypeDefinitionIndex = 17896;
