...
#define RPG_GAMECORE_OVERRIDEMONSTERRANKSCORE_METHOD_3_50A7EB165F97B595_OFFSET UNITYSDK_OFFSET(0x17483920)
#define RPG_GAMECORE_OVERRIDEMONSTERRANKSCORE_METHOD_3_54B4AE323B130B14_OFFSET UNITYSDK_OFFSET(0x174838A0)
#define RPG_GAMECORE_OVERRIDEMONSTERRANKSCORE__CTOR_OFFSET UNITYSDK_OFFSET(0x174838F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OverrideMonsterRankScore_TypeDefinitionIndex = 21962;
