...
#define RPG_GAMECORE_LINEARWITHDETECTPROJECTILEDATA_METHOD_3_C866378BA3E9BE12_OFFSET UNITYSDK_OFFSET(0x1B0900E0)
#define RPG_GAMECORE_LINEARWITHDETECTPROJECTILEDATA_METHOD_3_CE2BEFC0E19FA98D_OFFSET UNITYSDK_OFFSET(0x1B090200)
#define RPG_GAMECORE_LINEARWITHDETECTPROJECTILEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B090180)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LinearWithDetectProjectileData_TypeDefinitionIndex = 15054;
