...
#define RPG_GAMECORE_CHENLINGBATTLEVALUEGETTER_SKILLEXCELVALUE_METHOD_3_346EF61EE867D197_OFFSET UNITYSDK_OFFSET(0x187E8510)
#define RPG_GAMECORE_CHENLINGBATTLEVALUEGETTER_SKILLEXCELVALUE_METHOD_3_661AA7587039929B_OFFSET UNITYSDK_OFFSET(0x187E8410)
#define RPG_GAMECORE_CHENLINGBATTLEVALUEGETTER_SKILLEXCELVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x187E8500)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleValueGetter_SkillExcelValue_TypeDefinitionIndex = 14964;
