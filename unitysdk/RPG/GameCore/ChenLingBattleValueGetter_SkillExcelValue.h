...
#define RPG_GAMECORE_CHENLINGBATTLEVALUEGETTER_SKILLEXCELVALUE_METHOD_3_346EF61EE867D197_OFFSET UNITYSDK_OFFSET(0x196258D0)
#define RPG_GAMECORE_CHENLINGBATTLEVALUEGETTER_SKILLEXCELVALUE_METHOD_3_661AA7587039929B_OFFSET UNITYSDK_OFFSET(0x196257D0)
#define RPG_GAMECORE_CHENLINGBATTLEVALUEGETTER_SKILLEXCELVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x196258C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleValueGetter_SkillExcelValue_TypeDefinitionIndex = 15027;
