...
#define RPG_GAMECORE_CHENLINGBATTLEVALUEGETTER_SKILLEXCELVALUE_METHOD_3_346EF61EE867D197_OFFSET UNITYSDK_OFFSET(0x1C380210)
#define RPG_GAMECORE_CHENLINGBATTLEVALUEGETTER_SKILLEXCELVALUE_METHOD_3_661AA7587039929B_OFFSET UNITYSDK_OFFSET(0x1C380110)
#define RPG_GAMECORE_CHENLINGBATTLEVALUEGETTER_SKILLEXCELVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C380200)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleValueGetter_SkillExcelValue_TypeDefinitionIndex = 15191;
