...
#define RPG_GAMECORE_BYCOMPARESTORYLINEID_METHOD_4_40C3D6A20CF98EA5_OFFSET UNITYSDK_OFFSET(0x1A8A8F00)
#define RPG_GAMECORE_BYCOMPARESTORYLINEID_METHOD_4_5E6DBFA5633E856C_OFFSET UNITYSDK_OFFSET(0x1A8A8F40)
#define RPG_GAMECORE_BYCOMPARESTORYLINEID_METHOD_4_6717B9C0B19B7DA9_OFFSET UNITYSDK_OFFSET(0x1A8A90E0)
#define RPG_GAMECORE_BYCOMPARESTORYLINEID_METHOD_4_9BFBF4EFB6EDE536_OFFSET UNITYSDK_OFFSET(0x1A8A90B0)
#define RPG_GAMECORE_BYCOMPARESTORYLINEID__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8A8F30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareStoryLineID_TypeDefinitionIndex = 19982;
