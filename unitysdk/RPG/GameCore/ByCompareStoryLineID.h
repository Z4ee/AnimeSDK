...
#define RPG_GAMECORE_BYCOMPARESTORYLINEID_METHOD_4_5E6DBFA5633E856C_OFFSET UNITYSDK_OFFSET(0x17019290)
#define RPG_GAMECORE_BYCOMPARESTORYLINEID_METHOD_4_A125A719A05578AE_OFFSET UNITYSDK_OFFSET(0x170191C0)
#define RPG_GAMECORE_BYCOMPARESTORYLINEID__CTOR_OFFSET UNITYSDK_OFFSET(0x17019240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareStoryLineID_TypeDefinitionIndex = 19088;
