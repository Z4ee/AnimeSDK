...
#define RPG_GAMECORE_MARBLEEFFECTCONFIG_METHOD_2_9AA5B4BDBCAE9945_OFFSET UNITYSDK_OFFSET(0x1BD179E0)
#define RPG_GAMECORE_MARBLEEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD17B50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleEffectConfig_TypeDefinitionIndex = 16231;
