...
#define RPG_GAMECORE_PROPSERVERSTATEROTATION_METHOD_2_4D66A4CA9CF00829_OFFSET UNITYSDK_OFFSET(0x19A96530)
#define RPG_GAMECORE_PROPSERVERSTATEROTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x19A96570)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropServerStateRotation_TypeDefinitionIndex = 19211;
