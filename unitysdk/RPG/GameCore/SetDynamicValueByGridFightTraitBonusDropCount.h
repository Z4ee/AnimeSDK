...
#define RPG_GAMECORE_SETDYNAMICVALUEBYGRIDFIGHTTRAITBONUSDROPCOUNT_METHOD_3_968C390F763E1166_OFFSET UNITYSDK_OFFSET(0x1C2E2DE0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYGRIDFIGHTTRAITBONUSDROPCOUNT_METHOD_3_DEB46571587B559F_OFFSET UNITYSDK_OFFSET(0x1C2E2DA0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYGRIDFIGHTTRAITBONUSDROPCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2E2DD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByGridFightTraitBonusDropCount_TypeDefinitionIndex = 21715;
