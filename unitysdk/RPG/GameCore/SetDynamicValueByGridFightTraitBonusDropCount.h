...
#define RPG_GAMECORE_SETDYNAMICVALUEBYGRIDFIGHTTRAITBONUSDROPCOUNT_METHOD_3_89FDE3EA751ACC21_OFFSET UNITYSDK_OFFSET(0x19C417F0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYGRIDFIGHTTRAITBONUSDROPCOUNT_METHOD_3_968C390F763E1166_OFFSET UNITYSDK_OFFSET(0x19C41870)
#define RPG_GAMECORE_SETDYNAMICVALUEBYGRIDFIGHTTRAITBONUSDROPCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x19C41840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByGridFightTraitBonusDropCount_TypeDefinitionIndex = 21300;
