...
#define RPG_GAMECORE_LEVELBATTLEOPERATIONFROMLG_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1BDEF980)
#define RPG_GAMECORE_LEVELBATTLEOPERATIONFROMLG_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x1BDEF930)
#define RPG_GAMECORE_LEVELBATTLEOPERATIONFROMLG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDEF920)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelBattleOperationFromLG_TypeDefinitionIndex = 54204;
