...
#define RPG_GAMECORE_LEVELBATTLEOPERATIONFROMLG_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xA97CF90)
#define RPG_GAMECORE_LEVELBATTLEOPERATIONFROMLG_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xA97CF40)
#define RPG_GAMECORE_LEVELBATTLEOPERATIONFROMLG__CTOR_OFFSET UNITYSDK_OFFSET(0xA97CF30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelBattleOperationFromLG_TypeDefinitionIndex = 45643;
