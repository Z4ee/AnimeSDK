...
#define RPG_GAMECORE_SETDYNAMICVALUEBYITEMNUM_METHOD_3_221E13692E80D144_OFFSET UNITYSDK_OFFSET(0x18E23380)
#define RPG_GAMECORE_SETDYNAMICVALUEBYITEMNUM_METHOD_3_311376B4D342610B_OFFSET UNITYSDK_OFFSET(0x18E233F0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYITEMNUM__CTOR_OFFSET UNITYSDK_OFFSET(0x18E233C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByItemNum_TypeDefinitionIndex = 20614;
