...
#define RPG_GAMECORE_SETDYNAMICVALUEBYITEMNUM_METHOD_3_311376B4D342610B_OFFSET UNITYSDK_OFFSET(0x1C2E4140)
#define RPG_GAMECORE_SETDYNAMICVALUEBYITEMNUM_METHOD_3_A7FE5B705F26545E_OFFSET UNITYSDK_OFFSET(0x1C2E4100)
#define RPG_GAMECORE_SETDYNAMICVALUEBYITEMNUM__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2E4130)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByItemNum_TypeDefinitionIndex = 20962;
