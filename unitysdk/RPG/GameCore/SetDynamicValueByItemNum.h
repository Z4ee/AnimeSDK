...
#define RPG_GAMECORE_SETDYNAMICVALUEBYITEMNUM_METHOD_3_221E13692E80D144_OFFSET UNITYSDK_OFFSET(0x19C42100)
#define RPG_GAMECORE_SETDYNAMICVALUEBYITEMNUM_METHOD_3_311376B4D342610B_OFFSET UNITYSDK_OFFSET(0x19C42170)
#define RPG_GAMECORE_SETDYNAMICVALUEBYITEMNUM__CTOR_OFFSET UNITYSDK_OFFSET(0x19C42140)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByItemNum_TypeDefinitionIndex = 20547;
