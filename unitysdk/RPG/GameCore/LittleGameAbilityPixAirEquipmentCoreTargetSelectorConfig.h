...
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREQUIPMENTCORETARGETSELECTORCONFIG_METHOD_3_3CBB5C5B998B5D9B_OFFSET UNITYSDK_OFFSET(0x19894C00)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREQUIPMENTCORETARGETSELECTORCONFIG_METHOD_3_C95ADABF6E742F0F_OFFSET UNITYSDK_OFFSET(0x19894D10)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREQUIPMENTCORETARGETSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19894D00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityPixAirEquipmentCoreTargetSelectorConfig_TypeDefinitionIndex = 20207;
