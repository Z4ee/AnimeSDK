...
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREQUIPMENTCORETARGETSELECTORCONFIG_METHOD_3_3CBB5C5B998B5D9B_OFFSET UNITYSDK_OFFSET(0x1B094670)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREQUIPMENTCORETARGETSELECTORCONFIG_METHOD_3_C95ADABF6E742F0F_OFFSET UNITYSDK_OFFSET(0x1B094780)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREQUIPMENTCORETARGETSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B094770)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityPixAirEquipmentCoreTargetSelectorConfig_TypeDefinitionIndex = 20581;
