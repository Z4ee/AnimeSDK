...
#define RPG_GAMECORE_ELFPROGRESSUPGRADE_METHOD_3_3B86E4AD0BE2B1E1_OFFSET UNITYSDK_OFFSET(0x1889D860)
#define RPG_GAMECORE_ELFPROGRESSUPGRADE_METHOD_3_D049FD46B7EBCDED_OFFSET UNITYSDK_OFFSET(0x1889D750)
#define RPG_GAMECORE_ELFPROGRESSUPGRADE__CTOR_OFFSET UNITYSDK_OFFSET(0x1889D830)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfProgressUpgrade_TypeDefinitionIndex = 20058;
