...
#define RPG_GAMECORE_ELFPROGRESSUPGRADE_METHOD_3_3B86E4AD0BE2B1E1_OFFSET UNITYSDK_OFFSET(0x1BB385A0)
#define RPG_GAMECORE_ELFPROGRESSUPGRADE_METHOD_3_CE79FCA192276164_OFFSET UNITYSDK_OFFSET(0x1BB384D0)
#define RPG_GAMECORE_ELFPROGRESSUPGRADE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB38590)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfProgressUpgrade_TypeDefinitionIndex = 20283;
