...
#define RPG_GAMECORE_ELFPROGRESSUPGRADE_METHOD_3_3B86E4AD0BE2B1E1_OFFSET UNITYSDK_OFFSET(0x196DBFD0)
#define RPG_GAMECORE_ELFPROGRESSUPGRADE_METHOD_3_D049FD46B7EBCDED_OFFSET UNITYSDK_OFFSET(0x196DBEC0)
#define RPG_GAMECORE_ELFPROGRESSUPGRADE__CTOR_OFFSET UNITYSDK_OFFSET(0x196DBFA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfProgressUpgrade_TypeDefinitionIndex = 19918;
