...
#define RPG_GAMECORE_ROGUEADVENTUREWOLFGUNSPECIALTARGETRUANMEICONFIG_METHOD_3_04040BA040946164_OFFSET UNITYSDK_OFFSET(0x1C4A0F30)
#define RPG_GAMECORE_ROGUEADVENTUREWOLFGUNSPECIALTARGETRUANMEICONFIG_METHOD_3_D3393B7B5C0476A0_OFFSET UNITYSDK_OFFSET(0x1C4A0EA0)
#define RPG_GAMECORE_ROGUEADVENTUREWOLFGUNSPECIALTARGETRUANMEICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4A0E90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueAdventureWolfGunSpecialTargetRuanMeiConfig_TypeDefinitionIndex = 17172;
