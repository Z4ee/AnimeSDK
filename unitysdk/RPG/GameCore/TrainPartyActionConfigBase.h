...
#define RPG_GAMECORE_TRAINPARTYACTIONCONFIGBASE_METHOD_4_2AB58978242DCA99_OFFSET UNITYSDK_OFFSET(0x1D532070)
#define RPG_GAMECORE_TRAINPARTYACTIONCONFIGBASE_METHOD_4_8A0F1449EE586A65_OFFSET UNITYSDK_OFFSET(0x1D531BB0)
#define RPG_GAMECORE_TRAINPARTYACTIONCONFIGBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D531410)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyActionConfigBase_TypeDefinitionIndex = 17859;
