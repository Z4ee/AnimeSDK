...
#define RPG_GAMECORE_TRAINPARTYACTIONCONFIGBASE_METHOD_4_2AB58978242DCA99_OFFSET UNITYSDK_OFFSET(0x178A77F0)
#define RPG_GAMECORE_TRAINPARTYACTIONCONFIGBASE_METHOD_4_8A0F1449EE586A65_OFFSET UNITYSDK_OFFSET(0x178A6ED0)
#define RPG_GAMECORE_TRAINPARTYACTIONCONFIGBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x178A64A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyActionConfigBase_TypeDefinitionIndex = 16579;
