...
#define RPG_GAMECORE_TRAINPARTYACTIONCONFIGBASE_METHOD_4_2AB58978242DCA99_OFFSET UNITYSDK_OFFSET(0x19DF1070)
#define RPG_GAMECORE_TRAINPARTYACTIONCONFIGBASE_METHOD_4_8A0F1449EE586A65_OFFSET UNITYSDK_OFFSET(0x19DF0700)
#define RPG_GAMECORE_TRAINPARTYACTIONCONFIGBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x19DEFD20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyActionConfigBase_TypeDefinitionIndex = 17180;
