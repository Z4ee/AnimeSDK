...
#define RPG_GAMECORE_HIPPLENREQUIREGOODSCONFIG_METHOD_2_A8D2C20A094D37C6_OFFSET UNITYSDK_OFFSET(0x172B0D10)
#define RPG_GAMECORE_HIPPLENREQUIREGOODSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x172B0ED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HipplenRequireGoodsConfig_TypeDefinitionIndex = 15382;
