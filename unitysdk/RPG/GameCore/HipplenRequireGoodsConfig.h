...
#define RPG_GAMECORE_HIPPLENREQUIREGOODSCONFIG_METHOD_2_A8D2C20A094D37C6_OFFSET UNITYSDK_OFFSET(0x18A05930)
#define RPG_GAMECORE_HIPPLENREQUIREGOODSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18A05AF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HipplenRequireGoodsConfig_TypeDefinitionIndex = 15902;
