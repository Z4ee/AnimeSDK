...
#define RPG_GAMECORE_HIPPLENREQUIREGOODSCONFIG_METHOD_2_A8D2C20A094D37C6_OFFSET UNITYSDK_OFFSET(0x1D193FA0)
#define RPG_GAMECORE_HIPPLENREQUIREGOODSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D194160)
