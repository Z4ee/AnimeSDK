...
#define RPG_GAMECORE_ROGUEPARAMBUFFCATEGORYCOUNTCONFIG_METHOD_6_365493FCE94318C7_OFFSET UNITYSDK_OFFSET(0x18D58610)
#define RPG_GAMECORE_ROGUEPARAMBUFFCATEGORYCOUNTCONFIG_METHOD_6_82FD797355ED2791_OFFSET UNITYSDK_OFFSET(0x18D58360)
#define RPG_GAMECORE_ROGUEPARAMBUFFCATEGORYCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D584E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamBuffCategoryCountConfig_TypeDefinitionIndex = 18811;
