...
#define RPG_GAMECORE_ROGUEPARAMBUFFCATEGORYCOUNTCONFIG_METHOD_6_365493FCE94318C7_OFFSET UNITYSDK_OFFSET(0x1D176660)
#define RPG_GAMECORE_ROGUEPARAMBUFFCATEGORYCOUNTCONFIG_METHOD_6_FA1ECE0DBCAA2543_OFFSET UNITYSDK_OFFSET(0x1D176610)
#define RPG_GAMECORE_ROGUEPARAMBUFFCATEGORYCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D176650)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamBuffCategoryCountConfig_TypeDefinitionIndex = 19057;
