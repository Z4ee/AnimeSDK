...
#define RPG_GAMECORE_PROPSTATECASECONTAINER_METHOD_3_3BB382A3CB312270_OFFSET UNITYSDK_OFFSET(0x1756EBF0)
#define RPG_GAMECORE_PROPSTATECASECONTAINER_METHOD_3_8729C230C75962B3_OFFSET UNITYSDK_OFFSET(0x1756EBB0)
#define RPG_GAMECORE_PROPSTATECASECONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x1756EBE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropStateCaseContainer_TypeDefinitionIndex = 16115;
