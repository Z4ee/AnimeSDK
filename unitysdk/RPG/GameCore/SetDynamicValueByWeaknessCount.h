...
#define RPG_GAMECORE_SETDYNAMICVALUEBYWEAKNESSCOUNT_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1D4F9710)
#define RPG_GAMECORE_SETDYNAMICVALUEBYWEAKNESSCOUNT_METHOD_4_02282635974001D9_OFFSET UNITYSDK_OFFSET(0x1D4F9440)
#define RPG_GAMECORE_SETDYNAMICVALUEBYWEAKNESSCOUNT_METHOD_4_0F94C1F7F2903547_OFFSET UNITYSDK_OFFSET(0x1D4F9480)
#define RPG_GAMECORE_SETDYNAMICVALUEBYWEAKNESSCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4F9470)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByWeaknessCount_TypeDefinitionIndex = 22858;
