...
#define RPG_GAMECORE_SETDYNAMICVALUEBYWEAKNESSCOUNT_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x19C48030)
#define RPG_GAMECORE_SETDYNAMICVALUEBYWEAKNESSCOUNT_METHOD_4_0F94C1F7F2903547_OFFSET UNITYSDK_OFFSET(0x19C47DA0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYWEAKNESSCOUNT_METHOD_4_97746A959AAB953B_OFFSET UNITYSDK_OFFSET(0x19C47CD0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYWEAKNESSCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x19C47D50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByWeaknessCount_TypeDefinitionIndex = 21862;
