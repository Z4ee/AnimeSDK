...
#define RPG_GAMECORE_SETDYNAMICVALUEBYWEAKNESSCOUNT_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x18E2B310)
#define RPG_GAMECORE_SETDYNAMICVALUEBYWEAKNESSCOUNT_METHOD_4_0F94C1F7F2903547_OFFSET UNITYSDK_OFFSET(0x18E2B080)
#define RPG_GAMECORE_SETDYNAMICVALUEBYWEAKNESSCOUNT_METHOD_4_97746A959AAB953B_OFFSET UNITYSDK_OFFSET(0x18E2AFB0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYWEAKNESSCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x18E2B030)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByWeaknessCount_TypeDefinitionIndex = 22058;
