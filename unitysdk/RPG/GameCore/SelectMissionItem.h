...
#define RPG_GAMECORE_SELECTMISSIONITEM_METHOD_3_B3685B6B58604B7C_OFFSET UNITYSDK_OFFSET(0x1C2CA1B0)
#define RPG_GAMECORE_SELECTMISSIONITEM_METHOD_3_E7A39919BF8B2939_OFFSET UNITYSDK_OFFSET(0x1C2CA090)
#define RPG_GAMECORE_SELECTMISSIONITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2CA130)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SelectMissionItem_TypeDefinitionIndex = 19663;
