...
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMAGICUNITSELECTLEVELUPCONFIG_METHOD_6_1BEA7FB787633216_OFFSET UNITYSDK_OFFSET(0x175CCF20)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMAGICUNITSELECTLEVELUPCONFIG_METHOD_6_2E40A9A6747C3973_OFFSET UNITYSDK_OFFSET(0x175CCD00)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMAGICUNITSELECTLEVELUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175CCE40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActTriggerRogueMagicUnitSelectLevelUpConfig_TypeDefinitionIndex = 18037;
