...
#define RPG_GAMECORE_SETDYNAMICVALUEBYBEHAVIORFLAGCOUNT_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1E81A9A0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBEHAVIORFLAGCOUNT_METHOD_4_03CFE0D95FE20D2E_OFFSET UNITYSDK_OFFSET(0x1E81A7B0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBEHAVIORFLAGCOUNT_METHOD_4_498FEC7DD022B7C3_OFFSET UNITYSDK_OFFSET(0x1E81A770)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBEHAVIORFLAGCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E81A7A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByBehaviorFlagCount_TypeDefinitionIndex = 23316;
