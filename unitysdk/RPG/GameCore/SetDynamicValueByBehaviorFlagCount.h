...
#define RPG_GAMECORE_SETDYNAMICVALUEBYBEHAVIORFLAGCOUNT_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x176C09D0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBEHAVIORFLAGCOUNT_METHOD_4_03CFE0D95FE20D2E_OFFSET UNITYSDK_OFFSET(0x176B85A0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBEHAVIORFLAGCOUNT_METHOD_4_914BA2A66C607CF2_OFFSET UNITYSDK_OFFSET(0x176C0950)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBEHAVIORFLAGCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x176B8550)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByBehaviorFlagCount_TypeDefinitionIndex = 21821;
