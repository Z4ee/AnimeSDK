...
#define RPG_GAMECORE_SETDYNAMICVALUEBYBEHAVIORFLAGCOUNT_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x19C40820)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBEHAVIORFLAGCOUNT_METHOD_4_03CFE0D95FE20D2E_OFFSET UNITYSDK_OFFSET(0x19C37630)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBEHAVIORFLAGCOUNT_METHOD_4_914BA2A66C607CF2_OFFSET UNITYSDK_OFFSET(0x19C407A0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBEHAVIORFLAGCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x19C375E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByBehaviorFlagCount_TypeDefinitionIndex = 22298;
