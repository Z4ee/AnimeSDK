...
#define RPG_GAMECORE_SETUPACTIONDELAYLINK_METHOD_3_41470E85B2C97C30_OFFSET UNITYSDK_OFFSET(0x18E4CC70)
#define RPG_GAMECORE_SETUPACTIONDELAYLINK_METHOD_3_47E0FE9C4640EF3F_OFFSET UNITYSDK_OFFSET(0x18E4CBF0)
#define RPG_GAMECORE_SETUPACTIONDELAYLINK__CTOR_OFFSET UNITYSDK_OFFSET(0x18E4CC40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetupActionDelayLink_TypeDefinitionIndex = 22242;
