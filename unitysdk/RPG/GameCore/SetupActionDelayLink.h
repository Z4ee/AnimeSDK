...
#define RPG_GAMECORE_SETUPACTIONDELAYLINK_METHOD_3_41470E85B2C97C30_OFFSET UNITYSDK_OFFSET(0x176E9620)
#define RPG_GAMECORE_SETUPACTIONDELAYLINK_METHOD_3_47E0FE9C4640EF3F_OFFSET UNITYSDK_OFFSET(0x176E95A0)
#define RPG_GAMECORE_SETUPACTIONDELAYLINK__CTOR_OFFSET UNITYSDK_OFFSET(0x176E95F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetupActionDelayLink_TypeDefinitionIndex = 21506;
