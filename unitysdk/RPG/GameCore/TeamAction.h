...
#define RPG_GAMECORE_TEAMACTION_METHOD_3_16BCFFDAA32329EC_OFFSET UNITYSDK_OFFSET(0x19DDAB80)
#define RPG_GAMECORE_TEAMACTION_METHOD_3_446FB9923CAD2F4E_OFFSET UNITYSDK_OFFSET(0x19DDAC10)
#define RPG_GAMECORE_TEAMACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19DDABE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TeamAction_TypeDefinitionIndex = 21885;
