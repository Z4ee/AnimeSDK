...
#define RPG_GAMECORE_ALLEYDESKTALKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16F6F5C0)
#define RPG_GAMECORE_ALLEYDESKTALKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16F6FCE0)
