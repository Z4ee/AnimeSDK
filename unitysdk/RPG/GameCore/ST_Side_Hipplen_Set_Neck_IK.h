...
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_SET_NECK_IK_METHOD_4_845C245A6E96976A_OFFSET UNITYSDK_OFFSET(0x1D4D12A0)
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_SET_NECK_IK_METHOD_4_B68F3EB8F899409F_OFFSET UNITYSDK_OFFSET(0x1D4D12E0)
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_SET_NECK_IK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4D12D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_Hipplen_Set_Neck_IK_TypeDefinitionIndex = 21069;
