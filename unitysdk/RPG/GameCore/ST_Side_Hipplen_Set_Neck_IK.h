...
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_SET_NECK_IK_METHOD_4_95D2EFFD972EEA1B_OFFSET UNITYSDK_OFFSET(0x17699210)
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_SET_NECK_IK_METHOD_4_B68F3EB8F899409F_OFFSET UNITYSDK_OFFSET(0x1768CA00)
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_SET_NECK_IK__CTOR_OFFSET UNITYSDK_OFFSET(0x1768C9B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_Hipplen_Set_Neck_IK_TypeDefinitionIndex = 19615;
