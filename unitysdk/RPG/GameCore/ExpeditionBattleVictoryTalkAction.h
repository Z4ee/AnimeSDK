...
#define RPG_GAMECORE_EXPEDITIONBATTLEVICTORYTALKACTION_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1D083170)
#define RPG_GAMECORE_EXPEDITIONBATTLEVICTORYTALKACTION_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D0830D0)
#define RPG_GAMECORE_EXPEDITIONBATTLEVICTORYTALKACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D083160)
