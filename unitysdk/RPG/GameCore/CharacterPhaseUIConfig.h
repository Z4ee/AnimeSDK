...
#define RPG_GAMECORE_CHARACTERPHASEUICONFIG_METHOD_2_F9435E94D978FDAB_OFFSET UNITYSDK_OFFSET(0x17070790)
#define RPG_GAMECORE_CHARACTERPHASEUICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17070990)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterPhaseUIConfig_TypeDefinitionIndex = 15116;
