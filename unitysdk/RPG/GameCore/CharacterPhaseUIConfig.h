...
#define RPG_GAMECORE_CHARACTERPHASEUICONFIG_METHOD_2_F9435E94D978FDAB_OFFSET UNITYSDK_OFFSET(0x19613120)
#define RPG_GAMECORE_CHARACTERPHASEUICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19613330)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterPhaseUIConfig_TypeDefinitionIndex = 15683;
