...
#define RPG_GAMECORE_CHARACTERPHASEUICONFIG_METHOD_2_F9435E94D978FDAB_OFFSET UNITYSDK_OFFSET(0x1B728DB0)
#define RPG_GAMECORE_CHARACTERPHASEUICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B728FC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterPhaseUIConfig_TypeDefinitionIndex = 15856;
