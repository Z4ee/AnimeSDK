...
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAROOMCARDUNIQUETYPECONFIG_METHOD_3_97A7717164AE263E_OFFSET UNITYSDK_OFFSET(0x17637BA0)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAROOMCARDUNIQUETYPECONFIG_METHOD_3_AF8A0B3314722027_OFFSET UNITYSDK_OFFSET(0x17637AD0)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAROOMCARDUNIQUETYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17637B50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierPersonaRoomCardUniqueTypeConfig_TypeDefinitionIndex = 16368;
