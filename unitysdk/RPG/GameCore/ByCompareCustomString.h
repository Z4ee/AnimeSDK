...
#define RPG_GAMECORE_BYCOMPARECUSTOMSTRING_METHOD_4_18416825FC03508D_OFFSET UNITYSDK_OFFSET(0x19CDBCA0)
#define RPG_GAMECORE_BYCOMPARECUSTOMSTRING_METHOD_4_1F12AABEE37CC8D6_OFFSET UNITYSDK_OFFSET(0x19CDBA50)
#define RPG_GAMECORE_BYCOMPARECUSTOMSTRING_METHOD_4_26D82281C98CCF17_OFFSET UNITYSDK_OFFSET(0x19CDBA10)
#define RPG_GAMECORE_BYCOMPARECUSTOMSTRING_METHOD_4_9CF4849E7A4BBFEA_OFFSET UNITYSDK_OFFSET(0x19CDBC70)
#define RPG_GAMECORE_BYCOMPARECUSTOMSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x19CDBA40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareCustomString_TypeDefinitionIndex = 22946;
