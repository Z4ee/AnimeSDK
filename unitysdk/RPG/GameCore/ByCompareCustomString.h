...
#define RPG_GAMECORE_BYCOMPARECUSTOMSTRING_METHOD_4_1F12AABEE37CC8D6_OFFSET UNITYSDK_OFFSET(0x1872A9E0)
#define RPG_GAMECORE_BYCOMPARECUSTOMSTRING_METHOD_4_211C2282FC9A9CFB_OFFSET UNITYSDK_OFFSET(0x1872A910)
#define RPG_GAMECORE_BYCOMPARECUSTOMSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1872A990)
