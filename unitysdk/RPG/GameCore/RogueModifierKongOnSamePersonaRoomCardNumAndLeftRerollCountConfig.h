...
#define RPG_GAMECORE_ROGUEMODIFIERKONGONSAMEPERSONAROOMCARDNUMANDLEFTREROLLCOUNTCONFIG_METHOD_3_96419071E7E84E8F_OFFSET UNITYSDK_OFFSET(0x17632980)
#define RPG_GAMECORE_ROGUEMODIFIERKONGONSAMEPERSONAROOMCARDNUMANDLEFTREROLLCOUNTCONFIG_METHOD_3_C0B649DFA3010066_OFFSET UNITYSDK_OFFSET(0x17632A50)
#define RPG_GAMECORE_ROGUEMODIFIERKONGONSAMEPERSONAROOMCARDNUMANDLEFTREROLLCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17632A00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierKongOnSamePersonaRoomCardNumAndLeftRerollCountConfig_TypeDefinitionIndex = 16364;
