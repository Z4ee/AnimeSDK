...
#define RPG_GAMECORE_ROGUEMODIFIERKONGONSAMEPERSONAROOMCARDNUMANDLEFTREROLLCOUNTCONFIG_METHOD_3_5A407A1A74252A0A_OFFSET UNITYSDK_OFFSET(0x1CFC1460)
#define RPG_GAMECORE_ROGUEMODIFIERKONGONSAMEPERSONAROOMCARDNUMANDLEFTREROLLCOUNTCONFIG_METHOD_3_C0B649DFA3010066_OFFSET UNITYSDK_OFFSET(0x1CFC14B0)
#define RPG_GAMECORE_ROGUEMODIFIERKONGONSAMEPERSONAROOMCARDNUMANDLEFTREROLLCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFC14A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierKongOnSamePersonaRoomCardNumAndLeftRerollCountConfig_TypeDefinitionIndex = 17095;
