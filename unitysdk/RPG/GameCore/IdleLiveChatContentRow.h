...
#define RPG_GAMECORE_IDLELIVECHATCONTENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D20E900)
#define RPG_GAMECORE_IDLELIVECHATCONTENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D20EB10)
