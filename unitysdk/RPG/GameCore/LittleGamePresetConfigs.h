...
#define RPG_GAMECORE_LITTLEGAMEPRESETCONFIGS_METHOD_2_D99EB94DD1EB7C29_OFFSET UNITYSDK_OFFSET(0x1D2051F0)
#define RPG_GAMECORE_LITTLEGAMEPRESETCONFIGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D205310)
