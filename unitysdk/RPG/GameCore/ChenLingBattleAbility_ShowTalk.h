...
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_SHOWTALK_METHOD_3_0F4766B42B59ED9D_OFFSET UNITYSDK_OFFSET(0x1E008B90)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_SHOWTALK_METHOD_3_16E4F92B31FF9B1D_OFFSET UNITYSDK_OFFSET(0x1E008B30)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_SHOWTALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1E008B80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleAbility_ShowTalk_TypeDefinitionIndex = 15645;
