...
#define RPG_GAMECORE_ELFGLOBALEFFECTCONFIG_METHOD_2_44ED9DD5C0C7B62B_OFFSET UNITYSDK_OFFSET(0x196DACC0)
#define RPG_GAMECORE_ELFGLOBALEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x196DADF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfGlobalEffectConfig_TypeDefinitionIndex = 17550;
