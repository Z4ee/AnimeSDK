...
#define RPG_GAMECORE_ROGUEACTCHANGEROGUECOINBYPARAMCONFIG_METHOD_6_5E758E1B1BFB15CF_OFFSET UNITYSDK_OFFSET(0x1EE84CA0)
#define RPG_GAMECORE_ROGUEACTCHANGEROGUECOINBYPARAMCONFIG_METHOD_6_FA6BFB359954EE93_OFFSET UNITYSDK_OFFSET(0x1EE84CF0)
#define RPG_GAMECORE_ROGUEACTCHANGEROGUECOINBYPARAMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EE84CE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActChangeRogueCoinByParamConfig_TypeDefinitionIndex = 19389;
