...
#define RPG_GAMECORE_B51RACINGTRACKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CE5EDC0)
#define RPG_GAMECORE_B51RACINGTRACKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE5F170)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* MinimapPath_Dark; // 0x20
		::System::String* LittleGameConfig; // 0x28
		::RPG::Client::TextID RecordDriverName; // 0x30
		::System::Single RecordTime; // 0x40
