...
#define RPG_GAMECORE_SETGRIDFIGHTBEENERGYBARSTATE_METHOD_3_9F8BBF54F9031FC8_OFFSET UNITYSDK_OFFSET(0x18E33A40)
#define RPG_GAMECORE_SETGRIDFIGHTBEENERGYBARSTATE_METHOD_3_CE8BA87F034891F7_OFFSET UNITYSDK_OFFSET(0x18E338B0)
#define RPG_GAMECORE_SETGRIDFIGHTBEENERGYBARSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E338F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetGridFightBEEnergyBarState_TypeDefinitionIndex = 21412;
