...
#define RPG_GAMECORE_SETGRIDFIGHTBEENERGYBARSTATE_METHOD_3_9F8BBF54F9031FC8_OFFSET UNITYSDK_OFFSET(0x1C5FB990)
#define RPG_GAMECORE_SETGRIDFIGHTBEENERGYBARSTATE_METHOD_3_CE8BA87F034891F7_OFFSET UNITYSDK_OFFSET(0x1C5FB820)
#define RPG_GAMECORE_SETGRIDFIGHTBEENERGYBARSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5FB860)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetGridFightBEEnergyBarState_TypeDefinitionIndex = 21713;
