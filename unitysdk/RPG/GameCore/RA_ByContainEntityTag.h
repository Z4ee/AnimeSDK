...
#define RPG_GAMECORE_RA_BYCONTAINENTITYTAG_METHOD_4_16E1BD2990CF8025_OFFSET UNITYSDK_OFFSET(0x1B9AED70)
#define RPG_GAMECORE_RA_BYCONTAINENTITYTAG_METHOD_4_2E2F07294B8E0358_OFFSET UNITYSDK_OFFSET(0x1B9AEFB0)
#define RPG_GAMECORE_RA_BYCONTAINENTITYTAG_METHOD_4_8ED048FE1FFFC998_OFFSET UNITYSDK_OFFSET(0x1B9AEDB0)
#define RPG_GAMECORE_RA_BYCONTAINENTITYTAG_METHOD_4_B419588616294EBE_OFFSET UNITYSDK_OFFSET(0x1B9AEF80)
#define RPG_GAMECORE_RA_BYCONTAINENTITYTAG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9AEDA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RA_ByContainEntityTag_TypeDefinitionIndex = 19273;
