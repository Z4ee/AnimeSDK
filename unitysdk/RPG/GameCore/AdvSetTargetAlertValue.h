...
#define RPG_GAMECORE_ADVSETTARGETALERTVALUE_METHOD_3_5AA79FFDD7850D0C_OFFSET UNITYSDK_OFFSET(0x194387E0)
#define RPG_GAMECORE_ADVSETTARGETALERTVALUE_METHOD_3_E1D533264CD8D52E_OFFSET UNITYSDK_OFFSET(0x19438930)
#define RPG_GAMECORE_ADVSETTARGETALERTVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x194388A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSetTargetAlertValue_TypeDefinitionIndex = 19206;
