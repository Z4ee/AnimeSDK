...
#define RPG_GAMECORE_ADVSETTARGETALERTVALUE_METHOD_3_5AA79FFDD7850D0C_OFFSET UNITYSDK_OFFSET(0x18664EB0)
#define RPG_GAMECORE_ADVSETTARGETALERTVALUE_METHOD_3_E1D533264CD8D52E_OFFSET UNITYSDK_OFFSET(0x18665000)
#define RPG_GAMECORE_ADVSETTARGETALERTVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x18664F70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSetTargetAlertValue_TypeDefinitionIndex = 19290;
