...
#define RPG_GAMECORE_ADVSETTARGETALERTVALUE_METHOD_3_5A36E5D7F30B9094_OFFSET UNITYSDK_OFFSET(0x1BE2EAC0)
#define RPG_GAMECORE_ADVSETTARGETALERTVALUE_METHOD_3_E1D533264CD8D52E_OFFSET UNITYSDK_OFFSET(0x1BE2EB40)
#define RPG_GAMECORE_ADVSETTARGETALERTVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE2EB10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSetTargetAlertValue_TypeDefinitionIndex = 19562;
