...
#define RPG_GAMECORE_HELIOBUSACTIVITYQUESTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D17E900)
#define RPG_GAMECORE_HELIOBUSACTIVITYQUESTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D17F010)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HeliobusActivityQuestRow_TypeDefinitionIndex = 13652;
