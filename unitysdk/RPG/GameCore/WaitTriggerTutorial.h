...
#define RPG_GAMECORE_WAITTRIGGERTUTORIAL_METHOD_3_508835BA9D876EA6_OFFSET UNITYSDK_OFFSET(0x1910AFD0)
#define RPG_GAMECORE_WAITTRIGGERTUTORIAL_METHOD_3_E12B26EEF297DD8F_OFFSET UNITYSDK_OFFSET(0x1910AF50)
#define RPG_GAMECORE_WAITTRIGGERTUTORIAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1910AFA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitTriggerTutorial_TypeDefinitionIndex = 23388;
