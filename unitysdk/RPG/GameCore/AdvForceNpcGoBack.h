...
#define RPG_GAMECORE_ADVFORCENPCGOBACK_METHOD_3_DB4844A03491DE0F_OFFSET UNITYSDK_OFFSET(0x19425270)
#define RPG_GAMECORE_ADVFORCENPCGOBACK_METHOD_3_E027A13F72D7EBD0_OFFSET UNITYSDK_OFFSET(0x194252F0)
#define RPG_GAMECORE_ADVFORCENPCGOBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x194252C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvForceNpcGoBack_TypeDefinitionIndex = 20738;
