...
#define RPG_GAMECORE_ADVFORCENPCGOBACK_METHOD_3_E027A13F72D7EBD0_OFFSET UNITYSDK_OFFSET(0x1BE1D840)
#define RPG_GAMECORE_ADVFORCENPCGOBACK_METHOD_3_E417802D2DFB9FA5_OFFSET UNITYSDK_OFFSET(0x1BE1D800)
#define RPG_GAMECORE_ADVFORCENPCGOBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE1D830)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvForceNpcGoBack_TypeDefinitionIndex = 21153;
