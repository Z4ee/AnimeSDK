...
#define RPG_GAMECORE_ROGUEDLCAEONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18D01A50)
#define RPG_GAMECORE_ROGUEDLCAEONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18D02700)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueDLCAeonRow_TypeDefinitionIndex = 13938;
	...
	public:
		...
		::Il2CppArray<::System::UInt32>* EffectParam1; // 0x20
		...
		::Il2CppArray<::RPG::GameCore::FixPoint>* DescParam; // 0x40
		::System::UInt32 BattleEventBuffGroup; // 0x48
		::System::UInt32 BattleEventEnhanceBuffGroup; // 0x4C
		::RPG::GameCore::ModifierEffectType EffectType1; // 0x50
		...
		::RPG::GameCore::ModifierEffectType EffectType3; // 0x88
		::System::UInt32 AeonDiceID; // 0x8C
		::RPG::Client::TextID EffectDesc1; // 0x90
		::System::UInt32 RogueAeonDisplayID; // 0xA0
		::RPG::GameCore::ModifierEffectType EffectType2; // 0xA4
		::System::UInt32 AeonID; // 0xA8
		::System::UInt32 Sort; // 0xAC
		::System::UInt32 RogueBuffType; // 0xB0
