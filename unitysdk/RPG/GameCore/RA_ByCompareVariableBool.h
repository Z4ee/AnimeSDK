...
#define RPG_GAMECORE_RA_BYCOMPAREVARIABLEBOOL_METHOD_4_B370DA1DB4D71999_OFFSET UNITYSDK_OFFSET(0x1B9ADF10)
#define RPG_GAMECORE_RA_BYCOMPAREVARIABLEBOOL_METHOD_4_B4A3EDD418568100_OFFSET UNITYSDK_OFFSET(0x1B9ADD00)
#define RPG_GAMECORE_RA_BYCOMPAREVARIABLEBOOL_METHOD_4_EEB0120F93665326_OFFSET UNITYSDK_OFFSET(0x1B9ADEE0)
#define RPG_GAMECORE_RA_BYCOMPAREVARIABLEBOOL_METHOD_4_EFCEAABF502854AD_OFFSET UNITYSDK_OFFSET(0x1B9ADCC0)
#define RPG_GAMECORE_RA_BYCOMPAREVARIABLEBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9ADCF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RA_ByCompareVariableBool_TypeDefinitionIndex = 19277;
