...
#define RPG_GAMECORE_RA_BYCOMPAREVARIABLEBOOL_METHOD_4_1F68FDEF17ADF4E8_OFFSET UNITYSDK_OFFSET(0x17578E70)
#define RPG_GAMECORE_RA_BYCOMPAREVARIABLEBOOL_METHOD_4_B4A3EDD418568100_OFFSET UNITYSDK_OFFSET(0x17578F40)
#define RPG_GAMECORE_RA_BYCOMPAREVARIABLEBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x17578EF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RA_ByCompareVariableBool_TypeDefinitionIndex = 18326;
