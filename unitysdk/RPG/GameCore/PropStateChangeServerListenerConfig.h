...
#define RPG_GAMECORE_PROPSTATECHANGESERVERLISTENERCONFIG_METHOD_3_1713B7DFE5B87298_OFFSET UNITYSDK_OFFSET(0x1756F120)
#define RPG_GAMECORE_PROPSTATECHANGESERVERLISTENERCONFIG_METHOD_3_8A22794A92C5A9BF_OFFSET UNITYSDK_OFFSET(0x1756F0B0)
#define RPG_GAMECORE_PROPSTATECHANGESERVERLISTENERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1756F0F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropStateChangeServerListenerConfig_TypeDefinitionIndex = 18696;
