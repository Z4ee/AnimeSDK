...
#define RPG_GAMECORE_PROPSTATECHANGESERVERLISTENERCONFIG_METHOD_3_1713B7DFE5B87298_OFFSET UNITYSDK_OFFSET(0x19A9BDE0)
#define RPG_GAMECORE_PROPSTATECHANGESERVERLISTENERCONFIG_METHOD_3_8A22794A92C5A9BF_OFFSET UNITYSDK_OFFSET(0x19A9BD70)
#define RPG_GAMECORE_PROPSTATECHANGESERVERLISTENERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19A9BDB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropStateChangeServerListenerConfig_TypeDefinitionIndex = 19261;
