...
#define RPG_GAMECORE_FIVEDIMPLAYERSKILLARROWCONDITION_METHOD_3_07D73D0450C75F2C_OFFSET UNITYSDK_OFFSET(0x1BEA9B40)
#define RPG_GAMECORE_FIVEDIMPLAYERSKILLARROWCONDITION_METHOD_3_6B258563420F6941_OFFSET UNITYSDK_OFFSET(0x1BEA9AC0)
#define RPG_GAMECORE_FIVEDIMPLAYERSKILLARROWCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEA9B30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimPlayerSkillArrowCondition_TypeDefinitionIndex = 18064;
