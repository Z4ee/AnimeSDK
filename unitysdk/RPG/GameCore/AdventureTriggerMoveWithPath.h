...
#define RPG_GAMECORE_ADVENTURETRIGGERMOVEWITHPATH_METHOD_3_6512DE8FB15A6ECF_OFFSET UNITYSDK_OFFSET(0x19456E30)
#define RPG_GAMECORE_ADVENTURETRIGGERMOVEWITHPATH_METHOD_3_E601C3A0FFC65FC7_OFFSET UNITYSDK_OFFSET(0x19456F50)
#define RPG_GAMECORE_ADVENTURETRIGGERMOVEWITHPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x19456ED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureTriggerMoveWithPath_TypeDefinitionIndex = 20418;
