...
#define RPG_GAMECORE_ADVENTURETRIGGERMOVEWITHPATH_METHOD_3_6512DE8FB15A6ECF_OFFSET UNITYSDK_OFFSET(0x1CBC1400)
#define RPG_GAMECORE_ADVENTURETRIGGERMOVEWITHPATH_METHOD_3_E601C3A0FFC65FC7_OFFSET UNITYSDK_OFFSET(0x1CBC14E0)
#define RPG_GAMECORE_ADVENTURETRIGGERMOVEWITHPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1CBC1480)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureTriggerMoveWithPath_TypeDefinitionIndex = 21389;
