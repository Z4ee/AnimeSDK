...
#define RPG_GAMECORE_ADVENTURETRIGGERMOVEWITHPATH_METHOD_3_6512DE8FB15A6ECF_OFFSET UNITYSDK_OFFSET(0x1AE65580)
#define RPG_GAMECORE_ADVENTURETRIGGERMOVEWITHPATH_METHOD_3_E601C3A0FFC65FC7_OFFSET UNITYSDK_OFFSET(0x1AE65660)
#define RPG_GAMECORE_ADVENTURETRIGGERMOVEWITHPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE65600)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureTriggerMoveWithPath_TypeDefinitionIndex = 20833;
