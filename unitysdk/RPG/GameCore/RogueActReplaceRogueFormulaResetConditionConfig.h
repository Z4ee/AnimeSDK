...
#define RPG_GAMECORE_ROGUEACTREPLACEROGUEFORMULARESETCONDITIONCONFIG_METHOD_6_2D87CCD981D70520_OFFSET UNITYSDK_OFFSET(0x19AF7E50)
#define RPG_GAMECORE_ROGUEACTREPLACEROGUEFORMULARESETCONDITIONCONFIG_METHOD_6_909FA9A96A2E252D_OFFSET UNITYSDK_OFFSET(0x19AF7C30)
#define RPG_GAMECORE_ROGUEACTREPLACEROGUEFORMULARESETCONDITIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AF7D70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActReplaceRogueFormulaResetConditionConfig_TypeDefinitionIndex = 18625;
