...
#define RPG_GAMECORE_ROGUEACTREPLACEROGUEFORMULARESETCONDITIONCONFIG_METHOD_6_2D87CCD981D70520_OFFSET UNITYSDK_OFFSET(0x1C49DE30)
#define RPG_GAMECORE_ROGUEACTREPLACEROGUEFORMULARESETCONDITIONCONFIG_METHOD_6_5E529CFE6666EFE4_OFFSET UNITYSDK_OFFSET(0x1C49DDE0)
#define RPG_GAMECORE_ROGUEACTREPLACEROGUEFORMULARESETCONDITIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C49DE20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActReplaceRogueFormulaResetConditionConfig_TypeDefinitionIndex = 18901;
