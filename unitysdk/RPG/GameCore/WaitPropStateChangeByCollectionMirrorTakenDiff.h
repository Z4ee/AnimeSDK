...
#define RPG_GAMECORE_WAITPROPSTATECHANGEBYCOLLECTIONMIRRORTAKENDIFF_METHOD_3_5063EEE4E7C375CB_OFFSET UNITYSDK_OFFSET(0x1DEBF460)
#define RPG_GAMECORE_WAITPROPSTATECHANGEBYCOLLECTIONMIRRORTAKENDIFF_METHOD_3_F0B7A18C5DDEE618_OFFSET UNITYSDK_OFFSET(0x1DEBF4A0)
#define RPG_GAMECORE_WAITPROPSTATECHANGEBYCOLLECTIONMIRRORTAKENDIFF__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEBF490)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitPropStateChangeByCollectionMirrorTakenDiff_TypeDefinitionIndex = 20176;
