...
#define RPG_GAMECORE_ROGUEADVENTURETURNTABLECONFIG_METHOD_3_944E3DDC60398E2E_OFFSET UNITYSDK_OFFSET(0x18CE7980)
#define RPG_GAMECORE_ROGUEADVENTURETURNTABLECONFIG_METHOD_3_AE4F95DA51CD5FEA_OFFSET UNITYSDK_OFFSET(0x18CE7150)
#define RPG_GAMECORE_ROGUEADVENTURETURNTABLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CE7140)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueAdventureTurntableConfig_TypeDefinitionIndex = 16989;
