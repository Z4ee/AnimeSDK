...
#define RPG_GAMECORE_ROGUEADVENTURETURNTABLECONFIG_METHOD_3_944E3DDC60398E2E_OFFSET UNITYSDK_OFFSET(0x1C4A0B80)
#define RPG_GAMECORE_ROGUEADVENTURETURNTABLECONFIG_METHOD_3_AE4F95DA51CD5FEA_OFFSET UNITYSDK_OFFSET(0x1C4A0380)
#define RPG_GAMECORE_ROGUEADVENTURETURNTABLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4A0370)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueAdventureTurntableConfig_TypeDefinitionIndex = 17166;
