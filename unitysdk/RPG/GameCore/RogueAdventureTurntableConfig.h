...
#define RPG_GAMECORE_ROGUEADVENTURETURNTABLECONFIG_METHOD_3_944E3DDC60398E2E_OFFSET UNITYSDK_OFFSET(0x175DC9D0)
#define RPG_GAMECORE_ROGUEADVENTURETURNTABLECONFIG_METHOD_3_AE4F95DA51CD5FEA_OFFSET UNITYSDK_OFFSET(0x175DC1A0)
#define RPG_GAMECORE_ROGUEADVENTURETURNTABLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175DC190)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueAdventureTurntableConfig_TypeDefinitionIndex = 16435;
