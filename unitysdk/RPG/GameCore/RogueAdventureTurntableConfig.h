...
#define RPG_GAMECORE_ROGUEADVENTURETURNTABLECONFIG_METHOD_3_944E3DDC60398E2E_OFFSET UNITYSDK_OFFSET(0x19B0D370)
#define RPG_GAMECORE_ROGUEADVENTURETURNTABLECONFIG_METHOD_3_AE4F95DA51CD5FEA_OFFSET UNITYSDK_OFFSET(0x19B0CB40)
#define RPG_GAMECORE_ROGUEADVENTURETURNTABLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B0CB30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueAdventureTurntableConfig_TypeDefinitionIndex = 17004;
