...
#define RPG_GAMECORE_FIVEDIMVCAMERABLENDCONFIG_METHOD_2_02E8DBF4CDCFC6EA_OFFSET UNITYSDK_OFFSET(0x1975B2F0)
#define RPG_GAMECORE_FIVEDIMVCAMERABLENDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1975D920)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimVCameraBlendConfig_TypeDefinitionIndex = 17712;
