...
#define RPG_GAMECORE_VCAMERAMODECHANGE_METHOD_3_561256F424EC6811_OFFSET UNITYSDK_OFFSET(0x178EDA30)
#define RPG_GAMECORE_VCAMERAMODECHANGE_METHOD_3_760DD6AD373D4D52_OFFSET UNITYSDK_OFFSET(0x178ED9B0)
#define RPG_GAMECORE_VCAMERAMODECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x178EDA00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VCameraModeChange_TypeDefinitionIndex = 20643;
