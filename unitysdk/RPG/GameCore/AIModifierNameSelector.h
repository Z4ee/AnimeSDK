...
#define RPG_GAMECORE_AIMODIFIERNAMESELECTOR_METHOD_3_C1D5DA2052202F2D_OFFSET UNITYSDK_OFFSET(0x1B9F4FE0)
#define RPG_GAMECORE_AIMODIFIERNAMESELECTOR_METHOD_3_FE708AB4F663429F_OFFSET UNITYSDK_OFFSET(0x1B9F4F00)
#define RPG_GAMECORE_AIMODIFIERNAMESELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9F4F80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AIModifierNameSelector_TypeDefinitionIndex = 14990;
