...
#define RPG_GAMECORE_AIMODIFIERNAMESELECTOR_METHOD_3_C1D5DA2052202F2D_OFFSET UNITYSDK_OFFSET(0x1D323A00)
#define RPG_GAMECORE_AIMODIFIERNAMESELECTOR_METHOD_3_FE708AB4F663429F_OFFSET UNITYSDK_OFFSET(0x1D323920)
#define RPG_GAMECORE_AIMODIFIERNAMESELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3239A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AIModifierNameSelector_TypeDefinitionIndex = 15426;
