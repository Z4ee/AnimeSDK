...
#define RPG_GAMECORE_SETMONSTERPHASEPOINTPREFAB_METHOD_3_4302F6AD92ADA9BA_OFFSET UNITYSDK_OFFSET(0x1C602CE0)
#define RPG_GAMECORE_SETMONSTERPHASEPOINTPREFAB_METHOD_3_8492CC7A052AB96D_OFFSET UNITYSDK_OFFSET(0x1C602D20)
#define RPG_GAMECORE_SETMONSTERPHASEPOINTPREFAB__CTOR_OFFSET UNITYSDK_OFFSET(0x1C602D10)
