...
#define RPG_GAMECORE_SETMONSTERPHASEPOINTPREFAB_METHOD_3_5AFA1412A58683B1_OFFSET UNITYSDK_OFFSET(0x19C58670)
#define RPG_GAMECORE_SETMONSTERPHASEPOINTPREFAB_METHOD_3_8492CC7A052AB96D_OFFSET UNITYSDK_OFFSET(0x19C586F0)
#define RPG_GAMECORE_SETMONSTERPHASEPOINTPREFAB__CTOR_OFFSET UNITYSDK_OFFSET(0x19C586C0)
