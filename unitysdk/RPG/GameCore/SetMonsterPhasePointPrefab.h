...
#define RPG_GAMECORE_SETMONSTERPHASEPOINTPREFAB_METHOD_3_5AFA1412A58683B1_OFFSET UNITYSDK_OFFSET(0x18E3B920)
#define RPG_GAMECORE_SETMONSTERPHASEPOINTPREFAB_METHOD_3_8492CC7A052AB96D_OFFSET UNITYSDK_OFFSET(0x18E3B9A0)
#define RPG_GAMECORE_SETMONSTERPHASEPOINTPREFAB__CTOR_OFFSET UNITYSDK_OFFSET(0x18E3B970)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetMonsterPhasePointPrefab_TypeDefinitionIndex = 22212;
