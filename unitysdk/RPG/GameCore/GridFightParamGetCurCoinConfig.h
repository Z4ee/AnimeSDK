...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETCURCOINCONFIG_METHOD_6_205499DEAD09D0E2_OFFSET UNITYSDK_OFFSET(0x197F6EC0)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETCURCOINCONFIG_METHOD_6_9FDC89330B61F80C_OFFSET UNITYSDK_OFFSET(0x197F6C10)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETCURCOINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197F6D90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightParamGetCurCoinConfig_TypeDefinitionIndex = 18497;
