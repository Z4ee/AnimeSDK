...
#define RPG_GAMECORE_PIXAIRSKILLCONFIG_METHOD_2_C05AFE965700612A_OFFSET UNITYSDK_OFFSET(0x1D338570)
#define RPG_GAMECORE_PIXAIRSKILLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3386C0)
