...
#define RPG_GAMECORE_CHENLINGFESPOSITION_METHOD_2_F6D3CA7EFDA402C5_OFFSET UNITYSDK_OFFSET(0x1CFB4440)
#define RPG_GAMECORE_CHENLINGFESPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFB45B0)
