...
#define RPG_GAMECORE_CHENLINGFESPOSITION_METHOD_2_F6D3CA7EFDA402C5_OFFSET UNITYSDK_OFFSET(0x1962B720)
#define RPG_GAMECORE_CHENLINGFESPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1962B890)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingFesPosition_TypeDefinitionIndex = 17531;
