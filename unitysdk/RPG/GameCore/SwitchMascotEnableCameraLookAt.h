...
#define RPG_GAMECORE_SWITCHMASCOTENABLECAMERALOOKAT_METHOD_3_9B4619A78BBD9594_OFFSET UNITYSDK_OFFSET(0x1E150C40)
#define RPG_GAMECORE_SWITCHMASCOTENABLECAMERALOOKAT_METHOD_3_BBF4569DEECF28AF_OFFSET UNITYSDK_OFFSET(0x1E150C80)
#define RPG_GAMECORE_SWITCHMASCOTENABLECAMERALOOKAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E150C70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchMascotEnableCameraLookAt_TypeDefinitionIndex = 21756;
