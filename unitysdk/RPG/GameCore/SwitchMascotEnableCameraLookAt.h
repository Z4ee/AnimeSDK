...
#define RPG_GAMECORE_SWITCHMASCOTENABLECAMERALOOKAT_METHOD_3_6594B8AC7A4BAA3E_OFFSET UNITYSDK_OFFSET(0x18EBD160)
#define RPG_GAMECORE_SWITCHMASCOTENABLECAMERALOOKAT_METHOD_3_BBF4569DEECF28AF_OFFSET UNITYSDK_OFFSET(0x18EBD1E0)
#define RPG_GAMECORE_SWITCHMASCOTENABLECAMERALOOKAT__CTOR_OFFSET UNITYSDK_OFFSET(0x18EBD1B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchMascotEnableCameraLookAt_TypeDefinitionIndex = 20862;
