...
#define RPG_GAMECORE_OPENTRAINPARTYENTRANCEPAGE_METHOD_3_1042149A3E6F776C_OFFSET UNITYSDK_OFFSET(0x199D8980)
#define RPG_GAMECORE_OPENTRAINPARTYENTRANCEPAGE_METHOD_3_B5419DC51D545160_OFFSET UNITYSDK_OFFSET(0x199D8870)
#define RPG_GAMECORE_OPENTRAINPARTYENTRANCEPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x199D8950)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OpenTrainPartyEntrancePage_TypeDefinitionIndex = 21129;
