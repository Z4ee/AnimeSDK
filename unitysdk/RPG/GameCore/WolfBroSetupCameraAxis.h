...
#define RPG_GAMECORE_WOLFBROSETUPCAMERAAXIS_METHOD_3_144D29B00945623B_OFFSET UNITYSDK_OFFSET(0x1790CCF0)
#define RPG_GAMECORE_WOLFBROSETUPCAMERAAXIS_METHOD_3_3294ED9BF83B5492_OFFSET UNITYSDK_OFFSET(0x1790CD70)
#define RPG_GAMECORE_WOLFBROSETUPCAMERAAXIS__CTOR_OFFSET UNITYSDK_OFFSET(0x1790CD40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WolfBroSetupCameraAxis_TypeDefinitionIndex = 19746;
