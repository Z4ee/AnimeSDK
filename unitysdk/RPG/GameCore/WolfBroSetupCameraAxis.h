...
#define RPG_GAMECORE_WOLFBROSETUPCAMERAAXIS_METHOD_3_3294ED9BF83B5492_OFFSET UNITYSDK_OFFSET(0x1D6B3E40)
#define RPG_GAMECORE_WOLFBROSETUPCAMERAAXIS_METHOD_3_E1CF3B40BE771009_OFFSET UNITYSDK_OFFSET(0x1D6B3E00)
#define RPG_GAMECORE_WOLFBROSETUPCAMERAAXIS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6B3E30)
