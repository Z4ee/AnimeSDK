...
#define RPG_GAMECORE_WOLFBROSETUPCAMERAAXIS_METHOD_3_3294ED9BF83B5492_OFFSET UNITYSDK_OFFSET(0x1D1C3C30)
#define RPG_GAMECORE_WOLFBROSETUPCAMERAAXIS_METHOD_3_E1CF3B40BE771009_OFFSET UNITYSDK_OFFSET(0x1D1C3BF0)
#define RPG_GAMECORE_WOLFBROSETUPCAMERAAXIS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1C3C20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WolfBroSetupCameraAxis_TypeDefinitionIndex = 20784;
