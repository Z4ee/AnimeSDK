...
#define RPG_GAMECORE_FIVEDIMSETSUIYANGDEADACTION_METHOD_3_84905083C43F65B6_OFFSET UNITYSDK_OFFSET(0x1BEB24B0)
#define RPG_GAMECORE_FIVEDIMSETSUIYANGDEADACTION_METHOD_3_EC5E1FEEB35C3627_OFFSET UNITYSDK_OFFSET(0x1BEB2430)
#define RPG_GAMECORE_FIVEDIMSETSUIYANGDEADACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEB24A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSetSuiyangDeadAction_TypeDefinitionIndex = 17978;
