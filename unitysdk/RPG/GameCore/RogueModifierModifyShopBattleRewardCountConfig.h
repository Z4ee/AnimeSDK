...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYSHOPBATTLEREWARDCOUNTCONFIG_METHOD_3_458B3C1588BA1032_OFFSET UNITYSDK_OFFSET(0x17635DE0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYSHOPBATTLEREWARDCOUNTCONFIG_METHOD_3_9C673E2BF44E74BB_OFFSET UNITYSDK_OFFSET(0x17635D10)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYSHOPBATTLEREWARDCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17635D90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyShopBattleRewardCountConfig_TypeDefinitionIndex = 16305;
