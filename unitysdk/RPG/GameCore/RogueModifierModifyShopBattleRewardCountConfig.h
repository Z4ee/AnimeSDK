...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYSHOPBATTLEREWARDCOUNTCONFIG_METHOD_3_458B3C1588BA1032_OFFSET UNITYSDK_OFFSET(0x1D3FAAF0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYSHOPBATTLEREWARDCOUNTCONFIG_METHOD_3_ABAB3CB35BA95F56_OFFSET UNITYSDK_OFFSET(0x1D3FAAA0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYSHOPBATTLEREWARDCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3FAAE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyShopBattleRewardCountConfig_TypeDefinitionIndex = 17539;
