...
#define RPG_GAMECORE_LITTLEGAMEABILITYATTRIBUTECONFIG_METHOD_2_F561A658A7976590_OFFSET UNITYSDK_OFFSET(0x1D1F8870)
#define RPG_GAMECORE_LITTLEGAMEABILITYATTRIBUTECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1F8990)
