...
#define RPG_GAMECORE_LITTLEGAMEABILITYATTRIBUTECONFIG_METHOD_2_F561A658A7976590_OFFSET UNITYSDK_OFFSET(0x19892720)
#define RPG_GAMECORE_LITTLEGAMEABILITYATTRIBUTECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19892840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityAttributeConfig_TypeDefinitionIndex = 20165;
