...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONENTERROGUETOURNROOMCOUNTCONFIG_METHOD_3_9F46E228E6F2FD87_OFFSET UNITYSDK_OFFSET(0x17630300)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONENTERROGUETOURNROOMCOUNTCONFIG_METHOD_3_BE4AD85C6FE7301E_OFFSET UNITYSDK_OFFSET(0x176303D0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONENTERROGUETOURNROOMCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17630380)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnEnterRogueTournRoomCountConfig_TypeDefinitionIndex = 16321;
