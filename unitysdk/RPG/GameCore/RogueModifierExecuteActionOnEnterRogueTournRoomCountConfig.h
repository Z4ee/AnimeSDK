...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONENTERROGUETOURNROOMCOUNTCONFIG_METHOD_3_34FD02C8669BDC02_OFFSET UNITYSDK_OFFSET(0x1EEF8CF0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONENTERROGUETOURNROOMCOUNTCONFIG_METHOD_3_BE4AD85C6FE7301E_OFFSET UNITYSDK_OFFSET(0x1EEF8D40)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONENTERROGUETOURNROOMCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEF8D30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnEnterRogueTournRoomCountConfig_TypeDefinitionIndex = 17557;
