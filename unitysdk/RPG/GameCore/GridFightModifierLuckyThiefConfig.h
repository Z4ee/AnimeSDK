...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERLUCKYTHIEFCONFIG_METHOD_3_1F31AE816BA500E2_OFFSET UNITYSDK_OFFSET(0x197EDD10)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERLUCKYTHIEFCONFIG_METHOD_3_6E4355A791A266EB_OFFSET UNITYSDK_OFFSET(0x197F2C70)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERLUCKYTHIEFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197EDCC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierLuckyThiefConfig_TypeDefinitionIndex = 18376;
