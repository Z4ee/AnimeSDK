...
#define RPG_GAMECORE_WAITANIMEVENT_METHOD_3_1AD33694BE122BFB_OFFSET UNITYSDK_OFFSET(0x178F4320)
#define RPG_GAMECORE_WAITANIMEVENT_METHOD_3_72722F8F33A2CC52_OFFSET UNITYSDK_OFFSET(0x178F43A0)
#define RPG_GAMECORE_WAITANIMEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x178F4370)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitAnimEvent_TypeDefinitionIndex = 21076;
