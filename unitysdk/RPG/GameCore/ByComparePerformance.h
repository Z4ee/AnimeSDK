...
#define RPG_GAMECORE_BYCOMPAREPERFORMANCE_METHOD_4_01047C2314DC0962_OFFSET UNITYSDK_OFFSET(0x17011D50)
#define RPG_GAMECORE_BYCOMPAREPERFORMANCE_METHOD_4_063D82B0A89455C4_OFFSET UNITYSDK_OFFSET(0x17011C80)
#define RPG_GAMECORE_BYCOMPAREPERFORMANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x17011D00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByComparePerformance_TypeDefinitionIndex = 18602;
