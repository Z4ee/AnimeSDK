...
#define RPG_GAMECORE_BYCOMPAREPERFORMANCE_METHOD_4_01047C2314DC0962_OFFSET UNITYSDK_OFFSET(0x19CFC8D0)
#define RPG_GAMECORE_BYCOMPAREPERFORMANCE_METHOD_4_3C6032FAE9D5211A_OFFSET UNITYSDK_OFFSET(0x19CFCA60)
#define RPG_GAMECORE_BYCOMPAREPERFORMANCE_METHOD_4_883D5CBCEFC01EFD_OFFSET UNITYSDK_OFFSET(0x19CFCA90)
#define RPG_GAMECORE_BYCOMPAREPERFORMANCE_METHOD_4_8EADB76F7A58EC93_OFFSET UNITYSDK_OFFSET(0x19CFC890)
#define RPG_GAMECORE_BYCOMPAREPERFORMANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x19CFC8C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByComparePerformance_TypeDefinitionIndex = 19532;
