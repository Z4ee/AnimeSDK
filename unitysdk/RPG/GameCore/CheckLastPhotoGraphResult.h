...
#define RPG_GAMECORE_CHECKLASTPHOTOGRAPHRESULT_METHOD_3_27CF7028948930D3_OFFSET UNITYSDK_OFFSET(0x1B72DF30)
#define RPG_GAMECORE_CHECKLASTPHOTOGRAPHRESULT_METHOD_3_B89D8985FDF8EF1E_OFFSET UNITYSDK_OFFSET(0x1B72DEF0)
#define RPG_GAMECORE_CHECKLASTPHOTOGRAPHRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B72DF20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CheckLastPhotoGraphResult_TypeDefinitionIndex = 20820;
