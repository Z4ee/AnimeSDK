...
#define RPG_GAMECORE_CHECKLASTPHOTOGRAPHRESULT_METHOD_3_92A1C58714E5D015_OFFSET UNITYSDK_OFFSET(0x17075950)
#define RPG_GAMECORE_CHECKLASTPHOTOGRAPHRESULT_METHOD_3_A0DE990EEC9E1A02_OFFSET UNITYSDK_OFFSET(0x170758D0)
#define RPG_GAMECORE_CHECKLASTPHOTOGRAPHRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x17075920)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CheckLastPhotoGraphResult_TypeDefinitionIndex = 19785;
