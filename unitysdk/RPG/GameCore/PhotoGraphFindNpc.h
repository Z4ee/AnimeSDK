...
#define RPG_GAMECORE_PHOTOGRAPHFINDNPC_METHOD_2_86E7073ACFC65BF6_OFFSET UNITYSDK_OFFSET(0x1B4C18E0)
#define RPG_GAMECORE_PHOTOGRAPHFINDNPC_METHOD_2_F266A0247ABE2FDC_OFFSET UNITYSDK_OFFSET(0x1B4C1A50)
#define RPG_GAMECORE_PHOTOGRAPHFINDNPC__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4C1A40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotoGraphFindNpc_TypeDefinitionIndex = 20822;
