...
#define RPG_GAMECORE_WAITPERFORMANCEREPLAYEND_METHOD_3_27242D0C0EE6DD4C_OFFSET UNITYSDK_OFFSET(0x19103590)
#define RPG_GAMECORE_WAITPERFORMANCEREPLAYEND_METHOD_3_BF43089FC37CC6DD_OFFSET UNITYSDK_OFFSET(0x19103610)
#define RPG_GAMECORE_WAITPERFORMANCEREPLAYEND__CTOR_OFFSET UNITYSDK_OFFSET(0x191035E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitPerformanceReplayEnd_TypeDefinitionIndex = 20700;
