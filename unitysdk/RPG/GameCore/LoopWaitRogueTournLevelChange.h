...
#define RPG_GAMECORE_LOOPWAITROGUETOURNLEVELCHANGE_METHOD_3_7363549A14E78BA6_OFFSET UNITYSDK_OFFSET(0x18A7EB20)
#define RPG_GAMECORE_LOOPWAITROGUETOURNLEVELCHANGE_METHOD_3_F1F9317AB877F8E6_OFFSET UNITYSDK_OFFSET(0x18A7EA90)
#define RPG_GAMECORE_LOOPWAITROGUETOURNLEVELCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x18A7EAF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoopWaitRogueTournLevelChange_TypeDefinitionIndex = 20211;
