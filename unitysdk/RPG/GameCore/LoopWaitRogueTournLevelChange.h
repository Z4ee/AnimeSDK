...
#define RPG_GAMECORE_LOOPWAITROGUETOURNLEVELCHANGE_METHOD_3_6D81CB69BF0ACB4A_OFFSET UNITYSDK_OFFSET(0x1BCD4AB0)
#define RPG_GAMECORE_LOOPWAITROGUETOURNLEVELCHANGE_METHOD_3_7363549A14E78BA6_OFFSET UNITYSDK_OFFSET(0x1BCD4B00)
#define RPG_GAMECORE_LOOPWAITROGUETOURNLEVELCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCD4AF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoopWaitRogueTournLevelChange_TypeDefinitionIndex = 20439;
