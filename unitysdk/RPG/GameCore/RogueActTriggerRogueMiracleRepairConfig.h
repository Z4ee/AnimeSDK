...
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMIRACLEREPAIRCONFIG_METHOD_6_003688B3F8829D9D_OFFSET UNITYSDK_OFFSET(0x175CD390)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMIRACLEREPAIRCONFIG_METHOD_6_3A1509B27DBF4610_OFFSET UNITYSDK_OFFSET(0x175CD5B0)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMIRACLEREPAIRCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175CD4D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActTriggerRogueMiracleRepairConfig_TypeDefinitionIndex = 17955;
