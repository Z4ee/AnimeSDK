...
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMIRACLEREPAIRCONFIG_METHOD_6_003688B3F8829D9D_OFFSET UNITYSDK_OFFSET(0x18CD9060)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMIRACLEREPAIRCONFIG_METHOD_6_3A1509B27DBF4610_OFFSET UNITYSDK_OFFSET(0x18CD9280)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMIRACLEREPAIRCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CD91A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActTriggerRogueMiracleRepairConfig_TypeDefinitionIndex = 18600;
