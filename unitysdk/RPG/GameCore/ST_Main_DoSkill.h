...
#define RPG_GAMECORE_ST_MAIN_DOSKILL_METHOD_4_3F0A4055F93A9B1A_OFFSET UNITYSDK_OFFSET(0x18DEF2D0)
#define RPG_GAMECORE_ST_MAIN_DOSKILL_METHOD_4_5B9CC7A7863849BD_OFFSET UNITYSDK_OFFSET(0x18DE55D0)
#define RPG_GAMECORE_ST_MAIN_DOSKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x18DE5580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_DoSkill_TypeDefinitionIndex = 19022;
