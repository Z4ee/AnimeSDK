...
#define RPG_GAMECORE_TRAINPARTYACTIONMODIFYCARDSTEPCONFIG_METHOD_5_42E67B6948178B01_OFFSET UNITYSDK_OFFSET(0x1C15CD90)
#define RPG_GAMECORE_TRAINPARTYACTIONMODIFYCARDSTEPCONFIG_METHOD_5_6287D053752FC6DD_OFFSET UNITYSDK_OFFSET(0x1C15CE60)
#define RPG_GAMECORE_TRAINPARTYACTIONMODIFYCARDSTEPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C15CD80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyActionModifyCardStepConfig_TypeDefinitionIndex = 17349;
