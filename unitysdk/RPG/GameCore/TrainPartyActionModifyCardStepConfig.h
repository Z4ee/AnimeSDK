...
#define RPG_GAMECORE_TRAINPARTYACTIONMODIFYCARDSTEPCONFIG_METHOD_5_42E67B6948178B01_OFFSET UNITYSDK_OFFSET(0x19DF1160)
#define RPG_GAMECORE_TRAINPARTYACTIONMODIFYCARDSTEPCONFIG_METHOD_5_8BEF8301DF483DA8_OFFSET UNITYSDK_OFFSET(0x19DF13B0)
#define RPG_GAMECORE_TRAINPARTYACTIONMODIFYCARDSTEPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19DF1110)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyActionModifyCardStepConfig_TypeDefinitionIndex = 17187;
