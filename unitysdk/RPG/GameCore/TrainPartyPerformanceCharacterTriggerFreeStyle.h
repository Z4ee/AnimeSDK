...
#define RPG_GAMECORE_TRAINPARTYPERFORMANCECHARACTERTRIGGERFREESTYLE_METHOD_3_2E2157B1CEA273BC_OFFSET UNITYSDK_OFFSET(0x190AD510)
#define RPG_GAMECORE_TRAINPARTYPERFORMANCECHARACTERTRIGGERFREESTYLE_METHOD_3_4481823E8C5804EB_OFFSET UNITYSDK_OFFSET(0x190AD490)
#define RPG_GAMECORE_TRAINPARTYPERFORMANCECHARACTERTRIGGERFREESTYLE__CTOR_OFFSET UNITYSDK_OFFSET(0x190AD4E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyPerformanceCharacterTriggerFreeStyle_TypeDefinitionIndex = 21233;
