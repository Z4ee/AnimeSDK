...
#define RPG_GAMECORE_TRAINPARTYPERFORMANCECHARACTERTRIGGERFREESTYLE_METHOD_3_2E2157B1CEA273BC_OFFSET UNITYSDK_OFFSET(0x1D538580)
#define RPG_GAMECORE_TRAINPARTYPERFORMANCECHARACTERTRIGGERFREESTYLE_METHOD_3_E3C90E06E9C824C9_OFFSET UNITYSDK_OFFSET(0x1D538540)
#define RPG_GAMECORE_TRAINPARTYPERFORMANCECHARACTERTRIGGERFREESTYLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D538570)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyPerformanceCharacterTriggerFreeStyle_TypeDefinitionIndex = 22105;
