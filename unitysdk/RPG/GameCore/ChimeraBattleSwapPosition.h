...
#define RPG_GAMECORE_CHIMERABATTLESWAPPOSITION_METHOD_3_138DB09CD1ABAE22_OFFSET UNITYSDK_OFFSET(0x1CFBD680)
#define RPG_GAMECORE_CHIMERABATTLESWAPPOSITION_METHOD_3_3819C976B393FA92_OFFSET UNITYSDK_OFFSET(0x1CFBE3E0)
#define RPG_GAMECORE_CHIMERABATTLESWAPPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFBD670)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraBattleSwapPosition_TypeDefinitionIndex = 15705;
