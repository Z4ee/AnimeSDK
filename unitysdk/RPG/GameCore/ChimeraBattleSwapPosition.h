...
#define RPG_GAMECORE_CHIMERABATTLESWAPPOSITION_METHOD_3_138DB09CD1ABAE22_OFFSET UNITYSDK_OFFSET(0x17093950)
#define RPG_GAMECORE_CHIMERABATTLESWAPPOSITION_METHOD_3_3819C976B393FA92_OFFSET UNITYSDK_OFFSET(0x17094840)
#define RPG_GAMECORE_CHIMERABATTLESWAPPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x17093940)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraBattleSwapPosition_TypeDefinitionIndex = 14571;
