...
#define RPG_GAMECORE_CHIMERABATTLESWAPPOSITION_METHOD_3_138DB09CD1ABAE22_OFFSET UNITYSDK_OFFSET(0x1C38ED60)
#define RPG_GAMECORE_CHIMERABATTLESWAPPOSITION_METHOD_3_3819C976B393FA92_OFFSET UNITYSDK_OFFSET(0x1C38FC60)
#define RPG_GAMECORE_CHIMERABATTLESWAPPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C38ED50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraBattleSwapPosition_TypeDefinitionIndex = 15268;
