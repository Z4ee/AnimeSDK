...
#define RPG_GAMECORE_MUNICIPALCHATNODETRANSITIONINFO_METHOD_2_24742874CD621015_OFFSET UNITYSDK_OFFSET(0x18B69240)
#define RPG_GAMECORE_MUNICIPALCHATNODETRANSITIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18B692F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MunicipalChatNodeTransitionInfo_TypeDefinitionIndex = 16019;
