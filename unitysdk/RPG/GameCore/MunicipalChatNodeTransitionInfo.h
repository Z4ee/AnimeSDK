...
#define RPG_GAMECORE_MUNICIPALCHATNODETRANSITIONINFO_METHOD_2_24742874CD621015_OFFSET UNITYSDK_OFFSET(0x1D2DF1F0)
#define RPG_GAMECORE_MUNICIPALCHATNODETRANSITIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2DF2A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MunicipalChatNodeTransitionInfo_TypeDefinitionIndex = 16737;
