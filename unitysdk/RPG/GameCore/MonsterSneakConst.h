...
#define RPG_GAMECORE_MONSTERSNEAKCONST_METHOD_2_EDA7D147F13CB5EF_OFFSET UNITYSDK_OFFSET(0x1B1CCBF0)
#define RPG_GAMECORE_MONSTERSNEAKCONST__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1CCFC0)
