...
#define RPG_GAMECORE_STOPRANDOMMISSIONTALK_METHOD_3_34342B6C39D79077_OFFSET UNITYSDK_OFFSET(0x1CAFDC70)
#define RPG_GAMECORE_STOPRANDOMMISSIONTALK_METHOD_3_C68AF448F5F17A1A_OFFSET UNITYSDK_OFFSET(0x1CAFDD40)
#define RPG_GAMECORE_STOPRANDOMMISSIONTALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1CAFDD30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StopRandomMissionTalk_TypeDefinitionIndex = 20608;
