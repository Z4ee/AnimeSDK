...
#define RPG_GAMECORE_STOPRANDOMMISSIONTALK_METHOD_3_8A5976E8C8EE416E_OFFSET UNITYSDK_OFFSET(0x18EA3CD0)
#define RPG_GAMECORE_STOPRANDOMMISSIONTALK_METHOD_3_C68AF448F5F17A1A_OFFSET UNITYSDK_OFFSET(0x18EA3DE0)
#define RPG_GAMECORE_STOPRANDOMMISSIONTALK__CTOR_OFFSET UNITYSDK_OFFSET(0x18EA3DB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StopRandomMissionTalk_TypeDefinitionIndex = 19831;
