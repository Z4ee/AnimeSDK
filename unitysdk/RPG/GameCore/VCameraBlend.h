...
#define RPG_GAMECORE_VCAMERABLEND_METHOD_2_8D33CA9A5010063B_OFFSET UNITYSDK_OFFSET(0x190E7430)
#define RPG_GAMECORE_VCAMERABLEND__CTOR_OFFSET UNITYSDK_OFFSET(0x190E78D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VCameraBlend_TypeDefinitionIndex = 15536;
