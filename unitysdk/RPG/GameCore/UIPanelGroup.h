...
#define RPG_GAMECORE_UIPANELGROUP_METHOD_2_DCF6237C6FD54892_OFFSET UNITYSDK_OFFSET(0x190E05C0)
#define RPG_GAMECORE_UIPANELGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x190E06D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UIPanelGroup_TypeDefinitionIndex = 16240;
