...
#define RPG_GAMECORE_UIPANELGROUP_METHOD_2_DCF6237C6FD54892_OFFSET UNITYSDK_OFFSET(0x1B87DCE0)
#define RPG_GAMECORE_UIPANELGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B87DDA0)
