...
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTDAMAGEBOOSTPERCENTCONFIG_METHOD_3_48994AD99FA9E802_OFFSET UNITYSDK_OFFSET(0x198943F0)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTDAMAGEBOOSTPERCENTCONFIG_METHOD_3_E6532BEBFB30D856_OFFSET UNITYSDK_OFFSET(0x19894320)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTDAMAGEBOOSTPERCENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x198943E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityPixAirEffectDamageBoostPercentConfig_TypeDefinitionIndex = 20184;
