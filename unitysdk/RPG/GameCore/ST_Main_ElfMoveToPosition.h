...
#define RPG_GAMECORE_ST_MAIN_ELFMOVETOPOSITION_METHOD_4_911E60FF569840B2_OFFSET UNITYSDK_OFFSET(0x19C00400)
#define RPG_GAMECORE_ST_MAIN_ELFMOVETOPOSITION_METHOD_4_9AF4B527EB319B8A_OFFSET UNITYSDK_OFFSET(0x19C17EC0)
#define RPG_GAMECORE_ST_MAIN_ELFMOVETOPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x19C003B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_ElfMoveToPosition_TypeDefinitionIndex = 20347;
