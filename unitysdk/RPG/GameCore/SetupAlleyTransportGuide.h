...
#define RPG_GAMECORE_SETUPALLEYTRANSPORTGUIDE_METHOD_3_3EC95546C2F18D94_OFFSET UNITYSDK_OFFSET(0x1E0981C0)
#define RPG_GAMECORE_SETUPALLEYTRANSPORTGUIDE_METHOD_3_F3DB7E6039C94711_OFFSET UNITYSDK_OFFSET(0x1E098180)
#define RPG_GAMECORE_SETUPALLEYTRANSPORTGUIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0981B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetupAlleyTransportGuide_TypeDefinitionIndex = 24015;
