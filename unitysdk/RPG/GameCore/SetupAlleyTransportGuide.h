...
#define RPG_GAMECORE_SETUPALLEYTRANSPORTGUIDE_METHOD_3_1AD9469397EF8E25_OFFSET UNITYSDK_OFFSET(0x19C69AA0)
#define RPG_GAMECORE_SETUPALLEYTRANSPORTGUIDE_METHOD_3_3EC95546C2F18D94_OFFSET UNITYSDK_OFFSET(0x19C69B20)
#define RPG_GAMECORE_SETUPALLEYTRANSPORTGUIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C69AF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetupAlleyTransportGuide_TypeDefinitionIndex = 22968;
