...
#define RPG_GAMECORE_TARGETSORTBYPROPERTY_METHOD_3_1EC32C2A5300E557_OFFSET UNITYSDK_OFFSET(0x177D25C0)
#define RPG_GAMECORE_TARGETSORTBYPROPERTY_METHOD_3_950FF984DE5B23B3_OFFSET UNITYSDK_OFFSET(0x177D38A0)
#define RPG_GAMECORE_TARGETSORTBYPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x177D25A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetSortByProperty_TypeDefinitionIndex = 22258;
