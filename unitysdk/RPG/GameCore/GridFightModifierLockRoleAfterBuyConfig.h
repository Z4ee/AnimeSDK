...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERLOCKROLEAFTERBUYCONFIG_METHOD_3_BBE80D2BAAEE3E23_OFFSET UNITYSDK_OFFSET(0x1D06A2C0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERLOCKROLEAFTERBUYCONFIG_METHOD_3_E128F1C8106534A7_OFFSET UNITYSDK_OFFSET(0x1D06A310)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERLOCKROLEAFTERBUYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D06A300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierLockRoleAfterBuyConfig_TypeDefinitionIndex = 18597;
