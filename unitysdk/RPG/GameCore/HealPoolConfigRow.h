...
#define RPG_GAMECORE_HEALPOOLCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x189EB3E0)
#define RPG_GAMECORE_HEALPOOLCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x189EB550)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HealPoolConfigRow_TypeDefinitionIndex = 12983;

	class HealPoolConfigRow : public ::System::Object
	{
	public:
		::System::UInt32 RecoverTime; // 0x10
