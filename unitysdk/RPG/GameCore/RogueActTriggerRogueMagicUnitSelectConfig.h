...
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMAGICUNITSELECTCONFIG_METHOD_6_B1E6268D5A309B0B_OFFSET UNITYSDK_OFFSET(0x19AFCAE0)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMAGICUNITSELECTCONFIG_METHOD_6_DDAF49D4B5C53F9E_OFFSET UNITYSDK_OFFSET(0x19AFC8C0)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMAGICUNITSELECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AFCA00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActTriggerRogueMagicUnitSelectConfig_TypeDefinitionIndex = 18642;
