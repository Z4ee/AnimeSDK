...
#define RPG_GAMECORE_ROGUEPARAMROGUETOURNCURRENTROOMVARIANTTYPECONFIG_METHOD_6_93046C9513DE07D0_OFFSET UNITYSDK_OFFSET(0x18D5DE10)
#define RPG_GAMECORE_ROGUEPARAMROGUETOURNCURRENTROOMVARIANTTYPECONFIG_METHOD_6_EE3E4100179CAA46_OFFSET UNITYSDK_OFFSET(0x18D5DB60)
#define RPG_GAMECORE_ROGUEPARAMROGUETOURNCURRENTROOMVARIANTTYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D5DCE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamRogueTournCurrentRoomVariantTypeConfig_TypeDefinitionIndex = 18810;
