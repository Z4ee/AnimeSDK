...
#define RPG_GAMECORE_ROGUEPARAMROGUETOURNCURRENTROOMVARIANTTYPECONFIG_METHOD_6_76B8221D609351D4_OFFSET UNITYSDK_OFFSET(0x1D177210)
#define RPG_GAMECORE_ROGUEPARAMROGUETOURNCURRENTROOMVARIANTTYPECONFIG_METHOD_6_93046C9513DE07D0_OFFSET UNITYSDK_OFFSET(0x1D177260)
#define RPG_GAMECORE_ROGUEPARAMROGUETOURNCURRENTROOMVARIANTTYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D177250)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamRogueTournCurrentRoomVariantTypeConfig_TypeDefinitionIndex = 19056;
