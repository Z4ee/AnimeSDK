...
#define RPG_GAMECORE_CLEARREGARDASSKILLTYPE_METHOD_3_27A4522EA1559D01_OFFSET UNITYSDK_OFFSET(0x19654030)
#define RPG_GAMECORE_CLEARREGARDASSKILLTYPE_METHOD_3_E0178B6D0EBA6C6D_OFFSET UNITYSDK_OFFSET(0x19653FB0)
#define RPG_GAMECORE_CLEARREGARDASSKILLTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x19654000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClearRegardAsSkillType_TypeDefinitionIndex = 22377;
