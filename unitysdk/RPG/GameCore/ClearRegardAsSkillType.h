...
#define RPG_GAMECORE_CLEARREGARDASSKILLTYPE_METHOD_3_27A4522EA1559D01_OFFSET UNITYSDK_OFFSET(0x1C254AC0)
#define RPG_GAMECORE_CLEARREGARDASSKILLTYPE_METHOD_3_5A777ECB82178C7E_OFFSET UNITYSDK_OFFSET(0x1C254A80)
#define RPG_GAMECORE_CLEARREGARDASSKILLTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C254AB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClearRegardAsSkillType_TypeDefinitionIndex = 22819;
