...
#define RPG_GAMECORE_BOXINGCLUBNATURECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C2EB5A0)
#define RPG_GAMECORE_BOXINGCLUBNATURECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2EBC70)
