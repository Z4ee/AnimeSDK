...
#define RPG_GAMECORE_AVATARCOLLIDERCAMERACONFIG_METHOD_2_BF5D8A35B0952A41_OFFSET UNITYSDK_OFFSET(0x1C5865C0)
#define RPG_GAMECORE_AVATARCOLLIDERCAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5866D0)
