...
#define RPG_GAMECORE_AVATARCOLLIDERCAMERACONFIG_METHOD_2_BF5D8A35B0952A41_OFFSET UNITYSDK_OFFSET(0x186B9510)
#define RPG_GAMECORE_AVATARCOLLIDERCAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x186B9620)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AvatarColliderCameraConfig_TypeDefinitionIndex = 15549;
