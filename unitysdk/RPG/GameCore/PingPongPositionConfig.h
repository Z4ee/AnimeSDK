...
#define RPG_GAMECORE_PINGPONGPOSITIONCONFIG_METHOD_2_7933B39090E9698F_OFFSET UNITYSDK_OFFSET(0x1B4C94D0)
#define RPG_GAMECORE_PINGPONGPOSITIONCONFIG_METHOD_2_DB2B44FABAA6A6B5_1_OFFSET UNITYSDK_OFFSET(0x1B4C9670)
#define RPG_GAMECORE_PINGPONGPOSITIONCONFIG_METHOD_2_DB2B44FABAA6A6B5_OFFSET UNITYSDK_OFFSET(0x1B4C9620)
#define RPG_GAMECORE_PINGPONGPOSITIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4C9610)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PingPongPositionConfig_TypeDefinitionIndex = 16326;
