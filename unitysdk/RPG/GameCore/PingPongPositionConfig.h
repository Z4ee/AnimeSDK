...
#define RPG_GAMECORE_PINGPONGPOSITIONCONFIG_METHOD_2_7933B39090E9698F_OFFSET UNITYSDK_OFFSET(0x174B1F20)
#define RPG_GAMECORE_PINGPONGPOSITIONCONFIG_METHOD_2_DB2B44FABAA6A6B5_1_OFFSET UNITYSDK_OFFSET(0x174B20C0)
#define RPG_GAMECORE_PINGPONGPOSITIONCONFIG_METHOD_2_DB2B44FABAA6A6B5_OFFSET UNITYSDK_OFFSET(0x174B2070)
#define RPG_GAMECORE_PINGPONGPOSITIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x174B2060)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PingPongPositionConfig_TypeDefinitionIndex = 15572;
