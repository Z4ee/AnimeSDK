...
#define RPG_GAMECORE_PINGPONGPOSITIONCONFIG_METHOD_2_7933B39090E9698F_OFFSET UNITYSDK_OFFSET(0x1D333300)
#define RPG_GAMECORE_PINGPONGPOSITIONCONFIG_METHOD_2_DB2B44FABAA6A6B5_1_OFFSET UNITYSDK_OFFSET(0x1D3334A0)
#define RPG_GAMECORE_PINGPONGPOSITIONCONFIG_METHOD_2_DB2B44FABAA6A6B5_OFFSET UNITYSDK_OFFSET(0x1D333450)
#define RPG_GAMECORE_PINGPONGPOSITIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D333440)
