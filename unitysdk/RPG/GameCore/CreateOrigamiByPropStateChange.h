...
#define RPG_GAMECORE_CREATEORIGAMIBYPROPSTATECHANGE_METHOD_3_063953D9090CC119_OFFSET UNITYSDK_OFFSET(0x1D008990)
#define RPG_GAMECORE_CREATEORIGAMIBYPROPSTATECHANGE_METHOD_3_ED4ED28C0C96C672_OFFSET UNITYSDK_OFFSET(0x1D0089D0)
#define RPG_GAMECORE_CREATEORIGAMIBYPROPSTATECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0089C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CreateOrigamiByPropStateChange_TypeDefinitionIndex = 20928;
