...
#define RPG_GAMECORE_CREATEORIGAMIBYPROPSTATECHANGE_METHOD_3_94E600800FFCCF36_OFFSET UNITYSDK_OFFSET(0x19683340)
#define RPG_GAMECORE_CREATEORIGAMIBYPROPSTATECHANGE_METHOD_3_ED4ED28C0C96C672_OFFSET UNITYSDK_OFFSET(0x196833C0)
#define RPG_GAMECORE_CREATEORIGAMIBYPROPSTATECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x19683390)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CreateOrigamiByPropStateChange_TypeDefinitionIndex = 20004;
