...
#define RPG_GAMECORE_CHIMERATALKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1964C9B0)
#define RPG_GAMECORE_CHIMERATALKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1964D040)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraTalkRow_TypeDefinitionIndex = 12414;
