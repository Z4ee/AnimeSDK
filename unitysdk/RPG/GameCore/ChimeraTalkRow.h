...
#define RPG_GAMECORE_CHIMERATALKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1880B150)
#define RPG_GAMECORE_CHIMERATALKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1880B7C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraTalkRow_TypeDefinitionIndex = 12326;
