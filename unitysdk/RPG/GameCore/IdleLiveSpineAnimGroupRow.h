...
#define RPG_GAMECORE_IDLELIVESPINEANIMGROUPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D1A3E00)
#define RPG_GAMECORE_IDLELIVESPINEANIMGROUPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1A4030)
