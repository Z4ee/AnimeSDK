...
#define RPG_GAMECORE_FRAMECAPTUREIFNEED_METHOD_3_3817B6FB4DC0936B_OFFSET UNITYSDK_OFFSET(0x1D118A40)
#define RPG_GAMECORE_FRAMECAPTUREIFNEED_METHOD_3_681B5AF7F5C1EB88_OFFSET UNITYSDK_OFFSET(0x1D118A90)
#define RPG_GAMECORE_FRAMECAPTUREIFNEED__CTOR_OFFSET UNITYSDK_OFFSET(0x1D118A80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FrameCaptureIfNeed_TypeDefinitionIndex = 22471;
