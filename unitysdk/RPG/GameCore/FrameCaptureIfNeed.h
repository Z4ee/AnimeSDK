...
#define RPG_GAMECORE_FRAMECAPTUREIFNEED_METHOD_3_40CFAE43F24C4321_OFFSET UNITYSDK_OFFSET(0x1976BE40)
#define RPG_GAMECORE_FRAMECAPTUREIFNEED_METHOD_3_681B5AF7F5C1EB88_OFFSET UNITYSDK_OFFSET(0x1976BEC0)
#define RPG_GAMECORE_FRAMECAPTUREIFNEED__CTOR_OFFSET UNITYSDK_OFFSET(0x1976BE90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FrameCaptureIfNeed_TypeDefinitionIndex = 21487;
