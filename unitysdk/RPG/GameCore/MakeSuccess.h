...
#define RPG_GAMECORE_MAKESUCCESS_METHOD_3_3F5313BCF2B1A69B_OFFSET UNITYSDK_OFFSET(0x17377DF0)
#define RPG_GAMECORE_MAKESUCCESS_METHOD_3_9C14FE78756A5232_OFFSET UNITYSDK_OFFSET(0x17377D70)
#define RPG_GAMECORE_MAKESUCCESS__CTOR_OFFSET UNITYSDK_OFFSET(0x17377DC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MakeSuccess_TypeDefinitionIndex = 20691;
