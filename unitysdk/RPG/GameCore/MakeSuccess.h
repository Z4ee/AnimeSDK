...
#define RPG_GAMECORE_MAKESUCCESS_METHOD_3_3F5313BCF2B1A69B_OFFSET UNITYSDK_OFFSET(0x18A85A50)
#define RPG_GAMECORE_MAKESUCCESS_METHOD_3_9C14FE78756A5232_OFFSET UNITYSDK_OFFSET(0x18A859D0)
#define RPG_GAMECORE_MAKESUCCESS__CTOR_OFFSET UNITYSDK_OFFSET(0x18A85A20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MakeSuccess_TypeDefinitionIndex = 21388;
