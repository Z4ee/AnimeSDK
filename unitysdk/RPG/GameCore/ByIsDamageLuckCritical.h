...
#define RPG_GAMECORE_BYISDAMAGELUCKCRITICAL_METHOD_4_0526CF12F981E0F0_OFFSET UNITYSDK_OFFSET(0x1A8DDA60)
#define RPG_GAMECORE_BYISDAMAGELUCKCRITICAL_METHOD_4_47EF1422F9370403_OFFSET UNITYSDK_OFFSET(0x1A8DDAA0)
#define RPG_GAMECORE_BYISDAMAGELUCKCRITICAL_METHOD_4_D49F674F48742D90_OFFSET UNITYSDK_OFFSET(0x1A8DDC10)
#define RPG_GAMECORE_BYISDAMAGELUCKCRITICAL_METHOD_4_EFDF87D569449559_OFFSET UNITYSDK_OFFSET(0x1A8DDBE0)
#define RPG_GAMECORE_BYISDAMAGELUCKCRITICAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8DDA90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsDamageLuckCritical_TypeDefinitionIndex = 22653;
