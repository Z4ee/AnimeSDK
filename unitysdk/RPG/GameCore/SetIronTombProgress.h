...
#define RPG_GAMECORE_SETIRONTOMBPROGRESS_METHOD_3_0B69D4B14C04122C_OFFSET UNITYSDK_OFFSET(0x176D2530)
#define RPG_GAMECORE_SETIRONTOMBPROGRESS_METHOD_3_99F5BF092DD84ED5_OFFSET UNITYSDK_OFFSET(0x176D24A0)
#define RPG_GAMECORE_SETIRONTOMBPROGRESS__CTOR_OFFSET UNITYSDK_OFFSET(0x176D2500)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetIronTombProgress_TypeDefinitionIndex = 20996;
