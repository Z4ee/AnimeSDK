...
#define RPG_GAMECORE_MATCHTHREECREATELEVEL_METHOD_3_4866E6AA21EEA333_OFFSET UNITYSDK_OFFSET(0x18ABDE70)
#define RPG_GAMECORE_MATCHTHREECREATELEVEL_METHOD_3_8E9FF66750686E24_OFFSET UNITYSDK_OFFSET(0x18ABDDF0)
#define RPG_GAMECORE_MATCHTHREECREATELEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x18ABDE40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MatchThreeCreateLevel_TypeDefinitionIndex = 19974;
