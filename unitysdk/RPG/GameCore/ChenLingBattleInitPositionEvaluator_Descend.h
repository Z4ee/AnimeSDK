...
#define RPG_GAMECORE_CHENLINGBATTLEINITPOSITIONEVALUATOR_DESCEND_METHOD_3_1C38BF54D54F8559_OFFSET UNITYSDK_OFFSET(0x1707F770)
#define RPG_GAMECORE_CHENLINGBATTLEINITPOSITIONEVALUATOR_DESCEND_METHOD_3_41D386E30E0E3184_OFFSET UNITYSDK_OFFSET(0x1707F6D0)
#define RPG_GAMECORE_CHENLINGBATTLEINITPOSITIONEVALUATOR_DESCEND__CTOR_OFFSET UNITYSDK_OFFSET(0x1707F760)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleInitPositionEvaluator_Descend_TypeDefinitionIndex = 14451;
