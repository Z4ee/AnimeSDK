...
#define RPG_GAMECORE_CHENLINGBATTLEINITPOSITIONEVALUATOR_DESCEND_METHOD_3_1C38BF54D54F8559_OFFSET UNITYSDK_OFFSET(0x19621C50)
#define RPG_GAMECORE_CHENLINGBATTLEINITPOSITIONEVALUATOR_DESCEND_METHOD_3_41D386E30E0E3184_OFFSET UNITYSDK_OFFSET(0x19621BB0)
#define RPG_GAMECORE_CHENLINGBATTLEINITPOSITIONEVALUATOR_DESCEND__CTOR_OFFSET UNITYSDK_OFFSET(0x19621C40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleInitPositionEvaluator_Descend_TypeDefinitionIndex = 14984;
