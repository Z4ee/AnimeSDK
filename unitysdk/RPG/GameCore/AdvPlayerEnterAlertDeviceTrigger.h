...
#define RPG_GAMECORE_ADVPLAYERENTERALERTDEVICETRIGGER_METHOD_3_8C0B16DEC69F5EF4_OFFSET UNITYSDK_OFFSET(0x1D6C36C0)
#define RPG_GAMECORE_ADVPLAYERENTERALERTDEVICETRIGGER_METHOD_3_E30F046FFD8AFFCF_OFFSET UNITYSDK_OFFSET(0x1D6C3700)
#define RPG_GAMECORE_ADVPLAYERENTERALERTDEVICETRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6C36F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvPlayerEnterAlertDeviceTrigger_TypeDefinitionIndex = 20096;
