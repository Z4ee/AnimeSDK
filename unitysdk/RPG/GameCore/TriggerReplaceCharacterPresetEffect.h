...
#define RPG_GAMECORE_TRIGGERREPLACECHARACTERPRESETEFFECT_METHOD_3_92F8A44ECE5A2031_OFFSET UNITYSDK_OFFSET(0x1D603F30)
#define RPG_GAMECORE_TRIGGERREPLACECHARACTERPRESETEFFECT_METHOD_3_E288DF4A51329FDB_OFFSET UNITYSDK_OFFSET(0x1D603FB0)
#define RPG_GAMECORE_TRIGGERREPLACECHARACTERPRESETEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D603F80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerReplaceCharacterPresetEffect_TypeDefinitionIndex = 20030;
