...
#define RPG_GAMECORE_GRIDFIGHTPROJECTIONCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19803DB0)
#define RPG_GAMECORE_GRIDFIGHTPROJECTIONCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19804230)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 RoleID; // 0x50
		::System::UInt32 MazebuffID; // 0x54
		::RPG::Client::TextID ProjectionDesc; // 0x58
