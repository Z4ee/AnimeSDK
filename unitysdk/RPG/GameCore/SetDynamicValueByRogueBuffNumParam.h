...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEBUFFNUMPARAM_METHOD_4_6C633578394B33C5_OFFSET UNITYSDK_OFFSET(0x176C3420)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEBUFFNUMPARAM_METHOD_4_6EC86CA88B115FF5_OFFSET UNITYSDK_OFFSET(0x176C3390)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEBUFFNUMPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x176C33F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRogueBuffNumParam_TypeDefinitionIndex = 19936;
