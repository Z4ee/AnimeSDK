...
#define RPG_GAMECORE_CHIMERADUELSTATUSGETTER_METHOD_3_5D0AA5C20CC28135_OFFSET UNITYSDK_OFFSET(0x1CFCF470)
#define RPG_GAMECORE_CHIMERADUELSTATUSGETTER_METHOD_3_890810B4AE4F4DCD_OFFSET UNITYSDK_OFFSET(0x1CFCF4D0)
#define RPG_GAMECORE_CHIMERADUELSTATUSGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFCF4C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelStatusGetter_TypeDefinitionIndex = 15817;
