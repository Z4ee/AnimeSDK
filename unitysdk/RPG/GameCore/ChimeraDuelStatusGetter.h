...
#define RPG_GAMECORE_CHIMERADUELSTATUSGETTER_METHOD_3_5D0AA5C20CC28135_OFFSET UNITYSDK_OFFSET(0x170A66E0)
#define RPG_GAMECORE_CHIMERADUELSTATUSGETTER_METHOD_3_890810B4AE4F4DCD_OFFSET UNITYSDK_OFFSET(0x170A6740)
#define RPG_GAMECORE_CHIMERADUELSTATUSGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x170A6730)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelStatusGetter_TypeDefinitionIndex = 14684;
