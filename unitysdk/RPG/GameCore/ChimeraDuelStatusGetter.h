...
#define RPG_GAMECORE_CHIMERADUELSTATUSGETTER_METHOD_3_5D0AA5C20CC28135_OFFSET UNITYSDK_OFFSET(0x1C2487C0)
#define RPG_GAMECORE_CHIMERADUELSTATUSGETTER_METHOD_3_890810B4AE4F4DCD_OFFSET UNITYSDK_OFFSET(0x1C248820)
#define RPG_GAMECORE_CHIMERADUELSTATUSGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C248810)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelStatusGetter_TypeDefinitionIndex = 15380;
