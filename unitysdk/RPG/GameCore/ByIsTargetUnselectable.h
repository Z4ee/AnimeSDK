...
#define RPG_GAMECORE_BYISTARGETUNSELECTABLE_METHOD_4_1E496DCCA55219CF_OFFSET UNITYSDK_OFFSET(0x1B2A7DA0)
#define RPG_GAMECORE_BYISTARGETUNSELECTABLE_METHOD_4_6C84D86401A6B7F3_OFFSET UNITYSDK_OFFSET(0x1B2A7F60)
#define RPG_GAMECORE_BYISTARGETUNSELECTABLE_METHOD_4_D352B73ECE9E3E05_OFFSET UNITYSDK_OFFSET(0x1B2A7F90)
#define RPG_GAMECORE_BYISTARGETUNSELECTABLE_METHOD_4_E1B987F210709866_OFFSET UNITYSDK_OFFSET(0x1B2A7D60)
#define RPG_GAMECORE_BYISTARGETUNSELECTABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2A7D90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsTargetUnselectable_TypeDefinitionIndex = 22683;
