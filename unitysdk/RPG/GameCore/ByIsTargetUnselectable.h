...
#define RPG_GAMECORE_BYISTARGETUNSELECTABLE_METHOD_4_1E496DCCA55219CF_OFFSET UNITYSDK_OFFSET(0x17034080)
#define RPG_GAMECORE_BYISTARGETUNSELECTABLE_METHOD_4_35CA86ACD372C84B_OFFSET UNITYSDK_OFFSET(0x17033FB0)
#define RPG_GAMECORE_BYISTARGETUNSELECTABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x17034030)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsTargetUnselectable_TypeDefinitionIndex = 21756;
