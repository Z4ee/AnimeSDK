...
#define RPG_GAMECORE_TIMELINESTATECONFIG_METHOD_2_8AB1B2FC1F1233F9_OFFSET UNITYSDK_OFFSET(0x19DE84A0)
#define RPG_GAMECORE_TIMELINESTATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19DE8640)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TimelineStateConfig_TypeDefinitionIndex = 15783;
