...
#define RPG_GAMECORE_TIMELINESTATECONFIG_METHOD_2_8AB1B2FC1F1233F9_OFFSET UNITYSDK_OFFSET(0x1D5D1FD0)
#define RPG_GAMECORE_TIMELINESTATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5D2170)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TimelineStateConfig_TypeDefinitionIndex = 16433;
