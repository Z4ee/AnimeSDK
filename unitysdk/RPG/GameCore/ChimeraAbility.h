...
#define RPG_GAMECORE_CHIMERAABILITY_METHOD_3_A0A47EA4C0727DD9_OFFSET UNITYSDK_OFFSET(0x1C38BF10)
#define RPG_GAMECORE_CHIMERAABILITY_METHOD_3_B3194E8491FD4A71_OFFSET UNITYSDK_OFFSET(0x1C38BEB0)
#define RPG_GAMECORE_CHIMERAABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1C38BF00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraAbility_TypeDefinitionIndex = 15231;
