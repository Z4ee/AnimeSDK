...
#define RPG_GAMECORE_RESETBATTLEBGMTOSTAGE_METHOD_3_93CD9AC7281E3D38_OFFSET UNITYSDK_OFFSET(0x1D01B0C0)
#define RPG_GAMECORE_RESETBATTLEBGMTOSTAGE_METHOD_3_FDBD668940B17BDB_OFFSET UNITYSDK_OFFSET(0x1D01B080)
#define RPG_GAMECORE_RESETBATTLEBGMTOSTAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D01B0B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetBattleBGMToStage_TypeDefinitionIndex = 22140;
