...
#define RPG_GAMECORE_RESETBATTLEBGMTOSTAGE_METHOD_3_93CD9AC7281E3D38_OFFSET UNITYSDK_OFFSET(0x18CA9BC0)
#define RPG_GAMECORE_RESETBATTLEBGMTOSTAGE_METHOD_3_DA3816C81B3AF991_OFFSET UNITYSDK_OFFSET(0x18CA9B40)
#define RPG_GAMECORE_RESETBATTLEBGMTOSTAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x18CA9B90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetBattleBGMToStage_TypeDefinitionIndex = 21889;
