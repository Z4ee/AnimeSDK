...
#define RPG_GAMECORE_ADVBYPLAYERHIDE_METHOD_4_199F62C376732C92_OFFSET UNITYSDK_OFFSET(0x16F27AE0)
#define RPG_GAMECORE_ADVBYPLAYERHIDE_METHOD_4_45AA98E02D24C9B8_OFFSET UNITYSDK_OFFSET(0x16F27A10)
#define RPG_GAMECORE_ADVBYPLAYERHIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F27A90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvByPlayerHide_TypeDefinitionIndex = 18295;
