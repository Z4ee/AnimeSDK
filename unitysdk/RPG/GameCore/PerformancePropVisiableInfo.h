...
#define RPG_GAMECORE_PERFORMANCEPROPVISIABLEINFO_METHOD_2_77F2A9CAFDAB80FE_OFFSET UNITYSDK_OFFSET(0x1D422EE0)
#define RPG_GAMECORE_PERFORMANCEPROPVISIABLEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D423000)
