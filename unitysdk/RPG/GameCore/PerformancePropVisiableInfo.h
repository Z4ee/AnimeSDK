...
#define RPG_GAMECORE_PERFORMANCEPROPVISIABLEINFO_METHOD_2_3605A98F76584145_OFFSET UNITYSDK_OFFSET(0x17498BA0)
#define RPG_GAMECORE_PERFORMANCEPROPVISIABLEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x17498C90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PerformancePropVisiableInfo_TypeDefinitionIndex = 20023;
