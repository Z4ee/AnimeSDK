...
#define RPG_GAMECORE_PERFORMANCEPROPVISIABLEINFO_METHOD_2_3605A98F76584145_OFFSET UNITYSDK_OFFSET(0x1B4AF5E0)
#define RPG_GAMECORE_PERFORMANCEPROPVISIABLEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4AF6D0)
