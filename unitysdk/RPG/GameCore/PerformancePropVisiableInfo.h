...
#define RPG_GAMECORE_PERFORMANCEPROPVISIABLEINFO_METHOD_2_3605A98F76584145_OFFSET UNITYSDK_OFFSET(0x18BE3160)
#define RPG_GAMECORE_PERFORMANCEPROPVISIABLEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18BE3250)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PerformancePropVisiableInfo_TypeDefinitionIndex = 20704;
