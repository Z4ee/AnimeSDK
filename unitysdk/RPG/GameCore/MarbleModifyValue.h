...
#define RPG_GAMECORE_MARBLEMODIFYVALUE_METHOD_3_69C9D4B7BC1B22D7_OFFSET UNITYSDK_OFFSET(0x1BD1CDA0)
#define RPG_GAMECORE_MARBLEMODIFYVALUE_METHOD_3_AA86816FD34C9827_OFFSET UNITYSDK_OFFSET(0x1BD1CD40)
#define RPG_GAMECORE_MARBLEMODIFYVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD1CD90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleModifyValue_TypeDefinitionIndex = 16170;
