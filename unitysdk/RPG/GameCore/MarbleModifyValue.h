...
#define RPG_GAMECORE_MARBLEMODIFYVALUE_METHOD_3_69C9D4B7BC1B22D7_OFFSET UNITYSDK_OFFSET(0x1D4AD000)
#define RPG_GAMECORE_MARBLEMODIFYVALUE_METHOD_3_AA86816FD34C9827_OFFSET UNITYSDK_OFFSET(0x1D4ACFA0)
#define RPG_GAMECORE_MARBLEMODIFYVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4ACFF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleModifyValue_TypeDefinitionIndex = 16654;
	...
	public:
		...
		static ::System::Void Method_3_AA86816FD34C9827(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::MarbleModifyValue*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::MarbleModifyValue*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_MARBLEMODIFYVALUE_METHOD_3_AA86816FD34C9827_OFFSET))(a1, a2);
		}
