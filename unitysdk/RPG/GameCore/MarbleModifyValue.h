...
#define RPG_GAMECORE_MARBLEMODIFYVALUE_METHOD_3_5A3F108DBFD41D20_OFFSET UNITYSDK_OFFSET(0x18AA0C30)
#define RPG_GAMECORE_MARBLEMODIFYVALUE_METHOD_3_69C9D4B7BC1B22D7_OFFSET UNITYSDK_OFFSET(0x18AA0D10)
#define RPG_GAMECORE_MARBLEMODIFYVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x18AA0CC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleModifyValue_TypeDefinitionIndex = 15934;
