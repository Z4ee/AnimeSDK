...
#define RPG_GAMECORE_BYCOMPARELASTKILLTYPE_METHOD_4_7E337E019A34F2E4_OFFSET UNITYSDK_OFFSET(0x1700D6F0)
#define RPG_GAMECORE_BYCOMPARELASTKILLTYPE_METHOD_4_BEC87B772EA6309A_OFFSET UNITYSDK_OFFSET(0x1700D620)
#define RPG_GAMECORE_BYCOMPARELASTKILLTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1700D6A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareLastKillType_TypeDefinitionIndex = 21733;
