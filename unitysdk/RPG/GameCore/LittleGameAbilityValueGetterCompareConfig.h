...
#define RPG_GAMECORE_LITTLEGAMEABILITYVALUEGETTERCOMPARECONFIG_METHOD_3_3498129509E33A75_OFFSET UNITYSDK_OFFSET(0x198970B0)
#define RPG_GAMECORE_LITTLEGAMEABILITYVALUEGETTERCOMPARECONFIG_METHOD_3_AD4BD8F5862821C9_OFFSET UNITYSDK_OFFSET(0x19897050)
#define RPG_GAMECORE_LITTLEGAMEABILITYVALUEGETTERCOMPARECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x198970A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityValueGetterCompareConfig_TypeDefinitionIndex = 20217;
