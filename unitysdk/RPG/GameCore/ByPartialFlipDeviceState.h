...
#define RPG_GAMECORE_BYPARTIALFLIPDEVICESTATE_METHOD_4_4F21E8E9642AD374_OFFSET UNITYSDK_OFFSET(0x1CF56170)
#define RPG_GAMECORE_BYPARTIALFLIPDEVICESTATE_METHOD_4_754B0BBE37C74B55_OFFSET UNITYSDK_OFFSET(0x1CF55F30)
#define RPG_GAMECORE_BYPARTIALFLIPDEVICESTATE_METHOD_4_9B132C3FC9F78B70_OFFSET UNITYSDK_OFFSET(0x1CF55F70)
#define RPG_GAMECORE_BYPARTIALFLIPDEVICESTATE_METHOD_4_B67B597A79A45B9B_OFFSET UNITYSDK_OFFSET(0x1CF561A0)
#define RPG_GAMECORE_BYPARTIALFLIPDEVICESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF55F60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByPartialFlipDeviceState_TypeDefinitionIndex = 22087;
