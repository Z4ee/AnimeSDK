...
#define RPG_GAMECORE_DICECOMBATV2SINGLEDIALOGPERFORMANCETRIGGERCONDITION_DAMAGEREACH_METHOD_3_589D0B89518192D4_OFFSET UNITYSDK_OFFSET(0x1887EAC0)
#define RPG_GAMECORE_DICECOMBATV2SINGLEDIALOGPERFORMANCETRIGGERCONDITION_DAMAGEREACH_METHOD_3_C5A8B46F2D4CBC88_OFFSET UNITYSDK_OFFSET(0x1887E770)
#define RPG_GAMECORE_DICECOMBATV2SINGLEDIALOGPERFORMANCETRIGGERCONDITION_DAMAGEREACH__CTOR_OFFSET UNITYSDK_OFFSET(0x1887E760)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatV2SingleDialogPerformanceTriggerCondition_DamageReach_TypeDefinitionIndex = 15351;
