...
#define RPG_GAMECORE_TRIGGERMAZEMINIMAPUI_METHOD_3_A9F1C8E8A4AF1357_OFFSET UNITYSDK_OFFSET(0x19E17940)
#define RPG_GAMECORE_TRIGGERMAZEMINIMAPUI_METHOD_3_AB067C7BFC61E143_OFFSET UNITYSDK_OFFSET(0x19E17830)
#define RPG_GAMECORE_TRIGGERMAZEMINIMAPUI__CTOR_OFFSET UNITYSDK_OFFSET(0x19E17910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerMazeMiniMapUI_TypeDefinitionIndex = 20856;
