...
#define RPG_GAMECORE_FIVEDIMDASHORBCONFIG_METHOD_3_7E15FBC442BEAF38_OFFSET UNITYSDK_OFFSET(0x188FCCB0)
#define RPG_GAMECORE_FIVEDIMDASHORBCONFIG_METHOD_3_E6D3B3A2514DFB1E_OFFSET UNITYSDK_OFFSET(0x188FCC40)
#define RPG_GAMECORE_FIVEDIMDASHORBCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x188FCC90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimDashOrbConfig_TypeDefinitionIndex = 17642;
