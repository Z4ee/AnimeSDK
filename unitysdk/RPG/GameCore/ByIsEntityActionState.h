...
#define RPG_GAMECORE_BYISENTITYACTIONSTATE_METHOD_4_6F9ADF696BEE7F9F_OFFSET UNITYSDK_OFFSET(0x18752130)
#define RPG_GAMECORE_BYISENTITYACTIONSTATE_METHOD_4_E599C808F1EF0FC1_OFFSET UNITYSDK_OFFSET(0x18752060)
#define RPG_GAMECORE_BYISENTITYACTIONSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x187520E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsEntityActionState_TypeDefinitionIndex = 21988;
