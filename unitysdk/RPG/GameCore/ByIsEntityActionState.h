...
#define RPG_GAMECORE_BYISENTITYACTIONSTATE_METHOD_4_5D4B0071FE73973E_OFFSET UNITYSDK_OFFSET(0x1CF39AA0)
#define RPG_GAMECORE_BYISENTITYACTIONSTATE_METHOD_4_6F9ADF696BEE7F9F_OFFSET UNITYSDK_OFFSET(0x1CF39AE0)
#define RPG_GAMECORE_BYISENTITYACTIONSTATE_METHOD_4_7DEE599E6F40A37B_OFFSET UNITYSDK_OFFSET(0x1CF39C90)
#define RPG_GAMECORE_BYISENTITYACTIONSTATE_METHOD_4_C61471CF11ADDDF5_OFFSET UNITYSDK_OFFSET(0x1CF39C60)
#define RPG_GAMECORE_BYISENTITYACTIONSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF39AD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsEntityActionState_TypeDefinitionIndex = 22806;
