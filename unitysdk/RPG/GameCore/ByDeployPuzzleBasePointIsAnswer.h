...
#define RPG_GAMECORE_BYDEPLOYPUZZLEBASEPOINTISANSWER_METHOD_4_6B473086341B0748_OFFSET UNITYSDK_OFFSET(0x18744A70)
#define RPG_GAMECORE_BYDEPLOYPUZZLEBASEPOINTISANSWER_METHOD_4_D1157BC87209D95F_OFFSET UNITYSDK_OFFSET(0x18744C10)
#define RPG_GAMECORE_BYDEPLOYPUZZLEBASEPOINTISANSWER__CTOR_OFFSET UNITYSDK_OFFSET(0x18744B50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByDeployPuzzleBasePointIsAnswer_TypeDefinitionIndex = 20836;
