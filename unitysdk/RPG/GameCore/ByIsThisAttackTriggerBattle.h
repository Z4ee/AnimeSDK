...
#define RPG_GAMECORE_BYISTHISATTACKTRIGGERBATTLE_METHOD_4_33ACF008B32AFEBF_OFFSET UNITYSDK_OFFSET(0x17034E00)
#define RPG_GAMECORE_BYISTHISATTACKTRIGGERBATTLE_METHOD_4_63934EB617C35446_OFFSET UNITYSDK_OFFSET(0x17034D30)
#define RPG_GAMECORE_BYISTHISATTACKTRIGGERBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x17034DB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsThisAttackTriggerBattle_TypeDefinitionIndex = 19105;
