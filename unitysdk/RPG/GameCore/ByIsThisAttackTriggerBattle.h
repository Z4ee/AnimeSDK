...
#define RPG_GAMECORE_BYISTHISATTACKTRIGGERBATTLE_METHOD_4_33ACF008B32AFEBF_OFFSET UNITYSDK_OFFSET(0x1CF4DEF0)
#define RPG_GAMECORE_BYISTHISATTACKTRIGGERBATTLE_METHOD_4_CED2AF6AE150053B_OFFSET UNITYSDK_OFFSET(0x1CF4DEA0)
#define RPG_GAMECORE_BYISTHISATTACKTRIGGERBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF4DEE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsThisAttackTriggerBattle_TypeDefinitionIndex = 20546;
