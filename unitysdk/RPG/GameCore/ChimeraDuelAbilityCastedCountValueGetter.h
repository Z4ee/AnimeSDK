...
#define RPG_GAMECORE_CHIMERADUELABILITYCASTEDCOUNTVALUEGETTER_METHOD_3_4528D6B76AC207E9_OFFSET UNITYSDK_OFFSET(0x170953E0)
#define RPG_GAMECORE_CHIMERADUELABILITYCASTEDCOUNTVALUEGETTER_METHOD_3_EB70E6191F533914_OFFSET UNITYSDK_OFFSET(0x17095480)
#define RPG_GAMECORE_CHIMERADUELABILITYCASTEDCOUNTVALUEGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x17095470)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelAbilityCastedCountValueGetter_TypeDefinitionIndex = 14692;
