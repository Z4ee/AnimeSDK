...
#define RPG_GAMECORE_CHIMERADUELABILITYCASTEDCOUNTVALUEGETTER_METHOD_3_4528D6B76AC207E9_OFFSET UNITYSDK_OFFSET(0x19636690)
#define RPG_GAMECORE_CHIMERADUELABILITYCASTEDCOUNTVALUEGETTER_METHOD_3_EB70E6191F533914_OFFSET UNITYSDK_OFFSET(0x19636730)
#define RPG_GAMECORE_CHIMERADUELABILITYCASTEDCOUNTVALUEGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19636720)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelAbilityCastedCountValueGetter_TypeDefinitionIndex = 15223;
