...
#define RPG_GAMECORE_CHIMERADUELABILITYCASTEDCOUNTVALUEGETTER_METHOD_3_4528D6B76AC207E9_OFFSET UNITYSDK_OFFSET(0x1C390800)
#define RPG_GAMECORE_CHIMERADUELABILITYCASTEDCOUNTVALUEGETTER_METHOD_3_EB70E6191F533914_OFFSET UNITYSDK_OFFSET(0x1C3908A0)
#define RPG_GAMECORE_CHIMERADUELABILITYCASTEDCOUNTVALUEGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C390890)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelAbilityCastedCountValueGetter_TypeDefinitionIndex = 15387;
