...
#define RPG_GAMECORE_SETENERGYBARSTATE_METHOD_3_2FFF4AA972C84BB1_OFFSET UNITYSDK_OFFSET(0x18E2DC30)
#define RPG_GAMECORE_SETENERGYBARSTATE_METHOD_3_69FFF948B6EA4CA2_OFFSET UNITYSDK_OFFSET(0x18E2DA90)
#define RPG_GAMECORE_SETENERGYBARSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E2DAD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetEnergyBarState_TypeDefinitionIndex = 21640;
