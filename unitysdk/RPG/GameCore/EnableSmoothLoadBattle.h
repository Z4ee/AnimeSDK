...
#define RPG_GAMECORE_ENABLESMOOTHLOADBATTLE_METHOD_3_55CA621CDEB379B2_OFFSET UNITYSDK_OFFSET(0x1D064570)
#define RPG_GAMECORE_ENABLESMOOTHLOADBATTLE_METHOD_3_A9CB15978EA6796B_OFFSET UNITYSDK_OFFSET(0x1D064520)
#define RPG_GAMECORE_ENABLESMOOTHLOADBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D064560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnableSmoothLoadBattle_TypeDefinitionIndex = 23059;
