...
#define RPG_GAMECORE_ENABLESMOOTHLOADBATTLE_METHOD_3_55CA621CDEB379B2_OFFSET UNITYSDK_OFFSET(0x1719A310)
#define RPG_GAMECORE_ENABLESMOOTHLOADBATTLE_METHOD_3_B00DA771B7E0E0E3_OFFSET UNITYSDK_OFFSET(0x1719A280)
#define RPG_GAMECORE_ENABLESMOOTHLOADBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1719A2E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnableSmoothLoadBattle_TypeDefinitionIndex = 21560;
