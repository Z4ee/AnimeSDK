...
#define RPG_GAMECORE_ACTIVITYQUESTREWARDDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1862A350)
#define RPG_GAMECORE_ACTIVITYQUESTREWARDDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1862A9D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityQuestRewardDataRow_TypeDefinitionIndex = 11638;
