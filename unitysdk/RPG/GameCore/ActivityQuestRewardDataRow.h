...
#define RPG_GAMECORE_ACTIVITYQUESTREWARDDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1AB027A0)
#define RPG_GAMECORE_ACTIVITYQUESTREWARDDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB02E40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityQuestRewardDataRow_TypeDefinitionIndex = 11837;
