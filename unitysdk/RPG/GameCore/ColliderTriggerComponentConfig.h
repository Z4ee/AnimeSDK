...
#define RPG_GAMECORE_COLLIDERTRIGGERCOMPONENTCONFIG_METHOD_3_6E0637666EBE6D2D_OFFSET UNITYSDK_OFFSET(0x1D9A5B70)
#define RPG_GAMECORE_COLLIDERTRIGGERCOMPONENTCONFIG_METHOD_3_D9842F77CE5AEF48_OFFSET UNITYSDK_OFFSET(0x1D9A5AD0)
#define RPG_GAMECORE_COLLIDERTRIGGERCOMPONENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D9A5B60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ColliderTriggerComponentConfig_TypeDefinitionIndex = 16392;
