...
#define RPG_GAMECORE_COLLIDERTRIGGERCOMPONENTCONFIG_METHOD_3_6E0637666EBE6D2D_OFFSET UNITYSDK_OFFSET(0x1711FD10)
#define RPG_GAMECORE_COLLIDERTRIGGERCOMPONENTCONFIG_METHOD_3_D9842F77CE5AEF48_OFFSET UNITYSDK_OFFSET(0x1711FC70)
#define RPG_GAMECORE_COLLIDERTRIGGERCOMPONENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1711FD00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ColliderTriggerComponentConfig_TypeDefinitionIndex = 15170;
