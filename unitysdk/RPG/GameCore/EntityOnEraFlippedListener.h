...
#define RPG_GAMECORE_ENTITYONERAFLIPPEDLISTENER_METHOD_3_531791B1D529E117_OFFSET UNITYSDK_OFFSET(0x171A1C50)
#define RPG_GAMECORE_ENTITYONERAFLIPPEDLISTENER_METHOD_3_7770C2DB08C2B5F7_OFFSET UNITYSDK_OFFSET(0x171A1BD0)
#define RPG_GAMECORE_ENTITYONERAFLIPPEDLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x171A1C20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EntityOnEraFlippedListener_TypeDefinitionIndex = 20543;
