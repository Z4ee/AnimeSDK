...
#define RPG_GAMECORE_ENTITYONERAFLIPPEDLISTENER_METHOD_3_0EA77CCED904D1DF_OFFSET UNITYSDK_OFFSET(0x1D7C5FC0)
#define RPG_GAMECORE_ENTITYONERAFLIPPEDLISTENER_METHOD_3_C11E17BA95634945_OFFSET UNITYSDK_OFFSET(0x1D7C6010)
#define RPG_GAMECORE_ENTITYONERAFLIPPEDLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7C6000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EntityOnEraFlippedListener_TypeDefinitionIndex = 22099;
