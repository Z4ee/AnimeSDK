...
#define RPG_GAMECORE_ANNIVERSARYCOLLECTIONGROUPCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1947C1F0)
#define RPG_GAMECORE_ANNIVERSARYCOLLECTIONGROUPCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1947C380)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AnniversaryCollectionGroupConfigRow_TypeDefinitionIndex = 12057;
