...
#define RPG_GAMECORE_PROPSWITCHMATERIAL_METHOD_3_30CCBD148FDAD1F4_OFFSET UNITYSDK_OFFSET(0x18C7A8A0)
#define RPG_GAMECORE_PROPSWITCHMATERIAL_METHOD_3_BD03B23894186EDF_OFFSET UNITYSDK_OFFSET(0x18C7A6B0)
#define RPG_GAMECORE_PROPSWITCHMATERIAL__CTOR_OFFSET UNITYSDK_OFFSET(0x18C7A7C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropSwitchMaterial_TypeDefinitionIndex = 21031;
