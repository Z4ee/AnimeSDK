...
#define RPG_GAMECORE_OPTICALILLUSIONENTERPERFORMANCE_METHOD_3_82DD9059B84721B1_OFFSET UNITYSDK_OFFSET(0x1747EF90)
#define RPG_GAMECORE_OPTICALILLUSIONENTERPERFORMANCE_METHOD_3_91C4731A548A1C3F_OFFSET UNITYSDK_OFFSET(0x1747EE40)
#define RPG_GAMECORE_OPTICALILLUSIONENTERPERFORMANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1747EF00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OpticalIllusionEnterPerformance_TypeDefinitionIndex = 20413;
