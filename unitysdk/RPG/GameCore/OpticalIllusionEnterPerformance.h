...
#define RPG_GAMECORE_OPTICALILLUSIONENTERPERFORMANCE_METHOD_3_82DD9059B84721B1_OFFSET UNITYSDK_OFFSET(0x1CE99CF0)
#define RPG_GAMECORE_OPTICALILLUSIONENTERPERFORMANCE_METHOD_3_951E4EDDFB1AF881_OFFSET UNITYSDK_OFFSET(0x1CE99C70)
#define RPG_GAMECORE_OPTICALILLUSIONENTERPERFORMANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE99CC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OpticalIllusionEnterPerformance_TypeDefinitionIndex = 21974;
