...
#define RPG_GAMECORE_BYTARGETALIVESTATE_METHOD_4_39029E29FC2F1230_OFFSET UNITYSDK_OFFSET(0x1703B6F0)
#define RPG_GAMECORE_BYTARGETALIVESTATE_METHOD_4_9D2BB8B676902328_OFFSET UNITYSDK_OFFSET(0x1703B7C0)
#define RPG_GAMECORE_BYTARGETALIVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1703B770)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByTargetAliveState_TypeDefinitionIndex = 21674;
