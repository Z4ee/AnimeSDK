...
#define RPG_GAMECORE_SWITCHEFFECTBATTLEAREA_METHOD_3_733DB8F848D60550_OFFSET UNITYSDK_OFFSET(0x19CD9FA0)
#define RPG_GAMECORE_SWITCHEFFECTBATTLEAREA_METHOD_3_CB2E21A1E23717C1_OFFSET UNITYSDK_OFFSET(0x19CDA020)
#define RPG_GAMECORE_SWITCHEFFECTBATTLEAREA__CTOR_OFFSET UNITYSDK_OFFSET(0x19CD9FF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchEffectBattleArea_TypeDefinitionIndex = 22049;
