...
#define RPG_GAMECORE_SWITCHEFFECTBATTLEAREA_METHOD_3_A1671127875F7698_OFFSET UNITYSDK_OFFSET(0x1D58A7B0)
#define RPG_GAMECORE_SWITCHEFFECTBATTLEAREA_METHOD_3_D98F74A8D356C321_OFFSET UNITYSDK_OFFSET(0x1D58A770)
#define RPG_GAMECORE_SWITCHEFFECTBATTLEAREA__CTOR_OFFSET UNITYSDK_OFFSET(0x1D58A7A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchEffectBattleArea_TypeDefinitionIndex = 23057;
