...
#define RPG_GAMECORE_ROGUEACTGETROGUEMAGICUNITRANDOMCOUNTCONFIG_METHOD_6_93367ECA63088707_OFFSET UNITYSDK_OFFSET(0x1D02E3A0)
#define RPG_GAMECORE_ROGUEACTGETROGUEMAGICUNITRANDOMCOUNTCONFIG_METHOD_6_DD7342E6231C2AAB_OFFSET UNITYSDK_OFFSET(0x1D02E3F0)
#define RPG_GAMECORE_ROGUEACTGETROGUEMAGICUNITRANDOMCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D02E3E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActGetRogueMagicUnitRandomCountConfig_TypeDefinitionIndex = 18921;
