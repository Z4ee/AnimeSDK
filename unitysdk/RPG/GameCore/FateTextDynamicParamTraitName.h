...
#define RPG_GAMECORE_FATETEXTDYNAMICPARAMTRAITNAME_METHOD_3_3C3F1DB80DDD2778_OFFSET UNITYSDK_OFFSET(0x188DB870)
#define RPG_GAMECORE_FATETEXTDYNAMICPARAMTRAITNAME_METHOD_3_BB28B4C562F08E88_OFFSET UNITYSDK_OFFSET(0x188DB8D0)
#define RPG_GAMECORE_FATETEXTDYNAMICPARAMTRAITNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x188DB8C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateTextDynamicParamTraitName_TypeDefinitionIndex = 15765;
