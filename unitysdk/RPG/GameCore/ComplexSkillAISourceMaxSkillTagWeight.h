...
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEMAXSKILLTAGWEIGHT_METHOD_3_42B3DC331031E05B_OFFSET UNITYSDK_OFFSET(0x1966FA70)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEMAXSKILLTAGWEIGHT_METHOD_3_CFC848DB616F8D0C_OFFSET UNITYSDK_OFFSET(0x1966D2A0)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEMAXSKILLTAGWEIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x1966D280)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAISourceMaxSkillTagWeight_TypeDefinitionIndex = 14770;
