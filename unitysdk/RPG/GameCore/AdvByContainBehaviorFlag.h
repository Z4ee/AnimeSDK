...
#define RPG_GAMECORE_ADVBYCONTAINBEHAVIORFLAG_METHOD_4_46D7E3FA320721B9_OFFSET UNITYSDK_OFFSET(0x18648110)
#define RPG_GAMECORE_ADVBYCONTAINBEHAVIORFLAG_METHOD_4_8F050E4105BA6E2E_OFFSET UNITYSDK_OFFSET(0x18648230)
#define RPG_GAMECORE_ADVBYCONTAINBEHAVIORFLAG__CTOR_OFFSET UNITYSDK_OFFSET(0x186481B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvByContainBehaviorFlag_TypeDefinitionIndex = 20666;
