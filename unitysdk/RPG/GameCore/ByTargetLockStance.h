...
#define RPG_GAMECORE_BYTARGETLOCKSTANCE_METHOD_4_4B899A9B80CAD443_OFFSET UNITYSDK_OFFSET(0x1B2C1DA0)
#define RPG_GAMECORE_BYTARGETLOCKSTANCE_METHOD_4_7C298BF2F944EFD5_OFFSET UNITYSDK_OFFSET(0x1B2C1DD0)
#define RPG_GAMECORE_BYTARGETLOCKSTANCE_METHOD_4_7DB2933E07769D56_OFFSET UNITYSDK_OFFSET(0x1B2C1BA0)
#define RPG_GAMECORE_BYTARGETLOCKSTANCE_METHOD_4_D1C297B7355CB37F_OFFSET UNITYSDK_OFFSET(0x1B2C1BE0)
#define RPG_GAMECORE_BYTARGETLOCKSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2C1BD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByTargetLockStance_TypeDefinitionIndex = 22776;
