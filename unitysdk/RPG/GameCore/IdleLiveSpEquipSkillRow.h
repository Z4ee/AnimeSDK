...
#define RPG_GAMECORE_IDLELIVESPEQUIPSKILLROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D1A34A0)
#define RPG_GAMECORE_IDLELIVESPEQUIPSKILLROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1A3700)
