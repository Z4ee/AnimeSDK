...
#define RPG_GAMECORE_VP_MUL_METHOD_3_0A8FA96807155CA4_OFFSET UNITYSDK_OFFSET(0x1DEAAB00)
#define RPG_GAMECORE_VP_MUL_METHOD_3_0DF253D2109A5CFC_OFFSET UNITYSDK_OFFSET(0x1DEAAB30)
#define RPG_GAMECORE_VP_MUL_METHOD_3_1CFAE318C8045BD0_OFFSET UNITYSDK_OFFSET(0x1DEAAA80)
#define RPG_GAMECORE_VP_MUL_METHOD_3_CDEFB4653038268D_OFFSET UNITYSDK_OFFSET(0x1DEAA9D0)
#define RPG_GAMECORE_VP_MUL__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEAAA70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VP_Mul_TypeDefinitionIndex = 23774;
