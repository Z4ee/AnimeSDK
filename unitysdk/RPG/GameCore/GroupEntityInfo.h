...
#define RPG_GAMECORE_GROUPENTITYINFO_METHOD_2_0AC0F644E9C65E8C_OFFSET UNITYSDK_OFFSET(0x19813130)
#define RPG_GAMECORE_GROUPENTITYINFO_METHOD_2_6CFD44C339508CDE_OFFSET UNITYSDK_OFFSET(0x198132A0)
#define RPG_GAMECORE_GROUPENTITYINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19813290)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GroupEntityInfo_TypeDefinitionIndex = 19150;
