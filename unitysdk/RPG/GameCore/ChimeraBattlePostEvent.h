...
#define RPG_GAMECORE_CHIMERABATTLEPOSTEVENT_METHOD_3_28C0D6C49E1C0090_OFFSET UNITYSDK_OFFSET(0x19633F20)
#define RPG_GAMECORE_CHIMERABATTLEPOSTEVENT_METHOD_3_CD2F3851201553D8_OFFSET UNITYSDK_OFFSET(0x196357D0)
#define RPG_GAMECORE_CHIMERABATTLEPOSTEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19633F10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraBattlePostEvent_TypeDefinitionIndex = 15071;
