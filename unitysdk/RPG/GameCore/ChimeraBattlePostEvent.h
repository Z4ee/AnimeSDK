...
#define RPG_GAMECORE_CHIMERABATTLEPOSTEVENT_METHOD_3_28C0D6C49E1C0090_OFFSET UNITYSDK_OFFSET(0x1CFBCAA0)
#define RPG_GAMECORE_CHIMERABATTLEPOSTEVENT_METHOD_3_CD2F3851201553D8_OFFSET UNITYSDK_OFFSET(0x1CFBE1B0)
#define RPG_GAMECORE_CHIMERABATTLEPOSTEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFBCA90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraBattlePostEvent_TypeDefinitionIndex = 15672;
