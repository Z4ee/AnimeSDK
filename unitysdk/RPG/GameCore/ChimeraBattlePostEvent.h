...
#define RPG_GAMECORE_CHIMERABATTLEPOSTEVENT_METHOD_3_28C0D6C49E1C0090_OFFSET UNITYSDK_OFFSET(0x17092D70)
#define RPG_GAMECORE_CHIMERABATTLEPOSTEVENT_METHOD_3_CD2F3851201553D8_OFFSET UNITYSDK_OFFSET(0x17094610)
#define RPG_GAMECORE_CHIMERABATTLEPOSTEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x17092D60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraBattlePostEvent_TypeDefinitionIndex = 14538;
