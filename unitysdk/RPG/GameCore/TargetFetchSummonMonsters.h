...
#define RPG_GAMECORE_TARGETFETCHSUMMONMONSTERS_METHOD_4_CAC4DDCF92FE006A_OFFSET UNITYSDK_OFFSET(0x177C03C0)
#define RPG_GAMECORE_TARGETFETCHSUMMONMONSTERS_METHOD_4_FE0028A85C2F1498_OFFSET UNITYSDK_OFFSET(0x177B8650)
#define RPG_GAMECORE_TARGETFETCHSUMMONMONSTERS__CTOR_OFFSET UNITYSDK_OFFSET(0x177B8600)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchSummonMonsters_TypeDefinitionIndex = 22220;
