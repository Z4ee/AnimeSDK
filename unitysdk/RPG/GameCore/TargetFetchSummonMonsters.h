...
#define RPG_GAMECORE_TARGETFETCHSUMMONMONSTERS_METHOD_4_0CCE5CFA2882B4FD_OFFSET UNITYSDK_OFFSET(0x1D0BCD80)
#define RPG_GAMECORE_TARGETFETCHSUMMONMONSTERS_METHOD_4_1B753EE33C809EA0_OFFSET UNITYSDK_OFFSET(0x1D0BCE80)
#define RPG_GAMECORE_TARGETFETCHSUMMONMONSTERS_METHOD_4_4E100FAD46D4F5ED_OFFSET UNITYSDK_OFFSET(0x1D0BCE60)
#define RPG_GAMECORE_TARGETFETCHSUMMONMONSTERS_METHOD_4_FE0028A85C2F1498_OFFSET UNITYSDK_OFFSET(0x1D0BCE00)
#define RPG_GAMECORE_TARGETFETCHSUMMONMONSTERS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0BCDF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchSummonMonsters_TypeDefinitionIndex = 23088;
