...
#define RPG_GAMECORE_ALLEYBASEGRIDITEMDATA_METHOD_2_624105AE8EA76FA2_OFFSET UNITYSDK_OFFSET(0x19466080)
#define RPG_GAMECORE_ALLEYBASEGRIDITEMDATA_METHOD_2_F48D35FAF57FD14F_OFFSET UNITYSDK_OFFSET(0x19466360)
#define RPG_GAMECORE_ALLEYBASEGRIDITEMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19466350)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AlleyBaseGridItemData_TypeDefinitionIndex = 14900;
