...
#define RPG_GAMECORE_CHARACTERMATERIALTEMPLATE_METHOD_2_A917FB706A961AF0_OFFSET UNITYSDK_OFFSET(0x1B724FE0)
#define RPG_GAMECORE_CHARACTERMATERIALTEMPLATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B725020)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterMaterialTemplate_TypeDefinitionIndex = 16748;
