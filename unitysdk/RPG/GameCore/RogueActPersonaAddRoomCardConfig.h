...
#define RPG_GAMECORE_ROGUEACTPERSONAADDROOMCARDCONFIG_METHOD_6_BB2BD05D9EFFB57F_OFFSET UNITYSDK_OFFSET(0x175B9900)
#define RPG_GAMECORE_ROGUEACTPERSONAADDROOMCARDCONFIG_METHOD_6_C55A500CD877A6AA_OFFSET UNITYSDK_OFFSET(0x175B9B20)
#define RPG_GAMECORE_ROGUEACTPERSONAADDROOMCARDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175B9A40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaAddRoomCardConfig_TypeDefinitionIndex = 18103;
