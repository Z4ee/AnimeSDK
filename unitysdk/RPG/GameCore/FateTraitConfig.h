...
#define RPG_GAMECORE_FATETRAITCONFIG_METHOD_2_AF675373B13E5FC1_OFFSET UNITYSDK_OFFSET(0x19717D50)
#define RPG_GAMECORE_FATETRAITCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19717E00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateTraitConfig_TypeDefinitionIndex = 15796;
