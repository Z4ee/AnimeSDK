...
#define RPG_GAMECORE_FATETRAITCONFIG_METHOD_2_AF675373B13E5FC1_OFFSET UNITYSDK_OFFSET(0x1BA77C70)
#define RPG_GAMECORE_FATETRAITCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA77D20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateTraitConfig_TypeDefinitionIndex = 15970;
