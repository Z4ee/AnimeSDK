...
#define RPG_GAMECORE_GROUPPROPERTYCONFIG_METHOD_2_6BFF9490B892613C_OFFSET UNITYSDK_OFFSET(0x1D3C3420)
#define RPG_GAMECORE_GROUPPROPERTYCONFIG_METHOD_2_6E26656A9824F8DA_OFFSET UNITYSDK_OFFSET(0x1D3C3190)
#define RPG_GAMECORE_GROUPPROPERTYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3C3410)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GroupPropertyConfig_TypeDefinitionIndex = 18074;
