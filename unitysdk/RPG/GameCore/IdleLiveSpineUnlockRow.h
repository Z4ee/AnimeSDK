...
#define RPG_GAMECORE_IDLELIVESPINEUNLOCKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19847FC0)
#define RPG_GAMECORE_IDLELIVESPINEUNLOCKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19848100)

namespace RPG::GameCore
{
	inline static constexpr unsigned int IdleLiveSpineUnlockRow_TypeDefinitionIndex = 11310;
