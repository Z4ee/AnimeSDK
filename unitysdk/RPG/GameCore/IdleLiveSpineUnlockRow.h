...
#define RPG_GAMECORE_IDLELIVESPINEUNLOCKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B008380)
#define RPG_GAMECORE_IDLELIVESPINEUNLOCKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0084C0)
