...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONSAMEPERSONAROOMCARDNUMCONFIG_METHOD_3_1A72A4BFCF327374_OFFSET UNITYSDK_OFFSET(0x1CFC1030)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONSAMEPERSONAROOMCARDNUMCONFIG_METHOD_3_391F08243AF2C3F8_OFFSET UNITYSDK_OFFSET(0x1CFC0FE0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONSAMEPERSONAROOMCARDNUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFC1020)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionSamePersonaRoomCardNumConfig_TypeDefinitionIndex = 17092;
