...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERCHAPTERRETURNPREPARATIONCONFIG_METHOD_3_99782C147ED2F033_OFFSET UNITYSDK_OFFSET(0x197EBCB0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERCHAPTERRETURNPREPARATIONCONFIG_METHOD_3_AF49F575B4B9407A_OFFSET UNITYSDK_OFFSET(0x197F19A0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERCHAPTERRETURNPREPARATIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197EBC60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierExecActionAfterChapterReturnPreparationConfig_TypeDefinitionIndex = 18347;
