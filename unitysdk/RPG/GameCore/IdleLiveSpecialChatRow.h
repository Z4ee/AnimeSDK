...
#define RPG_GAMECORE_IDLELIVESPECIALCHATROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D1A39D0)
#define RPG_GAMECORE_IDLELIVESPECIALCHATROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1A3CB0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Boolean IsExclusive; // 0x24
