...
#define RPG_GAMECORE_FIVEDIMFIREAVATAREFFECTACTION_METHOD_3_2A03DF024D68B4C9_OFFSET UNITYSDK_OFFSET(0x1D85DFB0)
#define RPG_GAMECORE_FIVEDIMFIREAVATAREFFECTACTION_METHOD_3_D754605D3F484D52_OFFSET UNITYSDK_OFFSET(0x1D85DFF0)
#define RPG_GAMECORE_FIVEDIMFIREAVATAREFFECTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D85DFE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimFireAvatarEffectAction_TypeDefinitionIndex = 18531;
