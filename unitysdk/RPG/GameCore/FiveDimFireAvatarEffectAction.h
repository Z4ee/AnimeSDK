...
#define RPG_GAMECORE_FIVEDIMFIREAVATAREFFECTACTION_METHOD_3_7FB56762C9B7ACFB_OFFSET UNITYSDK_OFFSET(0x18901300)
#define RPG_GAMECORE_FIVEDIMFIREAVATAREFFECTACTION_METHOD_3_D754605D3F484D52_OFFSET UNITYSDK_OFFSET(0x188F5890)
#define RPG_GAMECORE_FIVEDIMFIREAVATAREFFECTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x188F5870)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimFireAvatarEffectAction_TypeDefinitionIndex = 17804;
