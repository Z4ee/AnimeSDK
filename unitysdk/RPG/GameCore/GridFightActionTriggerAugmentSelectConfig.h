...
#define RPG_GAMECORE_GRIDFIGHTACTIONTRIGGERAUGMENTSELECTCONFIG_METHOD_6_2D678115EB2E4599_OFFSET UNITYSDK_OFFSET(0x197D8220)
#define RPG_GAMECORE_GRIDFIGHTACTIONTRIGGERAUGMENTSELECTCONFIG_METHOD_6_534C3B794031F492_OFFSET UNITYSDK_OFFSET(0x197D8DE0)
#define RPG_GAMECORE_GRIDFIGHTACTIONTRIGGERAUGMENTSELECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197D8180)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightActionTriggerAugmentSelectConfig_TypeDefinitionIndex = 18317;
