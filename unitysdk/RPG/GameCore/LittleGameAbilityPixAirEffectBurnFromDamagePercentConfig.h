...
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTBURNFROMDAMAGEPERCENTCONFIG_METHOD_3_A6D095DED6E2E56E_OFFSET UNITYSDK_OFFSET(0x19894080)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTBURNFROMDAMAGEPERCENTCONFIG_METHOD_3_E302133F03E61E1A_OFFSET UNITYSDK_OFFSET(0x19894150)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTBURNFROMDAMAGEPERCENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19894140)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityPixAirEffectBurnFromDamagePercentConfig_TypeDefinitionIndex = 20191;
