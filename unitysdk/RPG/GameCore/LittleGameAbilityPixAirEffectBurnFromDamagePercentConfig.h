...
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTBURNFROMDAMAGEPERCENTCONFIG_METHOD_3_A6D095DED6E2E56E_OFFSET UNITYSDK_OFFSET(0x1D1FA380)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTBURNFROMDAMAGEPERCENTCONFIG_METHOD_3_E302133F03E61E1A_OFFSET UNITYSDK_OFFSET(0x1D1FA450)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTBURNFROMDAMAGEPERCENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1FA440)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityPixAirEffectBurnFromDamagePercentConfig_TypeDefinitionIndex = 21116;
