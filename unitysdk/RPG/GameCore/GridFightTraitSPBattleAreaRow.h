...
#define RPG_GAMECORE_GRIDFIGHTTRAITSPBATTLEAREAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17289900)
#define RPG_GAMECORE_GRIDFIGHTTRAITSPBATTLEAREAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17289A90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightTraitSPBattleAreaRow_TypeDefinitionIndex = 12519;
