...
#define RPG_GAMECORE_ROGUEMANAGERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D3F2A00)
#define RPG_GAMECORE_ROGUEMANAGERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3F3100)
