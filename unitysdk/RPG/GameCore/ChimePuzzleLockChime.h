...
#define RPG_GAMECORE_CHIMEPUZZLELOCKCHIME_METHOD_3_814E3DA60AA4489E_OFFSET UNITYSDK_OFFSET(0x17090850)
#define RPG_GAMECORE_CHIMEPUZZLELOCKCHIME_METHOD_3_C17792D495D37292_OFFSET UNITYSDK_OFFSET(0x17090740)
#define RPG_GAMECORE_CHIMEPUZZLELOCKCHIME__CTOR_OFFSET UNITYSDK_OFFSET(0x17090820)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimePuzzleLockChime_TypeDefinitionIndex = 20150;
