...
#define RPG_GAMECORE_CHIMEPUZZLELOCKCHIME_METHOD_3_814E3DA60AA4489E_OFFSET UNITYSDK_OFFSET(0x1E01CA10)
#define RPG_GAMECORE_CHIMEPUZZLELOCKCHIME_METHOD_3_BC409BCFEFE2DB9B_OFFSET UNITYSDK_OFFSET(0x1E01C940)
#define RPG_GAMECORE_CHIMEPUZZLELOCKCHIME__CTOR_OFFSET UNITYSDK_OFFSET(0x1E01CA00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimePuzzleLockChime_TypeDefinitionIndex = 21730;
