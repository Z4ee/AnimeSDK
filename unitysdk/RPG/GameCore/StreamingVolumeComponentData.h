...
#define RPG_GAMECORE_STREAMINGVOLUMECOMPONENTDATA_METHOD_3_575A94908D88E6E1_OFFSET UNITYSDK_OFFSET(0x19CC5CB0)
#define RPG_GAMECORE_STREAMINGVOLUMECOMPONENTDATA_METHOD_3_DA48B595FB3914EB_OFFSET UNITYSDK_OFFSET(0x19CC5D10)
#define RPG_GAMECORE_STREAMINGVOLUMECOMPONENTDATA_METHOD_3_E0AA829D55A442AB_OFFSET UNITYSDK_OFFSET(0x19CC5F90)
#define RPG_GAMECORE_STREAMINGVOLUMECOMPONENTDATA_METHOD_3_F6C3BB9787EE5DBF_OFFSET UNITYSDK_OFFSET(0x19CC59D0)
#define RPG_GAMECORE_STREAMINGVOLUMECOMPONENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19CC4C10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StreamingVolumeComponentData_TypeDefinitionIndex = 18139;
	...
	public:
		...
		static ::System::Void Method_3_DA48B595FB3914EB(::SimpleJSON::JSONNode* a1, ::RPG::GameCore::StreamingVolumeComponentData*& a2)
		{
			return ((::System::Void(*)(::SimpleJSON::JSONNode*, ::RPG::GameCore::StreamingVolumeComponentData*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_STREAMINGVOLUMECOMPONENTDATA_METHOD_3_DA48B595FB3914EB_OFFSET))(a1, a2);
		}
