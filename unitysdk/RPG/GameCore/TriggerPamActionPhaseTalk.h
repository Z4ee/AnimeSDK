...
#define RPG_GAMECORE_TRIGGERPAMACTIONPHASETALK_METHOD_3_9375824386727BFA_OFFSET UNITYSDK_OFFSET(0x1B059A80)
#define RPG_GAMECORE_TRIGGERPAMACTIONPHASETALK_METHOD_3_EA283F0610CBCB57_OFFSET UNITYSDK_OFFSET(0x1B0599B0)
#define RPG_GAMECORE_TRIGGERPAMACTIONPHASETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B059A70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerPamActionPhaseTalk_TypeDefinitionIndex = 19254;
