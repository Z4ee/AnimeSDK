...
#define RPG_GAMECORE_TRIGGERPAMACTIONPHASETALK_METHOD_3_9375824386727BFA_OFFSET UNITYSDK_OFFSET(0x190C9D70)
#define RPG_GAMECORE_TRIGGERPAMACTIONPHASETALK_METHOD_3_E8E58EAB46C095CE_OFFSET UNITYSDK_OFFSET(0x190C9C60)
#define RPG_GAMECORE_TRIGGERPAMACTIONPHASETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x190C9D40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerPamActionPhaseTalk_TypeDefinitionIndex = 18950;
