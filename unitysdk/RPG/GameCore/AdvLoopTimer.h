...
#define RPG_GAMECORE_ADVLOOPTIMER_METHOD_3_48E8688EA3BADA31_OFFSET UNITYSDK_OFFSET(0x16F33070)
#define RPG_GAMECORE_ADVLOOPTIMER_METHOD_3_F935F46CA447721C_OFFSET UNITYSDK_OFFSET(0x16F330F0)
#define RPG_GAMECORE_ADVLOOPTIMER__CTOR_OFFSET UNITYSDK_OFFSET(0x16F330C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvLoopTimer_TypeDefinitionIndex = 19528;
