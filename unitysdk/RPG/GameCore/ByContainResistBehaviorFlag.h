...
#define RPG_GAMECORE_BYCONTAINRESISTBEHAVIORFLAG_METHOD_4_739EC0FBEE81E649_OFFSET UNITYSDK_OFFSET(0x1701DCF0)
#define RPG_GAMECORE_BYCONTAINRESISTBEHAVIORFLAG_METHOD_4_76E43ACA1CD6F195_OFFSET UNITYSDK_OFFSET(0x1701DC20)
#define RPG_GAMECORE_BYCONTAINRESISTBEHAVIORFLAG__CTOR_OFFSET UNITYSDK_OFFSET(0x1701DCA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByContainResistBehaviorFlag_TypeDefinitionIndex = 21895;
