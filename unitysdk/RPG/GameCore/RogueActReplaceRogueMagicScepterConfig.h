...
#define RPG_GAMECORE_ROGUEACTREPLACEROGUEMAGICSCEPTERCONFIG_METHOD_6_0E0883B69CB24AF1_OFFSET UNITYSDK_OFFSET(0x1EE88CD0)
#define RPG_GAMECORE_ROGUEACTREPLACEROGUEMAGICSCEPTERCONFIG_METHOD_6_AFA5CC5950D73E0D_OFFSET UNITYSDK_OFFSET(0x1EE88C80)
#define RPG_GAMECORE_ROGUEACTREPLACEROGUEMAGICSCEPTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EE88CC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActReplaceRogueMagicScepterConfig_TypeDefinitionIndex = 19468;
