...
#define RPG_GAMECORE_ROGUEACTREPLACEROGUEMAGICSCEPTERCONFIG_METHOD_6_0E0883B69CB24AF1_OFFSET UNITYSDK_OFFSET(0x18CD3B00)
#define RPG_GAMECORE_ROGUEACTREPLACEROGUEMAGICSCEPTERCONFIG_METHOD_6_1D69BDF13AABAF3C_OFFSET UNITYSDK_OFFSET(0x18CD38E0)
#define RPG_GAMECORE_ROGUEACTREPLACEROGUEMAGICSCEPTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CD3A20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActReplaceRogueMagicScepterConfig_TypeDefinitionIndex = 18698;
