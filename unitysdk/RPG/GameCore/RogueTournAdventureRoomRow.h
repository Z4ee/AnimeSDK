...
#define RPG_GAMECORE_ROGUETOURNADVENTUREROOMROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1765D600)
#define RPG_GAMECORE_ROGUETOURNADVENTUREROOMROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1765D770)
