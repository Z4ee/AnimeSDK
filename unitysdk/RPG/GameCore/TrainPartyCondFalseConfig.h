...
#define RPG_GAMECORE_TRAINPARTYCONDFALSECONFIG_METHOD_5_808C200923294942_OFFSET UNITYSDK_OFFSET(0x190A8D30)
#define RPG_GAMECORE_TRAINPARTYCONDFALSECONFIG_METHOD_5_A4766245E5C523F0_OFFSET UNITYSDK_OFFSET(0x190A8C00)
#define RPG_GAMECORE_TRAINPARTYCONDFALSECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x190A8CB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyCondFalseConfig_TypeDefinitionIndex = 17188;
