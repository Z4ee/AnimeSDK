...
#define RPG_GAMECORE_TRAINPARTYCONDFALSECONFIG_METHOD_5_59AE9D5565DE6026_OFFSET UNITYSDK_OFFSET(0x1C15F080)
#define RPG_GAMECORE_TRAINPARTYCONDFALSECONFIG_METHOD_5_808C200923294942_OFFSET UNITYSDK_OFFSET(0x1C15F0D0)
#define RPG_GAMECORE_TRAINPARTYCONDFALSECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C15F0C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyCondFalseConfig_TypeDefinitionIndex = 17358;
