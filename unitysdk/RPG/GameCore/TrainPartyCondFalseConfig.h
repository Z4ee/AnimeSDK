...
#define RPG_GAMECORE_TRAINPARTYCONDFALSECONFIG_METHOD_5_808C200923294942_OFFSET UNITYSDK_OFFSET(0x19DF38F0)
#define RPG_GAMECORE_TRAINPARTYCONDFALSECONFIG_METHOD_5_A4766245E5C523F0_OFFSET UNITYSDK_OFFSET(0x19DF37C0)
#define RPG_GAMECORE_TRAINPARTYCONDFALSECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19DF3870)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyCondFalseConfig_TypeDefinitionIndex = 17196;
