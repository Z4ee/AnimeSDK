...
#define RPG_GAMECORE_ROGUEAEONSTORYCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19B11600)
#define RPG_GAMECORE_ROGUEAEONSTORYCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19B11DA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueAeonStoryConfigRow_TypeDefinitionIndex = 14114;

	class RogueAeonStoryConfigRow : public ::System::Object
	{
	public:
		::RPG::Client::TextID AeonStory; // 0x10
		::System::UInt32 UnlockID; // 0x20
		::System::UInt32 AeonStoryID; // 0x24
		::System::UInt32 ActivityModuleID; // 0x28
		::System::UInt32 RogueAeonID; // 0x2C
