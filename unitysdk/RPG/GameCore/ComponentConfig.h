...
#define RPG_GAMECORE_COMPONENTCONFIG_METHOD_2_A8EBF78230E22F38_OFFSET UNITYSDK_OFFSET(0x17129C60)
#define RPG_GAMECORE_COMPONENTCONFIG_METHOD_2_F366EDE048C147AD_OFFSET UNITYSDK_OFFSET(0x171297E0)
#define RPG_GAMECORE_COMPONENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1711FD70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComponentConfig_TypeDefinitionIndex = 15162;
