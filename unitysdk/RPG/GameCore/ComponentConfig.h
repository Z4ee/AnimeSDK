...
#define RPG_GAMECORE_COMPONENTCONFIG_METHOD_2_A8EBF78230E22F38_OFFSET UNITYSDK_OFFSET(0x1BC29910)
#define RPG_GAMECORE_COMPONENTCONFIG_METHOD_2_BB5D9120237356F8_OFFSET UNITYSDK_OFFSET(0x1BC29590)
#define RPG_GAMECORE_COMPONENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC21AA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComponentConfig_TypeDefinitionIndex = 15908;
