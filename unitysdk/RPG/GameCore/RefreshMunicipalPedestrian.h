...
#define RPG_GAMECORE_REFRESHMUNICIPALPEDESTRIAN_METHOD_3_4AC5526CE9C51E1B_OFFSET UNITYSDK_OFFSET(0x19AB9DD0)
#define RPG_GAMECORE_REFRESHMUNICIPALPEDESTRIAN_METHOD_3_8CFE6F7C434DAD27_OFFSET UNITYSDK_OFFSET(0x19AB9CC0)
#define RPG_GAMECORE_REFRESHMUNICIPALPEDESTRIAN__CTOR_OFFSET UNITYSDK_OFFSET(0x19AB9DA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RefreshMunicipalPedestrian_TypeDefinitionIndex = 19185;
