...
#define RPG_GAMECORE_REFRESHMUNICIPALPEDESTRIAN_METHOD_3_4AC5526CE9C51E1B_OFFSET UNITYSDK_OFFSET(0x175899A0)
#define RPG_GAMECORE_REFRESHMUNICIPALPEDESTRIAN_METHOD_3_8CFE6F7C434DAD27_OFFSET UNITYSDK_OFFSET(0x17589890)
#define RPG_GAMECORE_REFRESHMUNICIPALPEDESTRIAN__CTOR_OFFSET UNITYSDK_OFFSET(0x17589970)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RefreshMunicipalPedestrian_TypeDefinitionIndex = 18611;
