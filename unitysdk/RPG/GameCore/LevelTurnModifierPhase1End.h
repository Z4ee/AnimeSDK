...
#define RPG_GAMECORE_LEVELTURNMODIFIERPHASE1END_CLEAR_OFFSET UNITYSDK_OFFSET(0xE69BE40)
#define RPG_GAMECORE_LEVELTURNMODIFIERPHASE1END_GETACTIVEENTITY_OFFSET UNITYSDK_OFFSET(0xE69BF30)
#define RPG_GAMECORE_LEVELTURNMODIFIERPHASE1END_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xE69BEE0)
#define RPG_GAMECORE_LEVELTURNMODIFIERPHASE1END_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xE69BE90)
#define RPG_GAMECORE_LEVELTURNMODIFIERPHASE1END_GETTURNCOUNTER_OFFSET UNITYSDK_OFFSET(0xE69BF70)
#define RPG_GAMECORE_LEVELTURNMODIFIERPHASE1END_INIT_OFFSET UNITYSDK_OFFSET(0xE69BDE0)
#define RPG_GAMECORE_LEVELTURNMODIFIERPHASE1END__CTOR_OFFSET UNITYSDK_OFFSET(0xE69BFB0)
