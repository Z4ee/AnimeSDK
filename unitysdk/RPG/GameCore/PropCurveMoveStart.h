...
#define RPG_GAMECORE_PROPCURVEMOVESTART_METHOD_3_42DD3519273842F4_OFFSET UNITYSDK_OFFSET(0x17517D40)
#define RPG_GAMECORE_PROPCURVEMOVESTART_METHOD_3_A1320943A61CB818_OFFSET UNITYSDK_OFFSET(0x17517BA0)
#define RPG_GAMECORE_PROPCURVEMOVESTART__CTOR_OFFSET UNITYSDK_OFFSET(0x17517BE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropCurveMoveStart_TypeDefinitionIndex = 19335;
