...
#define RPG_GAMECORE_PROPCURVEMOVESTART_METHOD_3_42DD3519273842F4_OFFSET UNITYSDK_OFFSET(0x18C67780)
#define RPG_GAMECORE_PROPCURVEMOVESTART_METHOD_3_A1320943A61CB818_OFFSET UNITYSDK_OFFSET(0x18C675E0)
#define RPG_GAMECORE_PROPCURVEMOVESTART__CTOR_OFFSET UNITYSDK_OFFSET(0x18C67620)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropCurveMoveStart_TypeDefinitionIndex = 19994;
