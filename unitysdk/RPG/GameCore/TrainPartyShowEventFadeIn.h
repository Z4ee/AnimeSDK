...
#define RPG_GAMECORE_TRAINPARTYSHOWEVENTFADEIN_METHOD_3_7B98257C7AC6FC29_OFFSET UNITYSDK_OFFSET(0x19DF8F00)
#define RPG_GAMECORE_TRAINPARTYSHOWEVENTFADEIN_METHOD_3_94F56E17D97AD626_OFFSET UNITYSDK_OFFSET(0x19DF8F80)
#define RPG_GAMECORE_TRAINPARTYSHOWEVENTFADEIN__CTOR_OFFSET UNITYSDK_OFFSET(0x19DF8F50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyShowEventFadeIn_TypeDefinitionIndex = 21143;
