...
#define RPG_GAMECORE_TRAINPARTYSHOWEVENTFADEIN_METHOD_3_7B98257C7AC6FC29_OFFSET UNITYSDK_OFFSET(0x178AF7F0)
#define RPG_GAMECORE_TRAINPARTYSHOWEVENTFADEIN_METHOD_3_94F56E17D97AD626_OFFSET UNITYSDK_OFFSET(0x178AF870)
#define RPG_GAMECORE_TRAINPARTYSHOWEVENTFADEIN__CTOR_OFFSET UNITYSDK_OFFSET(0x178AF840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyShowEventFadeIn_TypeDefinitionIndex = 20567;
