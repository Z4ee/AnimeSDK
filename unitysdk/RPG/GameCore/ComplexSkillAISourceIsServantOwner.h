...
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEISSERVANTOWNER_METHOD_3_3B7512751E2FD838_OFFSET UNITYSDK_OFFSET(0x1966D100)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEISSERVANTOWNER_METHOD_3_7A2BE4F138ACB60A_OFFSET UNITYSDK_OFFSET(0x1966F9B0)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEISSERVANTOWNER__CTOR_OFFSET UNITYSDK_OFFSET(0x1966D0E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAISourceIsServantOwner_TypeDefinitionIndex = 14778;
