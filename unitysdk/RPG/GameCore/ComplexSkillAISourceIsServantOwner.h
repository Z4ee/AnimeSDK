...
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEISSERVANTOWNER_METHOD_3_3B7512751E2FD838_OFFSET UNITYSDK_OFFSET(0x17126A80)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEISSERVANTOWNER_METHOD_3_7A2BE4F138ACB60A_OFFSET UNITYSDK_OFFSET(0x17128D60)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEISSERVANTOWNER__CTOR_OFFSET UNITYSDK_OFFSET(0x17126A60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAISourceIsServantOwner_TypeDefinitionIndex = 14243;
