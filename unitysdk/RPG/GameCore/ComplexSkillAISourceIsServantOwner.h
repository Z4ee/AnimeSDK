...
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEISSERVANTOWNER_METHOD_3_3B7512751E2FD838_OFFSET UNITYSDK_OFFSET(0x1CFF4B50)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEISSERVANTOWNER_METHOD_3_8C07C7261C383C1D_OFFSET UNITYSDK_OFFSET(0x1CFF4AB0)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEISSERVANTOWNER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFF4B40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAISourceIsServantOwner_TypeDefinitionIndex = 15374;
