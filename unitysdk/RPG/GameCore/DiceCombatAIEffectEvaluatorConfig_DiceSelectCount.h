...
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICESELECTCOUNT_METHOD_3_687441B2D7DE5F87_OFFSET UNITYSDK_OFFSET(0x18863A60)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICESELECTCOUNT_METHOD_3_68F19C21DABAB34B_OFFSET UNITYSDK_OFFSET(0x18864320)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICESELECTCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x18863A50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatAIEffectEvaluatorConfig_DiceSelectCount_TypeDefinitionIndex = 15344;
