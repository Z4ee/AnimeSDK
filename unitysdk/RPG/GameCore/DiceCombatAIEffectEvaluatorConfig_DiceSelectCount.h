...
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICESELECTCOUNT_METHOD_3_687441B2D7DE5F87_OFFSET UNITYSDK_OFFSET(0x1C10BAE0)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICESELECTCOUNT_METHOD_3_68F19C21DABAB34B_OFFSET UNITYSDK_OFFSET(0x1C10C3A0)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICESELECTCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C10BAD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatAIEffectEvaluatorConfig_DiceSelectCount_TypeDefinitionIndex = 15566;
