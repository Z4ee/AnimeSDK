...
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICESELECTCOUNT_METHOD_3_687441B2D7DE5F87_OFFSET UNITYSDK_OFFSET(0x196A2C40)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICESELECTCOUNT_METHOD_3_68F19C21DABAB34B_OFFSET UNITYSDK_OFFSET(0x196A3500)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICESELECTCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x196A2C30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatAIEffectEvaluatorConfig_DiceSelectCount_TypeDefinitionIndex = 15402;
