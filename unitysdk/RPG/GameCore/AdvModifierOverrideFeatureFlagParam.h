...
#define RPG_GAMECORE_ADVMODIFIEROVERRIDEFEATUREFLAGPARAM_METHOD_3_5DA5EB6B29C5850C_OFFSET UNITYSDK_OFFSET(0x1CDCDD90)
#define RPG_GAMECORE_ADVMODIFIEROVERRIDEFEATUREFLAGPARAM_METHOD_3_6C10F6AE276DF0C7_OFFSET UNITYSDK_OFFSET(0x1CDCDDD0)
#define RPG_GAMECORE_ADVMODIFIEROVERRIDEFEATUREFLAGPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDCDDC0)
