...
#define RPG_GAMECORE_ADVMODIFIEROVERRIDEFEATUREFLAGPARAM_METHOD_3_57E64E6349506316_OFFSET UNITYSDK_OFFSET(0x194294F0)
#define RPG_GAMECORE_ADVMODIFIEROVERRIDEFEATUREFLAGPARAM_METHOD_3_6C10F6AE276DF0C7_OFFSET UNITYSDK_OFFSET(0x19429570)
#define RPG_GAMECORE_ADVMODIFIEROVERRIDEFEATUREFLAGPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x19429540)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvModifierOverrideFeatureFlagParam_TypeDefinitionIndex = 20589;
