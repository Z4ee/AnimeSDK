...
#define RPG_GAMECORE_BYCHECKCOLONYTRACE_METHOD_4_2CE7FB463BD517C5_OFFSET UNITYSDK_OFFSET(0x19CC3880)
#define RPG_GAMECORE_BYCHECKCOLONYTRACE_METHOD_4_723FDA3A5B10AD11_OFFSET UNITYSDK_OFFSET(0x19CC36B0)
#define RPG_GAMECORE_BYCHECKCOLONYTRACE_METHOD_4_EE1AEA8AEC0275D0_OFFSET UNITYSDK_OFFSET(0x19CC3670)
#define RPG_GAMECORE_BYCHECKCOLONYTRACE_METHOD_4_F993DD1927510872_OFFSET UNITYSDK_OFFSET(0x19CC3850)
#define RPG_GAMECORE_BYCHECKCOLONYTRACE__CTOR_OFFSET UNITYSDK_OFFSET(0x19CC36A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckColonyTrace_TypeDefinitionIndex = 21062;
