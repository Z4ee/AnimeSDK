...
#define RPG_GAMECORE_BYCHECKCOLONYTRACE_METHOD_4_723FDA3A5B10AD11_OFFSET UNITYSDK_OFFSET(0x16FFD900)
#define RPG_GAMECORE_BYCHECKCOLONYTRACE_METHOD_4_78D3808F89F82113_OFFSET UNITYSDK_OFFSET(0x16FFD830)
#define RPG_GAMECORE_BYCHECKCOLONYTRACE__CTOR_OFFSET UNITYSDK_OFFSET(0x16FFD8B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckColonyTrace_TypeDefinitionIndex = 20037;
