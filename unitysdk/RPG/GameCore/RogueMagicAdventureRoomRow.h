...
#define RPG_GAMECORE_ROGUEMAGICADVENTUREROOMROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19B41F80)
#define RPG_GAMECORE_ROGUEMAGICADVENTUREROOMROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19B420F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueMagicAdventureRoomRow_TypeDefinitionIndex = 14129;
