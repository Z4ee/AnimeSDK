...
#define RPG_GAMECORE_ROGUEMAGICADVENTUREROOMROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17610830)
#define RPG_GAMECORE_ROGUEMAGICADVENTUREROOMROW__CTOR_OFFSET UNITYSDK_OFFSET(0x176109A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueMagicAdventureRoomRow_TypeDefinitionIndex = 13593;
