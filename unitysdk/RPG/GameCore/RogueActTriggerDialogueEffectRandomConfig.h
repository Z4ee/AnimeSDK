...
#define RPG_GAMECORE_ROGUEACTTRIGGERDIALOGUEEFFECTRANDOMCONFIG_METHOD_6_529C167B5D3683F4_OFFSET UNITYSDK_OFFSET(0x1D3BB420)
#define RPG_GAMECORE_ROGUEACTTRIGGERDIALOGUEEFFECTRANDOMCONFIG_METHOD_6_714879DFC8F6D478_OFFSET UNITYSDK_OFFSET(0x1D3BB3D0)
#define RPG_GAMECORE_ROGUEACTTRIGGERDIALOGUEEFFECTRANDOMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3BB410)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActTriggerDialogueEffectRandomConfig_TypeDefinitionIndex = 19404;
