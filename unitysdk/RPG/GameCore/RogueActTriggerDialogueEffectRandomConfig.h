...
#define RPG_GAMECORE_ROGUEACTTRIGGERDIALOGUEEFFECTRANDOMCONFIG_METHOD_6_529C167B5D3683F4_OFFSET UNITYSDK_OFFSET(0x18CD59A0)
#define RPG_GAMECORE_ROGUEACTTRIGGERDIALOGUEEFFECTRANDOMCONFIG_METHOD_6_D85A2A43C5EAAC59_OFFSET UNITYSDK_OFFSET(0x18CD5780)
#define RPG_GAMECORE_ROGUEACTTRIGGERDIALOGUEEFFECTRANDOMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CD58C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActTriggerDialogueEffectRandomConfig_TypeDefinitionIndex = 18634;
