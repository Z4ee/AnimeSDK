...
#define RPG_GAMECORE_SETVERSUSBAR_METHOD_3_6395EFD1FF31AAE5_OFFSET UNITYSDK_OFFSET(0x18E49D50)
#define RPG_GAMECORE_SETVERSUSBAR_METHOD_3_6B61804D4EF0B13E_OFFSET UNITYSDK_OFFSET(0x18E49CD0)
#define RPG_GAMECORE_SETVERSUSBAR__CTOR_OFFSET UNITYSDK_OFFSET(0x18E49D20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetVersusBar_TypeDefinitionIndex = 22090;
