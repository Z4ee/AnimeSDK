...
#define RPG_GAMECORE_SETVERSUSBAR_METHOD_3_6395EFD1FF31AAE5_OFFSET UNITYSDK_OFFSET(0x19C66A90)
#define RPG_GAMECORE_SETVERSUSBAR_METHOD_3_6B61804D4EF0B13E_OFFSET UNITYSDK_OFFSET(0x19C66A10)
#define RPG_GAMECORE_SETVERSUSBAR__CTOR_OFFSET UNITYSDK_OFFSET(0x19C66A60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetVersusBar_TypeDefinitionIndex = 21889;
