...
#define RPG_GAMECORE_SETVERSUSBAR_METHOD_3_2C02026EA0D06698_OFFSET UNITYSDK_OFFSET(0x1C60FA70)
#define RPG_GAMECORE_SETVERSUSBAR_METHOD_3_6395EFD1FF31AAE5_OFFSET UNITYSDK_OFFSET(0x1C60FAB0)
#define RPG_GAMECORE_SETVERSUSBAR__CTOR_OFFSET UNITYSDK_OFFSET(0x1C60FAA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetVersusBar_TypeDefinitionIndex = 22316;
