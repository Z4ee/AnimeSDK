...
#define RPG_GAMECORE_CHARACTERNAVIGATIONCOMPONENTCONFIG_METHOD_3_56B2DF77F703F129_OFFSET UNITYSDK_OFFSET(0x1CF99630)
#define RPG_GAMECORE_CHARACTERNAVIGATIONCOMPONENTCONFIG_METHOD_3_7D6E2CEB1A3DDF54_OFFSET UNITYSDK_OFFSET(0x1CF996D0)
#define RPG_GAMECORE_CHARACTERNAVIGATIONCOMPONENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF996C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterNavigationComponentConfig_TypeDefinitionIndex = 16390;
