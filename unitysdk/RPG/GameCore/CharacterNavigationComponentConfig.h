...
#define RPG_GAMECORE_CHARACTERNAVIGATIONCOMPONENTCONFIG_METHOD_3_56B2DF77F703F129_OFFSET UNITYSDK_OFFSET(0x187D4640)
#define RPG_GAMECORE_CHARACTERNAVIGATIONCOMPONENTCONFIG_METHOD_3_7D6E2CEB1A3DDF54_OFFSET UNITYSDK_OFFSET(0x187D46E0)
#define RPG_GAMECORE_CHARACTERNAVIGATIONCOMPONENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x187D46D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterNavigationComponentConfig_TypeDefinitionIndex = 15682;
