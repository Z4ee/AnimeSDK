...
#define RPG_GAMECORE_BYCOMPAREFOURROTATEVOXELCURRENTDIRECTION_METHOD_4_117D088C3ED4A5D8_OFFSET UNITYSDK_OFFSET(0x1C31DC90)
#define RPG_GAMECORE_BYCOMPAREFOURROTATEVOXELCURRENTDIRECTION_METHOD_4_2D3203A128553FFE_OFFSET UNITYSDK_OFFSET(0x1C31DA90)
#define RPG_GAMECORE_BYCOMPAREFOURROTATEVOXELCURRENTDIRECTION_METHOD_4_9B59605BE99DCEDF_OFFSET UNITYSDK_OFFSET(0x1C31DC60)
#define RPG_GAMECORE_BYCOMPAREFOURROTATEVOXELCURRENTDIRECTION_METHOD_4_E4DEFE1BC437F213_OFFSET UNITYSDK_OFFSET(0x1C31DAD0)
#define RPG_GAMECORE_BYCOMPAREFOURROTATEVOXELCURRENTDIRECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C31DAC0)
