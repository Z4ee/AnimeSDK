...
#define RPG_GAMECORE_BYCOMPAREFOURROTATEVOXELCURRENTDIRECTION_METHOD_4_117D088C3ED4A5D8_OFFSET UNITYSDK_OFFSET(0x1CEC6FB0)
#define RPG_GAMECORE_BYCOMPAREFOURROTATEVOXELCURRENTDIRECTION_METHOD_4_2D3203A128553FFE_OFFSET UNITYSDK_OFFSET(0x1CEC6DB0)
#define RPG_GAMECORE_BYCOMPAREFOURROTATEVOXELCURRENTDIRECTION_METHOD_4_9B59605BE99DCEDF_OFFSET UNITYSDK_OFFSET(0x1CEC6F80)
#define RPG_GAMECORE_BYCOMPAREFOURROTATEVOXELCURRENTDIRECTION_METHOD_4_E4DEFE1BC437F213_OFFSET UNITYSDK_OFFSET(0x1CEC6DF0)
#define RPG_GAMECORE_BYCOMPAREFOURROTATEVOXELCURRENTDIRECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEC6DE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareFourRotateVoxelCurrentDirection_TypeDefinitionIndex = 20755;
