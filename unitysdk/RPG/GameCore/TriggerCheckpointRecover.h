...
#define RPG_GAMECORE_TRIGGERCHECKPOINTRECOVER_METHOD_3_81A2C82E3FF7A4FD_OFFSET UNITYSDK_OFFSET(0x190BEDF0)
#define RPG_GAMECORE_TRIGGERCHECKPOINTRECOVER_METHOD_3_E19C345F5CA8B28C_OFFSET UNITYSDK_OFFSET(0x190BED70)
#define RPG_GAMECORE_TRIGGERCHECKPOINTRECOVER__CTOR_OFFSET UNITYSDK_OFFSET(0x190BEDC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerCheckpointRecover_TypeDefinitionIndex = 19410;
