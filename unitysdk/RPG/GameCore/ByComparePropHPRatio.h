...
#define RPG_GAMECORE_BYCOMPAREPROPHPRATIO_METHOD_4_30F64CF352EC7EAE_OFFSET UNITYSDK_OFFSET(0x18737210)
#define RPG_GAMECORE_BYCOMPAREPROPHPRATIO_METHOD_4_84B91C6D481453EC_OFFSET UNITYSDK_OFFSET(0x187372F0)
#define RPG_GAMECORE_BYCOMPAREPROPHPRATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x18737290)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByComparePropHPRatio_TypeDefinitionIndex = 21137;
