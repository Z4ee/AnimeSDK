...
#define RPG_GAMECORE_CHANGEMONSTERNAME_METHOD_3_8C5473857B8F2605_OFFSET UNITYSDK_OFFSET(0x17063BA0)
#define RPG_GAMECORE_CHANGEMONSTERNAME_METHOD_3_B907466E7B556416_OFFSET UNITYSDK_OFFSET(0x17063B20)
#define RPG_GAMECORE_CHANGEMONSTERNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x17063B70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChangeMonsterName_TypeDefinitionIndex = 21923;
