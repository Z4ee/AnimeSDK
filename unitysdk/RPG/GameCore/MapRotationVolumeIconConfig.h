...
#define RPG_GAMECORE_MAPROTATIONVOLUMEICONCONFIG_METHOD_2_A7F01AF279A1FAF9_OFFSET UNITYSDK_OFFSET(0x173811C0)
#define RPG_GAMECORE_MAPROTATIONVOLUMEICONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17381320)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MapRotationVolumeIconConfig_TypeDefinitionIndex = 15600;
