...
#define RPG_GAMECORE_MAPROTATIONVOLUMEICONCONFIG_METHOD_2_A7F01AF279A1FAF9_OFFSET UNITYSDK_OFFSET(0x198C2690)
#define RPG_GAMECORE_MAPROTATIONVOLUMEICONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x198C27F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MapRotationVolumeIconConfig_TypeDefinitionIndex = 16169;
