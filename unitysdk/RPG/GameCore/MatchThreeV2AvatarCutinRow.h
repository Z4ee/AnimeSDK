...
#define RPG_GAMECORE_MATCHTHREEV2AVATARCUTINROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x198F52D0)
#define RPG_GAMECORE_MATCHTHREEV2AVATARCUTINROW__CTOR_OFFSET UNITYSDK_OFFSET(0x198F54D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MatchThreeV2AvatarCutinRow_TypeDefinitionIndex = 11442;
	...
	public:
		...
		::System::UInt32 CutinID; // 0x28
		::System::UInt32 MaxTriggerNum; // 0x2C
