...
#define RPG_GAMECORE_ADVCHARACTERFINDCHEST_METHOD_3_CA2B871BC6C32E74_OFFSET UNITYSDK_OFFSET(0x1941E210)
#define RPG_GAMECORE_ADVCHARACTERFINDCHEST_METHOD_3_F02143645F5B9BF5_OFFSET UNITYSDK_OFFSET(0x1941E190)
#define RPG_GAMECORE_ADVCHARACTERFINDCHEST__CTOR_OFFSET UNITYSDK_OFFSET(0x1941E1E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvCharacterFindChest_TypeDefinitionIndex = 19103;
