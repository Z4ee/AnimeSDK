...
#define RPG_GAMECORE_LEVELGROUPATMOSPHERELOADCONDITIONSET_METHOD_2_927BC1B2EA9D9352_OFFSET UNITYSDK_OFFSET(0x1D1D3670)
#define RPG_GAMECORE_LEVELGROUPATMOSPHERELOADCONDITIONSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1D37A0)
