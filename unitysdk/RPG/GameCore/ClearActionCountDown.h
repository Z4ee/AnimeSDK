...
#define RPG_GAMECORE_CLEARACTIONCOUNTDOWN_METHOD_3_24B80B2593869A41_OFFSET UNITYSDK_OFFSET(0x1C253210)
#define RPG_GAMECORE_CLEARACTIONCOUNTDOWN_METHOD_3_43A41CFDECBE72C4_OFFSET UNITYSDK_OFFSET(0x1C253140)
#define RPG_GAMECORE_CLEARACTIONCOUNTDOWN__CTOR_OFFSET UNITYSDK_OFFSET(0x1C253200)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClearActionCountDown_TypeDefinitionIndex = 22421;
