...
#define RPG_GAMECORE_CLEARACTIONCOUNTDOWN_METHOD_3_24B80B2593869A41_OFFSET UNITYSDK_OFFSET(0x18810BD0)
#define RPG_GAMECORE_CLEARACTIONCOUNTDOWN_METHOD_3_ED4FD0769637654D_OFFSET UNITYSDK_OFFSET(0x18810AC0)
#define RPG_GAMECORE_CLEARACTIONCOUNTDOWN__CTOR_OFFSET UNITYSDK_OFFSET(0x18810BA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClearActionCountDown_TypeDefinitionIndex = 22221;
