...
#define RPG_GAMECORE_TARGETFETCHPROJECTILEHITENTITY_METHOD_4_3044E2B5E20AD379_OFFSET UNITYSDK_OFFSET(0x177BFEB0)
#define RPG_GAMECORE_TARGETFETCHPROJECTILEHITENTITY_METHOD_4_65D53F1DC92F7257_OFFSET UNITYSDK_OFFSET(0x177B7C30)
#define RPG_GAMECORE_TARGETFETCHPROJECTILEHITENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x177B7BE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchProjectileHitEntity_TypeDefinitionIndex = 22198;
