...
#define RPG_GAMECORE_TARGETFETCHPROJECTILEHITENTITY_METHOD_4_65D53F1DC92F7257_OFFSET UNITYSDK_OFFSET(0x1D0BC500)
#define RPG_GAMECORE_TARGETFETCHPROJECTILEHITENTITY_METHOD_4_B3837C580F65A4BA_OFFSET UNITYSDK_OFFSET(0x1D0BC560)
#define RPG_GAMECORE_TARGETFETCHPROJECTILEHITENTITY_METHOD_4_D1793B12E5076D87_OFFSET UNITYSDK_OFFSET(0x1D0BC580)
#define RPG_GAMECORE_TARGETFETCHPROJECTILEHITENTITY_METHOD_4_FFCB74CF16B5C8E6_OFFSET UNITYSDK_OFFSET(0x1D0BC480)
#define RPG_GAMECORE_TARGETFETCHPROJECTILEHITENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0BC4F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchProjectileHitEntity_TypeDefinitionIndex = 23066;
