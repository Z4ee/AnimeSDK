...
#define RPG_GAMECORE_ADVPLAYERCANCELRIDE_METHOD_3_872F4BC88B503F6B_OFFSET UNITYSDK_OFFSET(0x1865D4F0)
#define RPG_GAMECORE_ADVPLAYERCANCELRIDE_METHOD_3_F011DA45BECA2B42_OFFSET UNITYSDK_OFFSET(0x1865D570)
#define RPG_GAMECORE_ADVPLAYERCANCELRIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x1865D540)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvPlayerCancelRide_TypeDefinitionIndex = 20021;
