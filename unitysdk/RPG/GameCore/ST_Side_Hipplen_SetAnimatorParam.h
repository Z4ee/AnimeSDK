...
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_SETANIMATORPARAM_METHOD_4_70E6DE2C282E3FAE_OFFSET UNITYSDK_OFFSET(0x1768C440)
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_SETANIMATORPARAM_METHOD_4_C40C41AE521055A5_OFFSET UNITYSDK_OFFSET(0x176990F0)
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_SETANIMATORPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1768C3F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_Hipplen_SetAnimatorParam_TypeDefinitionIndex = 19614;
