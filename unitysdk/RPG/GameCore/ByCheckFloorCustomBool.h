...
#define RPG_GAMECORE_BYCHECKFLOORCUSTOMBOOL_METHOD_4_0556A85D31899424_OFFSET UNITYSDK_OFFSET(0x19CC5590)
#define RPG_GAMECORE_BYCHECKFLOORCUSTOMBOOL_METHOD_4_204C874DF3D0210B_OFFSET UNITYSDK_OFFSET(0x19CC55C0)
#define RPG_GAMECORE_BYCHECKFLOORCUSTOMBOOL_METHOD_4_D0C988ECCBC93A24_OFFSET UNITYSDK_OFFSET(0x19CC5430)
#define RPG_GAMECORE_BYCHECKFLOORCUSTOMBOOL_METHOD_4_FD262333B1D5B9A1_OFFSET UNITYSDK_OFFSET(0x19CC53F0)
#define RPG_GAMECORE_BYCHECKFLOORCUSTOMBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x19CC5420)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckFloorCustomBool_TypeDefinitionIndex = 19910;
