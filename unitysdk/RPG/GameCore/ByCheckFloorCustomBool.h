...
#define RPG_GAMECORE_BYCHECKFLOORCUSTOMBOOL_METHOD_4_6C3D82DF10182EDA_OFFSET UNITYSDK_OFFSET(0x18722670)
#define RPG_GAMECORE_BYCHECKFLOORCUSTOMBOOL_METHOD_4_D0C988ECCBC93A24_OFFSET UNITYSDK_OFFSET(0x18722740)
#define RPG_GAMECORE_BYCHECKFLOORCUSTOMBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x187226F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckFloorCustomBool_TypeDefinitionIndex = 19671;
