...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERBATTLEFAILKEEPWINCONFIG_METHOD_3_9F4562E00FBE4E5F_OFFSET UNITYSDK_OFFSET(0x1C5D06E0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERBATTLEFAILKEEPWINCONFIG_METHOD_3_C4870D07F02B2E63_OFFSET UNITYSDK_OFFSET(0x1C5D0730)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERBATTLEFAILKEEPWINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5D0720)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierBattleFailKeepWinConfig_TypeDefinitionIndex = 18617;
