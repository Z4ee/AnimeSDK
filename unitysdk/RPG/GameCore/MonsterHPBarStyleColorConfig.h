...
#define RPG_GAMECORE_MONSTERHPBARSTYLECOLORCONFIG_METHOD_2_AEB7E74DC29C09C5_OFFSET UNITYSDK_OFFSET(0x1CE6D6E0)
#define RPG_GAMECORE_MONSTERHPBARSTYLECOLORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE6D7F0)
