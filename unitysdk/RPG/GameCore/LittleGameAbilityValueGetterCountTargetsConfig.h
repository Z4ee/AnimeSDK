...
#define RPG_GAMECORE_LITTLEGAMEABILITYVALUEGETTERCOUNTTARGETSCONFIG_METHOD_3_98B281E9EC557F74_OFFSET UNITYSDK_OFFSET(0x1D1FE7C0)
#define RPG_GAMECORE_LITTLEGAMEABILITYVALUEGETTERCOUNTTARGETSCONFIG_METHOD_3_BFE48BBDE1F27288_OFFSET UNITYSDK_OFFSET(0x1D1FE6F0)
#define RPG_GAMECORE_LITTLEGAMEABILITYVALUEGETTERCOUNTTARGETSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1FE7B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityValueGetterCountTargetsConfig_TypeDefinitionIndex = 21141;
