...
#define RPG_GAMECORE_USESKILLONEMORE_METHOD_3_69A4535FC7903EE0_OFFSET UNITYSDK_OFFSET(0x178E8A30)
#define RPG_GAMECORE_USESKILLONEMORE_METHOD_3_BCAC65686D1DC595_OFFSET UNITYSDK_OFFSET(0x178E8990)
#define RPG_GAMECORE_USESKILLONEMORE__CTOR_OFFSET UNITYSDK_OFFSET(0x178E89F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UseSkillOneMore_TypeDefinitionIndex = 20791;
