...
#define RPG_GAMECORE_LEVELPEDESTRIANV2EMITINFO_METHOD_2_36BEE6176B87B11F_OFFSET UNITYSDK_OFFSET(0x1B082060)
#define RPG_GAMECORE_LEVELPEDESTRIANV2EMITINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B082210)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPedestrianV2EmitInfo_TypeDefinitionIndex = 16625;
