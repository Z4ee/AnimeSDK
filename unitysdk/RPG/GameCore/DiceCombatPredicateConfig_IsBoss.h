...
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_ISBOSS_METHOD_4_341A0B8F3E6EA339_OFFSET UNITYSDK_OFFSET(0x1C1167F0)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_ISBOSS_METHOD_4_6E58652D7E2AD280_OFFSET UNITYSDK_OFFSET(0x1C115220)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_ISBOSS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C115210)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatPredicateConfig_IsBoss_TypeDefinitionIndex = 15498;
