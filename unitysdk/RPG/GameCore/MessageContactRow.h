...
#define RPG_GAMECORE_MESSAGECONTACTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D269570)
#define RPG_GAMECORE_MESSAGECONTACTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D269CA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MessageContactRow_TypeDefinitionIndex = 14292;
	...
	public:
		...
		::RPG::Client::TextID SignatureText; // 0x20
