...
#define RPG_GAMECORE_MESSAGECONTACTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D286EA0)
#define RPG_GAMECORE_MESSAGECONTACTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2875D0)
