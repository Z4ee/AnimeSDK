...
#define RPG_GAMECORE_INITCOLONYORIGAMIENTITY_METHOD_3_D5E18B41FF6177C8_OFFSET UNITYSDK_OFFSET(0x1984FCD0)
#define RPG_GAMECORE_INITCOLONYORIGAMIENTITY_METHOD_3_DBCEC77AE4A298D8_OFFSET UNITYSDK_OFFSET(0x1984FC50)
#define RPG_GAMECORE_INITCOLONYORIGAMIENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1984FCA0)
