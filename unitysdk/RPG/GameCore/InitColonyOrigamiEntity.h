...
#define RPG_GAMECORE_INITCOLONYORIGAMIENTITY_METHOD_3_D5E18B41FF6177C8_OFFSET UNITYSDK_OFFSET(0x18A1DD80)
#define RPG_GAMECORE_INITCOLONYORIGAMIENTITY_METHOD_3_DBCEC77AE4A298D8_OFFSET UNITYSDK_OFFSET(0x18A1DD00)
#define RPG_GAMECORE_INITCOLONYORIGAMIENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x18A1DD50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int InitColonyOrigamiEntity_TypeDefinitionIndex = 20146;
