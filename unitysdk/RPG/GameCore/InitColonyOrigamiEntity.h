...
#define RPG_GAMECORE_INITCOLONYORIGAMIENTITY_METHOD_3_1760E1C962D0A8BB_OFFSET UNITYSDK_OFFSET(0x1B00FE60)
#define RPG_GAMECORE_INITCOLONYORIGAMIENTITY_METHOD_3_D5E18B41FF6177C8_OFFSET UNITYSDK_OFFSET(0x1B00FEA0)
#define RPG_GAMECORE_INITCOLONYORIGAMIENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B00FE90)
