...
#define RPG_GAMECORE_BYCHECKMODIFIERCALLBACKISSELF_METHOD_4_64219F948BEBB8D4_OFFSET UNITYSDK_OFFSET(0x19CC85E0)
#define RPG_GAMECORE_BYCHECKMODIFIERCALLBACKISSELF_METHOD_4_B7A2F4A815F6E10A_OFFSET UNITYSDK_OFFSET(0x19CC8720)
#define RPG_GAMECORE_BYCHECKMODIFIERCALLBACKISSELF_METHOD_4_CAD4F7ABC139D72F_OFFSET UNITYSDK_OFFSET(0x19CC85A0)
#define RPG_GAMECORE_BYCHECKMODIFIERCALLBACKISSELF_METHOD_4_EE54DF165FAF405F_OFFSET UNITYSDK_OFFSET(0x19CC8750)
#define RPG_GAMECORE_BYCHECKMODIFIERCALLBACKISSELF__CTOR_OFFSET UNITYSDK_OFFSET(0x19CC85D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckModifierCallBackIsSelf_TypeDefinitionIndex = 22215;
