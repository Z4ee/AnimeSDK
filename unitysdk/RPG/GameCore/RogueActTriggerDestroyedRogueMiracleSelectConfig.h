...
#define RPG_GAMECORE_ROGUEACTTRIGGERDESTROYEDROGUEMIRACLESELECTCONFIG_METHOD_6_6393A2DEFE04925B_OFFSET UNITYSDK_OFFSET(0x19AF9440)
#define RPG_GAMECORE_ROGUEACTTRIGGERDESTROYEDROGUEMIRACLESELECTCONFIG_METHOD_6_B19DAFF866D4B8DE_OFFSET UNITYSDK_OFFSET(0x19AF9660)
#define RPG_GAMECORE_ROGUEACTTRIGGERDESTROYEDROGUEMIRACLESELECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AF9580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActTriggerDestroyedRogueMiracleSelectConfig_TypeDefinitionIndex = 18569;
