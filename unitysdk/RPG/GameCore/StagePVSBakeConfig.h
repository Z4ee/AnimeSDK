...
#define RPG_GAMECORE_STAGEPVSBAKECONFIG_METHOD_2_8D1AFC2E1FD56D26_OFFSET UNITYSDK_OFFSET(0x1D55A500)
#define RPG_GAMECORE_STAGEPVSBAKECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D55A540)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StagePVSBakeConfig_TypeDefinitionIndex = 18950;
