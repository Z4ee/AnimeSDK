...
#define RPG_GAMECORE_STAGEPVSBAKECONFIG_METHOD_2_8D1AFC2E1FD56D26_OFFSET UNITYSDK_OFFSET(0x1B0B1E00)
#define RPG_GAMECORE_STAGEPVSBAKECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0B1E40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StagePVSBakeConfig_TypeDefinitionIndex = 18426;
