...
#define RPG_GAMECORE_BYPAMNORMALACTION_METHOD_4_00DAE05840A18CBD_OFFSET UNITYSDK_OFFSET(0x1875C690)
#define RPG_GAMECORE_BYPAMNORMALACTION_METHOD_4_88EE3127DB4C2DD7_OFFSET UNITYSDK_OFFSET(0x1875C760)
#define RPG_GAMECORE_BYPAMNORMALACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1875C710)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByPamNormalAction_TypeDefinitionIndex = 18934;
