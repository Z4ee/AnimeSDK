...
#define RPG_GAMECORE_BYPAMNORMALACTION_METHOD_4_036C482F2E3164D4_OFFSET UNITYSDK_OFFSET(0x1B2B1840)
#define RPG_GAMECORE_BYPAMNORMALACTION_METHOD_4_6D46E65C070E5D1C_OFFSET UNITYSDK_OFFSET(0x1B2B1690)
#define RPG_GAMECORE_BYPAMNORMALACTION_METHOD_4_88EE3127DB4C2DD7_OFFSET UNITYSDK_OFFSET(0x1B2B16D0)
#define RPG_GAMECORE_BYPAMNORMALACTION_METHOD_4_9AB8D3DF173E98BD_OFFSET UNITYSDK_OFFSET(0x1B2B1810)
#define RPG_GAMECORE_BYPAMNORMALACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2B16C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByPamNormalAction_TypeDefinitionIndex = 19238;
