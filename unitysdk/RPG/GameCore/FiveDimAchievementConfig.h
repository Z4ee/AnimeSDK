...
#define RPG_GAMECORE_FIVEDIMACHIEVEMENTCONFIG_METHOD_2_8737E4B41739B309_OFFSET UNITYSDK_OFFSET(0x188E9440)
#define RPG_GAMECORE_FIVEDIMACHIEVEMENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x188E96A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimAchievementConfig_TypeDefinitionIndex = 15788;
