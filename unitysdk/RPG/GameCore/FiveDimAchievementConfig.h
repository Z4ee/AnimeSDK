...
#define RPG_GAMECORE_FIVEDIMACHIEVEMENTCONFIG_METHOD_2_18B0F1905E18CC4F_OFFSET UNITYSDK_OFFSET(0x1D09F2E0)
#define RPG_GAMECORE_FIVEDIMACHIEVEMENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D09F690)
