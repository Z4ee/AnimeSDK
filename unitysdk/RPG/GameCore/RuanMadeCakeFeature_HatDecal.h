...
#define RPG_GAMECORE_RUANMADECAKEFEATURE_HATDECAL_METHOD_3_50F2A57A1B0A8730_OFFSET UNITYSDK_OFFSET(0x19BF9B60)
#define RPG_GAMECORE_RUANMADECAKEFEATURE_HATDECAL_METHOD_3_8571EDEAFC071DD9_OFFSET UNITYSDK_OFFSET(0x19BF95B0)
#define RPG_GAMECORE_RUANMADECAKEFEATURE_HATDECAL__CTOR_OFFSET UNITYSDK_OFFSET(0x19BF95A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RuanMadeCakeFeature_HatDecal_TypeDefinitionIndex = 16606;
