...
#define RPG_GAMECORE_RUANMADECAKEFEATURE_HATDECAL_METHOD_3_50F2A57A1B0A8730_OFFSET UNITYSDK_OFFSET(0x1B772DA0)
#define RPG_GAMECORE_RUANMADECAKEFEATURE_HATDECAL_METHOD_3_8571EDEAFC071DD9_OFFSET UNITYSDK_OFFSET(0x1B7727F0)
#define RPG_GAMECORE_RUANMADECAKEFEATURE_HATDECAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7727E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RuanMadeCakeFeature_HatDecal_TypeDefinitionIndex = 16768;
