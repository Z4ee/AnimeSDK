...
#define RPG_GAMECORE_RUANMADECAKEFEATURE_HATDECAL_METHOD_3_50F2A57A1B0A8730_OFFSET UNITYSDK_OFFSET(0x1D4B9B80)
#define RPG_GAMECORE_RUANMADECAKEFEATURE_HATDECAL_METHOD_3_8571EDEAFC071DD9_OFFSET UNITYSDK_OFFSET(0x1D4B9BC0)
#define RPG_GAMECORE_RUANMADECAKEFEATURE_HATDECAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4B9BB0)
