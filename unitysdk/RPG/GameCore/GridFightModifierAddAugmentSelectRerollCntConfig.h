...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDAUGMENTSELECTREROLLCNTCONFIG_METHOD_3_5D0F2C832F57197B_OFFSET UNITYSDK_OFFSET(0x1D157B90)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDAUGMENTSELECTREROLLCNTCONFIG_METHOD_3_A62124B78431AE97_OFFSET UNITYSDK_OFFSET(0x1D157B40)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDAUGMENTSELECTREROLLCNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D157B80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierAddAugmentSelectRerollCntConfig_TypeDefinitionIndex = 19240;
