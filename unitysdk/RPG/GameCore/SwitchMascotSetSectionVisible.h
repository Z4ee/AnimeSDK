...
#define RPG_GAMECORE_SWITCHMASCOTSETSECTIONVISIBLE_METHOD_3_BE1BC483F7001954_OFFSET UNITYSDK_OFFSET(0x1D58DB20)
#define RPG_GAMECORE_SWITCHMASCOTSETSECTIONVISIBLE_METHOD_3_FBA6760E950B2CDD_OFFSET UNITYSDK_OFFSET(0x1D58DAD0)
#define RPG_GAMECORE_SWITCHMASCOTSETSECTIONVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D58DB10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchMascotSetSectionVisible_TypeDefinitionIndex = 21752;
