...
#define RPG_GAMECORE_SWITCHMASCOTSETSECTIONVISIBLE_METHOD_3_02CEAD5B11EE4363_OFFSET UNITYSDK_OFFSET(0x177975D0)
#define RPG_GAMECORE_SWITCHMASCOTSETSECTIONVISIBLE_METHOD_3_BE1BC483F7001954_OFFSET UNITYSDK_OFFSET(0x17797650)
#define RPG_GAMECORE_SWITCHMASCOTSETSECTIONVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x17797620)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchMascotSetSectionVisible_TypeDefinitionIndex = 20176;
