...
#define RPG_GAMECORE_REVERSEPROPSTATE_METHOD_3_273F385D726C72D7_OFFSET UNITYSDK_OFFSET(0x175AD980)
#define RPG_GAMECORE_REVERSEPROPSTATE_METHOD_3_98362A4695B35DE7_OFFSET UNITYSDK_OFFSET(0x175AD8F0)
#define RPG_GAMECORE_REVERSEPROPSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x175AD950)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ReversePropState_TypeDefinitionIndex = 20309;
