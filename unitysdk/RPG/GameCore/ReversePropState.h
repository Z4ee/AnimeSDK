...
#define RPG_GAMECORE_REVERSEPROPSTATE_METHOD_3_273F385D726C72D7_OFFSET UNITYSDK_OFFSET(0x1D029EC0)
#define RPG_GAMECORE_REVERSEPROPSTATE_METHOD_3_E3BDADFAA8BFBA93_OFFSET UNITYSDK_OFFSET(0x1D029E70)
#define RPG_GAMECORE_REVERSEPROPSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D029EB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ReversePropState_TypeDefinitionIndex = 21318;
