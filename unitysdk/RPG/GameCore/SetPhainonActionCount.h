...
#define RPG_GAMECORE_SETPHAINONACTIONCOUNT_METHOD_3_232AD636EECBE509_OFFSET UNITYSDK_OFFSET(0x176DAE80)
#define RPG_GAMECORE_SETPHAINONACTIONCOUNT_METHOD_3_A1014443D5BDA5E7_OFFSET UNITYSDK_OFFSET(0x176DAF00)
#define RPG_GAMECORE_SETPHAINONACTIONCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x176DAED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetPhainonActionCount_TypeDefinitionIndex = 21393;
