...
#define RPG_GAMECORE_SETALLROGUEPROPSTATE_METHOD_3_DDCA240129EAA9B4_OFFSET UNITYSDK_OFFSET(0x176A6190)
#define RPG_GAMECORE_SETALLROGUEPROPSTATE_METHOD_3_F18EAAEC85933D74_OFFSET UNITYSDK_OFFSET(0x176A6220)
#define RPG_GAMECORE_SETALLROGUEPROPSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x176A61F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetAllRoguePropState_TypeDefinitionIndex = 18780;
