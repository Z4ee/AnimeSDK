...
#define RPG_GAMECORE_ROGUEMODIFIEREXECACTIONONARBITRARYROOMCARDCHANGECONFIG_METHOD_3_0B274F3D8B447345_OFFSET UNITYSDK_OFFSET(0x1CFBF900)
#define RPG_GAMECORE_ROGUEMODIFIEREXECACTIONONARBITRARYROOMCARDCHANGECONFIG_METHOD_3_49E240432235BBC9_OFFSET UNITYSDK_OFFSET(0x1CFBF950)
#define RPG_GAMECORE_ROGUEMODIFIEREXECACTIONONARBITRARYROOMCARDCHANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFBF940)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecActionOnArbitraryRoomCardChangeConfig_TypeDefinitionIndex = 17141;
