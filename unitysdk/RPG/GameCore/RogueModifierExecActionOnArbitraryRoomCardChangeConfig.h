...
#define RPG_GAMECORE_ROGUEMODIFIEREXECACTIONONARBITRARYROOMCARDCHANGECONFIG_METHOD_3_49E240432235BBC9_OFFSET UNITYSDK_OFFSET(0x18D342C0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECACTIONONARBITRARYROOMCARDCHANGECONFIG_METHOD_3_76B4D742922242F0_OFFSET UNITYSDK_OFFSET(0x18D3C3F0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECACTIONONARBITRARYROOMCARDCHANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D34270)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecActionOnArbitraryRoomCardChangeConfig_TypeDefinitionIndex = 16964;
