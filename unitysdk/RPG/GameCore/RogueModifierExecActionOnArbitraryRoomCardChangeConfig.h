...
#define RPG_GAMECORE_ROGUEMODIFIEREXECACTIONONARBITRARYROOMCARDCHANGECONFIG_METHOD_3_49E240432235BBC9_OFFSET UNITYSDK_OFFSET(0x19B50040)
#define RPG_GAMECORE_ROGUEMODIFIEREXECACTIONONARBITRARYROOMCARDCHANGECONFIG_METHOD_3_76B4D742922242F0_OFFSET UNITYSDK_OFFSET(0x19B5BFA0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECACTIONONARBITRARYROOMCARDCHANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B4FFF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecActionOnArbitraryRoomCardChangeConfig_TypeDefinitionIndex = 16979;
