...
#define RPG_GAMECORE_ROGUENOUSDICESLOTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1763F470)
#define RPG_GAMECORE_ROGUENOUSDICESLOTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1763F720)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueNousDiceSlotRow_TypeDefinitionIndex = 13638;
