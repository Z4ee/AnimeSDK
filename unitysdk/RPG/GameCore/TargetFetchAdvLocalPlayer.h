...
#define RPG_GAMECORE_TARGETFETCHADVLOCALPLAYER_METHOD_4_5452A5AA1A24CE2E_OFFSET UNITYSDK_OFFSET(0x1D0B2A30)
#define RPG_GAMECORE_TARGETFETCHADVLOCALPLAYER_METHOD_4_94EE3D875163987A_OFFSET UNITYSDK_OFFSET(0x1D0B2880)
#define RPG_GAMECORE_TARGETFETCHADVLOCALPLAYER_METHOD_4_B682CCB2ACDD8A3B_OFFSET UNITYSDK_OFFSET(0x1D0B2A00)
#define RPG_GAMECORE_TARGETFETCHADVLOCALPLAYER_METHOD_4_DCE672916A3BF661_OFFSET UNITYSDK_OFFSET(0x1D0B28C0)
#define RPG_GAMECORE_TARGETFETCHADVLOCALPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0B28B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchAdvLocalPlayer_TypeDefinitionIndex = 23009;
