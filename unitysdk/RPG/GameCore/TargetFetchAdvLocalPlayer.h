...
#define RPG_GAMECORE_TARGETFETCHADVLOCALPLAYER_METHOD_4_DCE672916A3BF661_OFFSET UNITYSDK_OFFSET(0x177BAD90)
#define RPG_GAMECORE_TARGETFETCHADVLOCALPLAYER_METHOD_4_E36A00312068E38B_OFFSET UNITYSDK_OFFSET(0x177BACC0)
#define RPG_GAMECORE_TARGETFETCHADVLOCALPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x177BAD40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchAdvLocalPlayer_TypeDefinitionIndex = 22128;
