...
#define RPG_GAMECORE_ROGUEAEONLEVELCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19B10350)
#define RPG_GAMECORE_ROGUEAEONLEVELCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19B10BE0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 AeonStoryID; // 0x30
		::RPG::Client::TextID AeonStory; // 0x38
		::System::UInt32 KeyPointRewardItemID; // 0x48
		::System::UInt32 RogueAeonID; // 0x4C
