...
#define RPG_GAMECORE_WAITMUSICRHYTHMSONGCHANGEEVENT_METHOD_3_2B8DB3D4A5597976_OFFSET UNITYSDK_OFFSET(0x1D1B75B0)
#define RPG_GAMECORE_WAITMUSICRHYTHMSONGCHANGEEVENT_METHOD_3_9116A0895C54B235_OFFSET UNITYSDK_OFFSET(0x1D1B75F0)
#define RPG_GAMECORE_WAITMUSICRHYTHMSONGCHANGEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1B75E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitMusicRhythmSongChangeEvent_TypeDefinitionIndex = 21250;
