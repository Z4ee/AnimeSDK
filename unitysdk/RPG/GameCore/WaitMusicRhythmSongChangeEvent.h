...
#define RPG_GAMECORE_WAITMUSICRHYTHMSONGCHANGEEVENT_METHOD_3_2B8DB3D4A5597976_OFFSET UNITYSDK_OFFSET(0x1D6A75E0)
#define RPG_GAMECORE_WAITMUSICRHYTHMSONGCHANGEEVENT_METHOD_3_9116A0895C54B235_OFFSET UNITYSDK_OFFSET(0x1D6A7620)
#define RPG_GAMECORE_WAITMUSICRHYTHMSONGCHANGEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6A7610)
