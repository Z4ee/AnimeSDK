...
#define RPG_GAMECORE_WAITMUSICRHYTHMSONGCHANGEEVENT_METHOD_3_9116A0895C54B235_OFFSET UNITYSDK_OFFSET(0x19102A20)
#define RPG_GAMECORE_WAITMUSICRHYTHMSONGCHANGEEVENT_METHOD_3_AAD79541107427C4_OFFSET UNITYSDK_OFFSET(0x191029A0)
#define RPG_GAMECORE_WAITMUSICRHYTHMSONGCHANGEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x191029F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitMusicRhythmSongChangeEvent_TypeDefinitionIndex = 20922;
