...
#define RPG_GAMECORE_REMOVEADVENTUREMODIFIER_METHOD_3_5A4F78BA9F055BFF_OFFSET UNITYSDK_OFFSET(0x175963E0)
#define RPG_GAMECORE_REMOVEADVENTUREMODIFIER_METHOD_3_CCDE182400285E8B_OFFSET UNITYSDK_OFFSET(0x17596460)
#define RPG_GAMECORE_REMOVEADVENTUREMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x17596430)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveAdventureModifier_TypeDefinitionIndex = 19926;
