...
#define RPG_GAMECORE_REMOVEADVENTUREMODIFIER_METHOD_3_5A4F78BA9F055BFF_OFFSET UNITYSDK_OFFSET(0x18CA23E0)
#define RPG_GAMECORE_REMOVEADVENTUREMODIFIER_METHOD_3_CCDE182400285E8B_OFFSET UNITYSDK_OFFSET(0x18CA2460)
#define RPG_GAMECORE_REMOVEADVENTUREMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x18CA2430)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveAdventureModifier_TypeDefinitionIndex = 20607;
