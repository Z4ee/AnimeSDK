...
#define RPG_GAMECORE_TASKTEMPLATEFETCHPARAMSEQUENCE_METHOD_3_251BE854C786F840_OFFSET UNITYSDK_OFFSET(0x17895540)
#define RPG_GAMECORE_TASKTEMPLATEFETCHPARAMSEQUENCE_METHOD_3_90FBEEF2E3BFD039_OFFSET UNITYSDK_OFFSET(0x178873B0)
#define RPG_GAMECORE_TASKTEMPLATEFETCHPARAMSEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x17887380)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TaskTemplateFetchParamSequence_TypeDefinitionIndex = 22105;
