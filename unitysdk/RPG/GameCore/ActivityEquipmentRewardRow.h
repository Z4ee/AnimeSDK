...
#define RPG_GAMECORE_ACTIVITYEQUIPMENTREWARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16EAAF60)
#define RPG_GAMECORE_ACTIVITYEQUIPMENTREWARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16EAB180)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityEquipmentRewardRow_TypeDefinitionIndex = 10648;

	class ActivityEquipmentRewardRow : public ::System::Object
	{
	public:
		::Il2CppArray<::System::UInt32>* MaterialRewardQuestIDList; // 0x10
		::System::UInt32 EquipmentRewardQuestID; // 0x18
