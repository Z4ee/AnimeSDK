...
#define RPG_GAMECORE_TEAMLOOKAT_METHOD_3_1C8405416D93B38D_OFFSET UNITYSDK_OFFSET(0x17887CC0)
#define RPG_GAMECORE_TEAMLOOKAT_METHOD_3_6420D5667890140E_OFFSET UNITYSDK_OFFSET(0x178970B0)
#define RPG_GAMECORE_TEAMLOOKAT__CTOR_OFFSET UNITYSDK_OFFSET(0x17887C90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TeamLookAt_TypeDefinitionIndex = 20636;
