...
#define RPG_GAMECORE_FIVEDIMPLAYERMOVEMODIFIERCONFIG_METHOD_3_55FF2622F8924914_OFFSET UNITYSDK_OFFSET(0x18913C80)
#define RPG_GAMECORE_FIVEDIMPLAYERMOVEMODIFIERCONFIG_METHOD_3_DDE8F5213E21E8B7_OFFSET UNITYSDK_OFFSET(0x18913CF0)
#define RPG_GAMECORE_FIVEDIMPLAYERMOVEMODIFIERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18913CD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimPlayerMoveModifierConfig_TypeDefinitionIndex = 17618;
