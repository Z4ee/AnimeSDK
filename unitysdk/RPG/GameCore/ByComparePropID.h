...
#define RPG_GAMECORE_BYCOMPAREPROPID_METHOD_4_AD4111DD0FB5AADC_OFFSET UNITYSDK_OFFSET(0x18737670)
#define RPG_GAMECORE_BYCOMPAREPROPID_METHOD_4_ADBB29BD68DC9778_OFFSET UNITYSDK_OFFSET(0x187375A0)
#define RPG_GAMECORE_BYCOMPAREPROPID__CTOR_OFFSET UNITYSDK_OFFSET(0x18737620)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByComparePropID_TypeDefinitionIndex = 20813;
