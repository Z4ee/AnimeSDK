...
#define RPG_GAMECORE_DYNAMICVALUERANGEGROUP_METHOD_2_A6DD6CE5877AAB42_OFFSET UNITYSDK_OFFSET(0x17187B30)
#define RPG_GAMECORE_DYNAMICVALUERANGEGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x17187CE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DynamicValueRangeGroup_TypeDefinitionIndex = 16723;
