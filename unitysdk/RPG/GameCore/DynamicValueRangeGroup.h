...
#define RPG_GAMECORE_DYNAMICVALUERANGEGROUP_METHOD_2_A6DD6CE5877AAB42_OFFSET UNITYSDK_OFFSET(0x1DB202E0)
#define RPG_GAMECORE_DYNAMICVALUERANGEGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB20490)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DynamicValueRangeGroup_TypeDefinitionIndex = 18012;
