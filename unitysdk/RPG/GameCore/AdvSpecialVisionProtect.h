...
#define RPG_GAMECORE_ADVSPECIALVISIONPROTECT_METHOD_3_8D67088AF2BB7A34_OFFSET UNITYSDK_OFFSET(0x16F447A0)
#define RPG_GAMECORE_ADVSPECIALVISIONPROTECT_METHOD_3_F6615DD0B0A736A5_OFFSET UNITYSDK_OFFSET(0x16F44820)
#define RPG_GAMECORE_ADVSPECIALVISIONPROTECT__CTOR_OFFSET UNITYSDK_OFFSET(0x16F447F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSpecialVisionProtect_TypeDefinitionIndex = 20052;
