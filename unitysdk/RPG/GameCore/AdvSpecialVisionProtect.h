...
#define RPG_GAMECORE_ADVSPECIALVISIONPROTECT_METHOD_3_D113C68BCFF16166_OFFSET UNITYSDK_OFFSET(0x1AE482C0)
#define RPG_GAMECORE_ADVSPECIALVISIONPROTECT_METHOD_3_F6615DD0B0A736A5_OFFSET UNITYSDK_OFFSET(0x1AE48300)
#define RPG_GAMECORE_ADVSPECIALVISIONPROTECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE482F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSpecialVisionProtect_TypeDefinitionIndex = 21077;
