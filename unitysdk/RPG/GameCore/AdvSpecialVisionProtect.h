...
#define RPG_GAMECORE_ADVSPECIALVISIONPROTECT_METHOD_3_8D67088AF2BB7A34_OFFSET UNITYSDK_OFFSET(0x1943A290)
#define RPG_GAMECORE_ADVSPECIALVISIONPROTECT_METHOD_3_F6615DD0B0A736A5_OFFSET UNITYSDK_OFFSET(0x1943A310)
#define RPG_GAMECORE_ADVSPECIALVISIONPROTECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1943A2E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSpecialVisionProtect_TypeDefinitionIndex = 20662;
