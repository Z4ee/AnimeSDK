...
#define RPG_GAMECORE_MANIKINCUSTOMCONFIG_METHOD_2_86FB05DBD7BDCC5D_OFFSET UNITYSDK_OFFSET(0x1BCDD0D0)
#define RPG_GAMECORE_MANIKINCUSTOMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCDD280)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ManikinCustomConfig_TypeDefinitionIndex = 16777;
