...
#define RPG_GAMECORE_BYCOMPARELITTLEGAMELEVELVARFIXPOINT_METHOD_4_1440599890D57353_OFFSET UNITYSDK_OFFSET(0x19CF0BD0)
#define RPG_GAMECORE_BYCOMPARELITTLEGAMELEVELVARFIXPOINT_METHOD_4_466A214834A357D5_OFFSET UNITYSDK_OFFSET(0x19CF0EB0)
#define RPG_GAMECORE_BYCOMPARELITTLEGAMELEVELVARFIXPOINT_METHOD_4_47CFD305C79EFB5E_OFFSET UNITYSDK_OFFSET(0x19CF0C20)
#define RPG_GAMECORE_BYCOMPARELITTLEGAMELEVELVARFIXPOINT_METHOD_4_B8068360B13D4002_OFFSET UNITYSDK_OFFSET(0x19CF0E70)
#define RPG_GAMECORE_BYCOMPARELITTLEGAMELEVELVARFIXPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x19CF0C10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareLittleGameLevelVarFixPoint_TypeDefinitionIndex = 20630;
