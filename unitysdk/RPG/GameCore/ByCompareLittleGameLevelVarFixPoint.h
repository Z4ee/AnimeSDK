...
#define RPG_GAMECORE_BYCOMPARELITTLEGAMELEVELVARFIXPOINT_METHOD_4_47CFD305C79EFB5E_OFFSET UNITYSDK_OFFSET(0x18731F60)
#define RPG_GAMECORE_BYCOMPARELITTLEGAMELEVELVARFIXPOINT_METHOD_4_F00361732887FAE8_OFFSET UNITYSDK_OFFSET(0x18731E80)
#define RPG_GAMECORE_BYCOMPARELITTLEGAMELEVELVARFIXPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x18731F00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareLittleGameLevelVarFixPoint_TypeDefinitionIndex = 20318;
