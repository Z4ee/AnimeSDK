...
#define RPG_GAMECORE_FIVEDIMCRYSTALCONFIG_METHOD_3_30D756FA95B1D468_OFFSET UNITYSDK_OFFSET(0x171EDAF0)
#define RPG_GAMECORE_FIVEDIMCRYSTALCONFIG_METHOD_3_52F93B198B643705_OFFSET UNITYSDK_OFFSET(0x171EDA60)
#define RPG_GAMECORE_FIVEDIMCRYSTALCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171EDAC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimCrystalConfig_TypeDefinitionIndex = 17066;
