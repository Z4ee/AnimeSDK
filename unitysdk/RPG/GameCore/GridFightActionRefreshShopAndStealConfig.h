...
#define RPG_GAMECORE_GRIDFIGHTACTIONREFRESHSHOPANDSTEALCONFIG_METHOD_6_131CDB5BA685791D_OFFSET UNITYSDK_OFFSET(0x1C5C1F30)
#define RPG_GAMECORE_GRIDFIGHTACTIONREFRESHSHOPANDSTEALCONFIG_METHOD_6_AF8A811E81B80F41_OFFSET UNITYSDK_OFFSET(0x1C5C1B90)
#define RPG_GAMECORE_GRIDFIGHTACTIONREFRESHSHOPANDSTEALCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5C1B80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightActionRefreshShopAndStealConfig_TypeDefinitionIndex = 18551;
