...
#define RPG_GAMECORE_GRIDFIGHTACTIONREFRESHSHOPANDSTEALCONFIG_METHOD_6_6C2AAEF0DEC0217A_OFFSET UNITYSDK_OFFSET(0x189A05A0)
#define RPG_GAMECORE_GRIDFIGHTACTIONREFRESHSHOPANDSTEALCONFIG_METHOD_6_AF8A811E81B80F41_OFFSET UNITYSDK_OFFSET(0x1899FAC0)
#define RPG_GAMECORE_GRIDFIGHTACTIONREFRESHSHOPANDSTEALCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1899FA20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightActionRefreshShopAndStealConfig_TypeDefinitionIndex = 18342;
