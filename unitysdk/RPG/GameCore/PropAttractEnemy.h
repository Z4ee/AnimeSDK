...
#define RPG_GAMECORE_PROPATTRACTENEMY_METHOD_3_F6684869A268CB91_OFFSET UNITYSDK_OFFSET(0x1D1739B0)
#define RPG_GAMECORE_PROPATTRACTENEMY_METHOD_3_FE9C26D637C5E225_OFFSET UNITYSDK_OFFSET(0x1D173960)
#define RPG_GAMECORE_PROPATTRACTENEMY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1739A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropAttractEnemy_TypeDefinitionIndex = 19941;
