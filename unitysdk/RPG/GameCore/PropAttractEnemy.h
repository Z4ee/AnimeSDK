...
#define RPG_GAMECORE_PROPATTRACTENEMY_METHOD_3_5AC94833163FC34B_OFFSET UNITYSDK_OFFSET(0x17516080)
#define RPG_GAMECORE_PROPATTRACTENEMY_METHOD_3_F6684869A268CB91_OFFSET UNITYSDK_OFFSET(0x17516110)
#define RPG_GAMECORE_PROPATTRACTENEMY__CTOR_OFFSET UNITYSDK_OFFSET(0x175160E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropAttractEnemy_TypeDefinitionIndex = 18459;
