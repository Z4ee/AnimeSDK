...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERFINISHALLPRAYQUESTCONFIG_METHOD_3_035FF04870FEB67A_OFFSET UNITYSDK_OFFSET(0x1D069C70)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERFINISHALLPRAYQUESTCONFIG_METHOD_3_4D40E56B8AF17ED6_OFFSET UNITYSDK_OFFSET(0x1D069CC0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERFINISHALLPRAYQUESTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D069CB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierFinishAllPrayQuestConfig_TypeDefinitionIndex = 18740;
