...
#define RPG_GAMECORE_TIMEREWINDGLOBALUNSELECTABLE_METHOD_3_784135F9FB750B95_OFFSET UNITYSDK_OFFSET(0x19DE6AA0)
#define RPG_GAMECORE_TIMEREWINDGLOBALUNSELECTABLE_METHOD_3_CDDDCAB258594664_OFFSET UNITYSDK_OFFSET(0x19DE6B20)
#define RPG_GAMECORE_TIMEREWINDGLOBALUNSELECTABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x19DE6AF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TimeRewindGlobalUnselectable_TypeDefinitionIndex = 19538;
