...
#define RPG_GAMECORE_TIMEREWINDGLOBALUNSELECTABLE_METHOD_3_CDDDCAB258594664_OFFSET UNITYSDK_OFFSET(0x1C1533B0)
#define RPG_GAMECORE_TIMEREWINDGLOBALUNSELECTABLE_METHOD_3_D2DBF0358BD045BF_OFFSET UNITYSDK_OFFSET(0x1C153360)
#define RPG_GAMECORE_TIMEREWINDGLOBALUNSELECTABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1533A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TimeRewindGlobalUnselectable_TypeDefinitionIndex = 19896;
