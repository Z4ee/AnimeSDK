...
#define RPG_GAMECORE_MONOPOLYCHECKHASFINISHEDQUIZ_METHOD_3_7D1D6A84BFA7A05D_OFFSET UNITYSDK_OFFSET(0x1B1B0750)
#define RPG_GAMECORE_MONOPOLYCHECKHASFINISHEDQUIZ_METHOD_3_9FA63C637B40C2EA_OFFSET UNITYSDK_OFFSET(0x1B1B0710)
#define RPG_GAMECORE_MONOPOLYCHECKHASFINISHEDQUIZ__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1B0740)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonopolyCheckHasFinishedQuiz_TypeDefinitionIndex = 20141;
