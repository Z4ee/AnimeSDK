...
#define RPG_GAMECORE_MONOPOLYCHECKHASFINISHEDQUIZ_METHOD_3_34AEC9DE8FC162A1_OFFSET UNITYSDK_OFFSET(0x17436FE0)
#define RPG_GAMECORE_MONOPOLYCHECKHASFINISHEDQUIZ_METHOD_3_474FE93B48DBCF1F_OFFSET UNITYSDK_OFFSET(0x17437060)
#define RPG_GAMECORE_MONOPOLYCHECKHASFINISHEDQUIZ__CTOR_OFFSET UNITYSDK_OFFSET(0x17437030)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonopolyCheckHasFinishedQuiz_TypeDefinitionIndex = 19259;
