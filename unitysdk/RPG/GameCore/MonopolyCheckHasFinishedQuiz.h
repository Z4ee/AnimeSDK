...
#define RPG_GAMECORE_MONOPOLYCHECKHASFINISHEDQUIZ_METHOD_3_7D1D6A84BFA7A05D_OFFSET UNITYSDK_OFFSET(0x1D2BAA30)
#define RPG_GAMECORE_MONOPOLYCHECKHASFINISHEDQUIZ_METHOD_3_9FA63C637B40C2EA_OFFSET UNITYSDK_OFFSET(0x1D2BA9F0)
#define RPG_GAMECORE_MONOPOLYCHECKHASFINISHEDQUIZ__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2BAA20)
