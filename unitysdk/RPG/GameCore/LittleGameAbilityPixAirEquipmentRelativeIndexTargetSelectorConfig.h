...
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREQUIPMENTRELATIVEINDEXTARGETSELECTORCONFIG_METHOD_3_33C5801ABFD9B11A_OFFSET UNITYSDK_OFFSET(0x1B094980)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREQUIPMENTRELATIVEINDEXTARGETSELECTORCONFIG_METHOD_3_FEDEB80E227D3C7A_OFFSET UNITYSDK_OFFSET(0x1B0949E0)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREQUIPMENTRELATIVEINDEXTARGETSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0949D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityPixAirEquipmentRelativeIndexTargetSelectorConfig_TypeDefinitionIndex = 20577;
