...
#define RPG_GAMECORE_LEVELCHARACTERLIMBOREVIVABLE_CLEAR_OFFSET UNITYSDK_OFFSET(0x18452EC0)
#define RPG_GAMECORE_LEVELCHARACTERLIMBOREVIVABLE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x18452F60)
#define RPG_GAMECORE_LEVELCHARACTERLIMBOREVIVABLE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x18452F10)
#define RPG_GAMECORE_LEVELCHARACTERLIMBOREVIVABLE_INIT_OFFSET UNITYSDK_OFFSET(0x1841AAF0)
#define RPG_GAMECORE_LEVELCHARACTERLIMBOREVIVABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x18452FB0)
