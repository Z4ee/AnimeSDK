...
#define RPG_GAMECORE_LEVELAPPLYBATTLECARDBUFFSELECTIONEVENT_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1844B490)
#define RPG_GAMECORE_LEVELAPPLYBATTLECARDBUFFSELECTIONEVENT_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x1844B440)
#define RPG_GAMECORE_LEVELAPPLYBATTLECARDBUFFSELECTIONEVENT_INIT_OFFSET UNITYSDK_OFFSET(0x1844B4E0)
#define RPG_GAMECORE_LEVELAPPLYBATTLECARDBUFFSELECTIONEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1844B530)
