...
#define RPG_GAMECORE_CHANGEMUSICVISUALBEATEFFECTSTATE_METHOD_3_3F1B006580294301_OFFSET UNITYSDK_OFFSET(0x17063F50)
#define RPG_GAMECORE_CHANGEMUSICVISUALBEATEFFECTSTATE_METHOD_3_87F283E74A55ED7B_OFFSET UNITYSDK_OFFSET(0x17063E00)
#define RPG_GAMECORE_CHANGEMUSICVISUALBEATEFFECTSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x17063EC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChangeMusicVisualBeatEffectState_TypeDefinitionIndex = 20504;
