...
#define RPG_GAMECORE_MONOPOLYGAMERESOURCEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B1B4640)
#define RPG_GAMECORE_MONOPOLYGAMERESOURCEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1B4C80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonopolyGameResourceRow_TypeDefinitionIndex = 11603;
