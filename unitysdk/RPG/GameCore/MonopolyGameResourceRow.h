...
#define RPG_GAMECORE_MONOPOLYGAMERESOURCEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1995FBF0)
#define RPG_GAMECORE_MONOPOLYGAMERESOURCEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19960270)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonopolyGameResourceRow_TypeDefinitionIndex = 11503;

	class MonopolyGameResourceRow : public ::System::Object
	{
	public:
		::System::String* IconPath; // 0x10
		::System::String* RuleIconPath; // 0x18
