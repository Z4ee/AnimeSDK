...
#define RPG_GAMECORE_SWITCHMAINCAMERA_METHOD_3_4AD2CCF07A23E323_OFFSET UNITYSDK_OFFSET(0x18EBBF10)
#define RPG_GAMECORE_SWITCHMAINCAMERA_METHOD_3_A213E73CE13B65DD_OFFSET UNITYSDK_OFFSET(0x18EBBFB0)
#define RPG_GAMECORE_SWITCHMAINCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x18EBBF70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchMainCamera_TypeDefinitionIndex = 22297;
