...
#define RPG_GAMECORE_SWITCHMAINCAMERA_METHOD_3_8296F125E0D52DA4_OFFSET UNITYSDK_OFFSET(0x1B4370B0)
#define RPG_GAMECORE_SWITCHMAINCAMERA_METHOD_3_A213E73CE13B65DD_OFFSET UNITYSDK_OFFSET(0x1B437120)
#define RPG_GAMECORE_SWITCHMAINCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B437100)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchMainCamera_TypeDefinitionIndex = 22486;
