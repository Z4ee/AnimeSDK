...
#define RPG_GAMECORE_SWITCHMAINCAMERA_METHOD_3_4AD2CCF07A23E323_OFFSET UNITYSDK_OFFSET(0x19CDBD30)
#define RPG_GAMECORE_SWITCHMAINCAMERA_METHOD_3_A213E73CE13B65DD_OFFSET UNITYSDK_OFFSET(0x19CDBDD0)
#define RPG_GAMECORE_SWITCHMAINCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x19CDBD90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchMainCamera_TypeDefinitionIndex = 22050;
