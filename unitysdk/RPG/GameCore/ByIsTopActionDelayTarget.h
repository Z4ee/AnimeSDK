...
#define RPG_GAMECORE_BYISTOPACTIONDELAYTARGET_METHOD_4_27BBC0B525E291A3_OFFSET UNITYSDK_OFFSET(0x18759930)
#define RPG_GAMECORE_BYISTOPACTIONDELAYTARGET_METHOD_4_54BA36E229EA614B_OFFSET UNITYSDK_OFFSET(0x18759A00)
#define RPG_GAMECORE_BYISTOPACTIONDELAYTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x187599B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsTopActionDelayTarget_TypeDefinitionIndex = 21974;
