...
#define RPG_GAMECORE_BYCOMPAREFSVWITHGP_METHOD_4_276E77EA8D03DE83_OFFSET UNITYSDK_OFFSET(0x1CEC1660)
#define RPG_GAMECORE_BYCOMPAREFSVWITHGP_METHOD_4_418347DE1A47B068_OFFSET UNITYSDK_OFFSET(0x1CEC1460)
#define RPG_GAMECORE_BYCOMPAREFSVWITHGP_METHOD_4_481D392C488DF32C_OFFSET UNITYSDK_OFFSET(0x1CEC1620)
#define RPG_GAMECORE_BYCOMPAREFSVWITHGP_METHOD_4_AC6B7C1FA92B18AD_OFFSET UNITYSDK_OFFSET(0x1CEC1410)
#define RPG_GAMECORE_BYCOMPAREFSVWITHGP__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEC1450)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareFSVwithGP_TypeDefinitionIndex = 20203;
