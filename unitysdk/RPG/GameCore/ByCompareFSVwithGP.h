...
#define RPG_GAMECORE_BYCOMPAREFSVWITHGP_METHOD_4_418347DE1A47B068_OFFSET UNITYSDK_OFFSET(0x1872C370)
#define RPG_GAMECORE_BYCOMPAREFSVWITHGP_METHOD_4_434BC6E1D0C79FEE_OFFSET UNITYSDK_OFFSET(0x1872C290)
#define RPG_GAMECORE_BYCOMPAREFSVWITHGP__CTOR_OFFSET UNITYSDK_OFFSET(0x1872C310)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareFSVwithGP_TypeDefinitionIndex = 19395;
