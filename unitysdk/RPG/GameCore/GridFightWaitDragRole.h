...
#define RPG_GAMECORE_GRIDFIGHTWAITDRAGROLE_METHOD_3_74BE9A38E0C4489A_OFFSET UNITYSDK_OFFSET(0x189DF550)
#define RPG_GAMECORE_GRIDFIGHTWAITDRAGROLE_METHOD_3_A3CB618E08EE56AB_OFFSET UNITYSDK_OFFSET(0x189DF4D0)
#define RPG_GAMECORE_GRIDFIGHTWAITDRAGROLE__CTOR_OFFSET UNITYSDK_OFFSET(0x189DF520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightWaitDragRole_TypeDefinitionIndex = 18877;
