...
#define RPG_GAMECORE_SETFLOORCUSTOMBOOLV2_METHOD_3_5DC8ED7F7A9D7300_OFFSET UNITYSDK_OFFSET(0x19C4ECB0)
#define RPG_GAMECORE_SETFLOORCUSTOMBOOLV2_METHOD_3_A905AE43A0B94131_OFFSET UNITYSDK_OFFSET(0x19C4EC30)
#define RPG_GAMECORE_SETFLOORCUSTOMBOOLV2__CTOR_OFFSET UNITYSDK_OFFSET(0x19C4EC80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetFloorCustomBoolV2_TypeDefinitionIndex = 19554;
