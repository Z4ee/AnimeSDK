...
#define RPG_GAMECORE_SETFLOORCUSTOMBOOLV2_METHOD_3_5DC8ED7F7A9D7300_OFFSET UNITYSDK_OFFSET(0x1D4FF750)
#define RPG_GAMECORE_SETFLOORCUSTOMBOOLV2_METHOD_3_F87A057A4F4E42E5_OFFSET UNITYSDK_OFFSET(0x1D4FF710)
#define RPG_GAMECORE_SETFLOORCUSTOMBOOLV2__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4FF740)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetFloorCustomBoolV2_TypeDefinitionIndex = 20459;
