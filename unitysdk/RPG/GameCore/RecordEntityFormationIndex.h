...
#define RPG_GAMECORE_RECORDENTITYFORMATIONINDEX_METHOD_3_0048AFB8930ED401_OFFSET UNITYSDK_OFFSET(0x1B9BE510)
#define RPG_GAMECORE_RECORDENTITYFORMATIONINDEX_METHOD_3_C53A08864895341A_OFFSET UNITYSDK_OFFSET(0x1B9BE4D0)
#define RPG_GAMECORE_RECORDENTITYFORMATIONINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9BE500)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RecordEntityFormationIndex_TypeDefinitionIndex = 22848;
