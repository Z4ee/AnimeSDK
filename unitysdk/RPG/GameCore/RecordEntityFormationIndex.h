...
#define RPG_GAMECORE_RECORDENTITYFORMATIONINDEX_METHOD_3_0048AFB8930ED401_OFFSET UNITYSDK_OFFSET(0x17586850)
#define RPG_GAMECORE_RECORDENTITYFORMATIONINDEX_METHOD_3_E17928DD86091BA8_OFFSET UNITYSDK_OFFSET(0x175867D0)
#define RPG_GAMECORE_RECORDENTITYFORMATIONINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0x17586820)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RecordEntityFormationIndex_TypeDefinitionIndex = 21951;
