...
#define RPG_GAMECORE_GIFTDANMUSENDERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D144750)
#define RPG_GAMECORE_GIFTDANMUSENDERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D144920)
