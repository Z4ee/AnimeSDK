...
#define RPG_GAMECORE_NORMDISTANCELODTEMPLATE_METHOD_2_33CDAC60D40CD452_OFFSET UNITYSDK_OFFSET(0x1D2F5A40)
#define RPG_GAMECORE_NORMDISTANCELODTEMPLATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2F5D90)
