...
#define RPG_GAMECORE_SHOWPHASEUI_METHOD_3_1B4AC7E06FBC44CA_OFFSET UNITYSDK_OFFSET(0x17700F90)
#define RPG_GAMECORE_SHOWPHASEUI_METHOD_3_D411BB6F6307253C_OFFSET UNITYSDK_OFFSET(0x17701010)
#define RPG_GAMECORE_SHOWPHASEUI__CTOR_OFFSET UNITYSDK_OFFSET(0x17700FE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowPhaseUI_TypeDefinitionIndex = 21938;
