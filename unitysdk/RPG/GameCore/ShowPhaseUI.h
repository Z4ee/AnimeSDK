...
#define RPG_GAMECORE_SHOWPHASEUI_METHOD_3_8312D57E880CB29B_OFFSET UNITYSDK_OFFSET(0x1D52DC30)
#define RPG_GAMECORE_SHOWPHASEUI_METHOD_3_D411BB6F6307253C_OFFSET UNITYSDK_OFFSET(0x1D52DC70)
#define RPG_GAMECORE_SHOWPHASEUI__CTOR_OFFSET UNITYSDK_OFFSET(0x1D52DC60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowPhaseUI_TypeDefinitionIndex = 23413;
