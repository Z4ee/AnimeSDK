...
#define RPG_GAMECORE_SETBATTLEROUGEGOALPROGRESS_METHOD_3_83799E56225750D2_OFFSET UNITYSDK_OFFSET(0x1C2D4E90)
#define RPG_GAMECORE_SETBATTLEROUGEGOALPROGRESS_METHOD_3_955CFD4D8F764113_OFFSET UNITYSDK_OFFSET(0x1C2D4EE0)
#define RPG_GAMECORE_SETBATTLEROUGEGOALPROGRESS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2D4ED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetBattleRougeGoalProgress_TypeDefinitionIndex = 22813;
