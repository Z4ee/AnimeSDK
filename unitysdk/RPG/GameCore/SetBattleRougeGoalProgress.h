...
#define RPG_GAMECORE_SETBATTLEROUGEGOALPROGRESS_METHOD_3_305001F4A8BA242A_OFFSET UNITYSDK_OFFSET(0x176A9FB0)
#define RPG_GAMECORE_SETBATTLEROUGEGOALPROGRESS_METHOD_3_955CFD4D8F764113_OFFSET UNITYSDK_OFFSET(0x176AA040)
#define RPG_GAMECORE_SETBATTLEROUGEGOALPROGRESS__CTOR_OFFSET UNITYSDK_OFFSET(0x176AA010)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetBattleRougeGoalProgress_TypeDefinitionIndex = 21913;
