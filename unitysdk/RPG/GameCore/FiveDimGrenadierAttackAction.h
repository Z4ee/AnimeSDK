...
#define RPG_GAMECORE_FIVEDIMGRENADIERATTACKACTION_METHOD_3_3CFF1935919D4915_OFFSET UNITYSDK_OFFSET(0x171E8490)
#define RPG_GAMECORE_FIVEDIMGRENADIERATTACKACTION_METHOD_3_98D97814C5DCA030_OFFSET UNITYSDK_OFFSET(0x171F5C40)
#define RPG_GAMECORE_FIVEDIMGRENADIERATTACKACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x171E8470)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimGrenadierAttackAction_TypeDefinitionIndex = 17242;
