...
#define RPG_GAMECORE_FIVEDIMGRENADIERATTACKACTION_METHOD_3_3CFF1935919D4915_OFFSET UNITYSDK_OFFSET(0x188F5F00)
#define RPG_GAMECORE_FIVEDIMGRENADIERATTACKACTION_METHOD_3_98D97814C5DCA030_OFFSET UNITYSDK_OFFSET(0x18905550)
#define RPG_GAMECORE_FIVEDIMGRENADIERATTACKACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x188F5EE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimGrenadierAttackAction_TypeDefinitionIndex = 17847;
