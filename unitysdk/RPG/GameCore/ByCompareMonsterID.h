...
#define RPG_GAMECORE_BYCOMPAREMONSTERID_METHOD_4_55E93A0F2EB1E23F_OFFSET UNITYSDK_OFFSET(0x1700F740)
#define RPG_GAMECORE_BYCOMPAREMONSTERID_METHOD_4_6C683C63AB48E4CA_OFFSET UNITYSDK_OFFSET(0x1700F8A0)
#define RPG_GAMECORE_BYCOMPAREMONSTERID__CTOR_OFFSET UNITYSDK_OFFSET(0x1700F800)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareMonsterID_TypeDefinitionIndex = 21205;
