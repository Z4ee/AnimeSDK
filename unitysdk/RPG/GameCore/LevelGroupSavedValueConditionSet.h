...
#define RPG_GAMECORE_LEVELGROUPSAVEDVALUECONDITIONSET_METHOD_2_8D68B5BF7675D3CA_OFFSET UNITYSDK_OFFSET(0x1C117F50)
#define RPG_GAMECORE_LEVELGROUPSAVEDVALUECONDITIONSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1C118E90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelGroupSavedValueConditionSet_TypeDefinitionIndex = 17015;
