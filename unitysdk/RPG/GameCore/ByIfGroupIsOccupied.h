...
#define RPG_GAMECORE_BYIFGROUPISOCCUPIED_METHOD_4_026AB6726CC30F17_OFFSET UNITYSDK_OFFSET(0x17027540)
#define RPG_GAMECORE_BYIFGROUPISOCCUPIED_METHOD_4_CF278D7DDC4D4435_OFFSET UNITYSDK_OFFSET(0x17027610)
#define RPG_GAMECORE_BYIFGROUPISOCCUPIED__CTOR_OFFSET UNITYSDK_OFFSET(0x170275C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIfGroupIsOccupied_TypeDefinitionIndex = 19395;
