...
#define RPG_GAMECORE_BYIFGROUPISOCCUPIED_METHOD_4_19E93960D86042E5_OFFSET UNITYSDK_OFFSET(0x1CF29C40)
#define RPG_GAMECORE_BYIFGROUPISOCCUPIED_METHOD_4_33638E056F1C7D34_OFFSET UNITYSDK_OFFSET(0x1CF29A30)
#define RPG_GAMECORE_BYIFGROUPISOCCUPIED_METHOD_4_CF278D7DDC4D4435_OFFSET UNITYSDK_OFFSET(0x1CF29A70)
#define RPG_GAMECORE_BYIFGROUPISOCCUPIED_METHOD_4_E5D6B0C5212BF0A2_OFFSET UNITYSDK_OFFSET(0x1CF29C70)
#define RPG_GAMECORE_BYIFGROUPISOCCUPIED__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF29A60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIfGroupIsOccupied_TypeDefinitionIndex = 20848;
