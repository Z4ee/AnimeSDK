...
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIRONESIDEEQUIPMENTTARGETSELECTORCONFIG_METHOD_3_8AE2CA9A67564347_OFFSET UNITYSDK_OFFSET(0x1B095270)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIRONESIDEEQUIPMENTTARGETSELECTORCONFIG_METHOD_3_A3647279316AA5B3_OFFSET UNITYSDK_OFFSET(0x1B095160)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIRONESIDEEQUIPMENTTARGETSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B095260)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityPixAirOneSideEquipmentTargetSelectorConfig_TypeDefinitionIndex = 20582;
