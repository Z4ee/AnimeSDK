...
#define RPG_GAMECORE_SWITCHPROPSCENEOBJCLICKHINTATTACHPOINT_METHOD_3_E629190B9966A347_OFFSET UNITYSDK_OFFSET(0x19CDE6A0)
#define RPG_GAMECORE_SWITCHPROPSCENEOBJCLICKHINTATTACHPOINT_METHOD_3_EC3A0E60E8D7B668_OFFSET UNITYSDK_OFFSET(0x19CDE550)
#define RPG_GAMECORE_SWITCHPROPSCENEOBJCLICKHINTATTACHPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x19CDE610)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchPropSceneObjClickHintAttachPoint_TypeDefinitionIndex = 21017;
