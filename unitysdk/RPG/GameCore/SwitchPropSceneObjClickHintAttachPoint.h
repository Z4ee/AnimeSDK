...
#define RPG_GAMECORE_SWITCHPROPSCENEOBJCLICKHINTATTACHPOINT_METHOD_3_CBCA61B2108BC9DF_OFFSET UNITYSDK_OFFSET(0x1B4395A0)
#define RPG_GAMECORE_SWITCHPROPSCENEOBJCLICKHINTATTACHPOINT_METHOD_3_E629190B9966A347_OFFSET UNITYSDK_OFFSET(0x1B439620)
#define RPG_GAMECORE_SWITCHPROPSCENEOBJCLICKHINTATTACHPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4395F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchPropSceneObjClickHintAttachPoint_TypeDefinitionIndex = 21432;
