...
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTLEVELCHANGECONFIG_METHOD_7_1AF76778ACC899BF_OFFSET UNITYSDK_OFFSET(0x1D030680)
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTLEVELCHANGECONFIG_METHOD_7_7C1AF35DE5EA05C3_OFFSET UNITYSDK_OFFSET(0x1D0304C0)
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTLEVELCHANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0304B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaSelectRoomCardCastLevelChangeConfig_TypeDefinitionIndex = 18961;
