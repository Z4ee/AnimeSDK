...
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTLEVELCHANGECONFIG_METHOD_7_7C1AF35DE5EA05C3_OFFSET UNITYSDK_OFFSET(0x18CCE960)
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTLEVELCHANGECONFIG_METHOD_7_892C22EC76DC5FB6_OFFSET UNITYSDK_OFFSET(0x18CCF3D0)
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTLEVELCHANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CCE880)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaSelectRoomCardCastLevelChangeConfig_TypeDefinitionIndex = 18718;
