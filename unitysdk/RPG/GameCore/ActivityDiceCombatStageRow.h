...
#define RPG_GAMECORE_ACTIVITYDICECOMBATSTAGEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x193DA710)
#define RPG_GAMECORE_ACTIVITYDICECOMBATSTAGEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x193DAB20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityDiceCombatStageRow_TypeDefinitionIndex = 10819;
	...
	public:
		...
		::System::UInt32 IsUseDiceLuckControl; // 0x24
		::System::UInt32 OverWriteMaxHPLuckControl; // 0x28
		::System::UInt32 DiceStageID; // 0x2C
		::System::UInt32 DiceAvatarLevel; // 0x30
		::RPG::GameCore::DiceCombatStageFirstType FirstType; // 0x34
		::System::UInt32 HardLevel; // 0x38
		::System::UInt32 DiceAvatarID; // 0x3C
		::System::UInt32 RewardID; // 0x40
		::System::UInt32 PresetID; // 0x44
