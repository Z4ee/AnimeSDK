...
#define RPG_GAMECORE_ACTIVITYDICECOMBATSTAGEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C9F4D80)
#define RPG_GAMECORE_ACTIVITYDICECOMBATSTAGEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9F5190)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 DiceAvatarID; // 0x20
		::System::UInt32 PresetID; // 0x24
		::System::UInt32 OverWriteMaxHPLuckControl; // 0x28
		::System::UInt32 AILevel; // 0x2C
		::System::UInt32 DiceCampaignID; // 0x30
		::RPG::GameCore::DiceCombatStageFirstType FirstType; // 0x34
		::System::UInt32 RewardID; // 0x38
		::System::UInt32 IsUseDiceLuckControl; // 0x3C
