...
#define RPG_GAMECORE_ROGUECHESTMODIFIEREVENT_METHOD_2_D7ECDBEF29483FAE_OFFSET UNITYSDK_OFFSET(0x1C4AD700)
#define RPG_GAMECORE_ROGUECHESTMODIFIEREVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4AD980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueChestModifierEvent_TypeDefinitionIndex = 17182;
