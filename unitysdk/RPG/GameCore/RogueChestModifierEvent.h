...
#define RPG_GAMECORE_ROGUECHESTMODIFIEREVENT_METHOD_2_345CA33702013629_OFFSET UNITYSDK_OFFSET(0x175E9BD0)
#define RPG_GAMECORE_ROGUECHESTMODIFIEREVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x175E9E60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueChestModifierEvent_TypeDefinitionIndex = 16452;
