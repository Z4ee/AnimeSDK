...
#define RPG_GAMECORE_MUSEUMACTIVITYQUESTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1745C880)
#define RPG_GAMECORE_MUSEUMACTIVITYQUESTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1745CA30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MuseumActivityQuestConfigRow_TypeDefinitionIndex = 13046;
