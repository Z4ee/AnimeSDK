...
#define RPG_GAMECORE_BYCOMPAREGROUPSTATE_METHOD_4_119C868CE777423D_OFFSET UNITYSDK_OFFSET(0x1CECA310)
#define RPG_GAMECORE_BYCOMPAREGROUPSTATE_METHOD_4_6F4F5AE4750CE2E0_OFFSET UNITYSDK_OFFSET(0x1CECA520)
#define RPG_GAMECORE_BYCOMPAREGROUPSTATE_METHOD_4_8B9CCD7A6DF2067C_OFFSET UNITYSDK_OFFSET(0x1CECA360)
#define RPG_GAMECORE_BYCOMPAREGROUPSTATE_METHOD_4_A3316C3FE52140B7_OFFSET UNITYSDK_OFFSET(0x1CECA560)
#define RPG_GAMECORE_BYCOMPAREGROUPSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CECA350)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareGroupState_TypeDefinitionIndex = 21885;
