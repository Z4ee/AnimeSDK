...
#define RPG_GAMECORE_BYCOMPAREGROUPSTATE_METHOD_4_8B9CCD7A6DF2067C_OFFSET UNITYSDK_OFFSET(0x1700AEF0)
#define RPG_GAMECORE_BYCOMPAREGROUPSTATE_METHOD_4_C93AAE7418A6A698_OFFSET UNITYSDK_OFFSET(0x1700AE10)
#define RPG_GAMECORE_BYCOMPAREGROUPSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1700AE90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareGroupState_TypeDefinitionIndex = 20315;
