...
#define RPG_GAMECORE_MAZEDRAGCAMERACONFIG_METHOD_2_BE472612B613C70B_OFFSET UNITYSDK_OFFSET(0x1D25A4B0)
#define RPG_GAMECORE_MAZEDRAGCAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D25AA60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MazeDragCameraConfig_TypeDefinitionIndex = 17416;
