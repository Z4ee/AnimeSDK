...
#define RPG_GAMECORE_TEAMBOOSTCHECK_METHOD_3_61E08937568C0ACF_OFFSET UNITYSDK_OFFSET(0x19DDB080)
#define RPG_GAMECORE_TEAMBOOSTCHECK_METHOD_3_F5A048D77F91B3FE_OFFSET UNITYSDK_OFFSET(0x19DDB100)
#define RPG_GAMECORE_TEAMBOOSTCHECK__CTOR_OFFSET UNITYSDK_OFFSET(0x19DDB0D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TeamBoostCheck_TypeDefinitionIndex = 21715;
