...
#define RPG_GAMECORE_TEAMBOOSTCHECK_METHOD_3_C8FF71CCB66644BD_OFFSET UNITYSDK_OFFSET(0x1E1CAA10)
#define RPG_GAMECORE_TEAMBOOSTCHECK_METHOD_3_F5A048D77F91B3FE_OFFSET UNITYSDK_OFFSET(0x1E1CAA60)
#define RPG_GAMECORE_TEAMBOOSTCHECK__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1CAA50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TeamBoostCheck_TypeDefinitionIndex = 22711;
