...
#define RPG_GAMECORE_MAZEPUZZLEDOLLYZOOMTELEPORTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18AD4C70)
#define RPG_GAMECORE_MAZEPUZZLEDOLLYZOOMTELEPORTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18AD5030)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MazePuzzleDollyZoomTeleportRow_TypeDefinitionIndex = 13342;

	class MazePuzzleDollyZoomTeleportRow : public ::System::Object
	{
	public:
		::System::String* PuzzlePrefab; // 0x10
		::System::UInt32 InstanceIDA; // 0x18
		::System::UInt32 ID; // 0x1C
		::System::UInt32 OverridePosB; // 0x20
		::System::UInt32 DefaultComplete; // 0x24
		::System::UInt32 FloorID; // 0x28
		::System::Single OverrideInitFOV; // 0x2C
		::System::UInt32 OverrideTargetPosA; // 0x30
		::System::UInt32 InstanceIDB; // 0x34
		::System::UInt32 OverridePosA; // 0x38
		::System::UInt32 OverrideTargetPosB; // 0x3C
