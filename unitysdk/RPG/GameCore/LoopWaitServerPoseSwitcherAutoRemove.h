...
#define RPG_GAMECORE_LOOPWAITSERVERPOSESWITCHERAUTOREMOVE_METHOD_3_97C350BFBE052636_OFFSET UNITYSDK_OFFSET(0x1BCD4DD0)
#define RPG_GAMECORE_LOOPWAITSERVERPOSESWITCHERAUTOREMOVE_METHOD_3_D15E4EC2F11C6C92_OFFSET UNITYSDK_OFFSET(0x1BCD4E20)
#define RPG_GAMECORE_LOOPWAITSERVERPOSESWITCHERAUTOREMOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCD4E10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoopWaitServerPoseSwitcherAutoRemove_TypeDefinitionIndex = 20467;
