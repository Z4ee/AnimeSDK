...
#define RPG_GAMECORE_LOOPWAITSERVERPOSESWITCHERAUTOREMOVE_METHOD_3_D15E4EC2F11C6C92_OFFSET UNITYSDK_OFFSET(0x198B23C0)
#define RPG_GAMECORE_LOOPWAITSERVERPOSESWITCHERAUTOREMOVE_METHOD_3_E0E1DE2DAFF25512_OFFSET UNITYSDK_OFFSET(0x198B2330)
#define RPG_GAMECORE_LOOPWAITSERVERPOSESWITCHERAUTOREMOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x198B2390)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoopWaitServerPoseSwitcherAutoRemove_TypeDefinitionIndex = 20095;
