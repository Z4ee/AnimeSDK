...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONAFTERPERSONAROOMCARDWASHCONFIG_METHOD_3_7C7F36E0F59BFCA9_OFFSET UNITYSDK_OFFSET(0x1EEF83E0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONAFTERPERSONAROOMCARDWASHCONFIG_METHOD_3_A46AD0742F8C5625_OFFSET UNITYSDK_OFFSET(0x1EEF8390)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONAFTERPERSONAROOMCARDWASHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEF83D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionAfterPersonaRoomCardWashConfig_TypeDefinitionIndex = 17605;
