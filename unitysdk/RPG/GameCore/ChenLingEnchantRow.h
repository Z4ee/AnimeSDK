...
#define RPG_GAMECORE_CHENLINGENCHANTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x187EA4C0)
#define RPG_GAMECORE_CHENLINGENCHANTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x187EA700)
