...
#define RPG_GAMECORE_WAITANDPROCESSBATTLERESULT_METHOD_3_0300DDA5851E8C07_OFFSET UNITYSDK_OFFSET(0x19E50830)
#define RPG_GAMECORE_WAITANDPROCESSBATTLERESULT_METHOD_3_135846CF13F1B973_OFFSET UNITYSDK_OFFSET(0x19E50720)
#define RPG_GAMECORE_WAITANDPROCESSBATTLERESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x19E50800)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitAndProcessBattleResult_TypeDefinitionIndex = 22132;
