...
#define RPG_GAMECORE_ELFDAILYWAVECONFIG_METHOD_2_BB9704CA79448EEC_OFFSET UNITYSDK_OFFSET(0x1D058220)
#define RPG_GAMECORE_ELFDAILYWAVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D058320)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfDailyWaveConfig_TypeDefinitionIndex = 18264;
