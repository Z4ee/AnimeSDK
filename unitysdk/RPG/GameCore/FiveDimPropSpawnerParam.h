...
#define RPG_GAMECORE_FIVEDIMPROPSPAWNERPARAM_METHOD_2_3598B59837640DC5_OFFSET UNITYSDK_OFFSET(0x19750EE0)
#define RPG_GAMECORE_FIVEDIMPROPSPAWNERPARAM_METHOD_2_D2620691D63D49DA_OFFSET UNITYSDK_OFFSET(0x197506A0)
#define RPG_GAMECORE_FIVEDIMPROPSPAWNERPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x19750F40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimPropSpawnerParam_TypeDefinitionIndex = 17669;
