...
#define RPG_GAMECORE_FIVEDIMPROPSPAWNERPARAM_METHOD_2_3598B59837640DC5_OFFSET UNITYSDK_OFFSET(0x1BEAD280)
#define RPG_GAMECORE_FIVEDIMPROPSPAWNERPARAM_METHOD_2_D2620691D63D49DA_OFFSET UNITYSDK_OFFSET(0x1BEACA40)
#define RPG_GAMECORE_FIVEDIMPROPSPAWNERPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEA23D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimPropSpawnerParam_TypeDefinitionIndex = 17843;
