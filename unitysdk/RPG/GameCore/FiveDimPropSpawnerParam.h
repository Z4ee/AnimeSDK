...
#define RPG_GAMECORE_FIVEDIMPROPSPAWNERPARAM_METHOD_2_3598B59837640DC5_OFFSET UNITYSDK_OFFSET(0x1D875790)
#define RPG_GAMECORE_FIVEDIMPROPSPAWNERPARAM_METHOD_2_D2620691D63D49DA_OFFSET UNITYSDK_OFFSET(0x1D874F50)
#define RPG_GAMECORE_FIVEDIMPROPSPAWNERPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D85A980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimPropSpawnerParam_TypeDefinitionIndex = 18363;
