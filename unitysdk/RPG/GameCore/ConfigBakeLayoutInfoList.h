...
#define RPG_GAMECORE_CONFIGBAKELAYOUTINFOLIST_METHOD_2_00736BBB01AACE78_OFFSET UNITYSDK_OFFSET(0x19672F20)
#define RPG_GAMECORE_CONFIGBAKELAYOUTINFOLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x19672FE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConfigBakeLayoutInfoList_TypeDefinitionIndex = 15626;
