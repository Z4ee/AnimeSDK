...
#define RPG_GAMECORE_CONFIGBAKELAYOUTINFOLIST_METHOD_2_00736BBB01AACE78_OFFSET UNITYSDK_OFFSET(0x1CFF8C10)
#define RPG_GAMECORE_CONFIGBAKELAYOUTINFOLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFF8CD0)
