...
#define RPG_GAMECORE_ST_BYFOUNDSMARTOBJECT_METHOD_4_30846F98C39F0090_OFFSET UNITYSDK_OFFSET(0x17693270)
#define RPG_GAMECORE_ST_BYFOUNDSMARTOBJECT_METHOD_4_3AC28F1AC2D3DCEA_OFFSET UNITYSDK_OFFSET(0x176931A0)
#define RPG_GAMECORE_ST_BYFOUNDSMARTOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x17693220)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_ByFoundSmartObject_TypeDefinitionIndex = 18368;
