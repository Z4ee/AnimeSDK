...
#define RPG_GAMECORE_ST_BYFOUNDSMARTOBJECT_METHOD_4_27C0A1ACF2AD2246_OFFSET UNITYSDK_OFFSET(0x1D4C3630)
#define RPG_GAMECORE_ST_BYFOUNDSMARTOBJECT_METHOD_4_30846F98C39F0090_OFFSET UNITYSDK_OFFSET(0x1D4C34F0)
#define RPG_GAMECORE_ST_BYFOUNDSMARTOBJECT_METHOD_4_5C7477FE122D64BB_OFFSET UNITYSDK_OFFSET(0x1D4C3660)
#define RPG_GAMECORE_ST_BYFOUNDSMARTOBJECT_METHOD_4_BDEC572DD6A6A453_OFFSET UNITYSDK_OFFSET(0x1D4C34B0)
#define RPG_GAMECORE_ST_BYFOUNDSMARTOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4C34E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_ByFoundSmartObject_TypeDefinitionIndex = 19856;
