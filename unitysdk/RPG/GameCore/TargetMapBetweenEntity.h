...
#define RPG_GAMECORE_TARGETMAPBETWEENENTITY_METHOD_3_32689386B9330DC7_OFFSET UNITYSDK_OFFSET(0x1D5B28E0)
#define RPG_GAMECORE_TARGETMAPBETWEENENTITY_METHOD_3_49B0D05DE5CA543C_OFFSET UNITYSDK_OFFSET(0x1D5B29E0)
#define RPG_GAMECORE_TARGETMAPBETWEENENTITY_METHOD_3_93EC175E71EFBC56_OFFSET UNITYSDK_OFFSET(0x1D5B2980)
#define RPG_GAMECORE_TARGETMAPBETWEENENTITY_METHOD_3_C8BD60CC28903178_OFFSET UNITYSDK_OFFSET(0x1D5B2A20)
#define RPG_GAMECORE_TARGETMAPBETWEENENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5B2970)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapBetweenEntity_TypeDefinitionIndex = 23753;
