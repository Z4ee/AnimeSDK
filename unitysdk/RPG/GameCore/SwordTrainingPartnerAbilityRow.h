...
#define RPG_GAMECORE_SWORDTRAININGPARTNERABILITYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1779DF50)
#define RPG_GAMECORE_SWORDTRAININGPARTNERABILITYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1779E2A0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 PartnerAbilityID; // 0x3C
