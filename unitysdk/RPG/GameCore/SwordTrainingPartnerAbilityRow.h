...
#define RPG_GAMECORE_SWORDTRAININGPARTNERABILITYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B43ECC0)
#define RPG_GAMECORE_SWORDTRAININGPARTNERABILITYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B43F000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwordTrainingPartnerAbilityRow_TypeDefinitionIndex = 11962;
	...
	public:
		...
		::RPG::Client::TextID AbilityDesc; // 0x38
		::System::UInt32 Rare; // 0x48
		::System::UInt32 PartnerAbilityID; // 0x4C
