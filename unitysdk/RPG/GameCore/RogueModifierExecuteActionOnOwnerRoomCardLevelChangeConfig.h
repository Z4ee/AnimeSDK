...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONOWNERROOMCARDLEVELCHANGECONFIG_METHOD_3_2DD8337F63DE6FE8_OFFSET UNITYSDK_OFFSET(0x1CFC08C0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONOWNERROOMCARDLEVELCHANGECONFIG_METHOD_3_A4842D4ABB22D524_OFFSET UNITYSDK_OFFSET(0x1CFC0910)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONOWNERROOMCARDLEVELCHANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFC0900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnOwnerRoomCardLevelChangeConfig_TypeDefinitionIndex = 16976;
