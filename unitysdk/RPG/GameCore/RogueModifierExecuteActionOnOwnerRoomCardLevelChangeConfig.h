...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONOWNERROOMCARDLEVELCHANGECONFIG_METHOD_3_405FD158A7384D2D_OFFSET UNITYSDK_OFFSET(0x18D3D9B0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONOWNERROOMCARDLEVELCHANGECONFIG_METHOD_3_A4842D4ABB22D524_OFFSET UNITYSDK_OFFSET(0x18D3DA80)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONOWNERROOMCARDLEVELCHANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D3DA30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnOwnerRoomCardLevelChangeConfig_TypeDefinitionIndex = 16799;
