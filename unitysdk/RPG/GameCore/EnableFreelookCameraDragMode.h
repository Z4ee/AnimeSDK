...
#define RPG_GAMECORE_ENABLEFREELOOKCAMERADRAGMODE_METHOD_3_4C8CDD76ED0D6A0A_OFFSET UNITYSDK_OFFSET(0x188A5C40)
#define RPG_GAMECORE_ENABLEFREELOOKCAMERADRAGMODE_METHOD_3_92FAB2D29A3D7CCD_OFFSET UNITYSDK_OFFSET(0x188A5BC0)
#define RPG_GAMECORE_ENABLEFREELOOKCAMERADRAGMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x188A5C10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnableFreelookCameraDragMode_TypeDefinitionIndex = 19813;
