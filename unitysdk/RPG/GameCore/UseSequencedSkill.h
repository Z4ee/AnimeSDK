...
#define RPG_GAMECORE_USESEQUENCEDSKILL_METHOD_3_6B76359F7C4F6A4C_OFFSET UNITYSDK_OFFSET(0x1D2B44F0)
#define RPG_GAMECORE_USESEQUENCEDSKILL_METHOD_3_8A2DF3D4EEF1CF89_OFFSET UNITYSDK_OFFSET(0x1D2B4420)
#define RPG_GAMECORE_USESEQUENCEDSKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2B44E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UseSequencedSkill_TypeDefinitionIndex = 22187;
