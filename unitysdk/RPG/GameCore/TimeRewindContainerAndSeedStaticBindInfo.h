...
#define RPG_GAMECORE_TIMEREWINDCONTAINERANDSEEDSTATICBINDINFO_METHOD_2_4B1D339A5BCD2F69_OFFSET UNITYSDK_OFFSET(0x19DE5B10)
#define RPG_GAMECORE_TIMEREWINDCONTAINERANDSEEDSTATICBINDINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19DE5D00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TimeRewindContainerAndSeedStaticBindInfo_TypeDefinitionIndex = 15769;
