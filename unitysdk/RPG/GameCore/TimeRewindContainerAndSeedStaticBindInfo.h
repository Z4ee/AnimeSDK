...
#define RPG_GAMECORE_TIMEREWINDCONTAINERANDSEEDSTATICBINDINFO_METHOD_2_4B1D339A5BCD2F69_OFFSET UNITYSDK_OFFSET(0x1D5CF830)
#define RPG_GAMECORE_TIMEREWINDCONTAINERANDSEEDSTATICBINDINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5CFA20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TimeRewindContainerAndSeedStaticBindInfo_TypeDefinitionIndex = 16419;
