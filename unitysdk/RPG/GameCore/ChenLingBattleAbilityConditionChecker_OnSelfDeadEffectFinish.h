...
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_ONSELFDEADEFFECTFINISH_METHOD_3_29211F6AC650F510_OFFSET UNITYSDK_OFFSET(0x1961B420)
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_ONSELFDEADEFFECTFINISH_METHOD_3_DA2677CAA66FD015_OFFSET UNITYSDK_OFFSET(0x1961B380)
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_ONSELFDEADEFFECTFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1961B410)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleAbilityConditionChecker_OnSelfDeadEffectFinish_TypeDefinitionIndex = 14953;
