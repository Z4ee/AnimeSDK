...
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_ONSELFDEADEFFECTFINISH_METHOD_3_29211F6AC650F510_OFFSET UNITYSDK_OFFSET(0x187DD9D0)
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_ONSELFDEADEFFECTFINISH_METHOD_3_DA2677CAA66FD015_OFFSET UNITYSDK_OFFSET(0x187DD930)
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_ONSELFDEADEFFECTFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x187DD9C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleAbilityConditionChecker_OnSelfDeadEffectFinish_TypeDefinitionIndex = 14890;
