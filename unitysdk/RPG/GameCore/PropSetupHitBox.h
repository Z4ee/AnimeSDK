...
#define RPG_GAMECORE_PROPSETUPHITBOX_METHOD_3_038E2E800516BD94_OFFSET UNITYSDK_OFFSET(0x17525FE0)
#define RPG_GAMECORE_PROPSETUPHITBOX_METHOD_3_2BE445F52EE76510_OFFSET UNITYSDK_OFFSET(0x17526140)
#define RPG_GAMECORE_PROPSETUPHITBOX__CTOR_OFFSET UNITYSDK_OFFSET(0x175260A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropSetupHitBox_TypeDefinitionIndex = 18686;
