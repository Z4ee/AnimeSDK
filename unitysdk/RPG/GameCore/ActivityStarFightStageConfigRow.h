...
#define RPG_GAMECORE_ACTIVITYSTARFIGHTSTAGECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16F14C40)
#define RPG_GAMECORE_ACTIVITYSTARFIGHTSTAGECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16F14E70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityStarFightStageConfigRow_TypeDefinitionIndex = 11313;
	...
	public:
		...
		::System::UInt32 UnlockQuest; // 0x24
