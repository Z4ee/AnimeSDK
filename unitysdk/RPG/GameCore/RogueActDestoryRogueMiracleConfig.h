...
#define RPG_GAMECORE_ROGUEACTDESTORYROGUEMIRACLECONFIG_METHOD_6_3A3FBAE20A24479D_OFFSET UNITYSDK_OFFSET(0x18CBFEE0)
#define RPG_GAMECORE_ROGUEACTDESTORYROGUEMIRACLECONFIG_METHOD_6_8BDC98B45D0ED940_OFFSET UNITYSDK_OFFSET(0x18CBFCC0)
#define RPG_GAMECORE_ROGUEACTDESTORYROGUEMIRACLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CBFE00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActDestoryRogueMiracleConfig_TypeDefinitionIndex = 18647;
