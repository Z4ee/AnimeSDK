...
#define RPG_GAMECORE_ACTIONBACKUP2CONFIG_METHOD_4_467ACD5E2938ABD6_OFFSET UNITYSDK_OFFSET(0x16E98300)
#define RPG_GAMECORE_ACTIONBACKUP2CONFIG_METHOD_4_F93BB412376A1DBF_OFFSET UNITYSDK_OFFSET(0x16E98230)
#define RPG_GAMECORE_ACTIONBACKUP2CONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16E982B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActionBackup2Config_TypeDefinitionIndex = 15623;
