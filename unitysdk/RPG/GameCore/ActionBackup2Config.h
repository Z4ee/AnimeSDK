...
#define RPG_GAMECORE_ACTIONBACKUP2CONFIG_METHOD_4_467ACD5E2938ABD6_OFFSET UNITYSDK_OFFSET(0x1B9FD010)
#define RPG_GAMECORE_ACTIONBACKUP2CONFIG_METHOD_4_FC99D83B0F45E37A_OFFSET UNITYSDK_OFFSET(0x1B9FCFC0)
#define RPG_GAMECORE_ACTIONBACKUP2CONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9FD000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActionBackup2Config_TypeDefinitionIndex = 16378;
