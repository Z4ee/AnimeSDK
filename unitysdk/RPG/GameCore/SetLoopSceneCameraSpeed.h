...
#define RPG_GAMECORE_SETLOOPSCENECAMERASPEED_METHOD_3_39B61FC8046D0CC4_OFFSET UNITYSDK_OFFSET(0x19C547B0)
#define RPG_GAMECORE_SETLOOPSCENECAMERASPEED_METHOD_3_C671CCD5A698A68E_OFFSET UNITYSDK_OFFSET(0x19C54830)
#define RPG_GAMECORE_SETLOOPSCENECAMERASPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x19C54800)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetLoopSceneCameraSpeed_TypeDefinitionIndex = 19292;
