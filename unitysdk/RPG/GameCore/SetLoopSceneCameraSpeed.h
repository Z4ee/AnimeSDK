...
#define RPG_GAMECORE_SETLOOPSCENECAMERASPEED_METHOD_3_0E897A5C1585F0D9_OFFSET UNITYSDK_OFFSET(0x1D504910)
#define RPG_GAMECORE_SETLOOPSCENECAMERASPEED_METHOD_3_C671CCD5A698A68E_OFFSET UNITYSDK_OFFSET(0x1D504950)
#define RPG_GAMECORE_SETLOOPSCENECAMERASPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x1D504940)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetLoopSceneCameraSpeed_TypeDefinitionIndex = 20194;
