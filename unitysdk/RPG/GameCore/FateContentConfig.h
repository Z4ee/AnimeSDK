...
#define RPG_GAMECORE_FATECONTENTCONFIG_METHOD_2_BF717740BF549F68_OFFSET UNITYSDK_OFFSET(0x1970FB30)
#define RPG_GAMECORE_FATECONTENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1970FBE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateContentConfig_TypeDefinitionIndex = 15795;
