...
#define RPG_GAMECORE_FATECONTENTCONFIG_METHOD_2_BF717740BF549F68_OFFSET UNITYSDK_OFFSET(0x188D2BB0)
#define RPG_GAMECORE_FATECONTENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x188D2C60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateContentConfig_TypeDefinitionIndex = 15740;
