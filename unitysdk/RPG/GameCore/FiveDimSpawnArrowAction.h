...
#define RPG_GAMECORE_FIVEDIMSPAWNARROWACTION_METHOD_3_6DFF692D8777714A_OFFSET UNITYSDK_OFFSET(0x1891E230)
#define RPG_GAMECORE_FIVEDIMSPAWNARROWACTION_METHOD_3_AA30613C2FEF2F3B_OFFSET UNITYSDK_OFFSET(0x1891E2A0)
#define RPG_GAMECORE_FIVEDIMSPAWNARROWACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1891E280)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSpawnArrowAction_TypeDefinitionIndex = 17794;
