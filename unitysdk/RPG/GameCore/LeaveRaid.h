...
#define RPG_GAMECORE_LEAVERAID_METHOD_3_80B023C55B789638_OFFSET UNITYSDK_OFFSET(0x18A39FF0)
#define RPG_GAMECORE_LEAVERAID_METHOD_3_F68A15C082FE5DAC_OFFSET UNITYSDK_OFFSET(0x18A39EE0)
#define RPG_GAMECORE_LEAVERAID__CTOR_OFFSET UNITYSDK_OFFSET(0x18A39FC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LeaveRaid_TypeDefinitionIndex = 20457;
