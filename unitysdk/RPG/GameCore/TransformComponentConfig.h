...
#define RPG_GAMECORE_TRANSFORMCOMPONENTCONFIG_METHOD_3_2C3CE1417EF56378_OFFSET UNITYSDK_OFFSET(0x1D53CCB0)
#define RPG_GAMECORE_TRANSFORMCOMPONENTCONFIG_METHOD_3_D5D7832C6C8DCF5D_OFFSET UNITYSDK_OFFSET(0x1D53CD50)
#define RPG_GAMECORE_TRANSFORMCOMPONENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D53CD40)
