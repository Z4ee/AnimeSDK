...
#define RPG_GAMECORE_TRANSFORMCOMPONENTCONFIG_METHOD_3_2C3CE1417EF56378_OFFSET UNITYSDK_OFFSET(0x178B3590)
#define RPG_GAMECORE_TRANSFORMCOMPONENTCONFIG_METHOD_3_D5D7832C6C8DCF5D_OFFSET UNITYSDK_OFFSET(0x178B3630)
#define RPG_GAMECORE_TRANSFORMCOMPONENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x178B3620)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TransformComponentConfig_TypeDefinitionIndex = 15163;
