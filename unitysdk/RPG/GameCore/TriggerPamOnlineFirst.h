...
#define RPG_GAMECORE_TRIGGERPAMONLINEFIRST_METHOD_3_2B54955ABC203EEE_OFFSET UNITYSDK_OFFSET(0x1B059F30)
#define RPG_GAMECORE_TRIGGERPAMONLINEFIRST_METHOD_3_A5001001DC08996B_OFFSET UNITYSDK_OFFSET(0x1B059E60)
#define RPG_GAMECORE_TRIGGERPAMONLINEFIRST__CTOR_OFFSET UNITYSDK_OFFSET(0x1B059F20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerPamOnlineFirst_TypeDefinitionIndex = 19251;
