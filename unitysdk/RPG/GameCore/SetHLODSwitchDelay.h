...
#define RPG_GAMECORE_SETHLODSWITCHDELAY_METHOD_3_8FB91A4D73AF0F1D_OFFSET UNITYSDK_OFFSET(0x1E82D940)
#define RPG_GAMECORE_SETHLODSWITCHDELAY_METHOD_3_F66B578072335838_OFFSET UNITYSDK_OFFSET(0x1E82D900)
#define RPG_GAMECORE_SETHLODSWITCHDELAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1E82D930)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetHLODSwitchDelay_TypeDefinitionIndex = 20279;
