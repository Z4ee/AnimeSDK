...
#define RPG_GAMECORE_SETHLODSWITCHDELAY_METHOD_3_6CB80C3FE3CD8584_OFFSET UNITYSDK_OFFSET(0x19C50CD0)
#define RPG_GAMECORE_SETHLODSWITCHDELAY_METHOD_3_8FB91A4D73AF0F1D_OFFSET UNITYSDK_OFFSET(0x19C50D50)
#define RPG_GAMECORE_SETHLODSWITCHDELAY__CTOR_OFFSET UNITYSDK_OFFSET(0x19C50D20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetHLODSwitchDelay_TypeDefinitionIndex = 19377;
