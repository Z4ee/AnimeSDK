...
#define RPG_GAMECORE_TARGETFETCHTRAILBLAZER_METHOD_4_77DAD0F287096B00_OFFSET UNITYSDK_OFFSET(0x177B8FB0)
#define RPG_GAMECORE_TARGETFETCHTRAILBLAZER_METHOD_4_CF2EB1595F9C95D2_OFFSET UNITYSDK_OFFSET(0x177C07C0)
#define RPG_GAMECORE_TARGETFETCHTRAILBLAZER__CTOR_OFFSET UNITYSDK_OFFSET(0x177B8F60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchTrailblazer_TypeDefinitionIndex = 22245;
