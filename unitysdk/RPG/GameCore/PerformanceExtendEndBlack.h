...
#define RPG_GAMECORE_PERFORMANCEEXTENDENDBLACK_METHOD_3_2E45EDF055055174_OFFSET UNITYSDK_OFFSET(0x1B4AE350)
#define RPG_GAMECORE_PERFORMANCEEXTENDENDBLACK_METHOD_3_8F808D41CF8FAF4F_OFFSET UNITYSDK_OFFSET(0x1B4AE300)
#define RPG_GAMECORE_PERFORMANCEEXTENDENDBLACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4AE340)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PerformanceExtendEndBlack_TypeDefinitionIndex = 21113;
