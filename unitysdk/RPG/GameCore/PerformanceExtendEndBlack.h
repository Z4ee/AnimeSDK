...
#define RPG_GAMECORE_PERFORMANCEEXTENDENDBLACK_METHOD_3_2E45EDF055055174_OFFSET UNITYSDK_OFFSET(0x199F3EC0)
#define RPG_GAMECORE_PERFORMANCEEXTENDENDBLACK_METHOD_3_E415AD2EDA120925_OFFSET UNITYSDK_OFFSET(0x199F3E30)
#define RPG_GAMECORE_PERFORMANCEEXTENDENDBLACK__CTOR_OFFSET UNITYSDK_OFFSET(0x199F3E90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PerformanceExtendEndBlack_TypeDefinitionIndex = 20698;
