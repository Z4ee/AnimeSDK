...
#define RPG_GAMECORE_PERFORMANCEEXTENDENDBLACK_METHOD_3_2E45EDF055055174_OFFSET UNITYSDK_OFFSET(0x1D421C50)
#define RPG_GAMECORE_PERFORMANCEEXTENDENDBLACK_METHOD_3_8F808D41CF8FAF4F_OFFSET UNITYSDK_OFFSET(0x1D421C00)
#define RPG_GAMECORE_PERFORMANCEEXTENDENDBLACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D421C40)
