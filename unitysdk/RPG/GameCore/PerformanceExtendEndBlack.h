...
#define RPG_GAMECORE_PERFORMANCEEXTENDENDBLACK_METHOD_3_2E45EDF055055174_OFFSET UNITYSDK_OFFSET(0x17497940)
#define RPG_GAMECORE_PERFORMANCEEXTENDENDBLACK_METHOD_3_E415AD2EDA120925_OFFSET UNITYSDK_OFFSET(0x174978B0)
#define RPG_GAMECORE_PERFORMANCEEXTENDENDBLACK__CTOR_OFFSET UNITYSDK_OFFSET(0x17497910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PerformanceExtendEndBlack_TypeDefinitionIndex = 20088;
