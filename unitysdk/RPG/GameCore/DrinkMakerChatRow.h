...
#define RPG_GAMECORE_DRINKMAKERCHATROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18882C80)
#define RPG_GAMECORE_DRINKMAKERCHATROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18883290)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DrinkMakerChatRow_TypeDefinitionIndex = 12460;
	...
	public:
		...
		::System::UInt32 ChatID; // 0x18
		::System::UInt32 SuccessNextChatID; // 0x1C
