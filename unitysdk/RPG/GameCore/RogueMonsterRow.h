...
#define RPG_GAMECORE_ROGUEMONSTERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1E536310)
#define RPG_GAMECORE_ROGUEMONSTERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1E537730)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::RPG::GameCore::RogueMonsterDropType MonsterDropType; // 0x10
