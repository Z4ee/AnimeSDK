...
#define RPG_GAMECORE_SETTARGETUNIQUENAME_METHOD_3_C0262C5412C2F4B7_OFFSET UNITYSDK_OFFSET(0x18E46760)
#define RPG_GAMECORE_SETTARGETUNIQUENAME_METHOD_3_E7974EC4C0EA02B7_OFFSET UNITYSDK_OFFSET(0x18E46830)
#define RPG_GAMECORE_SETTARGETUNIQUENAME__CTOR_OFFSET UNITYSDK_OFFSET(0x18E467E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetTargetUniqueName_TypeDefinitionIndex = 22141;
