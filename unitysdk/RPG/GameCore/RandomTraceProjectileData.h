...
#define RPG_GAMECORE_RANDOMTRACEPROJECTILEDATA_METHOD_3_B1B872F7DE4CEE53_OFFSET UNITYSDK_OFFSET(0x1B9B7DC0)
#define RPG_GAMECORE_RANDOMTRACEPROJECTILEDATA_METHOD_3_D474125E3DA5F900_OFFSET UNITYSDK_OFFSET(0x1B9B7D60)
#define RPG_GAMECORE_RANDOMTRACEPROJECTILEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9B7DB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RandomTraceProjectileData_TypeDefinitionIndex = 15053;
