...
#define RPG_GAMECORE_RANDOMTRACEPROJECTILEDATA_METHOD_3_B1B872F7DE4CEE53_OFFSET UNITYSDK_OFFSET(0x1D19AA10)
#define RPG_GAMECORE_RANDOMTRACEPROJECTILEDATA_METHOD_3_D474125E3DA5F900_OFFSET UNITYSDK_OFFSET(0x1D19A9B0)
#define RPG_GAMECORE_RANDOMTRACEPROJECTILEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1D19AA00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RandomTraceProjectileData_TypeDefinitionIndex = 15489;
