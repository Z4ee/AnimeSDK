...
#define RPG_GAMECORE_ROGUENOUSAEONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1E5385A0)
#define RPG_GAMECORE_ROGUENOUSAEONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1E538DC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueNousAeonRow_TypeDefinitionIndex = 14754;
	...
	public:
		...
		::System::UInt32 BattleEventEnhanceBuffGroup; // 0x2C
		...
		::System::UInt32 RogueBuffType; // 0x44
