...
#define RPG_GAMECORE_TARGETFETCHNONE_METHOD_4_0791B0CA0C203F50_OFFSET UNITYSDK_OFFSET(0x177BF800)
#define RPG_GAMECORE_TARGETFETCHNONE_METHOD_4_B5E3E3391D7DBBA2_OFFSET UNITYSDK_OFFSET(0x177B6DF0)
#define RPG_GAMECORE_TARGETFETCHNONE__CTOR_OFFSET UNITYSDK_OFFSET(0x177B6DA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchNone_TypeDefinitionIndex = 22186;
