...
#define RPG_GAMECORE_ROGUEACTCHANGELINEUPMPCONFIG_METHOD_6_F1CD67A79384EA32_OFFSET UNITYSDK_OFFSET(0x1D3B6D30)
#define RPG_GAMECORE_ROGUEACTCHANGELINEUPMPCONFIG_METHOD_6_FA2528940E39AE4E_OFFSET UNITYSDK_OFFSET(0x1D3B6D80)
#define RPG_GAMECORE_ROGUEACTCHANGELINEUPMPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3B6D70)
