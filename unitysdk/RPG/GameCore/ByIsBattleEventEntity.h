...
#define RPG_GAMECORE_BYISBATTLEEVENTENTITY_METHOD_4_354F48C73F35BC96_OFFSET UNITYSDK_OFFSET(0x1BBEEF30)
#define RPG_GAMECORE_BYISBATTLEEVENTENTITY_METHOD_4_391CCB3B0F462710_OFFSET UNITYSDK_OFFSET(0x1BBEED60)
#define RPG_GAMECORE_BYISBATTLEEVENTENTITY_METHOD_4_87909B2851A76DC0_OFFSET UNITYSDK_OFFSET(0x1BBEEF60)
#define RPG_GAMECORE_BYISBATTLEEVENTENTITY_METHOD_4_948E7786405A67FD_OFFSET UNITYSDK_OFFSET(0x1BBEED20)
#define RPG_GAMECORE_BYISBATTLEEVENTENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBEED50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsBattleEventEntity_TypeDefinitionIndex = 22773;
