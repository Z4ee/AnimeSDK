...
#define RPG_GAMECORE_BYISBATTLEEVENTENTITY_METHOD_4_391CCB3B0F462710_OFFSET UNITYSDK_OFFSET(0x1874E550)
#define RPG_GAMECORE_BYISBATTLEEVENTENTITY_METHOD_4_9422C2DE2F08E0F8_OFFSET UNITYSDK_OFFSET(0x1874E480)
#define RPG_GAMECORE_BYISBATTLEEVENTENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1874E500)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsBattleEventEntity_TypeDefinitionIndex = 21955;
