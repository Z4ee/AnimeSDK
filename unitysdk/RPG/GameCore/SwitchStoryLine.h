...
#define RPG_GAMECORE_SWITCHSTORYLINE_METHOD_3_41D97AE6CCE88BE3_OFFSET UNITYSDK_OFFSET(0x19CE00A0)
#define RPG_GAMECORE_SWITCHSTORYLINE_METHOD_3_FC2EB1EE424E848A_OFFSET UNITYSDK_OFFSET(0x19CE0120)
#define RPG_GAMECORE_SWITCHSTORYLINE__CTOR_OFFSET UNITYSDK_OFFSET(0x19CE00F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchStoryLine_TypeDefinitionIndex = 19622;
