...
#define RPG_GAMECORE_SWITCHSTORYLINE_METHOD_3_3CEA98B4C6BC20FB_OFFSET UNITYSDK_OFFSET(0x1E153940)
#define RPG_GAMECORE_SWITCHSTORYLINE_METHOD_3_FC2EB1EE424E848A_OFFSET UNITYSDK_OFFSET(0x1E153980)
#define RPG_GAMECORE_SWITCHSTORYLINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E153970)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchStoryLine_TypeDefinitionIndex = 20528;
