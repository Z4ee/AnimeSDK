...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDBATTLEMONSTERCONFIG_METHOD_3_973585D03D4EB9A6_OFFSET UNITYSDK_OFFSET(0x197E7F30)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDBATTLEMONSTERCONFIG_METHOD_3_9FB32B9523E9C81F_OFFSET UNITYSDK_OFFSET(0x197E8000)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDBATTLEMONSTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197E7FB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierAddBattleMonsterConfig_TypeDefinitionIndex = 18398;
