...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDBATTLEMONSTERCONFIG_METHOD_3_973585D03D4EB9A6_OFFSET UNITYSDK_OFFSET(0x1725FE00)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDBATTLEMONSTERCONFIG_METHOD_3_9FB32B9523E9C81F_OFFSET UNITYSDK_OFFSET(0x1725FED0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDBATTLEMONSTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1725FE80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierAddBattleMonsterConfig_TypeDefinitionIndex = 17808;
