...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDBATTLEMONSTERCONFIG_METHOD_3_79684773B0F7069B_OFFSET UNITYSDK_OFFSET(0x1C5CFA30)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDBATTLEMONSTERCONFIG_METHOD_3_9FB32B9523E9C81F_OFFSET UNITYSDK_OFFSET(0x1C5CFA80)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDBATTLEMONSTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5CFA70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierAddBattleMonsterConfig_TypeDefinitionIndex = 18646;
