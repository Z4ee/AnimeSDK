...
#define RPG_GAMECORE_ADVENTUREBYNPCMONSTERPURPOSETYPE_METHOD_4_28048AB518F2CC5E_OFFSET UNITYSDK_OFFSET(0x18671060)
#define RPG_GAMECORE_ADVENTUREBYNPCMONSTERPURPOSETYPE_METHOD_4_E0913CDA9CD9579E_OFFSET UNITYSDK_OFFSET(0x18670F90)
#define RPG_GAMECORE_ADVENTUREBYNPCMONSTERPURPOSETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x18671010)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureByNPCMonsterPurposeType_TypeDefinitionIndex = 19161;
