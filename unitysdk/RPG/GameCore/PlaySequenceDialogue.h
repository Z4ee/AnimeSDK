...
#define RPG_GAMECORE_PLAYSEQUENCEDIALOGUE_METHOD_3_2D064E5C9B1D9B4E_OFFSET UNITYSDK_OFFSET(0x18C11F60)
#define RPG_GAMECORE_PLAYSEQUENCEDIALOGUE_METHOD_3_65FBE162EA2A1D7F_OFFSET UNITYSDK_OFFSET(0x18C11FE0)
#define RPG_GAMECORE_PLAYSEQUENCEDIALOGUE__CTOR_OFFSET UNITYSDK_OFFSET(0x18C11FB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlaySequenceDialogue_TypeDefinitionIndex = 20100;
