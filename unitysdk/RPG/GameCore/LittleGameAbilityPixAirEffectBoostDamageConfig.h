...
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTBOOSTDAMAGECONFIG_METHOD_3_347745A6AA4789C5_OFFSET UNITYSDK_OFFSET(0x198939F0)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTBOOSTDAMAGECONFIG_METHOD_3_B16D413EB058AC79_OFFSET UNITYSDK_OFFSET(0x19893AC0)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTBOOSTDAMAGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19893AB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityPixAirEffectBoostDamageConfig_TypeDefinitionIndex = 20179;
