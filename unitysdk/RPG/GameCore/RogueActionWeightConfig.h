...
#define RPG_GAMECORE_ROGUEACTIONWEIGHTCONFIG_METHOD_2_803A4E060E834D6A_OFFSET UNITYSDK_OFFSET(0x19B0B6F0)
#define RPG_GAMECORE_ROGUEACTIONWEIGHTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B0B730)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActionWeightConfig_TypeDefinitionIndex = 18667;
