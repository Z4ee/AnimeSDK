...
#define RPG_GAMECORE_ROGUEACTPERSONASPECIALACTSTYLERANDOMCONFIG_METHOD_6_1C81B57DA70C3CA9_OFFSET UNITYSDK_OFFSET(0x1EE88200)
#define RPG_GAMECORE_ROGUEACTPERSONASPECIALACTSTYLERANDOMCONFIG_METHOD_6_DDEDAE2FE5AA822D_OFFSET UNITYSDK_OFFSET(0x1EE88250)
#define RPG_GAMECORE_ROGUEACTPERSONASPECIALACTSTYLERANDOMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EE88240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaSpecialActStyleRandomConfig_TypeDefinitionIndex = 19549;
