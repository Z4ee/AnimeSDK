...
#define RPG_GAMECORE_ROGUEACTPERSONASPECIALACTSTYLERANDOMCONFIG_METHOD_6_6CC99B027B14F210_OFFSET UNITYSDK_OFFSET(0x18CD0230)
#define RPG_GAMECORE_ROGUEACTPERSONASPECIALACTSTYLERANDOMCONFIG_METHOD_6_DDEDAE2FE5AA822D_OFFSET UNITYSDK_OFFSET(0x18CD0450)
#define RPG_GAMECORE_ROGUEACTPERSONASPECIALACTSTYLERANDOMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CD0370)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaSpecialActStyleRandomConfig_TypeDefinitionIndex = 18773;
