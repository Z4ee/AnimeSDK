...
#define RPG_GAMECORE_SETDYNAMICENTITYPARAM_METHOD_3_768643E49C17340C_OFFSET UNITYSDK_OFFSET(0x1D4EB270)
#define RPG_GAMECORE_SETDYNAMICENTITYPARAM_METHOD_3_E473DA5A0230B331_OFFSET UNITYSDK_OFFSET(0x1D4EB2B0)
#define RPG_GAMECORE_SETDYNAMICENTITYPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4EB2A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicEntityParam_TypeDefinitionIndex = 22417;
