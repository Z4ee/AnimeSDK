...
#define RPG_GAMECORE_SETDYNAMICENTITYPARAM_METHOD_3_011D1A4769FE1F22_OFFSET UNITYSDK_OFFSET(0x176B2AF0)
#define RPG_GAMECORE_SETDYNAMICENTITYPARAM_METHOD_3_E473DA5A0230B331_OFFSET UNITYSDK_OFFSET(0x176B2B70)
#define RPG_GAMECORE_SETDYNAMICENTITYPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x176B2B40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicEntityParam_TypeDefinitionIndex = 20852;
