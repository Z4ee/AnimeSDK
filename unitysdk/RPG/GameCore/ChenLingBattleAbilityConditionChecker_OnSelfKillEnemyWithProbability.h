...
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_ONSELFKILLENEMYWITHPROBABILITY_METHOD_3_7C77C183AC7370B8_OFFSET UNITYSDK_OFFSET(0x1C3758D0)
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_ONSELFKILLENEMYWITHPROBABILITY_METHOD_3_B5647CBFAC08D214_OFFSET UNITYSDK_OFFSET(0x1C375930)
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_ONSELFKILLENEMYWITHPROBABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1C375920)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleAbilityConditionChecker_OnSelfKillEnemyWithProbability_TypeDefinitionIndex = 15114;
