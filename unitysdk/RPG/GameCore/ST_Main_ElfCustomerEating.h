...
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMEREATING_METHOD_4_596D07AA77A18994_OFFSET UNITYSDK_OFFSET(0x19C17540)
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMEREATING_METHOD_4_AB110F2BA74A05AB_OFFSET UNITYSDK_OFFSET(0x19BFF160)
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMEREATING__CTOR_OFFSET UNITYSDK_OFFSET(0x19BFF110)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_ElfCustomerEating_TypeDefinitionIndex = 20335;
