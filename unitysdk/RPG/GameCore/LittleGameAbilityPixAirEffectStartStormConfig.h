...
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTSTARTSTORMCONFIG_METHOD_3_1CF398776644FA49_OFFSET UNITYSDK_OFFSET(0x1B094610)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTSTARTSTORMCONFIG_METHOD_3_3DA18C647B8FB2F4_OFFSET UNITYSDK_OFFSET(0x1B094570)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTSTARTSTORMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B094600)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityPixAirEffectStartStormConfig_TypeDefinitionIndex = 20566;
