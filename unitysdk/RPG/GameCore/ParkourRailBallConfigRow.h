...
#define RPG_GAMECORE_PARKOURRAILBALLCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D30C530)
#define RPG_GAMECORE_PARKOURRAILBALLCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D30C930)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ParkourRailBallConfigRow_TypeDefinitionIndex = 12018;
	...
	public:
		...
		::System::Single SkillChargeDisplay; // 0x30
		::System::UInt32 UpgradeBallID; // 0x34
		::RPG::Client::TextID Name; // 0x38
		::System::Single StabilityDisplay; // 0x48
