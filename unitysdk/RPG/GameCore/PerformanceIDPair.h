...
#define RPG_GAMECORE_PERFORMANCEIDPAIR_METHOD_2_6866484A1AEA1050_OFFSET UNITYSDK_OFFSET(0x17497A50)
#define RPG_GAMECORE_PERFORMANCEIDPAIR__CTOR_OFFSET UNITYSDK_OFFSET(0x17497B50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PerformanceIDPair_TypeDefinitionIndex = 17454;
