...
#define RPG_GAMECORE_PERFORMANCEIDPAIR_METHOD_2_6866484A1AEA1050_OFFSET UNITYSDK_OFFSET(0x18BE2010)
#define RPG_GAMECORE_PERFORMANCEIDPAIR__CTOR_OFFSET UNITYSDK_OFFSET(0x18BE2110)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PerformanceIDPair_TypeDefinitionIndex = 18063;
