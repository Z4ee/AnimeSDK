...
#define RPG_GAMECORE_PERFORMANCEIDPAIR_METHOD_2_6866484A1AEA1050_OFFSET UNITYSDK_OFFSET(0x1B4AE460)
#define RPG_GAMECORE_PERFORMANCEIDPAIR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4AE560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PerformanceIDPair_TypeDefinitionIndex = 18291;
