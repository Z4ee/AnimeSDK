...
#define RPG_GAMECORE_CHIMERADUELSELECTIONCOUNTVALUEGETTER_METHOD_3_C7E78075178E19D3_OFFSET UNITYSDK_OFFSET(0x1C2479C0)
#define RPG_GAMECORE_CHIMERADUELSELECTIONCOUNTVALUEGETTER_METHOD_3_FE51ACAECA0CB87F_OFFSET UNITYSDK_OFFSET(0x1C2478F0)
#define RPG_GAMECORE_CHIMERADUELSELECTIONCOUNTVALUEGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2479B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelSelectionCountValueGetter_TypeDefinitionIndex = 15390;
