...
#define RPG_GAMECORE_CHIMERADUELSELECTIONCOUNTVALUEGETTER_METHOD_3_C7E78075178E19D3_OFFSET UNITYSDK_OFFSET(0x18804C80)
#define RPG_GAMECORE_CHIMERADUELSELECTIONCOUNTVALUEGETTER_METHOD_3_FE51ACAECA0CB87F_OFFSET UNITYSDK_OFFSET(0x18804BB0)
#define RPG_GAMECORE_CHIMERADUELSELECTIONCOUNTVALUEGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x18804C70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelSelectionCountValueGetter_TypeDefinitionIndex = 15165;
