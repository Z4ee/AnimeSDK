...
#define RPG_GAMECORE_CHIMERADUELSELECTIONCOUNTVALUEGETTER_METHOD_3_C7E78075178E19D3_OFFSET UNITYSDK_OFFSET(0x170A56D0)
#define RPG_GAMECORE_CHIMERADUELSELECTIONCOUNTVALUEGETTER_METHOD_3_FE51ACAECA0CB87F_OFFSET UNITYSDK_OFFSET(0x170A5600)
#define RPG_GAMECORE_CHIMERADUELSELECTIONCOUNTVALUEGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x170A56C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelSelectionCountValueGetter_TypeDefinitionIndex = 14695;
