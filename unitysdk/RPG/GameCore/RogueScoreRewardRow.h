...
#define RPG_GAMECORE_ROGUESCOREREWARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1BB6A120)
#define RPG_GAMECORE_ROGUESCOREREWARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB6A800)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueScoreRewardRow_TypeDefinitionIndex = 14351;
