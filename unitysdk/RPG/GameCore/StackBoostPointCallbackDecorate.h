...
#define RPG_GAMECORE_STACKBOOSTPOINTCALLBACKDECORATE_METHOD_3_CE0373ED0B8A6FED_OFFSET UNITYSDK_OFFSET(0x18E85EA0)
#define RPG_GAMECORE_STACKBOOSTPOINTCALLBACKDECORATE_METHOD_3_D95A4DA784187914_OFFSET UNITYSDK_OFFSET(0x18E85F30)
#define RPG_GAMECORE_STACKBOOSTPOINTCALLBACKDECORATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E85F00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StackBoostPointCallbackDecorate_TypeDefinitionIndex = 22523;
