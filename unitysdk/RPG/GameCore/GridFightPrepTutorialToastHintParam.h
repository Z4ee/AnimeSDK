...
#define RPG_GAMECORE_GRIDFIGHTPREPTUTORIALTOASTHINTPARAM_METHOD_2_9289CB7DB2498F62_OFFSET UNITYSDK_OFFSET(0x19802F00)
#define RPG_GAMECORE_GRIDFIGHTPREPTUTORIALTOASTHINTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x19803910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightPrepTutorialToastHintParam_TypeDefinitionIndex = 18843;
