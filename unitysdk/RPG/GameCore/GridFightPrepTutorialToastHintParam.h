...
#define RPG_GAMECORE_GRIDFIGHTPREPTUTORIALTOASTHINTPARAM_METHOD_2_9289CB7DB2498F62_OFFSET UNITYSDK_OFFSET(0x1D15F9C0)
#define RPG_GAMECORE_GRIDFIGHTPREPTUTORIALTOASTHINTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1603D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightPrepTutorialToastHintParam_TypeDefinitionIndex = 19734;
