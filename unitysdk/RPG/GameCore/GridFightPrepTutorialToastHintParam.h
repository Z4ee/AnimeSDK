...
#define RPG_GAMECORE_GRIDFIGHTPREPTUTORIALTOASTHINTPARAM_METHOD_2_9289CB7DB2498F62_OFFSET UNITYSDK_OFFSET(0x1727B9F0)
#define RPG_GAMECORE_GRIDFIGHTPREPTUTORIALTOASTHINTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1727C400)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightPrepTutorialToastHintParam_TypeDefinitionIndex = 18235;
