...
#define RPG_GAMECORE_ROGUEACTRANDOMGETROGUEMAGICUNITCONFIG_METHOD_6_7AB926F88ABF9A2F_OFFSET UNITYSDK_OFFSET(0x175C4FB0)
#define RPG_GAMECORE_ROGUEACTRANDOMGETROGUEMAGICUNITCONFIG_METHOD_6_D0574CF26355FF1A_OFFSET UNITYSDK_OFFSET(0x175C51D0)
#define RPG_GAMECORE_ROGUEACTRANDOMGETROGUEMAGICUNITCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175C50F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActRandomGetRogueMagicUnitConfig_TypeDefinitionIndex = 18034;
