...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_WRITECUSTOMVALUE_MODIFIERDATA_METHOD_3_0B4D826A69BEC1BD_OFFSET UNITYSDK_OFFSET(0x1D038C20)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_WRITECUSTOMVALUE_MODIFIERDATA_METHOD_3_457E34C1720C810F_OFFSET UNITYSDK_OFFSET(0x1D038C80)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_WRITECUSTOMVALUE_MODIFIERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1D038C70)
