...
#define RPG_GAMECORE_ADDTIMELINEENTITY_METHOD_3_3BA51F417196C5C7_OFFSET UNITYSDK_OFFSET(0x16F22270)
#define RPG_GAMECORE_ADDTIMELINEENTITY_METHOD_3_F1D013277AC92044_OFFSET UNITYSDK_OFFSET(0x16F222F0)
#define RPG_GAMECORE_ADDTIMELINEENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x16F222C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddTimelineEntity_TypeDefinitionIndex = 18944;
