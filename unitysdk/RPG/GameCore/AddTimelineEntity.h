...
#define RPG_GAMECORE_ADDTIMELINEENTITY_METHOD_3_3BA51F417196C5C7_OFFSET UNITYSDK_OFFSET(0x19413470)
#define RPG_GAMECORE_ADDTIMELINEENTITY_METHOD_3_F1D013277AC92044_OFFSET UNITYSDK_OFFSET(0x194134F0)
#define RPG_GAMECORE_ADDTIMELINEENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x194134C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddTimelineEntity_TypeDefinitionIndex = 19489;
