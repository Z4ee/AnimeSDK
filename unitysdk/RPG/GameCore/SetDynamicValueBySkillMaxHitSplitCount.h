...
#define RPG_GAMECORE_SETDYNAMICVALUEBYSKILLMAXHITSPLITCOUNT_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x19C44E70)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSKILLMAXHITSPLITCOUNT_METHOD_4_7AFF88025C851B20_OFFSET UNITYSDK_OFFSET(0x19C44BB0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSKILLMAXHITSPLITCOUNT_METHOD_4_CF959DE87EFCFA44_OFFSET UNITYSDK_OFFSET(0x19C44C80)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSKILLMAXHITSPLITCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x19C44C30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueBySkillMaxHitSplitCount_TypeDefinitionIndex = 22309;
