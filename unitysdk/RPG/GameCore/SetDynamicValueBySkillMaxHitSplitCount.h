...
#define RPG_GAMECORE_SETDYNAMICVALUEBYSKILLMAXHITSPLITCOUNT_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1D4F6AF0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSKILLMAXHITSPLITCOUNT_METHOD_4_0390F80CA456D4C5_OFFSET UNITYSDK_OFFSET(0x1D4F68C0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSKILLMAXHITSPLITCOUNT_METHOD_4_CF959DE87EFCFA44_OFFSET UNITYSDK_OFFSET(0x1D4F6900)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSKILLMAXHITSPLITCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4F68F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueBySkillMaxHitSplitCount_TypeDefinitionIndex = 23327;
