...
#define RPG_GAMECORE_SETDYNAMICVALUEBYSKILLMAXHITSPLITCOUNT_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x176C4EC0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSKILLMAXHITSPLITCOUNT_METHOD_4_7AFF88025C851B20_OFFSET UNITYSDK_OFFSET(0x176C4C00)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSKILLMAXHITSPLITCOUNT_METHOD_4_CF959DE87EFCFA44_OFFSET UNITYSDK_OFFSET(0x176C4CD0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSKILLMAXHITSPLITCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x176C4C80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueBySkillMaxHitSplitCount_TypeDefinitionIndex = 21836;
