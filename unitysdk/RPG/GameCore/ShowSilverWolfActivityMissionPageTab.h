...
#define RPG_GAMECORE_SHOWSILVERWOLFACTIVITYMISSIONPAGETAB_METHOD_3_5F9E54000F330FD1_OFFSET UNITYSDK_OFFSET(0x17703710)
#define RPG_GAMECORE_SHOWSILVERWOLFACTIVITYMISSIONPAGETAB_METHOD_3_EFF6B3030922A488_OFFSET UNITYSDK_OFFSET(0x17703690)
#define RPG_GAMECORE_SHOWSILVERWOLFACTIVITYMISSIONPAGETAB__CTOR_OFFSET UNITYSDK_OFFSET(0x177036E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowSilverWolfActivityMissionPageTab_TypeDefinitionIndex = 19867;
