...
#define RPG_GAMECORE_SHOWSILVERWOLFACTIVITYMISSIONPAGETAB_METHOD_3_5F9E54000F330FD1_OFFSET UNITYSDK_OFFSET(0x19C832B0)
#define RPG_GAMECORE_SHOWSILVERWOLFACTIVITYMISSIONPAGETAB_METHOD_3_EFF6B3030922A488_OFFSET UNITYSDK_OFFSET(0x19C83230)
#define RPG_GAMECORE_SHOWSILVERWOLFACTIVITYMISSIONPAGETAB__CTOR_OFFSET UNITYSDK_OFFSET(0x19C83280)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowSilverWolfActivityMissionPageTab_TypeDefinitionIndex = 20484;
