...
#define RPG_GAMECORE_SHOWSILVERWOLFACTIVITYMISSIONPAGETAB_METHOD_3_2BDBC8F7A7D5DC12_OFFSET UNITYSDK_OFFSET(0x1BE46E80)
#define RPG_GAMECORE_SHOWSILVERWOLFACTIVITYMISSIONPAGETAB_METHOD_3_5F9E54000F330FD1_OFFSET UNITYSDK_OFFSET(0x1BE46EC0)
#define RPG_GAMECORE_SHOWSILVERWOLFACTIVITYMISSIONPAGETAB__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE46EB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowSilverWolfActivityMissionPageTab_TypeDefinitionIndex = 20899;
