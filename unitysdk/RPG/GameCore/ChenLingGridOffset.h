...
#define RPG_GAMECORE_CHENLINGGRIDOFFSET_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C388E40)
#define RPG_GAMECORE_CHENLINGGRIDOFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1C388F90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingGridOffset_TypeDefinitionIndex = 10653;
