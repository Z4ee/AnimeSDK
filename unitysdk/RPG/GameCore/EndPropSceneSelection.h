...
#define RPG_GAMECORE_ENDPROPSCENESELECTION_METHOD_3_7C7A83640D1B0A64_OFFSET UNITYSDK_OFFSET(0x1C04FC50)
#define RPG_GAMECORE_ENDPROPSCENESELECTION_METHOD_3_E9876B6F86D65AE1_OFFSET UNITYSDK_OFFSET(0x1C04FD20)
#define RPG_GAMECORE_ENDPROPSCENESELECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C04FD10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EndPropSceneSelection_TypeDefinitionIndex = 21219;
