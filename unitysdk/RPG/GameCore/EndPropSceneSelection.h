...
#define RPG_GAMECORE_ENDPROPSCENESELECTION_METHOD_3_7E4A840932DF76ED_OFFSET UNITYSDK_OFFSET(0x188A8660)
#define RPG_GAMECORE_ENDPROPSCENESELECTION_METHOD_3_E9876B6F86D65AE1_OFFSET UNITYSDK_OFFSET(0x188A8770)
#define RPG_GAMECORE_ENDPROPSCENESELECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x188A8740)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EndPropSceneSelection_TypeDefinitionIndex = 20885;
