...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_MARKRECOMMENDDICEEX_METHOD_3_D9E99C112AAF73A3_OFFSET UNITYSDK_OFFSET(0x1C119530)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_MARKRECOMMENDDICEEX_METHOD_3_DC4E4C8219B8C893_OFFSET UNITYSDK_OFFSET(0x1C119590)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_MARKRECOMMENDDICEEX__CTOR_OFFSET UNITYSDK_OFFSET(0x1C119580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_MarkRecommendDiceEX_TypeDefinitionIndex = 15546;
