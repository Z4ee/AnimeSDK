...
#define RPG_GAMECORE_CLOCKPARKSTORYANIMSTATE_METHOD_2_695C3785DD7A4DD5_OFFSET UNITYSDK_OFFSET(0x196601C0)
#define RPG_GAMECORE_CLOCKPARKSTORYANIMSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x196602F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClockParkStoryAnimState_TypeDefinitionIndex = 15255;
