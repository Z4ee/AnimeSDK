...
#define RPG_GAMECORE_CAKERACEGAMESCENECONFIG_METHOD_2_2D2DAD87552E8596_OFFSET UNITYSDK_OFFSET(0x1D1015E0)
#define RPG_GAMECORE_CAKERACEGAMESCENECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D102040)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceGameSceneConfig_TypeDefinitionIndex = 18184;
