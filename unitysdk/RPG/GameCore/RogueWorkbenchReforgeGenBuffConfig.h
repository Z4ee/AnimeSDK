...
#define RPG_GAMECORE_ROGUEWORKBENCHREFORGEGENBUFFCONFIG_METHOD_2_FDEB3DF4772B72BA_OFFSET UNITYSDK_OFFSET(0x19BD47A0)
#define RPG_GAMECORE_ROGUEWORKBENCHREFORGEGENBUFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19BD47E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueWorkbenchReforgeGenBuffConfig_TypeDefinitionIndex = 17129;
