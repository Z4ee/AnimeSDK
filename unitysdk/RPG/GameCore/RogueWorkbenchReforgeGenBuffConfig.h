...
#define RPG_GAMECORE_ROGUEWORKBENCHREFORGEGENBUFFCONFIG_METHOD_2_FDEB3DF4772B72BA_OFFSET UNITYSDK_OFFSET(0x1BB82570)
#define RPG_GAMECORE_ROGUEWORKBENCHREFORGEGENBUFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB825B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueWorkbenchReforgeGenBuffConfig_TypeDefinitionIndex = 17291;
