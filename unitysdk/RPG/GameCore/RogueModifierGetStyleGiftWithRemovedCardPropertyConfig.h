...
#define RPG_GAMECORE_ROGUEMODIFIERGETSTYLEGIFTWITHREMOVEDCARDPROPERTYCONFIG_METHOD_3_33B03021AF536D17_OFFSET UNITYSDK_OFFSET(0x19B5E220)
#define RPG_GAMECORE_ROGUEMODIFIERGETSTYLEGIFTWITHREMOVEDCARDPROPERTYCONFIG_METHOD_3_F91DDD936AD7B8EE_OFFSET UNITYSDK_OFFSET(0x19B53CA0)
#define RPG_GAMECORE_ROGUEMODIFIERGETSTYLEGIFTWITHREMOVEDCARDPROPERTYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B53C50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierGetStyleGiftWithRemovedCardPropertyConfig_TypeDefinitionIndex = 16960;
