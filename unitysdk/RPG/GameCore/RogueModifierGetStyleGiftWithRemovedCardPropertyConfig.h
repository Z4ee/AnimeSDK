...
#define RPG_GAMECORE_ROGUEMODIFIERGETSTYLEGIFTWITHREMOVEDCARDPROPERTYCONFIG_METHOD_3_D4E18DB4FD1E4152_OFFSET UNITYSDK_OFFSET(0x1CFC12E0)
#define RPG_GAMECORE_ROGUEMODIFIERGETSTYLEGIFTWITHREMOVEDCARDPROPERTYCONFIG_METHOD_3_F91DDD936AD7B8EE_OFFSET UNITYSDK_OFFSET(0x1CFC1330)
#define RPG_GAMECORE_ROGUEMODIFIERGETSTYLEGIFTWITHREMOVEDCARDPROPERTYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFC1320)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierGetStyleGiftWithRemovedCardPropertyConfig_TypeDefinitionIndex = 17122;
