...
#define RPG_GAMECORE_REALTIMECONST_GET_REVERSEDMODIFIERSTATUSTYPEIMMUNEMAP_OFFSET UNITYSDK_OFFSET(0x1B9BA880)
#define RPG_GAMECORE_REALTIMECONST_GET_REVERSEMODIFIERBEHAVIORFLAGIMMUNEMAP_OFFSET UNITYSDK_OFFSET(0x1B9BACA0)
#define RPG_GAMECORE_REALTIMECONST_METHOD_2_3DA1C6D86A162460_OFFSET UNITYSDK_OFFSET(0x1B9BA3A0)
#define RPG_GAMECORE_REALTIMECONST_METHOD_2_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0x1B9BA730)
#define RPG_GAMECORE_REALTIMECONST_METHOD_2_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x1B9BA7B0)
#define RPG_GAMECORE_REALTIMECONST_METHOD_2_CF8DAE60A62181DC_OFFSET UNITYSDK_OFFSET(0x1B9BA7D0)
#define RPG_GAMECORE_REALTIMECONST__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9BA710)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RealtimeConst_TypeDefinitionIndex = 16933;
	...
	public:
		...
		{
			return (::RPG::GameCore::RealtimeConst**)Il2CppClass::FromTypeDefinitionIndex(RealtimeConst_TypeDefinitionIndex)->GetStaticField(0x3770);
		}
