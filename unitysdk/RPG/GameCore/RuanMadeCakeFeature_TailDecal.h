...
#define RPG_GAMECORE_RUANMADECAKEFEATURE_TAILDECAL_METHOD_3_B699DA33B313E792_OFFSET UNITYSDK_OFFSET(0x1B7729A0)
#define RPG_GAMECORE_RUANMADECAKEFEATURE_TAILDECAL_METHOD_3_C6007CAE66AFB55F_OFFSET UNITYSDK_OFFSET(0x1B772DD0)
#define RPG_GAMECORE_RUANMADECAKEFEATURE_TAILDECAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B772990)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RuanMadeCakeFeature_TailDecal_TypeDefinitionIndex = 16767;
