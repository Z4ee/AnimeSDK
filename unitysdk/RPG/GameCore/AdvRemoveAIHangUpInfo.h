...
#define RPG_GAMECORE_ADVREMOVEAIHANGUPINFO_METHOD_3_6DF94D95D10CE8D3_OFFSET UNITYSDK_OFFSET(0x16F3D690)
#define RPG_GAMECORE_ADVREMOVEAIHANGUPINFO_METHOD_3_FCF963BA814C5DAE_OFFSET UNITYSDK_OFFSET(0x16F3D610)
#define RPG_GAMECORE_ADVREMOVEAIHANGUPINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16F3D660)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvRemoveAIHangUpInfo_TypeDefinitionIndex = 18519;
