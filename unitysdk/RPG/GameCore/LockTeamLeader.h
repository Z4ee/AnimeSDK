...
#define RPG_GAMECORE_LOCKTEAMLEADER_METHOD_3_0BCBE7970C1E9D18_OFFSET UNITYSDK_OFFSET(0x1736C780)
#define RPG_GAMECORE_LOCKTEAMLEADER_METHOD_3_11C9DEFD8B582618_OFFSET UNITYSDK_OFFSET(0x1736C810)
#define RPG_GAMECORE_LOCKTEAMLEADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1736C7E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LockTeamLeader_TypeDefinitionIndex = 19765;
