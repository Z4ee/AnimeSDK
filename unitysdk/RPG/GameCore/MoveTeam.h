...
#define RPG_GAMECORE_MOVETEAM_METHOD_3_2D95233F60A64029_OFFSET UNITYSDK_OFFSET(0x17457B30)
#define RPG_GAMECORE_MOVETEAM_METHOD_3_723D197141B8C5CF_OFFSET UNITYSDK_OFFSET(0x17457BB0)
#define RPG_GAMECORE_MOVETEAM__CTOR_OFFSET UNITYSDK_OFFSET(0x17457B80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MoveTeam_TypeDefinitionIndex = 20816;
