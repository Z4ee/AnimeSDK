...
#define RPG_GAMECORE_FATEACTCHANGEMASTERHPTOCOINCONFIG_METHOD_6_70BA5A10D500C65A_OFFSET UNITYSDK_OFFSET(0x1C073680)
#define RPG_GAMECORE_FATEACTCHANGEMASTERHPTOCOINCONFIG_METHOD_6_C0F7B7F76B28C21E_OFFSET UNITYSDK_OFFSET(0x1C073630)
#define RPG_GAMECORE_FATEACTCHANGEMASTERHPTOCOINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C073670)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateActChangeMasterHpToCoinConfig_TypeDefinitionIndex = 18472;
