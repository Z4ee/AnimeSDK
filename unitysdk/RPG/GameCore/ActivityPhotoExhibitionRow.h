...
#define RPG_GAMECORE_ACTIVITYPHOTOEXHIBITIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CD9AA40)
#define RPG_GAMECORE_ACTIVITYPHOTOEXHIBITIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD9AD50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityPhotoExhibitionRow_TypeDefinitionIndex = 12035;
