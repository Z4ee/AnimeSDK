...
#define RPG_GAMECORE_INCLUDEGLOBALTASKLISTTEMPLATE_METHOD_3_1D47ADF2D6E6A54D_OFFSET UNITYSDK_OFFSET(0x172B9630)
#define RPG_GAMECORE_INCLUDEGLOBALTASKLISTTEMPLATE_METHOD_3_D6D9D89729B6928A_OFFSET UNITYSDK_OFFSET(0x172B96B0)
#define RPG_GAMECORE_INCLUDEGLOBALTASKLISTTEMPLATE__CTOR_OFFSET UNITYSDK_OFFSET(0x172B9680)

namespace RPG::GameCore
{
	inline static constexpr unsigned int IncludeGlobalTaskListTemplate_TypeDefinitionIndex = 22106;
