...
#define RPG_GAMECORE_MARBLEMATCHINFOCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17391A50)
#define RPG_GAMECORE_MARBLEMATCHINFOCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x173923A0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 PlayerID; // 0x3C
		::System::UInt32 CanGoMatchSubMission; // 0x40
		::System::UInt32 CustomID; // 0x44
		::System::UInt32 FirstType; // 0x48
		::RPG::GameCore::MarblePhaseType PhaseID; // 0x4C
		::System::UInt32 LevelID; // 0x50
		::System::UInt32 Round; // 0x54
