...
#define RPG_GAMECORE_LEVELWAITSECOND_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1978A950)
#define RPG_GAMECORE_LEVELWAITSECOND_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x1978A900)
#define RPG_GAMECORE_LEVELWAITSECOND_GET_LOOPEXECUTEUSED_OFFSET UNITYSDK_OFFSET(0x1978AA20)
#define RPG_GAMECORE_LEVELWAITSECOND_RESET_OFFSET UNITYSDK_OFFSET(0x1978A9A0)
#define RPG_GAMECORE_LEVELWAITSECOND_SETUSED_OFFSET UNITYSDK_OFFSET(0x1978A9E0)
#define RPG_GAMECORE_LEVELWAITSECOND_SET_LOOPEXECUTEUSED_OFFSET UNITYSDK_OFFSET(0x1978AA30)
#define RPG_GAMECORE_LEVELWAITSECOND__CTOR_OFFSET UNITYSDK_OFFSET(0x1978AA40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelWaitSecond_TypeDefinitionIndex = 54274;

	class LevelWaitSecond : public ::System::Object
	{
	public:
		::System::Single RemainWaitSecond; // 0x10
		::System::Boolean _LoopExecuteUsed_k__BackingField; // 0x14
		::System::Boolean FirstTick; // 0x15
