...
#define RPG_GAMECORE_DISABLECHARACTERVO_METHOD_3_8B9B6C260A9BFA4B_OFFSET UNITYSDK_OFFSET(0x171724D0)
#define RPG_GAMECORE_DISABLECHARACTERVO_METHOD_3_A7BD271D5EE0CBC2_OFFSET UNITYSDK_OFFSET(0x17172450)
#define RPG_GAMECORE_DISABLECHARACTERVO__CTOR_OFFSET UNITYSDK_OFFSET(0x171724A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DisableCharacterVO_TypeDefinitionIndex = 21099;
