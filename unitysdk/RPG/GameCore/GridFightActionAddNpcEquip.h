...
#define RPG_GAMECORE_GRIDFIGHTACTIONADDNPCEQUIP_METHOD_2_424E4F064B9B7856_OFFSET UNITYSDK_OFFSET(0x1D95F280)
#define RPG_GAMECORE_GRIDFIGHTACTIONADDNPCEQUIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D95F2C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightActionAddNpcEquip_TypeDefinitionIndex = 19084;
