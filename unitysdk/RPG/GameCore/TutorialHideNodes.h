...
#define RPG_GAMECORE_TUTORIALHIDENODES_METHOD_3_089EAAFD819404A4_OFFSET UNITYSDK_OFFSET(0x190DBB40)
#define RPG_GAMECORE_TUTORIALHIDENODES_METHOD_3_46DA45E098894395_OFFSET UNITYSDK_OFFSET(0x190DBBC0)
#define RPG_GAMECORE_TUTORIALHIDENODES__CTOR_OFFSET UNITYSDK_OFFSET(0x190DBB90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TutorialHideNodes_TypeDefinitionIndex = 23391;
