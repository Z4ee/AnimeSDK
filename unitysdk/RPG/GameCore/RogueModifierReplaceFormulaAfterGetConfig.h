...
#define RPG_GAMECORE_ROGUEMODIFIERREPLACEFORMULAAFTERGETCONFIG_METHOD_3_7268B90DBEF4E4FF_OFFSET UNITYSDK_OFFSET(0x17638F90)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACEFORMULAAFTERGETCONFIG_METHOD_3_F847D14602984C16_OFFSET UNITYSDK_OFFSET(0x1762C5B0)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACEFORMULAAFTERGETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1762C560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierReplaceFormulaAfterGetConfig_TypeDefinitionIndex = 16332;
