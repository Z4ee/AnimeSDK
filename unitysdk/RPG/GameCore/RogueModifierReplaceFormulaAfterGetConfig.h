...
#define RPG_GAMECORE_ROGUEMODIFIERREPLACEFORMULAAFTERGETCONFIG_METHOD_3_7268B90DBEF4E4FF_OFFSET UNITYSDK_OFFSET(0x18D45C00)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACEFORMULAAFTERGETCONFIG_METHOD_3_F847D14602984C16_OFFSET UNITYSDK_OFFSET(0x18D45CD0)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACEFORMULAAFTERGETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D45C80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierReplaceFormulaAfterGetConfig_TypeDefinitionIndex = 16886;
