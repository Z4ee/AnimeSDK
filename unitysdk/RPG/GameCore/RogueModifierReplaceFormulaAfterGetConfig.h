...
#define RPG_GAMECORE_ROGUEMODIFIERREPLACEFORMULAAFTERGETCONFIG_METHOD_3_637EB7F4571595BA_OFFSET UNITYSDK_OFFSET(0x1D3FC240)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACEFORMULAAFTERGETCONFIG_METHOD_3_F847D14602984C16_OFFSET UNITYSDK_OFFSET(0x1D3FC290)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACEFORMULAAFTERGETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3FC280)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierReplaceFormulaAfterGetConfig_TypeDefinitionIndex = 17568;
