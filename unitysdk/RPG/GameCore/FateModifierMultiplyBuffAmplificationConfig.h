...
#define RPG_GAMECORE_FATEMODIFIERMULTIPLYBUFFAMPLIFICATIONCONFIG_METHOD_3_2404A62095C102E4_OFFSET UNITYSDK_OFFSET(0x19712AC0)
#define RPG_GAMECORE_FATEMODIFIERMULTIPLYBUFFAMPLIFICATIONCONFIG_METHOD_3_3E3A2EC5C2F3335D_OFFSET UNITYSDK_OFFSET(0x197116D0)
#define RPG_GAMECORE_FATEMODIFIERMULTIPLYBUFFAMPLIFICATIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19711680)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateModifierMultiplyBuffAmplificationConfig_TypeDefinitionIndex = 18284;
