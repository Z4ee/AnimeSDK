...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONSELECTAEONOPTIONCONFIG_METHOD_3_E100EE6CE356BE4A_OFFSET UNITYSDK_OFFSET(0x1D3F8CE0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONSELECTAEONOPTIONCONFIG_METHOD_3_E6E2779D39337EA6_OFFSET UNITYSDK_OFFSET(0x1D3F8D30)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONSELECTAEONOPTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3F8D20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnSelectAeonOptionConfig_TypeDefinitionIndex = 17470;
