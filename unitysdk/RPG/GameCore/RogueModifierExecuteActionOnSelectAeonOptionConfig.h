...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONSELECTAEONOPTIONCONFIG_METHOD_3_3A5323EAFC2C47CF_OFFSET UNITYSDK_OFFSET(0x17631D40)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONSELECTAEONOPTIONCONFIG_METHOD_3_E6E2779D39337EA6_OFFSET UNITYSDK_OFFSET(0x17631E10)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONSELECTAEONOPTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17631DC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnSelectAeonOptionConfig_TypeDefinitionIndex = 16237;
