...
#define RPG_GAMECORE_CHIMERADUELDEFENDERSELECTORCONFIG_METHOD_3_48EE56708ED6CBB7_OFFSET UNITYSDK_OFFSET(0x187F8AB0)
#define RPG_GAMECORE_CHIMERADUELDEFENDERSELECTORCONFIG_METHOD_3_CD4E47E01C921EC6_OFFSET UNITYSDK_OFFSET(0x187F8A10)
#define RPG_GAMECORE_CHIMERADUELDEFENDERSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x187F8AA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelDefenderSelectorConfig_TypeDefinitionIndex = 15070;
