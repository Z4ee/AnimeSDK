...
#define RPG_GAMECORE_CHIMERADUELDEFENDERSELECTORCONFIG_METHOD_3_48EE56708ED6CBB7_OFFSET UNITYSDK_OFFSET(0x1E330C80)
#define RPG_GAMECORE_CHIMERADUELDEFENDERSELECTORCONFIG_METHOD_3_CD4E47E01C921EC6_OFFSET UNITYSDK_OFFSET(0x1E330BE0)
#define RPG_GAMECORE_CHIMERADUELDEFENDERSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1E330C70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelDefenderSelectorConfig_TypeDefinitionIndex = 15734;
