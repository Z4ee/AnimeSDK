...
#define RPG_GAMECORE_CONVINCEHPCHANGE_METHOD_3_41403969C121FA1C_OFFSET UNITYSDK_OFFSET(0x17136940)
#define RPG_GAMECORE_CONVINCEHPCHANGE_METHOD_3_E67577D54C177CBD_OFFSET UNITYSDK_OFFSET(0x171369C0)
#define RPG_GAMECORE_CONVINCEHPCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x17136990)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConvinceHpChange_TypeDefinitionIndex = 20003;
