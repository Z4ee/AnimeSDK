...
#define RPG_GAMECORE_CONDITIONBACKUP1CONFIG_METHOD_4_7F53D27E2811BC16_OFFSET UNITYSDK_OFFSET(0x1712B440)
#define RPG_GAMECORE_CONDITIONBACKUP1CONFIG_METHOD_4_9B39098D31CAA93C_OFFSET UNITYSDK_OFFSET(0x1712B310)
#define RPG_GAMECORE_CONDITIONBACKUP1CONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1712B3C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConditionBackup1Config_TypeDefinitionIndex = 15625;
