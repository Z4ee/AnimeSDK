...
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_ODD_METHOD_3_00DFEBB5F93D3727_OFFSET UNITYSDK_OFFSET(0x1C10FCC0)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_ODD_METHOD_3_5DF76D3352CD9BED_OFFSET UNITYSDK_OFFSET(0x1C10EF60)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_ODD__CTOR_OFFSET UNITYSDK_OFFSET(0x1C10EF00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatDiceSelectorConfig_Odd_TypeDefinitionIndex = 15535;
