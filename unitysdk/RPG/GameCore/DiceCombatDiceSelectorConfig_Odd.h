...
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_ODD_METHOD_3_00DFEBB5F93D3727_OFFSET UNITYSDK_OFFSET(0x196A6EC0)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_ODD_METHOD_3_5DF76D3352CD9BED_OFFSET UNITYSDK_OFFSET(0x196A6160)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_ODD__CTOR_OFFSET UNITYSDK_OFFSET(0x196A6100)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatDiceSelectorConfig_Odd_TypeDefinitionIndex = 15371;
