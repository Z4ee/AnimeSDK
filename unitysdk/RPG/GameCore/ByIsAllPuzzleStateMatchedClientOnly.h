...
#define RPG_GAMECORE_BYISALLPUZZLESTATEMATCHEDCLIENTONLY_METHOD_4_C968D56833687429_OFFSET UNITYSDK_OFFSET(0x1CF2ED80)
#define RPG_GAMECORE_BYISALLPUZZLESTATEMATCHEDCLIENTONLY_METHOD_4_D4A76DECA8716838_OFFSET UNITYSDK_OFFSET(0x1CF2EB30)
#define RPG_GAMECORE_BYISALLPUZZLESTATEMATCHEDCLIENTONLY_METHOD_4_E8D7EBDEC2FE1141_OFFSET UNITYSDK_OFFSET(0x1CF2EAF0)
#define RPG_GAMECORE_BYISALLPUZZLESTATEMATCHEDCLIENTONLY_METHOD_4_FE4D109738BADBB6_OFFSET UNITYSDK_OFFSET(0x1CF2ED50)
#define RPG_GAMECORE_BYISALLPUZZLESTATEMATCHEDCLIENTONLY__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF2EB20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsAllPuzzleStateMatchedClientOnly_TypeDefinitionIndex = 20959;
