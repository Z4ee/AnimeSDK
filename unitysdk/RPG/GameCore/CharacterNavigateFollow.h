...
#define RPG_GAMECORE_CHARACTERNAVIGATEFOLLOW_METHOD_3_83C2015637B4D5BE_OFFSET UNITYSDK_OFFSET(0x187D3E00)
#define RPG_GAMECORE_CHARACTERNAVIGATEFOLLOW_METHOD_3_F71A36AB8CE33556_OFFSET UNITYSDK_OFFSET(0x187D3E80)
#define RPG_GAMECORE_CHARACTERNAVIGATEFOLLOW__CTOR_OFFSET UNITYSDK_OFFSET(0x187D3E50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterNavigateFollow_TypeDefinitionIndex = 19841;
