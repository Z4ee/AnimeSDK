...
#define RPG_GAMECORE_PERFORMANCESKIPEROW_FROMBINARYWITHOUTNEW_OFFSET UNITYSDK_OFFSET(0x1B4B5D80)
#define RPG_GAMECORE_PERFORMANCESKIPEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B4B5F50)
#define RPG_GAMECORE_PERFORMANCESKIPEROW_FROMTABLEOFFSET_OFFSET UNITYSDK_OFFSET(0x1B4B5D00)
#define RPG_GAMECORE_PERFORMANCESKIPEROW_RESET_OFFSET UNITYSDK_OFFSET(0x1B4B5D60)
#define RPG_GAMECORE_PERFORMANCESKIPEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4B6140)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PerformanceSkipERow_TypeDefinitionIndex = 13850;
