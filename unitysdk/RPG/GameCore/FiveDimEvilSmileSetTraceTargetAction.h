...
#define RPG_GAMECORE_FIVEDIMEVILSMILESETTRACETARGETACTION_METHOD_3_728DE1F8E34E441A_OFFSET UNITYSDK_OFFSET(0x1972EB30)
#define RPG_GAMECORE_FIVEDIMEVILSMILESETTRACETARGETACTION_METHOD_3_F57910CD09982F93_OFFSET UNITYSDK_OFFSET(0x1973C6E0)
#define RPG_GAMECORE_FIVEDIMEVILSMILESETTRACETARGETACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1972EB10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimEvilSmileSetTraceTargetAction_TypeDefinitionIndex = 17878;
