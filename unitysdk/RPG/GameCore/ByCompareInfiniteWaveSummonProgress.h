...
#define RPG_GAMECORE_BYCOMPAREINFINITEWAVESUMMONPROGRESS_METHOD_4_9F6C1BADFE0AC38E_OFFSET UNITYSDK_OFFSET(0x19CEC560)
#define RPG_GAMECORE_BYCOMPAREINFINITEWAVESUMMONPROGRESS_METHOD_4_A44EFC30B30929DB_OFFSET UNITYSDK_OFFSET(0x19CEC5A0)
#define RPG_GAMECORE_BYCOMPAREINFINITEWAVESUMMONPROGRESS_METHOD_4_E01179FBE1B89DD9_OFFSET UNITYSDK_OFFSET(0x19CEC7F0)
#define RPG_GAMECORE_BYCOMPAREINFINITEWAVESUMMONPROGRESS_METHOD_4_E8C5364561EAE6F6_OFFSET UNITYSDK_OFFSET(0x19CEC820)
#define RPG_GAMECORE_BYCOMPAREINFINITEWAVESUMMONPROGRESS__CTOR_OFFSET UNITYSDK_OFFSET(0x19CEC590)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareInfiniteWaveSummonProgress_TypeDefinitionIndex = 22423;
