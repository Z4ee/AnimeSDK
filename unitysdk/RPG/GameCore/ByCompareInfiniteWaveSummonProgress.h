...
#define RPG_GAMECORE_BYCOMPAREINFINITEWAVESUMMONPROGRESS_METHOD_4_979F1860C14D4D49_OFFSET UNITYSDK_OFFSET(0x1700C0C0)
#define RPG_GAMECORE_BYCOMPAREINFINITEWAVESUMMONPROGRESS_METHOD_4_A44EFC30B30929DB_OFFSET UNITYSDK_OFFSET(0x1700C190)
#define RPG_GAMECORE_BYCOMPAREINFINITEWAVESUMMONPROGRESS__CTOR_OFFSET UNITYSDK_OFFSET(0x1700C140)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareInfiniteWaveSummonProgress_TypeDefinitionIndex = 21487;
