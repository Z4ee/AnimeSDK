...
#define RPG_GAMECORE_BYTARGETHITBOXACTIVE_METHOD_4_74B5D4CD2F4CA65A_OFFSET UNITYSDK_OFFSET(0x1703BFC0)
#define RPG_GAMECORE_BYTARGETHITBOXACTIVE_METHOD_4_D941DADAEAFDB1A4_OFFSET UNITYSDK_OFFSET(0x1703C090)
#define RPG_GAMECORE_BYTARGETHITBOXACTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1703C040)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByTargetHitBoxActive_TypeDefinitionIndex = 18498;
