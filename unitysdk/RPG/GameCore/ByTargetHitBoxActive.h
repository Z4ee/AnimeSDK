...
#define RPG_GAMECORE_BYTARGETHITBOXACTIVE_METHOD_4_059E7521D10A3121_OFFSET UNITYSDK_OFFSET(0x1CDC52F0)
#define RPG_GAMECORE_BYTARGETHITBOXACTIVE_METHOD_4_528B68C5BE0A89C2_OFFSET UNITYSDK_OFFSET(0x1CDC54E0)
#define RPG_GAMECORE_BYTARGETHITBOXACTIVE_METHOD_4_D941DADAEAFDB1A4_OFFSET UNITYSDK_OFFSET(0x1CDC5330)
#define RPG_GAMECORE_BYTARGETHITBOXACTIVE_METHOD_4_E2F4CA77AC1712A4_OFFSET UNITYSDK_OFFSET(0x1CDC54B0)
#define RPG_GAMECORE_BYTARGETHITBOXACTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDC5320)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByTargetHitBoxActive_TypeDefinitionIndex = 19977;
