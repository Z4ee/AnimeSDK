...
#define RPG_GAMECORE_PROPSREQINTERACTBYCOLONYMIRRORTAKENDIFF_METHOD_3_7A704907CA027127_OFFSET UNITYSDK_OFFSET(0x19AA0440)
#define RPG_GAMECORE_PROPSREQINTERACTBYCOLONYMIRRORTAKENDIFF_METHOD_3_F8DC775447370393_OFFSET UNITYSDK_OFFSET(0x19AA0330)
#define RPG_GAMECORE_PROPSREQINTERACTBYCOLONYMIRRORTAKENDIFF__CTOR_OFFSET UNITYSDK_OFFSET(0x19AA0410)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropsReqInteractByColonyMirrorTakenDiff_TypeDefinitionIndex = 20651;
