...
#define RPG_GAMECORE_PROPSREQINTERACTBYCOLONYMIRRORTAKENDIFF_METHOD_3_21956B077B98F88A_OFFSET UNITYSDK_OFFSET(0x1B9A7890)
#define RPG_GAMECORE_PROPSREQINTERACTBYCOLONYMIRRORTAKENDIFF_METHOD_3_7A704907CA027127_OFFSET UNITYSDK_OFFSET(0x1B9A7960)
#define RPG_GAMECORE_PROPSREQINTERACTBYCOLONYMIRRORTAKENDIFF__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9A7950)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropsReqInteractByColonyMirrorTakenDiff_TypeDefinitionIndex = 21066;
