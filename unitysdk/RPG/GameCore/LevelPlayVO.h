...
#define RPG_GAMECORE_LEVELPLAYVO_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1D1EBF70)
#define RPG_GAMECORE_LEVELPLAYVO_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D1EBF30)
#define RPG_GAMECORE_LEVELPLAYVO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1EBF60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPlayVO_TypeDefinitionIndex = 23129;
