...
#define RPG_GAMECORE_BYCHECKCHARACTERDIE_METHOD_4_1370A4CB3E88D236_OFFSET UNITYSDK_OFFSET(0x19CC2590)
#define RPG_GAMECORE_BYCHECKCHARACTERDIE_METHOD_4_6476EF1A63A93B6F_OFFSET UNITYSDK_OFFSET(0x19CC2730)
#define RPG_GAMECORE_BYCHECKCHARACTERDIE_METHOD_4_A2DB4DB2D9A8551B_OFFSET UNITYSDK_OFFSET(0x19CC2550)
#define RPG_GAMECORE_BYCHECKCHARACTERDIE_METHOD_4_F42BE948202CD848_OFFSET UNITYSDK_OFFSET(0x19CC2700)
#define RPG_GAMECORE_BYCHECKCHARACTERDIE__CTOR_OFFSET UNITYSDK_OFFSET(0x19CC2580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckCharacterDie_TypeDefinitionIndex = 22597;
