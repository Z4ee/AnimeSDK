...
#define RPG_GAMECORE_BYCHECKCHARACTERDIE_METHOD_4_1370A4CB3E88D236_OFFSET UNITYSDK_OFFSET(0x18721490)
#define RPG_GAMECORE_BYCHECKCHARACTERDIE_METHOD_4_CC6D6BA0DAE0D73C_OFFSET UNITYSDK_OFFSET(0x187213C0)
#define RPG_GAMECORE_BYCHECKCHARACTERDIE__CTOR_OFFSET UNITYSDK_OFFSET(0x18721440)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckCharacterDie_TypeDefinitionIndex = 22406;
