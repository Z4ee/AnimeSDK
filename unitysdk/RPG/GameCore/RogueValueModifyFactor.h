...
#define RPG_GAMECORE_ROGUEVALUEMODIFYFACTOR_METHOD_2_FA57B17085E32CAE_OFFSET UNITYSDK_OFFSET(0x19BD3A60)
#define RPG_GAMECORE_ROGUEVALUEMODIFYFACTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x19BD3AA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueValueModifyFactor_TypeDefinitionIndex = 17124;
