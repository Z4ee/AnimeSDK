...
#define RPG_GAMECORE_ROGUEVALUEMODIFYFACTOR_METHOD_2_FA57B17085E32CAE_OFFSET UNITYSDK_OFFSET(0x18D80530)
#define RPG_GAMECORE_ROGUEVALUEMODIFYFACTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x18D80570)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueValueModifyFactor_TypeDefinitionIndex = 17111;
