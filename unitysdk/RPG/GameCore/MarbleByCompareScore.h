...
#define RPG_GAMECORE_MARBLEBYCOMPARESCORE_METHOD_4_435B1A3B3AF17565_OFFSET UNITYSDK_OFFSET(0x1D4A4B20)
#define RPG_GAMECORE_MARBLEBYCOMPARESCORE_METHOD_4_BACF0E3A50B902E2_OFFSET UNITYSDK_OFFSET(0x1D4A4AC0)
#define RPG_GAMECORE_MARBLEBYCOMPARESCORE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4A4B10)
