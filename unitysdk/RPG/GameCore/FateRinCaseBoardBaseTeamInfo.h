...
#define RPG_GAMECORE_FATERINCASEBOARDBASETEAMINFO_METHOD_2_62CC3CE91BD57AD4_OFFSET UNITYSDK_OFFSET(0x1BA75970)
#define RPG_GAMECORE_FATERINCASEBOARDBASETEAMINFO_METHOD_2_DDEB5C97B1B73B76_OFFSET UNITYSDK_OFFSET(0x1BA75BA0)
#define RPG_GAMECORE_FATERINCASEBOARDBASETEAMINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA75B90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateRinCaseBoardBaseTeamInfo_TypeDefinitionIndex = 15586;
