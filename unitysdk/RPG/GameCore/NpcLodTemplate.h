...
#define RPG_GAMECORE_NPCLODTEMPLATE_METHOD_3_0B9A34BA288ECA43_OFFSET UNITYSDK_OFFSET(0x1BAFC330)
#define RPG_GAMECORE_NPCLODTEMPLATE_METHOD_3_1E4F64B0CC33E8ED_OFFSET UNITYSDK_OFFSET(0x1BAFC2E0)
#define RPG_GAMECORE_NPCLODTEMPLATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAFC320)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NpcLodTemplate_TypeDefinitionIndex = 18359;
