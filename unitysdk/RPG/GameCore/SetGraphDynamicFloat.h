...
#define RPG_GAMECORE_SETGRAPHDYNAMICFLOAT_METHOD_3_DA7D9B4F9F375F67_OFFSET UNITYSDK_OFFSET(0x1E82CE30)
#define RPG_GAMECORE_SETGRAPHDYNAMICFLOAT_METHOD_3_FBA12263B9F9FB3E_OFFSET UNITYSDK_OFFSET(0x1E82CE80)
#define RPG_GAMECORE_SETGRAPHDYNAMICFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E82CE70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetGraphDynamicFloat_TypeDefinitionIndex = 20471;
