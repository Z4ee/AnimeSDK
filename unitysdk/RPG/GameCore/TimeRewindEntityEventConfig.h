...
#define RPG_GAMECORE_TIMEREWINDENTITYEVENTCONFIG_METHOD_2_11DA05A8B70E24A8_OFFSET UNITYSDK_OFFSET(0x1789F600)
#define RPG_GAMECORE_TIMEREWINDENTITYEVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1789F820)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TimeRewindEntityEventConfig_TypeDefinitionIndex = 15207;
