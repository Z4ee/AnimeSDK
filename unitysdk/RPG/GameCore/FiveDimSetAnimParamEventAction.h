...
#define RPG_GAMECORE_FIVEDIMSETANIMPARAMEVENTACTION_METHOD_3_67198183B63AA59F_OFFSET UNITYSDK_OFFSET(0x1891A010)
#define RPG_GAMECORE_FIVEDIMSETANIMPARAMEVENTACTION_METHOD_3_A0349A2EE6FA9B10_OFFSET UNITYSDK_OFFSET(0x1891A080)
#define RPG_GAMECORE_FIVEDIMSETANIMPARAMEVENTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1891A060)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSetAnimParamEventAction_TypeDefinitionIndex = 17715;
