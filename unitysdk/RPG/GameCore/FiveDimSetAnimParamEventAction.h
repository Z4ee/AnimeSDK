...
#define RPG_GAMECORE_FIVEDIMSETANIMPARAMEVENTACTION_METHOD_3_67198183B63AA59F_OFFSET UNITYSDK_OFFSET(0x172088B0)
#define RPG_GAMECORE_FIVEDIMSETANIMPARAMEVENTACTION_METHOD_3_A0349A2EE6FA9B10_OFFSET UNITYSDK_OFFSET(0x17208920)
#define RPG_GAMECORE_FIVEDIMSETANIMPARAMEVENTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x17208900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSetAnimParamEventAction_TypeDefinitionIndex = 17114;
