...
#define RPG_GAMECORE_FIVEDIMSETANIMPARAMEVENTACTION_METHOD_3_8BA344D15FC920A9_OFFSET UNITYSDK_OFFSET(0x1BEAF790)
#define RPG_GAMECORE_FIVEDIMSETANIMPARAMEVENTACTION_METHOD_3_A0349A2EE6FA9B10_OFFSET UNITYSDK_OFFSET(0x1BEAF7D0)
#define RPG_GAMECORE_FIVEDIMSETANIMPARAMEVENTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEAF7C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSetAnimParamEventAction_TypeDefinitionIndex = 17916;
