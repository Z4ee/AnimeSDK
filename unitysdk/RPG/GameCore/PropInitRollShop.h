...
#define RPG_GAMECORE_PROPINITROLLSHOP_METHOD_3_4E49A34B87E196FB_OFFSET UNITYSDK_OFFSET(0x1BA23DF0)
#define RPG_GAMECORE_PROPINITROLLSHOP_METHOD_3_975B9B7FDCBC2C17_OFFSET UNITYSDK_OFFSET(0x1BA23DA0)
#define RPG_GAMECORE_PROPINITROLLSHOP__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA23DE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropInitRollShop_TypeDefinitionIndex = 20418;
