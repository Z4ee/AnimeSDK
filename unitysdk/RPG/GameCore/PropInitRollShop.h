...
#define RPG_GAMECORE_PROPINITROLLSHOP_METHOD_3_4E49A34B87E196FB_OFFSET UNITYSDK_OFFSET(0x18C6F210)
#define RPG_GAMECORE_PROPINITROLLSHOP_METHOD_3_665F9B9EAE23C02B_OFFSET UNITYSDK_OFFSET(0x18C6F180)
#define RPG_GAMECORE_PROPINITROLLSHOP__CTOR_OFFSET UNITYSDK_OFFSET(0x18C6F1E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropInitRollShop_TypeDefinitionIndex = 20189;
