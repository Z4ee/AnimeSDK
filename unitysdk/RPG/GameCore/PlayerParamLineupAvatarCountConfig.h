...
#define RPG_GAMECORE_PLAYERPARAMLINEUPAVATARCOUNTCONFIG_METHOD_5_2883EAEDD3590364_OFFSET UNITYSDK_OFFSET(0x1BA0CAC0)
#define RPG_GAMECORE_PLAYERPARAMLINEUPAVATARCOUNTCONFIG_METHOD_5_6195F6F66AFFEE28_OFFSET UNITYSDK_OFFSET(0x1BA0CA70)
#define RPG_GAMECORE_PLAYERPARAMLINEUPAVATARCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA0CAB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayerParamLineupAvatarCountConfig_TypeDefinitionIndex = 18812;
