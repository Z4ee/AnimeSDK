...
#define RPG_GAMECORE_PINGPONGDROPITEMINFO_METHOD_2_DE6E50B721251AEA_OFFSET UNITYSDK_OFFSET(0x1B4C6530)
#define RPG_GAMECORE_PINGPONGDROPITEMINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4C66D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PingPongDropItemInfo_TypeDefinitionIndex = 16311;
