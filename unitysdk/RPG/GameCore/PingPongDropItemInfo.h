...
#define RPG_GAMECORE_PINGPONGDROPITEMINFO_METHOD_2_DE6E50B721251AEA_OFFSET UNITYSDK_OFFSET(0x19A0C220)
#define RPG_GAMECORE_PINGPONGDROPITEMINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19A0C3C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PingPongDropItemInfo_TypeDefinitionIndex = 16127;
