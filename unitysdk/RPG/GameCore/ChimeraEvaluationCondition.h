...
#define RPG_GAMECORE_CHIMERAEVALUATIONCONDITION_METHOD_2_F2FAA28219EFAC89_OFFSET UNITYSDK_OFFSET(0x1C24A630)
#define RPG_GAMECORE_CHIMERAEVALUATIONCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C24A7C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraEvaluationCondition_TypeDefinitionIndex = 15246;
