...
#define RPG_GAMECORE_CAKERACECIRCLETARGETSELECTORCONFIG_METHOD_3_5B1949625F5A6A74_OFFSET UNITYSDK_OFFSET(0x18770520)
#define RPG_GAMECORE_CAKERACECIRCLETARGETSELECTORCONFIG_METHOD_3_815831156BA113D9_OFFSET UNITYSDK_OFFSET(0x1876DEE0)
#define RPG_GAMECORE_CAKERACECIRCLETARGETSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1876DED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceCircleTargetSelectorConfig_TypeDefinitionIndex = 17481;
