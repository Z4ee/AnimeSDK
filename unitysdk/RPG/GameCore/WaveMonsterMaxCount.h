...
#define RPG_GAMECORE_WAVEMONSTERMAXCOUNT_METHOD_3_1BC18D5B53A0FCCB_OFFSET UNITYSDK_OFFSET(0x1910D0A0)
#define RPG_GAMECORE_WAVEMONSTERMAXCOUNT_METHOD_3_2F1449CEDDC82F30_OFFSET UNITYSDK_OFFSET(0x1910D120)
#define RPG_GAMECORE_WAVEMONSTERMAXCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1910D0F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaveMonsterMaxCount_TypeDefinitionIndex = 22363;
