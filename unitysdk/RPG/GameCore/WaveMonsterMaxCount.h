...
#define RPG_GAMECORE_WAVEMONSTERMAXCOUNT_METHOD_3_2F1449CEDDC82F30_OFFSET UNITYSDK_OFFSET(0x1D1C0610)
#define RPG_GAMECORE_WAVEMONSTERMAXCOUNT_METHOD_3_A104541D7E651DC1_OFFSET UNITYSDK_OFFSET(0x1D1C05D0)
#define RPG_GAMECORE_WAVEMONSTERMAXCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1C0600)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaveMonsterMaxCount_TypeDefinitionIndex = 22556;
