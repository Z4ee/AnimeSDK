...
#define RPG_GAMECORE_WAVEMONSTERMAXCOUNT_METHOD_3_1BC18D5B53A0FCCB_OFFSET UNITYSDK_OFFSET(0x179091E0)
#define RPG_GAMECORE_WAVEMONSTERMAXCOUNT_METHOD_3_2F1449CEDDC82F30_OFFSET UNITYSDK_OFFSET(0x17909260)
#define RPG_GAMECORE_WAVEMONSTERMAXCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x17909230)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaveMonsterMaxCount_TypeDefinitionIndex = 21625;
