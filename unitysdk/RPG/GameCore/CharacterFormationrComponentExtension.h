...
#define RPG_GAMECORE_CHARACTERFORMATIONRCOMPONENTEXTENSION_GETFORMATIONENTITY_OFFSET UNITYSDK_OFFSET(0x12219A00)
#define RPG_GAMECORE_CHARACTERFORMATIONRCOMPONENTEXTENSION_GETFORMATIONWORLDPOS_1_OFFSET UNITYSDK_OFFSET(0x12219BA0)
#define RPG_GAMECORE_CHARACTERFORMATIONRCOMPONENTEXTENSION_GETFORMATIONWORLDPOS_OFFSET UNITYSDK_OFFSET(0x12219A70)
#define RPG_GAMECORE_CHARACTERFORMATIONRCOMPONENTEXTENSION_GETTARGETSELECTGROUP_OFFSET UNITYSDK_OFFSET(0x12219CC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterFormationrComponentExtension_TypeDefinitionIndex = 57111;
