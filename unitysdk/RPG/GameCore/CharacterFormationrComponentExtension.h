...
#define RPG_GAMECORE_CHARACTERFORMATIONRCOMPONENTEXTENSION_GETFORMATIONENTITY_OFFSET UNITYSDK_OFFSET(0xE546A80)
#define RPG_GAMECORE_CHARACTERFORMATIONRCOMPONENTEXTENSION_GETFORMATIONWORLDPOS_1_OFFSET UNITYSDK_OFFSET(0xE546C20)
#define RPG_GAMECORE_CHARACTERFORMATIONRCOMPONENTEXTENSION_GETFORMATIONWORLDPOS_OFFSET UNITYSDK_OFFSET(0xE546AF0)
#define RPG_GAMECORE_CHARACTERFORMATIONRCOMPONENTEXTENSION_GETTARGETSELECTGROUP_OFFSET UNITYSDK_OFFSET(0xE546D40)
