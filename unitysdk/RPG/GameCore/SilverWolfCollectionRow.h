...
#define RPG_GAMECORE_SILVERWOLFCOLLECTIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17708590)
#define RPG_GAMECORE_SILVERWOLFCOLLECTIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17708720)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SilverWolfCollectionRow_TypeDefinitionIndex = 11270;
