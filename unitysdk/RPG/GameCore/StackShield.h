...
#define RPG_GAMECORE_STACKSHIELD_METHOD_3_6BE654FC0932F7EE_OFFSET UNITYSDK_OFFSET(0x17762630)
#define RPG_GAMECORE_STACKSHIELD_METHOD_3_8AF309B97CB53886_OFFSET UNITYSDK_OFFSET(0x177626F0)
#define RPG_GAMECORE_STACKSHIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x177626A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StackShield_TypeDefinitionIndex = 21845;
