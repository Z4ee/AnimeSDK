...
#define RPG_GAMECORE_CHIMERADUELPLAYEYEANIMATIONNODE_METHOD_3_151CD5631151A84E_OFFSET UNITYSDK_OFFSET(0x170A2450)
#define RPG_GAMECORE_CHIMERADUELPLAYEYEANIMATIONNODE_METHOD_3_4E4C2F9B7DB47A0D_OFFSET UNITYSDK_OFFSET(0x170A2370)
#define RPG_GAMECORE_CHIMERADUELPLAYEYEANIMATIONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x170A2400)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelPlayEyeAnimationNode_TypeDefinitionIndex = 14641;
