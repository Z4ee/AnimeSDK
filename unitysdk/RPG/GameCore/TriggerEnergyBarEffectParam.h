...
#define RPG_GAMECORE_TRIGGERENERGYBAREFFECTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x11CC7520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerEnergyBarEffectParam_TypeDefinitionIndex = 55924;
