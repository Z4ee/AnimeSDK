...
#define RPG_GAMECORE_TALKFIGURE_METHOD_3_30A0D11E6A19258B_OFFSET UNITYSDK_OFFSET(0x18ECEC30)
#define RPG_GAMECORE_TALKFIGURE_METHOD_3_BE14FAAD6545BAC6_OFFSET UNITYSDK_OFFSET(0x18ECEB90)
#define RPG_GAMECORE_TALKFIGURE__CTOR_OFFSET UNITYSDK_OFFSET(0x18ECEBF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TalkFigure_TypeDefinitionIndex = 20778;
