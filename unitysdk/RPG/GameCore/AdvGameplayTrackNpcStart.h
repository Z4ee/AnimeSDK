...
#define RPG_GAMECORE_ADVGAMEPLAYTRACKNPCSTART_METHOD_3_0A5CFC36F2C044BE_OFFSET UNITYSDK_OFFSET(0x19426650)
#define RPG_GAMECORE_ADVGAMEPLAYTRACKNPCSTART_METHOD_3_2689B526D43AA5AA_OFFSET UNITYSDK_OFFSET(0x19426760)
#define RPG_GAMECORE_ADVGAMEPLAYTRACKNPCSTART__CTOR_OFFSET UNITYSDK_OFFSET(0x19426730)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvGameplayTrackNpcStart_TypeDefinitionIndex = 20963;
