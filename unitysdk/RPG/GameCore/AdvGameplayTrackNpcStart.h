...
#define RPG_GAMECORE_ADVGAMEPLAYTRACKNPCSTART_METHOD_3_0A5CFC36F2C044BE_OFFSET UNITYSDK_OFFSET(0x18652E80)
#define RPG_GAMECORE_ADVGAMEPLAYTRACKNPCSTART_METHOD_3_2689B526D43AA5AA_OFFSET UNITYSDK_OFFSET(0x18652F90)
#define RPG_GAMECORE_ADVGAMEPLAYTRACKNPCSTART__CTOR_OFFSET UNITYSDK_OFFSET(0x18652F60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvGameplayTrackNpcStart_TypeDefinitionIndex = 21055;
