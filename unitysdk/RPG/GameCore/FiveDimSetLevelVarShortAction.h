...
#define RPG_GAMECORE_FIVEDIMSETLEVELVARSHORTACTION_METHOD_3_26E69886A72E7622_OFFSET UNITYSDK_OFFSET(0x17209BD0)
#define RPG_GAMECORE_FIVEDIMSETLEVELVARSHORTACTION_METHOD_3_360B6D301C0FDB9B_OFFSET UNITYSDK_OFFSET(0x17209C40)
#define RPG_GAMECORE_FIVEDIMSETLEVELVARSHORTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x17209C20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSetLevelVarShortAction_TypeDefinitionIndex = 17122;
