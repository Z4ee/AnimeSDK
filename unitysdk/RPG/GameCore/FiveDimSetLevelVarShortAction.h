...
#define RPG_GAMECORE_FIVEDIMSETLEVELVARSHORTACTION_METHOD_3_360B6D301C0FDB9B_OFFSET UNITYSDK_OFFSET(0x1BEB0B80)
#define RPG_GAMECORE_FIVEDIMSETLEVELVARSHORTACTION_METHOD_3_EA951A881A76D270_OFFSET UNITYSDK_OFFSET(0x1BEB0B40)
#define RPG_GAMECORE_FIVEDIMSETLEVELVARSHORTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEB0B70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSetLevelVarShortAction_TypeDefinitionIndex = 17924;
