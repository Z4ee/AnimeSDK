...
#define RPG_GAMECORE_ANIMZONEBASECONFIG_METHOD_2_11F3ADFC5CB57C83_OFFSET UNITYSDK_OFFSET(0x1A056D70)
#define RPG_GAMECORE_ANIMZONEBASECONFIG_METHOD_2_A3F66B40D05E28A4_OFFSET UNITYSDK_OFFSET(0x1A056EE0)
#define RPG_GAMECORE_ANIMZONEBASECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A056ED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AnimZoneBaseConfig_TypeDefinitionIndex = 15679;
