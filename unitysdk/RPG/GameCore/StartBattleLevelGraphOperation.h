...
#define RPG_GAMECORE_STARTBATTLELEVELGRAPHOPERATION_METHOD_3_089C1AF7CA38E60C_OFFSET UNITYSDK_OFFSET(0x19CB6A20)
#define RPG_GAMECORE_STARTBATTLELEVELGRAPHOPERATION_METHOD_3_582B6197F804978F_OFFSET UNITYSDK_OFFSET(0x19CB6AA0)
#define RPG_GAMECORE_STARTBATTLELEVELGRAPHOPERATION__CTOR_OFFSET UNITYSDK_OFFSET(0x19CB6A70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StartBattleLevelGraphOperation_TypeDefinitionIndex = 22123;
