...
#define RPG_GAMECORE_STARTBATTLELEVELGRAPHOPERATION_METHOD_3_582B6197F804978F_OFFSET UNITYSDK_OFFSET(0x1D566740)
#define RPG_GAMECORE_STARTBATTLELEVELGRAPHOPERATION_METHOD_3_663AB6F5BA5AD99E_OFFSET UNITYSDK_OFFSET(0x1D566700)
#define RPG_GAMECORE_STARTBATTLELEVELGRAPHOPERATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D566730)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StartBattleLevelGraphOperation_TypeDefinitionIndex = 23137;
