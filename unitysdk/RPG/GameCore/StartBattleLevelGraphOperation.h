...
#define RPG_GAMECORE_STARTBATTLELEVELGRAPHOPERATION_METHOD_3_089C1AF7CA38E60C_OFFSET UNITYSDK_OFFSET(0x17773B30)
#define RPG_GAMECORE_STARTBATTLELEVELGRAPHOPERATION_METHOD_3_582B6197F804978F_OFFSET UNITYSDK_OFFSET(0x17773BB0)
#define RPG_GAMECORE_STARTBATTLELEVELGRAPHOPERATION__CTOR_OFFSET UNITYSDK_OFFSET(0x17773B80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StartBattleLevelGraphOperation_TypeDefinitionIndex = 21629;
