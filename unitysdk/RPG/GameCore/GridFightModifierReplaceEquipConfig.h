...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERREPLACEEQUIPCONFIG_METHOD_3_B23A524C4A529342_OFFSET UNITYSDK_OFFSET(0x1D06A8C0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERREPLACEEQUIPCONFIG_METHOD_3_D48477AA86899C5E_OFFSET UNITYSDK_OFFSET(0x1D06A910)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERREPLACEEQUIPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D06A900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierReplaceEquipConfig_TypeDefinitionIndex = 18665;
