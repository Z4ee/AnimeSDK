...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERREPLACEEQUIPCONFIG_METHOD_3_703B1AA7D158C7C7_OFFSET UNITYSDK_OFFSET(0x189BE7B0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERREPLACEEQUIPCONFIG_METHOD_3_D48477AA86899C5E_OFFSET UNITYSDK_OFFSET(0x189BE880)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERREPLACEEQUIPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189BE830)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierReplaceEquipConfig_TypeDefinitionIndex = 18445;
