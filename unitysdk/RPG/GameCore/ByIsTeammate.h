...
#define RPG_GAMECORE_BYISTEAMMATE_METHOD_4_A3EEA2AA2C6D8A1D_OFFSET UNITYSDK_OFFSET(0x18759600)
#define RPG_GAMECORE_BYISTEAMMATE_METHOD_4_D0F207836C71B8F3_OFFSET UNITYSDK_OFFSET(0x187596D0)
#define RPG_GAMECORE_BYISTEAMMATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18759680)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsTeammate_TypeDefinitionIndex = 22457;
