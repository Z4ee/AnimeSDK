...
#define RPG_GAMECORE_BYISTEAMMATE_METHOD_4_2BB5923F79CDA0C9_OFFSET UNITYSDK_OFFSET(0x1CDB2AA0)
#define RPG_GAMECORE_BYISTEAMMATE_METHOD_4_7C10375D698EB27A_OFFSET UNITYSDK_OFFSET(0x1CDB28E0)
#define RPG_GAMECORE_BYISTEAMMATE_METHOD_4_BB553F09A4E1E54F_OFFSET UNITYSDK_OFFSET(0x1CDB2AD0)
#define RPG_GAMECORE_BYISTEAMMATE_METHOD_4_D0F207836C71B8F3_OFFSET UNITYSDK_OFFSET(0x1CDB2920)
#define RPG_GAMECORE_BYISTEAMMATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDB2910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsTeammate_TypeDefinitionIndex = 23220;
