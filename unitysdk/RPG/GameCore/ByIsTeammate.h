...
#define RPG_GAMECORE_BYISTEAMMATE_METHOD_4_A3EEA2AA2C6D8A1D_OFFSET UNITYSDK_OFFSET(0x17034AE0)
#define RPG_GAMECORE_BYISTEAMMATE_METHOD_4_D0F207836C71B8F3_OFFSET UNITYSDK_OFFSET(0x17034BB0)
#define RPG_GAMECORE_BYISTEAMMATE__CTOR_OFFSET UNITYSDK_OFFSET(0x17034B60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsTeammate_TypeDefinitionIndex = 21719;
