...
#define RPG_GAMECORE_FLOATCURVEWITHMULTIPLIER_METHOD_2_229C63A78A89B641_OFFSET UNITYSDK_OFFSET(0x1DCAC550)
#define RPG_GAMECORE_FLOATCURVEWITHMULTIPLIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCAC630)
