...
#define RPG_GAMECORE_ADVENTITYSETEXTANIMLAYERENABLE_METHOD_3_2F96ABD23DC40FFD_OFFSET UNITYSDK_OFFSET(0x1CDC8B90)
#define RPG_GAMECORE_ADVENTITYSETEXTANIMLAYERENABLE_METHOD_3_890DDD91C0039C54_OFFSET UNITYSDK_OFFSET(0x1CDC8B50)
#define RPG_GAMECORE_ADVENTITYSETEXTANIMLAYERENABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDC8B80)
