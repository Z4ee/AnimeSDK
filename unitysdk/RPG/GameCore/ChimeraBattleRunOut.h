...
#define RPG_GAMECORE_CHIMERABATTLERUNOUT_METHOD_3_7809ED5D700BED80_OFFSET UNITYSDK_OFFSET(0x1C38FA80)
#define RPG_GAMECORE_CHIMERABATTLERUNOUT_METHOD_3_E31D9636E79EBB85_OFFSET UNITYSDK_OFFSET(0x1C38E2B0)
#define RPG_GAMECORE_CHIMERABATTLERUNOUT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C38E2A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraBattleRunOut_TypeDefinitionIndex = 15269;
