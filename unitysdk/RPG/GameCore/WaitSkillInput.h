...
#define RPG_GAMECORE_WAITSKILLINPUT_METHOD_3_52DCE3613EC8B349_OFFSET UNITYSDK_OFFSET(0x17904E00)
#define RPG_GAMECORE_WAITSKILLINPUT_METHOD_3_A4FD65C3D56D8F77_OFFSET UNITYSDK_OFFSET(0x17904E80)
#define RPG_GAMECORE_WAITSKILLINPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x17904E50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitSkillInput_TypeDefinitionIndex = 18479;
