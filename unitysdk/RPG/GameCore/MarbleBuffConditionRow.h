...
#define RPG_GAMECORE_MARBLEBUFFCONDITIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D22DFF0)
#define RPG_GAMECORE_MARBLEBUFFCONDITIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D22E210)
