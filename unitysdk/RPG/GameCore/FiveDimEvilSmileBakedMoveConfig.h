...
#define RPG_GAMECORE_FIVEDIMEVILSMILEBAKEDMOVECONFIG_METHOD_3_194FB74AE7365C3B_OFFSET UNITYSDK_OFFSET(0x1D85C9D0)
#define RPG_GAMECORE_FIVEDIMEVILSMILEBAKEDMOVECONFIG_METHOD_3_A41062164B3FE808_OFFSET UNITYSDK_OFFSET(0x1D85CA10)
#define RPG_GAMECORE_FIVEDIMEVILSMILEBAKEDMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D85CA00)
