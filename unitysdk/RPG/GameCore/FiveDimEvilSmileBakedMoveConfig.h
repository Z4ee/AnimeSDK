...
#define RPG_GAMECORE_FIVEDIMEVILSMILEBAKEDMOVECONFIG_METHOD_3_194FB74AE7365C3B_OFFSET UNITYSDK_OFFSET(0x1BA94470)
#define RPG_GAMECORE_FIVEDIMEVILSMILEBAKEDMOVECONFIG_METHOD_3_A41062164B3FE808_OFFSET UNITYSDK_OFFSET(0x1BA944B0)
#define RPG_GAMECORE_FIVEDIMEVILSMILEBAKEDMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA944A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimEvilSmileBakedMoveConfig_TypeDefinitionIndex = 16032;
