...
#define RPG_GAMECORE_RECORDOPERATION_METHOD_2_CEFCE0F8A97532D7_OFFSET UNITYSDK_OFFSET(0x19AB6EA0)
#define RPG_GAMECORE_RECORDOPERATION__CTOR_OFFSET UNITYSDK_OFFSET(0x19AB7130)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RecordOperation_TypeDefinitionIndex = 17300;
