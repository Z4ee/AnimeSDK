...
{
	inline static constexpr unsigned int EvolveBuildGearManager_SecondChapterStrategy___c__DisplayClass6_0_TypeDefinitionIndex = 44915;

	struct alignas(8) EvolveBuildGearManager_SecondChapterStrategy___c__DisplayClass6_0
	{
		::RPG::PoolList_1<::System::UInt32>* pCardIDPool; // 0x10
		::RPG::GameCore::EvolveBuildGearManager_SecondChapterStrategy* __4__this; // 0x18
		::Il2CppArray<::System::UInt32>* refBlacklist; // 0x20
		::Il2CppArray<::System::UInt32>* refWhitelist; // 0x28
		::System::Collections::Generic::List_1<::Class_1_7AB88D713F5121B3_33*>* targetList; // 0x30
