...
#define RPG_GAMECORE_DICECOMBATV2SINGLEDIALOGPERFORMANCETRIGGERCONDITION_METHOD_2_0948BEEF78D5D811_OFFSET UNITYSDK_OFFSET(0x196BB3E0)
#define RPG_GAMECORE_DICECOMBATV2SINGLEDIALOGPERFORMANCETRIGGERCONDITION_METHOD_2_EE996B6F5A6A973A_OFFSET UNITYSDK_OFFSET(0x196BAF40)
#define RPG_GAMECORE_DICECOMBATV2SINGLEDIALOGPERFORMANCETRIGGERCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x196BB3D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatV2SingleDialogPerformanceTriggerCondition_TypeDefinitionIndex = 15407;
