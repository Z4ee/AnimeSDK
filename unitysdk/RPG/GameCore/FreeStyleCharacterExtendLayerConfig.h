...
#define RPG_GAMECORE_FREESTYLECHARACTEREXTENDLAYERCONFIG_METHOD_2_19ED7A84CF9A14BB_OFFSET UNITYSDK_OFFSET(0x1721FA00)
#define RPG_GAMECORE_FREESTYLECHARACTEREXTENDLAYERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1721FB30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FreeStyleCharacterExtendLayerConfig_TypeDefinitionIndex = 14926;
