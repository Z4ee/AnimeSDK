...
#define RPG_GAMECORE_FREESTYLECHARACTEREXTENDLAYERCONFIG_METHOD_2_4E6E24A4293DC7C4_OFFSET UNITYSDK_OFFSET(0x1DCBB300)
#define RPG_GAMECORE_FREESTYLECHARACTEREXTENDLAYERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCBB400)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FreeStyleCharacterExtendLayerConfig_TypeDefinitionIndex = 16136;
