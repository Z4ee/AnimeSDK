...
#define RPG_GAMECORE_FATEPARAMMASTERCOUNTCONFIG_METHOD_6_0777DBFC85FAFE76_OFFSET UNITYSDK_OFFSET(0x19714A50)
#define RPG_GAMECORE_FATEPARAMMASTERCOUNTCONFIG_METHOD_6_5E4C48505FCD60CA_OFFSET UNITYSDK_OFFSET(0x19714890)
#define RPG_GAMECORE_FATEPARAMMASTERCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19714990)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateParamMasterCountConfig_TypeDefinitionIndex = 15811;
