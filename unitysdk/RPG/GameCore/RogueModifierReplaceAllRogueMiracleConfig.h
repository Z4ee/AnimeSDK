...
#define RPG_GAMECORE_ROGUEMODIFIERREPLACEALLROGUEMIRACLECONFIG_METHOD_3_1E3FAFE3291C7834_OFFSET UNITYSDK_OFFSET(0x1EEFC720)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACEALLROGUEMIRACLECONFIG_METHOD_3_7B279B41DBDC25B8_OFFSET UNITYSDK_OFFSET(0x1EEFC6D0)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACEALLROGUEMIRACLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEFC710)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierReplaceAllRogueMiracleConfig_TypeDefinitionIndex = 17542;
