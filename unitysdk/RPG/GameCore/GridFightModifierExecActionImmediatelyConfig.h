...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONIMMEDIATELYCONFIG_METHOD_3_304192B5DF73E70E_OFFSET UNITYSDK_OFFSET(0x1726AB70)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONIMMEDIATELYCONFIG_METHOD_3_71661393C4501D87_OFFSET UNITYSDK_OFFSET(0x17266F40)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONIMMEDIATELYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17266EF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierExecActionImmediatelyConfig_TypeDefinitionIndex = 17756;
