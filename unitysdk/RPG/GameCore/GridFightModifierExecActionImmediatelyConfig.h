...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONIMMEDIATELYCONFIG_METHOD_3_71661393C4501D87_OFFSET UNITYSDK_OFFSET(0x1C5D14C0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONIMMEDIATELYCONFIG_METHOD_3_A5CF9AB6694EBA03_OFFSET UNITYSDK_OFFSET(0x1C5D1470)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONIMMEDIATELYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5D14B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierExecActionImmediatelyConfig_TypeDefinitionIndex = 18586;
