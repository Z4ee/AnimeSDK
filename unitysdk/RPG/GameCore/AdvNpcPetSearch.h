...
#define RPG_GAMECORE_ADVNPCPETSEARCH_METHOD_3_362164B95CEA7F3B_OFFSET UNITYSDK_OFFSET(0x16F39040)
#define RPG_GAMECORE_ADVNPCPETSEARCH_METHOD_3_89CB789BC8459EF6_OFFSET UNITYSDK_OFFSET(0x16F38FA0)
#define RPG_GAMECORE_ADVNPCPETSEARCH__CTOR_OFFSET UNITYSDK_OFFSET(0x16F39000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvNpcPetSearch_TypeDefinitionIndex = 18262;
