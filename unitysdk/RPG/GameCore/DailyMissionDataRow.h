...
#define RPG_GAMECORE_DAILYMISSIONDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D809770)
#define RPG_GAMECORE_DAILYMISSIONDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D809E60)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 UnlockMainMission; // 0x18
