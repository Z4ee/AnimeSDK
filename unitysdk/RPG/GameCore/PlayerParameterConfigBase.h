...
#define RPG_GAMECORE_PLAYERPARAMETERCONFIGBASE_METHOD_4_2458B9A0DF7AC6A4_OFFSET UNITYSDK_OFFSET(0x1D3518F0)
#define RPG_GAMECORE_PLAYERPARAMETERCONFIGBASE_METHOD_4_779181EC892BA531_OFFSET UNITYSDK_OFFSET(0x1D351890)
#define RPG_GAMECORE_PLAYERPARAMETERCONFIGBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3517C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayerParameterConfigBase_TypeDefinitionIndex = 19335;
