...
#define RPG_GAMECORE_BYTARGETINCAMERASCREENSCOPE_METHOD_4_09118BDE3FC85942_OFFSET UNITYSDK_OFFSET(0x1B2BD230)
#define RPG_GAMECORE_BYTARGETINCAMERASCREENSCOPE_METHOD_4_5D226B683BF578BA_OFFSET UNITYSDK_OFFSET(0x1B2BD2B0)
#define RPG_GAMECORE_BYTARGETINCAMERASCREENSCOPE_METHOD_4_DD3CFE4E37B58CA0_OFFSET UNITYSDK_OFFSET(0x1B2BCF00)
#define RPG_GAMECORE_BYTARGETINCAMERASCREENSCOPE_METHOD_4_DFA61CC7FE0E979F_OFFSET UNITYSDK_OFFSET(0x1B2BCE20)
#define RPG_GAMECORE_BYTARGETINCAMERASCREENSCOPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2BCEA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByTargetInCameraScreenScope_TypeDefinitionIndex = 19474;
