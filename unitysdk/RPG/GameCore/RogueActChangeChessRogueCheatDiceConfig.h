...
#define RPG_GAMECORE_ROGUEACTCHANGECHESSROGUECHEATDICECONFIG_METHOD_6_9323025219D94B23_OFFSET UNITYSDK_OFFSET(0x19AE1BA0)
#define RPG_GAMECORE_ROGUEACTCHANGECHESSROGUECHEATDICECONFIG_METHOD_6_EA173C5D91271546_OFFSET UNITYSDK_OFFSET(0x19AE1DC0)
#define RPG_GAMECORE_ROGUEACTCHANGECHESSROGUECHEATDICECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AE1CE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActChangeChessRogueCheatDiceConfig_TypeDefinitionIndex = 18606;
