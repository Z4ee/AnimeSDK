...
#define RPG_GAMECORE_SOTASKCONFIG_METHOD_3_5FE05F69D94CF677_OFFSET UNITYSDK_OFFSET(0x19BFC520)
#define RPG_GAMECORE_SOTASKCONFIG_METHOD_3_F23728469566E01A_OFFSET UNITYSDK_OFFSET(0x19BFDEB0)
#define RPG_GAMECORE_SOTASKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19BFC3F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SOTaskConfig_TypeDefinitionIndex = 18929;
