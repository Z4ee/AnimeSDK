...
#define RPG_GAMECORE_MAPENTRYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D496720)
#define RPG_GAMECORE_MAPENTRYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D497E30)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::MapEntryType EntranceType; // 0x28
