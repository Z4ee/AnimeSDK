...
#define RPG_GAMECORE_FIVEDIMAPPLYPLAYERINTERACTACTION_METHOD_3_30E75A6C9D701C2F_OFFSET UNITYSDK_OFFSET(0x1BA87490)
#define RPG_GAMECORE_FIVEDIMAPPLYPLAYERINTERACTACTION_METHOD_3_EC0AA3BE67C5A43E_OFFSET UNITYSDK_OFFSET(0x1BA87410)
#define RPG_GAMECORE_FIVEDIMAPPLYPLAYERINTERACTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA87480)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimApplyPlayerInteractAction_TypeDefinitionIndex = 18034;
