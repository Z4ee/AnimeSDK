...
#define RPG_GAMECORE_FIVEDIMAPPLYPLAYERINTERACTACTION_METHOD_3_30E75A6C9D701C2F_OFFSET UNITYSDK_OFFSET(0x188EAF30)
#define RPG_GAMECORE_FIVEDIMAPPLYPLAYERINTERACTACTION_METHOD_3_C32D1304AFC03CA2_OFFSET UNITYSDK_OFFSET(0x188EAE70)
#define RPG_GAMECORE_FIVEDIMAPPLYPLAYERINTERACTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x188EAF10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimApplyPlayerInteractAction_TypeDefinitionIndex = 17830;
