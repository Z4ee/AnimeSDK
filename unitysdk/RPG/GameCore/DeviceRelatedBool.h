...
#define RPG_GAMECORE_DEVICERELATEDBOOL_METHOD_3_5082C8008E9769E7_OFFSET UNITYSDK_OFFSET(0x1C105820)
#define RPG_GAMECORE_DEVICERELATEDBOOL_METHOD_3_F98AB2C4375257BD_OFFSET UNITYSDK_OFFSET(0x1C1057C0)
#define RPG_GAMECORE_DEVICERELATEDBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C105810)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DeviceRelatedBool_TypeDefinitionIndex = 15821;
