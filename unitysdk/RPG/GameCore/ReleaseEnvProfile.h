...
#define RPG_GAMECORE_RELEASEENVPROFILE_METHOD_3_221667BC84F93AAA_OFFSET UNITYSDK_OFFSET(0x1758ACA0)
#define RPG_GAMECORE_RELEASEENVPROFILE_METHOD_3_47201BD3789D6FF3_OFFSET UNITYSDK_OFFSET(0x1758AD20)
#define RPG_GAMECORE_RELEASEENVPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x1758ACF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ReleaseEnvProfile_TypeDefinitionIndex = 19074;
