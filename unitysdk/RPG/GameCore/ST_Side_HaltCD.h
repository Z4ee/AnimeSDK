...
#define RPG_GAMECORE_ST_SIDE_HALTCD_METHOD_4_6C07BB4817BB9B42_OFFSET UNITYSDK_OFFSET(0x18DF78C0)
#define RPG_GAMECORE_ST_SIDE_HALTCD_METHOD_4_B9F612BE2EF92D05_OFFSET UNITYSDK_OFFSET(0x18DF7750)
#define RPG_GAMECORE_ST_SIDE_HALTCD__CTOR_OFFSET UNITYSDK_OFFSET(0x18DF7870)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_HaltCD_TypeDefinitionIndex = 19075;
