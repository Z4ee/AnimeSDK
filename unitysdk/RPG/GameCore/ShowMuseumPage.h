...
#define RPG_GAMECORE_SHOWMUSEUMPAGE_METHOD_3_A9CFDEDAE4423320_OFFSET UNITYSDK_OFFSET(0x1D52D560)
#define RPG_GAMECORE_SHOWMUSEUMPAGE_METHOD_3_C8CC7FC604BF3B09_OFFSET UNITYSDK_OFFSET(0x1D52D520)
#define RPG_GAMECORE_SHOWMUSEUMPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D52D550)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowMuseumPage_TypeDefinitionIndex = 20664;
