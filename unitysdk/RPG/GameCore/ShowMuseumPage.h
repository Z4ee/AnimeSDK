...
#define RPG_GAMECORE_SHOWMUSEUMPAGE_METHOD_3_9A341CBEC3616DAF_OFFSET UNITYSDK_OFFSET(0x17700770)
#define RPG_GAMECORE_SHOWMUSEUMPAGE_METHOD_3_A9CFDEDAE4423320_OFFSET UNITYSDK_OFFSET(0x177007F0)
#define RPG_GAMECORE_SHOWMUSEUMPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x177007C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowMuseumPage_TypeDefinitionIndex = 19230;
