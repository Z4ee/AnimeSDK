...
#define RPG_GAMECORE_UINOTIFYMONOPOLYEVENTSTART_METHOD_3_007D93F619EDE6F9_OFFSET UNITYSDK_OFFSET(0x190DF1E0)
#define RPG_GAMECORE_UINOTIFYMONOPOLYEVENTSTART_METHOD_3_DFADBF672E579C6D_OFFSET UNITYSDK_OFFSET(0x190DF2F0)
#define RPG_GAMECORE_UINOTIFYMONOPOLYEVENTSTART__CTOR_OFFSET UNITYSDK_OFFSET(0x190DF2C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UINotifyMonopolyEventStart_TypeDefinitionIndex = 19915;
