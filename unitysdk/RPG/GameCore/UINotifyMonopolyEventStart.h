...
#define RPG_GAMECORE_UINOTIFYMONOPOLYEVENTSTART_METHOD_3_030ACF25DABD3330_OFFSET UNITYSDK_OFFSET(0x1B87C9E0)
#define RPG_GAMECORE_UINOTIFYMONOPOLYEVENTSTART_METHOD_3_DFADBF672E579C6D_OFFSET UNITYSDK_OFFSET(0x1B87CAB0)
#define RPG_GAMECORE_UINOTIFYMONOPOLYEVENTSTART__CTOR_OFFSET UNITYSDK_OFFSET(0x1B87CAA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UINotifyMonopolyEventStart_TypeDefinitionIndex = 20138;
