...
#define RPG_GAMECORE_ROGUEDIALOGUEEVENTDYNAMICARGCONFIG_METHOD_2_694AE8ADE1045F05_OFFSET UNITYSDK_OFFSET(0x19B378F0)
#define RPG_GAMECORE_ROGUEDIALOGUEEVENTDYNAMICARGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B37930)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueDialogueEventDynamicArgConfig_TypeDefinitionIndex = 17029;
