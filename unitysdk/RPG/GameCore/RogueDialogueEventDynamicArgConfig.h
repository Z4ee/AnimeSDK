...
#define RPG_GAMECORE_ROGUEDIALOGUEEVENTDYNAMICARGCONFIG_METHOD_2_694AE8ADE1045F05_OFFSET UNITYSDK_OFFSET(0x17605960)
#define RPG_GAMECORE_ROGUEDIALOGUEEVENTDYNAMICARGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x176059A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueDialogueEventDynamicArgConfig_TypeDefinitionIndex = 16461;
