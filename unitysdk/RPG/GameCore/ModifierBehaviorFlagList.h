...
#define RPG_GAMECORE_MODIFIERBEHAVIORFLAGLIST_METHOD_2_1D25AF26A7E251D4_OFFSET UNITYSDK_OFFSET(0x174262D0)
#define RPG_GAMECORE_MODIFIERBEHAVIORFLAGLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x174263E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifierBehaviorFlagList_TypeDefinitionIndex = 15670;
