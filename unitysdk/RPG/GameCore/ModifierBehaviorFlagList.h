...
#define RPG_GAMECORE_MODIFIERBEHAVIORFLAGLIST_METHOD_2_1D25AF26A7E251D4_OFFSET UNITYSDK_OFFSET(0x1D2AA8E0)
#define RPG_GAMECORE_MODIFIERBEHAVIORFLAGLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2AA9A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifierBehaviorFlagList_TypeDefinitionIndex = 16911;
