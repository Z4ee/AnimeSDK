...
#define RPG_GAMECORE_ATTACHSKILLTYPEDISABLE_METHOD_3_BAEA28A9D337621A_OFFSET UNITYSDK_OFFSET(0x1A065E40)
#define RPG_GAMECORE_ATTACHSKILLTYPEDISABLE_METHOD_3_F38301C9D9B7CF9A_OFFSET UNITYSDK_OFFSET(0x1A065E00)
#define RPG_GAMECORE_ATTACHSKILLTYPEDISABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A065E30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AttachSkillTypeDisable_TypeDefinitionIndex = 22760;
