...
#define RPG_GAMECORE_ATTACHSKILLTYPEDISABLE_METHOD_3_096F0AA49E94B76A_OFFSET UNITYSDK_OFFSET(0x16F8AED0)
#define RPG_GAMECORE_ATTACHSKILLTYPEDISABLE_METHOD_3_AEF2DC8178207CEF_OFFSET UNITYSDK_OFFSET(0x16F8AF50)
#define RPG_GAMECORE_ATTACHSKILLTYPEDISABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F8AF20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AttachSkillTypeDisable_TypeDefinitionIndex = 21846;
