...
#define RPG_GAMECORE_AVATARDEMOGUIDEGROUPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x194942D0)
#define RPG_GAMECORE_AVATARDEMOGUIDEGROUPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19494910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AvatarDemoGuideGroupRow_TypeDefinitionIndex = 12168;
