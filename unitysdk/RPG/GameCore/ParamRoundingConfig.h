...
#define RPG_GAMECORE_PARAMROUNDINGCONFIG_METHOD_4_5B7BDEE3CF635799_OFFSET UNITYSDK_OFFSET(0x1D30B340)
#define RPG_GAMECORE_PARAMROUNDINGCONFIG_METHOD_4_8513F566F2E95B1F_OFFSET UNITYSDK_OFFSET(0x1D30B3A0)
#define RPG_GAMECORE_PARAMROUNDINGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D30B390)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ParamRoundingConfig_TypeDefinitionIndex = 16892;
