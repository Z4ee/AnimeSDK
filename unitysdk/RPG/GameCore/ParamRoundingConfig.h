...
#define RPG_GAMECORE_PARAMROUNDINGCONFIG_METHOD_4_8513F566F2E95B1F_OFFSET UNITYSDK_OFFSET(0x18BD41B0)
#define RPG_GAMECORE_PARAMROUNDINGCONFIG_METHOD_4_C672F52FED544892_OFFSET UNITYSDK_OFFSET(0x18BD4070)
#define RPG_GAMECORE_PARAMROUNDINGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18BD4130)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ParamRoundingConfig_TypeDefinitionIndex = 16175;
