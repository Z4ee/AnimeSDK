...
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTAPPLYDAMAGECONFIG_METHOD_3_B3E7284CE538C0DA_OFFSET UNITYSDK_OFFSET(0x1B093070)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTAPPLYDAMAGECONFIG_METHOD_3_D78783FEA7B81126_OFFSET UNITYSDK_OFFSET(0x1B093140)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTAPPLYDAMAGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B093130)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityPixAirEffectApplyDamageConfig_TypeDefinitionIndex = 20540;
