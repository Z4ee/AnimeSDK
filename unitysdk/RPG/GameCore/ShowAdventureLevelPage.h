...
#define RPG_GAMECORE_SHOWADVENTURELEVELPAGE_METHOD_3_BE6D4EA930D9E547_OFFSET UNITYSDK_OFFSET(0x176F3DD0)
#define RPG_GAMECORE_SHOWADVENTURELEVELPAGE_METHOD_3_D6EEF687FAEE47B3_OFFSET UNITYSDK_OFFSET(0x176F3CC0)
#define RPG_GAMECORE_SHOWADVENTURELEVELPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x176F3DA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowAdventureLevelPage_TypeDefinitionIndex = 19222;
