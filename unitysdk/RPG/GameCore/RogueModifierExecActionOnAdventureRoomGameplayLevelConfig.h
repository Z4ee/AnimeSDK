...
#define RPG_GAMECORE_ROGUEMODIFIEREXECACTIONONADVENTUREROOMGAMEPLAYLEVELCONFIG_METHOD_3_969636B6CE1A8F7E_OFFSET UNITYSDK_OFFSET(0x19B5BF20)
#define RPG_GAMECORE_ROGUEMODIFIEREXECACTIONONADVENTUREROOMGAMEPLAYLEVELCONFIG_METHOD_3_E372FEA59D1DCB77_OFFSET UNITYSDK_OFFSET(0x19B4FF60)
#define RPG_GAMECORE_ROGUEMODIFIEREXECACTIONONADVENTUREROOMGAMEPLAYLEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B4FF10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecActionOnAdventureRoomGameplayLevelConfig_TypeDefinitionIndex = 16950;
