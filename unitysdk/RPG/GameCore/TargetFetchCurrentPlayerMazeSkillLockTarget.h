...
#define RPG_GAMECORE_TARGETFETCHCURRENTPLAYERMAZESKILLLOCKTARGET_METHOD_4_5AA90FE4F88E691F_OFFSET UNITYSDK_OFFSET(0x1D0B9380)
#define RPG_GAMECORE_TARGETFETCHCURRENTPLAYERMAZESKILLLOCKTARGET_METHOD_4_704DF0AEE54E257E_OFFSET UNITYSDK_OFFSET(0x1D0B9480)
#define RPG_GAMECORE_TARGETFETCHCURRENTPLAYERMAZESKILLLOCKTARGET_METHOD_4_DF884970194A25AB_OFFSET UNITYSDK_OFFSET(0x1D0B9460)
#define RPG_GAMECORE_TARGETFETCHCURRENTPLAYERMAZESKILLLOCKTARGET_METHOD_4_E7099F9DDE3ADD6E_OFFSET UNITYSDK_OFFSET(0x1D0B9400)
#define RPG_GAMECORE_TARGETFETCHCURRENTPLAYERMAZESKILLLOCKTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0B93F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchCurrentPlayerMazeSkillLockTarget_TypeDefinitionIndex = 23032;
