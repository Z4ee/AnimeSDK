...
#define RPG_GAMECORE_BYISACTIVITYINSCHEDULE_METHOD_4_16FA4AABDA466FD1_OFFSET UNITYSDK_OFFSET(0x1CF2E0E0)
#define RPG_GAMECORE_BYISACTIVITYINSCHEDULE_METHOD_4_75AC6D813C1B44CE_OFFSET UNITYSDK_OFFSET(0x1CF2E0B0)
#define RPG_GAMECORE_BYISACTIVITYINSCHEDULE_METHOD_4_C28E1B515F24D79D_OFFSET UNITYSDK_OFFSET(0x1CF2DF00)
#define RPG_GAMECORE_BYISACTIVITYINSCHEDULE_METHOD_4_F6D63E59267DFFA4_OFFSET UNITYSDK_OFFSET(0x1CF2DF40)
#define RPG_GAMECORE_BYISACTIVITYINSCHEDULE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF2DF30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsActivityInSchedule_TypeDefinitionIndex = 20715;
