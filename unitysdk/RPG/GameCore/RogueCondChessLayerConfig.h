...
#define RPG_GAMECORE_ROGUECONDCHESSLAYERCONFIG_METHOD_6_1FD5A18C975C5B11_OFFSET UNITYSDK_OFFSET(0x1D9187E0)
#define RPG_GAMECORE_ROGUECONDCHESSLAYERCONFIG_METHOD_6_2415552AA638EB35_OFFSET UNITYSDK_OFFSET(0x1D918830)
#define RPG_GAMECORE_ROGUECONDCHESSLAYERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D918820)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueCondChessLayerConfig_TypeDefinitionIndex = 19574;
