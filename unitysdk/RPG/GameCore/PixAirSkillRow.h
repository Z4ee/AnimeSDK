...
#define RPG_GAMECORE_PIXAIRSKILLROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19A147C0)
#define RPG_GAMECORE_PIXAIRSKILLROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19A149C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PixAirSkillRow_TypeDefinitionIndex = 11591;
