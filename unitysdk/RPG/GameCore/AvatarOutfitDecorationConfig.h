...
#define RPG_GAMECORE_AVATAROUTFITDECORATIONCONFIG_METHOD_2_5F28DB4679A42A92_OFFSET UNITYSDK_OFFSET(0x1949C000)
#define RPG_GAMECORE_AVATAROUTFITDECORATIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1949C0B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AvatarOutfitDecorationConfig_TypeDefinitionIndex = 15764;
