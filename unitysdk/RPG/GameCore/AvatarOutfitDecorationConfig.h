...
#define RPG_GAMECORE_AVATAROUTFITDECORATIONCONFIG_METHOD_2_5F28DB4679A42A92_OFFSET UNITYSDK_OFFSET(0x1A07BE50)
#define RPG_GAMECORE_AVATAROUTFITDECORATIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A07BF00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AvatarOutfitDecorationConfig_TypeDefinitionIndex = 15938;
