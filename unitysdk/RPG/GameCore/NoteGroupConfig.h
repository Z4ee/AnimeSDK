...
#define RPG_GAMECORE_NOTEGROUPCONFIG_METHOD_2_388FABFE3C1182FC_OFFSET UNITYSDK_OFFSET(0x199CF9E0)
#define RPG_GAMECORE_NOTEGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x199CFD10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NoteGroupConfig_TypeDefinitionIndex = 16086;
