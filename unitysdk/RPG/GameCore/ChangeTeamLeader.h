...
#define RPG_GAMECORE_CHANGETEAMLEADER_METHOD_3_408D85C59FCA14BB_OFFSET UNITYSDK_OFFSET(0x17064A80)
#define RPG_GAMECORE_CHANGETEAMLEADER_METHOD_3_5DC8423F3999D3EB_OFFSET UNITYSDK_OFFSET(0x170649F0)
#define RPG_GAMECORE_CHANGETEAMLEADER__CTOR_OFFSET UNITYSDK_OFFSET(0x17064A50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChangeTeamLeader_TypeDefinitionIndex = 19767;
