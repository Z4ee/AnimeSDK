...
#define RPG_GAMECORE_CHANGETEAMLEADER_METHOD_3_408D85C59FCA14BB_OFFSET UNITYSDK_OFFSET(0x1B71B900)
#define RPG_GAMECORE_CHANGETEAMLEADER_METHOD_3_9C1F47BF547DCFD7_OFFSET UNITYSDK_OFFSET(0x1B71B8B0)
#define RPG_GAMECORE_CHANGETEAMLEADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B71B8F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChangeTeamLeader_TypeDefinitionIndex = 20805;
