...
#define RPG_GAMECORE_FOURROTATEVOXELSETCAMERAACTIVEACTION_METHOD_3_199DF2D581FFD1E5_OFFSET UNITYSDK_OFFSET(0x1B97DC80)
#define RPG_GAMECORE_FOURROTATEVOXELSETCAMERAACTIVEACTION_METHOD_3_8CC8B463EC133B46_OFFSET UNITYSDK_OFFSET(0x1B97DC40)
#define RPG_GAMECORE_FOURROTATEVOXELSETCAMERAACTIVEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B97DC70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FourRotateVoxelSetCameraActiveAction_TypeDefinitionIndex = 16111;
