...
#define RPG_GAMECORE_LEVELSELECTBUFFCONFIRM_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xA990C60)
#define RPG_GAMECORE_LEVELSELECTBUFFCONFIRM_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xA990C10)
#define RPG_GAMECORE_LEVELSELECTBUFFCONFIRM_INIT_OFFSET UNITYSDK_OFFSET(0xA990BC0)
#define RPG_GAMECORE_LEVELSELECTBUFFCONFIRM__CTOR_OFFSET UNITYSDK_OFFSET(0xA990CB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelSelectBuffConfirm_TypeDefinitionIndex = 45714;
