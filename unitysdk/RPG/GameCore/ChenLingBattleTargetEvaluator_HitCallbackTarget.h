...
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_HITCALLBACKTARGET_METHOD_3_05DA30E7FB8F8C0E_OFFSET UNITYSDK_OFFSET(0x19623DD0)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_HITCALLBACKTARGET_METHOD_3_9D2CBF951E36DF3F_OFFSET UNITYSDK_OFFSET(0x19623D30)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_HITCALLBACKTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x19623DC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleTargetEvaluator_HitCallbackTarget_TypeDefinitionIndex = 14988;
