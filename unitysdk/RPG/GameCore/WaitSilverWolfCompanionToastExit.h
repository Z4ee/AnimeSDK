...
#define RPG_GAMECORE_WAITSILVERWOLFCOMPANIONTOASTEXIT_METHOD_3_60F98438159B785E_OFFSET UNITYSDK_OFFSET(0x1D1BC520)
#define RPG_GAMECORE_WAITSILVERWOLFCOMPANIONTOASTEXIT_METHOD_3_9C4ED2C36C9BD2A3_OFFSET UNITYSDK_OFFSET(0x1D1BC4E0)
#define RPG_GAMECORE_WAITSILVERWOLFCOMPANIONTOASTEXIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1BC510)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitSilverWolfCompanionToastExit_TypeDefinitionIndex = 20902;
