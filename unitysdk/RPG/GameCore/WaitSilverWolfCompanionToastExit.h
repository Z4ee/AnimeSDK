...
#define RPG_GAMECORE_WAITSILVERWOLFCOMPANIONTOASTEXIT_METHOD_3_53C1327CD7F219A7_OFFSET UNITYSDK_OFFSET(0x191088E0)
#define RPG_GAMECORE_WAITSILVERWOLFCOMPANIONTOASTEXIT_METHOD_3_60F98438159B785E_OFFSET UNITYSDK_OFFSET(0x19108960)
#define RPG_GAMECORE_WAITSILVERWOLFCOMPANIONTOASTEXIT__CTOR_OFFSET UNITYSDK_OFFSET(0x19108930)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitSilverWolfCompanionToastExit_TypeDefinitionIndex = 20551;
