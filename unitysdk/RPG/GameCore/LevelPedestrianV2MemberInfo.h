...
#define RPG_GAMECORE_LEVELPEDESTRIANV2MEMBERINFO_METHOD_2_967E368D40202FB1_OFFSET UNITYSDK_OFFSET(0x1C12DB60)
#define RPG_GAMECORE_LEVELPEDESTRIANV2MEMBERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1C12DCB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPedestrianV2MemberInfo_TypeDefinitionIndex = 17093;
