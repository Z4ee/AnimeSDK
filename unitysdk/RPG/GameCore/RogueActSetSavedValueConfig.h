...
#define RPG_GAMECORE_ROGUEACTSETSAVEDVALUECONFIG_METHOD_6_34DF227E25B474D4_OFFSET UNITYSDK_OFFSET(0x18CD4820)
#define RPG_GAMECORE_ROGUEACTSETSAVEDVALUECONFIG_METHOD_6_70689E45322FB8B9_OFFSET UNITYSDK_OFFSET(0x18CD4600)
#define RPG_GAMECORE_ROGUEACTSETSAVEDVALUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CD4740)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActSetSavedValueConfig_TypeDefinitionIndex = 18709;
