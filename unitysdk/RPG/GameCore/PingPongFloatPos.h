...
#define RPG_GAMECORE_PINGPONGFLOATPOS_METHOD_2_4F899698942D93A0_OFFSET UNITYSDK_OFFSET(0x19A0E280)
#define RPG_GAMECORE_PINGPONGFLOATPOS__CTOR_OFFSET UNITYSDK_OFFSET(0x19A0E3B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PingPongFloatPos_TypeDefinitionIndex = 16141;
