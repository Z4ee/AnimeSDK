...
#define RPG_GAMECORE_PINGPONGFLOATPOS_METHOD_2_4F899698942D93A0_OFFSET UNITYSDK_OFFSET(0x174B0E60)
#define RPG_GAMECORE_PINGPONGFLOATPOS__CTOR_OFFSET UNITYSDK_OFFSET(0x174B0F90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PingPongFloatPos_TypeDefinitionIndex = 15571;
