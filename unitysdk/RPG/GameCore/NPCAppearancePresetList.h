...
#define RPG_GAMECORE_NPCAPPEARANCEPRESETLIST_METHOD_2_831F2C4E4A4C3DEB_OFFSET UNITYSDK_OFFSET(0x1BAF0320)
#define RPG_GAMECORE_NPCAPPEARANCEPRESETLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAF03E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NPCAppearancePresetList_TypeDefinitionIndex = 16762;
