...
#define RPG_GAMECORE_EXPEDITIONBATTLEWAITSECONDACTION_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1D7DDCF0)
#define RPG_GAMECORE_EXPEDITIONBATTLEWAITSECONDACTION_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D7DDC10)
#define RPG_GAMECORE_EXPEDITIONBATTLEWAITSECONDACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7DDCE0)
