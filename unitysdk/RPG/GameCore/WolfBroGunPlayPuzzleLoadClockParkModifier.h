...
#define RPG_GAMECORE_WOLFBROGUNPLAYPUZZLELOADCLOCKPARKMODIFIER_METHOD_3_91705C46A68BC551_OFFSET UNITYSDK_OFFSET(0x1D1C2CA0)
#define RPG_GAMECORE_WOLFBROGUNPLAYPUZZLELOADCLOCKPARKMODIFIER_METHOD_3_EC8668DF9B5FCF14_OFFSET UNITYSDK_OFFSET(0x1D1C2BD0)
#define RPG_GAMECORE_WOLFBROGUNPLAYPUZZLELOADCLOCKPARKMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1C2C90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WolfBroGunPlayPuzzleLoadClockParkModifier_TypeDefinitionIndex = 19589;
