...
#define RPG_GAMECORE_WOLFBROGUNPLAYPUZZLELOADCLOCKPARKMODIFIER_METHOD_3_91705C46A68BC551_OFFSET UNITYSDK_OFFSET(0x1910FA50)
#define RPG_GAMECORE_WOLFBROGUNPLAYPUZZLELOADCLOCKPARKMODIFIER_METHOD_3_C0F4784CBA6BC61D_OFFSET UNITYSDK_OFFSET(0x1910F940)
#define RPG_GAMECORE_WOLFBROGUNPLAYPUZZLELOADCLOCKPARKMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1910FA20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WolfBroGunPlayPuzzleLoadClockParkModifier_TypeDefinitionIndex = 19321;
