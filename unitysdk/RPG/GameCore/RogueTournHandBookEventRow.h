...
#define RPG_GAMECORE_ROGUETOURNHANDBOOKEVENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D488F50)
#define RPG_GAMECORE_ROGUETOURNHANDBOOKEVENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D489260)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 EventHandbookID; // 0x38
		::System::UInt32 UnlockDisplayID; // 0x3C
