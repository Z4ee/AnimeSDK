...
#define RPG_GAMECORE_TAROTBOOKCLUEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1E1C6AC0)
#define RPG_GAMECORE_TAROTBOOKCLUEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1C6C80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TarotBookClueRow_TypeDefinitionIndex = 15057;

	class TarotBookClueRow : public ::System::Object
	{
	public:
		::RPG::Client::TextID Name; // 0x10
		::System::UInt32 Style; // 0x20
