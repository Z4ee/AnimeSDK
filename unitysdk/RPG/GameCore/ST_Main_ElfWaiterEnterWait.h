...
#define RPG_GAMECORE_ST_MAIN_ELFWAITERENTERWAIT_METHOD_4_3DB9107124CCCC9E_OFFSET UNITYSDK_OFFSET(0x1D4CA0C0)
#define RPG_GAMECORE_ST_MAIN_ELFWAITERENTERWAIT_METHOD_4_78AB6E9B0A0B5F9B_OFFSET UNITYSDK_OFFSET(0x1D4C9FF0)
#define RPG_GAMECORE_ST_MAIN_ELFWAITERENTERWAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4CA0B0)
