...
#define RPG_GAMECORE_ST_MAIN_ELFWAITERENTERWAIT_METHOD_4_3DB9107124CCCC9E_OFFSET UNITYSDK_OFFSET(0x1B782F80)
#define RPG_GAMECORE_ST_MAIN_ELFWAITERENTERWAIT_METHOD_4_78AB6E9B0A0B5F9B_OFFSET UNITYSDK_OFFSET(0x1B782EB0)
#define RPG_GAMECORE_ST_MAIN_ELFWAITERENTERWAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B782F70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_ElfWaiterEnterWait_TypeDefinitionIndex = 20724;
