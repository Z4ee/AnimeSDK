...
#define RPG_GAMECORE_ST_MAIN_ELFWAITERENTERWAIT_METHOD_4_3DB9107124CCCC9E_OFFSET UNITYSDK_OFFSET(0x17684550)
#define RPG_GAMECORE_ST_MAIN_ELFWAITERENTERWAIT_METHOD_4_9A7F110306EEB989_OFFSET UNITYSDK_OFFSET(0x17697450)
#define RPG_GAMECORE_ST_MAIN_ELFWAITERENTERWAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x17684500)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_ElfWaiterEnterWait_TypeDefinitionIndex = 19704;
