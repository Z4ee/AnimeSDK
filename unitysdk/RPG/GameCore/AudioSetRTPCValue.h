...
#define RPG_GAMECORE_AUDIOSETRTPCVALUE_METHOD_3_1B308CF71E714FC2_OFFSET UNITYSDK_OFFSET(0x1948C7B0)
#define RPG_GAMECORE_AUDIOSETRTPCVALUE_METHOD_3_71C01BBD2555D375_OFFSET UNITYSDK_OFFSET(0x1948C730)
#define RPG_GAMECORE_AUDIOSETRTPCVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1948C780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AudioSetRTPCValue_TypeDefinitionIndex = 19470;
