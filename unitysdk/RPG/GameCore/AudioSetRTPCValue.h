...
#define RPG_GAMECORE_AUDIOSETRTPCVALUE_METHOD_3_1B308CF71E714FC2_OFFSET UNITYSDK_OFFSET(0x186B4AF0)
#define RPG_GAMECORE_AUDIOSETRTPCVALUE_METHOD_3_71C01BBD2555D375_OFFSET UNITYSDK_OFFSET(0x186B4A70)
#define RPG_GAMECORE_AUDIOSETRTPCVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x186B4AC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AudioSetRTPCValue_TypeDefinitionIndex = 19581;
