...
#define RPG_GAMECORE_AUDIOSETRTPCVALUE_METHOD_3_C68FCD99CEC4658B_OFFSET UNITYSDK_OFFSET(0x1CE32DD0)
#define RPG_GAMECORE_AUDIOSETRTPCVALUE_METHOD_3_DAD22F0FB571C142_OFFSET UNITYSDK_OFFSET(0x1CE32D90)
#define RPG_GAMECORE_AUDIOSETRTPCVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE32DC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AudioSetRTPCValue_TypeDefinitionIndex = 20374;
