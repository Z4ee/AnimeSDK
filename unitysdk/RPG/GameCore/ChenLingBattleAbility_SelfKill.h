...
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_SELFKILL_METHOD_3_314749C5BA38AB3A_OFFSET UNITYSDK_OFFSET(0x1707B000)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_SELFKILL_METHOD_3_418EB1CFB6D05B5B_OFFSET UNITYSDK_OFFSET(0x1707B0A0)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_SELFKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x1707B090)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleAbility_SelfKill_TypeDefinitionIndex = 14443;
