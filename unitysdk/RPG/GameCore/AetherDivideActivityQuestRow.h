...
#define RPG_GAMECORE_AETHERDIVIDEACTIVITYQUESTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19457B10)
#define RPG_GAMECORE_AETHERDIVIDEACTIVITYQUESTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19457CF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AetherDivideActivityQuestRow_TypeDefinitionIndex = 10525;
	...
	public:
		...
		::System::UInt32 TypeGroupID; // 0x28
