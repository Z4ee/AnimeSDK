...
#define RPG_GAMECORE_AETHERDIVIDEACTIVITYQUESTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CBC2030)
#define RPG_GAMECORE_AETHERDIVIDEACTIVITYQUESTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CBC2210)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AetherDivideActivityQuestRow_TypeDefinitionIndex = 10914;
