...
#define RPG_GAMECORE_BASESORTCONFIG_METHOD_2_22CBCE4877AEB33A_OFFSET UNITYSDK_OFFSET(0x186EE7F0)
#define RPG_GAMECORE_BASESORTCONFIG_METHOD_2_78081F4A01165F58_OFFSET UNITYSDK_OFFSET(0x186EE660)
#define RPG_GAMECORE_BASESORTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x186EE850)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BaseSortConfig_TypeDefinitionIndex = 22083;
