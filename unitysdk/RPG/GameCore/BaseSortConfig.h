...
#define RPG_GAMECORE_BASESORTCONFIG_METHOD_2_22CBCE4877AEB33A_OFFSET UNITYSDK_OFFSET(0x194C2000)
#define RPG_GAMECORE_BASESORTCONFIG_METHOD_2_78081F4A01165F58_OFFSET UNITYSDK_OFFSET(0x194C1EA0)
#define RPG_GAMECORE_BASESORTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x194C2060)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BaseSortConfig_TypeDefinitionIndex = 21883;
