...
#define RPG_GAMECORE_ACTIONNONECONFIG_METHOD_4_572F81432C5B49D0_OFFSET UNITYSDK_OFFSET(0x16E9AD20)
#define RPG_GAMECORE_ACTIONNONECONFIG_METHOD_4_EA682DFB392A3C5E_OFFSET UNITYSDK_OFFSET(0x16E9AB80)
#define RPG_GAMECORE_ACTIONNONECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16E9ACD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActionNoneConfig_TypeDefinitionIndex = 15612;
