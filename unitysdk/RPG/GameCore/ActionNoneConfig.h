...
#define RPG_GAMECORE_ACTIONNONECONFIG_METHOD_4_572F81432C5B49D0_OFFSET UNITYSDK_OFFSET(0x193CC3D0)
#define RPG_GAMECORE_ACTIONNONECONFIG_METHOD_4_EA682DFB392A3C5E_OFFSET UNITYSDK_OFFSET(0x193CC230)
#define RPG_GAMECORE_ACTIONNONECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x193CC380)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActionNoneConfig_TypeDefinitionIndex = 16182;
