...
#define RPG_GAMECORE_CHIMERADUELSUMVALUEGETTER_METHOD_3_669721172E63FD8B_OFFSET UNITYSDK_OFFSET(0x1C248AB0)
#define RPG_GAMECORE_CHIMERADUELSUMVALUEGETTER_METHOD_3_D5B07AF468EC28BB_OFFSET UNITYSDK_OFFSET(0x1C248B10)
#define RPG_GAMECORE_CHIMERADUELSUMVALUEGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C248B00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelSumValueGetter_TypeDefinitionIndex = 15381;
