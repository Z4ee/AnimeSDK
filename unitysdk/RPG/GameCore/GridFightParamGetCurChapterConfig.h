...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETCURCHAPTERCONFIG_METHOD_6_42E029C64717A60E_OFFSET UNITYSDK_OFFSET(0x197F6950)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETCURCHAPTERCONFIG_METHOD_6_C73CEE6A5F233368_OFFSET UNITYSDK_OFFSET(0x197F6C00)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETCURCHAPTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197F6AD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightParamGetCurChapterConfig_TypeDefinitionIndex = 18518;
