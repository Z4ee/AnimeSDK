...
#define RPG_GAMECORE_COMPLEXSKILLAIALLADJOINCOMBINE_METHOD_3_2F06D0C02706C6A7_OFFSET UNITYSDK_OFFSET(0x17121B70)
#define RPG_GAMECORE_COMPLEXSKILLAIALLADJOINCOMBINE_METHOD_3_83A22ABAF4019E94_OFFSET UNITYSDK_OFFSET(0x17121AE0)
#define RPG_GAMECORE_COMPLEXSKILLAIALLADJOINCOMBINE__CTOR_OFFSET UNITYSDK_OFFSET(0x17121B50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAIAllAdjoinCombine_TypeDefinitionIndex = 14240;
