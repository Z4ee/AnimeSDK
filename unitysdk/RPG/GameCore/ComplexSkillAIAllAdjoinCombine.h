...
#define RPG_GAMECORE_COMPLEXSKILLAIALLADJOINCOMBINE_METHOD_3_2F06D0C02706C6A7_OFFSET UNITYSDK_OFFSET(0x19668ED0)
#define RPG_GAMECORE_COMPLEXSKILLAIALLADJOINCOMBINE_METHOD_3_83A22ABAF4019E94_OFFSET UNITYSDK_OFFSET(0x19668E40)
#define RPG_GAMECORE_COMPLEXSKILLAIALLADJOINCOMBINE__CTOR_OFFSET UNITYSDK_OFFSET(0x19668EB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAIAllAdjoinCombine_TypeDefinitionIndex = 14775;
