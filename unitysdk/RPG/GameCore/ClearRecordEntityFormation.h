...
#define RPG_GAMECORE_CLEARRECORDENTITYFORMATION_METHOD_3_5AAA2A9C4BB85C04_OFFSET UNITYSDK_OFFSET(0x19653C60)
#define RPG_GAMECORE_CLEARRECORDENTITYFORMATION_METHOD_3_F61AFA2B464C0135_OFFSET UNITYSDK_OFFSET(0x19653BE0)
#define RPG_GAMECORE_CLEARRECORDENTITYFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x19653C30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClearRecordEntityFormation_TypeDefinitionIndex = 21528;
