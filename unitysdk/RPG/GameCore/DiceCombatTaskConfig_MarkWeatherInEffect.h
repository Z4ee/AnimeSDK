...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_MARKWEATHERINEFFECT_METHOD_3_3160114ED26194EF_OFFSET UNITYSDK_OFFSET(0x17170E80)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_MARKWEATHERINEFFECT_METHOD_3_4733E81D04D726A9_OFFSET UNITYSDK_OFFSET(0x1716D5C0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_MARKWEATHERINEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1716D570)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_MarkWeatherInEffect_TypeDefinitionIndex = 14836;
