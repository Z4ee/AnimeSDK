...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_MARKWEATHERINEFFECT_METHOD_3_22E4040603D128B5_OFFSET UNITYSDK_OFFSET(0x1C119860)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_MARKWEATHERINEFFECT_METHOD_3_4733E81D04D726A9_OFFSET UNITYSDK_OFFSET(0x1C119970)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_MARKWEATHERINEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C119960)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_MarkWeatherInEffect_TypeDefinitionIndex = 15549;
