...
#define RPG_GAMECORE_CHANGEMONSTERHEADICON_METHOD_3_3025E06ECA4C97CD_OFFSET UNITYSDK_OFFSET(0x187C87B0)
#define RPG_GAMECORE_CHANGEMONSTERHEADICON_METHOD_3_E2F513FECD3F3858_OFFSET UNITYSDK_OFFSET(0x187C8830)
#define RPG_GAMECORE_CHANGEMONSTERHEADICON__CTOR_OFFSET UNITYSDK_OFFSET(0x187C8800)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChangeMonsterHeadIcon_TypeDefinitionIndex = 22660;
