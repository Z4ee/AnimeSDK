...
#define RPG_GAMECORE_CHANGEMONSTERHEADICON_METHOD_3_3025E06ECA4C97CD_OFFSET UNITYSDK_OFFSET(0x170638C0)
#define RPG_GAMECORE_CHANGEMONSTERHEADICON_METHOD_3_E2F513FECD3F3858_OFFSET UNITYSDK_OFFSET(0x17063940)
#define RPG_GAMECORE_CHANGEMONSTERHEADICON__CTOR_OFFSET UNITYSDK_OFFSET(0x17063910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChangeMonsterHeadIcon_TypeDefinitionIndex = 21922;
