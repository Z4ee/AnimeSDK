...
#define RPG_GAMECORE_TRIGGERLEAVECHESSROGUE_METHOD_3_34F4F33ACF68FF46_OFFSET UNITYSDK_OFFSET(0x178C8B60)
#define RPG_GAMECORE_TRIGGERLEAVECHESSROGUE_METHOD_3_9AFEF76AE47197B2_OFFSET UNITYSDK_OFFSET(0x178C8C70)
#define RPG_GAMECORE_TRIGGERLEAVECHESSROGUE__CTOR_OFFSET UNITYSDK_OFFSET(0x178C8C40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerLeaveChessRogue_TypeDefinitionIndex = 20277;
