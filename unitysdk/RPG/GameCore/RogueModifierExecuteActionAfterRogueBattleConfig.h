...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONAFTERROGUEBATTLECONFIG_METHOD_3_01DD31E93F43D2DE_OFFSET UNITYSDK_OFFSET(0x1762EE00)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONAFTERROGUEBATTLECONFIG_METHOD_3_666FE5BB922D17D7_OFFSET UNITYSDK_OFFSET(0x1762EED0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONAFTERROGUEBATTLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1762EE80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionAfterRogueBattleConfig_TypeDefinitionIndex = 16486;
