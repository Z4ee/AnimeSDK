...
#define RPG_GAMECORE_ADVISOMETRICNOTIFY_METHOD_3_1D9AF81D2B2FBE6C_OFFSET UNITYSDK_OFFSET(0x18653D80)
#define RPG_GAMECORE_ADVISOMETRICNOTIFY_METHOD_3_DCE0DBD4AFF1D888_OFFSET UNITYSDK_OFFSET(0x18653BA0)
#define RPG_GAMECORE_ADVISOMETRICNOTIFY__CTOR_OFFSET UNITYSDK_OFFSET(0x18653CA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvIsometricNotify_TypeDefinitionIndex = 21083;
