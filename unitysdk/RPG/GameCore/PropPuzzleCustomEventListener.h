...
#define RPG_GAMECORE_PROPPUZZLECUSTOMEVENTLISTENER_METHOD_3_C1C28E353C10839D_OFFSET UNITYSDK_OFFSET(0x1D17FC10)
#define RPG_GAMECORE_PROPPUZZLECUSTOMEVENTLISTENER_METHOD_3_F1BD924450A4351C_OFFSET UNITYSDK_OFFSET(0x1D17FBC0)
#define RPG_GAMECORE_PROPPUZZLECUSTOMEVENTLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D17FC00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropPuzzleCustomEventListener_TypeDefinitionIndex = 21739;
