...
#define RPG_GAMECORE_MESSAGESECTIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1AF60B30)
#define RPG_GAMECORE_MESSAGESECTIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF60CF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MessageSectionRow_TypeDefinitionIndex = 13876;
	...
	public:
		...
		::System::Boolean IsPerformMessage; // 0x1C
