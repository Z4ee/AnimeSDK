...
#define RPG_GAMECORE_MESSAGESECTIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x199168B0)
#define RPG_GAMECORE_MESSAGESECTIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19916A70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MessageSectionRow_TypeDefinitionIndex = 13728;
