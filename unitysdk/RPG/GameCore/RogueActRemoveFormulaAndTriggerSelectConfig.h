...
#define RPG_GAMECORE_ROGUEACTREMOVEFORMULAANDTRIGGERSELECTCONFIG_METHOD_6_26A971C313B1B72C_OFFSET UNITYSDK_OFFSET(0x175C5640)
#define RPG_GAMECORE_ROGUEACTREMOVEFORMULAANDTRIGGERSELECTCONFIG_METHOD_6_BB37649E48D06461_OFFSET UNITYSDK_OFFSET(0x175C5860)
#define RPG_GAMECORE_ROGUEACTREMOVEFORMULAANDTRIGGERSELECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175C5780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActRemoveFormulaAndTriggerSelectConfig_TypeDefinitionIndex = 18062;
