...
#define RPG_GAMECORE_ROGUEACTREMOVEFORMULAANDTRIGGERSELECTCONFIG_METHOD_6_BB37649E48D06461_OFFSET UNITYSDK_OFFSET(0x1C49D830)
#define RPG_GAMECORE_ROGUEACTREMOVEFORMULAANDTRIGGERSELECTCONFIG_METHOD_6_BB3F6FD9B1F9E13D_OFFSET UNITYSDK_OFFSET(0x1C49D7E0)
#define RPG_GAMECORE_ROGUEACTREMOVEFORMULAANDTRIGGERSELECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C49D820)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActRemoveFormulaAndTriggerSelectConfig_TypeDefinitionIndex = 18950;
