...
#define RPG_GAMECORE_PERFLOORCONFLICTRELATIVEMISSIONBAKEDDATA_METHOD_2_1829A6E5018D80CC_OFFSET UNITYSDK_OFFSET(0x1D41ACE0)
#define RPG_GAMECORE_PERFLOORCONFLICTRELATIVEMISSIONBAKEDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1D41AE10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PerFloorConflictRelativeMissionBakedData_TypeDefinitionIndex = 16961;
