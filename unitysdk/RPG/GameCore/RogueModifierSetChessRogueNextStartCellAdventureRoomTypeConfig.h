...
#define RPG_GAMECORE_ROGUEMODIFIERSETCHESSROGUENEXTSTARTCELLADVENTUREROOMTYPECONFIG_METHOD_3_0D1C13FA552935F0_OFFSET UNITYSDK_OFFSET(0x18D46260)
#define RPG_GAMECORE_ROGUEMODIFIERSETCHESSROGUENEXTSTARTCELLADVENTUREROOMTYPECONFIG_METHOD_3_DB8F44B55C087E99_OFFSET UNITYSDK_OFFSET(0x18D46190)
#define RPG_GAMECORE_ROGUEMODIFIERSETCHESSROGUENEXTSTARTCELLADVENTUREROOMTYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D46210)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierSetChessRogueNextStartCellAdventureRoomTypeConfig_TypeDefinitionIndex = 17072;
