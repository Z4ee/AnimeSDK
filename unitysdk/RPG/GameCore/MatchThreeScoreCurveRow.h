...
#define RPG_GAMECORE_MATCHTHREESCORECURVEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x198F45A0)
#define RPG_GAMECORE_MATCHTHREESCORECURVEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x198F4D70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MatchThreeScoreCurveRow_TypeDefinitionIndex = 11403;

	class MatchThreeScoreCurveRow : public ::System::Object
	{
	public:
		::System::UInt32 HPDecrease; // 0x10
		::System::UInt32 AddHigh; // 0x14
		::System::UInt32 CurveID; // 0x18
		::System::UInt32 DelayTime; // 0x1C
		::System::UInt32 AddLow; // 0x20
		::System::Single AddCurveRatio; // 0x24
		::System::UInt32 PlayerStep; // 0x28
