...
#define RPG_GAMECORE_BYCOMPARECURRENTSKILLUSEPARAM_METHOD_4_E10A1F890BC682ED_OFFSET UNITYSDK_OFFSET(0x17006210)
#define RPG_GAMECORE_BYCOMPARECURRENTSKILLUSEPARAM_METHOD_4_FC12403D96AEBABD_OFFSET UNITYSDK_OFFSET(0x17006140)
#define RPG_GAMECORE_BYCOMPARECURRENTSKILLUSEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x170061C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareCurrentSkillUseParam_TypeDefinitionIndex = 20737;
