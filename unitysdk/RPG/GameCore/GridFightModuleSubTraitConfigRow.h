...
#define RPG_GAMECORE_GRIDFIGHTMODULESUBTRAITCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1EE6FCB0)
#define RPG_GAMECORE_GRIDFIGHTMODULESUBTRAITCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1EE6FE20)
