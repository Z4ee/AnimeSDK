...
#define RPG_GAMECORE_BYCOMPARENPCMONSTERCHECKSTATE_METHOD_4_048F7EA13D1E5858_OFFSET UNITYSDK_OFFSET(0x17010AA0)
#define RPG_GAMECORE_BYCOMPARENPCMONSTERCHECKSTATE_METHOD_4_412BD1226521B569_OFFSET UNITYSDK_OFFSET(0x170109D0)
#define RPG_GAMECORE_BYCOMPARENPCMONSTERCHECKSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x17010A50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareNPCMonsterCheckState_TypeDefinitionIndex = 19739;
