...
#define RPG_GAMECORE_BYCOMPARENPCMONSTERCHECKSTATE_METHOD_4_048F7EA13D1E5858_OFFSET UNITYSDK_OFFSET(0x19CF9190)
#define RPG_GAMECORE_BYCOMPARENPCMONSTERCHECKSTATE_METHOD_4_0E9F44B9511C367D_OFFSET UNITYSDK_OFFSET(0x19CF9490)
#define RPG_GAMECORE_BYCOMPARENPCMONSTERCHECKSTATE_METHOD_4_C2C21AF74B31389A_OFFSET UNITYSDK_OFFSET(0x19CF9460)
#define RPG_GAMECORE_BYCOMPARENPCMONSTERCHECKSTATE_METHOD_4_FC7C0D04CDD2BD82_OFFSET UNITYSDK_OFFSET(0x19CF9150)
#define RPG_GAMECORE_BYCOMPARENPCMONSTERCHECKSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19CF9180)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareNPCMonsterCheckState_TypeDefinitionIndex = 20779;
