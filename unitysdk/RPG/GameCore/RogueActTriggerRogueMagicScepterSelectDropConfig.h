...
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMAGICSCEPTERSELECTDROPCONFIG_METHOD_6_450007E35E9F3F04_OFFSET UNITYSDK_OFFSET(0x18CD7A70)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMAGICSCEPTERSELECTDROPCONFIG_METHOD_6_6CC79D546E936569_OFFSET UNITYSDK_OFFSET(0x18CD7850)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMAGICSCEPTERSELECTDROPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CD7990)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActTriggerRogueMagicScepterSelectDropConfig_TypeDefinitionIndex = 18695;
