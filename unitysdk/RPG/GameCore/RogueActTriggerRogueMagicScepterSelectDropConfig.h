...
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMAGICSCEPTERSELECTDROPCONFIG_METHOD_6_450007E35E9F3F04_OFFSET UNITYSDK_OFFSET(0x175CBDA0)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMAGICSCEPTERSELECTDROPCONFIG_METHOD_6_6CC79D546E936569_OFFSET UNITYSDK_OFFSET(0x175CBB80)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMAGICSCEPTERSELECTDROPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175CBCC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActTriggerRogueMagicScepterSelectDropConfig_TypeDefinitionIndex = 18050;
