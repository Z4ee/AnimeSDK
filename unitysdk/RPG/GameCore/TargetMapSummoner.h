...
#define RPG_GAMECORE_TARGETMAPSUMMONER_METHOD_3_D0F7E4D2667872D2_OFFSET UNITYSDK_OFFSET(0x177C4300)
#define RPG_GAMECORE_TARGETMAPSUMMONER_METHOD_3_DCD2D56BEA1A9566_OFFSET UNITYSDK_OFFSET(0x177C41D0)
#define RPG_GAMECORE_TARGETMAPSUMMONER__CTOR_OFFSET UNITYSDK_OFFSET(0x177C42E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapSummoner_TypeDefinitionIndex = 22229;
