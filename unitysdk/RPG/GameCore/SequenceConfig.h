...
#define RPG_GAMECORE_SEQUENCECONFIG_METHOD_4_05479A80423B2C4C_OFFSET UNITYSDK_OFFSET(0x18E01FF0)
#define RPG_GAMECORE_SEQUENCECONFIG_METHOD_4_60F22371C24186DD_OFFSET UNITYSDK_OFFSET(0x18E01F70)
#define RPG_GAMECORE_SEQUENCECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18E01FC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SequenceConfig_TypeDefinitionIndex = 22768;
