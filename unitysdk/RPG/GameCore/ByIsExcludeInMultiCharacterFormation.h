...
#define RPG_GAMECORE_BYISEXCLUDEINMULTICHARACTERFORMATION_METHOD_4_0762C3FF68ECE466_OFFSET UNITYSDK_OFFSET(0x1A8E1830)
#define RPG_GAMECORE_BYISEXCLUDEINMULTICHARACTERFORMATION_METHOD_4_107E6176EA54CFDD_OFFSET UNITYSDK_OFFSET(0x1A8E19F0)
#define RPG_GAMECORE_BYISEXCLUDEINMULTICHARACTERFORMATION_METHOD_4_82CBA3C6851A5C47_OFFSET UNITYSDK_OFFSET(0x1A8E1870)
#define RPG_GAMECORE_BYISEXCLUDEINMULTICHARACTERFORMATION_METHOD_4_86CE47C150597AB3_OFFSET UNITYSDK_OFFSET(0x1A8E1A20)
#define RPG_GAMECORE_BYISEXCLUDEINMULTICHARACTERFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8E1860)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsExcludeInMultiCharacterFormation_TypeDefinitionIndex = 21828;
