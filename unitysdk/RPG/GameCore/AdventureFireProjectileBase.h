...
#define RPG_GAMECORE_ADVENTUREFIREPROJECTILEBASE_METHOD_3_4C8F1FDCFAD18A7E_OFFSET UNITYSDK_OFFSET(0x1CDF1FF0)
#define RPG_GAMECORE_ADVENTUREFIREPROJECTILEBASE_METHOD_3_C484CAE0A248DB27_OFFSET UNITYSDK_OFFSET(0x1CDF1E40)
#define RPG_GAMECORE_ADVENTUREFIREPROJECTILEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDF1E30)
