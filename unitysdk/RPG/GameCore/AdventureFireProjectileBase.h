...
#define RPG_GAMECORE_ADVENTUREFIREPROJECTILEBASE_METHOD_3_0735D40079D80F25_OFFSET UNITYSDK_OFFSET(0x16F53FF0)
#define RPG_GAMECORE_ADVENTUREFIREPROJECTILEBASE_METHOD_3_C484CAE0A248DB27_OFFSET UNITYSDK_OFFSET(0x16F53DE0)
#define RPG_GAMECORE_ADVENTUREFIREPROJECTILEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F53DB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureFireProjectileBase_TypeDefinitionIndex = 18492;
