...
#define RPG_GAMECORE_SKILLCONDITIONPRESHOWCONFIG_METHOD_2_6DAB9C0C54804E22_OFFSET UNITYSDK_OFFSET(0x1D0A22A0)
#define RPG_GAMECORE_SKILLCONDITIONPRESHOWCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0A23B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SkillConditionPreshowConfig_TypeDefinitionIndex = 17966;
