...
#define RPG_GAMECORE_TARGETFETCHNEXTSKILLCASTER_METHOD_4_2C598428CE8BE1F1_OFFSET UNITYSDK_OFFSET(0x1D0BB1D0)
#define RPG_GAMECORE_TARGETFETCHNEXTSKILLCASTER_METHOD_4_5C8D2A1C277BEB9C_OFFSET UNITYSDK_OFFSET(0x1D0BB250)
#define RPG_GAMECORE_TARGETFETCHNEXTSKILLCASTER_METHOD_4_620D272EA63DC9D9_OFFSET UNITYSDK_OFFSET(0x1D0BB2B0)
#define RPG_GAMECORE_TARGETFETCHNEXTSKILLCASTER_METHOD_4_63BD0030280AA40C_OFFSET UNITYSDK_OFFSET(0x1D0BB2D0)
#define RPG_GAMECORE_TARGETFETCHNEXTSKILLCASTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0BB240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchNextSkillCaster_TypeDefinitionIndex = 23120;
