...
#define RPG_GAMECORE_SWITCHCASEBYTEAMMATECOUNT_METHOD_3_2BA722572EFCCE3F_OFFSET UNITYSDK_OFFSET(0x17792CC0)
#define RPG_GAMECORE_SWITCHCASEBYTEAMMATECOUNT_METHOD_3_6C86BCC2C8F1198E_OFFSET UNITYSDK_OFFSET(0x17792C30)
#define RPG_GAMECORE_SWITCHCASEBYTEAMMATECOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x17792C90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchCaseByTeammateCount_TypeDefinitionIndex = 22046;
