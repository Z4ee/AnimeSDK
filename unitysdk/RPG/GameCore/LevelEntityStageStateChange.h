...
#define RPG_GAMECORE_LEVELENTITYSTAGESTATECHANGE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xA9896A0)
#define RPG_GAMECORE_LEVELENTITYSTAGESTATECHANGE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xA989650)
#define RPG_GAMECORE_LEVELENTITYSTAGESTATECHANGE_GET_ISONSTAGE_OFFSET UNITYSDK_OFFSET(0xA989700)
#define RPG_GAMECORE_LEVELENTITYSTAGESTATECHANGE_GET_REASONKEY_OFFSET UNITYSDK_OFFSET(0xA989710)
#define RPG_GAMECORE_LEVELENTITYSTAGESTATECHANGE_GET_SOURCEENTITY_OFFSET UNITYSDK_OFFSET(0xA9896F0)
#define RPG_GAMECORE_LEVELENTITYSTAGESTATECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0xA989640)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelEntityStageStateChange_TypeDefinitionIndex = 45691;
