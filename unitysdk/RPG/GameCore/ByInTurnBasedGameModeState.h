...
#define RPG_GAMECORE_BYINTURNBASEDGAMEMODESTATE_METHOD_4_1A7B8403EF127C96_OFFSET UNITYSDK_OFFSET(0x1874D1B0)
#define RPG_GAMECORE_BYINTURNBASEDGAMEMODESTATE_METHOD_4_45AE92BFBB994368_OFFSET UNITYSDK_OFFSET(0x1874D0E0)
#define RPG_GAMECORE_BYINTURNBASEDGAMEMODESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1874D160)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByInTurnBasedGameModeState_TypeDefinitionIndex = 22515;
