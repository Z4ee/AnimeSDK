...
#define RPG_GAMECORE_BYINTURNBASEDGAMEMODESTATE_METHOD_4_0AA49AE794563DC2_OFFSET UNITYSDK_OFFSET(0x1CF2CE00)
#define RPG_GAMECORE_BYINTURNBASEDGAMEMODESTATE_METHOD_4_1A7B8403EF127C96_OFFSET UNITYSDK_OFFSET(0x1CF2CC80)
#define RPG_GAMECORE_BYINTURNBASEDGAMEMODESTATE_METHOD_4_2486542621D8AE95_OFFSET UNITYSDK_OFFSET(0x1CF2CE30)
#define RPG_GAMECORE_BYINTURNBASEDGAMEMODESTATE_METHOD_4_637B1BF72A350E47_OFFSET UNITYSDK_OFFSET(0x1CF2CC40)
#define RPG_GAMECORE_BYINTURNBASEDGAMEMODESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF2CC70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByInTurnBasedGameModeState_TypeDefinitionIndex = 23281;
