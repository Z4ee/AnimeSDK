...
#define RPG_GAMECORE_PINBALLPUZZLELAUNCH_METHOD_3_3CF7D1FE614814CC_OFFSET UNITYSDK_OFFSET(0x1B4C5B70)
#define RPG_GAMECORE_PINBALLPUZZLELAUNCH_METHOD_3_8FC78A66366AE287_OFFSET UNITYSDK_OFFSET(0x1B4C5BB0)
#define RPG_GAMECORE_PINBALLPUZZLELAUNCH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4C5BA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PinballPuzzleLaunch_TypeDefinitionIndex = 21199;
