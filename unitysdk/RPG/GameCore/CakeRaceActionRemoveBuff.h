...
#define RPG_GAMECORE_CAKERACEACTIONREMOVEBUFF_METHOD_3_708B091D96508639_OFFSET UNITYSDK_OFFSET(0x1D0FB4E0)
#define RPG_GAMECORE_CAKERACEACTIONREMOVEBUFF_METHOD_3_C6C4729E892CE4F1_OFFSET UNITYSDK_OFFSET(0x1D0FB480)
#define RPG_GAMECORE_CAKERACEACTIONREMOVEBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0FB4D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionRemoveBuff_TypeDefinitionIndex = 18120;
