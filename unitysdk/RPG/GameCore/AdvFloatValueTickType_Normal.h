...
#define RPG_GAMECORE_ADVFLOATVALUETICKTYPE_NORMAL_METHOD_3_8F6EE25BAB734A0D_OFFSET UNITYSDK_OFFSET(0x16F2F010)
#define RPG_GAMECORE_ADVFLOATVALUETICKTYPE_NORMAL_METHOD_3_E1EA4469C92FDDF4_OFFSET UNITYSDK_OFFSET(0x16F2F650)
#define RPG_GAMECORE_ADVFLOATVALUETICKTYPE_NORMAL__CTOR_OFFSET UNITYSDK_OFFSET(0x16F2F000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvFloatValueTickType_Normal_TypeDefinitionIndex = 19347;
