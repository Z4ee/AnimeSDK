...
#define RPG_GAMECORE_ADVFLOATVALUETICKTYPE_NORMAL_METHOD_3_8F6EE25BAB734A0D_OFFSET UNITYSDK_OFFSET(0x1BE1CF80)
#define RPG_GAMECORE_ADVFLOATVALUETICKTYPE_NORMAL_METHOD_3_E1EA4469C92FDDF4_OFFSET UNITYSDK_OFFSET(0x1BE1D5C0)
#define RPG_GAMECORE_ADVFLOATVALUETICKTYPE_NORMAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE1CF70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvFloatValueTickType_Normal_TypeDefinitionIndex = 20232;
