...
#define RPG_GAMECORE_ADVFLOATVALUETICKTYPE_NORMAL_METHOD_3_8F6EE25BAB734A0D_OFFSET UNITYSDK_OFFSET(0x194249B0)
#define RPG_GAMECORE_ADVFLOATVALUETICKTYPE_NORMAL_METHOD_3_E1EA4469C92FDDF4_OFFSET UNITYSDK_OFFSET(0x19424FF0)
#define RPG_GAMECORE_ADVFLOATVALUETICKTYPE_NORMAL__CTOR_OFFSET UNITYSDK_OFFSET(0x194249A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvFloatValueTickType_Normal_TypeDefinitionIndex = 19868;
