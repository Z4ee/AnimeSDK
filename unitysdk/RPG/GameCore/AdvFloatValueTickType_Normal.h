...
#define RPG_GAMECORE_ADVFLOATVALUETICKTYPE_NORMAL_METHOD_3_8F6EE25BAB734A0D_OFFSET UNITYSDK_OFFSET(0x186511E0)
#define RPG_GAMECORE_ADVFLOATVALUETICKTYPE_NORMAL_METHOD_3_E1EA4469C92FDDF4_OFFSET UNITYSDK_OFFSET(0x18651820)
#define RPG_GAMECORE_ADVFLOATVALUETICKTYPE_NORMAL__CTOR_OFFSET UNITYSDK_OFFSET(0x186511D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvFloatValueTickType_Normal_TypeDefinitionIndex = 20006;
