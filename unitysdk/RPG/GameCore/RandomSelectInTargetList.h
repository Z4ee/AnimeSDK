...
#define RPG_GAMECORE_RANDOMSELECTINTARGETLIST_METHOD_3_154D38ECC8163566_OFFSET UNITYSDK_OFFSET(0x175808D0)
#define RPG_GAMECORE_RANDOMSELECTINTARGETLIST_METHOD_3_25AA08CC24E7811A_OFFSET UNITYSDK_OFFSET(0x175807C0)
#define RPG_GAMECORE_RANDOMSELECTINTARGETLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x175808A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RandomSelectInTargetList_TypeDefinitionIndex = 20656;
