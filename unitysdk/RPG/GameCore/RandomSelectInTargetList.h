...
#define RPG_GAMECORE_RANDOMSELECTINTARGETLIST_METHOD_3_154D38ECC8163566_OFFSET UNITYSDK_OFFSET(0x18C8A630)
#define RPG_GAMECORE_RANDOMSELECTINTARGETLIST_METHOD_3_25AA08CC24E7811A_OFFSET UNITYSDK_OFFSET(0x18C8A520)
#define RPG_GAMECORE_RANDOMSELECTINTARGETLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x18C8A600)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RandomSelectInTargetList_TypeDefinitionIndex = 21351;
