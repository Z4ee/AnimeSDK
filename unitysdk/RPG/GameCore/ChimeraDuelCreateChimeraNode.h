...
#define RPG_GAMECORE_CHIMERADUELCREATECHIMERANODE_METHOD_3_31BBDCB7051935B9_OFFSET UNITYSDK_OFFSET(0x1C394090)
#define RPG_GAMECORE_CHIMERADUELCREATECHIMERANODE_METHOD_3_C4C329187C755E17_OFFSET UNITYSDK_OFFSET(0x1C394030)
#define RPG_GAMECORE_CHIMERADUELCREATECHIMERANODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C394080)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelCreateChimeraNode_TypeDefinitionIndex = 15352;
