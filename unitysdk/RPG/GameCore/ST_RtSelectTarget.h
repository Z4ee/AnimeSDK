...
#define RPG_GAMECORE_ST_RTSELECTTARGET_METHOD_4_0B07E09C09ACF7AF_OFFSET UNITYSDK_OFFSET(0x18DF5C60)
#define RPG_GAMECORE_ST_RTSELECTTARGET_METHOD_4_22DE152C31FCA315_OFFSET UNITYSDK_OFFSET(0x18DF5D30)
#define RPG_GAMECORE_ST_RTSELECTTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x18DF5CE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_RtSelectTarget_TypeDefinitionIndex = 23066;
