...
#define RPG_GAMECORE_SPECIALCHESTFINDDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D548A80)
#define RPG_GAMECORE_SPECIALCHESTFINDDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D548DA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SpecialChestFindDataRow_TypeDefinitionIndex = 13190;
	...
	public:
		...
		::System::Boolean IsUseSpecialMappinginfo; // 0x24
		::System::UInt32 ReplaceGroupID; // 0x28
		::System::UInt32 ReplaceInstanceID; // 0x2C
