...
#define RPG_GAMECORE_VALUEEVALUATORVEC2_METHOD_2_BBC35E0C2AE1CFC0_OFFSET UNITYSDK_OFFSET(0x1D6973C0)
#define RPG_GAMECORE_VALUEEVALUATORVEC2__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6974A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ValueEvaluatorVec2_TypeDefinitionIndex = 23763;
