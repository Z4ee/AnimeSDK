...
#define RPG_GAMECORE_BYREGIONERASTATE_METHOD_4_6D8FAEEEE555186E_OFFSET UNITYSDK_OFFSET(0x1875ED40)
#define RPG_GAMECORE_BYREGIONERASTATE_METHOD_4_B2035B0A97421840_OFFSET UNITYSDK_OFFSET(0x1875EC70)
#define RPG_GAMECORE_BYREGIONERASTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1875ECF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByRegionEraState_TypeDefinitionIndex = 21210;
