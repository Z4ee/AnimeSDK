...
#define RPG_GAMECORE_BASESCROLLGAMECONFIG_METHOD_2_0609B83BC25B41A6_OFFSET UNITYSDK_OFFSET(0x1A3E1750)
#define RPG_GAMECORE_BASESCROLLGAMECONFIG_METHOD_2_1A742A188B3B727F_OFFSET UNITYSDK_OFFSET(0x1A3E1960)
#define RPG_GAMECORE_BASESCROLLGAMECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3E1940)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BaseScrollGameConfig_TypeDefinitionIndex = 18072;
