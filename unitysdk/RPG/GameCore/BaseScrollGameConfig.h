...
#define RPG_GAMECORE_BASESCROLLGAMECONFIG_METHOD_2_0609B83BC25B41A6_OFFSET UNITYSDK_OFFSET(0x16FCA620)
#define RPG_GAMECORE_BASESCROLLGAMECONFIG_METHOD_2_1A742A188B3B727F_OFFSET UNITYSDK_OFFSET(0x16FCA830)
#define RPG_GAMECORE_BASESCROLLGAMECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16FCA810)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BaseScrollGameConfig_TypeDefinitionIndex = 17257;
