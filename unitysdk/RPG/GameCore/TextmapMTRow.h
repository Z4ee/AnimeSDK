...
#define RPG_GAMECORE_TEXTMAPMTROW_FROMBINARYWITHOUTNEW_OFFSET UNITYSDK_OFFSET(0x19097A60)
#define RPG_GAMECORE_TEXTMAPMTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19097C20)
#define RPG_GAMECORE_TEXTMAPMTROW_FROMTABLEOFFSET_OFFSET UNITYSDK_OFFSET(0x190979E0)
#define RPG_GAMECORE_TEXTMAPMTROW_RESET_OFFSET UNITYSDK_OFFSET(0x19097A40)
#define RPG_GAMECORE_TEXTMAPMTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19097E10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TextmapMTRow_TypeDefinitionIndex = 14493;
