...
#define RPG_GAMECORE_ADVBYCHECKWINDOWINSLOT_METHOD_4_1BE811B163AC49C3_OFFSET UNITYSDK_OFFSET(0x1D6A8DE0)
#define RPG_GAMECORE_ADVBYCHECKWINDOWINSLOT_METHOD_4_31A2FE37499A75A0_OFFSET UNITYSDK_OFFSET(0x1D6A8B90)
#define RPG_GAMECORE_ADVBYCHECKWINDOWINSLOT_METHOD_4_4C880308DC266555_OFFSET UNITYSDK_OFFSET(0x1D6A8E10)
#define RPG_GAMECORE_ADVBYCHECKWINDOWINSLOT_METHOD_4_6B226727F04CD919_OFFSET UNITYSDK_OFFSET(0x1D6A8BD0)
#define RPG_GAMECORE_ADVBYCHECKWINDOWINSLOT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6A8BC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvByCheckWindowInSlot_TypeDefinitionIndex = 21042;
