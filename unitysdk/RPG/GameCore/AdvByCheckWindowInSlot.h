...
#define RPG_GAMECORE_ADVBYCHECKWINDOWINSLOT_METHOD_4_1487FD0462CF124B_OFFSET UNITYSDK_OFFSET(0x18646ED0)
#define RPG_GAMECORE_ADVBYCHECKWINDOWINSLOT_METHOD_4_6B226727F04CD919_OFFSET UNITYSDK_OFFSET(0x18646FA0)
#define RPG_GAMECORE_ADVBYCHECKWINDOWINSLOT__CTOR_OFFSET UNITYSDK_OFFSET(0x18646F50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvByCheckWindowInSlot_TypeDefinitionIndex = 20262;
