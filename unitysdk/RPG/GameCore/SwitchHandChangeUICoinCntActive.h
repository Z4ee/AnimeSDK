...
#define RPG_GAMECORE_SWITCHHANDCHANGEUICOINCNTACTIVE_METHOD_3_2544419524AAF298_OFFSET UNITYSDK_OFFSET(0x17794940)
#define RPG_GAMECORE_SWITCHHANDCHANGEUICOINCNTACTIVE_METHOD_3_7A91812C667A16F1_OFFSET UNITYSDK_OFFSET(0x177949C0)
#define RPG_GAMECORE_SWITCHHANDCHANGEUICOINCNTACTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x17794990)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchHandChangeUICoinCntActive_TypeDefinitionIndex = 19298;
