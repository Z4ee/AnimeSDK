...
#define RPG_GAMECORE_SWITCHHANDCHANGEUICOINCNTACTIVE_METHOD_3_02E0B058FE01434A_OFFSET UNITYSDK_OFFSET(0x1B435FA0)
#define RPG_GAMECORE_SWITCHHANDCHANGEUICOINCNTACTIVE_METHOD_3_7A91812C667A16F1_OFFSET UNITYSDK_OFFSET(0x1B435FE0)
#define RPG_GAMECORE_SWITCHHANDCHANGEUICOINCNTACTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B435FD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchHandChangeUICoinCntActive_TypeDefinitionIndex = 20180;
