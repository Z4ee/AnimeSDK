...
#define RPG_GAMECORE_SETDYNAMICVALUEBYPRECALCHPDAMAGE_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1C2E5980)
#define RPG_GAMECORE_SETDYNAMICVALUEBYPRECALCHPDAMAGE_METHOD_4_B5DD7CADEAC6D71D_OFFSET UNITYSDK_OFFSET(0x1C2E51D0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYPRECALCHPDAMAGE_METHOD_4_FD846E23329CD814_OFFSET UNITYSDK_OFFSET(0x1C2E5510)
#define RPG_GAMECORE_SETDYNAMICVALUEBYPRECALCHPDAMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2E5430)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByPreCalcHPDamage_TypeDefinitionIndex = 22432;
