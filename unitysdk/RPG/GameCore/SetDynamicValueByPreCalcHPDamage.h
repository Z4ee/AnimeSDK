...
#define RPG_GAMECORE_SETDYNAMICVALUEBYPRECALCHPDAMAGE_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x19C42980)
#define RPG_GAMECORE_SETDYNAMICVALUEBYPRECALCHPDAMAGE_METHOD_4_ABCF33378AD8F7A2_OFFSET UNITYSDK_OFFSET(0x19C42940)
#define RPG_GAMECORE_SETDYNAMICVALUEBYPRECALCHPDAMAGE_METHOD_4_FD846E23329CD814_OFFSET UNITYSDK_OFFSET(0x19C3D300)
#define RPG_GAMECORE_SETDYNAMICVALUEBYPRECALCHPDAMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C3D1C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByPreCalcHPDamage_TypeDefinitionIndex = 21998;
