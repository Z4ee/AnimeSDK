...
#define RPG_GAMECORE_TRIGGERBLENDSHAPESEMOTION_METHOD_3_3568876E9B39B206_OFFSET UNITYSDK_OFFSET(0x1B046D20)
#define RPG_GAMECORE_TRIGGERBLENDSHAPESEMOTION_METHOD_3_B8AD0A3A3842B9EF_OFFSET UNITYSDK_OFFSET(0x1B046CD0)
#define RPG_GAMECORE_TRIGGERBLENDSHAPESEMOTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B046D10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerBlendShapesEmotion_TypeDefinitionIndex = 21084;
