...
#define RPG_GAMECORE_PERFORMANCESTANDALONEPLAYOVERRIDECONFIG_METHOD_2_CEC47A98E538DC1E_OFFSET UNITYSDK_OFFSET(0x174A20B0)
#define RPG_GAMECORE_PERFORMANCESTANDALONEPLAYOVERRIDECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x174A2210)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PerformanceStandalonePlayOverrideConfig_TypeDefinitionIndex = 17448;
