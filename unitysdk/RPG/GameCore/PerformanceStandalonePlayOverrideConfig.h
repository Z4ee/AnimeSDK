...
#define RPG_GAMECORE_PERFORMANCESTANDALONEPLAYOVERRIDECONFIG_METHOD_2_CEC47A98E538DC1E_OFFSET UNITYSDK_OFFSET(0x199FE740)
#define RPG_GAMECORE_PERFORMANCESTANDALONEPLAYOVERRIDECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x199FE8A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PerformanceStandalonePlayOverrideConfig_TypeDefinitionIndex = 18081;
