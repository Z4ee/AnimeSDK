...
#define RPG_GAMECORE_ADVENTURESKILLSLOTDATA_GET_SKILLINDEX_OFFSET UNITYSDK_OFFSET(0xA839A70)
#define RPG_GAMECORE_ADVENTURESKILLSLOTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA852000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureSkillSlotData_TypeDefinitionIndex = 45749;
