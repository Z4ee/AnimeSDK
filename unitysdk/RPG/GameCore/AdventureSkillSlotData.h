...
#define RPG_GAMECORE_ADVENTURESKILLSLOTDATA_GET_SKILLINDEX_OFFSET UNITYSDK_OFFSET(0xCCF5930)
#define RPG_GAMECORE_ADVENTURESKILLSLOTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCCF6970)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureSkillSlotData_TypeDefinitionIndex = 53104;
	...
	public:
		...
		::RPG::GameCore::AdventureSkillSlotState State; // 0x20
