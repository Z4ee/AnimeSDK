...
#define RPG_GAMECORE_TRIGGERCUSTOMSTRINGONDIALOGEND_METHOD_4_7603CB11D138AE72_OFFSET UNITYSDK_OFFSET(0x178C1720)
#define RPG_GAMECORE_TRIGGERCUSTOMSTRINGONDIALOGEND_METHOD_4_CDCD88D2C87A2BDB_OFFSET UNITYSDK_OFFSET(0x178C1400)
#define RPG_GAMECORE_TRIGGERCUSTOMSTRINGONDIALOGEND__CTOR_OFFSET UNITYSDK_OFFSET(0x178C13D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerCustomStringOnDialogEnd_TypeDefinitionIndex = 19070;
