...
#define RPG_GAMECORE_MONOPOLYCHECKSHOULDSETTLE_METHOD_3_3EB84B511C3561E3_OFFSET UNITYSDK_OFFSET(0x1D2BABC0)
#define RPG_GAMECORE_MONOPOLYCHECKSHOULDSETTLE_METHOD_3_B8CA9C5704589964_OFFSET UNITYSDK_OFFSET(0x1D2BAC00)
#define RPG_GAMECORE_MONOPOLYCHECKSHOULDSETTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2BABF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonopolyCheckShouldSettle_TypeDefinitionIndex = 20692;
