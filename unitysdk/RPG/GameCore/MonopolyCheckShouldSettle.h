...
#define RPG_GAMECORE_MONOPOLYCHECKSHOULDSETTLE_METHOD_3_2E3E5BB807CB57DE_OFFSET UNITYSDK_OFFSET(0x17437270)
#define RPG_GAMECORE_MONOPOLYCHECKSHOULDSETTLE_METHOD_3_E4CCB60A53E1F5F2_OFFSET UNITYSDK_OFFSET(0x174371F0)
#define RPG_GAMECORE_MONOPOLYCHECKSHOULDSETTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x17437240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonopolyCheckShouldSettle_TypeDefinitionIndex = 19260;
