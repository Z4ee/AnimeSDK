...
#define RPG_GAMECORE_FIVEDIMFOGOFWARCONFIG_METHOD_2_61D9ABF5DE2CC6D4_OFFSET UNITYSDK_OFFSET(0x1D0E7070)
#define RPG_GAMECORE_FIVEDIMFOGOFWARCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0E7200)
