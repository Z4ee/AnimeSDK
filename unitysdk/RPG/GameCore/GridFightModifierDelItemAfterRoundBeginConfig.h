...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERDELITEMAFTERROUNDBEGINCONFIG_METHOD_3_1DEE59C6718ABE3A_OFFSET UNITYSDK_OFFSET(0x197F1420)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERDELITEMAFTERROUNDBEGINCONFIG_METHOD_3_C498F00A6D6BBCF3_OFFSET UNITYSDK_OFFSET(0x197EB310)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERDELITEMAFTERROUNDBEGINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197EB2C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierDelItemAfterRoundBeginConfig_TypeDefinitionIndex = 18420;
