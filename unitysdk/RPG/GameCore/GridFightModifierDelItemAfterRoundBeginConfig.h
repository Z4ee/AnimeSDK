...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERDELITEMAFTERROUNDBEGINCONFIG_METHOD_3_7B09EC3023F5CB2F_OFFSET UNITYSDK_OFFSET(0x1C5D09F0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERDELITEMAFTERROUNDBEGINCONFIG_METHOD_3_C498F00A6D6BBCF3_OFFSET UNITYSDK_OFFSET(0x1C5D0A40)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERDELITEMAFTERROUNDBEGINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5D0A30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierDelItemAfterRoundBeginConfig_TypeDefinitionIndex = 18668;
