...
#define RPG_GAMECORE_BYCOMPAREFLOORCUSTOMSTRING_METHOD_4_216C14200ED8AFB3_OFFSET UNITYSDK_OFFSET(0x19CE3760)
#define RPG_GAMECORE_BYCOMPAREFLOORCUSTOMSTRING_METHOD_4_8545FD24898AE274_OFFSET UNITYSDK_OFFSET(0x19CE34F0)
#define RPG_GAMECORE_BYCOMPAREFLOORCUSTOMSTRING_METHOD_4_A7A24FE42338C405_OFFSET UNITYSDK_OFFSET(0x19CE34A0)
#define RPG_GAMECORE_BYCOMPAREFLOORCUSTOMSTRING_METHOD_4_E4092035CBEC9E1C_OFFSET UNITYSDK_OFFSET(0x19CE3720)
#define RPG_GAMECORE_BYCOMPAREFLOORCUSTOMSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x19CE34E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareFloorCustomString_TypeDefinitionIndex = 19909;
