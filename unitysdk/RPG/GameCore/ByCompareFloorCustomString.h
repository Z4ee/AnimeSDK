...
#define RPG_GAMECORE_BYCOMPAREFLOORCUSTOMSTRING_METHOD_4_8545FD24898AE274_OFFSET UNITYSDK_OFFSET(0x17009170)
#define RPG_GAMECORE_BYCOMPAREFLOORCUSTOMSTRING_METHOD_4_F6CA23B0A39C15C6_OFFSET UNITYSDK_OFFSET(0x17009090)
#define RPG_GAMECORE_BYCOMPAREFLOORCUSTOMSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x17009110)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareFloorCustomString_TypeDefinitionIndex = 19012;
