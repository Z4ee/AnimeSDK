...
#define RPG_GAMECORE_CAKERACEACTIONGENCURSECTIONWUBBABOO_METHOD_3_2E22473C0EF98D12_OFFSET UNITYSDK_OFFSET(0x1B2CB7C0)
#define RPG_GAMECORE_CAKERACEACTIONGENCURSECTIONWUBBABOO_METHOD_3_F73F9EFDE1373517_OFFSET UNITYSDK_OFFSET(0x1B2CB710)
#define RPG_GAMECORE_CAKERACEACTIONGENCURSECTIONWUBBABOO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2CB7B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionGenCurSectionWubbaboo_TypeDefinitionIndex = 17607;
