...
#define RPG_GAMECORE_UNLOCKTARGETSHIELD_METHOD_3_B38A20E846EF7FC8_OFFSET UNITYSDK_OFFSET(0x190E5FE0)
#define RPG_GAMECORE_UNLOCKTARGETSHIELD_METHOD_3_C875B5A4D5E7C9CA_OFFSET UNITYSDK_OFFSET(0x190E6060)
#define RPG_GAMECORE_UNLOCKTARGETSHIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x190E6030)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UnlockTargetShield_TypeDefinitionIndex = 22601;
