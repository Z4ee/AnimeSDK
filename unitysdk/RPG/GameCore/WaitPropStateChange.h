...
#define RPG_GAMECORE_WAITPROPSTATECHANGE_METHOD_4_675D14FE7EC67C8F_OFFSET UNITYSDK_OFFSET(0x191059C0)
#define RPG_GAMECORE_WAITPROPSTATECHANGE_METHOD_4_DE424BF29B9DA961_OFFSET UNITYSDK_OFFSET(0x191058E0)
#define RPG_GAMECORE_WAITPROPSTATECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x19105960)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitPropStateChange_TypeDefinitionIndex = 19720;
