...
#define RPG_GAMECORE_VE_CHARACTERID_METHOD_3_058491206EA3EABD_OFFSET UNITYSDK_OFFSET(0x1B88C2F0)
#define RPG_GAMECORE_VE_CHARACTERID_METHOD_3_32A1EED268F4BD45_OFFSET UNITYSDK_OFFSET(0x1B88C350)
#define RPG_GAMECORE_VE_CHARACTERID_METHOD_3_51E6E8B4C52C41F1_OFFSET UNITYSDK_OFFSET(0x1B88C0D0)
#define RPG_GAMECORE_VE_CHARACTERID_METHOD_3_76AB5523386C1D07_OFFSET UNITYSDK_OFFSET(0x1B88C170)
#define RPG_GAMECORE_VE_CHARACTERID__CTOR_OFFSET UNITYSDK_OFFSET(0x1B88C130)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VE_CharacterID_TypeDefinitionIndex = 23418;
