...
#define RPG_GAMECORE_CAKERACEAOECONFIG_METHOD_2_7EB775C43C5E7AD7_OFFSET UNITYSDK_OFFSET(0x1CF707D0)
#define RPG_GAMECORE_CAKERACEAOECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF711D0)
