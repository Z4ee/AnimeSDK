...
#define RPG_GAMECORE_ROGUEDLC1DOT3DICEINTERACT_METHOD_3_45C5446C231A04B4_OFFSET UNITYSDK_OFFSET(0x175EFF80)
#define RPG_GAMECORE_ROGUEDLC1DOT3DICEINTERACT_METHOD_3_600AE7EC81F5C07C_OFFSET UNITYSDK_OFFSET(0x175EFF00)
#define RPG_GAMECORE_ROGUEDLC1DOT3DICEINTERACT__CTOR_OFFSET UNITYSDK_OFFSET(0x175EFF50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueDLC1Dot3DiceInteract_TypeDefinitionIndex = 20464;
