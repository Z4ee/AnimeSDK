...
#define RPG_GAMECORE_WAITFORTURNEND_METHOD_3_228E1220FB636187_OFFSET UNITYSDK_OFFSET(0x190FE260)
#define RPG_GAMECORE_WAITFORTURNEND_METHOD_3_30BA599FC4C8ECB6_OFFSET UNITYSDK_OFFSET(0x190FE2E0)
#define RPG_GAMECORE_WAITFORTURNEND__CTOR_OFFSET UNITYSDK_OFFSET(0x190FE2B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitForTurnEnd_TypeDefinitionIndex = 22397;
