...
#define RPG_GAMECORE_MUSEUMDESKTALKCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x174607A0)
#define RPG_GAMECORE_MUSEUMDESKTALKCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17460ED0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::MuseumTalkTriggerType TriggerType; // 0x34
