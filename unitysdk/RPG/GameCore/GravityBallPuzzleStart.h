...
#define RPG_GAMECORE_GRAVITYBALLPUZZLESTART_METHOD_3_21F2AD781525EBDA_OFFSET UNITYSDK_OFFSET(0x1899C780)
#define RPG_GAMECORE_GRAVITYBALLPUZZLESTART_METHOD_3_45930929D7A53C26_OFFSET UNITYSDK_OFFSET(0x1899C890)
#define RPG_GAMECORE_GRAVITYBALLPUZZLESTART__CTOR_OFFSET UNITYSDK_OFFSET(0x1899C860)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GravityBallPuzzleStart_TypeDefinitionIndex = 19330;
