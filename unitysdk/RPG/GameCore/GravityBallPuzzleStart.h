...
#define RPG_GAMECORE_GRAVITYBALLPUZZLESTART_METHOD_3_21F2AD781525EBDA_OFFSET UNITYSDK_OFFSET(0x197D4A10)
#define RPG_GAMECORE_GRAVITYBALLPUZZLESTART_METHOD_3_45930929D7A53C26_OFFSET UNITYSDK_OFFSET(0x197D4B20)
#define RPG_GAMECORE_GRAVITYBALLPUZZLESTART__CTOR_OFFSET UNITYSDK_OFFSET(0x197D4AF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GravityBallPuzzleStart_TypeDefinitionIndex = 19241;
