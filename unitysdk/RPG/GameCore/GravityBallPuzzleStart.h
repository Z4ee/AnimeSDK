...
#define RPG_GAMECORE_GRAVITYBALLPUZZLESTART_METHOD_3_45930929D7A53C26_OFFSET UNITYSDK_OFFSET(0x1C5C0C20)
#define RPG_GAMECORE_GRAVITYBALLPUZZLESTART_METHOD_3_CA1AA1FB849E1323_OFFSET UNITYSDK_OFFSET(0x1C5C0B50)
#define RPG_GAMECORE_GRAVITYBALLPUZZLESTART__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5C0C10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GravityBallPuzzleStart_TypeDefinitionIndex = 19597;
