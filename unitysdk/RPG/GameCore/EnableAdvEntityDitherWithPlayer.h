...
#define RPG_GAMECORE_ENABLEADVENTITYDITHERWITHPLAYER_METHOD_3_303DF4E3E7CCF69C_OFFSET UNITYSDK_OFFSET(0x17196A70)
#define RPG_GAMECORE_ENABLEADVENTITYDITHERWITHPLAYER_METHOD_3_4334A333FB9984AA_OFFSET UNITYSDK_OFFSET(0x171969F0)
#define RPG_GAMECORE_ENABLEADVENTITYDITHERWITHPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x17196A40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnableAdvEntityDitherWithPlayer_TypeDefinitionIndex = 18877;
