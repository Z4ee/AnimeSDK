...
#define RPG_GAMECORE_BYCHECKLINEUPAVATARBASETYPE_METHOD_4_5A52FBF09A05CE58_OFFSET UNITYSDK_OFFSET(0x1CEA79A0)
#define RPG_GAMECORE_BYCHECKLINEUPAVATARBASETYPE_METHOD_4_944B5EF023AAE43F_OFFSET UNITYSDK_OFFSET(0x1CEA7C70)
#define RPG_GAMECORE_BYCHECKLINEUPAVATARBASETYPE_METHOD_4_AC3FEFFE7DDB0777_OFFSET UNITYSDK_OFFSET(0x1CEA7CF0)
#define RPG_GAMECORE_BYCHECKLINEUPAVATARBASETYPE_METHOD_4_C7F6C39B9EBA6D73_OFFSET UNITYSDK_OFFSET(0x1CEA7A80)
#define RPG_GAMECORE_BYCHECKLINEUPAVATARBASETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEA7A20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckLineupAvatarBaseType_TypeDefinitionIndex = 20555;
