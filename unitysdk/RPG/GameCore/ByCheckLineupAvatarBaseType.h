...
#define RPG_GAMECORE_BYCHECKLINEUPAVATARBASETYPE_METHOD_4_5A52FBF09A05CE58_OFFSET UNITYSDK_OFFSET(0x1C2FE680)
#define RPG_GAMECORE_BYCHECKLINEUPAVATARBASETYPE_METHOD_4_944B5EF023AAE43F_OFFSET UNITYSDK_OFFSET(0x1C2FE950)
#define RPG_GAMECORE_BYCHECKLINEUPAVATARBASETYPE_METHOD_4_AC3FEFFE7DDB0777_OFFSET UNITYSDK_OFFSET(0x1C2FE9D0)
#define RPG_GAMECORE_BYCHECKLINEUPAVATARBASETYPE_METHOD_4_C7F6C39B9EBA6D73_OFFSET UNITYSDK_OFFSET(0x1C2FE760)
#define RPG_GAMECORE_BYCHECKLINEUPAVATARBASETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2FE700)
