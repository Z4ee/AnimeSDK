...
#define RPG_GAMECORE_CHARACTERSKINCONFIG_METHOD_2_ABDADD775C184B9D_OFFSET UNITYSDK_OFFSET(0x1E000710)
#define RPG_GAMECORE_CHARACTERSKINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0007D0)
