...
#define RPG_GAMECORE_CHARACTERSKINCONFIG_METHOD_2_ABDADD775C184B9D_OFFSET UNITYSDK_OFFSET(0x196157C0)
#define RPG_GAMECORE_CHARACTERSKINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19615880)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterSkinConfig_TypeDefinitionIndex = 15718;
