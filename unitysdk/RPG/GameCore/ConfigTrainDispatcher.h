...
#define RPG_GAMECORE_CONFIGTRAINDISPATCHER_METHOD_2_52DD6AFFB19CBC58_OFFSET UNITYSDK_OFFSET(0x1CFFA160)
#define RPG_GAMECORE_CONFIGTRAINDISPATCHER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFFA360)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConfigTrainDispatcher_TypeDefinitionIndex = 16726;
