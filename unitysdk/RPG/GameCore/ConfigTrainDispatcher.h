...
#define RPG_GAMECORE_CONFIGTRAINDISPATCHER_METHOD_2_52DD6AFFB19CBC58_OFFSET UNITYSDK_OFFSET(0x1D9B0D70)
#define RPG_GAMECORE_CONFIGTRAINDISPATCHER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D9B0F70)
