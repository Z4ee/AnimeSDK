...
#define RPG_GAMECORE_LEVELAUDIENCEINFO_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1D1C9380)
#define RPG_GAMECORE_LEVELAUDIENCEINFO_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D1C9320)
#define RPG_GAMECORE_LEVELAUDIENCEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1C9370)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelAudienceInfo_TypeDefinitionIndex = 17133;
