...
#define RPG_GAMECORE_SETTRACEORIGAMIFLAG_METHOD_3_4D550F98A6CF6B8C_OFFSET UNITYSDK_OFFSET(0x18E48700)
#define RPG_GAMECORE_SETTRACEORIGAMIFLAG_METHOD_3_939B4861772FF118_OFFSET UNITYSDK_OFFSET(0x18E48810)
#define RPG_GAMECORE_SETTRACEORIGAMIFLAG__CTOR_OFFSET UNITYSDK_OFFSET(0x18E487E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetTraceOrigamiFlag_TypeDefinitionIndex = 20717;
