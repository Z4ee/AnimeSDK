...
#define RPG_GAMECORE_ACTIVITYDICECOMBATSHOPGOODSROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18609490)
#define RPG_GAMECORE_ACTIVITYDICECOMBATSHOPGOODSROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18609710)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityDiceCombatShopGoodsRow_TypeDefinitionIndex = 10751;

	class ActivityDiceCombatShopGoodsRow : public ::System::Object
	{
	public:
		::Il2CppArray<::RPG::GameCore::ConditionParam*>* UnlockCondition; // 0x10
		::Il2CppArray<::System::UInt32>* UnlockTipsList; // 0x18
		::Il2CppArray<::RPG::GameCore::ItemConfig*>* ItemCost; // 0x20
		::System::UInt32 GoodsSortID; // 0x28
		::System::UInt32 DiceShopGoodsID; // 0x2C
