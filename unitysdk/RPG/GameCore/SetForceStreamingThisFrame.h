...
#define RPG_GAMECORE_SETFORCESTREAMINGTHISFRAME_METHOD_3_8369197332E34D80_OFFSET UNITYSDK_OFFSET(0x18E32C40)
#define RPG_GAMECORE_SETFORCESTREAMINGTHISFRAME_METHOD_3_96730D7615AC9C39_OFFSET UNITYSDK_OFFSET(0x18E32BC0)
#define RPG_GAMECORE_SETFORCESTREAMINGTHISFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x18E32C10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetForceStreamingThisFrame_TypeDefinitionIndex = 20076;
