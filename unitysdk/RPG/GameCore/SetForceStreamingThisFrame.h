...
#define RPG_GAMECORE_SETFORCESTREAMINGTHISFRAME_METHOD_3_237AC7F4BF79BF43_OFFSET UNITYSDK_OFFSET(0x1D500300)
#define RPG_GAMECORE_SETFORCESTREAMINGTHISFRAME_METHOD_3_8369197332E34D80_OFFSET UNITYSDK_OFFSET(0x1D500340)
#define RPG_GAMECORE_SETFORCESTREAMINGTHISFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1D500330)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetForceStreamingThisFrame_TypeDefinitionIndex = 20856;
