...
#define RPG_GAMECORE_SETFORCESTREAMINGTHISFRAME_METHOD_3_8369197332E34D80_OFFSET UNITYSDK_OFFSET(0x176CF700)
#define RPG_GAMECORE_SETFORCESTREAMINGTHISFRAME_METHOD_3_96730D7615AC9C39_OFFSET UNITYSDK_OFFSET(0x176CF680)
#define RPG_GAMECORE_SETFORCESTREAMINGTHISFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x176CF6D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetForceStreamingThisFrame_TypeDefinitionIndex = 19403;
