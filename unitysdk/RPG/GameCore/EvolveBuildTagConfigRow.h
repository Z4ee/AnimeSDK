...
#define RPG_GAMECORE_EVOLVEBUILDTAGCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C0661A0)
#define RPG_GAMECORE_EVOLVEBUILDTAGCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C066930)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 ShopSkillID; // 0x1C
