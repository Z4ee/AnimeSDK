...
#define RPG_GAMECORE_SHOWMUSEUMMARKETPAGE_METHOD_3_117411F6DFC9CFDD_OFFSET UNITYSDK_OFFSET(0x18E63FF0)
#define RPG_GAMECORE_SHOWMUSEUMMARKETPAGE_METHOD_3_9AD77A45D6B6A711_OFFSET UNITYSDK_OFFSET(0x18E64100)
#define RPG_GAMECORE_SHOWMUSEUMMARKETPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E640D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowMuseumMarketPage_TypeDefinitionIndex = 19890;
