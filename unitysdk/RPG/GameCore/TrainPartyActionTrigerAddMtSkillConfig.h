...
#define RPG_GAMECORE_TRAINPARTYACTIONTRIGERADDMTSKILLCONFIG_METHOD_5_8BD0BE0E1677DF8D_OFFSET UNITYSDK_OFFSET(0x1C15CFA0)
#define RPG_GAMECORE_TRAINPARTYACTIONTRIGERADDMTSKILLCONFIG_METHOD_5_EA33756B6252EC71_OFFSET UNITYSDK_OFFSET(0x1C15CE30)
#define RPG_GAMECORE_TRAINPARTYACTIONTRIGERADDMTSKILLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C15CE20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyActionTrigerAddMtSkillConfig_TypeDefinitionIndex = 17352;
