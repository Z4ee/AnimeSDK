...
#define RPG_GAMECORE_TRAINPARTYACTIONTRIGERADDMTSKILLCONFIG_METHOD_5_E4179F3750ECAB58_OFFSET UNITYSDK_OFFSET(0x190A68D0)
#define RPG_GAMECORE_TRAINPARTYACTIONTRIGERADDMTSKILLCONFIG_METHOD_5_EA33756B6252EC71_OFFSET UNITYSDK_OFFSET(0x190A65E0)
#define RPG_GAMECORE_TRAINPARTYACTIONTRIGERADDMTSKILLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x190A6590)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyActionTrigerAddMtSkillConfig_TypeDefinitionIndex = 17182;
