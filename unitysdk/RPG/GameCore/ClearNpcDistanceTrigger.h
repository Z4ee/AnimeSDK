...
#define RPG_GAMECORE_CLEARNPCDISTANCETRIGGER_METHOD_3_183BA0F18C85233D_OFFSET UNITYSDK_OFFSET(0x170B2C40)
#define RPG_GAMECORE_CLEARNPCDISTANCETRIGGER_METHOD_3_666E82935D67292A_OFFSET UNITYSDK_OFFSET(0x170B2BC0)
#define RPG_GAMECORE_CLEARNPCDISTANCETRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x170B2C10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClearNpcDistanceTrigger_TypeDefinitionIndex = 18623;
