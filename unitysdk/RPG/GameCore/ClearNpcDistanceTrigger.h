...
#define RPG_GAMECORE_CLEARNPCDISTANCETRIGGER_METHOD_3_183BA0F18C85233D_OFFSET UNITYSDK_OFFSET(0x1CFDAD40)
#define RPG_GAMECORE_CLEARNPCDISTANCETRIGGER_METHOD_3_6E6AE8DCB93E4C08_OFFSET UNITYSDK_OFFSET(0x1CFDAD00)
#define RPG_GAMECORE_CLEARNPCDISTANCETRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFDAD30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClearNpcDistanceTrigger_TypeDefinitionIndex = 20098;
