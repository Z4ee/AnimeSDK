...
#define RPG_GAMECORE_CLEARNPCDISTANCETRIGGER_METHOD_3_183BA0F18C85233D_OFFSET UNITYSDK_OFFSET(0x19653900)
#define RPG_GAMECORE_CLEARNPCDISTANCETRIGGER_METHOD_3_666E82935D67292A_OFFSET UNITYSDK_OFFSET(0x19653880)
#define RPG_GAMECORE_CLEARNPCDISTANCETRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x196538D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClearNpcDistanceTrigger_TypeDefinitionIndex = 19196;
