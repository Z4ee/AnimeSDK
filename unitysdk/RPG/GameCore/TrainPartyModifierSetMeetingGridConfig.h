...
#define RPG_GAMECORE_TRAINPARTYMODIFIERSETMEETINGGRIDCONFIG_METHOD_3_4705E89DEA220CB3_OFFSET UNITYSDK_OFFSET(0x19DF6930)
#define RPG_GAMECORE_TRAINPARTYMODIFIERSETMEETINGGRIDCONFIG_METHOD_3_FD67C3582A28A5EF_OFFSET UNITYSDK_OFFSET(0x19DF6C90)
#define RPG_GAMECORE_TRAINPARTYMODIFIERSETMEETINGGRIDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19DF6920)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyModifierSetMeetingGridConfig_TypeDefinitionIndex = 17206;
