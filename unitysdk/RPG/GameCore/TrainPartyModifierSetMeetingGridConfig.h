...
#define RPG_GAMECORE_TRAINPARTYMODIFIERSETMEETINGGRIDCONFIG_METHOD_3_4705E89DEA220CB3_OFFSET UNITYSDK_OFFSET(0x1D5DED70)
#define RPG_GAMECORE_TRAINPARTYMODIFIERSETMEETINGGRIDCONFIG_METHOD_3_FD67C3582A28A5EF_OFFSET UNITYSDK_OFFSET(0x1D5DF0D0)
#define RPG_GAMECORE_TRAINPARTYMODIFIERSETMEETINGGRIDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5DED60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyModifierSetMeetingGridConfig_TypeDefinitionIndex = 17885;
