...
#define RPG_GAMECORE_PLANETFESBUFFDESCOVERRIDEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D79AB90)
#define RPG_GAMECORE_PLANETFESBUFFDESCOVERRIDEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D79AD10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlanetFesBuffDescOverrideRow_TypeDefinitionIndex = 12199;
