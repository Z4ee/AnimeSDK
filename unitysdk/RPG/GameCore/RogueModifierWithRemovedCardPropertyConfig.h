...
#define RPG_GAMECORE_ROGUEMODIFIERWITHREMOVEDCARDPROPERTYCONFIG_METHOD_3_8CFB7C7E9FCBBDFB_OFFSET UNITYSDK_OFFSET(0x1762DE30)
#define RPG_GAMECORE_ROGUEMODIFIERWITHREMOVEDCARDPROPERTYCONFIG_METHOD_3_FB6581591C9487E2_OFFSET UNITYSDK_OFFSET(0x17639E30)
#define RPG_GAMECORE_ROGUEMODIFIERWITHREMOVEDCARDPROPERTYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1762DDE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierWithRemovedCardPropertyConfig_TypeDefinitionIndex = 16406;
