...
#define RPG_GAMECORE_SWITCHAUDIOLISTENERTOTARGET_METHOD_3_DE1A9912ACCD61F0_OFFSET UNITYSDK_OFFSET(0x17791690)
#define RPG_GAMECORE_SWITCHAUDIOLISTENERTOTARGET_METHOD_3_F7A0779E8B649CC1_OFFSET UNITYSDK_OFFSET(0x17791710)
#define RPG_GAMECORE_SWITCHAUDIOLISTENERTOTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x177916E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchAudioListenerToTarget_TypeDefinitionIndex = 20070;
