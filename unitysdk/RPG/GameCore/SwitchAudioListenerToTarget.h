...
#define RPG_GAMECORE_SWITCHAUDIOLISTENERTOTARGET_METHOD_3_DE1A9912ACCD61F0_OFFSET UNITYSDK_OFFSET(0x18EB7AD0)
#define RPG_GAMECORE_SWITCHAUDIOLISTENERTOTARGET_METHOD_3_F7A0779E8B649CC1_OFFSET UNITYSDK_OFFSET(0x18EB7B50)
#define RPG_GAMECORE_SWITCHAUDIOLISTENERTOTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x18EB7B20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchAudioListenerToTarget_TypeDefinitionIndex = 20751;
