...
#define RPG_GAMECORE_CONVINCESHOWTOAST_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1BC36AD0)
#define RPG_GAMECORE_CONVINCESHOWTOAST_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1BC36A90)
#define RPG_GAMECORE_CONVINCESHOWTOAST__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC36AC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConvinceShowToast_TypeDefinitionIndex = 21040;
