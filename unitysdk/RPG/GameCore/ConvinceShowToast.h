...
#define RPG_GAMECORE_CONVINCESHOWTOAST_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1883EE00)
#define RPG_GAMECORE_CONVINCESHOWTOAST_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1883ED80)
#define RPG_GAMECORE_CONVINCESHOWTOAST__CTOR_OFFSET UNITYSDK_OFFSET(0x1883EDD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConvinceShowToast_TypeDefinitionIndex = 20697;
