...
#define RPG_GAMECORE_INITACTIVITYTELEVISIONBUFFINFO_METHOD_3_88B8A4C07C8BD7F7_OFFSET UNITYSDK_OFFSET(0x172BB140)
#define RPG_GAMECORE_INITACTIVITYTELEVISIONBUFFINFO_METHOD_3_ECC229761E172FFF_OFFSET UNITYSDK_OFFSET(0x172BB0C0)
#define RPG_GAMECORE_INITACTIVITYTELEVISIONBUFFINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x172BB110)

namespace RPG::GameCore
{
	inline static constexpr unsigned int InitActivityTelevisionBuffInfo_TypeDefinitionIndex = 21472;
