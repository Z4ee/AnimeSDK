...
#define RPG_GAMECORE_PEDESTRIANCONFIG_METHOD_2_D9B960991E72708F_OFFSET UNITYSDK_OFFSET(0x1748FE30)
#define RPG_GAMECORE_PEDESTRIANCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1748FEE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PedestrianConfig_TypeDefinitionIndex = 16210;
