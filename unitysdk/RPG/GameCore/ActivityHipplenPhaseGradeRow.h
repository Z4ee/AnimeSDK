...
#define RPG_GAMECORE_ACTIVITYHIPPLENPHASEGRADEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1AAF75E0)
#define RPG_GAMECORE_ACTIVITYHIPPLENPHASEGRADEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAF77C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityHipplenPhaseGradeRow_TypeDefinitionIndex = 11223;

	class ActivityHipplenPhaseGradeRow : public ::System::Object
	{
	public:
		::System::String* GradeIcon; // 0x10
		::RPG::Client::TextID GradeShowText; // 0x18
		::RPG::GameCore::HipplenStatGradeType GradeType; // 0x28
