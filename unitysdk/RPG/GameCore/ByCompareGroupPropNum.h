...
#define RPG_GAMECORE_BYCOMPAREGROUPPROPNUM_METHOD_4_2ACDAB99D9D6DF00_OFFSET UNITYSDK_OFFSET(0x19CE8850)
#define RPG_GAMECORE_BYCOMPAREGROUPPROPNUM_METHOD_4_98E352EE577B9DFC_OFFSET UNITYSDK_OFFSET(0x19CE88A0)
#define RPG_GAMECORE_BYCOMPAREGROUPPROPNUM__CTOR_OFFSET UNITYSDK_OFFSET(0x19CE8890)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareGroupPropNum_TypeDefinitionIndex = 20434;
