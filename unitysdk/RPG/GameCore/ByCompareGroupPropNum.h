...
#define RPG_GAMECORE_BYCOMPAREGROUPPROPNUM_METHOD_4_73D77DE063DE2A05_OFFSET UNITYSDK_OFFSET(0x1872ED50)
#define RPG_GAMECORE_BYCOMPAREGROUPPROPNUM_METHOD_4_98E352EE577B9DFC_OFFSET UNITYSDK_OFFSET(0x1872EE20)
#define RPG_GAMECORE_BYCOMPAREGROUPPROPNUM__CTOR_OFFSET UNITYSDK_OFFSET(0x1872EDD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareGroupPropNum_TypeDefinitionIndex = 20206;
