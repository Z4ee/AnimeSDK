...
#define RPG_GAMECORE_DEVICESETTINGCONFIGITEMBASE_METHOD_2_6CF52536EB9CDB36_OFFSET UNITYSDK_OFFSET(0x1C1072E0)
#define RPG_GAMECORE_DEVICESETTINGCONFIGITEMBASE_METHOD_2_9738FF049E22686A_OFFSET UNITYSDK_OFFSET(0x1C106F90)
#define RPG_GAMECORE_DEVICESETTINGCONFIGITEMBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1072D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DeviceSettingConfigItemBase_TypeDefinitionIndex = 15812;
