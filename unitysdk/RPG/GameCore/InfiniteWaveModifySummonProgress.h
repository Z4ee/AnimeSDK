...
#define RPG_GAMECORE_INFINITEWAVEMODIFYSUMMONPROGRESS_METHOD_3_05AB269B1C61DA92_OFFSET UNITYSDK_OFFSET(0x172BA920)
#define RPG_GAMECORE_INFINITEWAVEMODIFYSUMMONPROGRESS_METHOD_3_92BB0C4FB111FCD6_OFFSET UNITYSDK_OFFSET(0x172BA8A0)
#define RPG_GAMECORE_INFINITEWAVEMODIFYSUMMONPROGRESS__CTOR_OFFSET UNITYSDK_OFFSET(0x172BA8F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int InfiniteWaveModifySummonProgress_TypeDefinitionIndex = 21493;
