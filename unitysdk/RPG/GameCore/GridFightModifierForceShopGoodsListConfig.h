...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERFORCESHOPGOODSLISTCONFIG_METHOD_3_5E9B0EC1800506BC_OFFSET UNITYSDK_OFFSET(0x197F25A0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERFORCESHOPGOODSLISTCONFIG_METHOD_3_E1A1240F18F70995_OFFSET UNITYSDK_OFFSET(0x197ED1B0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERFORCESHOPGOODSLISTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197ED160)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierForceShopGoodsListConfig_TypeDefinitionIndex = 18437;
