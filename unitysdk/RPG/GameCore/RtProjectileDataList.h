...
#define RPG_GAMECORE_RTPROJECTILEDATALIST_METHOD_2_ADD06C4806FAE74D_OFFSET UNITYSDK_OFFSET(0x18DD52E0)
#define RPG_GAMECORE_RTPROJECTILEDATALIST__CTOR_OFFSET UNITYSDK_OFFSET(0x18DD54A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtProjectileDataList_TypeDefinitionIndex = 23136;
