...
#define RPG_GAMECORE_MARBLEAIDEGRADE_METHOD_3_2D3F2D5B9AEC3ED0_OFFSET UNITYSDK_OFFSET(0x17386B60)
#define RPG_GAMECORE_MARBLEAIDEGRADE_METHOD_3_AEDED0533F5E0577_OFFSET UNITYSDK_OFFSET(0x17386CA0)
#define RPG_GAMECORE_MARBLEAIDEGRADE__CTOR_OFFSET UNITYSDK_OFFSET(0x17386C50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleAIDegrade_TypeDefinitionIndex = 15440;
