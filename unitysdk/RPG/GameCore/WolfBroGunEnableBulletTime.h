...
#define RPG_GAMECORE_WOLFBROGUNENABLEBULLETTIME_METHOD_3_1A423A188092E256_OFFSET UNITYSDK_OFFSET(0x1D1C28A0)
#define RPG_GAMECORE_WOLFBROGUNENABLEBULLETTIME_METHOD_3_6B9CF24547911C07_OFFSET UNITYSDK_OFFSET(0x1D1C2850)
#define RPG_GAMECORE_WOLFBROGUNENABLEBULLETTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1C2890)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WolfBroGunEnableBulletTime_TypeDefinitionIndex = 20789;
