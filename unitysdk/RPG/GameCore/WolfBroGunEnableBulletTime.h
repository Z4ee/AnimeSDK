...
#define RPG_GAMECORE_WOLFBROGUNENABLEBULLETTIME_METHOD_3_1A423A188092E256_OFFSET UNITYSDK_OFFSET(0x1790B6C0)
#define RPG_GAMECORE_WOLFBROGUNENABLEBULLETTIME_METHOD_3_4ED3DB97D3C3A3CF_OFFSET UNITYSDK_OFFSET(0x1790B640)
#define RPG_GAMECORE_WOLFBROGUNENABLEBULLETTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x1790B690)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WolfBroGunEnableBulletTime_TypeDefinitionIndex = 19751;
