...
#define RPG_GAMECORE_EQUIPMENTPROMOTIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x196F3300)
#define RPG_GAMECORE_EQUIPMENTPROMOTIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x196F3CE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EquipmentPromotionRow_TypeDefinitionIndex = 12604;
	...
	public:
		...
		::RPG::GameCore::FixPoint BaseHP; // 0x20
		::RPG::GameCore::FixPoint BaseAttackAdd; // 0x28
