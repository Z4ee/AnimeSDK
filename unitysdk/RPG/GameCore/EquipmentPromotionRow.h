...
#define RPG_GAMECORE_EQUIPMENTPROMOTIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x171A80C0)
#define RPG_GAMECORE_EQUIPMENTPROMOTIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x171A8A90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EquipmentPromotionRow_TypeDefinitionIndex = 12083;
	...
	public:
		...
		::System::UInt32 PlayerLevelRequire; // 0x38
		::System::UInt32 EquipmentID; // 0x3C
		::RPG::GameCore::FixPoint BaseHP; // 0x40
		::RPG::GameCore::FixPoint BaseAttackAdd; // 0x48
		::RPG::GameCore::FixPoint BaseDefenceAdd; // 0x50
		::System::UInt32 Promotion; // 0x58
