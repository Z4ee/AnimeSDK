...
#define RPG_GAMECORE_SHOWGUIDEDETAILDIALOG_METHOD_3_4179D6A6D1DDFA52_OFFSET UNITYSDK_OFFSET(0x18E5FEE0)
#define RPG_GAMECORE_SHOWGUIDEDETAILDIALOG_METHOD_3_7D09F989BB65A33C_OFFSET UNITYSDK_OFFSET(0x18E5FF60)
#define RPG_GAMECORE_SHOWGUIDEDETAILDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x18E5FF30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowGuideDetailDialog_TypeDefinitionIndex = 23362;
