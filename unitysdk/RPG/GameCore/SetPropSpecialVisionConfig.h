...
#define RPG_GAMECORE_SETPROPSPECIALVISIONCONFIG_METHOD_3_47AA6EF33BC51B84_OFFSET UNITYSDK_OFFSET(0x176DC400)
#define RPG_GAMECORE_SETPROPSPECIALVISIONCONFIG_METHOD_3_6AAB7D00CBA6A51D_OFFSET UNITYSDK_OFFSET(0x176DC480)
#define RPG_GAMECORE_SETPROPSPECIALVISIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x176DC450)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetPropSpecialVisionConfig_TypeDefinitionIndex = 18810;
