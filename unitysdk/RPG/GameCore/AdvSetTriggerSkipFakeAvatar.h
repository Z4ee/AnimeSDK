...
#define RPG_GAMECORE_ADVSETTRIGGERSKIPFAKEAVATAR_METHOD_3_17F58BF9A790CBDB_OFFSET UNITYSDK_OFFSET(0x16F43170)
#define RPG_GAMECORE_ADVSETTRIGGERSKIPFAKEAVATAR_METHOD_3_E4E584405167C39D_OFFSET UNITYSDK_OFFSET(0x16F43020)
#define RPG_GAMECORE_ADVSETTRIGGERSKIPFAKEAVATAR__CTOR_OFFSET UNITYSDK_OFFSET(0x16F430E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSetTriggerSkipFakeAvatar_TypeDefinitionIndex = 18828;
