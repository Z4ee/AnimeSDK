...
#define RPG_GAMECORE_BYCURRENTSKILLNAME_METHOD_4_695DF84745E3BAEF_OFFSET UNITYSDK_OFFSET(0x1701F400)
#define RPG_GAMECORE_BYCURRENTSKILLNAME_METHOD_4_C4D1695BA513DD0F_OFFSET UNITYSDK_OFFSET(0x1701F4D0)
#define RPG_GAMECORE_BYCURRENTSKILLNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1701F480)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCurrentSkillName_TypeDefinitionIndex = 21737;
