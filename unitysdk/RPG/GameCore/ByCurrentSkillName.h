...
#define RPG_GAMECORE_BYCURRENTSKILLNAME_METHOD_4_2E4156EB6C95B848_OFFSET UNITYSDK_OFFSET(0x1A8BA240)
#define RPG_GAMECORE_BYCURRENTSKILLNAME_METHOD_4_E0EFEFEDE90A451D_OFFSET UNITYSDK_OFFSET(0x1A8BA200)
#define RPG_GAMECORE_BYCURRENTSKILLNAME_METHOD_4_EDC82C4EABF67BF3_OFFSET UNITYSDK_OFFSET(0x1A8BA4B0)
#define RPG_GAMECORE_BYCURRENTSKILLNAME_METHOD_4_F3E8D8BF37431B5C_OFFSET UNITYSDK_OFFSET(0x1A8BA480)
#define RPG_GAMECORE_BYCURRENTSKILLNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8BA230)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCurrentSkillName_TypeDefinitionIndex = 22664;
