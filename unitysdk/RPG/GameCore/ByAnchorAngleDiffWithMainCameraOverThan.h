...
#define RPG_GAMECORE_BYANCHORANGLEDIFFWITHMAINCAMERAOVERTHAN_METHOD_4_75F946FE5271502F_OFFSET UNITYSDK_OFFSET(0x19CB87C0)
#define RPG_GAMECORE_BYANCHORANGLEDIFFWITHMAINCAMERAOVERTHAN_METHOD_4_A0E262A979229EA8_OFFSET UNITYSDK_OFFSET(0x19CB87F0)
#define RPG_GAMECORE_BYANCHORANGLEDIFFWITHMAINCAMERAOVERTHAN_METHOD_4_C36F8FB40AB2F684_OFFSET UNITYSDK_OFFSET(0x19CB85A0)
#define RPG_GAMECORE_BYANCHORANGLEDIFFWITHMAINCAMERAOVERTHAN_METHOD_4_CB35697C455B036D_OFFSET UNITYSDK_OFFSET(0x19CB8560)
#define RPG_GAMECORE_BYANCHORANGLEDIFFWITHMAINCAMERAOVERTHAN__CTOR_OFFSET UNITYSDK_OFFSET(0x19CB8590)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByAnchorAngleDiffWithMainCameraOverThan_TypeDefinitionIndex = 21482;
