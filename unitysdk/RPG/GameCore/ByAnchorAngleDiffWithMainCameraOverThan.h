...
#define RPG_GAMECORE_BYANCHORANGLEDIFFWITHMAINCAMERAOVERTHAN_METHOD_4_8F7C2B7CB2789C3F_OFFSET UNITYSDK_OFFSET(0x16FF98B0)
#define RPG_GAMECORE_BYANCHORANGLEDIFFWITHMAINCAMERAOVERTHAN_METHOD_4_C36F8FB40AB2F684_OFFSET UNITYSDK_OFFSET(0x16FF9980)
#define RPG_GAMECORE_BYANCHORANGLEDIFFWITHMAINCAMERAOVERTHAN__CTOR_OFFSET UNITYSDK_OFFSET(0x16FF9930)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByAnchorAngleDiffWithMainCameraOverThan_TypeDefinitionIndex = 20488;
