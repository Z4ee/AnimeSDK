...
#define RPG_GAMECORE_SETVIRTUALLINEUPBINDPLANE_METHOD_3_3B05C5E09AB7FA00_OFFSET UNITYSDK_OFFSET(0x18E4A2C0)
#define RPG_GAMECORE_SETVIRTUALLINEUPBINDPLANE_METHOD_3_D3D9D3509851AC60_OFFSET UNITYSDK_OFFSET(0x18E4A350)
#define RPG_GAMECORE_SETVIRTUALLINEUPBINDPLANE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E4A320)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetVirtualLineupBindPlane_TypeDefinitionIndex = 20452;
