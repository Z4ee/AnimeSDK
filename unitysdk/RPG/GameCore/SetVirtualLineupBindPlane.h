...
#define RPG_GAMECORE_SETVIRTUALLINEUPBINDPLANE_METHOD_3_1311E7F9BF0F7124_OFFSET UNITYSDK_OFFSET(0x1D5156D0)
#define RPG_GAMECORE_SETVIRTUALLINEUPBINDPLANE_METHOD_3_D3D9D3509851AC60_OFFSET UNITYSDK_OFFSET(0x1D515720)
#define RPG_GAMECORE_SETVIRTUALLINEUPBINDPLANE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D515710)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetVirtualLineupBindPlane_TypeDefinitionIndex = 21365;
