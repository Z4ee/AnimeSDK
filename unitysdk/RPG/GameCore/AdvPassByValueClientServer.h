...
#define RPG_GAMECORE_ADVPASSBYVALUECLIENTSERVER_METHOD_3_0B35E6AF6010E561_OFFSET UNITYSDK_OFFSET(0x1865CE50)
#define RPG_GAMECORE_ADVPASSBYVALUECLIENTSERVER_METHOD_3_EE1AFB0521C055F3_OFFSET UNITYSDK_OFFSET(0x1865CDD0)
#define RPG_GAMECORE_ADVPASSBYVALUECLIENTSERVER__CTOR_OFFSET UNITYSDK_OFFSET(0x1865CE20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvPassByValueClientServer_TypeDefinitionIndex = 19492;
