...
#define RPG_GAMECORE_HOYOTAG_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x198396A0)
#define RPG_GAMECORE_HOYOTAG_EQUALS_OFFSET UNITYSDK_OFFSET(0x19839640)
#define RPG_GAMECORE_HOYOTAG_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19839750)
#define RPG_GAMECORE_HOYOTAG_METHOD_2_6A562E01650ACF04_OFFSET UNITYSDK_OFFSET(0x19839370)
#define RPG_GAMECORE_HOYOTAG_METHOD_2_A41B39264FED25E2_OFFSET UNITYSDK_OFFSET(0x19839760)
#define RPG_GAMECORE_HOYOTAG_METHOD_2_C5AAD2767EBBFC4F_OFFSET UNITYSDK_OFFSET(0x198394A0)
#define RPG_GAMECORE_HOYOTAG__CTOR_OFFSET UNITYSDK_OFFSET(0x19839490)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HoyoTag_TypeDefinitionIndex = 17412;
	...
	public:
		...
		static ::System::Void Method_2_C5AAD2767EBBFC4F(::SimpleJSON::JSONNode* a1, ::RPG::GameCore::HoyoTag*& a2)
		{
			return ((::System::Void(*)(::SimpleJSON::JSONNode*, ::RPG::GameCore::HoyoTag*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_HOYOTAG_METHOD_2_C5AAD2767EBBFC4F_OFFSET))(a1, a2);
		}
