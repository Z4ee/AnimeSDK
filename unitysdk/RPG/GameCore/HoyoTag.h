...
#define RPG_GAMECORE_HOYOTAG_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1D1959A0)
#define RPG_GAMECORE_HOYOTAG_EQUALS_OFFSET UNITYSDK_OFFSET(0x1D195940)
#define RPG_GAMECORE_HOYOTAG_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1D195A50)
#define RPG_GAMECORE_HOYOTAG_METHOD_2_6A562E01650ACF04_OFFSET UNITYSDK_OFFSET(0x1D195560)
#define RPG_GAMECORE_HOYOTAG_METHOD_2_9483972E6B019F86_OFFSET UNITYSDK_OFFSET(0x1D195690)
#define RPG_GAMECORE_HOYOTAG_METHOD_2_A41B39264FED25E2_OFFSET UNITYSDK_OFFSET(0x1D195A60)
#define RPG_GAMECORE_HOYOTAG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D195680)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HoyoTag_TypeDefinitionIndex = 18103;
