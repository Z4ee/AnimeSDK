...
#define RPG_GAMECORE_ROGUEACTTESTCONFIG_METHOD_6_14F1CD83D6650AE0_OFFSET UNITYSDK_OFFSET(0x19AF8FD0)
#define RPG_GAMECORE_ROGUEACTTESTCONFIG_METHOD_6_65084AB374F386ED_OFFSET UNITYSDK_OFFSET(0x19AF8DB0)
#define RPG_GAMECORE_ROGUEACTTESTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AF8EF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActTestConfig_TypeDefinitionIndex = 18675;
