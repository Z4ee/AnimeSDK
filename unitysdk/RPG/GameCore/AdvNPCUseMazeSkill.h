...
#define RPG_GAMECORE_ADVNPCUSEMAZESKILL_METHOD_3_50849937266838AC_OFFSET UNITYSDK_OFFSET(0x16F35B30)
#define RPG_GAMECORE_ADVNPCUSEMAZESKILL_METHOD_3_BEC542455A55012F_OFFSET UNITYSDK_OFFSET(0x16F35BC0)
#define RPG_GAMECORE_ADVNPCUSEMAZESKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x16F35B90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvNPCUseMazeSkill_TypeDefinitionIndex = 18255;
