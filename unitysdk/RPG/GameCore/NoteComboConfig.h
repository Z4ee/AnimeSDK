...
#define RPG_GAMECORE_NOTECOMBOCONFIG_METHOD_2_4C1D90C8D2C0F33D_OFFSET UNITYSDK_OFFSET(0x18B804E0)
#define RPG_GAMECORE_NOTECOMBOCONFIG_METHOD_2_832295EC279E5994_1_OFFSET UNITYSDK_OFFSET(0x18B806C0)
#define RPG_GAMECORE_NOTECOMBOCONFIG_METHOD_2_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x18B806B0)
#define RPG_GAMECORE_NOTECOMBOCONFIG_METHOD_2_963A230D5F748B05_OFFSET UNITYSDK_OFFSET(0x18B80680)
#define RPG_GAMECORE_NOTECOMBOCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18BBD9A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NoteComboConfig_TypeDefinitionIndex = 16038;
