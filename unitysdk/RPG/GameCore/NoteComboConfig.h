...
#define RPG_GAMECORE_NOTECOMBOCONFIG_METHOD_2_4C1D90C8D2C0F33D_OFFSET UNITYSDK_OFFSET(0x1BAF9780)
#define RPG_GAMECORE_NOTECOMBOCONFIG_METHOD_2_832295EC279E5994_1_OFFSET UNITYSDK_OFFSET(0x1BAF9960)
#define RPG_GAMECORE_NOTECOMBOCONFIG_METHOD_2_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x1BAF9950)
#define RPG_GAMECORE_NOTECOMBOCONFIG_METHOD_2_963A230D5F748B05_OFFSET UNITYSDK_OFFSET(0x1BAF9920)
#define RPG_GAMECORE_NOTECOMBOCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAF9910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NoteComboConfig_TypeDefinitionIndex = 16272;
