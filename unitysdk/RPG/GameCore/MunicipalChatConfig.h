...
#define RPG_GAMECORE_MUNICIPALCHATCONFIG_METHOD_2_29AEDB1D95A71E77_OFFSET UNITYSDK_OFFSET(0x1D2DEA80)
#define RPG_GAMECORE_MUNICIPALCHATCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2DECE0)
