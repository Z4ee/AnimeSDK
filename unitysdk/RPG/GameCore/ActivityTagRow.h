...
#define RPG_GAMECORE_ACTIVITYTAGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x194077A0)
#define RPG_GAMECORE_ACTIVITYTAGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19407900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityTagRow_TypeDefinitionIndex = 10774;
