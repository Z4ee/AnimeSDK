...
#define RPG_GAMECORE_RESETTREASURECHALLENGE_METHOD_3_1BA4639635945A4C_OFFSET UNITYSDK_OFFSET(0x1759FD10)
#define RPG_GAMECORE_RESETTREASURECHALLENGE_METHOD_3_B226B83761C83CD8_OFFSET UNITYSDK_OFFSET(0x1759FE20)
#define RPG_GAMECORE_RESETTREASURECHALLENGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1759FDF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetTreasureChallenge_TypeDefinitionIndex = 18770;
