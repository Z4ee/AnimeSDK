...
#define RPG_GAMECORE_TARGETSORTBYDISTANCE_METHOD_3_0BEF7B0D6B938E55_OFFSET UNITYSDK_OFFSET(0x1E1C10B0)
#define RPG_GAMECORE_TARGETSORTBYDISTANCE_METHOD_3_0D1C3BCFD4BF3F75_OFFSET UNITYSDK_OFFSET(0x1E1C0F30)
#define RPG_GAMECORE_TARGETSORTBYDISTANCE_METHOD_3_C6B5E5357FB9FF1A_OFFSET UNITYSDK_OFFSET(0x1E1C10E0)
#define RPG_GAMECORE_TARGETSORTBYDISTANCE_METHOD_3_EFD703D4B69AD242_OFFSET UNITYSDK_OFFSET(0x1E1C0EF0)
#define RPG_GAMECORE_TARGETSORTBYDISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1C0F20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetSortByDistance_TypeDefinitionIndex = 23717;
