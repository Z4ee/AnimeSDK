...
#define RPG_GAMECORE_TARGETSORTBYDISTANCE_METHOD_3_0D1C3BCFD4BF3F75_OFFSET UNITYSDK_OFFSET(0x177D16C0)
#define RPG_GAMECORE_TARGETSORTBYDISTANCE_METHOD_3_D0C60F1A2B56EDB9_OFFSET UNITYSDK_OFFSET(0x177D3320)
#define RPG_GAMECORE_TARGETSORTBYDISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x177D16A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetSortByDistance_TypeDefinitionIndex = 22268;
