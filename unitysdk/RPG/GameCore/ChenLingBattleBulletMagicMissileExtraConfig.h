...
#define RPG_GAMECORE_CHENLINGBATTLEBULLETMAGICMISSILEEXTRACONFIG_METHOD_3_0245D81A68E32567_OFFSET UNITYSDK_OFFSET(0x1C3798B0)
#define RPG_GAMECORE_CHENLINGBATTLEBULLETMAGICMISSILEEXTRACONFIG_METHOD_3_506E0236F0FAC389_OFFSET UNITYSDK_OFFSET(0x1C379910)
#define RPG_GAMECORE_CHENLINGBATTLEBULLETMAGICMISSILEEXTRACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C379900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleBulletMagicMissileExtraConfig_TypeDefinitionIndex = 15106;
