...
#define RPG_GAMECORE_CHENLINGBATTLEBULLETMAGICMISSILEEXTRACONFIG_METHOD_3_467ECD43F43DBDF1_OFFSET UNITYSDK_OFFSET(0x1707CA80)
#define RPG_GAMECORE_CHENLINGBATTLEBULLETMAGICMISSILEEXTRACONFIG_METHOD_3_8276730C0274589B_OFFSET UNITYSDK_OFFSET(0x1707CAE0)
#define RPG_GAMECORE_CHENLINGBATTLEBULLETMAGICMISSILEEXTRACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1707CAD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleBulletMagicMissileExtraConfig_TypeDefinitionIndex = 14408;
