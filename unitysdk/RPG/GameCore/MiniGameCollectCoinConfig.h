...
#define RPG_GAMECORE_MINIGAMECOLLECTCOINCONFIG_METHOD_2_0AB4E1863F0C51FB_OFFSET UNITYSDK_OFFSET(0x1D1A49B0)
#define RPG_GAMECORE_MINIGAMECOLLECTCOINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1A5020)
