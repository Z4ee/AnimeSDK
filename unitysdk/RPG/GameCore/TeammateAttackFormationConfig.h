...
#define RPG_GAMECORE_TEAMMATEATTACKFORMATIONCONFIG_METHOD_2_44E60777AA9E8DAD_OFFSET UNITYSDK_OFFSET(0x19DDD520)
#define RPG_GAMECORE_TEAMMATEATTACKFORMATIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19DDD6C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TeammateAttackFormationConfig_TypeDefinitionIndex = 16244;
