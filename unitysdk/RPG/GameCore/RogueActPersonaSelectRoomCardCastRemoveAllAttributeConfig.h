...
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTREMOVEALLATTRIBUTECONFIG_METHOD_7_4E69EBB105EA9AA0_OFFSET UNITYSDK_OFFSET(0x1D0306C0)
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTREMOVEALLATTRIBUTECONFIG_METHOD_7_5111CA642B98C11C_OFFSET UNITYSDK_OFFSET(0x1D0304E0)
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTREMOVEALLATTRIBUTECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0304D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaSelectRoomCardCastRemoveAllAttributeConfig_TypeDefinitionIndex = 18967;
