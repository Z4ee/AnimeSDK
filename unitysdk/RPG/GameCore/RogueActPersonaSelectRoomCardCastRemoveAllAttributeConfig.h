...
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTREMOVEALLATTRIBUTECONFIG_METHOD_7_04BC042A07B32CA1_OFFSET UNITYSDK_OFFSET(0x18CCF510)
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTREMOVEALLATTRIBUTECONFIG_METHOD_7_5111CA642B98C11C_OFFSET UNITYSDK_OFFSET(0x18CCEA50)
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTREMOVEALLATTRIBUTECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CCE970)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaSelectRoomCardCastRemoveAllAttributeConfig_TypeDefinitionIndex = 18724;
