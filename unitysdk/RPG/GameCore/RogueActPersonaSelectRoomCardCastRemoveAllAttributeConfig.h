...
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTREMOVEALLATTRIBUTECONFIG_METHOD_7_04BC042A07B32CA1_OFFSET UNITYSDK_OFFSET(0x19AF3A90)
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTREMOVEALLATTRIBUTECONFIG_METHOD_7_5111CA642B98C11C_OFFSET UNITYSDK_OFFSET(0x19AF2FD0)
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTREMOVEALLATTRIBUTECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AF2EF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaSelectRoomCardCastRemoveAllAttributeConfig_TypeDefinitionIndex = 18691;
