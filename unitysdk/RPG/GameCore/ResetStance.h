...
#define RPG_GAMECORE_RESETSTANCE_METHOD_3_3676355E2D7504C2_OFFSET UNITYSDK_OFFSET(0x1D3A5390)
#define RPG_GAMECORE_RESETSTANCE_METHOD_3_AEA63ADE13BC995A_OFFSET UNITYSDK_OFFSET(0x1D3A5340)
#define RPG_GAMECORE_RESETSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3A5380)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetStance_TypeDefinitionIndex = 22375;
