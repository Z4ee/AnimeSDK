...
#define RPG_GAMECORE_RESETSTANCE_METHOD_3_3676355E2D7504C2_OFFSET UNITYSDK_OFFSET(0x1759F320)
#define RPG_GAMECORE_RESETSTANCE_METHOD_3_91A5C9F302607878_OFFSET UNITYSDK_OFFSET(0x1759F280)
#define RPG_GAMECORE_RESETSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1759F2E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetStance_TypeDefinitionIndex = 20807;
