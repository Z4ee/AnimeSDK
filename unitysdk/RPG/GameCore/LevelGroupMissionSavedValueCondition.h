...
#define RPG_GAMECORE_LEVELGROUPMISSIONSAVEDVALUECONDITION_METHOD_3_931F3369DC67FBEE_OFFSET UNITYSDK_OFFSET(0x1B070840)
#define RPG_GAMECORE_LEVELGROUPMISSIONSAVEDVALUECONDITION_METHOD_3_B17CB9FE380C8097_OFFSET UNITYSDK_OFFSET(0x1B0707F0)
#define RPG_GAMECORE_LEVELGROUPMISSIONSAVEDVALUECONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B070830)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelGroupMissionSavedValueCondition_TypeDefinitionIndex = 16527;
