...
#define RPG_GAMECORE_LEVELGROUPMISSIONSAVEDVALUECONDITION_METHOD_3_931F3369DC67FBEE_OFFSET UNITYSDK_OFFSET(0x19876110)
#define RPG_GAMECORE_LEVELGROUPMISSIONSAVEDVALUECONDITION_METHOD_3_B17CB9FE380C8097_OFFSET UNITYSDK_OFFSET(0x198786D0)
#define RPG_GAMECORE_LEVELGROUPMISSIONSAVEDVALUECONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x19876100)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelGroupMissionSavedValueCondition_TypeDefinitionIndex = 16365;
