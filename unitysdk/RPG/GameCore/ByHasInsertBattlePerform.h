...
#define RPG_GAMECORE_BYHASINSERTBATTLEPERFORM_METHOD_4_44169F7855CD8E92_OFFSET UNITYSDK_OFFSET(0x18748D60)
#define RPG_GAMECORE_BYHASINSERTBATTLEPERFORM_METHOD_4_7021D5950C7F2BB8_OFFSET UNITYSDK_OFFSET(0x18748C90)
#define RPG_GAMECORE_BYHASINSERTBATTLEPERFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x18748D10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByHasInsertBattlePerform_TypeDefinitionIndex = 22341;
