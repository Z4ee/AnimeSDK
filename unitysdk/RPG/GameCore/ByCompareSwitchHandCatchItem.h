...
#define RPG_GAMECORE_BYCOMPARESWITCHHANDCATCHITEM_METHOD_4_7FBCAE0E248D1461_OFFSET UNITYSDK_OFFSET(0x1873E080)
#define RPG_GAMECORE_BYCOMPARESWITCHHANDCATCHITEM_METHOD_4_932CB330B6D01F9E_OFFSET UNITYSDK_OFFSET(0x1873E150)
#define RPG_GAMECORE_BYCOMPARESWITCHHANDCATCHITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1873E100)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareSwitchHandCatchItem_TypeDefinitionIndex = 19945;
