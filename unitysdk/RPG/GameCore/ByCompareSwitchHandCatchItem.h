...
#define RPG_GAMECORE_BYCOMPARESWITCHHANDCATCHITEM_METHOD_4_587B1CA49C6A943B_OFFSET UNITYSDK_OFFSET(0x1A8AAB50)
#define RPG_GAMECORE_BYCOMPARESWITCHHANDCATCHITEM_METHOD_4_932CB330B6D01F9E_OFFSET UNITYSDK_OFFSET(0x1A8AA870)
#define RPG_GAMECORE_BYCOMPARESWITCHHANDCATCHITEM_METHOD_4_98F278B886D18033_OFFSET UNITYSDK_OFFSET(0x1A8AA830)
#define RPG_GAMECORE_BYCOMPARESWITCHHANDCATCHITEM_METHOD_4_C882B4F450873F94_OFFSET UNITYSDK_OFFSET(0x1A8AAB80)
#define RPG_GAMECORE_BYCOMPARESWITCHHANDCATCHITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8AA860)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareSwitchHandCatchItem_TypeDefinitionIndex = 20168;
