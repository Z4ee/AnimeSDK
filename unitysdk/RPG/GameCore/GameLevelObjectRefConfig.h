...
#define RPG_GAMECORE_GAMELEVELOBJECTREFCONFIG_METHOD_3_1382F987171888A9_OFFSET UNITYSDK_OFFSET(0x1D953140)
#define RPG_GAMECORE_GAMELEVELOBJECTREFCONFIG_METHOD_3_361DE8D110D67C7A_OFFSET UNITYSDK_OFFSET(0x1D953180)
#define RPG_GAMECORE_GAMELEVELOBJECTREFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D953170)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GameLevelObjectRefConfig_TypeDefinitionIndex = 17221;
