...
#define RPG_GAMECORE_GAMELEVELOBJECTREFCONFIG_METHOD_3_1382F987171888A9_OFFSET UNITYSDK_OFFSET(0x18953B00)
#define RPG_GAMECORE_GAMELEVELOBJECTREFCONFIG_METHOD_3_361DE8D110D67C7A_OFFSET UNITYSDK_OFFSET(0x18953B40)
#define RPG_GAMECORE_GAMELEVELOBJECTREFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18953B30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GameLevelObjectRefConfig_TypeDefinitionIndex = 16526;
