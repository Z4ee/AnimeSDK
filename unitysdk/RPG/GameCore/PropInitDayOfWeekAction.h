...
#define RPG_GAMECORE_PROPINITDAYOFWEEKACTION_METHOD_3_75BFDD339841D5A7_OFFSET UNITYSDK_OFFSET(0x18C6E330)
#define RPG_GAMECORE_PROPINITDAYOFWEEKACTION_METHOD_3_C8C20455C9B428D6_OFFSET UNITYSDK_OFFSET(0x18C6E3B0)
#define RPG_GAMECORE_PROPINITDAYOFWEEKACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18C6E380)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropInitDayOfWeekAction_TypeDefinitionIndex = 20940;
