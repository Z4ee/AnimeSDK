...
#define RPG_GAMECORE_PROPINITDAYOFWEEKACTION_METHOD_3_75BFDD339841D5A7_OFFSET UNITYSDK_OFFSET(0x1751E8F0)
#define RPG_GAMECORE_PROPINITDAYOFWEEKACTION_METHOD_3_C8C20455C9B428D6_OFFSET UNITYSDK_OFFSET(0x1751E970)
#define RPG_GAMECORE_PROPINITDAYOFWEEKACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1751E940)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropInitDayOfWeekAction_TypeDefinitionIndex = 20258;
