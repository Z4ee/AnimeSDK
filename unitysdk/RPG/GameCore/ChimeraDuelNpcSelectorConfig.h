...
#define RPG_GAMECORE_CHIMERADUELNPCSELECTORCONFIG_METHOD_2_E17849708AA38263_OFFSET UNITYSDK_OFFSET(0x18800BE0)
#define RPG_GAMECORE_CHIMERADUELNPCSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18800F30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelNpcSelectorConfig_TypeDefinitionIndex = 15116;
