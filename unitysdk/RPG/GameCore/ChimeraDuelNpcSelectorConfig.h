...
#define RPG_GAMECORE_CHIMERADUELNPCSELECTORCONFIG_METHOD_2_E17849708AA38263_OFFSET UNITYSDK_OFFSET(0x170A15F0)
#define RPG_GAMECORE_CHIMERADUELNPCSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x170A1DE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelNpcSelectorConfig_TypeDefinitionIndex = 14646;
