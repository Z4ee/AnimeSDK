...
#define RPG_GAMECORE_CHRONICLECONNECTIONCONFIG_METHOD_2_BAD82BD4547D0AE7_OFFSET UNITYSDK_OFFSET(0x1964EDA0)
#define RPG_GAMECORE_CHRONICLECONNECTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1964EF50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChronicleConnectionConfig_TypeDefinitionIndex = 18023;
