...
#define RPG_GAMECORE_LEVELREGIONSTATECONDITION_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1B088480)
#define RPG_GAMECORE_LEVELREGIONSTATECONDITION_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B088040)
#define RPG_GAMECORE_LEVELREGIONSTATECONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0884E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelRegionStateCondition_TypeDefinitionIndex = 16684;
