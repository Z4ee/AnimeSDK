...
#define RPG_GAMECORE_BYCHECKMECHANISMBARPHASE_METHOD_4_5D6071B6D7420D39_OFFSET UNITYSDK_OFFSET(0x187233F0)
#define RPG_GAMECORE_BYCHECKMECHANISMBARPHASE_METHOD_4_E06D468CB2D9C61F_OFFSET UNITYSDK_OFFSET(0x18723320)
#define RPG_GAMECORE_BYCHECKMECHANISMBARPHASE__CTOR_OFFSET UNITYSDK_OFFSET(0x187233A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckMechanismBarPhase_TypeDefinitionIndex = 19484;
