...
#define RPG_GAMECORE_EFFECTDURATIONCONFIG_METHOD_2_B6C8BA000EBBDF8D_OFFSET UNITYSDK_OFFSET(0x1DB232B0)
#define RPG_GAMECORE_EFFECTDURATIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB233E0)
