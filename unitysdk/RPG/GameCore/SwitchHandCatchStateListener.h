...
#define RPG_GAMECORE_SWITCHHANDCATCHSTATELISTENER_METHOD_3_688B04CAD77B34C6_OFFSET UNITYSDK_OFFSET(0x1B435C90)
#define RPG_GAMECORE_SWITCHHANDCATCHSTATELISTENER_METHOD_3_816C241B93286CF1_OFFSET UNITYSDK_OFFSET(0x1B435C50)
#define RPG_GAMECORE_SWITCHHANDCATCHSTATELISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B435C80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchHandCatchStateListener_TypeDefinitionIndex = 20179;
