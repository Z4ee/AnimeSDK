...
#define RPG_GAMECORE_STORYTEXTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17781930)
#define RPG_GAMECORE_STORYTEXTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17781AB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StoryTextConfigRow_TypeDefinitionIndex = 11577;
