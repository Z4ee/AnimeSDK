...
#define RPG_GAMECORE_SWITCHCHARACTERANCHOR_METHOD_3_BF67C5917A52AB13_OFFSET UNITYSDK_OFFSET(0x18EB9900)
#define RPG_GAMECORE_SWITCHCHARACTERANCHOR_METHOD_3_C54D86AAB898CF29_OFFSET UNITYSDK_OFFSET(0x18EB99A0)
#define RPG_GAMECORE_SWITCHCHARACTERANCHOR__CTOR_OFFSET UNITYSDK_OFFSET(0x18EB9960)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchCharacterAnchor_TypeDefinitionIndex = 19804;
