...
#define RPG_GAMECORE_FIVEDIMDRAGONDOGBAKEDMOVECONFIG_METHOD_3_4FDAE82FC665BB60_OFFSET UNITYSDK_OFFSET(0x1D859CE0)
#define RPG_GAMECORE_FIVEDIMDRAGONDOGBAKEDMOVECONFIG_METHOD_3_C3AEAF82B2825185_OFFSET UNITYSDK_OFFSET(0x1D859CA0)
#define RPG_GAMECORE_FIVEDIMDRAGONDOGBAKEDMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D859CD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimDragonDogBakedMoveConfig_TypeDefinitionIndex = 16507;
