...
#define RPG_GAMECORE_ALLEYBUFFGRIDITEMDATA_METHOD_3_662053E9D9AED109_OFFSET UNITYSDK_OFFSET(0x1AE74AA0)
#define RPG_GAMECORE_ALLEYBUFFGRIDITEMDATA_METHOD_3_D9AB57CEF4F82FDD_OFFSET UNITYSDK_OFFSET(0x1AE75010)
#define RPG_GAMECORE_ALLEYBUFFGRIDITEMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE74A90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AlleyBuffGridItemData_TypeDefinitionIndex = 15069;
