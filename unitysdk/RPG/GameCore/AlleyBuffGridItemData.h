...
#define RPG_GAMECORE_ALLEYBUFFGRIDITEMDATA_METHOD_3_529D0562E7B68B12_OFFSET UNITYSDK_OFFSET(0x16F6E380)
#define RPG_GAMECORE_ALLEYBUFFGRIDITEMDATA_METHOD_3_FA715395B3D3B1B8_OFFSET UNITYSDK_OFFSET(0x16F6EB60)
#define RPG_GAMECORE_ALLEYBUFFGRIDITEMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x16F6E370)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AlleyBuffGridItemData_TypeDefinitionIndex = 14371;
