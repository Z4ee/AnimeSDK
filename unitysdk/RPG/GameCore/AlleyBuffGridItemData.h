...
#define RPG_GAMECORE_ALLEYBUFFGRIDITEMDATA_METHOD_3_662053E9D9AED109_OFFSET UNITYSDK_OFFSET(0x19466490)
#define RPG_GAMECORE_ALLEYBUFFGRIDITEMDATA_METHOD_3_D9AB57CEF4F82FDD_OFFSET UNITYSDK_OFFSET(0x19466C60)
#define RPG_GAMECORE_ALLEYBUFFGRIDITEMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19466480)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AlleyBuffGridItemData_TypeDefinitionIndex = 14905;
