...
#define RPG_GAMECORE_TARGETSORTBYFORMATION_METHOD_3_3A5780EEE44EA35C_OFFSET UNITYSDK_OFFSET(0x1D0C7B10)
#define RPG_GAMECORE_TARGETSORTBYFORMATION_METHOD_3_66FE2EB76E8CA185_OFFSET UNITYSDK_OFFSET(0x1D0C7AE0)
#define RPG_GAMECORE_TARGETSORTBYFORMATION_METHOD_3_AACF2D114A956B8D_OFFSET UNITYSDK_OFFSET(0x1D0C7940)
#define RPG_GAMECORE_TARGETSORTBYFORMATION_METHOD_3_F9DA5BC4E261A0D0_OFFSET UNITYSDK_OFFSET(0x1D0C7A20)
#define RPG_GAMECORE_TARGETSORTBYFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0C7A10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetSortByFormation_TypeDefinitionIndex = 23129;
