...
#define RPG_GAMECORE_TARGETSORTBYFORMATION_METHOD_3_AAB2AC6C26436D04_OFFSET UNITYSDK_OFFSET(0x177D3370)
#define RPG_GAMECORE_TARGETSORTBYFORMATION_METHOD_3_F9DA5BC4E261A0D0_OFFSET UNITYSDK_OFFSET(0x177D1960)
#define RPG_GAMECORE_TARGETSORTBYFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x177D1940)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetSortByFormation_TypeDefinitionIndex = 22260;
