...
#define RPG_GAMECORE_FIVEDIMLEVELVARIABLESHORT_METHOD_4_3A56F540516279C3_OFFSET UNITYSDK_OFFSET(0x171F9130)
#define RPG_GAMECORE_FIVEDIMLEVELVARIABLESHORT_METHOD_4_8F7E9E3BFA75CB43_OFFSET UNITYSDK_OFFSET(0x171F9170)
#define RPG_GAMECORE_FIVEDIMLEVELVARIABLESHORT__CTOR_OFFSET UNITYSDK_OFFSET(0x171F9160)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimLevelVariableShort_TypeDefinitionIndex = 16986;
