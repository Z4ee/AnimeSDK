...
#define RPG_GAMECORE_FIVEDIMLEVELVARIABLESHORT_METHOD_4_3A56F540516279C3_OFFSET UNITYSDK_OFFSET(0x18909AC0)
#define RPG_GAMECORE_FIVEDIMLEVELVARIABLESHORT_METHOD_4_8F7E9E3BFA75CB43_OFFSET UNITYSDK_OFFSET(0x18909B00)
#define RPG_GAMECORE_FIVEDIMLEVELVARIABLESHORT__CTOR_OFFSET UNITYSDK_OFFSET(0x18909AF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimLevelVariableShort_TypeDefinitionIndex = 17580;
