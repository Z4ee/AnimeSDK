...
#define RPG_GAMECORE_FIVEDIMLEVELVARIABLESHORT_METHOD_4_3A56F540516279C3_OFFSET UNITYSDK_OFFSET(0x1D0EF3A0)
#define RPG_GAMECORE_FIVEDIMLEVELVARIABLESHORT_METHOD_4_8F7E9E3BFA75CB43_OFFSET UNITYSDK_OFFSET(0x1D0EF3E0)
#define RPG_GAMECORE_FIVEDIMLEVELVARIABLESHORT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0EF3D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimLevelVariableShort_TypeDefinitionIndex = 18298;
