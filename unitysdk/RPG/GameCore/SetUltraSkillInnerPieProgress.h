...
#define RPG_GAMECORE_SETULTRASKILLINNERPIEPROGRESS_METHOD_3_2D10EBDC37491616_OFFSET UNITYSDK_OFFSET(0x176E5D90)
#define RPG_GAMECORE_SETULTRASKILLINNERPIEPROGRESS_METHOD_3_A8672192B956908A_OFFSET UNITYSDK_OFFSET(0x176E5E60)
#define RPG_GAMECORE_SETULTRASKILLINNERPIEPROGRESS__CTOR_OFFSET UNITYSDK_OFFSET(0x176E5E10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetUltraSkillInnerPieProgress_TypeDefinitionIndex = 21371;
