...
#define RPG_GAMECORE_RADIALBLUREFFECT_METHOD_3_D01B3431BA9AC6C1_OFFSET UNITYSDK_OFFSET(0x1757AC50)
#define RPG_GAMECORE_RADIALBLUREFFECT_METHOD_3_E3C802F5AAEE10D2_OFFSET UNITYSDK_OFFSET(0x1757AD70)
#define RPG_GAMECORE_RADIALBLUREFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1757ACF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RadialBlurEffect_TypeDefinitionIndex = 18539;
