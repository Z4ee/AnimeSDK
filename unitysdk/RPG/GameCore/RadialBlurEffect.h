...
#define RPG_GAMECORE_RADIALBLUREFFECT_METHOD_3_D01B3431BA9AC6C1_OFFSET UNITYSDK_OFFSET(0x18C849B0)
#define RPG_GAMECORE_RADIALBLUREFFECT_METHOD_3_E3C802F5AAEE10D2_OFFSET UNITYSDK_OFFSET(0x18C84AD0)
#define RPG_GAMECORE_RADIALBLUREFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x18C84A50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RadialBlurEffect_TypeDefinitionIndex = 19192;
