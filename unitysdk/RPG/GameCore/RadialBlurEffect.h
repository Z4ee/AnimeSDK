...
#define RPG_GAMECORE_RADIALBLUREFFECT_METHOD_3_612E074C11780892_OFFSET UNITYSDK_OFFSET(0x1D1944A0)
#define RPG_GAMECORE_RADIALBLUREFFECT_METHOD_3_E3C802F5AAEE10D2_OFFSET UNITYSDK_OFFSET(0x1D194580)
#define RPG_GAMECORE_RADIALBLUREFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D194520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RadialBlurEffect_TypeDefinitionIndex = 20021;
