...
#define RPG_GAMECORE_CONSUMEACTIONCOUNTDOWN_METHOD_3_14587A81DF4441F6_OFFSET UNITYSDK_OFFSET(0x171335D0)
#define RPG_GAMECORE_CONSUMEACTIONCOUNTDOWN_METHOD_3_96139679F9AA34C8_OFFSET UNITYSDK_OFFSET(0x171334B0)
#define RPG_GAMECORE_CONSUMEACTIONCOUNTDOWN__CTOR_OFFSET UNITYSDK_OFFSET(0x17133550)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConsumeActionCountDown_TypeDefinitionIndex = 21941;
