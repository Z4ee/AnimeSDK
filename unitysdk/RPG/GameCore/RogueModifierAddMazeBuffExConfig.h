...
#define RPG_GAMECORE_ROGUEMODIFIERADDMAZEBUFFEXCONFIG_METHOD_3_3FCA5B4E256724D0_OFFSET UNITYSDK_OFFSET(0x1CFBEE70)
#define RPG_GAMECORE_ROGUEMODIFIERADDMAZEBUFFEXCONFIG_METHOD_3_C61AD26EBD3B014C_OFFSET UNITYSDK_OFFSET(0x1CFBEEC0)
#define RPG_GAMECORE_ROGUEMODIFIERADDMAZEBUFFEXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFBEEB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierAddMazeBuffExConfig_TypeDefinitionIndex = 17221;
