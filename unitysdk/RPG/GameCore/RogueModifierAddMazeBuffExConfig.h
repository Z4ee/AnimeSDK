...
#define RPG_GAMECORE_ROGUEMODIFIERADDMAZEBUFFEXCONFIG_METHOD_3_092EBC330D640C95_OFFSET UNITYSDK_OFFSET(0x19B4DDF0)
#define RPG_GAMECORE_ROGUEMODIFIERADDMAZEBUFFEXCONFIG_METHOD_3_C61AD26EBD3B014C_OFFSET UNITYSDK_OFFSET(0x19B4DEC0)
#define RPG_GAMECORE_ROGUEMODIFIERADDMAZEBUFFEXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B4DE70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierAddMazeBuffExConfig_TypeDefinitionIndex = 17059;
