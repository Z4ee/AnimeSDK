...
#define RPG_GAMECORE_ROGUEMODIFIERADDMAZEBUFFEXCONFIG_METHOD_3_092EBC330D640C95_OFFSET UNITYSDK_OFFSET(0x18D2A470)
#define RPG_GAMECORE_ROGUEMODIFIERADDMAZEBUFFEXCONFIG_METHOD_3_C61AD26EBD3B014C_OFFSET UNITYSDK_OFFSET(0x18D2A540)
#define RPG_GAMECORE_ROGUEMODIFIERADDMAZEBUFFEXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D2A4F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierAddMazeBuffExConfig_TypeDefinitionIndex = 17046;
