...
#define RPG_GAMECORE_RTLEVELGROUPINFO_METHOD_3_8FF4208FD319C383_OFFSET UNITYSDK_OFFSET(0x1D4ABA20)
#define RPG_GAMECORE_RTLEVELGROUPINFO_METHOD_3_B667D5EB41182502_OFFSET UNITYSDK_OFFSET(0x1D4AB9B0)
#define RPG_GAMECORE_RTLEVELGROUPINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4ABA00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtLevelGroupInfo_TypeDefinitionIndex = 17149;
