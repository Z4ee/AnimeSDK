...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYMAGICROOMPROBABILITYCONFIG_METHOD_3_99E96B7A7E9EF8FB_OFFSET UNITYSDK_OFFSET(0x1EEFACE0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYMAGICROOMPROBABILITYCONFIG_METHOD_3_E2FB63AED3798E17_OFFSET UNITYSDK_OFFSET(0x1EEFAC90)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYMAGICROOMPROBABILITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEFACD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyMagicRoomProbabilityConfig_TypeDefinitionIndex = 17514;
