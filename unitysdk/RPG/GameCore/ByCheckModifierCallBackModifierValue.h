...
#define RPG_GAMECORE_BYCHECKMODIFIERCALLBACKMODIFIERVALUE_METHOD_4_AB07AC1EC1345C19_OFFSET UNITYSDK_OFFSET(0x18723CB0)
#define RPG_GAMECORE_BYCHECKMODIFIERCALLBACKMODIFIERVALUE_METHOD_4_C8D651B5C02C736F_OFFSET UNITYSDK_OFFSET(0x18723D80)
#define RPG_GAMECORE_BYCHECKMODIFIERCALLBACKMODIFIERVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x18723D30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckModifierCallBackModifierValue_TypeDefinitionIndex = 21970;
