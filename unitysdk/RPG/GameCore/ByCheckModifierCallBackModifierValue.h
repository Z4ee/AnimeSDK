...
#define RPG_GAMECORE_BYCHECKMODIFIERCALLBACKMODIFIERVALUE_METHOD_4_189DBDA144C2D559_OFFSET UNITYSDK_OFFSET(0x19CC8CD0)
#define RPG_GAMECORE_BYCHECKMODIFIERCALLBACKMODIFIERVALUE_METHOD_4_215179EAC4F51E76_OFFSET UNITYSDK_OFFSET(0x19CC8D00)
#define RPG_GAMECORE_BYCHECKMODIFIERCALLBACKMODIFIERVALUE_METHOD_4_67F978C6FE2271CA_OFFSET UNITYSDK_OFFSET(0x19CC8A60)
#define RPG_GAMECORE_BYCHECKMODIFIERCALLBACKMODIFIERVALUE_METHOD_4_C8D651B5C02C736F_OFFSET UNITYSDK_OFFSET(0x19CC8AA0)
#define RPG_GAMECORE_BYCHECKMODIFIERCALLBACKMODIFIERVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x19CC8A90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckModifierCallBackModifierValue_TypeDefinitionIndex = 22219;
