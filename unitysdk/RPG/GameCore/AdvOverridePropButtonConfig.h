...
#define RPG_GAMECORE_ADVOVERRIDEPROPBUTTONCONFIG_METHOD_3_751D6E93FC00BF89_OFFSET UNITYSDK_OFFSET(0x16F3A6A0)
#define RPG_GAMECORE_ADVOVERRIDEPROPBUTTONCONFIG_METHOD_3_C789B555A0B292F6_OFFSET UNITYSDK_OFFSET(0x16F3A720)
#define RPG_GAMECORE_ADVOVERRIDEPROPBUTTONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16F3A6F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvOverridePropButtonConfig_TypeDefinitionIndex = 18846;
