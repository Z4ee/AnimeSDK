...
#define RPG_GAMECORE_MATCH3_SHOWCHARACTERCUTINGROUPACTION_METHOD_5_8A0F2C36D0EDB02E_OFFSET UNITYSDK_OFFSET(0x18AB4450)
#define RPG_GAMECORE_MATCH3_SHOWCHARACTERCUTINGROUPACTION_METHOD_5_DC666C895D7F50BC_OFFSET UNITYSDK_OFFSET(0x18ABAFD0)
#define RPG_GAMECORE_MATCH3_SHOWCHARACTERCUTINGROUPACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18AB43E0)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int ShowCharacterCutInGroupAction_TypeDefinitionIndex = 23719;
