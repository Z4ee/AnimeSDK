...
#define RPG_GAMECORE_MATCH3_SETSTYLEWEIGHTACTION_METHOD_5_3F041305AA8BCE19_OFFSET UNITYSDK_OFFSET(0x18ABADC0)
#define RPG_GAMECORE_MATCH3_SETSTYLEWEIGHTACTION_METHOD_5_69D3C2A117464277_OFFSET UNITYSDK_OFFSET(0x18AB3D80)
#define RPG_GAMECORE_MATCH3_SETSTYLEWEIGHTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18AB3D10)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int SetStyleWeightAction_TypeDefinitionIndex = 23712;
