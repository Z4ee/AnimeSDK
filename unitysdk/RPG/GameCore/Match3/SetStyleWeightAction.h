...
#define RPG_GAMECORE_MATCH3_SETSTYLEWEIGHTACTION_METHOD_5_3F041305AA8BCE19_OFFSET UNITYSDK_OFFSET(0x173AC6C0)
#define RPG_GAMECORE_MATCH3_SETSTYLEWEIGHTACTION_METHOD_5_69D3C2A117464277_OFFSET UNITYSDK_OFFSET(0x173A5CE0)
#define RPG_GAMECORE_MATCH3_SETSTYLEWEIGHTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x173A5C70)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int SetStyleWeightAction_TypeDefinitionIndex = 22739;
