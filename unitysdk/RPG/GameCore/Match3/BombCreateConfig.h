...
#define RPG_GAMECORE_MATCH3_BOMBCREATECONFIG_METHOD_2_5E9910F99817B6EA_OFFSET UNITYSDK_OFFSET(0x1BD258B0)
#define RPG_GAMECORE_MATCH3_BOMBCREATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD25AB0)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int BombCreateConfig_TypeDefinitionIndex = 23997;
