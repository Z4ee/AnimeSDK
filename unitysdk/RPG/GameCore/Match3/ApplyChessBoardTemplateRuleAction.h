...
#define RPG_GAMECORE_MATCH3_APPLYCHESSBOARDTEMPLATERULEACTION_METHOD_5_2461F01E04B7274A_OFFSET UNITYSDK_OFFSET(0x18AAE270)
#define RPG_GAMECORE_MATCH3_APPLYCHESSBOARDTEMPLATERULEACTION_METHOD_5_65F7A4CF77CC63CC_OFFSET UNITYSDK_OFFSET(0x18AAE150)
#define RPG_GAMECORE_MATCH3_APPLYCHESSBOARDTEMPLATERULEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18AAE200)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int ApplyChessBoardTemplateRuleAction_TypeDefinitionIndex = 23704;
