...
#define RPG_GAMECORE_MATCH3_APPLYCHESSBOARDTEMPLATERULEACTION_METHOD_5_2461F01E04B7274A_OFFSET UNITYSDK_OFFSET(0x173A01D0)
#define RPG_GAMECORE_MATCH3_APPLYCHESSBOARDTEMPLATERULEACTION_METHOD_5_65F7A4CF77CC63CC_OFFSET UNITYSDK_OFFSET(0x173A00B0)
#define RPG_GAMECORE_MATCH3_APPLYCHESSBOARDTEMPLATERULEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x173A0160)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int ApplyChessBoardTemplateRuleAction_TypeDefinitionIndex = 22731;
