...
#define RPG_GAMECORE_MATCH3_APPLYOPPONENTCURVEACTION_METHOD_5_A4BBB32687D9238C_OFFSET UNITYSDK_OFFSET(0x1D25D390)
#define RPG_GAMECORE_MATCH3_APPLYOPPONENTCURVEACTION_METHOD_5_F8D8CA57B25625B0_OFFSET UNITYSDK_OFFSET(0x1D25D3F0)
#define RPG_GAMECORE_MATCH3_APPLYOPPONENTCURVEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D25D3E0)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int ApplyOpponentCurveAction_TypeDefinitionIndex = 24616;
