...
#define RPG_GAMECORE_MATCH3_APPLYOPPONENTCURVEACTION_METHOD_5_C59608F28734CAC1_OFFSET UNITYSDK_OFFSET(0x18AAE360)
#define RPG_GAMECORE_MATCH3_APPLYOPPONENTCURVEACTION_METHOD_5_F8D8CA57B25625B0_OFFSET UNITYSDK_OFFSET(0x18AAE480)
#define RPG_GAMECORE_MATCH3_APPLYOPPONENTCURVEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18AAE410)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int ApplyOpponentCurveAction_TypeDefinitionIndex = 23702;
