...
#define RPG_GAMECORE_MATCH3_TAGBEHAVIOURCONFIG_METHOD_2_719BF9664D7DA201_OFFSET UNITYSDK_OFFSET(0x1BD28570)
#define RPG_GAMECORE_MATCH3_TAGBEHAVIOURCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD2C730)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int TagBehaviourConfig_TypeDefinitionIndex = 24081;
