...
#define RPG_GAMECORE_MATCH3_TAGBEHAVIOURCONFIG_METHOD_2_53C2EC3A8565C073_OFFSET UNITYSDK_OFFSET(0x173AD000)
#define RPG_GAMECORE_MATCH3_TAGBEHAVIOURCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x173AD330)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int TagBehaviourConfig_TypeDefinitionIndex = 22785;
