...
#define RPG_GAMECORE_MATCH3_STARTSECTIONTRIGGER_METHOD_4_0CDBB3A58FD54EA3_OFFSET UNITYSDK_OFFSET(0x173ACDF0)
#define RPG_GAMECORE_MATCH3_STARTSECTIONTRIGGER_METHOD_4_51A894E392D1E722_OFFSET UNITYSDK_OFFSET(0x173AAD20)
#define RPG_GAMECORE_MATCH3_STARTSECTIONTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x173AAD10)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int StartSectionTrigger_TypeDefinitionIndex = 22709;
