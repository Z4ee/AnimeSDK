...
#define RPG_GAMECORE_MATCH3_MATCH3CHESSBOARDGRIDINFO_METHOD_2_4911C675EA4D4ED1_OFFSET UNITYSDK_OFFSET(0x1BD26960)
#define RPG_GAMECORE_MATCH3_MATCH3CHESSBOARDGRIDINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD26C00)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int Match3ChessBoardGridInfo_TypeDefinitionIndex = 24053;
