...
#define RPG_GAMECORE_MATCH3_BIRDPIECETYPEWEIGHTCONFIG_METHOD_2_8D003DEB89E5CC7F_OFFSET UNITYSDK_OFFSET(0x1D25D6D0)
#define RPG_GAMECORE_MATCH3_BIRDPIECETYPEWEIGHTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D25D8C0)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int BirdPieceTypeWeightConfig_TypeDefinitionIndex = 24654;
