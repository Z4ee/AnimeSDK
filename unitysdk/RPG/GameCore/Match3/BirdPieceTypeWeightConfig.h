...
#define RPG_GAMECORE_MATCH3_BIRDPIECETYPEWEIGHTCONFIG_METHOD_2_8D003DEB89E5CC7F_OFFSET UNITYSDK_OFFSET(0x173A06C0)
#define RPG_GAMECORE_MATCH3_BIRDPIECETYPEWEIGHTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x173A08B0)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int BirdPieceTypeWeightConfig_TypeDefinitionIndex = 22767;
