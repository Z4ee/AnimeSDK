...
#define RPG_GAMECORE_MATCH3_BIRDPIECETYPEWEIGHTCONFIG_METHOD_2_8D003DEB89E5CC7F_OFFSET UNITYSDK_OFFSET(0x1BD24DC0)
#define RPG_GAMECORE_MATCH3_BIRDPIECETYPEWEIGHTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD24FB0)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int BirdPieceTypeWeightConfig_TypeDefinitionIndex = 24065;
