...
#define RPG_GAMECORE_MATCH3_STEPPOWERLARGERTHANCONDITION_METHOD_5_4A66BD985C38D7FA_OFFSET UNITYSDK_OFFSET(0x1BD28160)
#define RPG_GAMECORE_MATCH3_STEPPOWERLARGERTHANCONDITION_METHOD_5_FEA07EDECF700460_OFFSET UNITYSDK_OFFSET(0x1BD2C6E0)
#define RPG_GAMECORE_MATCH3_STEPPOWERLARGERTHANCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD28150)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int StepPowerLargerThanCondition_TypeDefinitionIndex = 24021;
