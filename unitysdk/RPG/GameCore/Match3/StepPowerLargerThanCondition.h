...
#define RPG_GAMECORE_MATCH3_STEPPOWERLARGERTHANCONDITION_METHOD_5_4A66BD985C38D7FA_OFFSET UNITYSDK_OFFSET(0x18AB7AD0)
#define RPG_GAMECORE_MATCH3_STEPPOWERLARGERTHANCONDITION_METHOD_5_90968FFB13DA5673_OFFSET UNITYSDK_OFFSET(0x18ABB640)
#define RPG_GAMECORE_MATCH3_STEPPOWERLARGERTHANCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x18AB7A50)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int StepPowerLargerThanCondition_TypeDefinitionIndex = 23695;
