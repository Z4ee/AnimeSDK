...
#define RPG_GAMECORE_MATCH3_LOGICANDCONDITION_METHOD_5_3B21C42760748960_OFFSET UNITYSDK_OFFSET(0x18AB0220)
#define RPG_GAMECORE_MATCH3_LOGICANDCONDITION_METHOD_5_9CF379A0468E7C45_OFFSET UNITYSDK_OFFSET(0x18AB0360)
#define RPG_GAMECORE_MATCH3_LOGICANDCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x18AB02E0)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int LogicAndCondition_TypeDefinitionIndex = 23697;
