...
#define RPG_GAMECORE_MATCH3_STARTENEMYSECTIONTRIGGER_METHOD_4_02573FBAF58FF6EE_OFFSET UNITYSDK_OFFSET(0x1D262040)
#define RPG_GAMECORE_MATCH3_STARTENEMYSECTIONTRIGGER_METHOD_4_75F6B0020FE3829F_OFFSET UNITYSDK_OFFSET(0x1D264D60)
#define RPG_GAMECORE_MATCH3_STARTENEMYSECTIONTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D262030)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int StartEnemySectionTrigger_TypeDefinitionIndex = 24598;
