...
#define RPG_GAMECORE_MATCH3_MATCHTHREE1V1AISCOREASPECTCONFIG_METHOD_2_B3C2C61961A7052E_OFFSET UNITYSDK_OFFSET(0x198EA420)
#define RPG_GAMECORE_MATCH3_MATCHTHREE1V1AISCOREASPECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x198EA5A0)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int MatchThree1v1AIScoreAspectConfig_TypeDefinitionIndex = 23589;
