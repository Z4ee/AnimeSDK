...
#define RPG_GAMECORE_MATCH3_ENDROUNDTRIGGER_METHOD_4_9EFF1473EFC81682_OFFSET UNITYSDK_OFFSET(0x18AAFA30)
#define RPG_GAMECORE_MATCH3_ENDROUNDTRIGGER_METHOD_4_F4939A64300FF303_OFFSET UNITYSDK_OFFSET(0x18AAF990)
#define RPG_GAMECORE_MATCH3_ENDROUNDTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x18AAFA20)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int EndRoundTrigger_TypeDefinitionIndex = 23681;
