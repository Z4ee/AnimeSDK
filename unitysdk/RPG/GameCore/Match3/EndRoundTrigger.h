...
#define RPG_GAMECORE_MATCH3_ENDROUNDTRIGGER_METHOD_4_9EFF1473EFC81682_OFFSET UNITYSDK_OFFSET(0x198E1340)
#define RPG_GAMECORE_MATCH3_ENDROUNDTRIGGER_METHOD_4_F4939A64300FF303_OFFSET UNITYSDK_OFFSET(0x198E12A0)
#define RPG_GAMECORE_MATCH3_ENDROUNDTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x198E1330)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int EndRoundTrigger_TypeDefinitionIndex = 23518;
