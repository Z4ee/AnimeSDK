...
#define RPG_GAMECORE_MATCH3_SETSCOREBONUSACTION_METHOD_5_B8FC9CD481543706_OFFSET UNITYSDK_OFFSET(0x173A5A60)
#define RPG_GAMECORE_MATCH3_SETSCOREBONUSACTION_METHOD_5_EBD08443661EE41D_OFFSET UNITYSDK_OFFSET(0x173AC610)
#define RPG_GAMECORE_MATCH3_SETSCOREBONUSACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x173A59F0)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int SetScoreBonusAction_TypeDefinitionIndex = 22742;
