...
#define RPG_GAMECORE_MATCH3_SETSCOREBONUSACTION_METHOD_5_5D70322A3CACDCB8_OFFSET UNITYSDK_OFFSET(0x1D263EF0)
#define RPG_GAMECORE_MATCH3_SETSCOREBONUSACTION_METHOD_5_B8FC9CD481543706_OFFSET UNITYSDK_OFFSET(0x1D263F50)
#define RPG_GAMECORE_MATCH3_SETSCOREBONUSACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D263F40)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int SetScoreBonusAction_TypeDefinitionIndex = 24629;
