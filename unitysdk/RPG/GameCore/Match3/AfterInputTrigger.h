...
#define RPG_GAMECORE_MATCH3_AFTERINPUTTRIGGER_METHOD_4_B57A25A481E1E43A_OFFSET UNITYSDK_OFFSET(0x1739FC90)
#define RPG_GAMECORE_MATCH3_AFTERINPUTTRIGGER_METHOD_4_C5C18DAE7E79945B_OFFSET UNITYSDK_OFFSET(0x1739FD30)
#define RPG_GAMECORE_MATCH3_AFTERINPUTTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1739FD20)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int AfterInputTrigger_TypeDefinitionIndex = 22704;
