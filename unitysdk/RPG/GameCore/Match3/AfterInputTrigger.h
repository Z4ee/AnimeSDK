...
#define RPG_GAMECORE_MATCH3_AFTERINPUTTRIGGER_METHOD_4_B57A25A481E1E43A_OFFSET UNITYSDK_OFFSET(0x1D25CEE0)
#define RPG_GAMECORE_MATCH3_AFTERINPUTTRIGGER_METHOD_4_C5C18DAE7E79945B_OFFSET UNITYSDK_OFFSET(0x1D25CF80)
#define RPG_GAMECORE_MATCH3_AFTERINPUTTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D25CF70)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int AfterInputTrigger_TypeDefinitionIndex = 24592;
