...
#define RPG_GAMECORE_MATCH3_RESETPROPUSECOUNTACTION_METHOD_5_3428437EA378E41B_OFFSET UNITYSDK_OFFSET(0x198E3730)
#define RPG_GAMECORE_MATCH3_RESETPROPUSECOUNTACTION_METHOD_5_DBEE0554D4342B32_OFFSET UNITYSDK_OFFSET(0x198EAFA0)
#define RPG_GAMECORE_MATCH3_RESETPROPUSECOUNTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x198E36C0)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int ResetPropUseCountAction_TypeDefinitionIndex = 23553;
