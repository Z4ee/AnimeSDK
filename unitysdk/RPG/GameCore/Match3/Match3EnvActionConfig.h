...
#define RPG_GAMECORE_MATCH3_MATCH3ENVACTIONCONFIG_METHOD_2_F3AC746DEBE6B7A5_OFFSET UNITYSDK_OFFSET(0x173A9F50)
#define RPG_GAMECORE_MATCH3_MATCH3ENVACTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x173AA0A0)
