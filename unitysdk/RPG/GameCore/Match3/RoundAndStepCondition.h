...
#define RPG_GAMECORE_MATCH3_ROUNDANDSTEPCONDITION_METHOD_5_61063213955B8018_OFFSET UNITYSDK_OFFSET(0x18AB7490)
#define RPG_GAMECORE_MATCH3_ROUNDANDSTEPCONDITION_METHOD_5_DE2C30481A1D0514_OFFSET UNITYSDK_OFFSET(0x18ABA810)
#define RPG_GAMECORE_MATCH3_ROUNDANDSTEPCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x18AB7410)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int RoundAndStepCondition_TypeDefinitionIndex = 23686;
