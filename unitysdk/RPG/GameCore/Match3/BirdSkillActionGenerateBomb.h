...
#define RPG_GAMECORE_MATCH3_BIRDSKILLACTIONGENERATEBOMB_METHOD_5_3793E39D59A6C5BE_OFFSET UNITYSDK_OFFSET(0x18AAECD0)
#define RPG_GAMECORE_MATCH3_BIRDSKILLACTIONGENERATEBOMB_METHOD_5_50754097DB3A1DB1_OFFSET UNITYSDK_OFFSET(0x18AAEBC0)
#define RPG_GAMECORE_MATCH3_BIRDSKILLACTIONGENERATEBOMB__CTOR_OFFSET UNITYSDK_OFFSET(0x18AAEC60)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int BirdSkillActionGenerateBomb_TypeDefinitionIndex = 23734;
