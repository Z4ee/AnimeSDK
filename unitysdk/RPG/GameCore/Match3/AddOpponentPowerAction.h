...
#define RPG_GAMECORE_MATCH3_ADDOPPONENTPOWERACTION_METHOD_5_0344763E9D46A380_OFFSET UNITYSDK_OFFSET(0x1739F810)
#define RPG_GAMECORE_MATCH3_ADDOPPONENTPOWERACTION_METHOD_5_093617CEC283FC47_OFFSET UNITYSDK_OFFSET(0x1739F930)
#define RPG_GAMECORE_MATCH3_ADDOPPONENTPOWERACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1739F8C0)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int AddOpponentPowerAction_TypeDefinitionIndex = 22730;
