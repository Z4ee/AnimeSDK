...
#define RPG_GAMECORE_MATCH3_SHOWTEXTDIALOGACTION_METHOD_5_94CCC5794815341A_OFFSET UNITYSDK_OFFSET(0x18AB4DC0)
#define RPG_GAMECORE_MATCH3_SHOWTEXTDIALOGACTION_METHOD_5_BE4EA39764BA794F_OFFSET UNITYSDK_OFFSET(0x18ABB290)
#define RPG_GAMECORE_MATCH3_SHOWTEXTDIALOGACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18AB4D50)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int ShowTextDialogAction_TypeDefinitionIndex = 23708;
