...
#define RPG_GAMECORE_MATCH3_SHOWTEXTDIALOGACTION_METHOD_5_27FA6E80198C6FB6_OFFSET UNITYSDK_OFFSET(0x1BD2C2A0)
#define RPG_GAMECORE_MATCH3_SHOWTEXTDIALOGACTION_METHOD_5_94CCC5794815341A_OFFSET UNITYSDK_OFFSET(0x1BD2C300)
#define RPG_GAMECORE_MATCH3_SHOWTEXTDIALOGACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD2C2F0)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int ShowTextDialogAction_TypeDefinitionIndex = 24033;
