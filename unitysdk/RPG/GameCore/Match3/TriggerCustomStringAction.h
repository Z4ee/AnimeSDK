...
#define RPG_GAMECORE_MATCH3_TRIGGERCUSTOMSTRINGACTION_METHOD_5_14BF6998047AD498_OFFSET UNITYSDK_OFFSET(0x18AB5030)
#define RPG_GAMECORE_MATCH3_TRIGGERCUSTOMSTRINGACTION_METHOD_5_C7623F015A78DF66_OFFSET UNITYSDK_OFFSET(0x18ABB710)
#define RPG_GAMECORE_MATCH3_TRIGGERCUSTOMSTRINGACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18AB4FC0)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int TriggerCustomStringAction_TypeDefinitionIndex = 23710;
