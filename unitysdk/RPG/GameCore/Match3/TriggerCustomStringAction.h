...
#define RPG_GAMECORE_MATCH3_TRIGGERCUSTOMSTRINGACTION_METHOD_5_14BF6998047AD498_OFFSET UNITYSDK_OFFSET(0x1D247750)
#define RPG_GAMECORE_MATCH3_TRIGGERCUSTOMSTRINGACTION_METHOD_5_7E9E4AD05F41AB70_OFFSET UNITYSDK_OFFSET(0x1D2476F0)
#define RPG_GAMECORE_MATCH3_TRIGGERCUSTOMSTRINGACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D247740)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int TriggerCustomStringAction_TypeDefinitionIndex = 24624;
