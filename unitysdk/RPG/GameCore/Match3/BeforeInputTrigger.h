...
#define RPG_GAMECORE_MATCH3_BEFOREINPUTTRIGGER_METHOD_4_10B32EF2C26D4180_OFFSET UNITYSDK_OFFSET(0x18AAE600)
#define RPG_GAMECORE_MATCH3_BEFOREINPUTTRIGGER_METHOD_4_7F0B9261D0824945_OFFSET UNITYSDK_OFFSET(0x18AAE560)
#define RPG_GAMECORE_MATCH3_BEFOREINPUTTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x18AAE5F0)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int BeforeInputTrigger_TypeDefinitionIndex = 23676;
