...
#define RPG_GAMECORE_MATCH3_BEFOREINPUTTRIGGER_METHOD_4_10B32EF2C26D4180_OFFSET UNITYSDK_OFFSET(0x173A0560)
#define RPG_GAMECORE_MATCH3_BEFOREINPUTTRIGGER_METHOD_4_7F0B9261D0824945_OFFSET UNITYSDK_OFFSET(0x173A04C0)
#define RPG_GAMECORE_MATCH3_BEFOREINPUTTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x173A0550)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int BeforeInputTrigger_TypeDefinitionIndex = 22703;
