...
#define RPG_GAMECORE_MATCH3_SHOWEMOJIACTION_METHOD_5_B5DF3AABAE6943CA_OFFSET UNITYSDK_OFFSET(0x173A66A0)
#define RPG_GAMECORE_MATCH3_SHOWEMOJIACTION_METHOD_5_DDED07DED3590889_OFFSET UNITYSDK_OFFSET(0x173AC980)
#define RPG_GAMECORE_MATCH3_SHOWEMOJIACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x173A6630)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int ShowEmojiAction_TypeDefinitionIndex = 22736;
