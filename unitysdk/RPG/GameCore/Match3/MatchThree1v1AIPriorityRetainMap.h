...
#define RPG_GAMECORE_MATCH3_MATCHTHREE1V1AIPRIORITYRETAINMAP_METHOD_2_0A52FE55CA21B4B4_OFFSET UNITYSDK_OFFSET(0x1BD29C00)
#define RPG_GAMECORE_MATCH3_MATCHTHREE1V1AIPRIORITYRETAINMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD29D50)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int MatchThree1v1AIPriorityRetainMap_TypeDefinitionIndex = 24076;
