...
#define RPG_GAMECORE_MATCH3_MATCHTHREE1V1AIPRIORITYRETAINCONFIG_METHOD_2_23627825466CED96_OFFSET UNITYSDK_OFFSET(0x18AB9650)
#define RPG_GAMECORE_MATCH3_MATCHTHREE1V1AIPRIORITYRETAINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18AB97A0)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int MatchThree1v1AIPriorityRetainConfig_TypeDefinitionIndex = 23752;
