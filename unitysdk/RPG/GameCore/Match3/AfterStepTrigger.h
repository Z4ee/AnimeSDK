...
#define RPG_GAMECORE_MATCH3_AFTERSTEPTRIGGER_METHOD_4_8D1157C719BA4531_OFFSET UNITYSDK_OFFSET(0x1D25D090)
#define RPG_GAMECORE_MATCH3_AFTERSTEPTRIGGER_METHOD_4_96734080A5ECECDC_OFFSET UNITYSDK_OFFSET(0x1D25CFF0)
#define RPG_GAMECORE_MATCH3_AFTERSTEPTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D25D080)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int AfterStepTrigger_TypeDefinitionIndex = 24593;
