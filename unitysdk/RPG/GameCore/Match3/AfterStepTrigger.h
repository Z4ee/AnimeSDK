...
#define RPG_GAMECORE_MATCH3_AFTERSTEPTRIGGER_METHOD_4_8D1157C719BA4531_OFFSET UNITYSDK_OFFSET(0x198DF800)
#define RPG_GAMECORE_MATCH3_AFTERSTEPTRIGGER_METHOD_4_96734080A5ECECDC_OFFSET UNITYSDK_OFFSET(0x198DF760)
#define RPG_GAMECORE_MATCH3_AFTERSTEPTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x198DF7F0)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int AfterStepTrigger_TypeDefinitionIndex = 23515;
