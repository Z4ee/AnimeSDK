...
#define RPG_GAMECORE_MATCH3_SHOWSIDEDIALOGACTION_METHOD_5_28C798F065679840_OFFSET UNITYSDK_OFFSET(0x173A6B10)
#define RPG_GAMECORE_MATCH3_SHOWSIDEDIALOGACTION_METHOD_5_3491AE6EEC951D5E_OFFSET UNITYSDK_OFFSET(0x173ACAE0)
#define RPG_GAMECORE_MATCH3_SHOWSIDEDIALOGACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x173A6AA0)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int ShowSideDialogAction_TypeDefinitionIndex = 22734;
