...
#define RPG_GAMECORE_MATCH3_SETSUPERGEMPOUCHACTION_METHOD_5_5925CFB2A00527AE_OFFSET UNITYSDK_OFFSET(0x198EB840)
#define RPG_GAMECORE_MATCH3_SETSUPERGEMPOUCHACTION_METHOD_5_6E63E02DC554E499_OFFSET UNITYSDK_OFFSET(0x198E4690)
#define RPG_GAMECORE_MATCH3_SETSUPERGEMPOUCHACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x198E4620)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int SetSuperGemPouchAction_TypeDefinitionIndex = 23561;
