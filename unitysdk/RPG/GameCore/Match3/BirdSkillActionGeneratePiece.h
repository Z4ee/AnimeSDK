...
#define RPG_GAMECORE_MATCH3_BIRDSKILLACTIONGENERATEPIECE_METHOD_5_9C1D7A38DBA991DD_OFFSET UNITYSDK_OFFSET(0x18AAF0C0)
#define RPG_GAMECORE_MATCH3_BIRDSKILLACTIONGENERATEPIECE_METHOD_5_D927DB1AF5D951D2_OFFSET UNITYSDK_OFFSET(0x18AAF1D0)
#define RPG_GAMECORE_MATCH3_BIRDSKILLACTIONGENERATEPIECE__CTOR_OFFSET UNITYSDK_OFFSET(0x18AAF160)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int BirdSkillActionGeneratePiece_TypeDefinitionIndex = 23735;
