...
#define RPG_GAMECORE_MATCH3_BIRDSKILLACTIONGENERATEPIECE_METHOD_5_D927DB1AF5D951D2_OFFSET UNITYSDK_OFFSET(0x1BD254C0)
#define RPG_GAMECORE_MATCH3_BIRDSKILLACTIONGENERATEPIECE_METHOD_5_ECFA267E5798C69F_OFFSET UNITYSDK_OFFSET(0x1BD25480)
#define RPG_GAMECORE_MATCH3_BIRDSKILLACTIONGENERATEPIECE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD254B0)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int BirdSkillActionGeneratePiece_TypeDefinitionIndex = 24060;
