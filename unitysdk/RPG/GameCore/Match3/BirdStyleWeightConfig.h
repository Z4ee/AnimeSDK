...
#define RPG_GAMECORE_MATCH3_BIRDSTYLEWEIGHTCONFIG_METHOD_2_3552876F09019ED9_OFFSET UNITYSDK_OFFSET(0x18AAF4C0)
#define RPG_GAMECORE_MATCH3_BIRDSTYLEWEIGHTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18AAF5B0)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int BirdStyleWeightConfig_TypeDefinitionIndex = 23738;
