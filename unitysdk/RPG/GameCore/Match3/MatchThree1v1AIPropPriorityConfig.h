...
#define RPG_GAMECORE_MATCH3_MATCHTHREE1V1AIPROPPRIORITYCONFIG_METHOD_2_974D471643D41906_OFFSET UNITYSDK_OFFSET(0x198EA2E0)
#define RPG_GAMECORE_MATCH3_MATCHTHREE1V1AIPROPPRIORITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x198EA410)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int MatchThree1v1AIPropPriorityConfig_TypeDefinitionIndex = 23590;
