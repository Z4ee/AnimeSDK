...
#define RPG_GAMECORE_MATCH3_ADDSCOREBYGEMPOUCHACTION_METHOD_5_1969618E9097D3C5_OFFSET UNITYSDK_OFFSET(0x18AADB30)
#define RPG_GAMECORE_MATCH3_ADDSCOREBYGEMPOUCHACTION_METHOD_5_75D826E496F8D7D4_OFFSET UNITYSDK_OFFSET(0x18AADC50)
#define RPG_GAMECORE_MATCH3_ADDSCOREBYGEMPOUCHACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18AADBE0)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int AddScoreByGemPouchAction_TypeDefinitionIndex = 23705;
