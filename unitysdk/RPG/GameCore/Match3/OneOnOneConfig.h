...
#define RPG_GAMECORE_MATCH3_ONEONONECONFIG_METHOD_2_631FD98FBF79071D_OFFSET UNITYSDK_OFFSET(0x1BD28780)
#define RPG_GAMECORE_MATCH3_ONEONONECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD2A370)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int OneOnOneConfig_TypeDefinitionIndex = 24000;
