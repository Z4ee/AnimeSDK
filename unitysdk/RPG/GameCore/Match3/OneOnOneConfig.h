...
#define RPG_GAMECORE_MATCH3_ONEONONECONFIG_METHOD_2_631FD98FBF79071D_OFFSET UNITYSDK_OFFSET(0x173A9B20)
#define RPG_GAMECORE_MATCH3_ONEONONECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x173AB820)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int OneOnOneConfig_TypeDefinitionIndex = 22701;
