...
#define RPG_GAMECORE_MATCH3_GEMPOUCHEXISTSCONDITION_METHOD_5_8E4CBE21998C37E2_OFFSET UNITYSDK_OFFSET(0x173A1DE0)
#define RPG_GAMECORE_MATCH3_GEMPOUCHEXISTSCONDITION_METHOD_5_99BD7E41804AA513_OFFSET UNITYSDK_OFFSET(0x173A1BC0)
#define RPG_GAMECORE_MATCH3_GEMPOUCHEXISTSCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x173A1D60)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int GemPouchExistsCondition_TypeDefinitionIndex = 22718;
