...
#define RPG_GAMECORE_MATCH3_GEMPOUCHEXISTSCONDITION_METHOD_5_8E4CBE21998C37E2_OFFSET UNITYSDK_OFFSET(0x1BD26050)
#define RPG_GAMECORE_MATCH3_GEMPOUCHEXISTSCONDITION_METHOD_5_ADEA620B69BDEDB6_OFFSET UNITYSDK_OFFSET(0x1BD25F40)
#define RPG_GAMECORE_MATCH3_GEMPOUCHEXISTSCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD26040)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int GemPouchExistsCondition_TypeDefinitionIndex = 24017;
