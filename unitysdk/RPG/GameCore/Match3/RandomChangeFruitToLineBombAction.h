...
#define RPG_GAMECORE_MATCH3_RANDOMCHANGEFRUITTOLINEBOMBACTION_METHOD_5_192FCB22919003DE_OFFSET UNITYSDK_OFFSET(0x18AB2A00)
#define RPG_GAMECORE_MATCH3_RANDOMCHANGEFRUITTOLINEBOMBACTION_METHOD_5_BA46351B25EDB7EC_OFFSET UNITYSDK_OFFSET(0x18ABA470)
#define RPG_GAMECORE_MATCH3_RANDOMCHANGEFRUITTOLINEBOMBACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18AB2990)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int RandomChangeFruitToLineBombAction_TypeDefinitionIndex = 23722;
