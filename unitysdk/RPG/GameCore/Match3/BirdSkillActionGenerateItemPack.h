...
#define RPG_GAMECORE_MATCH3_BIRDSKILLACTIONGENERATEITEMPACK_METHOD_5_07F523705A4C7B75_OFFSET UNITYSDK_OFFSET(0x173A0F40)
#define RPG_GAMECORE_MATCH3_BIRDSKILLACTIONGENERATEITEMPACK_METHOD_5_61525920204C4ED3_OFFSET UNITYSDK_OFFSET(0x173A0E30)
#define RPG_GAMECORE_MATCH3_BIRDSKILLACTIONGENERATEITEMPACK__CTOR_OFFSET UNITYSDK_OFFSET(0x173A0ED0)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int BirdSkillActionGenerateItemPack_TypeDefinitionIndex = 22764;
