...
#define RPG_GAMECORE_MATCH3_LOGICORCONDITION_METHOD_5_2D206C3CDE0904D1_OFFSET UNITYSDK_OFFSET(0x18AB0610)
#define RPG_GAMECORE_MATCH3_LOGICORCONDITION_METHOD_5_8D564AF70A867604_OFFSET UNITYSDK_OFFSET(0x18AB04D0)
#define RPG_GAMECORE_MATCH3_LOGICORCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x18AB0590)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int LogicOrCondition_TypeDefinitionIndex = 23698;
