...
#define RPG_GAMECORE_MATCH3_LOGICORCONDITION_METHOD_5_2D206C3CDE0904D1_OFFSET UNITYSDK_OFFSET(0x1BD26500)
#define RPG_GAMECORE_MATCH3_LOGICORCONDITION_METHOD_5_AE685C35DF12B4B1_OFFSET UNITYSDK_OFFSET(0x1BD264A0)
#define RPG_GAMECORE_MATCH3_LOGICORCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD264F0)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int LogicOrCondition_TypeDefinitionIndex = 24024;
