...
#define RPG_GAMECORE_MATCH3_BIRDSKILLCHARGINGCONFIG_METHOD_2_096D7C2B0D193E44_OFFSET UNITYSDK_OFFSET(0x198E0C90)
#define RPG_GAMECORE_MATCH3_BIRDSKILLCHARGINGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x198E0DD0)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int BirdSkillChargingConfig_TypeDefinitionIndex = 23569;
