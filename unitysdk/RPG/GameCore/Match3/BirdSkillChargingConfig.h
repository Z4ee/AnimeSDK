...
#define RPG_GAMECORE_MATCH3_BIRDSKILLCHARGINGCONFIG_METHOD_2_096D7C2B0D193E44_OFFSET UNITYSDK_OFFSET(0x173A12D0)
#define RPG_GAMECORE_MATCH3_BIRDSKILLCHARGINGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x173A1410)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int BirdSkillChargingConfig_TypeDefinitionIndex = 22760;
