...
#define RPG_GAMECORE_MATCH3_STARTROUNDTRIGGER_METHOD_4_2F66486E63CBD56C_OFFSET UNITYSDK_OFFSET(0x198EBE30)
#define RPG_GAMECORE_MATCH3_STARTROUNDTRIGGER_METHOD_4_34B57D62BA789381_OFFSET UNITYSDK_OFFSET(0x198E9D90)
#define RPG_GAMECORE_MATCH3_STARTROUNDTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x198E9D80)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int StartRoundTrigger_TypeDefinitionIndex = 23517;
