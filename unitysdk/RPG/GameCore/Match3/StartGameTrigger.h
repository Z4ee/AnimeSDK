...
#define RPG_GAMECORE_MATCH3_STARTGAMETRIGGER_METHOD_4_4395B0DE9F0E2D77_OFFSET UNITYSDK_OFFSET(0x18AB9340)
#define RPG_GAMECORE_MATCH3_STARTGAMETRIGGER_METHOD_4_6F4A868D5C71A386_OFFSET UNITYSDK_OFFSET(0x18ABB3D0)
#define RPG_GAMECORE_MATCH3_STARTGAMETRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x18AB9330)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int StartGameTrigger_TypeDefinitionIndex = 23679;
