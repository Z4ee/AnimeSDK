...
#define RPG_GAMECORE_MATCH3_RANDOMFREEZEBOMBACTION_METHOD_5_0589B181DE51E26F_OFFSET UNITYSDK_OFFSET(0x1BD2AB10)
#define RPG_GAMECORE_MATCH3_RANDOMFREEZEBOMBACTION_METHOD_5_6D207B0E2CB76D0E_OFFSET UNITYSDK_OFFSET(0x1BD2AAB0)
#define RPG_GAMECORE_MATCH3_RANDOMFREEZEBOMBACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD2AB00)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int RandomFreezeBombAction_TypeDefinitionIndex = 24045;
