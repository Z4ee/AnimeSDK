...
#define RPG_GAMECORE_MATCH3_RANDOMFREEZEBOMBACTION_METHOD_5_0589B181DE51E26F_OFFSET UNITYSDK_OFFSET(0x198E3330)
#define RPG_GAMECORE_MATCH3_RANDOMFREEZEBOMBACTION_METHOD_5_E7BB0BEADF59CB19_OFFSET UNITYSDK_OFFSET(0x198EAEF0)
#define RPG_GAMECORE_MATCH3_RANDOMFREEZEBOMBACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x198E32C0)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int RandomFreezeBombAction_TypeDefinitionIndex = 23556;
