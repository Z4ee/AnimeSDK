...
#define RPG_GAMECORE_MATCH3_MATCH3TRIGGERBASE_METHOD_3_4BF3AEF28061CCC3_OFFSET UNITYSDK_OFFSET(0x173AAB60)
#define RPG_GAMECORE_MATCH3_MATCH3TRIGGERBASE_METHOD_3_BB7C501AE052E965_OFFSET UNITYSDK_OFFSET(0x173AA0B0)
#define RPG_GAMECORE_MATCH3_MATCH3TRIGGERBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1739FD90)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int Match3TriggerBase_TypeDefinitionIndex = 22702;
