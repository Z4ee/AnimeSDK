...
#define RPG_GAMECORE_MATCH3_HASPROPINPUTCONDITION_METHOD_5_0BB67E5A857DE9E5_OFFSET UNITYSDK_OFFSET(0x1D25EB30)
#define RPG_GAMECORE_MATCH3_HASPROPINPUTCONDITION_METHOD_5_BF0042D7E8687891_OFFSET UNITYSDK_OFFSET(0x1D25EA20)
#define RPG_GAMECORE_MATCH3_HASPROPINPUTCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D25EB20)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int HasPropInputCondition_TypeDefinitionIndex = 24611;
