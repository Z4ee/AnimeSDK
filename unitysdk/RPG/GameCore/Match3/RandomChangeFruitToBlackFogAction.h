...
#define RPG_GAMECORE_MATCH3_RANDOMCHANGEFRUITTOBLACKFOGACTION_METHOD_5_0B456AEA89B3446F_OFFSET UNITYSDK_OFFSET(0x198E2E90)
#define RPG_GAMECORE_MATCH3_RANDOMCHANGEFRUITTOBLACKFOGACTION_METHOD_5_FE863565244D7A99_OFFSET UNITYSDK_OFFSET(0x198EAD90)
#define RPG_GAMECORE_MATCH3_RANDOMCHANGEFRUITTOBLACKFOGACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x198E2E20)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int RandomChangeFruitToBlackFogAction_TypeDefinitionIndex = 23559;
