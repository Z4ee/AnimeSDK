...
#define RPG_GAMECORE_MATCH3_SHOWPOPUPDIALOGACTION_METHOD_5_3C4D82EBE65ED1A9_OFFSET UNITYSDK_OFFSET(0x173A6910)
#define RPG_GAMECORE_MATCH3_SHOWPOPUPDIALOGACTION_METHOD_5_75817511A69FF8FE_OFFSET UNITYSDK_OFFSET(0x173ACA30)
#define RPG_GAMECORE_MATCH3_SHOWPOPUPDIALOGACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x173A68A0)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int ShowPopupDialogAction_TypeDefinitionIndex = 22733;
