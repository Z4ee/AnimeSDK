...
#define RPG_GAMECORE_MATCH3_SHOWPOPUPDIALOGACTION_METHOD_5_3C4D82EBE65ED1A9_OFFSET UNITYSDK_OFFSET(0x18AB49B0)
#define RPG_GAMECORE_MATCH3_SHOWPOPUPDIALOGACTION_METHOD_5_75817511A69FF8FE_OFFSET UNITYSDK_OFFSET(0x18ABB130)
#define RPG_GAMECORE_MATCH3_SHOWPOPUPDIALOGACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18AB4940)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int ShowPopupDialogAction_TypeDefinitionIndex = 23706;
