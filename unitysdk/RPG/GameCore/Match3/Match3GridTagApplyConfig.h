...
#define RPG_GAMECORE_MATCH3_MATCH3GRIDTAGAPPLYCONFIG_METHOD_2_7B4117E680CB2DA1_OFFSET UNITYSDK_OFFSET(0x1D244090)
#define RPG_GAMECORE_MATCH3_MATCH3GRIDTAGAPPLYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D244240)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int Match3GridTagApplyConfig_TypeDefinitionIndex = 24659;
