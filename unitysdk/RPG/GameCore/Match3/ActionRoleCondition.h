...
#define RPG_GAMECORE_MATCH3_ACTIONROLECONDITION_METHOD_5_8B6514FD33236E21_OFFSET UNITYSDK_OFFSET(0x18AAD5A0)
#define RPG_GAMECORE_MATCH3_ACTIONROLECONDITION_METHOD_5_A5CF75682A7804A2_OFFSET UNITYSDK_OFFSET(0x18AAD6E0)
#define RPG_GAMECORE_MATCH3_ACTIONROLECONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x18AAD660)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int ActionRoleCondition_TypeDefinitionIndex = 23693;
