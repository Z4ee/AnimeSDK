...
#define RPG_GAMECORE_MATCH3_SETACTIVIZATIONAREAACTION_METHOD_5_B27F0B951EE8177C_OFFSET UNITYSDK_OFFSET(0x18ABAA50)
#define RPG_GAMECORE_MATCH3_SETACTIVIZATIONAREAACTION_METHOD_5_C7D5B3655E83417A_OFFSET UNITYSDK_OFFSET(0x18AB3210)
#define RPG_GAMECORE_MATCH3_SETACTIVIZATIONAREAACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18AB31A0)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int SetActivizationAreaAction_TypeDefinitionIndex = 23716;
