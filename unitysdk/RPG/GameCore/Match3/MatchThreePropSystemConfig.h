...
#define RPG_GAMECORE_MATCH3_MATCHTHREEPROPSYSTEMCONFIG_METHOD_2_75B2B03A8E9AF901_OFFSET UNITYSDK_OFFSET(0x1BD288F0)
#define RPG_GAMECORE_MATCH3_MATCHTHREEPROPSYSTEMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD2A360)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int MatchThreePropSystemConfig_TypeDefinitionIndex = 24073;
