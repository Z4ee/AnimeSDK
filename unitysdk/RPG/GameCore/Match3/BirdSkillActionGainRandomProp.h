...
#define RPG_GAMECORE_MATCH3_BIRDSKILLACTIONGAINRANDOMPROP_METHOD_5_89BBF369C3E82F1E_OFFSET UNITYSDK_OFFSET(0x198E0440)
#define RPG_GAMECORE_MATCH3_BIRDSKILLACTIONGAINRANDOMPROP_METHOD_5_BE5739C84542AA40_OFFSET UNITYSDK_OFFSET(0x198E0280)
#define RPG_GAMECORE_MATCH3_BIRDSKILLACTIONGAINRANDOMPROP__CTOR_OFFSET UNITYSDK_OFFSET(0x198E03D0)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int BirdSkillActionGainRandomProp_TypeDefinitionIndex = 23572;
