...
#define RPG_GAMECORE_MATCH3_STEPCONDITION_METHOD_5_CA34EB9B8321EA41_OFFSET UNITYSDK_OFFSET(0x173A9580)
#define RPG_GAMECORE_MATCH3_STEPCONDITION_METHOD_5_F28F1BF3362017E6_OFFSET UNITYSDK_OFFSET(0x173ACE80)
#define RPG_GAMECORE_MATCH3_STEPCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x173A9500)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int StepCondition_TypeDefinitionIndex = 22715;
