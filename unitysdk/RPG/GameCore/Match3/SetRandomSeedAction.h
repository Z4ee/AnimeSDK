...
#define RPG_GAMECORE_MATCH3_SETRANDOMSEEDACTION_METHOD_5_1551C07811D0AAA6_OFFSET UNITYSDK_OFFSET(0x198E3FE0)
#define RPG_GAMECORE_MATCH3_SETRANDOMSEEDACTION_METHOD_5_C38AE1F49E02BA4B_OFFSET UNITYSDK_OFFSET(0x198EB630)
#define RPG_GAMECORE_MATCH3_SETRANDOMSEEDACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x198E3F70)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int SetRandomSeedAction_TypeDefinitionIndex = 23547;
