...
#define RPG_GAMECORE_MATCH3_MATCH3CONDITIONBASE_METHOD_4_1D6364E517886E38_OFFSET UNITYSDK_OFFSET(0x1D25F780)
#define RPG_GAMECORE_MATCH3_MATCH3CONDITIONBASE_METHOD_4_D30CFC42DE5C7064_OFFSET UNITYSDK_OFFSET(0x1D260010)
#define RPG_GAMECORE_MATCH3_MATCH3CONDITIONBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D25CC10)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int Match3ConditionBase_TypeDefinitionIndex = 24600;
