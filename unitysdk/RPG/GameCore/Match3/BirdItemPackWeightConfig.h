...
#define RPG_GAMECORE_MATCH3_BIRDITEMPACKWEIGHTCONFIG_METHOD_2_E35BB5D51F265CD4_OFFSET UNITYSDK_OFFSET(0x1D23FC70)
#define RPG_GAMECORE_MATCH3_BIRDITEMPACKWEIGHTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D23FD60)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int BirdItemPackWeightConfig_TypeDefinitionIndex = 24653;
