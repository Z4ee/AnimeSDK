...
#define RPG_GAMECORE_MATCH3_MATCH3TEMPLATEAPPLYCONFIG_METHOD_2_C6067CF274CE03E9_OFFSET UNITYSDK_OFFSET(0x1D260D20)
#define RPG_GAMECORE_MATCH3_MATCH3TEMPLATEAPPLYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D261FC0)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int Match3TemplateApplyConfig_TypeDefinitionIndex = 24660;
