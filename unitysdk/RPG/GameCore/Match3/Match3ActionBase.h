...
#define RPG_GAMECORE_MATCH3_MATCH3ACTIONBASE_METHOD_4_7CDC97DA507BCEEF_OFFSET UNITYSDK_OFFSET(0x173A26E0)
#define RPG_GAMECORE_MATCH3_MATCH3ACTIONBASE_METHOD_4_B29685D25BC2F28B_OFFSET UNITYSDK_OFFSET(0x173A2860)
#define RPG_GAMECORE_MATCH3_MATCH3ACTIONBASE__CCTOR_OFFSET UNITYSDK_OFFSET(0x173A2900)
#define RPG_GAMECORE_MATCH3_MATCH3ACTIONBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1739FA40)
...
namespace RPG::GameCore::Match3
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Func_2<::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::Match3::Match3ActionBase*>*>**)Il2CppClass::FromTypeDefinitionIndex(Match3ActionBase_TypeDefinitionIndex)->GetStaticField(0x28040);
		}
