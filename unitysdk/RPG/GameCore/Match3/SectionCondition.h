...
#define RPG_GAMECORE_MATCH3_SECTIONCONDITION_METHOD_5_1992960738A5D3B2_OFFSET UNITYSDK_OFFSET(0x18AB77D0)
#define RPG_GAMECORE_MATCH3_SECTIONCONDITION_METHOD_5_8E0F66B25FEFC60B_OFFSET UNITYSDK_OFFSET(0x18ABA990)
#define RPG_GAMECORE_MATCH3_SECTIONCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x18AB7750)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int SectionCondition_TypeDefinitionIndex = 23689;
