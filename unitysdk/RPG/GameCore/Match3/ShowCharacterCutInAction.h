...
#define RPG_GAMECORE_MATCH3_SHOWCHARACTERCUTINACTION_METHOD_5_41AF87E4648B53C6_OFFSET UNITYSDK_OFFSET(0x18ABAF20)
#define RPG_GAMECORE_MATCH3_SHOWCHARACTERCUTINACTION_METHOD_5_CB6239775721C9ED_OFFSET UNITYSDK_OFFSET(0x18AB41B0)
#define RPG_GAMECORE_MATCH3_SHOWCHARACTERCUTINACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18AB4140)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int ShowCharacterCutInAction_TypeDefinitionIndex = 23718;
