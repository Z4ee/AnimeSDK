...
#define RPG_GAMECORE_MATCH3_SHOWCHARACTERCUTINACTION_METHOD_5_41AF87E4648B53C6_OFFSET UNITYSDK_OFFSET(0x198EB8F0)
#define RPG_GAMECORE_MATCH3_SHOWCHARACTERCUTINACTION_METHOD_5_CB6239775721C9ED_OFFSET UNITYSDK_OFFSET(0x198E4890)
#define RPG_GAMECORE_MATCH3_SHOWCHARACTERCUTINACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x198E4820)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int ShowCharacterCutInAction_TypeDefinitionIndex = 23554;
