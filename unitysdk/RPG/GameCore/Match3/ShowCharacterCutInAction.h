...
#define RPG_GAMECORE_MATCH3_SHOWCHARACTERCUTINACTION_METHOD_5_A51AA0365B67598E_OFFSET UNITYSDK_OFFSET(0x1D246A00)
#define RPG_GAMECORE_MATCH3_SHOWCHARACTERCUTINACTION_METHOD_5_CB6239775721C9ED_OFFSET UNITYSDK_OFFSET(0x1D246A60)
#define RPG_GAMECORE_MATCH3_SHOWCHARACTERCUTINACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D246A50)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int ShowCharacterCutInAction_TypeDefinitionIndex = 24632;
