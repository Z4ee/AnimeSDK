...
#define RPG_GAMECORE_MATCH3_MATCHTHREE1V1AILEVELCONFIG_METHOD_2_872FC6E20B81FC73_OFFSET UNITYSDK_OFFSET(0x1D2448A0)
#define RPG_GAMECORE_MATCH3_MATCHTHREE1V1AILEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D244A40)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int MatchThree1v1AILevelConfig_TypeDefinitionIndex = 24666;
