...
#define RPG_GAMECORE_MATCH3_MATCHTHREE1V1AILEVELCONFIG_METHOD_2_80EAC19E8484889E_OFFSET UNITYSDK_OFFSET(0x173AAD90)
#define RPG_GAMECORE_MATCH3_MATCHTHREE1V1AILEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x173AAF40)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int MatchThree1v1AILevelConfig_TypeDefinitionIndex = 22781;
