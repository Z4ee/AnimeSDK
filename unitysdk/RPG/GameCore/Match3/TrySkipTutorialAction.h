...
#define RPG_GAMECORE_MATCH3_TRYSKIPTUTORIALACTION_METHOD_5_6FC228BE0CC82B93_OFFSET UNITYSDK_OFFSET(0x18AB5300)
#define RPG_GAMECORE_MATCH3_TRYSKIPTUTORIALACTION_METHOD_5_828AED4183A8B1AA_OFFSET UNITYSDK_OFFSET(0x18ABB7C0)
#define RPG_GAMECORE_MATCH3_TRYSKIPTUTORIALACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18AB5290)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int TrySkipTutorialAction_TypeDefinitionIndex = 23724;
