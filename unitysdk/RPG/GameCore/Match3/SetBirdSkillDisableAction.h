...
#define RPG_GAMECORE_MATCH3_SETBIRDSKILLDISABLEACTION_METHOD_5_2F32E3B47FCDB448_OFFSET UNITYSDK_OFFSET(0x173AC400)
#define RPG_GAMECORE_MATCH3_SETBIRDSKILLDISABLEACTION_METHOD_5_3B5BE9022E6A124E_OFFSET UNITYSDK_OFFSET(0x173A53B0)
#define RPG_GAMECORE_MATCH3_SETBIRDSKILLDISABLEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x173A5340)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int SetBirdSkillDisableAction_TypeDefinitionIndex = 22740;
