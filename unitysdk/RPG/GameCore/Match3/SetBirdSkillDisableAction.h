...
#define RPG_GAMECORE_MATCH3_SETBIRDSKILLDISABLEACTION_METHOD_5_3B5BE9022E6A124E_OFFSET UNITYSDK_OFFSET(0x1D263AE0)
#define RPG_GAMECORE_MATCH3_SETBIRDSKILLDISABLEACTION_METHOD_5_F41C94B33F52ECAE_OFFSET UNITYSDK_OFFSET(0x1D263A80)
#define RPG_GAMECORE_MATCH3_SETBIRDSKILLDISABLEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D263AD0)

namespace RPG::GameCore::Match3
{
	inline static constexpr unsigned int SetBirdSkillDisableAction_TypeDefinitionIndex = 24627;
