...
#define RPG_GAMECORE_MARBLEBYCOMPAREVALUE_METHOD_4_705E1562455FDF6A_OFFSET UNITYSDK_OFFSET(0x1738A390)
#define RPG_GAMECORE_MARBLEBYCOMPAREVALUE_METHOD_4_A999723FBB607A40_OFFSET UNITYSDK_OFFSET(0x1738A470)
#define RPG_GAMECORE_MARBLEBYCOMPAREVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1738A420)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleByCompareValue_TypeDefinitionIndex = 15455;
