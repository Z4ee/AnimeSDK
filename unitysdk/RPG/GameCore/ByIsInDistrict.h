...
#define RPG_GAMECORE_BYISINDISTRICT_METHOD_4_2D6D0A3B0698D2B6_OFFSET UNITYSDK_OFFSET(0x1B29BB80)
#define RPG_GAMECORE_BYISINDISTRICT_METHOD_4_5275CF047A0DC778_OFFSET UNITYSDK_OFFSET(0x1B29BB50)
#define RPG_GAMECORE_BYISINDISTRICT_METHOD_4_A519A5E7D365CC6E_OFFSET UNITYSDK_OFFSET(0x1B29B990)
#define RPG_GAMECORE_BYISINDISTRICT_METHOD_4_F82FA2E5FA36B78F_OFFSET UNITYSDK_OFFSET(0x1B29B950)
#define RPG_GAMECORE_BYISINDISTRICT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B29B980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsInDistrict_TypeDefinitionIndex = 19812;
