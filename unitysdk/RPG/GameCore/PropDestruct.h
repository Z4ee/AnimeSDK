...
#define RPG_GAMECORE_PROPDESTRUCT_METHOD_3_17B0A56EAB7FD5B1_OFFSET UNITYSDK_OFFSET(0x18C69880)
#define RPG_GAMECORE_PROPDESTRUCT_METHOD_3_B78BC2DC70B922EE_OFFSET UNITYSDK_OFFSET(0x18C69560)
#define RPG_GAMECORE_PROPDESTRUCT__CTOR_OFFSET UNITYSDK_OFFSET(0x18C697F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropDestruct_TypeDefinitionIndex = 20930;
