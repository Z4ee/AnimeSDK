...
#define RPG_GAMECORE_PROPDESTRUCT_METHOD_3_17B0A56EAB7FD5B1_OFFSET UNITYSDK_OFFSET(0x17519E40)
#define RPG_GAMECORE_PROPDESTRUCT_METHOD_3_B78BC2DC70B922EE_OFFSET UNITYSDK_OFFSET(0x17519B20)
#define RPG_GAMECORE_PROPDESTRUCT__CTOR_OFFSET UNITYSDK_OFFSET(0x17519DB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropDestruct_TypeDefinitionIndex = 20248;
