...
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEPROPDESTRUCTGROUPCONFIG_METHOD_3_AE643B0E75C7E90B_OFFSET UNITYSDK_OFFSET(0x19B9BAF0)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEPROPDESTRUCTGROUPCONFIG_METHOD_3_BCE57E55E75667B2_OFFSET UNITYSDK_OFFSET(0x19B9BA20)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEPROPDESTRUCTGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B9BAA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierReplaceContentRoguePropDestructGroupConfig_TypeDefinitionIndex = 16829;
