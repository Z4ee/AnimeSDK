...
#define RPG_GAMECORE_SWORDTRAININGEXAMRESULT_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1779D490)
#define RPG_GAMECORE_SWORDTRAININGEXAMRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1779D5B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwordTrainingExamResult_TypeDefinitionIndex = 11349;
