...
#define RPG_GAMECORE_PREFABCUSTOMDATA_METHOD_2_779A929D7759169F_OFFSET UNITYSDK_OFFSET(0x18C601A0)
#define RPG_GAMECORE_PREFABCUSTOMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18C60300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PrefabCustomData_TypeDefinitionIndex = 18113;
