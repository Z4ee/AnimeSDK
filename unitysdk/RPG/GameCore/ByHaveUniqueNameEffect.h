...
#define RPG_GAMECORE_BYHAVEUNIQUENAMEEFFECT_METHOD_4_3D029ADB3F70A002_OFFSET UNITYSDK_OFFSET(0x1A8CFC00)
#define RPG_GAMECORE_BYHAVEUNIQUENAMEEFFECT_METHOD_4_539F59481BB10017_OFFSET UNITYSDK_OFFSET(0x1A8CF960)
#define RPG_GAMECORE_BYHAVEUNIQUENAMEEFFECT_METHOD_4_CF7772E7BDA73C0C_OFFSET UNITYSDK_OFFSET(0x1A8CFC30)
#define RPG_GAMECORE_BYHAVEUNIQUENAMEEFFECT_METHOD_4_F47FC09C88314E1A_OFFSET UNITYSDK_OFFSET(0x1A8CF9A0)
#define RPG_GAMECORE_BYHAVEUNIQUENAMEEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8CF990)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByHaveUniqueNameEffect_TypeDefinitionIndex = 19653;
