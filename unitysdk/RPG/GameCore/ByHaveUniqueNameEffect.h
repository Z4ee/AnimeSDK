...
#define RPG_GAMECORE_BYHAVEUNIQUENAMEEFFECT_METHOD_4_39784D76F9AB1AE8_OFFSET UNITYSDK_OFFSET(0x1874BB10)
#define RPG_GAMECORE_BYHAVEUNIQUENAMEEFFECT_METHOD_4_F47FC09C88314E1A_OFFSET UNITYSDK_OFFSET(0x1874BBE0)
#define RPG_GAMECORE_BYHAVEUNIQUENAMEEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1874BB90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByHaveUniqueNameEffect_TypeDefinitionIndex = 19391;
