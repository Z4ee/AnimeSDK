...
#define RPG_GAMECORE_ASSISTWAYPOINTGROUPPROPERTYCONDITION_METHOD_3_050F0D8CA83D07BD_OFFSET UNITYSDK_OFFSET(0x1A05FB50)
#define RPG_GAMECORE_ASSISTWAYPOINTGROUPPROPERTYCONDITION_METHOD_3_26FD83A6118EFB0B_OFFSET UNITYSDK_OFFSET(0x1A061490)
#define RPG_GAMECORE_ASSISTWAYPOINTGROUPPROPERTYCONDITION_METHOD_3_A42E908E5F4970DB_OFFSET UNITYSDK_OFFSET(0x1A0614C0)
#define RPG_GAMECORE_ASSISTWAYPOINTGROUPPROPERTYCONDITION_METHOD_3_EE2706CC8A8F613F_OFFSET UNITYSDK_OFFSET(0x1A05E5C0)
#define RPG_GAMECORE_ASSISTWAYPOINTGROUPPROPERTYCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A05E5B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AssistWayPointGroupPropertyCondition_TypeDefinitionIndex = 18254;
