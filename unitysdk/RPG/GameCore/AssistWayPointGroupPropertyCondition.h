...
#define RPG_GAMECORE_ASSISTWAYPOINTGROUPPROPERTYCONDITION_METHOD_3_26FD83A6118EFB0B_OFFSET UNITYSDK_OFFSET(0x16F89120)
#define RPG_GAMECORE_ASSISTWAYPOINTGROUPPROPERTYCONDITION_METHOD_3_EE2706CC8A8F613F_OFFSET UNITYSDK_OFFSET(0x16F880D0)
#define RPG_GAMECORE_ASSISTWAYPOINTGROUPPROPERTYCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x16F880C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AssistWayPointGroupPropertyCondition_TypeDefinitionIndex = 17415;
