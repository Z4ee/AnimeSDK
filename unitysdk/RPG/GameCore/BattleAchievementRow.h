...
#define RPG_GAMECORE_BATTLEACHIEVEMENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A3E2360)
#define RPG_GAMECORE_BATTLEACHIEVEMENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3E2560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleAchievementRow_TypeDefinitionIndex = 12398;

	class BattleAchievementRow : public ::System::Object
	{
	public:
		::Il2CppArray<::System::String*>* ExcludeTagList; // 0x10
