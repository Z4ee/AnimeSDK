...
#define RPG_GAMECORE_BATTLEACHIEVEMENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x194C2240)
#define RPG_GAMECORE_BATTLEACHIEVEMENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x194C2440)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleAchievementRow_TypeDefinitionIndex = 12264;
