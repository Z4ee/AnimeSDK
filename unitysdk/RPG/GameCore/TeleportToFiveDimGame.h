...
#define RPG_GAMECORE_TELEPORTTOFIVEDIMGAME_METHOD_3_490CBFC1FC1D19EF_OFFSET UNITYSDK_OFFSET(0x19093890)
#define RPG_GAMECORE_TELEPORTTOFIVEDIMGAME_METHOD_3_80CCEC55F21CD419_OFFSET UNITYSDK_OFFSET(0x19093910)
#define RPG_GAMECORE_TELEPORTTOFIVEDIMGAME__CTOR_OFFSET UNITYSDK_OFFSET(0x190938E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TeleportToFiveDimGame_TypeDefinitionIndex = 20256;
