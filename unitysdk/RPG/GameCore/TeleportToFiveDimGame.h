...
#define RPG_GAMECORE_TELEPORTTOFIVEDIMGAME_METHOD_3_1E4F0CED2294B250_OFFSET UNITYSDK_OFFSET(0x1E1D0830)
#define RPG_GAMECORE_TELEPORTTOFIVEDIMGAME_METHOD_3_80CCEC55F21CD419_OFFSET UNITYSDK_OFFSET(0x1E1D0870)
#define RPG_GAMECORE_TELEPORTTOFIVEDIMGAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1D0860)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TeleportToFiveDimGame_TypeDefinitionIndex = 21036;
