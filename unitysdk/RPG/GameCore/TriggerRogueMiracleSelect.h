...
#define RPG_GAMECORE_TRIGGERROGUEMIRACLESELECT_METHOD_3_13161B47DB2DD922_OFFSET UNITYSDK_OFFSET(0x1B05B970)
#define RPG_GAMECORE_TRIGGERROGUEMIRACLESELECT_METHOD_3_965F4C180C72103E_OFFSET UNITYSDK_OFFSET(0x1B05B9C0)
#define RPG_GAMECORE_TRIGGERROGUEMIRACLESELECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B05B9B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerRogueMiracleSelect_TypeDefinitionIndex = 19696;
