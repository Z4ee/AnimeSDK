...
#define RPG_GAMECORE_TRIGGERROGUEMIRACLESELECT_METHOD_3_31166AA07D6EE81E_OFFSET UNITYSDK_OFFSET(0x190CC0C0)
#define RPG_GAMECORE_TRIGGERROGUEMIRACLESELECT_METHOD_3_965F4C180C72103E_OFFSET UNITYSDK_OFFSET(0x190CC150)
#define RPG_GAMECORE_TRIGGERROGUEMIRACLESELECT__CTOR_OFFSET UNITYSDK_OFFSET(0x190CC120)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerRogueMiracleSelect_TypeDefinitionIndex = 19435;
