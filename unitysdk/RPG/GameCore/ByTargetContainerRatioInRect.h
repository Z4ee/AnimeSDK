...
#define RPG_GAMECORE_BYTARGETCONTAINERRATIOINRECT_METHOD_4_32207F2AC0855714_OFFSET UNITYSDK_OFFSET(0x187605A0)
#define RPG_GAMECORE_BYTARGETCONTAINERRATIOINRECT_METHOD_4_66B36311B089860F_OFFSET UNITYSDK_OFFSET(0x18760480)
#define RPG_GAMECORE_BYTARGETCONTAINERRATIOINRECT__CTOR_OFFSET UNITYSDK_OFFSET(0x18760520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByTargetContainerRatioInRect_TypeDefinitionIndex = 20497;
