...
#define RPG_GAMECORE_ADVENTUREISTRIGGERBATTLEBYNPCMONSTER_METHOD_4_73AC9E6E21F4A41B_OFFSET UNITYSDK_OFFSET(0x1CDF2430)
#define RPG_GAMECORE_ADVENTUREISTRIGGERBATTLEBYNPCMONSTER_METHOD_4_9EA752198751D561_OFFSET UNITYSDK_OFFSET(0x1CDF2570)
#define RPG_GAMECORE_ADVENTUREISTRIGGERBATTLEBYNPCMONSTER_METHOD_4_A0C735BCF3A5BF98_OFFSET UNITYSDK_OFFSET(0x1CDF25A0)
#define RPG_GAMECORE_ADVENTUREISTRIGGERBATTLEBYNPCMONSTER_METHOD_4_E4E8F2C898C13E48_OFFSET UNITYSDK_OFFSET(0x1CDF23F0)
#define RPG_GAMECORE_ADVENTUREISTRIGGERBATTLEBYNPCMONSTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDF2420)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureIsTriggerBattleByNpcMonster_TypeDefinitionIndex = 21419;
