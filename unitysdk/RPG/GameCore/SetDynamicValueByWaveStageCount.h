...
#define RPG_GAMECORE_SETDYNAMICVALUEBYWAVESTAGECOUNT_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1D4F91E0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYWAVESTAGECOUNT_METHOD_4_96BA95DFB99846A4_OFFSET UNITYSDK_OFFSET(0x1D4F9070)
#define RPG_GAMECORE_SETDYNAMICVALUEBYWAVESTAGECOUNT_METHOD_4_EF27C4582C8A0023_OFFSET UNITYSDK_OFFSET(0x1D4F9030)
#define RPG_GAMECORE_SETDYNAMICVALUEBYWAVESTAGECOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4F9060)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByWaveStageCount_TypeDefinitionIndex = 22920;
