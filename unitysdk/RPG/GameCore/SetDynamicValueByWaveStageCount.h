...
#define RPG_GAMECORE_SETDYNAMICVALUEBYWAVESTAGECOUNT_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x18E2ACC0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYWAVESTAGECOUNT_METHOD_4_07AFA37E2D96CF3B_OFFSET UNITYSDK_OFFSET(0x18E2AA80)
#define RPG_GAMECORE_SETDYNAMICVALUEBYWAVESTAGECOUNT_METHOD_4_96BA95DFB99846A4_OFFSET UNITYSDK_OFFSET(0x18E2AB50)
#define RPG_GAMECORE_SETDYNAMICVALUEBYWAVESTAGECOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x18E2AB00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByWaveStageCount_TypeDefinitionIndex = 22136;
