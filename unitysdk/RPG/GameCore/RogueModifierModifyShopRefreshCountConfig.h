...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYSHOPREFRESHCOUNTCONFIG_METHOD_3_61AADF88EA5BB58A_OFFSET UNITYSDK_OFFSET(0x17636240)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYSHOPREFRESHCOUNTCONFIG_METHOD_3_EF50475A2B9AEE53_OFFSET UNITYSDK_OFFSET(0x17636170)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYSHOPREFRESHCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x176361F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyShopRefreshCountConfig_TypeDefinitionIndex = 16303;
