...
#define RPG_GAMECORE_ELFBEHAVIORSTATEEMOJIITEM_METHOD_3_2361D5516A59DB31_OFFSET UNITYSDK_OFFSET(0x196D86C0)
#define RPG_GAMECORE_ELFBEHAVIORSTATEEMOJIITEM_METHOD_3_80A75FB46BDEA159_OFFSET UNITYSDK_OFFSET(0x196D8900)
#define RPG_GAMECORE_ELFBEHAVIORSTATEEMOJIITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x196D86B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfBehaviorStateEmojiItem_TypeDefinitionIndex = 17597;
