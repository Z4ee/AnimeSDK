...
#define RPG_GAMECORE_ELFBEHAVIORSTATEEMOJIITEM_METHOD_3_2361D5516A59DB31_OFFSET UNITYSDK_OFFSET(0x1D0574B0)
#define RPG_GAMECORE_ELFBEHAVIORSTATEEMOJIITEM_METHOD_3_80A75FB46BDEA159_OFFSET UNITYSDK_OFFSET(0x1D0576F0)
#define RPG_GAMECORE_ELFBEHAVIORSTATEEMOJIITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0574A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfBehaviorStateEmojiItem_TypeDefinitionIndex = 18288;
