...
#define RPG_GAMECORE_DRINKMAKERCHEERSPERFORMANCEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1BB1DA20)
#define RPG_GAMECORE_DRINKMAKERCHEERSPERFORMANCEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB1DB90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DrinkMakerCheersPerformanceRow_TypeDefinitionIndex = 12714;
