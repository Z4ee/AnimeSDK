...
#define RPG_GAMECORE_STAGEAUTOGENCONFIG_METHOD_2_3278101654E30287_OFFSET UNITYSDK_OFFSET(0x18E88B40)
#define RPG_GAMECORE_STAGEAUTOGENCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18E88DE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StageAutoGenConfig_TypeDefinitionIndex = 18164;
