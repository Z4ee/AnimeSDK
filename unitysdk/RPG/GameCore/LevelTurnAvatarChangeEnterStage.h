...
#define RPG_GAMECORE_LEVELTURNAVATARCHANGEENTERSTAGE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1DD2BCF0)
#define RPG_GAMECORE_LEVELTURNAVATARCHANGEENTERSTAGE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x1DD2BD40)
#define RPG_GAMECORE_LEVELTURNAVATARCHANGEENTERSTAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD2BD90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelTurnAvatarChangeEnterStage_TypeDefinitionIndex = 56896;
