...
#define RPG_GAMECORE_LEVELTURNAVATARCHANGEENTERSTAGE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xB6E0160)
#define RPG_GAMECORE_LEVELTURNAVATARCHANGEENTERSTAGE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xB6E01B0)
#define RPG_GAMECORE_LEVELTURNAVATARCHANGEENTERSTAGE__CTOR_OFFSET UNITYSDK_OFFSET(0xB6E0200)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelTurnAvatarChangeEnterStage_TypeDefinitionIndex = 52265;
