...
#define RPG_GAMECORE_LEVELTURNAVATARCHANGEENTERSTAGE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xCE4E240)
#define RPG_GAMECORE_LEVELTURNAVATARCHANGEENTERSTAGE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xCE4E290)
#define RPG_GAMECORE_LEVELTURNAVATARCHANGEENTERSTAGE__CTOR_OFFSET UNITYSDK_OFFSET(0xCE4E2E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelTurnAvatarChangeEnterStage_TypeDefinitionIndex = 52962;
