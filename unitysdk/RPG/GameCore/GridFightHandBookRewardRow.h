...
#define RPG_GAMECORE_GRIDFIGHTHANDBOOKREWARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1EE6B010)
#define RPG_GAMECORE_GRIDFIGHTHANDBOOKREWARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1EE6B160)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightHandBookRewardRow_TypeDefinitionIndex = 13468;
