...
#define RPG_GAMECORE_GRIDFIGHTHANDBOOKREWARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C5CEAD0)
#define RPG_GAMECORE_GRIDFIGHTHANDBOOKREWARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5CEC20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightHandBookRewardRow_TypeDefinitionIndex = 13077;

	class GridFightHandBookRewardRow : public ::System::Object
	{
	public:
		::Il2CppArray<::System::UInt32>* QuestList; // 0x10
		::RPG::GameCore::GridFightHandBookType HandBookType; // 0x18
