...
#define RPG_GAMECORE_GRIDFIGHTHANDBOOKREWARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1725EEC0)
#define RPG_GAMECORE_GRIDFIGHTHANDBOOKREWARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1725F020)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightHandBookRewardRow_TypeDefinitionIndex = 12411;
