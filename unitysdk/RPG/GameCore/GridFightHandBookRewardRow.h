...
#define RPG_GAMECORE_GRIDFIGHTHANDBOOKREWARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D156C40)
#define RPG_GAMECORE_GRIDFIGHTHANDBOOKREWARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D156D90)
