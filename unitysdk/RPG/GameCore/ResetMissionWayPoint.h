...
#define RPG_GAMECORE_RESETMISSIONWAYPOINT_METHOD_3_7916377EE16BDFAD_OFFSET UNITYSDK_OFFSET(0x1759ED20)
#define RPG_GAMECORE_RESETMISSIONWAYPOINT_METHOD_3_A16AEA80EB49B2AC_OFFSET UNITYSDK_OFFSET(0x1759EDA0)
#define RPG_GAMECORE_RESETMISSIONWAYPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1759ED70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetMissionWayPoint_TypeDefinitionIndex = 19852;
