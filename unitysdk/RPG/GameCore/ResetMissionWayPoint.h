...
#define RPG_GAMECORE_RESETMISSIONWAYPOINT_METHOD_3_5680F46EA55D2FBF_OFFSET UNITYSDK_OFFSET(0x1D01BFD0)
#define RPG_GAMECORE_RESETMISSIONWAYPOINT_METHOD_3_A16AEA80EB49B2AC_OFFSET UNITYSDK_OFFSET(0x1D01C010)
#define RPG_GAMECORE_RESETMISSIONWAYPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D01C000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetMissionWayPoint_TypeDefinitionIndex = 20884;
