...
#define RPG_GAMECORE_RESETMISSIONWAYPOINT_METHOD_3_7916377EE16BDFAD_OFFSET UNITYSDK_OFFSET(0x18CAACE0)
#define RPG_GAMECORE_RESETMISSIONWAYPOINT_METHOD_3_A16AEA80EB49B2AC_OFFSET UNITYSDK_OFFSET(0x18CAAD60)
#define RPG_GAMECORE_RESETMISSIONWAYPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x18CAAD30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetMissionWayPoint_TypeDefinitionIndex = 20533;
