...
#define RPG_GAMECORE_BYCONTAINOPINSKILL_METHOD_4_34E628933CC684D6_OFFSET UNITYSDK_OFFSET(0x18741FB0)
#define RPG_GAMECORE_BYCONTAINOPINSKILL_METHOD_4_A95EBD651CDF9238_OFFSET UNITYSDK_OFFSET(0x18742080)
#define RPG_GAMECORE_BYCONTAINOPINSKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x18742030)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByContainOpInSkill_TypeDefinitionIndex = 21456;
