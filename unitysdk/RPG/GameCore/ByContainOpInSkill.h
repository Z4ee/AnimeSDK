...
#define RPG_GAMECORE_BYCONTAINOPINSKILL_METHOD_4_26798C3E8EA50B08_OFFSET UNITYSDK_OFFSET(0x1A8B6060)
#define RPG_GAMECORE_BYCONTAINOPINSKILL_METHOD_4_2D18CF9DDD452546_OFFSET UNITYSDK_OFFSET(0x1A8B6090)
#define RPG_GAMECORE_BYCONTAINOPINSKILL_METHOD_4_589F57DAA4C2216D_OFFSET UNITYSDK_OFFSET(0x1A8B5EA0)
#define RPG_GAMECORE_BYCONTAINOPINSKILL_METHOD_4_A95EBD651CDF9238_OFFSET UNITYSDK_OFFSET(0x1A8B5EE0)
#define RPG_GAMECORE_BYCONTAINOPINSKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8B5ED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByContainOpInSkill_TypeDefinitionIndex = 21757;
