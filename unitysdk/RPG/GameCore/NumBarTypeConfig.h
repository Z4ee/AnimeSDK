...
#define RPG_GAMECORE_NUMBARTYPECONFIG_METHOD_2_9847733D03CB77E6_OFFSET UNITYSDK_OFFSET(0x18BC27A0)
#define RPG_GAMECORE_NUMBARTYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18BC2930)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NumBarTypeConfig_TypeDefinitionIndex = 21637;
