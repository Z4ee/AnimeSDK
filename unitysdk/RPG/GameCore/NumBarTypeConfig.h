...
#define RPG_GAMECORE_NUMBARTYPECONFIG_METHOD_2_6D2242AA2333D3CF_OFFSET UNITYSDK_OFFSET(0x1D2FA960)
#define RPG_GAMECORE_NUMBARTYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2FAAD0)
