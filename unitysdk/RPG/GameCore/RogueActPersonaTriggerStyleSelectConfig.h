...
#define RPG_GAMECORE_ROGUEACTPERSONATRIGGERSTYLESELECTCONFIG_METHOD_6_34B27036EE63F874_OFFSET UNITYSDK_OFFSET(0x175C4B50)
#define RPG_GAMECORE_ROGUEACTPERSONATRIGGERSTYLESELECTCONFIG_METHOD_6_FDC6EBEA10FF89A9_OFFSET UNITYSDK_OFFSET(0x175C4D70)
#define RPG_GAMECORE_ROGUEACTPERSONATRIGGERSTYLESELECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175C4C90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaTriggerStyleSelectConfig_TypeDefinitionIndex = 18067;
