...
#define RPG_GAMECORE_ROGUEACTPERSONATRIGGERSTYLESELECTCONFIG_METHOD_6_34B27036EE63F874_OFFSET UNITYSDK_OFFSET(0x18CD08C0)
#define RPG_GAMECORE_ROGUEACTPERSONATRIGGERSTYLESELECTCONFIG_METHOD_6_FDC6EBEA10FF89A9_OFFSET UNITYSDK_OFFSET(0x18CD0AE0)
#define RPG_GAMECORE_ROGUEACTPERSONATRIGGERSTYLESELECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CD0A00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaTriggerStyleSelectConfig_TypeDefinitionIndex = 18712;
