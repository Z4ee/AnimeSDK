...
#define RPG_GAMECORE_ROGUEACTPERSONATRIGGERSTYLESELECTCONFIG_METHOD_6_25B2857D4AEFE325_OFFSET UNITYSDK_OFFSET(0x1C49D600)
#define RPG_GAMECORE_ROGUEACTPERSONATRIGGERSTYLESELECTCONFIG_METHOD_6_FDC6EBEA10FF89A9_OFFSET UNITYSDK_OFFSET(0x1C49D650)
#define RPG_GAMECORE_ROGUEACTPERSONATRIGGERSTYLESELECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C49D640)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaTriggerStyleSelectConfig_TypeDefinitionIndex = 18955;
