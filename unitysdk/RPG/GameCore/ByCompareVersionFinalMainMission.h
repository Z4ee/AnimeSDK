...
#define RPG_GAMECORE_BYCOMPAREVERSIONFINALMAINMISSION_METHOD_4_08AE1D19545EFB4C_OFFSET UNITYSDK_OFFSET(0x1A8B32C0)
#define RPG_GAMECORE_BYCOMPAREVERSIONFINALMAINMISSION_METHOD_4_27E2FC592B194BA6_OFFSET UNITYSDK_OFFSET(0x1A8B34A0)
#define RPG_GAMECORE_BYCOMPAREVERSIONFINALMAINMISSION_METHOD_4_4F8C844FABAD5945_OFFSET UNITYSDK_OFFSET(0x1A8B3300)
#define RPG_GAMECORE_BYCOMPAREVERSIONFINALMAINMISSION_METHOD_4_D3D196C172419B09_OFFSET UNITYSDK_OFFSET(0x1A8B3470)
#define RPG_GAMECORE_BYCOMPAREVERSIONFINALMAINMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8B32F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareVersionFinalMainMission_TypeDefinitionIndex = 19979;
