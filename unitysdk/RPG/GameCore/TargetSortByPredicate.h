...
#define RPG_GAMECORE_TARGETSORTBYPREDICATE_METHOD_3_61F6BB80BD73D32A_OFFSET UNITYSDK_OFFSET(0x1E1C3600)
#define RPG_GAMECORE_TARGETSORTBYPREDICATE_METHOD_3_89BA15031B47B4AB_OFFSET UNITYSDK_OFFSET(0x1E1C34E0)
#define RPG_GAMECORE_TARGETSORTBYPREDICATE_METHOD_3_B1E3FA0A3D9C75E6_OFFSET UNITYSDK_OFFSET(0x1E1C3650)
#define RPG_GAMECORE_TARGETSORTBYPREDICATE_METHOD_3_D71F840DAD37429B_OFFSET UNITYSDK_OFFSET(0x1E1C3480)
#define RPG_GAMECORE_TARGETSORTBYPREDICATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1C34D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetSortByPredicate_TypeDefinitionIndex = 23706;
