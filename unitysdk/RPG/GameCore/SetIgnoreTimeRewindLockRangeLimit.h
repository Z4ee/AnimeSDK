...
#define RPG_GAMECORE_SETIGNORETIMEREWINDLOCKRANGELIMIT_METHOD_3_998E36D83AF1CF7A_OFFSET UNITYSDK_OFFSET(0x1C5FCED0)
#define RPG_GAMECORE_SETIGNORETIMEREWINDLOCKRANGELIMIT_METHOD_3_D719A85E8FE5392D_OFFSET UNITYSDK_OFFSET(0x1C5FCF20)
#define RPG_GAMECORE_SETIGNORETIMEREWINDLOCKRANGELIMIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5FCF10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetIgnoreTimeRewindLockRangeLimit_TypeDefinitionIndex = 19871;
