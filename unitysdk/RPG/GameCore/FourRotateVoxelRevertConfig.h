...
#define RPG_GAMECORE_FOURROTATEVOXELREVERTCONFIG_METHOD_2_2AA63B7BCD470CC0_OFFSET UNITYSDK_OFFSET(0x1721DD00)
#define RPG_GAMECORE_FOURROTATEVOXELREVERTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1721DE90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FourRotateVoxelRevertConfig_TypeDefinitionIndex = 15339;
