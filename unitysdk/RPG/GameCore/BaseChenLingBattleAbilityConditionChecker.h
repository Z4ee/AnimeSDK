...
#define RPG_GAMECORE_BASECHENLINGBATTLEABILITYCONDITIONCHECKER_METHOD_2_A1DE3F30E381A492_OFFSET UNITYSDK_OFFSET(0x16FC3220)
#define RPG_GAMECORE_BASECHENLINGBATTLEABILITYCONDITIONCHECKER_METHOD_2_A889B81F668FCC63_OFFSET UNITYSDK_OFFSET(0x16FC2BA0)
#define RPG_GAMECORE_BASECHENLINGBATTLEABILITYCONDITIONCHECKER__CTOR_OFFSET UNITYSDK_OFFSET(0x16FC3280)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BaseChenLingBattleAbilityConditionChecker_TypeDefinitionIndex = 14411;
