...
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_ONSELFCASTSKILLWITHPROBABILITY_METHOD_3_8DFF4DB0ED0C59CD_OFFSET UNITYSDK_OFFSET(0x187DD780)
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_ONSELFCASTSKILLWITHPROBABILITY_METHOD_3_D0BEE40F2B4B760F_OFFSET UNITYSDK_OFFSET(0x187DD720)
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_ONSELFCASTSKILLWITHPROBABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x187DD770)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleAbilityConditionChecker_OnSelfCastSkillWithProbability_TypeDefinitionIndex = 14892;
