...
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_ONSELFCASTSKILLWITHPROBABILITY_METHOD_3_8DFF4DB0ED0C59CD_OFFSET UNITYSDK_OFFSET(0x1C3754D0)
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_ONSELFCASTSKILLWITHPROBABILITY_METHOD_3_D0BEE40F2B4B760F_OFFSET UNITYSDK_OFFSET(0x1C375470)
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_ONSELFCASTSKILLWITHPROBABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3754C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleAbilityConditionChecker_OnSelfCastSkillWithProbability_TypeDefinitionIndex = 15119;
