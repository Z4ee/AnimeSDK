...
#define RPG_GAMECORE_HIDEENTITYFORCURRENTCAMERA_METHOD_3_7824063315A2E90B_OFFSET UNITYSDK_OFFSET(0x189FE260)
#define RPG_GAMECORE_HIDEENTITYFORCURRENTCAMERA_METHOD_3_F77749131CA6DFE2_OFFSET UNITYSDK_OFFSET(0x189FE2E0)
#define RPG_GAMECORE_HIDEENTITYFORCURRENTCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x189FE2B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HideEntityForCurrentCamera_TypeDefinitionIndex = 22716;
