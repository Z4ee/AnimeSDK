...
#define RPG_GAMECORE_TARGETSORTBYACTIONORDER_METHOD_3_98F1F4BDE55E9EA1_OFFSET UNITYSDK_OFFSET(0x18EF8FB0)
#define RPG_GAMECORE_TARGETSORTBYACTIONORDER_METHOD_3_C03DA171E8D44708_OFFSET UNITYSDK_OFFSET(0x18EF6CE0)
#define RPG_GAMECORE_TARGETSORTBYACTIONORDER__CTOR_OFFSET UNITYSDK_OFFSET(0x18EF6CC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetSortByActionOrder_TypeDefinitionIndex = 22981;
