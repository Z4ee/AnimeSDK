...
#define RPG_GAMECORE_TARGETSORTBYACTIONORDER_METHOD_3_1E716319C7E19199_OFFSET UNITYSDK_OFFSET(0x1D0C63E0)
#define RPG_GAMECORE_TARGETSORTBYACTIONORDER_METHOD_3_9039FD7540D2EEEB_OFFSET UNITYSDK_OFFSET(0x1D0C6230)
#define RPG_GAMECORE_TARGETSORTBYACTIONORDER_METHOD_3_C03DA171E8D44708_OFFSET UNITYSDK_OFFSET(0x1D0C6270)
#define RPG_GAMECORE_TARGETSORTBYACTIONORDER_METHOD_3_C4E403C7BC6596F8_OFFSET UNITYSDK_OFFSET(0x1D0C63B0)
#define RPG_GAMECORE_TARGETSORTBYACTIONORDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0C6260)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetSortByActionOrder_TypeDefinitionIndex = 23135;
