...
#define RPG_GAMECORE_ROGUEWORKBENCHSHOPGENMAGICUNITCONFIG_METHOD_2_E83DBE58A90A8422_OFFSET UNITYSDK_OFFSET(0x1BB826B0)
#define RPG_GAMECORE_ROGUEWORKBENCHSHOPGENMAGICUNITCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB826F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueWorkbenchShopGenMagicUnitConfig_TypeDefinitionIndex = 17299;
