...
#define RPG_GAMECORE_ACTIVITYSTARTHINTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1AB0E810)
#define RPG_GAMECORE_ACTIVITYSTARTHINTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB0EE60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityStartHintConfigRow_TypeDefinitionIndex = 10818;
