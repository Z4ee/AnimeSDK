...
#define RPG_GAMECORE_SCENEGACHALISTENER_METHOD_3_05006A720F513692_OFFSET UNITYSDK_OFFSET(0x1C2C7380)
#define RPG_GAMECORE_SCENEGACHALISTENER_METHOD_3_C5FD2DCEB6EDD545_OFFSET UNITYSDK_OFFSET(0x1C2C73C0)
#define RPG_GAMECORE_SCENEGACHALISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2C73B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SceneGachaListener_TypeDefinitionIndex = 19566;
