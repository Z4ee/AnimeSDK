...
#define RPG_GAMECORE_PIXAIRBATTLEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B4CA130)
#define RPG_GAMECORE_PIXAIRBATTLEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4CA3B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PixAirBattleRow_TypeDefinitionIndex = 11673;

	class PixAirBattleRow : public ::System::Object
	{
	public:
		::Il2CppArray<::System::UInt32>* EnemyIDList; // 0x10
		::System::UInt32 EnemyShow; // 0x18
