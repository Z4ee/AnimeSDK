...
#define RPG_GAMECORE_BASECHENLINGBATTLEEFFECT_METHOD_2_528E30C78EB5366E_OFFSET UNITYSDK_OFFSET(0x16FC3CC0)
#define RPG_GAMECORE_BASECHENLINGBATTLEEFFECT_METHOD_2_D87231D0840AD185_OFFSET UNITYSDK_OFFSET(0x16FC44A0)
#define RPG_GAMECORE_BASECHENLINGBATTLEEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x16FC4500)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BaseChenLingBattleEffect_TypeDefinitionIndex = 14476;
