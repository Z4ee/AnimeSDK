...
#define RPG_GAMECORE_BASECHENLINGBATTLEEFFECT_METHOD_2_8D586FD7A609A263_OFFSET UNITYSDK_OFFSET(0x194BA8D0)
#define RPG_GAMECORE_BASECHENLINGBATTLEEFFECT_METHOD_2_D87231D0840AD185_OFFSET UNITYSDK_OFFSET(0x194BAE80)
#define RPG_GAMECORE_BASECHENLINGBATTLEEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x194BAEE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BaseChenLingBattleEffect_TypeDefinitionIndex = 15009;
