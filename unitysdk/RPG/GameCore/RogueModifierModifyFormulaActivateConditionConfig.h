...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYFORMULAACTIVATECONDITIONCONFIG_METHOD_3_3C2289BCCF032F74_OFFSET UNITYSDK_OFFSET(0x176342C0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYFORMULAACTIVATECONDITIONCONFIG_METHOD_3_A80478D4CFD318BD_OFFSET UNITYSDK_OFFSET(0x176341F0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYFORMULAACTIVATECONDITIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17634270)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyFormulaActivateConditionConfig_TypeDefinitionIndex = 16298;
