...
#define RPG_GAMECORE_FOLLOWBYPLAYERCUSTOMROUTEPOINT_METHOD_2_149501AF03558415_OFFSET UNITYSDK_OFFSET(0x1DCAF360)
#define RPG_GAMECORE_FOLLOWBYPLAYERCUSTOMROUTEPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCAF4A0)
