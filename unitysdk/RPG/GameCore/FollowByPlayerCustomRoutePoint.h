...
#define RPG_GAMECORE_FOLLOWBYPLAYERCUSTOMROUTEPOINT_METHOD_2_149501AF03558415_OFFSET UNITYSDK_OFFSET(0x1BEBD7B0)
#define RPG_GAMECORE_FOLLOWBYPLAYERCUSTOMROUTEPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEBD8F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FollowByPlayerCustomRoutePoint_TypeDefinitionIndex = 19213;
