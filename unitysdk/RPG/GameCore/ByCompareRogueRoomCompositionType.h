...
#define RPG_GAMECORE_BYCOMPAREROGUEROOMCOMPOSITIONTYPE_METHOD_4_617827872EE327EA_OFFSET UNITYSDK_OFFSET(0x18739530)
#define RPG_GAMECORE_BYCOMPAREROGUEROOMCOMPOSITIONTYPE_METHOD_4_629EBBEE52598FA3_OFFSET UNITYSDK_OFFSET(0x18739600)
#define RPG_GAMECORE_BYCOMPAREROGUEROOMCOMPOSITIONTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x187395B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareRogueRoomCompositionType_TypeDefinitionIndex = 19782;
