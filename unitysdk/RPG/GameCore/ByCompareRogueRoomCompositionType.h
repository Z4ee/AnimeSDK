...
#define RPG_GAMECORE_BYCOMPAREROGUEROOMCOMPOSITIONTYPE_METHOD_4_629EBBEE52598FA3_OFFSET UNITYSDK_OFFSET(0x1A89EAD0)
#define RPG_GAMECORE_BYCOMPAREROGUEROOMCOMPOSITIONTYPE_METHOD_4_A5F0A8E6AEDED19F_OFFSET UNITYSDK_OFFSET(0x1A89EA80)
#define RPG_GAMECORE_BYCOMPAREROGUEROOMCOMPOSITIONTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A89EAC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareRogueRoomCompositionType_TypeDefinitionIndex = 20017;
