...
#define RPG_GAMECORE_STACKWEAKRESISTANCE_METHOD_3_63C42F7608FE7BF7_OFFSET UNITYSDK_OFFSET(0x19CA3850)
#define RPG_GAMECORE_STACKWEAKRESISTANCE_METHOD_3_AD4D5E20631BE5EE_OFFSET UNITYSDK_OFFSET(0x19CA38D0)
#define RPG_GAMECORE_STACKWEAKRESISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x19CA38A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StackWeakResistance_TypeDefinitionIndex = 21820;
