...
#define RPG_GAMECORE_STACKWEAKRESISTANCE_METHOD_3_63C42F7608FE7BF7_OFFSET UNITYSDK_OFFSET(0x177633C0)
#define RPG_GAMECORE_STACKWEAKRESISTANCE_METHOD_3_AD4D5E20631BE5EE_OFFSET UNITYSDK_OFFSET(0x17763440)
#define RPG_GAMECORE_STACKWEAKRESISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x17763410)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StackWeakResistance_TypeDefinitionIndex = 21288;
