...
#define RPG_GAMECORE_SHOWEXPANDELATIONITEM_METHOD_3_77D5E206FDB79400_OFFSET UNITYSDK_OFFSET(0x18E5DCF0)
#define RPG_GAMECORE_SHOWEXPANDELATIONITEM_METHOD_3_82E3320A0D8CD476_OFFSET UNITYSDK_OFFSET(0x18E5DC70)
#define RPG_GAMECORE_SHOWEXPANDELATIONITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x18E5DCC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowExpandElationItem_TypeDefinitionIndex = 22334;
