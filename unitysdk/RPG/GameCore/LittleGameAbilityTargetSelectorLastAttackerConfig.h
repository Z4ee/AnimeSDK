...
#define RPG_GAMECORE_LITTLEGAMEABILITYTARGETSELECTORLASTATTACKERCONFIG_METHOD_3_94FE64EB494A6E2C_OFFSET UNITYSDK_OFFSET(0x1B095C70)
#define RPG_GAMECORE_LITTLEGAMEABILITYTARGETSELECTORLASTATTACKERCONFIG_METHOD_3_F84CAD4A3A927841_OFFSET UNITYSDK_OFFSET(0x1B095D10)
#define RPG_GAMECORE_LITTLEGAMEABILITYTARGETSELECTORLASTATTACKERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B095D00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityTargetSelectorLastAttackerConfig_TypeDefinitionIndex = 20573;
