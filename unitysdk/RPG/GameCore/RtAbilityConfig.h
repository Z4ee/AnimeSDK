...
#define RPG_GAMECORE_RTABILITYCONFIG_METHOD_3_C168DDEA7273D413_OFFSET UNITYSDK_OFFSET(0x1D495130)
#define RPG_GAMECORE_RTABILITYCONFIG_METHOD_3_FB3F1F349255B70A_OFFSET UNITYSDK_OFFSET(0x1D4950F0)
#define RPG_GAMECORE_RTABILITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D495120)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtAbilityConfig_TypeDefinitionIndex = 17436;
