...
#define RPG_GAMECORE_CHENLINGBATTLEEFFECTCONFIG_METHOD_2_F22C727D81B7294B_OFFSET UNITYSDK_OFFSET(0x1C376200)
#define RPG_GAMECORE_CHENLINGBATTLEEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C379EE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleEffectConfig_TypeDefinitionIndex = 15097;
