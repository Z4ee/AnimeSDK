...
#define RPG_GAMECORE_GROUPINITMEMBERENTITYTRANSFORM_METHOD_3_3FBF32B32B8D7395_OFFSET UNITYSDK_OFFSET(0x1D3C2BC0)
#define RPG_GAMECORE_GROUPINITMEMBERENTITYTRANSFORM_METHOD_3_77BC1A727545DAB8_OFFSET UNITYSDK_OFFSET(0x1D3C2C00)
#define RPG_GAMECORE_GROUPINITMEMBERENTITYTRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3C2BF0)
