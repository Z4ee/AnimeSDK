...
#define RPG_GAMECORE_ADVENTUREBYISBATTLESKILLTYPE_METHOD_4_0E5D77B248BC52D4_OFFSET UNITYSDK_OFFSET(0x16F4CB90)
#define RPG_GAMECORE_ADVENTUREBYISBATTLESKILLTYPE_METHOD_4_6AA4D2737211964A_OFFSET UNITYSDK_OFFSET(0x16F4CAC0)
#define RPG_GAMECORE_ADVENTUREBYISBATTLESKILLTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F4CB40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureByIsBattleSkillType_TypeDefinitionIndex = 19987;
