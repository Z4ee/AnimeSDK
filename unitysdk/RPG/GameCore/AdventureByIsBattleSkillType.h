...
#define RPG_GAMECORE_ADVENTUREBYISBATTLESKILLTYPE_METHOD_4_0E5D77B248BC52D4_OFFSET UNITYSDK_OFFSET(0x1AE4FFE0)
#define RPG_GAMECORE_ADVENTUREBYISBATTLESKILLTYPE_METHOD_4_AE03D74CB5F8B134_OFFSET UNITYSDK_OFFSET(0x1AE50160)
#define RPG_GAMECORE_ADVENTUREBYISBATTLESKILLTYPE_METHOD_4_CCC9D051C97D975B_OFFSET UNITYSDK_OFFSET(0x1AE50190)
#define RPG_GAMECORE_ADVENTUREBYISBATTLESKILLTYPE_METHOD_4_DB3B0E5DBCCC2551_OFFSET UNITYSDK_OFFSET(0x1AE4FFA0)
#define RPG_GAMECORE_ADVENTUREBYISBATTLESKILLTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE4FFD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureByIsBattleSkillType_TypeDefinitionIndex = 21015;
