...
#define RPG_GAMECORE_WAITHIPPLENGAMEEXIT_METHOD_3_2D8A7A615C55EC61_OFFSET UNITYSDK_OFFSET(0x1DEBA790)
#define RPG_GAMECORE_WAITHIPPLENGAMEEXIT_METHOD_3_C07D9255E29A9BE4_OFFSET UNITYSDK_OFFSET(0x1DEBA860)
#define RPG_GAMECORE_WAITHIPPLENGAMEEXIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEBA850)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitHipplenGameExit_TypeDefinitionIndex = 21066;
