...
#define RPG_GAMECORE_WAITHIPPLENGAMEEXIT_METHOD_3_0AD3FAF81BC699B8_OFFSET UNITYSDK_OFFSET(0x19E58C80)
#define RPG_GAMECORE_WAITHIPPLENGAMEEXIT_METHOD_3_C07D9255E29A9BE4_OFFSET UNITYSDK_OFFSET(0x19E58D90)
#define RPG_GAMECORE_WAITHIPPLENGAMEEXIT__CTOR_OFFSET UNITYSDK_OFFSET(0x19E58D60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitHipplenGameExit_TypeDefinitionIndex = 20142;
