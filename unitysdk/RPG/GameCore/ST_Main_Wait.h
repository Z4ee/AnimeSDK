...
#define RPG_GAMECORE_ST_MAIN_WAIT_METHOD_4_3D6D04A91877EF16_OFFSET UNITYSDK_OFFSET(0x18DF51C0)
#define RPG_GAMECORE_ST_MAIN_WAIT_METHOD_4_7D51BC927B83FADC_OFFSET UNITYSDK_OFFSET(0x18DF5290)
#define RPG_GAMECORE_ST_MAIN_WAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x18DF5240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_Wait_TypeDefinitionIndex = 19024;
