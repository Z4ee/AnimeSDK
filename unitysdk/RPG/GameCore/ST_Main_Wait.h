...
#define RPG_GAMECORE_ST_MAIN_WAIT_METHOD_4_4D567DE31375D657_OFFSET UNITYSDK_OFFSET(0x1DB40880)
#define RPG_GAMECORE_ST_MAIN_WAIT_METHOD_4_7D51BC927B83FADC_OFFSET UNITYSDK_OFFSET(0x1DB408C0)
#define RPG_GAMECORE_ST_MAIN_WAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB408B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_Wait_TypeDefinitionIndex = 19864;
