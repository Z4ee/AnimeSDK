...
#define RPG_GAMECORE_CHIMERADUELMASTERSELECTORCONFIG_METHOD_3_48CDA00FC70934A8_OFFSET UNITYSDK_OFFSET(0x19641990)
#define RPG_GAMECORE_CHIMERADUELMASTERSELECTORCONFIG_METHOD_3_DDD50C057BD43918_OFFSET UNITYSDK_OFFSET(0x19641930)
#define RPG_GAMECORE_CHIMERADUELMASTERSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19641980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelMasterSelectorConfig_TypeDefinitionIndex = 15134;
