...
#define RPG_GAMECORE_CHIMERADUELMASTERSELECTORCONFIG_METHOD_3_48CDA00FC70934A8_OFFSET UNITYSDK_OFFSET(0x187FF980)
#define RPG_GAMECORE_CHIMERADUELMASTERSELECTORCONFIG_METHOD_3_DDD50C057BD43918_OFFSET UNITYSDK_OFFSET(0x187FF920)
#define RPG_GAMECORE_CHIMERADUELMASTERSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x187FF970)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelMasterSelectorConfig_TypeDefinitionIndex = 15071;
