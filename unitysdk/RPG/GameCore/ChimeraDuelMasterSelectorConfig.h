...
#define RPG_GAMECORE_CHIMERADUELMASTERSELECTORCONFIG_METHOD_3_48CDA00FC70934A8_OFFSET UNITYSDK_OFFSET(0x170A0640)
#define RPG_GAMECORE_CHIMERADUELMASTERSELECTORCONFIG_METHOD_3_DDD50C057BD43918_OFFSET UNITYSDK_OFFSET(0x170A05E0)
#define RPG_GAMECORE_CHIMERADUELMASTERSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x170A0630)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelMasterSelectorConfig_TypeDefinitionIndex = 14601;
