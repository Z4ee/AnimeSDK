...
#define RPG_GAMECORE_CHIMERADUELMASTERSELECTORCONFIG_METHOD_3_48CDA00FC70934A8_OFFSET UNITYSDK_OFFSET(0x1C243100)
#define RPG_GAMECORE_CHIMERADUELMASTERSELECTORCONFIG_METHOD_3_DDD50C057BD43918_OFFSET UNITYSDK_OFFSET(0x1C2430A0)
#define RPG_GAMECORE_CHIMERADUELMASTERSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2430F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelMasterSelectorConfig_TypeDefinitionIndex = 15298;
