...
#define RPG_GAMECORE_FIVEDIMDASHBASICCONFIG_METHOD_2_490D64200E4A72A8_OFFSET UNITYSDK_OFFSET(0x188FCBC0)
#define RPG_GAMECORE_FIVEDIMDASHBASICCONFIG_METHOD_2_F26D4D17A4081C51_OFFSET UNITYSDK_OFFSET(0x188FC960)
#define RPG_GAMECORE_FIVEDIMDASHBASICCONFIG_METHOD_2_F8C7231308CD2C82_OFFSET UNITYSDK_OFFSET(0x188FCB50)
#define RPG_GAMECORE_FIVEDIMDASHBASICCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x188FCB40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimDashBasicConfig_TypeDefinitionIndex = 15781;
