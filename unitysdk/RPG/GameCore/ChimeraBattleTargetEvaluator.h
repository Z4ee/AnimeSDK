...
#define RPG_GAMECORE_CHIMERABATTLETARGETEVALUATOR_METHOD_3_7DFCD86CD8062A6A_OFFSET UNITYSDK_OFFSET(0x187F36A0)
#define RPG_GAMECORE_CHIMERABATTLETARGETEVALUATOR_METHOD_3_946E9498D43F6814_OFFSET UNITYSDK_OFFSET(0x187F1A10)
#define RPG_GAMECORE_CHIMERABATTLETARGETEVALUATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x187F3690)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraBattleTargetEvaluator_TypeDefinitionIndex = 14998;
