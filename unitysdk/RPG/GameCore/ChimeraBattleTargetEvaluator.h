...
#define RPG_GAMECORE_CHIMERABATTLETARGETEVALUATOR_METHOD_3_7DFCD86CD8062A6A_OFFSET UNITYSDK_OFFSET(0x170942F0)
#define RPG_GAMECORE_CHIMERABATTLETARGETEVALUATOR_METHOD_3_946E9498D43F6814_OFFSET UNITYSDK_OFFSET(0x17092660)
#define RPG_GAMECORE_CHIMERABATTLETARGETEVALUATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x170942E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraBattleTargetEvaluator_TypeDefinitionIndex = 14528;
