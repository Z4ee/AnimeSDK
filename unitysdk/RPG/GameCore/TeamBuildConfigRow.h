...
#define RPG_GAMECORE_TEAMBUILDCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x190904A0)
#define RPG_GAMECORE_TEAMBUILDCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19090880)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TeamBuildConfigRow_TypeDefinitionIndex = 14471;

	class TeamBuildConfigRow : public ::System::Object
	{
	public:
		::Il2CppArray<::System::UInt32>* BackupList3; // 0x10
		::Il2CppArray<::System::UInt32>* BackupList1; // 0x18
		...
		::Il2CppArray<::System::UInt32>* MemberList; // 0x40
		::System::UInt32 Position; // 0x48
		::System::UInt32 TeamID; // 0x4C
