...
#define RPG_GAMECORE_TEAMBUILDCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1E1CABA0)
#define RPG_GAMECORE_TEAMBUILDCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1CAF50)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::System::UInt32>* BackupList1; // 0x38
