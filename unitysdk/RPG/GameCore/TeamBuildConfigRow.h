...
#define RPG_GAMECORE_TEAMBUILDCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19DDB240)
#define RPG_GAMECORE_TEAMBUILDCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19DDB5F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TeamBuildConfigRow_TypeDefinitionIndex = 14508;

	class TeamBuildConfigRow : public ::System::Object
	{
	public:
		::Il2CppArray<::System::UInt32>* BackupList2; // 0x10
		::Il2CppArray<::System::UInt32>* BackupGroupList2; // 0x18
		::Il2CppArray<::System::UInt32>* BackupGroupList1; // 0x20
		::Il2CppArray<::System::UInt32>* BackupList1; // 0x28
		::Il2CppArray<::System::UInt32>* BackupGroupList3; // 0x30
