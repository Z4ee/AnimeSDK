...
#define RPG_GAMECORE_BYISREBUILTSUMMONUNIT_METHOD_4_314617F59C384C17_OFFSET UNITYSDK_OFFSET(0x187566A0)
#define RPG_GAMECORE_BYISREBUILTSUMMONUNIT_METHOD_4_DA2E7D5D39AEF2D9_OFFSET UNITYSDK_OFFSET(0x187565D0)
#define RPG_GAMECORE_BYISREBUILTSUMMONUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0x18756650)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsRebuiltSummonUnit_TypeDefinitionIndex = 19100;
