...
#define RPG_GAMECORE_PROPRESETGACHAMACHINE_METHOD_3_E45A08411B9B6711_OFFSET UNITYSDK_OFFSET(0x1BA281C0)
#define RPG_GAMECORE_PROPRESETGACHAMACHINE_METHOD_3_F3621C456C2A6141_OFFSET UNITYSDK_OFFSET(0x1BA28240)
#define RPG_GAMECORE_PROPRESETGACHAMACHINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA28210)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropResetGachaMachine_TypeDefinitionIndex = 21163;
