...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEMIRACLERECORD_METHOD_3_32BBF2EA7F1B7B1D_OFFSET UNITYSDK_OFFSET(0x1C2E7230)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEMIRACLERECORD_METHOD_3_BE0FAD54E1714510_OFFSET UNITYSDK_OFFSET(0x1C2E7270)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEMIRACLERECORD__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2E7260)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRogueMiracleRecord_TypeDefinitionIndex = 20974;
