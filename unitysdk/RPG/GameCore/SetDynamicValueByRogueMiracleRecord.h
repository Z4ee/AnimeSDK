...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEMIRACLERECORD_METHOD_3_103BC976D4913737_OFFSET UNITYSDK_OFFSET(0x19C43B50)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEMIRACLERECORD_METHOD_3_BE0FAD54E1714510_OFFSET UNITYSDK_OFFSET(0x19C43BC0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEMIRACLERECORD__CTOR_OFFSET UNITYSDK_OFFSET(0x19C43B90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRogueMiracleRecord_TypeDefinitionIndex = 20559;
