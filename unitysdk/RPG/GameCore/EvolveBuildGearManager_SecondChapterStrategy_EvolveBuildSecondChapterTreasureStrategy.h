...
#define RPG_GAMECORE_EVOLVEBUILDGEARMANAGER_SECONDCHAPTERSTRATEGY_EVOLVEBUILDSECONDCHAPTERTREASURESTRATEGY_GET_DELAYSHOWTREASUREUI_OFFSET UNITYSDK_OFFSET(0xCDEA9D0)
#define RPG_GAMECORE_EVOLVEBUILDGEARMANAGER_SECONDCHAPTERSTRATEGY_EVOLVEBUILDSECONDCHAPTERTREASURESTRATEGY_SETTREASURECONFIG_OFFSET UNITYSDK_OFFSET(0xCDEA650)
#define RPG_GAMECORE_EVOLVEBUILDGEARMANAGER_SECONDCHAPTERSTRATEGY_EVOLVEBUILDSECONDCHAPTERTREASURESTRATEGY_SHOWEVOLVEBUILDTREASURE_OFFSET UNITYSDK_OFFSET(0xCDEA6B0)
#define RPG_GAMECORE_EVOLVEBUILDGEARMANAGER_SECONDCHAPTERSTRATEGY_EVOLVEBUILDSECONDCHAPTERTREASURESTRATEGY__CTOR_OFFSET UNITYSDK_OFFSET(0xCDE89C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EvolveBuildGearManager_SecondChapterStrategy_EvolveBuildSecondChapterTreasureStrategy_TypeDefinitionIndex = 52336;
