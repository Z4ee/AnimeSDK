...
#define RPG_GAMECORE_ROGUECONDMIRACLECOUNTCONFIG_METHOD_6_BAB4F1D0D06F4746_OFFSET UNITYSDK_OFFSET(0x1C4AEBE0)
#define RPG_GAMECORE_ROGUECONDMIRACLECOUNTCONFIG_METHOD_6_BE4098AF7BA7CFE2_OFFSET UNITYSDK_OFFSET(0x1C4AEC30)
#define RPG_GAMECORE_ROGUECONDMIRACLECOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4AEC20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueCondMiracleCountConfig_TypeDefinitionIndex = 19030;
