...
#define RPG_GAMECORE_ROGUECONDMIRACLECOUNTCONFIG_METHOD_6_3DC88803D9FFF70C_OFFSET UNITYSDK_OFFSET(0x19B1C510)
#define RPG_GAMECORE_ROGUECONDMIRACLECOUNTCONFIG_METHOD_6_BE4098AF7BA7CFE2_OFFSET UNITYSDK_OFFSET(0x19B1C7C0)
#define RPG_GAMECORE_ROGUECONDMIRACLECOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B1C690)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueCondMiracleCountConfig_TypeDefinitionIndex = 18751;
