...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONFIRSTENTERSUPERROOMEVERYLAYERCONFIG_METHOD_3_25C62FDA153DFAEA_OFFSET UNITYSDK_OFFSET(0x17630590)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONFIRSTENTERSUPERROOMEVERYLAYERCONFIG_METHOD_3_F24EFF468066A733_OFFSET UNITYSDK_OFFSET(0x176304C0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONFIRSTENTERSUPERROOMEVERYLAYERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17630540)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnFirstEnterSuperRoomEveryLayerConfig_TypeDefinitionIndex = 16407;
