...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONFIRSTENTERSUPERROOMEVERYLAYERCONFIG_METHOD_3_25C62FDA153DFAEA_OFFSET UNITYSDK_OFFSET(0x18D35DE0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONFIRSTENTERSUPERROOMEVERYLAYERCONFIG_METHOD_3_F24EFF468066A733_OFFSET UNITYSDK_OFFSET(0x18D3D370)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONFIRSTENTERSUPERROOMEVERYLAYERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D35D90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnFirstEnterSuperRoomEveryLayerConfig_TypeDefinitionIndex = 16961;
