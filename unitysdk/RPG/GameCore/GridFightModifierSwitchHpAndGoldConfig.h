...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSWITCHHPANDGOLDCONFIG_METHOD_3_4577E213952E3797_OFFSET UNITYSDK_OFFSET(0x1D06B4B0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSWITCHHPANDGOLDCONFIG_METHOD_3_4C6ED7215332AD53_OFFSET UNITYSDK_OFFSET(0x1D06B460)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSWITCHHPANDGOLDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D06B4A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierSwitchHpAndGoldConfig_TypeDefinitionIndex = 18661;
