...
#define RPG_GAMECORE_SO_TRIGGERGROUPEVENT_METHOD_4_C186FBC84337057E_OFFSET UNITYSDK_OFFSET(0x1767D420)
#define RPG_GAMECORE_SO_TRIGGERGROUPEVENT_METHOD_4_FDD3189D3DD447EF_OFFSET UNITYSDK_OFFSET(0x1767CE70)
#define RPG_GAMECORE_SO_TRIGGERGROUPEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1767CE40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SO_TriggerGroupEvent_TypeDefinitionIndex = 18341;
