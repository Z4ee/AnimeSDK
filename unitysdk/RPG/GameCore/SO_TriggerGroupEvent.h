...
#define RPG_GAMECORE_SO_TRIGGERGROUPEVENT_METHOD_4_DAEB4B81180489D4_OFFSET UNITYSDK_OFFSET(0x1DB2FE30)
#define RPG_GAMECORE_SO_TRIGGERGROUPEVENT_METHOD_4_FDD3189D3DD447EF_OFFSET UNITYSDK_OFFSET(0x1DB2F990)
#define RPG_GAMECORE_SO_TRIGGERGROUPEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB2F980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SO_TriggerGroupEvent_TypeDefinitionIndex = 19831;
