...
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTBURNBOOSTPERCENTCONFIG_METHOD_3_945354B63E6E6E16_OFFSET UNITYSDK_OFFSET(0x19894000)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTBURNBOOSTPERCENTCONFIG_METHOD_3_E05AD8A4E2240E4A_OFFSET UNITYSDK_OFFSET(0x19893F30)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTBURNBOOSTPERCENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19893FF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityPixAirEffectBurnBoostPercentConfig_TypeDefinitionIndex = 20186;
