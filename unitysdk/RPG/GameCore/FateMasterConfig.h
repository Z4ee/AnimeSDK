...
#define RPG_GAMECORE_FATEMASTERCONFIG_METHOD_2_C8E9746DD6E6761B_OFFSET UNITYSDK_OFFSET(0x1970FD90)
#define RPG_GAMECORE_FATEMASTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1970FE40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateMasterConfig_TypeDefinitionIndex = 15794;
