...
#define RPG_GAMECORE_FATEMASTERCONFIG_METHOD_2_C8E9746DD6E6761B_OFFSET UNITYSDK_OFFSET(0x1C074980)
#define RPG_GAMECORE_FATEMASTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C074A30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateMasterConfig_TypeDefinitionIndex = 15968;
