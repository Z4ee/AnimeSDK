...
#define RPG_GAMECORE_BYWAITCUSTOMSTRING_METHOD_4_1F03EC93448E2C06_OFFSET UNITYSDK_OFFSET(0x1703F350)
#define RPG_GAMECORE_BYWAITCUSTOMSTRING_METHOD_4_FAD85F4FFF311BD8_OFFSET UNITYSDK_OFFSET(0x1703F280)
#define RPG_GAMECORE_BYWAITCUSTOMSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1703F300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByWaitCustomString_TypeDefinitionIndex = 19855;
