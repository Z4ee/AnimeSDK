...
#define RPG_GAMECORE_BYWAITCUSTOMSTRING_METHOD_4_1450E590510397F7_OFFSET UNITYSDK_OFFSET(0x1B2C5E70)
#define RPG_GAMECORE_BYWAITCUSTOMSTRING_METHOD_4_1F03EC93448E2C06_OFFSET UNITYSDK_OFFSET(0x1B2C5EB0)
#define RPG_GAMECORE_BYWAITCUSTOMSTRING_METHOD_4_B3EF8F03A8E8B325_OFFSET UNITYSDK_OFFSET(0x1B2C6040)
#define RPG_GAMECORE_BYWAITCUSTOMSTRING_METHOD_4_BD06A0A7EDE18FD2_OFFSET UNITYSDK_OFFSET(0x1B2C6010)
#define RPG_GAMECORE_BYWAITCUSTOMSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2C5EA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByWaitCustomString_TypeDefinitionIndex = 20887;
