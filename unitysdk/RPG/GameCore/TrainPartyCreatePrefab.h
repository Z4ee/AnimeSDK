...
#define RPG_GAMECORE_TRAINPARTYCREATEPREFAB_METHOD_3_205195CB41E630CE_OFFSET UNITYSDK_OFFSET(0x190A9C40)
#define RPG_GAMECORE_TRAINPARTYCREATEPREFAB_METHOD_3_CF18F1BDFC64377F_OFFSET UNITYSDK_OFFSET(0x190A9D00)
#define RPG_GAMECORE_TRAINPARTYCREATEPREFAB__CTOR_OFFSET UNITYSDK_OFFSET(0x190A9CB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyCreatePrefab_TypeDefinitionIndex = 21244;
