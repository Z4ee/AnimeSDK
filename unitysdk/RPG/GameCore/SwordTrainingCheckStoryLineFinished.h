...
#define RPG_GAMECORE_SWORDTRAININGCHECKSTORYLINEFINISHED_METHOD_3_5F8A0E74CE9A8B69_OFFSET UNITYSDK_OFFSET(0x1B43CF60)
#define RPG_GAMECORE_SWORDTRAININGCHECKSTORYLINEFINISHED_METHOD_3_8E5BDC8095A82944_OFFSET UNITYSDK_OFFSET(0x1B43CF20)
#define RPG_GAMECORE_SWORDTRAININGCHECKSTORYLINEFINISHED__CTOR_OFFSET UNITYSDK_OFFSET(0x1B43CF50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwordTrainingCheckStoryLineFinished_TypeDefinitionIndex = 19545;
