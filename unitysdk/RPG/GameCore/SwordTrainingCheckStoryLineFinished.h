...
#define RPG_GAMECORE_SWORDTRAININGCHECKSTORYLINEFINISHED_METHOD_3_DAC19FFF97974E9A_OFFSET UNITYSDK_OFFSET(0x1779C0A0)
#define RPG_GAMECORE_SWORDTRAININGCHECKSTORYLINEFINISHED_METHOD_3_DF0EA5D6AFA30773_OFFSET UNITYSDK_OFFSET(0x1779C120)
#define RPG_GAMECORE_SWORDTRAININGCHECKSTORYLINEFINISHED__CTOR_OFFSET UNITYSDK_OFFSET(0x1779C0F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwordTrainingCheckStoryLineFinished_TypeDefinitionIndex = 18615;
