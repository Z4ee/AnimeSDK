...
#define RPG_GAMECORE_GRIDFIGHTGETGRIDEMPTYSLOTPARAM_METHOD_3_6E79A6F935B5A10A_OFFSET UNITYSDK_OFFSET(0x1725EAE0)
#define RPG_GAMECORE_GRIDFIGHTGETGRIDEMPTYSLOTPARAM_METHOD_3_F2F70EFE5B0A3D62_OFFSET UNITYSDK_OFFSET(0x1725EB40)
#define RPG_GAMECORE_GRIDFIGHTGETGRIDEMPTYSLOTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1725EB30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightGetGridEmptySlotParam_TypeDefinitionIndex = 18220;
