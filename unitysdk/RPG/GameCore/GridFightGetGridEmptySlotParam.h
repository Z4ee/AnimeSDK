...
#define RPG_GAMECORE_GRIDFIGHTGETGRIDEMPTYSLOTPARAM_METHOD_3_6E79A6F935B5A10A_OFFSET UNITYSDK_OFFSET(0x1D156870)
#define RPG_GAMECORE_GRIDFIGHTGETGRIDEMPTYSLOTPARAM_METHOD_3_F2F70EFE5B0A3D62_OFFSET UNITYSDK_OFFSET(0x1D1568D0)
#define RPG_GAMECORE_GRIDFIGHTGETGRIDEMPTYSLOTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1568C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightGetGridEmptySlotParam_TypeDefinitionIndex = 19723;
