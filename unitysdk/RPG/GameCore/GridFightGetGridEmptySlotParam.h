...
#define RPG_GAMECORE_GRIDFIGHTGETGRIDEMPTYSLOTPARAM_METHOD_3_6E79A6F935B5A10A_OFFSET UNITYSDK_OFFSET(0x197E6B70)
#define RPG_GAMECORE_GRIDFIGHTGETGRIDEMPTYSLOTPARAM_METHOD_3_F2F70EFE5B0A3D62_OFFSET UNITYSDK_OFFSET(0x197E6BD0)
#define RPG_GAMECORE_GRIDFIGHTGETGRIDEMPTYSLOTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x197E6BC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightGetGridEmptySlotParam_TypeDefinitionIndex = 18832;
