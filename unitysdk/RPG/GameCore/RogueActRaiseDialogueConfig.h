...
#define RPG_GAMECORE_ROGUEACTRAISEDIALOGUECONFIG_METHOD_6_7F324A441E26C3B7_OFFSET UNITYSDK_OFFSET(0x19AF5070)
#define RPG_GAMECORE_ROGUEACTRAISEDIALOGUECONFIG_METHOD_6_8DEA8F33BBA138C2_OFFSET UNITYSDK_OFFSET(0x19AF5290)
#define RPG_GAMECORE_ROGUEACTRAISEDIALOGUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AF51B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActRaiseDialogueConfig_TypeDefinitionIndex = 18664;
