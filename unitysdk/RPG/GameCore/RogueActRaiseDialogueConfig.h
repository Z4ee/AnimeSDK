...
#define RPG_GAMECORE_ROGUEACTRAISEDIALOGUECONFIG_METHOD_6_7F324A441E26C3B7_OFFSET UNITYSDK_OFFSET(0x175C4D80)
#define RPG_GAMECORE_ROGUEACTRAISEDIALOGUECONFIG_METHOD_6_8DEA8F33BBA138C2_OFFSET UNITYSDK_OFFSET(0x175C4FA0)
#define RPG_GAMECORE_ROGUEACTRAISEDIALOGUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175C4EC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActRaiseDialogueConfig_TypeDefinitionIndex = 18052;
