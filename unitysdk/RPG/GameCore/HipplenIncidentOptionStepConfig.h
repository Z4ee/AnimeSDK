...
#define RPG_GAMECORE_HIPPLENINCIDENTOPTIONSTEPCONFIG_METHOD_3_011538B22175590B_OFFSET UNITYSDK_OFFSET(0x1B688640)
#define RPG_GAMECORE_HIPPLENINCIDENTOPTIONSTEPCONFIG_METHOD_3_F4CD955283B3C0EC_OFFSET UNITYSDK_OFFSET(0x1B6885E0)
#define RPG_GAMECORE_HIPPLENINCIDENTOPTIONSTEPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B688630)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HipplenIncidentOptionStepConfig_TypeDefinitionIndex = 16146;
