...
#define RPG_GAMECORE_HIPPLENINCIDENTOPTIONSTEPCONFIG_METHOD_3_011538B22175590B_OFFSET UNITYSDK_OFFSET(0x172AED50)
#define RPG_GAMECORE_HIPPLENINCIDENTOPTIONSTEPCONFIG_METHOD_3_F4CD955283B3C0EC_OFFSET UNITYSDK_OFFSET(0x172AECF0)
#define RPG_GAMECORE_HIPPLENINCIDENTOPTIONSTEPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x172AED40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HipplenIncidentOptionStepConfig_TypeDefinitionIndex = 15391;
