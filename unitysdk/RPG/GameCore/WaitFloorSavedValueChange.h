...
#define RPG_GAMECORE_WAITFLOORSAVEDVALUECHANGE_METHOD_3_73FE11397DD8D486_OFFSET UNITYSDK_OFFSET(0x190FD7A0)
#define RPG_GAMECORE_WAITFLOORSAVEDVALUECHANGE_METHOD_3_980409FCC60114B5_OFFSET UNITYSDK_OFFSET(0x190FD820)
#define RPG_GAMECORE_WAITFLOORSAVEDVALUECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x190FD7F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitFloorSavedValueChange_TypeDefinitionIndex = 19684;
