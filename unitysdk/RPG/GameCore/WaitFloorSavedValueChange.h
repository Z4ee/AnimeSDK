...
#define RPG_GAMECORE_WAITFLOORSAVEDVALUECHANGE_METHOD_3_980409FCC60114B5_OFFSET UNITYSDK_OFFSET(0x1DEB8420)
#define RPG_GAMECORE_WAITFLOORSAVEDVALUECHANGE_METHOD_3_BE566C19F0826FA4_OFFSET UNITYSDK_OFFSET(0x1DEB83E0)
#define RPG_GAMECORE_WAITFLOORSAVEDVALUECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEB8410)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitFloorSavedValueChange_TypeDefinitionIndex = 20469;
