...
#define RPG_GAMECORE_STACKSTATUSPROBABILITY_METHOD_3_28FE2D567B7FFD55_OFFSET UNITYSDK_OFFSET(0x18E880B0)
#define RPG_GAMECORE_STACKSTATUSPROBABILITY_METHOD_3_DD7AA2719E08584D_OFFSET UNITYSDK_OFFSET(0x18E88030)
#define RPG_GAMECORE_STACKSTATUSPROBABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x18E88080)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StackStatusProbability_TypeDefinitionIndex = 21575;
