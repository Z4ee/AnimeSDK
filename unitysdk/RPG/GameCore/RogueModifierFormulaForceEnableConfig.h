...
#define RPG_GAMECORE_ROGUEMODIFIERFORMULAFORCEENABLECONFIG_METHOD_3_932FA214E98EE68C_OFFSET UNITYSDK_OFFSET(0x1CFC1270)
#define RPG_GAMECORE_ROGUEMODIFIERFORMULAFORCEENABLECONFIG_METHOD_3_E27FDDF0F4053E10_OFFSET UNITYSDK_OFFSET(0x1CFC1220)
#define RPG_GAMECORE_ROGUEMODIFIERFORMULAFORCEENABLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFC1260)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierFormulaForceEnableConfig_TypeDefinitionIndex = 17260;
