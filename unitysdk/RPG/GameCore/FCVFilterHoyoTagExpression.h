...
#define RPG_GAMECORE_FCVFILTERHOYOTAGEXPRESSION_METHOD_3_442A55749FEDCBD5_OFFSET UNITYSDK_OFFSET(0x1D7E2330)
#define RPG_GAMECORE_FCVFILTERHOYOTAGEXPRESSION_METHOD_3_F7D1136B55C987B1_OFFSET UNITYSDK_OFFSET(0x1D7E2340)
#define RPG_GAMECORE_FCVFILTERHOYOTAGEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7E2320)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FCVFilterHoyoTagExpression_TypeDefinitionIndex = 17205;
