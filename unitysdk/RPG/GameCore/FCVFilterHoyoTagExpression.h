...
#define RPG_GAMECORE_FCVFILTERHOYOTAGEXPRESSION_METHOD_3_442A55749FEDCBD5_OFFSET UNITYSDK_OFFSET(0x188C9780)
#define RPG_GAMECORE_FCVFILTERHOYOTAGEXPRESSION_METHOD_3_F7D1136B55C987B1_OFFSET UNITYSDK_OFFSET(0x188C9790)
#define RPG_GAMECORE_FCVFILTERHOYOTAGEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x188C9770)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FCVFilterHoyoTagExpression_TypeDefinitionIndex = 16510;
