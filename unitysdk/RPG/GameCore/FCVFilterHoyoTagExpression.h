...
#define RPG_GAMECORE_FCVFILTERHOYOTAGEXPRESSION_METHOD_3_442A55749FEDCBD5_OFFSET UNITYSDK_OFFSET(0x19706A30)
#define RPG_GAMECORE_FCVFILTERHOYOTAGEXPRESSION_METHOD_3_F7D1136B55C987B1_OFFSET UNITYSDK_OFFSET(0x19706A40)
#define RPG_GAMECORE_FCVFILTERHOYOTAGEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x19706A20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FCVFilterHoyoTagExpression_TypeDefinitionIndex = 16541;
