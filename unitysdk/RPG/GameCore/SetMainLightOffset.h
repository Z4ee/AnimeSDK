...
#define RPG_GAMECORE_SETMAINLIGHTOFFSET_METHOD_3_B1EC9FD9A7B2E713_OFFSET UNITYSDK_OFFSET(0x176D4830)
#define RPG_GAMECORE_SETMAINLIGHTOFFSET_METHOD_3_BCD805938C37A604_OFFSET UNITYSDK_OFFSET(0x176D48B0)
#define RPG_GAMECORE_SETMAINLIGHTOFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x176D4880)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetMainLightOffset_TypeDefinitionIndex = 21618;
