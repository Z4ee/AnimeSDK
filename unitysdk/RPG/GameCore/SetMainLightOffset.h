...
#define RPG_GAMECORE_SETMAINLIGHTOFFSET_METHOD_3_D1C40FF49782BF5B_OFFSET UNITYSDK_OFFSET(0x1D504C80)
#define RPG_GAMECORE_SETMAINLIGHTOFFSET_METHOD_3_DAA5938CDC14DC0A_OFFSET UNITYSDK_OFFSET(0x1D504C40)
#define RPG_GAMECORE_SETMAINLIGHTOFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1D504C70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetMainLightOffset_TypeDefinitionIndex = 23127;
