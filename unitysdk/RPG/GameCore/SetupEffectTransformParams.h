...
#define RPG_GAMECORE_SETUPEFFECTTRANSFORMPARAMS_METHOD_3_72C251D1CAD24F9B_OFFSET UNITYSDK_OFFSET(0x18E4D2F0)
#define RPG_GAMECORE_SETUPEFFECTTRANSFORMPARAMS_METHOD_3_9E0A20077A3B86BB_OFFSET UNITYSDK_OFFSET(0x18E4D370)
#define RPG_GAMECORE_SETUPEFFECTTRANSFORMPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x18E4D340)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetupEffectTransformParams_TypeDefinitionIndex = 21114;
