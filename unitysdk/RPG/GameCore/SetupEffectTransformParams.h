...
#define RPG_GAMECORE_SETUPEFFECTTRANSFORMPARAMS_METHOD_3_464BF9ECFF05A139_OFFSET UNITYSDK_OFFSET(0x1E098520)
#define RPG_GAMECORE_SETUPEFFECTTRANSFORMPARAMS_METHOD_3_9E0A20077A3B86BB_OFFSET UNITYSDK_OFFSET(0x1E098560)
#define RPG_GAMECORE_SETUPEFFECTTRANSFORMPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x1E098550)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetupEffectTransformParams_TypeDefinitionIndex = 21990;
