...
#define RPG_GAMECORE_TARGETREVERSE_METHOD_3_03858B82214BD0A1_OFFSET UNITYSDK_OFFSET(0x177C4C00)
#define RPG_GAMECORE_TARGETREVERSE_METHOD_3_CEE87F8603B1E7E4_OFFSET UNITYSDK_OFFSET(0x177C4B40)
#define RPG_GAMECORE_TARGETREVERSE__CTOR_OFFSET UNITYSDK_OFFSET(0x177C4BE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetReverse_TypeDefinitionIndex = 22307;
