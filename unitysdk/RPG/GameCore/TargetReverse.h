...
#define RPG_GAMECORE_TARGETREVERSE_METHOD_3_03858B82214BD0A1_OFFSET UNITYSDK_OFFSET(0x1D0C50A0)
#define RPG_GAMECORE_TARGETREVERSE_METHOD_3_2245CBE33D7FB5BE_OFFSET UNITYSDK_OFFSET(0x1D0C5100)
#define RPG_GAMECORE_TARGETREVERSE_METHOD_3_9F195BB8308DE9EB_OFFSET UNITYSDK_OFFSET(0x1D0C5120)
#define RPG_GAMECORE_TARGETREVERSE_METHOD_3_A68F969D306BF10C_OFFSET UNITYSDK_OFFSET(0x1D0C5020)
#define RPG_GAMECORE_TARGETREVERSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0C5090)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetReverse_TypeDefinitionIndex = 23179;
