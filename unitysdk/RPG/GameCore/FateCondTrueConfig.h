...
#define RPG_GAMECORE_FATECONDTRUECONFIG_METHOD_6_9CB46396511F268C_OFFSET UNITYSDK_OFFSET(0x1970F1E0)
#define RPG_GAMECORE_FATECONDTRUECONFIG_METHOD_6_B66367AF9B939BA8_OFFSET UNITYSDK_OFFSET(0x1970F3A0)
#define RPG_GAMECORE_FATECONDTRUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1970F2E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateCondTrueConfig_TypeDefinitionIndex = 18259;
