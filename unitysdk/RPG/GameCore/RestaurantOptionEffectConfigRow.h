...
#define RPG_GAMECORE_RESTAURANTOPTIONEFFECTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19AD6770)
#define RPG_GAMECORE_RESTAURANTOPTIONEFFECTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19AD6A60)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 EventRewardID; // 0x2C
		::RPG::GameCore::RestaurantSelectionType Type; // 0x30
		::System::UInt32 Param; // 0x34
