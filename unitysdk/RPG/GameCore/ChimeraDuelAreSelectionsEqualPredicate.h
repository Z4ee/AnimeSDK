...
#define RPG_GAMECORE_CHIMERADUELARESELECTIONSEQUALPREDICATE_METHOD_3_6F3C5062D550D643_OFFSET UNITYSDK_OFFSET(0x170958D0)
#define RPG_GAMECORE_CHIMERADUELARESELECTIONSEQUALPREDICATE_METHOD_3_ED62CC93FAB46C13_OFFSET UNITYSDK_OFFSET(0x17095870)
#define RPG_GAMECORE_CHIMERADUELARESELECTIONSEQUALPREDICATE__CTOR_OFFSET UNITYSDK_OFFSET(0x170958C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelAreSelectionsEqualPredicate_TypeDefinitionIndex = 14671;
