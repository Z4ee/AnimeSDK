...
#define RPG_GAMECORE_CHIMERADUELARESELECTIONSEQUALPREDICATE_METHOD_3_6C1729274536DB96_OFFSET UNITYSDK_OFFSET(0x1CFBF940)
#define RPG_GAMECORE_CHIMERADUELARESELECTIONSEQUALPREDICATE_METHOD_3_6CE4EC74B392D2CE_OFFSET UNITYSDK_OFFSET(0x1CFBF9A0)
#define RPG_GAMECORE_CHIMERADUELARESELECTIONSEQUALPREDICATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFBF990)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelAreSelectionsEqualPredicate_TypeDefinitionIndex = 15804;
