...
#define RPG_GAMECORE_DEACTIVATESERVERGAMEPLAYCOUNTER_METHOD_3_31F41DB3EA297774_OFFSET UNITYSDK_OFFSET(0x19692650)
#define RPG_GAMECORE_DEACTIVATESERVERGAMEPLAYCOUNTER_METHOD_3_80E90434EBD47234_OFFSET UNITYSDK_OFFSET(0x196926E0)
#define RPG_GAMECORE_DEACTIVATESERVERGAMEPLAYCOUNTER__CTOR_OFFSET UNITYSDK_OFFSET(0x196926B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DeactivateServerGameplayCounter_TypeDefinitionIndex = 19413;
