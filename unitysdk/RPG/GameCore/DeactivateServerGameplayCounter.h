...
#define RPG_GAMECORE_DEACTIVATESERVERGAMEPLAYCOUNTER_METHOD_3_31F41DB3EA297774_OFFSET UNITYSDK_OFFSET(0x18853500)
#define RPG_GAMECORE_DEACTIVATESERVERGAMEPLAYCOUNTER_METHOD_3_80E90434EBD47234_OFFSET UNITYSDK_OFFSET(0x18853590)
#define RPG_GAMECORE_DEACTIVATESERVERGAMEPLAYCOUNTER__CTOR_OFFSET UNITYSDK_OFFSET(0x18853560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DeactivateServerGameplayCounter_TypeDefinitionIndex = 19519;
