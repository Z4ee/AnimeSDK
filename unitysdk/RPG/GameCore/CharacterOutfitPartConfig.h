...
#define RPG_GAMECORE_CHARACTEROUTFITPARTCONFIG_METHOD_2_13421EF3946187DA_OFFSET UNITYSDK_OFFSET(0x19610E80)
#define RPG_GAMECORE_CHARACTEROUTFITPARTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19610F40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterOutfitPartConfig_TypeDefinitionIndex = 16623;
