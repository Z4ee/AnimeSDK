...
#define RPG_GAMECORE_CHARACTEROUTFITPARTCONFIG_METHOD_2_13421EF3946187DA_OFFSET UNITYSDK_OFFSET(0x1D124C60)
#define RPG_GAMECORE_CHARACTEROUTFITPARTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D124D20)
