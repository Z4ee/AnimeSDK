...
#define RPG_GAMECORE_TARGETFETCHPASSIVEENTITY_METHOD_4_5552BE9E63AE5870_OFFSET UNITYSDK_OFFSET(0x19CFB810)
#define RPG_GAMECORE_TARGETFETCHPASSIVEENTITY_METHOD_4_675BCBC480629A48_OFFSET UNITYSDK_OFFSET(0x19D0E680)
#define RPG_GAMECORE_TARGETFETCHPASSIVEENTITY_METHOD_4_9BC4595DDD3D41C2_OFFSET UNITYSDK_OFFSET(0x19D0E5C0)
#define RPG_GAMECORE_TARGETFETCHPASSIVEENTITY_METHOD_4_FC2CCCCC4E870288_OFFSET UNITYSDK_OFFSET(0x19D06CD0)
#define RPG_GAMECORE_TARGETFETCHPASSIVEENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x19CFB7C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchPassiveEntity_TypeDefinitionIndex = 22597;
	...
	public:
		...
		static ::System::Void Method_4_FC2CCCCC4E870288(::SimpleJSON::JSONNode* a1, ::RPG::GameCore::TargetFetchPassiveEntity*& a2)
		{
			return ((::System::Void(*)(::SimpleJSON::JSONNode*, ::RPG::GameCore::TargetFetchPassiveEntity*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_TARGETFETCHPASSIVEENTITY_METHOD_4_FC2CCCCC4E870288_OFFSET))(a1, a2);
		}
