...
#define RPG_GAMECORE_TARGETFETCHPASSIVEENTITY_METHOD_4_5552BE9E63AE5870_OFFSET UNITYSDK_OFFSET(0x18EDF460)
#define RPG_GAMECORE_TARGETFETCHPASSIVEENTITY_METHOD_4_9BC4595DDD3D41C2_OFFSET UNITYSDK_OFFSET(0x18EE5600)
#define RPG_GAMECORE_TARGETFETCHPASSIVEENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x18EDF410)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchPassiveEntity_TypeDefinitionIndex = 22906;
