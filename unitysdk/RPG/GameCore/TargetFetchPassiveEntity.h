...
#define RPG_GAMECORE_TARGETFETCHPASSIVEENTITY_METHOD_4_5552BE9E63AE5870_OFFSET UNITYSDK_OFFSET(0x1D5ADAE0)
#define RPG_GAMECORE_TARGETFETCHPASSIVEENTITY_METHOD_4_632F01B6FB57A2F5_OFFSET UNITYSDK_OFFSET(0x1D5ADA60)
#define RPG_GAMECORE_TARGETFETCHPASSIVEENTITY_METHOD_4_675BCBC480629A48_OFFSET UNITYSDK_OFFSET(0x1D5ADB60)
#define RPG_GAMECORE_TARGETFETCHPASSIVEENTITY_METHOD_4_9D7B497A57475F95_OFFSET UNITYSDK_OFFSET(0x1D5ADB40)
#define RPG_GAMECORE_TARGETFETCHPASSIVEENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5ADAD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchPassiveEntity_TypeDefinitionIndex = 23640;
