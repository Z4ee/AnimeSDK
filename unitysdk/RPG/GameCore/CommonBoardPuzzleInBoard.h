...
#define RPG_GAMECORE_COMMONBOARDPUZZLEINBOARD_METHOD_3_181EF509ACEAD108_OFFSET UNITYSDK_OFFSET(0x18827830)
#define RPG_GAMECORE_COMMONBOARDPUZZLEINBOARD_METHOD_3_9647A17B86F81CC3_OFFSET UNITYSDK_OFFSET(0x188277B0)
#define RPG_GAMECORE_COMMONBOARDPUZZLEINBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x18827800)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CommonBoardPuzzleInBoard_TypeDefinitionIndex = 20874;
