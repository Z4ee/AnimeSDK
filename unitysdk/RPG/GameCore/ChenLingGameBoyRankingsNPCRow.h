...
#define RPG_GAMECORE_CHENLINGGAMEBOYRANKINGSNPCROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x187EC880)
#define RPG_GAMECORE_CHENLINGGAMEBOYRANKINGSNPCROW__CTOR_OFFSET UNITYSDK_OFFSET(0x187ECB10)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 NPCScore; // 0x28
		::System::UInt32 GameBoyRankingsNPCID; // 0x2C
