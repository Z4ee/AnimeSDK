...
#define RPG_GAMECORE_CHENLINGGAMEBOYRANKINGSNPCROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17087770)
#define RPG_GAMECORE_CHENLINGGAMEBOYRANKINGSNPCROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17087A00)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 GameBoyRankingsNPCID; // 0x38
		::System::UInt32 NPCScore; // 0x3C
