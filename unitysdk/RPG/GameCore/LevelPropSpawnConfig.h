...
#define RPG_GAMECORE_LEVELPROPSPAWNCONFIG_METHOD_3_89CCEF482ABDBF19_OFFSET UNITYSDK_OFFSET(0x19889400)
#define RPG_GAMECORE_LEVELPROPSPAWNCONFIG_METHOD_3_DF52097FA33DEEA2_OFFSET UNITYSDK_OFFSET(0x19889760)
#define RPG_GAMECORE_LEVELPROPSPAWNCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19889750)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPropSpawnConfig_TypeDefinitionIndex = 16408;
