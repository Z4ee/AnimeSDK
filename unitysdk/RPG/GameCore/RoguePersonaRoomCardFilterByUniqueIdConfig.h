...
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYUNIQUEIDCONFIG_METHOD_3_882627E56C5C6DBB_OFFSET UNITYSDK_OFFSET(0x19BBA000)
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYUNIQUEIDCONFIG_METHOD_3_ED0068833E37673F_OFFSET UNITYSDK_OFFSET(0x19BB9D10)
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYUNIQUEIDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19BB9D00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RoguePersonaRoomCardFilterByUniqueIdConfig_TypeDefinitionIndex = 18829;
