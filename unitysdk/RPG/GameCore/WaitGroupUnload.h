...
#define RPG_GAMECORE_WAITGROUPUNLOAD_METHOD_3_57639384934FD674_OFFSET UNITYSDK_OFFSET(0x178FBF30)
#define RPG_GAMECORE_WAITGROUPUNLOAD_METHOD_3_9A1AD4171DD0F4E5_OFFSET UNITYSDK_OFFSET(0x178FBFB0)
#define RPG_GAMECORE_WAITGROUPUNLOAD__CTOR_OFFSET UNITYSDK_OFFSET(0x178FBF80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitGroupUnload_TypeDefinitionIndex = 19529;
