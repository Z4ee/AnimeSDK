...
#define RPG_GAMECORE_SHAREDSTRING_EQUALS_OFFSET UNITYSDK_OFFSET(0x1D51C570)
#define RPG_GAMECORE_SHAREDSTRING_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1D51C5D0)
#define RPG_GAMECORE_SHAREDSTRING_METHOD_3_1313316A5B8C7FBD_OFFSET UNITYSDK_OFFSET(0x1D51C430)
#define RPG_GAMECORE_SHAREDSTRING_METHOD_3_85D22C255258C41D_OFFSET UNITYSDK_OFFSET(0x1D51C560)
#define RPG_GAMECORE_SHAREDSTRING_METHOD_3_CB9B8324D70328E2_OFFSET UNITYSDK_OFFSET(0x1D51C470)
#define RPG_GAMECORE_SHAREDSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1D51C460)
