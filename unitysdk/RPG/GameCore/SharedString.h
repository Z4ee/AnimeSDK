...
#define RPG_GAMECORE_SHAREDSTRING_EQUALS_OFFSET UNITYSDK_OFFSET(0x1BE33510)
#define RPG_GAMECORE_SHAREDSTRING_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1BE33570)
#define RPG_GAMECORE_SHAREDSTRING_METHOD_3_1313316A5B8C7FBD_OFFSET UNITYSDK_OFFSET(0x1BE333D0)
#define RPG_GAMECORE_SHAREDSTRING_METHOD_3_85D22C255258C41D_OFFSET UNITYSDK_OFFSET(0x1BE33500)
#define RPG_GAMECORE_SHAREDSTRING_METHOD_3_CB9B8324D70328E2_OFFSET UNITYSDK_OFFSET(0x1BE33410)
#define RPG_GAMECORE_SHAREDSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE33400)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SharedString_TypeDefinitionIndex = 17573;
