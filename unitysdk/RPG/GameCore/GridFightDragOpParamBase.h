...
#define RPG_GAMECORE_GRIDFIGHTDRAGOPPARAMBASE_METHOD_2_1898AA7628FA7EBD_OFFSET UNITYSDK_OFFSET(0x1D965F30)
#define RPG_GAMECORE_GRIDFIGHTDRAGOPPARAMBASE_METHOD_2_26B8CA4473F78B88_OFFSET UNITYSDK_OFFSET(0x1D966470)
#define RPG_GAMECORE_GRIDFIGHTDRAGOPPARAMBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D965D20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightDragOpParamBase_TypeDefinitionIndex = 19725;
