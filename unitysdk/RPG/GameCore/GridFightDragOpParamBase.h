...
#define RPG_GAMECORE_GRIDFIGHTDRAGOPPARAMBASE_METHOD_2_1898AA7628FA7EBD_OFFSET UNITYSDK_OFFSET(0x1C5C8240)
#define RPG_GAMECORE_GRIDFIGHTDRAGOPPARAMBASE_METHOD_2_26B8CA4473F78B88_OFFSET UNITYSDK_OFFSET(0x1C5C8780)
#define RPG_GAMECORE_GRIDFIGHTDRAGOPPARAMBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5C8030)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightDragOpParamBase_TypeDefinitionIndex = 19184;
