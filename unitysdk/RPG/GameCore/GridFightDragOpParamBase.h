...
#define RPG_GAMECORE_GRIDFIGHTDRAGOPPARAMBASE_METHOD_2_1898AA7628FA7EBD_OFFSET UNITYSDK_OFFSET(0x197E06D0)
#define RPG_GAMECORE_GRIDFIGHTDRAGOPPARAMBASE_METHOD_2_26B8CA4473F78B88_OFFSET UNITYSDK_OFFSET(0x197E0C10)
#define RPG_GAMECORE_GRIDFIGHTDRAGOPPARAMBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x197E04C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightDragOpParamBase_TypeDefinitionIndex = 18834;
