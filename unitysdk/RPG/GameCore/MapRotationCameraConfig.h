...
#define RPG_GAMECORE_MAPROTATIONCAMERACONFIG_METHOD_2_FE2972EEAE53C97D_OFFSET UNITYSDK_OFFSET(0x198C0BD0)
#define RPG_GAMECORE_MAPROTATIONCAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x198C0D20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MapRotationCameraConfig_TypeDefinitionIndex = 16167;
