...
#define RPG_GAMECORE_STATICPROJECTILEDATA_METHOD_3_173256C9FD49E36E_OFFSET UNITYSDK_OFFSET(0x1D56A800)
#define RPG_GAMECORE_STATICPROJECTILEDATA_METHOD_3_E4D92800DEEA8B71_OFFSET UNITYSDK_OFFSET(0x1D56A870)
#define RPG_GAMECORE_STATICPROJECTILEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1D56A850)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StaticProjectileData_TypeDefinitionIndex = 15487;
