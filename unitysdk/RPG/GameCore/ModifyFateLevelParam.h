...
#define RPG_GAMECORE_MODIFYFATELEVELPARAM_METHOD_3_2B63569881989351_OFFSET UNITYSDK_OFFSET(0x17431380)
#define RPG_GAMECORE_MODIFYFATELEVELPARAM_METHOD_3_8CA807F7DEA4F36A_OFFSET UNITYSDK_OFFSET(0x174312F0)
#define RPG_GAMECORE_MODIFYFATELEVELPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x17431350)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyFateLevelParam_TypeDefinitionIndex = 21527;
