...
#define RPG_GAMECORE_MODIFYFATELEVELPARAM_METHOD_3_2B63569881989351_OFFSET UNITYSDK_OFFSET(0x1D2B5310)
#define RPG_GAMECORE_MODIFYFATELEVELPARAM_METHOD_3_F7A73482A0F0C884_OFFSET UNITYSDK_OFFSET(0x1D2B52C0)
#define RPG_GAMECORE_MODIFYFATELEVELPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2B5300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyFateLevelParam_TypeDefinitionIndex = 23024;
