...
#define RPG_GAMECORE_TURNINSERTABILITYCONDITIONGROUP_METHOD_3_B0736C7AC55E0F5E_OFFSET UNITYSDK_OFFSET(0x190D36F0)
#define RPG_GAMECORE_TURNINSERTABILITYCONDITIONGROUP_METHOD_3_D4253C52C3A5DD89_OFFSET UNITYSDK_OFFSET(0x190D35A0)
#define RPG_GAMECORE_TURNINSERTABILITYCONDITIONGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x190D3590)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TurnInsertAbilityConditionGroup_TypeDefinitionIndex = 17340;
