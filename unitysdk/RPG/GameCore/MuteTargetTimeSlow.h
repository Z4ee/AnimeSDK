...
#define RPG_GAMECORE_MUTETARGETTIMESLOW_METHOD_3_54D88A3432B70A78_OFFSET UNITYSDK_OFFSET(0x1746AA50)
#define RPG_GAMECORE_MUTETARGETTIMESLOW_METHOD_3_58A07545469F2B7A_OFFSET UNITYSDK_OFFSET(0x1746AAD0)
#define RPG_GAMECORE_MUTETARGETTIMESLOW__CTOR_OFFSET UNITYSDK_OFFSET(0x1746AAA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MuteTargetTimeSlow_TypeDefinitionIndex = 22103;
