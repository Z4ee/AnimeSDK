...
#define RPG_GAMECORE_BYPAMCURRENTACTIONANYDIRECTION_METHOD_4_5320EA8EFD2E9C7A_OFFSET UNITYSDK_OFFSET(0x1875C270)
#define RPG_GAMECORE_BYPAMCURRENTACTIONANYDIRECTION_METHOD_4_8FA2E9E56FF4D4A0_OFFSET UNITYSDK_OFFSET(0x1875C340)
#define RPG_GAMECORE_BYPAMCURRENTACTIONANYDIRECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1875C2F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByPamCurrentActionAnyDirection_TypeDefinitionIndex = 18936;
