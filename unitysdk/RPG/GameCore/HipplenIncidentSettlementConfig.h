...
#define RPG_GAMECORE_HIPPLENINCIDENTSETTLEMENTCONFIG_METHOD_2_CB4A8653690E2D25_OFFSET UNITYSDK_OFFSET(0x19835240)
#define RPG_GAMECORE_HIPPLENINCIDENTSETTLEMENTCONFIG_METHOD_2_EBF485A848324438_OFFSET UNITYSDK_OFFSET(0x198363F0)
#define RPG_GAMECORE_HIPPLENINCIDENTSETTLEMENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19836220)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HipplenIncidentSettlementConfig_TypeDefinitionIndex = 15959;
