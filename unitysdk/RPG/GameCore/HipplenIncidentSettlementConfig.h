...
#define RPG_GAMECORE_HIPPLENINCIDENTSETTLEMENTCONFIG_METHOD_2_CB4A8653690E2D25_OFFSET UNITYSDK_OFFSET(0x18A02D60)
#define RPG_GAMECORE_HIPPLENINCIDENTSETTLEMENTCONFIG_METHOD_2_EBF485A848324438_OFFSET UNITYSDK_OFFSET(0x18A03F90)
#define RPG_GAMECORE_HIPPLENINCIDENTSETTLEMENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18A03DC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HipplenIncidentSettlementConfig_TypeDefinitionIndex = 15906;
