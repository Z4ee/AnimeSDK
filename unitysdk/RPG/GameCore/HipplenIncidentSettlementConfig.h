...
#define RPG_GAMECORE_HIPPLENINCIDENTSETTLEMENTCONFIG_METHOD_2_CB4A8653690E2D25_OFFSET UNITYSDK_OFFSET(0x172AE140)
#define RPG_GAMECORE_HIPPLENINCIDENTSETTLEMENTCONFIG_METHOD_2_EBF485A848324438_OFFSET UNITYSDK_OFFSET(0x172AF370)
#define RPG_GAMECORE_HIPPLENINCIDENTSETTLEMENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x172AF1A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HipplenIncidentSettlementConfig_TypeDefinitionIndex = 15386;
