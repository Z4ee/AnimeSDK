...
#define RPG_GAMECORE_LEVELPERFORMANCEINITIALIZE_METHOD_3_2185171878718EA4_OFFSET UNITYSDK_OFFSET(0x1D1EBBC0)
#define RPG_GAMECORE_LEVELPERFORMANCEINITIALIZE_METHOD_3_928E03256D5FF253_OFFSET UNITYSDK_OFFSET(0x1D1EB0F0)
#define RPG_GAMECORE_LEVELPERFORMANCEINITIALIZE_METHOD_3_C91E5170F9E36EED_OFFSET UNITYSDK_OFFSET(0x1D1EBBD0)
#define RPG_GAMECORE_LEVELPERFORMANCEINITIALIZE_METHOD_3_D2D95C0CA1B2CE9C_OFFSET UNITYSDK_OFFSET(0x1D1EB160)
#define RPG_GAMECORE_LEVELPERFORMANCEINITIALIZE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1EB140)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPerformanceInitialize_TypeDefinitionIndex = 21608;
	...
	public:
		...
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::LevelPerformanceInitialize*))((::PBYTE)hIl2Cpp + RPG_GAMECORE_LEVELPERFORMANCEINITIALIZE_METHOD_3_D2D95C0CA1B2CE9C_OFFSET))(a1, a2);
		}
