...
#define RPG_GAMECORE_SETDYNAMICVALUEBYMOSTAVATARBASETYPEMEMBERCOUNT_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1C2E4E70)
#define RPG_GAMECORE_SETDYNAMICVALUEBYMOSTAVATARBASETYPEMEMBERCOUNT_METHOD_4_BCF2CB6165DC4B5B_OFFSET UNITYSDK_OFFSET(0x1C2E4C80)
#define RPG_GAMECORE_SETDYNAMICVALUEBYMOSTAVATARBASETYPEMEMBERCOUNT_METHOD_4_DB1DF53B95A6852E_OFFSET UNITYSDK_OFFSET(0x1C2E4C30)
#define RPG_GAMECORE_SETDYNAMICVALUEBYMOSTAVATARBASETYPEMEMBERCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2E4C70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByMostAvatarBaseTypeMemberCount_TypeDefinitionIndex = 22746;
