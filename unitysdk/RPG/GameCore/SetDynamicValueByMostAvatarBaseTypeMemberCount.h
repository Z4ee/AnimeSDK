...
#define RPG_GAMECORE_SETDYNAMICVALUEBYMOSTAVATARBASETYPEMEMBERCOUNT_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x18E243B0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYMOSTAVATARBASETYPEMEMBERCOUNT_METHOD_4_012B74C35A422E83_OFFSET UNITYSDK_OFFSET(0x18E240E0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYMOSTAVATARBASETYPEMEMBERCOUNT_METHOD_4_BCF2CB6165DC4B5B_OFFSET UNITYSDK_OFFSET(0x18E241C0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYMOSTAVATARBASETYPEMEMBERCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x18E24160)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByMostAvatarBaseTypeMemberCount_TypeDefinitionIndex = 22568;
