...
#define RPG_GAMECORE_FATECONDLINEUPHASAVATARCONFIG_METHOD_6_087072B9C70D5828_OFFSET UNITYSDK_OFFSET(0x171C4720)
#define RPG_GAMECORE_FATECONDLINEUPHASAVATARCONFIG_METHOD_6_820B1F3CB77484CC_OFFSET UNITYSDK_OFFSET(0x171C48E0)
#define RPG_GAMECORE_FATECONDLINEUPHASAVATARCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171C4820)
