...
#define RPG_GAMECORE_FATECONDLINEUPHASAVATARCONFIG_METHOD_6_087072B9C70D5828_OFFSET UNITYSDK_OFFSET(0x188D1EF0)
#define RPG_GAMECORE_FATECONDLINEUPHASAVATARCONFIG_METHOD_6_820B1F3CB77484CC_OFFSET UNITYSDK_OFFSET(0x188D20B0)
#define RPG_GAMECORE_FATECONDLINEUPHASAVATARCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x188D1FF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateCondLineupHasAvatarConfig_TypeDefinitionIndex = 18288;
