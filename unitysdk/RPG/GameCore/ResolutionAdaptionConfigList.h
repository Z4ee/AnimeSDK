...
#define RPG_GAMECORE_RESOLUTIONADAPTIONCONFIGLIST_METHOD_2_821C742B91CB6BA6_OFFSET UNITYSDK_OFFSET(0x1DB954F0)
#define RPG_GAMECORE_RESOLUTIONADAPTIONCONFIGLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB955D0)
