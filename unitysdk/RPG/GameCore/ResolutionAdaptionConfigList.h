...
#define RPG_GAMECORE_RESOLUTIONADAPTIONCONFIGLIST_METHOD_2_821C742B91CB6BA6_OFFSET UNITYSDK_OFFSET(0x19AD1830)
#define RPG_GAMECORE_RESOLUTIONADAPTIONCONFIGLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x19AD1910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResolutionAdaptionConfigList_TypeDefinitionIndex = 16270;
