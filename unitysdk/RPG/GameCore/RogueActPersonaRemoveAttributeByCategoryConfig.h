...
#define RPG_GAMECORE_ROGUEACTPERSONAREMOVEATTRIBUTEBYCATEGORYCONFIG_METHOD_6_386F7F12E467BA4D_OFFSET UNITYSDK_OFFSET(0x1D02FDE0)
#define RPG_GAMECORE_ROGUEACTPERSONAREMOVEATTRIBUTEBYCATEGORYCONFIG_METHOD_6_A901AC9DC4027731_OFFSET UNITYSDK_OFFSET(0x1D02FE30)
#define RPG_GAMECORE_ROGUEACTPERSONAREMOVEATTRIBUTEBYCATEGORYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D02FE20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaRemoveAttributeByCategoryConfig_TypeDefinitionIndex = 19012;
