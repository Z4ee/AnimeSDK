...
#define RPG_GAMECORE_ROGUEACTPERSONAREMOVEATTRIBUTEBYCATEGORYCONFIG_METHOD_6_03D73C700B4C6A7C_OFFSET UNITYSDK_OFFSET(0x175C05E0)
#define RPG_GAMECORE_ROGUEACTPERSONAREMOVEATTRIBUTEBYCATEGORYCONFIG_METHOD_6_A901AC9DC4027731_OFFSET UNITYSDK_OFFSET(0x175C0800)
#define RPG_GAMECORE_ROGUEACTPERSONAREMOVEATTRIBUTEBYCATEGORYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175C0720)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaRemoveAttributeByCategoryConfig_TypeDefinitionIndex = 18124;
