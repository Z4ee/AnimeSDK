...
#define RPG_GAMECORE_SMELLPROPCONFIG_METHOD_2_FB7ED5B86124F5DB_OFFSET UNITYSDK_OFFSET(0x18E73E40)
#define RPG_GAMECORE_SMELLPROPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18E73FD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SmellPropConfig_TypeDefinitionIndex = 19469;
