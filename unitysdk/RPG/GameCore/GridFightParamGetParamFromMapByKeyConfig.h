...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETPARAMFROMMAPBYKEYCONFIG_METHOD_6_44964828CCFEABE6_OFFSET UNITYSDK_OFFSET(0x189C5ED0)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETPARAMFROMMAPBYKEYCONFIG_METHOD_6_52142AAE8EF1DC90_OFFSET UNITYSDK_OFFSET(0x189C5C20)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETPARAMFROMMAPBYKEYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189C5DA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightParamGetParamFromMapByKeyConfig_TypeDefinitionIndex = 18543;
