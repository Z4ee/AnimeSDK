...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETPARAMFROMMAPBYKEYCONFIG_METHOD_6_44964828CCFEABE6_OFFSET UNITYSDK_OFFSET(0x1D06DBA0)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETPARAMFROMMAPBYKEYCONFIG_METHOD_6_DE2078639E22D58A_OFFSET UNITYSDK_OFFSET(0x1D06DB50)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETPARAMFROMMAPBYKEYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D06DB90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightParamGetParamFromMapByKeyConfig_TypeDefinitionIndex = 18778;
