...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUESPECIFICMAGICUNITNUMPARAM_METHOD_4_1ED6CDE55E14BAA7_OFFSET UNITYSDK_OFFSET(0x18E27570)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUESPECIFICMAGICUNITNUMPARAM_METHOD_4_E9F0F53C35927697_OFFSET UNITYSDK_OFFSET(0x18E27600)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUESPECIFICMAGICUNITNUMPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x18E275D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRogueSpecificMagicUnitNumParam_TypeDefinitionIndex = 20648;
