...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUESPECIFICMAGICUNITNUMPARAM_METHOD_4_E9F0F53C35927697_OFFSET UNITYSDK_OFFSET(0x1C5F08F0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUESPECIFICMAGICUNITNUMPARAM_METHOD_4_F0E7EA49F396EC53_OFFSET UNITYSDK_OFFSET(0x1C5F08A0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUESPECIFICMAGICUNITNUMPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5F08E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRogueSpecificMagicUnitNumParam_TypeDefinitionIndex = 20996;
