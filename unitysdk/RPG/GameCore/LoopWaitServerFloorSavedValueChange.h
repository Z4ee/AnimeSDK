...
#define RPG_GAMECORE_LOOPWAITSERVERFLOORSAVEDVALUECHANGE_METHOD_3_A839BE1888729430_OFFSET UNITYSDK_OFFSET(0x1BCD4C80)
#define RPG_GAMECORE_LOOPWAITSERVERFLOORSAVEDVALUECHANGE_METHOD_3_F602185761CD823D_OFFSET UNITYSDK_OFFSET(0x1BCD4CC0)
#define RPG_GAMECORE_LOOPWAITSERVERFLOORSAVEDVALUECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCD4CB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoopWaitServerFloorSavedValueChange_TypeDefinitionIndex = 21440;
