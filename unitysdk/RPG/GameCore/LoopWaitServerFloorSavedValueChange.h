...
#define RPG_GAMECORE_LOOPWAITSERVERFLOORSAVEDVALUECHANGE_METHOD_3_CB559999FB3D3832_OFFSET UNITYSDK_OFFSET(0x198B2110)
#define RPG_GAMECORE_LOOPWAITSERVERFLOORSAVEDVALUECHANGE_METHOD_3_F602185761CD823D_OFFSET UNITYSDK_OFFSET(0x198B2180)
#define RPG_GAMECORE_LOOPWAITSERVERFLOORSAVEDVALUECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x198B2150)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoopWaitServerFloorSavedValueChange_TypeDefinitionIndex = 21025;
