...
#define RPG_GAMECORE_ADVNPCSOLDIERLINEUPPATROL_METHOD_3_3B9398D5AB6CBD28_OFFSET UNITYSDK_OFFSET(0x18657B30)
#define RPG_GAMECORE_ADVNPCSOLDIERLINEUPPATROL_METHOD_3_905B2F74C0AAF014_OFFSET UNITYSDK_OFFSET(0x18657C40)
#define RPG_GAMECORE_ADVNPCSOLDIERLINEUPPATROL__CTOR_OFFSET UNITYSDK_OFFSET(0x18657C10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvNPCSoldierLineupPatrol_TypeDefinitionIndex = 18922;
