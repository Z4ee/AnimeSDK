...
#define RPG_GAMECORE_ADVNPCSOLDIERLINEUPPATROL_METHOD_3_354522DBCBD6E651_OFFSET UNITYSDK_OFFSET(0x1D6BE2A0)
#define RPG_GAMECORE_ADVNPCSOLDIERLINEUPPATROL_METHOD_3_905B2F74C0AAF014_OFFSET UNITYSDK_OFFSET(0x1D6BE370)
#define RPG_GAMECORE_ADVNPCSOLDIERLINEUPPATROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6BE360)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvNPCSoldierLineupPatrol_TypeDefinitionIndex = 19768;
