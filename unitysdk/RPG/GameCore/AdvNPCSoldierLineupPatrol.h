...
#define RPG_GAMECORE_ADVNPCSOLDIERLINEUPPATROL_METHOD_3_3B9398D5AB6CBD28_OFFSET UNITYSDK_OFFSET(0x1942B620)
#define RPG_GAMECORE_ADVNPCSOLDIERLINEUPPATROL_METHOD_3_905B2F74C0AAF014_OFFSET UNITYSDK_OFFSET(0x1942B730)
#define RPG_GAMECORE_ADVNPCSOLDIERLINEUPPATROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1942B700)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvNPCSoldierLineupPatrol_TypeDefinitionIndex = 18877;
