...
#define RPG_GAMECORE_LEVELCHARACTERDEATHRATTLE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1BDF0690)
#define RPG_GAMECORE_LEVELCHARACTERDEATHRATTLE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x1BDF0640)
#define RPG_GAMECORE_LEVELCHARACTERDEATHRATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDF0630)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelCharacterDeathrattle_TypeDefinitionIndex = 54226;
