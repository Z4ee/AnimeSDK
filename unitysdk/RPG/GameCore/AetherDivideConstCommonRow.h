...
#define RPG_GAMECORE_AETHERDIVIDECONSTCOMMONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1945A910)
#define RPG_GAMECORE_AETHERDIVIDECONSTCOMMONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1945AED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AetherDivideConstCommonRow_TypeDefinitionIndex = 10517;
