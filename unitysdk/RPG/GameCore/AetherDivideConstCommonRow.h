...
#define RPG_GAMECORE_AETHERDIVIDECONSTCOMMONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1AE68FB0)
#define RPG_GAMECORE_AETHERDIVIDECONSTCOMMONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE69570)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AetherDivideConstCommonRow_TypeDefinitionIndex = 10565;

	class AetherDivideConstCommonRow : public ::System::Object
	{
	public:
		::System::String* ConstValueName; // 0x10
		::System::String* ConstValueType; // 0x18
