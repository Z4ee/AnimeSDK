...
#define RPG_GAMECORE_MUNICIPALCHATACTIONTALK_METHOD_3_3FB1B2B8AB5E6787_OFFSET UNITYSDK_OFFSET(0x199B7B90)
#define RPG_GAMECORE_MUNICIPALCHATACTIONTALK_METHOD_3_F180BF31A3FF819E_OFFSET UNITYSDK_OFFSET(0x199B7E70)
#define RPG_GAMECORE_MUNICIPALCHATACTIONTALK__CTOR_OFFSET UNITYSDK_OFFSET(0x199B7B80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MunicipalChatActionTalk_TypeDefinitionIndex = 16063;
