...
#define RPG_GAMECORE_RUANMADECAKEFEATURE_EYEDECAL_METHOD_3_3E16CDF6DCC7144B_OFFSET UNITYSDK_OFFSET(0x1B772460)
#define RPG_GAMECORE_RUANMADECAKEFEATURE_EYEDECAL_METHOD_3_CB833E12B8B4E3D6_OFFSET UNITYSDK_OFFSET(0x1B772D40)
#define RPG_GAMECORE_RUANMADECAKEFEATURE_EYEDECAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B772450)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RuanMadeCakeFeature_EyeDecal_TypeDefinitionIndex = 16769;
