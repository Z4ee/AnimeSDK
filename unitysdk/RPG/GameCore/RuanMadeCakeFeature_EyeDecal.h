...
#define RPG_GAMECORE_RUANMADECAKEFEATURE_EYEDECAL_METHOD_3_5FE526E169083760_OFFSET UNITYSDK_OFFSET(0x17678A60)
#define RPG_GAMECORE_RUANMADECAKEFEATURE_EYEDECAL_METHOD_3_81F6D9FC991077E9_OFFSET UNITYSDK_OFFSET(0x17679330)
#define RPG_GAMECORE_RUANMADECAKEFEATURE_EYEDECAL__CTOR_OFFSET UNITYSDK_OFFSET(0x17678A50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RuanMadeCakeFeature_EyeDecal_TypeDefinitionIndex = 16048;
