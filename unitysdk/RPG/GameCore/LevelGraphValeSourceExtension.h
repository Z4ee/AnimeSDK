...
#define RPG_GAMECORE_LEVELGRAPHVALESOURCEEXTENSION_WRITETOCUSTOMDATA_OFFSET UNITYSDK_OFFSET(0x1BDFE470)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelGraphValeSourceExtension_TypeDefinitionIndex = 55199;
