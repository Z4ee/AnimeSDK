...
#define RPG_GAMECORE_GRIDFIGHTEQUIPCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x189A9BC0)
#define RPG_GAMECORE_GRIDFIGHTEQUIPCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x189AA180)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightEquipConfigRow_TypeDefinitionIndex = 12723;

	class GridFightEquipConfigRow : public ::System::Object
	{
	public:
		::Il2CppArray<::System::UInt32>* DressRuleParamList; // 0x10
		::Il2CppArray<::RPG::GameCore::AvatarPropertyValue*>* GeneralPropertyList; // 0x18
		::Il2CppArray<::RPG::GameCore::FixPoint>* ParamList; // 0x20
		::Il2CppArray<::System::UInt32>* EquipFuncParamList; // 0x28
		::Il2CppArray<::RPG::GameCore::FixPoint>* EffectParamList; // 0x30
		::Il2CppArray<::System::UInt32>* EquipmentTagList; // 0x38
		::System::String* AbilityName; // 0x40
		::System::String* JsonPath; // 0x48
		::System::Boolean IsDisplaySpecialParam; // 0x50
		::RPG::GameCore::GridFightEquipDressType DressRule; // 0x54
		::RPG::GameCore::GridFightEquipCategory EquipCategory; // 0x58
		::RPG::GameCore::GridFightEquipFuncType EquipFunc; // 0x5C
		::System::UInt32 ID; // 0x60
		::RPG::GameCore::GridFightEquipType EquipType; // 0x64
