...
#define RPG_GAMECORE_GRIDFIGHTEQUIPCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D151770)
#define RPG_GAMECORE_GRIDFIGHTEQUIPCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D151D00)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID EquipDesc; // 0x58
		::System::Boolean IsDisplaySpecialParam; // 0x68
		::RPG::GameCore::GridFightEquipFuncType EquipFunc; // 0x6C
		::RPG::GameCore::GridFightEquipDressType DressRule; // 0x70
