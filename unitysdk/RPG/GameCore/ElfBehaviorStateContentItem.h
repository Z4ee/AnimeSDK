...
#define RPG_GAMECORE_ELFBEHAVIORSTATECONTENTITEM_METHOD_2_3C72CDA77989E100_OFFSET UNITYSDK_OFFSET(0x18899B80)
#define RPG_GAMECORE_ELFBEHAVIORSTATECONTENTITEM_METHOD_2_ACBFF3E49E74258D_OFFSET UNITYSDK_OFFSET(0x18899CF0)
#define RPG_GAMECORE_ELFBEHAVIORSTATECONTENTITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x18899CE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfBehaviorStateContentItem_TypeDefinitionIndex = 17570;
