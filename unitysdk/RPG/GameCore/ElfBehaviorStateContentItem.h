...
#define RPG_GAMECORE_ELFBEHAVIORSTATECONTENTITEM_METHOD_2_3C72CDA77989E100_OFFSET UNITYSDK_OFFSET(0x1BB34B10)
#define RPG_GAMECORE_ELFBEHAVIORSTATECONTENTITEM_METHOD_2_ACBFF3E49E74258D_OFFSET UNITYSDK_OFFSET(0x1BB34C90)
#define RPG_GAMECORE_ELFBEHAVIORSTATECONTENTITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB34C80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfBehaviorStateContentItem_TypeDefinitionIndex = 17769;
