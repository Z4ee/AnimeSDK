...
#define RPG_GAMECORE_DEBATEINITIALIZE_METHOD_3_DADB58A4A01B8089_OFFSET UNITYSDK_OFFSET(0x1714C770)
#define RPG_GAMECORE_DEBATEINITIALIZE_METHOD_3_DF1CE82327C7B358_OFFSET UNITYSDK_OFFSET(0x1714C6D0)
#define RPG_GAMECORE_DEBATEINITIALIZE__CTOR_OFFSET UNITYSDK_OFFSET(0x1714C730)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DebateInitialize_TypeDefinitionIndex = 20101;
