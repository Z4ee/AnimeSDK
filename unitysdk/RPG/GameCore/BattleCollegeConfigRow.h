...
#define RPG_GAMECORE_BATTLECOLLEGECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x194C4910)
#define RPG_GAMECORE_BATTLECOLLEGECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x194C4E20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleCollegeConfigRow_TypeDefinitionIndex = 12219;
	...
	public:
		...
		::System::UInt32 StageIntroDescIDList; // 0x28
		...
		::System::UInt32 VideoAssetID; // 0x64
