...
#define RPG_GAMECORE_BATTLECOLLEGECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16FCD770)
#define RPG_GAMECORE_BATTLECOLLEGECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16FCDC90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleCollegeConfigRow_TypeDefinitionIndex = 11717;

	class BattleCollegeConfigRow : public ::System::Object
	{
	public:
		::System::String* VideoCoverPath; // 0x10
		::Il2CppArray<::System::UInt32>* AimList; // 0x18
		::Il2CppArray<::System::UInt32>* TrialAvatarList; // 0x20
		::RPG::Client::TextID StageIntroTitle; // 0x28
		...
		::System::UInt32 TutorialTypeGroupID; // 0x50
		::System::UInt32 BattleAreaGroupID; // 0x54
		::System::UInt32 VideoAssetID; // 0x58
		::System::UInt32 StageIntroDescIDList; // 0x5C
