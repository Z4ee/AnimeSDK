...
#define RPG_GAMECORE_BATTLECOLLEGECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B2F24F0)
#define RPG_GAMECORE_BATTLECOLLEGECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2F2A00)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 BattleAreaGroupID; // 0x2C
		::System::UInt32 StageIntroDescIDList; // 0x30
		::System::UInt32 RewardID; // 0x34
		::System::UInt32 ID; // 0x38
		::System::UInt32 FloorID; // 0x3C
		::System::UInt32 TutorialID; // 0x40
		::System::UInt32 SortID; // 0x44
		::RPG::Client::TextID StageIntroTitle; // 0x48
		::System::UInt32 BattleAreaID; // 0x58
		::System::UInt32 StageID; // 0x5C
		::System::UInt32 VideoAssetID; // 0x60
		::System::UInt32 TutorialTypeGroupID; // 0x64
