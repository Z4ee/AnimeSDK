...
#define RPG_GAMECORE_LEVELAUDIOSTATE_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1C10D240)
#define RPG_GAMECORE_LEVELAUDIOSTATE_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C10D200)
#define RPG_GAMECORE_LEVELAUDIOSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C10D230)
