...
#define RPG_GAMECORE_LEVELAUDIOSTATE_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1B02DD00)
#define RPG_GAMECORE_LEVELAUDIOSTATE_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B02DCC0)
#define RPG_GAMECORE_LEVELAUDIOSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B02DCF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelAudioState_TypeDefinitionIndex = 22937;
