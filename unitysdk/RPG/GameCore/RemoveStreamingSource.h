...
#define RPG_GAMECORE_REMOVESTREAMINGSOURCE_METHOD_3_75ACCDC09AE9214C_OFFSET UNITYSDK_OFFSET(0x1D0177A0)
#define RPG_GAMECORE_REMOVESTREAMINGSOURCE_METHOD_3_C87C8628700BEF07_OFFSET UNITYSDK_OFFSET(0x1D0177E0)
#define RPG_GAMECORE_REMOVESTREAMINGSOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0177D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveStreamingSource_TypeDefinitionIndex = 20444;
