...
#define RPG_GAMECORE_REMOVESTREAMINGSOURCE_METHOD_3_C87C8628700BEF07_OFFSET UNITYSDK_OFFSET(0x19ACA820)
#define RPG_GAMECORE_REMOVESTREAMINGSOURCE_METHOD_3_CE568906F0E65156_OFFSET UNITYSDK_OFFSET(0x19ACA7A0)
#define RPG_GAMECORE_REMOVESTREAMINGSOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x19ACA7F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveStreamingSource_TypeDefinitionIndex = 20072;
