...
#define RPG_GAMECORE_CHIMERADUELCHIMERACASTERATTRIBUTEDIVIDEVALUEGETTER_METHOD_3_8231EE155C4D0476_OFFSET UNITYSDK_OFFSET(0x187F6330)
#define RPG_GAMECORE_CHIMERADUELCHIMERACASTERATTRIBUTEDIVIDEVALUEGETTER_METHOD_3_95FF1CD4927A3308_OFFSET UNITYSDK_OFFSET(0x187F6390)
#define RPG_GAMECORE_CHIMERADUELCHIMERACASTERATTRIBUTEDIVIDEVALUEGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x187F6380)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelChimeraCasterAttributeDivideValueGetter_TypeDefinitionIndex = 15088;
