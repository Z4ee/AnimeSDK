...
#define RPG_GAMECORE_CHIMERADUELCHIMERACASTERATTRIBUTEDIVIDEVALUEGETTER_METHOD_3_8231EE155C4D0476_OFFSET UNITYSDK_OFFSET(0x17096D80)
#define RPG_GAMECORE_CHIMERADUELCHIMERACASTERATTRIBUTEDIVIDEVALUEGETTER_METHOD_3_95FF1CD4927A3308_OFFSET UNITYSDK_OFFSET(0x17096DE0)
#define RPG_GAMECORE_CHIMERADUELCHIMERACASTERATTRIBUTEDIVIDEVALUEGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x17096DD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelChimeraCasterAttributeDivideValueGetter_TypeDefinitionIndex = 14618;
