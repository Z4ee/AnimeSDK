...
#define RPG_GAMECORE_STARTRESHASCENESELECTION_METHOD_3_17260249546673F2_OFFSET UNITYSDK_OFFSET(0x17775FD0)
#define RPG_GAMECORE_STARTRESHASCENESELECTION_METHOD_3_271E63C111150FCB_OFFSET UNITYSDK_OFFSET(0x17775F50)
#define RPG_GAMECORE_STARTRESHASCENESELECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x17775FA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StartReShaSceneSelection_TypeDefinitionIndex = 20204;
