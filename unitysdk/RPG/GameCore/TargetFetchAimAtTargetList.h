...
#define RPG_GAMECORE_TARGETFETCHAIMATTARGETLIST_METHOD_4_69AB294BA9E0E41D_OFFSET UNITYSDK_OFFSET(0x1D0B6870)
#define RPG_GAMECORE_TARGETFETCHAIMATTARGETLIST_METHOD_4_7C11CF74121445EE_OFFSET UNITYSDK_OFFSET(0x1D0B68C0)
#define RPG_GAMECORE_TARGETFETCHAIMATTARGETLIST_METHOD_4_92423D26C6CD30E4_OFFSET UNITYSDK_OFFSET(0x1D0B6960)
#define RPG_GAMECORE_TARGETFETCHAIMATTARGETLIST_METHOD_4_95F670F5EACD7374_OFFSET UNITYSDK_OFFSET(0x1D0B69A0)
#define RPG_GAMECORE_TARGETFETCHAIMATTARGETLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0B68B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchAimAtTargetList_TypeDefinitionIndex = 23174;
