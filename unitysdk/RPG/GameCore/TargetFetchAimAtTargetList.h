...
#define RPG_GAMECORE_TARGETFETCHAIMATTARGETLIST_METHOD_4_4279B81DCECDD3CA_OFFSET UNITYSDK_OFFSET(0x18EE2CC0)
#define RPG_GAMECORE_TARGETFETCHAIMATTARGETLIST_METHOD_4_7C11CF74121445EE_OFFSET UNITYSDK_OFFSET(0x18EDA820)
#define RPG_GAMECORE_TARGETFETCHAIMATTARGETLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x18EDA7D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchAimAtTargetList_TypeDefinitionIndex = 23018;
