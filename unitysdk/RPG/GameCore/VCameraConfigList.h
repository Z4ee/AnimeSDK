...
#define RPG_GAMECORE_VCAMERACONFIGLIST_METHOD_2_6BFD12A4FF85E4C7_OFFSET UNITYSDK_OFFSET(0x1D2B8F50)
#define RPG_GAMECORE_VCAMERACONFIGLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2B9030)
