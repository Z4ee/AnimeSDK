...
#define RPG_GAMECORE_VCAMERACONFIGLIST_METHOD_2_025058B3BA67D86D_OFFSET UNITYSDK_OFFSET(0x178ECEC0)
#define RPG_GAMECORE_VCAMERACONFIGLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x178ECF90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VCameraConfigList_TypeDefinitionIndex = 15053;
