...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETCURCAMPIDCONFIG_METHOD_6_858F58C4D19FB967_OFFSET UNITYSDK_OFFSET(0x1726E8A0)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETCURCAMPIDCONFIG_METHOD_6_BF1200E99E67E0B1_OFFSET UNITYSDK_OFFSET(0x1726E5F0)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETCURCAMPIDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1726E770)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightParamGetCurCampIdConfig_TypeDefinitionIndex = 17905;
