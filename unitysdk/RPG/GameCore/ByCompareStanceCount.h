...
#define RPG_GAMECORE_BYCOMPARESTANCECOUNT_METHOD_4_3B18B028373F0FAD_OFFSET UNITYSDK_OFFSET(0x1A8A7C50)
#define RPG_GAMECORE_BYCOMPARESTANCECOUNT_METHOD_4_46A8ED4DD0560684_OFFSET UNITYSDK_OFFSET(0x1A8A7C10)
#define RPG_GAMECORE_BYCOMPARESTANCECOUNT_METHOD_4_4A4E99C75BB354CF_OFFSET UNITYSDK_OFFSET(0x1A8A7E80)
#define RPG_GAMECORE_BYCOMPARESTANCECOUNT_METHOD_4_8F96967624C5AEF1_OFFSET UNITYSDK_OFFSET(0x1A8A7EB0)
#define RPG_GAMECORE_BYCOMPARESTANCECOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8A7C40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareStanceCount_TypeDefinitionIndex = 22645;
