...
#define RPG_GAMECORE_BYCOMPARESTANCECOUNT_METHOD_4_09851FBB9E7342DF_OFFSET UNITYSDK_OFFSET(0x1873CE40)
#define RPG_GAMECORE_BYCOMPARESTANCECOUNT_METHOD_4_3B18B028373F0FAD_OFFSET UNITYSDK_OFFSET(0x1873CF10)
#define RPG_GAMECORE_BYCOMPARESTANCECOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1873CEC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareStanceCount_TypeDefinitionIndex = 22459;
