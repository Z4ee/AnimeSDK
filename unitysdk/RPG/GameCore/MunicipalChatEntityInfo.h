...
#define RPG_GAMECORE_MUNICIPALCHATENTITYINFO_METHOD_3_68A42E3239BB9FCD_OFFSET UNITYSDK_OFFSET(0x1745C1A0)
#define RPG_GAMECORE_MUNICIPALCHATENTITYINFO_METHOD_3_9CB2D5741F5C4562_OFFSET UNITYSDK_OFFSET(0x1745C160)
#define RPG_GAMECORE_MUNICIPALCHATENTITYINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1745C190)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MunicipalChatEntityInfo_TypeDefinitionIndex = 15503;
