...
#define RPG_GAMECORE_MUNICIPALCHATENTITYINFO_METHOD_3_68A42E3239BB9FCD_OFFSET UNITYSDK_OFFSET(0x18B68EA0)
#define RPG_GAMECORE_MUNICIPALCHATENTITYINFO_METHOD_3_9CB2D5741F5C4562_OFFSET UNITYSDK_OFFSET(0x18B68E60)
#define RPG_GAMECORE_MUNICIPALCHATENTITYINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18B68E90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MunicipalChatEntityInfo_TypeDefinitionIndex = 16023;
