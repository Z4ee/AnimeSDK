...
#define RPG_GAMECORE_RETURNTOLOGINPAGE_METHOD_3_4DFD58737D6CA75E_OFFSET UNITYSDK_OFFSET(0x1D029D20)
#define RPG_GAMECORE_RETURNTOLOGINPAGE_METHOD_3_D2C7DF650B8A4C5D_OFFSET UNITYSDK_OFFSET(0x1D029D60)
#define RPG_GAMECORE_RETURNTOLOGINPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D029D50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ReturnToLoginPage_TypeDefinitionIndex = 20295;
