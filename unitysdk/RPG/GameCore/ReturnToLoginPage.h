...
#define RPG_GAMECORE_RETURNTOLOGINPAGE_METHOD_3_3AA903D156F462CC_OFFSET UNITYSDK_OFFSET(0x19ADD9C0)
#define RPG_GAMECORE_RETURNTOLOGINPAGE_METHOD_3_D2C7DF650B8A4C5D_OFFSET UNITYSDK_OFFSET(0x19ADDA40)
#define RPG_GAMECORE_RETURNTOLOGINPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x19ADDA10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ReturnToLoginPage_TypeDefinitionIndex = 19924;
