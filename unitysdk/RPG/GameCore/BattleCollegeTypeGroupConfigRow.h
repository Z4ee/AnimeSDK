...
#define RPG_GAMECORE_BATTLECOLLEGETYPEGROUPCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x194C5000)
#define RPG_GAMECORE_BATTLECOLLEGETYPEGROUPCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x194C52F0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Boolean IsAdvanced; // 0x30
