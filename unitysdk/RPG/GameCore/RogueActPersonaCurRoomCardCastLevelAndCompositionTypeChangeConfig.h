...
#define RPG_GAMECORE_ROGUEACTPERSONACURROOMCARDCASTLEVELANDCOMPOSITIONTYPECHANGECONFIG_METHOD_7_5C33E16F83CB3D60_OFFSET UNITYSDK_OFFSET(0x1D02F0F0)
#define RPG_GAMECORE_ROGUEACTPERSONACURROOMCARDCASTLEVELANDCOMPOSITIONTYPECHANGECONFIG_METHOD_7_9B6BF618AA890224_OFFSET UNITYSDK_OFFSET(0x1D02F190)
#define RPG_GAMECORE_ROGUEACTPERSONACURROOMCARDCASTLEVELANDCOMPOSITIONTYPECHANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D02F0E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaCurRoomCardCastLevelAndCompositionTypeChangeConfig_TypeDefinitionIndex = 19005;
