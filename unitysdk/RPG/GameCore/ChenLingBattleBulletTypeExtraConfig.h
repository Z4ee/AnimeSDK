...
#define RPG_GAMECORE_CHENLINGBATTLEBULLETTYPEEXTRACONFIG_METHOD_2_06EECDD6DF72445D_OFFSET UNITYSDK_OFFSET(0x187E1C60)
#define RPG_GAMECORE_CHENLINGBATTLEBULLETTYPEEXTRACONFIG_METHOD_2_624A70F1B52DB429_OFFSET UNITYSDK_OFFSET(0x187E1E70)
#define RPG_GAMECORE_CHENLINGBATTLEBULLETTYPEEXTRACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x187E1A80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleBulletTypeExtraConfig_TypeDefinitionIndex = 14876;
