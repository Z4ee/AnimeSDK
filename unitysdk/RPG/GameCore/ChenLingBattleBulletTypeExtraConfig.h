...
#define RPG_GAMECORE_CHENLINGBATTLEBULLETTYPEEXTRACONFIG_METHOD_2_06EECDD6DF72445D_OFFSET UNITYSDK_OFFSET(0x1707CDF0)
#define RPG_GAMECORE_CHENLINGBATTLEBULLETTYPEEXTRACONFIG_METHOD_2_624A70F1B52DB429_OFFSET UNITYSDK_OFFSET(0x1707D000)
#define RPG_GAMECORE_CHENLINGBATTLEBULLETTYPEEXTRACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1707CC10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleBulletTypeExtraConfig_TypeDefinitionIndex = 14406;
