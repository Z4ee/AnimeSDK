...
#define RPG_GAMECORE_LITTLEGAMELEVELVARIABLESTRING_METHOD_3_CFAD5163B4A3A243_OFFSET UNITYSDK_OFFSET(0x1735F5B0)
#define RPG_GAMECORE_LITTLEGAMELEVELVARIABLESTRING_METHOD_3_F641425DF31D4FDC_OFFSET UNITYSDK_OFFSET(0x1735FA30)
#define RPG_GAMECORE_LITTLEGAMELEVELVARIABLESTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1735F5A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameLevelVariableString_TypeDefinitionIndex = 17338;
