...
#define RPG_GAMECORE_LITTLEGAMELEVELVARIABLESTRING_METHOD_3_CFAD5163B4A3A243_OFFSET UNITYSDK_OFFSET(0x1D2045C0)
#define RPG_GAMECORE_LITTLEGAMELEVELVARIABLESTRING_METHOD_3_F641425DF31D4FDC_OFFSET UNITYSDK_OFFSET(0x1D204A50)
#define RPG_GAMECORE_LITTLEGAMELEVELVARIABLESTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2045B0)
