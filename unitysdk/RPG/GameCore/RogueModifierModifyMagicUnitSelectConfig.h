...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYMAGICUNITSELECTCONFIG_METHOD_3_6FD7073AF274B0EB_OFFSET UNITYSDK_OFFSET(0x1D163EE0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYMAGICUNITSELECTCONFIG_METHOD_3_B4D4BFF31B9D03EF_OFFSET UNITYSDK_OFFSET(0x1D163F30)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYMAGICUNITSELECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D163F20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyMagicUnitSelectConfig_TypeDefinitionIndex = 17013;
