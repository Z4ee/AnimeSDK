...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYMAGICUNITSELECTCONFIG_METHOD_3_A31C716AF9FC8F36_OFFSET UNITYSDK_OFFSET(0x19B5F7C0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYMAGICUNITSELECTCONFIG_METHOD_3_B4D4BFF31B9D03EF_OFFSET UNITYSDK_OFFSET(0x19B55DE0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYMAGICUNITSELECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B55D90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyMagicUnitSelectConfig_TypeDefinitionIndex = 16851;
