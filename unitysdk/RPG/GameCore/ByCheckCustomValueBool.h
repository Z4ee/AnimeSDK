...
#define RPG_GAMECORE_BYCHECKCUSTOMVALUEBOOL_METHOD_4_08EA3F1BCFA8866B_OFFSET UNITYSDK_OFFSET(0x18721DF0)
#define RPG_GAMECORE_BYCHECKCUSTOMVALUEBOOL_METHOD_4_AF22C280DB8CEA93_OFFSET UNITYSDK_OFFSET(0x18721D20)
#define RPG_GAMECORE_BYCHECKCUSTOMVALUEBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x18721DA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckCustomValueBool_TypeDefinitionIndex = 21434;
