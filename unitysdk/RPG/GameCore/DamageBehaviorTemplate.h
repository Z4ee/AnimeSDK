...
#define RPG_GAMECORE_DAMAGEBEHAVIORTEMPLATE_GET_MUTEBUTTRIGGERBLOCKRESULT_OFFSET UNITYSDK_OFFSET(0x17146E20)
#define RPG_GAMECORE_DAMAGEBEHAVIORTEMPLATE_METHOD_2_4EB8D065532CCC58_OFFSET UNITYSDK_OFFSET(0x17146AF0)
#define RPG_GAMECORE_DAMAGEBEHAVIORTEMPLATE_METHOD_2_C5EDEED341352265_OFFSET UNITYSDK_OFFSET(0x17146E70)
#define RPG_GAMECORE_DAMAGEBEHAVIORTEMPLATE__CTOR_OFFSET UNITYSDK_OFFSET(0x17146E10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DamageBehaviorTemplate_TypeDefinitionIndex = 14341;
