...
#define RPG_GAMECORE_DAMAGEBEHAVIORTEMPLATE_GET_MUTEBUTTRIGGERBLOCKRESULT_OFFSET UNITYSDK_OFFSET(0x1BC450C0)
#define RPG_GAMECORE_DAMAGEBEHAVIORTEMPLATE_METHOD_2_4EB8D065532CCC58_OFFSET UNITYSDK_OFFSET(0x1BC44D90)
#define RPG_GAMECORE_DAMAGEBEHAVIORTEMPLATE_METHOD_2_C5EDEED341352265_OFFSET UNITYSDK_OFFSET(0x1BC45110)
#define RPG_GAMECORE_DAMAGEBEHAVIORTEMPLATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC450B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DamageBehaviorTemplate_TypeDefinitionIndex = 15037;
