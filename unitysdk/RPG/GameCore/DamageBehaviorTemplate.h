...
#define RPG_GAMECORE_DAMAGEBEHAVIORTEMPLATE_GET_MUTEBUTTRIGGERBLOCKRESULT_OFFSET UNITYSDK_OFFSET(0x1968D2E0)
#define RPG_GAMECORE_DAMAGEBEHAVIORTEMPLATE_METHOD_2_4EB8D065532CCC58_OFFSET UNITYSDK_OFFSET(0x1968CFB0)
#define RPG_GAMECORE_DAMAGEBEHAVIORTEMPLATE_METHOD_2_C5EDEED341352265_OFFSET UNITYSDK_OFFSET(0x1968D350)
#define RPG_GAMECORE_DAMAGEBEHAVIORTEMPLATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1968D2D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DamageBehaviorTemplate_TypeDefinitionIndex = 14875;
