...
#define RPG_GAMECORE_ADVENTUREBYPROPSHOWINFOID_METHOD_4_267ED9E1BD401570_OFFSET UNITYSDK_OFFSET(0x16F4F540)
#define RPG_GAMECORE_ADVENTUREBYPROPSHOWINFOID_METHOD_4_BAD4C89873E84214_OFFSET UNITYSDK_OFFSET(0x16F4F620)
#define RPG_GAMECORE_ADVENTUREBYPROPSHOWINFOID__CTOR_OFFSET UNITYSDK_OFFSET(0x16F4F5C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureByPropShowInfoId_TypeDefinitionIndex = 18773;
