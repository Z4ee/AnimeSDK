...
#define RPG_GAMECORE_LITTLEGAMECOLLIDER2DCOMPONENT_METHOD_3_E7EC0D74CDFC8CC2_OFFSET UNITYSDK_OFFSET(0x1D200840)
#define RPG_GAMECORE_LITTLEGAMECOLLIDER2DCOMPONENT_METHOD_3_E8F36321F99880BD_OFFSET UNITYSDK_OFFSET(0x1D2006E0)
#define RPG_GAMECORE_LITTLEGAMECOLLIDER2DCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1FFA30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameCollider2DComponent_TypeDefinitionIndex = 18659;
