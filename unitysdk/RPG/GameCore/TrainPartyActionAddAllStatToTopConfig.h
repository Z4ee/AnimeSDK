...
#define RPG_GAMECORE_TRAINPARTYACTIONADDALLSTATTOTOPCONFIG_METHOD_5_46719681E1F6268E_OFFSET UNITYSDK_OFFSET(0x190A4EE0)
#define RPG_GAMECORE_TRAINPARTYACTIONADDALLSTATTOTOPCONFIG_METHOD_5_8796175FC6D25D07_OFFSET UNITYSDK_OFFSET(0x190A4FB0)
#define RPG_GAMECORE_TRAINPARTYACTIONADDALLSTATTOTOPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x190A4F60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyActionAddAllStatToTopConfig_TypeDefinitionIndex = 17183;
