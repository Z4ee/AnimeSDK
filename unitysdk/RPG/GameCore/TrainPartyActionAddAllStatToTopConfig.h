...
#define RPG_GAMECORE_TRAINPARTYACTIONADDALLSTATTOTOPCONFIG_METHOD_5_8796175FC6D25D07_OFFSET UNITYSDK_OFFSET(0x1D5D9450)
#define RPG_GAMECORE_TRAINPARTYACTIONADDALLSTATTOTOPCONFIG_METHOD_5_BBFF9E826BD0F983_OFFSET UNITYSDK_OFFSET(0x1D5D9400)
#define RPG_GAMECORE_TRAINPARTYACTIONADDALLSTATTOTOPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5D9440)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyActionAddAllStatToTopConfig_TypeDefinitionIndex = 17870;
