...
#define RPG_GAMECORE_RESETVIRTUALCAMERAPOSBYPLAYERTALK_METHOD_3_CDB2698A826F4C30_OFFSET UNITYSDK_OFFSET(0x18CABEA0)
#define RPG_GAMECORE_RESETVIRTUALCAMERAPOSBYPLAYERTALK_METHOD_3_DF07DB499EEFF38F_OFFSET UNITYSDK_OFFSET(0x18CABF20)
#define RPG_GAMECORE_RESETVIRTUALCAMERAPOSBYPLAYERTALK__CTOR_OFFSET UNITYSDK_OFFSET(0x18CABEF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetVirtualCameraPosByPlayerTalk_TypeDefinitionIndex = 22722;
