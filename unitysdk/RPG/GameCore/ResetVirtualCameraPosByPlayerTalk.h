...
#define RPG_GAMECORE_RESETVIRTUALCAMERAPOSBYPLAYERTALK_METHOD_3_8EB3432ADF9EF85B_OFFSET UNITYSDK_OFFSET(0x1DB945D0)
#define RPG_GAMECORE_RESETVIRTUALCAMERAPOSBYPLAYERTALK_METHOD_3_DF07DB499EEFF38F_OFFSET UNITYSDK_OFFSET(0x1DB94610)
#define RPG_GAMECORE_RESETVIRTUALCAMERAPOSBYPLAYERTALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB94600)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetVirtualCameraPosByPlayerTalk_TypeDefinitionIndex = 23463;
