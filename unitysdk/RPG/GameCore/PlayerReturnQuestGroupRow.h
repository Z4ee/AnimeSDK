...
#define RPG_GAMECORE_PLAYERRETURNQUESTGROUPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19A41C60)
#define RPG_GAMECORE_PLAYERRETURNQUESTGROUPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19A41D80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayerReturnQuestGroupRow_TypeDefinitionIndex = 13798;
