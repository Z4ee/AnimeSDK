...
#define RPG_GAMECORE_LEVELSPATIALPRISMDESC_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B08A5B0)
#define RPG_GAMECORE_LEVELSPATIALPRISMDESC__CTOR_OFFSET UNITYSDK_OFFSET(0x1B08A5F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelSpatialPrismDesc_TypeDefinitionIndex = 16516;
