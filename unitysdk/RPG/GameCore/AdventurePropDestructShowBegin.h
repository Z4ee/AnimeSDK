...
#define RPG_GAMECORE_ADVENTUREPROPDESTRUCTSHOWBEGIN_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xE4ED0C0)
#define RPG_GAMECORE_ADVENTUREPROPDESTRUCTSHOWBEGIN_GETPROP_OFFSET UNITYSDK_OFFSET(0xE4ED160)
#define RPG_GAMECORE_ADVENTUREPROPDESTRUCTSHOWBEGIN_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xE4ED110)
#define RPG_GAMECORE_ADVENTUREPROPDESTRUCTSHOWBEGIN_INIT_OFFSET UNITYSDK_OFFSET(0xE4ED070)
#define RPG_GAMECORE_ADVENTUREPROPDESTRUCTSHOWBEGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xE4ED1A0)
