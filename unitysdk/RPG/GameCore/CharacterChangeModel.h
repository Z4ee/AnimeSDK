...
#define RPG_GAMECORE_CHARACTERCHANGEMODEL_METHOD_3_3E11E12927F24A77_OFFSET UNITYSDK_OFFSET(0x187CBC40)
#define RPG_GAMECORE_CHARACTERCHANGEMODEL_METHOD_3_90A418CE0539F81F_OFFSET UNITYSDK_OFFSET(0x187CBD10)
#define RPG_GAMECORE_CHARACTERCHANGEMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x187CBCC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterChangeModel_TypeDefinitionIndex = 22154;
