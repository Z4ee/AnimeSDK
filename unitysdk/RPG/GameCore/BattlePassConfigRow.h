...
#define RPG_GAMECORE_BATTLEPASSCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x194D1550)
#define RPG_GAMECORE_BATTLEPASSCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x194D1A70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattlePassConfigRow_TypeDefinitionIndex = 12250;

	class BattlePassConfigRow : public ::System::Object
	{
	public:
		::Il2CppArray<::System::UInt32>* WeekOrder2; // 0x10
		::Il2CppArray<::System::UInt32>* WeekOrder1; // 0x18
		::Il2CppArray<::System::UInt32>* VersionQuestList; // 0x20
		::Il2CppArray<::System::UInt32>* EquipmentShow; // 0x28
