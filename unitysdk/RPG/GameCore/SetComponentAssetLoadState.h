...
#define RPG_GAMECORE_SETCOMPONENTASSETLOADSTATE_METHOD_3_98D242F9951D9DCD_OFFSET UNITYSDK_OFFSET(0x19C31C60)
#define RPG_GAMECORE_SETCOMPONENTASSETLOADSTATE_METHOD_3_C13BB6FF481F2F85_OFFSET UNITYSDK_OFFSET(0x19C31D40)
#define RPG_GAMECORE_SETCOMPONENTASSETLOADSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C31CE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetComponentAssetLoadState_TypeDefinitionIndex = 21566;
