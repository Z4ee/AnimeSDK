...
#define RPG_GAMECORE_SETCOMPONENTASSETLOADSTATE_METHOD_3_C13BB6FF481F2F85_OFFSET UNITYSDK_OFFSET(0x1D4E9110)
#define RPG_GAMECORE_SETCOMPONENTASSETLOADSTATE_METHOD_3_EF268F80EBA4AB44_OFFSET UNITYSDK_OFFSET(0x1D4E9060)
#define RPG_GAMECORE_SETCOMPONENTASSETLOADSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4E90D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetComponentAssetLoadState_TypeDefinitionIndex = 22554;
