...
#define RPG_GAMECORE_REMOVEMAZEBUFF_METHOD_3_285DF138332F6821_OFFSET UNITYSDK_OFFSET(0x17598B30)
#define RPG_GAMECORE_REMOVEMAZEBUFF_METHOD_3_EEA5E53A6F1FB400_OFFSET UNITYSDK_OFFSET(0x17598AB0)
#define RPG_GAMECORE_REMOVEMAZEBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x17598B00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveMazeBuff_TypeDefinitionIndex = 18715;
