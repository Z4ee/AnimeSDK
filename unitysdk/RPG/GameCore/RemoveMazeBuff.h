...
#define RPG_GAMECORE_REMOVEMAZEBUFF_METHOD_3_285DF138332F6821_OFFSET UNITYSDK_OFFSET(0x1B9D01F0)
#define RPG_GAMECORE_REMOVEMAZEBUFF_METHOD_3_FCB2CD8853F4B838_OFFSET UNITYSDK_OFFSET(0x1B9D01B0)
#define RPG_GAMECORE_REMOVEMAZEBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9D01E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveMazeBuff_TypeDefinitionIndex = 19636;
