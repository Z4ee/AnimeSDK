...
#define RPG_GAMECORE_REMOVEMAZEBUFF_METHOD_3_285DF138332F6821_OFFSET UNITYSDK_OFFSET(0x19AC9620)
#define RPG_GAMECORE_REMOVEMAZEBUFF_METHOD_3_EEA5E53A6F1FB400_OFFSET UNITYSDK_OFFSET(0x19AC95A0)
#define RPG_GAMECORE_REMOVEMAZEBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x19AC95F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveMazeBuff_TypeDefinitionIndex = 19280;
