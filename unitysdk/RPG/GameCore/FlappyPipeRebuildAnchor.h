...
#define RPG_GAMECORE_FLAPPYPIPEREBUILDANCHOR_METHOD_3_22F1C11E62F975C1_OFFSET UNITYSDK_OFFSET(0x1975F110)
#define RPG_GAMECORE_FLAPPYPIPEREBUILDANCHOR_METHOD_3_EB89866F65AA40CD_OFFSET UNITYSDK_OFFSET(0x1975EFE0)
#define RPG_GAMECORE_FLAPPYPIPEREBUILDANCHOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1975F0F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FlappyPipeRebuildAnchor_TypeDefinitionIndex = 17725;
