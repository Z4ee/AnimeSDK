...
#define RPG_GAMECORE_FLAPPYPIPEREBUILDANCHOR_METHOD_3_22F1C11E62F975C1_OFFSET UNITYSDK_OFFSET(0x18924C20)
#define RPG_GAMECORE_FLAPPYPIPEREBUILDANCHOR_METHOD_3_EB89866F65AA40CD_OFFSET UNITYSDK_OFFSET(0x18924AF0)
#define RPG_GAMECORE_FLAPPYPIPEREBUILDANCHOR__CTOR_OFFSET UNITYSDK_OFFSET(0x18924C00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FlappyPipeRebuildAnchor_TypeDefinitionIndex = 17697;
