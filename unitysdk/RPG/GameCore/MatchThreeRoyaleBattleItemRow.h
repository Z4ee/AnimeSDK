...
#define RPG_GAMECORE_MATCHTHREEROYALEBATTLEITEMROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x198F38A0)
#define RPG_GAMECORE_MATCHTHREEROYALEBATTLEITEMROW__CTOR_OFFSET UNITYSDK_OFFSET(0x198F3CA0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 BattleItemID; // 0x18
		::RPG::GameCore::MatchThreePropType PropType; // 0x1C
		::RPG::Client::TextID ItemUseFailHint; // 0x20
		::RPG::Client::TextID ItemHint; // 0x30
		::RPG::Client::TextID ItemName; // 0x40
