...
#define RPG_GAMECORE_MATCHTHREEROYALEBATTLEITEMROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D24EF10)
#define RPG_GAMECORE_MATCHTHREEROYALEBATTLEITEMROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D24F310)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 InputGridCount; // 0x3C
