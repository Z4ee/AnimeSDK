...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEMIRACLECOUNTPARAM_METHOD_4_0896B864A9E8CC2C_OFFSET UNITYSDK_OFFSET(0x1C2E7180)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEMIRACLECOUNTPARAM_METHOD_4_D1A019357CD0CFA8_OFFSET UNITYSDK_OFFSET(0x1C2E71D0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEMIRACLECOUNTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2E71C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRogueMiracleCountParam_TypeDefinitionIndex = 20994;
