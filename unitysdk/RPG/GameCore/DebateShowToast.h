...
#define RPG_GAMECORE_DEBATESHOWTOAST_METHOD_3_4B88181AD12A92E8_OFFSET UNITYSDK_OFFSET(0x18853F90)
#define RPG_GAMECORE_DEBATESHOWTOAST_METHOD_3_587BFF299B0F4D3B_OFFSET UNITYSDK_OFFSET(0x18853F10)
#define RPG_GAMECORE_DEBATESHOWTOAST__CTOR_OFFSET UNITYSDK_OFFSET(0x18853F60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DebateShowToast_TypeDefinitionIndex = 20787;
