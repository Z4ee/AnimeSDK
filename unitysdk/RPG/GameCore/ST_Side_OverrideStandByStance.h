...
#define RPG_GAMECORE_ST_SIDE_OVERRIDESTANDBYSTANCE_METHOD_4_5A255CAFF018FC92_OFFSET UNITYSDK_OFFSET(0x18DFA370)
#define RPG_GAMECORE_ST_SIDE_OVERRIDESTANDBYSTANCE_METHOD_4_863092CCA6CA99B8_OFFSET UNITYSDK_OFFSET(0x18DFA2A0)
#define RPG_GAMECORE_ST_SIDE_OVERRIDESTANDBYSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x18DFA320)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_OverrideStandByStance_TypeDefinitionIndex = 19051;
