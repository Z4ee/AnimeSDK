...
#define RPG_GAMECORE_ST_SIDE_OVERRIDESTANDBYSTANCE_METHOD_4_5A255CAFF018FC92_OFFSET UNITYSDK_OFFSET(0x1768DEA0)
#define RPG_GAMECORE_ST_SIDE_OVERRIDESTANDBYSTANCE_METHOD_4_863092CCA6CA99B8_OFFSET UNITYSDK_OFFSET(0x176997D0)
#define RPG_GAMECORE_ST_SIDE_OVERRIDESTANDBYSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1768DE50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_OverrideStandByStance_TypeDefinitionIndex = 18406;
