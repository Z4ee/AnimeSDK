...
#define RPG_GAMECORE_TRIGGERPAMACTIONPHASEDONE_METHOD_3_6F4CA32FB4E2AF24_OFFSET UNITYSDK_OFFSET(0x190C96F0)
#define RPG_GAMECORE_TRIGGERPAMACTIONPHASEDONE_METHOD_3_F046CBEF26475B70_OFFSET UNITYSDK_OFFSET(0x190C9800)
#define RPG_GAMECORE_TRIGGERPAMACTIONPHASEDONE__CTOR_OFFSET UNITYSDK_OFFSET(0x190C97D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerPamActionPhaseDone_TypeDefinitionIndex = 18954;
