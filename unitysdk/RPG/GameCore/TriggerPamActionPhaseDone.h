...
#define RPG_GAMECORE_TRIGGERPAMACTIONPHASEDONE_METHOD_3_1AABD6A85FCE0FAD_OFFSET UNITYSDK_OFFSET(0x1D6021B0)
#define RPG_GAMECORE_TRIGGERPAMACTIONPHASEDONE_METHOD_3_F046CBEF26475B70_OFFSET UNITYSDK_OFFSET(0x1D602280)
#define RPG_GAMECORE_TRIGGERPAMACTIONPHASEDONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D602270)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerPamActionPhaseDone_TypeDefinitionIndex = 19799;
