...
#define RPG_GAMECORE_ELFLEADERSKILLLEVELCONFIG_METHOD_2_164F0CB4CFB31A99_OFFSET UNITYSDK_OFFSET(0x1D059E60)
#define RPG_GAMECORE_ELFLEADERSKILLLEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D05A050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfLeaderSkillLevelConfig_TypeDefinitionIndex = 18248;
