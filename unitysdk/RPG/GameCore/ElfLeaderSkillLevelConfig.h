...
#define RPG_GAMECORE_ELFLEADERSKILLLEVELCONFIG_METHOD_2_164F0CB4CFB31A99_OFFSET UNITYSDK_OFFSET(0x1718F310)
#define RPG_GAMECORE_ELFLEADERSKILLLEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1718F500)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfLeaderSkillLevelConfig_TypeDefinitionIndex = 16937;
