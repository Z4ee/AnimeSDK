...
#define RPG_GAMECORE_ELFLEADERSKILLLEVELCONFIG_METHOD_2_164F0CB4CFB31A99_OFFSET UNITYSDK_OFFSET(0x1889CA40)
#define RPG_GAMECORE_ELFLEADERSKILLLEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1889CC30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfLeaderSkillLevelConfig_TypeDefinitionIndex = 17531;
