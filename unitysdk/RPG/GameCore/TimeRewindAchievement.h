...
#define RPG_GAMECORE_TIMEREWINDACHIEVEMENT_METHOD_2_BA1F760D09B77EE9_OFFSET UNITYSDK_OFFSET(0x1E1D73B0)
#define RPG_GAMECORE_TIMEREWINDACHIEVEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1D7770)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TimeRewindAchievement_TypeDefinitionIndex = 16417;
