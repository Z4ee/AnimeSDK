...
#define RPG_GAMECORE_VE_FACTORGROUP_METHOD_3_17EA2DF4BBB00E34_OFFSET UNITYSDK_OFFSET(0x1B88CED0)
#define RPG_GAMECORE_VE_FACTORGROUP_METHOD_3_1C4115E8560D9086_OFFSET UNITYSDK_OFFSET(0x1B88CCA0)
#define RPG_GAMECORE_VE_FACTORGROUP_METHOD_3_9BED9ABE98A70F52_OFFSET UNITYSDK_OFFSET(0x1B88CEA0)
#define RPG_GAMECORE_VE_FACTORGROUP_METHOD_3_D978056F5283E957_OFFSET UNITYSDK_OFFSET(0x1B88CCE0)
#define RPG_GAMECORE_VE_FACTORGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B88CCD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VE_FactorGroup_TypeDefinitionIndex = 23191;
