...
#define RPG_GAMECORE_PERFORMANCESPLITOBJECTANIMMAP_METHOD_2_2EE51CE3DBE1F4D4_OFFSET UNITYSDK_OFFSET(0x1D3237C0)
#define RPG_GAMECORE_PERFORMANCESPLITOBJECTANIMMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3238F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PerformanceSplitObjectAnimMap_TypeDefinitionIndex = 17366;
