...
#define RPG_GAMECORE_PERFORMANCESPLITOBJECTANIMMAP_METHOD_2_2EE51CE3DBE1F4D4_OFFSET UNITYSDK_OFFSET(0x1D42C490)
#define RPG_GAMECORE_PERFORMANCESPLITOBJECTANIMMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D42C5C0)
