...
#define RPG_GAMECORE_GRIDFIGHTMODULETRAITSWITCHCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D06BF10)
#define RPG_GAMECORE_GRIDFIGHTMODULETRAITSWITCHCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D06C080)
