...
#define RPG_GAMECORE_SETEFFECTANIMATORSYNCWITHTIMELINE_METHOD_3_5A37024B48BC3A3D_OFFSET UNITYSDK_OFFSET(0x1D4FAB50)
#define RPG_GAMECORE_SETEFFECTANIMATORSYNCWITHTIMELINE_METHOD_3_66F2252AAD13AEA0_OFFSET UNITYSDK_OFFSET(0x1D4FAB90)
#define RPG_GAMECORE_SETEFFECTANIMATORSYNCWITHTIMELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4FAB80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetEffectAnimatorSyncWithTimeLine_TypeDefinitionIndex = 22206;
