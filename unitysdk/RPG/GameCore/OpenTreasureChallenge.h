...
#define RPG_GAMECORE_OPENTREASURECHALLENGE_METHOD_3_435BDA283DDAF542_OFFSET UNITYSDK_OFFSET(0x1BB02A50)
#define RPG_GAMECORE_OPENTREASURECHALLENGE_METHOD_3_44D77C5C1CEA9CDF_OFFSET UNITYSDK_OFFSET(0x1BB02A90)
#define RPG_GAMECORE_OPENTREASURECHALLENGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB02A80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OpenTreasureChallenge_TypeDefinitionIndex = 19687;
