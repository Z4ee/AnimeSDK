...
#define RPG_GAMECORE_OPENTREASURECHALLENGE_METHOD_3_48D31592A1E45A8C_OFFSET UNITYSDK_OFFSET(0x1747D970)
#define RPG_GAMECORE_OPENTREASURECHALLENGE_METHOD_3_E8D9A96185334CFD_OFFSET UNITYSDK_OFFSET(0x1747D9F0)
#define RPG_GAMECORE_OPENTREASURECHALLENGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1747D9C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OpenTreasureChallenge_TypeDefinitionIndex = 18769;
