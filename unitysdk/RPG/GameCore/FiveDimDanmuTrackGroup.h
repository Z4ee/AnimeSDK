...
#define RPG_GAMECORE_FIVEDIMDANMUTRACKGROUP_METHOD_2_566617BADDF04B47_OFFSET UNITYSDK_OFFSET(0x1BA8FFA0)
#define RPG_GAMECORE_FIVEDIMDANMUTRACKGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA900E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimDanmuTrackGroup_TypeDefinitionIndex = 18091;
