...
#define RPG_GAMECORE_FIVEDIMDANMUTRACKGROUP_METHOD_2_566617BADDF04B47_OFFSET UNITYSDK_OFFSET(0x19737EC0)
#define RPG_GAMECORE_FIVEDIMDANMUTRACKGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x19738000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimDanmuTrackGroup_TypeDefinitionIndex = 17913;
