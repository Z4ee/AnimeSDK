...
#define RPG_GAMECORE_RESETACTIONDELAY_METHOD_3_0E77CF49700CCEA8_OFFSET UNITYSDK_OFFSET(0x1759D330)
#define RPG_GAMECORE_RESETACTIONDELAY_METHOD_3_9DED3DFE360A0D2A_OFFSET UNITYSDK_OFFSET(0x1759D3B0)
#define RPG_GAMECORE_RESETACTIONDELAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1759D380)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetActionDelay_TypeDefinitionIndex = 21519;
