...
#define RPG_GAMECORE_WAITPERFORMANCECONDITION_METHOD_3_F4C0DF3FA7D752E1_OFFSET UNITYSDK_OFFSET(0x178FF140)
#define RPG_GAMECORE_WAITPERFORMANCECONDITION_METHOD_3_FA5FB74DD75E3B1B_OFFSET UNITYSDK_OFFSET(0x178FF060)
#define RPG_GAMECORE_WAITPERFORMANCECONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x178FF0E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitPerformanceCondition_TypeDefinitionIndex = 21601;
