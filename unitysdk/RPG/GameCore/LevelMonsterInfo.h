...
#define RPG_GAMECORE_LEVELMONSTERINFO_METHOD_4_D865A8CF394D8916_OFFSET UNITYSDK_OFFSET(0x1733C180)
#define RPG_GAMECORE_LEVELMONSTERINFO_METHOD_4_E2041FDB068DFF3F_OFFSET UNITYSDK_OFFSET(0x1733C060)
#define RPG_GAMECORE_LEVELMONSTERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1733C100)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelMonsterInfo_TypeDefinitionIndex = 15842;
