...
#define RPG_GAMECORE_LEVELMONSTERINFO_METHOD_4_56CFC09813D1C52F_OFFSET UNITYSDK_OFFSET(0x1D1D74F0)
#define RPG_GAMECORE_LEVELMONSTERINFO_METHOD_4_C2897D07C4E6CAA0_OFFSET UNITYSDK_OFFSET(0x1D1D73D0)
#define RPG_GAMECORE_LEVELMONSTERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1D7470)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelMonsterInfo_TypeDefinitionIndex = 17054;
