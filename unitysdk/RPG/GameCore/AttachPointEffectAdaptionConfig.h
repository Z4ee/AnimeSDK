...
#define RPG_GAMECORE_ATTACHPOINTEFFECTADAPTIONCONFIG_METHOD_2_825D4E3F207634AD_OFFSET UNITYSDK_OFFSET(0x16F8A9D0)
#define RPG_GAMECORE_ATTACHPOINTEFFECTADAPTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16F8AAE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AttachPointEffectAdaptionConfig_TypeDefinitionIndex = 15119;
