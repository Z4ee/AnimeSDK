...
#define RPG_GAMECORE_HIPPLENGAMETRIGGEROPERTATION_METHOD_3_F10166A8FED27B6A_OFFSET UNITYSDK_OFFSET(0x1B687360)
#define RPG_GAMECORE_HIPPLENGAMETRIGGEROPERTATION_METHOD_3_FC4541F8EE65FEA9_OFFSET UNITYSDK_OFFSET(0x1B687320)
#define RPG_GAMECORE_HIPPLENGAMETRIGGEROPERTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B687350)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HipplenGameTriggerOpertation_TypeDefinitionIndex = 20524;
