...
#define RPG_GAMECORE_HIPPLENGAMETRIGGEROPERTATION_METHOD_3_EF9D89A89D793689_OFFSET UNITYSDK_OFFSET(0x19834A40)
#define RPG_GAMECORE_HIPPLENGAMETRIGGEROPERTATION_METHOD_3_F10166A8FED27B6A_OFFSET UNITYSDK_OFFSET(0x19834AC0)
#define RPG_GAMECORE_HIPPLENGAMETRIGGEROPERTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x19834A90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HipplenGameTriggerOpertation_TypeDefinitionIndex = 20152;
