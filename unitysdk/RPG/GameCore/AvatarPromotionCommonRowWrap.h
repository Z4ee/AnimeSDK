...
#define RPG_GAMECORE_AVATARPROMOTIONCOMMONROWWRAP_GETALLWRAPDATA_OFFSET UNITYSDK_OFFSET(0xCD1A500)
#define RPG_GAMECORE_AVATARPROMOTIONCOMMONROWWRAP_GETWRAPDATA_OFFSET UNITYSDK_OFFSET(0xCD1A280)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AvatarPromotionCommonRowWrap_TypeDefinitionIndex = 52796;
