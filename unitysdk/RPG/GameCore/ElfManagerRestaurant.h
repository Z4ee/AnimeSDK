...
#define RPG_GAMECORE_ELFMANAGERRESTAURANT_METHOD_3_A4C13261FE83CAC8_OFFSET UNITYSDK_OFFSET(0x1DB29F80)
#define RPG_GAMECORE_ELFMANAGERRESTAURANT_METHOD_3_F0D0D4A72B4D1D45_OFFSET UNITYSDK_OFFSET(0x1DB29EB0)
#define RPG_GAMECORE_ELFMANAGERRESTAURANT__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB29F70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfManagerRestaurant_TypeDefinitionIndex = 21488;
