...
#define RPG_GAMECORE_ELFMANAGERRESTAURANT_METHOD_3_700E885577AFFAFC_OFFSET UNITYSDK_OFFSET(0x196DB3C0)
#define RPG_GAMECORE_ELFMANAGERRESTAURANT_METHOD_3_A4C13261FE83CAC8_OFFSET UNITYSDK_OFFSET(0x196DB4D0)
#define RPG_GAMECORE_ELFMANAGERRESTAURANT__CTOR_OFFSET UNITYSDK_OFFSET(0x196DB4A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfManagerRestaurant_TypeDefinitionIndex = 20517;
