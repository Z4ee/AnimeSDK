...
#define RPG_GAMECORE_MONOPOLYASSETCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1995AF60)
#define RPG_GAMECORE_MONOPOLYASSETCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1995B290)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonopolyAssetConfigRow_TypeDefinitionIndex = 11473;
	...
	public:
		...
		::System::UInt32 AssetID; // 0x34
		::System::UInt32 TaxValue; // 0x38
		::System::UInt32 BonusValue; // 0x3C
