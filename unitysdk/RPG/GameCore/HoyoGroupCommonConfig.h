...
#define RPG_GAMECORE_HOYOGROUPCOMMONCONFIG_METHOD_2_45CD62CA47DF344B_OFFSET UNITYSDK_OFFSET(0x1B68BA10)
#define RPG_GAMECORE_HOYOGROUPCOMMONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B68BAE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HoyoGroupCommonConfig_TypeDefinitionIndex = 16912;
