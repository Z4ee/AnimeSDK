...
#define RPG_GAMECORE_HOYOGROUPCOMMONCONFIG_METHOD_2_45CD62CA47DF344B_OFFSET UNITYSDK_OFFSET(0x18A06ED0)
#define RPG_GAMECORE_HOYOGROUPCOMMONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18A06FA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HoyoGroupCommonConfig_TypeDefinitionIndex = 16729;
