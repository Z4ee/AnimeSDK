...
#define RPG_GAMECORE_STREAMINGSCENEOBJLODSCALEVOLUMECOMPONENTDATA_METHOD_4_970012D1F194FB21_OFFSET UNITYSDK_OFFSET(0x17782740)
#define RPG_GAMECORE_STREAMINGSCENEOBJLODSCALEVOLUMECOMPONENTDATA_METHOD_4_E721789180083112_OFFSET UNITYSDK_OFFSET(0x17782700)
#define RPG_GAMECORE_STREAMINGSCENEOBJLODSCALEVOLUMECOMPONENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17782730)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StreamingSceneObjLodScaleVolumeComponentData_TypeDefinitionIndex = 17539;
