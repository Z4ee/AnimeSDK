...
#define RPG_GAMECORE_STREAMINGSCENEOBJLODSCALEVOLUMECOMPONENTDATA_METHOD_4_4F5CE8ECBBD2B693_OFFSET UNITYSDK_OFFSET(0x1D560A50)
#define RPG_GAMECORE_STREAMINGSCENEOBJLODSCALEVOLUMECOMPONENTDATA_METHOD_4_6E7E724F7791EC7E_OFFSET UNITYSDK_OFFSET(0x1D5603D0)
#define RPG_GAMECORE_STREAMINGSCENEOBJLODSCALEVOLUMECOMPONENTDATA_METHOD_4_82A3B6C6D358BD20_OFFSET UNITYSDK_OFFSET(0x1D55FBF0)
#define RPG_GAMECORE_STREAMINGSCENEOBJLODSCALEVOLUMECOMPONENTDATA_METHOD_4_D2C950494B18C093_OFFSET UNITYSDK_OFFSET(0x1D574710)
#define RPG_GAMECORE_STREAMINGSCENEOBJLODSCALEVOLUMECOMPONENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1D55FBE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StreamingSceneObjLodScaleVolumeComponentData_TypeDefinitionIndex = 18900;
