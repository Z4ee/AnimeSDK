...
#define RPG_GAMECORE_FREESTYLEANIMZONECONFIG_METHOD_2_935ED42C4AB1D762_OFFSET UNITYSDK_OFFSET(0x1D119B70)
#define RPG_GAMECORE_FREESTYLEANIMZONECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D119CA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FreeStyleAnimZoneConfig_TypeDefinitionIndex = 16133;
