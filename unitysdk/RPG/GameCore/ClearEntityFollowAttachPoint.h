...
#define RPG_GAMECORE_CLEARENTITYFOLLOWATTACHPOINT_METHOD_3_033B856A9E43499F_OFFSET UNITYSDK_OFFSET(0x19652F50)
#define RPG_GAMECORE_CLEARENTITYFOLLOWATTACHPOINT_METHOD_3_E778B85DF99C614E_OFFSET UNITYSDK_OFFSET(0x19652FD0)
#define RPG_GAMECORE_CLEARENTITYFOLLOWATTACHPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x19652FA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClearEntityFollowAttachPoint_TypeDefinitionIndex = 22352;
