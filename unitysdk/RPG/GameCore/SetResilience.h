...
#define RPG_GAMECORE_SETRESILIENCE_METHOD_3_7C916FA663862A5F_OFFSET UNITYSDK_OFFSET(0x18E40070)
#define RPG_GAMECORE_SETRESILIENCE_METHOD_3_9DC7B721C639EC6B_OFFSET UNITYSDK_OFFSET(0x18E400F0)
#define RPG_GAMECORE_SETRESILIENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E400C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetResilience_TypeDefinitionIndex = 22448;
