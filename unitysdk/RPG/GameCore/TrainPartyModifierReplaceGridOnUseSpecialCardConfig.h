...
#define RPG_GAMECORE_TRAINPARTYMODIFIERREPLACEGRIDONUSESPECIALCARDCONFIG_METHOD_3_510000A0880B76DD_OFFSET UNITYSDK_OFFSET(0x19DF68D0)
#define RPG_GAMECORE_TRAINPARTYMODIFIERREPLACEGRIDONUSESPECIALCARDCONFIG_METHOD_3_EA2C04A18E5A8719_OFFSET UNITYSDK_OFFSET(0x19DF6BD0)
#define RPG_GAMECORE_TRAINPARTYMODIFIERREPLACEGRIDONUSESPECIALCARDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19DF68C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyModifierReplaceGridOnUseSpecialCardConfig_TypeDefinitionIndex = 17211;
