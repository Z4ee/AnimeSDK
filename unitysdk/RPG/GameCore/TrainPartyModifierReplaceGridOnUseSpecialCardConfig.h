...
#define RPG_GAMECORE_TRAINPARTYMODIFIERREPLACEGRIDONUSESPECIALCARDCONFIG_METHOD_3_510000A0880B76DD_OFFSET UNITYSDK_OFFSET(0x178AD180)
#define RPG_GAMECORE_TRAINPARTYMODIFIERREPLACEGRIDONUSESPECIALCARDCONFIG_METHOD_3_EA2C04A18E5A8719_OFFSET UNITYSDK_OFFSET(0x178AD480)
#define RPG_GAMECORE_TRAINPARTYMODIFIERREPLACEGRIDONUSESPECIALCARDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x178AD170)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyModifierReplaceGridOnUseSpecialCardConfig_TypeDefinitionIndex = 16611;
