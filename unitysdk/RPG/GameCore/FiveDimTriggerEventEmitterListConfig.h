...
#define RPG_GAMECORE_FIVEDIMTRIGGEREVENTEMITTERLISTCONFIG_METHOD_3_284F55F2B4C7C3D0_OFFSET UNITYSDK_OFFSET(0x18923050)
#define RPG_GAMECORE_FIVEDIMTRIGGEREVENTEMITTERLISTCONFIG_METHOD_3_49D5F0C507890E89_OFFSET UNITYSDK_OFFSET(0x18922FE0)
#define RPG_GAMECORE_FIVEDIMTRIGGEREVENTEMITTERLISTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18923030)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimTriggerEventEmitterListConfig_TypeDefinitionIndex = 17708;
