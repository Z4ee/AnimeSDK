...
#define RPG_GAMECORE_FIVEDIMTRIGGEREVENTEMITTERLISTCONFIG_METHOD_3_284F55F2B4C7C3D0_OFFSET UNITYSDK_OFFSET(0x1BEB80E0)
#define RPG_GAMECORE_FIVEDIMTRIGGEREVENTEMITTERLISTCONFIG_METHOD_3_456440F9EC6AD993_OFFSET UNITYSDK_OFFSET(0x1BEB80A0)
#define RPG_GAMECORE_FIVEDIMTRIGGEREVENTEMITTERLISTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEB80D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimTriggerEventEmitterListConfig_TypeDefinitionIndex = 17910;
