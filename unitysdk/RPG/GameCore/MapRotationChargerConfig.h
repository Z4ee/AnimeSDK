...
#define RPG_GAMECORE_MAPROTATIONCHARGERCONFIG_METHOD_2_51032131C38E02EA_OFFSET UNITYSDK_OFFSET(0x18A8D900)
#define RPG_GAMECORE_MAPROTATIONCHARGERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18A8DA70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MapRotationChargerConfig_TypeDefinitionIndex = 16108;
