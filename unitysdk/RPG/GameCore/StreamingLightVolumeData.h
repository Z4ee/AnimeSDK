...
#define RPG_GAMECORE_STREAMINGLIGHTVOLUMEDATA_METHOD_4_C6C31034EBC555D3_OFFSET UNITYSDK_OFFSET(0x18EA7B40)
#define RPG_GAMECORE_STREAMINGLIGHTVOLUMEDATA_METHOD_4_F6607DBDF82A3D20_OFFSET UNITYSDK_OFFSET(0x18EA8380)
#define RPG_GAMECORE_STREAMINGLIGHTVOLUMEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18EA8370)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StreamingLightVolumeData_TypeDefinitionIndex = 18147;
