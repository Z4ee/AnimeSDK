...
#define RPG_GAMECORE_STREAMINGLIGHTVOLUMEDATA_METHOD_4_1511A825EEA6BEFB_OFFSET UNITYSDK_OFFSET(0x1B0B69B0)
#define RPG_GAMECORE_STREAMINGLIGHTVOLUMEDATA_METHOD_4_A2383201951BBBAA_OFFSET UNITYSDK_OFFSET(0x1B0CA430)
#define RPG_GAMECORE_STREAMINGLIGHTVOLUMEDATA_METHOD_4_C6C31034EBC555D3_OFFSET UNITYSDK_OFFSET(0x1B0C9B00)
#define RPG_GAMECORE_STREAMINGLIGHTVOLUMEDATA_METHOD_4_F6607DBDF82A3D20_OFFSET UNITYSDK_OFFSET(0x1B0B6110)
#define RPG_GAMECORE_STREAMINGLIGHTVOLUMEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0B6100)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StreamingLightVolumeData_TypeDefinitionIndex = 18375;
