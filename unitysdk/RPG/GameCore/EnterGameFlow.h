...
#define RPG_GAMECORE_ENTERGAMEFLOW_METHOD_3_A306605762AA5A6A_OFFSET UNITYSDK_OFFSET(0x1719E480)
#define RPG_GAMECORE_ENTERGAMEFLOW_METHOD_3_D47FCF29810D6ADB_OFFSET UNITYSDK_OFFSET(0x1719E500)
#define RPG_GAMECORE_ENTERGAMEFLOW__CTOR_OFFSET UNITYSDK_OFFSET(0x1719E4D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnterGameFlow_TypeDefinitionIndex = 22309;
