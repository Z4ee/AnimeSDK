...
#define RPG_GAMECORE_TARGETFETCHADVSKILLTARGETENTITYLIST_METHOD_4_7785FE5B7F7F301C_OFFSET UNITYSDK_OFFSET(0x177BC6A0)
#define RPG_GAMECORE_TARGETFETCHADVSKILLTARGETENTITYLIST_METHOD_4_9E5D5601A1B9071E_OFFSET UNITYSDK_OFFSET(0x177BC590)
#define RPG_GAMECORE_TARGETFETCHADVSKILLTARGETENTITYLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x177BC650)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchAdvSkillTargetEntityList_TypeDefinitionIndex = 22132;
