...
#define RPG_GAMECORE_TARGETFETCHADVSKILLTARGETENTITYLIST_METHOD_4_00761F0D1664988C_OFFSET UNITYSDK_OFFSET(0x1D5A7720)
#define RPG_GAMECORE_TARGETFETCHADVSKILLTARGETENTITYLIST_METHOD_4_47525868268F2671_OFFSET UNITYSDK_OFFSET(0x1D5A7620)
#define RPG_GAMECORE_TARGETFETCHADVSKILLTARGETENTITYLIST_METHOD_4_7785FE5B7F7F301C_OFFSET UNITYSDK_OFFSET(0x1D5A76A0)
#define RPG_GAMECORE_TARGETFETCHADVSKILLTARGETENTITYLIST_METHOD_4_FEC6460B9497BE59_OFFSET UNITYSDK_OFFSET(0x1D5A7700)
#define RPG_GAMECORE_TARGETFETCHADVSKILLTARGETENTITYLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5A7690)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchAdvSkillTargetEntityList_TypeDefinitionIndex = 23593;
