...
#define RPG_GAMECORE_PROJECTILEBEZIERCONTROLPOINT_METHOD_2_F9D70BCC0146532B_OFFSET UNITYSDK_OFFSET(0x19A85200)
#define RPG_GAMECORE_PROJECTILEBEZIERCONTROLPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x19A85330)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ProjectileBezierControlPoint_TypeDefinitionIndex = 14881;
