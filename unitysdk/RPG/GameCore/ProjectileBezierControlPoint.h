...
#define RPG_GAMECORE_PROJECTILEBEZIERCONTROLPOINT_METHOD_2_F9D70BCC0146532B_OFFSET UNITYSDK_OFFSET(0x1BA18CA0)
#define RPG_GAMECORE_PROJECTILEBEZIERCONTROLPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA18DD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ProjectileBezierControlPoint_TypeDefinitionIndex = 15043;
