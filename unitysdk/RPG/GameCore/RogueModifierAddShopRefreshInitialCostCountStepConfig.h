...
#define RPG_GAMECORE_ROGUEMODIFIERADDSHOPREFRESHINITIALCOSTCOUNTSTEPCONFIG_METHOD_3_70CE4666C60CD172_OFFSET UNITYSDK_OFFSET(0x19B4E320)
#define RPG_GAMECORE_ROGUEMODIFIERADDSHOPREFRESHINITIALCOSTCOUNTSTEPCONFIG_METHOD_3_DF0494A4D5F51EFB_OFFSET UNITYSDK_OFFSET(0x19B4E250)
#define RPG_GAMECORE_ROGUEMODIFIERADDSHOPREFRESHINITIALCOSTCOUNTSTEPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B4E2D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierAddShopRefreshInitialCostCountStepConfig_TypeDefinitionIndex = 16941;
