...
#define RPG_GAMECORE_ROGUEMODIFIERADDSHOPREFRESHINITIALCOSTCOUNTSTEPCONFIG_METHOD_3_70CE4666C60CD172_OFFSET UNITYSDK_OFFSET(0x1CFBF0A0)
#define RPG_GAMECORE_ROGUEMODIFIERADDSHOPREFRESHINITIALCOSTCOUNTSTEPCONFIG_METHOD_3_8B50CFBD35FC5B96_OFFSET UNITYSDK_OFFSET(0x1CFBF050)
#define RPG_GAMECORE_ROGUEMODIFIERADDSHOPREFRESHINITIALCOSTCOUNTSTEPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFBF090)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierAddShopRefreshInitialCostCountStepConfig_TypeDefinitionIndex = 17103;
