...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETROLENUMPREBATTLECONFIG_METHOD_6_6B8B6AA7E6B4914C_OFFSET UNITYSDK_OFFSET(0x197FBBC0)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETROLENUMPREBATTLECONFIG_METHOD_6_D33A5B4085969162_OFFSET UNITYSDK_OFFSET(0x197FB910)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETROLENUMPREBATTLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197FBA90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightParamGetRoleNumPreBattleConfig_TypeDefinitionIndex = 18501;
