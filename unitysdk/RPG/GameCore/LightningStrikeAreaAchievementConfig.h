...
#define RPG_GAMECORE_LIGHTNINGSTRIKEAREAACHIEVEMENTCONFIG_METHOD_2_E07D806DB34CD608_OFFSET UNITYSDK_OFFSET(0x1D1F2420)
#define RPG_GAMECORE_LIGHTNINGSTRIKEAREAACHIEVEMENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1F24C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LightningStrikeAreaAchievementConfig_TypeDefinitionIndex = 16640;
