...
#define RPG_GAMECORE_MISSIONITEMCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D1ABE60)
#define RPG_GAMECORE_MISSIONITEMCONFIG_FROMJSON_OFFSET UNITYSDK_OFFSET(0x1D1ABF60)
#define RPG_GAMECORE_MISSIONITEMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1ABF50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MissionItemConfig_TypeDefinitionIndex = 18759;
