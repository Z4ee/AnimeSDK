...
#define RPG_GAMECORE_MISSIONITEMCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17421E50)
#define RPG_GAMECORE_MISSIONITEMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17421F40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MissionItemConfig_TypeDefinitionIndex = 17396;
