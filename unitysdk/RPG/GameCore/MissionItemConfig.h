...
#define RPG_GAMECORE_MISSIONITEMCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D2A56D0)
#define RPG_GAMECORE_MISSIONITEMCONFIG_FROMJSON_OFFSET UNITYSDK_OFFSET(0x1D2A57D0)
#define RPG_GAMECORE_MISSIONITEMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2A57C0)
