...
#define RPG_GAMECORE_BYCOMPARECHARACTERNUMBER_METHOD_4_2C7055D190232589_OFFSET UNITYSDK_OFFSET(0x19CD6280)
#define RPG_GAMECORE_BYCOMPARECHARACTERNUMBER_METHOD_4_30E9B6BB2733D2E6_OFFSET UNITYSDK_OFFSET(0x19CD5F10)
#define RPG_GAMECORE_BYCOMPARECHARACTERNUMBER_METHOD_4_AFE40E0D5C77887F_OFFSET UNITYSDK_OFFSET(0x19CD6240)
#define RPG_GAMECORE_BYCOMPARECHARACTERNUMBER_METHOD_4_E81DA2C2EB557C83_OFFSET UNITYSDK_OFFSET(0x19CD5EC0)
#define RPG_GAMECORE_BYCOMPARECHARACTERNUMBER__CTOR_OFFSET UNITYSDK_OFFSET(0x19CD5F00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareCharacterNumber_TypeDefinitionIndex = 22176;
