...
#define RPG_GAMECORE_BYCOMPARECHARACTERNUMBER_METHOD_4_30E9B6BB2733D2E6_OFFSET UNITYSDK_OFFSET(0x17004720)
#define RPG_GAMECORE_BYCOMPARECHARACTERNUMBER_METHOD_4_38CE48CB31224984_OFFSET UNITYSDK_OFFSET(0x17004640)
#define RPG_GAMECORE_BYCOMPARECHARACTERNUMBER__CTOR_OFFSET UNITYSDK_OFFSET(0x170046C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareCharacterNumber_TypeDefinitionIndex = 21210;
