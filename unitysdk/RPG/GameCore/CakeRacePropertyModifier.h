...
#define RPG_GAMECORE_CAKERACEPROPERTYMODIFIER_METHOD_2_E72DEFCEA3501C78_OFFSET UNITYSDK_OFFSET(0x1B705710)
#define RPG_GAMECORE_CAKERACEPROPERTYMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B705890)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRacePropertyModifier_TypeDefinitionIndex = 17596;
