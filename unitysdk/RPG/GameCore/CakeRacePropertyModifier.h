...
#define RPG_GAMECORE_CAKERACEPROPERTYMODIFIER_METHOD_2_E72DEFCEA3501C78_OFFSET UNITYSDK_OFFSET(0x1D103B90)
#define RPG_GAMECORE_CAKERACEPROPERTYMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D103D10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRacePropertyModifier_TypeDefinitionIndex = 18114;
