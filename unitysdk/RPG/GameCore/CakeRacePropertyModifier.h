...
#define RPG_GAMECORE_CAKERACEPROPERTYMODIFIER_METHOD_2_E72DEFCEA3501C78_OFFSET UNITYSDK_OFFSET(0x18774240)
#define RPG_GAMECORE_CAKERACEPROPERTYMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x187743C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRacePropertyModifier_TypeDefinitionIndex = 17418;
