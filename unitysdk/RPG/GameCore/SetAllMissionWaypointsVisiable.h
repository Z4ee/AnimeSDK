...
#define RPG_GAMECORE_SETALLMISSIONWAYPOINTSVISIABLE_METHOD_3_24E1C7A1F2C5110A_OFFSET UNITYSDK_OFFSET(0x176A5FD0)
#define RPG_GAMECORE_SETALLMISSIONWAYPOINTSVISIABLE_METHOD_3_5F09B6EDC83CB053_OFFSET UNITYSDK_OFFSET(0x176A5F50)
#define RPG_GAMECORE_SETALLMISSIONWAYPOINTSVISIABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x176A5FA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetAllMissionWaypointsVisiable_TypeDefinitionIndex = 19199;
