...
#define RPG_GAMECORE_SETALLMISSIONWAYPOINTSVISIABLE_METHOD_3_24E1C7A1F2C5110A_OFFSET UNITYSDK_OFFSET(0x1C2D16E0)
#define RPG_GAMECORE_SETALLMISSIONWAYPOINTSVISIABLE_METHOD_3_2FC643FC6064B9C1_OFFSET UNITYSDK_OFFSET(0x1C2D16A0)
#define RPG_GAMECORE_SETALLMISSIONWAYPOINTSVISIABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2D16D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetAllMissionWaypointsVisiable_TypeDefinitionIndex = 20087;
