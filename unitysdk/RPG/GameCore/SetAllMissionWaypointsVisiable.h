...
#define RPG_GAMECORE_SETALLMISSIONWAYPOINTSVISIABLE_METHOD_3_24E1C7A1F2C5110A_OFFSET UNITYSDK_OFFSET(0x18E08AD0)
#define RPG_GAMECORE_SETALLMISSIONWAYPOINTSVISIABLE_METHOD_3_5F09B6EDC83CB053_OFFSET UNITYSDK_OFFSET(0x18E08A50)
#define RPG_GAMECORE_SETALLMISSIONWAYPOINTSVISIABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E08AA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetAllMissionWaypointsVisiable_TypeDefinitionIndex = 19858;
