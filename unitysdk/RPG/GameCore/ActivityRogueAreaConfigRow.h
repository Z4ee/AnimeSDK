...
#define RPG_GAMECORE_ACTIVITYROGUEAREACONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19404280)
#define RPG_GAMECORE_ACTIVITYROGUEAREACONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19404C40)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::Il2CppArray<::System::UInt32>* MiracleEffectIDList; // 0x10
		...
		::Il2CppArray<::System::UInt32>* TargetParamList; // 0x38
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::UInt32>* DisplayMonster; // 0x40
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::UInt32>* DisplayMonster2; // 0x48
		::System::String* FigurePath2; // 0x50
		::Il2CppArray<::System::UInt32>* ParamList_1; // 0x58
		::Il2CppArray<::System::UInt32>* ParamList_3; // 0x60
		::Il2CppArray<::System::UInt32>* ParamList_2; // 0x68
		::System::UInt32 AreaID; // 0x70
		::System::UInt32 DisplayMapID; // 0x74
		::RPG::Client::TextID GamePlay_1; // 0x78
		::RPG::Client::TextID Endless_GamePlay; // 0x88
		::System::UInt32 FloorID; // 0x98
		::System::UInt32 StageID; // 0x9C
		::System::UInt32 PlaneID; // 0xA0
		::System::UInt32 BattleAreaID; // 0xA4
		::RPG::Client::TextID Describe; // 0xA8
		::System::UInt32 EventID; // 0xB8
		::System::UInt32 ActivityModuleID; // 0xBC
		::System::UInt32 BattleAreaGroupID; // 0xC0
		::RPG::Client::TextID GamePlay_2; // 0xC8
		::RPG::Client::TextID GamePlay_3; // 0xD8
