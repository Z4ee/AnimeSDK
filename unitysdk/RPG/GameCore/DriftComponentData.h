...
#define RPG_GAMECORE_DRIFTCOMPONENTDATA_METHOD_2_5AA7CF844D1FF3E9_OFFSET UNITYSDK_OFFSET(0x196BE760)
#define RPG_GAMECORE_DRIFTCOMPONENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x196BEDD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DriftComponentData_TypeDefinitionIndex = 18204;
