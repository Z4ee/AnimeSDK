...
#define RPG_GAMECORE_GRIDFIGHTSTAGELEVELVALUECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1980C570)
#define RPG_GAMECORE_GRIDFIGHTSTAGELEVELVALUECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1980C6E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightStageLevelValueConfigRow_TypeDefinitionIndex = 12977;
