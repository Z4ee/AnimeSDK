...
#define RPG_GAMECORE_WAITSERVERGROUPPROPERTYCHANGE_METHOD_3_51BD3BC089F1AAC3_OFFSET UNITYSDK_OFFSET(0x1DEC1730)
#define RPG_GAMECORE_WAITSERVERGROUPPROPERTYCHANGE_METHOD_3_F099AFDB50D03EBF_OFFSET UNITYSDK_OFFSET(0x1DEC16E0)
#define RPG_GAMECORE_WAITSERVERGROUPPROPERTYCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEC1720)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitServerGroupPropertyChange_TypeDefinitionIndex = 20935;
