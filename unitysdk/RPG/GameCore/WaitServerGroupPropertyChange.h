...
#define RPG_GAMECORE_WAITSERVERGROUPPROPERTYCHANGE_METHOD_3_4AA187853170BC13_OFFSET UNITYSDK_OFFSET(0x19108600)
#define RPG_GAMECORE_WAITSERVERGROUPPROPERTYCHANGE_METHOD_3_51BD3BC089F1AAC3_OFFSET UNITYSDK_OFFSET(0x19108690)
#define RPG_GAMECORE_WAITSERVERGROUPPROPERTYCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x19108660)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitServerGroupPropertyChange_TypeDefinitionIndex = 20154;
