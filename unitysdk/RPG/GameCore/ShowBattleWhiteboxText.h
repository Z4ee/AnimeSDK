...
#define RPG_GAMECORE_SHOWBATTLEWHITEBOXTEXT_METHOD_3_78AA6785B62F53CD_OFFSET UNITYSDK_OFFSET(0x176F6E50)
#define RPG_GAMECORE_SHOWBATTLEWHITEBOXTEXT_METHOD_3_83B98BAD8A526574_OFFSET UNITYSDK_OFFSET(0x176F6DD0)
#define RPG_GAMECORE_SHOWBATTLEWHITEBOXTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x176F6E20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowBattleWhiteboxText_TypeDefinitionIndex = 21533;
