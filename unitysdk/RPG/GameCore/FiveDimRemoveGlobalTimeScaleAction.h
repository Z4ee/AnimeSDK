...
#define RPG_GAMECORE_FIVEDIMREMOVEGLOBALTIMESCALEACTION_METHOD_3_2AD27B72F19F5D97_OFFSET UNITYSDK_OFFSET(0x197522C0)
#define RPG_GAMECORE_FIVEDIMREMOVEGLOBALTIMESCALEACTION_METHOD_3_6C0DBD5E4D4DE40B_OFFSET UNITYSDK_OFFSET(0x197523C0)
#define RPG_GAMECORE_FIVEDIMREMOVEGLOBALTIMESCALEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x197523A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimRemoveGlobalTimeScaleAction_TypeDefinitionIndex = 17764;
