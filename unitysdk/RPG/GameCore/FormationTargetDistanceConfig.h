...
#define RPG_GAMECORE_FORMATIONTARGETDISTANCECONFIG_METHOD_2_5DC296C7E8F952AA_OFFSET UNITYSDK_OFFSET(0x1DCB3700)
#define RPG_GAMECORE_FORMATIONTARGETDISTANCECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCB3880)
