...
#define RPG_GAMECORE_FORMATIONTARGETDISTANCECONFIG_METHOD_2_5DC296C7E8F952AA_OFFSET UNITYSDK_OFFSET(0x197670A0)
#define RPG_GAMECORE_FORMATIONTARGETDISTANCECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19767220)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FormationTargetDistanceConfig_TypeDefinitionIndex = 17298;
