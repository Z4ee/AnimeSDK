...
#define RPG_GAMECORE_FORMATIONTARGETDISTANCECONFIG_METHOD_2_5DC296C7E8F952AA_OFFSET UNITYSDK_OFFSET(0x1892BD20)
#define RPG_GAMECORE_FORMATIONTARGETDISTANCECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1892BEA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FormationTargetDistanceConfig_TypeDefinitionIndex = 17293;
