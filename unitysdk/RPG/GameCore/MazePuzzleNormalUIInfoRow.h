...
#define RPG_GAMECORE_MAZEPUZZLENORMALUIINFOROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x173C8880)
#define RPG_GAMECORE_MAZEPUZZLENORMALUIINFOROW__CTOR_OFFSET UNITYSDK_OFFSET(0x173C8F20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MazePuzzleNormalUIInfoRow_TypeDefinitionIndex = 12822;
