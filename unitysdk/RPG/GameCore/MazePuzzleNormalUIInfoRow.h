...
#define RPG_GAMECORE_MAZEPUZZLENORMALUIINFOROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D27FA80)
#define RPG_GAMECORE_MAZEPUZZLENORMALUIINFOROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D280140)
