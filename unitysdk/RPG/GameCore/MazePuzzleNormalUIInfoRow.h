...
#define RPG_GAMECORE_MAZEPUZZLENORMALUIINFOROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1AF508A0)
#define RPG_GAMECORE_MAZEPUZZLENORMALUIINFOROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF50F60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MazePuzzleNormalUIInfoRow_TypeDefinitionIndex = 13511;
