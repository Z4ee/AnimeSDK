...
{
	inline static constexpr unsigned int OpenUIPageTaskBase_1_TypeDefinitionIndex = 46984;

	template <typename TConfig>
	class OpenUIPageTaskBase_1 : public ::Class_1_5F51D4049EA87B7B
	{
	public:
		::Class_3_5775A4FEC79026BC* _OnCancel; // 0x0
		::Class_3_5775A4FEC79026BC* _OnUIEnter; // 0x0
