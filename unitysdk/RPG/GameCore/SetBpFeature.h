...
#define RPG_GAMECORE_SETBPFEATURE_METHOD_3_6548632ED61F61A6_OFFSET UNITYSDK_OFFSET(0x176ABF80)
#define RPG_GAMECORE_SETBPFEATURE_METHOD_3_82C26879C3C606B7_OFFSET UNITYSDK_OFFSET(0x176ABF00)
#define RPG_GAMECORE_SETBPFEATURE__CTOR_OFFSET UNITYSDK_OFFSET(0x176ABF50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetBpFeature_TypeDefinitionIndex = 21443;
