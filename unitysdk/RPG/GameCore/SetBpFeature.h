...
#define RPG_GAMECORE_SETBPFEATURE_METHOD_3_6548632ED61F61A6_OFFSET UNITYSDK_OFFSET(0x1E811540)
#define RPG_GAMECORE_SETBPFEATURE_METHOD_3_A8CC8C481A169FA5_OFFSET UNITYSDK_OFFSET(0x1E811500)
#define RPG_GAMECORE_SETBPFEATURE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E811530)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetBpFeature_TypeDefinitionIndex = 22961;
