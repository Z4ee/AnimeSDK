...
#define RPG_GAMECORE_TOGGLESPECIALSKILLMARK_METHOD_3_2A6C7C1EFF05BC71_OFFSET UNITYSDK_OFFSET(0x1D5D4960)
#define RPG_GAMECORE_TOGGLESPECIALSKILLMARK_METHOD_3_B2E2C43DC76881BC_OFFSET UNITYSDK_OFFSET(0x1D5D49A0)
#define RPG_GAMECORE_TOGGLESPECIALSKILLMARK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5D4990)
