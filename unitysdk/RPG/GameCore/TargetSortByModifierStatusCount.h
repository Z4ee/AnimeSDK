...
#define RPG_GAMECORE_TARGETSORTBYMODIFIERSTATUSCOUNT_METHOD_3_BB0BA6736A0EBA99_OFFSET UNITYSDK_OFFSET(0x18EF95E0)
#define RPG_GAMECORE_TARGETSORTBYMODIFIERSTATUSCOUNT_METHOD_3_DDE2CB29F81543E0_OFFSET UNITYSDK_OFFSET(0x18EF7BD0)
#define RPG_GAMECORE_TARGETSORTBYMODIFIERSTATUSCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x18EF7BB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetSortByModifierStatusCount_TypeDefinitionIndex = 22977;
