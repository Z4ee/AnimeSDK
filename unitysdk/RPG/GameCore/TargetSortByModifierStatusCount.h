...
#define RPG_GAMECORE_TARGETSORTBYMODIFIERSTATUSCOUNT_METHOD_3_02E07A4A8DFCFA18_OFFSET UNITYSDK_OFFSET(0x1D0C85F0)
#define RPG_GAMECORE_TARGETSORTBYMODIFIERSTATUSCOUNT_METHOD_3_0E04A6A8AF4376A3_OFFSET UNITYSDK_OFFSET(0x1D0C8460)
#define RPG_GAMECORE_TARGETSORTBYMODIFIERSTATUSCOUNT_METHOD_3_BCDC1D7350EDD011_OFFSET UNITYSDK_OFFSET(0x1D0C85C0)
#define RPG_GAMECORE_TARGETSORTBYMODIFIERSTATUSCOUNT_METHOD_3_DDE2CB29F81543E0_OFFSET UNITYSDK_OFFSET(0x1D0C84A0)
#define RPG_GAMECORE_TARGETSORTBYMODIFIERSTATUSCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0C8490)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetSortByModifierStatusCount_TypeDefinitionIndex = 23131;
