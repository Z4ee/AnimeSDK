...
#define RPG_GAMECORE_TARGETSORTBYMODIFIERSTATUSCOUNT_METHOD_3_02E07A4A8DFCFA18_OFFSET UNITYSDK_OFFSET(0x1D5B9D00)
#define RPG_GAMECORE_TARGETSORTBYMODIFIERSTATUSCOUNT_METHOD_3_0E04A6A8AF4376A3_OFFSET UNITYSDK_OFFSET(0x1D5B9B70)
#define RPG_GAMECORE_TARGETSORTBYMODIFIERSTATUSCOUNT_METHOD_3_BCDC1D7350EDD011_OFFSET UNITYSDK_OFFSET(0x1D5B9CD0)
#define RPG_GAMECORE_TARGETSORTBYMODIFIERSTATUSCOUNT_METHOD_3_DDE2CB29F81543E0_OFFSET UNITYSDK_OFFSET(0x1D5B9BB0)
#define RPG_GAMECORE_TARGETSORTBYMODIFIERSTATUSCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5B9BA0)
