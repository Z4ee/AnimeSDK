...
#define RPG_GAMECORE_AIDECISIONBASECONFIG_METHOD_3_317B8487F57CE9A8_OFFSET UNITYSDK_OFFSET(0x1B9F4040)
#define RPG_GAMECORE_AIDECISIONBASECONFIG_METHOD_3_DE285A7BDE43B1BC_OFFSET UNITYSDK_OFFSET(0x1B9F36D0)
#define RPG_GAMECORE_AIDECISIONBASECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9F41E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AIDecisionBaseConfig_TypeDefinitionIndex = 14874;
