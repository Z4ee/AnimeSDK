...
#define RPG_GAMECORE_ADVENTUREABILITYCONFIG_METHOD_3_39BB5FCEDDCD9230_OFFSET UNITYSDK_OFFSET(0x1CDE02C0)
#define RPG_GAMECORE_ADVENTUREABILITYCONFIG_METHOD_3_AA735394EC67A1ED_OFFSET UNITYSDK_OFFSET(0x1CDE0280)
#define RPG_GAMECORE_ADVENTUREABILITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDE02B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureAbilityConfig_TypeDefinitionIndex = 17229;
