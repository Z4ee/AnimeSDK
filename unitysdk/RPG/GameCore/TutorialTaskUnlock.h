...
#define RPG_GAMECORE_TUTORIALTASKUNLOCK_METHOD_3_3722056C68A4F00C_OFFSET UNITYSDK_OFFSET(0x178DF5F0)
#define RPG_GAMECORE_TUTORIALTASKUNLOCK_METHOD_3_E9B4C7BB3A77879D_OFFSET UNITYSDK_OFFSET(0x178DF670)
#define RPG_GAMECORE_TUTORIALTASKUNLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x178DF640)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TutorialTaskUnlock_TypeDefinitionIndex = 19219;
