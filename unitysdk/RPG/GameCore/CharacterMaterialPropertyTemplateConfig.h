...
#define RPG_GAMECORE_CHARACTERMATERIALPROPERTYTEMPLATECONFIG_METHOD_2_C0A663CC4D6186AB_OFFSET UNITYSDK_OFFSET(0x187D2D90)
#define RPG_GAMECORE_CHARACTERMATERIALPROPERTYTEMPLATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x187D2DD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterMaterialPropertyTemplateConfig_TypeDefinitionIndex = 16555;
