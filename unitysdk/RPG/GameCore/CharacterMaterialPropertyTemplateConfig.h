...
#define RPG_GAMECORE_CHARACTERMATERIALPROPERTYTEMPLATECONFIG_METHOD_2_C0A663CC4D6186AB_OFFSET UNITYSDK_OFFSET(0x1B724F90)
#define RPG_GAMECORE_CHARACTERMATERIALPROPERTYTEMPLATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B724FD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterMaterialPropertyTemplateConfig_TypeDefinitionIndex = 16747;
