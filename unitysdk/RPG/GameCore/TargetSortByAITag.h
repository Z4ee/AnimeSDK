...
#define RPG_GAMECORE_TARGETSORTBYAITAG_METHOD_3_7FB2F87850E9FDAA_OFFSET UNITYSDK_OFFSET(0x18EF6AF0)
#define RPG_GAMECORE_TARGETSORTBYAITAG_METHOD_3_E4A028C13521E48E_OFFSET UNITYSDK_OFFSET(0x18EF8F40)
#define RPG_GAMECORE_TARGETSORTBYAITAG__CTOR_OFFSET UNITYSDK_OFFSET(0x18EF6AD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetSortByAITag_TypeDefinitionIndex = 22982;
