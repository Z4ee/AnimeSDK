...
#define RPG_GAMECORE_TRIGGERSOUNDINANIM_METHOD_3_7E84322EF5ABD222_OFFSET UNITYSDK_OFFSET(0x178CEE40)
#define RPG_GAMECORE_TRIGGERSOUNDINANIM_METHOD_3_E59908B870ED60D9_OFFSET UNITYSDK_OFFSET(0x178CEED0)
#define RPG_GAMECORE_TRIGGERSOUNDINANIM__CTOR_OFFSET UNITYSDK_OFFSET(0x178CEEA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerSoundInAnim_TypeDefinitionIndex = 20576;
	...
	public:
		...
		static ::System::Void Method_3_7E84322EF5ABD222(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::TriggerSoundInAnim*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::TriggerSoundInAnim*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_TRIGGERSOUNDINANIM_METHOD_3_7E84322EF5ABD222_OFFSET))(a1, a2);
		}
