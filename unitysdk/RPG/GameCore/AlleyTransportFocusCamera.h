...
#define RPG_GAMECORE_ALLEYTRANSPORTFOCUSCAMERA_METHOD_3_97BF6FCA13CBADE8_OFFSET UNITYSDK_OFFSET(0x1869F960)
#define RPG_GAMECORE_ALLEYTRANSPORTFOCUSCAMERA_METHOD_3_EA9E89FE3BD7CAB1_OFFSET UNITYSDK_OFFSET(0x1869F9E0)
#define RPG_GAMECORE_ALLEYTRANSPORTFOCUSCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x1869F9B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AlleyTransportFocusCamera_TypeDefinitionIndex = 23300;
