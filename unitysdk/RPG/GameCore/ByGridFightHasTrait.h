...
#define RPG_GAMECORE_BYGRIDFIGHTHASTRAIT_METHOD_4_35D60AA6B27A7C79_OFFSET UNITYSDK_OFFSET(0x17022A60)
#define RPG_GAMECORE_BYGRIDFIGHTHASTRAIT_METHOD_4_946F750F9C3A0BCF_OFFSET UNITYSDK_OFFSET(0x17022B40)
#define RPG_GAMECORE_BYGRIDFIGHTHASTRAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x17022AE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByGridFightHasTrait_TypeDefinitionIndex = 20710;
