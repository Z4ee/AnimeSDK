...
#define RPG_GAMECORE_BYISINELATIONTIME_METHOD_4_721BF12B1EA14222_OFFSET UNITYSDK_OFFSET(0x18754710)
#define RPG_GAMECORE_BYISINELATIONTIME_METHOD_4_B3A97AA292D987C8_OFFSET UNITYSDK_OFFSET(0x18754640)
#define RPG_GAMECORE_BYISINELATIONTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x187546C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsInElationTime_TypeDefinitionIndex = 21503;
