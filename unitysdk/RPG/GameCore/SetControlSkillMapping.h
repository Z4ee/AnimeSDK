...
#define RPG_GAMECORE_SETCONTROLSKILLMAPPING_METHOD_3_840BA4C83CD2D827_OFFSET UNITYSDK_OFFSET(0x1C2DAE60)
#define RPG_GAMECORE_SETCONTROLSKILLMAPPING_METHOD_3_BDDE36458822AD9A_OFFSET UNITYSDK_OFFSET(0x1C2DAE20)
#define RPG_GAMECORE_SETCONTROLSKILLMAPPING__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2DAE50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetControlSkillMapping_TypeDefinitionIndex = 21892;
