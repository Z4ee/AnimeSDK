...
#define RPG_GAMECORE_SETCONTROLSKILLMAPPING_METHOD_3_CC21A2FBFDB581C4_OFFSET UNITYSDK_OFFSET(0x176B0C10)
#define RPG_GAMECORE_SETCONTROLSKILLMAPPING_METHOD_3_D6DE1575E4F357D3_OFFSET UNITYSDK_OFFSET(0x176B0B90)
#define RPG_GAMECORE_SETCONTROLSKILLMAPPING__CTOR_OFFSET UNITYSDK_OFFSET(0x176B0BE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetControlSkillMapping_TypeDefinitionIndex = 20899;
