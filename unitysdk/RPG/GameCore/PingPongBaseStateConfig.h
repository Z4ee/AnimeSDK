...
#define RPG_GAMECORE_PINGPONGBASESTATECONFIG_METHOD_2_F8988DB7CD43D873_OFFSET UNITYSDK_OFFSET(0x1D438BC0)
#define RPG_GAMECORE_PINGPONGBASESTATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D78C0F0)
