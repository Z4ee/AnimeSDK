...
#define RPG_GAMECORE_PINGPONGBASESTATECONFIG_METHOD_2_F8988DB7CD43D873_OFFSET UNITYSDK_OFFSET(0x19A0BD70)
#define RPG_GAMECORE_PINGPONGBASESTATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19A0BF00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PingPongBaseStateConfig_TypeDefinitionIndex = 16114;
