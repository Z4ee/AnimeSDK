...
#define RPG_GAMECORE_PINGPONGBASESTATECONFIG_METHOD_2_F8988DB7CD43D873_OFFSET UNITYSDK_OFFSET(0x18BF9F10)
#define RPG_GAMECORE_PINGPONGBASESTATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18BFA0A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PingPongBaseStateConfig_TypeDefinitionIndex = 16064;
