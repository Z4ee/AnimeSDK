...
#define RPG_GAMECORE_REMOVEMAPPOSESWITCHER_METHOD_3_80EC226578D5674A_OFFSET UNITYSDK_OFFSET(0x1DB8DDA0)
#define RPG_GAMECORE_REMOVEMAPPOSESWITCHER_METHOD_3_D6815F5FC1A3A101_OFFSET UNITYSDK_OFFSET(0x1DB8DD60)
#define RPG_GAMECORE_REMOVEMAPPOSESWITCHER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB8DD90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveMapPoseSwitcher_TypeDefinitionIndex = 20704;
