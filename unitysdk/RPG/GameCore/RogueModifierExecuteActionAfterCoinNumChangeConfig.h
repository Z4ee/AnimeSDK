...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONAFTERCOINNUMCHANGECONFIG_METHOD_3_AF47C450BFE86B38_OFFSET UNITYSDK_OFFSET(0x18D34480)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONAFTERCOINNUMCHANGECONFIG_METHOD_3_E0D2BCD22229A4E1_OFFSET UNITYSDK_OFFSET(0x18D3C4F0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONAFTERCOINNUMCHANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D34430)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionAfterCoinNumChangeConfig_TypeDefinitionIndex = 17079;
