...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONAFTERCOINNUMCHANGECONFIG_METHOD_3_AF47C450BFE86B38_OFFSET UNITYSDK_OFFSET(0x1EEF8320)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONAFTERCOINNUMCHANGECONFIG_METHOD_3_B11A6D91EF7F92FC_OFFSET UNITYSDK_OFFSET(0x1EEF82D0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONAFTERCOINNUMCHANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEF8310)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionAfterCoinNumChangeConfig_TypeDefinitionIndex = 17771;
