...
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_NEARESTNTHSOLDIER_METHOD_3_2F515DC2B1A93D72_OFFSET UNITYSDK_OFFSET(0x1C37ED30)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_NEARESTNTHSOLDIER_METHOD_3_471AF9CC0EF2B76C_OFFSET UNITYSDK_OFFSET(0x1C37ED90)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_NEARESTNTHSOLDIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C37ED80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleTargetEvaluator_NearestNthSoldier_TypeDefinitionIndex = 15155;
