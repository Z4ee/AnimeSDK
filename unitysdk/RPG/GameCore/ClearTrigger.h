...
#define RPG_GAMECORE_CLEARTRIGGER_METHOD_3_12C05A93804B67A9_OFFSET UNITYSDK_OFFSET(0x19654680)
#define RPG_GAMECORE_CLEARTRIGGER_METHOD_3_973D118C31940970_OFFSET UNITYSDK_OFFSET(0x19654600)
#define RPG_GAMECORE_CLEARTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x19654650)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClearTrigger_TypeDefinitionIndex = 18899;
