...
#define RPG_GAMECORE_CLEARTRIGGER_METHOD_3_12C05A93804B67A9_OFFSET UNITYSDK_OFFSET(0x1C255060)
#define RPG_GAMECORE_CLEARTRIGGER_METHOD_3_EA78D9670C366522_OFFSET UNITYSDK_OFFSET(0x1C255020)
#define RPG_GAMECORE_CLEARTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C255050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClearTrigger_TypeDefinitionIndex = 19249;
