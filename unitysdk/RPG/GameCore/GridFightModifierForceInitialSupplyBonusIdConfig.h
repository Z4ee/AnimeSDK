...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERFORCEINITIALSUPPLYBONUSIDCONFIG_METHOD_3_5E78E2AD4CD3A575_OFFSET UNITYSDK_OFFSET(0x1726AF70)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERFORCEINITIALSUPPLYBONUSIDCONFIG_METHOD_3_720B9B9F45E3AAAC_OFFSET UNITYSDK_OFFSET(0x17267640)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERFORCEINITIALSUPPLYBONUSIDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x172675F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierForceInitialSupplyBonusIdConfig_TypeDefinitionIndex = 17787;
