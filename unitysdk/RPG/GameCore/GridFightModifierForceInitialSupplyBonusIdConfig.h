...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERFORCEINITIALSUPPLYBONUSIDCONFIG_METHOD_3_720B9B9F45E3AAAC_OFFSET UNITYSDK_OFFSET(0x1D069D20)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERFORCEINITIALSUPPLYBONUSIDCONFIG_METHOD_3_E2F9F405990584B0_OFFSET UNITYSDK_OFFSET(0x1D069CD0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERFORCEINITIALSUPPLYBONUSIDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D069D10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierForceInitialSupplyBonusIdConfig_TypeDefinitionIndex = 18622;
