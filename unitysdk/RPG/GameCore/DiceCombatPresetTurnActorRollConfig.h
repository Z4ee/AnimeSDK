...
#define RPG_GAMECORE_DICECOMBATPRESETTURNACTORROLLCONFIG_METHOD_2_09A1C656CB4B0B13_OFFSET UNITYSDK_OFFSET(0x1D033B80)
#define RPG_GAMECORE_DICECOMBATPRESETTURNACTORROLLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D033C70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatPresetTurnActorRollConfig_TypeDefinitionIndex = 15957;
