...
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_BUBBLETALK_METHOD_4_272349D579C001E2_OFFSET UNITYSDK_OFFSET(0x1D4D0390)
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_BUBBLETALK_METHOD_4_E57441599F027FAE_OFFSET UNITYSDK_OFFSET(0x1D4D03E0)
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_BUBBLETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4D03D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_Hipplen_BubbleTalk_TypeDefinitionIndex = 21056;
