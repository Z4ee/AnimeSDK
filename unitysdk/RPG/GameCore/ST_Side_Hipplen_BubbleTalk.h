...
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_BUBBLETALK_METHOD_4_8F067FC78A273FBF_OFFSET UNITYSDK_OFFSET(0x17698E50)
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_BUBBLETALK_METHOD_4_E57441599F027FAE_OFFSET UNITYSDK_OFFSET(0x1768B7D0)
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_BUBBLETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1768B770)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_Hipplen_BubbleTalk_TypeDefinitionIndex = 19602;
