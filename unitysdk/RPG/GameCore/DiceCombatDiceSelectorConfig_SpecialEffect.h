...
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_SPECIALEFFECT_METHOD_3_1DB550F69F6AE419_OFFSET UNITYSDK_OFFSET(0x1C110330)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_SPECIALEFFECT_METHOD_3_B4EBE9123FBE7944_OFFSET UNITYSDK_OFFSET(0x1C10F730)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_SPECIALEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C10F720)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatDiceSelectorConfig_SpecialEffect_TypeDefinitionIndex = 15536;
