...
#define RPG_GAMECORE_TEAMFORMATIONTEMPLATECONFIG_METHOD_2_40BBC85B884BA868_OFFSET UNITYSDK_OFFSET(0x19DDB750)
#define RPG_GAMECORE_TEAMFORMATIONTEMPLATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19DDB840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TeamFormationTemplateConfig_TypeDefinitionIndex = 15757;
