...
#define RPG_GAMECORE_TEAMFORMATIONTEMPLATECONFIG_METHOD_2_40BBC85B884BA868_OFFSET UNITYSDK_OFFSET(0x1D5C2740)
#define RPG_GAMECORE_TEAMFORMATIONTEMPLATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5C2830)
