...
#define RPG_GAMECORE_CHIMERADUELRANDOMENTITIESSELECTORCONFIG_METHOD_3_42F232EF419661CE_OFFSET UNITYSDK_OFFSET(0x170A3430)
#define RPG_GAMECORE_CHIMERADUELRANDOMENTITIESSELECTORCONFIG_METHOD_3_A4417499989BFC74_OFFSET UNITYSDK_OFFSET(0x170A3490)
#define RPG_GAMECORE_CHIMERADUELRANDOMENTITIESSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x170A3480)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelRandomEntitiesSelectorConfig_TypeDefinitionIndex = 14620;
