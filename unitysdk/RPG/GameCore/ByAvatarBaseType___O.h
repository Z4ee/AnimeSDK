...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_D837DED66799FBE3_DelegateParseJson_1<::RPG::GameCore::AvatarBaseType>**)Il2CppClass::FromTypeDefinitionIndex(ByAvatarBaseType___O_TypeDefinitionIndex)->GetStaticField(0xCE60);
		}
	};
}
