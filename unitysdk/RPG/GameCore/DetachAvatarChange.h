...
#define RPG_GAMECORE_DETACHAVATARCHANGE_METHOD_3_264BFD94656B200E_OFFSET UNITYSDK_OFFSET(0x17155410)
#define RPG_GAMECORE_DETACHAVATARCHANGE_METHOD_3_E8054889A7F90633_OFFSET UNITYSDK_OFFSET(0x171554B0)
#define RPG_GAMECORE_DETACHAVATARCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x17155470)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DetachAvatarChange_TypeDefinitionIndex = 21851;
