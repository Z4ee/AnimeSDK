...
#define RPG_GAMECORE_DETACHAVATARCHANGE_METHOD_3_21D32480012FA88A_OFFSET UNITYSDK_OFFSET(0x1C104A00)
#define RPG_GAMECORE_DETACHAVATARCHANGE_METHOD_3_E8054889A7F90633_OFFSET UNITYSDK_OFFSET(0x1C104A50)
#define RPG_GAMECORE_DETACHAVATARCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C104A40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DetachAvatarChange_TypeDefinitionIndex = 22765;
