...
#define RPG_GAMECORE_SINGLEANIMEVENTCONFIG_METHOD_2_02D361E672E99F2A_OFFSET UNITYSDK_OFFSET(0x1D0A0AB0)
#define RPG_GAMECORE_SINGLEANIMEVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0A0E30)
