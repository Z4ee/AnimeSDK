...
#define RPG_GAMECORE_FIVEDIMENTRYCONFIG_METHOD_3_7C82697C0859388C_OFFSET UNITYSDK_OFFSET(0x171F14B0)
#define RPG_GAMECORE_FIVEDIMENTRYCONFIG_METHOD_3_9EC689523426F43D_OFFSET UNITYSDK_OFFSET(0x171F1520)
#define RPG_GAMECORE_FIVEDIMENTRYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171F1500)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimEntryConfig_TypeDefinitionIndex = 17010;
