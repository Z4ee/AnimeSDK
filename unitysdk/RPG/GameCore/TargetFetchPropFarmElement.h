...
#define RPG_GAMECORE_TARGETFETCHPROPFARMELEMENT_METHOD_4_6DDCAC794C8DEC47_OFFSET UNITYSDK_OFFSET(0x1D5ADE30)
#define RPG_GAMECORE_TARGETFETCHPROPFARMELEMENT_METHOD_4_921AEF3DBA42C697_OFFSET UNITYSDK_OFFSET(0x1D5ADED0)
#define RPG_GAMECORE_TARGETFETCHPROPFARMELEMENT_METHOD_4_9911E44B78473C53_OFFSET UNITYSDK_OFFSET(0x1D5ADE90)
#define RPG_GAMECORE_TARGETFETCHPROPFARMELEMENT_METHOD_4_CF603051054A9AD6_OFFSET UNITYSDK_OFFSET(0x1D5ADD90)
#define RPG_GAMECORE_TARGETFETCHPROPFARMELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5ADE20)
