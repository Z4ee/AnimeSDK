...
#define RPG_GAMECORE_FIVEDIMMUTEPLAYERINPUTACTION_METHOD_3_3ADD79DB2D01EF6B_OFFSET UNITYSDK_OFFSET(0x18910960)
#define RPG_GAMECORE_FIVEDIMMUTEPLAYERINPUTACTION_METHOD_3_E88CAE17EE4AE0DF_OFFSET UNITYSDK_OFFSET(0x18910A90)
#define RPG_GAMECORE_FIVEDIMMUTEPLAYERINPUTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18910A70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimMutePlayerInputAction_TypeDefinitionIndex = 17831;
