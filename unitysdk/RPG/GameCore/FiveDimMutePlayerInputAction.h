...
#define RPG_GAMECORE_FIVEDIMMUTEPLAYERINPUTACTION_METHOD_3_3ADD79DB2D01EF6B_OFFSET UNITYSDK_OFFSET(0x171FFA60)
#define RPG_GAMECORE_FIVEDIMMUTEPLAYERINPUTACTION_METHOD_3_E88CAE17EE4AE0DF_OFFSET UNITYSDK_OFFSET(0x171FFB90)
#define RPG_GAMECORE_FIVEDIMMUTEPLAYERINPUTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x171FFB70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimMutePlayerInputAction_TypeDefinitionIndex = 17227;
