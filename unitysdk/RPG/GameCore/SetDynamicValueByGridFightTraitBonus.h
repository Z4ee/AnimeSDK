...
#define RPG_GAMECORE_SETDYNAMICVALUEBYGRIDFIGHTTRAITBONUS_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x19C41750)
#define RPG_GAMECORE_SETDYNAMICVALUEBYGRIDFIGHTTRAITBONUS_METHOD_4_D11939EAEC5CDBBA_OFFSET UNITYSDK_OFFSET(0x19C416D0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYGRIDFIGHTTRAITBONUS_METHOD_4_D94A1F342EBE4959_OFFSET UNITYSDK_OFFSET(0x19C3AB20)
#define RPG_GAMECORE_SETDYNAMICVALUEBYGRIDFIGHTTRAITBONUS__CTOR_OFFSET UNITYSDK_OFFSET(0x19C3AAD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByGridFightTraitBonus_TypeDefinitionIndex = 21304;
