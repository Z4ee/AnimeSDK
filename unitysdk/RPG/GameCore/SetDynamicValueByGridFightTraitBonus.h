...
#define RPG_GAMECORE_SETDYNAMICVALUEBYGRIDFIGHTTRAITBONUS_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1C2E2AE0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYGRIDFIGHTTRAITBONUS_METHOD_4_9EEBBE26A19B3F3C_OFFSET UNITYSDK_OFFSET(0x1C2E27E0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYGRIDFIGHTTRAITBONUS_METHOD_4_D94A1F342EBE4959_OFFSET UNITYSDK_OFFSET(0x1C2E2820)
#define RPG_GAMECORE_SETDYNAMICVALUEBYGRIDFIGHTTRAITBONUS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2E2810)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByGridFightTraitBonus_TypeDefinitionIndex = 21719;
