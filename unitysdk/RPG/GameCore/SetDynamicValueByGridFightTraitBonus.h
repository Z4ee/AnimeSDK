...
#define RPG_GAMECORE_SETDYNAMICVALUEBYGRIDFIGHTTRAITBONUS_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1D4F1590)
#define RPG_GAMECORE_SETDYNAMICVALUEBYGRIDFIGHTTRAITBONUS_METHOD_4_9EEBBE26A19B3F3C_OFFSET UNITYSDK_OFFSET(0x1D4F1290)
#define RPG_GAMECORE_SETDYNAMICVALUEBYGRIDFIGHTTRAITBONUS_METHOD_4_D94A1F342EBE4959_OFFSET UNITYSDK_OFFSET(0x1D4F12D0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYGRIDFIGHTTRAITBONUS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4F12C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByGridFightTraitBonus_TypeDefinitionIndex = 22282;
	...
	public:
		...
		static ::System::Void Method_4_9EEBBE26A19B3F3C(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::SetDynamicValueByGridFightTraitBonus*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::SetDynamicValueByGridFightTraitBonus*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_SETDYNAMICVALUEBYGRIDFIGHTTRAITBONUS_METHOD_4_9EEBBE26A19B3F3C_OFFSET))(a1, a2);
		}
