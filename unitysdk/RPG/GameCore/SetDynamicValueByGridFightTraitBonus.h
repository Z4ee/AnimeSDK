...
#define RPG_GAMECORE_SETDYNAMICVALUEBYGRIDFIGHTTRAITBONUS_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x176C17C0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYGRIDFIGHTTRAITBONUS_METHOD_4_D11939EAEC5CDBBA_OFFSET UNITYSDK_OFFSET(0x176C1740)
#define RPG_GAMECORE_SETDYNAMICVALUEBYGRIDFIGHTTRAITBONUS_METHOD_4_D94A1F342EBE4959_OFFSET UNITYSDK_OFFSET(0x176BB9D0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYGRIDFIGHTTRAITBONUS__CTOR_OFFSET UNITYSDK_OFFSET(0x176BB980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByGridFightTraitBonus_TypeDefinitionIndex = 20720;
