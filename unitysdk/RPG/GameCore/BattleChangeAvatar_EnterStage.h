...
#define RPG_GAMECORE_BATTLECHANGEAVATAR_ENTERSTAGE_METHOD_3_6BC5629475AF9BD3_OFFSET UNITYSDK_OFFSET(0x1A3E4350)
#define RPG_GAMECORE_BATTLECHANGEAVATAR_ENTERSTAGE_METHOD_3_A44FC9FDE8A0B496_OFFSET UNITYSDK_OFFSET(0x1A3E4280)
#define RPG_GAMECORE_BATTLECHANGEAVATAR_ENTERSTAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3E4340)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleChangeAvatar_EnterStage_TypeDefinitionIndex = 21959;
