...
#define RPG_GAMECORE_BATTLECHANGEAVATAR_ENTERSTAGE_METHOD_3_6BC5629475AF9BD3_OFFSET UNITYSDK_OFFSET(0x1B2F1C90)
#define RPG_GAMECORE_BATTLECHANGEAVATAR_ENTERSTAGE_METHOD_3_A44FC9FDE8A0B496_OFFSET UNITYSDK_OFFSET(0x1B2F1BC0)
#define RPG_GAMECORE_BATTLECHANGEAVATAR_ENTERSTAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2F1C80)
