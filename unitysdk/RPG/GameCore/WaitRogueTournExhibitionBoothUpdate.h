...
#define RPG_GAMECORE_WAITROGUETOURNEXHIBITIONBOOTHUPDATE_METHOD_4_337F67224CFB6F59_OFFSET UNITYSDK_OFFSET(0x179037C0)
#define RPG_GAMECORE_WAITROGUETOURNEXHIBITIONBOOTHUPDATE_METHOD_4_D74E9117AE22CC87_OFFSET UNITYSDK_OFFSET(0x179036E0)
#define RPG_GAMECORE_WAITROGUETOURNEXHIBITIONBOOTHUPDATE__CTOR_OFFSET UNITYSDK_OFFSET(0x17903760)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitRogueTournExhibitionBoothUpdate_TypeDefinitionIndex = 20299;
