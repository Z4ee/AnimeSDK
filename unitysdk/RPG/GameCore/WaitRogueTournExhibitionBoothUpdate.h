...
#define RPG_GAMECORE_WAITROGUETOURNEXHIBITIONBOOTHUPDATE_METHOD_4_337F67224CFB6F59_OFFSET UNITYSDK_OFFSET(0x1D1BB5B0)
#define RPG_GAMECORE_WAITROGUETOURNEXHIBITIONBOOTHUPDATE_METHOD_4_683CD471AC5199BC_OFFSET UNITYSDK_OFFSET(0x1D1BB560)
#define RPG_GAMECORE_WAITROGUETOURNEXHIBITIONBOOTHUPDATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1BB5A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitRogueTournExhibitionBoothUpdate_TypeDefinitionIndex = 21308;
