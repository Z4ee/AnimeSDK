...
#define RPG_GAMECORE_FATEACTADDSHOPFREEREFRESHCOUNTBYPARAMCONFIG_METHOD_6_67EC39212D10E020_OFFSET UNITYSDK_OFFSET(0x171C10D0)
#define RPG_GAMECORE_FATEACTADDSHOPFREEREFRESHCOUNTBYPARAMCONFIG_METHOD_6_F7749FC5E872364B_OFFSET UNITYSDK_OFFSET(0x171C1240)
#define RPG_GAMECORE_FATEACTADDSHOPFREEREFRESHCOUNTBYPARAMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171C11A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateActAddShopFreeRefreshCountByParamConfig_TypeDefinitionIndex = 17650;
