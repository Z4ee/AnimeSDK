...
#define RPG_GAMECORE_FIVEDIMDOORCONFIG_METHOD_3_0D372435D9CAE4BC_OFFSET UNITYSDK_OFFSET(0x19739330)
#define RPG_GAMECORE_FIVEDIMDOORCONFIG_METHOD_3_2AAEC2282D173F5F_OFFSET UNITYSDK_OFFSET(0x197392C0)
#define RPG_GAMECORE_FIVEDIMDOORCONFIG_METHOD_3_C0A12BF04F855754_OFFSET UNITYSDK_OFFSET(0x19738F90)
#define RPG_GAMECORE_FIVEDIMDOORCONFIG_METHOD_3_D4BAA86619FFD488_OFFSET UNITYSDK_OFFSET(0x19739020)
#define RPG_GAMECORE_FIVEDIMDOORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19738FF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimDoorConfig_TypeDefinitionIndex = 17689;
	...
	public:
		...
		static ::System::Void Method_3_C0A12BF04F855754(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::FiveDimDoorConfig*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::FiveDimDoorConfig*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_FIVEDIMDOORCONFIG_METHOD_3_C0A12BF04F855754_OFFSET))(a1, a2);
		}
