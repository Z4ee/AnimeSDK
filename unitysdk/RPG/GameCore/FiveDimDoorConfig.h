...
#define RPG_GAMECORE_FIVEDIMDOORCONFIG_METHOD_3_2AAEC2282D173F5F_OFFSET UNITYSDK_OFFSET(0x171EF8D0)
#define RPG_GAMECORE_FIVEDIMDOORCONFIG_METHOD_3_505EE027A7E5EC63_OFFSET UNITYSDK_OFFSET(0x171EF640)
#define RPG_GAMECORE_FIVEDIMDOORCONFIG_METHOD_3_8D87B72FD1FC440D_OFFSET UNITYSDK_OFFSET(0x171EF5B0)
#define RPG_GAMECORE_FIVEDIMDOORCONFIG_METHOD_3_BB881F05E41D3A04_OFFSET UNITYSDK_OFFSET(0x171EF940)
#define RPG_GAMECORE_FIVEDIMDOORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171EF610)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimDoorConfig_TypeDefinitionIndex = 17064;
