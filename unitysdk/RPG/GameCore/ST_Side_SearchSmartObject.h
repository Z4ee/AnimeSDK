...
#define RPG_GAMECORE_ST_SIDE_SEARCHSMARTOBJECT_METHOD_4_95730021841446A7_OFFSET UNITYSDK_OFFSET(0x19C1B1F0)
#define RPG_GAMECORE_ST_SIDE_SEARCHSMARTOBJECT_METHOD_4_AF5216FD351C88AD_OFFSET UNITYSDK_OFFSET(0x19C0D710)
#define RPG_GAMECORE_ST_SIDE_SEARCHSMARTOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x19C0D6B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_SearchSmartObject_TypeDefinitionIndex = 18986;
