...
#define RPG_GAMECORE_ADVISOMETRICZOOMLISTENER_METHOD_3_46B73FD96AA25BCE_OFFSET UNITYSDK_OFFSET(0x1CDCCC20)
#define RPG_GAMECORE_ADVISOMETRICZOOMLISTENER_METHOD_3_FF06E938FB66A419_OFFSET UNITYSDK_OFFSET(0x1CDCCBE0)
#define RPG_GAMECORE_ADVISOMETRICZOOMLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDCCC10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvIsometricZoomListener_TypeDefinitionIndex = 21964;
