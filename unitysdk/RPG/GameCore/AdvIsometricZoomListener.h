...
#define RPG_GAMECORE_ADVISOMETRICZOOMLISTENER_METHOD_3_339114C33656AB14_OFFSET UNITYSDK_OFFSET(0x186545D0)
#define RPG_GAMECORE_ADVISOMETRICZOOMLISTENER_METHOD_3_6153D53656EDEB84_OFFSET UNITYSDK_OFFSET(0x18654550)
#define RPG_GAMECORE_ADVISOMETRICZOOMLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x186545A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvIsometricZoomListener_TypeDefinitionIndex = 21084;
