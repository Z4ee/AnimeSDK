...
#define RPG_GAMECORE_ACTIVITYRAIDCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x194011A0)
#define RPG_GAMECORE_ACTIVITYRAIDCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x194017D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityRaidConfigRow_TypeDefinitionIndex = 13868;
	...
	public:
		...
		::System::UInt32 ActivityQuestID; // 0x1C
