...
#define RPG_GAMECORE_ACTIVITYRAIDCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1AB09C60)
#define RPG_GAMECORE_ACTIVITYRAIDCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB0A290)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityRaidConfigRow_TypeDefinitionIndex = 14016;
