...
#define RPG_GAMECORE_ACTIVITYRAIDCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CDA5CC0)
#define RPG_GAMECORE_ACTIVITYRAIDCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDA62F0)
