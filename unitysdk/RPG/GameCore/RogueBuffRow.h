...
#define RPG_GAMECORE_ROGUEBUFFROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C4A9840)
#define RPG_GAMECORE_ROGUEBUFFROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4AA200)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueBuffRow_TypeDefinitionIndex = 14146;
	...
	public:
		...
		::RPG::GameCore::RogueBuffCategory RogueBuffCategory; // 0x28
		...
		::System::UInt32 RogueBuffType; // 0x54
