...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONROOMFINISHCONFIG_METHOD_3_1F69DEA5057F2F7C_OFFSET UNITYSDK_OFFSET(0x19B53300)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONROOMFINISHCONFIG_METHOD_3_FA5E099711E1BB85_OFFSET UNITYSDK_OFFSET(0x19B5DCA0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONROOMFINISHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B532B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnRoomFinishConfig_TypeDefinitionIndex = 16813;
