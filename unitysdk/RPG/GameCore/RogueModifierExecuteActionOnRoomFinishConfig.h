...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONROOMFINISHCONFIG_METHOD_3_1F69DEA5057F2F7C_OFFSET UNITYSDK_OFFSET(0x1CFC0F10)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONROOMFINISHCONFIG_METHOD_3_B154375087DA7080_OFFSET UNITYSDK_OFFSET(0x1CFC0EC0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONROOMFINISHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFC0F00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnRoomFinishConfig_TypeDefinitionIndex = 16975;
