...
#define RPG_GAMECORE_FLOORCONSTVALUESYNCTEMPLATECONFIG_METHOD_2_9FD804C90432C869_OFFSET UNITYSDK_OFFSET(0x1DCACB90)
#define RPG_GAMECORE_FLOORCONSTVALUESYNCTEMPLATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCACBD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FloorConstValueSyncTemplateConfig_TypeDefinitionIndex = 17212;
