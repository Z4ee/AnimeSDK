...
#define RPG_GAMECORE_PARALLELABILITY_METHOD_2_EB4C0F572024977D_OFFSET UNITYSDK_OFFSET(0x1D412580)
#define RPG_GAMECORE_PARALLELABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D412890)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ParallelAbility_TypeDefinitionIndex = 22434;
