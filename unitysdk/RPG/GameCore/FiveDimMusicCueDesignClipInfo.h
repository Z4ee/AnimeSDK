...
#define RPG_GAMECORE_FIVEDIMMUSICCUEDESIGNCLIPINFO_METHOD_2_90136D0DFDA1B2CA_OFFSET UNITYSDK_OFFSET(0x1BEA5A90)
#define RPG_GAMECORE_FIVEDIMMUSICCUEDESIGNCLIPINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEA5CB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimMusicCueDesignClipInfo_TypeDefinitionIndex = 18084;
