...
#define RPG_GAMECORE_RECORDUSEAVATARGLOBALBUFF_METHOD_3_BD305AE5EC3351D3_OFFSET UNITYSDK_OFFSET(0x19AB80F0)
#define RPG_GAMECORE_RECORDUSEAVATARGLOBALBUFF_METHOD_3_F3C7C87B2DC1B1DA_OFFSET UNITYSDK_OFFSET(0x19AB8070)
#define RPG_GAMECORE_RECORDUSEAVATARGLOBALBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x19AB80C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RecordUseAvatarGlobalBuff_TypeDefinitionIndex = 22142;
