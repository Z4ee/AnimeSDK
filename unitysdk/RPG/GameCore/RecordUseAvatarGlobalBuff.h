...
#define RPG_GAMECORE_RECORDUSEAVATARGLOBALBUFF_METHOD_3_BD305AE5EC3351D3_OFFSET UNITYSDK_OFFSET(0x18C93C10)
#define RPG_GAMECORE_RECORDUSEAVATARGLOBALBUFF_METHOD_3_F3C7C87B2DC1B1DA_OFFSET UNITYSDK_OFFSET(0x18C93B90)
#define RPG_GAMECORE_RECORDUSEAVATARGLOBALBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x18C93BE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RecordUseAvatarGlobalBuff_TypeDefinitionIndex = 22387;
