...
#define RPG_GAMECORE_RECORDUSEAVATARGLOBALBUFF_METHOD_3_BD305AE5EC3351D3_OFFSET UNITYSDK_OFFSET(0x1B9BF830)
#define RPG_GAMECORE_RECORDUSEAVATARGLOBALBUFF_METHOD_3_DA1E440FFFE21568_OFFSET UNITYSDK_OFFSET(0x1B9BF7F0)
#define RPG_GAMECORE_RECORDUSEAVATARGLOBALBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9BF820)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RecordUseAvatarGlobalBuff_TypeDefinitionIndex = 22579;
