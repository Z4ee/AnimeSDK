...
#define RPG_GAMECORE_ROGUEMAGICENTERNEXTROOM_METHOD_3_F9B1DE3B1AE36DFC_OFFSET UNITYSDK_OFFSET(0x17613620)
#define RPG_GAMECORE_ROGUEMAGICENTERNEXTROOM_METHOD_3_F9F761549560FF30_OFFSET UNITYSDK_OFFSET(0x17613510)
#define RPG_GAMECORE_ROGUEMAGICENTERNEXTROOM__CTOR_OFFSET UNITYSDK_OFFSET(0x176135F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueMagicEnterNextRoom_TypeDefinitionIndex = 20306;
