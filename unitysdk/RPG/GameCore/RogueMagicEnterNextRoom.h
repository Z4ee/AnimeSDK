...
#define RPG_GAMECORE_ROGUEMAGICENTERNEXTROOM_METHOD_3_F76A2624D491B2F9_OFFSET UNITYSDK_OFFSET(0x1CFB5DF0)
#define RPG_GAMECORE_ROGUEMAGICENTERNEXTROOM_METHOD_3_F9B1DE3B1AE36DFC_OFFSET UNITYSDK_OFFSET(0x1CFB5EC0)
#define RPG_GAMECORE_ROGUEMAGICENTERNEXTROOM__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFB5EB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueMagicEnterNextRoom_TypeDefinitionIndex = 21315;
