...
#define RPG_GAMECORE_ROGUEMAGICENTERNEXTROOM_METHOD_3_F9B1DE3B1AE36DFC_OFFSET UNITYSDK_OFFSET(0x19B44C40)
#define RPG_GAMECORE_ROGUEMAGICENTERNEXTROOM_METHOD_3_F9F761549560FF30_OFFSET UNITYSDK_OFFSET(0x19B44B30)
#define RPG_GAMECORE_ROGUEMAGICENTERNEXTROOM__CTOR_OFFSET UNITYSDK_OFFSET(0x19B44C10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueMagicEnterNextRoom_TypeDefinitionIndex = 20900;
