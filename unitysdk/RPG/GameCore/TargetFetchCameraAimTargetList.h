...
#define RPG_GAMECORE_TARGETFETCHCAMERAAIMTARGETLIST_METHOD_4_1A1CD5C15A6FE689_OFFSET UNITYSDK_OFFSET(0x1D0B8B40)
#define RPG_GAMECORE_TARGETFETCHCAMERAAIMTARGETLIST_METHOD_4_99D75E4291C7528C_OFFSET UNITYSDK_OFFSET(0x1D0B8A40)
#define RPG_GAMECORE_TARGETFETCHCAMERAAIMTARGETLIST_METHOD_4_AAD384370C0954BC_OFFSET UNITYSDK_OFFSET(0x1D0B8B20)
#define RPG_GAMECORE_TARGETFETCHCAMERAAIMTARGETLIST_METHOD_4_F6CD532782A73221_OFFSET UNITYSDK_OFFSET(0x1D0B8AC0)
#define RPG_GAMECORE_TARGETFETCHCAMERAAIMTARGETLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0B8AB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchCameraAimTargetList_TypeDefinitionIndex = 23176;
