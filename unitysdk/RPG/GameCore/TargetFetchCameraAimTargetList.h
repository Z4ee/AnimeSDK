...
#define RPG_GAMECORE_TARGETFETCHCAMERAAIMTARGETLIST_METHOD_4_1A1CD5C15A6FE689_OFFSET UNITYSDK_OFFSET(0x19D0C090)
#define RPG_GAMECORE_TARGETFETCHCAMERAAIMTARGETLIST_METHOD_4_97B084E20D3A3E79_OFFSET UNITYSDK_OFFSET(0x19D04CB0)
#define RPG_GAMECORE_TARGETFETCHCAMERAAIMTARGETLIST_METHOD_4_9F82A993A8CCA47F_OFFSET UNITYSDK_OFFSET(0x19D0BFD0)
#define RPG_GAMECORE_TARGETFETCHCAMERAAIMTARGETLIST_METHOD_4_F6CD532782A73221_OFFSET UNITYSDK_OFFSET(0x19CF7FD0)
#define RPG_GAMECORE_TARGETFETCHCAMERAAIMTARGETLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x19CF7F80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchCameraAimTargetList_TypeDefinitionIndex = 22709;
	...
	public:
		...
		static ::System::Void Method_4_97B084E20D3A3E79(::SimpleJSON::JSONNode* a1, ::RPG::GameCore::TargetFetchCameraAimTargetList*& a2)
		{
			return ((::System::Void(*)(::SimpleJSON::JSONNode*, ::RPG::GameCore::TargetFetchCameraAimTargetList*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_TARGETFETCHCAMERAAIMTARGETLIST_METHOD_4_97B084E20D3A3E79_OFFSET))(a1, a2);
		}
