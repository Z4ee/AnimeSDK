...
#define RPG_GAMECORE_PAUSETIMEREWINDTARGET_METHOD_3_230287D4DEE482CA_OFFSET UNITYSDK_OFFSET(0x1748EF90)
#define RPG_GAMECORE_PAUSETIMEREWINDTARGET_METHOD_3_A9BB3D1375506E0D_OFFSET UNITYSDK_OFFSET(0x1748F030)
#define RPG_GAMECORE_PAUSETIMEREWINDTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1748EFF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PauseTimeRewindTarget_TypeDefinitionIndex = 18972;
