...
#define RPG_GAMECORE_PAUSETIMEREWINDTARGET_METHOD_3_933C89A73B271A15_OFFSET UNITYSDK_OFFSET(0x1D418EA0)
#define RPG_GAMECORE_PAUSETIMEREWINDTARGET_METHOD_3_A9BB3D1375506E0D_OFFSET UNITYSDK_OFFSET(0x1D418EF0)
#define RPG_GAMECORE_PAUSETIMEREWINDTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1D418EE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PauseTimeRewindTarget_TypeDefinitionIndex = 20420;
