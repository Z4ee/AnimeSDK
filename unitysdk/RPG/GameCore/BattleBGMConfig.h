...
#define RPG_GAMECORE_BATTLEBGMCONFIG_METHOD_2_9AEE972880513F9A_OFFSET UNITYSDK_OFFSET(0x16FCC560)
#define RPG_GAMECORE_BATTLEBGMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16FCC630)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleBGMConfig_TypeDefinitionIndex = 16628;
