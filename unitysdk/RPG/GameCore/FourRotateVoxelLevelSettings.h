...
#define RPG_GAMECORE_FOURROTATEVOXELLEVELSETTINGS_METHOD_3_20045C5A9C26E043_OFFSET UNITYSDK_OFFSET(0x1721CD40)
#define RPG_GAMECORE_FOURROTATEVOXELLEVELSETTINGS_METHOD_3_6D1906CEE8279282_OFFSET UNITYSDK_OFFSET(0x1721CD00)
#define RPG_GAMECORE_FOURROTATEVOXELLEVELSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1721CD30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FourRotateVoxelLevelSettings_TypeDefinitionIndex = 15350;
