...
#define RPG_GAMECORE_IRONTOMBNORMALMODETHRESHOLDCONFIG_METHOD_2_E12940A82832E48E_OFFSET UNITYSDK_OFFSET(0x19855520)
#define RPG_GAMECORE_IRONTOMBNORMALMODETHRESHOLDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19855740)

namespace RPG::GameCore
{
	inline static constexpr unsigned int IronTombNormalModeThresholdConfig_TypeDefinitionIndex = 21560;
