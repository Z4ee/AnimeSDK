...
#define RPG_GAMECORE_IRONTOMBNORMALMODETHRESHOLDCONFIG_METHOD_2_E12940A82832E48E_OFFSET UNITYSDK_OFFSET(0x1D1B1450)
#define RPG_GAMECORE_IRONTOMBNORMALMODETHRESHOLDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1B1670)
