...
#define RPG_GAMECORE_FIVEDIMKILLAVATAREFFECTACTION_METHOD_3_030DED4C7EFFBB83_OFFSET UNITYSDK_OFFSET(0x171F8030)
#define RPG_GAMECORE_FIVEDIMKILLAVATAREFFECTACTION_METHOD_3_CEA6649083563C97_OFFSET UNITYSDK_OFFSET(0x171E8930)
#define RPG_GAMECORE_FIVEDIMKILLAVATAREFFECTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x171E8910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimKillAvatarEffectAction_TypeDefinitionIndex = 17203;
