...
#define RPG_GAMECORE_FIVEDIMKILLAVATAREFFECTACTION_METHOD_3_030DED4C7EFFBB83_OFFSET UNITYSDK_OFFSET(0x18907940)
#define RPG_GAMECORE_FIVEDIMKILLAVATAREFFECTACTION_METHOD_3_CEA6649083563C97_OFFSET UNITYSDK_OFFSET(0x188F6380)
#define RPG_GAMECORE_FIVEDIMKILLAVATAREFFECTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18907A00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimKillAvatarEffectAction_TypeDefinitionIndex = 17805;
