...
#define RPG_GAMECORE_FIVEDIMKILLAVATAREFFECTACTION_METHOD_3_B0AEA76F045F563A_OFFSET UNITYSDK_OFFSET(0x1D0ED720)
#define RPG_GAMECORE_FIVEDIMKILLAVATAREFFECTACTION_METHOD_3_CEA6649083563C97_OFFSET UNITYSDK_OFFSET(0x1D0ED7D0)
#define RPG_GAMECORE_FIVEDIMKILLAVATAREFFECTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0ED7C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimKillAvatarEffectAction_TypeDefinitionIndex = 18532;
