...
#define RPG_GAMECORE_ROGUECONDBUFFCOUNTCONFIG_METHOD_6_33FC108B88E63610_OFFSET UNITYSDK_OFFSET(0x1D3CB900)
#define RPG_GAMECORE_ROGUECONDBUFFCOUNTCONFIG_METHOD_6_D43A46B407847514_OFFSET UNITYSDK_OFFSET(0x1D3CB8B0)
#define RPG_GAMECORE_ROGUECONDBUFFCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3CB8F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueCondBuffCountConfig_TypeDefinitionIndex = 19564;
