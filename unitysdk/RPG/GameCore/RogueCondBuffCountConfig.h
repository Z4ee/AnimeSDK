...
#define RPG_GAMECORE_ROGUECONDBUFFCOUNTCONFIG_METHOD_6_05225DB7E8CFD886_OFFSET UNITYSDK_OFFSET(0x19B1B490)
#define RPG_GAMECORE_ROGUECONDBUFFCOUNTCONFIG_METHOD_6_33FC108B88E63610_OFFSET UNITYSDK_OFFSET(0x19B1B740)
#define RPG_GAMECORE_ROGUECONDBUFFCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B1B610)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueCondBuffCountConfig_TypeDefinitionIndex = 18750;
