...
#define RPG_GAMECORE_BYISTEAMLOCATIONINDEXTYPE_METHOD_4_F38CD3B43677ED7F_OFFSET UNITYSDK_OFFSET(0x18759390)
#define RPG_GAMECORE_BYISTEAMLOCATIONINDEXTYPE_METHOD_4_F8A14D41C03D8219_OFFSET UNITYSDK_OFFSET(0x187592B0)
#define RPG_GAMECORE_BYISTEAMLOCATIONINDEXTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x18759330)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsTeamLocationIndexType_TypeDefinitionIndex = 21956;
