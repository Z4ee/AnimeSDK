...
#define RPG_GAMECORE_SWITCHHANDRESETGAME_METHOD_3_8B6E6B73C860A32D_OFFSET UNITYSDK_OFFSET(0x18EBB840)
#define RPG_GAMECORE_SWITCHHANDRESETGAME_METHOD_3_A12E072C76515B54_OFFSET UNITYSDK_OFFSET(0x18EBB7C0)
#define RPG_GAMECORE_SWITCHHANDRESETGAME__CTOR_OFFSET UNITYSDK_OFFSET(0x18EBB810)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchHandResetGame_TypeDefinitionIndex = 19948;
