...
#define RPG_GAMECORE_SWITCHHANDRESETGAME_METHOD_3_8B6E6B73C860A32D_OFFSET UNITYSDK_OFFSET(0x177955E0)
#define RPG_GAMECORE_SWITCHHANDRESETGAME_METHOD_3_A12E072C76515B54_OFFSET UNITYSDK_OFFSET(0x17795560)
#define RPG_GAMECORE_SWITCHHANDRESETGAME__CTOR_OFFSET UNITYSDK_OFFSET(0x177955B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchHandResetGame_TypeDefinitionIndex = 19289;
