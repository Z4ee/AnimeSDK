...
#define RPG_GAMECORE_BATTLERAIDTARGETCHANGEPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0xA88D020)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleRaidTargetChangeParams_TypeDefinitionIndex = 47267;
