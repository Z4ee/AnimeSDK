...
#define RPG_GAMECORE_CHENLINGBATTLEPREDICATE_INWAVE_METHOD_3_3CC6D23F4B5BACAF_OFFSET UNITYSDK_OFFSET(0x1C37D070)
#define RPG_GAMECORE_CHENLINGBATTLEPREDICATE_INWAVE_METHOD_3_8B36E2E9EBF923FB_OFFSET UNITYSDK_OFFSET(0x1C37D140)
#define RPG_GAMECORE_CHENLINGBATTLEPREDICATE_INWAVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C37D130)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattlePredicate_InWave_TypeDefinitionIndex = 15207;
