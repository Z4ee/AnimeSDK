...
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_ONCREATUREDAMAGEWITHPROBABILITY_METHOD_3_C8645ECA68158880_OFFSET UNITYSDK_OFFSET(0x1961AFA0)
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_ONCREATUREDAMAGEWITHPROBABILITY_METHOD_3_F028F19D7C22E234_OFFSET UNITYSDK_OFFSET(0x1961AED0)
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_ONCREATUREDAMAGEWITHPROBABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1961AF90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleAbilityConditionChecker_OnCreatureDamageWithProbability_TypeDefinitionIndex = 14956;
