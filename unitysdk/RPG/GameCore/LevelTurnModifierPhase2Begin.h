...
#define RPG_GAMECORE_LEVELTURNMODIFIERPHASE2BEGIN_GETACTIVEENTITY_OFFSET UNITYSDK_OFFSET(0xCE4F560)
#define RPG_GAMECORE_LEVELTURNMODIFIERPHASE2BEGIN_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xCE4F510)
#define RPG_GAMECORE_LEVELTURNMODIFIERPHASE2BEGIN_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xCE4F4C0)
#define RPG_GAMECORE_LEVELTURNMODIFIERPHASE2BEGIN_GETTURNCOUNTER_OFFSET UNITYSDK_OFFSET(0xCE4F5A0)
#define RPG_GAMECORE_LEVELTURNMODIFIERPHASE2BEGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xCE4F4B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelTurnModifierPhase2Begin_TypeDefinitionIndex = 52953;
