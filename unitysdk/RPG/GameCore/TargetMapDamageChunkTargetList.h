...
#define RPG_GAMECORE_TARGETMAPDAMAGECHUNKTARGETLIST_METHOD_3_7EC1DC801A5784C8_OFFSET UNITYSDK_OFFSET(0x18EE85D0)
#define RPG_GAMECORE_TARGETMAPDAMAGECHUNKTARGETLIST_METHOD_3_87F8983D39A6305A_OFFSET UNITYSDK_OFFSET(0x18EE86B0)
#define RPG_GAMECORE_TARGETMAPDAMAGECHUNKTARGETLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x18EE8690)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapDamageChunkTargetList_TypeDefinitionIndex = 23011;
