...
#define RPG_GAMECORE_ENABLEROGUEENTER_METHOD_3_3F80DA2054B12D03_OFFSET UNITYSDK_OFFSET(0x17199C20)
#define RPG_GAMECORE_ENABLEROGUEENTER_METHOD_3_DD4D63303B5AA3CC_OFFSET UNITYSDK_OFFSET(0x17199C90)
#define RPG_GAMECORE_ENABLEROGUEENTER__CTOR_OFFSET UNITYSDK_OFFSET(0x17199C60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnableRogueEnter_TypeDefinitionIndex = 18782;
