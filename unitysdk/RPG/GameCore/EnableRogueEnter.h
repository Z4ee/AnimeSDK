...
#define RPG_GAMECORE_ENABLEROGUEENTER_METHOD_3_51C5B50AFD95C399_OFFSET UNITYSDK_OFFSET(0x1BB41740)
#define RPG_GAMECORE_ENABLEROGUEENTER_METHOD_3_DD4D63303B5AA3CC_OFFSET UNITYSDK_OFFSET(0x1BB41780)
#define RPG_GAMECORE_ENABLEROGUEENTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB41770)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnableRogueEnter_TypeDefinitionIndex = 19700;
