...
#define RPG_GAMECORE_STARTCONTROLTIMEREWINDENTITY_METHOD_3_BA2C253F875455E6_OFFSET UNITYSDK_OFFSET(0x17774290)
#define RPG_GAMECORE_STARTCONTROLTIMEREWINDENTITY_METHOD_3_F95DEC57BCB7621C_OFFSET UNITYSDK_OFFSET(0x17774210)
#define RPG_GAMECORE_STARTCONTROLTIMEREWINDENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x17774260)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StartControlTimeRewindEntity_TypeDefinitionIndex = 18953;
