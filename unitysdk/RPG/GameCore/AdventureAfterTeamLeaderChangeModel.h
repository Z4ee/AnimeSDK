...
#define RPG_GAMECORE_ADVENTUREAFTERTEAMLEADERCHANGEMODEL_CLEAR_OFFSET UNITYSDK_OFFSET(0x11262550)
#define RPG_GAMECORE_ADVENTUREAFTERTEAMLEADERCHANGEMODEL_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x11262590)
#define RPG_GAMECORE_ADVENTUREAFTERTEAMLEADERCHANGEMODEL_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x112625E0)
#define RPG_GAMECORE_ADVENTUREAFTERTEAMLEADERCHANGEMODEL_INIT_OFFSET UNITYSDK_OFFSET(0x11262510)
#define RPG_GAMECORE_ADVENTUREAFTERTEAMLEADERCHANGEMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x11262630)
