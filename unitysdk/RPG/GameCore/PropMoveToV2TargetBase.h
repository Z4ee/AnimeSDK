...
#define RPG_GAMECORE_PROPMOVETOV2TARGETBASE_METHOD_2_C5B85B3E3B45A948_OFFSET UNITYSDK_OFFSET(0x18C713A0)
#define RPG_GAMECORE_PROPMOVETOV2TARGETBASE_METHOD_2_EA56471AEE5A0F19_OFFSET UNITYSDK_OFFSET(0x18C710F0)
#define RPG_GAMECORE_PROPMOVETOV2TARGETBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x18C71390)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropMoveToV2TargetBase_TypeDefinitionIndex = 19293;
