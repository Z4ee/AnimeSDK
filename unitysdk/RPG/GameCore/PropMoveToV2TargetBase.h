...
#define RPG_GAMECORE_PROPMOVETOV2TARGETBASE_METHOD_2_1E6D86F2EF86AB3A_OFFSET UNITYSDK_OFFSET(0x1D17EA30)
#define RPG_GAMECORE_PROPMOVETOV2TARGETBASE_METHOD_2_C5B85B3E3B45A948_OFFSET UNITYSDK_OFFSET(0x1D17ECE0)
#define RPG_GAMECORE_PROPMOVETOV2TARGETBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D17ECD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropMoveToV2TargetBase_TypeDefinitionIndex = 20111;
