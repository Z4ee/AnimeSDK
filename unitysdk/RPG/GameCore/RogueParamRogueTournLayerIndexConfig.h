...
#define RPG_GAMECORE_ROGUEPARAMROGUETOURNLAYERINDEXCONFIG_METHOD_6_2A1868D81AF0B5AC_OFFSET UNITYSDK_OFFSET(0x1D40D860)
#define RPG_GAMECORE_ROGUEPARAMROGUETOURNLAYERINDEXCONFIG_METHOD_6_F321C9A8EDD8B928_OFFSET UNITYSDK_OFFSET(0x1D40D8B0)
#define RPG_GAMECORE_ROGUEPARAMROGUETOURNLAYERINDEXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D40D8A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamRogueTournLayerIndexConfig_TypeDefinitionIndex = 19604;
