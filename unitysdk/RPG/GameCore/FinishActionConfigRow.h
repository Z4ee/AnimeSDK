...
#define RPG_GAMECORE_FINISHACTIONCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D09B0D0)
#define RPG_GAMECORE_FINISHACTIONCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D09B230)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::FinishActionType FinishActionType; // 0x14
