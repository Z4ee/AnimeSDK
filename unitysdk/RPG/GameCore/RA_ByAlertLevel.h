...
#define RPG_GAMECORE_RA_BYALERTLEVEL_METHOD_4_1A723752AAB50AA0_OFFSET UNITYSDK_OFFSET(0x1D1904E0)
#define RPG_GAMECORE_RA_BYALERTLEVEL_METHOD_4_51801E32AA615D17_OFFSET UNITYSDK_OFFSET(0x1D1904B0)
#define RPG_GAMECORE_RA_BYALERTLEVEL_METHOD_4_75447B606F521C5D_OFFSET UNITYSDK_OFFSET(0x1D190330)
#define RPG_GAMECORE_RA_BYALERTLEVEL_METHOD_4_BC9F0EC923B2FA78_OFFSET UNITYSDK_OFFSET(0x1D1902F0)
#define RPG_GAMECORE_RA_BYALERTLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D190320)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RA_ByAlertLevel_TypeDefinitionIndex = 19813;
