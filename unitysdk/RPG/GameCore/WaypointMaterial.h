...
#define RPG_GAMECORE_WAYPOINTMATERIAL_METHOD_2_EA0E5B58C384F64B_OFFSET UNITYSDK_OFFSET(0x1D1C0A80)
#define RPG_GAMECORE_WAYPOINTMATERIAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1C0C10)
