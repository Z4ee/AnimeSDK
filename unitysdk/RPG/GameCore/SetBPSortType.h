...
#define RPG_GAMECORE_SETBPSORTTYPE_METHOD_3_C637EA2B98BAF4B1_OFFSET UNITYSDK_OFFSET(0x19C2A2B0)
#define RPG_GAMECORE_SETBPSORTTYPE_METHOD_3_D520E46724985372_OFFSET UNITYSDK_OFFSET(0x19C2A230)
#define RPG_GAMECORE_SETBPSORTTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C2A280)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetBPSortType_TypeDefinitionIndex = 21955;
