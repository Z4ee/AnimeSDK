...
#define RPG_GAMECORE_SETBATTLEACHIEVEMENT_METHOD_3_20A0441BF8EA421A_OFFSET UNITYSDK_OFFSET(0x176A8C70)
#define RPG_GAMECORE_SETBATTLEACHIEVEMENT_METHOD_3_41AF54801A4E8194_OFFSET UNITYSDK_OFFSET(0x176A8D90)
#define RPG_GAMECORE_SETBATTLEACHIEVEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x176A8D10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetBattleAchievement_TypeDefinitionIndex = 21399;
