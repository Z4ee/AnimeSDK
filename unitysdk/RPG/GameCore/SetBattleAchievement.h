...
#define RPG_GAMECORE_SETBATTLEACHIEVEMENT_METHOD_3_20A0441BF8EA421A_OFFSET UNITYSDK_OFFSET(0x1C2D3D20)
#define RPG_GAMECORE_SETBATTLEACHIEVEMENT_METHOD_3_41AF54801A4E8194_OFFSET UNITYSDK_OFFSET(0x1C2D3E20)
#define RPG_GAMECORE_SETBATTLEACHIEVEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2D3DB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetBattleAchievement_TypeDefinitionIndex = 22346;
