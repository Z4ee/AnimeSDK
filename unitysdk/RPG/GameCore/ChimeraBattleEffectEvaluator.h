...
#define RPG_GAMECORE_CHIMERABATTLEEFFECTEVALUATOR_METHOD_3_0697352EEBA27404_OFFSET UNITYSDK_OFFSET(0x1CFBE030)
#define RPG_GAMECORE_CHIMERABATTLEEFFECTEVALUATOR_METHOD_3_55BEE487A7C0A7D0_OFFSET UNITYSDK_OFFSET(0x1CFBDDE0)
#define RPG_GAMECORE_CHIMERABATTLEEFFECTEVALUATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFBDDD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraBattleEffectEvaluator_TypeDefinitionIndex = 15661;
