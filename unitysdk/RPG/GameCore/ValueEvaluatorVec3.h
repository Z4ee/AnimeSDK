...
#define RPG_GAMECORE_VALUEEVALUATORVEC3_METHOD_2_68F29CB8F0377FB8_OFFSET UNITYSDK_OFFSET(0x190F1580)
#define RPG_GAMECORE_VALUEEVALUATORVEC3__CTOR_OFFSET UNITYSDK_OFFSET(0x190F1660)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ValueEvaluatorVec3_TypeDefinitionIndex = 23028;
