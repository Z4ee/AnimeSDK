...
#define RPG_GAMECORE_FLOORCUSTOMSTRINGCONFIG_METHOD_3_77F59B264FAEE1EE_OFFSET UNITYSDK_OFFSET(0x1BEBBE40)
#define RPG_GAMECORE_FLOORCUSTOMSTRINGCONFIG_METHOD_3_A5023B795C23CF65_OFFSET UNITYSDK_OFFSET(0x1BEBBCE0)
#define RPG_GAMECORE_FLOORCUSTOMSTRINGCONFIG_METHOD_3_CE46B4EAA1C6EFF8_OFFSET UNITYSDK_OFFSET(0x1BEBBE10)
#define RPG_GAMECORE_FLOORCUSTOMSTRINGCONFIG_METHOD_3_D11908D1863479F2_OFFSET UNITYSDK_OFFSET(0x1BEBBCA0)
#define RPG_GAMECORE_FLOORCUSTOMSTRINGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEBBCD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FloorCustomStringConfig_TypeDefinitionIndex = 17551;
