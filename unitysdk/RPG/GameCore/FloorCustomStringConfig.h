...
#define RPG_GAMECORE_FLOORCUSTOMSTRINGCONFIG_METHOD_3_A5023B795C23CF65_OFFSET UNITYSDK_OFFSET(0x18926800)
#define RPG_GAMECORE_FLOORCUSTOMSTRINGCONFIG_METHOD_3_D11908D1863479F2_OFFSET UNITYSDK_OFFSET(0x189267C0)
#define RPG_GAMECORE_FLOORCUSTOMSTRINGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189267F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FloorCustomStringConfig_TypeDefinitionIndex = 17373;
