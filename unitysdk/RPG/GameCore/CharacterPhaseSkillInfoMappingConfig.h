...
#define RPG_GAMECORE_CHARACTERPHASESKILLINFOMAPPINGCONFIG_METHOD_2_57492CA46A37658D_OFFSET UNITYSDK_OFFSET(0x1CF9BDC0)
#define RPG_GAMECORE_CHARACTERPHASESKILLINFOMAPPINGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF9BEA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterPhaseSkillInfoMappingConfig_TypeDefinitionIndex = 16361;
