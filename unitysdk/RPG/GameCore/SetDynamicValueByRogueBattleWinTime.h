...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEBATTLEWINTIME_METHOD_3_AE9D9104D530B75C_OFFSET UNITYSDK_OFFSET(0x176C3210)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEBATTLEWINTIME_METHOD_3_FF343822839EA7C3_OFFSET UNITYSDK_OFFSET(0x176C3280)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEBATTLEWINTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x176C3250)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRogueBattleWinTime_TypeDefinitionIndex = 19948;
