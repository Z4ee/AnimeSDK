...
#define RPG_GAMECORE_TIMEREWINDSPECULARSTATEDURATIONCONFIG_METHOD_2_6B366FB7E757AE27_OFFSET UNITYSDK_OFFSET(0x19DE7F80)
#define RPG_GAMECORE_TIMEREWINDSPECULARSTATEDURATIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19DE8090)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TimeRewindSpecularStateDurationConfig_TypeDefinitionIndex = 15771;
