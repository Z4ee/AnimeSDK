...
#define RPG_GAMECORE_STAGEVOLUMECOMPONENTDATA_METHOD_2_3E0553BA6D3E680F_OFFSET UNITYSDK_OFFSET(0x1B0B5990)
#define RPG_GAMECORE_STAGEVOLUMECOMPONENTDATA_METHOD_2_66428440DA99740A_OFFSET UNITYSDK_OFFSET(0x1B0B5D40)
#define RPG_GAMECORE_STAGEVOLUMECOMPONENTDATA_METHOD_2_A87870A41735DA06_OFFSET UNITYSDK_OFFSET(0x1B0B63E0)
#define RPG_GAMECORE_STAGEVOLUMECOMPONENTDATA_METHOD_2_F3AEEDCAC183F672_OFFSET UNITYSDK_OFFSET(0x1B0B6900)
#define RPG_GAMECORE_STAGEVOLUMECOMPONENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0B5D30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StageVolumeComponentData_TypeDefinitionIndex = 18369;
