...
#define RPG_GAMECORE_CONDLOGICNOTCONFIG_METHOD_4_4364FD2A1A5BEF08_OFFSET UNITYSDK_OFFSET(0x1BC2A4C0)
#define RPG_GAMECORE_CONDLOGICNOTCONFIG_METHOD_4_F5B096D259BC953A_OFFSET UNITYSDK_OFFSET(0x1BC2A520)
#define RPG_GAMECORE_CONDLOGICNOTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC2A510)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CondLogicNotConfig_TypeDefinitionIndex = 16393;
