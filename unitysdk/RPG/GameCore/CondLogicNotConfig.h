...
#define RPG_GAMECORE_CONDLOGICNOTCONFIG_METHOD_4_480FDCAFD45CFA83_OFFSET UNITYSDK_OFFSET(0x18831A30)
#define RPG_GAMECORE_CONDLOGICNOTCONFIG_METHOD_4_C1EF9C2E91CBECCE_OFFSET UNITYSDK_OFFSET(0x188318F0)
#define RPG_GAMECORE_CONDLOGICNOTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x188319B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CondLogicNotConfig_TypeDefinitionIndex = 16164;
