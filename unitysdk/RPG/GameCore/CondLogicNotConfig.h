...
#define RPG_GAMECORE_CONDLOGICNOTCONFIG_METHOD_4_480FDCAFD45CFA83_OFFSET UNITYSDK_OFFSET(0x1712AB40)
#define RPG_GAMECORE_CONDLOGICNOTCONFIG_METHOD_4_C1EF9C2E91CBECCE_OFFSET UNITYSDK_OFFSET(0x1712AA00)
#define RPG_GAMECORE_CONDLOGICNOTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1712AAC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CondLogicNotConfig_TypeDefinitionIndex = 15642;
