...
#define RPG_GAMECORE_MONSTERHPBARSTYLECOLORSETTING_METHOD_2_54A35CD2A5CFACD7_OFFSET UNITYSDK_OFFSET(0x1D2D3EE0)
#define RPG_GAMECORE_MONSTERHPBARSTYLECOLORSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2D4010)
