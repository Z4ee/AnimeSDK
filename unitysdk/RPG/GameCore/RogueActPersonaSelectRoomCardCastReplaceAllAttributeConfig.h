...
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTREPLACEALLATTRIBUTECONFIG_METHOD_7_520AECE3AA43572C_OFFSET UNITYSDK_OFFSET(0x19AF32A0)
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTREPLACEALLATTRIBUTECONFIG_METHOD_7_838D4DFDDD9AB2B1_OFFSET UNITYSDK_OFFSET(0x19AF3E50)
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTREPLACEALLATTRIBUTECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AF31C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaSelectRoomCardCastReplaceAllAttributeConfig_TypeDefinitionIndex = 18698;
