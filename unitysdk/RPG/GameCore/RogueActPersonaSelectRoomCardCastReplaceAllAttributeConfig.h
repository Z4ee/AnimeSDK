...
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTREPLACEALLATTRIBUTECONFIG_METHOD_7_520AECE3AA43572C_OFFSET UNITYSDK_OFFSET(0x1D030540)
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTREPLACEALLATTRIBUTECONFIG_METHOD_7_C2F94549FD653130_OFFSET UNITYSDK_OFFSET(0x1D030780)
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTREPLACEALLATTRIBUTECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D030530)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaSelectRoomCardCastReplaceAllAttributeConfig_TypeDefinitionIndex = 18974;
