...
#define RPG_GAMECORE_SHOWFUNCUNLOCKHINTDIALOG_METHOD_3_273F6D7E08EAD58F_OFFSET UNITYSDK_OFFSET(0x18E5F330)
#define RPG_GAMECORE_SHOWFUNCUNLOCKHINTDIALOG_METHOD_3_849C10DADCD26CD1_OFFSET UNITYSDK_OFFSET(0x18E5F2B0)
#define RPG_GAMECORE_SHOWFUNCUNLOCKHINTDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x18E5F300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowFuncUnlockHintDialog_TypeDefinitionIndex = 23297;
