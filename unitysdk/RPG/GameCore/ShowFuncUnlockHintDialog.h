...
#define RPG_GAMECORE_SHOWFUNCUNLOCKHINTDIALOG_METHOD_3_273F6D7E08EAD58F_OFFSET UNITYSDK_OFFSET(0x1BE3FC20)
#define RPG_GAMECORE_SHOWFUNCUNLOCKHINTDIALOG_METHOD_3_8389A5C24C0A73B4_OFFSET UNITYSDK_OFFSET(0x1BE3FBD0)
#define RPG_GAMECORE_SHOWFUNCUNLOCKHINTDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE3FC10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowFuncUnlockHintDialog_TypeDefinitionIndex = 23430;
