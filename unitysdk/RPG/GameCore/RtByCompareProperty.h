...
#define RPG_GAMECORE_RTBYCOMPAREPROPERTY_METHOD_4_380092D98CB34F8B_OFFSET UNITYSDK_OFFSET(0x1BB8BE30)
#define RPG_GAMECORE_RTBYCOMPAREPROPERTY_METHOD_4_7FDE22F816864EA8_OFFSET UNITYSDK_OFFSET(0x1BB8BB00)
#define RPG_GAMECORE_RTBYCOMPAREPROPERTY_METHOD_4_920AD8E1998E11B6_OFFSET UNITYSDK_OFFSET(0x1BB8BB50)
#define RPG_GAMECORE_RTBYCOMPAREPROPERTY_METHOD_4_F8626D8AEF83F9AD_OFFSET UNITYSDK_OFFSET(0x1BB8BE70)
#define RPG_GAMECORE_RTBYCOMPAREPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB8BB40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtByCompareProperty_TypeDefinitionIndex = 23357;
