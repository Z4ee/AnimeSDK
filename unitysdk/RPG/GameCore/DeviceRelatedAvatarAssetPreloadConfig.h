...
#define RPG_GAMECORE_DEVICERELATEDAVATARASSETPRELOADCONFIG_METHOD_3_2814C3349C740B13_OFFSET UNITYSDK_OFFSET(0x1C105580)
#define RPG_GAMECORE_DEVICERELATEDAVATARASSETPRELOADCONFIG_METHOD_3_F7D6345E5FDDBAC5_OFFSET UNITYSDK_OFFSET(0x1C1055E0)
#define RPG_GAMECORE_DEVICERELATEDAVATARASSETPRELOADCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1055D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DeviceRelatedAvatarAssetPreloadConfig_TypeDefinitionIndex = 15825;
