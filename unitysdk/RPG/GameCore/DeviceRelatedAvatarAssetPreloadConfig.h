...
#define RPG_GAMECORE_DEVICERELATEDAVATARASSETPRELOADCONFIG_METHOD_3_4DDD68D2A31FD705_OFFSET UNITYSDK_OFFSET(0x17156040)
#define RPG_GAMECORE_DEVICERELATEDAVATARASSETPRELOADCONFIG_METHOD_3_874B1EF7036DF083_OFFSET UNITYSDK_OFFSET(0x171560A0)
#define RPG_GAMECORE_DEVICERELATEDAVATARASSETPRELOADCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17156090)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DeviceRelatedAvatarAssetPreloadConfig_TypeDefinitionIndex = 15082;
