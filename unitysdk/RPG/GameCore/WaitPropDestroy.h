...
#define RPG_GAMECORE_WAITPROPDESTROY_METHOD_3_B25E39200D1B3DA9_OFFSET UNITYSDK_OFFSET(0x1D6A9A50)
#define RPG_GAMECORE_WAITPROPDESTROY_METHOD_3_BDFCD11B437F8F51_OFFSET UNITYSDK_OFFSET(0x1D6A99D0)
#define RPG_GAMECORE_WAITPROPDESTROY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6A9A20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitPropDestroy_TypeDefinitionIndex = 21323;
