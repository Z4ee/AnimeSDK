...
#define RPG_GAMECORE_WAITPROPDESTROY_METHOD_3_2C5DF8873AFE9173_OFFSET UNITYSDK_OFFSET(0x17901440)
#define RPG_GAMECORE_WAITPROPDESTROY_METHOD_3_34294A95452621C4_OFFSET UNITYSDK_OFFSET(0x179012F0)
#define RPG_GAMECORE_WAITPROPDESTROY__CTOR_OFFSET UNITYSDK_OFFSET(0x179013B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitPropDestroy_TypeDefinitionIndex = 19726;
