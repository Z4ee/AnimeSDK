...
#define RPG_GAMECORE_ADVENTURECAMERATOORTHOGRAPHIC_METHOD_3_EE029D45ED00EC2C_OFFSET UNITYSDK_OFFSET(0x16F50B70)
#define RPG_GAMECORE_ADVENTURECAMERATOORTHOGRAPHIC_METHOD_3_FF581D7F79249F2D_OFFSET UNITYSDK_OFFSET(0x16F50BF0)
#define RPG_GAMECORE_ADVENTURECAMERATOORTHOGRAPHIC__CTOR_OFFSET UNITYSDK_OFFSET(0x16F50BC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureCameraToOrthographic_TypeDefinitionIndex = 20320;
