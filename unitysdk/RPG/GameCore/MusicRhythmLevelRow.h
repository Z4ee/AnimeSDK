...
#define RPG_GAMECORE_MUSICRHYTHMLEVELROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D2EAA50)
#define RPG_GAMECORE_MUSICRHYTHMLEVELROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2EB240)
