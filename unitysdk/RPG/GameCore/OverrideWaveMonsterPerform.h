...
#define RPG_GAMECORE_OVERRIDEWAVEMONSTERPERFORM_METHOD_3_5470AC31AA545700_OFFSET UNITYSDK_OFFSET(0x1D305E10)
#define RPG_GAMECORE_OVERRIDEWAVEMONSTERPERFORM_METHOD_3_C3D33FDB07E99209_OFFSET UNITYSDK_OFFSET(0x1D305E50)
#define RPG_GAMECORE_OVERRIDEWAVEMONSTERPERFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D305E40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OverrideWaveMonsterPerform_TypeDefinitionIndex = 23143;
