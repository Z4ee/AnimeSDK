...
#define RPG_GAMECORE_TARGETINDEX_METHOD_3_02B30785BD0A3C46_OFFSET UNITYSDK_OFFSET(0x1E1B9070)
#define RPG_GAMECORE_TARGETINDEX_METHOD_3_A9C8EE2A1D92F603_OFFSET UNITYSDK_OFFSET(0x1E1B8E50)
#define RPG_GAMECORE_TARGETINDEX_METHOD_3_AAF0651CBE2E58C3_OFFSET UNITYSDK_OFFSET(0x1E1B9100)
#define RPG_GAMECORE_TARGETINDEX_METHOD_3_C043EBBDF5F1BE40_OFFSET UNITYSDK_OFFSET(0x1E1B8F50)
#define RPG_GAMECORE_TARGETINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1B8EE0)
