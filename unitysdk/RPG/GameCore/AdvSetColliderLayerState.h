...
#define RPG_GAMECORE_ADVSETCOLLIDERLAYERSTATE_METHOD_3_3D94D69EC2B566CB_OFFSET UNITYSDK_OFFSET(0x19435CE0)
#define RPG_GAMECORE_ADVSETCOLLIDERLAYERSTATE_METHOD_3_E8A9039E776AE8FA_OFFSET UNITYSDK_OFFSET(0x19435D60)
#define RPG_GAMECORE_ADVSETCOLLIDERLAYERSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19435D30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSetColliderLayerState_TypeDefinitionIndex = 19393;
