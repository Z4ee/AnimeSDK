...
#define RPG_GAMECORE_CIRCLEPOINTGENERATORCONFIG_METHOD_3_9DA017B6982CFF6B_OFFSET UNITYSDK_OFFSET(0x1880E4B0)
#define RPG_GAMECORE_CIRCLEPOINTGENERATORCONFIG_METHOD_3_F04EE940FFF5082A_OFFSET UNITYSDK_OFFSET(0x1880E500)
#define RPG_GAMECORE_CIRCLEPOINTGENERATORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1880E4F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CirclePointGeneratorConfig_TypeDefinitionIndex = 14791;
