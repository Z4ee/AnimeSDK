...
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_ADDATTACK_METHOD_3_681801058EEC8D21_OFFSET UNITYSDK_OFFSET(0x1961FD80)
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_ADDATTACK_METHOD_3_ECCEAF3923346263_OFFSET UNITYSDK_OFFSET(0x1961FDE0)
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_ADDATTACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1961FDD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleEffect_AddAttack_TypeDefinitionIndex = 15021;
