...
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_ADDATTACK_METHOD_3_681801058EEC8D21_OFFSET UNITYSDK_OFFSET(0x1CFA89A0)
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_ADDATTACK_METHOD_3_ECCEAF3923346263_OFFSET UNITYSDK_OFFSET(0x1CFA8A00)
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_ADDATTACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFA89F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleEffect_AddAttack_TypeDefinitionIndex = 15622;
