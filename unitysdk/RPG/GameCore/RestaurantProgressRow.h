...
#define RPG_GAMECORE_RESTAURANTPROGRESSROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D3AC980)
#define RPG_GAMECORE_RESTAURANTPROGRESSROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3AD2F0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 ChefNumber; // 0x1C
		::System::UInt32 TableNumber; // 0x20
		::System::UInt32 CheckDay; // 0x24
		::System::UInt32 WaiterNumber; // 0x28
		::System::UInt32 BreakMission; // 0x2C
		::System::UInt32 GoalIncome; // 0x30
		::System::UInt32 RecipeMaxLevel; // 0x34
		::RPG::Client::TextID Name; // 0x38
		::System::UInt32 ProgressID; // 0x48
		::System::UInt32 MenuNumber; // 0x4C
		::System::UInt32 FarmerNumber; // 0x50
		::System::UInt32 EmployeeMaxLevel; // 0x54
		::System::UInt32 TableMaxLevel; // 0x58
		::System::UInt32 BaseCustomer; // 0x5C
