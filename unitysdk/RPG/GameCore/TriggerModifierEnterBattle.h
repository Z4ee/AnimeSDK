...
#define RPG_GAMECORE_TRIGGERMODIFIERENTERBATTLE_METHOD_3_C4B5768F03E5ABBE_OFFSET UNITYSDK_OFFSET(0x1D601BB0)
#define RPG_GAMECORE_TRIGGERMODIFIERENTERBATTLE_METHOD_3_EEE94AF87AEB983D_OFFSET UNITYSDK_OFFSET(0x1D601BF0)
#define RPG_GAMECORE_TRIGGERMODIFIERENTERBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D601BE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerModifierEnterBattle_TypeDefinitionIndex = 23184;
