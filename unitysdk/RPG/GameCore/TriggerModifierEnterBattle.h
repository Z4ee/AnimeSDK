...
#define RPG_GAMECORE_TRIGGERMODIFIERENTERBATTLE_METHOD_3_40EC1D732529C5AC_OFFSET UNITYSDK_OFFSET(0x190C8FF0)
#define RPG_GAMECORE_TRIGGERMODIFIERENTERBATTLE_METHOD_3_EEE94AF87AEB983D_OFFSET UNITYSDK_OFFSET(0x190C9070)
#define RPG_GAMECORE_TRIGGERMODIFIERENTERBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x190C9040)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerModifierEnterBattle_TypeDefinitionIndex = 22416;
