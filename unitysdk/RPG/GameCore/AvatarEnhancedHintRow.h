...
#define RPG_GAMECORE_AVATARENHANCEDHINTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19495AD0)
#define RPG_GAMECORE_AVATARENHANCEDHINTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19495EB0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID EnhancedDesc2; // 0x30
		::System::UInt32 SeasonID; // 0x40
		::System::UInt32 EnhancedDescNum; // 0x44
		::System::UInt32 EnhancedID; // 0x48
		::System::UInt32 PreviewModuleID; // 0x4C
