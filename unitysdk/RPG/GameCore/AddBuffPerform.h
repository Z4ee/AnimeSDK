...
#define RPG_GAMECORE_ADDBUFFPERFORM_METHOD_3_BB3A687FA067993D_OFFSET UNITYSDK_OFFSET(0x1D69EC60)
#define RPG_GAMECORE_ADDBUFFPERFORM_METHOD_3_C40441C0B0DEFCCA_OFFSET UNITYSDK_OFFSET(0x1D69EB60)
#define RPG_GAMECORE_ADDBUFFPERFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D69EBF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddBuffPerform_TypeDefinitionIndex = 23285;
