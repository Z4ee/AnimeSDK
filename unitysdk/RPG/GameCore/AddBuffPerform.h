...
#define RPG_GAMECORE_ADDBUFFPERFORM_METHOD_3_7DCCA68246BBC442_OFFSET UNITYSDK_OFFSET(0x16F1A950)
#define RPG_GAMECORE_ADDBUFFPERFORM_METHOD_3_D92CAE17388F06BE_OFFSET UNITYSDK_OFFSET(0x16F1AA70)
#define RPG_GAMECORE_ADDBUFFPERFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x16F1A9F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddBuffPerform_TypeDefinitionIndex = 21781;
