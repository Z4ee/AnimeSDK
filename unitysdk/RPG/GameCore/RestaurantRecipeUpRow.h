...
#define RPG_GAMECORE_RESTAURANTRECIPEUPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D026040)
#define RPG_GAMECORE_RESTAURANTRECIPEUPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D026710)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RestaurantRecipeUpRow_TypeDefinitionIndex = 10943;
