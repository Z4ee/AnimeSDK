...
#define RPG_GAMECORE_RESTAURANTRECIPEUPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x175A9720)
#define RPG_GAMECORE_RESTAURANTRECIPEUPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x175A9DE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RestaurantRecipeUpRow_TypeDefinitionIndex = 10586;
	...
	public:
		...
		::System::UInt32 CookTime; // 0x18
		::System::UInt32 Price; // 0x1C
