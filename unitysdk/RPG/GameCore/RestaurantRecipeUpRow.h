...
#define RPG_GAMECORE_RESTAURANTRECIPEUPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1DB9D6D0)
#define RPG_GAMECORE_RESTAURANTRECIPEUPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB9DDA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RestaurantRecipeUpRow_TypeDefinitionIndex = 11318;
	...
	public:
		...
		::System::UInt32 CookTime; // 0x20
		::System::UInt32 RecipeID; // 0x24
