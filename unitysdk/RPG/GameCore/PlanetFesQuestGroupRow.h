...
#define RPG_GAMECORE_PLANETFESQUESTGROUPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19A21450)
#define RPG_GAMECORE_PLANETFESQUESTGROUPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19A215F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlanetFesQuestGroupRow_TypeDefinitionIndex = 11655;
