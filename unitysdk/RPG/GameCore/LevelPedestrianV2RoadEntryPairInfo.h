...
#define RPG_GAMECORE_LEVELPEDESTRIANV2ROADENTRYPAIRINFO_METHOD_2_14EE3F14D857C8CC_OFFSET UNITYSDK_OFFSET(0x173492A0)
#define RPG_GAMECORE_LEVELPEDESTRIANV2ROADENTRYPAIRINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x17349360)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPedestrianV2RoadEntryPairInfo_TypeDefinitionIndex = 15884;
