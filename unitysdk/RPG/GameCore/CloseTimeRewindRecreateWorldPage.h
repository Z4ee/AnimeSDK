...
#define RPG_GAMECORE_CLOSETIMEREWINDRECREATEWORLDPAGE_METHOD_3_3F70C7915DED8AC9_OFFSET UNITYSDK_OFFSET(0x19664690)
#define RPG_GAMECORE_CLOSETIMEREWINDRECREATEWORLDPAGE_METHOD_3_B948EBBC064037BD_OFFSET UNITYSDK_OFFSET(0x196647A0)
#define RPG_GAMECORE_CLOSETIMEREWINDRECREATEWORLDPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x19664770)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CloseTimeRewindRecreateWorldPage_TypeDefinitionIndex = 19523;
