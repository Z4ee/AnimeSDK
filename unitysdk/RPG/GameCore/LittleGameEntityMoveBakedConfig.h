...
#define RPG_GAMECORE_LITTLEGAMEENTITYMOVEBAKEDCONFIG_METHOD_2_774480EBA5C55D60_OFFSET UNITYSDK_OFFSET(0x1989E2A0)
#define RPG_GAMECORE_LITTLEGAMEENTITYMOVEBAKEDCONFIG_METHOD_2_C72B1DCE5C0A2B54_OFFSET UNITYSDK_OFFSET(0x1989E450)
#define RPG_GAMECORE_LITTLEGAMEENTITYMOVEBAKEDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1989E440)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameEntityMoveBakedConfig_TypeDefinitionIndex = 17958;
