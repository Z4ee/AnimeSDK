...
#define RPG_GAMECORE_CREATELEVELAREAS_METHOD_3_EC5E4F917F0BE291_OFFSET UNITYSDK_OFFSET(0x188434F0)
#define RPG_GAMECORE_CREATELEVELAREAS_METHOD_3_FE83C95243BA8048_OFFSET UNITYSDK_OFFSET(0x18843470)
#define RPG_GAMECORE_CREATELEVELAREAS__CTOR_OFFSET UNITYSDK_OFFSET(0x188434C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CreateLevelAreas_TypeDefinitionIndex = 19725;
