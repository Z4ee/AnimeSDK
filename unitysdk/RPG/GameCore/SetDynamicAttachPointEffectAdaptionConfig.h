...
#define RPG_GAMECORE_SETDYNAMICATTACHPOINTEFFECTADAPTIONCONFIG_METHOD_3_11930121BB1E8706_OFFSET UNITYSDK_OFFSET(0x176B2790)
#define RPG_GAMECORE_SETDYNAMICATTACHPOINTEFFECTADAPTIONCONFIG_METHOD_3_C72F84EC4E080D9F_OFFSET UNITYSDK_OFFSET(0x176B2860)
#define RPG_GAMECORE_SETDYNAMICATTACHPOINTEFFECTADAPTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x176B2810)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicAttachPointEffectAdaptionConfig_TypeDefinitionIndex = 18557;
