...
#define RPG_GAMECORE_ROGUEACTTRIGGERMODIFIERCUSTOMEVENTCONFIG_METHOD_6_0BF949C56DEF4B3E_OFFSET UNITYSDK_OFFSET(0x1C49E4F0)
#define RPG_GAMECORE_ROGUEACTTRIGGERMODIFIERCUSTOMEVENTCONFIG_METHOD_6_88B018F53CAB1422_OFFSET UNITYSDK_OFFSET(0x1C49E4A0)
#define RPG_GAMECORE_ROGUEACTTRIGGERMODIFIERCUSTOMEVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C49E4E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActTriggerModifierCustomEventConfig_TypeDefinitionIndex = 19020;
