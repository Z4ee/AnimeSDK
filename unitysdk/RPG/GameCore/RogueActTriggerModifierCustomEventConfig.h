...
#define RPG_GAMECORE_ROGUEACTTRIGGERMODIFIERCUSTOMEVENTCONFIG_METHOD_6_0BF949C56DEF4B3E_OFFSET UNITYSDK_OFFSET(0x19AFA5B0)
#define RPG_GAMECORE_ROGUEACTTRIGGERMODIFIERCUSTOMEVENTCONFIG_METHOD_6_3771379B84F23BBB_OFFSET UNITYSDK_OFFSET(0x19AFA390)
#define RPG_GAMECORE_ROGUEACTTRIGGERMODIFIERCUSTOMEVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AFA4D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActTriggerModifierCustomEventConfig_TypeDefinitionIndex = 18744;
