...
#define RPG_GAMECORE_ROGUEACTTRIGGERMODIFIERCUSTOMEVENTCONFIG_METHOD_6_0BF949C56DEF4B3E_OFFSET UNITYSDK_OFFSET(0x18CD6030)
#define RPG_GAMECORE_ROGUEACTTRIGGERMODIFIERCUSTOMEVENTCONFIG_METHOD_6_3771379B84F23BBB_OFFSET UNITYSDK_OFFSET(0x18CD5E10)
#define RPG_GAMECORE_ROGUEACTTRIGGERMODIFIERCUSTOMEVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CD5F50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActTriggerModifierCustomEventConfig_TypeDefinitionIndex = 18777;
