...
#define RPG_GAMECORE_RETRYSWORDTRAININGFINALBATTLE_METHOD_3_8EED0A48DCE980B3_OFFSET UNITYSDK_OFFSET(0x19ADD880)
#define RPG_GAMECORE_RETRYSWORDTRAININGFINALBATTLE_METHOD_3_A24B61531FE7326A_OFFSET UNITYSDK_OFFSET(0x19ADD800)
#define RPG_GAMECORE_RETRYSWORDTRAININGFINALBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x19ADD850)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RetrySwordTrainingFinalBattle_TypeDefinitionIndex = 19192;
