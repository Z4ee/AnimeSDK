...
#define RPG_GAMECORE_RETRYSWORDTRAININGFINALBATTLE_METHOD_3_7DFBC3299EA1A820_OFFSET UNITYSDK_OFFSET(0x1D029BA0)
#define RPG_GAMECORE_RETRYSWORDTRAININGFINALBATTLE_METHOD_3_8EED0A48DCE980B3_OFFSET UNITYSDK_OFFSET(0x1D029BE0)
#define RPG_GAMECORE_RETRYSWORDTRAININGFINALBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D029BD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RetrySwordTrainingFinalBattle_TypeDefinitionIndex = 19548;
