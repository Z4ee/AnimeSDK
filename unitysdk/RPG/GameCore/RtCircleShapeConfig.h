...
#define RPG_GAMECORE_RTCIRCLESHAPECONFIG_METHOD_3_53B3B352AB60F255_OFFSET UNITYSDK_OFFSET(0x1BB92BF0)
#define RPG_GAMECORE_RTCIRCLESHAPECONFIG_METHOD_3_B310E5395281EFF8_OFFSET UNITYSDK_OFFSET(0x1BB929A0)
#define RPG_GAMECORE_RTCIRCLESHAPECONFIG_METHOD_3_C9C4E8D117A729A2_OFFSET UNITYSDK_OFFSET(0x1BB92C70)
#define RPG_GAMECORE_RTCIRCLESHAPECONFIG_METHOD_3_DA3B7D8B4ED68245_OFFSET UNITYSDK_OFFSET(0x1BB92B30)
#define RPG_GAMECORE_RTCIRCLESHAPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB92AD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtCircleShapeConfig_TypeDefinitionIndex = 16941;
