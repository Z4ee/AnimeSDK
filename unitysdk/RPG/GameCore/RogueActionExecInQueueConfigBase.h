...
#define RPG_GAMECORE_ROGUEACTIONEXECINQUEUECONFIGBASE_METHOD_6_B45B661BC6CD68FF_OFFSET UNITYSDK_OFFSET(0x19B0B5B0)
#define RPG_GAMECORE_ROGUEACTIONEXECINQUEUECONFIGBASE_METHOD_6_BE89E5CB00455A2A_OFFSET UNITYSDK_OFFSET(0x19B0A0F0)
#define RPG_GAMECORE_ROGUEACTIONEXECINQUEUECONFIGBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x19B0A010)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActionExecInQueueConfigBase_TypeDefinitionIndex = 18552;
