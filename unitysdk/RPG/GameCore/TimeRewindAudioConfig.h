...
#define RPG_GAMECORE_TIMEREWINDAUDIOCONFIG_METHOD_2_9F3FED514437D63F_OFFSET UNITYSDK_OFFSET(0x1D527100)
#define RPG_GAMECORE_TIMEREWINDAUDIOCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5272C0)
