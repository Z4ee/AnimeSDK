...
#define RPG_GAMECORE_ROGUEMODIFIERSETCOUNTBYOTHERMODIFIERSCONFIG_METHOD_3_010C9A3A09DC070C_OFFSET UNITYSDK_OFFSET(0x1D166270)
#define RPG_GAMECORE_ROGUEMODIFIERSETCOUNTBYOTHERMODIFIERSCONFIG_METHOD_3_586DEDB5E27EBB88_OFFSET UNITYSDK_OFFSET(0x1D1662C0)
#define RPG_GAMECORE_ROGUEMODIFIERSETCOUNTBYOTHERMODIFIERSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1662B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierSetCountByOtherModifiersConfig_TypeDefinitionIndex = 17008;
