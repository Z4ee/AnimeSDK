...
#define RPG_GAMECORE_ROGUEMODIFIERSETCOUNTBYOTHERMODIFIERSCONFIG_METHOD_3_586DEDB5E27EBB88_OFFSET UNITYSDK_OFFSET(0x19B9C860)
#define RPG_GAMECORE_ROGUEMODIFIERSETCOUNTBYOTHERMODIFIERSCONFIG_METHOD_3_9B7C9B075E2420F1_OFFSET UNITYSDK_OFFSET(0x19B9C790)
#define RPG_GAMECORE_ROGUEMODIFIERSETCOUNTBYOTHERMODIFIERSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B9C810)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierSetCountByOtherModifiersConfig_TypeDefinitionIndex = 16846;
