...
#define RPG_GAMECORE_UIMONOPOLYSHOWFINISHEDQUIZ_METHOD_3_12AB465434261F9A_OFFSET UNITYSDK_OFFSET(0x1B87C470)
#define RPG_GAMECORE_UIMONOPOLYSHOWFINISHEDQUIZ_METHOD_3_80547D77780C35F7_OFFSET UNITYSDK_OFFSET(0x1B87C3A0)
#define RPG_GAMECORE_UIMONOPOLYSHOWFINISHEDQUIZ__CTOR_OFFSET UNITYSDK_OFFSET(0x1B87C460)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UIMonopolyShowFinishedQuiz_TypeDefinitionIndex = 20927;
