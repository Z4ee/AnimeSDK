...
#define RPG_GAMECORE_ELATIONCONFIG_METHOD_2_8F5C5571DBEA233E_OFFSET UNITYSDK_OFFSET(0x1718ABF0)
#define RPG_GAMECORE_ELATIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1718AEE0)
