...
#define RPG_GAMECORE_ELATIONCONFIG_METHOD_2_C843BFB2FC9891A4_OFFSET UNITYSDK_OFFSET(0x1DB25590)
#define RPG_GAMECORE_ELATIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB25880)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElationConfig_TypeDefinitionIndex = 16369;
