...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERLISTCONFIG_METHOD_2_662FE606DEDB3D05_OFFSET UNITYSDK_OFFSET(0x1D06A210)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERLISTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D06A250)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierListConfig_TypeDefinitionIndex = 16898;
