...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERLISTCONFIG_METHOD_2_662FE606DEDB3D05_OFFSET UNITYSDK_OFFSET(0x197F2AA0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERLISTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197F2AE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierListConfig_TypeDefinitionIndex = 16736;
