...
#define RPG_GAMECORE_REQUESTGROUPSTATECHANGE_METHOD_3_3A107AE2C4B34A74_OFFSET UNITYSDK_OFFSET(0x1D019C10)
#define RPG_GAMECORE_REQUESTGROUPSTATECHANGE_METHOD_3_8E00F712E627DF0F_OFFSET UNITYSDK_OFFSET(0x1D019BC0)
#define RPG_GAMECORE_REQUESTGROUPSTATECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D019C00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RequestGroupStateChange_TypeDefinitionIndex = 19939;
