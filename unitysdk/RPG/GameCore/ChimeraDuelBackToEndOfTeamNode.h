...
#define RPG_GAMECORE_CHIMERADUELBACKTOENDOFTEAMNODE_METHOD_3_2CDB57E8F7C2A48A_OFFSET UNITYSDK_OFFSET(0x19637260)
#define RPG_GAMECORE_CHIMERADUELBACKTOENDOFTEAMNODE_METHOD_3_9D201C772BFA396D_OFFSET UNITYSDK_OFFSET(0x19637180)
#define RPG_GAMECORE_CHIMERADUELBACKTOENDOFTEAMNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x19637210)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelBackToEndOfTeamNode_TypeDefinitionIndex = 15245;
