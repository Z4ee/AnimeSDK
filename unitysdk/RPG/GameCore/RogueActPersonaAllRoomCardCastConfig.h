...
#define RPG_GAMECORE_ROGUEACTPERSONAALLROOMCARDCASTCONFIG_METHOD_6_BEDFA9E1655DDF50_OFFSET UNITYSDK_OFFSET(0x19AEA3D0)
#define RPG_GAMECORE_ROGUEACTPERSONAALLROOMCARDCASTCONFIG_METHOD_6_EE8E4B85E7EF1FA9_OFFSET UNITYSDK_OFFSET(0x19AEB270)
#define RPG_GAMECORE_ROGUEACTPERSONAALLROOMCARDCASTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AEA0C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaAllRoomCardCastConfig_TypeDefinitionIndex = 18706;
