...
#define RPG_GAMECORE_ADVENTUREMONSTERENTERALERTEDEVENT_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1540C290)
#define RPG_GAMECORE_ADVENTUREMONSTERENTERALERTEDEVENT_GETMONSTER_OFFSET UNITYSDK_OFFSET(0x1540C2E0)
#define RPG_GAMECORE_ADVENTUREMONSTERENTERALERTEDEVENT_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x1540C240)
#define RPG_GAMECORE_ADVENTUREMONSTERENTERALERTEDEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1540C230)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureMonsterEnterAlertedEvent_TypeDefinitionIndex = 54074;
