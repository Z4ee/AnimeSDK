...
#define RPG_GAMECORE_WAITBATTLERESULT_METHOD_3_39E83CF7C63B6FF6_OFFSET UNITYSDK_OFFSET(0x1B8A1650)
#define RPG_GAMECORE_WAITBATTLERESULT_METHOD_3_D16A790D525624B9_OFFSET UNITYSDK_OFFSET(0x1B8A1690)
#define RPG_GAMECORE_WAITBATTLERESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8A1680)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitBattleResult_TypeDefinitionIndex = 22568;
