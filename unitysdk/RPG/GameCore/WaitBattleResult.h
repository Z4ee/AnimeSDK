...
#define RPG_GAMECORE_WAITBATTLERESULT_METHOD_3_03AE2FA779C07F43_OFFSET UNITYSDK_OFFSET(0x178F5B60)
#define RPG_GAMECORE_WAITBATTLERESULT_METHOD_3_9425DF7E44C0C285_OFFSET UNITYSDK_OFFSET(0x178F5AE0)
#define RPG_GAMECORE_WAITBATTLERESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x178F5B30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitBattleResult_TypeDefinitionIndex = 21637;
