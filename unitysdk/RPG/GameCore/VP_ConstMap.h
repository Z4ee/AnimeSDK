...
#define RPG_GAMECORE_VP_CONSTMAP_METHOD_3_4EE3D334C2F87998_OFFSET UNITYSDK_OFFSET(0x1B896290)
#define RPG_GAMECORE_VP_CONSTMAP_METHOD_3_551F9D0423D868BC_OFFSET UNITYSDK_OFFSET(0x1B896130)
#define RPG_GAMECORE_VP_CONSTMAP_METHOD_3_5D266255DE12B05C_OFFSET UNITYSDK_OFFSET(0x1B8962C0)
#define RPG_GAMECORE_VP_CONSTMAP_METHOD_3_9EF1F11437835883_OFFSET UNITYSDK_OFFSET(0x1B896170)
#define RPG_GAMECORE_VP_CONSTMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B896160)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VP_ConstMap_TypeDefinitionIndex = 23203;
