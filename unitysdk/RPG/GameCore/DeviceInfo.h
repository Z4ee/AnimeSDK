...
#define RPG_GAMECORE_DEVICEINFO_METHOD_2_FE735B0BCD4FC6CB_OFFSET UNITYSDK_OFFSET(0x1D021C50)
#define RPG_GAMECORE_DEVICEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D022110)
