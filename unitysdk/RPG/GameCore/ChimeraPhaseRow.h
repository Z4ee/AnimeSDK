...
#define RPG_GAMECORE_CHIMERAPHASEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x170AA160)
#define RPG_GAMECORE_CHIMERAPHASEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x170AA3C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraPhaseRow_TypeDefinitionIndex = 11887;
	...
	public:
		...
		::System::UInt32 NextPhaseID; // 0x28
