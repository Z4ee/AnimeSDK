...
#define RPG_GAMECORE_BYSHOWCHALLENGESELECTPAGE_METHOD_4_08AD0CD5F90A87A2_OFFSET UNITYSDK_OFFSET(0x1CDC14E0)
#define RPG_GAMECORE_BYSHOWCHALLENGESELECTPAGE_METHOD_4_30F48E026D1F8A29_OFFSET UNITYSDK_OFFSET(0x1CDC1520)
#define RPG_GAMECORE_BYSHOWCHALLENGESELECTPAGE_METHOD_4_92D17F883C104AD3_OFFSET UNITYSDK_OFFSET(0x1CDC1660)
#define RPG_GAMECORE_BYSHOWCHALLENGESELECTPAGE_METHOD_4_FAD709A09D0DDA86_OFFSET UNITYSDK_OFFSET(0x1CDC1690)
#define RPG_GAMECORE_BYSHOWCHALLENGESELECTPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDC1510)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByShowChallengeSelectPage_TypeDefinitionIndex = 20236;
