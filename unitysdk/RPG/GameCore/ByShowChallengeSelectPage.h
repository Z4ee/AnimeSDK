...
#define RPG_GAMECORE_BYSHOWCHALLENGESELECTPAGE_METHOD_4_30F48E026D1F8A29_OFFSET UNITYSDK_OFFSET(0x1875F480)
#define RPG_GAMECORE_BYSHOWCHALLENGESELECTPAGE_METHOD_4_90D6BE26CFB010A3_OFFSET UNITYSDK_OFFSET(0x1875F3B0)
#define RPG_GAMECORE_BYSHOWCHALLENGESELECTPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1875F430)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByShowChallengeSelectPage_TypeDefinitionIndex = 19429;
