...
#define RPG_GAMECORE_STARTTAROTBOOKTALK_METHOD_3_0E5F1A49FBFF66D5_OFFSET UNITYSDK_OFFSET(0x1D568FA0)
#define RPG_GAMECORE_STARTTAROTBOOKTALK_METHOD_3_58B68D37C7307098_OFFSET UNITYSDK_OFFSET(0x1D569070)
#define RPG_GAMECORE_STARTTAROTBOOKTALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D569060)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StartTarotBookTalk_TypeDefinitionIndex = 20893;
