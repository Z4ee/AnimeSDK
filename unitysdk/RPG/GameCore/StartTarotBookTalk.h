...
#define RPG_GAMECORE_STARTTAROTBOOKTALK_METHOD_3_1270546EF6CFEB0C_OFFSET UNITYSDK_OFFSET(0x17776770)
#define RPG_GAMECORE_STARTTAROTBOOKTALK_METHOD_3_58B68D37C7307098_OFFSET UNITYSDK_OFFSET(0x17776880)
#define RPG_GAMECORE_STARTTAROTBOOKTALK__CTOR_OFFSET UNITYSDK_OFFSET(0x17776850)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StartTarotBookTalk_TypeDefinitionIndex = 19441;
