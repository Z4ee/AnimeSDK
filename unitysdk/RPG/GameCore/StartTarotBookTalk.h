...
#define RPG_GAMECORE_STARTTAROTBOOKTALK_METHOD_3_1270546EF6CFEB0C_OFFSET UNITYSDK_OFFSET(0x19CB9650)
#define RPG_GAMECORE_STARTTAROTBOOKTALK_METHOD_3_58B68D37C7307098_OFFSET UNITYSDK_OFFSET(0x19CB9760)
#define RPG_GAMECORE_STARTTAROTBOOKTALK__CTOR_OFFSET UNITYSDK_OFFSET(0x19CB9730)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StartTarotBookTalk_TypeDefinitionIndex = 19972;
