...
#define RPG_GAMECORE_LOOPWAITROLLSHOPTAKEREWARD_METHOD_3_174EFCFB42E0AA3B_OFFSET UNITYSDK_OFFSET(0x198B2060)
#define RPG_GAMECORE_LOOPWAITROLLSHOPTAKEREWARD_METHOD_3_3489B974DCB0696B_OFFSET UNITYSDK_OFFSET(0x198B1FD0)
#define RPG_GAMECORE_LOOPWAITROLLSHOPTAKEREWARD__CTOR_OFFSET UNITYSDK_OFFSET(0x198B2030)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoopWaitRollShopTakeReward_TypeDefinitionIndex = 20045;
