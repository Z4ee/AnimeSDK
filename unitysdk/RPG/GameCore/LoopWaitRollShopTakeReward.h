...
#define RPG_GAMECORE_LOOPWAITROLLSHOPTAKEREWARD_METHOD_3_174EFCFB42E0AA3B_OFFSET UNITYSDK_OFFSET(0x1BCD4C10)
#define RPG_GAMECORE_LOOPWAITROLLSHOPTAKEREWARD_METHOD_3_72E0BEF4F7946557_OFFSET UNITYSDK_OFFSET(0x1BCD4BC0)
#define RPG_GAMECORE_LOOPWAITROLLSHOPTAKEREWARD__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCD4C00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoopWaitRollShopTakeReward_TypeDefinitionIndex = 20417;
