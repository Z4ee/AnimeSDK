...
#define RPG_GAMECORE_FATEMODIFIERMODIFYMASTERDAMAGECONFIG_METHOD_3_614B469B59A23D83_OFFSET UNITYSDK_OFFSET(0x19711430)
#define RPG_GAMECORE_FATEMODIFIERMODIFYMASTERDAMAGECONFIG_METHOD_3_6BFDC0F5AB0941CA_OFFSET UNITYSDK_OFFSET(0x19712940)
#define RPG_GAMECORE_FATEMODIFIERMODIFYMASTERDAMAGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197113E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateModifierModifyMasterDamageConfig_TypeDefinitionIndex = 18280;
