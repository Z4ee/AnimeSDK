...
#define RPG_GAMECORE_FATEMODIFIERMODIFYMASTERDAMAGECONFIG_METHOD_3_614B469B59A23D83_OFFSET UNITYSDK_OFFSET(0x171C7E00)
#define RPG_GAMECORE_FATEMODIFIERMODIFYMASTERDAMAGECONFIG_METHOD_3_6BFDC0F5AB0941CA_OFFSET UNITYSDK_OFFSET(0x171C8D80)
#define RPG_GAMECORE_FATEMODIFIERMODIFYMASTERDAMAGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171C7DB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateModifierModifyMasterDamageConfig_TypeDefinitionIndex = 17695;
