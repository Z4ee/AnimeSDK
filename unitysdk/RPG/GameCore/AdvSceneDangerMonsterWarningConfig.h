...
#define RPG_GAMECORE_ADVSCENEDANGERMONSTERWARNINGCONFIG_METHOD_2_7699D64B1F3CA3DD_OFFSET UNITYSDK_OFFSET(0x16F3E150)
#define RPG_GAMECORE_ADVSCENEDANGERMONSTERWARNINGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16F3E390)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSceneDangerMonsterWarningConfig_TypeDefinitionIndex = 16212;
