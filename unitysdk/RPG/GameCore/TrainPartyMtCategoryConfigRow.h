...
#define RPG_GAMECORE_TRAINPARTYMTCATEGORYCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19DF6DD0)
#define RPG_GAMECORE_TRAINPARTYMTCATEGORYCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19DF7070)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::RPG::Client::TextID CategoryDesc; // 0x10
		::RPG::Client::TextID CategoryTableName; // 0x20
