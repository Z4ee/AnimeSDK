...
#define RPG_GAMECORE_WAITPROPCURVEMOVEPAUSED_METHOD_3_444F9FF57BAFF811_OFFSET UNITYSDK_OFFSET(0x19104F60)
#define RPG_GAMECORE_WAITPROPCURVEMOVEPAUSED_METHOD_3_E8A947B543BDC4EA_OFFSET UNITYSDK_OFFSET(0x19105030)
#define RPG_GAMECORE_WAITPROPCURVEMOVEPAUSED__CTOR_OFFSET UNITYSDK_OFFSET(0x19104FE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitPropCurveMovePaused_TypeDefinitionIndex = 19996;
