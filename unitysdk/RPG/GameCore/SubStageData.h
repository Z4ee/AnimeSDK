...
#define RPG_GAMECORE_SUBSTAGEDATA_METHOD_2_0598B314313875F1_OFFSET UNITYSDK_OFFSET(0x1D5826B0)
#define RPG_GAMECORE_SUBSTAGEDATA_METHOD_2_6B593F795FD7A40F_OFFSET UNITYSDK_OFFSET(0x1D582790)
#define RPG_GAMECORE_SUBSTAGEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1D582780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SubStageData_TypeDefinitionIndex = 18912;
