...
#define RPG_GAMECORE_ROGUETOURNMODIFYROOMPOOLCONFIG_METHOD_2_552ED27CA50BB1E7_OFFSET UNITYSDK_OFFSET(0x1766D5C0)
#define RPG_GAMECORE_ROGUETOURNMODIFYROOMPOOLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1766D600)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournModifyRoomPoolConfig_TypeDefinitionIndex = 16553;
