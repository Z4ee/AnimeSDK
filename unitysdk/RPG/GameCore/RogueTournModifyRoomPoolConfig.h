...
#define RPG_GAMECORE_ROGUETOURNMODIFYROOMPOOLCONFIG_METHOD_2_552ED27CA50BB1E7_OFFSET UNITYSDK_OFFSET(0x19BCE600)
#define RPG_GAMECORE_ROGUETOURNMODIFYROOMPOOLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19BCE640)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournModifyRoomPoolConfig_TypeDefinitionIndex = 17120;
