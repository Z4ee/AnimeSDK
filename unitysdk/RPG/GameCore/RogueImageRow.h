...
#define RPG_GAMECORE_ROGUEIMAGEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19B405D0)
#define RPG_GAMECORE_ROGUEIMAGEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19B40C70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueImageRow_TypeDefinitionIndex = 14081;
