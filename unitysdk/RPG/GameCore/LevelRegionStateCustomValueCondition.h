...
#define RPG_GAMECORE_LEVELREGIONSTATECUSTOMVALUECONDITION_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1988A260)
#define RPG_GAMECORE_LEVELREGIONSTATECUSTOMVALUECONDITION_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1988A7D0)
#define RPG_GAMECORE_LEVELREGIONSTATECUSTOMVALUECONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1988A250)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelRegionStateCustomValueCondition_TypeDefinitionIndex = 16524;
