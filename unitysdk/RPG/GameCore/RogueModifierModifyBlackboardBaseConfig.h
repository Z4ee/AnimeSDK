...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYBLACKBOARDBASECONFIG_METHOD_3_98E373A1B6791048_OFFSET UNITYSDK_OFFSET(0x17633840)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYBLACKBOARDBASECONFIG_METHOD_3_CEAD33890D3D6E44_OFFSET UNITYSDK_OFFSET(0x17633580)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYBLACKBOARDBASECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x176337F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyBlackboardBaseConfig_TypeDefinitionIndex = 16250;
