...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYBLACKBOARDBASECONFIG_METHOD_3_98E373A1B6791048_OFFSET UNITYSDK_OFFSET(0x19B54B80)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYBLACKBOARDBASECONFIG_METHOD_3_CEAD33890D3D6E44_OFFSET UNITYSDK_OFFSET(0x19B5EB40)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYBLACKBOARDBASECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B54B30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyBlackboardBaseConfig_TypeDefinitionIndex = 16819;
