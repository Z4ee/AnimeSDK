...
#define RPG_GAMECORE_CUSTOMMONSTERWAVEINFO_METHOD_3_38C4923D84540706_OFFSET UNITYSDK_OFFSET(0x1D8049C0)
#define RPG_GAMECORE_CUSTOMMONSTERWAVEINFO_METHOD_3_FCE3155CB5DC51EB_OFFSET UNITYSDK_OFFSET(0x1D804980)
#define RPG_GAMECORE_CUSTOMMONSTERWAVEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D8049B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CustomMonsterWaveInfo_TypeDefinitionIndex = 23426;
