...
#define RPG_GAMECORE_CUSTOMMONSTERWAVEINFO_METHOD_3_38C4923D84540706_OFFSET UNITYSDK_OFFSET(0x18848560)
#define RPG_GAMECORE_CUSTOMMONSTERWAVEINFO_METHOD_3_F60A0C1D9490FE0D_OFFSET UNITYSDK_OFFSET(0x188484E0)
#define RPG_GAMECORE_CUSTOMMONSTERWAVEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18848530)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CustomMonsterWaveInfo_TypeDefinitionIndex = 22690;
