...
#define RPG_GAMECORE_TRAINPARTYDIALOGUEEVENTOPTIONCONFIG_METHOD_2_0B8FB17B5259CBF0_OFFSET UNITYSDK_OFFSET(0x190AA040)
#define RPG_GAMECORE_TRAINPARTYDIALOGUEEVENTOPTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x190AA100)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyDialogueEventOptionConfig_TypeDefinitionIndex = 17192;
