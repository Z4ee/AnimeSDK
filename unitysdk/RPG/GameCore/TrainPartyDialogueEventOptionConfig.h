...
#define RPG_GAMECORE_TRAINPARTYDIALOGUEEVENTOPTIONCONFIG_METHOD_2_0B8FB17B5259CBF0_OFFSET UNITYSDK_OFFSET(0x1D535110)
#define RPG_GAMECORE_TRAINPARTYDIALOGUEEVENTOPTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5351D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyDialogueEventOptionConfig_TypeDefinitionIndex = 17879;
