...
#define RPG_GAMECORE_BYCONTAINSPARAMFLAG_METHOD_4_07EDC543498380A3_OFFSET UNITYSDK_OFFSET(0x18742790)
#define RPG_GAMECORE_BYCONTAINSPARAMFLAG_METHOD_4_7EBADACA5D1A9845_OFFSET UNITYSDK_OFFSET(0x18742860)
#define RPG_GAMECORE_BYCONTAINSPARAMFLAG__CTOR_OFFSET UNITYSDK_OFFSET(0x18742810)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByContainsParamFlag_TypeDefinitionIndex = 22505;
