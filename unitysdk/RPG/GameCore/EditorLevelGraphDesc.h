...
#define RPG_GAMECORE_EDITORLEVELGRAPHDESC_METHOD_2_9864A34FF1AB9E1C_OFFSET UNITYSDK_OFFSET(0x1D051C60)
#define RPG_GAMECORE_EDITORLEVELGRAPHDESC__CTOR_OFFSET UNITYSDK_OFFSET(0x1D051D90)
