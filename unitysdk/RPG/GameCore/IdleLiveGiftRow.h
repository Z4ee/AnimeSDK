...
#define RPG_GAMECORE_IDLELIVEGIFTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D211B80)
#define RPG_GAMECORE_IDLELIVEGIFTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D212040)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 SourceID; // 0x2C
		::System::UInt32 SenderID; // 0x30
		::System::UInt32 UnlockID; // 0x34
		::System::UInt32 RewardID; // 0x38
		::System::UInt32 DonateValue; // 0x3C
		::System::UInt32 RarityType; // 0x40
		::System::UInt32 FinalActChapterIndex; // 0x44
		::System::UInt32 TriggerID; // 0x48
		::System::Single FlySpeed; // 0x4C
		::System::Single ProtectTime; // 0x50
		::RPG::GameCore::IdleLiveGiftSourceType SourceType; // 0x54
