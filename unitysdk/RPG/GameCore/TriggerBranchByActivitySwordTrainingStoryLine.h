...
#define RPG_GAMECORE_TRIGGERBRANCHBYACTIVITYSWORDTRAININGSTORYLINE_METHOD_3_678DA75370D33B51_OFFSET UNITYSDK_OFFSET(0x1D548DD0)
#define RPG_GAMECORE_TRIGGERBRANCHBYACTIVITYSWORDTRAININGSTORYLINE_METHOD_3_749432BCFE7650C2_OFFSET UNITYSDK_OFFSET(0x1D548D90)
#define RPG_GAMECORE_TRIGGERBRANCHBYACTIVITYSWORDTRAININGSTORYLINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D548DC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerBranchByActivitySwordTrainingStoryLine_TypeDefinitionIndex = 20093;
