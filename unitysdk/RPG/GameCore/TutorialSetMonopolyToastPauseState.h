...
#define RPG_GAMECORE_TUTORIALSETMONOPOLYTOASTPAUSESTATE_METHOD_3_375FD8AFE62136E3_OFFSET UNITYSDK_OFFSET(0x190DDD20)
#define RPG_GAMECORE_TUTORIALSETMONOPOLYTOASTPAUSESTATE_METHOD_3_8EEA12F24660C0DA_OFFSET UNITYSDK_OFFSET(0x190DDCA0)
#define RPG_GAMECORE_TUTORIALSETMONOPOLYTOASTPAUSESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x190DDCF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TutorialSetMonopolyToastPauseState_TypeDefinitionIndex = 23379;
