...
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAROOMCARDFORCEWASHIFSELECTCONFIG_METHOD_3_5A0C93DCDD07C13E_OFFSET UNITYSDK_OFFSET(0x17637AC0)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAROOMCARDFORCEWASHIFSELECTCONFIG_METHOD_3_71EF2D9E8CCBBB27_OFFSET UNITYSDK_OFFSET(0x176379F0)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAROOMCARDFORCEWASHIFSELECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17637A70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierPersonaRoomCardForceWashIfSelectConfig_TypeDefinitionIndex = 16359;
