...
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAROOMCARDFORCEWASHIFSELECTCONFIG_METHOD_3_5A0C93DCDD07C13E_OFFSET UNITYSDK_OFFSET(0x1D1653D0)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAROOMCARDFORCEWASHIFSELECTCONFIG_METHOD_3_D6C3630CABC38A22_OFFSET UNITYSDK_OFFSET(0x1D165380)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAROOMCARDFORCEWASHIFSELECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1653C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierPersonaRoomCardForceWashIfSelectConfig_TypeDefinitionIndex = 17090;
