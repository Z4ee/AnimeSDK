...
#define RPG_GAMECORE_RTATTACKDATA_METHOD_2_F934D1834A4F8AC1_OFFSET UNITYSDK_OFFSET(0x1CCD3C20)
#define RPG_GAMECORE_RTATTACKDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1CCD4E20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtAttackData_TypeDefinitionIndex = 23885;
