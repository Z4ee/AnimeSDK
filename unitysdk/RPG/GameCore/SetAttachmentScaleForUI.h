...
#define RPG_GAMECORE_SETATTACHMENTSCALEFORUI_METHOD_4_8F9B9BCA783AA1D1_OFFSET UNITYSDK_OFFSET(0x1C2D2570)
#define RPG_GAMECORE_SETATTACHMENTSCALEFORUI_METHOD_4_E3577C54F5FE36A8_OFFSET UNITYSDK_OFFSET(0x1C2D27F0)
#define RPG_GAMECORE_SETATTACHMENTSCALEFORUI__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2D2550)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetAttachmentScaleForUI_TypeDefinitionIndex = 21566;
