...
#define RPG_GAMECORE_FIVEDIMMOVEBAKEDCONFIG_METHOD_3_5243C97B39B5C1E7_OFFSET UNITYSDK_OFFSET(0x19747B90)
#define RPG_GAMECORE_FIVEDIMMOVEBAKEDCONFIG_METHOD_3_8035E3965941F0A2_OFFSET UNITYSDK_OFFSET(0x19747B50)
#define RPG_GAMECORE_FIVEDIMMOVEBAKEDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19747B80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimMoveBakedConfig_TypeDefinitionIndex = 15835;
