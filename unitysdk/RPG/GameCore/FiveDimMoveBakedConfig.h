...
#define RPG_GAMECORE_FIVEDIMMOVEBAKEDCONFIG_METHOD_3_5243C97B39B5C1E7_OFFSET UNITYSDK_OFFSET(0x1BEA26D0)
#define RPG_GAMECORE_FIVEDIMMOVEBAKEDCONFIG_METHOD_3_8035E3965941F0A2_OFFSET UNITYSDK_OFFSET(0x1BEA2690)
#define RPG_GAMECORE_FIVEDIMMOVEBAKEDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEA26C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimMoveBakedConfig_TypeDefinitionIndex = 16009;
