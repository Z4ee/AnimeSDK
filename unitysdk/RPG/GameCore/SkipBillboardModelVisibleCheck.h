...
#define RPG_GAMECORE_SKIPBILLBOARDMODELVISIBLECHECK_METHOD_3_BE34713A3E64B56F_OFFSET UNITYSDK_OFFSET(0x18E73920)
#define RPG_GAMECORE_SKIPBILLBOARDMODELVISIBLECHECK_METHOD_3_CEFBEA75E5C1E4E8_OFFSET UNITYSDK_OFFSET(0x18E737D0)
#define RPG_GAMECORE_SKIPBILLBOARDMODELVISIBLECHECK__CTOR_OFFSET UNITYSDK_OFFSET(0x18E73890)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SkipBillboardModelVisibleCheck_TypeDefinitionIndex = 19418;
