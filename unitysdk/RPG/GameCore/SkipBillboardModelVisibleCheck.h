...
#define RPG_GAMECORE_SKIPBILLBOARDMODELVISIBLECHECK_METHOD_3_5448887AC0D191A5_OFFSET UNITYSDK_OFFSET(0x1D0A64C0)
#define RPG_GAMECORE_SKIPBILLBOARDMODELVISIBLECHECK_METHOD_3_BE34713A3E64B56F_OFFSET UNITYSDK_OFFSET(0x1D0A6540)
#define RPG_GAMECORE_SKIPBILLBOARDMODELVISIBLECHECK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0A6510)
