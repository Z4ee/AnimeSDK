...
#define RPG_GAMECORE_BYCONTAINBEHAVIORFLAG_METHOD_4_01FA7088C4BF624E_OFFSET UNITYSDK_OFFSET(0x1BBCBD70)
#define RPG_GAMECORE_BYCONTAINBEHAVIORFLAG_METHOD_4_2B7B8F183CB8BE29_OFFSET UNITYSDK_OFFSET(0x1BBCBDC0)
#define RPG_GAMECORE_BYCONTAINBEHAVIORFLAG_METHOD_4_3935B9D02214F283_OFFSET UNITYSDK_OFFSET(0x1BBCC100)
#define RPG_GAMECORE_BYCONTAINBEHAVIORFLAG_METHOD_4_5A303CC1C961CEF5_OFFSET UNITYSDK_OFFSET(0x1BBCC0C0)
#define RPG_GAMECORE_BYCONTAINBEHAVIORFLAG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBCBDB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByContainBehaviorFlag_TypeDefinitionIndex = 22753;
