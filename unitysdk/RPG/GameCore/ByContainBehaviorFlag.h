...
#define RPG_GAMECORE_BYCONTAINBEHAVIORFLAG_METHOD_4_4C8D32059C9B7C27_OFFSET UNITYSDK_OFFSET(0x1701D0B0)
#define RPG_GAMECORE_BYCONTAINBEHAVIORFLAG_METHOD_4_5F448CBA177F31DA_OFFSET UNITYSDK_OFFSET(0x1701CFD0)
#define RPG_GAMECORE_BYCONTAINBEHAVIORFLAG__CTOR_OFFSET UNITYSDK_OFFSET(0x1701D050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByContainBehaviorFlag_TypeDefinitionIndex = 21218;
