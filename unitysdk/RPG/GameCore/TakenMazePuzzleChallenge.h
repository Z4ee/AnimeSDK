...
#define RPG_GAMECORE_TAKENMAZEPUZZLECHALLENGE_METHOD_3_574E6147F75AFB5A_OFFSET UNITYSDK_OFFSET(0x1D59D1E0)
#define RPG_GAMECORE_TAKENMAZEPUZZLECHALLENGE_METHOD_3_8E6691D8C4734E33_OFFSET UNITYSDK_OFFSET(0x1D59D280)
#define RPG_GAMECORE_TAKENMAZEPUZZLECHALLENGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D59D240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TakenMazePuzzleChallenge_TypeDefinitionIndex = 21761;
	...
	public:
		...
		static ::System::Void Method_3_574E6147F75AFB5A(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::TakenMazePuzzleChallenge*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::TakenMazePuzzleChallenge*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_TAKENMAZEPUZZLECHALLENGE_METHOD_3_574E6147F75AFB5A_OFFSET))(a1, a2);
		}
