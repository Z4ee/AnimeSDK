...
#define RPG_GAMECORE_TAKENMAZEPUZZLECHALLENGE_METHOD_3_15D1EA72CAAA9698_OFFSET UNITYSDK_OFFSET(0x177A7B40)
#define RPG_GAMECORE_TAKENMAZEPUZZLECHALLENGE_METHOD_3_FF7655CB66D322A3_OFFSET UNITYSDK_OFFSET(0x177A7A00)
#define RPG_GAMECORE_TAKENMAZEPUZZLECHALLENGE__CTOR_OFFSET UNITYSDK_OFFSET(0x177A7AB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TakenMazePuzzleChallenge_TypeDefinitionIndex = 20185;
