...
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_ATTACKER_METHOD_3_EFD9730EA81F09B4_OFFSET UNITYSDK_OFFSET(0x187E6470)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_ATTACKER_METHOD_3_FF9B618AC7AB4409_OFFSET UNITYSDK_OFFSET(0x187E63D0)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_ATTACKER__CTOR_OFFSET UNITYSDK_OFFSET(0x187E6460)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleTargetEvaluator_Attacker_TypeDefinitionIndex = 14934;
