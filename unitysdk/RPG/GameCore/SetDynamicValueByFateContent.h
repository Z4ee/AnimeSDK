...
#define RPG_GAMECORE_SETDYNAMICVALUEBYFATECONTENT_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x176C11C0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYFATECONTENT_METHOD_4_5A0E313287045A20_OFFSET UNITYSDK_OFFSET(0x176BAA00)
#define RPG_GAMECORE_SETDYNAMICVALUEBYFATECONTENT_METHOD_4_C9CA1B2B1BEA4888_OFFSET UNITYSDK_OFFSET(0x176C1140)
#define RPG_GAMECORE_SETDYNAMICVALUEBYFATECONTENT__CTOR_OFFSET UNITYSDK_OFFSET(0x176BA9B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByFateContent_TypeDefinitionIndex = 21522;
