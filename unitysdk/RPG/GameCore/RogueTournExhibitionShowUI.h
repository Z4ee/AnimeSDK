...
#define RPG_GAMECORE_ROGUETOURNEXHIBITIONSHOWUI_METHOD_3_252BC2ADFD7E1F6F_OFFSET UNITYSDK_OFFSET(0x176653C0)
#define RPG_GAMECORE_ROGUETOURNEXHIBITIONSHOWUI_METHOD_3_4F25FF2A392A4594_OFFSET UNITYSDK_OFFSET(0x17665440)
#define RPG_GAMECORE_ROGUETOURNEXHIBITIONSHOWUI__CTOR_OFFSET UNITYSDK_OFFSET(0x17665410)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournExhibitionShowUI_TypeDefinitionIndex = 20301;
