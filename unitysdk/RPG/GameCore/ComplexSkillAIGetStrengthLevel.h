...
#define RPG_GAMECORE_COMPLEXSKILLAIGETSTRENGTHLEVEL_METHOD_3_BE327CCC6FD0F52C_OFFSET UNITYSDK_OFFSET(0x18829F60)
#define RPG_GAMECORE_COMPLEXSKILLAIGETSTRENGTHLEVEL_METHOD_3_E88CA08579D3D675_OFFSET UNITYSDK_OFFSET(0x18829EA0)
#define RPG_GAMECORE_COMPLEXSKILLAIGETSTRENGTHLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x18829F40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAIGetStrengthLevel_TypeDefinitionIndex = 14737;
