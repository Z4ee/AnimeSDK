...
#define RPG_GAMECORE_COMPLEXSKILLAIGETSTRENGTHLEVEL_METHOD_3_2180C52B6118FF41_OFFSET UNITYSDK_OFFSET(0x1BC250F0)
#define RPG_GAMECORE_COMPLEXSKILLAIGETSTRENGTHLEVEL_METHOD_3_BE327CCC6FD0F52C_OFFSET UNITYSDK_OFFSET(0x1BC25170)
#define RPG_GAMECORE_COMPLEXSKILLAIGETSTRENGTHLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC25160)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAIGetStrengthLevel_TypeDefinitionIndex = 14964;
