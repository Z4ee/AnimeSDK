...
#define RPG_GAMECORE_FUNCTIONCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x197AB720)
#define RPG_GAMECORE_FUNCTIONCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x197AB920)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FunctionConfigRow_TypeDefinitionIndex = 12681;
