...
#define RPG_GAMECORE_MARBLEBYDEFENDERFEATURE_METHOD_4_2460F7B9D74CDE8A_OFFSET UNITYSDK_OFFSET(0x1738ABC0)
#define RPG_GAMECORE_MARBLEBYDEFENDERFEATURE_METHOD_4_B2EEA8F4C79316CF_OFFSET UNITYSDK_OFFSET(0x1738AAE0)
#define RPG_GAMECORE_MARBLEBYDEFENDERFEATURE__CTOR_OFFSET UNITYSDK_OFFSET(0x1738AB70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleByDefenderFeature_TypeDefinitionIndex = 15453;
