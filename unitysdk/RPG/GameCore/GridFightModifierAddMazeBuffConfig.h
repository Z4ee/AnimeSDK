...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDMAZEBUFFCONFIG_METHOD_3_9A77E1CB54F1A31C_OFFSET UNITYSDK_OFFSET(0x17260340)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDMAZEBUFFCONFIG_METHOD_3_DBD1153E06A344F5_OFFSET UNITYSDK_OFFSET(0x17260410)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDMAZEBUFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x172603C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierAddMazeBuffConfig_TypeDefinitionIndex = 17819;
