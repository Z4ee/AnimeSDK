...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYMAGICUNITAUTOCOMPOSEREWARDCOUNTCONFIG_METHOD_3_6131CA38F49A2906_OFFSET UNITYSDK_OFFSET(0x17634800)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYMAGICUNITAUTOCOMPOSEREWARDCOUNTCONFIG_METHOD_3_97E78FC6F0CBADAF_OFFSET UNITYSDK_OFFSET(0x17634730)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYMAGICUNITAUTOCOMPOSEREWARDCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x176347B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyMagicUnitAutoComposeRewardCountConfig_TypeDefinitionIndex = 16289;
