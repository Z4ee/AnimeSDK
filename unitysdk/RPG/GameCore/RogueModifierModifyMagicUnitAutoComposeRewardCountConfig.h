...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYMAGICUNITAUTOCOMPOSEREWARDCOUNTCONFIG_METHOD_3_0192AE6F0580EDAA_OFFSET UNITYSDK_OFFSET(0x1D3FA140)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYMAGICUNITAUTOCOMPOSEREWARDCOUNTCONFIG_METHOD_3_6131CA38F49A2906_OFFSET UNITYSDK_OFFSET(0x1D3FA190)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYMAGICUNITAUTOCOMPOSEREWARDCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3FA180)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyMagicUnitAutoComposeRewardCountConfig_TypeDefinitionIndex = 17523;
