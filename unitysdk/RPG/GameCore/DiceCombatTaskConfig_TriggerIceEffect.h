...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TRIGGERICEEFFECT_METHOD_3_5AADE336FD72A4F2_OFFSET UNITYSDK_OFFSET(0x171715D0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TRIGGERICEEFFECT_METHOD_3_CD7DA319DCB69037_OFFSET UNITYSDK_OFFSET(0x1716E990)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TRIGGERICEEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1716E940)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_TriggerIceEffect_TypeDefinitionIndex = 14779;
