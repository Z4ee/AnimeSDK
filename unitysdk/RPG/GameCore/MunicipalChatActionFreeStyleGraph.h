...
#define RPG_GAMECORE_MUNICIPALCHATACTIONFREESTYLEGRAPH_METHOD_3_5117408C87290418_OFFSET UNITYSDK_OFFSET(0x199B7680)
#define RPG_GAMECORE_MUNICIPALCHATACTIONFREESTYLEGRAPH_METHOD_3_578D0440C887C159_OFFSET UNITYSDK_OFFSET(0x199B7DB0)
#define RPG_GAMECORE_MUNICIPALCHATACTIONFREESTYLEGRAPH__CTOR_OFFSET UNITYSDK_OFFSET(0x199B7670)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MunicipalChatActionFreeStyleGraph_TypeDefinitionIndex = 16067;
