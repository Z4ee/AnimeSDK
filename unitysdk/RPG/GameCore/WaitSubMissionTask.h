...
#define RPG_GAMECORE_WAITSUBMISSIONTASK_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19D40B00)
#define RPG_GAMECORE_WAITSUBMISSIONTASK_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x19D40C00)
#define RPG_GAMECORE_WAITSUBMISSIONTASK_ONSKIP_OFFSET UNITYSDK_OFFSET(0x19D40DD0)
#define RPG_GAMECORE_WAITSUBMISSIONTASK_ONSUBMISSIONFINISH_OFFSET UNITYSDK_OFFSET(0x19D40E20)
#define RPG_GAMECORE_WAITSUBMISSIONTASK_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x19D40C10)
#define RPG_GAMECORE_WAITSUBMISSIONTASK_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x19D40D20)
#define RPG_GAMECORE_WAITSUBMISSIONTASK_REGIST_OFFSET UNITYSDK_OFFSET(0x19D40C60)
#define RPG_GAMECORE_WAITSUBMISSIONTASK_TICK_OFFSET UNITYSDK_OFFSET(0x19D40D70)
#define RPG_GAMECORE_WAITSUBMISSIONTASK_UNREGIST_OFFSET UNITYSDK_OFFSET(0x19D40B50)
#define RPG_GAMECORE_WAITSUBMISSIONTASK__CTOR_OFFSET UNITYSDK_OFFSET(0x19D40AE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitSubMissionTask_TypeDefinitionIndex = 56296;
