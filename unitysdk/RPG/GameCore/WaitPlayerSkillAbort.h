...
#define RPG_GAMECORE_WAITPLAYERSKILLABORT_METHOD_3_037EE14AD098D848_OFFSET UNITYSDK_OFFSET(0x1D1B8D50)
#define RPG_GAMECORE_WAITPLAYERSKILLABORT_METHOD_3_4461C77B126F937D_OFFSET UNITYSDK_OFFSET(0x1D1B8D10)
#define RPG_GAMECORE_WAITPLAYERSKILLABORT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1B8D40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitPlayerSkillAbort_TypeDefinitionIndex = 20127;
