...
#define RPG_GAMECORE_WAITPLAYERSKILLABORT_METHOD_3_037EE14AD098D848_OFFSET UNITYSDK_OFFSET(0x19E5CD30)
#define RPG_GAMECORE_WAITPLAYERSKILLABORT_METHOD_3_6610393933A30511_OFFSET UNITYSDK_OFFSET(0x19E5CCB0)
#define RPG_GAMECORE_WAITPLAYERSKILLABORT__CTOR_OFFSET UNITYSDK_OFFSET(0x19E5CD00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitPlayerSkillAbort_TypeDefinitionIndex = 19767;
