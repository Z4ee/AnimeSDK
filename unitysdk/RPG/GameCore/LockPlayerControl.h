...
#define RPG_GAMECORE_LOCKPLAYERCONTROL_METHOD_3_C96EDD76722AA2F7_OFFSET UNITYSDK_OFFSET(0x1BCCFB60)
#define RPG_GAMECORE_LOCKPLAYERCONTROL_METHOD_3_D421E47965B53706_OFFSET UNITYSDK_OFFSET(0x1BCCFBB0)
#define RPG_GAMECORE_LOCKPLAYERCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCCFBA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LockPlayerControl_TypeDefinitionIndex = 19514;
