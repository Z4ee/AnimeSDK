...
#define RPG_GAMECORE_LOCKPLAYERCONTROL_METHOD_3_23AF185D825B77FF_OFFSET UNITYSDK_OFFSET(0x18A79590)
#define RPG_GAMECORE_LOCKPLAYERCONTROL_METHOD_3_D421E47965B53706_OFFSET UNITYSDK_OFFSET(0x18A79620)
#define RPG_GAMECORE_LOCKPLAYERCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x18A795F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LockPlayerControl_TypeDefinitionIndex = 19237;
