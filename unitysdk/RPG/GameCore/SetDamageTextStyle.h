...
#define RPG_GAMECORE_SETDAMAGETEXTSTYLE_METHOD_3_5A2B956A6D502C20_OFFSET UNITYSDK_OFFSET(0x176B1830)
#define RPG_GAMECORE_SETDAMAGETEXTSTYLE_METHOD_3_95AE382F4836D24B_OFFSET UNITYSDK_OFFSET(0x176B18B0)
#define RPG_GAMECORE_SETDAMAGETEXTSTYLE__CTOR_OFFSET UNITYSDK_OFFSET(0x176B1880)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDamageTextStyle_TypeDefinitionIndex = 21155;
