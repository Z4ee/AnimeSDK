...
#define RPG_GAMECORE_OVERRIDEPERFORMANCEENDSCREENCUT_METHOD_3_74528B0A9F81DE82_OFFSET UNITYSDK_OFFSET(0x17483CE0)
#define RPG_GAMECORE_OVERRIDEPERFORMANCEENDSCREENCUT_METHOD_3_832E75E2D8D45FEB_OFFSET UNITYSDK_OFFSET(0x17483D60)
#define RPG_GAMECORE_OVERRIDEPERFORMANCEENDSCREENCUT__CTOR_OFFSET UNITYSDK_OFFSET(0x17483D30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OverridePerformanceEndScreenCut_TypeDefinitionIndex = 20087;
