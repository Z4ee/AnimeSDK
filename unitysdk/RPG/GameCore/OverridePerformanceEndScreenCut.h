...
#define RPG_GAMECORE_OVERRIDEPERFORMANCEENDSCREENCUT_METHOD_3_832E75E2D8D45FEB_OFFSET UNITYSDK_OFFSET(0x1D3050F0)
#define RPG_GAMECORE_OVERRIDEPERFORMANCEENDSCREENCUT_METHOD_3_A59BE0778272B158_OFFSET UNITYSDK_OFFSET(0x1D3050B0)
#define RPG_GAMECORE_OVERRIDEPERFORMANCEENDSCREENCUT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3050E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OverridePerformanceEndScreenCut_TypeDefinitionIndex = 21670;
