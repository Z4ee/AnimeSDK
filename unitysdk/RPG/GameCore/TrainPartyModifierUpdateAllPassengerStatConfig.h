...
#define RPG_GAMECORE_TRAINPARTYMODIFIERUPDATEALLPASSENGERSTATCONFIG_METHOD_3_012524A61FECDA50_OFFSET UNITYSDK_OFFSET(0x178AD260)
#define RPG_GAMECORE_TRAINPARTYMODIFIERUPDATEALLPASSENGERSTATCONFIG_METHOD_3_E4D8DA2E6CA22454_OFFSET UNITYSDK_OFFSET(0x178AD640)
#define RPG_GAMECORE_TRAINPARTYMODIFIERUPDATEALLPASSENGERSTATCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x178AD250)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyModifierUpdateAllPassengerStatConfig_TypeDefinitionIndex = 16613;
