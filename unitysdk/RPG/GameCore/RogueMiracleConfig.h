...
#define RPG_GAMECORE_ROGUEMIRACLECONFIG_METHOD_2_3191C7B069555E1B_OFFSET UNITYSDK_OFFSET(0x19B4B8D0)
#define RPG_GAMECORE_ROGUEMIRACLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B4B910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueMiracleConfig_TypeDefinitionIndex = 17040;
