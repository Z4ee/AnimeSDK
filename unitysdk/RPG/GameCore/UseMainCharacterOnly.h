...
#define RPG_GAMECORE_USEMAINCHARACTERONLY_METHOD_3_95B20367A03B88A9_OFFSET UNITYSDK_OFFSET(0x1B885B70)
#define RPG_GAMECORE_USEMAINCHARACTERONLY_METHOD_3_C7872ACD2E4BCEEC_OFFSET UNITYSDK_OFFSET(0x1B885C40)
#define RPG_GAMECORE_USEMAINCHARACTERONLY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B885C30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UseMainCharacterOnly_TypeDefinitionIndex = 19670;
