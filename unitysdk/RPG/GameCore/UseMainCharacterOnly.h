...
#define RPG_GAMECORE_USEMAINCHARACTERONLY_METHOD_3_6C86B3F80D30A8E0_OFFSET UNITYSDK_OFFSET(0x178E8040)
#define RPG_GAMECORE_USEMAINCHARACTERONLY_METHOD_3_C7872ACD2E4BCEEC_OFFSET UNITYSDK_OFFSET(0x178E8150)
#define RPG_GAMECORE_USEMAINCHARACTERONLY__CTOR_OFFSET UNITYSDK_OFFSET(0x178E8120)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UseMainCharacterOnly_TypeDefinitionIndex = 18752;
