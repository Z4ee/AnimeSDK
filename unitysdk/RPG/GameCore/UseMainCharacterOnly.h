...
#define RPG_GAMECORE_USEMAINCHARACTERONLY_METHOD_3_6C86B3F80D30A8E0_OFFSET UNITYSDK_OFFSET(0x190E6860)
#define RPG_GAMECORE_USEMAINCHARACTERONLY_METHOD_3_C7872ACD2E4BCEEC_OFFSET UNITYSDK_OFFSET(0x190E6970)
#define RPG_GAMECORE_USEMAINCHARACTERONLY__CTOR_OFFSET UNITYSDK_OFFSET(0x190E6940)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UseMainCharacterOnly_TypeDefinitionIndex = 19409;
