...
#define RPG_GAMECORE_STAGEGRASSOVERRIDECONFIG_METHOD_2_20B62182595CC99C_OFFSET UNITYSDK_OFFSET(0x1D0C1AA0)
#define RPG_GAMECORE_STAGEGRASSOVERRIDECONFIG_METHOD_2_2DD3D4560EB3EC36_OFFSET UNITYSDK_OFFSET(0x1D0C1D40)
#define RPG_GAMECORE_STAGEGRASSOVERRIDECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0C1D30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StageGrassOverrideConfig_TypeDefinitionIndex = 18903;
