...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYPERSONASTYLEGIFTPOOLRULECONFIG_METHOD_3_6E435CF68F0B2B83_OFFSET UNITYSDK_OFFSET(0x1D3FA610)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYPERSONASTYLEGIFTPOOLRULECONFIG_METHOD_3_AE8CF53AFF7B027F_OFFSET UNITYSDK_OFFSET(0x1D3FA5C0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYPERSONASTYLEGIFTPOOLRULECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3FA600)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyPersonaStyleGiftPoolRuleConfig_TypeDefinitionIndex = 17661;
