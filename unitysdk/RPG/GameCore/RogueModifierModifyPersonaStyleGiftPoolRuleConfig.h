...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYPERSONASTYLEGIFTPOOLRULECONFIG_METHOD_3_6E435CF68F0B2B83_OFFSET UNITYSDK_OFFSET(0x17635280)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYPERSONASTYLEGIFTPOOLRULECONFIG_METHOD_3_78F5D750E0722FCA_OFFSET UNITYSDK_OFFSET(0x176351B0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYPERSONASTYLEGIFTPOOLRULECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17635230)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyPersonaStyleGiftPoolRuleConfig_TypeDefinitionIndex = 16415;
