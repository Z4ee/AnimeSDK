...
#define RPG_GAMECORE_CHATBUBBLEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CF9FD40)
#define RPG_GAMECORE_CHATBUBBLEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF9FEB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChatBubbleRow_TypeDefinitionIndex = 12896;
