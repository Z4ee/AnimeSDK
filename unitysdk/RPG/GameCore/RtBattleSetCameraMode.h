...
#define RPG_GAMECORE_RTBATTLESETCAMERAMODE_METHOD_3_39B45A0DEA957682_OFFSET UNITYSDK_OFFSET(0x1BB89000)
#define RPG_GAMECORE_RTBATTLESETCAMERAMODE_METHOD_3_F49094647AD91B79_OFFSET UNITYSDK_OFFSET(0x1BB88FC0)
#define RPG_GAMECORE_RTBATTLESETCAMERAMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB88FF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtBattleSetCameraMode_TypeDefinitionIndex = 23238;
