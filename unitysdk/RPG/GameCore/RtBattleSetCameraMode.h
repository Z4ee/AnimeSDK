...
#define RPG_GAMECORE_RTBATTLESETCAMERAMODE_METHOD_3_39B45A0DEA957682_OFFSET UNITYSDK_OFFSET(0x18DC5870)
#define RPG_GAMECORE_RTBATTLESETCAMERAMODE_METHOD_3_D5BE7201D19E67AB_OFFSET UNITYSDK_OFFSET(0x18DC57F0)
#define RPG_GAMECORE_RTBATTLESETCAMERAMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x18DC5840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtBattleSetCameraMode_TypeDefinitionIndex = 23089;
