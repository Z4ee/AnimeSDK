...
#define RPG_GAMECORE_BYISSPLITDAMAGE_METHOD_4_0D9CF3E739A130D6_OFFSET UNITYSDK_OFFSET(0x1B2A5730)
#define RPG_GAMECORE_BYISSPLITDAMAGE_METHOD_4_1D37C2F5DA72A900_OFFSET UNITYSDK_OFFSET(0x1B2A5760)
#define RPG_GAMECORE_BYISSPLITDAMAGE_METHOD_4_796D736E12C2FA33_OFFSET UNITYSDK_OFFSET(0x1B2A5570)
#define RPG_GAMECORE_BYISSPLITDAMAGE_METHOD_4_D0F453910F8CA67A_OFFSET UNITYSDK_OFFSET(0x1B2A55B0)
#define RPG_GAMECORE_BYISSPLITDAMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2A55A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsSplitDamage_TypeDefinitionIndex = 22182;
