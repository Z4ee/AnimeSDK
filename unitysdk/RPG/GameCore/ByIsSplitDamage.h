...
#define RPG_GAMECORE_BYISSPLITDAMAGE_METHOD_4_38F7785594035B34_OFFSET UNITYSDK_OFFSET(0x17032FD0)
#define RPG_GAMECORE_BYISSPLITDAMAGE_METHOD_4_D0F453910F8CA67A_OFFSET UNITYSDK_OFFSET(0x170330A0)
#define RPG_GAMECORE_BYISSPLITDAMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x17033050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsSplitDamage_TypeDefinitionIndex = 21216;
