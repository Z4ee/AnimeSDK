...
#define RPG_GAMECORE_ALLEYDOCKGRIDITEMDATA_METHOD_3_2237E9C8303A5A8D_OFFSET UNITYSDK_OFFSET(0x18691100)
#define RPG_GAMECORE_ALLEYDOCKGRIDITEMDATA_METHOD_3_8A206B0167926DD8_OFFSET UNITYSDK_OFFSET(0x186927F0)
#define RPG_GAMECORE_ALLEYDOCKGRIDITEMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x186910F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AlleyDockGridItemData_TypeDefinitionIndex = 14840;
