...
#define RPG_GAMECORE_PHOTOGRAPHAIMCONTAINERLOCALPLAYER_METHOD_3_2C4872823B9F4B73_OFFSET UNITYSDK_OFFSET(0x18BF31B0)
#define RPG_GAMECORE_PHOTOGRAPHAIMCONTAINERLOCALPLAYER_METHOD_3_DC230AB034BE7E12_OFFSET UNITYSDK_OFFSET(0x18BF3270)
#define RPG_GAMECORE_PHOTOGRAPHAIMCONTAINERLOCALPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x18BF3230)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotoGraphAimContainerLocalPlayer_TypeDefinitionIndex = 16628;
