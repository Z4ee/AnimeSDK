...
#define RPG_GAMECORE_PHOTOGRAPHAIMCONTAINERLOCALPLAYER_METHOD_3_2C4872823B9F4B73_OFFSET UNITYSDK_OFFSET(0x1B4BF330)
#define RPG_GAMECORE_PHOTOGRAPHAIMCONTAINERLOCALPLAYER_METHOD_3_DC230AB034BE7E12_OFFSET UNITYSDK_OFFSET(0x1B4BF3F0)
#define RPG_GAMECORE_PHOTOGRAPHAIMCONTAINERLOCALPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4BF3B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotoGraphAimContainerLocalPlayer_TypeDefinitionIndex = 16820;
