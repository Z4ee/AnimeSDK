...
#define RPG_GAMECORE_ADVISOMETRICCAMERASIZEBLEND_METHOD_3_3ACF5845AFAD8B31_OFFSET UNITYSDK_OFFSET(0x16F31870)
#define RPG_GAMECORE_ADVISOMETRICCAMERASIZEBLEND_METHOD_3_EF7AB418B42AAC5D_OFFSET UNITYSDK_OFFSET(0x16F317F0)
#define RPG_GAMECORE_ADVISOMETRICCAMERASIZEBLEND__CTOR_OFFSET UNITYSDK_OFFSET(0x16F31840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvIsometricCameraSizeBlend_TypeDefinitionIndex = 20405;
