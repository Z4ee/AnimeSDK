...
#define RPG_GAMECORE_GRIDFIGHTAUGMENTREMARKCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D14BA70)
#define RPG_GAMECORE_GRIDFIGHTAUGMENTREMARKCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D14BBF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightAugmentRemarkConfigRow_TypeDefinitionIndex = 13300;
