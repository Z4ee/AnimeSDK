...
#define RPG_GAMECORE_GRIDFIGHTAUGMENTREMARKCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D961620)
#define RPG_GAMECORE_GRIDFIGHTAUGMENTREMARKCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D9617A0)
