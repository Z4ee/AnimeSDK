...
#define RPG_GAMECORE_MONSTERRANDOMPOOLROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x199ADB20)
#define RPG_GAMECORE_MONSTERRANDOMPOOLROW__CTOR_OFFSET UNITYSDK_OFFSET(0x199ADC90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonsterRandomPoolRow_TypeDefinitionIndex = 13523;

	class MonsterRandomPoolRow : public ::System::Object
	{
	public:
		::Il2CppArray<::System::UInt32>* ElitePool; // 0x10
		::Il2CppArray<::System::UInt32>* MinionPool; // 0x18
