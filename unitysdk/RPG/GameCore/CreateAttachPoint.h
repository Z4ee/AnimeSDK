...
#define RPG_GAMECORE_CREATEATTACHPOINT_METHOD_3_C6D09A6E4263A73D_OFFSET UNITYSDK_OFFSET(0x17138D70)
#define RPG_GAMECORE_CREATEATTACHPOINT_METHOD_3_F4FFC26B08457FA6_OFFSET UNITYSDK_OFFSET(0x17138C90)
#define RPG_GAMECORE_CREATEATTACHPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x17138D10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CreateAttachPoint_TypeDefinitionIndex = 21415;
