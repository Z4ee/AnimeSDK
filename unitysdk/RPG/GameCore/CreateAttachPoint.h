...
#define RPG_GAMECORE_CREATEATTACHPOINT_METHOD_3_C6D09A6E4263A73D_OFFSET UNITYSDK_OFFSET(0x1967F530)
#define RPG_GAMECORE_CREATEATTACHPOINT_METHOD_3_F4FFC26B08457FA6_OFFSET UNITYSDK_OFFSET(0x1967F450)
#define RPG_GAMECORE_CREATEATTACHPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1967F4D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CreateAttachPoint_TypeDefinitionIndex = 21933;
