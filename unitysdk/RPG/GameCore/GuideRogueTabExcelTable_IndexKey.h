...
#define RPG_GAMECORE_GUIDEROGUETABEXCELTABLE_INDEXKEY_EQUALS_OFFSET UNITYSDK_OFFSET(0x881AD0)
#define RPG_GAMECORE_GUIDEROGUETABEXCELTABLE_INDEXKEY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x167710)
#define RPG_GAMECORE_GUIDEROGUETABEXCELTABLE_INDEXKEY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x881A30)
#define RPG_GAMECORE_GUIDEROGUETABEXCELTABLE_INDEXKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x167520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GuideRogueTabExcelTable_IndexKey_TypeDefinitionIndex = 12895;
