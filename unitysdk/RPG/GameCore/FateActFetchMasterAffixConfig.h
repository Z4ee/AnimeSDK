...
#define RPG_GAMECORE_FATEACTFETCHMASTERAFFIXCONFIG_METHOD_6_1A035C019905C130_OFFSET UNITYSDK_OFFSET(0x1970C0E0)
#define RPG_GAMECORE_FATEACTFETCHMASTERAFFIXCONFIG_METHOD_6_AC62CE364C15156B_OFFSET UNITYSDK_OFFSET(0x1970BF70)
#define RPG_GAMECORE_FATEACTFETCHMASTERAFFIXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1970C040)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateActFetchMasterAffixConfig_TypeDefinitionIndex = 18253;
