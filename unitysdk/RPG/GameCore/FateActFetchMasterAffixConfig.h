...
#define RPG_GAMECORE_FATEACTFETCHMASTERAFFIXCONFIG_METHOD_6_1A035C019905C130_OFFSET UNITYSDK_OFFSET(0x188CF190)
#define RPG_GAMECORE_FATEACTFETCHMASTERAFFIXCONFIG_METHOD_6_AC62CE364C15156B_OFFSET UNITYSDK_OFFSET(0x188CF020)
#define RPG_GAMECORE_FATEACTFETCHMASTERAFFIXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x188CF0F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateActFetchMasterAffixConfig_TypeDefinitionIndex = 18280;
