...
#define RPG_GAMECORE_SWITCHREFROLLSHOPREWARD_METHOD_3_5FE57A24454483EE_OFFSET UNITYSDK_OFFSET(0x1E153190)
#define RPG_GAMECORE_SWITCHREFROLLSHOPREWARD_METHOD_3_D990F4CB652CDE6B_OFFSET UNITYSDK_OFFSET(0x1E153840)
#define RPG_GAMECORE_SWITCHREFROLLSHOPREWARD__CTOR_OFFSET UNITYSDK_OFFSET(0x1E153170)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchRefRollShopReward_TypeDefinitionIndex = 17335;
