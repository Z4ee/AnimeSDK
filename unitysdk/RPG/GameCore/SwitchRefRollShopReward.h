...
#define RPG_GAMECORE_SWITCHREFROLLSHOPREWARD_METHOD_3_32758402A454F3F6_OFFSET UNITYSDK_OFFSET(0x17799EB0)
#define RPG_GAMECORE_SWITCHREFROLLSHOPREWARD_METHOD_3_5FE57A24454483EE_OFFSET UNITYSDK_OFFSET(0x17799800)
#define RPG_GAMECORE_SWITCHREFROLLSHOPREWARD__CTOR_OFFSET UNITYSDK_OFFSET(0x177997A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchRefRollShopReward_TypeDefinitionIndex = 16110;
