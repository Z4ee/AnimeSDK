...
#define RPG_GAMECORE_FUNCENTRANCELISTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18934DD0)
#define RPG_GAMECORE_FUNCENTRANCELISTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18935510)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::Il2CppArray<::System::UInt32>* LeftHudFuncEntranceIDList; // 0x10
		::Il2CppArray<::System::UInt32>* UnlockGotoTypeList; // 0x18
		::Il2CppArray<::System::UInt32>* HudFuncEntranceIDList; // 0x20
		::Il2CppArray<::System::UInt32>* FuncEntranceIDList; // 0x28
		::Il2CppArray<::System::UInt32>* BottomFuncEntranceIDList; // 0x30
