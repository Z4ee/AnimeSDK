...
#define RPG_GAMECORE_ACTIVITYMODULEFIGHTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18621FF0)
#define RPG_GAMECORE_ACTIVITYMODULEFIGHTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x186220E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityModuleFightConfigRow_TypeDefinitionIndex = 11043;
