...
#define RPG_GAMECORE_BYCOMPARESPECIALSPRATIO_METHOD_4_0AD23D08ABDAF911_OFFSET UNITYSDK_OFFSET(0x170180C0)
#define RPG_GAMECORE_BYCOMPARESPECIALSPRATIO_METHOD_4_1AF099FFF0498863_OFFSET UNITYSDK_OFFSET(0x17017FF0)
#define RPG_GAMECORE_BYCOMPARESPECIALSPRATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x17018070)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareSpecialSPRatio_TypeDefinitionIndex = 21203;
