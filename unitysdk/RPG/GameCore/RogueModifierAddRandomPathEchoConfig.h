...
#define RPG_GAMECORE_ROGUEMODIFIERADDRANDOMPATHECHOCONFIG_METHOD_3_5B685F390E626992_OFFSET UNITYSDK_OFFSET(0x1CFBEF30)
#define RPG_GAMECORE_ROGUEMODIFIERADDRANDOMPATHECHOCONFIG_METHOD_3_DB71C7731B568A2E_OFFSET UNITYSDK_OFFSET(0x1CFBEF80)
#define RPG_GAMECORE_ROGUEMODIFIERADDRANDOMPATHECHOCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFBEF70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierAddRandomPathEchoConfig_TypeDefinitionIndex = 17263;
