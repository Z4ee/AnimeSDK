...
#define RPG_GAMECORE_ROGUEMODIFIERADDRANDOMPATHECHOCONFIG_METHOD_3_59A2BB10E7987F57_OFFSET UNITYSDK_OFFSET(0x18D2A630)
#define RPG_GAMECORE_ROGUEMODIFIERADDRANDOMPATHECHOCONFIG_METHOD_3_DB71C7731B568A2E_OFFSET UNITYSDK_OFFSET(0x18D2A700)
#define RPG_GAMECORE_ROGUEMODIFIERADDRANDOMPATHECHOCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D2A6B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierAddRandomPathEchoConfig_TypeDefinitionIndex = 17088;
