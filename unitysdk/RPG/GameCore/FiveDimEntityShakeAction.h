...
#define RPG_GAMECORE_FIVEDIMENTITYSHAKEACTION_METHOD_3_DA0E7721DFA39A55_OFFSET UNITYSDK_OFFSET(0x171E79F0)
#define RPG_GAMECORE_FIVEDIMENTITYSHAKEACTION_METHOD_3_E060A9277D22AB64_OFFSET UNITYSDK_OFFSET(0x171F0F80)
#define RPG_GAMECORE_FIVEDIMENTITYSHAKEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x171E79D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimEntityShakeAction_TypeDefinitionIndex = 17209;
