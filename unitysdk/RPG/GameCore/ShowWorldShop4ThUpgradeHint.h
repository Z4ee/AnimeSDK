...
#define RPG_GAMECORE_SHOWWORLDSHOP4THUPGRADEHINT_METHOD_3_80017438CFD7776B_OFFSET UNITYSDK_OFFSET(0x19C87920)
#define RPG_GAMECORE_SHOWWORLDSHOP4THUPGRADEHINT_METHOD_3_F209B95F3BF3DD84_OFFSET UNITYSDK_OFFSET(0x19C879A0)
#define RPG_GAMECORE_SHOWWORLDSHOP4THUPGRADEHINT__CTOR_OFFSET UNITYSDK_OFFSET(0x19C87970)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowWorldShop4ThUpgradeHint_TypeDefinitionIndex = 20720;
