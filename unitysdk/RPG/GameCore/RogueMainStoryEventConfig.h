...
#define RPG_GAMECORE_ROGUEMAINSTORYEVENTCONFIG_METHOD_2_663A84BFDFBB0EEE_OFFSET UNITYSDK_OFFSET(0x19B492D0)
#define RPG_GAMECORE_ROGUEMAINSTORYEVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B49310)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueMainStoryEventConfig_TypeDefinitionIndex = 17116;
