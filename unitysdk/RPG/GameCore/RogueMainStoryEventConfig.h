...
#define RPG_GAMECORE_ROGUEMAINSTORYEVENTCONFIG_METHOD_2_663A84BFDFBB0EEE_OFFSET UNITYSDK_OFFSET(0x1EEF2CA0)
#define RPG_GAMECORE_ROGUEMAINSTORYEVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEF2CE0)
