...
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_CHANGEMOVESPEED_METHOD_3_904F63B86B049407_OFFSET UNITYSDK_OFFSET(0x19620AF0)
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_CHANGEMOVESPEED_METHOD_3_A0A6CCE1F9D7C173_OFFSET UNITYSDK_OFFSET(0x19620A20)
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_CHANGEMOVESPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x19620AE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleEffect_ChangeMoveSpeed_TypeDefinitionIndex = 15019;
