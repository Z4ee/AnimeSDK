...
#define RPG_GAMECORE_RUBIKEVENTLISTENER_METHOD_3_276B609117525195_OFFSET UNITYSDK_OFFSET(0x19BF9C40)
#define RPG_GAMECORE_RUBIKEVENTLISTENER_METHOD_3_F587DEC2BB604759_OFFSET UNITYSDK_OFFSET(0x19BF9BC0)
#define RPG_GAMECORE_RUBIKEVENTLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x19BF9C10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RubikEventListener_TypeDefinitionIndex = 20921;
