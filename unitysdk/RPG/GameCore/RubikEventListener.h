...
#define RPG_GAMECORE_RUBIKEVENTLISTENER_METHOD_3_276B609117525195_OFFSET UNITYSDK_OFFSET(0x18DDCF10)
#define RPG_GAMECORE_RUBIKEVENTLISTENER_METHOD_3_F587DEC2BB604759_OFFSET UNITYSDK_OFFSET(0x18DDCE90)
#define RPG_GAMECORE_RUBIKEVENTLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x18DDCEE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RubikEventListener_TypeDefinitionIndex = 21012;
