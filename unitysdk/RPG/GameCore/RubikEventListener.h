...
#define RPG_GAMECORE_RUBIKEVENTLISTENER_METHOD_3_276B609117525195_OFFSET UNITYSDK_OFFSET(0x1D4B9F80)
#define RPG_GAMECORE_RUBIKEVENTLISTENER_METHOD_3_DCB5001352564EE2_OFFSET UNITYSDK_OFFSET(0x1D4B9F40)
#define RPG_GAMECORE_RUBIKEVENTLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4B9F70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RubikEventListener_TypeDefinitionIndex = 21897;
