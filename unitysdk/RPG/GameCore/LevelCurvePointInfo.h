...
#define RPG_GAMECORE_LEVELCURVEPOINTINFO_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1D1CA560)
#define RPG_GAMECORE_LEVELCURVEPOINTINFO_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D1CC390)
#define RPG_GAMECORE_LEVELCURVEPOINTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1CA550)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelCurvePointInfo_TypeDefinitionIndex = 17179;
