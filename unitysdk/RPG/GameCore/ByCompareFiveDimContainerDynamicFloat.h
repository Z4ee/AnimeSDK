...
#define RPG_GAMECORE_BYCOMPAREFIVEDIMCONTAINERDYNAMICFLOAT_METHOD_4_B5EE7BB41BE22F6E_OFFSET UNITYSDK_OFFSET(0x1872CA70)
#define RPG_GAMECORE_BYCOMPAREFIVEDIMCONTAINERDYNAMICFLOAT_METHOD_4_EB638552A0BF517E_OFFSET UNITYSDK_OFFSET(0x1872CB50)
#define RPG_GAMECORE_BYCOMPAREFIVEDIMCONTAINERDYNAMICFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1872CAF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareFiveDimContainerDynamicFloat_TypeDefinitionIndex = 20328;
