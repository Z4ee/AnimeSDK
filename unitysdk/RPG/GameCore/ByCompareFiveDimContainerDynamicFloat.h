...
#define RPG_GAMECORE_BYCOMPAREFIVEDIMCONTAINERDYNAMICFLOAT_METHOD_4_A0AD184CA48493B4_OFFSET UNITYSDK_OFFSET(0x19CE1CE0)
#define RPG_GAMECORE_BYCOMPAREFIVEDIMCONTAINERDYNAMICFLOAT_METHOD_4_BF731151B80979DB_OFFSET UNITYSDK_OFFSET(0x19CE1D20)
#define RPG_GAMECORE_BYCOMPAREFIVEDIMCONTAINERDYNAMICFLOAT_METHOD_4_EB638552A0BF517E_OFFSET UNITYSDK_OFFSET(0x19CE1AB0)
#define RPG_GAMECORE_BYCOMPAREFIVEDIMCONTAINERDYNAMICFLOAT_METHOD_4_F6FFEA2B5D0D9A5F_OFFSET UNITYSDK_OFFSET(0x19CE1A60)
#define RPG_GAMECORE_BYCOMPAREFIVEDIMCONTAINERDYNAMICFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x19CE1AA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareFiveDimContainerDynamicFloat_TypeDefinitionIndex = 20640;
