...
#define RPG_GAMECORE_FIVEDIMLEVELVARBINDINGEXTRAINFO_METHOD_3_04A8A7469D7CEAAF_OFFSET UNITYSDK_OFFSET(0x19745260)
#define RPG_GAMECORE_FIVEDIMLEVELVARBINDINGEXTRAINFO_METHOD_3_3AEA9B4E821CDA9C_OFFSET UNITYSDK_OFFSET(0x197452A0)
#define RPG_GAMECORE_FIVEDIMLEVELVARBINDINGEXTRAINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19745290)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimLevelVarBindingExtraInfo_TypeDefinitionIndex = 17607;
