...
#define RPG_GAMECORE_FIVEDIMLEVELVARBINDINGEXTRAINFO_METHOD_3_04A8A7469D7CEAAF_OFFSET UNITYSDK_OFFSET(0x171F8EA0)
#define RPG_GAMECORE_FIVEDIMLEVELVARBINDINGEXTRAINFO_METHOD_3_3AEA9B4E821CDA9C_OFFSET UNITYSDK_OFFSET(0x171F8EE0)
#define RPG_GAMECORE_FIVEDIMLEVELVARBINDINGEXTRAINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x171F8ED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimLevelVarBindingExtraInfo_TypeDefinitionIndex = 16987;
