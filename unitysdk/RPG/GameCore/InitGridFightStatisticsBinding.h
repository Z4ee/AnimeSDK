...
#define RPG_GAMECORE_INITGRIDFIGHTSTATISTICSBINDING_METHOD_3_5E15576C1B05EBA8_OFFSET UNITYSDK_OFFSET(0x1B0104F0)
#define RPG_GAMECORE_INITGRIDFIGHTSTATISTICSBINDING_METHOD_3_E87B95A19586D15F_OFFSET UNITYSDK_OFFSET(0x1B010530)
#define RPG_GAMECORE_INITGRIDFIGHTSTATISTICSBINDING__CTOR_OFFSET UNITYSDK_OFFSET(0x1B010520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int InitGridFightStatisticsBinding_TypeDefinitionIndex = 21725;
