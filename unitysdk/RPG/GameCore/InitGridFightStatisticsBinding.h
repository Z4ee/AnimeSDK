...
#define RPG_GAMECORE_INITGRIDFIGHTSTATISTICSBINDING_METHOD_3_6FE92D0E2E87AE17_OFFSET UNITYSDK_OFFSET(0x172BBED0)
#define RPG_GAMECORE_INITGRIDFIGHTSTATISTICSBINDING_METHOD_3_E4A8E46A56DA7D86_OFFSET UNITYSDK_OFFSET(0x172BBF50)
#define RPG_GAMECORE_INITGRIDFIGHTSTATISTICSBINDING__CTOR_OFFSET UNITYSDK_OFFSET(0x172BBF20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int InitGridFightStatisticsBinding_TypeDefinitionIndex = 20727;
