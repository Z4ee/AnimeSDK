...
#define RPG_GAMECORE_STAGEPARAMENTRY_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CAE99D0)
#define RPG_GAMECORE_STAGEPARAMENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1CAE9B10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StageParamEntry_TypeDefinitionIndex = 14976;
