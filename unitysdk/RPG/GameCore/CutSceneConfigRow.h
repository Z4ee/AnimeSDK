...
#define RPG_GAMECORE_CUTSCENECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18848FB0)
#define RPG_GAMECORE_CUTSCENECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x188493D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CutSceneConfigRow_TypeDefinitionIndex = 12379;

	class CutSceneConfigRow : public ::System::Object
	{
	public:
		::System::String* CaptionPath; // 0x10
		::System::String* CutSceneBGMStateName; // 0x18
		::Il2CppArray<::System::Single>* PosOffSet; // 0x20
		::System::String* CutSceneSFXJsonPath; // 0x28
		::System::String* CutScenePath; // 0x30
		::System::String* CutSceneName; // 0x38
		::Il2CppArray<::System::String*>* HideBlockList; // 0x40
		::System::UInt32 VoiceID; // 0x48
		::System::Boolean IsPlayerInvolved; // 0x4C
		::System::UInt32 MazePlaneID; // 0x50
		::System::UInt32 SFXID; // 0x54
