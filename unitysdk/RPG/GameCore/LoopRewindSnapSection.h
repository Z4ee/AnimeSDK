...
#define RPG_GAMECORE_LOOPREWINDSNAPSECTION_METHOD_2_A94C582ADB19F8B5_OFFSET UNITYSDK_OFFSET(0x17370690)
#define RPG_GAMECORE_LOOPREWINDSNAPSECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x17370810)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoopRewindSnapSection_TypeDefinitionIndex = 18951;
