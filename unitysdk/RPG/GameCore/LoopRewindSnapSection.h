...
#define RPG_GAMECORE_LOOPREWINDSNAPSECTION_METHOD_2_A94C582ADB19F8B5_OFFSET UNITYSDK_OFFSET(0x18A7E2A0)
#define RPG_GAMECORE_LOOPREWINDSNAPSECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18A7E420)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoopRewindSnapSection_TypeDefinitionIndex = 19609;
