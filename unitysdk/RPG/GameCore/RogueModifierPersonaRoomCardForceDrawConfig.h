...
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAROOMCARDFORCEDRAWCONFIG_METHOD_3_354C33DB644B8589_OFFSET UNITYSDK_OFFSET(0x17637750)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAROOMCARDFORCEDRAWCONFIG_METHOD_3_92F42777B7552220_OFFSET UNITYSDK_OFFSET(0x17637820)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAROOMCARDFORCEDRAWCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x176377D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierPersonaRoomCardForceDrawConfig_TypeDefinitionIndex = 16356;
