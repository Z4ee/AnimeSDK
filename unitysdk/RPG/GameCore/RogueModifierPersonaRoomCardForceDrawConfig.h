...
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAROOMCARDFORCEDRAWCONFIG_METHOD_3_92F42777B7552220_OFFSET UNITYSDK_OFFSET(0x1D1652B0)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAROOMCARDFORCEDRAWCONFIG_METHOD_3_C3BEF79C9BE50CE4_OFFSET UNITYSDK_OFFSET(0x1D165260)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAROOMCARDFORCEDRAWCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1652A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierPersonaRoomCardForceDrawConfig_TypeDefinitionIndex = 17087;
