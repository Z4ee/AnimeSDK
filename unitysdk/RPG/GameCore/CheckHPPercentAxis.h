...
#define RPG_GAMECORE_CHECKHPPERCENTAXIS_METHOD_3_475EA0CEAF129533_OFFSET UNITYSDK_OFFSET(0x170754C0)
#define RPG_GAMECORE_CHECKHPPERCENTAXIS_METHOD_3_930157C64FD65DE6_OFFSET UNITYSDK_OFFSET(0x17075500)
#define RPG_GAMECORE_CHECKHPPERCENTAXIS__CTOR_OFFSET UNITYSDK_OFFSET(0x170754F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CheckHPPercentAxis_TypeDefinitionIndex = 14201;
