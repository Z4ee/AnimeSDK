...
#define RPG_GAMECORE_CHECKHPPERCENTAXIS_METHOD_3_475EA0CEAF129533_OFFSET UNITYSDK_OFFSET(0x1B72DB20)
#define RPG_GAMECORE_CHECKHPPERCENTAXIS_METHOD_3_930157C64FD65DE6_OFFSET UNITYSDK_OFFSET(0x1B72DB60)
#define RPG_GAMECORE_CHECKHPPERCENTAXIS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B72DB50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CheckHPPercentAxis_TypeDefinitionIndex = 14896;
