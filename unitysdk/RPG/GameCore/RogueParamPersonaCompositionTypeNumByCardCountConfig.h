...
#define RPG_GAMECORE_ROGUEPARAMPERSONACOMPOSITIONTYPENUMBYCARDCOUNTCONFIG_METHOD_6_A2B5E8EEFDA54AD1_OFFSET UNITYSDK_OFFSET(0x18D59950)
#define RPG_GAMECORE_ROGUEPARAMPERSONACOMPOSITIONTYPENUMBYCARDCOUNTCONFIG_METHOD_6_AEDEDD1635BEB627_OFFSET UNITYSDK_OFFSET(0x18D596A0)
#define RPG_GAMECORE_ROGUEPARAMPERSONACOMPOSITIONTYPENUMBYCARDCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D59820)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamPersonaCompositionTypeNumByCardCountConfig_TypeDefinitionIndex = 18850;
