...
#define RPG_GAMECORE_FIVEDIMRENDERINGITEMSTATEMAPPINGCONFIG_METHOD_2_1398510D878EA43C_OFFSET UNITYSDK_OFFSET(0x172075A0)
#define RPG_GAMECORE_FIVEDIMRENDERINGITEMSTATEMAPPINGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x172076F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimRenderingItemStateMappingConfig_TypeDefinitionIndex = 15320;
