...
#define RPG_GAMECORE_FIVEDIMRENDERINGITEMSTATEMAPPINGCONFIG_METHOD_2_DDFA9E36DCBD396A_OFFSET UNITYSDK_OFFSET(0x1BEAE6A0)
#define RPG_GAMECORE_FIVEDIMRENDERINGITEMSTATEMAPPINGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEAE780)
