...
#define RPG_GAMECORE_TRAVELSHIPRESETSTATE_METHOD_3_1A6F4C6FAAC2A2AD_OFFSET UNITYSDK_OFFSET(0x178B7D00)
#define RPG_GAMECORE_TRAVELSHIPRESETSTATE_METHOD_3_302EE82858B35AD4_OFFSET UNITYSDK_OFFSET(0x178B7C70)
#define RPG_GAMECORE_TRAVELSHIPRESETSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x178B7CD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TravelShipResetState_TypeDefinitionIndex = 19306;
