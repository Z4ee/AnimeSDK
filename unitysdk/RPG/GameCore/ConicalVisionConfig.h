...
#define RPG_GAMECORE_CONICALVISIONCONFIG_METHOD_3_281CB1C61BA7983B_OFFSET UNITYSDK_OFFSET(0x19674850)
#define RPG_GAMECORE_CONICALVISIONCONFIG_METHOD_3_F89CF6A3672CD537_OFFSET UNITYSDK_OFFSET(0x19674900)
#define RPG_GAMECORE_CONICALVISIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x196748C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConicalVisionConfig_TypeDefinitionIndex = 18874;
