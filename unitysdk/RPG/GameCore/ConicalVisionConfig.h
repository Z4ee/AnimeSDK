...
#define RPG_GAMECORE_CONICALVISIONCONFIG_METHOD_3_281CB1C61BA7983B_OFFSET UNITYSDK_OFFSET(0x1CFFA4D0)
#define RPG_GAMECORE_CONICALVISIONCONFIG_METHOD_3_F89CF6A3672CD537_OFFSET UNITYSDK_OFFSET(0x1CFFA580)
#define RPG_GAMECORE_CONICALVISIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFFA540)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConicalVisionConfig_TypeDefinitionIndex = 19765;
