...
#define RPG_GAMECORE_SHOWBATTLECARDBUFFSELECTION_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1D522E20)
#define RPG_GAMECORE_SHOWBATTLECARDBUFFSELECTION_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D522DE0)
#define RPG_GAMECORE_SHOWBATTLECARDBUFFSELECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D522E10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowBattleCardBuffSelection_TypeDefinitionIndex = 22295;
