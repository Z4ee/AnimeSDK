...
#define RPG_GAMECORE_SHOWBATTLECARDBUFFSELECTION_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1E0A2F10)
#define RPG_GAMECORE_SHOWBATTLECARDBUFFSELECTION_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1E0A2ED0)
#define RPG_GAMECORE_SHOWBATTLECARDBUFFSELECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0A2F00)
