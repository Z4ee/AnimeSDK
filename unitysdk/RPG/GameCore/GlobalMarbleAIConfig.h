...
#define RPG_GAMECORE_GLOBALMARBLEAICONFIG_METHOD_2_24AAF11F1284A612_OFFSET UNITYSDK_OFFSET(0x1C5BBFD0)
#define RPG_GAMECORE_GLOBALMARBLEAICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5BC120)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GlobalMarbleAIConfig_TypeDefinitionIndex = 16236;
