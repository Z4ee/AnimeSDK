...
#define RPG_GAMECORE_ABILITYANYHPCHANGE_GETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0xA7C6860)
#define RPG_GAMECORE_ABILITYANYHPCHANGE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xA7C67C0)
#define RPG_GAMECORE_ABILITYANYHPCHANGE_GETNEGATIVEHPCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0xA7C68B0)
#define RPG_GAMECORE_ABILITYANYHPCHANGE_GETORIGINMODIFYVALUE_OFFSET UNITYSDK_OFFSET(0xA7C6810)
#define RPG_GAMECORE_ABILITYANYHPCHANGE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xA7C6770)
#define RPG_GAMECORE_ABILITYANYHPCHANGE_GET_CHANGEPARAMS_OFFSET UNITYSDK_OFFSET(0xA7C6900)
#define RPG_GAMECORE_ABILITYANYHPCHANGE_GET_MODIFYSOURCEENTITY_OFFSET UNITYSDK_OFFSET(0xA7C6940)
#define RPG_GAMECORE_ABILITYANYHPCHANGE_GET_USEBIGCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0xA7C6930)
#define RPG_GAMECORE_ABILITYANYHPCHANGE_INIT_OFFSET UNITYSDK_OFFSET(0xA7C66A0)
#define RPG_GAMECORE_ABILITYANYHPCHANGE_SET_CHANGEPARAMS_OFFSET UNITYSDK_OFFSET(0xA7C6920)
#define RPG_GAMECORE_ABILITYANYHPCHANGE_SET_MODIFYSOURCEENTITY_OFFSET UNITYSDK_OFFSET(0xA7C6950)
#define RPG_GAMECORE_ABILITYANYHPCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0xA7C6960)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AbilityAnyHPChange_TypeDefinitionIndex = 45469;
	...
	public:
		...
		::RPG::GameCore::FixPoint _OriginModifyValue; // 0x150
		::RPG::GameCore::FixPoint _NegativeHPChangeValue; // 0x158
		::RPG::GameCore::FixPoint _ChangeValue; // 0x160
		::System::UInt32 _EntityRuntimeID; // 0x168
