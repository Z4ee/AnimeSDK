...
#define RPG_GAMECORE_LITTLEGAMEABILITYTEAMTOWERSDESTROYBRICKEFFECTCONFIG_METHOD_3_9C04F34769FB3D73_OFFSET UNITYSDK_OFFSET(0x1B096900)
#define RPG_GAMECORE_LITTLEGAMEABILITYTEAMTOWERSDESTROYBRICKEFFECTCONFIG_METHOD_3_C9676A95E7FFB8F2_OFFSET UNITYSDK_OFFSET(0x1B096860)
#define RPG_GAMECORE_LITTLEGAMEABILITYTEAMTOWERSDESTROYBRICKEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0968F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityTeamTowersDestroyBrickEffectConfig_TypeDefinitionIndex = 20616;
