...
#define RPG_GAMECORE_QTECATCHGHOSTREWIND_METHOD_3_576E08067ED778DE_OFFSET UNITYSDK_OFFSET(0x18C7FCE0)
#define RPG_GAMECORE_QTECATCHGHOSTREWIND_METHOD_3_69DF8C042D29ACD3_OFFSET UNITYSDK_OFFSET(0x18C7FC60)
#define RPG_GAMECORE_QTECATCHGHOSTREWIND__CTOR_OFFSET UNITYSDK_OFFSET(0x18C7FCB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int QteCatchGhostRewind_TypeDefinitionIndex = 20906;
