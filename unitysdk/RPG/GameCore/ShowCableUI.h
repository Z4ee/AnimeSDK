...
#define RPG_GAMECORE_SHOWCABLEUI_METHOD_3_89D644A420A840EF_OFFSET UNITYSDK_OFFSET(0x176F78D0)
#define RPG_GAMECORE_SHOWCABLEUI_METHOD_3_C1CAF85E82BC851E_OFFSET UNITYSDK_OFFSET(0x176F7950)
#define RPG_GAMECORE_SHOWCABLEUI__CTOR_OFFSET UNITYSDK_OFFSET(0x176F7920)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowCableUI_TypeDefinitionIndex = 19224;
