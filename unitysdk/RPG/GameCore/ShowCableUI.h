...
#define RPG_GAMECORE_SHOWCABLEUI_METHOD_3_89D644A420A840EF_OFFSET UNITYSDK_OFFSET(0x18E5B340)
#define RPG_GAMECORE_SHOWCABLEUI_METHOD_3_C1CAF85E82BC851E_OFFSET UNITYSDK_OFFSET(0x18E5B3C0)
#define RPG_GAMECORE_SHOWCABLEUI__CTOR_OFFSET UNITYSDK_OFFSET(0x18E5B390)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowCableUI_TypeDefinitionIndex = 19883;
