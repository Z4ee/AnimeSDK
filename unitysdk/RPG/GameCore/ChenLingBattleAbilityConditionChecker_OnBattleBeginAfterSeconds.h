...
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_ONBATTLEBEGINAFTERSECONDS_METHOD_3_6E300EDE7C9396AB_OFFSET UNITYSDK_OFFSET(0x1C375050)
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_ONBATTLEBEGINAFTERSECONDS_METHOD_3_7D04B3EAE453AC37_OFFSET UNITYSDK_OFFSET(0x1C374F80)
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_ONBATTLEBEGINAFTERSECONDS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C375040)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleAbilityConditionChecker_OnBattleBeginAfterSeconds_TypeDefinitionIndex = 15118;
