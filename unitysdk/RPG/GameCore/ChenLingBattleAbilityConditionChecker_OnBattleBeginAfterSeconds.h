...
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_ONBATTLEBEGINAFTERSECONDS_METHOD_3_6E300EDE7C9396AB_OFFSET UNITYSDK_OFFSET(0x170781F0)
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_ONBATTLEBEGINAFTERSECONDS_METHOD_3_7D04B3EAE453AC37_OFFSET UNITYSDK_OFFSET(0x17078120)
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_ONBATTLEBEGINAFTERSECONDS__CTOR_OFFSET UNITYSDK_OFFSET(0x170781E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleAbilityConditionChecker_OnBattleBeginAfterSeconds_TypeDefinitionIndex = 14421;
