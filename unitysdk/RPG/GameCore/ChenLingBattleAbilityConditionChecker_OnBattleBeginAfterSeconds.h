...
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_ONBATTLEBEGINAFTERSECONDS_METHOD_3_6E300EDE7C9396AB_OFFSET UNITYSDK_OFFSET(0x187DD300)
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_ONBATTLEBEGINAFTERSECONDS_METHOD_3_7D04B3EAE453AC37_OFFSET UNITYSDK_OFFSET(0x187DD230)
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_ONBATTLEBEGINAFTERSECONDS__CTOR_OFFSET UNITYSDK_OFFSET(0x187DD2F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleAbilityConditionChecker_OnBattleBeginAfterSeconds_TypeDefinitionIndex = 14891;
