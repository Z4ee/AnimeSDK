...
#define RPG_GAMECORE_VE_RTBATTLELEVELBYCHARACTERID_METHOD_3_01BEB1066C64AAC3_OFFSET UNITYSDK_OFFSET(0x1D68EBE0)
#define RPG_GAMECORE_VE_RTBATTLELEVELBYCHARACTERID_METHOD_3_2A3386FBC3E51575_OFFSET UNITYSDK_OFFSET(0x1D68EA40)
#define RPG_GAMECORE_VE_RTBATTLELEVELBYCHARACTERID_METHOD_3_37C5EBCDF9AC62BA_OFFSET UNITYSDK_OFFSET(0x1D68EA80)
#define RPG_GAMECORE_VE_RTBATTLELEVELBYCHARACTERID_METHOD_3_D62D8C7E9AC1EC54_OFFSET UNITYSDK_OFFSET(0x1D68EC10)
#define RPG_GAMECORE_VE_RTBATTLELEVELBYCHARACTERID__CTOR_OFFSET UNITYSDK_OFFSET(0x1D68EA70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VE_RtBattleLevelByCharacterID_TypeDefinitionIndex = 23989;
