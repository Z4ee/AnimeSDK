...
#define RPG_GAMECORE_FIVEDIMPLAYSHOOTARROWANIMACTION_METHOD_3_99BA49F0C0DAA4F2_OFFSET UNITYSDK_OFFSET(0x1974C770)
#define RPG_GAMECORE_FIVEDIMPLAYSHOOTARROWANIMACTION_METHOD_3_B406C91775448CFF_OFFSET UNITYSDK_OFFSET(0x19730F90)
#define RPG_GAMECORE_FIVEDIMPLAYSHOOTARROWANIMACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19730F70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimPlayShootArrowAnimAction_TypeDefinitionIndex = 17817;
