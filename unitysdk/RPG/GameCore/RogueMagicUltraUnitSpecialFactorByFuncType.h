...
#define RPG_GAMECORE_ROGUEMAGICULTRAUNITSPECIALFACTORBYFUNCTYPE_METHOD_3_599F3883C41A7474_OFFSET UNITYSDK_OFFSET(0x1D93DFD0)
#define RPG_GAMECORE_ROGUEMAGICULTRAUNITSPECIALFACTORBYFUNCTYPE_METHOD_3_8A751F1CA62AED1C_OFFSET UNITYSDK_OFFSET(0x1D93E030)
#define RPG_GAMECORE_ROGUEMAGICULTRAUNITSPECIALFACTORBYFUNCTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D93E020)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueMagicUltraUnitSpecialFactorByFuncType_TypeDefinitionIndex = 17714;
