...
#define RPG_GAMECORE_BYHASSKILLTAG_METHOD_4_06F82458C8E55C56_OFFSET UNITYSDK_OFFSET(0x18749560)
#define RPG_GAMECORE_BYHASSKILLTAG_METHOD_4_8F9DDDBE1E7CE1DF_OFFSET UNITYSDK_OFFSET(0x18749680)
#define RPG_GAMECORE_BYHASSKILLTAG__CTOR_OFFSET UNITYSDK_OFFSET(0x18749600)
