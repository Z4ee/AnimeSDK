...
#define RPG_GAMECORE_GRIDFIGHTTRAITEQUIPRELATIONCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D07CCD0)
#define RPG_GAMECORE_GRIDFIGHTTRAITEQUIPRELATIONCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D07CDE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightTraitEquipRelationConfigRow_TypeDefinitionIndex = 12969;
