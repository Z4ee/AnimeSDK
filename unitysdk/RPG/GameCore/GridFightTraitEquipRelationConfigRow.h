...
#define RPG_GAMECORE_GRIDFIGHTTRAITEQUIPRELATIONCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1980FFE0)
#define RPG_GAMECORE_GRIDFIGHTTRAITEQUIPRELATIONCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x198100F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightTraitEquipRelationConfigRow_TypeDefinitionIndex = 12833;
