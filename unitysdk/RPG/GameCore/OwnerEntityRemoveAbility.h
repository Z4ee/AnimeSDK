...
#define RPG_GAMECORE_OWNERENTITYREMOVEABILITY_METHOD_3_0B6390D2B3CEB331_OFFSET UNITYSDK_OFFSET(0x17485000)
#define RPG_GAMECORE_OWNERENTITYREMOVEABILITY_METHOD_3_515E62B7E98E4758_OFFSET UNITYSDK_OFFSET(0x17485080)
#define RPG_GAMECORE_OWNERENTITYREMOVEABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x17485050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OwnerEntityRemoveAbility_TypeDefinitionIndex = 21702;
