...
#define RPG_GAMECORE_ADVCHASEBAILUSETDOOR_METHOD_3_1979E7E1251A15D3_OFFSET UNITYSDK_OFFSET(0x1941F010)
#define RPG_GAMECORE_ADVCHASEBAILUSETDOOR_METHOD_3_2F085F441B4B7A18_OFFSET UNITYSDK_OFFSET(0x1941F090)
#define RPG_GAMECORE_ADVCHASEBAILUSETDOOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1941F060)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvChaseBailuSetDoor_TypeDefinitionIndex = 21005;
