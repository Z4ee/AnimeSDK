...
#define RPG_GAMECORE_TARGETFETCHABILITYTARGETLEADER_METHOD_4_12F62383088EC673_OFFSET UNITYSDK_OFFSET(0x1B44E4A0)
#define RPG_GAMECORE_TARGETFETCHABILITYTARGETLEADER_METHOD_4_6FC9A49C193145D4_OFFSET UNITYSDK_OFFSET(0x1B44E2D0)
#define RPG_GAMECORE_TARGETFETCHABILITYTARGETLEADER_METHOD_4_77161C5D1728BF11_OFFSET UNITYSDK_OFFSET(0x1B44E3B0)
#define RPG_GAMECORE_TARGETFETCHABILITYTARGETLEADER_METHOD_4_F1BEEC778192E08E_OFFSET UNITYSDK_OFFSET(0x1B44E470)
#define RPG_GAMECORE_TARGETFETCHABILITYTARGETLEADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B44E3A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchAbilityTargetLeader_TypeDefinitionIndex = 23057;
