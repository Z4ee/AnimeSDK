...
#define RPG_GAMECORE_TARGETFETCHABILITYTARGETLEADER_METHOD_4_77161C5D1728BF11_OFFSET UNITYSDK_OFFSET(0x177BA210)
#define RPG_GAMECORE_TARGETFETCHABILITYTARGETLEADER_METHOD_4_D54AC7238F1AEB6E_OFFSET UNITYSDK_OFFSET(0x177BA070)
#define RPG_GAMECORE_TARGETFETCHABILITYTARGETLEADER__CTOR_OFFSET UNITYSDK_OFFSET(0x177BA1C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchAbilityTargetLeader_TypeDefinitionIndex = 22189;
