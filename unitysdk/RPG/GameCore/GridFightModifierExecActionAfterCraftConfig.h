...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERCRAFTCONFIG_METHOD_3_29F0DFC6C71FD65D_OFFSET UNITYSDK_OFFSET(0x1C5D0F80)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERCRAFTCONFIG_METHOD_3_C31CE3C7CD6EE699_OFFSET UNITYSDK_OFFSET(0x1C5D0F30)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERCRAFTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5D0F70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierExecActionAfterCraftConfig_TypeDefinitionIndex = 18620;
