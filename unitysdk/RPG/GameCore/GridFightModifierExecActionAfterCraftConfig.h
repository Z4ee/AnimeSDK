...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERCRAFTCONFIG_METHOD_3_0FBB572199EDA5E4_OFFSET UNITYSDK_OFFSET(0x1726A570)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERCRAFTCONFIG_METHOD_3_29F0DFC6C71FD65D_OFFSET UNITYSDK_OFFSET(0x172664C0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERCRAFTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17266470)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierExecActionAfterCraftConfig_TypeDefinitionIndex = 17785;
