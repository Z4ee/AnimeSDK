...
#define RPG_GAMECORE_MONSTERTEAMAPPEAR_METHOD_3_3089BA7EF910CDE9_OFFSET UNITYSDK_OFFSET(0x18B61870)
#define RPG_GAMECORE_MONSTERTEAMAPPEAR_METHOD_3_5CB0C45CEF095730_OFFSET UNITYSDK_OFFSET(0x18B618F0)
#define RPG_GAMECORE_MONSTERTEAMAPPEAR__CTOR_OFFSET UNITYSDK_OFFSET(0x18B618C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonsterTeamAppear_TypeDefinitionIndex = 22362;
