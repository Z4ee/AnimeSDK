...
#define RPG_GAMECORE_FIVEDIMCHENLINGEMOTIONAUDIOPOSTEVENTACTION_METHOD_3_02A52FFE024D9438_OFFSET UNITYSDK_OFFSET(0x1BA8C6A0)
#define RPG_GAMECORE_FIVEDIMCHENLINGEMOTIONAUDIOPOSTEVENTACTION_METHOD_3_3CA38A54C0E3D4EB_OFFSET UNITYSDK_OFFSET(0x1BA8C6E0)
#define RPG_GAMECORE_FIVEDIMCHENLINGEMOTIONAUDIOPOSTEVENTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA8C6D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimChenLingEmotionAudioPostEventAction_TypeDefinitionIndex = 17986;
