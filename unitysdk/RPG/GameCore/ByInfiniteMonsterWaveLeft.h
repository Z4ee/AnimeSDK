...
#define RPG_GAMECORE_BYINFINITEMONSTERWAVELEFT_METHOD_4_32C8BD2F7A4A9D61_OFFSET UNITYSDK_OFFSET(0x1CF2DA40)
#define RPG_GAMECORE_BYINFINITEMONSTERWAVELEFT_METHOD_4_58AF3567F4A899AE_OFFSET UNITYSDK_OFFSET(0x1CF2DA80)
#define RPG_GAMECORE_BYINFINITEMONSTERWAVELEFT_METHOD_4_7D8344CAE46B1B04_OFFSET UNITYSDK_OFFSET(0x1CF2D860)
#define RPG_GAMECORE_BYINFINITEMONSTERWAVELEFT_METHOD_4_C4EB45136157ADBD_OFFSET UNITYSDK_OFFSET(0x1CF2D8B0)
#define RPG_GAMECORE_BYINFINITEMONSTERWAVELEFT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF2D8A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByInfiniteMonsterWaveLeft_TypeDefinitionIndex = 22322;
