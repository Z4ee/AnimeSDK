...
#define RPG_GAMECORE_BYINFINITEMONSTERWAVELEFT_METHOD_4_04838D9FB0FF0B8F_OFFSET UNITYSDK_OFFSET(0x1874D590)
#define RPG_GAMECORE_BYINFINITEMONSTERWAVELEFT_METHOD_4_C4EB45136157ADBD_OFFSET UNITYSDK_OFFSET(0x1874D670)
#define RPG_GAMECORE_BYINFINITEMONSTERWAVELEFT__CTOR_OFFSET UNITYSDK_OFFSET(0x1874D610)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByInfiniteMonsterWaveLeft_TypeDefinitionIndex = 21457;
