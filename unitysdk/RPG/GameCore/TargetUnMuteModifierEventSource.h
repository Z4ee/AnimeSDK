...
#define RPG_GAMECORE_TARGETUNMUTEMODIFIEREVENTSOURCE_METHOD_3_B2E03DAF4532BD3A_OFFSET UNITYSDK_OFFSET(0x1D5BD3A0)
#define RPG_GAMECORE_TARGETUNMUTEMODIFIEREVENTSOURCE_METHOD_3_F470137BB7AFCCED_OFFSET UNITYSDK_OFFSET(0x1D5BD3E0)
#define RPG_GAMECORE_TARGETUNMUTEMODIFIEREVENTSOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5BD3D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetUnMuteModifierEventSource_TypeDefinitionIndex = 23208;
