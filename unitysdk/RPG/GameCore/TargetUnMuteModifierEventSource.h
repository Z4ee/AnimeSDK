...
#define RPG_GAMECORE_TARGETUNMUTEMODIFIEREVENTSOURCE_METHOD_3_16DE4CB1F3B25873_OFFSET UNITYSDK_OFFSET(0x177D4180)
#define RPG_GAMECORE_TARGETUNMUTEMODIFIEREVENTSOURCE_METHOD_3_9CD90B9F1B3E2308_OFFSET UNITYSDK_OFFSET(0x177D4100)
#define RPG_GAMECORE_TARGETUNMUTEMODIFIEREVENTSOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x177D4150)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetUnMuteModifierEventSource_TypeDefinitionIndex = 21705;
