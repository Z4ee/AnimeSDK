...
#define RPG_GAMECORE_HOYOGROUPSTREAMINGTEMPLATEITEM_METHOD_2_259C21D38A67E940_OFFSET UNITYSDK_OFFSET(0x172B2130)
#define RPG_GAMECORE_HOYOGROUPSTREAMINGTEMPLATEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x172B22A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HoYoGroupStreamingTemplateItem_TypeDefinitionIndex = 15935;
