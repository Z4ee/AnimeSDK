...
#define RPG_GAMECORE_SETDYNAMICVALUEBYDAMAGEDATAPROPERTY_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1C2E1230)
#define RPG_GAMECORE_SETDYNAMICVALUEBYDAMAGEDATAPROPERTY_METHOD_4_042ADCB9E55963D9_OFFSET UNITYSDK_OFFSET(0x1C2E1040)
#define RPG_GAMECORE_SETDYNAMICVALUEBYDAMAGEDATAPROPERTY_METHOD_4_F1EB47444F17FB90_OFFSET UNITYSDK_OFFSET(0x1C2E1000)
#define RPG_GAMECORE_SETDYNAMICVALUEBYDAMAGEDATAPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2E1030)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByDamageDataProperty_TypeDefinitionIndex = 22263;
