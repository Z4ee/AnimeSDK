...
#define RPG_GAMECORE_SETDYNAMICVALUEBYDAMAGEDATAPROPERTY_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x176C0F80)
#define RPG_GAMECORE_SETDYNAMICVALUEBYDAMAGEDATAPROPERTY_METHOD_4_042ADCB9E55963D9_OFFSET UNITYSDK_OFFSET(0x176B9FE0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYDAMAGEDATAPROPERTY_METHOD_4_E0A03F7442BB7C11_OFFSET UNITYSDK_OFFSET(0x176C0F00)
#define RPG_GAMECORE_SETDYNAMICVALUEBYDAMAGEDATAPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x176B9F90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByDamageDataProperty_TypeDefinitionIndex = 21310;
