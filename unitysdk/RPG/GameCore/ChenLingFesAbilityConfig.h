...
#define RPG_GAMECORE_CHENLINGFESABILITYCONFIG_METHOD_2_DA01811C41AD3276_OFFSET UNITYSDK_OFFSET(0x19628600)
#define RPG_GAMECORE_CHENLINGFESABILITYCONFIG_METHOD_2_F3A2E299997BDB96_OFFSET UNITYSDK_OFFSET(0x19628880)
#define RPG_GAMECORE_CHENLINGFESABILITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19628870)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingFesAbilityConfig_TypeDefinitionIndex = 17539;
