...
#define RPG_GAMECORE_CHENLINGFESABILITYCONFIG_METHOD_2_DA01811C41AD3276_OFFSET UNITYSDK_OFFSET(0x1C382A50)
#define RPG_GAMECORE_CHENLINGFESABILITYCONFIG_METHOD_2_F3A2E299997BDB96_OFFSET UNITYSDK_OFFSET(0x1C382CD0)
#define RPG_GAMECORE_CHENLINGFESABILITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C382CC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingFesAbilityConfig_TypeDefinitionIndex = 17712;
