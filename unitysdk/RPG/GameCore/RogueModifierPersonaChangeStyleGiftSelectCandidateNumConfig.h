...
#define RPG_GAMECORE_ROGUEMODIFIERPERSONACHANGESTYLEGIFTSELECTCANDIDATENUMCONFIG_METHOD_3_116053C0FE76E4AF_OFFSET UNITYSDK_OFFSET(0x18D439E0)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONACHANGESTYLEGIFTSELECTCANDIDATENUMCONFIG_METHOD_3_DAAA8E3302456006_OFFSET UNITYSDK_OFFSET(0x18D43AB0)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONACHANGESTYLEGIFTSELECTCANDIDATENUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D43A60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierPersonaChangeStyleGiftSelectCandidateNumConfig_TypeDefinitionIndex = 16930;
