...
#define RPG_GAMECORE_ROGUEMODIFIERPERSONACHANGESTYLEGIFTSELECTCANDIDATENUMCONFIG_METHOD_3_116053C0FE76E4AF_OFFSET UNITYSDK_OFFSET(0x17636E90)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONACHANGESTYLEGIFTSELECTCANDIDATENUMCONFIG_METHOD_3_DAAA8E3302456006_OFFSET UNITYSDK_OFFSET(0x17636F60)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONACHANGESTYLEGIFTSELECTCANDIDATENUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17636F10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierPersonaChangeStyleGiftSelectCandidateNumConfig_TypeDefinitionIndex = 16376;
