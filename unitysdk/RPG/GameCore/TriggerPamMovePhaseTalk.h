...
#define RPG_GAMECORE_TRIGGERPAMMOVEPHASETALK_METHOD_3_42B0BAF6DFDA3F0F_OFFSET UNITYSDK_OFFSET(0x19E193F0)
#define RPG_GAMECORE_TRIGGERPAMMOVEPHASETALK_METHOD_3_B6113C930AF16D9B_OFFSET UNITYSDK_OFFSET(0x19E192E0)
#define RPG_GAMECORE_TRIGGERPAMMOVEPHASETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x19E193C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerPamMovePhaseTalk_TypeDefinitionIndex = 18902;
