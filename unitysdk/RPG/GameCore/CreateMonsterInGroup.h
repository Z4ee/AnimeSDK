...
#define RPG_GAMECORE_CREATEMONSTERINGROUP_METHOD_3_12CAD4065D621362_OFFSET UNITYSDK_OFFSET(0x1D008380)
#define RPG_GAMECORE_CREATEMONSTERINGROUP_METHOD_3_E50691D86145C3AF_OFFSET UNITYSDK_OFFSET(0x1D0083C0)
#define RPG_GAMECORE_CREATEMONSTERINGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0083B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CreateMonsterInGroup_TypeDefinitionIndex = 20125;
