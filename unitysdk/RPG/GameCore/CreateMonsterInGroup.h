...
#define RPG_GAMECORE_CREATEMONSTERINGROUP_METHOD_3_9E87037E165AF638_OFFSET UNITYSDK_OFFSET(0x188436B0)
#define RPG_GAMECORE_CREATEMONSTERINGROUP_METHOD_3_E50691D86145C3AF_OFFSET UNITYSDK_OFFSET(0x18843720)
#define RPG_GAMECORE_CREATEMONSTERINGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x188436F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CreateMonsterInGroup_TypeDefinitionIndex = 19310;
