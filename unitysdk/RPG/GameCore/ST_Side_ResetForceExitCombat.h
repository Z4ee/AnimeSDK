...
#define RPG_GAMECORE_ST_SIDE_RESETFORCEEXITCOMBAT_METHOD_4_39A7256930C0979C_OFFSET UNITYSDK_OFFSET(0x1768F550)
#define RPG_GAMECORE_ST_SIDE_RESETFORCEEXITCOMBAT_METHOD_4_90B7732713983D2B_OFFSET UNITYSDK_OFFSET(0x17699C90)
#define RPG_GAMECORE_ST_SIDE_RESETFORCEEXITCOMBAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1768F500)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_ResetForceExitCombat_TypeDefinitionIndex = 18413;
