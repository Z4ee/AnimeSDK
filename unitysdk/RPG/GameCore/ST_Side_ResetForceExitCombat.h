...
#define RPG_GAMECORE_ST_SIDE_RESETFORCEEXITCOMBAT_METHOD_4_39A7256930C0979C_OFFSET UNITYSDK_OFFSET(0x1C2C5110)
#define RPG_GAMECORE_ST_SIDE_RESETFORCEEXITCOMBAT_METHOD_4_5B19805068C66599_OFFSET UNITYSDK_OFFSET(0x1C2C5040)
#define RPG_GAMECORE_ST_SIDE_RESETFORCEEXITCOMBAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2C5100)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_ResetForceExitCombat_TypeDefinitionIndex = 19348;
