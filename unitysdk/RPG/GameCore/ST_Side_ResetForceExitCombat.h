...
#define RPG_GAMECORE_ST_SIDE_RESETFORCEEXITCOMBAT_METHOD_4_39A7256930C0979C_OFFSET UNITYSDK_OFFSET(0x19C0D570)
#define RPG_GAMECORE_ST_SIDE_RESETFORCEEXITCOMBAT_METHOD_4_90B7732713983D2B_OFFSET UNITYSDK_OFFSET(0x19C1B0D0)
#define RPG_GAMECORE_ST_SIDE_RESETFORCEEXITCOMBAT__CTOR_OFFSET UNITYSDK_OFFSET(0x19C0D520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_ResetForceExitCombat_TypeDefinitionIndex = 18997;
