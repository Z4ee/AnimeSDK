...
#define RPG_GAMECORE_BYTARGETVISIBLE_METHOD_4_483CDA3598060E03_OFFSET UNITYSDK_OFFSET(0x1B2C30E0)
#define RPG_GAMECORE_BYTARGETVISIBLE_METHOD_4_A478E013EA9D79F0_OFFSET UNITYSDK_OFFSET(0x1B2C32D0)
#define RPG_GAMECORE_BYTARGETVISIBLE_METHOD_4_EA192B31175BE0C6_OFFSET UNITYSDK_OFFSET(0x1B2C32A0)
#define RPG_GAMECORE_BYTARGETVISIBLE_METHOD_4_FA57737ACF91A7CA_OFFSET UNITYSDK_OFFSET(0x1B2C3120)
#define RPG_GAMECORE_BYTARGETVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2C3110)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByTargetVisible_TypeDefinitionIndex = 19821;
