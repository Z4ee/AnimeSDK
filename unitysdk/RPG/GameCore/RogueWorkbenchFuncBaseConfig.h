...
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCBASECONFIG_METHOD_2_418BB5EC1EAAB603_OFFSET UNITYSDK_OFFSET(0x19BD3EF0)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCBASECONFIG_METHOD_2_876E697A9F997D3A_OFFSET UNITYSDK_OFFSET(0x19BD4270)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCBASECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19BD4260)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueWorkbenchFuncBaseConfig_TypeDefinitionIndex = 17126;
