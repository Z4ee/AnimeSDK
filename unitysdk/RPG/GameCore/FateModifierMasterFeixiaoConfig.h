...
#define RPG_GAMECORE_FATEMODIFIERMASTERFEIXIAOCONFIG_METHOD_3_63A3B25C82BB43E9_OFFSET UNITYSDK_OFFSET(0x1C075040)
#define RPG_GAMECORE_FATEMODIFIERMASTERFEIXIAOCONFIG_METHOD_3_BDEC2759178EF865_OFFSET UNITYSDK_OFFSET(0x1C074FF0)
#define RPG_GAMECORE_FATEMODIFIERMASTERFEIXIAOCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C075030)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateModifierMasterFeixiaoConfig_TypeDefinitionIndex = 18536;
