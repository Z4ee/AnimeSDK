...
#define RPG_GAMECORE_FATEMODIFIERMASTERFEIXIAOCONFIG_METHOD_3_43ACD550EBB78A90_OFFSET UNITYSDK_OFFSET(0x171C8A80)
#define RPG_GAMECORE_FATEMODIFIERMASTERFEIXIAOCONFIG_METHOD_3_63A3B25C82BB43E9_OFFSET UNITYSDK_OFFSET(0x171C78C0)
#define RPG_GAMECORE_FATEMODIFIERMASTERFEIXIAOCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171C7870)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateModifierMasterFeixiaoConfig_TypeDefinitionIndex = 17716;
