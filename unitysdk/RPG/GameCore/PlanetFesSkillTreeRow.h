...
#define RPG_GAMECORE_PLANETFESSKILLTREEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D7A2150)
#define RPG_GAMECORE_PLANETFESSKILLTREEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7A2520)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Boolean IsImportant; // 0x48
		::System::UInt32 MaxLevel; // 0x4C
		::System::UInt32 Phase; // 0x50
