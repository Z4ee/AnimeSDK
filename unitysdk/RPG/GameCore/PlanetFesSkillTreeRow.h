...
#define RPG_GAMECORE_PLANETFESSKILLTREEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18C0B230)
#define RPG_GAMECORE_PLANETFESSKILLTREEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18C0B620)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlanetFesSkillTreeRow_TypeDefinitionIndex = 11538;

	class PlanetFesSkillTreeRow : public ::System::Object
	{
	public:
		::System::String* Icon; // 0x10
		::Il2CppArray<::System::UInt32>* LevelCostList; // 0x18
		::Il2CppArray<::System::UInt32>* NextSkillIDList; // 0x20
		::Il2CppArray<::System::UInt32>* LevelSkillList; // 0x28
		::Il2CppArray<::System::UInt32>* UnlockIDList; // 0x30
		::System::Boolean IsImportant; // 0x38
