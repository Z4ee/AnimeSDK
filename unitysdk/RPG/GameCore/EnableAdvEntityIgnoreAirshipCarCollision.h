...
#define RPG_GAMECORE_ENABLEADVENTITYIGNOREAIRSHIPCARCOLLISION_METHOD_3_EC0D9354F38E0731_OFFSET UNITYSDK_OFFSET(0x1D7BC170)
#define RPG_GAMECORE_ENABLEADVENTITYIGNOREAIRSHIPCARCOLLISION_METHOD_3_FCB50F090A9D605D_OFFSET UNITYSDK_OFFSET(0x1D7BC0D0)
#define RPG_GAMECORE_ENABLEADVENTITYIGNOREAIRSHIPCARCOLLISION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7BC130)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnableAdvEntityIgnoreAirshipCarCollision_TypeDefinitionIndex = 20713;
