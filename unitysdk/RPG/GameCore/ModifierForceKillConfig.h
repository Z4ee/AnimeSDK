...
#define RPG_GAMECORE_MODIFIERFORCEKILLCONFIG_METHOD_2_FCDDE3E6BACF8384_OFFSET UNITYSDK_OFFSET(0x1D2AC2C0)
#define RPG_GAMECORE_MODIFIERFORCEKILLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2AC520)
