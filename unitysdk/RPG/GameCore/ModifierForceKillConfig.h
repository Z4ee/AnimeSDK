...
#define RPG_GAMECORE_MODIFIERFORCEKILLCONFIG_METHOD_2_DF8DD7601765989F_OFFSET UNITYSDK_OFFSET(0x1AF719C0)
#define RPG_GAMECORE_MODIFIERFORCEKILLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF71BE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifierForceKillConfig_TypeDefinitionIndex = 17515;
