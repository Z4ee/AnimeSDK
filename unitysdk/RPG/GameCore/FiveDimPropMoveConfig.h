...
#define RPG_GAMECORE_FIVEDIMPROPMOVECONFIG_METHOD_2_44799DD6C3ABA574_OFFSET UNITYSDK_OFFSET(0x1974F200)
#define RPG_GAMECORE_FIVEDIMPROPMOVECONFIG_METHOD_2_87F909D4BFB039B5_OFFSET UNITYSDK_OFFSET(0x1974FEA0)
#define RPG_GAMECORE_FIVEDIMPROPMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19750130)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimPropMoveConfig_TypeDefinitionIndex = 15861;
