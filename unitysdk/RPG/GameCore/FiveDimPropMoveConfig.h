...
#define RPG_GAMECORE_FIVEDIMPROPMOVECONFIG_METHOD_2_44799DD6C3ABA574_OFFSET UNITYSDK_OFFSET(0x1BEAB570)
#define RPG_GAMECORE_FIVEDIMPROPMOVECONFIG_METHOD_2_87F909D4BFB039B5_OFFSET UNITYSDK_OFFSET(0x1BEAC290)
#define RPG_GAMECORE_FIVEDIMPROPMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEA2200)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimPropMoveConfig_TypeDefinitionIndex = 16035;
