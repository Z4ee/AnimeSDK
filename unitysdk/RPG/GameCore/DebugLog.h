...
#define RPG_GAMECORE_DEBUGLOG_METHOD_3_5C8E7B009FFADC35_OFFSET UNITYSDK_OFFSET(0x1714D420)
#define RPG_GAMECORE_DEBUGLOG_METHOD_3_6E0FE4131587F369_OFFSET UNITYSDK_OFFSET(0x1714D4A0)
#define RPG_GAMECORE_DEBUGLOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1714D470)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DebugLog_TypeDefinitionIndex = 22036;
