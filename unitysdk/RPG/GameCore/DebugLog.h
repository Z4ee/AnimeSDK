...
#define RPG_GAMECORE_DEBUGLOG_METHOD_3_5C8E7B009FFADC35_OFFSET UNITYSDK_OFFSET(0x188546A0)
#define RPG_GAMECORE_DEBUGLOG_METHOD_3_6E0FE4131587F369_OFFSET UNITYSDK_OFFSET(0x18854720)
#define RPG_GAMECORE_DEBUGLOG__CTOR_OFFSET UNITYSDK_OFFSET(0x188546F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DebugLog_TypeDefinitionIndex = 22752;
