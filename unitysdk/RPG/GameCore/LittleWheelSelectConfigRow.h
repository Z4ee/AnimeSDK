...
#define RPG_GAMECORE_LITTLEWHEELSELECTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1DD70C10)
#define RPG_GAMECORE_LITTLEWHEELSELECTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD71460)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleWheelSelectConfigRow_TypeDefinitionIndex = 13217;

	class LittleWheelSelectConfigRow : public ::System::Object
	{
	public:
		::Il2CppArray<::System::UInt32>* Right4; // 0x10
		::Il2CppArray<::System::UInt32>* Right1; // 0x18
		::Il2CppArray<::System::UInt32>* Left4; // 0x20
		::Il2CppArray<::System::UInt32>* Left1; // 0x28
		::Il2CppArray<::System::UInt32>* Right3; // 0x30
		::Il2CppArray<::System::UInt32>* Left2; // 0x38
		::Il2CppArray<::System::UInt32>* Left3; // 0x40
		::Il2CppArray<::System::UInt32>* Right2; // 0x48
