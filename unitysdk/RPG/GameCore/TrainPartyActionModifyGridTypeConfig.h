...
#define RPG_GAMECORE_TRAINPARTYACTIONMODIFYGRIDTYPECONFIG_METHOD_5_83A7ED8E84CAE601_OFFSET UNITYSDK_OFFSET(0x1D5DA280)
#define RPG_GAMECORE_TRAINPARTYACTIONMODIFYGRIDTYPECONFIG_METHOD_5_CE8064D885BB6365_OFFSET UNITYSDK_OFFSET(0x1D5DA190)
#define RPG_GAMECORE_TRAINPARTYACTIONMODIFYGRIDTYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5DA180)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyActionModifyGridTypeConfig_TypeDefinitionIndex = 17865;
