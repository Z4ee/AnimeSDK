...
#define RPG_GAMECORE_TRAINPARTYACTIONMODIFYGRIDTYPECONFIG_METHOD_5_471D657B80F04F4C_OFFSET UNITYSDK_OFFSET(0x190A66D0)
#define RPG_GAMECORE_TRAINPARTYACTIONMODIFYGRIDTYPECONFIG_METHOD_5_CE8064D885BB6365_OFFSET UNITYSDK_OFFSET(0x190A6460)
#define RPG_GAMECORE_TRAINPARTYACTIONMODIFYGRIDTYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x190A6410)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyActionModifyGridTypeConfig_TypeDefinitionIndex = 17178;
