...
#define RPG_GAMECORE_CHIMERADUELORDEREDENTITIESSELECTORCONFIG_METHOD_3_49E113AD9039C9AF_OFFSET UNITYSDK_OFFSET(0x170A1DF0)
#define RPG_GAMECORE_CHIMERADUELORDEREDENTITIESSELECTORCONFIG_METHOD_3_698CCF79791F7A27_OFFSET UNITYSDK_OFFSET(0x170A1E50)
#define RPG_GAMECORE_CHIMERADUELORDEREDENTITIESSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x170A1E40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelOrderedEntitiesSelectorConfig_TypeDefinitionIndex = 14621;
