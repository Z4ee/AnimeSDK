...
#define RPG_GAMECORE_SPACEZOOQUESTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D5429A0)
#define RPG_GAMECORE_SPACEZOOQUESTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D543010)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SpaceZooQuestRow_TypeDefinitionIndex = 12295;
