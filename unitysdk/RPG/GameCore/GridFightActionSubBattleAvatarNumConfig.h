...
#define RPG_GAMECORE_GRIDFIGHTACTIONSUBBATTLEAVATARNUMCONFIG_METHOD_6_316C22EC5E0084E9_OFFSET UNITYSDK_OFFSET(0x1C5C1C70)
#define RPG_GAMECORE_GRIDFIGHTACTIONSUBBATTLEAVATARNUMCONFIG_METHOD_6_8BB497E8F2D43965_OFFSET UNITYSDK_OFFSET(0x1C5C20F0)
#define RPG_GAMECORE_GRIDFIGHTACTIONSUBBATTLEAVATARNUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5C1C60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightActionSubBattleAvatarNumConfig_TypeDefinitionIndex = 18550;
