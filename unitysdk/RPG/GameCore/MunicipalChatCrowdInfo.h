...
#define RPG_GAMECORE_MUNICIPALCHATCROWDINFO_METHOD_2_6632583CE1B6EB6E_OFFSET UNITYSDK_OFFSET(0x199B8130)
#define RPG_GAMECORE_MUNICIPALCHATCROWDINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x199B8240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MunicipalChatCrowdInfo_TypeDefinitionIndex = 16074;
