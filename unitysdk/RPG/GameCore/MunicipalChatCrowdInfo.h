...
#define RPG_GAMECORE_MUNICIPALCHATCROWDINFO_METHOD_2_6632583CE1B6EB6E_OFFSET UNITYSDK_OFFSET(0x1D2DED00)
#define RPG_GAMECORE_MUNICIPALCHATCROWDINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2DEE10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MunicipalChatCrowdInfo_TypeDefinitionIndex = 16742;
