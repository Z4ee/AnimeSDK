...
#define RPG_GAMECORE_UNLOCKMAINSTREAMINGSOURCE_METHOD_3_40D043E41A473AD4_OFFSET UNITYSDK_OFFSET(0x1D623EA0)
#define RPG_GAMECORE_UNLOCKMAINSTREAMINGSOURCE_METHOD_3_481CBBA5183EB411_OFFSET UNITYSDK_OFFSET(0x1D623F70)
#define RPG_GAMECORE_UNLOCKMAINSTREAMINGSOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D623F60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UnlockMainStreamingSource_TypeDefinitionIndex = 20265;
