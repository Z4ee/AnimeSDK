...
#define RPG_GAMECORE_UNLOCKMAINSTREAMINGSOURCE_METHOD_3_481CBBA5183EB411_OFFSET UNITYSDK_OFFSET(0x178E7350)
#define RPG_GAMECORE_UNLOCKMAINSTREAMINGSOURCE_METHOD_3_BEB953562151DCDD_OFFSET UNITYSDK_OFFSET(0x178E7240)
#define RPG_GAMECORE_UNLOCKMAINSTREAMINGSOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x178E7320)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UnlockMainStreamingSource_TypeDefinitionIndex = 18801;
