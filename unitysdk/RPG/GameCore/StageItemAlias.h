...
#define RPG_GAMECORE_STAGEITEMALIAS_METHOD_2_5166834B372C63DE_OFFSET UNITYSDK_OFFSET(0x1B0B1080)
#define RPG_GAMECORE_STAGEITEMALIAS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0B1190)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StageItemAlias_TypeDefinitionIndex = 21442;
