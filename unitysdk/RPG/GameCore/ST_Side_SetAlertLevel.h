...
#define RPG_GAMECORE_ST_SIDE_SETALERTLEVEL_METHOD_4_035F752176DE1F77_OFFSET UNITYSDK_OFFSET(0x1768F8C0)
#define RPG_GAMECORE_ST_SIDE_SETALERTLEVEL_METHOD_4_BB7904A1CBEC86DD_OFFSET UNITYSDK_OFFSET(0x17699E30)
#define RPG_GAMECORE_ST_SIDE_SETALERTLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1768F870)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_SetAlertLevel_TypeDefinitionIndex = 18389;
