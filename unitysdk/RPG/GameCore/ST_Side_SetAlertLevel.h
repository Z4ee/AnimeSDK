...
#define RPG_GAMECORE_ST_SIDE_SETALERTLEVEL_METHOD_4_035F752176DE1F77_OFFSET UNITYSDK_OFFSET(0x19C0D8E0)
#define RPG_GAMECORE_ST_SIDE_SETALERTLEVEL_METHOD_4_BB7904A1CBEC86DD_OFFSET UNITYSDK_OFFSET(0x19C1B270)
#define RPG_GAMECORE_ST_SIDE_SETALERTLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x19C0D890)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_SetAlertLevel_TypeDefinitionIndex = 18981;
