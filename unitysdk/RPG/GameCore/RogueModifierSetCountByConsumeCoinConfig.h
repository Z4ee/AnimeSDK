...
#define RPG_GAMECORE_ROGUEMODIFIERSETCOUNTBYCONSUMECOINCONFIG_METHOD_3_921DDD899213E36D_OFFSET UNITYSDK_OFFSET(0x18D46340)
#define RPG_GAMECORE_ROGUEMODIFIERSETCOUNTBYCONSUMECOINCONFIG_METHOD_3_F91B7F8A5604C974_OFFSET UNITYSDK_OFFSET(0x18D46270)
#define RPG_GAMECORE_ROGUEMODIFIERSETCOUNTBYCONSUMECOINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D462F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierSetCountByConsumeCoinConfig_TypeDefinitionIndex = 16825;
