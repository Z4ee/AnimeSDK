...
#define RPG_GAMECORE_LEVELADVENTUREREMOVEEVENT_GETBUFFID_OFFSET UNITYSDK_OFFSET(0x1BDE8720)
#define RPG_GAMECORE_LEVELADVENTUREREMOVEEVENT_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1BDE86D0)
#define RPG_GAMECORE_LEVELADVENTUREREMOVEEVENT_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x1BDE8680)
#define RPG_GAMECORE_LEVELADVENTUREREMOVEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDE8670)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelAdventureRemoveEvent_TypeDefinitionIndex = 54078;
