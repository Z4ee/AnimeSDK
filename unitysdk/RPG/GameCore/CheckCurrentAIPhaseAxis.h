...
#define RPG_GAMECORE_CHECKCURRENTAIPHASEAXIS_METHOD_3_528DD7560B2ECB77_OFFSET UNITYSDK_OFFSET(0x187DA300)
#define RPG_GAMECORE_CHECKCURRENTAIPHASEAXIS_METHOD_3_8FD17B09EF06DB82_OFFSET UNITYSDK_OFFSET(0x187DA2C0)
#define RPG_GAMECORE_CHECKCURRENTAIPHASEAXIS__CTOR_OFFSET UNITYSDK_OFFSET(0x187DA2F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CheckCurrentAIPhaseAxis_TypeDefinitionIndex = 14669;
