...
#define RPG_GAMECORE_COMPLEXSKILLAISOURCECHARACTERID_METHOD_3_EEF1F6175938819B_OFFSET UNITYSDK_OFFSET(0x17128BC0)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCECHARACTERID_METHOD_3_F71DD5BD99087B23_OFFSET UNITYSDK_OFFSET(0x171260E0)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCECHARACTERID__CTOR_OFFSET UNITYSDK_OFFSET(0x171260C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAISourceCharacterID_TypeDefinitionIndex = 14246;
