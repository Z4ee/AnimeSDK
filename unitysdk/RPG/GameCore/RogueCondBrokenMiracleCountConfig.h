...
#define RPG_GAMECORE_ROGUECONDBROKENMIRACLECOUNTCONFIG_METHOD_6_86CE11F2F72C9473_OFFSET UNITYSDK_OFFSET(0x19B1B3C0)
#define RPG_GAMECORE_ROGUECONDBROKENMIRACLECOUNTCONFIG_METHOD_6_EA8E41A8C9A3C87D_OFFSET UNITYSDK_OFFSET(0x19B1B110)
#define RPG_GAMECORE_ROGUECONDBROKENMIRACLECOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B1B290)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueCondBrokenMiracleCountConfig_TypeDefinitionIndex = 18753;
