...
#define RPG_GAMECORE_IDLELIVESTARROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D215A70)
#define RPG_GAMECORE_IDLELIVESTARROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D215C70)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::System::UInt32 LiveRoomExpNeeded; // 0x10
