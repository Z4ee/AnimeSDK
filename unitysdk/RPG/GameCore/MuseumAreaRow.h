...
#define RPG_GAMECORE_MUSEUMAREAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CE7A8A0)
#define RPG_GAMECORE_MUSEUMAREAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE7BF80)
