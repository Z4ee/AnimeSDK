...
#define RPG_GAMECORE_MUSEUMAREAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B1D6540)
#define RPG_GAMECORE_MUSEUMAREAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1D7C20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MuseumAreaRow_TypeDefinitionIndex = 13694;
	...
	public:
		...
		::System::UInt32 RequireStatsB; // 0x18
		::System::UInt32 PhaseLimit; // 0x1C
		::System::UInt32 FundCost; // 0x20
		::System::UInt32 AreaID; // 0x24
		::System::UInt32 RenewPoint; // 0x28
		::System::UInt32 RequireStatsA; // 0x2C
