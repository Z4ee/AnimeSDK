...
#define RPG_GAMECORE_ROGUEPERSONASTYLECONFIG_METHOD_2_81382D5E25DBB921_OFFSET UNITYSDK_OFFSET(0x1E547040)
#define RPG_GAMECORE_ROGUEPERSONASTYLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1E547080)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RoguePersonaStyleConfig_TypeDefinitionIndex = 17792;
