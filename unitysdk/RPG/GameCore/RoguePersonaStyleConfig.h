...
#define RPG_GAMECORE_ROGUEPERSONASTYLECONFIG_METHOD_2_81382D5E25DBB921_OFFSET UNITYSDK_OFFSET(0x176580D0)
#define RPG_GAMECORE_ROGUEPERSONASTYLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17658110)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RoguePersonaStyleConfig_TypeDefinitionIndex = 16546;
