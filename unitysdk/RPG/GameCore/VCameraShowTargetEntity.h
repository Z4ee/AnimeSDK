...
#define RPG_GAMECORE_VCAMERASHOWTARGETENTITY_METHOD_2_BFA33D6F15CEB745_OFFSET UNITYSDK_OFFSET(0x19E3D120)
#define RPG_GAMECORE_VCAMERASHOWTARGETENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x19E3F170)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VCameraShowTargetEntity_TypeDefinitionIndex = 15601;
