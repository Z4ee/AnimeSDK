...
#define RPG_GAMECORE_CHIMERADUELENTITYATTRIBUTECOMPAREPREDICATE_METHOD_3_0B446E0EADED9385_OFFSET UNITYSDK_OFFSET(0x1709A640)
#define RPG_GAMECORE_CHIMERADUELENTITYATTRIBUTECOMPAREPREDICATE_METHOD_3_D246B0EE5F629E13_OFFSET UNITYSDK_OFFSET(0x1709A6A0)
#define RPG_GAMECORE_CHIMERADUELENTITYATTRIBUTECOMPAREPREDICATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1709A690)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelEntityAttributeComparePredicate_TypeDefinitionIndex = 14619;
