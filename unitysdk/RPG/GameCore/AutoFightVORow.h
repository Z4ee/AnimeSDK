...
#define RPG_GAMECORE_AUTOFIGHTVOROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CE339F0)
#define RPG_GAMECORE_AUTOFIGHTVOROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE344F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AutoFightVORow_TypeDefinitionIndex = 10791;

	class AutoFightVORow : public ::System::Object
	{
	public:
		::System::UInt32 ReceiveBuff; // 0x10
		::System::UInt32 Mode; // 0x14
		::System::UInt32 Revived; // 0x18
		::System::UInt32 LightHit; // 0x1C
		::System::UInt32 ActionBegin; // 0x20
		::System::UInt32 ReceiveHealing; // 0x24
		::System::UInt32 StandBy; // 0x28
		::System::UInt32 UltraReady; // 0x2C
		::System::UInt32 ActionBeginHighThreat; // 0x30
