...
#define RPG_GAMECORE_AUTOFIGHTVOROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16F92940)
#define RPG_GAMECORE_AUTOFIGHTVOROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16F93090)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AutoFightVORow_TypeDefinitionIndex = 13853;

	class AutoFightVORow : public ::System::Object
	{
	public:
		::System::UInt32 Mode; // 0x10
