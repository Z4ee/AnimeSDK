...
#define RPG_GAMECORE_LEVELENTITYSTARTELATIONTIME_CLEAR_OFFSET UNITYSDK_OFFSET(0xA989780)
#define RPG_GAMECORE_LEVELENTITYSTARTELATIONTIME_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xA989820)
#define RPG_GAMECORE_LEVELENTITYSTARTELATIONTIME_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xA9897D0)
#define RPG_GAMECORE_LEVELENTITYSTARTELATIONTIME_INIT_OFFSET UNITYSDK_OFFSET(0xA989720)
#define RPG_GAMECORE_LEVELENTITYSTARTELATIONTIME__CTOR_OFFSET UNITYSDK_OFFSET(0xA989870)
#define RPG_GAMECORE_LEVELENTITYSTARTELATIONTIME___IFIXBASEPROXY_CLEAR_OFFSET UNITYSDK_OFFSET(0xA989880)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelEntityStartElationTime_TypeDefinitionIndex = 45653;
