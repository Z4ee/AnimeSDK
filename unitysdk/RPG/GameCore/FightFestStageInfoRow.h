...
#define RPG_GAMECORE_FIGHTFESTSTAGEINFOROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1BA7F260)
#define RPG_GAMECORE_FIGHTFESTSTAGEINFOROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA7FBF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FightFestStageInfoRow_TypeDefinitionIndex = 12786;

	class FightFestStageInfoRow : public ::System::Object
	{
	public:
		::Il2CppArray<::System::UInt32>* PreviewMonsterList; // 0x10
		...
		::RPG::Client::TextID ChallengeName; // 0x38
		::RPG::Client::TextID EnvironmentBuffDes; // 0x48
		::RPG::Client::TextID EnvironmentBuffName; // 0x58
		::RPG::Client::TextID HighLightDesc; // 0x68
		::System::UInt32 EnvironmentBuffID; // 0x78
		::System::UInt32 UIEnterBattleAreaID; // 0x7C
