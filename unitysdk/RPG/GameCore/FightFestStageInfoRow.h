...
#define RPG_GAMECORE_FIGHTFESTSTAGEINFOROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1E0D9010)
#define RPG_GAMECORE_FIGHTFESTSTAGEINFOROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0D99A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FightFestStageInfoRow_TypeDefinitionIndex = 13177;
	...
	public:
		...
		::Il2CppArray<::System::UInt32>* RecommadCoachID; // 0x20
		::Il2CppArray<::System::UInt32>* PreviewMonsterList; // 0x28
		::System::UInt32 EnvironmentBuffID; // 0x30
		::System::UInt32 UIEnterBattleAreaID; // 0x34
		::RPG::Client::TextID EnvironmentBuffName; // 0x38
		::RPG::Client::TextID HighLightDesc; // 0x48
