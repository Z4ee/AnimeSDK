...
#define RPG_GAMECORE_FIREPROJECTILE_METHOD_4_1D295D1C659491A2_OFFSET UNITYSDK_OFFSET(0x188E7F80)
#define RPG_GAMECORE_FIREPROJECTILE_METHOD_4_BF9B7529062BC21A_OFFSET UNITYSDK_OFFSET(0x188E8020)
#define RPG_GAMECORE_FIREPROJECTILE__CTOR_OFFSET UNITYSDK_OFFSET(0x188E7FE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FireProjectile_TypeDefinitionIndex = 21465;
