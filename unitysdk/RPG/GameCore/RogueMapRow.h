...
#define RPG_GAMECORE_ROGUEMAPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19B4ABA0)
#define RPG_GAMECORE_ROGUEMAPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19B4B8C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueMapRow_TypeDefinitionIndex = 13974;

	class RogueMapRow : public ::System::Object
	{
	public:
		::Il2CppArray<::System::UInt32>* NextSiteIDList; // 0x10
		::System::UInt32 SiteID; // 0x18
		::System::Boolean IsStart; // 0x1C
		::System::UInt32 RogueMapID; // 0x20
