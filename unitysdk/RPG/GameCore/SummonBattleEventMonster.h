...
#define RPG_GAMECORE_SUMMONBATTLEEVENTMONSTER_METHOD_3_9589811D6C577C4E_OFFSET UNITYSDK_OFFSET(0x19CD1F00)
#define RPG_GAMECORE_SUMMONBATTLEEVENTMONSTER_METHOD_3_BB42FE607BF62C67_OFFSET UNITYSDK_OFFSET(0x19CD1DE0)
#define RPG_GAMECORE_SUMMONBATTLEEVENTMONSTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19CD1E80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SummonBattleEventMonster_TypeDefinitionIndex = 21420;
