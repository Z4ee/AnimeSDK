...
#define RPG_GAMECORE_SUMMONBATTLEEVENTMONSTER_METHOD_3_9589811D6C577C4E_OFFSET UNITYSDK_OFFSET(0x18EB2170)
#define RPG_GAMECORE_SUMMONBATTLEEVENTMONSTER_METHOD_3_BB42FE607BF62C67_OFFSET UNITYSDK_OFFSET(0x18EB2050)
#define RPG_GAMECORE_SUMMONBATTLEEVENTMONSTER__CTOR_OFFSET UNITYSDK_OFFSET(0x18EB20F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SummonBattleEventMonster_TypeDefinitionIndex = 21546;
