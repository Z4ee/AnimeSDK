...
#define RPG_GAMECORE_SUMMONBATTLEEVENTMONSTER_METHOD_3_9589811D6C577C4E_OFFSET UNITYSDK_OFFSET(0x1778C5B0)
#define RPG_GAMECORE_SUMMONBATTLEEVENTMONSTER_METHOD_3_BB42FE607BF62C67_OFFSET UNITYSDK_OFFSET(0x1778C490)
#define RPG_GAMECORE_SUMMONBATTLEEVENTMONSTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1778C530)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SummonBattleEventMonster_TypeDefinitionIndex = 20837;
