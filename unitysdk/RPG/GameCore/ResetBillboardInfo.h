...
#define RPG_GAMECORE_RESETBILLBOARDINFO_METHOD_3_5A96C5DE6CF40411_OFFSET UNITYSDK_OFFSET(0x1759DDB0)
#define RPG_GAMECORE_RESETBILLBOARDINFO_METHOD_3_B721D9599FA1F7FA_OFFSET UNITYSDK_OFFSET(0x1759DD30)
#define RPG_GAMECORE_RESETBILLBOARDINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1759DD80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetBillboardInfo_TypeDefinitionIndex = 18759;
