...
#define RPG_GAMECORE_RESETBILLBOARDINFO_METHOD_3_5A96C5DE6CF40411_OFFSET UNITYSDK_OFFSET(0x18CA9D70)
#define RPG_GAMECORE_RESETBILLBOARDINFO_METHOD_3_B721D9599FA1F7FA_OFFSET UNITYSDK_OFFSET(0x18CA9CF0)
#define RPG_GAMECORE_RESETBILLBOARDINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18CA9D40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetBillboardInfo_TypeDefinitionIndex = 19416;
