...
#define RPG_GAMECORE_UI3DCAMERASTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A35CF70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UI3DCameraState_TypeDefinitionIndex = 57694;
