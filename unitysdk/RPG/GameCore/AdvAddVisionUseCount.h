...
#define RPG_GAMECORE_ADVADDVISIONUSECOUNT_METHOD_3_8621A750F817086E_OFFSET UNITYSDK_OFFSET(0x16F23F90)
#define RPG_GAMECORE_ADVADDVISIONUSECOUNT_METHOD_3_C3E87BD3F13F8AC1_OFFSET UNITYSDK_OFFSET(0x16F23F00)
#define RPG_GAMECORE_ADVADDVISIONUSECOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x16F23F60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvAddVisionUseCount_TypeDefinitionIndex = 19402;
