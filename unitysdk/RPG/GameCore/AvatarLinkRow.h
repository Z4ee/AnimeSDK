...
#define RPG_GAMECORE_AVATARLINKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16FA1EF0)
#define RPG_GAMECORE_AVATARLINKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16FA2010)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AvatarLinkRow_TypeDefinitionIndex = 11683;
