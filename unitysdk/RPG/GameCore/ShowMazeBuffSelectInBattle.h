...
#define RPG_GAMECORE_SHOWMAZEBUFFSELECTINBATTLE_METHOD_3_14EF2A792A17C071_OFFSET UNITYSDK_OFFSET(0x176FFA60)
#define RPG_GAMECORE_SHOWMAZEBUFFSELECTINBATTLE_METHOD_3_49D1A714799B9F2F_OFFSET UNITYSDK_OFFSET(0x176FFAE0)
#define RPG_GAMECORE_SHOWMAZEBUFFSELECTINBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x176FFAB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowMazeBuffSelectInBattle_TypeDefinitionIndex = 20697;
