...
#define RPG_GAMECORE_SHOWMAZEBUFFSELECTINBATTLE_METHOD_3_7E2C7D5E215819FA_OFFSET UNITYSDK_OFFSET(0x1BE43950)
#define RPG_GAMECORE_SHOWMAZEBUFFSELECTINBATTLE_METHOD_3_BBB7EEE4764B83AD_OFFSET UNITYSDK_OFFSET(0x1BE43990)
#define RPG_GAMECORE_SHOWMAZEBUFFSELECTINBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE43980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowMazeBuffSelectInBattle_TypeDefinitionIndex = 21699;
