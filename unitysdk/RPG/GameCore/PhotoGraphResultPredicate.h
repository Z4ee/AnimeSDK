...
#define RPG_GAMECORE_PHOTOGRAPHRESULTPREDICATE_METHOD_2_AF51F552ABD7F2CC_OFFSET UNITYSDK_OFFSET(0x1D435E70)
#define RPG_GAMECORE_PHOTOGRAPHRESULTPREDICATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4360A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotoGraphResultPredicate_TypeDefinitionIndex = 21402;
