...
#define RPG_GAMECORE_PLANETFESACHIEVEMENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D33AF00)
#define RPG_GAMECORE_PLANETFESACHIEVEMENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D33B010)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlanetFesAchievementRow_TypeDefinitionIndex = 12142;
