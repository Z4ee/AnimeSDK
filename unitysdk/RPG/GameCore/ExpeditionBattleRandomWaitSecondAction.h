...
#define RPG_GAMECORE_EXPEDITIONBATTLERANDOMWAITSECONDACTION_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1D7DCC20)
#define RPG_GAMECORE_EXPEDITIONBATTLERANDOMWAITSECONDACTION_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D7DCBC0)
#define RPG_GAMECORE_EXPEDITIONBATTLERANDOMWAITSECONDACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7DCC10)
