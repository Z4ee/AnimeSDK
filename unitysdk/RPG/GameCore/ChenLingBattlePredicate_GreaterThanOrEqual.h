...
#define RPG_GAMECORE_CHENLINGBATTLEPREDICATE_GREATERTHANOREQUAL_METHOD_3_590D4F63A73774E0_OFFSET UNITYSDK_OFFSET(0x19622520)
#define RPG_GAMECORE_CHENLINGBATTLEPREDICATE_GREATERTHANOREQUAL_METHOD_3_9C66FB551688C842_OFFSET UNITYSDK_OFFSET(0x196224C0)
#define RPG_GAMECORE_CHENLINGBATTLEPREDICATE_GREATERTHANOREQUAL__CTOR_OFFSET UNITYSDK_OFFSET(0x19622510)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattlePredicate_GreaterThanOrEqual_TypeDefinitionIndex = 15037;
