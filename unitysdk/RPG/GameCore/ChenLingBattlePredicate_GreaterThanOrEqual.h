...
#define RPG_GAMECORE_CHENLINGBATTLEPREDICATE_GREATERTHANOREQUAL_METHOD_3_590D4F63A73774E0_OFFSET UNITYSDK_OFFSET(0x187E5100)
#define RPG_GAMECORE_CHENLINGBATTLEPREDICATE_GREATERTHANOREQUAL_METHOD_3_9C66FB551688C842_OFFSET UNITYSDK_OFFSET(0x187E50A0)
#define RPG_GAMECORE_CHENLINGBATTLEPREDICATE_GREATERTHANOREQUAL__CTOR_OFFSET UNITYSDK_OFFSET(0x187E50F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattlePredicate_GreaterThanOrEqual_TypeDefinitionIndex = 14974;
