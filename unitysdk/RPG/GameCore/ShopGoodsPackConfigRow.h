...
#define RPG_GAMECORE_SHOPGOODSPACKCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D5202E0)
#define RPG_GAMECORE_SHOPGOODSPACKCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D520460)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::System::UInt32 ComboGoodsID2; // 0x10
		::System::UInt32 BundleGoodsID; // 0x14
		::System::UInt32 ID; // 0x18
		::System::UInt32 ComboGoodsID1; // 0x1C
