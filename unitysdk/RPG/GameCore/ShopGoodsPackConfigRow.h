...
#define RPG_GAMECORE_SHOPGOODSPACKCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19C71F80)
#define RPG_GAMECORE_SHOPGOODSPACKCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19C72100)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShopGoodsPackConfigRow_TypeDefinitionIndex = 14370;
