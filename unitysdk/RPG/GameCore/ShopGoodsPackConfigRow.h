...
#define RPG_GAMECORE_SHOPGOODSPACKCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1BE37270)
#define RPG_GAMECORE_SHOPGOODSPACKCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE373F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShopGoodsPackConfigRow_TypeDefinitionIndex = 14518;

	class ShopGoodsPackConfigRow : public ::System::Object
	{
	public:
		::System::UInt32 ID; // 0x10
		::System::UInt32 BundleGoodsID; // 0x14
		::System::UInt32 ComboGoodsID1; // 0x18
		::System::UInt32 ComboGoodsID2; // 0x1C
