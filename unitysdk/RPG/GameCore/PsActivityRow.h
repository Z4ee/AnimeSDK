...
#define RPG_GAMECORE_PSACTIVITYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D376A20)
#define RPG_GAMECORE_PSACTIVITYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D376D10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PsActivityRow_TypeDefinitionIndex = 12973;
