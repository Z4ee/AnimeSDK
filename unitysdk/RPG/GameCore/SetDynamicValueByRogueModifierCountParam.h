...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEMODIFIERCOUNTPARAM_METHOD_4_6EE1E3C823927268_OFFSET UNITYSDK_OFFSET(0x1C5F0530)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEMODIFIERCOUNTPARAM_METHOD_4_E58DDD937AD6D7A4_OFFSET UNITYSDK_OFFSET(0x1C5F0580)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEMODIFIERCOUNTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5F0570)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRogueModifierCountParam_TypeDefinitionIndex = 20992;
