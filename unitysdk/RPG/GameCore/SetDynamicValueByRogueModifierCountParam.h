...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEMODIFIERCOUNTPARAM_METHOD_4_D60A4E28BC00EF24_OFFSET UNITYSDK_OFFSET(0x176C3D40)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEMODIFIERCOUNTPARAM_METHOD_4_E58DDD937AD6D7A4_OFFSET UNITYSDK_OFFSET(0x176C3DD0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEMODIFIERCOUNTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x176C3DA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRogueModifierCountParam_TypeDefinitionIndex = 19963;
