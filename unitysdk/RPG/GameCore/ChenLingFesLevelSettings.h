...
#define RPG_GAMECORE_CHENLINGFESLEVELSETTINGS_METHOD_3_0B53544F572FFEE8_OFFSET UNITYSDK_OFFSET(0x1C385A70)
#define RPG_GAMECORE_CHENLINGFESLEVELSETTINGS_METHOD_3_5A02270E90DE4CBD_OFFSET UNITYSDK_OFFSET(0x1C3859A0)
#define RPG_GAMECORE_CHENLINGFESLEVELSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C385A60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingFesLevelSettings_TypeDefinitionIndex = 17696;
