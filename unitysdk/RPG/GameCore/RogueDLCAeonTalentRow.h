...
#define RPG_GAMECORE_ROGUEDLCAEONTALENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18D03000)
#define RPG_GAMECORE_ROGUEDLCAEONTALENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18D03820)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueDLCAeonTalentRow_TypeDefinitionIndex = 13950;
	...
	public:
		...
		::RPG::Client::TextID EffectTitle; // 0x28
		::RPG::Client::TextID EffectDesc; // 0x38
		::System::UInt32 AeonTalentID; // 0x48
		::System::UInt32 UnlockAeonDimensionPoint; // 0x4C
