...
#define RPG_GAMECORE_CHECKISMAGICROGUEAUTODRESSOPEN_METHOD_3_12E206DD9F5ABBDF_OFFSET UNITYSDK_OFFSET(0x1B72DD20)
#define RPG_GAMECORE_CHECKISMAGICROGUEAUTODRESSOPEN_METHOD_3_B7A1BB06CC3389F0_OFFSET UNITYSDK_OFFSET(0x1B72DD60)
#define RPG_GAMECORE_CHECKISMAGICROGUEAUTODRESSOPEN__CTOR_OFFSET UNITYSDK_OFFSET(0x1B72DD50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CheckIsMagicRogueAutoDressOpen_TypeDefinitionIndex = 23436;
