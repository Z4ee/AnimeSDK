...
#define RPG_GAMECORE_CHECKISMAGICROGUEAUTODRESSOPEN_METHOD_3_C15F99A378853062_OFFSET UNITYSDK_OFFSET(0x187DA850)
#define RPG_GAMECORE_CHECKISMAGICROGUEAUTODRESSOPEN_METHOD_3_D61B20C629EA6626_OFFSET UNITYSDK_OFFSET(0x187DA7D0)
#define RPG_GAMECORE_CHECKISMAGICROGUEAUTODRESSOPEN__CTOR_OFFSET UNITYSDK_OFFSET(0x187DA820)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CheckIsMagicRogueAutoDressOpen_TypeDefinitionIndex = 23303;
