...
#define RPG_GAMECORE_WOLFBROPUZZLEGAMEDATALISTENER_METHOD_3_2B10276F44B290CC_OFFSET UNITYSDK_OFFSET(0x1EFA89E0)
#define RPG_GAMECORE_WOLFBROPUZZLEGAMEDATALISTENER_METHOD_3_4925AFD58A8CE1AB_OFFSET UNITYSDK_OFFSET(0x1EFA89A0)
#define RPG_GAMECORE_WOLFBROPUZZLEGAMEDATALISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFA89D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WolfBroPuzzleGameDataListener_TypeDefinitionIndex = 20923;
