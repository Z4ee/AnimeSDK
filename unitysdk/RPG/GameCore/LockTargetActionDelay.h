...
#define RPG_GAMECORE_LOCKTARGETACTIONDELAY_METHOD_3_CBAE2A0A7344887D_OFFSET UNITYSDK_OFFSET(0x198AD230)
#define RPG_GAMECORE_LOCKTARGETACTIONDELAY_METHOD_3_FDE3B6932F299A41_OFFSET UNITYSDK_OFFSET(0x198AD1B0)
#define RPG_GAMECORE_LOCKTARGETACTIONDELAY__CTOR_OFFSET UNITYSDK_OFFSET(0x198AD200)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LockTargetActionDelay_TypeDefinitionIndex = 22195;
