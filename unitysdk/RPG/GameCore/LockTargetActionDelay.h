...
#define RPG_GAMECORE_LOCKTARGETACTIONDELAY_METHOD_3_18966F9CB1066E0A_OFFSET UNITYSDK_OFFSET(0x1D211490)
#define RPG_GAMECORE_LOCKTARGETACTIONDELAY_METHOD_3_CBAE2A0A7344887D_OFFSET UNITYSDK_OFFSET(0x1D2114E0)
#define RPG_GAMECORE_LOCKTARGETACTIONDELAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2114D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LockTargetActionDelay_TypeDefinitionIndex = 23209;
