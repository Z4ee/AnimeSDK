...
#define RPG_GAMECORE_LOCKTARGETACTIONDELAY_METHOD_3_CBAE2A0A7344887D_OFFSET UNITYSDK_OFFSET(0x1736C180)
#define RPG_GAMECORE_LOCKTARGETACTIONDELAY_METHOD_3_FDE3B6932F299A41_OFFSET UNITYSDK_OFFSET(0x1736C100)
#define RPG_GAMECORE_LOCKTARGETACTIONDELAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1736C150)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LockTargetActionDelay_TypeDefinitionIndex = 21707;
