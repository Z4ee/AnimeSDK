...
#define RPG_GAMECORE_PLANETFESCARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D79BDA0)
#define RPG_GAMECORE_PLANETFESCARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D79C0C0)
