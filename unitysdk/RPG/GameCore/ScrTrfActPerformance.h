...
#define RPG_GAMECORE_SCRTRFACTPERFORMANCE_METHOD_3_53AADF4046CE7B96_OFFSET UNITYSDK_OFFSET(0x1769CD00)
#define RPG_GAMECORE_SCRTRFACTPERFORMANCE_METHOD_3_D6AB3F8DB539E89D_OFFSET UNITYSDK_OFFSET(0x1769CD40)
#define RPG_GAMECORE_SCRTRFACTPERFORMANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1769CD30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ScrTrfActPerformance_TypeDefinitionIndex = 20123;
