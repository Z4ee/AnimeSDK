...
#define RPG_GAMECORE_MODIFIEROVERRIDEONHITEFFECT_METHOD_3_49568A65CE336EB9_OFFSET UNITYSDK_OFFSET(0x18B34D40)
#define RPG_GAMECORE_MODIFIEROVERRIDEONHITEFFECT_METHOD_3_6134091955B181F7_OFFSET UNITYSDK_OFFSET(0x18B34DE0)
#define RPG_GAMECORE_MODIFIEROVERRIDEONHITEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x18B34DA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifierOverrideOnHitEffect_TypeDefinitionIndex = 22437;
