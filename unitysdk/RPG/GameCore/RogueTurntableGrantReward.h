...
#define RPG_GAMECORE_ROGUETURNTABLEGRANTREWARD_METHOD_3_BD1A89A7DC8C20DB_OFFSET UNITYSDK_OFFSET(0x17671B70)
#define RPG_GAMECORE_ROGUETURNTABLEGRANTREWARD_METHOD_3_CB1009E516408A2B_OFFSET UNITYSDK_OFFSET(0x17671C00)
#define RPG_GAMECORE_ROGUETURNTABLEGRANTREWARD__CTOR_OFFSET UNITYSDK_OFFSET(0x17671BD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTurntableGrantReward_TypeDefinitionIndex = 19138;
