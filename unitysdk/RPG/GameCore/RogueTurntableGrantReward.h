...
#define RPG_GAMECORE_ROGUETURNTABLEGRANTREWARD_METHOD_3_80D345C9562CE687_OFFSET UNITYSDK_OFFSET(0x1BB80830)
#define RPG_GAMECORE_ROGUETURNTABLEGRANTREWARD_METHOD_3_CB1009E516408A2B_OFFSET UNITYSDK_OFFSET(0x1BB80880)
#define RPG_GAMECORE_ROGUETURNTABLEGRANTREWARD__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB80870)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTurntableGrantReward_TypeDefinitionIndex = 20032;
