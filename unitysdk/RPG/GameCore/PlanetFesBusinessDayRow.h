...
#define RPG_GAMECORE_PLANETFESBUSINESSDAYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D79B590)
#define RPG_GAMECORE_PLANETFESBUSINESSDAYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D79BD90)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 LargeBonusNum; // 0x1C
		::RPG::Client::TextID StartText; // 0x20
		::System::UInt32 BusinessDay; // 0x30
		::System::UInt32 MiddleBonusNum; // 0x34
		::System::UInt32 GameNum; // 0x38
		::System::UInt32 PamNum; // 0x3C
