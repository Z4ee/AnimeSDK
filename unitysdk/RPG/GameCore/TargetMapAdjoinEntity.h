...
#define RPG_GAMECORE_TARGETMAPADJOINENTITY_METHOD_3_3794874F3A54ACA7_OFFSET UNITYSDK_OFFSET(0x1E1B9C70)
#define RPG_GAMECORE_TARGETMAPADJOINENTITY_METHOD_3_DCCAF6D535829D72_OFFSET UNITYSDK_OFFSET(0x1E1B9CC0)
#define RPG_GAMECORE_TARGETMAPADJOINENTITY_METHOD_3_E2352EAB62E7469A_OFFSET UNITYSDK_OFFSET(0x1E1B9EE0)
#define RPG_GAMECORE_TARGETMAPADJOINENTITY_METHOD_3_E4FB343633A3F1C7_OFFSET UNITYSDK_OFFSET(0x1E1B9F20)
#define RPG_GAMECORE_TARGETMAPADJOINENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1B9CB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapAdjoinEntity_TypeDefinitionIndex = 23743;
