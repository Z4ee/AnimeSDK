...
#define RPG_GAMECORE_TARGETMAPADJOINENTITY_METHOD_3_6293A8663FBD49AF_OFFSET UNITYSDK_OFFSET(0x177C1880)
#define RPG_GAMECORE_TARGETMAPADJOINENTITY_METHOD_3_DCCAF6D535829D72_OFFSET UNITYSDK_OFFSET(0x177C1910)
#define RPG_GAMECORE_TARGETMAPADJOINENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x177C18E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapAdjoinEntity_TypeDefinitionIndex = 22290;
