...
#define RPG_GAMECORE_PLAYFULLSCREENTRANSFER_METHOD_3_1C1F2A84DAB9B340_OFFSET UNITYSDK_OFFSET(0x174C1E10)
#define RPG_GAMECORE_PLAYFULLSCREENTRANSFER_METHOD_3_B59063D94D266187_OFFSET UNITYSDK_OFFSET(0x174C1ED0)
#define RPG_GAMECORE_PLAYFULLSCREENTRANSFER__CTOR_OFFSET UNITYSDK_OFFSET(0x174C1E80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayFullScreenTransfer_TypeDefinitionIndex = 19188;
