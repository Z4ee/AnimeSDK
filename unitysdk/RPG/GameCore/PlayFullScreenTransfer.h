...
#define RPG_GAMECORE_PLAYFULLSCREENTRANSFER_METHOD_3_B59063D94D266187_OFFSET UNITYSDK_OFFSET(0x1D7A4200)
#define RPG_GAMECORE_PLAYFULLSCREENTRANSFER_METHOD_3_FA7E20CC59D5C20A_OFFSET UNITYSDK_OFFSET(0x1D7A4190)
#define RPG_GAMECORE_PLAYFULLSCREENTRANSFER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7A41E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayFullScreenTransfer_TypeDefinitionIndex = 20623;
