...
#define RPG_GAMECORE_ROGUEMODIFIERAPPENDATTRIBUTEONPERSONAROOMCARDADDCONFIG_METHOD_3_1711F8E8D5558520_OFFSET UNITYSDK_OFFSET(0x18D2A9B0)
#define RPG_GAMECORE_ROGUEMODIFIERAPPENDATTRIBUTEONPERSONAROOMCARDADDCONFIG_METHOD_3_46CD91E84168E0F9_OFFSET UNITYSDK_OFFSET(0x18D2AA80)
#define RPG_GAMECORE_ROGUEMODIFIERAPPENDATTRIBUTEONPERSONAROOMCARDADDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D2AA30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierAppendAttributeOnPersonaRoomCardAddConfig_TypeDefinitionIndex = 16942;
