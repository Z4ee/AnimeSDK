...
#define RPG_GAMECORE_ROGUEMODIFIERAPPENDATTRIBUTEONPERSONAROOMCARDADDCONFIG_METHOD_3_1711F8E8D5558520_OFFSET UNITYSDK_OFFSET(0x1761D1A0)
#define RPG_GAMECORE_ROGUEMODIFIERAPPENDATTRIBUTEONPERSONAROOMCARDADDCONFIG_METHOD_3_46CD91E84168E0F9_OFFSET UNITYSDK_OFFSET(0x1761D270)
#define RPG_GAMECORE_ROGUEMODIFIERAPPENDATTRIBUTEONPERSONAROOMCARDADDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1761D220)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierAppendAttributeOnPersonaRoomCardAddConfig_TypeDefinitionIndex = 16388;
