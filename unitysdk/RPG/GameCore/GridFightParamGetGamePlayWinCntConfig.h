...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETGAMEPLAYWINCNTCONFIG_METHOD_6_BB75778FED467A32_OFFSET UNITYSDK_OFFSET(0x1D06D670)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETGAMEPLAYWINCNTCONFIG_METHOD_6_C3CD387C67FB3E4E_OFFSET UNITYSDK_OFFSET(0x1D06D6C0)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETGAMEPLAYWINCNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D06D6B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightParamGetGamePlayWinCntConfig_TypeDefinitionIndex = 18789;
