...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETGAMEPLAYWINCNTCONFIG_METHOD_6_919C320B2AE67008_OFFSET UNITYSDK_OFFSET(0x1726FF70)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETGAMEPLAYWINCNTCONFIG_METHOD_6_C3CD387C67FB3E4E_OFFSET UNITYSDK_OFFSET(0x17270220)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETGAMEPLAYWINCNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x172700F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightParamGetGamePlayWinCntConfig_TypeDefinitionIndex = 17910;
