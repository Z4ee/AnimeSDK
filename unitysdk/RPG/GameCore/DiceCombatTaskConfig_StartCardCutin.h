...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_STARTCARDCUTIN_METHOD_3_75D8ED821D7B13E3_OFFSET UNITYSDK_OFFSET(0x1C11A640)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_STARTCARDCUTIN_METHOD_3_D7E4988344A2CD62_OFFSET UNITYSDK_OFFSET(0x1C11A6E0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_STARTCARDCUTIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1C11A6D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_StartCardCutin_TypeDefinitionIndex = 15434;
