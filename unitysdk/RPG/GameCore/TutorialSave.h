...
#define RPG_GAMECORE_TUTORIALSAVE_METHOD_3_8B934656C01E0507_OFFSET UNITYSDK_OFFSET(0x190DD9E0)
#define RPG_GAMECORE_TUTORIALSAVE_METHOD_3_F149D59DE80310C6_OFFSET UNITYSDK_OFFSET(0x190DD960)
#define RPG_GAMECORE_TUTORIALSAVE__CTOR_OFFSET UNITYSDK_OFFSET(0x190DD9B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TutorialSave_TypeDefinitionIndex = 23374;
