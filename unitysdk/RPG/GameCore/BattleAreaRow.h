...
#define RPG_GAMECORE_BATTLEAREAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x194C2D80)
#define RPG_GAMECORE_BATTLEAREAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x194C30D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleAreaRow_TypeDefinitionIndex = 12215;
	...
	public:
		...
		::System::UInt32 UnifiedConfigID; // 0x1C
		::System::Boolean IsLegacy; // 0x20
		::System::Boolean IsUseUnifiedConfig; // 0x21
