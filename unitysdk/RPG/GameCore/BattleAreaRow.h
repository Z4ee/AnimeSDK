...
#define RPG_GAMECORE_BATTLEAREAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B2F07A0)
#define RPG_GAMECORE_BATTLEAREAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2F0AF0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Boolean IsUseUnifiedConfig; // 0x30
		::System::Boolean IsLegacy; // 0x31
