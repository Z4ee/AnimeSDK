...
#define RPG_GAMECORE_MISSIONIDPAIR_METHOD_2_F04CD62693931396_OFFSET UNITYSDK_OFFSET(0x1D2A54E0)
#define RPG_GAMECORE_MISSIONIDPAIR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2A55F0)
