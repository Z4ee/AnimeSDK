...
#define RPG_GAMECORE_WAITPROPCURVEMOVEFINISH_METHOD_3_9FAE3F0E0A34EA44_OFFSET UNITYSDK_OFFSET(0x19104CF0)
#define RPG_GAMECORE_WAITPROPCURVEMOVEFINISH_METHOD_3_AD2CC6DA09E725A0_OFFSET UNITYSDK_OFFSET(0x19104DC0)
#define RPG_GAMECORE_WAITPROPCURVEMOVEFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x19104D70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitPropCurveMoveFinish_TypeDefinitionIndex = 20001;
