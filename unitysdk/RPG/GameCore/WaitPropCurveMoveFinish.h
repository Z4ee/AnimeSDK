...
#define RPG_GAMECORE_WAITPROPCURVEMOVEFINISH_METHOD_3_4959F286B3ADDCCD_OFFSET UNITYSDK_OFFSET(0x1D6A9590)
#define RPG_GAMECORE_WAITPROPCURVEMOVEFINISH_METHOD_3_AD2CC6DA09E725A0_OFFSET UNITYSDK_OFFSET(0x1D6A9630)
#define RPG_GAMECORE_WAITPROPCURVEMOVEFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6A95F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitPropCurveMoveFinish_TypeDefinitionIndex = 20777;
