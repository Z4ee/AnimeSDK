...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSHOPUPROLERARITYWEIGHTBYADDCONFIG_METHOD_3_7DB66E740D20B10F_OFFSET UNITYSDK_OFFSET(0x197F3F90)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSHOPUPROLERARITYWEIGHTBYADDCONFIG_METHOD_3_A82B27E1C83962E6_OFFSET UNITYSDK_OFFSET(0x197F4060)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSHOPUPROLERARITYWEIGHTBYADDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197F4010)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierShopUpRoleRarityWeightByAddConfig_TypeDefinitionIndex = 18356;
