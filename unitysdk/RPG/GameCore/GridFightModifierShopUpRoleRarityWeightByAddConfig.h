...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSHOPUPROLERARITYWEIGHTBYADDCONFIG_METHOD_3_41B5581C995D8C8A_OFFSET UNITYSDK_OFFSET(0x1D06B160)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSHOPUPROLERARITYWEIGHTBYADDCONFIG_METHOD_3_A82B27E1C83962E6_OFFSET UNITYSDK_OFFSET(0x1D06B1B0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSHOPUPROLERARITYWEIGHTBYADDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D06B1A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierShopUpRoleRarityWeightByAddConfig_TypeDefinitionIndex = 18600;
