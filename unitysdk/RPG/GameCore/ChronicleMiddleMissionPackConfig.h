...
#define RPG_GAMECORE_CHRONICLEMIDDLEMISSIONPACKCONFIG_METHOD_2_E9FD1BB0073C5D68_OFFSET UNITYSDK_OFFSET(0x1CFD6B90)
#define RPG_GAMECORE_CHRONICLEMIDDLEMISSIONPACKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFD6C50)
