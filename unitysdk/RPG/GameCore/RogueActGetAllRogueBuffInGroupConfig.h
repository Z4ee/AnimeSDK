...
#define RPG_GAMECORE_ROGUEACTGETALLROGUEBUFFINGROUPCONFIG_METHOD_6_5157B48580DA42C8_OFFSET UNITYSDK_OFFSET(0x19AE56A0)
#define RPG_GAMECORE_ROGUEACTGETALLROGUEBUFFINGROUPCONFIG_METHOD_6_F947CBD704FFCD75_OFFSET UNITYSDK_OFFSET(0x19AE5480)
#define RPG_GAMECORE_ROGUEACTGETALLROGUEBUFFINGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AE55C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActGetAllRogueBuffInGroupConfig_TypeDefinitionIndex = 18561;
