...
#define RPG_GAMECORE_ROGUEACTGETALLROGUEBUFFINGROUPCONFIG_METHOD_6_5157B48580DA42C8_OFFSET UNITYSDK_OFFSET(0x1D02DCD0)
#define RPG_GAMECORE_ROGUEACTGETALLROGUEBUFFINGROUPCONFIG_METHOD_6_DCA541E30325294C_OFFSET UNITYSDK_OFFSET(0x1D02DC80)
#define RPG_GAMECORE_ROGUEACTGETALLROGUEBUFFINGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D02DCC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActGetAllRogueBuffInGroupConfig_TypeDefinitionIndex = 18837;
