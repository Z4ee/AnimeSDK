...
#define RPG_GAMECORE_GAMELEVELHEARTDIALSCRIPTCONFIG_METHOD_2_EEC601C6E173CA6E_OFFSET UNITYSDK_OFFSET(0x17238B40)
#define RPG_GAMECORE_GAMELEVELHEARTDIALSCRIPTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17241140)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GameLevelHeartDialScriptConfig_TypeDefinitionIndex = 16002;
