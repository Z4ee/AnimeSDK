...
#define RPG_GAMECORE_SETTIMELINEENTITYSTATE_METHOD_3_887DD9289E15961D_OFFSET UNITYSDK_OFFSET(0x1E093C80)
#define RPG_GAMECORE_SETTIMELINEENTITYSTATE_METHOD_3_9C2D3C534837FEDC_OFFSET UNITYSDK_OFFSET(0x1E093CD0)
#define RPG_GAMECORE_SETTIMELINEENTITYSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E093CC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetTimelineEntityState_TypeDefinitionIndex = 20398;
