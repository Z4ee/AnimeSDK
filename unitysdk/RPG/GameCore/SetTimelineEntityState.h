...
#define RPG_GAMECORE_SETTIMELINEENTITYSTATE_METHOD_3_9C2D3C534837FEDC_OFFSET UNITYSDK_OFFSET(0x176E4FF0)
#define RPG_GAMECORE_SETTIMELINEENTITYSTATE_METHOD_3_CA19F5BF139D6521_OFFSET UNITYSDK_OFFSET(0x176E4F70)
#define RPG_GAMECORE_SETTIMELINEENTITYSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x176E4FC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetTimelineEntityState_TypeDefinitionIndex = 18949;
