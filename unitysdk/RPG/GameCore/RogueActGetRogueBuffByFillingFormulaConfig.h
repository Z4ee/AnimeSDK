...
#define RPG_GAMECORE_ROGUEACTGETROGUEBUFFBYFILLINGFORMULACONFIG_METHOD_6_2F17E4A95D16762C_OFFSET UNITYSDK_OFFSET(0x18CC2420)
#define RPG_GAMECORE_ROGUEACTGETROGUEBUFFBYFILLINGFORMULACONFIG_METHOD_6_C3A5D78492352361_OFFSET UNITYSDK_OFFSET(0x18CC2640)
#define RPG_GAMECORE_ROGUEACTGETROGUEBUFFBYFILLINGFORMULACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CC2560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActGetRogueBuffByFillingFormulaConfig_TypeDefinitionIndex = 18664;
