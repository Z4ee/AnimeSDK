...
#define RPG_GAMECORE_ROGUEACTGETROGUEBUFFBYFILLINGFORMULACONFIG_METHOD_6_C3A5D78492352361_OFFSET UNITYSDK_OFFSET(0x1D02E030)
#define RPG_GAMECORE_ROGUEACTGETROGUEBUFFBYFILLINGFORMULACONFIG_METHOD_6_C3ADE2BFFB5EA03D_OFFSET UNITYSDK_OFFSET(0x1D02DFE0)
#define RPG_GAMECORE_ROGUEACTGETROGUEBUFFBYFILLINGFORMULACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D02E020)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActGetRogueBuffByFillingFormulaConfig_TypeDefinitionIndex = 18907;
