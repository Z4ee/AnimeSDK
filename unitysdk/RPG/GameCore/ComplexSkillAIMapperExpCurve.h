...
#define RPG_GAMECORE_COMPLEXSKILLAIMAPPEREXPCURVE_METHOD_3_0DC78AFC7041894D_OFFSET UNITYSDK_OFFSET(0x17123DC0)
#define RPG_GAMECORE_COMPLEXSKILLAIMAPPEREXPCURVE_METHOD_3_AAE630D84E1CF774_OFFSET UNITYSDK_OFFSET(0x171239E0)
#define RPG_GAMECORE_COMPLEXSKILLAIMAPPEREXPCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x171239D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAIMapperExpCurve_TypeDefinitionIndex = 14254;
