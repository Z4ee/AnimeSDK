...
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_FIREPROJECTILE_METHOD_3_43B618CF4960EB68_OFFSET UNITYSDK_OFFSET(0x1707A140)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_FIREPROJECTILE_METHOD_3_917110D54B68D242_OFFSET UNITYSDK_OFFSET(0x1707A1A0)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_FIREPROJECTILE__CTOR_OFFSET UNITYSDK_OFFSET(0x1707A190)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleAbility_FireProjectile_TypeDefinitionIndex = 14401;
