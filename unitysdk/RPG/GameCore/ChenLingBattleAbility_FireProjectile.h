...
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_FIREPROJECTILE_METHOD_3_43B618CF4960EB68_OFFSET UNITYSDK_OFFSET(0x187DEB90)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_FIREPROJECTILE_METHOD_3_917110D54B68D242_OFFSET UNITYSDK_OFFSET(0x187DEBF0)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_FIREPROJECTILE__CTOR_OFFSET UNITYSDK_OFFSET(0x187DEBE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleAbility_FireProjectile_TypeDefinitionIndex = 14871;
