...
#define RPG_GAMECORE_BYSAVEMODELWHENDEAD_METHOD_4_6043EA1614531414_OFFSET UNITYSDK_OFFSET(0x1B2B8000)
#define RPG_GAMECORE_BYSAVEMODELWHENDEAD_METHOD_4_716D9E5D8CCAAB25_OFFSET UNITYSDK_OFFSET(0x1B2B8060)
#define RPG_GAMECORE_BYSAVEMODELWHENDEAD_METHOD_4_80FCEC40B7C5ED79_OFFSET UNITYSDK_OFFSET(0x1B2B7E80)
#define RPG_GAMECORE_BYSAVEMODELWHENDEAD_METHOD_4_D06F551879B396C8_OFFSET UNITYSDK_OFFSET(0x1B2B7DE0)
#define RPG_GAMECORE_BYSAVEMODELWHENDEAD__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2B7E40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BySaveModelWhenDead_TypeDefinitionIndex = 22308;
