...
#define RPG_GAMECORE_BYSAVEMODELWHENDEAD_METHOD_4_74A13E7C8691FA86_OFFSET UNITYSDK_OFFSET(0x1703A3D0)
#define RPG_GAMECORE_BYSAVEMODELWHENDEAD_METHOD_4_80FCEC40B7C5ED79_OFFSET UNITYSDK_OFFSET(0x1703A4F0)
#define RPG_GAMECORE_BYSAVEMODELWHENDEAD__CTOR_OFFSET UNITYSDK_OFFSET(0x1703A470)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BySaveModelWhenDead_TypeDefinitionIndex = 21364;
