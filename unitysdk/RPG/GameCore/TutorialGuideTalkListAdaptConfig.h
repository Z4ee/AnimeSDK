...
#define RPG_GAMECORE_TUTORIALGUIDETALKLISTADAPTCONFIG_METHOD_2_876419F9A078D635_OFFSET UNITYSDK_OFFSET(0x1B06DE10)
#define RPG_GAMECORE_TUTORIALGUIDETALKLISTADAPTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B06DFF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TutorialGuideTalkListAdaptConfig_TypeDefinitionIndex = 23532;
