...
#define RPG_GAMECORE_HOYOGROUPSTREAMINGBLACKLIST_METHOD_2_5E6B3995DF1474B3_OFFSET UNITYSDK_OFFSET(0x1D194FD0)
#define RPG_GAMECORE_HOYOGROUPSTREAMINGBLACKLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1950C0)
