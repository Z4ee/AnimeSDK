...
#define RPG_GAMECORE_PLAYERLOCKRANGECONFIG_METHOD_2_193F85E115477945_OFFSET UNITYSDK_OFFSET(0x18C28150)
#define RPG_GAMECORE_PLAYERLOCKRANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18C286C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayerLockRangeConfig_TypeDefinitionIndex = 16718;
