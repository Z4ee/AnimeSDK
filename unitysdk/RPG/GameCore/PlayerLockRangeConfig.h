...
#define RPG_GAMECORE_PLAYERLOCKRANGECONFIG_METHOD_2_193F85E115477945_OFFSET UNITYSDK_OFFSET(0x19A380E0)
#define RPG_GAMECORE_PLAYERLOCKRANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19A38650)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayerLockRangeConfig_TypeDefinitionIndex = 16741;
