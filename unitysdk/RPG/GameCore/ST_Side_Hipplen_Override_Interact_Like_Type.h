...
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_OVERRIDE_INTERACT_LIKE_TYPE_METHOD_4_8F4C41883345D386_OFFSET UNITYSDK_OFFSET(0x18DF8550)
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_OVERRIDE_INTERACT_LIKE_TYPE_METHOD_4_B3480FF1D721225E_OFFSET UNITYSDK_OFFSET(0x18DF8630)
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_OVERRIDE_INTERACT_LIKE_TYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x18DF85D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_Hipplen_Override_Interact_Like_Type_TypeDefinitionIndex = 20288;
