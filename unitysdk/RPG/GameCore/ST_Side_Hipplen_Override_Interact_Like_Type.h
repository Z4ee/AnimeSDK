...
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_OVERRIDE_INTERACT_LIKE_TYPE_METHOD_4_B3480FF1D721225E_OFFSET UNITYSDK_OFFSET(0x1D4D0C20)
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_OVERRIDE_INTERACT_LIKE_TYPE_METHOD_4_D2708D7AB957F3EB_OFFSET UNITYSDK_OFFSET(0x1D4D0BD0)
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_OVERRIDE_INTERACT_LIKE_TYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4D0C10)
