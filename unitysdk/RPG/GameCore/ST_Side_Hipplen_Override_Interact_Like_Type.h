...
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_OVERRIDE_INTERACT_LIKE_TYPE_METHOD_4_8F4C41883345D386_OFFSET UNITYSDK_OFFSET(0x17699070)
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_OVERRIDE_INTERACT_LIKE_TYPE_METHOD_4_B3480FF1D721225E_OFFSET UNITYSDK_OFFSET(0x1768C1C0)
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_OVERRIDE_INTERACT_LIKE_TYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1768C160)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_Hipplen_Override_Interact_Like_Type_TypeDefinitionIndex = 19608;
