...
#define RPG_GAMECORE_FIVEDIMCHENLINGCAPTUREFRAMEACTION_METHOD_3_633A12081CA93A9F_OFFSET UNITYSDK_OFFSET(0x1E0E5A20)
#define RPG_GAMECORE_FIVEDIMCHENLINGCAPTUREFRAMEACTION_METHOD_3_EF9AA1C10255AEEE_OFFSET UNITYSDK_OFFSET(0x1E0E59A0)
#define RPG_GAMECORE_FIVEDIMCHENLINGCAPTUREFRAMEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0E5A10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimChenLingCaptureFrameAction_TypeDefinitionIndex = 18572;
