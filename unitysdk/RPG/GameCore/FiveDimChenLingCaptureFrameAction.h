...
#define RPG_GAMECORE_FIVEDIMCHENLINGCAPTUREFRAMEACTION_METHOD_3_514F79262A258E92_OFFSET UNITYSDK_OFFSET(0x19734AE0)
#define RPG_GAMECORE_FIVEDIMCHENLINGCAPTUREFRAMEACTION_METHOD_3_633A12081CA93A9F_OFFSET UNITYSDK_OFFSET(0x1972C8F0)
#define RPG_GAMECORE_FIVEDIMCHENLINGCAPTUREFRAMEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1972C8D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimChenLingCaptureFrameAction_TypeDefinitionIndex = 17872;
