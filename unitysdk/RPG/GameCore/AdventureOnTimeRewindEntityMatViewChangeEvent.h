...
#define RPG_GAMECORE_ADVENTUREONTIMEREWINDENTITYMATVIEWCHANGEEVENT_CLEAR_OFFSET UNITYSDK_OFFSET(0x19404E40)
#define RPG_GAMECORE_ADVENTUREONTIMEREWINDENTITYMATVIEWCHANGEEVENT_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x19404EE0)
#define RPG_GAMECORE_ADVENTUREONTIMEREWINDENTITYMATVIEWCHANGEEVENT_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x19404E90)
#define RPG_GAMECORE_ADVENTUREONTIMEREWINDENTITYMATVIEWCHANGEEVENT_INIT_OFFSET UNITYSDK_OFFSET(0x19404DF0)
#define RPG_GAMECORE_ADVENTUREONTIMEREWINDENTITYMATVIEWCHANGEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19404F30)
