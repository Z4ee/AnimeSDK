...
#define RPG_GAMECORE_LEVELENTITYBEFORESKILLCOST_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xE6912E0)
#define RPG_GAMECORE_LEVELENTITYBEFORESKILLCOST_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xE691290)
#define RPG_GAMECORE_LEVELENTITYBEFORESKILLCOST_GET_BPCOST_OFFSET UNITYSDK_OFFSET(0xE691370)
#define RPG_GAMECORE_LEVELENTITYBEFORESKILLCOST_GET_OWNERID_OFFSET UNITYSDK_OFFSET(0xE691330)
#define RPG_GAMECORE_LEVELENTITYBEFORESKILLCOST_GET_SKILLCONFIG_OFFSET UNITYSDK_OFFSET(0xE691350)
#define RPG_GAMECORE_LEVELENTITYBEFORESKILLCOST_INIT_OFFSET UNITYSDK_OFFSET(0xE691230)
#define RPG_GAMECORE_LEVELENTITYBEFORESKILLCOST_SET_BPCOST_OFFSET UNITYSDK_OFFSET(0xE691380)
#define RPG_GAMECORE_LEVELENTITYBEFORESKILLCOST_SET_OWNERID_OFFSET UNITYSDK_OFFSET(0xE691340)
#define RPG_GAMECORE_LEVELENTITYBEFORESKILLCOST_SET_SKILLCONFIG_OFFSET UNITYSDK_OFFSET(0xE691360)
#define RPG_GAMECORE_LEVELENTITYBEFORESKILLCOST__CTOR_OFFSET UNITYSDK_OFFSET(0xE691390)
