...
#define RPG_GAMECORE_LEVELENTITYBEFORESKILLCOST_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1BDFA400)
#define RPG_GAMECORE_LEVELENTITYBEFORESKILLCOST_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x1BDFA3B0)
#define RPG_GAMECORE_LEVELENTITYBEFORESKILLCOST_GET_BPCOST_OFFSET UNITYSDK_OFFSET(0x1BDFA490)
#define RPG_GAMECORE_LEVELENTITYBEFORESKILLCOST_GET_OWNERID_OFFSET UNITYSDK_OFFSET(0x1BDFA450)
#define RPG_GAMECORE_LEVELENTITYBEFORESKILLCOST_GET_SKILLCONFIG_OFFSET UNITYSDK_OFFSET(0x1BDFA470)
#define RPG_GAMECORE_LEVELENTITYBEFORESKILLCOST_INIT_OFFSET UNITYSDK_OFFSET(0x1BDFA350)
#define RPG_GAMECORE_LEVELENTITYBEFORESKILLCOST_SET_BPCOST_OFFSET UNITYSDK_OFFSET(0x1BDFA4A0)
#define RPG_GAMECORE_LEVELENTITYBEFORESKILLCOST_SET_OWNERID_OFFSET UNITYSDK_OFFSET(0x1BDFA460)
#define RPG_GAMECORE_LEVELENTITYBEFORESKILLCOST_SET_SKILLCONFIG_OFFSET UNITYSDK_OFFSET(0x1BDFA480)
#define RPG_GAMECORE_LEVELENTITYBEFORESKILLCOST__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDFA4B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelEntityBeforeSkillCost_TypeDefinitionIndex = 54207;
	...
	public:
		...
		::System::Int32 _BPCost_k__BackingField; // 0x20
		::System::UInt32 _OwnerID_k__BackingField; // 0x24
