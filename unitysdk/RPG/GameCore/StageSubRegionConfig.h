...
#define RPG_GAMECORE_STAGESUBREGIONCONFIG_METHOD_2_86ACD79CD46FF7AE_OFFSET UNITYSDK_OFFSET(0x1B0B5830)
#define RPG_GAMECORE_STAGESUBREGIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0B5870)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StageSubRegionConfig_TypeDefinitionIndex = 18441;
