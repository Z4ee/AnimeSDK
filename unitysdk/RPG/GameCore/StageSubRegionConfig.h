...
#define RPG_GAMECORE_STAGESUBREGIONCONFIG_METHOD_2_86ACD79CD46FF7AE_OFFSET UNITYSDK_OFFSET(0x1776DA00)
#define RPG_GAMECORE_STAGESUBREGIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1776DA40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StageSubRegionConfig_TypeDefinitionIndex = 17605;
