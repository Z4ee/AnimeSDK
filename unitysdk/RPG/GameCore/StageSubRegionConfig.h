...
#define RPG_GAMECORE_STAGESUBREGIONCONFIG_METHOD_2_86ACD79CD46FF7AE_OFFSET UNITYSDK_OFFSET(0x1CAECA80)
#define RPG_GAMECORE_STAGESUBREGIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CAECAC0)
