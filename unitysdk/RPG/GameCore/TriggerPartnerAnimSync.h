...
#define RPG_GAMECORE_TRIGGERPARTNERANIMSYNC_METHOD_3_9358CD7A822E0E0E_OFFSET UNITYSDK_OFFSET(0x178CC510)
#define RPG_GAMECORE_TRIGGERPARTNERANIMSYNC_METHOD_3_B4617135F0F6BF5F_OFFSET UNITYSDK_OFFSET(0x178CC490)
#define RPG_GAMECORE_TRIGGERPARTNERANIMSYNC__CTOR_OFFSET UNITYSDK_OFFSET(0x178CC4E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerPartnerAnimSync_TypeDefinitionIndex = 21677;
