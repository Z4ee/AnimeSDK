...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_MARKBOSSFORCECHANGEPHASEFLAG_METHOD_3_035DEA46543EE65A_OFFSET UNITYSDK_OFFSET(0x1887C770)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_MARKBOSSFORCECHANGEPHASEFLAG_METHOD_3_D7FE6DEC532465D5_OFFSET UNITYSDK_OFFSET(0x18877730)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_MARKBOSSFORCECHANGEPHASEFLAG__CTOR_OFFSET UNITYSDK_OFFSET(0x188776E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_MarkBossForceChangePhaseFlag_TypeDefinitionIndex = 15246;
