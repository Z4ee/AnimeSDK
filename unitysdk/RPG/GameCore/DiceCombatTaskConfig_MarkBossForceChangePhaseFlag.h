...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_MARKBOSSFORCECHANGEPHASEFLAG_METHOD_3_42008D98B55629D0_OFFSET UNITYSDK_OFFSET(0x1C119310)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_MARKBOSSFORCECHANGEPHASEFLAG_METHOD_3_D7FE6DEC532465D5_OFFSET UNITYSDK_OFFSET(0x1C1193B0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_MARKBOSSFORCECHANGEPHASEFLAG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1193A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_MarkBossForceChangePhaseFlag_TypeDefinitionIndex = 15469;
