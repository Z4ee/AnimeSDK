...
#define RPG_GAMECORE_TRIGGERROGUEENTERNEXTROOM_METHOD_3_35DD831820197305_OFFSET UNITYSDK_OFFSET(0x1D604560)
#define RPG_GAMECORE_TRIGGERROGUEENTERNEXTROOM_METHOD_3_45A1C714AEF01088_OFFSET UNITYSDK_OFFSET(0x1D604490)
#define RPG_GAMECORE_TRIGGERROGUEENTERNEXTROOM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D604550)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerRogueEnterNextRoom_TypeDefinitionIndex = 22018;
