...
#define RPG_GAMECORE_TRIGGERROGUEENTERNEXTROOM_METHOD_3_35DD831820197305_OFFSET UNITYSDK_OFFSET(0x190CC000)
#define RPG_GAMECORE_TRIGGERROGUEENTERNEXTROOM_METHOD_3_9DD5F76A915893B1_OFFSET UNITYSDK_OFFSET(0x190CBEF0)
#define RPG_GAMECORE_TRIGGERROGUEENTERNEXTROOM__CTOR_OFFSET UNITYSDK_OFFSET(0x190CBFD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerRogueEnterNextRoom_TypeDefinitionIndex = 21141;
