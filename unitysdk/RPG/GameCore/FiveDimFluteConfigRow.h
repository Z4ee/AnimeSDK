...
#define RPG_GAMECORE_FIVEDIMFLUTECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x189022E0)
#define RPG_GAMECORE_FIVEDIMFLUTECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18902750)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimFluteConfigRow_TypeDefinitionIndex = 13371;
	...
	public:
		...
		::System::Int16 GPValue; // 0x24
		::RPG::GameCore::FiveDimFluteEffectType Type; // 0x28
		::System::UInt32 GroupID; // 0x2C
		::RPG::Client::TextID AutoPlayChangeGPFailTextmapKey; // 0x30
		::System::UInt32 FiveDimAnchorID; // 0x40
		::System::UInt32 ContainerID; // 0x44
		::System::UInt32 EntranceID; // 0x48
		::System::UInt32 TeleAnchorID; // 0x4C
