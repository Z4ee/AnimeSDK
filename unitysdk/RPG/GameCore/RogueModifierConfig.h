...
#define RPG_GAMECORE_ROGUEMODIFIERCONFIG_METHOD_2_B072661D47046B81_OFFSET UNITYSDK_OFFSET(0x1CFBF470)
#define RPG_GAMECORE_ROGUEMODIFIERCONFIG_METHOD_2_C3038A93A49112AD_OFFSET UNITYSDK_OFFSET(0x1CFBF4D0)
#define RPG_GAMECORE_ROGUEMODIFIERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFBEDA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierConfig_TypeDefinitionIndex = 17203;
