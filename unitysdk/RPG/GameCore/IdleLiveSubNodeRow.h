...
#define RPG_GAMECORE_IDLELIVESUBNODEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D215C80)
#define RPG_GAMECORE_IDLELIVESUBNODEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D215E30)
