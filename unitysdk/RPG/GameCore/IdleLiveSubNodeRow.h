...
#define RPG_GAMECORE_IDLELIVESUBNODEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19848320)
#define RPG_GAMECORE_IDLELIVESUBNODEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x198484D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int IdleLiveSubNodeRow_TypeDefinitionIndex = 11187;

	class IdleLiveSubNodeRow : public ::System::Object
	{
	public:
		::System::UInt32 RewardID; // 0x10
		::System::UInt32 SubNodeID; // 0x14
		::System::UInt32 EquipOrbDrop; // 0x18
