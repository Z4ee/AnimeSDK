...
#define RPG_GAMECORE_ANIMATORSTATEZONECONFIG_METHOD_2_11610B9E46F2D0AE_OFFSET UNITYSDK_OFFSET(0x1CE1D630)
#define RPG_GAMECORE_ANIMATORSTATEZONECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE1EBD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AnimatorStateZoneConfig_TypeDefinitionIndex = 16151;
