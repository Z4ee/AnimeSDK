...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETUNLOCKEXPERTNUMCONFIG_METHOD_6_BE8F75A638B45E3F_OFFSET UNITYSDK_OFFSET(0x17274170)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETUNLOCKEXPERTNUMCONFIG_METHOD_6_DA77E606691ED219_OFFSET UNITYSDK_OFFSET(0x17274420)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETUNLOCKEXPERTNUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x172742F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightParamGetUnlockExpertNumConfig_TypeDefinitionIndex = 17915;
