...
#define RPG_GAMECORE_ENABLEPERFORMANCEMODE_METHOD_3_6B37B84D069D392E_OFFSET UNITYSDK_OFFSET(0x188A6CF0)
#define RPG_GAMECORE_ENABLEPERFORMANCEMODE_METHOD_3_FD4068388DE3E3FF_OFFSET UNITYSDK_OFFSET(0x188A6C70)
#define RPG_GAMECORE_ENABLEPERFORMANCEMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x188A6CC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnablePerformanceMode_TypeDefinitionIndex = 20418;
