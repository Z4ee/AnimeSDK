...
#define RPG_GAMECORE_GAMEOBJECTPOOLGROUPSETTING_METHOD_2_F71A2711C8F52DFC_OFFSET UNITYSDK_OFFSET(0x1C5B4ED0)
#define RPG_GAMECORE_GAMEOBJECTPOOLGROUPSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5B52A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GameObjectPoolGroupSetting_TypeDefinitionIndex = 15813;
