...
#define RPG_GAMECORE_GAMEOBJECTPOOLGROUPSETTING_METHOD_2_F71A2711C8F52DFC_OFFSET UNITYSDK_OFFSET(0x197C9930)
#define RPG_GAMECORE_GAMEOBJECTPOOLGROUPSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x197C9D00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GameObjectPoolGroupSetting_TypeDefinitionIndex = 15640;
