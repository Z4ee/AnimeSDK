...
#define RPG_GAMECORE_FATEMODIFIERMASTERPHAINONCONFIG_METHOD_3_3AC1D093159C6BDB_OFFSET UNITYSDK_OFFSET(0x19711190)
#define RPG_GAMECORE_FATEMODIFIERMASTERPHAINONCONFIG_METHOD_3_806C4925FF6FCD42_OFFSET UNITYSDK_OFFSET(0x197127C0)
#define RPG_GAMECORE_FATEMODIFIERMASTERPHAINONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19711140)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateModifierMasterPhainonConfig_TypeDefinitionIndex = 18298;
