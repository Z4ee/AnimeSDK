...
#define RPG_GAMECORE_AVATARENHANCEDSKILLROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C58B930)
#define RPG_GAMECORE_AVATARENHANCEDSKILLROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C58BE40)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID SimpleDescBefore; // 0x20
		::RPG::Client::TextID DescAfter; // 0x30
		::System::UInt32 AvatarID; // 0x40
		::System::UInt32 SkillID; // 0x44
		::RPG::Client::TextID SimpleDescAfter; // 0x48
		::RPG::Client::TextID Comment01; // 0x58
		::RPG::Client::TextID Comment02; // 0x68
		::System::UInt32 CommentIndex; // 0x78
