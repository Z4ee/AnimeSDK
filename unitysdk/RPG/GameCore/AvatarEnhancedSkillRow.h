...
#define RPG_GAMECORE_AVATARENHANCEDSKILLROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x194963B0)
#define RPG_GAMECORE_AVATARENHANCEDSKILLROW__CTOR_OFFSET UNITYSDK_OFFSET(0x194968C0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 SkillTreeID; // 0x24
		::RPG::Client::TextID SimpleDescBefore; // 0x28
		...
		::RPG::Client::TextID SimpleDescAfter; // 0x70
