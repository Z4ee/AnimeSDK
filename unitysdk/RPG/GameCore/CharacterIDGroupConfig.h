...
#define RPG_GAMECORE_CHARACTERIDGROUPCONFIG_METHOD_2_9D698FE406A73A8A_OFFSET UNITYSDK_OFFSET(0x1706D3F0)
#define RPG_GAMECORE_CHARACTERIDGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1706D510)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterIDGroupConfig_TypeDefinitionIndex = 15705;
