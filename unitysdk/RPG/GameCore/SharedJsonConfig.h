...
#define RPG_GAMECORE_SHAREDJSONCONFIG_METHOD_3_85D22C255258C41D_OFFSET UNITYSDK_OFFSET(0x18E519D0)
#define RPG_GAMECORE_SHAREDJSONCONFIG_METHOD_3_BC3909DB1B22D7E8_OFFSET UNITYSDK_OFFSET(0x18E518C0)
#define RPG_GAMECORE_SHAREDJSONCONFIG_METHOD_3_EBFA7384E69D815F_OFFSET UNITYSDK_OFFSET(0x18E51900)
#define RPG_GAMECORE_SHAREDJSONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18E518F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SharedJsonConfig_TypeDefinitionIndex = 17399;
