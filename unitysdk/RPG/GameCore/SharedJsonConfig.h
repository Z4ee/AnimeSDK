...
#define RPG_GAMECORE_SHAREDJSONCONFIG_METHOD_3_85D22C255258C41D_OFFSET UNITYSDK_OFFSET(0x19C6DF80)
#define RPG_GAMECORE_SHAREDJSONCONFIG_METHOD_3_BC3909DB1B22D7E8_OFFSET UNITYSDK_OFFSET(0x19C6DE70)
#define RPG_GAMECORE_SHAREDJSONCONFIG_METHOD_3_EBFA7384E69D815F_OFFSET UNITYSDK_OFFSET(0x19C6DEB0)
#define RPG_GAMECORE_SHAREDJSONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19C6DEA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SharedJsonConfig_TypeDefinitionIndex = 17404;
