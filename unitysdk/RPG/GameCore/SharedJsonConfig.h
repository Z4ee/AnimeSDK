...
#define RPG_GAMECORE_SHAREDJSONCONFIG_METHOD_3_85D22C255258C41D_OFFSET UNITYSDK_OFFSET(0x1BE33260)
#define RPG_GAMECORE_SHAREDJSONCONFIG_METHOD_3_BC3909DB1B22D7E8_OFFSET UNITYSDK_OFFSET(0x1BE33150)
#define RPG_GAMECORE_SHAREDJSONCONFIG_METHOD_3_EBFA7384E69D815F_OFFSET UNITYSDK_OFFSET(0x1BE33190)
#define RPG_GAMECORE_SHAREDJSONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE33180)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SharedJsonConfig_TypeDefinitionIndex = 17577;
