...
#define RPG_GAMECORE_RTTARGETMAPMOVETARGET_METHOD_3_1AFB29A9621D3A91_OFFSET UNITYSDK_OFFSET(0x1B770570)
#define RPG_GAMECORE_RTTARGETMAPMOVETARGET_METHOD_3_1F3ADD4770F9CAB5_OFFSET UNITYSDK_OFFSET(0x1B7705B0)
#define RPG_GAMECORE_RTTARGETMAPMOVETARGET_METHOD_3_289188E4B60AE2B2_OFFSET UNITYSDK_OFFSET(0x1B770470)
#define RPG_GAMECORE_RTTARGETMAPMOVETARGET_METHOD_3_5F4F61FD917EB233_OFFSET UNITYSDK_OFFSET(0x1B770510)
#define RPG_GAMECORE_RTTARGETMAPMOVETARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1B770500)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtTargetMapMoveTarget_TypeDefinitionIndex = 23397;
