...
#define RPG_GAMECORE_ENABLESELECTIONPROP_METHOD_3_33A7BE17688EDE56_OFFSET UNITYSDK_OFFSET(0x1719A020)
#define RPG_GAMECORE_ENABLESELECTIONPROP_METHOD_3_BDA4EF74477F2470_OFFSET UNITYSDK_OFFSET(0x1719A170)
#define RPG_GAMECORE_ENABLESELECTIONPROP__CTOR_OFFSET UNITYSDK_OFFSET(0x1719A0E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnableSelectionProp_TypeDefinitionIndex = 20201;
