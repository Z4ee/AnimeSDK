...
#define RPG_GAMECORE_ENABLESELECTIONPROP_METHOD_3_33A7BE17688EDE56_OFFSET UNITYSDK_OFFSET(0x188A7760)
#define RPG_GAMECORE_ENABLESELECTIONPROP_METHOD_3_BDA4EF74477F2470_OFFSET UNITYSDK_OFFSET(0x188A78B0)
#define RPG_GAMECORE_ENABLESELECTIONPROP__CTOR_OFFSET UNITYSDK_OFFSET(0x188A7820)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnableSelectionProp_TypeDefinitionIndex = 20883;
