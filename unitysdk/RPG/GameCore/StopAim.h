...
#define RPG_GAMECORE_STOPAIM_METHOD_3_58D3286A0D54A58F_OFFSET UNITYSDK_OFFSET(0x18EA2390)
#define RPG_GAMECORE_STOPAIM_METHOD_3_A0839F8F323F1694_OFFSET UNITYSDK_OFFSET(0x18EA2300)
#define RPG_GAMECORE_STOPAIM__CTOR_OFFSET UNITYSDK_OFFSET(0x18EA2360)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StopAim_TypeDefinitionIndex = 21286;
