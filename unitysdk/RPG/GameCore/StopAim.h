...
#define RPG_GAMECORE_STOPAIM_METHOD_3_58D3286A0D54A58F_OFFSET UNITYSDK_OFFSET(0x1777C5B0)
#define RPG_GAMECORE_STOPAIM_METHOD_3_A0839F8F323F1694_OFFSET UNITYSDK_OFFSET(0x1777C520)
#define RPG_GAMECORE_STOPAIM__CTOR_OFFSET UNITYSDK_OFFSET(0x1777C580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StopAim_TypeDefinitionIndex = 20602;
