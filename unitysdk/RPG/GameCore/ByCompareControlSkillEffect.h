...
#define RPG_GAMECORE_BYCOMPARECONTROLSKILLEFFECT_METHOD_4_00BA19181AD40DCE_OFFSET UNITYSDK_OFFSET(0x1CEB8E60)
#define RPG_GAMECORE_BYCOMPARECONTROLSKILLEFFECT_METHOD_4_340C239534AF1079_OFFSET UNITYSDK_OFFSET(0x1CEB90B0)
#define RPG_GAMECORE_BYCOMPARECONTROLSKILLEFFECT_METHOD_4_9EBD1F1FC25AA957_OFFSET UNITYSDK_OFFSET(0x1CEB8E20)
#define RPG_GAMECORE_BYCOMPARECONTROLSKILLEFFECT_METHOD_4_FE4D6A3081F37127_OFFSET UNITYSDK_OFFSET(0x1CEB9080)
#define RPG_GAMECORE_BYCOMPARECONTROLSKILLEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEB8E50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareControlSkillEffect_TypeDefinitionIndex = 22765;
