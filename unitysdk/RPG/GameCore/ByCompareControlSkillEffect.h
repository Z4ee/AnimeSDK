...
#define RPG_GAMECORE_BYCOMPARECONTROLSKILLEFFECT_METHOD_4_01FCC972E4DF4357_OFFSET UNITYSDK_OFFSET(0x18729470)
#define RPG_GAMECORE_BYCOMPARECONTROLSKILLEFFECT_METHOD_4_493C6555934B486B_OFFSET UNITYSDK_OFFSET(0x187293A0)
#define RPG_GAMECORE_BYCOMPARECONTROLSKILLEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x18729420)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareControlSkillEffect_TypeDefinitionIndex = 21947;
