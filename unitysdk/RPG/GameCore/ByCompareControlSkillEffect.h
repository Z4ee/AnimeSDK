...
#define RPG_GAMECORE_BYCOMPARECONTROLSKILLEFFECT_METHOD_4_00BA19181AD40DCE_OFFSET UNITYSDK_OFFSET(0x1C30FB40)
#define RPG_GAMECORE_BYCOMPARECONTROLSKILLEFFECT_METHOD_4_340C239534AF1079_OFFSET UNITYSDK_OFFSET(0x1C30FD90)
#define RPG_GAMECORE_BYCOMPARECONTROLSKILLEFFECT_METHOD_4_9EBD1F1FC25AA957_OFFSET UNITYSDK_OFFSET(0x1C30FB00)
#define RPG_GAMECORE_BYCOMPARECONTROLSKILLEFFECT_METHOD_4_FE4D6A3081F37127_OFFSET UNITYSDK_OFFSET(0x1C30FD60)
#define RPG_GAMECORE_BYCOMPARECONTROLSKILLEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C30FB30)
