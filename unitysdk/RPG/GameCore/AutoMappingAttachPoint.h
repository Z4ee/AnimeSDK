...
#define RPG_GAMECORE_AUTOMAPPINGATTACHPOINT_METHOD_3_09DEA852146E81C8_OFFSET UNITYSDK_OFFSET(0x186B62B0)
#define RPG_GAMECORE_AUTOMAPPINGATTACHPOINT_METHOD_3_26460BEED99CB61D_OFFSET UNITYSDK_OFFSET(0x186B6330)
#define RPG_GAMECORE_AUTOMAPPINGATTACHPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x186B6300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AutoMappingAttachPoint_TypeDefinitionIndex = 22150;
