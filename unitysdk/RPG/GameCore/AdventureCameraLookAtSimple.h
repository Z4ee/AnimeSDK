...
#define RPG_GAMECORE_ADVENTURECAMERALOOKATSIMPLE_METHOD_3_0C1DB8355CB0B338_OFFSET UNITYSDK_OFFSET(0x186725E0)
#define RPG_GAMECORE_ADVENTURECAMERALOOKATSIMPLE_METHOD_3_14C1AF16396BD9B4_OFFSET UNITYSDK_OFFSET(0x18672550)
#define RPG_GAMECORE_ADVENTURECAMERALOOKATSIMPLE__CTOR_OFFSET UNITYSDK_OFFSET(0x186725B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureCameraLookAtSimple_TypeDefinitionIndex = 19464;
