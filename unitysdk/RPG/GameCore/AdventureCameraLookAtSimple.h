...
#define RPG_GAMECORE_ADVENTURECAMERALOOKATSIMPLE_METHOD_3_0C1DB8355CB0B338_OFFSET UNITYSDK_OFFSET(0x1CBB4EB0)
#define RPG_GAMECORE_ADVENTURECAMERALOOKATSIMPLE_METHOD_3_48A3D98A81601FEF_OFFSET UNITYSDK_OFFSET(0x1CBB4E60)
#define RPG_GAMECORE_ADVENTURECAMERALOOKATSIMPLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CBB4EA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureCameraLookAtSimple_TypeDefinitionIndex = 20270;
