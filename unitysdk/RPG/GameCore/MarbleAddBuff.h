...
#define RPG_GAMECORE_MARBLEADDBUFF_METHOD_3_779E96715C3DC3DF_OFFSET UNITYSDK_OFFSET(0x17387250)
#define RPG_GAMECORE_MARBLEADDBUFF_METHOD_3_F8C5363280B18AF6_OFFSET UNITYSDK_OFFSET(0x17387170)
#define RPG_GAMECORE_MARBLEADDBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x17387200)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleAddBuff_TypeDefinitionIndex = 15415;
