...
#define RPG_GAMECORE_DRONESPUZZLEEVENTLISTENER_METHOD_3_3FEA10928C1A0C4C_OFFSET UNITYSDK_OFFSET(0x1DB1A6A0)
#define RPG_GAMECORE_DRONESPUZZLEEVENTLISTENER_METHOD_3_8FC9C3FE97E454EA_OFFSET UNITYSDK_OFFSET(0x1DB1A6E0)
#define RPG_GAMECORE_DRONESPUZZLEEVENTLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB1A6D0)
