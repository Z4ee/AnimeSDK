...
#define RPG_GAMECORE_DRONESPUZZLEEVENTLISTENER_METHOD_3_5C68D4E25F4480CC_OFFSET UNITYSDK_OFFSET(0x17183030)
#define RPG_GAMECORE_DRONESPUZZLEEVENTLISTENER_METHOD_3_F0030FC401D8C964_OFFSET UNITYSDK_OFFSET(0x17182FB0)
#define RPG_GAMECORE_DRONESPUZZLEEVENTLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x17183000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DronesPuzzleEventListener_TypeDefinitionIndex = 18666;
