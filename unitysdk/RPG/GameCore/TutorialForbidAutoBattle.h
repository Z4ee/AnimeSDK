...
#define RPG_GAMECORE_TUTORIALFORBIDAUTOBATTLE_METHOD_3_82179E11888F8BA8_OFFSET UNITYSDK_OFFSET(0x1B069B90)
#define RPG_GAMECORE_TUTORIALFORBIDAUTOBATTLE_METHOD_3_AE04DC23BE757C7B_OFFSET UNITYSDK_OFFSET(0x1B069BD0)
#define RPG_GAMECORE_TUTORIALFORBIDAUTOBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B069BC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TutorialForbidAutoBattle_TypeDefinitionIndex = 23461;
