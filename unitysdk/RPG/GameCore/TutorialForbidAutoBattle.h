...
#define RPG_GAMECORE_TUTORIALFORBIDAUTOBATTLE_METHOD_3_003546BE79ABA412_OFFSET UNITYSDK_OFFSET(0x190D6E40)
#define RPG_GAMECORE_TUTORIALFORBIDAUTOBATTLE_METHOD_3_AE04DC23BE757C7B_OFFSET UNITYSDK_OFFSET(0x190D6EC0)
#define RPG_GAMECORE_TUTORIALFORBIDAUTOBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x190D6E90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TutorialForbidAutoBattle_TypeDefinitionIndex = 23327;
