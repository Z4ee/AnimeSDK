...
#define RPG_GAMECORE_TARGETFETCHADVTEAMLEADER_METHOD_4_45348A4E122BC312_OFFSET UNITYSDK_OFFSET(0x177BC8A0)
#define RPG_GAMECORE_TARGETFETCHADVTEAMLEADER_METHOD_4_66AF6F25CADE5FD5_OFFSET UNITYSDK_OFFSET(0x177BC700)
#define RPG_GAMECORE_TARGETFETCHADVTEAMLEADER__CTOR_OFFSET UNITYSDK_OFFSET(0x177BC850)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchAdvTeamLeader_TypeDefinitionIndex = 22129;
