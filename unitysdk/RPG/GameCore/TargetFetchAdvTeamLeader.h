...
#define RPG_GAMECORE_TARGETFETCHADVTEAMLEADER_METHOD_4_2AE73EC246B2F8A8_OFFSET UNITYSDK_OFFSET(0x1D0B6240)
#define RPG_GAMECORE_TARGETFETCHADVTEAMLEADER_METHOD_4_45348A4E122BC312_OFFSET UNITYSDK_OFFSET(0x1D0B6150)
#define RPG_GAMECORE_TARGETFETCHADVTEAMLEADER_METHOD_4_BCE3B25AF1A3FC51_OFFSET UNITYSDK_OFFSET(0x1D0B6210)
#define RPG_GAMECORE_TARGETFETCHADVTEAMLEADER_METHOD_4_CC9D11AD4123FD8F_OFFSET UNITYSDK_OFFSET(0x1D0B6070)
#define RPG_GAMECORE_TARGETFETCHADVTEAMLEADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0B6140)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchAdvTeamLeader_TypeDefinitionIndex = 23010;
