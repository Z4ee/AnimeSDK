...
#define RPG_GAMECORE_AITASKTARGETTYPESELECTOR_METHOD_3_743F9A6C1BBE14AE_OFFSET UNITYSDK_OFFSET(0x1D324EE0)
#define RPG_GAMECORE_AITASKTARGETTYPESELECTOR_METHOD_3_7B76DD661EC62FA1_OFFSET UNITYSDK_OFFSET(0x1D3246E0)
#define RPG_GAMECORE_AITASKTARGETTYPESELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3246D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AITaskTargetTypeSelector_TypeDefinitionIndex = 15422;
