...
#define RPG_GAMECORE_AITASKTARGETTYPESELECTOR_METHOD_3_743F9A6C1BBE14AE_OFFSET UNITYSDK_OFFSET(0x185F2940)
#define RPG_GAMECORE_AITASKTARGETTYPESELECTOR_METHOD_3_7B76DD661EC62FA1_OFFSET UNITYSDK_OFFSET(0x185F2210)
#define RPG_GAMECORE_AITASKTARGETTYPESELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x185F2200)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AITaskTargetTypeSelector_TypeDefinitionIndex = 14759;
