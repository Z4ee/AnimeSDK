...
#define RPG_GAMECORE_ROGUEADVENTUREROOMHUDPARAM_GET_HINTPARAM_OFFSET UNITYSDK_OFFSET(0xE6D9BF0)
#define RPG_GAMECORE_ROGUEADVENTUREROOMHUDPARAM_GET_ROOMINFO_OFFSET UNITYSDK_OFFSET(0xE6D9C30)
#define RPG_GAMECORE_ROGUEADVENTUREROOMHUDPARAM_GET_TARGETPARAM_OFFSET UNITYSDK_OFFSET(0xE6D9C10)
#define RPG_GAMECORE_ROGUEADVENTUREROOMHUDPARAM_SET_HINTPARAM_OFFSET UNITYSDK_OFFSET(0xE6D9C00)
#define RPG_GAMECORE_ROGUEADVENTUREROOMHUDPARAM_SET_ROOMINFO_OFFSET UNITYSDK_OFFSET(0xE6D9C40)
#define RPG_GAMECORE_ROGUEADVENTUREROOMHUDPARAM_SET_TARGETPARAM_OFFSET UNITYSDK_OFFSET(0xE6D9C20)
#define RPG_GAMECORE_ROGUEADVENTUREROOMHUDPARAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0xE6D9C60)
#define RPG_GAMECORE_ROGUEADVENTUREROOMHUDPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xE6D9C50)
