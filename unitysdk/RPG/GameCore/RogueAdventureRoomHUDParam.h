...
#define RPG_GAMECORE_ROGUEADVENTUREROOMHUDPARAM_GET_HINTPARAM_OFFSET UNITYSDK_OFFSET(0x127C4890)
#define RPG_GAMECORE_ROGUEADVENTUREROOMHUDPARAM_GET_ROOMINFO_OFFSET UNITYSDK_OFFSET(0x127C48D0)
#define RPG_GAMECORE_ROGUEADVENTUREROOMHUDPARAM_GET_TARGETPARAM_OFFSET UNITYSDK_OFFSET(0x127C48B0)
#define RPG_GAMECORE_ROGUEADVENTUREROOMHUDPARAM_SET_HINTPARAM_OFFSET UNITYSDK_OFFSET(0x127C48A0)
#define RPG_GAMECORE_ROGUEADVENTUREROOMHUDPARAM_SET_ROOMINFO_OFFSET UNITYSDK_OFFSET(0x127C48E0)
#define RPG_GAMECORE_ROGUEADVENTUREROOMHUDPARAM_SET_TARGETPARAM_OFFSET UNITYSDK_OFFSET(0x127C48C0)
#define RPG_GAMECORE_ROGUEADVENTUREROOMHUDPARAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x127C4900)
#define RPG_GAMECORE_ROGUEADVENTUREROOMHUDPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x127C48F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueAdventureRoomHUDParam_TypeDefinitionIndex = 55834;
