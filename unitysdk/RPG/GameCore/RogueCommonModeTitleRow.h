...
#define RPG_GAMECORE_ROGUECOMMONMODETITLEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C4AE300)
#define RPG_GAMECORE_ROGUECOMMONMODETITLEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4AE920)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueCommonModeTitleRow_TypeDefinitionIndex = 14095;
