...
#define RPG_GAMECORE_ENABLEROLETRIALCHANGELINEUPLEADER_METHOD_3_DCB339A7FFF3920D_OFFSET UNITYSDK_OFFSET(0x188A7460)
#define RPG_GAMECORE_ENABLEROLETRIALCHANGELINEUPLEADER_METHOD_3_E75CC6E6AEFCAD7C_OFFSET UNITYSDK_OFFSET(0x188A73E0)
#define RPG_GAMECORE_ENABLEROLETRIALCHANGELINEUPLEADER__CTOR_OFFSET UNITYSDK_OFFSET(0x188A7430)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnableRoleTrialChangeLineupLeader_TypeDefinitionIndex = 22845;
