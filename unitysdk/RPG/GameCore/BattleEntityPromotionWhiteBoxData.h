...
#define RPG_GAMECORE_BATTLEENTITYPROMOTIONWHITEBOXDATA_METHOD_2_285D300A878863CE_OFFSET UNITYSDK_OFFSET(0x1A3E6A50)
#define RPG_GAMECORE_BATTLEENTITYPROMOTIONWHITEBOXDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3E76A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleEntityPromotionWhiteBoxData_TypeDefinitionIndex = 21933;
