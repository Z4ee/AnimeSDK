...
#define RPG_GAMECORE_BATTLEENTITYPROMOTIONWHITEBOXDATA_METHOD_2_285D300A878863CE_OFFSET UNITYSDK_OFFSET(0x1CE6E420)
#define RPG_GAMECORE_BATTLEENTITYPROMOTIONWHITEBOXDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE6F070)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleEntityPromotionWhiteBoxData_TypeDefinitionIndex = 22497;
