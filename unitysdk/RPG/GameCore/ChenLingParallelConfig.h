...
#define RPG_GAMECORE_CHENLINGPARALLELCONFIG_METHOD_3_11D5648AEF8D8117_OFFSET UNITYSDK_OFFSET(0x187ECF20)
#define RPG_GAMECORE_CHENLINGPARALLELCONFIG_METHOD_3_FC888D44089710D7_OFFSET UNITYSDK_OFFSET(0x187ECEC0)
#define RPG_GAMECORE_CHENLINGPARALLELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x187ECF10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingParallelConfig_TypeDefinitionIndex = 14978;
