...
#define RPG_GAMECORE_CHENLINGPARALLELCONFIG_METHOD_3_2DC7C1944B07266A_OFFSET UNITYSDK_OFFSET(0x1CFB7B00)
#define RPG_GAMECORE_CHENLINGPARALLELCONFIG_METHOD_3_A7B165D39AE8F1C2_OFFSET UNITYSDK_OFFSET(0x1CFB7B60)
#define RPG_GAMECORE_CHENLINGPARALLELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFB7B50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingParallelConfig_TypeDefinitionIndex = 15642;
