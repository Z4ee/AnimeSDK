...
#define RPG_GAMECORE_STATETREESTATECONFIG_METHOD_3_06851D487CADA37E_OFFSET UNITYSDK_OFFSET(0x1B0C05D0)
#define RPG_GAMECORE_STATETREESTATECONFIG_METHOD_3_FE5B10BEB467818F_OFFSET UNITYSDK_OFFSET(0x1B0C00B0)
#define RPG_GAMECORE_STATETREESTATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0C00A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StateTreeStateConfig_TypeDefinitionIndex = 14890;
