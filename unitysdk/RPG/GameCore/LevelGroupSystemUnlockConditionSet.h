...
#define RPG_GAMECORE_LEVELGROUPSYSTEMUNLOCKCONDITIONSET_METHOD_2_502C92A4B7CCBBDF_OFFSET UNITYSDK_OFFSET(0x1D1D4AE0)
#define RPG_GAMECORE_LEVELGROUPSYSTEMUNLOCKCONDITIONSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1D5A40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelGroupSystemUnlockConditionSet_TypeDefinitionIndex = 17016;
