...
#define RPG_GAMECORE_LEVELGROUPSYSTEMUNLOCKCONDITIONSET_METHOD_2_4611ACB31B72FE5D_OFFSET UNITYSDK_OFFSET(0x173395A0)
#define RPG_GAMECORE_LEVELGROUPSYSTEMUNLOCKCONDITIONSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1733A650)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelGroupSystemUnlockConditionSet_TypeDefinitionIndex = 15804;
