...
#define RPG_GAMECORE_EXPEDITIONBATTLERESETALLMONSTERSTATEACTION_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1D082470)
#define RPG_GAMECORE_EXPEDITIONBATTLERESETALLMONSTERSTATEACTION_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D0823D0)
#define RPG_GAMECORE_EXPEDITIONBATTLERESETALLMONSTERSTATEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D082460)
