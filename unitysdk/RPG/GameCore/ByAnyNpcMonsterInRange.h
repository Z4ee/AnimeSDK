...
#define RPG_GAMECORE_BYANYNPCMONSTERINRANGE_METHOD_4_6F42AB6CE87FBF84_OFFSET UNITYSDK_OFFSET(0x16FFAAC0)
#define RPG_GAMECORE_BYANYNPCMONSTERINRANGE_METHOD_4_90A929A474B69134_OFFSET UNITYSDK_OFFSET(0x16FFAB90)
#define RPG_GAMECORE_BYANYNPCMONSTERINRANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x16FFAB40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByAnyNpcMonsterInRange_TypeDefinitionIndex = 18890;
