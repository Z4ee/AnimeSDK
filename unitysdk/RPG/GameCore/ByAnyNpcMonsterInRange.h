...
#define RPG_GAMECORE_BYANYNPCMONSTERINRANGE_METHOD_4_485C22311D5E4496_OFFSET UNITYSDK_OFFSET(0x19CBBE10)
#define RPG_GAMECORE_BYANYNPCMONSTERINRANGE_METHOD_4_90A929A474B69134_OFFSET UNITYSDK_OFFSET(0x19CBBBF0)
#define RPG_GAMECORE_BYANYNPCMONSTERINRANGE_METHOD_4_981B7FAF26E5F119_OFFSET UNITYSDK_OFFSET(0x19CBBBB0)
#define RPG_GAMECORE_BYANYNPCMONSTERINRANGE_METHOD_4_C2C82EC590976789_OFFSET UNITYSDK_OFFSET(0x19CBBE40)
#define RPG_GAMECORE_BYANYNPCMONSTERINRANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x19CBBBE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByAnyNpcMonsterInRange_TypeDefinitionIndex = 19798;
