...
#define RPG_GAMECORE_BINDTIMEREWINDCONTROLLER_METHOD_3_396CCE7507433FB4_OFFSET UNITYSDK_OFFSET(0x1870ADA0)
#define RPG_GAMECORE_BINDTIMEREWINDCONTROLLER_METHOD_3_9E969411FB557A31_OFFSET UNITYSDK_OFFSET(0x1870AE20)
#define RPG_GAMECORE_BINDTIMEREWINDCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1870ADF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BindTimeRewindController_TypeDefinitionIndex = 19618;
