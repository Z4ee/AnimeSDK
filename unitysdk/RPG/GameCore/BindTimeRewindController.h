...
#define RPG_GAMECORE_BINDTIMEREWINDCONTROLLER_METHOD_3_308DC42D63389BDB_OFFSET UNITYSDK_OFFSET(0x1A3FDFB0)
#define RPG_GAMECORE_BINDTIMEREWINDCONTROLLER_METHOD_3_689E39394DAE4803_OFFSET UNITYSDK_OFFSET(0x1A3FDFF0)
#define RPG_GAMECORE_BINDTIMEREWINDCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3FDFE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BindTimeRewindController_TypeDefinitionIndex = 19863;
