...
#define RPG_GAMECORE_ROGUECURSECHESTPROPINTERACT_METHOD_3_72D11B0E42E6EF95_OFFSET UNITYSDK_OFFSET(0x1C4AF210)
#define RPG_GAMECORE_ROGUECURSECHESTPROPINTERACT_METHOD_3_B2FDA26161451908_OFFSET UNITYSDK_OFFSET(0x1C4AF1D0)
#define RPG_GAMECORE_ROGUECURSECHESTPROPINTERACT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4AF200)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueCurseChestPropInteract_TypeDefinitionIndex = 21293;
