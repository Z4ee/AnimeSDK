...
#define RPG_GAMECORE_TARGETFETCHADVMONSTER_METHOD_4_02586BC9E3AADBDC_OFFSET UNITYSDK_OFFSET(0x1D0B2EF0)
#define RPG_GAMECORE_TARGETFETCHADVMONSTER_METHOD_4_6372B9CA3C3EB1FB_OFFSET UNITYSDK_OFFSET(0x1D0B2FE0)
#define RPG_GAMECORE_TARGETFETCHADVMONSTER_METHOD_4_BD40DF076475D919_OFFSET UNITYSDK_OFFSET(0x1D0B3030)
#define RPG_GAMECORE_TARGETFETCHADVMONSTER_METHOD_4_D03961D8019D9ECC_OFFSET UNITYSDK_OFFSET(0x1D0B2E90)
#define RPG_GAMECORE_TARGETFETCHADVMONSTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0B2EE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchAdvMonster_TypeDefinitionIndex = 23016;
