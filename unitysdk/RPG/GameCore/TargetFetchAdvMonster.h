...
#define RPG_GAMECORE_TARGETFETCHADVMONSTER_METHOD_4_47CB997EA4C4963A_OFFSET UNITYSDK_OFFSET(0x177BB060)
#define RPG_GAMECORE_TARGETFETCHADVMONSTER_METHOD_4_8C463A72F015C751_OFFSET UNITYSDK_OFFSET(0x177BB140)
#define RPG_GAMECORE_TARGETFETCHADVMONSTER__CTOR_OFFSET UNITYSDK_OFFSET(0x177BB0F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchAdvMonster_TypeDefinitionIndex = 22135;
