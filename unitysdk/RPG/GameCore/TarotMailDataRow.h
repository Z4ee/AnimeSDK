...
#define RPG_GAMECORE_TAROTMAILDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19D328D0)
#define RPG_GAMECORE_TAROTMAILDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19D32C30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TarotMailDataRow_TypeDefinitionIndex = 14482;
	...
	public:
		...
		::RPG::Client::TextID To; // 0x20
		::RPG::Client::TextID Title; // 0x30
		::RPG::Client::TextID From; // 0x40
