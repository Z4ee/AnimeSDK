...
#define RPG_GAMECORE_ACTIONPOINTOVERDRAWROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x193CDAB0)
#define RPG_GAMECORE_ACTIONPOINTOVERDRAWROW__CTOR_OFFSET UNITYSDK_OFFSET(0x193CE0C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActionPointOverdrawRow_TypeDefinitionIndex = 14056;
