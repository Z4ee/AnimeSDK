...
#define RPG_GAMECORE_BYCOMPAREGPWITHGP_METHOD_4_35533B5561424EE2_OFFSET UNITYSDK_OFFSET(0x1872DFC0)
#define RPG_GAMECORE_BYCOMPAREGPWITHGP_METHOD_4_BFB9F6C35F78F334_OFFSET UNITYSDK_OFFSET(0x1872E0A0)
#define RPG_GAMECORE_BYCOMPAREGPWITHGP__CTOR_OFFSET UNITYSDK_OFFSET(0x1872E040)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareGPwithGP_TypeDefinitionIndex = 19396;
