...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONAROOMCARDNOTKONGCONFIG_METHOD_3_BD826A02472B94A3_OFFSET UNITYSDK_OFFSET(0x1EEF9410)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONAROOMCARDNOTKONGCONFIG_METHOD_3_E2C34E9EACA28B27_OFFSET UNITYSDK_OFFSET(0x1EEF9460)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONAROOMCARDNOTKONGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEF9450)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnPersonaRoomCardNotKongConfig_TypeDefinitionIndex = 17650;
