...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONAROOMCARDNOTKONGCONFIG_METHOD_3_1CAED824747221AE_OFFSET UNITYSDK_OFFSET(0x18D3DE10)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONAROOMCARDNOTKONGCONFIG_METHOD_3_E2C34E9EACA28B27_OFFSET UNITYSDK_OFFSET(0x18D3DEE0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONAROOMCARDNOTKONGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D3DE90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnPersonaRoomCardNotKongConfig_TypeDefinitionIndex = 16959;
