...
#define RPG_GAMECORE_CHIMERADUELSTATUSEFFECTPARAM_METHOD_3_1B9DED232613887E_OFFSET UNITYSDK_OFFSET(0x1CFCF380)
#define RPG_GAMECORE_CHIMERADUELSTATUSEFFECTPARAM_METHOD_3_BD65E4F31A9D2E06_OFFSET UNITYSDK_OFFSET(0x1CFCF320)
#define RPG_GAMECORE_CHIMERADUELSTATUSEFFECTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFCF370)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelStatusEffectParam_TypeDefinitionIndex = 15838;
