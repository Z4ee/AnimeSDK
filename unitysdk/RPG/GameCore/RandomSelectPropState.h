...
#define RPG_GAMECORE_RANDOMSELECTPROPSTATE_METHOD_3_1F5690FE5185FF0D_OFFSET UNITYSDK_OFFSET(0x17580F30)
#define RPG_GAMECORE_RANDOMSELECTPROPSTATE_METHOD_3_A3FAE66E1C70220C_OFFSET UNITYSDK_OFFSET(0x17580FB0)
#define RPG_GAMECORE_RANDOMSELECTPROPSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x17580F80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RandomSelectPropState_TypeDefinitionIndex = 20427;
