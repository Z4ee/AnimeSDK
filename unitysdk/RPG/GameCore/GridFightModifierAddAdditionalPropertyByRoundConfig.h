...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDADDITIONALPROPERTYBYROUNDCONFIG_METHOD_3_56D9E0E23E601EF9_OFFSET UNITYSDK_OFFSET(0x1725FC30)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDADDITIONALPROPERTYBYROUNDCONFIG_METHOD_3_ECD2CF590677AC50_OFFSET UNITYSDK_OFFSET(0x1725FD00)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDADDITIONALPROPERTYBYROUNDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1725FCB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierAddAdditionalPropertyByRoundConfig_TypeDefinitionIndex = 17795;
