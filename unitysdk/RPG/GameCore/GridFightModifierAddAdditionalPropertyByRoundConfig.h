...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDADDITIONALPROPERTYBYROUNDCONFIG_METHOD_3_D08684E1532CF654_OFFSET UNITYSDK_OFFSET(0x1EE6BEB0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDADDITIONALPROPERTYBYROUNDCONFIG_METHOD_3_ECD2CF590677AC50_OFFSET UNITYSDK_OFFSET(0x1EE6BF00)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDADDITIONALPROPERTYBYROUNDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EE6BEF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierAddAdditionalPropertyByRoundConfig_TypeDefinitionIndex = 19155;
