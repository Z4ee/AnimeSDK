...
#define RPG_GAMECORE_FIVEDIMTRIGGEREVENTNEXTBEATACTION_METHOD_3_E1277D2DA2D826C4_OFFSET UNITYSDK_OFFSET(0x1BEB8200)
#define RPG_GAMECORE_FIVEDIMTRIGGEREVENTNEXTBEATACTION_METHOD_3_E7215ACB2DF8A34B_OFFSET UNITYSDK_OFFSET(0x1BEB8250)
#define RPG_GAMECORE_FIVEDIMTRIGGEREVENTNEXTBEATACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEB8240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimTriggerEventNextBeatAction_TypeDefinitionIndex = 17980;
