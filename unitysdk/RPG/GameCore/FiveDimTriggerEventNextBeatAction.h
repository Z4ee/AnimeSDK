...
#define RPG_GAMECORE_FIVEDIMTRIGGEREVENTNEXTBEATACTION_METHOD_3_4C21F85826AE265E_OFFSET UNITYSDK_OFFSET(0x18923180)
#define RPG_GAMECORE_FIVEDIMTRIGGEREVENTNEXTBEATACTION_METHOD_3_E7215ACB2DF8A34B_OFFSET UNITYSDK_OFFSET(0x189231F0)
#define RPG_GAMECORE_FIVEDIMTRIGGEREVENTNEXTBEATACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x189231D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimTriggerEventNextBeatAction_TypeDefinitionIndex = 17777;
