...
#define RPG_GAMECORE_CHENLINGSTAGEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1E01B900)
#define RPG_GAMECORE_CHENLINGSTAGEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1E01BD00)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 FinishUnlockDeckID; // 0x40
