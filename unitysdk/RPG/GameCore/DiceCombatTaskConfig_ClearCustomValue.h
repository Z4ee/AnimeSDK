...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_CLEARCUSTOMVALUE_METHOD_3_C0AFC7B146B5F61B_OFFSET UNITYSDK_OFFSET(0x1D0353E0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_CLEARCUSTOMVALUE_METHOD_3_FFD97C1D3E63E545_OFFSET UNITYSDK_OFFSET(0x1D035380)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_CLEARCUSTOMVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0353D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_ClearCustomValue_TypeDefinitionIndex = 15893;
