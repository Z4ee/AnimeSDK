...
#define RPG_GAMECORE_MINIGAMEHUNDREDFLOORCONFIG_METHOD_3_9D277892E91B74D6_OFFSET UNITYSDK_OFFSET(0x1D1A5EF0)
#define RPG_GAMECORE_MINIGAMEHUNDREDFLOORCONFIG_METHOD_3_EEFA63B326F57326_OFFSET UNITYSDK_OFFSET(0x1D1A5E80)
#define RPG_GAMECORE_MINIGAMEHUNDREDFLOORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1A5ED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MiniGameHundredFloorConfig_TypeDefinitionIndex = 18602;
