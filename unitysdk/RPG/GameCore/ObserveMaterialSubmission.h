...
#define RPG_GAMECORE_OBSERVEMATERIALSUBMISSION_METHOD_3_0952501E522A47D1_OFFSET UNITYSDK_OFFSET(0x18BC2B30)
#define RPG_GAMECORE_OBSERVEMATERIALSUBMISSION_METHOD_3_C514CD9E1480042E_OFFSET UNITYSDK_OFFSET(0x18BC2AB0)
#define RPG_GAMECORE_OBSERVEMATERIALSUBMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x18BC2B00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ObserveMaterialSubmission_TypeDefinitionIndex = 20222;
