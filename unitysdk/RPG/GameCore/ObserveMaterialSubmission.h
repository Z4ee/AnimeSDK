...
#define RPG_GAMECORE_OBSERVEMATERIALSUBMISSION_METHOD_3_D058D5EADB8070DF_OFFSET UNITYSDK_OFFSET(0x1CE94590)
#define RPG_GAMECORE_OBSERVEMATERIALSUBMISSION_METHOD_3_D503405E715D4FB2_OFFSET UNITYSDK_OFFSET(0x1CE94550)
#define RPG_GAMECORE_OBSERVEMATERIALSUBMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE94580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ObserveMaterialSubmission_TypeDefinitionIndex = 21003;
