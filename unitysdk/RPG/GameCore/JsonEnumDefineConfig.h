...
#define RPG_GAMECORE_JSONENUMDEFINECONFIG_METHOD_2_01A509E4ECE1D48E_OFFSET UNITYSDK_OFFSET(0x1732A510)
#define RPG_GAMECORE_JSONENUMDEFINECONFIG_METHOD_2_21CCF64DF4537C51_OFFSET UNITYSDK_OFFSET(0x17329990)
#define RPG_GAMECORE_JSONENUMDEFINECONFIG_METHOD_2_2BA22A36D9531E3B_OFFSET UNITYSDK_OFFSET(0x1732A5A0)
#define RPG_GAMECORE_JSONENUMDEFINECONFIG_METHOD_2_68C421496E2EDEFA_OFFSET UNITYSDK_OFFSET(0x17329380)
#define RPG_GAMECORE_JSONENUMDEFINECONFIG_METHOD_2_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x1732A4A0)
#define RPG_GAMECORE_JSONENUMDEFINECONFIG_METHOD_2_9F0F8384D37C2928_OFFSET UNITYSDK_OFFSET(0x1732A100)
#define RPG_GAMECORE_JSONENUMDEFINECONFIG_METHOD_2_A5058F1AD6A80A4F_OFFSET UNITYSDK_OFFSET(0x1732A250)
#define RPG_GAMECORE_JSONENUMDEFINECONFIG_METHOD_2_B8FB6B3CC6BD8AED_OFFSET UNITYSDK_OFFSET(0x1732A640)
#define RPG_GAMECORE_JSONENUMDEFINECONFIG_METHOD_2_E25FE014C1FEE4E2_OFFSET UNITYSDK_OFFSET(0x1732A4B0)
#define RPG_GAMECORE_JSONENUMDEFINECONFIG_METHOD_2_F08A2AF4B0963EB9_OFFSET UNITYSDK_OFFSET(0x173295F0)
#define RPG_GAMECORE_JSONENUMDEFINECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1732A240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int JsonEnumDefineConfig_TypeDefinitionIndex = 15689;
