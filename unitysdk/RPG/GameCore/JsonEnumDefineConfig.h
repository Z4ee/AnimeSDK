...
#define RPG_GAMECORE_JSONENUMDEFINECONFIG_METHOD_2_12997AFD45AE7923_OFFSET UNITYSDK_OFFSET(0x1B0286A0)
#define RPG_GAMECORE_JSONENUMDEFINECONFIG_METHOD_2_2BA22A36D9531E3B_OFFSET UNITYSDK_OFFSET(0x1B0295A0)
#define RPG_GAMECORE_JSONENUMDEFINECONFIG_METHOD_2_68C421496E2EDEFA_OFFSET UNITYSDK_OFFSET(0x1B028430)
#define RPG_GAMECORE_JSONENUMDEFINECONFIG_METHOD_2_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x1B029490)
#define RPG_GAMECORE_JSONENUMDEFINECONFIG_METHOD_2_A439E60FBFA4B14E_OFFSET UNITYSDK_OFFSET(0x1B029200)
#define RPG_GAMECORE_JSONENUMDEFINECONFIG_METHOD_2_A5058F1AD6A80A4F_OFFSET UNITYSDK_OFFSET(0x1B0292F0)
#define RPG_GAMECORE_JSONENUMDEFINECONFIG_METHOD_2_ADCB29474514FC0C_OFFSET UNITYSDK_OFFSET(0x1B028A90)
#define RPG_GAMECORE_JSONENUMDEFINECONFIG_METHOD_2_B8FB6B3CC6BD8AED_OFFSET UNITYSDK_OFFSET(0x1B029630)
#define RPG_GAMECORE_JSONENUMDEFINECONFIG_METHOD_2_E27F297ED141A364_OFFSET UNITYSDK_OFFSET(0x1B0294F0)
#define RPG_GAMECORE_JSONENUMDEFINECONFIG_METHOD_2_ECBA4B72F2593D16_OFFSET UNITYSDK_OFFSET(0x1B0294A0)
#define RPG_GAMECORE_JSONENUMDEFINECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0292E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int JsonEnumDefineConfig_TypeDefinitionIndex = 16439;
