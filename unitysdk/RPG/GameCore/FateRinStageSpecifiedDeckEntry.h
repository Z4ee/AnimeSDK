...
#define RPG_GAMECORE_FATERINSTAGESPECIFIEDDECKENTRY_METHOD_2_2D16921CD1DBE096_OFFSET UNITYSDK_OFFSET(0x1BA77290)
#define RPG_GAMECORE_FATERINSTAGESPECIFIEDDECKENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA77430)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateRinStageSpecifiedDeckEntry_TypeDefinitionIndex = 17422;
