...
#define RPG_GAMECORE_CHANGEMECHANISMBARVALUE_METHOD_3_8A3FB8E3153A894F_OFFSET UNITYSDK_OFFSET(0x187C8640)
#define RPG_GAMECORE_CHANGEMECHANISMBARVALUE_METHOD_3_FC5651F2DCFA31B8_OFFSET UNITYSDK_OFFSET(0x187C85C0)
#define RPG_GAMECORE_CHANGEMECHANISMBARVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x187C8610)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChangeMechanismBarValue_TypeDefinitionIndex = 19482;
