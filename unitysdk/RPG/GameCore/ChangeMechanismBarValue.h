...
#define RPG_GAMECORE_CHANGEMECHANISMBARVALUE_METHOD_3_59F0D2C66EFE9E4E_OFFSET UNITYSDK_OFFSET(0x1CF8D520)
#define RPG_GAMECORE_CHANGEMECHANISMBARVALUE_METHOD_3_8A3FB8E3153A894F_OFFSET UNITYSDK_OFFSET(0x1CF8D560)
#define RPG_GAMECORE_CHANGEMECHANISMBARVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF8D550)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChangeMechanismBarValue_TypeDefinitionIndex = 20287;
