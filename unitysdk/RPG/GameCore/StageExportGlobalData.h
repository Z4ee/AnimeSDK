...
#define RPG_GAMECORE_STAGEEXPORTGLOBALDATA_METHOD_2_71CD38E1E561950B_OFFSET UNITYSDK_OFFSET(0x1B0AF460)
#define RPG_GAMECORE_STAGEEXPORTGLOBALDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0AF4A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StageExportGlobalData_TypeDefinitionIndex = 18392;
