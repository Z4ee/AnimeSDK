...
#define RPG_GAMECORE_COMPLEXSKILLAIPOSTPROCESSCLAMP_METHOD_3_34DCE66C636C1B89_OFFSET UNITYSDK_OFFSET(0x1D9AA500)
#define RPG_GAMECORE_COMPLEXSKILLAIPOSTPROCESSCLAMP_METHOD_3_AC880BC480729C4A_OFFSET UNITYSDK_OFFSET(0x1D9AA010)
#define RPG_GAMECORE_COMPLEXSKILLAIPOSTPROCESSCLAMP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D9AA000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAIPostProcessClamp_TypeDefinitionIndex = 15389;
