...
#define RPG_GAMECORE_COMPLEXSKILLAIPOSTPROCESSCLAMP_METHOD_3_34DCE66C636C1B89_OFFSET UNITYSDK_OFFSET(0x1BC263D0)
#define RPG_GAMECORE_COMPLEXSKILLAIPOSTPROCESSCLAMP_METHOD_3_AC880BC480729C4A_OFFSET UNITYSDK_OFFSET(0x1BC25EE0)
#define RPG_GAMECORE_COMPLEXSKILLAIPOSTPROCESSCLAMP__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC25ED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAIPostProcessClamp_TypeDefinitionIndex = 14953;
