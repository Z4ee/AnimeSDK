...
#define RPG_GAMECORE_COMPLEXSKILLAISOURCESKILLPROPERTYVALUE_METHOD_3_0D399A5573F48198_OFFSET UNITYSDK_OFFSET(0x19670170)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCESKILLPROPERTYVALUE_METHOD_3_CCF9C4FED467B014_OFFSET UNITYSDK_OFFSET(0x1966E8F0)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCESKILLPROPERTYVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1966E8D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAISourceSkillPropertyValue_TypeDefinitionIndex = 14768;
