...
#define RPG_GAMECORE_SETMODIFIERVALUEBYBEHAVIORFLAG_METHOD_3_909069C9F4498428_OFFSET UNITYSDK_OFFSET(0x1D506CC0)
#define RPG_GAMECORE_SETMODIFIERVALUEBYBEHAVIORFLAG_METHOD_3_A62DD75CCE8C61F3_OFFSET UNITYSDK_OFFSET(0x1D506BC0)
#define RPG_GAMECORE_SETMODIFIERVALUEBYBEHAVIORFLAG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D506C50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetModifierValueByBehaviorFlag_TypeDefinitionIndex = 22821;
