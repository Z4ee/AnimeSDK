...
#define RPG_GAMECORE_MONOPOLYRAISECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B1BE6A0)
#define RPG_GAMECORE_MONOPOLYRAISECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1BED00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonopolyRaiseConfigRow_TypeDefinitionIndex = 11601;
