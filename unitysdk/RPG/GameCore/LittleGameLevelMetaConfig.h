...
#define RPG_GAMECORE_LITTLEGAMELEVELMETACONFIG_METHOD_2_E44174D0E0A92B9B_OFFSET UNITYSDK_OFFSET(0x1DD6B8B0)
#define RPG_GAMECORE_LITTLEGAMELEVELMETACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD6B8F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameLevelMetaConfig_TypeDefinitionIndex = 18701;
