...
#define RPG_GAMECORE_LITTLEGAMELEVELMETACONFIG_METHOD_2_E44174D0E0A92B9B_OFFSET UNITYSDK_OFFSET(0x18A6C550)
#define RPG_GAMECORE_LITTLEGAMELEVELMETACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18A6C590)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameLevelMetaConfig_TypeDefinitionIndex = 17966;
