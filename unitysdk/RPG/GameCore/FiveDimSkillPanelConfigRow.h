...
#define RPG_GAMECORE_FIVEDIMSKILLPANELCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1720BC60)
#define RPG_GAMECORE_FIVEDIMSKILLPANELCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1720C1F0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::FiveDimPanelSkillType Type; // 0x38
