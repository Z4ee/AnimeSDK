...
#define RPG_GAMECORE_SETDAMAGESHAREDTARGET_METHOD_3_027287D6B01442BF_OFFSET UNITYSDK_OFFSET(0x176B1380)
#define RPG_GAMECORE_SETDAMAGESHAREDTARGET_METHOD_3_A6FA110420B7C612_OFFSET UNITYSDK_OFFSET(0x176B1430)
#define RPG_GAMECORE_SETDAMAGESHAREDTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x176B13F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDamageSharedTarget_TypeDefinitionIndex = 21021;
