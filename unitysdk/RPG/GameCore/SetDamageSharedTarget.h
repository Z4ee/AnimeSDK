...
#define RPG_GAMECORE_SETDAMAGESHAREDTARGET_METHOD_3_027287D6B01442BF_OFFSET UNITYSDK_OFFSET(0x18E13CA0)
#define RPG_GAMECORE_SETDAMAGESHAREDTARGET_METHOD_3_A6FA110420B7C612_OFFSET UNITYSDK_OFFSET(0x18E13D50)
#define RPG_GAMECORE_SETDAMAGESHAREDTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x18E13D10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDamageSharedTarget_TypeDefinitionIndex = 21733;
