...
#define RPG_GAMECORE_SHOWWAYPOINT_METHOD_3_9C10471920C4EB3E_OFFSET UNITYSDK_OFFSET(0x1D09DEB0)
#define RPG_GAMECORE_SHOWWAYPOINT_METHOD_3_C39BCDDD8E340B9A_OFFSET UNITYSDK_OFFSET(0x1D09DE30)
#define RPG_GAMECORE_SHOWWAYPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D09DE80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowWayPoint_TypeDefinitionIndex = 20631;
