...
#define RPG_GAMECORE_SHOWWAYPOINT_METHOD_3_9C10471920C4EB3E_OFFSET UNITYSDK_OFFSET(0x17707860)
#define RPG_GAMECORE_SHOWWAYPOINT_METHOD_3_DB6720C45130C2F4_OFFSET UNITYSDK_OFFSET(0x177077A0)
#define RPG_GAMECORE_SHOWWAYPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x17707810)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowWayPoint_TypeDefinitionIndex = 19196;
