...
#define RPG_GAMECORE_CLOSEROGUENOUSPAGES_METHOD_3_531D4BB45A931610_OFFSET UNITYSDK_OFFSET(0x1D9A2C20)
#define RPG_GAMECORE_CLOSEROGUENOUSPAGES_METHOD_3_A5C975627C9B8CCD_OFFSET UNITYSDK_OFFSET(0x1D9A2B50)
#define RPG_GAMECORE_CLOSEROGUENOUSPAGES__CTOR_OFFSET UNITYSDK_OFFSET(0x1D9A2C10)
