...
#define RPG_GAMECORE_CLOSEROGUENOUSPAGES_METHOD_3_531D4BB45A931610_OFFSET UNITYSDK_OFFSET(0x1BC1EC80)
#define RPG_GAMECORE_CLOSEROGUENOUSPAGES_METHOD_3_A5C975627C9B8CCD_OFFSET UNITYSDK_OFFSET(0x1BC1EBB0)
#define RPG_GAMECORE_CLOSEROGUENOUSPAGES__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC1EC70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CloseRogueNousPages_TypeDefinitionIndex = 23427;
