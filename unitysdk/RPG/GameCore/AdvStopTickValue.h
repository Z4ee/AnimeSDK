...
#define RPG_GAMECORE_ADVSTOPTICKVALUE_METHOD_3_1748A6D17DB6DA3F_OFFSET UNITYSDK_OFFSET(0x1CBA4970)
#define RPG_GAMECORE_ADVSTOPTICKVALUE_METHOD_3_EC9C2D6477A8131B_OFFSET UNITYSDK_OFFSET(0x1CBA48D0)
#define RPG_GAMECORE_ADVSTOPTICKVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CBA4930)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvStopTickValue_TypeDefinitionIndex = 20789;
