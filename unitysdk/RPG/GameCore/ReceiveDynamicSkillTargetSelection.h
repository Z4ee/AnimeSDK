...
#define RPG_GAMECORE_RECEIVEDYNAMICSKILLTARGETSELECTION_METHOD_3_B3CFA5D43F18F507_OFFSET UNITYSDK_OFFSET(0x17584560)
#define RPG_GAMECORE_RECEIVEDYNAMICSKILLTARGETSELECTION_METHOD_3_CDFD790CFD92C689_OFFSET UNITYSDK_OFFSET(0x175845E0)
#define RPG_GAMECORE_RECEIVEDYNAMICSKILLTARGETSELECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x175845B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ReceiveDynamicSkillTargetSelection_TypeDefinitionIndex = 21043;
