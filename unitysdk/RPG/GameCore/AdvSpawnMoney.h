...
#define RPG_GAMECORE_ADVSPAWNMONEY_METHOD_3_6AFBD9E01DA4FFE2_OFFSET UNITYSDK_OFFSET(0x16F44420)
#define RPG_GAMECORE_ADVSPAWNMONEY_METHOD_3_7F40FC6759DD808C_OFFSET UNITYSDK_OFFSET(0x16F445B0)
#define RPG_GAMECORE_ADVSPAWNMONEY__CTOR_OFFSET UNITYSDK_OFFSET(0x16F44460)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSpawnMoney_TypeDefinitionIndex = 20340;
