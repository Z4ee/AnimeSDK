...
#define RPG_GAMECORE_TUTORIALREMOVEHIDENODES_METHOD_3_388EA08253A358AC_OFFSET UNITYSDK_OFFSET(0x190DC7C0)
#define RPG_GAMECORE_TUTORIALREMOVEHIDENODES_METHOD_3_E68BCE07A9652B3D_OFFSET UNITYSDK_OFFSET(0x190DC840)
#define RPG_GAMECORE_TUTORIALREMOVEHIDENODES__CTOR_OFFSET UNITYSDK_OFFSET(0x190DC810)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TutorialRemoveHideNodes_TypeDefinitionIndex = 23392;
