...
#define RPG_GAMECORE_TUTORIALREMOVEHIDENODES_METHOD_3_388EA08253A358AC_OFFSET UNITYSDK_OFFSET(0x178DDF50)
#define RPG_GAMECORE_TUTORIALREMOVEHIDENODES_METHOD_3_E68BCE07A9652B3D_OFFSET UNITYSDK_OFFSET(0x178DDFD0)
#define RPG_GAMECORE_TUTORIALREMOVEHIDENODES__CTOR_OFFSET UNITYSDK_OFFSET(0x178DDFA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TutorialRemoveHideNodes_TypeDefinitionIndex = 22422;
