...
#define RPG_GAMECORE_MARBLETRIGGEREFFECT_METHOD_3_1F0075A987BF1DED_OFFSET UNITYSDK_OFFSET(0x1739EDB0)
#define RPG_GAMECORE_MARBLETRIGGEREFFECT_METHOD_3_1F196970AEF2997B_OFFSET UNITYSDK_OFFSET(0x1739EEE0)
#define RPG_GAMECORE_MARBLETRIGGEREFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1739ED60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleTriggerEffect_TypeDefinitionIndex = 15419;
