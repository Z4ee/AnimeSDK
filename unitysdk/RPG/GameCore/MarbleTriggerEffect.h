...
#define RPG_GAMECORE_MARBLETRIGGEREFFECT_METHOD_3_1F0075A987BF1DED_OFFSET UNITYSDK_OFFSET(0x18AACD40)
#define RPG_GAMECORE_MARBLETRIGGEREFFECT_METHOD_3_1F196970AEF2997B_OFFSET UNITYSDK_OFFSET(0x18AACE70)
#define RPG_GAMECORE_MARBLETRIGGEREFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x18AACCF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleTriggerEffect_TypeDefinitionIndex = 15939;
