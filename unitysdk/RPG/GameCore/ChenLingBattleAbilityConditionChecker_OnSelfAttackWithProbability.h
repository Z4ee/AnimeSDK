...
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_ONSELFATTACKWITHPROBABILITY_METHOD_3_11AEA74022F404D2_OFFSET UNITYSDK_OFFSET(0x1961B0F0)
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_ONSELFATTACKWITHPROBABILITY_METHOD_3_1D8997D9A6962766_OFFSET UNITYSDK_OFFSET(0x1961B020)
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_ONSELFATTACKWITHPROBABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1961B0E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleAbilityConditionChecker_OnSelfAttackWithProbability_TypeDefinitionIndex = 14948;
