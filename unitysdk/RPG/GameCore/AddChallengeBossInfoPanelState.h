...
#define RPG_GAMECORE_ADDCHALLENGEBOSSINFOPANELSTATE_METHOD_3_432577730F5D4401_OFFSET UNITYSDK_OFFSET(0x1863D320)
#define RPG_GAMECORE_ADDCHALLENGEBOSSINFOPANELSTATE_METHOD_3_9C66B3FB54F584E0_OFFSET UNITYSDK_OFFSET(0x1863D2A0)
#define RPG_GAMECORE_ADDCHALLENGEBOSSINFOPANELSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1863D2F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddChallengeBossInfoPanelState_TypeDefinitionIndex = 22172;
