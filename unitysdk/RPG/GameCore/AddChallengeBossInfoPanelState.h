...
#define RPG_GAMECORE_ADDCHALLENGEBOSSINFOPANELSTATE_METHOD_3_432577730F5D4401_OFFSET UNITYSDK_OFFSET(0x16F1B230)
#define RPG_GAMECORE_ADDCHALLENGEBOSSINFOPANELSTATE_METHOD_3_9C66B3FB54F584E0_OFFSET UNITYSDK_OFFSET(0x16F1B1B0)
#define RPG_GAMECORE_ADDCHALLENGEBOSSINFOPANELSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F1B200)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddChallengeBossInfoPanelState_TypeDefinitionIndex = 21437;
