...
#define RPG_GAMECORE_ADDCHALLENGEBOSSINFOPANELSTATE_METHOD_3_432577730F5D4401_OFFSET UNITYSDK_OFFSET(0x1BE04A20)
#define RPG_GAMECORE_ADDCHALLENGEBOSSINFOPANELSTATE_METHOD_3_6CBD5A234B540698_OFFSET UNITYSDK_OFFSET(0x1BE049E0)
#define RPG_GAMECORE_ADDCHALLENGEBOSSINFOPANELSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE04A10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddChallengeBossInfoPanelState_TypeDefinitionIndex = 22386;
