...
#define RPG_GAMECORE_TRAINPARTYACTIONADDBUILDCOINCONFIG_METHOD_5_3BD002738F8DB200_OFFSET UNITYSDK_OFFSET(0x1D5D95E0)
#define RPG_GAMECORE_TRAINPARTYACTIONADDBUILDCOINCONFIG_METHOD_5_DBF6E46A93CC45FC_OFFSET UNITYSDK_OFFSET(0x1D5D9640)
#define RPG_GAMECORE_TRAINPARTYACTIONADDBUILDCOINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5D9630)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyActionAddBuildCoinConfig_TypeDefinitionIndex = 17863;
