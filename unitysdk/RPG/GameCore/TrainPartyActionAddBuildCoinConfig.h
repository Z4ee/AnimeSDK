...
#define RPG_GAMECORE_TRAINPARTYACTIONADDBUILDCOINCONFIG_METHOD_5_B100BD5E40A42BF4_OFFSET UNITYSDK_OFFSET(0x19DEFF60)
#define RPG_GAMECORE_TRAINPARTYACTIONADDBUILDCOINCONFIG_METHOD_5_DBF6E46A93CC45FC_OFFSET UNITYSDK_OFFSET(0x19DF0040)
#define RPG_GAMECORE_TRAINPARTYACTIONADDBUILDCOINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19DEFFF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyActionAddBuildCoinConfig_TypeDefinitionIndex = 17184;
