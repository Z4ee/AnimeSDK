...
#define RPG_GAMECORE_RESETTEAMMATEATTACKPERFORM_METHOD_3_7FBDD77E91FDB02E_OFFSET UNITYSDK_OFFSET(0x1D01CB00)
#define RPG_GAMECORE_RESETTEAMMATEATTACKPERFORM_METHOD_3_886E7AFFB2547DED_OFFSET UNITYSDK_OFFSET(0x1D01CAB0)
#define RPG_GAMECORE_RESETTEAMMATEATTACKPERFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D01CAF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetTeammateAttackPerform_TypeDefinitionIndex = 21680;
