...
#define RPG_GAMECORE_RESETTEAMMATEATTACKPERFORM_METHOD_3_11C6876A19445AFF_OFFSET UNITYSDK_OFFSET(0x19AD0340)
#define RPG_GAMECORE_RESETTEAMMATEATTACKPERFORM_METHOD_3_7FBDD77E91FDB02E_OFFSET UNITYSDK_OFFSET(0x19AD03D0)
#define RPG_GAMECORE_RESETTEAMMATEATTACKPERFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x19AD03A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetTeammateAttackPerform_TypeDefinitionIndex = 21265;
