...
#define RPG_GAMECORE_RESETTEAMMATEATTACKPERFORM_METHOD_3_11C6876A19445AFF_OFFSET UNITYSDK_OFFSET(0x1759F990)
#define RPG_GAMECORE_RESETTEAMMATEATTACKPERFORM_METHOD_3_7FBDD77E91FDB02E_OFFSET UNITYSDK_OFFSET(0x1759FA20)
#define RPG_GAMECORE_RESETTEAMMATEATTACKPERFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1759F9F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetTeammateAttackPerform_TypeDefinitionIndex = 20678;
