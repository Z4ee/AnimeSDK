...
#define RPG_GAMECORE_CHIMERADUELSUMMONEDCHIMERASELECTORCONFIG_METHOD_3_97DF7A8C33D911CB_OFFSET UNITYSDK_OFFSET(0x19647D70)
#define RPG_GAMECORE_CHIMERADUELSUMMONEDCHIMERASELECTORCONFIG_METHOD_3_9ECEB27FAE425EFB_OFFSET UNITYSDK_OFFSET(0x19647DD0)
#define RPG_GAMECORE_CHIMERADUELSUMMONEDCHIMERASELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19647DC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelSummonedChimeraSelectorConfig_TypeDefinitionIndex = 15136;
