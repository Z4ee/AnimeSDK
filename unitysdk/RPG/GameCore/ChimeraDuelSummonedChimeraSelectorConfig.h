...
#define RPG_GAMECORE_CHIMERADUELSUMMONEDCHIMERASELECTORCONFIG_METHOD_3_97DF7A8C33D911CB_OFFSET UNITYSDK_OFFSET(0x1CFCFBB0)
#define RPG_GAMECORE_CHIMERADUELSUMMONEDCHIMERASELECTORCONFIG_METHOD_3_9ECEB27FAE425EFB_OFFSET UNITYSDK_OFFSET(0x1CFCFC10)
#define RPG_GAMECORE_CHIMERADUELSUMMONEDCHIMERASELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFCFC00)
