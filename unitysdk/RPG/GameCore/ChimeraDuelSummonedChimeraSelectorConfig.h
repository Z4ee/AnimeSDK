...
#define RPG_GAMECORE_CHIMERADUELSUMMONEDCHIMERASELECTORCONFIG_METHOD_3_97DF7A8C33D911CB_OFFSET UNITYSDK_OFFSET(0x188064F0)
#define RPG_GAMECORE_CHIMERADUELSUMMONEDCHIMERASELECTORCONFIG_METHOD_3_9ECEB27FAE425EFB_OFFSET UNITYSDK_OFFSET(0x18806550)
#define RPG_GAMECORE_CHIMERADUELSUMMONEDCHIMERASELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18806540)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelSummonedChimeraSelectorConfig_TypeDefinitionIndex = 15073;
