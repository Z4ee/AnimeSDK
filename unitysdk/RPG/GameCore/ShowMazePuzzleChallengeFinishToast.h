...
#define RPG_GAMECORE_SHOWMAZEPUZZLECHALLENGEFINISHTOAST_METHOD_3_8037714414921677_OFFSET UNITYSDK_OFFSET(0x19C7F7E0)
#define RPG_GAMECORE_SHOWMAZEPUZZLECHALLENGEFINISHTOAST_METHOD_3_87E3BBCEBEC8209E_OFFSET UNITYSDK_OFFSET(0x19C7F870)
#define RPG_GAMECORE_SHOWMAZEPUZZLECHALLENGEFINISHTOAST__CTOR_OFFSET UNITYSDK_OFFSET(0x19C7F840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowMazePuzzleChallengeFinishToast_TypeDefinitionIndex = 20789;
