...
#define RPG_GAMECORE_SHOWMAZEPUZZLECHALLENGEFINISHTOAST_METHOD_3_8037714414921677_OFFSET UNITYSDK_OFFSET(0x18E636C0)
#define RPG_GAMECORE_SHOWMAZEPUZZLECHALLENGEFINISHTOAST_METHOD_3_87E3BBCEBEC8209E_OFFSET UNITYSDK_OFFSET(0x18E63750)
#define RPG_GAMECORE_SHOWMAZEPUZZLECHALLENGEFINISHTOAST__CTOR_OFFSET UNITYSDK_OFFSET(0x18E63720)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowMazePuzzleChallengeFinishToast_TypeDefinitionIndex = 20870;
