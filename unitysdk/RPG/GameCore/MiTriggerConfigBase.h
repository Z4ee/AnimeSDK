...
#define RPG_GAMECORE_MITRIGGERCONFIGBASE_METHOD_2_60F927397DDC6410_OFFSET UNITYSDK_OFFSET(0x1741AF40)
#define RPG_GAMECORE_MITRIGGERCONFIGBASE_METHOD_2_9F9E1C0E0CB33730_OFFSET UNITYSDK_OFFSET(0x1741B220)
#define RPG_GAMECORE_MITRIGGERCONFIGBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1741B210)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MiTriggerConfigBase_TypeDefinitionIndex = 15659;
