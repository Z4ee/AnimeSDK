...
#define RPG_GAMECORE_MITRIGGERCONFIGBASE_METHOD_2_60F927397DDC6410_OFFSET UNITYSDK_OFFSET(0x18B27810)
#define RPG_GAMECORE_MITRIGGERCONFIGBASE_METHOD_2_9F9E1C0E0CB33730_OFFSET UNITYSDK_OFFSET(0x18B27AF0)
#define RPG_GAMECORE_MITRIGGERCONFIGBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x18B27AE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MiTriggerConfigBase_TypeDefinitionIndex = 16181;
