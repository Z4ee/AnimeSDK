...
#define RPG_GAMECORE_TUTORIALGUIDEGROUPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D615160)
#define RPG_GAMECORE_TUTORIALGUIDEGROUPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D615D20)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 TutorialType; // 0x3C
		::System::UInt32 GroupID; // 0x40
		::RPG::GameCore::TutorialGuideShowType TutorialShowType; // 0x44
		::System::Boolean CanReview; // 0x48
