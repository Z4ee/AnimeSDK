...
#define RPG_GAMECORE_TUTORIALGUIDEGROUPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D2A47B0)
#define RPG_GAMECORE_TUTORIALGUIDEGROUPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2A5370)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TutorialGuideGroupRow_TypeDefinitionIndex = 15210;
	...
	public:
		...
		::System::Boolean CanReview; // 0x44
		::System::UInt32 TutorialType; // 0x48
		::RPG::GameCore::TutorialGuideShowType TutorialShowType; // 0x4C
