...
#define RPG_GAMECORE_TUTORIALGUIDEGROUPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19E29840)
#define RPG_GAMECORE_TUTORIALGUIDEGROUPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19E2A400)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TutorialGuideGroupRow_TypeDefinitionIndex = 14616;
