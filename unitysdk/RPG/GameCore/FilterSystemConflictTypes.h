...
#define RPG_GAMECORE_FILTERSYSTEMCONFLICTTYPES_METHOD_2_80C909D005B52E27_OFFSET UNITYSDK_OFFSET(0x1BA7FC70)
#define RPG_GAMECORE_FILTERSYSTEMCONFLICTTYPES__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA7FD30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FilterSystemConflictTypes_TypeDefinitionIndex = 15845;
