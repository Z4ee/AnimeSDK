...
#define RPG_GAMECORE_FILTERSYSTEMCONFLICTTYPES_METHOD_2_80C909D005B52E27_OFFSET UNITYSDK_OFFSET(0x171D5A40)
#define RPG_GAMECORE_FILTERSYSTEMCONFLICTTYPES__CTOR_OFFSET UNITYSDK_OFFSET(0x171D5B50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FilterSystemConflictTypes_TypeDefinitionIndex = 15104;
