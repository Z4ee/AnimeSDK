...
#define RPG_GAMECORE_LEVELTURNALLOWACTION_GETACTIVEENTITY_OFFSET UNITYSDK_OFFSET(0x19780D40)
#define RPG_GAMECORE_LEVELTURNALLOWACTION_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x19780CF0)
#define RPG_GAMECORE_LEVELTURNALLOWACTION_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x19780CA0)
#define RPG_GAMECORE_LEVELTURNALLOWACTION_GETTURNCOUNTER_OFFSET UNITYSDK_OFFSET(0x19780D80)
#define RPG_GAMECORE_LEVELTURNALLOWACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19780C90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelTurnAllowAction_TypeDefinitionIndex = 54161;
