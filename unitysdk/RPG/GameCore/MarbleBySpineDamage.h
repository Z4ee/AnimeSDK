...
#define RPG_GAMECORE_MARBLEBYSPINEDAMAGE_METHOD_4_A554974748D22719_OFFSET UNITYSDK_OFFSET(0x1BD164A0)
#define RPG_GAMECORE_MARBLEBYSPINEDAMAGE_METHOD_4_CC8C8E74434C2EE0_OFFSET UNITYSDK_OFFSET(0x1BD16500)
#define RPG_GAMECORE_MARBLEBYSPINEDAMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD164F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleBySpineDamage_TypeDefinitionIndex = 16219;
