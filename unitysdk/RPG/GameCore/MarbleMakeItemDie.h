...
#define RPG_GAMECORE_MARBLEMAKEITEMDIE_METHOD_3_9F7A5747BE63354B_OFFSET UNITYSDK_OFFSET(0x198D1B60)
#define RPG_GAMECORE_MARBLEMAKEITEMDIE_METHOD_3_E1E81ABE3DB72680_OFFSET UNITYSDK_OFFSET(0x198D1C40)
#define RPG_GAMECORE_MARBLEMAKEITEMDIE__CTOR_OFFSET UNITYSDK_OFFSET(0x198D1BF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleMakeItemDie_TypeDefinitionIndex = 16016;
