...
#define RPG_GAMECORE_MARBLEMAKEITEMDIE_METHOD_3_9F7A5747BE63354B_OFFSET UNITYSDK_OFFSET(0x17390C10)
#define RPG_GAMECORE_MARBLEMAKEITEMDIE_METHOD_3_E1E81ABE3DB72680_OFFSET UNITYSDK_OFFSET(0x17390CF0)
#define RPG_GAMECORE_MARBLEMAKEITEMDIE__CTOR_OFFSET UNITYSDK_OFFSET(0x17390CA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleMakeItemDie_TypeDefinitionIndex = 15444;
