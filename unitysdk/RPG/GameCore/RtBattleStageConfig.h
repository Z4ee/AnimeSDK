...
#define RPG_GAMECORE_RTBATTLESTAGECONFIG_METHOD_2_B5C198C7BBF5FD09_OFFSET UNITYSDK_OFFSET(0x1CCD8850)
#define RPG_GAMECORE_RTBATTLESTAGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CCD8D60)
