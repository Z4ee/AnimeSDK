...
#define RPG_GAMECORE_BATTLEEXTRASKILLTREEADDITIONPAIR_METHOD_3_BC36FFCBF1884962_OFFSET UNITYSDK_OFFSET(0x16FD8160)
#define RPG_GAMECORE_BATTLEEXTRASKILLTREEADDITIONPAIR_METHOD_3_F202795BBDAB96C8_OFFSET UNITYSDK_OFFSET(0x16FD83B0)
#define RPG_GAMECORE_BATTLEEXTRASKILLTREEADDITIONPAIR__CTOR_OFFSET UNITYSDK_OFFSET(0x16FD8150)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleExtraSkillTreeAdditionPair_TypeDefinitionIndex = 21891;
