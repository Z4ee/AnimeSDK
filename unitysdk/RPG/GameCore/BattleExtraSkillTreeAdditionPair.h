...
#define RPG_GAMECORE_BATTLEEXTRASKILLTREEADDITIONPAIR_METHOD_3_0E69DCF882D9CB1D_OFFSET UNITYSDK_OFFSET(0x1A3EF580)
#define RPG_GAMECORE_BATTLEEXTRASKILLTREEADDITIONPAIR_METHOD_3_5FA49233E49EAE73_OFFSET UNITYSDK_OFFSET(0x1A3EF790)
#define RPG_GAMECORE_BATTLEEXTRASKILLTREEADDITIONPAIR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3EF570)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleExtraSkillTreeAdditionPair_TypeDefinitionIndex = 22796;
