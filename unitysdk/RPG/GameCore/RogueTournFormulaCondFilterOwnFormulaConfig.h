...
#define RPG_GAMECORE_ROGUETOURNFORMULACONDFILTEROWNFORMULACONFIG_METHOD_7_1D1CCBACF376575D_OFFSET UNITYSDK_OFFSET(0x18D739C0)
#define RPG_GAMECORE_ROGUETOURNFORMULACONDFILTEROWNFORMULACONFIG_METHOD_7_788BD02EA772F9D2_OFFSET UNITYSDK_OFFSET(0x18D73960)
#define RPG_GAMECORE_ROGUETOURNFORMULACONDFILTEROWNFORMULACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D739B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournFormulaCondFilterOwnFormulaConfig_TypeDefinitionIndex = 18575;
