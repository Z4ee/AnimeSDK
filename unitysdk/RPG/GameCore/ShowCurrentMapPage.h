...
#define RPG_GAMECORE_SHOWCURRENTMAPPAGE_METHOD_3_1CF08E110A81B708_OFFSET UNITYSDK_OFFSET(0x176F7FE0)
#define RPG_GAMECORE_SHOWCURRENTMAPPAGE_METHOD_3_3B38F5717A50113C_OFFSET UNITYSDK_OFFSET(0x176F7ED0)
#define RPG_GAMECORE_SHOWCURRENTMAPPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x176F7FB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowCurrentMapPage_TypeDefinitionIndex = 22119;
