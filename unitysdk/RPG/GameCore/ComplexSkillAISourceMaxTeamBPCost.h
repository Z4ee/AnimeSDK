...
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEMAXTEAMBPCOST_METHOD_3_3FA46FDAB29EC335_OFFSET UNITYSDK_OFFSET(0x17126DE0)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEMAXTEAMBPCOST_METHOD_3_54C8D2B91CD7A8A1_OFFSET UNITYSDK_OFFSET(0x17128F50)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEMAXTEAMBPCOST__CTOR_OFFSET UNITYSDK_OFFSET(0x17126DC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAISourceMaxTeamBPCost_TypeDefinitionIndex = 14234;
