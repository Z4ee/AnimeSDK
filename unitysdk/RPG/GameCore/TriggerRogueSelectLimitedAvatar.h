...
#define RPG_GAMECORE_TRIGGERROGUESELECTLIMITEDAVATAR_METHOD_3_182F9E025CE46305_OFFSET UNITYSDK_OFFSET(0x178CDC30)
#define RPG_GAMECORE_TRIGGERROGUESELECTLIMITEDAVATAR_METHOD_3_FC9B094E5F1937ED_OFFSET UNITYSDK_OFFSET(0x178CDBB0)
#define RPG_GAMECORE_TRIGGERROGUESELECTLIMITEDAVATAR__CTOR_OFFSET UNITYSDK_OFFSET(0x178CDC00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerRogueSelectLimitedAvatar_TypeDefinitionIndex = 20463;
