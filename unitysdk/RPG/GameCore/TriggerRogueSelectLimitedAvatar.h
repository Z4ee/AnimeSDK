...
#define RPG_GAMECORE_TRIGGERROGUESELECTLIMITEDAVATAR_METHOD_3_8634BD30C72E5FFE_OFFSET UNITYSDK_OFFSET(0x1D293E20)
#define RPG_GAMECORE_TRIGGERROGUESELECTLIMITEDAVATAR_METHOD_3_A8E76D00FDDC54E3_OFFSET UNITYSDK_OFFSET(0x1D293E60)
#define RPG_GAMECORE_TRIGGERROGUESELECTLIMITEDAVATAR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D293E50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerRogueSelectLimitedAvatar_TypeDefinitionIndex = 22022;
