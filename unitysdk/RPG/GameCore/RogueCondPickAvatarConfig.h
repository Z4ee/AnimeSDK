...
#define RPG_GAMECORE_ROGUECONDPICKAVATARCONFIG_METHOD_6_6E4BF7CC736976D4_OFFSET UNITYSDK_OFFSET(0x1C4AEEE0)
#define RPG_GAMECORE_ROGUECONDPICKAVATARCONFIG_METHOD_6_8A98424426B42CD0_OFFSET UNITYSDK_OFFSET(0x1C4AEF30)
#define RPG_GAMECORE_ROGUECONDPICKAVATARCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4AEF20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueCondPickAvatarConfig_TypeDefinitionIndex = 19037;
