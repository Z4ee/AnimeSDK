...
#define RPG_GAMECORE_ROGUECONDPICKAVATARCONFIG_METHOD_6_8A98424426B42CD0_OFFSET UNITYSDK_OFFSET(0x18CF8B00)
#define RPG_GAMECORE_ROGUECONDPICKAVATARCONFIG_METHOD_6_E5D216AF2A72CF46_OFFSET UNITYSDK_OFFSET(0x18CF8850)
#define RPG_GAMECORE_ROGUECONDPICKAVATARCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CF89D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueCondPickAvatarConfig_TypeDefinitionIndex = 18792;
