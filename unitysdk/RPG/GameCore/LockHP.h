...
#define RPG_GAMECORE_LOCKHP_METHOD_3_40BC8C1901D751FE_OFFSET UNITYSDK_OFFSET(0x18A78C60)
#define RPG_GAMECORE_LOCKHP_METHOD_3_7EE24B2C8B1500BD_OFFSET UNITYSDK_OFFSET(0x18A78CF0)
#define RPG_GAMECORE_LOCKHP__CTOR_OFFSET UNITYSDK_OFFSET(0x18A78CC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LockHP_TypeDefinitionIndex = 22596;
