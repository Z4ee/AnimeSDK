...
#define RPG_GAMECORE_GAMELEVELDICECOMBATNPCCONFIG_METHOD_2_61A84F0DEABDCC3F_OFFSET UNITYSDK_OFFSET(0x1D952A10)
#define RPG_GAMECORE_GAMELEVELDICECOMBATNPCCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D952B50)
