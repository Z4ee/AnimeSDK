...
#define RPG_GAMECORE_GAMELEVELDICECOMBATNPCCONFIG_METHOD_2_61A84F0DEABDCC3F_OFFSET UNITYSDK_OFFSET(0x197C8A10)
#define RPG_GAMECORE_GAMELEVELDICECOMBATNPCCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197C8B50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GameLevelDiceCombatNPCConfig_TypeDefinitionIndex = 16533;
