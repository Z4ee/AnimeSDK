...
#define RPG_GAMECORE_GAMELEVELDICECOMBATNPCCONFIG_METHOD_2_61A84F0DEABDCC3F_OFFSET UNITYSDK_OFFSET(0x17240A20)
#define RPG_GAMECORE_GAMELEVELDICECOMBATNPCCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17240B60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GameLevelDiceCombatNPCConfig_TypeDefinitionIndex = 15976;
