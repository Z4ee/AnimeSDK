...
#define RPG_GAMECORE_GAMELEVELDICECOMBATNPCCONFIG_METHOD_2_61A84F0DEABDCC3F_OFFSET UNITYSDK_OFFSET(0x1B9A11A0)
#define RPG_GAMECORE_GAMELEVELDICECOMBATNPCCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9A12E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GameLevelDiceCombatNPCConfig_TypeDefinitionIndex = 16695;
