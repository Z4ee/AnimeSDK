...
#define RPG_GAMECORE_RTSKILLSETTARGETPOS_METHOD_3_272ACFE605BABC72_OFFSET UNITYSDK_OFFSET(0x1D4B15C0)
#define RPG_GAMECORE_RTSKILLSETTARGETPOS_METHOD_3_B331144CB74ADD53_OFFSET UNITYSDK_OFFSET(0x1D4B1570)
#define RPG_GAMECORE_RTSKILLSETTARGETPOS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4B15B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtSkillSetTargetPos_TypeDefinitionIndex = 23951;
	...
	public:
		...
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::RtSkillSetTargetPos*))((::PBYTE)hIl2Cpp + RPG_GAMECORE_RTSKILLSETTARGETPOS_METHOD_3_272ACFE605BABC72_OFFSET))(a1, a2);
		}
	};
}
