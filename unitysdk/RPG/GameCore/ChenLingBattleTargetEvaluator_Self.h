...
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_SELF_METHOD_3_05A8527DC1987A36_OFFSET UNITYSDK_OFFSET(0x1C37F270)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_SELF_METHOD_3_6D7621E8B0B54AA7_OFFSET UNITYSDK_OFFSET(0x1C37F310)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_SELF__CTOR_OFFSET UNITYSDK_OFFSET(0x1C37F300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleTargetEvaluator_Self_TypeDefinitionIndex = 15151;
