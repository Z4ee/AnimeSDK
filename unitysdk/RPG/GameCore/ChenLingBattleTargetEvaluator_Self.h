...
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_SELF_METHOD_3_05A8527DC1987A36_OFFSET UNITYSDK_OFFSET(0x17082460)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_SELF_METHOD_3_6D7621E8B0B54AA7_OFFSET UNITYSDK_OFFSET(0x17082500)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_SELF__CTOR_OFFSET UNITYSDK_OFFSET(0x170824F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleTargetEvaluator_Self_TypeDefinitionIndex = 14454;
