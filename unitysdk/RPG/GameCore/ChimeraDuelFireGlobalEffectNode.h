...
#define RPG_GAMECORE_CHIMERADUELFIREGLOBALEFFECTNODE_METHOD_3_BC75A39BE3DA21D8_OFFSET UNITYSDK_OFFSET(0x187FBD00)
#define RPG_GAMECORE_CHIMERADUELFIREGLOBALEFFECTNODE_METHOD_3_E6D1B867B1BFDFDF_OFFSET UNITYSDK_OFFSET(0x187FBC00)
#define RPG_GAMECORE_CHIMERADUELFIREGLOBALEFFECTNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x187FBCA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelFireGlobalEffectNode_TypeDefinitionIndex = 15121;
