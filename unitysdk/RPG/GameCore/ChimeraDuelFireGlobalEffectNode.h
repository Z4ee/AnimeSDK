...
#define RPG_GAMECORE_CHIMERADUELFIREGLOBALEFFECTNODE_METHOD_3_6D82F065F0E151AE_OFFSET UNITYSDK_OFFSET(0x1CFC66F0)
#define RPG_GAMECORE_CHIMERADUELFIREGLOBALEFFECTNODE_METHOD_3_BC75A39BE3DA21D8_OFFSET UNITYSDK_OFFSET(0x1CFC6780)
#define RPG_GAMECORE_CHIMERADUELFIREGLOBALEFFECTNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFC6760)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelFireGlobalEffectNode_TypeDefinitionIndex = 15784;
