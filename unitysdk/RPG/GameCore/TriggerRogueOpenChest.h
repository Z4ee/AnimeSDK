...
#define RPG_GAMECORE_TRIGGERROGUEOPENCHEST_METHOD_3_3461181C2DEBA8D6_OFFSET UNITYSDK_OFFSET(0x1B05B9D0)
#define RPG_GAMECORE_TRIGGERROGUEOPENCHEST_METHOD_3_8FBE78EA1C620515_OFFSET UNITYSDK_OFFSET(0x1B05BA10)
#define RPG_GAMECORE_TRIGGERROGUEOPENCHEST__CTOR_OFFSET UNITYSDK_OFFSET(0x1B05BA00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerRogueOpenChest_TypeDefinitionIndex = 21457;
