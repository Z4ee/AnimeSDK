...
#define RPG_GAMECORE_TRIGGERROGUEOPENCHEST_METHOD_3_5182DE07056CC624_OFFSET UNITYSDK_OFFSET(0x178CDA20)
#define RPG_GAMECORE_TRIGGERROGUEOPENCHEST_METHOD_3_8FBE78EA1C620515_OFFSET UNITYSDK_OFFSET(0x178CDAA0)
#define RPG_GAMECORE_TRIGGERROGUEOPENCHEST__CTOR_OFFSET UNITYSDK_OFFSET(0x178CDA70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerRogueOpenChest_TypeDefinitionIndex = 20460;
