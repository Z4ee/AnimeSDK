...
#define RPG_GAMECORE_FIREWAVEPROJECTILEBASE_METHOD_3_10697ABB99BC0654_OFFSET UNITYSDK_OFFSET(0x171DB650)
#define RPG_GAMECORE_FIREWAVEPROJECTILEBASE_METHOD_3_B51E21920262DA05_OFFSET UNITYSDK_OFFSET(0x171DB880)
#define RPG_GAMECORE_FIREWAVEPROJECTILEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x171DB620)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FireWaveProjectileBase_TypeDefinitionIndex = 20765;
