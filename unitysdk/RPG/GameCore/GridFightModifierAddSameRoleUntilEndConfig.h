...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDSAMEROLEUNTILENDCONFIG_METHOD_3_6F65838A5FCF0309_OFFSET UNITYSDK_OFFSET(0x17260B20)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDSAMEROLEUNTILENDCONFIG_METHOD_3_CD0D7726B2D89FA0_OFFSET UNITYSDK_OFFSET(0x17260BF0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDSAMEROLEUNTILENDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17260BA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierAddSameRoleUntilEndConfig_TypeDefinitionIndex = 17811;
