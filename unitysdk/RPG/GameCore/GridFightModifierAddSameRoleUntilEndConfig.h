...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDSAMEROLEUNTILENDCONFIG_METHOD_3_CD0D7726B2D89FA0_OFFSET UNITYSDK_OFFSET(0x1C5D0260)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDSAMEROLEUNTILENDCONFIG_METHOD_3_FDD8474B97688A64_OFFSET UNITYSDK_OFFSET(0x1C5D0210)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDSAMEROLEUNTILENDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5D0250)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierAddSameRoleUntilEndConfig_TypeDefinitionIndex = 18649;
