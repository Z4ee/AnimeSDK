...
#define RPG_GAMECORE_ST_SIDE_LISTENFINDTROTTERSTATE_METHOD_4_5E2DE80A0AB6546D_OFFSET UNITYSDK_OFFSET(0x18DF9770)
#define RPG_GAMECORE_ST_SIDE_LISTENFINDTROTTERSTATE_METHOD_4_9970E3BE71C44C01_OFFSET UNITYSDK_OFFSET(0x18DF9690)
#define RPG_GAMECORE_ST_SIDE_LISTENFINDTROTTERSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18DF9710)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_ListenFindTrotterState_TypeDefinitionIndex = 19073;
