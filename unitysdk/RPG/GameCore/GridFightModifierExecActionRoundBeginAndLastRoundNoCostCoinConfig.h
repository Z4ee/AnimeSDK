...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONROUNDBEGINANDLASTROUNDNOCOSTCOINCONFIG_METHOD_3_4E53E9B8CD3638B5_OFFSET UNITYSDK_OFFSET(0x1726AD70)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONROUNDBEGINANDLASTROUNDNOCOSTCOINCONFIG_METHOD_3_A87E96CA224847EC_OFFSET UNITYSDK_OFFSET(0x172672C0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONROUNDBEGINANDLASTROUNDNOCOSTCOINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17267270)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierExecActionRoundBeginAndLastRoundNoCostCoinConfig_TypeDefinitionIndex = 17775;
