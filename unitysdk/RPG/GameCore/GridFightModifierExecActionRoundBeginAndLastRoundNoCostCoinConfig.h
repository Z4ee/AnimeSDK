...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONROUNDBEGINANDLASTROUNDNOCOSTCOINCONFIG_METHOD_3_008F031F41C735F0_OFFSET UNITYSDK_OFFSET(0x1D069A90)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONROUNDBEGINANDLASTROUNDNOCOSTCOINCONFIG_METHOD_3_A87E96CA224847EC_OFFSET UNITYSDK_OFFSET(0x1D069AE0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONROUNDBEGINANDLASTROUNDNOCOSTCOINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D069AD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierExecActionRoundBeginAndLastRoundNoCostCoinConfig_TypeDefinitionIndex = 18609;
