...
#define RPG_GAMECORE_ADVENTUREFIREPROJECTILE_METHOD_4_014C9985CC051CC7_OFFSET UNITYSDK_OFFSET(0x18676240)
#define RPG_GAMECORE_ADVENTUREFIREPROJECTILE_METHOD_4_72712D531700284F_OFFSET UNITYSDK_OFFSET(0x186761C0)
#define RPG_GAMECORE_ADVENTUREFIREPROJECTILE__CTOR_OFFSET UNITYSDK_OFFSET(0x18676210)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureFireProjectile_TypeDefinitionIndex = 19146;
