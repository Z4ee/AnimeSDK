...
#define RPG_GAMECORE_DRINKMAKERCHEERSGROUPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18884380)
#define RPG_GAMECORE_DRINKMAKERCHEERSGROUPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18884800)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DrinkMakerCheersGroupRow_TypeDefinitionIndex = 12477;
	...
	public:
		...
		::System::UInt32 HidingDrinkID; // 0x3C
		::System::UInt32 NextGroupID; // 0x40
		::RPG::Client::TextID GroupName; // 0x48
		::RPG::Client::TextID AvatarName; // 0x58
		::System::UInt32 TutorialGuideGroupID; // 0x68
		::System::UInt32 PrimaryDrinkID; // 0x6C
