...
#define RPG_GAMECORE_ROGUEACTPERSONAALLROOMCARDCASTREMOVECONFIG_METHOD_7_47F93B5E6762F5C6_OFFSET UNITYSDK_OFFSET(0x1D3B8590)
#define RPG_GAMECORE_ROGUEACTPERSONAALLROOMCARDCASTREMOVECONFIG_METHOD_7_4B84E23D129B7E62_OFFSET UNITYSDK_OFFSET(0x1D3B84D0)
#define RPG_GAMECORE_ROGUEACTPERSONAALLROOMCARDCASTREMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3B84C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaAllRoomCardCastRemoveConfig_TypeDefinitionIndex = 19514;
