...
#define RPG_GAMECORE_ROGUEACTPERSONAALLROOMCARDCASTREMOVECONFIG_METHOD_7_34ED63F73D142DD7_OFFSET UNITYSDK_OFFSET(0x18CC6FB0)
#define RPG_GAMECORE_ROGUEACTPERSONAALLROOMCARDCASTREMOVECONFIG_METHOD_7_4B84E23D129B7E62_OFFSET UNITYSDK_OFFSET(0x18CC6B80)
#define RPG_GAMECORE_ROGUEACTPERSONAALLROOMCARDCASTREMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CC6AA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaAllRoomCardCastRemoveConfig_TypeDefinitionIndex = 18741;
