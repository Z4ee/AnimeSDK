...
#define RPG_GAMECORE_ROGUEACTPERSONAALLROOMCARDCASTREMOVECONFIG_METHOD_7_34ED63F73D142DD7_OFFSET UNITYSDK_OFFSET(0x19AEB3C0)
#define RPG_GAMECORE_ROGUEACTPERSONAALLROOMCARDCASTREMOVECONFIG_METHOD_7_4B84E23D129B7E62_OFFSET UNITYSDK_OFFSET(0x19AEAF90)
#define RPG_GAMECORE_ROGUEACTPERSONAALLROOMCARDCASTREMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AEAEB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaAllRoomCardCastRemoveConfig_TypeDefinitionIndex = 18708;
