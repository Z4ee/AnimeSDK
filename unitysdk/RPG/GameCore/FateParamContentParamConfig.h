...
#define RPG_GAMECORE_FATEPARAMCONTENTPARAMCONFIG_METHOD_6_39D8CA798F283436_OFFSET UNITYSDK_OFFSET(0x19713A10)
#define RPG_GAMECORE_FATEPARAMCONTENTPARAMCONFIG_METHOD_6_8DBA3347423EB976_OFFSET UNITYSDK_OFFSET(0x19713820)
#define RPG_GAMECORE_FATEPARAMCONTENTPARAMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19713950)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateParamContentParamConfig_TypeDefinitionIndex = 15812;
