...
#define RPG_GAMECORE_FATEPARAMCONTENTPARAMCONFIG_METHOD_6_39D8CA798F283436_OFFSET UNITYSDK_OFFSET(0x1C075930)
#define RPG_GAMECORE_FATEPARAMCONTENTPARAMCONFIG_METHOD_6_75B1A9879BC63F3E_OFFSET UNITYSDK_OFFSET(0x1C0758D0)
#define RPG_GAMECORE_FATEPARAMCONTENTPARAMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C075920)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateParamContentParamConfig_TypeDefinitionIndex = 15986;
