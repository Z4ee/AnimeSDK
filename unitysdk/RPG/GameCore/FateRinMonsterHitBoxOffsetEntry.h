...
#define RPG_GAMECORE_FATERINMONSTERHITBOXOFFSETENTRY_METHOD_2_1E026FBED551ADC9_OFFSET UNITYSDK_OFFSET(0x1BA77030)
#define RPG_GAMECORE_FATERINMONSTERHITBOXOFFSETENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA77280)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateRinMonsterHitBoxOffsetEntry_TypeDefinitionIndex = 17429;
