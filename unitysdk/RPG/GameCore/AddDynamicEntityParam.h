...
#define RPG_GAMECORE_ADDDYNAMICENTITYPARAM_METHOD_3_149836B19B5DF3C0_OFFSET UNITYSDK_OFFSET(0x1940C9B0)
#define RPG_GAMECORE_ADDDYNAMICENTITYPARAM_METHOD_3_86345638A5063A8F_OFFSET UNITYSDK_OFFSET(0x1940C930)
#define RPG_GAMECORE_ADDDYNAMICENTITYPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1940C980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddDynamicEntityParam_TypeDefinitionIndex = 21434;
