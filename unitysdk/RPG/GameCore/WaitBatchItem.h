...
#define RPG_GAMECORE_WAITBATCHITEM_METHOD_2_9BD9F367CF37E094_OFFSET UNITYSDK_OFFSET(0x1B8A1100)
#define RPG_GAMECORE_WAITBATCHITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8A1440)
