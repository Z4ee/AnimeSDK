...
#define RPG_GAMECORE_LOOKAT_METHOD_3_5AC68DAE2EA01F8B_OFFSET UNITYSDK_OFFSET(0x1736E370)
#define RPG_GAMECORE_LOOKAT_METHOD_3_73BAD9060BC701D1_OFFSET UNITYSDK_OFFSET(0x1736E460)
#define RPG_GAMECORE_LOOKAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1736E400)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LookAt_TypeDefinitionIndex = 21071;
