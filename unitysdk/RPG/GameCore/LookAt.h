...
#define RPG_GAMECORE_LOOKAT_METHOD_3_73BAD9060BC701D1_OFFSET UNITYSDK_OFFSET(0x1D488840)
#define RPG_GAMECORE_LOOKAT_METHOD_3_AF674D0B7E4D09C2_OFFSET UNITYSDK_OFFSET(0x1D488780)
#define RPG_GAMECORE_LOOKAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4887F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LookAt_TypeDefinitionIndex = 22616;
	...
	public:
		...
		static ::System::Void Method_3_AF674D0B7E4D09C2(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::LookAt*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::LookAt*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_LOOKAT_METHOD_3_AF674D0B7E4D09C2_OFFSET))(a1, a2);
		}
