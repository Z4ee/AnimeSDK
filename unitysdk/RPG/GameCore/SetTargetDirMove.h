...
#define RPG_GAMECORE_SETTARGETDIRMOVE_METHOD_3_378E7CB9136C3B37_OFFSET UNITYSDK_OFFSET(0x19C622F0)
#define RPG_GAMECORE_SETTARGETDIRMOVE_METHOD_3_BDE2DCDC0D511B31_OFFSET UNITYSDK_OFFSET(0x19C62470)
#define RPG_GAMECORE_SETTARGETDIRMOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C623C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetTargetDirMove_TypeDefinitionIndex = 19039;
