...
#define RPG_GAMECORE_SETMUSICVISUALRENDERENABLE_METHOD_3_7D67D31B9877EFF2_OFFSET UNITYSDK_OFFSET(0x176D95F0)
#define RPG_GAMECORE_SETMUSICVISUALRENDERENABLE_METHOD_3_89F414942BA99392_OFFSET UNITYSDK_OFFSET(0x176D94A0)
#define RPG_GAMECORE_SETMUSICVISUALRENDERENABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x176D9560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetMusicVisualRenderEnable_TypeDefinitionIndex = 20508;
