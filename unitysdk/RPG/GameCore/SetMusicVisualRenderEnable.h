...
#define RPG_GAMECORE_SETMUSICVISUALRENDERENABLE_METHOD_3_7D67D31B9877EFF2_OFFSET UNITYSDK_OFFSET(0x1C603C20)
#define RPG_GAMECORE_SETMUSICVISUALRENDERENABLE_METHOD_3_DE13FAE8152F4CEC_OFFSET UNITYSDK_OFFSET(0x1C603BA0)
#define RPG_GAMECORE_SETMUSICVISUALRENDERENABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C603BF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetMusicVisualRenderEnable_TypeDefinitionIndex = 21502;
