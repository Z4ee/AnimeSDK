...
#define RPG_GAMECORE_FIVEDIMLEVELVARCONDITION_METHOD_2_6B4CFDA16F749EA9_OFFSET UNITYSDK_OFFSET(0x197453A0)
#define RPG_GAMECORE_FIVEDIMLEVELVARCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x197454E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimLevelVarCondition_TypeDefinitionIndex = 17700;
