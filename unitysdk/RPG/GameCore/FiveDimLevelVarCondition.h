...
#define RPG_GAMECORE_FIVEDIMLEVELVARCONDITION_METHOD_2_6B4CFDA16F749EA9_OFFSET UNITYSDK_OFFSET(0x171F8FE0)
#define RPG_GAMECORE_FIVEDIMLEVELVARCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x171F9120)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimLevelVarCondition_TypeDefinitionIndex = 17073;
