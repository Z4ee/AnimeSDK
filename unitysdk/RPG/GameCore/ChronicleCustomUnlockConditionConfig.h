...
#define RPG_GAMECORE_CHRONICLECUSTOMUNLOCKCONDITIONCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1964F080)
#define RPG_GAMECORE_CHRONICLECUSTOMUNLOCKCONDITIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1964F1C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChronicleCustomUnlockConditionConfig_TypeDefinitionIndex = 18022;
