...
#define RPG_GAMECORE_CHRONICLECUSTOMUNLOCKCONDITIONCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1880D840)
#define RPG_GAMECORE_CHRONICLECUSTOMUNLOCKCONDITIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1880D980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChronicleCustomUnlockConditionConfig_TypeDefinitionIndex = 17995;
