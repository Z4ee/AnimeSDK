...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDTRAITMEMBERPROPERTYCONFIG_METHOD_3_4F219E302CA35450_OFFSET UNITYSDK_OFFSET(0x17260DB0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDTRAITMEMBERPROPERTYCONFIG_METHOD_3_B928AFB9648BC6F9_OFFSET UNITYSDK_OFFSET(0x17260CE0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDTRAITMEMBERPROPERTYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17260D60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierAddTraitMemberPropertyConfig_TypeDefinitionIndex = 17872;
