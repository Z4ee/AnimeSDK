...
#define RPG_GAMECORE_AVATARASSETPRELOADCONFIG_METHOD_3_1C15388CFD2AAE6A_OFFSET UNITYSDK_OFFSET(0x1948E5F0)
#define RPG_GAMECORE_AVATARASSETPRELOADCONFIG_METHOD_3_4A4FEFEBDA2817B3_OFFSET UNITYSDK_OFFSET(0x1948E640)
#define RPG_GAMECORE_AVATARASSETPRELOADCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1948E630)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AvatarAssetPreloadConfig_TypeDefinitionIndex = 15650;
