...
#define RPG_GAMECORE_AVATARASSETPRELOADCONFIG_METHOD_3_1C15388CFD2AAE6A_OFFSET UNITYSDK_OFFSET(0x186B68B0)
#define RPG_GAMECORE_AVATARASSETPRELOADCONFIG_METHOD_3_4A4FEFEBDA2817B3_OFFSET UNITYSDK_OFFSET(0x186B6900)
#define RPG_GAMECORE_AVATARASSETPRELOADCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x186B68F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AvatarAssetPreloadConfig_TypeDefinitionIndex = 15588;
