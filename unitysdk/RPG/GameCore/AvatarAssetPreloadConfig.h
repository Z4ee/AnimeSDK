...
#define RPG_GAMECORE_AVATARASSETPRELOADCONFIG_METHOD_3_1C15388CFD2AAE6A_OFFSET UNITYSDK_OFFSET(0x16F936A0)
#define RPG_GAMECORE_AVATARASSETPRELOADCONFIG_METHOD_3_4A4FEFEBDA2817B3_OFFSET UNITYSDK_OFFSET(0x16F936F0)
#define RPG_GAMECORE_AVATARASSETPRELOADCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16F936E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AvatarAssetPreloadConfig_TypeDefinitionIndex = 15080;
