...
#define RPG_GAMECORE_PRELOADGROUPSCORECONFIG_METHOD_2_6250FF2B6678082F_OFFSET UNITYSDK_OFFSET(0x18C60910)
#define RPG_GAMECORE_PRELOADGROUPSCORECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18C60A50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PreloadGroupScoreConfig_TypeDefinitionIndex = 15489;
