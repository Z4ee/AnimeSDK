...
#define RPG_GAMECORE_JSONENUMCONFIG_METHOD_2_1FE402EB0677D429_OFFSET UNITYSDK_OFFSET(0x1B028E90)
#define RPG_GAMECORE_JSONENUMCONFIG_METHOD_2_90D8319C0D612532_OFFSET UNITYSDK_OFFSET(0x1B028F80)
#define RPG_GAMECORE_JSONENUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B028F70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int JsonEnumConfig_TypeDefinitionIndex = 16438;
