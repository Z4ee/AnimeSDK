...
#define RPG_GAMECORE_REFRESHMAPROTATIONVOLUMEUSABLE_METHOD_3_354F1BE91F16B1F6_OFFSET UNITYSDK_OFFSET(0x17589450)
#define RPG_GAMECORE_REFRESHMAPROTATIONVOLUMEUSABLE_METHOD_3_BB0F6EF9264CC575_OFFSET UNITYSDK_OFFSET(0x175894D0)
#define RPG_GAMECORE_REFRESHMAPROTATIONVOLUMEUSABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x175894A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RefreshMapRotationVolumeUsable_TypeDefinitionIndex = 19251;
