...
#define RPG_GAMECORE_CHIMERADUELWAITSECONDSNODE_METHOD_3_D407FBB18DD7391E_OFFSET UNITYSDK_OFFSET(0x19649140)
#define RPG_GAMECORE_CHIMERADUELWAITSECONDSNODE_METHOD_3_F048FEE914F18090_OFFSET UNITYSDK_OFFSET(0x196492E0)
#define RPG_GAMECORE_CHIMERADUELWAITSECONDSNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x19649290)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelWaitSecondsNode_TypeDefinitionIndex = 15184;
