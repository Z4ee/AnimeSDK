...
#define RPG_GAMECORE_CHIMERADUELWAITSECONDSNODE_METHOD_3_9949751E8D8104C4_OFFSET UNITYSDK_OFFSET(0x1C249FC0)
#define RPG_GAMECORE_CHIMERADUELWAITSECONDSNODE_METHOD_3_F048FEE914F18090_OFFSET UNITYSDK_OFFSET(0x1C24A0A0)
#define RPG_GAMECORE_CHIMERADUELWAITSECONDSNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C24A090)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelWaitSecondsNode_TypeDefinitionIndex = 15348;
