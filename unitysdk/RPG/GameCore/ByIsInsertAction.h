...
#define RPG_GAMECORE_BYISINSERTACTION_METHOD_4_23CB2E079811CA42_OFFSET UNITYSDK_OFFSET(0x1B29EE80)
#define RPG_GAMECORE_BYISINSERTACTION_METHOD_4_3DACE74625943B15_OFFSET UNITYSDK_OFFSET(0x1B29EEB0)
#define RPG_GAMECORE_BYISINSERTACTION_METHOD_4_69C4609B10CEB07A_OFFSET UNITYSDK_OFFSET(0x1B29EC30)
#define RPG_GAMECORE_BYISINSERTACTION_METHOD_4_7C1746FC6E5C7E37_OFFSET UNITYSDK_OFFSET(0x1B29EC70)
#define RPG_GAMECORE_BYISINSERTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B29EC60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsInsertAction_TypeDefinitionIndex = 21749;
