...
#define RPG_GAMECORE_MARBLESETTECHACTIVE_METHOD_3_89E7214945186E46_OFFSET UNITYSDK_OFFSET(0x198DB100)
#define RPG_GAMECORE_MARBLESETTECHACTIVE_METHOD_3_D2E80BA6EE7A08E8_OFFSET UNITYSDK_OFFSET(0x198DAF40)
#define RPG_GAMECORE_MARBLESETTECHACTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x198DB0B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleSetTechActive_TypeDefinitionIndex = 15995;
