...
#define RPG_GAMECORE_MARBLESETTECHACTIVE_METHOD_3_05D1E9416596047A_OFFSET UNITYSDK_OFFSET(0x1BD22DB0)
#define RPG_GAMECORE_MARBLESETTECHACTIVE_METHOD_3_89E7214945186E46_OFFSET UNITYSDK_OFFSET(0x1BD22EC0)
#define RPG_GAMECORE_MARBLESETTECHACTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD22EB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleSetTechActive_TypeDefinitionIndex = 16179;
