...
#define RPG_GAMECORE_MODIFYCHARACTERFACEMATERIAL_METHOD_3_B65E5FA17BCCE81D_OFFSET UNITYSDK_OFFSET(0x1B1A4C60)
#define RPG_GAMECORE_MODIFYCHARACTERFACEMATERIAL_METHOD_3_CA0DC2CC25EF50DC_OFFSET UNITYSDK_OFFSET(0x1B1A4CB0)
#define RPG_GAMECORE_MODIFYCHARACTERFACEMATERIAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1A4CA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyCharacterFaceMaterial_TypeDefinitionIndex = 21609;
