...
#define RPG_GAMECORE_MODIFYCHARACTERFACEMATERIAL_METHOD_3_CA0DC2CC25EF50DC_OFFSET UNITYSDK_OFFSET(0x1742AE40)
#define RPG_GAMECORE_MODIFYCHARACTERFACEMATERIAL_METHOD_3_F7FA7C37F154B721_OFFSET UNITYSDK_OFFSET(0x1742ADB0)
#define RPG_GAMECORE_MODIFYCHARACTERFACEMATERIAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1742AE10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyCharacterFaceMaterial_TypeDefinitionIndex = 20614;
