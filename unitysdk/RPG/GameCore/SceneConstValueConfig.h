...
#define RPG_GAMECORE_SCENECONSTVALUECONFIG_METHOD_2_DF6B4522CBBB4F8C_OFFSET UNITYSDK_OFFSET(0x18DFDEF0)
#define RPG_GAMECORE_SCENECONSTVALUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18DFE1B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SceneConstValueConfig_TypeDefinitionIndex = 18203;
