...
#define RPG_GAMECORE_UNLOCKTEAMLEADER_METHOD_3_367566B3A0E2CE5B_OFFSET UNITYSDK_OFFSET(0x178E3960)
#define RPG_GAMECORE_UNLOCKTEAMLEADER_METHOD_3_446AE6F0DA9737AB_OFFSET UNITYSDK_OFFSET(0x178E39F0)
#define RPG_GAMECORE_UNLOCKTEAMLEADER__CTOR_OFFSET UNITYSDK_OFFSET(0x178E39C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UnLockTeamLeader_TypeDefinitionIndex = 19766;
