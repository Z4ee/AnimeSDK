...
#define RPG_GAMECORE_SUBMISSIONIDLISTFORSKIPMCVVERIFY_METHOD_2_256808872E4EDEFA_OFFSET UNITYSDK_OFFSET(0x17788B40)
#define RPG_GAMECORE_SUBMISSIONIDLISTFORSKIPMCVVERIFY__CTOR_OFFSET UNITYSDK_OFFSET(0x17788C00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SubMissionIDListForSkipMCVVerify_TypeDefinitionIndex = 17440;

	class SubMissionIDListForSkipMCVVerify : public ::RPG::GameCore::JsonConfig
	{
	public:
		::Il2CppArray<::System::UInt32>* SubMissionIDList; // 0x10
