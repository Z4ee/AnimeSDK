...
#define RPG_GAMECORE_BYISENEMY_METHOD_4_2F44EDAB81B8D623_OFFSET UNITYSDK_OFFSET(0x1CF39400)
#define RPG_GAMECORE_BYISENEMY_METHOD_4_417FFE90E85AD7DF_OFFSET UNITYSDK_OFFSET(0x1CF395C0)
#define RPG_GAMECORE_BYISENEMY_METHOD_4_A3E59FA1452A3C3A_OFFSET UNITYSDK_OFFSET(0x1CF393C0)
#define RPG_GAMECORE_BYISENEMY_METHOD_4_E16AB73B98695001_OFFSET UNITYSDK_OFFSET(0x1CF395F0)
#define RPG_GAMECORE_BYISENEMY__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF393F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsEnemy_TypeDefinitionIndex = 23218;
