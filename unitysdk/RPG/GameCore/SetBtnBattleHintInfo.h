...
#define RPG_GAMECORE_SETBTNBATTLEHINTINFO_METHOD_3_2773F621116DB1D7_OFFSET UNITYSDK_OFFSET(0x19C2D7A0)
#define RPG_GAMECORE_SETBTNBATTLEHINTINFO_METHOD_3_5EC9E5B446C047B2_OFFSET UNITYSDK_OFFSET(0x19C2D820)
#define RPG_GAMECORE_SETBTNBATTLEHINTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19C2D7F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetBtnBattleHintInfo_TypeDefinitionIndex = 22180;
