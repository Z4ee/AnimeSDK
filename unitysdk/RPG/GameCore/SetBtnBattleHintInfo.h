...
#define RPG_GAMECORE_SETBTNBATTLEHINTINFO_METHOD_3_2773F621116DB1D7_OFFSET UNITYSDK_OFFSET(0x18E0E9A0)
#define RPG_GAMECORE_SETBTNBATTLEHINTINFO_METHOD_3_5EC9E5B446C047B2_OFFSET UNITYSDK_OFFSET(0x18E0EA20)
#define RPG_GAMECORE_SETBTNBATTLEHINTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18E0E9F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetBtnBattleHintInfo_TypeDefinitionIndex = 22426;
