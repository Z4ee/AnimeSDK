...
#define RPG_GAMECORE_SETENTITYARTROTATION_METHOD_3_680B84D556DACC77_OFFSET UNITYSDK_OFFSET(0x19C4B1D0)
#define RPG_GAMECORE_SETENTITYARTROTATION_METHOD_3_C86C3BF8514071D5_OFFSET UNITYSDK_OFFSET(0x19C4B370)
#define RPG_GAMECORE_SETENTITYARTROTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x19C4B210)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetEntityArtRotation_TypeDefinitionIndex = 22452;
