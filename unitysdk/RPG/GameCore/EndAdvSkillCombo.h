...
#define RPG_GAMECORE_ENDADVSKILLCOMBO_METHOD_3_A46266F8FBFC23F2_OFFSET UNITYSDK_OFFSET(0x1D064A50)
#define RPG_GAMECORE_ENDADVSKILLCOMBO_METHOD_3_F6245AAE72492979_OFFSET UNITYSDK_OFFSET(0x1D064A90)
#define RPG_GAMECORE_ENDADVSKILLCOMBO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D064A80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EndAdvSkillCombo_TypeDefinitionIndex = 19960;
