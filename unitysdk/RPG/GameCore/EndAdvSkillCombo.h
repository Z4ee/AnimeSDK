...
#define RPG_GAMECORE_ENDADVSKILLCOMBO_METHOD_3_20437EBCF81BDD80_OFFSET UNITYSDK_OFFSET(0x196E6510)
#define RPG_GAMECORE_ENDADVSKILLCOMBO_METHOD_3_F6245AAE72492979_OFFSET UNITYSDK_OFFSET(0x196E6590)
#define RPG_GAMECORE_ENDADVSKILLCOMBO__CTOR_OFFSET UNITYSDK_OFFSET(0x196E6560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EndAdvSkillCombo_TypeDefinitionIndex = 19062;
