...
#define RPG_GAMECORE_ENDADVSKILLCOMBO_METHOD_3_20437EBCF81BDD80_OFFSET UNITYSDK_OFFSET(0x1719A860)
#define RPG_GAMECORE_ENDADVSKILLCOMBO_METHOD_3_F6245AAE72492979_OFFSET UNITYSDK_OFFSET(0x1719A8E0)
#define RPG_GAMECORE_ENDADVSKILLCOMBO__CTOR_OFFSET UNITYSDK_OFFSET(0x1719A8B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EndAdvSkillCombo_TypeDefinitionIndex = 18478;
