...
#define RPG_GAMECORE_SYNCWAIT_METHOD_3_0E6A27BDB61D3998_OFFSET UNITYSDK_OFFSET(0x18ECA510)
#define RPG_GAMECORE_SYNCWAIT_METHOD_3_975D5E4811DC7471_OFFSET UNITYSDK_OFFSET(0x18ECA490)
#define RPG_GAMECORE_SYNCWAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x18ECA4E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SyncWait_TypeDefinitionIndex = 19390;
