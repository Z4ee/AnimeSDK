...
#define RPG_GAMECORE_LOCKBATTLEOPERATION_METHOD_3_38D11BDB07730332_OFFSET UNITYSDK_OFFSET(0x17369FB0)
#define RPG_GAMECORE_LOCKBATTLEOPERATION_METHOD_3_C3862A681EBD482D_OFFSET UNITYSDK_OFFSET(0x17369F30)
#define RPG_GAMECORE_LOCKBATTLEOPERATION__CTOR_OFFSET UNITYSDK_OFFSET(0x17369F80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LockBattleOperation_TypeDefinitionIndex = 21513;
