...
#define RPG_GAMECORE_STARTSUBGRAPHRAW_METHOD_3_417528287A40BC9C_OFFSET UNITYSDK_OFFSET(0x18E9BF40)
#define RPG_GAMECORE_STARTSUBGRAPHRAW_METHOD_3_6C43293600FF5166_OFFSET UNITYSDK_OFFSET(0x18E9BFC0)
#define RPG_GAMECORE_STARTSUBGRAPHRAW__CTOR_OFFSET UNITYSDK_OFFSET(0x18E9BF90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StartSubGraphRaw_TypeDefinitionIndex = 19695;
