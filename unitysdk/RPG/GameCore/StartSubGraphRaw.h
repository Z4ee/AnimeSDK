...
#define RPG_GAMECORE_STARTSUBGRAPHRAW_METHOD_3_417528287A40BC9C_OFFSET UNITYSDK_OFFSET(0x17776360)
#define RPG_GAMECORE_STARTSUBGRAPHRAW_METHOD_3_6C43293600FF5166_OFFSET UNITYSDK_OFFSET(0x177763E0)
#define RPG_GAMECORE_STARTSUBGRAPHRAW__CTOR_OFFSET UNITYSDK_OFFSET(0x177763B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StartSubGraphRaw_TypeDefinitionIndex = 19037;
