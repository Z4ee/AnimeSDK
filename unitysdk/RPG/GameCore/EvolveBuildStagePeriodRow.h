...
#define RPG_GAMECORE_EVOLVEBUILDSTAGEPERIODROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D7D4D90)
#define RPG_GAMECORE_EVOLVEBUILDSTAGEPERIODROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7D5730)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EvolveBuildStagePeriodRow_TypeDefinitionIndex = 11405;
	...
	public:
		...
		::System::UInt32 PeriodScore; // 0x30
		::System::UInt32 StageID; // 0x34
		::RPG::GameCore::EvolvePeriodType PeriodRank; // 0x38
		::System::UInt32 EventID; // 0x3C
		::System::UInt32 WaveCount; // 0x40
		::System::UInt32 StagePeriodID; // 0x44
		::System::UInt32 StageScore; // 0x48
		::System::UInt32 BattleArea; // 0x4C
