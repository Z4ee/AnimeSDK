...
#define RPG_GAMECORE_EVOLVEBUILDSTAGEPERIODROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x196FC560)
#define RPG_GAMECORE_EVOLVEBUILDSTAGEPERIODROW__CTOR_OFFSET UNITYSDK_OFFSET(0x196FCF00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EvolveBuildStagePeriodRow_TypeDefinitionIndex = 10980;

	class EvolveBuildStagePeriodRow : public ::System::Object
	{
	public:
		::Il2CppArray<::Class_1_73B429E1E9F270F4*>* WeaknessList; // 0x10
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::UInt32>* SpecialMonsterScoreList; // 0x18
		::Il2CppArray<::System::Single>* EmotionList; // 0x20
		::Il2CppArray<::System::UInt32>* CountdownList; // 0x28
		::System::UInt32 StageID; // 0x30
		::System::UInt32 EventID; // 0x34
		::System::UInt32 Weight; // 0x38
		::RPG::GameCore::FixPoint DeadLinePosition; // 0x40
		::RPG::GameCore::EvolvePeriodType PeriodRank; // 0x48
		::System::UInt32 StageScore; // 0x4C
		::System::UInt32 BattleArea; // 0x50
		::System::UInt32 StagePeriodID; // 0x54
		::System::UInt32 PeriodScore; // 0x58
		::System::UInt32 WaveCount; // 0x5C
