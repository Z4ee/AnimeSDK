...
#define RPG_GAMECORE_TARGETOPERATIONCONFIGLIST_METHOD_2_8FB9FB731A6421CC_OFFSET UNITYSDK_OFFSET(0x1D5B5D00)
#define RPG_GAMECORE_TARGETOPERATIONCONFIGLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5B5DE0)
