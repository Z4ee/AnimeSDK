...
#define RPG_GAMECORE_FORCEPLAYERMOVEFORWARDONLY_METHOD_3_1A3D665CB3CA6920_OFFSET UNITYSDK_OFFSET(0x17216EE0)
#define RPG_GAMECORE_FORCEPLAYERMOVEFORWARDONLY_METHOD_3_9E017A2BE9CE1F71_OFFSET UNITYSDK_OFFSET(0x17216F60)
#define RPG_GAMECORE_FORCEPLAYERMOVEFORWARDONLY__CTOR_OFFSET UNITYSDK_OFFSET(0x17216F30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ForcePlayerMoveForwardOnly_TypeDefinitionIndex = 19155;
