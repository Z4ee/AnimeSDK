...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERGAINORBBONUSAFTERUSEORBCONFIG_METHOD_3_9B95CB75EC905E2A_OFFSET UNITYSDK_OFFSET(0x1726B270)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERGAINORBBONUSAFTERUSEORBCONFIG_METHOD_3_C59879B948CC79E3_OFFSET UNITYSDK_OFFSET(0x17267B80)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERGAINORBBONUSAFTERUSEORBCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17267B30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierGainOrbBonusAfterUseOrbConfig_TypeDefinitionIndex = 17816;
