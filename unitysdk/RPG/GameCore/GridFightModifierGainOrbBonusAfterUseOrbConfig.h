...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERGAINORBBONUSAFTERUSEORBCONFIG_METHOD_3_A056CF91685F99DF_OFFSET UNITYSDK_OFFSET(0x1D069F70)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERGAINORBBONUSAFTERUSEORBCONFIG_METHOD_3_C59879B948CC79E3_OFFSET UNITYSDK_OFFSET(0x1D069FC0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERGAINORBBONUSAFTERUSEORBCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D069FB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierGainOrbBonusAfterUseOrbConfig_TypeDefinitionIndex = 18654;
