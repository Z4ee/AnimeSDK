...
#define RPG_GAMECORE_TARGETFETCHFARMELEMENTENTITY_METHOD_4_8307BD6EF40BB23F_OFFSET UNITYSDK_OFFSET(0x18EDD100)
#define RPG_GAMECORE_TARGETFETCHFARMELEMENTENTITY_METHOD_4_8895C50C92BA7DE1_OFFSET UNITYSDK_OFFSET(0x18EE4300)
#define RPG_GAMECORE_TARGETFETCHFARMELEMENTENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x18EDD0B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchFarmElementEntity_TypeDefinitionIndex = 22956;
