...
#define RPG_GAMECORE_BYCHECKACTIONDELAYCHANGED_METHOD_4_4E5FF9291EBC422A_OFFSET UNITYSDK_OFFSET(0x18720820)
#define RPG_GAMECORE_BYCHECKACTIONDELAYCHANGED_METHOD_4_8086A183F161BF34_OFFSET UNITYSDK_OFFSET(0x187208F0)
#define RPG_GAMECORE_BYCHECKACTIONDELAYCHANGED__CTOR_OFFSET UNITYSDK_OFFSET(0x187208A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckActionDelayChanged_TypeDefinitionIndex = 21964;
