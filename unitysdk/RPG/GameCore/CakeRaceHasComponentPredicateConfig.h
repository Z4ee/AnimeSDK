...
#define RPG_GAMECORE_CAKERACEHASCOMPONENTPREDICATECONFIG_METHOD_3_CB3B8593AD51DDDE_OFFSET UNITYSDK_OFFSET(0x1704CBD0)
#define RPG_GAMECORE_CAKERACEHASCOMPONENTPREDICATECONFIG_METHOD_3_F620C7817D0CC28E_OFFSET UNITYSDK_OFFSET(0x17048040)
#define RPG_GAMECORE_CAKERACEHASCOMPONENTPREDICATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17048030)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceHasComponentPredicateConfig_TypeDefinitionIndex = 16874;
