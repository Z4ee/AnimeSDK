...
#define RPG_GAMECORE_LEVELROTATABLEBAKEDINFO_DISPOSE_OFFSET UNITYSDK_OFFSET(0x7B0860)
#define RPG_GAMECORE_LEVELROTATABLEBAKEDINFO_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x3A1B210)
#define RPG_GAMECORE_LEVELROTATABLEBAKEDINFO_EQUALS_OFFSET UNITYSDK_OFFSET(0x7C5660)
#define RPG_GAMECORE_LEVELROTATABLEBAKEDINFO_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8817F0)
#define RPG_GAMECORE_LEVELROTATABLEBAKEDINFO_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x881730)
#define RPG_GAMECORE_LEVELROTATABLEBAKEDINFO_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0x676EB0)
#define RPG_GAMECORE_LEVELROTATABLEBAKEDINFO_GET_POOL_OFFSET UNITYSDK_OFFSET(0x1651A0)
#define RPG_GAMECORE_LEVELROTATABLEBAKEDINFO_GET_ROTATABLEREGIONLIST_OFFSET UNITYSDK_OFFSET(0x3A1B220)
#define RPG_GAMECORE_LEVELROTATABLEBAKEDINFO_INIT_OFFSET UNITYSDK_OFFSET(0x6E35A0)
#define RPG_GAMECORE_LEVELROTATABLEBAKEDINFO_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1B088890)
#define RPG_GAMECORE_LEVELROTATABLEBAKEDINFO_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1B088AD0)
#define RPG_GAMECORE_LEVELROTATABLEBAKEDINFO_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1B0889A0)
#define RPG_GAMECORE_LEVELROTATABLEBAKEDINFO_OP_LOGICALNOT_OFFSET UNITYSDK_OFFSET(0x1B088B80)
#define RPG_GAMECORE_LEVELROTATABLEBAKEDINFO_SET_ROTATABLEREGIONLIST_OFFSET UNITYSDK_OFFSET(0x3A1B240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelRotatableBakedInfo_TypeDefinitionIndex = 10368;
