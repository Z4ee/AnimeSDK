...
#define RPG_GAMECORE_LEVELROTATABLEBAKEDINFO_DISPOSE_OFFSET UNITYSDK_OFFSET(0x3B78740)
#define RPG_GAMECORE_LEVELROTATABLEBAKEDINFO_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x3B8AF40)
#define RPG_GAMECORE_LEVELROTATABLEBAKEDINFO_EQUALS_OFFSET UNITYSDK_OFFSET(0x2F10A00)
#define RPG_GAMECORE_LEVELROTATABLEBAKEDINFO_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x2F3A950)
#define RPG_GAMECORE_LEVELROTATABLEBAKEDINFO_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x2F3A750)
#define RPG_GAMECORE_LEVELROTATABLEBAKEDINFO_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0xDAB0)
#define RPG_GAMECORE_LEVELROTATABLEBAKEDINFO_GET_POOL_OFFSET UNITYSDK_OFFSET(0x5AB0)
#define RPG_GAMECORE_LEVELROTATABLEBAKEDINFO_GET_ROTATABLEREGIONLIST_OFFSET UNITYSDK_OFFSET(0x3B8AF50)
#define RPG_GAMECORE_LEVELROTATABLEBAKEDINFO_INIT_OFFSET UNITYSDK_OFFSET(0x8EB60)
#define RPG_GAMECORE_LEVELROTATABLEBAKEDINFO_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1D1EDB40)
#define RPG_GAMECORE_LEVELROTATABLEBAKEDINFO_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1D1EE860)
#define RPG_GAMECORE_LEVELROTATABLEBAKEDINFO_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1D1EDC40)
#define RPG_GAMECORE_LEVELROTATABLEBAKEDINFO_OP_LOGICALNOT_OFFSET UNITYSDK_OFFSET(0x1D1EE9C0)
#define RPG_GAMECORE_LEVELROTATABLEBAKEDINFO_SET_ROTATABLEREGIONLIST_OFFSET UNITYSDK_OFFSET(0x3B8AF70)
