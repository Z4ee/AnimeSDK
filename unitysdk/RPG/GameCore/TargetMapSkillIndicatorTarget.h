...
#define RPG_GAMECORE_TARGETMAPSKILLINDICATORTARGET_METHOD_3_7317338E88E5174D_OFFSET UNITYSDK_OFFSET(0x1D5B4A30)
#define RPG_GAMECORE_TARGETMAPSKILLINDICATORTARGET_METHOD_3_73983B5BEC62008A_OFFSET UNITYSDK_OFFSET(0x1D5B4B30)
#define RPG_GAMECORE_TARGETMAPSKILLINDICATORTARGET_METHOD_3_8E60D20B81ACC3D7_OFFSET UNITYSDK_OFFSET(0x1D5B4B10)
#define RPG_GAMECORE_TARGETMAPSKILLINDICATORTARGET_METHOD_3_B501871CBD6F1EE8_OFFSET UNITYSDK_OFFSET(0x1D5B4AB0)
#define RPG_GAMECORE_TARGETMAPSKILLINDICATORTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5B4AA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapSkillIndicatorTarget_TypeDefinitionIndex = 23758;
