...
#define RPG_GAMECORE_COMMONSKILL_METHOD_2_6661381D32AC6F5B_OFFSET UNITYSDK_OFFSET(0x1D9A7170)
#define RPG_GAMECORE_COMMONSKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D9A72A0)
