...
#define RPG_GAMECORE_COMMONSKILL_METHOD_2_6661381D32AC6F5B_OFFSET UNITYSDK_OFFSET(0x1CFF0560)
#define RPG_GAMECORE_COMMONSKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFF0690)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CommonSkill_TypeDefinitionIndex = 17935;
