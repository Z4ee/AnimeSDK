...
#define RPG_GAMECORE_SETMODIFIEREFFECTVISIBLE_METHOD_3_6C20CB97CD84EBA5_OFFSET UNITYSDK_OFFSET(0x176D6340)
#define RPG_GAMECORE_SETMODIFIEREFFECTVISIBLE_METHOD_3_8F8E0CF694B8024C_OFFSET UNITYSDK_OFFSET(0x176D62C0)
#define RPG_GAMECORE_SETMODIFIEREFFECTVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x176D6310)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetModifierEffectVisible_TypeDefinitionIndex = 21877;
