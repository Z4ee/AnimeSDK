...
#define RPG_GAMECORE_BASESCROLLGAMEBLOCKCONFIG_METHOD_2_7BF217C5D4F83FE6_OFFSET UNITYSDK_OFFSET(0x16FCA320)
#define RPG_GAMECORE_BASESCROLLGAMEBLOCKCONFIG_METHOD_2_B7655C643B361DE1_OFFSET UNITYSDK_OFFSET(0x16FCA4E0)
#define RPG_GAMECORE_BASESCROLLGAMEBLOCKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16FCA4D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BaseScrollGameBlockConfig_TypeDefinitionIndex = 17258;
