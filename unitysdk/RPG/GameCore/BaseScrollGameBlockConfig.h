...
#define RPG_GAMECORE_BASESCROLLGAMEBLOCKCONFIG_METHOD_2_7BF217C5D4F83FE6_OFFSET UNITYSDK_OFFSET(0x1A3E1450)
#define RPG_GAMECORE_BASESCROLLGAMEBLOCKCONFIG_METHOD_2_B7655C643B361DE1_OFFSET UNITYSDK_OFFSET(0x1A3E1610)
#define RPG_GAMECORE_BASESCROLLGAMEBLOCKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3E1600)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BaseScrollGameBlockConfig_TypeDefinitionIndex = 18073;
