...
#define RPG_GAMECORE_CHIMERATEAMWORKINCREASEPHASECONFIG_METHOD_2_30EE0AFD3EBEEAE2_OFFSET UNITYSDK_OFFSET(0x170AC660)
#define RPG_GAMECORE_CHIMERATEAMWORKINCREASEPHASECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x170AC6A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraTeamWorkIncreasePhaseConfig_TypeDefinitionIndex = 14584;
