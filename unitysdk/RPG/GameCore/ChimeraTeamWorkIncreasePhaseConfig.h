...
#define RPG_GAMECORE_CHIMERATEAMWORKINCREASEPHASECONFIG_METHOD_2_30EE0AFD3EBEEAE2_OFFSET UNITYSDK_OFFSET(0x1CFD4A70)
#define RPG_GAMECORE_CHIMERATEAMWORKINCREASEPHASECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFD4AB0)
