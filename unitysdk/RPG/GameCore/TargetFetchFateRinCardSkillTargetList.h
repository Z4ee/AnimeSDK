...
#define RPG_GAMECORE_TARGETFETCHFATERINCARDSKILLTARGETLIST_METHOD_4_0C33D8F949300978_OFFSET UNITYSDK_OFFSET(0x1D0B9FC0)
#define RPG_GAMECORE_TARGETFETCHFATERINCARDSKILLTARGETLIST_METHOD_4_4054C9BF14CFADB0_OFFSET UNITYSDK_OFFSET(0x1D0B9EE0)
#define RPG_GAMECORE_TARGETFETCHFATERINCARDSKILLTARGETLIST_METHOD_4_5F1A9D2E07C53485_OFFSET UNITYSDK_OFFSET(0x1D0B9FE0)
#define RPG_GAMECORE_TARGETFETCHFATERINCARDSKILLTARGETLIST_METHOD_4_88C041CCFC0D3C35_OFFSET UNITYSDK_OFFSET(0x1D0B9F60)
#define RPG_GAMECORE_TARGETFETCHFATERINCARDSKILLTARGETLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0B9F50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchFateRinCardSkillTargetList_TypeDefinitionIndex = 23161;
