...
#define RPG_GAMECORE_ST_SIDE_RECORDGUARDPOSITION_METHOD_4_55FACA78510074A7_OFFSET UNITYSDK_OFFSET(0x19C0CC90)
#define RPG_GAMECORE_ST_SIDE_RECORDGUARDPOSITION_METHOD_4_C781F9A157C524F8_OFFSET UNITYSDK_OFFSET(0x19C1AE30)
#define RPG_GAMECORE_ST_SIDE_RECORDGUARDPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x19C0CC40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_RecordGuardPosition_TypeDefinitionIndex = 18980;
