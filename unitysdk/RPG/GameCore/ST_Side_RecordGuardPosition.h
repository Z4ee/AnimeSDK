...
#define RPG_GAMECORE_ST_SIDE_RECORDGUARDPOSITION_METHOD_4_55FACA78510074A7_OFFSET UNITYSDK_OFFSET(0x1768EC70)
#define RPG_GAMECORE_ST_SIDE_RECORDGUARDPOSITION_METHOD_4_C781F9A157C524F8_OFFSET UNITYSDK_OFFSET(0x176999F0)
#define RPG_GAMECORE_ST_SIDE_RECORDGUARDPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1768EC20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_RecordGuardPosition_TypeDefinitionIndex = 18387;
