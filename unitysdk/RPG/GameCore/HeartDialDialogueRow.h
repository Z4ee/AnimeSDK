...
#define RPG_GAMECORE_HEARTDIALDIALOGUEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17297A80)
#define RPG_GAMECORE_HEARTDIALDIALOGUEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17297C30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HeartDialDialogueRow_TypeDefinitionIndex = 12549;
