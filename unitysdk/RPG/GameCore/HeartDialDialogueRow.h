...
#define RPG_GAMECORE_HEARTDIALDIALOGUEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1981F7C0)
#define RPG_GAMECORE_HEARTDIALDIALOGUEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1981F960)
