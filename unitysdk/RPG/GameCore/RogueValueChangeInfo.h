...
#define RPG_GAMECORE_ROGUEVALUECHANGEINFO_METHOD_2_C62EBC2D96118321_OFFSET UNITYSDK_OFFSET(0x17672BA0)
#define RPG_GAMECORE_ROGUEVALUECHANGEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x17672CE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueValueChangeInfo_TypeDefinitionIndex = 10168;
