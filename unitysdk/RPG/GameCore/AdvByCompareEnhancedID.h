...
#define RPG_GAMECORE_ADVBYCOMPAREENHANCEDID_METHOD_4_97DD49AACD78F8E7_OFFSET UNITYSDK_OFFSET(0x16F25D60)
#define RPG_GAMECORE_ADVBYCOMPAREENHANCEDID_METHOD_4_C0839328241C0457_OFFSET UNITYSDK_OFFSET(0x16F25C90)
#define RPG_GAMECORE_ADVBYCOMPAREENHANCEDID__CTOR_OFFSET UNITYSDK_OFFSET(0x16F25D10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvByCompareEnhancedID_TypeDefinitionIndex = 18900;
