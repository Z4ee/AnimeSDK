...
#define RPG_GAMECORE_OPENTIMEREWINDPAGE_METHOD_3_C56BDF49FA4EFE6F_OFFSET UNITYSDK_OFFSET(0x199D7DC0)
#define RPG_GAMECORE_OPENTIMEREWINDPAGE_METHOD_3_DA4D061F7269624B_OFFSET UNITYSDK_OFFSET(0x199D7D40)
#define RPG_GAMECORE_OPENTIMEREWINDPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x199D7D90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OpenTimeRewindPage_TypeDefinitionIndex = 19506;
