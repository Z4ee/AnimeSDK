...
#define RPG_GAMECORE_ELFSPECIALEVENTCONFIG_METHOD_2_41E5BF2E79C5FD89_OFFSET UNITYSDK_OFFSET(0x171913D0)
#define RPG_GAMECORE_ELFSPECIALEVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17191570)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfSpecialEventConfig_TypeDefinitionIndex = 16973;
