...
#define RPG_GAMECORE_ELFSPECIALEVENTCONFIG_METHOD_2_41E5BF2E79C5FD89_OFFSET UNITYSDK_OFFSET(0x1D7B66C0)
#define RPG_GAMECORE_ELFSPECIALEVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7B6860)
