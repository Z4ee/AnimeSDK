...
#define RPG_GAMECORE_MODIFIERREATTACHEFFECT_METHOD_3_128BE72D99351558_OFFSET UNITYSDK_OFFSET(0x18B35440)
#define RPG_GAMECORE_MODIFIERREATTACHEFFECT_METHOD_3_D8BFFCBD0AC59557_OFFSET UNITYSDK_OFFSET(0x18B353C0)
#define RPG_GAMECORE_MODIFIERREATTACHEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x18B35410)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifierReattachEffect_TypeDefinitionIndex = 20589;
