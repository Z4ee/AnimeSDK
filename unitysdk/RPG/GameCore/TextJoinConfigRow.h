...
#define RPG_GAMECORE_TEXTJOINCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19095940)
#define RPG_GAMECORE_TEXTJOINCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19095B50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TextJoinConfigRow_TypeDefinitionIndex = 14482;
