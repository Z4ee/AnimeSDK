...
#define RPG_GAMECORE_CLOCKPARKSTORYSETBACKGROUNDFRONTVISIBLE_METHOD_3_28E2C3C4302B0DD0_OFFSET UNITYSDK_OFFSET(0x1C262440)
#define RPG_GAMECORE_CLOCKPARKSTORYSETBACKGROUNDFRONTVISIBLE_METHOD_3_45F7AECB67CE2393_OFFSET UNITYSDK_OFFSET(0x1C262400)
#define RPG_GAMECORE_CLOCKPARKSTORYSETBACKGROUNDFRONTVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C262430)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClockParkStorySetBackgroundFrontVisible_TypeDefinitionIndex = 20162;
