...
#define RPG_GAMECORE_CLOCKPARKSTORYSETBACKGROUNDFRONTVISIBLE_METHOD_3_28E2C3C4302B0DD0_OFFSET UNITYSDK_OFFSET(0x19661C20)
#define RPG_GAMECORE_CLOCKPARKSTORYSETBACKGROUNDFRONTVISIBLE_METHOD_3_4A695E9682EC5889_OFFSET UNITYSDK_OFFSET(0x19661BA0)
#define RPG_GAMECORE_CLOCKPARKSTORYSETBACKGROUNDFRONTVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x19661BF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClockParkStorySetBackgroundFrontVisible_TypeDefinitionIndex = 19802;
