...
#define RPG_GAMECORE_SCRTRFACTPERFORMANCEGROUP_METHOD_3_87DF695F8FF4D7B1_OFFSET UNITYSDK_OFFSET(0x1769D140)
#define RPG_GAMECORE_SCRTRFACTPERFORMANCEGROUP_METHOD_3_F48385B8F0589F55_OFFSET UNITYSDK_OFFSET(0x1769D180)
#define RPG_GAMECORE_SCRTRFACTPERFORMANCEGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1769D170)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ScrTrfActPerformanceGroup_TypeDefinitionIndex = 19186;
