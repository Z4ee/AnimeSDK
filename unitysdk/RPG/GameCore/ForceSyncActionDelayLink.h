...
#define RPG_GAMECORE_FORCESYNCACTIONDELAYLINK_METHOD_3_4E7A364C32B087EC_OFFSET UNITYSDK_OFFSET(0x1D110500)
#define RPG_GAMECORE_FORCESYNCACTIONDELAYLINK_METHOD_3_F6DBF6FDA5913293_OFFSET UNITYSDK_OFFSET(0x1D110540)
#define RPG_GAMECORE_FORCESYNCACTIONDELAYLINK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D110530)
