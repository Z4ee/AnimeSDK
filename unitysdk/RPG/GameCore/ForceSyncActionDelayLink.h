...
#define RPG_GAMECORE_FORCESYNCACTIONDELAYLINK_METHOD_3_1D80F065011EF6C7_OFFSET UNITYSDK_OFFSET(0x17217600)
#define RPG_GAMECORE_FORCESYNCACTIONDELAYLINK_METHOD_3_F6DBF6FDA5913293_OFFSET UNITYSDK_OFFSET(0x17217680)
#define RPG_GAMECORE_FORCESYNCACTIONDELAYLINK__CTOR_OFFSET UNITYSDK_OFFSET(0x17217650)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ForceSyncActionDelayLink_TypeDefinitionIndex = 21508;
