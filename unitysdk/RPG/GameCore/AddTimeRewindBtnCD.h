...
#define RPG_GAMECORE_ADDTIMEREWINDBTNCD_METHOD_3_3A85B19702FD669D_OFFSET UNITYSDK_OFFSET(0x1D6A59A0)
#define RPG_GAMECORE_ADDTIMEREWINDBTNCD_METHOD_3_5D6D1015A5B7E4BE_OFFSET UNITYSDK_OFFSET(0x1D6A5960)
#define RPG_GAMECORE_ADDTIMEREWINDBTNCD__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6A5990)
