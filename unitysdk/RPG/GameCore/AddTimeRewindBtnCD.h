...
#define RPG_GAMECORE_ADDTIMEREWINDBTNCD_METHOD_3_3A85B19702FD669D_OFFSET UNITYSDK_OFFSET(0x18644300)
#define RPG_GAMECORE_ADDTIMEREWINDBTNCD_METHOD_3_6C3C078BC674FBBB_OFFSET UNITYSDK_OFFSET(0x18644280)
#define RPG_GAMECORE_ADDTIMEREWINDBTNCD__CTOR_OFFSET UNITYSDK_OFFSET(0x186442D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddTimeRewindBtnCD_TypeDefinitionIndex = 19657;
