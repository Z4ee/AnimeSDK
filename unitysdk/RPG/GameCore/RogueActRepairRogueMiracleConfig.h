...
#define RPG_GAMECORE_ROGUEACTREPAIRROGUEMIRACLECONFIG_METHOD_6_419E5DCF615E2870_OFFSET UNITYSDK_OFFSET(0x175C6CB0)
#define RPG_GAMECORE_ROGUEACTREPAIRROGUEMIRACLECONFIG_METHOD_6_4E93945C37C23FFD_OFFSET UNITYSDK_OFFSET(0x175C6A90)
#define RPG_GAMECORE_ROGUEACTREPAIRROGUEMIRACLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175C6BD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActRepairRogueMiracleConfig_TypeDefinitionIndex = 17966;
