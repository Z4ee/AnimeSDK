...
#define RPG_GAMECORE_ROGUETAKEINITIALSCORE_METHOD_3_311FD5654CD0276C_OFFSET UNITYSDK_OFFSET(0x18D688F0)
#define RPG_GAMECORE_ROGUETAKEINITIALSCORE_METHOD_3_C2AC8B3BB5B44EF8_OFFSET UNITYSDK_OFFSET(0x18D68A00)
#define RPG_GAMECORE_ROGUETAKEINITIALSCORE__CTOR_OFFSET UNITYSDK_OFFSET(0x18D689D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTakeInitialScore_TypeDefinitionIndex = 21165;
