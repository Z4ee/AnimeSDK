...
#define RPG_GAMECORE_ROGUETOURNBUFFTYPEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D4155B0)
#define RPG_GAMECORE_ROGUETOURNBUFFTYPEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D415DB0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID RogueBuffTypeSubTitle; // 0x38
