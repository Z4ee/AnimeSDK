...
#define RPG_GAMECORE_TARGETTAKE_METHOD_3_0A7EE2D72351A36B_OFFSET UNITYSDK_OFFSET(0x1E1C54A0)
#define RPG_GAMECORE_TARGETTAKE_METHOD_3_821CD192B94A0914_OFFSET UNITYSDK_OFFSET(0x1E1C5640)
#define RPG_GAMECORE_TARGETTAKE_METHOD_3_9A002E355B91401B_OFFSET UNITYSDK_OFFSET(0x1E1C5670)
#define RPG_GAMECORE_TARGETTAKE_METHOD_3_B8832C23CD13191E_OFFSET UNITYSDK_OFFSET(0x1E1C5580)
#define RPG_GAMECORE_TARGETTAKE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1C5570)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetTake_TypeDefinitionIndex = 23627;
