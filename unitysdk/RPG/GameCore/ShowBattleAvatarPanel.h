...
#define RPG_GAMECORE_SHOWBATTLEAVATARPANEL_METHOD_3_05CBF51A487B2BE6_OFFSET UNITYSDK_OFFSET(0x1BE39B10)
#define RPG_GAMECORE_SHOWBATTLEAVATARPANEL_METHOD_3_785F613C145EA72B_OFFSET UNITYSDK_OFFSET(0x1BE39B50)
#define RPG_GAMECORE_SHOWBATTLEAVATARPANEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE39B40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowBattleAvatarPanel_TypeDefinitionIndex = 21994;
