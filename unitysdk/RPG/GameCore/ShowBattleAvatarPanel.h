...
#define RPG_GAMECORE_SHOWBATTLEAVATARPANEL_METHOD_3_604AC1897EB29525_OFFSET UNITYSDK_OFFSET(0x19C74A80)
#define RPG_GAMECORE_SHOWBATTLEAVATARPANEL_METHOD_3_785F613C145EA72B_OFFSET UNITYSDK_OFFSET(0x19C74B00)
#define RPG_GAMECORE_SHOWBATTLEAVATARPANEL__CTOR_OFFSET UNITYSDK_OFFSET(0x19C74AD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowBattleAvatarPanel_TypeDefinitionIndex = 21572;
