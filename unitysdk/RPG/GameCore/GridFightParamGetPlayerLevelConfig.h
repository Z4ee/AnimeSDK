...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETPLAYERLEVELCONFIG_METHOD_6_5CA5140B78471E08_OFFSET UNITYSDK_OFFSET(0x197FA880)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETPLAYERLEVELCONFIG_METHOD_6_71D3F2292D4210AE_OFFSET UNITYSDK_OFFSET(0x197FA5D0)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETPLAYERLEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197FA750)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightParamGetPlayerLevelConfig_TypeDefinitionIndex = 18496;
