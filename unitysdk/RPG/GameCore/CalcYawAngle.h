...
#define RPG_GAMECORE_CALCYAWANGLE_METHOD_3_5262ADC707A26CAC_OFFSET UNITYSDK_OFFSET(0x17051900)
#define RPG_GAMECORE_CALCYAWANGLE_METHOD_3_5943AA44D46F100E_OFFSET UNITYSDK_OFFSET(0x17051980)
#define RPG_GAMECORE_CALCYAWANGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x17051950)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CalcYawAngle_TypeDefinitionIndex = 18528;
