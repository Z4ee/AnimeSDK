...
#define RPG_GAMECORE_RESETTARGETLISTINDEX_METHOD_3_3FC290995FF3DCA5_OFFSET UNITYSDK_OFFSET(0x18CAB5E0)
#define RPG_GAMECORE_RESETTARGETLISTINDEX_METHOD_3_D9C4AFB56CE4CDD9_OFFSET UNITYSDK_OFFSET(0x18CAB6F0)
#define RPG_GAMECORE_RESETTARGETLISTINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0x18CAB6C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetTargetListIndex_TypeDefinitionIndex = 21350;
