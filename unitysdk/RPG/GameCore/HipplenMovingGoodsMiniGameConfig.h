...
#define RPG_GAMECORE_HIPPLENMOVINGGOODSMINIGAMECONFIG_METHOD_2_5BFAB2459B2D9F9A_OFFSET UNITYSDK_OFFSET(0x1D204B30)
#define RPG_GAMECORE_HIPPLENMOVINGGOODSMINIGAMECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D204EE0)
