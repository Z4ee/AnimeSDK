...
#define RPG_GAMECORE_BYCHIMERADUELISMASTERSELECTED_METHOD_4_1DAA222659CC2643_OFFSET UNITYSDK_OFFSET(0x19CCE020)
#define RPG_GAMECORE_BYCHIMERADUELISMASTERSELECTED_METHOD_4_525B4DA2CD16C60C_OFFSET UNITYSDK_OFFSET(0x19CCE050)
#define RPG_GAMECORE_BYCHIMERADUELISMASTERSELECTED_METHOD_4_D7DAAC50D7F0DDFA_OFFSET UNITYSDK_OFFSET(0x19CCDE70)
#define RPG_GAMECORE_BYCHIMERADUELISMASTERSELECTED_METHOD_4_DD6DF32DC627F547_OFFSET UNITYSDK_OFFSET(0x19CCDEB0)
#define RPG_GAMECORE_BYCHIMERADUELISMASTERSELECTED__CTOR_OFFSET UNITYSDK_OFFSET(0x19CCDEA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByChimeraDuelIsMasterSelected_TypeDefinitionIndex = 23450;
