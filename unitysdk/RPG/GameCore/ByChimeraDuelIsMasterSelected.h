...
#define RPG_GAMECORE_BYCHIMERADUELISMASTERSELECTED_METHOD_4_DD6DF32DC627F547_OFFSET UNITYSDK_OFFSET(0x18725CE0)
#define RPG_GAMECORE_BYCHIMERADUELISMASTERSELECTED_METHOD_4_DE1F85B3568C50C5_OFFSET UNITYSDK_OFFSET(0x18725C10)
#define RPG_GAMECORE_BYCHIMERADUELISMASTERSELECTED__CTOR_OFFSET UNITYSDK_OFFSET(0x18725C90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByChimeraDuelIsMasterSelected_TypeDefinitionIndex = 23318;
