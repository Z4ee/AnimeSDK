...
#define RPG_GAMECORE_MAPROTATIONCHARGERICONCONFIG_METHOD_2_79BFD01625A3526D_OFFSET UNITYSDK_OFFSET(0x1737F950)
#define RPG_GAMECORE_MAPROTATIONCHARGERICONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1737FAB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MapRotationChargerIconConfig_TypeDefinitionIndex = 15601;
