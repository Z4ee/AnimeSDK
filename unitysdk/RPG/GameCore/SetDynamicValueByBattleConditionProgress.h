...
#define RPG_GAMECORE_SETDYNAMICVALUEBYBATTLECONDITIONPROGRESS_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x19C40450)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBATTLECONDITIONPROGRESS_METHOD_4_02747523F8B652F4_OFFSET UNITYSDK_OFFSET(0x19C403D0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBATTLECONDITIONPROGRESS_METHOD_4_1F15A9951CC01850_OFFSET UNITYSDK_OFFSET(0x19C36E20)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBATTLECONDITIONPROGRESS__CTOR_OFFSET UNITYSDK_OFFSET(0x19C36DD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByBattleConditionProgress_TypeDefinitionIndex = 21925;
