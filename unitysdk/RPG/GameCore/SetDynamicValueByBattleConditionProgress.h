...
#define RPG_GAMECORE_SETDYNAMICVALUEBYBATTLECONDITIONPROGRESS_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1D4EDCB0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBATTLECONDITIONPROGRESS_METHOD_4_1F15A9951CC01850_OFFSET UNITYSDK_OFFSET(0x1D4EDAA0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBATTLECONDITIONPROGRESS_METHOD_4_D6F747A283B66DE5_OFFSET UNITYSDK_OFFSET(0x1D4EDA60)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBATTLECONDITIONPROGRESS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4EDA90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByBattleConditionProgress_TypeDefinitionIndex = 22924;
