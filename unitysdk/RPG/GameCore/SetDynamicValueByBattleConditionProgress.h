...
#define RPG_GAMECORE_SETDYNAMICVALUEBYBATTLECONDITIONPROGRESS_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x18E1D270)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBATTLECONDITIONPROGRESS_METHOD_4_02747523F8B652F4_OFFSET UNITYSDK_OFFSET(0x18E1CF90)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBATTLECONDITIONPROGRESS_METHOD_4_1F15A9951CC01850_OFFSET UNITYSDK_OFFSET(0x18E1D060)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBATTLECONDITIONPROGRESS__CTOR_OFFSET UNITYSDK_OFFSET(0x18E1D010)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByBattleConditionProgress_TypeDefinitionIndex = 22140;
