...
#define RPG_GAMECORE_PARKOURBGMCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1748A410)
#define RPG_GAMECORE_PARKOURBGMCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1748A590)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ParkourBGMConfigRow_TypeDefinitionIndex = 11096;
