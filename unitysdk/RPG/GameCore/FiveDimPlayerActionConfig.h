...
#define RPG_GAMECORE_FIVEDIMPLAYERACTIONCONFIG_METHOD_2_9678E7485DC2437B_OFFSET UNITYSDK_OFFSET(0x18912F10)
#define RPG_GAMECORE_FIVEDIMPLAYERACTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18912FE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimPlayerActionConfig_TypeDefinitionIndex = 15785;
