...
#define RPG_GAMECORE_FIVEDIMPLAYERACTIONCONFIG_METHOD_2_B8A1118F3314097E_OFFSET UNITYSDK_OFFSET(0x1D8711C0)
#define RPG_GAMECORE_FIVEDIMPLAYERACTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D871280)
