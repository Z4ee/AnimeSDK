...
#define RPG_GAMECORE_SETUPMAPROTATIONCHARGER_METHOD_3_384217892B2B944A_OFFSET UNITYSDK_OFFSET(0x19C6A8A0)
#define RPG_GAMECORE_SETUPMAPROTATIONCHARGER_METHOD_3_94F6BA095FDB2551_OFFSET UNITYSDK_OFFSET(0x19C6A920)
#define RPG_GAMECORE_SETUPMAPROTATIONCHARGER__CTOR_OFFSET UNITYSDK_OFFSET(0x19C6A8F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetupMapRotationCharger_TypeDefinitionIndex = 21077;
