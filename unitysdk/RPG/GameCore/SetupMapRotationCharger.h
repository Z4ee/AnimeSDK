...
#define RPG_GAMECORE_SETUPMAPROTATIONCHARGER_METHOD_3_384217892B2B944A_OFFSET UNITYSDK_OFFSET(0x176EA680)
#define RPG_GAMECORE_SETUPMAPROTATIONCHARGER_METHOD_3_94F6BA095FDB2551_OFFSET UNITYSDK_OFFSET(0x176EA700)
#define RPG_GAMECORE_SETUPMAPROTATIONCHARGER__CTOR_OFFSET UNITYSDK_OFFSET(0x176EA6D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetupMapRotationCharger_TypeDefinitionIndex = 20497;
	...
	public:
		...
		static ::System::Void Method_3_384217892B2B944A(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::SetupMapRotationCharger*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::SetupMapRotationCharger*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_SETUPMAPROTATIONCHARGER_METHOD_3_384217892B2B944A_OFFSET))(a1, a2);
		}
