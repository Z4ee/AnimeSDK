...
#define RPG_GAMECORE_OVERRIDEPERFORMANCEENDCRACK_METHOD_3_427C26E7A32D0428_OFFSET UNITYSDK_OFFSET(0x199DEE70)
#define RPG_GAMECORE_OVERRIDEPERFORMANCEENDCRACK_METHOD_3_614BADC2B032BC81_OFFSET UNITYSDK_OFFSET(0x199DEEF0)
#define RPG_GAMECORE_OVERRIDEPERFORMANCEENDCRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x199DEEC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OverridePerformanceEndCrack_TypeDefinitionIndex = 20695;
