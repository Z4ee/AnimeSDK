...
#define RPG_GAMECORE_OVERRIDEPERFORMANCEENDCRACK_METHOD_3_263D069065B91C9A_OFFSET UNITYSDK_OFFSET(0x1D40DC00)
#define RPG_GAMECORE_OVERRIDEPERFORMANCEENDCRACK_METHOD_3_614BADC2B032BC81_OFFSET UNITYSDK_OFFSET(0x1D40DC40)
#define RPG_GAMECORE_OVERRIDEPERFORMANCEENDCRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D40DC30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OverridePerformanceEndCrack_TypeDefinitionIndex = 21668;
