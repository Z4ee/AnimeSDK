...
#define RPG_GAMECORE_TEAMTOWERSPASSIVESKILLCONFIG_METHOD_2_B5055CB4063367A2_OFFSET UNITYSDK_OFFSET(0x1D5C6520)
#define RPG_GAMECORE_TEAMTOWERSPASSIVESKILLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5C65F0)
