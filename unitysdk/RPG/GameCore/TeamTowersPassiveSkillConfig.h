...
#define RPG_GAMECORE_TEAMTOWERSPASSIVESKILLCONFIG_METHOD_2_B5055CB4063367A2_OFFSET UNITYSDK_OFFSET(0x1E1CEE90)
#define RPG_GAMECORE_TEAMTOWERSPASSIVESKILLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1CEF60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TeamTowersPassiveSkillConfig_TypeDefinitionIndex = 21161;
