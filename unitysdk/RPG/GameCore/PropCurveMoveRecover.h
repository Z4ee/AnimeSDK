...
#define RPG_GAMECORE_PROPCURVEMOVERECOVER_METHOD_3_DF9B21F8FCDB6978_OFFSET UNITYSDK_OFFSET(0x1BA1C890)
#define RPG_GAMECORE_PROPCURVEMOVERECOVER_METHOD_3_F266E870893F7CD1_OFFSET UNITYSDK_OFFSET(0x1BA1C930)
#define RPG_GAMECORE_PROPCURVEMOVERECOVER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA1C8F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropCurveMoveRecover_TypeDefinitionIndex = 20223;
