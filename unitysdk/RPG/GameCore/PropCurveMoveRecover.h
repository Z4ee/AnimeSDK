...
#define RPG_GAMECORE_PROPCURVEMOVERECOVER_METHOD_3_9A9C1F9A217748FB_OFFSET UNITYSDK_OFFSET(0x18C67400)
#define RPG_GAMECORE_PROPCURVEMOVERECOVER_METHOD_3_F266E870893F7CD1_OFFSET UNITYSDK_OFFSET(0x18C674D0)
#define RPG_GAMECORE_PROPCURVEMOVERECOVER__CTOR_OFFSET UNITYSDK_OFFSET(0x18C67480)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropCurveMoveRecover_TypeDefinitionIndex = 19997;
