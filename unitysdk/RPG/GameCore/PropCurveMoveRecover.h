...
#define RPG_GAMECORE_PROPCURVEMOVERECOVER_METHOD_3_DF9B21F8FCDB6978_OFFSET UNITYSDK_OFFSET(0x1D361BD0)
#define RPG_GAMECORE_PROPCURVEMOVERECOVER_METHOD_3_F266E870893F7CD1_OFFSET UNITYSDK_OFFSET(0x1D361C70)
#define RPG_GAMECORE_PROPCURVEMOVERECOVER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D361C30)
