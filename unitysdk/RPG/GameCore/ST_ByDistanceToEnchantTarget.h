...
#define RPG_GAMECORE_ST_BYDISTANCETOENCHANTTARGET_METHOD_4_09D04241A173B5F4_OFFSET UNITYSDK_OFFSET(0x17692510)
#define RPG_GAMECORE_ST_BYDISTANCETOENCHANTTARGET_METHOD_4_267176B2C57D7B50_OFFSET UNITYSDK_OFFSET(0x176925E0)
#define RPG_GAMECORE_ST_BYDISTANCETOENCHANTTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x17692590)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_ByDistanceToEnchantTarget_TypeDefinitionIndex = 18356;
