...
#define RPG_GAMECORE_ST_BYDISTANCETOENCHANTTARGET_METHOD_4_267176B2C57D7B50_OFFSET UNITYSDK_OFFSET(0x1DB33620)
#define RPG_GAMECORE_ST_BYDISTANCETOENCHANTTARGET_METHOD_4_3040DEED8A11D295_OFFSET UNITYSDK_OFFSET(0x1DB33830)
#define RPG_GAMECORE_ST_BYDISTANCETOENCHANTTARGET_METHOD_4_7F2682E52F72FA12_OFFSET UNITYSDK_OFFSET(0x1DB33860)
#define RPG_GAMECORE_ST_BYDISTANCETOENCHANTTARGET_METHOD_4_DE5314C02C73D0E5_OFFSET UNITYSDK_OFFSET(0x1DB335E0)
#define RPG_GAMECORE_ST_BYDISTANCETOENCHANTTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB33610)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_ByDistanceToEnchantTarget_TypeDefinitionIndex = 19844;
