...
#define RPG_GAMECORE_PLAYERCONDINROGUESUBMODECONFIG_METHOD_5_AC42E986FDC94B8E_OFFSET UNITYSDK_OFFSET(0x1D34E5A0)
#define RPG_GAMECORE_PLAYERCONDINROGUESUBMODECONFIG_METHOD_5_E0B04FC56516A1CA_OFFSET UNITYSDK_OFFSET(0x1D34E5F0)
#define RPG_GAMECORE_PLAYERCONDINROGUESUBMODECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D34E5E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayerCondInRogueSubModeConfig_TypeDefinitionIndex = 19330;
