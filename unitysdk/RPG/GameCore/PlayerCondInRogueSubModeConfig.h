...
#define RPG_GAMECORE_PLAYERCONDINROGUESUBMODECONFIG_METHOD_5_1CA65A1F1F959236_OFFSET UNITYSDK_OFFSET(0x18C25800)
#define RPG_GAMECORE_PLAYERCONDINROGUESUBMODECONFIG_METHOD_5_E0B04FC56516A1CA_OFFSET UNITYSDK_OFFSET(0x18C24BC0)
#define RPG_GAMECORE_PLAYERCONDINROGUESUBMODECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18C24B00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayerCondInRogueSubModeConfig_TypeDefinitionIndex = 18565;
