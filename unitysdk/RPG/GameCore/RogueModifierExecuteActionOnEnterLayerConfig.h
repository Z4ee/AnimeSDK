...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONENTERLAYERCONFIG_METHOD_3_0A128726977BB05F_OFFSET UNITYSDK_OFFSET(0x18D358A0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONENTERLAYERCONFIG_METHOD_3_7DB880A8D0EE2BE6_OFFSET UNITYSDK_OFFSET(0x18D3D070)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONENTERLAYERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D35850)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnEnterLayerConfig_TypeDefinitionIndex = 16792;
