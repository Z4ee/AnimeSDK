...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONENTERLAYERCONFIG_METHOD_3_0A128726977BB05F_OFFSET UNITYSDK_OFFSET(0x19B51620)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONENTERLAYERCONFIG_METHOD_3_7DB880A8D0EE2BE6_OFFSET UNITYSDK_OFFSET(0x19B5CC20)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONENTERLAYERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B515D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnEnterLayerConfig_TypeDefinitionIndex = 16807;
