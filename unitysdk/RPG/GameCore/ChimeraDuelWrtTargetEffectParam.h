...
#define RPG_GAMECORE_CHIMERADUELWRTTARGETEFFECTPARAM_METHOD_3_4DABD3277357C900_OFFSET UNITYSDK_OFFSET(0x1C24A280)
#define RPG_GAMECORE_CHIMERADUELWRTTARGETEFFECTPARAM_METHOD_3_ADEA472A1F487C90_OFFSET UNITYSDK_OFFSET(0x1C24A2E0)
#define RPG_GAMECORE_CHIMERADUELWRTTARGETEFFECTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1C24A2D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelWrtTargetEffectParam_TypeDefinitionIndex = 15405;
