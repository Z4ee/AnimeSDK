...
#define RPG_GAMECORE_CHIMERADUELWRTTARGETEFFECTPARAM_METHOD_3_8885CECE45D09DAD_OFFSET UNITYSDK_OFFSET(0x170A86A0)
#define RPG_GAMECORE_CHIMERADUELWRTTARGETEFFECTPARAM_METHOD_3_C2E81330861459A5_OFFSET UNITYSDK_OFFSET(0x170A8700)
#define RPG_GAMECORE_CHIMERADUELWRTTARGETEFFECTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x170A86F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelWrtTargetEffectParam_TypeDefinitionIndex = 14710;
