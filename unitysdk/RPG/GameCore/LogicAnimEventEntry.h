...
#define RPG_GAMECORE_LOGICANIMEVENTENTRY_METHOD_2_DA40BC04FAA6F4D6_OFFSET UNITYSDK_OFFSET(0x1736E140)
#define RPG_GAMECORE_LOGICANIMEVENTENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1736E2C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LogicAnimEventEntry_TypeDefinitionIndex = 14912;
