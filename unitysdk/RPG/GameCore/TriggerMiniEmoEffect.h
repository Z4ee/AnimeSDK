...
#define RPG_GAMECORE_TRIGGERMINIEMOEFFECT_METHOD_3_0317D26B47B1AB27_OFFSET UNITYSDK_OFFSET(0x1D601220)
#define RPG_GAMECORE_TRIGGERMINIEMOEFFECT_METHOD_3_AD776BA9EB4B1D2A_OFFSET UNITYSDK_OFFSET(0x1D6012C0)
#define RPG_GAMECORE_TRIGGERMINIEMOEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D601280)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerMiniEmoEffect_TypeDefinitionIndex = 21615;
