...
#define RPG_GAMECORE_TRIGGERMINIEMOEFFECT_METHOD_3_85EC573208EA891E_OFFSET UNITYSDK_OFFSET(0x190C85D0)
#define RPG_GAMECORE_TRIGGERMINIEMOEFFECT_METHOD_3_AD776BA9EB4B1D2A_OFFSET UNITYSDK_OFFSET(0x190C86A0)
#define RPG_GAMECORE_TRIGGERMINIEMOEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x190C8650)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerMiniEmoEffect_TypeDefinitionIndex = 20713;
