...
#define RPG_GAMECORE_TRIGGERMINIEMOEFFECT_METHOD_3_85EC573208EA891E_OFFSET UNITYSDK_OFFSET(0x178C9EB0)
#define RPG_GAMECORE_TRIGGERMINIEMOEFFECT_METHOD_3_AD776BA9EB4B1D2A_OFFSET UNITYSDK_OFFSET(0x178C9F80)
#define RPG_GAMECORE_TRIGGERMINIEMOEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x178C9F30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerMiniEmoEffect_TypeDefinitionIndex = 20032;
