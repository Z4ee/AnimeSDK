...
#define RPG_GAMECORE_BYCOMPARENPCMONSTERID_METHOD_4_7CE37173D172AE51_OFFSET UNITYSDK_OFFSET(0x17010D70)
#define RPG_GAMECORE_BYCOMPARENPCMONSTERID_METHOD_4_9FD5B054BC260969_OFFSET UNITYSDK_OFFSET(0x17010E40)
#define RPG_GAMECORE_BYCOMPARENPCMONSTERID__CTOR_OFFSET UNITYSDK_OFFSET(0x17010DF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareNPCMonsterID_TypeDefinitionIndex = 19364;
