...
#define RPG_GAMECORE_BYCOMPARENPCMONSTERID_METHOD_4_55D74B7E417D967C_OFFSET UNITYSDK_OFFSET(0x19CF9BD0)
#define RPG_GAMECORE_BYCOMPARENPCMONSTERID_METHOD_4_5CC645515A6CB012_OFFSET UNITYSDK_OFFSET(0x19CF9E30)
#define RPG_GAMECORE_BYCOMPARENPCMONSTERID_METHOD_4_9FD5B054BC260969_OFFSET UNITYSDK_OFFSET(0x19CF9C10)
#define RPG_GAMECORE_BYCOMPARENPCMONSTERID_METHOD_4_E2ABB9EF85D3969C_OFFSET UNITYSDK_OFFSET(0x19CF9E60)
#define RPG_GAMECORE_BYCOMPARENPCMONSTERID__CTOR_OFFSET UNITYSDK_OFFSET(0x19CF9C00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareNPCMonsterID_TypeDefinitionIndex = 20247;
