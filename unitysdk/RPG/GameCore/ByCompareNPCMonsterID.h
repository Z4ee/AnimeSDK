...
#define RPG_GAMECORE_BYCOMPARENPCMONSTERID_METHOD_4_7CE37173D172AE51_OFFSET UNITYSDK_OFFSET(0x187350B0)
#define RPG_GAMECORE_BYCOMPARENPCMONSTERID_METHOD_4_9FD5B054BC260969_OFFSET UNITYSDK_OFFSET(0x18735180)
#define RPG_GAMECORE_BYCOMPARENPCMONSTERID__CTOR_OFFSET UNITYSDK_OFFSET(0x18735130)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareNPCMonsterID_TypeDefinitionIndex = 20023;
