...
#define RPG_GAMECORE_GRIDFIGHTMODULEBANPORTALCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x197F4FA0)
#define RPG_GAMECORE_GRIDFIGHTMODULEBANPORTALCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x197F50C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModuleBanPortalConfigRow_TypeDefinitionIndex = 12845;
