...
#define RPG_GAMECORE_HIPPLENINCIDENTSTORYSTEPCONFIG_METHOD_3_828D44BB64A4714C_OFFSET UNITYSDK_OFFSET(0x198366B0)
#define RPG_GAMECORE_HIPPLENINCIDENTSTORYSTEPCONFIG_METHOD_3_B95F5DE74346076A_OFFSET UNITYSDK_OFFSET(0x19836530)
#define RPG_GAMECORE_HIPPLENINCIDENTSTORYSTEPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19836520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HipplenIncidentStoryStepConfig_TypeDefinitionIndex = 15962;
