...
#define RPG_GAMECORE_HIPPLENINCIDENTSTORYSTEPCONFIG_METHOD_3_828D44BB64A4714C_OFFSET UNITYSDK_OFFSET(0x172AF630)
#define RPG_GAMECORE_HIPPLENINCIDENTSTORYSTEPCONFIG_METHOD_3_B95F5DE74346076A_OFFSET UNITYSDK_OFFSET(0x172AF4B0)
#define RPG_GAMECORE_HIPPLENINCIDENTSTORYSTEPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x172AF4A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HipplenIncidentStoryStepConfig_TypeDefinitionIndex = 15389;
