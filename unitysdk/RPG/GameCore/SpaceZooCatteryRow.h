...
#define RPG_GAMECORE_SPACEZOOCATTERYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18E75CB0)
#define RPG_GAMECORE_SPACEZOOCATTERYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18E75EA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SpaceZooCatteryRow_TypeDefinitionIndex = 11701;

	class SpaceZooCatteryRow : public ::System::Object
	{
	public:
		::System::UInt32 NpcGroupID; // 0x10
		::System::UInt32 NpcInstanceID; // 0x14
		::System::UInt32 FloorID; // 0x18
		::System::UInt32 UnlockMissionID; // 0x1C
		::System::UInt32 CatteryID; // 0x20
