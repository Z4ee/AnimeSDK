...
#define RPG_GAMECORE_SPACEZOOCATTERYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19C918B0)
#define RPG_GAMECORE_SPACEZOOCATTERYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19C91AA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SpaceZooCatteryRow_TypeDefinitionIndex = 11800;
