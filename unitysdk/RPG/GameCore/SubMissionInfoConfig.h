...
#define RPG_GAMECORE_SUBMISSIONINFOCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B4256A0)
#define RPG_GAMECORE_SUBMISSIONINFOCONFIG_FROMJSON_OFFSET UNITYSDK_OFFSET(0x1B426C30)
#define RPG_GAMECORE_SUBMISSIONINFOCONFIG_IFIGNOREVERSEPARAM_OFFSET UNITYSDK_OFFSET(0x1B425640)
#define RPG_GAMECORE_SUBMISSIONINFOCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B426C20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SubMissionInfoConfig_TypeDefinitionIndex = 14865;
