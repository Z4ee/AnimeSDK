...
#define RPG_GAMECORE_SUBMISSIONINFOCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CB084C0)
#define RPG_GAMECORE_SUBMISSIONINFOCONFIG_FROMJSON_OFFSET UNITYSDK_OFFSET(0x1CB09A50)
#define RPG_GAMECORE_SUBMISSIONINFOCONFIG_IFIGNOREVERSEPARAM_OFFSET UNITYSDK_OFFSET(0x1CB08460)
#define RPG_GAMECORE_SUBMISSIONINFOCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CB09A40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SubMissionInfoConfig_TypeDefinitionIndex = 15301;
