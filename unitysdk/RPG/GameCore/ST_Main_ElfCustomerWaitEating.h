...
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMERWAITEATING_METHOD_4_0C813FB221EBC2C6_OFFSET UNITYSDK_OFFSET(0x1D4C8E40)
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMERWAITEATING_METHOD_4_E033780024757643_OFFSET UNITYSDK_OFFSET(0x1D4C8D70)
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMERWAITEATING__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4C8E30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_ElfCustomerWaitEating_TypeDefinitionIndex = 21284;
