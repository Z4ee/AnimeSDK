...
#define RPG_GAMECORE_ACTIVITYPANELCONDITIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CD98B00)
#define RPG_GAMECORE_ACTIVITYPANELCONDITIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD98E10)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Boolean ActivityGotoStoryLineRestore; // 0x30
		::System::UInt32 GuideGoto; // 0x34
		::System::UInt32 ShopOnlyActivityModule; // 0x38
