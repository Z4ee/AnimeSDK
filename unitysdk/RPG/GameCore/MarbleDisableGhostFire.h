...
#define RPG_GAMECORE_MARBLEDISABLEGHOSTFIRE_METHOD_3_05BB3AD7F4666D50_OFFSET UNITYSDK_OFFSET(0x1738D250)
#define RPG_GAMECORE_MARBLEDISABLEGHOSTFIRE_METHOD_3_B42A2DEC2A1654EB_OFFSET UNITYSDK_OFFSET(0x1738D110)
#define RPG_GAMECORE_MARBLEDISABLEGHOSTFIRE__CTOR_OFFSET UNITYSDK_OFFSET(0x1738D200)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleDisableGhostFire_TypeDefinitionIndex = 15430;
