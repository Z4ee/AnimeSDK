...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETTUTORIALSUPPLYCONFIG_METHOD_3_83E00E44CD857804_OFFSET UNITYSDK_OFFSET(0x1726C4A0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETTUTORIALSUPPLYCONFIG_METHOD_3_C6CA3CA039AFF17D_OFFSET UNITYSDK_OFFSET(0x1726C570)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETTUTORIALSUPPLYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1726C520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierSetTutorialSupplyConfig_TypeDefinitionIndex = 17844;
