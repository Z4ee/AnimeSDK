...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETTUTORIALSUPPLYCONFIG_METHOD_3_ABB3452B6B6E7639_OFFSET UNITYSDK_OFFSET(0x1EE6F0E0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETTUTORIALSUPPLYCONFIG_METHOD_3_C6CA3CA039AFF17D_OFFSET UNITYSDK_OFFSET(0x1EE6F130)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETTUTORIALSUPPLYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EE6F120)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierSetTutorialSupplyConfig_TypeDefinitionIndex = 19211;
