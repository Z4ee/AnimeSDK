...
#define RPG_GAMECORE_MAZESKILLDROPCONFIG_METHOD_2_DB553DC456E7CFC7_OFFSET UNITYSDK_OFFSET(0x18ADAC80)
#define RPG_GAMECORE_MAZESKILLDROPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18ADACC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MazeSkillDropConfig_TypeDefinitionIndex = 20601;
