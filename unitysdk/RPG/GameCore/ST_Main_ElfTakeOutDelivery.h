...
#define RPG_GAMECORE_ST_MAIN_ELFTAKEOUTDELIVERY_METHOD_4_0E66D38F073944FE_OFFSET UNITYSDK_OFFSET(0x1B782620)
#define RPG_GAMECORE_ST_MAIN_ELFTAKEOUTDELIVERY_METHOD_4_EC3EA94831E77EFB_OFFSET UNITYSDK_OFFSET(0x1B782550)
#define RPG_GAMECORE_ST_MAIN_ELFTAKEOUTDELIVERY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B782610)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_ElfTakeOutDelivery_TypeDefinitionIndex = 20737;
