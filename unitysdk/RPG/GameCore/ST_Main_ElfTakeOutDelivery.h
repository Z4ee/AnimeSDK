...
#define RPG_GAMECORE_ST_MAIN_ELFTAKEOUTDELIVERY_METHOD_4_0E66D38F073944FE_OFFSET UNITYSDK_OFFSET(0x17683830)
#define RPG_GAMECORE_ST_MAIN_ELFTAKEOUTDELIVERY_METHOD_4_6126E519EFECBE69_OFFSET UNITYSDK_OFFSET(0x17696D90)
#define RPG_GAMECORE_ST_MAIN_ELFTAKEOUTDELIVERY__CTOR_OFFSET UNITYSDK_OFFSET(0x176837E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_ElfTakeOutDelivery_TypeDefinitionIndex = 19717;
