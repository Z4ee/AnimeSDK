...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUESELECTAEON_METHOD_3_059ADB58E5FB3D0F_OFFSET UNITYSDK_OFFSET(0x1C5F0730)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUESELECTAEON_METHOD_3_FCD1975E7210BCD3_OFFSET UNITYSDK_OFFSET(0x1C5F0780)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUESELECTAEON__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5F0770)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRogueSelectAeon_TypeDefinitionIndex = 20979;
