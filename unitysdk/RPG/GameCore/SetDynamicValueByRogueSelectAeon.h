...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUESELECTAEON_METHOD_3_14D07A56C9472263_OFFSET UNITYSDK_OFFSET(0x18E27310)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUESELECTAEON_METHOD_3_FCD1975E7210BCD3_OFFSET UNITYSDK_OFFSET(0x18E273A0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUESELECTAEON__CTOR_OFFSET UNITYSDK_OFFSET(0x18E27370)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRogueSelectAeon_TypeDefinitionIndex = 20631;
