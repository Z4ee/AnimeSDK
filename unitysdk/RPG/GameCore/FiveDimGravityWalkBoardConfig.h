...
#define RPG_GAMECORE_FIVEDIMGRAVITYWALKBOARDCONFIG_METHOD_3_186B1C452A0F5895_OFFSET UNITYSDK_OFFSET(0x171F57D0)
#define RPG_GAMECORE_FIVEDIMGRAVITYWALKBOARDCONFIG_METHOD_3_28BE7B2AD74B2CCA_OFFSET UNITYSDK_OFFSET(0x171F5760)
#define RPG_GAMECORE_FIVEDIMGRAVITYWALKBOARDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171F57B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimGravityWalkBoardConfig_TypeDefinitionIndex = 17043;
