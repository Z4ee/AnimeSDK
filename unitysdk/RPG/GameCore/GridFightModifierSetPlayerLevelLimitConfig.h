...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETPLAYERLEVELLIMITCONFIG_METHOD_3_8A16053EFA165B9C_OFFSET UNITYSDK_OFFSET(0x17269320)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETPLAYERLEVELLIMITCONFIG_METHOD_3_A5A064F6373B38A5_OFFSET UNITYSDK_OFFSET(0x1726C040)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETPLAYERLEVELLIMITCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x172692D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierSetPlayerLevelLimitConfig_TypeDefinitionIndex = 17822;
