...
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_ROTATION_METHOD_3_0A10AE0784FD4CCF_OFFSET UNITYSDK_OFFSET(0x1C377A70)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_ROTATION_METHOD_3_AA7B7733C5B32A6A_OFFSET UNITYSDK_OFFSET(0x1C377AD0)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_ROTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C377AC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleAbility_Rotation_TypeDefinitionIndex = 15139;
