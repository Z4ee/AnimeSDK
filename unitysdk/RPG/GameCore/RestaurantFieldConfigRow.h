...
#define RPG_GAMECORE_RESTAURANTFIELDCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D3AB630)
#define RPG_GAMECORE_RESTAURANTFIELDCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3AB910)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::System::UInt32>* ConfigIDList; // 0x30
