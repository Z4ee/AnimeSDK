...
#define RPG_GAMECORE_RESTAURANTFIELDCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19AD6170)
#define RPG_GAMECORE_RESTAURANTFIELDCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19AD6450)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RestaurantFieldConfigRow_TypeDefinitionIndex = 10928;
