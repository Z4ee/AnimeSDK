...
#define RPG_GAMECORE_RESTAURANTFIELDCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D022760)
#define RPG_GAMECORE_RESTAURANTFIELDCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D022A40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RestaurantFieldConfigRow_TypeDefinitionIndex = 10978;
	...
	public:
		...
		::Il2CppArray<::System::UInt32>* PropConfigIDList; // 0x20
		...
		::System::UInt32 FieldID; // 0x3C
		::System::UInt32 BigCropsConfigID; // 0x40
