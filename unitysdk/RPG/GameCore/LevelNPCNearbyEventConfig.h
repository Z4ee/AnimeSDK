...
#define RPG_GAMECORE_LEVELNPCNEARBYEVENTCONFIG_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1D1DB2A0)
#define RPG_GAMECORE_LEVELNPCNEARBYEVENTCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D1DA680)
#define RPG_GAMECORE_LEVELNPCNEARBYEVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1DB290)
