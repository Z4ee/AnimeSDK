...
#define RPG_GAMECORE_REMOVETEAMALLMAZESKILLBUFF_METHOD_3_30CBAAF044F121A2_OFFSET UNITYSDK_OFFSET(0x19ACA9C0)
#define RPG_GAMECORE_REMOVETEAMALLMAZESKILLBUFF_METHOD_3_449031DBA099B562_OFFSET UNITYSDK_OFFSET(0x19ACA930)
#define RPG_GAMECORE_REMOVETEAMALLMAZESKILLBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x19ACA990)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveTeamAllMazeSkillBuff_TypeDefinitionIndex = 21015;
