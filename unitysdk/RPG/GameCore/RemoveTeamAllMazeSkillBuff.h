...
#define RPG_GAMECORE_REMOVETEAMALLMAZESKILLBUFF_METHOD_3_30CBAAF044F121A2_OFFSET UNITYSDK_OFFSET(0x18CA5F10)
#define RPG_GAMECORE_REMOVETEAMALLMAZESKILLBUFF_METHOD_3_449031DBA099B562_OFFSET UNITYSDK_OFFSET(0x18CA5E80)
#define RPG_GAMECORE_REMOVETEAMALLMAZESKILLBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x18CA5EE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveTeamAllMazeSkillBuff_TypeDefinitionIndex = 21115;
