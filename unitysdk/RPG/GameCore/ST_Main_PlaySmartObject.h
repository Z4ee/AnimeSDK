...
#define RPG_GAMECORE_ST_MAIN_PLAYSMARTOBJECT_METHOD_4_8F1EF31CD6C33B83_OFFSET UNITYSDK_OFFSET(0x17688740)
#define RPG_GAMECORE_ST_MAIN_PLAYSMARTOBJECT_METHOD_4_B21087AA77116508_OFFSET UNITYSDK_OFFSET(0x176982A0)
#define RPG_GAMECORE_ST_MAIN_PLAYSMARTOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x176886F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_PlaySmartObject_TypeDefinitionIndex = 18399;
