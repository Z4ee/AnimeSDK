...
#define RPG_GAMECORE_HPSHOWRULEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x172929F0)
#define RPG_GAMECORE_HPSHOWRULEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17293070)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HPShowRuleRow_TypeDefinitionIndex = 12544;

	class HPShowRuleRow : public ::System::Object
	{
	public:
		::System::String* Color; // 0x10
		::System::Boolean IsDanger; // 0x18
