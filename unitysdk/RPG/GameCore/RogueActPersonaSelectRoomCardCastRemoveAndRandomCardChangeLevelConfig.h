...
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTREMOVEANDRANDOMCARDCHANGELEVELCONFIG_METHOD_7_273FC35963D56CAB_OFFSET UNITYSDK_OFFSET(0x18CCEB40)
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTREMOVEANDRANDOMCARDCHANGELEVELCONFIG_METHOD_7_D8B966E39F9489BE_OFFSET UNITYSDK_OFFSET(0x18CCF650)
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTREMOVEANDRANDOMCARDCHANGELEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CCEA60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaSelectRoomCardCastRemoveAndRandomCardChangeLevelConfig_TypeDefinitionIndex = 18727;
