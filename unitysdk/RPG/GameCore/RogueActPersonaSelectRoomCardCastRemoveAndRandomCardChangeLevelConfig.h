...
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTREMOVEANDRANDOMCARDCHANGELEVELCONFIG_METHOD_7_273FC35963D56CAB_OFFSET UNITYSDK_OFFSET(0x1D030500)
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTREMOVEANDRANDOMCARDCHANGELEVELCONFIG_METHOD_7_DD02FF3DA3C1C907_OFFSET UNITYSDK_OFFSET(0x1D030700)
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTREMOVEANDRANDOMCARDCHANGELEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0304F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaSelectRoomCardCastRemoveAndRandomCardChangeLevelConfig_TypeDefinitionIndex = 18970;
