...
#define RPG_GAMECORE_LEVELTURNBATTLESTART_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xA992310)
#define RPG_GAMECORE_LEVELTURNBATTLESTART_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xA9922C0)
#define RPG_GAMECORE_LEVELTURNBATTLESTART__CTOR_OFFSET UNITYSDK_OFFSET(0xA9922B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelTurnBattleStart_TypeDefinitionIndex = 45642;
