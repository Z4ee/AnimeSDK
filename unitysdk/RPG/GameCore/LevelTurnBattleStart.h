...
#define RPG_GAMECORE_LEVELTURNBATTLESTART_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xCE4E7F0)
#define RPG_GAMECORE_LEVELTURNBATTLESTART_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xCE4E7A0)
#define RPG_GAMECORE_LEVELTURNBATTLESTART__CTOR_OFFSET UNITYSDK_OFFSET(0xCE4E790)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelTurnBattleStart_TypeDefinitionIndex = 52990;
