...
#define RPG_GAMECORE_LEVELNAVNODETRANSITINFO_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1987F390)
#define RPG_GAMECORE_LEVELNAVNODETRANSITINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1987F5F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelNavNodeTransitInfo_TypeDefinitionIndex = 16300;
	...
	public:
		...
		static ::System::Void FromBinary(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::LevelNavNodeTransitInfo*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::LevelNavNodeTransitInfo*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_LEVELNAVNODETRANSITINFO_FROMBINARY_OFFSET))(a1, a2);
		}
	};
}
