...
#define RPG_GAMECORE_ROGUEMODIFIERADDREPLENISHROOMCARDEXTRACOMPOSITIONTYPECONFIG_METHOD_3_AA0ABA221FEFB60C_OFFSET UNITYSDK_OFFSET(0x1761CFD0)
#define RPG_GAMECORE_ROGUEMODIFIERADDREPLENISHROOMCARDEXTRACOMPOSITIONTYPECONFIG_METHOD_3_F5D36A5A7EC16D55_OFFSET UNITYSDK_OFFSET(0x1761CF00)
#define RPG_GAMECORE_ROGUEMODIFIERADDREPLENISHROOMCARDEXTRACOMPOSITIONTYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1761CF80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierAddReplenishRoomCardExtraCompositionTypeConfig_TypeDefinitionIndex = 16385;
