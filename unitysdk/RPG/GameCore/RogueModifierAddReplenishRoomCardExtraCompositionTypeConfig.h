...
#define RPG_GAMECORE_ROGUEMODIFIERADDREPLENISHROOMCARDEXTRACOMPOSITIONTYPECONFIG_METHOD_3_AA0ABA221FEFB60C_OFFSET UNITYSDK_OFFSET(0x1D3F6C20)
#define RPG_GAMECORE_ROGUEMODIFIERADDREPLENISHROOMCARDEXTRACOMPOSITIONTYPECONFIG_METHOD_3_F95AF5FE2A660D90_OFFSET UNITYSDK_OFFSET(0x1D3F6BD0)
#define RPG_GAMECORE_ROGUEMODIFIERADDREPLENISHROOMCARDEXTRACOMPOSITIONTYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3F6C10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierAddReplenishRoomCardExtraCompositionTypeConfig_TypeDefinitionIndex = 17630;
