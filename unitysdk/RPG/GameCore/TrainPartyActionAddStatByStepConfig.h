...
#define RPG_GAMECORE_TRAINPARTYACTIONADDSTATBYSTEPCONFIG_METHOD_5_3DEB66CAD524BA72_OFFSET UNITYSDK_OFFSET(0x19DF0150)
#define RPG_GAMECORE_TRAINPARTYACTIONADDSTATBYSTEPCONFIG_METHOD_5_BFDA07A31DB8DDC4_OFFSET UNITYSDK_OFFSET(0x19DF0230)
#define RPG_GAMECORE_TRAINPARTYACTIONADDSTATBYSTEPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19DF01E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyActionAddStatByStepConfig_TypeDefinitionIndex = 17183;
	...
	public:
		...
		static ::System::Void Method_5_3DEB66CAD524BA72(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::TrainPartyActionAddStatByStepConfig*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::TrainPartyActionAddStatByStepConfig*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_TRAINPARTYACTIONADDSTATBYSTEPCONFIG_METHOD_5_3DEB66CAD524BA72_OFFSET))(a1, a2);
		}
