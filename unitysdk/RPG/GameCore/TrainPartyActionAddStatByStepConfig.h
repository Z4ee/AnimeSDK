...
#define RPG_GAMECORE_TRAINPARTYACTIONADDSTATBYSTEPCONFIG_METHOD_5_46B10377980A2EDF_OFFSET UNITYSDK_OFFSET(0x178A69B0)
#define RPG_GAMECORE_TRAINPARTYACTIONADDSTATBYSTEPCONFIG_METHOD_5_51611A582308DDF7_OFFSET UNITYSDK_OFFSET(0x178A68D0)
#define RPG_GAMECORE_TRAINPARTYACTIONADDSTATBYSTEPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x178A6960)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyActionAddStatByStepConfig_TypeDefinitionIndex = 16582;
