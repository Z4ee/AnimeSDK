...
#define RPG_GAMECORE_TRAINPARTYACTIONADDSTATBYSTEPCONFIG_METHOD_5_0FFF19094E51CF8A_OFFSET UNITYSDK_OFFSET(0x1C15C370)
#define RPG_GAMECORE_TRAINPARTYACTIONADDSTATBYSTEPCONFIG_METHOD_5_BFDA07A31DB8DDC4_OFFSET UNITYSDK_OFFSET(0x1C15C3D0)
#define RPG_GAMECORE_TRAINPARTYACTIONADDSTATBYSTEPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C15C3C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyActionAddStatByStepConfig_TypeDefinitionIndex = 17345;
