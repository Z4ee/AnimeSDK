...
#define RPG_GAMECORE_FATEACTGETCOINBYPARAMCONFIG_METHOD_6_704D693F47B6E9CD_OFFSET UNITYSDK_OFFSET(0x188CF310)
#define RPG_GAMECORE_FATEACTGETCOINBYPARAMCONFIG_METHOD_6_C1B6434DEFFE35EE_OFFSET UNITYSDK_OFFSET(0x188CF1A0)
#define RPG_GAMECORE_FATEACTGETCOINBYPARAMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x188CF270)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateActGetCoinByParamConfig_TypeDefinitionIndex = 18262;
