...
#define RPG_GAMECORE_FATEACTGETCOINBYPARAMCONFIG_METHOD_6_704D693F47B6E9CD_OFFSET UNITYSDK_OFFSET(0x1970C260)
#define RPG_GAMECORE_FATEACTGETCOINBYPARAMCONFIG_METHOD_6_C1B6434DEFFE35EE_OFFSET UNITYSDK_OFFSET(0x1970C0F0)
#define RPG_GAMECORE_FATEACTGETCOINBYPARAMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1970C1C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateActGetCoinByParamConfig_TypeDefinitionIndex = 18235;
