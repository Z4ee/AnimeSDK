...
#define RPG_GAMECORE_DAWNSEYESUNNYUICONFIG_METHOD_3_0825DC494E24FD9E_OFFSET UNITYSDK_OFFSET(0x1D80F220)
#define RPG_GAMECORE_DAWNSEYESUNNYUICONFIG_METHOD_3_D8AADD6180ECE283_OFFSET UNITYSDK_OFFSET(0x1D80F1C0)
#define RPG_GAMECORE_DAWNSEYESUNNYUICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D80F210)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DawnsEyeSunnyUIConfig_TypeDefinitionIndex = 22540;
