...
#define RPG_GAMECORE_ADDSCENETEAMMEMBERBUFF_METHOD_3_222AC029EF8EFAB4_OFFSET UNITYSDK_OFFSET(0x19412300)
#define RPG_GAMECORE_ADDSCENETEAMMEMBERBUFF_METHOD_3_35EF47154B378E74_OFFSET UNITYSDK_OFFSET(0x19412390)
#define RPG_GAMECORE_ADDSCENETEAMMEMBERBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x19412360)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddSceneTeamMemberBuff_TypeDefinitionIndex = 19281;
