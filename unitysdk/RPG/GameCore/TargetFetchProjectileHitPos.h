...
#define RPG_GAMECORE_TARGETFETCHPROJECTILEHITPOS_METHOD_4_8E33552671733EC8_OFFSET UNITYSDK_OFFSET(0x177BFF70)
#define RPG_GAMECORE_TARGETFETCHPROJECTILEHITPOS_METHOD_4_976A10E390C1EA5A_OFFSET UNITYSDK_OFFSET(0x177B7DA0)
#define RPG_GAMECORE_TARGETFETCHPROJECTILEHITPOS__CTOR_OFFSET UNITYSDK_OFFSET(0x177B7D50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchProjectileHitPos_TypeDefinitionIndex = 22199;
