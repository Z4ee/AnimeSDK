...
#define RPG_GAMECORE_CHENLINGAISMOOTHCONFIG_METHOD_2_5397766EC142C9B4_OFFSET UNITYSDK_OFFSET(0x1961A300)
#define RPG_GAMECORE_CHENLINGAISMOOTHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1961A570)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingAISmoothConfig_TypeDefinitionIndex = 14923;
