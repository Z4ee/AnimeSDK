...
#define RPG_GAMECORE_CHENLINGAISMOOTHCONFIG_METHOD_2_5397766EC142C9B4_OFFSET UNITYSDK_OFFSET(0x170777A0)
#define RPG_GAMECORE_CHENLINGAISMOOTHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17077A10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingAISmoothConfig_TypeDefinitionIndex = 14389;
