...
#define RPG_GAMECORE_ABILITYADDMODIFIER_CLEAR_OFFSET UNITYSDK_OFFSET(0x106C3110)
#define RPG_GAMECORE_ABILITYADDMODIFIER_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x106C31B0)
#define RPG_GAMECORE_ABILITYADDMODIFIER_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x106C3160)
#define RPG_GAMECORE_ABILITYADDMODIFIER_INIT_OFFSET UNITYSDK_OFFSET(0x106C30B0)
#define RPG_GAMECORE_ABILITYADDMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x106C3200)
