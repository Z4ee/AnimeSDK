...
#define RPG_GAMECORE_BYCHECKADVMODIFIERCALLBACKBEHAVIORFLAG_METHOD_4_10D63DFB6C293422_OFFSET UNITYSDK_OFFSET(0x19CC1C50)
#define RPG_GAMECORE_BYCHECKADVMODIFIERCALLBACKBEHAVIORFLAG_METHOD_4_4F0D9EFFB4BB75F5_OFFSET UNITYSDK_OFFSET(0x19CC1C80)
#define RPG_GAMECORE_BYCHECKADVMODIFIERCALLBACKBEHAVIORFLAG_METHOD_4_6302EB46F2784E76_OFFSET UNITYSDK_OFFSET(0x19CC1AD0)
#define RPG_GAMECORE_BYCHECKADVMODIFIERCALLBACKBEHAVIORFLAG_METHOD_4_6495F049DB25FBA7_OFFSET UNITYSDK_OFFSET(0x19CC1A90)
#define RPG_GAMECORE_BYCHECKADVMODIFIERCALLBACKBEHAVIORFLAG__CTOR_OFFSET UNITYSDK_OFFSET(0x19CC1AC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckAdvModifierCallBackBehaviorFlag_TypeDefinitionIndex = 21012;
