...
#define RPG_GAMECORE_EXPEDITIONBATTLESTARTACTION_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1D082A70)
#define RPG_GAMECORE_EXPEDITIONBATTLESTARTACTION_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D0829D0)
#define RPG_GAMECORE_EXPEDITIONBATTLESTARTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D082A60)
