...
#define RPG_GAMECORE_PLAYCOLLECTIONMORSE_METHOD_3_8BD8A254E2477C09_OFFSET UNITYSDK_OFFSET(0x174C1790)
#define RPG_GAMECORE_PLAYCOLLECTIONMORSE_METHOD_3_FD1F2175F3ECB887_OFFSET UNITYSDK_OFFSET(0x174C1810)
#define RPG_GAMECORE_PLAYCOLLECTIONMORSE__CTOR_OFFSET UNITYSDK_OFFSET(0x174C17E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayCollectionMorse_TypeDefinitionIndex = 18708;
