...
#define RPG_GAMECORE_PROPDESTRUCTIMMEDIATELY_METHOD_4_237A6E4D0D8ADF2E_OFFSET UNITYSDK_OFFSET(0x1BA1EDF0)
#define RPG_GAMECORE_PROPDESTRUCTIMMEDIATELY_METHOD_4_7E524DC126577E0C_OFFSET UNITYSDK_OFFSET(0x1BA1EC70)
#define RPG_GAMECORE_PROPDESTRUCTIMMEDIATELY__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA1EC40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropDestructImmediately_TypeDefinitionIndex = 21259;
