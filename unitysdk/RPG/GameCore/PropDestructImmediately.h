...
#define RPG_GAMECORE_PROPDESTRUCTIMMEDIATELY_METHOD_4_1F65BC1C73C3AAE9_OFFSET UNITYSDK_OFFSET(0x18C69C10)
#define RPG_GAMECORE_PROPDESTRUCTIMMEDIATELY_METHOD_4_7E524DC126577E0C_OFFSET UNITYSDK_OFFSET(0x18C69A90)
#define RPG_GAMECORE_PROPDESTRUCTIMMEDIATELY__CTOR_OFFSET UNITYSDK_OFFSET(0x18C69A00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropDestructImmediately_TypeDefinitionIndex = 20931;
