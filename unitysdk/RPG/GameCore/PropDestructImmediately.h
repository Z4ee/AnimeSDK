...
#define RPG_GAMECORE_PROPDESTRUCTIMMEDIATELY_METHOD_4_1F65BC1C73C3AAE9_OFFSET UNITYSDK_OFFSET(0x1751A1D0)
#define RPG_GAMECORE_PROPDESTRUCTIMMEDIATELY_METHOD_4_7E524DC126577E0C_OFFSET UNITYSDK_OFFSET(0x1751A050)
#define RPG_GAMECORE_PROPDESTRUCTIMMEDIATELY__CTOR_OFFSET UNITYSDK_OFFSET(0x17519FC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropDestructImmediately_TypeDefinitionIndex = 20249;
