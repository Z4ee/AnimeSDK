...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYNOTHINGCONFIG_METHOD_3_76EEA094C4D9CE3B_OFFSET UNITYSDK_OFFSET(0x19B55EC0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYNOTHINGCONFIG_METHOD_3_940C9C693A572222_OFFSET UNITYSDK_OFFSET(0x19B5F840)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYNOTHINGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B55E70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyNothingConfig_TypeDefinitionIndex = 16862;
