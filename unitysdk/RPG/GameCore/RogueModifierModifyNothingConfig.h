...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYNOTHINGCONFIG_METHOD_3_76EEA094C4D9CE3B_OFFSET UNITYSDK_OFFSET(0x1EEFAEC0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYNOTHINGCONFIG_METHOD_3_D280628E798D8957_OFFSET UNITYSDK_OFFSET(0x1EEFAE70)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYNOTHINGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEFAEB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyNothingConfig_TypeDefinitionIndex = 17527;
