...
#define RPG_GAMECORE_ROGUEPARAMROGUEMAGICSCEPTERCOUNTCONFIG_METHOD_6_3835DA873A55911B_OFFSET UNITYSDK_OFFSET(0x19BB0840)
#define RPG_GAMECORE_ROGUEPARAMROGUEMAGICSCEPTERCOUNTCONFIG_METHOD_6_D22A48E0413E8455_OFFSET UNITYSDK_OFFSET(0x19BB0AF0)
#define RPG_GAMECORE_ROGUEPARAMROGUEMAGICSCEPTERCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19BB09C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamRogueMagicScepterCountConfig_TypeDefinitionIndex = 18795;
