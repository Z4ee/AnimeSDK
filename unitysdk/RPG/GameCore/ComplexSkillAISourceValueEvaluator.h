...
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEVALUEEVALUATOR_METHOD_3_544E0DDE55A4D6FF_OFFSET UNITYSDK_OFFSET(0x1966ED40)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEVALUEEVALUATOR_METHOD_3_9CE1F88F6DB21F30_OFFSET UNITYSDK_OFFSET(0x196702F0)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEVALUEEVALUATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1966ED20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAISourceValueEvaluator_TypeDefinitionIndex = 14751;
