...
#define RPG_GAMECORE_GRIDFIGHTAFFIXCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D14AA90)
#define RPG_GAMECORE_GRIDFIGHTAFFIXCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D14AE20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightAffixConfigRow_TypeDefinitionIndex = 13291;
	...
	public:
		...
		::RPG::GameCore::GridFightAffixRule AffixRule; // 0x30
		::System::UInt32 ID; // 0x34
		::RPG::Client::TextID AffixName; // 0x38
