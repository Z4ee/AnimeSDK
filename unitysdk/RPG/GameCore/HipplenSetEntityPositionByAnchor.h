...
#define RPG_GAMECORE_HIPPLENSETENTITYPOSITIONBYANCHOR_METHOD_3_BE8B720B75DEDD28_OFFSET UNITYSDK_OFFSET(0x1B68A8E0)
#define RPG_GAMECORE_HIPPLENSETENTITYPOSITIONBYANCHOR_METHOD_3_DD18E6930B41EF21_OFFSET UNITYSDK_OFFSET(0x1B68A930)
#define RPG_GAMECORE_HIPPLENSETENTITYPOSITIONBYANCHOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B68A920)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HipplenSetEntityPositionByAnchor_TypeDefinitionIndex = 20519;
