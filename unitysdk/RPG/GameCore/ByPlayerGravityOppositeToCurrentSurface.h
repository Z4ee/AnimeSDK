...
#define RPG_GAMECORE_BYPLAYERGRAVITYOPPOSITETOCURRENTSURFACE_METHOD_4_5790C917C115380D_OFFSET UNITYSDK_OFFSET(0x1B2B4200)
#define RPG_GAMECORE_BYPLAYERGRAVITYOPPOSITETOCURRENTSURFACE_METHOD_4_E665CDA6C76A144E_OFFSET UNITYSDK_OFFSET(0x1B2B41C0)
#define RPG_GAMECORE_BYPLAYERGRAVITYOPPOSITETOCURRENTSURFACE_METHOD_4_F3BF1697B1C2867A_OFFSET UNITYSDK_OFFSET(0x1B2B4370)
#define RPG_GAMECORE_BYPLAYERGRAVITYOPPOSITETOCURRENTSURFACE_METHOD_4_FE9715EEA9F30C67_OFFSET UNITYSDK_OFFSET(0x1B2B4340)
#define RPG_GAMECORE_BYPLAYERGRAVITYOPPOSITETOCURRENTSURFACE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2B41F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByPlayerGravityOppositeToCurrentSurface_TypeDefinitionIndex = 20632;
