...
#define RPG_GAMECORE_BYPLAYERGRAVITYOPPOSITETOCURRENTSURFACE_METHOD_4_5790C917C115380D_OFFSET UNITYSDK_OFFSET(0x1CDBCC80)
#define RPG_GAMECORE_BYPLAYERGRAVITYOPPOSITETOCURRENTSURFACE_METHOD_4_E665CDA6C76A144E_OFFSET UNITYSDK_OFFSET(0x1CDBCC40)
#define RPG_GAMECORE_BYPLAYERGRAVITYOPPOSITETOCURRENTSURFACE_METHOD_4_F3BF1697B1C2867A_OFFSET UNITYSDK_OFFSET(0x1CDBCDF0)
#define RPG_GAMECORE_BYPLAYERGRAVITYOPPOSITETOCURRENTSURFACE_METHOD_4_FE9715EEA9F30C67_OFFSET UNITYSDK_OFFSET(0x1CDBCDC0)
#define RPG_GAMECORE_BYPLAYERGRAVITYOPPOSITETOCURRENTSURFACE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDBCC70)
