...
#define RPG_GAMECORE_CHENLINGBATTLERESOURCE_ONHIT_METHOD_3_257234CAB999F717_OFFSET UNITYSDK_OFFSET(0x1961C320)
#define RPG_GAMECORE_CHENLINGBATTLERESOURCE_ONHIT_METHOD_3_3C3CB0289058124D_OFFSET UNITYSDK_OFFSET(0x19623460)
#define RPG_GAMECORE_CHENLINGBATTLERESOURCE_ONHIT__CTOR_OFFSET UNITYSDK_OFFSET(0x19623450)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleResource_OnHit_TypeDefinitionIndex = 15008;
