...
#define RPG_GAMECORE_CHENLINGBATTLERESOURCE_ONHIT_METHOD_3_257234CAB999F717_OFFSET UNITYSDK_OFFSET(0x17079800)
#define RPG_GAMECORE_CHENLINGBATTLERESOURCE_ONHIT_METHOD_3_3C3CB0289058124D_OFFSET UNITYSDK_OFFSET(0x17080F90)
#define RPG_GAMECORE_CHENLINGBATTLERESOURCE_ONHIT__CTOR_OFFSET UNITYSDK_OFFSET(0x17080F80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleResource_OnHit_TypeDefinitionIndex = 14475;
