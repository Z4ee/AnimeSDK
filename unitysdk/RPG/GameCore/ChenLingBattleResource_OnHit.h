...
#define RPG_GAMECORE_CHENLINGBATTLERESOURCE_ONHIT_METHOD_3_257234CAB999F717_OFFSET UNITYSDK_OFFSET(0x1CFA4F40)
#define RPG_GAMECORE_CHENLINGBATTLERESOURCE_ONHIT_METHOD_3_3C3CB0289058124D_OFFSET UNITYSDK_OFFSET(0x1CFAC6C0)
#define RPG_GAMECORE_CHENLINGBATTLERESOURCE_ONHIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFAC6B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleResource_OnHit_TypeDefinitionIndex = 15609;
