...
#define RPG_GAMECORE_CHENLINGBATTLERESOURCE_ONHIT_METHOD_3_257234CAB999F717_OFFSET UNITYSDK_OFFSET(0x187E6040)
#define RPG_GAMECORE_CHENLINGBATTLERESOURCE_ONHIT_METHOD_3_3C3CB0289058124D_OFFSET UNITYSDK_OFFSET(0x187E60A0)
#define RPG_GAMECORE_CHENLINGBATTLERESOURCE_ONHIT__CTOR_OFFSET UNITYSDK_OFFSET(0x187E6090)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleResource_OnHit_TypeDefinitionIndex = 14945;
