...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONTRAITREFRESHCONFIG_METHOD_3_45B2D7F8CA342F3E_OFFSET UNITYSDK_OFFSET(0x1D069AF0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONTRAITREFRESHCONFIG_METHOD_3_DC072E02F9BAE9FA_OFFSET UNITYSDK_OFFSET(0x1D069B40)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONTRAITREFRESHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D069B30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierExecActionTraitRefreshConfig_TypeDefinitionIndex = 18706;
