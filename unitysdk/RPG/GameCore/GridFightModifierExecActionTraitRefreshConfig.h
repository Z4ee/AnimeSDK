...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONTRAITREFRESHCONFIG_METHOD_3_DC072E02F9BAE9FA_OFFSET UNITYSDK_OFFSET(0x197ECD50)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONTRAITREFRESHCONFIG_METHOD_3_E3F4B3FB8224CBC3_OFFSET UNITYSDK_OFFSET(0x197F2320)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONTRAITREFRESHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197ECD00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierExecActionTraitRefreshConfig_TypeDefinitionIndex = 18457;
