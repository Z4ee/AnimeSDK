...
#define RPG_GAMECORE_ROGUEMODIFIEREMPTYCONFIG_METHOD_3_5BE4BF30B68717AD_OFFSET UNITYSDK_OFFSET(0x1CFBF710)
#define RPG_GAMECORE_ROGUEMODIFIEREMPTYCONFIG_METHOD_3_9A78C67E77E8D229_OFFSET UNITYSDK_OFFSET(0x1CFBF6C0)
#define RPG_GAMECORE_ROGUEMODIFIEREMPTYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFBF700)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierEmptyConfig_TypeDefinitionIndex = 16967;
