...
#define RPG_GAMECORE_ADDFINISHMISSIONDATA_RESULTVALUE_METHOD_3_B7CEC4C5E028EE47_OFFSET UNITYSDK_OFFSET(0x16F1C8B0)
#define RPG_GAMECORE_ADDFINISHMISSIONDATA_RESULTVALUE_METHOD_3_F9506AD661724CD0_OFFSET UNITYSDK_OFFSET(0x16F1C830)
#define RPG_GAMECORE_ADDFINISHMISSIONDATA_RESULTVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F1C880)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddFinishMissionData_ResultValue_TypeDefinitionIndex = 19733;
