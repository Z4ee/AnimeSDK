...
#define RPG_GAMECORE_REGISTERPROPSERVERSTATEROTATION_METHOD_3_06B1D112378BF985_OFFSET UNITYSDK_OFFSET(0x1758A330)
#define RPG_GAMECORE_REGISTERPROPSERVERSTATEROTATION_METHOD_3_E026BB97B36428B5_OFFSET UNITYSDK_OFFSET(0x1758A2A0)
#define RPG_GAMECORE_REGISTERPROPSERVERSTATEROTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1758A300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RegisterPropServerStateRotation_TypeDefinitionIndex = 18639;
