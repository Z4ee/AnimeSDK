...
#define RPG_GAMECORE_REGISTERPROPSERVERSTATEROTATION_METHOD_3_06B1D112378BF985_OFFSET UNITYSDK_OFFSET(0x1B9C1A80)
#define RPG_GAMECORE_REGISTERPROPSERVERSTATEROTATION_METHOD_3_E13DAE68EB354821_OFFSET UNITYSDK_OFFSET(0x1B9C1A30)
#define RPG_GAMECORE_REGISTERPROPSERVERSTATEROTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9C1A70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RegisterPropServerStateRotation_TypeDefinitionIndex = 19568;
