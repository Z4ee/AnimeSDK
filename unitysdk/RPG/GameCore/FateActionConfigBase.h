...
#define RPG_GAMECORE_FATEACTIONCONFIGBASE_METHOD_5_2E1FEF72D589D632_OFFSET UNITYSDK_OFFSET(0x171C3CC0)
#define RPG_GAMECORE_FATEACTIONCONFIGBASE_METHOD_5_84FBF189411E3ABB_OFFSET UNITYSDK_OFFSET(0x171C25D0)
#define RPG_GAMECORE_FATEACTIONCONFIGBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x171C02B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateActionConfigBase_TypeDefinitionIndex = 17647;
