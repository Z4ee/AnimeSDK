...
#define RPG_GAMECORE_FATEACTIONCONFIGBASE_METHOD_5_2E1FEF72D589D632_OFFSET UNITYSDK_OFFSET(0x1C073F20)
#define RPG_GAMECORE_FATEACTIONCONFIGBASE_METHOD_5_84FBF189411E3ABB_OFFSET UNITYSDK_OFFSET(0x1C073A50)
#define RPG_GAMECORE_FATEACTIONCONFIGBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0731A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateActionConfigBase_TypeDefinitionIndex = 18467;
