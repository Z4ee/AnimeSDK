...
#define RPG_GAMECORE_RESETWOLFBROACHIEVEMENTDATA_METHOD_3_201A73B3F96978B8_OFFSET UNITYSDK_OFFSET(0x175A01C0)
#define RPG_GAMECORE_RESETWOLFBROACHIEVEMENTDATA_METHOD_3_D5C40B11C03D7AE4_OFFSET UNITYSDK_OFFSET(0x175A02D0)
#define RPG_GAMECORE_RESETWOLFBROACHIEVEMENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x175A02A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetWolfBroAchievementData_TypeDefinitionIndex = 20167;
