...
#define RPG_GAMECORE_RESETWOLFBROACHIEVEMENTDATA_METHOD_3_42D0F31D39F8CB61_OFFSET UNITYSDK_OFFSET(0x1D01D1E0)
#define RPG_GAMECORE_RESETWOLFBROACHIEVEMENTDATA_METHOD_3_D5C40B11C03D7AE4_OFFSET UNITYSDK_OFFSET(0x1D01D2B0)
#define RPG_GAMECORE_RESETWOLFBROACHIEVEMENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1D01D2A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetWolfBroAchievementData_TypeDefinitionIndex = 21184;
