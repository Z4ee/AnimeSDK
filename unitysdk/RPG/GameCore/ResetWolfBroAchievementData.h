...
#define RPG_GAMECORE_RESETWOLFBROACHIEVEMENTDATA_METHOD_3_201A73B3F96978B8_OFFSET UNITYSDK_OFFSET(0x19AD0B70)
#define RPG_GAMECORE_RESETWOLFBROACHIEVEMENTDATA_METHOD_3_D5C40B11C03D7AE4_OFFSET UNITYSDK_OFFSET(0x19AD0C80)
#define RPG_GAMECORE_RESETWOLFBROACHIEVEMENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19AD0C50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetWolfBroAchievementData_TypeDefinitionIndex = 20769;
