...
#define RPG_GAMECORE_CAKERACETOPRANKEDCATSELECTORCONFIG_METHOD_3_C4A00E795624F277_OFFSET UNITYSDK_OFFSET(0x1B706960)
#define RPG_GAMECORE_CAKERACETOPRANKEDCATSELECTORCONFIG_METHOD_3_E5FB56A1DBC73EF2_OFFSET UNITYSDK_OFFSET(0x1B7068B0)
#define RPG_GAMECORE_CAKERACETOPRANKEDCATSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B706950)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceTopRankedCatSelectorConfig_TypeDefinitionIndex = 17660;
