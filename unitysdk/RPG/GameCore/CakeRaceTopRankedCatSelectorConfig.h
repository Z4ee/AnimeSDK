...
#define RPG_GAMECORE_CAKERACETOPRANKEDCATSELECTORCONFIG_METHOD_3_C4A00E795624F277_OFFSET UNITYSDK_OFFSET(0x195EA4E0)
#define RPG_GAMECORE_CAKERACETOPRANKEDCATSELECTORCONFIG_METHOD_3_E5FB56A1DBC73EF2_OFFSET UNITYSDK_OFFSET(0x195F12F0)
#define RPG_GAMECORE_CAKERACETOPRANKEDCATSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x195EA4D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceTopRankedCatSelectorConfig_TypeDefinitionIndex = 17487;
