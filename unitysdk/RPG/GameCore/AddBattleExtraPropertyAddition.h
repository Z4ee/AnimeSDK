...
#define RPG_GAMECORE_ADDBATTLEEXTRAPROPERTYADDITION_METHOD_3_3C69A1D1D13B43DF_OFFSET UNITYSDK_OFFSET(0x1BE03E10)
#define RPG_GAMECORE_ADDBATTLEEXTRAPROPERTYADDITION_METHOD_3_71C60CA31E31452C_OFFSET UNITYSDK_OFFSET(0x1BE03DD0)
#define RPG_GAMECORE_ADDBATTLEEXTRAPROPERTYADDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE03E00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddBattleExtraPropertyAddition_TypeDefinitionIndex = 22797;
