...
#define RPG_GAMECORE_ADDBATTLEEXTRAPROPERTYADDITION_METHOD_3_3C69A1D1D13B43DF_OFFSET UNITYSDK_OFFSET(0x16F1A520)
#define RPG_GAMECORE_ADDBATTLEEXTRAPROPERTYADDITION_METHOD_3_90923B5DC3A9463C_OFFSET UNITYSDK_OFFSET(0x16F1A4A0)
#define RPG_GAMECORE_ADDBATTLEEXTRAPROPERTYADDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x16F1A4F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddBattleExtraPropertyAddition_TypeDefinitionIndex = 21893;
