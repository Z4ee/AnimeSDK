...
#define RPG_GAMECORE_AVATARSERVANTSKILLLINKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x194AA650)
#define RPG_GAMECORE_AVATARSERVANTSKILLLINKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x194AA840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AvatarServantSkillLinkRow_TypeDefinitionIndex = 12199;
