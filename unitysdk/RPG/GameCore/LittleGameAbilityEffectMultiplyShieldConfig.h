...
#define RPG_GAMECORE_LITTLEGAMEABILITYEFFECTMULTIPLYSHIELDCONFIG_METHOD_3_00580BEEDAD158D1_OFFSET UNITYSDK_OFFSET(0x19893010)
#define RPG_GAMECORE_LITTLEGAMEABILITYEFFECTMULTIPLYSHIELDCONFIG_METHOD_3_4852F881812C7825_OFFSET UNITYSDK_OFFSET(0x198930E0)
#define RPG_GAMECORE_LITTLEGAMEABILITYEFFECTMULTIPLYSHIELDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x198930D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityEffectMultiplyShieldConfig_TypeDefinitionIndex = 20178;
