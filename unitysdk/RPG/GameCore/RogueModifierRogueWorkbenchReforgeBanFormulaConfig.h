...
#define RPG_GAMECORE_ROGUEMODIFIERROGUEWORKBENCHREFORGEBANFORMULACONFIG_METHOD_3_2732D8BC9D583CB0_OFFSET UNITYSDK_OFFSET(0x1D165F60)
#define RPG_GAMECORE_ROGUEMODIFIERROGUEWORKBENCHREFORGEBANFORMULACONFIG_METHOD_3_F554BCF81A3AADB4_OFFSET UNITYSDK_OFFSET(0x1D165F10)
#define RPG_GAMECORE_ROGUEMODIFIERROGUEWORKBENCHREFORGEBANFORMULACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D165F50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierRogueWorkbenchReforgeBanFormulaConfig_TypeDefinitionIndex = 17042;
