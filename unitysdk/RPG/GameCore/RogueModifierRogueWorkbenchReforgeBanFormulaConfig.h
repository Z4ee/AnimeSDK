...
#define RPG_GAMECORE_ROGUEMODIFIERROGUEWORKBENCHREFORGEBANFORMULACONFIG_METHOD_3_2732D8BC9D583CB0_OFFSET UNITYSDK_OFFSET(0x18D460A0)
#define RPG_GAMECORE_ROGUEMODIFIERROGUEWORKBENCHREFORGEBANFORMULACONFIG_METHOD_3_32D78297F5001C59_OFFSET UNITYSDK_OFFSET(0x18D45FD0)
#define RPG_GAMECORE_ROGUEMODIFIERROGUEWORKBENCHREFORGEBANFORMULACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D46050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierRogueWorkbenchReforgeBanFormulaConfig_TypeDefinitionIndex = 16865;
