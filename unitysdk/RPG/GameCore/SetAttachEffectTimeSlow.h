...
#define RPG_GAMECORE_SETATTACHEFFECTTIMESLOW_METHOD_3_88803EEF9AD05800_OFFSET UNITYSDK_OFFSET(0x19C28500)
#define RPG_GAMECORE_SETATTACHEFFECTTIMESLOW_METHOD_3_ED48E6976B9B61A2_OFFSET UNITYSDK_OFFSET(0x19C28580)
#define RPG_GAMECORE_SETATTACHEFFECTTIMESLOW__CTOR_OFFSET UNITYSDK_OFFSET(0x19C28550)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetAttachEffectTimeSlow_TypeDefinitionIndex = 21636;
