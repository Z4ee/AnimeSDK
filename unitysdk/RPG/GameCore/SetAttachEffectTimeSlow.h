...
#define RPG_GAMECORE_SETATTACHEFFECTTIMESLOW_METHOD_3_54D3A3A4CA5E781D_OFFSET UNITYSDK_OFFSET(0x1D4E0720)
#define RPG_GAMECORE_SETATTACHEFFECTTIMESLOW_METHOD_3_ED48E6976B9B61A2_OFFSET UNITYSDK_OFFSET(0x1D4E0760)
#define RPG_GAMECORE_SETATTACHEFFECTTIMESLOW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4E0750)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetAttachEffectTimeSlow_TypeDefinitionIndex = 22627;
