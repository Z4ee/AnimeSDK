...
#define RPG_GAMECORE_ROGUEMODIFERDECREASEDOORNUMCONFIG_METHOD_3_ACEDF884159F3836_OFFSET UNITYSDK_OFFSET(0x19B4DB40)
#define RPG_GAMECORE_ROGUEMODIFERDECREASEDOORNUMCONFIG_METHOD_3_BEA6470C373FACEF_OFFSET UNITYSDK_OFFSET(0x19B4DC10)
#define RPG_GAMECORE_ROGUEMODIFERDECREASEDOORNUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B4DBC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModiferDecreaseDoorNumConfig_TypeDefinitionIndex = 16905;
