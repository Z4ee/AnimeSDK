...
#define RPG_GAMECORE_ROGUEMODIFERDECREASEDOORNUMCONFIG_METHOD_3_79A88E540E1759EB_OFFSET UNITYSDK_OFFSET(0x1CFBED40)
#define RPG_GAMECORE_ROGUEMODIFERDECREASEDOORNUMCONFIG_METHOD_3_BEA6470C373FACEF_OFFSET UNITYSDK_OFFSET(0x1CFBED90)
#define RPG_GAMECORE_ROGUEMODIFERDECREASEDOORNUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFBED80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModiferDecreaseDoorNumConfig_TypeDefinitionIndex = 17067;
