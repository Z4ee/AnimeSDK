...
#define RPG_GAMECORE_ROGUEMODIFERDECREASEDOORNUMCONFIG_METHOD_3_ACEDF884159F3836_OFFSET UNITYSDK_OFFSET(0x18D2A1C0)
#define RPG_GAMECORE_ROGUEMODIFERDECREASEDOORNUMCONFIG_METHOD_3_BEA6470C373FACEF_OFFSET UNITYSDK_OFFSET(0x18D2A290)
#define RPG_GAMECORE_ROGUEMODIFERDECREASEDOORNUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D2A240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModiferDecreaseDoorNumConfig_TypeDefinitionIndex = 16890;
