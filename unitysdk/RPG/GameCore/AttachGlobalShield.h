...
#define RPG_GAMECORE_ATTACHGLOBALSHIELD_METHOD_3_11A0124276C92D57_OFFSET UNITYSDK_OFFSET(0x1CE2B7E0)
#define RPG_GAMECORE_ATTACHGLOBALSHIELD_METHOD_3_739D0C3ACF4291CE_OFFSET UNITYSDK_OFFSET(0x1CE2B820)
#define RPG_GAMECORE_ATTACHGLOBALSHIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE2B810)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AttachGlobalShield_TypeDefinitionIndex = 23332;
