...
#define RPG_GAMECORE_SETDYNAMICVALUEBYTEAMFORMATIONROW_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1C5F2480)
#define RPG_GAMECORE_SETDYNAMICVALUEBYTEAMFORMATIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C5F2440)
#define RPG_GAMECORE_SETDYNAMICVALUEBYTEAMFORMATIONROW_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1C5F2690)
#define RPG_GAMECORE_SETDYNAMICVALUEBYTEAMFORMATIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5F2470)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByTeamFormationRow_TypeDefinitionIndex = 22095;
