...
#define RPG_GAMECORE_ADVENTUREPOSITIONCHECKCONFIG_METHOD_2_1F1110F156ECB82E_OFFSET UNITYSDK_OFFSET(0x194528E0)
#define RPG_GAMECORE_ADVENTUREPOSITIONCHECKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19452CF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventurePositionCheckConfig_TypeDefinitionIndex = 15470;
