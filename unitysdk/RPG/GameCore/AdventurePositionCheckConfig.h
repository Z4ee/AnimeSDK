...
#define RPG_GAMECORE_ADVENTUREPOSITIONCHECKCONFIG_METHOD_2_1F1110F156ECB82E_OFFSET UNITYSDK_OFFSET(0x1867BB50)
#define RPG_GAMECORE_ADVENTUREPOSITIONCHECKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1867BF60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventurePositionCheckConfig_TypeDefinitionIndex = 15407;
