...
#define RPG_GAMECORE_ROGUECURSECHESTEVENTEFFECTCONFIG_METHOD_2_5424454870640780_OFFSET UNITYSDK_OFFSET(0x18CFC7C0)
#define RPG_GAMECORE_ROGUECURSECHESTEVENTEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CFC800)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueCurseChestEventEffectConfig_TypeDefinitionIndex = 17002;
