...
#define RPG_GAMECORE_ROGUECURSECHESTEVENTEFFECTCONFIG_METHOD_2_5424454870640780_OFFSET UNITYSDK_OFFSET(0x1D918F60)
#define RPG_GAMECORE_ROGUECURSECHESTEVENTEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D918FA0)
