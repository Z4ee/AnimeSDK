...
#define RPG_GAMECORE_ROGUECURSECHESTEVENTEFFECTCONFIG_METHOD_2_5424454870640780_OFFSET UNITYSDK_OFFSET(0x1D3CC090)
#define RPG_GAMECORE_ROGUECURSECHESTEVENTEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3CC0D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueCurseChestEventEffectConfig_TypeDefinitionIndex = 17695;
