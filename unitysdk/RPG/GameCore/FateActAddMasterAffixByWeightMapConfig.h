...
#define RPG_GAMECORE_FATEACTADDMASTERAFFIXBYWEIGHTMAPCONFIG_METHOD_6_5FD4B69A2EC441A5_OFFSET UNITYSDK_OFFSET(0x171C0AD0)
#define RPG_GAMECORE_FATEACTADDMASTERAFFIXBYWEIGHTMAPCONFIG_METHOD_6_FFA14217EDC64736_OFFSET UNITYSDK_OFFSET(0x171C0C40)
#define RPG_GAMECORE_FATEACTADDMASTERAFFIXBYWEIGHTMAPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171C0BA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateActAddMasterAffixByWeightMapConfig_TypeDefinitionIndex = 17657;
