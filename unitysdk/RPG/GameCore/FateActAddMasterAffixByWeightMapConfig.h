...
#define RPG_GAMECORE_FATEACTADDMASTERAFFIXBYWEIGHTMAPCONFIG_METHOD_6_5FD4B69A2EC441A5_OFFSET UNITYSDK_OFFSET(0x188CE2A0)
#define RPG_GAMECORE_FATEACTADDMASTERAFFIXBYWEIGHTMAPCONFIG_METHOD_6_FFA14217EDC64736_OFFSET UNITYSDK_OFFSET(0x188CE410)
#define RPG_GAMECORE_FATEACTADDMASTERAFFIXBYWEIGHTMAPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x188CE370)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateActAddMasterAffixByWeightMapConfig_TypeDefinitionIndex = 18270;
