...
#define RPG_GAMECORE_ADDFINISHMISSIONDATA_CONSUMEITEM_METHOD_3_0F47F964318FB135_OFFSET UNITYSDK_OFFSET(0x16F1BE40)
#define RPG_GAMECORE_ADDFINISHMISSIONDATA_CONSUMEITEM_METHOD_3_EBD30C7C61E90F00_OFFSET UNITYSDK_OFFSET(0x16F1BEC0)
#define RPG_GAMECORE_ADDFINISHMISSIONDATA_CONSUMEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x16F1BE90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddFinishMissionData_ConsumeItem_TypeDefinitionIndex = 19731;
