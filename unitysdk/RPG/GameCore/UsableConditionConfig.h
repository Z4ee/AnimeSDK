...
#define RPG_GAMECORE_USABLECONDITIONCONFIG_METHOD_2_FFAF40007F4E7997_OFFSET UNITYSDK_OFFSET(0x19E38C40)
#define RPG_GAMECORE_USABLECONDITIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19E38D80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UsableConditionConfig_TypeDefinitionIndex = 17285;
