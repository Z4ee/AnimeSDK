...
#define RPG_GAMECORE_SYNCCHARLIGHTANDCAMERADIR_METHOD_3_76009D8938878669_OFFSET UNITYSDK_OFFSET(0x1B444210)
#define RPG_GAMECORE_SYNCCHARLIGHTANDCAMERADIR_METHOD_3_E2E3C2BA929095F2_OFFSET UNITYSDK_OFFSET(0x1B444260)
#define RPG_GAMECORE_SYNCCHARLIGHTANDCAMERADIR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B444250)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SyncCharLightAndCameraDir_TypeDefinitionIndex = 22147;
