...
#define RPG_GAMECORE_SYNCCHARLIGHTANDCAMERADIR_METHOD_3_5296C003FA497B9B_OFFSET UNITYSDK_OFFSET(0x19CE9730)
#define RPG_GAMECORE_SYNCCHARLIGHTANDCAMERADIR_METHOD_3_E2E3C2BA929095F2_OFFSET UNITYSDK_OFFSET(0x19CE97B0)
#define RPG_GAMECORE_SYNCCHARLIGHTANDCAMERADIR__CTOR_OFFSET UNITYSDK_OFFSET(0x19CE9780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SyncCharLightAndCameraDir_TypeDefinitionIndex = 21720;
