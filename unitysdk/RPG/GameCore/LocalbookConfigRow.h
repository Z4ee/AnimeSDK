...
#define RPG_GAMECORE_LOCALBOOKCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17368610)
#define RPG_GAMECORE_LOCALBOOKCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17368DB0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 BookID; // 0x20
		::System::UInt32 BookSeriesInsideID; // 0x24
