...
#define RPG_GAMECORE_LOCALBOOKCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D20DB90)
#define RPG_GAMECORE_LOCALBOOKCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D20E310)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 BookSeriesInsideID; // 0x18
		::System::UInt32 BookDisplayType; // 0x1C
		::RPG::Client::TextID BookContent; // 0x20
		::RPG::Client::TextID BookInsideName; // 0x30
