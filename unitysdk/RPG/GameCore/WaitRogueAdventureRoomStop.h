...
#define RPG_GAMECORE_WAITROGUEADVENTUREROOMSTOP_METHOD_3_1032F56253E91DDF_OFFSET UNITYSDK_OFFSET(0x1D1BAAC0)
#define RPG_GAMECORE_WAITROGUEADVENTUREROOMSTOP_METHOD_3_35749F8A3455FDE3_OFFSET UNITYSDK_OFFSET(0x1D1BAB10)
#define RPG_GAMECORE_WAITROGUEADVENTUREROOMSTOP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1BAB00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitRogueAdventureRoomStop_TypeDefinitionIndex = 20027;
