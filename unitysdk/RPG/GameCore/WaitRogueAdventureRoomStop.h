...
#define RPG_GAMECORE_WAITROGUEADVENTUREROOMSTOP_METHOD_3_32186C84FEDFAF33_OFFSET UNITYSDK_OFFSET(0x17902880)
#define RPG_GAMECORE_WAITROGUEADVENTUREROOMSTOP_METHOD_3_35749F8A3455FDE3_OFFSET UNITYSDK_OFFSET(0x17902910)
#define RPG_GAMECORE_WAITROGUEADVENTUREROOMSTOP__CTOR_OFFSET UNITYSDK_OFFSET(0x179028E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitRogueAdventureRoomStop_TypeDefinitionIndex = 19133;
