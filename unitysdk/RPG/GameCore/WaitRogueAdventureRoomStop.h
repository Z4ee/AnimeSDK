...
#define RPG_GAMECORE_WAITROGUEADVENTUREROOMSTOP_METHOD_3_32186C84FEDFAF33_OFFSET UNITYSDK_OFFSET(0x19E5EFA0)
#define RPG_GAMECORE_WAITROGUEADVENTUREROOMSTOP_METHOD_3_35749F8A3455FDE3_OFFSET UNITYSDK_OFFSET(0x19E5F030)
#define RPG_GAMECORE_WAITROGUEADVENTUREROOMSTOP__CTOR_OFFSET UNITYSDK_OFFSET(0x19E5F000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitRogueAdventureRoomStop_TypeDefinitionIndex = 19668;
