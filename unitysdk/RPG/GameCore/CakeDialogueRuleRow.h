...
#define RPG_GAMECORE_CAKEDIALOGUERULEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x195E3150)
#define RPG_GAMECORE_CAKEDIALOGUERULEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x195E3390)
