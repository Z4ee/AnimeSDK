...
#define RPG_GAMECORE_CAKEDIALOGUERULEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CDD21A0)
#define RPG_GAMECORE_CAKEDIALOGUERULEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDD23E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeDialogueRuleRow_TypeDefinitionIndex = 12831;

	class CakeDialogueRuleRow : public ::System::Object
	{
	public:
		::Il2CppArray<::System::UInt32>* CakeDialogueList; // 0x10
