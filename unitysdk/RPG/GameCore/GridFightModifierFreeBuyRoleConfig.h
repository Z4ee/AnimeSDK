...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERFREEBUYROLECONFIG_METHOD_3_59AE2875D934308F_OFFSET UNITYSDK_OFFSET(0x1726B1F0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERFREEBUYROLECONFIG_METHOD_3_8422E1E3944CE266_OFFSET UNITYSDK_OFFSET(0x17267AA0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERFREEBUYROLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17267A50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierFreeBuyRoleConfig_TypeDefinitionIndex = 17774;
