...
#define RPG_GAMECORE_EFFECTMUTEXCONFIGDATA_METHOD_2_1B76CF12BE3EEDF1_OFFSET UNITYSDK_OFFSET(0x1DB242C0)
#define RPG_GAMECORE_EFFECTMUTEXCONFIGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB24410)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EffectMutexConfigData_TypeDefinitionIndex = 16315;
