...
#define RPG_GAMECORE_EFFECTMUTEXCONFIGDATA_METHOD_2_1B76CF12BE3EEDF1_OFFSET UNITYSDK_OFFSET(0x17189A30)
#define RPG_GAMECORE_EFFECTMUTEXCONFIGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17189B80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EffectMutexConfigData_TypeDefinitionIndex = 15096;
