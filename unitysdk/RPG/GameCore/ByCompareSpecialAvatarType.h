...
#define RPG_GAMECORE_BYCOMPARESPECIALAVATARTYPE_METHOD_4_4859B7814DC3AC38_OFFSET UNITYSDK_OFFSET(0x17017D50)
#define RPG_GAMECORE_BYCOMPARESPECIALAVATARTYPE_METHOD_4_810BE6FA90AF7850_OFFSET UNITYSDK_OFFSET(0x17017E20)
#define RPG_GAMECORE_BYCOMPARESPECIALAVATARTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x17017DD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareSpecialAvatarType_TypeDefinitionIndex = 21598;
