...
#define RPG_GAMECORE_ACTIVITYWORLDUNLOCKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16F19B10)
#define RPG_GAMECORE_ACTIVITYWORLDUNLOCKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16F19C00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityWorldUnlockRow_TypeDefinitionIndex = 10510;
