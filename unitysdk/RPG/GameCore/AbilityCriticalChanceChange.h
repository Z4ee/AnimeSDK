...
#define RPG_GAMECORE_ABILITYCRITICALCHANCECHANGE_CLEAR_OFFSET UNITYSDK_OFFSET(0x106C8C90)
#define RPG_GAMECORE_ABILITYCRITICALCHANCECHANGE_GETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x106C8D80)
#define RPG_GAMECORE_ABILITYCRITICALCHANCECHANGE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x106C8D30)
#define RPG_GAMECORE_ABILITYCRITICALCHANCECHANGE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x106C8CE0)
#define RPG_GAMECORE_ABILITYCRITICALCHANCECHANGE_INIT_OFFSET UNITYSDK_OFFSET(0x106C8BF0)
#define RPG_GAMECORE_ABILITYCRITICALCHANCECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x106C8DD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AbilityCriticalChanceChange_TypeDefinitionIndex = 54029;
