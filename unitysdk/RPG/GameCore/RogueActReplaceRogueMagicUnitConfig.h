...
#define RPG_GAMECORE_ROGUEACTREPLACEROGUEMAGICUNITCONFIG_METHOD_6_035A161E31149A1F_OFFSET UNITYSDK_OFFSET(0x1C49DEF0)
#define RPG_GAMECORE_ROGUEACTREPLACEROGUEMAGICUNITCONFIG_METHOD_6_DD0F31FCBE21D89B_OFFSET UNITYSDK_OFFSET(0x1C49DEA0)
#define RPG_GAMECORE_ROGUEACTREPLACEROGUEMAGICUNITCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C49DEE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActReplaceRogueMagicUnitConfig_TypeDefinitionIndex = 18934;
