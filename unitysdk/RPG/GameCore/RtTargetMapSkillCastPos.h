...
#define RPG_GAMECORE_RTTARGETMAPSKILLCASTPOS_METHOD_3_2A01848665E3CBF1_OFFSET UNITYSDK_OFFSET(0x1D4B8660)
#define RPG_GAMECORE_RTTARGETMAPSKILLCASTPOS_METHOD_3_8F6E66689235D067_OFFSET UNITYSDK_OFFSET(0x1D4B85C0)
#define RPG_GAMECORE_RTTARGETMAPSKILLCASTPOS_METHOD_3_CB9ECD291A08BF0D_OFFSET UNITYSDK_OFFSET(0x1D4B8620)
#define RPG_GAMECORE_RTTARGETMAPSKILLCASTPOS_METHOD_3_F9CC8743A04445F6_OFFSET UNITYSDK_OFFSET(0x1D4B8520)
#define RPG_GAMECORE_RTTARGETMAPSKILLCASTPOS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4B85B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtTargetMapSkillCastPos_TypeDefinitionIndex = 23974;
