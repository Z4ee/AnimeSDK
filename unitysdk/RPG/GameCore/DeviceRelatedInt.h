...
#define RPG_GAMECORE_DEVICERELATEDINT_METHOD_3_654DAE80410DB4CA_OFFSET UNITYSDK_OFFSET(0x1C1069D0)
#define RPG_GAMECORE_DEVICERELATEDINT_METHOD_3_722E37EE47C006A4_OFFSET UNITYSDK_OFFSET(0x1C106510)
#define RPG_GAMECORE_DEVICERELATEDINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C106500)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DeviceRelatedInt_TypeDefinitionIndex = 15820;
