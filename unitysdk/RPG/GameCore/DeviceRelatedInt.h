...
#define RPG_GAMECORE_DEVICERELATEDINT_METHOD_3_6D8AF074C50B60D6_OFFSET UNITYSDK_OFFSET(0x17156FF0)
#define RPG_GAMECORE_DEVICERELATEDINT_METHOD_3_7BD49A918916E460_OFFSET UNITYSDK_OFFSET(0x171574A0)
#define RPG_GAMECORE_DEVICERELATEDINT__CTOR_OFFSET UNITYSDK_OFFSET(0x17156FE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DeviceRelatedInt_TypeDefinitionIndex = 15077;
