...
#define RPG_GAMECORE_ROGUEPERSONAATTRIBUTECONFIG_METHOD_2_9E458FFBBC73863C_OFFSET UNITYSDK_OFFSET(0x17657870)
#define RPG_GAMECORE_ROGUEPERSONAATTRIBUTECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x176578B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RoguePersonaAttributeConfig_TypeDefinitionIndex = 16545;
