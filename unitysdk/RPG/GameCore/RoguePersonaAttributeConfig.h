...
#define RPG_GAMECORE_ROGUEPERSONAATTRIBUTECONFIG_METHOD_2_9E458FFBBC73863C_OFFSET UNITYSDK_OFFSET(0x19BB9750)
#define RPG_GAMECORE_ROGUEPERSONAATTRIBUTECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19BB9790)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RoguePersonaAttributeConfig_TypeDefinitionIndex = 17112;
