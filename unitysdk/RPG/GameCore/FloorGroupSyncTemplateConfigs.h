...
#define RPG_GAMECORE_FLOORGROUPSYNCTEMPLATECONFIGS_METHOD_2_762C9646973179A3_OFFSET UNITYSDK_OFFSET(0x19761F30)
#define RPG_GAMECORE_FLOORGROUPSYNCTEMPLATECONFIGS__CTOR_OFFSET UNITYSDK_OFFSET(0x19761F70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FloorGroupSyncTemplateConfigs_TypeDefinitionIndex = 16539;
