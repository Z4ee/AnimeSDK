...
#define RPG_GAMECORE_FLOORGROUPSYNCTEMPLATECONFIGS_METHOD_2_762C9646973179A3_OFFSET UNITYSDK_OFFSET(0x1DCAE8E0)
#define RPG_GAMECORE_FLOORGROUPSYNCTEMPLATECONFIGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCAE920)
