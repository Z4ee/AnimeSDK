...
#define RPG_GAMECORE_CONVINCEPANELACTIVE_METHOD_3_4D5D2BB3EC7934D6_OFFSET UNITYSDK_OFFSET(0x1883E9D0)
#define RPG_GAMECORE_CONVINCEPANELACTIVE_METHOD_3_81EECD333FA9F64F_OFFSET UNITYSDK_OFFSET(0x1883E950)
#define RPG_GAMECORE_CONVINCEPANELACTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1883E9A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConvincePanelActive_TypeDefinitionIndex = 20692;
