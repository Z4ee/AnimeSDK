...
#define RPG_GAMECORE_CONVINCEPANELACTIVE_METHOD_3_4D5D2BB3EC7934D6_OFFSET UNITYSDK_OFFSET(0x1D003C80)
#define RPG_GAMECORE_CONVINCEPANELACTIVE_METHOD_3_9EB7E3E0B3776E87_OFFSET UNITYSDK_OFFSET(0x1D003C40)
#define RPG_GAMECORE_CONVINCEPANELACTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D003C70)
