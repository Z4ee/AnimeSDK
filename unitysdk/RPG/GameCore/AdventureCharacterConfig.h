...
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1944B4F0)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_GETATTACHPOINTEFFECTADAPTIONCONFIG_OFFSET UNITYSDK_OFFSET(0x1944D3B0)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_GETEFFECTADAPTIONCONFIG_OFFSET UNITYSDK_OFFSET(0x1944D270)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_GETEFFECTATTACHPOINTREDIRECT_OFFSET UNITYSDK_OFFSET(0x1944D3C0)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERAICONFIG_GET_ADVAICONFIG_OFFSET UNITYSDK_OFFSET(0x1944D4C0)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERAICONFIG_GET_AICONFIGOVERRIDELIST_OFFSET UNITYSDK_OFFSET(0x1944D4B0)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERANIMCONFIG_GET_ANIMZONECONFIGPATH_OFFSET UNITYSDK_OFFSET(0x1944D630)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERANIMCONFIG_GET_BREAKRECOVERSTANDBYTYPE_OFFSET UNITYSDK_OFFSET(0x1944D640)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERANIMCONFIG_GET_COMMONANIMZONECONFIGPATH_OFFSET UNITYSDK_OFFSET(0x1944D620)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERANIMCONFIG_GET_ENABLEFOOTIK_OFFSET UNITYSDK_OFFSET(0x1944D590)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERANIMCONFIG_GET_ENABLEIDLESHOW_OFFSET UNITYSDK_OFFSET(0x1944D5A0)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERANIMCONFIG_GET_FASTRUNSPEEDRATIO_OFFSET UNITYSDK_OFFSET(0x1944D540)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERANIMCONFIG_GET_FOOTSCALE_OFFSET UNITYSDK_OFFSET(0x1944D4D0)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERANIMCONFIG_GET_IDLESHOWCONFIG_OFFSET UNITYSDK_OFFSET(0x1944D5B0)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERANIMCONFIG_GET_MAXFASTRUNANIMSPEEDRATIO_OFFSET UNITYSDK_OFFSET(0x1944D550)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERANIMCONFIG_GET_MAXRUNANIMSPEEDRATIO_OFFSET UNITYSDK_OFFSET(0x1944D530)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERANIMCONFIG_GET_MAXWALKANIMSPEEDRATIO_OFFSET UNITYSDK_OFFSET(0x1944D520)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERANIMCONFIG_GET_OVERRIDEMOVEMENTSTEPTOGROUNDCURVENAME_OFFSET UNITYSDK_OFFSET(0x1944D610)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERANIMCONFIG_GET_REFERENCEFASTRUNSPEED_OFFSET UNITYSDK_OFFSET(0x1944D580)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERANIMCONFIG_GET_REFERENCERUNSPEED_OFFSET UNITYSDK_OFFSET(0x1944D570)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERANIMCONFIG_GET_REFERENCEWALKSPEED_OFFSET UNITYSDK_OFFSET(0x1944D560)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERANIMCONFIG_GET_ROOTMOTIONSCALE_OFFSET UNITYSDK_OFFSET(0x1944D510)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERANIMCONFIG_GET_RUNSPEEDRATIO_OFFSET UNITYSDK_OFFSET(0x1944D500)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERANIMCONFIG_GET_WALKSPEEDRATIO_OFFSET UNITYSDK_OFFSET(0x1944D4F0)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERMOVECONFIG_GET_ADVENTURESOMATOTYPE_OFFSET UNITYSDK_OFFSET(0x1944D650)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERMOVECONFIG_GET_NAVMOVINGSTEERTURNBACKTURNSPEED_OFFSET UNITYSDK_OFFSET(0x1944D690)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERMOVECONFIG_GET_NAVMOVINGSTEERTURNSPEED_OFFSET UNITYSDK_OFFSET(0x1944D680)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERMOVECONFIG_GET_NAVTURNBACKTURNSPEED_OFFSET UNITYSDK_OFFSET(0x1944D670)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERMOVECONFIG_GET_NAVTURNSPEED_OFFSET UNITYSDK_OFFSET(0x1944D660)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERMOVECONFIG_GET_USENAVJUMPLAYER_OFFSET UNITYSDK_OFFSET(0x1944D6A0)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERSKILLCONFIG_GET_ABILITYLIST_OFFSET UNITYSDK_OFFSET(0x1944D6E0)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERSKILLCONFIG_GET_SKILLABILITYLIST_OFFSET UNITYSDK_OFFSET(0x1944D6D0)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERSKILLCONFIG_GET_SKILLLIST_OFFSET UNITYSDK_OFFSET(0x1944D6C0)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERSKILLCONFIG_GET_USETYPEAHEADSKILLINPUT_OFFSET UNITYSDK_OFFSET(0x1944D6B0)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1944CEA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureCharacterConfig_TypeDefinitionIndex = 16573;
