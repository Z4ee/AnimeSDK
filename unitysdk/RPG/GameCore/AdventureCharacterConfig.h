...
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1AE59E30)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_GETATTACHPOINTEFFECTADAPTIONCONFIG_OFFSET UNITYSDK_OFFSET(0x1AE5BCF0)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_GETEFFECTADAPTIONCONFIG_OFFSET UNITYSDK_OFFSET(0x1AE5BBB0)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_GETEFFECTATTACHPOINTREDIRECT_OFFSET UNITYSDK_OFFSET(0x1AE5BD00)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERAICONFIG_GET_ADVAICONFIG_OFFSET UNITYSDK_OFFSET(0x1AE5BE00)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERAICONFIG_GET_AICONFIGOVERRIDELIST_OFFSET UNITYSDK_OFFSET(0x1AE5BDF0)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERANIMCONFIG_GET_ANIMZONECONFIGPATH_OFFSET UNITYSDK_OFFSET(0x1AE5BF70)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERANIMCONFIG_GET_BREAKRECOVERSTANDBYTYPE_OFFSET UNITYSDK_OFFSET(0x1AE5BF80)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERANIMCONFIG_GET_COMMONANIMZONECONFIGPATH_OFFSET UNITYSDK_OFFSET(0x1AE5BF60)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERANIMCONFIG_GET_ENABLEFOOTIK_OFFSET UNITYSDK_OFFSET(0x1AE5BED0)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERANIMCONFIG_GET_ENABLEIDLESHOW_OFFSET UNITYSDK_OFFSET(0x1AE5BEE0)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERANIMCONFIG_GET_FASTRUNSPEEDRATIO_OFFSET UNITYSDK_OFFSET(0x1AE5BE80)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERANIMCONFIG_GET_FOOTSCALE_OFFSET UNITYSDK_OFFSET(0x1AE5BE10)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERANIMCONFIG_GET_IDLESHOWCONFIG_OFFSET UNITYSDK_OFFSET(0x1AE5BEF0)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERANIMCONFIG_GET_MAXFASTRUNANIMSPEEDRATIO_OFFSET UNITYSDK_OFFSET(0x1AE5BE90)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERANIMCONFIG_GET_MAXRUNANIMSPEEDRATIO_OFFSET UNITYSDK_OFFSET(0x1AE5BE70)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERANIMCONFIG_GET_MAXWALKANIMSPEEDRATIO_OFFSET UNITYSDK_OFFSET(0x1AE5BE60)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERANIMCONFIG_GET_OVERRIDEMOVEMENTSTEPTOGROUNDCURVENAME_OFFSET UNITYSDK_OFFSET(0x1AE5BF50)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERANIMCONFIG_GET_REFERENCEFASTRUNSPEED_OFFSET UNITYSDK_OFFSET(0x1AE5BEC0)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERANIMCONFIG_GET_REFERENCERUNSPEED_OFFSET UNITYSDK_OFFSET(0x1AE5BEB0)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERANIMCONFIG_GET_REFERENCEWALKSPEED_OFFSET UNITYSDK_OFFSET(0x1AE5BEA0)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERANIMCONFIG_GET_ROOTMOTIONSCALE_OFFSET UNITYSDK_OFFSET(0x1AE5BE50)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERANIMCONFIG_GET_RUNSPEEDRATIO_OFFSET UNITYSDK_OFFSET(0x1AE5BE40)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERANIMCONFIG_GET_WALKSPEEDRATIO_OFFSET UNITYSDK_OFFSET(0x1AE5BE30)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERMOVECONFIG_GET_ADVENTURESOMATOTYPE_OFFSET UNITYSDK_OFFSET(0x1AE5BF90)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERMOVECONFIG_GET_NAVMOVINGSTEERTURNBACKTURNSPEED_OFFSET UNITYSDK_OFFSET(0x1AE5BFD0)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERMOVECONFIG_GET_NAVMOVINGSTEERTURNSPEED_OFFSET UNITYSDK_OFFSET(0x1AE5BFC0)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERMOVECONFIG_GET_NAVTURNBACKTURNSPEED_OFFSET UNITYSDK_OFFSET(0x1AE5BFB0)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERMOVECONFIG_GET_NAVTURNSPEED_OFFSET UNITYSDK_OFFSET(0x1AE5BFA0)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERMOVECONFIG_GET_USENAVJUMPLAYER_OFFSET UNITYSDK_OFFSET(0x1AE5BFE0)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERSKILLCONFIG_GET_ABILITYLIST_OFFSET UNITYSDK_OFFSET(0x1AE5C020)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERSKILLCONFIG_GET_SKILLABILITYLIST_OFFSET UNITYSDK_OFFSET(0x1AE5C010)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERSKILLCONFIG_GET_SKILLLIST_OFFSET UNITYSDK_OFFSET(0x1AE5C000)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG_RPG_GAMECORE_IADVENTURECHARACTERSKILLCONFIG_GET_USETYPEAHEADSKILLINPUT_OFFSET UNITYSDK_OFFSET(0x1AE5BFF0)
#define RPG_GAMECORE_ADVENTURECHARACTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE5B7E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureCharacterConfig_TypeDefinitionIndex = 16735;
