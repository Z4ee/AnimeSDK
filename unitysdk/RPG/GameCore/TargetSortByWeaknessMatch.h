...
#define RPG_GAMECORE_TARGETSORTBYWEAKNESSMATCH_METHOD_3_7580DB8B4A4B40DE_OFFSET UNITYSDK_OFFSET(0x1E1C4930)
#define RPG_GAMECORE_TARGETSORTBYWEAKNESSMATCH_METHOD_3_EB054EE9DAD10D7E_OFFSET UNITYSDK_OFFSET(0x1E1C4990)
#define RPG_GAMECORE_TARGETSORTBYWEAKNESSMATCH_METHOD_3_F1D3434D68917F85_OFFSET UNITYSDK_OFFSET(0x1E1C4B00)
#define RPG_GAMECORE_TARGETSORTBYWEAKNESSMATCH_METHOD_3_F91A1490DDD7AEE1_OFFSET UNITYSDK_OFFSET(0x1E1C4AB0)
#define RPG_GAMECORE_TARGETSORTBYWEAKNESSMATCH__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1C4980)
