...
#define RPG_GAMECORE_TARGETSORTBYWEAKNESSMATCH_METHOD_3_27FD06F3DCC54FB2_OFFSET UNITYSDK_OFFSET(0x177D3940)
#define RPG_GAMECORE_TARGETSORTBYWEAKNESSMATCH_METHOD_3_EB054EE9DAD10D7E_OFFSET UNITYSDK_OFFSET(0x177D29D0)
#define RPG_GAMECORE_TARGETSORTBYWEAKNESSMATCH__CTOR_OFFSET UNITYSDK_OFFSET(0x177D29B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetSortByWeaknessMatch_TypeDefinitionIndex = 22269;
