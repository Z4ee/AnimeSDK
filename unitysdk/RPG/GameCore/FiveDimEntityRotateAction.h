...
#define RPG_GAMECORE_FIVEDIMENTITYROTATEACTION_METHOD_3_0484B2FE21A5BE3F_OFFSET UNITYSDK_OFFSET(0x1973ACE0)
#define RPG_GAMECORE_FIVEDIMENTITYROTATEACTION_METHOD_3_B4A0EE9E455A866E_OFFSET UNITYSDK_OFFSET(0x1972E630)
#define RPG_GAMECORE_FIVEDIMENTITYROTATEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1972E610)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimEntityRotateAction_TypeDefinitionIndex = 17840;
