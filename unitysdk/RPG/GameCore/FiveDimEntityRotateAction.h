...
#define RPG_GAMECORE_FIVEDIMENTITYROTATEACTION_METHOD_3_0484B2FE21A5BE3F_OFFSET UNITYSDK_OFFSET(0x171F0D50)
#define RPG_GAMECORE_FIVEDIMENTITYROTATEACTION_METHOD_3_B4A0EE9E455A866E_OFFSET UNITYSDK_OFFSET(0x171E7880)
#define RPG_GAMECORE_FIVEDIMENTITYROTATEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x171E7860)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimEntityRotateAction_TypeDefinitionIndex = 17211;
