...
#define RPG_GAMECORE_PARALLELCOMPLETECONFIG_METHOD_4_8839706DDC6753F2_OFFSET UNITYSDK_OFFSET(0x1D412900)
#define RPG_GAMECORE_PARALLELCOMPLETECONFIG_METHOD_4_D9FB642352B45979_OFFSET UNITYSDK_OFFSET(0x1D412940)
#define RPG_GAMECORE_PARALLELCOMPLETECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D412930)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ParallelCompleteConfig_TypeDefinitionIndex = 23509;
