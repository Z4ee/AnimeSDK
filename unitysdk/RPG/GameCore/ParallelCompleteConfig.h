...
#define RPG_GAMECORE_PARALLELCOMPLETECONFIG_METHOD_4_8839706DDC6753F2_OFFSET UNITYSDK_OFFSET(0x1D309C30)
#define RPG_GAMECORE_PARALLELCOMPLETECONFIG_METHOD_4_D9FB642352B45979_OFFSET UNITYSDK_OFFSET(0x1D309C70)
#define RPG_GAMECORE_PARALLELCOMPLETECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D309C60)
