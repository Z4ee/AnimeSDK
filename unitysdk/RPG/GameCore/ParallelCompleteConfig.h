...
#define RPG_GAMECORE_PARALLELCOMPLETECONFIG_METHOD_4_041A8831D8870D80_OFFSET UNITYSDK_OFFSET(0x17487D60)
#define RPG_GAMECORE_PARALLELCOMPLETECONFIG_METHOD_4_D9FB642352B45979_OFFSET UNITYSDK_OFFSET(0x17487DE0)
#define RPG_GAMECORE_PARALLELCOMPLETECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17487DB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ParallelCompleteConfig_TypeDefinitionIndex = 22056;
