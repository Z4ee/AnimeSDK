...
#define RPG_GAMECORE_FATEBATTLESHOWRIDERUI_METHOD_3_20FB45312980566F_OFFSET UNITYSDK_OFFSET(0x171C4130)
#define RPG_GAMECORE_FATEBATTLESHOWRIDERUI_METHOD_3_E4AF285C2EE313FE_OFFSET UNITYSDK_OFFSET(0x171C40B0)
#define RPG_GAMECORE_FATEBATTLESHOWRIDERUI__CTOR_OFFSET UNITYSDK_OFFSET(0x171C4100)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateBattleShowRiderUI_TypeDefinitionIndex = 21529;
