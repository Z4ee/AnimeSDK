...
#define RPG_GAMECORE_GRIDFIGHTAVATARROW_AVATARCOMMONROWWRAP_BINDOVERRIDESKILLS_OFFSET UNITYSDK_OFFSET(0x189A23B0)
#define RPG_GAMECORE_GRIDFIGHTAVATARROW_AVATARCOMMONROWWRAP_BIND_OFFSET UNITYSDK_OFFSET(0x189A2490)
#define RPG_GAMECORE_GRIDFIGHTAVATARROW_AVATARCOMMONROWWRAP_CLEAR_OFFSET UNITYSDK_OFFSET(0x189A2370)
#define RPG_GAMECORE_GRIDFIGHTAVATARROW_AVATARCOMMONROWWRAP_GETAVATARSTARROW_OFFSET UNITYSDK_OFFSET(0x189A2610)
#define RPG_GAMECORE_GRIDFIGHTAVATARROW_AVATARCOMMONROWWRAP_GETID_OFFSET UNITYSDK_OFFSET(0x189A26B0)
#define RPG_GAMECORE_GRIDFIGHTAVATARROW_AVATARCOMMONROWWRAP_GETRARITY_OFFSET UNITYSDK_OFFSET(0x189A26F0)
#define RPG_GAMECORE_GRIDFIGHTAVATARROW_AVATARCOMMONROWWRAP_GETSTARPROPERTYVALUES_OFFSET UNITYSDK_OFFSET(0x189A26D0)
#define RPG_GAMECORE_GRIDFIGHTAVATARROW_AVATARCOMMONROWWRAP_GETSTAR_OFFSET UNITYSDK_OFFSET(0x189A26A0)
#define RPG_GAMECORE_GRIDFIGHTAVATARROW_AVATARCOMMONROWWRAP_GET_ALLBACKENDRANKIDLIST_OFFSET UNITYSDK_OFFSET(0x189A27A0)
#define RPG_GAMECORE_GRIDFIGHTAVATARROW_AVATARCOMMONROWWRAP_GET_ASBACKAVATAR_OFFSET UNITYSDK_OFFSET(0x189A2650)
#define RPG_GAMECORE_GRIDFIGHTAVATARROW_AVATARCOMMONROWWRAP_GET_INHERITEDSKILLLIST_OFFSET UNITYSDK_OFFSET(0x189A2760)
#define RPG_GAMECORE_GRIDFIGHTAVATARROW_AVATARCOMMONROWWRAP_GET_ISVALIDGRIDFIGHTAVATAR_OFFSET UNITYSDK_OFFSET(0x189A25E0)
#define RPG_GAMECORE_GRIDFIGHTAVATARROW_AVATARCOMMONROWWRAP_GET_JSONPATH_OFFSET UNITYSDK_OFFSET(0x189A2710)
#define RPG_GAMECORE_GRIDFIGHTAVATARROW_AVATARCOMMONROWWRAP_GET_MGRREF_OFFSET UNITYSDK_OFFSET(0x189A25C0)
#define RPG_GAMECORE_GRIDFIGHTAVATARROW_AVATARCOMMONROWWRAP_GET_SKILLLIST_OFFSET UNITYSDK_OFFSET(0x189A2660)
#define RPG_GAMECORE_GRIDFIGHTAVATARROW_AVATARCOMMONROWWRAP_GET__ASFRONTAVATAR_OFFSET UNITYSDK_OFFSET(0x189A2460)
#define RPG_GAMECORE_GRIDFIGHTAVATARROW_AVATARCOMMONROWWRAP_SET_MGRREF_OFFSET UNITYSDK_OFFSET(0x189A25D0)
#define RPG_GAMECORE_GRIDFIGHTAVATARROW_AVATARCOMMONROWWRAP__CTOR_OFFSET UNITYSDK_OFFSET(0x189A27C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightAvatarRow_AvatarCommonRowWrap_TypeDefinitionIndex = 23623;
	...
	public:
		...
		::Il2CppArray<::System::UInt32>* _OverrideSkillList; // 0x30
		::RPG::GameCore::GridFightRoleConfigRow* _GridFightRow; // 0x38
		::RPG::GameCore::GridFightRoleStarConfigRow* _GridFightStarRow; // 0x40
