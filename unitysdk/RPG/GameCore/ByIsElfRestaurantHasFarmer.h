...
#define RPG_GAMECORE_BYISELFRESTAURANTHASFARMER_METHOD_4_A0B8F8C76835344A_OFFSET UNITYSDK_OFFSET(0x1A8DF070)
#define RPG_GAMECORE_BYISELFRESTAURANTHASFARMER_METHOD_4_B7531D6468EFD717_OFFSET UNITYSDK_OFFSET(0x1A8DF030)
#define RPG_GAMECORE_BYISELFRESTAURANTHASFARMER_METHOD_4_CE1E4895D65475F3_OFFSET UNITYSDK_OFFSET(0x1A8DF210)
#define RPG_GAMECORE_BYISELFRESTAURANTHASFARMER_METHOD_4_D43EF50661A1155C_OFFSET UNITYSDK_OFFSET(0x1A8DF1E0)
#define RPG_GAMECORE_BYISELFRESTAURANTHASFARMER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8DF060)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsElfRestaurantHasFarmer_TypeDefinitionIndex = 23509;
