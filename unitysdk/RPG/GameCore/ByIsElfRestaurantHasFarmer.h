...
#define RPG_GAMECORE_BYISELFRESTAURANTHASFARMER_METHOD_4_23E7DB998D5E6CC0_OFFSET UNITYSDK_OFFSET(0x18751700)
#define RPG_GAMECORE_BYISELFRESTAURANTHASFARMER_METHOD_4_A0B8F8C76835344A_OFFSET UNITYSDK_OFFSET(0x187517D0)
#define RPG_GAMECORE_BYISELFRESTAURANTHASFARMER__CTOR_OFFSET UNITYSDK_OFFSET(0x18751780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsElfRestaurantHasFarmer_TypeDefinitionIndex = 23384;
