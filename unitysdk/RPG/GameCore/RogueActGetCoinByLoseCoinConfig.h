...
#define RPG_GAMECORE_ROGUEACTGETCOINBYLOSECOINCONFIG_METHOD_6_90DA48C4D0FE3AFC_OFFSET UNITYSDK_OFFSET(0x175B5750)
#define RPG_GAMECORE_ROGUEACTGETCOINBYLOSECOINCONFIG_METHOD_6_AE251F1F877DBA81_OFFSET UNITYSDK_OFFSET(0x175B5530)
#define RPG_GAMECORE_ROGUEACTGETCOINBYLOSECOINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175B5670)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActGetCoinByLoseCoinConfig_TypeDefinitionIndex = 17977;
