...
#define RPG_GAMECORE_ROGUEACTGETCOINBYLOSECOINCONFIG_METHOD_6_22C4A17053597C00_OFFSET UNITYSDK_OFFSET(0x1D02DCE0)
#define RPG_GAMECORE_ROGUEACTGETCOINBYLOSECOINCONFIG_METHOD_6_90DA48C4D0FE3AFC_OFFSET UNITYSDK_OFFSET(0x1D02DD30)
#define RPG_GAMECORE_ROGUEACTGETCOINBYLOSECOINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D02DD20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActGetCoinByLoseCoinConfig_TypeDefinitionIndex = 18865;
