...
#define RPG_GAMECORE_FANTASTICSTORYBUFFROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D7E3110)
#define RPG_GAMECORE_FANTASTICSTORYBUFFROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7E3390)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FantasticStoryBuffRow_TypeDefinitionIndex = 11451;
