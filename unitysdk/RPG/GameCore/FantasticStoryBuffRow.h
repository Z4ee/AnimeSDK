...
#define RPG_GAMECORE_FANTASTICSTORYBUFFROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D0886D0)
#define RPG_GAMECORE_FANTASTICSTORYBUFFROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D088950)
