...
#define RPG_GAMECORE_CHIMERADUELMODIFIERCONTAINERNODE_METHOD_3_9A82C3F36EFB80D7_OFFSET UNITYSDK_OFFSET(0x187FFE60)
#define RPG_GAMECORE_CHIMERADUELMODIFIERCONTAINERNODE_METHOD_3_A954EC6E42428FFC_OFFSET UNITYSDK_OFFSET(0x187FFD80)
#define RPG_GAMECORE_CHIMERADUELMODIFIERCONTAINERNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x187FFE10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelModifierContainerNode_TypeDefinitionIndex = 15183;
