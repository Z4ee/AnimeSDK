...
#define RPG_GAMECORE_CHIMERADUELMODIFIERCONTAINERNODE_METHOD_3_229A6414E6DB882A_OFFSET UNITYSDK_OFFSET(0x1CFCA550)
#define RPG_GAMECORE_CHIMERADUELMODIFIERCONTAINERNODE_METHOD_3_E053F932FB290682_OFFSET UNITYSDK_OFFSET(0x1CFCA5B0)
#define RPG_GAMECORE_CHIMERADUELMODIFIERCONTAINERNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFCA5A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelModifierContainerNode_TypeDefinitionIndex = 15845;
