...
#define RPG_GAMECORE_TRIGGERTURNPAGE_METHOD_3_DAA618FA14AE3BC3_OFFSET UNITYSDK_OFFSET(0x19E1F2F0)
#define RPG_GAMECORE_TRIGGERTURNPAGE_METHOD_3_DCBB455CC140C12F_OFFSET UNITYSDK_OFFSET(0x19E1F1E0)
#define RPG_GAMECORE_TRIGGERTURNPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x19E1F2C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerTurnPage_TypeDefinitionIndex = 21455;
