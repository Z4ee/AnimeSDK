...
#define RPG_GAMECORE_TRIGGERTURNPAGE_METHOD_3_06F3E0AC12248846_OFFSET UNITYSDK_OFFSET(0x1B060DC0)
#define RPG_GAMECORE_TRIGGERTURNPAGE_METHOD_3_DAA618FA14AE3BC3_OFFSET UNITYSDK_OFFSET(0x1B060E90)
#define RPG_GAMECORE_TRIGGERTURNPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B060E80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerTurnPage_TypeDefinitionIndex = 21875;
