...
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEMIRACLEGROUPCONFIG_METHOD_3_9B47C259291AE42B_OFFSET UNITYSDK_OFFSET(0x18D45790)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEMIRACLEGROUPCONFIG_METHOD_3_DE5216F97BA93FD2_OFFSET UNITYSDK_OFFSET(0x18D456C0)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEMIRACLEGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D45740)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierReplaceContentRogueMiracleGroupConfig_TypeDefinitionIndex = 16812;
