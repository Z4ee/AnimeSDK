...
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEMIRACLEGROUPCONFIG_METHOD_3_510AFE3D69074087_OFFSET UNITYSDK_OFFSET(0x1D3FC000)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEMIRACLEGROUPCONFIG_METHOD_3_9B47C259291AE42B_OFFSET UNITYSDK_OFFSET(0x1D3FC050)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEMIRACLEGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3FC040)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierReplaceContentRogueMiracleGroupConfig_TypeDefinitionIndex = 17492;
