...
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEMIRACLEGROUPCONFIG_METHOD_3_9B47C259291AE42B_OFFSET UNITYSDK_OFFSET(0x17638C40)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEMIRACLEGROUPCONFIG_METHOD_3_DE5216F97BA93FD2_OFFSET UNITYSDK_OFFSET(0x17638B70)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEMIRACLEGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17638BF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierReplaceContentRogueMiracleGroupConfig_TypeDefinitionIndex = 16258;
