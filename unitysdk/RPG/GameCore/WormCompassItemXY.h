...
#define RPG_GAMECORE_WORMCOMPASSITEMXY_METHOD_2_127EA6CDB6955818_OFFSET UNITYSDK_OFFSET(0x1D6B8A40)
#define RPG_GAMECORE_WORMCOMPASSITEMXY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6B8C00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WormCompassItemXY_TypeDefinitionIndex = 21918;
