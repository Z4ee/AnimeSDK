...
#define RPG_GAMECORE_SWORDTRAININGEVENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1779CEE0)
#define RPG_GAMECORE_SWORDTRAININGEVENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1779D2B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwordTrainingEventRow_TypeDefinitionIndex = 11392;
	...
	public:
		...
		::RPG::Client::TextID TalkEventText2; // 0x58
