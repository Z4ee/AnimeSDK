...
#define RPG_GAMECORE_SWORDTRAININGEVENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1E1566B0)
#define RPG_GAMECORE_SWORDTRAININGEVENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1E156A70)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID TalkEventText2; // 0x20
