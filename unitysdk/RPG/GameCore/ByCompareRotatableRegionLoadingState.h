...
#define RPG_GAMECORE_BYCOMPAREROTATABLEREGIONLOADINGSTATE_METHOD_4_8A1789E91CA00C3B_OFFSET UNITYSDK_OFFSET(0x1A89EC50)
#define RPG_GAMECORE_BYCOMPAREROTATABLEREGIONLOADINGSTATE_METHOD_4_9C9A3D24403A53D5_OFFSET UNITYSDK_OFFSET(0x1A89EEB0)
#define RPG_GAMECORE_BYCOMPAREROTATABLEREGIONLOADINGSTATE_METHOD_4_B8BEA7E4BC5A0852_OFFSET UNITYSDK_OFFSET(0x1A89EEE0)
#define RPG_GAMECORE_BYCOMPAREROTATABLEREGIONLOADINGSTATE_METHOD_4_CCB8B5B5406629EA_OFFSET UNITYSDK_OFFSET(0x1A89EC90)
#define RPG_GAMECORE_BYCOMPAREROTATABLEREGIONLOADINGSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A89EC80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareRotatableRegionLoadingState_TypeDefinitionIndex = 20128;
