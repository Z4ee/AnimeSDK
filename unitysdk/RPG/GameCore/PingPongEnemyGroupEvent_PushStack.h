...
#define RPG_GAMECORE_PINGPONGENEMYGROUPEVENT_PUSHSTACK_METHOD_3_AAB148B80F8440B5_OFFSET UNITYSDK_OFFSET(0x1B4C76C0)
#define RPG_GAMECORE_PINGPONGENEMYGROUPEVENT_PUSHSTACK_METHOD_3_EDC43DF8F5CDF2A1_OFFSET UNITYSDK_OFFSET(0x1B4C7460)
#define RPG_GAMECORE_PINGPONGENEMYGROUPEVENT_PUSHSTACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4C7450)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PingPongEnemyGroupEvent_PushStack_TypeDefinitionIndex = 16319;
