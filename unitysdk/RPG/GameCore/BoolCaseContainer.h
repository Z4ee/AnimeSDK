...
#define RPG_GAMECORE_BOOLCASECONTAINER_METHOD_3_49DDABB5CEC66292_OFFSET UNITYSDK_OFFSET(0x16FEE970)
#define RPG_GAMECORE_BOOLCASECONTAINER_METHOD_3_75D3C90ED0C606F9_OFFSET UNITYSDK_OFFSET(0x16FEE930)
#define RPG_GAMECORE_BOOLCASECONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x16FEE960)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BoolCaseContainer_TypeDefinitionIndex = 16114;
