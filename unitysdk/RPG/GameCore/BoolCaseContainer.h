...
#define RPG_GAMECORE_BOOLCASECONTAINER_METHOD_3_52C327CF1F70D1BF_OFFSET UNITYSDK_OFFSET(0x1A405E50)
#define RPG_GAMECORE_BOOLCASECONTAINER_METHOD_3_7A2705D4D2695F00_OFFSET UNITYSDK_OFFSET(0x1A405E90)
#define RPG_GAMECORE_BOOLCASECONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A405E80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BoolCaseContainer_TypeDefinitionIndex = 16837;
