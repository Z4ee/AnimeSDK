...
#define RPG_GAMECORE_COMPLEXSKILLAIPOSTPROCESSUPPERGROUP_METHOD_3_42E81117D20917AE_OFFSET UNITYSDK_OFFSET(0x1CFF36D0)
#define RPG_GAMECORE_COMPLEXSKILLAIPOSTPROCESSUPPERGROUP_METHOD_3_FDAF493017918F69_OFFSET UNITYSDK_OFFSET(0x1CFF3960)
#define RPG_GAMECORE_COMPLEXSKILLAIPOSTPROCESSUPPERGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFF36C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAIPostProcessUpperGroup_TypeDefinitionIndex = 15392;
