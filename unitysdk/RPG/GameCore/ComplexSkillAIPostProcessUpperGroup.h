...
#define RPG_GAMECORE_COMPLEXSKILLAIPOSTPROCESSUPPERGROUP_METHOD_3_42E81117D20917AE_OFFSET UNITYSDK_OFFSET(0x1966BCA0)
#define RPG_GAMECORE_COMPLEXSKILLAIPOSTPROCESSUPPERGROUP_METHOD_3_FDAF493017918F69_OFFSET UNITYSDK_OFFSET(0x1966BF30)
#define RPG_GAMECORE_COMPLEXSKILLAIPOSTPROCESSUPPERGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1966BC90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAIPostProcessUpperGroup_TypeDefinitionIndex = 14794;
