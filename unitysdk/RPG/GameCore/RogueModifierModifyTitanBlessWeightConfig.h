...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYTITANBLESSWEIGHTCONFIG_METHOD_3_3D575DA445247EFD_OFFSET UNITYSDK_OFFSET(0x1EEFB950)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYTITANBLESSWEIGHTCONFIG_METHOD_3_B6C5B9B859852D21_OFFSET UNITYSDK_OFFSET(0x1EEFB9A0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYTITANBLESSWEIGHTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEFB990)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyTitanBlessWeightConfig_TypeDefinitionIndex = 17536;
