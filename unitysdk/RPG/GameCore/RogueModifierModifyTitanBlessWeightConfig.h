...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYTITANBLESSWEIGHTCONFIG_METHOD_3_9A82260FE438C448_OFFSET UNITYSDK_OFFSET(0x18D42F60)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYTITANBLESSWEIGHTCONFIG_METHOD_3_B6C5B9B859852D21_OFFSET UNITYSDK_OFFSET(0x18D43030)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYTITANBLESSWEIGHTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D42FE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyTitanBlessWeightConfig_TypeDefinitionIndex = 16856;
