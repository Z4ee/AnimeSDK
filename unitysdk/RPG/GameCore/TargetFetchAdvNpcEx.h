...
#define RPG_GAMECORE_TARGETFETCHADVNPCEX_METHOD_4_201A31293351DF6B_OFFSET UNITYSDK_OFFSET(0x1D0B3F60)
#define RPG_GAMECORE_TARGETFETCHADVNPCEX_METHOD_4_795EBDABA2FFB809_OFFSET UNITYSDK_OFFSET(0x1D0B4120)
#define RPG_GAMECORE_TARGETFETCHADVNPCEX_METHOD_4_7F7C413B92FDA50E_OFFSET UNITYSDK_OFFSET(0x1D0B3F20)
#define RPG_GAMECORE_TARGETFETCHADVNPCEX_METHOD_4_FCD275E76F541AFF_OFFSET UNITYSDK_OFFSET(0x1D0B40F0)
#define RPG_GAMECORE_TARGETFETCHADVNPCEX__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0B3F50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchAdvNpcEx_TypeDefinitionIndex = 23023;
