...
#define RPG_GAMECORE_TARGETFETCHADVNPCEX_METHOD_4_201A31293351DF6B_OFFSET UNITYSDK_OFFSET(0x177BB850)
#define RPG_GAMECORE_TARGETFETCHADVNPCEX_METHOD_4_C126435DE3ECF21F_OFFSET UNITYSDK_OFFSET(0x177BB790)
#define RPG_GAMECORE_TARGETFETCHADVNPCEX__CTOR_OFFSET UNITYSDK_OFFSET(0x177BB800)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchAdvNpcEx_TypeDefinitionIndex = 22144;
