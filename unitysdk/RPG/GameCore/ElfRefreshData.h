...
#define RPG_GAMECORE_ELFREFRESHDATA_METHOD_3_71143DE3EE3D142B_OFFSET UNITYSDK_OFFSET(0x1889DBD0)
#define RPG_GAMECORE_ELFREFRESHDATA_METHOD_3_7FE8E2F055FD29B7_OFFSET UNITYSDK_OFFSET(0x1889DAC0)
#define RPG_GAMECORE_ELFREFRESHDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1889DBA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfRefreshData_TypeDefinitionIndex = 20584;
