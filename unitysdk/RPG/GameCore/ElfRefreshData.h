...
#define RPG_GAMECORE_ELFREFRESHDATA_METHOD_3_71143DE3EE3D142B_OFFSET UNITYSDK_OFFSET(0x171904A0)
#define RPG_GAMECORE_ELFREFRESHDATA_METHOD_3_7FE8E2F055FD29B7_OFFSET UNITYSDK_OFFSET(0x17190390)
#define RPG_GAMECORE_ELFREFRESHDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17190470)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfRefreshData_TypeDefinitionIndex = 19903;
