...
#define RPG_GAMECORE_RTSKILLEXTRACONFIGBASE_METHOD_2_1DA63BBD2128607B_OFFSET UNITYSDK_OFFSET(0x19BF0DA0)
#define RPG_GAMECORE_RTSKILLEXTRACONFIGBASE_METHOD_2_F11E3F9E62820973_OFFSET UNITYSDK_OFFSET(0x19BF0FC0)
#define RPG_GAMECORE_RTSKILLEXTRACONFIGBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x19BF0FB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtSkillExtraConfigBase_TypeDefinitionIndex = 16798;
