...
#define RPG_GAMECORE_TREASUREDUNGEOACTIVITYQUESTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x178B8990)
#define RPG_GAMECORE_TREASUREDUNGEOACTIVITYQUESTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x178B9050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TreasureDungeoActivityQuestConfigRow_TypeDefinitionIndex = 11436;
