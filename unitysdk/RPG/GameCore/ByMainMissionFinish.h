...
#define RPG_GAMECORE_BYMAINMISSIONFINISH_METHOD_4_724AEBA713197D9D_OFFSET UNITYSDK_OFFSET(0x1B2AE960)
#define RPG_GAMECORE_BYMAINMISSIONFINISH_METHOD_4_77CA0793CFBEA70E_OFFSET UNITYSDK_OFFSET(0x1B2AEB00)
#define RPG_GAMECORE_BYMAINMISSIONFINISH_METHOD_4_D7464AD26ABF75E4_OFFSET UNITYSDK_OFFSET(0x1B2AE920)
#define RPG_GAMECORE_BYMAINMISSIONFINISH_METHOD_4_FAE11127B79763C1_OFFSET UNITYSDK_OFFSET(0x1B2AEAD0)
#define RPG_GAMECORE_BYMAINMISSIONFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2AE950)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByMainMissionFinish_TypeDefinitionIndex = 19693;
