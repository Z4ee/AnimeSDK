...
#define RPG_GAMECORE_OVERRIDEENTITYMODIFIERPHASECAMERA_METHOD_3_0505474B812367DA_OFFSET UNITYSDK_OFFSET(0x17482690)
#define RPG_GAMECORE_OVERRIDEENTITYMODIFIERPHASECAMERA_METHOD_3_A28636602C5A9B6D_OFFSET UNITYSDK_OFFSET(0x17482610)
#define RPG_GAMECORE_OVERRIDEENTITYMODIFIERPHASECAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x17482660)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OverrideEntityModifierPhaseCamera_TypeDefinitionIndex = 20955;
