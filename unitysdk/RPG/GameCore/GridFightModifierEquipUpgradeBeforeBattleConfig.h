...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREQUIPUPGRADEBEFOREBATTLECONFIG_METHOD_3_4B64C6F62DFF4ECF_OFFSET UNITYSDK_OFFSET(0x1C5D0C20)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREQUIPUPGRADEBEFOREBATTLECONFIG_METHOD_3_F6F21D125552A2CB_OFFSET UNITYSDK_OFFSET(0x1C5D0BD0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREQUIPUPGRADEBEFOREBATTLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5D0C10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierEquipUpgradeBeforeBattleConfig_TypeDefinitionIndex = 18709;
