...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREQUIPUPGRADEBEFOREBATTLECONFIG_METHOD_3_31256A1571DA5F96_OFFSET UNITYSDK_OFFSET(0x1726A1F0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREQUIPUPGRADEBEFOREBATTLECONFIG_METHOD_3_4B64C6F62DFF4ECF_OFFSET UNITYSDK_OFFSET(0x17265EA0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREQUIPUPGRADEBEFOREBATTLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17265E50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierEquipUpgradeBeforeBattleConfig_TypeDefinitionIndex = 17865;
