...
#define RPG_GAMECORE_SWITCHREFBASE_METHOD_2_38696A2313BF856F_OFFSET UNITYSDK_OFFSET(0x177998E0)
#define RPG_GAMECORE_SWITCHREFBASE_METHOD_2_5904CD377781D222_OFFSET UNITYSDK_OFFSET(0x17798770)
#define RPG_GAMECORE_SWITCHREFBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x17799940)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchRefBase_TypeDefinitionIndex = 22041;
