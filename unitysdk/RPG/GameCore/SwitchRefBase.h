...
#define RPG_GAMECORE_SWITCHREFBASE_METHOD_2_38696A2313BF856F_OFFSET UNITYSDK_OFFSET(0x18EBFB40)
#define RPG_GAMECORE_SWITCHREFBASE_METHOD_2_5904CD377781D222_OFFSET UNITYSDK_OFFSET(0x18EBE9D0)
#define RPG_GAMECORE_SWITCHREFBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x18EBFBA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchRefBase_TypeDefinitionIndex = 22757;
