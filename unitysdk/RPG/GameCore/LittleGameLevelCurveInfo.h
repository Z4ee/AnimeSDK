...
#define RPG_GAMECORE_LITTLEGAMELEVELCURVEINFO_METHOD_2_2D6E774D549B2975_OFFSET UNITYSDK_OFFSET(0x1989DE30)
#define RPG_GAMECORE_LITTLEGAMELEVELCURVEINFO_METHOD_2_CEB754F3F93AA827_OFFSET UNITYSDK_OFFSET(0x1989FBF0)
#define RPG_GAMECORE_LITTLEGAMELEVELCURVEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19898160)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameLevelCurveInfo_TypeDefinitionIndex = 17937;
