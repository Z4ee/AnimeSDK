...
#define RPG_GAMECORE_LITTLEGAMELEVELCURVEINFO_METHOD_2_435B8C2FCD02CF71_OFFSET UNITYSDK_OFFSET(0x1735C990)
#define RPG_GAMECORE_LITTLEGAMELEVELCURVEINFO_METHOD_2_CEB754F3F93AA827_OFFSET UNITYSDK_OFFSET(0x1735E5B0)
#define RPG_GAMECORE_LITTLEGAMELEVELCURVEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x17354700)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameLevelCurveInfo_TypeDefinitionIndex = 17302;
