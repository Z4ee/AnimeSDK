...
#define RPG_GAMECORE_LITTLEGAMELEVELCURVEINFO_METHOD_2_2D6E774D549B2975_OFFSET UNITYSDK_OFFSET(0x1BCC0360)
#define RPG_GAMECORE_LITTLEGAMELEVELCURVEINFO_METHOD_2_CEB754F3F93AA827_OFFSET UNITYSDK_OFFSET(0x1BCC2620)
#define RPG_GAMECORE_LITTLEGAMELEVELCURVEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCBE2F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameLevelCurveInfo_TypeDefinitionIndex = 18116;
