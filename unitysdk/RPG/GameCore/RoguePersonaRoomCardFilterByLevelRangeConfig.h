...
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYLEVELRANGECONFIG_METHOD_3_39B9AEFBE609ADBE_OFFSET UNITYSDK_OFFSET(0x18D657F0)
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYLEVELRANGECONFIG_METHOD_3_B6707E2BB4C576A2_OFFSET UNITYSDK_OFFSET(0x18D65A80)
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYLEVELRANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D657E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RoguePersonaRoomCardFilterByLevelRangeConfig_TypeDefinitionIndex = 18856;
