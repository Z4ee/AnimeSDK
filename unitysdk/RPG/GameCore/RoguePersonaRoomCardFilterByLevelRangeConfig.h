...
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYLEVELRANGECONFIG_METHOD_3_39B9AEFBE609ADBE_OFFSET UNITYSDK_OFFSET(0x19BB9CB0)
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYLEVELRANGECONFIG_METHOD_3_B6707E2BB4C576A2_OFFSET UNITYSDK_OFFSET(0x19BB9F40)
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYLEVELRANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19BB9CA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RoguePersonaRoomCardFilterByLevelRangeConfig_TypeDefinitionIndex = 18821;
