...
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYLEVELRANGECONFIG_METHOD_3_39B9AEFBE609ADBE_OFFSET UNITYSDK_OFFSET(0x1BB67E10)
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYLEVELRANGECONFIG_METHOD_3_B6707E2BB4C576A2_OFFSET UNITYSDK_OFFSET(0x1BB680A0)
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYLEVELRANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB67E00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RoguePersonaRoomCardFilterByLevelRangeConfig_TypeDefinitionIndex = 19103;
