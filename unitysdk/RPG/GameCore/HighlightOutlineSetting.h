...
#define RPG_GAMECORE_HIGHLIGHTOUTLINESETTING_METHOD_2_12123BF3F4A917BA_OFFSET UNITYSDK_OFFSET(0x172AB9F0)
#define RPG_GAMECORE_HIGHLIGHTOUTLINESETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x172ABC10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HighlightOutlineSetting_TypeDefinitionIndex = 15718;
