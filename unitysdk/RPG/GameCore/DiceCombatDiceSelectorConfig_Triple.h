...
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_TRIPLE_METHOD_3_17FE67D9F4CE3B6B_OFFSET UNITYSDK_OFFSET(0x188685C0)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_TRIPLE_METHOD_3_BFDDE7D88375760A_OFFSET UNITYSDK_OFFSET(0x188679A0)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_TRIPLE__CTOR_OFFSET UNITYSDK_OFFSET(0x18867990)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatDiceSelectorConfig_Triple_TypeDefinitionIndex = 15309;
