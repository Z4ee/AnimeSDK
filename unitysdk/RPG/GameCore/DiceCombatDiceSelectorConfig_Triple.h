...
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_TRIPLE_METHOD_3_17FE67D9F4CE3B6B_OFFSET UNITYSDK_OFFSET(0x1C1103C0)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_TRIPLE_METHOD_3_BFDDE7D88375760A_OFFSET UNITYSDK_OFFSET(0x1C10F7A0)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_TRIPLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C10F790)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatDiceSelectorConfig_Triple_TypeDefinitionIndex = 15532;
