...
#define RPG_GAMECORE_CAKERACEAVATARTALKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17047420)
#define RPG_GAMECORE_CAKERACEAVATARTALKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x170476B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceAvatarTalkRow_TypeDefinitionIndex = 10323;
