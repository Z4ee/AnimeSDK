...
#define RPG_GAMECORE_MAZEBUFFPARAMKEY_METHOD_2_C10F5538C6645469_OFFSET UNITYSDK_OFFSET(0x198FC770)
#define RPG_GAMECORE_MAZEBUFFPARAMKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x198FC8B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MazeBuffParamKey_TypeDefinitionIndex = 17356;
