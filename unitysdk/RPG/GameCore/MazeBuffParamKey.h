...
#define RPG_GAMECORE_MAZEBUFFPARAMKEY_METHOD_2_C10F5538C6645469_OFFSET UNITYSDK_OFFSET(0x173BE0A0)
#define RPG_GAMECORE_MAZEBUFFPARAMKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x173BE1E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MazeBuffParamKey_TypeDefinitionIndex = 16758;
