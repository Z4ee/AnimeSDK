...
#define RPG_GAMECORE_EVOLVEBUILDGEAREQUIPINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x11568580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EvolveBuildGearEquipInfo_TypeDefinitionIndex = 56264;
