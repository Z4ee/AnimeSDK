...
#define RPG_GAMECORE_MONOPOLYQUIZRESULTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17443840)
#define RPG_GAMECORE_MONOPOLYQUIZRESULTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17443EF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonopolyQuizResultRow_TypeDefinitionIndex = 11047;
