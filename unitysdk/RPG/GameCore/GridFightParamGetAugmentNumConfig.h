...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETAUGMENTNUMCONFIG_METHOD_6_03E5170A8B7CB63A_OFFSET UNITYSDK_OFFSET(0x1D15CF00)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETAUGMENTNUMCONFIG_METHOD_6_FCDD411FED36227E_OFFSET UNITYSDK_OFFSET(0x1D15CEB0)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETAUGMENTNUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D15CEF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightParamGetAugmentNumConfig_TypeDefinitionIndex = 19296;
