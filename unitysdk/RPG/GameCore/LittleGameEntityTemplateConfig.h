...
#define RPG_GAMECORE_LITTLEGAMEENTITYTEMPLATECONFIG_METHOD_2_73CC08FE7A770709_OFFSET UNITYSDK_OFFSET(0x1735D4A0)
#define RPG_GAMECORE_LITTLEGAMEENTITYTEMPLATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1735D4E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameEntityTemplateConfig_TypeDefinitionIndex = 17354;
