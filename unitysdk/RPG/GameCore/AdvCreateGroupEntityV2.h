...
#define RPG_GAMECORE_ADVCREATEGROUPENTITYV2_METHOD_3_360ED04ABD9DE24A_OFFSET UNITYSDK_OFFSET(0x1864C320)
#define RPG_GAMECORE_ADVCREATEGROUPENTITYV2_METHOD_3_9B3B57FAF5B70D31_OFFSET UNITYSDK_OFFSET(0x1864C3A0)
#define RPG_GAMECORE_ADVCREATEGROUPENTITYV2__CTOR_OFFSET UNITYSDK_OFFSET(0x1864C370)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvCreateGroupEntityV2_TypeDefinitionIndex = 19226;
