...
#define RPG_GAMECORE_SHAKEDISTANCEATTENUATION_METHOD_2_4D9185EE61470553_OFFSET UNITYSDK_OFFSET(0x1E09A630)
#define RPG_GAMECORE_SHAKEDISTANCEATTENUATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1E09A7D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShakeDistanceAttenuation_TypeDefinitionIndex = 16243;
