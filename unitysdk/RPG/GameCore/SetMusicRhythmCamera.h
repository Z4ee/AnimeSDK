...
#define RPG_GAMECORE_SETMUSICRHYTHMCAMERA_METHOD_3_354DC175E0290D7F_OFFSET UNITYSDK_OFFSET(0x1C603A10)
#define RPG_GAMECORE_SETMUSICRHYTHMCAMERA_METHOD_3_45CDEFDEE5AB30C8_OFFSET UNITYSDK_OFFSET(0x1C6039D0)
#define RPG_GAMECORE_SETMUSICRHYTHMCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x1C603A00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetMusicRhythmCamera_TypeDefinitionIndex = 21248;
