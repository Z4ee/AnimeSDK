...
#define RPG_GAMECORE_ADVNPCGUARDING_METHOD_3_2B038902D5C32559_OFFSET UNITYSDK_OFFSET(0x1942A270)
#define RPG_GAMECORE_ADVNPCGUARDING_METHOD_3_64925654FB707612_OFFSET UNITYSDK_OFFSET(0x1942A1E0)
#define RPG_GAMECORE_ADVNPCGUARDING__CTOR_OFFSET UNITYSDK_OFFSET(0x1942A240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvNPCGuarding_TypeDefinitionIndex = 18857;
