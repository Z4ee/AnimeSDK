...
#define RPG_GAMECORE_ADVNPCGUARDING_METHOD_3_2B038902D5C32559_OFFSET UNITYSDK_OFFSET(0x18656700)
#define RPG_GAMECORE_ADVNPCGUARDING_METHOD_3_64925654FB707612_OFFSET UNITYSDK_OFFSET(0x18656670)
#define RPG_GAMECORE_ADVNPCGUARDING__CTOR_OFFSET UNITYSDK_OFFSET(0x186566D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvNPCGuarding_TypeDefinitionIndex = 18900;
