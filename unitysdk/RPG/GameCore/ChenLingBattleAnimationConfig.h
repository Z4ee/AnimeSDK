...
#define RPG_GAMECORE_CHENLINGBATTLEANIMATIONCONFIG_METHOD_2_B6EBD3005E7550C6_OFFSET UNITYSDK_OFFSET(0x1CFA7550)
#define RPG_GAMECORE_CHENLINGBATTLEANIMATIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFA7630)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleAnimationConfig_TypeDefinitionIndex = 15520;
