...
#define RPG_GAMECORE_BASECHIMERADUELSAVEENTITYSELECTIONCONFIG_METHOD_2_C486126AFC9A2677_OFFSET UNITYSDK_OFFSET(0x1A3DF650)
#define RPG_GAMECORE_BASECHIMERADUELSAVEENTITYSELECTIONCONFIG_METHOD_2_F76E5798A1C5AD31_OFFSET UNITYSDK_OFFSET(0x1A3DF7E0)
#define RPG_GAMECORE_BASECHIMERADUELSAVEENTITYSELECTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3DF840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BaseChimeraDuelSaveEntitySelectionConfig_TypeDefinitionIndex = 15289;
