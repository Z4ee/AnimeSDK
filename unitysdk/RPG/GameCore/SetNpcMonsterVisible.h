...
#define RPG_GAMECORE_SETNPCMONSTERVISIBLE_METHOD_3_9A46FC4D7D2FF498_OFFSET UNITYSDK_OFFSET(0x176DA2E0)
#define RPG_GAMECORE_SETNPCMONSTERVISIBLE_METHOD_3_EF943BE4BEFF18F1_OFFSET UNITYSDK_OFFSET(0x176DA360)
#define RPG_GAMECORE_SETNPCMONSTERVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x176DA330)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetNpcMonsterVisible_TypeDefinitionIndex = 20252;
