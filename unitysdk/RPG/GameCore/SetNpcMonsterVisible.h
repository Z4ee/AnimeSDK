...
#define RPG_GAMECORE_SETNPCMONSTERVISIBLE_METHOD_3_77E36B115686454A_OFFSET UNITYSDK_OFFSET(0x1E089F50)
#define RPG_GAMECORE_SETNPCMONSTERVISIBLE_METHOD_3_EF943BE4BEFF18F1_OFFSET UNITYSDK_OFFSET(0x1E089F90)
#define RPG_GAMECORE_SETNPCMONSTERVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E089F80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetNpcMonsterVisible_TypeDefinitionIndex = 21822;
