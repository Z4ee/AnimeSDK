...
#define RPG_GAMECORE_SETNPCMONSTERVISIBLE_METHOD_3_9A46FC4D7D2FF498_OFFSET UNITYSDK_OFFSET(0x18E3D820)
#define RPG_GAMECORE_SETNPCMONSTERVISIBLE_METHOD_3_EF943BE4BEFF18F1_OFFSET UNITYSDK_OFFSET(0x18E3D8A0)
#define RPG_GAMECORE_SETNPCMONSTERVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E3D870)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetNpcMonsterVisible_TypeDefinitionIndex = 20934;
