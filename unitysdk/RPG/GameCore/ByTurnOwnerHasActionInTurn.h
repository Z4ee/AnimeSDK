...
#define RPG_GAMECORE_BYTURNOWNERHASACTIONINTURN_METHOD_4_2440CBBC74B1629E_OFFSET UNITYSDK_OFFSET(0x187637D0)
#define RPG_GAMECORE_BYTURNOWNERHASACTIONINTURN_METHOD_4_8F70003B96B7B194_OFFSET UNITYSDK_OFFSET(0x18763700)
#define RPG_GAMECORE_BYTURNOWNERHASACTIONINTURN__CTOR_OFFSET UNITYSDK_OFFSET(0x18763780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByTurnOwnerHasActionInTurn_TypeDefinitionIndex = 22452;
