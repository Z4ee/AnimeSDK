...
#define RPG_GAMECORE_LEVELGROUPRANDOMINITINFO_METHOD_2_3478711D32A4475C_OFFSET UNITYSDK_OFFSET(0x1C1181B0)
#define RPG_GAMECORE_LEVELGROUPRANDOMINITINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1C118CF0)
