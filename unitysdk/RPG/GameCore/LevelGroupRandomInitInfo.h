...
#define RPG_GAMECORE_LEVELGROUPRANDOMINITINFO_METHOD_2_C4B4B5C01EA509A8_OFFSET UNITYSDK_OFFSET(0x173396D0)
#define RPG_GAMECORE_LEVELGROUPRANDOMINITINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1733A200)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelGroupRandomInitInfo_TypeDefinitionIndex = 15911;
