...
#define RPG_GAMECORE_ROGUEDLC1DOT3ADVENTUREROOMPREPARE_METHOD_3_BBBA63D8360AFC53_OFFSET UNITYSDK_OFFSET(0x18CFCE00)
#define RPG_GAMECORE_ROGUEDLC1DOT3ADVENTUREROOMPREPARE_METHOD_3_F2249011E8899AFF_OFFSET UNITYSDK_OFFSET(0x18CFCCF0)
#define RPG_GAMECORE_ROGUEDLC1DOT3ADVENTUREROOMPREPARE__CTOR_OFFSET UNITYSDK_OFFSET(0x18CFCDD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueDLC1Dot3AdventureRoomPrepare_TypeDefinitionIndex = 21153;
