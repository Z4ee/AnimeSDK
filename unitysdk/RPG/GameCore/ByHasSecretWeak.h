...
#define RPG_GAMECORE_BYHASSECRETWEAK_METHOD_4_589660E036E34D29_OFFSET UNITYSDK_OFFSET(0x17024860)
#define RPG_GAMECORE_BYHASSECRETWEAK_METHOD_4_BA34A453944E37B6_OFFSET UNITYSDK_OFFSET(0x17024740)
#define RPG_GAMECORE_BYHASSECRETWEAK__CTOR_OFFSET UNITYSDK_OFFSET(0x170247E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByHasSecretWeak_TypeDefinitionIndex = 21235;
