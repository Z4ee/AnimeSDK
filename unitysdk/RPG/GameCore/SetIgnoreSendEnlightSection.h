...
#define RPG_GAMECORE_SETIGNORESENDENLIGHTSECTION_METHOD_3_5AA69F2A9B692E1E_OFFSET UNITYSDK_OFFSET(0x1C5FCD90)
#define RPG_GAMECORE_SETIGNORESENDENLIGHTSECTION_METHOD_3_80D52BC14506C6DD_OFFSET UNITYSDK_OFFSET(0x1C5FCD50)
#define RPG_GAMECORE_SETIGNORESENDENLIGHTSECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5FCD80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetIgnoreSendEnlightSection_TypeDefinitionIndex = 21120;
