...
#define RPG_GAMECORE_SETIGNORESENDENLIGHTSECTION_METHOD_3_22B1EB703954E9EF_OFFSET UNITYSDK_OFFSET(0x19C51D60)
#define RPG_GAMECORE_SETIGNORESENDENLIGHTSECTION_METHOD_3_5AA69F2A9B692E1E_OFFSET UNITYSDK_OFFSET(0x19C51DE0)
#define RPG_GAMECORE_SETIGNORESENDENLIGHTSECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19C51DB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetIgnoreSendEnlightSection_TypeDefinitionIndex = 20705;
