...
#define RPG_GAMECORE_CLEARALLEFFECT_METHOD_3_80BDFA9A9A954E86_OFFSET UNITYSDK_OFFSET(0x18810C90)
#define RPG_GAMECORE_CLEARALLEFFECT_METHOD_3_F3A37D4E791A27F2_OFFSET UNITYSDK_OFFSET(0x18810DA0)
#define RPG_GAMECORE_CLEARALLEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x18810D70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClearAllEffect_TypeDefinitionIndex = 19211;
