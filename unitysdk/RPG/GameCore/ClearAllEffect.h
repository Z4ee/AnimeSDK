...
#define RPG_GAMECORE_CLEARALLEFFECT_METHOD_3_F3A37D4E791A27F2_OFFSET UNITYSDK_OFFSET(0x1CFD9C50)
#define RPG_GAMECORE_CLEARALLEFFECT_METHOD_3_FE2734C91248796F_OFFSET UNITYSDK_OFFSET(0x1CFD9B80)
#define RPG_GAMECORE_CLEARALLEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFD9C40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClearAllEffect_TypeDefinitionIndex = 20035;
