...
#define RPG_GAMECORE_VOLUMECONFIGV2_METHOD_2_F1B15B0E5018F52C_OFFSET UNITYSDK_OFFSET(0x19E4FF70)
#define RPG_GAMECORE_VOLUMECONFIGV2__CTOR_OFFSET UNITYSDK_OFFSET(0x19E500F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VolumeConfigV2_TypeDefinitionIndex = 18164;
