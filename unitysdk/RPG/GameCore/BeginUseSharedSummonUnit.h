...
#define RPG_GAMECORE_BEGINUSESHAREDSUMMONUNIT_METHOD_3_36C7B72A2A17E0C2_OFFSET UNITYSDK_OFFSET(0x16FE38D0)
#define RPG_GAMECORE_BEGINUSESHAREDSUMMONUNIT_METHOD_3_CDE528ACF69DF4EB_OFFSET UNITYSDK_OFFSET(0x16FE3850)
#define RPG_GAMECORE_BEGINUSESHAREDSUMMONUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0x16FE38A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BeginUseSharedSummonUnit_TypeDefinitionIndex = 19463;
