...
#define RPG_GAMECORE_BEGINUSESHAREDSUMMONUNIT_METHOD_3_26E28F7A864444B9_OFFSET UNITYSDK_OFFSET(0x1A3FA7C0)
#define RPG_GAMECORE_BEGINUSESHAREDSUMMONUNIT_METHOD_3_36C7B72A2A17E0C2_OFFSET UNITYSDK_OFFSET(0x1A3FA800)
#define RPG_GAMECORE_BEGINUSESHAREDSUMMONUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3FA7F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BeginUseSharedSummonUnit_TypeDefinitionIndex = 20367;
