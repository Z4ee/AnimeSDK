...
#define RPG_GAMECORE_SETACTIONDELAY_METHOD_3_BA8E488434F63FEF_OFFSET UNITYSDK_OFFSET(0x1C2D0230)
#define RPG_GAMECORE_SETACTIONDELAY_METHOD_3_C4A45D1103E83D32_OFFSET UNITYSDK_OFFSET(0x1C2D00F0)
#define RPG_GAMECORE_SETACTIONDELAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2D01A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetActionDelay_TypeDefinitionIndex = 21883;
