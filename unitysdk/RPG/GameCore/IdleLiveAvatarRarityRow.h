...
#define RPG_GAMECORE_IDLELIVEAVATARRARITYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19840140)
#define RPG_GAMECORE_IDLELIVEAVATARRARITYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x198402C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int IdleLiveAvatarRarityRow_TypeDefinitionIndex = 11210;
