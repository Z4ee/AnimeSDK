...
#define RPG_GAMECORE_OVERRIDESELECTDARKTEAMENTITYCAMERA_METHOD_3_56EDA74D080BBD92_OFFSET UNITYSDK_OFFSET(0x18BCD5E0)
#define RPG_GAMECORE_OVERRIDESELECTDARKTEAMENTITYCAMERA_METHOD_3_BC02F2737E0F7991_OFFSET UNITYSDK_OFFSET(0x18BCD660)
#define RPG_GAMECORE_OVERRIDESELECTDARKTEAMENTITYCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x18BCD630)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OverrideSelectDarkTeamEntityCamera_TypeDefinitionIndex = 21665;
