...
#define RPG_GAMECORE_OVERRIDESELECTDARKTEAMENTITYCAMERA_METHOD_3_B112B8352BB4547D_OFFSET UNITYSDK_OFFSET(0x1D40DF00)
#define RPG_GAMECORE_OVERRIDESELECTDARKTEAMENTITYCAMERA_METHOD_3_BC02F2737E0F7991_OFFSET UNITYSDK_OFFSET(0x1D40DF50)
#define RPG_GAMECORE_OVERRIDESELECTDARKTEAMENTITYCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x1D40DF40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OverrideSelectDarkTeamEntityCamera_TypeDefinitionIndex = 22505;
