...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONAROOMCARDKONGCONFIG_METHOD_3_71271131FEDE3372_OFFSET UNITYSDK_OFFSET(0x18D3DE00)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONAROOMCARDKONGCONFIG_METHOD_3_DF5D5F700EC680FB_OFFSET UNITYSDK_OFFSET(0x18D3DD30)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONAROOMCARDKONGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D3DDB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnPersonaRoomCardKongConfig_TypeDefinitionIndex = 16920;
