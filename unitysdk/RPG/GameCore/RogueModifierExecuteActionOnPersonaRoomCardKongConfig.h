...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONAROOMCARDKONGCONFIG_METHOD_3_71271131FEDE3372_OFFSET UNITYSDK_OFFSET(0x1CFC0A90)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONAROOMCARDKONGCONFIG_METHOD_3_8BA99A886ECDBD96_OFFSET UNITYSDK_OFFSET(0x1CFC0A40)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONAROOMCARDKONGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFC0A80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnPersonaRoomCardKongConfig_TypeDefinitionIndex = 17097;
