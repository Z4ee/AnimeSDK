...
#define RPG_GAMECORE_HEARTDIALSCRIPTCONDITIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B673B20)
#define RPG_GAMECORE_HEARTDIALSCRIPTCONDITIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B673D20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HeartDialScriptConditionRow_TypeDefinitionIndex = 13226;

	class HeartDialScriptConditionRow : public ::System::Object
	{
	public:
		::System::UInt32 ControlConditionID; // 0x10
		::System::UInt32 UnLockConditionID; // 0x14
		::System::UInt32 LockConditionID; // 0x18
		::System::UInt32 FullConditionID; // 0x1C
		::System::UInt32 MissingConditionID; // 0x20
