...
#define RPG_GAMECORE_SETDYNAMICVALUEBYSTATISTICCUSTOMVALUE_METHOD_3_6B411F73422D8B9A_OFFSET UNITYSDK_OFFSET(0x1C5F1AB0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSTATISTICCUSTOMVALUE_METHOD_3_E62E6E414349CE67_OFFSET UNITYSDK_OFFSET(0x1C5F1A70)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSTATISTICCUSTOMVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5F1AA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByStatisticCustomValue_TypeDefinitionIndex = 20966;
