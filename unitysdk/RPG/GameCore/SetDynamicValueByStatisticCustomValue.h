...
#define RPG_GAMECORE_SETDYNAMICVALUEBYSTATISTICCUSTOMVALUE_METHOD_3_5D97B95D15DFC675_OFFSET UNITYSDK_OFFSET(0x18E287C0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSTATISTICCUSTOMVALUE_METHOD_3_6B411F73422D8B9A_OFFSET UNITYSDK_OFFSET(0x18E28830)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSTATISTICCUSTOMVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E28800)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByStatisticCustomValue_TypeDefinitionIndex = 20618;
