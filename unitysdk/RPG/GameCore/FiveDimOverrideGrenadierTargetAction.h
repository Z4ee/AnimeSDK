...
#define RPG_GAMECORE_FIVEDIMOVERRIDEGRENADIERTARGETACTION_METHOD_3_1B4339F5E5C4FA75_OFFSET UNITYSDK_OFFSET(0x1D86FB40)
#define RPG_GAMECORE_FIVEDIMOVERRIDEGRENADIERTARGETACTION_METHOD_3_B3C7826DD5486460_OFFSET UNITYSDK_OFFSET(0x1D86FA90)
#define RPG_GAMECORE_FIVEDIMOVERRIDEGRENADIERTARGETACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D86FB30)
