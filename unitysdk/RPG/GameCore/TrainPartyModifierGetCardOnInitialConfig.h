...
#define RPG_GAMECORE_TRAINPARTYMODIFIERGETCARDONINITIALCONFIG_METHOD_3_9660FE7E09C4F813_OFFSET UNITYSDK_OFFSET(0x1D5DEE00)
#define RPG_GAMECORE_TRAINPARTYMODIFIERGETCARDONINITIALCONFIG_METHOD_3_D9E288E0D371B057_OFFSET UNITYSDK_OFFSET(0x1D5DEC30)
#define RPG_GAMECORE_TRAINPARTYMODIFIERGETCARDONINITIALCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5DEC20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyModifierGetCardOnInitialConfig_TypeDefinitionIndex = 17891;
