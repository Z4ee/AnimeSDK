...
#define RPG_GAMECORE_RENDERTESTCAMERACONFIG_METHOD_2_3E00AFC07B0A1281_OFFSET UNITYSDK_OFFSET(0x1759A750)
#define RPG_GAMECORE_RENDERTESTCAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1759AC40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RenderTestCameraConfig_TypeDefinitionIndex = 22448;
