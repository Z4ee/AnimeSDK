...
#define RPG_GAMECORE_RENDERTESTCAMERACONFIG_METHOD_2_3E00AFC07B0A1281_OFFSET UNITYSDK_OFFSET(0x1DB8F710)
#define RPG_GAMECORE_RENDERTESTCAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB8FC00)
