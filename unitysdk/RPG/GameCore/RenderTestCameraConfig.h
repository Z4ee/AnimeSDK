...
#define RPG_GAMECORE_RENDERTESTCAMERACONFIG_METHOD_2_3E00AFC07B0A1281_OFFSET UNITYSDK_OFFSET(0x1D3A0F50)
#define RPG_GAMECORE_RENDERTESTCAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3A1440)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RenderTestCameraConfig_TypeDefinitionIndex = 24121;
