...
#define RPG_GAMECORE_TRAINPARTYMODIFIERCONFIGBASE_METHOD_2_93C723EBE3F25975_OFFSET UNITYSDK_OFFSET(0x190AB670)
#define RPG_GAMECORE_TRAINPARTYMODIFIERCONFIGBASE_METHOD_2_A759DCDDDD025EAC_OFFSET UNITYSDK_OFFSET(0x190ABAF0)
#define RPG_GAMECORE_TRAINPARTYMODIFIERCONFIGBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x190AB420)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyModifierConfigBase_TypeDefinitionIndex = 17195;
