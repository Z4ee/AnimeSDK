...
#define RPG_GAMECORE_TRAINPARTYMODIFIERCONFIGBASE_METHOD_2_93C723EBE3F25975_OFFSET UNITYSDK_OFFSET(0x1C1612B0)
#define RPG_GAMECORE_TRAINPARTYMODIFIERCONFIGBASE_METHOD_2_A759DCDDDD025EAC_OFFSET UNITYSDK_OFFSET(0x1C161830)
#define RPG_GAMECORE_TRAINPARTYMODIFIERCONFIGBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C161060)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyModifierConfigBase_TypeDefinitionIndex = 17365;
