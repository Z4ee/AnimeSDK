...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDMONSTERDROPBYPROBABILITYCONFIG_METHOD_3_A5299F321BFCE20F_OFFSET UNITYSDK_OFFSET(0x189B0D60)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDMONSTERDROPBYPROBABILITYCONFIG_METHOD_3_CF9E589FD71593E6_OFFSET UNITYSDK_OFFSET(0x189B0E30)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDMONSTERDROPBYPROBABILITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189B0DE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierAddMonsterDropByProbabilityConfig_TypeDefinitionIndex = 18418;
