...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDMONSTERDROPBYPROBABILITYCONFIG_METHOD_3_692888DAA839BD8A_OFFSET UNITYSDK_OFFSET(0x1C5CFEB0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDMONSTERDROPBYPROBABILITYCONFIG_METHOD_3_CF9E589FD71593E6_OFFSET UNITYSDK_OFFSET(0x1C5CFF00)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDMONSTERDROPBYPROBABILITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5CFEF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierAddMonsterDropByProbabilityConfig_TypeDefinitionIndex = 18635;
