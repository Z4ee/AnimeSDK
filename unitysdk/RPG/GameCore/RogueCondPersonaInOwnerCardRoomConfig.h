...
#define RPG_GAMECORE_ROGUECONDPERSONAINOWNERCARDROOMCONFIG_METHOD_6_89E7C538B4DD537B_OFFSET UNITYSDK_OFFSET(0x1D918B40)
#define RPG_GAMECORE_ROGUECONDPERSONAINOWNERCARDROOMCONFIG_METHOD_6_A3248E8F23B887FF_OFFSET UNITYSDK_OFFSET(0x1D918B90)
#define RPG_GAMECORE_ROGUECONDPERSONAINOWNERCARDROOMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D918B80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueCondPersonaInOwnerCardRoomConfig_TypeDefinitionIndex = 19582;
