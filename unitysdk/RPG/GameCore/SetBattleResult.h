...
#define RPG_GAMECORE_SETBATTLERESULT_METHOD_3_048D361267F9A0D5_OFFSET UNITYSDK_OFFSET(0x18E0C7B0)
#define RPG_GAMECORE_SETBATTLERESULT_METHOD_3_0ADF68180578B1E4_OFFSET UNITYSDK_OFFSET(0x18E0C730)
#define RPG_GAMECORE_SETBATTLERESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x18E0C780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetBattleResult_TypeDefinitionIndex = 22374;
