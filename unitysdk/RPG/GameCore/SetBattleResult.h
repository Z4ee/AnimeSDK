...
#define RPG_GAMECORE_SETBATTLERESULT_METHOD_3_048D361267F9A0D5_OFFSET UNITYSDK_OFFSET(0x19C2B620)
#define RPG_GAMECORE_SETBATTLERESULT_METHOD_3_0ADF68180578B1E4_OFFSET UNITYSDK_OFFSET(0x19C2B5A0)
#define RPG_GAMECORE_SETBATTLERESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x19C2B5F0)
