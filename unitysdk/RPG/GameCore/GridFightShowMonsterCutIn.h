...
#define RPG_GAMECORE_GRIDFIGHTSHOWMONSTERCUTIN_METHOD_3_85DE1BD852656DF1_OFFSET UNITYSDK_OFFSET(0x1D077C40)
#define RPG_GAMECORE_GRIDFIGHTSHOWMONSTERCUTIN_METHOD_3_EF721DC8130DADB4_OFFSET UNITYSDK_OFFSET(0x1D077B70)
#define RPG_GAMECORE_GRIDFIGHTSHOWMONSTERCUTIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1D077C30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightShowMonsterCutIn_TypeDefinitionIndex = 22401;
