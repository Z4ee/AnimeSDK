...
#define RPG_GAMECORE_ADDWEAKNESS_METHOD_3_74DE26AF0687A086_OFFSET UNITYSDK_OFFSET(0x18645060)
#define RPG_GAMECORE_ADDWEAKNESS_METHOD_3_791E3E0837340BB7_OFFSET UNITYSDK_OFFSET(0x186450E0)
#define RPG_GAMECORE_ADDWEAKNESS__CTOR_OFFSET UNITYSDK_OFFSET(0x186450B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddWeakness_TypeDefinitionIndex = 22010;
