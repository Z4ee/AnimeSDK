...
#define RPG_GAMECORE_TRFCAMERACOMPONENTCONFIG_METHOD_3_2207D189A8976569_OFFSET UNITYSDK_OFFSET(0x1B4472A0)
#define RPG_GAMECORE_TRFCAMERACOMPONENTCONFIG_METHOD_3_5DC2B11252038013_OFFSET UNITYSDK_OFFSET(0x1B447300)
#define RPG_GAMECORE_TRFCAMERACOMPONENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4472F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TRFCameraComponentConfig_TypeDefinitionIndex = 18161;
