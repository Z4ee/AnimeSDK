...
#define RPG_GAMECORE_TRFCAMERACOMPONENTCONFIG_METHOD_3_5DC2B11252038013_OFFSET UNITYSDK_OFFSET(0x18ECD090)
#define RPG_GAMECORE_TRFCAMERACOMPONENTCONFIG_METHOD_3_E412699840608E0B_OFFSET UNITYSDK_OFFSET(0x18ECD000)
#define RPG_GAMECORE_TRFCAMERACOMPONENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18ECD070)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TRFCameraComponentConfig_TypeDefinitionIndex = 17950;
