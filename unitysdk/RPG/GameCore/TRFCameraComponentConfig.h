...
#define RPG_GAMECORE_TRFCAMERACOMPONENTCONFIG_METHOD_3_5DC2B11252038013_OFFSET UNITYSDK_OFFSET(0x177A6AD0)
#define RPG_GAMECORE_TRFCAMERACOMPONENTCONFIG_METHOD_3_E412699840608E0B_OFFSET UNITYSDK_OFFSET(0x177A6A40)
#define RPG_GAMECORE_TRFCAMERACOMPONENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x177A6AB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TRFCameraComponentConfig_TypeDefinitionIndex = 17342;
