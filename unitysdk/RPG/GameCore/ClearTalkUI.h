...
#define RPG_GAMECORE_CLEARTALKUI_METHOD_3_37FB3E4B825A8454_OFFSET UNITYSDK_OFFSET(0x170B3560)
#define RPG_GAMECORE_CLEARTALKUI_METHOD_3_4701A08B414C7AE5_OFFSET UNITYSDK_OFFSET(0x170B34E0)
#define RPG_GAMECORE_CLEARTALKUI__CTOR_OFFSET UNITYSDK_OFFSET(0x170B3530)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClearTalkUI_TypeDefinitionIndex = 20080;
