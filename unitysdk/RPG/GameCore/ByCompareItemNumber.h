...
#define RPG_GAMECORE_BYCOMPAREITEMNUMBER_METHOD_4_63CC97329D3E7286_OFFSET UNITYSDK_OFFSET(0x18731390)
#define RPG_GAMECORE_BYCOMPAREITEMNUMBER_METHOD_4_BA9AF0E80BB03F6B_OFFSET UNITYSDK_OFFSET(0x187312B0)
#define RPG_GAMECORE_BYCOMPAREITEMNUMBER__CTOR_OFFSET UNITYSDK_OFFSET(0x18731330)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareItemNumber_TypeDefinitionIndex = 19775;
