...
#define RPG_GAMECORE_BYCOMPAREITEMNUMBER_METHOD_4_0B46BEB5000EBD87_OFFSET UNITYSDK_OFFSET(0x1C326890)
#define RPG_GAMECORE_BYCOMPAREITEMNUMBER_METHOD_4_47F94D18D4AC2FBA_OFFSET UNITYSDK_OFFSET(0x1C326B30)
#define RPG_GAMECORE_BYCOMPAREITEMNUMBER_METHOD_4_63CC97329D3E7286_OFFSET UNITYSDK_OFFSET(0x1C3268E0)
#define RPG_GAMECORE_BYCOMPAREITEMNUMBER_METHOD_4_9C72A2D14CF8589D_OFFSET UNITYSDK_OFFSET(0x1C326B70)
#define RPG_GAMECORE_BYCOMPAREITEMNUMBER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3268D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareItemNumber_TypeDefinitionIndex = 20557;
