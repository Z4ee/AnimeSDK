...
#define RPG_GAMECORE_STOPMUNICIPALCHAT_METHOD_3_207546AA1F5A5E8A_OFFSET UNITYSDK_OFFSET(0x1777D9A0)
#define RPG_GAMECORE_STOPMUNICIPALCHAT_METHOD_3_C62659B0FE9E0A7C_OFFSET UNITYSDK_OFFSET(0x1777DA20)
#define RPG_GAMECORE_STOPMUNICIPALCHAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1777D9F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StopMunicipalChat_TypeDefinitionIndex = 19090;
