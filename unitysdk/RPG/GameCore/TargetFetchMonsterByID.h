...
#define RPG_GAMECORE_TARGETFETCHMONSTERBYID_METHOD_4_5770113543797A6B_OFFSET UNITYSDK_OFFSET(0x18EDE310)
#define RPG_GAMECORE_TARGETFETCHMONSTERBYID_METHOD_4_A160624307D82978_OFFSET UNITYSDK_OFFSET(0x18EE4D90)
#define RPG_GAMECORE_TARGETFETCHMONSTERBYID__CTOR_OFFSET UNITYSDK_OFFSET(0x18EDE2C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchMonsterByID_TypeDefinitionIndex = 22953;
