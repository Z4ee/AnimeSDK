...
#define RPG_GAMECORE_REMOVEVIRTUALLINEUPBINDPLANE_METHOD_3_B5E24AB9A68F237C_OFFSET UNITYSDK_OFFSET(0x19ACAE20)
#define RPG_GAMECORE_REMOVEVIRTUALLINEUPBINDPLANE_METHOD_3_BEE32108B196A73C_OFFSET UNITYSDK_OFFSET(0x19ACAD90)
#define RPG_GAMECORE_REMOVEVIRTUALLINEUPBINDPLANE__CTOR_OFFSET UNITYSDK_OFFSET(0x19ACADF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveVirtualLineupBindPlane_TypeDefinitionIndex = 20395;
