...
#define RPG_GAMECORE_REMOVEVIRTUALLINEUPBINDPLANE_METHOD_3_47CCA36528EA6480_OFFSET UNITYSDK_OFFSET(0x1D017C90)
#define RPG_GAMECORE_REMOVEVIRTUALLINEUPBINDPLANE_METHOD_3_B5E24AB9A68F237C_OFFSET UNITYSDK_OFFSET(0x1D017CE0)
#define RPG_GAMECORE_REMOVEVIRTUALLINEUPBINDPLANE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D017CD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveVirtualLineupBindPlane_TypeDefinitionIndex = 20810;
