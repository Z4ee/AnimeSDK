...
#define RPG_GAMECORE_ST_BYINATTACKANGLE_METHOD_4_9D45FD9508FBFDAC_OFFSET UNITYSDK_OFFSET(0x18DEE2D0)
#define RPG_GAMECORE_ST_BYINATTACKANGLE_METHOD_4_FEE07A009578FB66_OFFSET UNITYSDK_OFFSET(0x18DEE3A0)
#define RPG_GAMECORE_ST_BYINATTACKANGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x18DEE350)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_ByInAttackAngle_TypeDefinitionIndex = 18999;
