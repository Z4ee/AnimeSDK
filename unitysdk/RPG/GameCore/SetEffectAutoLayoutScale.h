...
#define RPG_GAMECORE_SETEFFECTAUTOLAYOUTSCALE_METHOD_3_04C116B25ECFCA20_OFFSET UNITYSDK_OFFSET(0x18E2D2B0)
#define RPG_GAMECORE_SETEFFECTAUTOLAYOUTSCALE_METHOD_3_692607EF88752D96_OFFSET UNITYSDK_OFFSET(0x18E2D220)
#define RPG_GAMECORE_SETEFFECTAUTOLAYOUTSCALE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E2D280)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetEffectAutoLayoutScale_TypeDefinitionIndex = 22068;
