...
#define RPG_GAMECORE_INTERRUPTSKILLEXECUTION_METHOD_3_33E52BE45BB5B52B_OFFSET UNITYSDK_OFFSET(0x172BE260)
#define RPG_GAMECORE_INTERRUPTSKILLEXECUTION_METHOD_3_8B7AD1C35D18250D_OFFSET UNITYSDK_OFFSET(0x172BE1E0)
#define RPG_GAMECORE_INTERRUPTSKILLEXECUTION__CTOR_OFFSET UNITYSDK_OFFSET(0x172BE230)

namespace RPG::GameCore
{
	inline static constexpr unsigned int InterruptSkillExecution_TypeDefinitionIndex = 21359;
