...
#define RPG_GAMECORE_ROGUEADVENTUREROOMROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x175DC850)
#define RPG_GAMECORE_ROGUEADVENTUREROOMROW__CTOR_OFFSET UNITYSDK_OFFSET(0x175DC9C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueAdventureRoomRow_TypeDefinitionIndex = 13439;
