...
#define RPG_GAMECORE_ADVENTURENPCMONSTERDESTROY_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x15411C00)
#define RPG_GAMECORE_ADVENTURENPCMONSTERDESTROY_GETMONSTER_OFFSET UNITYSDK_OFFSET(0x15411CA0)
#define RPG_GAMECORE_ADVENTURENPCMONSTERDESTROY_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x15411C50)
#define RPG_GAMECORE_ADVENTURENPCMONSTERDESTROY__CTOR_OFFSET UNITYSDK_OFFSET(0x15411BF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureNpcMonsterDestroy_TypeDefinitionIndex = 54082;
