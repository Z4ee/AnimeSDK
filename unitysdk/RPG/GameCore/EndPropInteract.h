...
#define RPG_GAMECORE_ENDPROPINTERACT_METHOD_3_2276A1DBDB0C37D5_OFFSET UNITYSDK_OFFSET(0x196E6A00)
#define RPG_GAMECORE_ENDPROPINTERACT_METHOD_3_BB4711C081826949_OFFSET UNITYSDK_OFFSET(0x196E6B10)
#define RPG_GAMECORE_ENDPROPINTERACT__CTOR_OFFSET UNITYSDK_OFFSET(0x196E6AE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EndPropInteract_TypeDefinitionIndex = 19249;
