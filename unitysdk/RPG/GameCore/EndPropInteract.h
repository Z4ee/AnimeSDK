...
#define RPG_GAMECORE_ENDPROPINTERACT_METHOD_3_2687DC00D5DCBC0C_OFFSET UNITYSDK_OFFSET(0x1D064E80)
#define RPG_GAMECORE_ENDPROPINTERACT_METHOD_3_BB4711C081826949_OFFSET UNITYSDK_OFFSET(0x1D064F50)
#define RPG_GAMECORE_ENDPROPINTERACT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D064F40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EndPropInteract_TypeDefinitionIndex = 20151;
