...
#define RPG_GAMECORE_LEVELEVOLVEBUILDREROLL_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1BDFC8C0)
#define RPG_GAMECORE_LEVELEVOLVEBUILDREROLL_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x1BDFC870)
#define RPG_GAMECORE_LEVELEVOLVEBUILDREROLL__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDFC910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelEvolveBuildReRoll_TypeDefinitionIndex = 54285;
