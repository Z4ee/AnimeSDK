...
#define RPG_GAMECORE_ROGUEPROPOPENPAGE_METHOD_3_01C988493D50ECC2_OFFSET UNITYSDK_OFFSET(0x1E547130)
#define RPG_GAMECORE_ROGUEPROPOPENPAGE_METHOD_3_284088757170DEE7_OFFSET UNITYSDK_OFFSET(0x1E547170)
#define RPG_GAMECORE_ROGUEPROPOPENPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E547160)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RoguePropOpenPage_TypeDefinitionIndex = 22041;
