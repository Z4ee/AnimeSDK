...
#define RPG_GAMECORE_ROGUEPROPOPENPAGE_METHOD_3_6A9F37C9C37AD925_OFFSET UNITYSDK_OFFSET(0x17658240)
#define RPG_GAMECORE_ROGUEPROPOPENPAGE_METHOD_3_DFEC8590853F45B0_OFFSET UNITYSDK_OFFSET(0x176581C0)
#define RPG_GAMECORE_ROGUEPROPOPENPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x17658210)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RoguePropOpenPage_TypeDefinitionIndex = 20485;
