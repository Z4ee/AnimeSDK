...
#define RPG_GAMECORE_STACKREDIRECTSKILLTARGET_METHOD_3_80FE99BD2E991AD4_OFFSET UNITYSDK_OFFSET(0x1B0A6040)
#define RPG_GAMECORE_STACKREDIRECTSKILLTARGET_METHOD_3_AD0A4EB6DC17E756_OFFSET UNITYSDK_OFFSET(0x1B0A61A0)
#define RPG_GAMECORE_STACKREDIRECTSKILLTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0A6100)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StackRedirectSkillTarget_TypeDefinitionIndex = 22778;
