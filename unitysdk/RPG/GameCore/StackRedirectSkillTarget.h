...
#define RPG_GAMECORE_STACKREDIRECTSKILLTARGET_METHOD_3_AD0A4EB6DC17E756_OFFSET UNITYSDK_OFFSET(0x18E87270)
#define RPG_GAMECORE_STACKREDIRECTSKILLTARGET_METHOD_3_FEE7A92F35A3BCDD_OFFSET UNITYSDK_OFFSET(0x18E870F0)
#define RPG_GAMECORE_STACKREDIRECTSKILLTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x18E871C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StackRedirectSkillTarget_TypeDefinitionIndex = 22607;
