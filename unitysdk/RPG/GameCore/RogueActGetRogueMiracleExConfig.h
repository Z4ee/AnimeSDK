...
#define RPG_GAMECORE_ROGUEACTGETROGUEMIRACLEEXCONFIG_METHOD_6_7D6DA958BDEEABD4_OFFSET UNITYSDK_OFFSET(0x19AE8670)
#define RPG_GAMECORE_ROGUEACTGETROGUEMIRACLEEXCONFIG_METHOD_6_B8F7251FCA69EFB9_OFFSET UNITYSDK_OFFSET(0x19AE8450)
#define RPG_GAMECORE_ROGUEACTGETROGUEMIRACLEEXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AE8590)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActGetRogueMiracleExConfig_TypeDefinitionIndex = 18572;
