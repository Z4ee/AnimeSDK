...
#define RPG_GAMECORE_MODIFIERBEHAVIORVISUAL_GET_HASLOOPANIM_OFFSET UNITYSDK_OFFSET(0x1D2AB390)
#define RPG_GAMECORE_MODIFIERBEHAVIORVISUAL_GET_HASOCCURANIM_OFFSET UNITYSDK_OFFSET(0x1D2AB3B0)
#define RPG_GAMECORE_MODIFIERBEHAVIORVISUAL_GET_HASRECOVERANIM_OFFSET UNITYSDK_OFFSET(0x1D2AB3D0)
#define RPG_GAMECORE_MODIFIERBEHAVIORVISUAL_METHOD_2_D45237155D85F493_OFFSET UNITYSDK_OFFSET(0x1D2AAAE0)
#define RPG_GAMECORE_MODIFIERBEHAVIORVISUAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2AB360)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifierBehaviorVisual_TypeDefinitionIndex = 17989;
