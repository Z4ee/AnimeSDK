...
#define RPG_GAMECORE_MODIFIERBEHAVIORVISUAL_GET_HASLOOPANIM_OFFSET UNITYSDK_OFFSET(0x1994BA70)
#define RPG_GAMECORE_MODIFIERBEHAVIORVISUAL_GET_HASOCCURANIM_OFFSET UNITYSDK_OFFSET(0x1994BA90)
#define RPG_GAMECORE_MODIFIERBEHAVIORVISUAL_GET_HASRECOVERANIM_OFFSET UNITYSDK_OFFSET(0x1994BAB0)
#define RPG_GAMECORE_MODIFIERBEHAVIORVISUAL_METHOD_2_D45237155D85F493_OFFSET UNITYSDK_OFFSET(0x1994B1C0)
#define RPG_GAMECORE_MODIFIERBEHAVIORVISUAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1994BA40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifierBehaviorVisual_TypeDefinitionIndex = 17299;
