...
#define RPG_GAMECORE_MAZEPUZZLESWITCHHANDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x173CA880)
#define RPG_GAMECORE_MAZEPUZZLESWITCHHANDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x173CAD00)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::Class_1_A88C3AAF0DD46F4C_9*>* ControllerListID; // 0x18
		::System::String* ColliderPath; // 0x20
		::Il2CppArray<::System::UInt32>* SwitchHandID; // 0x28
		::Il2CppArray<::System::UInt32>* ChestID; // 0x30
		::Il2CppArray<::Class_1_A88C3AAF0DD46F4C_9*>* CoinPropID; // 0x38
		::System::UInt32 PlaneID; // 0x40
