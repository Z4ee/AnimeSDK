...
#define RPG_GAMECORE_MAZEPUZZLESWITCHHANDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1AF527E0)
#define RPG_GAMECORE_MAZEPUZZLESWITCHHANDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF52C40)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::Class_1_A88C3AAF0DD46F4C_12*>* CoinPropID; // 0x20
