...
#define RPG_GAMECORE_FATERINCASEBOARDTRIPLETEAMINFO_METHOD_3_5A9E5DB61CE8A34D_OFFSET UNITYSDK_OFFSET(0x1BA76FE0)
#define RPG_GAMECORE_FATERINCASEBOARDTRIPLETEAMINFO_METHOD_3_FCAAC7225534345A_OFFSET UNITYSDK_OFFSET(0x1BA76350)
#define RPG_GAMECORE_FATERINCASEBOARDTRIPLETEAMINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA76340)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateRinCaseBoardTripleTeamInfo_TypeDefinitionIndex = 15589;
