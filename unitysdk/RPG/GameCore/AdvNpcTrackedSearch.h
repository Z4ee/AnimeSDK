...
#define RPG_GAMECORE_ADVNPCTRACKEDSEARCH_METHOD_3_F5C303B4C58A9890_OFFSET UNITYSDK_OFFSET(0x1942F860)
#define RPG_GAMECORE_ADVNPCTRACKEDSEARCH_METHOD_3_FD007F0F30449849_OFFSET UNITYSDK_OFFSET(0x1942F7E0)
#define RPG_GAMECORE_ADVNPCTRACKEDSEARCH__CTOR_OFFSET UNITYSDK_OFFSET(0x1942F830)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvNpcTrackedSearch_TypeDefinitionIndex = 18869;
