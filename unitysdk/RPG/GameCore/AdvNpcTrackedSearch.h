...
#define RPG_GAMECORE_ADVNPCTRACKEDSEARCH_METHOD_3_832AEB49D8923C53_OFFSET UNITYSDK_OFFSET(0x1BE26AE0)
#define RPG_GAMECORE_ADVNPCTRACKEDSEARCH_METHOD_3_F5C303B4C58A9890_OFFSET UNITYSDK_OFFSET(0x1BE26B20)
#define RPG_GAMECORE_ADVNPCTRACKEDSEARCH__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE26B10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvNpcTrackedSearch_TypeDefinitionIndex = 19219;
