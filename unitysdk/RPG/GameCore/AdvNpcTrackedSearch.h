...
#define RPG_GAMECORE_ADVNPCTRACKEDSEARCH_METHOD_3_F5C303B4C58A9890_OFFSET UNITYSDK_OFFSET(0x1865BE00)
#define RPG_GAMECORE_ADVNPCTRACKEDSEARCH_METHOD_3_FD007F0F30449849_OFFSET UNITYSDK_OFFSET(0x1865BD80)
#define RPG_GAMECORE_ADVNPCTRACKEDSEARCH__CTOR_OFFSET UNITYSDK_OFFSET(0x1865BDD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvNpcTrackedSearch_TypeDefinitionIndex = 18913;
