...
#define RPG_GAMECORE_BYCOMPAREFLOORCUSTOMFLOAT_METHOD_4_2332ED9C7ED0E751_OFFSET UNITYSDK_OFFSET(0x19CE25A0)
#define RPG_GAMECORE_BYCOMPAREFLOORCUSTOMFLOAT_METHOD_4_2CA4D93D0E56D12E_OFFSET UNITYSDK_OFFSET(0x19CE2390)
#define RPG_GAMECORE_BYCOMPAREFLOORCUSTOMFLOAT_METHOD_4_8ED50045A10F8D3B_OFFSET UNITYSDK_OFFSET(0x19CE2340)
#define RPG_GAMECORE_BYCOMPAREFLOORCUSTOMFLOAT_METHOD_4_C6B9BD0056C0141E_OFFSET UNITYSDK_OFFSET(0x19CE25E0)
#define RPG_GAMECORE_BYCOMPAREFLOORCUSTOMFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x19CE2380)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareFloorCustomFloat_TypeDefinitionIndex = 19908;
