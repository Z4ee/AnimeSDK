...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_ATTACKEFFECT_CUTINANIMATION_METHOD_3_00FFE251A8C16448_OFFSET UNITYSDK_OFFSET(0x196B1EB0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_ATTACKEFFECT_CUTINANIMATION_METHOD_3_B25E929237883723_OFFSET UNITYSDK_OFFSET(0x196B88D0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_ATTACKEFFECT_CUTINANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x196B1E60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_AttackEffect_CutinAnimation_TypeDefinitionIndex = 15271;
