...
#define RPG_GAMECORE_BYISMATCHTEAMMATECOUNT_METHOD_4_361C9DF326070109_OFFSET UNITYSDK_OFFSET(0x1CDA8140)
#define RPG_GAMECORE_BYISMATCHTEAMMATECOUNT_METHOD_4_5EE233099D404824_OFFSET UNITYSDK_OFFSET(0x1CDA7F10)
#define RPG_GAMECORE_BYISMATCHTEAMMATECOUNT_METHOD_4_8A2E038ADEDEB1A6_OFFSET UNITYSDK_OFFSET(0x1CDA8180)
#define RPG_GAMECORE_BYISMATCHTEAMMATECOUNT_METHOD_4_D538136C86468979_OFFSET UNITYSDK_OFFSET(0x1CDA7EC0)
#define RPG_GAMECORE_BYISMATCHTEAMMATECOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDA7F00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsMatchTeammateCount_TypeDefinitionIndex = 22775;
