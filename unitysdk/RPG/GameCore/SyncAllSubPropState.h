...
#define RPG_GAMECORE_SYNCALLSUBPROPSTATE_METHOD_3_4FD7A01B25BF1B31_OFFSET UNITYSDK_OFFSET(0x19CE8F60)
#define RPG_GAMECORE_SYNCALLSUBPROPSTATE_METHOD_3_9F04B73A42B39FE1_OFFSET UNITYSDK_OFFSET(0x19CE8FF0)
#define RPG_GAMECORE_SYNCALLSUBPROPSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19CE8FC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SyncAllSubPropState_TypeDefinitionIndex = 20910;
