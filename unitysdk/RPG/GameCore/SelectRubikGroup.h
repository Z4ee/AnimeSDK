...
#define RPG_GAMECORE_SELECTRUBIKGROUP_METHOD_3_11C7A81FDC567CB5_OFFSET UNITYSDK_OFFSET(0x18E01A80)
#define RPG_GAMECORE_SELECTRUBIKGROUP_METHOD_3_1BE59FE3D4E30449_OFFSET UNITYSDK_OFFSET(0x18E01B00)
#define RPG_GAMECORE_SELECTRUBIKGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x18E01AD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SelectRubikGroup_TypeDefinitionIndex = 21011;
