...
#define RPG_GAMECORE_WAITBPEQUAL_METHOD_3_CB4E5B3C0B86BF35_OFFSET UNITYSDK_OFFSET(0x190F9020)
#define RPG_GAMECORE_WAITBPEQUAL_METHOD_3_D6011CA141F08D94_OFFSET UNITYSDK_OFFSET(0x190F8FA0)
#define RPG_GAMECORE_WAITBPEQUAL__CTOR_OFFSET UNITYSDK_OFFSET(0x190F8FF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitBPEqual_TypeDefinitionIndex = 23373;
