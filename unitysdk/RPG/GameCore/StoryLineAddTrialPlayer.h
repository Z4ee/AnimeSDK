...
#define RPG_GAMECORE_STORYLINEADDTRIALPLAYER_METHOD_3_C8DC5D48FCBCE998_OFFSET UNITYSDK_OFFSET(0x19CC2960)
#define RPG_GAMECORE_STORYLINEADDTRIALPLAYER_METHOD_3_CEDA54AF7BF67298_OFFSET UNITYSDK_OFFSET(0x19CC29F0)
#define RPG_GAMECORE_STORYLINEADDTRIALPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x19CC29C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StoryLineAddTrialPlayer_TypeDefinitionIndex = 20452;
