...
#define RPG_GAMECORE_STORYLINEADDTRIALPLAYER_METHOD_3_C8DC5D48FCBCE998_OFFSET UNITYSDK_OFFSET(0x1777FD90)
#define RPG_GAMECORE_STORYLINEADDTRIALPLAYER_METHOD_3_CEDA54AF7BF67298_OFFSET UNITYSDK_OFFSET(0x1777FE20)
#define RPG_GAMECORE_STORYLINEADDTRIALPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1777FDF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StoryLineAddTrialPlayer_TypeDefinitionIndex = 19835;
