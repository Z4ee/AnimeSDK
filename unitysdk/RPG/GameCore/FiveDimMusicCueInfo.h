...
#define RPG_GAMECORE_FIVEDIMMUSICCUEINFO_METHOD_2_5BC62FBD7218263A_OFFSET UNITYSDK_OFFSET(0x1D86E4F0)
#define RPG_GAMECORE_FIVEDIMMUSICCUEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D86E6D0)
