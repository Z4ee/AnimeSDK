...
#define RPG_GAMECORE_WAITROGUESELECTBUFF_METHOD_3_234E84E2AF445F73_OFFSET UNITYSDK_OFFSET(0x19106C30)
#define RPG_GAMECORE_WAITROGUESELECTBUFF_METHOD_3_F866739344894223_OFFSET UNITYSDK_OFFSET(0x19106CC0)
#define RPG_GAMECORE_WAITROGUESELECTBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x19106C90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitRogueSelectBuff_TypeDefinitionIndex = 19441;
