...
#define RPG_GAMECORE_WAITROGUESELECTBUFF_METHOD_3_3BB8608BA10E841F_OFFSET UNITYSDK_OFFSET(0x1D6AAEC0)
#define RPG_GAMECORE_WAITROGUESELECTBUFF_METHOD_3_F866739344894223_OFFSET UNITYSDK_OFFSET(0x1D6AAF10)
#define RPG_GAMECORE_WAITROGUESELECTBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6AAF00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitRogueSelectBuff_TypeDefinitionIndex = 20248;
