...
#define RPG_GAMECORE_SWITCHREFGRAPHDYNAMICFLOAT_METHOD_3_118781D4FFA0469B_OFFSET UNITYSDK_OFFSET(0x1D58FE20)
#define RPG_GAMECORE_SWITCHREFGRAPHDYNAMICFLOAT_METHOD_3_79E9909A2ED46BCC_OFFSET UNITYSDK_OFFSET(0x1D58F5D0)
#define RPG_GAMECORE_SWITCHREFGRAPHDYNAMICFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D58F5C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchRefGraphDynamicFloat_TypeDefinitionIndex = 17324;
