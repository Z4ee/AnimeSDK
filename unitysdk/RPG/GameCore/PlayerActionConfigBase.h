...
#define RPG_GAMECORE_PLAYERACTIONCONFIGBASE_METHOD_4_7542D13DC033961A_OFFSET UNITYSDK_OFFSET(0x18C14330)
#define RPG_GAMECORE_PLAYERACTIONCONFIGBASE_METHOD_4_B285F723C48D871F_OFFSET UNITYSDK_OFFSET(0x18C14170)
#define RPG_GAMECORE_PLAYERACTIONCONFIGBASE__CCTOR_OFFSET UNITYSDK_OFFSET(0x18C14390)
#define RPG_GAMECORE_PLAYERACTIONCONFIGBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x18C14340)
...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Func_2<::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::PlayerActionConfigBase*>*>**)Il2CppClass::FromTypeDefinitionIndex(PlayerActionConfigBase_TypeDefinitionIndex)->GetStaticField(0x451A0);
		}
