...
#define RPG_GAMECORE_GRIDFIGHTACTIONADDMAXINTERESTCONFIG_METHOD_6_30EACC56E30EFCAB_OFFSET UNITYSDK_OFFSET(0x1C5C12F0)
#define RPG_GAMECORE_GRIDFIGHTACTIONADDMAXINTERESTCONFIG_METHOD_6_E6AE083B22FB5907_OFFSET UNITYSDK_OFFSET(0x1C5C12A0)
#define RPG_GAMECORE_GRIDFIGHTACTIONADDMAXINTERESTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5C12E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightActionAddMaxInterestConfig_TypeDefinitionIndex = 18546;
