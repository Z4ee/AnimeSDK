...
#define RPG_GAMECORE_RANDOMSELECTFLOORVALUE_METHOD_3_210BB568AA340F67_OFFSET UNITYSDK_OFFSET(0x1B9B6DD0)
#define RPG_GAMECORE_RANDOMSELECTFLOORVALUE_METHOD_3_DEA3B58070BAAD86_OFFSET UNITYSDK_OFFSET(0x1B9B6E10)
#define RPG_GAMECORE_RANDOMSELECTFLOORVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9B6E00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RandomSelectFloorValue_TypeDefinitionIndex = 20414;
