...
#define RPG_GAMECORE_CAKERACEEVENTHANDLER_METHOD_2_10B3E16EAA3C89C0_OFFSET UNITYSDK_OFFSET(0x1704B0F0)
#define RPG_GAMECORE_CAKERACEEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1704B2B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceEventHandler_TypeDefinitionIndex = 16826;
