...
#define RPG_GAMECORE_PREDICATECONFIG_METHOD_3_00922438CF3D88E4_OFFSET UNITYSDK_OFFSET(0x1D7B5530)
#define RPG_GAMECORE_PREDICATECONFIG_METHOD_3_5ABFE8E95CEE0BB6_OFFSET UNITYSDK_OFFSET(0x1D7B54D0)
#define RPG_GAMECORE_PREDICATECONFIG_METHOD_3_B25F1F3414B44449_OFFSET UNITYSDK_OFFSET(0x1D7B5390)
#define RPG_GAMECORE_PREDICATECONFIG_METHOD_3_E1A307E8D8FA9443_OFFSET UNITYSDK_OFFSET(0x1D7B5350)
#define RPG_GAMECORE_PREDICATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7B5840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PredicateConfig_TypeDefinitionIndex = 23467;
