...
#define RPG_GAMECORE_LOGICANIMEVENTTIMELINETRACKGROUP_METHOD_2_AF32FB866E4AEDA0_OFFSET UNITYSDK_OFFSET(0x1BCD21C0)
#define RPG_GAMECORE_LOGICANIMEVENTTIMELINETRACKGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCD2200)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LogicAnimEventTimelineTrackGroup_TypeDefinitionIndex = 15655;
