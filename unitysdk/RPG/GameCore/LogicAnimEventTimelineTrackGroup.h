...
#define RPG_GAMECORE_LOGICANIMEVENTTIMELINETRACKGROUP_METHOD_2_AF32FB866E4AEDA0_OFFSET UNITYSDK_OFFSET(0x18A7BF30)
#define RPG_GAMECORE_LOGICANIMEVENTTIMELINETRACKGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x18A7BF70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LogicAnimEventTimelineTrackGroup_TypeDefinitionIndex = 15421;
