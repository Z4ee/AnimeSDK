...
#define RPG_GAMECORE_LOGICANIMEVENTTIMELINETRACKGROUP_METHOD_2_AF32FB866E4AEDA0_OFFSET UNITYSDK_OFFSET(0x1736E320)
#define RPG_GAMECORE_LOGICANIMEVENTTIMELINETRACKGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1736E360)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LogicAnimEventTimelineTrackGroup_TypeDefinitionIndex = 14914;
