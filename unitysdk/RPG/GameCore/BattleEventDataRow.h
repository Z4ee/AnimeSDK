...
#define RPG_GAMECORE_BATTLEEVENTDATAROW_FROMBINARYWITHOUTNEW_OFFSET UNITYSDK_OFFSET(0x186F71E0)
#define RPG_GAMECORE_BATTLEEVENTDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x186F7490)
#define RPG_GAMECORE_BATTLEEVENTDATAROW_FROMTABLEOFFSET_OFFSET UNITYSDK_OFFSET(0x186F7160)
#define RPG_GAMECORE_BATTLEEVENTDATAROW_RESET_OFFSET UNITYSDK_OFFSET(0x186F71C0)
#define RPG_GAMECORE_BATTLEEVENTDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x186F7770)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleEventDataRow_TypeDefinitionIndex = 12150;

	class BattleEventDataRow : public ::System::Object
	{
	public:
		::System::String* Prefab; // 0x10
		::System::String* Config; // 0x18
		::System::String* BasePoint; // 0x20
		::Il2CppArray<::System::UInt32>* SkillIDList; // 0x28
		::System::String* LevelAreaPrefab; // 0x30
