...
#define RPG_GAMECORE_STARTTRACKPHOTO_METHOD_3_4FA7809B47358C4A_OFFSET UNITYSDK_OFFSET(0x1D569130)
#define RPG_GAMECORE_STARTTRACKPHOTO_METHOD_3_B6C6BCCEC66C6429_OFFSET UNITYSDK_OFFSET(0x1D569170)
#define RPG_GAMECORE_STARTTRACKPHOTO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D569160)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StartTrackPhoto_TypeDefinitionIndex = 21399;
