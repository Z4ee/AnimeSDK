...
#define RPG_GAMECORE_ROGUEMODIFIERLEVELUPROOMCARDONROOMCARDATTRIBUTEEVICTCONFIG_METHOD_3_B0AD13F2805D1353_OFFSET UNITYSDK_OFFSET(0x1CFC15D0)
#define RPG_GAMECORE_ROGUEMODIFIERLEVELUPROOMCARDONROOMCARDATTRIBUTEEVICTCONFIG_METHOD_3_B97657ECF447938F_OFFSET UNITYSDK_OFFSET(0x1CFC1580)
#define RPG_GAMECORE_ROGUEMODIFIERLEVELUPROOMCARDONROOMCARDATTRIBUTEEVICTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFC15C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierLevelUpRoomCardOnRoomCardAttributeEvictConfig_TypeDefinitionIndex = 17134;
