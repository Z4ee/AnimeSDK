...
#define RPG_GAMECORE_ROGUEMODIFIERLEVELUPROOMCARDONROOMCARDATTRIBUTEEVICTCONFIG_METHOD_3_B0AD13F2805D1353_OFFSET UNITYSDK_OFFSET(0x17632CF0)
#define RPG_GAMECORE_ROGUEMODIFIERLEVELUPROOMCARDONROOMCARDATTRIBUTEEVICTCONFIG_METHOD_3_CA13353AED42459A_OFFSET UNITYSDK_OFFSET(0x17632C20)
#define RPG_GAMECORE_ROGUEMODIFIERLEVELUPROOMCARDONROOMCARDATTRIBUTEEVICTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17632CA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierLevelUpRoomCardOnRoomCardAttributeEvictConfig_TypeDefinitionIndex = 16403;
