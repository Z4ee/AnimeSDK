...
#define RPG_GAMECORE_CHIMERADUELROUNDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18804530)
#define RPG_GAMECORE_CHIMERADUELROUNDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x188047F0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 ShopChimeraSlotCount; // 0x28
		::System::UInt32 ShopChimeraGroup; // 0x2C
		::System::UInt32 ShopItemGroup; // 0x30
		::System::UInt32 RoundID; // 0x34
