...
#define RPG_GAMECORE_CHIMERADUELROUNDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C247280)
#define RPG_GAMECORE_CHIMERADUELROUNDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C247530)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelRoundRow_TypeDefinitionIndex = 10741;
