...
#define RPG_GAMECORE_CHIMERADUELROUNDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19645E20)
#define RPG_GAMECORE_CHIMERADUELROUNDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x196460D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelRoundRow_TypeDefinitionIndex = 10691;
	...
	public:
		...
		::System::UInt32 ShopItemGroup; // 0x28
		::System::UInt32 RoundID; // 0x2C
		::System::UInt32 ShopChimeraSlotCount; // 0x30
		::System::UInt32 ShopItemSlotCount; // 0x34
		::System::UInt32 ShopChimeraGroup; // 0x38
