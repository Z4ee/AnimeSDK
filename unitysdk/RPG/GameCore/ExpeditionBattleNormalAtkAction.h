...
#define RPG_GAMECORE_EXPEDITIONBATTLENORMALATKACTION_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1D7DC870)
#define RPG_GAMECORE_EXPEDITIONBATTLENORMALATKACTION_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D7DC7D0)
#define RPG_GAMECORE_EXPEDITIONBATTLENORMALATKACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7DC860)
