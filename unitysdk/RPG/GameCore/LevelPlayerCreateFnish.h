...
#define RPG_GAMECORE_LEVELPLAYERCREATEFNISH_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xCE4C4A0)
#define RPG_GAMECORE_LEVELPLAYERCREATEFNISH_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xCE4C450)
#define RPG_GAMECORE_LEVELPLAYERCREATEFNISH_INIT_OFFSET UNITYSDK_OFFSET(0xCE4C410)
#define RPG_GAMECORE_LEVELPLAYERCREATEFNISH__CTOR_OFFSET UNITYSDK_OFFSET(0xCE4C4F0)
