...
#define RPG_GAMECORE_TARGETSORTBYGRIDFIGHTROLETOTALDAMAGE_METHOD_3_6F55E48B894764C6_OFFSET UNITYSDK_OFFSET(0x1D0C81A0)
#define RPG_GAMECORE_TARGETSORTBYGRIDFIGHTROLETOTALDAMAGE_METHOD_3_C9F6DEA5AF69B606_OFFSET UNITYSDK_OFFSET(0x1D0C8260)
#define RPG_GAMECORE_TARGETSORTBYGRIDFIGHTROLETOTALDAMAGE_METHOD_3_D357941325E86B72_OFFSET UNITYSDK_OFFSET(0x1D0C82B0)
#define RPG_GAMECORE_TARGETSORTBYGRIDFIGHTROLETOTALDAMAGE_METHOD_3_EB40AC83A9C4FAFA_OFFSET UNITYSDK_OFFSET(0x1D0C8090)
#define RPG_GAMECORE_TARGETSORTBYGRIDFIGHTROLETOTALDAMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0C8190)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetSortByGridFightRoleTotalDamage_TypeDefinitionIndex = 23139;
