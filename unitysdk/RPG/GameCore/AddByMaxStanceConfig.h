...
#define RPG_GAMECORE_ADDBYMAXSTANCECONFIG_METHOD_2_169CCB0447BEE926_OFFSET UNITYSDK_OFFSET(0x16F1AC50)
#define RPG_GAMECORE_ADDBYMAXSTANCECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16F1B060)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddByMaxStanceConfig_TypeDefinitionIndex = 16684;
