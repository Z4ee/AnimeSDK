...
#define RPG_GAMECORE_CHIMERAFIREEFFECT_METHOD_3_EEEAFF887878C5DF_OFFSET UNITYSDK_OFFSET(0x19649EA0)
#define RPG_GAMECORE_CHIMERAFIREEFFECT_METHOD_3_FF4301BFD8757871_OFFSET UNITYSDK_OFFSET(0x19649F00)
#define RPG_GAMECORE_CHIMERAFIREEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x19649EF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraFireEffect_TypeDefinitionIndex = 15089;
