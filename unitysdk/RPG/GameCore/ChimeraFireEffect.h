...
#define RPG_GAMECORE_CHIMERAFIREEFFECT_METHOD_3_EEEAFF887878C5DF_OFFSET UNITYSDK_OFFSET(0x18808750)
#define RPG_GAMECORE_CHIMERAFIREEFFECT_METHOD_3_FF4301BFD8757871_OFFSET UNITYSDK_OFFSET(0x188087B0)
#define RPG_GAMECORE_CHIMERAFIREEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x188087A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraFireEffect_TypeDefinitionIndex = 15026;
