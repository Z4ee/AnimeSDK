...
#define RPG_GAMECORE_ROGUEACTSETBLACKBOARDBYRANDOMCONFIG_METHOD_6_309FEFB74E1EA5A3_OFFSET UNITYSDK_OFFSET(0x175C84C0)
#define RPG_GAMECORE_ROGUEACTSETBLACKBOARDBYRANDOMCONFIG_METHOD_6_C572FA0F488FCE96_OFFSET UNITYSDK_OFFSET(0x175C82A0)
#define RPG_GAMECORE_ROGUEACTSETBLACKBOARDBYRANDOMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175C83E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActSetBlackboardByRandomConfig_TypeDefinitionIndex = 18127;
