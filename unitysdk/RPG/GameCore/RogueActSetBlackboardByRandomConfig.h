...
#define RPG_GAMECORE_ROGUEACTSETBLACKBOARDBYRANDOMCONFIG_METHOD_6_309FEFB74E1EA5A3_OFFSET UNITYSDK_OFFSET(0x18CD4190)
#define RPG_GAMECORE_ROGUEACTSETBLACKBOARDBYRANDOMCONFIG_METHOD_6_C572FA0F488FCE96_OFFSET UNITYSDK_OFFSET(0x18CD3F70)
#define RPG_GAMECORE_ROGUEACTSETBLACKBOARDBYRANDOMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CD40B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActSetBlackboardByRandomConfig_TypeDefinitionIndex = 18772;
