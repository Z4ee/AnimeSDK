...
#define RPG_GAMECORE_IRIFBXLODSIZECONFIG_METHOD_2_5B6492929B8F1D76_OFFSET UNITYSDK_OFFSET(0x1D19B7F0)
#define RPG_GAMECORE_IRIFBXLODSIZECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D19B8D0)
