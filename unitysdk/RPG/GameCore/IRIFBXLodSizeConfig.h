...
#define RPG_GAMECORE_IRIFBXLODSIZECONFIG_METHOD_2_5B6492929B8F1D76_OFFSET UNITYSDK_OFFSET(0x1B691CD0)
#define RPG_GAMECORE_IRIFBXLODSIZECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B691DB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int IRIFBXLodSizeConfig_TypeDefinitionIndex = 18451;
