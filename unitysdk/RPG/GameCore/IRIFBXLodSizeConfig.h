...
#define RPG_GAMECORE_IRIFBXLODSIZECONFIG_METHOD_2_2353662CC69507D4_OFFSET UNITYSDK_OFFSET(0x172B5390)
#define RPG_GAMECORE_IRIFBXLODSIZECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x172B5460)

namespace RPG::GameCore
{
	inline static constexpr unsigned int IRIFBXLodSizeConfig_TypeDefinitionIndex = 17630;
