...
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_ISPVE_METHOD_4_3FCB8A56B7D10165_OFFSET UNITYSDK_OFFSET(0x1D8290B0)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_ISPVE_METHOD_4_94BB5E297798EE93_OFFSET UNITYSDK_OFFSET(0x1D82A260)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_ISPVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D8290A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatPredicateConfig_IsPVE_TypeDefinitionIndex = 15945;
