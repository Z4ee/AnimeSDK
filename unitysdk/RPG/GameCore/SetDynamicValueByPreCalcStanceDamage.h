...
#define RPG_GAMECORE_SETDYNAMICVALUEBYPRECALCSTANCEDAMAGE_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1E820E00)
#define RPG_GAMECORE_SETDYNAMICVALUEBYPRECALCSTANCEDAMAGE_METHOD_4_2BFFE18A03F88C18_OFFSET UNITYSDK_OFFSET(0x1E8208C0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYPRECALCSTANCEDAMAGE_METHOD_4_4875BE446B9F7531_OFFSET UNITYSDK_OFFSET(0x1E820A80)
#define RPG_GAMECORE_SETDYNAMICVALUEBYPRECALCSTANCEDAMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E8209B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByPreCalcStanceDamage_TypeDefinitionIndex = 23003;
