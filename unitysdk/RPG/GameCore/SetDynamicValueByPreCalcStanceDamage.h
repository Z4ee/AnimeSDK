...
#define RPG_GAMECORE_SETDYNAMICVALUEBYPRECALCSTANCEDAMAGE_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x18E25430)
#define RPG_GAMECORE_SETDYNAMICVALUEBYPRECALCSTANCEDAMAGE_METHOD_4_4875BE446B9F7531_OFFSET UNITYSDK_OFFSET(0x18E250B0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYPRECALCSTANCEDAMAGE_METHOD_4_4B064920D4F04CCA_OFFSET UNITYSDK_OFFSET(0x18E24EC0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYPRECALCSTANCEDAMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E24FD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByPreCalcStanceDamage_TypeDefinitionIndex = 22238;
