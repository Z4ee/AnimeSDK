...
#define RPG_GAMECORE_USESKILL_METHOD_3_4474EFFF13F2A180_OFFSET UNITYSDK_OFFSET(0x190E6E20)
#define RPG_GAMECORE_USESKILL_METHOD_3_D5E6F956B67D054F_OFFSET UNITYSDK_OFFSET(0x190E6DA0)
#define RPG_GAMECORE_USESKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x190E6DF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UseSkill_TypeDefinitionIndex = 21312;
