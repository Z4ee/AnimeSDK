...
#define RPG_GAMECORE_SETWEATHERUI_METHOD_3_621AC65B8FB2852B_OFFSET UNITYSDK_OFFSET(0x176E72F0)
#define RPG_GAMECORE_SETWEATHERUI_METHOD_3_938A4FFA2B5465F2_OFFSET UNITYSDK_OFFSET(0x176E7370)
#define RPG_GAMECORE_SETWEATHERUI__CTOR_OFFSET UNITYSDK_OFFSET(0x176E7340)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetWeatherUI_TypeDefinitionIndex = 20982;
