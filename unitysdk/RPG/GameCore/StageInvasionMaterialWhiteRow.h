...
#define RPG_GAMECORE_STAGEINVASIONMATERIALWHITEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D558820)
#define RPG_GAMECORE_STAGEINVASIONMATERIALWHITEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5588E0)
