...
#define RPG_GAMECORE_PRELOADITEMSILENCE_METHOD_2_598C07C9A42FA419_OFFSET UNITYSDK_OFFSET(0x1BA15F10)
#define RPG_GAMECORE_PRELOADITEMSILENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA16090)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PreloadItemSilence_TypeDefinitionIndex = 15712;
