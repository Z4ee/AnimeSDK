...
#define RPG_GAMECORE_RELEASECHARACTERHUDVISIBLECONTROL_METHOD_3_C5BF4458FAAD0DC8_OFFSET UNITYSDK_OFFSET(0x19ABAFC0)
#define RPG_GAMECORE_RELEASECHARACTERHUDVISIBLECONTROL_METHOD_3_E1C8047C6EBA3D61_OFFSET UNITYSDK_OFFSET(0x19ABAF40)
#define RPG_GAMECORE_RELEASECHARACTERHUDVISIBLECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x19ABAF90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ReleaseCharacterHUDVisibleControl_TypeDefinitionIndex = 21575;
