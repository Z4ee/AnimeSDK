...
#define RPG_GAMECORE_RELEASECHARACTERHUDVISIBLECONTROL_METHOD_3_C5BF4458FAAD0DC8_OFFSET UNITYSDK_OFFSET(0x18C96B50)
#define RPG_GAMECORE_RELEASECHARACTERHUDVISIBLECONTROL_METHOD_3_E1C8047C6EBA3D61_OFFSET UNITYSDK_OFFSET(0x18C96AD0)
#define RPG_GAMECORE_RELEASECHARACTERHUDVISIBLECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x18C96B20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ReleaseCharacterHUDVisibleControl_TypeDefinitionIndex = 21728;
