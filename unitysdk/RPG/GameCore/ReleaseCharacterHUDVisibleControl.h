...
#define RPG_GAMECORE_RELEASECHARACTERHUDVISIBLECONTROL_METHOD_3_7258D2E7CA7536AB_OFFSET UNITYSDK_OFFSET(0x1DB7FEF0)
#define RPG_GAMECORE_RELEASECHARACTERHUDVISIBLECONTROL_METHOD_3_C5BF4458FAAD0DC8_OFFSET UNITYSDK_OFFSET(0x1DB7FF30)
#define RPG_GAMECORE_RELEASECHARACTERHUDVISIBLECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB7FF20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ReleaseCharacterHUDVisibleControl_TypeDefinitionIndex = 22563;
