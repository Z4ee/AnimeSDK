...
#define RPG_GAMECORE_BYTARGETENTITYTYPE_METHOD_4_0DB6079465FD2B06_OFFSET UNITYSDK_OFFSET(0x1B2BC020)
#define RPG_GAMECORE_BYTARGETENTITYTYPE_METHOD_4_601FF42B5C162B01_OFFSET UNITYSDK_OFFSET(0x1B2BC270)
#define RPG_GAMECORE_BYTARGETENTITYTYPE_METHOD_4_A53DEC672B782B4F_OFFSET UNITYSDK_OFFSET(0x1B2BBFD0)
#define RPG_GAMECORE_BYTARGETENTITYTYPE_METHOD_4_C0353B80AC07B2DF_OFFSET UNITYSDK_OFFSET(0x1B2BC230)
#define RPG_GAMECORE_BYTARGETENTITYTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2BC010)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByTargetEntityType_TypeDefinitionIndex = 22188;
