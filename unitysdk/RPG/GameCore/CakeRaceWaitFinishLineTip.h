...
#define RPG_GAMECORE_CAKERACEWAITFINISHLINETIP_METHOD_3_95FC791C87CEF7DD_OFFSET UNITYSDK_OFFSET(0x187B57F0)
#define RPG_GAMECORE_CAKERACEWAITFINISHLINETIP_METHOD_3_BCD8497FEBE0B1E9_OFFSET UNITYSDK_OFFSET(0x187B56E0)
#define RPG_GAMECORE_CAKERACEWAITFINISHLINETIP__CTOR_OFFSET UNITYSDK_OFFSET(0x187B57C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceWaitFinishLineTip_TypeDefinitionIndex = 23312;
