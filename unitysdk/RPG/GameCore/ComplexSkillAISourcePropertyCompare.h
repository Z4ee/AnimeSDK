...
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEPROPERTYCOMPARE_METHOD_3_3A98A2D41335AE90_OFFSET UNITYSDK_OFFSET(0x1882DFA0)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEPROPERTYCOMPARE_METHOD_3_EECA2316FE7580AF_OFFSET UNITYSDK_OFFSET(0x1882FF70)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEPROPERTYCOMPARE__CTOR_OFFSET UNITYSDK_OFFSET(0x1882DF80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAISourcePropertyCompare_TypeDefinitionIndex = 14687;
