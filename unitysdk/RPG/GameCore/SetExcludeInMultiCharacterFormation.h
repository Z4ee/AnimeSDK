...
#define RPG_GAMECORE_SETEXCLUDEINMULTICHARACTERFORMATION_METHOD_3_3400EC4F8D9BBFF5_OFFSET UNITYSDK_OFFSET(0x176CCE70)
#define RPG_GAMECORE_SETEXCLUDEINMULTICHARACTERFORMATION_METHOD_3_3AD44EE2F0B0BB76_OFFSET UNITYSDK_OFFSET(0x176CCF50)
#define RPG_GAMECORE_SETEXCLUDEINMULTICHARACTERFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x176CCEF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetExcludeInMultiCharacterFormation_TypeDefinitionIndex = 20824;
