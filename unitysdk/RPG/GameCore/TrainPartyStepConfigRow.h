...
#define RPG_GAMECORE_TRAINPARTYSTEPCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D5E2030)
#define RPG_GAMECORE_TRAINPARTYSTEPCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5E23E0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Boolean HasPreview; // 0x3C
		::System::Boolean HasCutScene; // 0x3D
