...
#define RPG_GAMECORE_TRAINPARTYSTEPCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C164C50)
#define RPG_GAMECORE_TRAINPARTYSTEPCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C165000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyStepConfigRow_TypeDefinitionIndex = 14721;
