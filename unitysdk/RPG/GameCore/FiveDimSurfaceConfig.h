...
#define RPG_GAMECORE_FIVEDIMSURFACECONFIG_METHOD_3_5561278D96EB854E_OFFSET UNITYSDK_OFFSET(0x1720F8B0)
#define RPG_GAMECORE_FIVEDIMSURFACECONFIG_METHOD_3_C58CBBD2253122E7_OFFSET UNITYSDK_OFFSET(0x1720F840)
#define RPG_GAMECORE_FIVEDIMSURFACECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1720F890)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSurfaceConfig_TypeDefinitionIndex = 17008;
