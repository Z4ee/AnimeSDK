...
#define RPG_GAMECORE_FIVEDIMSURFACECONFIG_METHOD_3_ADE92D10F6A36F8B_OFFSET UNITYSDK_OFFSET(0x1BEB6A60)
#define RPG_GAMECORE_FIVEDIMSURFACECONFIG_METHOD_3_C84FC0E9E0ABECD6_OFFSET UNITYSDK_OFFSET(0x1BEB6AA0)
#define RPG_GAMECORE_FIVEDIMSURFACECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEB6A90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSurfaceConfig_TypeDefinitionIndex = 17802;
