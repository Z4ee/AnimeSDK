...
#define RPG_GAMECORE_ADDRESHAEASTEREGGMATCHRULE_METHOD_3_22D4E91DD6B19AAA_OFFSET UNITYSDK_OFFSET(0x1BE09550)
#define RPG_GAMECORE_ADDRESHAEASTEREGGMATCHRULE_METHOD_3_3E49178CFC401627_OFFSET UNITYSDK_OFFSET(0x1BE09510)
#define RPG_GAMECORE_ADDRESHAEASTEREGGMATCHRULE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE09540)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddReShaEasterEggMatchRule_TypeDefinitionIndex = 21227;
