...
#define RPG_GAMECORE_SETTARGETCROSSHAIRVISIBLE_METHOD_3_0EE3FE06A221A7C5_OFFSET UNITYSDK_OFFSET(0x18E44BD0)
#define RPG_GAMECORE_SETTARGETCROSSHAIRVISIBLE_METHOD_3_292232884F995C79_OFFSET UNITYSDK_OFFSET(0x18E44C50)
#define RPG_GAMECORE_SETTARGETCROSSHAIRVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E44C20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetTargetCrossHairVisible_TypeDefinitionIndex = 21865;
