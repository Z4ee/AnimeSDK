...
#define RPG_GAMECORE_SETTARGETCROSSHAIRVISIBLE_METHOD_3_292232884F995C79_OFFSET UNITYSDK_OFFSET(0x1D5106C0)
#define RPG_GAMECORE_SETTARGETCROSSHAIRVISIBLE_METHOD_3_7D5414D1F3A10EB6_OFFSET UNITYSDK_OFFSET(0x1D510680)
#define RPG_GAMECORE_SETTARGETCROSSHAIRVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5106B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetTargetCrossHairVisible_TypeDefinitionIndex = 22688;
