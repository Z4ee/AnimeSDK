...
#define RPG_GAMECORE_SETTVNOTIFYCONFIG_METHOD_2_E82129229BEB09AE_OFFSET UNITYSDK_OFFSET(0x1D50FC00)
#define RPG_GAMECORE_SETTVNOTIFYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D50FCE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetTVNotifyConfig_TypeDefinitionIndex = 16773;
