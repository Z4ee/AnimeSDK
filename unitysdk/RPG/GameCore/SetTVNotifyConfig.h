...
#define RPG_GAMECORE_SETTVNOTIFYCONFIG_METHOD_2_E82129229BEB09AE_OFFSET UNITYSDK_OFFSET(0x1E08FD00)
#define RPG_GAMECORE_SETTVNOTIFYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1E08FDE0)
