...
#define RPG_GAMECORE_ROGUEPARAMMAGICUNITCOUNTCONFIG_METHOD_6_962CAAA6B8B5CE2D_OFFSET UNITYSDK_OFFSET(0x1764B920)
#define RPG_GAMECORE_ROGUEPARAMMAGICUNITCOUNTCONFIG_METHOD_6_ABB010A28B67F3C3_OFFSET UNITYSDK_OFFSET(0x1764B670)
#define RPG_GAMECORE_ROGUEPARAMMAGICUNITCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1764B7F0)
