...
#define RPG_GAMECORE_ROGUEPARAMMAGICUNITCOUNTCONFIG_METHOD_6_962CAAA6B8B5CE2D_OFFSET UNITYSDK_OFFSET(0x18D593D0)
#define RPG_GAMECORE_ROGUEPARAMMAGICUNITCOUNTCONFIG_METHOD_6_ABB010A28B67F3C3_OFFSET UNITYSDK_OFFSET(0x18D59120)
#define RPG_GAMECORE_ROGUEPARAMMAGICUNITCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D592A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamMagicUnitCountConfig_TypeDefinitionIndex = 18819;
