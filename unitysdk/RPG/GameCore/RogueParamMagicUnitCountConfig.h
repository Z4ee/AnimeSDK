...
#define RPG_GAMECORE_ROGUEPARAMMAGICUNITCOUNTCONFIG_METHOD_6_962CAAA6B8B5CE2D_OFFSET UNITYSDK_OFFSET(0x1D176840)
#define RPG_GAMECORE_ROGUEPARAMMAGICUNITCOUNTCONFIG_METHOD_6_D4C0B1F47A1788A9_OFFSET UNITYSDK_OFFSET(0x1D1767F0)
#define RPG_GAMECORE_ROGUEPARAMMAGICUNITCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D176830)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamMagicUnitCountConfig_TypeDefinitionIndex = 19065;
