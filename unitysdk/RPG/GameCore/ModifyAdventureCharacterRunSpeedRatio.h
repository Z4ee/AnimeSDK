...
#define RPG_GAMECORE_MODIFYADVENTURECHARACTERRUNSPEEDRATIO_METHOD_3_3D85CE0BBD2FB8DA_OFFSET UNITYSDK_OFFSET(0x1D2AE820)
#define RPG_GAMECORE_MODIFYADVENTURECHARACTERRUNSPEEDRATIO_METHOD_3_4BBA5E5ADD13C482_OFFSET UNITYSDK_OFFSET(0x1D2AE870)
#define RPG_GAMECORE_MODIFYADVENTURECHARACTERRUNSPEEDRATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2AE860)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyAdventureCharacterRunSpeedRatio_TypeDefinitionIndex = 20282;
