...
#define RPG_GAMECORE_BYCOMPAREMUSICRHYTHMSONGID_METHOD_4_64E1F2AF82396CBB_OFFSET UNITYSDK_OFFSET(0x19CF8D10)
#define RPG_GAMECORE_BYCOMPAREMUSICRHYTHMSONGID_METHOD_4_6FC5CEB322AAAA7F_OFFSET UNITYSDK_OFFSET(0x19CF8BA0)
#define RPG_GAMECORE_BYCOMPAREMUSICRHYTHMSONGID_METHOD_4_78D0E32809C51DF2_OFFSET UNITYSDK_OFFSET(0x19CF8B60)
#define RPG_GAMECORE_BYCOMPAREMUSICRHYTHMSONGID_METHOD_4_D4E98AFF36561814_OFFSET UNITYSDK_OFFSET(0x19CF8D40)
#define RPG_GAMECORE_BYCOMPAREMUSICRHYTHMSONGID__CTOR_OFFSET UNITYSDK_OFFSET(0x19CF8B90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareMusicRhythmSongID_TypeDefinitionIndex = 21252;
