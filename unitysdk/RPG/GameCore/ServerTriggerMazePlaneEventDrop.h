...
#define RPG_GAMECORE_SERVERTRIGGERMAZEPLANEEVENTDROP_METHOD_3_535FDF03A75F5476_OFFSET UNITYSDK_OFFSET(0x18E06AF0)
#define RPG_GAMECORE_SERVERTRIGGERMAZEPLANEEVENTDROP_METHOD_3_6234581BC9113B76_OFFSET UNITYSDK_OFFSET(0x18E06B80)
#define RPG_GAMECORE_SERVERTRIGGERMAZEPLANEEVENTDROP__CTOR_OFFSET UNITYSDK_OFFSET(0x18E06B50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ServerTriggerMazePlaneEventDrop_TypeDefinitionIndex = 21194;
