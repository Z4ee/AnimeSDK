...
#define RPG_GAMECORE_SERVERTRIGGERMAZEPLANEEVENTDROP_METHOD_3_535FDF03A75F5476_OFFSET UNITYSDK_OFFSET(0x176A3FF0)
#define RPG_GAMECORE_SERVERTRIGGERMAZEPLANEEVENTDROP_METHOD_3_6234581BC9113B76_OFFSET UNITYSDK_OFFSET(0x176A4080)
#define RPG_GAMECORE_SERVERTRIGGERMAZEPLANEEVENTDROP__CTOR_OFFSET UNITYSDK_OFFSET(0x176A4050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ServerTriggerMazePlaneEventDrop_TypeDefinitionIndex = 20511;
