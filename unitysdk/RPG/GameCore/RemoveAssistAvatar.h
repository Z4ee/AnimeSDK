...
#define RPG_GAMECORE_REMOVEASSISTAVATAR_METHOD_3_4091A4A4C0EF7798_OFFSET UNITYSDK_OFFSET(0x1DB8C1D0)
#define RPG_GAMECORE_REMOVEASSISTAVATAR_METHOD_3_F63A31B6F5BE6DD5_OFFSET UNITYSDK_OFFSET(0x1DB8C2A0)
#define RPG_GAMECORE_REMOVEASSISTAVATAR__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB8C290)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveAssistAvatar_TypeDefinitionIndex = 20305;
