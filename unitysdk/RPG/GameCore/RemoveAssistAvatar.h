...
#define RPG_GAMECORE_REMOVEASSISTAVATAR_METHOD_3_6A58B51F1BC718C1_OFFSET UNITYSDK_OFFSET(0x19AC74E0)
#define RPG_GAMECORE_REMOVEASSISTAVATAR_METHOD_3_F63A31B6F5BE6DD5_OFFSET UNITYSDK_OFFSET(0x19AC75F0)
#define RPG_GAMECORE_REMOVEASSISTAVATAR__CTOR_OFFSET UNITYSDK_OFFSET(0x19AC75C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveAssistAvatar_TypeDefinitionIndex = 19401;
