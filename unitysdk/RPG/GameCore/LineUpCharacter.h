...
#define RPG_GAMECORE_LINEUPCHARACTER_DEEPCOPY_OFFSET UNITYSDK_OFFSET(0xCE57650)
#define RPG_GAMECORE_LINEUPCHARACTER_GETAVATARROWWRAPPEREXTRAPARAM_OFFSET UNITYSDK_OFFSET(0xCE57B20)
#define RPG_GAMECORE_LINEUPCHARACTER_GET_AVATARDERIVETYPE_OFFSET UNITYSDK_OFFSET(0xCE57AD0)
#define RPG_GAMECORE_LINEUPCHARACTER_GET_CHARACTERSPRATIO_OFFSET UNITYSDK_OFFSET(0xCE57A80)
#define RPG_GAMECORE_LINEUPCHARACTER_RESET_OFFSET UNITYSDK_OFFSET(0xCE57600)
#define RPG_GAMECORE_LINEUPCHARACTER_TOSTRING_OFFSET UNITYSDK_OFFSET(0xCE57C30)
#define RPG_GAMECORE_LINEUPCHARACTER__CTOR_OFFSET UNITYSDK_OFFSET(0xCE57590)
#define RPG_GAMECORE_LINEUPCHARACTER___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0xCE57EE0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Class_1_EA6B9573C4BF1DD5* BattleRelicItemModule; // 0x20
		::RPG::GameCore::BattleGridFightAvatarData* BattleGridAvatarData; // 0x28
		::Il2CppArray<::Class_1_7AB88D713F5121B3_47*>* ChangedSkillTreePointList; // 0x30
		::Il2CppArray<::Class_1_7AB88D713F5121B3_47*>* SkillTreePointList; // 0x38
		::System::UInt32 CharacterRowIndex; // 0x40
		::System::UInt32 CharacterPromotion; // 0x44
		::System::UInt32 EnhancedID; // 0x48
		::System::UInt32 CharacterLevel; // 0x4C
		::System::UInt32 TotalPower; // 0x50
		::System::UInt32 CharacterID; // 0x54
		::Enum_3_0A3761FE34514D6C_13 SpiritLineupType; // 0x58
		::Enum_3_01618AD0437C8486 CharacterAvatarType; // 0x5C
		::System::UInt32 AssistUid; // 0x60
		::System::UInt32 WorldLevel; // 0x64
		::RPG::GameCore::FixPoint CharacterSP_Numerator; // 0x68
		::System::UInt32 CharacterRank; // 0x70
		::RPG::GameCore::FixPoint CharacterHPRatio; // 0x78
		::RPG::GameCore::FixPoint CharacterSP_Denominator; // 0x80
		::System::UInt32 SpecialAvatarID; // 0x88
		::System::UInt32 Index; // 0x8C
