...
#define RPG_GAMECORE_SIMPLECHIMERADUELVALUEGETTER_METHOD_3_5E4EB95BD11B1890_OFFSET UNITYSDK_OFFSET(0x19C88780)
#define RPG_GAMECORE_SIMPLECHIMERADUELVALUEGETTER_METHOD_3_8961DF48220E919C_OFFSET UNITYSDK_OFFSET(0x19C88660)
#define RPG_GAMECORE_SIMPLECHIMERADUELVALUEGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19C88770)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SimpleChimeraDuelValueGetter_TypeDefinitionIndex = 15218;
