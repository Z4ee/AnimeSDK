...
#define RPG_GAMECORE_SIMPLECHIMERADUELVALUEGETTER_METHOD_3_5E4EB95BD11B1890_OFFSET UNITYSDK_OFFSET(0x1BE4BCA0)
#define RPG_GAMECORE_SIMPLECHIMERADUELVALUEGETTER_METHOD_3_8961DF48220E919C_OFFSET UNITYSDK_OFFSET(0x1BE4BB80)
#define RPG_GAMECORE_SIMPLECHIMERADUELVALUEGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE4BC90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SimpleChimeraDuelValueGetter_TypeDefinitionIndex = 15382;
