...
#define RPG_GAMECORE_ROGUEPERSONAGUIDEDRAWCONFIG_METHOD_2_E69303F702E880E6_OFFSET UNITYSDK_OFFSET(0x18D65370)
#define RPG_GAMECORE_ROGUEPERSONAGUIDEDRAWCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D653B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RoguePersonaGuideDrawConfig_TypeDefinitionIndex = 16954;
