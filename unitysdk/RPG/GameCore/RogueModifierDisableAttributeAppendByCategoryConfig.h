...
#define RPG_GAMECORE_ROGUEMODIFIERDISABLEATTRIBUTEAPPENDBYCATEGORYCONFIG_METHOD_3_083C3984F7729D83_OFFSET UNITYSDK_OFFSET(0x1CFBF5F0)
#define RPG_GAMECORE_ROGUEMODIFIERDISABLEATTRIBUTEAPPENDBYCATEGORYCONFIG_METHOD_3_4885D1C967E2747F_OFFSET UNITYSDK_OFFSET(0x1CFBF5A0)
#define RPG_GAMECORE_ROGUEMODIFIERDISABLEATTRIBUTEAPPENDBYCATEGORYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFBF5E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierDisableAttributeAppendByCategoryConfig_TypeDefinitionIndex = 17118;
