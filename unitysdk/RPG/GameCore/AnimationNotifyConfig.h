...
#define RPG_GAMECORE_ANIMATIONNOTIFYCONFIG_METHOD_2_8B54E6C1CF65A389_OFFSET UNITYSDK_OFFSET(0x1947A970)
#define RPG_GAMECORE_ANIMATIONNOTIFYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1947ABC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AnimationNotifyConfig_TypeDefinitionIndex = 16095;
