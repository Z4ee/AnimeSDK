...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERDIFFERENTROLEMERGECONFIG_METHOD_3_04A054B02D9A3B20_OFFSET UNITYSDK_OFFSET(0x189BB800)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERDIFFERENTROLEMERGECONFIG_METHOD_3_345BEDAF99AD96F9_OFFSET UNITYSDK_OFFSET(0x189B7ED0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERDIFFERENTROLEMERGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189B7E80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierDifferentRoleMergeConfig_TypeDefinitionIndex = 18515;
