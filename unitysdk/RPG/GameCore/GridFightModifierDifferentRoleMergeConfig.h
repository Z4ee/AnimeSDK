...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERDIFFERENTROLEMERGECONFIG_METHOD_3_345BEDAF99AD96F9_OFFSET UNITYSDK_OFFSET(0x1C5D0AA0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERDIFFERENTROLEMERGECONFIG_METHOD_3_C6469228F31DD0F5_OFFSET UNITYSDK_OFFSET(0x1C5D0A50)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERDIFFERENTROLEMERGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5D0A90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierDifferentRoleMergeConfig_TypeDefinitionIndex = 18737;
