...
#define RPG_GAMECORE_SHAREDINT_EQUALS_OFFSET UNITYSDK_OFFSET(0x18E51870)
#define RPG_GAMECORE_SHAREDINT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x18E518B0)
#define RPG_GAMECORE_SHAREDINT_METHOD_3_6298D73FAACC4622_OFFSET UNITYSDK_OFFSET(0x18E51750)
#define RPG_GAMECORE_SHAREDINT_METHOD_3_85D22C255258C41D_OFFSET UNITYSDK_OFFSET(0x18E51860)
#define RPG_GAMECORE_SHAREDINT_METHOD_3_D606EE9005CB8215_OFFSET UNITYSDK_OFFSET(0x18E51710)
#define RPG_GAMECORE_SHAREDINT__CTOR_OFFSET UNITYSDK_OFFSET(0x18E51740)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SharedInt_TypeDefinitionIndex = 17394;
