...
#define RPG_GAMECORE_SHAREDINT_EQUALS_OFFSET UNITYSDK_OFFSET(0x176EE200)
#define RPG_GAMECORE_SHAREDINT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x176EE240)
#define RPG_GAMECORE_SHAREDINT_METHOD_3_6298D73FAACC4622_OFFSET UNITYSDK_OFFSET(0x176EE0E0)
#define RPG_GAMECORE_SHAREDINT_METHOD_3_85D22C255258C41D_OFFSET UNITYSDK_OFFSET(0x176EE1F0)
#define RPG_GAMECORE_SHAREDINT_METHOD_3_D606EE9005CB8215_OFFSET UNITYSDK_OFFSET(0x176EE0A0)
#define RPG_GAMECORE_SHAREDINT__CTOR_OFFSET UNITYSDK_OFFSET(0x176EE0D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SharedInt_TypeDefinitionIndex = 16800;
