...
#define RPG_GAMECORE_GRIDFIGHTPREPTUTORIALTOPHINTPARAM_METHOD_2_35AD31FDAA43A322_OFFSET UNITYSDK_OFFSET(0x1727BD30)
#define RPG_GAMECORE_GRIDFIGHTPREPTUTORIALTOPHINTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1727C410)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightPrepTutorialTopHintParam_TypeDefinitionIndex = 18237;
