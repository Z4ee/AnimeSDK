...
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEALLSEQUENCE_METHOD_3_4EEFAB28AD33A09E_OFFSET UNITYSDK_OFFSET(0x196A2F90)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEALLSEQUENCE_METHOD_3_80DC7BAA04457C0F_OFFSET UNITYSDK_OFFSET(0x196A24C0)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEALLSEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x196A24B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatAIEffectEvaluatorConfig_DiceAllSequence_TypeDefinitionIndex = 15404;
