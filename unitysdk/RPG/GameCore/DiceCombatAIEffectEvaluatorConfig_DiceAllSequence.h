...
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEALLSEQUENCE_METHOD_3_4EEFAB28AD33A09E_OFFSET UNITYSDK_OFFSET(0x18863DB0)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEALLSEQUENCE_METHOD_3_80DC7BAA04457C0F_OFFSET UNITYSDK_OFFSET(0x188632E0)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEALLSEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x188632D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatAIEffectEvaluatorConfig_DiceAllSequence_TypeDefinitionIndex = 15346;
