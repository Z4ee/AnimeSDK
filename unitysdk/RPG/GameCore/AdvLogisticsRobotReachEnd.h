...
#define RPG_GAMECORE_ADVLOGISTICSROBOTREACHEND_METHOD_3_B8A0B926F0D3DA1F_OFFSET UNITYSDK_OFFSET(0x18654FB0)
#define RPG_GAMECORE_ADVLOGISTICSROBOTREACHEND_METHOD_3_E8001D95CA0212AB_OFFSET UNITYSDK_OFFSET(0x18654EA0)
#define RPG_GAMECORE_ADVLOGISTICSROBOTREACHEND__CTOR_OFFSET UNITYSDK_OFFSET(0x18654F80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvLogisticsRobotReachEnd_TypeDefinitionIndex = 20175;
