...
#define RPG_GAMECORE_ADVLOGISTICSROBOTREACHEND_METHOD_3_3E542A1D2088B362_OFFSET UNITYSDK_OFFSET(0x1BE20770)
#define RPG_GAMECORE_ADVLOGISTICSROBOTREACHEND_METHOD_3_B8A0B926F0D3DA1F_OFFSET UNITYSDK_OFFSET(0x1BE20840)
#define RPG_GAMECORE_ADVLOGISTICSROBOTREACHEND__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE20830)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvLogisticsRobotReachEnd_TypeDefinitionIndex = 20404;
