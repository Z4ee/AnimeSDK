...
#define RPG_GAMECORE_ADVLOGISTICSROBOTREACHEND_METHOD_3_B8A0B926F0D3DA1F_OFFSET UNITYSDK_OFFSET(0x19428B20)
#define RPG_GAMECORE_ADVLOGISTICSROBOTREACHEND_METHOD_3_E8001D95CA0212AB_OFFSET UNITYSDK_OFFSET(0x19428A10)
#define RPG_GAMECORE_ADVLOGISTICSROBOTREACHEND__CTOR_OFFSET UNITYSDK_OFFSET(0x19428AF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvLogisticsRobotReachEnd_TypeDefinitionIndex = 20032;
