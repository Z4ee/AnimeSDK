...
#define RPG_GAMECORE_MUNICIPALCHATACTIONFREESTYLE_METHOD_3_3D7C04C5FC0F398E_OFFSET UNITYSDK_OFFSET(0x1745BC70)
#define RPG_GAMECORE_MUNICIPALCHATACTIONFREESTYLE_METHOD_3_DE19F4B39C6373EB_OFFSET UNITYSDK_OFFSET(0x1745B390)
#define RPG_GAMECORE_MUNICIPALCHATACTIONFREESTYLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1745B380)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MunicipalChatActionFreeStyle_TypeDefinitionIndex = 15496;
