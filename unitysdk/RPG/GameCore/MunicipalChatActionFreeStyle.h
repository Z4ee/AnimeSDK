...
#define RPG_GAMECORE_MUNICIPALCHATACTIONFREESTYLE_METHOD_3_3D7C04C5FC0F398E_OFFSET UNITYSDK_OFFSET(0x1B1D3F10)
#define RPG_GAMECORE_MUNICIPALCHATACTIONFREESTYLE_METHOD_3_DE19F4B39C6373EB_OFFSET UNITYSDK_OFFSET(0x1B1D3630)
#define RPG_GAMECORE_MUNICIPALCHATACTIONFREESTYLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1D3620)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MunicipalChatActionFreeStyle_TypeDefinitionIndex = 16250;
