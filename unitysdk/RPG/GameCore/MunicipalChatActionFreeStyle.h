...
#define RPG_GAMECORE_MUNICIPALCHATACTIONFREESTYLE_METHOD_3_3D7C04C5FC0F398E_OFFSET UNITYSDK_OFFSET(0x18B68970)
#define RPG_GAMECORE_MUNICIPALCHATACTIONFREESTYLE_METHOD_3_DE19F4B39C6373EB_OFFSET UNITYSDK_OFFSET(0x18B68090)
#define RPG_GAMECORE_MUNICIPALCHATACTIONFREESTYLE__CTOR_OFFSET UNITYSDK_OFFSET(0x18B68080)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MunicipalChatActionFreeStyle_TypeDefinitionIndex = 16016;
