...
#define RPG_GAMECORE_LITTLEGAMECIRCLECURVEINFO_METHOD_3_23EAA5B6C78B0858_OFFSET UNITYSDK_OFFSET(0x19898E00)
#define RPG_GAMECORE_LITTLEGAMECIRCLECURVEINFO_METHOD_3_5BA71826636BA9C3_OFFSET UNITYSDK_OFFSET(0x19898850)
#define RPG_GAMECORE_LITTLEGAMECIRCLECURVEINFO_METHOD_3_823B0920A1E5575C_OFFSET UNITYSDK_OFFSET(0x19898800)
#define RPG_GAMECORE_LITTLEGAMECIRCLECURVEINFO_METHOD_3_8B071BD4E0283A69_OFFSET UNITYSDK_OFFSET(0x198989D0)
#define RPG_GAMECORE_LITTLEGAMECIRCLECURVEINFO_METHOD_3_8E2CE51AB9C33B3D_OFFSET UNITYSDK_OFFSET(0x19898AA0)
#define RPG_GAMECORE_LITTLEGAMECIRCLECURVEINFO_METHOD_3_978C9496D0413FBC_OFFSET UNITYSDK_OFFSET(0x19898A00)
#define RPG_GAMECORE_LITTLEGAMECIRCLECURVEINFO_METHOD_3_D978819B0A4871A0_OFFSET UNITYSDK_OFFSET(0x198989C0)
#define RPG_GAMECORE_LITTLEGAMECIRCLECURVEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19898840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameCircleCurveInfo_TypeDefinitionIndex = 17939;
