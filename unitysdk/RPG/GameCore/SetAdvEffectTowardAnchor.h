...
#define RPG_GAMECORE_SETADVEFFECTTOWARDANCHOR_METHOD_3_30AEFFE252751D96_OFFSET UNITYSDK_OFFSET(0x1D4DFA50)
#define RPG_GAMECORE_SETADVEFFECTTOWARDANCHOR_METHOD_3_8741AF86F314763F_OFFSET UNITYSDK_OFFSET(0x1D4DFA10)
#define RPG_GAMECORE_SETADVEFFECTTOWARDANCHOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4DFA40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetAdvEffectTowardAnchor_TypeDefinitionIndex = 22071;
