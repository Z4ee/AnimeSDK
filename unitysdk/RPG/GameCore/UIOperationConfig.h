...
#define RPG_GAMECORE_UIOPERATIONCONFIG_METHOD_2_AB912C6706A1CFBD_OFFSET UNITYSDK_OFFSET(0x1D2AA3B0)
#define RPG_GAMECORE_UIOPERATIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2AB410)
