...
#define RPG_GAMECORE_BATTLEFULLSCREENTRANSFER_METHOD_3_2AAE1F2A46A3CBE9_OFFSET UNITYSDK_OFFSET(0x1B2FD850)
#define RPG_GAMECORE_BATTLEFULLSCREENTRANSFER_METHOD_3_9E2C77D9DDF8D29E_OFFSET UNITYSDK_OFFSET(0x1B2FD8A0)
#define RPG_GAMECORE_BATTLEFULLSCREENTRANSFER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2FD890)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleFullScreenTransfer_TypeDefinitionIndex = 22798;
