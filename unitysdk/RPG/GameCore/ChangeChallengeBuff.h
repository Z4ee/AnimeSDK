...
#define RPG_GAMECORE_CHANGECHALLENGEBUFF_METHOD_3_97473529E64CAAAB_OFFSET UNITYSDK_OFFSET(0x187C53E0)
#define RPG_GAMECORE_CHANGECHALLENGEBUFF_METHOD_3_FB3D1D35FF43B982_OFFSET UNITYSDK_OFFSET(0x187C5460)
#define RPG_GAMECORE_CHANGECHALLENGEBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x187C5430)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChangeChallengeBuff_TypeDefinitionIndex = 19431;
