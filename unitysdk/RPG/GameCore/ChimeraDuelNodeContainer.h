...
#define RPG_GAMECORE_CHIMERADUELNODECONTAINER_METHOD_2_41EF049A734EE93E_OFFSET UNITYSDK_OFFSET(0x1CFCA7C0)
#define RPG_GAMECORE_CHIMERADUELNODECONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFCA9F0)
