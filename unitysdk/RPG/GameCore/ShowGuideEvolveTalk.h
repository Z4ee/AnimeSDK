...
#define RPG_GAMECORE_SHOWGUIDEEVOLVETALK_METHOD_3_08A49B504AFD4FCD_OFFSET UNITYSDK_OFFSET(0x18E601C0)
#define RPG_GAMECORE_SHOWGUIDEEVOLVETALK_METHOD_3_E4DDE1146AF0759A_OFFSET UNITYSDK_OFFSET(0x18E60240)
#define RPG_GAMECORE_SHOWGUIDEEVOLVETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x18E60210)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowGuideEvolveTalk_TypeDefinitionIndex = 23342;
