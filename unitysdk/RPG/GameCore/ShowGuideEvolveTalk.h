...
#define RPG_GAMECORE_SHOWGUIDEEVOLVETALK_METHOD_3_0914F65207660701_OFFSET UNITYSDK_OFFSET(0x1D0942A0)
#define RPG_GAMECORE_SHOWGUIDEEVOLVETALK_METHOD_3_6C776FA3A13698A0_OFFSET UNITYSDK_OFFSET(0x1D0942E0)
#define RPG_GAMECORE_SHOWGUIDEEVOLVETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0942D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowGuideEvolveTalk_TypeDefinitionIndex = 24050;
