...
#define RPG_GAMECORE_PROPCURVEMOVESTARTMODE_PINPONG_METHOD_3_3F9921AC5E3EA22B_OFFSET UNITYSDK_OFFSET(0x18C685D0)
#define RPG_GAMECORE_PROPCURVEMOVESTARTMODE_PINPONG_METHOD_3_92FF931D8E767948_OFFSET UNITYSDK_OFFSET(0x18C68220)
#define RPG_GAMECORE_PROPCURVEMOVESTARTMODE_PINPONG__CTOR_OFFSET UNITYSDK_OFFSET(0x18C68210)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropCurveMoveStartMode_PinPong_TypeDefinitionIndex = 19992;
