...
#define RPG_GAMECORE_PROPCURVEMOVESTARTMODE_PINPONG_METHOD_3_3F9921AC5E3EA22B_OFFSET UNITYSDK_OFFSET(0x1D176970)
#define RPG_GAMECORE_PROPCURVEMOVESTARTMODE_PINPONG_METHOD_3_92FF931D8E767948_OFFSET UNITYSDK_OFFSET(0x1D1765C0)
#define RPG_GAMECORE_PROPCURVEMOVESTARTMODE_PINPONG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1765B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropCurveMoveStartMode_PinPong_TypeDefinitionIndex = 20769;
