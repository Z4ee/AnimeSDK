...
#define RPG_GAMECORE_PRELOADBATTLEPERFORM_METHOD_3_033CD7743D618B1E_OFFSET UNITYSDK_OFFSET(0x17511450)
#define RPG_GAMECORE_PRELOADBATTLEPERFORM_METHOD_3_CB4823B9DB4D46EF_OFFSET UNITYSDK_OFFSET(0x175113D0)
#define RPG_GAMECORE_PRELOADBATTLEPERFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x17511420)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PreloadBattlePerform_TypeDefinitionIndex = 21604;
