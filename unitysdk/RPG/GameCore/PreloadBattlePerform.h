...
#define RPG_GAMECORE_PRELOADBATTLEPERFORM_METHOD_3_033CD7743D618B1E_OFFSET UNITYSDK_OFFSET(0x18C60800)
#define RPG_GAMECORE_PRELOADBATTLEPERFORM_METHOD_3_CB4823B9DB4D46EF_OFFSET UNITYSDK_OFFSET(0x18C60780)
#define RPG_GAMECORE_PRELOADBATTLEPERFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x18C607D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PreloadBattlePerform_TypeDefinitionIndex = 22342;
