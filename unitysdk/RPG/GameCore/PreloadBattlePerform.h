...
#define RPG_GAMECORE_PRELOADBATTLEPERFORM_METHOD_3_033CD7743D618B1E_OFFSET UNITYSDK_OFFSET(0x1BA15710)
#define RPG_GAMECORE_PRELOADBATTLEPERFORM_METHOD_3_296B640AE6FF23DD_OFFSET UNITYSDK_OFFSET(0x1BA156D0)
#define RPG_GAMECORE_PRELOADBATTLEPERFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA15700)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PreloadBattlePerform_TypeDefinitionIndex = 22538;
