...
#define RPG_GAMECORE_CHIMERADUELWAITANIMATIONNORMALIZEDTIMENODE_METHOD_3_D62CD939A8D64A57_OFFSET UNITYSDK_OFFSET(0x1C249C50)
#define RPG_GAMECORE_CHIMERADUELWAITANIMATIONNORMALIZEDTIMENODE_METHOD_3_D7418CCD00891843_OFFSET UNITYSDK_OFFSET(0x1C249B70)
#define RPG_GAMECORE_CHIMERADUELWAITANIMATIONNORMALIZEDTIMENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C249C40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelWaitAnimationNormalizedTimeNode_TypeDefinitionIndex = 15338;
