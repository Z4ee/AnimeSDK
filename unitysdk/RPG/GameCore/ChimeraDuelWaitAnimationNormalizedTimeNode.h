...
#define RPG_GAMECORE_CHIMERADUELWAITANIMATIONNORMALIZEDTIMENODE_METHOD_3_D62CD939A8D64A57_OFFSET UNITYSDK_OFFSET(0x188074E0)
#define RPG_GAMECORE_CHIMERADUELWAITANIMATIONNORMALIZEDTIMENODE_METHOD_3_FA78EB09E178FA91_OFFSET UNITYSDK_OFFSET(0x18807340)
#define RPG_GAMECORE_CHIMERADUELWAITANIMATIONNORMALIZEDTIMENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x18807490)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelWaitAnimationNormalizedTimeNode_TypeDefinitionIndex = 15112;
