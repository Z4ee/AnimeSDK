...
#define RPG_GAMECORE_CHIMERADUELWAITANIMATIONNORMALIZEDTIMENODE_METHOD_3_D62CD939A8D64A57_OFFSET UNITYSDK_OFFSET(0x170A7F30)
#define RPG_GAMECORE_CHIMERADUELWAITANIMATIONNORMALIZEDTIMENODE_METHOD_3_FA78EB09E178FA91_OFFSET UNITYSDK_OFFSET(0x170A7D90)
#define RPG_GAMECORE_CHIMERADUELWAITANIMATIONNORMALIZEDTIMENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x170A7EE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelWaitAnimationNormalizedTimeNode_TypeDefinitionIndex = 14642;
