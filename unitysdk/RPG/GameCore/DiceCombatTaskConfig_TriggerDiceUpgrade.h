...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TRIGGERDICEUPGRADE_METHOD_3_19291C174F457812_OFFSET UNITYSDK_OFFSET(0x1C11AC00)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TRIGGERDICEUPGRADE_METHOD_3_797DE8ABA062A3AA_OFFSET UNITYSDK_OFFSET(0x1C11AC60)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TRIGGERDICEUPGRADE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C11AC50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_TriggerDiceUpgrade_TypeDefinitionIndex = 15448;
