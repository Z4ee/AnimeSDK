...
#define RPG_GAMECORE_ST_BYDISTTOGUARDPOSITION_METHOD_4_9EB71DE4AF08487D_OFFSET UNITYSDK_OFFSET(0x17692230)
#define RPG_GAMECORE_ST_BYDISTTOGUARDPOSITION_METHOD_4_A764A4E4EF7394AD_OFFSET UNITYSDK_OFFSET(0x17692300)
#define RPG_GAMECORE_ST_BYDISTTOGUARDPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x176922B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_ByDistToGuardPosition_TypeDefinitionIndex = 18345;
