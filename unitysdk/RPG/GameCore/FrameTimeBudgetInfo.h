...
#define RPG_GAMECORE_FRAMETIMEBUDGETINFO_METHOD_3_1B2F5A22944F090D_OFFSET UNITYSDK_OFFSET(0x18930DF0)
#define RPG_GAMECORE_FRAMETIMEBUDGETINFO_METHOD_3_BA967BAEBEBB1CB1_OFFSET UNITYSDK_OFFSET(0x18930E80)
#define RPG_GAMECORE_FRAMETIMEBUDGETINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18930E50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FrameTimeBudgetInfo_TypeDefinitionIndex = 15580;
