...
#define RPG_GAMECORE_SHOWTARGETHPBAR_METHOD_3_B384933BED98FE67_OFFSET UNITYSDK_OFFSET(0x1D531430)
#define RPG_GAMECORE_SHOWTARGETHPBAR_METHOD_3_C3C3AABF0CC8C6D0_OFFSET UNITYSDK_OFFSET(0x1D5313F0)
#define RPG_GAMECORE_SHOWTARGETHPBAR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D531420)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowTargetHPBar_TypeDefinitionIndex = 22679;
