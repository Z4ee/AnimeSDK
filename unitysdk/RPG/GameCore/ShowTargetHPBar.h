...
#define RPG_GAMECORE_SHOWTARGETHPBAR_METHOD_3_01CD460A9DF9E9C3_OFFSET UNITYSDK_OFFSET(0x17705290)
#define RPG_GAMECORE_SHOWTARGETHPBAR_METHOD_3_B384933BED98FE67_OFFSET UNITYSDK_OFFSET(0x17705310)
#define RPG_GAMECORE_SHOWTARGETHPBAR__CTOR_OFFSET UNITYSDK_OFFSET(0x177052E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowTargetHPBar_TypeDefinitionIndex = 21138;
