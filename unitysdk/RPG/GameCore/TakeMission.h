...
#define RPG_GAMECORE_TAKEMISSION_METHOD_3_45BF4B984AAA1822_OFFSET UNITYSDK_OFFSET(0x177A76B0)
#define RPG_GAMECORE_TAKEMISSION_METHOD_3_54E42041BF8B7D9B_OFFSET UNITYSDK_OFFSET(0x177A7730)
#define RPG_GAMECORE_TAKEMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x177A7700)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TakeMission_TypeDefinitionIndex = 18580;
