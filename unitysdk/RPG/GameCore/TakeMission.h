...
#define RPG_GAMECORE_TAKEMISSION_METHOD_3_45BF4B984AAA1822_OFFSET UNITYSDK_OFFSET(0x19CED440)
#define RPG_GAMECORE_TAKEMISSION_METHOD_3_54E42041BF8B7D9B_OFFSET UNITYSDK_OFFSET(0x19CED4C0)
#define RPG_GAMECORE_TAKEMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x19CED490)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TakeMission_TypeDefinitionIndex = 19156;
