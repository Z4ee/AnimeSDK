...
#define RPG_GAMECORE_CLEARTUTORIALGUIDE_METHOD_3_3D427BFBCDCD1FA3_OFFSET UNITYSDK_OFFSET(0x1C2551C0)
#define RPG_GAMECORE_CLEARTUTORIALGUIDE_METHOD_3_9189CEFCD6116D90_OFFSET UNITYSDK_OFFSET(0x1C255180)
#define RPG_GAMECORE_CLEARTUTORIALGUIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2551B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClearTutorialGuide_TypeDefinitionIndex = 23488;
