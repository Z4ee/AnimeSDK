...
#define RPG_GAMECORE_CLEARTUTORIALGUIDE_METHOD_3_3D427BFBCDCD1FA3_OFFSET UNITYSDK_OFFSET(0x19654820)
#define RPG_GAMECORE_CLEARTUTORIALGUIDE_METHOD_3_80014F6E1815099A_OFFSET UNITYSDK_OFFSET(0x196547A0)
#define RPG_GAMECORE_CLEARTUTORIALGUIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x196547F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClearTutorialGuide_TypeDefinitionIndex = 23021;
