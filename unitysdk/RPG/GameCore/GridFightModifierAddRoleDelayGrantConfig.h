...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDROLEDELAYGRANTCONFIG_METHOD_3_04E29B1E87E7D968_OFFSET UNITYSDK_OFFSET(0x1EE6C6F0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDROLEDELAYGRANTCONFIG_METHOD_3_7B8E94E9DF2C3EA4_OFFSET UNITYSDK_OFFSET(0x1EE6C740)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDROLEDELAYGRANTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EE6C730)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierAddRoleDelayGrantConfig_TypeDefinitionIndex = 19238;
