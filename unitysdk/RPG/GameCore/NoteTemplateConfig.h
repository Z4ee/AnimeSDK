...
#define RPG_GAMECORE_NOTETEMPLATECONFIG_METHOD_2_01D04ABCF38A68AC_OFFSET UNITYSDK_OFFSET(0x1CE90640)
#define RPG_GAMECORE_NOTETEMPLATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE90680)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NoteTemplateConfig_TypeDefinitionIndex = 16779;
