...
#define RPG_GAMECORE_CAMERALOOKATSCREENRANGECONFIG_METHOD_2_023088A00DFD821B_OFFSET UNITYSDK_OFFSET(0x1B709B50)
#define RPG_GAMECORE_CAMERALOOKATSCREENRANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B709CC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CameraLookAtScreenRangeConfig_TypeDefinitionIndex = 19723;
