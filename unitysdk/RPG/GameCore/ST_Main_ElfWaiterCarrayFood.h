...
#define RPG_GAMECORE_ST_MAIN_ELFWAITERCARRAYFOOD_METHOD_4_254E89D5FD12353E_OFFSET UNITYSDK_OFFSET(0x19C182A0)
#define RPG_GAMECORE_ST_MAIN_ELFWAITERCARRAYFOOD_METHOD_4_AE4795D0AC6DF161_OFFSET UNITYSDK_OFFSET(0x19C00EA0)
#define RPG_GAMECORE_ST_MAIN_ELFWAITERCARRAYFOOD__CTOR_OFFSET UNITYSDK_OFFSET(0x19C00E50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_ElfWaiterCarrayFood_TypeDefinitionIndex = 20323;
