...
#define RPG_GAMECORE_ST_MAIN_ELFWAITERCARRAYFOOD_METHOD_4_413AADC532B2A0E4_OFFSET UNITYSDK_OFFSET(0x1D4C9B40)
#define RPG_GAMECORE_ST_MAIN_ELFWAITERCARRAYFOOD_METHOD_4_AE4795D0AC6DF161_OFFSET UNITYSDK_OFFSET(0x1D4C9C10)
#define RPG_GAMECORE_ST_MAIN_ELFWAITERCARRAYFOOD__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4C9C00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_ElfWaiterCarrayFood_TypeDefinitionIndex = 21273;
