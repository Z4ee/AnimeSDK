...
#define RPG_GAMECORE_ST_MAIN_ELFWAITERCARRAYFOOD_METHOD_4_254E89D5FD12353E_OFFSET UNITYSDK_OFFSET(0x176970F0)
#define RPG_GAMECORE_ST_MAIN_ELFWAITERCARRAYFOOD_METHOD_4_AE4795D0AC6DF161_OFFSET UNITYSDK_OFFSET(0x17683EC0)
#define RPG_GAMECORE_ST_MAIN_ELFWAITERCARRAYFOOD__CTOR_OFFSET UNITYSDK_OFFSET(0x17683E70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_ElfWaiterCarrayFood_TypeDefinitionIndex = 19697;
