...
#define RPG_GAMECORE_CONVINCEMOVETURN_METHOD_3_9A972AE33E6794EF_OFFSET UNITYSDK_OFFSET(0x17137790)
#define RPG_GAMECORE_CONVINCEMOVETURN_METHOD_3_C834424611D0DA4E_OFFSET UNITYSDK_OFFSET(0x17137710)
#define RPG_GAMECORE_CONVINCEMOVETURN__CTOR_OFFSET UNITYSDK_OFFSET(0x17137760)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConvinceMoveTurn_TypeDefinitionIndex = 20006;
