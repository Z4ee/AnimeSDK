...
#define RPG_GAMECORE_TRIGGERSOUNDHIT_METHOD_3_0CAEA9428F666FBB_OFFSET UNITYSDK_OFFSET(0x178CEC70)
#define RPG_GAMECORE_TRIGGERSOUNDHIT_METHOD_3_CE635A75996DD1AF_OFFSET UNITYSDK_OFFSET(0x178CED80)
#define RPG_GAMECORE_TRIGGERSOUNDHIT__CTOR_OFFSET UNITYSDK_OFFSET(0x178CED50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerSoundHit_TypeDefinitionIndex = 20577;
