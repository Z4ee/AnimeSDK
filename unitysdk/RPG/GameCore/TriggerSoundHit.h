...
#define RPG_GAMECORE_TRIGGERSOUNDHIT_METHOD_3_5EA5F9F4FF5A3132_OFFSET UNITYSDK_OFFSET(0x1B0605D0)
#define RPG_GAMECORE_TRIGGERSOUNDHIT_METHOD_3_CE635A75996DD1AF_OFFSET UNITYSDK_OFFSET(0x1B0606A0)
#define RPG_GAMECORE_TRIGGERSOUNDHIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B060690)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerSoundHit_TypeDefinitionIndex = 21569;
