...
#define RPG_GAMECORE_SETROGUETOURNFLOORTYPE_METHOD_3_403B9485903D04C4_OFFSET UNITYSDK_OFFSET(0x19C5D5A0)
#define RPG_GAMECORE_SETROGUETOURNFLOORTYPE_METHOD_3_4EEE72772E67CC17_OFFSET UNITYSDK_OFFSET(0x19C5D620)
#define RPG_GAMECORE_SETROGUETOURNFLOORTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C5D5F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetRogueTournFloorType_TypeDefinitionIndex = 21856;
