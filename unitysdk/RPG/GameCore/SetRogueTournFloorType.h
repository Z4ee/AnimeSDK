...
#define RPG_GAMECORE_SETROGUETOURNFLOORTYPE_METHOD_3_4EEE72772E67CC17_OFFSET UNITYSDK_OFFSET(0x1E08C950)
#define RPG_GAMECORE_SETROGUETOURNFLOORTYPE_METHOD_3_F669A8C8A73EBA44_OFFSET UNITYSDK_OFFSET(0x1E08C910)
#define RPG_GAMECORE_SETROGUETOURNFLOORTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E08C940)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetRogueTournFloorType_TypeDefinitionIndex = 22852;
