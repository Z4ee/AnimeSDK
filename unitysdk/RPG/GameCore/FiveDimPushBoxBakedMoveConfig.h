...
#define RPG_GAMECORE_FIVEDIMPUSHBOXBAKEDMOVECONFIG_METHOD_3_3D834FEFF335FA90_OFFSET UNITYSDK_OFFSET(0x172061A0)
#define RPG_GAMECORE_FIVEDIMPUSHBOXBAKEDMOVECONFIG_METHOD_3_590BB2C4FDEFF821_OFFSET UNITYSDK_OFFSET(0x172042A0)
#define RPG_GAMECORE_FIVEDIMPUSHBOXBAKEDMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17204290)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimPushBoxBakedMoveConfig_TypeDefinitionIndex = 15282;
