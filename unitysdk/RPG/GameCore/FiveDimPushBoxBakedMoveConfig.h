...
#define RPG_GAMECORE_FIVEDIMPUSHBOXBAKEDMOVECONFIG_METHOD_3_3D834FEFF335FA90_OFFSET UNITYSDK_OFFSET(0x189177E0)
#define RPG_GAMECORE_FIVEDIMPUSHBOXBAKEDMOVECONFIG_METHOD_3_590BB2C4FDEFF821_OFFSET UNITYSDK_OFFSET(0x189153B0)
#define RPG_GAMECORE_FIVEDIMPUSHBOXBAKEDMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189153A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimPushBoxBakedMoveConfig_TypeDefinitionIndex = 15796;
