...
#define RPG_GAMECORE_FIVEDIMPUSHBOXBAKEDMOVECONFIG_METHOD_3_3D834FEFF335FA90_OFFSET UNITYSDK_OFFSET(0x19750F50)
#define RPG_GAMECORE_FIVEDIMPUSHBOXBAKEDMOVECONFIG_METHOD_3_590BB2C4FDEFF821_OFFSET UNITYSDK_OFFSET(0x1974EAF0)
#define RPG_GAMECORE_FIVEDIMPUSHBOXBAKEDMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1974EAE0)
