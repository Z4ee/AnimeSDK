...
#define RPG_GAMECORE_GRIDFIGHTROLECONDITIONCONFIG_METHOD_2_D9C5FC841D5742C5_OFFSET UNITYSDK_OFFSET(0x189D25B0)
#define RPG_GAMECORE_GRIDFIGHTROLECONDITIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189D25F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightRoleConditionConfig_TypeDefinitionIndex = 18408;
