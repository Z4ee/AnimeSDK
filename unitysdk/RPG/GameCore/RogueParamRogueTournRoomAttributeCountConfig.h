...
#define RPG_GAMECORE_ROGUEPARAMROGUETOURNROOMATTRIBUTECOUNTCONFIG_METHOD_6_51EA20409CEED4C5_OFFSET UNITYSDK_OFFSET(0x19BB39C0)
#define RPG_GAMECORE_ROGUEPARAMROGUETOURNROOMATTRIBUTECOUNTCONFIG_METHOD_6_C75AEDB031F3856B_OFFSET UNITYSDK_OFFSET(0x19BB3C70)
#define RPG_GAMECORE_ROGUEPARAMROGUETOURNROOMATTRIBUTECOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19BB3B40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamRogueTournRoomAttributeCountConfig_TypeDefinitionIndex = 18807;
