...
#define RPG_GAMECORE_FAKESKILLCONFIG_METHOD_2_3DB4ED63E50BBF66_OFFSET UNITYSDK_OFFSET(0x1D7E26A0)
#define RPG_GAMECORE_FAKESKILLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7E2800)
