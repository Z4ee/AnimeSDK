...
#define RPG_GAMECORE_SPACEZOOMUTATIONMATERIALROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B0993B0)
#define RPG_GAMECORE_SPACEZOOMUTATIONMATERIALROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B099A60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SpaceZooMutationMaterialRow_TypeDefinitionIndex = 11891;
	...
	public:
		...
		::System::UInt32 ExchangeCost; // 0x2C
