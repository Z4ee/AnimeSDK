...
#define RPG_GAMECORE_SPACEZOOMUTATIONMATERIALROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D0AC340)
#define RPG_GAMECORE_SPACEZOOMUTATIONMATERIALROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0AC9F0)
