...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTEROPENSHOPCONFIG_METHOD_3_06A929FBBEC362DE_OFFSET UNITYSDK_OFFSET(0x197F1CA0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTEROPENSHOPCONFIG_METHOD_3_6B3BDDCE11ACA7D7_OFFSET UNITYSDK_OFFSET(0x197EC1F0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTEROPENSHOPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197EC1A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierExecActionAfterOpenShopConfig_TypeDefinitionIndex = 18421;
