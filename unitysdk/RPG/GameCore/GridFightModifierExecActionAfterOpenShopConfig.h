...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTEROPENSHOPCONFIG_METHOD_3_06A929FBBEC362DE_OFFSET UNITYSDK_OFFSET(0x189BC000)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTEROPENSHOPCONFIG_METHOD_3_6B3BDDCE11ACA7D7_OFFSET UNITYSDK_OFFSET(0x189BC0D0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTEROPENSHOPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189BC080)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierExecActionAfterOpenShopConfig_TypeDefinitionIndex = 18449;
