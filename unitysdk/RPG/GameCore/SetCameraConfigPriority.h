...
#define RPG_GAMECORE_SETCAMERACONFIGPRIORITY_METHOD_3_1B8C2CF37F7BCCA1_OFFSET UNITYSDK_OFFSET(0x19C2DA40)
#define RPG_GAMECORE_SETCAMERACONFIGPRIORITY_METHOD_3_4071100F3B5A7718_OFFSET UNITYSDK_OFFSET(0x19C2D9C0)
#define RPG_GAMECORE_SETCAMERACONFIGPRIORITY__CTOR_OFFSET UNITYSDK_OFFSET(0x19C2DA10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetCameraConfigPriority_TypeDefinitionIndex = 21168;
