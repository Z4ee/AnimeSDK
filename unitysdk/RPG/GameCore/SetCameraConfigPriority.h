...
#define RPG_GAMECORE_SETCAMERACONFIGPRIORITY_METHOD_3_1B8C2CF37F7BCCA1_OFFSET UNITYSDK_OFFSET(0x1C2D6C60)
#define RPG_GAMECORE_SETCAMERACONFIGPRIORITY_METHOD_3_5E76E8128B3C6E62_OFFSET UNITYSDK_OFFSET(0x1C2D6C20)
#define RPG_GAMECORE_SETCAMERACONFIGPRIORITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2D6C50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetCameraConfigPriority_TypeDefinitionIndex = 21583;
