...
#define RPG_GAMECORE_BASECHENLINGBATTLETARGETEVALUATOR_METHOD_2_7B5539A683631E0E_OFFSET UNITYSDK_OFFSET(0x194BBE80)
#define RPG_GAMECORE_BASECHENLINGBATTLETARGETEVALUATOR_METHOD_2_A2E2AEE1E7FE990A_OFFSET UNITYSDK_OFFSET(0x194BB7B0)
#define RPG_GAMECORE_BASECHENLINGBATTLETARGETEVALUATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x194BBEE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BaseChenLingBattleTargetEvaluator_TypeDefinitionIndex = 14985;
