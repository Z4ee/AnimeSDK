...
#define RPG_GAMECORE_FIVEDIMPROPSPAWNERCONFIG_METHOD_3_20CFBFD9D1FCFFCE_OFFSET UNITYSDK_OFFSET(0x1D0FBFF0)
#define RPG_GAMECORE_FIVEDIMPROPSPAWNERCONFIG_METHOD_3_9AA320A21C18C300_OFFSET UNITYSDK_OFFSET(0x1D0FBFA0)
#define RPG_GAMECORE_FIVEDIMPROPSPAWNERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0FBFE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimPropSpawnerConfig_TypeDefinitionIndex = 18376;
