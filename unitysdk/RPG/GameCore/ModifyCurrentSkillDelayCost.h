...
#define RPG_GAMECORE_MODIFYCURRENTSKILLDELAYCOST_METHOD_3_00F9537B5A3E3C65_OFFSET UNITYSDK_OFFSET(0x1D2AF690)
#define RPG_GAMECORE_MODIFYCURRENTSKILLDELAYCOST_METHOD_3_A1BA1BAAA49EDD00_OFFSET UNITYSDK_OFFSET(0x1D2AF640)
#define RPG_GAMECORE_MODIFYCURRENTSKILLDELAYCOST__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2AF680)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyCurrentSkillDelayCost_TypeDefinitionIndex = 22449;
