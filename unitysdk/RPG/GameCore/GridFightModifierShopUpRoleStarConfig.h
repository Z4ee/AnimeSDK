...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSHOPUPROLESTARCONFIG_METHOD_3_7AE0EECA587A9033_OFFSET UNITYSDK_OFFSET(0x189BFD80)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSHOPUPROLESTARCONFIG_METHOD_3_90B2B82B8E60E07A_OFFSET UNITYSDK_OFFSET(0x189BFCB0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSHOPUPROLESTARCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189BFD30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierShopUpRoleStarConfig_TypeDefinitionIndex = 18379;
