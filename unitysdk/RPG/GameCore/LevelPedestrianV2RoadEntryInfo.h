...
#define RPG_GAMECORE_LEVELPEDESTRIANV2ROADENTRYINFO_METHOD_2_662403E26E324806_OFFSET UNITYSDK_OFFSET(0x19883580)
#define RPG_GAMECORE_LEVELPEDESTRIANV2ROADENTRYINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19885A50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPedestrianV2RoadEntryInfo_TypeDefinitionIndex = 16443;
