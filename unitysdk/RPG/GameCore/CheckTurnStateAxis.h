...
#define RPG_GAMECORE_CHECKTURNSTATEAXIS_METHOD_3_DD60ED7B49BA3A19_OFFSET UNITYSDK_OFFSET(0x1B72F430)
#define RPG_GAMECORE_CHECKTURNSTATEAXIS_METHOD_3_F155B90BFF3C189E_OFFSET UNITYSDK_OFFSET(0x1B72F3F0)
#define RPG_GAMECORE_CHECKTURNSTATEAXIS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B72F420)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CheckTurnStateAxis_TypeDefinitionIndex = 14901;
