...
#define RPG_GAMECORE_ITEMMULTIMATERIALCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D22F1D0)
#define RPG_GAMECORE_ITEMMULTIMATERIALCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D22F3A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ItemMultiMaterialConfigRow_TypeDefinitionIndex = 13783;
