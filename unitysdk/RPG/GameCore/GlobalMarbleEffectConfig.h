...
#define RPG_GAMECORE_GLOBALMARBLEEFFECTCONFIG_METHOD_2_6579046AEBCF03E0_OFFSET UNITYSDK_OFFSET(0x1D93FFE0)
#define RPG_GAMECORE_GLOBALMARBLEEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D95A9F0)
