...
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_MAX_METHOD_3_692055759198A1AD_OFFSET UNITYSDK_OFFSET(0x196A6DA0)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_MAX_METHOD_3_D49E4D86F13523C8_OFFSET UNITYSDK_OFFSET(0x196A6030)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_MAX__CTOR_OFFSET UNITYSDK_OFFSET(0x196A6020)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatDiceSelectorConfig_Max_TypeDefinitionIndex = 15374;
