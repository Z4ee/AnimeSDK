...
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_MAX_METHOD_3_692055759198A1AD_OFFSET UNITYSDK_OFFSET(0x1D823520)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_MAX_METHOD_3_D49E4D86F13523C8_OFFSET UNITYSDK_OFFSET(0x1D8227B0)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_MAX__CTOR_OFFSET UNITYSDK_OFFSET(0x1D8227A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatDiceSelectorConfig_Max_TypeDefinitionIndex = 15975;
