...
#define RPG_GAMECORE_BYCHECKTARGETHPCANBEDAMAGE_METHOD_4_2FB1603012135530_OFFSET UNITYSDK_OFFSET(0x1C303C80)
#define RPG_GAMECORE_BYCHECKTARGETHPCANBEDAMAGE_METHOD_4_360F666A1C30833E_OFFSET UNITYSDK_OFFSET(0x1C303CB0)
#define RPG_GAMECORE_BYCHECKTARGETHPCANBEDAMAGE_METHOD_4_86EE155B54369995_OFFSET UNITYSDK_OFFSET(0x1C303AC0)
#define RPG_GAMECORE_BYCHECKTARGETHPCANBEDAMAGE_METHOD_4_B84F5605182D9B00_OFFSET UNITYSDK_OFFSET(0x1C303B00)
#define RPG_GAMECORE_BYCHECKTARGETHPCANBEDAMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C303AF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckTargetHPCanBeDamage_TypeDefinitionIndex = 22298;
