...
#define RPG_GAMECORE_BYCHECKTARGETHPCANBEDAMAGE_METHOD_4_789420D03FADE8FE_OFFSET UNITYSDK_OFFSET(0x18725000)
#define RPG_GAMECORE_BYCHECKTARGETHPCANBEDAMAGE_METHOD_4_B84F5605182D9B00_OFFSET UNITYSDK_OFFSET(0x187250D0)
#define RPG_GAMECORE_BYCHECKTARGETHPCANBEDAMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x18725080)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckTargetHPCanBeDamage_TypeDefinitionIndex = 21432;
