...
#define RPG_GAMECORE_GRIDFIGHTSEASONPORTALCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x189D5F10)
#define RPG_GAMECORE_GRIDFIGHTSEASONPORTALCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x189D6090)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightSeasonPortalConfigRow_TypeDefinitionIndex = 12902;
