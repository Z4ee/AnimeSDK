...
#define RPG_GAMECORE_GRIDFIGHTSEASONPORTALCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D165DC0)
#define RPG_GAMECORE_GRIDFIGHTSEASONPORTALCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D165EB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightSeasonPortalConfigRow_TypeDefinitionIndex = 13526;
