...
#define RPG_GAMECORE_GRIDFIGHTSEASONPORTALCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D3B8210)
#define RPG_GAMECORE_GRIDFIGHTSEASONPORTALCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3B8300)
