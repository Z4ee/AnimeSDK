...
#define RPG_GAMECORE_BYLOCALPLAYERAVATARID_METHOD_4_D4D462E98413987F_OFFSET UNITYSDK_OFFSET(0x17036190)
#define RPG_GAMECORE_BYLOCALPLAYERAVATARID_METHOD_4_DBD854D42A0F45A1_OFFSET UNITYSDK_OFFSET(0x170360C0)
#define RPG_GAMECORE_BYLOCALPLAYERAVATARID__CTOR_OFFSET UNITYSDK_OFFSET(0x17036140)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByLocalPlayerAvatarID_TypeDefinitionIndex = 18895;
