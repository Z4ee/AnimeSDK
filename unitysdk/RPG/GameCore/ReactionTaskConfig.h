...
#define RPG_GAMECORE_REACTIONTASKCONFIG_METHOD_3_B6305489B169F566_OFFSET UNITYSDK_OFFSET(0x19AB2710)
#define RPG_GAMECORE_REACTIONTASKCONFIG_METHOD_3_C525E618F88C7463_OFFSET UNITYSDK_OFFSET(0x19AB29B0)
#define RPG_GAMECORE_REACTIONTASKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AA82F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ReactionTaskConfig_TypeDefinitionIndex = 18916;
