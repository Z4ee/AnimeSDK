...
#define RPG_GAMECORE_CONDRANDOMSUCCCONFIG_METHOD_4_63F02B9B97E84361_OFFSET UNITYSDK_OFFSET(0x1712B1C0)
#define RPG_GAMECORE_CONDRANDOMSUCCCONFIG_METHOD_4_71265C2E80D80C54_OFFSET UNITYSDK_OFFSET(0x1712B080)
#define RPG_GAMECORE_CONDRANDOMSUCCCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1712B140)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CondRandomSuccConfig_TypeDefinitionIndex = 15645;
