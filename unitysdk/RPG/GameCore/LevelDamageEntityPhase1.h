...
#define RPG_GAMECORE_LEVELDAMAGEENTITYPHASE1_CLEAR_OFFSET UNITYSDK_OFFSET(0x1BDF37A0)
#define RPG_GAMECORE_LEVELDAMAGEENTITYPHASE1_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1BDF3840)
#define RPG_GAMECORE_LEVELDAMAGEENTITYPHASE1_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x1BDF37F0)
#define RPG_GAMECORE_LEVELDAMAGEENTITYPHASE1_GET_ABILITYID_OFFSET UNITYSDK_OFFSET(0x1BDF38D0)
#define RPG_GAMECORE_LEVELDAMAGEENTITYPHASE1_GET_ATTACKDATAREF_OFFSET UNITYSDK_OFFSET(0x1BDF38B0)
#define RPG_GAMECORE_LEVELDAMAGEENTITYPHASE1_GET_ATTACKERENTITYREF_OFFSET UNITYSDK_OFFSET(0x1BDF38F0)
#define RPG_GAMECORE_LEVELDAMAGEENTITYPHASE1_GET_CUSTOMNAME_OFFSET UNITYSDK_OFFSET(0x1BDF3990)
#define RPG_GAMECORE_LEVELDAMAGEENTITYPHASE1_GET_DAMAGEDATAREF_OFFSET UNITYSDK_OFFSET(0x1BDF3890)
#define RPG_GAMECORE_LEVELDAMAGEENTITYPHASE1_GET_DEFENDERENTITYREF_OFFSET UNITYSDK_OFFSET(0x1BDF3910)
#define RPG_GAMECORE_LEVELDAMAGEENTITYPHASE1_GET_HPCHANGE_OFFSET UNITYSDK_OFFSET(0x1BDF3970)
#define RPG_GAMECORE_LEVELDAMAGEENTITYPHASE1_GET_STANCEDAMAGE_OFFSET UNITYSDK_OFFSET(0x1BDF3930)
#define RPG_GAMECORE_LEVELDAMAGEENTITYPHASE1_GET_STANCEELEMENTRATIO_OFFSET UNITYSDK_OFFSET(0x1BDF3950)
#define RPG_GAMECORE_LEVELDAMAGEENTITYPHASE1_INIT_OFFSET UNITYSDK_OFFSET(0x1BDF36B0)
#define RPG_GAMECORE_LEVELDAMAGEENTITYPHASE1_SET_ABILITYID_OFFSET UNITYSDK_OFFSET(0x1BDF38E0)
#define RPG_GAMECORE_LEVELDAMAGEENTITYPHASE1_SET_ATTACKDATAREF_OFFSET UNITYSDK_OFFSET(0x1BDF38C0)
#define RPG_GAMECORE_LEVELDAMAGEENTITYPHASE1_SET_ATTACKERENTITYREF_OFFSET UNITYSDK_OFFSET(0x1BDF3900)
#define RPG_GAMECORE_LEVELDAMAGEENTITYPHASE1_SET_CUSTOMNAME_OFFSET UNITYSDK_OFFSET(0x1BDF39A0)
#define RPG_GAMECORE_LEVELDAMAGEENTITYPHASE1_SET_DAMAGEDATAREF_OFFSET UNITYSDK_OFFSET(0x1BDF38A0)
#define RPG_GAMECORE_LEVELDAMAGEENTITYPHASE1_SET_DEFENDERENTITYREF_OFFSET UNITYSDK_OFFSET(0x1BDF3920)
#define RPG_GAMECORE_LEVELDAMAGEENTITYPHASE1_SET_HPCHANGE_OFFSET UNITYSDK_OFFSET(0x1BDF3980)
#define RPG_GAMECORE_LEVELDAMAGEENTITYPHASE1_SET_STANCEDAMAGE_OFFSET UNITYSDK_OFFSET(0x1BDF3940)
#define RPG_GAMECORE_LEVELDAMAGEENTITYPHASE1_SET_STANCEELEMENTRATIO_OFFSET UNITYSDK_OFFSET(0x1BDF3960)
#define RPG_GAMECORE_LEVELDAMAGEENTITYPHASE1__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDF39B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelDamageEntityPhase1_TypeDefinitionIndex = 54196;

	class LevelDamageEntityPhase1 : public ::Class_1_BF7A075734D15E98
	{
	public:
		::RPG::GameCore::AttackData* _AttackDataRef_k__BackingField; // 0x18
		::Class_1_843DD6330B22E422* _DamageDataRef_k__BackingField; // 0x20
		::RPG::GameCore::GameEntity* _DefenderEntityRef_k__BackingField; // 0x28
		::RPG::GameCore::GameEntity* _AttackerEntityRef_k__BackingField; // 0x30
		::System::String* _CustomName_k__BackingField; // 0x38
		::System::String* _AbilityID_k__BackingField; // 0x40
