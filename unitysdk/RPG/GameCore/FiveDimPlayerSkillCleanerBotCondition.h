...
#define RPG_GAMECORE_FIVEDIMPLAYERSKILLCLEANERBOTCONDITION_METHOD_3_7904A568EC1D763F_OFFSET UNITYSDK_OFFSET(0x1974D560)
#define RPG_GAMECORE_FIVEDIMPLAYERSKILLCLEANERBOTCONDITION_METHOD_3_E1B216BBC976230E_OFFSET UNITYSDK_OFFSET(0x19733E60)
#define RPG_GAMECORE_FIVEDIMPLAYERSKILLCLEANERBOTCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x19733E50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimPlayerSkillCleanerBotCondition_TypeDefinitionIndex = 17887;
