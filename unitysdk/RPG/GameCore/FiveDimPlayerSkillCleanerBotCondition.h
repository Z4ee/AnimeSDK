...
#define RPG_GAMECORE_FIVEDIMPLAYERSKILLCLEANERBOTCONDITION_METHOD_3_7904A568EC1D763F_OFFSET UNITYSDK_OFFSET(0x1BEA9BA0)
#define RPG_GAMECORE_FIVEDIMPLAYERSKILLCLEANERBOTCONDITION_METHOD_3_E1B216BBC976230E_OFFSET UNITYSDK_OFFSET(0x1BEA9C20)
#define RPG_GAMECORE_FIVEDIMPLAYERSKILLCLEANERBOTCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEA9C10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimPlayerSkillCleanerBotCondition_TypeDefinitionIndex = 18065;
