...
#define RPG_GAMECORE_TRAVELSHIPFOLLOWTO_METHOD_3_502906B09F9ED8E6_OFFSET UNITYSDK_OFFSET(0x190B5500)
#define RPG_GAMECORE_TRAVELSHIPFOLLOWTO_METHOD_3_F83F6CB03439866C_OFFSET UNITYSDK_OFFSET(0x190B55D0)
#define RPG_GAMECORE_TRAVELSHIPFOLLOWTO__CTOR_OFFSET UNITYSDK_OFFSET(0x190B5580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TravelShipFollowTo_TypeDefinitionIndex = 19962;
