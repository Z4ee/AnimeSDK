...
#define RPG_GAMECORE_TRAVELSHIPFOLLOWTO_METHOD_3_502906B09F9ED8E6_OFFSET UNITYSDK_OFFSET(0x19E00320)
#define RPG_GAMECORE_TRAVELSHIPFOLLOWTO_METHOD_3_F83F6CB03439866C_OFFSET UNITYSDK_OFFSET(0x19E003F0)
#define RPG_GAMECORE_TRAVELSHIPFOLLOWTO__CTOR_OFFSET UNITYSDK_OFFSET(0x19E003A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TravelShipFollowTo_TypeDefinitionIndex = 19825;
