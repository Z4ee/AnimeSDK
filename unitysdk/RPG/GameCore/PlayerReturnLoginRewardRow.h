...
#define RPG_GAMECORE_PLAYERRETURNLOGINREWARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D7B0DD0)
#define RPG_GAMECORE_PLAYERRETURNLOGINREWARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7B0F60)
