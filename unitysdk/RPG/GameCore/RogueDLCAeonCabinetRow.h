...
#define RPG_GAMECORE_ROGUEDLCAEONCABINETROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18CFE390)
#define RPG_GAMECORE_ROGUEDLCAEONCABINETROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18CFE840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueDLCAeonCabinetRow_TypeDefinitionIndex = 13954;

	class RogueDLCAeonCabinetRow : public ::System::Object
	{
	public:
		::Il2CppArray<::System::UInt32>* DescParam; // 0x10
		...
		::RPG::GameCore::ChessRogueCabinetType CabinetType; // 0x3C
		::RPG::Client::TextID CabinetDesc; // 0x40
		::RPG::Client::TextID CabinetMissionDesc; // 0x50
		::RPG::Client::TextID CabinetName; // 0x60
