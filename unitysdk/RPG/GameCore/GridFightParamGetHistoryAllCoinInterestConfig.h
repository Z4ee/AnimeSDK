...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETHISTORYALLCOININTERESTCONFIG_METHOD_6_2AD68DA3E5CB6119_OFFSET UNITYSDK_OFFSET(0x172704F0)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETHISTORYALLCOININTERESTCONFIG_METHOD_6_AA46681BEB923BDF_OFFSET UNITYSDK_OFFSET(0x172707A0)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETHISTORYALLCOININTERESTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17270670)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightParamGetHistoryAllCoinInterestConfig_TypeDefinitionIndex = 17909;
