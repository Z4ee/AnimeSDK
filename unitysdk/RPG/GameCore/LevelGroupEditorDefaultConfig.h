...
#define RPG_GAMECORE_LEVELGROUPEDITORDEFAULTCONFIG_METHOD_2_6EC6118AEB4C46CF_OFFSET UNITYSDK_OFFSET(0x1C116F50)
#define RPG_GAMECORE_LEVELGROUPEDITORDEFAULTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C116F90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelGroupEditorDefaultConfig_TypeDefinitionIndex = 17218;
