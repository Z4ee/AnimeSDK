...
#define RPG_GAMECORE_LEVELGROUPEDITORDEFAULTCONFIG_METHOD_2_6EC6118AEB4C46CF_OFFSET UNITYSDK_OFFSET(0x1B036CB0)
#define RPG_GAMECORE_LEVELGROUPEDITORDEFAULTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B036CF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelGroupEditorDefaultConfig_TypeDefinitionIndex = 16716;
