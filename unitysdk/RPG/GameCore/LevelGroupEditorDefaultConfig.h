...
#define RPG_GAMECORE_LEVELGROUPEDITORDEFAULTCONFIG_METHOD_2_6EC6118AEB4C46CF_OFFSET UNITYSDK_OFFSET(0x19876BE0)
#define RPG_GAMECORE_LEVELGROUPEDITORDEFAULTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19876C20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelGroupEditorDefaultConfig_TypeDefinitionIndex = 16554;
