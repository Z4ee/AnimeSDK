...
#define RPG_GAMECORE_LEVELGROUPEDITORDEFAULTCONFIG_METHOD_2_6EC6118AEB4C46CF_OFFSET UNITYSDK_OFFSET(0x17338410)
#define RPG_GAMECORE_LEVELGROUPEDITORDEFAULTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17338450)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelGroupEditorDefaultConfig_TypeDefinitionIndex = 15994;
