...
#define RPG_GAMECORE_FATEACTADDEXTRABUFFSLOTNUMCONFIG_METHOD_6_0637346EB184E9CA_OFFSET UNITYSDK_OFFSET(0x188CDC90)
#define RPG_GAMECORE_FATEACTADDEXTRABUFFSLOTNUMCONFIG_METHOD_6_4E8DFD667E5F2921_OFFSET UNITYSDK_OFFSET(0x188CDB20)
#define RPG_GAMECORE_FATEACTADDEXTRABUFFSLOTNUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x188CDBF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateActAddExtraBuffSlotNumConfig_TypeDefinitionIndex = 18278;
