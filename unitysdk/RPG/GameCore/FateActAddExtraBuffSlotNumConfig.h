...
#define RPG_GAMECORE_FATEACTADDEXTRABUFFSLOTNUMCONFIG_METHOD_6_0637346EB184E9CA_OFFSET UNITYSDK_OFFSET(0x171C04C0)
#define RPG_GAMECORE_FATEACTADDEXTRABUFFSLOTNUMCONFIG_METHOD_6_4E8DFD667E5F2921_OFFSET UNITYSDK_OFFSET(0x171C0350)
#define RPG_GAMECORE_FATEACTADDEXTRABUFFSLOTNUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171C0420)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateActAddExtraBuffSlotNumConfig_TypeDefinitionIndex = 17665;
