...
#define RPG_GAMECORE_BASELITTLEGAMEABILITYVALUEGETTERCONFIG_METHOD_2_214B4ACB3746C180_OFFSET UNITYSDK_OFFSET(0x1B2EEA70)
#define RPG_GAMECORE_BASELITTLEGAMEABILITYVALUEGETTERCONFIG_METHOD_2_B66DFCD117707735_OFFSET UNITYSDK_OFFSET(0x1B2EE5C0)
#define RPG_GAMECORE_BASELITTLEGAMEABILITYVALUEGETTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2EEAD0)
