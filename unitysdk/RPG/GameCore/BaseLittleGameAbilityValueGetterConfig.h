...
#define RPG_GAMECORE_BASELITTLEGAMEABILITYVALUEGETTERCONFIG_METHOD_2_214B4ACB3746C180_OFFSET UNITYSDK_OFFSET(0x1CE68B00)
#define RPG_GAMECORE_BASELITTLEGAMEABILITYVALUEGETTERCONFIG_METHOD_2_B66DFCD117707735_OFFSET UNITYSDK_OFFSET(0x1CE68650)
#define RPG_GAMECORE_BASELITTLEGAMEABILITYVALUEGETTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE68B60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BaseLittleGameAbilityValueGetterConfig_TypeDefinitionIndex = 21137;
