...
#define RPG_GAMECORE_SHOWSDFTEXT_METHOD_3_1608696199732EF0_OFFSET UNITYSDK_OFFSET(0x17702D80)
#define RPG_GAMECORE_SHOWSDFTEXT_METHOD_3_469CF65C7F3DB525_OFFSET UNITYSDK_OFFSET(0x17702C50)
#define RPG_GAMECORE_SHOWSDFTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x17702D00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowSDFText_TypeDefinitionIndex = 19239;
