...
#define RPG_GAMECORE_SHOWSDFTEXT_METHOD_3_1608696199732EF0_OFFSET UNITYSDK_OFFSET(0x1BE46580)
#define RPG_GAMECORE_SHOWSDFTEXT_METHOD_3_74B43B20CC77AA5C_OFFSET UNITYSDK_OFFSET(0x1BE46440)
#define RPG_GAMECORE_SHOWSDFTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE464F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowSDFText_TypeDefinitionIndex = 20124;
