...
#define RPG_GAMECORE_ROGUEACTGETROGUEBUFFCONFIG_METHOD_6_C781D89B0997505A_OFFSET UNITYSDK_OFFSET(0x19AE70A0)
#define RPG_GAMECORE_ROGUEACTGETROGUEBUFFCONFIG_METHOD_6_FCD3053D93366AFF_OFFSET UNITYSDK_OFFSET(0x19AE72C0)
#define RPG_GAMECORE_ROGUEACTGETROGUEBUFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AE71E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActGetRogueBuffConfig_TypeDefinitionIndex = 18556;
