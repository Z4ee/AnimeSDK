...
#define RPG_GAMECORE_ROGUEACTGETROGUEBUFFCONFIG_METHOD_6_E3963BE7245B367B_OFFSET UNITYSDK_OFFSET(0x1D02E160)
#define RPG_GAMECORE_ROGUEACTGETROGUEBUFFCONFIG_METHOD_6_FCD3053D93366AFF_OFFSET UNITYSDK_OFFSET(0x1D02E1B0)
#define RPG_GAMECORE_ROGUEACTGETROGUEBUFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D02E1A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActGetRogueBuffConfig_TypeDefinitionIndex = 18832;
