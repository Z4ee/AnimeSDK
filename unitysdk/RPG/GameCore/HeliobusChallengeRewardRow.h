...
#define RPG_GAMECORE_HELIOBUSCHALLENGEREWARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B678950)
#define RPG_GAMECORE_HELIOBUSCHALLENGEREWARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B679030)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HeliobusChallengeRewardRow_TypeDefinitionIndex = 13271;
	...
	public:
		...
		::System::UInt32 ChallengeRewardTabID; // 0x28
		::System::UInt32 ChallengePhaseID; // 0x2C
