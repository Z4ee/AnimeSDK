...
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUECHESTGROUPLISTONENTERREPEATEDROOMCONFIG_METHOD_3_A628091787011405_OFFSET UNITYSDK_OFFSET(0x18D45090)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUECHESTGROUPLISTONENTERREPEATEDROOMCONFIG_METHOD_3_D5C1FF1991EF876C_OFFSET UNITYSDK_OFFSET(0x18D44FC0)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUECHESTGROUPLISTONENTERREPEATEDROOMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D45040)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierReplaceContentRogueChestGroupListOnEnterRepeatedRoomConfig_TypeDefinitionIndex = 16870;
