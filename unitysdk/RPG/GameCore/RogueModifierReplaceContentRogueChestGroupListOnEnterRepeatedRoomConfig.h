...
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUECHESTGROUPLISTONENTERREPEATEDROOMCONFIG_METHOD_3_80B3E66E3AAA62A1_OFFSET UNITYSDK_OFFSET(0x1D165800)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUECHESTGROUPLISTONENTERREPEATEDROOMCONFIG_METHOD_3_A628091787011405_OFFSET UNITYSDK_OFFSET(0x1D165850)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUECHESTGROUPLISTONENTERREPEATEDROOMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D165840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierReplaceContentRogueChestGroupListOnEnterRepeatedRoomConfig_TypeDefinitionIndex = 17047;
