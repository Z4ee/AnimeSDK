...
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUECHESTGROUPLISTONENTERREPEATEDROOMCONFIG_METHOD_3_A628091787011405_OFFSET UNITYSDK_OFFSET(0x19B9B070)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUECHESTGROUPLISTONENTERREPEATEDROOMCONFIG_METHOD_3_D5C1FF1991EF876C_OFFSET UNITYSDK_OFFSET(0x19B9AFA0)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUECHESTGROUPLISTONENTERREPEATEDROOMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B9B020)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierReplaceContentRogueChestGroupListOnEnterRepeatedRoomConfig_TypeDefinitionIndex = 16885;
