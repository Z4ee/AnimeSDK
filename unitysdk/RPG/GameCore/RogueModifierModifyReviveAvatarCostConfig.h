...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYREVIVEAVATARCOSTCONFIG_METHOD_3_818EECFB8A2F4AED_OFFSET UNITYSDK_OFFSET(0x1D3FA860)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYREVIVEAVATARCOSTCONFIG_METHOD_3_B28282651C7BF251_OFFSET UNITYSDK_OFFSET(0x1D3FA8B0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYREVIVEAVATARCOSTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3FA8A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyReviveAvatarCostConfig_TypeDefinitionIndex = 17750;
