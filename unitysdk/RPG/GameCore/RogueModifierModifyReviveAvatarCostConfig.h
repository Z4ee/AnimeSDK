...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYREVIVEAVATARCOSTCONFIG_METHOD_3_1C93C4A9617BE3B8_OFFSET UNITYSDK_OFFSET(0x18D42320)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYREVIVEAVATARCOSTCONFIG_METHOD_3_B28282651C7BF251_OFFSET UNITYSDK_OFFSET(0x18D423F0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYREVIVEAVATARCOSTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D423A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyReviveAvatarCostConfig_TypeDefinitionIndex = 17059;
