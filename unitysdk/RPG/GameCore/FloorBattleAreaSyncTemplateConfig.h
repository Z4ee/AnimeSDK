...
#define RPG_GAMECORE_FLOORBATTLEAREASYNCTEMPLATECONFIG_METHOD_2_FB9351093B15A38A_OFFSET UNITYSDK_OFFSET(0x17213E60)
#define RPG_GAMECORE_FLOORBATTLEAREASYNCTEMPLATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17213EA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FloorBattleAreaSyncTemplateConfig_TypeDefinitionIndex = 15991;
