...
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_ATTACK_METHOD_3_2BCCF71D84DF9277_OFFSET UNITYSDK_OFFSET(0x1C375D10)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_ATTACK_METHOD_3_3980F39C22DABD55_OFFSET UNITYSDK_OFFSET(0x1C375D70)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_ATTACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C375D60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleAbility_Attack_TypeDefinitionIndex = 15135;
