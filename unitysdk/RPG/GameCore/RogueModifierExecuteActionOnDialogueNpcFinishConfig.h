...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONDIALOGUENPCFINISHCONFIG_METHOD_3_0E23F4D55E72FD05_OFFSET UNITYSDK_OFFSET(0x18D3CEF0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONDIALOGUENPCFINISHCONFIG_METHOD_3_332FC9E3521070FC_OFFSET UNITYSDK_OFFSET(0x18D35600)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONDIALOGUENPCFINISHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D355B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnDialogueNpcFinishConfig_TypeDefinitionIndex = 16893;
