...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONDIALOGUENPCFINISHCONFIG_METHOD_3_332FC9E3521070FC_OFFSET UNITYSDK_OFFSET(0x1CFC0190)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONDIALOGUENPCFINISHCONFIG_METHOD_3_C51A228ED46BB200_OFFSET UNITYSDK_OFFSET(0x1CFC0140)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONDIALOGUENPCFINISHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFC0180)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnDialogueNpcFinishConfig_TypeDefinitionIndex = 17070;
