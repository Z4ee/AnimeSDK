...
#define RPG_GAMECORE_REMOVEWALKINGEFFECT_METHOD_3_5785E841F994265E_OFFSET UNITYSDK_OFFSET(0x1759A410)
#define RPG_GAMECORE_REMOVEWALKINGEFFECT_METHOD_3_6040B37434A5F3B1_OFFSET UNITYSDK_OFFSET(0x1759A390)
#define RPG_GAMECORE_REMOVEWALKINGEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1759A3E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveWalkingEffect_TypeDefinitionIndex = 20625;
