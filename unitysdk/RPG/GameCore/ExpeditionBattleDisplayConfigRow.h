...
#define RPG_GAMECORE_EXPEDITIONBATTLEDISPLAYCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D080970)
#define RPG_GAMECORE_EXPEDITIONBATTLEDISPLAYCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D080C90)
