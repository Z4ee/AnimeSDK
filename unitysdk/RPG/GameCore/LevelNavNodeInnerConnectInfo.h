...
#define RPG_GAMECORE_LEVELNAVNODEINNERCONNECTINFO_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x18A4E030)
#define RPG_GAMECORE_LEVELNAVNODEINNERCONNECTINFO_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18A4DEF0)
#define RPG_GAMECORE_LEVELNAVNODEINNERCONNECTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18A4DEE0)
