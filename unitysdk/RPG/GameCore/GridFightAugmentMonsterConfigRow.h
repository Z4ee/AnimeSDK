...
#define RPG_GAMECORE_GRIDFIGHTAUGMENTMONSTERCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17252860)
#define RPG_GAMECORE_GRIDFIGHTAUGMENTMONSTERCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x172529D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightAugmentMonsterConfigRow_TypeDefinitionIndex = 12246;
