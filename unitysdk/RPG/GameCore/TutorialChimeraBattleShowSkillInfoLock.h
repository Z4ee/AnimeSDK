...
#define RPG_GAMECORE_TUTORIALCHIMERABATTLESHOWSKILLINFOLOCK_METHOD_3_3173CDDF9AC7F476_OFFSET UNITYSDK_OFFSET(0x178D6BB0)
#define RPG_GAMECORE_TUTORIALCHIMERABATTLESHOWSKILLINFOLOCK_METHOD_3_4134D5C89A3664BD_OFFSET UNITYSDK_OFFSET(0x178D6B30)
#define RPG_GAMECORE_TUTORIALCHIMERABATTLESHOWSKILLINFOLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x178D6B80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TutorialChimeraBattleShowSkillInfoLock_TypeDefinitionIndex = 22428;
