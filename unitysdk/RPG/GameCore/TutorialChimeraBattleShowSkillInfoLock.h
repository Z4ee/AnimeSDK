...
#define RPG_GAMECORE_TUTORIALCHIMERABATTLESHOWSKILLINFOLOCK_METHOD_3_3173CDDF9AC7F476_OFFSET UNITYSDK_OFFSET(0x1D612290)
#define RPG_GAMECORE_TUTORIALCHIMERABATTLESHOWSKILLINFOLOCK_METHOD_3_FE14C30EB9D5585B_OFFSET UNITYSDK_OFFSET(0x1D612240)
#define RPG_GAMECORE_TUTORIALCHIMERABATTLESHOWSKILLINFOLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D612280)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TutorialChimeraBattleShowSkillInfoLock_TypeDefinitionIndex = 24105;
