...
#define RPG_GAMECORE_ROGUEACTREPLACEROGUEBUFFCONFIG_METHOD_6_778C6EA9A7149246_OFFSET UNITYSDK_OFFSET(0x18CD3250)
#define RPG_GAMECORE_ROGUEACTREPLACEROGUEBUFFCONFIG_METHOD_6_9D6A52ADA6B4CAD3_OFFSET UNITYSDK_OFFSET(0x18CD3470)
#define RPG_GAMECORE_ROGUEACTREPLACEROGUEBUFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CD3390)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActReplaceRogueBuffConfig_TypeDefinitionIndex = 18595;
