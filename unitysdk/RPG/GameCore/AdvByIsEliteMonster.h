...
#define RPG_GAMECORE_ADVBYISELITEMONSTER_METHOD_4_7EB9179B438D3085_OFFSET UNITYSDK_OFFSET(0x16F27430)
#define RPG_GAMECORE_ADVBYISELITEMONSTER_METHOD_4_9D8271B0F7D7BCE3_OFFSET UNITYSDK_OFFSET(0x16F27360)
#define RPG_GAMECORE_ADVBYISELITEMONSTER__CTOR_OFFSET UNITYSDK_OFFSET(0x16F273E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvByIsEliteMonster_TypeDefinitionIndex = 19983;
