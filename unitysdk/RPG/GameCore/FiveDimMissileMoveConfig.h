...
#define RPG_GAMECORE_FIVEDIMMISSILEMOVECONFIG_METHOD_3_DA0725CE043BF55E_OFFSET UNITYSDK_OFFSET(0x1D0F1470)
#define RPG_GAMECORE_FIVEDIMMISSILEMOVECONFIG_METHOD_3_EEC50B0364AA3A37_OFFSET UNITYSDK_OFFSET(0x1D0F1420)
#define RPG_GAMECORE_FIVEDIMMISSILEMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0F1460)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimMissileMoveConfig_TypeDefinitionIndex = 16517;
