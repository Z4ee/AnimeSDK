...
#define RPG_GAMECORE_UNLOCKCAMERA_METHOD_3_194CFD073DF8FF28_OFFSET UNITYSDK_OFFSET(0x178E36E0)
#define RPG_GAMECORE_UNLOCKCAMERA_METHOD_3_8910B86451F83CDC_OFFSET UNITYSDK_OFFSET(0x178E35D0)
#define RPG_GAMECORE_UNLOCKCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x178E36B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UnLockCamera_TypeDefinitionIndex = 18440;
