...
#define RPG_GAMECORE_FIVEDIMCLIENTFINISHMISSIONACTION_METHOD_3_7852842A615610D3_OFFSET UNITYSDK_OFFSET(0x188FAB20)
#define RPG_GAMECORE_FIVEDIMCLIENTFINISHMISSIONACTION_METHOD_3_A45A9AF08395452F_OFFSET UNITYSDK_OFFSET(0x188F3AD0)
#define RPG_GAMECORE_FIVEDIMCLIENTFINISHMISSIONACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x188F3AB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimClientFinishMissionAction_TypeDefinitionIndex = 17842;
