...
#define RPG_GAMECORE_BYISTRIGGERBATTLEATTACKER_METHOD_4_43B1D0D2F142CF02_OFFSET UNITYSDK_OFFSET(0x170351B0)
#define RPG_GAMECORE_BYISTRIGGERBATTLEATTACKER_METHOD_4_E35D57396C2B417C_OFFSET UNITYSDK_OFFSET(0x170350E0)
#define RPG_GAMECORE_BYISTRIGGERBATTLEATTACKER__CTOR_OFFSET UNITYSDK_OFFSET(0x17035160)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsTriggerBattleAttacker_TypeDefinitionIndex = 19108;
