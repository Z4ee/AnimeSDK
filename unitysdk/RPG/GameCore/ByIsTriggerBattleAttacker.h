...
#define RPG_GAMECORE_BYISTRIGGERBATTLEATTACKER_METHOD_4_43B1D0D2F142CF02_OFFSET UNITYSDK_OFFSET(0x1B2AACD0)
#define RPG_GAMECORE_BYISTRIGGERBATTLEATTACKER_METHOD_4_6FB775810D2F27F8_OFFSET UNITYSDK_OFFSET(0x1B2AAE80)
#define RPG_GAMECORE_BYISTRIGGERBATTLEATTACKER_METHOD_4_B01E5CB42EF283DE_OFFSET UNITYSDK_OFFSET(0x1B2AAE50)
#define RPG_GAMECORE_BYISTRIGGERBATTLEATTACKER_METHOD_4_FCE9F0C6B136F97B_OFFSET UNITYSDK_OFFSET(0x1B2AAC90)
#define RPG_GAMECORE_BYISTRIGGERBATTLEATTACKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2AACC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsTriggerBattleAttacker_TypeDefinitionIndex = 20002;
