...
#define RPG_GAMECORE_FATEACTADDTRIGGERHOUGUSELECTCOUNTCONFIG_METHOD_6_E43C7A1A3395BF41_OFFSET UNITYSDK_OFFSET(0x188CEA20)
#define RPG_GAMECORE_FATEACTADDTRIGGERHOUGUSELECTCOUNTCONFIG_METHOD_6_F472730998E9796A_OFFSET UNITYSDK_OFFSET(0x188CEB90)
#define RPG_GAMECORE_FATEACTADDTRIGGERHOUGUSELECTCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x188CEAF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateActAddTriggerHouguSelectCountConfig_TypeDefinitionIndex = 18283;
