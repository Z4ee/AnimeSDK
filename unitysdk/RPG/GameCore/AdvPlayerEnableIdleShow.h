...
#define RPG_GAMECORE_ADVPLAYERENABLEIDLESHOW_METHOD_3_E84EBAEC91BAA186_OFFSET UNITYSDK_OFFSET(0x16F3B500)
#define RPG_GAMECORE_ADVPLAYERENABLEIDLESHOW_METHOD_3_EC8ED245C2670CB7_OFFSET UNITYSDK_OFFSET(0x16F3B580)
#define RPG_GAMECORE_ADVPLAYERENABLEIDLESHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x16F3B550)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvPlayerEnableIdleShow_TypeDefinitionIndex = 18521;
