...
#define RPG_GAMECORE_TEAMTOWERSSKILLCONFIG_METHOD_2_EBDFC10948CEFEC4_OFFSET UNITYSDK_OFFSET(0x1C149660)
#define RPG_GAMECORE_TEAMTOWERSSKILLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C149740)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TeamTowersSkillConfig_TypeDefinitionIndex = 20608;
