...
#define RPG_GAMECORE_DEBUGLOGINPREDICATES_METHOD_4_5A54955D0B4E9870_OFFSET UNITYSDK_OFFSET(0x18854880)
#define RPG_GAMECORE_DEBUGLOGINPREDICATES_METHOD_4_E0D47C77686CE018_OFFSET UNITYSDK_OFFSET(0x18854960)
#define RPG_GAMECORE_DEBUGLOGINPREDICATES__CTOR_OFFSET UNITYSDK_OFFSET(0x18854900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DebugLogInPredicates_TypeDefinitionIndex = 22793;
