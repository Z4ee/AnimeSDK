...
#define RPG_GAMECORE_DEBUGLOGINPREDICATES_METHOD_4_43851F5C2B77AA8D_OFFSET UNITYSDK_OFFSET(0x1C0FD590)
#define RPG_GAMECORE_DEBUGLOGINPREDICATES_METHOD_4_C8383BD4A9C019EA_OFFSET UNITYSDK_OFFSET(0x1C0FD550)
#define RPG_GAMECORE_DEBUGLOGINPREDICATES_METHOD_4_E0D47C77686CE018_OFFSET UNITYSDK_OFFSET(0x1C0FD320)
#define RPG_GAMECORE_DEBUGLOGINPREDICATES_METHOD_4_E1258C5FDE3CB83D_OFFSET UNITYSDK_OFFSET(0x1C0FD2D0)
#define RPG_GAMECORE_DEBUGLOGINPREDICATES__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0FD310)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DebugLogInPredicates_TypeDefinitionIndex = 22950;
