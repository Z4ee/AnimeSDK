...
#define RPG_GAMECORE_SUBNAVMAPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19CD0FC0)
#define RPG_GAMECORE_SUBNAVMAPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19CD1850)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SubNavMapRow_TypeDefinitionIndex = 13344;
	...
	public:
		...
		::System::UInt32 NearbyTeleportMappingInfoID; // 0x18
		::System::UInt32 NavMapSubTabID; // 0x1C
		::System::Int32 DefaultLayer; // 0x20
