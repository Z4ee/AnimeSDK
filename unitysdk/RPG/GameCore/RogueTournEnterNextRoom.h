...
#define RPG_GAMECORE_ROGUETOURNENTERNEXTROOM_METHOD_3_2B1D02E38C8E1379_OFFSET UNITYSDK_OFFSET(0x1D41ACF0)
#define RPG_GAMECORE_ROGUETOURNENTERNEXTROOM_METHOD_3_2D64BAF9D2DFCE7C_OFFSET UNITYSDK_OFFSET(0x1D41AC20)
#define RPG_GAMECORE_ROGUETOURNENTERNEXTROOM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D41ACE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournEnterNextRoom_TypeDefinitionIndex = 21851;
