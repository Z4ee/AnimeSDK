...
#define RPG_GAMECORE_ROGUETOURNENTERNEXTROOM_METHOD_3_2B1D02E38C8E1379_OFFSET UNITYSDK_OFFSET(0x19BC68F0)
#define RPG_GAMECORE_ROGUETOURNENTERNEXTROOM_METHOD_3_AE27074B867CF0C5_OFFSET UNITYSDK_OFFSET(0x19BC67E0)
#define RPG_GAMECORE_ROGUETOURNENTERNEXTROOM__CTOR_OFFSET UNITYSDK_OFFSET(0x19BC68C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournEnterNextRoom_TypeDefinitionIndex = 20876;
