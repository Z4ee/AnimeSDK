...
#define RPG_GAMECORE_PROPFASTDELIVERINITENTITY_METHOD_3_5617476D6DB14198_OFFSET UNITYSDK_OFFSET(0x1D3679E0)
#define RPG_GAMECORE_PROPFASTDELIVERINITENTITY_METHOD_3_6495D8DFBA155D22_OFFSET UNITYSDK_OFFSET(0x1D367AC0)
#define RPG_GAMECORE_PROPFASTDELIVERINITENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D367A20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropFastDeliverInitEntity_TypeDefinitionIndex = 21901;
