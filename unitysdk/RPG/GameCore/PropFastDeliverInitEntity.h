...
#define RPG_GAMECORE_PROPFASTDELIVERINITENTITY_METHOD_3_5617476D6DB14198_OFFSET UNITYSDK_OFFSET(0x18C6D4F0)
#define RPG_GAMECORE_PROPFASTDELIVERINITENTITY_METHOD_3_6495D8DFBA155D22_OFFSET UNITYSDK_OFFSET(0x18C6D6A0)
#define RPG_GAMECORE_PROPFASTDELIVERINITENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x18C6D530)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropFastDeliverInitEntity_TypeDefinitionIndex = 21016;
