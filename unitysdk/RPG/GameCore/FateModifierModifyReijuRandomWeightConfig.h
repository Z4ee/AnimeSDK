...
#define RPG_GAMECORE_FATEMODIFIERMODIFYREIJURANDOMWEIGHTCONFIG_METHOD_3_6D5DD02446DBE7C9_OFFSET UNITYSDK_OFFSET(0x171C8E80)
#define RPG_GAMECORE_FATEMODIFIERMODIFYREIJURANDOMWEIGHTCONFIG_METHOD_3_D89EF8E87C427060_OFFSET UNITYSDK_OFFSET(0x171C7FC0)
#define RPG_GAMECORE_FATEMODIFIERMODIFYREIJURANDOMWEIGHTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171C7F70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateModifierModifyReijuRandomWeightConfig_TypeDefinitionIndex = 17706;
