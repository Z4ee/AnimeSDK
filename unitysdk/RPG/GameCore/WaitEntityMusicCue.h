...
#define RPG_GAMECORE_WAITENTITYMUSICCUE_METHOD_3_D0D3F013B6D64E4D_OFFSET UNITYSDK_OFFSET(0x1DEB72B0)
#define RPG_GAMECORE_WAITENTITYMUSICCUE_METHOD_3_EBDDB3BB325F1ED4_OFFSET UNITYSDK_OFFSET(0x1DEB7260)
#define RPG_GAMECORE_WAITENTITYMUSICCUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEB72A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitEntityMusicCue_TypeDefinitionIndex = 20380;
