...
#define RPG_GAMECORE_WAITENTITYMUSICCUE_METHOD_3_2B4F9404A8F4069C_OFFSET UNITYSDK_OFFSET(0x190FC320)
#define RPG_GAMECORE_WAITENTITYMUSICCUE_METHOD_3_D0D3F013B6D64E4D_OFFSET UNITYSDK_OFFSET(0x190FC3A0)
#define RPG_GAMECORE_WAITENTITYMUSICCUE__CTOR_OFFSET UNITYSDK_OFFSET(0x190FC370)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitEntityMusicCue_TypeDefinitionIndex = 19587;
