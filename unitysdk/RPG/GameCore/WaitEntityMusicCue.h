...
#define RPG_GAMECORE_WAITENTITYMUSICCUE_METHOD_3_D0D3F013B6D64E4D_OFFSET UNITYSDK_OFFSET(0x1D6A2110)
#define RPG_GAMECORE_WAITENTITYMUSICCUE_METHOD_3_EBDDB3BB325F1ED4_OFFSET UNITYSDK_OFFSET(0x1D6A20C0)
#define RPG_GAMECORE_WAITENTITYMUSICCUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6A2100)
