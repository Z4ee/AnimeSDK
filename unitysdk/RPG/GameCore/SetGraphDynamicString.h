...
#define RPG_GAMECORE_SETGRAPHDYNAMICSTRING_METHOD_3_125FEC9B23C594E7_OFFSET UNITYSDK_OFFSET(0x18E33640)
#define RPG_GAMECORE_SETGRAPHDYNAMICSTRING_METHOD_3_E3D6E6D611742928_OFFSET UNITYSDK_OFFSET(0x18E336C0)
#define RPG_GAMECORE_SETGRAPHDYNAMICSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x18E33690)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetGraphDynamicString_TypeDefinitionIndex = 19687;
