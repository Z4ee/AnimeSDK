...
#define RPG_GAMECORE_MONOPOLYSHOPCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D1D1910)
#define RPG_GAMECORE_MONOPOLYSHOPCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1D1A20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonopolyShopConfigRow_TypeDefinitionIndex = 11966;
