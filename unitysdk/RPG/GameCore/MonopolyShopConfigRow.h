...
#define RPG_GAMECORE_MONOPOLYSHOPCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17448020)
#define RPG_GAMECORE_MONOPOLYSHOPCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17448140)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonopolyShopConfigRow_TypeDefinitionIndex = 11029;
