...
#define RPG_GAMECORE_ADVWAITPROPSTEEREVENTV2_METHOD_3_0028D77E674941D7_OFFSET UNITYSDK_OFFSET(0x16F46580)
#define RPG_GAMECORE_ADVWAITPROPSTEEREVENTV2_METHOD_3_EF081ADE2A2DE439_OFFSET UNITYSDK_OFFSET(0x16F46500)
#define RPG_GAMECORE_ADVWAITPROPSTEEREVENTV2__CTOR_OFFSET UNITYSDK_OFFSET(0x16F46550)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvWaitPropSteerEventV2_TypeDefinitionIndex = 20235;
