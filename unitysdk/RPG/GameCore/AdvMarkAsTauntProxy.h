...
#define RPG_GAMECORE_ADVMARKASTAUNTPROXY_METHOD_3_6C110AD00C2AFB6E_OFFSET UNITYSDK_OFFSET(0x16F33440)
#define RPG_GAMECORE_ADVMARKASTAUNTPROXY_METHOD_3_F8DBA22760D83224_OFFSET UNITYSDK_OFFSET(0x16F333C0)
#define RPG_GAMECORE_ADVMARKASTAUNTPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x16F33410)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvMarkAsTauntProxy_TypeDefinitionIndex = 18870;
