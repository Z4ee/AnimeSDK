...
#define RPG_GAMECORE_SWITCHHANDCATCHITEM_METHOD_3_4951562FFB21F566_OFFSET UNITYSDK_OFFSET(0x1B435AB0)
#define RPG_GAMECORE_SWITCHHANDCATCHITEM_METHOD_3_7C7BCC6C68B8C129_OFFSET UNITYSDK_OFFSET(0x1B435AF0)
#define RPG_GAMECORE_SWITCHHANDCATCHITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B435AE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchHandCatchItem_TypeDefinitionIndex = 20177;
