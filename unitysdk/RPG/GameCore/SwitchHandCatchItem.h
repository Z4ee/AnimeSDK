...
#define RPG_GAMECORE_SWITCHHANDCATCHITEM_METHOD_3_6CCBF81BE29B2775_OFFSET UNITYSDK_OFFSET(0x19CDA410)
#define RPG_GAMECORE_SWITCHHANDCATCHITEM_METHOD_3_7C7BCC6C68B8C129_OFFSET UNITYSDK_OFFSET(0x19CDA490)
#define RPG_GAMECORE_SWITCHHANDCATCHITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x19CDA460)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchHandCatchItem_TypeDefinitionIndex = 19817;
