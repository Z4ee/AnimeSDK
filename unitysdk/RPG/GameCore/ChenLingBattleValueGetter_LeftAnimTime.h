...
#define RPG_GAMECORE_CHENLINGBATTLEVALUEGETTER_LEFTANIMTIME_METHOD_3_3467519CE0F98407_OFFSET UNITYSDK_OFFSET(0x1C37FD10)
#define RPG_GAMECORE_CHENLINGBATTLEVALUEGETTER_LEFTANIMTIME_METHOD_3_82F794E37359EC96_OFFSET UNITYSDK_OFFSET(0x1C37FDB0)
#define RPG_GAMECORE_CHENLINGBATTLEVALUEGETTER_LEFTANIMTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x1C37FDA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleValueGetter_LeftAnimTime_TypeDefinitionIndex = 15197;
