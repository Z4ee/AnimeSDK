...
#define RPG_GAMECORE_ROGUEMAGICWORKBENCHROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17617D50)
#define RPG_GAMECORE_ROGUEMAGICWORKBENCHROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17617EA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueMagicWorkbenchRow_TypeDefinitionIndex = 13601;
