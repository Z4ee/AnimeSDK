...
#define RPG_GAMECORE_RESTAURANTFARMCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18CB1170)
#define RPG_GAMECORE_RESTAURANTFARMCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18CB1400)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RestaurantFarmConfigRow_TypeDefinitionIndex = 10877;
