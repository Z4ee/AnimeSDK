...
#define RPG_GAMECORE_CHALLENGESTORYGROUPEXTRACONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x195FFF90)
#define RPG_GAMECORE_CHALLENGESTORYGROUPEXTRACONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19600750)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* ThemeToastPicPath; // 0x18
		::System::String* ThemePosterEffectPrefabPath; // 0x20
		::Il2CppArray<::System::UInt32>* SubMazeBuffList; // 0x28
