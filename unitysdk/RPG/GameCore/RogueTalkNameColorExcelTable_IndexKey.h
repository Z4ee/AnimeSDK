...
#define RPG_GAMECORE_ROGUETALKNAMECOLOREXCELTABLE_INDEXKEY_EQUALS_OFFSET UNITYSDK_OFFSET(0x3B8B450)
#define RPG_GAMECORE_ROGUETALKNAMECOLOREXCELTABLE_INDEXKEY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x5F00)
#define RPG_GAMECORE_ROGUETALKNAMECOLOREXCELTABLE_INDEXKEY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3B8B3A0)
#define RPG_GAMECORE_ROGUETALKNAMECOLOREXCELTABLE_INDEXKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x2E50B00)
