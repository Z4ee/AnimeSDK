...
#define RPG_GAMECORE_BYCOMPAREISWOLFBROBULLETACTIVATED_METHOD_4_BC5A443A800D5803_OFFSET UNITYSDK_OFFSET(0x18730CC0)
#define RPG_GAMECORE_BYCOMPAREISWOLFBROBULLETACTIVATED_METHOD_4_DB481AEFEF358759_OFFSET UNITYSDK_OFFSET(0x18730BF0)
#define RPG_GAMECORE_BYCOMPAREISWOLFBROBULLETACTIVATED__CTOR_OFFSET UNITYSDK_OFFSET(0x18730C70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareIsWolfBroBulletActivated_TypeDefinitionIndex = 20847;
