...
#define RPG_GAMECORE_TARGETFETCHELATIONTIMEALLTARGETS_METHOD_4_4363DB4F37D2D1DE_OFFSET UNITYSDK_OFFSET(0x177B4FB0)
#define RPG_GAMECORE_TARGETFETCHELATIONTIMEALLTARGETS_METHOD_4_C093BBF260B30CDC_OFFSET UNITYSDK_OFFSET(0x177BE6A0)
#define RPG_GAMECORE_TARGETFETCHELATIONTIMEALLTARGETS__CTOR_OFFSET UNITYSDK_OFFSET(0x177B4F60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchElationTimeAllTargets_TypeDefinitionIndex = 22218;
