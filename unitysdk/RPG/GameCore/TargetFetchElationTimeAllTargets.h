...
#define RPG_GAMECORE_TARGETFETCHELATIONTIMEALLTARGETS_METHOD_4_0CD87A2BFCAA0A4F_OFFSET UNITYSDK_OFFSET(0x1D0B9800)
#define RPG_GAMECORE_TARGETFETCHELATIONTIMEALLTARGETS_METHOD_4_4363DB4F37D2D1DE_OFFSET UNITYSDK_OFFSET(0x1D0B9880)
#define RPG_GAMECORE_TARGETFETCHELATIONTIMEALLTARGETS_METHOD_4_7154BB05E90117BB_OFFSET UNITYSDK_OFFSET(0x1D0B98E0)
#define RPG_GAMECORE_TARGETFETCHELATIONTIMEALLTARGETS_METHOD_4_CBA3CCA4D3A99D4E_OFFSET UNITYSDK_OFFSET(0x1D0B9900)
#define RPG_GAMECORE_TARGETFETCHELATIONTIMEALLTARGETS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0B9870)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchElationTimeAllTargets_TypeDefinitionIndex = 23086;
