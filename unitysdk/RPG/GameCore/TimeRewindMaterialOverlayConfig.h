...
#define RPG_GAMECORE_TIMEREWINDMATERIALOVERLAYCONFIG_METHOD_2_DD76E8150A509C85_OFFSET UNITYSDK_OFFSET(0x1789F920)
#define RPG_GAMECORE_TIMEREWINDMATERIALOVERLAYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1789FAD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TimeRewindMaterialOverlayConfig_TypeDefinitionIndex = 16133;
