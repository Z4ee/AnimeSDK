...
#define RPG_GAMECORE_SHOWHEARTDIALUI_METHOD_3_25CB8B555E4D31A5_OFFSET UNITYSDK_OFFSET(0x176FEF00)
#define RPG_GAMECORE_SHOWHEARTDIALUI_METHOD_3_BCD1360FA0617534_OFFSET UNITYSDK_OFFSET(0x176FEE80)
#define RPG_GAMECORE_SHOWHEARTDIALUI__CTOR_OFFSET UNITYSDK_OFFSET(0x176FEED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowHeartDialUI_TypeDefinitionIndex = 19521;
