...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEDICEACCUMULATE_METHOD_3_02EDC889716874F5_OFFSET UNITYSDK_OFFSET(0x19C43760)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEDICEACCUMULATE_METHOD_3_8FA173512C4A8DCA_OFFSET UNITYSDK_OFFSET(0x19C436F0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEDICEACCUMULATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C43730)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRogueDiceAccumulate_TypeDefinitionIndex = 20573;
