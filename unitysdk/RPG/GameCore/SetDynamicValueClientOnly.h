...
#define RPG_GAMECORE_SETDYNAMICVALUECLIENTONLY_METHOD_5_AE9168916630E401_OFFSET UNITYSDK_OFFSET(0x176C81A0)
#define RPG_GAMECORE_SETDYNAMICVALUECLIENTONLY_METHOD_5_DF59490BAC43F26E_OFFSET UNITYSDK_OFFSET(0x176C8080)
#define RPG_GAMECORE_SETDYNAMICVALUECLIENTONLY__CTOR_OFFSET UNITYSDK_OFFSET(0x176C8120)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueClientOnly_TypeDefinitionIndex = 22100;
