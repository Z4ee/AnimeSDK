...
#define RPG_GAMECORE_SETDYNAMICVALUECLIENTONLY_METHOD_5_AE9168916630E401_OFFSET UNITYSDK_OFFSET(0x18E2B710)
#define RPG_GAMECORE_SETDYNAMICVALUECLIENTONLY_METHOD_5_DF59490BAC43F26E_OFFSET UNITYSDK_OFFSET(0x18E2B5F0)
#define RPG_GAMECORE_SETDYNAMICVALUECLIENTONLY__CTOR_OFFSET UNITYSDK_OFFSET(0x18E2B690)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueClientOnly_TypeDefinitionIndex = 22817;
