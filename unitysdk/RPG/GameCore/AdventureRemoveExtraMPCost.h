...
#define RPG_GAMECORE_ADVENTUREREMOVEEXTRAMPCOST_METHOD_3_01F155941DF100C0_OFFSET UNITYSDK_OFFSET(0x1AE619D0)
#define RPG_GAMECORE_ADVENTUREREMOVEEXTRAMPCOST_METHOD_3_586EE0EB0A2E0995_OFFSET UNITYSDK_OFFSET(0x1AE61990)
#define RPG_GAMECORE_ADVENTUREREMOVEEXTRAMPCOST__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE619C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureRemoveExtraMPCost_TypeDefinitionIndex = 21001;
