...
#define RPG_GAMECORE_POINTGENERATORONNAVPATHCONFIG_METHOD_3_71381AF007425FC0_OFFSET UNITYSDK_OFFSET(0x174EC210)
#define RPG_GAMECORE_POINTGENERATORONNAVPATHCONFIG_METHOD_3_ECCBF057757545FD_OFFSET UNITYSDK_OFFSET(0x174EC060)
#define RPG_GAMECORE_POINTGENERATORONNAVPATHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x174EC000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PointGeneratorOnNavPathConfig_TypeDefinitionIndex = 14322;
