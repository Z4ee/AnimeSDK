...
#define RPG_GAMECORE_POINTGENERATORONNAVPATHCONFIG_METHOD_3_71381AF007425FC0_OFFSET UNITYSDK_OFFSET(0x18C37880)
#define RPG_GAMECORE_POINTGENERATORONNAVPATHCONFIG_METHOD_3_ECCBF057757545FD_OFFSET UNITYSDK_OFFSET(0x18C376D0)
#define RPG_GAMECORE_POINTGENERATORONNAVPATHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18C37670)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PointGeneratorOnNavPathConfig_TypeDefinitionIndex = 14792;
