...
#define RPG_GAMECORE_POINTGENERATORONNAVPATHCONFIG_METHOD_3_CD9A4F61F5B63703_OFFSET UNITYSDK_OFFSET(0x1D358800)
#define RPG_GAMECORE_POINTGENERATORONNAVPATHCONFIG_METHOD_3_ECCBF057757545FD_OFFSET UNITYSDK_OFFSET(0x1D358650)
#define RPG_GAMECORE_POINTGENERATORONNAVPATHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D358630)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PointGeneratorOnNavPathConfig_TypeDefinitionIndex = 15454;
