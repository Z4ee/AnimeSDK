...
#define RPG_GAMECORE_DRONESSWITCHDYNAMICCOLLIDER_METHOD_3_6B3DA8DB782A49F6_OFFSET UNITYSDK_OFFSET(0x1DB1A9A0)
#define RPG_GAMECORE_DRONESSWITCHDYNAMICCOLLIDER_METHOD_3_90057D349D35BFE1_OFFSET UNITYSDK_OFFSET(0x1DB1A960)
#define RPG_GAMECORE_DRONESSWITCHDYNAMICCOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB1A990)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DronesSwitchDynamicCollider_TypeDefinitionIndex = 20136;
