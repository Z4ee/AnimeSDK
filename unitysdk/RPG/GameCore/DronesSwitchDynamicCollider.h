...
#define RPG_GAMECORE_DRONESSWITCHDYNAMICCOLLIDER_METHOD_3_6B3DA8DB782A49F6_OFFSET UNITYSDK_OFFSET(0x18890400)
#define RPG_GAMECORE_DRONESSWITCHDYNAMICCOLLIDER_METHOD_3_F0478BEDD5661BAC_OFFSET UNITYSDK_OFFSET(0x18890380)
#define RPG_GAMECORE_DRONESSWITCHDYNAMICCOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x188903D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DronesSwitchDynamicCollider_TypeDefinitionIndex = 19322;
