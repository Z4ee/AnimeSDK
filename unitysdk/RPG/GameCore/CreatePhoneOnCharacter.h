...
#define RPG_GAMECORE_CREATEPHONEONCHARACTER_METHOD_3_AE5F20A649060CDE_OFFSET UNITYSDK_OFFSET(0x1D9BF760)
#define RPG_GAMECORE_CREATEPHONEONCHARACTER_METHOD_3_F5BF8D08098AA170_OFFSET UNITYSDK_OFFSET(0x1D9BF720)
#define RPG_GAMECORE_CREATEPHONEONCHARACTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D9BF750)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CreatePhoneOnCharacter_TypeDefinitionIndex = 20638;
