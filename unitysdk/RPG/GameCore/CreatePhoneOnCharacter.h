...
#define RPG_GAMECORE_CREATEPHONEONCHARACTER_METHOD_3_4AB16BBA17C7FCB9_OFFSET UNITYSDK_OFFSET(0x1713CD80)
#define RPG_GAMECORE_CREATEPHONEONCHARACTER_METHOD_3_AE5F20A649060CDE_OFFSET UNITYSDK_OFFSET(0x1713CE00)
#define RPG_GAMECORE_CREATEPHONEONCHARACTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1713CDD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CreatePhoneOnCharacter_TypeDefinitionIndex = 19203;
