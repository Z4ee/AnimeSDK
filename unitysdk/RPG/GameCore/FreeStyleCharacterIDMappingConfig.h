...
#define RPG_GAMECORE_FREESTYLECHARACTERIDMAPPINGCONFIG_METHOD_2_0A1B688B71BC30ED_OFFSET UNITYSDK_OFFSET(0x1721FC70)
#define RPG_GAMECORE_FREESTYLECHARACTERIDMAPPINGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1721FD40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FreeStyleCharacterIDMappingConfig_TypeDefinitionIndex = 14929;
