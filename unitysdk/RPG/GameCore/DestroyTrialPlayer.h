...
#define RPG_GAMECORE_DESTROYTRIALPLAYER_METHOD_3_7C4E76762F1CEF60_OFFSET UNITYSDK_OFFSET(0x1885C340)
#define RPG_GAMECORE_DESTROYTRIALPLAYER_METHOD_3_E37A690631833D00_OFFSET UNITYSDK_OFFSET(0x1885C2B0)
#define RPG_GAMECORE_DESTROYTRIALPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1885C310)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DestroyTrialPlayer_TypeDefinitionIndex = 20449;
