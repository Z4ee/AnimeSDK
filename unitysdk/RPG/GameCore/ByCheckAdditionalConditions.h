...
#define RPG_GAMECORE_BYCHECKADDITIONALCONDITIONS_METHOD_4_001F579E19B19BAD_OFFSET UNITYSDK_OFFSET(0x19CC1400)
#define RPG_GAMECORE_BYCHECKADDITIONALCONDITIONS_METHOD_4_61033AF00E136848_OFFSET UNITYSDK_OFFSET(0x19CC15E0)
#define RPG_GAMECORE_BYCHECKADDITIONALCONDITIONS_METHOD_4_6D0F58F4E66AD778_OFFSET UNITYSDK_OFFSET(0x19CC1440)
#define RPG_GAMECORE_BYCHECKADDITIONALCONDITIONS_METHOD_4_D14E40C2518FCB6F_OFFSET UNITYSDK_OFFSET(0x19CC1610)
#define RPG_GAMECORE_BYCHECKADDITIONALCONDITIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x19CC1430)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckAdditionalConditions_TypeDefinitionIndex = 22594;
