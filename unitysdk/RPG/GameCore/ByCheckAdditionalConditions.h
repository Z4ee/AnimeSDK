...
#define RPG_GAMECORE_BYCHECKADDITIONALCONDITIONS_METHOD_4_6D0F58F4E66AD778_OFFSET UNITYSDK_OFFSET(0x18720DC0)
#define RPG_GAMECORE_BYCHECKADDITIONALCONDITIONS_METHOD_4_A779EEA055BC2D16_OFFSET UNITYSDK_OFFSET(0x18720CF0)
#define RPG_GAMECORE_BYCHECKADDITIONALCONDITIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x18720D70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckAdditionalConditions_TypeDefinitionIndex = 22403;
