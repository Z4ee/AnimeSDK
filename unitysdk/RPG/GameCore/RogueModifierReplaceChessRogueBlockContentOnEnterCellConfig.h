...
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECHESSROGUEBLOCKCONTENTONENTERCELLCONFIG_METHOD_3_2EACF6362F7407DB_OFFSET UNITYSDK_OFFSET(0x1D3FBBD0)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECHESSROGUEBLOCKCONTENTONENTERCELLCONFIG_METHOD_3_4DC3CF759A599377_OFFSET UNITYSDK_OFFSET(0x1D3FBB80)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECHESSROGUEBLOCKCONTENTONENTERCELLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3FBBC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierReplaceChessRogueBlockContentOnEnterCellConfig_TypeDefinitionIndex = 17763;
