...
#define RPG_GAMECORE_AVATARUSEMATERIALDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x194B4E30)
#define RPG_GAMECORE_AVATARUSEMATERIALDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x194B50F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AvatarUseMaterialDataRow_TypeDefinitionIndex = 12156;

	class AvatarUseMaterialDataRow : public ::System::Object
	{
	public:
		::System::UInt32 SkillMaterialLarge; // 0x10
