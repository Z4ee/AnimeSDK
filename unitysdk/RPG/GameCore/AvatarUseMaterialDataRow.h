...
#define RPG_GAMECORE_AVATARUSEMATERIALDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A3D73F0)
#define RPG_GAMECORE_AVATARUSEMATERIALDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3D76B0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 SkillMaterialMedium; // 0x18
