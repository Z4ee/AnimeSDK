...
#define RPG_GAMECORE_FLOORCUSTOMVALUECONFIG_METHOD_2_3EFC69FCD1845D7A_OFFSET UNITYSDK_OFFSET(0x18926B90)
#define RPG_GAMECORE_FLOORCUSTOMVALUECONFIG_METHOD_2_B2AEC0CE9688E3D4_OFFSET UNITYSDK_OFFSET(0x18926930)
#define RPG_GAMECORE_FLOORCUSTOMVALUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18926470)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FloorCustomValueConfig_TypeDefinitionIndex = 17370;
