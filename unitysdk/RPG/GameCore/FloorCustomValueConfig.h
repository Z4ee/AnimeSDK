...
#define RPG_GAMECORE_FLOORCUSTOMVALUECONFIG_METHOD_2_3EFC69FCD1845D7A_OFFSET UNITYSDK_OFFSET(0x1BEBC3A0)
#define RPG_GAMECORE_FLOORCUSTOMVALUECONFIG_METHOD_2_75EA2AB08D969260_OFFSET UNITYSDK_OFFSET(0x1BEBC650)
#define RPG_GAMECORE_FLOORCUSTOMVALUECONFIG_METHOD_2_B2AEC0CE9688E3D4_OFFSET UNITYSDK_OFFSET(0x1BEBC160)
#define RPG_GAMECORE_FLOORCUSTOMVALUECONFIG_METHOD_2_BEBB414CC4EFA368_OFFSET UNITYSDK_OFFSET(0x1BEBCA00)
#define RPG_GAMECORE_FLOORCUSTOMVALUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEBB590)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FloorCustomValueConfig_TypeDefinitionIndex = 17548;
