...
#define RPG_GAMECORE_CHIMERACONFIG_METHOD_2_2499054EA5AF24C0_OFFSET UNITYSDK_OFFSET(0x1CFBE550)
#define RPG_GAMECORE_CHIMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFBE6D0)
