...
#define RPG_GAMECORE_ELATIONACTIVITYACTIONBARABILITYCHANGE_METHOD_3_8473306A632D0B94_OFFSET UNITYSDK_OFFSET(0x1718A560)
#define RPG_GAMECORE_ELATIONACTIVITYACTIONBARABILITYCHANGE_METHOD_3_98EFA70BF9DB095D_OFFSET UNITYSDK_OFFSET(0x1718A5E0)
#define RPG_GAMECORE_ELATIONACTIVITYACTIONBARABILITYCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1718A5B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElationActivityActionBarAbilityChange_TypeDefinitionIndex = 21030;
