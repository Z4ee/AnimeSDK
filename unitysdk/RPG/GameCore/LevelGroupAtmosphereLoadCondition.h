...
#define RPG_GAMECORE_LEVELGROUPATMOSPHERELOADCONDITION_METHOD_2_2797B037FB889F43_OFFSET UNITYSDK_OFFSET(0x173373D0)
#define RPG_GAMECORE_LEVELGROUPATMOSPHERELOADCONDITION_METHOD_2_BDA8D3E2D8324F51_OFFSET UNITYSDK_OFFSET(0x17337AF0)
#define RPG_GAMECORE_LEVELGROUPATMOSPHERELOADCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x17337B50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelGroupAtmosphereLoadCondition_TypeDefinitionIndex = 15805;
