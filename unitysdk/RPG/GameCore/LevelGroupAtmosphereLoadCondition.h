...
#define RPG_GAMECORE_LEVELGROUPATMOSPHERELOADCONDITION_METHOD_2_2797B037FB889F43_OFFSET UNITYSDK_OFFSET(0x18A43C90)
#define RPG_GAMECORE_LEVELGROUPATMOSPHERELOADCONDITION_METHOD_2_BDA8D3E2D8324F51_OFFSET UNITYSDK_OFFSET(0x18A441C0)
#define RPG_GAMECORE_LEVELGROUPATMOSPHERELOADCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x18A44220)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelGroupAtmosphereLoadCondition_TypeDefinitionIndex = 16331;
