...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEBUFFNUMWITHCATEGORYPARAM_METHOD_4_7D5D6F10A42F7EF5_OFFSET UNITYSDK_OFFSET(0x19C43470)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEBUFFNUMWITHCATEGORYPARAM_METHOD_4_BCD02156F4AE4AE5_OFFSET UNITYSDK_OFFSET(0x19C433E0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEBUFFNUMWITHCATEGORYPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x19C43440)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRogueBuffNumWithCategoryParam_TypeDefinitionIndex = 20558;
