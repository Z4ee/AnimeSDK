...
#define RPG_GAMECORE_PROPCLOSEPUZZLE_METHOD_3_8D6BADC9695B57CD_OFFSET UNITYSDK_OFFSET(0x175168A0)
#define RPG_GAMECORE_PROPCLOSEPUZZLE_METHOD_3_F228A58075EC2ABB_OFFSET UNITYSDK_OFFSET(0x17516750)
#define RPG_GAMECORE_PROPCLOSEPUZZLE__CTOR_OFFSET UNITYSDK_OFFSET(0x17516810)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropClosePuzzle_TypeDefinitionIndex = 18659;
