...
#define RPG_GAMECORE_PROPCLOSEPUZZLE_METHOD_3_7039A45D409B6285_OFFSET UNITYSDK_OFFSET(0x1D173FF0)
#define RPG_GAMECORE_PROPCLOSEPUZZLE_METHOD_3_8D6BADC9695B57CD_OFFSET UNITYSDK_OFFSET(0x1D174070)
#define RPG_GAMECORE_PROPCLOSEPUZZLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D174040)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropClosePuzzle_TypeDefinitionIndex = 20130;
