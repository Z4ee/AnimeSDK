...
#define RPG_GAMECORE_ROGUEDLC1DOT3TELEPORT_METHOD_3_315AF0F7FEE48A72_OFFSET UNITYSDK_OFFSET(0x18CFDD60)
#define RPG_GAMECORE_ROGUEDLC1DOT3TELEPORT_METHOD_3_8924AEB8F62607DB_OFFSET UNITYSDK_OFFSET(0x18CFDDE0)
#define RPG_GAMECORE_ROGUEDLC1DOT3TELEPORT__CTOR_OFFSET UNITYSDK_OFFSET(0x18CFDDB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueDLC1Dot3Teleport_TypeDefinitionIndex = 21162;
