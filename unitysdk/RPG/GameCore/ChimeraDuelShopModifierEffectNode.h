...
#define RPG_GAMECORE_CHIMERADUELSHOPMODIFIEREFFECTNODE_METHOD_3_09E509B7F346009F_OFFSET UNITYSDK_OFFSET(0x18805320)
#define RPG_GAMECORE_CHIMERADUELSHOPMODIFIEREFFECTNODE_METHOD_3_3D208D414F0D7198_OFFSET UNITYSDK_OFFSET(0x188051E0)
#define RPG_GAMECORE_CHIMERADUELSHOPMODIFIEREFFECTNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x188052D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelShopModifierEffectNode_TypeDefinitionIndex = 15128;
