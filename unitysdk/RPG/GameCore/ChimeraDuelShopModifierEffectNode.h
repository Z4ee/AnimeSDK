...
#define RPG_GAMECORE_CHIMERADUELSHOPMODIFIEREFFECTNODE_METHOD_3_09E509B7F346009F_OFFSET UNITYSDK_OFFSET(0x1E33C1F0)
#define RPG_GAMECORE_CHIMERADUELSHOPMODIFIEREFFECTNODE_METHOD_3_96459970D8F274EE_OFFSET UNITYSDK_OFFSET(0x1E33C150)
#define RPG_GAMECORE_CHIMERADUELSHOPMODIFIEREFFECTNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E33C1E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelShopModifierEffectNode_TypeDefinitionIndex = 15791;
