...
#define RPG_GAMECORE_SETCAMERAXAXISBYPLAYERTARGETAXIS_METHOD_3_04555DE31D6395EC_OFFSET UNITYSDK_OFFSET(0x176AC6D0)
#define RPG_GAMECORE_SETCAMERAXAXISBYPLAYERTARGETAXIS_METHOD_3_FEBC4424C431F6B6_OFFSET UNITYSDK_OFFSET(0x176AC760)
#define RPG_GAMECORE_SETCAMERAXAXISBYPLAYERTARGETAXIS__CTOR_OFFSET UNITYSDK_OFFSET(0x176AC730)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetCameraXAxisByPlayerTargetAxis_TypeDefinitionIndex = 19152;
