...
#define RPG_GAMECORE_SETCAMERAXAXISBYPLAYERTARGETAXIS_METHOD_3_04555DE31D6395EC_OFFSET UNITYSDK_OFFSET(0x19C2DDF0)
#define RPG_GAMECORE_SETCAMERAXAXISBYPLAYERTARGETAXIS_METHOD_3_FEBC4424C431F6B6_OFFSET UNITYSDK_OFFSET(0x19C2DE80)
#define RPG_GAMECORE_SETCAMERAXAXISBYPLAYERTARGETAXIS__CTOR_OFFSET UNITYSDK_OFFSET(0x19C2DE50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetCameraXAxisByPlayerTargetAxis_TypeDefinitionIndex = 19686;
