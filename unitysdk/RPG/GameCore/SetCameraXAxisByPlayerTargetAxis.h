...
#define RPG_GAMECORE_SETCAMERAXAXISBYPLAYERTARGETAXIS_METHOD_3_0E73EFFB11EC00A1_OFFSET UNITYSDK_OFFSET(0x1E811BD0)
#define RPG_GAMECORE_SETCAMERAXAXISBYPLAYERTARGETAXIS_METHOD_3_FEBC4424C431F6B6_OFFSET UNITYSDK_OFFSET(0x1E811C20)
#define RPG_GAMECORE_SETCAMERAXAXISBYPLAYERTARGETAXIS__CTOR_OFFSET UNITYSDK_OFFSET(0x1E811C10)
