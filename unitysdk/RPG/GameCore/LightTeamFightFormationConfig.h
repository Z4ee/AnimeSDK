...
#define RPG_GAMECORE_LIGHTTEAMFIGHTFORMATIONCONFIG_METHOD_2_41F8109879560C3A_OFFSET UNITYSDK_OFFSET(0x1D1F1CA0)
#define RPG_GAMECORE_LIGHTTEAMFIGHTFORMATIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1F1F80)
