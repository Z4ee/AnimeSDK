...
#define RPG_GAMECORE_FIVEDIMPLAYERSTATELISTENERCONFIG_METHOD_3_A79DEDA27655D41A_OFFSET UNITYSDK_OFFSET(0x17203120)
#define RPG_GAMECORE_FIVEDIMPLAYERSTATELISTENERCONFIG_METHOD_3_BDFC6AB78B2657E9_OFFSET UNITYSDK_OFFSET(0x172030B0)
#define RPG_GAMECORE_FIVEDIMPLAYERSTATELISTENERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17203100)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimPlayerStateListenerConfig_TypeDefinitionIndex = 17078;
