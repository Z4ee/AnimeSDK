...
#define RPG_GAMECORE_ROGUEMODIFIERADDMAZEBUFFONENTERROOMCONFIG_METHOD_3_630DAE7EA269BD4F_OFFSET UNITYSDK_OFFSET(0x1CFBEED0)
#define RPG_GAMECORE_ROGUEMODIFIERADDMAZEBUFFONENTERROOMCONFIG_METHOD_3_FF041B991FC39613_OFFSET UNITYSDK_OFFSET(0x1CFBEF20)
#define RPG_GAMECORE_ROGUEMODIFIERADDMAZEBUFFONENTERROOMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFBEF10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierAddMazeBuffOnEnterRoomConfig_TypeDefinitionIndex = 17222;
