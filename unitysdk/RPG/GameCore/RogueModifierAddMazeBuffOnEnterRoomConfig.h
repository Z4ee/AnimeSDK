...
#define RPG_GAMECORE_ROGUEMODIFIERADDMAZEBUFFONENTERROOMCONFIG_METHOD_3_C1C7FA7FFE02585A_OFFSET UNITYSDK_OFFSET(0x1761CD40)
#define RPG_GAMECORE_ROGUEMODIFIERADDMAZEBUFFONENTERROOMCONFIG_METHOD_3_FF041B991FC39613_OFFSET UNITYSDK_OFFSET(0x1761CE10)
#define RPG_GAMECORE_ROGUEMODIFIERADDMAZEBUFFONENTERROOMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1761CDC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierAddMazeBuffOnEnterRoomConfig_TypeDefinitionIndex = 16493;
