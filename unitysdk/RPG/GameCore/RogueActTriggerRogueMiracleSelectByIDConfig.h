...
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMIRACLESELECTBYIDCONFIG_METHOD_6_199FA554E3866CD8_OFFSET UNITYSDK_OFFSET(0x18CD9290)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMIRACLESELECTBYIDCONFIG_METHOD_6_B222CB112BD81515_OFFSET UNITYSDK_OFFSET(0x18CD94B0)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMIRACLESELECTBYIDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CD93D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActTriggerRogueMiracleSelectByIDConfig_TypeDefinitionIndex = 18598;
