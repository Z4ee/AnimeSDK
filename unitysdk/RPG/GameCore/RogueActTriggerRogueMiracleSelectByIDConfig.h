...
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMIRACLESELECTBYIDCONFIG_METHOD_6_B222CB112BD81515_OFFSET UNITYSDK_OFFSET(0x1C49EDF0)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMIRACLESELECTBYIDCONFIG_METHOD_6_CECF5338CFF01AF1_OFFSET UNITYSDK_OFFSET(0x1C49EDA0)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMIRACLESELECTBYIDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C49EDE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActTriggerRogueMiracleSelectByIDConfig_TypeDefinitionIndex = 18841;
