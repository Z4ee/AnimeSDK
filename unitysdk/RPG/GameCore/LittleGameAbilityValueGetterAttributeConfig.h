...
#define RPG_GAMECORE_LITTLEGAMEABILITYVALUEGETTERATTRIBUTECONFIG_METHOD_3_5184CEAED90FECF9_OFFSET UNITYSDK_OFFSET(0x1BCBCF70)
#define RPG_GAMECORE_LITTLEGAMEABILITYVALUEGETTERATTRIBUTECONFIG_METHOD_3_69D585133B82BF57_OFFSET UNITYSDK_OFFSET(0x1BCBCF10)
#define RPG_GAMECORE_LITTLEGAMEABILITYVALUEGETTERATTRIBUTECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCBCF60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityValueGetterAttributeConfig_TypeDefinitionIndex = 20587;
