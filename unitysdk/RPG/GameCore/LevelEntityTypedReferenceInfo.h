...
#define RPG_GAMECORE_LEVELENTITYTYPEDREFERENCEINFO_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1C113730)
#define RPG_GAMECORE_LEVELENTITYTYPEDREFERENCEINFO_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C113FD0)
#define RPG_GAMECORE_LEVELENTITYTYPEDREFERENCEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1C113720)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelEntityTypedReferenceInfo_TypeDefinitionIndex = 17044;
