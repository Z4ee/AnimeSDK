...
#define RPG_GAMECORE_LEVELENTITYTYPEDREFERENCEINFO_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1D1D0190)
#define RPG_GAMECORE_LEVELENTITYTYPEDREFERENCEINFO_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D1D0A30)
#define RPG_GAMECORE_LEVELENTITYTYPEDREFERENCEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1D0180)
