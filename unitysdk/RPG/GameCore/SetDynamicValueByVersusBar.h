...
#define RPG_GAMECORE_SETDYNAMICVALUEBYVERSUSBAR_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1D4F8E60)
#define RPG_GAMECORE_SETDYNAMICVALUEBYVERSUSBAR_METHOD_4_441FD9EAA491E815_OFFSET UNITYSDK_OFFSET(0x1D4F8C30)
#define RPG_GAMECORE_SETDYNAMICVALUEBYVERSUSBAR_METHOD_4_844C613DC2F01188_OFFSET UNITYSDK_OFFSET(0x1D4F8BF0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYVERSUSBAR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4F8C20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByVersusBar_TypeDefinitionIndex = 22886;
