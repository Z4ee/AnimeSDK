...
#define RPG_GAMECORE_SETDYNAMICVALUEBYVERSUSBAR_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x19C47540)
#define RPG_GAMECORE_SETDYNAMICVALUEBYVERSUSBAR_METHOD_4_2FA9D55D500C5B75_OFFSET UNITYSDK_OFFSET(0x19C47240)
#define RPG_GAMECORE_SETDYNAMICVALUEBYVERSUSBAR_METHOD_4_441FD9EAA491E815_OFFSET UNITYSDK_OFFSET(0x19C47310)
#define RPG_GAMECORE_SETDYNAMICVALUEBYVERSUSBAR__CTOR_OFFSET UNITYSDK_OFFSET(0x19C472C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByVersusBar_TypeDefinitionIndex = 21890;
