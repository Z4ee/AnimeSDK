...
#define RPG_GAMECORE_SETDYNAMICVALUEBYVERSUSBAR_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x176C72B0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYVERSUSBAR_METHOD_4_2FA9D55D500C5B75_OFFSET UNITYSDK_OFFSET(0x176C6FB0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYVERSUSBAR_METHOD_4_441FD9EAA491E815_OFFSET UNITYSDK_OFFSET(0x176C7080)
#define RPG_GAMECORE_SETDYNAMICVALUEBYVERSUSBAR__CTOR_OFFSET UNITYSDK_OFFSET(0x176C7030)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByVersusBar_TypeDefinitionIndex = 21375;
