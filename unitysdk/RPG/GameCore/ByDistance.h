...
#define RPG_GAMECORE_BYDISTANCE_METHOD_4_1344447CA47347D4_OFFSET UNITYSDK_OFFSET(0x1A8BE010)
#define RPG_GAMECORE_BYDISTANCE_METHOD_4_3AC116D65CDC79AB_OFFSET UNITYSDK_OFFSET(0x1A8BDCB0)
#define RPG_GAMECORE_BYDISTANCE_METHOD_4_3ED5690476160643_OFFSET UNITYSDK_OFFSET(0x1A8BDFD0)
#define RPG_GAMECORE_BYDISTANCE_METHOD_4_E839AE69916489E1_OFFSET UNITYSDK_OFFSET(0x1A8BDD00)
#define RPG_GAMECORE_BYDISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8BDCF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByDistance_TypeDefinitionIndex = 19987;
