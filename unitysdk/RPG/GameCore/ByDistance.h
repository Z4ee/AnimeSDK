...
#define RPG_GAMECORE_BYDISTANCE_METHOD_4_BDB64190ABC520A0_OFFSET UNITYSDK_OFFSET(0x17020A60)
#define RPG_GAMECORE_BYDISTANCE_METHOD_4_E839AE69916489E1_OFFSET UNITYSDK_OFFSET(0x17020B40)
#define RPG_GAMECORE_BYDISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x17020AE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByDistance_TypeDefinitionIndex = 19092;
