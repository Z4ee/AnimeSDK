...
#define RPG_GAMECORE_EDITORPROPTAGCOMPONENTOVERRIDECONFIG_METHOD_2_8F35A74C99218989_OFFSET UNITYSDK_OFFSET(0x1DB21BF0)
#define RPG_GAMECORE_EDITORPROPTAGCOMPONENTOVERRIDECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB21C30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EditorPropTagComponentOverrideConfig_TypeDefinitionIndex = 17065;
