...
#define RPG_GAMECORE_EDITORPROPTAGCOMPONENTOVERRIDECONFIG_METHOD_2_8F35A74C99218989_OFFSET UNITYSDK_OFFSET(0x196D3A60)
#define RPG_GAMECORE_EDITORPROPTAGCOMPONENTOVERRIDECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x196D3AA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EditorPropTagComponentOverrideConfig_TypeDefinitionIndex = 16411;
