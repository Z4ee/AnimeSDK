...
#define RPG_GAMECORE_AVATARGLOBALBUFFCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1949A1C0)
#define RPG_GAMECORE_AVATARGLOBALBUFFCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1949B330)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AvatarGlobalBuffConfigRow_TypeDefinitionIndex = 12182;

	class AvatarGlobalBuffConfigRow : public ::System::Object
	{
	public:
		::Il2CppArray<::System::UInt32>* StageTypeBlackList; // 0x10
		::Il2CppArray<::System::UInt32>* TeamStageTypeBlackList; // 0x18
		::Il2CppArray<::System::UInt32>* TeamBlackList; // 0x20
		::Il2CppArray<::System::UInt32>* TrialBagStageTypeWhiteList; // 0x28
		::Il2CppArray<::RPG::GameCore::FixPoint>* ParamList; // 0x30
		::Il2CppArray<::System::UInt32>* GameModeBlackList; // 0x38
		::Il2CppArray<::System::UInt32>* SimpleExtraEffectIDList; // 0x40
		::Il2CppArray<::RPG::GameCore::FixPoint>* SimpleParamList; // 0x48
		::Il2CppArray<::System::UInt32>* ExtraEffectIDList; // 0x50
		::System::UInt32 MazeBuffID; // 0x58
		::RPG::Client::TextID SimpleDesc; // 0x60
