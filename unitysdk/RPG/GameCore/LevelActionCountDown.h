...
#define RPG_GAMECORE_LEVELACTIONCOUNTDOWN_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1BDE8470)
#define RPG_GAMECORE_LEVELACTIONCOUNTDOWN_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x1BDE8420)
#define RPG_GAMECORE_LEVELACTIONCOUNTDOWN_INIT_OFFSET UNITYSDK_OFFSET(0x1BDE83C0)
#define RPG_GAMECORE_LEVELACTIONCOUNTDOWN__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDE84C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelActionCountDown_TypeDefinitionIndex = 54275;

	class LevelActionCountDown : public ::Class_1_BF7A075734D15E98
	{
	public:
		::RPG::GameCore::GameEntity* TriggerEntity; // 0x18
		::System::Int32 RemainingCount; // 0x20
