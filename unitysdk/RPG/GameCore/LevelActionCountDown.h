...
#define RPG_GAMECORE_LEVELACTIONCOUNTDOWN_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1844AC30)
#define RPG_GAMECORE_LEVELACTIONCOUNTDOWN_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x1844ABE0)
#define RPG_GAMECORE_LEVELACTIONCOUNTDOWN_INIT_OFFSET UNITYSDK_OFFSET(0x1844AB80)
#define RPG_GAMECORE_LEVELACTIONCOUNTDOWN__CTOR_OFFSET UNITYSDK_OFFSET(0x1844AC80)
