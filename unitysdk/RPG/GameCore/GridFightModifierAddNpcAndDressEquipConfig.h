...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDNPCANDDRESSEQUIPCONFIG_METHOD_3_5876CD01423DDCA3_OFFSET UNITYSDK_OFFSET(0x189B0F20)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDNPCANDDRESSEQUIPCONFIG_METHOD_3_AC4936E90CC9EA5A_OFFSET UNITYSDK_OFFSET(0x189B0FF0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDNPCANDDRESSEQUIPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189B0FA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierAddNpcAndDressEquipConfig_TypeDefinitionIndex = 18453;
