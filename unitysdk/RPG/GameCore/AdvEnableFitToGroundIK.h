...
#define RPG_GAMECORE_ADVENABLEFITTOGROUNDIK_METHOD_3_7643A0E367ABDB4D_OFFSET UNITYSDK_OFFSET(0x1864DED0)
#define RPG_GAMECORE_ADVENABLEFITTOGROUNDIK_METHOD_3_C9207BC014149761_OFFSET UNITYSDK_OFFSET(0x1864DF50)
#define RPG_GAMECORE_ADVENABLEFITTOGROUNDIK__CTOR_OFFSET UNITYSDK_OFFSET(0x1864DF20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvEnableFitToGroundIK_TypeDefinitionIndex = 21282;
