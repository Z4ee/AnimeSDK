...
#define RPG_GAMECORE_ADVENABLEFITTOGROUNDIK_METHOD_3_0BBB8EDD905F9CDE_OFFSET UNITYSDK_OFFSET(0x1BE1A190)
#define RPG_GAMECORE_ADVENABLEFITTOGROUNDIK_METHOD_3_C9207BC014149761_OFFSET UNITYSDK_OFFSET(0x1BE1A1D0)
#define RPG_GAMECORE_ADVENABLEFITTOGROUNDIK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE1A1C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvEnableFitToGroundIK_TypeDefinitionIndex = 21590;
