...
#define RPG_GAMECORE_ADVENABLEFITTOGROUNDIK_METHOD_3_7643A0E367ABDB4D_OFFSET UNITYSDK_OFFSET(0x194216B0)
#define RPG_GAMECORE_ADVENABLEFITTOGROUNDIK_METHOD_3_C9207BC014149761_OFFSET UNITYSDK_OFFSET(0x19421730)
#define RPG_GAMECORE_ADVENABLEFITTOGROUNDIK__CTOR_OFFSET UNITYSDK_OFFSET(0x19421700)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvEnableFitToGroundIK_TypeDefinitionIndex = 21175;
