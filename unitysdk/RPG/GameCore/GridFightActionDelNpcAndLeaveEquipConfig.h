...
#define RPG_GAMECORE_GRIDFIGHTACTIONDELNPCANDLEAVEEQUIPCONFIG_METHOD_6_4837852A4036AC1D_OFFSET UNITYSDK_OFFSET(0x189A03B0)
#define RPG_GAMECORE_GRIDFIGHTACTIONDELNPCANDLEAVEEQUIPCONFIG_METHOD_6_4D84F746ECC9758E_OFFSET UNITYSDK_OFFSET(0x1899F960)
#define RPG_GAMECORE_GRIDFIGHTACTIONDELNPCANDLEAVEEQUIPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1899F8C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightActionDelNpcAndLeaveEquipConfig_TypeDefinitionIndex = 18351;
