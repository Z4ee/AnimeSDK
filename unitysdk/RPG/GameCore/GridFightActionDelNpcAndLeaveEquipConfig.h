...
#define RPG_GAMECORE_GRIDFIGHTACTIONDELNPCANDLEAVEEQUIPCONFIG_METHOD_6_4837852A4036AC1D_OFFSET UNITYSDK_OFFSET(0x17250C00)
#define RPG_GAMECORE_GRIDFIGHTACTIONDELNPCANDLEAVEEQUIPCONFIG_METHOD_6_4D84F746ECC9758E_OFFSET UNITYSDK_OFFSET(0x172501B0)
#define RPG_GAMECORE_GRIDFIGHTACTIONDELNPCANDLEAVEEQUIPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17250110)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightActionDelNpcAndLeaveEquipConfig_TypeDefinitionIndex = 17738;
