...
#define RPG_GAMECORE_SETCHARACTERCUSTOMTEAMFORMATION_METHOD_3_41BBE39AC0E2AE10_OFFSET UNITYSDK_OFFSET(0x176AD1C0)
#define RPG_GAMECORE_SETCHARACTERCUSTOMTEAMFORMATION_METHOD_3_8117B2BFD656B32D_OFFSET UNITYSDK_OFFSET(0x176AD260)
#define RPG_GAMECORE_SETCHARACTERCUSTOMTEAMFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x176AD220)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetCharacterCustomTeamFormation_TypeDefinitionIndex = 20826;
