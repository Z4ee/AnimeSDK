...
#define RPG_GAMECORE_MARBLEMATCHGROUPSTAGERANKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x198D1E70)
#define RPG_GAMECORE_MARBLEMATCHGROUPSTAGERANKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x198D2090)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleMatchGroupStageRankRow_TypeDefinitionIndex = 11359;

	class MarbleMatchGroupStageRankRow : public ::System::Object
	{
	public:
		::System::UInt32 LostNum; // 0x10
		::System::UInt32 ID; // 0x14
		::System::UInt32 Index; // 0x18
		::System::UInt32 PlayerID; // 0x1C
		::System::UInt32 WinNum; // 0x20
