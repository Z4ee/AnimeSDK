...
#define RPG_GAMECORE_MARBLEMATCHGROUPSTAGERANKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D4AAFF0)
#define RPG_GAMECORE_MARBLEMATCHGROUPSTAGERANKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4AB210)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleMatchGroupStageRankRow_TypeDefinitionIndex = 11848;
	...
	public:
		...
		::System::UInt32 WinNum; // 0x18
		::System::UInt32 Rank; // 0x1C
		::System::UInt32 LostNum; // 0x20
		::System::UInt32 PlayerID; // 0x24
