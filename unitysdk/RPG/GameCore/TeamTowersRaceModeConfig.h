...
#define RPG_GAMECORE_TEAMTOWERSRACEMODECONFIG_METHOD_2_BA35F4CC8B9AC8DB_OFFSET UNITYSDK_OFFSET(0x1D5C6400)
#define RPG_GAMECORE_TEAMTOWERSRACEMODECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5C6830)
