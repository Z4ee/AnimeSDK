...
#define RPG_GAMECORE_CAKERACEWAITDRAGPROP_METHOD_3_24AB9ACAB5C2C241_OFFSET UNITYSDK_OFFSET(0x170509D0)
#define RPG_GAMECORE_CAKERACEWAITDRAGPROP_METHOD_3_CD2FB5707335E510_OFFSET UNITYSDK_OFFSET(0x17050A50)
#define RPG_GAMECORE_CAKERACEWAITDRAGPROP__CTOR_OFFSET UNITYSDK_OFFSET(0x17050A20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceWaitDragProp_TypeDefinitionIndex = 22342;
