...
#define RPG_GAMECORE_CAKERACEWAITDRAGPROP_METHOD_3_CD2FB5707335E510_OFFSET UNITYSDK_OFFSET(0x1B707500)
#define RPG_GAMECORE_CAKERACEWAITDRAGPROP_METHOD_3_EBB77624CE7D9975_OFFSET UNITYSDK_OFFSET(0x1B7074C0)
#define RPG_GAMECORE_CAKERACEWAITDRAGPROP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7074F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceWaitDragProp_TypeDefinitionIndex = 23443;
