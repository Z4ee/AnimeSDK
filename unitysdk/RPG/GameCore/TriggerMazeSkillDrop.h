...
#define RPG_GAMECORE_TRIGGERMAZESKILLDROP_METHOD_3_E408C7E05ECBF60A_OFFSET UNITYSDK_OFFSET(0x1D601210)
#define RPG_GAMECORE_TRIGGERMAZESKILLDROP_METHOD_3_FED15E8FF416B957_OFFSET UNITYSDK_OFFSET(0x1D6011D0)
#define RPG_GAMECORE_TRIGGERMAZESKILLDROP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D601200)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerMazeSkillDrop_TypeDefinitionIndex = 21509;
