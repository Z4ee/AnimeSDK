...
#define RPG_GAMECORE_TRIGGERMAZESKILLDROP_METHOD_3_E408C7E05ECBF60A_OFFSET UNITYSDK_OFFSET(0x1D290860)
#define RPG_GAMECORE_TRIGGERMAZESKILLDROP_METHOD_3_FED15E8FF416B957_OFFSET UNITYSDK_OFFSET(0x1D290820)
#define RPG_GAMECORE_TRIGGERMAZESKILLDROP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D290850)
