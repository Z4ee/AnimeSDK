...
#define RPG_GAMECORE_DEFINEHPSHAREDGROUP_METHOD_3_08E35FE2E4008812_OFFSET UNITYSDK_OFFSET(0x18859030)
#define RPG_GAMECORE_DEFINEHPSHAREDGROUP_METHOD_3_2A4ACF4D434BB00C_OFFSET UNITYSDK_OFFSET(0x188590B0)
#define RPG_GAMECORE_DEFINEHPSHAREDGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x18859080)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DefineHPSharedGroup_TypeDefinitionIndex = 21734;
