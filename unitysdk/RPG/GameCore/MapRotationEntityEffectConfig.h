...
#define RPG_GAMECORE_MAPROTATIONENTITYEFFECTCONFIG_METHOD_2_237C6CD412A34839_OFFSET UNITYSDK_OFFSET(0x1BCE4410)
#define RPG_GAMECORE_MAPROTATIONENTITYEFFECTCONFIG_METHOD_2_B28EAC3C4A8DDF34_OFFSET UNITYSDK_OFFSET(0x1BCE4280)
#define RPG_GAMECORE_MAPROTATIONENTITYEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCE4400)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MapRotationEntityEffectConfig_TypeDefinitionIndex = 16347;
