...
#define RPG_GAMECORE_RENDERTESTJSON_METHOD_2_76ED19F6F4764241_OFFSET UNITYSDK_OFFSET(0x1D3A15D0)
#define RPG_GAMECORE_RENDERTESTJSON__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3A17C0)
