...
#define RPG_GAMECORE_RENDERTESTJSON_METHOD_2_76ED19F6F4764241_OFFSET UNITYSDK_OFFSET(0x18CA6DD0)
#define RPG_GAMECORE_RENDERTESTJSON__CTOR_OFFSET UNITYSDK_OFFSET(0x18CA6FD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RenderTestJson_TypeDefinitionIndex = 23419;
