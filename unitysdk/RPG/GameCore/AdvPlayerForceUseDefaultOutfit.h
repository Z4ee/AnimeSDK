...
#define RPG_GAMECORE_ADVPLAYERFORCEUSEDEFAULTOUTFIT_METHOD_3_5F02A21CE6628D7A_OFFSET UNITYSDK_OFFSET(0x16F3B9F0)
#define RPG_GAMECORE_ADVPLAYERFORCEUSEDEFAULTOUTFIT_METHOD_3_610B9B8E3CBD2003_OFFSET UNITYSDK_OFFSET(0x16F3B920)
#define RPG_GAMECORE_ADVPLAYERFORCEUSEDEFAULTOUTFIT__CTOR_OFFSET UNITYSDK_OFFSET(0x16F3B9A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvPlayerForceUseDefaultOutfit_TypeDefinitionIndex = 19359;
