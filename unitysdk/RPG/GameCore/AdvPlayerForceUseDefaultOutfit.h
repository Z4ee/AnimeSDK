...
#define RPG_GAMECORE_ADVPLAYERFORCEUSEDEFAULTOUTFIT_METHOD_3_0EAC55B0C21CBABA_OFFSET UNITYSDK_OFFSET(0x1D6C3840)
#define RPG_GAMECORE_ADVPLAYERFORCEUSEDEFAULTOUTFIT_METHOD_3_B6CA1272C86EAAC3_OFFSET UNITYSDK_OFFSET(0x1D6C38E0)
#define RPG_GAMECORE_ADVPLAYERFORCEUSEDEFAULTOUTFIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6C38A0)
