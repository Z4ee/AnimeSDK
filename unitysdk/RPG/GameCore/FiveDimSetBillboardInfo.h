...
#define RPG_GAMECORE_FIVEDIMSETBILLBOARDINFO_METHOD_2_4A4299D423155B80_OFFSET UNITYSDK_OFFSET(0x1891A670)
#define RPG_GAMECORE_FIVEDIMSETBILLBOARDINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1891A8A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSetBillboardInfo_TypeDefinitionIndex = 20365;
