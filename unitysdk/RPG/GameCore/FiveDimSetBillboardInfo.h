...
#define RPG_GAMECORE_FIVEDIMSETBILLBOARDINFO_METHOD_2_4A4299D423155B80_OFFSET UNITYSDK_OFFSET(0x19753D80)
#define RPG_GAMECORE_FIVEDIMSETBILLBOARDINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19753FB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSetBillboardInfo_TypeDefinitionIndex = 20285;
