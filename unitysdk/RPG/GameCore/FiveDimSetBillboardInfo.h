...
#define RPG_GAMECORE_FIVEDIMSETBILLBOARDINFO_METHOD_2_4A4299D423155B80_OFFSET UNITYSDK_OFFSET(0x1BEAFE60)
#define RPG_GAMECORE_FIVEDIMSETBILLBOARDINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEB0090)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSetBillboardInfo_TypeDefinitionIndex = 20679;
