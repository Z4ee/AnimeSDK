...
#define RPG_GAMECORE_ELATIONCAMERAWHITEBOXCONFIG_METHOD_2_9A95506F21538684_OFFSET UNITYSDK_OFFSET(0x196D67F0)
#define RPG_GAMECORE_ELATIONCAMERAWHITEBOXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x196D6980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElationCameraWhiteBoxConfig_TypeDefinitionIndex = 15722;
