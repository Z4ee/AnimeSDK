...
#define RPG_GAMECORE_ELATIONCAMERAWHITEBOXCONFIG_METHOD_2_9A95506F21538684_OFFSET UNITYSDK_OFFSET(0x1718A940)
#define RPG_GAMECORE_ELATIONCAMERAWHITEBOXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1718AAD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElationCameraWhiteBoxConfig_TypeDefinitionIndex = 15155;
