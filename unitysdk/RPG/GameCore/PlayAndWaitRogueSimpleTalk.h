...
#define RPG_GAMECORE_PLAYANDWAITROGUESIMPLETALK_METHOD_3_1B918ADFABD5C5F7_OFFSET UNITYSDK_OFFSET(0x18C0C110)
#define RPG_GAMECORE_PLAYANDWAITROGUESIMPLETALK_METHOD_3_6AB370BCC55421E6_OFFSET UNITYSDK_OFFSET(0x18C0C190)
#define RPG_GAMECORE_PLAYANDWAITROGUESIMPLETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x18C0C160)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayAndWaitRogueSimpleTalk_TypeDefinitionIndex = 20088;
