...
#define RPG_GAMECORE_PLAYANDWAITROGUESIMPLETALK_METHOD_3_295F341ADA9529E5_OFFSET UNITYSDK_OFFSET(0x1D7A2FC0)
#define RPG_GAMECORE_PLAYANDWAITROGUESIMPLETALK_METHOD_3_6AB370BCC55421E6_OFFSET UNITYSDK_OFFSET(0x1D7A3000)
#define RPG_GAMECORE_PLAYANDWAITROGUESIMPLETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7A2FF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayAndWaitRogueSimpleTalk_TypeDefinitionIndex = 20868;
