...
#define RPG_GAMECORE_PLAYANDWAITROGUESIMPLETALK_METHOD_3_1B918ADFABD5C5F7_OFFSET UNITYSDK_OFFSET(0x174C0B00)
#define RPG_GAMECORE_PLAYANDWAITROGUESIMPLETALK_METHOD_3_6AB370BCC55421E6_OFFSET UNITYSDK_OFFSET(0x174C0B80)
#define RPG_GAMECORE_PLAYANDWAITROGUESIMPLETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x174C0B50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayAndWaitRogueSimpleTalk_TypeDefinitionIndex = 19415;
