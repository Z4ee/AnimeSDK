...
#define RPG_GAMECORE_RESTAURANTSPECIALCUSTOMERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x175AAB40)
#define RPG_GAMECORE_RESTAURANTSPECIALCUSTOMERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x175AACC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RestaurantSpecialCustomerRow_TypeDefinitionIndex = 10621;
