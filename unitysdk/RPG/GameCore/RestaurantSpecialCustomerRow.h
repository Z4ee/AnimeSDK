...
#define RPG_GAMECORE_RESTAURANTSPECIALCUSTOMERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19ADAF30)
#define RPG_GAMECORE_RESTAURANTSPECIALCUSTOMERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19ADB0B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RestaurantSpecialCustomerRow_TypeDefinitionIndex = 10926;
