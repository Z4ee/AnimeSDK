...
#define RPG_GAMECORE_RESTAURANTSPECIALCUSTOMERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D3B0330)
#define RPG_GAMECORE_RESTAURANTSPECIALCUSTOMERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3B04B0)
