...
#define RPG_GAMECORE_VE_RTBATTLERANKPARAMBYCHARACTERID_METHOD_3_290ED19C23A9B4F4_OFFSET UNITYSDK_OFFSET(0x1B891B70)
#define RPG_GAMECORE_VE_RTBATTLERANKPARAMBYCHARACTERID_METHOD_3_3A1314EB0129375C_OFFSET UNITYSDK_OFFSET(0x1B891D10)
#define RPG_GAMECORE_VE_RTBATTLERANKPARAMBYCHARACTERID_METHOD_3_556C75E562F746F1_OFFSET UNITYSDK_OFFSET(0x1B891B30)
#define RPG_GAMECORE_VE_RTBATTLERANKPARAMBYCHARACTERID_METHOD_3_91C524E174C80F2B_OFFSET UNITYSDK_OFFSET(0x1B891D40)
#define RPG_GAMECORE_VE_RTBATTLERANKPARAMBYCHARACTERID__CTOR_OFFSET UNITYSDK_OFFSET(0x1B891B60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VE_RtBattleRankParamByCharacterID_TypeDefinitionIndex = 23408;
