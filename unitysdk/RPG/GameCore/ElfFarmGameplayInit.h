...
#define RPG_GAMECORE_ELFFARMGAMEPLAYINIT_METHOD_3_303C7927CFAD6B6C_OFFSET UNITYSDK_OFFSET(0x1718E920)
#define RPG_GAMECORE_ELFFARMGAMEPLAYINIT_METHOD_3_D53C0252AE924560_OFFSET UNITYSDK_OFFSET(0x1718E810)
#define RPG_GAMECORE_ELFFARMGAMEPLAYINIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1718E8F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfFarmGameplayInit_TypeDefinitionIndex = 19389;
