...
#define RPG_GAMECORE_DAILYACTIVEQUESTPOOLROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1884C750)
#define RPG_GAMECORE_DAILYACTIVEQUESTPOOLROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1884C870)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DailyActiveQuestPoolRow_TypeDefinitionIndex = 12393;
