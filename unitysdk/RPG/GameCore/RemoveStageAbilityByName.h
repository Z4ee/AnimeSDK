...
#define RPG_GAMECORE_REMOVESTAGEABILITYBYNAME_METHOD_3_D158EC5836889829_OFFSET UNITYSDK_OFFSET(0x1D3A04D0)
#define RPG_GAMECORE_REMOVESTAGEABILITYBYNAME_METHOD_3_F3F3DBA230468BFA_OFFSET UNITYSDK_OFFSET(0x1D3A0510)
#define RPG_GAMECORE_REMOVESTAGEABILITYBYNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3A0500)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveStageAbilityByName_TypeDefinitionIndex = 22715;
