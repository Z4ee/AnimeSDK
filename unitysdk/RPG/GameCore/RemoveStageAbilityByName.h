...
#define RPG_GAMECORE_REMOVESTAGEABILITYBYNAME_METHOD_3_F3F3DBA230468BFA_OFFSET UNITYSDK_OFFSET(0x18CA5B90)
#define RPG_GAMECORE_REMOVESTAGEABILITYBYNAME_METHOD_3_FB609807627154F3_OFFSET UNITYSDK_OFFSET(0x18CA5B10)
#define RPG_GAMECORE_REMOVESTAGEABILITYBYNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x18CA5B60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveStageAbilityByName_TypeDefinitionIndex = 21895;
