...
#define RPG_GAMECORE_INCREASEMISSIONCUSTOMVALUE_METHOD_3_014E15FB00297A7C_OFFSET UNITYSDK_OFFSET(0x1984E1A0)
#define RPG_GAMECORE_INCREASEMISSIONCUSTOMVALUE_METHOD_3_0B434CC5A02F8523_OFFSET UNITYSDK_OFFSET(0x1984E120)
#define RPG_GAMECORE_INCREASEMISSIONCUSTOMVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1984E170)

namespace RPG::GameCore
{
	inline static constexpr unsigned int IncreaseMissionCustomValue_TypeDefinitionIndex = 19304;
