...
#define RPG_GAMECORE_TARGETMAPBATTLEEVENTCASTER_METHOD_3_05BED5382E8D10E7_OFFSET UNITYSDK_OFFSET(0x1D0C1080)
#define RPG_GAMECORE_TARGETMAPBATTLEEVENTCASTER_METHOD_3_85C8DEF69D2C2595_OFFSET UNITYSDK_OFFSET(0x1D0C0FE0)
#define RPG_GAMECORE_TARGETMAPBATTLEEVENTCASTER_METHOD_3_896A481A17C20163_OFFSET UNITYSDK_OFFSET(0x1D0C1040)
#define RPG_GAMECORE_TARGETMAPBATTLEEVENTCASTER_METHOD_3_D4C38696BD0D4A90_OFFSET UNITYSDK_OFFSET(0x1D0C0F40)
#define RPG_GAMECORE_TARGETMAPBATTLEEVENTCASTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0C0FD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapBattleEventCaster_TypeDefinitionIndex = 23075;
