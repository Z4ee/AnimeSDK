...
#define RPG_GAMECORE_TARGETMAPBATTLEEVENTCASTER_METHOD_3_0E258C843348FE63_OFFSET UNITYSDK_OFFSET(0x177C2110)
#define RPG_GAMECORE_TARGETMAPBATTLEEVENTCASTER_METHOD_3_85C8DEF69D2C2595_OFFSET UNITYSDK_OFFSET(0x177C21F0)
#define RPG_GAMECORE_TARGETMAPBATTLEEVENTCASTER__CTOR_OFFSET UNITYSDK_OFFSET(0x177C21D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapBattleEventCaster_TypeDefinitionIndex = 22207;
