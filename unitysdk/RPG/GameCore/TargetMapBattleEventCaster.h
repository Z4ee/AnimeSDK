...
#define RPG_GAMECORE_TARGETMAPBATTLEEVENTCASTER_METHOD_3_05BED5382E8D10E7_OFFSET UNITYSDK_OFFSET(0x19D12300)
#define RPG_GAMECORE_TARGETMAPBATTLEEVENTCASTER_METHOD_3_0C59382F5629B177_OFFSET UNITYSDK_OFFSET(0x19D122A0)
#define RPG_GAMECORE_TARGETMAPBATTLEEVENTCASTER_METHOD_3_0E258C843348FE63_OFFSET UNITYSDK_OFFSET(0x19D12160)
#define RPG_GAMECORE_TARGETMAPBATTLEEVENTCASTER_METHOD_3_85C8DEF69D2C2595_OFFSET UNITYSDK_OFFSET(0x19D12240)
#define RPG_GAMECORE_TARGETMAPBATTLEEVENTCASTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19D12220)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapBattleEventCaster_TypeDefinitionIndex = 22612;
	...
	public:
		...
		static ::System::Void Method_3_0C59382F5629B177(::SimpleJSON::JSONNode* a1, ::RPG::GameCore::TargetMapBattleEventCaster*& a2)
		{
			return ((::System::Void(*)(::SimpleJSON::JSONNode*, ::RPG::GameCore::TargetMapBattleEventCaster*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_TARGETMAPBATTLEEVENTCASTER_METHOD_3_0C59382F5629B177_OFFSET))(a1, a2);
		}
