...
#define RPG_GAMECORE_UNLOCKRESHACAMERA_METHOD_3_455DB4AE8710489C_OFFSET UNITYSDK_OFFSET(0x1D624030)
#define RPG_GAMECORE_UNLOCKRESHACAMERA_METHOD_3_66D00F95BF161699_OFFSET UNITYSDK_OFFSET(0x1D624100)
#define RPG_GAMECORE_UNLOCKRESHACAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6240F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UnlockReShaCamera_TypeDefinitionIndex = 21781;
