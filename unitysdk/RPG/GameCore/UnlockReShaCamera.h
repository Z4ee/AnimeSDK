...
#define RPG_GAMECORE_UNLOCKRESHACAMERA_METHOD_3_66D00F95BF161699_OFFSET UNITYSDK_OFFSET(0x178E7520)
#define RPG_GAMECORE_UNLOCKRESHACAMERA_METHOD_3_C6299A678940B665_OFFSET UNITYSDK_OFFSET(0x178E7410)
#define RPG_GAMECORE_UNLOCKRESHACAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x178E74F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UnlockReShaCamera_TypeDefinitionIndex = 20205;
