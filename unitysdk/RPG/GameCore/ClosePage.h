...
#define RPG_GAMECORE_CLOSEPAGE_METHOD_3_DD1D042269A19E90_OFFSET UNITYSDK_OFFSET(0x1711D170)
#define RPG_GAMECORE_CLOSEPAGE_METHOD_3_FB05D32EA198D4E9_OFFSET UNITYSDK_OFFSET(0x1711D0F0)
#define RPG_GAMECORE_CLOSEPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1711D140)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClosePage_TypeDefinitionIndex = 18931;
