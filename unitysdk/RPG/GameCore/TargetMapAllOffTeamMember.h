...
#define RPG_GAMECORE_TARGETMAPALLOFFTEAMMEMBER_METHOD_3_26421B0B83F1A6CA_OFFSET UNITYSDK_OFFSET(0x18EE7420)
#define RPG_GAMECORE_TARGETMAPALLOFFTEAMMEMBER_METHOD_3_8BB250EA873004F8_OFFSET UNITYSDK_OFFSET(0x18EE7500)
#define RPG_GAMECORE_TARGETMAPALLOFFTEAMMEMBER__CTOR_OFFSET UNITYSDK_OFFSET(0x18EE74E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapAllOffTeamMember_TypeDefinitionIndex = 22940;
