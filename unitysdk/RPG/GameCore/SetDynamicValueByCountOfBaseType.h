...
#define RPG_GAMECORE_SETDYNAMICVALUEBYCOUNTOFBASETYPE_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x19C40D70)
#define RPG_GAMECORE_SETDYNAMICVALUEBYCOUNTOFBASETYPE_METHOD_4_081408ADB076708B_OFFSET UNITYSDK_OFFSET(0x19C38A50)
#define RPG_GAMECORE_SETDYNAMICVALUEBYCOUNTOFBASETYPE_METHOD_4_46FF1741738D9B0A_OFFSET UNITYSDK_OFFSET(0x19C40CF0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYCOUNTOFBASETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C389F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByCountOfBaseType_TypeDefinitionIndex = 22302;
	...
	public:
		...
		static ::System::Void Method_4_46FF1741738D9B0A(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::SetDynamicValueByCountOfBaseType*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::SetDynamicValueByCountOfBaseType*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_SETDYNAMICVALUEBYCOUNTOFBASETYPE_METHOD_4_46FF1741738D9B0A_OFFSET))(a1, a2);
		}
