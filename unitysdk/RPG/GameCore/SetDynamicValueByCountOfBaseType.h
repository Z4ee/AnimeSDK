...
#define RPG_GAMECORE_SETDYNAMICVALUEBYCOUNTOFBASETYPE_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x18E1F380)
#define RPG_GAMECORE_SETDYNAMICVALUEBYCOUNTOFBASETYPE_METHOD_4_5D2623A726D78FE8_OFFSET UNITYSDK_OFFSET(0x18E1F060)
#define RPG_GAMECORE_SETDYNAMICVALUEBYCOUNTOFBASETYPE_METHOD_4_68A020F9F4718C40_OFFSET UNITYSDK_OFFSET(0x18E1EF80)
#define RPG_GAMECORE_SETDYNAMICVALUEBYCOUNTOFBASETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E1F000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByCountOfBaseType_TypeDefinitionIndex = 22564;
