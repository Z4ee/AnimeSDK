...
#define RPG_GAMECORE_SETDYNAMICVALUEBYCOUNTOFBASETYPE_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1C2E0D40)
#define RPG_GAMECORE_SETDYNAMICVALUEBYCOUNTOFBASETYPE_METHOD_4_081408ADB076708B_OFFSET UNITYSDK_OFFSET(0x1C2E0A60)
#define RPG_GAMECORE_SETDYNAMICVALUEBYCOUNTOFBASETYPE_METHOD_4_90CADB2D5538FE09_OFFSET UNITYSDK_OFFSET(0x1C2E0A00)
#define RPG_GAMECORE_SETDYNAMICVALUEBYCOUNTOFBASETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2E0A40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByCountOfBaseType_TypeDefinitionIndex = 22743;
