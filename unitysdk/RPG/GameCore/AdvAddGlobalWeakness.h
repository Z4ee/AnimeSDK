...
#define RPG_GAMECORE_ADVADDGLOBALWEAKNESS_METHOD_3_C3225BCEF018DCCA_OFFSET UNITYSDK_OFFSET(0x18645F30)
#define RPG_GAMECORE_ADVADDGLOBALWEAKNESS_METHOD_3_FF5353DD98909ABB_OFFSET UNITYSDK_OFFSET(0x18645FB0)
#define RPG_GAMECORE_ADVADDGLOBALWEAKNESS__CTOR_OFFSET UNITYSDK_OFFSET(0x18645F80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvAddGlobalWeakness_TypeDefinitionIndex = 20658;
