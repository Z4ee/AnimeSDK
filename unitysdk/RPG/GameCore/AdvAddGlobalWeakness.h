...
#define RPG_GAMECORE_ADVADDGLOBALWEAKNESS_METHOD_3_C3225BCEF018DCCA_OFFSET UNITYSDK_OFFSET(0x16F23D30)
#define RPG_GAMECORE_ADVADDGLOBALWEAKNESS_METHOD_3_FF5353DD98909ABB_OFFSET UNITYSDK_OFFSET(0x16F23DB0)
#define RPG_GAMECORE_ADVADDGLOBALWEAKNESS__CTOR_OFFSET UNITYSDK_OFFSET(0x16F23D80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvAddGlobalWeakness_TypeDefinitionIndex = 19977;
