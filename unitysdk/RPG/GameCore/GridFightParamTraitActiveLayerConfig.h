...
#define RPG_GAMECORE_GRIDFIGHTPARAMTRAITACTIVELAYERCONFIG_METHOD_6_5A89087E24081EFC_OFFSET UNITYSDK_OFFSET(0x189C8DA0)
#define RPG_GAMECORE_GRIDFIGHTPARAMTRAITACTIVELAYERCONFIG_METHOD_6_9F4576B6B6F1D712_OFFSET UNITYSDK_OFFSET(0x189C9050)
#define RPG_GAMECORE_GRIDFIGHTPARAMTRAITACTIVELAYERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189C8F20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightParamTraitActiveLayerConfig_TypeDefinitionIndex = 18520;
