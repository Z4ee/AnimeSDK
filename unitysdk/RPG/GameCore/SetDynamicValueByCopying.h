...
#define RPG_GAMECORE_SETDYNAMICVALUEBYCOPYING_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x19C40BA0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYCOPYING_METHOD_4_2652182A3D544CA4_OFFSET UNITYSDK_OFFSET(0x19C40B00)
#define RPG_GAMECORE_SETDYNAMICVALUEBYCOPYING_METHOD_4_B61700AE79374CCF_OFFSET UNITYSDK_OFFSET(0x19C386D0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYCOPYING__CTOR_OFFSET UNITYSDK_OFFSET(0x19C38650)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByCopying_TypeDefinitionIndex = 22519;
