...
#define RPG_GAMECORE_SETDYNAMICVALUEBYCOPYING_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x18E1EE30)
#define RPG_GAMECORE_SETDYNAMICVALUEBYCOPYING_METHOD_4_2652182A3D544CA4_OFFSET UNITYSDK_OFFSET(0x18E1EB10)
#define RPG_GAMECORE_SETDYNAMICVALUEBYCOPYING_METHOD_4_B61700AE79374CCF_OFFSET UNITYSDK_OFFSET(0x18E1EC30)
#define RPG_GAMECORE_SETDYNAMICVALUEBYCOPYING__CTOR_OFFSET UNITYSDK_OFFSET(0x18E1EBB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByCopying_TypeDefinitionIndex = 22818;
