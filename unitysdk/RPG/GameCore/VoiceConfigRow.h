...
#define RPG_GAMECORE_VOICECONFIGROW_FROMBINARYWITHOUTNEW_OFFSET UNITYSDK_OFFSET(0x1B89E080)
#define RPG_GAMECORE_VOICECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B89E4B0)
#define RPG_GAMECORE_VOICECONFIGROW_FROMTABLEOFFSET_OFFSET UNITYSDK_OFFSET(0x1B89F3A0)
#define RPG_GAMECORE_VOICECONFIGROW_RESET_OFFSET UNITYSDK_OFFSET(0x1B89F400)
#define RPG_GAMECORE_VOICECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B89F390)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VoiceConfigRow_TypeDefinitionIndex = 14816;
	...
	public:
		...
		::RPG::GameCore::VoicePlayType VoiceType; // 0x1C
