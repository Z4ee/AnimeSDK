...
#define RPG_GAMECORE_LITTLEGAMEABILITYTARGETSELECTORFILTERBYATTRIBUTECONFIG_METHOD_3_700B59E31F8900F6_OFFSET UNITYSDK_OFFSET(0x19895F30)
#define RPG_GAMECORE_LITTLEGAMEABILITYTARGETSELECTORFILTERBYATTRIBUTECONFIG_METHOD_3_B7793F5BB23DFB7C_OFFSET UNITYSDK_OFFSET(0x19895ED0)
#define RPG_GAMECORE_LITTLEGAMEABILITYTARGETSELECTORFILTERBYATTRIBUTECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19895F20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityTargetSelectorFilterByAttributeConfig_TypeDefinitionIndex = 20209;
