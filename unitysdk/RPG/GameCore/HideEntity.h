...
#define RPG_GAMECORE_HIDEENTITY_METHOD_3_56B73E0D5A5DEE0D_OFFSET UNITYSDK_OFFSET(0x189FE060)
#define RPG_GAMECORE_HIDEENTITY_METHOD_3_E6079BFA573CC5A1_OFFSET UNITYSDK_OFFSET(0x189FE0E0)
#define RPG_GAMECORE_HIDEENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x189FE0B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HideEntity_TypeDefinitionIndex = 20514;
