...
#define RPG_GAMECORE_TEAMTOWERSLEVELSETTINGS_METHOD_3_2B9D43AC50C2E1BA_OFFSET UNITYSDK_OFFSET(0x1D5C5FA0)
#define RPG_GAMECORE_TEAMTOWERSLEVELSETTINGS_METHOD_3_3B09C2117AA7CA95_OFFSET UNITYSDK_OFFSET(0x1D5C6000)
#define RPG_GAMECORE_TEAMTOWERSLEVELSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5C5FE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TeamTowersLevelSettings_TypeDefinitionIndex = 18731;
