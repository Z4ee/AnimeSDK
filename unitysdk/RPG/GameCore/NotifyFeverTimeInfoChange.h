...
#define RPG_GAMECORE_NOTIFYFEVERTIMEINFOCHANGE_METHOD_3_5E33D3BB38ACE999_OFFSET UNITYSDK_OFFSET(0x174756C0)
#define RPG_GAMECORE_NOTIFYFEVERTIMEINFOCHANGE_METHOD_3_9F89E5835DBFDAA7_OFFSET UNITYSDK_OFFSET(0x17475640)
#define RPG_GAMECORE_NOTIFYFEVERTIMEINFOCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x17475690)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NotifyFeverTimeInfoChange_TypeDefinitionIndex = 21483;
	...
	public:
		...
		static ::System::Void Method_3_9F89E5835DBFDAA7(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::NotifyFeverTimeInfoChange*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::NotifyFeverTimeInfoChange*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_NOTIFYFEVERTIMEINFOCHANGE_METHOD_3_9F89E5835DBFDAA7_OFFSET))(a1, a2);
		}
