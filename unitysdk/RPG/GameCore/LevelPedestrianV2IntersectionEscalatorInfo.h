...
#define RPG_GAMECORE_LEVELPEDESTRIANV2INTERSECTIONESCALATORINFO_METHOD_3_85BD9CCC8D7C4906_OFFSET UNITYSDK_OFFSET(0x17347AB0)
#define RPG_GAMECORE_LEVELPEDESTRIANV2INTERSECTIONESCALATORINFO_METHOD_3_92DBD128C1B310C8_OFFSET UNITYSDK_OFFSET(0x17347A70)
#define RPG_GAMECORE_LEVELPEDESTRIANV2INTERSECTIONESCALATORINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x17347AA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPedestrianV2IntersectionEscalatorInfo_TypeDefinitionIndex = 15890;
