...
#define RPG_GAMECORE_LEVELPEDESTRIANV2INTERSECTIONESCALATORINFO_METHOD_3_B9DE4FD8F6A0DEA7_OFFSET UNITYSDK_OFFSET(0x198842A0)
#define RPG_GAMECORE_LEVELPEDESTRIANV2INTERSECTIONESCALATORINFO_METHOD_3_F22A446D6A2BCA30_OFFSET UNITYSDK_OFFSET(0x198842E0)
#define RPG_GAMECORE_LEVELPEDESTRIANV2INTERSECTIONESCALATORINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x198842D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPedestrianV2IntersectionEscalatorInfo_TypeDefinitionIndex = 16450;
