...
#define RPG_GAMECORE_SETUPTRAINVISITORDIALOGUE_METHOD_3_53B263736309CEEC_OFFSET UNITYSDK_OFFSET(0x19C66640)
#define RPG_GAMECORE_SETUPTRAINVISITORDIALOGUE_METHOD_3_E53F1949CBEDF678_OFFSET UNITYSDK_OFFSET(0x19C66750)
#define RPG_GAMECORE_SETUPTRAINVISITORDIALOGUE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C66720)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetUpTrainVisitorDialogue_TypeDefinitionIndex = 20377;
