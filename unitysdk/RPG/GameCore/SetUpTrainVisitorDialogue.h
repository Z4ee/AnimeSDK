...
#define RPG_GAMECORE_SETUPTRAINVISITORDIALOGUE_METHOD_3_E53F1949CBEDF678_OFFSET UNITYSDK_OFFSET(0x1C60F7F0)
#define RPG_GAMECORE_SETUPTRAINVISITORDIALOGUE_METHOD_3_FD8D57F6D3F38AB5_OFFSET UNITYSDK_OFFSET(0x1C60F720)
#define RPG_GAMECORE_SETUPTRAINVISITORDIALOGUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C60F7E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetUpTrainVisitorDialogue_TypeDefinitionIndex = 20792;
