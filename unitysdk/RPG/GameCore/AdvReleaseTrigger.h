...
#define RPG_GAMECORE_ADVRELEASETRIGGER_METHOD_3_8EC2CD4E59D5D571_OFFSET UNITYSDK_OFFSET(0x16F3D360)
#define RPG_GAMECORE_ADVRELEASETRIGGER_METHOD_3_EFAA8DF0BD89DA24_OFFSET UNITYSDK_OFFSET(0x16F3D4B0)
#define RPG_GAMECORE_ADVRELEASETRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x16F3D420)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvReleaseTrigger_TypeDefinitionIndex = 18847;
