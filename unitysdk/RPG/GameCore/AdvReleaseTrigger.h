...
#define RPG_GAMECORE_ADVRELEASETRIGGER_METHOD_3_8EC2CD4E59D5D571_OFFSET UNITYSDK_OFFSET(0x1865F4F0)
#define RPG_GAMECORE_ADVRELEASETRIGGER_METHOD_3_EFAA8DF0BD89DA24_OFFSET UNITYSDK_OFFSET(0x1865F640)
#define RPG_GAMECORE_ADVRELEASETRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1865F5B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvReleaseTrigger_TypeDefinitionIndex = 19505;
