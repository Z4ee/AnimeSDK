...
#define RPG_GAMECORE_TEXTDANMUCONTENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D5C98C0)
#define RPG_GAMECORE_TEXTDANMUCONTENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5C9A40)
