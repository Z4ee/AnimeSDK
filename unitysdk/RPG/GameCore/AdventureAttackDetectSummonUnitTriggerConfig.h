...
#define RPG_GAMECORE_ADVENTUREATTACKDETECTSUMMONUNITTRIGGERCONFIG_METHOD_2_08A0B55D81DA3169_OFFSET UNITYSDK_OFFSET(0x1AE4C860)
#define RPG_GAMECORE_ADVENTUREATTACKDETECTSUMMONUNITTRIGGERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE4C960)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureAttackDetectSummonUnitTriggerConfig_TypeDefinitionIndex = 15635;
