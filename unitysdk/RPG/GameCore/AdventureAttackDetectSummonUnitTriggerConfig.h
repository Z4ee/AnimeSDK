...
#define RPG_GAMECORE_ADVENTUREATTACKDETECTSUMMONUNITTRIGGERCONFIG_METHOD_2_08A0B55D81DA3169_OFFSET UNITYSDK_OFFSET(0x1CDE17A0)
#define RPG_GAMECORE_ADVENTUREATTACKDETECTSUMMONUNITTRIGGERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDE18A0)
