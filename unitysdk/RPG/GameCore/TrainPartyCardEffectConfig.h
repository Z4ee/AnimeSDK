...
#define RPG_GAMECORE_TRAINPARTYCARDEFFECTCONFIG_METHOD_2_EBAC6B1F104745EB_OFFSET UNITYSDK_OFFSET(0x1D5DC000)
#define RPG_GAMECORE_TRAINPARTYCARDEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5DC0F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyCardEffectConfig_TypeDefinitionIndex = 17872;
