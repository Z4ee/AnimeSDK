...
#define RPG_GAMECORE_FATEACTADDMASTERAFFIXBYRARITYCONFIG_METHOD_6_073DC93498555973_OFFSET UNITYSDK_OFFSET(0x1970B060)
#define RPG_GAMECORE_FATEACTADDMASTERAFFIXBYRARITYCONFIG_METHOD_6_D724555B0D570A28_OFFSET UNITYSDK_OFFSET(0x1970AEF0)
#define RPG_GAMECORE_FATEACTADDMASTERAFFIXBYRARITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1970AFC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateActAddMasterAffixByRarityConfig_TypeDefinitionIndex = 18244;
