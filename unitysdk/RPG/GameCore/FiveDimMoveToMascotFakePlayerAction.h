...
#define RPG_GAMECORE_FIVEDIMMOVETOMASCOTFAKEPLAYERACTION_METHOD_3_4D114E7F3BEC8F2B_OFFSET UNITYSDK_OFFSET(0x1BEA5640)
#define RPG_GAMECORE_FIVEDIMMOVETOMASCOTFAKEPLAYERACTION_METHOD_3_D5C55B596381E8CA_OFFSET UNITYSDK_OFFSET(0x1BEA55C0)
#define RPG_GAMECORE_FIVEDIMMOVETOMASCOTFAKEPLAYERACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEA5630)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimMoveToMascotFakePlayerAction_TypeDefinitionIndex = 17959;
