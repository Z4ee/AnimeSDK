...
#define RPG_GAMECORE_FIVEDIMMOVETOMASCOTFAKEPLAYERACTION_METHOD_3_465A0149518052C6_OFFSET UNITYSDK_OFFSET(0x1974A600)
#define RPG_GAMECORE_FIVEDIMMOVETOMASCOTFAKEPLAYERACTION_METHOD_3_4D114E7F3BEC8F2B_OFFSET UNITYSDK_OFFSET(0x19730470)
#define RPG_GAMECORE_FIVEDIMMOVETOMASCOTFAKEPLAYERACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19730450)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimMoveToMascotFakePlayerAction_TypeDefinitionIndex = 17783;
