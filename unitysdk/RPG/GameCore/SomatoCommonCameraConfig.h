...
#define RPG_GAMECORE_SOMATOCOMMONCAMERACONFIG_METHOD_2_8EF0423777EA30A5_OFFSET UNITYSDK_OFFSET(0x1D53C330)
#define RPG_GAMECORE_SOMATOCOMMONCAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D53C4A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SomatoCommonCameraConfig_TypeDefinitionIndex = 16256;
