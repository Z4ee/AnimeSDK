...
#define RPG_GAMECORE_SOMATOCOMMONCAMERACONFIG_METHOD_2_8EF0423777EA30A5_OFFSET UNITYSDK_OFFSET(0x17710490)
#define RPG_GAMECORE_SOMATOCOMMONCAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17710600)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SomatoCommonCameraConfig_TypeDefinitionIndex = 15038;
