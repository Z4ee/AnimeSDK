...
#define RPG_GAMECORE_TRIGGERMODELSHAKE_METHOD_3_517FE5AA8A675291_OFFSET UNITYSDK_OFFSET(0x178CA220)
#define RPG_GAMECORE_TRIGGERMODELSHAKE_METHOD_3_F6C54E17558263FA_OFFSET UNITYSDK_OFFSET(0x178CA140)
#define RPG_GAMECORE_TRIGGERMODELSHAKE__CTOR_OFFSET UNITYSDK_OFFSET(0x178CA1C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerModelShake_TypeDefinitionIndex = 20637;
