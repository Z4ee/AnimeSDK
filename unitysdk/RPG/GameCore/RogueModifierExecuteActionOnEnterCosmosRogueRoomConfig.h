...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONENTERCOSMOSROGUEROOMCONFIG_METHOD_3_420B5F644B2A051B_OFFSET UNITYSDK_OFFSET(0x18D357C0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONENTERCOSMOSROGUEROOMCONFIG_METHOD_3_8B4DE780567E3782_OFFSET UNITYSDK_OFFSET(0x18D3CFF0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONENTERCOSMOSROGUEROOMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D35770)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnEnterCosmosRogueRoomConfig_TypeDefinitionIndex = 17038;
