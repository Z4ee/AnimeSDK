...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONENTERCOSMOSROGUEROOMCONFIG_METHOD_3_420B5F644B2A051B_OFFSET UNITYSDK_OFFSET(0x1D3F7FB0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONENTERCOSMOSROGUEROOMCONFIG_METHOD_3_C7974052E9D117B7_OFFSET UNITYSDK_OFFSET(0x1D3F7F60)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONENTERCOSMOSROGUEROOMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3F7FA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnEnterCosmosRogueRoomConfig_TypeDefinitionIndex = 17729;
