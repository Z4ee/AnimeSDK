...
#define RPG_GAMECORE_PHOTOGRAPHAIMCONTAINERTARGETBASE_METHOD_2_40E5BF40283839B4_OFFSET UNITYSDK_OFFSET(0x1B4BEA00)
#define RPG_GAMECORE_PHOTOGRAPHAIMCONTAINERTARGETBASE_METHOD_2_6A1598DC3C142341_OFFSET UNITYSDK_OFFSET(0x1B4BF750)
#define RPG_GAMECORE_PHOTOGRAPHAIMCONTAINERTARGETBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4BD6D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotoGraphAimContainerTargetBase_TypeDefinitionIndex = 20837;
