...
#define RPG_GAMECORE_PHOTOGRAPHAIMCONTAINERTARGETBASE_METHOD_2_40E5BF40283839B4_OFFSET UNITYSDK_OFFSET(0x19A04700)
#define RPG_GAMECORE_PHOTOGRAPHAIMCONTAINERTARGETBASE_METHOD_2_6A1598DC3C142341_OFFSET UNITYSDK_OFFSET(0x19A05450)
#define RPG_GAMECORE_PHOTOGRAPHAIMCONTAINERTARGETBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x19A033D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotoGraphAimContainerTargetBase_TypeDefinitionIndex = 20422;
