...
#define RPG_GAMECORE_PHOTOGRAPHAIMCONTAINERTARGETBASE_METHOD_2_40E5BF40283839B4_OFFSET UNITYSDK_OFFSET(0x1D432610)
#define RPG_GAMECORE_PHOTOGRAPHAIMCONTAINERTARGETBASE_METHOD_2_6A1598DC3C142341_OFFSET UNITYSDK_OFFSET(0x1D433360)
#define RPG_GAMECORE_PHOTOGRAPHAIMCONTAINERTARGETBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4312E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotoGraphAimContainerTargetBase_TypeDefinitionIndex = 21393;
	...
	public:
		...
		static ::System::Void Method_2_40E5BF40283839B4(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::PhotoGraphAimContainerTargetBase*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::PhotoGraphAimContainerTargetBase*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_PHOTOGRAPHAIMCONTAINERTARGETBASE_METHOD_2_40E5BF40283839B4_OFFSET))(a1, a2);
		}
