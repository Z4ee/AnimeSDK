...
#define RPG_GAMECORE_PHOTOGRAPHAIMCONTAINERTARGETBASE_METHOD_2_40E5BF40283839B4_OFFSET UNITYSDK_OFFSET(0x18BF28A0)
#define RPG_GAMECORE_PHOTOGRAPHAIMCONTAINERTARGETBASE_METHOD_2_6A1598DC3C142341_OFFSET UNITYSDK_OFFSET(0x18BF35D0)
#define RPG_GAMECORE_PHOTOGRAPHAIMCONTAINERTARGETBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x18BF1570)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotoGraphAimContainerTargetBase_TypeDefinitionIndex = 20485;
