...
#define RPG_GAMECORE_DEPLOYPUZZLECHANGELINEEMISSION_METHOD_3_4B6AFA27590B624E_OFFSET UNITYSDK_OFFSET(0x18859DD0)
#define RPG_GAMECORE_DEPLOYPUZZLECHANGELINEEMISSION_METHOD_3_BD4D9294E10E0706_OFFSET UNITYSDK_OFFSET(0x18859F20)
#define RPG_GAMECORE_DEPLOYPUZZLECHANGELINEEMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x18859E90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DeployPuzzleChangeLineEmission_TypeDefinitionIndex = 19314;
