...
#define RPG_GAMECORE_PUMANHINTNOTIFYCONFIG_METHOD_2_73BF97487F0A95BE_OFFSET UNITYSDK_OFFSET(0x1D18A920)
#define RPG_GAMECORE_PUMANHINTNOTIFYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D18AA20)
