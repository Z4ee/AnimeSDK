...
#define RPG_GAMECORE_PUMANHINTNOTIFYCONFIG_METHOD_2_73BF97487F0A95BE_OFFSET UNITYSDK_OFFSET(0x1B9A7D20)
#define RPG_GAMECORE_PUMANHINTNOTIFYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9A7E20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PuManHintNotifyConfig_TypeDefinitionIndex = 16285;
