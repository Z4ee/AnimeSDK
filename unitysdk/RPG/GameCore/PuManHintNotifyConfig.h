...
#define RPG_GAMECORE_PUMANHINTNOTIFYCONFIG_METHOD_2_73BF97487F0A95BE_OFFSET UNITYSDK_OFFSET(0x18C7DEE0)
#define RPG_GAMECORE_PUMANHINTNOTIFYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18C7DFE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PuManHintNotifyConfig_TypeDefinitionIndex = 16051;
