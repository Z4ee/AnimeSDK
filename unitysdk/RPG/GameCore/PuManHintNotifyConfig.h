...
#define RPG_GAMECORE_PUMANHINTNOTIFYCONFIG_METHOD_2_73BF97487F0A95BE_OFFSET UNITYSDK_OFFSET(0x19AA0800)
#define RPG_GAMECORE_PUMANHINTNOTIFYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AA0900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PuManHintNotifyConfig_TypeDefinitionIndex = 16101;
