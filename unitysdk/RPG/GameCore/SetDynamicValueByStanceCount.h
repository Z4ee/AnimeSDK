...
#define RPG_GAMECORE_SETDYNAMICVALUEBYSTANCECOUNT_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x19C454D0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSTANCECOUNT_METHOD_4_8D0660D3225287B9_OFFSET UNITYSDK_OFFSET(0x19C45320)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSTANCECOUNT_METHOD_4_D3CF15273A79C501_OFFSET UNITYSDK_OFFSET(0x19C45250)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSTANCECOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x19C452D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByStanceCount_TypeDefinitionIndex = 21830;
