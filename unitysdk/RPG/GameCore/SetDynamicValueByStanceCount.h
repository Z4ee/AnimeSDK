...
#define RPG_GAMECORE_SETDYNAMICVALUEBYSTANCECOUNT_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1C5F1A60)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSTANCECOUNT_METHOD_4_8D0660D3225287B9_OFFSET UNITYSDK_OFFSET(0x1C5F18B0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSTANCECOUNT_METHOD_4_D04A97F608FDA254_OFFSET UNITYSDK_OFFSET(0x1C5F1870)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSTANCECOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5F18A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByStanceCount_TypeDefinitionIndex = 22256;
