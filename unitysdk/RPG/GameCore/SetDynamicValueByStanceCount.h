...
#define RPG_GAMECORE_SETDYNAMICVALUEBYSTANCECOUNT_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x176C5520)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSTANCECOUNT_METHOD_4_8D0660D3225287B9_OFFSET UNITYSDK_OFFSET(0x176C5370)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSTANCECOUNT_METHOD_4_D3CF15273A79C501_OFFSET UNITYSDK_OFFSET(0x176C52A0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSTANCECOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x176C5320)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByStanceCount_TypeDefinitionIndex = 21302;
