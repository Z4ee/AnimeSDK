...
#define RPG_GAMECORE_STAGEHARMONYSIGNALDEMODULATORMONOSERIALIZATION_METHOD_2_01BAD194C541D1AE_OFFSET UNITYSDK_OFFSET(0x18E8D680)
#define RPG_GAMECORE_STAGEHARMONYSIGNALDEMODULATORMONOSERIALIZATION__CTOR_OFFSET UNITYSDK_OFFSET(0x18E8D7A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StageHarmonySignalDemodulatorMonoSerialization_TypeDefinitionIndex = 18229;
