...
#define RPG_GAMECORE_ROGUEMODIFIERBATTLESELECTBUFFFORMULAREQUIREDCONFIG_METHOD_3_B1916B8CFDC52732_OFFSET UNITYSDK_OFFSET(0x1CFBF290)
#define RPG_GAMECORE_ROGUEMODIFIERBATTLESELECTBUFFFORMULAREQUIREDCONFIG_METHOD_3_B9E92C797879EB4E_OFFSET UNITYSDK_OFFSET(0x1CFBF2E0)
#define RPG_GAMECORE_ROGUEMODIFIERBATTLESELECTBUFFFORMULAREQUIREDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFBF2D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierBattleSelectBuffFormulaRequiredConfig_TypeDefinitionIndex = 17266;
