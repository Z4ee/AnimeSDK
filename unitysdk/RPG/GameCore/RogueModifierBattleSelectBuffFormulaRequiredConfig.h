...
#define RPG_GAMECORE_ROGUEMODIFIERBATTLESELECTBUFFFORMULAREQUIREDCONFIG_METHOD_3_AD04113078A21977_OFFSET UNITYSDK_OFFSET(0x1761D600)
#define RPG_GAMECORE_ROGUEMODIFIERBATTLESELECTBUFFFORMULAREQUIREDCONFIG_METHOD_3_B9E92C797879EB4E_OFFSET UNITYSDK_OFFSET(0x1761D6D0)
#define RPG_GAMECORE_ROGUEMODIFIERBATTLESELECTBUFFFORMULAREQUIREDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1761D680)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierBattleSelectBuffFormulaRequiredConfig_TypeDefinitionIndex = 16537;
