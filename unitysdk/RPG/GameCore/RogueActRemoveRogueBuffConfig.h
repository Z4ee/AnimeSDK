...
#define RPG_GAMECORE_ROGUEACTREMOVEROGUEBUFFCONFIG_METHOD_6_198B971665C74287_OFFSET UNITYSDK_OFFSET(0x1D3BA890)
#define RPG_GAMECORE_ROGUEACTREMOVEROGUEBUFFCONFIG_METHOD_6_63C85B3225DAE62B_OFFSET UNITYSDK_OFFSET(0x1D3BA8E0)
#define RPG_GAMECORE_ROGUEACTREMOVEROGUEBUFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3BA8D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActRemoveRogueBuffConfig_TypeDefinitionIndex = 19361;
