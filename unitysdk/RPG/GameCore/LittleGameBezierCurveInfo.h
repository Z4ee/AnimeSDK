...
#define RPG_GAMECORE_LITTLEGAMEBEZIERCURVEINFO_METHOD_3_0B5A6A046CE77CA9_OFFSET UNITYSDK_OFFSET(0x1BCBE150)
#define RPG_GAMECORE_LITTLEGAMEBEZIERCURVEINFO_METHOD_3_8B071BD4E0283A69_OFFSET UNITYSDK_OFFSET(0x1BCBE2C0)
#define RPG_GAMECORE_LITTLEGAMEBEZIERCURVEINFO_METHOD_3_D978819B0A4871A0_OFFSET UNITYSDK_OFFSET(0x1BCBE2B0)
#define RPG_GAMECORE_LITTLEGAMEBEZIERCURVEINFO_METHOD_3_F76D7505EE61B432_OFFSET UNITYSDK_OFFSET(0x1BCBE190)
#define RPG_GAMECORE_LITTLEGAMEBEZIERCURVEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCBE180)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameBezierCurveInfo_TypeDefinitionIndex = 18117;
