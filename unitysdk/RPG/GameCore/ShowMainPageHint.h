...
#define RPG_GAMECORE_SHOWMAINPAGEHINT_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1BE43780)
#define RPG_GAMECORE_SHOWMAINPAGEHINT_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1BE43740)
#define RPG_GAMECORE_SHOWMAINPAGEHINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE43770)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowMainPageHint_TypeDefinitionIndex = 20340;
