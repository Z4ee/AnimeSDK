...
#define RPG_GAMECORE_PRESETCOLLIDERSTATEBEFOREFLIPERAREGION_METHOD_3_23A06E2E19BAFD4D_OFFSET UNITYSDK_OFFSET(0x17512330)
#define RPG_GAMECORE_PRESETCOLLIDERSTATEBEFOREFLIPERAREGION_METHOD_3_5B08A8DD170A3241_OFFSET UNITYSDK_OFFSET(0x17512440)
#define RPG_GAMECORE_PRESETCOLLIDERSTATEBEFOREFLIPERAREGION__CTOR_OFFSET UNITYSDK_OFFSET(0x17512410)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PresetColliderStateBeforeFlipEraRegion_TypeDefinitionIndex = 20526;
