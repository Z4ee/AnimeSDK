...
#define RPG_GAMECORE_PRESETCOLLIDERSTATEBEFOREFLIPERAREGION_METHOD_3_23A06E2E19BAFD4D_OFFSET UNITYSDK_OFFSET(0x18C616E0)
#define RPG_GAMECORE_PRESETCOLLIDERSTATEBEFOREFLIPERAREGION_METHOD_3_5B08A8DD170A3241_OFFSET UNITYSDK_OFFSET(0x18C617F0)
#define RPG_GAMECORE_PRESETCOLLIDERSTATEBEFOREFLIPERAREGION__CTOR_OFFSET UNITYSDK_OFFSET(0x18C617C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PresetColliderStateBeforeFlipEraRegion_TypeDefinitionIndex = 21209;
