...
#define RPG_GAMECORE_ENABLEDYNAMICSKILLBUTTONINPUT_METHOD_3_02AD2F0C74C528EB_OFFSET UNITYSDK_OFFSET(0x1BB3F6B0)
#define RPG_GAMECORE_ENABLEDYNAMICSKILLBUTTONINPUT_METHOD_3_AEAC7B91C4D22932_OFFSET UNITYSDK_OFFSET(0x1BB3F6F0)
#define RPG_GAMECORE_ENABLEDYNAMICSKILLBUTTONINPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB3F6E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnableDynamicSkillButtonInput_TypeDefinitionIndex = 22019;
