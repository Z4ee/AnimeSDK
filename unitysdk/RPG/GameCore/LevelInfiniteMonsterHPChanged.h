...
#define RPG_GAMECORE_LEVELINFINITEMONSTERHPCHANGED_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1BE00980)
#define RPG_GAMECORE_LEVELINFINITEMONSTERHPCHANGED_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x1BE009D0)
#define RPG_GAMECORE_LEVELINFINITEMONSTERHPCHANGED__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE00A20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelInfiniteMonsterHPChanged_TypeDefinitionIndex = 54193;
