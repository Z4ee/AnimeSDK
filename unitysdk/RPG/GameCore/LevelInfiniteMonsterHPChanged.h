...
#define RPG_GAMECORE_LEVELINFINITEMONSTERHPCHANGED_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1DD28780)
#define RPG_GAMECORE_LEVELINFINITEMONSTERHPCHANGED_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x1DD287D0)
#define RPG_GAMECORE_LEVELINFINITEMONSTERHPCHANGED__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD28820)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelInfiniteMonsterHPChanged_TypeDefinitionIndex = 56914;
