...
#define RPG_GAMECORE_TEXTWEATHERUICONFIG_METHOD_3_5C417834BB3D5696_OFFSET UNITYSDK_OFFSET(0x19095EF0)
#define RPG_GAMECORE_TEXTWEATHERUICONFIG_METHOD_3_A848FC235EF2F6CA_OFFSET UNITYSDK_OFFSET(0x19095E10)
#define RPG_GAMECORE_TEXTWEATHERUICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19095EE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TextWeatherUIConfig_TypeDefinitionIndex = 21696;
