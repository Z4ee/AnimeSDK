...
#define RPG_GAMECORE_ROGUEMODIFIEREXTRAMIRACLEONADDEFFECTCONFIG_METHOD_3_09E80F50801659DB_OFFSET UNITYSDK_OFFSET(0x18D3ECF0)
#define RPG_GAMECORE_ROGUEMODIFIEREXTRAMIRACLEONADDEFFECTCONFIG_METHOD_3_AD6653DED03E2652_OFFSET UNITYSDK_OFFSET(0x18D3EDC0)
#define RPG_GAMECORE_ROGUEMODIFIEREXTRAMIRACLEONADDEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D3ED70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExtraMiracleOnAddEffectConfig_TypeDefinitionIndex = 16866;
