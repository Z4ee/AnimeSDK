...
#define RPG_GAMECORE_ROGUEMODIFIEREXTRAMIRACLEONADDEFFECTCONFIG_METHOD_3_A32A1247881E7BF6_OFFSET UNITYSDK_OFFSET(0x1CFC1100)
#define RPG_GAMECORE_ROGUEMODIFIEREXTRAMIRACLEONADDEFFECTCONFIG_METHOD_3_AD6653DED03E2652_OFFSET UNITYSDK_OFFSET(0x1CFC1150)
#define RPG_GAMECORE_ROGUEMODIFIEREXTRAMIRACLEONADDEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFC1140)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExtraMiracleOnAddEffectConfig_TypeDefinitionIndex = 17043;
