...
#define RPG_GAMECORE_ST_BYONHIT_METHOD_4_141739E85EA33FDD_OFFSET UNITYSDK_OFFSET(0x1D4C64B0)
#define RPG_GAMECORE_ST_BYONHIT_METHOD_4_DEE5E09538606C79_OFFSET UNITYSDK_OFFSET(0x1D4C6660)
#define RPG_GAMECORE_ST_BYONHIT_METHOD_4_EDE8AD51B505A71E_OFFSET UNITYSDK_OFFSET(0x1D4C64F0)
#define RPG_GAMECORE_ST_BYONHIT_METHOD_4_F881F35ABBC406D8_OFFSET UNITYSDK_OFFSET(0x1D4C6630)
#define RPG_GAMECORE_ST_BYONHIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4C64E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_ByOnHit_TypeDefinitionIndex = 19855;
