...
#define RPG_GAMECORE_LEVELWAVEMONSTERBEGIN_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1978AB00)
#define RPG_GAMECORE_LEVELWAVEMONSTERBEGIN_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x1978AB50)
#define RPG_GAMECORE_LEVELWAVEMONSTERBEGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1978ABA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelWaveMonsterBegin_TypeDefinitionIndex = 54190;
