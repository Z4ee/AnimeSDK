...
#define RPG_GAMECORE_LEVELWAVEMONSTERBEGIN_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x18FF0620)
#define RPG_GAMECORE_LEVELWAVEMONSTERBEGIN_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x18FF0670)
#define RPG_GAMECORE_LEVELWAVEMONSTERBEGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x18FF06C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelWaveMonsterBegin_TypeDefinitionIndex = 56911;
