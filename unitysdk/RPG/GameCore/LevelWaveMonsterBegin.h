...
#define RPG_GAMECORE_LEVELWAVEMONSTERBEGIN_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xB6E8DE0)
#define RPG_GAMECORE_LEVELWAVEMONSTERBEGIN_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xB6E8E30)
#define RPG_GAMECORE_LEVELWAVEMONSTERBEGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xB6E8E80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelWaveMonsterBegin_TypeDefinitionIndex = 52280;
