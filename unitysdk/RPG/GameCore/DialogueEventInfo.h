...
#define RPG_GAMECORE_DIALOGUEEVENTINFO_METHOD_2_829EA1350BF74F1E_OFFSET UNITYSDK_OFFSET(0x1D81B540)
#define RPG_GAMECORE_DIALOGUEEVENTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D81B690)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DialogueEventInfo_TypeDefinitionIndex = 20880;
