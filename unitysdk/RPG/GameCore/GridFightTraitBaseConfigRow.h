...
#define RPG_GAMECORE_GRIDFIGHTTRAITBASECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x189DBE40)
#define RPG_GAMECORE_GRIDFIGHTTRAITBASECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x189DC400)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::System::UInt32>* BEIDList; // 0x20
		::System::String* IconPath; // 0x28
		::System::String* TraitSearchKey; // 0x30
		::Il2CppArray<::System::UInt32>* TraitEffectList; // 0x38
		::System::Collections::Generic::List_1<::System::UInt32>* TraitLayerList; // 0x40
		::System::String* MiniIconPath; // 0x48
		::System::UInt32 TraitSortPriority; // 0x50
		::RPG::GameCore::GridFightTraitType TraitType; // 0x54
		::System::UInt32 ID; // 0x58
		::RPG::Client::TextID TraitName; // 0x60
		::RPG::Client::TextID TraitBaseDesc; // 0x70
		::RPG::Client::TextID TraitBaseSimpleDesc; // 0x80
