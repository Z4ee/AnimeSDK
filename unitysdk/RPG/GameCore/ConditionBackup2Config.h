...
#define RPG_GAMECORE_CONDITIONBACKUP2CONFIG_METHOD_4_C31F47A7DBB58043_OFFSET UNITYSDK_OFFSET(0x18832470)
#define RPG_GAMECORE_CONDITIONBACKUP2CONFIG_METHOD_4_DC9135D47F032921_OFFSET UNITYSDK_OFFSET(0x18832340)
#define RPG_GAMECORE_CONDITIONBACKUP2CONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x188323F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConditionBackup2Config_TypeDefinitionIndex = 16148;
