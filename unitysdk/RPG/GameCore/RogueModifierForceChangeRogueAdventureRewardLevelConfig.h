...
#define RPG_GAMECORE_ROGUEMODIFIERFORCECHANGEROGUEADVENTUREREWARDLEVELCONFIG_METHOD_3_29EA84D5CE9C2892_OFFSET UNITYSDK_OFFSET(0x1D3F8F80)
#define RPG_GAMECORE_ROGUEMODIFIERFORCECHANGEROGUEADVENTUREREWARDLEVELCONFIG_METHOD_3_A9F3ED0FDB90492E_OFFSET UNITYSDK_OFFSET(0x1D3F8FD0)
#define RPG_GAMECORE_ROGUEMODIFIERFORCECHANGEROGUEADVENTUREREWARDLEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3F8FC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierForceChangeRogueAdventureRewardLevelConfig_TypeDefinitionIndex = 17619;
