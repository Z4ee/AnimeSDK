...
#define RPG_GAMECORE_ROGUEMODIFIERFORCECHANGEROGUEADVENTUREREWARDLEVELCONFIG_METHOD_3_2824E0ADA7D23E57_OFFSET UNITYSDK_OFFSET(0x19B5E0A0)
#define RPG_GAMECORE_ROGUEMODIFIERFORCECHANGEROGUEADVENTUREREWARDLEVELCONFIG_METHOD_3_A9F3ED0FDB90492E_OFFSET UNITYSDK_OFFSET(0x19B53A00)
#define RPG_GAMECORE_ROGUEMODIFIERFORCECHANGEROGUEADVENTUREREWARDLEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B539B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierForceChangeRogueAdventureRewardLevelConfig_TypeDefinitionIndex = 16943;
