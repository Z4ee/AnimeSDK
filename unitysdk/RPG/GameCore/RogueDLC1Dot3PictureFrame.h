...
#define RPG_GAMECORE_ROGUEDLC1DOT3PICTUREFRAME_METHOD_3_3608C3B5B8E65B93_OFFSET UNITYSDK_OFFSET(0x18CFDA50)
#define RPG_GAMECORE_ROGUEDLC1DOT3PICTUREFRAME_METHOD_3_F32F5CC0F55BDFCA_OFFSET UNITYSDK_OFFSET(0x18CFD9D0)
#define RPG_GAMECORE_ROGUEDLC1DOT3PICTUREFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x18CFDA20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueDLC1Dot3PictureFrame_TypeDefinitionIndex = 21163;
