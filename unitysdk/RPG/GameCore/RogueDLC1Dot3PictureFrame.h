...
#define RPG_GAMECORE_ROGUEDLC1DOT3PICTUREFRAME_METHOD_3_3608C3B5B8E65B93_OFFSET UNITYSDK_OFFSET(0x175F05F0)
#define RPG_GAMECORE_ROGUEDLC1DOT3PICTUREFRAME_METHOD_3_F32F5CC0F55BDFCA_OFFSET UNITYSDK_OFFSET(0x175F0570)
#define RPG_GAMECORE_ROGUEDLC1DOT3PICTUREFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x175F05C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueDLC1Dot3PictureFrame_TypeDefinitionIndex = 20481;
