...
#define RPG_GAMECORE_SWITCHCASETASKLIST_METHOD_2_A0B68FCBED262E0F_OFFSET UNITYSDK_OFFSET(0x18EB9140)
#define RPG_GAMECORE_SWITCHCASETASKLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x18EB9290)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchCaseTaskList_TypeDefinitionIndex = 22760;
