...
#define RPG_GAMECORE_LEVELANCHORINFO_METHOD_4_87169FB2EBAD4F5C_OFFSET UNITYSDK_OFFSET(0x18A3B760)
#define RPG_GAMECORE_LEVELANCHORINFO_METHOD_4_CC434A7BC86FFFD1_OFFSET UNITYSDK_OFFSET(0x18A3B720)
#define RPG_GAMECORE_LEVELANCHORINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18A3B750)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelAnchorInfo_TypeDefinitionIndex = 16365;
