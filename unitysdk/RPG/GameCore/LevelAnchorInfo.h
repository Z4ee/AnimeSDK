...
#define RPG_GAMECORE_LEVELANCHORINFO_METHOD_4_87169FB2EBAD4F5C_OFFSET UNITYSDK_OFFSET(0x1D1C8D10)
#define RPG_GAMECORE_LEVELANCHORINFO_METHOD_4_CC434A7BC86FFFD1_OFFSET UNITYSDK_OFFSET(0x1D1C8CD0)
#define RPG_GAMECORE_LEVELANCHORINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1C8D00)
