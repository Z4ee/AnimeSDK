...
#define RPG_GAMECORE_ACTIVITYVERSIONBANNERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CDAF200)
#define RPG_GAMECORE_ACTIVITYVERSIONBANNERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDAF7B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityVersionBannerRow_TypeDefinitionIndex = 11213;
