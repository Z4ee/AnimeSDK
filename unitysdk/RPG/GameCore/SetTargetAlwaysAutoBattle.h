...
#define RPG_GAMECORE_SETTARGETALWAYSAUTOBATTLE_METHOD_3_2830705DE36EDE93_OFFSET UNITYSDK_OFFSET(0x18E441D0)
#define RPG_GAMECORE_SETTARGETALWAYSAUTOBATTLE_METHOD_3_CDB72EEE20CA3AC7_OFFSET UNITYSDK_OFFSET(0x18E44150)
#define RPG_GAMECORE_SETTARGETALWAYSAUTOBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E441A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetTargetAlwaysAutoBattle_TypeDefinitionIndex = 21361;
