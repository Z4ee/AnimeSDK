...
#define RPG_GAMECORE_SETTARGETALWAYSAUTOBATTLE_METHOD_3_2830705DE36EDE93_OFFSET UNITYSDK_OFFSET(0x1E08FE30)
#define RPG_GAMECORE_SETTARGETALWAYSAUTOBATTLE_METHOD_3_7FCEAFAC708E33EC_OFFSET UNITYSDK_OFFSET(0x1E08FDF0)
#define RPG_GAMECORE_SETTARGETALWAYSAUTOBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E08FE20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetTargetAlwaysAutoBattle_TypeDefinitionIndex = 22231;
