...
#define RPG_GAMECORE_TRIGGERROGUESHOPENTERBATTLE_METHOD_3_5EACA8055EE13559_OFFSET UNITYSDK_OFFSET(0x178CDFA0)
#define RPG_GAMECORE_TRIGGERROGUESHOPENTERBATTLE_METHOD_3_C4AA88E951F04425_OFFSET UNITYSDK_OFFSET(0x178CDE90)
#define RPG_GAMECORE_TRIGGERROGUESHOPENTERBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x178CDF70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerRogueShopEnterBattle_TypeDefinitionIndex = 19376;
