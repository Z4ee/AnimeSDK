...
#define RPG_GAMECORE_SWITCHCLIENTRAIDMAP_METHOD_3_5B4DCFE82AAB3B2D_OFFSET UNITYSDK_OFFSET(0x19CD9DE0)
#define RPG_GAMECORE_SWITCHCLIENTRAIDMAP_METHOD_3_6E9F99E215D95926_OFFSET UNITYSDK_OFFSET(0x19CD9D60)
#define RPG_GAMECORE_SWITCHCLIENTRAIDMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x19CD9DB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchClientRaidMap_TypeDefinitionIndex = 20354;
