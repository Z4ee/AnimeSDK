...
#define RPG_GAMECORE_BYDIEANIMFINISHED_METHOD_4_62240149679DD0CB_OFFSET UNITYSDK_OFFSET(0x1A8BD760)
#define RPG_GAMECORE_BYDIEANIMFINISHED_METHOD_4_F21E2BB5CD8B33D5_OFFSET UNITYSDK_OFFSET(0x1A8BD7A0)
#define RPG_GAMECORE_BYDIEANIMFINISHED_METHOD_4_F8477A5EBA8DB554_OFFSET UNITYSDK_OFFSET(0x1A8BD590)
#define RPG_GAMECORE_BYDIEANIMFINISHED_METHOD_4_F9663F49F15BCAD1_OFFSET UNITYSDK_OFFSET(0x1A8BD530)
#define RPG_GAMECORE_BYDIEANIMFINISHED__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8BD570)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByDieAnimFinished_TypeDefinitionIndex = 22468;
