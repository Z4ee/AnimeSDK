...
#define RPG_GAMECORE_FIVEDIMDEBUGLOGEVENTACTION_METHOD_3_75066E1564E1EF76_OFFSET UNITYSDK_OFFSET(0x188FCF30)
#define RPG_GAMECORE_FIVEDIMDEBUGLOGEVENTACTION_METHOD_3_86974953F8CF8FE3_OFFSET UNITYSDK_OFFSET(0x188F4260)
#define RPG_GAMECORE_FIVEDIMDEBUGLOGEVENTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x188F4240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimDebugLogEventAction_TypeDefinitionIndex = 17722;
