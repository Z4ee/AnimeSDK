...
#define RPG_GAMECORE_FOURROTATEVOXELENTRANCECONFIG_METHOD_3_A156656FC5990219_OFFSET UNITYSDK_OFFSET(0x1892D820)
#define RPG_GAMECORE_FOURROTATEVOXELENTRANCECONFIG_METHOD_3_AB83FC38234AAC02_OFFSET UNITYSDK_OFFSET(0x1892D790)
#define RPG_GAMECORE_FOURROTATEVOXELENTRANCECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1892D7F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FourRotateVoxelEntranceConfig_TypeDefinitionIndex = 15873;
