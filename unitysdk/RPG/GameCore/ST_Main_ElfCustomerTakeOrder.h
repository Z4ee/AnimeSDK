...
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMERTAKEORDER_METHOD_4_B8F134AA99748059_OFFSET UNITYSDK_OFFSET(0x18DEF850)
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMERTAKEORDER_METHOD_4_C600825CD4F39A6E_OFFSET UNITYSDK_OFFSET(0x18DE63E0)
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMERTAKEORDER__CTOR_OFFSET UNITYSDK_OFFSET(0x18DE6390)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_ElfCustomerTakeOrder_TypeDefinitionIndex = 20388;
