...
#define RPG_GAMECORE_SETMONSTERHITCOUNTENERGYBARSTATE_METHOD_3_7510B2583B39E6DD_OFFSET UNITYSDK_OFFSET(0x176D7C70)
#define RPG_GAMECORE_SETMONSTERHITCOUNTENERGYBARSTATE_METHOD_3_8DBABA4FD0492153_OFFSET UNITYSDK_OFFSET(0x176D7D50)
#define RPG_GAMECORE_SETMONSTERHITCOUNTENERGYBARSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x176D7CF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetMonsterHitCountEnergyBarState_TypeDefinitionIndex = 21903;
