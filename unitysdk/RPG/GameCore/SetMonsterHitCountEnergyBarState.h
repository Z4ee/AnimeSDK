...
#define RPG_GAMECORE_SETMONSTERHITCOUNTENERGYBARSTATE_METHOD_3_7510B2583B39E6DD_OFFSET UNITYSDK_OFFSET(0x18E3B1B0)
#define RPG_GAMECORE_SETMONSTERHITCOUNTENERGYBARSTATE_METHOD_3_8DBABA4FD0492153_OFFSET UNITYSDK_OFFSET(0x18E3B290)
#define RPG_GAMECORE_SETMONSTERHITCOUNTENERGYBARSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E3B230)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetMonsterHitCountEnergyBarState_TypeDefinitionIndex = 22641;
