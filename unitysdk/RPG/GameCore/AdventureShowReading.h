...
#define RPG_GAMECORE_ADVENTURESHOWREADING_METHOD_3_9DEEDA39FF9C3752_OFFSET UNITYSDK_OFFSET(0x1867CCA0)
#define RPG_GAMECORE_ADVENTURESHOWREADING_METHOD_3_A12DB97ABDD7F003_OFFSET UNITYSDK_OFFSET(0x1867CC20)
#define RPG_GAMECORE_ADVENTURESHOWREADING__CTOR_OFFSET UNITYSDK_OFFSET(0x1867CC70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureShowReading_TypeDefinitionIndex = 19877;
