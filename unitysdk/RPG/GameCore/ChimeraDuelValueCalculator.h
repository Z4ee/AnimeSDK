...
#define RPG_GAMECORE_CHIMERADUELVALUECALCULATOR_METHOD_3_1B0E6DF26266883D_OFFSET UNITYSDK_OFFSET(0x170A7BF0)
#define RPG_GAMECORE_CHIMERADUELVALUECALCULATOR_METHOD_3_AB0F9B14D1EA382B_OFFSET UNITYSDK_OFFSET(0x170A7B90)
#define RPG_GAMECORE_CHIMERADUELVALUECALCULATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x170A7BE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelValueCalculator_TypeDefinitionIndex = 14690;
