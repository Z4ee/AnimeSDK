...
#define RPG_GAMECORE_CHIMERADUELVALUECALCULATOR_METHOD_3_1B0E6DF26266883D_OFFSET UNITYSDK_OFFSET(0x1C2499D0)
#define RPG_GAMECORE_CHIMERADUELVALUECALCULATOR_METHOD_3_AB0F9B14D1EA382B_OFFSET UNITYSDK_OFFSET(0x1C249970)
#define RPG_GAMECORE_CHIMERADUELVALUECALCULATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2499C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelValueCalculator_TypeDefinitionIndex = 15385;
