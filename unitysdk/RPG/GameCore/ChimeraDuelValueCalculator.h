...
#define RPG_GAMECORE_CHIMERADUELVALUECALCULATOR_METHOD_3_1B0E6DF26266883D_OFFSET UNITYSDK_OFFSET(0x19648A10)
#define RPG_GAMECORE_CHIMERADUELVALUECALCULATOR_METHOD_3_AB0F9B14D1EA382B_OFFSET UNITYSDK_OFFSET(0x196489B0)
#define RPG_GAMECORE_CHIMERADUELVALUECALCULATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x19648A00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelValueCalculator_TypeDefinitionIndex = 15221;
