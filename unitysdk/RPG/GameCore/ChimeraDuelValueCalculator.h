...
#define RPG_GAMECORE_CHIMERADUELVALUECALCULATOR_METHOD_3_1B0E6DF26266883D_OFFSET UNITYSDK_OFFSET(0x1E33DCE0)
#define RPG_GAMECORE_CHIMERADUELVALUECALCULATOR_METHOD_3_AB0F9B14D1EA382B_OFFSET UNITYSDK_OFFSET(0x1E33DC80)
#define RPG_GAMECORE_CHIMERADUELVALUECALCULATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1E33DCD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelValueCalculator_TypeDefinitionIndex = 15822;
