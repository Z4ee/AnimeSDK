...
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_HASCUSTOMVALUE_METHOD_4_03119D01ACEE7A79_OFFSET UNITYSDK_OFFSET(0x1C116520)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_HASCUSTOMVALUE_METHOD_4_ACC500152EF0A365_OFFSET UNITYSDK_OFFSET(0x1C1142B0)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_HASCUSTOMVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1142A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatPredicateConfig_HasCustomValue_TypeDefinitionIndex = 15458;
