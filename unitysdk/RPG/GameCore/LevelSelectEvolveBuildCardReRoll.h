...
#define RPG_GAMECORE_LEVELSELECTEVOLVEBUILDCARDREROLL_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1DD2AE80)
#define RPG_GAMECORE_LEVELSELECTEVOLVEBUILDCARDREROLL_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x1DD2AE30)
#define RPG_GAMECORE_LEVELSELECTEVOLVEBUILDCARDREROLL_INIT_OFFSET UNITYSDK_OFFSET(0x1DD2ADE0)
#define RPG_GAMECORE_LEVELSELECTEVOLVEBUILDCARDREROLL__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD2AED0)
