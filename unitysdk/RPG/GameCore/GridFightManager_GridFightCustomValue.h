...
#define RPG_GAMECORE_GRIDFIGHTMANAGER_GRIDFIGHTCUSTOMVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0xCE2D960)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightManager_GridFightCustomValue_TypeDefinitionIndex = 52442;
