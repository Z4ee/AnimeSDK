...
#define RPG_GAMECORE_GRIDFIGHTMANAGER_GRIDFIGHTCUSTOMVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1551F8C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightManager_GridFightCustomValue_TypeDefinitionIndex = 53646;

	class GridFightManager_GridFightCustomValue : public ::System::Object
	{
	public:
		::System::Object* SourceObject; // 0x10
		::System::String* Key; // 0x18
		::System::Action_1<::RPG::GameCore::GridFightManager_GridFightCustomValue*>* OnChanged; // 0x20
