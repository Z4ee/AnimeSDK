...
#define RPG_GAMECORE_GRIDFIGHTMANAGER_GRIDFIGHTCUSTOMVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0xE67B310)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::GridFightManager_GridFightCustomValue_ValueClassify Classify; // 0x28
		::RPG::GameCore::FixPoint Value; // 0x30
