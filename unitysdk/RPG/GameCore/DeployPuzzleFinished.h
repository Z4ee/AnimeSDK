...
#define RPG_GAMECORE_DEPLOYPUZZLEFINISHED_METHOD_3_0D0F76003D3EF667_OFFSET UNITYSDK_OFFSET(0x17153650)
#define RPG_GAMECORE_DEPLOYPUZZLEFINISHED_METHOD_3_7990282402B8ED61_OFFSET UNITYSDK_OFFSET(0x17153500)
#define RPG_GAMECORE_DEPLOYPUZZLEFINISHED__CTOR_OFFSET UNITYSDK_OFFSET(0x171535C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DeployPuzzleFinished_TypeDefinitionIndex = 18654;
