...
#define RPG_GAMECORE_ST_SIDE_LOOKATTARGET_METHOD_4_5094B626D7FBAEEA_OFFSET UNITYSDK_OFFSET(0x19C1A8D0)
#define RPG_GAMECORE_ST_SIDE_LOOKATTARGET_METHOD_4_8504F445FBD37095_OFFSET UNITYSDK_OFFSET(0x19C0B620)
#define RPG_GAMECORE_ST_SIDE_LOOKATTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x19C0B5D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_LookAtTarget_TypeDefinitionIndex = 18983;
