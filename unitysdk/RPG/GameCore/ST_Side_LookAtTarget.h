...
#define RPG_GAMECORE_ST_SIDE_LOOKATTARGET_METHOD_4_70B5588ED36D7458_OFFSET UNITYSDK_OFFSET(0x1B78AA00)
#define RPG_GAMECORE_ST_SIDE_LOOKATTARGET_METHOD_4_8504F445FBD37095_OFFSET UNITYSDK_OFFSET(0x1B78AAD0)
#define RPG_GAMECORE_ST_SIDE_LOOKATTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1B78AAC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_LookAtTarget_TypeDefinitionIndex = 19334;
