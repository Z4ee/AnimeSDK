...
#define RPG_GAMECORE_ST_SIDE_LOOKATTARGET_METHOD_4_5094B626D7FBAEEA_OFFSET UNITYSDK_OFFSET(0x18DF9930)
#define RPG_GAMECORE_ST_SIDE_LOOKATTARGET_METHOD_4_8504F445FBD37095_OFFSET UNITYSDK_OFFSET(0x18DF9AA0)
#define RPG_GAMECORE_ST_SIDE_LOOKATTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x18DF9A50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_LookAtTarget_TypeDefinitionIndex = 19039;
