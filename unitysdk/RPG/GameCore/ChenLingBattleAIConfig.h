...
#define RPG_GAMECORE_CHENLINGBATTLEAICONFIG_METHOD_2_2BB07206ECB65F97_OFFSET UNITYSDK_OFFSET(0x1B7302A0)
#define RPG_GAMECORE_CHENLINGBATTLEAICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B730380)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleAIConfig_TypeDefinitionIndex = 15084;
