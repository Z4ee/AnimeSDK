...
#define RPG_GAMECORE_ELFSPECIALEVENTSELECT_METHOD_2_BAE37F1163D60DC4_OFFSET UNITYSDK_OFFSET(0x1889ECB0)
#define RPG_GAMECORE_ELFSPECIALEVENTSELECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1889F380)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfSpecialEventSelect_TypeDefinitionIndex = 17559;
	...
	public:
		...
		static ::System::Void Method_2_BAE37F1163D60DC4(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::ElfSpecialEventSelect*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::ElfSpecialEventSelect*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_ELFSPECIALEVENTSELECT_METHOD_2_BAE37F1163D60DC4_OFFSET))(a1, a2);
		}
	};
}
