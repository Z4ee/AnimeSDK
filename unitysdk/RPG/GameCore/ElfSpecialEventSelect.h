...
#define RPG_GAMECORE_ELFSPECIALEVENTSELECT_METHOD_2_BAE37F1163D60DC4_OFFSET UNITYSDK_OFFSET(0x17191580)
#define RPG_GAMECORE_ELFSPECIALEVENTSELECT__CTOR_OFFSET UNITYSDK_OFFSET(0x17191C50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfSpecialEventSelect_TypeDefinitionIndex = 16965;
