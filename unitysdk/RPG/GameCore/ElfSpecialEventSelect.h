...
#define RPG_GAMECORE_ELFSPECIALEVENTSELECT_METHOD_2_6F58FB8C584568A3_OFFSET UNITYSDK_OFFSET(0x1D05BDA0)
#define RPG_GAMECORE_ELFSPECIALEVENTSELECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D05C460)
