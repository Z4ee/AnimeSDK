...
#define RPG_GAMECORE_KILLNPCMONSTERINSERVER_METHOD_3_0D47B74A18A95FAC_OFFSET UNITYSDK_OFFSET(0x18A39AD0)
#define RPG_GAMECORE_KILLNPCMONSTERINSERVER_METHOD_3_F9693CA833D692AC_OFFSET UNITYSDK_OFFSET(0x18A39A40)
#define RPG_GAMECORE_KILLNPCMONSTERINSERVER__CTOR_OFFSET UNITYSDK_OFFSET(0x18A39AA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int KillNPCMonsterInServer_TypeDefinitionIndex = 19264;
