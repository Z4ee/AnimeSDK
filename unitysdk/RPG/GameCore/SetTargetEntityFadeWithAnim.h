...
#define RPG_GAMECORE_SETTARGETENTITYFADEWITHANIM_METHOD_3_633C624641099C6D_OFFSET UNITYSDK_OFFSET(0x18E45A10)
#define RPG_GAMECORE_SETTARGETENTITYFADEWITHANIM_METHOD_3_C0F83E57D8FBB8F8_OFFSET UNITYSDK_OFFSET(0x18E45A90)
#define RPG_GAMECORE_SETTARGETENTITYFADEWITHANIM__CTOR_OFFSET UNITYSDK_OFFSET(0x18E45A60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetTargetEntityFadeWithAnim_TypeDefinitionIndex = 19472;
