...
#define RPG_GAMECORE_SETTARGETENTITYFADEWITHANIM_METHOD_3_81E26830B43D0359_OFFSET UNITYSDK_OFFSET(0x1C60BD50)
#define RPG_GAMECORE_SETTARGETENTITYFADEWITHANIM_METHOD_3_C0F83E57D8FBB8F8_OFFSET UNITYSDK_OFFSET(0x1C60BD90)
#define RPG_GAMECORE_SETTARGETENTITYFADEWITHANIM__CTOR_OFFSET UNITYSDK_OFFSET(0x1C60BD80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetTargetEntityFadeWithAnim_TypeDefinitionIndex = 19731;
