...
#define RPG_GAMECORE_GRIDFIGHTPARAMISROLEPREBATTLECONFIG_METHOD_6_836B66E1C2AFE29A_OFFSET UNITYSDK_OFFSET(0x172749B0)
#define RPG_GAMECORE_GRIDFIGHTPARAMISROLEPREBATTLECONFIG_METHOD_6_C3864A2935AD1014_OFFSET UNITYSDK_OFFSET(0x17274C60)
#define RPG_GAMECORE_GRIDFIGHTPARAMISROLEPREBATTLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17274B30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightParamIsRolePreBattleConfig_TypeDefinitionIndex = 17885;
