...
#define RPG_GAMECORE_GRIDFIGHTPARAMISROLEPREBATTLECONFIG_METHOD_6_836B66E1C2AFE29A_OFFSET UNITYSDK_OFFSET(0x197FCC50)
#define RPG_GAMECORE_GRIDFIGHTPARAMISROLEPREBATTLECONFIG_METHOD_6_C3864A2935AD1014_OFFSET UNITYSDK_OFFSET(0x197FCF00)
#define RPG_GAMECORE_GRIDFIGHTPARAMISROLEPREBATTLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197FCDD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightParamIsRolePreBattleConfig_TypeDefinitionIndex = 18499;
