...
#define RPG_GAMECORE_SETMONSTERNAMEBOARDMAXBUFFCOUNT_METHOD_3_2BADAA0059901804_OFFSET UNITYSDK_OFFSET(0x18E3B4C0)
#define RPG_GAMECORE_SETMONSTERNAMEBOARDMAXBUFFCOUNT_METHOD_3_F405D86277BDD325_OFFSET UNITYSDK_OFFSET(0x18E3B540)
#define RPG_GAMECORE_SETMONSTERNAMEBOARDMAXBUFFCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x18E3B510)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetMonsterNameBoardMaxBuffCount_TypeDefinitionIndex = 22427;
