...
#define RPG_GAMECORE_SETMONSTERNAMEBOARDMAXBUFFCOUNT_METHOD_3_2BADAA0059901804_OFFSET UNITYSDK_OFFSET(0x19C58210)
#define RPG_GAMECORE_SETMONSTERNAMEBOARDMAXBUFFCOUNT_METHOD_3_F405D86277BDD325_OFFSET UNITYSDK_OFFSET(0x19C58290)
#define RPG_GAMECORE_SETMONSTERNAMEBOARDMAXBUFFCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x19C58260)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetMonsterNameBoardMaxBuffCount_TypeDefinitionIndex = 22181;
