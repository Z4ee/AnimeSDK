...
#define RPG_GAMECORE_SETMONSTERNAMEBOARDMAXBUFFCOUNT_METHOD_3_9AFB0FFF1F33F66E_OFFSET UNITYSDK_OFFSET(0x1E088090)
#define RPG_GAMECORE_SETMONSTERNAMEBOARDMAXBUFFCOUNT_METHOD_3_F405D86277BDD325_OFFSET UNITYSDK_OFFSET(0x1E0880D0)
#define RPG_GAMECORE_SETMONSTERNAMEBOARDMAXBUFFCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0880C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetMonsterNameBoardMaxBuffCount_TypeDefinitionIndex = 23195;
