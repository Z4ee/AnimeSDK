...
#define RPG_GAMECORE_ROGUECONDTRUECONFIG_METHOD_6_67BC343C6C6FB9C0_OFFSET UNITYSDK_OFFSET(0x1D3CBF00)
#define RPG_GAMECORE_ROGUECONDTRUECONFIG_METHOD_6_9DA144A268EE0B04_OFFSET UNITYSDK_OFFSET(0x1D3CBEB0)
#define RPG_GAMECORE_ROGUECONDTRUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3CBEF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueCondTrueConfig_TypeDefinitionIndex = 19569;
