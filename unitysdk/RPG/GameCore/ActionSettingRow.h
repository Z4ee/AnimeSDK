...
#define RPG_GAMECORE_ACTIONSETTINGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1AAD7CB0)
#define RPG_GAMECORE_ACTIONSETTINGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAD8320)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActionSettingRow_TypeDefinitionIndex = 13313;
