...
#define RPG_GAMECORE_RESTAURANTMESSAGECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19AD6460)
#define RPG_GAMECORE_RESTAURANTMESSAGECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19AD6760)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RestaurantMessageConfigRow_TypeDefinitionIndex = 10943;
	...
	public:
		...
		::System::UInt32 OptionEffectID; // 0x28
		::RPG::GameCore::MessageItemType ItemType; // 0x2C
		::RPG::GameCore::RestaurantSelectEventSenderType Sender; // 0x30
		::System::UInt32 ContactsID; // 0x34
		::System::UInt32 ItemImageID; // 0x38
