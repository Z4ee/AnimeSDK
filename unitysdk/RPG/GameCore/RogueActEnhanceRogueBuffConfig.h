...
#define RPG_GAMECORE_ROGUEACTENHANCEROGUEBUFFCONFIG_METHOD_6_09F837678B0C4F44_OFFSET UNITYSDK_OFFSET(0x175B4C70)
#define RPG_GAMECORE_ROGUEACTENHANCEROGUEBUFFCONFIG_METHOD_6_DB11BAE36C6CFDB9_OFFSET UNITYSDK_OFFSET(0x175B4E90)
#define RPG_GAMECORE_ROGUEACTENHANCEROGUEBUFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175B4DB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActEnhanceRogueBuffConfig_TypeDefinitionIndex = 17947;
