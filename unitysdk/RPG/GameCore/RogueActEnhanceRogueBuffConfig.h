...
#define RPG_GAMECORE_ROGUEACTENHANCEROGUEBUFFCONFIG_METHOD_6_808653C42F3CB4B5_OFFSET UNITYSDK_OFFSET(0x1D02DB60)
#define RPG_GAMECORE_ROGUEACTENHANCEROGUEBUFFCONFIG_METHOD_6_DB11BAE36C6CFDB9_OFFSET UNITYSDK_OFFSET(0x1D02DBB0)
#define RPG_GAMECORE_ROGUEACTENHANCEROGUEBUFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D02DBA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActEnhanceRogueBuffConfig_TypeDefinitionIndex = 18835;
