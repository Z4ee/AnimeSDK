...
#define RPG_GAMECORE_BYSTATUSCOUNT_METHOD_4_0A85B371B0FAC072_OFFSET UNITYSDK_OFFSET(0x1B2BA250)
#define RPG_GAMECORE_BYSTATUSCOUNT_METHOD_4_BD17854D11E1AD7C_OFFSET UNITYSDK_OFFSET(0x1B2BA290)
#define RPG_GAMECORE_BYSTATUSCOUNT_METHOD_4_DA9407CFDE88B9E3_OFFSET UNITYSDK_OFFSET(0x1B2B9F90)
#define RPG_GAMECORE_BYSTATUSCOUNT_METHOD_4_DE032D9922A48C70_OFFSET UNITYSDK_OFFSET(0x1B2B9FE0)
#define RPG_GAMECORE_BYSTATUSCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2B9FD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByStatusCount_TypeDefinitionIndex = 21746;
