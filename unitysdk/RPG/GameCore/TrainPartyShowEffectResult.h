...
#define RPG_GAMECORE_TRAINPARTYSHOWEFFECTRESULT_METHOD_3_8CEA3DE25AA5CEBD_OFFSET UNITYSDK_OFFSET(0x1C163D50)
#define RPG_GAMECORE_TRAINPARTYSHOWEFFECTRESULT_METHOD_3_E57F350BEA1FF800_OFFSET UNITYSDK_OFFSET(0x1C163E20)
#define RPG_GAMECORE_TRAINPARTYSHOWEFFECTRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C163E10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyShowEffectResult_TypeDefinitionIndex = 21552;
