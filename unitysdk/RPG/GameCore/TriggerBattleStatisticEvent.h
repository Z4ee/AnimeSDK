...
#define RPG_GAMECORE_TRIGGERBATTLESTATISTICEVENT_METHOD_3_558BC0438E10478C_OFFSET UNITYSDK_OFFSET(0x190BE1F0)
#define RPG_GAMECORE_TRIGGERBATTLESTATISTICEVENT_METHOD_3_6DF6C35260A48C09_OFFSET UNITYSDK_OFFSET(0x190BE270)
#define RPG_GAMECORE_TRIGGERBATTLESTATISTICEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x190BE240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerBattleStatisticEvent_TypeDefinitionIndex = 22201;
