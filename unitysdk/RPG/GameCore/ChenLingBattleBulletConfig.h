...
#define RPG_GAMECORE_CHENLINGBATTLEBULLETCONFIG_METHOD_2_23511808BF34820F_OFFSET UNITYSDK_OFFSET(0x1707A290)
#define RPG_GAMECORE_CHENLINGBATTLEBULLETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1707C7E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleBulletConfig_TypeDefinitionIndex = 14402;
