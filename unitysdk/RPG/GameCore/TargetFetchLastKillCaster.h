...
#define RPG_GAMECORE_TARGETFETCHLASTKILLCASTER_METHOD_4_34D1730DF36A13B4_OFFSET UNITYSDK_OFFSET(0x177B5BE0)
#define RPG_GAMECORE_TARGETFETCHLASTKILLCASTER_METHOD_4_65FD4FD173A774F6_OFFSET UNITYSDK_OFFSET(0x177BED20)
#define RPG_GAMECORE_TARGETFETCHLASTKILLCASTER__CTOR_OFFSET UNITYSDK_OFFSET(0x177B5B90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchLastKillCaster_TypeDefinitionIndex = 22278;
