...
#define RPG_GAMECORE_ASSISTWAYPOINTDISTANCECONDITION_METHOD_3_5693CC7851C09A3E_OFFSET UNITYSDK_OFFSET(0x1A05DB10)
#define RPG_GAMECORE_ASSISTWAYPOINTDISTANCECONDITION_METHOD_3_64D8111335B81113_OFFSET UNITYSDK_OFFSET(0x1A05E1B0)
#define RPG_GAMECORE_ASSISTWAYPOINTDISTANCECONDITION_METHOD_3_8B282298D437722E_OFFSET UNITYSDK_OFFSET(0x1A05C530)
#define RPG_GAMECORE_ASSISTWAYPOINTDISTANCECONDITION_METHOD_3_D413F4A57216B8D0_OFFSET UNITYSDK_OFFSET(0x1A060090)
#define RPG_GAMECORE_ASSISTWAYPOINTDISTANCECONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A05E1A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AssistWayPointDistanceCondition_TypeDefinitionIndex = 18248;
	...
	public:
		...
		static ::System::Void Method_3_D413F4A57216B8D0(::SimpleJSON::JSONNode* a1, ::RPG::GameCore::AssistWayPointDistanceCondition* a2)
		{
			return ((::System::Void(*)(::SimpleJSON::JSONNode*, ::RPG::GameCore::AssistWayPointDistanceCondition*))((::PBYTE)hIl2Cpp + RPG_GAMECORE_ASSISTWAYPOINTDISTANCECONDITION_METHOD_3_D413F4A57216B8D0_OFFSET))(a1, a2);
		}
	};
}
