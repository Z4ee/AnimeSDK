...
#define RPG_GAMECORE_ASSISTWAYPOINTDISTANCECONDITION_METHOD_3_5693CC7851C09A3E_OFFSET UNITYSDK_OFFSET(0x1CE23F10)
#define RPG_GAMECORE_ASSISTWAYPOINTDISTANCECONDITION_METHOD_3_64D8111335B81113_OFFSET UNITYSDK_OFFSET(0x1CE245B0)
#define RPG_GAMECORE_ASSISTWAYPOINTDISTANCECONDITION_METHOD_3_8B282298D437722E_OFFSET UNITYSDK_OFFSET(0x1CE22930)
#define RPG_GAMECORE_ASSISTWAYPOINTDISTANCECONDITION_METHOD_3_D413F4A57216B8D0_OFFSET UNITYSDK_OFFSET(0x1CE26490)
#define RPG_GAMECORE_ASSISTWAYPOINTDISTANCECONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE245A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AssistWayPointDistanceCondition_TypeDefinitionIndex = 18772;
