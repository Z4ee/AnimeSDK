...
#define RPG_GAMECORE_PHOTOGRAPHAIMCONTAIERCITYTRAIN_METHOD_3_05381F0761249630_OFFSET UNITYSDK_OFFSET(0x18BF1150)
#define RPG_GAMECORE_PHOTOGRAPHAIMCONTAIERCITYTRAIN_METHOD_3_EC54420CBD7AF571_OFFSET UNITYSDK_OFFSET(0x18BF1210)
#define RPG_GAMECORE_PHOTOGRAPHAIMCONTAIERCITYTRAIN__CTOR_OFFSET UNITYSDK_OFFSET(0x18BF11D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotoGraphAimContaierCityTrain_TypeDefinitionIndex = 16627;
