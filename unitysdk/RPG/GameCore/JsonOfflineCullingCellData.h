...
#define RPG_GAMECORE_JSONOFFLINECULLINGCELLDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18A387E0)
#define RPG_GAMECORE_JSONOFFLINECULLINGCELLDATA_FINALIZE_OFFSET UNITYSDK_OFFSET(0x18A38720)
#define RPG_GAMECORE_JSONOFFLINECULLINGCELLDATA_METHOD_3_6528AFD77893149A_OFFSET UNITYSDK_OFFSET(0x18A38AF0)
#define RPG_GAMECORE_JSONOFFLINECULLINGCELLDATA_METHOD_3_9C5A4AA76964B563_OFFSET UNITYSDK_OFFSET(0x18A38AB0)
#define RPG_GAMECORE_JSONOFFLINECULLINGCELLDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18A38AE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int JsonOfflineCullingCellData_TypeDefinitionIndex = 17369;
