...
#define RPG_GAMECORE_JSONOFFLINECULLINGCELLDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B02A210)
#define RPG_GAMECORE_JSONOFFLINECULLINGCELLDATA_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1B02A0F0)
#define RPG_GAMECORE_JSONOFFLINECULLINGCELLDATA_METHOD_3_36D92A7CB3DAF914_OFFSET UNITYSDK_OFFSET(0x1B02A5F0)
#define RPG_GAMECORE_JSONOFFLINECULLINGCELLDATA_METHOD_3_62D08FAF71BB9F40_OFFSET UNITYSDK_OFFSET(0x1B02A630)
#define RPG_GAMECORE_JSONOFFLINECULLINGCELLDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B02A620)

namespace RPG::GameCore
{
	inline static constexpr unsigned int JsonOfflineCullingCellData_TypeDefinitionIndex = 17547;
