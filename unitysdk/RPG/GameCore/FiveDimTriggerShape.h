...
#define RPG_GAMECORE_FIVEDIMTRIGGERSHAPE_METHOD_3_0DF9C32F54D75735_OFFSET UNITYSDK_OFFSET(0x1D108560)
#define RPG_GAMECORE_FIVEDIMTRIGGERSHAPE_METHOD_3_49ED5BA149224D02_OFFSET UNITYSDK_OFFSET(0x1D107A10)
#define RPG_GAMECORE_FIVEDIMTRIGGERSHAPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D108550)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimTriggerShape_TypeDefinitionIndex = 18318;
