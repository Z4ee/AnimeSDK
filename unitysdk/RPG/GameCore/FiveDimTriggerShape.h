...
#define RPG_GAMECORE_FIVEDIMTRIGGERSHAPE_METHOD_3_0DF9C32F54D75735_OFFSET UNITYSDK_OFFSET(0x17211370)
#define RPG_GAMECORE_FIVEDIMTRIGGERSHAPE_METHOD_3_22C96C8C929895F9_OFFSET UNITYSDK_OFFSET(0x171F9D50)
#define RPG_GAMECORE_FIVEDIMTRIGGERSHAPE__CTOR_OFFSET UNITYSDK_OFFSET(0x17211350)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimTriggerShape_TypeDefinitionIndex = 17005;
