...
#define RPG_GAMECORE_CHARACTERPLAYVO_METHOD_3_5CCA6525F0002B77_OFFSET UNITYSDK_OFFSET(0x1B728FE0)
#define RPG_GAMECORE_CHARACTERPLAYVO_METHOD_3_A5608D858DFDB948_OFFSET UNITYSDK_OFFSET(0x1B729020)
#define RPG_GAMECORE_CHARACTERPLAYVO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B729010)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterPlayVO_TypeDefinitionIndex = 21666;
