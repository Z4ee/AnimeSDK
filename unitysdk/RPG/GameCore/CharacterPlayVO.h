...
#define RPG_GAMECORE_CHARACTERPLAYVO_METHOD_3_0738828ADA3C76BE_OFFSET UNITYSDK_OFFSET(0x170709B0)
#define RPG_GAMECORE_CHARACTERPLAYVO_METHOD_3_A5608D858DFDB948_OFFSET UNITYSDK_OFFSET(0x17070A30)
#define RPG_GAMECORE_CHARACTERPLAYVO__CTOR_OFFSET UNITYSDK_OFFSET(0x17070A00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterPlayVO_TypeDefinitionIndex = 20664;
