...
#define RPG_GAMECORE_WOLFBROCARTOONGUNCONFIG_METHOD_2_6C19AFF16076E52E_OFFSET UNITYSDK_OFFSET(0x1EFA7670)
#define RPG_GAMECORE_WOLFBROCARTOONGUNCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFA78C0)
