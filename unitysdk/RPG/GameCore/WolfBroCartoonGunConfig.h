...
#define RPG_GAMECORE_WOLFBROCARTOONGUNCONFIG_METHOD_2_6C19AFF16076E52E_OFFSET UNITYSDK_OFFSET(0x1D6B2630)
#define RPG_GAMECORE_WOLFBROCARTOONGUNCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6B2880)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WolfBroCartoonGunConfig_TypeDefinitionIndex = 16826;
