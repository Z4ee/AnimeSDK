...
#define RPG_GAMECORE_WOLFBROCARTOONGUNCONFIG_METHOD_2_6C19AFF16076E52E_OFFSET UNITYSDK_OFFSET(0x19E67780)
#define RPG_GAMECORE_WOLFBROCARTOONGUNCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19E679D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WolfBroCartoonGunConfig_TypeDefinitionIndex = 16154;
