...
#define RPG_GAMECORE_WOLFBROCARTOONGUNCONFIG_METHOD_2_6C19AFF16076E52E_OFFSET UNITYSDK_OFFSET(0x1790B1F0)
#define RPG_GAMECORE_WOLFBROCARTOONGUNCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1790B450)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WolfBroCartoonGunConfig_TypeDefinitionIndex = 15584;
