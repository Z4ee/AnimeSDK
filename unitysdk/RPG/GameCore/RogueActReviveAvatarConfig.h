...
#define RPG_GAMECORE_ROGUEACTREVIVEAVATARCONFIG_METHOD_6_2DF97855D0404C31_OFFSET UNITYSDK_OFFSET(0x18CD3D40)
#define RPG_GAMECORE_ROGUEACTREVIVEAVATARCONFIG_METHOD_6_FC77173B9CE8F0AC_OFFSET UNITYSDK_OFFSET(0x18CD3F60)
#define RPG_GAMECORE_ROGUEACTREVIVEAVATARCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CD3E80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActReviveAvatarConfig_TypeDefinitionIndex = 18630;
