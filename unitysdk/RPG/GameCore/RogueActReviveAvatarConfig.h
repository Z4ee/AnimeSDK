...
#define RPG_GAMECORE_ROGUEACTREVIVEAVATARCONFIG_METHOD_6_6D656FA1F00ACAB0_OFFSET UNITYSDK_OFFSET(0x1C49DF00)
#define RPG_GAMECORE_ROGUEACTREVIVEAVATARCONFIG_METHOD_6_FC77173B9CE8F0AC_OFFSET UNITYSDK_OFFSET(0x1C49DF50)
#define RPG_GAMECORE_ROGUEACTREVIVEAVATARCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C49DF40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActReviveAvatarConfig_TypeDefinitionIndex = 18873;
