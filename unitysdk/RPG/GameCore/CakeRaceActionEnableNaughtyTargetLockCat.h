...
#define RPG_GAMECORE_CAKERACEACTIONENABLENAUGHTYTARGETLOCKCAT_METHOD_3_3563DFA514B724C5_OFFSET UNITYSDK_OFFSET(0x170443A0)
#define RPG_GAMECORE_CAKERACEACTIONENABLENAUGHTYTARGETLOCKCAT_METHOD_3_A8EA9A2A30CF379F_OFFSET UNITYSDK_OFFSET(0x17046550)
#define RPG_GAMECORE_CAKERACEACTIONENABLENAUGHTYTARGETLOCKCAT__CTOR_OFFSET UNITYSDK_OFFSET(0x17044380)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionEnableNaughtyTargetLockCat_TypeDefinitionIndex = 16860;
