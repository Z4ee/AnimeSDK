...
#define RPG_GAMECORE_CAKERACEACTIONENABLENAUGHTYTARGETLOCKCAT_METHOD_3_3563DFA514B724C5_OFFSET UNITYSDK_OFFSET(0x1B2CB1F0)
#define RPG_GAMECORE_CAKERACEACTIONENABLENAUGHTYTARGETLOCKCAT_METHOD_3_D93153EC057C83F5_OFFSET UNITYSDK_OFFSET(0x1B2CB190)
#define RPG_GAMECORE_CAKERACEACTIONENABLENAUGHTYTARGETLOCKCAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2CB1E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionEnableNaughtyTargetLockCat_TypeDefinitionIndex = 17630;
