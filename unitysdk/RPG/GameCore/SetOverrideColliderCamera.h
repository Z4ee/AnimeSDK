...
#define RPG_GAMECORE_SETOVERRIDECOLLIDERCAMERA_METHOD_3_45F4D090EE628019_OFFSET UNITYSDK_OFFSET(0x18E3E0E0)
#define RPG_GAMECORE_SETOVERRIDECOLLIDERCAMERA_METHOD_3_981C138AE75FC365_OFFSET UNITYSDK_OFFSET(0x18E3E060)
#define RPG_GAMECORE_SETOVERRIDECOLLIDERCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x18E3E0B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetOverrideColliderCamera_TypeDefinitionIndex = 21276;
