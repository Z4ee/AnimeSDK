...
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_SAMEPOINTCOUNT_METHOD_3_6E59DF7484FA5084_OFFSET UNITYSDK_OFFSET(0x1715FC70)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_SAMEPOINTCOUNT_METHOD_3_94AD829DAD8BD88C_OFFSET UNITYSDK_OFFSET(0x17160740)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_SAMEPOINTCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1715FC60)
