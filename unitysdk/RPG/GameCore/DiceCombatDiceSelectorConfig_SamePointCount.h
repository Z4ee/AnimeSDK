...
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_SAMEPOINTCOUNT_METHOD_3_6E59DF7484FA5084_OFFSET UNITYSDK_OFFSET(0x188676A0)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_SAMEPOINTCOUNT_METHOD_3_94AD829DAD8BD88C_OFFSET UNITYSDK_OFFSET(0x18868380)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_SAMEPOINTCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x18867690)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatDiceSelectorConfig_SamePointCount_TypeDefinitionIndex = 15307;
