...
#define RPG_GAMECORE_ENTITYLODMODELCONFIG_METHOD_2_8B6B88BB55BEE3B0_OFFSET UNITYSDK_OFFSET(0x1C055B70)
#define RPG_GAMECORE_ENTITYLODMODELCONFIG_METHOD_2_E3AA469B35D90116_OFFSET UNITYSDK_OFFSET(0x1C055830)
#define RPG_GAMECORE_ENTITYLODMODELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C055B40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EntityLodModelConfig_TypeDefinitionIndex = 18461;
