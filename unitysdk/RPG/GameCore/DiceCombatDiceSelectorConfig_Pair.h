...
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_PAIR_METHOD_3_6BA16AC62CF3E988_OFFSET UNITYSDK_OFFSET(0x196A6280)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_PAIR_METHOD_3_D0ECFDC65937983A_OFFSET UNITYSDK_OFFSET(0x196A7020)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_PAIR__CTOR_OFFSET UNITYSDK_OFFSET(0x196A6220)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatDiceSelectorConfig_Pair_TypeDefinitionIndex = 15367;
