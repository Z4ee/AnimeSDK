...
#define RPG_GAMECORE_BYCOMPARETARGETNATUREID_METHOD_4_21350C33CE107D89_OFFSET UNITYSDK_OFFSET(0x1A8AE1F0)
#define RPG_GAMECORE_BYCOMPARETARGETNATUREID_METHOD_4_469B61DAAC0D1B89_OFFSET UNITYSDK_OFFSET(0x1A8AE3D0)
#define RPG_GAMECORE_BYCOMPARETARGETNATUREID_METHOD_4_7ABE7F0AFE96AFB7_OFFSET UNITYSDK_OFFSET(0x1A8AE3A0)
#define RPG_GAMECORE_BYCOMPARETARGETNATUREID_METHOD_4_B1D2788A707B4280_OFFSET UNITYSDK_OFFSET(0x1A8AE1B0)
#define RPG_GAMECORE_BYCOMPARETARGETNATUREID__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8AE1E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareTargetNatureID_TypeDefinitionIndex = 22186;
