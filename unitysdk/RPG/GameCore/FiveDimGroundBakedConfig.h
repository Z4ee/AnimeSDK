...
#define RPG_GAMECORE_FIVEDIMGROUNDBAKEDCONFIG_METHOD_2_E97267A5FA709480_OFFSET UNITYSDK_OFFSET(0x1D0EC8A0)
#define RPG_GAMECORE_FIVEDIMGROUNDBAKEDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0ECA40)
