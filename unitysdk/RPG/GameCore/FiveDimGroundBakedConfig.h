...
#define RPG_GAMECORE_FIVEDIMGROUNDBAKEDCONFIG_METHOD_2_E97267A5FA709480_OFFSET UNITYSDK_OFFSET(0x1D865330)
#define RPG_GAMECORE_FIVEDIMGROUNDBAKEDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D8654D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimGroundBakedConfig_TypeDefinitionIndex = 16476;
