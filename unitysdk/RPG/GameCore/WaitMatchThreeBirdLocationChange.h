...
#define RPG_GAMECORE_WAITMATCHTHREEBIRDLOCATIONCHANGE_METHOD_4_79C23954B52C2212_OFFSET UNITYSDK_OFFSET(0x178FDA30)
#define RPG_GAMECORE_WAITMATCHTHREEBIRDLOCATIONCHANGE_METHOD_4_C3F06E99892F8AB4_OFFSET UNITYSDK_OFFSET(0x178FD950)
#define RPG_GAMECORE_WAITMATCHTHREEBIRDLOCATIONCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x178FD9D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitMatchThreeBirdLocationChange_TypeDefinitionIndex = 19312;
