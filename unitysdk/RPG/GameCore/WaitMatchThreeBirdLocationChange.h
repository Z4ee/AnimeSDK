...
#define RPG_GAMECORE_WAITMATCHTHREEBIRDLOCATIONCHANGE_METHOD_4_79C23954B52C2212_OFFSET UNITYSDK_OFFSET(0x19101920)
#define RPG_GAMECORE_WAITMATCHTHREEBIRDLOCATIONCHANGE_METHOD_4_C3F06E99892F8AB4_OFFSET UNITYSDK_OFFSET(0x19101840)
#define RPG_GAMECORE_WAITMATCHTHREEBIRDLOCATIONCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x191018C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitMatchThreeBirdLocationChange_TypeDefinitionIndex = 19971;
