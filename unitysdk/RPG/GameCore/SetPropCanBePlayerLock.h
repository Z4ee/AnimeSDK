...
#define RPG_GAMECORE_SETPROPCANBEPLAYERLOCK_METHOD_3_9A6888D117DB4127_OFFSET UNITYSDK_OFFSET(0x1D50B2F0)
#define RPG_GAMECORE_SETPROPCANBEPLAYERLOCK_METHOD_3_A9E9C77D75493B70_OFFSET UNITYSDK_OFFSET(0x1D50B2A0)
#define RPG_GAMECORE_SETPROPCANBEPLAYERLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D50B2E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetPropCanBePlayerLock_TypeDefinitionIndex = 21997;
