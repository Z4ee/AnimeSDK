...
#define RPG_GAMECORE_SETPROPCANBEPLAYERLOCK_METHOD_3_9A6888D117DB4127_OFFSET UNITYSDK_OFFSET(0x19C5BE90)
#define RPG_GAMECORE_SETPROPCANBEPLAYERLOCK_METHOD_3_C51F8F1E1BB772AF_OFFSET UNITYSDK_OFFSET(0x19C5BE10)
#define RPG_GAMECORE_SETPROPCANBEPLAYERLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x19C5BE60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetPropCanBePlayerLock_TypeDefinitionIndex = 21021;
