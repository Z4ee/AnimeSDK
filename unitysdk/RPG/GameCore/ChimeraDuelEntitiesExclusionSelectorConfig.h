...
#define RPG_GAMECORE_CHIMERADUELENTITIESEXCLUSIONSELECTORCONFIG_METHOD_3_848BBA396CAB26E7_OFFSET UNITYSDK_OFFSET(0x1CFC4490)
#define RPG_GAMECORE_CHIMERADUELENTITIESEXCLUSIONSELECTORCONFIG_METHOD_3_CF968462324791FD_OFFSET UNITYSDK_OFFSET(0x1CFC4430)
#define RPG_GAMECORE_CHIMERADUELENTITIESEXCLUSIONSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFC4480)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelEntitiesExclusionSelectorConfig_TypeDefinitionIndex = 15742;
