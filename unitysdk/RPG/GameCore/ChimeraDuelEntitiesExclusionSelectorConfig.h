...
#define RPG_GAMECORE_CHIMERADUELENTITIESEXCLUSIONSELECTORCONFIG_METHOD_3_848BBA396CAB26E7_OFFSET UNITYSDK_OFFSET(0x187F98F0)
#define RPG_GAMECORE_CHIMERADUELENTITIESEXCLUSIONSELECTORCONFIG_METHOD_3_CF968462324791FD_OFFSET UNITYSDK_OFFSET(0x187F9890)
#define RPG_GAMECORE_CHIMERADUELENTITIESEXCLUSIONSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x187F98E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelEntitiesExclusionSelectorConfig_TypeDefinitionIndex = 15078;
