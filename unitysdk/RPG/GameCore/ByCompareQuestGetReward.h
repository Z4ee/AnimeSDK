...
#define RPG_GAMECORE_BYCOMPAREQUESTGETREWARD_METHOD_4_6490E28D69210B49_OFFSET UNITYSDK_OFFSET(0x1CEF4A60)
#define RPG_GAMECORE_BYCOMPAREQUESTGETREWARD_METHOD_4_78A1044B7A4B1172_OFFSET UNITYSDK_OFFSET(0x1CEF4C70)
#define RPG_GAMECORE_BYCOMPAREQUESTGETREWARD_METHOD_4_98BB74D6EF2F8478_OFFSET UNITYSDK_OFFSET(0x1CEF4AA0)
#define RPG_GAMECORE_BYCOMPAREQUESTGETREWARD_METHOD_4_BFECA14C5D5A2775_OFFSET UNITYSDK_OFFSET(0x1CEF4C40)
#define RPG_GAMECORE_BYCOMPAREQUESTGETREWARD__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEF4A90)
