...
#define RPG_GAMECORE_BYCOMPAREQUESTGETREWARD_METHOD_4_409378A17EE349AA_OFFSET UNITYSDK_OFFSET(0x18738490)
#define RPG_GAMECORE_BYCOMPAREQUESTGETREWARD_METHOD_4_98BB74D6EF2F8478_OFFSET UNITYSDK_OFFSET(0x18738560)
#define RPG_GAMECORE_BYCOMPAREQUESTGETREWARD__CTOR_OFFSET UNITYSDK_OFFSET(0x18738510)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareQuestGetReward_TypeDefinitionIndex = 20736;
