...
#define RPG_GAMECORE_BYCOMPAREQUESTGETREWARD_METHOD_4_6490E28D69210B49_OFFSET UNITYSDK_OFFSET(0x1BBB3790)
#define RPG_GAMECORE_BYCOMPAREQUESTGETREWARD_METHOD_4_78A1044B7A4B1172_OFFSET UNITYSDK_OFFSET(0x1BBB39A0)
#define RPG_GAMECORE_BYCOMPAREQUESTGETREWARD_METHOD_4_98BB74D6EF2F8478_OFFSET UNITYSDK_OFFSET(0x1BBB37D0)
#define RPG_GAMECORE_BYCOMPAREQUESTGETREWARD_METHOD_4_BFECA14C5D5A2775_OFFSET UNITYSDK_OFFSET(0x1BBB3970)
#define RPG_GAMECORE_BYCOMPAREQUESTGETREWARD__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBB37C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareQuestGetReward_TypeDefinitionIndex = 21638;
