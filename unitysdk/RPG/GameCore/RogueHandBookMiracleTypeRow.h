...
#define RPG_GAMECORE_ROGUEHANDBOOKMIRACLETYPEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19B3DDC0)
#define RPG_GAMECORE_ROGUEHANDBOOKMIRACLETYPEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19B3DFA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueHandBookMiracleTypeRow_TypeDefinitionIndex = 14104;
