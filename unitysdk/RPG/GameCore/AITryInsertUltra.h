...
#define RPG_GAMECORE_AITRYINSERTULTRA_METHOD_3_2A92F54FEFA198A7_OFFSET UNITYSDK_OFFSET(0x16E924F0)
#define RPG_GAMECORE_AITRYINSERTULTRA_METHOD_3_7D951C722113EBD6_OFFSET UNITYSDK_OFFSET(0x16E92570)
#define RPG_GAMECORE_AITRYINSERTULTRA__CTOR_OFFSET UNITYSDK_OFFSET(0x16E92540)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AITryInsertUltra_TypeDefinitionIndex = 21035;
