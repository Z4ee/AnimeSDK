...
#define RPG_GAMECORE_AITRYINSERTULTRA_METHOD_3_2A92F54FEFA198A7_OFFSET UNITYSDK_OFFSET(0x193C3850)
#define RPG_GAMECORE_AITRYINSERTULTRA_METHOD_3_7D951C722113EBD6_OFFSET UNITYSDK_OFFSET(0x193C38D0)
#define RPG_GAMECORE_AITRYINSERTULTRA__CTOR_OFFSET UNITYSDK_OFFSET(0x193C38A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AITryInsertUltra_TypeDefinitionIndex = 21591;
