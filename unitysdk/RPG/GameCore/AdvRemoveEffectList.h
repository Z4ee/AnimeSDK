...
#define RPG_GAMECORE_ADVREMOVEEFFECTLIST_METHOD_3_225832074879FED2_OFFSET UNITYSDK_OFFSET(0x16F3D8C0)
#define RPG_GAMECORE_ADVREMOVEEFFECTLIST_METHOD_3_D5BF672589A529B0_OFFSET UNITYSDK_OFFSET(0x16F3D840)
#define RPG_GAMECORE_ADVREMOVEEFFECTLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x16F3D890)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvRemoveEffectList_TypeDefinitionIndex = 20514;
