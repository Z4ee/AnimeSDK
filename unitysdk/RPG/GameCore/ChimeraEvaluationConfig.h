...
#define RPG_GAMECORE_CHIMERAEVALUATIONCONFIG_METHOD_2_CA8C8BC12AE779A9_OFFSET UNITYSDK_OFFSET(0x19649A10)
#define RPG_GAMECORE_CHIMERAEVALUATIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19649B00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraEvaluationConfig_TypeDefinitionIndex = 15081;
