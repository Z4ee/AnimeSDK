...
#define RPG_GAMECORE_CHIMERAEVALUATIONCONFIG_METHOD_2_CA8C8BC12AE779A9_OFFSET UNITYSDK_OFFSET(0x1C24A7D0)
#define RPG_GAMECORE_CHIMERAEVALUATIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C24A8C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraEvaluationConfig_TypeDefinitionIndex = 15245;
