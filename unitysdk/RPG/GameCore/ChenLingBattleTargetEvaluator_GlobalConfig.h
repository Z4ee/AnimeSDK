...
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_GLOBALCONFIG_METHOD_3_15799E58BF897E63_OFFSET UNITYSDK_OFFSET(0x17081760)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_GLOBALCONFIG_METHOD_3_77854959E6B137E2_OFFSET UNITYSDK_OFFSET(0x17081800)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_GLOBALCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x170817F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleTargetEvaluator_GlobalConfig_TypeDefinitionIndex = 14461;
