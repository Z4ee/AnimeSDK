...
#define RPG_GAMECORE_ROGUEWORKBENCHREFORGEGENFORMULACONFIG_METHOD_2_195FD691DF38272F_OFFSET UNITYSDK_OFFSET(0x19BD4840)
#define RPG_GAMECORE_ROGUEWORKBENCHREFORGEGENFORMULACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19BD4880)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueWorkbenchReforgeGenFormulaConfig_TypeDefinitionIndex = 17131;
