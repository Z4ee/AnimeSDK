...
#define RPG_GAMECORE_ROGUEWORKBENCHREFORGEGENFORMULACONFIG_METHOD_2_195FD691DF38272F_OFFSET UNITYSDK_OFFSET(0x17673A60)
#define RPG_GAMECORE_ROGUEWORKBENCHREFORGEGENFORMULACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17673AA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueWorkbenchReforgeGenFormulaConfig_TypeDefinitionIndex = 16564;
