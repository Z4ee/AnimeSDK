...
#define RPG_GAMECORE_MISSIONCUSTOMVALUETUPLE_METHOD_2_57C6FFDD77C870E3_OFFSET UNITYSDK_OFFSET(0x1D2A38D0)
#define RPG_GAMECORE_MISSIONCUSTOMVALUETUPLE_METHOD_2_D7EAEB1F921AAC5B_OFFSET UNITYSDK_OFFSET(0x1D2A33D0)
#define RPG_GAMECORE_MISSIONCUSTOMVALUETUPLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2A4470)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MissionCustomValueTuple_TypeDefinitionIndex = 18768;
