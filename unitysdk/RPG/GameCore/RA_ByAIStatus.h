...
#define RPG_GAMECORE_RA_BYAISTATUS_METHOD_4_41D6BFFF9F1BCF78_OFFSET UNITYSDK_OFFSET(0x18C5BE10)
#define RPG_GAMECORE_RA_BYAISTATUS_METHOD_4_6186FE26BBA8DD30_OFFSET UNITYSDK_OFFSET(0x18C82D20)
#define RPG_GAMECORE_RA_BYAISTATUS__CTOR_OFFSET UNITYSDK_OFFSET(0x18C5BDC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RA_ByAIStatus_TypeDefinitionIndex = 18971;
