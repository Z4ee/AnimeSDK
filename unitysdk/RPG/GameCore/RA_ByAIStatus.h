...
#define RPG_GAMECORE_RA_BYAISTATUS_METHOD_4_0949C72413977E51_OFFSET UNITYSDK_OFFSET(0x1B9AD170)
#define RPG_GAMECORE_RA_BYAISTATUS_METHOD_4_2A56728F9DB03AEA_OFFSET UNITYSDK_OFFSET(0x1B9ACF30)
#define RPG_GAMECORE_RA_BYAISTATUS_METHOD_4_4EBBBF23158BB193_OFFSET UNITYSDK_OFFSET(0x1B9ACF70)
#define RPG_GAMECORE_RA_BYAISTATUS_METHOD_4_E4AF2172CC7C06AF_OFFSET UNITYSDK_OFFSET(0x1B9AD140)
#define RPG_GAMECORE_RA_BYAISTATUS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9ACF60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RA_ByAIStatus_TypeDefinitionIndex = 19275;
