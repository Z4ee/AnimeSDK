...
#define RPG_GAMECORE_PHOTOGRAPHTOASTTEMPLATE_METHOD_2_07918AC68D547F2B_OFFSET UNITYSDK_OFFSET(0x1B4C5660)
#define RPG_GAMECORE_PHOTOGRAPHTOASTTEMPLATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4C5810)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotographToastTemplate_TypeDefinitionIndex = 18314;
