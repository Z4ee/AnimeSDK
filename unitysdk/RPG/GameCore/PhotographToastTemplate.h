...
#define RPG_GAMECORE_PHOTOGRAPHTOASTTEMPLATE_METHOD_2_07918AC68D547F2B_OFFSET UNITYSDK_OFFSET(0x19A0B250)
#define RPG_GAMECORE_PHOTOGRAPHTOASTTEMPLATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19A0B400)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotographToastTemplate_TypeDefinitionIndex = 18110;
