...
#define RPG_GAMECORE_CONVINCEWAITALLTURNFINISH_METHOD_3_21E4615BE2EFBAA8_OFFSET UNITYSDK_OFFSET(0x1883F3F0)
#define RPG_GAMECORE_CONVINCEWAITALLTURNFINISH_METHOD_3_76ABF7FAF82DED94_OFFSET UNITYSDK_OFFSET(0x1883F500)
#define RPG_GAMECORE_CONVINCEWAITALLTURNFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1883F4D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConvinceWaitAllTurnFinish_TypeDefinitionIndex = 20691;
