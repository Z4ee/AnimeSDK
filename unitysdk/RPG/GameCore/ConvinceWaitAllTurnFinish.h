...
#define RPG_GAMECORE_CONVINCEWAITALLTURNFINISH_METHOD_3_21E4615BE2EFBAA8_OFFSET UNITYSDK_OFFSET(0x17138360)
#define RPG_GAMECORE_CONVINCEWAITALLTURNFINISH_METHOD_3_76ABF7FAF82DED94_OFFSET UNITYSDK_OFFSET(0x17138470)
#define RPG_GAMECORE_CONVINCEWAITALLTURNFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x17138440)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConvinceWaitAllTurnFinish_TypeDefinitionIndex = 20010;
