...
#define RPG_GAMECORE_CONVINCEWAITALLTURNFINISH_METHOD_3_1B95EB620359E3D1_OFFSET UNITYSDK_OFFSET(0x1D004590)
#define RPG_GAMECORE_CONVINCEWAITALLTURNFINISH_METHOD_3_76ABF7FAF82DED94_OFFSET UNITYSDK_OFFSET(0x1D004660)
#define RPG_GAMECORE_CONVINCEWAITALLTURNFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1D004650)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConvinceWaitAllTurnFinish_TypeDefinitionIndex = 21594;
