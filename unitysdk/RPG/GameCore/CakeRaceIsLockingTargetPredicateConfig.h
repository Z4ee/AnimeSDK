...
#define RPG_GAMECORE_CAKERACEISLOCKINGTARGETPREDICATECONFIG_METHOD_3_4089FBFBD0EB76FD_OFFSET UNITYSDK_OFFSET(0x195EEBF0)
#define RPG_GAMECORE_CAKERACEISLOCKINGTARGETPREDICATECONFIG_METHOD_3_ED3F8D49DF52D131_OFFSET UNITYSDK_OFFSET(0x195E98A0)
#define RPG_GAMECORE_CAKERACEISLOCKINGTARGETPREDICATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x195E9890)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceIsLockingTargetPredicateConfig_TypeDefinitionIndex = 17474;
