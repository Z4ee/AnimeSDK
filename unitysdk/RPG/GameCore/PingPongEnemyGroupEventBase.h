...
#define RPG_GAMECORE_PINGPONGENEMYGROUPEVENTBASE_METHOD_2_4216E5166463F957_OFFSET UNITYSDK_OFFSET(0x18BFACD0)
#define RPG_GAMECORE_PINGPONGENEMYGROUPEVENTBASE_METHOD_2_CAC0DC54921FD8F9_OFFSET UNITYSDK_OFFSET(0x18BFB450)
#define RPG_GAMECORE_PINGPONGENEMYGROUPEVENTBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x18BFB4B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PingPongEnemyGroupEventBase_TypeDefinitionIndex = 16084;
