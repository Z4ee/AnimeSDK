...
#define RPG_GAMECORE_PINGPONGENEMYGROUPEVENTBASE_METHOD_2_4216E5166463F957_OFFSET UNITYSDK_OFFSET(0x19A0CB00)
#define RPG_GAMECORE_PINGPONGENEMYGROUPEVENTBASE_METHOD_2_CAC0DC54921FD8F9_OFFSET UNITYSDK_OFFSET(0x19A0D2A0)
#define RPG_GAMECORE_PINGPONGENEMYGROUPEVENTBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x19A0D300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PingPongEnemyGroupEventBase_TypeDefinitionIndex = 16134;
