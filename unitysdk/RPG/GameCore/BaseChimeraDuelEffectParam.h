...
#define RPG_GAMECORE_BASECHIMERADUELEFFECTPARAM_METHOD_2_91A3A33AC994804D_OFFSET UNITYSDK_OFFSET(0x16FC6050)
#define RPG_GAMECORE_BASECHIMERADUELEFFECTPARAM_METHOD_2_E636238726A2A20B_OFFSET UNITYSDK_OFFSET(0x16FC5C90)
#define RPG_GAMECORE_BASECHIMERADUELEFFECTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x16FC6040)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BaseChimeraDuelEffectParam_TypeDefinitionIndex = 14705;
