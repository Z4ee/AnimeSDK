...
#define RPG_GAMECORE_BASECHIMERADUELEFFECTPARAM_METHOD_2_91A3A33AC994804D_OFFSET UNITYSDK_OFFSET(0x194BC700)
#define RPG_GAMECORE_BASECHIMERADUELEFFECTPARAM_METHOD_2_E636238726A2A20B_OFFSET UNITYSDK_OFFSET(0x194BC370)
#define RPG_GAMECORE_BASECHIMERADUELEFFECTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x194BC6F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BaseChimeraDuelEffectParam_TypeDefinitionIndex = 15236;
