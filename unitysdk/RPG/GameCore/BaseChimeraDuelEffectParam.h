...
#define RPG_GAMECORE_BASECHIMERADUELEFFECTPARAM_METHOD_2_91A3A33AC994804D_OFFSET UNITYSDK_OFFSET(0x1A3DEBD0)
#define RPG_GAMECORE_BASECHIMERADUELEFFECTPARAM_METHOD_2_E636238726A2A20B_OFFSET UNITYSDK_OFFSET(0x1A3DE840)
#define RPG_GAMECORE_BASECHIMERADUELEFFECTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3DEBC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BaseChimeraDuelEffectParam_TypeDefinitionIndex = 15400;
