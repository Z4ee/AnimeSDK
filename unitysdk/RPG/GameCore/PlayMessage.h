...
#define RPG_GAMECORE_PLAYMESSAGE_METHOD_3_6743730682F31DF3_OFFSET UNITYSDK_OFFSET(0x1D7A4720)
#define RPG_GAMECORE_PLAYMESSAGE_METHOD_3_7FA2D28FBBEBF220_OFFSET UNITYSDK_OFFSET(0x1D7A4770)
#define RPG_GAMECORE_PLAYMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7A4760)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayMessage_TypeDefinitionIndex = 20874;
