...
#define RPG_GAMECORE_PREFABCACHECONFIG_METHOD_2_105FC9DAB7076BB2_OFFSET UNITYSDK_OFFSET(0x1D359FA0)
#define RPG_GAMECORE_PREFABCACHECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D35A080)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PrefabCacheConfig_TypeDefinitionIndex = 24134;
