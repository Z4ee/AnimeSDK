...
#define RPG_GAMECORE_MODIFYSPECIALSP_METHOD_3_247ED945856FBCCA_OFFSET UNITYSDK_OFFSET(0x174346F0)
#define RPG_GAMECORE_MODIFYSPECIALSP_METHOD_3_B51F7BEF128B2BCA_OFFSET UNITYSDK_OFFSET(0x17434670)
#define RPG_GAMECORE_MODIFYSPECIALSP__CTOR_OFFSET UNITYSDK_OFFSET(0x174346C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifySpecialSP_TypeDefinitionIndex = 21281;
