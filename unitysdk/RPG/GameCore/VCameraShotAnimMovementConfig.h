...
#define RPG_GAMECORE_VCAMERASHOTANIMMOVEMENTCONFIG_METHOD_2_2699366CB151397E_OFFSET UNITYSDK_OFFSET(0x190E9A20)
#define RPG_GAMECORE_VCAMERASHOTANIMMOVEMENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x190ECBA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VCameraShotAnimMovementConfig_TypeDefinitionIndex = 15529;
