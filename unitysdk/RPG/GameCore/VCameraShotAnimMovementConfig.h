...
#define RPG_GAMECORE_VCAMERASHOTANIMMOVEMENTCONFIG_METHOD_2_2699366CB151397E_OFFSET UNITYSDK_OFFSET(0x1B888BF0)
#define RPG_GAMECORE_VCAMERASHOTANIMMOVEMENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B88C090)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VCameraShotAnimMovementConfig_TypeDefinitionIndex = 15763;
