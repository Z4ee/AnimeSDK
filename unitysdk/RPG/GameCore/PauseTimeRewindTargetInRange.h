...
#define RPG_GAMECORE_PAUSETIMEREWINDTARGETINRANGE_METHOD_3_3A7FB5361FB548CB_OFFSET UNITYSDK_OFFSET(0x1D310500)
#define RPG_GAMECORE_PAUSETIMEREWINDTARGETINRANGE_METHOD_3_F3644F7BD52A0AE7_OFFSET UNITYSDK_OFFSET(0x1D3104B0)
#define RPG_GAMECORE_PAUSETIMEREWINDTARGETINRANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3104F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PauseTimeRewindTargetInRange_TypeDefinitionIndex = 20421;
