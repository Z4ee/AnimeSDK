...
#define RPG_GAMECORE_PAUSETIMEREWINDTARGETINRANGE_METHOD_3_3A7FB5361FB548CB_OFFSET UNITYSDK_OFFSET(0x199EB540)
#define RPG_GAMECORE_PAUSETIMEREWINDTARGETINRANGE_METHOD_3_CF75D9082087DECC_OFFSET UNITYSDK_OFFSET(0x199EB4A0)
#define RPG_GAMECORE_PAUSETIMEREWINDTARGETINRANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x199EB500)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PauseTimeRewindTargetInRange_TypeDefinitionIndex = 19517;
