...
#define RPG_GAMECORE_MARBLELAUNCHAICONFIG_METHOD_2_3D2FC51262288A18_OFFSET UNITYSDK_OFFSET(0x1D4AA570)
#define RPG_GAMECORE_MARBLELAUNCHAICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4AA7C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleLaunchAIConfig_TypeDefinitionIndex = 16719;
