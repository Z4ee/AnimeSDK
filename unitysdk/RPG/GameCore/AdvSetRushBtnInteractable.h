...
#define RPG_GAMECORE_ADVSETRUSHBTNINTERACTABLE_METHOD_3_308557A1B314959B_OFFSET UNITYSDK_OFFSET(0x19438240)
#define RPG_GAMECORE_ADVSETRUSHBTNINTERACTABLE_METHOD_3_8D47425D35CD4132_OFFSET UNITYSDK_OFFSET(0x194381C0)
#define RPG_GAMECORE_ADVSETRUSHBTNINTERACTABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x19438210)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSetRushBtnInteractable_TypeDefinitionIndex = 19069;
