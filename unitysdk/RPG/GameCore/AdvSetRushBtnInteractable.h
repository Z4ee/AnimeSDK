...
#define RPG_GAMECORE_ADVSETRUSHBTNINTERACTABLE_METHOD_3_308557A1B314959B_OFFSET UNITYSDK_OFFSET(0x1CDDB3E0)
#define RPG_GAMECORE_ADVSETRUSHBTNINTERACTABLE_METHOD_3_A1C1ABFC29E12FC8_OFFSET UNITYSDK_OFFSET(0x1CDDB3A0)
#define RPG_GAMECORE_ADVSETRUSHBTNINTERACTABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDDB3D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSetRushBtnInteractable_TypeDefinitionIndex = 19967;
