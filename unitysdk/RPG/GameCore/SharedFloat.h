...
#define RPG_GAMECORE_SHAREDFLOAT_EQUALS_OFFSET UNITYSDK_OFFSET(0x19C6DC50)
#define RPG_GAMECORE_SHAREDFLOAT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19C6DCA0)
#define RPG_GAMECORE_SHAREDFLOAT_METHOD_3_85D22C255258C41D_OFFSET UNITYSDK_OFFSET(0x19C6DC40)
#define RPG_GAMECORE_SHAREDFLOAT_METHOD_3_CCD85D2FF35B1913_OFFSET UNITYSDK_OFFSET(0x19C6DB50)
#define RPG_GAMECORE_SHAREDFLOAT_METHOD_3_D87B231C96B37D4C_OFFSET UNITYSDK_OFFSET(0x19C6DB10)
#define RPG_GAMECORE_SHAREDFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x19C6DB40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SharedFloat_TypeDefinitionIndex = 17397;
