...
#define RPG_GAMECORE_SHAREDFLOAT_EQUALS_OFFSET UNITYSDK_OFFSET(0x18E516A0)
#define RPG_GAMECORE_SHAREDFLOAT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x18E516F0)
#define RPG_GAMECORE_SHAREDFLOAT_METHOD_3_85D22C255258C41D_OFFSET UNITYSDK_OFFSET(0x18E51690)
#define RPG_GAMECORE_SHAREDFLOAT_METHOD_3_CCD85D2FF35B1913_OFFSET UNITYSDK_OFFSET(0x18E515A0)
#define RPG_GAMECORE_SHAREDFLOAT_METHOD_3_D87B231C96B37D4C_OFFSET UNITYSDK_OFFSET(0x18E51560)
#define RPG_GAMECORE_SHAREDFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x18E51590)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SharedFloat_TypeDefinitionIndex = 17392;
