...
#define RPG_GAMECORE_CHIMERADUELCOREFLAMEVESSELLEVELROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CFC30E0)
#define RPG_GAMECORE_CHIMERADUELCOREFLAMEVESSELLEVELROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFC3230)
