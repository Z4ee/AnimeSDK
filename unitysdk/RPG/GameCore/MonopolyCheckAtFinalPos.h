...
#define RPG_GAMECORE_MONOPOLYCHECKATFINALPOS_METHOD_3_170906B64BD8CAA3_OFFSET UNITYSDK_OFFSET(0x17436DD0)
#define RPG_GAMECORE_MONOPOLYCHECKATFINALPOS_METHOD_3_A37C9E106C32A9A5_OFFSET UNITYSDK_OFFSET(0x17436E50)
#define RPG_GAMECORE_MONOPOLYCHECKATFINALPOS__CTOR_OFFSET UNITYSDK_OFFSET(0x17436E20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonopolyCheckAtFinalPos_TypeDefinitionIndex = 19261;
