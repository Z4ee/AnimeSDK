...
#define RPG_GAMECORE_CHIMERADUELMIDDLEVALUESELECTORCONFIG_METHOD_3_9B724CB63241E1A7_OFFSET UNITYSDK_OFFSET(0x187FFA60)
#define RPG_GAMECORE_CHIMERADUELMIDDLEVALUESELECTORCONFIG_METHOD_3_A5591FD3D34023C9_OFFSET UNITYSDK_OFFSET(0x187FFAC0)
#define RPG_GAMECORE_CHIMERADUELMIDDLEVALUESELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x187FFAB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelMiddleValueSelectorConfig_TypeDefinitionIndex = 15104;
