...
#define RPG_GAMECORE_CHIMERADUELMIDDLEVALUESELECTORCONFIG_METHOD_3_9B724CB63241E1A7_OFFSET UNITYSDK_OFFSET(0x1C2431E0)
#define RPG_GAMECORE_CHIMERADUELMIDDLEVALUESELECTORCONFIG_METHOD_3_A5591FD3D34023C9_OFFSET UNITYSDK_OFFSET(0x1C243240)
#define RPG_GAMECORE_CHIMERADUELMIDDLEVALUESELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C243230)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelMiddleValueSelectorConfig_TypeDefinitionIndex = 15331;
