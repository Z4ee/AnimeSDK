...
#define RPG_GAMECORE_SETDYNAMICVALUEBYHITSPLITRATIO_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x19C42060)
#define RPG_GAMECORE_SETDYNAMICVALUEBYHITSPLITRATIO_METHOD_4_340DBF20D2D5A684_OFFSET UNITYSDK_OFFSET(0x19C3BFA0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYHITSPLITRATIO_METHOD_4_C708FC3B18EDAB1B_OFFSET UNITYSDK_OFFSET(0x19C41FE0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYHITSPLITRATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x19C3BF50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByHitSplitRatio_TypeDefinitionIndex = 21997;
