...
#define RPG_GAMECORE_SETDYNAMICVALUEBYHITSPLITRATIO_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1E81EDE0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYHITSPLITRATIO_METHOD_4_340DBF20D2D5A684_OFFSET UNITYSDK_OFFSET(0x1E81EC70)
#define RPG_GAMECORE_SETDYNAMICVALUEBYHITSPLITRATIO_METHOD_4_739C21CC87B2B983_OFFSET UNITYSDK_OFFSET(0x1E81EC30)
#define RPG_GAMECORE_SETDYNAMICVALUEBYHITSPLITRATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x1E81EC60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByHitSplitRatio_TypeDefinitionIndex = 23001;
