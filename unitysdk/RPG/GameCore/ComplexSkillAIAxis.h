...
#define RPG_GAMECORE_COMPLEXSKILLAIAXIS_METHOD_3_56D3AEF9BC85ECED_OFFSET UNITYSDK_OFFSET(0x171221B0)
#define RPG_GAMECORE_COMPLEXSKILLAIAXIS_METHOD_3_A24344F099036F08_OFFSET UNITYSDK_OFFSET(0x17122230)
#define RPG_GAMECORE_COMPLEXSKILLAIAXIS__CTOR_OFFSET UNITYSDK_OFFSET(0x17122220)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAIAxis_TypeDefinitionIndex = 14214;
