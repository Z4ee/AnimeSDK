...
#define RPG_GAMECORE_CAMERAFORWARDWITHDETECTPROJECTILEDATA_METHOD_3_07A8BAC121A8E18D_OFFSET UNITYSDK_OFFSET(0x1D106C30)
#define RPG_GAMECORE_CAMERAFORWARDWITHDETECTPROJECTILEDATA_METHOD_3_BF92578ED234D7CA_OFFSET UNITYSDK_OFFSET(0x1D106C90)
#define RPG_GAMECORE_CAMERAFORWARDWITHDETECTPROJECTILEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1D106C80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CameraForwardWithDetectProjectileData_TypeDefinitionIndex = 15500;
