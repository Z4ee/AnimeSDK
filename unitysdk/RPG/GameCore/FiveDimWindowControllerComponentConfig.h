...
#define RPG_GAMECORE_FIVEDIMWINDOWCONTROLLERCOMPONENTCONFIG_METHOD_3_04C7843B99E70E80_OFFSET UNITYSDK_OFFSET(0x18924200)
#define RPG_GAMECORE_FIVEDIMWINDOWCONTROLLERCOMPONENTCONFIG_METHOD_3_6E9CD4921AB86DAA_OFFSET UNITYSDK_OFFSET(0x189242B0)
#define RPG_GAMECORE_FIVEDIMWINDOWCONTROLLERCOMPONENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18924270)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimWindowControllerComponentConfig_TypeDefinitionIndex = 17888;
