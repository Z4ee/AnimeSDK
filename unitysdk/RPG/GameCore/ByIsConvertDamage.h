...
#define RPG_GAMECORE_BYISCONVERTDAMAGE_METHOD_4_2D6B44385D8B2DC4_OFFSET UNITYSDK_OFFSET(0x1A8DC130)
#define RPG_GAMECORE_BYISCONVERTDAMAGE_METHOD_4_66B8DAF8943AF645_OFFSET UNITYSDK_OFFSET(0x1A8DC160)
#define RPG_GAMECORE_BYISCONVERTDAMAGE_METHOD_4_7A69B11D65C9CB7A_OFFSET UNITYSDK_OFFSET(0x1A8DBFF0)
#define RPG_GAMECORE_BYISCONVERTDAMAGE_METHOD_4_93BFABDCEBBB7A71_OFFSET UNITYSDK_OFFSET(0x1A8DBFB0)
#define RPG_GAMECORE_BYISCONVERTDAMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8DBFE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsConvertDamage_TypeDefinitionIndex = 22651;
