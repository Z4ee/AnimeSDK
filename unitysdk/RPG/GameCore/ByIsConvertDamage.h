...
#define RPG_GAMECORE_BYISCONVERTDAMAGE_METHOD_4_7A69B11D65C9CB7A_OFFSET UNITYSDK_OFFSET(0x1702B8B0)
#define RPG_GAMECORE_BYISCONVERTDAMAGE_METHOD_4_7BF5344AF54E5750_OFFSET UNITYSDK_OFFSET(0x1702B7E0)
#define RPG_GAMECORE_BYISCONVERTDAMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1702B860)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsConvertDamage_TypeDefinitionIndex = 21726;
