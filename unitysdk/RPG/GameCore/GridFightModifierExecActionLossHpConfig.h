...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONLOSSHPCONFIG_METHOD_3_6FC2DC3870F584CA_OFFSET UNITYSDK_OFFSET(0x17267020)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONLOSSHPCONFIG_METHOD_3_978C02C842012C93_OFFSET UNITYSDK_OFFSET(0x1726ABF0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONLOSSHPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17266FD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierExecActionLossHpConfig_TypeDefinitionIndex = 17820;
