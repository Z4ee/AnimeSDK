...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONLOSSHPCONFIG_METHOD_3_6FC2DC3870F584CA_OFFSET UNITYSDK_OFFSET(0x197EC9D0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONLOSSHPCONFIG_METHOD_3_978C02C842012C93_OFFSET UNITYSDK_OFFSET(0x197F2120)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONLOSSHPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197EC980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierExecActionLossHpConfig_TypeDefinitionIndex = 18414;
