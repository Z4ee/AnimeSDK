...
#define RPG_GAMECORE_ROGUEMODIFIERREFRESHBUFFSELECTGUARANTEEDAEONBUFFCONFIG_METHOD_3_85724F3B3D2572E2_OFFSET UNITYSDK_OFFSET(0x17637D60)
#define RPG_GAMECORE_ROGUEMODIFIERREFRESHBUFFSELECTGUARANTEEDAEONBUFFCONFIG_METHOD_3_D483F6616322D8EB_OFFSET UNITYSDK_OFFSET(0x17637C90)
#define RPG_GAMECORE_ROGUEMODIFIERREFRESHBUFFSELECTGUARANTEEDAEONBUFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17637D10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierRefreshBuffSelectGuaranteedAeonBuffConfig_TypeDefinitionIndex = 16481;
