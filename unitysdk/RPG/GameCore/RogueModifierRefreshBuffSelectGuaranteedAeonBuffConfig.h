...
#define RPG_GAMECORE_ROGUEMODIFIERREFRESHBUFFSELECTGUARANTEEDAEONBUFFCONFIG_METHOD_3_81E6A85C91ECEA46_OFFSET UNITYSDK_OFFSET(0x1D1654A0)
#define RPG_GAMECORE_ROGUEMODIFIERREFRESHBUFFSELECTGUARANTEEDAEONBUFFCONFIG_METHOD_3_85724F3B3D2572E2_OFFSET UNITYSDK_OFFSET(0x1D1654F0)
#define RPG_GAMECORE_ROGUEMODIFIERREFRESHBUFFSELECTGUARANTEEDAEONBUFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1654E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierRefreshBuffSelectGuaranteedAeonBuffConfig_TypeDefinitionIndex = 17210;
