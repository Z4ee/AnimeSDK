...
#define RPG_GAMECORE_ROGUEMODIFIERREFRESHBUFFSELECTGUARANTEEDAEONBUFFCONFIG_METHOD_3_85724F3B3D2572E2_OFFSET UNITYSDK_OFFSET(0x19B9A890)
#define RPG_GAMECORE_ROGUEMODIFIERREFRESHBUFFSELECTGUARANTEEDAEONBUFFCONFIG_METHOD_3_D483F6616322D8EB_OFFSET UNITYSDK_OFFSET(0x19B9A7C0)
#define RPG_GAMECORE_ROGUEMODIFIERREFRESHBUFFSELECTGUARANTEEDAEONBUFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B9A840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierRefreshBuffSelectGuaranteedAeonBuffConfig_TypeDefinitionIndex = 17048;
