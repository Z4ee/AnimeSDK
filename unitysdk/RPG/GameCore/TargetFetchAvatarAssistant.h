...
#define RPG_GAMECORE_TARGETFETCHAVATARASSISTANT_METHOD_4_310AEEFCB3CF1031_OFFSET UNITYSDK_OFFSET(0x177BD310)
#define RPG_GAMECORE_TARGETFETCHAVATARASSISTANT_METHOD_4_86B195EFDBF8B54F_OFFSET UNITYSDK_OFFSET(0x177B2CF0)
#define RPG_GAMECORE_TARGETFETCHAVATARASSISTANT__CTOR_OFFSET UNITYSDK_OFFSET(0x177B2CA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchAvatarAssistant_TypeDefinitionIndex = 22217;
