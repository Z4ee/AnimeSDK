...
#define RPG_GAMECORE_BYHASBILLBOARD_METHOD_4_84B40662F38CC2D2_OFFSET UNITYSDK_OFFSET(0x1BBDDC90)
#define RPG_GAMECORE_BYHASBILLBOARD_METHOD_4_85B970375FC732ED_OFFSET UNITYSDK_OFFSET(0x1BBDDE10)
#define RPG_GAMECORE_BYHASBILLBOARD_METHOD_4_87F2E5A3B1C87B83_OFFSET UNITYSDK_OFFSET(0x1BBDDBF0)
#define RPG_GAMECORE_BYHASBILLBOARD_METHOD_4_E0A929357C3255E8_OFFSET UNITYSDK_OFFSET(0x1BBDDE70)
#define RPG_GAMECORE_BYHASBILLBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBDDC50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByHasBillboard_TypeDefinitionIndex = 22176;
