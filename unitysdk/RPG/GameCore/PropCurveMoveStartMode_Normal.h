...
#define RPG_GAMECORE_PROPCURVEMOVESTARTMODE_NORMAL_METHOD_3_7F6A5A6847BBACA8_OFFSET UNITYSDK_OFFSET(0x18C68500)
#define RPG_GAMECORE_PROPCURVEMOVESTARTMODE_NORMAL_METHOD_3_C116D1010E80F525_OFFSET UNITYSDK_OFFSET(0x18C68150)
#define RPG_GAMECORE_PROPCURVEMOVESTARTMODE_NORMAL__CTOR_OFFSET UNITYSDK_OFFSET(0x18C68140)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropCurveMoveStartMode_Normal_TypeDefinitionIndex = 19989;
