...
#define RPG_GAMECORE_SHOWFIGHTFESTMAINRACEUPGRADERESULTDIALOG_METHOD_3_5AE082388CEA6793_OFFSET UNITYSDK_OFFSET(0x19C7A3E0)
#define RPG_GAMECORE_SHOWFIGHTFESTMAINRACEUPGRADERESULTDIALOG_METHOD_3_6366294E9EF60455_OFFSET UNITYSDK_OFFSET(0x19C7A460)
#define RPG_GAMECORE_SHOWFIGHTFESTMAINRACEUPGRADERESULTDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x19C7A430)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowFightFestMainRaceUpgradeResultDialog_TypeDefinitionIndex = 20505;
