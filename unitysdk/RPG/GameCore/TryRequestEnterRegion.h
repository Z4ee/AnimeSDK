...
#define RPG_GAMECORE_TRYREQUESTENTERREGION_METHOD_3_A325C1008CE911CF_OFFSET UNITYSDK_OFFSET(0x178D1290)
#define RPG_GAMECORE_TRYREQUESTENTERREGION_METHOD_3_AAC5373C73794E50_OFFSET UNITYSDK_OFFSET(0x178D13F0)
#define RPG_GAMECORE_TRYREQUESTENTERREGION__CTOR_OFFSET UNITYSDK_OFFSET(0x178D12D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TryRequestEnterRegion_TypeDefinitionIndex = 19078;
