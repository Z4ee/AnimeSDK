...
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEISCOMBATPOWERWEIGHTEDRANDOMTARGET_METHOD_3_209E395D263BD62E_OFFSET UNITYSDK_OFFSET(0x1BC27270)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEISCOMBATPOWERWEIGHTEDRANDOMTARGET_METHOD_3_CD215A6E5E9C21B8_OFFSET UNITYSDK_OFFSET(0x1BC27220)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEISCOMBATPOWERWEIGHTEDRANDOMTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC27260)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAISourceIsCombatPowerWeightedRandomTarget_TypeDefinitionIndex = 14939;
