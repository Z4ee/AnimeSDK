...
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEISCOMBATPOWERWEIGHTEDRANDOMTARGET_METHOD_3_03C0C655CE055988_OFFSET UNITYSDK_OFFSET(0x1882FAD0)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEISCOMBATPOWERWEIGHTEDRANDOMTARGET_METHOD_3_209E395D263BD62E_OFFSET UNITYSDK_OFFSET(0x1882D260)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEISCOMBATPOWERWEIGHTEDRANDOMTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1882D230)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAISourceIsCombatPowerWeightedRandomTarget_TypeDefinitionIndex = 14714;
