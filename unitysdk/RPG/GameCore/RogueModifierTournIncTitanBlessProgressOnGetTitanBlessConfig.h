...
#define RPG_GAMECORE_ROGUEMODIFIERTOURNINCTITANBLESSPROGRESSONGETTITANBLESSCONFIG_METHOD_3_03681F91524F5A71_OFFSET UNITYSDK_OFFSET(0x17639D30)
#define RPG_GAMECORE_ROGUEMODIFIERTOURNINCTITANBLESSPROGRESSONGETTITANBLESSCONFIG_METHOD_3_C059723FD6A9F508_OFFSET UNITYSDK_OFFSET(0x1762DC70)
#define RPG_GAMECORE_ROGUEMODIFIERTOURNINCTITANBLESSPROGRESSONGETTITANBLESSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1762DC20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierTournIncTitanBlessProgressOnGetTitanBlessConfig_TypeDefinitionIndex = 16329;
