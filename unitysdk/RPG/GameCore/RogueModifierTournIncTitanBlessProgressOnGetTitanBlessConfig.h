...
#define RPG_GAMECORE_ROGUEMODIFIERTOURNINCTITANBLESSPROGRESSONGETTITANBLESSCONFIG_METHOD_3_68F81EC3FE07408C_OFFSET UNITYSDK_OFFSET(0x1D3FCD60)
#define RPG_GAMECORE_ROGUEMODIFIERTOURNINCTITANBLESSPROGRESSONGETTITANBLESSCONFIG_METHOD_3_C059723FD6A9F508_OFFSET UNITYSDK_OFFSET(0x1D3FCDB0)
#define RPG_GAMECORE_ROGUEMODIFIERTOURNINCTITANBLESSPROGRESSONGETTITANBLESSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3FCDA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierTournIncTitanBlessProgressOnGetTitanBlessConfig_TypeDefinitionIndex = 17565;
