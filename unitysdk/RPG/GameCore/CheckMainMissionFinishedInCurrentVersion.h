...
#define RPG_GAMECORE_CHECKMAINMISSIONFINISHEDINCURRENTVERSION_METHOD_3_0C7EADE962C51A82_OFFSET UNITYSDK_OFFSET(0x1CFA1390)
#define RPG_GAMECORE_CHECKMAINMISSIONFINISHEDINCURRENTVERSION_METHOD_3_BB1362652C25E4CB_OFFSET UNITYSDK_OFFSET(0x1CFA1350)
#define RPG_GAMECORE_CHECKMAINMISSIONFINISHEDINCURRENTVERSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFA1380)
