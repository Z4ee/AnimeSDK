...
#define RPG_GAMECORE_FOUNDATIONANDBALLBIND_METHOD_2_3F367997DF80A2A1_OFFSET UNITYSDK_OFFSET(0x1DCB3AD0)
#define RPG_GAMECORE_FOUNDATIONANDBALLBIND__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCB3D70)
