...
#define RPG_GAMECORE_ADVADDAIHANGUPINFO_METHOD_3_7BA5A4A3B3AA7622_OFFSET UNITYSDK_OFFSET(0x1CDB8850)
#define RPG_GAMECORE_ADVADDAIHANGUPINFO_METHOD_3_8408FB33CA4ACE97_OFFSET UNITYSDK_OFFSET(0x1CDB8810)
#define RPG_GAMECORE_ADVADDAIHANGUPINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDB8840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvAddAIHangUpInfo_TypeDefinitionIndex = 19996;
