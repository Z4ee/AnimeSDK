...
#define RPG_GAMECORE_MARBLEBYCOMPARESKILLROUND_METHOD_4_B04319FDA56F829A_OFFSET UNITYSDK_OFFSET(0x1BD14BE0)
#define RPG_GAMECORE_MARBLEBYCOMPARESKILLROUND_METHOD_4_E8E90F04883F7BD6_OFFSET UNITYSDK_OFFSET(0x1BD14C40)
#define RPG_GAMECORE_MARBLEBYCOMPARESKILLROUND__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD14C30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleByCompareSkillRound_TypeDefinitionIndex = 16212;
