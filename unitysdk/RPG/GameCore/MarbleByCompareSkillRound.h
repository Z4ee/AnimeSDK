...
#define RPG_GAMECORE_MARBLEBYCOMPARESKILLROUND_METHOD_4_2291BE262C307FE7_OFFSET UNITYSDK_OFFSET(0x1738A050)
#define RPG_GAMECORE_MARBLEBYCOMPARESKILLROUND_METHOD_4_C734367F8BBD0A31_OFFSET UNITYSDK_OFFSET(0x1738A130)
#define RPG_GAMECORE_MARBLEBYCOMPARESKILLROUND__CTOR_OFFSET UNITYSDK_OFFSET(0x1738A0E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleByCompareSkillRound_TypeDefinitionIndex = 15458;
