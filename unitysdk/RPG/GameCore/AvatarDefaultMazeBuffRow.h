...
#define RPG_GAMECORE_AVATARDEFAULTMAZEBUFFROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A0713E0)
#define RPG_GAMECORE_AVATARDEFAULTMAZEBUFFROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A071560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AvatarDefaultMazeBuffRow_TypeDefinitionIndex = 12290;
