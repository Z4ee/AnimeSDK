...
#define RPG_GAMECORE_AVATARENHANCEDSKILLTREEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x194968D0)
#define RPG_GAMECORE_AVATARENHANCEDSKILLTREEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19496C80)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 CommentIndex; // 0x40
