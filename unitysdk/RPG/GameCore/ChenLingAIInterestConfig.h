...
#define RPG_GAMECORE_CHENLINGAIINTERESTCONFIG_METHOD_2_B43CD488E3BB0D86_OFFSET UNITYSDK_OFFSET(0x1E0050C0)
#define RPG_GAMECORE_CHENLINGAIINTERESTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1E005210)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingAIInterestConfig_TypeDefinitionIndex = 15522;
