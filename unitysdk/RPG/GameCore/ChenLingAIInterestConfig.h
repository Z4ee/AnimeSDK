...
#define RPG_GAMECORE_CHENLINGAIINTERESTCONFIG_METHOD_2_B43CD488E3BB0D86_OFFSET UNITYSDK_OFFSET(0x1B72FB50)
#define RPG_GAMECORE_CHENLINGAIINTERESTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B72FCA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingAIInterestConfig_TypeDefinitionIndex = 15085;
