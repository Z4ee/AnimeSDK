...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TRIGGERBOSSSPECIALEFFECT_METHOD_3_8DDC1856F8A1FB06_OFFSET UNITYSDK_OFFSET(0x1C11AAC0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TRIGGERBOSSSPECIALEFFECT_METHOD_3_EC1420870418557E_OFFSET UNITYSDK_OFFSET(0x1C11AB20)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TRIGGERBOSSSPECIALEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C11AB10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_TriggerBossSpecialEffect_TypeDefinitionIndex = 15431;
