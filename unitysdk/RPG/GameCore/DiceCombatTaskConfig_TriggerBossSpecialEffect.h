...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TRIGGERBOSSSPECIALEFFECT_METHOD_3_8DDC1856F8A1FB06_OFFSET UNITYSDK_OFFSET(0x1D037820)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TRIGGERBOSSSPECIALEFFECT_METHOD_3_EC1420870418557E_OFFSET UNITYSDK_OFFSET(0x1D037880)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TRIGGERBOSSSPECIALEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D037870)
