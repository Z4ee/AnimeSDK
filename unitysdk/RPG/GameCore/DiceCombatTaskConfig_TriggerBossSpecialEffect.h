...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TRIGGERBOSSSPECIALEFFECT_METHOD_3_BA3135A193573415_OFFSET UNITYSDK_OFFSET(0x1887D440)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TRIGGERBOSSSPECIALEFFECT_METHOD_3_EC1420870418557E_OFFSET UNITYSDK_OFFSET(0x18879740)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TRIGGERBOSSSPECIALEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x188796F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_TriggerBossSpecialEffect_TypeDefinitionIndex = 15207;
