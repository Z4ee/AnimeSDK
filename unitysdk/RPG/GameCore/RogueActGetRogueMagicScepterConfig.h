...
#define RPG_GAMECORE_ROGUEACTGETROGUEMAGICSCEPTERCONFIG_METHOD_6_384CE4FDEED3EDAD_OFFSET UNITYSDK_OFFSET(0x19AE7B80)
#define RPG_GAMECORE_ROGUEACTGETROGUEMAGICSCEPTERCONFIG_METHOD_6_C728D1D0843E5D90_OFFSET UNITYSDK_OFFSET(0x19AE7960)
#define RPG_GAMECORE_ROGUEACTGETROGUEMAGICSCEPTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AE7AA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActGetRogueMagicScepterConfig_TypeDefinitionIndex = 18655;
