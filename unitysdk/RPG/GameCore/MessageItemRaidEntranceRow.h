...
#define RPG_GAMECORE_MESSAGEITEMRAIDENTRANCEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19914A10)
#define RPG_GAMECORE_MESSAGEITEMRAIDENTRANCEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19915670)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MessageItemRaidEntranceRow_TypeDefinitionIndex = 13748;
