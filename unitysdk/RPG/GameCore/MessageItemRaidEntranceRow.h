...
#define RPG_GAMECORE_MESSAGEITEMRAIDENTRANCEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1AF5EC90)
#define RPG_GAMECORE_MESSAGEITEMRAIDENTRANCEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF5F8F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MessageItemRaidEntranceRow_TypeDefinitionIndex = 13896;
