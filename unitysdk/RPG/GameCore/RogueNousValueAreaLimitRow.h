...
#define RPG_GAMECORE_ROGUENOUSVALUEAREALIMITROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D40BEC0)
#define RPG_GAMECORE_ROGUENOUSVALUEAREALIMITROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D40C530)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueNousValueAreaLimitRow_TypeDefinitionIndex = 14752;
