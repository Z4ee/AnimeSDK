...
#define RPG_GAMECORE_ROGUENOUSVALUEAREALIMITROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D175940)
#define RPG_GAMECORE_ROGUENOUSVALUEAREALIMITROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D175FB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueNousValueAreaLimitRow_TypeDefinitionIndex = 14332;

	class RogueNousValueAreaLimitRow : public ::System::Object
	{
	public:
		::System::Int32 MaxNousValue; // 0x10
		::System::UInt32 AreaID; // 0x14
		::System::Int32 MinNousValue; // 0x18
