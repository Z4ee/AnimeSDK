...
#define RPG_GAMECORE_ROGUENOUSVALUEAREALIMITROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17649680)
#define RPG_GAMECORE_ROGUENOUSVALUEAREALIMITROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17649CD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueNousValueAreaLimitRow_TypeDefinitionIndex = 13651;
