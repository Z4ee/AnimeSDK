...
#define RPG_GAMECORE_ROGUEBONUSEVENTEFFECTCONFIG_METHOD_2_404883545EFC4BD4_OFFSET UNITYSDK_OFFSET(0x1D3C4DD0)
#define RPG_GAMECORE_ROGUEBONUSEVENTEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3C4E10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueBonusEventEffectConfig_TypeDefinitionIndex = 17691;
