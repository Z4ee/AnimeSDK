...
#define RPG_GAMECORE_ROGUEBONUSEVENTEFFECTCONFIG_METHOD_2_404883545EFC4BD4_OFFSET UNITYSDK_OFFSET(0x1D911CA0)
#define RPG_GAMECORE_ROGUEBONUSEVENTEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D911CE0)
