...
#define RPG_GAMECORE_TRACKNPCALERTVALUECONFIG_METHOD_2_6BFCFEF2B832669A_OFFSET UNITYSDK_OFFSET(0x1C1596B0)
#define RPG_GAMECORE_TRACKNPCALERTVALUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C159900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrackNpcAlertValueConfig_TypeDefinitionIndex = 21370;
