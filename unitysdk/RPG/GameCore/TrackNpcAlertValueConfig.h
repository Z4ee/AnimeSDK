...
#define RPG_GAMECORE_TRACKNPCALERTVALUECONFIG_METHOD_2_6BFCFEF2B832669A_OFFSET UNITYSDK_OFFSET(0x178A39C0)
#define RPG_GAMECORE_TRACKNPCALERTVALUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x178A3C10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrackNpcAlertValueConfig_TypeDefinitionIndex = 20364;
