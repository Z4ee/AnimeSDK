...
#define RPG_GAMECORE_TRACKNPCALERTVALUECONFIG_METHOD_2_6BFCFEF2B832669A_OFFSET UNITYSDK_OFFSET(0x1D52EA40)
#define RPG_GAMECORE_TRACKNPCALERTVALUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D52EC90)
