...
#define RPG_GAMECORE_ADVENTUREATTACKDETECTCIRCLECONFIG_METHOD_3_1571164E920D0733_OFFSET UNITYSDK_OFFSET(0x1866D260)
#define RPG_GAMECORE_ADVENTUREATTACKDETECTCIRCLECONFIG_METHOD_3_DFC2BC2A6B419832_OFFSET UNITYSDK_OFFSET(0x1866D2B0)
#define RPG_GAMECORE_ADVENTUREATTACKDETECTCIRCLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1866D2A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureAttackDetectCircleConfig_TypeDefinitionIndex = 15400;
