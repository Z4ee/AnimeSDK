...
#define RPG_GAMECORE_MODIFYSWITCHHANDCONTROLPARAM_METHOD_3_B07CD41B72737B2D_OFFSET UNITYSDK_OFFSET(0x174351D0)
#define RPG_GAMECORE_MODIFYSWITCHHANDCONTROLPARAM_METHOD_3_FC314BB4F30400B8_OFFSET UNITYSDK_OFFSET(0x17435250)
#define RPG_GAMECORE_MODIFYSWITCHHANDCONTROLPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x17435220)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifySwitchHandControlParam_TypeDefinitionIndex = 19291;
