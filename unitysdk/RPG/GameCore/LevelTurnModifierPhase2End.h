...
#define RPG_GAMECORE_LEVELTURNMODIFIERPHASE2END_GETACTIVEENTITY_OFFSET UNITYSDK_OFFSET(0xA9930D0)
#define RPG_GAMECORE_LEVELTURNMODIFIERPHASE2END_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xA993080)
#define RPG_GAMECORE_LEVELTURNMODIFIERPHASE2END_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xA993030)
#define RPG_GAMECORE_LEVELTURNMODIFIERPHASE2END_GETTURNCOUNTER_OFFSET UNITYSDK_OFFSET(0xA993110)
#define RPG_GAMECORE_LEVELTURNMODIFIERPHASE2END__CTOR_OFFSET UNITYSDK_OFFSET(0xA993020)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelTurnModifierPhase2End_TypeDefinitionIndex = 45607;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::RPG::GameCore::GameEntity*, ::System::UInt32))((::PBYTE)hIl2Cpp + RPG_GAMECORE_LEVELTURNMODIFIERPHASE2END__CTOR_OFFSET))(this, ActiveEntity, TurnCounter);
		}
