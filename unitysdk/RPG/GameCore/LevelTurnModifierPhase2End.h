...
#define RPG_GAMECORE_LEVELTURNMODIFIERPHASE2END_GETACTIVEENTITY_OFFSET UNITYSDK_OFFSET(0x197821C0)
#define RPG_GAMECORE_LEVELTURNMODIFIERPHASE2END_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x19782170)
#define RPG_GAMECORE_LEVELTURNMODIFIERPHASE2END_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x19782120)
#define RPG_GAMECORE_LEVELTURNMODIFIERPHASE2END_GETTURNCOUNTER_OFFSET UNITYSDK_OFFSET(0x19782200)
#define RPG_GAMECORE_LEVELTURNMODIFIERPHASE2END__CTOR_OFFSET UNITYSDK_OFFSET(0x19782110)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelTurnModifierPhase2End_TypeDefinitionIndex = 54167;
