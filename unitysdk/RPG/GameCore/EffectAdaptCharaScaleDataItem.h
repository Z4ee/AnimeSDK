...
#define RPG_GAMECORE_EFFECTADAPTCHARASCALEDATAITEM_METHOD_2_F00076090E402343_OFFSET UNITYSDK_OFFSET(0x17188620)
#define RPG_GAMECORE_EFFECTADAPTCHARASCALEDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x17188780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EffectAdaptCharaScaleDataItem_TypeDefinitionIndex = 15102;
