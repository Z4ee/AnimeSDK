...
#define RPG_GAMECORE_EFFECTADAPTCHARASCALEDATAITEM_METHOD_2_F00076090E402343_OFFSET UNITYSDK_OFFSET(0x1D051F80)
#define RPG_GAMECORE_EFFECTADAPTCHARASCALEDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0520E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EffectAdaptCharaScaleDataItem_TypeDefinitionIndex = 16319;
