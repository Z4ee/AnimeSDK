...
#define RPG_GAMECORE_SILVERWOLFQUESTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D09EC70)
#define RPG_GAMECORE_SILVERWOLFQUESTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D09EE60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SilverWolfQuestConfigRow_TypeDefinitionIndex = 12267;
