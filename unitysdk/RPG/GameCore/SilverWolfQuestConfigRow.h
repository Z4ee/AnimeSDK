...
#define RPG_GAMECORE_SILVERWOLFQUESTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19C87E50)
#define RPG_GAMECORE_SILVERWOLFQUESTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19C88040)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SilverWolfQuestConfigRow_TypeDefinitionIndex = 11778;
