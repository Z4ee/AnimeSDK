...
#define RPG_GAMECORE_ROGUEMAGICTALENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19B48000)
#define RPG_GAMECORE_ROGUEMAGICTALENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19B482D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueMagicTalentRow_TypeDefinitionIndex = 14135;
	...
	public:
		...
		::System::UInt32 NameDisplayID; // 0x44
