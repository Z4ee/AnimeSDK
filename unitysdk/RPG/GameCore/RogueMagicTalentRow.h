...
#define RPG_GAMECORE_ROGUEMAGICTALENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17616B20)
#define RPG_GAMECORE_ROGUEMAGICTALENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17616E00)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 NameDisplayID; // 0x40
