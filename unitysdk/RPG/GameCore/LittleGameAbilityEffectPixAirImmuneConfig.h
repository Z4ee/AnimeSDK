...
#define RPG_GAMECORE_LITTLEGAMEABILITYEFFECTPIXAIRIMMUNECONFIG_METHOD_3_1EE4868694CC1584_OFFSET UNITYSDK_OFFSET(0x1B092D20)
#define RPG_GAMECORE_LITTLEGAMEABILITYEFFECTPIXAIRIMMUNECONFIG_METHOD_3_F949BEF85C0D6959_OFFSET UNITYSDK_OFFSET(0x1B092DC0)
#define RPG_GAMECORE_LITTLEGAMEABILITYEFFECTPIXAIRIMMUNECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B092DB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityEffectPixAirImmuneConfig_TypeDefinitionIndex = 20547;
