...
#define RPG_GAMECORE_LITTLEGAMEABILITYEFFECTPIXAIRIMMUNECONFIG_METHOD_3_1EE4868694CC1584_OFFSET UNITYSDK_OFFSET(0x198932B0)
#define RPG_GAMECORE_LITTLEGAMEABILITYEFFECTPIXAIRIMMUNECONFIG_METHOD_3_F949BEF85C0D6959_OFFSET UNITYSDK_OFFSET(0x19893350)
#define RPG_GAMECORE_LITTLEGAMEABILITYEFFECTPIXAIRIMMUNECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19893340)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityEffectPixAirImmuneConfig_TypeDefinitionIndex = 20174;
