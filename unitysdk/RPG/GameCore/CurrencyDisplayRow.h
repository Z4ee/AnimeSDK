...
#define RPG_GAMECORE_CURRENCYDISPLAYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D00C9D0)
#define RPG_GAMECORE_CURRENCYDISPLAYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D00CF80)
