...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERMONSTERHPRATIOCONFIG_METHOD_3_59DB532F03EDB793_OFFSET UNITYSDK_OFFSET(0x1D06A4A0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERMONSTERHPRATIOCONFIG_METHOD_3_9D5CDD91CD9A6FD7_OFFSET UNITYSDK_OFFSET(0x1D06A4F0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERMONSTERHPRATIOCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D06A4E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierMonsterHpRatioConfig_TypeDefinitionIndex = 18729;
