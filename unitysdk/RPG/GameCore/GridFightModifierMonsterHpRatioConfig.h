...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERMONSTERHPRATIOCONFIG_METHOD_3_38CA29BF7AB12ADE_OFFSET UNITYSDK_OFFSET(0x189BDE10)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERMONSTERHPRATIOCONFIG_METHOD_3_9D5CDD91CD9A6FD7_OFFSET UNITYSDK_OFFSET(0x189BDEE0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERMONSTERHPRATIOCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189BDE90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierMonsterHpRatioConfig_TypeDefinitionIndex = 18507;
