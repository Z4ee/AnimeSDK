...
#define RPG_GAMECORE_SHOWRAIDFINISHUI_METHOD_3_979CB63E733A28A9_OFFSET UNITYSDK_OFFSET(0x18E65400)
#define RPG_GAMECORE_SHOWRAIDFINISHUI_METHOD_3_AFB78C2AF410F0A0_OFFSET UNITYSDK_OFFSET(0x18E65480)
#define RPG_GAMECORE_SHOWRAIDFINISHUI__CTOR_OFFSET UNITYSDK_OFFSET(0x18E65450)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowRaidFinishUI_TypeDefinitionIndex = 20458;
