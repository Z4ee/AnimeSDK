...
#define RPG_GAMECORE_SHOWRAIDFINISHUI_METHOD_3_7557ED6E6DD8DC1B_OFFSET UNITYSDK_OFFSET(0x1BE45410)
#define RPG_GAMECORE_SHOWRAIDFINISHUI_METHOD_3_AFB78C2AF410F0A0_OFFSET UNITYSDK_OFFSET(0x1BE45450)
#define RPG_GAMECORE_SHOWRAIDFINISHUI__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE45440)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowRaidFinishUI_TypeDefinitionIndex = 20814;
