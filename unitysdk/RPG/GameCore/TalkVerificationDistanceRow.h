...
#define RPG_GAMECORE_TALKVERIFICATIONDISTANCEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19CF2530)
#define RPG_GAMECORE_TALKVERIFICATIONDISTANCEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19CF2660)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TalkVerificationDistanceRow_TypeDefinitionIndex = 14451;
