...
#define RPG_GAMECORE_ELFSPECIALEVENTSELECTRESULTITEM_METHOD_2_E271AEB8D469ACF9_OFFSET UNITYSDK_OFFSET(0x1D7B6F40)
#define RPG_GAMECORE_ELFSPECIALEVENTSELECTRESULTITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7B7330)
