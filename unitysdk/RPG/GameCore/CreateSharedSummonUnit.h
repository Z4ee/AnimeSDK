...
#define RPG_GAMECORE_CREATESHAREDSUMMONUNIT_METHOD_3_A0CEB95917031CBC_OFFSET UNITYSDK_OFFSET(0x19684C80)
#define RPG_GAMECORE_CREATESHAREDSUMMONUNIT_METHOD_3_B73155A6A13641FE_OFFSET UNITYSDK_OFFSET(0x19684E90)
#define RPG_GAMECORE_CREATESHAREDSUMMONUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0x19684CC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CreateSharedSummonUnit_TypeDefinitionIndex = 19992;
