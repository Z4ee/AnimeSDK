...
#define RPG_GAMECORE_CREATESHAREDSUMMONUNIT_METHOD_3_A0CEB95917031CBC_OFFSET UNITYSDK_OFFSET(0x1BC3CC40)
#define RPG_GAMECORE_CREATESHAREDSUMMONUNIT_METHOD_3_B73155A6A13641FE_OFFSET UNITYSDK_OFFSET(0x1BC3CE00)
#define RPG_GAMECORE_CREATESHAREDSUMMONUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC3CC80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CreateSharedSummonUnit_TypeDefinitionIndex = 20364;
