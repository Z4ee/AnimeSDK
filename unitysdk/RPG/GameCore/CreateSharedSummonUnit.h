...
#define RPG_GAMECORE_CREATESHAREDSUMMONUNIT_METHOD_3_2A874A3828E22EB5_OFFSET UNITYSDK_OFFSET(0x1713E580)
#define RPG_GAMECORE_CREATESHAREDSUMMONUNIT_METHOD_3_EFFCE7EFF563BAED_OFFSET UNITYSDK_OFFSET(0x1713E790)
#define RPG_GAMECORE_CREATESHAREDSUMMONUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1713E5C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CreateSharedSummonUnit_TypeDefinitionIndex = 19460;
