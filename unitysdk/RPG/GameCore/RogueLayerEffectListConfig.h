...
#define RPG_GAMECORE_ROGUELAYEREFFECTLISTCONFIG_METHOD_2_0AB62ECF33FB9C8C_OFFSET UNITYSDK_OFFSET(0x176107E0)
#define RPG_GAMECORE_ROGUELAYEREFFECTLISTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17610820)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueLayerEffectListConfig_TypeDefinitionIndex = 16465;
