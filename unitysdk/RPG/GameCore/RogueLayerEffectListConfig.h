...
#define RPG_GAMECORE_ROGUELAYEREFFECTLISTCONFIG_METHOD_2_0AB62ECF33FB9C8C_OFFSET UNITYSDK_OFFSET(0x1CFB3EA0)
#define RPG_GAMECORE_ROGUELAYEREFFECTLISTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFB3EE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueLayerEffectListConfig_TypeDefinitionIndex = 17195;
