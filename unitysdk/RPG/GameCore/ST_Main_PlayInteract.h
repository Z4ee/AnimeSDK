...
#define RPG_GAMECORE_ST_MAIN_PLAYINTERACT_METHOD_4_A3474BC459BCCFDA_OFFSET UNITYSDK_OFFSET(0x17688420)
#define RPG_GAMECORE_ST_MAIN_PLAYINTERACT_METHOD_4_D7868C88FE1C1BA8_OFFSET UNITYSDK_OFFSET(0x17698220)
#define RPG_GAMECORE_ST_MAIN_PLAYINTERACT__CTOR_OFFSET UNITYSDK_OFFSET(0x176883D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_PlayInteract_TypeDefinitionIndex = 18427;
