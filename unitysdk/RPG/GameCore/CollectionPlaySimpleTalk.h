...
#define RPG_GAMECORE_COLLECTIONPLAYSIMPLETALK_METHOD_3_4114C02E6E463901_OFFSET UNITYSDK_OFFSET(0x1CFEE9A0)
#define RPG_GAMECORE_COLLECTIONPLAYSIMPLETALK_METHOD_3_9D237791A02B5034_OFFSET UNITYSDK_OFFSET(0x1CFEE950)
#define RPG_GAMECORE_COLLECTIONPLAYSIMPLETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFEE990)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CollectionPlaySimpleTalk_TypeDefinitionIndex = 20174;
