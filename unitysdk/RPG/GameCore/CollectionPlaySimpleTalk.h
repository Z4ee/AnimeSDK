...
#define RPG_GAMECORE_COLLECTIONPLAYSIMPLETALK_METHOD_3_4114C02E6E463901_OFFSET UNITYSDK_OFFSET(0x19666B80)
#define RPG_GAMECORE_COLLECTIONPLAYSIMPLETALK_METHOD_3_84BAABDA5EF018C0_OFFSET UNITYSDK_OFFSET(0x19666B00)
#define RPG_GAMECORE_COLLECTIONPLAYSIMPLETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x19666B50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CollectionPlaySimpleTalk_TypeDefinitionIndex = 19272;
