...
#define RPG_GAMECORE_BUFFCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C2EE6D0)
#define RPG_GAMECORE_BUFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2EE7F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BuffConfig_TypeDefinitionIndex = 12965;
