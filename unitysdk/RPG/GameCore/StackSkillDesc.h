...
#define RPG_GAMECORE_STACKSKILLDESC_METHOD_3_E001CC4C5B83652D_OFFSET UNITYSDK_OFFSET(0x18E87C10)
#define RPG_GAMECORE_STACKSKILLDESC_METHOD_3_EFFA8692BDCE2294_OFFSET UNITYSDK_OFFSET(0x18E87B90)
#define RPG_GAMECORE_STACKSKILLDESC__CTOR_OFFSET UNITYSDK_OFFSET(0x18E87BE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StackSkillDesc_TypeDefinitionIndex = 22075;
