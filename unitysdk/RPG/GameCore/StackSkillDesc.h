...
#define RPG_GAMECORE_STACKSKILLDESC_METHOD_3_AAC8E2066CBA6F5C_OFFSET UNITYSDK_OFFSET(0x1D0B9C20)
#define RPG_GAMECORE_STACKSKILLDESC_METHOD_3_E001CC4C5B83652D_OFFSET UNITYSDK_OFFSET(0x1D0B9C60)
#define RPG_GAMECORE_STACKSKILLDESC__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0B9C50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StackSkillDesc_TypeDefinitionIndex = 22872;
