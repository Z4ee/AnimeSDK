...
#define RPG_GAMECORE_WAITPARALLELTIMESTAMP_METHOD_3_424D5C1D53963308_OFFSET UNITYSDK_OFFSET(0x178FEE00)
#define RPG_GAMECORE_WAITPARALLELTIMESTAMP_METHOD_3_CBB797929CF0F66F_OFFSET UNITYSDK_OFFSET(0x178FEF20)
#define RPG_GAMECORE_WAITPARALLELTIMESTAMP__CTOR_OFFSET UNITYSDK_OFFSET(0x178FEEA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitParallelTimeStamp_TypeDefinitionIndex = 20877;
