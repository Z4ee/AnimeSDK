...
#define RPG_GAMECORE_WAITPARALLELTIMESTAMP_METHOD_3_9A818C7335FEB631_OFFSET UNITYSDK_OFFSET(0x1D6A78A0)
#define RPG_GAMECORE_WAITPARALLELTIMESTAMP_METHOD_3_CBB797929CF0F66F_OFFSET UNITYSDK_OFFSET(0x1D6A79A0)
#define RPG_GAMECORE_WAITPARALLELTIMESTAMP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6A7930)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitParallelTimeStamp_TypeDefinitionIndex = 22436;
