...
#define RPG_GAMECORE_ADVENTUREBYCOMPAREMP_METHOD_4_6EA6B6C15F4E0719_OFFSET UNITYSDK_OFFSET(0x16F4BE80)
#define RPG_GAMECORE_ADVENTUREBYCOMPAREMP_METHOD_4_AA6324D93AAA9EE5_OFFSET UNITYSDK_OFFSET(0x16F4BDB0)
#define RPG_GAMECORE_ADVENTUREBYCOMPAREMP__CTOR_OFFSET UNITYSDK_OFFSET(0x16F4BE30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureByCompareMP_TypeDefinitionIndex = 22324;
