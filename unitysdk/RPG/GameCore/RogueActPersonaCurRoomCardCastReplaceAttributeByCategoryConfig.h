...
#define RPG_GAMECORE_ROGUEACTPERSONACURROOMCARDCASTREPLACEATTRIBUTEBYCATEGORYCONFIG_METHOD_7_503BBEAF461C5A2E_OFFSET UNITYSDK_OFFSET(0x1D3B89F0)
#define RPG_GAMECORE_ROGUEACTPERSONACURROOMCARDCASTREPLACEATTRIBUTEBYCATEGORYCONFIG_METHOD_7_D032567539283992_OFFSET UNITYSDK_OFFSET(0x1D3B8AD0)
#define RPG_GAMECORE_ROGUEACTPERSONACURROOMCARDCASTREPLACEATTRIBUTEBYCATEGORYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3B89E0)
