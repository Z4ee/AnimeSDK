...
#define RPG_GAMECORE_ROGUEACTPERSONACURROOMCARDCASTREPLACEATTRIBUTEBYCATEGORYCONFIG_METHOD_7_3415D7B90DE305EB_OFFSET UNITYSDK_OFFSET(0x175BC910)
#define RPG_GAMECORE_ROGUEACTPERSONACURROOMCARDCASTREPLACEATTRIBUTEBYCATEGORYCONFIG_METHOD_7_503BBEAF461C5A2E_OFFSET UNITYSDK_OFFSET(0x175BC530)
#define RPG_GAMECORE_ROGUEACTPERSONACURROOMCARDCASTREPLACEATTRIBUTEBYCATEGORYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175BC450)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaCurRoomCardCastReplaceAttributeByCategoryConfig_TypeDefinitionIndex = 18120;
