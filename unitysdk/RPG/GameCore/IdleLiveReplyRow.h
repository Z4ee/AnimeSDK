...
#define RPG_GAMECORE_IDLELIVEREPLYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D1A2EA0)
#define RPG_GAMECORE_IDLELIVEREPLYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1A3020)

namespace RPG::GameCore
{
	inline static constexpr unsigned int IdleLiveReplyRow_TypeDefinitionIndex = 11771;
