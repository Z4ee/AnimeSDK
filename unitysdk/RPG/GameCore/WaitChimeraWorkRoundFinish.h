...
#define RPG_GAMECORE_WAITCHIMERAWORKROUNDFINISH_METHOD_3_21C9D00BDDBD71EB_OFFSET UNITYSDK_OFFSET(0x19E52700)
#define RPG_GAMECORE_WAITCHIMERAWORKROUNDFINISH_METHOD_3_5727CE9F04003CB2_OFFSET UNITYSDK_OFFSET(0x19E52780)
#define RPG_GAMECORE_WAITCHIMERAWORKROUNDFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x19E52750)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitChimeraWorkRoundFinish_TypeDefinitionIndex = 20515;
