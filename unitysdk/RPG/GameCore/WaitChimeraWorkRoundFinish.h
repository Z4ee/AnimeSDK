...
#define RPG_GAMECORE_WAITCHIMERAWORKROUNDFINISH_METHOD_3_282F3D2939EEE681_OFFSET UNITYSDK_OFFSET(0x1DEB50E0)
#define RPG_GAMECORE_WAITCHIMERAWORKROUNDFINISH_METHOD_3_5727CE9F04003CB2_OFFSET UNITYSDK_OFFSET(0x1DEB5120)
#define RPG_GAMECORE_WAITCHIMERAWORKROUNDFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEB5110)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitChimeraWorkRoundFinish_TypeDefinitionIndex = 21486;
