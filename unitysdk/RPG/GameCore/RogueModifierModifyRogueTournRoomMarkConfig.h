...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYROGUETOURNROOMMARKCONFIG_METHOD_3_4B54732702E3926D_OFFSET UNITYSDK_OFFSET(0x18D425C0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYROGUETOURNROOMMARKCONFIG_METHOD_3_F70602D1193A1E64_OFFSET UNITYSDK_OFFSET(0x18D42690)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYROGUETOURNROOMMARKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D42640)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyRogueTournRoomMarkConfig_TypeDefinitionIndex = 16881;
