...
#define RPG_GAMECORE_TUTORIALCLICKBTN_METHOD_3_D1BADCDE0D187F51_OFFSET UNITYSDK_OFFSET(0x19E26BD0)
#define RPG_GAMECORE_TUTORIALCLICKBTN_METHOD_3_D892F439DD18BEF8_OFFSET UNITYSDK_OFFSET(0x19E26C50)
#define RPG_GAMECORE_TUTORIALCLICKBTN__CTOR_OFFSET UNITYSDK_OFFSET(0x19E26C20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TutorialClickBtn_TypeDefinitionIndex = 22965;
