...
#define RPG_GAMECORE_TUTORIALCLICKBTN_METHOD_3_50F0048037D9D79B_OFFSET UNITYSDK_OFFSET(0x1B068600)
#define RPG_GAMECORE_TUTORIALCLICKBTN_METHOD_3_D892F439DD18BEF8_OFFSET UNITYSDK_OFFSET(0x1B068640)
#define RPG_GAMECORE_TUTORIALCLICKBTN__CTOR_OFFSET UNITYSDK_OFFSET(0x1B068630)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TutorialClickBtn_TypeDefinitionIndex = 23432;
