...
#define RPG_GAMECORE_ADVSETWAVINGBLOCKCONTROL_METHOD_3_E0E6F386D341518A_OFFSET UNITYSDK_OFFSET(0x18665530)
#define RPG_GAMECORE_ADVSETWAVINGBLOCKCONTROL_METHOD_3_FF42F42F7C698ED9_OFFSET UNITYSDK_OFFSET(0x186655B0)
#define RPG_GAMECORE_ADVSETWAVINGBLOCKCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x18665580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSetWavingBlockControl_TypeDefinitionIndex = 21106;
