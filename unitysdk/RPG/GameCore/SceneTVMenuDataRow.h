...
#define RPG_GAMECORE_SCENETVMENUDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1769B950)
#define RPG_GAMECORE_SCENETVMENUDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1769BC50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SceneTVMenuDataRow_TypeDefinitionIndex = 13288;
	...
	public:
		...
		::System::Int32 ProgramGroupID; // 0x28
		::System::UInt32 ID; // 0x2C
		::System::Int32 Order; // 0x30
		::System::Int32 PlayType; // 0x34
