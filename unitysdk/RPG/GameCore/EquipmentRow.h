...
#define RPG_GAMECORE_EQUIPMENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x171A4740)
#define RPG_GAMECORE_EQUIPMENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x171A8AA0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::System::Single>* GachaResultOffset; // 0x30
		::Il2CppArray<::System::Single>* ItemRightPanelOffset; // 0x38
		::Il2CppArray<::System::Single>* BattleDialogOffset; // 0x40
		::RPG::Client::TextID EquipmentDesc; // 0x48
		::System::UInt32 EquipmentID; // 0x58
		::RPG::GameCore::AvatarBaseType AvatarBaseType; // 0x5C
		::System::UInt32 CoinCost; // 0x60
		::RPG::GameCore::CombatPowerLightconeRarityType Rarity; // 0x64
		::RPG::Client::TextID EquipmentName; // 0x68
		::System::UInt32 MaxRank; // 0x78
		::System::UInt32 ExpProvide; // 0x7C
		::System::Boolean Release; // 0x80
		::System::UInt32 SkillID; // 0x84
		::System::UInt32 ExpType; // 0x88
