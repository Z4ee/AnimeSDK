...
#define RPG_GAMECORE_EQUIPMENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x196EFAB0)
#define RPG_GAMECORE_EQUIPMENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x196F3CF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EquipmentRow_TypeDefinitionIndex = 12602;

	class EquipmentRow : public ::System::Object
	{
	public:
		::Il2CppArray<::System::Single>* AvatarDetailOffset; // 0x10
		::System::String* ThumbnailPath; // 0x18
		::Il2CppArray<::System::Single>* GachaResultOffset; // 0x20
		::Il2CppArray<::System::Single>* BattleDialogOffset; // 0x28
		...
		::System::UInt32 ExpType; // 0x58
		::RPG::GameCore::CombatPowerLightconeRarityType Rarity; // 0x5C
		::System::UInt32 ExpProvide; // 0x60
		::System::UInt32 MaxRank; // 0x64
		::RPG::Client::TextID EquipmentName; // 0x68
		::RPG::Client::TextID EquipmentDesc; // 0x78
		::System::UInt32 MaxPromotion; // 0x88
		::System::Boolean Release; // 0x8C
