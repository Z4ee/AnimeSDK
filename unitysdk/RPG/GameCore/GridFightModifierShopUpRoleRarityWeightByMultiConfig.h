...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSHOPUPROLERARITYWEIGHTBYMULTICONFIG_METHOD_3_2D148826BA7D90E4_OFFSET UNITYSDK_OFFSET(0x1D06B1C0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSHOPUPROLERARITYWEIGHTBYMULTICONFIG_METHOD_3_FC49B801D5EDA620_OFFSET UNITYSDK_OFFSET(0x1D06B210)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSHOPUPROLERARITYWEIGHTBYMULTICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D06B200)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierShopUpRoleRarityWeightByMultiConfig_TypeDefinitionIndex = 18599;
