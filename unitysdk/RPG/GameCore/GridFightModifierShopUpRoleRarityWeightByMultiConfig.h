...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSHOPUPROLERARITYWEIGHTBYMULTICONFIG_METHOD_3_9EA1C46582E40989_OFFSET UNITYSDK_OFFSET(0x1726C740)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSHOPUPROLERARITYWEIGHTBYMULTICONFIG_METHOD_3_FC49B801D5EDA620_OFFSET UNITYSDK_OFFSET(0x1726C810)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSHOPUPROLERARITYWEIGHTBYMULTICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1726C7C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierShopUpRoleRarityWeightByMultiConfig_TypeDefinitionIndex = 17766;
