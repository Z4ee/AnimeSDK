...
#define RPG_GAMECORE_BYCURRENTROGUEHASBUFFCOMPONENT_METHOD_4_52DFD9D78B4F76CA_OFFSET UNITYSDK_OFFSET(0x187431B0)
#define RPG_GAMECORE_BYCURRENTROGUEHASBUFFCOMPONENT_METHOD_4_A361F41A90BD138A_OFFSET UNITYSDK_OFFSET(0x187430F0)
#define RPG_GAMECORE_BYCURRENTROGUEHASBUFFCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x18743160)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCurrentRogueHasBuffComponent_TypeDefinitionIndex = 20032;
