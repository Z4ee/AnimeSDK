...
#define RPG_GAMECORE_BYCURRENTROGUEHASBUFFCOMPONENT_METHOD_4_52DFD9D78B4F76CA_OFFSET UNITYSDK_OFFSET(0x1A8B8BC0)
#define RPG_GAMECORE_BYCURRENTROGUEHASBUFFCOMPONENT_METHOD_4_C756F971B6A44817_OFFSET UNITYSDK_OFFSET(0x1A8B8B80)
#define RPG_GAMECORE_BYCURRENTROGUEHASBUFFCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8B8BB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCurrentRogueHasBuffComponent_TypeDefinitionIndex = 20256;
