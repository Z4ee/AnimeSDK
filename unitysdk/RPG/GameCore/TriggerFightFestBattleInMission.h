...
#define RPG_GAMECORE_TRIGGERFIGHTFESTBATTLEINMISSION_METHOD_3_244A3684DBD03876_OFFSET UNITYSDK_OFFSET(0x190C6020)
#define RPG_GAMECORE_TRIGGERFIGHTFESTBATTLEINMISSION_METHOD_3_C6710AA0C49F25A2_OFFSET UNITYSDK_OFFSET(0x190C6130)
#define RPG_GAMECORE_TRIGGERFIGHTFESTBATTLEINMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x190C6100)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerFightFestBattleInMission_TypeDefinitionIndex = 20569;
