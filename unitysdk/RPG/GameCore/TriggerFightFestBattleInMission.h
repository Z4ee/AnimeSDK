...
#define RPG_GAMECORE_TRIGGERFIGHTFESTBATTLEINMISSION_METHOD_3_743CFF82AA3A825F_OFFSET UNITYSDK_OFFSET(0x1D5FF0D0)
#define RPG_GAMECORE_TRIGGERFIGHTFESTBATTLEINMISSION_METHOD_3_C6710AA0C49F25A2_OFFSET UNITYSDK_OFFSET(0x1D5FF1A0)
#define RPG_GAMECORE_TRIGGERFIGHTFESTBATTLEINMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5FF190)
