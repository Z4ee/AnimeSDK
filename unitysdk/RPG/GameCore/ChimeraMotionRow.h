...
#define RPG_GAMECORE_CHIMERAMOTIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x170A99C0)
#define RPG_GAMECORE_CHIMERAMOTIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x170A9B00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraMotionRow_TypeDefinitionIndex = 11889;
