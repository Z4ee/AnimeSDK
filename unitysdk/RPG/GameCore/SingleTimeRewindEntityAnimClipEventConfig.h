...
#define RPG_GAMECORE_SINGLETIMEREWINDENTITYANIMCLIPEVENTCONFIG_METHOD_3_7C57C0CCCCBB0669_OFFSET UNITYSDK_OFFSET(0x1770AFD0)
#define RPG_GAMECORE_SINGLETIMEREWINDENTITYANIMCLIPEVENTCONFIG_METHOD_3_E2025E265CFFA78A_OFFSET UNITYSDK_OFFSET(0x1770AF70)
#define RPG_GAMECORE_SINGLETIMEREWINDENTITYANIMCLIPEVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1770AFC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SingleTimeRewindEntityAnimClipEventConfig_TypeDefinitionIndex = 15205;
