...
#define RPG_GAMECORE_FREESTYLECHARACTERCONFIG_METHOD_2_895F216600126C59_OFFSET UNITYSDK_OFFSET(0x1DCBB050)
#define RPG_GAMECORE_FREESTYLECHARACTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCBB2F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FreeStyleCharacterConfig_TypeDefinitionIndex = 16137;
