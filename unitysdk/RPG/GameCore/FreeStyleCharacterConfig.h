...
#define RPG_GAMECORE_FREESTYLECHARACTERCONFIG_METHOD_2_79413102F997B3D6_OFFSET UNITYSDK_OFFSET(0x1721F740)
#define RPG_GAMECORE_FREESTYLECHARACTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1721F9F0)
