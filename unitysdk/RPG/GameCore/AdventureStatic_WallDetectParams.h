...
#define RPG_GAMECORE_ADVENTURESTATIC_WALLDETECTPARAMS__CCTOR_OFFSET UNITYSDK_OFFSET(0x195B4620)
#define RPG_GAMECORE_ADVENTURESTATIC_WALLDETECTPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x195B3060)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureStatic_WallDetectParams_TypeDefinitionIndex = 56381;
	...
	public:
		...
		{
			return (::RPG::GameCore::AdventureStatic_WallDetectParams**)Il2CppClass::FromTypeDefinitionIndex(AdventureStatic_WallDetectParams_TypeDefinitionIndex)->GetStaticField(0x5E0A0);
		}
		::System::Collections::Generic::List_1<::UnityEngine::Transform*>* ExcludeTransformList; // 0x10
		::System::Single MaxSlopeAngle; // 0x18
