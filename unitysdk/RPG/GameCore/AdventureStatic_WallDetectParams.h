...
#define RPG_GAMECORE_ADVENTURESTATIC_WALLDETECTPARAMS__CCTOR_OFFSET UNITYSDK_OFFSET(0xB5AEC40)
#define RPG_GAMECORE_ADVENTURESTATIC_WALLDETECTPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0xB5ADA30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureStatic_WallDetectParams_TypeDefinitionIndex = 54421;
	...
	public:
		...
		{
			return (::RPG::GameCore::AdventureStatic_WallDetectParams**)Il2CppClass::FromTypeDefinitionIndex(AdventureStatic_WallDetectParams_TypeDefinitionIndex)->GetStaticField(0x41460);
		}
		::System::Collections::Generic::List_1<::UnityEngine::Transform*>* ExcludeTransformList; // 0x10
		::System::Single LineLength; // 0x18
		::System::Single StartHeight; // 0x1C
