...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_HEAL_METHOD_3_52D9612A5B56A95D_OFFSET UNITYSDK_OFFSET(0x1716CA00)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_HEAL_METHOD_3_606A11C807EBCF9F_OFFSET UNITYSDK_OFFSET(0x17170A10)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_HEAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1716C9B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_Heal_TypeDefinitionIndex = 14746;
