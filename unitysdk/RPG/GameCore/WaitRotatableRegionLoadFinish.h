...
#define RPG_GAMECORE_WAITROTATABLEREGIONLOADFINISH_METHOD_3_8FA614DFAA768343_OFFSET UNITYSDK_OFFSET(0x19107CC0)
#define RPG_GAMECORE_WAITROTATABLEREGIONLOADFINISH_METHOD_3_91BB4142570908AF_OFFSET UNITYSDK_OFFSET(0x19107BB0)
#define RPG_GAMECORE_WAITROTATABLEREGIONLOADFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x19107C90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitRotatableRegionLoadFinish_TypeDefinitionIndex = 19905;
