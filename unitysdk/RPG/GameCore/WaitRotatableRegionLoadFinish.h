...
#define RPG_GAMECORE_WAITROTATABLEREGIONLOADFINISH_METHOD_3_8FA614DFAA768343_OFFSET UNITYSDK_OFFSET(0x1D1BBB10)
#define RPG_GAMECORE_WAITROTATABLEREGIONLOADFINISH_METHOD_3_BBF3DC91A7ECCFC6_OFFSET UNITYSDK_OFFSET(0x1D1BBA40)
#define RPG_GAMECORE_WAITROTATABLEREGIONLOADFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1BBB00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitRotatableRegionLoadFinish_TypeDefinitionIndex = 20130;
