...
#define RPG_GAMECORE_ROGUEACTPERSONARANDOMROOMCARDCASTREMOVEANDGETBUFFMIRACLECONFIG_METHOD_7_6994FBA962CE6AB1_OFFSET UNITYSDK_OFFSET(0x1D02FC40)
#define RPG_GAMECORE_ROGUEACTPERSONARANDOMROOMCARDCASTREMOVEANDGETBUFFMIRACLECONFIG_METHOD_7_F902CE1E8333ADCD_OFFSET UNITYSDK_OFFSET(0x1D02FD20)
#define RPG_GAMECORE_ROGUEACTPERSONARANDOMROOMCARDCASTREMOVEANDGETBUFFMIRACLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D02FC30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaRandomRoomCardCastRemoveAndGetBuffMiracleConfig_TypeDefinitionIndex = 18977;
