...
#define RPG_GAMECORE_ROGUEACTPERSONARANDOMROOMCARDCASTREMOVEANDGETBUFFMIRACLECONFIG_METHOD_7_6994FBA962CE6AB1_OFFSET UNITYSDK_OFFSET(0x18CCBB10)
#define RPG_GAMECORE_ROGUEACTPERSONARANDOMROOMCARDCASTREMOVEANDGETBUFFMIRACLECONFIG_METHOD_7_C46A8B7BAA185DFC_OFFSET UNITYSDK_OFFSET(0x18CCBF90)
#define RPG_GAMECORE_ROGUEACTPERSONARANDOMROOMCARDCASTREMOVEANDGETBUFFMIRACLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CCBA30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaRandomRoomCardCastRemoveAndGetBuffMiracleConfig_TypeDefinitionIndex = 18734;
