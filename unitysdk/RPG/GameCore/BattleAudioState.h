...
#define RPG_GAMECORE_BATTLEAUDIOSTATE_METHOD_3_18FCD5225F36B89F_OFFSET UNITYSDK_OFFSET(0x16FCC1A0)
#define RPG_GAMECORE_BATTLEAUDIOSTATE_METHOD_3_952493F0F8F4AE2B_OFFSET UNITYSDK_OFFSET(0x16FCC220)
#define RPG_GAMECORE_BATTLEAUDIOSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16FCC1F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleAudioState_TypeDefinitionIndex = 21170;
