...
#define RPG_GAMECORE_MARBLEPAUSEGAME_METHOD_3_886A88847134A76E_OFFSET UNITYSDK_OFFSET(0x1BD1DB10)
#define RPG_GAMECORE_MARBLEPAUSEGAME_METHOD_3_C28FDF29C3FAEF2D_OFFSET UNITYSDK_OFFSET(0x1BD1DB50)
#define RPG_GAMECORE_MARBLEPAUSEGAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD1DB40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarblePauseGame_TypeDefinitionIndex = 23439;
