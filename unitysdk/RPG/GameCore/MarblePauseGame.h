...
#define RPG_GAMECORE_MARBLEPAUSEGAME_METHOD_3_BF47008A0EACEC9C_OFFSET UNITYSDK_OFFSET(0x17393ED0)
#define RPG_GAMECORE_MARBLEPAUSEGAME_METHOD_3_C28FDF29C3FAEF2D_OFFSET UNITYSDK_OFFSET(0x17393F50)
#define RPG_GAMECORE_MARBLEPAUSEGAME__CTOR_OFFSET UNITYSDK_OFFSET(0x17393F20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarblePauseGame_TypeDefinitionIndex = 22338;
