...
#define RPG_GAMECORE_SCREENTRANSFERBASEACTION_METHOD_2_61C6ABC44E45A3F4_OFFSET UNITYSDK_OFFSET(0x1C2C91E0)
#define RPG_GAMECORE_SCREENTRANSFERBASEACTION_METHOD_2_F22C04E5812EFCFB_OFFSET UNITYSDK_OFFSET(0x1C2C9420)
#define RPG_GAMECORE_SCREENTRANSFERBASEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2C8BE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ScreenTransferBaseAction_TypeDefinitionIndex = 20073;
