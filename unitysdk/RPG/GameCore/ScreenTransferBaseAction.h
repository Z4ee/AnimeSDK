...
#define RPG_GAMECORE_SCREENTRANSFERBASEACTION_METHOD_2_61C6ABC44E45A3F4_OFFSET UNITYSDK_OFFSET(0x18E002B0)
#define RPG_GAMECORE_SCREENTRANSFERBASEACTION_METHOD_2_F22C04E5812EFCFB_OFFSET UNITYSDK_OFFSET(0x18E00500)
#define RPG_GAMECORE_SCREENTRANSFERBASEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18DFFBB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ScreenTransferBaseAction_TypeDefinitionIndex = 19844;
