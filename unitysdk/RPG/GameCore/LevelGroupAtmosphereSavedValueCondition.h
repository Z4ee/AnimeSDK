...
#define RPG_GAMECORE_LEVELGROUPATMOSPHERESAVEDVALUECONDITION_METHOD_3_CFB4B92B38FA3875_OFFSET UNITYSDK_OFFSET(0x1D1D3850)
#define RPG_GAMECORE_LEVELGROUPATMOSPHERESAVEDVALUECONDITION_METHOD_3_F711879EE5A4674C_OFFSET UNITYSDK_OFFSET(0x1D1D32A0)
#define RPG_GAMECORE_LEVELGROUPATMOSPHERESAVEDVALUECONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1D3290)
