...
#define RPG_GAMECORE_LEVELGROUPATMOSPHERESAVEDVALUECONDITION_METHOD_3_CFB4B92B38FA3875_OFFSET UNITYSDK_OFFSET(0x17337D40)
#define RPG_GAMECORE_LEVELGROUPATMOSPHERESAVEDVALUECONDITION_METHOD_3_F711879EE5A4674C_OFFSET UNITYSDK_OFFSET(0x17337790)
#define RPG_GAMECORE_LEVELGROUPATMOSPHERESAVEDVALUECONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x17337780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelGroupAtmosphereSavedValueCondition_TypeDefinitionIndex = 15808;
