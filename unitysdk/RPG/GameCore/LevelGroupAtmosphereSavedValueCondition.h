...
#define RPG_GAMECORE_LEVELGROUPATMOSPHERESAVEDVALUECONDITION_METHOD_3_CFB4B92B38FA3875_OFFSET UNITYSDK_OFFSET(0x18A44410)
#define RPG_GAMECORE_LEVELGROUPATMOSPHERESAVEDVALUECONDITION_METHOD_3_F711879EE5A4674C_OFFSET UNITYSDK_OFFSET(0x18A44060)
#define RPG_GAMECORE_LEVELGROUPATMOSPHERESAVEDVALUECONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x18A44050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelGroupAtmosphereSavedValueCondition_TypeDefinitionIndex = 16334;
