...
#define RPG_GAMECORE_BOUNCYPROJECTILEDATA_METHOD_3_2F466F8F3D1E0EDB_OFFSET UNITYSDK_OFFSET(0x1C2E64B0)
#define RPG_GAMECORE_BOUNCYPROJECTILEDATA_METHOD_3_42D2652E7E35E898_OFFSET UNITYSDK_OFFSET(0x1C2E6440)
#define RPG_GAMECORE_BOUNCYPROJECTILEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2E6490)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BouncyProjectileData_TypeDefinitionIndex = 15488;
