...
#define RPG_GAMECORE_BOUNCYPROJECTILEDATA_METHOD_3_2F466F8F3D1E0EDB_OFFSET UNITYSDK_OFFSET(0x194E7180)
#define RPG_GAMECORE_BOUNCYPROJECTILEDATA_METHOD_3_42D2652E7E35E898_OFFSET UNITYSDK_OFFSET(0x194E7110)
#define RPG_GAMECORE_BOUNCYPROJECTILEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x194E7160)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BouncyProjectileData_TypeDefinitionIndex = 14890;
