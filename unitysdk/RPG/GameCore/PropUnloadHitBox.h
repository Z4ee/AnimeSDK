...
#define RPG_GAMECORE_PROPUNLOADHITBOX_METHOD_3_344D148D94EC9FFA_OFFSET UNITYSDK_OFFSET(0x1B9A6940)
#define RPG_GAMECORE_PROPUNLOADHITBOX_METHOD_3_4DA30F4D1ADE4EF1_OFFSET UNITYSDK_OFFSET(0x1B9A6900)
#define RPG_GAMECORE_PROPUNLOADHITBOX__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9A6930)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropUnloadHitBox_TypeDefinitionIndex = 21213;
