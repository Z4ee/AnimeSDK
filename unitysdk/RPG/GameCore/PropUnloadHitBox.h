...
#define RPG_GAMECORE_PROPUNLOADHITBOX_METHOD_3_344D148D94EC9FFA_OFFSET UNITYSDK_OFFSET(0x175720D0)
#define RPG_GAMECORE_PROPUNLOADHITBOX_METHOD_3_B717E66BFA4D2983_OFFSET UNITYSDK_OFFSET(0x17572050)
#define RPG_GAMECORE_PROPUNLOADHITBOX__CTOR_OFFSET UNITYSDK_OFFSET(0x175720A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropUnloadHitBox_TypeDefinitionIndex = 20197;
