...
#define RPG_GAMECORE_ROGUEMODIFIEREXECACTIONONROGUECOINCHANGECONFIG_METHOD_3_390168A79175B454_OFFSET UNITYSDK_OFFSET(0x1762EA80)
#define RPG_GAMECORE_ROGUEMODIFIEREXECACTIONONROGUECOINCHANGECONFIG_METHOD_3_4D19B1205F180DCD_OFFSET UNITYSDK_OFFSET(0x1762EB50)
#define RPG_GAMECORE_ROGUEMODIFIEREXECACTIONONROGUECOINCHANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1762EB00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecActionOnRogueCoinChangeConfig_TypeDefinitionIndex = 16373;
