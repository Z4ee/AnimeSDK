...
#define RPG_GAMECORE_ROGUEMODIFIEREXECACTIONONROGUECOINCHANGECONFIG_METHOD_3_4D19B1205F180DCD_OFFSET UNITYSDK_OFFSET(0x1EEF82C0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECACTIONONROGUECOINCHANGECONFIG_METHOD_3_FD17DAFD7A57D1C9_OFFSET UNITYSDK_OFFSET(0x1EEF8270)
#define RPG_GAMECORE_ROGUEMODIFIEREXECACTIONONROGUECOINCHANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEF82B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecActionOnRogueCoinChangeConfig_TypeDefinitionIndex = 17618;
