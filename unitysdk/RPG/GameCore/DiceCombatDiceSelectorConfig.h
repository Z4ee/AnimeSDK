...
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_METHOD_2_721398143C1A4927_OFFSET UNITYSDK_OFFSET(0x188661D0)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_METHOD_2_900F972706525836_OFFSET UNITYSDK_OFFSET(0x18866B20)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18866B10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatDiceSelectorConfig_TypeDefinitionIndex = 15304;
