...
#define RPG_GAMECORE_WAVEMONSTERPERFORM_METHOD_3_61AFCF5DB9951561_OFFSET UNITYSDK_OFFSET(0x1D6B0A50)
#define RPG_GAMECORE_WAVEMONSTERPERFORM_METHOD_3_A44AE27B35E01ADE_OFFSET UNITYSDK_OFFSET(0x1D6B0A10)
#define RPG_GAMECORE_WAVEMONSTERPERFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6B0A40)
