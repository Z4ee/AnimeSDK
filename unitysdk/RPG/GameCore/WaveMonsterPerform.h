...
#define RPG_GAMECORE_WAVEMONSTERPERFORM_METHOD_3_324CB5C3A101F54D_OFFSET UNITYSDK_OFFSET(0x17909440)
#define RPG_GAMECORE_WAVEMONSTERPERFORM_METHOD_3_B6855378A61782EB_OFFSET UNITYSDK_OFFSET(0x179094C0)
#define RPG_GAMECORE_WAVEMONSTERPERFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x17909490)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaveMonsterPerform_TypeDefinitionIndex = 21634;
