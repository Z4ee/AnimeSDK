...
#define RPG_GAMECORE_WAVEMONSTERPERFORM_METHOD_3_61AFCF5DB9951561_OFFSET UNITYSDK_OFFSET(0x1DEC5BF0)
#define RPG_GAMECORE_WAVEMONSTERPERFORM_METHOD_3_A44AE27B35E01ADE_OFFSET UNITYSDK_OFFSET(0x1DEC5BB0)
#define RPG_GAMECORE_WAVEMONSTERPERFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEC5BE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaveMonsterPerform_TypeDefinitionIndex = 23142;
