...
#define RPG_GAMECORE_ADVBYCHECKNEEDWAITSERVERCHECKSKILLRESULT_METHOD_4_4E0444C255B89D6A_OFFSET UNITYSDK_OFFSET(0x1BE0DC80)
#define RPG_GAMECORE_ADVBYCHECKNEEDWAITSERVERCHECKSKILLRESULT_METHOD_4_CF961F1182F6AC91_OFFSET UNITYSDK_OFFSET(0x1BE0DCC0)
#define RPG_GAMECORE_ADVBYCHECKNEEDWAITSERVERCHECKSKILLRESULT_METHOD_4_EC530074A1F250CB_OFFSET UNITYSDK_OFFSET(0x1BE0DE00)
#define RPG_GAMECORE_ADVBYCHECKNEEDWAITSERVERCHECKSKILLRESULT_METHOD_4_F3C56C6417421CBE_OFFSET UNITYSDK_OFFSET(0x1BE0DE30)
#define RPG_GAMECORE_ADVBYCHECKNEEDWAITSERVERCHECKSKILLRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE0DCB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvByCheckNeedWaitServerCheckSkillResult_TypeDefinitionIndex = 19435;
