...
#define RPG_GAMECORE_MARBLERANDOMREVIVE_METHOD_3_6C4779B4E04084B2_OFFSET UNITYSDK_OFFSET(0x173969C0)
#define RPG_GAMECORE_MARBLERANDOMREVIVE_METHOD_3_FA03C283E326F1BD_OFFSET UNITYSDK_OFFSET(0x173968E0)
#define RPG_GAMECORE_MARBLERANDOMREVIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x17396970)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleRandomRevive_TypeDefinitionIndex = 15431;
