...
#define RPG_GAMECORE_SETFLOORSAVEDVALUE_METHOD_3_802AF69F897E12F4_OFFSET UNITYSDK_OFFSET(0x1D500120)
#define RPG_GAMECORE_SETFLOORSAVEDVALUE_METHOD_3_CC49FB8F677CDD21_OFFSET UNITYSDK_OFFSET(0x1D500160)
#define RPG_GAMECORE_SETFLOORSAVEDVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D500150)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetFloorSavedValue_TypeDefinitionIndex = 20465;
