...
#define RPG_GAMECORE_SETFLOORSAVEDVALUE_METHOD_3_5438514AFF0ED806_OFFSET UNITYSDK_OFFSET(0x19C4F780)
#define RPG_GAMECORE_SETFLOORSAVEDVALUE_METHOD_3_CC49FB8F677CDD21_OFFSET UNITYSDK_OFFSET(0x19C4F7F0)
#define RPG_GAMECORE_SETFLOORSAVEDVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C4F7C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetFloorSavedValue_TypeDefinitionIndex = 19560;
