...
#define RPG_GAMECORE_SETDYNAMICSTAGEBATTLEEVENT_METHOD_3_1CDF49FD239D8F47_OFFSET UNITYSDK_OFFSET(0x18E15A20)
#define RPG_GAMECORE_SETDYNAMICSTAGEBATTLEEVENT_METHOD_3_73AFA0BA699222F2_OFFSET UNITYSDK_OFFSET(0x18E15880)
#define RPG_GAMECORE_SETDYNAMICSTAGEBATTLEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x18E15960)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicStageBattleEvent_TypeDefinitionIndex = 21649;
