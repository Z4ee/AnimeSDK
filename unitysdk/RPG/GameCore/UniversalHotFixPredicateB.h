...
#define RPG_GAMECORE_UNIVERSALHOTFIXPREDICATEB_METHOD_5_221F47270C0C12DA_OFFSET UNITYSDK_OFFSET(0x190E4000)
#define RPG_GAMECORE_UNIVERSALHOTFIXPREDICATEB_METHOD_5_3D54A5BFF3F73A2D_OFFSET UNITYSDK_OFFSET(0x190E5110)
#define RPG_GAMECORE_UNIVERSALHOTFIXPREDICATEB__CTOR_OFFSET UNITYSDK_OFFSET(0x190E3FB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UniversalHotFixPredicateB_TypeDefinitionIndex = 22330;
