...
#define RPG_GAMECORE_TARGETFETCHABILITYTARGET_METHOD_4_6B5B661EDF362777_OFFSET UNITYSDK_OFFSET(0x177BA010)
#define RPG_GAMECORE_TARGETFETCHABILITYTARGET_METHOD_4_E4848C2294D35D19_OFFSET UNITYSDK_OFFSET(0x177B9F00)
#define RPG_GAMECORE_TARGETFETCHABILITYTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x177B9FC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchAbilityTarget_TypeDefinitionIndex = 22187;
