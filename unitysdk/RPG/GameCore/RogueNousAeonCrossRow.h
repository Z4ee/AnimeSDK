...
#define RPG_GAMECORE_ROGUENOUSAEONCROSSROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D168B80)
#define RPG_GAMECORE_ROGUENOUSAEONCROSSROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D168D70)
