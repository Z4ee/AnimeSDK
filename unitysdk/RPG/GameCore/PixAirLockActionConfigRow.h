...
#define RPG_GAMECORE_PIXAIRLOCKACTIONCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19A13400)
#define RPG_GAMECORE_PIXAIRLOCKACTIONCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19A136D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PixAirLockActionConfigRow_TypeDefinitionIndex = 11604;
	...
	public:
		...
		::RPG::GameCore::PixAirLockActionName PermissionActionName; // 0x24
		::System::UInt32 ID; // 0x28
		::RPG::Client::TextID TextHint; // 0x30
