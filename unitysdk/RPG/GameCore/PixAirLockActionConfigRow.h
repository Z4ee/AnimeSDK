...
#define RPG_GAMECORE_PIXAIRLOCKACTIONCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B4CD510)
#define RPG_GAMECORE_PIXAIRLOCKACTIONCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4CD7E0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID TextHint; // 0x20
		::System::UInt32 AreaID; // 0x30
		::System::UInt32 NodeID; // 0x34
