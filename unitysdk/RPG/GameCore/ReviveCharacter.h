...
#define RPG_GAMECORE_REVIVECHARACTER_METHOD_3_0A109FFE2C251108_OFFSET UNITYSDK_OFFSET(0x19ADDD80)
#define RPG_GAMECORE_REVIVECHARACTER_METHOD_3_B4EAF08CE95CEB6A_OFFSET UNITYSDK_OFFSET(0x19ADDFF0)
#define RPG_GAMECORE_REVIVECHARACTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19ADDED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ReviveCharacter_TypeDefinitionIndex = 21479;
