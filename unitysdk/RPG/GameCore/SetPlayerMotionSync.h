...
#define RPG_GAMECORE_SETPLAYERMOTIONSYNC_METHOD_3_2F6479E143C790AD_OFFSET UNITYSDK_OFFSET(0x1E08AD10)
#define RPG_GAMECORE_SETPLAYERMOTIONSYNC_METHOD_3_C3C2AB6B7407C3EE_OFFSET UNITYSDK_OFFSET(0x1E08AD50)
#define RPG_GAMECORE_SETPLAYERMOTIONSYNC__CTOR_OFFSET UNITYSDK_OFFSET(0x1E08AD40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetPlayerMotionSync_TypeDefinitionIndex = 20278;
