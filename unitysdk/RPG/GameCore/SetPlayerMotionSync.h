...
#define RPG_GAMECORE_SETPLAYERMOTIONSYNC_METHOD_3_13A66FCB5052FBBF_OFFSET UNITYSDK_OFFSET(0x18E3E900)
#define RPG_GAMECORE_SETPLAYERMOTIONSYNC_METHOD_3_C3C2AB6B7407C3EE_OFFSET UNITYSDK_OFFSET(0x18E3E980)
#define RPG_GAMECORE_SETPLAYERMOTIONSYNC__CTOR_OFFSET UNITYSDK_OFFSET(0x18E3E950)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetPlayerMotionSync_TypeDefinitionIndex = 19473;
