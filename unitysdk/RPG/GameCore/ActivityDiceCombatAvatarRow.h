...
#define RPG_GAMECORE_ACTIVITYDICECOMBATAVATARROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1AAE0AE0)
#define RPG_GAMECORE_ACTIVITYDICECOMBATAVATARROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAE1240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityDiceCombatAvatarRow_TypeDefinitionIndex = 10844;

	class ActivityDiceCombatAvatarRow : public ::System::Object
	{
	public:
		::System::String* AttackEffectPath; // 0x10
		::Il2CppArray<::System::UInt32>* DiceIDPerRare; // 0x18
		::System::String* ImgPathHeadIcon; // 0x20
		::System::String* AttackEffectEnemyPath; // 0x28
		::System::String* ImgPath; // 0x30
		::System::String* ImgPathUI3D; // 0x38
		::System::String* AttackAnimation; // 0x40
		::System::String* AttackJson; // 0x48
		::System::String* HighLevelBGImgPath; // 0x50
		::System::String* FinalAttackVoice; // 0x58
		::System::String* ShopIcon; // 0x60
		::Il2CppArray<::System::UInt32>* DiceCountPerRare; // 0x68
		::System::String* HighLevelBGImgPathUI3D; // 0x70
		...
		::System::UInt32 DefendDiceNumber; // 0x98
		::System::UInt32 SkillID; // 0x9C
