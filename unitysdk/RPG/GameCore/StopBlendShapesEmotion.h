...
#define RPG_GAMECORE_STOPBLENDSHAPESEMOTION_METHOD_3_9E5F232F6302264E_OFFSET UNITYSDK_OFFSET(0x1777CB70)
#define RPG_GAMECORE_STOPBLENDSHAPESEMOTION_METHOD_3_F085E7CD6883CFD8_OFFSET UNITYSDK_OFFSET(0x1777CC00)
#define RPG_GAMECORE_STOPBLENDSHAPESEMOTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1777CBD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StopBlendShapesEmotion_TypeDefinitionIndex = 20060;
