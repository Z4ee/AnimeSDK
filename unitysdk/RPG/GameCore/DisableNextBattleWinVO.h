...
#define RPG_GAMECORE_DISABLENEXTBATTLEWINVO_METHOD_3_29F5003EFDABD023_OFFSET UNITYSDK_OFFSET(0x196BCB50)
#define RPG_GAMECORE_DISABLENEXTBATTLEWINVO_METHOD_3_85674E7C50B8ED37_OFFSET UNITYSDK_OFFSET(0x196BCC60)
#define RPG_GAMECORE_DISABLENEXTBATTLEWINVO__CTOR_OFFSET UNITYSDK_OFFSET(0x196BCC30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DisableNextBattleWinVO_TypeDefinitionIndex = 19408;
