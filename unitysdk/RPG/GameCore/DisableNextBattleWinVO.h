...
#define RPG_GAMECORE_DISABLENEXTBATTLEWINVO_METHOD_3_29F5003EFDABD023_OFFSET UNITYSDK_OFFSET(0x1887FD60)
#define RPG_GAMECORE_DISABLENEXTBATTLEWINVO_METHOD_3_85674E7C50B8ED37_OFFSET UNITYSDK_OFFSET(0x1887FE70)
#define RPG_GAMECORE_DISABLENEXTBATTLEWINVO__CTOR_OFFSET UNITYSDK_OFFSET(0x1887FE40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DisableNextBattleWinVO_TypeDefinitionIndex = 19514;
