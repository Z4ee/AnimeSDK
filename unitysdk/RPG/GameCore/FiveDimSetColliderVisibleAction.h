...
#define RPG_GAMECORE_FIVEDIMSETCOLLIDERVISIBLEACTION_METHOD_3_79C1A8D294C9B62C_OFFSET UNITYSDK_OFFSET(0x1D8785C0)
#define RPG_GAMECORE_FIVEDIMSETCOLLIDERVISIBLEACTION_METHOD_3_BCB5F9B8131211E7_OFFSET UNITYSDK_OFFSET(0x1D878580)
#define RPG_GAMECORE_FIVEDIMSETCOLLIDERVISIBLEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D8785B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSetColliderVisibleAction_TypeDefinitionIndex = 18473;
