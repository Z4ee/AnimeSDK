...
#define RPG_GAMECORE_TARGETMAPALLTEAMMEMBER_METHOD_3_B7229ADE2018A2FC_OFFSET UNITYSDK_OFFSET(0x18EE7560)
#define RPG_GAMECORE_TARGETMAPALLTEAMMEMBER_METHOD_3_EBD544EAA6EC72C8_OFFSET UNITYSDK_OFFSET(0x18EE7670)
#define RPG_GAMECORE_TARGETMAPALLTEAMMEMBER__CTOR_OFFSET UNITYSDK_OFFSET(0x18EE7650)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapAllTeamMember_TypeDefinitionIndex = 22938;
