...
#define RPG_GAMECORE_TARGETMAPALLTEAMMEMBER_METHOD_3_37E4E72FD3B5C545_OFFSET UNITYSDK_OFFSET(0x1D0C0600)
#define RPG_GAMECORE_TARGETMAPALLTEAMMEMBER_METHOD_3_74FF5CB42F2D8A1D_OFFSET UNITYSDK_OFFSET(0x1D0C0790)
#define RPG_GAMECORE_TARGETMAPALLTEAMMEMBER_METHOD_3_EBD544EAA6EC72C8_OFFSET UNITYSDK_OFFSET(0x1D0C06D0)
#define RPG_GAMECORE_TARGETMAPALLTEAMMEMBER_METHOD_3_F0660C4664397D94_OFFSET UNITYSDK_OFFSET(0x1D0C07C0)
#define RPG_GAMECORE_TARGETMAPALLTEAMMEMBER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0C06C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapAllTeamMember_TypeDefinitionIndex = 23092;
