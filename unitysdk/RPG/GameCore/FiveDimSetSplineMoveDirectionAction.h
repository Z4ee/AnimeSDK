...
#define RPG_GAMECORE_FIVEDIMSETSPLINEMOVEDIRECTIONACTION_METHOD_3_280888297D4D9F86_OFFSET UNITYSDK_OFFSET(0x1D101AA0)
#define RPG_GAMECORE_FIVEDIMSETSPLINEMOVEDIRECTIONACTION_METHOD_3_E91916A58D647995_OFFSET UNITYSDK_OFFSET(0x1D101A60)
#define RPG_GAMECORE_FIVEDIMSETSPLINEMOVEDIRECTIONACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D101A90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSetSplineMoveDirectionAction_TypeDefinitionIndex = 18453;
