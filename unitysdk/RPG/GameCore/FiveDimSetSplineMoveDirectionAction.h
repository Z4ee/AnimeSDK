...
#define RPG_GAMECORE_FIVEDIMSETSPLINEMOVEDIRECTIONACTION_METHOD_3_280888297D4D9F86_OFFSET UNITYSDK_OFFSET(0x1891CCF0)
#define RPG_GAMECORE_FIVEDIMSETSPLINEMOVEDIRECTIONACTION_METHOD_3_F953842DACD875D9_OFFSET UNITYSDK_OFFSET(0x1891CC80)
#define RPG_GAMECORE_FIVEDIMSETSPLINEMOVEDIRECTIONACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1891CCD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSetSplineMoveDirectionAction_TypeDefinitionIndex = 17731;
