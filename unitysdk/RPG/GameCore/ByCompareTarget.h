...
#define RPG_GAMECORE_BYCOMPARETARGET_METHOD_4_3115995BD6F90BC1_OFFSET UNITYSDK_OFFSET(0x1BBC3E90)
#define RPG_GAMECORE_BYCOMPARETARGET_METHOD_4_46A5B7F5E62E1A3C_OFFSET UNITYSDK_OFFSET(0x1BBC3C80)
#define RPG_GAMECORE_BYCOMPARETARGET_METHOD_4_56E315A081C27697_OFFSET UNITYSDK_OFFSET(0x1BBC3ED0)
#define RPG_GAMECORE_BYCOMPARETARGET_METHOD_4_BE2F6FD71DCB54F1_OFFSET UNITYSDK_OFFSET(0x1BBC3C30)
#define RPG_GAMECORE_BYCOMPARETARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBC3C70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareTarget_TypeDefinitionIndex = 22756;
