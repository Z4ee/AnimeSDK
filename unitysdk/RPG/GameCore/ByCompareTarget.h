...
#define RPG_GAMECORE_BYCOMPARETARGET_METHOD_4_46A5B7F5E62E1A3C_OFFSET UNITYSDK_OFFSET(0x1701A740)
#define RPG_GAMECORE_BYCOMPARETARGET_METHOD_4_6D16825289398698_OFFSET UNITYSDK_OFFSET(0x1701A660)
#define RPG_GAMECORE_BYCOMPARETARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1701A6E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareTarget_TypeDefinitionIndex = 21221;
