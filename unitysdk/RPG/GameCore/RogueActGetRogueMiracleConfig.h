...
#define RPG_GAMECORE_ROGUEACTGETROGUEMIRACLECONFIG_METHOD_6_592AC72146B6EFE1_OFFSET UNITYSDK_OFFSET(0x19AE8210)
#define RPG_GAMECORE_ROGUEACTGETROGUEMIRACLECONFIG_METHOD_6_C49CD446119842AC_OFFSET UNITYSDK_OFFSET(0x19AE7FF0)
#define RPG_GAMECORE_ROGUEACTGETROGUEMIRACLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AE8130)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActGetRogueMiracleConfig_TypeDefinitionIndex = 18570;
