...
#define RPG_GAMECORE_ROGUEACTGETROGUEMIRACLECONFIG_METHOD_6_592AC72146B6EFE1_OFFSET UNITYSDK_OFFSET(0x18CC3E50)
#define RPG_GAMECORE_ROGUEACTGETROGUEMIRACLECONFIG_METHOD_6_C49CD446119842AC_OFFSET UNITYSDK_OFFSET(0x18CC3C30)
#define RPG_GAMECORE_ROGUEACTGETROGUEMIRACLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CC3D70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActGetRogueMiracleConfig_TypeDefinitionIndex = 18603;
