...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERLOSTCOINANDGAINMORECONFIG_METHOD_3_8A11D65C6C7E69A3_OFFSET UNITYSDK_OFFSET(0x1726B540)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERLOSTCOINANDGAINMORECONFIG_METHOD_3_DDE44044370A775A_OFFSET UNITYSDK_OFFSET(0x17267FE0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERLOSTCOINANDGAINMORECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17267F90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierLostCoinAndGainMoreConfig_TypeDefinitionIndex = 17801;
