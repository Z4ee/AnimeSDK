...
#define RPG_GAMECORE_ST_SIDE_REMOVEMODIFIERWHENRESET_METHOD_4_49C770D06E227EAD_OFFSET UNITYSDK_OFFSET(0x17699C10)
#define RPG_GAMECORE_ST_SIDE_REMOVEMODIFIERWHENRESET_METHOD_4_7800D811468E9107_OFFSET UNITYSDK_OFFSET(0x1768F2D0)
#define RPG_GAMECORE_ST_SIDE_REMOVEMODIFIERWHENRESET__CTOR_OFFSET UNITYSDK_OFFSET(0x1768F280)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_RemoveModifierWhenReset_TypeDefinitionIndex = 18434;
