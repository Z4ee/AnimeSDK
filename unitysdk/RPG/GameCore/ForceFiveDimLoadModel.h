...
#define RPG_GAMECORE_FORCEFIVEDIMLOADMODEL_METHOD_3_329AE0C5F3747D3C_OFFSET UNITYSDK_OFFSET(0x18928970)
#define RPG_GAMECORE_FORCEFIVEDIMLOADMODEL_METHOD_3_70C5BBA4393F1ABD_OFFSET UNITYSDK_OFFSET(0x189288F0)
#define RPG_GAMECORE_FORCEFIVEDIMLOADMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x18928940)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ForceFiveDimLoadModel_TypeDefinitionIndex = 20042;
