...
#define RPG_GAMECORE_FORCEFIVEDIMLOADMODEL_METHOD_3_329AE0C5F3747D3C_OFFSET UNITYSDK_OFFSET(0x17216340)
#define RPG_GAMECORE_FORCEFIVEDIMLOADMODEL_METHOD_3_70C5BBA4393F1ABD_OFFSET UNITYSDK_OFFSET(0x172162C0)
#define RPG_GAMECORE_FORCEFIVEDIMLOADMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x17216310)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ForceFiveDimLoadModel_TypeDefinitionIndex = 19383;
