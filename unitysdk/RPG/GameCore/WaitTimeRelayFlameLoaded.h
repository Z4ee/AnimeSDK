...
#define RPG_GAMECORE_WAITTIMERELAYFLAMELOADED_METHOD_3_1CB1D159E0510432_OFFSET UNITYSDK_OFFSET(0x1D1BDF20)
#define RPG_GAMECORE_WAITTIMERELAYFLAMELOADED_METHOD_3_8C6F31DA7A64A4AF_OFFSET UNITYSDK_OFFSET(0x1D1BDE50)
#define RPG_GAMECORE_WAITTIMERELAYFLAMELOADED__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1BDF10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitTimeRelayFlameLoaded_TypeDefinitionIndex = 21231;
