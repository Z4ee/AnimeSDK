...
#define RPG_GAMECORE_WAITHEARTDIALSCRIPTSTEPCHANGE_METHOD_3_73853BDDDD835DA3_OFFSET UNITYSDK_OFFSET(0x1DEBA5F0)
#define RPG_GAMECORE_WAITHEARTDIALSCRIPTSTEPCHANGE_METHOD_3_B6D728D63A089F9F_OFFSET UNITYSDK_OFFSET(0x1DEBA5A0)
#define RPG_GAMECORE_WAITHEARTDIALSCRIPTSTEPCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEBA5E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitHeartDialScriptStepChange_TypeDefinitionIndex = 20972;
