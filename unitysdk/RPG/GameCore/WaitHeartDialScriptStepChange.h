...
#define RPG_GAMECORE_WAITHEARTDIALSCRIPTSTEPCHANGE_METHOD_3_73853BDDDD835DA3_OFFSET UNITYSDK_OFFSET(0x19100100)
#define RPG_GAMECORE_WAITHEARTDIALSCRIPTSTEPCHANGE_METHOD_3_9E6D4D2D483E7AF3_OFFSET UNITYSDK_OFFSET(0x19100070)
#define RPG_GAMECORE_WAITHEARTDIALSCRIPTSTEPCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x191000D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitHeartDialScriptStepChange_TypeDefinitionIndex = 20191;
