...
#define RPG_GAMECORE_ASSISTWAYPOINTREGIONERAFLIPSTATECONDITION_METHOD_3_1F434A0C0ACE8A81_OFFSET UNITYSDK_OFFSET(0x1A05FBE0)
#define RPG_GAMECORE_ASSISTWAYPOINTREGIONERAFLIPSTATECONDITION_METHOD_3_7C28C445A8417C7F_OFFSET UNITYSDK_OFFSET(0x1A063870)
#define RPG_GAMECORE_ASSISTWAYPOINTREGIONERAFLIPSTATECONDITION_METHOD_3_C5E536C486A9FAD5_OFFSET UNITYSDK_OFFSET(0x1A063840)
#define RPG_GAMECORE_ASSISTWAYPOINTREGIONERAFLIPSTATECONDITION_METHOD_3_DFAFD709052B7B08_OFFSET UNITYSDK_OFFSET(0x1A05ED80)
#define RPG_GAMECORE_ASSISTWAYPOINTREGIONERAFLIPSTATECONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A05ED70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AssistWayPointRegionEraFlipStateCondition_TypeDefinitionIndex = 18251;
