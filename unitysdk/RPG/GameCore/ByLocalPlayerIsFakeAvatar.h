...
#define RPG_GAMECORE_BYLOCALPLAYERISFAKEAVATAR_METHOD_4_18B9B03C65D0FD31_OFFSET UNITYSDK_OFFSET(0x1CF51540)
#define RPG_GAMECORE_BYLOCALPLAYERISFAKEAVATAR_METHOD_4_3FCDE4EB9CCA8204_OFFSET UNITYSDK_OFFSET(0x1CF516C0)
#define RPG_GAMECORE_BYLOCALPLAYERISFAKEAVATAR_METHOD_4_72D1198EC2C9203A_OFFSET UNITYSDK_OFFSET(0x1CF51580)
#define RPG_GAMECORE_BYLOCALPLAYERISFAKEAVATAR_METHOD_4_FFDEC79F3D2E5F85_OFFSET UNITYSDK_OFFSET(0x1CF516F0)
#define RPG_GAMECORE_BYLOCALPLAYERISFAKEAVATAR__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF51570)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByLocalPlayerIsFakeAvatar_TypeDefinitionIndex = 20346;
