...
#define RPG_GAMECORE_BYLOCALPLAYERISFAKEAVATAR_METHOD_4_72D1198EC2C9203A_OFFSET UNITYSDK_OFFSET(0x1875AF10)
#define RPG_GAMECORE_BYLOCALPLAYERISFAKEAVATAR_METHOD_4_D27BC0D2787C9510_OFFSET UNITYSDK_OFFSET(0x1875AE40)
#define RPG_GAMECORE_BYLOCALPLAYERISFAKEAVATAR__CTOR_OFFSET UNITYSDK_OFFSET(0x1875AEC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByLocalPlayerIsFakeAvatar_TypeDefinitionIndex = 19550;
