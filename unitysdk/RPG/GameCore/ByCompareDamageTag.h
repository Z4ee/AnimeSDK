...
#define RPG_GAMECORE_BYCOMPAREDAMAGETAG_METHOD_4_0D263E10A7185BB5_OFFSET UNITYSDK_OFFSET(0x19CDCA20)
#define RPG_GAMECORE_BYCOMPAREDAMAGETAG_METHOD_4_5F493E1CDAD32048_OFFSET UNITYSDK_OFFSET(0x19CDCBE0)
#define RPG_GAMECORE_BYCOMPAREDAMAGETAG_METHOD_4_6CCD474B8CBD914F_OFFSET UNITYSDK_OFFSET(0x19CDCBB0)
#define RPG_GAMECORE_BYCOMPAREDAMAGETAG_METHOD_4_8212BBDDB969FF50_OFFSET UNITYSDK_OFFSET(0x19CDC9E0)
#define RPG_GAMECORE_BYCOMPAREDAMAGETAG__CTOR_OFFSET UNITYSDK_OFFSET(0x19CDCA10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareDamageTag_TypeDefinitionIndex = 22726;
