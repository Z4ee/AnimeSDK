...
#define RPG_GAMECORE_BYCHECKELFTODAYMANAGED_METHOD_4_029B191E460DDF1B_OFFSET UNITYSDK_OFFSET(0x18722250)
#define RPG_GAMECORE_BYCHECKELFTODAYMANAGED_METHOD_4_A2456C257C18B771_OFFSET UNITYSDK_OFFSET(0x18722320)
#define RPG_GAMECORE_BYCHECKELFTODAYMANAGED__CTOR_OFFSET UNITYSDK_OFFSET(0x187222D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckElfTodayManaged_TypeDefinitionIndex = 20583;
