...
#define RPG_GAMECORE_CHIMERADUELEFFECTCONFIG_METHOD_2_845A2BDC99806D42_OFFSET UNITYSDK_OFFSET(0x1963AFF0)
#define RPG_GAMECORE_CHIMERADUELEFFECTCONFIG_METHOD_2_B38A12E5AF6B1D1A_OFFSET UNITYSDK_OFFSET(0x19637B60)
#define RPG_GAMECORE_CHIMERADUELEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1963AFE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelEffectConfig_TypeDefinitionIndex = 15233;
