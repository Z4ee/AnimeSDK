...
#define RPG_GAMECORE_CHIMERADUELEFFECTCONFIG_METHOD_2_845A2BDC99806D42_OFFSET UNITYSDK_OFFSET(0x1C394840)
#define RPG_GAMECORE_CHIMERADUELEFFECTCONFIG_METHOD_2_B38A12E5AF6B1D1A_OFFSET UNITYSDK_OFFSET(0x1C391740)
#define RPG_GAMECORE_CHIMERADUELEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C394830)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelEffectConfig_TypeDefinitionIndex = 15397;
