...
#define RPG_GAMECORE_ROGUETOURNBUILDREFMATCHHEXMIRACLERATECONFIG_METHOD_2_AC4760BC4FFC1D64_OFFSET UNITYSDK_OFFSET(0x1BB70EA0)
#define RPG_GAMECORE_ROGUETOURNBUILDREFMATCHHEXMIRACLERATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB70FD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournBuildRefMatchHexMiracleRateConfig_TypeDefinitionIndex = 16965;
