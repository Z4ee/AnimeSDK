...
#define RPG_GAMECORE_ROGUETOURNBUILDREFMATCHHEXMIRACLERATECONFIG_METHOD_2_AC4760BC4FFC1D64_OFFSET UNITYSDK_OFFSET(0x1D417290)
#define RPG_GAMECORE_ROGUETOURNBUILDREFMATCHHEXMIRACLERATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4173C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournBuildRefMatchHexMiracleRateConfig_TypeDefinitionIndex = 17467;
