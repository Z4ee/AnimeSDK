...
#define RPG_GAMECORE_ADVENTUREATTACKDETECTSPHERECONFIG_METHOD_3_507FFACF5E7EB7F4_OFFSET UNITYSDK_OFFSET(0x16F4B370)
#define RPG_GAMECORE_ADVENTUREATTACKDETECTSPHERECONFIG_METHOD_3_BDE99FDBCDC0A1CB_OFFSET UNITYSDK_OFFSET(0x16F4B230)
#define RPG_GAMECORE_ADVENTUREATTACKDETECTSPHERECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16F4B220)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureAttackDetectSphereConfig_TypeDefinitionIndex = 14892;
