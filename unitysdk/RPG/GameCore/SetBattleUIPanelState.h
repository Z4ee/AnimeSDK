...
#define RPG_GAMECORE_SETBATTLEUIPANELSTATE_METHOD_3_3330E25111376018_OFFSET UNITYSDK_OFFSET(0x1E8104D0)
#define RPG_GAMECORE_SETBATTLEUIPANELSTATE_METHOD_3_E58CA86274BE6A56_OFFSET UNITYSDK_OFFSET(0x1E810510)
#define RPG_GAMECORE_SETBATTLEUIPANELSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E810500)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetBattleUIPanelState_TypeDefinitionIndex = 22559;
