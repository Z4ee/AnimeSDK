...
#define RPG_GAMECORE_LEVELPROPTIMEREWINDPARAMETER_METHOD_3_BFBD4B00EAEE8C86_OFFSET UNITYSDK_OFFSET(0x19889BF0)
#define RPG_GAMECORE_LEVELPROPTIMEREWINDPARAMETER_METHOD_3_C843853EA20F1D7B_OFFSET UNITYSDK_OFFSET(0x198895E0)
#define RPG_GAMECORE_LEVELPROPTIMEREWINDPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x198895D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPropTimeRewindParameter_TypeDefinitionIndex = 16405;
