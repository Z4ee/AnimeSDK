...
#define RPG_GAMECORE_LEVELPROPTIMEREWINDPARAMETER_METHOD_3_BFBD4B00EAEE8C86_OFFSET UNITYSDK_OFFSET(0x1B087B40)
#define RPG_GAMECORE_LEVELPROPTIMEREWINDPARAMETER_METHOD_3_C843853EA20F1D7B_OFFSET UNITYSDK_OFFSET(0x1B087530)
#define RPG_GAMECORE_LEVELPROPTIMEREWINDPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B087520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPropTimeRewindParameter_TypeDefinitionIndex = 16567;
