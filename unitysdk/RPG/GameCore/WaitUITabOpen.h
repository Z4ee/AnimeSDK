...
#define RPG_GAMECORE_WAITUITABOPEN_METHOD_3_1E7B88807468A47D_OFFSET UNITYSDK_OFFSET(0x1D6AFB10)
#define RPG_GAMECORE_WAITUITABOPEN_METHOD_3_30EF63AB39D84594_OFFSET UNITYSDK_OFFSET(0x1D6AFB60)
#define RPG_GAMECORE_WAITUITABOPEN__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6AFB50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitUITabOpen_TypeDefinitionIndex = 24076;
