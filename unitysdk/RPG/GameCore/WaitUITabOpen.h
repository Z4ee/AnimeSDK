...
#define RPG_GAMECORE_WAITUITABOPEN_METHOD_3_0880AF0C6D1574F3_OFFSET UNITYSDK_OFFSET(0x19E64AB0)
#define RPG_GAMECORE_WAITUITABOPEN_METHOD_3_30EF63AB39D84594_OFFSET UNITYSDK_OFFSET(0x19E64B30)
#define RPG_GAMECORE_WAITUITABOPEN__CTOR_OFFSET UNITYSDK_OFFSET(0x19E64B00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitUITabOpen_TypeDefinitionIndex = 23027;
