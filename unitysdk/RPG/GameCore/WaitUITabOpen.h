...
#define RPG_GAMECORE_WAITUITABOPEN_METHOD_3_0880AF0C6D1574F3_OFFSET UNITYSDK_OFFSET(0x1910C2E0)
#define RPG_GAMECORE_WAITUITABOPEN_METHOD_3_30EF63AB39D84594_OFFSET UNITYSDK_OFFSET(0x1910C360)
#define RPG_GAMECORE_WAITUITABOPEN__CTOR_OFFSET UNITYSDK_OFFSET(0x1910C330)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitUITabOpen_TypeDefinitionIndex = 23369;
