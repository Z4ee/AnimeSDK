...
#define RPG_GAMECORE_RESHAEASTEREGGSTATELISTENER_METHOD_3_015457EE03BDD70D_OFFSET UNITYSDK_OFFSET(0x1D387C00)
#define RPG_GAMECORE_RESHAEASTEREGGSTATELISTENER_METHOD_3_DEE1D2EB25944CB7_OFFSET UNITYSDK_OFFSET(0x1D387C80)
#define RPG_GAMECORE_RESHAEASTEREGGSTATELISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D387C50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ReShaEasterEggStateListener_TypeDefinitionIndex = 21784;
