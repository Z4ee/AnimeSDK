...
#define RPG_GAMECORE_RESHAEASTEREGGSTATELISTENER_METHOD_3_C6BDD5895A2AC880_OFFSET UNITYSDK_OFFSET(0x18C8C2F0)
#define RPG_GAMECORE_RESHAEASTEREGGSTATELISTENER_METHOD_3_DEE1D2EB25944CB7_OFFSET UNITYSDK_OFFSET(0x18C8C440)
#define RPG_GAMECORE_RESHAEASTEREGGSTATELISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x18C8C3B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ReShaEasterEggStateListener_TypeDefinitionIndex = 20890;
