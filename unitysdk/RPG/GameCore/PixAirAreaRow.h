...
#define RPG_GAMECORE_PIXAIRAREAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B4CA010)
#define RPG_GAMECORE_PIXAIRAREAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4CA120)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PixAirAreaRow_TypeDefinitionIndex = 11659;
