...
#define RPG_GAMECORE_PIXAIRAREAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D78FEB0)
#define RPG_GAMECORE_PIXAIRAREAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D78FFC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PixAirAreaRow_TypeDefinitionIndex = 12048;
