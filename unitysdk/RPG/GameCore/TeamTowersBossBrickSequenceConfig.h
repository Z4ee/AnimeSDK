...
#define RPG_GAMECORE_TEAMTOWERSBOSSBRICKSEQUENCECONFIG_METHOD_3_FC89BDDFD6916FAB_OFFSET UNITYSDK_OFFSET(0x1C1477F0)
#define RPG_GAMECORE_TEAMTOWERSBOSSBRICKSEQUENCECONFIG_METHOD_3_FD25B3B750A8FCE0_OFFSET UNITYSDK_OFFSET(0x1C1477B0)
#define RPG_GAMECORE_TEAMTOWERSBOSSBRICKSEQUENCECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1477E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TeamTowersBossBrickSequenceConfig_TypeDefinitionIndex = 18211;
