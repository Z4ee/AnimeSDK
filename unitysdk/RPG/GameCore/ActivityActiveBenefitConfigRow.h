...
#define RPG_GAMECORE_ACTIVITYACTIVEBENEFITCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x193D4140)
#define RPG_GAMECORE_ACTIVITYACTIVEBENEFITCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x193D42B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityActiveBenefitConfigRow_TypeDefinitionIndex = 10493;
