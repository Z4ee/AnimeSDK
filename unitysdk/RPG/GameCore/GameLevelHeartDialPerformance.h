...
#define RPG_GAMECORE_GAMELEVELHEARTDIALPERFORMANCE_METHOD_2_B71925988E489AC3_OFFSET UNITYSDK_OFFSET(0x1D952ED0)
#define RPG_GAMECORE_GAMELEVELHEARTDIALPERFORMANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D953120)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GameLevelHeartDialPerformance_TypeDefinitionIndex = 17222;
