...
#define RPG_GAMECORE_GAMELEVELHEARTDIALPERFORMANCE_METHOD_2_B71925988E489AC3_OFFSET UNITYSDK_OFFSET(0x1B9A1660)
#define RPG_GAMECORE_GAMELEVELHEARTDIALPERFORMANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9A18B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GameLevelHeartDialPerformance_TypeDefinitionIndex = 16720;
