...
#define RPG_GAMECORE_GAMEWORLDSTATIC_ISALLTEAMLIGHTENTITYDIED_OFFSET UNITYSDK_OFFSET(0xE66D9E0)
#define RPG_GAMECORE_GAMEWORLDSTATIC_TRIGGERADVENTUREENTITYCUSTOMEVENT_OFFSET UNITYSDK_OFFSET(0xE66DC60)
#define RPG_GAMECORE_GAMEWORLDSTATIC_TRIGGERADVENTUREGROUPCUSTOMEVENT_OFFSET UNITYSDK_OFFSET(0xE66DBD0)
#define RPG_GAMECORE_GAMEWORLDSTATIC_TRIGGERCUSTOMSTRINGEVENT_OFFSET UNITYSDK_OFFSET(0xE66DB40)
#define RPG_GAMECORE_GAMEWORLDSTATIC__CTOR_OFFSET UNITYSDK_OFFSET(0xE66DDE0)
