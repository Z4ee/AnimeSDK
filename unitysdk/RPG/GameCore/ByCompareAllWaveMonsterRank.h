...
#define RPG_GAMECORE_BYCOMPAREALLWAVEMONSTERRANK_METHOD_4_91F6A5F562F9BD92_OFFSET UNITYSDK_OFFSET(0x1CEB1C50)
#define RPG_GAMECORE_BYCOMPAREALLWAVEMONSTERRANK_METHOD_4_C84EA68CE9275059_OFFSET UNITYSDK_OFFSET(0x1CEB1E40)
#define RPG_GAMECORE_BYCOMPAREALLWAVEMONSTERRANK_METHOD_4_D575AE4C2E5A51E6_OFFSET UNITYSDK_OFFSET(0x1CEB1E10)
#define RPG_GAMECORE_BYCOMPAREALLWAVEMONSTERRANK_METHOD_4_E9888521419E57C7_OFFSET UNITYSDK_OFFSET(0x1CEB1C10)
#define RPG_GAMECORE_BYCOMPAREALLWAVEMONSTERRANK__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEB1C40)
