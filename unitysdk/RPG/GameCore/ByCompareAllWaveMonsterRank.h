...
#define RPG_GAMECORE_BYCOMPAREALLWAVEMONSTERRANK_METHOD_4_91F6A5F562F9BD92_OFFSET UNITYSDK_OFFSET(0x19CD0BE0)
#define RPG_GAMECORE_BYCOMPAREALLWAVEMONSTERRANK_METHOD_4_C84EA68CE9275059_OFFSET UNITYSDK_OFFSET(0x19CD0DD0)
#define RPG_GAMECORE_BYCOMPAREALLWAVEMONSTERRANK_METHOD_4_D575AE4C2E5A51E6_OFFSET UNITYSDK_OFFSET(0x19CD0DA0)
#define RPG_GAMECORE_BYCOMPAREALLWAVEMONSTERRANK_METHOD_4_E9888521419E57C7_OFFSET UNITYSDK_OFFSET(0x19CD0BA0)
#define RPG_GAMECORE_BYCOMPAREALLWAVEMONSTERRANK__CTOR_OFFSET UNITYSDK_OFFSET(0x19CD0BD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareAllWaveMonsterRank_TypeDefinitionIndex = 22212;
