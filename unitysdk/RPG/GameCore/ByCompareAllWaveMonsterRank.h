...
#define RPG_GAMECORE_BYCOMPAREALLWAVEMONSTERRANK_METHOD_4_1B3968ED24967866_OFFSET UNITYSDK_OFFSET(0x18726B00)
#define RPG_GAMECORE_BYCOMPAREALLWAVEMONSTERRANK_METHOD_4_91F6A5F562F9BD92_OFFSET UNITYSDK_OFFSET(0x18726BD0)
#define RPG_GAMECORE_BYCOMPAREALLWAVEMONSTERRANK__CTOR_OFFSET UNITYSDK_OFFSET(0x18726B80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareAllWaveMonsterRank_TypeDefinitionIndex = 21963;
