...
#define RPG_GAMECORE_TIMERELAYFLAMESETSPECIALFINALLEVEL_METHOD_3_6613BD4F1C5F1554_OFFSET UNITYSDK_OFFSET(0x1C151470)
#define RPG_GAMECORE_TIMERELAYFLAMESETSPECIALFINALLEVEL_METHOD_3_AEF333B790EDFB86_OFFSET UNITYSDK_OFFSET(0x1C151310)
#define RPG_GAMECORE_TIMERELAYFLAMESETSPECIALFINALLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1513D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TimeRelayFlameSetSpecialFinalLevel_TypeDefinitionIndex = 21232;
