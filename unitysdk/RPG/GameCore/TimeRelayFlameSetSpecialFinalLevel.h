...
#define RPG_GAMECORE_TIMERELAYFLAMESETSPECIALFINALLEVEL_METHOD_3_3853BA0E63B80B9A_OFFSET UNITYSDK_OFFSET(0x190999B0)
#define RPG_GAMECORE_TIMERELAYFLAMESETSPECIALFINALLEVEL_METHOD_3_6613BD4F1C5F1554_OFFSET UNITYSDK_OFFSET(0x19099B30)
#define RPG_GAMECORE_TIMERELAYFLAMESETSPECIALFINALLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x19099A80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TimeRelayFlameSetSpecialFinalLevel_TypeDefinitionIndex = 20899;
