...
#define RPG_GAMECORE_TIMERELAYFLAMESETSPECIALFINALLEVEL_METHOD_3_3853BA0E63B80B9A_OFFSET UNITYSDK_OFFSET(0x19DE49B0)
#define RPG_GAMECORE_TIMERELAYFLAMESETSPECIALFINALLEVEL_METHOD_3_6613BD4F1C5F1554_OFFSET UNITYSDK_OFFSET(0x19DE4B30)
#define RPG_GAMECORE_TIMERELAYFLAMESETSPECIALFINALLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x19DE4A80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TimeRelayFlameSetSpecialFinalLevel_TypeDefinitionIndex = 20817;
