...
#define RPG_GAMECORE_CHARACTERREPLACEANIMATORCONTROLLER_METHOD_3_298CC1C038D78808_OFFSET UNITYSDK_OFFSET(0x1DFFF2A0)
#define RPG_GAMECORE_CHARACTERREPLACEANIMATORCONTROLLER_METHOD_3_47B0B0DB245B168A_OFFSET UNITYSDK_OFFSET(0x1DFFF340)
#define RPG_GAMECORE_CHARACTERREPLACEANIMATORCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DFFF300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterReplaceAnimatorController_TypeDefinitionIndex = 22943;
