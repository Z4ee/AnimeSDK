...
#define RPG_GAMECORE_CHARACTERREPLACEANIMATORCONTROLLER_METHOD_3_47B0B0DB245B168A_OFFSET UNITYSDK_OFFSET(0x187D6AB0)
#define RPG_GAMECORE_CHARACTERREPLACEANIMATORCONTROLLER_METHOD_3_81C0F2161B400B31_OFFSET UNITYSDK_OFFSET(0x187D69E0)
#define RPG_GAMECORE_CHARACTERREPLACEANIMATORCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x187D6A60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterReplaceAnimatorController_TypeDefinitionIndex = 22156;
