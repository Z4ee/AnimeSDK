...
#define RPG_GAMECORE_BYPAMACTIONPHASETALK_METHOD_4_2948C2F0CE2F8118_OFFSET UNITYSDK_OFFSET(0x1B2B0390)
#define RPG_GAMECORE_BYPAMACTIONPHASETALK_METHOD_4_A929381BFF99FAAB_OFFSET UNITYSDK_OFFSET(0x1B2B03D0)
#define RPG_GAMECORE_BYPAMACTIONPHASETALK_METHOD_4_CEB0421A8D563B88_OFFSET UNITYSDK_OFFSET(0x1B2B0540)
#define RPG_GAMECORE_BYPAMACTIONPHASETALK_METHOD_4_EBC748AEE7E52451_OFFSET UNITYSDK_OFFSET(0x1B2B0510)
#define RPG_GAMECORE_BYPAMACTIONPHASETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2B03C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByPamActionPhaseTalk_TypeDefinitionIndex = 19237;
