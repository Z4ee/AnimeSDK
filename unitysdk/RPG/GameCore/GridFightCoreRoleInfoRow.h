...
#define RPG_GAMECORE_GRIDFIGHTCOREROLEINFOROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D14DEF0)
#define RPG_GAMECORE_GRIDFIGHTCOREROLEINFOROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D14E0F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightCoreRoleInfoRow_TypeDefinitionIndex = 13579;
