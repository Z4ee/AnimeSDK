...
#define RPG_GAMECORE_MODIFYLOSEHPDATA_METHOD_3_5FE6B95FBF56BA0B_OFFSET UNITYSDK_OFFSET(0x18B3ED70)
#define RPG_GAMECORE_MODIFYLOSEHPDATA_METHOD_3_BB0F51DBDA5B392E_OFFSET UNITYSDK_OFFSET(0x18B3EE90)
#define RPG_GAMECORE_MODIFYLOSEHPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18B3EE10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyLoseHPData_TypeDefinitionIndex = 22548;
