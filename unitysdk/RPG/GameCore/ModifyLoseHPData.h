...
#define RPG_GAMECORE_MODIFYLOSEHPDATA_METHOD_3_5FE6B95FBF56BA0B_OFFSET UNITYSDK_OFFSET(0x17432190)
#define RPG_GAMECORE_MODIFYLOSEHPDATA_METHOD_3_BB0F51DBDA5B392E_OFFSET UNITYSDK_OFFSET(0x174322B0)
#define RPG_GAMECORE_MODIFYLOSEHPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17432230)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyLoseHPData_TypeDefinitionIndex = 21810;
