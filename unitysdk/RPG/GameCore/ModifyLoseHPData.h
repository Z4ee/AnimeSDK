...
#define RPG_GAMECORE_MODIFYLOSEHPDATA_METHOD_3_B48778BD0F03A442_OFFSET UNITYSDK_OFFSET(0x1B1ABDA0)
#define RPG_GAMECORE_MODIFYLOSEHPDATA_METHOD_3_BB0F51DBDA5B392E_OFFSET UNITYSDK_OFFSET(0x1B1ABE80)
#define RPG_GAMECORE_MODIFYLOSEHPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1ABE20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyLoseHPData_TypeDefinitionIndex = 22729;
