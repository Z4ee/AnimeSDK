...
#define RPG_GAMECORE_SETDYNAMICVALUEBYCHARACTERCOUNT_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x19C40AF0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYCHARACTERCOUNT_METHOD_4_11D1612F4AB28FB1_OFFSET UNITYSDK_OFFSET(0x19C40A70)
#define RPG_GAMECORE_SETDYNAMICVALUEBYCHARACTERCOUNT_METHOD_4_589F6DC2C8426E8E_OFFSET UNITYSDK_OFFSET(0x19C38360)
#define RPG_GAMECORE_SETDYNAMICVALUEBYCHARACTERCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x19C38310)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByCharacterCount_TypeDefinitionIndex = 21831;
