...
#define RPG_GAMECORE_SETDYNAMICVALUEBYCHARACTERCOUNT_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1D4EF080)
#define RPG_GAMECORE_SETDYNAMICVALUEBYCHARACTERCOUNT_METHOD_4_3702816A79E7AA1B_OFFSET UNITYSDK_OFFSET(0x1D4EEDF0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYCHARACTERCOUNT_METHOD_4_589F6DC2C8426E8E_OFFSET UNITYSDK_OFFSET(0x1D4EEE30)
#define RPG_GAMECORE_SETDYNAMICVALUEBYCHARACTERCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4EEE20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByCharacterCount_TypeDefinitionIndex = 22826;
