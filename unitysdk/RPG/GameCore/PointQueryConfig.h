...
#define RPG_GAMECORE_POINTQUERYCONFIG_METHOD_2_9A4FF790F32C2757_OFFSET UNITYSDK_OFFSET(0x18C37950)
#define RPG_GAMECORE_POINTQUERYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18C37A10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PointQueryConfig_TypeDefinitionIndex = 14789;
