...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYREPLENISHROOMCARDCOUNTCONFIG_METHOD_3_0387289EA814C5C6_OFFSET UNITYSDK_OFFSET(0x1D164470)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYREPLENISHROOMCARDCOUNTCONFIG_METHOD_3_F6CEEB7312756B6A_OFFSET UNITYSDK_OFFSET(0x1D164420)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYREPLENISHROOMCARDCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D164460)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyReplenishRoomCardCountConfig_TypeDefinitionIndex = 17115;
