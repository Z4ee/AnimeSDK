...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYREPLENISHROOMCARDCOUNTCONFIG_METHOD_3_0387289EA814C5C6_OFFSET UNITYSDK_OFFSET(0x19B56A20)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYREPLENISHROOMCARDCOUNTCONFIG_METHOD_3_9AEE597403E5A26F_OFFSET UNITYSDK_OFFSET(0x19B5FEC0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYREPLENISHROOMCARDCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B569D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyReplenishRoomCardCountConfig_TypeDefinitionIndex = 16953;
