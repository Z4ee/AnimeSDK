...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONBUYEXPCONFIG_METHOD_3_070A6C5B98A09B2A_OFFSET UNITYSDK_OFFSET(0x197EC810)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONBUYEXPCONFIG_METHOD_3_95112ED38FE51873_OFFSET UNITYSDK_OFFSET(0x197F2020)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONBUYEXPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197EC7C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierExecActionBuyExpConfig_TypeDefinitionIndex = 18374;
