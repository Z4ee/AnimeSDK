...
#define RPG_GAMECORE_CAKERACEACTIONGODEXCHANGECATTRANSFER_METHOD_3_3E8A83BBD8C37138_OFFSET UNITYSDK_OFFSET(0x1B2CB9E0)
#define RPG_GAMECORE_CAKERACEACTIONGODEXCHANGECATTRANSFER_METHOD_3_8F1D386CD6CBD51D_OFFSET UNITYSDK_OFFSET(0x1B2CBA60)
#define RPG_GAMECORE_CAKERACEACTIONGODEXCHANGECATTRANSFER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2CBA50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionGodExchangeCatTransfer_TypeDefinitionIndex = 17626;
