...
#define RPG_GAMECORE_CHIMERADUELPARALLELNODE_METHOD_3_F782096C88ACAB43_OFFSET UNITYSDK_OFFSET(0x1C2446E0)
#define RPG_GAMECORE_CHIMERADUELPARALLELNODE_METHOD_3_FBE791170E0D4EB3_OFFSET UNITYSDK_OFFSET(0x1C244740)
#define RPG_GAMECORE_CHIMERADUELPARALLELNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C244730)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelParallelNode_TypeDefinitionIndex = 15374;
