...
#define RPG_GAMECORE_BLINKTOPOSITION_METHOD_3_49F56242224536BA_OFFSET UNITYSDK_OFFSET(0x16FE78B0)
#define RPG_GAMECORE_BLINKTOPOSITION_METHOD_3_6DD9BBC870C213E1_OFFSET UNITYSDK_OFFSET(0x16FE77E0)
#define RPG_GAMECORE_BLINKTOPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x16FE7860)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BlinkToPosition_TypeDefinitionIndex = 21362;
