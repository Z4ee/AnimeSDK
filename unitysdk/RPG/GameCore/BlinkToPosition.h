...
#define RPG_GAMECORE_BLINKTOPOSITION_METHOD_3_49F56242224536BA_OFFSET UNITYSDK_OFFSET(0x1B30C290)
#define RPG_GAMECORE_BLINKTOPOSITION_METHOD_3_4B233C5F3032C138_OFFSET UNITYSDK_OFFSET(0x1B30C1F0)
#define RPG_GAMECORE_BLINKTOPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B30C250)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BlinkToPosition_TypeDefinitionIndex = 22875;
