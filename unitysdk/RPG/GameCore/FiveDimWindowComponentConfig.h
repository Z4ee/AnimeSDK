...
#define RPG_GAMECORE_FIVEDIMWINDOWCOMPONENTCONFIG_METHOD_3_1B22C73BEE2618E7_OFFSET UNITYSDK_OFFSET(0x18924030)
#define RPG_GAMECORE_FIVEDIMWINDOWCOMPONENTCONFIG_METHOD_3_B26074C86B26F650_OFFSET UNITYSDK_OFFSET(0x18924160)
#define RPG_GAMECORE_FIVEDIMWINDOWCOMPONENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18924140)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimWindowComponentConfig_TypeDefinitionIndex = 17887;
