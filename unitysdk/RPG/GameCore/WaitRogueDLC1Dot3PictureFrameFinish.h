...
#define RPG_GAMECORE_WAITROGUEDLC1DOT3PICTUREFRAMEFINISH_METHOD_3_5B025A4A227A4AB3_OFFSET UNITYSDK_OFFSET(0x1D6AABB0)
#define RPG_GAMECORE_WAITROGUEDLC1DOT3PICTUREFRAMEFINISH_METHOD_3_DA55A11187678876_OFFSET UNITYSDK_OFFSET(0x1D6AAC80)
#define RPG_GAMECORE_WAITROGUEDLC1DOT3PICTUREFRAMEFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6AAC70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitRogueDLC1Dot3PictureFrameFinish_TypeDefinitionIndex = 22039;
