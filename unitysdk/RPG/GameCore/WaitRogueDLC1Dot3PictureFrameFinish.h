...
#define RPG_GAMECORE_WAITROGUEDLC1DOT3PICTUREFRAMEFINISH_METHOD_3_345BDF0BFBB47DAA_OFFSET UNITYSDK_OFFSET(0x17902920)
#define RPG_GAMECORE_WAITROGUEDLC1DOT3PICTUREFRAMEFINISH_METHOD_3_DA55A11187678876_OFFSET UNITYSDK_OFFSET(0x17902A30)
#define RPG_GAMECORE_WAITROGUEDLC1DOT3PICTUREFRAMEFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x17902A00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitRogueDLC1Dot3PictureFrameFinish_TypeDefinitionIndex = 20482;
