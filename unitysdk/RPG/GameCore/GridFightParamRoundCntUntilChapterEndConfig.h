...
#define RPG_GAMECORE_GRIDFIGHTPARAMROUNDCNTUNTILCHAPTERENDCONFIG_METHOD_6_4B6294AC83872C4C_OFFSET UNITYSDK_OFFSET(0x1D15DF90)
#define RPG_GAMECORE_GRIDFIGHTPARAMROUNDCNTUNTILCHAPTERENDCONFIG_METHOD_6_C5121D8BEBB34FD0_OFFSET UNITYSDK_OFFSET(0x1D15DF40)
#define RPG_GAMECORE_GRIDFIGHTPARAMROUNDCNTUNTILCHAPTERENDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D15DF80)
