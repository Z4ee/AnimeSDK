...
#define RPG_GAMECORE_GRIDFIGHTDRAGOPEQUIPSELECTOR_METHOD_3_36107C6FE94A4571_OFFSET UNITYSDK_OFFSET(0x172588C0)
#define RPG_GAMECORE_GRIDFIGHTDRAGOPEQUIPSELECTOR_METHOD_3_E5EBE060FA70E49D_OFFSET UNITYSDK_OFFSET(0x17258990)
#define RPG_GAMECORE_GRIDFIGHTDRAGOPEQUIPSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x17258980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightDragOpEquipSelector_TypeDefinitionIndex = 18228;
