...
#define RPG_GAMECORE_GRIDFIGHTDRAGOPEQUIPSELECTOR_METHOD_3_36107C6FE94A4571_OFFSET UNITYSDK_OFFSET(0x1C5C7ED0)
#define RPG_GAMECORE_GRIDFIGHTDRAGOPEQUIPSELECTOR_METHOD_3_E5EBE060FA70E49D_OFFSET UNITYSDK_OFFSET(0x1C5C7FA0)
#define RPG_GAMECORE_GRIDFIGHTDRAGOPEQUIPSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5C7F90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightDragOpEquipSelector_TypeDefinitionIndex = 19187;
