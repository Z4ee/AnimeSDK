...
#define RPG_GAMECORE_FORMATIONSLOTCONFIG_METHOD_2_0103188E41323BB3_OFFSET UNITYSDK_OFFSET(0x19766F60)
#define RPG_GAMECORE_FORMATIONSLOTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19767090)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FormationSlotConfig_TypeDefinitionIndex = 14848;
