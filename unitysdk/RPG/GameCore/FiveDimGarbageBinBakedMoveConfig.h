...
#define RPG_GAMECORE_FIVEDIMGARBAGEBINBAKEDMOVECONFIG_METHOD_3_09010B09539B43FC_OFFSET UNITYSDK_OFFSET(0x171F3AA0)
#define RPG_GAMECORE_FIVEDIMGARBAGEBINBAKEDMOVECONFIG_METHOD_3_7DD022A12516F8F1_OFFSET UNITYSDK_OFFSET(0x171F3A60)
#define RPG_GAMECORE_FIVEDIMGARBAGEBINBAKEDMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171F3A90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimGarbageBinBakedMoveConfig_TypeDefinitionIndex = 15286;
