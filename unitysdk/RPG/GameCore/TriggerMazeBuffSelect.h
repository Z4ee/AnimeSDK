...
#define RPG_GAMECORE_TRIGGERMAZEBUFFSELECT_METHOD_3_D9EFB402680AF63A_OFFSET UNITYSDK_OFFSET(0x1B057FB0)
#define RPG_GAMECORE_TRIGGERMAZEBUFFSELECT_METHOD_3_ECCA57F55DB8866F_OFFSET UNITYSDK_OFFSET(0x1B057FF0)
#define RPG_GAMECORE_TRIGGERMAZEBUFFSELECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B057FE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerMazeBuffSelect_TypeDefinitionIndex = 19634;
