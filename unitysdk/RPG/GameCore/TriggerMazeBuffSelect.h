...
#define RPG_GAMECORE_TRIGGERMAZEBUFFSELECT_METHOD_3_40CD5B3E2A165DCD_OFFSET UNITYSDK_OFFSET(0x178C9850)
#define RPG_GAMECORE_TRIGGERMAZEBUFFSELECT_METHOD_3_4BDC7F65FE396F74_OFFSET UNITYSDK_OFFSET(0x178C97D0)
#define RPG_GAMECORE_TRIGGERMAZEBUFFSELECT__CTOR_OFFSET UNITYSDK_OFFSET(0x178C9820)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerMazeBuffSelect_TypeDefinitionIndex = 18713;
