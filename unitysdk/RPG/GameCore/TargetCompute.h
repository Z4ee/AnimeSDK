...
#define RPG_GAMECORE_TARGETCOMPUTE_METHOD_4_0F30F2E6655A8E77_OFFSET UNITYSDK_OFFSET(0x1E166030)
#define RPG_GAMECORE_TARGETCOMPUTE_METHOD_4_95CF1DF861241F4B_OFFSET UNITYSDK_OFFSET(0x1E165FE0)
#define RPG_GAMECORE_TARGETCOMPUTE_METHOD_4_9B2C725DE2ACDDA8_OFFSET UNITYSDK_OFFSET(0x1E165E30)
#define RPG_GAMECORE_TARGETCOMPUTE_METHOD_4_D80294825193200E_OFFSET UNITYSDK_OFFSET(0x1E165E90)
#define RPG_GAMECORE_TARGETCOMPUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E165E80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetCompute_TypeDefinitionIndex = 23622;
