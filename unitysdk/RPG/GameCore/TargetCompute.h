...
#define RPG_GAMECORE_TARGETCOMPUTE_METHOD_4_8122EF1751E8610F_OFFSET UNITYSDK_OFFSET(0x18ED3770)
#define RPG_GAMECORE_TARGETCOMPUTE_METHOD_4_D80294825193200E_OFFSET UNITYSDK_OFFSET(0x18ED3850)
#define RPG_GAMECORE_TARGETCOMPUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x18ED3800)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetCompute_TypeDefinitionIndex = 22887;
