...
#define RPG_GAMECORE_COMPLEXSKILLAISOURCERETARGET_METHOD_3_D75DB2ED5030EDF5_OFFSET UNITYSDK_OFFSET(0x17127F60)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCERETARGET_METHOD_3_FD541A8F3F7D1424_OFFSET UNITYSDK_OFFSET(0x17129450)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCERETARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x17127F40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAISourceRetarget_TypeDefinitionIndex = 14237;
