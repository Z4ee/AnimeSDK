...
#define RPG_GAMECORE_COMPLEXSKILLAISOURCERETARGET_METHOD_3_D75DB2ED5030EDF5_OFFSET UNITYSDK_OFFSET(0x1882EB10)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCERETARGET_METHOD_3_FD541A8F3F7D1424_OFFSET UNITYSDK_OFFSET(0x18830220)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCERETARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1882EAF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAISourceRetarget_TypeDefinitionIndex = 14707;
