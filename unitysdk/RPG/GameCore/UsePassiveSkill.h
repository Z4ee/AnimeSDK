...
#define RPG_GAMECORE_USEPASSIVESKILL_METHOD_3_7FC60F7DB467D48F_OFFSET UNITYSDK_OFFSET(0x1D2B4300)
#define RPG_GAMECORE_USEPASSIVESKILL_METHOD_3_9F76E6CD89681F74_OFFSET UNITYSDK_OFFSET(0x1D2B42C0)
#define RPG_GAMECORE_USEPASSIVESKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2B42F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UsePassiveSkill_TypeDefinitionIndex = 23159;
