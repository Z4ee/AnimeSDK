...
#define RPG_GAMECORE_USEPASSIVESKILL_METHOD_3_13E5800277D5621E_OFFSET UNITYSDK_OFFSET(0x19E38F60)
#define RPG_GAMECORE_USEPASSIVESKILL_METHOD_3_7FC60F7DB467D48F_OFFSET UNITYSDK_OFFSET(0x19E38FE0)
#define RPG_GAMECORE_USEPASSIVESKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x19E38FB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UsePassiveSkill_TypeDefinitionIndex = 22145;
