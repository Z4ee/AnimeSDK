...
#define RPG_GAMECORE_BYCHARACTERSOMATOWIDTHTYPE_METHOD_4_1BB4B594E0BF66E7_OFFSET UNITYSDK_OFFSET(0x1CEA1380)
#define RPG_GAMECORE_BYCHARACTERSOMATOWIDTHTYPE_METHOD_4_57C3E83317068639_OFFSET UNITYSDK_OFFSET(0x1CEA13B0)
#define RPG_GAMECORE_BYCHARACTERSOMATOWIDTHTYPE_METHOD_4_BBDAD8407F9A41AB_OFFSET UNITYSDK_OFFSET(0x1CEA11B0)
#define RPG_GAMECORE_BYCHARACTERSOMATOWIDTHTYPE_METHOD_4_E53B72343B8E0362_OFFSET UNITYSDK_OFFSET(0x1CEA1170)
#define RPG_GAMECORE_BYCHARACTERSOMATOWIDTHTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEA11A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCharacterSomatoWidthType_TypeDefinitionIndex = 23432;
