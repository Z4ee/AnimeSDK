...
#define RPG_GAMECORE_BYCHARACTERSOMATOWIDTHTYPE_METHOD_4_BBDAD8407F9A41AB_OFFSET UNITYSDK_OFFSET(0x18720650)
#define RPG_GAMECORE_BYCHARACTERSOMATOWIDTHTYPE_METHOD_4_E70767F80762DACF_OFFSET UNITYSDK_OFFSET(0x18720580)
#define RPG_GAMECORE_BYCHARACTERSOMATOWIDTHTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x18720600)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCharacterSomatoWidthType_TypeDefinitionIndex = 22698;
