...
#define RPG_GAMECORE_ADAPTENTITYPOSITION_METHOD_3_398F9E547BCB5545_OFFSET UNITYSDK_OFFSET(0x1CDAF8C0)
#define RPG_GAMECORE_ADAPTENTITYPOSITION_METHOD_3_9C8A7BB91EB6CE90_OFFSET UNITYSDK_OFFSET(0x1CDAF960)
#define RPG_GAMECORE_ADAPTENTITYPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDAF920)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdaptEntityPosition_TypeDefinitionIndex = 19932;
