...
#define RPG_GAMECORE_ADAPTENTITYPOSITION_METHOD_3_398F9E547BCB5545_OFFSET UNITYSDK_OFFSET(0x1940AD70)
#define RPG_GAMECORE_ADAPTENTITYPOSITION_METHOD_3_9C8A7BB91EB6CE90_OFFSET UNITYSDK_OFFSET(0x1940AE40)
#define RPG_GAMECORE_ADAPTENTITYPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1940ADF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdaptEntityPosition_TypeDefinitionIndex = 19036;
