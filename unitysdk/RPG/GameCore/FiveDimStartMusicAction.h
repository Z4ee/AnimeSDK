...
#define RPG_GAMECORE_FIVEDIMSTARTMUSICACTION_METHOD_3_81013194E6CCBB9B_OFFSET UNITYSDK_OFFSET(0x1BEB5150)
#define RPG_GAMECORE_FIVEDIMSTARTMUSICACTION_METHOD_3_AAD0DB2733785E7A_OFFSET UNITYSDK_OFFSET(0x1BEB50D0)
#define RPG_GAMECORE_FIVEDIMSTARTMUSICACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEB5140)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimStartMusicAction_TypeDefinitionIndex = 17967;
