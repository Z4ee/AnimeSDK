...
#define RPG_GAMECORE_FIVEDIMSTARTMUSICACTION_METHOD_3_81013194E6CCBB9B_OFFSET UNITYSDK_OFFSET(0x1720DCC0)
#define RPG_GAMECORE_FIVEDIMSTARTMUSICACTION_METHOD_3_C5E0ADB4500425F6_OFFSET UNITYSDK_OFFSET(0x1720DC00)
#define RPG_GAMECORE_FIVEDIMSTARTMUSICACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1720DCA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimStartMusicAction_TypeDefinitionIndex = 17162;
