...
#define RPG_GAMECORE_FIVEDIMSTARTMUSICACTION_METHOD_3_81013194E6CCBB9B_OFFSET UNITYSDK_OFFSET(0x19759700)
#define RPG_GAMECORE_FIVEDIMSTARTMUSICACTION_METHOD_3_C5E0ADB4500425F6_OFFSET UNITYSDK_OFFSET(0x19759640)
#define RPG_GAMECORE_FIVEDIMSTARTMUSICACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x197596E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimStartMusicAction_TypeDefinitionIndex = 17791;
