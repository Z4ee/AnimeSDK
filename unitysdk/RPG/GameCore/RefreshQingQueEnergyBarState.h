...
#define RPG_GAMECORE_REFRESHQINGQUEENERGYBARSTATE_METHOD_3_1C8CF601C1857B5E_OFFSET UNITYSDK_OFFSET(0x1D3908A0)
#define RPG_GAMECORE_REFRESHQINGQUEENERGYBARSTATE_METHOD_3_9E371DC9A3F180CF_OFFSET UNITYSDK_OFFSET(0x1D390940)
#define RPG_GAMECORE_REFRESHQINGQUEENERGYBARSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D390900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RefreshQingQueEnergyBarState_TypeDefinitionIndex = 22484;
