...
#define RPG_GAMECORE_OVERRIDEADVENTURECHARACTERTILTCONFIG_METHOD_3_C2CAC885E67296E4_OFFSET UNITYSDK_OFFSET(0x199DCD00)
#define RPG_GAMECORE_OVERRIDEADVENTURECHARACTERTILTCONFIG_METHOD_3_FD1549B4860BB672_OFFSET UNITYSDK_OFFSET(0x199DCC80)
#define RPG_GAMECORE_OVERRIDEADVENTURECHARACTERTILTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x199DCCD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OverrideAdventureCharacterTiltConfig_TypeDefinitionIndex = 19381;
