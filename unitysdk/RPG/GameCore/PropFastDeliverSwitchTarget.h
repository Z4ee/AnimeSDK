...
#define RPG_GAMECORE_PROPFASTDELIVERSWITCHTARGET_METHOD_3_6D2A1C4441C783F8_OFFSET UNITYSDK_OFFSET(0x18C6E030)
#define RPG_GAMECORE_PROPFASTDELIVERSWITCHTARGET_METHOD_3_F498F952F7FCA69A_OFFSET UNITYSDK_OFFSET(0x18C6E170)
#define RPG_GAMECORE_PROPFASTDELIVERSWITCHTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x18C6E0E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropFastDeliverSwitchTarget_TypeDefinitionIndex = 21029;
