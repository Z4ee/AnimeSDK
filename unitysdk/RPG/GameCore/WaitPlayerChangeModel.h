...
#define RPG_GAMECORE_WAITPLAYERCHANGEMODEL_METHOD_3_4DEF5312DED279DC_OFFSET UNITYSDK_OFFSET(0x1DEBDBC0)
#define RPG_GAMECORE_WAITPLAYERCHANGEMODEL_METHOD_3_D9C0453CED005297_OFFSET UNITYSDK_OFFSET(0x1DEBDC00)
#define RPG_GAMECORE_WAITPLAYERCHANGEMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEBDBF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitPlayerChangeModel_TypeDefinitionIndex = 20149;
