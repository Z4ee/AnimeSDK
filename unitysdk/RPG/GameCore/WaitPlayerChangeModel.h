...
#define RPG_GAMECORE_WAITPLAYERCHANGEMODEL_METHOD_3_D9C0453CED005297_OFFSET UNITYSDK_OFFSET(0x17900150)
#define RPG_GAMECORE_WAITPLAYERCHANGEMODEL_METHOD_3_F6681EF467ADCEE6_OFFSET UNITYSDK_OFFSET(0x179000D0)
#define RPG_GAMECORE_WAITPLAYERCHANGEMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x17900120)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitPlayerChangeModel_TypeDefinitionIndex = 18680;
