...
#define RPG_GAMECORE_WAITPLAYERCHANGEMODEL_METHOD_3_4DEF5312DED279DC_OFFSET UNITYSDK_OFFSET(0x1D6A8A20)
#define RPG_GAMECORE_WAITPLAYERCHANGEMODEL_METHOD_3_D9C0453CED005297_OFFSET UNITYSDK_OFFSET(0x1D6A8A60)
#define RPG_GAMECORE_WAITPLAYERCHANGEMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6A8A50)
