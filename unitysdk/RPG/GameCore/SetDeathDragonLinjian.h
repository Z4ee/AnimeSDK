...
#define RPG_GAMECORE_SETDEATHDRAGONLINJIAN_METHOD_3_72AFD09EE3D819BD_OFFSET UNITYSDK_OFFSET(0x18E14540)
#define RPG_GAMECORE_SETDEATHDRAGONLINJIAN_METHOD_3_912E10BFC86D4376_OFFSET UNITYSDK_OFFSET(0x18E145C0)
#define RPG_GAMECORE_SETDEATHDRAGONLINJIAN__CTOR_OFFSET UNITYSDK_OFFSET(0x18E14590)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDeathDragonLinjian_TypeDefinitionIndex = 21766;
