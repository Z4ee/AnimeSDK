...
#define RPG_GAMECORE_ITEMGOTODATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x172CC660)
#define RPG_GAMECORE_ITEMGOTODATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x172CCC20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ItemGotoDataRow_TypeDefinitionIndex = 12676;
