...
#define RPG_GAMECORE_ADVBLOCKREWARDTOAST_METHOD_3_7286298472D7DBAB_OFFSET UNITYSDK_OFFSET(0x16F24440)
#define RPG_GAMECORE_ADVBLOCKREWARDTOAST_METHOD_3_D67C11908BCEEA82_OFFSET UNITYSDK_OFFSET(0x16F244C0)
#define RPG_GAMECORE_ADVBLOCKREWARDTOAST__CTOR_OFFSET UNITYSDK_OFFSET(0x16F24490)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvBlockRewardToast_TypeDefinitionIndex = 19971;
