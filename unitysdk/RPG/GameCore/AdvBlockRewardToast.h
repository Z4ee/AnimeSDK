...
#define RPG_GAMECORE_ADVBLOCKREWARDTOAST_METHOD_3_7286298472D7DBAB_OFFSET UNITYSDK_OFFSET(0x18646610)
#define RPG_GAMECORE_ADVBLOCKREWARDTOAST_METHOD_3_D67C11908BCEEA82_OFFSET UNITYSDK_OFFSET(0x18646690)
#define RPG_GAMECORE_ADVBLOCKREWARDTOAST__CTOR_OFFSET UNITYSDK_OFFSET(0x18646660)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvBlockRewardToast_TypeDefinitionIndex = 20652;
