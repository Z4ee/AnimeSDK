...
#define RPG_GAMECORE_GRIDFIGHTACTIONADDBATTLEAVATARNUMCONFIG_METHOD_6_22155B06083958AE_OFFSET UNITYSDK_OFFSET(0x1C5C10B0)
#define RPG_GAMECORE_GRIDFIGHTACTIONADDBATTLEAVATARNUMCONFIG_METHOD_6_3C16B303F9CD2A6A_OFFSET UNITYSDK_OFFSET(0x1C5C1100)
#define RPG_GAMECORE_GRIDFIGHTACTIONADDBATTLEAVATARNUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5C10F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightActionAddBattleAvatarNumConfig_TypeDefinitionIndex = 18549;
