...
#define RPG_GAMECORE_TRYCANCELENTERREGION_METHOD_3_6CB2664263ABAAAC_OFFSET UNITYSDK_OFFSET(0x178D10C0)
#define RPG_GAMECORE_TRYCANCELENTERREGION_METHOD_3_F6D874473C25E338_OFFSET UNITYSDK_OFFSET(0x178D11D0)
#define RPG_GAMECORE_TRYCANCELENTERREGION__CTOR_OFFSET UNITYSDK_OFFSET(0x178D11A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TryCancelEnterRegion_TypeDefinitionIndex = 19079;
