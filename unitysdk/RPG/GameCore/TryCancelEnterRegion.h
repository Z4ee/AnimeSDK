...
#define RPG_GAMECORE_TRYCANCELENTERREGION_METHOD_3_6CB2664263ABAAAC_OFFSET UNITYSDK_OFFSET(0x190CF800)
#define RPG_GAMECORE_TRYCANCELENTERREGION_METHOD_3_F6D874473C25E338_OFFSET UNITYSDK_OFFSET(0x190CF910)
#define RPG_GAMECORE_TRYCANCELENTERREGION__CTOR_OFFSET UNITYSDK_OFFSET(0x190CF8E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TryCancelEnterRegion_TypeDefinitionIndex = 19737;
