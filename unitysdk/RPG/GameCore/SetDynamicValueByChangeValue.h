...
#define RPG_GAMECORE_SETDYNAMICVALUEBYCHANGEVALUE_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1C2E0360)
#define RPG_GAMECORE_SETDYNAMICVALUEBYCHANGEVALUE_METHOD_4_37908AA421FC5F4E_OFFSET UNITYSDK_OFFSET(0x1C2E0170)
#define RPG_GAMECORE_SETDYNAMICVALUEBYCHANGEVALUE_METHOD_4_8A588D2E770CD9BF_OFFSET UNITYSDK_OFFSET(0x1C2E01B0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYCHANGEVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2E01A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByChangeValue_TypeDefinitionIndex = 22268;
