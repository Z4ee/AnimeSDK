...
#define RPG_GAMECORE_SETDYNAMICVALUEBYCHANGEVALUE_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x18E1E7D0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYCHANGEVALUE_METHOD_4_2E90541981B6BC3F_OFFSET UNITYSDK_OFFSET(0x18E1E550)
#define RPG_GAMECORE_SETDYNAMICVALUEBYCHANGEVALUE_METHOD_4_8A588D2E770CD9BF_OFFSET UNITYSDK_OFFSET(0x18E1E620)
#define RPG_GAMECORE_SETDYNAMICVALUEBYCHANGEVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E1E5D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByChangeValue_TypeDefinitionIndex = 22036;
