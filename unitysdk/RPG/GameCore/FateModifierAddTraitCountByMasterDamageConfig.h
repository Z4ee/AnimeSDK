...
#define RPG_GAMECORE_FATEMODIFIERADDTRAITCOUNTBYMASTERDAMAGECONFIG_METHOD_3_137BB10490127512_OFFSET UNITYSDK_OFFSET(0x19710390)
#define RPG_GAMECORE_FATEMODIFIERADDTRAITCOUNTBYMASTERDAMAGECONFIG_METHOD_3_1DC8496AA8F7C69B_OFFSET UNITYSDK_OFFSET(0x197102C0)
#define RPG_GAMECORE_FATEMODIFIERADDTRAITCOUNTBYMASTERDAMAGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19710340)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateModifierAddTraitCountByMasterDamageConfig_TypeDefinitionIndex = 18295;
