...
#define RPG_GAMECORE_LEAVELOOPSCENE_METHOD_3_4BC304D2E1815C80_OFFSET UNITYSDK_OFFSET(0x1C10AB60)
#define RPG_GAMECORE_LEAVELOOPSCENE_METHOD_3_F32E0DA95207333D_OFFSET UNITYSDK_OFFSET(0x1C10AA90)
#define RPG_GAMECORE_LEAVELOOPSCENE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C10AB50)
