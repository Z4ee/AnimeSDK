...
#define RPG_GAMECORE_LEAVELOOPSCENE_METHOD_3_4BC304D2E1815C80_OFFSET UNITYSDK_OFFSET(0x1732C570)
#define RPG_GAMECORE_LEAVELOOPSCENE_METHOD_3_738797A5F58EB634_OFFSET UNITYSDK_OFFSET(0x1732C460)
#define RPG_GAMECORE_LEAVELOOPSCENE__CTOR_OFFSET UNITYSDK_OFFSET(0x1732C540)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LeaveLoopScene_TypeDefinitionIndex = 18728;
