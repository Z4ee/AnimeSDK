...
#define RPG_GAMECORE_UIMONOPOLYWAITMAINPAGE_METHOD_3_A164BE515FB353D3_OFFSET UNITYSDK_OFFSET(0x178E0730)
#define RPG_GAMECORE_UIMONOPOLYWAITMAINPAGE_METHOD_3_D7CEEA8B1231F27F_OFFSET UNITYSDK_OFFSET(0x178E0620)
#define RPG_GAMECORE_UIMONOPOLYWAITMAINPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x178E0700)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UIMonopolyWaitMainPage_TypeDefinitionIndex = 19895;
