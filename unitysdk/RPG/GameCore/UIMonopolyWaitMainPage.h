...
#define RPG_GAMECORE_UIMONOPOLYWAITMAINPAGE_METHOD_3_A164BE515FB353D3_OFFSET UNITYSDK_OFFSET(0x19E2FDC0)
#define RPG_GAMECORE_UIMONOPOLYWAITMAINPAGE_METHOD_3_D7CEEA8B1231F27F_OFFSET UNITYSDK_OFFSET(0x19E2FCB0)
#define RPG_GAMECORE_UIMONOPOLYWAITMAINPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x19E2FD90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UIMonopolyWaitMainPage_TypeDefinitionIndex = 20511;
