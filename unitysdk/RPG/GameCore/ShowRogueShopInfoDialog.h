...
#define RPG_GAMECORE_SHOWROGUESHOPINFODIALOG_METHOD_3_40581891A0983660_OFFSET UNITYSDK_OFFSET(0x19C820D0)
#define RPG_GAMECORE_SHOWROGUESHOPINFODIALOG_METHOD_3_D515C2A92B8F86E9_OFFSET UNITYSDK_OFFSET(0x19C82150)
#define RPG_GAMECORE_SHOWROGUESHOPINFODIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x19C82120)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowRogueShopInfoDialog_TypeDefinitionIndex = 19671;
