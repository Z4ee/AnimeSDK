...
#define RPG_GAMECORE_SHOWROGUESHOPINFODIALOG_METHOD_3_40581891A0983660_OFFSET UNITYSDK_OFFSET(0x18E65FB0)
#define RPG_GAMECORE_SHOWROGUESHOPINFODIALOG_METHOD_3_D515C2A92B8F86E9_OFFSET UNITYSDK_OFFSET(0x18E66030)
#define RPG_GAMECORE_SHOWROGUESHOPINFODIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x18E66000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowRogueShopInfoDialog_TypeDefinitionIndex = 19795;
