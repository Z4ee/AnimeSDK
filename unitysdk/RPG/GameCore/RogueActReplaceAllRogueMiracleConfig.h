...
#define RPG_GAMECORE_ROGUEACTREPLACEALLROGUEMIRACLECONFIG_METHOD_6_12B27854D381AF4A_OFFSET UNITYSDK_OFFSET(0x1C49DD10)
#define RPG_GAMECORE_ROGUEACTREPLACEALLROGUEMIRACLECONFIG_METHOD_6_DE4512166C34590E_OFFSET UNITYSDK_OFFSET(0x1C49DCC0)
#define RPG_GAMECORE_ROGUEACTREPLACEALLROGUEMIRACLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C49DD00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActReplaceAllRogueMiracleConfig_TypeDefinitionIndex = 18891;
