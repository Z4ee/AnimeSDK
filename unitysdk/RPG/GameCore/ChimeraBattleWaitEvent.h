...
#define RPG_GAMECORE_CHIMERABATTLEWAITEVENT_METHOD_3_182E32511DC00450_OFFSET UNITYSDK_OFFSET(0x1C38FCB0)
#define RPG_GAMECORE_CHIMERABATTLEWAITEVENT_METHOD_3_CCE63574FEA70BCA_OFFSET UNITYSDK_OFFSET(0x1C38EEF0)
#define RPG_GAMECORE_CHIMERABATTLEWAITEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C38EEE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraBattleWaitEvent_TypeDefinitionIndex = 15236;
