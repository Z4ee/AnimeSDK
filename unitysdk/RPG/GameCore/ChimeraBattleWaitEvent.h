...
#define RPG_GAMECORE_CHIMERABATTLEWAITEVENT_METHOD_3_182E32511DC00450_OFFSET UNITYSDK_OFFSET(0x19635A50)
#define RPG_GAMECORE_CHIMERABATTLEWAITEVENT_METHOD_3_CCE63574FEA70BCA_OFFSET UNITYSDK_OFFSET(0x19634C90)
#define RPG_GAMECORE_CHIMERABATTLEWAITEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19634C80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraBattleWaitEvent_TypeDefinitionIndex = 15072;
