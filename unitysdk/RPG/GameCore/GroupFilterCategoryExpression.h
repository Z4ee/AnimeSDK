...
#define RPG_GAMECORE_GROUPFILTERCATEGORYEXPRESSION_METHOD_3_35B57FCF113276F8_OFFSET UNITYSDK_OFFSET(0x1D170090)
#define RPG_GAMECORE_GROUPFILTERCATEGORYEXPRESSION_METHOD_3_B6A8EF60CE6C99BC_OFFSET UNITYSDK_OFFSET(0x1D170040)
#define RPG_GAMECORE_GROUPFILTERCATEGORYEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D170080)
