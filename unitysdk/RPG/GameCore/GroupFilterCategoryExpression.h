...
#define RPG_GAMECORE_GROUPFILTERCATEGORYEXPRESSION_METHOD_3_35B57FCF113276F8_OFFSET UNITYSDK_OFFSET(0x1D0803F0)
#define RPG_GAMECORE_GROUPFILTERCATEGORYEXPRESSION_METHOD_3_B6A8EF60CE6C99BC_OFFSET UNITYSDK_OFFSET(0x1D0803A0)
#define RPG_GAMECORE_GROUPFILTERCATEGORYEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0803E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GroupFilterCategoryExpression_TypeDefinitionIndex = 16699;
