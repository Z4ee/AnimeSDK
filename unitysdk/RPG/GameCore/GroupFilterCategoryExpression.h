...
#define RPG_GAMECORE_GROUPFILTERCATEGORYEXPRESSION_METHOD_3_35B57FCF113276F8_OFFSET UNITYSDK_OFFSET(0x189E0790)
#define RPG_GAMECORE_GROUPFILTERCATEGORYEXPRESSION_METHOD_3_B6A8EF60CE6C99BC_OFFSET UNITYSDK_OFFSET(0x189E0740)
#define RPG_GAMECORE_GROUPFILTERCATEGORYEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x189E0780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GroupFilterCategoryExpression_TypeDefinitionIndex = 16506;
