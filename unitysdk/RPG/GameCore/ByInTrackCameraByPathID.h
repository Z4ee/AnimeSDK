...
#define RPG_GAMECORE_BYINTRACKCAMERABYPATHID_METHOD_4_4E4A5FEE2634ECCB_OFFSET UNITYSDK_OFFSET(0x17028250)
#define RPG_GAMECORE_BYINTRACKCAMERABYPATHID_METHOD_4_70648FFF2A8DB086_OFFSET UNITYSDK_OFFSET(0x17028180)
#define RPG_GAMECORE_BYINTRACKCAMERABYPATHID__CTOR_OFFSET UNITYSDK_OFFSET(0x17028200)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByInTrackCameraByPathID_TypeDefinitionIndex = 19159;
