...
#define RPG_GAMECORE_BYINTRACKCAMERABYPATHID_METHOD_4_050A727B77F7B9F1_OFFSET UNITYSDK_OFFSET(0x1A8D3160)
#define RPG_GAMECORE_BYINTRACKCAMERABYPATHID_METHOD_4_4E4A5FEE2634ECCB_OFFSET UNITYSDK_OFFSET(0x1A8D2E20)
#define RPG_GAMECORE_BYINTRACKCAMERABYPATHID_METHOD_4_5FF96188692D40F6_OFFSET UNITYSDK_OFFSET(0x1A8D2DE0)
#define RPG_GAMECORE_BYINTRACKCAMERABYPATHID_METHOD_4_9A4E98A687D601BE_OFFSET UNITYSDK_OFFSET(0x1A8D3190)
#define RPG_GAMECORE_BYINTRACKCAMERABYPATHID__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8D2E10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByInTrackCameraByPathID_TypeDefinitionIndex = 20050;
