...
#define RPG_GAMECORE_TEAMFORMATIONCOMPONENT_MULTIROWTARGETSELECTOR_GETLEFTADJOINENTITY_OFFSET UNITYSDK_OFFSET(0xB781460)
#define RPG_GAMECORE_TEAMFORMATIONCOMPONENT_MULTIROWTARGETSELECTOR_GETRIGHTADJOINENTITY_OFFSET UNITYSDK_OFFSET(0xB781620)
#define RPG_GAMECORE_TEAMFORMATIONCOMPONENT_MULTIROWTARGETSELECTOR_PREPARE_OFFSET UNITYSDK_OFFSET(0xB767830)
#define RPG_GAMECORE_TEAMFORMATIONCOMPONENT_MULTIROWTARGETSELECTOR_RELEASE_OFFSET UNITYSDK_OFFSET(0xB781960)
#define RPG_GAMECORE_TEAMFORMATIONCOMPONENT_MULTIROWTARGETSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0xB76A9C0)
#define RPG_GAMECORE_TEAMFORMATIONCOMPONENT_MULTIROWTARGETSELECTOR__INTERNALGETLEFTADJOINENTITY_OFFSET UNITYSDK_OFFSET(0xB7817E0)
#define RPG_GAMECORE_TEAMFORMATIONCOMPONENT_MULTIROWTARGETSELECTOR__INTERNALGETRIGHTADJOINENTITY_OFFSET UNITYSDK_OFFSET(0xB7818A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TeamFormationComponent_MultiRowTargetSelector_TypeDefinitionIndex = 53199;

	class TeamFormationComponent_MultiRowTargetSelector : public ::System::Object
	{
	public:
		::System::Collections::Generic::List_1<::Class_2_BF927CBEA754F6BE*>* _finalFormationList; // 0x10
		...
		::System::Int32 _RghtIteration; // 0x28
		::Struct_2_2B6684D3E43696AE _MainTargetRowFormationPos; // 0x2C
		::System::Boolean _InverseFlag; // 0x34
		::System::Boolean _InProcess; // 0x35
		::System::Int32 _leftIteration; // 0x38
