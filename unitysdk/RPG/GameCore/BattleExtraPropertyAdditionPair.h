...
#define RPG_GAMECORE_BATTLEEXTRAPROPERTYADDITIONPAIR_METHOD_2_1436B6DB26FEC618_OFFSET UNITYSDK_OFFSET(0x1CE76F20)
#define RPG_GAMECORE_BATTLEEXTRAPROPERTYADDITIONPAIR_METHOD_2_F412DFCC2181D785_OFFSET UNITYSDK_OFFSET(0x1CE76DB0)
#define RPG_GAMECORE_BATTLEEXTRAPROPERTYADDITIONPAIR__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE76F10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleExtraPropertyAdditionPair_TypeDefinitionIndex = 23373;
