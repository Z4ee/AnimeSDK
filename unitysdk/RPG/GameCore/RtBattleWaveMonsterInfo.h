...
#define RPG_GAMECORE_RTBATTLEWAVEMONSTERINFO_METHOD_2_80F5D68A9B653765_OFFSET UNITYSDK_OFFSET(0x19BDE3F0)
#define RPG_GAMECORE_RTBATTLEWAVEMONSTERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19BDE4E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtBattleWaveMonsterInfo_TypeDefinitionIndex = 17164;
