...
#define RPG_GAMECORE_BYCOMPARESPCHANGETAG_METHOD_4_49F6B22A9C0E19E7_OFFSET UNITYSDK_OFFSET(0x18739D40)
#define RPG_GAMECORE_BYCOMPARESPCHANGETAG_METHOD_4_D6D91B26BD431DA9_OFFSET UNITYSDK_OFFSET(0x18739C70)
#define RPG_GAMECORE_BYCOMPARESPCHANGETAG__CTOR_OFFSET UNITYSDK_OFFSET(0x18739CF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareSPChangeTag_TypeDefinitionIndex = 22541;
