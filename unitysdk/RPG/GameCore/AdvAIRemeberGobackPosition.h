...
#define RPG_GAMECORE_ADVAIREMEBERGOBACKPOSITION_METHOD_3_5D0BC922786868EB_OFFSET UNITYSDK_OFFSET(0x16F236B0)
#define RPG_GAMECORE_ADVAIREMEBERGOBACKPOSITION_METHOD_3_A367BBE3CABD57FD_OFFSET UNITYSDK_OFFSET(0x16F23800)
#define RPG_GAMECORE_ADVAIREMEBERGOBACKPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x16F23770)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvAIRemeberGobackPosition_TypeDefinitionIndex = 18278;
