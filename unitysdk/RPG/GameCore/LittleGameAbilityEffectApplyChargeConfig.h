...
#define RPG_GAMECORE_LITTLEGAMEABILITYEFFECTAPPLYCHARGECONFIG_METHOD_3_5A4CCCA963F828D6_OFFSET UNITYSDK_OFFSET(0x19892B70)
#define RPG_GAMECORE_LITTLEGAMEABILITYEFFECTAPPLYCHARGECONFIG_METHOD_3_83D28FED88B8FB0A_OFFSET UNITYSDK_OFFSET(0x19892AA0)
#define RPG_GAMECORE_LITTLEGAMEABILITYEFFECTAPPLYCHARGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19892B60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityEffectApplyChargeConfig_TypeDefinitionIndex = 20171;
