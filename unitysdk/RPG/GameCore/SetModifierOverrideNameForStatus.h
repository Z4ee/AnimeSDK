...
#define RPG_GAMECORE_SETMODIFIEROVERRIDENAMEFORSTATUS_METHOD_3_284A1E3397B7F2E0_OFFSET UNITYSDK_OFFSET(0x1D506670)
#define RPG_GAMECORE_SETMODIFIEROVERRIDENAMEFORSTATUS_METHOD_3_BA99AC15F45183D5_OFFSET UNITYSDK_OFFSET(0x1D5066B0)
#define RPG_GAMECORE_SETMODIFIEROVERRIDENAMEFORSTATUS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5066A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetModifierOverrideNameForStatus_TypeDefinitionIndex = 22381;
