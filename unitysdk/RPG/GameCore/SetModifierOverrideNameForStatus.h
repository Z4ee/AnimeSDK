...
#define RPG_GAMECORE_SETMODIFIEROVERRIDENAMEFORSTATUS_METHOD_3_BA99AC15F45183D5_OFFSET UNITYSDK_OFFSET(0x18E39A80)
#define RPG_GAMECORE_SETMODIFIEROVERRIDENAMEFORSTATUS_METHOD_3_C4EA8DDF2B654BD6_OFFSET UNITYSDK_OFFSET(0x18E39A00)
#define RPG_GAMECORE_SETMODIFIEROVERRIDENAMEFORSTATUS__CTOR_OFFSET UNITYSDK_OFFSET(0x18E39A50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetModifierOverrideNameForStatus_TypeDefinitionIndex = 21522;
