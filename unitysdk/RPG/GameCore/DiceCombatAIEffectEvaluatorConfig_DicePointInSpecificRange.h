...
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEPOINTINSPECIFICRANGE_METHOD_3_3BD58AF1EE695FBA_OFFSET UNITYSDK_OFFSET(0x196A2A40)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEPOINTINSPECIFICRANGE_METHOD_3_7EAA1067AB245F5A_OFFSET UNITYSDK_OFFSET(0x196A3360)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEPOINTINSPECIFICRANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x196A2A30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatAIEffectEvaluatorConfig_DicePointInSpecificRange_TypeDefinitionIndex = 15400;
