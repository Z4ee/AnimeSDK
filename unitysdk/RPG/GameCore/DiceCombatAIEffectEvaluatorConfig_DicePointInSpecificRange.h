...
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEPOINTINSPECIFICRANGE_METHOD_3_3BD58AF1EE695FBA_OFFSET UNITYSDK_OFFSET(0x1D0285B0)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEPOINTINSPECIFICRANGE_METHOD_3_7EAA1067AB245F5A_OFFSET UNITYSDK_OFFSET(0x1D028ED0)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEPOINTINSPECIFICRANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0285A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatAIEffectEvaluatorConfig_DicePointInSpecificRange_TypeDefinitionIndex = 16001;
