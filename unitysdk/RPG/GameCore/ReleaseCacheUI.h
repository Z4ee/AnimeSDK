...
#define RPG_GAMECORE_RELEASECACHEUI_METHOD_3_0620D24DC89C5991_OFFSET UNITYSDK_OFFSET(0x18C96830)
#define RPG_GAMECORE_RELEASECACHEUI_METHOD_3_AF7F0737FE10A838_OFFSET UNITYSDK_OFFSET(0x18C967B0)
#define RPG_GAMECORE_RELEASECACHEUI__CTOR_OFFSET UNITYSDK_OFFSET(0x18C96800)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ReleaseCacheUI_TypeDefinitionIndex = 20550;
