...
#define RPG_GAMECORE_TAKEPHOTO_METHOD_3_036C4F56FFFB19FE_OFFSET UNITYSDK_OFFSET(0x18ECDF00)
#define RPG_GAMECORE_TAKEPHOTO_METHOD_3_E21EA03FEA077872_OFFSET UNITYSDK_OFFSET(0x18ECDDF0)
#define RPG_GAMECORE_TAKEPHOTO__CTOR_OFFSET UNITYSDK_OFFSET(0x18ECDED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TakePhoto_TypeDefinitionIndex = 21041;
