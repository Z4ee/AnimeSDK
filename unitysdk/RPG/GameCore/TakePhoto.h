...
#define RPG_GAMECORE_TAKEPHOTO_METHOD_3_036C4F56FFFB19FE_OFFSET UNITYSDK_OFFSET(0x1B447FD0)
#define RPG_GAMECORE_TAKEPHOTO_METHOD_3_E14425102AA953FB_OFFSET UNITYSDK_OFFSET(0x1B447F00)
#define RPG_GAMECORE_TAKEPHOTO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B447FC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TakePhoto_TypeDefinitionIndex = 21365;
