...
#define RPG_GAMECORE_TAKEPHOTO_METHOD_3_036C4F56FFFB19FE_OFFSET UNITYSDK_OFFSET(0x177A7940)
#define RPG_GAMECORE_TAKEPHOTO_METHOD_3_E21EA03FEA077872_OFFSET UNITYSDK_OFFSET(0x177A7830)
#define RPG_GAMECORE_TAKEPHOTO__CTOR_OFFSET UNITYSDK_OFFSET(0x177A7910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TakePhoto_TypeDefinitionIndex = 20359;
