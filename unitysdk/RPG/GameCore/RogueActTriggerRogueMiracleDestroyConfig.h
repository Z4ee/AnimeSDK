...
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMIRACLEDESTROYCONFIG_METHOD_6_A33AAE76EDABFD8C_OFFSET UNITYSDK_OFFSET(0x175CCF30)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMIRACLEDESTROYCONFIG_METHOD_6_AF498DCDE4607FC1_OFFSET UNITYSDK_OFFSET(0x175CD150)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMIRACLEDESTROYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175CD070)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActTriggerRogueMiracleDestroyConfig_TypeDefinitionIndex = 17954;
