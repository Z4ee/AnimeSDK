...
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_OR_METHOD_4_A14C715D0891E021_OFFSET UNITYSDK_OFFSET(0x1D032790)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_OR_METHOD_4_E6A5F99857A4A4DF_OFFSET UNITYSDK_OFFSET(0x1D033610)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_OR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D032780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatPredicateConfig_Or_TypeDefinitionIndex = 15912;
