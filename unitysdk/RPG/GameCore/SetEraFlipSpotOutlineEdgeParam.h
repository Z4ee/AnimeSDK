...
#define RPG_GAMECORE_SETERAFLIPSPOTOUTLINEEDGEPARAM_METHOD_3_22F075A7B3FB57F0_OFFSET UNITYSDK_OFFSET(0x1C5F8680)
#define RPG_GAMECORE_SETERAFLIPSPOTOUTLINEEDGEPARAM_METHOD_3_F3F7D3441F463691_OFFSET UNITYSDK_OFFSET(0x1C5F8630)
#define RPG_GAMECORE_SETERAFLIPSPOTOUTLINEEDGEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5F8670)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetEraFlipSpotOutlineEdgeParam_TypeDefinitionIndex = 21526;
