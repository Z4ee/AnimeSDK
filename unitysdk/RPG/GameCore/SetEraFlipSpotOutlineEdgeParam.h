...
#define RPG_GAMECORE_SETERAFLIPSPOTOUTLINEEDGEPARAM_METHOD_3_22F075A7B3FB57F0_OFFSET UNITYSDK_OFFSET(0x176CCC90)
#define RPG_GAMECORE_SETERAFLIPSPOTOUTLINEEDGEPARAM_METHOD_3_6ABBF351B362AAA5_OFFSET UNITYSDK_OFFSET(0x176CCBF0)
#define RPG_GAMECORE_SETERAFLIPSPOTOUTLINEEDGEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x176CCC50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetEraFlipSpotOutlineEdgeParam_TypeDefinitionIndex = 20533;
