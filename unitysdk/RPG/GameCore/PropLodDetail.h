...
#define RPG_GAMECORE_PROPLODDETAIL_METHOD_3_68EAC2B0C6D4B98D_OFFSET UNITYSDK_OFFSET(0x18C6F750)
#define RPG_GAMECORE_PROPLODDETAIL_METHOD_3_D39EE853BCC53661_OFFSET UNITYSDK_OFFSET(0x18C6F7B0)
#define RPG_GAMECORE_PROPLODDETAIL__CTOR_OFFSET UNITYSDK_OFFSET(0x18C6F790)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropLodDetail_TypeDefinitionIndex = 18106;
