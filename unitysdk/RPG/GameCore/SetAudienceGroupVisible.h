...
#define RPG_GAMECORE_SETAUDIENCEGROUPVISIBLE_METHOD_3_27ADC2AFAD5AEF8D_OFFSET UNITYSDK_OFFSET(0x18E0A490)
#define RPG_GAMECORE_SETAUDIENCEGROUPVISIBLE_METHOD_3_532EBAF907C00B2C_OFFSET UNITYSDK_OFFSET(0x18E0A410)
#define RPG_GAMECORE_SETAUDIENCEGROUPVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E0A460)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetAudienceGroupVisible_TypeDefinitionIndex = 20731;
