...
#define RPG_GAMECORE_SETAUDIENCEGROUPVISIBLE_METHOD_3_27ADC2AFAD5AEF8D_OFFSET UNITYSDK_OFFSET(0x1D4E1630)
#define RPG_GAMECORE_SETAUDIENCEGROUPVISIBLE_METHOD_3_C884D7C71EBC15B6_OFFSET UNITYSDK_OFFSET(0x1D4E15F0)
#define RPG_GAMECORE_SETAUDIENCEGROUPVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4E1620)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetAudienceGroupVisible_TypeDefinitionIndex = 21633;
