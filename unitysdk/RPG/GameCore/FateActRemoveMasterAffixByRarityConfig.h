...
#define RPG_GAMECORE_FATEACTREMOVEMASTERAFFIXBYRARITYCONFIG_METHOD_6_13375462211A3FB1_OFFSET UNITYSDK_OFFSET(0x171C1E50)
#define RPG_GAMECORE_FATEACTREMOVEMASTERAFFIXBYRARITYCONFIG_METHOD_6_DBCBA06C2100A41A_OFFSET UNITYSDK_OFFSET(0x171C1FC0)
#define RPG_GAMECORE_FATEACTREMOVEMASTERAFFIXBYRARITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171C1F20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateActRemoveMasterAffixByRarityConfig_TypeDefinitionIndex = 17659;
