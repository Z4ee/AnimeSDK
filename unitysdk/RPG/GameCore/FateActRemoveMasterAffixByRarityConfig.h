...
#define RPG_GAMECORE_FATEACTREMOVEMASTERAFFIXBYRARITYCONFIG_METHOD_6_812F497EABECB6DE_OFFSET UNITYSDK_OFFSET(0x1E0CC3E0)
#define RPG_GAMECORE_FATEACTREMOVEMASTERAFFIXBYRARITYCONFIG_METHOD_6_DBCBA06C2100A41A_OFFSET UNITYSDK_OFFSET(0x1E0CC430)
#define RPG_GAMECORE_FATEACTREMOVEMASTERAFFIXBYRARITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0CC420)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateActRemoveMasterAffixByRarityConfig_TypeDefinitionIndex = 19004;
