...
#define RPG_GAMECORE_BYISROGUETOURNCOLLECTIONDISPLAYINGCOLLECTION_METHOD_4_57CD3F4096A9984C_OFFSET UNITYSDK_OFFSET(0x1B2A27D0)
#define RPG_GAMECORE_BYISROGUETOURNCOLLECTIONDISPLAYINGCOLLECTION_METHOD_4_7C1DDDDC6DF0F179_OFFSET UNITYSDK_OFFSET(0x1B2A2970)
#define RPG_GAMECORE_BYISROGUETOURNCOLLECTIONDISPLAYINGCOLLECTION_METHOD_4_B206CFB2F3AC9816_OFFSET UNITYSDK_OFFSET(0x1B2A29A0)
#define RPG_GAMECORE_BYISROGUETOURNCOLLECTIONDISPLAYINGCOLLECTION_METHOD_4_F965EFB2EEB76E25_OFFSET UNITYSDK_OFFSET(0x1B2A2790)
#define RPG_GAMECORE_BYISROGUETOURNCOLLECTIONDISPLAYINGCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2A27C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsRogueTournCollectionDisplayingCollection_TypeDefinitionIndex = 21306;
