...
#define RPG_GAMECORE_ELFSPECIALEVENTSELECTITEM_METHOD_2_30700088C3699C44_OFFSET UNITYSDK_OFFSET(0x1D05C5D0)
#define RPG_GAMECORE_ELFSPECIALEVENTSELECTITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D05C850)
