...
#define RPG_GAMECORE_CHIMERADUELCASTERSELECTORCONFIG_METHOD_3_B02329E566822932_OFFSET UNITYSDK_OFFSET(0x1CFC1020)
#define RPG_GAMECORE_CHIMERADUELCASTERSELECTORCONFIG_METHOD_3_E6E102FE41F5F8B3_OFFSET UNITYSDK_OFFSET(0x1CFC0F80)
#define RPG_GAMECORE_CHIMERADUELCASTERSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFC1010)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelCasterSelectorConfig_TypeDefinitionIndex = 15732;
