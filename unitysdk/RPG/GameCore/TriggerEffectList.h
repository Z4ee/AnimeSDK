...
#define RPG_GAMECORE_TRIGGEREFFECTLIST_METHOD_3_1F5179B55B236E33_OFFSET UNITYSDK_OFFSET(0x190C4310)
#define RPG_GAMECORE_TRIGGEREFFECTLIST_METHOD_3_ABDC0589660D8BCB_OFFSET UNITYSDK_OFFSET(0x190C44D0)
#define RPG_GAMECORE_TRIGGEREFFECTLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x190C44A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerEffectList_TypeDefinitionIndex = 19218;
