...
#define RPG_GAMECORE_RTSKILLPAUSETARGET_METHOD_3_17C8594A7A61EC6A_OFFSET UNITYSDK_OFFSET(0x18DD7240)
#define RPG_GAMECORE_RTSKILLPAUSETARGET_METHOD_3_96053E6B7BCC5DDC_OFFSET UNITYSDK_OFFSET(0x18DD72C0)
#define RPG_GAMECORE_RTSKILLPAUSETARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x18DD7290)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtSkillPauseTarget_TypeDefinitionIndex = 23224;
