...
#define RPG_GAMECORE_ST_MAIN_PATROL_METHOD_4_0365E8762EB6E05B_OFFSET UNITYSDK_OFFSET(0x17698110)
#define RPG_GAMECORE_ST_MAIN_PATROL_METHOD_4_B5FE9918C03B7B73_OFFSET UNITYSDK_OFFSET(0x17687CB0)
#define RPG_GAMECORE_ST_MAIN_PATROL__CTOR_OFFSET UNITYSDK_OFFSET(0x17687C50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_Patrol_TypeDefinitionIndex = 18383;
