...
#define RPG_GAMECORE_ST_MAIN_PATROL_METHOD_4_0365E8762EB6E05B_OFFSET UNITYSDK_OFFSET(0x18DF38A0)
#define RPG_GAMECORE_ST_MAIN_PATROL_METHOD_4_B5FE9918C03B7B73_OFFSET UNITYSDK_OFFSET(0x18DF3980)
#define RPG_GAMECORE_ST_MAIN_PATROL__CTOR_OFFSET UNITYSDK_OFFSET(0x18DF3920)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_Patrol_TypeDefinitionIndex = 19030;
