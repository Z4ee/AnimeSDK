...
#define RPG_GAMECORE_CHIMERADUELITEMGROUPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x187FD540)
#define RPG_GAMECORE_CHIMERADUELITEMGROUPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x187FD690)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelItemGroupRow_TypeDefinitionIndex = 10646;
