...
#define RPG_GAMECORE_UPDATETREASURECHALLENGEPROGRESS_METHOD_3_0DB01052B866BAD8_OFFSET UNITYSDK_OFFSET(0x190E6460)
#define RPG_GAMECORE_UPDATETREASURECHALLENGEPROGRESS_METHOD_3_FBB29ECEC90C3D80_OFFSET UNITYSDK_OFFSET(0x190E64E0)
#define RPG_GAMECORE_UPDATETREASURECHALLENGEPROGRESS__CTOR_OFFSET UNITYSDK_OFFSET(0x190E64B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UpdateTreasureChallengeProgress_TypeDefinitionIndex = 19425;
