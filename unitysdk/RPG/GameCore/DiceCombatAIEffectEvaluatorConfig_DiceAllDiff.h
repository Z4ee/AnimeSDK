...
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEALLDIFF_METHOD_3_2A7CDBA981A333B4_OFFSET UNITYSDK_OFFSET(0x18863B60)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEALLDIFF_METHOD_3_3A3ECA25A12F6E09_OFFSET UNITYSDK_OFFSET(0x18863100)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEALLDIFF__CTOR_OFFSET UNITYSDK_OFFSET(0x188630F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatAIEffectEvaluatorConfig_DiceAllDiff_TypeDefinitionIndex = 15345;
