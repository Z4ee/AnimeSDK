...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYFREEBUFFROLLCOUNTCONFIG_METHOD_3_27596E8D1AE38478_OFFSET UNITYSDK_OFFSET(0x18D40E20)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYFREEBUFFROLLCOUNTCONFIG_METHOD_3_FAC3D9A136EF9311_OFFSET UNITYSDK_OFFSET(0x18D40EF0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYFREEBUFFROLLCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D40EA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyFreeBuffRollCountConfig_TypeDefinitionIndex = 17065;
