...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYFREEBUFFROLLCOUNTCONFIG_METHOD_3_6EE65AB7FF075DAD_OFFSET UNITYSDK_OFFSET(0x1D163BE0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYFREEBUFFROLLCOUNTCONFIG_METHOD_3_FAC3D9A136EF9311_OFFSET UNITYSDK_OFFSET(0x1D163C30)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYFREEBUFFROLLCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D163C20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyFreeBuffRollCountConfig_TypeDefinitionIndex = 17240;
