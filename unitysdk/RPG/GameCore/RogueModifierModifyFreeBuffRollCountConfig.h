...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYFREEBUFFROLLCOUNTCONFIG_METHOD_3_6EE65AB7FF075DAD_OFFSET UNITYSDK_OFFSET(0x1EEFAB10)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYFREEBUFFROLLCOUNTCONFIG_METHOD_3_FAC3D9A136EF9311_OFFSET UNITYSDK_OFFSET(0x1EEFAB60)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYFREEBUFFROLLCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEFAB50)
