...
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEPROPERTYCOMPARERATIO_METHOD_3_2C8A785055FA93C6_OFFSET UNITYSDK_OFFSET(0x1966DFB0)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEPROPERTYCOMPARERATIO_METHOD_3_4C6835BF10A42C2F_OFFSET UNITYSDK_OFFSET(0x1966FEB0)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEPROPERTYCOMPARERATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x1966DF90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAISourcePropertyCompareRatio_TypeDefinitionIndex = 14754;
