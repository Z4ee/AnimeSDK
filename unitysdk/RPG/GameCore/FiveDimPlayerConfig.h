...
#define RPG_GAMECORE_FIVEDIMPLAYERCONFIG_METHOD_2_2A2A7E9AB7B7AC90_OFFSET UNITYSDK_OFFSET(0x1D0E7760)
#define RPG_GAMECORE_FIVEDIMPLAYERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0F8A80)
