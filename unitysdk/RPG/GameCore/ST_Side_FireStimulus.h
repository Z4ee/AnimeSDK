...
#define RPG_GAMECORE_ST_SIDE_FIRESTIMULUS_METHOD_4_5D669E80881B7CAD_OFFSET UNITYSDK_OFFSET(0x19C090F0)
#define RPG_GAMECORE_ST_SIDE_FIRESTIMULUS_METHOD_4_A34EEC92A7BBDFCA_OFFSET UNITYSDK_OFFSET(0x19C1A070)
#define RPG_GAMECORE_ST_SIDE_FIRESTIMULUS__CTOR_OFFSET UNITYSDK_OFFSET(0x19C090A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_FireStimulus_TypeDefinitionIndex = 19014;
