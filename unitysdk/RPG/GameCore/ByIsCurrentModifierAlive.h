...
#define RPG_GAMECORE_BYISCURRENTMODIFIERALIVE_METHOD_4_1639A75F9FA020E5_OFFSET UNITYSDK_OFFSET(0x1702B9F0)
#define RPG_GAMECORE_BYISCURRENTMODIFIERALIVE_METHOD_4_6D8C9DAC9F80C40F_OFFSET UNITYSDK_OFFSET(0x1702BAC0)
#define RPG_GAMECORE_BYISCURRENTMODIFIERALIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1702BA70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsCurrentModifierAlive_TypeDefinitionIndex = 21963;
