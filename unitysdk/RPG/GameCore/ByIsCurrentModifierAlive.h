...
#define RPG_GAMECORE_BYISCURRENTMODIFIERALIVE_METHOD_4_1639A75F9FA020E5_OFFSET UNITYSDK_OFFSET(0x18750510)
#define RPG_GAMECORE_BYISCURRENTMODIFIERALIVE_METHOD_4_6D8C9DAC9F80C40F_OFFSET UNITYSDK_OFFSET(0x187505E0)
#define RPG_GAMECORE_BYISCURRENTMODIFIERALIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x18750590)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsCurrentModifierAlive_TypeDefinitionIndex = 22703;
