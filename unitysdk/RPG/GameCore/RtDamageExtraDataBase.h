...
#define RPG_GAMECORE_RTDAMAGEEXTRADATABASE_METHOD_2_7472E53B74CDDBC5_OFFSET UNITYSDK_OFFSET(0x1CCE3EF0)
#define RPG_GAMECORE_RTDAMAGEEXTRADATABASE_METHOD_2_EE74DBF244932ED3_OFFSET UNITYSDK_OFFSET(0x1CCD5190)
#define RPG_GAMECORE_RTDAMAGEEXTRADATABASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CCD7C90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtDamageExtraDataBase_TypeDefinitionIndex = 23886;
