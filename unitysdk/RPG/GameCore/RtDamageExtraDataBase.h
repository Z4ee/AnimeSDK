...
#define RPG_GAMECORE_RTDAMAGEEXTRADATABASE_METHOD_2_7472E53B74CDDBC5_OFFSET UNITYSDK_OFFSET(0x1B75F3E0)
#define RPG_GAMECORE_RTDAMAGEEXTRADATABASE_METHOD_2_EE74DBF244932ED3_OFFSET UNITYSDK_OFFSET(0x1B75F1C0)
#define RPG_GAMECORE_RTDAMAGEEXTRADATABASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B75F3D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtDamageExtraDataBase_TypeDefinitionIndex = 23306;
