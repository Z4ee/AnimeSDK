...
#define RPG_GAMECORE_ENABLEDYNAMICSKILLTARGETSELECTION_METHOD_3_5A99AF677CAD831D_OFFSET UNITYSDK_OFFSET(0x196E3690)
#define RPG_GAMECORE_ENABLEDYNAMICSKILLTARGETSELECTION_METHOD_3_9DDD37DC09AC858C_OFFSET UNITYSDK_OFFSET(0x196E3710)
#define RPG_GAMECORE_ENABLEDYNAMICSKILLTARGETSELECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x196E36E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnableDynamicSkillTargetSelection_TypeDefinitionIndex = 21596;
