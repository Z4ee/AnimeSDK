...
#define RPG_GAMECORE_ENABLEDYNAMICSKILLTARGETSELECTION_METHOD_3_7ACBCB4E8A5B6C47_OFFSET UNITYSDK_OFFSET(0x1BB3F880)
#define RPG_GAMECORE_ENABLEDYNAMICSKILLTARGETSELECTION_METHOD_3_9DDD37DC09AC858C_OFFSET UNITYSDK_OFFSET(0x1BB3F8C0)
#define RPG_GAMECORE_ENABLEDYNAMICSKILLTARGETSELECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB3F8B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnableDynamicSkillTargetSelection_TypeDefinitionIndex = 22018;
