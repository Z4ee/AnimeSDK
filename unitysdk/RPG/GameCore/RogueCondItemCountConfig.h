...
#define RPG_GAMECORE_ROGUECONDITEMCOUNTCONFIG_METHOD_6_095363C684CFACF0_OFFSET UNITYSDK_OFFSET(0x19B1C250)
#define RPG_GAMECORE_ROGUECONDITEMCOUNTCONFIG_METHOD_6_3BAD16FDAD655BC6_OFFSET UNITYSDK_OFFSET(0x19B1C500)
#define RPG_GAMECORE_ROGUECONDITEMCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B1C3D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueCondItemCountConfig_TypeDefinitionIndex = 18752;
