...
#define RPG_GAMECORE_ROGUECONDITEMCOUNTCONFIG_METHOD_6_2EF4D9D217C6016A_OFFSET UNITYSDK_OFFSET(0x1C4AEB80)
#define RPG_GAMECORE_ROGUECONDITEMCOUNTCONFIG_METHOD_6_3BAD16FDAD655BC6_OFFSET UNITYSDK_OFFSET(0x1C4AEBD0)
#define RPG_GAMECORE_ROGUECONDITEMCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4AEBC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueCondItemCountConfig_TypeDefinitionIndex = 19031;
