...
#define RPG_GAMECORE_BYISFAKESKILLBYSLOT_METHOD_4_13B6F3EC088C36E7_OFFSET UNITYSDK_OFFSET(0x1A8E25A0)
#define RPG_GAMECORE_BYISFAKESKILLBYSLOT_METHOD_4_58CE9E08386CAC9E_OFFSET UNITYSDK_OFFSET(0x1A8E2640)
#define RPG_GAMECORE_BYISFAKESKILLBYSLOT_METHOD_4_77468DF4D5F85467_OFFSET UNITYSDK_OFFSET(0x1A8E2810)
#define RPG_GAMECORE_BYISFAKESKILLBYSLOT_METHOD_4_C3F5F32C68AD4EC6_OFFSET UNITYSDK_OFFSET(0x1A8E2870)
#define RPG_GAMECORE_BYISFAKESKILLBYSLOT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8E2600)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsFakeSkillBySlot_TypeDefinitionIndex = 22181;
