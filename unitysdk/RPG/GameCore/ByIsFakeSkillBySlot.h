...
#define RPG_GAMECORE_BYISFAKESKILLBYSLOT_METHOD_4_58CE9E08386CAC9E_OFFSET UNITYSDK_OFFSET(0x18752D20)
#define RPG_GAMECORE_BYISFAKESKILLBYSLOT_METHOD_4_F2A550FEA8A978E9_OFFSET UNITYSDK_OFFSET(0x18752C00)
#define RPG_GAMECORE_BYISFAKESKILLBYSLOT__CTOR_OFFSET UNITYSDK_OFFSET(0x18752CA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsFakeSkillBySlot_TypeDefinitionIndex = 21932;
