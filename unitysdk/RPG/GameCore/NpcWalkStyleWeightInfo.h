...
#define RPG_GAMECORE_NPCWALKSTYLEWEIGHTINFO_METHOD_2_D1A8F1370253D8F3_OFFSET UNITYSDK_OFFSET(0x1BAFE190)
#define RPG_GAMECORE_NPCWALKSTYLEWEIGHTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAFE330)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NpcWalkStyleWeightInfo_TypeDefinitionIndex = 16238;
