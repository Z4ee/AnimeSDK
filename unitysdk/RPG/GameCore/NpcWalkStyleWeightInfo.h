...
#define RPG_GAMECORE_NPCWALKSTYLEWEIGHTINFO_METHOD_2_CB63EBF37B56651E_OFFSET UNITYSDK_OFFSET(0x18BC25F0)
#define RPG_GAMECORE_NPCWALKSTYLEWEIGHTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18BC2790)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NpcWalkStyleWeightInfo_TypeDefinitionIndex = 16004;
