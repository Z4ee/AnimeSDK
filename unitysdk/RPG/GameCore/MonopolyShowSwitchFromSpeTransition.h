...
#define RPG_GAMECORE_MONOPOLYSHOWSWITCHFROMSPETRANSITION_METHOD_3_3A1E1FB147398812_OFFSET UNITYSDK_OFFSET(0x174483F0)
#define RPG_GAMECORE_MONOPOLYSHOWSWITCHFROMSPETRANSITION_METHOD_3_4330D79E6ECABBA6_OFFSET UNITYSDK_OFFSET(0x174482E0)
#define RPG_GAMECORE_MONOPOLYSHOWSWITCHFROMSPETRANSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x174483C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonopolyShowSwitchFromSpeTransition_TypeDefinitionIndex = 19269;
