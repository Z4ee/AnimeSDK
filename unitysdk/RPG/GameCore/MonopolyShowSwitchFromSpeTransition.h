...
#define RPG_GAMECORE_MONOPOLYSHOWSWITCHFROMSPETRANSITION_METHOD_3_3A1E1FB147398812_OFFSET UNITYSDK_OFFSET(0x199A4C70)
#define RPG_GAMECORE_MONOPOLYSHOWSWITCHFROMSPETRANSITION_METHOD_3_4330D79E6ECABBA6_OFFSET UNITYSDK_OFFSET(0x199A4B60)
#define RPG_GAMECORE_MONOPOLYSHOWSWITCHFROMSPETRANSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x199A4C40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonopolyShowSwitchFromSpeTransition_TypeDefinitionIndex = 19791;
