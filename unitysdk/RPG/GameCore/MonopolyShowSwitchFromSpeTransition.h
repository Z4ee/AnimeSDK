...
#define RPG_GAMECORE_MONOPOLYSHOWSWITCHFROMSPETRANSITION_METHOD_3_3A1E1FB147398812_OFFSET UNITYSDK_OFFSET(0x1B1C10E0)
#define RPG_GAMECORE_MONOPOLYSHOWSWITCHFROMSPETRANSITION_METHOD_3_C186A7107631C28F_OFFSET UNITYSDK_OFFSET(0x1B1C1010)
#define RPG_GAMECORE_MONOPOLYSHOWSWITCHFROMSPETRANSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1C10D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonopolyShowSwitchFromSpeTransition_TypeDefinitionIndex = 20151;
