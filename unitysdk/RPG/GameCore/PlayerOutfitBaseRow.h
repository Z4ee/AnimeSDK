...
#define RPG_GAMECORE_PLAYEROUTFITBASEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19A38680)
#define RPG_GAMECORE_PLAYEROUTFITBASEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19A387D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayerOutfitBaseRow_TypeDefinitionIndex = 13778;
