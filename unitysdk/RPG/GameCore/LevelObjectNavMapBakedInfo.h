...
#define RPG_GAMECORE_LEVELOBJECTNAVMAPBAKEDINFO_METHOD_2_139CA547CB6E6FA6_OFFSET UNITYSDK_OFFSET(0x17333DD0)
#define RPG_GAMECORE_LEVELOBJECTNAVMAPBAKEDINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x17344F80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelObjectNavMapBakedInfo_TypeDefinitionIndex = 15726;
