...
#define RPG_GAMECORE_LEVELOBJECTNAVMAPBAKEDINFO_METHOD_2_139CA547CB6E6FA6_OFFSET UNITYSDK_OFFSET(0x19872950)
#define RPG_GAMECORE_LEVELOBJECTNAVMAPBAKEDINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19881770)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelObjectNavMapBakedInfo_TypeDefinitionIndex = 16286;
