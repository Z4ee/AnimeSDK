...
#define RPG_GAMECORE_FATEPARAMRANDOMGETMASTERAVATARIDCONFIG_METHOD_6_A206AFDA1B47728C_OFFSET UNITYSDK_OFFSET(0x1BA75160)
#define RPG_GAMECORE_FATEPARAMRANDOMGETMASTERAVATARIDCONFIG_METHOD_6_F156EBB625BDCA10_OFFSET UNITYSDK_OFFSET(0x1BA75110)
#define RPG_GAMECORE_FATEPARAMRANDOMGETMASTERAVATARIDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA75150)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateParamRandomGetMasterAvatarIDConfig_TypeDefinitionIndex = 15980;
