...
#define RPG_GAMECORE_GRIDFIGHTWAVEINFO_METHOD_2_3E304D6651B070EB_OFFSET UNITYSDK_OFFSET(0x1728B0C0)
#define RPG_GAMECORE_GRIDFIGHTWAVEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1728B1E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightWaveInfo_TypeDefinitionIndex = 16663;
