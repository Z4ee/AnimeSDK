...
#define RPG_GAMECORE_GRIDFIGHTWAVEINFO_METHOD_2_3E304D6651B070EB_OFFSET UNITYSDK_OFFSET(0x1D16F030)
#define RPG_GAMECORE_GRIDFIGHTWAVEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D16F150)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightWaveInfo_TypeDefinitionIndex = 17951;
