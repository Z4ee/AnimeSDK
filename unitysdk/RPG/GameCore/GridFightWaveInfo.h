...
#define RPG_GAMECORE_GRIDFIGHTWAVEINFO_METHOD_2_3E304D6651B070EB_OFFSET UNITYSDK_OFFSET(0x19812770)
#define RPG_GAMECORE_GRIDFIGHTWAVEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19812890)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightWaveInfo_TypeDefinitionIndex = 17263;
