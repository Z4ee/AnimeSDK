...
#define RPG_GAMECORE_PROJECTILECURVE__CTOR_OFFSET UNITYSDK_OFFSET(0xB708D50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ProjectileCurve_TypeDefinitionIndex = 50513;
