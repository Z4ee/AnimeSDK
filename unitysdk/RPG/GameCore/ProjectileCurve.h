...
#define RPG_GAMECORE_PROJECTILECURVE__CTOR_OFFSET UNITYSDK_OFFSET(0xAA08E50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ProjectileCurve_TypeDefinitionIndex = 43814;
