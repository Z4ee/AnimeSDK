...
#define RPG_GAMECORE_LOCKCURRENTTELEPORTACTION_METHOD_3_1B997A84F0FF4996_OFFSET UNITYSDK_OFFSET(0x1D20FD80)
#define RPG_GAMECORE_LOCKCURRENTTELEPORTACTION_METHOD_3_EDE4EE10DAAD0DCB_OFFSET UNITYSDK_OFFSET(0x1D20FD40)
#define RPG_GAMECORE_LOCKCURRENTTELEPORTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D20FD70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LockCurrentTeleportAction_TypeDefinitionIndex = 21417;
