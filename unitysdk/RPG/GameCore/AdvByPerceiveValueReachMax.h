...
#define RPG_GAMECORE_ADVBYPERCEIVEVALUEREACHMAX_METHOD_4_4973DD6361DBF5FF_OFFSET UNITYSDK_OFFSET(0x1D6B0410)
#define RPG_GAMECORE_ADVBYPERCEIVEVALUEREACHMAX_METHOD_4_C78233E445EC5DCF_OFFSET UNITYSDK_OFFSET(0x1D6B05C0)
#define RPG_GAMECORE_ADVBYPERCEIVEVALUEREACHMAX_METHOD_4_D218A8688DA7467A_OFFSET UNITYSDK_OFFSET(0x1D6B0590)
#define RPG_GAMECORE_ADVBYPERCEIVEVALUEREACHMAX_METHOD_4_D84731B050BC72A4_OFFSET UNITYSDK_OFFSET(0x1D6B0450)
#define RPG_GAMECORE_ADVBYPERCEIVEVALUEREACHMAX__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6B0440)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvByPerceiveValueReachMax_TypeDefinitionIndex = 19786;
