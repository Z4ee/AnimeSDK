...
#define RPG_GAMECORE_ADVBYPERCEIVEVALUEREACHMAX_METHOD_4_B9F197A604D8E4CE_OFFSET UNITYSDK_OFFSET(0x186499D0)
#define RPG_GAMECORE_ADVBYPERCEIVEVALUEREACHMAX_METHOD_4_D84731B050BC72A4_OFFSET UNITYSDK_OFFSET(0x18649AA0)
#define RPG_GAMECORE_ADVBYPERCEIVEVALUEREACHMAX__CTOR_OFFSET UNITYSDK_OFFSET(0x18649A50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvByPerceiveValueReachMax_TypeDefinitionIndex = 18941;
