...
#define RPG_GAMECORE_TRAINPARTYEVENTCHARACTERTRIGGEREMOTION_METHOD_3_5575D9705FBB5FA4_OFFSET UNITYSDK_OFFSET(0x1C160060)
#define RPG_GAMECORE_TRAINPARTYEVENTCHARACTERTRIGGEREMOTION_METHOD_3_E7B9AEC0C074F591_OFFSET UNITYSDK_OFFSET(0x1C160020)
#define RPG_GAMECORE_TRAINPARTYEVENTCHARACTERTRIGGEREMOTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C160050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyEventCharacterTriggerEmotion_TypeDefinitionIndex = 21557;
