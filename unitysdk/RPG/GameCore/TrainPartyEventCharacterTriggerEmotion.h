...
#define RPG_GAMECORE_TRAINPARTYEVENTCHARACTERTRIGGEREMOTION_METHOD_3_5575D9705FBB5FA4_OFFSET UNITYSDK_OFFSET(0x19DF4F40)
#define RPG_GAMECORE_TRAINPARTYEVENTCHARACTERTRIGGEREMOTION_METHOD_3_F2D5EF23CAE0DB33_OFFSET UNITYSDK_OFFSET(0x19DF4EC0)
#define RPG_GAMECORE_TRAINPARTYEVENTCHARACTERTRIGGEREMOTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19DF4F10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyEventCharacterTriggerEmotion_TypeDefinitionIndex = 21142;
