...
#define RPG_GAMECORE_ROGUETOURNBUILDREFAVATARROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17660610)
#define RPG_GAMECORE_ROGUETOURNBUILDREFAVATARROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17660BD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournBuildRefAvatarRow_TypeDefinitionIndex = 13734;
