...
#define RPG_GAMECORE_FINDCHESTFUNCDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x188E3F50)
#define RPG_GAMECORE_FINDCHESTFUNCDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x188E4890)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FindChestFuncDataRow_TypeDefinitionIndex = 12567;

	class FindChestFuncDataRow : public ::System::Object
	{
	public:
		::Il2CppArray<::RPG::GameCore::ChestType>* ChestTypeList; // 0x10
		::Il2CppArray<::System::UInt32>* TriggerParamList; // 0x18
		::Il2CppArray<::RPG::GameCore::GameModeType>* GameModeList; // 0x20
