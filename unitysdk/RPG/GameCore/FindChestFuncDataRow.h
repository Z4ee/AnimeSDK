...
#define RPG_GAMECORE_FINDCHESTFUNCDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D09A080)
#define RPG_GAMECORE_FINDCHESTFUNCDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D09A940)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 SpecialMappinginfo; // 0x3C
		::System::UInt32 FindNum; // 0x40
		::RPG::GameCore::FindChestTriggerType TriggerType; // 0x44
		::System::UInt32 FindRange; // 0x48
