...
#define RPG_GAMECORE_FATEMODIFIERADDTRAITCOUNTBYDEFEATFIXEDENEMYCONFIG_METHOD_3_13758E790D459274_OFFSET UNITYSDK_OFFSET(0x188D3100)
#define RPG_GAMECORE_FATEMODIFIERADDTRAITCOUNTBYDEFEATFIXEDENEMYCONFIG_METHOD_3_7F577D910E157BBD_OFFSET UNITYSDK_OFFSET(0x188D3030)
#define RPG_GAMECORE_FATEMODIFIERADDTRAITCOUNTBYDEFEATFIXEDENEMYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x188D30B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateModifierAddTraitCountByDefeatFixedEnemyConfig_TypeDefinitionIndex = 18324;
