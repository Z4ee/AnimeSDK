...
#define RPG_GAMECORE_BYHAVEENEMYALIVE_METHOD_4_21CCC867EB8455E2_OFFSET UNITYSDK_OFFSET(0x1BBE5940)
#define RPG_GAMECORE_BYHAVEENEMYALIVE_METHOD_4_432414A555F8EAEC_OFFSET UNITYSDK_OFFSET(0x1BBE5970)
#define RPG_GAMECORE_BYHAVEENEMYALIVE_METHOD_4_816E012B27BC0810_OFFSET UNITYSDK_OFFSET(0x1BBE5700)
#define RPG_GAMECORE_BYHAVEENEMYALIVE_METHOD_4_9FF5C1DF8303BC75_OFFSET UNITYSDK_OFFSET(0x1BBE56C0)
#define RPG_GAMECORE_BYHAVEENEMYALIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBE56F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByHaveEnemyAlive_TypeDefinitionIndex = 22297;
