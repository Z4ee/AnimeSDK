...
#define RPG_GAMECORE_BYHAVEENEMYALIVE_METHOD_4_816E012B27BC0810_OFFSET UNITYSDK_OFFSET(0x17026440)
#define RPG_GAMECORE_BYHAVEENEMYALIVE_METHOD_4_AF22D60B0F714418_OFFSET UNITYSDK_OFFSET(0x17026370)
#define RPG_GAMECORE_BYHAVEENEMYALIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x170263F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByHaveEnemyAlive_TypeDefinitionIndex = 20729;
