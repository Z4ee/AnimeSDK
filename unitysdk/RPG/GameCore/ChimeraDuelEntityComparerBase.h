...
#define RPG_GAMECORE_CHIMERADUELENTITYCOMPARERBASE_METHOD_3_2F2752BFA6007FBF_OFFSET UNITYSDK_OFFSET(0x187FA220)
#define RPG_GAMECORE_CHIMERADUELENTITYCOMPARERBASE_METHOD_3_E078793C714C45E9_OFFSET UNITYSDK_OFFSET(0x187FA3A0)
#define RPG_GAMECORE_CHIMERADUELENTITYCOMPARERBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x187F9F90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelEntityComparerBase_TypeDefinitionIndex = 15093;
