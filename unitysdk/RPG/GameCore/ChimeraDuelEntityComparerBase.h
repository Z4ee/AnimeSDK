...
#define RPG_GAMECORE_CHIMERADUELENTITYCOMPARERBASE_METHOD_3_1CB47FDFD9AF01FC_OFFSET UNITYSDK_OFFSET(0x1C23DBD0)
#define RPG_GAMECORE_CHIMERADUELENTITYCOMPARERBASE_METHOD_3_E078793C714C45E9_OFFSET UNITYSDK_OFFSET(0x1C23DED0)
#define RPG_GAMECORE_CHIMERADUELENTITYCOMPARERBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C23DF90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelEntityComparerBase_TypeDefinitionIndex = 15320;
