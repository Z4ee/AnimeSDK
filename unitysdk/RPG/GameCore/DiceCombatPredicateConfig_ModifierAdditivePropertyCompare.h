...
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_MODIFIERADDITIVEPROPERTYCOMPARE_METHOD_4_D791F9D29A3E9400_OFFSET UNITYSDK_OFFSET(0x1D0335C0)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_MODIFIERADDITIVEPROPERTYCOMPARE_METHOD_4_DF2635F350763040_OFFSET UNITYSDK_OFFSET(0x1D032530)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_MODIFIERADDITIVEPROPERTYCOMPARE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D032520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatPredicateConfig_ModifierAdditivePropertyCompare_TypeDefinitionIndex = 15917;
