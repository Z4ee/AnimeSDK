...
#define RPG_GAMECORE_ST_BYCOMPAREVARIABLEFLOAT_METHOD_4_9BCC1CA0A340D91E_OFFSET UNITYSDK_OFFSET(0x17691A70)
#define RPG_GAMECORE_ST_BYCOMPAREVARIABLEFLOAT_METHOD_4_BF2D544D8DF8DE2C_OFFSET UNITYSDK_OFFSET(0x176919A0)
#define RPG_GAMECORE_ST_BYCOMPAREVARIABLEFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x17691A20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_ByCompareVariableFloat_TypeDefinitionIndex = 18349;
