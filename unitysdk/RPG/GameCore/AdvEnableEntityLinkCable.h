...
#define RPG_GAMECORE_ADVENABLEENTITYLINKCABLE_METHOD_3_20537F954DE51328_OFFSET UNITYSDK_OFFSET(0x16F2BB80)
#define RPG_GAMECORE_ADVENABLEENTITYLINKCABLE_METHOD_3_77623C071185D79E_OFFSET UNITYSDK_OFFSET(0x16F2BB00)
#define RPG_GAMECORE_ADVENABLEENTITYLINKCABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F2BB50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvEnableEntityLinkCable_TypeDefinitionIndex = 19979;
