...
#define RPG_GAMECORE_ADVENABLEENTITYLINKCABLE_METHOD_3_20537F954DE51328_OFFSET UNITYSDK_OFFSET(0x1864DD50)
#define RPG_GAMECORE_ADVENABLEENTITYLINKCABLE_METHOD_3_77623C071185D79E_OFFSET UNITYSDK_OFFSET(0x1864DCD0)
#define RPG_GAMECORE_ADVENABLEENTITYLINKCABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1864DD20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvEnableEntityLinkCable_TypeDefinitionIndex = 20660;
