...
#define RPG_GAMECORE_SHOWWORLDSHOP_METHOD_3_10E6634EAB57D6D4_OFFSET UNITYSDK_OFFSET(0x18E6BA90)
#define RPG_GAMECORE_SHOWWORLDSHOP_METHOD_3_BE8191741A29BB63_OFFSET UNITYSDK_OFFSET(0x18E6BB10)
#define RPG_GAMECORE_SHOWWORLDSHOP__CTOR_OFFSET UNITYSDK_OFFSET(0x18E6BAE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowWorldShop_TypeDefinitionIndex = 19886;
