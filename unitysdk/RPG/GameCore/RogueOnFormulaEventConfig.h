...
#define RPG_GAMECORE_ROGUEONFORMULAEVENTCONFIG_METHOD_2_939FBC75BD5E608B_OFFSET UNITYSDK_OFFSET(0x1D40C540)
#define RPG_GAMECORE_ROGUEONFORMULAEVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D40C580)
