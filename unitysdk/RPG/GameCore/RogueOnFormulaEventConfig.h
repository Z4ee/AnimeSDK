...
#define RPG_GAMECORE_ROGUEONFORMULAEVENTCONFIG_METHOD_2_939FBC75BD5E608B_OFFSET UNITYSDK_OFFSET(0x19BACDB0)
#define RPG_GAMECORE_ROGUEONFORMULAEVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19BACDF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueOnFormulaEventConfig_TypeDefinitionIndex = 16910;
