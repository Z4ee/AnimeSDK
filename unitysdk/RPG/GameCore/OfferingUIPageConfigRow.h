...
#define RPG_GAMECORE_OFFERINGUIPAGECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17479F70)
#define RPG_GAMECORE_OFFERINGUIPAGECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1747A450)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OfferingUIPageConfigRow_TypeDefinitionIndex = 13094;

	class OfferingUIPageConfigRow : public ::System::Object
	{
	public:
		::System::UInt32 ID; // 0x10
		::RPG::Client::TextID SubmitBtnName; // 0x18
		::RPG::Client::TextID LongTailDesc; // 0x28
		::RPG::Client::TextID MaxTip; // 0x38
		::RPG::Client::TextID Name; // 0x48
		::RPG::Client::TextID CostTitle; // 0x58
