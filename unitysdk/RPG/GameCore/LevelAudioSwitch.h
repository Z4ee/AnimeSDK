...
#define RPG_GAMECORE_LEVELAUDIOSWITCH_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1986E030)
#define RPG_GAMECORE_LEVELAUDIOSWITCH_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1986DFB0)
#define RPG_GAMECORE_LEVELAUDIOSWITCH__CTOR_OFFSET UNITYSDK_OFFSET(0x1986E000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelAudioSwitch_TypeDefinitionIndex = 21280;
