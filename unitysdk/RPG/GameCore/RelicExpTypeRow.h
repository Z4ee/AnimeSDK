...
#define RPG_GAMECORE_RELICEXPTYPEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1DB857B0)
#define RPG_GAMECORE_RELICEXPTYPEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB85E10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RelicExpTypeRow_TypeDefinitionIndex = 14477;
