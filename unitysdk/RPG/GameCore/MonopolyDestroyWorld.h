...
#define RPG_GAMECORE_MONOPOLYDESTROYWORLD_METHOD_3_1B35D7A7DAF5F96D_OFFSET UNITYSDK_OFFSET(0x1D1C1B80)
#define RPG_GAMECORE_MONOPOLYDESTROYWORLD_METHOD_3_3E92E766875B9030_OFFSET UNITYSDK_OFFSET(0x1D1C1C50)
#define RPG_GAMECORE_MONOPOLYDESTROYWORLD__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1C1C40)
