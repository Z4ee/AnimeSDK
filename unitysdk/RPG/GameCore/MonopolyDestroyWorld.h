...
#define RPG_GAMECORE_MONOPOLYDESTROYWORLD_METHOD_3_1965D702B5318CE4_OFFSET UNITYSDK_OFFSET(0x1995C640)
#define RPG_GAMECORE_MONOPOLYDESTROYWORLD_METHOD_3_3E92E766875B9030_OFFSET UNITYSDK_OFFSET(0x1995C750)
#define RPG_GAMECORE_MONOPOLYDESTROYWORLD__CTOR_OFFSET UNITYSDK_OFFSET(0x1995C720)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonopolyDestroyWorld_TypeDefinitionIndex = 19785;
