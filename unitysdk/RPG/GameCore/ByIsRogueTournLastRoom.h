...
#define RPG_GAMECORE_BYISROGUETOURNLASTROOM_METHOD_4_45298A96A4780C0D_OFFSET UNITYSDK_OFFSET(0x18756CA0)
#define RPG_GAMECORE_BYISROGUETOURNLASTROOM_METHOD_4_C90D4D370D8EBA67_OFFSET UNITYSDK_OFFSET(0x18756D70)
#define RPG_GAMECORE_BYISROGUETOURNLASTROOM__CTOR_OFFSET UNITYSDK_OFFSET(0x18756D20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsRogueTournLastRoom_TypeDefinitionIndex = 20985;
