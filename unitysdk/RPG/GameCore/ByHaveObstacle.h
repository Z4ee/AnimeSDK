...
#define RPG_GAMECORE_BYHAVEOBSTACLE_METHOD_4_3A1CE2DF91184804_OFFSET UNITYSDK_OFFSET(0x1874B740)
#define RPG_GAMECORE_BYHAVEOBSTACLE_METHOD_4_757A738AF90CC374_OFFSET UNITYSDK_OFFSET(0x1874B670)
#define RPG_GAMECORE_BYHAVEOBSTACLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1874B6F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByHaveObstacle_TypeDefinitionIndex = 18957;
