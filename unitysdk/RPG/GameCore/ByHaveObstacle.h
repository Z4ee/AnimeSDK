...
#define RPG_GAMECORE_BYHAVEOBSTACLE_METHOD_4_27B2FC9789CFE512_OFFSET UNITYSDK_OFFSET(0x1A8CEFC0)
#define RPG_GAMECORE_BYHAVEOBSTACLE_METHOD_4_3A1CE2DF91184804_OFFSET UNITYSDK_OFFSET(0x1A8CEE00)
#define RPG_GAMECORE_BYHAVEOBSTACLE_METHOD_4_4A240770F08CCC41_OFFSET UNITYSDK_OFFSET(0x1A8CEDC0)
#define RPG_GAMECORE_BYHAVEOBSTACLE_METHOD_4_AD987135B536CB9C_OFFSET UNITYSDK_OFFSET(0x1A8CEFF0)
#define RPG_GAMECORE_BYHAVEOBSTACLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8CEDF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByHaveObstacle_TypeDefinitionIndex = 19261;
