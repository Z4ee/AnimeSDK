...
#define RPG_GAMECORE_STAGEINVASIONCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CAE60A0)
#define RPG_GAMECORE_STAGEINVASIONCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CAE6230)
