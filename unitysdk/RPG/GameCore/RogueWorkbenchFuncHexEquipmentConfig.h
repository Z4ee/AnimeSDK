...
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCHEXEQUIPMENTCONFIG_METHOD_3_A0E5AE9E8E07BC43_OFFSET UNITYSDK_OFFSET(0x1CCD0620)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCHEXEQUIPMENTCONFIG_METHOD_3_DD1B748DBAA0AFC7_OFFSET UNITYSDK_OFFSET(0x1CCD0400)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCHEXEQUIPMENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CCD03F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueWorkbenchFuncHexEquipmentConfig_TypeDefinitionIndex = 17823;
