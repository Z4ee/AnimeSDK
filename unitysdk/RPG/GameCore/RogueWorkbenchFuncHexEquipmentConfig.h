...
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCHEXEQUIPMENTCONFIG_METHOD_3_A0E5AE9E8E07BC43_OFFSET UNITYSDK_OFFSET(0x1BB822E0)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCHEXEQUIPMENTCONFIG_METHOD_3_DD1B748DBAA0AFC7_OFFSET UNITYSDK_OFFSET(0x1BB820C0)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCHEXEQUIPMENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB820B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueWorkbenchFuncHexEquipmentConfig_TypeDefinitionIndex = 17306;
