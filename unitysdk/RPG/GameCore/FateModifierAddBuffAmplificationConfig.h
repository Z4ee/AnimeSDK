...
#define RPG_GAMECORE_FATEMODIFIERADDBUFFAMPLIFICATIONCONFIG_METHOD_3_65C9A4EF76164183_OFFSET UNITYSDK_OFFSET(0x188D2D80)
#define RPG_GAMECORE_FATEMODIFIERADDBUFFAMPLIFICATIONCONFIG_METHOD_3_ABAC587DF70508BA_OFFSET UNITYSDK_OFFSET(0x188D2E50)
#define RPG_GAMECORE_FATEMODIFIERADDBUFFAMPLIFICATIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x188D2E00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateModifierAddBuffAmplificationConfig_TypeDefinitionIndex = 18310;
