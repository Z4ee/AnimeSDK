...
#define RPG_GAMECORE_FATEMODIFIERADDBUFFAMPLIFICATIONCONFIG_METHOD_3_65C9A4EF76164183_OFFSET UNITYSDK_OFFSET(0x1970FE50)
#define RPG_GAMECORE_FATEMODIFIERADDBUFFAMPLIFICATIONCONFIG_METHOD_3_ABAC587DF70508BA_OFFSET UNITYSDK_OFFSET(0x1970FF20)
#define RPG_GAMECORE_FATEMODIFIERADDBUFFAMPLIFICATIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1970FED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateModifierAddBuffAmplificationConfig_TypeDefinitionIndex = 18282;
