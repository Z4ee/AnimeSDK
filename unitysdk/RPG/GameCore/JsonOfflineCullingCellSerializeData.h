...
#define RPG_GAMECORE_JSONOFFLINECULLINGCELLSERIALIZEDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D1C6400)
#define RPG_GAMECORE_JSONOFFLINECULLINGCELLSERIALIZEDATA_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1D1C6330)
#define RPG_GAMECORE_JSONOFFLINECULLINGCELLSERIALIZEDATA_METHOD_2_2FD3A9739073CBA2_OFFSET UNITYSDK_OFFSET(0x1D1C69E0)
#define RPG_GAMECORE_JSONOFFLINECULLINGCELLSERIALIZEDATA_METHOD_2_D1A606803BE80A89_OFFSET UNITYSDK_OFFSET(0x1D1C6880)
#define RPG_GAMECORE_JSONOFFLINECULLINGCELLSERIALIZEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1C6870)
