...
#define RPG_GAMECORE_JSONOFFLINECULLINGCELLSERIALIZEDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1732B070)
#define RPG_GAMECORE_JSONOFFLINECULLINGCELLSERIALIZEDATA_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1732B000)
#define RPG_GAMECORE_JSONOFFLINECULLINGCELLSERIALIZEDATA_METHOD_2_4EC84823BC0B4E8D_OFFSET UNITYSDK_OFFSET(0x1732B640)
#define RPG_GAMECORE_JSONOFFLINECULLINGCELLSERIALIZEDATA_METHOD_2_F411F0A48FC9EDBE_OFFSET UNITYSDK_OFFSET(0x1732B4F0)
#define RPG_GAMECORE_JSONOFFLINECULLINGCELLSERIALIZEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1732B4E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int JsonOfflineCullingCellSerializeData_TypeDefinitionIndex = 16774;
