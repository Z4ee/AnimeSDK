...
#define RPG_GAMECORE_JSONOFFLINECULLINGCELLSERIALIZEDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19869F80)
#define RPG_GAMECORE_JSONOFFLINECULLINGCELLSERIALIZEDATA_FINALIZE_OFFSET UNITYSDK_OFFSET(0x19869F10)
#define RPG_GAMECORE_JSONOFFLINECULLINGCELLSERIALIZEDATA_METHOD_2_2FD3A9739073CBA2_OFFSET UNITYSDK_OFFSET(0x1986A6A0)
#define RPG_GAMECORE_JSONOFFLINECULLINGCELLSERIALIZEDATA_METHOD_2_D1A606803BE80A89_OFFSET UNITYSDK_OFFSET(0x1986A540)
#define RPG_GAMECORE_JSONOFFLINECULLINGCELLSERIALIZEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1986A530)

namespace RPG::GameCore
{
	inline static constexpr unsigned int JsonOfflineCullingCellSerializeData_TypeDefinitionIndex = 17373;
