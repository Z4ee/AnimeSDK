...
#define RPG_GAMECORE_SO_SENDMESSAGE_METHOD_4_DB61BFF33571926C_OFFSET UNITYSDK_OFFSET(0x1DB2FDA0)
#define RPG_GAMECORE_SO_SENDMESSAGE_METHOD_4_FE35FABD832CA2A7_OFFSET UNITYSDK_OFFSET(0x1DB2F760)
#define RPG_GAMECORE_SO_SENDMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB2F750)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SO_SendMessage_TypeDefinitionIndex = 19832;
