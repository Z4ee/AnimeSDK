...
#define RPG_GAMECORE_SO_SENDMESSAGE_METHOD_4_46C48CBA06B4E9F6_OFFSET UNITYSDK_OFFSET(0x1767D330)
#define RPG_GAMECORE_SO_SENDMESSAGE_METHOD_4_FE35FABD832CA2A7_OFFSET UNITYSDK_OFFSET(0x1767CC00)
#define RPG_GAMECORE_SO_SENDMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1767CBD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SO_SendMessage_TypeDefinitionIndex = 18342;
