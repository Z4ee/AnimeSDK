...
#define RPG_GAMECORE_BYISSKILLTYPEDISABLE_METHOD_4_0B64C64DEFB172A0_OFFSET UNITYSDK_OFFSET(0x17032E00)
#define RPG_GAMECORE_BYISSKILLTYPEDISABLE_METHOD_4_464B06AC8E4FE3AF_OFFSET UNITYSDK_OFFSET(0x17032CE0)
#define RPG_GAMECORE_BYISSKILLTYPEDISABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x17032D80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsSkillTypeDisable_TypeDefinitionIndex = 22356;
