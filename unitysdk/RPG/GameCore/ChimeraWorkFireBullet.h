...
#define RPG_GAMECORE_CHIMERAWORKFIREBULLET_METHOD_3_B62CA79155238F4A_OFFSET UNITYSDK_OFFSET(0x1964E050)
#define RPG_GAMECORE_CHIMERAWORKFIREBULLET_METHOD_3_C268D596A7EC949E_OFFSET UNITYSDK_OFFSET(0x1964DFF0)
#define RPG_GAMECORE_CHIMERAWORKFIREBULLET__CTOR_OFFSET UNITYSDK_OFFSET(0x1964E040)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraWorkFireBullet_TypeDefinitionIndex = 15094;
