...
#define RPG_GAMECORE_MODIFIERBEHAVIORFLAGLISTPAIR_METHOD_2_CBE2A98613B331E8_OFFSET UNITYSDK_OFFSET(0x1D2AA9B0)
#define RPG_GAMECORE_MODIFIERBEHAVIORFLAGLISTPAIR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2AAAD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifierBehaviorFlagListPair_TypeDefinitionIndex = 16912;
