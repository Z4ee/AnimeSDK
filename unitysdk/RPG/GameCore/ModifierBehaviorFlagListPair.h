...
#define RPG_GAMECORE_MODIFIERBEHAVIORFLAGLISTPAIR_METHOD_2_CBE2A98613B331E8_OFFSET UNITYSDK_OFFSET(0x1D1B1140)
#define RPG_GAMECORE_MODIFIERBEHAVIORFLAGLISTPAIR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1B1260)
