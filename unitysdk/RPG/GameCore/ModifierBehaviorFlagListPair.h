...
#define RPG_GAMECORE_MODIFIERBEHAVIORFLAGLISTPAIR_METHOD_2_CBE2A98613B331E8_OFFSET UNITYSDK_OFFSET(0x174263F0)
#define RPG_GAMECORE_MODIFIERBEHAVIORFLAGLISTPAIR__CTOR_OFFSET UNITYSDK_OFFSET(0x17426560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifierBehaviorFlagListPair_TypeDefinitionIndex = 15672;
