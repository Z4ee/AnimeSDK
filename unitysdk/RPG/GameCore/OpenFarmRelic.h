...
#define RPG_GAMECORE_OPENFARMRELIC_METHOD_3_628FF0E3F0C5D010_OFFSET UNITYSDK_OFFSET(0x1D2FD6E0)
#define RPG_GAMECORE_OPENFARMRELIC_METHOD_3_D2979FCCBF1FF4FF_OFFSET UNITYSDK_OFFSET(0x1D2FD6A0)
#define RPG_GAMECORE_OPENFARMRELIC__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2FD6D0)
