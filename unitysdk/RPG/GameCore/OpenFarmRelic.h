...
#define RPG_GAMECORE_OPENFARMRELIC_METHOD_3_628FF0E3F0C5D010_OFFSET UNITYSDK_OFFSET(0x1BB010E0)
#define RPG_GAMECORE_OPENFARMRELIC_METHOD_3_D2979FCCBF1FF4FF_OFFSET UNITYSDK_OFFSET(0x1BB010A0)
#define RPG_GAMECORE_OPENFARMRELIC__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB010D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OpenFarmRelic_TypeDefinitionIndex = 21285;
