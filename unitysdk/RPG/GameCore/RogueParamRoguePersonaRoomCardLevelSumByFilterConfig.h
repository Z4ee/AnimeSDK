...
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONAROOMCARDLEVELSUMBYFILTERCONFIG_METHOD_6_7353F91307180F3C_OFFSET UNITYSDK_OFFSET(0x18D5BD10)
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONAROOMCARDLEVELSUMBYFILTERCONFIG_METHOD_6_B6B8AF77A05A5492_OFFSET UNITYSDK_OFFSET(0x18D5BA60)
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONAROOMCARDLEVELSUMBYFILTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D5BBE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamRoguePersonaRoomCardLevelSumByFilterConfig_TypeDefinitionIndex = 18837;
