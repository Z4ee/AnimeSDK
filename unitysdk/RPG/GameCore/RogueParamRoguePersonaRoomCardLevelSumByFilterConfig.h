...
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONAROOMCARDLEVELSUMBYFILTERCONFIG_METHOD_6_7353F91307180F3C_OFFSET UNITYSDK_OFFSET(0x1D176DE0)
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONAROOMCARDLEVELSUMBYFILTERCONFIG_METHOD_6_BA729069F4B72F40_OFFSET UNITYSDK_OFFSET(0x1D176D90)
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONAROOMCARDLEVELSUMBYFILTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D176DD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamRoguePersonaRoomCardLevelSumByFilterConfig_TypeDefinitionIndex = 19083;
