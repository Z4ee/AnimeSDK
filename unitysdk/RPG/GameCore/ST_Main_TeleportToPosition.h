...
#define RPG_GAMECORE_ST_MAIN_TELEPORTTOPOSITION_METHOD_4_33943FF2A1893DAE_OFFSET UNITYSDK_OFFSET(0x1B787170)
#define RPG_GAMECORE_ST_MAIN_TELEPORTTOPOSITION_METHOD_4_5C7EB525D8271057_OFFSET UNITYSDK_OFFSET(0x1B787130)
#define RPG_GAMECORE_ST_MAIN_TELEPORTTOPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B787160)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_TeleportToPosition_TypeDefinitionIndex = 19326;
