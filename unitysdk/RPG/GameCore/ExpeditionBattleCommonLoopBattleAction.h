...
#define RPG_GAMECORE_EXPEDITIONBATTLECOMMONLOOPBATTLEACTION_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1D080810)
#define RPG_GAMECORE_EXPEDITIONBATTLECOMMONLOOPBATTLEACTION_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D080770)
#define RPG_GAMECORE_EXPEDITIONBATTLECOMMONLOOPBATTLEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D080800)
