...
#define RPG_GAMECORE_MISSIONMAPNPCTYPE_METHOD_2_9614B5548A722A8B_OFFSET UNITYSDK_OFFSET(0x18B2E930)
#define RPG_GAMECORE_MISSIONMAPNPCTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x18B2EA50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MissionMapNpcType_TypeDefinitionIndex = 18031;
