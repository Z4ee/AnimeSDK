...
#define RPG_GAMECORE_MISSIONMAPNPCTYPE_METHOD_2_9614B5548A722A8B_OFFSET UNITYSDK_OFFSET(0x1AF6B1E0)
#define RPG_GAMECORE_MISSIONMAPNPCTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF6B300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MissionMapNpcType_TypeDefinitionIndex = 18261;
