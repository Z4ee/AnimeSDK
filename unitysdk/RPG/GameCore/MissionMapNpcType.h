...
#define RPG_GAMECORE_MISSIONMAPNPCTYPE_METHOD_2_9614B5548A722A8B_OFFSET UNITYSDK_OFFSET(0x17422060)
#define RPG_GAMECORE_MISSIONMAPNPCTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x17422180)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MissionMapNpcType_TypeDefinitionIndex = 17423;
