...
#define RPG_GAMECORE_TRAINPARTYEVENTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D535770)
#define RPG_GAMECORE_TRAINPARTYEVENTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5358F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyEventConfigRow_TypeDefinitionIndex = 15142;
