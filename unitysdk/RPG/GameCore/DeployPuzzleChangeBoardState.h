...
#define RPG_GAMECORE_DEPLOYPUZZLECHANGEBOARDSTATE_METHOD_3_55A252E8672E7540_OFFSET UNITYSDK_OFFSET(0x18859C30)
#define RPG_GAMECORE_DEPLOYPUZZLECHANGEBOARDSTATE_METHOD_3_B76A0D5B21B3B3D4_OFFSET UNITYSDK_OFFSET(0x18859AE0)
#define RPG_GAMECORE_DEPLOYPUZZLECHANGEBOARDSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18859BA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DeployPuzzleChangeBoardState_TypeDefinitionIndex = 19313;
