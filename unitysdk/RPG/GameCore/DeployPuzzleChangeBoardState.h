...
#define RPG_GAMECORE_DEPLOYPUZZLECHANGEBOARDSTATE_METHOD_3_55A252E8672E7540_OFFSET UNITYSDK_OFFSET(0x1D8160B0)
#define RPG_GAMECORE_DEPLOYPUZZLECHANGEBOARDSTATE_METHOD_3_823EBB1B039CF7E6_OFFSET UNITYSDK_OFFSET(0x1D816030)
#define RPG_GAMECORE_DEPLOYPUZZLECHANGEBOARDSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D816080)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DeployPuzzleChangeBoardState_TypeDefinitionIndex = 20127;
