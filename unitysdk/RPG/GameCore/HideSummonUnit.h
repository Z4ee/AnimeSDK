...
#define RPG_GAMECORE_HIDESUMMONUNIT_METHOD_3_64798B691BF60D6F_OFFSET UNITYSDK_OFFSET(0x189FF9D0)
#define RPG_GAMECORE_HIDESUMMONUNIT_METHOD_3_C5977F05A147DF4B_OFFSET UNITYSDK_OFFSET(0x189FF950)
#define RPG_GAMECORE_HIDESUMMONUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0x189FF9A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HideSummonUnit_TypeDefinitionIndex = 19309;
