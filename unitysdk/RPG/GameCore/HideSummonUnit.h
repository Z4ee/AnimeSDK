...
#define RPG_GAMECORE_HIDESUMMONUNIT_METHOD_3_64798B691BF60D6F_OFFSET UNITYSDK_OFFSET(0x1B684990)
#define RPG_GAMECORE_HIDESUMMONUNIT_METHOD_3_8B83E6905F9B8838_OFFSET UNITYSDK_OFFSET(0x1B684940)
#define RPG_GAMECORE_HIDESUMMONUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B684980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HideSummonUnit_TypeDefinitionIndex = 19578;
