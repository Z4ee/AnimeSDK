...
#define RPG_GAMECORE_HIDESUMMONUNIT_METHOD_3_64798B691BF60D6F_OFFSET UNITYSDK_OFFSET(0x19831F30)
#define RPG_GAMECORE_HIDESUMMONUNIT_METHOD_3_C5977F05A147DF4B_OFFSET UNITYSDK_OFFSET(0x19831EB0)
#define RPG_GAMECORE_HIDESUMMONUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0x19831F00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HideSummonUnit_TypeDefinitionIndex = 19222;
