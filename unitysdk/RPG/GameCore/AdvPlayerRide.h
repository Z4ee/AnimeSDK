...
#define RPG_GAMECORE_ADVPLAYERRIDE_METHOD_3_4F0599C71C6ADF47_OFFSET UNITYSDK_OFFSET(0x16F3C000)
#define RPG_GAMECORE_ADVPLAYERRIDE_METHOD_3_690B3F91DEA02848_OFFSET UNITYSDK_OFFSET(0x16F3C0D0)
#define RPG_GAMECORE_ADVPLAYERRIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F3C080)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvPlayerRide_TypeDefinitionIndex = 19361;
