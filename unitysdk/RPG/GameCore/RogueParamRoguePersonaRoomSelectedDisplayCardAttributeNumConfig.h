...
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONAROOMSELECTEDDISPLAYCARDATTRIBUTENUMCONFIG_METHOD_6_634242A7DF8507DB_OFFSET UNITYSDK_OFFSET(0x1D176F70)
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONAROOMSELECTEDDISPLAYCARDATTRIBUTENUMCONFIG_METHOD_6_F9F89EEBF2126C5F_OFFSET UNITYSDK_OFFSET(0x1D176FC0)
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONAROOMSELECTEDDISPLAYCARDATTRIBUTENUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D176FB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamRoguePersonaRoomSelectedDisplayCardAttributeNumConfig_TypeDefinitionIndex = 19093;
