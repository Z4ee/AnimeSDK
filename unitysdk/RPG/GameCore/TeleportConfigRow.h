...
#define RPG_GAMECORE_TELEPORTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C14A420)
#define RPG_GAMECORE_TELEPORTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C14AAC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TeleportConfigRow_TypeDefinitionIndex = 12101;
