...
#define RPG_GAMECORE_ADVSETPETDYNAMICVALUE_METHOD_3_3ABE7252D9116C99_OFFSET UNITYSDK_OFFSET(0x16F42530)
#define RPG_GAMECORE_ADVSETPETDYNAMICVALUE_METHOD_3_5D9597096717F5E0_OFFSET UNITYSDK_OFFSET(0x16F425B0)
#define RPG_GAMECORE_ADVSETPETDYNAMICVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F42580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSetPetDynamicValue_TypeDefinitionIndex = 19270;
