...
#define RPG_GAMECORE_ADVSETPETDYNAMICVALUE_METHOD_3_5D9597096717F5E0_OFFSET UNITYSDK_OFFSET(0x1CDDB290)
#define RPG_GAMECORE_ADVSETPETDYNAMICVALUE_METHOD_3_8DB772881E4628A3_OFFSET UNITYSDK_OFFSET(0x1CDDB250)
#define RPG_GAMECORE_ADVSETPETDYNAMICVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDDB280)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSetPetDynamicValue_TypeDefinitionIndex = 20702;
