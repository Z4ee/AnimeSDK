...
#define RPG_GAMECORE_PUMANMOVENOTIFYCONFIG_METHOD_2_2B32ABE60215DFC2_OFFSET UNITYSDK_OFFSET(0x17573930)
#define RPG_GAMECORE_PUMANMOVENOTIFYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17573AB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PuManMoveNotifyConfig_TypeDefinitionIndex = 15532;
