...
#define RPG_GAMECORE_ADVDISTRICTENABLETRIGGER_METHOD_3_0B2789046BD20C83_OFFSET UNITYSDK_OFFSET(0x1864CF50)
#define RPG_GAMECORE_ADVDISTRICTENABLETRIGGER_METHOD_3_B7A340D71081FC2C_OFFSET UNITYSDK_OFFSET(0x1864CDA0)
#define RPG_GAMECORE_ADVDISTRICTENABLETRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1864CE90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvDistrictEnableTrigger_TypeDefinitionIndex = 20168;
