...
#define RPG_GAMECORE_AIDECISIONCONFIG_METHOD_4_22339FA9D2FC4821_OFFSET UNITYSDK_OFFSET(0x1CD65AB0)
#define RPG_GAMECORE_AIDECISIONCONFIG_METHOD_4_8C011774F91AAF8A_OFFSET UNITYSDK_OFFSET(0x1CD65AF0)
#define RPG_GAMECORE_AIDECISIONCONFIG_METHOD_4_EA0B3C288704FB98_OFFSET UNITYSDK_OFFSET(0x1CD65190)
#define RPG_GAMECORE_AIDECISIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD65180)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AIDecisionConfig_TypeDefinitionIndex = 15311;
