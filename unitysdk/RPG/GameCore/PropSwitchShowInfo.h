...
#define RPG_GAMECORE_PROPSWITCHSHOWINFO_METHOD_3_8C2125DA46A8A7C6_OFFSET UNITYSDK_OFFSET(0x18C7AAC0)
#define RPG_GAMECORE_PROPSWITCHSHOWINFO_METHOD_3_F7A1D6FB32875961_OFFSET UNITYSDK_OFFSET(0x18C7AA20)
#define RPG_GAMECORE_PROPSWITCHSHOWINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18C7AA80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropSwitchShowInfo_TypeDefinitionIndex = 19389;
