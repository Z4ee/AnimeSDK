...
#define RPG_GAMECORE_PROPSWITCHSHOWINFO_METHOD_3_8C2125DA46A8A7C6_OFFSET UNITYSDK_OFFSET(0x17570330)
#define RPG_GAMECORE_PROPSWITCHSHOWINFO_METHOD_3_F7A1D6FB32875961_OFFSET UNITYSDK_OFFSET(0x17570290)
#define RPG_GAMECORE_PROPSWITCHSHOWINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x175702F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropSwitchShowInfo_TypeDefinitionIndex = 18732;
