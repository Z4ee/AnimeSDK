...
#define RPG_GAMECORE_MANIKINSERVANTCONFIG_METHOD_2_3B2B39305CD04544_OFFSET UNITYSDK_OFFSET(0x1D4951B0)
#define RPG_GAMECORE_MANIKINSERVANTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D495300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ManikinServantConfig_TypeDefinitionIndex = 17277;
