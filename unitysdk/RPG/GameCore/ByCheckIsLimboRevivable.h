...
#define RPG_GAMECORE_BYCHECKISLIMBOREVIVABLE_METHOD_4_2D73A0CAE0418FF2_OFFSET UNITYSDK_OFFSET(0x1C2FDEB0)
#define RPG_GAMECORE_BYCHECKISLIMBOREVIVABLE_METHOD_4_6AA129B820A8E6B6_OFFSET UNITYSDK_OFFSET(0x1C2FDD00)
#define RPG_GAMECORE_BYCHECKISLIMBOREVIVABLE_METHOD_4_8E99DC2F46A6D01F_OFFSET UNITYSDK_OFFSET(0x1C2FDE80)
#define RPG_GAMECORE_BYCHECKISLIMBOREVIVABLE_METHOD_4_DB97F421CBDA4575_OFFSET UNITYSDK_OFFSET(0x1C2FDD40)
#define RPG_GAMECORE_BYCHECKISLIMBOREVIVABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2FDD30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckIsLimboRevivable_TypeDefinitionIndex = 22777;
