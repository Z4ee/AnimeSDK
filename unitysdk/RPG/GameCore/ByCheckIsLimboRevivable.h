...
#define RPG_GAMECORE_BYCHECKISLIMBOREVIVABLE_METHOD_4_5DE0B9709C7EA61F_OFFSET UNITYSDK_OFFSET(0x16FFE850)
#define RPG_GAMECORE_BYCHECKISLIMBOREVIVABLE_METHOD_4_DB97F421CBDA4575_OFFSET UNITYSDK_OFFSET(0x16FFE920)
#define RPG_GAMECORE_BYCHECKISLIMBOREVIVABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x16FFE8D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckIsLimboRevivable_TypeDefinitionIndex = 21242;
