...
#define RPG_GAMECORE_RUANMADECAKEFEATURE_HATCOLOR_METHOD_3_0596358E11614EC1_OFFSET UNITYSDK_OFFSET(0x18DDCE00)
#define RPG_GAMECORE_RUANMADECAKEFEATURE_HATCOLOR_METHOD_3_2297D7B5EB883E76_OFFSET UNITYSDK_OFFSET(0x18DDC770)
#define RPG_GAMECORE_RUANMADECAKEFEATURE_HATCOLOR__CTOR_OFFSET UNITYSDK_OFFSET(0x18DDC760)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RuanMadeCakeFeature_HatColor_TypeDefinitionIndex = 16574;
