...
#define RPG_GAMECORE_RUANMADECAKEFEATURE_HATCOLOR_METHOD_3_0596358E11614EC1_OFFSET UNITYSDK_OFFSET(0x17679360)
#define RPG_GAMECORE_RUANMADECAKEFEATURE_HATCOLOR_METHOD_3_2297D7B5EB883E76_OFFSET UNITYSDK_OFFSET(0x17678CD0)
#define RPG_GAMECORE_RUANMADECAKEFEATURE_HATCOLOR__CTOR_OFFSET UNITYSDK_OFFSET(0x17678CC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RuanMadeCakeFeature_HatColor_TypeDefinitionIndex = 16045;
