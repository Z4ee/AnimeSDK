...
#define RPG_GAMECORE_CHARACTERLODCONFIG_METHOD_2_22018F2C79FFE6A9_OFFSET UNITYSDK_OFFSET(0x1960EE20)
#define RPG_GAMECORE_CHARACTERLODCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1960EF70)
