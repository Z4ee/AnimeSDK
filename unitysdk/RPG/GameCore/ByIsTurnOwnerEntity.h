...
#define RPG_GAMECORE_BYISTURNOWNERENTITY_METHOD_4_AC4F59C06CF45F10_OFFSET UNITYSDK_OFFSET(0x170357D0)
#define RPG_GAMECORE_BYISTURNOWNERENTITY_METHOD_4_E60DC3D43181C9FE_OFFSET UNITYSDK_OFFSET(0x170358A0)
#define RPG_GAMECORE_BYISTURNOWNERENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x17035850)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsTurnOwnerEntity_TypeDefinitionIndex = 21190;
