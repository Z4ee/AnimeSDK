...
#define RPG_GAMECORE_RECOVERALLCHARACTERSHP_METHOD_3_3BE971E0427AE358_OFFSET UNITYSDK_OFFSET(0x18C93D10)
#define RPG_GAMECORE_RECOVERALLCHARACTERSHP_METHOD_3_747546A4146DA704_OFFSET UNITYSDK_OFFSET(0x18C93E20)
#define RPG_GAMECORE_RECOVERALLCHARACTERSHP__CTOR_OFFSET UNITYSDK_OFFSET(0x18C93DF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RecoverAllCharactersHP_TypeDefinitionIndex = 20554;
