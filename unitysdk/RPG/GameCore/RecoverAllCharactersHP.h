...
#define RPG_GAMECORE_RECOVERALLCHARACTERSHP_METHOD_3_65B0825A9D528481_OFFSET UNITYSDK_OFFSET(0x1B9BF930)
#define RPG_GAMECORE_RECOVERALLCHARACTERSHP_METHOD_3_747546A4146DA704_OFFSET UNITYSDK_OFFSET(0x1B9BFA00)
#define RPG_GAMECORE_RECOVERALLCHARACTERSHP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9BF9F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RecoverAllCharactersHP_TypeDefinitionIndex = 20904;
