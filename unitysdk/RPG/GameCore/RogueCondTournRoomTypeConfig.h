...
#define RPG_GAMECORE_ROGUECONDTOURNROOMTYPECONFIG_METHOD_6_4C4D496939216E17_OFFSET UNITYSDK_OFFSET(0x1C4AEF90)
#define RPG_GAMECORE_ROGUECONDTOURNROOMTYPECONFIG_METHOD_6_53443E76F725E3D3_OFFSET UNITYSDK_OFFSET(0x1C4AEF40)
#define RPG_GAMECORE_ROGUECONDTOURNROOMTYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4AEF80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueCondTournRoomTypeConfig_TypeDefinitionIndex = 19045;
