...
#define RPG_GAMECORE_BATTLEAREAFILTEREXPRESSION_METHOD_2_663F7881FF067E0F_OFFSET UNITYSDK_OFFSET(0x16FCBC10)
#define RPG_GAMECORE_BATTLEAREAFILTEREXPRESSION_METHOD_2_E1D5A3BB7470A44C_OFFSET UNITYSDK_OFFSET(0x16FCBAE0)
#define RPG_GAMECORE_BATTLEAREAFILTEREXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x16FCBAD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleAreaFilterExpression_TypeDefinitionIndex = 15989;
