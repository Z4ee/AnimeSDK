...
#define RPG_GAMECORE_BATTLEAREAFILTEREXPRESSION_METHOD_2_663F7881FF067E0F_OFFSET UNITYSDK_OFFSET(0x186EF420)
#define RPG_GAMECORE_BATTLEAREAFILTEREXPRESSION_METHOD_2_E1D5A3BB7470A44C_OFFSET UNITYSDK_OFFSET(0x186EF2F0)
#define RPG_GAMECORE_BATTLEAREAFILTEREXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x186EF2E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleAreaFilterExpression_TypeDefinitionIndex = 16518;
