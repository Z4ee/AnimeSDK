...
#define RPG_GAMECORE_BATTLEAREAFILTEREXPRESSION_METHOD_2_663F7881FF067E0F_OFFSET UNITYSDK_OFFSET(0x1A3E2D40)
#define RPG_GAMECORE_BATTLEAREAFILTEREXPRESSION_METHOD_2_E1D5A3BB7470A44C_OFFSET UNITYSDK_OFFSET(0x1A3E2C00)
#define RPG_GAMECORE_BATTLEAREAFILTEREXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3E2BF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleAreaFilterExpression_TypeDefinitionIndex = 16711;
