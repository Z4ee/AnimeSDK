...
#define RPG_GAMECORE_AVATAREQUIPRECOMMENDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C58C210)
#define RPG_GAMECORE_AVATAREQUIPRECOMMENDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C58C350)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AvatarEquipRecommendRow_TypeDefinitionIndex = 12673;
