...
#define RPG_GAMECORE_FIVEDIMREFILLPLAYERDASHENERGYACTION_METHOD_3_99ABF3A3254FC68C_OFFSET UNITYSDK_OFFSET(0x1BEAE240)
#define RPG_GAMECORE_FIVEDIMREFILLPLAYERDASHENERGYACTION_METHOD_3_F6A1E888162FA621_OFFSET UNITYSDK_OFFSET(0x1BEAE2C0)
#define RPG_GAMECORE_FIVEDIMREFILLPLAYERDASHENERGYACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEAE2B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimRefillPlayerDashEnergyAction_TypeDefinitionIndex = 18032;
