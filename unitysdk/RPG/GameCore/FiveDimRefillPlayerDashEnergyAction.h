...
#define RPG_GAMECORE_FIVEDIMREFILLPLAYERDASHENERGYACTION_METHOD_3_C204DC8BF895BD64_OFFSET UNITYSDK_OFFSET(0x189187A0)
#define RPG_GAMECORE_FIVEDIMREFILLPLAYERDASHENERGYACTION_METHOD_3_F6A1E888162FA621_OFFSET UNITYSDK_OFFSET(0x18918860)
#define RPG_GAMECORE_FIVEDIMREFILLPLAYERDASHENERGYACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18918840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimRefillPlayerDashEnergyAction_TypeDefinitionIndex = 17828;
