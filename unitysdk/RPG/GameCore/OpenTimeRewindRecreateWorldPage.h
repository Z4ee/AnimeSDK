...
#define RPG_GAMECORE_OPENTIMEREWINDRECREATEWORLDPAGE_METHOD_3_1D04BADB742635B7_OFFSET UNITYSDK_OFFSET(0x1747CF30)
#define RPG_GAMECORE_OPENTIMEREWINDRECREATEWORLDPAGE_METHOD_3_F49DE27B1C0E5E3F_OFFSET UNITYSDK_OFFSET(0x1747CE70)
#define RPG_GAMECORE_OPENTIMEREWINDRECREATEWORLDPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1747CEE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OpenTimeRewindRecreateWorldPage_TypeDefinitionIndex = 18979;
