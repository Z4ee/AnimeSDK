...
#define RPG_GAMECORE_OPENTIMEREWINDRECREATEWORLDPAGE_METHOD_3_4A9FE83658CEFC1D_OFFSET UNITYSDK_OFFSET(0x1BB02040)
#define RPG_GAMECORE_OPENTIMEREWINDRECREATEWORLDPAGE_METHOD_3_7088B9E29EEF8881_OFFSET UNITYSDK_OFFSET(0x1BB020D0)
#define RPG_GAMECORE_OPENTIMEREWINDRECREATEWORLDPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB020A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OpenTimeRewindRecreateWorldPage_TypeDefinitionIndex = 19879;
