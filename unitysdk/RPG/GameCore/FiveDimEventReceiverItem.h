...
#define RPG_GAMECORE_FIVEDIMEVENTRECEIVERITEM_METHOD_2_9099147E09DAF980_OFFSET UNITYSDK_OFFSET(0x1D85C860)
#define RPG_GAMECORE_FIVEDIMEVENTRECEIVERITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D85C9B0)
