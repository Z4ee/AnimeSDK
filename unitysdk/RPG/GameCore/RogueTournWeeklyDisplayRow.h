...
#define RPG_GAMECORE_ROGUETOURNWEEKLYDISPLAYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CCCD610)
#define RPG_GAMECORE_ROGUETOURNWEEKLYDISPLAYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CCCD7D0)
