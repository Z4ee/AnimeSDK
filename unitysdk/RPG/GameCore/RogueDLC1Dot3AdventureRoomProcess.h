...
#define RPG_GAMECORE_ROGUEDLC1DOT3ADVENTUREROOMPROCESS_METHOD_3_4F63129483793E8D_OFFSET UNITYSDK_OFFSET(0x175EFAE0)
#define RPG_GAMECORE_ROGUEDLC1DOT3ADVENTUREROOMPROCESS_METHOD_3_F0F2BDD767BBE57D_OFFSET UNITYSDK_OFFSET(0x175EFA60)
#define RPG_GAMECORE_ROGUEDLC1DOT3ADVENTUREROOMPROCESS__CTOR_OFFSET UNITYSDK_OFFSET(0x175EFAB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueDLC1Dot3AdventureRoomProcess_TypeDefinitionIndex = 20472;
