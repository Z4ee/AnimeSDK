...
#define RPG_GAMECORE_ROGUEDLC1DOT3ADVENTUREROOMPROCESS_METHOD_3_0858FC21A745D10C_OFFSET UNITYSDK_OFFSET(0x19B22610)
#define RPG_GAMECORE_ROGUEDLC1DOT3ADVENTUREROOMPROCESS_METHOD_3_DA769E4490658F3F_OFFSET UNITYSDK_OFFSET(0x19B22690)
#define RPG_GAMECORE_ROGUEDLC1DOT3ADVENTUREROOMPROCESS__CTOR_OFFSET UNITYSDK_OFFSET(0x19B22660)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueDLC1Dot3AdventureRoomProcess_TypeDefinitionIndex = 21052;
	...
	public:
		...
		static ::System::Void Method_3_0858FC21A745D10C(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::RogueDLC1Dot3AdventureRoomProcess*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::RogueDLC1Dot3AdventureRoomProcess*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_ROGUEDLC1DOT3ADVENTUREROOMPROCESS_METHOD_3_0858FC21A745D10C_OFFSET))(a1, a2);
		}
