...
#define RPG_GAMECORE_TRIGGERDRINKMAKERBARTENDINMISSION_METHOD_3_A4FAEED92FFCA9D3_OFFSET UNITYSDK_OFFSET(0x178C1E60)
#define RPG_GAMECORE_TRIGGERDRINKMAKERBARTENDINMISSION_METHOD_3_FC3E9988464253EA_OFFSET UNITYSDK_OFFSET(0x178C1EE0)
#define RPG_GAMECORE_TRIGGERDRINKMAKERBARTENDINMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x178C1EB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerDrinkMakerBartendInMission_TypeDefinitionIndex = 19881;
