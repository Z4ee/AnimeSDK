...
#define RPG_GAMECORE_TRIGGERDRINKMAKERBARTENDINMISSION_METHOD_3_0C60D08E06CA30F4_OFFSET UNITYSDK_OFFSET(0x1D54A950)
#define RPG_GAMECORE_TRIGGERDRINKMAKERBARTENDINMISSION_METHOD_3_3B4F3A68C40D9D09_OFFSET UNITYSDK_OFFSET(0x1D54A910)
#define RPG_GAMECORE_TRIGGERDRINKMAKERBARTENDINMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D54A940)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerDrinkMakerBartendInMission_TypeDefinitionIndex = 21468;
