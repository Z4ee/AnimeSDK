...
#define RPG_GAMECORE_CLOSEALLTOPPAGE_METHOD_3_B1257A545029C8B6_OFFSET UNITYSDK_OFFSET(0x1711D030)
#define RPG_GAMECORE_CLOSEALLTOPPAGE_METHOD_3_DB69542202AF55EA_OFFSET UNITYSDK_OFFSET(0x1711CF20)
#define RPG_GAMECORE_CLOSEALLTOPPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1711D000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CloseAllTopPage_TypeDefinitionIndex = 18932;
