...
#define RPG_GAMECORE_CLOSEALLTOPPAGE_METHOD_3_0777F9D890E0DAF3_OFFSET UNITYSDK_OFFSET(0x1D9A2780)
#define RPG_GAMECORE_CLOSEALLTOPPAGE_METHOD_3_B1257A545029C8B6_OFFSET UNITYSDK_OFFSET(0x1D9A2850)
#define RPG_GAMECORE_CLOSEALLTOPPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D9A2840)
