...
#define RPG_GAMECORE_CLOSEALLTOPPAGE_METHOD_3_0777F9D890E0DAF3_OFFSET UNITYSDK_OFFSET(0x1BC1E7E0)
#define RPG_GAMECORE_CLOSEALLTOPPAGE_METHOD_3_B1257A545029C8B6_OFFSET UNITYSDK_OFFSET(0x1BC1E8B0)
#define RPG_GAMECORE_CLOSEALLTOPPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC1E8A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CloseAllTopPage_TypeDefinitionIndex = 19837;
