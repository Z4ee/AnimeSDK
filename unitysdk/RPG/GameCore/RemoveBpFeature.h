...
#define RPG_GAMECORE_REMOVEBPFEATURE_METHOD_3_88531024E6186969_OFFSET UNITYSDK_OFFSET(0x1D39DE30)
#define RPG_GAMECORE_REMOVEBPFEATURE_METHOD_3_F5363556402178F2_OFFSET UNITYSDK_OFFSET(0x1D39DE70)
#define RPG_GAMECORE_REMOVEBPFEATURE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D39DE60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveBpFeature_TypeDefinitionIndex = 22962;
