...
#define RPG_GAMECORE_CHENLINGBUILDINGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x187E8980)
#define RPG_GAMECORE_CHENLINGBUILDINGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x187E8C40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBuildingRow_TypeDefinitionIndex = 10582;
