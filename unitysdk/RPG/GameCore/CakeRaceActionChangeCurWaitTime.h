...
#define RPG_GAMECORE_CAKERACEACTIONCHANGECURWAITTIME_METHOD_3_0688BE09A2097D0A_OFFSET UNITYSDK_OFFSET(0x1CDD2FF0)
#define RPG_GAMECORE_CAKERACEACTIONCHANGECURWAITTIME_METHOD_3_E6CF9C6B10A6CD46_OFFSET UNITYSDK_OFFSET(0x1CDD3050)
#define RPG_GAMECORE_CAKERACEACTIONCHANGECURWAITTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDD3040)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionChangeCurWaitTime_TypeDefinitionIndex = 18121;
