...
#define RPG_GAMECORE_CAKERACEACTIONCHANGECURWAITTIME_METHOD_3_321A8915806F3C58_OFFSET UNITYSDK_OFFSET(0x1876BA50)
#define RPG_GAMECORE_CAKERACEACTIONCHANGECURWAITTIME_METHOD_3_E6CF9C6B10A6CD46_OFFSET UNITYSDK_OFFSET(0x18769120)
#define RPG_GAMECORE_CAKERACEACTIONCHANGECURWAITTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x18769100)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionChangeCurWaitTime_TypeDefinitionIndex = 17427;
