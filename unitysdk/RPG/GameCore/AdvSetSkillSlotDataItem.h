...
#define RPG_GAMECORE_ADVSETSKILLSLOTDATAITEM_METHOD_2_B6C147AB05405B9D_OFFSET UNITYSDK_OFFSET(0x1CDDB730)
#define RPG_GAMECORE_ADVSETSKILLSLOTDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDDB9B0)
