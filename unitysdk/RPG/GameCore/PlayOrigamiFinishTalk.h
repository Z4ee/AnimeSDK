...
#define RPG_GAMECORE_PLAYORIGAMIFINISHTALK_METHOD_3_86400D664FDD9A9A_OFFSET UNITYSDK_OFFSET(0x1D7A66F0)
#define RPG_GAMECORE_PLAYORIGAMIFINISHTALK_METHOD_3_F3E9448993C3B0F7_OFFSET UNITYSDK_OFFSET(0x1D7A6620)
#define RPG_GAMECORE_PLAYORIGAMIFINISHTALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7A66E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayOrigamiFinishTalk_TypeDefinitionIndex = 21829;
