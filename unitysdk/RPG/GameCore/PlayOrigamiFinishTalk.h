...
#define RPG_GAMECORE_PLAYORIGAMIFINISHTALK_METHOD_3_4A0E900622DA61EE_OFFSET UNITYSDK_OFFSET(0x18C0FD00)
#define RPG_GAMECORE_PLAYORIGAMIFINISHTALK_METHOD_3_86400D664FDD9A9A_OFFSET UNITYSDK_OFFSET(0x18C0FE10)
#define RPG_GAMECORE_PLAYORIGAMIFINISHTALK__CTOR_OFFSET UNITYSDK_OFFSET(0x18C0FDE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayOrigamiFinishTalk_TypeDefinitionIndex = 20941;
