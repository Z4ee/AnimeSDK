...
#define RPG_GAMECORE_PLAYORIGAMIFINISHTALK_METHOD_3_4A0E900622DA61EE_OFFSET UNITYSDK_OFFSET(0x174C46F0)
#define RPG_GAMECORE_PLAYORIGAMIFINISHTALK_METHOD_3_86400D664FDD9A9A_OFFSET UNITYSDK_OFFSET(0x174C4800)
#define RPG_GAMECORE_PLAYORIGAMIFINISHTALK__CTOR_OFFSET UNITYSDK_OFFSET(0x174C47D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayOrigamiFinishTalk_TypeDefinitionIndex = 20259;
