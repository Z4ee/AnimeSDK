...
#define RPG_GAMECORE_ROGUEBONUSROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C4A8780)
#define RPG_GAMECORE_ROGUEBONUSROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4A8F70)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID BonusDesc; // 0x18
		::RPG::Client::TextID BonusTag; // 0x28
