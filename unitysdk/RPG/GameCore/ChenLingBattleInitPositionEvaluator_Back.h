...
#define RPG_GAMECORE_CHENLINGBATTLEINITPOSITIONEVALUATOR_BACK_METHOD_3_9047DCD8033A38AC_OFFSET UNITYSDK_OFFSET(0x1707F670)
#define RPG_GAMECORE_CHENLINGBATTLEINITPOSITIONEVALUATOR_BACK_METHOD_3_F3962536F48242C1_OFFSET UNITYSDK_OFFSET(0x1707F5D0)
#define RPG_GAMECORE_CHENLINGBATTLEINITPOSITIONEVALUATOR_BACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1707F660)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleInitPositionEvaluator_Back_TypeDefinitionIndex = 14448;
