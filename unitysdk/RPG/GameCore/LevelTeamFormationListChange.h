...
#define RPG_GAMECORE_LEVELTEAMFORMATIONLISTCHANGE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x19780870)
#define RPG_GAMECORE_LEVELTEAMFORMATIONLISTCHANGE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x197808C0)
#define RPG_GAMECORE_LEVELTEAMFORMATIONLISTCHANGE_GET_CHANGEDENTITY_OFFSET UNITYSDK_OFFSET(0x19780920)
#define RPG_GAMECORE_LEVELTEAMFORMATIONLISTCHANGE_GET_TEAMENTITY_OFFSET UNITYSDK_OFFSET(0x19780910)
#define RPG_GAMECORE_LEVELTEAMFORMATIONLISTCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x19780860)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelTeamFormationListChange_TypeDefinitionIndex = 54187;
