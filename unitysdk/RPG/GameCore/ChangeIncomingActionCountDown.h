...
#define RPG_GAMECORE_CHANGEINCOMINGACTIONCOUNTDOWN_METHOD_3_B5FEC447646C0C04_OFFSET UNITYSDK_OFFSET(0x187C8480)
#define RPG_GAMECORE_CHANGEINCOMINGACTIONCOUNTDOWN_METHOD_3_C20026AAADE82EF4_OFFSET UNITYSDK_OFFSET(0x187C8400)
#define RPG_GAMECORE_CHANGEINCOMINGACTIONCOUNTDOWN__CTOR_OFFSET UNITYSDK_OFFSET(0x187C8450)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChangeIncomingActionCountDown_TypeDefinitionIndex = 22685;
