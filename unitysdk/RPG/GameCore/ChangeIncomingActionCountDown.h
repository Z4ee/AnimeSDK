...
#define RPG_GAMECORE_CHANGEINCOMINGACTIONCOUNTDOWN_METHOD_3_B1A14523FA38A19F_OFFSET UNITYSDK_OFFSET(0x1CF8D3A0)
#define RPG_GAMECORE_CHANGEINCOMINGACTIONCOUNTDOWN_METHOD_3_B5FEC447646C0C04_OFFSET UNITYSDK_OFFSET(0x1CF8D3E0)
#define RPG_GAMECORE_CHANGEINCOMINGACTIONCOUNTDOWN__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF8D3D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChangeIncomingActionCountDown_TypeDefinitionIndex = 23421;
