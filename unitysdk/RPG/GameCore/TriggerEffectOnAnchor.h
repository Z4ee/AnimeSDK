...
#define RPG_GAMECORE_TRIGGEREFFECTONANCHOR_METHOD_3_054809949042609C_OFFSET UNITYSDK_OFFSET(0x19E13F90)
#define RPG_GAMECORE_TRIGGEREFFECTONANCHOR_METHOD_3_406A079DD4DC0AE1_OFFSET UNITYSDK_OFFSET(0x19E13F10)
#define RPG_GAMECORE_TRIGGEREFFECTONANCHOR__CTOR_OFFSET UNITYSDK_OFFSET(0x19E13F60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerEffectOnAnchor_TypeDefinitionIndex = 20478;
