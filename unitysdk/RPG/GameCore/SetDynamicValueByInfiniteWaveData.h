...
#define RPG_GAMECORE_SETDYNAMICVALUEBYINFINITEWAVEDATA_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x19C420F0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYINFINITEWAVEDATA_METHOD_4_011D96502E737EA8_OFFSET UNITYSDK_OFFSET(0x19C42070)
#define RPG_GAMECORE_SETDYNAMICVALUEBYINFINITEWAVEDATA_METHOD_4_B4BA3640302C1FC0_OFFSET UNITYSDK_OFFSET(0x19C3C1D0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYINFINITEWAVEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19C3C180)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByInfiniteWaveData_TypeDefinitionIndex = 21995;
