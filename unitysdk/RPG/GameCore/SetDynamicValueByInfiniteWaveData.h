...
#define RPG_GAMECORE_SETDYNAMICVALUEBYINFINITEWAVEDATA_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1C2E40F0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYINFINITEWAVEDATA_METHOD_4_0B44BC8135DE756D_OFFSET UNITYSDK_OFFSET(0x1C2E3ED0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYINFINITEWAVEDATA_METHOD_4_B4BA3640302C1FC0_OFFSET UNITYSDK_OFFSET(0x1C2E3F10)
#define RPG_GAMECORE_SETDYNAMICVALUEBYINFINITEWAVEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2E3F00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByInfiniteWaveData_TypeDefinitionIndex = 22429;
