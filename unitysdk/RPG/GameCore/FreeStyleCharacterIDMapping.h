...
#define RPG_GAMECORE_FREESTYLECHARACTERIDMAPPING_METHOD_2_2D35DCC7DB947536_OFFSET UNITYSDK_OFFSET(0x1DCBB410)
#define RPG_GAMECORE_FREESTYLECHARACTERIDMAPPING__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCBB530)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FreeStyleCharacterIDMapping_TypeDefinitionIndex = 16138;
