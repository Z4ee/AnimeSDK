...
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONAROOMDISPLAYCARDNUMCONFIG_METHOD_6_24F4C206243944B4_OFFSET UNITYSDK_OFFSET(0x19BB1E30)
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONAROOMDISPLAYCARDNUMCONFIG_METHOD_6_9E45BE671DD4333A_OFFSET UNITYSDK_OFFSET(0x19BB1B80)
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONAROOMDISPLAYCARDNUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19BB1D00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamRoguePersonaRoomDisplayCardNumConfig_TypeDefinitionIndex = 18810;
