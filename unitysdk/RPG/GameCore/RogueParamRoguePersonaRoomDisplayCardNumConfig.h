...
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONAROOMDISPLAYCARDNUMCONFIG_METHOD_6_24F4C206243944B4_OFFSET UNITYSDK_OFFSET(0x1D40D550)
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONAROOMDISPLAYCARDNUMCONFIG_METHOD_6_81DCAD64D6F8F238_OFFSET UNITYSDK_OFFSET(0x1D40D500)
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONAROOMDISPLAYCARDNUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D40D540)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamRoguePersonaRoomDisplayCardNumConfig_TypeDefinitionIndex = 19627;
