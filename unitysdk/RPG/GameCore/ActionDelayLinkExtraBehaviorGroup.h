...
#define RPG_GAMECORE_ACTIONDELAYLINKEXTRABEHAVIORGROUP_METHOD_2_C90B3E94773F5B57_OFFSET UNITYSDK_OFFSET(0x1B9FE310)
#define RPG_GAMECORE_ACTIONDELAYLINKEXTRABEHAVIORGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9FE3F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActionDelayLinkExtraBehaviorGroup_TypeDefinitionIndex = 22435;
