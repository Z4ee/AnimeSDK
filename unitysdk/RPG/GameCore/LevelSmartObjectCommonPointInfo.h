...
#define RPG_GAMECORE_LEVELSMARTOBJECTCOMMONPOINTINFO_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B089CD0)
#define RPG_GAMECORE_LEVELSMARTOBJECTCOMMONPOINTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B089ED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelSmartObjectCommonPointInfo_TypeDefinitionIndex = 16674;
