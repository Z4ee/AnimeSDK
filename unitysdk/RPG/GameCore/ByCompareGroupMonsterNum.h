...
#define RPG_GAMECORE_BYCOMPAREGROUPMONSTERNUM_METHOD_4_598B3B2569B72DDA_OFFSET UNITYSDK_OFFSET(0x1872EB90)
#define RPG_GAMECORE_BYCOMPAREGROUPMONSTERNUM_METHOD_4_96C75C3E8B786B93_OFFSET UNITYSDK_OFFSET(0x1872EC60)
#define RPG_GAMECORE_BYCOMPAREGROUPMONSTERNUM__CTOR_OFFSET UNITYSDK_OFFSET(0x1872EC10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareGroupMonsterNum_TypeDefinitionIndex = 21138;
