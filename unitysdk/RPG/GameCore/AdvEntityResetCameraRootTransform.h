...
#define RPG_GAMECORE_ADVENTITYRESETCAMERAROOTTRANSFORM_METHOD_3_38A0CBDDD5A6600C_OFFSET UNITYSDK_OFFSET(0x1864FC20)
#define RPG_GAMECORE_ADVENTITYRESETCAMERAROOTTRANSFORM_METHOD_3_F55D436948A75D9D_OFFSET UNITYSDK_OFFSET(0x1864FBA0)
#define RPG_GAMECORE_ADVENTITYRESETCAMERAROOTTRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1864FBF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvEntityResetCameraRootTransform_TypeDefinitionIndex = 20030;
