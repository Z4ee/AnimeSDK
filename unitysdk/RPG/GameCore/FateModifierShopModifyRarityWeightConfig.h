...
#define RPG_GAMECORE_FATEMODIFIERSHOPMODIFYRARITYWEIGHTCONFIG_METHOD_3_5482A6611930693A_OFFSET UNITYSDK_OFFSET(0x171C9180)
#define RPG_GAMECORE_FATEMODIFIERSHOPMODIFYRARITYWEIGHTCONFIG_METHOD_3_FB2D3CA5151167F3_OFFSET UNITYSDK_OFFSET(0x171C8500)
#define RPG_GAMECORE_FATEMODIFIERSHOPMODIFYRARITYWEIGHTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171C84B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateModifierShopModifyRarityWeightConfig_TypeDefinitionIndex = 17689;
