...
#define RPG_GAMECORE_CHANGEMONSTERUIDISPLAY_METHOD_4_68AD134DF2A6BC52_OFFSET UNITYSDK_OFFSET(0x17062610)
#define RPG_GAMECORE_CHANGEMONSTERUIDISPLAY_METHOD_4_F61B8E1C405AFC2E_OFFSET UNITYSDK_OFFSET(0x17063D80)
#define RPG_GAMECORE_CHANGEMONSTERUIDISPLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x170625C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChangeMonsterUIDisplay_TypeDefinitionIndex = 21925;
