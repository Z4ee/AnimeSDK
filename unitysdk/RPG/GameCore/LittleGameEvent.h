...
#define RPG_GAMECORE_LITTLEGAMEEVENT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1DD6A4C0)
#define RPG_GAMECORE_LITTLEGAMEEVENT_EQUALS_OFFSET UNITYSDK_OFFSET(0x1DD6A470)
#define RPG_GAMECORE_LITTLEGAMEEVENT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1DD6A580)
#define RPG_GAMECORE_LITTLEGAMEEVENT_METHOD_2_11FBAD25CE3FF00E_OFFSET UNITYSDK_OFFSET(0x1DD6A310)
#define RPG_GAMECORE_LITTLEGAMEEVENT_METHOD_2_27EA000C936DCCD3_OFFSET UNITYSDK_OFFSET(0x1DD6A5C0)
#define RPG_GAMECORE_LITTLEGAMEEVENT_METHOD_2_70AFE4EF4BF5C212_OFFSET UNITYSDK_OFFSET(0x1DD6A710)
#define RPG_GAMECORE_LITTLEGAMEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD6A460)
