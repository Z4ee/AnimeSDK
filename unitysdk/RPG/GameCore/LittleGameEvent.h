...
#define RPG_GAMECORE_LITTLEGAMEEVENT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x18A6B590)
#define RPG_GAMECORE_LITTLEGAMEEVENT_EQUALS_OFFSET UNITYSDK_OFFSET(0x18A6B540)
#define RPG_GAMECORE_LITTLEGAMEEVENT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x18A6B650)
#define RPG_GAMECORE_LITTLEGAMEEVENT_METHOD_2_11FBAD25CE3FF00E_OFFSET UNITYSDK_OFFSET(0x18A6B3E0)
#define RPG_GAMECORE_LITTLEGAMEEVENT_METHOD_2_DA9AFBAF121A7C2C_1_OFFSET UNITYSDK_OFFSET(0x18A6B6C0)
#define RPG_GAMECORE_LITTLEGAMEEVENT_METHOD_2_DA9AFBAF121A7C2C_OFFSET UNITYSDK_OFFSET(0x18A6B680)
#define RPG_GAMECORE_LITTLEGAMEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x18A6B530)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameEvent_TypeDefinitionIndex = 17929;
