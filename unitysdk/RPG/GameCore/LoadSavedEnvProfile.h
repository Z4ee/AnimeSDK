...
#define RPG_GAMECORE_LOADSAVEDENVPROFILE_METHOD_3_4364B61B3A88B2FC_OFFSET UNITYSDK_OFFSET(0x18A71F50)
#define RPG_GAMECORE_LOADSAVEDENVPROFILE_METHOD_3_78176027C15C82C8_OFFSET UNITYSDK_OFFSET(0x18A72060)
#define RPG_GAMECORE_LOADSAVEDENVPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x18A72030)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoadSavedEnvProfile_TypeDefinitionIndex = 19733;
