...
#define RPG_GAMECORE_LOADSAVEDENVPROFILE_METHOD_3_78176027C15C82C8_OFFSET UNITYSDK_OFFSET(0x1BCC8C80)
#define RPG_GAMECORE_LOADSAVEDENVPROFILE_METHOD_3_C427026CEE25D545_OFFSET UNITYSDK_OFFSET(0x1BCC8BB0)
#define RPG_GAMECORE_LOADSAVEDENVPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCC8C70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoadSavedEnvProfile_TypeDefinitionIndex = 19969;
