...
#define RPG_GAMECORE_LEVELNPCNEARBYANIMCONFIG_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1D1DAF60)
#define RPG_GAMECORE_LEVELNPCNEARBYANIMCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D1DA640)
#define RPG_GAMECORE_LEVELNPCNEARBYANIMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1DAF50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelNPCNearbyAnimConfig_TypeDefinitionIndex = 17078;
