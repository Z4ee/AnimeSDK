...
#define RPG_GAMECORE_LEVELLOOKATANCHORINFO_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D1CBC80)
#define RPG_GAMECORE_LEVELLOOKATANCHORINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1D6520)
