...
#define RPG_GAMECORE_CAKERACEFIELDSCOREROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B2D11F0)
#define RPG_GAMECORE_CAKERACEFIELDSCOREROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2D1470)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceFieldScoreRow_TypeDefinitionIndex = 10623;
	...
	public:
		...
		::System::UInt32 FieldID; // 0x18
		::System::UInt32 TotalScoreMaxLimit; // 0x1C
		::System::UInt32 SingleScoreMaxLimit; // 0x20
		::System::UInt32 TotalScoreRate; // 0x24
		::System::UInt32 SingleScoreRate; // 0x28
		::System::UInt32 SingleScoreMinLimit; // 0x2C
