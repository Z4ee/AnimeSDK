...
#define RPG_GAMECORE_CAKERACEFIELDSCOREROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D100D20)
#define RPG_GAMECORE_CAKERACEFIELDSCOREROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D100FA0)
