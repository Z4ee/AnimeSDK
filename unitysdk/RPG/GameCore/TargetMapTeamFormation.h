...
#define RPG_GAMECORE_TARGETMAPTEAMFORMATION_METHOD_3_1A21DD68B97D0FCB_OFFSET UNITYSDK_OFFSET(0x1D0C4390)
#define RPG_GAMECORE_TARGETMAPTEAMFORMATION_METHOD_3_A3E74E2F822CB2F9_OFFSET UNITYSDK_OFFSET(0x1D0C43F0)
#define RPG_GAMECORE_TARGETMAPTEAMFORMATION_METHOD_3_AFCC9E7ACF634EEA_OFFSET UNITYSDK_OFFSET(0x1D0C42F0)
#define RPG_GAMECORE_TARGETMAPTEAMFORMATION_METHOD_3_F43CE39E1C56ED3D_OFFSET UNITYSDK_OFFSET(0x1D0C4430)
#define RPG_GAMECORE_TARGETMAPTEAMFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0C4380)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapTeamFormation_TypeDefinitionIndex = 23100;
