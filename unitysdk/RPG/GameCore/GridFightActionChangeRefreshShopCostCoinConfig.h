...
#define RPG_GAMECORE_GRIDFIGHTACTIONCHANGEREFRESHSHOPCOSTCOINCONFIG_METHOD_6_174000A583AD68F1_OFFSET UNITYSDK_OFFSET(0x197D5DD0)
#define RPG_GAMECORE_GRIDFIGHTACTIONCHANGEREFRESHSHOPCOSTCOINCONFIG_METHOD_6_F103880976D5626A_OFFSET UNITYSDK_OFFSET(0x197D5C60)
#define RPG_GAMECORE_GRIDFIGHTACTIONCHANGEREFRESHSHOPCOSTCOINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197D5D30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightActionChangeRefreshShopCostCoinConfig_TypeDefinitionIndex = 18316;
