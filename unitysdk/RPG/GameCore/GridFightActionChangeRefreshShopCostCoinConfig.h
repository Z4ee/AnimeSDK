...
#define RPG_GAMECORE_GRIDFIGHTACTIONCHANGEREFRESHSHOPCOSTCOINCONFIG_METHOD_6_174000A583AD68F1_OFFSET UNITYSDK_OFFSET(0x1C5C1460)
#define RPG_GAMECORE_GRIDFIGHTACTIONCHANGEREFRESHSHOPCOSTCOINCONFIG_METHOD_6_B8DD494837D25C0D_OFFSET UNITYSDK_OFFSET(0x1C5C1410)
#define RPG_GAMECORE_GRIDFIGHTACTIONCHANGEREFRESHSHOPCOSTCOINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5C1450)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightActionChangeRefreshShopCostCoinConfig_TypeDefinitionIndex = 18553;
