...
#define RPG_GAMECORE_JSONOFFLINECULLINGCELLSUBDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18A391B0)
#define RPG_GAMECORE_JSONOFFLINECULLINGCELLSUBDATA_FINALIZE_OFFSET UNITYSDK_OFFSET(0x18A39140)
#define RPG_GAMECORE_JSONOFFLINECULLINGCELLSUBDATA_METHOD_2_EFBB1E447CC99B97_OFFSET UNITYSDK_OFFSET(0x18A394D0)
#define RPG_GAMECORE_JSONOFFLINECULLINGCELLSUBDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18A39720)

namespace RPG::GameCore
{
	inline static constexpr unsigned int JsonOfflineCullingCellSubData_TypeDefinitionIndex = 17366;
