...
#define RPG_GAMECORE_JSONOFFLINECULLINGCELLSUBDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B02AD50)
#define RPG_GAMECORE_JSONOFFLINECULLINGCELLSUBDATA_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1B02AC80)
#define RPG_GAMECORE_JSONOFFLINECULLINGCELLSUBDATA_METHOD_2_7818D54B29E61A30_OFFSET UNITYSDK_OFFSET(0x1B02AE20)
#define RPG_GAMECORE_JSONOFFLINECULLINGCELLSUBDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B02B060)

namespace RPG::GameCore
{
	inline static constexpr unsigned int JsonOfflineCullingCellSubData_TypeDefinitionIndex = 17544;
