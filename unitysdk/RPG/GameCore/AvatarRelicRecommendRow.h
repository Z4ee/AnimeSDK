...
#define RPG_GAMECORE_AVATARRELICRECOMMENDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16FAB400)
#define RPG_GAMECORE_AVATARRELICRECOMMENDROW_GETPROPERTYTYPEARRAY_OFFSET UNITYSDK_OFFSET(0x16FABEC0)
#define RPG_GAMECORE_AVATARRELICRECOMMENDROW_GETPROPERTYTYPE_OFFSET UNITYSDK_OFFSET(0x16FABE80)
#define RPG_GAMECORE_AVATARRELICRECOMMENDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16FABE70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AvatarRelicRecommendRow_TypeDefinitionIndex = 11650;
	...
	public:
		...
		::Il2CppArray<::RPG::GameCore::AvatarPropertyType>* PropertyList6; // 0x20
		::Il2CppArray<::System::UInt32>* Set4IDList; // 0x28
		::Il2CppArray<::RPG::GameCore::AvatarPropertyType>* SubAffixPropertyList; // 0x30
		::Il2CppArray<::RPG::GameCore::RelicRecommendProperty*>* PropertyList; // 0x38
		::Il2CppArray<::System::UInt32>* Set2IDList; // 0x40
		::Il2CppArray<::RPG::GameCore::AvatarPropertyType>* PropertyList5; // 0x48
		::Il2CppArray<::RPG::GameCore::AvatarPropertyType>* PropertyList3; // 0x50
