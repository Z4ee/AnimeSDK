...
#define RPG_GAMECORE_TARGETMAPATTACKTARGETLIST_METHOD_3_443D0165800D8958_OFFSET UNITYSDK_OFFSET(0x1E1BAFA0)
#define RPG_GAMECORE_TARGETMAPATTACKTARGETLIST_METHOD_3_97CCA50E87341936_OFFSET UNITYSDK_OFFSET(0x1E1BAF20)
#define RPG_GAMECORE_TARGETMAPATTACKTARGETLIST_METHOD_3_B8DC8929DBD5A7E5_OFFSET UNITYSDK_OFFSET(0x1E1BAF80)
#define RPG_GAMECORE_TARGETMAPATTACKTARGETLIST_METHOD_3_FF9A74797650E9A7_OFFSET UNITYSDK_OFFSET(0x1E1BAEA0)
#define RPG_GAMECORE_TARGETMAPATTACKTARGETLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1BAF10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapAttackTargetList_TypeDefinitionIndex = 23747;
