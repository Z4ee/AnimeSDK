...
#define RPG_GAMECORE_TARGETMAPATTACKTARGETLIST_METHOD_3_1E99066141F67B4F_OFFSET UNITYSDK_OFFSET(0x18EE78E0)
#define RPG_GAMECORE_TARGETMAPATTACKTARGETLIST_METHOD_3_97CCA50E87341936_OFFSET UNITYSDK_OFFSET(0x18EE79A0)
#define RPG_GAMECORE_TARGETMAPATTACKTARGETLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x18EE7980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapAttackTargetList_TypeDefinitionIndex = 23010;
