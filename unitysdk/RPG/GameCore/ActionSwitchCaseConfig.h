...
#define RPG_GAMECORE_ACTIONSWITCHCASECONFIG_METHOD_4_7B53AD4C83367DD9_OFFSET UNITYSDK_OFFSET(0x16E9DF70)
#define RPG_GAMECORE_ACTIONSWITCHCASECONFIG_METHOD_4_B397A87BB3064116_OFFSET UNITYSDK_OFFSET(0x16E9DE70)
#define RPG_GAMECORE_ACTIONSWITCHCASECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16E9DF10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActionSwitchCaseConfig_TypeDefinitionIndex = 15620;
