...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYQUERYOPTIONCONFIG_METHOD_3_475A03A476CA344B_OFFSET UNITYSDK_OFFSET(0x1D164360)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYQUERYOPTIONCONFIG_METHOD_3_9BCCAD884F76E04F_OFFSET UNITYSDK_OFFSET(0x1D1643B0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYQUERYOPTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1643A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyQueryOptionConfig_TypeDefinitionIndex = 17229;
