...
#define RPG_GAMECORE_RESTARTBATTLEBLACKLISTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18CADF40)
#define RPG_GAMECORE_RESTARTBATTLEBLACKLISTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18CADFE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RestartBattleBlackListRow_TypeDefinitionIndex = 14378;
