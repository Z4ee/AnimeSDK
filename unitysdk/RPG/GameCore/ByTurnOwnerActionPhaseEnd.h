...
#define RPG_GAMECORE_BYTURNOWNERACTIONPHASEEND_METHOD_4_9A3FC2E59406BF62_OFFSET UNITYSDK_OFFSET(0x187634F0)
#define RPG_GAMECORE_BYTURNOWNERACTIONPHASEEND_METHOD_4_B97FC72BF527FB78_OFFSET UNITYSDK_OFFSET(0x187635C0)
#define RPG_GAMECORE_BYTURNOWNERACTIONPHASEEND__CTOR_OFFSET UNITYSDK_OFFSET(0x18763570)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByTurnOwnerActionPhaseEnd_TypeDefinitionIndex = 22453;
