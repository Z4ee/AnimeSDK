...
#define RPG_GAMECORE_REPLACETRIALPLAYER_METHOD_3_061C173784733352_OFFSET UNITYSDK_OFFSET(0x18CA71A0)
#define RPG_GAMECORE_REPLACETRIALPLAYER_METHOD_3_589A86E848583AD2_OFFSET UNITYSDK_OFFSET(0x18CA7230)
#define RPG_GAMECORE_REPLACETRIALPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x18CA7200)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ReplaceTrialPlayer_TypeDefinitionIndex = 20445;
