...
#define RPG_GAMECORE_REPLACETRIALPLAYER_METHOD_3_4E5E455100389076_OFFSET UNITYSDK_OFFSET(0x1D018A80)
#define RPG_GAMECORE_REPLACETRIALPLAYER_METHOD_3_589A86E848583AD2_OFFSET UNITYSDK_OFFSET(0x1D018AD0)
#define RPG_GAMECORE_REPLACETRIALPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D018AC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ReplaceTrialPlayer_TypeDefinitionIndex = 20802;
