...
#define RPG_GAMECORE_PLAYSCREENCRACK_METHOD_3_32446382DE51C0D9_OFFSET UNITYSDK_OFFSET(0x19A28490)
#define RPG_GAMECORE_PLAYSCREENCRACK_METHOD_3_D44851BEE3DFA21B_OFFSET UNITYSDK_OFFSET(0x19A28510)
#define RPG_GAMECORE_PLAYSCREENCRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19A284E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayScreenCrack_TypeDefinitionIndex = 19743;
