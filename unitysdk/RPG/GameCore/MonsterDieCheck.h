...
#define RPG_GAMECORE_MONSTERDIECHECK_METHOD_3_7AA854EE7192CB63_OFFSET UNITYSDK_OFFSET(0x174499C0)
#define RPG_GAMECORE_MONSTERDIECHECK_METHOD_3_7AD2962B2A4B3A5A_OFFSET UNITYSDK_OFFSET(0x17449A40)
#define RPG_GAMECORE_MONSTERDIECHECK__CTOR_OFFSET UNITYSDK_OFFSET(0x17449A10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonsterDieCheck_TypeDefinitionIndex = 21167;
