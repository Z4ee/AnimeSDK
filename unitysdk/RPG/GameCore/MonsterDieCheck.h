...
#define RPG_GAMECORE_MONSTERDIECHECK_METHOD_3_7AD2962B2A4B3A5A_OFFSET UNITYSDK_OFFSET(0x1D2CCC40)
#define RPG_GAMECORE_MONSTERDIECHECK_METHOD_3_92003D9BE51FA8D1_OFFSET UNITYSDK_OFFSET(0x1D2CCC00)
#define RPG_GAMECORE_MONSTERDIECHECK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2CCC30)
