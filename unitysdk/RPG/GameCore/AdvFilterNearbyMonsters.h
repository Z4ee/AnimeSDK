...
#define RPG_GAMECORE_ADVFILTERNEARBYMONSTERS_METHOD_3_6CAA3F5049DE1E39_OFFSET UNITYSDK_OFFSET(0x1BE1C750)
#define RPG_GAMECORE_ADVFILTERNEARBYMONSTERS_METHOD_3_AD6A3207492ECBB2_OFFSET UNITYSDK_OFFSET(0x1BE1C710)
#define RPG_GAMECORE_ADVFILTERNEARBYMONSTERS__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE1C740)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvFilterNearbyMonsters_TypeDefinitionIndex = 20944;
