...
#define RPG_GAMECORE_ADVFILTERNEARBYMONSTERS_METHOD_3_6CAA3F5049DE1E39_OFFSET UNITYSDK_OFFSET(0x1D6B7AC0)
#define RPG_GAMECORE_ADVFILTERNEARBYMONSTERS_METHOD_3_AD6A3207492ECBB2_OFFSET UNITYSDK_OFFSET(0x1D6B7A80)
#define RPG_GAMECORE_ADVFILTERNEARBYMONSTERS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6B7AB0)
