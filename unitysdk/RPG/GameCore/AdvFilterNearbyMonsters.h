...
#define RPG_GAMECORE_ADVFILTERNEARBYMONSTERS_METHOD_3_00CA38B22DA54640_OFFSET UNITYSDK_OFFSET(0x194240C0)
#define RPG_GAMECORE_ADVFILTERNEARBYMONSTERS_METHOD_3_6CAA3F5049DE1E39_OFFSET UNITYSDK_OFFSET(0x19424140)
#define RPG_GAMECORE_ADVFILTERNEARBYMONSTERS__CTOR_OFFSET UNITYSDK_OFFSET(0x19424110)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvFilterNearbyMonsters_TypeDefinitionIndex = 20529;
