...
#define RPG_GAMECORE_FIVEDIMDEFAULTCAMERACONFIG_METHOD_2_467B9CBB559C2364_OFFSET UNITYSDK_OFFSET(0x171EECD0)
#define RPG_GAMECORE_FIVEDIMDEFAULTCAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171EEE50)
...
namespace RPG::GameCore
{
	...
	public:
		...
		static ::System::Void Method_2_467B9CBB559C2364(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::FiveDimDefaultCameraConfig*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::FiveDimDefaultCameraConfig*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_FIVEDIMDEFAULTCAMERACONFIG_METHOD_2_467B9CBB559C2364_OFFSET))(a1, a2);
		}
	};
}
