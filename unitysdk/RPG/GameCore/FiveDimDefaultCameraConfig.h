...
#define RPG_GAMECORE_FIVEDIMDEFAULTCAMERACONFIG_METHOD_2_BC2029E236CAF652_OFFSET UNITYSDK_OFFSET(0x188FCF80)
#define RPG_GAMECORE_FIVEDIMDEFAULTCAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x188FD120)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimDefaultCameraConfig_TypeDefinitionIndex = 15790;
