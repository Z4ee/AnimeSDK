...
#define RPG_GAMECORE_FIVEDIMDEFAULTCAMERACONFIG_METHOD_2_BC2029E236CAF652_OFFSET UNITYSDK_OFFSET(0x1D0DFEF0)
#define RPG_GAMECORE_FIVEDIMDEFAULTCAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0E0090)
