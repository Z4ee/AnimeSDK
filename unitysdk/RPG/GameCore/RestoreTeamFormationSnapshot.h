...
#define RPG_GAMECORE_RESTORETEAMFORMATIONSNAPSHOT_METHOD_3_BE7579FC6241CAF2_OFFSET UNITYSDK_OFFSET(0x19ADB580)
#define RPG_GAMECORE_RESTORETEAMFORMATIONSNAPSHOT_METHOD_3_EC7B59B3615CF064_OFFSET UNITYSDK_OFFSET(0x19ADB620)
#define RPG_GAMECORE_RESTORETEAMFORMATIONSNAPSHOT__CTOR_OFFSET UNITYSDK_OFFSET(0x19ADB5E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RestoreTeamFormationSnapshot_TypeDefinitionIndex = 21260;
