...
#define RPG_GAMECORE_RESTORETEAMFORMATIONSNAPSHOT_METHOD_3_726908AD7939B8E3_OFFSET UNITYSDK_OFFSET(0x1D027AB0)
#define RPG_GAMECORE_RESTORETEAMFORMATIONSNAPSHOT_METHOD_3_EC7B59B3615CF064_OFFSET UNITYSDK_OFFSET(0x1D027B00)
#define RPG_GAMECORE_RESTORETEAMFORMATIONSNAPSHOT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D027AF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RestoreTeamFormationSnapshot_TypeDefinitionIndex = 21675;
