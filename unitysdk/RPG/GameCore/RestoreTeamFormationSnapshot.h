...
#define RPG_GAMECORE_RESTORETEAMFORMATIONSNAPSHOT_METHOD_3_BE7579FC6241CAF2_OFFSET UNITYSDK_OFFSET(0x18CB6F30)
#define RPG_GAMECORE_RESTORETEAMFORMATIONSNAPSHOT_METHOD_3_EC7B59B3615CF064_OFFSET UNITYSDK_OFFSET(0x18CB6FD0)
#define RPG_GAMECORE_RESTORETEAMFORMATIONSNAPSHOT__CTOR_OFFSET UNITYSDK_OFFSET(0x18CB6F90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RestoreTeamFormationSnapshot_TypeDefinitionIndex = 21370;
