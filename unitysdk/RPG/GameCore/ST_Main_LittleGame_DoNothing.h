...
#define RPG_GAMECORE_ST_MAIN_LITTLEGAME_DONOTHING_METHOD_4_A7E31B2440F8D912_OFFSET UNITYSDK_OFFSET(0x19C03680)
#define RPG_GAMECORE_ST_MAIN_LITTLEGAME_DONOTHING_METHOD_4_D3EE5140F7AA7638_OFFSET UNITYSDK_OFFSET(0x19C18DF0)
#define RPG_GAMECORE_ST_MAIN_LITTLEGAME_DONOTHING__CTOR_OFFSET UNITYSDK_OFFSET(0x19C03630)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_LittleGame_DoNothing_TypeDefinitionIndex = 20156;
