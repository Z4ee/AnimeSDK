...
#define RPG_GAMECORE_ST_MAIN_LITTLEGAME_DONOTHING_METHOD_4_571D68C907349489_OFFSET UNITYSDK_OFFSET(0x1B784A90)
#define RPG_GAMECORE_ST_MAIN_LITTLEGAME_DONOTHING_METHOD_4_A7E31B2440F8D912_OFFSET UNITYSDK_OFFSET(0x1B784AD0)
#define RPG_GAMECORE_ST_MAIN_LITTLEGAME_DONOTHING__CTOR_OFFSET UNITYSDK_OFFSET(0x1B784AC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_LittleGame_DoNothing_TypeDefinitionIndex = 20528;
