...
#define RPG_GAMECORE_ST_MAIN_LITTLEGAME_DONOTHING_METHOD_4_A7E31B2440F8D912_OFFSET UNITYSDK_OFFSET(0x18DF2160)
#define RPG_GAMECORE_ST_MAIN_LITTLEGAME_DONOTHING_METHOD_4_D3EE5140F7AA7638_OFFSET UNITYSDK_OFFSET(0x18DF2090)
#define RPG_GAMECORE_ST_MAIN_LITTLEGAME_DONOTHING__CTOR_OFFSET UNITYSDK_OFFSET(0x18DF2110)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_LittleGame_DoNothing_TypeDefinitionIndex = 20306;
