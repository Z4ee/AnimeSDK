...
#define RPG_GAMECORE_CONFIGBAKELAYOUTINFO_METHOD_2_A98A562928C75821_OFFSET UNITYSDK_OFFSET(0x1712C140)
#define RPG_GAMECORE_CONFIGBAKELAYOUTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1712C320)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConfigBakeLayoutInfo_TypeDefinitionIndex = 15055;
