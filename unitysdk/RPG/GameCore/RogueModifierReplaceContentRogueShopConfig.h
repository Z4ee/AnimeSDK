...
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUESHOPCONFIG_METHOD_3_B529F2C2775F1EC5_OFFSET UNITYSDK_OFFSET(0x1D165CE0)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUESHOPCONFIG_METHOD_3_F3E4E3C80E506749_OFFSET UNITYSDK_OFFSET(0x1D165D30)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUESHOPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D165D20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierReplaceContentRogueShopConfig_TypeDefinitionIndex = 16988;
