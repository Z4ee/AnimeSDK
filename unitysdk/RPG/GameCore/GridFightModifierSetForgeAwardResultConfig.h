...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETFORGEAWARDRESULTCONFIG_METHOD_3_0B7BCED490A62815_OFFSET UNITYSDK_OFFSET(0x189BF140)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETFORGEAWARDRESULTCONFIG_METHOD_3_8875B986F7B4253C_OFFSET UNITYSDK_OFFSET(0x189BF070)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETFORGEAWARDRESULTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189BF0F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierSetForgeAwardResultConfig_TypeDefinitionIndex = 18470;
