...
#define RPG_GAMECORE_MARBLESETNEXTSCOREDELTA_METHOD_3_08EE47FF281E430F_OFFSET UNITYSDK_OFFSET(0x1BD22D00)
#define RPG_GAMECORE_MARBLESETNEXTSCOREDELTA_METHOD_3_F3DDF13BA85DB6B3_OFFSET UNITYSDK_OFFSET(0x1BD22C00)
#define RPG_GAMECORE_MARBLESETNEXTSCOREDELTA__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD22CF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleSetNextScoreDelta_TypeDefinitionIndex = 16191;
