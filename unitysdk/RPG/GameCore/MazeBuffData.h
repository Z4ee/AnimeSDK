...
#define RPG_GAMECORE_MAZEBUFFDATA_CANMERGE_OFFSET UNITYSDK_OFFSET(0xB6EB7E0)
#define RPG_GAMECORE_MAZEBUFFDATA_DEEPCOPY_OFFSET UNITYSDK_OFFSET(0xB6EBC10)
#define RPG_GAMECORE_MAZEBUFFDATA_DOMERGE_OFFSET UNITYSDK_OFFSET(0xB6EB640)
#define RPG_GAMECORE_MAZEBUFFDATA_INBATTLEBINDINGEQUALS_OFFSET UNITYSDK_OFFSET(0xB6EBB30)
#define RPG_GAMECORE_MAZEBUFFDATA_VALUEEQUALS_OFFSET UNITYSDK_OFFSET(0xB6EBBA0)
#define RPG_GAMECORE_MAZEBUFFDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB6EB0A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MazeBuffData_TypeDefinitionIndex = 51908;
	...
	public:
		...
		::System::UInt32 OwnerCharacterIndex; // 0x20
