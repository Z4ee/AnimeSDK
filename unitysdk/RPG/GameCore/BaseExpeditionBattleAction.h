...
#define RPG_GAMECORE_BASEEXPEDITIONBATTLEACTION_METHOD_2_0ECAEBB4444C2D25_OFFSET UNITYSDK_OFFSET(0x1CE66D30)
#define RPG_GAMECORE_BASEEXPEDITIONBATTLEACTION_METHOD_2_588B4444C20A8883_OFFSET UNITYSDK_OFFSET(0x1CE66780)
#define RPG_GAMECORE_BASEEXPEDITIONBATTLEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE66D90)
