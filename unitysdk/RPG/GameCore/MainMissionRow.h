...
#define RPG_GAMECORE_MAINMISSIONROW_FROMBINARYWITHOUTNEW_OFFSET UNITYSDK_OFFSET(0x1D48CDA0)
#define RPG_GAMECORE_MAINMISSIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D48D440)
#define RPG_GAMECORE_MAINMISSIONROW_FROMTABLEOFFSET_OFFSET UNITYSDK_OFFSET(0x1D48FE20)
#define RPG_GAMECORE_MAINMISSIONROW_RESET_OFFSET UNITYSDK_OFFSET(0x1D48FE80)
#define RPG_GAMECORE_MAINMISSIONROW__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D48FEB0)
#define RPG_GAMECORE_MAINMISSIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D48FEA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MainMissionRow_TypeDefinitionIndex = 14035;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(MainMissionRow_TypeDefinitionIndex)->GetStaticField(0x3240);
		}
		...
		::Il2CppArray<::RPG::GameCore::MissionCondition*>* BeginParam; // 0x28
		::RPG::GameCore::MainMissionType Type; // 0x30
		::RPG::GameCore::LogicOperation BeginOperation; // 0x34
		::System::UInt32 MissionStoryEvent; // 0x38
		::System::UInt32 DisplayPriority; // 0x3C
		::RPG::GameCore::LogicOperation TakeOperation; // 0x40
		::System::UInt32 DisplayRewardID; // 0x44
		::RPG::GameCore::MainMissionSubType SubType; // 0x48
		::System::Boolean IsInRaid; // 0x4C
		::System::UInt32 MissionAdvance; // 0x50
		::System::UInt32 MissionPack; // 0x54
		::System::UInt32 ChapterID; // 0x58
		::System::UInt32 TrackWeight; // 0x5C
		::System::UInt32 MainMissionID; // 0x60
		::System::UInt32 NextTrackMainMission; // 0x64
		::RPG::Client::TextID Name; // 0x68
		::System::UInt32 RewardID; // 0x78
		::System::UInt32 WorldID; // 0x7C
