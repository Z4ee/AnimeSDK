...
#define RPG_GAMECORE_MAINMISSIONROW_FROMBINARYWITHOUTNEW_OFFSET UNITYSDK_OFFSET(0x1BCD6770)
#define RPG_GAMECORE_MAINMISSIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1BCD6E10)
#define RPG_GAMECORE_MAINMISSIONROW_FROMTABLEOFFSET_OFFSET UNITYSDK_OFFSET(0x1BCD97F0)
#define RPG_GAMECORE_MAINMISSIONROW_RESET_OFFSET UNITYSDK_OFFSET(0x1BCD9850)
#define RPG_GAMECORE_MAINMISSIONROW__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BCD9890)
#define RPG_GAMECORE_MAINMISSIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCD9880)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MainMissionRow_TypeDefinitionIndex = 13618;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(MainMissionRow_TypeDefinitionIndex)->GetStaticField(0x3D9C0);
		}
		::Il2CppArray<::RPG::GameCore::MissionCondition*>* BeginParam; // 0x10
		...
		::System::Boolean IsInRaid; // 0x30
		::System::UInt32 MissionStoryEvent; // 0x34
		::System::UInt32 MissionPack; // 0x38
		::System::UInt32 MainMissionID; // 0x3C
		::System::UInt32 ChapterID; // 0x40
		::System::UInt32 DisplayPriority; // 0x44
		::RPG::GameCore::MainMissionType Type; // 0x48
		::System::UInt32 WorldID; // 0x4C
		::RPG::GameCore::LogicOperation BeginOperation; // 0x50
		::RPG::GameCore::MainMissionSubType SubType; // 0x54
		...
		::System::UInt32 MissionAdvance; // 0x74
		::System::UInt32 NextTrackMainMission; // 0x78
		::System::UInt32 DisplayRewardID; // 0x7C
