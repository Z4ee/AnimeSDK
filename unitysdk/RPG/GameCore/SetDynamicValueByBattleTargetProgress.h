...
#define RPG_GAMECORE_SETDYNAMICVALUEBYBATTLETARGETPROGRESS_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x19C40790)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBATTLETARGETPROGRESS_METHOD_4_0C621928E42A7E4E_OFFSET UNITYSDK_OFFSET(0x19C40710)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBATTLETARGETPROGRESS_METHOD_4_9A2EB539ED1C2F52_OFFSET UNITYSDK_OFFSET(0x19C37360)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBATTLETARGETPROGRESS__CTOR_OFFSET UNITYSDK_OFFSET(0x19C37310)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByBattleTargetProgress_TypeDefinitionIndex = 21919;
