...
#define RPG_GAMECORE_SETDYNAMICVALUEBYBATTLETARGETPROGRESS_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1C2DF870)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBATTLETARGETPROGRESS_METHOD_4_0B1BEF95F4BD7DFB_OFFSET UNITYSDK_OFFSET(0x1C2DF620)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBATTLETARGETPROGRESS_METHOD_4_9A2EB539ED1C2F52_OFFSET UNITYSDK_OFFSET(0x1C2DF660)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBATTLETARGETPROGRESS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2DF650)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByBattleTargetProgress_TypeDefinitionIndex = 22348;
