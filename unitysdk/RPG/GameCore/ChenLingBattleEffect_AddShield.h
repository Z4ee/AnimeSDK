...
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_ADDSHIELD_METHOD_3_9EE722E1F4504519_OFFSET UNITYSDK_OFFSET(0x196206E0)
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_ADDSHIELD_METHOD_3_FE40ADB3BE7AE4E5_OFFSET UNITYSDK_OFFSET(0x19620610)
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_ADDSHIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x196206D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleEffect_AddShield_TypeDefinitionIndex = 15014;
