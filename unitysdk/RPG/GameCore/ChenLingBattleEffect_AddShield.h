...
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_ADDSHIELD_METHOD_3_9EE722E1F4504519_OFFSET UNITYSDK_OFFSET(0x1707DBC0)
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_ADDSHIELD_METHOD_3_FE40ADB3BE7AE4E5_OFFSET UNITYSDK_OFFSET(0x1707DAF0)
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_ADDSHIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x1707DBB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleEffect_AddShield_TypeDefinitionIndex = 14481;
