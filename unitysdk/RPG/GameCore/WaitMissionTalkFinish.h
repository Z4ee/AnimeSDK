...
#define RPG_GAMECORE_WAITMISSIONTALKFINISH_METHOD_3_856C3D9F2B5A12BF_OFFSET UNITYSDK_OFFSET(0x178FE170)
#define RPG_GAMECORE_WAITMISSIONTALKFINISH_METHOD_3_D9761DE28CC10713_OFFSET UNITYSDK_OFFSET(0x178FE280)
#define RPG_GAMECORE_WAITMISSIONTALKFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x178FE250)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitMissionTalkFinish_TypeDefinitionIndex = 22083;
