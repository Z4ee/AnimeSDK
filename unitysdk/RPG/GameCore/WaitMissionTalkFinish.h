...
#define RPG_GAMECORE_WAITMISSIONTALKFINISH_METHOD_3_856C3D9F2B5A12BF_OFFSET UNITYSDK_OFFSET(0x19102060)
#define RPG_GAMECORE_WAITMISSIONTALKFINISH_METHOD_3_D9761DE28CC10713_OFFSET UNITYSDK_OFFSET(0x19102170)
#define RPG_GAMECORE_WAITMISSIONTALKFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x19102140)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitMissionTalkFinish_TypeDefinitionIndex = 22800;
