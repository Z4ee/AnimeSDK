...
#define RPG_GAMECORE_TWINKLEFLIPPERLIGHTDEVICE_METHOD_3_2C309C27B5AC71C1_OFFSET UNITYSDK_OFFSET(0x19E2F2E0)
#define RPG_GAMECORE_TWINKLEFLIPPERLIGHTDEVICE_METHOD_3_78D73FDE4C79BEED_OFFSET UNITYSDK_OFFSET(0x19E2F200)
#define RPG_GAMECORE_TWINKLEFLIPPERLIGHTDEVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x19E2F280)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TwinkleFlipperLightDevice_TypeDefinitionIndex = 21113;
