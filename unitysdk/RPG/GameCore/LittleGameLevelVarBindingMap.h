...
#define RPG_GAMECORE_LITTLEGAMELEVELVARBINDINGMAP_METHOD_2_37B472C4731F0FFD_OFFSET UNITYSDK_OFFSET(0x1D203B10)
#define RPG_GAMECORE_LITTLEGAMELEVELVARBINDINGMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D203BD0)
