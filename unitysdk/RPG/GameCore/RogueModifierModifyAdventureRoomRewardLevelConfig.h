...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYADVENTUREROOMREWARDLEVELCONFIG_METHOD_3_25FA5828DEDE7372_OFFSET UNITYSDK_OFFSET(0x18D3FE20)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYADVENTUREROOMREWARDLEVELCONFIG_METHOD_3_9430A666EEC6C0FB_OFFSET UNITYSDK_OFFSET(0x18D3FD50)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYADVENTUREROOMREWARDLEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D3FDD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyAdventureRoomRewardLevelConfig_TypeDefinitionIndex = 16854;
