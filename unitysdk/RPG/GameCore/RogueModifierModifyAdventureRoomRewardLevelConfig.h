...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYADVENTUREROOMREWARDLEVELCONFIG_METHOD_3_25FA5828DEDE7372_OFFSET UNITYSDK_OFFSET(0x1EEFA2E0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYADVENTUREROOMREWARDLEVELCONFIG_METHOD_3_407CE17F4ECDFD96_OFFSET UNITYSDK_OFFSET(0x1EEFA290)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYADVENTUREROOMREWARDLEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEFA2D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyAdventureRoomRewardLevelConfig_TypeDefinitionIndex = 17534;
