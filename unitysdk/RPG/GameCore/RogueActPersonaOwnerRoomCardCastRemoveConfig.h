...
#define RPG_GAMECORE_ROGUEACTPERSONAOWNERROOMCARDCASTREMOVECONFIG_METHOD_7_0DF40DE8132CF88B_OFFSET UNITYSDK_OFFSET(0x19AEE6D0)
#define RPG_GAMECORE_ROGUEACTPERSONAOWNERROOMCARDCASTREMOVECONFIG_METHOD_7_B0D307F030ECC84E_OFFSET UNITYSDK_OFFSET(0x19AEE160)
#define RPG_GAMECORE_ROGUEACTPERSONAOWNERROOMCARDCASTREMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AEE080)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaOwnerRoomCardCastRemoveConfig_TypeDefinitionIndex = 18720;
