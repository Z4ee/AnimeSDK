...
#define RPG_GAMECORE_ROGUEACTPERSONAOWNERROOMCARDCASTREMOVECONFIG_METHOD_7_0DF40DE8132CF88B_OFFSET UNITYSDK_OFFSET(0x18CCA240)
#define RPG_GAMECORE_ROGUEACTPERSONAOWNERROOMCARDCASTREMOVECONFIG_METHOD_7_B0D307F030ECC84E_OFFSET UNITYSDK_OFFSET(0x18CC9CD0)
#define RPG_GAMECORE_ROGUEACTPERSONAOWNERROOMCARDCASTREMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CC9BF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaOwnerRoomCardCastRemoveConfig_TypeDefinitionIndex = 18753;
