...
#define RPG_GAMECORE_PIXAIRPLANEPRESETCONFIG_METHOD_2_8CB068B9A354A1A1_OFFSET UNITYSDK_OFFSET(0x19A12FE0)
#define RPG_GAMECORE_PIXAIRPLANEPRESETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19A13CF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PixAirPlanePresetConfig_TypeDefinitionIndex = 15434;
