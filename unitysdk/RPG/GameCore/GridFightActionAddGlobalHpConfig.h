...
#define RPG_GAMECORE_GRIDFIGHTACTIONADDGLOBALHPCONFIG_METHOD_6_568216F7E0A853DA_OFFSET UNITYSDK_OFFSET(0x1D95F0F0)
#define RPG_GAMECORE_GRIDFIGHTACTIONADDGLOBALHPCONFIG_METHOD_6_A6BF74DE76D04F9E_OFFSET UNITYSDK_OFFSET(0x1D95F0A0)
#define RPG_GAMECORE_GRIDFIGHTACTIONADDGLOBALHPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D95F0E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightActionAddGlobalHpConfig_TypeDefinitionIndex = 19065;
