...
#define RPG_GAMECORE_ELFFOODEVENTCONFIG_METHOD_2_A787CE09D77BAF01_OFFSET UNITYSDK_OFFSET(0x1889C3A0)
#define RPG_GAMECORE_ELFFOODEVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1889C520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfFoodEventConfig_TypeDefinitionIndex = 17540;
