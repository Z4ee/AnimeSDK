...
#define RPG_GAMECORE_ELFFOODEVENTCONFIG_METHOD_2_A787CE09D77BAF01_OFFSET UNITYSDK_OFFSET(0x1718EC70)
#define RPG_GAMECORE_ELFFOODEVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1718EDF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfFoodEventConfig_TypeDefinitionIndex = 16946;
