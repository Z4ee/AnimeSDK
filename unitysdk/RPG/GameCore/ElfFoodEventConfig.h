...
#define RPG_GAMECORE_ELFFOODEVENTCONFIG_METHOD_2_A787CE09D77BAF01_OFFSET UNITYSDK_OFFSET(0x196DAB30)
#define RPG_GAMECORE_ELFFOODEVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x196DACB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfFoodEventConfig_TypeDefinitionIndex = 17566;
