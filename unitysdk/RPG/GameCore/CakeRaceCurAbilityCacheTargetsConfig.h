...
#define RPG_GAMECORE_CAKERACECURABILITYCACHETARGETSCONFIG_METHOD_3_4DF430BE75D27BDA_OFFSET UNITYSDK_OFFSET(0x18770580)
#define RPG_GAMECORE_CAKERACECURABILITYCACHETARGETSCONFIG_METHOD_3_AD1508E6A6211DFB_OFFSET UNITYSDK_OFFSET(0x1876E280)
#define RPG_GAMECORE_CAKERACECURABILITYCACHETARGETSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1876E270)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceCurAbilityCacheTargetsConfig_TypeDefinitionIndex = 17486;
