...
#define RPG_GAMECORE_LEVELDATACOMPONENT_WAVEMONSTERSEQUENCE_GET_MAXCOUNT_OFFSET UNITYSDK_OFFSET(0xB6D4D40)
#define RPG_GAMECORE_LEVELDATACOMPONENT_WAVEMONSTERSEQUENCE_GET_PASSCOUNT_OFFSET UNITYSDK_OFFSET(0xB6D5270)
#define RPG_GAMECORE_LEVELDATACOMPONENT_WAVEMONSTERSEQUENCE_GET_SUMMONEDCOUNT_OFFSET UNITYSDK_OFFSET(0xB6D4F40)
#define RPG_GAMECORE_LEVELDATACOMPONENT_WAVEMONSTERSEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0xB6CFDA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelDataComponent_WaveMonsterSequence_TypeDefinitionIndex = 53095;
