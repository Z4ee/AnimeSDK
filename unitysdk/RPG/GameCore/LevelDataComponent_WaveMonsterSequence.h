...
#define RPG_GAMECORE_LEVELDATACOMPONENT_WAVEMONSTERSEQUENCE_GET_MAXCOUNT_OFFSET UNITYSDK_OFFSET(0xE690390)
#define RPG_GAMECORE_LEVELDATACOMPONENT_WAVEMONSTERSEQUENCE_GET_PASSCOUNT_OFFSET UNITYSDK_OFFSET(0xE690880)
#define RPG_GAMECORE_LEVELDATACOMPONENT_WAVEMONSTERSEQUENCE_GET_SUMMONEDCOUNT_OFFSET UNITYSDK_OFFSET(0xE690580)
#define RPG_GAMECORE_LEVELDATACOMPONENT_WAVEMONSTERSEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0xE68ACC0)
