...
#define RPG_GAMECORE_BATTLETUTORIALDYNAMICVALUEPARAM_METHOD_3_44B0A91649C3F8F8_OFFSET UNITYSDK_OFFSET(0x1B3082E0)
#define RPG_GAMECORE_BATTLETUTORIALDYNAMICVALUEPARAM_METHOD_3_B323F33FE0DFD16C_OFFSET UNITYSDK_OFFSET(0x1B308200)
#define RPG_GAMECORE_BATTLETUTORIALDYNAMICVALUEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3082D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleTutorialDynamicValueParam_TypeDefinitionIndex = 24046;
