...
#define RPG_GAMECORE_BATTLETUTORIALDYNAMICVALUEPARAM_METHOD_3_44B0A91649C3F8F8_OFFSET UNITYSDK_OFFSET(0x1A3FA6A0)
#define RPG_GAMECORE_BATTLETUTORIALDYNAMICVALUEPARAM_METHOD_3_B323F33FE0DFD16C_OFFSET UNITYSDK_OFFSET(0x1A3FA5C0)
#define RPG_GAMECORE_BATTLETUTORIALDYNAMICVALUEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3FA690)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleTutorialDynamicValueParam_TypeDefinitionIndex = 23464;
