...
#define RPG_GAMECORE_PLAYPENACONYENDMOSTSCALE_METHOD_3_61D147E37450769A_OFFSET UNITYSDK_OFFSET(0x1D7A6FA0)
#define RPG_GAMECORE_PLAYPENACONYENDMOSTSCALE_METHOD_3_C2024F7DAFA645CD_OFFSET UNITYSDK_OFFSET(0x1D7A6FE0)
#define RPG_GAMECORE_PLAYPENACONYENDMOSTSCALE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7A6FD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayPenaconyEndmostScale_TypeDefinitionIndex = 21579;
