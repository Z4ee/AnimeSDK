...
#define RPG_GAMECORE_MARBLEFIELDCOMPONENTCONFIG_METHOD_3_9D9E2BC0CF699F39_OFFSET UNITYSDK_OFFSET(0x1738DDE0)
#define RPG_GAMECORE_MARBLEFIELDCOMPONENTCONFIG_METHOD_3_A61FD3697014BDD4_OFFSET UNITYSDK_OFFSET(0x1738DE70)
#define RPG_GAMECORE_MARBLEFIELDCOMPONENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1738DE50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleFieldComponentConfig_TypeDefinitionIndex = 17349;
