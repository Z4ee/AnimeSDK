...
#define RPG_GAMECORE_TARGETMAPSUMMONEDMINIONS_METHOD_3_1A7DAC2A284C8195_OFFSET UNITYSDK_OFFSET(0x177C40B0)
#define RPG_GAMECORE_TARGETMAPSUMMONEDMINIONS_METHOD_3_6D76543FDC3D64CC_OFFSET UNITYSDK_OFFSET(0x177C4170)
#define RPG_GAMECORE_TARGETMAPSUMMONEDMINIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x177C4150)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapSummonedMinions_TypeDefinitionIndex = 22231;
