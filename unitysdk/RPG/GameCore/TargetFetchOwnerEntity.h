...
#define RPG_GAMECORE_TARGETFETCHOWNERENTITY_METHOD_4_10F2684111BDACA3_OFFSET UNITYSDK_OFFSET(0x1D0BBAA0)
#define RPG_GAMECORE_TARGETFETCHOWNERENTITY_METHOD_4_476DFA9AE99E7987_OFFSET UNITYSDK_OFFSET(0x1D0BB9C0)
#define RPG_GAMECORE_TARGETFETCHOWNERENTITY_METHOD_4_95FE3DE17BFEE216_OFFSET UNITYSDK_OFFSET(0x1D0BBA40)
#define RPG_GAMECORE_TARGETFETCHOWNERENTITY_METHOD_4_F9956A196E297DB6_OFFSET UNITYSDK_OFFSET(0x1D0BBAC0)
#define RPG_GAMECORE_TARGETFETCHOWNERENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0BBA30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchOwnerEntity_TypeDefinitionIndex = 23121;
