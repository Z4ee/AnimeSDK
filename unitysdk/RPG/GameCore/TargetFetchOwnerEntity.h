...
#define RPG_GAMECORE_TARGETFETCHOWNERENTITY_METHOD_4_853F5B059CAEF954_OFFSET UNITYSDK_OFFSET(0x177BFA10)
#define RPG_GAMECORE_TARGETFETCHOWNERENTITY_METHOD_4_95FE3DE17BFEE216_OFFSET UNITYSDK_OFFSET(0x177B72A0)
#define RPG_GAMECORE_TARGETFETCHOWNERENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x177B7250)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchOwnerEntity_TypeDefinitionIndex = 22253;
