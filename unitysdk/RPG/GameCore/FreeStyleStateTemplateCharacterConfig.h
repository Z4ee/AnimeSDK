...
#define RPG_GAMECORE_FREESTYLESTATETEMPLATECHARACTERCONFIG_METHOD_2_A0AD0E18049BAC8B_OFFSET UNITYSDK_OFFSET(0x17220D50)
#define RPG_GAMECORE_FREESTYLESTATETEMPLATECHARACTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17220D90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FreeStyleStateTemplateCharacterConfig_TypeDefinitionIndex = 14932;
