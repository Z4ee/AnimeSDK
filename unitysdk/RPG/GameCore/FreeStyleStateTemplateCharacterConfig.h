...
#define RPG_GAMECORE_FREESTYLESTATETEMPLATECHARACTERCONFIG_METHOD_2_A0AD0E18049BAC8B_OFFSET UNITYSDK_OFFSET(0x189334E0)
#define RPG_GAMECORE_FREESTYLESTATETEMPLATECHARACTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18933520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FreeStyleStateTemplateCharacterConfig_TypeDefinitionIndex = 15439;
