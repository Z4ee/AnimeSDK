...
#define RPG_GAMECORE_FREESTYLESTATETEMPLATECHARACTERCONFIG_METHOD_2_A0AD0E18049BAC8B_OFFSET UNITYSDK_OFFSET(0x1B980A90)
#define RPG_GAMECORE_FREESTYLESTATETEMPLATECHARACTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B980AD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FreeStyleStateTemplateCharacterConfig_TypeDefinitionIndex = 15673;
