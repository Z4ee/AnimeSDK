...
#define RPG_GAMECORE_MAZEITEMUSEBUFFDROPCONFIG_METHOD_2_9FDF98F9D53E4D99_OFFSET UNITYSDK_OFFSET(0x1D27A6F0)
#define RPG_GAMECORE_MAZEITEMUSEBUFFDROPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D27A730)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MazeItemUseBuffDropConfig_TypeDefinitionIndex = 21510;
