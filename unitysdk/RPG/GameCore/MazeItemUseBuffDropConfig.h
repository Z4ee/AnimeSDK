...
#define RPG_GAMECORE_MAZEITEMUSEBUFFDROPCONFIG_METHOD_2_9FDF98F9D53E4D99_OFFSET UNITYSDK_OFFSET(0x18AD1680)
#define RPG_GAMECORE_MAZEITEMUSEBUFFDROPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18AD16C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MazeItemUseBuffDropConfig_TypeDefinitionIndex = 20604;
