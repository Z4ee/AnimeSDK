...
#define RPG_GAMECORE_MAZEITEMUSEBUFFDROPCONFIG_METHOD_2_9FDF98F9D53E4D99_OFFSET UNITYSDK_OFFSET(0x173C32C0)
#define RPG_GAMECORE_MAZEITEMUSEBUFFDROPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x173C3300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MazeItemUseBuffDropConfig_TypeDefinitionIndex = 19923;
