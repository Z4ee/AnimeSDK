...
#define RPG_GAMECORE_DEPLOYMAPPOSESWITCHER_METHOD_3_89BC49258C2DCC17_OFFSET UNITYSDK_OFFSET(0x188596E0)
#define RPG_GAMECORE_DEPLOYMAPPOSESWITCHER_METHOD_3_A66422DD06DB4866_OFFSET UNITYSDK_OFFSET(0x18859660)
#define RPG_GAMECORE_DEPLOYMAPPOSESWITCHER__CTOR_OFFSET UNITYSDK_OFFSET(0x188596B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DeployMapPoseSwitcher_TypeDefinitionIndex = 19908;
