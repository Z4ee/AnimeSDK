...
#define RPG_GAMECORE_DEPLOYMAPPOSESWITCHER_METHOD_3_89BC49258C2DCC17_OFFSET UNITYSDK_OFFSET(0x171524A0)
#define RPG_GAMECORE_DEPLOYMAPPOSESWITCHER_METHOD_3_A66422DD06DB4866_OFFSET UNITYSDK_OFFSET(0x17152420)
#define RPG_GAMECORE_DEPLOYMAPPOSESWITCHER__CTOR_OFFSET UNITYSDK_OFFSET(0x17152470)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DeployMapPoseSwitcher_TypeDefinitionIndex = 19249;
