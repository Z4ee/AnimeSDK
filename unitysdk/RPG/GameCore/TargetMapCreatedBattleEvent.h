...
#define RPG_GAMECORE_TARGETMAPCREATEDBATTLEEVENT_METHOD_3_4DF4965030F2B6C9_OFFSET UNITYSDK_OFFSET(0x1D0C1B30)
#define RPG_GAMECORE_TARGETMAPCREATEDBATTLEEVENT_METHOD_3_89B37CFD8F3B084F_OFFSET UNITYSDK_OFFSET(0x1D0C1AB0)
#define RPG_GAMECORE_TARGETMAPCREATEDBATTLEEVENT_METHOD_3_8E7758F8E6644BFC_OFFSET UNITYSDK_OFFSET(0x1D0C1B10)
#define RPG_GAMECORE_TARGETMAPCREATEDBATTLEEVENT_METHOD_3_C03EDE20CA63CFDE_OFFSET UNITYSDK_OFFSET(0x1D0C1A30)
#define RPG_GAMECORE_TARGETMAPCREATEDBATTLEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0C1AA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapCreatedBattleEvent_TypeDefinitionIndex = 23077;
