...
#define RPG_GAMECORE_TARGETMAPCREATEDBATTLEEVENT_METHOD_3_89B37CFD8F3B084F_OFFSET UNITYSDK_OFFSET(0x177C2970)
#define RPG_GAMECORE_TARGETMAPCREATEDBATTLEEVENT_METHOD_3_BFCB717AF3AAC8C2_OFFSET UNITYSDK_OFFSET(0x177C28B0)
#define RPG_GAMECORE_TARGETMAPCREATEDBATTLEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x177C2950)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapCreatedBattleEvent_TypeDefinitionIndex = 22209;
