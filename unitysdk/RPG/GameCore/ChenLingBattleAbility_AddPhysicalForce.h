...
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_ADDPHYSICALFORCE_METHOD_3_5C57FB614F6FC6A6_OFFSET UNITYSDK_OFFSET(0x1CFA4560)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_ADDPHYSICALFORCE_METHOD_3_CDF3693EE0A0F9DC_OFFSET UNITYSDK_OFFSET(0x1CFA4500)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_ADDPHYSICALFORCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFA4550)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleAbility_AddPhysicalForce_TypeDefinitionIndex = 15562;
