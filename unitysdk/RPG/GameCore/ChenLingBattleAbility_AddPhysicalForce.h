...
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_ADDPHYSICALFORCE_METHOD_3_5C57FB614F6FC6A6_OFFSET UNITYSDK_OFFSET(0x1961B940)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_ADDPHYSICALFORCE_METHOD_3_CDF3693EE0A0F9DC_OFFSET UNITYSDK_OFFSET(0x1961B8E0)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_ADDPHYSICALFORCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1961B930)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleAbility_AddPhysicalForce_TypeDefinitionIndex = 14961;
