...
#define RPG_GAMECORE_SPECIALNPCEFFECTCONFIG_METHOD_3_8A5BAC48951E68E8_OFFSET UNITYSDK_OFFSET(0x1775E1D0)
#define RPG_GAMECORE_SPECIALNPCEFFECTCONFIG_METHOD_3_F543E08A2401D12D_OFFSET UNITYSDK_OFFSET(0x1775E190)
#define RPG_GAMECORE_SPECIALNPCEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1775E1C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SpecialNPCEffectConfig_TypeDefinitionIndex = 15596;
