...
#define RPG_GAMECORE_SPECIALNPCEFFECTCONFIG_METHOD_3_2DE22C5499B5E436_OFFSET UNITYSDK_OFFSET(0x1B0A2610)
#define RPG_GAMECORE_SPECIALNPCEFFECTCONFIG_METHOD_3_69122D3048D1417B_OFFSET UNITYSDK_OFFSET(0x1B0A25D0)
#define RPG_GAMECORE_SPECIALNPCEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0A2600)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SpecialNPCEffectConfig_TypeDefinitionIndex = 16349;
