...
#define RPG_GAMECORE_SPECIALNPCEFFECTCONFIG_METHOD_3_2DE22C5499B5E436_OFFSET UNITYSDK_OFFSET(0x19C9E790)
#define RPG_GAMECORE_SPECIALNPCEFFECTCONFIG_METHOD_3_69122D3048D1417B_OFFSET UNITYSDK_OFFSET(0x19C9E750)
#define RPG_GAMECORE_SPECIALNPCEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19C9E780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SpecialNPCEffectConfig_TypeDefinitionIndex = 16165;
