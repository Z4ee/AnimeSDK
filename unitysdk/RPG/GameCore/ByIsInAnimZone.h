...
#define RPG_GAMECORE_BYISINANIMZONE_METHOD_4_B695D30DB5B3DCC9_OFFSET UNITYSDK_OFFSET(0x1702EF30)
#define RPG_GAMECORE_BYISINANIMZONE_METHOD_4_B9DB4CDBE408E815_OFFSET UNITYSDK_OFFSET(0x1702EE60)
#define RPG_GAMECORE_BYISINANIMZONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1702EEE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsInAnimZone_TypeDefinitionIndex = 18525;
