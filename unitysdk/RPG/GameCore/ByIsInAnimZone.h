...
#define RPG_GAMECORE_BYISINANIMZONE_METHOD_4_11C65EC5ED91E9C9_OFFSET UNITYSDK_OFFSET(0x1CDA2A50)
#define RPG_GAMECORE_BYISINANIMZONE_METHOD_4_52C02FA23CF48614_OFFSET UNITYSDK_OFFSET(0x1CDA2840)
#define RPG_GAMECORE_BYISINANIMZONE_METHOD_4_A1660B9018A62E4F_OFFSET UNITYSDK_OFFSET(0x1CDA2A80)
#define RPG_GAMECORE_BYISINANIMZONE_METHOD_4_B695D30DB5B3DCC9_OFFSET UNITYSDK_OFFSET(0x1CDA2880)
#define RPG_GAMECORE_BYISINANIMZONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDA2870)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsInAnimZone_TypeDefinitionIndex = 20005;
