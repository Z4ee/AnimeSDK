...
#define RPG_GAMECORE_FSVOVERRIDITEM_METHOD_2_C24ADD1F0F0D94E3_OFFSET UNITYSDK_OFFSET(0x1C06F530)
#define RPG_GAMECORE_FSVOVERRIDITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1C06F680)
