...
#define RPG_GAMECORE_FSVOVERRIDITEM_METHOD_2_C24ADD1F0F0D94E3_OFFSET UNITYSDK_OFFSET(0x188C9980)
#define RPG_GAMECORE_FSVOVERRIDITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x188C9AD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FSVOverridItem_TypeDefinitionIndex = 18065;
