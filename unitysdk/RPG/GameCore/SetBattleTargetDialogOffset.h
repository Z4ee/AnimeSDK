...
#define RPG_GAMECORE_SETBATTLETARGETDIALOGOFFSET_METHOD_3_50DD636B66936149_OFFSET UNITYSDK_OFFSET(0x1D4E3B40)
#define RPG_GAMECORE_SETBATTLETARGETDIALOGOFFSET_METHOD_3_FE2DE4C65872F9D2_OFFSET UNITYSDK_OFFSET(0x1D4E3B80)
#define RPG_GAMECORE_SETBATTLETARGETDIALOGOFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4E3B70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetBattleTargetDialogOffset_TypeDefinitionIndex = 22984;
