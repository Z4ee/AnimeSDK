...
#define RPG_GAMECORE_SETBATTLETARGETDIALOGOFFSET_METHOD_3_A68EEBCBE2E2597B_OFFSET UNITYSDK_OFFSET(0x176AA550)
#define RPG_GAMECORE_SETBATTLETARGETDIALOGOFFSET_METHOD_3_FE2DE4C65872F9D2_OFFSET UNITYSDK_OFFSET(0x176AA5D0)
#define RPG_GAMECORE_SETBATTLETARGETDIALOGOFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x176AA5A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetBattleTargetDialogOffset_TypeDefinitionIndex = 21476;
