...
#define RPG_GAMECORE_FATEMODIFIERENABLESPECIALAVATARCONFIG_METHOD_3_6CDE433AB40F842A_OFFSET UNITYSDK_OFFSET(0x197124F0)
#define RPG_GAMECORE_FATEMODIFIERENABLESPECIALAVATARCONFIG_METHOD_3_96E0F17E104B9FE3_OFFSET UNITYSDK_OFFSET(0x19710D30)
#define RPG_GAMECORE_FATEMODIFIERENABLESPECIALAVATARCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19710CE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateModifierEnableSpecialAvatarConfig_TypeDefinitionIndex = 18277;
