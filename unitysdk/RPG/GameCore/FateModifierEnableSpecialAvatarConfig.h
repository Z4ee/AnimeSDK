...
#define RPG_GAMECORE_FATEMODIFIERENABLESPECIALAVATARCONFIG_METHOD_3_719F47562FDEBFDF_OFFSET UNITYSDK_OFFSET(0x1E0CDBD0)
#define RPG_GAMECORE_FATEMODIFIERENABLESPECIALAVATARCONFIG_METHOD_3_96E0F17E104B9FE3_OFFSET UNITYSDK_OFFSET(0x1E0CDC20)
#define RPG_GAMECORE_FATEMODIFIERENABLESPECIALAVATARCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0CDC10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateModifierEnableSpecialAvatarConfig_TypeDefinitionIndex = 19037;
