...
#define RPG_GAMECORE_BYCOMPAREHEARTDIALSCRIPTEMO_METHOD_4_24B6FA4C1FFC270A_OFFSET UNITYSDK_OFFSET(0x1872F9F0)
#define RPG_GAMECORE_BYCOMPAREHEARTDIALSCRIPTEMO_METHOD_4_CA6AD7D4B8A0F7FC_OFFSET UNITYSDK_OFFSET(0x1872FAC0)
#define RPG_GAMECORE_BYCOMPAREHEARTDIALSCRIPTEMO__CTOR_OFFSET UNITYSDK_OFFSET(0x1872FA70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareHeartDialScriptEmo_TypeDefinitionIndex = 20747;
