...
#define RPG_GAMECORE_ATTACHNISHASTAGAITEMTOSCENE_METHOD_3_45EC3D352790AA75_OFFSET UNITYSDK_OFFSET(0x16F8A720)
#define RPG_GAMECORE_ATTACHNISHASTAGAITEMTOSCENE_METHOD_3_69320F40B2B5DA1A_OFFSET UNITYSDK_OFFSET(0x16F8A6A0)
#define RPG_GAMECORE_ATTACHNISHASTAGAITEMTOSCENE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F8A6F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AttachNishastagaItemToScene_TypeDefinitionIndex = 20326;
