...
#define RPG_GAMECORE_ATTACHNISHASTAGAITEMTOSCENE_METHOD_3_45EC3D352790AA75_OFFSET UNITYSDK_OFFSET(0x1C57AB30)
#define RPG_GAMECORE_ATTACHNISHASTAGAITEMTOSCENE_METHOD_3_DFBE4C43E1AB49F6_OFFSET UNITYSDK_OFFSET(0x1C57AAF0)
#define RPG_GAMECORE_ATTACHNISHASTAGAITEMTOSCENE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C57AB20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AttachNishastagaItemToScene_TypeDefinitionIndex = 21893;
