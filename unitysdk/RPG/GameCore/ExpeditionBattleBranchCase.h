...
#define RPG_GAMECORE_EXPEDITIONBATTLEBRANCHCASE_METHOD_2_44FF08DF91B74BF0_OFFSET UNITYSDK_OFFSET(0x1D7DAD50)
#define RPG_GAMECORE_EXPEDITIONBATTLEBRANCHCASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7DAF20)
