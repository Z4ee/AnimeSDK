...
#define RPG_GAMECORE_ROGUEACTREMOVEROGUEMIRACLECONFIG_METHOD_6_7AC09978DA445911_OFFSET UNITYSDK_OFFSET(0x1C49DAE0)
#define RPG_GAMECORE_ROGUEACTREMOVEROGUEMIRACLECONFIG_METHOD_6_7F004D16E920E935_OFFSET UNITYSDK_OFFSET(0x1C49DB30)
#define RPG_GAMECORE_ROGUEACTREMOVEROGUEMIRACLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C49DB20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActRemoveRogueMiracleConfig_TypeDefinitionIndex = 18851;
