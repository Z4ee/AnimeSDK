...
#define RPG_GAMECORE_TRIGGERSDFTEXTEFFECT_METHOD_4_4BFC73E1E6DE1378_OFFSET UNITYSDK_OFFSET(0x1D605F60)
#define RPG_GAMECORE_TRIGGERSDFTEXTEFFECT_METHOD_4_67137DCE65BFE32C_OFFSET UNITYSDK_OFFSET(0x1D604C00)
#define RPG_GAMECORE_TRIGGERSDFTEXTEFFECT_METHOD_4_6AF613AFDA0FD020_OFFSET UNITYSDK_OFFSET(0x1D604CC0)
#define RPG_GAMECORE_TRIGGERSDFTEXTEFFECT_METHOD_4_D45C30B15CD0A2DC_OFFSET UNITYSDK_OFFSET(0x1D605EF0)
#define RPG_GAMECORE_TRIGGERSDFTEXTEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D604C70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerSDFTextEffect_TypeDefinitionIndex = 23365;
