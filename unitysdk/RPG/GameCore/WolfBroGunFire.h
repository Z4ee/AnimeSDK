...
#define RPG_GAMECORE_WOLFBROGUNFIRE_METHOD_3_3743F157271959A4_OFFSET UNITYSDK_OFFSET(0x1D6B2C30)
#define RPG_GAMECORE_WOLFBROGUNFIRE_METHOD_3_8FE6202D3AE7ECEB_OFFSET UNITYSDK_OFFSET(0x1D6B2C70)
#define RPG_GAMECORE_WOLFBROGUNFIRE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6B2C60)
