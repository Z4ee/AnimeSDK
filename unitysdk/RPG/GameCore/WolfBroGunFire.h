...
#define RPG_GAMECORE_WOLFBROGUNFIRE_METHOD_3_3743F157271959A4_OFFSET UNITYSDK_OFFSET(0x1D1C2A20)
#define RPG_GAMECORE_WOLFBROGUNFIRE_METHOD_3_8FE6202D3AE7ECEB_OFFSET UNITYSDK_OFFSET(0x1D1C2A60)
#define RPG_GAMECORE_WOLFBROGUNFIRE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1C2A50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WolfBroGunFire_TypeDefinitionIndex = 19395;
