...
#define RPG_GAMECORE_OBSOLETE_METHOD_3_601E5534EC2E5D75_OFFSET UNITYSDK_OFFSET(0x18BC2DD0)
#define RPG_GAMECORE_OBSOLETE_METHOD_3_FFB7270A603CA904_OFFSET UNITYSDK_OFFSET(0x18BC2D50)
#define RPG_GAMECORE_OBSOLETE__CTOR_OFFSET UNITYSDK_OFFSET(0x18BC2DA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int Obsolete_TypeDefinitionIndex = 22755;
