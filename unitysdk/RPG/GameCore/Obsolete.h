...
#define RPG_GAMECORE_OBSOLETE_METHOD_3_601E5534EC2E5D75_OFFSET UNITYSDK_OFFSET(0x1BAFE8F0)
#define RPG_GAMECORE_OBSOLETE_METHOD_3_EF278ACB40FCFEB6_OFFSET UNITYSDK_OFFSET(0x1BAFE8B0)
#define RPG_GAMECORE_OBSOLETE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAFE8E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int Obsolete_TypeDefinitionIndex = 22912;
