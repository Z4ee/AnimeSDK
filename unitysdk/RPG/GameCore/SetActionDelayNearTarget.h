...
#define RPG_GAMECORE_SETACTIONDELAYNEARTARGET_METHOD_3_052366C1468342E1_OFFSET UNITYSDK_OFFSET(0x19C266F0)
#define RPG_GAMECORE_SETACTIONDELAYNEARTARGET_METHOD_3_A683E35A46CCCAF0_OFFSET UNITYSDK_OFFSET(0x19C26670)
#define RPG_GAMECORE_SETACTIONDELAYNEARTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x19C266C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetActionDelayNearTarget_TypeDefinitionIndex = 22335;
