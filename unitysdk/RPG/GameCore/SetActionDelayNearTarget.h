...
#define RPG_GAMECORE_SETACTIONDELAYNEARTARGET_METHOD_3_052366C1468342E1_OFFSET UNITYSDK_OFFSET(0x18E07600)
#define RPG_GAMECORE_SETACTIONDELAYNEARTARGET_METHOD_3_A683E35A46CCCAF0_OFFSET UNITYSDK_OFFSET(0x18E07580)
#define RPG_GAMECORE_SETACTIONDELAYNEARTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x18E075D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetActionDelayNearTarget_TypeDefinitionIndex = 22605;
