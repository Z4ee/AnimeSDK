...
#define RPG_GAMECORE_TOASTPAGE_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1D5D3B30)
#define RPG_GAMECORE_TOASTPAGE_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D5D3AF0)
#define RPG_GAMECORE_TOASTPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5D3B20)
