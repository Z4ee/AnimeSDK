...
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEALLODDOREVEN_METHOD_3_73D8B21AE9089841_OFFSET UNITYSDK_OFFSET(0x1715C610)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEALLODDOREVEN_METHOD_3_FFBA2EB2C2FFED55_OFFSET UNITYSDK_OFFSET(0x1715BD30)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEALLODDOREVEN__CTOR_OFFSET UNITYSDK_OFFSET(0x1715BD20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatAIEffectEvaluatorConfig_DiceAllOddOrEven_TypeDefinitionIndex = 14840;
