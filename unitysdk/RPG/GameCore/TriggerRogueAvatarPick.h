...
#define RPG_GAMECORE_TRIGGERROGUEAVATARPICK_METHOD_3_CD52F6B0B7158E5C_OFFSET UNITYSDK_OFFSET(0x190CBB10)
#define RPG_GAMECORE_TRIGGERROGUEAVATARPICK_METHOD_3_E439F03F28F250AB_OFFSET UNITYSDK_OFFSET(0x190CBA90)
#define RPG_GAMECORE_TRIGGERROGUEAVATARPICK__CTOR_OFFSET UNITYSDK_OFFSET(0x190CBAE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerRogueAvatarPick_TypeDefinitionIndex = 21140;
