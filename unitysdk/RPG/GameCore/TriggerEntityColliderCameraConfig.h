...
#define RPG_GAMECORE_TRIGGERENTITYCOLLIDERCAMERACONFIG_METHOD_3_3F3189AE9DC91883_OFFSET UNITYSDK_OFFSET(0x1D5FE580)
#define RPG_GAMECORE_TRIGGERENTITYCOLLIDERCAMERACONFIG_METHOD_3_FFA32702E8EC0584_OFFSET UNITYSDK_OFFSET(0x1D5FE5C0)
#define RPG_GAMECORE_TRIGGERENTITYCOLLIDERCAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5FE5B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerEntityColliderCameraConfig_TypeDefinitionIndex = 23190;
