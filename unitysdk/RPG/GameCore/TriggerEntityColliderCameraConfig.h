...
#define RPG_GAMECORE_TRIGGERENTITYCOLLIDERCAMERACONFIG_METHOD_3_D17E786B46E1AF12_OFFSET UNITYSDK_OFFSET(0x178C6C20)
#define RPG_GAMECORE_TRIGGERENTITYCOLLIDERCAMERACONFIG_METHOD_3_FFA32702E8EC0584_OFFSET UNITYSDK_OFFSET(0x178C6CA0)
#define RPG_GAMECORE_TRIGGERENTITYCOLLIDERCAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x178C6C70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerEntityColliderCameraConfig_TypeDefinitionIndex = 21684;
