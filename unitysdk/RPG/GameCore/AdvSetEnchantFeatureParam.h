...
#define RPG_GAMECORE_ADVSETENCHANTFEATUREPARAM_METHOD_3_2C541648389944B4_OFFSET UNITYSDK_OFFSET(0x1CDD9D50)
#define RPG_GAMECORE_ADVSETENCHANTFEATUREPARAM_METHOD_3_84C5D2C03B9359CD_OFFSET UNITYSDK_OFFSET(0x1CDD9D90)
#define RPG_GAMECORE_ADVSETENCHANTFEATUREPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDD9D80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSetEnchantFeatureParam_TypeDefinitionIndex = 21567;
