...
#define RPG_GAMECORE_ADVSETENCHANTFEATUREPARAM_METHOD_3_14F744332AC13EC6_OFFSET UNITYSDK_OFFSET(0x194367F0)
#define RPG_GAMECORE_ADVSETENCHANTFEATUREPARAM_METHOD_3_84C5D2C03B9359CD_OFFSET UNITYSDK_OFFSET(0x19436870)
#define RPG_GAMECORE_ADVSETENCHANTFEATUREPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x19436840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSetEnchantFeatureParam_TypeDefinitionIndex = 20594;
