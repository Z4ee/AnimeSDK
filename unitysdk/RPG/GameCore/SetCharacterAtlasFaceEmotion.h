...
#define RPG_GAMECORE_SETCHARACTERATLASFACEEMOTION_METHOD_3_2561F8DDA59F7BF4_OFFSET UNITYSDK_OFFSET(0x176ACF50)
#define RPG_GAMECORE_SETCHARACTERATLASFACEEMOTION_METHOD_3_3CCBF64A23B83D99_OFFSET UNITYSDK_OFFSET(0x176ACFF0)
#define RPG_GAMECORE_SETCHARACTERATLASFACEEMOTION__CTOR_OFFSET UNITYSDK_OFFSET(0x176ACFB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetCharacterAtlasFaceEmotion_TypeDefinitionIndex = 18938;
