...
#define RPG_GAMECORE_SETIRONTOMBINFINITYHPUI_METHOD_3_1C09C519A1986B3C_OFFSET UNITYSDK_OFFSET(0x176D2220)
#define RPG_GAMECORE_SETIRONTOMBINFINITYHPUI_METHOD_3_920BFCE4D43AD2AD_OFFSET UNITYSDK_OFFSET(0x176D22A0)
#define RPG_GAMECORE_SETIRONTOMBINFINITYHPUI__CTOR_OFFSET UNITYSDK_OFFSET(0x176D2270)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetIronTombInfinityHPUI_TypeDefinitionIndex = 21896;
