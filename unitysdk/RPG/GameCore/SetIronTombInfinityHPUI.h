...
#define RPG_GAMECORE_SETIRONTOMBINFINITYHPUI_METHOD_3_42F06754E3BF7528_OFFSET UNITYSDK_OFFSET(0x1C5FD450)
#define RPG_GAMECORE_SETIRONTOMBINFINITYHPUI_METHOD_3_920BFCE4D43AD2AD_OFFSET UNITYSDK_OFFSET(0x1C5FD4A0)
#define RPG_GAMECORE_SETIRONTOMBINFINITYHPUI__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5FD490)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetIronTombInfinityHPUI_TypeDefinitionIndex = 22800;
