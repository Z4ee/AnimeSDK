...
#define RPG_GAMECORE_SWITCHONPARTIALFLIPDEVICE_METHOD_3_71427885D46E47E4_OFFSET UNITYSDK_OFFSET(0x17797AF0)
#define RPG_GAMECORE_SWITCHONPARTIALFLIPDEVICE_METHOD_3_BB98E1280D9A45B8_OFFSET UNITYSDK_OFFSET(0x177979E0)
#define RPG_GAMECORE_SWITCHONPARTIALFLIPDEVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x17797AC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchOnPartialFlipDevice_TypeDefinitionIndex = 20532;
