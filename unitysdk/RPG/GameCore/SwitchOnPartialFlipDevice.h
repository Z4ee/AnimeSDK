...
#define RPG_GAMECORE_SWITCHONPARTIALFLIPDEVICE_METHOD_3_71427885D46E47E4_OFFSET UNITYSDK_OFFSET(0x1B438C90)
#define RPG_GAMECORE_SWITCHONPARTIALFLIPDEVICE_METHOD_3_DE4F60914E299861_OFFSET UNITYSDK_OFFSET(0x1B438BC0)
#define RPG_GAMECORE_SWITCHONPARTIALFLIPDEVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B438C80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchOnPartialFlipDevice_TypeDefinitionIndex = 21525;
