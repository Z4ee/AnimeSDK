...
#define RPG_GAMECORE_DAWNSEYETHUNDERFIGHTUICONFIG_METHOD_3_5B6388C2160DD4C2_OFFSET UNITYSDK_OFFSET(0x196920C0)
#define RPG_GAMECORE_DAWNSEYETHUNDERFIGHTUICONFIG_METHOD_3_761F1B73D52F1D95_OFFSET UNITYSDK_OFFSET(0x19692120)
#define RPG_GAMECORE_DAWNSEYETHUNDERFIGHTUICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19692110)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DawnsEyeThunderFightUIConfig_TypeDefinitionIndex = 21555;
