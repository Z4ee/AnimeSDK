...
#define RPG_GAMECORE_SETFLOORCUSTOMSTRING_METHOD_3_188DBBFBD28A6FC2_OFFSET UNITYSDK_OFFSET(0x1D4FFD50)
#define RPG_GAMECORE_SETFLOORCUSTOMSTRING_METHOD_3_4B096023EAB64A43_OFFSET UNITYSDK_OFFSET(0x1D4FFD90)
#define RPG_GAMECORE_SETFLOORCUSTOMSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4FFD80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetFloorCustomString_TypeDefinitionIndex = 20453;
