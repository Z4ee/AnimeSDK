...
#define RPG_GAMECORE_SETFLOORCUSTOMSTRING_METHOD_3_0B7DFC4FD24F8ADA_OFFSET UNITYSDK_OFFSET(0x18E32530)
#define RPG_GAMECORE_SETFLOORCUSTOMSTRING_METHOD_3_4B096023EAB64A43_OFFSET UNITYSDK_OFFSET(0x18E325B0)
#define RPG_GAMECORE_SETFLOORCUSTOMSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x18E32580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetFloorCustomString_TypeDefinitionIndex = 19668;
