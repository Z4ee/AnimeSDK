...
#define RPG_GAMECORE_LOOPWAITTELEPORTBYANCHOR_METHOD_3_7FACCE162639D4A3_OFFSET UNITYSDK_OFFSET(0x17371670)
#define RPG_GAMECORE_LOOPWAITTELEPORTBYANCHOR_METHOD_3_B423EC85AD94D7BC_OFFSET UNITYSDK_OFFSET(0x17371600)
#define RPG_GAMECORE_LOOPWAITTELEPORTBYANCHOR__CTOR_OFFSET UNITYSDK_OFFSET(0x17371640)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoopWaitTeleportByAnchor_TypeDefinitionIndex = 18876;
