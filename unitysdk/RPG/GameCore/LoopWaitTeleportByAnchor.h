...
#define RPG_GAMECORE_LOOPWAITTELEPORTBYANCHOR_METHOD_3_7FACCE162639D4A3_OFFSET UNITYSDK_OFFSET(0x1D216240)
#define RPG_GAMECORE_LOOPWAITTELEPORTBYANCHOR_METHOD_3_C2FEBB0E82BF169F_OFFSET UNITYSDK_OFFSET(0x1D2161F0)
#define RPG_GAMECORE_LOOPWAITTELEPORTBYANCHOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D216230)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoopWaitTeleportByAnchor_TypeDefinitionIndex = 20330;
