...
#define RPG_GAMECORE_ELFENTRANCENPCCONFIG_METHOD_2_118409708306B4F4_OFFSET UNITYSDK_OFFSET(0x1718E1B0)
#define RPG_GAMECORE_ELFENTRANCENPCCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1718E2D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfEntranceNPCConfig_TypeDefinitionIndex = 14853;
