...
#define RPG_GAMECORE_ELFENTRANCENPCCONFIG_METHOD_2_118409708306B4F4_OFFSET UNITYSDK_OFFSET(0x1889B8E0)
#define RPG_GAMECORE_ELFENTRANCENPCCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1889BA00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfEntranceNPCConfig_TypeDefinitionIndex = 15360;
