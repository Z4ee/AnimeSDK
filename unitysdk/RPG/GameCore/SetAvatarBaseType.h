...
#define RPG_GAMECORE_SETAVATARBASETYPE_METHOD_3_12674314453660FE_OFFSET UNITYSDK_OFFSET(0x176A7F90)
#define RPG_GAMECORE_SETAVATARBASETYPE_METHOD_3_F11C75DCB2C4E981_OFFSET UNITYSDK_OFFSET(0x176A7F00)
#define RPG_GAMECORE_SETAVATARBASETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x176A7F60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetAvatarBaseType_TypeDefinitionIndex = 21823;
