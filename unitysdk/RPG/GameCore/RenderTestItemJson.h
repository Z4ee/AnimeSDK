...
#define RPG_GAMECORE_RENDERTESTITEMJSON_METHOD_2_57F8D7C286261357_OFFSET UNITYSDK_OFFSET(0x19ACB720)
#define RPG_GAMECORE_RENDERTESTITEMJSON__CTOR_OFFSET UNITYSDK_OFFSET(0x19ACB860)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RenderTestItemJson_TypeDefinitionIndex = 23067;
