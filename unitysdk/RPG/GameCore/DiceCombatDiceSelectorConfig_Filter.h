...
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_FILTER_METHOD_3_86EDC5E624F8FF7D_OFFSET UNITYSDK_OFFSET(0x1C10FB00)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_FILTER_METHOD_3_E48F3AA5E67F01B5_OFFSET UNITYSDK_OFFSET(0x1C10EC70)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_FILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C10EC60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatDiceSelectorConfig_Filter_TypeDefinitionIndex = 15543;
