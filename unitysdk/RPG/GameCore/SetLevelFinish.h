...
#define RPG_GAMECORE_SETLEVELFINISH_METHOD_3_1D4D3C2D15F80A1E_OFFSET UNITYSDK_OFFSET(0x176D34E0)
#define RPG_GAMECORE_SETLEVELFINISH_METHOD_3_5D76915BA1273412_OFFSET UNITYSDK_OFFSET(0x176D33D0)
#define RPG_GAMECORE_SETLEVELFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x176D34B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetLevelFinish_TypeDefinitionIndex = 21658;
