...
#define RPG_GAMECORE_SETLEVELFINISH_METHOD_3_1D4D3C2D15F80A1E_OFFSET UNITYSDK_OFFSET(0x18E36A20)
#define RPG_GAMECORE_SETLEVELFINISH_METHOD_3_5D76915BA1273412_OFFSET UNITYSDK_OFFSET(0x18E36910)
#define RPG_GAMECORE_SETLEVELFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x18E369F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetLevelFinish_TypeDefinitionIndex = 22396;
