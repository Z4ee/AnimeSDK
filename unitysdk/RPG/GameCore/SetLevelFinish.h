...
#define RPG_GAMECORE_SETLEVELFINISH_METHOD_3_1D4D3C2D15F80A1E_OFFSET UNITYSDK_OFFSET(0x1E083C30)
#define RPG_GAMECORE_SETLEVELFINISH_METHOD_3_583F9A56FB369D1B_OFFSET UNITYSDK_OFFSET(0x1E083B60)
#define RPG_GAMECORE_SETLEVELFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1E083C20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetLevelFinish_TypeDefinitionIndex = 23164;
