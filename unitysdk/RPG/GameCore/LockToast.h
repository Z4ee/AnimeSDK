...
#define RPG_GAMECORE_LOCKTOAST_METHOD_3_9325E0556C47AFFC_OFFSET UNITYSDK_OFFSET(0x18A7A4B0)
#define RPG_GAMECORE_LOCKTOAST_METHOD_3_A4DB745803B8CE8D_OFFSET UNITYSDK_OFFSET(0x18A7A430)
#define RPG_GAMECORE_LOCKTOAST__CTOR_OFFSET UNITYSDK_OFFSET(0x18A7A480)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LockToast_TypeDefinitionIndex = 23366;
