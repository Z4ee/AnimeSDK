...
#define RPG_GAMECORE_LOCKTOAST_METHOD_3_9325E0556C47AFFC_OFFSET UNITYSDK_OFFSET(0x1736C8A0)
#define RPG_GAMECORE_LOCKTOAST_METHOD_3_A4DB745803B8CE8D_OFFSET UNITYSDK_OFFSET(0x1736C820)
#define RPG_GAMECORE_LOCKTOAST__CTOR_OFFSET UNITYSDK_OFFSET(0x1736C870)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LockToast_TypeDefinitionIndex = 22396;
