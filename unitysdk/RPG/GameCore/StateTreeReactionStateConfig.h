...
#define RPG_GAMECORE_STATETREEREACTIONSTATECONFIG_METHOD_3_18D3CE8F5F719A0D_OFFSET UNITYSDK_OFFSET(0x1B0BFA10)
#define RPG_GAMECORE_STATETREEREACTIONSTATECONFIG_METHOD_3_47593994CF1E2F02_OFFSET UNITYSDK_OFFSET(0x1B0BFA50)
#define RPG_GAMECORE_STATETREEREACTIONSTATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0BFA40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StateTreeReactionStateConfig_TypeDefinitionIndex = 14893;
