...
#define RPG_GAMECORE_STATETREEREACTIONSTATECONFIG_METHOD_3_18D3CE8F5F719A0D_OFFSET UNITYSDK_OFFSET(0x19CBA080)
#define RPG_GAMECORE_STATETREEREACTIONSTATECONFIG_METHOD_3_47593994CF1E2F02_OFFSET UNITYSDK_OFFSET(0x19CBA0C0)
#define RPG_GAMECORE_STATETREEREACTIONSTATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19CBA0B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StateTreeReactionStateConfig_TypeDefinitionIndex = 14733;
