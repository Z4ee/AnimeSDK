...
#define RPG_GAMECORE_SWITCHHANDLAYITEM_METHOD_3_27B623279493809A_OFFSET UNITYSDK_OFFSET(0x18EBB420)
#define RPG_GAMECORE_SWITCHHANDLAYITEM_METHOD_3_B46724EE08669C0C_OFFSET UNITYSDK_OFFSET(0x18EBB4A0)
#define RPG_GAMECORE_SWITCHHANDLAYITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x18EBB470)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchHandLayItem_TypeDefinitionIndex = 19955;
