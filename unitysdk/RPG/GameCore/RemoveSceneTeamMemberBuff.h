...
#define RPG_GAMECORE_REMOVESCENETEAMMEMBERBUFF_METHOD_3_1C08E2BCB1433939_OFFSET UNITYSDK_OFFSET(0x19ACA150)
#define RPG_GAMECORE_REMOVESCENETEAMMEMBERBUFF_METHOD_3_42E05C6FB2BB9B49_OFFSET UNITYSDK_OFFSET(0x19ACA1E0)
#define RPG_GAMECORE_REMOVESCENETEAMMEMBERBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x19ACA1B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveSceneTeamMemberBuff_TypeDefinitionIndex = 19282;
