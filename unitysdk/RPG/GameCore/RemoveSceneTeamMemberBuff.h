...
#define RPG_GAMECORE_REMOVESCENETEAMMEMBERBUFF_METHOD_3_1C08E2BCB1433939_OFFSET UNITYSDK_OFFSET(0x175996A0)
#define RPG_GAMECORE_REMOVESCENETEAMMEMBERBUFF_METHOD_3_42E05C6FB2BB9B49_OFFSET UNITYSDK_OFFSET(0x17599730)
#define RPG_GAMECORE_REMOVESCENETEAMMEMBERBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x17599700)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveSceneTeamMemberBuff_TypeDefinitionIndex = 18717;
