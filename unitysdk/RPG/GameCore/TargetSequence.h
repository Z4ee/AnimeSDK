...
#define RPG_GAMECORE_TARGETSEQUENCE_METHOD_4_1B6AB92A0F4AEE12_OFFSET UNITYSDK_OFFSET(0x177D2FA0)
#define RPG_GAMECORE_TARGETSEQUENCE_METHOD_4_21B947C3EC1B2476_OFFSET UNITYSDK_OFFSET(0x177B9CD0)
#define RPG_GAMECORE_TARGETSEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x177B9C80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetSequence_TypeDefinitionIndex = 22174;
