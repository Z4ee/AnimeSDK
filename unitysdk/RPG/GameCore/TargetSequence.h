...
#define RPG_GAMECORE_TARGETSEQUENCE_METHOD_4_0FDCAA5A05763F40_OFFSET UNITYSDK_OFFSET(0x1D0C58C0)
#define RPG_GAMECORE_TARGETSEQUENCE_METHOD_4_4D9861C07039E52F_OFFSET UNITYSDK_OFFSET(0x1D0C59E0)
#define RPG_GAMECORE_TARGETSEQUENCE_METHOD_4_A26600FC872DE6B3_OFFSET UNITYSDK_OFFSET(0x1D0C5900)
#define RPG_GAMECORE_TARGETSEQUENCE_METHOD_4_D4C747641F885762_OFFSET UNITYSDK_OFFSET(0x1D0C59B0)
#define RPG_GAMECORE_TARGETSEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0C58F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetSequence_TypeDefinitionIndex = 23043;
