...
#define RPG_GAMECORE_ACTIVEFMCHANNELSOURCE_METHOD_3_301A9C8C8C6504F3_OFFSET UNITYSDK_OFFSET(0x16E9F720)
#define RPG_GAMECORE_ACTIVEFMCHANNELSOURCE_METHOD_3_D887CB0D4BF2D5FA_OFFSET UNITYSDK_OFFSET(0x16E9F6A0)
#define RPG_GAMECORE_ACTIVEFMCHANNELSOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x16E9F6F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActiveFMChannelSource_TypeDefinitionIndex = 18885;
