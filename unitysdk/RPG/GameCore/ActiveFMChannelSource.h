...
#define RPG_GAMECORE_ACTIVEFMCHANNELSOURCE_METHOD_3_301A9C8C8C6504F3_OFFSET UNITYSDK_OFFSET(0x1C9EB3F0)
#define RPG_GAMECORE_ACTIVEFMCHANNELSOURCE_METHOD_3_EB4134B82669FF08_OFFSET UNITYSDK_OFFSET(0x1C9EB3B0)
#define RPG_GAMECORE_ACTIVEFMCHANNELSOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9EB3E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActiveFMChannelSource_TypeDefinitionIndex = 20339;
