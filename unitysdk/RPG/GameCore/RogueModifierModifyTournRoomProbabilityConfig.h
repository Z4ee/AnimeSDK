...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYTOURNROOMPROBABILITYCONFIG_METHOD_3_457E43B162D38037_OFFSET UNITYSDK_OFFSET(0x18D43120)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYTOURNROOMPROBABILITYCONFIG_METHOD_3_BEC118AD9709AF0E_OFFSET UNITYSDK_OFFSET(0x18D431F0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYTOURNROOMPROBABILITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D431A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyTournRoomProbabilityConfig_TypeDefinitionIndex = 16878;
