...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYTOURNROOMPROBABILITYCONFIG_METHOD_3_1F6E2181942F65F2_OFFSET UNITYSDK_OFFSET(0x1D164AE0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYTOURNROOMPROBABILITYCONFIG_METHOD_3_BEC118AD9709AF0E_OFFSET UNITYSDK_OFFSET(0x1D164B30)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYTOURNROOMPROBABILITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D164B20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyTournRoomProbabilityConfig_TypeDefinitionIndex = 17055;
