...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONENTERROGUEMAGICROOMCONFIG_METHOD_3_622CB045B3A19923_OFFSET UNITYSDK_OFFSET(0x17630060)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONENTERROGUEMAGICROOMCONFIG_METHOD_3_B5FF1A2D7E2DA6DA_OFFSET UNITYSDK_OFFSET(0x17630130)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONENTERROGUEMAGICROOMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x176300E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnEnterRogueMagicRoomConfig_TypeDefinitionIndex = 16279;
