...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONENTERROGUEMAGICROOMCONFIG_METHOD_3_622CB045B3A19923_OFFSET UNITYSDK_OFFSET(0x18D3D0F0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONENTERROGUEMAGICROOMCONFIG_METHOD_3_B5FF1A2D7E2DA6DA_OFFSET UNITYSDK_OFFSET(0x18D35980)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONENTERROGUEMAGICROOMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D35930)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnEnterRogueMagicRoomConfig_TypeDefinitionIndex = 16833;
