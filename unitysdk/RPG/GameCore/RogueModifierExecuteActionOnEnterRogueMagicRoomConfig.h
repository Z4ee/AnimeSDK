...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONENTERROGUEMAGICROOMCONFIG_METHOD_3_063C78141455A29E_OFFSET UNITYSDK_OFFSET(0x1EEF8BD0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONENTERROGUEMAGICROOMCONFIG_METHOD_3_B5FF1A2D7E2DA6DA_OFFSET UNITYSDK_OFFSET(0x1EEF8C20)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONENTERROGUEMAGICROOMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEF8C10)
