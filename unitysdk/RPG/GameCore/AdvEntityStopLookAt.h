...
#define RPG_GAMECORE_ADVENTITYSTOPLOOKAT_METHOD_3_14254510A3674B5C_OFFSET UNITYSDK_OFFSET(0x16F2E100)
#define RPG_GAMECORE_ADVENTITYSTOPLOOKAT_METHOD_3_E3EFF078E7B15B0B_OFFSET UNITYSDK_OFFSET(0x16F2E080)
#define RPG_GAMECORE_ADVENTITYSTOPLOOKAT__CTOR_OFFSET UNITYSDK_OFFSET(0x16F2E0D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvEntityStopLookAt_TypeDefinitionIndex = 18854;
