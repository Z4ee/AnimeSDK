...
#define RPG_GAMECORE_CHIMERADUELWAITSUMMONUNITQUEUECOUNTVALUEGETTER_METHOD_3_45FDF56B9FBD6DD7_OFFSET UNITYSDK_OFFSET(0x1C24A1A0)
#define RPG_GAMECORE_CHIMERADUELWAITSUMMONUNITQUEUECOUNTVALUEGETTER_METHOD_3_7716E2E85E524797_OFFSET UNITYSDK_OFFSET(0x1C24A140)
#define RPG_GAMECORE_CHIMERADUELWAITSUMMONUNITQUEUECOUNTVALUEGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C24A190)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelWaitSummonUnitQueueCountValueGetter_TypeDefinitionIndex = 15392;
