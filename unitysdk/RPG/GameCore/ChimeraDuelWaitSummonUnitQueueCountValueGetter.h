...
#define RPG_GAMECORE_CHIMERADUELWAITSUMMONUNITQUEUECOUNTVALUEGETTER_METHOD_3_45FDF56B9FBD6DD7_OFFSET UNITYSDK_OFFSET(0x18807B70)
#define RPG_GAMECORE_CHIMERADUELWAITSUMMONUNITQUEUECOUNTVALUEGETTER_METHOD_3_7716E2E85E524797_OFFSET UNITYSDK_OFFSET(0x18807B10)
#define RPG_GAMECORE_CHIMERADUELWAITSUMMONUNITQUEUECOUNTVALUEGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x18807B60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelWaitSummonUnitQueueCountValueGetter_TypeDefinitionIndex = 15167;
