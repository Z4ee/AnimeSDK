...
#define RPG_GAMECORE_CHIMERADUELWAITSUMMONUNITQUEUECOUNTVALUEGETTER_METHOD_3_45FDF56B9FBD6DD7_OFFSET UNITYSDK_OFFSET(0x170A85C0)
#define RPG_GAMECORE_CHIMERADUELWAITSUMMONUNITQUEUECOUNTVALUEGETTER_METHOD_3_7716E2E85E524797_OFFSET UNITYSDK_OFFSET(0x170A8560)
#define RPG_GAMECORE_CHIMERADUELWAITSUMMONUNITQUEUECOUNTVALUEGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x170A85B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelWaitSummonUnitQueueCountValueGetter_TypeDefinitionIndex = 14697;
