...
#define RPG_GAMECORE_CHIMERADUELWAITSUMMONUNITQUEUECOUNTVALUEGETTER_METHOD_3_45FDF56B9FBD6DD7_OFFSET UNITYSDK_OFFSET(0x1CFD0E50)
#define RPG_GAMECORE_CHIMERADUELWAITSUMMONUNITQUEUECOUNTVALUEGETTER_METHOD_3_7716E2E85E524797_OFFSET UNITYSDK_OFFSET(0x1CFD0DF0)
#define RPG_GAMECORE_CHIMERADUELWAITSUMMONUNITQUEUECOUNTVALUEGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFD0E40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelWaitSummonUnitQueueCountValueGetter_TypeDefinitionIndex = 15829;
