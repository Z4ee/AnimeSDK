...
#define RPG_GAMECORE_BYHASINSERTABILITYEXECUTINGDURINGGAMEMODEPAUSE_METHOD_4_0556FB87F5A04D5D_OFFSET UNITYSDK_OFFSET(0x1A8C6B00)
#define RPG_GAMECORE_BYHASINSERTABILITYEXECUTINGDURINGGAMEMODEPAUSE_METHOD_4_1E1F8C666E62A2AA_OFFSET UNITYSDK_OFFSET(0x1A8C6C70)
#define RPG_GAMECORE_BYHASINSERTABILITYEXECUTINGDURINGGAMEMODEPAUSE_METHOD_4_808C74966782A85E_OFFSET UNITYSDK_OFFSET(0x1A8C6AC0)
#define RPG_GAMECORE_BYHASINSERTABILITYEXECUTINGDURINGGAMEMODEPAUSE_METHOD_4_E38DE6B41912F457_OFFSET UNITYSDK_OFFSET(0x1A8C6C40)
#define RPG_GAMECORE_BYHASINSERTABILITYEXECUTINGDURINGGAMEMODEPAUSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8C6AF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByHasInsertAbilityExecutingDuringGameModePause_TypeDefinitionIndex = 22691;
