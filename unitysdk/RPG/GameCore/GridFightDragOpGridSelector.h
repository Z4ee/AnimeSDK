...
#define RPG_GAMECORE_GRIDFIGHTDRAGOPGRIDSELECTOR_METHOD_3_78444FBCC6C56E39_OFFSET UNITYSDK_OFFSET(0x189A8550)
#define RPG_GAMECORE_GRIDFIGHTDRAGOPGRIDSELECTOR_METHOD_3_9BC5B5D009AFC4D5_OFFSET UNITYSDK_OFFSET(0x189A85B0)
#define RPG_GAMECORE_GRIDFIGHTDRAGOPGRIDSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x189A85A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightDragOpGridSelector_TypeDefinitionIndex = 18871;
