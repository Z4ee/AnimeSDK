...
#define RPG_GAMECORE_GRIDFIGHTDRAGOPGRIDSELECTOR_METHOD_3_78444FBCC6C56E39_OFFSET UNITYSDK_OFFSET(0x1C5C8040)
#define RPG_GAMECORE_GRIDFIGHTDRAGOPGRIDSELECTOR_METHOD_3_9BC5B5D009AFC4D5_OFFSET UNITYSDK_OFFSET(0x1C5C80A0)
#define RPG_GAMECORE_GRIDFIGHTDRAGOPGRIDSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5C8090)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightDragOpGridSelector_TypeDefinitionIndex = 19185;
