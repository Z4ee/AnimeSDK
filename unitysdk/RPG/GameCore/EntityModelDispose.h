...
#define RPG_GAMECORE_ENTITYMODELDISPOSE__CTOR_OFFSET UNITYSDK_OFFSET(0xA90F660)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EntityModelDispose_TypeDefinitionIndex = 46056;
