...
#define RPG_GAMECORE_ENTITYMODELDISPOSE__CTOR_OFFSET UNITYSDK_OFFSET(0xB659C60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EntityModelDispose_TypeDefinitionIndex = 52720;
