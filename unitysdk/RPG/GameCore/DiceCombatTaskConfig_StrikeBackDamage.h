...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_STRIKEBACKDAMAGE_METHOD_3_43B981B7F31C2E21_OFFSET UNITYSDK_OFFSET(0x17171420)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_STRIKEBACKDAMAGE_METHOD_3_B4568984BFC4DF08_OFFSET UNITYSDK_OFFSET(0x1716E3C0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_STRIKEBACKDAMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1716E370)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_StrikeBackDamage_TypeDefinitionIndex = 14745;
