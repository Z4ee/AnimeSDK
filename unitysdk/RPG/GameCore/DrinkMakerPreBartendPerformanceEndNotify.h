...
#define RPG_GAMECORE_DRINKMAKERPREBARTENDPERFORMANCEENDNOTIFY_METHOD_3_CF4E2E6529C5B6CC_OFFSET UNITYSDK_OFFSET(0x1DB17310)
#define RPG_GAMECORE_DRINKMAKERPREBARTENDPERFORMANCEENDNOTIFY_METHOD_3_EE05EC9A9C681C09_OFFSET UNITYSDK_OFFSET(0x1DB17240)
#define RPG_GAMECORE_DRINKMAKERPREBARTENDPERFORMANCEENDNOTIFY__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB17300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DrinkMakerPreBartendPerformanceEndNotify_TypeDefinitionIndex = 21467;
