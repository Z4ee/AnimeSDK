...
#define RPG_GAMECORE_DRINKMAKERPREBARTENDPERFORMANCEENDNOTIFY_METHOD_3_C5DB32673BA0AA40_OFFSET UNITYSDK_OFFSET(0x1888CA50)
#define RPG_GAMECORE_DRINKMAKERPREBARTENDPERFORMANCEENDNOTIFY_METHOD_3_CF4E2E6529C5B6CC_OFFSET UNITYSDK_OFFSET(0x1888CB60)
#define RPG_GAMECORE_DRINKMAKERPREBARTENDPERFORMANCEENDNOTIFY__CTOR_OFFSET UNITYSDK_OFFSET(0x1888CB30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DrinkMakerPreBartendPerformanceEndNotify_TypeDefinitionIndex = 20561;
