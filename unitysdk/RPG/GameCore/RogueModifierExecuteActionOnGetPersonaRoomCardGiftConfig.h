...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONGETPERSONAROOMCARDGIFTCONFIG_METHOD_3_920FF09131C0D687_OFFSET UNITYSDK_OFFSET(0x1EEF8F80)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONGETPERSONAROOMCARDGIFTCONFIG_METHOD_3_C67977B3D6BF7303_OFFSET UNITYSDK_OFFSET(0x1EEF8F30)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONGETPERSONAROOMCARDGIFTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEF8F70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnGetPersonaRoomCardGiftConfig_TypeDefinitionIndex = 17658;
