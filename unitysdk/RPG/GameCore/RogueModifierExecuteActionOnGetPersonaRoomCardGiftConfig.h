...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONGETPERSONAROOMCARDGIFTCONFIG_METHOD_3_50EB6FB34CE4A00E_OFFSET UNITYSDK_OFFSET(0x17630840)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONGETPERSONAROOMCARDGIFTCONFIG_METHOD_3_920FF09131C0D687_OFFSET UNITYSDK_OFFSET(0x17630910)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONGETPERSONAROOMCARDGIFTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x176308C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnGetPersonaRoomCardGiftConfig_TypeDefinitionIndex = 16413;
