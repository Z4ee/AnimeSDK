...
#define RPG_GAMECORE_TARGETFETCHNEXTTURNOWNERENTITY_METHOD_4_7D4EBA3E2B7A783E_OFFSET UNITYSDK_OFFSET(0x177BF740)
#define RPG_GAMECORE_TARGETFETCHNEXTTURNOWNERENTITY_METHOD_4_CB48E3CC304A5D3C_OFFSET UNITYSDK_OFFSET(0x177B6C80)
#define RPG_GAMECORE_TARGETFETCHNEXTTURNOWNERENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x177B6C30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchNextTurnOwnerEntity_TypeDefinitionIndex = 22251;
