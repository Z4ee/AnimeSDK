...
#define RPG_GAMECORE_TRAINPARTYMODIFIERADDGRIDTYPEWEIGHTCONFIG_METHOD_3_0CE85E176220403F_OFFSET UNITYSDK_OFFSET(0x178ACA80)
#define RPG_GAMECORE_TRAINPARTYMODIFIERADDGRIDTYPEWEIGHTCONFIG_METHOD_3_6E0BE9FC9B41AC43_OFFSET UNITYSDK_OFFSET(0x178ACAD0)
#define RPG_GAMECORE_TRAINPARTYMODIFIERADDGRIDTYPEWEIGHTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x178ACAC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyModifierAddGridTypeWeightConfig_TypeDefinitionIndex = 16609;
