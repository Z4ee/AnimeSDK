...
#define RPG_GAMECORE_TRIGGERMODIFIERCUSTOMEVENT_METHOD_3_92BB07320FEDF53F_OFFSET UNITYSDK_OFFSET(0x178CA440)
#define RPG_GAMECORE_TRIGGERMODIFIERCUSTOMEVENT_METHOD_3_BB21DF926805CCB7_OFFSET UNITYSDK_OFFSET(0x178CA560)
#define RPG_GAMECORE_TRIGGERMODIFIERCUSTOMEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x178CA4E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerModifierCustomEvent_TypeDefinitionIndex = 20895;
