...
#define RPG_GAMECORE_TRIGGERMODIFIERCUSTOMEVENT_METHOD_3_92BB07320FEDF53F_OFFSET UNITYSDK_OFFSET(0x190C8B60)
#define RPG_GAMECORE_TRIGGERMODIFIERCUSTOMEVENT_METHOD_3_BB21DF926805CCB7_OFFSET UNITYSDK_OFFSET(0x190C8C80)
#define RPG_GAMECORE_TRIGGERMODIFIERCUSTOMEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x190C8C00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerModifierCustomEvent_TypeDefinitionIndex = 21606;
