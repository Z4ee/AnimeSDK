...
#define RPG_GAMECORE_ROGUENPCCONFIG_METHOD_2_71C0FA310DF1A962_OFFSET UNITYSDK_OFFSET(0x1D3FED10)
#define RPG_GAMECORE_ROGUENPCCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3FEE30)
