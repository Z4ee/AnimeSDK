...
#define RPG_GAMECORE_ADVENTITYSYNCFREESTYLEWITHSOUND_METHOD_3_8BE492AE2B56064D_OFFSET UNITYSDK_OFFSET(0x186506F0)
#define RPG_GAMECORE_ADVENTITYSYNCFREESTYLEWITHSOUND_METHOD_3_AD0DA1F873DE4061_OFFSET UNITYSDK_OFFSET(0x18650780)
#define RPG_GAMECORE_ADVENTITYSYNCFREESTYLEWITHSOUND__CTOR_OFFSET UNITYSDK_OFFSET(0x18650750)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvEntitySyncFreeStyleWithSound_TypeDefinitionIndex = 21304;
