...
#define RPG_GAMECORE_PROPSETUPSCENESELECTION_METHOD_3_1788F76848666D1D_OFFSET UNITYSDK_OFFSET(0x175269B0)
#define RPG_GAMECORE_PROPSETUPSCENESELECTION_METHOD_3_1F312887AF6B1A48_OFFSET UNITYSDK_OFFSET(0x17526B00)
#define RPG_GAMECORE_PROPSETUPSCENESELECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x17526A70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropSetupSceneSelection_TypeDefinitionIndex = 20199;
