...
#define RPG_GAMECORE_PROPSETUPSCENESELECTION_METHOD_3_228DC5932D8CB806_OFFSET UNITYSDK_OFFSET(0x1BA2A7E0)
#define RPG_GAMECORE_PROPSETUPSCENESELECTION_METHOD_3_2B2E43A1E54DA5B5_OFFSET UNITYSDK_OFFSET(0x1BA2A860)
#define RPG_GAMECORE_PROPSETUPSCENESELECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA2A830)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropSetupSceneSelection_TypeDefinitionIndex = 21215;
