...
#define RPG_GAMECORE_SKILLCUSTOMFORMATIONCONFIG_METHOD_2_1136D03A7D7BD88D_OFFSET UNITYSDK_OFFSET(0x1770DEF0)
#define RPG_GAMECORE_SKILLCUSTOMFORMATIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1770E170)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SkillCustomFormationConfig_TypeDefinitionIndex = 16687;
