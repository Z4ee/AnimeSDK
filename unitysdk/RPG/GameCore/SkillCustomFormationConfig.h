...
#define RPG_GAMECORE_SKILLCUSTOMFORMATIONCONFIG_METHOD_2_1136D03A7D7BD88D_OFFSET UNITYSDK_OFFSET(0x19C8D610)
#define RPG_GAMECORE_SKILLCUSTOMFORMATIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19C8DA10)
