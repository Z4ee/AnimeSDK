...
#define RPG_GAMECORE_MARBLEREMOVESKILL_METHOD_3_0261C3DE0E96E59B_OFFSET UNITYSDK_OFFSET(0x1D23B200)
#define RPG_GAMECORE_MARBLEREMOVESKILL_METHOD_3_2553FE71EAEC6085_OFFSET UNITYSDK_OFFSET(0x1D23B260)
#define RPG_GAMECORE_MARBLEREMOVESKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D23B250)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleRemoveSkill_TypeDefinitionIndex = 16677;
