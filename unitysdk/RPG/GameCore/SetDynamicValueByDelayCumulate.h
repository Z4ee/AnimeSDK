...
#define RPG_GAMECORE_SETDYNAMICVALUEBYDELAYCUMULATE_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1C2E13F0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYDELAYCUMULATE_METHOD_4_2DB9A5C7D0BE00BC_OFFSET UNITYSDK_OFFSET(0x1C2E1240)
#define RPG_GAMECORE_SETDYNAMICVALUEBYDELAYCUMULATE_METHOD_4_3F8E1846BE673723_OFFSET UNITYSDK_OFFSET(0x1C2E1280)
#define RPG_GAMECORE_SETDYNAMICVALUEBYDELAYCUMULATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2E1270)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByDelayCumulate_TypeDefinitionIndex = 22740;
