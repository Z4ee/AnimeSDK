...
#define RPG_GAMECORE_ROGUEPARAMUPGRADABLEMAGICUNITLEVELCOUNTCONFIG_METHOD_6_26F074251D20A0EA_OFFSET UNITYSDK_OFFSET(0x19BB4D00)
#define RPG_GAMECORE_ROGUEPARAMUPGRADABLEMAGICUNITLEVELCOUNTCONFIG_METHOD_6_8AF9059B72F154E4_OFFSET UNITYSDK_OFFSET(0x19BB4FB0)
#define RPG_GAMECORE_ROGUEPARAMUPGRADABLEMAGICUNITLEVELCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19BB4E80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamUpgradableMagicUnitLevelCountConfig_TypeDefinitionIndex = 18782;
