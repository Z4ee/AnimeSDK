...
#define RPG_GAMECORE_HEARTDIALBILLBOARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D3CDF40)
#define RPG_GAMECORE_HEARTDIALBILLBOARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3CE540)
