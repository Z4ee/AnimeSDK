...
#define RPG_GAMECORE_SETGAMEPLAYBGMEMOTIONSTATE_METHOD_3_2C3648438F53B8C5_OFFSET UNITYSDK_OFFSET(0x1C5FAFF0)
#define RPG_GAMECORE_SETGAMEPLAYBGMEMOTIONSTATE_METHOD_3_5A9CAB8EC608D54A_OFFSET UNITYSDK_OFFSET(0x1C5FB030)
#define RPG_GAMECORE_SETGAMEPLAYBGMEMOTIONSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5FB020)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetGameplayBGMEmotionState_TypeDefinitionIndex = 19966;
