...
#define RPG_GAMECORE_SETGAMEPLAYBGMEMOTIONSTATE_METHOD_3_2CC97D6B4F160A48_OFFSET UNITYSDK_OFFSET(0x176CFA60)
#define RPG_GAMECORE_SETGAMEPLAYBGMEMOTIONSTATE_METHOD_3_5A9CAB8EC608D54A_OFFSET UNITYSDK_OFFSET(0x176CFAE0)
#define RPG_GAMECORE_SETGAMEPLAYBGMEMOTIONSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x176CFAB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetGameplayBGMEmotionState_TypeDefinitionIndex = 19072;
