...
#define RPG_GAMECORE_SHOWROGUESELECTMAINPAGEMODE_METHOD_3_71C3E230FBB042C0_OFFSET UNITYSDK_OFFSET(0x1BE45CB0)
#define RPG_GAMECORE_SHOWROGUESELECTMAINPAGEMODE_METHOD_3_E57D57BAF04B621B_OFFSET UNITYSDK_OFFSET(0x1BE45D00)
#define RPG_GAMECORE_SHOWROGUESELECTMAINPAGEMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE45CF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowRogueSelectMainPageMode_TypeDefinitionIndex = 23449;
