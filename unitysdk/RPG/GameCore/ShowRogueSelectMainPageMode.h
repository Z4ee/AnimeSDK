...
#define RPG_GAMECORE_SHOWROGUESELECTMAINPAGEMODE_METHOD_3_16BF84DC4CED9638_OFFSET UNITYSDK_OFFSET(0x18E65DD0)
#define RPG_GAMECORE_SHOWROGUESELECTMAINPAGEMODE_METHOD_3_E57D57BAF04B621B_OFFSET UNITYSDK_OFFSET(0x18E65E60)
#define RPG_GAMECORE_SHOWROGUESELECTMAINPAGEMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E65E30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowRogueSelectMainPageMode_TypeDefinitionIndex = 23317;
