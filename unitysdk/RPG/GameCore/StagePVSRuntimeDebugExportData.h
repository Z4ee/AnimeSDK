...
#define RPG_GAMECORE_STAGEPVSRUNTIMEDEBUGEXPORTDATA_METHOD_2_6795175FA1385078_OFFSET UNITYSDK_OFFSET(0x1B0B3620)
#define RPG_GAMECORE_STAGEPVSRUNTIMEDEBUGEXPORTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0B3710)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StagePVSRuntimeDebugExportData_TypeDefinitionIndex = 18424;
