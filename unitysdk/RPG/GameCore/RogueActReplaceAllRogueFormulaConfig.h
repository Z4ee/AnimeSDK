...
#define RPG_GAMECORE_ROGUEACTREPLACEALLROGUEFORMULACONFIG_METHOD_6_37073C64623A3C22_OFFSET UNITYSDK_OFFSET(0x18CD2DF0)
#define RPG_GAMECORE_ROGUEACTREPLACEALLROGUEFORMULACONFIG_METHOD_6_5E9F3B7D68F5EDC7_OFFSET UNITYSDK_OFFSET(0x18CD3010)
#define RPG_GAMECORE_ROGUEACTREPLACEALLROGUEFORMULACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CD2F30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActReplaceAllRogueFormulaConfig_TypeDefinitionIndex = 18659;
