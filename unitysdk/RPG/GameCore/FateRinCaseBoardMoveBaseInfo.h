...
#define RPG_GAMECORE_FATERINCASEBOARDMOVEBASEINFO_METHOD_2_0D5F69DADCDAF908_OFFSET UNITYSDK_OFFSET(0x1D0904C0)
#define RPG_GAMECORE_FATERINCASEBOARDMOVEBASEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D090640)
