...
#define RPG_GAMECORE_FATERINCASEBOARDMOVEBASEINFO_METHOD_2_0D5F69DADCDAF908_OFFSET UNITYSDK_OFFSET(0x1BA76B20)
#define RPG_GAMECORE_FATERINCASEBOARDMOVEBASEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA76CA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateRinCaseBoardMoveBaseInfo_TypeDefinitionIndex = 19149;
