...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETCURDIVISIONLEVELCONFIG_METHOD_6_498997242B2E6A28_OFFSET UNITYSDK_OFFSET(0x189C2AA0)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETCURDIVISIONLEVELCONFIG_METHOD_6_85608540D486286E_OFFSET UNITYSDK_OFFSET(0x189C2D50)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETCURDIVISIONLEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189C2C20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightParamGetCurDivisionLevelConfig_TypeDefinitionIndex = 18550;
