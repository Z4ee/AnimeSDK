...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETCURDIVISIONLEVELCONFIG_METHOD_6_498997242B2E6A28_OFFSET UNITYSDK_OFFSET(0x1726EEF0)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETCURDIVISIONLEVELCONFIG_METHOD_6_85608540D486286E_OFFSET UNITYSDK_OFFSET(0x1726F1A0)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETCURDIVISIONLEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1726F070)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightParamGetCurDivisionLevelConfig_TypeDefinitionIndex = 17906;
