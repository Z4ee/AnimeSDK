...
#define RPG_GAMECORE_VP_MIN_METHOD_3_354EE36AC864B94F_OFFSET UNITYSDK_OFFSET(0x1B896FD0)
#define RPG_GAMECORE_VP_MIN_METHOD_3_430DF9969363B87E_OFFSET UNITYSDK_OFFSET(0x1B897130)
#define RPG_GAMECORE_VP_MIN_METHOD_3_54992364255A3AD2_OFFSET UNITYSDK_OFFSET(0x1B897080)
#define RPG_GAMECORE_VP_MIN_METHOD_3_BAFB2269FBAD5E02_OFFSET UNITYSDK_OFFSET(0x1B897100)
#define RPG_GAMECORE_VP_MIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1B897070)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VP_Min_TypeDefinitionIndex = 23202;
