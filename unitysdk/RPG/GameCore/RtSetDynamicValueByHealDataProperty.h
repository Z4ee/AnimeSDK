...
#define RPG_GAMECORE_RTSETDYNAMICVALUEBYHEALDATAPROPERTY_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1B768CF0)
#define RPG_GAMECORE_RTSETDYNAMICVALUEBYHEALDATAPROPERTY_METHOD_4_1373348A5D9DF5DE_OFFSET UNITYSDK_OFFSET(0x1B768B00)
#define RPG_GAMECORE_RTSETDYNAMICVALUEBYHEALDATAPROPERTY_METHOD_4_1DD8C566C4A1BA33_OFFSET UNITYSDK_OFFSET(0x1B768AC0)
#define RPG_GAMECORE_RTSETDYNAMICVALUEBYHEALDATAPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B768AF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtSetDynamicValueByHealDataProperty_TypeDefinitionIndex = 23321;
