...
#define RPG_GAMECORE_RTSETDYNAMICVALUEBYHEALDATAPROPERTY_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1D4AFE50)
#define RPG_GAMECORE_RTSETDYNAMICVALUEBYHEALDATAPROPERTY_METHOD_4_1373348A5D9DF5DE_OFFSET UNITYSDK_OFFSET(0x1D4AFC60)
#define RPG_GAMECORE_RTSETDYNAMICVALUEBYHEALDATAPROPERTY_METHOD_4_1DD8C566C4A1BA33_OFFSET UNITYSDK_OFFSET(0x1D4AFC20)
#define RPG_GAMECORE_RTSETDYNAMICVALUEBYHEALDATAPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4AFC50)
