...
#define RPG_GAMECORE_FIVEDIMLADDERBAKEDCONFIG_METHOD_2_28A10FDC3FE70DF1_OFFSET UNITYSDK_OFFSET(0x18907B80)
#define RPG_GAMECORE_FIVEDIMLADDERBAKEDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18907DA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimLadderBakedConfig_TypeDefinitionIndex = 15774;
