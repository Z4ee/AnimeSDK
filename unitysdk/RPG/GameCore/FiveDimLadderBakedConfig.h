...
#define RPG_GAMECORE_FIVEDIMLADDERBAKEDCONFIG_METHOD_2_28A10FDC3FE70DF1_OFFSET UNITYSDK_OFFSET(0x1D0ED980)
#define RPG_GAMECORE_FIVEDIMLADDERBAKEDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0EDBA0)
