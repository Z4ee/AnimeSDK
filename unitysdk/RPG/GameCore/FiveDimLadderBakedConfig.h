...
#define RPG_GAMECORE_FIVEDIMLADDERBAKEDCONFIG_METHOD_2_28A10FDC3FE70DF1_OFFSET UNITYSDK_OFFSET(0x1D866410)
#define RPG_GAMECORE_FIVEDIMLADDERBAKEDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D866630)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimLadderBakedConfig_TypeDefinitionIndex = 16479;
