...
#define RPG_GAMECORE_FIVEDIMLADDERBAKEDCONFIG_METHOD_2_28A10FDC3FE70DF1_OFFSET UNITYSDK_OFFSET(0x171F81B0)
#define RPG_GAMECORE_FIVEDIMLADDERBAKEDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171F83D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimLadderBakedConfig_TypeDefinitionIndex = 15261;
