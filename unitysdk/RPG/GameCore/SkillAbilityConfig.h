...
#define RPG_GAMECORE_SKILLABILITYCONFIG_METHOD_2_2D6E1F92B1FBF606_OFFSET UNITYSDK_OFFSET(0x1BE4E5A0)
#define RPG_GAMECORE_SKILLABILITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE4E6C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SkillAbilityConfig_TypeDefinitionIndex = 15036;
