...
#define RPG_GAMECORE_RELEASETARGETUNIQUENAME_METHOD_3_DAE2183EFD7871BB_OFFSET UNITYSDK_OFFSET(0x18C96FC0)
#define RPG_GAMECORE_RELEASETARGETUNIQUENAME_METHOD_3_F929DC2AEC6E6412_OFFSET UNITYSDK_OFFSET(0x18C97040)
#define RPG_GAMECORE_RELEASETARGETUNIQUENAME__CTOR_OFFSET UNITYSDK_OFFSET(0x18C97010)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ReleaseTargetUniqueName_TypeDefinitionIndex = 22142;
