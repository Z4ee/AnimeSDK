...
#define RPG_GAMECORE_CHIMERABATTLESHOWNPCLEAVE_METHOD_3_1BD8C90BAE326220_OFFSET UNITYSDK_OFFSET(0x1C38EA90)
#define RPG_GAMECORE_CHIMERABATTLESHOWNPCLEAVE_METHOD_3_CAC3313AEB560082_OFFSET UNITYSDK_OFFSET(0x1C38FBC0)
#define RPG_GAMECORE_CHIMERABATTLESHOWNPCLEAVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C38EA80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraBattleShowNPCLeave_TypeDefinitionIndex = 15264;
