...
#define RPG_GAMECORE_CHIMERABATTLESHOWNPCLEAVE_METHOD_3_1BD8C90BAE326220_OFFSET UNITYSDK_OFFSET(0x17093680)
#define RPG_GAMECORE_CHIMERABATTLESHOWNPCLEAVE_METHOD_3_CAC3313AEB560082_OFFSET UNITYSDK_OFFSET(0x170947A0)
#define RPG_GAMECORE_CHIMERABATTLESHOWNPCLEAVE__CTOR_OFFSET UNITYSDK_OFFSET(0x17093670)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraBattleShowNPCLeave_TypeDefinitionIndex = 14567;
