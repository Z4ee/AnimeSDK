...
#define RPG_GAMECORE_NPCAPPEARANCEPRESET_METHOD_2_399D005045C6C2FC_OFFSET UNITYSDK_OFFSET(0x1746AC50)
#define RPG_GAMECORE_NPCAPPEARANCEPRESET__CTOR_OFFSET UNITYSDK_OFFSET(0x1746AE20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NPCAppearancePreset_TypeDefinitionIndex = 16040;
