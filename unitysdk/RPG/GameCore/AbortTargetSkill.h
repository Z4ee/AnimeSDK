...
#define RPG_GAMECORE_ABORTTARGETSKILL_METHOD_3_28440225569EE360_OFFSET UNITYSDK_OFFSET(0x193C6B00)
#define RPG_GAMECORE_ABORTTARGETSKILL_METHOD_3_AB730E9B18CCC682_OFFSET UNITYSDK_OFFSET(0x193C6B80)
#define RPG_GAMECORE_ABORTTARGETSKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x193C6B50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AbortTargetSkill_TypeDefinitionIndex = 19807;
