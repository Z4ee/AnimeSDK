...
#define RPG_GAMECORE_ABORTTARGETSKILL_METHOD_3_28440225569EE360_OFFSET UNITYSDK_OFFSET(0x16E955B0)
#define RPG_GAMECORE_ABORTTARGETSKILL_METHOD_3_AB730E9B18CCC682_OFFSET UNITYSDK_OFFSET(0x16E95630)
#define RPG_GAMECORE_ABORTTARGETSKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x16E95600)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AbortTargetSkill_TypeDefinitionIndex = 19285;
