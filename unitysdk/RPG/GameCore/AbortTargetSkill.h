...
#define RPG_GAMECORE_ABORTTARGETSKILL_METHOD_3_0F2385E590A1AD7D_OFFSET UNITYSDK_OFFSET(0x1C9E1B20)
#define RPG_GAMECORE_ABORTTARGETSKILL_METHOD_3_AB730E9B18CCC682_OFFSET UNITYSDK_OFFSET(0x1C9E1B60)
#define RPG_GAMECORE_ABORTTARGETSKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9E1B50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AbortTargetSkill_TypeDefinitionIndex = 20717;
