...
#define RPG_GAMECORE_ENTERHIPPLENGAME_METHOD_3_42152EA725C0565D_OFFSET UNITYSDK_OFFSET(0x1719E880)
#define RPG_GAMECORE_ENTERHIPPLENGAME_METHOD_3_CB7896F61CAD2D91_OFFSET UNITYSDK_OFFSET(0x1719E990)
#define RPG_GAMECORE_ENTERHIPPLENGAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1719E960)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnterHipplenGame_TypeDefinitionIndex = 19604;
