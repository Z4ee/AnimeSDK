...
#define RPG_GAMECORE_VCAMERAFREELOOK3RDBASECHANGEPARAM_METHOD_2_E76FD3A954783DC1_OFFSET UNITYSDK_OFFSET(0x19E3E200)
#define RPG_GAMECORE_VCAMERAFREELOOK3RDBASECHANGEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x19E3E520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VCameraFreelook3rdBaseChangeParam_TypeDefinitionIndex = 15589;
