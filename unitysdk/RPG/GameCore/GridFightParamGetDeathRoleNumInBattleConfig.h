...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETDEATHROLENUMINBATTLECONFIG_METHOD_6_32874671558E8CE6_OFFSET UNITYSDK_OFFSET(0x1726F9F0)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETDEATHROLENUMINBATTLECONFIG_METHOD_6_70FE41BC0F75EDF0_OFFSET UNITYSDK_OFFSET(0x1726FCA0)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETDEATHROLENUMINBATTLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1726FB70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightParamGetDeathRoleNumInBattleConfig_TypeDefinitionIndex = 17896;
