...
#define RPG_GAMECORE_STARTSTAGEBGM_METHOD_3_1E998E83DF11C9BE_OFFSET UNITYSDK_OFFSET(0x1B0BEBD0)
#define RPG_GAMECORE_STARTSTAGEBGM_METHOD_3_FBB230053C574B9D_OFFSET UNITYSDK_OFFSET(0x1B0BEC10)
#define RPG_GAMECORE_STARTSTAGEBGM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0BEC00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StartStageBGM_TypeDefinitionIndex = 22573;
