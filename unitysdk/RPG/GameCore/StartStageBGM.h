...
#define RPG_GAMECORE_STARTSTAGEBGM_METHOD_3_04BBDCD73A351ABB_OFFSET UNITYSDK_OFFSET(0x177761A0)
#define RPG_GAMECORE_STARTSTAGEBGM_METHOD_3_FBB230053C574B9D_OFFSET UNITYSDK_OFFSET(0x17776220)
#define RPG_GAMECORE_STARTSTAGEBGM__CTOR_OFFSET UNITYSDK_OFFSET(0x177761F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StartStageBGM_TypeDefinitionIndex = 21642;
