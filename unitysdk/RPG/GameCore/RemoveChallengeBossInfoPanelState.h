...
#define RPG_GAMECORE_REMOVECHALLENGEBOSSINFOPANELSTATE_METHOD_3_5A880B76904ED407_OFFSET UNITYSDK_OFFSET(0x1B9CEA80)
#define RPG_GAMECORE_REMOVECHALLENGEBOSSINFOPANELSTATE_METHOD_3_A3B574803374F614_OFFSET UNITYSDK_OFFSET(0x1B9CEA40)
#define RPG_GAMECORE_REMOVECHALLENGEBOSSINFOPANELSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9CEA70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveChallengeBossInfoPanelState_TypeDefinitionIndex = 22387;
