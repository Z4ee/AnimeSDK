...
#define RPG_GAMECORE_ROGUEMODIFIERLEVELUPROOMCARDONSELFATTRIBUTEREMOVECONFIG_METHOD_3_74577F94FD505951_OFFSET UNITYSDK_OFFSET(0x18D3F920)
#define RPG_GAMECORE_ROGUEMODIFIERLEVELUPROOMCARDONSELFATTRIBUTEREMOVECONFIG_METHOD_3_DE68C1D942504AB8_OFFSET UNITYSDK_OFFSET(0x18D3F850)
#define RPG_GAMECORE_ROGUEMODIFIERLEVELUPROOMCARDONSELFATTRIBUTEREMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D3F8D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierLevelUpRoomCardOnSelfAttributeRemoveConfig_TypeDefinitionIndex = 16956;
