...
#define RPG_GAMECORE_CLOCKPARKSTORYSWITCHBACKGROUND_METHOD_3_97B770EDA07FF672_OFFSET UNITYSDK_OFFSET(0x18820E00)
#define RPG_GAMECORE_CLOCKPARKSTORYSWITCHBACKGROUND_METHOD_3_E97FA74A6E754839_OFFSET UNITYSDK_OFFSET(0x18820E90)
#define RPG_GAMECORE_CLOCKPARKSTORYSWITCHBACKGROUND__CTOR_OFFSET UNITYSDK_OFFSET(0x18820E60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClockParkStorySwitchBackground_TypeDefinitionIndex = 19937;
