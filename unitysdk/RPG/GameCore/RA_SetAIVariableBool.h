...
#define RPG_GAMECORE_RA_SETAIVARIABLEBOOL_METHOD_4_6D23C85EE214B863_OFFSET UNITYSDK_OFFSET(0x18C830A0)
#define RPG_GAMECORE_RA_SETAIVARIABLEBOOL_METHOD_4_95A8CC5FD29C0417_OFFSET UNITYSDK_OFFSET(0x18C83020)
#define RPG_GAMECORE_RA_SETAIVARIABLEBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x18C83070)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RA_SetAIVariableBool_TypeDefinitionIndex = 18963;
