...
#define RPG_GAMECORE_RA_SETAIVARIABLEBOOL_METHOD_4_6D23C85EE214B863_OFFSET UNITYSDK_OFFSET(0x1D192CB0)
#define RPG_GAMECORE_RA_SETAIVARIABLEBOOL_METHOD_4_C6CB2528826C27FC_OFFSET UNITYSDK_OFFSET(0x1D192C70)
#define RPG_GAMECORE_RA_SETAIVARIABLEBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D192CA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RA_SetAIVariableBool_TypeDefinitionIndex = 19808;
