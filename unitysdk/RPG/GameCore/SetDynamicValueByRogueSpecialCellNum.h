...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUESPECIALCELLNUM_METHOD_3_47ED0A627A9B7D1D_OFFSET UNITYSDK_OFFSET(0x18E27420)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUESPECIALCELLNUM_METHOD_3_A517F704D75ABD92_OFFSET UNITYSDK_OFFSET(0x18E273B0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUESPECIALCELLNUM__CTOR_OFFSET UNITYSDK_OFFSET(0x18E273F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRogueSpecialCellNum_TypeDefinitionIndex = 20641;
