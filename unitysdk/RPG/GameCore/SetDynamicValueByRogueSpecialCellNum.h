...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUESPECIALCELLNUM_METHOD_3_47ED0A627A9B7D1D_OFFSET UNITYSDK_OFFSET(0x1E822530)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUESPECIALCELLNUM_METHOD_3_D340C4CCDCF14710_OFFSET UNITYSDK_OFFSET(0x1E8224F0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUESPECIALCELLNUM__CTOR_OFFSET UNITYSDK_OFFSET(0x1E822520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRogueSpecialCellNum_TypeDefinitionIndex = 21547;
