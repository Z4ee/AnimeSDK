...
#define RPG_GAMECORE_MANIKINMONSTERPOSITIONSCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x198BA580)
#define RPG_GAMECORE_MANIKINMONSTERPOSITIONSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x198BA820)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ManikinMonsterPositionsConfig_TypeDefinitionIndex = 16617;
	...
	public:
		...
		static ::System::Void FromBinary(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::ManikinMonsterPositionsConfig*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::ManikinMonsterPositionsConfig*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_MANIKINMONSTERPOSITIONSCONFIG_FROMBINARY_OFFSET))(a1, a2);
		}
	};
}
