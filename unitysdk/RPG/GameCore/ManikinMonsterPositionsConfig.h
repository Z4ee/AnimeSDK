...
#define RPG_GAMECORE_MANIKINMONSTERPOSITIONSCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17379230)
#define RPG_GAMECORE_MANIKINMONSTERPOSITIONSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x173794E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ManikinMonsterPositionsConfig_TypeDefinitionIndex = 16058;
