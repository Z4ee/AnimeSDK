...
#define RPG_GAMECORE_DEPLOYPUZZLEFADEOUT_METHOD_3_66893F6EC5C64B59_OFFSET UNITYSDK_OFFSET(0x1885A5A0)
#define RPG_GAMECORE_DEPLOYPUZZLEFADEOUT_METHOD_3_AEB0835A8A24BA11_OFFSET UNITYSDK_OFFSET(0x1885A450)
#define RPG_GAMECORE_DEPLOYPUZZLEFADEOUT__CTOR_OFFSET UNITYSDK_OFFSET(0x1885A510)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DeployPuzzleFadeout_TypeDefinitionIndex = 20837;
