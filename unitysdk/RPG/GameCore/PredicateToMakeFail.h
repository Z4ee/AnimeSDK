...
#define RPG_GAMECORE_PREDICATETOMAKEFAIL_METHOD_3_4753A87FD3BE224C_OFFSET UNITYSDK_OFFSET(0x1D7B5EA0)
#define RPG_GAMECORE_PREDICATETOMAKEFAIL_METHOD_3_656930E61998732B_OFFSET UNITYSDK_OFFSET(0x1D7B5E60)
#define RPG_GAMECORE_PREDICATETOMAKEFAIL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7B5E90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PredicateToMakeFail_TypeDefinitionIndex = 23490;
