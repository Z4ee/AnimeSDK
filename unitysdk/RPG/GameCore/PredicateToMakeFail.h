...
#define RPG_GAMECORE_PREDICATETOMAKEFAIL_METHOD_3_4753A87FD3BE224C_OFFSET UNITYSDK_OFFSET(0x18C5FE60)
#define RPG_GAMECORE_PREDICATETOMAKEFAIL_METHOD_3_F6C2D01ED273045A_OFFSET UNITYSDK_OFFSET(0x18C5FDE0)
#define RPG_GAMECORE_PREDICATETOMAKEFAIL__CTOR_OFFSET UNITYSDK_OFFSET(0x18C5FE30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PredicateToMakeFail_TypeDefinitionIndex = 22753;
