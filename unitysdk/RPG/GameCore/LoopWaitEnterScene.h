...
#define RPG_GAMECORE_LOOPWAITENTERSCENE_METHOD_3_7A4733B0087E7C96_OFFSET UNITYSDK_OFFSET(0x17370CB0)
#define RPG_GAMECORE_LOOPWAITENTERSCENE_METHOD_3_F68856A7854D8F96_OFFSET UNITYSDK_OFFSET(0x17370C20)
#define RPG_GAMECORE_LOOPWAITENTERSCENE__CTOR_OFFSET UNITYSDK_OFFSET(0x17370C80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoopWaitEnterScene_TypeDefinitionIndex = 19483;
