...
#define RPG_GAMECORE_TALKREWARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18ECF230)
#define RPG_GAMECORE_TALKREWARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18ECF540)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TalkRewardRow_TypeDefinitionIndex = 14412;
	...
	public:
		...
		::System::UInt32 NPCConfigID; // 0x18
