...
#define RPG_GAMECORE_ROGUEDLC1DOT3ADVENTUREROOMMANAGE_METHOD_3_D78A7F648B382E88_OFFSET UNITYSDK_OFFSET(0x18CFCB50)
#define RPG_GAMECORE_ROGUEDLC1DOT3ADVENTUREROOMMANAGE_METHOD_3_D7ECE59D81973C97_OFFSET UNITYSDK_OFFSET(0x18CFCAD0)
#define RPG_GAMECORE_ROGUEDLC1DOT3ADVENTUREROOMMANAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x18CFCB20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueDLC1Dot3AdventureRoomManage_TypeDefinitionIndex = 21152;
