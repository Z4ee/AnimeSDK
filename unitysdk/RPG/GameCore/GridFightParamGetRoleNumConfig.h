...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETROLENUMCONFIG_METHOD_6_0CE86A9D2BB58A95_OFFSET UNITYSDK_OFFSET(0x1EE71F40)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETROLENUMCONFIG_METHOD_6_2994F2C4CFCD9071_OFFSET UNITYSDK_OFFSET(0x1EE71EF0)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETROLENUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EE71F30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightParamGetRoleNumConfig_TypeDefinitionIndex = 19288;
