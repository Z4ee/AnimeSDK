...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETROLENUMCONFIG_METHOD_6_0CE86A9D2BB58A95_OFFSET UNITYSDK_OFFSET(0x189C7210)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETROLENUMCONFIG_METHOD_6_2F705BE95693E65B_OFFSET UNITYSDK_OFFSET(0x189C6F60)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETROLENUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189C70E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightParamGetRoleNumConfig_TypeDefinitionIndex = 18531;
