...
#define RPG_GAMECORE_BYCOMPARECONTROLSKILLEFFECTISDAMAGING_METHOD_4_3130F74CCEC63951_OFFSET UNITYSDK_OFFSET(0x17005480)
#define RPG_GAMECORE_BYCOMPARECONTROLSKILLEFFECTISDAMAGING_METHOD_4_3870518E5DCE6DF3_OFFSET UNITYSDK_OFFSET(0x17005560)
#define RPG_GAMECORE_BYCOMPARECONTROLSKILLEFFECTISDAMAGING__CTOR_OFFSET UNITYSDK_OFFSET(0x17005500)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareControlSkillEffectIsDamaging_TypeDefinitionIndex = 21232;
