...
#define RPG_GAMECORE_BYCOMPARECONTROLSKILLEFFECTISDAMAGING_METHOD_4_1800A3982D6A3551_OFFSET UNITYSDK_OFFSET(0x1CEB99B0)
#define RPG_GAMECORE_BYCOMPARECONTROLSKILLEFFECTISDAMAGING_METHOD_4_328C460B6D4808B2_OFFSET UNITYSDK_OFFSET(0x1CEB96F0)
#define RPG_GAMECORE_BYCOMPARECONTROLSKILLEFFECTISDAMAGING_METHOD_4_3870518E5DCE6DF3_OFFSET UNITYSDK_OFFSET(0x1CEB9740)
#define RPG_GAMECORE_BYCOMPARECONTROLSKILLEFFECTISDAMAGING_METHOD_4_38B2EE3544208427_OFFSET UNITYSDK_OFFSET(0x1CEB99F0)
#define RPG_GAMECORE_BYCOMPARECONTROLSKILLEFFECTISDAMAGING__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEB9730)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareControlSkillEffectIsDamaging_TypeDefinitionIndex = 22767;
