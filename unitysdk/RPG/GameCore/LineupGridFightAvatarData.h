...
#define RPG_GAMECORE_LINEUPGRIDFIGHTAVATARDATA_METHOD_2_5EB7717F86A280C7_OFFSET UNITYSDK_OFFSET(0x1DD5F910)
#define RPG_GAMECORE_LINEUPGRIDFIGHTAVATARDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD5FAD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LineupGridFightAvatarData_TypeDefinitionIndex = 17915;
