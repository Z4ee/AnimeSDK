...
#define RPG_GAMECORE_LINEUPGRIDFIGHTAVATARDATA_METHOD_2_5EB7717F86A280C7_OFFSET UNITYSDK_OFFSET(0x18A60610)
#define RPG_GAMECORE_LINEUPGRIDFIGHTAVATARDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18A607E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LineupGridFightAvatarData_TypeDefinitionIndex = 17228;
