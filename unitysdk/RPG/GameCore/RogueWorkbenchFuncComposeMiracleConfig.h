...
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCCOMPOSEMIRACLECONFIG_METHOD_3_713C3A8875F61877_OFFSET UNITYSDK_OFFSET(0x176734D0)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCCOMPOSEMIRACLECONFIG_METHOD_3_F254292ED92FB633_OFFSET UNITYSDK_OFFSET(0x17673660)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCCOMPOSEMIRACLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x176734C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueWorkbenchFuncComposeMiracleConfig_TypeDefinitionIndex = 16566;
