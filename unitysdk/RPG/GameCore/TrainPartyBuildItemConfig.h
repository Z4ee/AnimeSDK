...
#define RPG_GAMECORE_TRAINPARTYBUILDITEMCONFIG_METHOD_2_B9F2FDA3756AE097_OFFSET UNITYSDK_OFFSET(0x1C15D880)
#define RPG_GAMECORE_TRAINPARTYBUILDITEMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C15D970)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyBuildItemConfig_TypeDefinitionIndex = 15630;
