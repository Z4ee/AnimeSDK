...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_CHALLENGERREVIVAL_METHOD_3_1B2D014C54A8A14B_OFFSET UNITYSDK_OFFSET(0x196B25E0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_CHALLENGERREVIVAL_METHOD_3_203098AD367578F4_OFFSET UNITYSDK_OFFSET(0x196B8D10)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_CHALLENGERREVIVAL__CTOR_OFFSET UNITYSDK_OFFSET(0x196B2590)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_ChallengerRevival_TypeDefinitionIndex = 15306;
