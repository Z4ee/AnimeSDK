...
#define RPG_GAMECORE_PLAYERREMOTECONTROLOTHERENTITY_METHOD_3_52D8336334ACC424_OFFSET UNITYSDK_OFFSET(0x18C30850)
#define RPG_GAMECORE_PLAYERREMOTECONTROLOTHERENTITY_METHOD_3_82620A8445A11AE6_OFFSET UNITYSDK_OFFSET(0x18C307D0)
#define RPG_GAMECORE_PLAYERREMOTECONTROLOTHERENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x18C30820)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayerRemoteControlOtherEntity_TypeDefinitionIndex = 19475;
