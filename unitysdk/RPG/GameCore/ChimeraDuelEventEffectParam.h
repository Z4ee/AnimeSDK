...
#define RPG_GAMECORE_CHIMERADUELEVENTEFFECTPARAM_METHOD_3_1041FB1B97D3BCCB_OFFSET UNITYSDK_OFFSET(0x1C23E7A0)
#define RPG_GAMECORE_CHIMERADUELEVENTEFFECTPARAM_METHOD_3_1731330F123D09FB_OFFSET UNITYSDK_OFFSET(0x1C23E800)
#define RPG_GAMECORE_CHIMERADUELEVENTEFFECTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1C23E7F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelEventEffectParam_TypeDefinitionIndex = 15406;
