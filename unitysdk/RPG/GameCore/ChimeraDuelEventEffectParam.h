...
#define RPG_GAMECORE_CHIMERADUELEVENTEFFECTPARAM_METHOD_3_1041FB1B97D3BCCB_OFFSET UNITYSDK_OFFSET(0x1709B8B0)
#define RPG_GAMECORE_CHIMERADUELEVENTEFFECTPARAM_METHOD_3_1731330F123D09FB_OFFSET UNITYSDK_OFFSET(0x1709B910)
#define RPG_GAMECORE_CHIMERADUELEVENTEFFECTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1709B900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelEventEffectParam_TypeDefinitionIndex = 14711;
