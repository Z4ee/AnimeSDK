...
#define RPG_GAMECORE_CHIMERADUELEVENTEFFECTPARAM_METHOD_3_1041FB1B97D3BCCB_OFFSET UNITYSDK_OFFSET(0x1963CE20)
#define RPG_GAMECORE_CHIMERADUELEVENTEFFECTPARAM_METHOD_3_1731330F123D09FB_OFFSET UNITYSDK_OFFSET(0x1963CE80)
#define RPG_GAMECORE_CHIMERADUELEVENTEFFECTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1963CE70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelEventEffectParam_TypeDefinitionIndex = 15242;
