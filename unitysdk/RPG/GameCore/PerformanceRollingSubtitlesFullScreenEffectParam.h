...
#define RPG_GAMECORE_PERFORMANCEROLLINGSUBTITLESFULLSCREENEFFECTPARAM_METHOD_2_225BA76B1686C76A_OFFSET UNITYSDK_OFFSET(0x199FA930)
#define RPG_GAMECORE_PERFORMANCEROLLINGSUBTITLESFULLSCREENEFFECTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x199FAAF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PerformanceRollingSubtitlesFullScreenEffectParam_TypeDefinitionIndex = 23078;
