...
#define RPG_GAMECORE_PERFORMANCEROLLINGSUBTITLESFULLSCREENEFFECTPARAM_METHOD_2_225BA76B1686C76A_OFFSET UNITYSDK_OFFSET(0x1D31F950)
#define RPG_GAMECORE_PERFORMANCEROLLINGSUBTITLESFULLSCREENEFFECTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D31FB10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PerformanceRollingSubtitlesFullScreenEffectParam_TypeDefinitionIndex = 24130;
