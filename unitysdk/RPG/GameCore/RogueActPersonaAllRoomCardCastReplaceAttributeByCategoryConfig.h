...
#define RPG_GAMECORE_ROGUEACTPERSONAALLROOMCARDCASTREPLACEATTRIBUTEBYCATEGORYCONFIG_METHOD_7_1641980B26348D1F_OFFSET UNITYSDK_OFFSET(0x1D3B85D0)
#define RPG_GAMECORE_ROGUEACTPERSONAALLROOMCARDCASTREPLACEATTRIBUTEBYCATEGORYCONFIG_METHOD_7_D2EFAB12C9AF4B23_OFFSET UNITYSDK_OFFSET(0x1D3B84F0)
#define RPG_GAMECORE_ROGUEACTPERSONAALLROOMCARDCASTREPLACEATTRIBUTEBYCATEGORYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3B84E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaAllRoomCardCastReplaceAttributeByCategoryConfig_TypeDefinitionIndex = 19519;
