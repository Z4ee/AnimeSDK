...
#define RPG_GAMECORE_COLLECTDATACONDITIONS_METHOD_3_215A9C5B539377B3_OFFSET UNITYSDK_OFFSET(0x1711EEE0)
#define RPG_GAMECORE_COLLECTDATACONDITIONS_METHOD_3_909991EEB7C7239B_OFFSET UNITYSDK_OFFSET(0x1711EE60)
#define RPG_GAMECORE_COLLECTDATACONDITIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1711EEB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CollectDataConditions_TypeDefinitionIndex = 19179;
