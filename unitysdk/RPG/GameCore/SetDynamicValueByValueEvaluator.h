...
#define RPG_GAMECORE_SETDYNAMICVALUEBYVALUEEVALUATOR_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x18E2A200)
#define RPG_GAMECORE_SETDYNAMICVALUEBYVALUEEVALUATOR_METHOD_4_0B97E22B2350D1F6_OFFSET UNITYSDK_OFFSET(0x18E2A050)
#define RPG_GAMECORE_SETDYNAMICVALUEBYVALUEEVALUATOR_METHOD_4_5092248C167D0A37_OFFSET UNITYSDK_OFFSET(0x18E29F30)
#define RPG_GAMECORE_SETDYNAMICVALUEBYVALUEEVALUATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x18E29FD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByValueEvaluator_TypeDefinitionIndex = 22821;
