...
#define RPG_GAMECORE_FSVFILTERHOYOTAGEXPRESSION_METHOD_3_0E498E66C4E9F305_OFFSET UNITYSDK_OFFSET(0x188C9930)
#define RPG_GAMECORE_FSVFILTERHOYOTAGEXPRESSION_METHOD_3_E8D56BBD789341A1_OFFSET UNITYSDK_OFFSET(0x188C9940)
#define RPG_GAMECORE_FSVFILTERHOYOTAGEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x188C9920)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FSVFilterHoyoTagExpression_TypeDefinitionIndex = 16513;
