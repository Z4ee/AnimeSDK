...
#define RPG_GAMECORE_RAIDTYPECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18C89570)
#define RPG_GAMECORE_RAIDTYPECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18C89790)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::RPG::GameCore::RaidFinishType FinishType; // 0x10
