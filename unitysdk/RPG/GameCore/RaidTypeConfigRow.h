...
#define RPG_GAMECORE_RAIDTYPECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B9B6120)
#define RPG_GAMECORE_RAIDTYPECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9B6340)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RaidTypeConfigRow_TypeDefinitionIndex = 14022;
