...
#define RPG_GAMECORE_CHIMERAGALLERYACTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x170A93B0)
#define RPG_GAMECORE_CHIMERAGALLERYACTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x170A95A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraGalleryActRow_TypeDefinitionIndex = 11905;
