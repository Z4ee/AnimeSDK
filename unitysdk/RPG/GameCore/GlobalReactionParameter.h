...
#define RPG_GAMECORE_GLOBALREACTIONPARAMETER_METHOD_2_21DACADD96880816_OFFSET UNITYSDK_OFFSET(0x1D1451D0)
#define RPG_GAMECORE_GLOBALREACTIONPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D145320)
