...
#define RPG_GAMECORE_GRIDFIGHTTRAITVIDEOCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x189DE2F0)
#define RPG_GAMECORE_GRIDFIGHTTRAITVIDEOCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x189DE4B0)
