...
#define RPG_GAMECORE_RELICCOMPOSECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B9C3650)
#define RPG_GAMECORE_RELICCOMPOSECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9C38D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RelicComposeConfigRow_TypeDefinitionIndex = 13346;
