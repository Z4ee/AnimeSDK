...
#define RPG_GAMECORE_RELICCOMPOSECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D392C20)
#define RPG_GAMECORE_RELICCOMPOSECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D392EA0)
