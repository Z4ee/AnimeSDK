...
#define RPG_GAMECORE_RELICCOMPOSECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19ABC530)
#define RPG_GAMECORE_RELICCOMPOSECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19ABC7B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RelicComposeConfigRow_TypeDefinitionIndex = 13198;
