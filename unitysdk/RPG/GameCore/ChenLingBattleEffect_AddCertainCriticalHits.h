...
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_ADDCERTAINCRITICALHITS_METHOD_3_73385A17223C2B5F_OFFSET UNITYSDK_OFFSET(0x1C37A410)
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_ADDCERTAINCRITICALHITS_METHOD_3_A3F24A51EEE4A3B3_OFFSET UNITYSDK_OFFSET(0x1C37A4E0)
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_ADDCERTAINCRITICALHITS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C37A4D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleEffect_AddCertainCriticalHits_TypeDefinitionIndex = 15180;
