...
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_ADDCERTAINCRITICALHITS_METHOD_3_73385A17223C2B5F_OFFSET UNITYSDK_OFFSET(0x1CFA8D30)
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_ADDCERTAINCRITICALHITS_METHOD_3_A3F24A51EEE4A3B3_OFFSET UNITYSDK_OFFSET(0x1CFA8E00)
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_ADDCERTAINCRITICALHITS__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFA8DF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleEffect_AddCertainCriticalHits_TypeDefinitionIndex = 15617;
