...
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMAGICUNITRANDOMDROPCONFIG_METHOD_6_3B3A890AC8B0A929_OFFSET UNITYSDK_OFFSET(0x19AFC450)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMAGICUNITRANDOMDROPCONFIG_METHOD_6_72260D57A61517F4_OFFSET UNITYSDK_OFFSET(0x19AFC230)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMAGICUNITRANDOMDROPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AFC370)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActTriggerRogueMagicUnitRandomDropConfig_TypeDefinitionIndex = 18648;
