...
#define RPG_GAMECORE_TUTORIALCHIMERAARRANGEMENTDISABLEDRAGGING_METHOD_3_170561BABF8E5088_OFFSET UNITYSDK_OFFSET(0x190D4F80)
#define RPG_GAMECORE_TUTORIALCHIMERAARRANGEMENTDISABLEDRAGGING_METHOD_3_EFB9B506BC18A821_OFFSET UNITYSDK_OFFSET(0x190D4F00)
#define RPG_GAMECORE_TUTORIALCHIMERAARRANGEMENTDISABLEDRAGGING__CTOR_OFFSET UNITYSDK_OFFSET(0x190D4F50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TutorialChimeraArrangementDisableDragging_TypeDefinitionIndex = 23399;
