...
#define RPG_GAMECORE_PARAMBATCHEXPRCONFIG_METHOD_4_957678D67209FC44_OFFSET UNITYSDK_OFFSET(0x1BB0D180)
#define RPG_GAMECORE_PARAMBATCHEXPRCONFIG_METHOD_4_EAC47D1D5D405EDA_OFFSET UNITYSDK_OFFSET(0x1BB0D1E0)
#define RPG_GAMECORE_PARAMBATCHEXPRCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB0D1D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ParamBatchExprConfig_TypeDefinitionIndex = 16402;
