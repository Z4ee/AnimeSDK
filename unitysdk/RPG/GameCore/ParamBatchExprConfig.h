...
#define RPG_GAMECORE_PARAMBATCHEXPRCONFIG_METHOD_4_222B7DA24E4A6505_OFFSET UNITYSDK_OFFSET(0x18BD2B10)
#define RPG_GAMECORE_PARAMBATCHEXPRCONFIG_METHOD_4_EAC47D1D5D405EDA_OFFSET UNITYSDK_OFFSET(0x18BD2C50)
#define RPG_GAMECORE_PARAMBATCHEXPRCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18BD2BD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ParamBatchExprConfig_TypeDefinitionIndex = 16173;
