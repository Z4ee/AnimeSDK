...
#define RPG_GAMECORE_PARAMBATCHEXPRCONFIG_METHOD_4_222B7DA24E4A6505_OFFSET UNITYSDK_OFFSET(0x174885F0)
#define RPG_GAMECORE_PARAMBATCHEXPRCONFIG_METHOD_4_EAC47D1D5D405EDA_OFFSET UNITYSDK_OFFSET(0x17488730)
#define RPG_GAMECORE_PARAMBATCHEXPRCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x174886B0)
