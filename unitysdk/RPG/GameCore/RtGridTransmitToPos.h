...
#define RPG_GAMECORE_RTGRIDTRANSMITTOPOS_METHOD_3_3F92DD6A1FA5DAE9_OFFSET UNITYSDK_OFFSET(0x1D4AA830)
#define RPG_GAMECORE_RTGRIDTRANSMITTOPOS_METHOD_3_D6B66F797121701E_OFFSET UNITYSDK_OFFSET(0x1D4AA790)
#define RPG_GAMECORE_RTGRIDTRANSMITTOPOS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4AA7F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtGridTransmitToPos_TypeDefinitionIndex = 23841;
