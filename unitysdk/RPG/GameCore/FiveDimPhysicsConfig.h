...
#define RPG_GAMECORE_FIVEDIMPHYSICSCONFIG_METHOD_2_1F0E31563523514D_OFFSET UNITYSDK_OFFSET(0x1973F030)
#define RPG_GAMECORE_FIVEDIMPHYSICSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1974BE90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimPhysicsConfig_TypeDefinitionIndex = 15847;
