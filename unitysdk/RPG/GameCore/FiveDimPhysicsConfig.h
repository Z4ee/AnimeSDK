...
#define RPG_GAMECORE_FIVEDIMPHYSICSCONFIG_METHOD_2_1F0E31563523514D_OFFSET UNITYSDK_OFFSET(0x18911A30)
#define RPG_GAMECORE_FIVEDIMPHYSICSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18911AE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimPhysicsConfig_TypeDefinitionIndex = 15792;
