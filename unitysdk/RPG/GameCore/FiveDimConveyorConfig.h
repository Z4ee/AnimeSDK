...
#define RPG_GAMECORE_FIVEDIMCONVEYORCONFIG_METHOD_3_36F92CFB895C9187_OFFSET UNITYSDK_OFFSET(0x171ED3B0)
#define RPG_GAMECORE_FIVEDIMCONVEYORCONFIG_METHOD_3_42A09DD4111C5B32_OFFSET UNITYSDK_OFFSET(0x171ED340)
#define RPG_GAMECORE_FIVEDIMCONVEYORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171ED390)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimConveyorConfig_TypeDefinitionIndex = 17063;
	...
	public:
		...
		static ::System::Void Method_3_36F92CFB895C9187(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::FiveDimConveyorConfig* a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::FiveDimConveyorConfig*))((::PBYTE)hIl2Cpp + RPG_GAMECORE_FIVEDIMCONVEYORCONFIG_METHOD_3_36F92CFB895C9187_OFFSET))(a1, a2);
		}
	};
}
