...
#define RPG_GAMECORE_BYSKIPNEXTTELEPORTEFFECT_METHOD_4_12D8F22203F82425_OFFSET UNITYSDK_OFFSET(0x1CDC2730)
#define RPG_GAMECORE_BYSKIPNEXTTELEPORTEFFECT_METHOD_4_676730271EAEFEDA_OFFSET UNITYSDK_OFFSET(0x1CDC25C0)
#define RPG_GAMECORE_BYSKIPNEXTTELEPORTEFFECT_METHOD_4_7E94D797D9836D51_OFFSET UNITYSDK_OFFSET(0x1CDC2580)
#define RPG_GAMECORE_BYSKIPNEXTTELEPORTEFFECT_METHOD_4_C2622D518CA30D24_OFFSET UNITYSDK_OFFSET(0x1CDC2700)
#define RPG_GAMECORE_BYSKIPNEXTTELEPORTEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDC25B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BySkipNextTeleportEffect_TypeDefinitionIndex = 20347;
