...
#define RPG_GAMECORE_RECOMMENDDISPLAYCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1DB7BA50)
#define RPG_GAMECORE_RECOMMENDDISPLAYCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB7BC20)
