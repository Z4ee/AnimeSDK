...
#define RPG_GAMECORE_RTTRIGGERABILITY_METHOD_3_5E61CAFF920C86AE_OFFSET UNITYSDK_OFFSET(0x1D4B8C10)
#define RPG_GAMECORE_RTTRIGGERABILITY_METHOD_3_C091F20824C542BB_OFFSET UNITYSDK_OFFSET(0x1D4B8BC0)
#define RPG_GAMECORE_RTTRIGGERABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4B8C00)
