...
#define RPG_GAMECORE_RTTRIGGERABILITY_METHOD_3_5E61CAFF920C86AE_OFFSET UNITYSDK_OFFSET(0x1CCF5AC0)
#define RPG_GAMECORE_RTTRIGGERABILITY_METHOD_3_C091F20824C542BB_OFFSET UNITYSDK_OFFSET(0x1CCF5A70)
#define RPG_GAMECORE_RTTRIGGERABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1CCF5AB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtTriggerAbility_TypeDefinitionIndex = 23804;
