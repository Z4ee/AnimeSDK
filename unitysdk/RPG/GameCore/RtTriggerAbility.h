...
#define RPG_GAMECORE_RTTRIGGERABILITY_METHOD_3_5E61CAFF920C86AE_OFFSET UNITYSDK_OFFSET(0x19BF8850)
#define RPG_GAMECORE_RTTRIGGERABILITY_METHOD_3_99B8884E1C3E8D31_OFFSET UNITYSDK_OFFSET(0x19BF87D0)
#define RPG_GAMECORE_RTTRIGGERABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x19BF8820)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtTriggerAbility_TypeDefinitionIndex = 22757;
