...
#define RPG_GAMECORE_GRIDFIGHTSHOWGUIDETALK_METHOD_3_D86C4F8B9D5BB5E6_OFFSET UNITYSDK_OFFSET(0x1D077A10)
#define RPG_GAMECORE_GRIDFIGHTSHOWGUIDETALK_METHOD_3_FDB9E6D07E118B25_OFFSET UNITYSDK_OFFSET(0x1D077A50)
#define RPG_GAMECORE_GRIDFIGHTSHOWGUIDETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D077A40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightShowGuideTalk_TypeDefinitionIndex = 19201;
