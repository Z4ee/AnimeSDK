...
#define RPG_GAMECORE_GRIDFIGHTSHOWGUIDETALK_METHOD_3_94BF918AC025CEB4_OFFSET UNITYSDK_OFFSET(0x1980AA20)
#define RPG_GAMECORE_GRIDFIGHTSHOWGUIDETALK_METHOD_3_FDB9E6D07E118B25_OFFSET UNITYSDK_OFFSET(0x1980AAA0)
#define RPG_GAMECORE_GRIDFIGHTSHOWGUIDETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1980AA70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightShowGuideTalk_TypeDefinitionIndex = 18851;
