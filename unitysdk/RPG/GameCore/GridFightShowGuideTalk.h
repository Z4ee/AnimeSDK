...
#define RPG_GAMECORE_GRIDFIGHTSHOWGUIDETALK_METHOD_3_94BF918AC025CEB4_OFFSET UNITYSDK_OFFSET(0x17283740)
#define RPG_GAMECORE_GRIDFIGHTSHOWGUIDETALK_METHOD_3_FDB9E6D07E118B25_OFFSET UNITYSDK_OFFSET(0x172837C0)
#define RPG_GAMECORE_GRIDFIGHTSHOWGUIDETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x17283790)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightShowGuideTalk_TypeDefinitionIndex = 18244;
