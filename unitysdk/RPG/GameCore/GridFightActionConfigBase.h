...
#define RPG_GAMECORE_GRIDFIGHTACTIONCONFIGBASE_METHOD_5_8C0DDF8D4A3F0FA3_OFFSET UNITYSDK_OFFSET(0x1D95F3F0)
#define RPG_GAMECORE_GRIDFIGHTACTIONCONFIGBASE_METHOD_5_DFE0497514CB1D5A_OFFSET UNITYSDK_OFFSET(0x1D95F990)
#define RPG_GAMECORE_GRIDFIGHTACTIONCONFIGBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D95F030)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightActionConfigBase_TypeDefinitionIndex = 19064;
