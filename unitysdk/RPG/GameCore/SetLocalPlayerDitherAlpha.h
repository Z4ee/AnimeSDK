...
#define RPG_GAMECORE_SETLOCALPLAYERDITHERALPHA_METHOD_3_2559A1CB8765FAE0_OFFSET UNITYSDK_OFFSET(0x18E371A0)
#define RPG_GAMECORE_SETLOCALPLAYERDITHERALPHA_METHOD_3_86961E754085BCD6_OFFSET UNITYSDK_OFFSET(0x18E37120)
#define RPG_GAMECORE_SETLOCALPLAYERDITHERALPHA__CTOR_OFFSET UNITYSDK_OFFSET(0x18E37170)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetLocalPlayerDitherAlpha_TypeDefinitionIndex = 19471;
