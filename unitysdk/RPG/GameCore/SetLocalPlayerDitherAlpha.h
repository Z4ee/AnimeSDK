...
#define RPG_GAMECORE_SETLOCALPLAYERDITHERALPHA_METHOD_3_2559A1CB8765FAE0_OFFSET UNITYSDK_OFFSET(0x19C53F90)
#define RPG_GAMECORE_SETLOCALPLAYERDITHERALPHA_METHOD_3_86961E754085BCD6_OFFSET UNITYSDK_OFFSET(0x19C53F10)
#define RPG_GAMECORE_SETLOCALPLAYERDITHERALPHA__CTOR_OFFSET UNITYSDK_OFFSET(0x19C53F60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetLocalPlayerDitherAlpha_TypeDefinitionIndex = 19374;
