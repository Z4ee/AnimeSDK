...
#define RPG_GAMECORE_SETLOCALPLAYERDITHERALPHA_METHOD_3_2559A1CB8765FAE0_OFFSET UNITYSDK_OFFSET(0x1E0842B0)
#define RPG_GAMECORE_SETLOCALPLAYERDITHERALPHA_METHOD_3_B1762C3CECB85ECF_OFFSET UNITYSDK_OFFSET(0x1E084270)
#define RPG_GAMECORE_SETLOCALPLAYERDITHERALPHA__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0842A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetLocalPlayerDitherAlpha_TypeDefinitionIndex = 20276;
