...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETLEFTDELAYINBATTLECONFIG_METHOD_6_3103F7B8FD667610_OFFSET UNITYSDK_OFFSET(0x1D06D8B0)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETLEFTDELAYINBATTLECONFIG_METHOD_6_E1B3BBDCF2F01E8C_OFFSET UNITYSDK_OFFSET(0x1D06D900)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETLEFTDELAYINBATTLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D06D8F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightParamGetLeftDelayInBattleConfig_TypeDefinitionIndex = 18777;
