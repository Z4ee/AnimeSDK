...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETLEFTDELAYINBATTLECONFIG_METHOD_6_00FA9D66EFE52DA2_OFFSET UNITYSDK_OFFSET(0x189C4BA0)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETLEFTDELAYINBATTLECONFIG_METHOD_6_E1B3BBDCF2F01E8C_OFFSET UNITYSDK_OFFSET(0x189C4E50)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETLEFTDELAYINBATTLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189C4D20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightParamGetLeftDelayInBattleConfig_TypeDefinitionIndex = 18542;
