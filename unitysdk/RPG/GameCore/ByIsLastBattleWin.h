...
#define RPG_GAMECORE_BYISLASTBATTLEWIN_METHOD_4_94D7C9FBE1676C2D_OFFSET UNITYSDK_OFFSET(0x18755550)
#define RPG_GAMECORE_BYISLASTBATTLEWIN_METHOD_4_B8D77D4082AA6B3D_OFFSET UNITYSDK_OFFSET(0x18755490)
#define RPG_GAMECORE_BYISLASTBATTLEWIN__CTOR_OFFSET UNITYSDK_OFFSET(0x18755500)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsLastBattleWin_TypeDefinitionIndex = 19772;
