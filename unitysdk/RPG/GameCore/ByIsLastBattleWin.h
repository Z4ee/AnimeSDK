...
#define RPG_GAMECORE_BYISLASTBATTLEWIN_METHOD_4_94D7C9FBE1676C2D_OFFSET UNITYSDK_OFFSET(0x1B29F470)
#define RPG_GAMECORE_BYISLASTBATTLEWIN_METHOD_4_AA4081DA0FBE46E0_OFFSET UNITYSDK_OFFSET(0x1B29F430)
#define RPG_GAMECORE_BYISLASTBATTLEWIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1B29F460)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsLastBattleWin_TypeDefinitionIndex = 20007;
