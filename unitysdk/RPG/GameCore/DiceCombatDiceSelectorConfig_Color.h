...
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_COLOR_METHOD_3_180A8A92D1C39904_OFFSET UNITYSDK_OFFSET(0x1715F2F0)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_COLOR_METHOD_3_484EADAC0CDF3E74_OFFSET UNITYSDK_OFFSET(0x17160070)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_COLOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1715F2E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatDiceSelectorConfig_Color_TypeDefinitionIndex = 14826;
