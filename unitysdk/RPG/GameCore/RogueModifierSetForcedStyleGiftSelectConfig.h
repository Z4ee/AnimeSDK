...
#define RPG_GAMECORE_ROGUEMODIFIERSETFORCEDSTYLEGIFTSELECTCONFIG_METHOD_3_C2CA37D723C4CF06_OFFSET UNITYSDK_OFFSET(0x1762D3B0)
#define RPG_GAMECORE_ROGUEMODIFIERSETFORCEDSTYLEGIFTSELECTCONFIG_METHOD_3_F97FFD651FF653AF_OFFSET UNITYSDK_OFFSET(0x17639830)
#define RPG_GAMECORE_ROGUEMODIFIERSETFORCEDSTYLEGIFTSELECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1762D360)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierSetForcedStyleGiftSelectConfig_TypeDefinitionIndex = 16399;
