...
#define RPG_GAMECORE_ROGUEMODIFIERSETFORCEDSTYLEGIFTSELECTCONFIG_METHOD_3_632B1C0D34AB93AA_OFFSET UNITYSDK_OFFSET(0x1D3FC8E0)
#define RPG_GAMECORE_ROGUEMODIFIERSETFORCEDSTYLEGIFTSELECTCONFIG_METHOD_3_C2CA37D723C4CF06_OFFSET UNITYSDK_OFFSET(0x1D3FC930)
#define RPG_GAMECORE_ROGUEMODIFIERSETFORCEDSTYLEGIFTSELECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3FC920)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierSetForcedStyleGiftSelectConfig_TypeDefinitionIndex = 17644;
