...
#define RPG_GAMECORE_CAKERACECATCOMMONCONFIG_METHOD_2_922A6DA3585D6B6C_OFFSET UNITYSDK_OFFSET(0x1D0FEA20)
#define RPG_GAMECORE_CAKERACECATCOMMONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0FF000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceCatCommonConfig_TypeDefinitionIndex = 18185;
