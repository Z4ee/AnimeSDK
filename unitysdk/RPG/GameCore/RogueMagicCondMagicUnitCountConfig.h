...
#define RPG_GAMECORE_ROGUEMAGICCONDMAGICUNITCOUNTCONFIG_METHOD_7_4053E5B53CCEC5FC_OFFSET UNITYSDK_OFFSET(0x1CFB5330)
#define RPG_GAMECORE_ROGUEMAGICCONDMAGICUNITCOUNTCONFIG_METHOD_7_D23E3E60BF2A0700_OFFSET UNITYSDK_OFFSET(0x1CFB52E0)
#define RPG_GAMECORE_ROGUEMAGICCONDMAGICUNITCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFB5320)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueMagicCondMagicUnitCountConfig_TypeDefinitionIndex = 18823;
