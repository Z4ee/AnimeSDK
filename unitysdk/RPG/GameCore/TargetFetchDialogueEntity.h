...
#define RPG_GAMECORE_TARGETFETCHDIALOGUEENTITY_METHOD_4_4DA864CECA5CFE07_OFFSET UNITYSDK_OFFSET(0x1D5AAE00)
#define RPG_GAMECORE_TARGETFETCHDIALOGUEENTITY_METHOD_4_63BAC2F92B942293_OFFSET UNITYSDK_OFFSET(0x1D5AAE60)
#define RPG_GAMECORE_TARGETFETCHDIALOGUEENTITY_METHOD_4_9C38A8155CBD6696_OFFSET UNITYSDK_OFFSET(0x1D5AAD60)
#define RPG_GAMECORE_TARGETFETCHDIALOGUEENTITY_METHOD_4_A73C4D5BF540DAD7_OFFSET UNITYSDK_OFFSET(0x1D5AAEA0)
#define RPG_GAMECORE_TARGETFETCHDIALOGUEENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5AADF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchDialogueEntity_TypeDefinitionIndex = 23610;
