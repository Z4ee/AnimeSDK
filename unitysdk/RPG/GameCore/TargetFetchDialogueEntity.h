...
#define RPG_GAMECORE_TARGETFETCHDIALOGUEENTITY_METHOD_4_4DA864CECA5CFE07_OFFSET UNITYSDK_OFFSET(0x18EDCC70)
#define RPG_GAMECORE_TARGETFETCHDIALOGUEENTITY_METHOD_4_64BE77C65A338FA9_OFFSET UNITYSDK_OFFSET(0x18EE4080)
#define RPG_GAMECORE_TARGETFETCHDIALOGUEENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x18EDCC20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchDialogueEntity_TypeDefinitionIndex = 22869;
