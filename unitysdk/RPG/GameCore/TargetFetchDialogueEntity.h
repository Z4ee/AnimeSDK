...
#define RPG_GAMECORE_TARGETFETCHDIALOGUEENTITY_METHOD_4_4DA864CECA5CFE07_OFFSET UNITYSDK_OFFSET(0x177B4E40)
#define RPG_GAMECORE_TARGETFETCHDIALOGUEENTITY_METHOD_4_64BE77C65A338FA9_OFFSET UNITYSDK_OFFSET(0x177BE5C0)
#define RPG_GAMECORE_TARGETFETCHDIALOGUEENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x177B4DF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchDialogueEntity_TypeDefinitionIndex = 22151;
