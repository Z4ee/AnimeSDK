...
#define RPG_GAMECORE_FLOORFSVSYNCTEMPLATECONFIG_METHOD_2_6E59DD0EA355FB4A_OFFSET UNITYSDK_OFFSET(0x17214A70)
#define RPG_GAMECORE_FLOORFSVSYNCTEMPLATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17214AB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FloorFSVSyncTemplateConfig_TypeDefinitionIndex = 15988;
