...
#define RPG_GAMECORE_FLOORFSVSYNCTEMPLATECONFIG_METHOD_2_6E59DD0EA355FB4A_OFFSET UNITYSDK_OFFSET(0x18926E90)
#define RPG_GAMECORE_FLOORFSVSYNCTEMPLATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18926ED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FloorFSVSyncTemplateConfig_TypeDefinitionIndex = 16514;
