...
#define RPG_GAMECORE_SHOWBATTLEQTEUI_METHOD_3_BB606F9C53BC8A58_OFFSET UNITYSDK_OFFSET(0x19C75830)
#define RPG_GAMECORE_SHOWBATTLEQTEUI_METHOD_3_D2E6C1926BC054B1_OFFSET UNITYSDK_OFFSET(0x19C758B0)
#define RPG_GAMECORE_SHOWBATTLEQTEUI__CTOR_OFFSET UNITYSDK_OFFSET(0x19C75880)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowBattleQTEUI_TypeDefinitionIndex = 22073;
