...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERREPLACESTAGENODECONFIG_METHOD_3_4AB67D9C5937C944_OFFSET UNITYSDK_OFFSET(0x1D06A980)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERREPLACESTAGENODECONFIG_METHOD_3_76CD764655BD5600_OFFSET UNITYSDK_OFFSET(0x1D06A9D0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERREPLACESTAGENODECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D06A9C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierReplaceStageNodeConfig_TypeDefinitionIndex = 18679;
