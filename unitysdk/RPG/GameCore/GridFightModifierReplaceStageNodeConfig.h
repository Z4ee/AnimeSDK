...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERREPLACESTAGENODECONFIG_METHOD_3_76CD764655BD5600_OFFSET UNITYSDK_OFFSET(0x17268C20)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERREPLACESTAGENODECONFIG_METHOD_3_850EC871A02ABE69_OFFSET UNITYSDK_OFFSET(0x1726BC40)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERREPLACESTAGENODECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17268BD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierReplaceStageNodeConfig_TypeDefinitionIndex = 17837;
