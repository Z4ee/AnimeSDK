...
#define RPG_GAMECORE_NPCMONSTERSVISIBLEINFO_METHOD_2_539D61DA8B3A9C2E_OFFSET UNITYSDK_OFFSET(0x1BAF2A00)
#define RPG_GAMECORE_NPCMONSTERSVISIBLEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAF2B20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NPCMonstersVisibleInfo_TypeDefinitionIndex = 19538;
