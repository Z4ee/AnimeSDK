...
#define RPG_GAMECORE_NPCMONSTERSVISIBLEINFO_METHOD_2_539D61DA8B3A9C2E_OFFSET UNITYSDK_OFFSET(0x1D2EFB60)
#define RPG_GAMECORE_NPCMONSTERSVISIBLEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2EFC80)
