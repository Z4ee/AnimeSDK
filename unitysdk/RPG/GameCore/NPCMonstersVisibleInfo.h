...
#define RPG_GAMECORE_NPCMONSTERSVISIBLEINFO_METHOD_2_539D61DA8B3A9C2E_OFFSET UNITYSDK_OFFSET(0x18B7A370)
#define RPG_GAMECORE_NPCMONSTERSVISIBLEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18B7A490)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NPCMonstersVisibleInfo_TypeDefinitionIndex = 19265;
