...
#define RPG_GAMECORE_LEVELEVENTAPPLYOPERATION_CLEAR_OFFSET UNITYSDK_OFFSET(0xA98A1A0)
#define RPG_GAMECORE_LEVELEVENTAPPLYOPERATION_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xA98A240)
#define RPG_GAMECORE_LEVELEVENTAPPLYOPERATION_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xA98A1F0)
#define RPG_GAMECORE_LEVELEVENTAPPLYOPERATION_INIT_OFFSET UNITYSDK_OFFSET(0xA98A150)
#define RPG_GAMECORE_LEVELEVENTAPPLYOPERATION__CTOR_OFFSET UNITYSDK_OFFSET(0xA98A290)
#define RPG_GAMECORE_LEVELEVENTAPPLYOPERATION___IFIXBASEPROXY_CLEAR_OFFSET UNITYSDK_OFFSET(0xA98A2A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelEventApplyOperation_TypeDefinitionIndex = 45704;
