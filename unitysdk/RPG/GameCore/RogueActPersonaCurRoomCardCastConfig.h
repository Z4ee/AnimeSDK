...
#define RPG_GAMECORE_ROGUEACTPERSONACURROOMCARDCASTCONFIG_METHOD_6_6A91D7F866F0E144_OFFSET UNITYSDK_OFFSET(0x18CC82B0)
#define RPG_GAMECORE_ROGUEACTPERSONACURROOMCARDCASTCONFIG_METHOD_6_6B6A38A834E1ADCD_OFFSET UNITYSDK_OFFSET(0x18CC77C0)
#define RPG_GAMECORE_ROGUEACTPERSONACURROOMCARDCASTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CC76E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaCurRoomCardCastConfig_TypeDefinitionIndex = 18760;
