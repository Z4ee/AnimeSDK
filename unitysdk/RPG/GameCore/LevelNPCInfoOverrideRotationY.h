...
#define RPG_GAMECORE_LEVELNPCINFOOVERRIDEROTATIONY_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1733F070)
#define RPG_GAMECORE_LEVELNPCINFOOVERRIDEROTATIONY__CTOR_OFFSET UNITYSDK_OFFSET(0x1733F4F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelNPCInfoOverrideRotationY_TypeDefinitionIndex = 15945;
