...
#define RPG_GAMECORE_LEVELNPCINFOOVERRIDEROTATIONY_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D1DAA00)
#define RPG_GAMECORE_LEVELNPCINFOOVERRIDEROTATIONY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1DAED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelNPCInfoOverrideRotationY_TypeDefinitionIndex = 17167;
