...
#define RPG_GAMECORE_LEVELNPCINFOOVERRIDEROTATIONY_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B076900)
#define RPG_GAMECORE_LEVELNPCINFOOVERRIDEROTATIONY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B076DD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelNPCInfoOverrideRotationY_TypeDefinitionIndex = 16665;
