...
#define RPG_GAMECORE_CHANGEFACEDIR_METHOD_3_2A09A183D64D85B9_OFFSET UNITYSDK_OFFSET(0x187C7BF0)
#define RPG_GAMECORE_CHANGEFACEDIR_METHOD_3_EE56C1E68BEA0D1F_OFFSET UNITYSDK_OFFSET(0x187C7CD0)
#define RPG_GAMECORE_CHANGEFACEDIR__CTOR_OFFSET UNITYSDK_OFFSET(0x187C7C70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChangeFaceDir_TypeDefinitionIndex = 21328;
