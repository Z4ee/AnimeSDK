...
#define RPG_GAMECORE_BASECHIMERADUELENTITIESSELECTORCONFIG_METHOD_2_ABB06EDDA336ABAB_OFFSET UNITYSDK_OFFSET(0x1B2EBC50)
#define RPG_GAMECORE_BASECHIMERADUELENTITIESSELECTORCONFIG_METHOD_2_D7A8204B0BFAD56D_OFFSET UNITYSDK_OFFSET(0x1B2EB370)
#define RPG_GAMECORE_BASECHIMERADUELENTITIESSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2EBCB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BaseChimeraDuelEntitiesSelectorConfig_TypeDefinitionIndex = 15725;
