...
#define RPG_GAMECORE_BASECHIMERADUELENTITIESSELECTORCONFIG_METHOD_2_202E88481F6266B8_OFFSET UNITYSDK_OFFSET(0x16FC60B0)
#define RPG_GAMECORE_BASECHIMERADUELENTITIESSELECTORCONFIG_METHOD_2_ABB06EDDA336ABAB_OFFSET UNITYSDK_OFFSET(0x16FC6BA0)
#define RPG_GAMECORE_BASECHIMERADUELENTITIESSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16FC6C00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BaseChimeraDuelEntitiesSelectorConfig_TypeDefinitionIndex = 14591;
