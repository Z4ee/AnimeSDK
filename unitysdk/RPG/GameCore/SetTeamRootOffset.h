...
#define RPG_GAMECORE_SETTEAMROOTOFFSET_METHOD_3_5E96BE3275B6C749_OFFSET UNITYSDK_OFFSET(0x176E3C70)
#define RPG_GAMECORE_SETTEAMROOTOFFSET_METHOD_3_95879A4769583B86_OFFSET UNITYSDK_OFFSET(0x176E3CF0)
#define RPG_GAMECORE_SETTEAMROOTOFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x176E3CC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetTeamRootOffset_TypeDefinitionIndex = 20684;
