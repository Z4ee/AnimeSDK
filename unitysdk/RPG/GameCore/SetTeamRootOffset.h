...
#define RPG_GAMECORE_SETTEAMROOTOFFSET_METHOD_3_2D0F7F1A2ED33BCF_OFFSET UNITYSDK_OFFSET(0x1E092B70)
#define RPG_GAMECORE_SETTEAMROOTOFFSET_METHOD_3_95879A4769583B86_OFFSET UNITYSDK_OFFSET(0x1E092BB0)
#define RPG_GAMECORE_SETTEAMROOTOFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1E092BA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetTeamRootOffset_TypeDefinitionIndex = 22249;
