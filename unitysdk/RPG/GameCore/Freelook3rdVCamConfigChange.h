...
#define RPG_GAMECORE_FREELOOK3RDVCAMCONFIGCHANGE_METHOD_3_27B2A221A7C7EA30_OFFSET UNITYSDK_OFFSET(0x1976F3C0)
#define RPG_GAMECORE_FREELOOK3RDVCAMCONFIGCHANGE_METHOD_3_ABE6B98A57AADD73_OFFSET UNITYSDK_OFFSET(0x1976F340)
#define RPG_GAMECORE_FREELOOK3RDVCAMCONFIGCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1976F390)

namespace RPG::GameCore
{
	inline static constexpr unsigned int Freelook3rdVCamConfigChange_TypeDefinitionIndex = 20914;
