...
#define RPG_GAMECORE_FREELOOK3RDVCAMCONFIGCHANGE_METHOD_3_27B2A221A7C7EA30_OFFSET UNITYSDK_OFFSET(0x1B9817C0)
#define RPG_GAMECORE_FREELOOK3RDVCAMCONFIGCHANGE_METHOD_3_D288F80CB14D73FB_OFFSET UNITYSDK_OFFSET(0x1B981780)
#define RPG_GAMECORE_FREELOOK3RDVCAMCONFIGCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9817B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int Freelook3rdVCamConfigChange_TypeDefinitionIndex = 21329;
