...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERRANDOMROLEDELAYGRANTCONFIG_METHOD_3_2BAF99C68591B6DA_OFFSET UNITYSDK_OFFSET(0x1D06A7A0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERRANDOMROLEDELAYGRANTCONFIG_METHOD_3_BC7A90225175AF36_OFFSET UNITYSDK_OFFSET(0x1D06A7F0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERRANDOMROLEDELAYGRANTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D06A7E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierRandomRoleDelayGrantConfig_TypeDefinitionIndex = 18712;
