...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERRANDOMROLEDELAYGRANTCONFIG_METHOD_3_031C0B351F275A1F_OFFSET UNITYSDK_OFFSET(0x189BE510)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERRANDOMROLEDELAYGRANTCONFIG_METHOD_3_BC7A90225175AF36_OFFSET UNITYSDK_OFFSET(0x189BE5E0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERRANDOMROLEDELAYGRANTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189BE590)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierRandomRoleDelayGrantConfig_TypeDefinitionIndex = 18490;
