...
#define RPG_GAMECORE_CORRECTIONPLAYERTELEPORTPOS_METHOD_3_43FD22A46EE39BAC_OFFSET UNITYSDK_OFFSET(0x171388B0)
#define RPG_GAMECORE_CORRECTIONPLAYERTELEPORTPOS_METHOD_3_5C40230642F6C9F6_OFFSET UNITYSDK_OFFSET(0x17138930)
#define RPG_GAMECORE_CORRECTIONPLAYERTELEPORTPOS__CTOR_OFFSET UNITYSDK_OFFSET(0x17138900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CorrectionPlayerTeleportPos_TypeDefinitionIndex = 18804;
