...
#define RPG_GAMECORE_LEVELBEFORESCEPTERTRIGGER_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1BDEFC90)
#define RPG_GAMECORE_LEVELBEFORESCEPTERTRIGGER_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x1BDEFC40)
#define RPG_GAMECORE_LEVELBEFORESCEPTERTRIGGER_GET_SCEPTER_OFFSET UNITYSDK_OFFSET(0x1BDEFCE0)
#define RPG_GAMECORE_LEVELBEFORESCEPTERTRIGGER_INIT_OFFSET UNITYSDK_OFFSET(0x1BDEFBF0)
#define RPG_GAMECORE_LEVELBEFORESCEPTERTRIGGER_SET_SCEPTER_OFFSET UNITYSDK_OFFSET(0x1BDEFCF0)
#define RPG_GAMECORE_LEVELBEFORESCEPTERTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDEFD00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelBeforeScepterTrigger_TypeDefinitionIndex = 54289;
