...
#define RPG_GAMECORE_LEVELBEFORESCEPTERTRIGGER_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xE6866D0)
#define RPG_GAMECORE_LEVELBEFORESCEPTERTRIGGER_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xE686680)
#define RPG_GAMECORE_LEVELBEFORESCEPTERTRIGGER_GET_SCEPTER_OFFSET UNITYSDK_OFFSET(0xE686720)
#define RPG_GAMECORE_LEVELBEFORESCEPTERTRIGGER_INIT_OFFSET UNITYSDK_OFFSET(0xE686630)
#define RPG_GAMECORE_LEVELBEFORESCEPTERTRIGGER_SET_SCEPTER_OFFSET UNITYSDK_OFFSET(0xE686730)
#define RPG_GAMECORE_LEVELBEFORESCEPTERTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0xE686740)
