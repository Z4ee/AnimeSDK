...
#define RPG_GAMECORE_ROGUEACTADDROGUEMODIFIERCONFIG_METHOD_6_4E85B7C5FD9FA166_OFFSET UNITYSDK_OFFSET(0x1D3B69C0)
#define RPG_GAMECORE_ROGUEACTADDROGUEMODIFIERCONFIG_METHOD_6_E80FE800CEC3CB0A_OFFSET UNITYSDK_OFFSET(0x1D3B6970)
#define RPG_GAMECORE_ROGUEACTADDROGUEMODIFIERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3B69B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActAddRogueModifierConfig_TypeDefinitionIndex = 19415;
