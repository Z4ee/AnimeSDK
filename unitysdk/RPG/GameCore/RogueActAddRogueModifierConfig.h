...
#define RPG_GAMECORE_ROGUEACTADDROGUEMODIFIERCONFIG_METHOD_6_4E85B7C5FD9FA166_OFFSET UNITYSDK_OFFSET(0x19AE1500)
#define RPG_GAMECORE_ROGUEACTADDROGUEMODIFIERCONFIG_METHOD_6_E2AB1374FCDA87C3_OFFSET UNITYSDK_OFFSET(0x19AE12E0)
#define RPG_GAMECORE_ROGUEACTADDROGUEMODIFIERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AE1420)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActAddRogueModifierConfig_TypeDefinitionIndex = 18612;
