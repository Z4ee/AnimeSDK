...
#define RPG_GAMECORE_STOPELEVATIONDITHER_METHOD_3_93A07090E4F85D46_OFFSET UNITYSDK_OFFSET(0x1B0C5BF0)
#define RPG_GAMECORE_STOPELEVATIONDITHER_METHOD_3_A98C30CD0CD96205_OFFSET UNITYSDK_OFFSET(0x1B0C5C40)
#define RPG_GAMECORE_STOPELEVATIONDITHER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0C5C30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StopElevationDither_TypeDefinitionIndex = 19845;
