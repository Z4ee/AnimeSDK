...
#define RPG_GAMECORE_STOPELEVATIONDITHER_METHOD_3_10AB5464A57C6E14_OFFSET UNITYSDK_OFFSET(0x1777D7E0)
#define RPG_GAMECORE_STOPELEVATIONDITHER_METHOD_3_A98C30CD0CD96205_OFFSET UNITYSDK_OFFSET(0x1777D860)
#define RPG_GAMECORE_STOPELEVATIONDITHER__CTOR_OFFSET UNITYSDK_OFFSET(0x1777D830)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StopElevationDither_TypeDefinitionIndex = 18942;
