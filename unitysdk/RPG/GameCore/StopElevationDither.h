...
#define RPG_GAMECORE_STOPELEVATIONDITHER_METHOD_3_10AB5464A57C6E14_OFFSET UNITYSDK_OFFSET(0x19CC0460)
#define RPG_GAMECORE_STOPELEVATIONDITHER_METHOD_3_A98C30CD0CD96205_OFFSET UNITYSDK_OFFSET(0x19CC04E0)
#define RPG_GAMECORE_STOPELEVATIONDITHER__CTOR_OFFSET UNITYSDK_OFFSET(0x19CC04B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StopElevationDither_TypeDefinitionIndex = 19487;
