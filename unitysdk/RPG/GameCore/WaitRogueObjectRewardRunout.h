...
#define RPG_GAMECORE_WAITROGUEOBJECTREWARDRUNOUT_METHOD_3_91B878A9CD5957AD_OFFSET UNITYSDK_OFFSET(0x1D1BAD60)
#define RPG_GAMECORE_WAITROGUEOBJECTREWARDRUNOUT_METHOD_3_D04C7FF78EBB1229_OFFSET UNITYSDK_OFFSET(0x1D1BAD10)
#define RPG_GAMECORE_WAITROGUEOBJECTREWARDRUNOUT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1BAD50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitRogueObjectRewardRunout_TypeDefinitionIndex = 19708;
