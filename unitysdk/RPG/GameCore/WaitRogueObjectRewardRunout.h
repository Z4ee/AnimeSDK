...
#define RPG_GAMECORE_WAITROGUEOBJECTREWARDRUNOUT_METHOD_3_91B878A9CD5957AD_OFFSET UNITYSDK_OFFSET(0x19106AE0)
#define RPG_GAMECORE_WAITROGUEOBJECTREWARDRUNOUT_METHOD_3_B5B82BEE6E9C56BD_OFFSET UNITYSDK_OFFSET(0x19106A50)
#define RPG_GAMECORE_WAITROGUEOBJECTREWARDRUNOUT__CTOR_OFFSET UNITYSDK_OFFSET(0x19106AB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitRogueObjectRewardRunout_TypeDefinitionIndex = 19447;
