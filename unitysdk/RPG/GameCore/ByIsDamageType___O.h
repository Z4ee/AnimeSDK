...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::Class_1_D837DED66799FBE3_DelegateParseJson_1<::RPG::GameCore::AttackDamageType>**)Il2CppClass::FromTypeDefinitionIndex(ByIsDamageType___O_TypeDefinitionIndex)->GetStaticField(0x11340);
		}
	};
}
