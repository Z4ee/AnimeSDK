...
#define RPG_GAMECORE_QUESTPROGRESSCHANGELISTENER_METHOD_3_CC31604B3114D401_OFFSET UNITYSDK_OFFSET(0x18C819E0)
#define RPG_GAMECORE_QUESTPROGRESSCHANGELISTENER_METHOD_3_DDD8B67C8961A878_OFFSET UNITYSDK_OFFSET(0x18C81A60)
#define RPG_GAMECORE_QUESTPROGRESSCHANGELISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x18C81A30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int QuestProgressChangeListener_TypeDefinitionIndex = 20186;
