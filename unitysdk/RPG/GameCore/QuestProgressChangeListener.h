...
#define RPG_GAMECORE_QUESTPROGRESSCHANGELISTENER_METHOD_3_70E8B525BCA86CAD_OFFSET UNITYSDK_OFFSET(0x1D18E8F0)
#define RPG_GAMECORE_QUESTPROGRESSCHANGELISTENER_METHOD_3_DDD8B67C8961A878_OFFSET UNITYSDK_OFFSET(0x1D18E930)
#define RPG_GAMECORE_QUESTPROGRESSCHANGELISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D18E920)

namespace RPG::GameCore
{
	inline static constexpr unsigned int QuestProgressChangeListener_TypeDefinitionIndex = 20967;
