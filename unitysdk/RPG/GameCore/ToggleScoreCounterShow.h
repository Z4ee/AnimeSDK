...
#define RPG_GAMECORE_TOGGLESCORECOUNTERSHOW_METHOD_3_4D1A0618BD829E30_OFFSET UNITYSDK_OFFSET(0x1909FC90)
#define RPG_GAMECORE_TOGGLESCORECOUNTERSHOW_METHOD_3_C8824E6B52AC6C69_OFFSET UNITYSDK_OFFSET(0x1909FD10)
#define RPG_GAMECORE_TOGGLESCORECOUNTERSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x1909FCE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ToggleScoreCounterShow_TypeDefinitionIndex = 22206;
