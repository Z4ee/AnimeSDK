...
#define RPG_GAMECORE_CHIMERADUELENTERTUTORIALBATTLE_METHOD_3_2D99BCE3BCA87DAC_OFFSET UNITYSDK_OFFSET(0x17099F90)
#define RPG_GAMECORE_CHIMERADUELENTERTUTORIALBATTLE_METHOD_3_B7BFCAE89522B638_OFFSET UNITYSDK_OFFSET(0x1709A0A0)
#define RPG_GAMECORE_CHIMERADUELENTERTUTORIALBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1709A070)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelEnterTutorialBattle_TypeDefinitionIndex = 19907;
