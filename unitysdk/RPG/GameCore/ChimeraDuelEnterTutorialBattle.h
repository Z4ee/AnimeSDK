...
#define RPG_GAMECORE_CHIMERADUELENTERTUTORIALBATTLE_METHOD_3_2D99BCE3BCA87DAC_OFFSET UNITYSDK_OFFSET(0x187F96C0)
#define RPG_GAMECORE_CHIMERADUELENTERTUTORIALBATTLE_METHOD_3_B7BFCAE89522B638_OFFSET UNITYSDK_OFFSET(0x187F97D0)
#define RPG_GAMECORE_CHIMERADUELENTERTUTORIALBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x187F97A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelEnterTutorialBattle_TypeDefinitionIndex = 20588;
