...
#define RPG_GAMECORE_CHIMERADUELENTERTUTORIALBATTLE_METHOD_3_2DE57E93A86B4575_OFFSET UNITYSDK_OFFSET(0x1C394EE0)
#define RPG_GAMECORE_CHIMERADUELENTERTUTORIALBATTLE_METHOD_3_B7BFCAE89522B638_OFFSET UNITYSDK_OFFSET(0x1C394FB0)
#define RPG_GAMECORE_CHIMERADUELENTERTUTORIALBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C394FA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelEnterTutorialBattle_TypeDefinitionIndex = 20938;
