...
#define RPG_GAMECORE_CLOCKPARKTAKEPHOTOREPORT_METHOD_3_4A039404CE7EDE26_OFFSET UNITYSDK_OFFSET(0x1BC1CF00)
#define RPG_GAMECORE_CLOCKPARKTAKEPHOTOREPORT_METHOD_3_CE8B2CD67B77B523_OFFSET UNITYSDK_OFFSET(0x1BC1CE30)
#define RPG_GAMECORE_CLOCKPARKTAKEPHOTOREPORT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC1CEF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClockParkTakePhotoReport_TypeDefinitionIndex = 20840;
