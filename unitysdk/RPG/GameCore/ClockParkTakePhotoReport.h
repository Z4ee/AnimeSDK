...
#define RPG_GAMECORE_CLOCKPARKTAKEPHOTOREPORT_METHOD_3_266338530BFF8DDA_OFFSET UNITYSDK_OFFSET(0x18821630)
#define RPG_GAMECORE_CLOCKPARKTAKEPHOTOREPORT_METHOD_3_4A039404CE7EDE26_OFFSET UNITYSDK_OFFSET(0x18821740)
#define RPG_GAMECORE_CLOCKPARKTAKEPHOTOREPORT__CTOR_OFFSET UNITYSDK_OFFSET(0x18821710)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClockParkTakePhotoReport_TypeDefinitionIndex = 20488;
