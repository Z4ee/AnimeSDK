...
#define RPG_GAMECORE_CLOCKPARKTAKEPHOTOREPORT_METHOD_3_4A039404CE7EDE26_OFFSET UNITYSDK_OFFSET(0x1D9A1180)
#define RPG_GAMECORE_CLOCKPARKTAKEPHOTOREPORT_METHOD_3_CE8B2CD67B77B523_OFFSET UNITYSDK_OFFSET(0x1D9A10B0)
#define RPG_GAMECORE_CLOCKPARKTAKEPHOTOREPORT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D9A1170)
