...
#define RPG_GAMECORE_CHIMERADUELENTITYVALUECOMPAREPREDICATE_METHOD_3_3EC62A219214FA3E_OFFSET UNITYSDK_OFFSET(0x1963C930)
#define RPG_GAMECORE_CHIMERADUELENTITYVALUECOMPAREPREDICATE_METHOD_3_B5935C075B333A6E_OFFSET UNITYSDK_OFFSET(0x1963C7A0)
#define RPG_GAMECORE_CHIMERADUELENTITYVALUECOMPAREPREDICATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1963C790)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelEntityValueComparePredicate_TypeDefinitionIndex = 15145;
