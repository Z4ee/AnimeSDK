...
#define RPG_GAMECORE_CHIMERADUELENTITYVALUECOMPAREPREDICATE_METHOD_3_3EC62A219214FA3E_OFFSET UNITYSDK_OFFSET(0x1C23E2B0)
#define RPG_GAMECORE_CHIMERADUELENTITYVALUECOMPAREPREDICATE_METHOD_3_B5935C075B333A6E_OFFSET UNITYSDK_OFFSET(0x1C23E120)
#define RPG_GAMECORE_CHIMERADUELENTITYVALUECOMPAREPREDICATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C23E110)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelEntityValueComparePredicate_TypeDefinitionIndex = 15309;
