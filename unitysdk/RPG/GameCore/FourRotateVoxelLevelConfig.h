...
#define RPG_GAMECORE_FOURROTATEVOXELLEVELCONFIG_METHOD_2_787DAFD785C867E7_OFFSET UNITYSDK_OFFSET(0x1D1150C0)
#define RPG_GAMECORE_FOURROTATEVOXELLEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D115CE0)
