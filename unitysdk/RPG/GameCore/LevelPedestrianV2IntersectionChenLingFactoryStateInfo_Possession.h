...
#define RPG_GAMECORE_LEVELPEDESTRIANV2INTERSECTIONCHENLINGFACTORYSTATEINFO_POSSESSION_METHOD_3_6639618E48AB606A_OFFSET UNITYSDK_OFFSET(0x17346CB0)
#define RPG_GAMECORE_LEVELPEDESTRIANV2INTERSECTIONCHENLINGFACTORYSTATEINFO_POSSESSION_METHOD_3_978BCAEBDD4AE471_OFFSET UNITYSDK_OFFSET(0x17346AA0)
#define RPG_GAMECORE_LEVELPEDESTRIANV2INTERSECTIONCHENLINGFACTORYSTATEINFO_POSSESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x17346A90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPedestrianV2IntersectionChenLingFactoryStateInfo_Possession_TypeDefinitionIndex = 15897;
