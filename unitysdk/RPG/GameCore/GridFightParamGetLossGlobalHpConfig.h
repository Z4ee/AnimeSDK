...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETLOSSGLOBALHPCONFIG_METHOD_6_84CE9F650E53A10D_OFFSET UNITYSDK_OFFSET(0x189C5120)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETLOSSGLOBALHPCONFIG_METHOD_6_FFA1F78AB58BECC3_OFFSET UNITYSDK_OFFSET(0x189C53D0)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETLOSSGLOBALHPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189C52A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightParamGetLossGlobalHpConfig_TypeDefinitionIndex = 18546;
