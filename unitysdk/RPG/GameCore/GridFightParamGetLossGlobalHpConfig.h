...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETLOSSGLOBALHPCONFIG_METHOD_6_9E7E6BA57C6A80BF_OFFSET UNITYSDK_OFFSET(0x1D06D970)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETLOSSGLOBALHPCONFIG_METHOD_6_FFA1F78AB58BECC3_OFFSET UNITYSDK_OFFSET(0x1D06D9C0)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETLOSSGLOBALHPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D06D9B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightParamGetLossGlobalHpConfig_TypeDefinitionIndex = 18781;
