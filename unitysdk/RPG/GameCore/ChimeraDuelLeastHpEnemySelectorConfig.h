...
#define RPG_GAMECORE_CHIMERADUELLEASTHPENEMYSELECTORCONFIG_METHOD_3_76E456C56F3388BE_OFFSET UNITYSDK_OFFSET(0x1709E6E0)
#define RPG_GAMECORE_CHIMERADUELLEASTHPENEMYSELECTORCONFIG_METHOD_3_BBC10D73A4DE00AF_OFFSET UNITYSDK_OFFSET(0x1709E780)
#define RPG_GAMECORE_CHIMERADUELLEASTHPENEMYSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1709E770)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelLeastHpEnemySelectorConfig_TypeDefinitionIndex = 14628;
