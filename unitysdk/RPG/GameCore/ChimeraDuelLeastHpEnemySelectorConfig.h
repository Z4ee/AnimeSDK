...
#define RPG_GAMECORE_CHIMERADUELLEASTHPENEMYSELECTORCONFIG_METHOD_3_76E456C56F3388BE_OFFSET UNITYSDK_OFFSET(0x187FDA50)
#define RPG_GAMECORE_CHIMERADUELLEASTHPENEMYSELECTORCONFIG_METHOD_3_BBC10D73A4DE00AF_OFFSET UNITYSDK_OFFSET(0x187FDAF0)
#define RPG_GAMECORE_CHIMERADUELLEASTHPENEMYSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x187FDAE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelLeastHpEnemySelectorConfig_TypeDefinitionIndex = 15098;
