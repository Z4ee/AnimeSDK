...
#define RPG_GAMECORE_DICECOMBATOPTIONTALKINFO_METHOD_3_9E18120ABF9510E2_OFFSET UNITYSDK_OFFSET(0x1C1112B0)
#define RPG_GAMECORE_DICECOMBATOPTIONTALKINFO_METHOD_3_D29161959348A1DC_OFFSET UNITYSDK_OFFSET(0x1C111210)
#define RPG_GAMECORE_DICECOMBATOPTIONTALKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1C111270)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatOptionTalkInfo_TypeDefinitionIndex = 20062;
