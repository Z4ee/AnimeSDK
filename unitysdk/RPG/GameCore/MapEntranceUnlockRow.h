...
#define RPG_GAMECORE_MAPENTRANCEUNLOCKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1BCDE9D0)
#define RPG_GAMECORE_MAPENTRANCEUNLOCKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCDEAD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MapEntranceUnlockRow_TypeDefinitionIndex = 13542;
