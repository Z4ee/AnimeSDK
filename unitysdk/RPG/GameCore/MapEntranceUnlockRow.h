...
#define RPG_GAMECORE_MAPENTRANCEUNLOCKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D220B70)
#define RPG_GAMECORE_MAPENTRANCEUNLOCKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D220C70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MapEntranceUnlockRow_TypeDefinitionIndex = 13959;
