...
#define RPG_GAMECORE_ADVENTUREFORBIDATTACKTRIGGERBATTLE_METHOD_3_8AF42581274B2FCA_OFFSET UNITYSDK_OFFSET(0x1CDF22A0)
#define RPG_GAMECORE_ADVENTUREFORBIDATTACKTRIGGERBATTLE_METHOD_3_E089627B70196981_OFFSET UNITYSDK_OFFSET(0x1CDF2260)
#define RPG_GAMECORE_ADVENTUREFORBIDATTACKTRIGGERBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDF2290)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureForbidAttackTriggerBattle_TypeDefinitionIndex = 21418;
