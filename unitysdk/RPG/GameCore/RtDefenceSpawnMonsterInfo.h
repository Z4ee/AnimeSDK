...
#define RPG_GAMECORE_RTDEFENCESPAWNMONSTERINFO_METHOD_2_08C0001655AEB8C4_OFFSET UNITYSDK_OFFSET(0x1B761100)
#define RPG_GAMECORE_RTDEFENCESPAWNMONSTERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B761390)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtDefenceSpawnMonsterInfo_TypeDefinitionIndex = 17337;
