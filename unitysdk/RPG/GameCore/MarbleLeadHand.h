...
#define RPG_GAMECORE_MARBLELEADHAND_METHOD_3_09CFB28EFAFF1FE3_OFFSET UNITYSDK_OFFSET(0x17390810)
#define RPG_GAMECORE_MARBLELEADHAND_METHOD_3_C6CBB5E0BAB59A85_OFFSET UNITYSDK_OFFSET(0x173909D0)
#define RPG_GAMECORE_MARBLELEADHAND__CTOR_OFFSET UNITYSDK_OFFSET(0x17390980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleLeadHand_TypeDefinitionIndex = 15439;
