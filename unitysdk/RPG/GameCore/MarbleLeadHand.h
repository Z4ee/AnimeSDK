...
#define RPG_GAMECORE_MARBLELEADHAND_METHOD_3_09CFB28EFAFF1FE3_OFFSET UNITYSDK_OFFSET(0x198D1760)
#define RPG_GAMECORE_MARBLELEADHAND_METHOD_3_C6CBB5E0BAB59A85_OFFSET UNITYSDK_OFFSET(0x198D1920)
#define RPG_GAMECORE_MARBLELEADHAND__CTOR_OFFSET UNITYSDK_OFFSET(0x198D18D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleLeadHand_TypeDefinitionIndex = 16011;
