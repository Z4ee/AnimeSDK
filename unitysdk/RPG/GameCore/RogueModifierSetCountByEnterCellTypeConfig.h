...
#define RPG_GAMECORE_ROGUEMODIFIERSETCOUNTBYENTERCELLTYPECONFIG_METHOD_3_62DB8516A35349A0_OFFSET UNITYSDK_OFFSET(0x1D1660F0)
#define RPG_GAMECORE_ROGUEMODIFIERSETCOUNTBYENTERCELLTYPECONFIG_METHOD_3_658363C9C901701C_OFFSET UNITYSDK_OFFSET(0x1D166140)
#define RPG_GAMECORE_ROGUEMODIFIERSETCOUNTBYENTERCELLTYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D166130)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierSetCountByEnterCellTypeConfig_TypeDefinitionIndex = 17003;
