...
#define RPG_GAMECORE_PROJECTILETEMPLATECONFIG_METHOD_2_EBDF3B3C5FEF7D7A_OFFSET UNITYSDK_OFFSET(0x18C647A0)
#define RPG_GAMECORE_PROJECTILETEMPLATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18C64880)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ProjectileTemplateConfig_TypeDefinitionIndex = 14819;
