...
#define RPG_GAMECORE_PROJECTILETEMPLATECONFIG_METHOD_2_EBDF3B3C5FEF7D7A_OFFSET UNITYSDK_OFFSET(0x17515440)
#define RPG_GAMECORE_PROJECTILETEMPLATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17515520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ProjectileTemplateConfig_TypeDefinitionIndex = 14349;
