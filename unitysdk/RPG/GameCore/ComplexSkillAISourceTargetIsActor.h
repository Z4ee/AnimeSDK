...
#define RPG_GAMECORE_COMPLEXSKILLAISOURCETARGETISACTOR_METHOD_3_BBC073679720DF48_OFFSET UNITYSDK_OFFSET(0x18830380)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCETARGETISACTOR_METHOD_3_C4F72F24B66F8ADA_OFFSET UNITYSDK_OFFSET(0x1882EFB0)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCETARGETISACTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1882EF90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAISourceTargetIsActor_TypeDefinitionIndex = 14718;
