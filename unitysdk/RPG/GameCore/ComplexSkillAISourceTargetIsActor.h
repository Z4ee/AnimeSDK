...
#define RPG_GAMECORE_COMPLEXSKILLAISOURCETARGETISACTOR_METHOD_3_BBC073679720DF48_OFFSET UNITYSDK_OFFSET(0x196701E0)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCETARGETISACTOR_METHOD_3_C4F72F24B66F8ADA_OFFSET UNITYSDK_OFFSET(0x1966EA60)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCETARGETISACTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1966EA40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAISourceTargetIsActor_TypeDefinitionIndex = 14783;
