...
#define RPG_GAMECORE_ROGUEDLCAREAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D920160)
#define RPG_GAMECORE_ROGUEDLCAREAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D920BC0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 RecommendLevel; // 0x3C
		::RPG::Client::TextID AreaNameID; // 0x40
		::System::UInt32 UnlockID; // 0x50
		::System::UInt32 AreaID; // 0x54
		::System::Boolean IsHard; // 0x58
		::RPG::GameCore::ChessRogueAreaGroupID AreaGroupID; // 0x5C
		::RPG::GameCore::ChessRogueDifficultyType Difficulty; // 0x60
		::RPG::Client::TextID AreaDescID; // 0x68
		::System::UInt32 MonsterEliteDropDisplayID; // 0x78
		::RPG::GameCore::RogueSubMode SubType; // 0x7C
