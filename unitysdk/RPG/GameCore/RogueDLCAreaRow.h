...
#define RPG_GAMECORE_ROGUEDLCAREAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19B29470)
#define RPG_GAMECORE_ROGUEDLCAREAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19B29F10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueDLCAreaRow_TypeDefinitionIndex = 14030;
	...
	public:
		...
		::RPG::GameCore::ChessRogueAreaGroupID AreaGroupID; // 0x40
		::RPG::GameCore::RogueSubMode SubType; // 0x44
		::System::UInt32 RecommendLevel; // 0x48
		::System::UInt32 UnlockID; // 0x4C
		::RPG::GameCore::ChessRogueDifficultyType Difficulty; // 0x50
		::RPG::Client::TextID AreaDescID; // 0x58
		::System::UInt32 AreaID; // 0x68
		::System::Boolean IsHard; // 0x6C
