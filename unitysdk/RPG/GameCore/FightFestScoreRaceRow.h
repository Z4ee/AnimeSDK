...
#define RPG_GAMECORE_FIGHTFESTSCORERACEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1E0D7F00)
#define RPG_GAMECORE_FIGHTFESTSCORERACEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0D84F0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::ScoreRaceType ScoreRaceType; // 0x48
		::System::UInt32 BlueAvatarID; // 0x4C
		::System::UInt32 RewardScore; // 0x50
		::System::UInt32 ScoreRaceID; // 0x54
		::RPG::Client::TextID StageName; // 0x58
		::System::UInt32 PhaseID; // 0x68
		::System::UInt32 TutorialID; // 0x6C
		::System::UInt32 EventID; // 0x70
		::System::UInt32 RedAvatarID; // 0x74
		::System::UInt32 TakeMainMissionID; // 0x78
