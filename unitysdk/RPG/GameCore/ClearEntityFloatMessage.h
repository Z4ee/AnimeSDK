...
#define RPG_GAMECORE_CLEARENTITYFLOATMESSAGE_METHOD_3_73D3A38D13684085_OFFSET UNITYSDK_OFFSET(0x1CFDA390)
#define RPG_GAMECORE_CLEARENTITYFLOATMESSAGE_METHOD_3_AE5DC3DD41091FD2_OFFSET UNITYSDK_OFFSET(0x1CFDA340)
#define RPG_GAMECORE_CLEARENTITYFLOATMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFDA380)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClearEntityFloatMessage_TypeDefinitionIndex = 22952;
