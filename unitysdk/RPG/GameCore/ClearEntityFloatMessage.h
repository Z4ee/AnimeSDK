...
#define RPG_GAMECORE_CLEARENTITYFLOATMESSAGE_METHOD_3_15BFEC2D7E73AAC9_OFFSET UNITYSDK_OFFSET(0x170B2090)
#define RPG_GAMECORE_CLEARENTITYFLOATMESSAGE_METHOD_3_73D3A38D13684085_OFFSET UNITYSDK_OFFSET(0x170B2120)
#define RPG_GAMECORE_CLEARENTITYFLOATMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x170B20F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClearEntityFloatMessage_TypeDefinitionIndex = 21431;
