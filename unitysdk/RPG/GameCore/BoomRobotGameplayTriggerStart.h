...
#define RPG_GAMECORE_BOOMROBOTGAMEPLAYTRIGGERSTART_METHOD_3_6D1C34F5290A42E2_OFFSET UNITYSDK_OFFSET(0x1CE8E960)
#define RPG_GAMECORE_BOOMROBOTGAMEPLAYTRIGGERSTART_METHOD_3_E768C3FEF955699F_OFFSET UNITYSDK_OFFSET(0x1CE8E890)
#define RPG_GAMECORE_BOOMROBOTGAMEPLAYTRIGGERSTART__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE8E950)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BoomRobotGameplayTriggerStart_TypeDefinitionIndex = 20943;
