...
#define RPG_GAMECORE_BOOMROBOTGAMEPLAYTRIGGERSTART_METHOD_3_6D1C34F5290A42E2_OFFSET UNITYSDK_OFFSET(0x187137B0)
#define RPG_GAMECORE_BOOMROBOTGAMEPLAYTRIGGERSTART_METHOD_3_8CB9D8DEF93BF8B6_OFFSET UNITYSDK_OFFSET(0x187136A0)
#define RPG_GAMECORE_BOOMROBOTGAMEPLAYTRIGGERSTART__CTOR_OFFSET UNITYSDK_OFFSET(0x18713780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BoomRobotGameplayTriggerStart_TypeDefinitionIndex = 20162;
