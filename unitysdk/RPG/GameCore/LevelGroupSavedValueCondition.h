...
#define RPG_GAMECORE_LEVELGROUPSAVEDVALUECONDITION_METHOD_2_CCD757E74709368D_OFFSET UNITYSDK_OFFSET(0x1C118D00)
#define RPG_GAMECORE_LEVELGROUPSAVEDVALUECONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C118E80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelGroupSavedValueCondition_TypeDefinitionIndex = 17014;
