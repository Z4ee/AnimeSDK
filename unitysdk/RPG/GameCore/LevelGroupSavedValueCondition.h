...
#define RPG_GAMECORE_LEVELGROUPSAVEDVALUECONDITION_METHOD_2_CCD757E74709368D_OFFSET UNITYSDK_OFFSET(0x1D1D5760)
#define RPG_GAMECORE_LEVELGROUPSAVEDVALUECONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1D58E0)
