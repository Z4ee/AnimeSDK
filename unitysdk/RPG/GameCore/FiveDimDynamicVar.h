...
#define RPG_GAMECORE_FIVEDIMDYNAMICVAR_METHOD_2_94416CBCB25482A0_OFFSET UNITYSDK_OFFSET(0x1973A460)
#define RPG_GAMECORE_FIVEDIMDYNAMICVAR_METHOD_2_C175C4FAB09B42B6_OFFSET UNITYSDK_OFFSET(0x19735090)
#define RPG_GAMECORE_FIVEDIMDYNAMICVAR_METHOD_2_CEED9CF58A3C83CA_OFFSET UNITYSDK_OFFSET(0x1973A4A0)
#define RPG_GAMECORE_FIVEDIMDYNAMICVAR_METHOD_2_F0E307B84478A272_OFFSET UNITYSDK_OFFSET(0x1973A5D0)
#define RPG_GAMECORE_FIVEDIMDYNAMICVAR__CTOR_OFFSET UNITYSDK_OFFSET(0x197394A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimDynamicVar_TypeDefinitionIndex = 17947;
