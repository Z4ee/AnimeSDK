...
#define RPG_GAMECORE_FIVEDIMDYNAMICVAR_METHOD_2_94416CBCB25482A0_OFFSET UNITYSDK_OFFSET(0x1D0E21C0)
#define RPG_GAMECORE_FIVEDIMDYNAMICVAR_METHOD_2_C175C4FAB09B42B6_OFFSET UNITYSDK_OFFSET(0x1D0E2090)
#define RPG_GAMECORE_FIVEDIMDYNAMICVAR_METHOD_2_CEED9CF58A3C83CA_OFFSET UNITYSDK_OFFSET(0x1D0E2200)
#define RPG_GAMECORE_FIVEDIMDYNAMICVAR_METHOD_2_F0E307B84478A272_OFFSET UNITYSDK_OFFSET(0x1D0E2330)
#define RPG_GAMECORE_FIVEDIMDYNAMICVAR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0E0F80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimDynamicVar_TypeDefinitionIndex = 18650;
