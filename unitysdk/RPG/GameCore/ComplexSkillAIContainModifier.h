...
#define RPG_GAMECORE_COMPLEXSKILLAICONTAINMODIFIER_METHOD_3_73B086392C2A67BC_OFFSET UNITYSDK_OFFSET(0x17122530)
#define RPG_GAMECORE_COMPLEXSKILLAICONTAINMODIFIER_METHOD_3_A5A04FFA39A17086_OFFSET UNITYSDK_OFFSET(0x171225A0)
#define RPG_GAMECORE_COMPLEXSKILLAICONTAINMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x17122580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAIContainModifier_TypeDefinitionIndex = 14230;
