...
#define RPG_GAMECORE_COMPLEXSKILLAICONTAINMODIFIER_METHOD_3_A5A04FFA39A17086_OFFSET UNITYSDK_OFFSET(0x1D9A81B0)
#define RPG_GAMECORE_COMPLEXSKILLAICONTAINMODIFIER_METHOD_3_CBF773B2BE7280B1_OFFSET UNITYSDK_OFFSET(0x1D9A8170)
#define RPG_GAMECORE_COMPLEXSKILLAICONTAINMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D9A81A0)
