...
#define RPG_GAMECORE_COMPLEXSKILLAICONTAINMODIFIER_METHOD_3_73B086392C2A67BC_OFFSET UNITYSDK_OFFSET(0x18828D60)
#define RPG_GAMECORE_COMPLEXSKILLAICONTAINMODIFIER_METHOD_3_A5A04FFA39A17086_OFFSET UNITYSDK_OFFSET(0x18828DD0)
#define RPG_GAMECORE_COMPLEXSKILLAICONTAINMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x18828DB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAIContainModifier_TypeDefinitionIndex = 14700;
