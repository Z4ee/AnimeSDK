...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERPLAYERLEVELUPCONFIG_METHOD_3_340BC7B61A042B5B_OFFSET UNITYSDK_OFFSET(0x1C5D11C0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERPLAYERLEVELUPCONFIG_METHOD_3_5322A0F584E9B6F7_OFFSET UNITYSDK_OFFSET(0x1C5D1170)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERPLAYERLEVELUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5D11B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierExecActionAfterPlayerLevelUpConfig_TypeDefinitionIndex = 18610;
