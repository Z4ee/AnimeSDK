...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERPLAYERLEVELUPCONFIG_METHOD_3_340BC7B61A042B5B_OFFSET UNITYSDK_OFFSET(0x197EC2D0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERPLAYERLEVELUPCONFIG_METHOD_3_79B6404903D78CC2_OFFSET UNITYSDK_OFFSET(0x197F1D20)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERPLAYERLEVELUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197EC280)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierExecActionAfterPlayerLevelUpConfig_TypeDefinitionIndex = 18365;
