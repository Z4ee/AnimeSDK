...
#define RPG_GAMECORE_ROGUEDESTROYPROPCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CFA8EA0)
#define RPG_GAMECORE_ROGUEDESTROYPROPCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFA9520)
