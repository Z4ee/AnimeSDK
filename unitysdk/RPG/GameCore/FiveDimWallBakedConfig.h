...
#define RPG_GAMECORE_FIVEDIMWALLBAKEDCONFIG_METHOD_2_6BFD8AB0052E6619_OFFSET UNITYSDK_OFFSET(0x1890CE30)
#define RPG_GAMECORE_FIVEDIMWALLBAKEDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18923DD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimWallBakedConfig_TypeDefinitionIndex = 15773;
