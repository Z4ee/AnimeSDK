...
#define RPG_GAMECORE_FIVEDIMWALLBAKEDCONFIG_METHOD_2_6BFD8AB0052E6619_OFFSET UNITYSDK_OFFSET(0x171FC310)
#define RPG_GAMECORE_FIVEDIMWALLBAKEDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17211B10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimWallBakedConfig_TypeDefinitionIndex = 15260;
