...
#define RPG_GAMECORE_FIVEDIMSURFACEBAKEDINFO_METHOD_2_05B7F0AE8D82505D_OFFSET UNITYSDK_OFFSET(0x1BEB5F50)
#define RPG_GAMECORE_FIVEDIMSURFACEBAKEDINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEB6330)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSurfaceBakedInfo_TypeDefinitionIndex = 16071;
