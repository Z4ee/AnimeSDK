...
#define RPG_GAMECORE_RESTAURANTEMPLOYEEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D0210C0)
#define RPG_GAMECORE_RESTAURANTEMPLOYEEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0215D0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 BehaviorID; // 0x5C
		::System::UInt32 EmployeeID; // 0x60
		::System::UInt32 GroupID; // 0x64
		::RPG::GameCore::RestaurantEmployeeType Type; // 0x68
