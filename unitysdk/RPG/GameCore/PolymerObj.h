...
#define RPG_GAMECORE_POLYMEROBJ_METHOD_3_3A61DDF89E5C170B_OFFSET UNITYSDK_OFFSET(0x174ECBA0)
#define RPG_GAMECORE_POLYMEROBJ_METHOD_3_B245B8C845ED5E41_OFFSET UNITYSDK_OFFSET(0x174ECBE0)
#define RPG_GAMECORE_POLYMEROBJ__CTOR_OFFSET UNITYSDK_OFFSET(0x174ECBD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PolymerObj_TypeDefinitionIndex = 17512;
