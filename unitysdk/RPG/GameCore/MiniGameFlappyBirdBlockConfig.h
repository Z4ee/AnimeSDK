...
#define RPG_GAMECORE_MINIGAMEFLAPPYBIRDBLOCKCONFIG_METHOD_3_38106468237C86F2_OFFSET UNITYSDK_OFFSET(0x18B290C0)
#define RPG_GAMECORE_MINIGAMEFLAPPYBIRDBLOCKCONFIG_METHOD_3_B52BF8AE4ED6637D_OFFSET UNITYSDK_OFFSET(0x18B29080)
#define RPG_GAMECORE_MINIGAMEFLAPPYBIRDBLOCKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18B290B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MiniGameFlappyBirdBlockConfig_TypeDefinitionIndex = 17869;
