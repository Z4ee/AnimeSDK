...
#define RPG_GAMECORE_MINIGAMEFLAPPYBIRDBLOCKCONFIG_METHOD_3_38106468237C86F2_OFFSET UNITYSDK_OFFSET(0x1D1A5530)
#define RPG_GAMECORE_MINIGAMEFLAPPYBIRDBLOCKCONFIG_METHOD_3_E27B4FD285384774_OFFSET UNITYSDK_OFFSET(0x1D1A54D0)
#define RPG_GAMECORE_MINIGAMEFLAPPYBIRDBLOCKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1A5520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MiniGameFlappyBirdBlockConfig_TypeDefinitionIndex = 18600;
