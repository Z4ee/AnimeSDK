...
#define RPG_GAMECORE_FREESTYLEMOTIONINFOCONFIG_METHOD_2_A28C629BC37FEBB7_OFFSET UNITYSDK_OFFSET(0x18932C00)
#define RPG_GAMECORE_FREESTYLEMOTIONINFOCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18932D50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FreeStyleMotionInfoConfig_TypeDefinitionIndex = 15426;
