...
#define RPG_GAMECORE_ROGUEMODIFIERCHANGEROGUENPCWEIGHTCONFIG_METHOD_3_5FFC154B8836E717_OFFSET UNITYSDK_OFFSET(0x1EEF7D70)
#define RPG_GAMECORE_ROGUEMODIFIERCHANGEROGUENPCWEIGHTCONFIG_METHOD_3_66F30A59463B5CD3_OFFSET UNITYSDK_OFFSET(0x1EEF7D20)
#define RPG_GAMECORE_ROGUEMODIFIERCHANGEROGUENPCWEIGHTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEF7D60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierChangeRogueNpcWeightConfig_TypeDefinitionIndex = 17722;
