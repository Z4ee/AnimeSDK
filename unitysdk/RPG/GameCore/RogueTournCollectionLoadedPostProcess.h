...
#define RPG_GAMECORE_ROGUETOURNCOLLECTIONLOADEDPOSTPROCESS_METHOD_3_1758A5885AA5FDB8_OFFSET UNITYSDK_OFFSET(0x1E550630)
#define RPG_GAMECORE_ROGUETOURNCOLLECTIONLOADEDPOSTPROCESS_METHOD_3_8D7E59336DEE8CF5_OFFSET UNITYSDK_OFFSET(0x1E550700)
#define RPG_GAMECORE_ROGUETOURNCOLLECTIONLOADEDPOSTPROCESS__CTOR_OFFSET UNITYSDK_OFFSET(0x1E5506F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournCollectionLoadedPostProcess_TypeDefinitionIndex = 21867;
