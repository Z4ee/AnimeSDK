...
#define RPG_GAMECORE_ROGUETOURNCOLLECTIONLOADEDPOSTPROCESS_METHOD_3_3A0F24F19B355061_OFFSET UNITYSDK_OFFSET(0x18D6F8D0)
#define RPG_GAMECORE_ROGUETOURNCOLLECTIONLOADEDPOSTPROCESS_METHOD_3_8D7E59336DEE8CF5_OFFSET UNITYSDK_OFFSET(0x18D6F9E0)
#define RPG_GAMECORE_ROGUETOURNCOLLECTIONLOADEDPOSTPROCESS__CTOR_OFFSET UNITYSDK_OFFSET(0x18D6F9B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournCollectionLoadedPostProcess_TypeDefinitionIndex = 20980;
