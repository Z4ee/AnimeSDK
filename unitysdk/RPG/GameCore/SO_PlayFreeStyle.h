...
#define RPG_GAMECORE_SO_PLAYFREESTYLE_METHOD_4_4C0C5EFD176EE252_OFFSET UNITYSDK_OFFSET(0x1767D280)
#define RPG_GAMECORE_SO_PLAYFREESTYLE_METHOD_4_97B5A011780B349E_OFFSET UNITYSDK_OFFSET(0x1767C660)
#define RPG_GAMECORE_SO_PLAYFREESTYLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1767C620)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SO_PlayFreeStyle_TypeDefinitionIndex = 18335;
