...
#define RPG_GAMECORE_SO_PLAYFREESTYLE_METHOD_4_4C0C5EFD176EE252_OFFSET UNITYSDK_OFFSET(0x18DE0C60)
#define RPG_GAMECORE_SO_PLAYFREESTYLE_METHOD_4_97B5A011780B349E_OFFSET UNITYSDK_OFFSET(0x18DE0040)
#define RPG_GAMECORE_SO_PLAYFREESTYLE__CTOR_OFFSET UNITYSDK_OFFSET(0x18DE0000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SO_PlayFreeStyle_TypeDefinitionIndex = 18982;
