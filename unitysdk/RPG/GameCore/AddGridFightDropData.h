...
#define RPG_GAMECORE_ADDGRIDFIGHTDROPDATA_METHOD_3_9DDF5A36F94E8782_OFFSET UNITYSDK_OFFSET(0x16F1D370)
#define RPG_GAMECORE_ADDGRIDFIGHTDROPDATA_METHOD_3_F2E337D5A4450319_OFFSET UNITYSDK_OFFSET(0x16F1D3F0)
#define RPG_GAMECORE_ADDGRIDFIGHTDROPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x16F1D3C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddGridFightDropData_TypeDefinitionIndex = 20726;
