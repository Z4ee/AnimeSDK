...
#define RPG_GAMECORE_STAGEPVSOFFLINESAMPLERINFO_METHOD_2_0D71AC0AE1F02461_OFFSET UNITYSDK_OFFSET(0x1B0B29B0)
#define RPG_GAMECORE_STAGEPVSOFFLINESAMPLERINFO_METHOD_2_C895AE24D93BC425_OFFSET UNITYSDK_OFFSET(0x1B0B2840)
#define RPG_GAMECORE_STAGEPVSOFFLINESAMPLERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0B29A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StagePVSOfflineSamplerInfo_TypeDefinitionIndex = 18427;
