...
#define RPG_GAMECORE_STAGEPVSOFFLINESAMPLERINFO_METHOD_2_0D71AC0AE1F02461_OFFSET UNITYSDK_OFFSET(0x1776A040)
#define RPG_GAMECORE_STAGEPVSOFFLINESAMPLERINFO_METHOD_2_C895AE24D93BC425_OFFSET UNITYSDK_OFFSET(0x17769EE0)
#define RPG_GAMECORE_STAGEPVSOFFLINESAMPLERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1776A030)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StagePVSOfflineSamplerInfo_TypeDefinitionIndex = 17588;
