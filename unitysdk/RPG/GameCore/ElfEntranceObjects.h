...
#define RPG_GAMECORE_ELFENTRANCEOBJECTS_METHOD_2_B4574971132B5B1C_OFFSET UNITYSDK_OFFSET(0x1718E3F0)
#define RPG_GAMECORE_ELFENTRANCEOBJECTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1718E5A0)
