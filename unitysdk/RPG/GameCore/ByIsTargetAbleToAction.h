...
#define RPG_GAMECORE_BYISTARGETABLETOACTION_METHOD_4_B190FD30111E5B01_OFFSET UNITYSDK_OFFSET(0x18758660)
#define RPG_GAMECORE_BYISTARGETABLETOACTION_METHOD_4_CFD227DB0A8F2C77_OFFSET UNITYSDK_OFFSET(0x18758590)
#define RPG_GAMECORE_BYISTARGETABLETOACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18758610)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsTargetAbleToAction_TypeDefinitionIndex = 21960;
