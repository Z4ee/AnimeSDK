...
#define RPG_GAMECORE_BYISTARGETABLETOACTION_METHOD_4_79D7D4C9E7F6F63B_OFFSET UNITYSDK_OFFSET(0x1B2A7260)
#define RPG_GAMECORE_BYISTARGETABLETOACTION_METHOD_4_B190FD30111E5B01_OFFSET UNITYSDK_OFFSET(0x1B2A70E0)
#define RPG_GAMECORE_BYISTARGETABLETOACTION_METHOD_4_BE4D7C86BB1F989D_OFFSET UNITYSDK_OFFSET(0x1B2A7290)
#define RPG_GAMECORE_BYISTARGETABLETOACTION_METHOD_4_E1C324151ED10104_OFFSET UNITYSDK_OFFSET(0x1B2A70A0)
#define RPG_GAMECORE_BYISTARGETABLETOACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2A70D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsTargetAbleToAction_TypeDefinitionIndex = 22209;
