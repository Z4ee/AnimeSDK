...
#define RPG_GAMECORE_CONVINCEWAITTURNBEGIN_METHOD_3_7C3A5A284AC70681_OFFSET UNITYSDK_OFFSET(0x1967ED40)
#define RPG_GAMECORE_CONVINCEWAITTURNBEGIN_METHOD_3_DCB6F3A706B6A0B8_OFFSET UNITYSDK_OFFSET(0x1967EDC0)
#define RPG_GAMECORE_CONVINCEWAITTURNBEGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1967ED90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConvinceWaitTurnBegin_TypeDefinitionIndex = 20616;
