...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYPERSONADOORSTATUSCONFIG_METHOD_3_118E20864CEEA88D_OFFSET UNITYSDK_OFFSET(0x19B5F8C0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYPERSONADOORSTATUSCONFIG_METHOD_3_8082694EF7E31C04_OFFSET UNITYSDK_OFFSET(0x19B55FA0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYPERSONADOORSTATUSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B55F50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyPersonaDoorStatusConfig_TypeDefinitionIndex = 16985;
