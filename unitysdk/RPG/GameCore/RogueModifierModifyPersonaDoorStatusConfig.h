...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYPERSONADOORSTATUSCONFIG_METHOD_3_118E20864CEEA88D_OFFSET UNITYSDK_OFFSET(0x18D416E0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYPERSONADOORSTATUSCONFIG_METHOD_3_8082694EF7E31C04_OFFSET UNITYSDK_OFFSET(0x18D417B0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYPERSONADOORSTATUSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D41760)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyPersonaDoorStatusConfig_TypeDefinitionIndex = 16970;
