...
#define RPG_GAMECORE_BATTLECONDITIONCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x194C6040)
#define RPG_GAMECORE_BATTLECONDITIONCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x194C67A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleConditionConfigRow_TypeDefinitionIndex = 12227;
	...
	public:
		...
		::System::UInt32 TargetParam; // 0x28
		::System::UInt32 ID; // 0x2C
		::System::UInt32 IsShowProgress; // 0x30
