...
#define RPG_GAMECORE_DECALPUZZLECLEAR_METHOD_3_E1A360DAFB0BD97C_OFFSET UNITYSDK_OFFSET(0x18856F20)
#define RPG_GAMECORE_DECALPUZZLECLEAR_METHOD_3_F358F4DD927CF80D_OFFSET UNITYSDK_OFFSET(0x18856EA0)
#define RPG_GAMECORE_DECALPUZZLECLEAR__CTOR_OFFSET UNITYSDK_OFFSET(0x18856EF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DecalPuzzleClear_TypeDefinitionIndex = 20183;
