...
#define RPG_GAMECORE_DECALPUZZLECLEAR_METHOD_3_185FF65226AA34F7_OFFSET UNITYSDK_OFFSET(0x1D01CA60)
#define RPG_GAMECORE_DECALPUZZLECLEAR_METHOD_3_E1A360DAFB0BD97C_OFFSET UNITYSDK_OFFSET(0x1D01CAA0)
#define RPG_GAMECORE_DECALPUZZLECLEAR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D01CA90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DecalPuzzleClear_TypeDefinitionIndex = 20964;
