...
#define RPG_GAMECORE_FLOATCURVE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1BEB9F50)
#define RPG_GAMECORE_FLOATCURVE_GET_CACHEDANIMCURVE_OFFSET UNITYSDK_OFFSET(0x1BEBA330)
#define RPG_GAMECORE_FLOATCURVE_METHOD_2_0739E5F4AFDDD8B0_OFFSET UNITYSDK_OFFSET(0x1BEA52F0)
#define RPG_GAMECORE_FLOATCURVE_METHOD_2_28633EAD2621903E_OFFSET UNITYSDK_OFFSET(0x1BEBA380)
#define RPG_GAMECORE_FLOATCURVE_METHOD_2_6115B8FF6F2F3006_OFFSET UNITYSDK_OFFSET(0x1BEBA830)
#define RPG_GAMECORE_FLOATCURVE_METHOD_2_65C44E317041EBAA_OFFSET UNITYSDK_OFFSET(0x1BEBA3C0)
#define RPG_GAMECORE_FLOATCURVE_METHOD_2_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x1BEBA7F0)
#define RPG_GAMECORE_FLOATCURVE_METHOD_2_8A6035CCBA726F8F_OFFSET UNITYSDK_OFFSET(0x1BEBA2D0)
#define RPG_GAMECORE_FLOATCURVE_METHOD_2_B7AEDE66D3D00F7D_OFFSET UNITYSDK_OFFSET(0x1BEBA560)
#define RPG_GAMECORE_FLOATCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEB9F40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FloatCurve_TypeDefinitionIndex = 15695;
	...
	public:
		...
		static ::System::Void Method_2_0739E5F4AFDDD8B0(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::FloatCurve*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::FloatCurve*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_FLOATCURVE_METHOD_2_0739E5F4AFDDD8B0_OFFSET))(a1, a2);
		}
		...
		::System::Void Method_2_B7AEDE66D3D00F7D(::UnityEngine::AnimationCurve* a1)
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::AnimationCurve*))((::PBYTE)hIl2Cpp + RPG_GAMECORE_FLOATCURVE_METHOD_2_B7AEDE66D3D00F7D_OFFSET))(this, a1);
		}
