...
#define RPG_GAMECORE_FLOATCURVE_EQUALS_OFFSET UNITYSDK_OFFSET(0x189251D0)
#define RPG_GAMECORE_FLOATCURVE_GET_CACHEDANIMCURVE_OFFSET UNITYSDK_OFFSET(0x189255C0)
#define RPG_GAMECORE_FLOATCURVE_METHOD_2_1D86C4DD96C4B551_OFFSET UNITYSDK_OFFSET(0x18925800)
#define RPG_GAMECORE_FLOATCURVE_METHOD_2_28633EAD2621903E_OFFSET UNITYSDK_OFFSET(0x18925610)
#define RPG_GAMECORE_FLOATCURVE_METHOD_2_6115B8FF6F2F3006_OFFSET UNITYSDK_OFFSET(0x18925B00)
#define RPG_GAMECORE_FLOATCURVE_METHOD_2_65C44E317041EBAA_OFFSET UNITYSDK_OFFSET(0x18925650)
#define RPG_GAMECORE_FLOATCURVE_METHOD_2_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0x18925AC0)
#define RPG_GAMECORE_FLOATCURVE_METHOD_2_8A6035CCBA726F8F_OFFSET UNITYSDK_OFFSET(0x18925560)
#define RPG_GAMECORE_FLOATCURVE_METHOD_2_D80DF33D8BFF493D_OFFSET UNITYSDK_OFFSET(0x1890F750)
#define RPG_GAMECORE_FLOATCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x189251C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FloatCurve_TypeDefinitionIndex = 15461;
