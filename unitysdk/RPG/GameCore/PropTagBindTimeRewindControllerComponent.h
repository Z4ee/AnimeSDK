...
#define RPG_GAMECORE_PROPTAGBINDTIMEREWINDCONTROLLERCOMPONENT_METHOD_3_17842D26D5142366_OFFSET UNITYSDK_OFFSET(0x18C7AE60)
#define RPG_GAMECORE_PROPTAGBINDTIMEREWINDCONTROLLERCOMPONENT_METHOD_3_6FA78EA814811477_OFFSET UNITYSDK_OFFSET(0x18C7AEB0)
#define RPG_GAMECORE_PROPTAGBINDTIMEREWINDCONTROLLERCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x18C7AEA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropTagBindTimeRewindControllerComponent_TypeDefinitionIndex = 16661;
