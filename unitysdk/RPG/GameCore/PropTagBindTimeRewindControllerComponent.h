...
#define RPG_GAMECORE_PROPTAGBINDTIMEREWINDCONTROLLERCOMPONENT_METHOD_3_64C288A126C19AE5_OFFSET UNITYSDK_OFFSET(0x1D374130)
#define RPG_GAMECORE_PROPTAGBINDTIMEREWINDCONTROLLERCOMPONENT_METHOD_3_ACE0EA93BFCB4550_OFFSET UNITYSDK_OFFSET(0x1D374180)
#define RPG_GAMECORE_PROPTAGBINDTIMEREWINDCONTROLLERCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D374170)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropTagBindTimeRewindControllerComponent_TypeDefinitionIndex = 17354;
