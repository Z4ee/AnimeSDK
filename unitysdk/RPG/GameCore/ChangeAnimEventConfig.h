...
#define RPG_GAMECORE_CHANGEANIMEVENTCONFIG_METHOD_3_743016DD3ABFFF3F_OFFSET UNITYSDK_OFFSET(0x1CF89E80)
#define RPG_GAMECORE_CHANGEANIMEVENTCONFIG_METHOD_3_8CD3AD66C7AB114B_OFFSET UNITYSDK_OFFSET(0x1CF89F20)
#define RPG_GAMECORE_CHANGEANIMEVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF89EE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChangeAnimEventConfig_TypeDefinitionIndex = 22625;
