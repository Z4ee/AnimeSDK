...
#define RPG_GAMECORE_MATCHTHREEBASICROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1BD2E260)
#define RPG_GAMECORE_MATCHTHREEBASICROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD2E850)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MatchThreeBasicRow_TypeDefinitionIndex = 11499;
