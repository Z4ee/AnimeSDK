...
#define RPG_GAMECORE_MATCHTHREEBASICROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x198EDB60)
#define RPG_GAMECORE_MATCHTHREEBASICROW__CTOR_OFFSET UNITYSDK_OFFSET(0x198EE150)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MatchThreeBasicRow_TypeDefinitionIndex = 11399;
