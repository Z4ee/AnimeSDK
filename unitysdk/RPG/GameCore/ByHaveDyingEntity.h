...
#define RPG_GAMECORE_BYHAVEDYINGENTITY_METHOD_4_B3D3175C9CCDA94F_OFFSET UNITYSDK_OFFSET(0x170261A0)
#define RPG_GAMECORE_BYHAVEDYINGENTITY_METHOD_4_CB54303CCAEE57CB_OFFSET UNITYSDK_OFFSET(0x170260C0)
#define RPG_GAMECORE_BYHAVEDYINGENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x17026140)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByHaveDyingEntity_TypeDefinitionIndex = 21272;
