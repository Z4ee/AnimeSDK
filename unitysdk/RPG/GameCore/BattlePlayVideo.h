...
#define RPG_GAMECORE_BATTLEPLAYVIDEO_METHOD_3_6762DDB76D419191_OFFSET UNITYSDK_OFFSET(0x1CE7D810)
#define RPG_GAMECORE_BATTLEPLAYVIDEO_METHOD_3_9DAE00E84FD89D5C_OFFSET UNITYSDK_OFFSET(0x1CE7D7A0)
#define RPG_GAMECORE_BATTLEPLAYVIDEO__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE7D7F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattlePlayVideo_TypeDefinitionIndex = 23119;
