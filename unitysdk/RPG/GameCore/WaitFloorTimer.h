...
#define RPG_GAMECORE_WAITFLOORTIMER_METHOD_3_6CEBA139ED71347D_OFFSET UNITYSDK_OFFSET(0x190FDCE0)
#define RPG_GAMECORE_WAITFLOORTIMER_METHOD_3_C995D561F1C0696C_OFFSET UNITYSDK_OFFSET(0x190FDD60)
#define RPG_GAMECORE_WAITFLOORTIMER__CTOR_OFFSET UNITYSDK_OFFSET(0x190FDD30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitFloorTimer_TypeDefinitionIndex = 19433;
