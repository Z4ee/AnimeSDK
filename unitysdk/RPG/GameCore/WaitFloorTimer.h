...
#define RPG_GAMECORE_WAITFLOORTIMER_METHOD_3_8BD50CCC51077D27_OFFSET UNITYSDK_OFFSET(0x1DEB8830)
#define RPG_GAMECORE_WAITFLOORTIMER_METHOD_3_C995D561F1C0696C_OFFSET UNITYSDK_OFFSET(0x1DEB8870)
#define RPG_GAMECORE_WAITFLOORTIMER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEB8860)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitFloorTimer_TypeDefinitionIndex = 20240;
