...
#define RPG_GAMECORE_STOPDITHERCLOSE_METHOD_3_CDFFA319F0F859E1_OFFSET UNITYSDK_OFFSET(0x1B0C5560)
#define RPG_GAMECORE_STOPDITHERCLOSE_METHOD_3_EA60A0D1B8646DAA_OFFSET UNITYSDK_OFFSET(0x1B0C55B0)
#define RPG_GAMECORE_STOPDITHERCLOSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0C55A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StopDitherClose_TypeDefinitionIndex = 19844;
