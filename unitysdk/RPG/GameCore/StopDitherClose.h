...
#define RPG_GAMECORE_STOPDITHERCLOSE_METHOD_3_AC67BA2DDBE82E73_OFFSET UNITYSDK_OFFSET(0x19CBFD40)
#define RPG_GAMECORE_STOPDITHERCLOSE_METHOD_3_EA60A0D1B8646DAA_OFFSET UNITYSDK_OFFSET(0x19CBFDC0)
#define RPG_GAMECORE_STOPDITHERCLOSE__CTOR_OFFSET UNITYSDK_OFFSET(0x19CBFD90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StopDitherClose_TypeDefinitionIndex = 19486;
