...
#define RPG_GAMECORE_ST_BYDISTANCETOTARGET_METHOD_4_1CCEE9D74F80E571_OFFSET UNITYSDK_OFFSET(0x176928C0)
#define RPG_GAMECORE_ST_BYDISTANCETOTARGET_METHOD_4_A9F5D2766C667E10_OFFSET UNITYSDK_OFFSET(0x176927F0)
#define RPG_GAMECORE_ST_BYDISTANCETOTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x17692870)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_ByDistanceToTarget_TypeDefinitionIndex = 18357;
