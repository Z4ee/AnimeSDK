...
#define RPG_GAMECORE_FIVEDIMMUSICINFO_METHOD_2_3CFD533F0A3F9422_OFFSET UNITYSDK_OFFSET(0x1D86EC90)
#define RPG_GAMECORE_FIVEDIMMUSICINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D86EF70)
