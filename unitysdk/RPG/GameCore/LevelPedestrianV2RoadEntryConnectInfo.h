...
#define RPG_GAMECORE_LEVELPEDESTRIANV2ROADENTRYCONNECTINFO_METHOD_2_04E038D21AD6C9AE_OFFSET UNITYSDK_OFFSET(0x1B0855B0)
#define RPG_GAMECORE_LEVELPEDESTRIANV2ROADENTRYCONNECTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B085670)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPedestrianV2RoadEntryConnectInfo_TypeDefinitionIndex = 16607;
