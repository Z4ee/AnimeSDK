...
#define RPG_GAMECORE_ADVFORCEHIDEBILLBOARD_METHOD_3_759A11801B5F3ECA_OFFSET UNITYSDK_OFFSET(0x1D6B89C0)
#define RPG_GAMECORE_ADVFORCEHIDEBILLBOARD_METHOD_3_DB6F38911A805D3D_OFFSET UNITYSDK_OFFSET(0x1D6B8A10)
#define RPG_GAMECORE_ADVFORCEHIDEBILLBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6B8A00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvForceHideBillboard_TypeDefinitionIndex = 21503;
