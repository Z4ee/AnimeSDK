...
#define RPG_GAMECORE_ADVFORCEHIDEBILLBOARD_METHOD_3_247D1893CCB56C81_OFFSET UNITYSDK_OFFSET(0x186518B0)
#define RPG_GAMECORE_ADVFORCEHIDEBILLBOARD_METHOD_3_DB6F38911A805D3D_OFFSET UNITYSDK_OFFSET(0x18651940)
#define RPG_GAMECORE_ADVFORCEHIDEBILLBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x18651910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvForceHideBillboard_TypeDefinitionIndex = 20597;
