...
#define RPG_GAMECORE_ALLEYWALKABLEGRIDITEMDATA_METHOD_3_5006AB4F982808CF_OFFSET UNITYSDK_OFFSET(0x1869FB10)
#define RPG_GAMECORE_ALLEYWALKABLEGRIDITEMDATA_METHOD_3_FE619C0DB0EFDB7E_OFFSET UNITYSDK_OFFSET(0x18691500)
#define RPG_GAMECORE_ALLEYWALKABLEGRIDITEMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x186914F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AlleyWalkableGridItemData_TypeDefinitionIndex = 14837;
