...
#define RPG_GAMECORE_ALLEYWALKABLEGRIDITEMDATA_METHOD_3_5006AB4F982808CF_OFFSET UNITYSDK_OFFSET(0x1C566D80)
#define RPG_GAMECORE_ALLEYWALKABLEGRIDITEMDATA_METHOD_3_FE619C0DB0EFDB7E_OFFSET UNITYSDK_OFFSET(0x1C566DC0)
#define RPG_GAMECORE_ALLEYWALKABLEGRIDITEMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1C566DB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AlleyWalkableGridItemData_TypeDefinitionIndex = 15502;
