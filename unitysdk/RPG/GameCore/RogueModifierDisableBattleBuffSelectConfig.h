...
#define RPG_GAMECORE_ROGUEMODIFIERDISABLEBATTLEBUFFSELECTCONFIG_METHOD_3_814871353FF35C67_OFFSET UNITYSDK_OFFSET(0x1762E370)
#define RPG_GAMECORE_ROGUEMODIFIERDISABLEBATTLEBUFFSELECTCONFIG_METHOD_3_DE081FA8F6A6ADEE_OFFSET UNITYSDK_OFFSET(0x1762E2A0)
#define RPG_GAMECORE_ROGUEMODIFIERDISABLEBATTLEBUFFSELECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1762E320)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierDisableBattleBuffSelectConfig_TypeDefinitionIndex = 16498;
