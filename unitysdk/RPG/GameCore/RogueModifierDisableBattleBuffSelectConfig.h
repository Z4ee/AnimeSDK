...
#define RPG_GAMECORE_ROGUEMODIFIERDISABLEBATTLEBUFFSELECTCONFIG_METHOD_3_04F3E41729284CE3_OFFSET UNITYSDK_OFFSET(0x1EEF7F10)
#define RPG_GAMECORE_ROGUEMODIFIERDISABLEBATTLEBUFFSELECTCONFIG_METHOD_3_814871353FF35C67_OFFSET UNITYSDK_OFFSET(0x1EEF7F60)
#define RPG_GAMECORE_ROGUEMODIFIERDISABLEBATTLEBUFFSELECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEF7F50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierDisableBattleBuffSelectConfig_TypeDefinitionIndex = 17743;
