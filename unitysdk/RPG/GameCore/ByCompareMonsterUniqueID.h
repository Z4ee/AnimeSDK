...
#define RPG_GAMECORE_BYCOMPAREMONSTERUNIQUEID_METHOD_4_0DC791D31E0AD3D6_OFFSET UNITYSDK_OFFSET(0x19CF8670)
#define RPG_GAMECORE_BYCOMPAREMONSTERUNIQUEID_METHOD_4_5E6B8C74B5521BF7_OFFSET UNITYSDK_OFFSET(0x19CF85F0)
#define RPG_GAMECORE_BYCOMPAREMONSTERUNIQUEID_METHOD_4_98091678A8916BAB_OFFSET UNITYSDK_OFFSET(0x19CF8410)
#define RPG_GAMECORE_BYCOMPAREMONSTERUNIQUEID_METHOD_4_DA0D93B6C898E4D0_OFFSET UNITYSDK_OFFSET(0x19CF8330)
#define RPG_GAMECORE_BYCOMPAREMONSTERUNIQUEID__CTOR_OFFSET UNITYSDK_OFFSET(0x19CF83B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareMonsterUniqueID_TypeDefinitionIndex = 22173;
