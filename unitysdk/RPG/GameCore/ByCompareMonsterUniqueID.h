...
#define RPG_GAMECORE_BYCOMPAREMONSTERUNIQUEID_METHOD_4_08ED9C8A23D47D3A_OFFSET UNITYSDK_OFFSET(0x17010450)
#define RPG_GAMECORE_BYCOMPAREMONSTERUNIQUEID_METHOD_4_98091678A8916BAB_OFFSET UNITYSDK_OFFSET(0x170105B0)
#define RPG_GAMECORE_BYCOMPAREMONSTERUNIQUEID__CTOR_OFFSET UNITYSDK_OFFSET(0x17010510)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareMonsterUniqueID_TypeDefinitionIndex = 21207;
