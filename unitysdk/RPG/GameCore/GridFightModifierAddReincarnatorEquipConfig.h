...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDREINCARNATOREQUIPCONFIG_METHOD_3_135D509D8ABBBAC1_OFFSET UNITYSDK_OFFSET(0x1EE6C5D0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDREINCARNATOREQUIPCONFIG_METHOD_3_3F1AA1911A6AD725_OFFSET UNITYSDK_OFFSET(0x1EE6C620)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDREINCARNATOREQUIPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EE6C610)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierAddReincarnatorEquipConfig_TypeDefinitionIndex = 19243;
