...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDREINCARNATOREQUIPCONFIG_METHOD_3_3F1AA1911A6AD725_OFFSET UNITYSDK_OFFSET(0x197E8EE0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDREINCARNATOREQUIPCONFIG_METHOD_3_9D520FF3E04A0B0C_OFFSET UNITYSDK_OFFSET(0x197E8E10)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDREINCARNATOREQUIPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197E8E90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierAddReincarnatorEquipConfig_TypeDefinitionIndex = 18468;
