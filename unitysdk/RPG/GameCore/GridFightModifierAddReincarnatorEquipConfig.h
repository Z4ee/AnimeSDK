...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDREINCARNATOREQUIPCONFIG_METHOD_3_3F1AA1911A6AD725_OFFSET UNITYSDK_OFFSET(0x189B1290)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDREINCARNATOREQUIPCONFIG_METHOD_3_9D520FF3E04A0B0C_OFFSET UNITYSDK_OFFSET(0x189B11C0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDREINCARNATOREQUIPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189B1240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierAddReincarnatorEquipConfig_TypeDefinitionIndex = 18496;
