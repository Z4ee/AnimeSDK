...
#define RPG_GAMECORE_ADVSETHOYOGROUPNPCANIMSPEEDRATIO_METHOD_3_4F827CBB7611E609_OFFSET UNITYSDK_OFFSET(0x1CDD9F80)
#define RPG_GAMECORE_ADVSETHOYOGROUPNPCANIMSPEEDRATIO_METHOD_3_D5B1EE5F02F5AB28_OFFSET UNITYSDK_OFFSET(0x1CDD9F40)
#define RPG_GAMECORE_ADVSETHOYOGROUPNPCANIMSPEEDRATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDD9F70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSetHoyoGroupNpcAnimSpeedRatio_TypeDefinitionIndex = 20791;
