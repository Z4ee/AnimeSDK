...
#define RPG_GAMECORE_PROPCURVEMOVESTARTMODE_METHOD_2_1CAADBF49CA18D51_OFFSET UNITYSDK_OFFSET(0x1BA1D0C0)
#define RPG_GAMECORE_PROPCURVEMOVESTARTMODE_METHOD_2_69838BB5F72F0A9B_OFFSET UNITYSDK_OFFSET(0x1BA1D800)
#define RPG_GAMECORE_PROPCURVEMOVESTARTMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA1D860)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropCurveMoveStartMode_TypeDefinitionIndex = 20215;
