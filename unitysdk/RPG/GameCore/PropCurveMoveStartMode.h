...
#define RPG_GAMECORE_PROPCURVEMOVESTARTMODE_METHOD_2_1CAADBF49CA18D51_OFFSET UNITYSDK_OFFSET(0x18C67C80)
#define RPG_GAMECORE_PROPCURVEMOVESTARTMODE_METHOD_2_69838BB5F72F0A9B_OFFSET UNITYSDK_OFFSET(0x18C683C0)
#define RPG_GAMECORE_PROPCURVEMOVESTARTMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x18C68420)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropCurveMoveStartMode_TypeDefinitionIndex = 19988;
