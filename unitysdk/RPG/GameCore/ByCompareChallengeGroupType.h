...
#define RPG_GAMECORE_BYCOMPARECHALLENGEGROUPTYPE_METHOD_4_38221E01C628D9CC_OFFSET UNITYSDK_OFFSET(0x18727E80)
#define RPG_GAMECORE_BYCOMPARECHALLENGEGROUPTYPE_METHOD_4_F130E1E1F27B0282_OFFSET UNITYSDK_OFFSET(0x18727DB0)
#define RPG_GAMECORE_BYCOMPARECHALLENGEGROUPTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x18727E30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareChallengeGroupType_TypeDefinitionIndex = 22410;
