...
#define RPG_GAMECORE_TARGETSORTSEQUENCE_METHOD_3_2FF606840276CCDE_OFFSET UNITYSDK_OFFSET(0x1D0CB2C0)
#define RPG_GAMECORE_TARGETSORTSEQUENCE_METHOD_3_79FCE1B26DC2F0B6_OFFSET UNITYSDK_OFFSET(0x1D0CB1C0)
#define RPG_GAMECORE_TARGETSORTSEQUENCE_METHOD_3_D0DC364474FED5F4_OFFSET UNITYSDK_OFFSET(0x1D0CB270)
#define RPG_GAMECORE_TARGETSORTSEQUENCE_METHOD_3_D640436D2B6EE6FC_OFFSET UNITYSDK_OFFSET(0x1D0CB160)
#define RPG_GAMECORE_TARGETSORTSEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0CB1B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetSortSequence_TypeDefinitionIndex = 23124;
