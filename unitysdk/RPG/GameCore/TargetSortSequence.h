...
#define RPG_GAMECORE_TARGETSORTSEQUENCE_METHOD_3_D04F6136AE7A02F3_OFFSET UNITYSDK_OFFSET(0x18EF8B90)
#define RPG_GAMECORE_TARGETSORTSEQUENCE_METHOD_3_E8B3164CF7C064BF_OFFSET UNITYSDK_OFFSET(0x18EF9930)
#define RPG_GAMECORE_TARGETSORTSEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x18EF8B70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetSortSequence_TypeDefinitionIndex = 22970;
