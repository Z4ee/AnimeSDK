...
#define RPG_GAMECORE_BYCOMPARETEXTJOINVALUE_METHOD_4_226BD00DC73AA323_OFFSET UNITYSDK_OFFSET(0x1A8B09E0)
#define RPG_GAMECORE_BYCOMPARETEXTJOINVALUE_METHOD_4_53852523F4D94044_OFFSET UNITYSDK_OFFSET(0x1A8B07C0)
#define RPG_GAMECORE_BYCOMPARETEXTJOINVALUE_METHOD_4_9EE93E5A994F1431_OFFSET UNITYSDK_OFFSET(0x1A8B0800)
#define RPG_GAMECORE_BYCOMPARETEXTJOINVALUE_METHOD_4_F9DAE346C65E4A4C_OFFSET UNITYSDK_OFFSET(0x1A8B09B0)
#define RPG_GAMECORE_BYCOMPARETEXTJOINVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8B07F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareTextJoinValue_TypeDefinitionIndex = 20095;
