...
#define RPG_GAMECORE_BYCOMPARETEXTJOINVALUE_METHOD_4_95DC7C725B433A17_OFFSET UNITYSDK_OFFSET(0x1701BF00)
#define RPG_GAMECORE_BYCOMPARETEXTJOINVALUE_METHOD_4_9EE93E5A994F1431_OFFSET UNITYSDK_OFFSET(0x1701BFD0)
#define RPG_GAMECORE_BYCOMPARETEXTJOINVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1701BF80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareTextJoinValue_TypeDefinitionIndex = 19208;
