...
#define RPG_GAMECORE_ADVENTUREDYINGPARAM_METHOD_2_2162C1CE5E1F5107_OFFSET UNITYSDK_OFFSET(0x16F537C0)
#define RPG_GAMECORE_ADVENTUREDYINGPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x16F538D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureDyingParam_TypeDefinitionIndex = 18502;
