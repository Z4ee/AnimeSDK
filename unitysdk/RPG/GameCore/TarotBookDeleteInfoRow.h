...
#define RPG_GAMECORE_TAROTBOOKDELETEINFOROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x177D5270)
#define RPG_GAMECORE_TAROTBOOKDELETEINFOROW__CTOR_OFFSET UNITYSDK_OFFSET(0x177D55E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TarotBookDeleteInfoRow_TypeDefinitionIndex = 13994;

	class TarotBookDeleteInfoRow : public ::System::Object
	{
	public:
		::System::Single FadeInTime; // 0x10
		::System::UInt32 ProgressEnd; // 0x14
		::RPG::Client::TextID SentenceTextmapID; // 0x18
		::RPG::Client::TextID SentenceName; // 0x28
		::RPG::Client::TextID ProgressDesc; // 0x38
		::System::Single ProgressGapTime; // 0x48
