...
#define RPG_GAMECORE_UNIVERSALHOTFIXBASETASK_METHOD_3_3C5BD2870EE0BA88_OFFSET UNITYSDK_OFFSET(0x178E5FD0)
#define RPG_GAMECORE_UNIVERSALHOTFIXBASETASK_METHOD_3_61A7BDAF4C1DB6F7_OFFSET UNITYSDK_OFFSET(0x178E62A0)
#define RPG_GAMECORE_UNIVERSALHOTFIXBASETASK__CTOR_OFFSET UNITYSDK_OFFSET(0x178E6270)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UniversalHotFixBaseTask_TypeDefinitionIndex = 21586;
