...
#define RPG_GAMECORE_WOLFBROMONSTERHITBOOMPROP_METHOD_3_2BF977DE54E45BD0_OFFSET UNITYSDK_OFFSET(0x19110050)
#define RPG_GAMECORE_WOLFBROMONSTERHITBOOMPROP_METHOD_3_445B64E3E16E6864_OFFSET UNITYSDK_OFFSET(0x19110150)
#define RPG_GAMECORE_WOLFBROMONSTERHITBOOMPROP__CTOR_OFFSET UNITYSDK_OFFSET(0x191100E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WolfBroMonsterHitBoomProp_TypeDefinitionIndex = 19106;
	...
	public:
		...
		static ::System::Void Method_3_2BF977DE54E45BD0(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::WolfBroMonsterHitBoomProp*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::WolfBroMonsterHitBoomProp*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_WOLFBROMONSTERHITBOOMPROP_METHOD_3_2BF977DE54E45BD0_OFFSET))(a1, a2);
		}
