...
#define RPG_GAMECORE_WOLFBROMONSTERHITBOOMPROP_METHOD_3_2BF977DE54E45BD0_OFFSET UNITYSDK_OFFSET(0x1790C150)
#define RPG_GAMECORE_WOLFBROMONSTERHITBOOMPROP_METHOD_3_445B64E3E16E6864_OFFSET UNITYSDK_OFFSET(0x1790C250)
#define RPG_GAMECORE_WOLFBROMONSTERHITBOOMPROP__CTOR_OFFSET UNITYSDK_OFFSET(0x1790C1E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WolfBroMonsterHitBoomProp_TypeDefinitionIndex = 18454;
