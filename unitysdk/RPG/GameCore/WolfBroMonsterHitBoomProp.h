...
#define RPG_GAMECORE_WOLFBROMONSTERHITBOOMPROP_METHOD_3_445B64E3E16E6864_OFFSET UNITYSDK_OFFSET(0x1D1C3260)
#define RPG_GAMECORE_WOLFBROMONSTERHITBOOMPROP_METHOD_3_AD38C68F2AC05983_OFFSET UNITYSDK_OFFSET(0x1D1C31A0)
#define RPG_GAMECORE_WOLFBROMONSTERHITBOOMPROP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1C3210)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WolfBroMonsterHitBoomProp_TypeDefinitionIndex = 19394;
