...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERFORCEMONSTERCAMPIDCONFIG_METHOD_3_1FC90A4630A2A981_OFFSET UNITYSDK_OFFSET(0x1D069D30)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERFORCEMONSTERCAMPIDCONFIG_METHOD_3_6AA18190319326E5_OFFSET UNITYSDK_OFFSET(0x1D069D80)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERFORCEMONSTERCAMPIDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D069D70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierForceMonsterCampIdConfig_TypeDefinitionIndex = 18624;
