...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETNODAMAGEROLENUMINBATTLECONFIG_METHOD_6_F3445CBC7137B3C6_OFFSET UNITYSDK_OFFSET(0x1D06DA30)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETNODAMAGEROLENUMINBATTLECONFIG_METHOD_6_F6D0039B1C703C62_OFFSET UNITYSDK_OFFSET(0x1D06DA80)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETNODAMAGEROLENUMINBATTLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D06DA70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightParamGetNoDamageRoleNumInBattleConfig_TypeDefinitionIndex = 18775;
