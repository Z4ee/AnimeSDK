...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETNODAMAGEROLENUMINBATTLECONFIG_METHOD_6_7657F2EF7AC8638C_OFFSET UNITYSDK_OFFSET(0x189C56A0)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETNODAMAGEROLENUMINBATTLECONFIG_METHOD_6_F6D0039B1C703C62_OFFSET UNITYSDK_OFFSET(0x189C5950)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETNODAMAGEROLENUMINBATTLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189C5820)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightParamGetNoDamageRoleNumInBattleConfig_TypeDefinitionIndex = 18541;
