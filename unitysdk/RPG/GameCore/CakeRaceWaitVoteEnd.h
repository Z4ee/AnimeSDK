...
#define RPG_GAMECORE_CAKERACEWAITVOTEEND_METHOD_3_E7E91CD387C767DA_OFFSET UNITYSDK_OFFSET(0x17051230)
#define RPG_GAMECORE_CAKERACEWAITVOTEEND_METHOD_3_EB37DDE45E8A512E_OFFSET UNITYSDK_OFFSET(0x17051120)
#define RPG_GAMECORE_CAKERACEWAITVOTEEND__CTOR_OFFSET UNITYSDK_OFFSET(0x17051200)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceWaitVoteEnd_TypeDefinitionIndex = 22345;
