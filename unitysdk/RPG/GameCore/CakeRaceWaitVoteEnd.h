...
#define RPG_GAMECORE_CAKERACEWAITVOTEEND_METHOD_3_E7E91CD387C767DA_OFFSET UNITYSDK_OFFSET(0x187B59C0)
#define RPG_GAMECORE_CAKERACEWAITVOTEEND_METHOD_3_EB37DDE45E8A512E_OFFSET UNITYSDK_OFFSET(0x187B58B0)
#define RPG_GAMECORE_CAKERACEWAITVOTEEND__CTOR_OFFSET UNITYSDK_OFFSET(0x187B5990)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceWaitVoteEnd_TypeDefinitionIndex = 23313;
