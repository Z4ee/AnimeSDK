...
#define RPG_GAMECORE_CAKERACEWAITVOTEEND_METHOD_3_E7E91CD387C767DA_OFFSET UNITYSDK_OFFSET(0x1CF7A8E0)
#define RPG_GAMECORE_CAKERACEWAITVOTEEND_METHOD_3_EB835F944A4CAC37_OFFSET UNITYSDK_OFFSET(0x1CF7A810)
#define RPG_GAMECORE_CAKERACEWAITVOTEEND__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF7A8D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceWaitVoteEnd_TypeDefinitionIndex = 24026;
