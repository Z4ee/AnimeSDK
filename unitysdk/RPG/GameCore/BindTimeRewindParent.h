...
#define RPG_GAMECORE_BINDTIMEREWINDPARENT_METHOD_3_1788AF2155F280FA_OFFSET UNITYSDK_OFFSET(0x1A3FE2D0)
#define RPG_GAMECORE_BINDTIMEREWINDPARENT_METHOD_3_FF8A73A97B4D489F_OFFSET UNITYSDK_OFFSET(0x1A3FE310)
#define RPG_GAMECORE_BINDTIMEREWINDPARENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3FE300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BindTimeRewindParent_TypeDefinitionIndex = 19869;
