...
#define RPG_GAMECORE_HOYOGROUPSTREAMINGBLACKLISTITEM_METHOD_2_7CA2615DEE69DD8C_OFFSET UNITYSDK_OFFSET(0x1D1950D0)
#define RPG_GAMECORE_HOYOGROUPSTREAMINGBLACKLISTITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1951F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HoYoGroupStreamingBlackListItem_TypeDefinitionIndex = 17156;
