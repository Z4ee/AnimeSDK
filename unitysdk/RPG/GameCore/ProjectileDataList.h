...
#define RPG_GAMECORE_PROJECTILEDATALIST_METHOD_2_36B38DE4EC1F726B_OFFSET UNITYSDK_OFFSET(0x1BA1A1B0)
#define RPG_GAMECORE_PROJECTILEDATALIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA1A330)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ProjectileDataList_TypeDefinitionIndex = 21770;
