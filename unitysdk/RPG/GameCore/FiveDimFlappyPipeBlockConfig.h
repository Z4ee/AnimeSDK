...
#define RPG_GAMECORE_FIVEDIMFLAPPYPIPEBLOCKCONFIG_METHOD_2_DE463D5C807A01DF_OFFSET UNITYSDK_OFFSET(0x1D0E58F0)
#define RPG_GAMECORE_FIVEDIMFLAPPYPIPEBLOCKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0E5A20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimFlappyPipeBlockConfig_TypeDefinitionIndex = 16552;
