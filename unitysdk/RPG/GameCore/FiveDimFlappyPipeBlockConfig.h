...
#define RPG_GAMECORE_FIVEDIMFLAPPYPIPEBLOCKCONFIG_METHOD_2_DE463D5C807A01DF_OFFSET UNITYSDK_OFFSET(0x171F1E50)
#define RPG_GAMECORE_FIVEDIMFLAPPYPIPEBLOCKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171F1F80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimFlappyPipeBlockConfig_TypeDefinitionIndex = 15329;
