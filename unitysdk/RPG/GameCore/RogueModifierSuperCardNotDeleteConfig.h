...
#define RPG_GAMECORE_ROGUEMODIFIERSUPERCARDNOTDELETECONFIG_METHOD_3_74D7F2957897DC8B_OFFSET UNITYSDK_OFFSET(0x19B9CFB0)
#define RPG_GAMECORE_ROGUEMODIFIERSUPERCARDNOTDELETECONFIG_METHOD_3_835935DCEA265B32_OFFSET UNITYSDK_OFFSET(0x19B9CEE0)
#define RPG_GAMECORE_ROGUEMODIFIERSUPERCARDNOTDELETECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B9CF60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierSuperCardNotDeleteConfig_TypeDefinitionIndex = 16949;
