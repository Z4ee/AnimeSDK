...
#define RPG_GAMECORE_ROGUEMODIFIERSUPERCARDNOTDELETECONFIG_METHOD_3_74D7F2957897DC8B_OFFSET UNITYSDK_OFFSET(0x1D166610)
#define RPG_GAMECORE_ROGUEMODIFIERSUPERCARDNOTDELETECONFIG_METHOD_3_C14C7D0C7AABFFE7_OFFSET UNITYSDK_OFFSET(0x1D1665C0)
#define RPG_GAMECORE_ROGUEMODIFIERSUPERCARDNOTDELETECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D166600)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierSuperCardNotDeleteConfig_TypeDefinitionIndex = 17111;
