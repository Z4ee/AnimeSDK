...
#define RPG_GAMECORE_TARGETFETCHADVFAKEAVATARPLAYERSTUB_METHOD_4_21E84F4B62FE0F92_OFFSET UNITYSDK_OFFSET(0x19CF4AF0)
#define RPG_GAMECORE_TARGETFETCHADVFAKEAVATARPLAYERSTUB_METHOD_4_37BE0359D84CEEAA_OFFSET UNITYSDK_OFFSET(0x19D08690)
#define RPG_GAMECORE_TARGETFETCHADVFAKEAVATARPLAYERSTUB_METHOD_4_8372EA235D640FC0_OFFSET UNITYSDK_OFFSET(0x19D085B0)
#define RPG_GAMECORE_TARGETFETCHADVFAKEAVATARPLAYERSTUB_METHOD_4_C5C4C5D1CF916BF3_OFFSET UNITYSDK_OFFSET(0x19D03130)
#define RPG_GAMECORE_TARGETFETCHADVFAKEAVATARPLAYERSTUB__CTOR_OFFSET UNITYSDK_OFFSET(0x19CF4AA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchAdvFakeAvatarPlayerStub_TypeDefinitionIndex = 22562;
	...
	public:
		...
		static ::System::Void Method_4_C5C4C5D1CF916BF3(::SimpleJSON::JSONNode* a1, ::RPG::GameCore::TargetFetchAdvFakeAvatarPlayerStub*& a2)
		{
			return ((::System::Void(*)(::SimpleJSON::JSONNode*, ::RPG::GameCore::TargetFetchAdvFakeAvatarPlayerStub*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_TARGETFETCHADVFAKEAVATARPLAYERSTUB_METHOD_4_C5C4C5D1CF916BF3_OFFSET))(a1, a2);
		}
