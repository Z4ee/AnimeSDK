...
#define RPG_GAMECORE_TARGETFETCHADVFAKEAVATARPLAYERSTUB_METHOD_4_21E84F4B62FE0F92_OFFSET UNITYSDK_OFFSET(0x1D0B26C0)
#define RPG_GAMECORE_TARGETFETCHADVFAKEAVATARPLAYERSTUB_METHOD_4_3371DB6E2AEFCEEE_OFFSET UNITYSDK_OFFSET(0x1D0B2720)
#define RPG_GAMECORE_TARGETFETCHADVFAKEAVATARPLAYERSTUB_METHOD_4_37BE0359D84CEEAA_OFFSET UNITYSDK_OFFSET(0x1D0B2760)
#define RPG_GAMECORE_TARGETFETCHADVFAKEAVATARPLAYERSTUB_METHOD_4_3918ECB7A81E2993_OFFSET UNITYSDK_OFFSET(0x1D0B2620)
#define RPG_GAMECORE_TARGETFETCHADVFAKEAVATARPLAYERSTUB__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0B26B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchAdvFakeAvatarPlayerStub_TypeDefinitionIndex = 23025;
