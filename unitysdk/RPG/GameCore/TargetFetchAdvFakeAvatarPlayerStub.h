...
#define RPG_GAMECORE_TARGETFETCHADVFAKEAVATARPLAYERSTUB_METHOD_4_21E84F4B62FE0F92_OFFSET UNITYSDK_OFFSET(0x18ED8720)
#define RPG_GAMECORE_TARGETFETCHADVFAKEAVATARPLAYERSTUB_METHOD_4_8372EA235D640FC0_OFFSET UNITYSDK_OFFSET(0x18EE1D10)
#define RPG_GAMECORE_TARGETFETCHADVFAKEAVATARPLAYERSTUB__CTOR_OFFSET UNITYSDK_OFFSET(0x18ED86D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchAdvFakeAvatarPlayerStub_TypeDefinitionIndex = 22864;
