...
#define RPG_GAMECORE_ADVSETCOLLIDERGROUPSTATE_METHOD_3_10CEDB2929E21A9A_OFFSET UNITYSDK_OFFSET(0x1BE2C4D0)
#define RPG_GAMECORE_ADVSETCOLLIDERGROUPSTATE_METHOD_3_70FFE2C36537E9CD_OFFSET UNITYSDK_OFFSET(0x1BE2C510)
#define RPG_GAMECORE_ADVSETCOLLIDERGROUPSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE2C500)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSetColliderGroupState_TypeDefinitionIndex = 19748;
