...
#define RPG_GAMECORE_ADVSETCOLLIDERGROUPSTATE_METHOD_3_70FFE2C36537E9CD_OFFSET UNITYSDK_OFFSET(0x18662230)
#define RPG_GAMECORE_ADVSETCOLLIDERGROUPSTATE_METHOD_3_A329B87B6F1A1411_OFFSET UNITYSDK_OFFSET(0x186621B0)
#define RPG_GAMECORE_ADVSETCOLLIDERGROUPSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18662200)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSetColliderGroupState_TypeDefinitionIndex = 19494;
