...
#define RPG_GAMECORE_ADVSETCOLLIDERGROUPSTATE_METHOD_3_70FFE2C36537E9CD_OFFSET UNITYSDK_OFFSET(0x16F40070)
#define RPG_GAMECORE_ADVSETCOLLIDERGROUPSTATE_METHOD_3_A329B87B6F1A1411_OFFSET UNITYSDK_OFFSET(0x16F3FFF0)
#define RPG_GAMECORE_ADVSETCOLLIDERGROUPSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F40040)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSetColliderGroupState_TypeDefinitionIndex = 18836;
