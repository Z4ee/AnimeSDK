...
#define RPG_GAMECORE_GRIDFIGHTMONSTERCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D06C090)
#define RPG_GAMECORE_GRIDFIGHTMONSTERCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D06C2B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightMonsterConfigRow_TypeDefinitionIndex = 13131;
	...
	public:
		...
		::System::UInt32 Star2EliteGroup3; // 0x1C
		::System::UInt32 Star1EliteGroup3; // 0x20
