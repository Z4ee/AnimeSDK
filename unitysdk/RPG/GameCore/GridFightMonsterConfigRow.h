...
#define RPG_GAMECORE_GRIDFIGHTMONSTERCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x197F5200)
#define RPG_GAMECORE_GRIDFIGHTMONSTERCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x197F5420)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightMonsterConfigRow_TypeDefinitionIndex = 12983;
	...
	public:
		...
		::System::UInt32 MonsterTier; // 0x24
