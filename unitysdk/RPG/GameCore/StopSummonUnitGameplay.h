...
#define RPG_GAMECORE_STOPSUMMONUNITGAMEPLAY_METHOD_3_328C5361A86B543E_OFFSET UNITYSDK_OFFSET(0x18EA4380)
#define RPG_GAMECORE_STOPSUMMONUNITGAMEPLAY_METHOD_3_88EBF1531CEED2AF_OFFSET UNITYSDK_OFFSET(0x18EA4400)
#define RPG_GAMECORE_STOPSUMMONUNITGAMEPLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x18EA43D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StopSummonUnitGameplay_TypeDefinitionIndex = 20137;
