...
#define RPG_GAMECORE_STACKSTATUSRESISTANCE_METHOD_3_8FB84279E4D0530F_OFFSET UNITYSDK_OFFSET(0x17763170)
#define RPG_GAMECORE_STACKSTATUSRESISTANCE_METHOD_3_B59B10AC9E36F352_OFFSET UNITYSDK_OFFSET(0x177631F0)
#define RPG_GAMECORE_STACKSTATUSRESISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x177631C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StackStatusResistance_TypeDefinitionIndex = 20863;
