...
#define RPG_GAMECORE_GRIDFIGHTACTIONSETGLOBALSAVEDVALUECONFIG_METHOD_6_A1C98A6EAB5599FE_OFFSET UNITYSDK_OFFSET(0x17251010)
#define RPG_GAMECORE_GRIDFIGHTACTIONSETGLOBALSAVEDVALUECONFIG_METHOD_6_D62F4EE26565981D_OFFSET UNITYSDK_OFFSET(0x17250520)
#define RPG_GAMECORE_GRIDFIGHTACTIONSETGLOBALSAVEDVALUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17250480)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightActionSetGlobalSavedValueConfig_TypeDefinitionIndex = 17740;
