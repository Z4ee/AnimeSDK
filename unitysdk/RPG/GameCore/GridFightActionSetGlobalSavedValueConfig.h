...
#define RPG_GAMECORE_GRIDFIGHTACTIONSETGLOBALSAVEDVALUECONFIG_METHOD_6_A1C98A6EAB5599FE_OFFSET UNITYSDK_OFFSET(0x197D8AA0)
#define RPG_GAMECORE_GRIDFIGHTACTIONSETGLOBALSAVEDVALUECONFIG_METHOD_6_D62F4EE26565981D_OFFSET UNITYSDK_OFFSET(0x197D7F60)
#define RPG_GAMECORE_GRIDFIGHTACTIONSETGLOBALSAVEDVALUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197D7EC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightActionSetGlobalSavedValueConfig_TypeDefinitionIndex = 18325;
