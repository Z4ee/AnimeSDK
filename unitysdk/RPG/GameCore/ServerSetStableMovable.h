...
#define RPG_GAMECORE_SERVERSETSTABLEMOVABLE_METHOD_3_DA4D2F108E6953DB_OFFSET UNITYSDK_OFFSET(0x1C2CFAA0)
#define RPG_GAMECORE_SERVERSETSTABLEMOVABLE_METHOD_3_F964084FF94EDF77_OFFSET UNITYSDK_OFFSET(0x1C2CFA50)
#define RPG_GAMECORE_SERVERSETSTABLEMOVABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2CFA90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ServerSetStableMovable_TypeDefinitionIndex = 20282;
