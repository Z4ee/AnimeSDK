...
#define RPG_GAMECORE_SERVERSETSTABLEMOVABLE_METHOD_3_CB56E846288FCB0B_OFFSET UNITYSDK_OFFSET(0x19C25B40)
#define RPG_GAMECORE_SERVERSETSTABLEMOVABLE_METHOD_3_DA4D2F108E6953DB_OFFSET UNITYSDK_OFFSET(0x19C25BD0)
#define RPG_GAMECORE_SERVERSETSTABLEMOVABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C25BA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ServerSetStableMovable_TypeDefinitionIndex = 19917;
