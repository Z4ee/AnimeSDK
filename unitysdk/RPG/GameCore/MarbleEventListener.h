...
#define RPG_GAMECORE_MARBLEEVENTLISTENER_METHOD_3_2587054D632F762C_OFFSET UNITYSDK_OFFSET(0x1D4A7F40)
#define RPG_GAMECORE_MARBLEEVENTLISTENER_METHOD_3_2722F0A43CADA6F5_OFFSET UNITYSDK_OFFSET(0x1D4A7F80)
#define RPG_GAMECORE_MARBLEEVENTLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4A7F70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleEventListener_TypeDefinitionIndex = 21794;
