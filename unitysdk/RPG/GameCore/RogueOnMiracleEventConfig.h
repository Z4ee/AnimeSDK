...
#define RPG_GAMECORE_ROGUEONMIRACLEEVENTCONFIG_METHOD_2_3CE15F85292815C0_OFFSET UNITYSDK_OFFSET(0x1D40C590)
#define RPG_GAMECORE_ROGUEONMIRACLEEVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D40C5D0)
