...
#define RPG_GAMECORE_ROGUEONMIRACLEEVENTCONFIG_METHOD_2_3CE15F85292815C0_OFFSET UNITYSDK_OFFSET(0x18D577E0)
#define RPG_GAMECORE_ROGUEONMIRACLEEVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D57820)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueOnMiracleEventConfig_TypeDefinitionIndex = 16793;
