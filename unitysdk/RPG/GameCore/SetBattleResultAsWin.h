...
#define RPG_GAMECORE_SETBATTLERESULTASWIN_METHOD_3_0222CA7F6E2859D9_OFFSET UNITYSDK_OFFSET(0x19C2B7E0)
#define RPG_GAMECORE_SETBATTLERESULTASWIN_METHOD_3_743AE71B48F334E0_OFFSET UNITYSDK_OFFSET(0x19C2B760)
#define RPG_GAMECORE_SETBATTLERESULTASWIN__CTOR_OFFSET UNITYSDK_OFFSET(0x19C2B7B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetBattleResultAsWin_TypeDefinitionIndex = 22186;
