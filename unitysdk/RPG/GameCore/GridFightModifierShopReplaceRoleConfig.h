...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSHOPREPLACEROLECONFIG_METHOD_3_54A693EE512CAFE8_OFFSET UNITYSDK_OFFSET(0x1D06B0A0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSHOPREPLACEROLECONFIG_METHOD_3_CB528DB9A8711524_OFFSET UNITYSDK_OFFSET(0x1D06B0F0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSHOPREPLACEROLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D06B0E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierShopReplaceRoleConfig_TypeDefinitionIndex = 18598;
