...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSHOPREPLACEROLECONFIG_METHOD_3_672E31C794868D2D_OFFSET UNITYSDK_OFFSET(0x189BF930)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSHOPREPLACEROLECONFIG_METHOD_3_CB528DB9A8711524_OFFSET UNITYSDK_OFFSET(0x189BFA00)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSHOPREPLACEROLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189BF9B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierShopReplaceRoleConfig_TypeDefinitionIndex = 18382;
