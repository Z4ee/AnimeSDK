...
#define RPG_GAMECORE_FIVEDIMFLUTETALKCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1973E280)
#define RPG_GAMECORE_FIVEDIMFLUTETALKCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1973E5F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimFluteTalkConfigRow_TypeDefinitionIndex = 13435;

	class FiveDimFluteTalkConfigRow : public ::System::Object
	{
	public:
		::System::String* IconPathInputTips; // 0x10
		::System::String* IconPathErrorTIps; // 0x18
		::System::String* IconPath; // 0x20
		::RPG::Client::TextID InputTipsTextID; // 0x28
		::RPG::Client::TextID ErrorTIpsTextID; // 0x38
		::System::UInt32 FluteID; // 0x48
		::RPG::Client::TextID EnterTipsTextID; // 0x50
