...
#define RPG_GAMECORE_DYNAMICSTRINGLIST_METHOD_2_9B5D4B5FA3E608F5_OFFSET UNITYSDK_OFFSET(0x1BB2B110)
#define RPG_GAMECORE_DYNAMICSTRINGLIST_METHOD_2_C698CD91779AB72C_OFFSET UNITYSDK_OFFSET(0x1BB2B2B0)
#define RPG_GAMECORE_DYNAMICSTRINGLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB2B2A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DynamicStringList_TypeDefinitionIndex = 15832;
