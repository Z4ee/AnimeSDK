...
#define RPG_GAMECORE_CHARACTERATLASFACEEMOTION_METHOD_2_3E89669D07E186FB_OFFSET UNITYSDK_OFFSET(0x19606480)
#define RPG_GAMECORE_CHARACTERATLASFACEEMOTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19606590)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterAtlasFaceEmotion_TypeDefinitionIndex = 20671;
