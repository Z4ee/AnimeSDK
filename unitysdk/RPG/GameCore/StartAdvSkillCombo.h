...
#define RPG_GAMECORE_STARTADVSKILLCOMBO_METHOD_3_794CACD83B714FE6_OFFSET UNITYSDK_OFFSET(0x177730E0)
#define RPG_GAMECORE_STARTADVSKILLCOMBO_METHOD_3_B2356548373E69C7_OFFSET UNITYSDK_OFFSET(0x17773160)
#define RPG_GAMECORE_STARTADVSKILLCOMBO__CTOR_OFFSET UNITYSDK_OFFSET(0x17773130)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StartAdvSkillCombo_TypeDefinitionIndex = 18477;
