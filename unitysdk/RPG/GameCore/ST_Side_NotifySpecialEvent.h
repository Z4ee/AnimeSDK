...
#define RPG_GAMECORE_ST_SIDE_NOTIFYSPECIALEVENT_METHOD_4_652E3AA1137305A8_OFFSET UNITYSDK_OFFSET(0x1D4D2000)
#define RPG_GAMECORE_ST_SIDE_NOTIFYSPECIALEVENT_METHOD_4_753E6325C450FC19_OFFSET UNITYSDK_OFFSET(0x1D4D1FB0)
#define RPG_GAMECORE_ST_SIDE_NOTIFYSPECIALEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4D1FF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_NotifySpecialEvent_TypeDefinitionIndex = 19898;
