...
#define RPG_GAMECORE_SETSTEPPERDECISIONGROUPINDEX_METHOD_3_0A5A703EC0A0E311_OFFSET UNITYSDK_OFFSET(0x18E42FE0)
#define RPG_GAMECORE_SETSTEPPERDECISIONGROUPINDEX_METHOD_3_2B8661889E20143E_OFFSET UNITYSDK_OFFSET(0x18E43060)
#define RPG_GAMECORE_SETSTEPPERDECISIONGROUPINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0x18E43030)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetStepperDecisionGroupIndex_TypeDefinitionIndex = 21645;
