...
#define RPG_GAMECORE_CHANGEHEARTDIALMODELBYSCRIPT_METHOD_3_39ED1AE5A8E3D0E0_OFFSET UNITYSDK_OFFSET(0x17063160)
#define RPG_GAMECORE_CHANGEHEARTDIALMODELBYSCRIPT_METHOD_3_E1B9F66150C003F0_OFFSET UNITYSDK_OFFSET(0x170630E0)
#define RPG_GAMECORE_CHANGEHEARTDIALMODELBYSCRIPT__CTOR_OFFSET UNITYSDK_OFFSET(0x17063130)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChangeHeartDialModelByScript_TypeDefinitionIndex = 20067;
