...
#define RPG_GAMECORE_CHANGEHEARTDIALMODELBYSCRIPT_METHOD_3_39ED1AE5A8E3D0E0_OFFSET UNITYSDK_OFFSET(0x187C8050)
#define RPG_GAMECORE_CHANGEHEARTDIALMODELBYSCRIPT_METHOD_3_E1B9F66150C003F0_OFFSET UNITYSDK_OFFSET(0x187C7FD0)
#define RPG_GAMECORE_CHANGEHEARTDIALMODELBYSCRIPT__CTOR_OFFSET UNITYSDK_OFFSET(0x187C8020)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChangeHeartDialModelByScript_TypeDefinitionIndex = 20748;
