...
#define RPG_GAMECORE_CHECKRANDOMCHANCEAXIS_METHOD_3_5667720635ABA7B1_OFFSET UNITYSDK_OFFSET(0x1B72E6E0)
#define RPG_GAMECORE_CHECKRANDOMCHANCEAXIS_METHOD_3_E04EEB7C581FA874_OFFSET UNITYSDK_OFFSET(0x1B72E6A0)
#define RPG_GAMECORE_CHECKRANDOMCHANCEAXIS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B72E6D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CheckRandomChanceAxis_TypeDefinitionIndex = 14903;
