...
#define RPG_GAMECORE_CHECKRANDOMCHANCEAXIS_METHOD_3_5667720635ABA7B1_OFFSET UNITYSDK_OFFSET(0x187DB290)
#define RPG_GAMECORE_CHECKRANDOMCHANCEAXIS_METHOD_3_E04EEB7C581FA874_OFFSET UNITYSDK_OFFSET(0x187DB250)
#define RPG_GAMECORE_CHECKRANDOMCHANCEAXIS__CTOR_OFFSET UNITYSDK_OFFSET(0x187DB280)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CheckRandomChanceAxis_TypeDefinitionIndex = 14677;
