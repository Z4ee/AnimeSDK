...
#define RPG_GAMECORE_BYISSCEPTER_METHOD_4_48FB0D951DBBA72B_OFFSET UNITYSDK_OFFSET(0x17032920)
#define RPG_GAMECORE_BYISSCEPTER_METHOD_4_7DF62F7B791FC495_OFFSET UNITYSDK_OFFSET(0x17032850)
#define RPG_GAMECORE_BYISSCEPTER__CTOR_OFFSET UNITYSDK_OFFSET(0x170328D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsScepter_TypeDefinitionIndex = 21331;
