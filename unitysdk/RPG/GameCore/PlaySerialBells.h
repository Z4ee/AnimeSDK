...
#define RPG_GAMECORE_PLAYSERIALBELLS_METHOD_3_AD20929A8912B5BD_OFFSET UNITYSDK_OFFSET(0x1D34C5B0)
#define RPG_GAMECORE_PLAYSERIALBELLS_METHOD_3_B9DBB579ED6A2A20_OFFSET UNITYSDK_OFFSET(0x1D34C600)
#define RPG_GAMECORE_PLAYSERIALBELLS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D34C5F0)
