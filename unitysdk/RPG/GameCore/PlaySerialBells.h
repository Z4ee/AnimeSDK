...
#define RPG_GAMECORE_PLAYSERIALBELLS_METHOD_3_AD20929A8912B5BD_OFFSET UNITYSDK_OFFSET(0x1D7A8620)
#define RPG_GAMECORE_PLAYSERIALBELLS_METHOD_3_B9DBB579ED6A2A20_OFFSET UNITYSDK_OFFSET(0x1D7A8670)
#define RPG_GAMECORE_PLAYSERIALBELLS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7A8660)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlaySerialBells_TypeDefinitionIndex = 21947;
