...
#define RPG_GAMECORE_PLAYSERIALBELLS_METHOD_3_87FC6DE03DFF73EF_OFFSET UNITYSDK_OFFSET(0x19A29070)
#define RPG_GAMECORE_PLAYSERIALBELLS_METHOD_3_B9DBB579ED6A2A20_OFFSET UNITYSDK_OFFSET(0x19A29100)
#define RPG_GAMECORE_PLAYSERIALBELLS__CTOR_OFFSET UNITYSDK_OFFSET(0x19A290D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlaySerialBells_TypeDefinitionIndex = 20971;
