...
#define RPG_GAMECORE_PLAYSERIALBELLS_METHOD_3_87FC6DE03DFF73EF_OFFSET UNITYSDK_OFFSET(0x174C6AA0)
#define RPG_GAMECORE_PLAYSERIALBELLS_METHOD_3_B9DBB579ED6A2A20_OFFSET UNITYSDK_OFFSET(0x174C6B30)
#define RPG_GAMECORE_PLAYSERIALBELLS__CTOR_OFFSET UNITYSDK_OFFSET(0x174C6B00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlaySerialBells_TypeDefinitionIndex = 20382;
