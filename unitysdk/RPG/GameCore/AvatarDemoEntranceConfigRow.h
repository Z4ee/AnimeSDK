...
#define RPG_GAMECORE_AVATARDEMOENTRANCECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C587E40)
#define RPG_GAMECORE_AVATARDEMOENTRANCECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C588020)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AvatarDemoEntranceConfigRow_TypeDefinitionIndex = 12693;
