...
#define RPG_GAMECORE_TRAINEXTERIORCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C15BE60)
#define RPG_GAMECORE_TRAINEXTERIORCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C15C010)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainExteriorConfigRow_TypeDefinitionIndex = 13500;
