...
#define RPG_GAMECORE_FIVEDIMMINIONDESTROYBYPRESETNAMEACTION_METHOD_3_8F1C2279E980F027_OFFSET UNITYSDK_OFFSET(0x1890B7C0)
#define RPG_GAMECORE_FIVEDIMMINIONDESTROYBYPRESETNAMEACTION_METHOD_3_D7AAB4766D093776_OFFSET UNITYSDK_OFFSET(0x1890B750)
#define RPG_GAMECORE_FIVEDIMMINIONDESTROYBYPRESETNAMEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1890B7A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimMinionDestroyByPresetNameAction_TypeDefinitionIndex = 17808;
