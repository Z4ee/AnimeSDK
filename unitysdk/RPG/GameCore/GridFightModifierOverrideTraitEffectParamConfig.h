...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEROVERRIDETRAITEFFECTPARAMCONFIG_METHOD_3_608ECB725C1052F9_OFFSET UNITYSDK_OFFSET(0x189BE190)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEROVERRIDETRAITEFFECTPARAMCONFIG_METHOD_3_F687B9E92427E050_OFFSET UNITYSDK_OFFSET(0x189BE260)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEROVERRIDETRAITEFFECTPARAMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189BE210)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierOverrideTraitEffectParamConfig_TypeDefinitionIndex = 18483;
