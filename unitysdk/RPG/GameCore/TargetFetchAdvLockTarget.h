...
#define RPG_GAMECORE_TARGETFETCHADVLOCKTARGET_METHOD_4_3FDCF70080D9C1D3_OFFSET UNITYSDK_OFFSET(0x177BB000)
#define RPG_GAMECORE_TARGETFETCHADVLOCKTARGET_METHOD_4_C5DB0049B1146EC5_OFFSET UNITYSDK_OFFSET(0x177BAED0)
#define RPG_GAMECORE_TARGETFETCHADVLOCKTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x177BAFB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchAdvLockTarget_TypeDefinitionIndex = 22194;
