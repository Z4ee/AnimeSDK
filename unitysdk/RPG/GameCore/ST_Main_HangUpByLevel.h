...
#define RPG_GAMECORE_ST_MAIN_HANGUPBYLEVEL_METHOD_4_1356CE08F6769A59_OFFSET UNITYSDK_OFFSET(0x19C18CD0)
#define RPG_GAMECORE_ST_MAIN_HANGUPBYLEVEL_METHOD_4_20661BBB31F5B46E_OFFSET UNITYSDK_OFFSET(0x19C03470)
#define RPG_GAMECORE_ST_MAIN_HANGUPBYLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x19C03420)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_HangUpByLevel_TypeDefinitionIndex = 18989;
