...
#define RPG_GAMECORE_ST_MAIN_HANGUPBYLEVEL_METHOD_4_20661BBB31F5B46E_OFFSET UNITYSDK_OFFSET(0x1B7849D0)
#define RPG_GAMECORE_ST_MAIN_HANGUPBYLEVEL_METHOD_4_9A11966251DE0EEB_OFFSET UNITYSDK_OFFSET(0x1B784900)
#define RPG_GAMECORE_ST_MAIN_HANGUPBYLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7849C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_HangUpByLevel_TypeDefinitionIndex = 19340;
