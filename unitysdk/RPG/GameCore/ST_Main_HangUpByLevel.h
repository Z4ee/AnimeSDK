...
#define RPG_GAMECORE_ST_MAIN_HANGUPBYLEVEL_METHOD_4_1356CE08F6769A59_OFFSET UNITYSDK_OFFSET(0x18DF1E60)
#define RPG_GAMECORE_ST_MAIN_HANGUPBYLEVEL_METHOD_4_20661BBB31F5B46E_OFFSET UNITYSDK_OFFSET(0x18DF1FD0)
#define RPG_GAMECORE_ST_MAIN_HANGUPBYLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x18DF1F80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_HangUpByLevel_TypeDefinitionIndex = 19048;
