...
#define RPG_GAMECORE_BYISALLOWUSESKILL_METHOD_4_388104DA4DF32D40_OFFSET UNITYSDK_OFFSET(0x1A8D6120)
#define RPG_GAMECORE_BYISALLOWUSESKILL_METHOD_4_8F0B8B1B53A582ED_OFFSET UNITYSDK_OFFSET(0x1A8D60E0)
#define RPG_GAMECORE_BYISALLOWUSESKILL_METHOD_4_9FBC6103C29A7566_OFFSET UNITYSDK_OFFSET(0x1A8D62F0)
#define RPG_GAMECORE_BYISALLOWUSESKILL_METHOD_4_E3956E2209AAA590_OFFSET UNITYSDK_OFFSET(0x1A8D6320)
#define RPG_GAMECORE_BYISALLOWUSESKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8D6110)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsAllowUseSkill_TypeDefinitionIndex = 22227;
