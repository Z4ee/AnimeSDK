...
#define RPG_GAMECORE_STORYPROPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19CC4080)
#define RPG_GAMECORE_STORYPROPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19CC42A0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* StoryCharacterModelPath; // 0x20
