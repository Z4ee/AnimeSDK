...
#define RPG_GAMECORE_WAITROGUEADVENTUREROOMSTART_METHOD_3_30A7BA89A297BB1B_OFFSET UNITYSDK_OFFSET(0x19E5EF00)
#define RPG_GAMECORE_WAITROGUEADVENTUREROOMSTART_METHOD_3_D7D1CDAC3F6A846B_OFFSET UNITYSDK_OFFSET(0x19E5EF90)
#define RPG_GAMECORE_WAITROGUEADVENTUREROOMSTART__CTOR_OFFSET UNITYSDK_OFFSET(0x19E5EF60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitRogueAdventureRoomStart_TypeDefinitionIndex = 19667;
