...
#define RPG_GAMECORE_WAITROGUEADVENTUREROOMSTART_METHOD_3_854FCA268A881BC7_OFFSET UNITYSDK_OFFSET(0x1D6AAAF0)
#define RPG_GAMECORE_WAITROGUEADVENTUREROOMSTART_METHOD_3_D7D1CDAC3F6A846B_OFFSET UNITYSDK_OFFSET(0x1D6AAB40)
#define RPG_GAMECORE_WAITROGUEADVENTUREROOMSTART__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6AAB30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitRogueAdventureRoomStart_TypeDefinitionIndex = 20573;
