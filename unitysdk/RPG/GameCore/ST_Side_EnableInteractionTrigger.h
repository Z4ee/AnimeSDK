...
#define RPG_GAMECORE_ST_SIDE_ENABLEINTERACTIONTRIGGER_METHOD_4_1AD51B6D16981189_OFFSET UNITYSDK_OFFSET(0x19C08F70)
#define RPG_GAMECORE_ST_SIDE_ENABLEINTERACTIONTRIGGER_METHOD_4_32AE290085295DE6_OFFSET UNITYSDK_OFFSET(0x19C19F50)
#define RPG_GAMECORE_ST_SIDE_ENABLEINTERACTIONTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x19C08F20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_EnableInteractionTrigger_TypeDefinitionIndex = 19011;
