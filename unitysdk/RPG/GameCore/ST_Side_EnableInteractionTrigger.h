...
#define RPG_GAMECORE_ST_SIDE_ENABLEINTERACTIONTRIGGER_METHOD_4_1AD51B6D16981189_OFFSET UNITYSDK_OFFSET(0x1D4CFD80)
#define RPG_GAMECORE_ST_SIDE_ENABLEINTERACTIONTRIGGER_METHOD_4_FC1D5D37A3F5AC4C_OFFSET UNITYSDK_OFFSET(0x1D4CFCB0)
#define RPG_GAMECORE_ST_SIDE_ENABLEINTERACTIONTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4CFD70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_EnableInteractionTrigger_TypeDefinitionIndex = 19904;
