...
#define RPG_GAMECORE_ADDRESHAREACTPROP_METHOD_3_6FC47CF8DDBD1F9C_OFFSET UNITYSDK_OFFSET(0x1CDB5CB0)
#define RPG_GAMECORE_ADDRESHAREACTPROP_METHOD_3_74D7B50FA42428B4_OFFSET UNITYSDK_OFFSET(0x1CDB5D30)
#define RPG_GAMECORE_ADDRESHAREACTPROP__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDB5D00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddReShaReactProp_TypeDefinitionIndex = 21785;
