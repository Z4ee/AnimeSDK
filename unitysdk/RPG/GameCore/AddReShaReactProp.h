...
#define RPG_GAMECORE_ADDRESHAREACTPROP_METHOD_3_56ED75563FA6925A_OFFSET UNITYSDK_OFFSET(0x18642980)
#define RPG_GAMECORE_ADDRESHAREACTPROP_METHOD_3_74D7B50FA42428B4_OFFSET UNITYSDK_OFFSET(0x18642AD0)
#define RPG_GAMECORE_ADDRESHAREACTPROP__CTOR_OFFSET UNITYSDK_OFFSET(0x18642A40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddReShaReactProp_TypeDefinitionIndex = 20891;
