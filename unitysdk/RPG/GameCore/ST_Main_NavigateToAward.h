...
#define RPG_GAMECORE_ST_MAIN_NAVIGATETOAWARD_METHOD_4_6FBB206563BF146F_OFFSET UNITYSDK_OFFSET(0x19C04CE0)
#define RPG_GAMECORE_ST_MAIN_NAVIGATETOAWARD_METHOD_4_B019DA1D362CFE20_OFFSET UNITYSDK_OFFSET(0x19C191B0)
#define RPG_GAMECORE_ST_MAIN_NAVIGATETOAWARD__CTOR_OFFSET UNITYSDK_OFFSET(0x19C04C90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_NavigateToAward_TypeDefinitionIndex = 21211;
