...
#define RPG_GAMECORE_ST_MAIN_NAVIGATETOAWARD_METHOD_4_653768EACA90C2F2_OFFSET UNITYSDK_OFFSET(0x1D4CCE50)
#define RPG_GAMECORE_ST_MAIN_NAVIGATETOAWARD_METHOD_4_6FBB206563BF146F_OFFSET UNITYSDK_OFFSET(0x1D4CCF20)
#define RPG_GAMECORE_ST_MAIN_NAVIGATETOAWARD__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4CCF10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_NavigateToAward_TypeDefinitionIndex = 22189;
