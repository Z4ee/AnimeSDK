...
#define RPG_GAMECORE_ST_MAIN_NAVIGATETOAWARD_METHOD_4_6FBB206563BF146F_OFFSET UNITYSDK_OFFSET(0x17687B10)
#define RPG_GAMECORE_ST_MAIN_NAVIGATETOAWARD_METHOD_4_B019DA1D362CFE20_OFFSET UNITYSDK_OFFSET(0x17697FF0)
#define RPG_GAMECORE_ST_MAIN_NAVIGATETOAWARD__CTOR_OFFSET UNITYSDK_OFFSET(0x17687AC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_NavigateToAward_TypeDefinitionIndex = 20631;
