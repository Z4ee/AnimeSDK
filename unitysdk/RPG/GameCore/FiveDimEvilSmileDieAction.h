...
#define RPG_GAMECORE_FIVEDIMEVILSMILEDIEACTION_METHOD_3_365B0954266A1D37_OFFSET UNITYSDK_OFFSET(0x18900400)
#define RPG_GAMECORE_FIVEDIMEVILSMILEDIEACTION_METHOD_3_8585A33CA65CF3AE_OFFSET UNITYSDK_OFFSET(0x188F53B0)
#define RPG_GAMECORE_FIVEDIMEVILSMILEDIEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x188F5390)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimEvilSmileDieAction_TypeDefinitionIndex = 17850;
