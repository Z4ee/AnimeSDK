...
#define RPG_GAMECORE_ACTIVEFARMELEMENT_METHOD_3_AA833D47D59F3828_OFFSET UNITYSDK_OFFSET(0x1C9EB550)
#define RPG_GAMECORE_ACTIVEFARMELEMENT_METHOD_3_EC2FB3E09C6480A5_OFFSET UNITYSDK_OFFSET(0x1C9EB620)
#define RPG_GAMECORE_ACTIVEFARMELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9EB610)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActiveFarmElement_TypeDefinitionIndex = 21838;
