...
#define RPG_GAMECORE_LOCATIONCONFIG_METHOD_2_09290BFB0D83795C_OFFSET UNITYSDK_OFFSET(0x1DD76B50)
#define RPG_GAMECORE_LOCATIONCONFIG_METHOD_2_BAE9EAF11BB67243_OFFSET UNITYSDK_OFFSET(0x1DD76520)
#define RPG_GAMECORE_LOCATIONCONFIG_METHOD_2_FB4BE762B6186C23_OFFSET UNITYSDK_OFFSET(0x1DD76B80)
#define RPG_GAMECORE_LOCATIONCONFIG_SHAREBYCOPY_OFFSET UNITYSDK_OFFSET(0x1DD76BA0)
#define RPG_GAMECORE_LOCATIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD76B40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LocationConfig_TypeDefinitionIndex = 16323;
