...
#define RPG_GAMECORE_LOCATIONCONFIG_METHOD_2_09290BFB0D83795C_OFFSET UNITYSDK_OFFSET(0x1BCCD940)
#define RPG_GAMECORE_LOCATIONCONFIG_METHOD_2_BAE9EAF11BB67243_OFFSET UNITYSDK_OFFSET(0x1BCCD310)
#define RPG_GAMECORE_LOCATIONCONFIG_METHOD_2_FB4BE762B6186C23_OFFSET UNITYSDK_OFFSET(0x1BCCD970)
#define RPG_GAMECORE_LOCATIONCONFIG_SHAREBYCOPY_OFFSET UNITYSDK_OFFSET(0x1BCCD990)
#define RPG_GAMECORE_LOCATIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCCD930)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LocationConfig_TypeDefinitionIndex = 15847;
