...
#define RPG_GAMECORE_LOCATIONCONFIG_METHOD_2_09290BFB0D83795C_OFFSET UNITYSDK_OFFSET(0x173693F0)
#define RPG_GAMECORE_LOCATIONCONFIG_METHOD_2_BAE9EAF11BB67243_OFFSET UNITYSDK_OFFSET(0x17368DC0)
#define RPG_GAMECORE_LOCATIONCONFIG_METHOD_2_FB4BE762B6186C23_OFFSET UNITYSDK_OFFSET(0x17369420)
#define RPG_GAMECORE_LOCATIONCONFIG_SHAREBYCOPY_OFFSET UNITYSDK_OFFSET(0x17369440)
#define RPG_GAMECORE_LOCATIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x173693E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LocationConfig_TypeDefinitionIndex = 15107;
