...
#define RPG_GAMECORE_SETROGUEROOMFINISH_METHOD_3_22B98FB137F517F5_OFFSET UNITYSDK_OFFSET(0x176DD300)
#define RPG_GAMECORE_SETROGUEROOMFINISH_METHOD_3_622C41F78873E3E5_OFFSET UNITYSDK_OFFSET(0x176DD270)
#define RPG_GAMECORE_SETROGUEROOMFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x176DD2D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetRogueRoomFinish_TypeDefinitionIndex = 18781;
