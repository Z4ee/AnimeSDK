...
#define RPG_GAMECORE_TRAINPARTYPERFORMANCEFREESTYLEACTION_METHOD_2_27F05C87CC57DE23_OFFSET UNITYSDK_OFFSET(0x1C163690)
#define RPG_GAMECORE_TRAINPARTYPERFORMANCEFREESTYLEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1637E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyPerformanceFreeStyleAction_TypeDefinitionIndex = 15620;
