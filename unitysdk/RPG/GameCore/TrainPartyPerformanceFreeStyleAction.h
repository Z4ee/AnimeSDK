...
#define RPG_GAMECORE_TRAINPARTYPERFORMANCEFREESTYLEACTION_METHOD_2_27F05C87CC57DE23_OFFSET UNITYSDK_OFFSET(0x178AEF50)
#define RPG_GAMECORE_TRAINPARTYPERFORMANCEFREESTYLEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x178AF0A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyPerformanceFreeStyleAction_TypeDefinitionIndex = 14879;
