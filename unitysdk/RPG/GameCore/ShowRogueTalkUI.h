...
#define RPG_GAMECORE_SHOWROGUETALKUI_METHOD_3_D37E85741D112402_OFFSET UNITYSDK_OFFSET(0x19C82430)
#define RPG_GAMECORE_SHOWROGUETALKUI_METHOD_3_E25A704C5663A56B_OFFSET UNITYSDK_OFFSET(0x19C824B0)
#define RPG_GAMECORE_SHOWROGUETALKUI__CTOR_OFFSET UNITYSDK_OFFSET(0x19C82480)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowRogueTalkUI_TypeDefinitionIndex = 19943;
