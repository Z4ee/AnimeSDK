...
#define RPG_GAMECORE_SHOWROGUETALKUI_METHOD_3_04C7DAE10001F6D8_OFFSET UNITYSDK_OFFSET(0x1BE46130)
#define RPG_GAMECORE_SHOWROGUETALKUI_METHOD_3_E25A704C5663A56B_OFFSET UNITYSDK_OFFSET(0x1BE46170)
#define RPG_GAMECORE_SHOWROGUETALKUI__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE46160)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowRogueTalkUI_TypeDefinitionIndex = 20314;
