...
#define RPG_GAMECORE_PAUSEGAMEMODETOSTATE_METHOD_3_468243AECDEE60D9_OFFSET UNITYSDK_OFFSET(0x1D4188F0)
#define RPG_GAMECORE_PAUSEGAMEMODETOSTATE_METHOD_3_837CB796B3077A16_OFFSET UNITYSDK_OFFSET(0x1D4188B0)
#define RPG_GAMECORE_PAUSEGAMEMODETOSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4188E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PauseGameModeToState_TypeDefinitionIndex = 23160;
