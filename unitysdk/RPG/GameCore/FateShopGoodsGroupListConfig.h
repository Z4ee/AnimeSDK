...
#define RPG_GAMECORE_FATESHOPGOODSGROUPLISTCONFIG_METHOD_2_D97E7242013F049D_OFFSET UNITYSDK_OFFSET(0x1D090E80)
#define RPG_GAMECORE_FATESHOPGOODSGROUPLISTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D090EC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateShopGoodsGroupListConfig_TypeDefinitionIndex = 19032;
