...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERCLEARPRAYQUESTCONFIG_METHOD_3_0CA1A90903399673_OFFSET UNITYSDK_OFFSET(0x1D1589C0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERCLEARPRAYQUESTCONFIG_METHOD_3_C312A52EB9C3A4AF_OFFSET UNITYSDK_OFFSET(0x1D158970)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERCLEARPRAYQUESTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1589B0)
