...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERCLEARPRAYQUESTCONFIG_METHOD_3_0CA1A90903399673_OFFSET UNITYSDK_OFFSET(0x1C5D0850)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERCLEARPRAYQUESTCONFIG_METHOD_3_C312A52EB9C3A4AF_OFFSET UNITYSDK_OFFSET(0x1C5D0800)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERCLEARPRAYQUESTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5D0840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierClearPrayQuestConfig_TypeDefinitionIndex = 18741;
