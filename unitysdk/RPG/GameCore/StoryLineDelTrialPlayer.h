...
#define RPG_GAMECORE_STORYLINEDELTRIALPLAYER_METHOD_3_76C9E15816939AB6_OFFSET UNITYSDK_OFFSET(0x18EA5F50)
#define RPG_GAMECORE_STORYLINEDELTRIALPLAYER_METHOD_3_8AD7516548FB60B6_OFFSET UNITYSDK_OFFSET(0x18EA5FE0)
#define RPG_GAMECORE_STORYLINEDELTRIALPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x18EA5FB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StoryLineDelTrialPlayer_TypeDefinitionIndex = 20517;
