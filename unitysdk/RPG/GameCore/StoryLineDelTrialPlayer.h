...
#define RPG_GAMECORE_STORYLINEDELTRIALPLAYER_METHOD_3_76C9E15816939AB6_OFFSET UNITYSDK_OFFSET(0x17780170)
#define RPG_GAMECORE_STORYLINEDELTRIALPLAYER_METHOD_3_8AD7516548FB60B6_OFFSET UNITYSDK_OFFSET(0x17780200)
#define RPG_GAMECORE_STORYLINEDELTRIALPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x177801D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StoryLineDelTrialPlayer_TypeDefinitionIndex = 19836;
