...
#define RPG_GAMECORE_ROGUECANDYCRASHCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19B182F0)
#define RPG_GAMECORE_ROGUECANDYCRASHCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19B189B0)
