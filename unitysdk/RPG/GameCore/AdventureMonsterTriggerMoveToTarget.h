...
#define RPG_GAMECORE_ADVENTUREMONSTERTRIGGERMOVETOTARGET_METHOD_3_16151E6F8F395145_OFFSET UNITYSDK_OFFSET(0x186791B0)
#define RPG_GAMECORE_ADVENTUREMONSTERTRIGGERMOVETOTARGET_METHOD_3_AB4771B3D5306720_OFFSET UNITYSDK_OFFSET(0x18679230)
#define RPG_GAMECORE_ADVENTUREMONSTERTRIGGERMOVETOTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x18679200)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureMonsterTriggerMoveToTarget_TypeDefinitionIndex = 19125;
