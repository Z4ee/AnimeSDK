...
#define RPG_GAMECORE_LITTLEGAMEABILITYEFFECTCLEARSHIELDCONFIG_METHOD_3_C0C8F44850259D92_OFFSET UNITYSDK_OFFSET(0x19892F70)
#define RPG_GAMECORE_LITTLEGAMEABILITYEFFECTCLEARSHIELDCONFIG_METHOD_3_C9DBAC3577B6D126_OFFSET UNITYSDK_OFFSET(0x19892E90)
#define RPG_GAMECORE_LITTLEGAMEABILITYEFFECTCLEARSHIELDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19892F60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityEffectClearShieldConfig_TypeDefinitionIndex = 20175;
