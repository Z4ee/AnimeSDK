...
#define RPG_GAMECORE_REMOVELEVELAREAS_METHOD_3_005A3981F5C18742_OFFSET UNITYSDK_OFFSET(0x1D39F4A0)
#define RPG_GAMECORE_REMOVELEVELAREAS_METHOD_3_F07511D251EDEB39_OFFSET UNITYSDK_OFFSET(0x1D39F460)
#define RPG_GAMECORE_REMOVELEVELAREAS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D39F490)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveLevelAreas_TypeDefinitionIndex = 20509;
