...
#define RPG_GAMECORE_REMOVELEVELAREAS_METHOD_3_005A3981F5C18742_OFFSET UNITYSDK_OFFSET(0x17598820)
#define RPG_GAMECORE_REMOVELEVELAREAS_METHOD_3_9777AB04C2479B6B_OFFSET UNITYSDK_OFFSET(0x175987A0)
#define RPG_GAMECORE_REMOVELEVELAREAS__CTOR_OFFSET UNITYSDK_OFFSET(0x175987F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveLevelAreas_TypeDefinitionIndex = 19068;
