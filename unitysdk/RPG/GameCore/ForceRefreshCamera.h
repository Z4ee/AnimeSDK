...
#define RPG_GAMECORE_FORCEREFRESHCAMERA_METHOD_3_6B3017EF27EE23DE_OFFSET UNITYSDK_OFFSET(0x19764BF0)
#define RPG_GAMECORE_FORCEREFRESHCAMERA_METHOD_3_9CEC289970EF73D2_OFFSET UNITYSDK_OFFSET(0x19764AE0)
#define RPG_GAMECORE_FORCEREFRESHCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x19764BC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ForceRefreshCamera_TypeDefinitionIndex = 19678;
