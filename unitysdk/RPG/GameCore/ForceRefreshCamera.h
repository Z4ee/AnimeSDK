...
#define RPG_GAMECORE_FORCEREFRESHCAMERA_METHOD_3_4BEC53BBE4ACAEDB_OFFSET UNITYSDK_OFFSET(0x1BEBF890)
#define RPG_GAMECORE_FORCEREFRESHCAMERA_METHOD_3_6B3017EF27EE23DE_OFFSET UNITYSDK_OFFSET(0x1BEBF960)
#define RPG_GAMECORE_FORCEREFRESHCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEBF950)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ForceRefreshCamera_TypeDefinitionIndex = 20037;
