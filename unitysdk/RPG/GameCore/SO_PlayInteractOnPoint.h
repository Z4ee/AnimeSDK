...
#define RPG_GAMECORE_SO_PLAYINTERACTONPOINT_METHOD_4_94DDEB05A6232D54_OFFSET UNITYSDK_OFFSET(0x1767C910)
#define RPG_GAMECORE_SO_PLAYINTERACTONPOINT_METHOD_4_B8DFF11F99D7C9E2_OFFSET UNITYSDK_OFFSET(0x1767D2E0)
#define RPG_GAMECORE_SO_PLAYINTERACTONPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1767C8E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SO_PlayInteractOnPoint_TypeDefinitionIndex = 18340;
