...
#define RPG_GAMECORE_SO_PLAYINTERACTONPOINT_METHOD_4_94DDEB05A6232D54_OFFSET UNITYSDK_OFFSET(0x18DE02F0)
#define RPG_GAMECORE_SO_PLAYINTERACTONPOINT_METHOD_4_B8DFF11F99D7C9E2_OFFSET UNITYSDK_OFFSET(0x18DE0CC0)
#define RPG_GAMECORE_SO_PLAYINTERACTONPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x18DE02C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SO_PlayInteractOnPoint_TypeDefinitionIndex = 18987;
