...
#define RPG_GAMECORE_ACTIVITYEVOLVEBUILDGEARROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1AAE7E70)
#define RPG_GAMECORE_ACTIVITYEVOLVEBUILDGEARROW_GETMAXLEVEL_OFFSET UNITYSDK_OFFSET(0x1AAE8C60)
#define RPG_GAMECORE_ACTIVITYEVOLVEBUILDGEARROW_GETMAZEBUFF_OFFSET UNITYSDK_OFFSET(0x1AAE8C20)
#define RPG_GAMECORE_ACTIVITYEVOLVEBUILDGEARROW_ISMATERIALOFFORGE_OFFSET UNITYSDK_OFFSET(0x1AAE8CD0)
#define RPG_GAMECORE_ACTIVITYEVOLVEBUILDGEARROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAE8C10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityEvolveBuildGearRow_TypeDefinitionIndex = 11009;

	class ActivityEvolveBuildGearRow : public ::System::Object
	{
	public:
		::Il2CppArray<::System::UInt32>* SimpIndexList; // 0x10
		::Il2CppArray<::System::UInt32>* DynamicIndexList; // 0x18
