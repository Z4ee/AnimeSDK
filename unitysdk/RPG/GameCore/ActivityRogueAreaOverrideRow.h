...
#define RPG_GAMECORE_ACTIVITYROGUEAREAOVERRIDEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18635880)
#define RPG_GAMECORE_ACTIVITYROGUEAREAOVERRIDEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18635A90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityRogueAreaOverrideRow_TypeDefinitionIndex = 11667;
