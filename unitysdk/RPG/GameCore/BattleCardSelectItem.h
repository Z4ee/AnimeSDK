...
#define RPG_GAMECORE_BATTLECARDSELECTITEM_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A3E3B10)
#define RPG_GAMECORE_BATTLECARDSELECTITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3E3CB0)
