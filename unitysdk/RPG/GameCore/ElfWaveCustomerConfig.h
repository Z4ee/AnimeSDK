...
#define RPG_GAMECORE_ELFWAVECUSTOMERCONFIG_METHOD_2_730091410F0D9438_OFFSET UNITYSDK_OFFSET(0x1D05D460)
#define RPG_GAMECORE_ELFWAVECUSTOMERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D05D680)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfWaveCustomerConfig_TypeDefinitionIndex = 18261;
