...
#define RPG_GAMECORE_RTLEVELDIMENSIONINFO_METHOD_2_7159EDB58142B4CA_OFFSET UNITYSDK_OFFSET(0x1D4AAD40)
#define RPG_GAMECORE_RTLEVELDIMENSIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4AB2B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtLevelDimensionInfo_TypeDefinitionIndex = 17153;
