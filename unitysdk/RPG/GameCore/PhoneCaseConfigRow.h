...
#define RPG_GAMECORE_PHONECASECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D3267D0)
#define RPG_GAMECORE_PHONECASECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D326A30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhoneCaseConfigRow_TypeDefinitionIndex = 14286;
	...
	public:
		...
		::System::String* ItemFigurePath; // 0x28
