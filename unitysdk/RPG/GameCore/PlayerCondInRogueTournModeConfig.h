...
#define RPG_GAMECORE_PLAYERCONDINROGUETOURNMODECONFIG_METHOD_5_1B16DDD60321B4E4_OFFSET UNITYSDK_OFFSET(0x18C25900)
#define RPG_GAMECORE_PLAYERCONDINROGUETOURNMODECONFIG_METHOD_5_CCD0614B8A57A560_OFFSET UNITYSDK_OFFSET(0x18C24D90)
#define RPG_GAMECORE_PLAYERCONDINROGUETOURNMODECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18C24CD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayerCondInRogueTournModeConfig_TypeDefinitionIndex = 18567;
