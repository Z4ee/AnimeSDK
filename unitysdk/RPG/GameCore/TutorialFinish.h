...
#define RPG_GAMECORE_TUTORIALFINISH_METHOD_3_98E426301EBE3040_OFFSET UNITYSDK_OFFSET(0x190D6CC0)
#define RPG_GAMECORE_TUTORIALFINISH_METHOD_3_BF72193C4C640A49_OFFSET UNITYSDK_OFFSET(0x190D6D40)
#define RPG_GAMECORE_TUTORIALFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x190D6D10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TutorialFinish_TypeDefinitionIndex = 23370;
