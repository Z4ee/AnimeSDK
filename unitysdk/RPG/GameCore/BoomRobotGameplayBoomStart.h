...
#define RPG_GAMECORE_BOOMROBOTGAMEPLAYBOOMSTART_METHOD_3_95B7E39B63788349_OFFSET UNITYSDK_OFFSET(0x18712F10)
#define RPG_GAMECORE_BOOMROBOTGAMEPLAYBOOMSTART_METHOD_3_FCE773B6BD0251D5_OFFSET UNITYSDK_OFFSET(0x18712E00)
#define RPG_GAMECORE_BOOMROBOTGAMEPLAYBOOMSTART__CTOR_OFFSET UNITYSDK_OFFSET(0x18712EE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BoomRobotGameplayBoomStart_TypeDefinitionIndex = 19167;
