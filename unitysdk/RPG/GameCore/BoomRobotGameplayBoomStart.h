...
#define RPG_GAMECORE_BOOMROBOTGAMEPLAYBOOMSTART_METHOD_3_00F8ADDBB7D2D60C_OFFSET UNITYSDK_OFFSET(0x1C2E4D90)
#define RPG_GAMECORE_BOOMROBOTGAMEPLAYBOOMSTART_METHOD_3_95B7E39B63788349_OFFSET UNITYSDK_OFFSET(0x1C2E4E60)
#define RPG_GAMECORE_BOOMROBOTGAMEPLAYBOOMSTART__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2E4E50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BoomRobotGameplayBoomStart_TypeDefinitionIndex = 19992;
