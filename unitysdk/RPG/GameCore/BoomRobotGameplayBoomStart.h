...
#define RPG_GAMECORE_BOOMROBOTGAMEPLAYBOOMSTART_METHOD_3_95B7E39B63788349_OFFSET UNITYSDK_OFFSET(0x194E5A70)
#define RPG_GAMECORE_BOOMROBOTGAMEPLAYBOOMSTART_METHOD_3_FCE773B6BD0251D5_OFFSET UNITYSDK_OFFSET(0x194E5960)
#define RPG_GAMECORE_BOOMROBOTGAMEPLAYBOOMSTART__CTOR_OFFSET UNITYSDK_OFFSET(0x194E5A40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BoomRobotGameplayBoomStart_TypeDefinitionIndex = 19094;
