...
#define RPG_GAMECORE_LEVELPROPSTATECONFIG_METHOD_2_F9BE9BACFD0978C4_OFFSET UNITYSDK_OFFSET(0x1C12FF80)
#define RPG_GAMECORE_LEVELPROPSTATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1300C0)
