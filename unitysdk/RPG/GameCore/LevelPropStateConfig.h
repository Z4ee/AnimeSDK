...
#define RPG_GAMECORE_LEVELPROPSTATECONFIG_METHOD_2_F9BE9BACFD0978C4_OFFSET UNITYSDK_OFFSET(0x1D1EC9E0)
#define RPG_GAMECORE_LEVELPROPSTATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1ECB20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPropStateConfig_TypeDefinitionIndex = 17063;
