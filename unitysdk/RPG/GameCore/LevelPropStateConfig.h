...
#define RPG_GAMECORE_LEVELPROPSTATECONFIG_METHOD_2_F9BE9BACFD0978C4_OFFSET UNITYSDK_OFFSET(0x1B0877B0)
#define RPG_GAMECORE_LEVELPROPSTATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0878F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPropStateConfig_TypeDefinitionIndex = 16571;
