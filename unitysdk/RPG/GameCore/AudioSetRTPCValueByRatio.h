...
#define RPG_GAMECORE_AUDIOSETRTPCVALUEBYRATIO_METHOD_3_1CBB9A472362FA2B_OFFSET UNITYSDK_OFFSET(0x1A06CD20)
#define RPG_GAMECORE_AUDIOSETRTPCVALUEBYRATIO_METHOD_3_44530D94017052A7_OFFSET UNITYSDK_OFFSET(0x1A06CBA0)
#define RPG_GAMECORE_AUDIOSETRTPCVALUEBYRATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x1A06CC70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AudioSetRTPCValueByRatio_TypeDefinitionIndex = 19829;
