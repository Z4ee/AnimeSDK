...
#define RPG_GAMECORE_AUDIOSETRTPCVALUEBYRATIO_METHOD_3_1CBB9A472362FA2B_OFFSET UNITYSDK_OFFSET(0x16F91C30)
#define RPG_GAMECORE_AUDIOSETRTPCVALUEBYRATIO_METHOD_3_44530D94017052A7_OFFSET UNITYSDK_OFFSET(0x16F91A80)
#define RPG_GAMECORE_AUDIOSETRTPCVALUEBYRATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x16F91B70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AudioSetRTPCValueByRatio_TypeDefinitionIndex = 18924;
