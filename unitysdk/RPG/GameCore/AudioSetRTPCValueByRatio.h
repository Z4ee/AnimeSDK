...
#define RPG_GAMECORE_AUDIOSETRTPCVALUEBYRATIO_METHOD_3_1CBB9A472362FA2B_OFFSET UNITYSDK_OFFSET(0x1C5821C0)
#define RPG_GAMECORE_AUDIOSETRTPCVALUEBYRATIO_METHOD_3_44530D94017052A7_OFFSET UNITYSDK_OFFSET(0x1C582040)
#define RPG_GAMECORE_AUDIOSETRTPCVALUEBYRATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x1C582110)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AudioSetRTPCValueByRatio_TypeDefinitionIndex = 20375;
