...
#define RPG_GAMECORE_AUDIOSETRTPCVALUEBYRATIO_METHOD_3_1CBB9A472362FA2B_OFFSET UNITYSDK_OFFSET(0x186B4E40)
#define RPG_GAMECORE_AUDIOSETRTPCVALUEBYRATIO_METHOD_3_44530D94017052A7_OFFSET UNITYSDK_OFFSET(0x186B4C90)
#define RPG_GAMECORE_AUDIOSETRTPCVALUEBYRATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x186B4D80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AudioSetRTPCValueByRatio_TypeDefinitionIndex = 19582;
