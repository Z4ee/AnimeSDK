...
#define RPG_GAMECORE_FATECONDMASTERBATTLERESULTCONFIG_METHOD_6_9EB863487628D17D_OFFSET UNITYSDK_OFFSET(0x171C4AB0)
#define RPG_GAMECORE_FATECONDMASTERBATTLERESULTCONFIG_METHOD_6_F2A693CBE938F069_OFFSET UNITYSDK_OFFSET(0x171C48F0)
#define RPG_GAMECORE_FATECONDMASTERBATTLERESULTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171C49F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateCondMasterBattleResultConfig_TypeDefinitionIndex = 17677;
