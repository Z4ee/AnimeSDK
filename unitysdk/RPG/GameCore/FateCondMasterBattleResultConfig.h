...
#define RPG_GAMECORE_FATECONDMASTERBATTLERESULTCONFIG_METHOD_6_9EB863487628D17D_OFFSET UNITYSDK_OFFSET(0x1970F1D0)
#define RPG_GAMECORE_FATECONDMASTERBATTLERESULTCONFIG_METHOD_6_F2A693CBE938F069_OFFSET UNITYSDK_OFFSET(0x1970F010)
#define RPG_GAMECORE_FATECONDMASTERBATTLERESULTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1970F110)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateCondMasterBattleResultConfig_TypeDefinitionIndex = 18263;
