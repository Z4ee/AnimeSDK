...
#define RPG_GAMECORE_FATECONDMASTERBATTLERESULTCONFIG_METHOD_6_83A16BD3A7E75639_OFFSET UNITYSDK_OFFSET(0x1C074590)
#define RPG_GAMECORE_FATECONDMASTERBATTLERESULTCONFIG_METHOD_6_9EB863487628D17D_OFFSET UNITYSDK_OFFSET(0x1C0745E0)
#define RPG_GAMECORE_FATECONDMASTERBATTLERESULTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0745D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateCondMasterBattleResultConfig_TypeDefinitionIndex = 18497;
