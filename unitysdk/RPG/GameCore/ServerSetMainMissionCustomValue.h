...
#define RPG_GAMECORE_SERVERSETMAINMISSIONCUSTOMVALUE_METHOD_3_EC7B25E10AE7F8E9_OFFSET UNITYSDK_OFFSET(0x18E069B0)
#define RPG_GAMECORE_SERVERSETMAINMISSIONCUSTOMVALUE_METHOD_3_F30B6F70E3F074F9_OFFSET UNITYSDK_OFFSET(0x18E06A40)
#define RPG_GAMECORE_SERVERSETMAINMISSIONCUSTOMVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E06A10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ServerSetMainMissionCustomValue_TypeDefinitionIndex = 19394;
