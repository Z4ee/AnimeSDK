...
#define RPG_GAMECORE_SERVERSETMAINMISSIONCUSTOMVALUE_METHOD_3_84F613EA3D60AEF5_OFFSET UNITYSDK_OFFSET(0x1C2CF9F0)
#define RPG_GAMECORE_SERVERSETMAINMISSIONCUSTOMVALUE_METHOD_3_F30B6F70E3F074F9_OFFSET UNITYSDK_OFFSET(0x1C2CFA40)
#define RPG_GAMECORE_SERVERSETMAINMISSIONCUSTOMVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2CFA30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ServerSetMainMissionCustomValue_TypeDefinitionIndex = 19656;
