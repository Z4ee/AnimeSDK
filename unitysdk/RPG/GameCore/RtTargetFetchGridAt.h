...
#define RPG_GAMECORE_RTTARGETFETCHGRIDAT_METHOD_4_4A847605CF9EC49F_OFFSET UNITYSDK_OFFSET(0x1CCEFE30)
#define RPG_GAMECORE_RTTARGETFETCHGRIDAT_METHOD_4_BAAEFDEADA629EED_OFFSET UNITYSDK_OFFSET(0x1CCEFFE0)
#define RPG_GAMECORE_RTTARGETFETCHGRIDAT_METHOD_4_BAF1EC6006D7054B_OFFSET UNITYSDK_OFFSET(0x1CCF0010)
#define RPG_GAMECORE_RTTARGETFETCHGRIDAT_METHOD_4_F8B69ACDB642CA14_OFFSET UNITYSDK_OFFSET(0x1CCEFE70)
#define RPG_GAMECORE_RTTARGETFETCHGRIDAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CCEFE60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtTargetFetchGridAt_TypeDefinitionIndex = 23964;
