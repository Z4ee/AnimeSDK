...
#define RPG_GAMECORE_DAMAGEBYATTACKPROPERTY_METHOD_3_09A6BDFE6690377F_OFFSET UNITYSDK_OFFSET(0x1BC453A0)
#define RPG_GAMECORE_DAMAGEBYATTACKPROPERTY_METHOD_3_A274B2D3440BBB56_OFFSET UNITYSDK_OFFSET(0x1BC45650)
#define RPG_GAMECORE_DAMAGEBYATTACKPROPERTY_SHAREBYCOPY_OFFSET UNITYSDK_OFFSET(0x1BC46190)
#define RPG_GAMECORE_DAMAGEBYATTACKPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC455E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DamageByAttackProperty_TypeDefinitionIndex = 21778;
	...
	public:
		...
		static ::System::Void Method_3_09A6BDFE6690377F(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::DamageByAttackProperty*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::DamageByAttackProperty*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_DAMAGEBYATTACKPROPERTY_METHOD_3_09A6BDFE6690377F_OFFSET))(a1, a2);
		}
