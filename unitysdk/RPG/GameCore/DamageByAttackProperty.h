...
#define RPG_GAMECORE_DAMAGEBYATTACKPROPERTY_METHOD_3_26CD3EED7D0FB26D_OFFSET UNITYSDK_OFFSET(0x17147220)
#define RPG_GAMECORE_DAMAGEBYATTACKPROPERTY_METHOD_3_8A32FD65A5CB3972_OFFSET UNITYSDK_OFFSET(0x171470F0)
#define RPG_GAMECORE_DAMAGEBYATTACKPROPERTY_SHAREBYCOPY_OFFSET UNITYSDK_OFFSET(0x17147D60)
#define RPG_GAMECORE_DAMAGEBYATTACKPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x171471A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DamageByAttackProperty_TypeDefinitionIndex = 20777;
