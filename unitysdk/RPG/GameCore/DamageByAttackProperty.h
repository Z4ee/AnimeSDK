...
#define RPG_GAMECORE_DAMAGEBYATTACKPROPERTY_METHOD_3_09A6BDFE6690377F_OFFSET UNITYSDK_OFFSET(0x1D80A6E0)
#define RPG_GAMECORE_DAMAGEBYATTACKPROPERTY_METHOD_3_A274B2D3440BBB56_OFFSET UNITYSDK_OFFSET(0x1D80A990)
#define RPG_GAMECORE_DAMAGEBYATTACKPROPERTY_SHAREBYCOPY_OFFSET UNITYSDK_OFFSET(0x1D80B4D0)
#define RPG_GAMECORE_DAMAGEBYATTACKPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D80A920)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DamageByAttackProperty_TypeDefinitionIndex = 22342;
