...
#define RPG_GAMECORE_FATEMODIFIERMODIFYHOUGUSELECTTYPECONFIG_METHOD_3_441CAACCC248722B_OFFSET UNITYSDK_OFFSET(0x188D6450)
#define RPG_GAMECORE_FATEMODIFIERMODIFYHOUGUSELECTTYPECONFIG_METHOD_3_86AC3068BD267F22_OFFSET UNITYSDK_OFFSET(0x188D5410)
#define RPG_GAMECORE_FATEMODIFIERMODIFYHOUGUSELECTTYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x188D53C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateModifierModifyHouguSelectTypeConfig_TypeDefinitionIndex = 18306;
