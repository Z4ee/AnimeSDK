...
#define RPG_GAMECORE_ADDFINISHMISSIONDATA_PLAYMESSAGE_METHOD_3_84026B789BBA3098_OFFSET UNITYSDK_OFFSET(0x16F1C380)
#define RPG_GAMECORE_ADDFINISHMISSIONDATA_PLAYMESSAGE_METHOD_3_E97C66D182D31FA1_OFFSET UNITYSDK_OFFSET(0x16F1C400)
#define RPG_GAMECORE_ADDFINISHMISSIONDATA_PLAYMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F1C3D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddFinishMissionData_PlayMessage_TypeDefinitionIndex = 20109;
