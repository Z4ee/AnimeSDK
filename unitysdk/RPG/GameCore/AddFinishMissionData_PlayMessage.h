...
#define RPG_GAMECORE_ADDFINISHMISSIONDATA_PLAYMESSAGE_METHOD_3_5A4C4E50C2530300_OFFSET UNITYSDK_OFFSET(0x1BE05A10)
#define RPG_GAMECORE_ADDFINISHMISSIONDATA_PLAYMESSAGE_METHOD_3_E97C66D182D31FA1_OFFSET UNITYSDK_OFFSET(0x1BE05A60)
#define RPG_GAMECORE_ADDFINISHMISSIONDATA_PLAYMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE05A50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddFinishMissionData_PlayMessage_TypeDefinitionIndex = 21131;
