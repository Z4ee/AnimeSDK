...
#define RPG_GAMECORE_ADDFINISHMISSIONDATA_PLAYMESSAGE_METHOD_3_84026B789BBA3098_OFFSET UNITYSDK_OFFSET(0x1863E470)
#define RPG_GAMECORE_ADDFINISHMISSIONDATA_PLAYMESSAGE_METHOD_3_E97C66D182D31FA1_OFFSET UNITYSDK_OFFSET(0x1863E4F0)
#define RPG_GAMECORE_ADDFINISHMISSIONDATA_PLAYMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1863E4C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddFinishMissionData_PlayMessage_TypeDefinitionIndex = 20791;
