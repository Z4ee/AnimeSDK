...
#define RPG_GAMECORE_SETFIVEDIMIGNORECOLLISIONTARGET_METHOD_3_17147E63935AFABB_OFFSET UNITYSDK_OFFSET(0x18E30D70)
#define RPG_GAMECORE_SETFIVEDIMIGNORECOLLISIONTARGET_METHOD_3_4F9BB3B39E2BB528_OFFSET UNITYSDK_OFFSET(0x18E30CF0)
#define RPG_GAMECORE_SETFIVEDIMIGNORECOLLISIONTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x18E30D40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetFiveDimIgnoreCollisionTarget_TypeDefinitionIndex = 20254;
