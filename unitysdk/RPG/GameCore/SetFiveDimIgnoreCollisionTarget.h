...
#define RPG_GAMECORE_SETFIVEDIMIGNORECOLLISIONTARGET_METHOD_3_17147E63935AFABB_OFFSET UNITYSDK_OFFSET(0x19C4DB70)
#define RPG_GAMECORE_SETFIVEDIMIGNORECOLLISIONTARGET_METHOD_3_4F9BB3B39E2BB528_OFFSET UNITYSDK_OFFSET(0x19C4DAF0)
#define RPG_GAMECORE_SETFIVEDIMIGNORECOLLISIONTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x19C4DB40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetFiveDimIgnoreCollisionTarget_TypeDefinitionIndex = 20111;
