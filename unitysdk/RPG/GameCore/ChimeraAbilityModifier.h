...
#define RPG_GAMECORE_CHIMERAABILITYMODIFIER_METHOD_2_94595847773890A9_OFFSET UNITYSDK_OFFSET(0x1C38D890)
#define RPG_GAMECORE_CHIMERAABILITYMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C38DA70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraAbilityModifier_TypeDefinitionIndex = 15233;
