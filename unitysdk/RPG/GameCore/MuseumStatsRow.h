...
#define RPG_GAMECORE_MUSEUMSTATSROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x199C0130)
#define RPG_GAMECORE_MUSEUMSTATSROW__CTOR_OFFSET UNITYSDK_OFFSET(0x199C0810)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MuseumStatsRow_TypeDefinitionIndex = 13550;

	class MuseumStatsRow : public ::System::Object
	{
	public:
		::System::UInt32 FundCost; // 0x10
		::System::UInt32 StatsType; // 0x14
