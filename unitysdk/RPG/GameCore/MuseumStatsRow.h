...
#define RPG_GAMECORE_MUSEUMSTATSROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B1DC240)
#define RPG_GAMECORE_MUSEUMSTATSROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1DC910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MuseumStatsRow_TypeDefinitionIndex = 13698;
	...
	public:
		...
		::System::UInt32 StatsType; // 0x1C
		::System::UInt32 FundCost; // 0x20
		::System::UInt32 StatsValue; // 0x24
