...
#define RPG_GAMECORE_SOMATOWIDTHRANGECONFIG_METHOD_2_FF09348F965C465E_OFFSET UNITYSDK_OFFSET(0x18E74160)
#define RPG_GAMECORE_SOMATOWIDTHRANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18E742C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SomatoWidthRangeConfig_TypeDefinitionIndex = 16205;
