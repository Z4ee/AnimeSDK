...
#define RPG_GAMECORE_SOMATOWIDTHRANGECONFIG_METHOD_2_FF09348F965C465E_OFFSET UNITYSDK_OFFSET(0x1D53C4B0)
#define RPG_GAMECORE_SOMATOWIDTHRANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D53C610)
