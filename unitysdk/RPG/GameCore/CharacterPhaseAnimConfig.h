...
#define RPG_GAMECORE_CHARACTERPHASEANIMCONFIG_METHOD_3_92F5A7CD50844694_OFFSET UNITYSDK_OFFSET(0x17067310)
#define RPG_GAMECORE_CHARACTERPHASEANIMCONFIG_METHOD_3_9E7E826336CD6D31_OFFSET UNITYSDK_OFFSET(0x1706FD50)
#define RPG_GAMECORE_CHARACTERPHASEANIMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1706FD40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterPhaseAnimConfig_TypeDefinitionIndex = 16698;
