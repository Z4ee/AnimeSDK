...
#define RPG_GAMECORE_ST_SIDE_DETECTAWARD_METHOD_4_3217F7A0904A3FB5_OFFSET UNITYSDK_OFFSET(0x1B788110)
#define RPG_GAMECORE_ST_SIDE_DETECTAWARD_METHOD_4_A4BD0DAED2E634DE_OFFSET UNITYSDK_OFFSET(0x1B788050)
#define RPG_GAMECORE_ST_SIDE_DETECTAWARD__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7880C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_DetectAward_TypeDefinitionIndex = 19349;
