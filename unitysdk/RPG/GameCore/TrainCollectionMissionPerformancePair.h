...
#define RPG_GAMECORE_TRAINCOLLECTIONMISSIONPERFORMANCEPAIR_METHOD_2_7901BC0643A20B24_OFFSET UNITYSDK_OFFSET(0x19DEF900)
#define RPG_GAMECORE_TRAINCOLLECTIONMISSIONPERFORMANCEPAIR__CTOR_OFFSET UNITYSDK_OFFSET(0x19DEFA70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainCollectionMissionPerformancePair_TypeDefinitionIndex = 19886;
