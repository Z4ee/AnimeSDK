...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEROVERRIDETRAITBONUSPERFECTCLEARRATIOCONFIG_METHOD_3_ADCF87A91C2E2E00_OFFSET UNITYSDK_OFFSET(0x189BE180)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEROVERRIDETRAITBONUSPERFECTCLEARRATIOCONFIG_METHOD_3_BC10D9D4669B9669_OFFSET UNITYSDK_OFFSET(0x189BE0B0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEROVERRIDETRAITBONUSPERFECTCLEARRATIOCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189BE130)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierOverrideTraitBonusPerfectClearRatioConfig_TypeDefinitionIndex = 18481;
