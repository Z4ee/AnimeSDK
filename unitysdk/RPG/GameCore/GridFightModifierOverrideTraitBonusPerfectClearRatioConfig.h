...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEROVERRIDETRAITBONUSPERFECTCLEARRATIOCONFIG_METHOD_3_81B88EFF1FA8A144_OFFSET UNITYSDK_OFFSET(0x1EE6E660)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEROVERRIDETRAITBONUSPERFECTCLEARRATIOCONFIG_METHOD_3_ADCF87A91C2E2E00_OFFSET UNITYSDK_OFFSET(0x1EE6E6B0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEROVERRIDETRAITBONUSPERFECTCLEARRATIOCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EE6E6A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierOverrideTraitBonusPerfectClearRatioConfig_TypeDefinitionIndex = 19226;
