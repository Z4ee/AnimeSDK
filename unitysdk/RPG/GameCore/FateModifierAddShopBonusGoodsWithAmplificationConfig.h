...
#define RPG_GAMECORE_FATEMODIFIERADDSHOPBONUSGOODSWITHAMPLIFICATIONCONFIG_METHOD_3_9D918FC6622A7D00_OFFSET UNITYSDK_OFFSET(0x197100F0)
#define RPG_GAMECORE_FATEMODIFIERADDSHOPBONUSGOODSWITHAMPLIFICATIONCONFIG_METHOD_3_ABD2E1F1AC97E569_OFFSET UNITYSDK_OFFSET(0x19710020)
#define RPG_GAMECORE_FATEMODIFIERADDSHOPBONUSGOODSWITHAMPLIFICATIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197100A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateModifierAddShopBonusGoodsWithAmplificationConfig_TypeDefinitionIndex = 18276;
