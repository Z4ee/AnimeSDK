...
#define RPG_GAMECORE_STORYLINECREATETRIALPLAYER_METHOD_3_1D866A846F51461B_OFFSET UNITYSDK_OFFSET(0x1B0C8210)
#define RPG_GAMECORE_STORYLINECREATETRIALPLAYER_METHOD_3_A3124B730DF858B7_OFFSET UNITYSDK_OFFSET(0x1B0C81C0)
#define RPG_GAMECORE_STORYLINECREATETRIALPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0C8200)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StoryLineCreateTrialPlayer_TypeDefinitionIndex = 20869;
