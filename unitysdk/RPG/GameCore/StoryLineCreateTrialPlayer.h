...
#define RPG_GAMECORE_STORYLINECREATETRIALPLAYER_METHOD_3_1D866A846F51461B_OFFSET UNITYSDK_OFFSET(0x19CC2D30)
#define RPG_GAMECORE_STORYLINECREATETRIALPLAYER_METHOD_3_6532661B981E2D4B_OFFSET UNITYSDK_OFFSET(0x19CC2CA0)
#define RPG_GAMECORE_STORYLINECREATETRIALPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x19CC2D00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StoryLineCreateTrialPlayer_TypeDefinitionIndex = 20454;
