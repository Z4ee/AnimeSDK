...
#define RPG_GAMECORE_LOGSAMPLERPARAMDEFINE_METHOD_2_84D35F3508CE728D_OFFSET UNITYSDK_OFFSET(0x1D212E20)
#define RPG_GAMECORE_LOGSAMPLERPARAMDEFINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D212FA0)
