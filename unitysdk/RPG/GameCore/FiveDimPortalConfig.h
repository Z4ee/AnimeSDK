...
#define RPG_GAMECORE_FIVEDIMPORTALCONFIG_METHOD_3_26DA67182310A593_OFFSET UNITYSDK_OFFSET(0x17203440)
#define RPG_GAMECORE_FIVEDIMPORTALCONFIG_METHOD_3_7805D4966358A752_OFFSET UNITYSDK_OFFSET(0x172033D0)
#define RPG_GAMECORE_FIVEDIMPORTALCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17203420)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimPortalConfig_TypeDefinitionIndex = 17032;
	...
	public:
		...
		static ::System::Void Method_3_26DA67182310A593(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::FiveDimPortalConfig* a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::FiveDimPortalConfig*))((::PBYTE)hIl2Cpp + RPG_GAMECORE_FIVEDIMPORTALCONFIG_METHOD_3_26DA67182310A593_OFFSET))(a1, a2);
		}
	};
}
