...
#define RPG_GAMECORE_FIVEDIMSURFACEPOINT_METHOD_2_3F7FD23A4D2C5AF4_OFFSET UNITYSDK_OFFSET(0x1DCA72B0)
#define RPG_GAMECORE_FIVEDIMSURFACEPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCA7E70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSurfacePoint_TypeDefinitionIndex = 16546;
