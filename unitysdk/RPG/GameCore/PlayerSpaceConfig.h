...
#define RPG_GAMECORE_PLAYERSPACECONFIG_METHOD_2_901B6599D95E06FD_OFFSET UNITYSDK_OFFSET(0x18C35F30)
#define RPG_GAMECORE_PLAYERSPACECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18C36260)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayerSpaceConfig_TypeDefinitionIndex = 15516;
