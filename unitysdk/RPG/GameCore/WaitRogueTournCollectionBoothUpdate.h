...
#define RPG_GAMECORE_WAITROGUETOURNCOLLECTIONBOOTHUPDATE_METHOD_4_062E9B2EE0CFA8BC_OFFSET UNITYSDK_OFFSET(0x179034E0)
#define RPG_GAMECORE_WAITROGUETOURNCOLLECTIONBOOTHUPDATE_METHOD_4_FDDF2901365F4CCA_OFFSET UNITYSDK_OFFSET(0x17903400)
#define RPG_GAMECORE_WAITROGUETOURNCOLLECTIONBOOTHUPDATE__CTOR_OFFSET UNITYSDK_OFFSET(0x17903480)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitRogueTournCollectionBoothUpdate_TypeDefinitionIndex = 20293;
