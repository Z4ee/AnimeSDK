...
#define RPG_GAMECORE_LEVELPEDESTRIANV2ROADPOINTINFO_METHOD_2_A542E1C2451810A1_OFFSET UNITYSDK_OFFSET(0x1D1EABB0)
#define RPG_GAMECORE_LEVELPEDESTRIANV2ROADPOINTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1EAD60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPedestrianV2RoadPointInfo_TypeDefinitionIndex = 17094;
