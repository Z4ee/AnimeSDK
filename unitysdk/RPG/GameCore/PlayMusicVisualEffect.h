...
#define RPG_GAMECORE_PLAYMUSICVISUALEFFECT_METHOD_3_6CA89E29A255CA66_OFFSET UNITYSDK_OFFSET(0x174C3850)
#define RPG_GAMECORE_PLAYMUSICVISUALEFFECT_METHOD_3_B9304EAB23A1A936_OFFSET UNITYSDK_OFFSET(0x174C39A0)
#define RPG_GAMECORE_PLAYMUSICVISUALEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x174C3910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayMusicVisualEffect_TypeDefinitionIndex = 20506;
