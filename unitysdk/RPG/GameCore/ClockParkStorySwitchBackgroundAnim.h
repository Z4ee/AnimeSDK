...
#define RPG_GAMECORE_CLOCKPARKSTORYSWITCHBACKGROUNDANIM_METHOD_3_2DEBA61B6FB32E5E_OFFSET UNITYSDK_OFFSET(0x18821130)
#define RPG_GAMECORE_CLOCKPARKSTORYSWITCHBACKGROUNDANIM_METHOD_3_33DF889EA063DBFF_OFFSET UNITYSDK_OFFSET(0x188210B0)
#define RPG_GAMECORE_CLOCKPARKSTORYSWITCHBACKGROUNDANIM__CTOR_OFFSET UNITYSDK_OFFSET(0x18821100)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClockParkStorySwitchBackgroundAnim_TypeDefinitionIndex = 19938;
