...
#define RPG_GAMECORE_CLOCKPARKSTORYSWITCHBACKGROUNDANIM_METHOD_3_2DEBA61B6FB32E5E_OFFSET UNITYSDK_OFFSET(0x170C1A10)
#define RPG_GAMECORE_CLOCKPARKSTORYSWITCHBACKGROUNDANIM_METHOD_3_33DF889EA063DBFF_OFFSET UNITYSDK_OFFSET(0x170C1990)
#define RPG_GAMECORE_CLOCKPARKSTORYSWITCHBACKGROUNDANIM__CTOR_OFFSET UNITYSDK_OFFSET(0x170C19E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClockParkStorySwitchBackgroundAnim_TypeDefinitionIndex = 19279;
