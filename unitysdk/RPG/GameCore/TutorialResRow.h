...
#define RPG_GAMECORE_TUTORIALRESROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D6195E0)
#define RPG_GAMECORE_TUTORIALRESROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D61A090)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::System::String* KeyMapPath; // 0x10
		::System::String* PrefabPath; // 0x18
		::System::String* ContentPath; // 0x20
		::System::String* TextPath; // 0x28
