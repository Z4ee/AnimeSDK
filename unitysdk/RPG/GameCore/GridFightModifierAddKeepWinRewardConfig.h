...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDKEEPWINREWARDCONFIG_METHOD_3_7DF3944BA54285E9_OFFSET UNITYSDK_OFFSET(0x1C5CFD90)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDKEEPWINREWARDCONFIG_METHOD_3_876315A61C8BFD6D_OFFSET UNITYSDK_OFFSET(0x1C5CFDE0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDKEEPWINREWARDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5CFDD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierAddKeepWinRewardConfig_TypeDefinitionIndex = 18618;
