...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDKEEPWINREWARDCONFIG_METHOD_3_876315A61C8BFD6D_OFFSET UNITYSDK_OFFSET(0x189B0B90)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDKEEPWINREWARDCONFIG_METHOD_3_EE60B7A6E07CE374_OFFSET UNITYSDK_OFFSET(0x189B0AC0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDKEEPWINREWARDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189B0B40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierAddKeepWinRewardConfig_TypeDefinitionIndex = 18401;
