...
#define RPG_GAMECORE_LOOPWAITHEARTDIALSCRIPTSTEPCHANGE_METHOD_3_77157DDB21FA1341_OFFSET UNITYSDK_OFFSET(0x1BCD4A50)
#define RPG_GAMECORE_LOOPWAITHEARTDIALSCRIPTSTEPCHANGE_METHOD_3_A2D2CECEB1A92FA5_OFFSET UNITYSDK_OFFSET(0x1BCD4AA0)
#define RPG_GAMECORE_LOOPWAITHEARTDIALSCRIPTSTEPCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCD4A90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoopWaitHeartDialScriptStepChange_TypeDefinitionIndex = 20422;
