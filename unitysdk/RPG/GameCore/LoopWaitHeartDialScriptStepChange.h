...
#define RPG_GAMECORE_LOOPWAITHEARTDIALSCRIPTSTEPCHANGE_METHOD_3_A2D2CECEB1A92FA5_OFFSET UNITYSDK_OFFSET(0x17370E70)
#define RPG_GAMECORE_LOOPWAITHEARTDIALSCRIPTSTEPCHANGE_METHOD_3_FCF9030C7CB7DF55_OFFSET UNITYSDK_OFFSET(0x17370DE0)
#define RPG_GAMECORE_LOOPWAITHEARTDIALSCRIPTSTEPCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x17370E40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoopWaitHeartDialScriptStepChange_TypeDefinitionIndex = 19518;
