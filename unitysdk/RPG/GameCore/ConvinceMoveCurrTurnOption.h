...
#define RPG_GAMECORE_CONVINCEMOVECURRTURNOPTION_METHOD_3_7338ED8115883021_OFFSET UNITYSDK_OFFSET(0x1BC361A0)
#define RPG_GAMECORE_CONVINCEMOVECURRTURNOPTION_METHOD_3_D270753D1DAC46A4_OFFSET UNITYSDK_OFFSET(0x1BC360D0)
#define RPG_GAMECORE_CONVINCEMOVECURRTURNOPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC36190)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConvinceMoveCurrTurnOption_TypeDefinitionIndex = 21035;
