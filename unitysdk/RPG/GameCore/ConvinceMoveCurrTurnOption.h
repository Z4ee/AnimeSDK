...
#define RPG_GAMECORE_CONVINCEMOVECURRTURNOPTION_METHOD_3_7338ED8115883021_OFFSET UNITYSDK_OFFSET(0x1883E350)
#define RPG_GAMECORE_CONVINCEMOVECURRTURNOPTION_METHOD_3_7DCFA8B5C897A72D_OFFSET UNITYSDK_OFFSET(0x1883E240)
#define RPG_GAMECORE_CONVINCEMOVECURRTURNOPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1883E320)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConvinceMoveCurrTurnOption_TypeDefinitionIndex = 20690;
