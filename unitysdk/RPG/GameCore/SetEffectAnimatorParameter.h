...
#define RPG_GAMECORE_SETEFFECTANIMATORPARAMETER_METHOD_3_09511807A5DE0381_OFFSET UNITYSDK_OFFSET(0x18E2C600)
#define RPG_GAMECORE_SETEFFECTANIMATORPARAMETER_METHOD_3_BEABCCAB6C676C92_OFFSET UNITYSDK_OFFSET(0x18E2C7B0)
#define RPG_GAMECORE_SETEFFECTANIMATORPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x18E2C6F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetEffectAnimatorParameter_TypeDefinitionIndex = 22733;
