...
#define RPG_GAMECORE_LITTLEGAMEABILITYEFFECTAPPLYSHIELDCONFIG_METHOD_3_0BAE61C70F3D951B_OFFSET UNITYSDK_OFFSET(0x1B092880)
#define RPG_GAMECORE_LITTLEGAMEABILITYEFFECTAPPLYSHIELDCONFIG_METHOD_3_4DE77ED668C62427_OFFSET UNITYSDK_OFFSET(0x1B0927B0)
#define RPG_GAMECORE_LITTLEGAMEABILITYEFFECTAPPLYSHIELDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B092870)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityEffectApplyShieldConfig_TypeDefinitionIndex = 20542;
