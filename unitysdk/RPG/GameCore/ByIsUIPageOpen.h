...
#define RPG_GAMECORE_BYISUIPAGEOPEN_METHOD_4_0DA78A0525669028_OFFSET UNITYSDK_OFFSET(0x1875A850)
#define RPG_GAMECORE_BYISUIPAGEOPEN_METHOD_4_CE1271FCC7E96386_OFFSET UNITYSDK_OFFSET(0x1875A780)
#define RPG_GAMECORE_BYISUIPAGEOPEN__CTOR_OFFSET UNITYSDK_OFFSET(0x1875A800)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsUIPageOpen_TypeDefinitionIndex = 21119;
