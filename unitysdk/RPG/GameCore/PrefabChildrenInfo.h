...
#define RPG_GAMECORE_PREFABCHILDRENINFO_METHOD_2_9F0F78723A458023_OFFSET UNITYSDK_OFFSET(0x18C600C0)
#define RPG_GAMECORE_PREFABCHILDRENINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18C60190)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PrefabChildrenInfo_TypeDefinitionIndex = 18109;
