...
#define RPG_GAMECORE_TRIGGERSTANCECOUNTDOWN_METHOD_3_041D4D513B190AE6_OFFSET UNITYSDK_OFFSET(0x19E1EDB0)
#define RPG_GAMECORE_TRIGGERSTANCECOUNTDOWN_METHOD_3_EED7840A49DB6C25_OFFSET UNITYSDK_OFFSET(0x19E1EE40)
#define RPG_GAMECORE_TRIGGERSTANCECOUNTDOWN__CTOR_OFFSET UNITYSDK_OFFSET(0x19E1EE10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerStanceCountDown_TypeDefinitionIndex = 21478;
