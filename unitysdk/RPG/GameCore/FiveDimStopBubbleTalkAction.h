...
#define RPG_GAMECORE_FIVEDIMSTOPBUBBLETALKACTION_METHOD_3_74B97D3336460AC3_OFFSET UNITYSDK_OFFSET(0x19759E70)
#define RPG_GAMECORE_FIVEDIMSTOPBUBBLETALKACTION_METHOD_3_897FB4F89661C262_OFFSET UNITYSDK_OFFSET(0x19759F30)
#define RPG_GAMECORE_FIVEDIMSTOPBUBBLETALKACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19759F10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimStopBubbleTalkAction_TypeDefinitionIndex = 17866;
