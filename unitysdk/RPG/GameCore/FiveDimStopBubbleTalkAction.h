...
#define RPG_GAMECORE_FIVEDIMSTOPBUBBLETALKACTION_METHOD_3_74B97D3336460AC3_OFFSET UNITYSDK_OFFSET(0x1720E430)
#define RPG_GAMECORE_FIVEDIMSTOPBUBBLETALKACTION_METHOD_3_897FB4F89661C262_OFFSET UNITYSDK_OFFSET(0x1720E4F0)
#define RPG_GAMECORE_FIVEDIMSTOPBUBBLETALKACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1720E4D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimStopBubbleTalkAction_TypeDefinitionIndex = 17234;
