...
#define RPG_GAMECORE_EVENTMUSEUMITEMCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D7CED40)
#define RPG_GAMECORE_EVENTMUSEUMITEMCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7CF4A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EventMuseumItemConfigRow_TypeDefinitionIndex = 14128;
	...
	public:
		...
		::System::UInt32 MuseumItemID; // 0x28
		::System::Boolean IsTargetReward; // 0x2C
		::System::Boolean ForceComplete; // 0x2D
