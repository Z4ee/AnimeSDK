...
#define RPG_GAMECORE_CAKERACEBASETARGETSELECTORCONFIG_METHOD_2_C82B0AC5042AABA9_OFFSET UNITYSDK_OFFSET(0x195E9CF0)
#define RPG_GAMECORE_CAKERACEBASETARGETSELECTORCONFIG_METHOD_2_D0A8FD6A4FC3367B_OFFSET UNITYSDK_OFFSET(0x195E40F0)
#define RPG_GAMECORE_CAKERACEBASETARGETSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x195E9CE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceBaseTargetSelectorConfig_TypeDefinitionIndex = 17478;
