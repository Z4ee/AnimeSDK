...
#define RPG_GAMECORE_CAKERACEBASETARGETSELECTORCONFIG_METHOD_2_C82B0AC5042AABA9_OFFSET UNITYSDK_OFFSET(0x170482C0)
#define RPG_GAMECORE_CAKERACEBASETARGETSELECTORCONFIG_METHOD_2_F2D127B12514FC7E_OFFSET UNITYSDK_OFFSET(0x17041D40)
#define RPG_GAMECORE_CAKERACEBASETARGETSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x170482B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceBaseTargetSelectorConfig_TypeDefinitionIndex = 16882;
