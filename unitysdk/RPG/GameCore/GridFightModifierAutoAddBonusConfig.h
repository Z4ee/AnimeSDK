...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERAUTOADDBONUSCONFIG_METHOD_3_11D74EE7FD80C9A2_OFFSET UNITYSDK_OFFSET(0x197E97B0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERAUTOADDBONUSCONFIG_METHOD_3_F4B95313880375BB_OFFSET UNITYSDK_OFFSET(0x197E9880)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERAUTOADDBONUSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197E9830)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierAutoAddBonusConfig_TypeDefinitionIndex = 18394;
