...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERAUTOADDBONUSCONFIG_METHOD_3_504B150D3CB730D7_OFFSET UNITYSDK_OFFSET(0x1C5D04B0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERAUTOADDBONUSCONFIG_METHOD_3_F4B95313880375BB_OFFSET UNITYSDK_OFFSET(0x1C5D0500)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERAUTOADDBONUSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5D04F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierAutoAddBonusConfig_TypeDefinitionIndex = 18639;
