...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERAUTOADDBONUSCONFIG_METHOD_3_11D74EE7FD80C9A2_OFFSET UNITYSDK_OFFSET(0x189B1B60)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERAUTOADDBONUSCONFIG_METHOD_3_F4B95313880375BB_OFFSET UNITYSDK_OFFSET(0x189B1C30)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERAUTOADDBONUSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189B1BE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierAutoAddBonusConfig_TypeDefinitionIndex = 18422;
