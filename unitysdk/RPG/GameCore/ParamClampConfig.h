...
#define RPG_GAMECORE_PARAMCLAMPCONFIG_METHOD_4_1805F7E419C041B6_OFFSET UNITYSDK_OFFSET(0x17488880)
#define RPG_GAMECORE_PARAMCLAMPCONFIG_METHOD_4_3956DD3B8FC1BA5D_OFFSET UNITYSDK_OFFSET(0x174889C0)
#define RPG_GAMECORE_PARAMCLAMPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17488940)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ParamClampConfig_TypeDefinitionIndex = 15657;
