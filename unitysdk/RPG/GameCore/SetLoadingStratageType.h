...
#define RPG_GAMECORE_SETLOADINGSTRATAGETYPE_METHOD_3_0E16831AC1DE9E45_OFFSET UNITYSDK_OFFSET(0x176D3800)
#define RPG_GAMECORE_SETLOADINGSTRATAGETYPE_METHOD_3_1A8E79B7C454BBEE_OFFSET UNITYSDK_OFFSET(0x176D3780)
#define RPG_GAMECORE_SETLOADINGSTRATAGETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x176D37D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetLoadingStratageType_TypeDefinitionIndex = 19730;
