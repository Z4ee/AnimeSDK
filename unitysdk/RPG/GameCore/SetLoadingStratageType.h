...
#define RPG_GAMECORE_SETLOADINGSTRATAGETYPE_METHOD_3_0E16831AC1DE9E45_OFFSET UNITYSDK_OFFSET(0x1E083ED0)
#define RPG_GAMECORE_SETLOADINGSTRATAGETYPE_METHOD_3_D4C8EC5A8B2ED5C4_OFFSET UNITYSDK_OFFSET(0x1E083E90)
#define RPG_GAMECORE_SETLOADINGSTRATAGETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E083EC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetLoadingStratageType_TypeDefinitionIndex = 21327;
