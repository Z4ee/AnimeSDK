...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYWORKBENCHFUNCTIONCONFIG_METHOD_3_34638FF6294E5673_OFFSET UNITYSDK_OFFSET(0x1D164CB0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYWORKBENCHFUNCTIONCONFIG_METHOD_3_EAD48C1BDFD864AF_OFFSET UNITYSDK_OFFSET(0x1D164C60)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYWORKBENCHFUNCTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D164CA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyWorkbenchFunctionConfig_TypeDefinitionIndex = 17158;
