...
#define RPG_GAMECORE_CHENLINGBATTLEINITPOSITIONEVALUATOR_ALL_METHOD_3_0E8DFDDB02A8F8EF_OFFSET UNITYSDK_OFFSET(0x1707F3D0)
#define RPG_GAMECORE_CHENLINGBATTLEINITPOSITIONEVALUATOR_ALL_METHOD_3_AA84CF7CF03D37FE_OFFSET UNITYSDK_OFFSET(0x1707F470)
#define RPG_GAMECORE_CHENLINGBATTLEINITPOSITIONEVALUATOR_ALL__CTOR_OFFSET UNITYSDK_OFFSET(0x1707F460)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleInitPositionEvaluator_All_TypeDefinitionIndex = 14449;
