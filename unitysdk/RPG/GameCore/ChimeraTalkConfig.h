...
#define RPG_GAMECORE_CHIMERATALKCONFIG_METHOD_2_4337A68CA6352481_OFFSET UNITYSDK_OFFSET(0x1E32BEF0)
#define RPG_GAMECORE_CHIMERATALKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1E340AF0)
