...
#define RPG_GAMECORE_ADVGAMEPLAYTRACKNPCINIT_METHOD_3_AACB64638028164E_OFFSET UNITYSDK_OFFSET(0x18652BF0)
#define RPG_GAMECORE_ADVGAMEPLAYTRACKNPCINIT_METHOD_3_F1DF49FDD660D182_OFFSET UNITYSDK_OFFSET(0x18652AE0)
#define RPG_GAMECORE_ADVGAMEPLAYTRACKNPCINIT__CTOR_OFFSET UNITYSDK_OFFSET(0x18652BC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvGameplayTrackNpcInit_TypeDefinitionIndex = 21054;
