...
#define RPG_GAMECORE_ADVGAMEPLAYTRACKNPCINIT_METHOD_3_AACB64638028164E_OFFSET UNITYSDK_OFFSET(0x1BE1E790)
#define RPG_GAMECORE_ADVGAMEPLAYTRACKNPCINIT_METHOD_3_F048BD78F3D9864B_OFFSET UNITYSDK_OFFSET(0x1BE1E6C0)
#define RPG_GAMECORE_ADVGAMEPLAYTRACKNPCINIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE1E780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvGameplayTrackNpcInit_TypeDefinitionIndex = 21377;
