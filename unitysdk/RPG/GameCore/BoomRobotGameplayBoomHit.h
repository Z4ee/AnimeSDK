...
#define RPG_GAMECORE_BOOMROBOTGAMEPLAYBOOMHIT_METHOD_3_7DF6FC33655D377C_OFFSET UNITYSDK_OFFSET(0x16FEEDE0)
#define RPG_GAMECORE_BOOMROBOTGAMEPLAYBOOMHIT_METHOD_3_B2A9A63FEC310748_OFFSET UNITYSDK_OFFSET(0x16FEEEF0)
#define RPG_GAMECORE_BOOMROBOTGAMEPLAYBOOMHIT__CTOR_OFFSET UNITYSDK_OFFSET(0x16FEEEC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BoomRobotGameplayBoomHit_TypeDefinitionIndex = 19974;
