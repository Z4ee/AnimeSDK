...
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_UNLOCK_TRAIT_METHOD_4_C4F77A001B33C11D_OFFSET UNITYSDK_OFFSET(0x19C1A750)
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_UNLOCK_TRAIT_METHOD_4_F7EF4B3DAFD18CB7_OFFSET UNITYSDK_OFFSET(0x19C0AE50)
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_UNLOCK_TRAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x19C0AE00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_Hipplen_Unlock_Trait_TypeDefinitionIndex = 20136;
