...
#define RPG_GAMECORE_CHENLINGSOLDIERLEVELROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1962FBD0)
#define RPG_GAMECORE_CHENLINGSOLDIERLEVELROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1962FE50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingSoldierLevelRow_TypeDefinitionIndex = 10616;

	class ChenLingSoldierLevelRow : public ::System::Object
	{
	public:
		::Il2CppArray<::System::UInt32>* UnitIDList; // 0x10
		::System::UInt32 FormationType; // 0x18
