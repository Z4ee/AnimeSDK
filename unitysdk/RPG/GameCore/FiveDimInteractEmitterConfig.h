...
#define RPG_GAMECORE_FIVEDIMINTERACTEMITTERCONFIG_METHOD_3_ABCC8DEFAB2AFCF2_OFFSET UNITYSDK_OFFSET(0x18906D90)
#define RPG_GAMECORE_FIVEDIMINTERACTEMITTERCONFIG_METHOD_3_DF539A0ABF2224D0_OFFSET UNITYSDK_OFFSET(0x18906D20)
#define RPG_GAMECORE_FIVEDIMINTERACTEMITTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18906D70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimInteractEmitterConfig_TypeDefinitionIndex = 17627;
