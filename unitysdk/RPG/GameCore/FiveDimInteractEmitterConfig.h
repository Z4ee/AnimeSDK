...
#define RPG_GAMECORE_FIVEDIMINTERACTEMITTERCONFIG_METHOD_3_ABCC8DEFAB2AFCF2_OFFSET UNITYSDK_OFFSET(0x171F7480)
#define RPG_GAMECORE_FIVEDIMINTERACTEMITTERCONFIG_METHOD_3_DF539A0ABF2224D0_OFFSET UNITYSDK_OFFSET(0x171F7410)
#define RPG_GAMECORE_FIVEDIMINTERACTEMITTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171F7460)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimInteractEmitterConfig_TypeDefinitionIndex = 17033;
