...
#define RPG_GAMECORE_FIVEDIMINTERACTEMITTERCONFIG_METHOD_3_835CDE1AFB35447F_OFFSET UNITYSDK_OFFSET(0x1D0ECA50)
#define RPG_GAMECORE_FIVEDIMINTERACTEMITTERCONFIG_METHOD_3_E381C3F34DA8966C_OFFSET UNITYSDK_OFFSET(0x1D0ECA90)
#define RPG_GAMECORE_FIVEDIMINTERACTEMITTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0ECA80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimInteractEmitterConfig_TypeDefinitionIndex = 18346;
