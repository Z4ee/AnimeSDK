...
#define RPG_GAMECORE_PSTROPHYGROUPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D40FA10)
#define RPG_GAMECORE_PSTROPHYGROUPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D40FB90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PSTrophyGroupRow_TypeDefinitionIndex = 12977;
