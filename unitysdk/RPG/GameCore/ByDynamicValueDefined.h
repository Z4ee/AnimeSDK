...
#define RPG_GAMECORE_BYDYNAMICVALUEDEFINED_METHOD_4_339D44C92E73E34F_OFFSET UNITYSDK_OFFSET(0x1CF189D0)
#define RPG_GAMECORE_BYDYNAMICVALUEDEFINED_METHOD_4_8B0A6747C8E65176_OFFSET UNITYSDK_OFFSET(0x1CF18BE0)
#define RPG_GAMECORE_BYDYNAMICVALUEDEFINED_METHOD_4_C3F1A8B9E2BC6238_OFFSET UNITYSDK_OFFSET(0x1CF18BB0)
#define RPG_GAMECORE_BYDYNAMICVALUEDEFINED_METHOD_4_F386CA00352A972E_OFFSET UNITYSDK_OFFSET(0x1CF18A10)
#define RPG_GAMECORE_BYDYNAMICVALUEDEFINED__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF18A00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByDynamicValueDefined_TypeDefinitionIndex = 22644;
