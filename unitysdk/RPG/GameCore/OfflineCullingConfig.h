...
#define RPG_GAMECORE_OFFLINECULLINGCONFIG_METHOD_2_5D0750B987017478_OFFSET UNITYSDK_OFFSET(0x1D2FBB20)
#define RPG_GAMECORE_OFFLINECULLINGCONFIG_METHOD_2_8151046A97A29664_OFFSET UNITYSDK_OFFSET(0x1D2FBCF0)
#define RPG_GAMECORE_OFFLINECULLINGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2FBCE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OfflineCullingConfig_TypeDefinitionIndex = 18944;
