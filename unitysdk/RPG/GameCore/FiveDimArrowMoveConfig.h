...
#define RPG_GAMECORE_FIVEDIMARROWMOVECONFIG_METHOD_3_C863CCBFA08CAF12_OFFSET UNITYSDK_OFFSET(0x171DD9A0)
#define RPG_GAMECORE_FIVEDIMARROWMOVECONFIG_METHOD_3_F440F39542D393B3_OFFSET UNITYSDK_OFFSET(0x171DD950)
#define RPG_GAMECORE_FIVEDIMARROWMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171DD990)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimArrowMoveConfig_TypeDefinitionIndex = 15292;
