...
#define RPG_GAMECORE_ROGUEACTIVITYRESIDENTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1EE89F40)
#define RPG_GAMECORE_ROGUEACTIVITYRESIDENTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1EE8A4E0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 RelatedActivityPanelID; // 0x78
		::RPG::GameCore::RogueSubMode SubMode; // 0x7C
