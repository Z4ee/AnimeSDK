...
#define RPG_GAMECORE_LEVELACTIONCOUNTACTIVE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1844AB20)
#define RPG_GAMECORE_LEVELACTIONCOUNTACTIVE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x1844AAD0)
#define RPG_GAMECORE_LEVELACTIONCOUNTACTIVE_INIT_OFFSET UNITYSDK_OFFSET(0x1844AA80)
#define RPG_GAMECORE_LEVELACTIONCOUNTACTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1844AB70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelActionCountActive_TypeDefinitionIndex = 56997;
