...
#define RPG_GAMECORE_LEVELACTIONCOUNTACTIVE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xE67F520)
#define RPG_GAMECORE_LEVELACTIONCOUNTACTIVE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xE67F4D0)
#define RPG_GAMECORE_LEVELACTIONCOUNTACTIVE_INIT_OFFSET UNITYSDK_OFFSET(0xE67F480)
#define RPG_GAMECORE_LEVELACTIONCOUNTACTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0xE67F570)
