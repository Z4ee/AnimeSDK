...
#define RPG_GAMECORE_EFFECTMODIFYDATA_METHOD_2_556C152397FF3202_OFFSET UNITYSDK_OFFSET(0x1DB23E20)
#define RPG_GAMECORE_EFFECTMODIFYDATA_METHOD_2_5D3E56C701A1EA19_OFFSET UNITYSDK_OFFSET(0x1DB23FB0)
#define RPG_GAMECORE_EFFECTMODIFYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB23FA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EffectModifyData_TypeDefinitionIndex = 20029;
