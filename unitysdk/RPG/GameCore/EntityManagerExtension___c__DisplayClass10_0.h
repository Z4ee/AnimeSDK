...
#define RPG_GAMECORE_ENTITYMANAGEREXTENSION___C__DISPLAYCLASS10_0__CLIENTCREATESTILLNPC_B__0_OFFSET UNITYSDK_OFFSET(0x11553E80)
#define RPG_GAMECORE_ENTITYMANAGEREXTENSION___C__DISPLAYCLASS10_0__CTOR_OFFSET UNITYSDK_OFFSET(0x11532D10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EntityManagerExtension___c__DisplayClass10_0_TypeDefinitionIndex = 57927;

	class EntityManagerExtension___c__DisplayClass10_0 : public ::System::Object
	{
	public:
		::RPG::GameCore::EntityManager* pEntityManager; // 0x10
