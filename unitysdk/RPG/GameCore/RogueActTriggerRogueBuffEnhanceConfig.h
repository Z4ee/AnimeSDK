...
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEBUFFENHANCECONFIG_METHOD_6_8560B1AB05849AB3_OFFSET UNITYSDK_OFFSET(0x19AFAE70)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEBUFFENHANCECONFIG_METHOD_6_B60A06D35BBC6926_OFFSET UNITYSDK_OFFSET(0x19AFAC50)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEBUFFENHANCECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AFAD90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActTriggerRogueBuffEnhanceConfig_TypeDefinitionIndex = 18554;
