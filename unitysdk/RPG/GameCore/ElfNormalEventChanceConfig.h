...
#define RPG_GAMECORE_ELFNORMALEVENTCHANCECONFIG_METHOD_2_1FB6778FA88C16A1_OFFSET UNITYSDK_OFFSET(0x1718F6E0)
#define RPG_GAMECORE_ELFNORMALEVENTCHANCECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1718F8B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfNormalEventChanceConfig_TypeDefinitionIndex = 16949;
