...
#define RPG_GAMECORE_TARGETQUERY_METHOD_4_81D1D2118B9DF1EC_OFFSET UNITYSDK_OFFSET(0x177B9810)
#define RPG_GAMECORE_TARGETQUERY_METHOD_4_FD142F713EF58B3D_OFFSET UNITYSDK_OFFSET(0x177C4970)
#define RPG_GAMECORE_TARGETQUERY__CTOR_OFFSET UNITYSDK_OFFSET(0x177B9780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetQuery_TypeDefinitionIndex = 22248;
