...
#define RPG_GAMECORE_FLOATCURVEKEYFRAME_EQUALS_OFFSET UNITYSDK_OFFSET(0x1975F890)
#define RPG_GAMECORE_FLOATCURVEKEYFRAME_METHOD_2_B10C0CBE85DBEC26_OFFSET UNITYSDK_OFFSET(0x1975FF70)
#define RPG_GAMECORE_FLOATCURVEKEYFRAME_METHOD_2_EC794351DF892425_OFFSET UNITYSDK_OFFSET(0x1975FFD0)
#define RPG_GAMECORE_FLOATCURVEKEYFRAME_METHOD_2_F3EEE9A84E9975A1_OFFSET UNITYSDK_OFFSET(0x1975FCA0)
#define RPG_GAMECORE_FLOATCURVEKEYFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1975FF60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FloatCurveKeyframe_TypeDefinitionIndex = 15523;
