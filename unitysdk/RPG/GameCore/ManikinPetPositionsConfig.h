...
#define RPG_GAMECORE_MANIKINPETPOSITIONSCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1BCDDB10)
#define RPG_GAMECORE_MANIKINPETPOSITIONSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCDDD50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ManikinPetPositionsConfig_TypeDefinitionIndex = 16781;
