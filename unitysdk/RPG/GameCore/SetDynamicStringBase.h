...
#define RPG_GAMECORE_SETDYNAMICSTRINGBASE_METHOD_3_0008672B7EDA832F_OFFSET UNITYSDK_OFFSET(0x18E15F00)
#define RPG_GAMECORE_SETDYNAMICSTRINGBASE_METHOD_3_43A631F7294671C3_OFFSET UNITYSDK_OFFSET(0x18E16050)
#define RPG_GAMECORE_SETDYNAMICSTRINGBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E15ED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicStringBase_TypeDefinitionIndex = 22811;
