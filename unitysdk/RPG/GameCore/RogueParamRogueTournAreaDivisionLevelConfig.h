...
#define RPG_GAMECORE_ROGUEPARAMROGUETOURNAREADIVISIONLEVELCONFIG_METHOD_6_05B659718F237421_OFFSET UNITYSDK_OFFSET(0x19BB2930)
#define RPG_GAMECORE_ROGUEPARAMROGUETOURNAREADIVISIONLEVELCONFIG_METHOD_6_0EAA7E22B9EBBEB7_OFFSET UNITYSDK_OFFSET(0x19BB2680)
#define RPG_GAMECORE_ROGUEPARAMROGUETOURNAREADIVISIONLEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19BB2800)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamRogueTournAreaDivisionLevelConfig_TypeDefinitionIndex = 18798;
