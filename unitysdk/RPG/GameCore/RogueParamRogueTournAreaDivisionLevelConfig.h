...
#define RPG_GAMECORE_ROGUEPARAMROGUETOURNAREADIVISIONLEVELCONFIG_METHOD_6_05B659718F237421_OFFSET UNITYSDK_OFFSET(0x1764F860)
#define RPG_GAMECORE_ROGUEPARAMROGUETOURNAREADIVISIONLEVELCONFIG_METHOD_6_0EAA7E22B9EBBEB7_OFFSET UNITYSDK_OFFSET(0x1764F5B0)
#define RPG_GAMECORE_ROGUEPARAMROGUETOURNAREADIVISIONLEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1764F730)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamRogueTournAreaDivisionLevelConfig_TypeDefinitionIndex = 18186;
