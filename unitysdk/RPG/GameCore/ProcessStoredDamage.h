...
#define RPG_GAMECORE_PROCESSSTOREDDAMAGE_METHOD_3_4315169E7166DB2B_OFFSET UNITYSDK_OFFSET(0x175137E0)
#define RPG_GAMECORE_PROCESSSTOREDDAMAGE_METHOD_3_D4C34EF143C1D369_OFFSET UNITYSDK_OFFSET(0x175138D0)
#define RPG_GAMECORE_PROCESSSTOREDDAMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x17513820)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ProcessStoredDamage_TypeDefinitionIndex = 20953;
