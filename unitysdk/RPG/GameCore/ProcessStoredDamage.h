...
#define RPG_GAMECORE_PROCESSSTOREDDAMAGE_METHOD_3_4315169E7166DB2B_OFFSET UNITYSDK_OFFSET(0x18C62A80)
#define RPG_GAMECORE_PROCESSSTOREDDAMAGE_METHOD_3_D4C34EF143C1D369_OFFSET UNITYSDK_OFFSET(0x18C62B70)
#define RPG_GAMECORE_PROCESSSTOREDDAMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x18C62AC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ProcessStoredDamage_TypeDefinitionIndex = 21664;
