...
#define RPG_GAMECORE_ROGUEPARAMBATTLEWINTIMECONFIG_METHOD_6_B2D7BB5EB5DA7B22_OFFSET UNITYSDK_OFFSET(0x19BAD970)
#define RPG_GAMECORE_ROGUEPARAMBATTLEWINTIMECONFIG_METHOD_6_F72F4B1D6E303B4C_OFFSET UNITYSDK_OFFSET(0x19BAD6C0)
#define RPG_GAMECORE_ROGUEPARAMBATTLEWINTIMECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19BAD840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamBattleWinTimeConfig_TypeDefinitionIndex = 18816;
