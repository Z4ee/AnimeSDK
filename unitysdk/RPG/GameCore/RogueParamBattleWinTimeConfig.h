...
#define RPG_GAMECORE_ROGUEPARAMBATTLEWINTIMECONFIG_METHOD_6_7A88FA8D8BA20E86_OFFSET UNITYSDK_OFFSET(0x1D1765B0)
#define RPG_GAMECORE_ROGUEPARAMBATTLEWINTIMECONFIG_METHOD_6_B2D7BB5EB5DA7B22_OFFSET UNITYSDK_OFFSET(0x1D176600)
#define RPG_GAMECORE_ROGUEPARAMBATTLEWINTIMECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1765F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamBattleWinTimeConfig_TypeDefinitionIndex = 19097;
