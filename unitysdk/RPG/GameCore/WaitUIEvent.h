...
#define RPG_GAMECORE_WAITUIEVENT_METHOD_3_119D535C718E99C6_OFFSET UNITYSDK_OFFSET(0x1910BD30)
#define RPG_GAMECORE_WAITUIEVENT_METHOD_3_FDFB445D743E7785_OFFSET UNITYSDK_OFFSET(0x1910BCB0)
#define RPG_GAMECORE_WAITUIEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1910BD00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitUIEvent_TypeDefinitionIndex = 20553;
