...
#define RPG_GAMECORE_WAITUIEVENT_METHOD_3_119D535C718E99C6_OFFSET UNITYSDK_OFFSET(0x1DEC4780)
#define RPG_GAMECORE_WAITUIEVENT_METHOD_3_9B248A83DCA5369D_OFFSET UNITYSDK_OFFSET(0x1DEC4740)
#define RPG_GAMECORE_WAITUIEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEC4770)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitUIEvent_TypeDefinitionIndex = 21459;
