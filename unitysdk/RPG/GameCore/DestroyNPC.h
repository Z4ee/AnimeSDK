...
#define RPG_GAMECORE_DESTROYNPC_METHOD_3_68C0CB8D0B09C591_OFFSET UNITYSDK_OFFSET(0x1D0206F0)
#define RPG_GAMECORE_DESTROYNPC_METHOD_3_B0A4FDDCCE7CE880_OFFSET UNITYSDK_OFFSET(0x1D020730)
#define RPG_GAMECORE_DESTROYNPC__CTOR_OFFSET UNITYSDK_OFFSET(0x1D020720)
