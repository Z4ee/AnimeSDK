...
#define RPG_GAMECORE_TARGETSEQOPERATION_METHOD_2_217BAE0F42864A8E_OFFSET UNITYSDK_OFFSET(0x1D0C5630)
#define RPG_GAMECORE_TARGETSEQOPERATION_METHOD_2_6112A888C5B98EBD_OFFSET UNITYSDK_OFFSET(0x1D0C56D0)
#define RPG_GAMECORE_TARGETSEQOPERATION_METHOD_2_9C4C5D2174678974_OFFSET UNITYSDK_OFFSET(0x1D0C5670)
#define RPG_GAMECORE_TARGETSEQOPERATION_METHOD_2_B571ADBE19D3F564_OFFSET UNITYSDK_OFFSET(0x1D0C5730)
#define RPG_GAMECORE_TARGETSEQOPERATION_METHOD_2_D9014E6A724C6ECA_OFFSET UNITYSDK_OFFSET(0x1D0C5740)
#define RPG_GAMECORE_TARGETSEQOPERATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0B6C00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetSeqOperation_TypeDefinitionIndex = 22889;
