...
#define RPG_GAMECORE_TARGETSEQOPERATION_METHOD_2_217BAE0F42864A8E_OFFSET UNITYSDK_OFFSET(0x1D5B6D40)
#define RPG_GAMECORE_TARGETSEQOPERATION_METHOD_2_6112A888C5B98EBD_OFFSET UNITYSDK_OFFSET(0x1D5B6DE0)
#define RPG_GAMECORE_TARGETSEQOPERATION_METHOD_2_9C4C5D2174678974_OFFSET UNITYSDK_OFFSET(0x1D5B6D80)
#define RPG_GAMECORE_TARGETSEQOPERATION_METHOD_2_B571ADBE19D3F564_OFFSET UNITYSDK_OFFSET(0x1D5B6E40)
#define RPG_GAMECORE_TARGETSEQOPERATION_METHOD_2_D9014E6A724C6ECA_OFFSET UNITYSDK_OFFSET(0x1D5B6E50)
#define RPG_GAMECORE_TARGETSEQOPERATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5AFCD0)
