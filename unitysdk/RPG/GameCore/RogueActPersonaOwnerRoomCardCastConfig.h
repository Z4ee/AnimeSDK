...
#define RPG_GAMECORE_ROGUEACTPERSONAOWNERROOMCARDCASTCONFIG_METHOD_6_32E22F1D7A15DD04_OFFSET UNITYSDK_OFFSET(0x18CC8F30)
#define RPG_GAMECORE_ROGUEACTPERSONAOWNERROOMCARDCASTCONFIG_METHOD_6_75CC5D78E640567D_OFFSET UNITYSDK_OFFSET(0x18CC9FB0)
#define RPG_GAMECORE_ROGUEACTPERSONAOWNERROOMCARDCASTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CC8C20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaOwnerRoomCardCastConfig_TypeDefinitionIndex = 18751;
