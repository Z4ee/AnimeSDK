...
#define RPG_GAMECORE_BYHASPAUSEDELATIONTIME_METHOD_4_34763F50B546CCB3_OFFSET UNITYSDK_OFFSET(0x170243F0)
#define RPG_GAMECORE_BYHASPAUSEDELATIONTIME_METHOD_4_44D3F23363C9A1C9_OFFSET UNITYSDK_OFFSET(0x17024320)
#define RPG_GAMECORE_BYHASPAUSEDELATIONTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x170243A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByHasPausedElationTime_TypeDefinitionIndex = 20797;
