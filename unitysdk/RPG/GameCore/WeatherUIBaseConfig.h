...
#define RPG_GAMECORE_WEATHERUIBASECONFIG_METHOD_2_9B5BE891BB8875C0_OFFSET UNITYSDK_OFFSET(0x179098B0)
#define RPG_GAMECORE_WEATHERUIBASECONFIG_METHOD_2_D367DDDBC263D560_OFFSET UNITYSDK_OFFSET(0x17909BA0)
#define RPG_GAMECORE_WEATHERUIBASECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17909B90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WeatherUIBaseConfig_TypeDefinitionIndex = 20983;
