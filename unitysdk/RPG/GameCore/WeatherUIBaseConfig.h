...
#define RPG_GAMECORE_WEATHERUIBASECONFIG_METHOD_2_9B5BE891BB8875C0_OFFSET UNITYSDK_OFFSET(0x1D1C0C20)
#define RPG_GAMECORE_WEATHERUIBASECONFIG_METHOD_2_D367DDDBC263D560_OFFSET UNITYSDK_OFFSET(0x1D1C0EA0)
#define RPG_GAMECORE_WEATHERUIBASECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1C0E90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WeatherUIBaseConfig_TypeDefinitionIndex = 21968;
