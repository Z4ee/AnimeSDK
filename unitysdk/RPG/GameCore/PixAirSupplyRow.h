...
#define RPG_GAMECORE_PIXAIRSUPPLYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D338CE0)
#define RPG_GAMECORE_PIXAIRSUPPLYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D338DA0)
