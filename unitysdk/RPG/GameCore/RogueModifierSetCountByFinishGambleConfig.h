...
#define RPG_GAMECORE_ROGUEMODIFIERSETCOUNTBYFINISHGAMBLECONFIG_METHOD_3_0FA0D782729DB17A_OFFSET UNITYSDK_OFFSET(0x18D465F0)
#define RPG_GAMECORE_ROGUEMODIFIERSETCOUNTBYFINISHGAMBLECONFIG_METHOD_3_F9CF0E213CB76133_OFFSET UNITYSDK_OFFSET(0x18D466C0)
#define RPG_GAMECORE_ROGUEMODIFIERSETCOUNTBYFINISHGAMBLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D46670)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierSetCountByFinishGambleConfig_TypeDefinitionIndex = 16828;
