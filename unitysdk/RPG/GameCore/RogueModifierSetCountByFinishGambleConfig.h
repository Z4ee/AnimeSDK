...
#define RPG_GAMECORE_ROGUEMODIFIERSETCOUNTBYFINISHGAMBLECONFIG_METHOD_3_B030E8DB7CBDFA6F_OFFSET UNITYSDK_OFFSET(0x1D1661B0)
#define RPG_GAMECORE_ROGUEMODIFIERSETCOUNTBYFINISHGAMBLECONFIG_METHOD_3_F9CF0E213CB76133_OFFSET UNITYSDK_OFFSET(0x1D166200)
#define RPG_GAMECORE_ROGUEMODIFIERSETCOUNTBYFINISHGAMBLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1661F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierSetCountByFinishGambleConfig_TypeDefinitionIndex = 17005;
