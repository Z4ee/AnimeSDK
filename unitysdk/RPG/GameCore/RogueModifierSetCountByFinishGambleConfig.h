...
#define RPG_GAMECORE_ROGUEMODIFIERSETCOUNTBYFINISHGAMBLECONFIG_METHOD_3_0FA0D782729DB17A_OFFSET UNITYSDK_OFFSET(0x19B9C5D0)
#define RPG_GAMECORE_ROGUEMODIFIERSETCOUNTBYFINISHGAMBLECONFIG_METHOD_3_F9CF0E213CB76133_OFFSET UNITYSDK_OFFSET(0x19B9C6A0)
#define RPG_GAMECORE_ROGUEMODIFIERSETCOUNTBYFINISHGAMBLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B9C650)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierSetCountByFinishGambleConfig_TypeDefinitionIndex = 16843;
