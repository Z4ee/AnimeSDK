...
#define RPG_GAMECORE_SETDEATHDRAGONSKILLBUTTONSTATE_METHOD_3_0AF10FAF6332C4DE_OFFSET UNITYSDK_OFFSET(0x1E816C60)
#define RPG_GAMECORE_SETDEATHDRAGONSKILLBUTTONSTATE_METHOD_3_4AF13B1A19BDA67D_OFFSET UNITYSDK_OFFSET(0x1E816C10)
#define RPG_GAMECORE_SETDEATHDRAGONSKILLBUTTONSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E816C50)
