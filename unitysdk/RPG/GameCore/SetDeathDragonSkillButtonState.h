...
#define RPG_GAMECORE_SETDEATHDRAGONSKILLBUTTONSTATE_METHOD_3_0AF10FAF6332C4DE_OFFSET UNITYSDK_OFFSET(0x1C2DC000)
#define RPG_GAMECORE_SETDEATHDRAGONSKILLBUTTONSTATE_METHOD_3_4AF13B1A19BDA67D_OFFSET UNITYSDK_OFFSET(0x1C2DBFB0)
#define RPG_GAMECORE_SETDEATHDRAGONSKILLBUTTONSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2DBFF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDeathDragonSkillButtonState_TypeDefinitionIndex = 22027;
