...
#define RPG_GAMECORE_VP_EXP_METHOD_3_0106DD444772739F_OFFSET UNITYSDK_OFFSET(0x19E47740)
#define RPG_GAMECORE_VP_EXP_METHOD_3_263194E01AD15D45_OFFSET UNITYSDK_OFFSET(0x19E47660)
#define RPG_GAMECORE_VP_EXP_METHOD_3_B7D931710CBC5580_OFFSET UNITYSDK_OFFSET(0x19E476E0)
#define RPG_GAMECORE_VP_EXP_METHOD_3_DFF2F0277A704912_OFFSET UNITYSDK_OFFSET(0x19E47760)
#define RPG_GAMECORE_VP_EXP__CTOR_OFFSET UNITYSDK_OFFSET(0x19E476D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VP_Exp_TypeDefinitionIndex = 22729;
