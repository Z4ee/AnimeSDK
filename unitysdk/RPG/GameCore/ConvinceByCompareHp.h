...
#define RPG_GAMECORE_CONVINCEBYCOMPAREHP_METHOD_4_82E3CE7CF2179E61_OFFSET UNITYSDK_OFFSET(0x1883B7D0)
#define RPG_GAMECORE_CONVINCEBYCOMPAREHP_METHOD_4_D09A3A6380FC3D39_OFFSET UNITYSDK_OFFSET(0x1883B700)
#define RPG_GAMECORE_CONVINCEBYCOMPAREHP__CTOR_OFFSET UNITYSDK_OFFSET(0x1883B780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConvinceByCompareHp_TypeDefinitionIndex = 20685;
