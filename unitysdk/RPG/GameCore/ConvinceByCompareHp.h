...
#define RPG_GAMECORE_CONVINCEBYCOMPAREHP_METHOD_4_4A96BC8B713D5398_OFFSET UNITYSDK_OFFSET(0x1D000790)
#define RPG_GAMECORE_CONVINCEBYCOMPAREHP_METHOD_4_82E3CE7CF2179E61_OFFSET UNITYSDK_OFFSET(0x1D0007D0)
#define RPG_GAMECORE_CONVINCEBYCOMPAREHP_METHOD_4_E99A890FF7206268_OFFSET UNITYSDK_OFFSET(0x1D0009E0)
#define RPG_GAMECORE_CONVINCEBYCOMPAREHP_METHOD_4_F8E37FB5D33FF6EF_OFFSET UNITYSDK_OFFSET(0x1D0009B0)
#define RPG_GAMECORE_CONVINCEBYCOMPAREHP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0007C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConvinceByCompareHp_TypeDefinitionIndex = 21588;
