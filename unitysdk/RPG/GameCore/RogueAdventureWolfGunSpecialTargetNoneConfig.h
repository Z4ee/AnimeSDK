...
#define RPG_GAMECORE_ROGUEADVENTUREWOLFGUNSPECIALTARGETNONECONFIG_METHOD_3_446A6948713F7A3D_OFFSET UNITYSDK_OFFSET(0x19B0D670)
#define RPG_GAMECORE_ROGUEADVENTUREWOLFGUNSPECIALTARGETNONECONFIG_METHOD_3_F414D3D9D7153FF9_OFFSET UNITYSDK_OFFSET(0x19B0D6E0)
#define RPG_GAMECORE_ROGUEADVENTUREWOLFGUNSPECIALTARGETNONECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B0D660)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueAdventureWolfGunSpecialTargetNoneConfig_TypeDefinitionIndex = 17007;
