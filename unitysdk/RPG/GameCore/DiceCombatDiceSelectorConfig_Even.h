...
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_EVEN_METHOD_3_32A1FDD8FF2AF40C_OFFSET UNITYSDK_OFFSET(0x1C10EBA0)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_EVEN_METHOD_3_7B852DC634D8947E_OFFSET UNITYSDK_OFFSET(0x1C10F9A0)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_EVEN__CTOR_OFFSET UNITYSDK_OFFSET(0x1C10EB40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatDiceSelectorConfig_Even_TypeDefinitionIndex = 15534;
