...
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_EVEN_METHOD_3_32A1FDD8FF2AF40C_OFFSET UNITYSDK_OFFSET(0x1D822520)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_EVEN_METHOD_3_7B852DC634D8947E_OFFSET UNITYSDK_OFFSET(0x1D823320)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_EVEN__CTOR_OFFSET UNITYSDK_OFFSET(0x1D8224C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatDiceSelectorConfig_Even_TypeDefinitionIndex = 15971;
