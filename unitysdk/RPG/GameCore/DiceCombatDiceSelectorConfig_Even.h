...
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_EVEN_METHOD_3_32A1FDD8FF2AF40C_OFFSET UNITYSDK_OFFSET(0x18866DA0)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_EVEN_METHOD_3_7B852DC634D8947E_OFFSET UNITYSDK_OFFSET(0x18867BA0)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_EVEN__CTOR_OFFSET UNITYSDK_OFFSET(0x18866D40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatDiceSelectorConfig_Even_TypeDefinitionIndex = 15311;
