...
#define RPG_GAMECORE_RECORDCAMERAROOTPOS_METHOD_3_C4F3E38AAE3DB4BB_OFFSET UNITYSDK_OFFSET(0x18C92600)
#define RPG_GAMECORE_RECORDCAMERAROOTPOS_METHOD_3_E33BA7769D33A712_OFFSET UNITYSDK_OFFSET(0x18C92680)
#define RPG_GAMECORE_RECORDCAMERAROOTPOS__CTOR_OFFSET UNITYSDK_OFFSET(0x18C92650)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RecordCameraRootPos_TypeDefinitionIndex = 22714;
