...
#define RPG_GAMECORE_ROGUESHOWSELECTMAINPAGE_METHOD_3_01A6659C1084AC3A_OFFSET UNITYSDK_OFFSET(0x1BB6AA60)
#define RPG_GAMECORE_ROGUESHOWSELECTMAINPAGE_METHOD_3_1F9E22BD8F7B9297_OFFSET UNITYSDK_OFFSET(0x1BB6A990)
#define RPG_GAMECORE_ROGUESHOWSELECTMAINPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB6AA50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueShowSelectMainPage_TypeDefinitionIndex = 20021;
