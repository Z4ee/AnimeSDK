...
#define RPG_GAMECORE_ROGUESHOWSELECTMAINPAGE_METHOD_3_01A6659C1084AC3A_OFFSET UNITYSDK_OFFSET(0x1765AA60)
#define RPG_GAMECORE_ROGUESHOWSELECTMAINPAGE_METHOD_3_76B99CE4FCD96B0E_OFFSET UNITYSDK_OFFSET(0x1765A950)
#define RPG_GAMECORE_ROGUESHOWSELECTMAINPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1765AA30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueShowSelectMainPage_TypeDefinitionIndex = 19127;
