...
#define RPG_GAMECORE_CAMERALOOKATSCREENRANGE_METHOD_2_995C21E4DE7C99D7_OFFSET UNITYSDK_OFFSET(0x1D1079B0)
#define RPG_GAMECORE_CAMERALOOKATSCREENRANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D107AC0)
