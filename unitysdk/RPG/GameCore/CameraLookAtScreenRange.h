...
#define RPG_GAMECORE_CAMERALOOKATSCREENRANGE_METHOD_2_995C21E4DE7C99D7_OFFSET UNITYSDK_OFFSET(0x195F36A0)
#define RPG_GAMECORE_CAMERALOOKATSCREENRANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x195F37B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CameraLookAtScreenRange_TypeDefinitionIndex = 19366;
