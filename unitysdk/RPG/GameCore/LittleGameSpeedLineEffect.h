...
#define RPG_GAMECORE_LITTLEGAMESPEEDLINEEFFECT_METHOD_3_5E80ABABA492070E_OFFSET UNITYSDK_OFFSET(0x1D205FE0)
#define RPG_GAMECORE_LITTLEGAMESPEEDLINEEFFECT_METHOD_3_EAF5D0BAFFBD5171_OFFSET UNITYSDK_OFFSET(0x1D206090)
#define RPG_GAMECORE_LITTLEGAMESPEEDLINEEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D206050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameSpeedLineEffect_TypeDefinitionIndex = 21246;
