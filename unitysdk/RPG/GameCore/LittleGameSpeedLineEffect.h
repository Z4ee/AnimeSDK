...
#define RPG_GAMECORE_LITTLEGAMESPEEDLINEEFFECT_METHOD_3_3812DFAF47358662_OFFSET UNITYSDK_OFFSET(0x198A20F0)
#define RPG_GAMECORE_LITTLEGAMESPEEDLINEEFFECT_METHOD_3_EAF5D0BAFFBD5171_OFFSET UNITYSDK_OFFSET(0x198A21F0)
#define RPG_GAMECORE_LITTLEGAMESPEEDLINEEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x198A2180)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameSpeedLineEffect_TypeDefinitionIndex = 20297;
