...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERPROBCOPYDRESSEDROLECONFIG_METHOD_3_3A3657976D43161C_OFFSET UNITYSDK_OFFSET(0x197EE410)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERPROBCOPYDRESSEDROLECONFIG_METHOD_3_55C0B74EAA67F325_OFFSET UNITYSDK_OFFSET(0x197F3070)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERPROBCOPYDRESSEDROLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197EE3C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierProbCopyDressedRoleConfig_TypeDefinitionIndex = 18486;
