...
#define RPG_GAMECORE_TRAINPARTYMODIFIERADDSTATUPDATERATIOCONFIG_METHOD_3_2B7E72FE1F98640D_OFFSET UNITYSDK_OFFSET(0x190AB610)
#define RPG_GAMECORE_TRAINPARTYMODIFIERADDSTATUPDATERATIOCONFIG_METHOD_3_89E12A5B6B7370F1_OFFSET UNITYSDK_OFFSET(0x190AB660)
#define RPG_GAMECORE_TRAINPARTYMODIFIERADDSTATUPDATERATIOCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x190AB650)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyModifierAddStatUpdateRatioConfig_TypeDefinitionIndex = 17200;
