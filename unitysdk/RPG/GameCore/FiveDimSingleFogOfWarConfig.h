...
#define RPG_GAMECORE_FIVEDIMSINGLEFOGOFWARCONFIG_METHOD_2_A537AE75FA701A55_OFFSET UNITYSDK_OFFSET(0x1BEB2D30)
#define RPG_GAMECORE_FIVEDIMSINGLEFOGOFWARCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEB2E80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSingleFogOfWarConfig_TypeDefinitionIndex = 17793;
