...
#define RPG_GAMECORE_NOTECOMBOTEMPLATENOTECONFIG_METHOD_2_444B2B98DF3385A2_OFFSET UNITYSDK_OFFSET(0x199CF3A0)
#define RPG_GAMECORE_NOTECOMBOTEMPLATENOTECONFIG_METHOD_2_963A230D5F748B05_OFFSET UNITYSDK_OFFSET(0x199CF3F0)
#define RPG_GAMECORE_NOTECOMBOTEMPLATENOTECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x199CF3E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NoteComboTemplateNoteConfig_TypeDefinitionIndex = 16110;
