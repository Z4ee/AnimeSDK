...
#define RPG_GAMECORE_PARKOURRANKINGLISTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1BB0FA60)
#define RPG_GAMECORE_PARKOURRANKINGLISTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB0FC80)
