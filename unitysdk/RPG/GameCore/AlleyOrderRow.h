...
#define RPG_GAMECORE_ALLEYORDERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1946FA70)
#define RPG_GAMECORE_ALLEYORDERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x194701B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AlleyOrderRow_TypeDefinitionIndex = 12010;
