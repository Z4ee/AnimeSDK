...
#define RPG_GAMECORE_DESTROYVIRTUALTEAM_METHOD_3_9A562443D4D971C3_OFFSET UNITYSDK_OFFSET(0x1D818270)
#define RPG_GAMECORE_DESTROYVIRTUALTEAM_METHOD_3_D68BEA3301726547_OFFSET UNITYSDK_OFFSET(0x1D8182C0)
#define RPG_GAMECORE_DESTROYVIRTUALTEAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D8182B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DestroyVirtualTeam_TypeDefinitionIndex = 21364;
