...
#define RPG_GAMECORE_DESTROYVIRTUALTEAM_METHOD_3_4967865323846857_OFFSET UNITYSDK_OFFSET(0x1885C530)
#define RPG_GAMECORE_DESTROYVIRTUALTEAM_METHOD_3_D68BEA3301726547_OFFSET UNITYSDK_OFFSET(0x1885C5C0)
#define RPG_GAMECORE_DESTROYVIRTUALTEAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1885C590)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DestroyVirtualTeam_TypeDefinitionIndex = 20451;
