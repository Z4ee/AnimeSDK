...
#define RPG_GAMECORE_ENDMOSTCHRONICLEPERFORMANCEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D7BFF50)
#define RPG_GAMECORE_ENDMOSTCHRONICLEPERFORMANCEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7C0130)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::System::UInt32 EndmostChronicleID; // 0x10
