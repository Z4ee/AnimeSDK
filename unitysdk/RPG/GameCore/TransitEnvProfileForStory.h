...
#define RPG_GAMECORE_TRANSITENVPROFILEFORSTORY_METHOD_4_356012A91F5D2A94_OFFSET UNITYSDK_OFFSET(0x1B03B3F0)
#define RPG_GAMECORE_TRANSITENVPROFILEFORSTORY_METHOD_4_59A2E11592810C1D_OFFSET UNITYSDK_OFFSET(0x1B03B260)
#define RPG_GAMECORE_TRANSITENVPROFILEFORSTORY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B03B250)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TransitEnvProfileForStory_TypeDefinitionIndex = 21095;
