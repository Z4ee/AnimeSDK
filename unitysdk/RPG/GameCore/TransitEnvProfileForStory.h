...
#define RPG_GAMECORE_TRANSITENVPROFILEFORSTORY_METHOD_4_2A4B6EABA30841EC_OFFSET UNITYSDK_OFFSET(0x19DFD130)
#define RPG_GAMECORE_TRANSITENVPROFILEFORSTORY_METHOD_4_59A2E11592810C1D_OFFSET UNITYSDK_OFFSET(0x19DFCFA0)
#define RPG_GAMECORE_TRANSITENVPROFILEFORSTORY__CTOR_OFFSET UNITYSDK_OFFSET(0x19DFCF70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TransitEnvProfileForStory_TypeDefinitionIndex = 20680;
