...
#define RPG_GAMECORE_ROLLSHOPCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18D81390)
#define RPG_GAMECORE_ROLLSHOPCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18D817C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RollShopConfigRow_TypeDefinitionIndex = 14288;

	class RollShopConfigRow : public ::System::Object
	{
	public:
		::Il2CppArray<::Class_1_6D3107F5009DB1BB_2*>* SpecialGroupList; // 0x10
		::System::UInt32 RollShopID; // 0x18
		::System::UInt32 T2GroupID; // 0x1C
		...
		::RPG::GameCore::RollShopType RollShopType; // 0x3C
