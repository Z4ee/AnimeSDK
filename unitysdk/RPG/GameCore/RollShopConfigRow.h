...
#define RPG_GAMECORE_ROLLSHOPCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CCD0A40)
#define RPG_GAMECORE_ROLLSHOPCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CCD0E60)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 T4GroupID; // 0x28
		::System::UInt32 T2GroupID; // 0x2C
		::RPG::GameCore::RollShopType RollShopType; // 0x30
		::System::UInt32 RollShopID; // 0x34
		::System::UInt32 SecretGroupID; // 0x38
		::System::UInt32 T1GroupID; // 0x3C
		::System::UInt32 CostItemID; // 0x40
		::System::UInt32 CostItemNum; // 0x44
		::System::Int32 IntroduceID; // 0x48
		::System::UInt32 T3GroupID; // 0x4C
