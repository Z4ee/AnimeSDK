...
#define RPG_GAMECORE_TARGETFETCHADVFAKEAVATAR_METHOD_4_1FCB6CE54285D0C1_OFFSET UNITYSDK_OFFSET(0x1D0B2610)
#define RPG_GAMECORE_TARGETFETCHADVFAKEAVATAR_METHOD_4_3417B7F4924A37C9_OFFSET UNITYSDK_OFFSET(0x1D0B2570)
#define RPG_GAMECORE_TARGETFETCHADVFAKEAVATAR_METHOD_4_54C5ABE1A794F074_OFFSET UNITYSDK_OFFSET(0x1D0B24D0)
#define RPG_GAMECORE_TARGETFETCHADVFAKEAVATAR_METHOD_4_835DC72267533A9D_OFFSET UNITYSDK_OFFSET(0x1D0B25D0)
#define RPG_GAMECORE_TARGETFETCHADVFAKEAVATAR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0B2560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchAdvFakeAvatar_TypeDefinitionIndex = 23026;
