...
#define RPG_GAMECORE_TARGETFETCHADVFAKEAVATAR_METHOD_4_1FCB6CE54285D0C1_OFFSET UNITYSDK_OFFSET(0x1D5A3CE0)
#define RPG_GAMECORE_TARGETFETCHADVFAKEAVATAR_METHOD_4_3417B7F4924A37C9_OFFSET UNITYSDK_OFFSET(0x1D5A3C40)
#define RPG_GAMECORE_TARGETFETCHADVFAKEAVATAR_METHOD_4_54C5ABE1A794F074_OFFSET UNITYSDK_OFFSET(0x1D5A3BA0)
#define RPG_GAMECORE_TARGETFETCHADVFAKEAVATAR_METHOD_4_835DC72267533A9D_OFFSET UNITYSDK_OFFSET(0x1D5A3CA0)
#define RPG_GAMECORE_TARGETFETCHADVFAKEAVATAR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5A3C30)
