...
#define RPG_GAMECORE_TARGETFETCHADVFAKEAVATAR_METHOD_4_3417B7F4924A37C9_OFFSET UNITYSDK_OFFSET(0x177BA960)
#define RPG_GAMECORE_TARGETFETCHADVFAKEAVATAR_METHOD_4_91E6606B34AA5E27_OFFSET UNITYSDK_OFFSET(0x177BA850)
#define RPG_GAMECORE_TARGETFETCHADVFAKEAVATAR__CTOR_OFFSET UNITYSDK_OFFSET(0x177BA910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchAdvFakeAvatar_TypeDefinitionIndex = 22147;
