...
#define RPG_GAMECORE_MODIFYHEALDATA_METHOD_3_2CF4CF3E39AAE3A3_OFFSET UNITYSDK_OFFSET(0x18B3E660)
#define RPG_GAMECORE_MODIFYHEALDATA_METHOD_3_6C97B3E56D7B0942_OFFSET UNITYSDK_OFFSET(0x18B3E940)
#define RPG_GAMECORE_MODIFYHEALDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18B3E6A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyHealData_TypeDefinitionIndex = 22547;
