...
#define RPG_GAMECORE_BATTLEROGUEMAGICDATA_ROUNDCOUNT_DEEPCLONE_OFFSET UNITYSDK_OFFSET(0xA88D3B0)
#define RPG_GAMECORE_BATTLEROGUEMAGICDATA_ROUNDCOUNT_GETLEFTBATTLECOUNT_OFFSET UNITYSDK_OFFSET(0xA88D7F0)
#define RPG_GAMECORE_BATTLEROGUEMAGICDATA_ROUNDCOUNT_GETLEFTGLOBALCOUNT_OFFSET UNITYSDK_OFFSET(0xA88D7A0)
#define RPG_GAMECORE_BATTLEROGUEMAGICDATA_ROUNDCOUNT_GET_TOTALROUNDCNT_OFFSET UNITYSDK_OFFSET(0xA887560)
#define RPG_GAMECORE_BATTLEROGUEMAGICDATA_ROUNDCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0xA88D840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleRogueMagicData_RoundCount_TypeDefinitionIndex = 45147;
