...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONENTERCHESSROGUECELLCONFIG_METHOD_3_3E138A4A3B65E982_OFFSET UNITYSDK_OFFSET(0x1CFC01F0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONENTERCHESSROGUECELLCONFIG_METHOD_3_BC14D83C1222EE66_OFFSET UNITYSDK_OFFSET(0x1CFC01A0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONENTERCHESSROGUECELLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFC01E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnEnterChessRogueCellConfig_TypeDefinitionIndex = 17212;
