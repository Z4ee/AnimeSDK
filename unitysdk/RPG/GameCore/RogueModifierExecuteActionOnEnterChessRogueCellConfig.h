...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONENTERCHESSROGUECELLCONFIG_METHOD_3_3E138A4A3B65E982_OFFSET UNITYSDK_OFFSET(0x19B51460)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONENTERCHESSROGUECELLCONFIG_METHOD_3_45B89CAF9CC0C18B_OFFSET UNITYSDK_OFFSET(0x19B5CB20)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONENTERCHESSROGUECELLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B51410)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnEnterChessRogueCellConfig_TypeDefinitionIndex = 17050;
