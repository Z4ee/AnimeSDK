...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONENTERCHESSROGUECELLCONFIG_METHOD_3_3E138A4A3B65E982_OFFSET UNITYSDK_OFFSET(0x1762FE90)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONENTERCHESSROGUECELLCONFIG_METHOD_3_45B89CAF9CC0C18B_OFFSET UNITYSDK_OFFSET(0x1762FDC0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONENTERCHESSROGUECELLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1762FE40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnEnterChessRogueCellConfig_TypeDefinitionIndex = 16483;
