...
#define RPG_GAMECORE_ADVDISABLENPCSYNCMOTION_METHOD_3_26D66354F298E2E1_OFFSET UNITYSDK_OFFSET(0x16F2A8C0)
#define RPG_GAMECORE_ADVDISABLENPCSYNCMOTION_METHOD_3_36A7A2D9827825CD_OFFSET UNITYSDK_OFFSET(0x16F2A840)
#define RPG_GAMECORE_ADVDISABLENPCSYNCMOTION__CTOR_OFFSET UNITYSDK_OFFSET(0x16F2A890)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvDisableNpcSyncMotion_TypeDefinitionIndex = 20595;
