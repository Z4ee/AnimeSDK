...
#define RPG_GAMECORE_ADVNPCPATROL_METHOD_3_02EE9E976B64A2FA_OFFSET UNITYSDK_OFFSET(0x1CDCEFC0)
#define RPG_GAMECORE_ADVNPCPATROL_METHOD_3_EE95B8F05C27FEBB_OFFSET UNITYSDK_OFFSET(0x1CDCF010)
#define RPG_GAMECORE_ADVNPCPATROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDCF000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvNPCPatrol_TypeDefinitionIndex = 19745;
