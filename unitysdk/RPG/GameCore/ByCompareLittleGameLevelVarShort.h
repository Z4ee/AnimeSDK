...
#define RPG_GAMECORE_BYCOMPARELITTLEGAMELEVELVARSHORT_METHOD_4_7BFCBD0970A0C99F_OFFSET UNITYSDK_OFFSET(0x1700DF50)
#define RPG_GAMECORE_BYCOMPARELITTLEGAMELEVELVARSHORT_METHOD_4_B51D9B35D8C7F8CD_OFFSET UNITYSDK_OFFSET(0x1700DE70)
#define RPG_GAMECORE_BYCOMPARELITTLEGAMELEVELVARSHORT__CTOR_OFFSET UNITYSDK_OFFSET(0x1700DEF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareLittleGameLevelVarShort_TypeDefinitionIndex = 19637;
