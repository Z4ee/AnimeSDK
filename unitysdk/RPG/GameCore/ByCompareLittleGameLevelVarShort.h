...
#define RPG_GAMECORE_BYCOMPARELITTLEGAMELEVELVARSHORT_METHOD_4_7BFCBD0970A0C99F_OFFSET UNITYSDK_OFFSET(0x1CED2570)
#define RPG_GAMECORE_BYCOMPARELITTLEGAMELEVELVARSHORT_METHOD_4_BD71F1EB9403DED5_OFFSET UNITYSDK_OFFSET(0x1CED27C0)
#define RPG_GAMECORE_BYCOMPARELITTLEGAMELEVELVARSHORT_METHOD_4_D7081725556D2222_OFFSET UNITYSDK_OFFSET(0x1CED2520)
#define RPG_GAMECORE_BYCOMPARELITTLEGAMELEVELVARSHORT_METHOD_4_D9965CAC10239352_OFFSET UNITYSDK_OFFSET(0x1CED2800)
#define RPG_GAMECORE_BYCOMPARELITTLEGAMELEVELVARSHORT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CED2560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareLittleGameLevelVarShort_TypeDefinitionIndex = 21181;
