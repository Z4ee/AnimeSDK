...
#define RPG_GAMECORE_CHECKSKILLUSABILITYAXIS_METHOD_3_2CD2901163F22775_OFFSET UNITYSDK_OFFSET(0x1E004370)
#define RPG_GAMECORE_CHECKSKILLUSABILITYAXIS_METHOD_3_CF9D03FFB74CCC30_OFFSET UNITYSDK_OFFSET(0x1E004320)
#define RPG_GAMECORE_CHECKSKILLUSABILITYAXIS__CTOR_OFFSET UNITYSDK_OFFSET(0x1E004360)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CheckSkillUsabilityAxis_TypeDefinitionIndex = 15333;
