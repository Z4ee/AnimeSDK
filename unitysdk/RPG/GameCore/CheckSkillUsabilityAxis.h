...
#define RPG_GAMECORE_CHECKSKILLUSABILITYAXIS_METHOD_3_2CD2901163F22775_OFFSET UNITYSDK_OFFSET(0x170768A0)
#define RPG_GAMECORE_CHECKSKILLUSABILITYAXIS_METHOD_3_CF9D03FFB74CCC30_OFFSET UNITYSDK_OFFSET(0x17076850)
#define RPG_GAMECORE_CHECKSKILLUSABILITYAXIS__CTOR_OFFSET UNITYSDK_OFFSET(0x17076890)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CheckSkillUsabilityAxis_TypeDefinitionIndex = 14202;
