...
#define RPG_GAMECORE_CHIMERADUELCHIMERAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1E32FBC0)
#define RPG_GAMECORE_CHIMERADUELCHIMERAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1E330100)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelChimeraRow_TypeDefinitionIndex = 11097;

	class ChimeraDuelChimeraRow : public ::System::Object
	{
	public:
		::System::String* ChimeraIconPath; // 0x10
		::System::String* ChimeraHeadIconPath; // 0x18
		::System::String* EmojiPath; // 0x20
		::System::String* ModelItemMatOverride; // 0x28
		::RPG::GameCore::ChimeraWingsPartType ModelWing; // 0x30
		::System::UInt32 ChimeraID; // 0x34
		::System::Int32 BaseHp; // 0x38
		::RPG::GameCore::ChimeraTailPartType ModelTail; // 0x3C
		::System::UInt32 Price; // 0x40
		::System::UInt32 Rarity; // 0x44
		::RPG::Client::TextID ChimeraName; // 0x48
		::System::Int32 BaseAttack; // 0x58
		::RPG::GameCore::ChimeraMaterialType ModelBody; // 0x5C
		::RPG::GameCore::ChimeraEyeDetailType ModelEye; // 0x60
		::RPG::GameCore::ChimeraHornsPartType ModelHorn; // 0x64
