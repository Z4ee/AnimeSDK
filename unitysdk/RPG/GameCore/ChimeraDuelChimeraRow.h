...
#define RPG_GAMECORE_CHIMERADUELCHIMERAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CFC2560)
#define RPG_GAMECORE_CHIMERADUELCHIMERAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFC2AA0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* EmojiPath; // 0x28
		::System::UInt32 ChimeraID; // 0x30
		::RPG::GameCore::ChimeraHornsPartType ModelHorn; // 0x34
		::RPG::GameCore::ChimeraMaterialType ModelBody; // 0x38
		::System::UInt32 Rarity; // 0x3C
		::RPG::GameCore::ChimeraEyeDetailType ModelEye; // 0x40
		::RPG::GameCore::ChimeraTailPartType ModelTail; // 0x44
		::System::UInt32 Price; // 0x48
		::System::Int32 BaseHp; // 0x4C
		::System::Int32 BaseAttack; // 0x50
