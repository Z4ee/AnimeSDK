...
#define RPG_GAMECORE_MODIFYSHIELDMAX_METHOD_3_37A92BEB50BCB873_OFFSET UNITYSDK_OFFSET(0x199582C0)
#define RPG_GAMECORE_MODIFYSHIELDMAX_METHOD_3_ACB3399971D03EEB_OFFSET UNITYSDK_OFFSET(0x19958350)
#define RPG_GAMECORE_MODIFYSHIELDMAX__CTOR_OFFSET UNITYSDK_OFFSET(0x19958320)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyShieldMax_TypeDefinitionIndex = 21864;
	...
	public:
		...
		static ::System::Void Method_3_37A92BEB50BCB873(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::ModifyShieldMax*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::ModifyShieldMax*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_MODIFYSHIELDMAX_METHOD_3_37A92BEB50BCB873_OFFSET))(a1, a2);
		}
