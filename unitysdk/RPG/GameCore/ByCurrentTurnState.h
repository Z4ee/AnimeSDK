...
#define RPG_GAMECORE_BYCURRENTTURNSTATE_METHOD_4_033512C3B8CB9C78_OFFSET UNITYSDK_OFFSET(0x187442B0)
#define RPG_GAMECORE_BYCURRENTTURNSTATE_METHOD_4_A95F28C65DA98926_OFFSET UNITYSDK_OFFSET(0x18744380)
#define RPG_GAMECORE_BYCURRENTTURNSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18744330)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCurrentTurnState_TypeDefinitionIndex = 22510;
