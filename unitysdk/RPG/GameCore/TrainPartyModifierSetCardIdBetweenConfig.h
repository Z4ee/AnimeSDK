...
#define RPG_GAMECORE_TRAINPARTYMODIFIERSETCARDIDBETWEENCONFIG_METHOD_3_388B71458FC90DBB_OFFSET UNITYSDK_OFFSET(0x1C161C70)
#define RPG_GAMECORE_TRAINPARTYMODIFIERSETCARDIDBETWEENCONFIG_METHOD_3_9D65B1E361A4073F_OFFSET UNITYSDK_OFFSET(0x1C161950)
#define RPG_GAMECORE_TRAINPARTYMODIFIERSETCARDIDBETWEENCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C161940)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyModifierSetCardIdBetweenConfig_TypeDefinitionIndex = 17369;
