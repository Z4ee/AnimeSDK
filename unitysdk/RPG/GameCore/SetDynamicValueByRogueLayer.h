...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUELAYER_METHOD_3_58F553C77ECD885E_OFFSET UNITYSDK_OFFSET(0x1D4F5C20)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUELAYER_METHOD_3_E20A6F0BF2E9950B_OFFSET UNITYSDK_OFFSET(0x1D4F5C60)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUELAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4F5C50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRogueLayer_TypeDefinitionIndex = 21542;
