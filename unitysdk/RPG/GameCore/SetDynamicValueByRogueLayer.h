...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUELAYER_METHOD_3_D3150BC04E280544_OFFSET UNITYSDK_OFFSET(0x176C3A00)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUELAYER_METHOD_3_E20A6F0BF2E9950B_OFFSET UNITYSDK_OFFSET(0x176C3A70)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUELAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x176C3A40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRogueLayer_TypeDefinitionIndex = 19955;
