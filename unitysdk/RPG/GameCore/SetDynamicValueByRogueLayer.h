...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUELAYER_METHOD_3_D3150BC04E280544_OFFSET UNITYSDK_OFFSET(0x19C439B0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUELAYER_METHOD_3_E20A6F0BF2E9950B_OFFSET UNITYSDK_OFFSET(0x19C43A20)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUELAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x19C439F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRogueLayer_TypeDefinitionIndex = 20569;
