...
#define RPG_GAMECORE_VCAMERAFREELOOK3RDCONFIG_METHOD_2_816E4EA6E8E89FEF_OFFSET UNITYSDK_OFFSET(0x1D2B6F60)
#define RPG_GAMECORE_VCAMERAFREELOOK3RDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2B96A0)
