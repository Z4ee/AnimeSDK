...
#define RPG_GAMECORE_ST_MAIN_PREDICATE_BEHAVIOUR_METHOD_4_0E3EAE14EF4D21AA_OFFSET UNITYSDK_OFFSET(0x18DF4670)
#define RPG_GAMECORE_ST_MAIN_PREDICATE_BEHAVIOUR_METHOD_4_1A5F8C744C6E05EE_OFFSET UNITYSDK_OFFSET(0x18DF4740)
#define RPG_GAMECORE_ST_MAIN_PREDICATE_BEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x18DF46F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_Predicate_Behaviour_TypeDefinitionIndex = 19054;
