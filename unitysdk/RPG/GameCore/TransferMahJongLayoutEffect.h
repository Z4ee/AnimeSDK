...
#define RPG_GAMECORE_TRANSFERMAHJONGLAYOUTEFFECT_METHOD_3_5238B526D014A5D4_OFFSET UNITYSDK_OFFSET(0x178B33D0)
#define RPG_GAMECORE_TRANSFERMAHJONGLAYOUTEFFECT_METHOD_3_CCF4438F76714D63_OFFSET UNITYSDK_OFFSET(0x178B3350)
#define RPG_GAMECORE_TRANSFERMAHJONGLAYOUTEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x178B33A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TransferMahJongLayoutEffect_TypeDefinitionIndex = 21355;
