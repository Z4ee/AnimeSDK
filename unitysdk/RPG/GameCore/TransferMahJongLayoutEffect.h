...
#define RPG_GAMECORE_TRANSFERMAHJONGLAYOUTEFFECT_METHOD_3_4D5387E6B4618DC1_OFFSET UNITYSDK_OFFSET(0x1D53CAB0)
#define RPG_GAMECORE_TRANSFERMAHJONGLAYOUTEFFECT_METHOD_3_5238B526D014A5D4_OFFSET UNITYSDK_OFFSET(0x1D53CAF0)
#define RPG_GAMECORE_TRANSFERMAHJONGLAYOUTEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D53CAE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TransferMahJongLayoutEffect_TypeDefinitionIndex = 22869;
