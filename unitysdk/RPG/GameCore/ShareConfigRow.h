...
#define RPG_GAMECORE_SHARECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18E50EC0)
#define RPG_GAMECORE_SHARECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18E51070)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShareConfigRow_TypeDefinitionIndex = 13691;
