...
namespace RPG::GameCore
{
	...
	public:
		...
		{
			return (::UnityEngine::Animator_OnAnimatorDispatchMovementJobFinishDelegate**)Il2CppClass::FromTypeDefinitionIndex(AdventureMovementManager___O_TypeDefinitionIndex)->GetStaticField(0x65F30);
		}
	};
}
