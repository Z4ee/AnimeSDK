...
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_LOOKAT_METHOD_4_B47524ECA659C43F_OFFSET UNITYSDK_OFFSET(0x1DB42C40)
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_LOOKAT_METHOD_4_C49E77C19E8C1B86_OFFSET UNITYSDK_OFFSET(0x1DB42CA0)
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_LOOKAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB42C80)
