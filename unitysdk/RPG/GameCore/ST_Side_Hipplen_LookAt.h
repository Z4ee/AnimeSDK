...
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_LOOKAT_METHOD_4_5E46A316C91915C1_OFFSET UNITYSDK_OFFSET(0x18DF8130)
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_LOOKAT_METHOD_4_C49E77C19E8C1B86_OFFSET UNITYSDK_OFFSET(0x18DF8210)
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_LOOKAT__CTOR_OFFSET UNITYSDK_OFFSET(0x18DF81B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_Hipplen_LookAt_TypeDefinitionIndex = 20285;
