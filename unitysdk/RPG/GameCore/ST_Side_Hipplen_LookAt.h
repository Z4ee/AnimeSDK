...
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_LOOKAT_METHOD_4_5E46A316C91915C1_OFFSET UNITYSDK_OFFSET(0x17698FF0)
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_LOOKAT_METHOD_4_C49E77C19E8C1B86_OFFSET UNITYSDK_OFFSET(0x1768BDA0)
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_LOOKAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1768BD40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_Hipplen_LookAt_TypeDefinitionIndex = 19605;
