...
#define RPG_GAMECORE_ENABLEFIELDEFFECTSOFTZOFFSET_METHOD_3_F07B9838C0838CBA_OFFSET UNITYSDK_OFFSET(0x17197E30)
#define RPG_GAMECORE_ENABLEFIELDEFFECTSOFTZOFFSET_METHOD_3_F8667EEA6F863A43_OFFSET UNITYSDK_OFFSET(0x17197EB0)
#define RPG_GAMECORE_ENABLEFIELDEFFECTSOFTZOFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x17197E80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnableFieldEffectSoftZOffset_TypeDefinitionIndex = 20897;
