...
#define RPG_GAMECORE_BYGAMEENTITYNOTCREATED_METHOD_4_1CD3B477C41891B8_OFFSET UNITYSDK_OFFSET(0x1A8C21D0)
#define RPG_GAMECORE_BYGAMEENTITYNOTCREATED_METHOD_4_B466100803BB90E0_OFFSET UNITYSDK_OFFSET(0x1A8C23C0)
#define RPG_GAMECORE_BYGAMEENTITYNOTCREATED_METHOD_4_B552F142E8D84A57_OFFSET UNITYSDK_OFFSET(0x1A8C2390)
#define RPG_GAMECORE_BYGAMEENTITYNOTCREATED_METHOD_4_B6217744C594489D_OFFSET UNITYSDK_OFFSET(0x1A8C2210)
#define RPG_GAMECORE_BYGAMEENTITYNOTCREATED__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8C2200)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByGameEntityNotCreated_TypeDefinitionIndex = 19527;
