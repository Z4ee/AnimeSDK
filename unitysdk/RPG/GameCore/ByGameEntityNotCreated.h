...
#define RPG_GAMECORE_BYGAMEENTITYNOTCREATED_METHOD_4_B5108C4456E817FB_OFFSET UNITYSDK_OFFSET(0x18746A90)
#define RPG_GAMECORE_BYGAMEENTITYNOTCREATED_METHOD_4_B6217744C594489D_OFFSET UNITYSDK_OFFSET(0x18746B60)
#define RPG_GAMECORE_BYGAMEENTITYNOTCREATED__CTOR_OFFSET UNITYSDK_OFFSET(0x18746B10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByGameEntityNotCreated_TypeDefinitionIndex = 19252;
