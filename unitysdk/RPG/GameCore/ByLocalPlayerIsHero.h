...
#define RPG_GAMECORE_BYLOCALPLAYERISHERO_METHOD_4_022B0BBAB9337956_OFFSET UNITYSDK_OFFSET(0x1CDB6A60)
#define RPG_GAMECORE_BYLOCALPLAYERISHERO_METHOD_4_1379DBBE913ED055_OFFSET UNITYSDK_OFFSET(0x1CDB6A20)
#define RPG_GAMECORE_BYLOCALPLAYERISHERO_METHOD_4_C1F0E0CA24D46CC0_OFFSET UNITYSDK_OFFSET(0x1CDB6BA0)
#define RPG_GAMECORE_BYLOCALPLAYERISHERO_METHOD_4_FE8EB376F7BFF1E1_OFFSET UNITYSDK_OFFSET(0x1CDB6BD0)
#define RPG_GAMECORE_BYLOCALPLAYERISHERO__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDB6A50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByLocalPlayerIsHero_TypeDefinitionIndex = 20350;
