...
#define RPG_GAMECORE_BYLOCALPLAYERISHERO_METHOD_4_022B0BBAB9337956_OFFSET UNITYSDK_OFFSET(0x17036600)
#define RPG_GAMECORE_BYLOCALPLAYERISHERO_METHOD_4_C5BF1CD4837B659C_OFFSET UNITYSDK_OFFSET(0x17036530)
#define RPG_GAMECORE_BYLOCALPLAYERISHERO__CTOR_OFFSET UNITYSDK_OFFSET(0x170365B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByLocalPlayerIsHero_TypeDefinitionIndex = 18896;
