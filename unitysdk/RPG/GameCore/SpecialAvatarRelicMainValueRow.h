...
#define RPG_GAMECORE_SPECIALAVATARRELICMAINVALUEROW_FROMBINARYWITHOUTNEW_OFFSET UNITYSDK_OFFSET(0x1B09F8B0)
#define RPG_GAMECORE_SPECIALAVATARRELICMAINVALUEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B09F9B0)
#define RPG_GAMECORE_SPECIALAVATARRELICMAINVALUEROW_FROMTABLEOFFSET_OFFSET UNITYSDK_OFFSET(0x1B09FAE0)
#define RPG_GAMECORE_SPECIALAVATARRELICMAINVALUEROW_RESET_OFFSET UNITYSDK_OFFSET(0x1B09FB40)
#define RPG_GAMECORE_SPECIALAVATARRELICMAINVALUEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B09FAD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SpecialAvatarRelicMainValueRow_TypeDefinitionIndex = 14530;
