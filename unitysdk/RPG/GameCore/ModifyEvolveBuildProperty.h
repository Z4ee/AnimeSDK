...
#define RPG_GAMECORE_MODIFYEVOLVEBUILDPROPERTY_METHOD_3_1C464D090863587F_OFFSET UNITYSDK_OFFSET(0x17430BF0)
#define RPG_GAMECORE_MODIFYEVOLVEBUILDPROPERTY_METHOD_3_AE271607FE018280_OFFSET UNITYSDK_OFFSET(0x17430C80)
#define RPG_GAMECORE_MODIFYEVOLVEBUILDPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x17430C50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyEvolveBuildProperty_TypeDefinitionIndex = 21322;
