...
#define RPG_GAMECORE_MODIFYEVOLVEBUILDPROPERTY_METHOD_3_1C464D090863587F_OFFSET UNITYSDK_OFFSET(0x18B3D7D0)
#define RPG_GAMECORE_MODIFYEVOLVEBUILDPROPERTY_METHOD_3_AE271607FE018280_OFFSET UNITYSDK_OFFSET(0x18B3D860)
#define RPG_GAMECORE_MODIFYEVOLVEBUILDPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x18B3D830)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyEvolveBuildProperty_TypeDefinitionIndex = 22039;
