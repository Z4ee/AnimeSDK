...
#define RPG_GAMECORE_SETDYNAMICVALUEBYBATTLETARGETPARAM_METHOD_3_5A5290899E5D0C1B_OFFSET UNITYSDK_OFFSET(0x1C2DF480)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBATTLETARGETPARAM_METHOD_3_EF4B57BF16E6ACCA_OFFSET UNITYSDK_OFFSET(0x1C2DF440)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBATTLETARGETPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2DF470)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByBattleTargetParam_TypeDefinitionIndex = 22981;
