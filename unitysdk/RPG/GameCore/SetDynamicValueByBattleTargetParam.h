...
#define RPG_GAMECORE_SETDYNAMICVALUEBYBATTLETARGETPARAM_METHOD_3_1D129634DC4D9508_OFFSET UNITYSDK_OFFSET(0x176C06A0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBATTLETARGETPARAM_METHOD_3_5A5290899E5D0C1B_OFFSET UNITYSDK_OFFSET(0x176C0720)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBATTLETARGETPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x176C06F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByBattleTargetParam_TypeDefinitionIndex = 22109;
