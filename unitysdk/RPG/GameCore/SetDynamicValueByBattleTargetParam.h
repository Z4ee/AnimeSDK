...
#define RPG_GAMECORE_SETDYNAMICVALUEBYBATTLETARGETPARAM_METHOD_3_1D129634DC4D9508_OFFSET UNITYSDK_OFFSET(0x18E1D510)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBATTLETARGETPARAM_METHOD_3_5A5290899E5D0C1B_OFFSET UNITYSDK_OFFSET(0x18E1D590)
#define RPG_GAMECORE_SETDYNAMICVALUEBYBATTLETARGETPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x18E1D560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByBattleTargetParam_TypeDefinitionIndex = 22829;
