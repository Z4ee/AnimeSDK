...
#define RPG_GAMECORE_GRIDFIGHTADDTRAITMEMBERPROPERTYCONFIG_METHOD_2_194EE315D652A916_OFFSET UNITYSDK_OFFSET(0x189A1110)
#define RPG_GAMECORE_GRIDFIGHTADDTRAITMEMBERPROPERTYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189A1150)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightAddTraitMemberPropertyConfig_TypeDefinitionIndex = 18497;
