...
#define RPG_GAMECORE_CAKERACEACTIONENABLETARGETLOCKCAT_METHOD_3_791D571422EF14A1_OFFSET UNITYSDK_OFFSET(0x1876BD20)
#define RPG_GAMECORE_CAKERACEACTIONENABLETARGETLOCKCAT_METHOD_3_B6A0662F6CC0AD23_OFFSET UNITYSDK_OFFSET(0x18769C60)
#define RPG_GAMECORE_CAKERACEACTIONENABLETARGETLOCKCAT__CTOR_OFFSET UNITYSDK_OFFSET(0x18769C40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionEnableTargetLockCat_TypeDefinitionIndex = 17446;
