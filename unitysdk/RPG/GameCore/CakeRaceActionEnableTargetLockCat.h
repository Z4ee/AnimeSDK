...
#define RPG_GAMECORE_CAKERACEACTIONENABLETARGETLOCKCAT_METHOD_3_8607F494FE2FBD57_OFFSET UNITYSDK_OFFSET(0x1CDD3A50)
#define RPG_GAMECORE_CAKERACEACTIONENABLETARGETLOCKCAT_METHOD_3_B6A0662F6CC0AD23_OFFSET UNITYSDK_OFFSET(0x1CDD3AB0)
#define RPG_GAMECORE_CAKERACEACTIONENABLETARGETLOCKCAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDD3AA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionEnableTargetLockCat_TypeDefinitionIndex = 18140;
