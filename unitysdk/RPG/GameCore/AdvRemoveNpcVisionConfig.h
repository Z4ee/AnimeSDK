...
#define RPG_GAMECORE_ADVREMOVENPCVISIONCONFIG_METHOD_3_28FDF4294B61D62C_OFFSET UNITYSDK_OFFSET(0x1CB9DE10)
#define RPG_GAMECORE_ADVREMOVENPCVISIONCONFIG_METHOD_3_6BF2450EC9AA31E7_OFFSET UNITYSDK_OFFSET(0x1CB9DDD0)
#define RPG_GAMECORE_ADVREMOVENPCVISIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CB9DE00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvRemoveNpcVisionConfig_TypeDefinitionIndex = 20105;
