...
#define RPG_GAMECORE_ADVREMOVENPCVISIONCONFIG_METHOD_3_28FDF4294B61D62C_OFFSET UNITYSDK_OFFSET(0x16F3DAC0)
#define RPG_GAMECORE_ADVREMOVENPCVISIONCONFIG_METHOD_3_DCFA5F3F87840E3D_OFFSET UNITYSDK_OFFSET(0x16F3DA40)
#define RPG_GAMECORE_ADVREMOVENPCVISIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16F3DA90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvRemoveNpcVisionConfig_TypeDefinitionIndex = 18630;
