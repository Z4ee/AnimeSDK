...
#define RPG_GAMECORE_ROGUEPARAMACTIVEFORMULACATEGORYCOUNTCONFIG_METHOD_6_2CA3D31FAACB2F48_OFFSET UNITYSDK_OFFSET(0x19BAD340)
#define RPG_GAMECORE_ROGUEPARAMACTIVEFORMULACATEGORYCOUNTCONFIG_METHOD_6_CB1E60757F16118E_OFFSET UNITYSDK_OFFSET(0x19BAD5F0)
#define RPG_GAMECORE_ROGUEPARAMACTIVEFORMULACATEGORYCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19BAD4C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamActiveFormulaCategoryCountConfig_TypeDefinitionIndex = 18777;
