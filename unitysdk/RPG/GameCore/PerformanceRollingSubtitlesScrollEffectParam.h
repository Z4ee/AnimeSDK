...
#define RPG_GAMECORE_PERFORMANCEROLLINGSUBTITLESSCROLLEFFECTPARAM_METHOD_2_8111A3DC08D35B2B_OFFSET UNITYSDK_OFFSET(0x199FACB0)
#define RPG_GAMECORE_PERFORMANCEROLLINGSUBTITLESSCROLLEFFECTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x199FADE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PerformanceRollingSubtitlesScrollEffectParam_TypeDefinitionIndex = 23079;
