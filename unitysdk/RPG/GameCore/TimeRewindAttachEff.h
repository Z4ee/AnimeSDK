...
#define RPG_GAMECORE_TIMEREWINDATTACHEFF_METHOD_2_84544CE0FDCC3441_OFFSET UNITYSDK_OFFSET(0x1909A160)
#define RPG_GAMECORE_TIMEREWINDATTACHEFF__CTOR_OFFSET UNITYSDK_OFFSET(0x1909A3C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TimeRewindAttachEff_TypeDefinitionIndex = 15726;
