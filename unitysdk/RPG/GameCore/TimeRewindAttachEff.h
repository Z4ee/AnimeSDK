...
#define RPG_GAMECORE_TIMEREWINDATTACHEFF_METHOD_2_84544CE0FDCC3441_OFFSET UNITYSDK_OFFSET(0x1789E180)
#define RPG_GAMECORE_TIMEREWINDATTACHEFF__CTOR_OFFSET UNITYSDK_OFFSET(0x1789E3E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TimeRewindAttachEff_TypeDefinitionIndex = 15212;
