...
#define RPG_GAMECORE_TIMEREWINDATTACHEFF_METHOD_2_84544CE0FDCC3441_OFFSET UNITYSDK_OFFSET(0x1D5CEE30)
#define RPG_GAMECORE_TIMEREWINDATTACHEFF__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5CF090)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TimeRewindAttachEff_TypeDefinitionIndex = 16431;
