...
#define RPG_GAMECORE_GLOBALMAININTENSITYEFFECT_METHOD_3_08237A1ABF92B2D3_OFFSET UNITYSDK_OFFSET(0x1C5BBB20)
#define RPG_GAMECORE_GLOBALMAININTENSITYEFFECT_METHOD_3_859BC91E7336CC8A_OFFSET UNITYSDK_OFFSET(0x1C5BBAE0)
#define RPG_GAMECORE_GLOBALMAININTENSITYEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5BBB10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GlobalMainIntensityEffect_TypeDefinitionIndex = 22879;
