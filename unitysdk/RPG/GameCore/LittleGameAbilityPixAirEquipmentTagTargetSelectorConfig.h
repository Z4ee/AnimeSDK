...
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREQUIPMENTTAGTARGETSELECTORCONFIG_METHOD_3_3A9DFDBBC819ED92_OFFSET UNITYSDK_OFFSET(0x19895200)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREQUIPMENTTAGTARGETSELECTORCONFIG_METHOD_3_E748AF28DC46B090_OFFSET UNITYSDK_OFFSET(0x198951A0)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREQUIPMENTTAGTARGETSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x198951F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityPixAirEquipmentTagTargetSelectorConfig_TypeDefinitionIndex = 20205;
