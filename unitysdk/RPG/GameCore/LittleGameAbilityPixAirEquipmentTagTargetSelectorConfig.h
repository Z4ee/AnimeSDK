...
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREQUIPMENTTAGTARGETSELECTORCONFIG_METHOD_3_3A9DFDBBC819ED92_OFFSET UNITYSDK_OFFSET(0x1D1FB500)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREQUIPMENTTAGTARGETSELECTORCONFIG_METHOD_3_E748AF28DC46B090_OFFSET UNITYSDK_OFFSET(0x1D1FB4A0)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREQUIPMENTTAGTARGETSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1FB4F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityPixAirEquipmentTagTargetSelectorConfig_TypeDefinitionIndex = 21131;
