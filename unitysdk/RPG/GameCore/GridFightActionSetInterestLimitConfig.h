...
#define RPG_GAMECORE_GRIDFIGHTACTIONSETINTERESTLIMITCONFIG_METHOD_6_364A99C7DCD7C087_OFFSET UNITYSDK_OFFSET(0x1D14A3E0)
#define RPG_GAMECORE_GRIDFIGHTACTIONSETINTERESTLIMITCONFIG_METHOD_6_80875DE39CEB642B_OFFSET UNITYSDK_OFFSET(0x1D149FA0)
#define RPG_GAMECORE_GRIDFIGHTACTIONSETINTERESTLIMITCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D149F90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightActionSetInterestLimitConfig_TypeDefinitionIndex = 19070;
