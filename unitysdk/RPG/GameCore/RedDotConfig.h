...
#define RPG_GAMECORE_REDDOTCONFIG_METHOD_2_050379D7C7E41D0D_OFFSET UNITYSDK_OFFSET(0x1DB7D4C0)
#define RPG_GAMECORE_REDDOTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB7D5C0)
