...
#define RPG_GAMECORE_ROGUECHESTEFFECTLISTCONFIG_METHOD_2_380B69A1472C3BBC_OFFSET UNITYSDK_OFFSET(0x19B19950)
#define RPG_GAMECORE_ROGUECHESTEFFECTLISTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B19990)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueChestEffectListConfig_TypeDefinitionIndex = 17016;
