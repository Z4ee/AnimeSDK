...
#define RPG_GAMECORE_ROGUECHESTEFFECTLISTCONFIG_METHOD_2_380B69A1472C3BBC_OFFSET UNITYSDK_OFFSET(0x175E95F0)
#define RPG_GAMECORE_ROGUECHESTEFFECTLISTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175E9630)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueChestEffectListConfig_TypeDefinitionIndex = 16447;
