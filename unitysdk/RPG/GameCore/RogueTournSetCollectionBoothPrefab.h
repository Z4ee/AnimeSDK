...
#define RPG_GAMECORE_ROGUETOURNSETCOLLECTIONBOOTHPREFAB_METHOD_3_90E882C00D3D340B_OFFSET UNITYSDK_OFFSET(0x1766E3C0)
#define RPG_GAMECORE_ROGUETOURNSETCOLLECTIONBOOTHPREFAB_METHOD_3_DECA6AA79939952D_OFFSET UNITYSDK_OFFSET(0x1766E440)
#define RPG_GAMECORE_ROGUETOURNSETCOLLECTIONBOOTHPREFAB__CTOR_OFFSET UNITYSDK_OFFSET(0x1766E410)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournSetCollectionBoothPrefab_TypeDefinitionIndex = 20295;
