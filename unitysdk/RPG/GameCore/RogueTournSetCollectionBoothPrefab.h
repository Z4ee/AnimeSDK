...
#define RPG_GAMECORE_ROGUETOURNSETCOLLECTIONBOOTHPREFAB_METHOD_3_90E882C00D3D340B_OFFSET UNITYSDK_OFFSET(0x19BCF3B0)
#define RPG_GAMECORE_ROGUETOURNSETCOLLECTIONBOOTHPREFAB_METHOD_3_DECA6AA79939952D_OFFSET UNITYSDK_OFFSET(0x19BCF430)
#define RPG_GAMECORE_ROGUETOURNSETCOLLECTIONBOOTHPREFAB__CTOR_OFFSET UNITYSDK_OFFSET(0x19BCF400)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournSetCollectionBoothPrefab_TypeDefinitionIndex = 20889;
