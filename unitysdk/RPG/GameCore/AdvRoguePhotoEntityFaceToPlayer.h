...
#define RPG_GAMECORE_ADVROGUEPHOTOENTITYFACETOPLAYER_METHOD_3_0565C969A07D0CBF_OFFSET UNITYSDK_OFFSET(0x1CDD7070)
#define RPG_GAMECORE_ADVROGUEPHOTOENTITYFACETOPLAYER_METHOD_3_3DE0E9F30F0F7AA4_OFFSET UNITYSDK_OFFSET(0x1CDD7030)
#define RPG_GAMECORE_ADVROGUEPHOTOENTITYFACETOPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDD7060)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvRoguePhotoEntityFaceToPlayer_TypeDefinitionIndex = 20329;
