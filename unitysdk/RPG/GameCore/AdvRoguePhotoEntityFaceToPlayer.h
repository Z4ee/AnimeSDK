...
#define RPG_GAMECORE_ADVROGUEPHOTOENTITYFACETOPLAYER_METHOD_3_0565C969A07D0CBF_OFFSET UNITYSDK_OFFSET(0x1865FF70)
#define RPG_GAMECORE_ADVROGUEPHOTOENTITYFACETOPLAYER_METHOD_3_44ED71A668164D8E_OFFSET UNITYSDK_OFFSET(0x1865FEF0)
#define RPG_GAMECORE_ADVROGUEPHOTOENTITYFACETOPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1865FF40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvRoguePhotoEntityFaceToPlayer_TypeDefinitionIndex = 19533;
