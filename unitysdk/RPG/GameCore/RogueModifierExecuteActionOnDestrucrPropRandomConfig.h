...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONDESTRUCRPROPRANDOMCONFIG_METHOD_3_42586542FD522BA6_OFFSET UNITYSDK_OFFSET(0x18D35520)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONDESTRUCRPROPRANDOMCONFIG_METHOD_3_95C91190C04AF4CF_OFFSET UNITYSDK_OFFSET(0x18D3CE70)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONDESTRUCRPROPRANDOMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D354D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnDestrucrPropRandomConfig_TypeDefinitionIndex = 17041;
