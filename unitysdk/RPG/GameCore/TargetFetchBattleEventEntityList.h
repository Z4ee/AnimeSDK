...
#define RPG_GAMECORE_TARGETFETCHBATTLEEVENTENTITYLIST_METHOD_4_45915D5904B1812B_OFFSET UNITYSDK_OFFSET(0x18EE33C0)
#define RPG_GAMECORE_TARGETFETCHBATTLEEVENTENTITYLIST_METHOD_4_DD5041FD1D1DA4DD_OFFSET UNITYSDK_OFFSET(0x18EDB750)
#define RPG_GAMECORE_TARGETFETCHBATTLEEVENTENTITYLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x18EDB700)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchBattleEventEntityList_TypeDefinitionIndex = 22997;
