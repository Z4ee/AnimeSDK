...
#define RPG_GAMECORE_WAITBATCH_METHOD_3_5C5D4AEA032DCD4F_OFFSET UNITYSDK_OFFSET(0x1B8A0E80)
#define RPG_GAMECORE_WAITBATCH_METHOD_3_C4D566173DB2CD06_OFFSET UNITYSDK_OFFSET(0x1B8A0ED0)
#define RPG_GAMECORE_WAITBATCH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8A0EC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitBatch_TypeDefinitionIndex = 22906;
