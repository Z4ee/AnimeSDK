...
#define RPG_GAMECORE_WAITBATCH_METHOD_3_87827B7CE3C57166_OFFSET UNITYSDK_OFFSET(0x190F9120)
#define RPG_GAMECORE_WAITBATCH_METHOD_3_DB9C3454B47C362D_OFFSET UNITYSDK_OFFSET(0x190F91A0)
#define RPG_GAMECORE_WAITBATCH__CTOR_OFFSET UNITYSDK_OFFSET(0x190F9170)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitBatch_TypeDefinitionIndex = 22747;
