...
#define RPG_GAMECORE_CHIMERATALKCONTENT_METHOD_2_DDF2E390B9F0C76C_OFFSET UNITYSDK_OFFSET(0x1964BCE0)
#define RPG_GAMECORE_CHIMERATALKCONTENT_METHOD_2_EBCF9465C5DDE5CA_OFFSET UNITYSDK_OFFSET(0x1964AA80)
#define RPG_GAMECORE_CHIMERATALKCONTENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1964BCD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraTalkContent_TypeDefinitionIndex = 15077;
