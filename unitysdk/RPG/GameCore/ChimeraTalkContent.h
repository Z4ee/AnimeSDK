...
#define RPG_GAMECORE_CHIMERATALKCONTENT_METHOD_2_DDF2E390B9F0C76C_OFFSET UNITYSDK_OFFSET(0x170AB010)
#define RPG_GAMECORE_CHIMERATALKCONTENT_METHOD_2_EBCF9465C5DDE5CA_OFFSET UNITYSDK_OFFSET(0x170A9D80)
#define RPG_GAMECORE_CHIMERATALKCONTENT__CTOR_OFFSET UNITYSDK_OFFSET(0x170AB000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraTalkContent_TypeDefinitionIndex = 14544;
