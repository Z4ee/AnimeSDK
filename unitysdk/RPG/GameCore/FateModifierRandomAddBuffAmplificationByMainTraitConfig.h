...
#define RPG_GAMECORE_FATEMODIFIERRANDOMADDBUFFAMPLIFICATIONBYMAINTRAITCONFIG_METHOD_3_209B1B1BFFB7539D_OFFSET UNITYSDK_OFFSET(0x188D5950)
#define RPG_GAMECORE_FATEMODIFIERRANDOMADDBUFFAMPLIFICATIONBYMAINTRAITCONFIG_METHOD_3_AFC3501543DEB324_OFFSET UNITYSDK_OFFSET(0x188D6750)
#define RPG_GAMECORE_FATEMODIFIERRANDOMADDBUFFAMPLIFICATIONBYMAINTRAITCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x188D5900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateModifierRandomAddBuffAmplificationByMainTraitConfig_TypeDefinitionIndex = 18311;
