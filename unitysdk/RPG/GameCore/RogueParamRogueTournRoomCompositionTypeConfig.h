...
#define RPG_GAMECORE_ROGUEPARAMROGUETOURNROOMCOMPOSITIONTYPECONFIG_METHOD_6_4DB760B99AE5092A_OFFSET UNITYSDK_OFFSET(0x1D177390)
#define RPG_GAMECORE_ROGUEPARAMROGUETOURNROOMCOMPOSITIONTYPECONFIG_METHOD_6_AD567C8389FE4486_OFFSET UNITYSDK_OFFSET(0x1D1773E0)
#define RPG_GAMECORE_ROGUEPARAMROGUETOURNROOMCOMPOSITIONTYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1773D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamRogueTournRoomCompositionTypeConfig_TypeDefinitionIndex = 19086;
