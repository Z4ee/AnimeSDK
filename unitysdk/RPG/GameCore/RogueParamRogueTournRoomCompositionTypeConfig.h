...
#define RPG_GAMECORE_ROGUEPARAMROGUETOURNROOMCOMPOSITIONTYPECONFIG_METHOD_6_1F9F55AECC0CACB0_OFFSET UNITYSDK_OFFSET(0x19BB3C80)
#define RPG_GAMECORE_ROGUEPARAMROGUETOURNROOMCOMPOSITIONTYPECONFIG_METHOD_6_AD567C8389FE4486_OFFSET UNITYSDK_OFFSET(0x19BB3F30)
#define RPG_GAMECORE_ROGUEPARAMROGUETOURNROOMCOMPOSITIONTYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19BB3E00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamRogueTournRoomCompositionTypeConfig_TypeDefinitionIndex = 18805;
