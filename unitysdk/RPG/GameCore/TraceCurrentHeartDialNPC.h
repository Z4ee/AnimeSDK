...
#define RPG_GAMECORE_TRACECURRENTHEARTDIALNPC_METHOD_3_99D4652B8A31B2EE_OFFSET UNITYSDK_OFFSET(0x1D5D5250)
#define RPG_GAMECORE_TRACECURRENTHEARTDIALNPC_METHOD_3_D3F9BBD0DCF7FAAD_OFFSET UNITYSDK_OFFSET(0x1D5D5290)
#define RPG_GAMECORE_TRACECURRENTHEARTDIALNPC__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5D5280)
