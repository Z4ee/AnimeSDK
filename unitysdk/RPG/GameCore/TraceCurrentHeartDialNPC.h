...
#define RPG_GAMECORE_TRACECURRENTHEARTDIALNPC_METHOD_3_D0B0DD3127A9F81C_OFFSET UNITYSDK_OFFSET(0x178A28C0)
#define RPG_GAMECORE_TRACECURRENTHEARTDIALNPC_METHOD_3_D3F9BBD0DCF7FAAD_OFFSET UNITYSDK_OFFSET(0x1788BC30)
#define RPG_GAMECORE_TRACECURRENTHEARTDIALNPC__CTOR_OFFSET UNITYSDK_OFFSET(0x1788BC00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TraceCurrentHeartDialNPC_TypeDefinitionIndex = 19000;
