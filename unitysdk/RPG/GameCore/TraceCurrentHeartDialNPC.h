...
#define RPG_GAMECORE_TRACECURRENTHEARTDIALNPC_METHOD_3_99D4652B8A31B2EE_OFFSET UNITYSDK_OFFSET(0x1C157E70)
#define RPG_GAMECORE_TRACECURRENTHEARTDIALNPC_METHOD_3_D3F9BBD0DCF7FAAD_OFFSET UNITYSDK_OFFSET(0x1C157EB0)
#define RPG_GAMECORE_TRACECURRENTHEARTDIALNPC__CTOR_OFFSET UNITYSDK_OFFSET(0x1C157EA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TraceCurrentHeartDialNPC_TypeDefinitionIndex = 19898;
