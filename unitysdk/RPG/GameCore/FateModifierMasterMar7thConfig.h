...
#define RPG_GAMECORE_FATEMODIFIERMASTERMAR7THCONFIG_METHOD_3_90389303F7F3CE89_OFFSET UNITYSDK_OFFSET(0x1C0750B0)
#define RPG_GAMECORE_FATEMODIFIERMASTERMAR7THCONFIG_METHOD_3_9E0F69DBB7FCAC8D_OFFSET UNITYSDK_OFFSET(0x1C075100)
#define RPG_GAMECORE_FATEMODIFIERMASTERMAR7THCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0750F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateModifierMasterMar7thConfig_TypeDefinitionIndex = 18534;
