...
#define RPG_GAMECORE_FATEMODIFIERMASTERMAR7THCONFIG_METHOD_3_271A5EA89C943514_OFFSET UNITYSDK_OFFSET(0x171C8B80)
#define RPG_GAMECORE_FATEMODIFIERMASTERMAR7THCONFIG_METHOD_3_9E0F69DBB7FCAC8D_OFFSET UNITYSDK_OFFSET(0x171C7A80)
#define RPG_GAMECORE_FATEMODIFIERMASTERMAR7THCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171C7A30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateModifierMasterMar7thConfig_TypeDefinitionIndex = 17714;
