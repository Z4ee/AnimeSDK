...
#define RPG_GAMECORE_ROGUEMODIFIERCHANGEPERSONASTYLEGIFTMAXREROLLCOUNTCONFIG_METHOD_3_3A3ABEC277C7D68E_OFFSET UNITYSDK_OFFSET(0x18D2B0A0)
#define RPG_GAMECORE_ROGUEMODIFIERCHANGEPERSONASTYLEGIFTMAXREROLLCOUNTCONFIG_METHOD_3_C0F7E9C64391A7B7_OFFSET UNITYSDK_OFFSET(0x18D2AFD0)
#define RPG_GAMECORE_ROGUEMODIFIERCHANGEPERSONASTYLEGIFTMAXREROLLCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D2B050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierChangePersonaStyleGiftMaxRerollCountConfig_TypeDefinitionIndex = 16906;
