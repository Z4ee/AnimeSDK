...
#define RPG_GAMECORE_ROGUEMODIFIERCHANGEPERSONASTYLEGIFTMAXREROLLCOUNTCONFIG_METHOD_3_3A3ABEC277C7D68E_OFFSET UNITYSDK_OFFSET(0x1EEF7C50)
#define RPG_GAMECORE_ROGUEMODIFIERCHANGEPERSONASTYLEGIFTMAXREROLLCOUNTCONFIG_METHOD_3_9AE7C79674ED8D72_OFFSET UNITYSDK_OFFSET(0x1EEF7C00)
#define RPG_GAMECORE_ROGUEMODIFIERCHANGEPERSONASTYLEGIFTMAXREROLLCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEF7C40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierChangePersonaStyleGiftMaxRerollCountConfig_TypeDefinitionIndex = 17588;
