...
#define RPG_GAMECORE_BYHAVESKILLPOINTENTITY_METHOD_4_219F87448AC0B2DC_OFFSET UNITYSDK_OFFSET(0x1874B900)
#define RPG_GAMECORE_BYHAVESKILLPOINTENTITY_METHOD_4_42472F1B67E5D096_OFFSET UNITYSDK_OFFSET(0x1874B9D0)
#define RPG_GAMECORE_BYHAVESKILLPOINTENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1874B980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByHaveSkillPointEntity_TypeDefinitionIndex = 21300;
