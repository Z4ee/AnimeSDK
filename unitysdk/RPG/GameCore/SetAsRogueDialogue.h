...
#define RPG_GAMECORE_SETASROGUEDIALOGUE_METHOD_3_BF620B0AE7EB747F_OFFSET UNITYSDK_OFFSET(0x1C2D1ED0)
#define RPG_GAMECORE_SETASROGUEDIALOGUE_METHOD_3_E52B577F1F653F42_OFFSET UNITYSDK_OFFSET(0x1C2D1E00)
#define RPG_GAMECORE_SETASROGUEDIALOGUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2D1EC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetAsRogueDialogue_TypeDefinitionIndex = 20323;
