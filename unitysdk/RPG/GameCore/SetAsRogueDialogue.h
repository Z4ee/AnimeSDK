...
#define RPG_GAMECORE_SETASROGUEDIALOGUE_METHOD_3_908A9821CFB8550B_OFFSET UNITYSDK_OFFSET(0x18E09240)
#define RPG_GAMECORE_SETASROGUEDIALOGUE_METHOD_3_BF620B0AE7EB747F_OFFSET UNITYSDK_OFFSET(0x18E09350)
#define RPG_GAMECORE_SETASROGUEDIALOGUE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E09320)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetAsRogueDialogue_TypeDefinitionIndex = 20093;
