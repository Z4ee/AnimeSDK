...
#define RPG_GAMECORE_SETASROGUEDIALOGUE_METHOD_3_908A9821CFB8550B_OFFSET UNITYSDK_OFFSET(0x176A6740)
#define RPG_GAMECORE_SETASROGUEDIALOGUE_METHOD_3_BF620B0AE7EB747F_OFFSET UNITYSDK_OFFSET(0x176A6850)
#define RPG_GAMECORE_SETASROGUEDIALOGUE__CTOR_OFFSET UNITYSDK_OFFSET(0x176A6820)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetAsRogueDialogue_TypeDefinitionIndex = 19420;
