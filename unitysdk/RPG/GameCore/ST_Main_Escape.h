...
#define RPG_GAMECORE_ST_MAIN_ESCAPE_METHOD_4_1F616BEB314669CA_OFFSET UNITYSDK_OFFSET(0x1D4CA850)
#define RPG_GAMECORE_ST_MAIN_ESCAPE_METHOD_4_AC2712B06C27E2BE_OFFSET UNITYSDK_OFFSET(0x1D4CA8F0)
#define RPG_GAMECORE_ST_MAIN_ESCAPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4CA8B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_Escape_TypeDefinitionIndex = 19877;
