...
#define RPG_GAMECORE_ST_MAIN_ESCAPE_METHOD_4_AC2712B06C27E2BE_OFFSET UNITYSDK_OFFSET(0x18DF0BF0)
#define RPG_GAMECORE_ST_MAIN_ESCAPE_METHOD_4_E0080B1904F87FC9_OFFSET UNITYSDK_OFFSET(0x18DF0AD0)
#define RPG_GAMECORE_ST_MAIN_ESCAPE__CTOR_OFFSET UNITYSDK_OFFSET(0x18DF0B70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_Escape_TypeDefinitionIndex = 19040;
