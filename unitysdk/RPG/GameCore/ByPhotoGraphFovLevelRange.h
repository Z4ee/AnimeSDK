...
#define RPG_GAMECORE_BYPHOTOGRAPHFOVLEVELRANGE_METHOD_4_30F9DA37ED1130AC_OFFSET UNITYSDK_OFFSET(0x17038A50)
#define RPG_GAMECORE_BYPHOTOGRAPHFOVLEVELRANGE_METHOD_4_6948A5DFBF35D8F4_OFFSET UNITYSDK_OFFSET(0x17038980)
#define RPG_GAMECORE_BYPHOTOGRAPHFOVLEVELRANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x17038A00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByPhotoGraphFovLevelRange_TypeDefinitionIndex = 19819;
