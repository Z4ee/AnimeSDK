...
#define RPG_GAMECORE_BYPHOTOGRAPHFOVLEVELRANGE_METHOD_4_2FF57240EB188F75_OFFSET UNITYSDK_OFFSET(0x1B2B3A40)
#define RPG_GAMECORE_BYPHOTOGRAPHFOVLEVELRANGE_METHOD_4_30F9DA37ED1130AC_OFFSET UNITYSDK_OFFSET(0x1B2B3A80)
#define RPG_GAMECORE_BYPHOTOGRAPHFOVLEVELRANGE_METHOD_4_43E82D25D25D6153_OFFSET UNITYSDK_OFFSET(0x1B2B3C80)
#define RPG_GAMECORE_BYPHOTOGRAPHFOVLEVELRANGE_METHOD_4_8433860D06B03D9C_OFFSET UNITYSDK_OFFSET(0x1B2B3CB0)
#define RPG_GAMECORE_BYPHOTOGRAPHFOVLEVELRANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2B3A70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByPhotoGraphFovLevelRange_TypeDefinitionIndex = 20851;
