...
#define RPG_GAMECORE_FORCEVULKANDEVICES_METHOD_2_6BB38731CBE015FB_OFFSET UNITYSDK_OFFSET(0x1DCB1A40)
#define RPG_GAMECORE_FORCEVULKANDEVICES__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCB1C00)
