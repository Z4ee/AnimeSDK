...
#define RPG_GAMECORE_SETPROPCABLELINEVISIBLE_METHOD_3_B1133F26E44E972B_OFFSET UNITYSDK_OFFSET(0x19C5BC90)
#define RPG_GAMECORE_SETPROPCABLELINEVISIBLE_METHOD_3_D9A78BD178E02B0D_OFFSET UNITYSDK_OFFSET(0x19C5BC10)
#define RPG_GAMECORE_SETPROPCABLELINEVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C5BC60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetPropCablelineVisible_TypeDefinitionIndex = 20101;
