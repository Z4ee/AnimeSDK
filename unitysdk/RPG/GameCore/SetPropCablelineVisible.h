...
#define RPG_GAMECORE_SETPROPCABLELINEVISIBLE_METHOD_3_B1133F26E44E972B_OFFSET UNITYSDK_OFFSET(0x18E3EF50)
#define RPG_GAMECORE_SETPROPCABLELINEVISIBLE_METHOD_3_D9A78BD178E02B0D_OFFSET UNITYSDK_OFFSET(0x18E3EED0)
#define RPG_GAMECORE_SETPROPCABLELINEVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E3EF20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetPropCablelineVisible_TypeDefinitionIndex = 20244;
