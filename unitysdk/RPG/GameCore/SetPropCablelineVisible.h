...
#define RPG_GAMECORE_SETPROPCABLELINEVISIBLE_METHOD_3_48E2F83BEA976108_OFFSET UNITYSDK_OFFSET(0x1C605A30)
#define RPG_GAMECORE_SETPROPCABLELINEVISIBLE_METHOD_3_B1133F26E44E972B_OFFSET UNITYSDK_OFFSET(0x1C605A70)
#define RPG_GAMECORE_SETPROPCABLELINEVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C605A60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetPropCablelineVisible_TypeDefinitionIndex = 20473;
