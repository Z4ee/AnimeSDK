...
#define RPG_GAMECORE_STAGEPVSOFFLINESCENEITEMINFO_METHOD_2_072711BD8F16EBED_OFFSET UNITYSDK_OFFSET(0x1B0B2F80)
#define RPG_GAMECORE_STAGEPVSOFFLINESCENEITEMINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0B31E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StagePVSOfflineSceneItemInfo_TypeDefinitionIndex = 18433;
