...
#define RPG_GAMECORE_STAGEPVSOFFLINESCENEITEMINFO_METHOD_2_072711BD8F16EBED_OFFSET UNITYSDK_OFFSET(0x18E901B0)
#define RPG_GAMECORE_STAGEPVSOFFLINESCENEITEMINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18E90410)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StagePVSOfflineSceneItemInfo_TypeDefinitionIndex = 18207;
