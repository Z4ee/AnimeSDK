...
#define RPG_GAMECORE_STAGEPVSOFFLINESCENEITEMINFO_METHOD_2_072711BD8F16EBED_OFFSET UNITYSDK_OFFSET(0x1D55B680)
#define RPG_GAMECORE_STAGEPVSOFFLINESCENEITEMINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D55B8E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StagePVSOfflineSceneItemInfo_TypeDefinitionIndex = 18957;
