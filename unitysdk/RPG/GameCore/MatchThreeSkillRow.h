...
#define RPG_GAMECORE_MATCHTHREESKILLROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D2503F0)
#define RPG_GAMECORE_MATCHTHREESKILLROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2506E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MatchThreeSkillRow_TypeDefinitionIndex = 11882;

	class MatchThreeSkillRow : public ::System::Object
	{
	public:
		::System::String* SkillChargedImg; // 0x10
		::System::String* SkillUnchangedImg; // 0x18
		::System::String* SkillJson; // 0x20
		::System::String* BirdSkillTrailEffectPath; // 0x28
		::System::String* DescFigure; // 0x30
