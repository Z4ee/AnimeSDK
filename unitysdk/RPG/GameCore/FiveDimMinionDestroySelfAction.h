...
#define RPG_GAMECORE_FIVEDIMMINIONDESTROYSELFACTION_METHOD_3_D130B99AEC10F8F8_OFFSET UNITYSDK_OFFSET(0x1BEA1530)
#define RPG_GAMECORE_FIVEDIMMINIONDESTROYSELFACTION_METHOD_3_E97EF847F4168D35_OFFSET UNITYSDK_OFFSET(0x1BEA1610)
#define RPG_GAMECORE_FIVEDIMMINIONDESTROYSELFACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEA1600)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimMinionDestroySelfAction_TypeDefinitionIndex = 18011;
