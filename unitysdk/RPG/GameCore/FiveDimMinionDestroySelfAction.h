...
#define RPG_GAMECORE_FIVEDIMMINIONDESTROYSELFACTION_METHOD_3_E97EF847F4168D35_OFFSET UNITYSDK_OFFSET(0x1890BA00)
#define RPG_GAMECORE_FIVEDIMMINIONDESTROYSELFACTION_METHOD_3_FEA35B265E4F72A1_OFFSET UNITYSDK_OFFSET(0x1890B8D0)
#define RPG_GAMECORE_FIVEDIMMINIONDESTROYSELFACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1890B9E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimMinionDestroySelfAction_TypeDefinitionIndex = 17807;
