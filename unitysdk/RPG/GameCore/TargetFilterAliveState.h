...
#define RPG_GAMECORE_TARGETFILTERALIVESTATE_METHOD_3_2BE24600F177F6F6_OFFSET UNITYSDK_OFFSET(0x18EE65D0)
#define RPG_GAMECORE_TARGETFILTERALIVESTATE_METHOD_3_A09B881C660D7ADA_OFFSET UNITYSDK_OFFSET(0x18EE6660)
#define RPG_GAMECORE_TARGETFILTERALIVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18EE6640)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFilterAliveState_TypeDefinitionIndex = 22896;
