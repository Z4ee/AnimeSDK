...
#define RPG_GAMECORE_TARGETFILTERALIVESTATE_METHOD_3_34B859CE10C0E24A_OFFSET UNITYSDK_OFFSET(0x1E1B8760)
#define RPG_GAMECORE_TARGETFILTERALIVESTATE_METHOD_3_80E5135060B96801_OFFSET UNITYSDK_OFFSET(0x1E1B8650)
#define RPG_GAMECORE_TARGETFILTERALIVESTATE_METHOD_3_A09B881C660D7ADA_OFFSET UNITYSDK_OFFSET(0x1E1B8690)
#define RPG_GAMECORE_TARGETFILTERALIVESTATE_METHOD_3_E32E06B639EF9F9B_OFFSET UNITYSDK_OFFSET(0x1E1B8730)
#define RPG_GAMECORE_TARGETFILTERALIVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1B8680)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFilterAliveState_TypeDefinitionIndex = 23630;
