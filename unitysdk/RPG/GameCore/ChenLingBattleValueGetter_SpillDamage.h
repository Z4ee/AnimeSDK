...
#define RPG_GAMECORE_CHENLINGBATTLEVALUEGETTER_SPILLDAMAGE_METHOD_3_1915202FB87CFBA7_OFFSET UNITYSDK_OFFSET(0x170835B0)
#define RPG_GAMECORE_CHENLINGBATTLEVALUEGETTER_SPILLDAMAGE_METHOD_3_B14750C4C9602B36_OFFSET UNITYSDK_OFFSET(0x17083650)
#define RPG_GAMECORE_CHENLINGBATTLEVALUEGETTER_SPILLDAMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x17083640)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleValueGetter_SpillDamage_TypeDefinitionIndex = 14498;
