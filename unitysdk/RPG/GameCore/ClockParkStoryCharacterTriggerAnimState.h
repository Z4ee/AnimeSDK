...
#define RPG_GAMECORE_CLOCKPARKSTORYCHARACTERTRIGGERANIMSTATE_METHOD_3_5FF0111E1C51CE68_OFFSET UNITYSDK_OFFSET(0x1881F4E0)
#define RPG_GAMECORE_CLOCKPARKSTORYCHARACTERTRIGGERANIMSTATE_METHOD_3_7725889BB4B82295_OFFSET UNITYSDK_OFFSET(0x1881F560)
#define RPG_GAMECORE_CLOCKPARKSTORYCHARACTERTRIGGERANIMSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1881F530)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClockParkStoryCharacterTriggerAnimState_TypeDefinitionIndex = 19933;
