...
#define RPG_GAMECORE_UNIVERSALHOTFIXBASEPREDICATE_METHOD_4_97D2EAC174F075A4_OFFSET UNITYSDK_OFFSET(0x178E5320)
#define RPG_GAMECORE_UNIVERSALHOTFIXBASEPREDICATE_METHOD_4_B8B4575AB9CB3BDD_OFFSET UNITYSDK_OFFSET(0x178E4F80)
#define RPG_GAMECORE_UNIVERSALHOTFIXBASEPREDICATE__CTOR_OFFSET UNITYSDK_OFFSET(0x178E52D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UniversalHotFixBasePredicate_TypeDefinitionIndex = 21587;
