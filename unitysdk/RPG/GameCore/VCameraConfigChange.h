...
#define RPG_GAMECORE_VCAMERACONFIGCHANGE_METHOD_3_4134187906C32F3C_OFFSET UNITYSDK_OFFSET(0x190EB410)
#define RPG_GAMECORE_VCAMERACONFIGCHANGE_METHOD_3_F65C54B5219F931E_OFFSET UNITYSDK_OFFSET(0x190EB5D0)
#define RPG_GAMECORE_VCAMERACONFIGCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x190EB5A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VCameraConfigChange_TypeDefinitionIndex = 22713;
