...
#define RPG_GAMECORE_BYCOMPARESKILLBPCHANGEPREVIEW_METHOD_4_04F8727BE56DAA96_OFFSET UNITYSDK_OFFSET(0x1CEFB610)
#define RPG_GAMECORE_BYCOMPARESKILLBPCHANGEPREVIEW_METHOD_4_2D8B74C0AB2099EA_OFFSET UNITYSDK_OFFSET(0x1CEFB2C0)
#define RPG_GAMECORE_BYCOMPARESKILLBPCHANGEPREVIEW_METHOD_4_60A5D96F47A38267_OFFSET UNITYSDK_OFFSET(0x1CEFB300)
#define RPG_GAMECORE_BYCOMPARESKILLBPCHANGEPREVIEW_METHOD_4_CF0F80A55FB203F9_OFFSET UNITYSDK_OFFSET(0x1CEFB5E0)
#define RPG_GAMECORE_BYCOMPARESKILLBPCHANGEPREVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEFB2F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareSkillBPChangePreview_TypeDefinitionIndex = 23243;
