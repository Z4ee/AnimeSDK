...
#define RPG_GAMECORE_CHIMERADUELENTITYVALUESUM_METHOD_3_5DD26F4E221745F6_OFFSET UNITYSDK_OFFSET(0x1709B600)
#define RPG_GAMECORE_CHIMERADUELENTITYVALUESUM_METHOD_3_9DA2D2E892D30CFE_OFFSET UNITYSDK_OFFSET(0x1709B760)
#define RPG_GAMECORE_CHIMERADUELENTITYVALUESUM__CTOR_OFFSET UNITYSDK_OFFSET(0x1709B5F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelEntityValueSum_TypeDefinitionIndex = 14617;
