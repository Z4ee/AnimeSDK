...
#define RPG_GAMECORE_UNLOCKPLAYERCONTROL_METHOD_3_68BD2096583EA79C_OFFSET UNITYSDK_OFFSET(0x1D2ADAD0)
#define RPG_GAMECORE_UNLOCKPLAYERCONTROL_METHOD_3_9DEC67959DDD1517_OFFSET UNITYSDK_OFFSET(0x1D2ADA80)
#define RPG_GAMECORE_UNLOCKPLAYERCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2ADAC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UnLockPlayerControl_TypeDefinitionIndex = 20061;
