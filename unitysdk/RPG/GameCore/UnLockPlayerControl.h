...
#define RPG_GAMECORE_UNLOCKPLAYERCONTROL_METHOD_3_68BD2096583EA79C_OFFSET UNITYSDK_OFFSET(0x19E32CF0)
#define RPG_GAMECORE_UNLOCKPLAYERCONTROL_METHOD_3_995A8D825D1F7B2D_OFFSET UNITYSDK_OFFSET(0x19E32C70)
#define RPG_GAMECORE_UNLOCKPLAYERCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x19E32CC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UnLockPlayerControl_TypeDefinitionIndex = 19159;
