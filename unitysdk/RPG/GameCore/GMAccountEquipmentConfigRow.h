...
#define RPG_GAMECORE_GMACCOUNTEQUIPMENTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x172251D0)
#define RPG_GAMECORE_GMACCOUNTEQUIPMENTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x172253C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GMAccountEquipmentConfigRow_TypeDefinitionIndex = 12183;

	class GMAccountEquipmentConfigRow : public ::System::Object
	{
	public:
		::System::UInt32 ItemEquipmentID; // 0x10
		::System::UInt32 GroupID; // 0x14
		::System::UInt32 ItemEquipmentNum; // 0x18
		::System::UInt32 ID; // 0x1C
		::System::UInt32 ItemEquipmentLevel; // 0x20
