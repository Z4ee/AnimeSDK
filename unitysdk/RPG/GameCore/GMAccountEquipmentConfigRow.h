...
#define RPG_GAMECORE_GMACCOUNTEQUIPMENTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B984DB0)
#define RPG_GAMECORE_GMACCOUNTEQUIPMENTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B984FA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GMAccountEquipmentConfigRow_TypeDefinitionIndex = 12843;

	class GMAccountEquipmentConfigRow : public ::System::Object
	{
	public:
		::System::UInt32 GroupID; // 0x10
		::System::UInt32 ItemEquipmentNum; // 0x14
