...
#define RPG_GAMECORE_SETDITHERGROUP_METHOD_3_A6B25F25C67E701F_OFFSET UNITYSDK_OFFSET(0x176B23A0)
#define RPG_GAMECORE_SETDITHERGROUP_METHOD_3_B75B7931A16809D4_OFFSET UNITYSDK_OFFSET(0x176B2320)
#define RPG_GAMECORE_SETDITHERGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x176B2370)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDitherGroup_TypeDefinitionIndex = 21107;
