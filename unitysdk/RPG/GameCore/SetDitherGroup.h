...
#define RPG_GAMECORE_SETDITHERGROUP_METHOD_3_2639B0D9B79BE1CA_OFFSET UNITYSDK_OFFSET(0x1E817010)
#define RPG_GAMECORE_SETDITHERGROUP_METHOD_3_A6B25F25C67E701F_OFFSET UNITYSDK_OFFSET(0x1E817050)
#define RPG_GAMECORE_SETDITHERGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1E817040)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDitherGroup_TypeDefinitionIndex = 22655;
