...
#define RPG_GAMECORE_SETDITHERGROUP_METHOD_3_A6B25F25C67E701F_OFFSET UNITYSDK_OFFSET(0x19C33AA0)
#define RPG_GAMECORE_SETDITHERGROUP_METHOD_3_B75B7931A16809D4_OFFSET UNITYSDK_OFFSET(0x19C33A20)
#define RPG_GAMECORE_SETDITHERGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x19C33A70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDitherGroup_TypeDefinitionIndex = 21661;
