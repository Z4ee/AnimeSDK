...
#define RPG_GAMECORE_PROPERTYADSORPTIONCONFIG_METHOD_2_E35973DF0AD0AA2F_OFFSET UNITYSDK_OFFSET(0x18C7D730)
#define RPG_GAMECORE_PROPERTYADSORPTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18C7D8A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropertyAdsorptionConfig_TypeDefinitionIndex = 16211;
