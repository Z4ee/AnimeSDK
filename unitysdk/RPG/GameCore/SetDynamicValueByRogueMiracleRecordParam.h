...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEMIRACLERECORDPARAM_METHOD_4_5605CFE452016ECE_OFFSET UNITYSDK_OFFSET(0x19C43BD0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEMIRACLERECORDPARAM_METHOD_4_D9178CA14FCAAF2E_OFFSET UNITYSDK_OFFSET(0x19C43C60)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEMIRACLERECORDPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x19C43C30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRogueMiracleRecordParam_TypeDefinitionIndex = 20560;
