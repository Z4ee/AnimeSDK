...
#define RPG_GAMECORE_PASSIVEUNITEFFECTTYPEMATCHFACTORCONFIG_METHOD_2_D1E8B20D52FC6308_OFFSET UNITYSDK_OFFSET(0x199E8570)
#define RPG_GAMECORE_PASSIVEUNITEFFECTTYPEMATCHFACTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x199E86B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PassiveUnitEffectTypeMatchFactorConfig_TypeDefinitionIndex = 17034;
