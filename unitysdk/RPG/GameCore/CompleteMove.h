...
#define RPG_GAMECORE_COMPLETEMOVE_METHOD_3_042258C6C818EAED_OFFSET UNITYSDK_OFFSET(0x1D9A7560)
#define RPG_GAMECORE_COMPLETEMOVE_METHOD_3_21A9ADA309925F5C_OFFSET UNITYSDK_OFFSET(0x1D9A7600)
#define RPG_GAMECORE_COMPLETEMOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D9A75C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CompleteMove_TypeDefinitionIndex = 22215;
