...
#define RPG_GAMECORE_SETATTACHMENTVISIBILITY_METHOD_3_08872094B51770A9_OFFSET UNITYSDK_OFFSET(0x18E09F30)
#define RPG_GAMECORE_SETATTACHMENTVISIBILITY_METHOD_3_22B19C17F28E85E6_OFFSET UNITYSDK_OFFSET(0x18E09D70)
#define RPG_GAMECORE_SETATTACHMENTVISIBILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x18E09F00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetAttachmentVisibility_TypeDefinitionIndex = 21255;
