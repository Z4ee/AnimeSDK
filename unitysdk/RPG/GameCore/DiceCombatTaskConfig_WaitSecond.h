...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_WAITSECOND_METHOD_3_96F9A548B6430D6B_OFFSET UNITYSDK_OFFSET(0x1C11B5C0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_WAITSECOND_METHOD_3_C728DF25074401F7_OFFSET UNITYSDK_OFFSET(0x1C11B4E0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_WAITSECOND__CTOR_OFFSET UNITYSDK_OFFSET(0x1C11B5B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_WaitSecond_TypeDefinitionIndex = 15424;
