...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_WAITSECOND_METHOD_3_35B6178C277BAF5D_OFFSET UNITYSDK_OFFSET(0x171719D0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_WAITSECOND_METHOD_3_96F9A548B6430D6B_OFFSET UNITYSDK_OFFSET(0x1716F290)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_WAITSECOND__CTOR_OFFSET UNITYSDK_OFFSET(0x1716F240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_WaitSecond_TypeDefinitionIndex = 14730;
