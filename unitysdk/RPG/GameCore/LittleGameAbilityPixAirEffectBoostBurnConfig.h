...
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTBOOSTBURNCONFIG_METHOD_3_A47E98A0B5D442D1_OFFSET UNITYSDK_OFFSET(0x1B0933E0)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTBOOSTBURNCONFIG_METHOD_3_D402B4A6C9B4439D_OFFSET UNITYSDK_OFFSET(0x1B093310)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTBOOSTBURNCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0933D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityPixAirEffectBoostBurnConfig_TypeDefinitionIndex = 20554;
