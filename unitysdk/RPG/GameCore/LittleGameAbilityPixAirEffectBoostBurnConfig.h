...
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTBOOSTBURNCONFIG_METHOD_3_A47E98A0B5D442D1_OFFSET UNITYSDK_OFFSET(0x1D1F9C70)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTBOOSTBURNCONFIG_METHOD_3_D402B4A6C9B4439D_OFFSET UNITYSDK_OFFSET(0x1D1F9BA0)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTBOOSTBURNCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1F9C60)
