...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERCONSTTIMECONFIG_METHOD_3_5C042951950CF2A1_OFFSET UNITYSDK_OFFSET(0x1C5D0ED0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERCONSTTIMECONFIG_METHOD_3_81784BFAE163A405_OFFSET UNITYSDK_OFFSET(0x1C5D0F20)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERCONSTTIMECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5D0F10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierExecActionAfterConstTimeConfig_TypeDefinitionIndex = 18672;
