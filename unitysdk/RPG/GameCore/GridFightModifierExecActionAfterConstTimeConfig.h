...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERCONSTTIMECONFIG_METHOD_3_81784BFAE163A405_OFFSET UNITYSDK_OFFSET(0x189B8870)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERCONSTTIMECONFIG_METHOD_3_B11241FCEC52176C_OFFSET UNITYSDK_OFFSET(0x189BBD80)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERCONSTTIMECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189B8820)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierExecActionAfterConstTimeConfig_TypeDefinitionIndex = 18452;
