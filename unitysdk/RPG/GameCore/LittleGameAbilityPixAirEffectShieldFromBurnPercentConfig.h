...
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTSHIELDFROMBURNPERCENTCONFIG_METHOD_3_9EF760E1F94318B6_OFFSET UNITYSDK_OFFSET(0x1D1FAC30)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTSHIELDFROMBURNPERCENTCONFIG_METHOD_3_C93B3AAFABC8A5EA_OFFSET UNITYSDK_OFFSET(0x1D1FAB60)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTSHIELDFROMBURNPERCENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1FAC20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityPixAirEffectShieldFromBurnPercentConfig_TypeDefinitionIndex = 21115;
