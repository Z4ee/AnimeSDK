...
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTSHIELDFROMBURNPERCENTCONFIG_METHOD_3_9EF760E1F94318B6_OFFSET UNITYSDK_OFFSET(0x1B0943A0)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTSHIELDFROMBURNPERCENTCONFIG_METHOD_3_C93B3AAFABC8A5EA_OFFSET UNITYSDK_OFFSET(0x1B0942D0)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTSHIELDFROMBURNPERCENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B094390)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityPixAirEffectShieldFromBurnPercentConfig_TypeDefinitionIndex = 20563;
