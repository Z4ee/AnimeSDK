...
#define RPG_GAMECORE_WAITPROPPUZZLELOADINGFINISH_METHOD_3_4AE7B799289E1DE0_OFFSET UNITYSDK_OFFSET(0x17901890)
#define RPG_GAMECORE_WAITPROPPUZZLELOADINGFINISH_METHOD_3_D8CF9AFD4DD342D9_OFFSET UNITYSDK_OFFSET(0x17901910)
#define RPG_GAMECORE_WAITPROPPUZZLELOADINGFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x179018E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitPropPuzzleLoadingFinish_TypeDefinitionIndex = 20354;
