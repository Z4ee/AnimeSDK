...
#define RPG_GAMECORE_ADVPAUSETICKVALUE_METHOD_3_022F8D0496410D6A_OFFSET UNITYSDK_OFFSET(0x16F3AF10)
#define RPG_GAMECORE_ADVPAUSETICKVALUE_METHOD_3_595369525D267497_OFFSET UNITYSDK_OFFSET(0x16F3AFE0)
#define RPG_GAMECORE_ADVPAUSETICKVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F3AF90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvPauseTickValue_TypeDefinitionIndex = 19352;
