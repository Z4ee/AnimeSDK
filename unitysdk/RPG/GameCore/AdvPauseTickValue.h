...
#define RPG_GAMECORE_ADVPAUSETICKVALUE_METHOD_3_2E3E32BB24729273_OFFSET UNITYSDK_OFFSET(0x1BE27BF0)
#define RPG_GAMECORE_ADVPAUSETICKVALUE_METHOD_3_595369525D267497_OFFSET UNITYSDK_OFFSET(0x1BE27C90)
#define RPG_GAMECORE_ADVPAUSETICKVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE27C50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvPauseTickValue_TypeDefinitionIndex = 20237;
