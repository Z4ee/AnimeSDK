...
#define RPG_GAMECORE_ADVPAUSETICKVALUE_METHOD_3_022F8D0496410D6A_OFFSET UNITYSDK_OFFSET(0x1865D0A0)
#define RPG_GAMECORE_ADVPAUSETICKVALUE_METHOD_3_595369525D267497_OFFSET UNITYSDK_OFFSET(0x1865D170)
#define RPG_GAMECORE_ADVPAUSETICKVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1865D120)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvPauseTickValue_TypeDefinitionIndex = 20011;
