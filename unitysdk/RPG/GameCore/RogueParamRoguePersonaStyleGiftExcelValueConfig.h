...
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONASTYLEGIFTEXCELVALUECONFIG_METHOD_6_0F3375444DD7F5CA_OFFSET UNITYSDK_OFFSET(0x1D176FD0)
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONASTYLEGIFTEXCELVALUECONFIG_METHOD_6_1514FE74A3B4B626_OFFSET UNITYSDK_OFFSET(0x1D177020)
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONASTYLEGIFTEXCELVALUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D177010)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamRoguePersonaStyleGiftExcelValueConfig_TypeDefinitionIndex = 19095;
