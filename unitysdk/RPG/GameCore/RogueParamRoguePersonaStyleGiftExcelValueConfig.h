...
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONASTYLEGIFTEXCELVALUECONFIG_METHOD_6_1514FE74A3B4B626_OFFSET UNITYSDK_OFFSET(0x1764F2E0)
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONASTYLEGIFTEXCELVALUECONFIG_METHOD_6_A5CC3E5FADFCD0D0_OFFSET UNITYSDK_OFFSET(0x1764F030)
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONASTYLEGIFTEXCELVALUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1764F1B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamRoguePersonaStyleGiftExcelValueConfig_TypeDefinitionIndex = 18202;
