...
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONASTYLEGIFTEXCELVALUECONFIG_METHOD_6_1514FE74A3B4B626_OFFSET UNITYSDK_OFFSET(0x19BB23B0)
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONASTYLEGIFTEXCELVALUECONFIG_METHOD_6_A5CC3E5FADFCD0D0_OFFSET UNITYSDK_OFFSET(0x19BB2100)
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONASTYLEGIFTEXCELVALUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19BB2280)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamRoguePersonaStyleGiftExcelValueConfig_TypeDefinitionIndex = 18814;
