...
#define RPG_GAMECORE_SHOWGROUPCHALLENGESELECTPAGE_METHOD_3_1AF782787197DF13_OFFSET UNITYSDK_OFFSET(0x1D093870)
#define RPG_GAMECORE_SHOWGROUPCHALLENGESELECTPAGE_METHOD_3_69FC58A14733B930_OFFSET UNITYSDK_OFFSET(0x1D093820)
#define RPG_GAMECORE_SHOWGROUPCHALLENGESELECTPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D093860)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowGroupChallengeSelectPage_TypeDefinitionIndex = 21372;
