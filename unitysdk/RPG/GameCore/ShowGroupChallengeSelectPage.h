...
#define RPG_GAMECORE_SHOWGROUPCHALLENGESELECTPAGE_METHOD_3_1AF782787197DF13_OFFSET UNITYSDK_OFFSET(0x176FBC80)
#define RPG_GAMECORE_SHOWGROUPCHALLENGESELECTPAGE_METHOD_3_33B3DF9854B71E15_OFFSET UNITYSDK_OFFSET(0x176FBBF0)
#define RPG_GAMECORE_SHOWGROUPCHALLENGESELECTPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x176FBC50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowGroupChallengeSelectPage_TypeDefinitionIndex = 19779;
