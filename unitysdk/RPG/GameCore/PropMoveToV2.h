...
#define RPG_GAMECORE_PROPMOVETOV2_METHOD_3_0F87B71F02783BC3_OFFSET UNITYSDK_OFFSET(0x18C70BE0)
#define RPG_GAMECORE_PROPMOVETOV2_METHOD_3_702092C0F916397C_OFFSET UNITYSDK_OFFSET(0x18C70D80)
#define RPG_GAMECORE_PROPMOVETOV2__CTOR_OFFSET UNITYSDK_OFFSET(0x18C70CC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropMoveToV2_TypeDefinitionIndex = 20817;
	...
	public:
		...
		static ::System::Void Method_3_0F87B71F02783BC3(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::PropMoveToV2*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::PropMoveToV2*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_PROPMOVETOV2_METHOD_3_0F87B71F02783BC3_OFFSET))(a1, a2);
		}
