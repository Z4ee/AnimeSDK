...
#define RPG_GAMECORE_CHRONICLECUSTOMSHOWCONDITION_METHOD_2_E67DD0DD8C0FBBB9_OFFSET UNITYSDK_OFFSET(0x1964EF60)
#define RPG_GAMECORE_CHRONICLECUSTOMSHOWCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1964F070)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChronicleCustomShowCondition_TypeDefinitionIndex = 18024;
