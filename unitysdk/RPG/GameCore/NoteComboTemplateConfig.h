...
#define RPG_GAMECORE_NOTECOMBOTEMPLATECONFIG_METHOD_2_05E5C725B4123FF6_OFFSET UNITYSDK_OFFSET(0x199CF350)
#define RPG_GAMECORE_NOTECOMBOTEMPLATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x199CF390)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NoteComboTemplateConfig_TypeDefinitionIndex = 16109;
