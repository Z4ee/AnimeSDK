...
#define RPG_GAMECORE_SETNAVMESHSTATE_METHOD_3_3258037F0DBBC9CB_OFFSET UNITYSDK_OFFSET(0x18E3D270)
#define RPG_GAMECORE_SETNAVMESHSTATE_METHOD_3_7B920410862438EF_OFFSET UNITYSDK_OFFSET(0x18E3D2F0)
#define RPG_GAMECORE_SETNAVMESHSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E3D2C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetNavMeshState_TypeDefinitionIndex = 21103;
