...
#define RPG_GAMECORE_MONOPOLYSHOWSWITCHTRANSITION_METHOD_3_40F2A9C3F0B23385_OFFSET UNITYSDK_OFFSET(0x199A4F80)
#define RPG_GAMECORE_MONOPOLYSHOWSWITCHTRANSITION_METHOD_3_A811CD5B89553F94_OFFSET UNITYSDK_OFFSET(0x199A4F00)
#define RPG_GAMECORE_MONOPOLYSHOWSWITCHTRANSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x199A4F50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonopolyShowSwitchTransition_TypeDefinitionIndex = 19788;
