...
#define RPG_GAMECORE_MONOPOLYSHOWSWITCHTRANSITION_METHOD_3_2B06E987C8D12EC6_OFFSET UNITYSDK_OFFSET(0x1D2CB710)
#define RPG_GAMECORE_MONOPOLYSHOWSWITCHTRANSITION_METHOD_3_40F2A9C3F0B23385_OFFSET UNITYSDK_OFFSET(0x1D2CB750)
#define RPG_GAMECORE_MONOPOLYSHOWSWITCHTRANSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2CB740)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonopolyShowSwitchTransition_TypeDefinitionIndex = 20698;
