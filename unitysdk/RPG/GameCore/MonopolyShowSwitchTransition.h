...
#define RPG_GAMECORE_MONOPOLYSHOWSWITCHTRANSITION_METHOD_3_40F2A9C3F0B23385_OFFSET UNITYSDK_OFFSET(0x18B55360)
#define RPG_GAMECORE_MONOPOLYSHOWSWITCHTRANSITION_METHOD_3_A811CD5B89553F94_OFFSET UNITYSDK_OFFSET(0x18B552E0)
#define RPG_GAMECORE_MONOPOLYSHOWSWITCHTRANSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x18B55330)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonopolyShowSwitchTransition_TypeDefinitionIndex = 19925;
