...
#define RPG_GAMECORE_CHIMERADUELENTITYPREDICATEBASE_METHOD_2_BBBCA82BCC0BD503_OFFSET UNITYSDK_OFFSET(0x187FA700)
#define RPG_GAMECORE_CHIMERADUELENTITYPREDICATEBASE_METHOD_2_D50AF52EA84BC575_OFFSET UNITYSDK_OFFSET(0x187F5080)
#define RPG_GAMECORE_CHIMERADUELENTITYPREDICATEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x187F9F30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelEntityPredicateBase_TypeDefinitionIndex = 15081;
