...
#define RPG_GAMECORE_CHIMERADUELENTITYPREDICATEBASE_METHOD_2_7E908F261CE5CEF1_OFFSET UNITYSDK_OFFSET(0x1C23D9C0)
#define RPG_GAMECORE_CHIMERADUELENTITYPREDICATEBASE_METHOD_2_BBBCA82BCC0BD503_OFFSET UNITYSDK_OFFSET(0x1C23E250)
#define RPG_GAMECORE_CHIMERADUELENTITYPREDICATEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C23E100)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelEntityPredicateBase_TypeDefinitionIndex = 15308;
