...
#define RPG_GAMECORE_CHIMERADUELENTITYPREDICATEBASE_METHOD_2_7E908F261CE5CEF1_OFFSET UNITYSDK_OFFSET(0x19636F90)
#define RPG_GAMECORE_CHIMERADUELENTITYPREDICATEBASE_METHOD_2_BBBCA82BCC0BD503_OFFSET UNITYSDK_OFFSET(0x1963C8D0)
#define RPG_GAMECORE_CHIMERADUELENTITYPREDICATEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1963C0F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelEntityPredicateBase_TypeDefinitionIndex = 15144;
