...
#define RPG_GAMECORE_STACKEXTRASTANCE_METHOD_3_64F0E87E53332B6E_OFFSET UNITYSDK_OFFSET(0x18E86A00)
#define RPG_GAMECORE_STACKEXTRASTANCE_METHOD_3_9C270A0A4E33E734_OFFSET UNITYSDK_OFFSET(0x18E86890)
#define RPG_GAMECORE_STACKEXTRASTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E86960)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StackExtraStance_TypeDefinitionIndex = 21519;
