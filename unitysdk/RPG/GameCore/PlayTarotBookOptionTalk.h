...
#define RPG_GAMECORE_PLAYTAROTBOOKOPTIONTALK_METHOD_3_1ADF9FFEB2397BFA_OFFSET UNITYSDK_OFFSET(0x174C73D0)
#define RPG_GAMECORE_PLAYTAROTBOOKOPTIONTALK_METHOD_3_9DAA71DD179A0583_OFFSET UNITYSDK_OFFSET(0x174C7350)
#define RPG_GAMECORE_PLAYTAROTBOOKOPTIONTALK__CTOR_OFFSET UNITYSDK_OFFSET(0x174C73A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayTarotBookOptionTalk_TypeDefinitionIndex = 19445;
