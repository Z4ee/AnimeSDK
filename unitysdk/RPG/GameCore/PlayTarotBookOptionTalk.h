...
#define RPG_GAMECORE_PLAYTAROTBOOKOPTIONTALK_METHOD_3_1ADF9FFEB2397BFA_OFFSET UNITYSDK_OFFSET(0x1D7A8E60)
#define RPG_GAMECORE_PLAYTAROTBOOKOPTIONTALK_METHOD_3_34359ABE382B2AF1_OFFSET UNITYSDK_OFFSET(0x1D7A8E20)
#define RPG_GAMECORE_PLAYTAROTBOOKOPTIONTALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7A8E50)
