...
#define RPG_GAMECORE_PLAYTAROTBOOKOPTIONTALK_METHOD_3_1ADF9FFEB2397BFA_OFFSET UNITYSDK_OFFSET(0x18C12A40)
#define RPG_GAMECORE_PLAYTAROTBOOKOPTIONTALK_METHOD_3_9DAA71DD179A0583_OFFSET UNITYSDK_OFFSET(0x18C129C0)
#define RPG_GAMECORE_PLAYTAROTBOOKOPTIONTALK__CTOR_OFFSET UNITYSDK_OFFSET(0x18C12A10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayTarotBookOptionTalk_TypeDefinitionIndex = 20118;
