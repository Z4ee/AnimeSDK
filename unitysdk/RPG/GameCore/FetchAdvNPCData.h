...
#define RPG_GAMECORE_FETCHADVNPCDATA_METHOD_2_9850D7BFB02D5F74_OFFSET UNITYSDK_OFFSET(0x171CE540)
#define RPG_GAMECORE_FETCHADVNPCDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x171CE660)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FetchAdvNPCData_TypeDefinitionIndex = 22138;
