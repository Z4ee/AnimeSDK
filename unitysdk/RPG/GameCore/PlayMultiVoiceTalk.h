...
#define RPG_GAMECORE_PLAYMULTIVOICETALK_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1BA042C0)
#define RPG_GAMECORE_PLAYMULTIVOICETALK_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1BA04270)
#define RPG_GAMECORE_PLAYMULTIVOICETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA042B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayMultiVoiceTalk_TypeDefinitionIndex = 20328;
