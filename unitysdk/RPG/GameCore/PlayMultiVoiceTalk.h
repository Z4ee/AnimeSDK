...
#define RPG_GAMECORE_PLAYMULTIVOICETALK_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x174C2EF0)
#define RPG_GAMECORE_PLAYMULTIVOICETALK_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x174C2E70)
#define RPG_GAMECORE_PLAYMULTIVOICETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x174C2EC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayMultiVoiceTalk_TypeDefinitionIndex = 19426;
