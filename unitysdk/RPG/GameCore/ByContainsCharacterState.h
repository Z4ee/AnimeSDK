...
#define RPG_GAMECORE_BYCONTAINSCHARACTERSTATE_METHOD_4_47A03D34BB0E94B1_OFFSET UNITYSDK_OFFSET(0x1701DEC0)
#define RPG_GAMECORE_BYCONTAINSCHARACTERSTATE_METHOD_4_9AB8A5D627B4FBC6_OFFSET UNITYSDK_OFFSET(0x1701DFF0)
#define RPG_GAMECORE_BYCONTAINSCHARACTERSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1701DF70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByContainsCharacterState_TypeDefinitionIndex = 20952;
