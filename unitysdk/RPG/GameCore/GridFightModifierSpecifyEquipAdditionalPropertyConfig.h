...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSPECIFYEQUIPADDITIONALPROPERTYCONFIG_METHOD_3_A3DF1A5DD80966DB_OFFSET UNITYSDK_OFFSET(0x1D06B450)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSPECIFYEQUIPADDITIONALPROPERTYCONFIG_METHOD_3_C2F5F39D42EEF277_OFFSET UNITYSDK_OFFSET(0x1D06B400)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSPECIFYEQUIPADDITIONALPROPERTYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D06B440)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierSpecifyEquipAdditionalPropertyConfig_TypeDefinitionIndex = 18628;
