...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSPECIFYEQUIPADDITIONALPROPERTYCONFIG_METHOD_3_A3DF1A5DD80966DB_OFFSET UNITYSDK_OFFSET(0x189C01E0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSPECIFYEQUIPADDITIONALPROPERTYCONFIG_METHOD_3_E98992F0C1DCC842_OFFSET UNITYSDK_OFFSET(0x189C0110)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSPECIFYEQUIPADDITIONALPROPERTYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189C0190)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierSpecifyEquipAdditionalPropertyConfig_TypeDefinitionIndex = 18411;
