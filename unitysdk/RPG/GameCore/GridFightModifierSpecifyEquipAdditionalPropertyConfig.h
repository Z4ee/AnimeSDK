...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSPECIFYEQUIPADDITIONALPROPERTYCONFIG_METHOD_3_A3DF1A5DD80966DB_OFFSET UNITYSDK_OFFSET(0x1726CC70)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSPECIFYEQUIPADDITIONALPROPERTYCONFIG_METHOD_3_E98992F0C1DCC842_OFFSET UNITYSDK_OFFSET(0x1726CBA0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSPECIFYEQUIPADDITIONALPROPERTYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1726CC20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierSpecifyEquipAdditionalPropertyConfig_TypeDefinitionIndex = 17793;
