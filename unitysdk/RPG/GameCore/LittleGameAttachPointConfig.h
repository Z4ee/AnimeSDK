...
#define RPG_GAMECORE_LITTLEGAMEATTACHPOINTCONFIG_METHOD_2_B910B4E571CB8078_OFFSET UNITYSDK_OFFSET(0x1DD66F60)
#define RPG_GAMECORE_LITTLEGAMEATTACHPOINTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD67020)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAttachPointConfig_TypeDefinitionIndex = 18645;
