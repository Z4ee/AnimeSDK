...
#define RPG_GAMECORE_LITTLEGAMEATTACHPOINTCONFIG_METHOD_2_B910B4E571CB8078_OFFSET UNITYSDK_OFFSET(0x1D1FED60)
#define RPG_GAMECORE_LITTLEGAMEATTACHPOINTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1FEE20)
