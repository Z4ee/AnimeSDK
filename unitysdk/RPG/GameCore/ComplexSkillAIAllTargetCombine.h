...
#define RPG_GAMECORE_COMPLEXSKILLAIALLTARGETCOMBINE_METHOD_3_8583C4CF0111BB0E_OFFSET UNITYSDK_OFFSET(0x17121E60)
#define RPG_GAMECORE_COMPLEXSKILLAIALLTARGETCOMBINE_METHOD_3_8845FB3A1EC18CCA_OFFSET UNITYSDK_OFFSET(0x17121EF0)
#define RPG_GAMECORE_COMPLEXSKILLAIALLTARGETCOMBINE__CTOR_OFFSET UNITYSDK_OFFSET(0x17121ED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAIAllTargetCombine_TypeDefinitionIndex = 14238;
