...
#define RPG_GAMECORE_COMPLEXSKILLAIALLTARGETCOMBINE_METHOD_3_8845FB3A1EC18CCA_OFFSET UNITYSDK_OFFSET(0x1BC23850)
#define RPG_GAMECORE_COMPLEXSKILLAIALLTARGETCOMBINE_METHOD_3_B8ADCA3EA888220A_OFFSET UNITYSDK_OFFSET(0x1BC237F0)
#define RPG_GAMECORE_COMPLEXSKILLAIALLTARGETCOMBINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC23840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAIAllTargetCombine_TypeDefinitionIndex = 14933;
