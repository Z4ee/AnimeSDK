...
#define RPG_GAMECORE_STARTBATTLESCORINGABILITY_METHOD_3_8327C47FE48D0D90_OFFSET UNITYSDK_OFFSET(0x17773EC0)
#define RPG_GAMECORE_STARTBATTLESCORINGABILITY_METHOD_3_C63CD54A9892DFDC_OFFSET UNITYSDK_OFFSET(0x17773FD0)
#define RPG_GAMECORE_STARTBATTLESCORINGABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x17773FA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StartBattleScoringAbility_TypeDefinitionIndex = 21650;
