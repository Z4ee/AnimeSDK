...
#define RPG_GAMECORE_STARTBATTLESCORINGABILITY_METHOD_3_3227AFA25849DBD9_OFFSET UNITYSDK_OFFSET(0x1B0BCCE0)
#define RPG_GAMECORE_STARTBATTLESCORINGABILITY_METHOD_3_C63CD54A9892DFDC_OFFSET UNITYSDK_OFFSET(0x1B0BCDB0)
#define RPG_GAMECORE_STARTBATTLESCORINGABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0BCDA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StartBattleScoringAbility_TypeDefinitionIndex = 22580;
