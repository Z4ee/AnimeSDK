...
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_LEAPSLAM_METHOD_3_32A80D0C0F2C4537_OFFSET UNITYSDK_OFFSET(0x1707A760)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_LEAPSLAM_METHOD_3_D89DDA52D30D789E_OFFSET UNITYSDK_OFFSET(0x1707A7C0)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_LEAPSLAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1707A7B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleAbility_LeapSlam_TypeDefinitionIndex = 14431;
