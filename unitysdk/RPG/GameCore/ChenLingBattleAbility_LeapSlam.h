...
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_LEAPSLAM_METHOD_3_4FECF89A78C2B998_OFFSET UNITYSDK_OFFSET(0x1C377570)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_LEAPSLAM_METHOD_3_9CDDB495CCC8CD08_OFFSET UNITYSDK_OFFSET(0x1C3775D0)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_LEAPSLAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3775C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleAbility_LeapSlam_TypeDefinitionIndex = 15128;
