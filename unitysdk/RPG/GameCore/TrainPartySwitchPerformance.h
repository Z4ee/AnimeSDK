...
#define RPG_GAMECORE_TRAINPARTYSWITCHPERFORMANCE_METHOD_3_EF66ACCCC83A7375_OFFSET UNITYSDK_OFFSET(0x1D5E2540)
#define RPG_GAMECORE_TRAINPARTYSWITCHPERFORMANCE_METHOD_3_FCF9119EFE01C0BA_OFFSET UNITYSDK_OFFSET(0x1D5E2580)
#define RPG_GAMECORE_TRAINPARTYSWITCHPERFORMANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5E2570)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartySwitchPerformance_TypeDefinitionIndex = 22110;
