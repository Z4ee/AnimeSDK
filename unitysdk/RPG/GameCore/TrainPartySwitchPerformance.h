...
#define RPG_GAMECORE_TRAINPARTYSWITCHPERFORMANCE_METHOD_3_36F0372891913F38_OFFSET UNITYSDK_OFFSET(0x178B0D70)
#define RPG_GAMECORE_TRAINPARTYSWITCHPERFORMANCE_METHOD_3_FCF9119EFE01C0BA_OFFSET UNITYSDK_OFFSET(0x178B0DF0)
#define RPG_GAMECORE_TRAINPARTYSWITCHPERFORMANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x178B0DC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartySwitchPerformance_TypeDefinitionIndex = 20555;
