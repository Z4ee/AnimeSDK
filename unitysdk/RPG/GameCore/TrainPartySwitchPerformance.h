...
#define RPG_GAMECORE_TRAINPARTYSWITCHPERFORMANCE_METHOD_3_36F0372891913F38_OFFSET UNITYSDK_OFFSET(0x19DFA200)
#define RPG_GAMECORE_TRAINPARTYSWITCHPERFORMANCE_METHOD_3_FCF9119EFE01C0BA_OFFSET UNITYSDK_OFFSET(0x19DFA280)
#define RPG_GAMECORE_TRAINPARTYSWITCHPERFORMANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x19DFA250)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartySwitchPerformance_TypeDefinitionIndex = 21132;
