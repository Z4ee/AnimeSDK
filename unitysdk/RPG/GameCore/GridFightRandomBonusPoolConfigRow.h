...
#define RPG_GAMECORE_GRIDFIGHTRANDOMBONUSPOOLCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D071030)
#define RPG_GAMECORE_GRIDFIGHTRANDOMBONUSPOOLCONFIGROW_GETRUNTIMERANDOMRECORDARR_OFFSET UNITYSDK_OFFSET(0x1D0712D0)
#define RPG_GAMECORE_GRIDFIGHTRANDOMBONUSPOOLCONFIGROW_GETRUNTIMEWEIGHTARR_OFFSET UNITYSDK_OFFSET(0x1D071270)
#define RPG_GAMECORE_GRIDFIGHTRANDOMBONUSPOOLCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D071260)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::System::UInt32>* BonusList; // 0x28
