...
#define RPG_GAMECORE_SETUPBATTLELINEUP_METHOD_3_463C37D77A0B962F_OFFSET UNITYSDK_OFFSET(0x176E9AA0)
#define RPG_GAMECORE_SETUPBATTLELINEUP_METHOD_3_AA00D950ACFB8031_OFFSET UNITYSDK_OFFSET(0x176E9B20)
#define RPG_GAMECORE_SETUPBATTLELINEUP__CTOR_OFFSET UNITYSDK_OFFSET(0x176E9AF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetupBattleLineup_TypeDefinitionIndex = 21162;
