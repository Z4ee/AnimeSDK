...
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMAGICUNITSELECTDROPCONFIG_METHOD_6_4B3B592F894BF577_OFFSET UNITYSDK_OFFSET(0x19AFCD20)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMAGICUNITSELECTDROPCONFIG_METHOD_6_AD9C680B0A091F82_OFFSET UNITYSDK_OFFSET(0x19AFCF40)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMAGICUNITSELECTDROPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AFCE60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActTriggerRogueMagicUnitSelectDropConfig_TypeDefinitionIndex = 18647;
