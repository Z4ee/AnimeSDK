...
#define RPG_GAMECORE_RTLEVELGROUPINSTANCEINFO_METHOD_4_0100194C786A9970_OFFSET UNITYSDK_OFFSET(0x1B766B50)
#define RPG_GAMECORE_RTLEVELGROUPINSTANCEINFO_METHOD_4_B51136D85938741C_OFFSET UNITYSDK_OFFSET(0x1B766B10)
#define RPG_GAMECORE_RTLEVELGROUPINSTANCEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B766B40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtLevelGroupInstanceInfo_TypeDefinitionIndex = 16648;
