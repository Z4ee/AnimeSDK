...
#define RPG_GAMECORE_RTLEVELGROUPINSTANCEINFO_METHOD_4_0100194C786A9970_OFFSET UNITYSDK_OFFSET(0x18DD4050)
#define RPG_GAMECORE_RTLEVELGROUPINSTANCEINFO_METHOD_4_B51136D85938741C_OFFSET UNITYSDK_OFFSET(0x18DD4010)
#define RPG_GAMECORE_RTLEVELGROUPINSTANCEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18DD4040)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtLevelGroupInstanceInfo_TypeDefinitionIndex = 16452;
