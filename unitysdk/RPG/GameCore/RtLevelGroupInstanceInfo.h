...
#define RPG_GAMECORE_RTLEVELGROUPINSTANCEINFO_METHOD_4_0100194C786A9970_OFFSET UNITYSDK_OFFSET(0x176781D0)
#define RPG_GAMECORE_RTLEVELGROUPINSTANCEINFO_METHOD_4_B51136D85938741C_OFFSET UNITYSDK_OFFSET(0x17678190)
#define RPG_GAMECORE_RTLEVELGROUPINSTANCEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x176781C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtLevelGroupInstanceInfo_TypeDefinitionIndex = 15926;
