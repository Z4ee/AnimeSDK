...
#define RPG_GAMECORE_STACKWEAKNESS_METHOD_3_0D171A25AEE859C4_OFFSET UNITYSDK_OFFSET(0x177636B0)
#define RPG_GAMECORE_STACKWEAKNESS_METHOD_3_CA813496135B6646_OFFSET UNITYSDK_OFFSET(0x17763630)
#define RPG_GAMECORE_STACKWEAKNESS__CTOR_OFFSET UNITYSDK_OFFSET(0x17763680)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StackWeakness_TypeDefinitionIndex = 21289;
