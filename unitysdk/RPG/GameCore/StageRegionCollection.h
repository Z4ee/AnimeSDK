...
#define RPG_GAMECORE_STAGEREGIONCOLLECTION_METHOD_2_25DD8A078B7F0A7D_OFFSET UNITYSDK_OFFSET(0x1B0B3BA0)
#define RPG_GAMECORE_STAGEREGIONCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0B3CF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StageRegionCollection_TypeDefinitionIndex = 18444;
