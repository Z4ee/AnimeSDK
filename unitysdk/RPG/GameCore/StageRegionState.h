...
#define RPG_GAMECORE_STAGEREGIONSTATE_METHOD_2_34063431D233EDCE_OFFSET UNITYSDK_OFFSET(0x1776C7C0)
#define RPG_GAMECORE_STAGEREGIONSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1776C8A0)
