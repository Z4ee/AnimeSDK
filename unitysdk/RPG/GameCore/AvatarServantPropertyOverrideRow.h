...
#define RPG_GAMECORE_AVATARSERVANTPROPERTYOVERRIDEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x194A6D20)
#define RPG_GAMECORE_AVATARSERVANTPROPERTYOVERRIDEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x194A7430)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AvatarServantPropertyOverrideRow_TypeDefinitionIndex = 12197;
