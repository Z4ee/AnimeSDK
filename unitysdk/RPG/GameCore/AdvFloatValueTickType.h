...
#define RPG_GAMECORE_ADVFLOATVALUETICKTYPE_METHOD_2_9750A64F52DF433B_OFFSET UNITYSDK_OFFSET(0x19424550)
#define RPG_GAMECORE_ADVFLOATVALUETICKTYPE_METHOD_2_A185CD19061B6ED6_OFFSET UNITYSDK_OFFSET(0x19424F50)
#define RPG_GAMECORE_ADVFLOATVALUETICKTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x19424FB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvFloatValueTickType_TypeDefinitionIndex = 19867;
