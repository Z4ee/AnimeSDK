...
#define RPG_GAMECORE_ADVFLOATVALUETICKTYPE_METHOD_2_9750A64F52DF433B_OFFSET UNITYSDK_OFFSET(0x1D6B7E90)
#define RPG_GAMECORE_ADVFLOATVALUETICKTYPE_METHOD_2_A185CD19061B6ED6_OFFSET UNITYSDK_OFFSET(0x1D6B8890)
#define RPG_GAMECORE_ADVFLOATVALUETICKTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6B88F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvFloatValueTickType_TypeDefinitionIndex = 20781;
