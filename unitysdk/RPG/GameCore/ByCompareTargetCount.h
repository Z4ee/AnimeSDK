...
#define RPG_GAMECORE_BYCOMPARETARGETCOUNT_METHOD_4_2739012C4882F40D_OFFSET UNITYSDK_OFFSET(0x1A8AC900)
#define RPG_GAMECORE_BYCOMPARETARGETCOUNT_METHOD_4_5E212403CED349A2_OFFSET UNITYSDK_OFFSET(0x1A8AD270)
#define RPG_GAMECORE_BYCOMPARETARGETCOUNT_METHOD_4_63A961384C99836B_OFFSET UNITYSDK_OFFSET(0x1A8ACF90)
#define RPG_GAMECORE_BYCOMPARETARGETCOUNT_METHOD_4_A8B0773DEEE84565_OFFSET UNITYSDK_OFFSET(0x1A8ACA60)
#define RPG_GAMECORE_BYCOMPARETARGETCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8ACA50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareTargetCount_TypeDefinitionIndex = 22686;
