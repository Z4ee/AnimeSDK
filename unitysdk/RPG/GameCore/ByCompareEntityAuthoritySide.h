...
#define RPG_GAMECORE_BYCOMPAREENTITYAUTHORITYSIDE_METHOD_4_166DD29DE0F0ACA9_OFFSET UNITYSDK_OFFSET(0x19CDE470)
#define RPG_GAMECORE_BYCOMPAREENTITYAUTHORITYSIDE_METHOD_4_1FEABD662137DB23_OFFSET UNITYSDK_OFFSET(0x19CDE5F0)
#define RPG_GAMECORE_BYCOMPAREENTITYAUTHORITYSIDE_METHOD_4_26C2DC1933514A6C_OFFSET UNITYSDK_OFFSET(0x19CDE620)
#define RPG_GAMECORE_BYCOMPAREENTITYAUTHORITYSIDE_METHOD_4_D1B091F2B216016C_OFFSET UNITYSDK_OFFSET(0x19CDE430)
#define RPG_GAMECORE_BYCOMPAREENTITYAUTHORITYSIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x19CDE460)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareEntityAuthoritySide_TypeDefinitionIndex = 21504;
