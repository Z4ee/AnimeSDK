...
#define RPG_GAMECORE_ADVNPCHITLISTENER_METHOD_3_C627DB71950689F7_OFFSET UNITYSDK_OFFSET(0x1942DF60)
#define RPG_GAMECORE_ADVNPCHITLISTENER_METHOD_3_E2AFDE4A6E615640_OFFSET UNITYSDK_OFFSET(0x1942DE10)
#define RPG_GAMECORE_ADVNPCHITLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1942DED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvNpcHitListener_TypeDefinitionIndex = 20799;
