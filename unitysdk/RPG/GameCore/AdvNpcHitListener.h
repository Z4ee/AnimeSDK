...
#define RPG_GAMECORE_ADVNPCHITLISTENER_METHOD_3_C627DB71950689F7_OFFSET UNITYSDK_OFFSET(0x16F382B0)
#define RPG_GAMECORE_ADVNPCHITLISTENER_METHOD_3_E2AFDE4A6E615640_OFFSET UNITYSDK_OFFSET(0x16F38160)
#define RPG_GAMECORE_ADVNPCHITLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x16F38220)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvNpcHitListener_TypeDefinitionIndex = 20198;
