...
#define RPG_GAMECORE_ADVNPCHITLISTENER_METHOD_3_35524E5E72E0C04D_OFFSET UNITYSDK_OFFSET(0x1CDD20D0)
#define RPG_GAMECORE_ADVNPCHITLISTENER_METHOD_3_C627DB71950689F7_OFFSET UNITYSDK_OFFSET(0x1CDD2150)
#define RPG_GAMECORE_ADVNPCHITLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDD2120)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvNpcHitListener_TypeDefinitionIndex = 21774;
