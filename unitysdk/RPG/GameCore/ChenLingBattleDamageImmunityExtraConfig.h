...
#define RPG_GAMECORE_CHENLINGBATTLEDAMAGEIMMUNITYEXTRACONFIG_METHOD_3_C9067D2162CE0CAB_OFFSET UNITYSDK_OFFSET(0x1CFA7E00)
#define RPG_GAMECORE_CHENLINGBATTLEDAMAGEIMMUNITYEXTRACONFIG_METHOD_3_CC9A4BBF97191255_OFFSET UNITYSDK_OFFSET(0x1CFA87B0)
#define RPG_GAMECORE_CHENLINGBATTLEDAMAGEIMMUNITYEXTRACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFA7DF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleDamageImmunityExtraConfig_TypeDefinitionIndex = 15625;
