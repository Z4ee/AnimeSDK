...
#define RPG_GAMECORE_STAGEINVASIONBUFFROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CAE5ED0)
#define RPG_GAMECORE_STAGEINVASIONBUFFROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CAE6090)
