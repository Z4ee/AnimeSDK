...
#define RPG_GAMECORE_FIVEDIMLEVELCAMERACONFIG_METHOD_4_2727BF0127F100A9_OFFSET UNITYSDK_OFFSET(0x18908250)
#define RPG_GAMECORE_FIVEDIMLEVELCAMERACONFIG_METHOD_4_6EF575EEFEE4E427_OFFSET UNITYSDK_OFFSET(0x18908300)
#define RPG_GAMECORE_FIVEDIMLEVELCAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189082C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimLevelCameraConfig_TypeDefinitionIndex = 17692;
