...
#define RPG_GAMECORE_SETNPCSTATUS_METHOD_3_1E64331B1103CD6D_OFFSET UNITYSDK_OFFSET(0x18E3D9E0)
#define RPG_GAMECORE_SETNPCSTATUS_METHOD_3_48E9B685014A6A8D_OFFSET UNITYSDK_OFFSET(0x18E3DB30)
#define RPG_GAMECORE_SETNPCSTATUS__CTOR_OFFSET UNITYSDK_OFFSET(0x18E3DAA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetNpcStatus_TypeDefinitionIndex = 19285;
