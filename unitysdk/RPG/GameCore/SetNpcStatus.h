...
#define RPG_GAMECORE_SETNPCSTATUS_METHOD_3_1E64331B1103CD6D_OFFSET UNITYSDK_OFFSET(0x19C5A720)
#define RPG_GAMECORE_SETNPCSTATUS_METHOD_3_48E9B685014A6A8D_OFFSET UNITYSDK_OFFSET(0x19C5A870)
#define RPG_GAMECORE_SETNPCSTATUS__CTOR_OFFSET UNITYSDK_OFFSET(0x19C5A7E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetNpcStatus_TypeDefinitionIndex = 19201;
