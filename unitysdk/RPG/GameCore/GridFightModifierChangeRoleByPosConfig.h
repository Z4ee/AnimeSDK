...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERCHANGEROLEBYPOSCONFIG_METHOD_3_A7F90BE93F930999_OFFSET UNITYSDK_OFFSET(0x189B20E0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERCHANGEROLEBYPOSCONFIG_METHOD_3_C24FB77C8AC209C0_OFFSET UNITYSDK_OFFSET(0x189B2010)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERCHANGEROLEBYPOSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189B2090)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierChangeRoleByPosConfig_TypeDefinitionIndex = 18477;
