...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERCHANGEROLEBYPOSCONFIG_METHOD_3_A7F90BE93F930999_OFFSET UNITYSDK_OFFSET(0x1C5D0790)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERCHANGEROLEBYPOSCONFIG_METHOD_3_DE52AA66D1F1C895_OFFSET UNITYSDK_OFFSET(0x1C5D0740)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERCHANGEROLEBYPOSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5D0780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierChangeRoleByPosConfig_TypeDefinitionIndex = 18697;
