...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERCHANGEROLEBYPOSCONFIG_METHOD_3_A7F90BE93F930999_OFFSET UNITYSDK_OFFSET(0x197E9D30)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERCHANGEROLEBYPOSCONFIG_METHOD_3_C24FB77C8AC209C0_OFFSET UNITYSDK_OFFSET(0x197E9C60)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERCHANGEROLEBYPOSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197E9CE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierChangeRoleByPosConfig_TypeDefinitionIndex = 18449;
