...
#define RPG_GAMECORE_SETSKILLTEXTDIALOGTYPE_METHOD_3_3930E09BC7B49144_OFFSET UNITYSDK_OFFSET(0x176DEB70)
#define RPG_GAMECORE_SETSKILLTEXTDIALOGTYPE_METHOD_3_B83F5CC25A05EFAC_OFFSET UNITYSDK_OFFSET(0x176DEAF0)
#define RPG_GAMECORE_SETSKILLTEXTDIALOGTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x176DEB40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetSkillTextDialogType_TypeDefinitionIndex = 21136;
