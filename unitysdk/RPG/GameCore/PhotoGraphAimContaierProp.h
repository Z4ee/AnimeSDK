...
#define RPG_GAMECORE_PHOTOGRAPHAIMCONTAIERPROP_METHOD_3_36A6F02CD836E4DE_OFFSET UNITYSDK_OFFSET(0x18BF1A30)
#define RPG_GAMECORE_PHOTOGRAPHAIMCONTAIERPROP_METHOD_3_557B2C94F2DA5F13_OFFSET UNITYSDK_OFFSET(0x18BF1AF0)
#define RPG_GAMECORE_PHOTOGRAPHAIMCONTAIERPROP__CTOR_OFFSET UNITYSDK_OFFSET(0x18BF1AB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotoGraphAimContaierProp_TypeDefinitionIndex = 16626;
