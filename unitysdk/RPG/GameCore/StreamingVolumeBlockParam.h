...
#define RPG_GAMECORE_STREAMINGVOLUMEBLOCKPARAM_METHOD_2_5D5A3D691B308399_OFFSET UNITYSDK_OFFSET(0x17782920)
#define RPG_GAMECORE_STREAMINGVOLUMEBLOCKPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x17782B60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StreamingVolumeBlockParam_TypeDefinitionIndex = 17529;
