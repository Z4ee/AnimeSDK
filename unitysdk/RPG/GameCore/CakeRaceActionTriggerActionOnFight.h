...
#define RPG_GAMECORE_CAKERACEACTIONTRIGGERACTIONONFIGHT_METHOD_3_32F0F84D89D909C4_OFFSET UNITYSDK_OFFSET(0x1876B5E0)
#define RPG_GAMECORE_CAKERACEACTIONTRIGGERACTIONONFIGHT_METHOD_3_9B5F251FE9856963_OFFSET UNITYSDK_OFFSET(0x1876C8D0)
#define RPG_GAMECORE_CAKERACEACTIONTRIGGERACTIONONFIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x1876B5C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionTriggerActionOnFight_TypeDefinitionIndex = 17449;
