...
#define RPG_GAMECORE_CAKERACEACTIONTRIGGERACTIONONFIGHT_METHOD_3_32F0F84D89D909C4_OFFSET UNITYSDK_OFFSET(0x1B2CCB20)
#define RPG_GAMECORE_CAKERACEACTIONTRIGGERACTIONONFIGHT_METHOD_3_FE11176BAE79F619_OFFSET UNITYSDK_OFFSET(0x1B2CCAE0)
#define RPG_GAMECORE_CAKERACEACTIONTRIGGERACTIONONFIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2CCB10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionTriggerActionOnFight_TypeDefinitionIndex = 17625;
