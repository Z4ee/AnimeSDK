...
#define RPG_GAMECORE_CAKERACEACTIONTRIGGERACTIONONFIGHT_METHOD_3_32F0F84D89D909C4_OFFSET UNITYSDK_OFFSET(0x17045E80)
#define RPG_GAMECORE_CAKERACEACTIONTRIGGERACTIONONFIGHT_METHOD_3_9B5F251FE9856963_OFFSET UNITYSDK_OFFSET(0x17047170)
#define RPG_GAMECORE_CAKERACEACTIONTRIGGERACTIONONFIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x17045E60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionTriggerActionOnFight_TypeDefinitionIndex = 16855;
	...
	public:
		...
		static ::System::Void Method_3_9B5F251FE9856963(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::CakeRaceActionTriggerActionOnFight*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::CakeRaceActionTriggerActionOnFight*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_CAKERACEACTIONTRIGGERACTIONONFIGHT_METHOD_3_9B5F251FE9856963_OFFSET))(a1, a2);
		}
