...
#define RPG_GAMECORE_WAITGRAPHDYNAMICVALUECHANGE_METHOD_4_1839A79FFB1125EC_OFFSET UNITYSDK_OFFSET(0x1D6A4820)
#define RPG_GAMECORE_WAITGRAPHDYNAMICVALUECHANGE_METHOD_4_A31B5CFDE33BB5E1_OFFSET UNITYSDK_OFFSET(0x1D6A47D0)
#define RPG_GAMECORE_WAITGRAPHDYNAMICVALUECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6A4810)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitGraphDynamicValueChange_TypeDefinitionIndex = 20476;
