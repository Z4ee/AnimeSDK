...
#define RPG_GAMECORE_WAITGRAPHDYNAMICVALUECHANGE_METHOD_4_1839A79FFB1125EC_OFFSET UNITYSDK_OFFSET(0x178FB340)
#define RPG_GAMECORE_WAITGRAPHDYNAMICVALUECHANGE_METHOD_4_B704497C12159B08_OFFSET UNITYSDK_OFFSET(0x178FB260)
#define RPG_GAMECORE_WAITGRAPHDYNAMICVALUECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x178FB2E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitGraphDynamicValueChange_TypeDefinitionIndex = 19033;
