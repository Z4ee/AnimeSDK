...
#define RPG_GAMECORE_MARBLEHIDEAUXILIARYLINE_METHOD_3_3A8B5A0FE26BDD95_OFFSET UNITYSDK_OFFSET(0x18A9DCA0)
#define RPG_GAMECORE_MARBLEHIDEAUXILIARYLINE_METHOD_3_C44F45ED8E37831A_OFFSET UNITYSDK_OFFSET(0x18A9DB60)
#define RPG_GAMECORE_MARBLEHIDEAUXILIARYLINE__CTOR_OFFSET UNITYSDK_OFFSET(0x18A9DC50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleHideAuxiliaryLine_TypeDefinitionIndex = 15953;
