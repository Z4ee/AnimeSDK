...
#define RPG_GAMECORE_SETDYNAMICVALUEBYSKILLPROPERTY_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x19C45240)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSKILLPROPERTY_METHOD_4_CA8453D81A87BCC4_OFFSET UNITYSDK_OFFSET(0x19C44E80)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSKILLPROPERTY_METHOD_4_E512AD9BB56CE1F1_OFFSET UNITYSDK_OFFSET(0x19C44FB0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSKILLPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x19C44F30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueBySkillProperty_TypeDefinitionIndex = 22275;
