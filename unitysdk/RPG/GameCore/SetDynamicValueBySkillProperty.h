...
#define RPG_GAMECORE_SETDYNAMICVALUEBYSKILLPROPERTY_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1C5F1560)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSKILLPROPERTY_METHOD_4_CA8453D81A87BCC4_OFFSET UNITYSDK_OFFSET(0x1C5F1210)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSKILLPROPERTY_METHOD_4_E512AD9BB56CE1F1_OFFSET UNITYSDK_OFFSET(0x1C5F12D0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSKILLPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5F1280)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueBySkillProperty_TypeDefinitionIndex = 22716;
