...
#define RPG_GAMECORE_CAPTURENPCTOCHARACTER_METHOD_3_2D1FAAED58BA46D3_OFFSET UNITYSDK_OFFSET(0x1CF7D910)
#define RPG_GAMECORE_CAPTURENPCTOCHARACTER_METHOD_3_F7FEA7463C8F75BA_OFFSET UNITYSDK_OFFSET(0x1CF7D8C0)
#define RPG_GAMECORE_CAPTURENPCTOCHARACTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF7D900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CaptureNPCToCharacter_TypeDefinitionIndex = 20055;
