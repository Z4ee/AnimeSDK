...
#define RPG_GAMECORE_CAPTURENPCTOCHARACTER_METHOD_3_13F05A60B4C1F423_OFFSET UNITYSDK_OFFSET(0x170537C0)
#define RPG_GAMECORE_CAPTURENPCTOCHARACTER_METHOD_3_2D1FAAED58BA46D3_OFFSET UNITYSDK_OFFSET(0x17053840)
#define RPG_GAMECORE_CAPTURENPCTOCHARACTER__CTOR_OFFSET UNITYSDK_OFFSET(0x17053810)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CaptureNPCToCharacter_TypeDefinitionIndex = 18577;
