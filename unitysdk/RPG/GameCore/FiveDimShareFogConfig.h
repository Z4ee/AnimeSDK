...
#define RPG_GAMECORE_FIVEDIMSHAREFOGCONFIG_METHOD_2_3132C228A53DDE85_OFFSET UNITYSDK_OFFSET(0x19756970)
#define RPG_GAMECORE_FIVEDIMSHAREFOGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197569B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimShareFogConfig_TypeDefinitionIndex = 17621;
