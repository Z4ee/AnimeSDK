...
#define RPG_GAMECORE_FIVEDIMSHAREFOGCONFIG_METHOD_2_3132C228A53DDE85_OFFSET UNITYSDK_OFFSET(0x1891D220)
#define RPG_GAMECORE_FIVEDIMSHAREFOGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1891D260)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimShareFogConfig_TypeDefinitionIndex = 17595;
