...
#define RPG_GAMECORE_ADVADDEXTRABATTLEMONSTER_METHOD_3_1B6540409EC3F195_OFFSET UNITYSDK_OFFSET(0x16F23BA0)
#define RPG_GAMECORE_ADVADDEXTRABATTLEMONSTER_METHOD_3_7101D4F8FBA82C64_OFFSET UNITYSDK_OFFSET(0x16F23C20)
#define RPG_GAMECORE_ADVADDEXTRABATTLEMONSTER__CTOR_OFFSET UNITYSDK_OFFSET(0x16F23BF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvAddExtraBattleMonster_TypeDefinitionIndex = 19978;
