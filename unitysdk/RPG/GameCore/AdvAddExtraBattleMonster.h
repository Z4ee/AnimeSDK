...
#define RPG_GAMECORE_ADVADDEXTRABATTLEMONSTER_METHOD_3_1B6540409EC3F195_OFFSET UNITYSDK_OFFSET(0x18645DA0)
#define RPG_GAMECORE_ADVADDEXTRABATTLEMONSTER_METHOD_3_7101D4F8FBA82C64_OFFSET UNITYSDK_OFFSET(0x18645E20)
#define RPG_GAMECORE_ADVADDEXTRABATTLEMONSTER__CTOR_OFFSET UNITYSDK_OFFSET(0x18645DF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvAddExtraBattleMonster_TypeDefinitionIndex = 20659;
