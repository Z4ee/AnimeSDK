...
#define RPG_GAMECORE_ADVADDEXTRABATTLEMONSTER_METHOD_3_7101D4F8FBA82C64_OFFSET UNITYSDK_OFFSET(0x1BE0C770)
#define RPG_GAMECORE_ADVADDEXTRABATTLEMONSTER_METHOD_3_75FFFA7C2F1F2BBF_OFFSET UNITYSDK_OFFSET(0x1BE0C730)
#define RPG_GAMECORE_ADVADDEXTRABATTLEMONSTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE0C760)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvAddExtraBattleMonster_TypeDefinitionIndex = 21006;
