...
#define RPG_GAMECORE_FIVEDIMMUSICDIRECTORCOMPONENTCONFIG_METHOD_3_0E5558229A8ED0AF_OFFSET UNITYSDK_OFFSET(0x189100B0)
#define RPG_GAMECORE_FIVEDIMMUSICDIRECTORCOMPONENTCONFIG_METHOD_3_D5600382010E3B4D_OFFSET UNITYSDK_OFFSET(0x18910120)
#define RPG_GAMECORE_FIVEDIMMUSICDIRECTORCOMPONENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18910100)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimMusicDirectorComponentConfig_TypeDefinitionIndex = 17880;
