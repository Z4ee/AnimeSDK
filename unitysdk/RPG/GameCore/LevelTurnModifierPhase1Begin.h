...
#define RPG_GAMECORE_LEVELTURNMODIFIERPHASE1BEGIN_GETACTIVEENTITY_OFFSET UNITYSDK_OFFSET(0xB6E1140)
#define RPG_GAMECORE_LEVELTURNMODIFIERPHASE1BEGIN_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xB6E10F0)
#define RPG_GAMECORE_LEVELTURNMODIFIERPHASE1BEGIN_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xB6E10A0)
#define RPG_GAMECORE_LEVELTURNMODIFIERPHASE1BEGIN_GETTURNCOUNTER_OFFSET UNITYSDK_OFFSET(0xB6E1180)
#define RPG_GAMECORE_LEVELTURNMODIFIERPHASE1BEGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xB6E1090)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelTurnModifierPhase1Begin_TypeDefinitionIndex = 52249;
