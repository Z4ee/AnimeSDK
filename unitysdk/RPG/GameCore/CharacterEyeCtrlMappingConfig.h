...
#define RPG_GAMECORE_CHARACTEREYECTRLMAPPINGCONFIG_METHOD_2_560EFF3130BB177D_OFFSET UNITYSDK_OFFSET(0x1706C050)
#define RPG_GAMECORE_CHARACTEREYECTRLMAPPINGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1706C120)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterEyeCtrlMappingConfig_TypeDefinitionIndex = 16030;
