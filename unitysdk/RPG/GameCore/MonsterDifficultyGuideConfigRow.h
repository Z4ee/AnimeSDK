...
#define RPG_GAMECORE_MONSTERDIFFICULTYGUIDECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CE66EF0)
#define RPG_GAMECORE_MONSTERDIFFICULTYGUIDECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE675D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonsterDifficultyGuideConfigRow_TypeDefinitionIndex = 14101;
