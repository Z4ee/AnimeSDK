...
#define RPG_GAMECORE_DISABLEHEADLOOKATOVERRIDE_METHOD_3_E06D6D96F7A3B9A3_OFFSET UNITYSDK_OFFSET(0x196BC540)
#define RPG_GAMECORE_DISABLEHEADLOOKATOVERRIDE_METHOD_3_F5270914EC530F14_OFFSET UNITYSDK_OFFSET(0x196BC5C0)
#define RPG_GAMECORE_DISABLEHEADLOOKATOVERRIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x196BC590)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DisableHeadLookAtOverride_TypeDefinitionIndex = 22199;
