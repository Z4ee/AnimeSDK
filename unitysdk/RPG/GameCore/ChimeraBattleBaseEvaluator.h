...
#define RPG_GAMECORE_CHIMERABATTLEBASEEVALUATOR_METHOD_2_11321B2887049EFE_OFFSET UNITYSDK_OFFSET(0x1C38F5F0)
#define RPG_GAMECORE_CHIMERABATTLEBASEEVALUATOR_METHOD_2_96EBC6E939936445_OFFSET UNITYSDK_OFFSET(0x1C38F330)
#define RPG_GAMECORE_CHIMERABATTLEBASEEVALUATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1C38F5E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraBattleBaseEvaluator_TypeDefinitionIndex = 15223;
