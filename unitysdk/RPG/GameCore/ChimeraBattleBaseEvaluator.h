...
#define RPG_GAMECORE_CHIMERABATTLEBASEEVALUATOR_METHOD_2_11321B2887049EFE_OFFSET UNITYSDK_OFFSET(0x1E020070)
#define RPG_GAMECORE_CHIMERABATTLEBASEEVALUATOR_METHOD_2_96EBC6E939936445_OFFSET UNITYSDK_OFFSET(0x1E01FDB0)
#define RPG_GAMECORE_CHIMERABATTLEBASEEVALUATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1E020060)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraBattleBaseEvaluator_TypeDefinitionIndex = 15660;
