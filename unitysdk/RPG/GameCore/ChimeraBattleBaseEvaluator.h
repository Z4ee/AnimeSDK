...
#define RPG_GAMECORE_CHIMERABATTLEBASEEVALUATOR_METHOD_2_11321B2887049EFE_OFFSET UNITYSDK_OFFSET(0x170941D0)
#define RPG_GAMECORE_CHIMERABATTLEBASEEVALUATOR_METHOD_2_96EBC6E939936445_OFFSET UNITYSDK_OFFSET(0x17093F20)
#define RPG_GAMECORE_CHIMERABATTLEBASEEVALUATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x170941C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraBattleBaseEvaluator_TypeDefinitionIndex = 14526;
