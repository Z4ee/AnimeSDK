...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONAFTERSTYLEGIFTSELECTCONFIG_METHOD_3_2C6DC3E112F3E558_OFFSET UNITYSDK_OFFSET(0x18D349C0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONAFTERSTYLEGIFTSELECTCONFIG_METHOD_3_D9F3B163F0FC7381_OFFSET UNITYSDK_OFFSET(0x18D3C7F0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONAFTERSTYLEGIFTSELECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D34970)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionAfterStyleGiftSelectConfig_TypeDefinitionIndex = 16968;
