...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONAFTERSTYLEGIFTSELECTCONFIG_METHOD_3_2C6DC3E112F3E558_OFFSET UNITYSDK_OFFSET(0x1762F170)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONAFTERSTYLEGIFTSELECTCONFIG_METHOD_3_D9F3B163F0FC7381_OFFSET UNITYSDK_OFFSET(0x1762F0A0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONAFTERSTYLEGIFTSELECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1762F120)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionAfterStyleGiftSelectConfig_TypeDefinitionIndex = 16414;
