...
#define RPG_GAMECORE_MISSIONMAPPROPTYPE_METHOD_2_A4BE208EF3B5E9DD_OFFSET UNITYSDK_OFFSET(0x1D1AC3D0)
#define RPG_GAMECORE_MISSIONMAPPROPTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1AC4F0)
