...
#define RPG_GAMECORE_MISSIONMAPPROPTYPE_METHOD_2_A4BE208EF3B5E9DD_OFFSET UNITYSDK_OFFSET(0x19946810)
#define RPG_GAMECORE_MISSIONMAPPROPTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x19946930)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MissionMapPropType_TypeDefinitionIndex = 18058;
