...
#define RPG_GAMECORE_MISSIONMAPPROPTYPE_METHOD_2_A4BE208EF3B5E9DD_OFFSET UNITYSDK_OFFSET(0x1D2A5C40)
#define RPG_GAMECORE_MISSIONMAPPROPTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2A5D60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MissionMapPropType_TypeDefinitionIndex = 18786;
