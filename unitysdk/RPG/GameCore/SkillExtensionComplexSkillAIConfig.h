...
#define RPG_GAMECORE_SKILLEXTENSIONCOMPLEXSKILLAICONFIG_METHOD_2_C5289D3817CBD0C3_OFFSET UNITYSDK_OFFSET(0x1D0A52C0)
#define RPG_GAMECORE_SKILLEXTENSIONCOMPLEXSKILLAICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0A54B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SkillExtensionComplexSkillAIConfig_TypeDefinitionIndex = 15399;
