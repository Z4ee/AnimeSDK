...
#define RPG_GAMECORE_COLLECTHEARTDIALCAMERAINDEX_METHOD_3_55D3B5FC59A329DE_OFFSET UNITYSDK_OFFSET(0x196666E0)
#define RPG_GAMECORE_COLLECTHEARTDIALCAMERAINDEX_METHOD_3_878FC6A6A2A479D2_OFFSET UNITYSDK_OFFSET(0x196665D0)
#define RPG_GAMECORE_COLLECTHEARTDIALCAMERAINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0x196666B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CollectHeartDialCameraIndex_TypeDefinitionIndex = 19939;
