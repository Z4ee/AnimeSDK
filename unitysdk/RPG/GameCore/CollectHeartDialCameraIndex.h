...
#define RPG_GAMECORE_COLLECTHEARTDIALCAMERAINDEX_METHOD_3_368FF1C91661B4DB_OFFSET UNITYSDK_OFFSET(0x1D9A50A0)
#define RPG_GAMECORE_COLLECTHEARTDIALCAMERAINDEX_METHOD_3_55D3B5FC59A329DE_OFFSET UNITYSDK_OFFSET(0x1D9A5170)
#define RPG_GAMECORE_COLLECTHEARTDIALCAMERAINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0x1D9A5160)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CollectHeartDialCameraIndex_TypeDefinitionIndex = 20860;
