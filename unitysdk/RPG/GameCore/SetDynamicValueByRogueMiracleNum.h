...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEMIRACLENUM_METHOD_3_CCF03400B64E168A_OFFSET UNITYSDK_OFFSET(0x176C3B20)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEMIRACLENUM_METHOD_3_EF02714FD43145B5_OFFSET UNITYSDK_OFFSET(0x176C3B90)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEMIRACLENUM__CTOR_OFFSET UNITYSDK_OFFSET(0x176C3B60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRogueMiracleNum_TypeDefinitionIndex = 19938;
