...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEMIRACLENUM_METHOD_3_CCF03400B64E168A_OFFSET UNITYSDK_OFFSET(0x19C43AD0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEMIRACLENUM_METHOD_3_EF02714FD43145B5_OFFSET UNITYSDK_OFFSET(0x19C43B40)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEMIRACLENUM__CTOR_OFFSET UNITYSDK_OFFSET(0x19C43B10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRogueMiracleNum_TypeDefinitionIndex = 20552;
