...
#define RPG_GAMECORE_REMOVENAVMESHSTATE_METHOD_3_3C88E7A54493F6BF_OFFSET UNITYSDK_OFFSET(0x18CA54F0)
#define RPG_GAMECORE_REMOVENAVMESHSTATE_METHOD_3_7C108FE20C2D378E_OFFSET UNITYSDK_OFFSET(0x18CA5470)
#define RPG_GAMECORE_REMOVENAVMESHSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18CA54C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveNavMeshState_TypeDefinitionIndex = 21104;
