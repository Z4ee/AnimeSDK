...
#define RPG_GAMECORE_TRIGGERGROUPEVENTONDIALOGEND_METHOD_4_8F39ADF9714DB66B_OFFSET UNITYSDK_OFFSET(0x190C6B40)
#define RPG_GAMECORE_TRIGGERGROUPEVENTONDIALOGEND_METHOD_4_F81C3C76A4C7A242_OFFSET UNITYSDK_OFFSET(0x190C6A40)
#define RPG_GAMECORE_TRIGGERGROUPEVENTONDIALOGEND__CTOR_OFFSET UNITYSDK_OFFSET(0x190C6A10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerGroupEventOnDialogEnd_TypeDefinitionIndex = 20081;
