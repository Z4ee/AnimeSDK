...
#define RPG_GAMECORE_BYCOMPAREPROPTYPE_METHOD_4_38E5A558FD893332_OFFSET UNITYSDK_OFFSET(0x17013F60)
#define RPG_GAMECORE_BYCOMPAREPROPTYPE_METHOD_4_854469E85C94511A_OFFSET UNITYSDK_OFFSET(0x17013E90)
#define RPG_GAMECORE_BYCOMPAREPROPTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x17013F10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByComparePropType_TypeDefinitionIndex = 18603;
