...
#define RPG_GAMECORE_ROGUEACTLEVELUPRANDOMROGUEMAGICUNITWITHLEVELCONFIG_METHOD_6_513913F4903A27CF_OFFSET UNITYSDK_OFFSET(0x1EE85D20)
#define RPG_GAMECORE_ROGUEACTLEVELUPRANDOMROGUEMAGICUNITWITHLEVELCONFIG_METHOD_6_ED2F810F0D940093_OFFSET UNITYSDK_OFFSET(0x1EE85D70)
#define RPG_GAMECORE_ROGUEACTLEVELUPRANDOMROGUEMAGICUNITWITHLEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EE85D60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActLevelUpRandomRogueMagicUnitWithLevelConfig_TypeDefinitionIndex = 19454;
