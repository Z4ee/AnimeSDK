...
#define RPG_GAMECORE_ROGUEACTLEVELUPRANDOMROGUEMAGICUNITWITHLEVELCONFIG_METHOD_6_C90D852BB6B66606_OFFSET UNITYSDK_OFFSET(0x19AE8F40)
#define RPG_GAMECORE_ROGUEACTLEVELUPRANDOMROGUEMAGICUNITWITHLEVELCONFIG_METHOD_6_ED2F810F0D940093_OFFSET UNITYSDK_OFFSET(0x19AE9160)
#define RPG_GAMECORE_ROGUEACTLEVELUPRANDOMROGUEMAGICUNITWITHLEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AE9080)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActLevelUpRandomRogueMagicUnitWithLevelConfig_TypeDefinitionIndex = 18651;
