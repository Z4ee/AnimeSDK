...
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTBURNFROMSHIELDPERCENTCONFIG_METHOD_3_69BAE24D4C92D822_OFFSET UNITYSDK_OFFSET(0x1D1FA5A0)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTBURNFROMSHIELDPERCENTCONFIG_METHOD_3_C7940E3163C3EAF6_OFFSET UNITYSDK_OFFSET(0x1D1FA4D0)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTBURNFROMSHIELDPERCENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1FA590)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityPixAirEffectBurnFromShieldPercentConfig_TypeDefinitionIndex = 21117;
