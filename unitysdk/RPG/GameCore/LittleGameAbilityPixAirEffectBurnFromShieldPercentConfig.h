...
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTBURNFROMSHIELDPERCENTCONFIG_METHOD_3_69BAE24D4C92D822_OFFSET UNITYSDK_OFFSET(0x1B093D10)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTBURNFROMSHIELDPERCENTCONFIG_METHOD_3_C7940E3163C3EAF6_OFFSET UNITYSDK_OFFSET(0x1B093C40)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTBURNFROMSHIELDPERCENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B093D00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityPixAirEffectBurnFromShieldPercentConfig_TypeDefinitionIndex = 20565;
