...
#define RPG_GAMECORE_AIAVATARBASETYPESELECTOR_METHOD_3_364B1D26533C5FED_OFFSET UNITYSDK_OFFSET(0x1CD64140)
#define RPG_GAMECORE_AIAVATARBASETYPESELECTOR_METHOD_3_BBD009CB5B03889A_OFFSET UNITYSDK_OFFSET(0x1CD640F0)
#define RPG_GAMECORE_AIAVATARBASETYPESELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD64130)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AIAvatarBaseTypeSelector_TypeDefinitionIndex = 15429;
