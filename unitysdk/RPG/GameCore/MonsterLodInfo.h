...
#define RPG_GAMECORE_MONSTERLODINFO_METHOD_2_1D433E9AF2243E34_OFFSET UNITYSDK_OFFSET(0x174513D0)
#define RPG_GAMECORE_MONSTERLODINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x174514F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonsterLodInfo_TypeDefinitionIndex = 17491;
