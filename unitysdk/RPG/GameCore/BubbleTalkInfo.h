...
#define RPG_GAMECORE_BUBBLETALKINFO_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1871C810)
#define RPG_GAMECORE_BUBBLETALKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1871CB60)
