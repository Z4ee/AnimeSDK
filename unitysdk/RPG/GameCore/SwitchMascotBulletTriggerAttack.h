...
#define RPG_GAMECORE_SWITCHMASCOTBULLETTRIGGERATTACK_METHOD_3_DECDB6E877CF8687_OFFSET UNITYSDK_OFFSET(0x19CDC2D0)
#define RPG_GAMECORE_SWITCHMASCOTBULLETTRIGGERATTACK_METHOD_3_EA7527C0FF8F5032_OFFSET UNITYSDK_OFFSET(0x19CDC1D0)
#define RPG_GAMECORE_SWITCHMASCOTBULLETTRIGGERATTACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19CDC260)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchMascotBulletTriggerAttack_TypeDefinitionIndex = 19043;
