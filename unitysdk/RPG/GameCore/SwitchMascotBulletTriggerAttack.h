...
#define RPG_GAMECORE_SWITCHMASCOTBULLETTRIGGERATTACK_METHOD_3_DECDB6E877CF8687_OFFSET UNITYSDK_OFFSET(0x17796250)
#define RPG_GAMECORE_SWITCHMASCOTBULLETTRIGGERATTACK_METHOD_3_EA7527C0FF8F5032_OFFSET UNITYSDK_OFFSET(0x17796150)
#define RPG_GAMECORE_SWITCHMASCOTBULLETTRIGGERATTACK__CTOR_OFFSET UNITYSDK_OFFSET(0x177961E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchMascotBulletTriggerAttack_TypeDefinitionIndex = 18456;
