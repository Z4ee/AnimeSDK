...
#define RPG_GAMECORE_SWITCHMASCOTBULLETTRIGGERATTACK_METHOD_3_DECDB6E877CF8687_OFFSET UNITYSDK_OFFSET(0x1E14FDA0)
#define RPG_GAMECORE_SWITCHMASCOTBULLETTRIGGERATTACK_METHOD_3_EA7527C0FF8F5032_OFFSET UNITYSDK_OFFSET(0x1E14FCE0)
#define RPG_GAMECORE_SWITCHMASCOTBULLETTRIGGERATTACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1E14FD50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchMascotBulletTriggerAttack_TypeDefinitionIndex = 19939;
