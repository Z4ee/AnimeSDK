...
#define RPG_GAMECORE_WAITHELIOBUSCHALLENGEEXITNOTIFY_METHOD_3_15A90519F8F6BAF1_OFFSET UNITYSDK_OFFSET(0x19100110)
#define RPG_GAMECORE_WAITHELIOBUSCHALLENGEEXITNOTIFY_METHOD_3_47A7AE27430F6F68_OFFSET UNITYSDK_OFFSET(0x19100190)
#define RPG_GAMECORE_WAITHELIOBUSCHALLENGEEXITNOTIFY__CTOR_OFFSET UNITYSDK_OFFSET(0x19100160)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitHeliobusChallengeExitNotify_TypeDefinitionIndex = 20559;
