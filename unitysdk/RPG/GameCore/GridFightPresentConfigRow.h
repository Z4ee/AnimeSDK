...
#define RPG_GAMECORE_GRIDFIGHTPRESENTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D3B29D0)
#define RPG_GAMECORE_GRIDFIGHTPRESENTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3B2C70)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID PresentDesc; // 0x20
		::RPG::Client::TextID PresentName; // 0x30
