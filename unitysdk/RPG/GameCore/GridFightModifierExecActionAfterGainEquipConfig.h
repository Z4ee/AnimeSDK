...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERGAINEQUIPCONFIG_METHOD_3_91D319892816F4B2_OFFSET UNITYSDK_OFFSET(0x189B8B10)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERGAINEQUIPCONFIG_METHOD_3_E8AF1B9F93AB593B_OFFSET UNITYSDK_OFFSET(0x189BBF00)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERGAINEQUIPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189B8AC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierExecActionAfterGainEquipConfig_TypeDefinitionIndex = 18446;
