...
#define RPG_GAMECORE_ACTIVETEMPLATEVIRTUALCAMERA_METHOD_3_C62A4034CFA70520_OFFSET UNITYSDK_OFFSET(0x16EA0A50)
#define RPG_GAMECORE_ACTIVETEMPLATEVIRTUALCAMERA_METHOD_3_D472540401E2D54E_OFFSET UNITYSDK_OFFSET(0x16EA0AD0)
#define RPG_GAMECORE_ACTIVETEMPLATEVIRTUALCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x16EA0AA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActiveTemplateVirtualCamera_TypeDefinitionIndex = 19147;
