...
#define RPG_GAMECORE_BASESCROLLGAMEWAVECONFIG_METHOD_2_3CFAE03D7B322F96_OFFSET UNITYSDK_OFFSET(0x186EE340)
#define RPG_GAMECORE_BASESCROLLGAMEWAVECONFIG_METHOD_2_989A625BC0D54491_OFFSET UNITYSDK_OFFSET(0x186EE500)
#define RPG_GAMECORE_BASESCROLLGAMEWAVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x186EE4F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BaseScrollGameWaveConfig_TypeDefinitionIndex = 17867;
