...
#define RPG_GAMECORE_BASESCROLLGAMEWAVECONFIG_METHOD_2_3CFAE03D7B322F96_OFFSET UNITYSDK_OFFSET(0x194C1B70)
#define RPG_GAMECORE_BASESCROLLGAMEWAVECONFIG_METHOD_2_989A625BC0D54491_OFFSET UNITYSDK_OFFSET(0x194C1D40)
#define RPG_GAMECORE_BASESCROLLGAMEWAVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x194C1D30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BaseScrollGameWaveConfig_TypeDefinitionIndex = 17896;
