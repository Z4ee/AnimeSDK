...
#define RPG_GAMECORE_SETADVEFFECTTOANCHOR_METHOD_3_5217C84EA27847E4_OFFSET UNITYSDK_OFFSET(0x176A5900)
#define RPG_GAMECORE_SETADVEFFECTTOANCHOR_METHOD_3_7151B77C6732CA73_OFFSET UNITYSDK_OFFSET(0x176A5880)
#define RPG_GAMECORE_SETADVEFFECTTOANCHOR__CTOR_OFFSET UNITYSDK_OFFSET(0x176A58D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetAdvEffectToAnchor_TypeDefinitionIndex = 20516;
