...
#define RPG_GAMECORE_SETADVEFFECTTOANCHOR_METHOD_3_3385F7D2B16C13D1_OFFSET UNITYSDK_OFFSET(0x1C2D10C0)
#define RPG_GAMECORE_SETADVEFFECTTOANCHOR_METHOD_3_5217C84EA27847E4_OFFSET UNITYSDK_OFFSET(0x1C2D1100)
#define RPG_GAMECORE_SETADVEFFECTTOANCHOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2D10F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetAdvEffectToAnchor_TypeDefinitionIndex = 21510;
