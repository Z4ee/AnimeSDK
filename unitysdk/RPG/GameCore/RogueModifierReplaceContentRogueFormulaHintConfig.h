...
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEFORMULAHINTCONFIG_METHOD_3_0C3CE98EF686E6DA_OFFSET UNITYSDK_OFFSET(0x18D45170)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEFORMULAHINTCONFIG_METHOD_3_B86A7FA72BFAD923_OFFSET UNITYSDK_OFFSET(0x18D450A0)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEFORMULAHINTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D45120)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierReplaceContentRogueFormulaHintConfig_TypeDefinitionIndex = 16816;
