...
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEFORMULAHINTCONFIG_METHOD_3_0C3CE98EF686E6DA_OFFSET UNITYSDK_OFFSET(0x1D3FBDB0)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEFORMULAHINTCONFIG_METHOD_3_5C7A47758CAEE29E_OFFSET UNITYSDK_OFFSET(0x1D3FBD60)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEFORMULAHINTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3FBDA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierReplaceContentRogueFormulaHintConfig_TypeDefinitionIndex = 17496;
