...
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEFORMULAHINTCONFIG_METHOD_3_0C3CE98EF686E6DA_OFFSET UNITYSDK_OFFSET(0x17638620)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEFORMULAHINTCONFIG_METHOD_3_B86A7FA72BFAD923_OFFSET UNITYSDK_OFFSET(0x17638550)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEFORMULAHINTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x176385D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierReplaceContentRogueFormulaHintConfig_TypeDefinitionIndex = 16262;
