...
#define RPG_GAMECORE_SETCHARACTEREFFECTMATERIALBLOCK_METHOD_3_0DD6DFB7BBF3C0C4_OFFSET UNITYSDK_OFFSET(0x1E812810)
#define RPG_GAMECORE_SETCHARACTEREFFECTMATERIALBLOCK_METHOD_3_2320AC5561A7BB31_OFFSET UNITYSDK_OFFSET(0x1E8127D0)
#define RPG_GAMECORE_SETCHARACTEREFFECTMATERIALBLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x1E812800)
