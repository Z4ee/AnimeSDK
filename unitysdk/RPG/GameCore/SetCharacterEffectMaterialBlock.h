...
#define RPG_GAMECORE_SETCHARACTEREFFECTMATERIALBLOCK_METHOD_3_0DD6DFB7BBF3C0C4_OFFSET UNITYSDK_OFFSET(0x19C2EC30)
#define RPG_GAMECORE_SETCHARACTEREFFECTMATERIALBLOCK_METHOD_3_18935231A33196D3_OFFSET UNITYSDK_OFFSET(0x19C2EBB0)
#define RPG_GAMECORE_SETCHARACTEREFFECTMATERIALBLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x19C2EC00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetCharacterEffectMaterialBlock_TypeDefinitionIndex = 21928;
