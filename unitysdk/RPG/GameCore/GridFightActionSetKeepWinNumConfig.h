...
#define RPG_GAMECORE_GRIDFIGHTACTIONSETKEEPWINNUMCONFIG_METHOD_6_7ECB6DB90BE30955_OFFSET UNITYSDK_OFFSET(0x17250680)
#define RPG_GAMECORE_GRIDFIGHTACTIONSETKEEPWINNUMCONFIG_METHOD_6_FB7DDC539684A156_OFFSET UNITYSDK_OFFSET(0x172511B0)
#define RPG_GAMECORE_GRIDFIGHTACTIONSETKEEPWINNUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x172505E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightActionSetKeepWinNumConfig_TypeDefinitionIndex = 17726;
