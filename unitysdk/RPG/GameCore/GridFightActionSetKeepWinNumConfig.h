...
#define RPG_GAMECORE_GRIDFIGHTACTIONSETKEEPWINNUMCONFIG_METHOD_6_32722BAFC1BEC531_OFFSET UNITYSDK_OFFSET(0x1C5C20B0)
#define RPG_GAMECORE_GRIDFIGHTACTIONSETKEEPWINNUMCONFIG_METHOD_6_7ECB6DB90BE30955_OFFSET UNITYSDK_OFFSET(0x1C5C1C50)
#define RPG_GAMECORE_GRIDFIGHTACTIONSETKEEPWINNUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5C1C40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightActionSetKeepWinNumConfig_TypeDefinitionIndex = 18547;
