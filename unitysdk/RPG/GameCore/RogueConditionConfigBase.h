...
#define RPG_GAMECORE_ROGUECONDITIONCONFIGBASE_METHOD_5_202F60AA9B78CCAD_OFFSET UNITYSDK_OFFSET(0x1D3CBFD0)
#define RPG_GAMECORE_ROGUECONDITIONCONFIGBASE_METHOD_5_4D275D38310FAFB9_OFFSET UNITYSDK_OFFSET(0x1D3CC030)
#define RPG_GAMECORE_ROGUECONDITIONCONFIGBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3CB8A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueConditionConfigBase_TypeDefinitionIndex = 19562;
