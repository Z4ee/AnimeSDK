...
#define RPG_GAMECORE_MAPROTATIONVOLUMESLOTCONFIGBASE_METHOD_2_D09F207CF7F8D1AB_OFFSET UNITYSDK_OFFSET(0x18A8F8A0)
#define RPG_GAMECORE_MAPROTATIONVOLUMESLOTCONFIGBASE_METHOD_2_EE8449C16FFC1037_OFFSET UNITYSDK_OFFSET(0x18A8F710)
#define RPG_GAMECORE_MAPROTATIONVOLUMESLOTCONFIGBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x18A8F580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MapRotationVolumeSlotConfigBase_TypeDefinitionIndex = 21183;
