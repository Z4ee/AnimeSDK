...
#define RPG_GAMECORE_STARTAIM_METHOD_3_437D51C179124BDD_OFFSET UNITYSDK_OFFSET(0x1B0BC3D0)
#define RPG_GAMECORE_STARTAIM_METHOD_3_DD0E6FB00E9A9041_OFFSET UNITYSDK_OFFSET(0x1B0BC450)
#define RPG_GAMECORE_STARTAIM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0BC420)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StartAim_TypeDefinitionIndex = 21593;
