...
#define RPG_GAMECORE_STARTAIM_METHOD_3_87C2E1E4BEF72A07_OFFSET UNITYSDK_OFFSET(0x18E99090)
#define RPG_GAMECORE_STARTAIM_METHOD_3_DD0E6FB00E9A9041_OFFSET UNITYSDK_OFFSET(0x18E99150)
#define RPG_GAMECORE_STARTAIM__CTOR_OFFSET UNITYSDK_OFFSET(0x18E99100)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StartAim_TypeDefinitionIndex = 21285;
	...
	public:
		...
		static ::System::Void Method_3_87C2E1E4BEF72A07(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::StartAim*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::StartAim*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_STARTAIM_METHOD_3_87C2E1E4BEF72A07_OFFSET))(a1, a2);
		}
