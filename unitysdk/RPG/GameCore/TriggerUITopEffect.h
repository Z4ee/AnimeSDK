...
#define RPG_GAMECORE_TRIGGERUITOPEFFECT_METHOD_3_206557BA4B24B5C0_OFFSET UNITYSDK_OFFSET(0x178CFF10)
#define RPG_GAMECORE_TRIGGERUITOPEFFECT_METHOD_3_64ECB840827D45EC_OFFSET UNITYSDK_OFFSET(0x178CFFE0)
#define RPG_GAMECORE_TRIGGERUITOPEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x178CFF90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerUITopEffect_TypeDefinitionIndex = 21386;
