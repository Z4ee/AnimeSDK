...
#define RPG_GAMECORE_TRAINPARTYBUILDITEMSLOT_METHOD_2_4FCEDC98F37A22E5_OFFSET UNITYSDK_OFFSET(0x1D5DB5C0)
#define RPG_GAMECORE_TRAINPARTYBUILDITEMSLOT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5DB7D0)
