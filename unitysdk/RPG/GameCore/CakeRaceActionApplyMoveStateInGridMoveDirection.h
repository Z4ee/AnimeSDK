...
#define RPG_GAMECORE_CAKERACEACTIONAPPLYMOVESTATEINGRIDMOVEDIRECTION_METHOD_3_B870D485B211C8AD_OFFSET UNITYSDK_OFFSET(0x1B2CA460)
#define RPG_GAMECORE_CAKERACEACTIONAPPLYMOVESTATEINGRIDMOVEDIRECTION_METHOD_3_E67DF8C1B151C71B_OFFSET UNITYSDK_OFFSET(0x1B2CA400)
#define RPG_GAMECORE_CAKERACEACTIONAPPLYMOVESTATEINGRIDMOVEDIRECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2CA450)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionApplyMoveStateInGridMoveDirection_TypeDefinitionIndex = 17613;
