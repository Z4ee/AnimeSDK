...
#define RPG_GAMECORE_CAKERACEACTIONAPPLYMOVESTATEINGRIDMOVEDIRECTION_METHOD_3_0F105FF1E5C570ED_OFFSET UNITYSDK_OFFSET(0x170421C0)
#define RPG_GAMECORE_CAKERACEACTIONAPPLYMOVESTATEINGRIDMOVEDIRECTION_METHOD_3_B870D485B211C8AD_OFFSET UNITYSDK_OFFSET(0x17042250)
#define RPG_GAMECORE_CAKERACEACTIONAPPLYMOVESTATEINGRIDMOVEDIRECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x17042230)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionApplyMoveStateInGridMoveDirection_TypeDefinitionIndex = 16843;
