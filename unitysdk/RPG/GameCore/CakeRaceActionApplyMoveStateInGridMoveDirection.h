...
#define RPG_GAMECORE_CAKERACEACTIONAPPLYMOVESTATEINGRIDMOVEDIRECTION_METHOD_3_0F105FF1E5C570ED_OFFSET UNITYSDK_OFFSET(0x18767920)
#define RPG_GAMECORE_CAKERACEACTIONAPPLYMOVESTATEINGRIDMOVEDIRECTION_METHOD_3_B870D485B211C8AD_OFFSET UNITYSDK_OFFSET(0x187679B0)
#define RPG_GAMECORE_CAKERACEACTIONAPPLYMOVESTATEINGRIDMOVEDIRECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18767990)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionApplyMoveStateInGridMoveDirection_TypeDefinitionIndex = 17437;
