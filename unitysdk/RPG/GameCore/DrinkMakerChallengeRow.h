...
#define RPG_GAMECORE_DRINKMAKERCHALLENGEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1BB1AC40)
#define RPG_GAMECORE_DRINKMAKERCHALLENGEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB1AF00)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::DrinkMakerUnlockType UnlockType; // 0x28
