...
#define RPG_GAMECORE_TRAVELSHIPARRIVETO_METHOD_3_0BAAD1472C48C136_OFFSET UNITYSDK_OFFSET(0x178B6B20)
#define RPG_GAMECORE_TRAVELSHIPARRIVETO_METHOD_3_3125392B6D5483D1_OFFSET UNITYSDK_OFFSET(0x178B6A20)
#define RPG_GAMECORE_TRAVELSHIPARRIVETO__CTOR_OFFSET UNITYSDK_OFFSET(0x178B6AB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TravelShipArriveTo_TypeDefinitionIndex = 19304;
