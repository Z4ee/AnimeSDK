...
#define RPG_GAMECORE_BYATTACKTYPE_METHOD_4_463824F155FA3A64_OFFSET UNITYSDK_OFFSET(0x19CBCD30)
#define RPG_GAMECORE_BYATTACKTYPE_METHOD_4_B1D6A07AB61BC742_OFFSET UNITYSDK_OFFSET(0x19CBCFA0)
#define RPG_GAMECORE_BYATTACKTYPE_METHOD_4_CEDF7FADD7FD6957_OFFSET UNITYSDK_OFFSET(0x19CBD000)
#define RPG_GAMECORE_BYATTACKTYPE_METHOD_4_FB6181DFE4F159C1_OFFSET UNITYSDK_OFFSET(0x19CBCDD0)
#define RPG_GAMECORE_BYATTACKTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x19CBCD90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByAttackType_TypeDefinitionIndex = 22667;
