...
#define RPG_GAMECORE_BYATTACKTYPE_METHOD_4_BBDCB21837290D52_OFFSET UNITYSDK_OFFSET(0x16FFB0D0)
#define RPG_GAMECORE_BYATTACKTYPE_METHOD_4_FB6181DFE4F159C1_OFFSET UNITYSDK_OFFSET(0x16FFB1F0)
#define RPG_GAMECORE_BYATTACKTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x16FFB170)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByAttackType_TypeDefinitionIndex = 21740;
