...
#define RPG_GAMECORE_LINEUPMAZEBUFFCONFIG_METHOD_2_B0A2E776730B42FA_OFFSET UNITYSDK_OFFSET(0x1D1F7CF0)
#define RPG_GAMECORE_LINEUPMAZEBUFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1F7E80)
