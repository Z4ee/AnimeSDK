...
#define RPG_GAMECORE_LINEUPMAZEBUFFCONFIG_METHOD_2_B0A2E776730B42FA_OFFSET UNITYSDK_OFFSET(0x19891AF0)
#define RPG_GAMECORE_LINEUPMAZEBUFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19891C80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LineupMazeBuffConfig_TypeDefinitionIndex = 17241;
