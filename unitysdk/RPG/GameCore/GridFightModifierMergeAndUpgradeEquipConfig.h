...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERMERGEANDUPGRADEEQUIPCONFIG_METHOD_3_8679C7EB9C11DDF6_OFFSET UNITYSDK_OFFSET(0x189BDC50)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERMERGEANDUPGRADEEQUIPCONFIG_METHOD_3_ABE77358871980AF_OFFSET UNITYSDK_OFFSET(0x189BDD20)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERMERGEANDUPGRADEEQUIPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189BDCD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierMergeAndUpgradeEquipConfig_TypeDefinitionIndex = 18457;
