...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERMERGEANDUPGRADEEQUIPCONFIG_METHOD_3_8357A8FF2CAF2FAB_OFFSET UNITYSDK_OFFSET(0x1D06A3E0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERMERGEANDUPGRADEEQUIPCONFIG_METHOD_3_ABE77358871980AF_OFFSET UNITYSDK_OFFSET(0x1D06A430)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERMERGEANDUPGRADEEQUIPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D06A420)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierMergeAndUpgradeEquipConfig_TypeDefinitionIndex = 18677;
