...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERMERGEANDUPGRADEEQUIPCONFIG_METHOD_3_8679C7EB9C11DDF6_OFFSET UNITYSDK_OFFSET(0x197F2CF0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERMERGEANDUPGRADEEQUIPCONFIG_METHOD_3_ABE77358871980AF_OFFSET UNITYSDK_OFFSET(0x197EDDF0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERMERGEANDUPGRADEEQUIPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197EDDA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierMergeAndUpgradeEquipConfig_TypeDefinitionIndex = 18429;
