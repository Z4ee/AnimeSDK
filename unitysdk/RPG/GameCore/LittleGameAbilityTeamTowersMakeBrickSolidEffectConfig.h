...
#define RPG_GAMECORE_LITTLEGAMEABILITYTEAMTOWERSMAKEBRICKSOLIDEFFECTCONFIG_METHOD_3_C8C99F80A16FC049_OFFSET UNITYSDK_OFFSET(0x1BCBC930)
#define RPG_GAMECORE_LITTLEGAMEABILITYTEAMTOWERSMAKEBRICKSOLIDEFFECTCONFIG_METHOD_3_E977936DB6BA78F4_OFFSET UNITYSDK_OFFSET(0x1BCBC9D0)
#define RPG_GAMECORE_LITTLEGAMEABILITYTEAMTOWERSMAKEBRICKSOLIDEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCBC9C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityTeamTowersMakeBrickSolidEffectConfig_TypeDefinitionIndex = 20617;
