...
#define RPG_GAMECORE_SHOWEVOLVEBUILDCARDSELECTINBATTLE_METHOD_3_23FB611870D35CF4_OFFSET UNITYSDK_OFFSET(0x18E5D2F0)
#define RPG_GAMECORE_SHOWEVOLVEBUILDCARDSELECTINBATTLE_METHOD_3_DB91D1EC3291B225_OFFSET UNITYSDK_OFFSET(0x18E5D270)
#define RPG_GAMECORE_SHOWEVOLVEBUILDCARDSELECTINBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E5D2C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowEvolveBuildCardSelectInBattle_TypeDefinitionIndex = 21396;
