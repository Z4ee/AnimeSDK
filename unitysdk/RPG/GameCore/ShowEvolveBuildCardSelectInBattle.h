...
#define RPG_GAMECORE_SHOWEVOLVEBUILDCARDSELECTINBATTLE_METHOD_3_5DF8F5B6EC5F3D72_OFFSET UNITYSDK_OFFSET(0x1E0A70B0)
#define RPG_GAMECORE_SHOWEVOLVEBUILDCARDSELECTINBATTLE_METHOD_3_9C95762E89F5BABB_OFFSET UNITYSDK_OFFSET(0x1E0A7060)
#define RPG_GAMECORE_SHOWEVOLVEBUILDCARDSELECTINBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0A70A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowEvolveBuildCardSelectInBattle_TypeDefinitionIndex = 22264;
