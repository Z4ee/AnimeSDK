...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETCURKEEPWINCNTCONFIG_METHOD_6_37E41C1CB77E0F9B_OFFSET UNITYSDK_OFFSET(0x197F7700)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETCURKEEPWINCNTCONFIG_METHOD_6_59E2218F8EF86FB5_OFFSET UNITYSDK_OFFSET(0x197F7450)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETCURKEEPWINCNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197F75D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightParamGetCurKeepWinCntConfig_TypeDefinitionIndex = 18515;
