...
#define RPG_GAMECORE_CAKERACEACTIONSPAWNABILITY_METHOD_3_735475285C3C6AE7_OFFSET UNITYSDK_OFFSET(0x1B2CC3E0)
#define RPG_GAMECORE_CAKERACEACTIONSPAWNABILITY_METHOD_3_7E870B39A2CAC5DB_OFFSET UNITYSDK_OFFSET(0x1B2CC4B0)
#define RPG_GAMECORE_CAKERACEACTIONSPAWNABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2CC4A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionSpawnAbility_TypeDefinitionIndex = 17627;
