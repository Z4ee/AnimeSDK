...
#define RPG_GAMECORE_CAKERACEACTIONSPAWNABILITY_METHOD_3_7E870B39A2CAC5DB_OFFSET UNITYSDK_OFFSET(0x1876B050)
#define RPG_GAMECORE_CAKERACEACTIONSPAWNABILITY_METHOD_3_BB6A735C1D1F1484_OFFSET UNITYSDK_OFFSET(0x1876C3A0)
#define RPG_GAMECORE_CAKERACEACTIONSPAWNABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1876B030)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionSpawnAbility_TypeDefinitionIndex = 17451;
