...
#define RPG_GAMECORE_ST_SIDE_REGISTERSPECIALEVENT_METHOD_4_7CA488C00B33FDAC_OFFSET UNITYSDK_OFFSET(0x1C2C4B20)
#define RPG_GAMECORE_ST_SIDE_REGISTERSPECIALEVENT_METHOD_4_D7442EF998285D53_OFFSET UNITYSDK_OFFSET(0x1C2C4B60)
#define RPG_GAMECORE_ST_SIDE_REGISTERSPECIALEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2C4B50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_RegisterSpecialEvent_TypeDefinitionIndex = 19355;
