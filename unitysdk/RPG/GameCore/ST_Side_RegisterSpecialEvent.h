...
#define RPG_GAMECORE_ST_SIDE_REGISTERSPECIALEVENT_METHOD_4_98103278129BB67E_OFFSET UNITYSDK_OFFSET(0x19C1AF50)
#define RPG_GAMECORE_ST_SIDE_REGISTERSPECIALEVENT_METHOD_4_D7442EF998285D53_OFFSET UNITYSDK_OFFSET(0x19C0CE10)
#define RPG_GAMECORE_ST_SIDE_REGISTERSPECIALEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19C0CDC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_RegisterSpecialEvent_TypeDefinitionIndex = 19004;
