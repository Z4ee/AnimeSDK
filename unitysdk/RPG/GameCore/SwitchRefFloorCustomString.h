...
#define RPG_GAMECORE_SWITCHREFFLOORCUSTOMSTRING_METHOD_3_08E978B2A0BB50C0_OFFSET UNITYSDK_OFFSET(0x19CDF2D0)
#define RPG_GAMECORE_SWITCHREFFLOORCUSTOMSTRING_METHOD_3_FB054228EC6FB87D_OFFSET UNITYSDK_OFFSET(0x19CDFB40)
#define RPG_GAMECORE_SWITCHREFFLOORCUSTOMSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x19CDF2C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchRefFloorCustomString_TypeDefinitionIndex = 16663;
