...
#define RPG_GAMECORE_SWITCHREFFLOORCUSTOMSTRING_METHOD_3_08E978B2A0BB50C0_OFFSET UNITYSDK_OFFSET(0x17799220)
#define RPG_GAMECORE_SWITCHREFFLOORCUSTOMSTRING_METHOD_3_FB054228EC6FB87D_OFFSET UNITYSDK_OFFSET(0x17799A90)
#define RPG_GAMECORE_SWITCHREFFLOORCUSTOMSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x17799210)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchRefFloorCustomString_TypeDefinitionIndex = 16102;
