...
#define RPG_GAMECORE_BYISBODYPART_METHOD_4_0EB4546BEE028812_OFFSET UNITYSDK_OFFSET(0x1A8D8150)
#define RPG_GAMECORE_BYISBODYPART_METHOD_4_4032B792DADECEDB_OFFSET UNITYSDK_OFFSET(0x1A8D7E70)
#define RPG_GAMECORE_BYISBODYPART_METHOD_4_425C424AF8B6EFD5_OFFSET UNITYSDK_OFFSET(0x1A8D7A00)
#define RPG_GAMECORE_BYISBODYPART_METHOD_4_D5092F1293684E94_OFFSET UNITYSDK_OFFSET(0x1A8D7B60)
#define RPG_GAMECORE_BYISBODYPART__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8D7B50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsBodyPart_TypeDefinitionIndex = 22475;
