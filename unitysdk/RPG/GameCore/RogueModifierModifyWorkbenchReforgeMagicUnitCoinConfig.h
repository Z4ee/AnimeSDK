...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYWORKBENCHREFORGEMAGICUNITCOINCONFIG_METHOD_3_1A9F0308BBBBE027_OFFSET UNITYSDK_OFFSET(0x18D439D0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYWORKBENCHREFORGEMAGICUNITCOINCONFIG_METHOD_3_548A8C8E838B76AE_OFFSET UNITYSDK_OFFSET(0x18D43900)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYWORKBENCHREFORGEMAGICUNITCOINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D43980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyWorkbenchReforgeMagicUnitCoinConfig_TypeDefinitionIndex = 16978;
