...
#define RPG_GAMECORE_CHESTMONSTERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C38B7B0)
#define RPG_GAMECORE_CHESTMONSTERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C38BA40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChestMonsterRow_TypeDefinitionIndex = 13860;
