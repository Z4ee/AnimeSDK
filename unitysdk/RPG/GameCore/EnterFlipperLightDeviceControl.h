...
#define RPG_GAMECORE_ENTERFLIPPERLIGHTDEVICECONTROL_METHOD_3_7F7BEC30B24AB3F1_OFFSET UNITYSDK_OFFSET(0x188AB4F0)
#define RPG_GAMECORE_ENTERFLIPPERLIGHTDEVICECONTROL_METHOD_3_F8F5753BB800AF94_OFFSET UNITYSDK_OFFSET(0x188AB420)
#define RPG_GAMECORE_ENTERFLIPPERLIGHTDEVICECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x188AB4A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnterFlipperLightDeviceControl_TypeDefinitionIndex = 21223;
