...
#define RPG_GAMECORE_ENTERFLIPPERLIGHTDEVICECONTROL_METHOD_3_7F7BEC30B24AB3F1_OFFSET UNITYSDK_OFFSET(0x1D067CE0)
#define RPG_GAMECORE_ENTERFLIPPERLIGHTDEVICECONTROL_METHOD_3_CD6384A8D70CA69D_OFFSET UNITYSDK_OFFSET(0x1D067C40)
#define RPG_GAMECORE_ENTERFLIPPERLIGHTDEVICECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D067CA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnterFlipperLightDeviceControl_TypeDefinitionIndex = 22096;
