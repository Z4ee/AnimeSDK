...
#define RPG_GAMECORE_FIVEDIMMISCCONFIG_METHOD_2_EB8164199D647622_OFFSET UNITYSDK_OFFSET(0x1D0E8290)
#define RPG_GAMECORE_FIVEDIMMISCCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0F1020)
