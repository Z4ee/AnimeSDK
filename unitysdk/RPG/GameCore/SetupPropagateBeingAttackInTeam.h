...
#define RPG_GAMECORE_SETUPPROPAGATEBEINGATTACKINTEAM_METHOD_3_1B65D8EDE69CF097_OFFSET UNITYSDK_OFFSET(0x19C6B5C0)
#define RPG_GAMECORE_SETUPPROPAGATEBEINGATTACKINTEAM_METHOD_3_380DB2A5614A6CE6_OFFSET UNITYSDK_OFFSET(0x19C6B540)
#define RPG_GAMECORE_SETUPPROPAGATEBEINGATTACKINTEAM__CTOR_OFFSET UNITYSDK_OFFSET(0x19C6B590)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetupPropagateBeingAttackInTeam_TypeDefinitionIndex = 21945;
