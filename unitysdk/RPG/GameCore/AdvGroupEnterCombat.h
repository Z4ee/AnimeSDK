...
#define RPG_GAMECORE_ADVGROUPENTERCOMBAT_METHOD_3_B77887AE21F691A2_OFFSET UNITYSDK_OFFSET(0x16F30F00)
#define RPG_GAMECORE_ADVGROUPENTERCOMBAT_METHOD_3_C590CCD336BA8855_OFFSET UNITYSDK_OFFSET(0x16F30E80)
#define RPG_GAMECORE_ADVGROUPENTERCOMBAT__CTOR_OFFSET UNITYSDK_OFFSET(0x16F30ED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvGroupEnterCombat_TypeDefinitionIndex = 18867;
