...
#define RPG_GAMECORE_PARAMUNARYEXPRCONFIG_METHOD_4_2EE1E7DBCC6D7B9C_OFFSET UNITYSDK_OFFSET(0x18BD42F0)
#define RPG_GAMECORE_PARAMUNARYEXPRCONFIG_METHOD_4_B4E54B9AA1F58EFD_OFFSET UNITYSDK_OFFSET(0x18BD4430)
#define RPG_GAMECORE_PARAMUNARYEXPRCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18BD43B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ParamUnaryExprConfig_TypeDefinitionIndex = 16172;
