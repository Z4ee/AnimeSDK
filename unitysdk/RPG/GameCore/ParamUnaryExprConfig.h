...
#define RPG_GAMECORE_PARAMUNARYEXPRCONFIG_METHOD_4_B4E54B9AA1F58EFD_OFFSET UNITYSDK_OFFSET(0x1BB0E320)
#define RPG_GAMECORE_PARAMUNARYEXPRCONFIG_METHOD_4_EA63E0761B9E42EB_OFFSET UNITYSDK_OFFSET(0x1BB0E2C0)
#define RPG_GAMECORE_PARAMUNARYEXPRCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB0E310)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ParamUnaryExprConfig_TypeDefinitionIndex = 16401;
