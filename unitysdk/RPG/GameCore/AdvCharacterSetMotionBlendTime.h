...
#define RPG_GAMECORE_ADVCHARACTERSETMOTIONBLENDTIME_METHOD_3_9467531248750D98_OFFSET UNITYSDK_OFFSET(0x16F28BF0)
#define RPG_GAMECORE_ADVCHARACTERSETMOTIONBLENDTIME_METHOD_3_FD8D163508A399A4_OFFSET UNITYSDK_OFFSET(0x16F28CD0)
#define RPG_GAMECORE_ADVCHARACTERSETMOTIONBLENDTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x16F28C70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvCharacterSetMotionBlendTime_TypeDefinitionIndex = 18916;
