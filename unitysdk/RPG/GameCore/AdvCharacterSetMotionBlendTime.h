...
#define RPG_GAMECORE_ADVCHARACTERSETMOTIONBLENDTIME_METHOD_3_9467531248750D98_OFFSET UNITYSDK_OFFSET(0x1864ADC0)
#define RPG_GAMECORE_ADVCHARACTERSETMOTIONBLENDTIME_METHOD_3_FD8D163508A399A4_OFFSET UNITYSDK_OFFSET(0x1864AEA0)
#define RPG_GAMECORE_ADVCHARACTERSETMOTIONBLENDTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x1864AE40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvCharacterSetMotionBlendTime_TypeDefinitionIndex = 19574;
