...
#define RPG_GAMECORE_PARKOURGAMECONFIG_METHOD_3_0595DF97722CFF15_OFFSET UNITYSDK_OFFSET(0x1D414720)
#define RPG_GAMECORE_PARKOURGAMECONFIG_METHOD_3_F14643E049C702D8_OFFSET UNITYSDK_OFFSET(0x1D414660)
#define RPG_GAMECORE_PARKOURGAMECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D414710)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ParkourGameConfig_TypeDefinitionIndex = 16780;
