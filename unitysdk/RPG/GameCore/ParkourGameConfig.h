...
#define RPG_GAMECORE_PARKOURGAMECONFIG_METHOD_3_0595DF97722CFF15_OFFSET UNITYSDK_OFFSET(0x1748A660)
#define RPG_GAMECORE_PARKOURGAMECONFIG_METHOD_3_F14643E049C702D8_OFFSET UNITYSDK_OFFSET(0x1748A5A0)
#define RPG_GAMECORE_PARKOURGAMECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1748A650)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ParkourGameConfig_TypeDefinitionIndex = 15542;
