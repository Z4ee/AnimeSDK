...
#define RPG_GAMECORE_TEAMFORMATIONCOMPONENT_ROWFORMATIONREFRESHGROUP_FINDFORMATIONWITHFILTER_OFFSET UNITYSDK_OFFSET(0xB781B40)
#define RPG_GAMECORE_TEAMFORMATIONCOMPONENT_ROWFORMATIONREFRESHGROUP_GETFORMATIONLIST_OFFSET UNITYSDK_OFFSET(0xB7813E0)
#define RPG_GAMECORE_TEAMFORMATIONCOMPONENT_ROWFORMATIONREFRESHGROUP_GETINDEX_OFFSET UNITYSDK_OFFSET(0xB781CF0)
#define RPG_GAMECORE_TEAMFORMATIONCOMPONENT_ROWFORMATIONREFRESHGROUP_GET_ITEM_OFFSET UNITYSDK_OFFSET(0xB7810B0)
#define RPG_GAMECORE_TEAMFORMATIONCOMPONENT_ROWFORMATIONREFRESHGROUP_GET_REALLENGTH_OFFSET UNITYSDK_OFFSET(0xB781B20)
#define RPG_GAMECORE_TEAMFORMATIONCOMPONENT_ROWFORMATIONREFRESHGROUP_INIT_OFFSET UNITYSDK_OFFSET(0xB780DC0)
#define RPG_GAMECORE_TEAMFORMATIONCOMPONENT_ROWFORMATIONREFRESHGROUP_RESET_OFFSET UNITYSDK_OFFSET(0xB780EB0)
#define RPG_GAMECORE_TEAMFORMATIONCOMPONENT_ROWFORMATIONREFRESHGROUP_SET_REALLENGTH_OFFSET UNITYSDK_OFFSET(0xB781B30)
#define RPG_GAMECORE_TEAMFORMATIONCOMPONENT_ROWFORMATIONREFRESHGROUP__ADDFORMATION_OFFSET UNITYSDK_OFFSET(0xB781BD0)
#define RPG_GAMECORE_TEAMFORMATIONCOMPONENT_ROWFORMATIONREFRESHGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0xB781420)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TeamFormationComponent_RowFormationRefreshGroup_TypeDefinitionIndex = 53202;
