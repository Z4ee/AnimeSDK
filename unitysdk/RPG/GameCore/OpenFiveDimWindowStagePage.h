...
#define RPG_GAMECORE_OPENFIVEDIMWINDOWSTAGEPAGE_METHOD_3_400DEE1D1A272C2F_OFFSET UNITYSDK_OFFSET(0x1CE97170)
#define RPG_GAMECORE_OPENFIVEDIMWINDOWSTAGEPAGE_METHOD_3_9F18E02315F9EF22_OFFSET UNITYSDK_OFFSET(0x1CE971B0)
#define RPG_GAMECORE_OPENFIVEDIMWINDOWSTAGEPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE971A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OpenFiveDimWindowStagePage_TypeDefinitionIndex = 21041;
