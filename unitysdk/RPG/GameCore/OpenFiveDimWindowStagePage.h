...
#define RPG_GAMECORE_OPENFIVEDIMWINDOWSTAGEPAGE_METHOD_3_9F18E02315F9EF22_OFFSET UNITYSDK_OFFSET(0x18BC54A0)
#define RPG_GAMECORE_OPENFIVEDIMWINDOWSTAGEPAGE_METHOD_3_E576895061AB5487_OFFSET UNITYSDK_OFFSET(0x18BC5420)
#define RPG_GAMECORE_OPENFIVEDIMWINDOWSTAGEPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x18BC5470)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OpenFiveDimWindowStagePage_TypeDefinitionIndex = 20261;
