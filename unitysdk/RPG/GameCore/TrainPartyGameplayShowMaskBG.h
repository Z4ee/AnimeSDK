...
#define RPG_GAMECORE_TRAINPARTYGAMEPLAYSHOWMASKBG_METHOD_3_32A73084D8CBBA2B_OFFSET UNITYSDK_OFFSET(0x19DF5510)
#define RPG_GAMECORE_TRAINPARTYGAMEPLAYSHOWMASKBG_METHOD_3_346299B982BCF03A_OFFSET UNITYSDK_OFFSET(0x19DF5490)
#define RPG_GAMECORE_TRAINPARTYGAMEPLAYSHOWMASKBG__CTOR_OFFSET UNITYSDK_OFFSET(0x19DF54E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyGameplayShowMaskBG_TypeDefinitionIndex = 21144;
