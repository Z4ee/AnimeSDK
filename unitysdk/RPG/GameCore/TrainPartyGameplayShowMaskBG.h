...
#define RPG_GAMECORE_TRAINPARTYGAMEPLAYSHOWMASKBG_METHOD_3_32A73084D8CBBA2B_OFFSET UNITYSDK_OFFSET(0x1C1605B0)
#define RPG_GAMECORE_TRAINPARTYGAMEPLAYSHOWMASKBG_METHOD_3_3F86E7E2C2DC4332_OFFSET UNITYSDK_OFFSET(0x1C160570)
#define RPG_GAMECORE_TRAINPARTYGAMEPLAYSHOWMASKBG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1605A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyGameplayShowMaskBG_TypeDefinitionIndex = 21559;
