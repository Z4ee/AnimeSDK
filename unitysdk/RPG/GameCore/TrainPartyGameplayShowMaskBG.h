...
#define RPG_GAMECORE_TRAINPARTYGAMEPLAYSHOWMASKBG_METHOD_3_32A73084D8CBBA2B_OFFSET UNITYSDK_OFFSET(0x178ABEC0)
#define RPG_GAMECORE_TRAINPARTYGAMEPLAYSHOWMASKBG_METHOD_3_346299B982BCF03A_OFFSET UNITYSDK_OFFSET(0x178ABE40)
#define RPG_GAMECORE_TRAINPARTYGAMEPLAYSHOWMASKBG__CTOR_OFFSET UNITYSDK_OFFSET(0x178ABE90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyGameplayShowMaskBG_TypeDefinitionIndex = 20568;
