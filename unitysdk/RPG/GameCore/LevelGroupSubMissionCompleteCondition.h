...
#define RPG_GAMECORE_LEVELGROUPSUBMISSIONCOMPLETECONDITION_METHOD_3_29A012CEE775FCA3_OFFSET UNITYSDK_OFFSET(0x18A470C0)
#define RPG_GAMECORE_LEVELGROUPSUBMISSIONCOMPLETECONDITION_METHOD_3_6C11EF30CBDC644E_OFFSET UNITYSDK_OFFSET(0x18A47170)
#define RPG_GAMECORE_LEVELGROUPSUBMISSIONCOMPLETECONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x18A47160)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelGroupSubMissionCompleteCondition_TypeDefinitionIndex = 16332;
