...
#define RPG_GAMECORE_BYDAMAGESOURCECONTAINBEHAVIORFLAG_METHOD_4_4B5C72D1644C12AD_OFFSET UNITYSDK_OFFSET(0x1CF15900)
#define RPG_GAMECORE_BYDAMAGESOURCECONTAINBEHAVIORFLAG_METHOD_4_64AFFBBC809A6D47_OFFSET UNITYSDK_OFFSET(0x1CF15A90)
#define RPG_GAMECORE_BYDAMAGESOURCECONTAINBEHAVIORFLAG_METHOD_4_B7DE979A62C4C050_OFFSET UNITYSDK_OFFSET(0x1CF15AC0)
#define RPG_GAMECORE_BYDAMAGESOURCECONTAINBEHAVIORFLAG_METHOD_4_F8948E17D9FF97C8_OFFSET UNITYSDK_OFFSET(0x1CF158C0)
#define RPG_GAMECORE_BYDAMAGESOURCECONTAINBEHAVIORFLAG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF158F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByDamageSourceContainBehaviorFlag_TypeDefinitionIndex = 23045;
