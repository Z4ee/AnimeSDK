...
#define RPG_GAMECORE_REMOVEDITHERGROUP_METHOD_3_612B08CA531B33A1_OFFSET UNITYSDK_OFFSET(0x175971F0)
#define RPG_GAMECORE_REMOVEDITHERGROUP_METHOD_3_B95D03ACB8740B5D_OFFSET UNITYSDK_OFFSET(0x17597270)
#define RPG_GAMECORE_REMOVEDITHERGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x17597240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveDitherGroup_TypeDefinitionIndex = 21108;
