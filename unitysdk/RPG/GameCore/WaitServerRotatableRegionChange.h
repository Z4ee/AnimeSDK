...
#define RPG_GAMECORE_WAITSERVERROTATABLEREGIONCHANGE_METHOD_3_1CF80741BE80973D_OFFSET UNITYSDK_OFFSET(0x1DEC1890)
#define RPG_GAMECORE_WAITSERVERROTATABLEREGIONCHANGE_METHOD_3_CCA271D324565CF9_OFFSET UNITYSDK_OFFSET(0x1DEC1840)
#define RPG_GAMECORE_WAITSERVERROTATABLEREGIONCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEC1880)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitServerRotatableRegionChange_TypeDefinitionIndex = 21006;
