...
#define RPG_GAMECORE_ADVSTARTTICKFLOATVALUE_METHOD_3_2D1EB5FB598704A8_OFFSET UNITYSDK_OFFSET(0x18666F70)
#define RPG_GAMECORE_ADVSTARTTICKFLOATVALUE_METHOD_3_9C23BA6C6A283F71_OFFSET UNITYSDK_OFFSET(0x18666EF0)
#define RPG_GAMECORE_ADVSTARTTICKFLOATVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x18666F40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvStartTickFloatValue_TypeDefinitionIndex = 20010;
