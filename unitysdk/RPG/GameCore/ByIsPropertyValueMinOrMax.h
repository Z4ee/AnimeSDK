...
#define RPG_GAMECORE_BYISPROPERTYVALUEMINORMAX_METHOD_4_7A8EE6DDDBC48682_OFFSET UNITYSDK_OFFSET(0x17031760)
#define RPG_GAMECORE_BYISPROPERTYVALUEMINORMAX_METHOD_4_E88E6D2A4B53730E_OFFSET UNITYSDK_OFFSET(0x17031880)
#define RPG_GAMECORE_BYISPROPERTYVALUEMINORMAX__CTOR_OFFSET UNITYSDK_OFFSET(0x17031800)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsPropertyValueMinOrMax_TypeDefinitionIndex = 20741;
