...
#define RPG_GAMECORE_NOTIFYOVERRIDEFUNCBTNPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x190031D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NotifyOverrideFuncBtnParam_TypeDefinitionIndex = 53493;
