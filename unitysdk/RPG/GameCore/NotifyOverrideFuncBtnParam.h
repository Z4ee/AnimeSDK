...
#define RPG_GAMECORE_NOTIFYOVERRIDEFUNCBTNPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xA9FE5B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NotifyOverrideFuncBtnParam_TypeDefinitionIndex = 43099;
