...
#define RPG_GAMECORE_BYCURRENTROGUEHASMIRACLE_METHOD_4_893B97EA58BC0FE8_OFFSET UNITYSDK_OFFSET(0x1A8B8DB0)
#define RPG_GAMECORE_BYCURRENTROGUEHASMIRACLE_METHOD_4_986CA1204AFEBD2E_OFFSET UNITYSDK_OFFSET(0x1A8B8BD0)
#define RPG_GAMECORE_BYCURRENTROGUEHASMIRACLE_METHOD_4_98848E9034DBA46F_OFFSET UNITYSDK_OFFSET(0x1A8B8D80)
#define RPG_GAMECORE_BYCURRENTROGUEHASMIRACLE_METHOD_4_BFB9B70198F60B43_OFFSET UNITYSDK_OFFSET(0x1A8B8C10)
#define RPG_GAMECORE_BYCURRENTROGUEHASMIRACLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8B8C00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCurrentRogueHasMiracle_TypeDefinitionIndex = 20257;
