...
#define RPG_GAMECORE_BYCURRENTROGUEHASMIRACLE_METHOD_4_9993237B4DDF2141_OFFSET UNITYSDK_OFFSET(0x1701EBE0)
#define RPG_GAMECORE_BYCURRENTROGUEHASMIRACLE_METHOD_4_BFB9B70198F60B43_OFFSET UNITYSDK_OFFSET(0x1701ECB0)
#define RPG_GAMECORE_BYCURRENTROGUEHASMIRACLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1701EC60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCurrentRogueHasMiracle_TypeDefinitionIndex = 19374;
