...
#define RPG_GAMECORE_COMMONSKILLPOOL_METHOD_2_EAD0E25947E93DA9_OFFSET UNITYSDK_OFFSET(0x1D9A72B0)
#define RPG_GAMECORE_COMMONSKILLPOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D9A7420)
