...
#define RPG_GAMECORE_COMMONSKILLPOOL_METHOD_2_EAD0E25947E93DA9_OFFSET UNITYSDK_OFFSET(0x19668970)
#define RPG_GAMECORE_COMMONSKILLPOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x19668AE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CommonSkillPool_TypeDefinitionIndex = 17257;
