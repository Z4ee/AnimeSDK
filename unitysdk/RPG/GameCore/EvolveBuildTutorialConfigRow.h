...
#define RPG_GAMECORE_EVOLVEBUILDTUTORIALCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D7D7060)
#define RPG_GAMECORE_EVOLVEBUILDTUTORIALCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7D7750)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 StageMergedID; // 0x18
