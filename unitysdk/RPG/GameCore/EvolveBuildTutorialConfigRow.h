...
#define RPG_GAMECORE_EVOLVEBUILDTUTORIALCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C0671F0)
#define RPG_GAMECORE_EVOLVEBUILDTUTORIALCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0678E0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 WeaponLevel; // 0x20
