...
#define RPG_GAMECORE_GRAVITYBALLPUZZLECONTROLLERINIT_METHOD_3_43EFD85F0B9AE6FA_OFFSET UNITYSDK_OFFSET(0x1899C120)
#define RPG_GAMECORE_GRAVITYBALLPUZZLECONTROLLERINIT_METHOD_3_BA0119C547A2AF99_OFFSET UNITYSDK_OFFSET(0x1899C240)
#define RPG_GAMECORE_GRAVITYBALLPUZZLECONTROLLERINIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1899C1C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GravityBallPuzzleControllerInit_TypeDefinitionIndex = 19327;
