...
#define RPG_GAMECORE_LITTLEGAMEABILITYEFFECTREDUCEBASECOOLDOWNCONFIG_METHOD_3_5B51FF5CCAED9C6E_OFFSET UNITYSDK_OFFSET(0x1B092FF0)
#define RPG_GAMECORE_LITTLEGAMEABILITYEFFECTREDUCEBASECOOLDOWNCONFIG_METHOD_3_D4E0B95EC6838BA2_OFFSET UNITYSDK_OFFSET(0x1B092F20)
#define RPG_GAMECORE_LITTLEGAMEABILITYEFFECTREDUCEBASECOOLDOWNCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B092FE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityEffectReduceBaseCooldownConfig_TypeDefinitionIndex = 20550;
