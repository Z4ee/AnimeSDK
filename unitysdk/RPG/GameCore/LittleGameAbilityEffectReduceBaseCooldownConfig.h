...
#define RPG_GAMECORE_LITTLEGAMEABILITYEFFECTREDUCEBASECOOLDOWNCONFIG_METHOD_3_5B51FF5CCAED9C6E_OFFSET UNITYSDK_OFFSET(0x19893580)
#define RPG_GAMECORE_LITTLEGAMEABILITYEFFECTREDUCEBASECOOLDOWNCONFIG_METHOD_3_D4E0B95EC6838BA2_OFFSET UNITYSDK_OFFSET(0x198934B0)
#define RPG_GAMECORE_LITTLEGAMEABILITYEFFECTREDUCEBASECOOLDOWNCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19893570)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityEffectReduceBaseCooldownConfig_TypeDefinitionIndex = 20177;
