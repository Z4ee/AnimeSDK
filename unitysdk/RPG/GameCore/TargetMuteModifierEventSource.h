...
#define RPG_GAMECORE_TARGETMUTEMODIFIEREVENTSOURCE_METHOD_3_29428BCD386F0990_OFFSET UNITYSDK_OFFSET(0x1D0C4480)
#define RPG_GAMECORE_TARGETMUTEMODIFIEREVENTSOURCE_METHOD_3_994A3AB606C92E7F_OFFSET UNITYSDK_OFFSET(0x1D0C4440)
#define RPG_GAMECORE_TARGETMUTEMODIFIEREVENTSOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0C4470)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMuteModifierEventSource_TypeDefinitionIndex = 22630;
