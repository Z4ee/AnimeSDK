...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETNPCNUMCONFIG_METHOD_6_03F605C3073DAFB6_OFFSET UNITYSDK_OFFSET(0x1D06DAF0)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETNPCNUMCONFIG_METHOD_6_3D9103C63A54F612_OFFSET UNITYSDK_OFFSET(0x1D06DB40)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETNPCNUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D06DB30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightParamGetNpcNumConfig_TypeDefinitionIndex = 18766;
