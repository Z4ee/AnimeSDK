...
#define RPG_GAMECORE_MARBLESAMPLECONFIG_METHOD_2_77F17FFE0D8A7BEB_OFFSET UNITYSDK_OFFSET(0x1D4AA7D0)
#define RPG_GAMECORE_MARBLESAMPLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4B0810)
