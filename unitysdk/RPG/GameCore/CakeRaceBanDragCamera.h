...
#define RPG_GAMECORE_CAKERACEBANDRAGCAMERA_METHOD_3_1023110E313ACCAE_OFFSET UNITYSDK_OFFSET(0x1B2CD2E0)
#define RPG_GAMECORE_CAKERACEBANDRAGCAMERA_METHOD_3_AF5EBA9394855D6D_OFFSET UNITYSDK_OFFSET(0x1B2CD320)
#define RPG_GAMECORE_CAKERACEBANDRAGCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2CD310)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceBanDragCamera_TypeDefinitionIndex = 23444;
