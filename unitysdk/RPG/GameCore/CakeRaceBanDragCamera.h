...
#define RPG_GAMECORE_CAKERACEBANDRAGCAMERA_METHOD_3_648FFB50C087B5DC_OFFSET UNITYSDK_OFFSET(0x170476C0)
#define RPG_GAMECORE_CAKERACEBANDRAGCAMERA_METHOD_3_AF5EBA9394855D6D_OFFSET UNITYSDK_OFFSET(0x17047740)
#define RPG_GAMECORE_CAKERACEBANDRAGCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x17047710)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceBanDragCamera_TypeDefinitionIndex = 22343;
