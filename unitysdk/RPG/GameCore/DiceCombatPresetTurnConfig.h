...
#define RPG_GAMECORE_DICECOMBATPRESETTURNCONFIG_METHOD_2_C305CD72D310FDB5_OFFSET UNITYSDK_OFFSET(0x196AFB50)
#define RPG_GAMECORE_DICECOMBATPRESETTURNCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x196AFC60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatPresetTurnConfig_TypeDefinitionIndex = 15359;
