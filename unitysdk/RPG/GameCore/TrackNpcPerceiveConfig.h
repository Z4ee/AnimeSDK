...
#define RPG_GAMECORE_TRACKNPCPERCEIVECONFIG_METHOD_2_A620285B11B74D1D_OFFSET UNITYSDK_OFFSET(0x178A3D00)
#define RPG_GAMECORE_TRACKNPCPERCEIVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x178A3DE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrackNpcPerceiveConfig_TypeDefinitionIndex = 20363;
