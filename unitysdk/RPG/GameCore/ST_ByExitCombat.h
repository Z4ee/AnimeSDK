...
#define RPG_GAMECORE_ST_BYEXITCOMBAT_METHOD_4_CD55CC68E3732C78_OFFSET UNITYSDK_OFFSET(0x17692D80)
#define RPG_GAMECORE_ST_BYEXITCOMBAT_METHOD_4_DFF5C3047D9FAC52_OFFSET UNITYSDK_OFFSET(0x17692E50)
#define RPG_GAMECORE_ST_BYEXITCOMBAT__CTOR_OFFSET UNITYSDK_OFFSET(0x17692E00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_ByExitCombat_TypeDefinitionIndex = 18371;
