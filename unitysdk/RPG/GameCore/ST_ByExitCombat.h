...
#define RPG_GAMECORE_ST_BYEXITCOMBAT_METHOD_4_32A541A98BC013C9_OFFSET UNITYSDK_OFFSET(0x1B77B9F0)
#define RPG_GAMECORE_ST_BYEXITCOMBAT_METHOD_4_32A8980B06BBA4ED_OFFSET UNITYSDK_OFFSET(0x1B77BBA0)
#define RPG_GAMECORE_ST_BYEXITCOMBAT_METHOD_4_8FD7708D607F806C_OFFSET UNITYSDK_OFFSET(0x1B77BB70)
#define RPG_GAMECORE_ST_BYEXITCOMBAT_METHOD_4_DFF5C3047D9FAC52_OFFSET UNITYSDK_OFFSET(0x1B77BA30)
#define RPG_GAMECORE_ST_BYEXITCOMBAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B77BA20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_ByExitCombat_TypeDefinitionIndex = 19318;
