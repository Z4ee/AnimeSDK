...
#define RPG_GAMECORE_PLANETFESANIMCOMPOSITE_METHOD_2_42A19DAA9AD4874E_OFFSET UNITYSDK_OFFSET(0x1B4D1210)
#define RPG_GAMECORE_PLANETFESANIMCOMPOSITE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4D1530)
