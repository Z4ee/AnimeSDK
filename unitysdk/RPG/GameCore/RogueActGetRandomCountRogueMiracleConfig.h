...
#define RPG_GAMECORE_ROGUEACTGETRANDOMCOUNTROGUEMIRACLECONFIG_METHOD_6_90570A2DBCC0C59B_OFFSET UNITYSDK_OFFSET(0x175B6470)
#define RPG_GAMECORE_ROGUEACTGETRANDOMCOUNTROGUEMIRACLECONFIG_METHOD_6_C4223000928C5BAE_OFFSET UNITYSDK_OFFSET(0x175B6250)
#define RPG_GAMECORE_ROGUEACTGETRANDOMCOUNTROGUEMIRACLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175B6390)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActGetRandomCountRogueMiracleConfig_TypeDefinitionIndex = 17961;
