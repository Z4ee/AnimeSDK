...
#define RPG_GAMECORE_ROGUEACTGETRANDOMCOUNTROGUEMIRACLECONFIG_METHOD_6_90570A2DBCC0C59B_OFFSET UNITYSDK_OFFSET(0x19AE65F0)
#define RPG_GAMECORE_ROGUEACTGETRANDOMCOUNTROGUEMIRACLECONFIG_METHOD_6_C4223000928C5BAE_OFFSET UNITYSDK_OFFSET(0x19AE63D0)
#define RPG_GAMECORE_ROGUEACTGETRANDOMCOUNTROGUEMIRACLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AE6510)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActGetRandomCountRogueMiracleConfig_TypeDefinitionIndex = 18573;
