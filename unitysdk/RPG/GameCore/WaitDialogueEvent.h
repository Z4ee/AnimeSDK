...
#define RPG_GAMECORE_WAITDIALOGUEEVENT_METHOD_3_66C8BBEC5342F6FE_OFFSET UNITYSDK_OFFSET(0x19E53760)
#define RPG_GAMECORE_WAITDIALOGUEEVENT_METHOD_3_A314D8C14DE0396F_OFFSET UNITYSDK_OFFSET(0x19E537E0)
#define RPG_GAMECORE_WAITDIALOGUEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19E537B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitDialogueEvent_TypeDefinitionIndex = 19960;
