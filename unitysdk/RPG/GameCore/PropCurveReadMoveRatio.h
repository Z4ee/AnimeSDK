...
#define RPG_GAMECORE_PROPCURVEREADMOVERATIO_METHOD_3_66B2D32D80EDCAC8_OFFSET UNITYSDK_OFFSET(0x18C688F0)
#define RPG_GAMECORE_PROPCURVEREADMOVERATIO_METHOD_3_AEAC275D27100814_OFFSET UNITYSDK_OFFSET(0x18C689E0)
#define RPG_GAMECORE_PROPCURVEREADMOVERATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x18C68980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropCurveReadMoveRatio_TypeDefinitionIndex = 19987;
