...
#define RPG_GAMECORE_CHIMERATEAMWORKINCREASETEAMCONFIG_METHOD_2_C4F2A240F02A8EE6_OFFSET UNITYSDK_OFFSET(0x1880BCB0)
#define RPG_GAMECORE_CHIMERATEAMWORKINCREASETEAMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1880BCF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraTeamWorkIncreaseTeamConfig_TypeDefinitionIndex = 15052;
