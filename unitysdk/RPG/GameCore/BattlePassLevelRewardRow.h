...
#define RPG_GAMECORE_BATTLEPASSLEVELREWARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B300140)
#define RPG_GAMECORE_BATTLEPASSLEVELREWARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B301130)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 PremiumFixedReward1; // 0x14
		::System::UInt32 PremiumOptional; // 0x18
