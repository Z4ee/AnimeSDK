...
#define RPG_GAMECORE_ADVBYTARGETENTITYTYPE_METHOD_4_879DDE1EEF74150C_OFFSET UNITYSDK_OFFSET(0x16F28280)
#define RPG_GAMECORE_ADVBYTARGETENTITYTYPE_METHOD_4_D777C87C4916508C_OFFSET UNITYSDK_OFFSET(0x16F281C0)
#define RPG_GAMECORE_ADVBYTARGETENTITYTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F28230)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvByTargetEntityType_TypeDefinitionIndex = 18902;
