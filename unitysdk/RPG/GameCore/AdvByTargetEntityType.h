...
#define RPG_GAMECORE_ADVBYTARGETENTITYTYPE_METHOD_4_879DDE1EEF74150C_OFFSET UNITYSDK_OFFSET(0x1941D9F0)
#define RPG_GAMECORE_ADVBYTARGETENTITYTYPE_METHOD_4_D777C87C4916508C_OFFSET UNITYSDK_OFFSET(0x1941D930)
#define RPG_GAMECORE_ADVBYTARGETENTITYTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1941D9A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvByTargetEntityType_TypeDefinitionIndex = 19452;
