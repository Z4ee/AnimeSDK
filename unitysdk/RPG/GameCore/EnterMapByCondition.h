...
#define RPG_GAMECORE_ENTERMAPBYCONDITION_METHOD_3_13262A11FB9E7773_OFFSET UNITYSDK_OFFSET(0x1719EE20)
#define RPG_GAMECORE_ENTERMAPBYCONDITION_METHOD_3_25195C2185A886F5_OFFSET UNITYSDK_OFFSET(0x1719EDA0)
#define RPG_GAMECORE_ENTERMAPBYCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1719EDF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnterMapByCondition_TypeDefinitionIndex = 18579;
