...
#define RPG_GAMECORE_BASECHENLINGBATTLERESOURCE_METHOD_2_068FD37A1D4C1FEF_OFFSET UNITYSDK_OFFSET(0x1B2EA2F0)
#define RPG_GAMECORE_BASECHENLINGBATTLERESOURCE_METHOD_2_4ADD2245234AE4C1_OFFSET UNITYSDK_OFFSET(0x1B2EA100)
#define RPG_GAMECORE_BASECHENLINGBATTLERESOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2EA3B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BaseChenLingBattleResource_TypeDefinitionIndex = 15606;
