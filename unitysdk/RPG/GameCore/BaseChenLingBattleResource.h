...
#define RPG_GAMECORE_BASECHENLINGBATTLERESOURCE_METHOD_2_068FD37A1D4C1FEF_OFFSET UNITYSDK_OFFSET(0x194BB6E0)
#define RPG_GAMECORE_BASECHENLINGBATTLERESOURCE_METHOD_2_4ADD2245234AE4C1_OFFSET UNITYSDK_OFFSET(0x194BB4F0)
#define RPG_GAMECORE_BASECHENLINGBATTLERESOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x194BB7A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BaseChenLingBattleResource_TypeDefinitionIndex = 15005;
