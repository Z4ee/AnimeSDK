...
#define RPG_GAMECORE_BASECHENLINGBATTLERESOURCE_METHOD_2_068FD37A1D4C1FEF_OFFSET UNITYSDK_OFFSET(0x16FC4DC0)
#define RPG_GAMECORE_BASECHENLINGBATTLERESOURCE_METHOD_2_16A4F070C6B7895F_OFFSET UNITYSDK_OFFSET(0x16FC4BC0)
#define RPG_GAMECORE_BASECHENLINGBATTLERESOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x16FC4E80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BaseChenLingBattleResource_TypeDefinitionIndex = 14472;
