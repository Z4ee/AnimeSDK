...
#define RPG_GAMECORE_RPGCOLORGRADINGCURVEEFFECT_METHOD_3_77F82516FBC9F917_OFFSET UNITYSDK_OFFSET(0x1757A2D0)
#define RPG_GAMECORE_RPGCOLORGRADINGCURVEEFFECT_METHOD_3_BDC2051E4D5359D9_OFFSET UNITYSDK_OFFSET(0x1757A230)
#define RPG_GAMECORE_RPGCOLORGRADINGCURVEEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1757A290)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RPGColorGradingCurveEffect_TypeDefinitionIndex = 22019;
