...
#define RPG_GAMECORE_RPGCOLORGRADINGCURVEEFFECT_METHOD_3_77F82516FBC9F917_OFFSET UNITYSDK_OFFSET(0x1B9B0750)
#define RPG_GAMECORE_RPGCOLORGRADINGCURVEEFFECT_METHOD_3_E6505CA67611D95E_OFFSET UNITYSDK_OFFSET(0x1B9B06E0)
#define RPG_GAMECORE_RPGCOLORGRADINGCURVEEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9B0730)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RPGColorGradingCurveEffect_TypeDefinitionIndex = 22893;
	...
	public:
		...
		static ::System::Void Method_3_E6505CA67611D95E(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::RPGColorGradingCurveEffect*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::RPGColorGradingCurveEffect*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_RPGCOLORGRADINGCURVEEFFECT_METHOD_3_E6505CA67611D95E_OFFSET))(a1, a2);
		}
