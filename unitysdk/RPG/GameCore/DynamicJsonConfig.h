...
#define RPG_GAMECORE_DYNAMICJSONCONFIG_METHOD_2_209D7EB5332ED9BD_OFFSET UNITYSDK_OFFSET(0x196CE440)
#define RPG_GAMECORE_DYNAMICJSONCONFIG_METHOD_2_C01C3A67C2CCB8F4_OFFSET UNITYSDK_OFFSET(0x196CE690)
#define RPG_GAMECORE_DYNAMICJSONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x196CE680)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DynamicJsonConfig_TypeDefinitionIndex = 15660;
