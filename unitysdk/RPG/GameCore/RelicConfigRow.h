...
#define RPG_GAMECORE_RELICCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19ABCFB0)
#define RPG_GAMECORE_RELICCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19ABE100)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RelicConfigRow_TypeDefinitionIndex = 13898;

	class RelicConfigRow : public ::System::Object
	{
	public:
		::System::UInt32 SubAffixGroup; // 0x10
		...
		::System::UInt32 ExpType; // 0x28
		::System::UInt32 SetID; // 0x2C
