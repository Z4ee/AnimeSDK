...
#define RPG_GAMECORE_TIMEREWINDPARENTPROPSTATECONFIG_METHOD_2_A4AF73F5ECAC9C54_OFFSET UNITYSDK_OFFSET(0x1909C7B0)
#define RPG_GAMECORE_TIMEREWINDPARENTPROPSTATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1909C8F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TimeRewindParentPropStateConfig_TypeDefinitionIndex = 19625;
