...
#define RPG_GAMECORE_FIVEDIMSTARTWINDOWSTAGEACTION_METHOD_3_5AA39CCF585AA36D_OFFSET UNITYSDK_OFFSET(0x1BEB55E0)
#define RPG_GAMECORE_FIVEDIMSTARTWINDOWSTAGEACTION_METHOD_3_B10ED25FD7154D56_OFFSET UNITYSDK_OFFSET(0x1BEB55A0)
#define RPG_GAMECORE_FIVEDIMSTARTWINDOWSTAGEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEB55D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimStartWindowStageAction_TypeDefinitionIndex = 17989;
