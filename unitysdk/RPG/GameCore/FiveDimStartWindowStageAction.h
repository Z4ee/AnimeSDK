...
#define RPG_GAMECORE_FIVEDIMSTARTWINDOWSTAGEACTION_METHOD_3_140D2BFCF0530F0E_OFFSET UNITYSDK_OFFSET(0x18920230)
#define RPG_GAMECORE_FIVEDIMSTARTWINDOWSTAGEACTION_METHOD_3_5AA39CCF585AA36D_OFFSET UNITYSDK_OFFSET(0x189202A0)
#define RPG_GAMECORE_FIVEDIMSTARTWINDOWSTAGEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18920280)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimStartWindowStageAction_TypeDefinitionIndex = 17786;
