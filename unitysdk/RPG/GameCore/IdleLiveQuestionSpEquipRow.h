...
#define RPG_GAMECORE_IDLELIVEQUESTIONSPEQUIPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D1A2C20)
#define RPG_GAMECORE_IDLELIVEQUESTIONSPEQUIPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1A2D40)
