...
#define RPG_GAMECORE_IDLELIVEQUESTIONSPEQUIPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B006CB0)
#define RPG_GAMECORE_IDLELIVEQUESTIONSPEQUIPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B006DD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int IdleLiveQuestionSpEquipRow_TypeDefinitionIndex = 11421;
