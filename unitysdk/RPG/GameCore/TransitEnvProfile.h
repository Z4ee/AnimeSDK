...
#define RPG_GAMECORE_TRANSITENVPROFILE_METHOD_3_4942AB81878A4872_OFFSET UNITYSDK_OFFSET(0x178B3690)
#define RPG_GAMECORE_TRANSITENVPROFILE_METHOD_3_D13E4BFDB0947502_OFFSET UNITYSDK_OFFSET(0x178B38F0)
#define RPG_GAMECORE_TRANSITENVPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x178B38C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TransitEnvProfile_TypeDefinitionIndex = 19073;
