...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETEQUIPNUMINCUREQUIPCONFIG_METHOD_6_9B21FFFBB93048AE_OFFSET UNITYSDK_OFFSET(0x1D06D610)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETEQUIPNUMINCUREQUIPCONFIG_METHOD_6_B52357F9AAC41A6A_OFFSET UNITYSDK_OFFSET(0x1D06D660)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETEQUIPNUMINCUREQUIPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D06D650)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightParamGetEquipNumInCurEquipConfig_TypeDefinitionIndex = 18797;
