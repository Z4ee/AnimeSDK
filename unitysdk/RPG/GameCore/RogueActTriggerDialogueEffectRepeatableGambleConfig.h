...
#define RPG_GAMECORE_ROGUEACTTRIGGERDIALOGUEEFFECTREPEATABLEGAMBLECONFIG_METHOD_6_144FF096F2E25134_OFFSET UNITYSDK_OFFSET(0x19AFA150)
#define RPG_GAMECORE_ROGUEACTTRIGGERDIALOGUEEFFECTREPEATABLEGAMBLECONFIG_METHOD_6_5989AD1FEB50A399_OFFSET UNITYSDK_OFFSET(0x19AF9F30)
#define RPG_GAMECORE_ROGUEACTTRIGGERDIALOGUEEFFECTREPEATABLEGAMBLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AFA070)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActTriggerDialogueEffectRepeatableGambleConfig_TypeDefinitionIndex = 18602;
