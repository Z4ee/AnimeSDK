...
#define RPG_GAMECORE_BYISCONTAINMODIFIER_METHOD_4_C34A6335241E6990_OFFSET UNITYSDK_OFFSET(0x1874FCA0)
#define RPG_GAMECORE_BYISCONTAINMODIFIER_METHOD_4_E35774B88C3C05C8_OFFSET UNITYSDK_OFFSET(0x1874FD70)
#define RPG_GAMECORE_BYISCONTAINMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1874FD20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsContainModifier_TypeDefinitionIndex = 21906;
