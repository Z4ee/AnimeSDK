...
#define RPG_GAMECORE_BYISCONTAINMODIFIER_METHOD_4_176198D9B99BE32A_OFFSET UNITYSDK_OFFSET(0x1CF34130)
#define RPG_GAMECORE_BYISCONTAINMODIFIER_METHOD_4_598DE36A0B3A8CB2_OFFSET UNITYSDK_OFFSET(0x1CF33E50)
#define RPG_GAMECORE_BYISCONTAINMODIFIER_METHOD_4_876565C00FF0E944_OFFSET UNITYSDK_OFFSET(0x1CF34160)
#define RPG_GAMECORE_BYISCONTAINMODIFIER_METHOD_4_E35774B88C3C05C8_OFFSET UNITYSDK_OFFSET(0x1CF33E90)
#define RPG_GAMECORE_BYISCONTAINMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF33E80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsContainModifier_TypeDefinitionIndex = 22726;
