...
#define RPG_GAMECORE_USESKILLBYCOMPLEXSKILLAI_METHOD_3_5D8A44A2C1E3FE99_OFFSET UNITYSDK_OFFSET(0x190E6FF0)
#define RPG_GAMECORE_USESKILLBYCOMPLEXSKILLAI_METHOD_3_806169594FEA87E0_OFFSET UNITYSDK_OFFSET(0x190E7070)
#define RPG_GAMECORE_USESKILLBYCOMPLEXSKILLAI__CTOR_OFFSET UNITYSDK_OFFSET(0x190E7040)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UseSkillByComplexSkillAI_TypeDefinitionIndex = 21314;
