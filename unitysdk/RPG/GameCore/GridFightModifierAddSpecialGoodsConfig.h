...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDSPECIALGOODSCONFIG_METHOD_3_87100C736C279601_OFFSET UNITYSDK_OFFSET(0x17260C00)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDSPECIALGOODSCONFIG_METHOD_3_D98A1EF08E1F07D8_OFFSET UNITYSDK_OFFSET(0x17260CD0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDSPECIALGOODSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17260C80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierAddSpecialGoodsConfig_TypeDefinitionIndex = 17817;
