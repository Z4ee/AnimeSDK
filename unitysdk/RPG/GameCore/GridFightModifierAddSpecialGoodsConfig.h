...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDSPECIALGOODSCONFIG_METHOD_3_87100C736C279601_OFFSET UNITYSDK_OFFSET(0x189B1620)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDSPECIALGOODSCONFIG_METHOD_3_D98A1EF08E1F07D8_OFFSET UNITYSDK_OFFSET(0x189B16F0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDSPECIALGOODSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189B16A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierAddSpecialGoodsConfig_TypeDefinitionIndex = 18435;
