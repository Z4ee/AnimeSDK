...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDSPECIALGOODSCONFIG_METHOD_3_CD5DC0FBE7B6B89C_OFFSET UNITYSDK_OFFSET(0x1C5D0270)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDSPECIALGOODSCONFIG_METHOD_3_D98A1EF08E1F07D8_OFFSET UNITYSDK_OFFSET(0x1C5D02C0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDSPECIALGOODSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5D02B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierAddSpecialGoodsConfig_TypeDefinitionIndex = 18655;
