...
#define RPG_GAMECORE_CHIMERAABILITYPASSIVE_METHOD_3_487956D6B30CD75C_OFFSET UNITYSDK_OFFSET(0x187F0470)
#define RPG_GAMECORE_CHIMERAABILITYPASSIVE_METHOD_3_A32CAFFC3BEFCD3C_OFFSET UNITYSDK_OFFSET(0x187F1BD0)
#define RPG_GAMECORE_CHIMERAABILITYPASSIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x187F0460)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraAbilityPassive_TypeDefinitionIndex = 15005;
