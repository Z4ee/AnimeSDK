...
#define RPG_GAMECORE_CHIMERAABILITYPASSIVE_METHOD_3_487956D6B30CD75C_OFFSET UNITYSDK_OFFSET(0x1C38C640)
#define RPG_GAMECORE_CHIMERAABILITYPASSIVE_METHOD_3_A32CAFFC3BEFCD3C_OFFSET UNITYSDK_OFFSET(0x1C38DC30)
#define RPG_GAMECORE_CHIMERAABILITYPASSIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C38C630)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraAbilityPassive_TypeDefinitionIndex = 15232;
