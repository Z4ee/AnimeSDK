...
#define RPG_GAMECORE_LITTLEGAMEABILITYVALUEGETTERCONSTANTCONFIG_METHOD_3_8837216425070D05_OFFSET UNITYSDK_OFFSET(0x19897230)
#define RPG_GAMECORE_LITTLEGAMEABILITYVALUEGETTERCONSTANTCONFIG_METHOD_3_FEA2F3A81F9FA961_OFFSET UNITYSDK_OFFSET(0x19897350)
#define RPG_GAMECORE_LITTLEGAMEABILITYVALUEGETTERCONSTANTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19897340)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityValueGetterConstantConfig_TypeDefinitionIndex = 20212;
