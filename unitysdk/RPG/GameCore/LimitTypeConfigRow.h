...
#define RPG_GAMECORE_LIMITTYPECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D1F41D0)
#define RPG_GAMECORE_LIMITTYPECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1F4BD0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID LimitTypeDetailDesc; // 0x20
