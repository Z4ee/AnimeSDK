...
#define RPG_GAMECORE_RTBATTLESTAGEUNITINFO_METHOD_2_C6589F5F0081613F_OFFSET UNITYSDK_OFFSET(0x18DC63F0)
#define RPG_GAMECORE_RTBATTLESTAGEUNITINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18DC66A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtBattleStageUnitInfo_TypeDefinitionIndex = 17152;
