...
#define RPG_GAMECORE_RTBATTLESTAGEUNITINFO_METHOD_2_C6589F5F0081613F_OFFSET UNITYSDK_OFFSET(0x19BDCC80)
#define RPG_GAMECORE_RTBATTLESTAGEUNITINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19BDCF30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtBattleStageUnitInfo_TypeDefinitionIndex = 17162;
