...
#define RPG_GAMECORE_EVOLVEBUILDREWARDBOXRANDOMITEMROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C0626C0)
#define RPG_GAMECORE_EVOLVEBUILDREWARDBOXRANDOMITEMROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C062800)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EvolveBuildRewardBoxRandomItemRow_TypeDefinitionIndex = 11049;
