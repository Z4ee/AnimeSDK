...
#define RPG_GAMECORE_EVOLVEBUILDREWARDBOXRANDOMITEMROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x171AEB10)
#define RPG_GAMECORE_EVOLVEBUILDREWARDBOXRANDOMITEMROW__CTOR_OFFSET UNITYSDK_OFFSET(0x171AEC60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EvolveBuildRewardBoxRandomItemRow_TypeDefinitionIndex = 10695;
