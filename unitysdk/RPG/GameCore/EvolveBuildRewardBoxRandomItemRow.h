...
#define RPG_GAMECORE_EVOLVEBUILDREWARDBOXRANDOMITEMROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D7D2570)
#define RPG_GAMECORE_EVOLVEBUILDREWARDBOXRANDOMITEMROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7D26B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EvolveBuildRewardBoxRandomItemRow_TypeDefinitionIndex = 11424;
