...
#define RPG_GAMECORE_ABILITYSKILLPERFORMFINISH_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xA7D30B0)
#define RPG_GAMECORE_ABILITYSKILLPERFORMFINISH_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xA7D3070)
#define RPG_GAMECORE_ABILITYSKILLPERFORMFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0xA7D3060)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AbilitySkillPerformFinish_TypeDefinitionIndex = 45483;
