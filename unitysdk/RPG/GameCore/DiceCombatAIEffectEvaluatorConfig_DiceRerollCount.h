...
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEREROLLCOUNT_METHOD_3_1DBD0C9D91B14689_OFFSET UNITYSDK_OFFSET(0x1715CBF0)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEREROLLCOUNT_METHOD_3_229B4611F3712055_OFFSET UNITYSDK_OFFSET(0x1715C510)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEREROLLCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1715C500)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatAIEffectEvaluatorConfig_DiceRerollCount_TypeDefinitionIndex = 14850;
