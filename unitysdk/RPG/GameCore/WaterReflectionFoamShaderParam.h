...
#define RPG_GAMECORE_WATERREFLECTIONFOAMSHADERPARAM_METHOD_2_5F4CD61893A3A957_OFFSET UNITYSDK_OFFSET(0x1910C9D0)
#define RPG_GAMECORE_WATERREFLECTIONFOAMSHADERPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1910CB70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaterReflectionFoamShaderParam_TypeDefinitionIndex = 15830;
