...
#define RPG_GAMECORE_RESETCHARACTERCUSTOMTEAMFORMATION_METHOD_3_5B5C2486BBFC2169_OFFSET UNITYSDK_OFFSET(0x1D3A4660)
#define RPG_GAMECORE_RESETCHARACTERCUSTOMTEAMFORMATION_METHOD_3_87E4E8151E22BAA6_OFFSET UNITYSDK_OFFSET(0x1D3A4620)
#define RPG_GAMECORE_RESETCHARACTERCUSTOMTEAMFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3A4650)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetCharacterCustomTeamFormation_TypeDefinitionIndex = 22394;
