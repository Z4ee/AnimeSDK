...
#define RPG_GAMECORE_LINEUPGRIDFIGHTTRAITPARAM_METHOD_2_17EECF92366FA05B_OFFSET UNITYSDK_OFFSET(0x19891960)
#define RPG_GAMECORE_LINEUPGRIDFIGHTTRAITPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x19891AE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LineupGridFightTraitParam_TypeDefinitionIndex = 17237;
