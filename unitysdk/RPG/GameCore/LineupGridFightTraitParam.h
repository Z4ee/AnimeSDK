...
#define RPG_GAMECORE_LINEUPGRIDFIGHTTRAITPARAM_METHOD_2_17EECF92366FA05B_OFFSET UNITYSDK_OFFSET(0x1DD5FD60)
#define RPG_GAMECORE_LINEUPGRIDFIGHTTRAITPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD5FEE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LineupGridFightTraitParam_TypeDefinitionIndex = 17916;
