...
#define RPG_GAMECORE_LINEUPGRIDFIGHTTRAITPARAM_METHOD_2_17EECF92366FA05B_OFFSET UNITYSDK_OFFSET(0x1D1F7B60)
#define RPG_GAMECORE_LINEUPGRIDFIGHTTRAITPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1F7CE0)
