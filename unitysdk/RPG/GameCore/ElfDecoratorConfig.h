...
#define RPG_GAMECORE_ELFDECORATORCONFIG_METHOD_3_0796C7F8F5EA2B1D_OFFSET UNITYSDK_OFFSET(0x1889B050)
#define RPG_GAMECORE_ELFDECORATORCONFIG_METHOD_3_A921478E76A52486_OFFSET UNITYSDK_OFFSET(0x1889AF30)
#define RPG_GAMECORE_ELFDECORATORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1889B030)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfDecoratorConfig_TypeDefinitionIndex = 17550;
