...
#define RPG_GAMECORE_ELFDECORATORCONFIG_METHOD_3_0796C7F8F5EA2B1D_OFFSET UNITYSDK_OFFSET(0x1DB283B0)
#define RPG_GAMECORE_ELFDECORATORCONFIG_METHOD_3_57BB6407E4C38BF1_OFFSET UNITYSDK_OFFSET(0x1DB282E0)
#define RPG_GAMECORE_ELFDECORATORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB283A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfDecoratorConfig_TypeDefinitionIndex = 18267;
