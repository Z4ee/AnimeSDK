...
#define RPG_GAMECORE_MODIFIERPLAYERCHANGEEFFECT_METHOD_3_65F446DB51D703AF_OFFSET UNITYSDK_OFFSET(0x174285D0)
#define RPG_GAMECORE_MODIFIERPLAYERCHANGEEFFECT_METHOD_3_F159647A5247B37D_OFFSET UNITYSDK_OFFSET(0x17428650)
#define RPG_GAMECORE_MODIFIERPLAYERCHANGEEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x17428620)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifierPlayerChangeEffect_TypeDefinitionIndex = 18565;
