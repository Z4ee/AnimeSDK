...
#define RPG_GAMECORE_TRIGGERANDWAITMONOPOLYEVENT_METHOD_3_198030574036F7F1_OFFSET UNITYSDK_OFFSET(0x1D5EF0D0)
#define RPG_GAMECORE_TRIGGERANDWAITMONOPOLYEVENT_METHOD_3_A1CF5F83D7BE244A_OFFSET UNITYSDK_OFFSET(0x1D5EF090)
#define RPG_GAMECORE_TRIGGERANDWAITMONOPOLYEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5EF0C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerAndWaitMonopolyEvent_TypeDefinitionIndex = 21478;
