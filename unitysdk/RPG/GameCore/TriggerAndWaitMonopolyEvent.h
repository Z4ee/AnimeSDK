...
#define RPG_GAMECORE_TRIGGERANDWAITMONOPOLYEVENT_METHOD_3_198030574036F7F1_OFFSET UNITYSDK_OFFSET(0x178BE0E0)
#define RPG_GAMECORE_TRIGGERANDWAITMONOPOLYEVENT_METHOD_3_C432F0BFFE67D398_OFFSET UNITYSDK_OFFSET(0x178BE060)
#define RPG_GAMECORE_TRIGGERANDWAITMONOPOLYEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x178BE0B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerAndWaitMonopolyEvent_TypeDefinitionIndex = 19891;
