...
#define RPG_GAMECORE_CHANGEPROPSTATE_METHOD_3_8969AF821CA7D9D5_OFFSET UNITYSDK_OFFSET(0x1D119070)
#define RPG_GAMECORE_CHANGEPROPSTATE_METHOD_3_E4DC3D22F01B1288_OFFSET UNITYSDK_OFFSET(0x1D119030)
#define RPG_GAMECORE_CHANGEPROPSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D119060)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChangePropState_TypeDefinitionIndex = 20218;
