...
#define RPG_GAMECORE_CHANGEPROPSTATE_METHOD_3_19B1B2310E88D52A_OFFSET UNITYSDK_OFFSET(0x19605210)
#define RPG_GAMECORE_CHANGEPROPSTATE_METHOD_3_8969AF821CA7D9D5_OFFSET UNITYSDK_OFFSET(0x19605280)
#define RPG_GAMECORE_CHANGEPROPSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19605250)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChangePropState_TypeDefinitionIndex = 19316;
