...
#define RPG_GAMECORE_WAITTRANSFERFINISHEDEVENT_METHOD_3_979B672261634BD7_OFFSET UNITYSDK_OFFSET(0x19E63660)
#define RPG_GAMECORE_WAITTRANSFERFINISHEDEVENT_METHOD_3_98B01AB5B91619C3_OFFSET UNITYSDK_OFFSET(0x19E63550)
#define RPG_GAMECORE_WAITTRANSFERFINISHEDEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19E63630)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitTransferFinishedEvent_TypeDefinitionIndex = 20383;
