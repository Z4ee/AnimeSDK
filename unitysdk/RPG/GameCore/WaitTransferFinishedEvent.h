...
#define RPG_GAMECORE_WAITTRANSFERFINISHEDEVENT_METHOD_3_979B672261634BD7_OFFSET UNITYSDK_OFFSET(0x1910AE90)
#define RPG_GAMECORE_WAITTRANSFERFINISHEDEVENT_METHOD_3_98B01AB5B91619C3_OFFSET UNITYSDK_OFFSET(0x1910AD80)
#define RPG_GAMECORE_WAITTRANSFERFINISHEDEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1910AE60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitTransferFinishedEvent_TypeDefinitionIndex = 20441;
