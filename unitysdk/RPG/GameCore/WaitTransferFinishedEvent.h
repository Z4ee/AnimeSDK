...
#define RPG_GAMECORE_WAITTRANSFERFINISHEDEVENT_METHOD_3_40E8AA5FD709FC7A_OFFSET UNITYSDK_OFFSET(0x1D1BE5C0)
#define RPG_GAMECORE_WAITTRANSFERFINISHEDEVENT_METHOD_3_979B672261634BD7_OFFSET UNITYSDK_OFFSET(0x1D1BE690)
#define RPG_GAMECORE_WAITTRANSFERFINISHEDEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1BE680)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitTransferFinishedEvent_TypeDefinitionIndex = 20798;
