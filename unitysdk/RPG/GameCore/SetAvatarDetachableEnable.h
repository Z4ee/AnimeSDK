...
#define RPG_GAMECORE_SETAVATARDETACHABLEENABLE_METHOD_3_6DAD97B336356F72_OFFSET UNITYSDK_OFFSET(0x19C29D90)
#define RPG_GAMECORE_SETAVATARDETACHABLEENABLE_METHOD_3_C57755742D76ECDB_OFFSET UNITYSDK_OFFSET(0x19C29E10)
#define RPG_GAMECORE_SETAVATARDETACHABLEENABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C29DE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetAvatarDetachableEnable_TypeDefinitionIndex = 19615;
