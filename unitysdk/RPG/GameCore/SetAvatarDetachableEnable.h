...
#define RPG_GAMECORE_SETAVATARDETACHABLEENABLE_METHOD_3_7D227E2A234BA308_OFFSET UNITYSDK_OFFSET(0x1C2D35B0)
#define RPG_GAMECORE_SETAVATARDETACHABLEENABLE_METHOD_3_C57755742D76ECDB_OFFSET UNITYSDK_OFFSET(0x1C2D35F0)
#define RPG_GAMECORE_SETAVATARDETACHABLEENABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2D35E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetAvatarDetachableEnable_TypeDefinitionIndex = 19974;
