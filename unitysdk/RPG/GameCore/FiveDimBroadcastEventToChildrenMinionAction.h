...
#define RPG_GAMECORE_FIVEDIMBROADCASTEVENTTOCHILDRENMINIONACTION_METHOD_3_761B57711EA14D86_OFFSET UNITYSDK_OFFSET(0x171E58E0)
#define RPG_GAMECORE_FIVEDIMBROADCASTEVENTTOCHILDRENMINIONACTION_METHOD_3_D4C933113734C7BA_OFFSET UNITYSDK_OFFSET(0x171EB190)
#define RPG_GAMECORE_FIVEDIMBROADCASTEVENTTOCHILDRENMINIONACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x171E58C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimBroadcastEventToChildrenMinionAction_TypeDefinitionIndex = 17243;
