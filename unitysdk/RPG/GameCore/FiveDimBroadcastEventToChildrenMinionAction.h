...
#define RPG_GAMECORE_FIVEDIMBROADCASTEVENTTOCHILDRENMINIONACTION_METHOD_3_761B57711EA14D86_OFFSET UNITYSDK_OFFSET(0x188F2FE0)
#define RPG_GAMECORE_FIVEDIMBROADCASTEVENTTOCHILDRENMINIONACTION_METHOD_3_D4C933113734C7BA_OFFSET UNITYSDK_OFFSET(0x188F8C60)
#define RPG_GAMECORE_FIVEDIMBROADCASTEVENTTOCHILDRENMINIONACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x188F2FC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimBroadcastEventToChildrenMinionAction_TypeDefinitionIndex = 17848;
