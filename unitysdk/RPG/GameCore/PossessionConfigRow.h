...
#define RPG_GAMECORE_POSSESSIONCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D358960)
#define RPG_GAMECORE_POSSESSIONCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D358C10)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::Il2CppArray<::System::Single>* LocalScale; // 0x10
		::Il2CppArray<::System::Single>* LocalPosition; // 0x18
		::System::String* AttachPoint; // 0x20
		::System::String* PossessionName; // 0x28
		::Il2CppArray<::System::Single>* LocalRotation; // 0x30
		::System::String* PossessionPrefabPath; // 0x38
