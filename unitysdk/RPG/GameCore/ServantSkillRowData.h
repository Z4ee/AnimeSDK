...
#define RPG_GAMECORE_SERVANTSKILLROWDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB731BB0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_ATTACKDAMAGETYPEOVERRIDE_OFFSET UNITYSDK_OFFSET(0xB732320)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_ATTACKTYPE_OFFSET UNITYSDK_OFFSET(0xB732360)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_BPADD_OFFSET UNITYSDK_OFFSET(0xB7320B0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_BPNEED_OFFSET UNITYSDK_OFFSET(0xB732020)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0xB731CA0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_COOLDOWN_OFFSET UNITYSDK_OFFSET(0xB731DC0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_DELAYRATIO_OFFSET UNITYSDK_OFFSET(0xB732140)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_EXTRAEFFECTIDLIST_OFFSET UNITYSDK_OFFSET(0xB7329D0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_HIDEINUI_OFFSET UNITYSDK_OFFSET(0xB732900)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_INITCOOLDOWN_OFFSET UNITYSDK_OFFSET(0xB731D60)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0xB7323E0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_MAXLEVEL_OFFSET UNITYSDK_OFFSET(0xB732410)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_PARAMLIST_OFFSET UNITYSDK_OFFSET(0xB7321D0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_PREADDMODIFIERLIST_OFFSET UNITYSDK_OFFSET(0xB732440)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_PRECALEQUALSPLITTARGET_OFFSET UNITYSDK_OFFSET(0xB732450)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_RATEDRANKID_OFFSET UNITYSDK_OFFSET(0xB732A30)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_RATEDSKILLTREEID_OFFSET UNITYSDK_OFFSET(0xB732A10)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_ROW_OFFSET UNITYSDK_OFFSET(0xB731BF0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SHOWDAMAGELIST_OFFSET UNITYSDK_OFFSET(0xB732BE0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SHOWHEALLIST_OFFSET UNITYSDK_OFFSET(0xB732BF0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SHOWSTANCELIST_OFFSET UNITYSDK_OFFSET(0xB732BC0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SIMPLEEXTRAEFFECTIDLIST_OFFSET UNITYSDK_OFFSET(0xB7329F0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SIMPLEPARAMLIST_OFFSET UNITYSDK_OFFSET(0xB732240)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SIMPLESKILLDESC_OFFSET UNITYSDK_OFFSET(0xB732850)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SKILLCOMBOVALUEDELTA_OFFSET UNITYSDK_OFFSET(0xB7323B0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SKILLDESC_OFFSET UNITYSDK_OFFSET(0xB7327A0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SKILLEFFECT_OFFSET UNITYSDK_OFFSET(0xB732390)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SKILLICON_OFFSET UNITYSDK_OFFSET(0xB7326C0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SKILLID_OFFSET UNITYSDK_OFFSET(0xB731CB0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SKILLNAME_OFFSET UNITYSDK_OFFSET(0xB7324B0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SKILLNEED_OFFSET UNITYSDK_OFFSET(0xB732970)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SKILLTAG_OFFSET UNITYSDK_OFFSET(0xB732560)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SKILLTRIGGERKEY_OFFSET UNITYSDK_OFFSET(0xB731CE0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SKILLTYPEDESC_OFFSET UNITYSDK_OFFSET(0xB732610)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SPADD_OFFSET UNITYSDK_OFFSET(0xB731E20)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SPBASE_OFFSET UNITYSDK_OFFSET(0xB731EB0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SPMULTIPLERATIO_OFFSET UNITYSDK_OFFSET(0xB731FB0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SPNEED_OFFSET UNITYSDK_OFFSET(0xB731F20)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_STANCEDAMAGEDISPLAY_OFFSET UNITYSDK_OFFSET(0xB7329A0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_STANCEDAMAGETYPE_OFFSET UNITYSDK_OFFSET(0xB7322B0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_ULTRASKILLICON_OFFSET UNITYSDK_OFFSET(0xB732730)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_OVERRIDEDATA_OFFSET UNITYSDK_OFFSET(0xB732A50)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_SET_ROW_OFFSET UNITYSDK_OFFSET(0xB731C50)
#define RPG_GAMECORE_SERVANTSKILLROWDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB731AD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ServantSkillRowData_TypeDefinitionIndex = 53176;
	...
	public:
		...
		{
			return (::RPG::GameCore::AvatarServantSkillRow**)Il2CppClass::FromTypeDefinitionIndex(ServantSkillRowData_TypeDefinitionIndex)->GetStaticField(0x5CEA0);
		}
