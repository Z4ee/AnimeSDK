...
#define RPG_GAMECORE_SERVANTSKILLROWDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0xCE9E1C0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_ATTACKDAMAGETYPEOVERRIDE_OFFSET UNITYSDK_OFFSET(0xCE9EC70)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_ATTACKTYPE_OFFSET UNITYSDK_OFFSET(0xCE9ECC0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_BPADD_OFFSET UNITYSDK_OFFSET(0xCE9E8A0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_BPNEED_OFFSET UNITYSDK_OFFSET(0xCE9E760)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0xCE9E2B0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_COOLDOWN_OFFSET UNITYSDK_OFFSET(0xCE9E3B0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_DELAYRATIO_OFFSET UNITYSDK_OFFSET(0xCE9E9E0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_EXTRAEFFECTIDLIST_OFFSET UNITYSDK_OFFSET(0xCE9F340)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_HIDEINUI_OFFSET UNITYSDK_OFFSET(0xCE9F270)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_INITCOOLDOWN_OFFSET UNITYSDK_OFFSET(0xCE9E360)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0xCE9ED50)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_MAXLEVEL_OFFSET UNITYSDK_OFFSET(0xCE9ED80)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_PARAMLIST_OFFSET UNITYSDK_OFFSET(0xCE9EB20)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_PREADDMODIFIERLIST_OFFSET UNITYSDK_OFFSET(0xCE9EDB0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_PRECALEQUALSPLITTARGET_OFFSET UNITYSDK_OFFSET(0xCE9EDC0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_RATEDRANKID_OFFSET UNITYSDK_OFFSET(0xCE9F3A0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_RATEDSKILLTREEID_OFFSET UNITYSDK_OFFSET(0xCE9F380)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_ROW_OFFSET UNITYSDK_OFFSET(0xCE9E200)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SHOWDAMAGELIST_OFFSET UNITYSDK_OFFSET(0xCE9F550)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SHOWHEALLIST_OFFSET UNITYSDK_OFFSET(0xCE9F560)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SHOWSTANCELIST_OFFSET UNITYSDK_OFFSET(0xCE9F530)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SIMPLEEXTRAEFFECTIDLIST_OFFSET UNITYSDK_OFFSET(0xCE9F360)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SIMPLEPARAMLIST_OFFSET UNITYSDK_OFFSET(0xCE9EB90)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SIMPLESKILLDESC_OFFSET UNITYSDK_OFFSET(0xCE9F1C0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SKILLCOMBOVALUEDELTA_OFFSET UNITYSDK_OFFSET(0xCE9ED20)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SKILLDESC_OFFSET UNITYSDK_OFFSET(0xCE9F110)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SKILLEFFECT_OFFSET UNITYSDK_OFFSET(0xCE9ECF0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SKILLICON_OFFSET UNITYSDK_OFFSET(0xCE9F030)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SKILLID_OFFSET UNITYSDK_OFFSET(0xCE9E2C0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SKILLNAME_OFFSET UNITYSDK_OFFSET(0xCE9EE20)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SKILLNEED_OFFSET UNITYSDK_OFFSET(0xCE9F2E0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SKILLTAG_OFFSET UNITYSDK_OFFSET(0xCE9EED0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SKILLTRIGGERKEY_OFFSET UNITYSDK_OFFSET(0xCE9E2E0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SKILLTYPEDESC_OFFSET UNITYSDK_OFFSET(0xCE9EF80)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SPADD_OFFSET UNITYSDK_OFFSET(0xCE9E400)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SPBASE_OFFSET UNITYSDK_OFFSET(0xCE9E540)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SPMULTIPLERATIO_OFFSET UNITYSDK_OFFSET(0xCE9E6F0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_SPNEED_OFFSET UNITYSDK_OFFSET(0xCE9E5B0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_STANCEDAMAGEDISPLAY_OFFSET UNITYSDK_OFFSET(0xCE9F310)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_STANCEDAMAGETYPE_OFFSET UNITYSDK_OFFSET(0xCE9EC00)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_GET_ULTRASKILLICON_OFFSET UNITYSDK_OFFSET(0xCE9F0A0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_OVERRIDEDATA_OFFSET UNITYSDK_OFFSET(0xCE9F3C0)
#define RPG_GAMECORE_SERVANTSKILLROWDATA_SET_ROW_OFFSET UNITYSDK_OFFSET(0xCE9E260)
#define RPG_GAMECORE_SERVANTSKILLROWDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCE9E0E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ServantSkillRowData_TypeDefinitionIndex = 53887;
	...
	public:
		...
		{
			return (::RPG::GameCore::AvatarServantSkillRow**)Il2CppClass::FromTypeDefinitionIndex(ServantSkillRowData_TypeDefinitionIndex)->GetStaticField(0x689E0);
		}
