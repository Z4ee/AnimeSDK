...
#define RPG_GAMECORE_RESTAURANTABILITYCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D01F0D0)
#define RPG_GAMECORE_RESTAURANTABILITYCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D01F420)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RestaurantAbilityConfigRow_TypeDefinitionIndex = 10951;
	...
	public:
		...
		::RPG::GameCore::RestaurantEmployeeAbility Type; // 0x30
		::RPG::Client::TextID Name; // 0x38
		::RPG::GameCore::ElfTargetType TargetType; // 0x48
		::System::UInt32 AbilityID; // 0x4C
