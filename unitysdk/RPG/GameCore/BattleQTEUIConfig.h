...
#define RPG_GAMECORE_BATTLEQTEUICONFIG_METHOD_2_54FD53255CA60E38_OFFSET UNITYSDK_OFFSET(0x194D7090)
#define RPG_GAMECORE_BATTLEQTEUICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x194D7360)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleQTEUIConfig_TypeDefinitionIndex = 22074;
