...
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_BRANCH_METHOD_3_5499596C08154FEA_OFFSET UNITYSDK_OFFSET(0x1CFA47A0)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_BRANCH_METHOD_3_F05E3BC3E2575B8B_OFFSET UNITYSDK_OFFSET(0x1CFA4740)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_BRANCH__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFA4790)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleAbility_Branch_TypeDefinitionIndex = 15575;
