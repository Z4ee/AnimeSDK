...
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_BRANCH_METHOD_3_17A2A99DA12FFC58_OFFSET UNITYSDK_OFFSET(0x17079060)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_BRANCH_METHOD_3_E31A47C6FB3DB77D_OFFSET UNITYSDK_OFFSET(0x17079000)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_BRANCH__CTOR_OFFSET UNITYSDK_OFFSET(0x17079050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleAbility_Branch_TypeDefinitionIndex = 14441;
