...
#define RPG_GAMECORE_PINGPONGENEMYCMPTCONFIG_METHOD_3_AC9D6546CAB5F67B_OFFSET UNITYSDK_OFFSET(0x1B4C67C0)
#define RPG_GAMECORE_PINGPONGENEMYCMPTCONFIG_METHOD_3_F3C3243313F01907_OFFSET UNITYSDK_OFFSET(0x1B4C66E0)
#define RPG_GAMECORE_PINGPONGENEMYCMPTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4C67B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PingPongEnemyCmptConfig_TypeDefinitionIndex = 18186;
