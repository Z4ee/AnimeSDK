...
#define RPG_GAMECORE_PINGPONGENEMYCMPTCONFIG_METHOD_3_925388FA9E3F1A24_OFFSET UNITYSDK_OFFSET(0x19A0C3D0)
#define RPG_GAMECORE_PINGPONGENEMYCMPTCONFIG_METHOD_3_AC9D6546CAB5F67B_OFFSET UNITYSDK_OFFSET(0x19A0C500)
#define RPG_GAMECORE_PINGPONGENEMYCMPTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19A0C4E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PingPongEnemyCmptConfig_TypeDefinitionIndex = 18002;
