...
#define RPG_GAMECORE_BYCOMPAREMODIFIERCALLBACKDYNAMICVALUE_METHOD_4_2DD9D26BC20FFE17_OFFSET UNITYSDK_OFFSET(0x18733120)
#define RPG_GAMECORE_BYCOMPAREMODIFIERCALLBACKDYNAMICVALUE_METHOD_4_58F2C6B50B8963F6_OFFSET UNITYSDK_OFFSET(0x18733050)
#define RPG_GAMECORE_BYCOMPAREMODIFIERCALLBACKDYNAMICVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x187330D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareModifierCallBackDynamicValue_TypeDefinitionIndex = 21929;
