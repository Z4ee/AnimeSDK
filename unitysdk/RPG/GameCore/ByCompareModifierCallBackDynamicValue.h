...
#define RPG_GAMECORE_BYCOMPAREMODIFIERCALLBACKDYNAMICVALUE_METHOD_4_080C562717469341_OFFSET UNITYSDK_OFFSET(0x1BBA4B60)
#define RPG_GAMECORE_BYCOMPAREMODIFIERCALLBACKDYNAMICVALUE_METHOD_4_2DD9D26BC20FFE17_OFFSET UNITYSDK_OFFSET(0x1BBA4BA0)
#define RPG_GAMECORE_BYCOMPAREMODIFIERCALLBACKDYNAMICVALUE_METHOD_4_A544683B4AAF55B0_OFFSET UNITYSDK_OFFSET(0x1BBA4E30)
#define RPG_GAMECORE_BYCOMPAREMODIFIERCALLBACKDYNAMICVALUE_METHOD_4_D5F3FAC492F84F47_OFFSET UNITYSDK_OFFSET(0x1BBA4E60)
#define RPG_GAMECORE_BYCOMPAREMODIFIERCALLBACKDYNAMICVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBA4B90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareModifierCallBackDynamicValue_TypeDefinitionIndex = 22747;
