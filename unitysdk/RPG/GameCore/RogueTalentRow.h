...
#define RPG_GAMECORE_ROGUETALENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1BB6AEA0)
#define RPG_GAMECORE_ROGUETALENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB6B340)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTalentRow_TypeDefinitionIndex = 14256;
