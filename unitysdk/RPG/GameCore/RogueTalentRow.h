...
#define RPG_GAMECORE_ROGUETALENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18D68AC0)
#define RPG_GAMECORE_ROGUETALENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18D68F80)
