...
#define RPG_GAMECORE_ROGUETALENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1765AF20)
#define RPG_GAMECORE_ROGUETALENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1765B3E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTalentRow_TypeDefinitionIndex = 13572;
