...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERREPLACESUPPLYRULEIDCONFIG_METHOD_3_912551DDCECF21B5_OFFSET UNITYSDK_OFFSET(0x1726BD40)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERREPLACESUPPLYRULEIDCONFIG_METHOD_3_EB4FFEEF23E130EC_OFFSET UNITYSDK_OFFSET(0x17268DE0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERREPLACESUPPLYRULEIDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17268D90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierReplaceSupplyRuleIdConfig_TypeDefinitionIndex = 17838;
