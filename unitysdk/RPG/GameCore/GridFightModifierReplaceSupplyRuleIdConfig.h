...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERREPLACESUPPLYRULEIDCONFIG_METHOD_3_912551DDCECF21B5_OFFSET UNITYSDK_OFFSET(0x197F3570)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERREPLACESUPPLYRULEIDCONFIG_METHOD_3_EB4FFEEF23E130EC_OFFSET UNITYSDK_OFFSET(0x197EECD0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERREPLACESUPPLYRULEIDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197EEC80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierReplaceSupplyRuleIdConfig_TypeDefinitionIndex = 18432;
