...
#define RPG_GAMECORE_BYCOMPARESTAGETYPE_METHOD_4_CC249D221517F756_OFFSET UNITYSDK_OFFSET(0x1873C960)
#define RPG_GAMECORE_BYCOMPARESTAGETYPE_METHOD_4_E36DFD7C7BB65228_OFFSET UNITYSDK_OFFSET(0x1873C890)
#define RPG_GAMECORE_BYCOMPARESTAGETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1873C910)
