...
#define RPG_GAMECORE_SHOWSPEICALAVATARHUDCONTAINERPANEL_METHOD_3_2AC11EB9775459B2_OFFSET UNITYSDK_OFFSET(0x18E67F70)
#define RPG_GAMECORE_SHOWSPEICALAVATARHUDCONTAINERPANEL_METHOD_3_5EF0B357727ECBBC_OFFSET UNITYSDK_OFFSET(0x18E68040)
#define RPG_GAMECORE_SHOWSPEICALAVATARHUDCONTAINERPANEL__CTOR_OFFSET UNITYSDK_OFFSET(0x18E67FF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowSpeicalAvatarHUDContainerPanel_TypeDefinitionIndex = 22106;
