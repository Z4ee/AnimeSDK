...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYADVENTUREROOMTIMECONFIG_METHOD_3_54375E416159D319_OFFSET UNITYSDK_OFFSET(0x19B5E9C0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYADVENTUREROOMTIMECONFIG_METHOD_3_85C42D865A7A8A70_OFFSET UNITYSDK_OFFSET(0x19B548E0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYADVENTUREROOMTIMECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B54890)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyAdventureRoomTimeConfig_TypeDefinitionIndex = 17077;
