...
#define RPG_GAMECORE_LEVELANCHORPARAMETER_METHOD_2_E3F525CD63145BFD_OFFSET UNITYSDK_OFFSET(0x18A3BCD0)
#define RPG_GAMECORE_LEVELANCHORPARAMETER_METHOD_2_FEEE01F5F1985CC1_OFFSET UNITYSDK_OFFSET(0x18A3BAF0)
#define RPG_GAMECORE_LEVELANCHORPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x18A3B5F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelAnchorParameter_TypeDefinitionIndex = 16362;
