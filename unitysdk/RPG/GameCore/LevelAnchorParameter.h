...
#define RPG_GAMECORE_LEVELANCHORPARAMETER_METHOD_2_E3F525CD63145BFD_OFFSET UNITYSDK_OFFSET(0x1B02D2D0)
#define RPG_GAMECORE_LEVELANCHORPARAMETER_METHOD_2_FEEE01F5F1985CC1_OFFSET UNITYSDK_OFFSET(0x1B02D100)
#define RPG_GAMECORE_LEVELANCHORPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B02CC00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelAnchorParameter_TypeDefinitionIndex = 16556;
