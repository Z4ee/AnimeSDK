...
#define RPG_GAMECORE_ADVMODIFYMAXMAZEMP_METHOD_3_58125755B265973B_OFFSET UNITYSDK_OFFSET(0x18655B20)
#define RPG_GAMECORE_ADVMODIFYMAXMAZEMP_METHOD_3_F4FBEBCC4B349CF3_OFFSET UNITYSDK_OFFSET(0x18655C40)
#define RPG_GAMECORE_ADVMODIFYMAXMAZEMP__CTOR_OFFSET UNITYSDK_OFFSET(0x18655BC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvModifyMaxMazeMP_TypeDefinitionIndex = 20670;
