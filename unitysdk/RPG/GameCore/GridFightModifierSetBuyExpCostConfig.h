...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETBUYEXPCOSTCONFIG_METHOD_3_914CB38C60D68F72_OFFSET UNITYSDK_OFFSET(0x197EF130)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETBUYEXPCOSTCONFIG_METHOD_3_FF8301CA70BEDCFB_OFFSET UNITYSDK_OFFSET(0x197F37F0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETBUYEXPCOSTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197EF0E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierSetBuyExpCostConfig_TypeDefinitionIndex = 18402;
