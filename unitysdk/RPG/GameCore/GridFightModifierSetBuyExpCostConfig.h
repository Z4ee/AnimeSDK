...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETBUYEXPCOSTCONFIG_METHOD_3_914CB38C60D68F72_OFFSET UNITYSDK_OFFSET(0x1D15A940)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETBUYEXPCOSTCONFIG_METHOD_3_ABCF3CE2D0C61996_OFFSET UNITYSDK_OFFSET(0x1D15A8F0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETBUYEXPCOSTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D15A930)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierSetBuyExpCostConfig_TypeDefinitionIndex = 19175;
