...
#define RPG_GAMECORE_CHENLINGSTAGEWAVEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17089CF0)
#define RPG_GAMECORE_CHENLINGSTAGEWAVEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17089EA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingStageWaveRow_TypeDefinitionIndex = 10376;
