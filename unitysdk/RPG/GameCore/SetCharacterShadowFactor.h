...
#define RPG_GAMECORE_SETCHARACTERSHADOWFACTOR_METHOD_3_2C705EFE023C67FF_OFFSET UNITYSDK_OFFSET(0x1C2D9080)
#define RPG_GAMECORE_SETCHARACTERSHADOWFACTOR_METHOD_3_C5350054DAFB1B1E_OFFSET UNITYSDK_OFFSET(0x1C2D9040)
#define RPG_GAMECORE_SETCHARACTERSHADOWFACTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2D9070)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetCharacterShadowFactor_TypeDefinitionIndex = 21079;
