...
#define RPG_GAMECORE_SETMONSTERPHASE_METHOD_3_852C90B8B5F0CCE0_OFFSET UNITYSDK_OFFSET(0x18E3B640)
#define RPG_GAMECORE_SETMONSTERPHASE_METHOD_3_B750F9A61D439704_OFFSET UNITYSDK_OFFSET(0x18E3B720)
#define RPG_GAMECORE_SETMONSTERPHASE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E3B6C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetMonsterPhase_TypeDefinitionIndex = 21628;
