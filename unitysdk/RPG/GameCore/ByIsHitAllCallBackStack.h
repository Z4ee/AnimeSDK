...
#define RPG_GAMECORE_BYISHITALLCALLBACKSTACK_METHOD_4_0DE4EE3F277B4BAB_OFFSET UNITYSDK_OFFSET(0x1702EC50)
#define RPG_GAMECORE_BYISHITALLCALLBACKSTACK_METHOD_4_A1BEE485FBBE7801_OFFSET UNITYSDK_OFFSET(0x1702ED20)
#define RPG_GAMECORE_BYISHITALLCALLBACKSTACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1702ECD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsHitAllCallBackStack_TypeDefinitionIndex = 21731;
