...
#define RPG_GAMECORE_BYISHITALLCALLBACKSTACK_METHOD_4_1E40B02EFE1CEA5B_OFFSET UNITYSDK_OFFSET(0x1B299AC0)
#define RPG_GAMECORE_BYISHITALLCALLBACKSTACK_METHOD_4_66B03D53B144D81A_OFFSET UNITYSDK_OFFSET(0x1B299940)
#define RPG_GAMECORE_BYISHITALLCALLBACKSTACK_METHOD_4_7BDE0E64C039ABCE_OFFSET UNITYSDK_OFFSET(0x1B299AF0)
#define RPG_GAMECORE_BYISHITALLCALLBACKSTACK_METHOD_4_A1BEE485FBBE7801_OFFSET UNITYSDK_OFFSET(0x1B299980)
#define RPG_GAMECORE_BYISHITALLCALLBACKSTACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B299970)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsHitAllCallBackStack_TypeDefinitionIndex = 22656;
