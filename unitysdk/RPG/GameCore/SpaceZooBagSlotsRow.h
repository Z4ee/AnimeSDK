...
#define RPG_GAMECORE_SPACEZOOBAGSLOTSROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1BE544A0)
#define RPG_GAMECORE_SPACEZOOBAGSLOTSROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE54AE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SpaceZooBagSlotsRow_TypeDefinitionIndex = 11902;
