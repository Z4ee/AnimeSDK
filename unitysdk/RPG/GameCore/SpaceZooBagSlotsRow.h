...
#define RPG_GAMECORE_SPACEZOOBAGSLOTSROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19C91260)
#define RPG_GAMECORE_SPACEZOOBAGSLOTSROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19C918A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SpaceZooBagSlotsRow_TypeDefinitionIndex = 11802;
