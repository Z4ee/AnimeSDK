...
#define RPG_GAMECORE_FANTASTICSTORYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D088D20)
#define RPG_GAMECORE_FANTASTICSTORYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D088F70)
