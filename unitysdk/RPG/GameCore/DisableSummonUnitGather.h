...
#define RPG_GAMECORE_DISABLESUMMONUNITGATHER_METHOD_3_8C23B9CE8571D888_OFFSET UNITYSDK_OFFSET(0x18880400)
#define RPG_GAMECORE_DISABLESUMMONUNITGATHER_METHOD_3_A537023C519C637E_OFFSET UNITYSDK_OFFSET(0x18880380)
#define RPG_GAMECORE_DISABLESUMMONUNITGATHER__CTOR_OFFSET UNITYSDK_OFFSET(0x188803D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DisableSummonUnitGather_TypeDefinitionIndex = 19099;
