...
#define RPG_GAMECORE_TRACKNPCVISIONCONFIG_METHOD_2_5AF98F108809A282_OFFSET UNITYSDK_OFFSET(0x19DEDA20)
#define RPG_GAMECORE_TRACKNPCVISIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19DEDDB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrackNpcVisionConfig_TypeDefinitionIndex = 15467;
