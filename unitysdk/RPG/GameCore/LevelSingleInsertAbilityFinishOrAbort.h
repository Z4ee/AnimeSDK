...
#define RPG_GAMECORE_LEVELSINGLEINSERTABILITYFINISHORABORT_CLEAR_OFFSET UNITYSDK_OFFSET(0xB6DF8D0)
#define RPG_GAMECORE_LEVELSINGLEINSERTABILITYFINISHORABORT_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xB6DF920)
#define RPG_GAMECORE_LEVELSINGLEINSERTABILITYFINISHORABORT_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xB6DF970)
#define RPG_GAMECORE_LEVELSINGLEINSERTABILITYFINISHORABORT_GET_FINISHSOURCE_OFFSET UNITYSDK_OFFSET(0xB6DF9E0)
#define RPG_GAMECORE_LEVELSINGLEINSERTABILITYFINISHORABORT_GET_SILENCE_OFFSET UNITYSDK_OFFSET(0xB6DFA00)
#define RPG_GAMECORE_LEVELSINGLEINSERTABILITYFINISHORABORT_GET_TURNINSERTABILITYINSTANCE_OFFSET UNITYSDK_OFFSET(0xB6DF9C0)
#define RPG_GAMECORE_LEVELSINGLEINSERTABILITYFINISHORABORT_INIT_OFFSET UNITYSDK_OFFSET(0xB6DF870)
#define RPG_GAMECORE_LEVELSINGLEINSERTABILITYFINISHORABORT_SET_FINISHSOURCE_OFFSET UNITYSDK_OFFSET(0xB6DF9F0)
#define RPG_GAMECORE_LEVELSINGLEINSERTABILITYFINISHORABORT_SET_SILENCE_OFFSET UNITYSDK_OFFSET(0xB6DFA10)
#define RPG_GAMECORE_LEVELSINGLEINSERTABILITYFINISHORABORT_SET_TURNINSERTABILITYINSTANCE_OFFSET UNITYSDK_OFFSET(0xB6DF9D0)
#define RPG_GAMECORE_LEVELSINGLEINSERTABILITYFINISHORABORT__CTOR_OFFSET UNITYSDK_OFFSET(0xB6DFA20)
#define RPG_GAMECORE_LEVELSINGLEINSERTABILITYFINISHORABORT___IFIXBASEPROXY_CLEAR_OFFSET UNITYSDK_OFFSET(0xB6DFA30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelSingleInsertAbilityFinishOrAbort_TypeDefinitionIndex = 52292;
