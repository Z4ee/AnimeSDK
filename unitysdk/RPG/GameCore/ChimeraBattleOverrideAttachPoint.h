...
#define RPG_GAMECORE_CHIMERABATTLEOVERRIDEATTACHPOINT_METHOD_3_E07B9647DEF53986_OFFSET UNITYSDK_OFFSET(0x1CFBE110)
#define RPG_GAMECORE_CHIMERABATTLEOVERRIDEATTACHPOINT_METHOD_3_E9DC4BB55573EEF2_OFFSET UNITYSDK_OFFSET(0x1CFBC7A0)
#define RPG_GAMECORE_CHIMERABATTLEOVERRIDEATTACHPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFBC790)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraBattleOverrideAttachPoint_TypeDefinitionIndex = 15707;
