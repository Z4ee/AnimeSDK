...
#define RPG_GAMECORE_CHIMERABATTLEOVERRIDEATTACHPOINT_METHOD_3_E07B9647DEF53986_OFFSET UNITYSDK_OFFSET(0x187F3920)
#define RPG_GAMECORE_CHIMERABATTLEOVERRIDEATTACHPOINT_METHOD_3_E9DC4BB55573EEF2_OFFSET UNITYSDK_OFFSET(0x187F1E20)
#define RPG_GAMECORE_CHIMERABATTLEOVERRIDEATTACHPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x187F1E10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraBattleOverrideAttachPoint_TypeDefinitionIndex = 15043;
