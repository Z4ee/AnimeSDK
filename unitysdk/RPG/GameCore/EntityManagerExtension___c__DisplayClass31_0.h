...
#define RPG_GAMECORE_ENTITYMANAGEREXTENSION___C__DISPLAYCLASS31_0__CLIENTCREATEUI3DMODELENTITY_B__0_OFFSET UNITYSDK_OFFSET(0xCDC1900)
#define RPG_GAMECORE_ENTITYMANAGEREXTENSION___C__DISPLAYCLASS31_0__CTOR_OFFSET UNITYSDK_OFFSET(0xCDA8680)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EntityManagerExtension___c__DisplayClass31_0_TypeDefinitionIndex = 53989;
