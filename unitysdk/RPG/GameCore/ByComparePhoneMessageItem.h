...
#define RPG_GAMECORE_BYCOMPAREPHONEMESSAGEITEM_METHOD_4_05857B824FE917C0_OFFSET UNITYSDK_OFFSET(0x18736480)
#define RPG_GAMECORE_BYCOMPAREPHONEMESSAGEITEM_METHOD_4_825698B02ABFDF4A_OFFSET UNITYSDK_OFFSET(0x18736550)
#define RPG_GAMECORE_BYCOMPAREPHONEMESSAGEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x18736500)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByComparePhoneMessageItem_TypeDefinitionIndex = 19690;
