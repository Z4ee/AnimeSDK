...
#define RPG_GAMECORE_BYCOMPAREPHONEMESSAGEITEM_METHOD_4_05857B824FE917C0_OFFSET UNITYSDK_OFFSET(0x17012170)
#define RPG_GAMECORE_BYCOMPAREPHONEMESSAGEITEM_METHOD_4_825698B02ABFDF4A_OFFSET UNITYSDK_OFFSET(0x17012240)
#define RPG_GAMECORE_BYCOMPAREPHONEMESSAGEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x170121F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByComparePhoneMessageItem_TypeDefinitionIndex = 19032;
