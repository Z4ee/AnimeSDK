...
#define RPG_GAMECORE_NETDEFINECONSTVALUE_METHOD_2_601BF670998A0249_OFFSET UNITYSDK_OFFSET(0x1BAF5AE0)
#define RPG_GAMECORE_NETDEFINECONSTVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAF61B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NetDefineConstValue_TypeDefinitionIndex = 18288;
