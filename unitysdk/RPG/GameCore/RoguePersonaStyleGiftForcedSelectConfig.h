...
#define RPG_GAMECORE_ROGUEPERSONASTYLEGIFTFORCEDSELECTCONFIG_METHOD_2_109363217ED775BE_OFFSET UNITYSDK_OFFSET(0x18D65C20)
#define RPG_GAMECORE_ROGUEPERSONASTYLEGIFTFORCEDSELECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D65C60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RoguePersonaStyleGiftForcedSelectConfig_TypeDefinitionIndex = 16952;
