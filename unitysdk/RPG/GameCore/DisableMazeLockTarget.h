...
#define RPG_GAMECORE_DISABLEMAZELOCKTARGET_METHOD_3_A8F197A596744DDB_OFFSET UNITYSDK_OFFSET(0x1887FB60)
#define RPG_GAMECORE_DISABLEMAZELOCKTARGET_METHOD_3_C5F557868227D07F_OFFSET UNITYSDK_OFFSET(0x1887FBE0)
#define RPG_GAMECORE_DISABLEMAZELOCKTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1887FBB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DisableMazeLockTarget_TypeDefinitionIndex = 19093;
