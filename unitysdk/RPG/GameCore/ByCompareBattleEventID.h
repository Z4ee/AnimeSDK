...
#define RPG_GAMECORE_BYCOMPAREBATTLEEVENTID_METHOD_4_AD944FED6D309CBB_OFFSET UNITYSDK_OFFSET(0x187277A0)
#define RPG_GAMECORE_BYCOMPAREBATTLEEVENTID_METHOD_4_F352A6951BDE819E_OFFSET UNITYSDK_OFFSET(0x18727900)
#define RPG_GAMECORE_BYCOMPAREBATTLEEVENTID__CTOR_OFFSET UNITYSDK_OFFSET(0x18727860)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareBattleEventID_TypeDefinitionIndex = 21926;
