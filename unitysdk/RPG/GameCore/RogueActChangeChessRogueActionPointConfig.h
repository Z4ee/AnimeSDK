...
#define RPG_GAMECORE_ROGUEACTCHANGECHESSROGUEACTIONPOINTCONFIG_METHOD_6_9E8DB20CCFF40EDE_OFFSET UNITYSDK_OFFSET(0x1D3B6A90)
#define RPG_GAMECORE_ROGUEACTCHANGECHESSROGUEACTIONPOINTCONFIG_METHOD_6_F92A08FA4507FC1A_OFFSET UNITYSDK_OFFSET(0x1D3B6AE0)
#define RPG_GAMECORE_ROGUEACTCHANGECHESSROGUEACTIONPOINTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3B6AD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActChangeChessRogueActionPointConfig_TypeDefinitionIndex = 19411;
