...
#define RPG_GAMECORE_ROGUEACTCHANGECHESSROGUEACTIONPOINTCONFIG_METHOD_6_A38BE3006C71972F_OFFSET UNITYSDK_OFFSET(0x18CBD560)
#define RPG_GAMECORE_ROGUEACTCHANGECHESSROGUEACTIONPOINTCONFIG_METHOD_6_F92A08FA4507FC1A_OFFSET UNITYSDK_OFFSET(0x18CBD780)
#define RPG_GAMECORE_ROGUEACTCHANGECHESSROGUEACTIONPOINTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CBD6A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActChangeChessRogueActionPointConfig_TypeDefinitionIndex = 18641;
