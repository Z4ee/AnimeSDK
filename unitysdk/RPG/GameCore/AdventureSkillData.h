...
#define RPG_GAMECORE_ADVENTURESKILLDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1541AE50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureSkillData_TypeDefinitionIndex = 54317;
