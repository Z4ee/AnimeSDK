...
#define RPG_GAMECORE_BYCOMPAREALERTVALUE_METHOD_4_DC937188A25C69AA_OFFSET UNITYSDK_OFFSET(0x17002200)
#define RPG_GAMECORE_BYCOMPAREALERTVALUE_METHOD_4_FE3E1B0F91D61ED6_OFFSET UNITYSDK_OFFSET(0x170022D0)
#define RPG_GAMECORE_BYCOMPAREALERTVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x17002280)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareAlertValue_TypeDefinitionIndex = 19095;
