...
#define RPG_GAMECORE_PINBALLPUZZLEENABLECONTROLMODE_METHOD_3_0AF29308CE27F19B_OFFSET UNITYSDK_OFFSET(0x18BF9800)
#define RPG_GAMECORE_PINBALLPUZZLEENABLECONTROLMODE_METHOD_3_56ACA4D59591EF8F_OFFSET UNITYSDK_OFFSET(0x18BF9780)
#define RPG_GAMECORE_PINBALLPUZZLEENABLECONTROLMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x18BF97D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PinballPuzzleEnableControlMode_TypeDefinitionIndex = 20864;
