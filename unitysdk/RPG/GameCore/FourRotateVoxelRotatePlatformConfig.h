...
#define RPG_GAMECORE_FOURROTATEVOXELROTATEPLATFORMCONFIG_METHOD_3_68F595C9E33584AB_OFFSET UNITYSDK_OFFSET(0x189304C0)
#define RPG_GAMECORE_FOURROTATEVOXELROTATEPLATFORMCONFIG_METHOD_3_8B2A09255960573A_OFFSET UNITYSDK_OFFSET(0x18930530)
#define RPG_GAMECORE_FOURROTATEVOXELROTATEPLATFORMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18930510)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FourRotateVoxelRotatePlatformConfig_TypeDefinitionIndex = 15876;
