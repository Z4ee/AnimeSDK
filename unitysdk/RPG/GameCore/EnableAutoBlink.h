...
#define RPG_GAMECORE_ENABLEAUTOBLINK_METHOD_3_6E84DBBD5FEF3746_OFFSET UNITYSDK_OFFSET(0x188A4590)
#define RPG_GAMECORE_ENABLEAUTOBLINK_METHOD_3_E5EC2E1EC8000410_OFFSET UNITYSDK_OFFSET(0x188A4610)
#define RPG_GAMECORE_ENABLEAUTOBLINK__CTOR_OFFSET UNITYSDK_OFFSET(0x188A45E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnableAutoBlink_TypeDefinitionIndex = 21289;
