...
#define RPG_GAMECORE_ENABLEAUTOBLINK_METHOD_3_6E84DBBD5FEF3746_OFFSET UNITYSDK_OFFSET(0x17196E50)
#define RPG_GAMECORE_ENABLEAUTOBLINK_METHOD_3_E5EC2E1EC8000410_OFFSET UNITYSDK_OFFSET(0x17196ED0)
#define RPG_GAMECORE_ENABLEAUTOBLINK__CTOR_OFFSET UNITYSDK_OFFSET(0x17196EA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnableAutoBlink_TypeDefinitionIndex = 20605;
