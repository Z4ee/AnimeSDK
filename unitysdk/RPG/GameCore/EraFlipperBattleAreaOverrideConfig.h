...
#define RPG_GAMECORE_ERAFLIPPERBATTLEAREAOVERRIDECONFIG_METHOD_2_610744A499980B69_OFFSET UNITYSDK_OFFSET(0x171A9DE0)
#define RPG_GAMECORE_ERAFLIPPERBATTLEAREAOVERRIDECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171A9F50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EraFlipperBattleAreaOverrideConfig_TypeDefinitionIndex = 15222;
