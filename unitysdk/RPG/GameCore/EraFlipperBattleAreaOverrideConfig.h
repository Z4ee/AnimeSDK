...
#define RPG_GAMECORE_ERAFLIPPERBATTLEAREAOVERRIDECONFIG_METHOD_2_610744A499980B69_OFFSET UNITYSDK_OFFSET(0x196F4F90)
#define RPG_GAMECORE_ERAFLIPPERBATTLEAREAOVERRIDECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x196F5100)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EraFlipperBattleAreaOverrideConfig_TypeDefinitionIndex = 15791;
