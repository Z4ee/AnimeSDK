...
#define RPG_GAMECORE_CAKERACEACTIONSLOPESLIDE_METHOD_3_07557168107372DD_OFFSET UNITYSDK_OFFSET(0x17046B80)
#define RPG_GAMECORE_CAKERACEACTIONSLOPESLIDE_METHOD_3_6F968CC3F8074F2B_OFFSET UNITYSDK_OFFSET(0x170457A0)
#define RPG_GAMECORE_CAKERACEACTIONSLOPESLIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x17045780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionSlopeSlide_TypeDefinitionIndex = 16850;
