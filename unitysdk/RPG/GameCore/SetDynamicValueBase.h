...
#define RPG_GAMECORE_SETDYNAMICVALUEBASE_GET_ISCLIENTONLY_OFFSET UNITYSDK_OFFSET(0x1D4EC700)
#define RPG_GAMECORE_SETDYNAMICVALUEBASE_METHOD_3_2E0E90D7E0EB2A64_OFFSET UNITYSDK_OFFSET(0x1D4EC640)
#define RPG_GAMECORE_SETDYNAMICVALUEBASE_METHOD_3_4E91E1F53AD58FB2_OFFSET UNITYSDK_OFFSET(0x1D4EC5E0)
#define RPG_GAMECORE_SETDYNAMICVALUEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4EC5D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueBase_TypeDefinitionIndex = 23547;
