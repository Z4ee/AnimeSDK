...
#define RPG_GAMECORE_ABILITYPROPERTYRANGEGROUP_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x185F5540)
#define RPG_GAMECORE_ABILITYPROPERTYRANGEGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x185F5670)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AbilityPropertyRangeGroup_TypeDefinitionIndex = 17318;
