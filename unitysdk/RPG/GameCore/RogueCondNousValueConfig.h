...
#define RPG_GAMECORE_ROGUECONDNOUSVALUECONFIG_METHOD_6_30596BB4EA24FA00_OFFSET UNITYSDK_OFFSET(0x1D918A80)
#define RPG_GAMECORE_ROGUECONDNOUSVALUECONFIG_METHOD_6_9E6F130967C9B8FC_OFFSET UNITYSDK_OFFSET(0x1D918AD0)
#define RPG_GAMECORE_ROGUECONDNOUSVALUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D918AC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueCondNousValueConfig_TypeDefinitionIndex = 19573;
