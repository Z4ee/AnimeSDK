...
#define RPG_GAMECORE_FLOORCUSTOMFLOATCONFIG_METHOD_3_086EF979BE80AA06_OFFSET UNITYSDK_OFFSET(0x1BEBB910)
#define RPG_GAMECORE_FLOORCUSTOMFLOATCONFIG_METHOD_3_0A0F444FEAC5D6B8_OFFSET UNITYSDK_OFFSET(0x1BEBB7B0)
#define RPG_GAMECORE_FLOORCUSTOMFLOATCONFIG_METHOD_3_44EA7C921DD05EE7_OFFSET UNITYSDK_OFFSET(0x1BEBB770)
#define RPG_GAMECORE_FLOORCUSTOMFLOATCONFIG_METHOD_3_685933B36DB43CF1_OFFSET UNITYSDK_OFFSET(0x1BEBB8E0)
#define RPG_GAMECORE_FLOORCUSTOMFLOATCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEBB7A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FloorCustomFloatConfig_TypeDefinitionIndex = 17549;
