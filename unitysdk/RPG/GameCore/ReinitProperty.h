...
#define RPG_GAMECORE_REINITPROPERTY_METHOD_3_253D2C2880F2C502_OFFSET UNITYSDK_OFFSET(0x18C96380)
#define RPG_GAMECORE_REINITPROPERTY_METHOD_3_E7AA732EDF14AC3F_OFFSET UNITYSDK_OFFSET(0x18C96300)
#define RPG_GAMECORE_REINITPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x18C96350)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ReinitProperty_TypeDefinitionIndex = 22538;
