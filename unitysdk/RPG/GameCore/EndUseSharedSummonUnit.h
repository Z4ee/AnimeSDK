...
#define RPG_GAMECORE_ENDUSESHAREDSUMMONUNIT_METHOD_3_37B5434BA997B5E3_OFFSET UNITYSDK_OFFSET(0x196E6F70)
#define RPG_GAMECORE_ENDUSESHAREDSUMMONUNIT_METHOD_3_37DF8488625024DA_OFFSET UNITYSDK_OFFSET(0x196E6FF0)
#define RPG_GAMECORE_ENDUSESHAREDSUMMONUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0x196E6FC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EndUseSharedSummonUnit_TypeDefinitionIndex = 19996;
