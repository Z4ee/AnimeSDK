...
#define RPG_GAMECORE_ENDUSESHAREDSUMMONUNIT_METHOD_3_37B5434BA997B5E3_OFFSET UNITYSDK_OFFSET(0x1719B2C0)
#define RPG_GAMECORE_ENDUSESHAREDSUMMONUNIT_METHOD_3_37DF8488625024DA_OFFSET UNITYSDK_OFFSET(0x1719B340)
#define RPG_GAMECORE_ENDUSESHAREDSUMMONUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1719B310)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EndUseSharedSummonUnit_TypeDefinitionIndex = 19464;
