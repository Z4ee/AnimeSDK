...
#define RPG_GAMECORE_ENDUSESHAREDSUMMONUNIT_METHOD_3_37DF8488625024DA_OFFSET UNITYSDK_OFFSET(0x1D065370)
#define RPG_GAMECORE_ENDUSESHAREDSUMMONUNIT_METHOD_3_4F0D2BF91D249351_OFFSET UNITYSDK_OFFSET(0x1D065330)
#define RPG_GAMECORE_ENDUSESHAREDSUMMONUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D065360)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EndUseSharedSummonUnit_TypeDefinitionIndex = 20920;
