...
#define RPG_GAMECORE_LEVELENTITYUSESKILL_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xE693060)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xE693010)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_GET_INDEX_OFFSET UNITYSDK_OFFSET(0xE693130)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_GET_SKILLCONFIGID_OFFSET UNITYSDK_OFFSET(0xE693150)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_GET_SKILLID_OFFSET UNITYSDK_OFFSET(0xE6930D0)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_GET_SKILLLEVEL_OFFSET UNITYSDK_OFFSET(0xE693170)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_GET_SKILLTARGETS_OFFSET UNITYSDK_OFFSET(0xE693190)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_GET_SKILLTYPE_OFFSET UNITYSDK_OFFSET(0xE6930F0)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_GET_TARGETID_OFFSET UNITYSDK_OFFSET(0xE6930B0)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_GET_USETYPE_OFFSET UNITYSDK_OFFSET(0xE693110)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_INIT_OFFSET UNITYSDK_OFFSET(0xE692F40)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_SET_INDEX_OFFSET UNITYSDK_OFFSET(0xE693140)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_SET_SKILLCONFIGID_OFFSET UNITYSDK_OFFSET(0xE693160)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_SET_SKILLID_OFFSET UNITYSDK_OFFSET(0xE6930E0)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_SET_SKILLLEVEL_OFFSET UNITYSDK_OFFSET(0xE693180)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_SET_SKILLTARGETS_OFFSET UNITYSDK_OFFSET(0xE6931A0)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_SET_SKILLTYPE_OFFSET UNITYSDK_OFFSET(0xE693100)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_SET_TARGETID_OFFSET UNITYSDK_OFFSET(0xE6930C0)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_SET_USETYPE_OFFSET UNITYSDK_OFFSET(0xE693120)
#define RPG_GAMECORE_LEVELENTITYUSESKILL__CTOR_OFFSET UNITYSDK_OFFSET(0xE6931B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelEntityUseSkill_TypeDefinitionIndex = 56929;

	class LevelEntityUseSkill : public ::Class_1_BF7A075734D15E98
	{
	public:
		::System::String* _SkillID_k__BackingField; // 0x18
		::System::Collections::Generic::List_1<::RPG::GameCore::GameEntity*>* _SkillTargets_k__BackingField; // 0x20
		::System::UInt32 _TargetID_k__BackingField; // 0x28
		::System::Int32 _Index_k__BackingField; // 0x2C
		::RPG::GameCore::SkillType _SkillType_k__BackingField; // 0x30
		::System::UInt32 _SkillConfigID_k__BackingField; // 0x34
		::RPG::GameCore::SkillUseType _UseType_k__BackingField; // 0x38
		::System::UInt32 _SkillLevel_k__BackingField; // 0x3C
