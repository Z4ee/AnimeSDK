...
#define RPG_GAMECORE_LEVELENTITYUSESKILL_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1DD23EC0)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x1DD23E70)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x1DD23F90)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_GET_SKILLCONFIGID_OFFSET UNITYSDK_OFFSET(0x1DD23FB0)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_GET_SKILLID_OFFSET UNITYSDK_OFFSET(0x1DD23F30)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_GET_SKILLLEVEL_OFFSET UNITYSDK_OFFSET(0x1DD23FD0)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_GET_SKILLTARGETS_OFFSET UNITYSDK_OFFSET(0x1DD23FF0)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_GET_SKILLTYPE_OFFSET UNITYSDK_OFFSET(0x1DD23F50)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_GET_TARGETID_OFFSET UNITYSDK_OFFSET(0x1DD23F10)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_GET_USETYPE_OFFSET UNITYSDK_OFFSET(0x1DD23F70)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_INIT_OFFSET UNITYSDK_OFFSET(0x1DD23DA0)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_SET_INDEX_OFFSET UNITYSDK_OFFSET(0x1DD23FA0)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_SET_SKILLCONFIGID_OFFSET UNITYSDK_OFFSET(0x1DD23FC0)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_SET_SKILLID_OFFSET UNITYSDK_OFFSET(0x1DD23F40)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_SET_SKILLLEVEL_OFFSET UNITYSDK_OFFSET(0x1DD23FE0)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_SET_SKILLTARGETS_OFFSET UNITYSDK_OFFSET(0x1DD24000)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_SET_SKILLTYPE_OFFSET UNITYSDK_OFFSET(0x1DD23F60)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_SET_TARGETID_OFFSET UNITYSDK_OFFSET(0x1DD23F20)
#define RPG_GAMECORE_LEVELENTITYUSESKILL_SET_USETYPE_OFFSET UNITYSDK_OFFSET(0x1DD23F80)
#define RPG_GAMECORE_LEVELENTITYUSESKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD24010)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 _SkillLevel_k__BackingField; // 0x34
		::System::UInt32 _TargetID_k__BackingField; // 0x38
		::System::Int32 _Index_k__BackingField; // 0x3C
