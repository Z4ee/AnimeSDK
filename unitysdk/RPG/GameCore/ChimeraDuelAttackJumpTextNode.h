...
#define RPG_GAMECORE_CHIMERADUELATTACKJUMPTEXTNODE_METHOD_3_AA279FDCC7136976_OFFSET UNITYSDK_OFFSET(0x19636DC0)
#define RPG_GAMECORE_CHIMERADUELATTACKJUMPTEXTNODE_METHOD_3_F8A2391CA34E853D_OFFSET UNITYSDK_OFFSET(0x19636C80)
#define RPG_GAMECORE_CHIMERADUELATTACKJUMPTEXTNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x19636D70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelAttackJumpTextNode_TypeDefinitionIndex = 15189;
