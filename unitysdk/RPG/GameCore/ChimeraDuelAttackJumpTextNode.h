...
#define RPG_GAMECORE_CHIMERADUELATTACKJUMPTEXTNODE_METHOD_3_AA279FDCC7136976_OFFSET UNITYSDK_OFFSET(0x187F4EB0)
#define RPG_GAMECORE_CHIMERADUELATTACKJUMPTEXTNODE_METHOD_3_F8A2391CA34E853D_OFFSET UNITYSDK_OFFSET(0x187F4D70)
#define RPG_GAMECORE_CHIMERADUELATTACKJUMPTEXTNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x187F4E60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelAttackJumpTextNode_TypeDefinitionIndex = 15127;
