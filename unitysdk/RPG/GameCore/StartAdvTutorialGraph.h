...
#define RPG_GAMECORE_STARTADVTUTORIALGRAPH_METHOD_3_086305275DC8880F_OFFSET UNITYSDK_OFFSET(0x18E98E90)
#define RPG_GAMECORE_STARTADVTUTORIALGRAPH_METHOD_3_7F4BFE11D225B71B_OFFSET UNITYSDK_OFFSET(0x18E98F10)
#define RPG_GAMECORE_STARTADVTUTORIALGRAPH__CTOR_OFFSET UNITYSDK_OFFSET(0x18E98EE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StartAdvTutorialGraph_TypeDefinitionIndex = 20250;
