...
#define RPG_GAMECORE_STARTADVTUTORIALGRAPH_METHOD_3_086305275DC8880F_OFFSET UNITYSDK_OFFSET(0x177732B0)
#define RPG_GAMECORE_STARTADVTUTORIALGRAPH_METHOD_3_7F4BFE11D225B71B_OFFSET UNITYSDK_OFFSET(0x17773330)
#define RPG_GAMECORE_STARTADVTUTORIALGRAPH__CTOR_OFFSET UNITYSDK_OFFSET(0x17773300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StartAdvTutorialGraph_TypeDefinitionIndex = 19575;
