...
#define RPG_GAMECORE_CAKERACELOOKATCATBYRANK_METHOD_3_3E2015404BF1064A_OFFSET UNITYSDK_OFFSET(0x18772BD0)
#define RPG_GAMECORE_CAKERACELOOKATCATBYRANK_METHOD_3_72DF6D6BDE7BE683_OFFSET UNITYSDK_OFFSET(0x18772B50)
#define RPG_GAMECORE_CAKERACELOOKATCATBYRANK__CTOR_OFFSET UNITYSDK_OFFSET(0x18772BA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceLookAtCatByRank_TypeDefinitionIndex = 23315;
