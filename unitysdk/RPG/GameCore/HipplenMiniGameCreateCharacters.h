...
#define RPG_GAMECORE_HIPPLENMINIGAMECREATECHARACTERS_METHOD_3_13BBC159E90E4433_OFFSET UNITYSDK_OFFSET(0x172AF8C0)
#define RPG_GAMECORE_HIPPLENMINIGAMECREATECHARACTERS_METHOD_3_7C0BD498F33831F0_OFFSET UNITYSDK_OFFSET(0x172AF940)
#define RPG_GAMECORE_HIPPLENMINIGAMECREATECHARACTERS__CTOR_OFFSET UNITYSDK_OFFSET(0x172AF910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HipplenMiniGameCreateCharacters_TypeDefinitionIndex = 19623;
