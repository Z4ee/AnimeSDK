...
#define RPG_GAMECORE_ST_SIDE_TRIGGEREFFECT_METHOD_4_34D42A6F7507E798_OFFSET UNITYSDK_OFFSET(0x1769A130)
#define RPG_GAMECORE_ST_SIDE_TRIGGEREFFECT_METHOD_4_61D5EB787223950F_OFFSET UNITYSDK_OFFSET(0x176908F0)
#define RPG_GAMECORE_ST_SIDE_TRIGGEREFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x17690880)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_TriggerEffect_TypeDefinitionIndex = 18431;
