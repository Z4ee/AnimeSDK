...
#define RPG_GAMECORE_FORMATIONMOVEPAUSE_METHOD_3_91AB2AC793CD5CBB_OFFSET UNITYSDK_OFFSET(0x1D111930)
#define RPG_GAMECORE_FORMATIONMOVEPAUSE_METHOD_3_EA82191DE4C24C40_OFFSET UNITYSDK_OFFSET(0x1D111970)
#define RPG_GAMECORE_FORMATIONMOVEPAUSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D111960)
