...
#define RPG_GAMECORE_FORMATIONMOVEPAUSE_METHOD_3_AE0D716F4247B1C9_OFFSET UNITYSDK_OFFSET(0x1892B1B0)
#define RPG_GAMECORE_FORMATIONMOVEPAUSE_METHOD_3_EA82191DE4C24C40_OFFSET UNITYSDK_OFFSET(0x1892B230)
#define RPG_GAMECORE_FORMATIONMOVEPAUSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1892B200)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FormationMovePause_TypeDefinitionIndex = 20230;
