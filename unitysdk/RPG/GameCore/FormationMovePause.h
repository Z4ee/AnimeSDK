...
#define RPG_GAMECORE_FORMATIONMOVEPAUSE_METHOD_3_AE0D716F4247B1C9_OFFSET UNITYSDK_OFFSET(0x17218B80)
#define RPG_GAMECORE_FORMATIONMOVEPAUSE_METHOD_3_EA82191DE4C24C40_OFFSET UNITYSDK_OFFSET(0x17218C00)
#define RPG_GAMECORE_FORMATIONMOVEPAUSE__CTOR_OFFSET UNITYSDK_OFFSET(0x17218BD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FormationMovePause_TypeDefinitionIndex = 19555;
