...
#define RPG_GAMECORE_FORMATIONMOVEPAUSE_METHOD_3_91AB2AC793CD5CBB_OFFSET UNITYSDK_OFFSET(0x1BEC1120)
#define RPG_GAMECORE_FORMATIONMOVEPAUSE_METHOD_3_EA82191DE4C24C40_OFFSET UNITYSDK_OFFSET(0x1BEC1160)
#define RPG_GAMECORE_FORMATIONMOVEPAUSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEC1150)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FormationMovePause_TypeDefinitionIndex = 20459;
