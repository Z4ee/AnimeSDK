...
#define RPG_GAMECORE_GRIDFIGHTBINARYDIFFADDRULECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x197DB240)
#define RPG_GAMECORE_GRIDFIGHTBINARYDIFFADDRULECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x197DB3B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightBinaryDiffAddRuleConfigRow_TypeDefinitionIndex = 12965;
