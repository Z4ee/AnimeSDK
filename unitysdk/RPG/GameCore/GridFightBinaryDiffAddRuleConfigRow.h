...
#define RPG_GAMECORE_GRIDFIGHTBINARYDIFFADDRULECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17253CD0)
#define RPG_GAMECORE_GRIDFIGHTBINARYDIFFADDRULECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17253E40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightBinaryDiffAddRuleConfigRow_TypeDefinitionIndex = 12445;
