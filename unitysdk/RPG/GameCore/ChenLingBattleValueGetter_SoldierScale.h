...
#define RPG_GAMECORE_CHENLINGBATTLEVALUEGETTER_SOLDIERSCALE_METHOD_3_5D8C02F0B72A5C50_OFFSET UNITYSDK_OFFSET(0x170834B0)
#define RPG_GAMECORE_CHENLINGBATTLEVALUEGETTER_SOLDIERSCALE_METHOD_3_F389E34454F89855_OFFSET UNITYSDK_OFFSET(0x17083550)
#define RPG_GAMECORE_CHENLINGBATTLEVALUEGETTER_SOLDIERSCALE__CTOR_OFFSET UNITYSDK_OFFSET(0x17083540)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleValueGetter_SoldierScale_TypeDefinitionIndex = 14501;
