...
#define RPG_GAMECORE_SWITCHHANDRESETTRANSFORM_METHOD_3_37EF99D40B5B2AF2_OFFSET UNITYSDK_OFFSET(0x17795740)
#define RPG_GAMECORE_SWITCHHANDRESETTRANSFORM_METHOD_3_9548BA0246A89723_OFFSET UNITYSDK_OFFSET(0x177957C0)
#define RPG_GAMECORE_SWITCHHANDRESETTRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x17795790)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchHandResetTransform_TypeDefinitionIndex = 19288;
