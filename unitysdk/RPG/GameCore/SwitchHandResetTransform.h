...
#define RPG_GAMECORE_SWITCHHANDRESETTRANSFORM_METHOD_3_9548BA0246A89723_OFFSET UNITYSDK_OFFSET(0x1D58BD00)
#define RPG_GAMECORE_SWITCHHANDRESETTRANSFORM_METHOD_3_96CDFCBDAB8A46AA_OFFSET UNITYSDK_OFFSET(0x1D58BCC0)
#define RPG_GAMECORE_SWITCHHANDRESETTRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D58BCF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchHandResetTransform_TypeDefinitionIndex = 20720;
