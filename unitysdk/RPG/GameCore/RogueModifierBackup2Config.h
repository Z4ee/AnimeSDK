...
#define RPG_GAMECORE_ROGUEMODIFIERBACKUP2CONFIG_METHOD_3_AA445D100752BF88_OFFSET UNITYSDK_OFFSET(0x19B4E6A0)
#define RPG_GAMECORE_ROGUEMODIFIERBACKUP2CONFIG_METHOD_3_ED530A6182F824F1_OFFSET UNITYSDK_OFFSET(0x19B4E5D0)
#define RPG_GAMECORE_ROGUEMODIFIERBACKUP2CONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B4E650)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierBackup2Config_TypeDefinitionIndex = 17107;
