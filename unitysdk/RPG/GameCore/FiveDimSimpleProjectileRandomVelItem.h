...
#define RPG_GAMECORE_FIVEDIMSIMPLEPROJECTILERANDOMVELITEM_METHOD_2_9B06471BFEA8F271_OFFSET UNITYSDK_OFFSET(0x19756F00)
#define RPG_GAMECORE_FIVEDIMSIMPLEPROJECTILERANDOMVELITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x19757010)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSimpleProjectileRandomVelItem_TypeDefinitionIndex = 17679;
