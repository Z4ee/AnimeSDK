...
#define RPG_GAMECORE_MONSTERHPRATIOCHECK_METHOD_3_140662C32C6E892B_OFFSET UNITYSDK_OFFSET(0x1B1C9760)
#define RPG_GAMECORE_MONSTERHPRATIOCHECK_METHOD_3_974DE1DE1D8808E2_OFFSET UNITYSDK_OFFSET(0x1B1C97A0)
#define RPG_GAMECORE_MONSTERHPRATIOCHECK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1C9790)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonsterHPRatioCheck_TypeDefinitionIndex = 22134;
