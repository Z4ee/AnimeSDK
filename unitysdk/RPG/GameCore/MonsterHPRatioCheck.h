...
#define RPG_GAMECORE_MONSTERHPRATIOCHECK_METHOD_3_1C5887BCDD6DB7F1_OFFSET UNITYSDK_OFFSET(0x17451120)
#define RPG_GAMECORE_MONSTERHPRATIOCHECK_METHOD_3_6A5A6F4A82F529E2_OFFSET UNITYSDK_OFFSET(0x174510A0)
#define RPG_GAMECORE_MONSTERHPRATIOCHECK__CTOR_OFFSET UNITYSDK_OFFSET(0x174510F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonsterHPRatioCheck_TypeDefinitionIndex = 21166;
