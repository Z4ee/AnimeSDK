...
#define RPG_GAMECORE_ROGUEPARAMROGUEMAGICCURRENTROOMTYPECONFIG_METHOD_6_8326F357FC4875B2_OFFSET UNITYSDK_OFFSET(0x1D176B40)
#define RPG_GAMECORE_ROGUEPARAMROGUEMAGICCURRENTROOMTYPECONFIG_METHOD_6_E946F3F5CF37C4D6_OFFSET UNITYSDK_OFFSET(0x1D176AF0)
#define RPG_GAMECORE_ROGUEPARAMROGUEMAGICCURRENTROOMTYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D176B30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamRogueMagicCurrentRoomTypeConfig_TypeDefinitionIndex = 19072;
