...
#define RPG_GAMECORE_ROGUEPARAMROGUEMAGICCURRENTROOMTYPECONFIG_METHOD_6_8326F357FC4875B2_OFFSET UNITYSDK_OFFSET(0x18D5A9D0)
#define RPG_GAMECORE_ROGUEPARAMROGUEMAGICCURRENTROOMTYPECONFIG_METHOD_6_DD03D995FC58231C_OFFSET UNITYSDK_OFFSET(0x18D5A720)
#define RPG_GAMECORE_ROGUEPARAMROGUEMAGICCURRENTROOMTYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D5A8A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamRogueMagicCurrentRoomTypeConfig_TypeDefinitionIndex = 18826;
