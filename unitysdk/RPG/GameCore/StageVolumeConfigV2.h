...
#define RPG_GAMECORE_STAGEVOLUMECONFIGV2_METHOD_2_DBFBCD73AC83A9EB_OFFSET UNITYSDK_OFFSET(0x19CB15A0)
#define RPG_GAMECORE_STAGEVOLUMECONFIGV2_METHOD_2_ECD5F8AFC5543385_OFFSET UNITYSDK_OFFSET(0x19CB1420)
#define RPG_GAMECORE_STAGEVOLUMECONFIGV2__CTOR_OFFSET UNITYSDK_OFFSET(0x19CB1590)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StageVolumeConfigV2_TypeDefinitionIndex = 18166;
