...
#define RPG_GAMECORE_SETTARGETCUSTOMASSETPRELOADSTATE_METHOD_3_64BE99F0AF95A6B9_OFFSET UNITYSDK_OFFSET(0x19C61AD0)
#define RPG_GAMECORE_SETTARGETCUSTOMASSETPRELOADSTATE_METHOD_3_D8867D1BDA29ABCE_OFFSET UNITYSDK_OFFSET(0x19C61BB0)
#define RPG_GAMECORE_SETTARGETCUSTOMASSETPRELOADSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C61B50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetTargetCustomAssetPreloadState_TypeDefinitionIndex = 21564;
