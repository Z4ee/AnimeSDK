...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_WRITECUSTOMVALUE_MODIFIERSTACKCOUNT_METHOD_3_CDB4C8FFB185E50A_OFFSET UNITYSDK_OFFSET(0x1DB08CD0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_WRITECUSTOMVALUE_MODIFIERSTACKCOUNT_METHOD_3_DF5FA45AA09D9B61_OFFSET UNITYSDK_OFFSET(0x1DB08D30)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_WRITECUSTOMVALUE_MODIFIERSTACKCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB08D20)
