...
#define RPG_GAMECORE_PINGPONGBOARDCMPTCONFIG_METHOD_3_034118288AA1CABA_OFFSET UNITYSDK_OFFSET(0x18BFA1A0)
#define RPG_GAMECORE_PINGPONGBOARDCMPTCONFIG_METHOD_3_12F93CBA7BBF3C28_OFFSET UNITYSDK_OFFSET(0x18BFA0C0)
#define RPG_GAMECORE_PINGPONGBOARDCMPTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18BFA180)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PingPongBoardCmptConfig_TypeDefinitionIndex = 17974;
