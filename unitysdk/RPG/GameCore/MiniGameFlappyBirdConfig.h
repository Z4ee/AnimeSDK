...
#define RPG_GAMECORE_MINIGAMEFLAPPYBIRDCONFIG_METHOD_3_103553F3D49A75E3_OFFSET UNITYSDK_OFFSET(0x1D1A5670)
#define RPG_GAMECORE_MINIGAMEFLAPPYBIRDCONFIG_METHOD_3_B57BC4FE6F373B42_OFFSET UNITYSDK_OFFSET(0x1D1A56E0)
#define RPG_GAMECORE_MINIGAMEFLAPPYBIRDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1A56C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MiniGameFlappyBirdConfig_TypeDefinitionIndex = 18599;
