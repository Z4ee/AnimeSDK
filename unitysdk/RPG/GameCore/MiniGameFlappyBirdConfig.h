...
#define RPG_GAMECORE_MINIGAMEFLAPPYBIRDCONFIG_METHOD_3_103553F3D49A75E3_OFFSET UNITYSDK_OFFSET(0x1741C930)
#define RPG_GAMECORE_MINIGAMEFLAPPYBIRDCONFIG_METHOD_3_B57BC4FE6F373B42_OFFSET UNITYSDK_OFFSET(0x1741C9A0)
#define RPG_GAMECORE_MINIGAMEFLAPPYBIRDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1741C980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MiniGameFlappyBirdConfig_TypeDefinitionIndex = 17260;
