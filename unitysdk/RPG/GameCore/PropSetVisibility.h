...
#define RPG_GAMECORE_PROPSETVISIBILITY_METHOD_3_7982506B62293525_OFFSET UNITYSDK_OFFSET(0x175256E0)
#define RPG_GAMECORE_PROPSETVISIBILITY_METHOD_3_8B4AB4C7C40E0BEF_OFFSET UNITYSDK_OFFSET(0x17525590)
#define RPG_GAMECORE_PROPSETVISIBILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x17525650)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropSetVisibility_TypeDefinitionIndex = 18693;
