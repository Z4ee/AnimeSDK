...
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICENOFAKINDCOUNT_METHOD_3_1AB3EDC64D4A5195_OFFSET UNITYSDK_OFFSET(0x18863590)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICENOFAKINDCOUNT_METHOD_3_F25226F9158B6745_OFFSET UNITYSDK_OFFSET(0x18863FE0)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICENOFAKINDCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x18863580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatAIEffectEvaluatorConfig_DiceNOfAKindCount_TypeDefinitionIndex = 15338;
