...
#define RPG_GAMECORE_CAKERACEACTIONCHANGEWAITTIMEBYVOTE_METHOD_3_0C2F62C4D16530CA_OFFSET UNITYSDK_OFFSET(0x1876BB80)
#define RPG_GAMECORE_CAKERACEACTIONCHANGEWAITTIMEBYVOTE_METHOD_3_CEAA55ACD4E770F8_OFFSET UNITYSDK_OFFSET(0x18769640)
#define RPG_GAMECORE_CAKERACEACTIONCHANGEWAITTIMEBYVOTE__CTOR_OFFSET UNITYSDK_OFFSET(0x18769620)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionChangeWaitTimeByVote_TypeDefinitionIndex = 17428;
	...
	public:
		...
		static ::System::Void Method_3_0C2F62C4D16530CA(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::CakeRaceActionChangeWaitTimeByVote*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::CakeRaceActionChangeWaitTimeByVote*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_CAKERACEACTIONCHANGEWAITTIMEBYVOTE_METHOD_3_0C2F62C4D16530CA_OFFSET))(a1, a2);
		}
