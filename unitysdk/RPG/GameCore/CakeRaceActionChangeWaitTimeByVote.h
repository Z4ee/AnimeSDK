...
#define RPG_GAMECORE_CAKERACEACTIONCHANGEWAITTIMEBYVOTE_METHOD_3_0C2F62C4D16530CA_OFFSET UNITYSDK_OFFSET(0x195E7B30)
#define RPG_GAMECORE_CAKERACEACTIONCHANGEWAITTIMEBYVOTE_METHOD_3_CEAA55ACD4E770F8_OFFSET UNITYSDK_OFFSET(0x195E5140)
#define RPG_GAMECORE_CAKERACEACTIONCHANGEWAITTIMEBYVOTE__CTOR_OFFSET UNITYSDK_OFFSET(0x195E5120)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionChangeWaitTimeByVote_TypeDefinitionIndex = 17431;
