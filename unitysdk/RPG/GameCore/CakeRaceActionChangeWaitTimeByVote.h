...
#define RPG_GAMECORE_CAKERACEACTIONCHANGEWAITTIMEBYVOTE_METHOD_3_CEAA55ACD4E770F8_OFFSET UNITYSDK_OFFSET(0x1CF6E4E0)
#define RPG_GAMECORE_CAKERACEACTIONCHANGEWAITTIMEBYVOTE_METHOD_3_E270391CDFBCE1AF_OFFSET UNITYSDK_OFFSET(0x1CF6E480)
#define RPG_GAMECORE_CAKERACEACTIONCHANGEWAITTIMEBYVOTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF6E4D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionChangeWaitTimeByVote_TypeDefinitionIndex = 18122;
