...
#define RPG_GAMECORE_MODIFIERVALUEBINDDATA_METHOD_2_7E99884E2D79A386_OFFSET UNITYSDK_OFFSET(0x1AF72E70)
#define RPG_GAMECORE_MODIFIERVALUEBINDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF72FC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifierValueBindData_TypeDefinitionIndex = 17501;
