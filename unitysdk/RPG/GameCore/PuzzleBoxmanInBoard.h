...
#define RPG_GAMECORE_PUZZLEBOXMANINBOARD_METHOD_3_0B8A6DE63D662A3C_OFFSET UNITYSDK_OFFSET(0x17574970)
#define RPG_GAMECORE_PUZZLEBOXMANINBOARD_METHOD_3_6102990D591EB037_OFFSET UNITYSDK_OFFSET(0x175748F0)
#define RPG_GAMECORE_PUZZLEBOXMANINBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x17574940)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PuzzleBoxmanInBoard_TypeDefinitionIndex = 20191;
