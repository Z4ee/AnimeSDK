...
#define RPG_GAMECORE_PUZZLEBOXMANINBOARD_METHOD_3_882839CE1B83632E_OFFSET UNITYSDK_OFFSET(0x1D18B9F0)
#define RPG_GAMECORE_PUZZLEBOXMANINBOARD_METHOD_3_C83EB49714CCAF4F_OFFSET UNITYSDK_OFFSET(0x1D18B9A0)
#define RPG_GAMECORE_PUZZLEBOXMANINBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x1D18B9E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PuzzleBoxmanInBoard_TypeDefinitionIndex = 21767;
