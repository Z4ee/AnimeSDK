...
#define RPG_GAMECORE_BYCOMPAREGRAPHDYNAMICSTRING_METHOD_4_19AA049BF7E0F882_OFFSET UNITYSDK_OFFSET(0x1700A370)
#define RPG_GAMECORE_BYCOMPAREGRAPHDYNAMICSTRING_METHOD_4_1F375432E521458A_OFFSET UNITYSDK_OFFSET(0x1700A2A0)
#define RPG_GAMECORE_BYCOMPAREGRAPHDYNAMICSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1700A320)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareGraphDynamicString_TypeDefinitionIndex = 19031;
