...
#define RPG_GAMECORE_BYCOMPAREGRAPHDYNAMICSTRING_METHOD_4_19AA049BF7E0F882_OFFSET UNITYSDK_OFFSET(0x19CE7520)
#define RPG_GAMECORE_BYCOMPAREGRAPHDYNAMICSTRING_METHOD_4_C4D4C106E1F6692B_OFFSET UNITYSDK_OFFSET(0x19CE76F0)
#define RPG_GAMECORE_BYCOMPAREGRAPHDYNAMICSTRING_METHOD_4_E4F0AA8E988C0343_OFFSET UNITYSDK_OFFSET(0x19CE74E0)
#define RPG_GAMECORE_BYCOMPAREGRAPHDYNAMICSTRING_METHOD_4_EEB6EE66342A73C4_OFFSET UNITYSDK_OFFSET(0x19CE76C0)
#define RPG_GAMECORE_BYCOMPAREGRAPHDYNAMICSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x19CE7510)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareGraphDynamicString_TypeDefinitionIndex = 19928;
