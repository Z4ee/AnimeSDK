...
#define RPG_GAMECORE_EXTRAREWRADINFO_METHOD_2_FB59FB140C136A03_OFFSET UNITYSDK_OFFSET(0x1D7E2170)
#define RPG_GAMECORE_EXTRAREWRADINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7E21B0)
