...
#define RPG_GAMECORE_UNLOCKTARGETHP_METHOD_3_22C91DB2516703F3_OFFSET UNITYSDK_OFFSET(0x190E5E80)
#define RPG_GAMECORE_UNLOCKTARGETHP_METHOD_3_F4DFD397728D9327_OFFSET UNITYSDK_OFFSET(0x190E5E00)
#define RPG_GAMECORE_UNLOCKTARGETHP__CTOR_OFFSET UNITYSDK_OFFSET(0x190E5E50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UnlockTargetHP_TypeDefinitionIndex = 22599;
