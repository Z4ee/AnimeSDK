...
#define RPG_GAMECORE_UNLOCKTARGETHP_METHOD_3_22C91DB2516703F3_OFFSET UNITYSDK_OFFSET(0x19E383B0)
#define RPG_GAMECORE_UNLOCKTARGETHP_METHOD_3_F4DFD397728D9327_OFFSET UNITYSDK_OFFSET(0x19E38330)
#define RPG_GAMECORE_UNLOCKTARGETHP__CTOR_OFFSET UNITYSDK_OFFSET(0x19E38380)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UnlockTargetHP_TypeDefinitionIndex = 22330;
