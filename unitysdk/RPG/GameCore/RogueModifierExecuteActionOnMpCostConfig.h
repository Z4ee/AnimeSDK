...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONMPCOSTCONFIG_METHOD_3_5749BAA3D0311D98_OFFSET UNITYSDK_OFFSET(0x18D3D8C0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONMPCOSTCONFIG_METHOD_3_7B12D3B7ABCF35C1_OFFSET UNITYSDK_OFFSET(0x18D3D7F0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONMPCOSTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D3D870)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnMpCostConfig_TypeDefinitionIndex = 16797;
