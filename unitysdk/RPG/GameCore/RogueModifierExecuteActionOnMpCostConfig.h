...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONMPCOSTCONFIG_METHOD_3_5749BAA3D0311D98_OFFSET UNITYSDK_OFFSET(0x19B52340)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONMPCOSTCONFIG_METHOD_3_7B12D3B7ABCF35C1_OFFSET UNITYSDK_OFFSET(0x19B5D3A0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONMPCOSTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B522F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnMpCostConfig_TypeDefinitionIndex = 16812;
