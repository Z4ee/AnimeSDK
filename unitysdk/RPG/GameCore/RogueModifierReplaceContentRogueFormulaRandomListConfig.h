...
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEFORMULARANDOMLISTCONFIG_METHOD_3_031AF59019FED170_OFFSET UNITYSDK_OFFSET(0x18D45250)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEFORMULARANDOMLISTCONFIG_METHOD_3_D18E264B20DE1A19_OFFSET UNITYSDK_OFFSET(0x18D45180)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEFORMULARANDOMLISTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D45200)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierReplaceContentRogueFormulaRandomListConfig_TypeDefinitionIndex = 16815;
