...
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEFORMULARANDOMLISTCONFIG_METHOD_3_031AF59019FED170_OFFSET UNITYSDK_OFFSET(0x1D165910)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEFORMULARANDOMLISTCONFIG_METHOD_3_F7D73376AD3D4774_OFFSET UNITYSDK_OFFSET(0x1D1658C0)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEFORMULARANDOMLISTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D165900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierReplaceContentRogueFormulaRandomListConfig_TypeDefinitionIndex = 16992;
