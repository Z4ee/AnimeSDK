...
#define RPG_GAMECORE_CLEARHPSHAREDGROUP_METHOD_3_956AF5A981599F79_OFFSET UNITYSDK_OFFSET(0x18811F50)
#define RPG_GAMECORE_CLEARHPSHAREDGROUP_METHOD_3_B6FA188A071E67B5_OFFSET UNITYSDK_OFFSET(0x18811FD0)
#define RPG_GAMECORE_CLEARHPSHAREDGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x18811FA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClearHPSharedGroup_TypeDefinitionIndex = 21735;
