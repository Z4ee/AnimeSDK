...
#define RPG_GAMECORE_LEVELTURNACTIONPHASEBEGIN_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x19780AC0)
#define RPG_GAMECORE_LEVELTURNACTIONPHASEBEGIN_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x19780A70)
#define RPG_GAMECORE_LEVELTURNACTIONPHASEBEGIN_GET_ACTIVEENTITY_OFFSET UNITYSDK_OFFSET(0x19780B10)
#define RPG_GAMECORE_LEVELTURNACTIONPHASEBEGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x19780A60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelTurnActionPhaseBegin_TypeDefinitionIndex = 54165;
