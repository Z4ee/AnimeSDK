...
#define RPG_GAMECORE_LEVELTURNACTIONPHASEBEGIN_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1DD2B940)
#define RPG_GAMECORE_LEVELTURNACTIONPHASEBEGIN_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x1DD2B8F0)
#define RPG_GAMECORE_LEVELTURNACTIONPHASEBEGIN_GET_ACTIVEENTITY_OFFSET UNITYSDK_OFFSET(0x1DD2B990)
#define RPG_GAMECORE_LEVELTURNACTIONPHASEBEGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD2B8E0)
