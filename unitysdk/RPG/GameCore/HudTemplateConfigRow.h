...
#define RPG_GAMECORE_HUDTEMPLATECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D209650)
#define RPG_GAMECORE_HUDTEMPLATECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D209CD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HudTemplateConfigRow_TypeDefinitionIndex = 13665;
