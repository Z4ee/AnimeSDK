...
#define RPG_GAMECORE_SETPROPABILITYTRIGGERENABLE_METHOD_3_AF8CE5AA5ACC7133_OFFSET UNITYSDK_OFFSET(0x18E3EE30)
#define RPG_GAMECORE_SETPROPABILITYTRIGGERENABLE_METHOD_3_B2E918AF9042BFE3_OFFSET UNITYSDK_OFFSET(0x18E3EEC0)
#define RPG_GAMECORE_SETPROPABILITYTRIGGERENABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E3EE90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetPropAbilityTriggerEnable_TypeDefinitionIndex = 19302;
