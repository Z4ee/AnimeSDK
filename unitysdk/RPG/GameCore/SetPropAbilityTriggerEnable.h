...
#define RPG_GAMECORE_SETPROPABILITYTRIGGERENABLE_METHOD_3_8DA76E87AFD5DFDF_OFFSET UNITYSDK_OFFSET(0x1C6059D0)
#define RPG_GAMECORE_SETPROPABILITYTRIGGERENABLE_METHOD_3_B2E918AF9042BFE3_OFFSET UNITYSDK_OFFSET(0x1C605A20)
#define RPG_GAMECORE_SETPROPABILITYTRIGGERENABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C605A10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetPropAbilityTriggerEnable_TypeDefinitionIndex = 19572;
