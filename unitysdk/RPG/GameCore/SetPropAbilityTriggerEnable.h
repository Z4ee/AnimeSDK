...
#define RPG_GAMECORE_SETPROPABILITYTRIGGERENABLE_METHOD_3_AF8CE5AA5ACC7133_OFFSET UNITYSDK_OFFSET(0x19C5BB70)
#define RPG_GAMECORE_SETPROPABILITYTRIGGERENABLE_METHOD_3_B2E918AF9042BFE3_OFFSET UNITYSDK_OFFSET(0x19C5BC00)
#define RPG_GAMECORE_SETPROPABILITYTRIGGERENABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C5BBD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetPropAbilityTriggerEnable_TypeDefinitionIndex = 19216;
