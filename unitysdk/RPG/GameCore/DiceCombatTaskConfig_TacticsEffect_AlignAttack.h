...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TACTICSEFFECT_ALIGNATTACK_METHOD_3_967E055AC9508FE5_OFFSET UNITYSDK_OFFSET(0x1C11A960)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TACTICSEFFECT_ALIGNATTACK_METHOD_3_B2E95A5A32716620_OFFSET UNITYSDK_OFFSET(0x1C11A8C0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TACTICSEFFECT_ALIGNATTACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C11A950)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_TacticsEffect_AlignAttack_TypeDefinitionIndex = 15553;
