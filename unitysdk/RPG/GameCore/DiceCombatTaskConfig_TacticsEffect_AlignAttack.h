...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TACTICSEFFECT_ALIGNATTACK_METHOD_3_1EC52B86DFBBE8EA_OFFSET UNITYSDK_OFFSET(0x196BA0B0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TACTICSEFFECT_ALIGNATTACK_METHOD_3_967E055AC9508FE5_OFFSET UNITYSDK_OFFSET(0x196B5870)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_TACTICSEFFECT_ALIGNATTACK__CTOR_OFFSET UNITYSDK_OFFSET(0x196B5820)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_TacticsEffect_AlignAttack_TypeDefinitionIndex = 15389;
