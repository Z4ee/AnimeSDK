...
#define RPG_GAMECORE_TRFCUBECOMPONENTCONFIG_METHOD_3_139CF1B3390C3910_OFFSET UNITYSDK_OFFSET(0x1B447480)
#define RPG_GAMECORE_TRFCUBECOMPONENTCONFIG_METHOD_3_C12759A364296DA0_OFFSET UNITYSDK_OFFSET(0x1B4474E0)
#define RPG_GAMECORE_TRFCUBECOMPONENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4474D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TRFCubeComponentConfig_TypeDefinitionIndex = 18163;
