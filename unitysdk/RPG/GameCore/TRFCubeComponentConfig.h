...
#define RPG_GAMECORE_TRFCUBECOMPONENTCONFIG_METHOD_3_0B8EFF26C7138B34_OFFSET UNITYSDK_OFFSET(0x177A6C50)
#define RPG_GAMECORE_TRFCUBECOMPONENTCONFIG_METHOD_3_C12759A364296DA0_OFFSET UNITYSDK_OFFSET(0x177A6CE0)
#define RPG_GAMECORE_TRFCUBECOMPONENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x177A6CC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TRFCubeComponentConfig_TypeDefinitionIndex = 17344;
