...
#define RPG_GAMECORE_TRFCUBECOMPONENTCONFIG_METHOD_3_0B8EFF26C7138B34_OFFSET UNITYSDK_OFFSET(0x18ECD210)
#define RPG_GAMECORE_TRFCUBECOMPONENTCONFIG_METHOD_3_C12759A364296DA0_OFFSET UNITYSDK_OFFSET(0x18ECD2A0)
#define RPG_GAMECORE_TRFCUBECOMPONENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18ECD280)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TRFCubeComponentConfig_TypeDefinitionIndex = 17952;
