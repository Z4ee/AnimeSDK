...
#define RPG_GAMECORE_TRAINPARTYMODIFIERADDSTATRATIOONSTOPGRIDBREAKBYMEETINGCONFIG_METHOD_3_07DDE4EE397BF860_OFFSET UNITYSDK_OFFSET(0x190AB5A0)
#define RPG_GAMECORE_TRAINPARTYMODIFIERADDSTATRATIOONSTOPGRIDBREAKBYMEETINGCONFIG_METHOD_3_4715F9976039BD24_OFFSET UNITYSDK_OFFSET(0x190AB550)
#define RPG_GAMECORE_TRAINPARTYMODIFIERADDSTATRATIOONSTOPGRIDBREAKBYMEETINGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x190AB590)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyModifierAddStatRatioOnStopGridBreakByMeetingConfig_TypeDefinitionIndex = 17207;
