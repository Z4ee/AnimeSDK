...
#define RPG_GAMECORE_TRAINPARTYMODIFIERADDSTATRATIOONSTOPGRIDBREAKBYMEETINGCONFIG_METHOD_3_07DDE4EE397BF860_OFFSET UNITYSDK_OFFSET(0x178ACB30)
#define RPG_GAMECORE_TRAINPARTYMODIFIERADDSTATRATIOONSTOPGRIDBREAKBYMEETINGCONFIG_METHOD_3_4715F9976039BD24_OFFSET UNITYSDK_OFFSET(0x178ACAE0)
#define RPG_GAMECORE_TRAINPARTYMODIFIERADDSTATRATIOONSTOPGRIDBREAKBYMEETINGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x178ACB20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyModifierAddStatRatioOnStopGridBreakByMeetingConfig_TypeDefinitionIndex = 16615;
