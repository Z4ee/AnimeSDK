...
#define RPG_GAMECORE_PINGPONGMPSKILLINFO_METHOD_2_3CBD7B338255B0B6_OFFSET UNITYSDK_OFFSET(0x19A0F090)
#define RPG_GAMECORE_PINGPONGMPSKILLINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19A0F1C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PingPongMPSkillInfo_TypeDefinitionIndex = 16121;
