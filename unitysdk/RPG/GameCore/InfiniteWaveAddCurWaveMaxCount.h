...
#define RPG_GAMECORE_INFINITEWAVEADDCURWAVEMAXCOUNT_METHOD_3_18DD54CA4C748AAB_OFFSET UNITYSDK_OFFSET(0x1B00EDA0)
#define RPG_GAMECORE_INFINITEWAVEADDCURWAVEMAXCOUNT_METHOD_3_B0AD0DDF52BD5488_OFFSET UNITYSDK_OFFSET(0x1B00ED60)
#define RPG_GAMECORE_INFINITEWAVEADDCURWAVEMAXCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B00ED90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int InfiniteWaveAddCurWaveMaxCount_TypeDefinitionIndex = 22424;
