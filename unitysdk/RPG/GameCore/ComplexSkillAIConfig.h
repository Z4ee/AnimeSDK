...
#define RPG_GAMECORE_COMPLEXSKILLAICONFIG_METHOD_2_CEAC272075CCFB0C_OFFSET UNITYSDK_OFFSET(0x1D9A7DE0)
#define RPG_GAMECORE_COMPLEXSKILLAICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D9A7FA0)
