...
#define RPG_GAMECORE_TIMEREWINDOVERRIDEHITPROTECTTIME_METHOD_3_158E99EED5EF953D_OFFSET UNITYSDK_OFFSET(0x1909C260)
#define RPG_GAMECORE_TIMEREWINDOVERRIDEHITPROTECTTIME_METHOD_3_D768DADB4CB1E67E_OFFSET UNITYSDK_OFFSET(0x1909C1E0)
#define RPG_GAMECORE_TIMEREWINDOVERRIDEHITPROTECTTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x1909C230)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TimeRewindOverrideHitProtectTime_TypeDefinitionIndex = 19614;
