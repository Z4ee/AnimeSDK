...
#define RPG_GAMECORE_TIMEREWINDOVERRIDEHITPROTECTTIME_METHOD_3_158E99EED5EF953D_OFFSET UNITYSDK_OFFSET(0x178896A0)
#define RPG_GAMECORE_TIMEREWINDOVERRIDEHITPROTECTTIME_METHOD_3_D768DADB4CB1E67E_OFFSET UNITYSDK_OFFSET(0x1789FC40)
#define RPG_GAMECORE_TIMEREWINDOVERRIDEHITPROTECTTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x17889670)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TimeRewindOverrideHitProtectTime_TypeDefinitionIndex = 18956;
