...
#define RPG_GAMECORE_BYISSTAGEBUFFAFFECTCURRENTWAVE_METHOD_4_1A499F236759CEF4_OFFSET UNITYSDK_OFFSET(0x1B2A5B90)
#define RPG_GAMECORE_BYISSTAGEBUFFAFFECTCURRENTWAVE_METHOD_4_7B843E74E1E42CCF_OFFSET UNITYSDK_OFFSET(0x1B2A5B50)
#define RPG_GAMECORE_BYISSTAGEBUFFAFFECTCURRENTWAVE_METHOD_4_87DC67097E5FE72A_OFFSET UNITYSDK_OFFSET(0x1B2A5CD0)
#define RPG_GAMECORE_BYISSTAGEBUFFAFFECTCURRENTWAVE_METHOD_4_C975984D402B587F_OFFSET UNITYSDK_OFFSET(0x1B2A5D00)
#define RPG_GAMECORE_BYISSTAGEBUFFAFFECTCURRENTWAVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2A5B80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsStageBuffAffectCurrentWave_TypeDefinitionIndex = 22679;
