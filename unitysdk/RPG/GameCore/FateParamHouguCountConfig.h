...
#define RPG_GAMECORE_FATEPARAMHOUGUCOUNTCONFIG_METHOD_6_44103E091565A6CD_OFFSET UNITYSDK_OFFSET(0x19714390)
#define RPG_GAMECORE_FATEPARAMHOUGUCOUNTCONFIG_METHOD_6_F90B5D054B868A46_OFFSET UNITYSDK_OFFSET(0x19714140)
#define RPG_GAMECORE_FATEPARAMHOUGUCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197142D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateParamHouguCountConfig_TypeDefinitionIndex = 15814;
