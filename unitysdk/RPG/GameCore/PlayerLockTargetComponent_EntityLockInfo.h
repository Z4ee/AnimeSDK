...
#define RPG_GAMECORE_PLAYERLOCKTARGETCOMPONENT_ENTITYLOCKINFO_INIT_OFFSET UNITYSDK_OFFSET(0x39D7BE0)
#define RPG_GAMECORE_PLAYERLOCKTARGETCOMPONENT_ENTITYLOCKINFO_SETSCORE_OFFSET UNITYSDK_OFFSET(0x39D7CA0)
#define RPG_GAMECORE_PLAYERLOCKTARGETCOMPONENT_ENTITYLOCKINFO_UNIONSTATE_OFFSET UNITYSDK_OFFSET(0x39D7D00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayerLockTargetComponent_EntityLockInfo_TypeDefinitionIndex = 55087;
