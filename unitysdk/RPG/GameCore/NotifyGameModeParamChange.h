...
#define RPG_GAMECORE_NOTIFYGAMEMODEPARAMCHANGE_METHOD_3_D0A12265E64E32E3_OFFSET UNITYSDK_OFFSET(0x18BBF090)
#define RPG_GAMECORE_NOTIFYGAMEMODEPARAMCHANGE_METHOD_3_DFD85B0D9CDB5912_OFFSET UNITYSDK_OFFSET(0x18BBF110)
#define RPG_GAMECORE_NOTIFYGAMEMODEPARAMCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x18BBF0E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NotifyGameModeParamChange_TypeDefinitionIndex = 22694;
