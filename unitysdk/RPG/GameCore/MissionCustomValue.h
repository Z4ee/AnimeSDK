...
#define RPG_GAMECORE_MISSIONCUSTOMVALUE_METHOD_2_A0FEA106DC66755E_OFFSET UNITYSDK_OFFSET(0x1D2A27A0)
#define RPG_GAMECORE_MISSIONCUSTOMVALUE_METHOD_2_CEBE603975403A32_OFFSET UNITYSDK_OFFSET(0x1D2A2A60)
#define RPG_GAMECORE_MISSIONCUSTOMVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2A2A50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MissionCustomValue_TypeDefinitionIndex = 18765;
	...
	public:
		...
		static ::System::Void Method_2_CEBE603975403A32(::SimpleJSON::JSONNode* a1, ::RPG::GameCore::MissionCustomValue*& a2)
		{
			return ((::System::Void(*)(::SimpleJSON::JSONNode*, ::RPG::GameCore::MissionCustomValue*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_MISSIONCUSTOMVALUE_METHOD_2_CEBE603975403A32_OFFSET))(a1, a2);
		}
	};
}
