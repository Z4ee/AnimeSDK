...
#define RPG_GAMECORE_TRAINPARTYCREATEMANIKINENTITY_METHOD_3_758EA812D4A4FDCA_OFFSET UNITYSDK_OFFSET(0x190A9920)
#define RPG_GAMECORE_TRAINPARTYCREATEMANIKINENTITY_METHOD_3_E9A5F062D89F5484_OFFSET UNITYSDK_OFFSET(0x190A99E0)
#define RPG_GAMECORE_TRAINPARTYCREATEMANIKINENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x190A9990)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyCreateManikinEntity_TypeDefinitionIndex = 21246;
