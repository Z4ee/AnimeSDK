...
#define RPG_GAMECORE_BATTLESEEKONBGM_METHOD_3_4360DF5C50B7B1C8_OFFSET UNITYSDK_OFFSET(0x1A3F8900)
#define RPG_GAMECORE_BATTLESEEKONBGM_METHOD_3_E9B88A87A5B62FB3_OFFSET UNITYSDK_OFFSET(0x1A3F8940)
#define RPG_GAMECORE_BATTLESEEKONBGM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3F8930)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleSeekOnBGM_TypeDefinitionIndex = 22141;
