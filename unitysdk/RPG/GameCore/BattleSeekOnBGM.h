...
#define RPG_GAMECORE_BATTLESEEKONBGM_METHOD_3_E0657B85652BD8BA_OFFSET UNITYSDK_OFFSET(0x16FE1A50)
#define RPG_GAMECORE_BATTLESEEKONBGM_METHOD_3_E9B88A87A5B62FB3_OFFSET UNITYSDK_OFFSET(0x16FE1AD0)
#define RPG_GAMECORE_BATTLESEEKONBGM__CTOR_OFFSET UNITYSDK_OFFSET(0x16FE1AA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleSeekOnBGM_TypeDefinitionIndex = 21173;
