...
#define RPG_GAMECORE_BATTLESEEKONBGM_METHOD_3_E0657B85652BD8BA_OFFSET UNITYSDK_OFFSET(0x18705470)
#define RPG_GAMECORE_BATTLESEEKONBGM_METHOD_3_E9B88A87A5B62FB3_OFFSET UNITYSDK_OFFSET(0x187054F0)
#define RPG_GAMECORE_BATTLESEEKONBGM__CTOR_OFFSET UNITYSDK_OFFSET(0x187054C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleSeekOnBGM_TypeDefinitionIndex = 21890;
