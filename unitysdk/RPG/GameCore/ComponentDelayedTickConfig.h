...
#define RPG_GAMECORE_COMPONENTDELAYEDTICKCONFIG_METHOD_2_E80F641A58A4771E_OFFSET UNITYSDK_OFFSET(0x1BC29970)
#define RPG_GAMECORE_COMPONENTDELAYEDTICKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC29AF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComponentDelayedTickConfig_TypeDefinitionIndex = 15918;
