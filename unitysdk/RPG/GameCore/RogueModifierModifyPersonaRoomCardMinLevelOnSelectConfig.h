...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYPERSONAROOMCARDMINLEVELONSELECTCONFIG_METHOD_3_45F7AF0215A593AC_OFFSET UNITYSDK_OFFSET(0x1EEFB040)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYPERSONAROOMCARDMINLEVELONSELECTCONFIG_METHOD_3_B6E6076868C76DB0_OFFSET UNITYSDK_OFFSET(0x1EEFAFF0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYPERSONAROOMCARDMINLEVELONSELECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEFB030)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyPersonaRoomCardMinLevelOnSelectConfig_TypeDefinitionIndex = 17638;
