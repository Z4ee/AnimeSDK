...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYPERSONAROOMCARDMINLEVELONSELECTCONFIG_METHOD_3_3264F6101C958E75_OFFSET UNITYSDK_OFFSET(0x17634E30)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYPERSONAROOMCARDMINLEVELONSELECTCONFIG_METHOD_3_45F7AF0215A593AC_OFFSET UNITYSDK_OFFSET(0x17634F00)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYPERSONAROOMCARDMINLEVELONSELECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17634EB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyPersonaRoomCardMinLevelOnSelectConfig_TypeDefinitionIndex = 16393;
