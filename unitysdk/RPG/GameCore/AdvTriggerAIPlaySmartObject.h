...
#define RPG_GAMECORE_ADVTRIGGERAIPLAYSMARTOBJECT_METHOD_3_364B466B188F3345_OFFSET UNITYSDK_OFFSET(0x16F45AD0)
#define RPG_GAMECORE_ADVTRIGGERAIPLAYSMARTOBJECT_METHOD_3_7FC0AD4D338BE97B_OFFSET UNITYSDK_OFFSET(0x16F45B50)
#define RPG_GAMECORE_ADVTRIGGERAIPLAYSMARTOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x16F45B20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvTriggerAIPlaySmartObject_TypeDefinitionIndex = 20391;
