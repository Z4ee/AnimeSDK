...
#define RPG_GAMECORE_LEVELHEALHP_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1DD28630)
#define RPG_GAMECORE_LEVELHEALHP_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x1DD285E0)
#define RPG_GAMECORE_LEVELHEALHP__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD28590)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Class_1_43BD383C98B4C0C5_130* HealDataRef; // 0x18
		::RPG::GameCore::FixPoint PreHP; // 0x20
		::RPG::GameCore::FixPoint PostHP; // 0x28
		::System::UInt32 SourceHealerID; // 0x30
		::RPG::GameCore::FixPoint HealValue; // 0x38
		::RPG::GameCore::FixPoint ActualHealValue; // 0x40
		::System::UInt32 HealerID; // 0x48
		::System::UInt32 TargetID; // 0x4C
		::RPG::GameCore::FixPoint HealPercentage; // 0x50
