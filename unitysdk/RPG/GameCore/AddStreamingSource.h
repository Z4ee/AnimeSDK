...
#define RPG_GAMECORE_ADDSTREAMINGSOURCE_METHOD_3_A8BB0D1960FB47B9_OFFSET UNITYSDK_OFFSET(0x1BE0A570)
#define RPG_GAMECORE_ADDSTREAMINGSOURCE_METHOD_3_B8A034C904CEE3C2_OFFSET UNITYSDK_OFFSET(0x1BE0A5B0)
#define RPG_GAMECORE_ADDSTREAMINGSOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE0A5A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddStreamingSource_TypeDefinitionIndex = 20443;
