...
#define RPG_GAMECORE_ADDSTREAMINGSOURCE_METHOD_3_4FBDA64BD154F7EB_OFFSET UNITYSDK_OFFSET(0x18643880)
#define RPG_GAMECORE_ADDSTREAMINGSOURCE_METHOD_3_B8A034C904CEE3C2_OFFSET UNITYSDK_OFFSET(0x18643900)
#define RPG_GAMECORE_ADDSTREAMINGSOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x186438D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddStreamingSource_TypeDefinitionIndex = 20215;
