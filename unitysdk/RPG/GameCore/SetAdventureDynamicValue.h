...
#define RPG_GAMECORE_SETADVENTUREDYNAMICVALUE_METHOD_3_47FFA5EA5A3446ED_OFFSET UNITYSDK_OFFSET(0x19C27B30)
#define RPG_GAMECORE_SETADVENTUREDYNAMICVALUE_METHOD_3_CF1DEA531996F262_OFFSET UNITYSDK_OFFSET(0x19C27AC0)
#define RPG_GAMECORE_SETADVENTUREDYNAMICVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C27B00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetAdventureDynamicValue_TypeDefinitionIndex = 20583;
