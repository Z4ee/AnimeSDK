...
#define RPG_GAMECORE_SETADVENTUREDYNAMICVALUE_METHOD_3_1564D5204FDFEFA0_OFFSET UNITYSDK_OFFSET(0x1DB521F0)
#define RPG_GAMECORE_SETADVENTUREDYNAMICVALUE_METHOD_3_47FFA5EA5A3446ED_OFFSET UNITYSDK_OFFSET(0x1DB52230)
#define RPG_GAMECORE_SETADVENTUREDYNAMICVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB52220)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetAdventureDynamicValue_TypeDefinitionIndex = 21556;
