...
#define RPG_GAMECORE_LEVELSETACTIVESKILL_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1BE03450)
#define RPG_GAMECORE_LEVELSETACTIVESKILL_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x1BE03400)
#define RPG_GAMECORE_LEVELSETACTIVESKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE034A0)
