...
#define RPG_GAMECORE_LEVELSETACTIVESKILL_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xA991210)
#define RPG_GAMECORE_LEVELSETACTIVESKILL_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xA9911C0)
#define RPG_GAMECORE_LEVELSETACTIVESKILL__CTOR_OFFSET UNITYSDK_OFFSET(0xA991260)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelSetActiveSkill_TypeDefinitionIndex = 45736;
