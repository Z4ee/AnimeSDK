...
#define RPG_GAMECORE_ROGUEMAGICSCOREROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x176153F0)
#define RPG_GAMECORE_ROGUEMAGICSCOREROW__CTOR_OFFSET UNITYSDK_OFFSET(0x176155A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueMagicScoreRow_TypeDefinitionIndex = 13607;
