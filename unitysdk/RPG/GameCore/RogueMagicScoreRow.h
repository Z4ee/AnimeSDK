...
#define RPG_GAMECORE_ROGUEMAGICSCOREROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19B46960)
#define RPG_GAMECORE_ROGUEMAGICSCOREROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19B46B10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueMagicScoreRow_TypeDefinitionIndex = 14143;
