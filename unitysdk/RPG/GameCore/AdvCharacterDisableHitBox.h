...
#define RPG_GAMECORE_ADVCHARACTERDISABLEHITBOX_METHOD_3_B3410652FC62197B_OFFSET UNITYSDK_OFFSET(0x1864A7B0)
#define RPG_GAMECORE_ADVCHARACTERDISABLEHITBOX_METHOD_3_BD7379288E8CF236_OFFSET UNITYSDK_OFFSET(0x1864A730)
#define RPG_GAMECORE_ADVCHARACTERDISABLEHITBOX__CTOR_OFFSET UNITYSDK_OFFSET(0x1864A780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvCharacterDisableHitBox_TypeDefinitionIndex = 21280;
