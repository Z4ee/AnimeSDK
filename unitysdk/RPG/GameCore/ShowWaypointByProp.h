...
#define RPG_GAMECORE_SHOWWAYPOINTBYPROP_METHOD_3_6B6F417A21602FC7_OFFSET UNITYSDK_OFFSET(0x17707B60)
#define RPG_GAMECORE_SHOWWAYPOINTBYPROP_METHOD_3_F62CCBBED8F88C0C_OFFSET UNITYSDK_OFFSET(0x17707C20)
#define RPG_GAMECORE_SHOWWAYPOINTBYPROP__CTOR_OFFSET UNITYSDK_OFFSET(0x17707BD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowWaypointByProp_TypeDefinitionIndex = 19200;
	...
	public:
		...
		static ::System::Void Method_3_6B6F417A21602FC7(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::ShowWaypointByProp*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::ShowWaypointByProp*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_SHOWWAYPOINTBYPROP_METHOD_3_6B6F417A21602FC7_OFFSET))(a1, a2);
		}
