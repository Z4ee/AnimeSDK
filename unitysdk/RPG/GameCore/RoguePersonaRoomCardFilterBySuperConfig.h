...
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYSUPERCONFIG_METHOD_3_1B5F6E4F93CD6AF2_OFFSET UNITYSDK_OFFSET(0x19BB9CF0)
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYSUPERCONFIG_METHOD_3_35E1F7A603BCF516_OFFSET UNITYSDK_OFFSET(0x19BB9FC0)
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYSUPERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19BB9CE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RoguePersonaRoomCardFilterBySuperConfig_TypeDefinitionIndex = 18830;
