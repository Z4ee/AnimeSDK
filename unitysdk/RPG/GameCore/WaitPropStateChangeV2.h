...
#define RPG_GAMECORE_WAITPROPSTATECHANGEV2_METHOD_4_74AD34358240AA05_OFFSET UNITYSDK_OFFSET(0x19105EA0)
#define RPG_GAMECORE_WAITPROPSTATECHANGEV2_METHOD_4_EBC9FED13848E32B_OFFSET UNITYSDK_OFFSET(0x19105F80)
#define RPG_GAMECORE_WAITPROPSTATECHANGEV2__CTOR_OFFSET UNITYSDK_OFFSET(0x19105F20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitPropStateChangeV2_TypeDefinitionIndex = 19721;
