...
#define RPG_GAMECORE_ROGUEDLC1DOT3COMPASSPROCESS_METHOD_3_6C64FEF75C2AC079_OFFSET UNITYSDK_OFFSET(0x175EFDF0)
#define RPG_GAMECORE_ROGUEDLC1DOT3COMPASSPROCESS_METHOD_3_96842305E1FD7480_OFFSET UNITYSDK_OFFSET(0x175EFD70)
#define RPG_GAMECORE_ROGUEDLC1DOT3COMPASSPROCESS__CTOR_OFFSET UNITYSDK_OFFSET(0x175EFDC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueDLC1Dot3CompassProcess_TypeDefinitionIndex = 20475;
