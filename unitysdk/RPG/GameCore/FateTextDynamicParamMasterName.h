...
#define RPG_GAMECORE_FATETEXTDYNAMICPARAMMASTERNAME_METHOD_3_528DA7711A744165_OFFSET UNITYSDK_OFFSET(0x1D0910B0)
#define RPG_GAMECORE_FATETEXTDYNAMICPARAMMASTERNAME_METHOD_3_F3341C9F5049A199_OFFSET UNITYSDK_OFFSET(0x1D0911D0)
#define RPG_GAMECORE_FATETEXTDYNAMICPARAMMASTERNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0911C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateTextDynamicParamMasterName_TypeDefinitionIndex = 16471;
