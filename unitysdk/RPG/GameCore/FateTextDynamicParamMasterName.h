...
#define RPG_GAMECORE_FATETEXTDYNAMICPARAMMASTERNAME_METHOD_3_2E9D706E0F0326C0_OFFSET UNITYSDK_OFFSET(0x188DB740)
#define RPG_GAMECORE_FATETEXTDYNAMICPARAMMASTERNAME_METHOD_3_F86B53A3F63AA550_OFFSET UNITYSDK_OFFSET(0x188DB7A0)
#define RPG_GAMECORE_FATETEXTDYNAMICPARAMMASTERNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x188DB790)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateTextDynamicParamMasterName_TypeDefinitionIndex = 15766;
