...
#define RPG_GAMECORE_FATETEXTDYNAMICPARAMMASTERNAME_METHOD_3_2E9D706E0F0326C0_OFFSET UNITYSDK_OFFSET(0x171CDF70)
#define RPG_GAMECORE_FATETEXTDYNAMICPARAMMASTERNAME_METHOD_3_F86B53A3F63AA550_OFFSET UNITYSDK_OFFSET(0x171CDFD0)
#define RPG_GAMECORE_FATETEXTDYNAMICPARAMMASTERNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x171CDFC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateTextDynamicParamMasterName_TypeDefinitionIndex = 15252;
