...
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTCONFIG_METHOD_6_10A4671C3294B5DE_OFFSET UNITYSDK_OFFSET(0x19AF3580)
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTCONFIG_METHOD_6_AC5B0A197D63E147_OFFSET UNITYSDK_OFFSET(0x19AF1860)
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AF1320)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaSelectRoomCardCastConfig_TypeDefinitionIndex = 18683;
