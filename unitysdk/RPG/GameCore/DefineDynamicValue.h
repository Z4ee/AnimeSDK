...
#define RPG_GAMECORE_DEFINEDYNAMICVALUE_METHOD_3_34BE8C2EDB6D677C_OFFSET UNITYSDK_OFFSET(0x17151AE0)
#define RPG_GAMECORE_DEFINEDYNAMICVALUE_METHOD_3_A70544D91D0A6910_OFFSET UNITYSDK_OFFSET(0x17151C00)
#define RPG_GAMECORE_DEFINEDYNAMICVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x17151B80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DefineDynamicValue_TypeDefinitionIndex = 21095;
