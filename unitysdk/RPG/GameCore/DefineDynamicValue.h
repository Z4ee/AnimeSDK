...
#define RPG_GAMECORE_DEFINEDYNAMICVALUE_METHOD_3_0925065E29B8E8D5_OFFSET UNITYSDK_OFFSET(0x1C101B20)
#define RPG_GAMECORE_DEFINEDYNAMICVALUE_METHOD_3_F76DD8BC165DC97E_OFFSET UNITYSDK_OFFSET(0x1C101A20)
#define RPG_GAMECORE_DEFINEDYNAMICVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C101AB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DefineDynamicValue_TypeDefinitionIndex = 22075;
