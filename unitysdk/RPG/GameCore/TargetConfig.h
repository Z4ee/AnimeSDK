...
#define RPG_GAMECORE_TARGETCONFIG_METHOD_2_2CCA2840C181AA33_OFFSET UNITYSDK_OFFSET(0x177AD5B0)
#define RPG_GAMECORE_TARGETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x177AD750)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetConfig_TypeDefinitionIndex = 14337;
