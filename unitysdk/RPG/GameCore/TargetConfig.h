...
#define RPG_GAMECORE_TARGETCONFIG_METHOD_2_2CCA2840C181AA33_OFFSET UNITYSDK_OFFSET(0x1B44DCB0)
#define RPG_GAMECORE_TARGETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B44DE50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetConfig_TypeDefinitionIndex = 15033;
