...
#define RPG_GAMECORE_CHENLINGFESBUFF_METHOD_2_4C48E304A81978F6_OFFSET UNITYSDK_OFFSET(0x1C383820)
#define RPG_GAMECORE_CHENLINGFESBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x1C383A40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingFesBuff_TypeDefinitionIndex = 17715;
