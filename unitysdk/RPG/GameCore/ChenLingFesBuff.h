...
#define RPG_GAMECORE_CHENLINGFESBUFF_METHOD_2_4C48E304A81978F6_OFFSET UNITYSDK_OFFSET(0x196293D0)
#define RPG_GAMECORE_CHENLINGFESBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x196295F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingFesBuff_TypeDefinitionIndex = 17542;
