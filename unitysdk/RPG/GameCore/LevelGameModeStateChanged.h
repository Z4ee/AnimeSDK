...
#define RPG_GAMECORE_LEVELGAMEMODESTATECHANGED_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xB6D8DA0)
#define RPG_GAMECORE_LEVELGAMEMODESTATECHANGED_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xB6D8D50)
#define RPG_GAMECORE_LEVELGAMEMODESTATECHANGED_INIT_OFFSET UNITYSDK_OFFSET(0xB6D8D00)
#define RPG_GAMECORE_LEVELGAMEMODESTATECHANGED__CTOR_OFFSET UNITYSDK_OFFSET(0xB6D8DF0)
