...
#define RPG_GAMECORE_SHOWALLEYTRANSPORTENERGYHINT_METHOD_3_6EB9BA363F06A9C1_OFFSET UNITYSDK_OFFSET(0x19C73D20)
#define RPG_GAMECORE_SHOWALLEYTRANSPORTENERGYHINT_METHOD_3_A1222DB2B8255E28_OFFSET UNITYSDK_OFFSET(0x19C73DA0)
#define RPG_GAMECORE_SHOWALLEYTRANSPORTENERGYHINT__CTOR_OFFSET UNITYSDK_OFFSET(0x19C73D70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowAlleyTransportEnergyHint_TypeDefinitionIndex = 22967;
