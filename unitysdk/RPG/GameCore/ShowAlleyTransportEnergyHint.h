...
#define RPG_GAMECORE_SHOWALLEYTRANSPORTENERGYHINT_METHOD_3_6EB9BA363F06A9C1_OFFSET UNITYSDK_OFFSET(0x176F40A0)
#define RPG_GAMECORE_SHOWALLEYTRANSPORTENERGYHINT_METHOD_3_A1222DB2B8255E28_OFFSET UNITYSDK_OFFSET(0x176F4120)
#define RPG_GAMECORE_SHOWALLEYTRANSPORTENERGYHINT__CTOR_OFFSET UNITYSDK_OFFSET(0x176F40F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowAlleyTransportEnergyHint_TypeDefinitionIndex = 22333;
