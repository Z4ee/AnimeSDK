...
#define RPG_GAMECORE_REMOVESELFMODIFIER_METHOD_3_28C656195331A15C_OFFSET UNITYSDK_OFFSET(0x17599850)
#define RPG_GAMECORE_REMOVESELFMODIFIER_METHOD_3_E5B1454E9F2BCF10_OFFSET UNITYSDK_OFFSET(0x17599740)
#define RPG_GAMECORE_REMOVESELFMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x17599820)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveSelfModifier_TypeDefinitionIndex = 21713;
