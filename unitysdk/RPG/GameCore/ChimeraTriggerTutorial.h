...
#define RPG_GAMECORE_CHIMERATRIGGERTUTORIAL_METHOD_3_271792A63F45B6E7_OFFSET UNITYSDK_OFFSET(0x1C24E460)
#define RPG_GAMECORE_CHIMERATRIGGERTUTORIAL_METHOD_3_CEA240D572DE4EC5_OFFSET UNITYSDK_OFFSET(0x1C24E4C0)
#define RPG_GAMECORE_CHIMERATRIGGERTUTORIAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C24E4B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraTriggerTutorial_TypeDefinitionIndex = 15267;
