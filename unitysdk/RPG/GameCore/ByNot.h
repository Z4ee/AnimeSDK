...
#define RPG_GAMECORE_BYNOT_METHOD_4_21ECF94F5F385685_OFFSET UNITYSDK_OFFSET(0x1B2AFF40)
#define RPG_GAMECORE_BYNOT_METHOD_4_40868C0950B70332_OFFSET UNITYSDK_OFFSET(0x1B2AFF10)
#define RPG_GAMECORE_BYNOT_METHOD_4_9220BC9B4E7BDED7_OFFSET UNITYSDK_OFFSET(0x1B2AFD50)
#define RPG_GAMECORE_BYNOT_METHOD_4_EC5222F00B443866_OFFSET UNITYSDK_OFFSET(0x1B2AFD90)
#define RPG_GAMECORE_BYNOT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2AFD80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByNot_TypeDefinitionIndex = 22943;
