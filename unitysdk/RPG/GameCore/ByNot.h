...
#define RPG_GAMECORE_BYNOT_METHOD_4_33438B6CF26C3CB8_OFFSET UNITYSDK_OFFSET(0x170370E0)
#define RPG_GAMECORE_BYNOT_METHOD_4_EC5222F00B443866_OFFSET UNITYSDK_OFFSET(0x170371B0)
#define RPG_GAMECORE_BYNOT__CTOR_OFFSET UNITYSDK_OFFSET(0x17037160)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByNot_TypeDefinitionIndex = 22070;
