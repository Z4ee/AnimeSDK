...
#define RPG_GAMECORE_MATCHTHREEROBOTINFOROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18AC2FF0)
#define RPG_GAMECORE_MATCHTHREEROBOTINFOROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18AC3200)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MatchThreeRobotInfoRow_TypeDefinitionIndex = 11360;
