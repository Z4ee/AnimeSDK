...
#define RPG_GAMECORE_ACTIVEVIRTUALCAMERA_METHOD_3_68DE2B2E790B38E5_OFFSET UNITYSDK_OFFSET(0x18602010)
#define RPG_GAMECORE_ACTIVEVIRTUALCAMERA_METHOD_3_A5678D081AE08358_OFFSET UNITYSDK_OFFSET(0x18602B30)
#define RPG_GAMECORE_ACTIVEVIRTUALCAMERA_METHOD_3_C22DDB0159E33BD3_OFFSET UNITYSDK_OFFSET(0x18601E40)
#define RPG_GAMECORE_ACTIVEVIRTUALCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x18601010)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActiveVirtualCamera_TypeDefinitionIndex = 19819;
