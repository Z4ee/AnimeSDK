...
#define RPG_GAMECORE_SETDYNAMICVALUEBYSCORINGID_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1C5F0D80)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSCORINGID_METHOD_4_1CAAED88B50660F7_OFFSET UNITYSDK_OFFSET(0x1C5F0BB0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSCORINGID_METHOD_4_BE82365B5C36EDAA_OFFSET UNITYSDK_OFFSET(0x1C5F0B70)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSCORINGID__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5F0BA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByScoringID_TypeDefinitionIndex = 22264;
