...
#define RPG_GAMECORE_SETDYNAMICVALUEBYSCORINGID_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x18E27BB0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSCORINGID_METHOD_4_1CAAED88B50660F7_OFFSET UNITYSDK_OFFSET(0x18E279E0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSCORINGID_METHOD_4_1FF5429ACCD5AEAF_OFFSET UNITYSDK_OFFSET(0x18E27910)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSCORINGID__CTOR_OFFSET UNITYSDK_OFFSET(0x18E27990)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByScoringID_TypeDefinitionIndex = 22028;
