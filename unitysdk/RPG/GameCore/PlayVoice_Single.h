...
#define RPG_GAMECORE_PLAYVOICE_SINGLE_METHOD_3_0D2B2CEA9322F353_OFFSET UNITYSDK_OFFSET(0x1D7AA190)
#define RPG_GAMECORE_PLAYVOICE_SINGLE_METHOD_3_5030FABB95576A80_OFFSET UNITYSDK_OFFSET(0x1D7AA1D0)
#define RPG_GAMECORE_PLAYVOICE_SINGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7AA1C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayVoice_Single_TypeDefinitionIndex = 20379;
