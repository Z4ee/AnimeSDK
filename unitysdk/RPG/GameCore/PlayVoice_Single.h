...
#define RPG_GAMECORE_PLAYVOICE_SINGLE_METHOD_3_5030FABB95576A80_OFFSET UNITYSDK_OFFSET(0x174C89B0)
#define RPG_GAMECORE_PLAYVOICE_SINGLE_METHOD_3_BE96E35661FB5D10_OFFSET UNITYSDK_OFFSET(0x174C8930)
#define RPG_GAMECORE_PLAYVOICE_SINGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x174C8980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayVoice_Single_TypeDefinitionIndex = 18928;
