...
#define RPG_GAMECORE_SETDAWNSEYEWEATHERUI_METHOD_3_0744C6A968A6CF90_OFFSET UNITYSDK_OFFSET(0x18E14440)
#define RPG_GAMECORE_SETDAWNSEYEWEATHERUI_METHOD_3_0E824203D360CF49_OFFSET UNITYSDK_OFFSET(0x18E143C0)
#define RPG_GAMECORE_SETDAWNSEYEWEATHERUI__CTOR_OFFSET UNITYSDK_OFFSET(0x18E14410)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDawnsEyeWeatherUI_TypeDefinitionIndex = 21700;
