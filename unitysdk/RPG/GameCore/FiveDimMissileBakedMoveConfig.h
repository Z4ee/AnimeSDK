...
#define RPG_GAMECORE_FIVEDIMMISSILEBAKEDMOVECONFIG_METHOD_3_0F55787485EC540A_OFFSET UNITYSDK_OFFSET(0x1BEA1B40)
#define RPG_GAMECORE_FIVEDIMMISSILEBAKEDMOVECONFIG_METHOD_3_91DD2970D2483A53_OFFSET UNITYSDK_OFFSET(0x1BEA1B80)
#define RPG_GAMECORE_FIVEDIMMISSILEBAKEDMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEA1B70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimMissileBakedMoveConfig_TypeDefinitionIndex = 16030;
