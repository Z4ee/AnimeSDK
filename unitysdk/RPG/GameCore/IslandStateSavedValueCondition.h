...
#define RPG_GAMECORE_ISLANDSTATESAVEDVALUECONDITION_METHOD_2_062FF7EBE42549AF_OFFSET UNITYSDK_OFFSET(0x1B015F70)
#define RPG_GAMECORE_ISLANDSTATESAVEDVALUECONDITION_METHOD_2_BE6DC69CD1B3AB80_OFFSET UNITYSDK_OFFSET(0x1B016120)
#define RPG_GAMECORE_ISLANDSTATESAVEDVALUECONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B016110)

namespace RPG::GameCore
{
	inline static constexpr unsigned int IslandStateSavedValueCondition_TypeDefinitionIndex = 18384;
