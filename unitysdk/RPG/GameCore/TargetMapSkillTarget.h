...
#define RPG_GAMECORE_TARGETMAPSKILLTARGET_METHOD_3_1C7DD83CF5861EDC_OFFSET UNITYSDK_OFFSET(0x18EE97A0)
#define RPG_GAMECORE_TARGETMAPSKILLTARGET_METHOD_3_D968C77241804C90_OFFSET UNITYSDK_OFFSET(0x18EE9690)
#define RPG_GAMECORE_TARGETMAPSKILLTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x18EE9780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapSkillTarget_TypeDefinitionIndex = 23014;
