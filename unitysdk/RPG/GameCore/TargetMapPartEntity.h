...
#define RPG_GAMECORE_TARGETMAPPARTENTITY_METHOD_3_4BD36B6B85FE0207_OFFSET UNITYSDK_OFFSET(0x1D5B4140)
#define RPG_GAMECORE_TARGETMAPPARTENTITY_METHOD_3_4DE7525F6B61A102_OFFSET UNITYSDK_OFFSET(0x1D5B4210)
#define RPG_GAMECORE_TARGETMAPPARTENTITY_METHOD_3_8729121DA2CD857C_OFFSET UNITYSDK_OFFSET(0x1D5B42F0)
#define RPG_GAMECORE_TARGETMAPPARTENTITY_METHOD_3_C097B59EEFDA0125_OFFSET UNITYSDK_OFFSET(0x1D5B42C0)
#define RPG_GAMECORE_TARGETMAPPARTENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5B4200)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapPartEntity_TypeDefinitionIndex = 23749;
