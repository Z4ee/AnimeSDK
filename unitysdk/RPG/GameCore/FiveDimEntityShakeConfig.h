...
#define RPG_GAMECORE_FIVEDIMENTITYSHAKECONFIG_METHOD_2_00D00ACC9DA8B1A7_OFFSET UNITYSDK_OFFSET(0x1D8593E0)
#define RPG_GAMECORE_FIVEDIMENTITYSHAKECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D85BED0)
