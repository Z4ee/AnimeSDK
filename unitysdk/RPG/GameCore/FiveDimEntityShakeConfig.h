...
#define RPG_GAMECORE_FIVEDIMENTITYSHAKECONFIG_METHOD_2_00D00ACC9DA8B1A7_OFFSET UNITYSDK_OFFSET(0x1D0E0950)
#define RPG_GAMECORE_FIVEDIMENTITYSHAKECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0E3440)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimEntityShakeConfig_TypeDefinitionIndex = 18539;
