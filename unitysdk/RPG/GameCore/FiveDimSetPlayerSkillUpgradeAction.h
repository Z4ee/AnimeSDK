...
#define RPG_GAMECORE_FIVEDIMSETPLAYERSKILLUPGRADEACTION_METHOD_3_A437919812A0D8A8_OFFSET UNITYSDK_OFFSET(0x1BEB15A0)
#define RPG_GAMECORE_FIVEDIMSETPLAYERSKILLUPGRADEACTION_METHOD_3_E5E40830D9662125_OFFSET UNITYSDK_OFFSET(0x1BEB1680)
#define RPG_GAMECORE_FIVEDIMSETPLAYERSKILLUPGRADEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEB1670)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSetPlayerSkillUpgradeAction_TypeDefinitionIndex = 18020;
