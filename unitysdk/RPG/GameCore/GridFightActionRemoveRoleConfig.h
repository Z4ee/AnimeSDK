...
#define RPG_GAMECORE_GRIDFIGHTACTIONREMOVEROLECONFIG_METHOD_6_3DCAAB01FB367C85_OFFSET UNITYSDK_OFFSET(0x197D8900)
#define RPG_GAMECORE_GRIDFIGHTACTIONREMOVEROLECONFIG_METHOD_6_4FF21F4FF0228716_OFFSET UNITYSDK_OFFSET(0x197D7E00)
#define RPG_GAMECORE_GRIDFIGHTACTIONREMOVEROLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197D7D60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightActionRemoveRoleConfig_TypeDefinitionIndex = 18320;
