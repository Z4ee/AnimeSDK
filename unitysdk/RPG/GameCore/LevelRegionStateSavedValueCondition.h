...
#define RPG_GAMECORE_LEVELREGIONSTATESAVEDVALUECONDITION_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1C130B70)
#define RPG_GAMECORE_LEVELREGIONSTATESAVEDVALUECONDITION_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C130FB0)
#define RPG_GAMECORE_LEVELREGIONSTATESAVEDVALUECONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C130B60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelRegionStateSavedValueCondition_TypeDefinitionIndex = 17187;
