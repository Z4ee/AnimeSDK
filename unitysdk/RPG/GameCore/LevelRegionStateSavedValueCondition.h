...
#define RPG_GAMECORE_LEVELREGIONSTATESAVEDVALUECONDITION_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1B088320)
#define RPG_GAMECORE_LEVELREGIONSTATESAVEDVALUECONDITION_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B088760)
#define RPG_GAMECORE_LEVELREGIONSTATESAVEDVALUECONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B088310)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelRegionStateSavedValueCondition_TypeDefinitionIndex = 16685;
