...
#define RPG_GAMECORE_BYRANDOMCHANCE_METHOD_4_06FF06254573283E_OFFSET UNITYSDK_OFFSET(0x1CF59740)
#define RPG_GAMECORE_BYRANDOMCHANCE_METHOD_4_311DA5452D9B8447_OFFSET UNITYSDK_OFFSET(0x1CF59520)
#define RPG_GAMECORE_BYRANDOMCHANCE_METHOD_4_AADBC542D5AF7E01_OFFSET UNITYSDK_OFFSET(0x1CF59770)
#define RPG_GAMECORE_BYRANDOMCHANCE_METHOD_4_F3DEF6BA0C7ADF0E_OFFSET UNITYSDK_OFFSET(0x1CF59560)
#define RPG_GAMECORE_BYRANDOMCHANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF59550)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByRandomChance_TypeDefinitionIndex = 22731;
