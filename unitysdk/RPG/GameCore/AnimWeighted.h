...
#define RPG_GAMECORE_ANIMWEIGHTED_METHOD_2_17FAAD58C0CC0EAA_OFFSET UNITYSDK_OFFSET(0x16F822D0)
#define RPG_GAMECORE_ANIMWEIGHTED__CTOR_OFFSET UNITYSDK_OFFSET(0x16F82470)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AnimWeighted_TypeDefinitionIndex = 14901;
