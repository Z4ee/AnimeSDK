...
#define RPG_GAMECORE_ROGUEADVROOMCANDYCRASHPROPEVENT_METHOD_3_1DF835CD75F8B5C1_OFFSET UNITYSDK_OFFSET(0x175DBC20)
#define RPG_GAMECORE_ROGUEADVROOMCANDYCRASHPROPEVENT_METHOD_3_8F3D8E7353489532_OFFSET UNITYSDK_OFFSET(0x175DBBA0)
#define RPG_GAMECORE_ROGUEADVROOMCANDYCRASHPROPEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x175DBBF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueAdvRoomCandyCrashPropEvent_TypeDefinitionIndex = 20478;
