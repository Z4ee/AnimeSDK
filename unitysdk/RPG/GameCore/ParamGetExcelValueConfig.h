...
#define RPG_GAMECORE_PARAMGETEXCELVALUECONFIG_METHOD_4_B3D8AEBECF0CC29E_OFFSET UNITYSDK_OFFSET(0x18BD3FA0)
#define RPG_GAMECORE_PARAMGETEXCELVALUECONFIG_METHOD_4_E31010E82FA3A0EC_OFFSET UNITYSDK_OFFSET(0x18BD3E60)
#define RPG_GAMECORE_PARAMGETEXCELVALUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18BD3F20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ParamGetExcelValueConfig_TypeDefinitionIndex = 16176;
