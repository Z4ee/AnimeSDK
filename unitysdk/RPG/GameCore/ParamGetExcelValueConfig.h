...
#define RPG_GAMECORE_PARAMGETEXCELVALUECONFIG_METHOD_4_B3D8AEBECF0CC29E_OFFSET UNITYSDK_OFFSET(0x17489A80)
#define RPG_GAMECORE_PARAMGETEXCELVALUECONFIG_METHOD_4_E31010E82FA3A0EC_OFFSET UNITYSDK_OFFSET(0x17489940)
#define RPG_GAMECORE_PARAMGETEXCELVALUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17489A00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ParamGetExcelValueConfig_TypeDefinitionIndex = 15654;
