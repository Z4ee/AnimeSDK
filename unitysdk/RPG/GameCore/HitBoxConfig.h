...
#define RPG_GAMECORE_HITBOXCONFIG_METHOD_2_A1ACCA43DC9C20FC_OFFSET UNITYSDK_OFFSET(0x1D194620)
#define RPG_GAMECORE_HITBOXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D194860)
