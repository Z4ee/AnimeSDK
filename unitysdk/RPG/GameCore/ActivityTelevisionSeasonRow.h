...
#define RPG_GAMECORE_ACTIVITYTELEVISIONSEASONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CDADDB0)
#define RPG_GAMECORE_ACTIVITYTELEVISIONSEASONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDAE070)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityTelevisionSeasonRow_TypeDefinitionIndex = 12416;
	...
	public:
		...
		::System::UInt32 FirstMainMissionID; // 0x28
		::System::UInt32 LastStage; // 0x2C
		::System::UInt32 LastStageQuest; // 0x30
		::System::UInt32 Season; // 0x34
		::System::UInt32 LevelMessageSubmission; // 0x38
