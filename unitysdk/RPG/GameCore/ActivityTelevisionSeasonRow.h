...
#define RPG_GAMECORE_ACTIVITYTELEVISIONSEASONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1AB11D10)
#define RPG_GAMECORE_ACTIVITYTELEVISIONSEASONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB11FD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityTelevisionSeasonRow_TypeDefinitionIndex = 12027;
