...
#define RPG_GAMECORE_ACTIVITYTELEVISIONSEASONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D69C4A0)
#define RPG_GAMECORE_ACTIVITYTELEVISIONSEASONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D69C760)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* BuffLevelDefaultBackgroundPath; // 0x18
		::Il2CppArray<::System::String*>* BuffLevelIconPathList; // 0x20
		::System::UInt32 LevelMessageSubmission; // 0x28
		::System::UInt32 FirstMainMissionID; // 0x2C
		::System::UInt32 LastStage; // 0x30
