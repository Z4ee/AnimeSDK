...
#define RPG_GAMECORE_TURNBASEDMODIFIERCALLBACKPRIORITY_METHOD_2_7B92CA125B902AE2_OFFSET UNITYSDK_OFFSET(0x1B064440)
#define RPG_GAMECORE_TURNBASEDMODIFIERCALLBACKPRIORITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0645E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TurnBasedModifierCallbackPriority_TypeDefinitionIndex = 17505;
