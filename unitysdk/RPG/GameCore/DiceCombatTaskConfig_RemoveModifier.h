...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_REMOVEMODIFIER_METHOD_3_B1F4071340E9592F_OFFSET UNITYSDK_OFFSET(0x18878530)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_REMOVEMODIFIER_METHOD_3_ECCF2F50A5E8DF45_OFFSET UNITYSDK_OFFSET(0x1887CCA0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_REMOVEMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x188784E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_RemoveModifier_TypeDefinitionIndex = 15229;
