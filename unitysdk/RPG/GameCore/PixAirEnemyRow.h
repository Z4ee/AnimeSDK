...
#define RPG_GAMECORE_PIXAIRENEMYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D334D20)
#define RPG_GAMECORE_PIXAIRENEMYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D334FB0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 CoinLoot; // 0x20
		::System::UInt32 DisplayID; // 0x24
		::System::UInt32 EnemyID; // 0x28
		::RPG::GameCore::FixPoint HP; // 0x30
