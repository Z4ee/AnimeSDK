...
#define RPG_GAMECORE_SERVERPREFSCONFIG_METHOD_2_9ED0344226182869_OFFSET UNITYSDK_OFFSET(0x19C258A0)
#define RPG_GAMECORE_SERVERPREFSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19C25980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ServerPrefsConfig_TypeDefinitionIndex = 23086;
