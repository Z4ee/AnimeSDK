...
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEBUFFSELECTBYAEONCONFIG_METHOD_6_799B27028DB0EF3D_OFFSET UNITYSDK_OFFSET(0x18CD6B20)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEBUFFSELECTBYAEONCONFIG_METHOD_6_9F2511215D004F60_OFFSET UNITYSDK_OFFSET(0x18CD6900)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEBUFFSELECTBYAEONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CD6A40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActTriggerRogueBuffSelectByAeonConfig_TypeDefinitionIndex = 18649;
