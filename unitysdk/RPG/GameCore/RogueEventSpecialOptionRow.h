...
#define RPG_GAMECORE_ROGUEEVENTSPECIALOPTIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D9324C0)
#define RPG_GAMECORE_ROGUEEVENTSPECIALOPTIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D932A80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueEventSpecialOptionRow_TypeDefinitionIndex = 14651;
