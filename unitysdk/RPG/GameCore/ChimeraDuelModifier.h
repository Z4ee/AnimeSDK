...
#define RPG_GAMECORE_CHIMERADUELMODIFIER_METHOD_2_5A8E4D36BC12F5F5_OFFSET UNITYSDK_OFFSET(0x1CFCA3E0)
#define RPG_GAMECORE_CHIMERADUELMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFCA540)
