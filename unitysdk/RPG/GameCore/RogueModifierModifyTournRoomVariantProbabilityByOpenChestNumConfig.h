...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYTOURNROOMVARIANTPROBABILITYBYOPENCHESTNUMCONFIG_METHOD_3_48E3A1B6A1DC6B96_OFFSET UNITYSDK_OFFSET(0x18D432E0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYTOURNROOMVARIANTPROBABILITYBYOPENCHESTNUMCONFIG_METHOD_3_6322FE975E015ACF_OFFSET UNITYSDK_OFFSET(0x18D433B0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYTOURNROOMVARIANTPROBABILITYBYOPENCHESTNUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D43360)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyTournRoomVariantProbabilityByOpenChestNumConfig_TypeDefinitionIndex = 16884;
