...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYTOURNROOMVARIANTPROBABILITYBYOPENCHESTNUMCONFIG_METHOD_3_48E3A1B6A1DC6B96_OFFSET UNITYSDK_OFFSET(0x19B992C0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYTOURNROOMVARIANTPROBABILITYBYOPENCHESTNUMCONFIG_METHOD_3_6322FE975E015ACF_OFFSET UNITYSDK_OFFSET(0x19B99390)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYTOURNROOMVARIANTPROBABILITYBYOPENCHESTNUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B99340)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyTournRoomVariantProbabilityByOpenChestNumConfig_TypeDefinitionIndex = 16899;
