...
#define RPG_GAMECORE_CHARACTERREPLACEMATERIALPARTSHOW_METHOD_2_B2EEAA36569AEC52_OFFSET UNITYSDK_OFFSET(0x1B72A430)
#define RPG_GAMECORE_CHARACTERREPLACEMATERIALPARTSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B72A600)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterReplaceMaterialPartShow_TypeDefinitionIndex = 16740;
