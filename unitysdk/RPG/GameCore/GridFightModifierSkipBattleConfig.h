...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSKIPBATTLECONFIG_METHOD_3_61D80A48351BD7E6_OFFSET UNITYSDK_OFFSET(0x197F43F0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSKIPBATTLECONFIG_METHOD_3_EE3210C5FBA95C5F_OFFSET UNITYSDK_OFFSET(0x197F44C0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSKIPBATTLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197F4470)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierSkipBattleConfig_TypeDefinitionIndex = 18482;
