...
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTAPPENDATTRIBUTECONFIG_METHOD_7_762F727E3FEF927D_OFFSET UNITYSDK_OFFSET(0x18CCD140)
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTAPPENDATTRIBUTECONFIG_METHOD_7_A0F253921FF4D1A0_OFFSET UNITYSDK_OFFSET(0x18CCCF20)
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTAPPENDATTRIBUTECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CCD060)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaSelectRoomCardCastAppendAttributeConfig_TypeDefinitionIndex = 18720;
