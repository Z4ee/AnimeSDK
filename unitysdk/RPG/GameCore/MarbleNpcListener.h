...
#define RPG_GAMECORE_MARBLENPCLISTENER_METHOD_3_1DED02AA4BBEF85B_OFFSET UNITYSDK_OFFSET(0x1D238100)
#define RPG_GAMECORE_MARBLENPCLISTENER_METHOD_3_C0161FB08F369E10_OFFSET UNITYSDK_OFFSET(0x1D238140)
#define RPG_GAMECORE_MARBLENPCLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D238130)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleNpcListener_TypeDefinitionIndex = 21795;
