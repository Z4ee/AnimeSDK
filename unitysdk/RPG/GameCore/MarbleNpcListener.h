...
#define RPG_GAMECORE_MARBLENPCLISTENER_METHOD_3_1E7E0F2FF1479E0B_OFFSET UNITYSDK_OFFSET(0x17393420)
#define RPG_GAMECORE_MARBLENPCLISTENER_METHOD_3_F1D60CDB0FF45867_OFFSET UNITYSDK_OFFSET(0x173934A0)
#define RPG_GAMECORE_MARBLENPCLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x17393470)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleNpcListener_TypeDefinitionIndex = 20220;
