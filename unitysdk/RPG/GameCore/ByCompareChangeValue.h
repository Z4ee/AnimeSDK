...
#define RPG_GAMECORE_BYCOMPARECHANGEVALUE_METHOD_4_74166146569D8CDE_OFFSET UNITYSDK_OFFSET(0x19CD4DF0)
#define RPG_GAMECORE_BYCOMPARECHANGEVALUE_METHOD_4_94224A6B444E57D5_OFFSET UNITYSDK_OFFSET(0x19CD5050)
#define RPG_GAMECORE_BYCOMPARECHANGEVALUE_METHOD_4_968F7800B6A95443_OFFSET UNITYSDK_OFFSET(0x19CD4E30)
#define RPG_GAMECORE_BYCOMPARECHANGEVALUE_METHOD_4_B046B52BC06E0C52_OFFSET UNITYSDK_OFFSET(0x19CD5080)
#define RPG_GAMECORE_BYCOMPARECHANGEVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x19CD4E20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareChangeValue_TypeDefinitionIndex = 22159;
