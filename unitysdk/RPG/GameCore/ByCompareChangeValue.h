...
#define RPG_GAMECORE_BYCOMPARECHANGEVALUE_METHOD_4_968F7800B6A95443_OFFSET UNITYSDK_OFFSET(0x170040E0)
#define RPG_GAMECORE_BYCOMPARECHANGEVALUE_METHOD_4_E891264CFCFDFBCD_OFFSET UNITYSDK_OFFSET(0x17004010)
#define RPG_GAMECORE_BYCOMPARECHANGEVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x17004090)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareChangeValue_TypeDefinitionIndex = 21191;
