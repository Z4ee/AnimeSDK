...
#define RPG_GAMECORE_LITTLEGAMEFETCHPROXYBYID_METHOD_4_468F6C384AB4FD9D_OFFSET UNITYSDK_OFFSET(0x18A6B700)
#define RPG_GAMECORE_LITTLEGAMEFETCHPROXYBYID_METHOD_4_BB0577FF57290970_OFFSET UNITYSDK_OFFSET(0x18A6B7E0)
#define RPG_GAMECORE_LITTLEGAMEFETCHPROXYBYID__CTOR_OFFSET UNITYSDK_OFFSET(0x18A6B790)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameFetchProxyByID_TypeDefinitionIndex = 20314;
