...
#define RPG_GAMECORE_LITTLEGAMEFETCHPROXYBYID_METHOD_4_CBAF848C5A466DB3_OFFSET UNITYSDK_OFFSET(0x1BCC17F0)
#define RPG_GAMECORE_LITTLEGAMEFETCHPROXYBYID_METHOD_4_D29A0958C3119837_OFFSET UNITYSDK_OFFSET(0x1BCC16E0)
#define RPG_GAMECORE_LITTLEGAMEFETCHPROXYBYID_METHOD_4_D8F83BB3C0A45D31_OFFSET UNITYSDK_OFFSET(0x1BCC1840)
#define RPG_GAMECORE_LITTLEGAMEFETCHPROXYBYID_METHOD_4_E56A82B890AFBDAD_OFFSET UNITYSDK_OFFSET(0x1BCC1740)
#define RPG_GAMECORE_LITTLEGAMEFETCHPROXYBYID__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCC1730)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameFetchProxyByID_TypeDefinitionIndex = 20626;
