...
#define RPG_GAMECORE_FIELDEFFECTADAPTIONCONFIGLIST_METHOD_2_0CBBD730A0B7ADB4_OFFSET UNITYSDK_OFFSET(0x1D092A10)
#define RPG_GAMECORE_FIELDEFFECTADAPTIONCONFIGLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1D092AD0)
