...
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_UNION_METHOD_3_0F80AF059D071ED7_OFFSET UNITYSDK_OFFSET(0x1C37F370)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_UNION_METHOD_3_24CD864C83FD8F17_OFFSET UNITYSDK_OFFSET(0x1C37F3D0)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_UNION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C37F3C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleTargetEvaluator_Union_TypeDefinitionIndex = 15164;
