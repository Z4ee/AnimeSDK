...
#define RPG_GAMECORE_WAITUIANIM_METHOD_3_63AE727AE2E7D2F5_OFFSET UNITYSDK_OFFSET(0x17907A80)
#define RPG_GAMECORE_WAITUIANIM_METHOD_3_9BB17C72C949B374_OFFSET UNITYSDK_OFFSET(0x179079F0)
#define RPG_GAMECORE_WAITUIANIM__CTOR_OFFSET UNITYSDK_OFFSET(0x17907A50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitUIAnim_TypeDefinitionIndex = 22397;
