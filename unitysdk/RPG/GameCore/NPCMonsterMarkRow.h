...
#define RPG_GAMECORE_NPCMONSTERMARKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D2EF770)
#define RPG_GAMECORE_NPCMONSTERMARKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2EF8E0)
