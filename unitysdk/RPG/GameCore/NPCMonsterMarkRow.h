...
#define RPG_GAMECORE_NPCMONSTERMARKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18B79F80)
#define RPG_GAMECORE_NPCMONSTERMARKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18B7A0F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NPCMonsterMarkRow_TypeDefinitionIndex = 13545;
