...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSHOPUPROLEPOOLNUMCONFIG_METHOD_3_DA6C56FAAD1243D8_OFFSET UNITYSDK_OFFSET(0x197F3EB0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSHOPUPROLEPOOLNUMCONFIG_METHOD_3_E0882D2EBE7884F1_OFFSET UNITYSDK_OFFSET(0x197F3F80)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSHOPUPROLEPOOLNUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197F3F30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierShopUpRolePoolNumConfig_TypeDefinitionIndex = 18358;
