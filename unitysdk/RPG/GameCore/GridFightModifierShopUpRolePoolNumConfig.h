...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSHOPUPROLEPOOLNUMCONFIG_METHOD_3_DA6C56FAAD1243D8_OFFSET UNITYSDK_OFFSET(0x1726C580)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSHOPUPROLEPOOLNUMCONFIG_METHOD_3_E0882D2EBE7884F1_OFFSET UNITYSDK_OFFSET(0x1726C650)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSHOPUPROLEPOOLNUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1726C600)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierShopUpRolePoolNumConfig_TypeDefinitionIndex = 17769;
