...
#define RPG_GAMECORE_RTBATTLELINEUPBACKUPCHARACTERPRESET_METHOD_2_E8D9808AB1012557_OFFSET UNITYSDK_OFFSET(0x19BDBAE0)
#define RPG_GAMECORE_RTBATTLELINEUPBACKUPCHARACTERPRESET__CTOR_OFFSET UNITYSDK_OFFSET(0x19BDBB20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtBattleLineupBackupCharacterPreset_TypeDefinitionIndex = 17158;
