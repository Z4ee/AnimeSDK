...
#define RPG_GAMECORE_NEWFIREMULTIPROJECTILES_METHOD_4_16E3981F67F0C209_OFFSET UNITYSDK_OFFSET(0x1BAF6F50)
#define RPG_GAMECORE_NEWFIREMULTIPROJECTILES_METHOD_4_1D339455895AF8E8_OFFSET UNITYSDK_OFFSET(0x1BAF6F90)
#define RPG_GAMECORE_NEWFIREMULTIPROJECTILES__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAF6F80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NewFireMultiProjectiles_TypeDefinitionIndex = 21775;
