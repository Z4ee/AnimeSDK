...
#define RPG_GAMECORE_NEWFIREMULTIPROJECTILES_METHOD_4_4D824E7070FE6859_OFFSET UNITYSDK_OFFSET(0x18B7E8D0)
#define RPG_GAMECORE_NEWFIREMULTIPROJECTILES_METHOD_4_EF863CAC768C499B_OFFSET UNITYSDK_OFFSET(0x18B7E950)
#define RPG_GAMECORE_NEWFIREMULTIPROJECTILES__CTOR_OFFSET UNITYSDK_OFFSET(0x18B7E920)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NewFireMultiProjectiles_TypeDefinitionIndex = 21475;
