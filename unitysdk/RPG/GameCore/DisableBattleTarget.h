...
#define RPG_GAMECORE_DISABLEBATTLETARGET_METHOD_3_1FEF9B27704D216D_OFFSET UNITYSDK_OFFSET(0x1DB0A380)
#define RPG_GAMECORE_DISABLEBATTLETARGET_METHOD_3_D6A6DA0560FA8C4E_OFFSET UNITYSDK_OFFSET(0x1DB0A3C0)
#define RPG_GAMECORE_DISABLEBATTLETARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB0A3B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DisableBattleTarget_TypeDefinitionIndex = 23390;
