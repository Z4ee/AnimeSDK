...
#define RPG_GAMECORE_DISABLEBATTLETARGET_METHOD_3_9496C0B28B0D5E62_OFFSET UNITYSDK_OFFSET(0x1887F2E0)
#define RPG_GAMECORE_DISABLEBATTLETARGET_METHOD_3_D6A6DA0560FA8C4E_OFFSET UNITYSDK_OFFSET(0x1887F360)
#define RPG_GAMECORE_DISABLEBATTLETARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1887F330)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DisableBattleTarget_TypeDefinitionIndex = 22650;
