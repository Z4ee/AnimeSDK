...
#define RPG_GAMECORE_ACTIONTRIGGERACTIONWITHTIMESLIMITCONFIG_METHOD_4_01E08232722A1633_OFFSET UNITYSDK_OFFSET(0x16E9EE20)
#define RPG_GAMECORE_ACTIONTRIGGERACTIONWITHTIMESLIMITCONFIG_METHOD_4_E75AE553A8852D6E_OFFSET UNITYSDK_OFFSET(0x16E9EF00)
#define RPG_GAMECORE_ACTIONTRIGGERACTIONWITHTIMESLIMITCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16E9EEB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActionTriggerActionWithTimesLimitConfig_TypeDefinitionIndex = 15618;
