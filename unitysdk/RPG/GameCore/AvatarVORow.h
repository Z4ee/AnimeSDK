...
#define RPG_GAMECORE_AVATARVOROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16FBEB30)
#define RPG_GAMECORE_AVATARVOROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16FBF2B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AvatarVORow_TypeDefinitionIndex = 11638;
	...
	public:
		...
		::System::UInt32 ActionBegin; // 0x24
		::System::UInt32 ReceiveBuff; // 0x28
		::System::UInt32 Revived; // 0x2C
		::System::UInt32 ReceiveHealing; // 0x30
		::System::UInt32 ActionBeginAdvantage; // 0x34
		::System::UInt32 UltraReady; // 0x38
