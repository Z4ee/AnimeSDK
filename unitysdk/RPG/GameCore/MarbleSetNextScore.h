...
#define RPG_GAMECORE_MARBLESETNEXTSCORE_METHOD_3_04BB698152AA94AF_OFFSET UNITYSDK_OFFSET(0x18AA7C00)
#define RPG_GAMECORE_MARBLESETNEXTSCORE_METHOD_3_4A6E79A774318A5D_OFFSET UNITYSDK_OFFSET(0x18AA7D90)
#define RPG_GAMECORE_MARBLESETNEXTSCORE__CTOR_OFFSET UNITYSDK_OFFSET(0x18AA7D40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleSetNextScore_TypeDefinitionIndex = 15954;
