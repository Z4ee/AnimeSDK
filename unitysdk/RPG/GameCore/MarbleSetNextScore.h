...
#define RPG_GAMECORE_MARBLESETNEXTSCORE_METHOD_3_04BB698152AA94AF_OFFSET UNITYSDK_OFFSET(0x17399BA0)
#define RPG_GAMECORE_MARBLESETNEXTSCORE_METHOD_3_4A6E79A774318A5D_OFFSET UNITYSDK_OFFSET(0x17399D30)
#define RPG_GAMECORE_MARBLESETNEXTSCORE__CTOR_OFFSET UNITYSDK_OFFSET(0x17399CE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleSetNextScore_TypeDefinitionIndex = 15434;
