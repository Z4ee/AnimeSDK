...
#define RPG_GAMECORE_POINTEVALUATORBYDISTANCECONFIG_METHOD_3_18634D06A601D0C0_OFFSET UNITYSDK_OFFSET(0x1D357A50)
#define RPG_GAMECORE_POINTEVALUATORBYDISTANCECONFIG_METHOD_3_D6E8CCED08A34AF0_OFFSET UNITYSDK_OFFSET(0x1D357CB0)
#define RPG_GAMECORE_POINTEVALUATORBYDISTANCECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D357A40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PointEvaluatorByDistanceConfig_TypeDefinitionIndex = 15457;
