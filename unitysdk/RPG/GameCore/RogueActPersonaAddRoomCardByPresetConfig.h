...
#define RPG_GAMECORE_ROGUEACTPERSONAADDROOMCARDBYPRESETCONFIG_METHOD_6_0E093422FC91B371_OFFSET UNITYSDK_OFFSET(0x19AE9800)
#define RPG_GAMECORE_ROGUEACTPERSONAADDROOMCARDBYPRESETCONFIG_METHOD_6_2886F1A08CA819EC_OFFSET UNITYSDK_OFFSET(0x19AE9A20)
#define RPG_GAMECORE_ROGUEACTPERSONAADDROOMCARDBYPRESETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AE9940)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaAddRoomCardByPresetConfig_TypeDefinitionIndex = 18714;
