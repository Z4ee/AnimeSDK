...
#define RPG_GAMECORE_MAZEITEMUSEBUFFGAMEMODEDROPCONFIG_METHOD_2_EA66BE8F8B96B8E4_OFFSET UNITYSDK_OFFSET(0x18AD16D0)
#define RPG_GAMECORE_MAZEITEMUSEBUFFGAMEMODEDROPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18AD1710)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MazeItemUseBuffGameModeDropConfig_TypeDefinitionIndex = 20605;
