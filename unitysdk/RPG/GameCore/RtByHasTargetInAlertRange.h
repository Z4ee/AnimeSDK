...
#define RPG_GAMECORE_RTBYHASTARGETINALERTRANGE_METHOD_4_937AB86299DB861D_OFFSET UNITYSDK_OFFSET(0x1BB8E5B0)
#define RPG_GAMECORE_RTBYHASTARGETINALERTRANGE_METHOD_4_963245C0B3B12756_OFFSET UNITYSDK_OFFSET(0x1BB8E7A0)
#define RPG_GAMECORE_RTBYHASTARGETINALERTRANGE_METHOD_4_A9CAAF7D5E939E68_OFFSET UNITYSDK_OFFSET(0x1BB8E5F0)
#define RPG_GAMECORE_RTBYHASTARGETINALERTRANGE_METHOD_4_E3D67FAF502A1D18_OFFSET UNITYSDK_OFFSET(0x1BB8E770)
#define RPG_GAMECORE_RTBYHASTARGETINALERTRANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB8E5E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtByHasTargetInAlertRange_TypeDefinitionIndex = 23372;
