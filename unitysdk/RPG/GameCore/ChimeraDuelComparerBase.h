...
#define RPG_GAMECORE_CHIMERADUELCOMPARERBASE_METHOD_2_004AE1F3B4955B15_OFFSET UNITYSDK_OFFSET(0x1C393D00)
#define RPG_GAMECORE_CHIMERADUELCOMPARERBASE_METHOD_2_EF8EEEC0F188E310_OFFSET UNITYSDK_OFFSET(0x1C393A10)
#define RPG_GAMECORE_CHIMERADUELCOMPARERBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C393DC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelComparerBase_TypeDefinitionIndex = 15319;
