...
#define RPG_GAMECORE_CHIMERADUELCOMPARERBASE_METHOD_2_004AE1F3B4955B15_OFFSET UNITYSDK_OFFSET(0x1963A290)
#define RPG_GAMECORE_CHIMERADUELCOMPARERBASE_METHOD_2_EF8EEEC0F188E310_OFFSET UNITYSDK_OFFSET(0x19639E30)
#define RPG_GAMECORE_CHIMERADUELCOMPARERBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1963A350)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelComparerBase_TypeDefinitionIndex = 15155;
