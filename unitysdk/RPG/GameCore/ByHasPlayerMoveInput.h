...
#define RPG_GAMECORE_BYHASPLAYERMOVEINPUT_METHOD_4_2428D18D8B2FC900_OFFSET UNITYSDK_OFFSET(0x187490B0)
#define RPG_GAMECORE_BYHASPLAYERMOVEINPUT_METHOD_4_BEC3E6BB528B93AA_OFFSET UNITYSDK_OFFSET(0x18749180)
#define RPG_GAMECORE_BYHASPLAYERMOVEINPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x18749130)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByHasPlayerMoveInput_TypeDefinitionIndex = 19191;
