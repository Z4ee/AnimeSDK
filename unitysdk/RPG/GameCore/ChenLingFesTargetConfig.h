...
#define RPG_GAMECORE_CHENLINGFESTARGETCONFIG_METHOD_2_10CA704E41BF162D_OFFSET UNITYSDK_OFFSET(0x1962C8D0)
#define RPG_GAMECORE_CHENLINGFESTARGETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1962CB10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingFesTargetConfig_TypeDefinitionIndex = 20298;
