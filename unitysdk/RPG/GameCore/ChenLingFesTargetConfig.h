...
#define RPG_GAMECORE_CHENLINGFESTARGETCONFIG_METHOD_2_10CA704E41BF162D_OFFSET UNITYSDK_OFFSET(0x1CFB56D0)
#define RPG_GAMECORE_CHENLINGFESTARGETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFB5910)
