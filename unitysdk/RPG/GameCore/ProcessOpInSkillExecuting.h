...
#define RPG_GAMECORE_PROCESSOPINSKILLEXECUTING_METHOD_3_B6EC97F06089435C_OFFSET UNITYSDK_OFFSET(0x18C62900)
#define RPG_GAMECORE_PROCESSOPINSKILLEXECUTING_METHOD_3_BDCAF61B275BE4EA_OFFSET UNITYSDK_OFFSET(0x18C62880)
#define RPG_GAMECORE_PROCESSOPINSKILLEXECUTING__CTOR_OFFSET UNITYSDK_OFFSET(0x18C628D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ProcessOpInSkillExecuting_TypeDefinitionIndex = 21363;
