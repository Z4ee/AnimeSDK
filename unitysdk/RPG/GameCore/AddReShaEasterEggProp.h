...
#define RPG_GAMECORE_ADDRESHAEASTEREGGPROP_METHOD_3_D222763753E57829_OFFSET UNITYSDK_OFFSET(0x16F20650)
#define RPG_GAMECORE_ADDRESHAEASTEREGGPROP_METHOD_3_D874E781B2B83B97_OFFSET UNITYSDK_OFFSET(0x16F20500)
#define RPG_GAMECORE_ADDRESHAEASTEREGGPROP__CTOR_OFFSET UNITYSDK_OFFSET(0x16F205C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddReShaEasterEggProp_TypeDefinitionIndex = 20207;
