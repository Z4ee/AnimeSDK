...
#define RPG_GAMECORE_ADDRESHAEASTEREGGPROP_METHOD_3_D222763753E57829_OFFSET UNITYSDK_OFFSET(0x18642820)
#define RPG_GAMECORE_ADDRESHAEASTEREGGPROP_METHOD_3_D874E781B2B83B97_OFFSET UNITYSDK_OFFSET(0x186426D0)
#define RPG_GAMECORE_ADDRESHAEASTEREGGPROP__CTOR_OFFSET UNITYSDK_OFFSET(0x18642790)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddReShaEasterEggProp_TypeDefinitionIndex = 20889;
