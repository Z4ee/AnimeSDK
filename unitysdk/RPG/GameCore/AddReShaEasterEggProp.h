...
#define RPG_GAMECORE_ADDRESHAEASTEREGGPROP_METHOD_3_995B64AB9FF9D2EF_OFFSET UNITYSDK_OFFSET(0x1D6A41C0)
#define RPG_GAMECORE_ADDRESHAEASTEREGGPROP_METHOD_3_D222763753E57829_OFFSET UNITYSDK_OFFSET(0x1D6A4240)
#define RPG_GAMECORE_ADDRESHAEASTEREGGPROP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6A4210)
