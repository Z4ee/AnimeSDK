...
#define RPG_GAMECORE_ADDRESHAEASTEREGGPROP_METHOD_3_995B64AB9FF9D2EF_OFFSET UNITYSDK_OFFSET(0x1BE097A0)
#define RPG_GAMECORE_ADDRESHAEASTEREGGPROP_METHOD_3_D222763753E57829_OFFSET UNITYSDK_OFFSET(0x1BE09820)
#define RPG_GAMECORE_ADDRESHAEASTEREGGPROP__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE097F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddReShaEasterEggProp_TypeDefinitionIndex = 21223;
