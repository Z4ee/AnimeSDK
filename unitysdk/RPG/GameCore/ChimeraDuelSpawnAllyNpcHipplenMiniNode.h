...
#define RPG_GAMECORE_CHIMERADUELSPAWNALLYNPCHIPPLENMININODE_METHOD_3_22F32C54AE85C8D9_OFFSET UNITYSDK_OFFSET(0x170A62B0)
#define RPG_GAMECORE_CHIMERADUELSPAWNALLYNPCHIPPLENMININODE_METHOD_3_23637435EED557C6_OFFSET UNITYSDK_OFFSET(0x170A6390)
#define RPG_GAMECORE_CHIMERADUELSPAWNALLYNPCHIPPLENMININODE__CTOR_OFFSET UNITYSDK_OFFSET(0x170A6340)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelSpawnAllyNpcHipplenMiniNode_TypeDefinitionIndex = 14647;
