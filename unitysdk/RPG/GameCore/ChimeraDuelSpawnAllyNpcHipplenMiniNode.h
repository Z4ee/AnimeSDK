...
#define RPG_GAMECORE_CHIMERADUELSPAWNALLYNPCHIPPLENMININODE_METHOD_3_23637435EED557C6_OFFSET UNITYSDK_OFFSET(0x1CFCF120)
#define RPG_GAMECORE_CHIMERADUELSPAWNALLYNPCHIPPLENMININODE_METHOD_3_60FA80D9E493CD26_OFFSET UNITYSDK_OFFSET(0x1CFCF0C0)
#define RPG_GAMECORE_CHIMERADUELSPAWNALLYNPCHIPPLENMININODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFCF110)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelSpawnAllyNpcHipplenMiniNode_TypeDefinitionIndex = 15780;
