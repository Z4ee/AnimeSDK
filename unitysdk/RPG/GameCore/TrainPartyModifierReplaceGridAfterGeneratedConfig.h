...
#define RPG_GAMECORE_TRAINPARTYMODIFIERREPLACEGRIDAFTERGENERATEDCONFIG_METHOD_3_154C2B615961802F_OFFSET UNITYSDK_OFFSET(0x19DF6B90)
#define RPG_GAMECORE_TRAINPARTYMODIFIERREPLACEGRIDAFTERGENERATEDCONFIG_METHOD_3_5EDB2F3BA2D771F3_OFFSET UNITYSDK_OFFSET(0x19DF68B0)
#define RPG_GAMECORE_TRAINPARTYMODIFIERREPLACEGRIDAFTERGENERATEDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19DF68A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyModifierReplaceGridAfterGeneratedConfig_TypeDefinitionIndex = 17210;
