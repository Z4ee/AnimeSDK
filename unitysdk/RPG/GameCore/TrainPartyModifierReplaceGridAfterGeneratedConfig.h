...
#define RPG_GAMECORE_TRAINPARTYMODIFIERREPLACEGRIDAFTERGENERATEDCONFIG_METHOD_3_154C2B615961802F_OFFSET UNITYSDK_OFFSET(0x1D536F80)
#define RPG_GAMECORE_TRAINPARTYMODIFIERREPLACEGRIDAFTERGENERATEDCONFIG_METHOD_3_5EDB2F3BA2D771F3_OFFSET UNITYSDK_OFFSET(0x1D536CA0)
#define RPG_GAMECORE_TRAINPARTYMODIFIERREPLACEGRIDAFTERGENERATEDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D536C90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyModifierReplaceGridAfterGeneratedConfig_TypeDefinitionIndex = 17889;
