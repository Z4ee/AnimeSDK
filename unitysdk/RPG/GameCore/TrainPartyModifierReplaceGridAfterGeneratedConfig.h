...
#define RPG_GAMECORE_TRAINPARTYMODIFIERREPLACEGRIDAFTERGENERATEDCONFIG_METHOD_3_154C2B615961802F_OFFSET UNITYSDK_OFFSET(0x190ABEB0)
#define RPG_GAMECORE_TRAINPARTYMODIFIERREPLACEGRIDAFTERGENERATEDCONFIG_METHOD_3_5EDB2F3BA2D771F3_OFFSET UNITYSDK_OFFSET(0x190ABBD0)
#define RPG_GAMECORE_TRAINPARTYMODIFIERREPLACEGRIDAFTERGENERATEDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x190ABBC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyModifierReplaceGridAfterGeneratedConfig_TypeDefinitionIndex = 17202;
