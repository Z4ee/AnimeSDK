...
#define RPG_GAMECORE_TRAINPARTYMODIFIERREPLACEGRIDAFTERGENERATEDCONFIG_METHOD_3_154C2B615961802F_OFFSET UNITYSDK_OFFSET(0x178AD440)
#define RPG_GAMECORE_TRAINPARTYMODIFIERREPLACEGRIDAFTERGENERATEDCONFIG_METHOD_3_5EDB2F3BA2D771F3_OFFSET UNITYSDK_OFFSET(0x178AD160)
#define RPG_GAMECORE_TRAINPARTYMODIFIERREPLACEGRIDAFTERGENERATEDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x178AD150)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyModifierReplaceGridAfterGeneratedConfig_TypeDefinitionIndex = 16610;
