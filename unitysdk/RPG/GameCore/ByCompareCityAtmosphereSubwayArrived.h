...
#define RPG_GAMECORE_BYCOMPARECITYATMOSPHERESUBWAYARRIVED_METHOD_4_12B41C668754ACD1_OFFSET UNITYSDK_OFFSET(0x17004EE0)
#define RPG_GAMECORE_BYCOMPARECITYATMOSPHERESUBWAYARRIVED_METHOD_4_7F042E972ED4BD13_OFFSET UNITYSDK_OFFSET(0x17004FB0)
#define RPG_GAMECORE_BYCOMPARECITYATMOSPHERESUBWAYARRIVED__CTOR_OFFSET UNITYSDK_OFFSET(0x17004F60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareCityAtmosphereSubwayArrived_TypeDefinitionIndex = 19365;
