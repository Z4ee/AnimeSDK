...
#define RPG_GAMECORE_DRINKMAKERMIXTAGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1BB23C70)
#define RPG_GAMECORE_DRINKMAKERMIXTAGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB24230)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DrinkMakerMixTagRow_TypeDefinitionIndex = 12663;
