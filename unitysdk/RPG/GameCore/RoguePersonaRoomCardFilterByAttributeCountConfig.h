...
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYATTRIBUTECOUNTCONFIG_METHOD_3_02F75EC7EFEB84E2_OFFSET UNITYSDK_OFFSET(0x17657E50)
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYATTRIBUTECOUNTCONFIG_METHOD_3_3D68F97F6568E3FE_OFFSET UNITYSDK_OFFSET(0x17657C80)
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYATTRIBUTECOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17657C70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RoguePersonaRoomCardFilterByAttributeCountConfig_TypeDefinitionIndex = 18214;
