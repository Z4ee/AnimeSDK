...
#define RPG_GAMECORE_IDLELIVEAVATARUPGRADECOSTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D20DC30)
#define RPG_GAMECORE_IDLELIVEAVATARUPGRADECOSTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D20DD50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int IdleLiveAvatarUpgradeCostRow_TypeDefinitionIndex = 11660;
