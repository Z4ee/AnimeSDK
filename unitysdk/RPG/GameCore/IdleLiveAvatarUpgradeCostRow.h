...
#define RPG_GAMECORE_IDLELIVEAVATARUPGRADECOSTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x198402D0)
#define RPG_GAMECORE_IDLELIVEAVATARUPGRADECOSTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x198403F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int IdleLiveAvatarUpgradeCostRow_TypeDefinitionIndex = 11171;
