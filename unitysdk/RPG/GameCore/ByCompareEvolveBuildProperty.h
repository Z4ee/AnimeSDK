...
#define RPG_GAMECORE_BYCOMPAREEVOLVEBUILDPROPERTY_METHOD_4_20CA32EBAFD78B90_OFFSET UNITYSDK_OFFSET(0x17007C70)
#define RPG_GAMECORE_BYCOMPAREEVOLVEBUILDPROPERTY_METHOD_4_E5092DD324D38B86_OFFSET UNITYSDK_OFFSET(0x17007D40)
#define RPG_GAMECORE_BYCOMPAREEVOLVEBUILDPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x17007CF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareEvolveBuildProperty_TypeDefinitionIndex = 20705;
