...
#define RPG_GAMECORE_ROGUEMODIFIERSETFIXEDMIRACLEINSHOPCONFIG_METHOD_3_43B56D624A6D2456_OFFSET UNITYSDK_OFFSET(0x1D166380)
#define RPG_GAMECORE_ROGUEMODIFIERSETFIXEDMIRACLEINSHOPCONFIG_METHOD_3_DD956CC4777DD532_OFFSET UNITYSDK_OFFSET(0x1D1663D0)
#define RPG_GAMECORE_ROGUEMODIFIERSETFIXEDMIRACLEINSHOPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1663C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierSetFixedMiracleInShopConfig_TypeDefinitionIndex = 17069;
