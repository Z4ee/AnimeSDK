...
#define RPG_GAMECORE_ROGUEMODIFIERSETFIXEDMIRACLEINSHOPCONFIG_METHOD_3_34716EDAE31239BB_OFFSET UNITYSDK_OFFSET(0x176397B0)
#define RPG_GAMECORE_ROGUEMODIFIERSETFIXEDMIRACLEINSHOPCONFIG_METHOD_3_DD956CC4777DD532_OFFSET UNITYSDK_OFFSET(0x1762D2D0)
#define RPG_GAMECORE_ROGUEMODIFIERSETFIXEDMIRACLEINSHOPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1762D280)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierSetFixedMiracleInShopConfig_TypeDefinitionIndex = 16338;
