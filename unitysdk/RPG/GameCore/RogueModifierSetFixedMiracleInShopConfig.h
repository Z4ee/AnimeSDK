...
#define RPG_GAMECORE_ROGUEMODIFIERSETFIXEDMIRACLEINSHOPCONFIG_METHOD_3_34716EDAE31239BB_OFFSET UNITYSDK_OFFSET(0x19B9C9A0)
#define RPG_GAMECORE_ROGUEMODIFIERSETFIXEDMIRACLEINSHOPCONFIG_METHOD_3_DD956CC4777DD532_OFFSET UNITYSDK_OFFSET(0x19B9CA70)
#define RPG_GAMECORE_ROGUEMODIFIERSETFIXEDMIRACLEINSHOPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B9CA20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierSetFixedMiracleInShopConfig_TypeDefinitionIndex = 16907;
