...
#define RPG_GAMECORE_SWORDTRAININGCHECKCANENTERGAME_METHOD_3_3FBB1A964B65289C_OFFSET UNITYSDK_OFFSET(0x1E1555C0)
#define RPG_GAMECORE_SWORDTRAININGCHECKCANENTERGAME_METHOD_3_EBC35277B8481C7B_OFFSET UNITYSDK_OFFSET(0x1E155580)
#define RPG_GAMECORE_SWORDTRAININGCHECKCANENTERGAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1555B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwordTrainingCheckCanEnterGame_TypeDefinitionIndex = 20760;
