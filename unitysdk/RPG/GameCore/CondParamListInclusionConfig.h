...
#define RPG_GAMECORE_CONDPARAMLISTINCLUSIONCONFIG_METHOD_4_0E1BBF545D0D70E9_OFFSET UNITYSDK_OFFSET(0x1712B070)
#define RPG_GAMECORE_CONDPARAMLISTINCLUSIONCONFIG_METHOD_4_23DF95C4952DFA6B_OFFSET UNITYSDK_OFFSET(0x1712AF40)
#define RPG_GAMECORE_CONDPARAMLISTINCLUSIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1712AFF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CondParamListInclusionConfig_TypeDefinitionIndex = 15644;
