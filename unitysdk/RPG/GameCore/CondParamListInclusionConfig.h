...
#define RPG_GAMECORE_CONDPARAMLISTINCLUSIONCONFIG_METHOD_4_0E1BBF545D0D70E9_OFFSET UNITYSDK_OFFSET(0x19671C90)
#define RPG_GAMECORE_CONDPARAMLISTINCLUSIONCONFIG_METHOD_4_23DF95C4952DFA6B_OFFSET UNITYSDK_OFFSET(0x19671B60)
#define RPG_GAMECORE_CONDPARAMLISTINCLUSIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19671C10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CondParamListInclusionConfig_TypeDefinitionIndex = 16211;
