...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_METHOD_2_74916D5CE466B341_OFFSET UNITYSDK_OFFSET(0x18871300)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_METHOD_2_A5257641A02F4D53_OFFSET UNITYSDK_OFFSET(0x188714C0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG__CCTOR_OFFSET UNITYSDK_OFFSET(0x18871520)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18865F10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_TypeDefinitionIndex = 15198;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Func_2<::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::DiceCombatTaskConfig*>*>**)Il2CppClass::FromTypeDefinitionIndex(DiceCombatTaskConfig_TypeDefinitionIndex)->GetStaticField(0x33920);
		}
