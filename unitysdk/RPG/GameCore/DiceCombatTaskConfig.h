...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_METHOD_2_A5257641A02F4D53_OFFSET UNITYSDK_OFFSET(0x1D82AF10)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_METHOD_2_E7F36E34A0038EEA_OFFSET UNITYSDK_OFFSET(0x1D82AEB0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB040D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_TypeDefinitionIndex = 15860;
