...
#define RPG_GAMECORE_CLOCKPARKSTORYCHARACTERTRIGGERDIALOG_METHOD_3_1779DEF9D1685C68_OFFSET UNITYSDK_OFFSET(0x19660750)
#define RPG_GAMECORE_CLOCKPARKSTORYCHARACTERTRIGGERDIALOG_METHOD_3_48F2FB11706F5C49_OFFSET UNITYSDK_OFFSET(0x196607D0)
#define RPG_GAMECORE_CLOCKPARKSTORYCHARACTERTRIGGERDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x196607A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClockParkStoryCharacterTriggerDialog_TypeDefinitionIndex = 19797;
