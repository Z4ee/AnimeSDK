...
#define RPG_GAMECORE_CLOCKPARKSTORYCHARACTERTRIGGERDIALOG_METHOD_3_34C95445326A75A0_OFFSET UNITYSDK_OFFSET(0x1C260FF0)
#define RPG_GAMECORE_CLOCKPARKSTORYCHARACTERTRIGGERDIALOG_METHOD_3_48F2FB11706F5C49_OFFSET UNITYSDK_OFFSET(0x1C261030)
#define RPG_GAMECORE_CLOCKPARKSTORYCHARACTERTRIGGERDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C261020)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClockParkStoryCharacterTriggerDialog_TypeDefinitionIndex = 20157;
