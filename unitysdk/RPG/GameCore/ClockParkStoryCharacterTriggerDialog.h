...
#define RPG_GAMECORE_CLOCKPARKSTORYCHARACTERTRIGGERDIALOG_METHOD_3_1779DEF9D1685C68_OFFSET UNITYSDK_OFFSET(0x1881F760)
#define RPG_GAMECORE_CLOCKPARKSTORYCHARACTERTRIGGERDIALOG_METHOD_3_48F2FB11706F5C49_OFFSET UNITYSDK_OFFSET(0x1881F7E0)
#define RPG_GAMECORE_CLOCKPARKSTORYCHARACTERTRIGGERDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1881F7B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClockParkStoryCharacterTriggerDialog_TypeDefinitionIndex = 19934;
