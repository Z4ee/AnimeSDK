...
#define RPG_GAMECORE_UIMONOPOLYTRYTRIGGERTELEPORT_METHOD_3_6597FEC5FA4B8FE8_OFFSET UNITYSDK_OFFSET(0x19E2FBF0)
#define RPG_GAMECORE_UIMONOPOLYTRYTRIGGERTELEPORT_METHOD_3_DF6B00BCCF488E9C_OFFSET UNITYSDK_OFFSET(0x19E2FAE0)
#define RPG_GAMECORE_UIMONOPOLYTRYTRIGGERTELEPORT__CTOR_OFFSET UNITYSDK_OFFSET(0x19E2FBC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UIMonopolyTryTriggerTeleport_TypeDefinitionIndex = 20510;
