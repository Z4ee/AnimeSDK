...
#define RPG_GAMECORE_UIMONOPOLYTRYTRIGGERTELEPORT_METHOD_3_6036E675D178FC65_OFFSET UNITYSDK_OFFSET(0x1B87C530)
#define RPG_GAMECORE_UIMONOPOLYTRYTRIGGERTELEPORT_METHOD_3_6597FEC5FA4B8FE8_OFFSET UNITYSDK_OFFSET(0x1B87C600)
#define RPG_GAMECORE_UIMONOPOLYTRYTRIGGERTELEPORT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B87C5F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UIMonopolyTryTriggerTeleport_TypeDefinitionIndex = 20925;
