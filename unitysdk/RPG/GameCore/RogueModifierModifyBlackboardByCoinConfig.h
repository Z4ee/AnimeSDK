...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYBLACKBOARDBYCOINCONFIG_METHOD_4_5A92FB46A81B5038_OFFSET UNITYSDK_OFFSET(0x1D3F9AE0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYBLACKBOARDBYCOINCONFIG_METHOD_4_FDAB0FE7F55BA2B4_OFFSET UNITYSDK_OFFSET(0x1D3F9A90)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYBLACKBOARDBYCOINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3F9A80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyBlackboardByCoinConfig_TypeDefinitionIndex = 17484;
