...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYBLACKBOARDBYCOINCONFIG_METHOD_4_8166D242BD4EC3FD_OFFSET UNITYSDK_OFFSET(0x18D40460)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYBLACKBOARDBYCOINCONFIG_METHOD_4_FDAB0FE7F55BA2B4_OFFSET UNITYSDK_OFFSET(0x18D403F0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYBLACKBOARDBYCOINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D403A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyBlackboardByCoinConfig_TypeDefinitionIndex = 16805;
