...
#define RPG_GAMECORE_SETDYNAMICVALUEBYATTACKTARGETCOUNT_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1C2DEB80)
#define RPG_GAMECORE_SETDYNAMICVALUEBYATTACKTARGETCOUNT_METHOD_4_6FBC337039F9EE18_OFFSET UNITYSDK_OFFSET(0x1C2DE9D0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYATTACKTARGETCOUNT_METHOD_4_8D5CB5AB96FB4775_OFFSET UNITYSDK_OFFSET(0x1C2DE990)
#define RPG_GAMECORE_SETDYNAMICVALUEBYATTACKTARGETCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2DE9C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByAttackTargetCount_TypeDefinitionIndex = 22258;
