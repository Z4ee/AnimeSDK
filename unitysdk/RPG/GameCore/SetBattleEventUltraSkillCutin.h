...
#define RPG_GAMECORE_SETBATTLEEVENTULTRASKILLCUTIN_METHOD_3_2E4A7AF8A128C306_OFFSET UNITYSDK_OFFSET(0x18E0C240)
#define RPG_GAMECORE_SETBATTLEEVENTULTRASKILLCUTIN_METHOD_3_342A1483171B973C_OFFSET UNITYSDK_OFFSET(0x18E0C1C0)
#define RPG_GAMECORE_SETBATTLEEVENTULTRASKILLCUTIN__CTOR_OFFSET UNITYSDK_OFFSET(0x18E0C210)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetBattleEventUltraSkillCutin_TypeDefinitionIndex = 21650;
