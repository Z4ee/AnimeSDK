...
#define RPG_GAMECORE_SETBATTLEEVENTULTRASKILLCUTIN_METHOD_3_2E4A7AF8A128C306_OFFSET UNITYSDK_OFFSET(0x1C2D46D0)
#define RPG_GAMECORE_SETBATTLEEVENTULTRASKILLCUTIN_METHOD_3_54A19EB125F9D331_OFFSET UNITYSDK_OFFSET(0x1C2D4690)
#define RPG_GAMECORE_SETBATTLEEVENTULTRASKILLCUTIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2D46C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetBattleEventUltraSkillCutin_TypeDefinitionIndex = 21927;
