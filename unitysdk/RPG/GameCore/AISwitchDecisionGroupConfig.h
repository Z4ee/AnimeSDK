...
#define RPG_GAMECORE_AISWITCHDECISIONGROUPCONFIG_METHOD_4_A1490A35DCAFE8EA_OFFSET UNITYSDK_OFFSET(0x16E922F0)
#define RPG_GAMECORE_AISWITCHDECISIONGROUPCONFIG_METHOD_4_D1F5B122C5EE6849_OFFSET UNITYSDK_OFFSET(0x16E8FCE0)
#define RPG_GAMECORE_AISWITCHDECISIONGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16E8FCD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AISwitchDecisionGroupConfig_TypeDefinitionIndex = 14183;
