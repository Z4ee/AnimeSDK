...
#define RPG_GAMECORE_AISWITCHDECISIONGROUPCONFIG_METHOD_4_972CD1EBB7240B15_OFFSET UNITYSDK_OFFSET(0x1D324E70)
#define RPG_GAMECORE_AISWITCHDECISIONGROUPCONFIG_METHOD_4_E61275E35C853292_OFFSET UNITYSDK_OFFSET(0x1D322770)
#define RPG_GAMECORE_AISWITCHDECISIONGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D322760)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AISwitchDecisionGroupConfig_TypeDefinitionIndex = 15314;
