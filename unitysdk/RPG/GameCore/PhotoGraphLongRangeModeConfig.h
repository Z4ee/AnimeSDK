...
#define RPG_GAMECORE_PHOTOGRAPHLONGRANGEMODECONFIG_METHOD_2_FED46C93F827DCD1_OFFSET UNITYSDK_OFFSET(0x19A082C0)
#define RPG_GAMECORE_PHOTOGRAPHLONGRANGEMODECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19A08440)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotoGraphLongRangeModeConfig_TypeDefinitionIndex = 20440;
