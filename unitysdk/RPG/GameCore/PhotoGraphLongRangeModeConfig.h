...
#define RPG_GAMECORE_PHOTOGRAPHLONGRANGEMODECONFIG_METHOD_2_FED46C93F827DCD1_OFFSET UNITYSDK_OFFSET(0x1D435070)
#define RPG_GAMECORE_PHOTOGRAPHLONGRANGEMODECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4351F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotoGraphLongRangeModeConfig_TypeDefinitionIndex = 21411;
