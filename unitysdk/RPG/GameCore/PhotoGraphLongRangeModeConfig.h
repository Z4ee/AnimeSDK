...
#define RPG_GAMECORE_PHOTOGRAPHLONGRANGEMODECONFIG_METHOD_2_FED46C93F827DCD1_OFFSET UNITYSDK_OFFSET(0x1B4C2580)
#define RPG_GAMECORE_PHOTOGRAPHLONGRANGEMODECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4C2700)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotoGraphLongRangeModeConfig_TypeDefinitionIndex = 20855;
