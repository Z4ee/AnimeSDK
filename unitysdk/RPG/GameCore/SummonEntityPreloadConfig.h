...
#define RPG_GAMECORE_SUMMONENTITYPRELOADCONFIG_METHOD_2_8E60481D74A36AD8_OFFSET UNITYSDK_OFFSET(0x18EB2810)
#define RPG_GAMECORE_SUMMONENTITYPRELOADCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18EB2910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SummonEntityPreloadConfig_TypeDefinitionIndex = 15466;
