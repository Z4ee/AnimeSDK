...
#define RPG_GAMECORE_SUMMONENTITYPRELOADCONFIG_METHOD_2_8E60481D74A36AD8_OFFSET UNITYSDK_OFFSET(0x1B42E1F0)
#define RPG_GAMECORE_SUMMONENTITYPRELOADCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B42E2F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SummonEntityPreloadConfig_TypeDefinitionIndex = 15700;
