...
#define RPG_GAMECORE_CAPTURECURRENTINTERACTPROP_METHOD_3_A2066D7ABD42B48A_OFFSET UNITYSDK_OFFSET(0x17053190)
#define RPG_GAMECORE_CAPTURECURRENTINTERACTPROP_METHOD_3_DC2E5CC692BA53D3_OFFSET UNITYSDK_OFFSET(0x17053110)
#define RPG_GAMECORE_CAPTURECURRENTINTERACTPROP__CTOR_OFFSET UNITYSDK_OFFSET(0x17053160)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CaptureCurrentInteractProp_TypeDefinitionIndex = 20486;
