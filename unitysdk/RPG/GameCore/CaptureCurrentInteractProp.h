...
#define RPG_GAMECORE_CAPTURECURRENTINTERACTPROP_METHOD_3_A2066D7ABD42B48A_OFFSET UNITYSDK_OFFSET(0x1B70A600)
#define RPG_GAMECORE_CAPTURECURRENTINTERACTPROP_METHOD_3_ACEAE9D52AE25D41_OFFSET UNITYSDK_OFFSET(0x1B70A5C0)
#define RPG_GAMECORE_CAPTURECURRENTINTERACTPROP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B70A5F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CaptureCurrentInteractProp_TypeDefinitionIndex = 21480;
