...
#define RPG_GAMECORE_CAPTURECURRENTINTERACTPROP_METHOD_3_A2066D7ABD42B48A_OFFSET UNITYSDK_OFFSET(0x187B7920)
#define RPG_GAMECORE_CAPTURECURRENTINTERACTPROP_METHOD_3_DC2E5CC692BA53D3_OFFSET UNITYSDK_OFFSET(0x187B78A0)
#define RPG_GAMECORE_CAPTURECURRENTINTERACTPROP__CTOR_OFFSET UNITYSDK_OFFSET(0x187B78F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CaptureCurrentInteractProp_TypeDefinitionIndex = 21168;
