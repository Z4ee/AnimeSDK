...
#define RPG_GAMECORE_BASELEVELTASK_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B620A70)
#define RPG_GAMECORE_BASELEVELTASK_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x1B620A60)
#define RPG_GAMECORE_BASELEVELTASK_ONSKIP_OFFSET UNITYSDK_OFFSET(0x1B620AB0)
#define RPG_GAMECORE_BASELEVELTASK_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1B620B00)
#define RPG_GAMECORE_BASELEVELTASK_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1B620B50)
#define RPG_GAMECORE_BASELEVELTASK_TICK_OFFSET UNITYSDK_OFFSET(0x1B620BA0)
#define RPG_GAMECORE_BASELEVELTASK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B620A50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BaseLevelTask_TypeDefinitionIndex = 58097;
