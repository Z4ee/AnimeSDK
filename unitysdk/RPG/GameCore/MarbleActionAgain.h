...
#define RPG_GAMECORE_MARBLEACTIONAGAIN_METHOD_3_0968E8EC57D8916C_OFFSET UNITYSDK_OFFSET(0x1D4A2570)
#define RPG_GAMECORE_MARBLEACTIONAGAIN_METHOD_3_858CEF4BD4CCB30A_OFFSET UNITYSDK_OFFSET(0x1D4A2510)
#define RPG_GAMECORE_MARBLEACTIONAGAIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4A2560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleActionAgain_TypeDefinitionIndex = 16658;
