...
#define RPG_GAMECORE_MARBLEACTIONAGAIN_METHOD_3_0968E8EC57D8916C_OFFSET UNITYSDK_OFFSET(0x18A95130)
#define RPG_GAMECORE_MARBLEACTIONAGAIN_METHOD_3_E7CF048290FF688D_OFFSET UNITYSDK_OFFSET(0x18A95050)
#define RPG_GAMECORE_MARBLEACTIONAGAIN__CTOR_OFFSET UNITYSDK_OFFSET(0x18A950E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleActionAgain_TypeDefinitionIndex = 15938;
