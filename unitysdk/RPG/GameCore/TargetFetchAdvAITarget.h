...
#define RPG_GAMECORE_TARGETFETCHADVAITARGET_METHOD_4_14B9DE76B950689C_OFFSET UNITYSDK_OFFSET(0x1D5A3A80)
#define RPG_GAMECORE_TARGETFETCHADVAITARGET_METHOD_4_2FF3F5180B061BCC_OFFSET UNITYSDK_OFFSET(0x1D5A3A00)
#define RPG_GAMECORE_TARGETFETCHADVAITARGET_METHOD_4_3B3D4F3326AD21E9_OFFSET UNITYSDK_OFFSET(0x1D5A3A60)
#define RPG_GAMECORE_TARGETFETCHADVAITARGET_METHOD_4_8AB207D8330C6A61_OFFSET UNITYSDK_OFFSET(0x1D5A3980)
#define RPG_GAMECORE_TARGETFETCHADVAITARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5A39F0)
