...
#define RPG_GAMECORE_PLAYVIDEOSEQUENCE_METHOD_3_2EFF72E9BF68731E_OFFSET UNITYSDK_OFFSET(0x1D7A9AB0)
#define RPG_GAMECORE_PLAYVIDEOSEQUENCE_METHOD_3_D0FAA631BE306B22_OFFSET UNITYSDK_OFFSET(0x1D7A9AF0)
#define RPG_GAMECORE_PLAYVIDEOSEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7A9AE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayVideoSequence_TypeDefinitionIndex = 21675;
