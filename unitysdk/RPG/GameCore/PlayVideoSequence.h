...
#define RPG_GAMECORE_PLAYVIDEOSEQUENCE_METHOD_3_5BE37D40EAB71A20_OFFSET UNITYSDK_OFFSET(0x174C8180)
#define RPG_GAMECORE_PLAYVIDEOSEQUENCE_METHOD_3_D0FAA631BE306B22_OFFSET UNITYSDK_OFFSET(0x174C8200)
#define RPG_GAMECORE_PLAYVIDEOSEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x174C81D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayVideoSequence_TypeDefinitionIndex = 20092;
