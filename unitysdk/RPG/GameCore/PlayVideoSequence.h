...
#define RPG_GAMECORE_PLAYVIDEOSEQUENCE_METHOD_3_5BE37D40EAB71A20_OFFSET UNITYSDK_OFFSET(0x19A2A720)
#define RPG_GAMECORE_PLAYVIDEOSEQUENCE_METHOD_3_D0FAA631BE306B22_OFFSET UNITYSDK_OFFSET(0x19A2A7A0)
#define RPG_GAMECORE_PLAYVIDEOSEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x19A2A770)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayVideoSequence_TypeDefinitionIndex = 20702;
	...
	public:
		...
		static ::System::Void Method_3_5BE37D40EAB71A20(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::PlayVideoSequence*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::PlayVideoSequence*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_PLAYVIDEOSEQUENCE_METHOD_3_5BE37D40EAB71A20_OFFSET))(a1, a2);
		}
