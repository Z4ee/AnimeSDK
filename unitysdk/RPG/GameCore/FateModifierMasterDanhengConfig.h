...
#define RPG_GAMECORE_FATEMODIFIERMASTERDANHENGCONFIG_METHOD_3_2D9F5D1AE1366835_OFFSET UNITYSDK_OFFSET(0x1C074F90)
#define RPG_GAMECORE_FATEMODIFIERMASTERDANHENGCONFIG_METHOD_3_882AC43A1E66B139_OFFSET UNITYSDK_OFFSET(0x1C074FE0)
#define RPG_GAMECORE_FATEMODIFIERMASTERDANHENGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C074FD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateModifierMasterDanhengConfig_TypeDefinitionIndex = 18537;
