...
#define RPG_GAMECORE_FATEMODIFIERMASTERDANHENGCONFIG_METHOD_3_24BE502D8935BB60_OFFSET UNITYSDK_OFFSET(0x171C8A00)
#define RPG_GAMECORE_FATEMODIFIERMASTERDANHENGCONFIG_METHOD_3_882AC43A1E66B139_OFFSET UNITYSDK_OFFSET(0x171C77E0)
#define RPG_GAMECORE_FATEMODIFIERMASTERDANHENGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171C7790)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateModifierMasterDanhengConfig_TypeDefinitionIndex = 17717;
