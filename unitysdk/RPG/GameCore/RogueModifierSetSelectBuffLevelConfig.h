...
#define RPG_GAMECORE_ROGUEMODIFIERSETSELECTBUFFLEVELCONFIG_METHOD_3_3911587F189157EA_OFFSET UNITYSDK_OFFSET(0x17639930)
#define RPG_GAMECORE_ROGUEMODIFIERSETSELECTBUFFLEVELCONFIG_METHOD_3_3A37ECE63C07BFA3_OFFSET UNITYSDK_OFFSET(0x1762D570)
#define RPG_GAMECORE_ROGUEMODIFIERSETSELECTBUFFLEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1762D520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierSetSelectBuffLevelConfig_TypeDefinitionIndex = 16513;
