...
#define RPG_GAMECORE_ROGUEMODIFIERSETSELECTBUFFLEVELCONFIG_METHOD_3_3911587F189157EA_OFFSET UNITYSDK_OFFSET(0x18D46C60)
#define RPG_GAMECORE_ROGUEMODIFIERSETSELECTBUFFLEVELCONFIG_METHOD_3_3A37ECE63C07BFA3_OFFSET UNITYSDK_OFFSET(0x18D46D30)
#define RPG_GAMECORE_ROGUEMODIFIERSETSELECTBUFFLEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D46CE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierSetSelectBuffLevelConfig_TypeDefinitionIndex = 17067;
