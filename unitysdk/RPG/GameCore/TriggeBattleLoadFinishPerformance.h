...
#define RPG_GAMECORE_TRIGGEBATTLELOADFINISHPERFORMANCE_METHOD_3_03AD0EB4861F2973_OFFSET UNITYSDK_OFFSET(0x178BD310)
#define RPG_GAMECORE_TRIGGEBATTLELOADFINISHPERFORMANCE_METHOD_3_52B850E53C3BD6C2_OFFSET UNITYSDK_OFFSET(0x178BD3A0)
#define RPG_GAMECORE_TRIGGEBATTLELOADFINISHPERFORMANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x178BD370)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggeBattleLoadFinishPerformance_TypeDefinitionIndex = 21551;
