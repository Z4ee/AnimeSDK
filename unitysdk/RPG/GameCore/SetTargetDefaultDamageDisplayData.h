...
#define RPG_GAMECORE_SETTARGETDEFAULTDAMAGEDISPLAYDATA_METHOD_3_2719C925DCE9CF77_OFFSET UNITYSDK_OFFSET(0x176E1E80)
#define RPG_GAMECORE_SETTARGETDEFAULTDAMAGEDISPLAYDATA_METHOD_3_D2B1626F17513CD2_OFFSET UNITYSDK_OFFSET(0x176E1F00)
#define RPG_GAMECORE_SETTARGETDEFAULTDAMAGEDISPLAYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x176E1ED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetTargetDefaultDamageDisplayData_TypeDefinitionIndex = 20761;
