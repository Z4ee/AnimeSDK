...
#define RPG_GAMECORE_SETTARGETDEFAULTDAMAGEDISPLAYDATA_METHOD_3_D2B1626F17513CD2_OFFSET UNITYSDK_OFFSET(0x1C60B770)
#define RPG_GAMECORE_SETTARGETDEFAULTDAMAGEDISPLAYDATA_METHOD_3_E683ADD27910B19F_OFFSET UNITYSDK_OFFSET(0x1C60B730)
#define RPG_GAMECORE_SETTARGETDEFAULTDAMAGEDISPLAYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1C60B760)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetTargetDefaultDamageDisplayData_TypeDefinitionIndex = 21763;
