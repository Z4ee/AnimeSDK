...
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCREFORGEMAGICUNITCOSTCONFIG_METHOD_3_4CBCB7328FCF5568_OFFSET UNITYSDK_OFFSET(0x19BD43D0)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCREFORGEMAGICUNITCOSTCONFIG_METHOD_3_550A227A67DA24EC_OFFSET UNITYSDK_OFFSET(0x19BD46D0)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCREFORGEMAGICUNITCOSTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19BD43C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueWorkbenchFuncReforgeMagicUnitCostConfig_TypeDefinitionIndex = 17141;
