...
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCREFORGEMAGICUNITCOSTCONFIG_METHOD_3_4CBCB7328FCF5568_OFFSET UNITYSDK_OFFSET(0x176735F0)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCREFORGEMAGICUNITCOSTCONFIG_METHOD_3_550A227A67DA24EC_OFFSET UNITYSDK_OFFSET(0x176738F0)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCREFORGEMAGICUNITCOSTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x176735E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueWorkbenchFuncReforgeMagicUnitCostConfig_TypeDefinitionIndex = 16574;
