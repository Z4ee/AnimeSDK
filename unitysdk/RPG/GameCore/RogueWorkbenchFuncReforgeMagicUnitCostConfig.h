...
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCREFORGEMAGICUNITCOSTCONFIG_METHOD_3_4CBCB7328FCF5568_OFFSET UNITYSDK_OFFSET(0x1CCD04E0)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCREFORGEMAGICUNITCOSTCONFIG_METHOD_3_550A227A67DA24EC_OFFSET UNITYSDK_OFFSET(0x1CCD07E0)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCREFORGEMAGICUNITCOSTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CCD04D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueWorkbenchFuncReforgeMagicUnitCostConfig_TypeDefinitionIndex = 17820;
