...
#define RPG_GAMECORE_CHANGEGROUPSTATE_METHOD_3_59CD469E94EF4843_OFFSET UNITYSDK_OFFSET(0x187C7F30)
#define RPG_GAMECORE_CHANGEGROUPSTATE_METHOD_3_EC340CE77CFCDAB3_OFFSET UNITYSDK_OFFSET(0x187C7FC0)
#define RPG_GAMECORE_CHANGEGROUPSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x187C7F90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChangeGroupState_TypeDefinitionIndex = 20151;
