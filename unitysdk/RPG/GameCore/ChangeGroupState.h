...
#define RPG_GAMECORE_CHANGEGROUPSTATE_METHOD_3_A295E7A1BD0373EF_OFFSET UNITYSDK_OFFSET(0x1B71A280)
#define RPG_GAMECORE_CHANGEGROUPSTATE_METHOD_3_EC340CE77CFCDAB3_OFFSET UNITYSDK_OFFSET(0x1B71A2D0)
#define RPG_GAMECORE_CHANGEGROUPSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B71A2C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChangeGroupState_TypeDefinitionIndex = 20380;
