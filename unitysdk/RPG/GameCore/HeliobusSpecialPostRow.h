...
#define RPG_GAMECORE_HELIOBUSSPECIALPOSTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1982DA00)
#define RPG_GAMECORE_HELIOBUSSPECIALPOSTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1982DC10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HeliobusSpecialPostRow_TypeDefinitionIndex = 13099;
