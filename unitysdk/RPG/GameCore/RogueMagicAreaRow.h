...
#define RPG_GAMECORE_ROGUEMAGICAREAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19B429B0)
#define RPG_GAMECORE_ROGUEMAGICAREAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19B43320)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueMagicAreaRow_TypeDefinitionIndex = 14117;
	...
	public:
		...
		::Il2CppArray<::System::UInt32>* DifficultyIDList; // 0x30
		::RPG::GameCore::RogueMagicAreaGroupID AreaGroupID; // 0x38
		::System::UInt32 FirstReward; // 0x3C
		::System::UInt32 ExtraLayerID; // 0x40
		::System::Boolean IsHard; // 0x44
		::RPG::GameCore::RogueMagicStyleType DefaultStyle; // 0x48
		::System::UInt32 AreaIndex; // 0x4C
