...
#define RPG_GAMECORE_ROGUEMAGICAREAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D3EC540)
#define RPG_GAMECORE_ROGUEMAGICAREAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3ECEF0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 ExtraLayerID; // 0x48
		::RPG::GameCore::RogueMagicStyleType DefaultStyle; // 0x4C
		::System::UInt32 UnlockID; // 0x50
		::System::Boolean IsHard; // 0x54
		::System::UInt32 AreaIndex; // 0x58
		::RPG::GameCore::RogueMagicAreaGroupID AreaGroupID; // 0x5C
