...
#define RPG_GAMECORE_ROGUEMODIFIERWORKBENCHREFORGEEXTRAFREECOUNTCONFIG_METHOD_3_4865AABFB86824AE_OFFSET UNITYSDK_OFFSET(0x1D166910)
#define RPG_GAMECORE_ROGUEMODIFIERWORKBENCHREFORGEEXTRAFREECOUNTCONFIG_METHOD_3_C85C4285AB740412_OFFSET UNITYSDK_OFFSET(0x1D1668C0)
#define RPG_GAMECORE_ROGUEMODIFIERWORKBENCHREFORGEEXTRAFREECOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D166900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierWorkbenchReforgeExtraFreeCountConfig_TypeDefinitionIndex = 17151;
