...
#define RPG_GAMECORE_ROGUEMODIFIERWORKBENCHREFORGEEXTRAFREECOUNTCONFIG_METHOD_3_4865AABFB86824AE_OFFSET UNITYSDK_OFFSET(0x1762DF10)
#define RPG_GAMECORE_ROGUEMODIFIERWORKBENCHREFORGEEXTRAFREECOUNTCONFIG_METHOD_3_C6969E5D84AA19D7_OFFSET UNITYSDK_OFFSET(0x17639EB0)
#define RPG_GAMECORE_ROGUEMODIFIERWORKBENCHREFORGEEXTRAFREECOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1762DEC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierWorkbenchReforgeExtraFreeCountConfig_TypeDefinitionIndex = 16420;
