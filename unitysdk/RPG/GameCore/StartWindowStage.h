...
#define RPG_GAMECORE_STARTWINDOWSTAGE_METHOD_3_4DD5662413556F0E_OFFSET UNITYSDK_OFFSET(0x17776E90)
#define RPG_GAMECORE_STARTWINDOWSTAGE_METHOD_3_DC37F054231FCD18_OFFSET UNITYSDK_OFFSET(0x17776F10)
#define RPG_GAMECORE_STARTWINDOWSTAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x17776EE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StartWindowStage_TypeDefinitionIndex = 19584;
