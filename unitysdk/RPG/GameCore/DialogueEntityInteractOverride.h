...
#define RPG_GAMECORE_DIALOGUEENTITYINTERACTOVERRIDE_METHOD_2_11C05085C39B8404_OFFSET UNITYSDK_OFFSET(0x17158530)
#define RPG_GAMECORE_DIALOGUEENTITYINTERACTOVERRIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x17158660)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DialogueEntityInteractOverride_TypeDefinitionIndex = 18687;
