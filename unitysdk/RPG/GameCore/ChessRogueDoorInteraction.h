...
#define RPG_GAMECORE_CHESSROGUEDOORINTERACTION_METHOD_3_00321FD48E40AB10_OFFSET UNITYSDK_OFFSET(0x1708DB60)
#define RPG_GAMECORE_CHESSROGUEDOORINTERACTION_METHOD_3_076F9B2EF8FAAAC9_OFFSET UNITYSDK_OFFSET(0x1708DAE0)
#define RPG_GAMECORE_CHESSROGUEDOORINTERACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1708DB30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChessRogueDoorInteraction_TypeDefinitionIndex = 20278;
