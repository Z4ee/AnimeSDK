...
#define RPG_GAMECORE_SETSTANCEHINTEFFECT_METHOD_3_67111A1BBD172180_OFFSET UNITYSDK_OFFSET(0x176DF7F0)
#define RPG_GAMECORE_SETSTANCEHINTEFFECT_METHOD_3_D7FE20C1F7BCCA14_OFFSET UNITYSDK_OFFSET(0x176DF8D0)
#define RPG_GAMECORE_SETSTANCEHINTEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x176DF870)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetStanceHintEffect_TypeDefinitionIndex = 21907;
