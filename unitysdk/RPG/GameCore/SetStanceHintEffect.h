...
#define RPG_GAMECORE_SETSTANCEHINTEFFECT_METHOD_3_C3B348A5A7F6ACF3_OFFSET UNITYSDK_OFFSET(0x1E08EA80)
#define RPG_GAMECORE_SETSTANCEHINTEFFECT_METHOD_3_D7FE20C1F7BCCA14_OFFSET UNITYSDK_OFFSET(0x1E08EB20)
#define RPG_GAMECORE_SETSTANCEHINTEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E08EAE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetStanceHintEffect_TypeDefinitionIndex = 23385;
