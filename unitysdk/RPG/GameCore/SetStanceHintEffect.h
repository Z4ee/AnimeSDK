...
#define RPG_GAMECORE_SETSTANCEHINTEFFECT_METHOD_3_67111A1BBD172180_OFFSET UNITYSDK_OFFSET(0x19C5FA00)
#define RPG_GAMECORE_SETSTANCEHINTEFFECT_METHOD_3_D7FE20C1F7BCCA14_OFFSET UNITYSDK_OFFSET(0x19C5FAE0)
#define RPG_GAMECORE_SETSTANCEHINTEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x19C5FA80)
