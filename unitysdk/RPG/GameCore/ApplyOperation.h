...
#define RPG_GAMECORE_APPLYOPERATION_METHOD_3_8561C2DC7FB90A3F_OFFSET UNITYSDK_OFFSET(0x186A8240)
#define RPG_GAMECORE_APPLYOPERATION_METHOD_3_C4E96B1947524B0E_OFFSET UNITYSDK_OFFSET(0x186A81B0)
#define RPG_GAMECORE_APPLYOPERATION__CTOR_OFFSET UNITYSDK_OFFSET(0x186A8210)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ApplyOperation_TypeDefinitionIndex = 22632;
