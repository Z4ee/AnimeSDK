...
#define RPG_GAMECORE_LGAMEENTITYREF_METHOD_2_5472FF12F81F7231_OFFSET UNITYSDK_OFFSET(0x1732C310)
#define RPG_GAMECORE_LGAMEENTITYREF__CTOR_OFFSET UNITYSDK_OFFSET(0x1732C450)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LGameEntityRef_TypeDefinitionIndex = 17333;
