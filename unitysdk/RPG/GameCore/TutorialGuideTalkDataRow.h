...
#define RPG_GAMECORE_TUTORIALGUIDETALKDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x190DAE80)
#define RPG_GAMECORE_TUTORIALGUIDETALKDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x190DB4E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TutorialGuideTalkDataRow_TypeDefinitionIndex = 14594;
