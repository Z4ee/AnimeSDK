...
#define RPG_GAMECORE_TUTORIALGUIDETALKDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B06D460)
#define RPG_GAMECORE_TUTORIALGUIDETALKDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B06DE00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TutorialGuideTalkDataRow_TypeDefinitionIndex = 14775;
