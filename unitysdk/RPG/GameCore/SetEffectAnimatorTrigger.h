...
#define RPG_GAMECORE_SETEFFECTANIMATORTRIGGER_METHOD_3_C0662E5A8A1D14A6_OFFSET UNITYSDK_OFFSET(0x176C9A30)
#define RPG_GAMECORE_SETEFFECTANIMATORTRIGGER_METHOD_3_E9532BFCB05269D7_OFFSET UNITYSDK_OFFSET(0x176C9AB0)
#define RPG_GAMECORE_SETEFFECTANIMATORTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x176C9A80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetEffectAnimatorTrigger_TypeDefinitionIndex = 21086;
