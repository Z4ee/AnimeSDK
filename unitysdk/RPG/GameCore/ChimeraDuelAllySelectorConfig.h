...
#define RPG_GAMECORE_CHIMERADUELALLYSELECTORCONFIG_METHOD_3_197C0DE26EC86861_OFFSET UNITYSDK_OFFSET(0x1C390A90)
#define RPG_GAMECORE_CHIMERADUELALLYSELECTORCONFIG_METHOD_3_BEBDFB2246C219CC_OFFSET UNITYSDK_OFFSET(0x1C390B30)
#define RPG_GAMECORE_CHIMERADUELALLYSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C390B20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelAllySelectorConfig_TypeDefinitionIndex = 15327;
