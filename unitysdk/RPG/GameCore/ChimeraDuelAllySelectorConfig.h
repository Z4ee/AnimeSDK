...
#define RPG_GAMECORE_CHIMERADUELALLYSELECTORCONFIG_METHOD_3_197C0DE26EC86861_OFFSET UNITYSDK_OFFSET(0x1E32CDA0)
#define RPG_GAMECORE_CHIMERADUELALLYSELECTORCONFIG_METHOD_3_BEBDFB2246C219CC_OFFSET UNITYSDK_OFFSET(0x1E32CE40)
#define RPG_GAMECORE_CHIMERADUELALLYSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1E32CE30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelAllySelectorConfig_TypeDefinitionIndex = 15764;
