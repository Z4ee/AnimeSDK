...
#define RPG_GAMECORE_CHIMERADUELALLYSELECTORCONFIG_METHOD_3_197C0DE26EC86861_OFFSET UNITYSDK_OFFSET(0x187F4A20)
#define RPG_GAMECORE_CHIMERADUELALLYSELECTORCONFIG_METHOD_3_BEBDFB2246C219CC_OFFSET UNITYSDK_OFFSET(0x187F4AC0)
#define RPG_GAMECORE_CHIMERADUELALLYSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x187F4AB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelAllySelectorConfig_TypeDefinitionIndex = 15100;
