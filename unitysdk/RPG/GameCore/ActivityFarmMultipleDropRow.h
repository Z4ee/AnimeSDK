...
#define RPG_GAMECORE_ACTIVITYFARMMULTIPLEDROPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CD893F0)
#define RPG_GAMECORE_ACTIVITYFARMMULTIPLEDROPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD89ED0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID BannerText; // 0x28
		::RPG::Client::TextID LabelText; // 0x38
		::RPG::GameCore::ActivityCountRefreshType CountRefreshType; // 0x48
		::System::UInt32 ActivityModuleID; // 0x4C
		::RPG::GameCore::ActivityFarmMultipleDropType Type; // 0x50
		::System::UInt32 DropMultiple; // 0x54
		::System::UInt32 Priority; // 0x58
		::System::UInt32 ID; // 0x5C
		::RPG::Client::TextID ActivityPanelBannerText; // 0x60
		::RPG::Client::TextID HintText; // 0x70
		::RPG::Client::TextID MappingInfoBannerText; // 0x80
		::System::UInt32 ActivityThemeID; // 0x90
		::System::UInt32 CountValue; // 0x94
