...
#define RPG_GAMECORE_PROPSETUPTRIGGER_METHOD_3_61F3686B46B57398_OFFSET UNITYSDK_OFFSET(0x17526E90)
#define RPG_GAMECORE_PROPSETUPTRIGGER_METHOD_3_DE6D2D8B1BB289DA_OFFSET UNITYSDK_OFFSET(0x17526FC0)
#define RPG_GAMECORE_PROPSETUPTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x17526F40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropSetupTrigger_TypeDefinitionIndex = 18641;
