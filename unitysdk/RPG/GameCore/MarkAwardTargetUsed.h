...
#define RPG_GAMECORE_MARKAWARDTARGETUSED_METHOD_3_908137597B01E721_OFFSET UNITYSDK_OFFSET(0x1739F2B0)
#define RPG_GAMECORE_MARKAWARDTARGETUSED_METHOD_3_9B17F28E2E115E2D_OFFSET UNITYSDK_OFFSET(0x1739F1A0)
#define RPG_GAMECORE_MARKAWARDTARGETUSED__CTOR_OFFSET UNITYSDK_OFFSET(0x1739F280)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarkAwardTargetUsed_TypeDefinitionIndex = 18442;
