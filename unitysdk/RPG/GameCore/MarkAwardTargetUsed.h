...
#define RPG_GAMECORE_MARKAWARDTARGETUSED_METHOD_3_908137597B01E721_OFFSET UNITYSDK_OFFSET(0x1D25C740)
#define RPG_GAMECORE_MARKAWARDTARGETUSED_METHOD_3_EFB8BF158325FDA4_OFFSET UNITYSDK_OFFSET(0x1D25C670)
#define RPG_GAMECORE_MARKAWARDTARGETUSED__CTOR_OFFSET UNITYSDK_OFFSET(0x1D25C730)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarkAwardTargetUsed_TypeDefinitionIndex = 19924;
