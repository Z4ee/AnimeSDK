...
#define RPG_GAMECORE_ADVENTUREBYNPCMAZESKILLCOOLDOWN_METHOD_4_BFB352B4CA188CDC_OFFSET UNITYSDK_OFFSET(0x18671230)
#define RPG_GAMECORE_ADVENTUREBYNPCMAZESKILLCOOLDOWN_METHOD_4_E05AFA8BA73DAA96_OFFSET UNITYSDK_OFFSET(0x18671300)
#define RPG_GAMECORE_ADVENTUREBYNPCMAZESKILLCOOLDOWN__CTOR_OFFSET UNITYSDK_OFFSET(0x186712B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureByNpcMazeSkillCooldown_TypeDefinitionIndex = 18929;
