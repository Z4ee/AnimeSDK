...
#define RPG_GAMECORE_ROGUEACTPERSONARANDOMADDROOMCARDCONFIG_METHOD_6_2F105D65D2D84D26_OFFSET UNITYSDK_OFFSET(0x175BE9D0)
#define RPG_GAMECORE_ROGUEACTPERSONARANDOMADDROOMCARDCONFIG_METHOD_6_FE67083D7CA07EB3_OFFSET UNITYSDK_OFFSET(0x175BEBF0)
#define RPG_GAMECORE_ROGUEACTPERSONARANDOMADDROOMCARDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175BEB10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaRandomAddRoomCardConfig_TypeDefinitionIndex = 18104;
