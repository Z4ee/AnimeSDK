...
#define RPG_GAMECORE_ROGUEACTPERSONARANDOMADDROOMCARDCONFIG_METHOD_6_B4C8E2F7BCA717EF_OFFSET UNITYSDK_OFFSET(0x1D02F860)
#define RPG_GAMECORE_ROGUEACTPERSONARANDOMADDROOMCARDCONFIG_METHOD_6_FE67083D7CA07EB3_OFFSET UNITYSDK_OFFSET(0x1D02F8B0)
#define RPG_GAMECORE_ROGUEACTPERSONARANDOMADDROOMCARDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D02F8A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaRandomAddRoomCardConfig_TypeDefinitionIndex = 18992;
