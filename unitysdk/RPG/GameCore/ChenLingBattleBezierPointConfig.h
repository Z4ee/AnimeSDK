...
#define RPG_GAMECORE_CHENLINGBATTLEBEZIERPOINTCONFIG_METHOD_2_C020CE49A7F2D1FE_OFFSET UNITYSDK_OFFSET(0x1C378EB0)
#define RPG_GAMECORE_CHENLINGBATTLEBEZIERPOINTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C379260)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleBezierPointConfig_TypeDefinitionIndex = 15107;
