...
#define RPG_GAMECORE_CHENLINGFESCELLCONFIG_METHOD_3_2E734196BD4CBB30_OFFSET UNITYSDK_OFFSET(0x1CFB2480)
#define RPG_GAMECORE_CHENLINGFESCELLCONFIG_METHOD_3_7109CC106C39CA02_OFFSET UNITYSDK_OFFSET(0x1CFB24E0)
#define RPG_GAMECORE_CHENLINGFESCELLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFB24D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingFesCellConfig_TypeDefinitionIndex = 18226;
