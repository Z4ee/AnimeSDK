...
#define RPG_GAMECORE_PLAYAEONTALK_METHOD_4_308B48D2B9215BD5_OFFSET UNITYSDK_OFFSET(0x174C0890)
#define RPG_GAMECORE_PLAYAEONTALK_METHOD_4_398DBB32D27E48FC_OFFSET UNITYSDK_OFFSET(0x174C0810)
#define RPG_GAMECORE_PLAYAEONTALK__CTOR_OFFSET UNITYSDK_OFFSET(0x174C0860)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayAeonTalk_TypeDefinitionIndex = 19416;
