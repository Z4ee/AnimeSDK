...
#define RPG_GAMECORE_PLAYAEONTALK_METHOD_4_7E8D1EDFC23EEA67_OFFSET UNITYSDK_OFFSET(0x1BA01F30)
#define RPG_GAMECORE_PLAYAEONTALK_METHOD_4_A34B847C50998E52_OFFSET UNITYSDK_OFFSET(0x1BA01EF0)
#define RPG_GAMECORE_PLAYAEONTALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA01F20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayAeonTalk_TypeDefinitionIndex = 20319;
