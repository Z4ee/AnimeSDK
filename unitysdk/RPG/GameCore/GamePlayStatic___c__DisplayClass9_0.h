...
#define RPG_GAMECORE_GAMEPLAYSTATIC___C__DISPLAYCLASS9_0__CTOR_OFFSET UNITYSDK_OFFSET(0x18425DB0)
#define RPG_GAMECORE_GAMEPLAYSTATIC___C__DISPLAYCLASS9_0__PRECALCSKILLSTANCE_B__0_OFFSET UNITYSDK_OFFSET(0x18432F80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GamePlayStatic___c__DisplayClass9_0_TypeDefinitionIndex = 59203;
	...
	public:
		...
		::RPG::GameCore::FixPoint totalForceAddRatio; // 0x38
		::RPG::GameCore::FixPoint totalAddValue; // 0x40
		::RPG::GameCore::FixPoint totalStanceBreakAddRatio; // 0x48
		::RPG::GameCore::FixPoint totalForceStanceBreakRatio; // 0x50
		::RPG::GameCore::FixPoint totalForceAddValue; // 0x58
		::RPG::GameCore::AttackDamageType addweaknessList; // 0x60
		::System::Boolean forceStanceDamage; // 0x64
		::RPG::GameCore::FixPoint totalMultiplyRatio; // 0x68
