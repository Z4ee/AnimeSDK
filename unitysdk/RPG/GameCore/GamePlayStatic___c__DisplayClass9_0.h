...
#define RPG_GAMECORE_GAMEPLAYSTATIC___C__DISPLAYCLASS9_0__CTOR_OFFSET UNITYSDK_OFFSET(0xE65A760)
#define RPG_GAMECORE_GAMEPLAYSTATIC___C__DISPLAYCLASS9_0__PRECALCSKILLSTANCE_B__0_OFFSET UNITYSDK_OFFSET(0xE6678F0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::AttackDamageType addweaknessList; // 0x48
		::System::Boolean forceStanceDamage; // 0x4C
		...
		::RPG::GameCore::FixPoint totalStanceBreakAddRatio; // 0x68
