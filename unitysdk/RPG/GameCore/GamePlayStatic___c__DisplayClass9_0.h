...
#define RPG_GAMECORE_GAMEPLAYSTATIC___C__DISPLAYCLASS9_0__CTOR_OFFSET UNITYSDK_OFFSET(0x154FF800)
#define RPG_GAMECORE_GAMEPLAYSTATIC___C__DISPLAYCLASS9_0__PRECALCSKILLSTANCE_B__0_OFFSET UNITYSDK_OFFSET(0x1550C7F0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::AttackDamageType addweaknessList; // 0x30
		::System::Boolean forceStanceDamage; // 0x34
		::RPG::GameCore::FixPoint totalAddValue; // 0x38
		::RPG::GameCore::FixPoint totalStanceBreakAddRatio; // 0x40
		::RPG::GameCore::FixPoint totalForceAddValue; // 0x48
		::RPG::GameCore::FixPoint totalForceAddRatio; // 0x50
		::RPG::GameCore::FixPoint totalAddRatio; // 0x58
