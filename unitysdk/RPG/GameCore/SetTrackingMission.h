...
#define RPG_GAMECORE_SETTRACKINGMISSION_METHOD_3_12C442B859D2299D_OFFSET UNITYSDK_OFFSET(0x1D514120)
#define RPG_GAMECORE_SETTRACKINGMISSION_METHOD_3_57BD5B8D950E2346_OFFSET UNITYSDK_OFFSET(0x1D5140E0)
#define RPG_GAMECORE_SETTRACKINGMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D514110)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetTrackingMission_TypeDefinitionIndex = 20523;
