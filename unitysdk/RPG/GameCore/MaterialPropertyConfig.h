...
#define RPG_GAMECORE_MATERIALPROPERTYCONFIG_METHOD_2_8BB0DDAB1B8A86D0_OFFSET UNITYSDK_OFFSET(0x18AC7A40)
#define RPG_GAMECORE_MATERIALPROPERTYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18AC7C50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MaterialPropertyConfig_TypeDefinitionIndex = 15628;
