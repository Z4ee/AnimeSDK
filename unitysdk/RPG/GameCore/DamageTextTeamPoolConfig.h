...
#define RPG_GAMECORE_DAMAGETEXTTEAMPOOLCONFIG_METHOD_2_68F117186625E969_OFFSET UNITYSDK_OFFSET(0x17149890)
#define RPG_GAMECORE_DAMAGETEXTTEAMPOOLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17149AA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DamageTextTeamPoolConfig_TypeDefinitionIndex = 15713;
