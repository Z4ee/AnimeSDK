...
#define RPG_GAMECORE_DAMAGETEXTTEAMPOOLCONFIG_METHOD_2_1267694444390973_OFFSET UNITYSDK_OFFSET(0x1C0F9570)
#define RPG_GAMECORE_DAMAGETEXTTEAMPOOLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0F9770)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DamageTextTeamPoolConfig_TypeDefinitionIndex = 16459;
