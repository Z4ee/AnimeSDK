...
#define RPG_GAMECORE_ACTIVITYFIGHTGROUPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16EF9EF0)
#define RPG_GAMECORE_ACTIVITYFIGHTGROUPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16EFA780)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID FightStageDesc; // 0x18
		...
		::System::UInt32 ActivityFightGroupID; // 0x48
