...
#define RPG_GAMECORE_TRAINPARTYMODIFIERADDCARDWEIGHTCONFIG_METHOD_3_53222C0D151EE8B5_OFFSET UNITYSDK_OFFSET(0x19DF6070)
#define RPG_GAMECORE_TRAINPARTYMODIFIERADDCARDWEIGHTCONFIG_METHOD_3_ADAD932C524F31B9_OFFSET UNITYSDK_OFFSET(0x19DF60C0)
#define RPG_GAMECORE_TRAINPARTYMODIFIERADDCARDWEIGHTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19DF60B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyModifierAddCardWeightConfig_TypeDefinitionIndex = 17214;
