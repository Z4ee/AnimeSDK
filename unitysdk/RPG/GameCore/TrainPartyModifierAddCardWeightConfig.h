...
#define RPG_GAMECORE_TRAINPARTYMODIFIERADDCARDWEIGHTCONFIG_METHOD_3_53222C0D151EE8B5_OFFSET UNITYSDK_OFFSET(0x1D536460)
#define RPG_GAMECORE_TRAINPARTYMODIFIERADDCARDWEIGHTCONFIG_METHOD_3_ADAD932C524F31B9_OFFSET UNITYSDK_OFFSET(0x1D5364B0)
#define RPG_GAMECORE_TRAINPARTYMODIFIERADDCARDWEIGHTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5364A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyModifierAddCardWeightConfig_TypeDefinitionIndex = 17893;
