...
#define RPG_GAMECORE_TRAINPARTYCONDTRUECONFIG_METHOD_5_1CA2F0CBEA04C73F_OFFSET UNITYSDK_OFFSET(0x19DF3B80)
#define RPG_GAMECORE_TRAINPARTYCONDTRUECONFIG_METHOD_5_F32D92E3D06B4655_OFFSET UNITYSDK_OFFSET(0x19DF3CB0)
#define RPG_GAMECORE_TRAINPARTYCONDTRUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19DF3C30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyCondTrueConfig_TypeDefinitionIndex = 17195;
