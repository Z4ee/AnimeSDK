...
#define RPG_GAMECORE_TRAINPARTYCONDTRUECONFIG_METHOD_5_A6D450DA86470231_OFFSET UNITYSDK_OFFSET(0x1C15F1A0)
#define RPG_GAMECORE_TRAINPARTYCONDTRUECONFIG_METHOD_5_F32D92E3D06B4655_OFFSET UNITYSDK_OFFSET(0x1C15F1F0)
#define RPG_GAMECORE_TRAINPARTYCONDTRUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C15F1E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyCondTrueConfig_TypeDefinitionIndex = 17357;
