...
#define RPG_GAMECORE_STAGEINFINITEMONSTERGROUPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19CAAD20)
#define RPG_GAMECORE_STAGEINFINITEMONSTERGROUPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19CAAE70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StageInfiniteMonsterGroupRow_TypeDefinitionIndex = 14415;
