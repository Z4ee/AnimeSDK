...
#define RPG_GAMECORE_CHIMERADELETEEFFECT_METHOD_3_61DACDDBFDA1BFA7_OFFSET UNITYSDK_OFFSET(0x17093BB0)
#define RPG_GAMECORE_CHIMERADELETEEFFECT_METHOD_3_78077D5D8AB0B6BD_OFFSET UNITYSDK_OFFSET(0x17094EA0)
#define RPG_GAMECORE_CHIMERADELETEEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x17093BA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDeleteEffect_TypeDefinitionIndex = 14558;
