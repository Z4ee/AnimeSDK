...
#define RPG_GAMECORE_CHIMERADELETEEFFECT_METHOD_3_61DACDDBFDA1BFA7_OFFSET UNITYSDK_OFFSET(0x1C38EFC0)
#define RPG_GAMECORE_CHIMERADELETEEFFECT_METHOD_3_78077D5D8AB0B6BD_OFFSET UNITYSDK_OFFSET(0x1C3902C0)
#define RPG_GAMECORE_CHIMERADELETEEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C38EFB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDeleteEffect_TypeDefinitionIndex = 15255;
