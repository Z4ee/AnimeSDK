...
#define RPG_GAMECORE_LITTLEGAMEABILITYEFFECTPIXAIRINSTANTUSECONFIG_METHOD_3_9822AE7EB57937E3_OFFSET UNITYSDK_OFFSET(0x1B092E20)
#define RPG_GAMECORE_LITTLEGAMEABILITYEFFECTPIXAIRINSTANTUSECONFIG_METHOD_3_FA2E597FDCA0F162_OFFSET UNITYSDK_OFFSET(0x1B092EC0)
#define RPG_GAMECORE_LITTLEGAMEABILITYEFFECTPIXAIRINSTANTUSECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B092EB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityEffectPixAirInstantUseConfig_TypeDefinitionIndex = 20546;
