...
#define RPG_GAMECORE_DAILYACTIVETYPEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1968BB50)
#define RPG_GAMECORE_DAILYACTIVETYPEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1968BC70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DailyActiveTypeRow_TypeDefinitionIndex = 12483;

	class DailyActiveTypeRow : public ::System::Object
	{
	public:
		::System::UInt32 PoolSort; // 0x10
