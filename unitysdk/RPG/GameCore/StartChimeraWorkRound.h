...
#define RPG_GAMECORE_STARTCHIMERAWORKROUND_METHOD_3_4ED8441665218448_OFFSET UNITYSDK_OFFSET(0x18E99CF0)
#define RPG_GAMECORE_STARTCHIMERAWORKROUND_METHOD_3_9401EE6F1DAD0751_OFFSET UNITYSDK_OFFSET(0x18E99C70)
#define RPG_GAMECORE_STARTCHIMERAWORKROUND__CTOR_OFFSET UNITYSDK_OFFSET(0x18E99CC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StartChimeraWorkRound_TypeDefinitionIndex = 20579;
