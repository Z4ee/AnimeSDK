...
#define RPG_GAMECORE_CHIMERAWORKPHASE_METHOD_2_76BB5948732C447D_OFFSET UNITYSDK_OFFSET(0x170AD7B0)
#define RPG_GAMECORE_CHIMERAWORKPHASE__CTOR_OFFSET UNITYSDK_OFFSET(0x170AD890)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraWorkPhase_TypeDefinitionIndex = 14578;
