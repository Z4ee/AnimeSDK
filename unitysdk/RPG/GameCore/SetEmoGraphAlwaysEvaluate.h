...
#define RPG_GAMECORE_SETEMOGRAPHALWAYSEVALUATE_METHOD_3_1E0BB5336BD7DF92_OFFSET UNITYSDK_OFFSET(0x1D4FB570)
#define RPG_GAMECORE_SETEMOGRAPHALWAYSEVALUATE_METHOD_3_DF08789013747E45_OFFSET UNITYSDK_OFFSET(0x1D4FB5B0)
#define RPG_GAMECORE_SETEMOGRAPHALWAYSEVALUATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4FB5A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetEmoGraphAlwaysEvaluate_TypeDefinitionIndex = 21639;
