...
#define RPG_GAMECORE_SETEMOGRAPHALWAYSEVALUATE_METHOD_3_DF08789013747E45_OFFSET UNITYSDK_OFFSET(0x18E2D910)
#define RPG_GAMECORE_SETEMOGRAPHALWAYSEVALUATE_METHOD_3_DF7DF52286EEC609_OFFSET UNITYSDK_OFFSET(0x18E2D890)
#define RPG_GAMECORE_SETEMOGRAPHALWAYSEVALUATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E2D8E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetEmoGraphAlwaysEvaluate_TypeDefinitionIndex = 20737;
