...
#define RPG_GAMECORE_ITEMRARITYCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17323690)
#define RPG_GAMECORE_ITEMRARITYCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17323990)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::System::String* LineItemRarityColor; // 0x10
		...
		::System::String* FrameItemRarityColor; // 0x38
