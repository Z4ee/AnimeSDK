...
#define RPG_GAMECORE_LEVELPEDESTRIANV2BAKEDINFO_METHOD_2_3A05214E4CF61A9A_OFFSET UNITYSDK_OFFSET(0x19882300)
#define RPG_GAMECORE_LEVELPEDESTRIANV2BAKEDINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19882460)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPedestrianV2BakedInfo_TypeDefinitionIndex = 16291;
