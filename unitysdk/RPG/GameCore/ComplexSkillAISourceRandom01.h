...
#define RPG_GAMECORE_COMPLEXSKILLAISOURCERANDOM01_METHOD_3_63DD53EA7040E979_OFFSET UNITYSDK_OFFSET(0x17127E30)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCERANDOM01_METHOD_3_E6E758526A2FC6C5_OFFSET UNITYSDK_OFFSET(0x17129340)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCERANDOM01__CTOR_OFFSET UNITYSDK_OFFSET(0x17127E10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAISourceRandom01_TypeDefinitionIndex = 14249;
