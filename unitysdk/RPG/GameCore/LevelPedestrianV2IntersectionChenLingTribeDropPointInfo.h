...
#define RPG_GAMECORE_LEVELPEDESTRIANV2INTERSECTIONCHENLINGTRIBEDROPPOINTINFO_METHOD_2_EC8589995696CC46_OFFSET UNITYSDK_OFFSET(0x1D1E7940)
#define RPG_GAMECORE_LEVELPEDESTRIANV2INTERSECTIONCHENLINGTRIBEDROPPOINTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1E7A90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPedestrianV2IntersectionChenLingTribeDropPointInfo_TypeDefinitionIndex = 17114;
