...
#define RPG_GAMECORE_MAPPROPCONDITIONCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x198C00E0)
#define RPG_GAMECORE_MAPPROPCONDITIONCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x198C07C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MapPropConditionConfigRow_TypeDefinitionIndex = 11965;
