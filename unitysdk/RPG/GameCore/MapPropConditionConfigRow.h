...
#define RPG_GAMECORE_MAPPROPCONDITIONCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1737EB50)
#define RPG_GAMECORE_MAPPROPCONDITIONCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1737F260)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MapPropConditionConfigRow_TypeDefinitionIndex = 11470;
	...
	public:
		...
		::System::UInt32 MiniMapIconID; // 0x30
