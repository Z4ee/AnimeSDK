...
#define RPG_GAMECORE_SHIELDMODIFIERCONSTKEYS_METHOD_2_03659F9A5627B045_OFFSET UNITYSDK_OFFSET(0x176EF180)
#define RPG_GAMECORE_SHIELDMODIFIERCONSTKEYS__CTOR_OFFSET UNITYSDK_OFFSET(0x176EF6F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShieldModifierConstKeys_TypeDefinitionIndex = 15669;
