...
#define RPG_GAMECORE_SHIELDMODIFIERCONSTKEYS_METHOD_2_03659F9A5627B045_OFFSET UNITYSDK_OFFSET(0x19C6EC70)
#define RPG_GAMECORE_SHIELDMODIFIERCONSTKEYS__CTOR_OFFSET UNITYSDK_OFFSET(0x19C6F1E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShieldModifierConstKeys_TypeDefinitionIndex = 16234;
