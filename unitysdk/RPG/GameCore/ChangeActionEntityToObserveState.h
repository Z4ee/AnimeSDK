...
#define RPG_GAMECORE_CHANGEACTIONENTITYTOOBSERVESTATE_METHOD_3_46587AD3AC4429D7_OFFSET UNITYSDK_OFFSET(0x1D114F80)
#define RPG_GAMECORE_CHANGEACTIONENTITYTOOBSERVESTATE_METHOD_3_BC24A27B696C4540_OFFSET UNITYSDK_OFFSET(0x1D114F30)
#define RPG_GAMECORE_CHANGEACTIONENTITYTOOBSERVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D114F70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChangeActionEntityToObserveState_TypeDefinitionIndex = 23187;
