...
#define RPG_GAMECORE_CHANGEACTIONENTITYTOOBSERVESTATE_METHOD_3_1B0923478BA88933_OFFSET UNITYSDK_OFFSET(0x187C4CF0)
#define RPG_GAMECORE_CHANGEACTIONENTITYTOOBSERVESTATE_METHOD_3_46587AD3AC4429D7_OFFSET UNITYSDK_OFFSET(0x187C4D90)
#define RPG_GAMECORE_CHANGEACTIONENTITYTOOBSERVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x187C4D50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChangeActionEntityToObserveState_TypeDefinitionIndex = 22419;
