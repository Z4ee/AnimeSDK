...
#define RPG_GAMECORE_FIVEDIMWATERREFLECTIONCONFIG_METHOD_3_24440A6ED4009A44_OFFSET UNITYSDK_OFFSET(0x1975E0E0)
#define RPG_GAMECORE_FIVEDIMWATERREFLECTIONCONFIG_METHOD_3_F65931ED307B1E85_OFFSET UNITYSDK_OFFSET(0x1975E150)
#define RPG_GAMECORE_FIVEDIMWATERREFLECTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1975E130)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimWaterReflectionConfig_TypeDefinitionIndex = 17698;
