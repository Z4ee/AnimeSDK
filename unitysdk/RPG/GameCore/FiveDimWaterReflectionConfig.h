...
#define RPG_GAMECORE_FIVEDIMWATERREFLECTIONCONFIG_METHOD_3_C8E1A5F7768416FC_OFFSET UNITYSDK_OFFSET(0x1BEB8CF0)
#define RPG_GAMECORE_FIVEDIMWATERREFLECTIONCONFIG_METHOD_3_F65931ED307B1E85_OFFSET UNITYSDK_OFFSET(0x1BEB8D30)
#define RPG_GAMECORE_FIVEDIMWATERREFLECTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEB8D20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimWaterReflectionConfig_TypeDefinitionIndex = 17872;
