...
#define RPG_GAMECORE_LEVELPEDESTRIANFLOWINFO_METHOD_2_73447E5E24EAEC41_OFFSET UNITYSDK_OFFSET(0x18A52B70)
#define RPG_GAMECORE_LEVELPEDESTRIANFLOWINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18A52E00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPedestrianFlowInfo_TypeDefinitionIndex = 16399;
