...
#define RPG_GAMECORE_FIVEDIMSUIYANGCONFIG_METHOD_3_2748BADC9035E714_OFFSET UNITYSDK_OFFSET(0x1720EBF0)
#define RPG_GAMECORE_FIVEDIMSUIYANGCONFIG_METHOD_3_A88E8512A985E8E2_OFFSET UNITYSDK_OFFSET(0x1720EB80)
#define RPG_GAMECORE_FIVEDIMSUIYANGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1720EBD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSuiyangConfig_TypeDefinitionIndex = 17278;
