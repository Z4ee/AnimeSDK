...
#define RPG_GAMECORE_FIVEDIMSUIYANGCONFIG_METHOD_3_2748BADC9035E714_OFFSET UNITYSDK_OFFSET(0x1975A650)
#define RPG_GAMECORE_FIVEDIMSUIYANGCONFIG_METHOD_3_A88E8512A985E8E2_OFFSET UNITYSDK_OFFSET(0x1975A5E0)
#define RPG_GAMECORE_FIVEDIMSUIYANGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1975A630)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSuiyangConfig_TypeDefinitionIndex = 17915;
