...
#define RPG_GAMECORE_FIVEDIMSUIYANGCONFIG_METHOD_3_2748BADC9035E714_OFFSET UNITYSDK_OFFSET(0x1DCA6D50)
#define RPG_GAMECORE_FIVEDIMSUIYANGCONFIG_METHOD_3_AFD4799B722EF813_OFFSET UNITYSDK_OFFSET(0x1D87E410)
#define RPG_GAMECORE_FIVEDIMSUIYANGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCA6EB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSuiyangConfig_TypeDefinitionIndex = 18617;
