...
#define RPG_GAMECORE_SETMECHANISMBARSTATE_METHOD_3_1FB655EBD3C81A5C_OFFSET UNITYSDK_OFFSET(0x18E38440)
#define RPG_GAMECORE_SETMECHANISMBARSTATE_METHOD_3_3F66443C19DDC5C3_OFFSET UNITYSDK_OFFSET(0x18E384C0)
#define RPG_GAMECORE_SETMECHANISMBARSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E38490)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetMechanismBarState_TypeDefinitionIndex = 19480;
