...
#define RPG_GAMECORE_AVATARDEMOCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C587200)
#define RPG_GAMECORE_AVATARDEMOCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C587E30)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::Il2CppArray<::System::String*>* OverrideDisplaySkillTriggerKeyList; // 0x10
		...
		::Il2CppArray<::System::UInt32>* SPList; // 0x38
		::Il2CppArray<::System::UInt32>* ConfigList1; // 0x40
		::System::Boolean NormalWaveNotShowDetail; // 0x48
		::System::Boolean EnableSwitchAvatar; // 0x49
		::System::Boolean EnableMazeSkillEffect; // 0x4A
		::RPG::GameCore::AvatarDemoStageType StageType; // 0x4C
		...
		::System::UInt32 ScoringGroupID; // 0x80
		::RPG::Client::TextID AvatarDemoTitle; // 0x88
