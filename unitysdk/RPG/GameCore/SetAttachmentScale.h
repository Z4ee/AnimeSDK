...
#define RPG_GAMECORE_SETATTACHMENTSCALE_METHOD_3_78DF49299B7E6A1A_OFFSET UNITYSDK_OFFSET(0x176A6AF0)
#define RPG_GAMECORE_SETATTACHMENTSCALE_METHOD_3_99EE598DBCE2A994_OFFSET UNITYSDK_OFFSET(0x176A6CF0)
#define RPG_GAMECORE_SETATTACHMENTSCALE__CTOR_OFFSET UNITYSDK_OFFSET(0x176A6CB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetAttachmentScale_TypeDefinitionIndex = 20573;
