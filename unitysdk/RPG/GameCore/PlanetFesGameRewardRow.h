...
#define RPG_GAMECORE_PLANETFESGAMEREWARDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19A1D970)
#define RPG_GAMECORE_PLANETFESGAMEREWARDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19A1DB50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlanetFesGameRewardRow_TypeDefinitionIndex = 11680;
	...
	public:
		...
		::System::UInt32 GoldNum; // 0x20
		::System::UInt32 GameRewardID; // 0x24
