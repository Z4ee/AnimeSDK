...
#define RPG_GAMECORE_PROPUNLOADHITBOXGROUP_METHOD_3_6F804EACBCA5C1D9_OFFSET UNITYSDK_OFFSET(0x19A9F320)
#define RPG_GAMECORE_PROPUNLOADHITBOXGROUP_METHOD_3_F971C0CBAAFE6D97_OFFSET UNITYSDK_OFFSET(0x19A9F1D0)
#define RPG_GAMECORE_PROPUNLOADHITBOXGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x19A9F290)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropUnloadHitBoxGroup_TypeDefinitionIndex = 19252;
