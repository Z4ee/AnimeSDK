...
#define RPG_GAMECORE_PROPUNLOADHITBOXGROUP_METHOD_3_6F804EACBCA5C1D9_OFFSET UNITYSDK_OFFSET(0x18C7C9F0)
#define RPG_GAMECORE_PROPUNLOADHITBOXGROUP_METHOD_3_F971C0CBAAFE6D97_OFFSET UNITYSDK_OFFSET(0x18C7C8A0)
#define RPG_GAMECORE_PROPUNLOADHITBOXGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x18C7C960)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropUnloadHitBoxGroup_TypeDefinitionIndex = 19342;
