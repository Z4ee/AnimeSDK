...
#define RPG_GAMECORE_STATETREESELECTSTATECONFIG_METHOD_2_07D210A084BDAD88_OFFSET UNITYSDK_OFFSET(0x18E9D2D0)
#define RPG_GAMECORE_STATETREESELECTSTATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18E9D400)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StateTreeSelectStateConfig_TypeDefinitionIndex = 14663;
