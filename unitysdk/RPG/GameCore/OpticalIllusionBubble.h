...
#define RPG_GAMECORE_OPTICALILLUSIONBUBBLE_METHOD_3_743D12A132072FDE_OFFSET UNITYSDK_OFFSET(0x18BC8140)
#define RPG_GAMECORE_OPTICALILLUSIONBUBBLE_METHOD_3_BEF41EA9F7679924_OFFSET UNITYSDK_OFFSET(0x18BC8290)
#define RPG_GAMECORE_OPTICALILLUSIONBUBBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x18BC8200)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OpticalIllusionBubble_TypeDefinitionIndex = 21098;
