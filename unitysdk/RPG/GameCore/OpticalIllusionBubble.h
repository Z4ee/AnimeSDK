...
#define RPG_GAMECORE_OPTICALILLUSIONBUBBLE_METHOD_3_3FE2D6AF029BB5C6_OFFSET UNITYSDK_OFFSET(0x1BB03BA0)
#define RPG_GAMECORE_OPTICALILLUSIONBUBBLE_METHOD_3_BEF41EA9F7679924_OFFSET UNITYSDK_OFFSET(0x1BB03C20)
#define RPG_GAMECORE_OPTICALILLUSIONBUBBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB03BF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OpticalIllusionBubble_TypeDefinitionIndex = 21416;
