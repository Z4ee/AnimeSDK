...
#define RPG_GAMECORE_OPTICALILLUSIONBUBBLE_METHOD_3_743D12A132072FDE_OFFSET UNITYSDK_OFFSET(0x1747EBA0)
#define RPG_GAMECORE_OPTICALILLUSIONBUBBLE_METHOD_3_BEF41EA9F7679924_OFFSET UNITYSDK_OFFSET(0x1747ECF0)
#define RPG_GAMECORE_OPTICALILLUSIONBUBBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1747EC60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OpticalIllusionBubble_TypeDefinitionIndex = 20416;
