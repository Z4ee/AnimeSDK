...
#define RPG_GAMECORE_CAMERABATTLETRANSITIONBEHITCONFIG_METHOD_2_348B3D7C6AC05BAC_OFFSET UNITYSDK_OFFSET(0x195F32A0)
#define RPG_GAMECORE_CAMERABATTLETRANSITIONBEHITCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x195F34C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CameraBattleTransitionBeHitConfig_TypeDefinitionIndex = 19286;
