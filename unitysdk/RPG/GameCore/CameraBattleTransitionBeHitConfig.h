...
#define RPG_GAMECORE_CAMERABATTLETRANSITIONBEHITCONFIG_METHOD_2_348B3D7C6AC05BAC_OFFSET UNITYSDK_OFFSET(0x1D106860)
#define RPG_GAMECORE_CAMERABATTLETRANSITIONBEHITCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D106A80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CameraBattleTransitionBeHitConfig_TypeDefinitionIndex = 20188;
