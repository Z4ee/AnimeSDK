...
#define RPG_GAMECORE_ROGUEPARAMOWNROGUEMIRACLECOUNTCONFIG_METHOD_6_1BFDEBEFFA2B30EB_OFFSET UNITYSDK_OFFSET(0x19BAEA00)
#define RPG_GAMECORE_ROGUEPARAMOWNROGUEMIRACLECOUNTCONFIG_METHOD_6_EE3CC5BB6CA6BE25_OFFSET UNITYSDK_OFFSET(0x19BAECB0)
#define RPG_GAMECORE_ROGUEPARAMOWNROGUEMIRACLECOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19BAEB80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamOwnRogueMiracleCountConfig_TypeDefinitionIndex = 18796;
