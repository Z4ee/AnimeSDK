...
#define RPG_GAMECORE_FIVEDIMPAUSEMUSICACTION_METHOD_3_3B2914FE013091B4_OFFSET UNITYSDK_OFFSET(0x18911900)
#define RPG_GAMECORE_FIVEDIMPAUSEMUSICACTION_METHOD_3_64C15A810288E0F1_OFFSET UNITYSDK_OFFSET(0x189119C0)
#define RPG_GAMECORE_FIVEDIMPAUSEMUSICACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x189119A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimPauseMusicAction_TypeDefinitionIndex = 17766;
