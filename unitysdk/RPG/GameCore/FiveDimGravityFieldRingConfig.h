...
#define RPG_GAMECORE_FIVEDIMGRAVITYFIELDRINGCONFIG_METHOD_3_114CBDD1AC21341D_OFFSET UNITYSDK_OFFSET(0x18904760)
#define RPG_GAMECORE_FIVEDIMGRAVITYFIELDRINGCONFIG_METHOD_3_CE63A19536A4B258_OFFSET UNITYSDK_OFFSET(0x189047D0)
#define RPG_GAMECORE_FIVEDIMGRAVITYFIELDRINGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189047B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimGravityFieldRingConfig_TypeDefinitionIndex = 17661;
