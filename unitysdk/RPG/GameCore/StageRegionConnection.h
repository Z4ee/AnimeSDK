...
#define RPG_GAMECORE_STAGEREGIONCONNECTION_METHOD_2_EA2CB7BE152764C7_OFFSET UNITYSDK_OFFSET(0x1CAEA500)
#define RPG_GAMECORE_STAGEREGIONCONNECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1CAEA980)
