...
#define RPG_GAMECORE_TARGETFETCHUNIQUENAMEENTITY_METHOD_4_B2F009FEB93A24E1_OFFSET UNITYSDK_OFFSET(0x177C0A00)
#define RPG_GAMECORE_TARGETFETCHUNIQUENAMEENTITY_METHOD_4_CAECCF00305CA616_OFFSET UNITYSDK_OFFSET(0x177B9440)
#define RPG_GAMECORE_TARGETFETCHUNIQUENAMEENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x177B93F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchUniqueNameEntity_TypeDefinitionIndex = 22210;
