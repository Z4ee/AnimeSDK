...
#define RPG_GAMECORE_TARGETFETCHUNIQUENAMEENTITY_METHOD_4_92626796BD6B8D53_OFFSET UNITYSDK_OFFSET(0x1D0BDD50)
#define RPG_GAMECORE_TARGETFETCHUNIQUENAMEENTITY_METHOD_4_C087B29B69EADFEC_OFFSET UNITYSDK_OFFSET(0x1D0BDEB0)
#define RPG_GAMECORE_TARGETFETCHUNIQUENAMEENTITY_METHOD_4_CAECCF00305CA616_OFFSET UNITYSDK_OFFSET(0x1D0BDE10)
#define RPG_GAMECORE_TARGETFETCHUNIQUENAMEENTITY_METHOD_4_F1E403B4188644C3_OFFSET UNITYSDK_OFFSET(0x1D0BDEE0)
#define RPG_GAMECORE_TARGETFETCHUNIQUENAMEENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0BDE00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchUniqueNameEntity_TypeDefinitionIndex = 23078;
