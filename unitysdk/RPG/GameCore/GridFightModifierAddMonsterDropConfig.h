...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDMONSTERDROPCONFIG_METHOD_3_B6DDD2FDEC7AE81C_OFFSET UNITYSDK_OFFSET(0x1D158080)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDMONSTERDROPCONFIG_METHOD_3_C30A30F292E33758_OFFSET UNITYSDK_OFFSET(0x1D1580D0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDMONSTERDROPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1580C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierAddMonsterDropConfig_TypeDefinitionIndex = 19137;
