...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDMONSTERDROPCONFIG_METHOD_3_70901E7570EBC581_OFFSET UNITYSDK_OFFSET(0x197E8A90)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDMONSTERDROPCONFIG_METHOD_3_C30A30F292E33758_OFFSET UNITYSDK_OFFSET(0x197E8B60)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDMONSTERDROPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197E8B10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierAddMonsterDropConfig_TypeDefinitionIndex = 18367;
