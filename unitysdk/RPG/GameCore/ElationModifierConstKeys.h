...
#define RPG_GAMECORE_ELATIONMODIFIERCONSTKEYS_METHOD_2_5FC651935E7C6E80_OFFSET UNITYSDK_OFFSET(0x196D7170)
#define RPG_GAMECORE_ELATIONMODIFIERCONSTKEYS__CTOR_OFFSET UNITYSDK_OFFSET(0x196D7250)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElationModifierConstKeys_TypeDefinitionIndex = 16235;
