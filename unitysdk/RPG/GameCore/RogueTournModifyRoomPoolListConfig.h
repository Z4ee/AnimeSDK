...
#define RPG_GAMECORE_ROGUETOURNMODIFYROOMPOOLLISTCONFIG_METHOD_2_1814731AD2D1CC2F_OFFSET UNITYSDK_OFFSET(0x1BB7C7B0)
#define RPG_GAMECORE_ROGUETOURNMODIFYROOMPOOLLISTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB7C7F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournModifyRoomPoolListConfig_TypeDefinitionIndex = 17283;
