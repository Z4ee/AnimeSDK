...
#define RPG_GAMECORE_LOOPTARGETLIST_METHOD_3_14104223E5AFBA38_OFFSET UNITYSDK_OFFSET(0x17370820)
#define RPG_GAMECORE_LOOPTARGETLIST_METHOD_3_CD1ED9A6FE87B5E6_OFFSET UNITYSDK_OFFSET(0x17370940)
#define RPG_GAMECORE_LOOPTARGETLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x173708C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoopTargetList_TypeDefinitionIndex = 21093;
