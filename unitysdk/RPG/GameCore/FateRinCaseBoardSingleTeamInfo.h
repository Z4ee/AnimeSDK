...
#define RPG_GAMECORE_FATERINCASEBOARDSINGLETEAMINFO_METHOD_3_22E06B807C493699_OFFSET UNITYSDK_OFFSET(0x1E0D0D70)
#define RPG_GAMECORE_FATERINCASEBOARDSINGLETEAMINFO_METHOD_3_233FA242FE04973B_OFFSET UNITYSDK_OFFSET(0x1E0D0070)
#define RPG_GAMECORE_FATERINCASEBOARDSINGLETEAMINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0D0060)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateRinCaseBoardSingleTeamInfo_TypeDefinitionIndex = 16056;
