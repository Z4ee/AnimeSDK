...
#define RPG_GAMECORE_ACTIVEFMCHANNELRECEIVER_METHOD_3_42B3EC61249E690A_OFFSET UNITYSDK_OFFSET(0x185FFD50)
#define RPG_GAMECORE_ACTIVEFMCHANNELRECEIVER_METHOD_3_A90264EB663E8783_OFFSET UNITYSDK_OFFSET(0x185FFDD0)
#define RPG_GAMECORE_ACTIVEFMCHANNELRECEIVER__CTOR_OFFSET UNITYSDK_OFFSET(0x185FFDA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActiveFMChannelReceiver_TypeDefinitionIndex = 19545;
