...
#define RPG_GAMECORE_FORCESETDIALOGCAMERA_METHOD_3_794C130D10C15C99_OFFSET UNITYSDK_OFFSET(0x172172B0)
#define RPG_GAMECORE_FORCESETDIALOGCAMERA_METHOD_3_9C2337C39EC7E5E0_OFFSET UNITYSDK_OFFSET(0x17217330)
#define RPG_GAMECORE_FORCESETDIALOGCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x17217300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ForceSetDialogCamera_TypeDefinitionIndex = 19435;
