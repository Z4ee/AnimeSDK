...
#define RPG_GAMECORE_FIVEDIMSWITCHPLATFORMCONFIG_METHOD_3_5A4AA0A18EE8F32B_OFFSET UNITYSDK_OFFSET(0x1DCA8060)
#define RPG_GAMECORE_FIVEDIMSWITCHPLATFORMCONFIG_METHOD_3_842CCE00E11CFDC4_OFFSET UNITYSDK_OFFSET(0x1DCA8020)
#define RPG_GAMECORE_FIVEDIMSWITCHPLATFORMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCA8050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSwitchPlatformConfig_TypeDefinitionIndex = 18344;
