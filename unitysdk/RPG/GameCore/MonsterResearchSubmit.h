...
#define RPG_GAMECORE_MONSTERRESEARCHSUBMIT_METHOD_3_74EB08ED8126A983_OFFSET UNITYSDK_OFFSET(0x17451880)
#define RPG_GAMECORE_MONSTERRESEARCHSUBMIT_METHOD_3_9E21A8F026822E62_OFFSET UNITYSDK_OFFSET(0x17451900)
#define RPG_GAMECORE_MONSTERRESEARCHSUBMIT__CTOR_OFFSET UNITYSDK_OFFSET(0x174518D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonsterResearchSubmit_TypeDefinitionIndex = 19401;
