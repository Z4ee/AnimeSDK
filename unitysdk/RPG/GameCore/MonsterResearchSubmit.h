...
#define RPG_GAMECORE_MONSTERRESEARCHSUBMIT_METHOD_3_0EAC3E5782F11F24_OFFSET UNITYSDK_OFFSET(0x1CE6E230)
#define RPG_GAMECORE_MONSTERRESEARCHSUBMIT_METHOD_3_C5B82F9AEB45750D_OFFSET UNITYSDK_OFFSET(0x1CE6E1F0)
#define RPG_GAMECORE_MONSTERRESEARCHSUBMIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE6E220)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonsterResearchSubmit_TypeDefinitionIndex = 20854;
	...
	public:
		...
		static ::System::Void Method_3_C5B82F9AEB45750D(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::MonsterResearchSubmit*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::MonsterResearchSubmit*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_MONSTERRESEARCHSUBMIT_METHOD_3_C5B82F9AEB45750D_OFFSET))(a1, a2);
		}
