...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYPERSONAROOMCARDGIFTCONFIG_METHOD_3_99022543ABFA9D95_OFFSET UNITYSDK_OFFSET(0x1D3FA3D0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYPERSONAROOMCARDGIFTCONFIG_METHOD_3_B5AEAD6B5012A371_OFFSET UNITYSDK_OFFSET(0x1D3FA380)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYPERSONAROOMCARDGIFTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3FA3C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyPersonaRoomCardGiftConfig_TypeDefinitionIndex = 17657;
