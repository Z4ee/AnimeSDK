...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYPERSONAROOMCARDGIFTCONFIG_METHOD_3_15FC0FF613089ABC_OFFSET UNITYSDK_OFFSET(0x18D417C0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYPERSONAROOMCARDGIFTCONFIG_METHOD_3_99022543ABFA9D95_OFFSET UNITYSDK_OFFSET(0x18D41890)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYPERSONAROOMCARDGIFTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D41840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyPersonaRoomCardGiftConfig_TypeDefinitionIndex = 16966;
