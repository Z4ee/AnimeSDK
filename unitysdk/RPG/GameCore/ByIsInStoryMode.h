...
#define RPG_GAMECORE_BYISINSTORYMODE_METHOD_4_19686E0819704134_OFFSET UNITYSDK_OFFSET(0x1B29DA80)
#define RPG_GAMECORE_BYISINSTORYMODE_METHOD_4_3548E7C880C5C4F7_OFFSET UNITYSDK_OFFSET(0x1B29DCC0)
#define RPG_GAMECORE_BYISINSTORYMODE_METHOD_4_D571A3C9CA182421_OFFSET UNITYSDK_OFFSET(0x1B29DA30)
#define RPG_GAMECORE_BYISINSTORYMODE_METHOD_4_FDD9B3E6E4EE6D20_OFFSET UNITYSDK_OFFSET(0x1B29DC80)
#define RPG_GAMECORE_BYISINSTORYMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B29DA70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsInStoryMode_TypeDefinitionIndex = 19799;
