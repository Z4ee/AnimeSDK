...
#define RPG_GAMECORE_BYISINSTORYMODE_METHOD_4_19686E0819704134_OFFSET UNITYSDK_OFFSET(0x17030060)
#define RPG_GAMECORE_BYISINSTORYMODE_METHOD_4_8F01B29A1B399CE2_OFFSET UNITYSDK_OFFSET(0x1702FF80)
#define RPG_GAMECORE_BYISINSTORYMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x17030000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsInStoryMode_TypeDefinitionIndex = 18891;
