...
#define RPG_GAMECORE_WAITMUSICRHYTHMNOTIFY_METHOD_3_44BB6C27523FFD67_OFFSET UNITYSDK_OFFSET(0x19102820)
#define RPG_GAMECORE_WAITMUSICRHYTHMNOTIFY_METHOD_3_68FEDE06A5BD36C3_OFFSET UNITYSDK_OFFSET(0x191027A0)
#define RPG_GAMECORE_WAITMUSICRHYTHMNOTIFY__CTOR_OFFSET UNITYSDK_OFFSET(0x191027F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitMusicRhythmNotify_TypeDefinitionIndex = 20928;
