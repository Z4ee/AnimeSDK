...
#define RPG_GAMECORE_WAITMUSICRHYTHMNOTIFY_METHOD_3_44BB6C27523FFD67_OFFSET UNITYSDK_OFFSET(0x178FE930)
#define RPG_GAMECORE_WAITMUSICRHYTHMNOTIFY_METHOD_3_68FEDE06A5BD36C3_OFFSET UNITYSDK_OFFSET(0x178FE8B0)
#define RPG_GAMECORE_WAITMUSICRHYTHMNOTIFY__CTOR_OFFSET UNITYSDK_OFFSET(0x178FE900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitMusicRhythmNotify_TypeDefinitionIndex = 20246;
