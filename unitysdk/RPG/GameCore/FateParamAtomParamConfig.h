...
#define RPG_GAMECORE_FATEPARAMATOMPARAMCONFIG_METHOD_6_986CE0FB8DC0AFC1_OFFSET UNITYSDK_OFFSET(0x1C075710)
#define RPG_GAMECORE_FATEPARAMATOMPARAMCONFIG_METHOD_6_C42A31EF1D6FCC25_OFFSET UNITYSDK_OFFSET(0x1C075760)
#define RPG_GAMECORE_FATEPARAMATOMPARAMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C075750)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateParamAtomParamConfig_TypeDefinitionIndex = 15972;
