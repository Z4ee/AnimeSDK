...
#define RPG_GAMECORE_FATEPARAMATOMPARAMCONFIG_METHOD_6_660F7C0DFA079411_OFFSET UNITYSDK_OFFSET(0x188D6D20)
#define RPG_GAMECORE_FATEPARAMATOMPARAMCONFIG_METHOD_6_C42A31EF1D6FCC25_OFFSET UNITYSDK_OFFSET(0x188D6EE0)
#define RPG_GAMECORE_FATEPARAMATOMPARAMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x188D6E20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateParamAtomParamConfig_TypeDefinitionIndex = 15743;
