...
#define RPG_GAMECORE_FATEPARAMATOMPARAMCONFIG_METHOD_6_660F7C0DFA079411_OFFSET UNITYSDK_OFFSET(0x197131D0)
#define RPG_GAMECORE_FATEPARAMATOMPARAMCONFIG_METHOD_6_C42A31EF1D6FCC25_OFFSET UNITYSDK_OFFSET(0x19713390)
#define RPG_GAMECORE_FATEPARAMATOMPARAMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197132D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateParamAtomParamConfig_TypeDefinitionIndex = 15798;
