...
#define RPG_GAMECORE_PROPINTERACTOVERRIDEDATA01_METHOD_3_0251A7754BF5C700_OFFSET UNITYSDK_OFFSET(0x19A90F40)
#define RPG_GAMECORE_PROPINTERACTOVERRIDEDATA01_METHOD_3_93C3B0CCEE802ACF_OFFSET UNITYSDK_OFFSET(0x19A90EC0)
#define RPG_GAMECORE_PROPINTERACTOVERRIDEDATA01__CTOR_OFFSET UNITYSDK_OFFSET(0x19A90F10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropInteractOverrideData01_TypeDefinitionIndex = 19246;
