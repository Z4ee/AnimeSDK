...
#define RPG_GAMECORE_PROPINTERACTOVERRIDEDATA01_METHOD_3_0251A7754BF5C700_OFFSET UNITYSDK_OFFSET(0x1751F860)
#define RPG_GAMECORE_PROPINTERACTOVERRIDEDATA01_METHOD_3_93C3B0CCEE802ACF_OFFSET UNITYSDK_OFFSET(0x1751F7E0)
#define RPG_GAMECORE_PROPINTERACTOVERRIDEDATA01__CTOR_OFFSET UNITYSDK_OFFSET(0x1751F830)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropInteractOverrideData01_TypeDefinitionIndex = 18679;
