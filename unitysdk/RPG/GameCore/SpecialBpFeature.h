...
#define RPG_GAMECORE_SPECIALBPFEATURE_METHOD_2_93069D4652E90C28_OFFSET UNITYSDK_OFFSET(0x1775BC30)
#define RPG_GAMECORE_SPECIALBPFEATURE__CTOR_OFFSET UNITYSDK_OFFSET(0x1775BDB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SpecialBpFeature_TypeDefinitionIndex = 21442;
