...
#define RPG_GAMECORE_FIVEDIMDESTRUCTPROPACTION_METHOD_3_B1678C0D06541207_OFFSET UNITYSDK_OFFSET(0x1D858F50)
#define RPG_GAMECORE_FIVEDIMDESTRUCTPROPACTION_METHOD_3_FFF7CF5398B47A96_OFFSET UNITYSDK_OFFSET(0x1D858ED0)
#define RPG_GAMECORE_FIVEDIMDESTRUCTPROPACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D858F40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimDestructPropAction_TypeDefinitionIndex = 18465;
