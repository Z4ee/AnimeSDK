...
#define RPG_GAMECORE_FIVEDIMDESTRUCTPROPACTION_METHOD_3_B1678C0D06541207_OFFSET UNITYSDK_OFFSET(0x171E6FB0)
#define RPG_GAMECORE_FIVEDIMDESTRUCTPROPACTION_METHOD_3_CE3258685E5B5BCA_OFFSET UNITYSDK_OFFSET(0x171EEF50)
#define RPG_GAMECORE_FIVEDIMDESTRUCTPROPACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x171E6F90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimDestructPropAction_TypeDefinitionIndex = 17140;
