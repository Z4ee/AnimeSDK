...
#define RPG_GAMECORE_FIVEDIMDESTRUCTPROPACTION_METHOD_3_B1678C0D06541207_OFFSET UNITYSDK_OFFSET(0x1972D9B0)
#define RPG_GAMECORE_FIVEDIMDESTRUCTPROPACTION_METHOD_3_CE3258685E5B5BCA_OFFSET UNITYSDK_OFFSET(0x19738930)
#define RPG_GAMECORE_FIVEDIMDESTRUCTPROPACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1972D990)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimDestructPropAction_TypeDefinitionIndex = 17768;
