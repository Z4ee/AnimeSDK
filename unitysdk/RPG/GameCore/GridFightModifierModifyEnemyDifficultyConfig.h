...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERMODIFYENEMYDIFFICULTYCONFIG_METHOD_3_806AEC8F15FC2A83_OFFSET UNITYSDK_OFFSET(0x17268280)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERMODIFYENEMYDIFFICULTYCONFIG_METHOD_3_8B1D66E967632ECA_OFFSET UNITYSDK_OFFSET(0x1726B6C0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERMODIFYENEMYDIFFICULTYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17268230)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierModifyEnemyDifficultyConfig_TypeDefinitionIndex = 17821;
