...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERMODIFYENEMYDIFFICULTYCONFIG_METHOD_3_806AEC8F15FC2A83_OFFSET UNITYSDK_OFFSET(0x197EDED0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERMODIFYENEMYDIFFICULTYCONFIG_METHOD_3_8B1D66E967632ECA_OFFSET UNITYSDK_OFFSET(0x197F2D70)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERMODIFYENEMYDIFFICULTYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197EDE80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierModifyEnemyDifficultyConfig_TypeDefinitionIndex = 18415;
