...
#define RPG_GAMECORE_TEAMMEMBEREXPANSIONFIGHTFORMATIONCONFIG_METHOD_2_3A7BF3A5C6EC57B5_OFFSET UNITYSDK_OFFSET(0x19DDD040)
#define RPG_GAMECORE_TEAMMEMBEREXPANSIONFIGHTFORMATIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19DDD380)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TeamMemberExpansionFightFormationConfig_TypeDefinitionIndex = 15754;
