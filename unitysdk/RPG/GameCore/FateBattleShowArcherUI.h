...
#define RPG_GAMECORE_FATEBATTLESHOWARCHERUI_METHOD_3_7EC8C68B6E459212_OFFSET UNITYSDK_OFFSET(0x171C3E90)
#define RPG_GAMECORE_FATEBATTLESHOWARCHERUI_METHOD_3_B65505FF70817A43_OFFSET UNITYSDK_OFFSET(0x171C3F10)
#define RPG_GAMECORE_FATEBATTLESHOWARCHERUI__CTOR_OFFSET UNITYSDK_OFFSET(0x171C3EE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateBattleShowArcherUI_TypeDefinitionIndex = 21530;
