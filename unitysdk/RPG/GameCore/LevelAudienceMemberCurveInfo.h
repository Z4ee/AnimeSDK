...
#define RPG_GAMECORE_LEVELAUDIENCEMEMBERCURVEINFO_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1732EB20)
#define RPG_GAMECORE_LEVELAUDIENCEMEMBERCURVEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1732ECA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelAudienceMemberCurveInfo_TypeDefinitionIndex = 15906;
