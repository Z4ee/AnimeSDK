...
#define RPG_GAMECORE_PLAYERPARAMLINEUPAVATARCONSUMEHPCOUNTCONFIG_METHOD_5_18A01B3755CBEF52_OFFSET UNITYSDK_OFFSET(0x18C290E0)
#define RPG_GAMECORE_PLAYERPARAMLINEUPAVATARCONSUMEHPCOUNTCONFIG_METHOD_5_3490FA707B17A93E_OFFSET UNITYSDK_OFFSET(0x18C28F20)
#define RPG_GAMECORE_PLAYERPARAMLINEUPAVATARCONSUMEHPCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18C29020)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayerParamLineupAvatarConsumeHpCountConfig_TypeDefinitionIndex = 18572;
