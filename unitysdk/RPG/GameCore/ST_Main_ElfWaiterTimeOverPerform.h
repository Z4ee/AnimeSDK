...
#define RPG_GAMECORE_ST_MAIN_ELFWAITERTIMEOVERPERFORM_METHOD_4_5BA9725F9A8DABDE_OFFSET UNITYSDK_OFFSET(0x18DF08F0)
#define RPG_GAMECORE_ST_MAIN_ELFWAITERTIMEOVERPERFORM_METHOD_4_BFBB43F91C763274_OFFSET UNITYSDK_OFFSET(0x18DF09C0)
#define RPG_GAMECORE_ST_MAIN_ELFWAITERTIMEOVERPERFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x18DF0970)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_ElfWaiterTimeOverPerform_TypeDefinitionIndex = 20384;
