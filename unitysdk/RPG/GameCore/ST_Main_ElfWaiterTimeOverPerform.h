...
#define RPG_GAMECORE_ST_MAIN_ELFWAITERTIMEOVERPERFORM_METHOD_4_20F5E34A9700904F_OFFSET UNITYSDK_OFFSET(0x1DB3CB10)
#define RPG_GAMECORE_ST_MAIN_ELFWAITERTIMEOVERPERFORM_METHOD_4_BFBB43F91C763274_OFFSET UNITYSDK_OFFSET(0x1DB3CB50)
#define RPG_GAMECORE_ST_MAIN_ELFWAITERTIMEOVERPERFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB3CB40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_ElfWaiterTimeOverPerform_TypeDefinitionIndex = 21279;
