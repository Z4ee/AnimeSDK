...
#define RPG_GAMECORE_EVOLVEBUILDCARDTYPEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D7D03F0)
#define RPG_GAMECORE_EVOLVEBUILDCARDTYPEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7D0600)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* CardBuffItemBgSmall; // 0x18
