...
#define RPG_GAMECORE_EVOLVEBUILDCARDTYPEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x171AC840)
#define RPG_GAMECORE_EVOLVEBUILDCARDTYPEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x171ACA50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EvolveBuildCardTypeRow_TypeDefinitionIndex = 10691;
