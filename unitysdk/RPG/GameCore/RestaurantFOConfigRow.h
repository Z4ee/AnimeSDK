...
#define RPG_GAMECORE_RESTAURANTFOCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19AD5490)
#define RPG_GAMECORE_RESTAURANTFOCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19AD5600)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RestaurantFOConfigRow_TypeDefinitionIndex = 10919;
