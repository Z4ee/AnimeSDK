...
#define RPG_GAMECORE_ADVENTUREBYPROPINPOSITION_METHOD_4_EEFC65201823F2D1_OFFSET UNITYSDK_OFFSET(0x16F4F200)
#define RPG_GAMECORE_ADVENTUREBYPROPINPOSITION_METHOD_4_F038CCDB5A5B3FDB_OFFSET UNITYSDK_OFFSET(0x16F4F120)
#define RPG_GAMECORE_ADVENTUREBYPROPINPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x16F4F1A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureByPropInPosition_TypeDefinitionIndex = 19103;
