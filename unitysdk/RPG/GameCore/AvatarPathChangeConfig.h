...
#define RPG_GAMECORE_AVATARPATHCHANGECONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A07C1E0)
#define RPG_GAMECORE_AVATARPATHCHANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A07C470)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AvatarPathChangeConfig_TypeDefinitionIndex = 23540;
