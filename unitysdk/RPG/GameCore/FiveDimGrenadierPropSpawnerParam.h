...
#define RPG_GAMECORE_FIVEDIMGRENADIERPROPSPAWNERPARAM_METHOD_3_8E9EE9AF3B346134_OFFSET UNITYSDK_OFFSET(0x19742B50)
#define RPG_GAMECORE_FIVEDIMGRENADIERPROPSPAWNERPARAM_METHOD_3_CF38851C4B9CA149_OFFSET UNITYSDK_OFFSET(0x19742BA0)
#define RPG_GAMECORE_FIVEDIMGRENADIERPROPSPAWNERPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x19742B90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimGrenadierPropSpawnerParam_TypeDefinitionIndex = 17678;
