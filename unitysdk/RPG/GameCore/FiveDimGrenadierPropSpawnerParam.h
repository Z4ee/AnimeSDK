...
#define RPG_GAMECORE_FIVEDIMGRENADIERPROPSPAWNERPARAM_METHOD_3_1636ADB9B3ECA84F_OFFSET UNITYSDK_OFFSET(0x189062F0)
#define RPG_GAMECORE_FIVEDIMGRENADIERPROPSPAWNERPARAM_METHOD_3_CD1343F2AAB20C3F_OFFSET UNITYSDK_OFFSET(0x18906340)
#define RPG_GAMECORE_FIVEDIMGRENADIERPROPSPAWNERPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x18906330)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimGrenadierPropSpawnerParam_TypeDefinitionIndex = 17652;
