...
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYLEVELMAXCONFIG_METHOD_3_CE18CFE180B9EE21_OFFSET UNITYSDK_OFFSET(0x19BB9EC0)
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYLEVELMAXCONFIG_METHOD_3_F38CF28ACD109F85_OFFSET UNITYSDK_OFFSET(0x19BB9C70)
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYLEVELMAXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19BB9C60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RoguePersonaRoomCardFilterByLevelMaxConfig_TypeDefinitionIndex = 18822;
