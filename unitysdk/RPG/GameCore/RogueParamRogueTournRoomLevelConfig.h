...
#define RPG_GAMECORE_ROGUEPARAMROGUETOURNROOMLEVELCONFIG_METHOD_6_B6CEE32F2379DC5A_OFFSET UNITYSDK_OFFSET(0x176513E0)
#define RPG_GAMECORE_ROGUEPARAMROGUETOURNROOMLEVELCONFIG_METHOD_6_F47BCC61B0270894_OFFSET UNITYSDK_OFFSET(0x17651130)
#define RPG_GAMECORE_ROGUEPARAMROGUETOURNROOMLEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x176512B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamRogueTournRoomLevelConfig_TypeDefinitionIndex = 18194;
