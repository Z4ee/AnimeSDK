...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEKILLPASSIVEMONSTER_METHOD_3_AA84E3131D7201C0_OFFSET UNITYSDK_OFFSET(0x1C2E70E0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEKILLPASSIVEMONSTER_METHOD_3_E086741E3E42518D_OFFSET UNITYSDK_OFFSET(0x1C2E7120)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEKILLPASSIVEMONSTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2E7110)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRogueKillPassiveMonster_TypeDefinitionIndex = 20980;
