...
#define RPG_GAMECORE_FATEMODIFIERTRIGGERCONFIG_METHOD_3_0BB0114F0A4099ED_OFFSET UNITYSDK_OFFSET(0x188D6AD0)
#define RPG_GAMECORE_FATEMODIFIERTRIGGERCONFIG_METHOD_3_B761A0F9209725E4_OFFSET UNITYSDK_OFFSET(0x188D5F70)
#define RPG_GAMECORE_FATEMODIFIERTRIGGERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x188D5F20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateModifierTriggerConfig_TypeDefinitionIndex = 18296;
