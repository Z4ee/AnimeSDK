...
#define RPG_GAMECORE_WAITROGUEADVENTUREROOMFIRSTENTER_METHOD_3_716D87AA6AB09393_OFFSET UNITYSDK_OFFSET(0x1D1BAA00)
#define RPG_GAMECORE_WAITROGUEADVENTUREROOMFIRSTENTER_METHOD_3_B4EF120D345D4BD7_OFFSET UNITYSDK_OFFSET(0x1D1BAA50)
#define RPG_GAMECORE_WAITROGUEADVENTUREROOMFIRSTENTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1BAA40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitRogueAdventureRoomFirstEnter_TypeDefinitionIndex = 20028;
