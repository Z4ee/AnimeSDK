...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_ATTACKEFFECT_CUTOUT_METHOD_3_69B700564CFF6D86_OFFSET UNITYSDK_OFFSET(0x17170270)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_ATTACKEFFECT_CUTOUT_METHOD_3_E773E58F074B8D51_OFFSET UNITYSDK_OFFSET(0x1716BA90)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_ATTACKEFFECT_CUTOUT__CTOR_OFFSET UNITYSDK_OFFSET(0x1716BA40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_AttackEffect_Cutout_TypeDefinitionIndex = 14747;
