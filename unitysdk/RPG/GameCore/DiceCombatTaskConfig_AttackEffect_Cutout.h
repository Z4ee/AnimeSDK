...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_ATTACKEFFECT_CUTOUT_METHOD_3_880E6B95B1387A7C_OFFSET UNITYSDK_OFFSET(0x1DB04B50)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_ATTACKEFFECT_CUTOUT_METHOD_3_E773E58F074B8D51_OFFSET UNITYSDK_OFFSET(0x1DB04BF0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_ATTACKEFFECT_CUTOUT__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB04BE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_AttackEffect_Cutout_TypeDefinitionIndex = 15880;
