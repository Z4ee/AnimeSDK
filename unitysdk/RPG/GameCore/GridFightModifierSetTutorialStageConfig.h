...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETTUTORIALSTAGECONFIG_METHOD_3_4AD48E245D57E98E_OFFSET UNITYSDK_OFFSET(0x1726C440)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETTUTORIALSTAGECONFIG_METHOD_3_D191B9282921BAB7_OFFSET UNITYSDK_OFFSET(0x1726C3C0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETTUTORIALSTAGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1726C450)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierSetTutorialStageConfig_TypeDefinitionIndex = 17840;
