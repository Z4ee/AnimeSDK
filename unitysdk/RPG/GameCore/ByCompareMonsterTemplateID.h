...
#define RPG_GAMECORE_BYCOMPAREMONSTERTEMPLATEID_METHOD_4_5C3783E02B34A793_OFFSET UNITYSDK_OFFSET(0x19CF7B00)
#define RPG_GAMECORE_BYCOMPAREMONSTERTEMPLATEID_METHOD_4_8086B028EECABB3A_OFFSET UNITYSDK_OFFSET(0x19CF7DC0)
#define RPG_GAMECORE_BYCOMPAREMONSTERTEMPLATEID_METHOD_4_95C19D6DFF8C12B4_OFFSET UNITYSDK_OFFSET(0x19CF7BE0)
#define RPG_GAMECORE_BYCOMPAREMONSTERTEMPLATEID_METHOD_4_EE76AACDCB45F0FF_OFFSET UNITYSDK_OFFSET(0x19CF7E40)
#define RPG_GAMECORE_BYCOMPAREMONSTERTEMPLATEID__CTOR_OFFSET UNITYSDK_OFFSET(0x19CF7B80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareMonsterTemplateID_TypeDefinitionIndex = 22174;
