...
#define RPG_GAMECORE_BYCOMPAREMONSTERTEMPLATEID_METHOD_4_7F3BBE2F9765E469_OFFSET UNITYSDK_OFFSET(0x18734450)
#define RPG_GAMECORE_BYCOMPAREMONSTERTEMPLATEID_METHOD_4_95C19D6DFF8C12B4_OFFSET UNITYSDK_OFFSET(0x187345B0)
#define RPG_GAMECORE_BYCOMPAREMONSTERTEMPLATEID__CTOR_OFFSET UNITYSDK_OFFSET(0x18734510)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareMonsterTemplateID_TypeDefinitionIndex = 21925;
