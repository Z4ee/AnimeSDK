...
#define RPG_GAMECORE_PIXAIREQUIPMENTPRESETCONFIG_METHOD_2_98920AA644FA7849_OFFSET UNITYSDK_OFFSET(0x19A128D0)
#define RPG_GAMECORE_PIXAIREQUIPMENTPRESETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19A12A50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PixAirEquipmentPresetConfig_TypeDefinitionIndex = 15433;
