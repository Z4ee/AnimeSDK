...
#define RPG_GAMECORE_CONDLOGICORCONFIG_METHOD_4_777CFBF05229AAD2_OFFSET UNITYSDK_OFFSET(0x18831B80)
#define RPG_GAMECORE_CONDLOGICORCONFIG_METHOD_4_FEDB8EDEDB38F10F_OFFSET UNITYSDK_OFFSET(0x18831CC0)
#define RPG_GAMECORE_CONDLOGICORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18831C40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CondLogicOrConfig_TypeDefinitionIndex = 16163;
