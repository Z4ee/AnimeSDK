...
#define RPG_GAMECORE_ELATIONCONFIGLIST_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D055B90)
#define RPG_GAMECORE_ELATIONCONFIGLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1D055CA0)
