...
#define RPG_GAMECORE_ELATIONCONFIGLIST_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x196D6EF0)
#define RPG_GAMECORE_ELATIONCONFIGLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x196D7000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElationConfigList_TypeDefinitionIndex = 15720;
