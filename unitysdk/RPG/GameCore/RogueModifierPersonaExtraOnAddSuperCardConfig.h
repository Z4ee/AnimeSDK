...
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAEXTRAONADDSUPERCARDCONFIG_METHOD_3_D967BAC31E2C10A1_OFFSET UNITYSDK_OFFSET(0x1EEFBEF0)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAEXTRAONADDSUPERCARDCONFIG_METHOD_3_FEDBDD6C6A82C205_OFFSET UNITYSDK_OFFSET(0x1EEFBF40)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAEXTRAONADDSUPERCARDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEFBF30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierPersonaExtraOnAddSuperCardConfig_TypeDefinitionIndex = 17653;
