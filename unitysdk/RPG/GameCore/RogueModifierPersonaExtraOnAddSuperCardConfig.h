...
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAEXTRAONADDSUPERCARDCONFIG_METHOD_3_2E75D36E7571356C_OFFSET UNITYSDK_OFFSET(0x18D43C80)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAEXTRAONADDSUPERCARDCONFIG_METHOD_3_FEDBDD6C6A82C205_OFFSET UNITYSDK_OFFSET(0x18D43D50)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAEXTRAONADDSUPERCARDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D43D00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierPersonaExtraOnAddSuperCardConfig_TypeDefinitionIndex = 16962;
