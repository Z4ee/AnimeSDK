...
#define RPG_GAMECORE_MARBLEPROPERTY_METHOD_2_2E317E38A1103EEA_OFFSET UNITYSDK_OFFSET(0x17396230)
#define RPG_GAMECORE_MARBLEPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x17396380)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleProperty_TypeDefinitionIndex = 15413;
