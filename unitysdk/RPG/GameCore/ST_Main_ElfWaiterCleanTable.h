...
#define RPG_GAMECORE_ST_MAIN_ELFWAITERCLEANTABLE_METHOD_4_01ACD4687668A843_OFFSET UNITYSDK_OFFSET(0x17697330)
#define RPG_GAMECORE_ST_MAIN_ELFWAITERCLEANTABLE_METHOD_4_1D97BAE459611154_OFFSET UNITYSDK_OFFSET(0x17684320)
#define RPG_GAMECORE_ST_MAIN_ELFWAITERCLEANTABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x176842D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_ElfWaiterCleanTable_TypeDefinitionIndex = 19699;
