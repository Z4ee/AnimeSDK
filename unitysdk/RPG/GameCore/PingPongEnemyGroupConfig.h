...
#define RPG_GAMECORE_PINGPONGENEMYGROUPCONFIG_METHOD_2_D36C0767BFBE7FE7_OFFSET UNITYSDK_OFFSET(0x1B4C6C10)
#define RPG_GAMECORE_PINGPONGENEMYGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4C6DB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PingPongEnemyGroupConfig_TypeDefinitionIndex = 16317;
