...
#define RPG_GAMECORE_ROGUEDIALOGUEEVENTEFFECTCONFIG_METHOD_2_48DB072B65CC9837_OFFSET UNITYSDK_OFFSET(0x18D12CB0)
#define RPG_GAMECORE_ROGUEDIALOGUEEVENTEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D12CF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueDialogueEventEffectConfig_TypeDefinitionIndex = 17013;
