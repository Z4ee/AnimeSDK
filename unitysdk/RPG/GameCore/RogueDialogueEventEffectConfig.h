...
#define RPG_GAMECORE_ROGUEDIALOGUEEVENTEFFECTCONFIG_METHOD_2_48DB072B65CC9837_OFFSET UNITYSDK_OFFSET(0x1CFA9B40)
#define RPG_GAMECORE_ROGUEDIALOGUEEVENTEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFA9B80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueDialogueEventEffectConfig_TypeDefinitionIndex = 17189;
