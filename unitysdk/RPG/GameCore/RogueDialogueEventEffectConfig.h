...
#define RPG_GAMECORE_ROGUEDIALOGUEEVENTEFFECTCONFIG_METHOD_2_48DB072B65CC9837_OFFSET UNITYSDK_OFFSET(0x19B37990)
#define RPG_GAMECORE_ROGUEDIALOGUEEVENTEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B379D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueDialogueEventEffectConfig_TypeDefinitionIndex = 17027;
