...
#define RPG_GAMECORE_PHOTOGRAPHTIPRANGECONFIG_METHOD_2_845A88146AA11D6A_OFFSET UNITYSDK_OFFSET(0x18BF89B0)
#define RPG_GAMECORE_PHOTOGRAPHTIPRANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18BF8B70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotoGraphTipRangeConfig_TypeDefinitionIndex = 20484;
