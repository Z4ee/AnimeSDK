...
#define RPG_GAMECORE_PHOTOGRAPHTIPRANGECONFIG_METHOD_2_845A88146AA11D6A_OFFSET UNITYSDK_OFFSET(0x1B4C4C60)
#define RPG_GAMECORE_PHOTOGRAPHTIPRANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4C4E20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotoGraphTipRangeConfig_TypeDefinitionIndex = 20836;
