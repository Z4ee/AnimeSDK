...
#define RPG_GAMECORE_PHOTOGRAPHTIPRANGECONFIG_METHOD_2_845A88146AA11D6A_OFFSET UNITYSDK_OFFSET(0x19A0A810)
#define RPG_GAMECORE_PHOTOGRAPHTIPRANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19A0A9D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotoGraphTipRangeConfig_TypeDefinitionIndex = 20421;
