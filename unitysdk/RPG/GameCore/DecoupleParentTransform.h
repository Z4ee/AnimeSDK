...
#define RPG_GAMECORE_DECOUPLEPARENTTRANSFORM_METHOD_3_7967D0837B4F86F0_OFFSET UNITYSDK_OFFSET(0x188584B0)
#define RPG_GAMECORE_DECOUPLEPARENTTRANSFORM_METHOD_3_81CBBFDC309F3B4B_OFFSET UNITYSDK_OFFSET(0x18858530)
#define RPG_GAMECORE_DECOUPLEPARENTTRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x18858500)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DecoupleParentTransform_TypeDefinitionIndex = 21763;
