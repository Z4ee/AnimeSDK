...
#define RPG_GAMECORE_DECOUPLEPARENTTRANSFORM_METHOD_3_7967D0837B4F86F0_OFFSET UNITYSDK_OFFSET(0x17151270)
#define RPG_GAMECORE_DECOUPLEPARENTTRANSFORM_METHOD_3_81CBBFDC309F3B4B_OFFSET UNITYSDK_OFFSET(0x171512F0)
#define RPG_GAMECORE_DECOUPLEPARENTTRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x171512C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DecoupleParentTransform_TypeDefinitionIndex = 21051;
