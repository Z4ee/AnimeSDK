...
#define RPG_GAMECORE_PUZZLESETANIMATORPARAMS_METHOD_3_914E95E81E6BBC69_OFFSET UNITYSDK_OFFSET(0x1D377FE0)
#define RPG_GAMECORE_PUZZLESETANIMATORPARAMS_METHOD_3_A3A5E93D664782CB_OFFSET UNITYSDK_OFFSET(0x1D378060)
#define RPG_GAMECORE_PUZZLESETANIMATORPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D378030)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PuzzleSetAnimatorParams_TypeDefinitionIndex = 21979;
