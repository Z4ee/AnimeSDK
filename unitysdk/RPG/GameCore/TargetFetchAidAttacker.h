...
#define RPG_GAMECORE_TARGETFETCHAIDATTACKER_METHOD_4_1343F5BC5AC52CF4_OFFSET UNITYSDK_OFFSET(0x1D0B6500)
#define RPG_GAMECORE_TARGETFETCHAIDATTACKER_METHOD_4_19B3DD808F99BD41_OFFSET UNITYSDK_OFFSET(0x1D0B6640)
#define RPG_GAMECORE_TARGETFETCHAIDATTACKER_METHOD_4_7D4637BDB467271D_OFFSET UNITYSDK_OFFSET(0x1D0B6600)
#define RPG_GAMECORE_TARGETFETCHAIDATTACKER_METHOD_4_F29601CF457A7449_OFFSET UNITYSDK_OFFSET(0x1D0B65A0)
#define RPG_GAMECORE_TARGETFETCHAIDATTACKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0B6590)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchAidAttacker_TypeDefinitionIndex = 23152;
