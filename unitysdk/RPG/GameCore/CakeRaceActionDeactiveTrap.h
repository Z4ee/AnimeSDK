...
#define RPG_GAMECORE_CAKERACEACTIONDEACTIVETRAP_METHOD_3_2401394A6A134DFD_OFFSET UNITYSDK_OFFSET(0x195E5520)
#define RPG_GAMECORE_CAKERACEACTIONDEACTIVETRAP_METHOD_3_4C4CF90DBEA85A4B_OFFSET UNITYSDK_OFFSET(0x195E7BA0)
#define RPG_GAMECORE_CAKERACEACTIONDEACTIVETRAP__CTOR_OFFSET UNITYSDK_OFFSET(0x195E5500)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionDeactiveTrap_TypeDefinitionIndex = 17445;
