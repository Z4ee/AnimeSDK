...
#define RPG_GAMECORE_FOURROTATEVOXELSETENTITYENABLEACTION_METHOD_3_32FC3BA7A1F9B1A2_OFFSET UNITYSDK_OFFSET(0x1721E0C0)
#define RPG_GAMECORE_FOURROTATEVOXELSETENTITYENABLEACTION_METHOD_3_B96D81A5A663C26E_OFFSET UNITYSDK_OFFSET(0x1721E1F0)
#define RPG_GAMECORE_FOURROTATEVOXELSETENTITYENABLEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1721E1D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FourRotateVoxelSetEntityEnableAction_TypeDefinitionIndex = 15361;
