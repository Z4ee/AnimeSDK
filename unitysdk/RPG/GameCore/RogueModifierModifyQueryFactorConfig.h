...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYQUERYFACTORCONFIG_METHOD_3_1A7258187DEB8845_OFFSET UNITYSDK_OFFSET(0x1EEFB230)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYQUERYFACTORCONFIG_METHOD_3_592D491E14DCD0C9_OFFSET UNITYSDK_OFFSET(0x1EEFB280)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYQUERYFACTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEFB270)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyQueryFactorConfig_TypeDefinitionIndex = 17747;
