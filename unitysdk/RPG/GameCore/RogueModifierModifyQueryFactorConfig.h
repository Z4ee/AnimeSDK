...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYQUERYFACTORCONFIG_METHOD_3_592D491E14DCD0C9_OFFSET UNITYSDK_OFFSET(0x19B56780)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYQUERYFACTORCONFIG_METHOD_3_85FFE01D84C957F0_OFFSET UNITYSDK_OFFSET(0x19B5FD40)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYQUERYFACTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B56730)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyQueryFactorConfig_TypeDefinitionIndex = 17069;
