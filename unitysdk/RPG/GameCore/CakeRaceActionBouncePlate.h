...
#define RPG_GAMECORE_CAKERACEACTIONBOUNCEPLATE_METHOD_3_49B8BCA3CF243594_OFFSET UNITYSDK_OFFSET(0x1B2CA640)
#define RPG_GAMECORE_CAKERACEACTIONBOUNCEPLATE_METHOD_3_A370AD421A930469_OFFSET UNITYSDK_OFFSET(0x1B2CA6E0)
#define RPG_GAMECORE_CAKERACEACTIONBOUNCEPLATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2CA6D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionBouncePlate_TypeDefinitionIndex = 17621;
