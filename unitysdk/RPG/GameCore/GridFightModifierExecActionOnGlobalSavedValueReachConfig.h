...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONONGLOBALSAVEDVALUEREACHCONFIG_METHOD_3_0991FDFD09F2BA98_OFFSET UNITYSDK_OFFSET(0x172671E0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONONGLOBALSAVEDVALUEREACHCONFIG_METHOD_3_2D5B1710E590D2C1_OFFSET UNITYSDK_OFFSET(0x1726ACF0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONONGLOBALSAVEDVALUEREACHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17267190)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierExecActionOnGlobalSavedValueReachConfig_TypeDefinitionIndex = 17809;
