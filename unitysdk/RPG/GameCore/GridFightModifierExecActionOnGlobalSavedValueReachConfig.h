...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONONGLOBALSAVEDVALUEREACHCONFIG_METHOD_3_0991FDFD09F2BA98_OFFSET UNITYSDK_OFFSET(0x1D159750)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONONGLOBALSAVEDVALUEREACHCONFIG_METHOD_3_8D2DA42F41B36D5C_OFFSET UNITYSDK_OFFSET(0x1D159700)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONONGLOBALSAVEDVALUEREACHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D159740)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierExecActionOnGlobalSavedValueReachConfig_TypeDefinitionIndex = 19172;
