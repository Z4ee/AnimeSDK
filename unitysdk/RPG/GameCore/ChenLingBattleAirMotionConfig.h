...
#define RPG_GAMECORE_CHENLINGBATTLEAIRMOTIONCONFIG_METHOD_2_CB3AA1F9B443B854_OFFSET UNITYSDK_OFFSET(0x1707B670)
#define RPG_GAMECORE_CHENLINGBATTLEAIRMOTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1707BCB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleAirMotionConfig_TypeDefinitionIndex = 14440;
