...
#define RPG_GAMECORE_FIVEDIMENTITYVAR_METHOD_2_128774387667156B_OFFSET UNITYSDK_OFFSET(0x1D85ADB0)
#define RPG_GAMECORE_FIVEDIMENTITYVAR_METHOD_2_35BAD89675FB426E_OFFSET UNITYSDK_OFFSET(0x1D85BEE0)
#define RPG_GAMECORE_FIVEDIMENTITYVAR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D85C1F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimEntityVar_TypeDefinitionIndex = 18423;
