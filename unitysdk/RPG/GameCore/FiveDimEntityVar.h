...
#define RPG_GAMECORE_FIVEDIMENTITYVAR_METHOD_2_128774387667156B_OFFSET UNITYSDK_OFFSET(0x1973A5C0)
#define RPG_GAMECORE_FIVEDIMENTITYVAR_METHOD_2_35BAD89675FB426E_OFFSET UNITYSDK_OFFSET(0x1973AF70)
#define RPG_GAMECORE_FIVEDIMENTITYVAR__CTOR_OFFSET UNITYSDK_OFFSET(0x1973B280)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimEntityVar_TypeDefinitionIndex = 17729;
