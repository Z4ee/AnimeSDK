...
#define RPG_GAMECORE_ENDRESHASCENESELECTION_METHOD_3_5D1C89515E75F13F_OFFSET UNITYSDK_OFFSET(0x1719B0F0)
#define RPG_GAMECORE_ENDRESHASCENESELECTION_METHOD_3_B1266994BFDCE593_OFFSET UNITYSDK_OFFSET(0x1719B200)
#define RPG_GAMECORE_ENDRESHASCENESELECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1719B1D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EndReShaSceneSelection_TypeDefinitionIndex = 19468;
