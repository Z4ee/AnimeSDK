...
#define RPG_GAMECORE_ENDRESHASCENESELECTION_METHOD_3_B0599A03CF7E0856_OFFSET UNITYSDK_OFFSET(0x1C04FDE0)
#define RPG_GAMECORE_ENDRESHASCENESELECTION_METHOD_3_B1266994BFDCE593_OFFSET UNITYSDK_OFFSET(0x1C04FEB0)
#define RPG_GAMECORE_ENDRESHASCENESELECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C04FEA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EndReShaSceneSelection_TypeDefinitionIndex = 20372;
