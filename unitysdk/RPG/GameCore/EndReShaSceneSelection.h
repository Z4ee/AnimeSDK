...
#define RPG_GAMECORE_ENDRESHASCENESELECTION_METHOD_3_B0599A03CF7E0856_OFFSET UNITYSDK_OFFSET(0x1D7BFC70)
#define RPG_GAMECORE_ENDRESHASCENESELECTION_METHOD_3_B1266994BFDCE593_OFFSET UNITYSDK_OFFSET(0x1D7BFD40)
#define RPG_GAMECORE_ENDRESHASCENESELECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7BFD30)
