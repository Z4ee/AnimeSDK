...
#define RPG_GAMECORE_ST_MAIN_STANDBY_METHOD_4_17B8C05B134CE9E7_OFFSET UNITYSDK_OFFSET(0x18DF4910)
#define RPG_GAMECORE_ST_MAIN_STANDBY_METHOD_4_AA5DD8C57035D86A_OFFSET UNITYSDK_OFFSET(0x18DF49E0)
#define RPG_GAMECORE_ST_MAIN_STANDBY__CTOR_OFFSET UNITYSDK_OFFSET(0x18DF4990)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_StandBy_TypeDefinitionIndex = 19023;
