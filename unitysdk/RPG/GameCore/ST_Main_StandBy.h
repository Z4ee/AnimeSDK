...
#define RPG_GAMECORE_ST_MAIN_STANDBY_METHOD_4_17B8C05B134CE9E7_OFFSET UNITYSDK_OFFSET(0x176983A0)
#define RPG_GAMECORE_ST_MAIN_STANDBY_METHOD_4_AA5DD8C57035D86A_OFFSET UNITYSDK_OFFSET(0x17688CD0)
#define RPG_GAMECORE_ST_MAIN_STANDBY__CTOR_OFFSET UNITYSDK_OFFSET(0x17688C80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_StandBy_TypeDefinitionIndex = 18376;
