...
#define RPG_GAMECORE_PROPFASTDELIVERSETSIMPLIFIEDMODE_METHOD_3_5F1B5BEED7231AA3_OFFSET UNITYSDK_OFFSET(0x1BA22C60)
#define RPG_GAMECORE_PROPFASTDELIVERSETSIMPLIFIEDMODE_METHOD_3_B362AEEFDF676890_OFFSET UNITYSDK_OFFSET(0x1BA22C10)
#define RPG_GAMECORE_PROPFASTDELIVERSETSIMPLIFIEDMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA22C50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropFastDeliverSetSimplifiedMode_TypeDefinitionIndex = 21342;
