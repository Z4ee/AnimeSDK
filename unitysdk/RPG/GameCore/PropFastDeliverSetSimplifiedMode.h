...
#define RPG_GAMECORE_PROPFASTDELIVERSETSIMPLIFIEDMODE_METHOD_3_5F1B5BEED7231AA3_OFFSET UNITYSDK_OFFSET(0x19A8F940)
#define RPG_GAMECORE_PROPFASTDELIVERSETSIMPLIFIEDMODE_METHOD_3_A1DA2F61216B049A_OFFSET UNITYSDK_OFFSET(0x19A8F8C0)
#define RPG_GAMECORE_PROPFASTDELIVERSETSIMPLIFIEDMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x19A8F910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropFastDeliverSetSimplifiedMode_TypeDefinitionIndex = 20927;
