...
#define RPG_GAMECORE_SETEFFECTFRAMECAPTUREMATTEX_METHOD_3_2280185EF5CA1961_OFFSET UNITYSDK_OFFSET(0x1C5F5B40)
#define RPG_GAMECORE_SETEFFECTFRAMECAPTUREMATTEX_METHOD_3_DA87E354DCF1BB7A_OFFSET UNITYSDK_OFFSET(0x1C5F5B00)
#define RPG_GAMECORE_SETEFFECTFRAMECAPTUREMATTEX__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5F5B30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetEffectFrameCaptureMatTex_TypeDefinitionIndex = 22064;
