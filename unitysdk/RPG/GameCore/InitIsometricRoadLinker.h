...
#define RPG_GAMECORE_INITISOMETRICROADLINKER_METHOD_3_2069DFAE03494BEB_OFFSET UNITYSDK_OFFSET(0x1D1AC660)
#define RPG_GAMECORE_INITISOMETRICROADLINKER_METHOD_3_A677D672CBC6CFCB_OFFSET UNITYSDK_OFFSET(0x1D1AC6E0)
#define RPG_GAMECORE_INITISOMETRICROADLINKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1AC6B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int InitIsometricRoadLinker_TypeDefinitionIndex = 21956;
