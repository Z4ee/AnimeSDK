...
#define RPG_GAMECORE_MODIFYENTITYBOOSTPOINT_METHOD_3_235D2BC7064DC75B_OFFSET UNITYSDK_OFFSET(0x1D2B4A10)
#define RPG_GAMECORE_MODIFYENTITYBOOSTPOINT_METHOD_3_53FC66E92D791B32_OFFSET UNITYSDK_OFFSET(0x1D2B4A50)
#define RPG_GAMECORE_MODIFYENTITYBOOSTPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2B4A40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyEntityBoostPoint_TypeDefinitionIndex = 22352;
