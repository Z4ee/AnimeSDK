...
#define RPG_GAMECORE_SETCOMPONENTASSETLOADSTATEWITHANIMSTATE_METHOD_3_2CCAEB995ABB0AFB_OFFSET UNITYSDK_OFFSET(0x18E13130)
#define RPG_GAMECORE_SETCOMPONENTASSETLOADSTATEWITHANIMSTATE_METHOD_3_8F734A944FEB00A7_OFFSET UNITYSDK_OFFSET(0x18E13200)
#define RPG_GAMECORE_SETCOMPONENTASSETLOADSTATEWITHANIMSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E131B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetComponentAssetLoadStateWithAnimState_TypeDefinitionIndex = 21719;
