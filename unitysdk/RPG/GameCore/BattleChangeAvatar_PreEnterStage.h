...
#define RPG_GAMECORE_BATTLECHANGEAVATAR_PREENTERSTAGE_METHOD_3_6E05914FB1596232_OFFSET UNITYSDK_OFFSET(0x1CE6C040)
#define RPG_GAMECORE_BATTLECHANGEAVATAR_PREENTERSTAGE_METHOD_3_DDC2F1D04B6D02AF_OFFSET UNITYSDK_OFFSET(0x1CE6BF70)
#define RPG_GAMECORE_BATTLECHANGEAVATAR_PREENTERSTAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE6C030)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleChangeAvatar_PreEnterStage_TypeDefinitionIndex = 22522;
