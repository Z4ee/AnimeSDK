...
#define RPG_GAMECORE_BYCOMPARELASTKILLSKILL_METHOD_4_19E3DA203AFE74B1_OFFSET UNITYSDK_OFFSET(0x1C3276F0)
#define RPG_GAMECORE_BYCOMPARELASTKILLSKILL_METHOD_4_620F8F0EB7D0C57E_OFFSET UNITYSDK_OFFSET(0x1C327720)
#define RPG_GAMECORE_BYCOMPARELASTKILLSKILL_METHOD_4_DE29349BFBCAED22_OFFSET UNITYSDK_OFFSET(0x1C327530)
#define RPG_GAMECORE_BYCOMPARELASTKILLSKILL_METHOD_4_ED79BF2CDBC5A39B_OFFSET UNITYSDK_OFFSET(0x1C327570)
#define RPG_GAMECORE_BYCOMPARELASTKILLSKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C327560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareLastKillSkill_TypeDefinitionIndex = 22758;
