...
#define RPG_GAMECORE_BYCOMPARELASTKILLSKILL_METHOD_4_DF54E6B9675723C5_OFFSET UNITYSDK_OFFSET(0x1700D3D0)
#define RPG_GAMECORE_BYCOMPARELASTKILLSKILL_METHOD_4_ED79BF2CDBC5A39B_OFFSET UNITYSDK_OFFSET(0x1700D4A0)
#define RPG_GAMECORE_BYCOMPARELASTKILLSKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x1700D450)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareLastKillSkill_TypeDefinitionIndex = 21223;
