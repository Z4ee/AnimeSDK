...
#define RPG_GAMECORE_OPENTAROTBOOKLETPAGEFORCHARATER_METHOD_3_98342D717F0795BA_OFFSET UNITYSDK_OFFSET(0x199D7C40)
#define RPG_GAMECORE_OPENTAROTBOOKLETPAGEFORCHARATER_METHOD_3_B9EA094E9939A9B3_OFFSET UNITYSDK_OFFSET(0x199D7BC0)
#define RPG_GAMECORE_OPENTAROTBOOKLETPAGEFORCHARATER__CTOR_OFFSET UNITYSDK_OFFSET(0x199D7C10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OpenTarotBookletPageForCharater_TypeDefinitionIndex = 21126;
