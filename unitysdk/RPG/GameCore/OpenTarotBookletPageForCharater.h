...
#define RPG_GAMECORE_OPENTAROTBOOKLETPAGEFORCHARATER_METHOD_3_98342D717F0795BA_OFFSET UNITYSDK_OFFSET(0x1CE97C80)
#define RPG_GAMECORE_OPENTAROTBOOKLETPAGEFORCHARATER_METHOD_3_A96D49F4C7A04FE9_OFFSET UNITYSDK_OFFSET(0x1CE97C40)
#define RPG_GAMECORE_OPENTAROTBOOKLETPAGEFORCHARATER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE97C70)
