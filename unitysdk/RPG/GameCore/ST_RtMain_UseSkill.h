...
#define RPG_GAMECORE_ST_RTMAIN_USESKILL_METHOD_4_1C865F66FB90BA34_OFFSET UNITYSDK_OFFSET(0x1B787810)
#define RPG_GAMECORE_ST_RTMAIN_USESKILL_METHOD_4_D7453D46066B304F_OFFSET UNITYSDK_OFFSET(0x1B787850)
#define RPG_GAMECORE_ST_RTMAIN_USESKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B787840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_RtMain_UseSkill_TypeDefinitionIndex = 23223;
