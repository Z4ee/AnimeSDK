...
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONAROOMCARDMAXLEVELBYFILTERCONFIG_METHOD_6_B85A100467A8C645_OFFSET UNITYSDK_OFFSET(0x1D176DF0)
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONAROOMCARDMAXLEVELBYFILTERCONFIG_METHOD_6_F7150109FE9A0EC9_OFFSET UNITYSDK_OFFSET(0x1D176E40)
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONAROOMCARDMAXLEVELBYFILTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D176E30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamRoguePersonaRoomCardMaxLevelByFilterConfig_TypeDefinitionIndex = 19085;
