...
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONAROOMCARDMAXLEVELBYFILTERCONFIG_METHOD_6_EDA87C15F2ED216F_OFFSET UNITYSDK_OFFSET(0x1764E270)
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONAROOMCARDMAXLEVELBYFILTERCONFIG_METHOD_6_F7150109FE9A0EC9_OFFSET UNITYSDK_OFFSET(0x1764E520)
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONAROOMCARDMAXLEVELBYFILTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1764E3F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamRoguePersonaRoomCardMaxLevelByFilterConfig_TypeDefinitionIndex = 18192;
