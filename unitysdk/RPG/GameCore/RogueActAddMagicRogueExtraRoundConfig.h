...
#define RPG_GAMECORE_ROGUEACTADDMAGICROGUEEXTRAROUNDCONFIG_METHOD_6_6B17F084C7F2E4F2_OFFSET UNITYSDK_OFFSET(0x18CBCBF0)
#define RPG_GAMECORE_ROGUEACTADDMAGICROGUEEXTRAROUNDCONFIG_METHOD_6_6F481D81F5C32FE7_OFFSET UNITYSDK_OFFSET(0x18CBC9D0)
#define RPG_GAMECORE_ROGUEACTADDMAGICROGUEEXTRAROUNDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CBCB10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActAddMagicRogueExtraRoundConfig_TypeDefinitionIndex = 18690;
