...
#define RPG_GAMECORE_TRAVELSHIPHIDEDOCKMAPICON_METHOD_3_A7A3C3CE06C04423_OFFSET UNITYSDK_OFFSET(0x19E00500)
#define RPG_GAMECORE_TRAVELSHIPHIDEDOCKMAPICON_METHOD_3_DA32565E933C2E5F_OFFSET UNITYSDK_OFFSET(0x19E00650)
#define RPG_GAMECORE_TRAVELSHIPHIDEDOCKMAPICON__CTOR_OFFSET UNITYSDK_OFFSET(0x19E005C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TravelShipHideDockMapIcon_TypeDefinitionIndex = 19829;
