...
#define RPG_GAMECORE_SHAREDVALUE_METHOD_2_1E4EDFC3378184A7_OFFSET UNITYSDK_OFFSET(0x18E52260)
#define RPG_GAMECORE_SHAREDVALUE_METHOD_2_5B507F4CDFBF1081_OFFSET UNITYSDK_OFFSET(0x18E527A0)
#define RPG_GAMECORE_SHAREDVALUE_METHOD_2_C57401C2E9180C0A_OFFSET UNITYSDK_OFFSET(0x18E52700)
#define RPG_GAMECORE_SHAREDVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E51360)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SharedValue_TypeDefinitionIndex = 17391;
