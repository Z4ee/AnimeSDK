...
#define RPG_GAMECORE_SHAREDVALUE_METHOD_2_1E4EDFC3378184A7_OFFSET UNITYSDK_OFFSET(0x1BE33A70)
#define RPG_GAMECORE_SHAREDVALUE_METHOD_2_5B507F4CDFBF1081_OFFSET UNITYSDK_OFFSET(0x1BE33F60)
#define RPG_GAMECORE_SHAREDVALUE_METHOD_2_C57401C2E9180C0A_OFFSET UNITYSDK_OFFSET(0x1BE33EC0)
#define RPG_GAMECORE_SHAREDVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE32BF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SharedValue_TypeDefinitionIndex = 17569;
