...
#define RPG_GAMECORE_FATEMODIFIERADDTRANSFEREDMAINTRAITCOUNTCONFIG_METHOD_3_6A6D454E32BBF007_OFFSET UNITYSDK_OFFSET(0x1C074CF0)
#define RPG_GAMECORE_FATEMODIFIERADDTRANSFEREDMAINTRAITCOUNTCONFIG_METHOD_3_B4AA0969F2CF93AB_OFFSET UNITYSDK_OFFSET(0x1C074D40)
#define RPG_GAMECORE_FATEMODIFIERADDTRANSFEREDMAINTRAITCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C074D30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateModifierAddTransferedMainTraitCountConfig_TypeDefinitionIndex = 18528;
