...
#define RPG_GAMECORE_SPACEZOOCHANNELCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19C922E0)
#define RPG_GAMECORE_SPACEZOOCHANNELCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19C92970)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 HandbookTag; // 0x20
		::RPG::GameCore::SpaceZooChannelType Channel; // 0x24
		::RPG::GameCore::SpaceZooInheritType InheritType; // 0x28
