...
#define RPG_GAMECORE_RA_BYDISTANCE_METHOD_4_138DC296DD45EE99_OFFSET UNITYSDK_OFFSET(0x175797F0)
#define RPG_GAMECORE_RA_BYDISTANCE_METHOD_4_1DBB595F3AF79882_OFFSET UNITYSDK_OFFSET(0x17579720)
#define RPG_GAMECORE_RA_BYDISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x175797A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RA_ByDistance_TypeDefinitionIndex = 18320;
