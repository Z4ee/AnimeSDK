...
#define RPG_GAMECORE_RA_BYDISTANCE_METHOD_4_138DC296DD45EE99_OFFSET UNITYSDK_OFFSET(0x1B9AF540)
#define RPG_GAMECORE_RA_BYDISTANCE_METHOD_4_3F7AD1BFD7842930_OFFSET UNITYSDK_OFFSET(0x1B9AF7C0)
#define RPG_GAMECORE_RA_BYDISTANCE_METHOD_4_702A64491FCD22C7_OFFSET UNITYSDK_OFFSET(0x1B9AF7F0)
#define RPG_GAMECORE_RA_BYDISTANCE_METHOD_4_88F1D0C2517A7AE1_OFFSET UNITYSDK_OFFSET(0x1B9AF500)
#define RPG_GAMECORE_RA_BYDISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9AF530)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RA_ByDistance_TypeDefinitionIndex = 19271;
