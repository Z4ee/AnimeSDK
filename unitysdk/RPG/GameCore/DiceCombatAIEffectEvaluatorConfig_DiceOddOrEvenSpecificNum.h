...
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEODDOREVENSPECIFICNUM_METHOD_3_270E67ECA2794F81_OFFSET UNITYSDK_OFFSET(0x1C10C1B0)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEODDOREVENSPECIFICNUM_METHOD_3_DF806F0F02F010C3_OFFSET UNITYSDK_OFFSET(0x1C10B7D0)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEODDOREVENSPECIFICNUM__CTOR_OFFSET UNITYSDK_OFFSET(0x1C10B7C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatAIEffectEvaluatorConfig_DiceOddOrEvenSpecificNum_TypeDefinitionIndex = 15557;
