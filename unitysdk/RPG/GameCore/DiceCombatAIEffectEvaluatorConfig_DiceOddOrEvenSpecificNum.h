...
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEODDOREVENSPECIFICNUM_METHOD_3_270E67ECA2794F81_OFFSET UNITYSDK_OFFSET(0x18864130)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEODDOREVENSPECIFICNUM_METHOD_3_DF806F0F02F010C3_OFFSET UNITYSDK_OFFSET(0x18863750)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEODDOREVENSPECIFICNUM__CTOR_OFFSET UNITYSDK_OFFSET(0x18863740)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatAIEffectEvaluatorConfig_DiceOddOrEvenSpecificNum_TypeDefinitionIndex = 15335;
