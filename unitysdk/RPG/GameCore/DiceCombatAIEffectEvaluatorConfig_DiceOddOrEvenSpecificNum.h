...
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEODDOREVENSPECIFICNUM_METHOD_3_270E67ECA2794F81_OFFSET UNITYSDK_OFFSET(0x1715CAC0)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEODDOREVENSPECIFICNUM_METHOD_3_DF806F0F02F010C3_OFFSET UNITYSDK_OFFSET(0x1715C2A0)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEODDOREVENSPECIFICNUM__CTOR_OFFSET UNITYSDK_OFFSET(0x1715C290)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatAIEffectEvaluatorConfig_DiceOddOrEvenSpecificNum_TypeDefinitionIndex = 14842;
