...
#define RPG_GAMECORE_GRIDFIGHTSTAGEROUTECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x189DA340)
#define RPG_GAMECORE_GRIDFIGHTSTAGEROUTECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x189DAC10)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::Il2CppArray<::System::UInt32>* PenaltyBonusRuleIDList; // 0x10
		::Il2CppArray<::System::UInt32>* IntensifyBuffPoolIDList; // 0x18
		::Il2CppArray<::System::UInt32>* ParamList; // 0x20
		::System::UInt32 StageID; // 0x28
		::System::UInt32 ChapterID; // 0x2C
		::System::UInt32 NodeTemplateID; // 0x30
		::System::UInt32 BasicGoldRewardNum; // 0x34
		::RPG::GameCore::GridFightNodeType NodeType; // 0x38
