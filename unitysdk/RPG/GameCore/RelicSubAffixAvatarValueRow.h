...
#define RPG_GAMECORE_RELICSUBAFFIXAVATARVALUEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18CA08A0)
#define RPG_GAMECORE_RELICSUBAFFIXAVATARVALUEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18CA0BF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RelicSubAffixAvatarValueRow_TypeDefinitionIndex = 10437;

	class RelicSubAffixAvatarValueRow : public ::System::Object
	{
	public:
		::System::Single StatusProbability; // 0x10
		::System::Single CriticalDamage; // 0x14
		::System::UInt32 AvatarID; // 0x18
		::System::Single StatusResistance; // 0x1C
		::System::Single Defence; // 0x20
		::System::Single CriticalChance; // 0x24
		::System::Single HP; // 0x28
		::System::Single Speed; // 0x2C
		::System::Single Attack; // 0x30
		::System::Single BreakDamage; // 0x34
