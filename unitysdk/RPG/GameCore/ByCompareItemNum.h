...
#define RPG_GAMECORE_BYCOMPAREITEMNUM_METHOD_4_71100AC1BB1B7480_OFFSET UNITYSDK_OFFSET(0x1700CCD0)
#define RPG_GAMECORE_BYCOMPAREITEMNUM_METHOD_4_8C33D2099279797E_OFFSET UNITYSDK_OFFSET(0x1700CDA0)
#define RPG_GAMECORE_BYCOMPAREITEMNUM__CTOR_OFFSET UNITYSDK_OFFSET(0x1700CD50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareItemNum_TypeDefinitionIndex = 19394;
