...
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_UNLOCK_ACHIEVEMENT_METHOD_4_BCEDBCE6C480769D_OFFSET UNITYSDK_OFFSET(0x17699290)
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_UNLOCK_ACHIEVEMENT_METHOD_4_C7D43A6F63077572_OFFSET UNITYSDK_OFFSET(0x1768CC60)
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_UNLOCK_ACHIEVEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1768CC10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_Hipplen_Unlock_Achievement_TypeDefinitionIndex = 19607;
