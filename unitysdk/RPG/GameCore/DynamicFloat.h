...
#define RPG_GAMECORE_DYNAMICFLOAT_GET_ISDYNAMIC_OFFSET UNITYSDK_OFFSET(0x17183A40)
#define RPG_GAMECORE_DYNAMICFLOAT_METHOD_1_0854E9454645D1B7_OFFSET UNITYSDK_OFFSET(0x171839E0)
#define RPG_GAMECORE_DYNAMICFLOAT_METHOD_1_1DCC0C7F8AC23022_OFFSET UNITYSDK_OFFSET(0x17183AF0)
#define RPG_GAMECORE_DYNAMICFLOAT_METHOD_1_28C8D0626FC9B6CE_OFFSET UNITYSDK_OFFSET(0x17183D00)
#define RPG_GAMECORE_DYNAMICFLOAT_METHOD_1_2A5E94F9B9A71A0B_OFFSET UNITYSDK_OFFSET(0x17183B90)
#define RPG_GAMECORE_DYNAMICFLOAT_METHOD_1_533C5677051CA131_OFFSET UNITYSDK_OFFSET(0x17183830)
#define RPG_GAMECORE_DYNAMICFLOAT_METHOD_1_79908043EE0BD956_OFFSET UNITYSDK_OFFSET(0x171837C0)
#define RPG_GAMECORE_DYNAMICFLOAT_METHOD_1_E1B33223F9F2D6BB_OFFSET UNITYSDK_OFFSET(0x17183A50)
#define RPG_GAMECORE_DYNAMICFLOAT_METHOD_1_E83C519CAA6854AF_OFFSET UNITYSDK_OFFSET(0x17183880)
#define RPG_GAMECORE_DYNAMICFLOAT_METHOD_1_F06B17D67D5067C6_OFFSET UNITYSDK_OFFSET(0x17183900)
#define RPG_GAMECORE_DYNAMICFLOAT_METHOD_1_F7097473EC9DE578_OFFSET UNITYSDK_OFFSET(0x17184440)
#define RPG_GAMECORE_DYNAMICFLOAT_METHOD_1_FBDC5F72FD2730B3_OFFSET UNITYSDK_OFFSET(0x17183970)
#define RPG_GAMECORE_DYNAMICFLOAT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x171843A0)
#define RPG_GAMECORE_DYNAMICFLOAT__CCTOR_OFFSET UNITYSDK_OFFSET(0x171848B0)
#define RPG_GAMECORE_DYNAMICFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x17183AE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DynamicFloat_TypeDefinitionIndex = 22582;
	...
	public:
		...
		{
			return (::RPG::GameCore::DynamicFloat**)Il2CppClass::FromTypeDefinitionIndex(DynamicFloat_TypeDefinitionIndex)->GetStaticField(0x2AF90);
		}
		static ::RPG::GameCore::DynamicFloat** StaticGet_ONEHUNDRED()
		{
			return (::RPG::GameCore::DynamicFloat**)Il2CppClass::FromTypeDefinitionIndex(DynamicFloat_TypeDefinitionIndex)->GetStaticField(0x2AF98);
		}
		static ::RPG::GameCore::DynamicFloat** StaticGet_ONE()
		{
			return (::RPG::GameCore::DynamicFloat**)Il2CppClass::FromTypeDefinitionIndex(DynamicFloat_TypeDefinitionIndex)->GetStaticField(0x2AFA0);
		}
		static ::RPG::GameCore::DynamicFloat** StaticGet_THREESIXZERO()
		{
			return (::RPG::GameCore::DynamicFloat**)Il2CppClass::FromTypeDefinitionIndex(DynamicFloat_TypeDefinitionIndex)->GetStaticField(0x2AFA8);
		}
