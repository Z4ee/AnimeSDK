...
#define RPG_GAMECORE_FORMATIONMOVESETGROUPTOSTATION_METHOD_3_004E70F0A682D94A_OFFSET UNITYSDK_OFFSET(0x17218F00)
#define RPG_GAMECORE_FORMATIONMOVESETGROUPTOSTATION_METHOD_3_CDEE83DB80680D85_OFFSET UNITYSDK_OFFSET(0x17218E80)
#define RPG_GAMECORE_FORMATIONMOVESETGROUPTOSTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x17218ED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FormationMoveSetGroupToStation_TypeDefinitionIndex = 19558;
