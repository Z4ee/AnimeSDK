...
#define RPG_GAMECORE_FORMATIONMOVESETGROUPTOSTATION_METHOD_3_004E70F0A682D94A_OFFSET UNITYSDK_OFFSET(0x1DCB2F90)
#define RPG_GAMECORE_FORMATIONMOVESETGROUPTOSTATION_METHOD_3_D6268CCD1DAED91B_OFFSET UNITYSDK_OFFSET(0x1DCB2F50)
#define RPG_GAMECORE_FORMATIONMOVESETGROUPTOSTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCB2F80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FormationMoveSetGroupToStation_TypeDefinitionIndex = 21014;
