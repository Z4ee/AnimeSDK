...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONROGUEDIALOGUEAEONOPTIONCONFIG_METHOD_3_6D27B6F65AF83A50_OFFSET UNITYSDK_OFFSET(0x19B52EA0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONROGUEDIALOGUEAEONOPTIONCONFIG_METHOD_3_D72EC87F92E0ACF9_OFFSET UNITYSDK_OFFSET(0x19B5DA20)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONROGUEDIALOGUEAEONOPTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B52E50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnRogueDialogueAeonOptionConfig_TypeDefinitionIndex = 17056;
