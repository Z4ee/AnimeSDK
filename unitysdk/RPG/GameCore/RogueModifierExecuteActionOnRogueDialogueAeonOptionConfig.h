...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONROGUEDIALOGUEAEONOPTIONCONFIG_METHOD_3_50DB6C7EA7AD8454_OFFSET UNITYSDK_OFFSET(0x1CFC0CE0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONROGUEDIALOGUEAEONOPTIONCONFIG_METHOD_3_6D27B6F65AF83A50_OFFSET UNITYSDK_OFFSET(0x1CFC0D30)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONROGUEDIALOGUEAEONOPTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFC0D20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnRogueDialogueAeonOptionConfig_TypeDefinitionIndex = 17218;
