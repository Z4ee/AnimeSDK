...
#define RPG_GAMECORE_CHIMERADUELSAVEENTITYSELECTIONCONFIG_METHOD_3_3D3881AA082F2369_OFFSET UNITYSDK_OFFSET(0x196460E0)
#define RPG_GAMECORE_CHIMERADUELSAVEENTITYSELECTIONCONFIG_METHOD_3_5BDCDBF255929BD1_OFFSET UNITYSDK_OFFSET(0x19646140)
#define RPG_GAMECORE_CHIMERADUELSAVEENTITYSELECTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19646130)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelSaveEntitySelectionConfig_TypeDefinitionIndex = 15126;
