...
#define RPG_GAMECORE_CHIMERADUELSAVEENTITYSELECTIONCONFIG_METHOD_3_3D3881AA082F2369_OFFSET UNITYSDK_OFFSET(0x1C247540)
#define RPG_GAMECORE_CHIMERADUELSAVEENTITYSELECTIONCONFIG_METHOD_3_5BDCDBF255929BD1_OFFSET UNITYSDK_OFFSET(0x1C2475A0)
#define RPG_GAMECORE_CHIMERADUELSAVEENTITYSELECTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C247590)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelSaveEntitySelectionConfig_TypeDefinitionIndex = 15290;
