...
#define RPG_GAMECORE_CHIMERADUELSAVEENTITYSELECTIONCONFIG_METHOD_3_3D3881AA082F2369_OFFSET UNITYSDK_OFFSET(0x170A5250)
#define RPG_GAMECORE_CHIMERADUELSAVEENTITYSELECTIONCONFIG_METHOD_3_5BDCDBF255929BD1_OFFSET UNITYSDK_OFFSET(0x170A52B0)
#define RPG_GAMECORE_CHIMERADUELSAVEENTITYSELECTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x170A52A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelSaveEntitySelectionConfig_TypeDefinitionIndex = 14593;
