...
#define RPG_GAMECORE_ROGUEMAGICMISCDISPLAYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D3EE5C0)
#define RPG_GAMECORE_ROGUEMAGICMISCDISPLAYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3EE740)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueMagicMiscDisplayRow_TypeDefinitionIndex = 14709;
