...
#define RPG_GAMECORE_LEVELBASECURVEPOINTINFO_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1732F650)
#define RPG_GAMECORE_LEVELBASECURVEPOINTINFO_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1732F3E0)
#define RPG_GAMECORE_LEVELBASECURVEPOINTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1732F640)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelBaseCurvePointInfo_TypeDefinitionIndex = 15956;
