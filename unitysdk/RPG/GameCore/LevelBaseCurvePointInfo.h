...
#define RPG_GAMECORE_LEVELBASECURVEPOINTINFO_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1B02E410)
#define RPG_GAMECORE_LEVELBASECURVEPOINTINFO_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B02E1B0)
#define RPG_GAMECORE_LEVELBASECURVEPOINTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B02E400)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelBaseCurvePointInfo_TypeDefinitionIndex = 16676;
