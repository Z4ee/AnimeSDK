...
#define RPG_GAMECORE_BYISTARGETCUSTOMUNSELECTABLE_METHOD_4_34DA52CF4C605E12_OFFSET UNITYSDK_OFFSET(0x187587E0)
#define RPG_GAMECORE_BYISTARGETCUSTOMUNSELECTABLE_METHOD_4_E4A60E91BAABD74A_OFFSET UNITYSDK_OFFSET(0x187588B0)
#define RPG_GAMECORE_BYISTARGETCUSTOMUNSELECTABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x18758860)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsTargetCustomUnselectable_TypeDefinitionIndex = 22495;
