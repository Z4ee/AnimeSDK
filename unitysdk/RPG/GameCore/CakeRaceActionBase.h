...
#define RPG_GAMECORE_CAKERACEACTIONBASE_METHOD_2_7826B614D7BCA881_OFFSET UNITYSDK_OFFSET(0x1B2CA5A0)
#define RPG_GAMECORE_CAKERACEACTIONBASE_METHOD_2_C01912DEA5DCFAF5_OFFSET UNITYSDK_OFFSET(0x1B2CA5E0)
#define RPG_GAMECORE_CAKERACEACTIONBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2CA3F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionBase_TypeDefinitionIndex = 17599;
