...
#define RPG_GAMECORE_CAKERACEACTIONBASE_METHOD_2_1FA550A1BB0E6826_OFFSET UNITYSDK_OFFSET(0x18767AF0)
#define RPG_GAMECORE_CAKERACEACTIONBASE_METHOD_2_C01912DEA5DCFAF5_OFFSET UNITYSDK_OFFSET(0x18767C70)
#define RPG_GAMECORE_CAKERACEACTIONBASE__CCTOR_OFFSET UNITYSDK_OFFSET(0x18767CD0)
#define RPG_GAMECORE_CAKERACEACTIONBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x18767910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionBase_TypeDefinitionIndex = 17421;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Func_2<::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::CakeRaceActionBase*>*>**)Il2CppClass::FromTypeDefinitionIndex(CakeRaceActionBase_TypeDefinitionIndex)->GetStaticField(0x25F40);
		}
