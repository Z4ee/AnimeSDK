...
#define RPG_GAMECORE_SETUPMAPROTATIONVOLUME_METHOD_3_10411CBF3012EBBF_OFFSET UNITYSDK_OFFSET(0x176EA9E0)
#define RPG_GAMECORE_SETUPMAPROTATIONVOLUME_METHOD_3_E5E685C140CDA65C_OFFSET UNITYSDK_OFFSET(0x176EA960)
#define RPG_GAMECORE_SETUPMAPROTATIONVOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0x176EA9B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetupMapRotationVolume_TypeDefinitionIndex = 20501;
