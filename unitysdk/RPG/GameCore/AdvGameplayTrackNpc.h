...
#define RPG_GAMECORE_ADVGAMEPLAYTRACKNPC_METHOD_3_95A7F496BDEA20FF_OFFSET UNITYSDK_OFFSET(0x16F30060)
#define RPG_GAMECORE_ADVGAMEPLAYTRACKNPC_METHOD_3_E5DBEA3E7D5F0AF4_OFFSET UNITYSDK_OFFSET(0x16F2FEB0)
#define RPG_GAMECORE_ADVGAMEPLAYTRACKNPC__CTOR_OFFSET UNITYSDK_OFFSET(0x16F2FEF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvGameplayTrackNpc_TypeDefinitionIndex = 20370;
