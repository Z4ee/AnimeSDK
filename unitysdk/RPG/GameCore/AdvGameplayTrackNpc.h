...
#define RPG_GAMECORE_ADVGAMEPLAYTRACKNPC_METHOD_3_3890B36F889C654E_OFFSET UNITYSDK_OFFSET(0x1CDCA9A0)
#define RPG_GAMECORE_ADVGAMEPLAYTRACKNPC_METHOD_3_4412A590264E8774_OFFSET UNITYSDK_OFFSET(0x1CDCAAD0)
#define RPG_GAMECORE_ADVGAMEPLAYTRACKNPC__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDCA9E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvGameplayTrackNpc_TypeDefinitionIndex = 21936;
