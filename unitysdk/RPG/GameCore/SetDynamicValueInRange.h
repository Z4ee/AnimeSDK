...
#define RPG_GAMECORE_SETDYNAMICVALUEINRANGE_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x19C48C60)
#define RPG_GAMECORE_SETDYNAMICVALUEINRANGE_METHOD_4_B664628F0FC75374_OFFSET UNITYSDK_OFFSET(0x19C489F0)
#define RPG_GAMECORE_SETDYNAMICVALUEINRANGE_METHOD_4_BBDF26300A5493AC_OFFSET UNITYSDK_OFFSET(0x19C488D0)
#define RPG_GAMECORE_SETDYNAMICVALUEINRANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C48970)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueInRange_TypeDefinitionIndex = 22292;
