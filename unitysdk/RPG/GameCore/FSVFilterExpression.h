...
#define RPG_GAMECORE_FSVFILTEREXPRESSION_METHOD_2_0B2B1786A99AC05C_OFFSET UNITYSDK_OFFSET(0x1D7E2380)
#define RPG_GAMECORE_FSVFILTEREXPRESSION_METHOD_2_374112A97D09225F_OFFSET UNITYSDK_OFFSET(0x1D7E24D0)
#define RPG_GAMECORE_FSVFILTEREXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7E24C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FSVFilterExpression_TypeDefinitionIndex = 17207;
