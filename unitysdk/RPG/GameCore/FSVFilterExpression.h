...
#define RPG_GAMECORE_FSVFILTEREXPRESSION_METHOD_2_0B2B1786A99AC05C_OFFSET UNITYSDK_OFFSET(0x171BC020)
#define RPG_GAMECORE_FSVFILTEREXPRESSION_METHOD_2_374112A97D09225F_OFFSET UNITYSDK_OFFSET(0x171BC160)
#define RPG_GAMECORE_FSVFILTEREXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x171BC150)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FSVFilterExpression_TypeDefinitionIndex = 15986;
