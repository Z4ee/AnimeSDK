...
#define RPG_GAMECORE_FSVFILTEREXPRESSION_METHOD_2_0B2B1786A99AC05C_OFFSET UNITYSDK_OFFSET(0x188C97D0)
#define RPG_GAMECORE_FSVFILTEREXPRESSION_METHOD_2_374112A97D09225F_OFFSET UNITYSDK_OFFSET(0x188C9910)
#define RPG_GAMECORE_FSVFILTEREXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x188C9900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FSVFilterExpression_TypeDefinitionIndex = 16512;
