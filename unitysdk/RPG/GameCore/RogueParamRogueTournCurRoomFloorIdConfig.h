...
#define RPG_GAMECORE_ROGUEPARAMROGUETOURNCURROOMFLOORIDCONFIG_METHOD_6_85535830D51F619B_OFFSET UNITYSDK_OFFSET(0x1764FB20)
#define RPG_GAMECORE_ROGUEPARAMROGUETOURNCURROOMFLOORIDCONFIG_METHOD_6_A7515DA3AC99C1B5_OFFSET UNITYSDK_OFFSET(0x1764F870)
#define RPG_GAMECORE_ROGUEPARAMROGUETOURNCURROOMFLOORIDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1764F9F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamRogueTournCurRoomFloorIdConfig_TypeDefinitionIndex = 18187;
