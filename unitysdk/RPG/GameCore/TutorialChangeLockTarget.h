...
#define RPG_GAMECORE_TUTORIALCHANGELOCKTARGET_METHOD_3_8B5562BBB66C9948_OFFSET UNITYSDK_OFFSET(0x1D611D00)
#define RPG_GAMECORE_TUTORIALCHANGELOCKTARGET_METHOD_3_963E8A4E94236465_OFFSET UNITYSDK_OFFSET(0x1D611CC0)
#define RPG_GAMECORE_TUTORIALCHANGELOCKTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1D611CF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TutorialChangeLockTarget_TypeDefinitionIndex = 24072;
