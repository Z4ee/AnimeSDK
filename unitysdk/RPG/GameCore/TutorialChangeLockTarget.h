...
#define RPG_GAMECORE_TUTORIALCHANGELOCKTARGET_METHOD_3_8B5562BBB66C9948_OFFSET UNITYSDK_OFFSET(0x178D6590)
#define RPG_GAMECORE_TUTORIALCHANGELOCKTARGET_METHOD_3_B8B011864FC57177_OFFSET UNITYSDK_OFFSET(0x178D6510)
#define RPG_GAMECORE_TUTORIALCHANGELOCKTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x178D6560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TutorialChangeLockTarget_TypeDefinitionIndex = 22395;
