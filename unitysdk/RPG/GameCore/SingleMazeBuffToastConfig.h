...
#define RPG_GAMECORE_SINGLEMAZEBUFFTOASTCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19C8A270)
#define RPG_GAMECORE_SINGLEMAZEBUFFTOASTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19C8A4D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SingleMazeBuffToastConfig_TypeDefinitionIndex = 16758;
