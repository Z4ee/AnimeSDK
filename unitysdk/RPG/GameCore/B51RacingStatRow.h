...
#define RPG_GAMECORE_B51RACINGSTATROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CE5E4B0)
#define RPG_GAMECORE_B51RACINGSTATROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE5E7B0)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::Il2CppArray<::System::UInt32>* TierRequireValueList; // 0x10
		::System::String* IconPath; // 0x18
		::RPG::Client::TextID Name; // 0x20
		::RPG::GameCore::B51RacingStatType ID; // 0x30
		::System::Single ExtraRatio; // 0x34
