...
#define RPG_GAMECORE_ROGUEACTCHANGEROGUEMIRACLETOROGUECOINCONFIG_METHOD_6_2A0B674C473C7807_OFFSET UNITYSDK_OFFSET(0x175B3AE0)
#define RPG_GAMECORE_ROGUEACTCHANGEROGUEMIRACLETOROGUECOINCONFIG_METHOD_6_FCABC8B796782362_OFFSET UNITYSDK_OFFSET(0x175B38C0)
#define RPG_GAMECORE_ROGUEACTCHANGEROGUEMIRACLETOROGUECOINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175B3A00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActChangeRogueMiracleToRogueCoinConfig_TypeDefinitionIndex = 17968;
