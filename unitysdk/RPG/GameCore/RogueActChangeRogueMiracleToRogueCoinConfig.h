...
#define RPG_GAMECORE_ROGUEACTCHANGEROGUEMIRACLETOROGUECOINCONFIG_METHOD_6_2A0B674C473C7807_OFFSET UNITYSDK_OFFSET(0x1D02D850)
#define RPG_GAMECORE_ROGUEACTCHANGEROGUEMIRACLETOROGUECOINCONFIG_METHOD_6_5E74EE6EEC3B1483_OFFSET UNITYSDK_OFFSET(0x1D02D800)
#define RPG_GAMECORE_ROGUEACTCHANGEROGUEMIRACLETOROGUECOINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D02D840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActChangeRogueMiracleToRogueCoinConfig_TypeDefinitionIndex = 18856;
