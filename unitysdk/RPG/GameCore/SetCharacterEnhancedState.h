...
#define RPG_GAMECORE_SETCHARACTERENHANCEDSTATE_METHOD_3_80AE678CB1019500_OFFSET UNITYSDK_OFFSET(0x19C2EDD0)
#define RPG_GAMECORE_SETCHARACTERENHANCEDSTATE_METHOD_3_8CF3D1FF02D2CF78_OFFSET UNITYSDK_OFFSET(0x19C2EEA0)
#define RPG_GAMECORE_SETCHARACTERENHANCEDSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C2EE50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetCharacterEnhancedState_TypeDefinitionIndex = 21936;
