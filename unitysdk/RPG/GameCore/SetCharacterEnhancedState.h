...
#define RPG_GAMECORE_SETCHARACTERENHANCEDSTATE_METHOD_3_80AE678CB1019500_OFFSET UNITYSDK_OFFSET(0x18E0FFD0)
#define RPG_GAMECORE_SETCHARACTERENHANCEDSTATE_METHOD_3_8CF3D1FF02D2CF78_OFFSET UNITYSDK_OFFSET(0x18E100A0)
#define RPG_GAMECORE_SETCHARACTERENHANCEDSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E10050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetCharacterEnhancedState_TypeDefinitionIndex = 22153;
