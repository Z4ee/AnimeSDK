...
#define RPG_GAMECORE_TRAINPARTYCONDGRIDIDXMODEQUALCONFIG_METHOD_5_1BD1F3D537700A34_OFFSET UNITYSDK_OFFSET(0x19DF3A40)
#define RPG_GAMECORE_TRAINPARTYCONDGRIDIDXMODEQUALCONFIG_METHOD_5_58353DD88F6D8F2E_OFFSET UNITYSDK_OFFSET(0x19DF3B70)
#define RPG_GAMECORE_TRAINPARTYCONDGRIDIDXMODEQUALCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19DF3AF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyCondGridIdxModEqualConfig_TypeDefinitionIndex = 17197;
