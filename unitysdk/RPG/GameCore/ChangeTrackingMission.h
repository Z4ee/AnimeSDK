...
#define RPG_GAMECORE_CHANGETRACKINGMISSION_METHOD_3_BA38D0C1B2030339_OFFSET UNITYSDK_OFFSET(0x187C9DD0)
#define RPG_GAMECORE_CHANGETRACKINGMISSION_METHOD_3_FE1DA113A76B6CB0_OFFSET UNITYSDK_OFFSET(0x187C9D50)
#define RPG_GAMECORE_CHANGETRACKINGMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x187C9DA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChangeTrackingMission_TypeDefinitionIndex = 20416;
