...
#define RPG_GAMECORE_CHANGETRACKINGMISSION_METHOD_3_BA38D0C1B2030339_OFFSET UNITYSDK_OFFSET(0x17064EE0)
#define RPG_GAMECORE_CHANGETRACKINGMISSION_METHOD_3_FE1DA113A76B6CB0_OFFSET UNITYSDK_OFFSET(0x17064E60)
#define RPG_GAMECORE_CHANGETRACKINGMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x17064EB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChangeTrackingMission_TypeDefinitionIndex = 19735;
