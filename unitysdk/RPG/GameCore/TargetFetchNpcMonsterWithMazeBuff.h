...
#define RPG_GAMECORE_TARGETFETCHNPCMONSTERWITHMAZEBUFF_METHOD_4_0CAE9F18734E7A0E_OFFSET UNITYSDK_OFFSET(0x177B70A0)
#define RPG_GAMECORE_TARGETFETCHNPCMONSTERWITHMAZEBUFF_METHOD_4_85C9865B84FF2EA0_OFFSET UNITYSDK_OFFSET(0x177BF9A0)
#define RPG_GAMECORE_TARGETFETCHNPCMONSTERWITHMAZEBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x177B7050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchNpcMonsterWithMazeBuff_TypeDefinitionIndex = 22159;
