...
#define RPG_GAMECORE_GRIDFIGHTDIVISIONSTAGEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D9650D0)
#define RPG_GAMECORE_GRIDFIGHTDIVISIONSTAGEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D965BB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightDivisionStageRow_TypeDefinitionIndex = 13502;
	...
	public:
		...
		::Il2CppArray<::System::UInt32>* AffixChooseNumList; // 0x20
		...
		::System::UInt32 ScoreRule; // 0x3C
		::System::UInt32 EnemyDifficultyLevel; // 0x40
		::System::UInt32 EnemyHardLevel; // 0x44
		::RPG::GameCore::FixPoint LevelBaseHPMultiRatio; // 0x48
		::System::UInt32 ExpModify; // 0x50
		::RPG::Client::TextID EnvironmentDesc; // 0x58
		::System::UInt32 OCScoreRule; // 0x68
		::System::UInt32 DivisionID; // 0x6C
		::RPG::GameCore::FixPoint LevelBaseAttackMultiRatio; // 0x70
		::System::UInt32 WeeklyScoreModify; // 0x78
		::System::UInt32 BinaryNodeDiffAddRule; // 0x7C
