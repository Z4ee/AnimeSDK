...
#define RPG_GAMECORE_RELICMAINAFFIXCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19AC2AD0)
#define RPG_GAMECORE_RELICMAINAFFIXCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19AC3210)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::RPG::GameCore::FixPoint LevelAdd; // 0x10
