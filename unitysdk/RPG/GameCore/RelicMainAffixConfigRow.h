...
#define RPG_GAMECORE_RELICMAINAFFIXCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B9C9BA0)
#define RPG_GAMECORE_RELICMAINAFFIXCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9CA2E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RelicMainAffixConfigRow_TypeDefinitionIndex = 14048;
