...
#define RPG_GAMECORE_LITTLEGAMEPROPERTYENTITYVARBINDINGMAP_METHOD_2_F56A8D37DD7CFC0C_OFFSET UNITYSDK_OFFSET(0x1BCC43A0)
#define RPG_GAMECORE_LITTLEGAMEPROPERTYENTITYVARBINDINGMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCC43E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGamePropertyEntityVarBindingMap_TypeDefinitionIndex = 18178;
