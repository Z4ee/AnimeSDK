...
#define RPG_GAMECORE_LITTLEGAMEPROPERTYENTITYVARBINDINGMAP_METHOD_2_F56A8D37DD7CFC0C_OFFSET UNITYSDK_OFFSET(0x173601D0)
#define RPG_GAMECORE_LITTLEGAMEPROPERTYENTITYVARBINDINGMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x17360210)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGamePropertyEntityVarBindingMap_TypeDefinitionIndex = 17359;
