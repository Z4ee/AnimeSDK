...
#define RPG_GAMECORE_CHENLINGBATTLEPREDICATE_ISTEAMTYPE_METHOD_3_22685F6E7095F344_OFFSET UNITYSDK_OFFSET(0x1CFABAF0)
#define RPG_GAMECORE_CHENLINGBATTLEPREDICATE_ISTEAMTYPE_METHOD_3_D63926613485D238_OFFSET UNITYSDK_OFFSET(0x1CFABB50)
#define RPG_GAMECORE_CHENLINGBATTLEPREDICATE_ISTEAMTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFABB40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattlePredicate_IsTeamType_TypeDefinitionIndex = 15640;
