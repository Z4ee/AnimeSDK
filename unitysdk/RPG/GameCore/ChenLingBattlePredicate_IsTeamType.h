...
#define RPG_GAMECORE_CHENLINGBATTLEPREDICATE_ISTEAMTYPE_METHOD_3_22685F6E7095F344_OFFSET UNITYSDK_OFFSET(0x187E5470)
#define RPG_GAMECORE_CHENLINGBATTLEPREDICATE_ISTEAMTYPE_METHOD_3_D63926613485D238_OFFSET UNITYSDK_OFFSET(0x187E54D0)
#define RPG_GAMECORE_CHENLINGBATTLEPREDICATE_ISTEAMTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x187E54C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattlePredicate_IsTeamType_TypeDefinitionIndex = 14976;
