...
#define RPG_GAMECORE_MAPROTATIONAUDIOCONFIG_METHOD_2_BFB3C00067290EC5_OFFSET UNITYSDK_OFFSET(0x1D225C10)
#define RPG_GAMECORE_MAPROTATIONAUDIOCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D225D20)
