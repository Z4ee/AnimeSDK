...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDTRAITROLECONFIG_METHOD_3_374CFDC973185AD6_OFFSET UNITYSDK_OFFSET(0x197E9510)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDTRAITROLECONFIG_METHOD_3_EA97CDCBB561BC0F_OFFSET UNITYSDK_OFFSET(0x197E95E0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDTRAITROLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197E9590)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierAddTraitRoleConfig_TypeDefinitionIndex = 18430;
