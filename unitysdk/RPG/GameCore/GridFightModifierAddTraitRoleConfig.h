...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDTRAITROLECONFIG_METHOD_3_374CFDC973185AD6_OFFSET UNITYSDK_OFFSET(0x189B18C0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDTRAITROLECONFIG_METHOD_3_EA97CDCBB561BC0F_OFFSET UNITYSDK_OFFSET(0x189B1990)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDTRAITROLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189B1940)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierAddTraitRoleConfig_TypeDefinitionIndex = 18458;
