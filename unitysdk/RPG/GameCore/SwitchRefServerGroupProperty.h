...
#define RPG_GAMECORE_SWITCHREFSERVERGROUPPROPERTY_METHOD_3_01E5FCF6A8901713_OFFSET UNITYSDK_OFFSET(0x177998B0)
#define RPG_GAMECORE_SWITCHREFSERVERGROUPPROPERTY_METHOD_3_9114C06F0BCDE266_OFFSET UNITYSDK_OFFSET(0x17799FB0)
#define RPG_GAMECORE_SWITCHREFSERVERGROUPPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x177998A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchRefServerGroupProperty_TypeDefinitionIndex = 16107;
