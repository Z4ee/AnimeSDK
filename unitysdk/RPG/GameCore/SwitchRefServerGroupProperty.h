...
#define RPG_GAMECORE_SWITCHREFSERVERGROUPPROPERTY_METHOD_3_01E5FCF6A8901713_OFFSET UNITYSDK_OFFSET(0x18EBFB10)
#define RPG_GAMECORE_SWITCHREFSERVERGROUPPROPERTY_METHOD_3_9114C06F0BCDE266_OFFSET UNITYSDK_OFFSET(0x18EC0210)
#define RPG_GAMECORE_SWITCHREFSERVERGROUPPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x18EBFB00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchRefServerGroupProperty_TypeDefinitionIndex = 16638;
