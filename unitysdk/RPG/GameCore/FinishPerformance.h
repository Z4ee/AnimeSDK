...
#define RPG_GAMECORE_FINISHPERFORMANCE_METHOD_3_22DA3AD210C44253_OFFSET UNITYSDK_OFFSET(0x19721D60)
#define RPG_GAMECORE_FINISHPERFORMANCE_METHOD_3_5971A8675252A25A_OFFSET UNITYSDK_OFFSET(0x19721CE0)
#define RPG_GAMECORE_FINISHPERFORMANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x19721D30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FinishPerformance_TypeDefinitionIndex = 19930;
