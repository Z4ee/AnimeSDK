...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETROLESTARNUMCONFIG_METHOD_6_818AA40BF59AA417_OFFSET UNITYSDK_OFFSET(0x189C77A0)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETROLESTARNUMCONFIG_METHOD_6_C2185BC870967F01_OFFSET UNITYSDK_OFFSET(0x189C7A50)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETROLESTARNUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189C7920)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightParamGetRoleStarNumConfig_TypeDefinitionIndex = 18538;
