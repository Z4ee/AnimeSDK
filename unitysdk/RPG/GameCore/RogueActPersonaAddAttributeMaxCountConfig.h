...
#define RPG_GAMECORE_ROGUEACTPERSONAADDATTRIBUTEMAXCOUNTCONFIG_METHOD_6_4EA1CA73F50DB894_OFFSET UNITYSDK_OFFSET(0x19AE95C0)
#define RPG_GAMECORE_ROGUEACTPERSONAADDATTRIBUTEMAXCOUNTCONFIG_METHOD_6_DE101EFE49B4F079_OFFSET UNITYSDK_OFFSET(0x19AE93A0)
#define RPG_GAMECORE_ROGUEACTPERSONAADDATTRIBUTEMAXCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AE94E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaAddAttributeMaxCountConfig_TypeDefinitionIndex = 18741;
