...
#define RPG_GAMECORE_RESETHEADLOOKAT_METHOD_3_5CCB05E506E9D5CD_OFFSET UNITYSDK_OFFSET(0x1D01BAE0)
#define RPG_GAMECORE_RESETHEADLOOKAT_METHOD_3_FC99FE4ACB94069A_OFFSET UNITYSDK_OFFSET(0x1D01BAA0)
#define RPG_GAMECORE_RESETHEADLOOKAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D01BAD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetHeadLookAt_TypeDefinitionIndex = 22086;
