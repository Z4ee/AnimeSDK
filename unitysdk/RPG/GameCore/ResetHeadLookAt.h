...
#define RPG_GAMECORE_RESETHEADLOOKAT_METHOD_3_5CCB05E506E9D5CD_OFFSET UNITYSDK_OFFSET(0x18CAA770)
#define RPG_GAMECORE_RESETHEADLOOKAT_METHOD_3_FF426AA1306E1811_OFFSET UNITYSDK_OFFSET(0x18CAA6F0)
#define RPG_GAMECORE_RESETHEADLOOKAT__CTOR_OFFSET UNITYSDK_OFFSET(0x18CAA740)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetHeadLookAt_TypeDefinitionIndex = 21823;
