...
#define RPG_GAMECORE_RESETHEADLOOKAT_METHOD_3_5CCB05E506E9D5CD_OFFSET UNITYSDK_OFFSET(0x1759E7B0)
#define RPG_GAMECORE_RESETHEADLOOKAT_METHOD_3_FF426AA1306E1811_OFFSET UNITYSDK_OFFSET(0x1759E730)
#define RPG_GAMECORE_RESETHEADLOOKAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1759E780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetHeadLookAt_TypeDefinitionIndex = 21106;
