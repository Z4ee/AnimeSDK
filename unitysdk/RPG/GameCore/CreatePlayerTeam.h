...
#define RPG_GAMECORE_CREATEPLAYERTEAM_METHOD_3_3385A90D999DEF1C_OFFSET UNITYSDK_OFFSET(0x1D9BFBD0)
#define RPG_GAMECORE_CREATEPLAYERTEAM_METHOD_3_FC346D1139145CF1_OFFSET UNITYSDK_OFFSET(0x1D9BFC20)
#define RPG_GAMECORE_CREATEPLAYERTEAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D9BFC10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CreatePlayerTeam_TypeDefinitionIndex = 23130;
