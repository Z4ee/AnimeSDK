...
#define RPG_GAMECORE_CREATEPLAYERTEAM_METHOD_3_C7673EF3709D7554_OFFSET UNITYSDK_OFFSET(0x188445A0)
#define RPG_GAMECORE_CREATEPLAYERTEAM_METHOD_3_FC346D1139145CF1_OFFSET UNITYSDK_OFFSET(0x18844630)
#define RPG_GAMECORE_CREATEPLAYERTEAM__CTOR_OFFSET UNITYSDK_OFFSET(0x18844600)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CreatePlayerTeam_TypeDefinitionIndex = 22360;
