...
#define RPG_GAMECORE_STAMINAEXCHANGEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B0B8CE0)
#define RPG_GAMECORE_STAMINAEXCHANGEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0B92B0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 ToStamina; // 0x18
		::System::UInt32 Times; // 0x1C
