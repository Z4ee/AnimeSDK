...
#define RPG_GAMECORE_FLOORGROUPSYNCTEMPLATECONFIG_METHOD_2_E917D271ED2ECFE6_OFFSET UNITYSDK_OFFSET(0x1DCAE890)
#define RPG_GAMECORE_FLOORGROUPSYNCTEMPLATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCAE8D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FloorGroupSyncTemplateConfig_TypeDefinitionIndex = 17202;
