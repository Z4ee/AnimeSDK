...
#define RPG_GAMECORE_FIVEDIMTRAMPOLINECONFIG_METHOD_3_40A3E63E798DABE3_OFFSET UNITYSDK_OFFSET(0x1DCA8BA0)
#define RPG_GAMECORE_FIVEDIMTRAMPOLINECONFIG_METHOD_3_F8463761901A030E_OFFSET UNITYSDK_OFFSET(0x1DCA8B60)
#define RPG_GAMECORE_FIVEDIMTRAMPOLINECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCA8B90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimTrampolineConfig_TypeDefinitionIndex = 18329;
