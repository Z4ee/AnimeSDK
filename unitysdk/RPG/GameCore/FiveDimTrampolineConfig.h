...
#define RPG_GAMECORE_FIVEDIMTRAMPOLINECONFIG_METHOD_3_420B248E8F3C789A_OFFSET UNITYSDK_OFFSET(0x18922700)
#define RPG_GAMECORE_FIVEDIMTRAMPOLINECONFIG_METHOD_3_72704E4310E0CF38_OFFSET UNITYSDK_OFFSET(0x1890C140)
#define RPG_GAMECORE_FIVEDIMTRAMPOLINECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189226E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimTrampolineConfig_TypeDefinitionIndex = 17610;
