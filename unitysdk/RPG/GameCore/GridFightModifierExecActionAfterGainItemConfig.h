...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERGAINITEMCONFIG_METHOD_3_72530B778B238D07_OFFSET UNITYSDK_OFFSET(0x1EE6D640)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERGAINITEMCONFIG_METHOD_3_A6BC929A30222983_OFFSET UNITYSDK_OFFSET(0x1EE6D5F0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERGAINITEMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EE6D630)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierExecActionAfterGainItemConfig_TypeDefinitionIndex = 19192;
