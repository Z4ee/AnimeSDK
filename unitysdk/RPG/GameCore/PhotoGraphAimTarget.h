...
#define RPG_GAMECORE_PHOTOGRAPHAIMTARGET_METHOD_3_D0C823BCD30492E4_OFFSET UNITYSDK_OFFSET(0x18BF3930)
#define RPG_GAMECORE_PHOTOGRAPHAIMTARGET_METHOD_3_FEA216629C9533AA_OFFSET UNITYSDK_OFFSET(0x18BF39B0)
#define RPG_GAMECORE_PHOTOGRAPHAIMTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x18BF3980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotoGraphAimTarget_TypeDefinitionIndex = 20507;
