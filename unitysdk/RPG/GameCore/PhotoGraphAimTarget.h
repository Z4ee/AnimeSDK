...
#define RPG_GAMECORE_PHOTOGRAPHAIMTARGET_METHOD_3_EF1CC8C7335FBD0B_OFFSET UNITYSDK_OFFSET(0x1D4336C0)
#define RPG_GAMECORE_PHOTOGRAPHAIMTARGET_METHOD_3_FEA216629C9533AA_OFFSET UNITYSDK_OFFSET(0x1D433700)
#define RPG_GAMECORE_PHOTOGRAPHAIMTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4336F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotoGraphAimTarget_TypeDefinitionIndex = 21414;
	...
	public:
		...
		static ::System::Void Method_3_EF1CC8C7335FBD0B(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::PhotoGraphAimTarget*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::PhotoGraphAimTarget*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_PHOTOGRAPHAIMTARGET_METHOD_3_EF1CC8C7335FBD0B_OFFSET))(a1, a2);
		}
