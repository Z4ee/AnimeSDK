...
#define RPG_GAMECORE_PHOTOGRAPHAIMTARGET_METHOD_3_D0C823BCD30492E4_OFFSET UNITYSDK_OFFSET(0x174A8490)
#define RPG_GAMECORE_PHOTOGRAPHAIMTARGET_METHOD_3_FEA216629C9533AA_OFFSET UNITYSDK_OFFSET(0x174A8510)
#define RPG_GAMECORE_PHOTOGRAPHAIMTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x174A84E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotoGraphAimTarget_TypeDefinitionIndex = 19826;
