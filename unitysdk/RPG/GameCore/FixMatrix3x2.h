...
#define RPG_GAMECORE_FIXMATRIX3X2_EQUALS_OFFSET UNITYSDK_OFFSET(0x3B8BC10)
#define RPG_GAMECORE_FIXMATRIX3X2_GET_IDENTITY_OFFSET UNITYSDK_OFFSET(0x1D6F42F0)
#define RPG_GAMECORE_FIXMATRIX3X2_GET_ISIDENTITY_OFFSET UNITYSDK_OFFSET(0x3B8BC50)
#define RPG_GAMECORE_FIXMATRIX3X2_METHOD_2_A95AF245556BB0A6_OFFSET UNITYSDK_OFFSET(0x1D6F4750)
#define RPG_GAMECORE_FIXMATRIX3X2_METHOD_2_E712529611B9063F_OFFSET UNITYSDK_OFFSET(0x1D6F4C60)
#define RPG_GAMECORE_FIXMATRIX3X2__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D6F5760)
#define RPG_GAMECORE_FIXMATRIX3X2__CTOR_1_OFFSET UNITYSDK_OFFSET(0x3B8C050)
#define RPG_GAMECORE_FIXMATRIX3X2__CTOR_OFFSET UNITYSDK_OFFSET(0x2F38A20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FixMatrix3x2_TypeDefinitionIndex = 9880;

	struct alignas(8) FixMatrix3x2
	{
		static ::RPG::GameCore::FixMatrix3x2* StaticGet__identity()
		{
			return (::RPG::GameCore::FixMatrix3x2*)Il2CppClass::FromTypeDefinitionIndex(FixMatrix3x2_TypeDefinitionIndex)->GetStaticField(0x101F0);
		}
