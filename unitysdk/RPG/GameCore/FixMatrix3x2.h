...
#define RPG_GAMECORE_FIXMATRIX3X2_EQUALS_OFFSET UNITYSDK_OFFSET(0x3C66F70)
#define RPG_GAMECORE_FIXMATRIX3X2_GET_IDENTITY_OFFSET UNITYSDK_OFFSET(0x1EC50FE0)
#define RPG_GAMECORE_FIXMATRIX3X2_GET_ISIDENTITY_OFFSET UNITYSDK_OFFSET(0x3C66FB0)
#define RPG_GAMECORE_FIXMATRIX3X2_METHOD_2_A95AF245556BB0A6_OFFSET UNITYSDK_OFFSET(0x1EC51440)
#define RPG_GAMECORE_FIXMATRIX3X2_METHOD_2_E712529611B9063F_OFFSET UNITYSDK_OFFSET(0x1EC51950)
#define RPG_GAMECORE_FIXMATRIX3X2__CCTOR_OFFSET UNITYSDK_OFFSET(0x1EC52450)
#define RPG_GAMECORE_FIXMATRIX3X2__CTOR_1_OFFSET UNITYSDK_OFFSET(0x3C673B0)
#define RPG_GAMECORE_FIXMATRIX3X2__CTOR_OFFSET UNITYSDK_OFFSET(0x37AC4B0)
...
namespace RPG::GameCore
{
	...
	struct alignas(8) FixMatrix3x2
	{
		...
		{
			return (::RPG::GameCore::FixMatrix3x2*)Il2CppClass::FromTypeDefinitionIndex(FixMatrix3x2_TypeDefinitionIndex)->GetStaticField(0x10960);
		}
