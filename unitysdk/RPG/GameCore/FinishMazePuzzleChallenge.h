...
#define RPG_GAMECORE_FINISHMAZEPUZZLECHALLENGE_METHOD_3_05D17D2E7A6ECCAF_OFFSET UNITYSDK_OFFSET(0x188E53D0)
#define RPG_GAMECORE_FINISHMAZEPUZZLECHALLENGE_METHOD_3_AF71DF3D05EB4E3E_OFFSET UNITYSDK_OFFSET(0x188E5350)
#define RPG_GAMECORE_FINISHMAZEPUZZLECHALLENGE__CTOR_OFFSET UNITYSDK_OFFSET(0x188E53A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FinishMazePuzzleChallenge_TypeDefinitionIndex = 20868;
