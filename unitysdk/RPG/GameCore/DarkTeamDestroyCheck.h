...
#define RPG_GAMECORE_DARKTEAMDESTROYCHECK_METHOD_3_A66550BA1906AF1D_OFFSET UNITYSDK_OFFSET(0x1714B0A0)
#define RPG_GAMECORE_DARKTEAMDESTROYCHECK_METHOD_3_F3D28E6B4734178C_OFFSET UNITYSDK_OFFSET(0x1714B020)
#define RPG_GAMECORE_DARKTEAMDESTROYCHECK__CTOR_OFFSET UNITYSDK_OFFSET(0x1714B070)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DarkTeamDestroyCheck_TypeDefinitionIndex = 21631;
