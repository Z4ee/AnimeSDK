...
#define RPG_GAMECORE_MUSICRHYTHMTALKINFO_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x199C55A0)
#define RPG_GAMECORE_MUSICRHYTHMTALKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x199C58D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MusicRhythmTalkInfo_TypeDefinitionIndex = 20839;
