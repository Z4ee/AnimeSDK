...
#define RPG_GAMECORE_MUSICRHYTHMTALKINFO_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CE85A50)
#define RPG_GAMECORE_MUSICRHYTHMTALKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE85D80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MusicRhythmTalkInfo_TypeDefinitionIndex = 21814;
