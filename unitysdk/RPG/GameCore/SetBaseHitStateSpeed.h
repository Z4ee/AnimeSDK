...
#define RPG_GAMECORE_SETBASEHITSTATESPEED_METHOD_3_8FFD749348EBC8F8_OFFSET UNITYSDK_OFFSET(0x18E0B610)
#define RPG_GAMECORE_SETBASEHITSTATESPEED_METHOD_3_96D6B8887BB74BEE_OFFSET UNITYSDK_OFFSET(0x18E0B590)
#define RPG_GAMECORE_SETBASEHITSTATESPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x18E0B5E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetBaseHitStateSpeed_TypeDefinitionIndex = 21294;
