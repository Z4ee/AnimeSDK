...
#define RPG_GAMECORE_SETBASEHITSTATESPEED_METHOD_3_8FFD749348EBC8F8_OFFSET UNITYSDK_OFFSET(0x176A8B10)
#define RPG_GAMECORE_SETBASEHITSTATESPEED_METHOD_3_96D6B8887BB74BEE_OFFSET UNITYSDK_OFFSET(0x176A8A90)
#define RPG_GAMECORE_SETBASEHITSTATESPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x176A8AE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetBaseHitStateSpeed_TypeDefinitionIndex = 20610;
