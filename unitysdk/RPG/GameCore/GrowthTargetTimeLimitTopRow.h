...
#define RPG_GAMECORE_GROWTHTARGETTIMELIMITTOPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1728D8B0)
#define RPG_GAMECORE_GROWTHTARGETTIMELIMITTOPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1728D9D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GrowthTargetTimeLimitTopRow_TypeDefinitionIndex = 12212;
