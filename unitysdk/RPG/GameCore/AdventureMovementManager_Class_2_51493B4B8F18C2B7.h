...
#define RPG_GAMECORE_ADVENTUREMOVEMENTMANAGER_CLASS_2_51493B4B8F18C2B7_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA84A4B0)
#define RPG_GAMECORE_ADVENTUREMOVEMENTMANAGER_CLASS_2_51493B4B8F18C2B7_METHOD_2_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0xA849580)
#define RPG_GAMECORE_ADVENTUREMOVEMENTMANAGER_CLASS_2_51493B4B8F18C2B7_METHOD_2_CE66CB9BD31906A2_OFFSET UNITYSDK_OFFSET(0xA846420)
#define RPG_GAMECORE_ADVENTUREMOVEMENTMANAGER_CLASS_2_51493B4B8F18C2B7__CTOR_OFFSET UNITYSDK_OFFSET(0xA845CD0)
#define RPG_GAMECORE_ADVENTUREMOVEMENTMANAGER_CLASS_2_51493B4B8F18C2B7___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA84A580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureMovementManager_Class_2_51493B4B8F18C2B7_TypeDefinitionIndex = 45966;
	...
	{
	public:
		::UnityEngine::SphereCollider* Field_2_0; // 0x38
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_GAMECORE_ADVENTUREMOVEMENTMANAGER_CLASS_2_51493B4B8F18C2B7___IFIXBASEPROXY_DISPOSE_OFFSET))(this);
		}
	};
}
