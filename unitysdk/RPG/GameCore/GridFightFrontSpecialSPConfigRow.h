...
#define RPG_GAMECORE_GRIDFIGHTFRONTSPECIALSPCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1725E390)
#define RPG_GAMECORE_GRIDFIGHTFRONTSPECIALSPCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1725E580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightFrontSpecialSPConfigRow_TypeDefinitionIndex = 12381;
	...
	public:
		...
		::RPG::GameCore::GridFightFrontSpecialSPDisplayType SpecialSPType; // 0x18
