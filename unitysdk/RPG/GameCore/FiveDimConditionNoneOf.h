...
#define RPG_GAMECORE_FIVEDIMCONDITIONNONEOF_METHOD_3_45F6F2BCB43B16D4_OFFSET UNITYSDK_OFFSET(0x1D0A6D70)
#define RPG_GAMECORE_FIVEDIMCONDITIONNONEOF_METHOD_3_642EF283128D42B7_OFFSET UNITYSDK_OFFSET(0x1D0A4290)
#define RPG_GAMECORE_FIVEDIMCONDITIONNONEOF__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0A4280)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimConditionNoneOf_TypeDefinitionIndex = 18587;
