...
#define RPG_GAMECORE_FIVEDIMCONDITIONNONEOF_METHOD_3_45F6F2BCB43B16D4_OFFSET UNITYSDK_OFFSET(0x197363E0)
#define RPG_GAMECORE_FIVEDIMCONDITIONNONEOF_METHOD_3_642EF283128D42B7_OFFSET UNITYSDK_OFFSET(0x19733CF0)
#define RPG_GAMECORE_FIVEDIMCONDITIONNONEOF__CTOR_OFFSET UNITYSDK_OFFSET(0x19733CE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimConditionNoneOf_TypeDefinitionIndex = 17885;
