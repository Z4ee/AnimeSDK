...
#define RPG_GAMECORE_FIVEDIMCONDITIONNONEOF_METHOD_3_1F05A0ADA36BD421_OFFSET UNITYSDK_OFFSET(0x171ECF60)
#define RPG_GAMECORE_FIVEDIMCONDITIONNONEOF_METHOD_3_ABAE59FE0153CDE2_OFFSET UNITYSDK_OFFSET(0x171EABD0)
#define RPG_GAMECORE_FIVEDIMCONDITIONNONEOF__CTOR_OFFSET UNITYSDK_OFFSET(0x171EABC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimConditionNoneOf_TypeDefinitionIndex = 17248;
