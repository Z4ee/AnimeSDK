...
#define RPG_GAMECORE_REMOVEAIRLINE_METHOD_3_33A3C5E8C0C9FF87_OFFSET UNITYSDK_OFFSET(0x18CA2640)
#define RPG_GAMECORE_REMOVEAIRLINE_METHOD_3_912AB873C054EE29_OFFSET UNITYSDK_OFFSET(0x18CA25C0)
#define RPG_GAMECORE_REMOVEAIRLINE__CTOR_OFFSET UNITYSDK_OFFSET(0x18CA2610)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveAirline_TypeDefinitionIndex = 20727;
