...
#define RPG_GAMECORE_ADVBYHASMOVESINCELASTTELEPORT_METHOD_4_325DB3E34CA73EE7_OFFSET UNITYSDK_OFFSET(0x1CDC02B0)
#define RPG_GAMECORE_ADVBYHASMOVESINCELASTTELEPORT_METHOD_4_471BDE745F62F8B6_OFFSET UNITYSDK_OFFSET(0x1CDC02F0)
#define RPG_GAMECORE_ADVBYHASMOVESINCELASTTELEPORT_METHOD_4_BDA336B31C5E5D62_OFFSET UNITYSDK_OFFSET(0x1CDC0470)
#define RPG_GAMECORE_ADVBYHASMOVESINCELASTTELEPORT_METHOD_4_DEFA82F086D2F26C_OFFSET UNITYSDK_OFFSET(0x1CDC04A0)
#define RPG_GAMECORE_ADVBYHASMOVESINCELASTTELEPORT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDC02E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvByHasMoveSinceLastTeleport_TypeDefinitionIndex = 20352;
