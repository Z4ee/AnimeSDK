...
#define RPG_GAMECORE_ADVENTUREBYISWEAKTYPEACTIVE_METHOD_4_260D80406448540D_OFFSET UNITYSDK_OFFSET(0x1CBB0500)
#define RPG_GAMECORE_ADVENTUREBYISWEAKTYPEACTIVE_METHOD_4_96C208197175503E_OFFSET UNITYSDK_OFFSET(0x1CBB02D0)
#define RPG_GAMECORE_ADVENTUREBYISWEAKTYPEACTIVE_METHOD_4_A2657AAD4BFA65A7_OFFSET UNITYSDK_OFFSET(0x1CBB0310)
#define RPG_GAMECORE_ADVENTUREBYISWEAKTYPEACTIVE_METHOD_4_F0B5B7EF75253CEB_OFFSET UNITYSDK_OFFSET(0x1CBB04D0)
#define RPG_GAMECORE_ADVENTUREBYISWEAKTYPEACTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CBB0300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureByIsWeakTypeActive_TypeDefinitionIndex = 20550;
