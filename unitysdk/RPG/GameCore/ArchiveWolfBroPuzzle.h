...
#define RPG_GAMECORE_ARCHIVEWOLFBROPUZZLE_METHOD_3_0CA63096CBFE809C_OFFSET UNITYSDK_OFFSET(0x1947CF20)
#define RPG_GAMECORE_ARCHIVEWOLFBROPUZZLE_METHOD_3_0FEF0F36814C832D_OFFSET UNITYSDK_OFFSET(0x1947CFA0)
#define RPG_GAMECORE_ARCHIVEWOLFBROPUZZLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1947CF70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ArchiveWolfBroPuzzle_TypeDefinitionIndex = 20772;
