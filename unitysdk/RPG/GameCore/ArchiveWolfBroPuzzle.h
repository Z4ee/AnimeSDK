...
#define RPG_GAMECORE_ARCHIVEWOLFBROPUZZLE_METHOD_3_0CA63096CBFE809C_OFFSET UNITYSDK_OFFSET(0x186A8530)
#define RPG_GAMECORE_ARCHIVEWOLFBROPUZZLE_METHOD_3_0FEF0F36814C832D_OFFSET UNITYSDK_OFFSET(0x186A85B0)
#define RPG_GAMECORE_ARCHIVEWOLFBROPUZZLE__CTOR_OFFSET UNITYSDK_OFFSET(0x186A8580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ArchiveWolfBroPuzzle_TypeDefinitionIndex = 20852;
