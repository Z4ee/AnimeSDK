...
#define RPG_GAMECORE_BYCOMPAREENVPROFILEPATH_METHOD_4_74A17B2BA6EF7BBD_OFFSET UNITYSDK_OFFSET(0x1872BA80)
#define RPG_GAMECORE_BYCOMPAREENVPROFILEPATH_METHOD_4_99A8EF3D6CF1631B_OFFSET UNITYSDK_OFFSET(0x1872B9B0)
#define RPG_GAMECORE_BYCOMPAREENVPROFILEPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1872BA30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareEnvProfilePath_TypeDefinitionIndex = 19547;
