...
#define RPG_GAMECORE_DAMAGEPERFORMFINISH_METHOD_3_58EEA8822C2ACC1C_OFFSET UNITYSDK_OFFSET(0x1884F270)
#define RPG_GAMECORE_DAMAGEPERFORMFINISH_METHOD_3_D25523C21EAF3109_OFFSET UNITYSDK_OFFSET(0x1884F0B0)
#define RPG_GAMECORE_DAMAGEPERFORMFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1884F240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DamagePerformFinish_TypeDefinitionIndex = 21512;
