...
#define RPG_GAMECORE_STARTPROPSCENESELECTION_METHOD_3_8C03A9402CD9F962_OFFSET UNITYSDK_OFFSET(0x17775DD0)
#define RPG_GAMECORE_STARTPROPSCENESELECTION_METHOD_3_9B0BAF52964D8013_OFFSET UNITYSDK_OFFSET(0x17775D40)
#define RPG_GAMECORE_STARTPROPSCENESELECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x17775DA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StartPropSceneSelection_TypeDefinitionIndex = 20202;
