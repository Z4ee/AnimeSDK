...
#define RPG_GAMECORE_FIVEDIMBUBBLETALKACTION_METHOD_3_40A28EAFDBD21E77_OFFSET UNITYSDK_OFFSET(0x171E59F0)
#define RPG_GAMECORE_FIVEDIMBUBBLETALKACTION_METHOD_3_8C1697CDBB9294F1_OFFSET UNITYSDK_OFFSET(0x171EB270)
#define RPG_GAMECORE_FIVEDIMBUBBLETALKACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x171E59D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimBubbleTalkAction_TypeDefinitionIndex = 17230;
