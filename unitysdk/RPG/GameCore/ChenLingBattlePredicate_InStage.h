...
#define RPG_GAMECORE_CHENLINGBATTLEPREDICATE_INSTAGE_METHOD_3_6BA8927567762926_OFFSET UNITYSDK_OFFSET(0x1CFAB830)
#define RPG_GAMECORE_CHENLINGBATTLEPREDICATE_INSTAGE_METHOD_3_AE478FE5C856D6AA_OFFSET UNITYSDK_OFFSET(0x1CFAB900)
#define RPG_GAMECORE_CHENLINGBATTLEPREDICATE_INSTAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFAB8F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattlePredicate_InStage_TypeDefinitionIndex = 15643;
