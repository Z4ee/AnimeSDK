...
#define RPG_GAMECORE_MARBLESETFINISH_METHOD_3_6771130C752EB8FA_OFFSET UNITYSDK_OFFSET(0x18AA7BA0)
#define RPG_GAMECORE_MARBLESETFINISH_METHOD_3_E51B65F6FDEE6E91_OFFSET UNITYSDK_OFFSET(0x18AA7A60)
#define RPG_GAMECORE_MARBLESETFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x18AA7B50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleSetFinish_TypeDefinitionIndex = 15942;
