...
#define RPG_GAMECORE_MARBLESETFINISH_METHOD_3_6771130C752EB8FA_OFFSET UNITYSDK_OFFSET(0x17399B40)
#define RPG_GAMECORE_MARBLESETFINISH_METHOD_3_E51B65F6FDEE6E91_OFFSET UNITYSDK_OFFSET(0x17399A00)
#define RPG_GAMECORE_MARBLESETFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x17399AF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleSetFinish_TypeDefinitionIndex = 15422;
