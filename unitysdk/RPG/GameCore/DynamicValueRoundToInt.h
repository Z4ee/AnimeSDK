...
#define RPG_GAMECORE_DYNAMICVALUEROUNDTOINT_METHOD_3_3005453B53689E1E_OFFSET UNITYSDK_OFFSET(0x18895370)
#define RPG_GAMECORE_DYNAMICVALUEROUNDTOINT_METHOD_3_F8109180F15459EF_OFFSET UNITYSDK_OFFSET(0x188952F0)
#define RPG_GAMECORE_DYNAMICVALUEROUNDTOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x18895340)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DynamicValueRoundToInt_TypeDefinitionIndex = 21878;
