...
#define RPG_GAMECORE_DYNAMICVALUEROUNDTOINT_METHOD_3_3005453B53689E1E_OFFSET UNITYSDK_OFFSET(0x17187D70)
#define RPG_GAMECORE_DYNAMICVALUEROUNDTOINT_METHOD_3_F8109180F15459EF_OFFSET UNITYSDK_OFFSET(0x17187CF0)
#define RPG_GAMECORE_DYNAMICVALUEROUNDTOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x17187D40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DynamicValueRoundToInt_TypeDefinitionIndex = 21161;
