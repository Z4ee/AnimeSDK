...
#define RPG_GAMECORE_LOADSWORDTRAININGPROPERTY_METHOD_3_4EF9FD69FAD563C1_OFFSET UNITYSDK_OFFSET(0x1BCC8E10)
#define RPG_GAMECORE_LOADSWORDTRAININGPROPERTY_METHOD_3_6DE60F42540D3C44_OFFSET UNITYSDK_OFFSET(0x1BCC8D40)
#define RPG_GAMECORE_LOADSWORDTRAININGPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCC8E00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoadSwordTrainingProperty_TypeDefinitionIndex = 21780;
