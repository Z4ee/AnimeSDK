...
#define RPG_GAMECORE_LOADSWORDTRAININGPROPERTY_METHOD_3_1791C2BAFD862ECD_OFFSET UNITYSDK_OFFSET(0x173644A0)
#define RPG_GAMECORE_LOADSWORDTRAININGPROPERTY_METHOD_3_4EF9FD69FAD563C1_OFFSET UNITYSDK_OFFSET(0x173645B0)
#define RPG_GAMECORE_LOADSWORDTRAININGPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x17364580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoadSwordTrainingProperty_TypeDefinitionIndex = 20779;
