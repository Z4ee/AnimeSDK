...
#define RPG_GAMECORE_FATEACTBANMASTERCONFIG_METHOD_6_39E8CB499869A330_OFFSET UNITYSDK_OFFSET(0x1970BAF0)
#define RPG_GAMECORE_FATEACTBANMASTERCONFIG_METHOD_6_D173B479CE02C45B_OFFSET UNITYSDK_OFFSET(0x1970BC60)
#define RPG_GAMECORE_FATEACTBANMASTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1970BBC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateActBanMasterConfig_TypeDefinitionIndex = 18254;
