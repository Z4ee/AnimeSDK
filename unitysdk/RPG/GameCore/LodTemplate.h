...
#define RPG_GAMECORE_LODTEMPLATE_METHOD_2_B6371B90F9686635_OFFSET UNITYSDK_OFFSET(0x1D487B60)
#define RPG_GAMECORE_LODTEMPLATE_METHOD_2_DAD1C3A7A1AA0A49_OFFSET UNITYSDK_OFFSET(0x1D487DC0)
#define RPG_GAMECORE_LODTEMPLATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D487DB0)
