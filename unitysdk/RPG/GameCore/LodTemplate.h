...
#define RPG_GAMECORE_LODTEMPLATE_METHOD_2_B6371B90F9686635_OFFSET UNITYSDK_OFFSET(0x1D2128A0)
#define RPG_GAMECORE_LODTEMPLATE_METHOD_2_DAD1C3A7A1AA0A49_OFFSET UNITYSDK_OFFSET(0x1D212B00)
#define RPG_GAMECORE_LODTEMPLATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D212AF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LodTemplate_TypeDefinitionIndex = 18971;
