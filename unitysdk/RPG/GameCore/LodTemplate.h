...
#define RPG_GAMECORE_LODTEMPLATE_METHOD_2_99F845AFBFA921C5_OFFSET UNITYSDK_OFFSET(0x1736D970)
#define RPG_GAMECORE_LODTEMPLATE_METHOD_2_B6371B90F9686635_OFFSET UNITYSDK_OFFSET(0x1736D730)
#define RPG_GAMECORE_LODTEMPLATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1736D960)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LodTemplate_TypeDefinitionIndex = 17625;
