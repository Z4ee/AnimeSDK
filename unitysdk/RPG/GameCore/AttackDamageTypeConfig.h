...
#define RPG_GAMECORE_ATTACKDAMAGETYPECONFIG_METHOD_2_42A043373CD9509C_OFFSET UNITYSDK_OFFSET(0x1A0663D0)
#define RPG_GAMECORE_ATTACKDAMAGETYPECONFIG_METHOD_2_70AD061FE2E32537_OFFSET UNITYSDK_OFFSET(0x1A065CA0)
#define RPG_GAMECORE_ATTACKDAMAGETYPECONFIG_METHOD_2_D72A8BA1AB8D977A_OFFSET UNITYSDK_OFFSET(0x1A0666F0)
#define RPG_GAMECORE_ATTACKDAMAGETYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0663C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AttackDamageTypeConfig_TypeDefinitionIndex = 22243;
