...
#define RPG_GAMECORE_MISSIONCUSTOMVALUEPAIR_METHOD_2_61C7F6C564FCBF93_OFFSET UNITYSDK_OFFSET(0x19944AC0)
#define RPG_GAMECORE_MISSIONCUSTOMVALUEPAIR__CTOR_OFFSET UNITYSDK_OFFSET(0x19944C60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MissionCustomValuePair_TypeDefinitionIndex = 18038;
