...
#define RPG_GAMECORE_CAKERACECATAICONFIG_METHOD_2_5A3152F0034737CB_OFFSET UNITYSDK_OFFSET(0x1876ED50)
#define RPG_GAMECORE_CAKERACECATAICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1876F110)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceCatAIConfig_TypeDefinitionIndex = 17520;
