...
#define RPG_GAMECORE_SETPROPINTERACTBTNSWITCH_METHOD_3_2128FD4285021B4B_OFFSET UNITYSDK_OFFSET(0x19C5C160)
#define RPG_GAMECORE_SETPROPINTERACTBTNSWITCH_METHOD_3_7DC99BC079961EE2_OFFSET UNITYSDK_OFFSET(0x19C5C0E0)
#define RPG_GAMECORE_SETPROPINTERACTBTNSWITCH__CTOR_OFFSET UNITYSDK_OFFSET(0x19C5C130)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetPropInteractBtnSwitch_TypeDefinitionIndex = 20797;
