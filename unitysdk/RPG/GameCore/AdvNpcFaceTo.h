...
#define RPG_GAMECORE_ADVNPCFACETO_METHOD_3_3C8AC6D6EA9110D1_OFFSET UNITYSDK_OFFSET(0x16F36140)
#define RPG_GAMECORE_ADVNPCFACETO_METHOD_3_61A32E4441B12701_OFFSET UNITYSDK_OFFSET(0x16F361D0)
#define RPG_GAMECORE_ADVNPCFACETO__CTOR_OFFSET UNITYSDK_OFFSET(0x16F361A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvNpcFaceTo_TypeDefinitionIndex = 18626;
	...
	public:
		...
		static ::System::Void Method_3_3C8AC6D6EA9110D1(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::AdvNpcFaceTo*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::AdvNpcFaceTo*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_ADVNPCFACETO_METHOD_3_3C8AC6D6EA9110D1_OFFSET))(a1, a2);
		}
