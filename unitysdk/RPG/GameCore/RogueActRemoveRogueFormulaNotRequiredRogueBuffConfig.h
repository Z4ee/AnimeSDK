...
#define RPG_GAMECORE_ROGUEACTREMOVEROGUEFORMULANOTREQUIREDROGUEBUFFCONFIG_METHOD_6_864A9133607A5B86_OFFSET UNITYSDK_OFFSET(0x175C5F00)
#define RPG_GAMECORE_ROGUEACTREMOVEROGUEFORMULANOTREQUIREDROGUEBUFFCONFIG_METHOD_6_AA6C8D16B757F613_OFFSET UNITYSDK_OFFSET(0x175C6120)
#define RPG_GAMECORE_ROGUEACTREMOVEROGUEFORMULANOTREQUIREDROGUEBUFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175C6040)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActRemoveRogueFormulaNotRequiredRogueBuffConfig_TypeDefinitionIndex = 18024;
