...
#define RPG_GAMECORE_FATEACTADDSHOPBONUSGOODSCONFIG_METHOD_6_71C5B6BD601F20F7_OFFSET UNITYSDK_OFFSET(0x1970B670)
#define RPG_GAMECORE_FATEACTADDSHOPBONUSGOODSCONFIG_METHOD_6_C13BA5DE5D010694_OFFSET UNITYSDK_OFFSET(0x1970B7E0)
#define RPG_GAMECORE_FATEACTADDSHOPBONUSGOODSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1970B740)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateActAddShopBonusGoodsConfig_TypeDefinitionIndex = 18252;
