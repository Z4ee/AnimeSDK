...
#define RPG_GAMECORE_FATEACTADDSHOPBONUSGOODSCONFIG_METHOD_6_08504A93FC67F298_OFFSET UNITYSDK_OFFSET(0x1C0734B0)
#define RPG_GAMECORE_FATEACTADDSHOPBONUSGOODSCONFIG_METHOD_6_C13BA5DE5D010694_OFFSET UNITYSDK_OFFSET(0x1C073500)
#define RPG_GAMECORE_FATEACTADDSHOPBONUSGOODSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0734F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateActAddShopBonusGoodsConfig_TypeDefinitionIndex = 18486;
