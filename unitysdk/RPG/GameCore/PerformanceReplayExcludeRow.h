...
#define RPG_GAMECORE_PERFORMANCEREPLAYEXCLUDEROW_FROMBINARYWITHOUTNEW_OFFSET UNITYSDK_OFFSET(0x1B4B2DF0)
#define RPG_GAMECORE_PERFORMANCEREPLAYEXCLUDEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B4B2EE0)
#define RPG_GAMECORE_PERFORMANCEREPLAYEXCLUDEROW_FROMTABLEOFFSET_OFFSET UNITYSDK_OFFSET(0x1B4B2D80)
#define RPG_GAMECORE_PERFORMANCEREPLAYEXCLUDEROW_RESET_OFFSET UNITYSDK_OFFSET(0x1B4B2DE0)
#define RPG_GAMECORE_PERFORMANCEREPLAYEXCLUDEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4B3010)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PerformanceReplayExcludeRow_TypeDefinitionIndex = 13822;
