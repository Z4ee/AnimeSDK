...
#define RPG_GAMECORE_CHIMERADUELPREDICATEBASE_METHOD_2_7EF2F4FF5908A4B0_OFFSET UNITYSDK_OFFSET(0x170A2700)
#define RPG_GAMECORE_CHIMERADUELPREDICATEBASE_METHOD_2_A2536585F11B097F_OFFSET UNITYSDK_OFFSET(0x170A1000)
#define RPG_GAMECORE_CHIMERADUELPREDICATEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x170A2760)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelPredicateBase_TypeDefinitionIndex = 14668;
