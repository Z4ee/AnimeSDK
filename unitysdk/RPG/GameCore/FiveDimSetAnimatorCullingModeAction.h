...
#define RPG_GAMECORE_FIVEDIMSETANIMATORCULLINGMODEACTION_METHOD_3_E094A7A25050DF63_OFFSET UNITYSDK_OFFSET(0x1D877DB0)
#define RPG_GAMECORE_FIVEDIMSETANIMATORCULLINGMODEACTION_METHOD_3_EAEC3C1A3D03C870_OFFSET UNITYSDK_OFFSET(0x1D877D70)
#define RPG_GAMECORE_FIVEDIMSETANIMATORCULLINGMODEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D877DA0)
