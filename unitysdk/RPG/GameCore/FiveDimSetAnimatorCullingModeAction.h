...
#define RPG_GAMECORE_FIVEDIMSETANIMATORCULLINGMODEACTION_METHOD_3_73283CE255FF5AAC_OFFSET UNITYSDK_OFFSET(0x1891A2E0)
#define RPG_GAMECORE_FIVEDIMSETANIMATORCULLINGMODEACTION_METHOD_3_E094A7A25050DF63_OFFSET UNITYSDK_OFFSET(0x1891A350)
#define RPG_GAMECORE_FIVEDIMSETANIMATORCULLINGMODEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1891A330)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSetAnimatorCullingModeAction_TypeDefinitionIndex = 17773;
