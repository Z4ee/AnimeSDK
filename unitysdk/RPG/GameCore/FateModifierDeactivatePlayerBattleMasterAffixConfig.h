...
#define RPG_GAMECORE_FATEMODIFIERDEACTIVATEPLAYERBATTLEMASTERAFFIXCONFIG_METHOD_3_0B297A2A12DAD613_OFFSET UNITYSDK_OFFSET(0x1C074E10)
#define RPG_GAMECORE_FATEMODIFIERDEACTIVATEPLAYERBATTLEMASTERAFFIXCONFIG_METHOD_3_6F330D0F9580FD4F_OFFSET UNITYSDK_OFFSET(0x1C074DC0)
#define RPG_GAMECORE_FATEMODIFIERDEACTIVATEPLAYERBATTLEMASTERAFFIXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C074E00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateModifierDeactivatePlayerBattleMasterAffixConfig_TypeDefinitionIndex = 18514;
