...
#define RPG_GAMECORE_ADVENTUREATTACKDETECTSHAPECONFIG_METHOD_2_249F6D388E30B97E_OFFSET UNITYSDK_OFFSET(0x1866D4B0)
#define RPG_GAMECORE_ADVENTUREATTACKDETECTSHAPECONFIG_METHOD_2_2A4A54B57813716F_OFFSET UNITYSDK_OFFSET(0x1866D6A0)
#define RPG_GAMECORE_ADVENTUREATTACKDETECTSHAPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1866D250)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureAttackDetectShapeConfig_TypeDefinitionIndex = 15397;
