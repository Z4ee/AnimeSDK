...
#define RPG_GAMECORE_ADVENTUREATTACKDETECTSHAPECONFIG_METHOD_2_249F6D388E30B97E_OFFSET UNITYSDK_OFFSET(0x194400B0)
#define RPG_GAMECORE_ADVENTUREATTACKDETECTSHAPECONFIG_METHOD_2_2A4A54B57813716F_OFFSET UNITYSDK_OFFSET(0x194402A0)
#define RPG_GAMECORE_ADVENTUREATTACKDETECTSHAPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1943FE50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureAttackDetectShapeConfig_TypeDefinitionIndex = 15460;
