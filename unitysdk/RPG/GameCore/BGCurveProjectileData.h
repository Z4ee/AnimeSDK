...
#define RPG_GAMECORE_BGCURVEPROJECTILEDATA_METHOD_3_AF3FD6E9A78823CD_OFFSET UNITYSDK_OFFSET(0x1CE5F280)
#define RPG_GAMECORE_BGCURVEPROJECTILEDATA_METHOD_3_B9C6AFD4966F3286_OFFSET UNITYSDK_OFFSET(0x1CE5F180)
#define RPG_GAMECORE_BGCURVEPROJECTILEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE5F210)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BGCurveProjectileData_TypeDefinitionIndex = 15497;
