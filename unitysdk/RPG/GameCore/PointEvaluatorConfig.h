...
#define RPG_GAMECORE_POINTEVALUATORCONFIG_METHOD_2_0CB5F8D4399A76F0_OFFSET UNITYSDK_OFFSET(0x19A43E00)
#define RPG_GAMECORE_POINTEVALUATORCONFIG_METHOD_2_9A5787E9BA923BA4_OFFSET UNITYSDK_OFFSET(0x19A440F0)
#define RPG_GAMECORE_POINTEVALUATORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19A43DF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PointEvaluatorConfig_TypeDefinitionIndex = 14858;
