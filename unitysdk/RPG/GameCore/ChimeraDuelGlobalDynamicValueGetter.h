...
#define RPG_GAMECORE_CHIMERADUELGLOBALDYNAMICVALUEGETTER_METHOD_3_312683B4167FFDC0_OFFSET UNITYSDK_OFFSET(0x187FCF10)
#define RPG_GAMECORE_CHIMERADUELGLOBALDYNAMICVALUEGETTER_METHOD_3_8C61F8394AEE02CE_OFFSET UNITYSDK_OFFSET(0x187FCEB0)
#define RPG_GAMECORE_CHIMERADUELGLOBALDYNAMICVALUEGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x187FCF00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelGlobalDynamicValueGetter_TypeDefinitionIndex = 15163;
