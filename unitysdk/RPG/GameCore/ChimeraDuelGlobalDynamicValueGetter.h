...
#define RPG_GAMECORE_CHIMERADUELGLOBALDYNAMICVALUEGETTER_METHOD_3_312683B4167FFDC0_OFFSET UNITYSDK_OFFSET(0x1963F020)
#define RPG_GAMECORE_CHIMERADUELGLOBALDYNAMICVALUEGETTER_METHOD_3_8C61F8394AEE02CE_OFFSET UNITYSDK_OFFSET(0x1963EFC0)
#define RPG_GAMECORE_CHIMERADUELGLOBALDYNAMICVALUEGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1963F010)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelGlobalDynamicValueGetter_TypeDefinitionIndex = 15224;
