...
#define RPG_GAMECORE_ADVENTURESETATTACKTARGETWITHOUTBATTLE_METHOD_3_6F420CA0942F9CAE_OFFSET UNITYSDK_OFFSET(0x1867CA90)
#define RPG_GAMECORE_ADVENTURESETATTACKTARGETWITHOUTBATTLE_METHOD_3_B40491D83480E3DF_OFFSET UNITYSDK_OFFSET(0x1867CB10)
#define RPG_GAMECORE_ADVENTURESETATTACKTARGETWITHOUTBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1867CAE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureSetAttackTargetWithoutBattle_TypeDefinitionIndex = 20610;
