...
#define RPG_GAMECORE_ADVENTURESETATTACKTARGETWITHOUTBATTLE_METHOD_3_6F420CA0942F9CAE_OFFSET UNITYSDK_OFFSET(0x19453810)
#define RPG_GAMECORE_ADVENTURESETATTACKTARGETWITHOUTBATTLE_METHOD_3_B40491D83480E3DF_OFFSET UNITYSDK_OFFSET(0x19453890)
#define RPG_GAMECORE_ADVENTURESETATTACKTARGETWITHOUTBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x19453860)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureSetAttackTargetWithoutBattle_TypeDefinitionIndex = 20543;
