...
#define RPG_GAMECORE_PROPSTARTFARMELEMENT_METHOD_3_6BBE6702D8B3A356_OFFSET UNITYSDK_OFFSET(0x1D372210)
#define RPG_GAMECORE_PROPSTARTFARMELEMENT_METHOD_3_6C8B3693C9128093_OFFSET UNITYSDK_OFFSET(0x1D372140)
#define RPG_GAMECORE_PROPSTARTFARMELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D372200)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropStartFarmElement_TypeDefinitionIndex = 21840;
