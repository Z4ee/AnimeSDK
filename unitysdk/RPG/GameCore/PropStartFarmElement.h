...
#define RPG_GAMECORE_PROPSTARTFARMELEMENT_METHOD_3_6BBE6702D8B3A356_OFFSET UNITYSDK_OFFSET(0x18C78FB0)
#define RPG_GAMECORE_PROPSTARTFARMELEMENT_METHOD_3_95442A46FD74758A_OFFSET UNITYSDK_OFFSET(0x18C78EA0)
#define RPG_GAMECORE_PROPSTARTFARMELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x18C78F80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropStartFarmElement_TypeDefinitionIndex = 20952;
