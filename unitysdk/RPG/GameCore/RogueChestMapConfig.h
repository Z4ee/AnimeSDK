...
#define RPG_GAMECORE_ROGUECHESTMAPCONFIG_METHOD_2_857192509F1C804E_OFFSET UNITYSDK_OFFSET(0x1D9171A0)
#define RPG_GAMECORE_ROGUECHESTMAPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D9174D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueChestMapConfig_TypeDefinitionIndex = 17702;
