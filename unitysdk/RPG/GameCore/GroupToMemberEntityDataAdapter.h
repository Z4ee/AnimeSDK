...
#define RPG_GAMECORE_GROUPTOMEMBERENTITYDATAADAPTER_METHOD_3_C684DAC13DAC644A_OFFSET UNITYSDK_OFFSET(0x189E1BE0)
#define RPG_GAMECORE_GROUPTOMEMBERENTITYDATAADAPTER_METHOD_3_DCB5BA2F0EBA6D39_OFFSET UNITYSDK_OFFSET(0x189E1C60)
#define RPG_GAMECORE_GROUPTOMEMBERENTITYDATAADAPTER__CTOR_OFFSET UNITYSDK_OFFSET(0x189E1C30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GroupToMemberEntityDataAdapter_TypeDefinitionIndex = 19717;
