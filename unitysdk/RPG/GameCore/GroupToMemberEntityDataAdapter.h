...
#define RPG_GAMECORE_GROUPTOMEMBERENTITYDATAADAPTER_METHOD_3_BC9137AD207578AA_OFFSET UNITYSDK_OFFSET(0x1D171B70)
#define RPG_GAMECORE_GROUPTOMEMBERENTITYDATAADAPTER_METHOD_3_DCB5BA2F0EBA6D39_OFFSET UNITYSDK_OFFSET(0x1D171BB0)
#define RPG_GAMECORE_GROUPTOMEMBERENTITYDATAADAPTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D171BA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GroupToMemberEntityDataAdapter_TypeDefinitionIndex = 20502;
