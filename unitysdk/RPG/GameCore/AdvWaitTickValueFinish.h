...
#define RPG_GAMECORE_ADVWAITTICKVALUEFINISH_METHOD_3_3D56ABD552E8F24C_OFFSET UNITYSDK_OFFSET(0x186688D0)
#define RPG_GAMECORE_ADVWAITTICKVALUEFINISH_METHOD_3_A8C99AC848142328_OFFSET UNITYSDK_OFFSET(0x186689A0)
#define RPG_GAMECORE_ADVWAITTICKVALUEFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x18668950)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvWaitTickValueFinish_TypeDefinitionIndex = 20014;
