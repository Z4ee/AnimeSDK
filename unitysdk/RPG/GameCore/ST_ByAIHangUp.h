...
#define RPG_GAMECORE_ST_BYAIHANGUP_METHOD_4_93BCF57104C1002F_OFFSET UNITYSDK_OFFSET(0x17691250)
#define RPG_GAMECORE_ST_BYAIHANGUP_METHOD_4_F1546C9832841F45_OFFSET UNITYSDK_OFFSET(0x17691320)
#define RPG_GAMECORE_ST_BYAIHANGUP__CTOR_OFFSET UNITYSDK_OFFSET(0x176912D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_ByAIHangUp_TypeDefinitionIndex = 18353;
