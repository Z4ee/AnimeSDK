...
#define RPG_GAMECORE_SHOWPUZZLEHUDWOLFBRO_METHOD_3_D645F4DE83D4B650_OFFSET UNITYSDK_OFFSET(0x19C811A0)
#define RPG_GAMECORE_SHOWPUZZLEHUDWOLFBRO_METHOD_3_DF69C2D5FCEE4409_OFFSET UNITYSDK_OFFSET(0x19C81220)
#define RPG_GAMECORE_SHOWPUZZLEHUDWOLFBRO__CTOR_OFFSET UNITYSDK_OFFSET(0x19C811F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowPuzzleHudWolfBro_TypeDefinitionIndex = 21075;
