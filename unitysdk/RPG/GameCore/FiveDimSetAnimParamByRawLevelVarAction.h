...
#define RPG_GAMECORE_FIVEDIMSETANIMPARAMBYRAWLEVELVARACTION_METHOD_3_7AE683FF19DFADC0_OFFSET UNITYSDK_OFFSET(0x1BEAF600)
#define RPG_GAMECORE_FIVEDIMSETANIMPARAMBYRAWLEVELVARACTION_METHOD_3_BE70B044C2D14CDD_OFFSET UNITYSDK_OFFSET(0x1BEAF5C0)
#define RPG_GAMECORE_FIVEDIMSETANIMPARAMBYRAWLEVELVARACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEAF5F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSetAnimParamByRawLevelVarAction_TypeDefinitionIndex = 17918;
