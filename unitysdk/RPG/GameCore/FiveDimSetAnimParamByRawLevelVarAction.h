...
#define RPG_GAMECORE_FIVEDIMSETANIMPARAMBYRAWLEVELVARACTION_METHOD_3_7AE683FF19DFADC0_OFFSET UNITYSDK_OFFSET(0x17208720)
#define RPG_GAMECORE_FIVEDIMSETANIMPARAMBYRAWLEVELVARACTION_METHOD_3_EC82A3862387F48F_OFFSET UNITYSDK_OFFSET(0x172086B0)
#define RPG_GAMECORE_FIVEDIMSETANIMPARAMBYRAWLEVELVARACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x17208700)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSetAnimParamByRawLevelVarAction_TypeDefinitionIndex = 17116;
