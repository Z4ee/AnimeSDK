...
#define RPG_GAMECORE_ROGUEACTCHANGEROGUEMIRACLETOMAGICUNITCONFIG_METHOD_6_118DC34BD6028BDD_OFFSET UNITYSDK_OFFSET(0x1D3B6FC0)
#define RPG_GAMECORE_ROGUEACTCHANGEROGUEMIRACLETOMAGICUNITCONFIG_METHOD_6_AAB9C74CDC519C19_OFFSET UNITYSDK_OFFSET(0x1D3B6F70)
#define RPG_GAMECORE_ROGUEACTCHANGEROGUEMIRACLETOMAGICUNITCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3B6FB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActChangeRogueMiracleToMagicUnitConfig_TypeDefinitionIndex = 19466;
