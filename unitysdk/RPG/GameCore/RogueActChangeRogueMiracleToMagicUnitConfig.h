...
#define RPG_GAMECORE_ROGUEACTCHANGEROGUEMIRACLETOMAGICUNITCONFIG_METHOD_6_103DB0AC326C9980_OFFSET UNITYSDK_OFFSET(0x19AE35E0)
#define RPG_GAMECORE_ROGUEACTCHANGEROGUEMIRACLETOMAGICUNITCONFIG_METHOD_6_118DC34BD6028BDD_OFFSET UNITYSDK_OFFSET(0x19AE3800)
#define RPG_GAMECORE_ROGUEACTCHANGEROGUEMIRACLETOMAGICUNITCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AE3720)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActChangeRogueMiracleToMagicUnitConfig_TypeDefinitionIndex = 18663;
