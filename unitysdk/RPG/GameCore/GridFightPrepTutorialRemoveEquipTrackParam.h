...
#define RPG_GAMECORE_GRIDFIGHTPREPTUTORIALREMOVEEQUIPTRACKPARAM_METHOD_2_EA8BC63940A74CC6_OFFSET UNITYSDK_OFFSET(0x1D070600)
#define RPG_GAMECORE_GRIDFIGHTPREPTUTORIALREMOVEEQUIPTRACKPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0706D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightPrepTutorialRemoveEquipTrackParam_TypeDefinitionIndex = 19199;
