...
#define RPG_GAMECORE_TRACKNPCTRACKCONFIG_METHOD_2_1475B64C80A48835_OFFSET UNITYSDK_OFFSET(0x1D52F090)
#define RPG_GAMECORE_TRACKNPCTRACKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D52F1C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrackNpcTrackConfig_TypeDefinitionIndex = 21933;
