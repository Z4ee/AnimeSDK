...
#define RPG_GAMECORE_TRACKNPCTRACKCONFIG_METHOD_2_1475B64C80A48835_OFFSET UNITYSDK_OFFSET(0x1C159D00)
#define RPG_GAMECORE_TRACKNPCTRACKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C159E30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrackNpcTrackConfig_TypeDefinitionIndex = 21372;
