...
#define RPG_GAMECORE_RESTAURANTCUSTOMERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D3A9560)
#define RPG_GAMECORE_RESTAURANTCUSTOMERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3A98D0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::RestaurantCustomerType Type; // 0x30
