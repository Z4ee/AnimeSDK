...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYSTYLEEXPGAININPERCENTAGECONFIG_METHOD_3_9168A3EB1CD2AB9D_OFFSET UNITYSDK_OFFSET(0x17636250)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYSTYLEEXPGAININPERCENTAGECONFIG_METHOD_3_C0E23BBE776568D4_OFFSET UNITYSDK_OFFSET(0x17636320)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYSTYLEEXPGAININPERCENTAGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x176362D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyStyleExpGainInPercentageConfig_TypeDefinitionIndex = 16353;
