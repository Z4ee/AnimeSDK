...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYSTYLEEXPGAININPERCENTAGECONFIG_METHOD_3_C0E23BBE776568D4_OFFSET UNITYSDK_OFFSET(0x1D1649B0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYSTYLEEXPGAININPERCENTAGECONFIG_METHOD_3_F562E5CBF6802DD8_OFFSET UNITYSDK_OFFSET(0x1D164960)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYSTYLEEXPGAININPERCENTAGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1649A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyStyleExpGainInPercentageConfig_TypeDefinitionIndex = 17084;
