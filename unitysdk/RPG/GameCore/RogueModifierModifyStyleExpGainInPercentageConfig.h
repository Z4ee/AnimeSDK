...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYSTYLEEXPGAININPERCENTAGECONFIG_METHOD_3_9168A3EB1CD2AB9D_OFFSET UNITYSDK_OFFSET(0x18D42DA0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYSTYLEEXPGAININPERCENTAGECONFIG_METHOD_3_C0E23BBE776568D4_OFFSET UNITYSDK_OFFSET(0x18D42E70)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYSTYLEEXPGAININPERCENTAGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D42E20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyStyleExpGainInPercentageConfig_TypeDefinitionIndex = 16907;
