...
#define RPG_GAMECORE_SHOWBATTLESKILLENHANCED_METHOD_3_79F21717C46CAB7A_OFFSET UNITYSDK_OFFSET(0x1D523DE0)
#define RPG_GAMECORE_SHOWBATTLESKILLENHANCED_METHOD_3_90BE7022014482EF_OFFSET UNITYSDK_OFFSET(0x1D523D90)
#define RPG_GAMECORE_SHOWBATTLESKILLENHANCED__CTOR_OFFSET UNITYSDK_OFFSET(0x1D523DD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowBattleSkillEnhanced_TypeDefinitionIndex = 22670;
