...
#define RPG_GAMECORE_SHOWBATTLESKILLENHANCED_METHOD_3_79F21717C46CAB7A_OFFSET UNITYSDK_OFFSET(0x176F6060)
#define RPG_GAMECORE_SHOWBATTLESKILLENHANCED_METHOD_3_AA9B7CF92C3EE14D_OFFSET UNITYSDK_OFFSET(0x176F5FD0)
#define RPG_GAMECORE_SHOWBATTLESKILLENHANCED__CTOR_OFFSET UNITYSDK_OFFSET(0x176F6030)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowBattleSkillEnhanced_TypeDefinitionIndex = 21122;
