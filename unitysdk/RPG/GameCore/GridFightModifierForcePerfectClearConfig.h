...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERFORCEPERFECTCLEARCONFIG_METHOD_3_84A9160FB188C1C1_OFFSET UNITYSDK_OFFSET(0x1D159A60)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERFORCEPERFECTCLEARCONFIG_METHOD_3_B06667034137DE25_OFFSET UNITYSDK_OFFSET(0x1D159AB0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERFORCEPERFECTCLEARCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D159AA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierForcePerfectClearConfig_TypeDefinitionIndex = 19227;
