...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERSUPPLYCONFIG_METHOD_3_16260B582BE719D0_OFFSET UNITYSDK_OFFSET(0x17266CA0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERSUPPLYCONFIG_METHOD_3_802D1CE163CF8C79_OFFSET UNITYSDK_OFFSET(0x1726A9F0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERSUPPLYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17266C50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierExecActionAfterSupplyConfig_TypeDefinitionIndex = 17777;
