...
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERSUPPLYCONFIG_METHOD_3_16260B582BE719D0_OFFSET UNITYSDK_OFFSET(0x1D1594B0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERSUPPLYCONFIG_METHOD_3_F9D9C0E0789C63D4_OFFSET UNITYSDK_OFFSET(0x1D159460)
#define RPG_GAMECORE_GRIDFIGHTMODIFIEREXECACTIONAFTERSUPPLYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1594A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierExecActionAfterSupplyConfig_TypeDefinitionIndex = 19136;
