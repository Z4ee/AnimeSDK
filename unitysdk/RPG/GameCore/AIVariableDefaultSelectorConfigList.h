...
#define RPG_GAMECORE_AIVARIABLEDEFAULTSELECTORCONFIGLIST_METHOD_3_DAFBA574900F8D75_OFFSET UNITYSDK_OFFSET(0x16E93930)
#define RPG_GAMECORE_AIVARIABLEDEFAULTSELECTORCONFIGLIST_METHOD_3_E88E0A46C5D6DABA_OFFSET UNITYSDK_OFFSET(0x16E92C60)
#define RPG_GAMECORE_AIVARIABLEDEFAULTSELECTORCONFIGLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x16E92C50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AIVariableDefaultSelectorConfigList_TypeDefinitionIndex = 14308;
