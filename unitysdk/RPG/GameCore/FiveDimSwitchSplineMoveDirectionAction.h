...
#define RPG_GAMECORE_FIVEDIMSWITCHSPLINEMOVEDIRECTIONACTION_METHOD_3_5789F3D95E44074D_OFFSET UNITYSDK_OFFSET(0x1BEB73B0)
#define RPG_GAMECORE_FIVEDIMSWITCHSPLINEMOVEDIRECTIONACTION_METHOD_3_9974476792CE0EE8_OFFSET UNITYSDK_OFFSET(0x1BEB7330)
#define RPG_GAMECORE_FIVEDIMSWITCHSPLINEMOVEDIRECTIONACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEB73A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSwitchSplineMoveDirectionAction_TypeDefinitionIndex = 17931;
