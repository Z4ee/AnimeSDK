...
#define RPG_GAMECORE_FIVEDIMSWITCHSPLINEMOVEDIRECTIONACTION_METHOD_3_5789F3D95E44074D_OFFSET UNITYSDK_OFFSET(0x18922260)
#define RPG_GAMECORE_FIVEDIMSWITCHSPLINEMOVEDIRECTIONACTION_METHOD_3_EA400A87EBB66598_OFFSET UNITYSDK_OFFSET(0x189221A0)
#define RPG_GAMECORE_FIVEDIMSWITCHSPLINEMOVEDIRECTIONACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18922240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSwitchSplineMoveDirectionAction_TypeDefinitionIndex = 17730;
