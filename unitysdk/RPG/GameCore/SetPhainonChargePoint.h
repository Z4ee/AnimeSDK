...
#define RPG_GAMECORE_SETPHAINONCHARGEPOINT_METHOD_3_D23EB9774B07F170_OFFSET UNITYSDK_OFFSET(0x18E3E600)
#define RPG_GAMECORE_SETPHAINONCHARGEPOINT_METHOD_3_DFB3350920B77EC0_OFFSET UNITYSDK_OFFSET(0x18E3E580)
#define RPG_GAMECORE_SETPHAINONCHARGEPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x18E3E5D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetPhainonChargePoint_TypeDefinitionIndex = 22108;
