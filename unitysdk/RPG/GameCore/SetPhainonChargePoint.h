...
#define RPG_GAMECORE_SETPHAINONCHARGEPOINT_METHOD_3_8892FECD41DBD9C3_OFFSET UNITYSDK_OFFSET(0x1E08AA10)
#define RPG_GAMECORE_SETPHAINONCHARGEPOINT_METHOD_3_D23EB9774B07F170_OFFSET UNITYSDK_OFFSET(0x1E08AA50)
#define RPG_GAMECORE_SETPHAINONCHARGEPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E08AA40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetPhainonChargePoint_TypeDefinitionIndex = 22896;
