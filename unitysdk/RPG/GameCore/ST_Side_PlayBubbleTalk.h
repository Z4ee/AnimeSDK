...
#define RPG_GAMECORE_ST_SIDE_PLAYBUBBLETALK_METHOD_4_5FFFEB07AD296417_OFFSET UNITYSDK_OFFSET(0x1D4D2560)
#define RPG_GAMECORE_ST_SIDE_PLAYBUBBLETALK_METHOD_4_85135766A45D7BDE_OFFSET UNITYSDK_OFFSET(0x1D4D25B0)
#define RPG_GAMECORE_ST_SIDE_PLAYBUBBLETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4D25A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_PlayBubbleTalk_TypeDefinitionIndex = 19910;
