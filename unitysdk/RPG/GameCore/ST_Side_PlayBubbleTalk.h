...
#define RPG_GAMECORE_ST_SIDE_PLAYBUBBLETALK_METHOD_4_5917DB0E738E158C_OFFSET UNITYSDK_OFFSET(0x176998D0)
#define RPG_GAMECORE_ST_SIDE_PLAYBUBBLETALK_METHOD_4_85135766A45D7BDE_OFFSET UNITYSDK_OFFSET(0x1768E2E0)
#define RPG_GAMECORE_ST_SIDE_PLAYBUBBLETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1768E280)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_PlayBubbleTalk_TypeDefinitionIndex = 18429;
	...
	public:
		...
		static ::System::Void Method_4_5917DB0E738E158C(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::ST_Side_PlayBubbleTalk*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::ST_Side_PlayBubbleTalk*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_ST_SIDE_PLAYBUBBLETALK_METHOD_4_5917DB0E738E158C_OFFSET))(a1, a2);
		}
