...
#define RPG_GAMECORE_ST_SIDE_PLAYBUBBLETALK_METHOD_4_5917DB0E738E158C_OFFSET UNITYSDK_OFFSET(0x18DFA6E0)
#define RPG_GAMECORE_ST_SIDE_PLAYBUBBLETALK_METHOD_4_85135766A45D7BDE_OFFSET UNITYSDK_OFFSET(0x18DFA7C0)
#define RPG_GAMECORE_ST_SIDE_PLAYBUBBLETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x18DFA760)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_PlayBubbleTalk_TypeDefinitionIndex = 19082;
