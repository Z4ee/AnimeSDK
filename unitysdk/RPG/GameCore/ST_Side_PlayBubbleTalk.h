...
#define RPG_GAMECORE_ST_SIDE_PLAYBUBBLETALK_METHOD_4_5917DB0E738E158C_OFFSET UNITYSDK_OFFSET(0x19C1AD10)
#define RPG_GAMECORE_ST_SIDE_PLAYBUBBLETALK_METHOD_4_85135766A45D7BDE_OFFSET UNITYSDK_OFFSET(0x19C0C300)
#define RPG_GAMECORE_ST_SIDE_PLAYBUBBLETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x19C0C2A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_PlayBubbleTalk_TypeDefinitionIndex = 19017;
