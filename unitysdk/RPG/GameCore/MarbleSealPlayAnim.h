...
#define RPG_GAMECORE_MARBLESEALPLAYANIM_METHOD_3_4B84E9FC3DBE24AE_OFFSET UNITYSDK_OFFSET(0x173987F0)
#define RPG_GAMECORE_MARBLESEALPLAYANIM_METHOD_3_4FCA15F982F026CF_OFFSET UNITYSDK_OFFSET(0x17398870)
#define RPG_GAMECORE_MARBLESEALPLAYANIM__CTOR_OFFSET UNITYSDK_OFFSET(0x17398840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleSealPlayAnim_TypeDefinitionIndex = 20221;
