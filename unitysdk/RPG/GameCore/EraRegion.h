...
#define RPG_GAMECORE_ERAREGION_METHOD_2_31CD7C9F7ED2B7BE_OFFSET UNITYSDK_OFFSET(0x1D0733B0)
#define RPG_GAMECORE_ERAREGION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D073710)
