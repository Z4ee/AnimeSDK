...
#define RPG_GAMECORE_BYISTEAMLEADER_METHOD_4_1135FB6B9F9EB77B_OFFSET UNITYSDK_OFFSET(0x17034610)
#define RPG_GAMECORE_BYISTEAMLEADER_METHOD_4_A16D297D9316095C_OFFSET UNITYSDK_OFFSET(0x170344F0)
#define RPG_GAMECORE_BYISTEAMLEADER__CTOR_OFFSET UNITYSDK_OFFSET(0x17034590)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsTeamLeader_TypeDefinitionIndex = 18894;
