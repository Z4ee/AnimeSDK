...
#define RPG_GAMECORE_BYISTEAMLEADER_METHOD_4_1135FB6B9F9EB77B_OFFSET UNITYSDK_OFFSET(0x18759130)
#define RPG_GAMECORE_BYISTEAMLEADER_METHOD_4_A16D297D9316095C_OFFSET UNITYSDK_OFFSET(0x18759010)
#define RPG_GAMECORE_BYISTEAMLEADER__CTOR_OFFSET UNITYSDK_OFFSET(0x187590B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsTeamLeader_TypeDefinitionIndex = 19552;
