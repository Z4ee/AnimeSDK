...
#define RPG_GAMECORE_ADVSETMAXREGIONROTATEENERGY_METHOD_3_703101615B37F54B_OFFSET UNITYSDK_OFFSET(0x1BE2D9E0)
#define RPG_GAMECORE_ADVSETMAXREGIONROTATEENERGY_METHOD_3_7840DEB385D1B6A7_OFFSET UNITYSDK_OFFSET(0x1BE2D990)
#define RPG_GAMECORE_ADVSETMAXREGIONROTATEENERGY__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE2D9D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSetMaxRegionRotateEnergy_TypeDefinitionIndex = 20134;
