...
#define RPG_GAMECORE_ADVSETMAXREGIONROTATEENERGY_METHOD_3_703101615B37F54B_OFFSET UNITYSDK_OFFSET(0x18663B70)
#define RPG_GAMECORE_ADVSETMAXREGIONROTATEENERGY_METHOD_3_94EBAE5A74DC3F7B_OFFSET UNITYSDK_OFFSET(0x18663AE0)
#define RPG_GAMECORE_ADVSETMAXREGIONROTATEENERGY__CTOR_OFFSET UNITYSDK_OFFSET(0x18663B40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSetMaxRegionRotateEnergy_TypeDefinitionIndex = 19909;
