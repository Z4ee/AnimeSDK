...
#define RPG_GAMECORE_SCREENTRANSFERTEXTINFO_METHOD_2_80830381444B2D23_OFFSET UNITYSDK_OFFSET(0x1769DD10)
#define RPG_GAMECORE_SCREENTRANSFERTEXTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1769DEC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ScreenTransferTextInfo_TypeDefinitionIndex = 19184;
