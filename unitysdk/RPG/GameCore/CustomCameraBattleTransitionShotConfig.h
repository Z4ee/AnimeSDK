...
#define RPG_GAMECORE_CUSTOMCAMERABATTLETRANSITIONSHOTCONFIG_METHOD_2_D736503E9C4EB0EE_OFFSET UNITYSDK_OFFSET(0x1D00D2A0)
#define RPG_GAMECORE_CUSTOMCAMERABATTLETRANSITIONSHOTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D00D9E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CustomCameraBattleTransitionShotConfig_TypeDefinitionIndex = 20186;
