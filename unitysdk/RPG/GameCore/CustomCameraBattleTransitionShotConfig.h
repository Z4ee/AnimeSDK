...
#define RPG_GAMECORE_CUSTOMCAMERABATTLETRANSITIONSHOTCONFIG_METHOD_2_D736503E9C4EB0EE_OFFSET UNITYSDK_OFFSET(0x1BC3EE60)
#define RPG_GAMECORE_CUSTOMCAMERABATTLETRANSITIONSHOTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC3F5A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CustomCameraBattleTransitionShotConfig_TypeDefinitionIndex = 19640;
