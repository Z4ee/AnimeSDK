...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDPRESENTCONFIG_METHOD_3_2ADF032589B8FFA8_OFFSET UNITYSDK_OFFSET(0x1C5D0080)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDPRESENTCONFIG_METHOD_3_61D5A254B6D0FC2C_OFFSET UNITYSDK_OFFSET(0x1C5D0030)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDPRESENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5D0070)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierAddPresentConfig_TypeDefinitionIndex = 18711;
