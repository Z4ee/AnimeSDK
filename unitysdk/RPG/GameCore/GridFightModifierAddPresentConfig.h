...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDPRESENTCONFIG_METHOD_3_2ADF032589B8FFA8_OFFSET UNITYSDK_OFFSET(0x189B11B0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDPRESENTCONFIG_METHOD_3_54DDDAC855FD1E91_OFFSET UNITYSDK_OFFSET(0x189B10E0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDPRESENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189B1160)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierAddPresentConfig_TypeDefinitionIndex = 18489;
