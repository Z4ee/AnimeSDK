...
#define RPG_GAMECORE_EVOLVEBUILDSHOPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D7D2880)
#define RPG_GAMECORE_EVOLVEBUILDSHOPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7D2E80)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::EvolveBuildProtductType ShopType; // 0x7C
