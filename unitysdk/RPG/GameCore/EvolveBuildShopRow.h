...
#define RPG_GAMECORE_EVOLVEBUILDSHOPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D077E40)
#define RPG_GAMECORE_EVOLVEBUILDSHOPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D078440)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EvolveBuildShopRow_TypeDefinitionIndex = 11409;
	...
	public:
		...
		::Il2CppArray<::Class_1_A88C3AAF0DD46F4C_1*>* PriceList; // 0x20
		::System::String* ItemIcon; // 0x28
		::RPG::Client::TextID BuffTextFormat; // 0x30
		::System::UInt32 LvMax; // 0x40
		::System::UInt32 ID; // 0x44
		::RPG::Client::TextID Name; // 0x48
		::RPG::Client::TextID ShopDesc; // 0x58
		::RPG::Client::TextID Category; // 0x68
		::RPG::Client::TextID TotalBuff; // 0x78
		::RPG::GameCore::EvolveBuildProtductType ShopType; // 0x88
