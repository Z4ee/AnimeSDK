...
#define RPG_GAMECORE_LEVELTURNULTRASKILLPREPARE_GETACTIVEENTITY_OFFSET UNITYSDK_OFFSET(0xCE502C0)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPREPARE_GETDISABLEREADYCAMERA_OFFSET UNITYSDK_OFFSET(0xCE503A0)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPREPARE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xCE50230)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPREPARE_GETINSERTULTRASKILLPARAMS_OFFSET UNITYSDK_OFFSET(0xCE50280)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPREPARE_GETSKILLINDEX_OFFSET UNITYSDK_OFFSET(0xCE50310)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPREPARE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xCE501E0)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPREPARE_GET_ACTIONTYPE_OFFSET UNITYSDK_OFFSET(0xCE50440)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPREPARE_HASPREPAREABILITY_OFFSET UNITYSDK_OFFSET(0xCE503E0)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPREPARE_INIT_OFFSET UNITYSDK_OFFSET(0xCE50170)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPREPARE__CTOR_OFFSET UNITYSDK_OFFSET(0xCE50460)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelTurnUltraSkillPrepare_TypeDefinitionIndex = 52964;
