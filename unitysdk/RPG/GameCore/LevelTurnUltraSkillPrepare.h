...
#define RPG_GAMECORE_LEVELTURNULTRASKILLPREPARE_GETACTIVEENTITY_OFFSET UNITYSDK_OFFSET(0x1DD2DCE0)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPREPARE_GETDISABLEREADYCAMERA_OFFSET UNITYSDK_OFFSET(0x1DD2DDC0)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPREPARE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1DD2DC50)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPREPARE_GETINSERTULTRASKILLPARAMS_OFFSET UNITYSDK_OFFSET(0x1DD2DCA0)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPREPARE_GETSKILLINDEX_OFFSET UNITYSDK_OFFSET(0x1DD2DD30)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPREPARE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x1DD2DC00)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPREPARE_GET_ACTIONTYPE_OFFSET UNITYSDK_OFFSET(0x1DD2DE60)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPREPARE_HASPREPAREABILITY_OFFSET UNITYSDK_OFFSET(0x1DD2DE00)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPREPARE_INIT_OFFSET UNITYSDK_OFFSET(0x1DD2DB90)
#define RPG_GAMECORE_LEVELTURNULTRASKILLPREPARE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD2DE80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelTurnUltraSkillPrepare_TypeDefinitionIndex = 56898;
