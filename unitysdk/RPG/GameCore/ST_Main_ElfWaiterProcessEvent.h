...
#define RPG_GAMECORE_ST_MAIN_ELFWAITERPROCESSEVENT_METHOD_4_787EEBCBF6994D59_OFFSET UNITYSDK_OFFSET(0x1B783080)
#define RPG_GAMECORE_ST_MAIN_ELFWAITERPROCESSEVENT_METHOD_4_79F84E1C04489B52_OFFSET UNITYSDK_OFFSET(0x1B783040)
#define RPG_GAMECORE_ST_MAIN_ELFWAITERPROCESSEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B783070)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_ElfWaiterProcessEvent_TypeDefinitionIndex = 20721;
