...
#define RPG_GAMECORE_ST_MAIN_ELFWAITERPROCESSEVENT_METHOD_4_787EEBCBF6994D59_OFFSET UNITYSDK_OFFSET(0x176846D0)
#define RPG_GAMECORE_ST_MAIN_ELFWAITERPROCESSEVENT_METHOD_4_94E525E315F90753_OFFSET UNITYSDK_OFFSET(0x17697570)
#define RPG_GAMECORE_ST_MAIN_ELFWAITERPROCESSEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x17684680)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_ElfWaiterProcessEvent_TypeDefinitionIndex = 19701;
