...
#define RPG_GAMECORE_ROGUENPCDIALOGUECONFIG_METHOD_3_C05C3DAAE9C7D373_OFFSET UNITYSDK_OFFSET(0x18D49820)
#define RPG_GAMECORE_ROGUENPCDIALOGUECONFIG_METHOD_3_EE7DE6ABDC122662_OFFSET UNITYSDK_OFFSET(0x18D497E0)
#define RPG_GAMECORE_ROGUENPCDIALOGUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D49810)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueNPCDialogueConfig_TypeDefinitionIndex = 17097;
