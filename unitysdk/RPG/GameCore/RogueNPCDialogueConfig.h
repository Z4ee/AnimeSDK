...
#define RPG_GAMECORE_ROGUENPCDIALOGUECONFIG_METHOD_3_C05C3DAAE9C7D373_OFFSET UNITYSDK_OFFSET(0x19B9F6E0)
#define RPG_GAMECORE_ROGUENPCDIALOGUECONFIG_METHOD_3_EE7DE6ABDC122662_OFFSET UNITYSDK_OFFSET(0x19B9F6A0)
#define RPG_GAMECORE_ROGUENPCDIALOGUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B9F6D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueNPCDialogueConfig_TypeDefinitionIndex = 17110;
