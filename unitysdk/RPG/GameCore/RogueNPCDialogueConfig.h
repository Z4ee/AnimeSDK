...
#define RPG_GAMECORE_ROGUENPCDIALOGUECONFIG_METHOD_3_C05C3DAAE9C7D373_OFFSET UNITYSDK_OFFSET(0x1763C010)
#define RPG_GAMECORE_ROGUENPCDIALOGUECONFIG_METHOD_3_EE7DE6ABDC122662_OFFSET UNITYSDK_OFFSET(0x1763BFD0)
#define RPG_GAMECORE_ROGUENPCDIALOGUECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1763C000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueNPCDialogueConfig_TypeDefinitionIndex = 16543;
