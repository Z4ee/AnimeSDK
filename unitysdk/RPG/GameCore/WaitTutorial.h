...
#define RPG_GAMECORE_WAITTUTORIAL_METHOD_3_13F7640F0FE4C664_OFFSET UNITYSDK_OFFSET(0x17907690)
#define RPG_GAMECORE_WAITTUTORIAL_METHOD_3_FEDAF34D6D9F2615_OFFSET UNITYSDK_OFFSET(0x17907710)
#define RPG_GAMECORE_WAITTUTORIAL__CTOR_OFFSET UNITYSDK_OFFSET(0x179076E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitTutorial_TypeDefinitionIndex = 22361;
