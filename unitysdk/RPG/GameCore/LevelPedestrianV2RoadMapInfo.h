...
#define RPG_GAMECORE_LEVELPEDESTRIANV2ROADMAPINFO_METHOD_2_6BB29F36E0D9458C_OFFSET UNITYSDK_OFFSET(0x1B0823B0)
#define RPG_GAMECORE_LEVELPEDESTRIANV2ROADMAPINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B085A60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPedestrianV2RoadMapInfo_TypeDefinitionIndex = 16623;
