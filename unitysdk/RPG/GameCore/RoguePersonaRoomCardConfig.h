...
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDCONFIG_METHOD_2_6083BBBDCD60BAB1_OFFSET UNITYSDK_OFFSET(0x19BB97F0)
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19BB9830)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RoguePersonaRoomCardConfig_TypeDefinitionIndex = 18742;
