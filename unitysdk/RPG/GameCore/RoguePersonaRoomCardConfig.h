...
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDCONFIG_METHOD_2_6083BBBDCD60BAB1_OFFSET UNITYSDK_OFFSET(0x1D40DD30)
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D40DD70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RoguePersonaRoomCardConfig_TypeDefinitionIndex = 19551;
