...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERCOSTEXTRAGLOBALHPAFTERBATTLECONFIG_METHOD_3_28CC3E80F518A068_OFFSET UNITYSDK_OFFSET(0x1C5D0980)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERCOSTEXTRAGLOBALHPAFTERBATTLECONFIG_METHOD_3_3119A9C8CD236FEC_OFFSET UNITYSDK_OFFSET(0x1C5D0930)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERCOSTEXTRAGLOBALHPAFTERBATTLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5D0970)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierCostExtraGlobalHpAfterBattleConfig_TypeDefinitionIndex = 18651;
