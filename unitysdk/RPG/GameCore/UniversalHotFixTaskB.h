...
#define RPG_GAMECORE_UNIVERSALHOTFIXTASKB_METHOD_4_953972F5DC2CCA52_OFFSET UNITYSDK_OFFSET(0x1D623870)
#define RPG_GAMECORE_UNIVERSALHOTFIXTASKB_METHOD_4_DAE54065822F0511_OFFSET UNITYSDK_OFFSET(0x1D622330)
#define RPG_GAMECORE_UNIVERSALHOTFIXTASKB__CTOR_OFFSET UNITYSDK_OFFSET(0x1D622320)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UniversalHotFixTaskB_TypeDefinitionIndex = 23094;
