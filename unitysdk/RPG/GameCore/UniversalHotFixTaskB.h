...
#define RPG_GAMECORE_UNIVERSALHOTFIXTASKB_METHOD_4_1D8198B00FEE39C8_OFFSET UNITYSDK_OFFSET(0x178E6A40)
#define RPG_GAMECORE_UNIVERSALHOTFIXTASKB_METHOD_4_DAE54065822F0511_OFFSET UNITYSDK_OFFSET(0x178E65A0)
#define RPG_GAMECORE_UNIVERSALHOTFIXTASKB__CTOR_OFFSET UNITYSDK_OFFSET(0x178E6570)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UniversalHotFixTaskB_TypeDefinitionIndex = 21589;
