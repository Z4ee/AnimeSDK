...
#define RPG_GAMECORE_REQUESTSETSERVERGROUPPROPERTYV2_METHOD_3_688CB8CFBB10CD4E_OFFSET UNITYSDK_OFFSET(0x1D3A31D0)
#define RPG_GAMECORE_REQUESTSETSERVERGROUPPROPERTYV2_METHOD_3_8901DE022FB29253_OFFSET UNITYSDK_OFFSET(0x1D3A3190)
#define RPG_GAMECORE_REQUESTSETSERVERGROUPPROPERTYV2__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3A31C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RequestSetServerGroupPropertyV2_TypeDefinitionIndex = 20494;
