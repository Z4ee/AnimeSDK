...
#define RPG_GAMECORE_IDLELIVESUPERCHATROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x198484E0)
#define RPG_GAMECORE_IDLELIVESUPERCHATROW__CTOR_OFFSET UNITYSDK_OFFSET(0x198487A0)
