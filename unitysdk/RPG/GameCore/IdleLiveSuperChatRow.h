...
#define RPG_GAMECORE_IDLELIVESUPERCHATROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D215E40)
#define RPG_GAMECORE_IDLELIVESUPERCHATROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D216100)

namespace RPG::GameCore
{
	inline static constexpr unsigned int IdleLiveSuperChatRow_TypeDefinitionIndex = 11775;
