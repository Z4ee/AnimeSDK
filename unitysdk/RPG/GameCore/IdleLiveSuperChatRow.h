...
#define RPG_GAMECORE_IDLELIVESUPERCHATROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D1A4810)
#define RPG_GAMECORE_IDLELIVESUPERCHATROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1A4AD0)
