...
#define RPG_GAMECORE_TUTORIALGUIDEGROUPTYPEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19E2A8A0)
#define RPG_GAMECORE_TUTORIALGUIDEGROUPTYPEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19E2B2F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TutorialGuideGroupTypeRow_TypeDefinitionIndex = 14618;
