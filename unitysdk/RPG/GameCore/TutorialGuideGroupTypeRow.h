...
#define RPG_GAMECORE_TUTORIALGUIDEGROUPTYPEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D2A5810)
#define RPG_GAMECORE_TUTORIALGUIDEGROUPTYPEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2A6260)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TutorialGuideGroupTypeRow_TypeDefinitionIndex = 15212;
