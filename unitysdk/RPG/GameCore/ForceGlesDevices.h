...
#define RPG_GAMECORE_FORCEGLESDEVICES_METHOD_2_747C1C750E34FF24_OFFSET UNITYSDK_OFFSET(0x1DCB0920)
#define RPG_GAMECORE_FORCEGLESDEVICES__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCB0A80)
