...
#define RPG_GAMECORE_ROGUEADVENTUREESCAPELAYSERCONFIG_METHOD_3_6CE1927FA819F5BC_OFFSET UNITYSDK_OFFSET(0x1C4A0360)
#define RPG_GAMECORE_ROGUEADVENTUREESCAPELAYSERCONFIG_METHOD_3_B40029D695B915C0_OFFSET UNITYSDK_OFFSET(0x1C4A03F0)
#define RPG_GAMECORE_ROGUEADVENTUREESCAPELAYSERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4A0350)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueAdventureEscapeLayserConfig_TypeDefinitionIndex = 17167;
