...
#define RPG_GAMECORE_TRIGGERHITPROP_METHOD_3_1693E8BA028812E7_OFFSET UNITYSDK_OFFSET(0x190C6B90)
#define RPG_GAMECORE_TRIGGERHITPROP_METHOD_3_412AB712E6B69138_OFFSET UNITYSDK_OFFSET(0x190C6C10)
#define RPG_GAMECORE_TRIGGERHITPROP__CTOR_OFFSET UNITYSDK_OFFSET(0x190C6BE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerHitProp_TypeDefinitionIndex = 19149;
