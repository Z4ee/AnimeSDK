...
#define RPG_GAMECORE_ADVENTURETRIGGERONTRIGGEREVT_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x195B4820)
#define RPG_GAMECORE_ADVENTURETRIGGERONTRIGGEREVT_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x195B4870)
#define RPG_GAMECORE_ADVENTURETRIGGERONTRIGGEREVT_GET_TRIGGERKEY_OFFSET UNITYSDK_OFFSET(0x195B48C0)
#define RPG_GAMECORE_ADVENTURETRIGGERONTRIGGEREVT_SET_TRIGGERKEY_OFFSET UNITYSDK_OFFSET(0x195B48D0)
#define RPG_GAMECORE_ADVENTURETRIGGERONTRIGGEREVT__CTOR_OFFSET UNITYSDK_OFFSET(0x195B4810)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureTriggerOnTriggerEvt_TypeDefinitionIndex = 54061;
