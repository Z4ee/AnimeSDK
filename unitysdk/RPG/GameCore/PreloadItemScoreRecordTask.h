...
#define RPG_GAMECORE_PRELOADITEMSCORERECORDTASK_METHOD_2_B1AD970977527DC3_OFFSET UNITYSDK_OFFSET(0x19A82060)
#define RPG_GAMECORE_PRELOADITEMSCORERECORDTASK__CTOR_OFFSET UNITYSDK_OFFSET(0x19A821D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PreloadItemScoreRecordTask_TypeDefinitionIndex = 15553;
