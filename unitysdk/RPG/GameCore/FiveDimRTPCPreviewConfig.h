...
#define RPG_GAMECORE_FIVEDIMRTPCPREVIEWCONFIG_METHOD_2_104D3A4A256B4E4D_OFFSET UNITYSDK_OFFSET(0x1D0FD930)
#define RPG_GAMECORE_FIVEDIMRTPCPREVIEWCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0FD970)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimRTPCPreviewConfig_TypeDefinitionIndex = 18612;
