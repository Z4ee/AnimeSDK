...
#define RPG_GAMECORE_FIVEDIMRTPCPREVIEWCONFIG_METHOD_2_104D3A4A256B4E4D_OFFSET UNITYSDK_OFFSET(0x19751B50)
#define RPG_GAMECORE_FIVEDIMRTPCPREVIEWCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19751B90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimRTPCPreviewConfig_TypeDefinitionIndex = 17910;
