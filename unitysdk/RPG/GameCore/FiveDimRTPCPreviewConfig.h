...
#define RPG_GAMECORE_FIVEDIMRTPCPREVIEWCONFIG_METHOD_2_104D3A4A256B4E4D_OFFSET UNITYSDK_OFFSET(0x17206DB0)
#define RPG_GAMECORE_FIVEDIMRTPCPREVIEWCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17206DF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimRTPCPreviewConfig_TypeDefinitionIndex = 17273;
