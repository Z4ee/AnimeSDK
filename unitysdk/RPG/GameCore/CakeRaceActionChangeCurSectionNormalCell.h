...
#define RPG_GAMECORE_CAKERACEACTIONCHANGECURSECTIONNORMALCELL_METHOD_3_15EEA70C9CFEDDC6_OFFSET UNITYSDK_OFFSET(0x1B2CA740)
#define RPG_GAMECORE_CAKERACEACTIONCHANGECURSECTIONNORMALCELL_METHOD_3_97D19AA69937B701_OFFSET UNITYSDK_OFFSET(0x1B2CA780)
#define RPG_GAMECORE_CAKERACEACTIONCHANGECURSECTIONNORMALCELL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2CA770)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionChangeCurSectionNormalCell_TypeDefinitionIndex = 17605;
