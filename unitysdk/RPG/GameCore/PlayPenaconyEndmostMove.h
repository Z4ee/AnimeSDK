...
#define RPG_GAMECORE_PLAYPENACONYENDMOSTMOVE_METHOD_3_C7D193E17F4B471C_OFFSET UNITYSDK_OFFSET(0x18C105A0)
#define RPG_GAMECORE_PLAYPENACONYENDMOSTMOVE_METHOD_3_E08D81A2B314DC6B_OFFSET UNITYSDK_OFFSET(0x18C10520)
#define RPG_GAMECORE_PLAYPENACONYENDMOSTMOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x18C10570)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayPenaconyEndmostMove_TypeDefinitionIndex = 20675;
