...
#define RPG_GAMECORE_PLAYPENACONYENDMOSTMOVE_METHOD_3_1EAA24470C4B7649_OFFSET UNITYSDK_OFFSET(0x1D7A6D40)
#define RPG_GAMECORE_PLAYPENACONYENDMOSTMOVE_METHOD_3_C7D193E17F4B471C_OFFSET UNITYSDK_OFFSET(0x1D7A6D80)
#define RPG_GAMECORE_PLAYPENACONYENDMOSTMOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7A6D70)
