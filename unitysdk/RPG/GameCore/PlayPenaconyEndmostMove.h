...
#define RPG_GAMECORE_PLAYPENACONYENDMOSTMOVE_METHOD_3_1EAA24470C4B7649_OFFSET UNITYSDK_OFFSET(0x1BA05F10)
#define RPG_GAMECORE_PLAYPENACONYENDMOSTMOVE_METHOD_3_C7D193E17F4B471C_OFFSET UNITYSDK_OFFSET(0x1BA05F50)
#define RPG_GAMECORE_PLAYPENACONYENDMOSTMOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA05F40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayPenaconyEndmostMove_TypeDefinitionIndex = 21022;
