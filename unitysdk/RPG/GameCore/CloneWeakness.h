...
#define RPG_GAMECORE_CLONEWEAKNESS_METHOD_3_28C2AB5D8383C46E_OFFSET UNITYSDK_OFFSET(0x1711CD00)
#define RPG_GAMECORE_CLONEWEAKNESS_METHOD_3_2CE8E951597DE431_OFFSET UNITYSDK_OFFSET(0x1711CC70)
#define RPG_GAMECORE_CLONEWEAKNESS__CTOR_OFFSET UNITYSDK_OFFSET(0x1711CCD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CloneWeakness_TypeDefinitionIndex = 21294;
