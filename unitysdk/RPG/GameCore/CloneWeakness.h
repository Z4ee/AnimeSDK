...
#define RPG_GAMECORE_CLONEWEAKNESS_METHOD_3_28C2AB5D8383C46E_OFFSET UNITYSDK_OFFSET(0x1CFEB950)
#define RPG_GAMECORE_CLONEWEAKNESS_METHOD_3_923F01F98B6D84F7_OFFSET UNITYSDK_OFFSET(0x1CFEB900)
#define RPG_GAMECORE_CLONEWEAKNESS__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFEB940)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CloneWeakness_TypeDefinitionIndex = 22819;
