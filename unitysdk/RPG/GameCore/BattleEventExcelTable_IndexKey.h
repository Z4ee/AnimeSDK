...
#define RPG_GAMECORE_BATTLEEVENTEXCELTABLE_INDEXKEY_EQUALS_OFFSET UNITYSDK_OFFSET(0x881AD0)
#define RPG_GAMECORE_BATTLEEVENTEXCELTABLE_INDEXKEY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x167710)
#define RPG_GAMECORE_BATTLEEVENTEXCELTABLE_INDEXKEY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x881A30)
#define RPG_GAMECORE_BATTLEEVENTEXCELTABLE_INDEXKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x167520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleEventExcelTable_IndexKey_TypeDefinitionIndex = 12372;
