...
#define RPG_GAMECORE_FIVEDIMDANMUTRACK_METHOD_2_A1E0EF023D75345B_OFFSET UNITYSDK_OFFSET(0x1D857E40)
#define RPG_GAMECORE_FIVEDIMDANMUTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D857FC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimDanmuTrack_TypeDefinitionIndex = 18614;
