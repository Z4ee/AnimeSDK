...
#define RPG_GAMECORE_PHOTOGRAPHWATERMARKCONFIG_METHOD_2_19C24BFFA3C3BB5F_OFFSET UNITYSDK_OFFSET(0x1D436640)
#define RPG_GAMECORE_PHOTOGRAPHWATERMARKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D438150)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotoGraphWaterMarkConfig_TypeDefinitionIndex = 18836;
