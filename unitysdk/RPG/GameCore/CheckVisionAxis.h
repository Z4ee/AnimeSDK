...
#define RPG_GAMECORE_CHECKVISIONAXIS_METHOD_3_3FBF01CEC2D999E0_OFFSET UNITYSDK_OFFSET(0x187DC3E0)
#define RPG_GAMECORE_CHECKVISIONAXIS_METHOD_3_C72160262CE66467_OFFSET UNITYSDK_OFFSET(0x187DC420)
#define RPG_GAMECORE_CHECKVISIONAXIS__CTOR_OFFSET UNITYSDK_OFFSET(0x187DC410)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CheckVisionAxis_TypeDefinitionIndex = 14681;
