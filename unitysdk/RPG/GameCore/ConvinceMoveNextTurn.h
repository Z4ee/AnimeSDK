...
#define RPG_GAMECORE_CONVINCEMOVENEXTTURN_METHOD_3_447D08A933C1A931_OFFSET UNITYSDK_OFFSET(0x1BC36330)
#define RPG_GAMECORE_CONVINCEMOVENEXTTURN_METHOD_3_C516CE7F5BBC32F4_OFFSET UNITYSDK_OFFSET(0x1BC36260)
#define RPG_GAMECORE_CONVINCEMOVENEXTTURN__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC36320)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConvinceMoveNextTurn_TypeDefinitionIndex = 21033;
