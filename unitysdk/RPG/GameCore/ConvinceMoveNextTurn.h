...
#define RPG_GAMECORE_CONVINCEMOVENEXTTURN_METHOD_3_447D08A933C1A931_OFFSET UNITYSDK_OFFSET(0x17137490)
#define RPG_GAMECORE_CONVINCEMOVENEXTTURN_METHOD_3_97C7775B255A4EFD_OFFSET UNITYSDK_OFFSET(0x17137380)
#define RPG_GAMECORE_CONVINCEMOVENEXTTURN__CTOR_OFFSET UNITYSDK_OFFSET(0x17137460)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConvinceMoveNextTurn_TypeDefinitionIndex = 20007;
