...
#define RPG_GAMECORE_CONVINCEMOVENEXTTURN_METHOD_3_447D08A933C1A931_OFFSET UNITYSDK_OFFSET(0x1883E520)
#define RPG_GAMECORE_CONVINCEMOVENEXTTURN_METHOD_3_97C7775B255A4EFD_OFFSET UNITYSDK_OFFSET(0x1883E410)
#define RPG_GAMECORE_CONVINCEMOVENEXTTURN__CTOR_OFFSET UNITYSDK_OFFSET(0x1883E4F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConvinceMoveNextTurn_TypeDefinitionIndex = 20688;
