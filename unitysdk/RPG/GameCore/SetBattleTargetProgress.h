...
#define RPG_GAMECORE_SETBATTLETARGETPROGRESS_METHOD_3_6CF5C621BBB87E1A_OFFSET UNITYSDK_OFFSET(0x176AA8A0)
#define RPG_GAMECORE_SETBATTLETARGETPROGRESS_METHOD_3_9EA66BE71A253483_OFFSET UNITYSDK_OFFSET(0x176AA930)
#define RPG_GAMECORE_SETBATTLETARGETPROGRESS__CTOR_OFFSET UNITYSDK_OFFSET(0x176AA900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetBattleTargetProgress_TypeDefinitionIndex = 21400;
