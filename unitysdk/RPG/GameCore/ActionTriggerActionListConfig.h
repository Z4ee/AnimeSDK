...
#define RPG_GAMECORE_ACTIONTRIGGERACTIONLISTCONFIG_METHOD_4_2EFF0F8B47634368_OFFSET UNITYSDK_OFFSET(0x1AAD8840)
#define RPG_GAMECORE_ACTIONTRIGGERACTIONLISTCONFIG_METHOD_4_6BF032646FD715CE_OFFSET UNITYSDK_OFFSET(0x1AAD88A0)
#define RPG_GAMECORE_ACTIONTRIGGERACTIONLISTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAD8890)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActionTriggerActionListConfig_TypeDefinitionIndex = 16370;
