...
#define RPG_GAMECORE_ACTIONTRIGGERACTIONLISTCONFIG_METHOD_4_6BF032646FD715CE_OFFSET UNITYSDK_OFFSET(0x185FEC90)
#define RPG_GAMECORE_ACTIONTRIGGERACTIONLISTCONFIG_METHOD_4_F37DDA742DE0BECF_OFFSET UNITYSDK_OFFSET(0x185FEBB0)
#define RPG_GAMECORE_ACTIONTRIGGERACTIONLISTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x185FEC40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActionTriggerActionListConfig_TypeDefinitionIndex = 16137;
