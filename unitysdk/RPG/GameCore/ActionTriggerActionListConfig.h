...
#define RPG_GAMECORE_ACTIONTRIGGERACTIONLISTCONFIG_METHOD_4_6BF032646FD715CE_OFFSET UNITYSDK_OFFSET(0x193CF8B0)
#define RPG_GAMECORE_ACTIONTRIGGERACTIONLISTCONFIG_METHOD_4_F37DDA742DE0BECF_OFFSET UNITYSDK_OFFSET(0x193CF7D0)
#define RPG_GAMECORE_ACTIONTRIGGERACTIONLISTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x193CF860)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActionTriggerActionListConfig_TypeDefinitionIndex = 16186;
