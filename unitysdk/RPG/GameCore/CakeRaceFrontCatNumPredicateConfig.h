...
#define RPG_GAMECORE_CAKERACEFRONTCATNUMPREDICATECONFIG_METHOD_3_647E6CAC983EB203_OFFSET UNITYSDK_OFFSET(0x1B2D1480)
#define RPG_GAMECORE_CAKERACEFRONTCATNUMPREDICATECONFIG_METHOD_3_72F143E60539301E_OFFSET UNITYSDK_OFFSET(0x1B2CD8A0)
#define RPG_GAMECORE_CAKERACEFRONTCATNUMPREDICATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2CD890)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceFrontCatNumPredicateConfig_TypeDefinitionIndex = 17650;
