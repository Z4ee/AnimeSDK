...
#define RPG_GAMECORE_ROGUETOURNMODIFYROOMPOOLITEMCONFIGBASE_METHOD_2_78B894B3C91B8EE7_OFFSET UNITYSDK_OFFSET(0x19BCE650)
#define RPG_GAMECORE_ROGUETOURNMODIFYROOMPOOLITEMCONFIGBASE_METHOD_2_FA770335C86383B5_OFFSET UNITYSDK_OFFSET(0x19BCE7C0)
#define RPG_GAMECORE_ROGUETOURNMODIFYROOMPOOLITEMCONFIGBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x19BCE7B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournModifyRoomPoolItemConfigBase_TypeDefinitionIndex = 17117;
