...
#define RPG_GAMECORE_ROGUETOURNMODIFYROOMPOOLITEMCONFIGBASE_METHOD_2_78B894B3C91B8EE7_OFFSET UNITYSDK_OFFSET(0x1766D610)
#define RPG_GAMECORE_ROGUETOURNMODIFYROOMPOOLITEMCONFIGBASE_METHOD_2_FA770335C86383B5_OFFSET UNITYSDK_OFFSET(0x1766D770)
#define RPG_GAMECORE_ROGUETOURNMODIFYROOMPOOLITEMCONFIGBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1766D760)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournModifyRoomPoolItemConfigBase_TypeDefinitionIndex = 16550;
