...
#define RPG_GAMECORE_BYCOMPARESCEPTERMAINUNITEFFECTTAG_METHOD_4_1D26153D9591771B_OFFSET UNITYSDK_OFFSET(0x1BBB8550)
#define RPG_GAMECORE_BYCOMPARESCEPTERMAINUNITEFFECTTAG_METHOD_4_BA4F1315EE39D06A_OFFSET UNITYSDK_OFFSET(0x1BBB8790)
#define RPG_GAMECORE_BYCOMPARESCEPTERMAINUNITEFFECTTAG_METHOD_4_EC7E653D07B7F4DC_OFFSET UNITYSDK_OFFSET(0x1BBB8760)
#define RPG_GAMECORE_BYCOMPARESCEPTERMAINUNITEFFECTTAG_METHOD_4_EF74F36934B4287A_OFFSET UNITYSDK_OFFSET(0x1BBB8590)
#define RPG_GAMECORE_BYCOMPARESCEPTERMAINUNITEFFECTTAG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBB8580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareScepterMainUnitEffectTag_TypeDefinitionIndex = 22850;
