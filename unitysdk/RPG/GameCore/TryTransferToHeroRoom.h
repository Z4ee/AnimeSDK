...
#define RPG_GAMECORE_TRYTRANSFERTOHEROROOM_METHOD_3_13D3F7FB70C6090B_OFFSET UNITYSDK_OFFSET(0x19E21980)
#define RPG_GAMECORE_TRYTRANSFERTOHEROROOM_METHOD_3_D298B61015178297_OFFSET UNITYSDK_OFFSET(0x19E21870)
#define RPG_GAMECORE_TRYTRANSFERTOHEROROOM__CTOR_OFFSET UNITYSDK_OFFSET(0x19E21950)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TryTransferToHeroRoom_TypeDefinitionIndex = 21083;
