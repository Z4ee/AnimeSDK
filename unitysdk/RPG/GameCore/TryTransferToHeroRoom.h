...
#define RPG_GAMECORE_TRYTRANSFERTOHEROROOM_METHOD_3_13D3F7FB70C6090B_OFFSET UNITYSDK_OFFSET(0x1D29CAA0)
#define RPG_GAMECORE_TRYTRANSFERTOHEROROOM_METHOD_3_29B4303782755B0E_OFFSET UNITYSDK_OFFSET(0x1D29C9D0)
#define RPG_GAMECORE_TRYTRANSFERTOHEROROOM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D29CA90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TryTransferToHeroRoom_TypeDefinitionIndex = 22060;
