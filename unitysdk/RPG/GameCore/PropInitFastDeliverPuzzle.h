...
#define RPG_GAMECORE_PROPINITFASTDELIVERPUZZLE_METHOD_3_7E910852102E1953_OFFSET UNITYSDK_OFFSET(0x1751EE00)
#define RPG_GAMECORE_PROPINITFASTDELIVERPUZZLE_METHOD_3_DD3B6F2342F06C28_OFFSET UNITYSDK_OFFSET(0x1751EFE0)
#define RPG_GAMECORE_PROPINITFASTDELIVERPUZZLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1751EF00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropInitFastDeliverPuzzle_TypeDefinitionIndex = 20332;
