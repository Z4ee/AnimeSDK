...
#define RPG_GAMECORE_FIVEDIMCUSTOMVISIBILITYCONFIG_METHOD_3_B2E3A7A26C239FB2_OFFSET UNITYSDK_OFFSET(0x1D0A84D0)
#define RPG_GAMECORE_FIVEDIMCUSTOMVISIBILITYCONFIG_METHOD_3_D7BE84CD01B8DAF6_OFFSET UNITYSDK_OFFSET(0x1D0A8430)
#define RPG_GAMECORE_FIVEDIMCUSTOMVISIBILITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0A8490)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimCustomVisibilityConfig_TypeDefinitionIndex = 18398;
