...
#define RPG_GAMECORE_TRIGGERGRIDFIGHTWAVESETTLE_METHOD_3_6E3C815BD0F1BA2D_OFFSET UNITYSDK_OFFSET(0x190C6590)
#define RPG_GAMECORE_TRIGGERGRIDFIGHTWAVESETTLE_METHOD_3_837E9B3AC0AF6EC1_OFFSET UNITYSDK_OFFSET(0x190C6470)
#define RPG_GAMECORE_TRIGGERGRIDFIGHTWAVESETTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x190C6510)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerGridFightWaveSettle_TypeDefinitionIndex = 21421;
