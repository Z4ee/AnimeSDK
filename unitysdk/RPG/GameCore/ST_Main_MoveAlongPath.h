...
#define RPG_GAMECORE_ST_MAIN_MOVEALONGPATH_METHOD_4_1DA71D1682CC8B73_OFFSET UNITYSDK_OFFSET(0x19C19010)
#define RPG_GAMECORE_ST_MAIN_MOVEALONGPATH_METHOD_4_D52A6B93FE9D2BB7_OFFSET UNITYSDK_OFFSET(0x19C03CE0)
#define RPG_GAMECORE_ST_MAIN_MOVEALONGPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x19C03C90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_MoveAlongPath_TypeDefinitionIndex = 18976;
