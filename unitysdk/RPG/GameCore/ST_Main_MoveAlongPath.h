...
#define RPG_GAMECORE_ST_MAIN_MOVEALONGPATH_METHOD_4_1DA71D1682CC8B73_OFFSET UNITYSDK_OFFSET(0x18DF2710)
#define RPG_GAMECORE_ST_MAIN_MOVEALONGPATH_METHOD_4_D52A6B93FE9D2BB7_OFFSET UNITYSDK_OFFSET(0x18DF27E0)
#define RPG_GAMECORE_ST_MAIN_MOVEALONGPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x18DF2790)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_MoveAlongPath_TypeDefinitionIndex = 19029;
