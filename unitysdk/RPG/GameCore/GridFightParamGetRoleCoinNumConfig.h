...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETROLECOINNUMCONFIG_METHOD_6_BA206B0477CA82DA_OFFSET UNITYSDK_OFFSET(0x172730E0)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETROLECOINNUMCONFIG_METHOD_6_F7CD54370477AF14_OFFSET UNITYSDK_OFFSET(0x17272E30)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETROLECOINNUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17272FB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightParamGetRoleCoinNumConfig_TypeDefinitionIndex = 17889;
