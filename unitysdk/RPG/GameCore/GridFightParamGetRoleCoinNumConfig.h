...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETROLECOINNUMCONFIG_METHOD_6_BA206B0477CA82DA_OFFSET UNITYSDK_OFFSET(0x189C6C90)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETROLECOINNUMCONFIG_METHOD_6_F7CD54370477AF14_OFFSET UNITYSDK_OFFSET(0x189C69E0)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETROLECOINNUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189C6B60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightParamGetRoleCoinNumConfig_TypeDefinitionIndex = 18532;
