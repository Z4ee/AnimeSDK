...
#define RPG_GAMECORE_ACTIVITYAVATARDELIVERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x193D4550)
#define RPG_GAMECORE_ACTIVITYAVATARDELIVERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x193D4840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityAvatarDeliverRow_TypeDefinitionIndex = 10535;
