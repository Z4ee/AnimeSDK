...
#define RPG_GAMECORE_TARGETFETCHADVALLNPCMONSTERS_METHOD_4_6DD9E87A8E7E4302_OFFSET UNITYSDK_OFFSET(0x19CF47D0)
#define RPG_GAMECORE_TARGETFETCHADVALLNPCMONSTERS_METHOD_4_6E9C21F5D38540BA_OFFSET UNITYSDK_OFFSET(0x19D084B0)
#define RPG_GAMECORE_TARGETFETCHADVALLNPCMONSTERS_METHOD_4_ADC3A7BB2C270FB0_OFFSET UNITYSDK_OFFSET(0x19D083F0)
#define RPG_GAMECORE_TARGETFETCHADVALLNPCMONSTERS_METHOD_4_D65A2889D7F6143A_OFFSET UNITYSDK_OFFSET(0x19D02F50)
#define RPG_GAMECORE_TARGETFETCHADVALLNPCMONSTERS__CTOR_OFFSET UNITYSDK_OFFSET(0x19CF4780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchAdvAllNPCMonsters_TypeDefinitionIndex = 22549;
	...
	public:
		...
		static ::System::Void Method_4_D65A2889D7F6143A(::SimpleJSON::JSONNode* a1, ::RPG::GameCore::TargetFetchAdvAllNPCMonsters*& a2)
		{
			return ((::System::Void(*)(::SimpleJSON::JSONNode*, ::RPG::GameCore::TargetFetchAdvAllNPCMonsters*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_TARGETFETCHADVALLNPCMONSTERS_METHOD_4_D65A2889D7F6143A_OFFSET))(a1, a2);
		}
