...
#define RPG_GAMECORE_TARGETFETCHADVALLNPCMONSTERS_METHOD_4_6DD9E87A8E7E4302_OFFSET UNITYSDK_OFFSET(0x177BA7F0)
#define RPG_GAMECORE_TARGETFETCHADVALLNPCMONSTERS_METHOD_4_ADC3A7BB2C270FB0_OFFSET UNITYSDK_OFFSET(0x177BA6E0)
#define RPG_GAMECORE_TARGETFETCHADVALLNPCMONSTERS__CTOR_OFFSET UNITYSDK_OFFSET(0x177BA7A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchAdvAllNPCMonsters_TypeDefinitionIndex = 22131;
