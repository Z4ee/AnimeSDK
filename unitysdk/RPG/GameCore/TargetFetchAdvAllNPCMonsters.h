...
#define RPG_GAMECORE_TARGETFETCHADVALLNPCMONSTERS_METHOD_4_6DD9E87A8E7E4302_OFFSET UNITYSDK_OFFSET(0x1D5A3B10)
#define RPG_GAMECORE_TARGETFETCHADVALLNPCMONSTERS_METHOD_4_6E9C21F5D38540BA_OFFSET UNITYSDK_OFFSET(0x1D5A3B90)
#define RPG_GAMECORE_TARGETFETCHADVALLNPCMONSTERS_METHOD_4_8C91E0B0A9270987_OFFSET UNITYSDK_OFFSET(0x1D5A3B70)
#define RPG_GAMECORE_TARGETFETCHADVALLNPCMONSTERS_METHOD_4_C36E6E6ACEC61F83_OFFSET UNITYSDK_OFFSET(0x1D5A3A90)
#define RPG_GAMECORE_TARGETFETCHADVALLNPCMONSTERS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5A3B00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchAdvAllNPCMonsters_TypeDefinitionIndex = 23592;
