...
#define RPG_GAMECORE_CHARACTERANIMZONECONFIG_METHOD_3_2EAA624C67680C4D_OFFSET UNITYSDK_OFFSET(0x187CA2E0)
#define RPG_GAMECORE_CHARACTERANIMZONECONFIG_METHOD_3_8AFE23C0B91C63D9_OFFSET UNITYSDK_OFFSET(0x187CA200)
#define RPG_GAMECORE_CHARACTERANIMZONECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x187CA2D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterAnimZoneConfig_TypeDefinitionIndex = 15680;
