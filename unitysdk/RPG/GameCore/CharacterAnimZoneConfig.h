...
#define RPG_GAMECORE_CHARACTERANIMZONECONFIG_METHOD_3_2EAA624C67680C4D_OFFSET UNITYSDK_OFFSET(0x1B71C100)
#define RPG_GAMECORE_CHARACTERANIMZONECONFIG_METHOD_3_8AFE23C0B91C63D9_OFFSET UNITYSDK_OFFSET(0x1B71C020)
#define RPG_GAMECORE_CHARACTERANIMZONECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B71C0F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterAnimZoneConfig_TypeDefinitionIndex = 15912;
