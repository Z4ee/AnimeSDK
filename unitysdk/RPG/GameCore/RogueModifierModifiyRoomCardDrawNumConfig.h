...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFIYROOMCARDDRAWNUMCONFIG_METHOD_3_8ECC9FB496A3DD08_OFFSET UNITYSDK_OFFSET(0x1D3F9620)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFIYROOMCARDDRAWNUMCONFIG_METHOD_3_CCC2EF06EFF8B0C4_OFFSET UNITYSDK_OFFSET(0x1D3F9670)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFIYROOMCARDDRAWNUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3F9660)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifiyRoomCardDrawNumConfig_TypeDefinitionIndex = 17622;
