...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFIYROOMCARDDRAWNUMCONFIG_METHOD_3_CCC2EF06EFF8B0C4_OFFSET UNITYSDK_OFFSET(0x19B54640)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFIYROOMCARDDRAWNUMCONFIG_METHOD_3_CD9B4FB6BDE97D4D_OFFSET UNITYSDK_OFFSET(0x19B5E840)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFIYROOMCARDDRAWNUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B545F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifiyRoomCardDrawNumConfig_TypeDefinitionIndex = 16946;
