...
#define RPG_GAMECORE_MODIFYAUDIENCEGROUPANIMTYPE_METHOD_3_D4B6DC0477BD9835_OFFSET UNITYSDK_OFFSET(0x1742AC30)
#define RPG_GAMECORE_MODIFYAUDIENCEGROUPANIMTYPE_METHOD_3_E86078588929FD64_OFFSET UNITYSDK_OFFSET(0x1742ABB0)
#define RPG_GAMECORE_MODIFYAUDIENCEGROUPANIMTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1742AC00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyAudienceGroupAnimType_TypeDefinitionIndex = 20049;
