...
#define RPG_GAMECORE_FIVEDIMCLEANERBOTBAKEDMOVECONFIG_METHOD_3_875F455E990589E8_OFFSET UNITYSDK_OFFSET(0x188F9D80)
#define RPG_GAMECORE_FIVEDIMCLEANERBOTBAKEDMOVECONFIG_METHOD_3_9737F1D1C24415CD_OFFSET UNITYSDK_OFFSET(0x188F9D40)
#define RPG_GAMECORE_FIVEDIMCLEANERBOTBAKEDMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x188F9D70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimCleanerBotBakedMoveConfig_TypeDefinitionIndex = 15797;
