...
#define RPG_GAMECORE_FIVEDIMCLEANERBOTBAKEDMOVECONFIG_METHOD_3_875F455E990589E8_OFFSET UNITYSDK_OFFSET(0x1D0A5D70)
#define RPG_GAMECORE_FIVEDIMCLEANERBOTBAKEDMOVECONFIG_METHOD_3_9737F1D1C24415CD_OFFSET UNITYSDK_OFFSET(0x1D0A5D30)
#define RPG_GAMECORE_FIVEDIMCLEANERBOTBAKEDMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0A5D60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimCleanerBotBakedMoveConfig_TypeDefinitionIndex = 16502;
