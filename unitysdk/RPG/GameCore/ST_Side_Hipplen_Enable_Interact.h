...
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_ENABLE_INTERACT_METHOD_4_3FB2393579A50825_OFFSET UNITYSDK_OFFSET(0x1768BC00)
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_ENABLE_INTERACT_METHOD_4_8774A03241FD103A_OFFSET UNITYSDK_OFFSET(0x17698ED0)
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_ENABLE_INTERACT__CTOR_OFFSET UNITYSDK_OFFSET(0x1768BBB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_Hipplen_Enable_Interact_TypeDefinitionIndex = 19610;
