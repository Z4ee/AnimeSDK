...
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_ENABLE_INTERACT_METHOD_4_3FB2393579A50825_OFFSET UNITYSDK_OFFSET(0x18DF8070)
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_ENABLE_INTERACT_METHOD_4_8774A03241FD103A_OFFSET UNITYSDK_OFFSET(0x18DF7F00)
#define RPG_GAMECORE_ST_SIDE_HIPPLEN_ENABLE_INTERACT__CTOR_OFFSET UNITYSDK_OFFSET(0x18DF8020)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_Hipplen_Enable_Interact_TypeDefinitionIndex = 20290;
