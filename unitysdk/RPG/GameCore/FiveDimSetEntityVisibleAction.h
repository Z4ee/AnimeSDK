...
#define RPG_GAMECORE_FIVEDIMSETENTITYVISIBLEACTION_METHOD_3_46C19EDFAAE9BAFC_OFFSET UNITYSDK_OFFSET(0x19754850)
#define RPG_GAMECORE_FIVEDIMSETENTITYVISIBLEACTION_METHOD_3_470721F925674C30_OFFSET UNITYSDK_OFFSET(0x19754720)
#define RPG_GAMECORE_FIVEDIMSETENTITYVISIBLEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19754830)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSetEntityVisibleAction_TypeDefinitionIndex = 17777;
