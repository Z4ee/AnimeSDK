...
#define RPG_GAMECORE_LEVELPROPSTATEICON_METHOD_2_E1BA8C3439B27B7B_OFFSET UNITYSDK_OFFSET(0x1734B380)
#define RPG_GAMECORE_LEVELPROPSTATEICON__CTOR_OFFSET UNITYSDK_OFFSET(0x1734B5B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPropStateIcon_TypeDefinitionIndex = 15828;
