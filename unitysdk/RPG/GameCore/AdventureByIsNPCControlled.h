...
#define RPG_GAMECORE_ADVENTUREBYISNPCCONTROLLED_METHOD_4_8DE1721C7AA0E01A_OFFSET UNITYSDK_OFFSET(0x1CDE7C70)
#define RPG_GAMECORE_ADVENTUREBYISNPCCONTROLLED_METHOD_4_E5AE9D4CDB9F93F3_OFFSET UNITYSDK_OFFSET(0x1CDE7CB0)
#define RPG_GAMECORE_ADVENTUREBYISNPCCONTROLLED_METHOD_4_ECF6AA591E326891_OFFSET UNITYSDK_OFFSET(0x1CDE7EF0)
#define RPG_GAMECORE_ADVENTUREBYISNPCCONTROLLED_METHOD_4_EDDD5A3A9B67128E_OFFSET UNITYSDK_OFFSET(0x1CDE7EC0)
#define RPG_GAMECORE_ADVENTUREBYISNPCCONTROLLED__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDE7CA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureByIsNPCControlled_TypeDefinitionIndex = 20551;
