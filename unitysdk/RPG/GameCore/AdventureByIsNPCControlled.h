...
#define RPG_GAMECORE_ADVENTUREBYISNPCCONTROLLED_METHOD_4_39890152845F6D57_OFFSET UNITYSDK_OFFSET(0x16F4D8B0)
#define RPG_GAMECORE_ADVENTUREBYISNPCCONTROLLED_METHOD_4_E5AE9D4CDB9F93F3_OFFSET UNITYSDK_OFFSET(0x16F4D980)
#define RPG_GAMECORE_ADVENTUREBYISNPCCONTROLLED__CTOR_OFFSET UNITYSDK_OFFSET(0x16F4D930)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureByIsNPCControlled_TypeDefinitionIndex = 19110;
