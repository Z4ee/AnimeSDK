...
#define RPG_GAMECORE_MARBLERANDOMBUFFROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17396390)
#define RPG_GAMECORE_MARBLERANDOMBUFFROW__CTOR_OFFSET UNITYSDK_OFFSET(0x173968D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleRandomBuffRow_TypeDefinitionIndex = 10919;
	...
	public:
		...
		::System::UInt32 SetInactive; // 0x28
		::System::Int32 Weight; // 0x2C
		::System::UInt32 UnlockSubMission; // 0x30
		::System::UInt32 ActivityID; // 0x34
		::System::UInt32 EffectParam; // 0x38
		::System::UInt32 ID; // 0x3C
		::RPG::Client::TextID Desc; // 0x40
		::System::UInt32 EffectType; // 0x50
		::System::UInt32 IsRepeat; // 0x54
