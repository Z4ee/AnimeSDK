...
#define RPG_GAMECORE_ACTIVITYHOTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x193F0120)
#define RPG_GAMECORE_ACTIVITYHOTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x193F0630)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityHotRow_TypeDefinitionIndex = 11167;
	...
	public:
		...
		::RPG::Client::TextID TimeDes; // 0x28
		::System::UInt32 ActivityID; // 0x38
		::System::UInt32 GotoID; // 0x3C
		::RPG::Client::TextID DesName; // 0x40
		::System::Int32 SortWeight; // 0x50
		::System::UInt32 ActivityPanelOverwrite; // 0x54
		::RPG::Client::TextID ActivityName; // 0x58
