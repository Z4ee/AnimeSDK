...
#define RPG_GAMECORE_HIPPLENMINIGAMEGRADECONFIG_METHOD_2_C5BE7F79038C5014_OFFSET UNITYSDK_OFFSET(0x172AFBF0)
#define RPG_GAMECORE_HIPPLENMINIGAMEGRADECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x172AFD20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HipplenMiniGameGradeConfig_TypeDefinitionIndex = 15371;
