...
#define RPG_GAMECORE_HIPPLENMINIGAMEGRADECONFIG_METHOD_2_C5BE7F79038C5014_OFFSET UNITYSDK_OFFSET(0x19836C70)
#define RPG_GAMECORE_HIPPLENMINIGAMEGRADECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19836DA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HipplenMiniGameGradeConfig_TypeDefinitionIndex = 15944;
