...
#define RPG_GAMECORE_CHENLINGBATTLEVALUEGETTER_ATTRIBUTEVALUEWHENENTERBATTLE_METHOD_3_346BFCC0A0EE12B2_OFFSET UNITYSDK_OFFSET(0x1CFAE550)
#define RPG_GAMECORE_CHENLINGBATTLEVALUEGETTER_ATTRIBUTEVALUEWHENENTERBATTLE_METHOD_3_CDDEBF9778E3A45A_OFFSET UNITYSDK_OFFSET(0x1CFAE4F0)
#define RPG_GAMECORE_CHENLINGBATTLEVALUEGETTER_ATTRIBUTEVALUEWHENENTERBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFAE540)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleValueGetter_AttributeValueWhenEnterBattle_TypeDefinitionIndex = 15630;
