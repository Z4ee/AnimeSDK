...
#define RPG_GAMECORE_CHENLINGBATTLEVALUEGETTER_ATTRIBUTEVALUEWHENENTERBATTLE_METHOD_3_346BFCC0A0EE12B2_OFFSET UNITYSDK_OFFSET(0x187E7F30)
#define RPG_GAMECORE_CHENLINGBATTLEVALUEGETTER_ATTRIBUTEVALUEWHENENTERBATTLE_METHOD_3_CDDEBF9778E3A45A_OFFSET UNITYSDK_OFFSET(0x187E7ED0)
#define RPG_GAMECORE_CHENLINGBATTLEVALUEGETTER_ATTRIBUTEVALUEWHENENTERBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x187E7F20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleValueGetter_AttributeValueWhenEnterBattle_TypeDefinitionIndex = 14966;
