...
#define RPG_GAMECORE_SWORDTRAININGBRANCHINFO_METHOD_2_BC59015E1500A705_OFFSET UNITYSDK_OFFSET(0x1779BB40)
#define RPG_GAMECORE_SWORDTRAININGBRANCHINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1779BC70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwordTrainingBranchInfo_TypeDefinitionIndex = 18612;
