...
#define RPG_GAMECORE_LOCKACTIONDELAYCHANGE_METHOD_3_C77AF668774D8C1B_OFFSET UNITYSDK_OFFSET(0x1D20EEE0)
#define RPG_GAMECORE_LOCKACTIONDELAYCHANGE_METHOD_3_D1E8990498BF3AAA_OFFSET UNITYSDK_OFFSET(0x1D20EE90)
#define RPG_GAMECORE_LOCKACTIONDELAYCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D20EED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LockActionDelayChange_TypeDefinitionIndex = 23013;
