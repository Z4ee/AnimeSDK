...
#define RPG_GAMECORE_LOCKACTIONDELAYCHANGE_METHOD_3_6305CB962EAF72D5_OFFSET UNITYSDK_OFFSET(0x17369910)
#define RPG_GAMECORE_LOCKACTIONDELAYCHANGE_METHOD_3_C77AF668774D8C1B_OFFSET UNITYSDK_OFFSET(0x17369990)
#define RPG_GAMECORE_LOCKACTIONDELAYCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x17369960)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LockActionDelayChange_TypeDefinitionIndex = 21517;
