...
#define RPG_GAMECORE_ADVENTUREPLAYVO_METHOD_3_136F2CFA50D25C17_OFFSET UNITYSDK_OFFSET(0x18679800)
#define RPG_GAMECORE_ADVENTUREPLAYVO_METHOD_3_301706B1CB7FD866_OFFSET UNITYSDK_OFFSET(0x18679780)
#define RPG_GAMECORE_ADVENTUREPLAYVO__CTOR_OFFSET UNITYSDK_OFFSET(0x186797D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventurePlayVO_TypeDefinitionIndex = 19727;
