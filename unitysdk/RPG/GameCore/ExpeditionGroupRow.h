...
#define RPG_GAMECORE_EXPEDITIONGROUPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x188C6A70)
#define RPG_GAMECORE_EXPEDITIONGROUPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x188C70A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ExpeditionGroupRow_TypeDefinitionIndex = 12529;
