...
#define RPG_GAMECORE_REMOVEMODIFIER_METHOD_3_0DE1613A55034822_OFFSET UNITYSDK_OFFSET(0x18CA4EB0)
#define RPG_GAMECORE_REMOVEMODIFIER_METHOD_3_C00F48B3942FBA37_OFFSET UNITYSDK_OFFSET(0x18CA4F30)
#define RPG_GAMECORE_REMOVEMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x18CA4F00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveModifier_TypeDefinitionIndex = 21990;
