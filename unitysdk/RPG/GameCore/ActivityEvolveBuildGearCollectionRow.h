...
#define RPG_GAMECORE_ACTIVITYEVOLVEBUILDGEARCOLLECTIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1AAE6990)
#define RPG_GAMECORE_ACTIVITYEVOLVEBUILDGEARCOLLECTIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAE75B0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::EvolveGearType Type; // 0x48
		::System::UInt32 UnlockQuest; // 0x4C
