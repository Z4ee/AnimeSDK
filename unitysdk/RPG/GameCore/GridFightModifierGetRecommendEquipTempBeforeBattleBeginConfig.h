...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERGETRECOMMENDEQUIPTEMPBEFOREBATTLEBEGINCONFIG_METHOD_3_0A172C45C3C57940_OFFSET UNITYSDK_OFFSET(0x17267C60)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERGETRECOMMENDEQUIPTEMPBEFOREBATTLEBEGINCONFIG_METHOD_3_242FED24928BDCA9_OFFSET UNITYSDK_OFFSET(0x1726B2F0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERGETRECOMMENDEQUIPTEMPBEFOREBATTLEBEGINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17267C10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierGetRecommendEquipTempBeforeBattleBeginConfig_TypeDefinitionIndex = 17771;
