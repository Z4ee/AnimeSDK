...
#define RPG_GAMECORE_MAZESKILLGAMEMODEDROPCONFIG_METHOD_2_FDB970B964D42072_OFFSET UNITYSDK_OFFSET(0x18ADBDB0)
#define RPG_GAMECORE_MAZESKILLGAMEMODEDROPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18ADBDF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MazeSkillGameModeDropConfig_TypeDefinitionIndex = 20602;
