...
#define RPG_GAMECORE_ACTIVITYELATIONMODIFIEDAVATARROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x193DAFE0)
#define RPG_GAMECORE_ACTIVITYELATIONMODIFIEDAVATARROW__CTOR_OFFSET UNITYSDK_OFFSET(0x193DB700)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::TextID BESkill; // 0x68
		::RPG::Client::TextID Tag; // 0x78
		::RPG::Client::TextID BESkill_Simple; // 0x88
		::RPG::Client::TextID ModifiedSkill; // 0x98
