...
#define RPG_GAMECORE_FLOORSYNCTEMPLATECONFIG_METHOD_2_DCEAD06FA1C5B149_OFFSET UNITYSDK_OFFSET(0x197623E0)
#define RPG_GAMECORE_FLOORSYNCTEMPLATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19762420)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FloorSyncTemplateConfig_TypeDefinitionIndex = 16552;
