...
#define RPG_GAMECORE_FLOORSYNCTEMPLATECONFIG_METHOD_2_DCEAD06FA1C5B149_OFFSET UNITYSDK_OFFSET(0x17214E60)
#define RPG_GAMECORE_FLOORSYNCTEMPLATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17214EA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FloorSyncTemplateConfig_TypeDefinitionIndex = 15992;
