...
#define RPG_GAMECORE_FLOORSYNCTEMPLATECONFIG_METHOD_2_DCEAD06FA1C5B149_OFFSET UNITYSDK_OFFSET(0x189273E0)
#define RPG_GAMECORE_FLOORSYNCTEMPLATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18927420)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FloorSyncTemplateConfig_TypeDefinitionIndex = 16521;
