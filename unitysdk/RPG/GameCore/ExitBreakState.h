...
#define RPG_GAMECORE_EXITBREAKSTATE_METHOD_3_9DEC090457E6E2CE_OFFSET UNITYSDK_OFFSET(0x197001C0)
#define RPG_GAMECORE_EXITBREAKSTATE_METHOD_3_D48CA927825F5084_OFFSET UNITYSDK_OFFSET(0x19700140)
#define RPG_GAMECORE_EXITBREAKSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19700190)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ExitBreakState_TypeDefinitionIndex = 22347;
