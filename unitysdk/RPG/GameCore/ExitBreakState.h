...
#define RPG_GAMECORE_EXITBREAKSTATE_METHOD_3_9DEC090457E6E2CE_OFFSET UNITYSDK_OFFSET(0x171B5370)
#define RPG_GAMECORE_EXITBREAKSTATE_METHOD_3_D48CA927825F5084_OFFSET UNITYSDK_OFFSET(0x171B52F0)
#define RPG_GAMECORE_EXITBREAKSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x171B5340)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ExitBreakState_TypeDefinitionIndex = 21882;
