...
#define RPG_GAMECORE_EXITBREAKSTATE_METHOD_3_563BB263E8AB2B19_OFFSET UNITYSDK_OFFSET(0x1D7D8940)
#define RPG_GAMECORE_EXITBREAKSTATE_METHOD_3_9DEC090457E6E2CE_OFFSET UNITYSDK_OFFSET(0x1D7D8980)
#define RPG_GAMECORE_EXITBREAKSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7D8970)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ExitBreakState_TypeDefinitionIndex = 23367;
