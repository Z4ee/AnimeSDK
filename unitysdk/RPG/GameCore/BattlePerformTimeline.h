...
#define RPG_GAMECORE_BATTLEPERFORMTIMELINE_METHOD_3_04DEECB3CCBED62E_OFFSET UNITYSDK_OFFSET(0x16FDE740)
#define RPG_GAMECORE_BATTLEPERFORMTIMELINE_METHOD_3_96E79C9F540580FF_OFFSET UNITYSDK_OFFSET(0x16FDE6C0)
#define RPG_GAMECORE_BATTLEPERFORMTIMELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x16FDE710)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattlePerformTimeline_TypeDefinitionIndex = 21613;
