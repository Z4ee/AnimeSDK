...
#define RPG_GAMECORE_BATTLEPERFORMTIMELINE_METHOD_3_04DEECB3CCBED62E_OFFSET UNITYSDK_OFFSET(0x1CE7D480)
#define RPG_GAMECORE_BATTLEPERFORMTIMELINE_METHOD_3_0D8F9034ED15A3ED_OFFSET UNITYSDK_OFFSET(0x1CE7D440)
#define RPG_GAMECORE_BATTLEPERFORMTIMELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE7D470)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattlePerformTimeline_TypeDefinitionIndex = 23123;
