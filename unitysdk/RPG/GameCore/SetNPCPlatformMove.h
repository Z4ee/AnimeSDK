...
#define RPG_GAMECORE_SETNPCPLATFORMMOVE_METHOD_3_76695BFDE8A3D334_OFFSET UNITYSDK_OFFSET(0x1D509530)
#define RPG_GAMECORE_SETNPCPLATFORMMOVE_METHOD_3_D14BFA7E14E9033B_OFFSET UNITYSDK_OFFSET(0x1D509570)
#define RPG_GAMECORE_SETNPCPLATFORMMOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D509560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetNPCPlatformMove_TypeDefinitionIndex = 21708;
