...
#define RPG_GAMECORE_SETNPCPLATFORMMOVE_METHOD_3_5879911779D48F2F_OFFSET UNITYSDK_OFFSET(0x19C59B10)
#define RPG_GAMECORE_SETNPCPLATFORMMOVE_METHOD_3_D14BFA7E14E9033B_OFFSET UNITYSDK_OFFSET(0x19C59B90)
#define RPG_GAMECORE_SETNPCPLATFORMMOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C59B60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetNPCPlatformMove_TypeDefinitionIndex = 20733;
