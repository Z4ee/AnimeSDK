...
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_CHAINLIGHTNING_METHOD_3_E258C0C9AF29E3E4_OFFSET UNITYSDK_OFFSET(0x17079240)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_CHAINLIGHTNING_METHOD_3_FA6C927D298F0C0E_OFFSET UNITYSDK_OFFSET(0x170791E0)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_CHAINLIGHTNING__CTOR_OFFSET UNITYSDK_OFFSET(0x17079230)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleAbility_ChainLightning_TypeDefinitionIndex = 14427;
