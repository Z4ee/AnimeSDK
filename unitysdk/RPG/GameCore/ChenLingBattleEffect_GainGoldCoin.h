...
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_GAINGOLDCOIN_METHOD_3_7D82D1EBF1121E97_OFFSET UNITYSDK_OFFSET(0x1707E120)
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_GAINGOLDCOIN_METHOD_3_B1EA5AA7ECBB9D83_OFFSET UNITYSDK_OFFSET(0x1707E050)
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_GAINGOLDCOIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1707E110)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleEffect_GainGoldCoin_TypeDefinitionIndex = 14480;
