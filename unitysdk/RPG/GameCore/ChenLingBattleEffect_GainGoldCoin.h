...
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_GAINGOLDCOIN_METHOD_3_7D82D1EBF1121E97_OFFSET UNITYSDK_OFFSET(0x19620C40)
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_GAINGOLDCOIN_METHOD_3_B1EA5AA7ECBB9D83_OFFSET UNITYSDK_OFFSET(0x19620B70)
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_GAINGOLDCOIN__CTOR_OFFSET UNITYSDK_OFFSET(0x19620C30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleEffect_GainGoldCoin_TypeDefinitionIndex = 15013;
