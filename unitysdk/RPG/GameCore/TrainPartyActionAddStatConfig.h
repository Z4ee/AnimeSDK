...
#define RPG_GAMECORE_TRAINPARTYACTIONADDSTATCONFIG_METHOD_5_6493B7423262B4AF_OFFSET UNITYSDK_OFFSET(0x178A6D00)
#define RPG_GAMECORE_TRAINPARTYACTIONADDSTATCONFIG_METHOD_5_D8E2AB4F8ED3DB46_OFFSET UNITYSDK_OFFSET(0x178A6C20)
#define RPG_GAMECORE_TRAINPARTYACTIONADDSTATCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x178A6CB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyActionAddStatConfig_TypeDefinitionIndex = 16581;
