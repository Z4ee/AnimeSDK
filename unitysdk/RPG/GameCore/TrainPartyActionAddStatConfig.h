...
#define RPG_GAMECORE_TRAINPARTYACTIONADDSTATCONFIG_METHOD_5_5C01699461A33C47_OFFSET UNITYSDK_OFFSET(0x1D5D99D0)
#define RPG_GAMECORE_TRAINPARTYACTIONADDSTATCONFIG_METHOD_5_6493B7423262B4AF_OFFSET UNITYSDK_OFFSET(0x1D5D9A30)
#define RPG_GAMECORE_TRAINPARTYACTIONADDSTATCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5D9A20)
