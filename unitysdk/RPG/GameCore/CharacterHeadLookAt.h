...
#define RPG_GAMECORE_CHARACTERHEADLOOKAT_METHOD_3_4C6DBD36A1A6B8D2_OFFSET UNITYSDK_OFFSET(0x1D1221F0)
#define RPG_GAMECORE_CHARACTERHEADLOOKAT_METHOD_3_C65175C0F14EEFB3_OFFSET UNITYSDK_OFFSET(0x1D1221A0)
#define RPG_GAMECORE_CHARACTERHEADLOOKAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1221E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterHeadLookAt_TypeDefinitionIndex = 20626;
