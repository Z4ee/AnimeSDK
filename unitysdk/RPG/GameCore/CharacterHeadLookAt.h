...
#define RPG_GAMECORE_CHARACTERHEADLOOKAT_METHOD_3_4C6DBD36A1A6B8D2_OFFSET UNITYSDK_OFFSET(0x1706CC80)
#define RPG_GAMECORE_CHARACTERHEADLOOKAT_METHOD_3_7DA8D231D3282CC8_OFFSET UNITYSDK_OFFSET(0x1706CBE0)
#define RPG_GAMECORE_CHARACTERHEADLOOKAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1706CC40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterHeadLookAt_TypeDefinitionIndex = 19191;
