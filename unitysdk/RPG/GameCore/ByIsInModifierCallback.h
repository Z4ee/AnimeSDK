...
#define RPG_GAMECORE_BYISINMODIFIERCALLBACK_METHOD_4_257CDDB0468C44BE_OFFSET UNITYSDK_OFFSET(0x1B29CAF0)
#define RPG_GAMECORE_BYISINMODIFIERCALLBACK_METHOD_4_5466F502779F9370_OFFSET UNITYSDK_OFFSET(0x1B29CF50)
#define RPG_GAMECORE_BYISINMODIFIERCALLBACK_METHOD_4_75B9E4A48D442833_OFFSET UNITYSDK_OFFSET(0x1B29CEF0)
#define RPG_GAMECORE_BYISINMODIFIERCALLBACK_METHOD_4_B3CCBF41E346B124_OFFSET UNITYSDK_OFFSET(0x1B29CB90)
#define RPG_GAMECORE_BYISINMODIFIERCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B29CB50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsInModifierCallback_TypeDefinitionIndex = 22658;
