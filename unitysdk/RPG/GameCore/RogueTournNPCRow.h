...
#define RPG_GAMECORE_ROGUETOURNNPCROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19BCEA30)
#define RPG_GAMECORE_ROGUETOURNNPCROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19BCEB30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournNPCRow_TypeDefinitionIndex = 14304;
