...
#define RPG_GAMECORE_ROGUETOURNNPCROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CCCAC00)
#define RPG_GAMECORE_ROGUETOURNNPCROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CCCAD00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournNPCRow_TypeDefinitionIndex = 14872;
