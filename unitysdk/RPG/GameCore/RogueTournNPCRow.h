...
#define RPG_GAMECORE_ROGUETOURNNPCROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D48DD50)
#define RPG_GAMECORE_ROGUETOURNNPCROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D48DE50)
