...
#define RPG_GAMECORE_BYTIMEREWINDTARGETCURRENTSTATE_METHOD_4_259673E560D87CE1_OFFSET UNITYSDK_OFFSET(0x18762D80)
#define RPG_GAMECORE_BYTIMEREWINDTARGETCURRENTSTATE_METHOD_4_B72B7CE29FB8A4AD_OFFSET UNITYSDK_OFFSET(0x18762CB0)
#define RPG_GAMECORE_BYTIMEREWINDTARGETCURRENTSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18762D30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByTimeRewindTargetCurrentState_TypeDefinitionIndex = 19645;
