...
#define RPG_GAMECORE_BYANIMATORPARAM_METHOD_4_3E8F49C8E4B91C8D_OFFSET UNITYSDK_OFFSET(0x16FFA440)
#define RPG_GAMECORE_BYANIMATORPARAM_METHOD_4_71E6FB3E7E9E59D3_OFFSET UNITYSDK_OFFSET(0x16FFA510)
#define RPG_GAMECORE_BYANIMATORPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x16FFA4C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByAnimatorParam_TypeDefinitionIndex = 19124;
