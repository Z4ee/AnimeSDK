...
#define RPG_GAMECORE_CHIMERADUELSUMMONCONFIGSELECTORCONFIG_METHOD_3_A8D7F59B92C691CB_OFFSET UNITYSDK_OFFSET(0x19647A00)
#define RPG_GAMECORE_CHIMERADUELSUMMONCONFIGSELECTORCONFIG_METHOD_3_C07C7AFC8F43AFDB_OFFSET UNITYSDK_OFFSET(0x196479A0)
#define RPG_GAMECORE_CHIMERADUELSUMMONCONFIGSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x196479F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelSummonConfigSelectorConfig_TypeDefinitionIndex = 15169;
