...
#define RPG_GAMECORE_SETCOUNTDOWNWARNING_METHOD_3_4AD7F1E3372DD4B8_OFFSET UNITYSDK_OFFSET(0x18E136E0)
#define RPG_GAMECORE_SETCOUNTDOWNWARNING_METHOD_3_7FCAA7189A4AB7A8_OFFSET UNITYSDK_OFFSET(0x18E13760)
#define RPG_GAMECORE_SETCOUNTDOWNWARNING__CTOR_OFFSET UNITYSDK_OFFSET(0x18E13730)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetCountDownWarning_TypeDefinitionIndex = 21850;
