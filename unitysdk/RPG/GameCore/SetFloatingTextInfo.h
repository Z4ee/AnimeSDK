...
#define RPG_GAMECORE_SETFLOATINGTEXTINFO_METHOD_3_4A59BCFEBF653E43_OFFSET UNITYSDK_OFFSET(0x176CE270)
#define RPG_GAMECORE_SETFLOATINGTEXTINFO_METHOD_3_D90BFFAC9ED84F22_OFFSET UNITYSDK_OFFSET(0x176CE2F0)
#define RPG_GAMECORE_SETFLOATINGTEXTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x176CE2C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetFloatingTextInfo_TypeDefinitionIndex = 18764;
