...
#define RPG_GAMECORE_LEVELTURNACTIONEXECUTINGBEGIN_GETACTIVEENTITY_OFFSET UNITYSDK_OFFSET(0x197809E0)
#define RPG_GAMECORE_LEVELTURNACTIONEXECUTINGBEGIN_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x19780990)
#define RPG_GAMECORE_LEVELTURNACTIONEXECUTINGBEGIN_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x19780940)
#define RPG_GAMECORE_LEVELTURNACTIONEXECUTINGBEGIN_GETTURNCOUNTER_OFFSET UNITYSDK_OFFSET(0x19780A20)
#define RPG_GAMECORE_LEVELTURNACTIONEXECUTINGBEGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x19780930)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelTurnActionExecutingBegin_TypeDefinitionIndex = 54163;
