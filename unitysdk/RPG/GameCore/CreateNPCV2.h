...
#define RPG_GAMECORE_CREATENPCV2_METHOD_3_5F7E46E0B131827F_OFFSET UNITYSDK_OFFSET(0x19683080)
#define RPG_GAMECORE_CREATENPCV2_METHOD_3_6B9417477C734906_OFFSET UNITYSDK_OFFSET(0x19683100)
#define RPG_GAMECORE_CREATENPCV2__CTOR_OFFSET UNITYSDK_OFFSET(0x196830D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CreateNPCV2_TypeDefinitionIndex = 20723;
