...
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMAGICUNITSELECTCERTAINCONFIG_METHOD_6_39E078C489716022_OFFSET UNITYSDK_OFFSET(0x18CD8110)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMAGICUNITSELECTCERTAINCONFIG_METHOD_6_617877DD902D11C7_OFFSET UNITYSDK_OFFSET(0x18CD8330)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMAGICUNITSELECTCERTAINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CD8250)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActTriggerRogueMagicUnitSelectCertainConfig_TypeDefinitionIndex = 18676;
