...
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMAGICUNITSELECTCERTAINCONFIG_METHOD_6_2542B1EE63941E43_OFFSET UNITYSDK_OFFSET(0x1C49EAA0)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMAGICUNITSELECTCERTAINCONFIG_METHOD_6_617877DD902D11C7_OFFSET UNITYSDK_OFFSET(0x1C49EAF0)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMAGICUNITSELECTCERTAINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C49EAE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActTriggerRogueMagicUnitSelectCertainConfig_TypeDefinitionIndex = 18919;
