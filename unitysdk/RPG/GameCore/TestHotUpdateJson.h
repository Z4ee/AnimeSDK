...
#define RPG_GAMECORE_TESTHOTUPDATEJSON_METHOD_2_D82E9B3D8EC54E19_OFFSET UNITYSDK_OFFSET(0x17899AC0)
#define RPG_GAMECORE_TESTHOTUPDATEJSON__CTOR_OFFSET UNITYSDK_OFFSET(0x17899C20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TestHotUpdateJson_TypeDefinitionIndex = 22449;
