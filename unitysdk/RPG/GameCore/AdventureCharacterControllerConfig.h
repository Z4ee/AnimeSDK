...
#define RPG_GAMECORE_ADVENTURECHARACTERCONTROLLERCONFIG_METHOD_3_5E742A1533627529_OFFSET UNITYSDK_OFFSET(0x16F53230)
#define RPG_GAMECORE_ADVENTURECHARACTERCONTROLLERCONFIG_METHOD_3_852F7788569C6354_OFFSET UNITYSDK_OFFSET(0x16F53190)
#define RPG_GAMECORE_ADVENTURECHARACTERCONTROLLERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16F53220)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureCharacterControllerConfig_TypeDefinitionIndex = 15167;
