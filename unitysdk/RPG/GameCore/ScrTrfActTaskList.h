...
#define RPG_GAMECORE_SCRTRFACTTASKLIST_METHOD_3_8D6BA0981AC5A4D8_OFFSET UNITYSDK_OFFSET(0x1C2C8EE0)
#define RPG_GAMECORE_SCRTRFACTTASKLIST_METHOD_3_9293E3121F88C08B_OFFSET UNITYSDK_OFFSET(0x1C2C8F20)
#define RPG_GAMECORE_SCRTRFACTTASKLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2C8F10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ScrTrfActTaskList_TypeDefinitionIndex = 20075;
