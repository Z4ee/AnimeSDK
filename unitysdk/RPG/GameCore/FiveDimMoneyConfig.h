...
#define RPG_GAMECORE_FIVEDIMMONEYCONFIG_METHOD_3_8003324B0A1A92AA_OFFSET UNITYSDK_OFFSET(0x171FBDB0)
#define RPG_GAMECORE_FIVEDIMMONEYCONFIG_METHOD_3_95A4DF698D8D3C9B_OFFSET UNITYSDK_OFFSET(0x171FBE20)
#define RPG_GAMECORE_FIVEDIMMONEYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171FBE00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimMoneyConfig_TypeDefinitionIndex = 17029;
