...
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_ADDRESOURCE_METHOD_3_198FB485F458D1EB_OFFSET UNITYSDK_OFFSET(0x1C37A860)
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_ADDRESOURCE_METHOD_3_B12971B341770549_OFFSET UNITYSDK_OFFSET(0x1C37A800)
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_ADDRESOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C37A850)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleEffect_AddResource_TypeDefinitionIndex = 15184;
