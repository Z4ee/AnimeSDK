...
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_ADDRESOURCE_METHOD_3_198FB485F458D1EB_OFFSET UNITYSDK_OFFSET(0x1707DA40)
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_ADDRESOURCE_METHOD_3_B12971B341770549_OFFSET UNITYSDK_OFFSET(0x1707D9E0)
#define RPG_GAMECORE_CHENLINGBATTLEEFFECT_ADDRESOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1707DA30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleEffect_AddResource_TypeDefinitionIndex = 14487;
