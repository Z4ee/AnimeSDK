...
#define RPG_GAMECORE_WAITPLAYERPASSBUBBLEBRIDGE_METHOD_4_4382FB9462241000_OFFSET UNITYSDK_OFFSET(0x19104140)
#define RPG_GAMECORE_WAITPLAYERPASSBUBBLEBRIDGE_METHOD_4_CD6C014C622438B8_OFFSET UNITYSDK_OFFSET(0x19104220)
#define RPG_GAMECORE_WAITPLAYERPASSBUBBLEBRIDGE__CTOR_OFFSET UNITYSDK_OFFSET(0x191041C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitPlayerPassBubbleBridge_TypeDefinitionIndex = 21185;
