...
#define RPG_GAMECORE_WAITPLAYERPASSBUBBLEBRIDGE_METHOD_4_B6AE160408598045_OFFSET UNITYSDK_OFFSET(0x1D6A8B80)
#define RPG_GAMECORE_WAITPLAYERPASSBUBBLEBRIDGE_METHOD_4_CD6C014C622438B8_OFFSET UNITYSDK_OFFSET(0x1D6A8BD0)
#define RPG_GAMECORE_WAITPLAYERPASSBUBBLEBRIDGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6A8BC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitPlayerPassBubbleBridge_TypeDefinitionIndex = 22059;
