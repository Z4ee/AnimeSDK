...
#define RPG_GAMECORE_BATTLEAFFECTRANGECONFIG_METHOD_2_D6C5403B2538AB48_OFFSET UNITYSDK_OFFSET(0x16FCB8A0)
#define RPG_GAMECORE_BATTLEAFFECTRANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16FCBA60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleAffectRangeConfig_TypeDefinitionIndex = 16205;
