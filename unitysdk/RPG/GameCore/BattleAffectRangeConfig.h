...
#define RPG_GAMECORE_BATTLEAFFECTRANGECONFIG_METHOD_2_D6C5403B2538AB48_OFFSET UNITYSDK_OFFSET(0x1B2F02C0)
#define RPG_GAMECORE_BATTLEAFFECTRANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2F0480)
