...
#define RPG_GAMECORE_BATTLEAFFECTRANGECONFIG_METHOD_2_D6C5403B2538AB48_OFFSET UNITYSDK_OFFSET(0x1A3E29C0)
#define RPG_GAMECORE_BATTLEAFFECTRANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3E2B80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleAffectRangeConfig_TypeDefinitionIndex = 16904;
