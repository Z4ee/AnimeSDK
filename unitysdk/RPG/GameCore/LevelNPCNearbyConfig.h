...
#define RPG_GAMECORE_LEVELNPCNEARBYCONFIG_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1B077360)
#define RPG_GAMECORE_LEVELNPCNEARBYCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B077020)
#define RPG_GAMECORE_LEVELNPCNEARBYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B077010)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelNPCNearbyConfig_TypeDefinitionIndex = 16585;
