...
#define RPG_GAMECORE_INSERTBATTLEPERFORM_METHOD_3_37A6BB0722176311_OFFSET UNITYSDK_OFFSET(0x172BCC70)
#define RPG_GAMECORE_INSERTBATTLEPERFORM_METHOD_3_90DFDB29D7A6A63F_OFFSET UNITYSDK_OFFSET(0x172BCCF0)
#define RPG_GAMECORE_INSERTBATTLEPERFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x172BCCC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int InsertBattlePerform_TypeDefinitionIndex = 21602;
