...
#define RPG_GAMECORE_BYCOMPAREPROPFASTDELIVERCHECKSIMPLIFIEDMODE_METHOD_4_19E469E08181BF26_OFFSET UNITYSDK_OFFSET(0x19CFF570)
#define RPG_GAMECORE_BYCOMPAREPROPFASTDELIVERCHECKSIMPLIFIEDMODE_METHOD_4_5D6892F9C578FD25_OFFSET UNITYSDK_OFFSET(0x19CFF530)
#define RPG_GAMECORE_BYCOMPAREPROPFASTDELIVERCHECKSIMPLIFIEDMODE_METHOD_4_BB0A119386B612D1_OFFSET UNITYSDK_OFFSET(0x19CFF6E0)
#define RPG_GAMECORE_BYCOMPAREPROPFASTDELIVERCHECKSIMPLIFIEDMODE_METHOD_4_F9E71D60F252DCB0_OFFSET UNITYSDK_OFFSET(0x19CFF6B0)
#define RPG_GAMECORE_BYCOMPAREPROPFASTDELIVERCHECKSIMPLIFIEDMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x19CFF560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByComparePropFastDeliverCheckSimplifiedMode_TypeDefinitionIndex = 21343;
