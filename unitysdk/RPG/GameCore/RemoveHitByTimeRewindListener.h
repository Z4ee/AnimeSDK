...
#define RPG_GAMECORE_REMOVEHITBYTIMEREWINDLISTENER_METHOD_3_64FD42DB535B1B5D_OFFSET UNITYSDK_OFFSET(0x18CA46E0)
#define RPG_GAMECORE_REMOVEHITBYTIMEREWINDLISTENER_METHOD_3_8BD9133EB76CD569_OFFSET UNITYSDK_OFFSET(0x18CA45D0)
#define RPG_GAMECORE_REMOVEHITBYTIMEREWINDLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x18CA46B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveHitByTimeRewindListener_TypeDefinitionIndex = 19633;
