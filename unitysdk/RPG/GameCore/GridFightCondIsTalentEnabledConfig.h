...
#define RPG_GAMECORE_GRIDFIGHTCONDISTALENTENABLEDCONFIG_METHOD_6_283874A4F172C7B3_OFFSET UNITYSDK_OFFSET(0x1C5C53D0)
#define RPG_GAMECORE_GRIDFIGHTCONDISTALENTENABLEDCONFIG_METHOD_6_DE9A4F5F317960EF_OFFSET UNITYSDK_OFFSET(0x1C5C5380)
#define RPG_GAMECORE_GRIDFIGHTCONDISTALENTENABLEDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5C53C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightCondIsTalentEnabledConfig_TypeDefinitionIndex = 18582;
