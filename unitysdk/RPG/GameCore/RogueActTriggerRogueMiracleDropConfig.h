...
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMIRACLEDROPCONFIG_METHOD_6_7794F7B9C9D5A014_OFFSET UNITYSDK_OFFSET(0x1D3BBD30)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMIRACLEDROPCONFIG_METHOD_6_D756C1914B376110_OFFSET UNITYSDK_OFFSET(0x1D3BBD80)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMIRACLEDROPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3BBD70)
