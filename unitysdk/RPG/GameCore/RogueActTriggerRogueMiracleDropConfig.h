...
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMIRACLEDROPCONFIG_METHOD_6_9D784092C5FAB89D_OFFSET UNITYSDK_OFFSET(0x175CD160)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMIRACLEDROPCONFIG_METHOD_6_D756C1914B376110_OFFSET UNITYSDK_OFFSET(0x175CD380)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMIRACLEDROPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175CD2A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActTriggerRogueMiracleDropConfig_TypeDefinitionIndex = 17956;
