...
#define RPG_GAMECORE_CONSUMEMISSIONITEM_METHOD_3_7019574467E21174_OFFSET UNITYSDK_OFFSET(0x17133770)
#define RPG_GAMECORE_CONSUMEMISSIONITEM_METHOD_3_FF5EAF6ECD843A0A_OFFSET UNITYSDK_OFFSET(0x171337F0)
#define RPG_GAMECORE_CONSUMEMISSIONITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x171337C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConsumeMissionItem_TypeDefinitionIndex = 19759;
