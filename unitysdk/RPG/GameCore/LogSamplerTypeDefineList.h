...
#define RPG_GAMECORE_LOGSAMPLERTYPEDEFINELIST_METHOD_2_D294CBFDD60B4565_OFFSET UNITYSDK_OFFSET(0x1D2131C0)
#define RPG_GAMECORE_LOGSAMPLERTYPEDEFINELIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2132B0)
