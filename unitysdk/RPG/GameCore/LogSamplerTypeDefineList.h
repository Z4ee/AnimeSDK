...
#define RPG_GAMECORE_LOGSAMPLERTYPEDEFINELIST_METHOD_2_D294CBFDD60B4565_OFFSET UNITYSDK_OFFSET(0x1BCD1EE0)
#define RPG_GAMECORE_LOGSAMPLERTYPEDEFINELIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCD1FD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LogSamplerTypeDefineList_TypeDefinitionIndex = 17430;
