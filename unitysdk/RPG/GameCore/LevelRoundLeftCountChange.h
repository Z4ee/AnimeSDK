...
#define RPG_GAMECORE_LEVELROUNDLEFTCOUNTCHANGE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1DD2AB80)
#define RPG_GAMECORE_LEVELROUNDLEFTCOUNTCHANGE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x1DD2AB30)
#define RPG_GAMECORE_LEVELROUNDLEFTCOUNTCHANGE_INIT_OFFSET UNITYSDK_OFFSET(0x1DD2AAD0)
#define RPG_GAMECORE_LEVELROUNDLEFTCOUNTCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD2ABD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelRoundLeftCountChange_TypeDefinitionIndex = 56994;
