...
#define RPG_GAMECORE_INCLINATIONTYPEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x172B9560)
#define RPG_GAMECORE_INCLINATIONTYPEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x172B9620)

namespace RPG::GameCore
{
	inline static constexpr unsigned int InclinationTypeRow_TypeDefinitionIndex = 12611;
