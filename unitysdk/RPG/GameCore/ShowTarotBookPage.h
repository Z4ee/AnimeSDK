...
#define RPG_GAMECORE_SHOWTAROTBOOKPAGE_METHOD_3_8B56382252B76D47_OFFSET UNITYSDK_OFFSET(0x17705490)
#define RPG_GAMECORE_SHOWTAROTBOOKPAGE_METHOD_3_DD85DD0C99BEA7FE_OFFSET UNITYSDK_OFFSET(0x17705510)
#define RPG_GAMECORE_SHOWTAROTBOOKPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x177054E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowTarotBookPage_TypeDefinitionIndex = 20548;
