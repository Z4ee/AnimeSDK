...
#define RPG_GAMECORE_TARGETFETCHADVNPC_METHOD_4_1CDC792D1EAC4254_OFFSET UNITYSDK_OFFSET(0x1D0B3D70)
#define RPG_GAMECORE_TARGETFETCHADVNPC_METHOD_4_A8973A21CC47C8BE_OFFSET UNITYSDK_OFFSET(0x1D0B3DC0)
#define RPG_GAMECORE_TARGETFETCHADVNPC_METHOD_4_B2D4DC7EF84418B5_OFFSET UNITYSDK_OFFSET(0x1D0B3C20)
#define RPG_GAMECORE_TARGETFETCHADVNPC_METHOD_4_DED2477199D0E54D_OFFSET UNITYSDK_OFFSET(0x1D0B3C80)
#define RPG_GAMECORE_TARGETFETCHADVNPC__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0B3C70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchAdvNPC_TypeDefinitionIndex = 23020;
