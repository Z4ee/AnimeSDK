...
#define RPG_GAMECORE_TARGETFETCHADVNPC_METHOD_4_D2F57EE6F3B5DE23_OFFSET UNITYSDK_OFFSET(0x177BB5C0)
#define RPG_GAMECORE_TARGETFETCHADVNPC_METHOD_4_EC7371A63C487918_OFFSET UNITYSDK_OFFSET(0x177BB6A0)
#define RPG_GAMECORE_TARGETFETCHADVNPC__CTOR_OFFSET UNITYSDK_OFFSET(0x177BB650)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchAdvNPC_TypeDefinitionIndex = 22139;
