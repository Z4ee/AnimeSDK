...
#define RPG_GAMECORE_LITTLEGAMEABILITYTEAMTOWERSFORBIDROTATEEFFECTCONFIG_METHOD_3_BEFEFEC9E37F3FD9_OFFSET UNITYSDK_OFFSET(0x1D1FD440)
#define RPG_GAMECORE_LITTLEGAMEABILITYTEAMTOWERSFORBIDROTATEEFFECTCONFIG_METHOD_3_E499C6581C3DEC04_OFFSET UNITYSDK_OFFSET(0x1D1FD3A0)
#define RPG_GAMECORE_LITTLEGAMEABILITYTEAMTOWERSFORBIDROTATEEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1FD430)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityTeamTowersForbidRotateEffectConfig_TypeDefinitionIndex = 21165;
