...
#define RPG_GAMECORE_TURNINSERTACTIONUICONFIG_METHOD_2_9BC27D1573993C70_OFFSET UNITYSDK_OFFSET(0x178D5C50)
#define RPG_GAMECORE_TURNINSERTACTIONUICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x178D5D20)
