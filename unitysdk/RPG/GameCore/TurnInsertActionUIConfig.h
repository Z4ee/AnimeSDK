...
#define RPG_GAMECORE_TURNINSERTACTIONUICONFIG_METHOD_2_9BC27D1573993C70_OFFSET UNITYSDK_OFFSET(0x190D4400)
#define RPG_GAMECORE_TURNINSERTACTIONUICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x190D44D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TurnInsertActionUIConfig_TypeDefinitionIndex = 21550;
