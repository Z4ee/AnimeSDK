...
#define RPG_GAMECORE_SHOWTALKRECORDINGDIALOG_METHOD_3_36225EF44F407C38_OFFSET UNITYSDK_OFFSET(0x17704F30)
#define RPG_GAMECORE_SHOWTALKRECORDINGDIALOG_METHOD_3_7C8CDAF5425D3891_OFFSET UNITYSDK_OFFSET(0x17704EB0)
#define RPG_GAMECORE_SHOWTALKRECORDINGDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x17704F00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowTalkRecordingDialog_TypeDefinitionIndex = 20108;
