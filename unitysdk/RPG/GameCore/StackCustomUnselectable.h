...
#define RPG_GAMECORE_STACKCUSTOMUNSELECTABLE_METHOD_3_34837A4187EB221A_OFFSET UNITYSDK_OFFSET(0x1D54DE50)
#define RPG_GAMECORE_STACKCUSTOMUNSELECTABLE_METHOD_3_FAB0E8C43C9B4CA7_OFFSET UNITYSDK_OFFSET(0x1D54DEA0)
#define RPG_GAMECORE_STACKCUSTOMUNSELECTABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D54DE90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StackCustomUnselectable_TypeDefinitionIndex = 23441;
