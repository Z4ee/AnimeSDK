...
#define RPG_GAMECORE_OVERRIDESKILLTARGETINFO_METHOD_3_137ECCD8BE77E11F_OFFSET UNITYSDK_OFFSET(0x1BB09310)
#define RPG_GAMECORE_OVERRIDESKILLTARGETINFO_METHOD_3_C8AFC70DF9E28090_OFFSET UNITYSDK_OFFSET(0x1BB093B0)
#define RPG_GAMECORE_OVERRIDESKILLTARGETINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB09370)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OverrideSkillTargetInfo_TypeDefinitionIndex = 21896;
