...
#define RPG_GAMECORE_OVERRIDESKILLTARGETINFO_METHOD_3_5B280B0C7EFE25DC_OFFSET UNITYSDK_OFFSET(0x17484730)
#define RPG_GAMECORE_OVERRIDESKILLTARGETINFO_METHOD_3_C8AFC70DF9E28090_OFFSET UNITYSDK_OFFSET(0x17484800)
#define RPG_GAMECORE_OVERRIDESKILLTARGETINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x174847B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OverrideSkillTargetInfo_TypeDefinitionIndex = 20901;
