...
#define RPG_GAMECORE_SETBOSSHPSTANCECHANGETYPE_METHOD_3_07454D2A26F7E197_OFFSET UNITYSDK_OFFSET(0x1C2D6410)
#define RPG_GAMECORE_SETBOSSHPSTANCECHANGETYPE_METHOD_3_EBF58E416F6D6D0E_OFFSET UNITYSDK_OFFSET(0x1C2D64B0)
#define RPG_GAMECORE_SETBOSSHPSTANCECHANGETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2D6470)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetBossHPStanceChangeType_TypeDefinitionIndex = 22801;
