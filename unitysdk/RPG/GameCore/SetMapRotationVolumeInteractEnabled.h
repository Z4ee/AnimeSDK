...
#define RPG_GAMECORE_SETMAPROTATIONVOLUMEINTERACTENABLED_METHOD_3_7E51248E0FFADF6E_OFFSET UNITYSDK_OFFSET(0x176D4A70)
#define RPG_GAMECORE_SETMAPROTATIONVOLUMEINTERACTENABLED_METHOD_3_CCC5BD0DEBC4879F_OFFSET UNITYSDK_OFFSET(0x176D4AF0)
#define RPG_GAMECORE_SETMAPROTATIONVOLUMEINTERACTENABLED__CTOR_OFFSET UNITYSDK_OFFSET(0x176D4AC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetMapRotationVolumeInteractEnabled_TypeDefinitionIndex = 19248;
