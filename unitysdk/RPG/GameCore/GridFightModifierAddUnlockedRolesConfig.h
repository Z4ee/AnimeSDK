...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDUNLOCKEDROLESCONFIG_METHOD_3_9DED47A4CD87A6E1_OFFSET UNITYSDK_OFFSET(0x1C5D0440)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDUNLOCKEDROLESCONFIG_METHOD_3_9DF552E036B123BD_OFFSET UNITYSDK_OFFSET(0x1C5D03F0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDUNLOCKEDROLESCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5D0430)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierAddUnlockedRolesConfig_TypeDefinitionIndex = 18700;
