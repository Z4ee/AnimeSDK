...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDUNLOCKEDROLESCONFIG_METHOD_3_9DED47A4CD87A6E1_OFFSET UNITYSDK_OFFSET(0x197E96C0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDUNLOCKEDROLESCONFIG_METHOD_3_F68C002FCE2A9F08_OFFSET UNITYSDK_OFFSET(0x197E95F0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERADDUNLOCKEDROLESCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197E9670)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierAddUnlockedRolesConfig_TypeDefinitionIndex = 18452;
