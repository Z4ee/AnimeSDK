...
#define RPG_GAMECORE_ADVENTURELOOPATTACKDETECT_METHOD_3_6B8EF017C5473A5E_OFFSET UNITYSDK_OFFSET(0x18676D60)
#define RPG_GAMECORE_ADVENTURELOOPATTACKDETECT_METHOD_3_7D7E2D5C697AD278_OFFSET UNITYSDK_OFFSET(0x18676E60)
#define RPG_GAMECORE_ADVENTURELOOPATTACKDETECT__CTOR_OFFSET UNITYSDK_OFFSET(0x18676DF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureLoopAttackDetect_TypeDefinitionIndex = 19134;
