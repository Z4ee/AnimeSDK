...
#define RPG_GAMECORE_CONVINCEWAITTRICKSKILL_METHOD_3_2031568F2A557D30_OFFSET UNITYSDK_OFFSET(0x17138530)
#define RPG_GAMECORE_CONVINCEWAITTRICKSKILL_METHOD_3_F505DAFDB4639523_OFFSET UNITYSDK_OFFSET(0x171385B0)
#define RPG_GAMECORE_CONVINCEWAITTRICKSKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x17138580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConvinceWaitTrickSkill_TypeDefinitionIndex = 20014;
