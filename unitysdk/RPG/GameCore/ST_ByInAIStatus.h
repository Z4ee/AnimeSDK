...
#define RPG_GAMECORE_ST_BYINAISTATUS_METHOD_4_879CC8C5E7F577A6_OFFSET UNITYSDK_OFFSET(0x17694020)
#define RPG_GAMECORE_ST_BYINAISTATUS_METHOD_4_E172B2C343178AF8_OFFSET UNITYSDK_OFFSET(0x17693F50)
#define RPG_GAMECORE_ST_BYINAISTATUS__CTOR_OFFSET UNITYSDK_OFFSET(0x17693FD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_ByInAIStatus_TypeDefinitionIndex = 18365;
