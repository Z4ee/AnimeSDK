...
#define RPG_GAMECORE_LOOPWAITBEHIT_METHOD_3_04DB4192A6E93664_OFFSET UNITYSDK_OFFSET(0x198B1BA0)
#define RPG_GAMECORE_LOOPWAITBEHIT_METHOD_3_5759B1436ACE3DE4_OFFSET UNITYSDK_OFFSET(0x198B1B10)
#define RPG_GAMECORE_LOOPWAITBEHIT__CTOR_OFFSET UNITYSDK_OFFSET(0x198B1B70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoopWaitBeHit_TypeDefinitionIndex = 20905;
