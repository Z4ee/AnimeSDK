...
#define RPG_GAMECORE_LOOPWAITBEHIT_METHOD_3_04DB4192A6E93664_OFFSET UNITYSDK_OFFSET(0x1D48AEA0)
#define RPG_GAMECORE_LOOPWAITBEHIT_METHOD_3_3DED4D9B3E902128_OFFSET UNITYSDK_OFFSET(0x1D48AE50)
#define RPG_GAMECORE_LOOPWAITBEHIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D48AE90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoopWaitBeHit_TypeDefinitionIndex = 21881;
