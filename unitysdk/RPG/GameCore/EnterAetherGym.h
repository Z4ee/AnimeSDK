...
#define RPG_GAMECORE_ENTERAETHERGYM_METHOD_3_4E807E8DECC94C8F_OFFSET UNITYSDK_OFFSET(0x1719DB60)
#define RPG_GAMECORE_ENTERAETHERGYM_METHOD_3_D03857E83BA0D8EE_OFFSET UNITYSDK_OFFSET(0x1719DBE0)
#define RPG_GAMECORE_ENTERAETHERGYM__CTOR_OFFSET UNITYSDK_OFFSET(0x1719DBB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnterAetherGym_TypeDefinitionIndex = 19840;
