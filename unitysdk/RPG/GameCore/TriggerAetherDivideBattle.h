...
#define RPG_GAMECORE_TRIGGERAETHERDIVIDEBATTLE_METHOD_3_0BC08D0DB09066DE_OFFSET UNITYSDK_OFFSET(0x1D546C80)
#define RPG_GAMECORE_TRIGGERAETHERDIVIDEBATTLE_METHOD_3_CEFE683CF11ED903_OFFSET UNITYSDK_OFFSET(0x1D546C40)
#define RPG_GAMECORE_TRIGGERAETHERDIVIDEBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D546C70)
