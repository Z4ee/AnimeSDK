...
#define RPG_GAMECORE_TRIGGERAETHERDIVIDEBATTLE_METHOD_3_0BC08D0DB09066DE_OFFSET UNITYSDK_OFFSET(0x190BC2D0)
#define RPG_GAMECORE_TRIGGERAETHERDIVIDEBATTLE_METHOD_3_E3BCF9DFB9111755_OFFSET UNITYSDK_OFFSET(0x190BC250)
#define RPG_GAMECORE_TRIGGERAETHERDIVIDEBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x190BC2A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerAetherDivideBattle_TypeDefinitionIndex = 20544;
