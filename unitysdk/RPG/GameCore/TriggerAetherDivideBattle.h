...
#define RPG_GAMECORE_TRIGGERAETHERDIVIDEBATTLE_METHOD_3_0BC08D0DB09066DE_OFFSET UNITYSDK_OFFSET(0x1D5EECD0)
#define RPG_GAMECORE_TRIGGERAETHERDIVIDEBATTLE_METHOD_3_CEFE683CF11ED903_OFFSET UNITYSDK_OFFSET(0x1D5EEC90)
#define RPG_GAMECORE_TRIGGERAETHERDIVIDEBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5EECC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerAetherDivideBattle_TypeDefinitionIndex = 21451;
