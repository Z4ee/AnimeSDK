...
#define RPG_GAMECORE_ADVBYENTITIESEXIST_METHOD_4_017AB40905B3BEB2_OFFSET UNITYSDK_OFFSET(0x1D6AD190)
#define RPG_GAMECORE_ADVBYENTITIESEXIST_METHOD_4_1282EDB314A836F1_OFFSET UNITYSDK_OFFSET(0x1D6AD340)
#define RPG_GAMECORE_ADVBYENTITIESEXIST_METHOD_4_5D2537ADF48FF29A_OFFSET UNITYSDK_OFFSET(0x1D6AD110)
#define RPG_GAMECORE_ADVBYENTITIESEXIST_METHOD_4_F7F493EF79C311C4_OFFSET UNITYSDK_OFFSET(0x1D6AD2F0)
#define RPG_GAMECORE_ADVBYENTITIESEXIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6AD160)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvByEntitiesExist_TypeDefinitionIndex = 20975;
