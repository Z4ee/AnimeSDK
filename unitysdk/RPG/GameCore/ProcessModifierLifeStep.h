...
#define RPG_GAMECORE_PROCESSMODIFIERLIFESTEP_METHOD_3_CE0C45CEF9D53DCE_OFFSET UNITYSDK_OFFSET(0x19A84A00)
#define RPG_GAMECORE_PROCESSMODIFIERLIFESTEP_METHOD_3_E9CF12DB9E7C261F_OFFSET UNITYSDK_OFFSET(0x19A84980)
#define RPG_GAMECORE_PROCESSMODIFIERLIFESTEP__CTOR_OFFSET UNITYSDK_OFFSET(0x19A849D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ProcessModifierLifeStep_TypeDefinitionIndex = 21465;
