...
#define RPG_GAMECORE_PROCESSMODIFIERLIFESTEP_METHOD_3_CE0C45CEF9D53DCE_OFFSET UNITYSDK_OFFSET(0x175134D0)
#define RPG_GAMECORE_PROCESSMODIFIERLIFESTEP_METHOD_3_E9CF12DB9E7C261F_OFFSET UNITYSDK_OFFSET(0x17513450)
#define RPG_GAMECORE_PROCESSMODIFIERLIFESTEP__CTOR_OFFSET UNITYSDK_OFFSET(0x175134A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ProcessModifierLifeStep_TypeDefinitionIndex = 20891;
