...
#define RPG_GAMECORE_EXPEDITIONDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C06B600)
#define RPG_GAMECORE_EXPEDITIONDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C06BF30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ExpeditionDataRow_TypeDefinitionIndex = 12764;
	...
	public:
		...
		::System::UInt32 AvatarNumMin; // 0x38
		::RPG::Client::TextID AssignDesc; // 0x40
		::System::UInt32 GroupID; // 0x50
		::System::UInt32 ExpeditionID; // 0x54
