...
#define RPG_GAMECORE_ACTIONBARUICONFIG_METHOD_2_5A4A19043813488A_OFFSET UNITYSDK_OFFSET(0x1B9FDE70)
#define RPG_GAMECORE_ACTIONBARUICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9FDF80)
