...
#define RPG_GAMECORE_LEVELTURNAVATARCHANGENEWAVATARPREPARE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x19781080)
#define RPG_GAMECORE_LEVELTURNAVATARCHANGENEWAVATARPREPARE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x197810D0)
#define RPG_GAMECORE_LEVELTURNAVATARCHANGENEWAVATARPREPARE__CTOR_OFFSET UNITYSDK_OFFSET(0x19781120)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelTurnAvatarChangeNewAvatarPrepare_TypeDefinitionIndex = 54174;
