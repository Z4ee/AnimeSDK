...
#define RPG_GAMECORE_CHIMERADUELABUSOLUTEPOSITIONSELECTORCONFIG_METHOD_3_06E4C5D03AAC9306_OFFSET UNITYSDK_OFFSET(0x187F48F0)
#define RPG_GAMECORE_CHIMERADUELABUSOLUTEPOSITIONSELECTORCONFIG_METHOD_3_AB585B25F60538B8_OFFSET UNITYSDK_OFFSET(0x187F4890)
#define RPG_GAMECORE_CHIMERADUELABUSOLUTEPOSITIONSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x187F48E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelAbusolutePositionSelectorConfig_TypeDefinitionIndex = 15067;
