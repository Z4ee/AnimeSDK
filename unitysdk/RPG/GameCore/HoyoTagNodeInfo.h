...
#define RPG_GAMECORE_HOYOTAGNODEINFO_METHOD_2_3A2D6C34ACDF1A73_OFFSET UNITYSDK_OFFSET(0x1B68DAE0)
#define RPG_GAMECORE_HOYOTAGNODEINFO_METHOD_2_501E7A3E999BA1E8_OFFSET UNITYSDK_OFFSET(0x1B68CC10)
#define RPG_GAMECORE_HOYOTAGNODEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B68DCC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HoyoTagNodeInfo_TypeDefinitionIndex = 17583;
