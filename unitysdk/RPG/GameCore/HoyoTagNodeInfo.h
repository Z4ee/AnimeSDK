...
#define RPG_GAMECORE_HOYOTAGNODEINFO_METHOD_2_3A2D6C34ACDF1A73_OFFSET UNITYSDK_OFFSET(0x172B41D0)
#define RPG_GAMECORE_HOYOTAGNODEINFO_METHOD_2_501E7A3E999BA1E8_OFFSET UNITYSDK_OFFSET(0x172B3160)
#define RPG_GAMECORE_HOYOTAGNODEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x172B43B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HoyoTagNodeInfo_TypeDefinitionIndex = 16811;
