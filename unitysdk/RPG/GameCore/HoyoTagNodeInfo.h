...
#define RPG_GAMECORE_HOYOTAGNODEINFO_METHOD_2_3A2D6C34ACDF1A73_OFFSET UNITYSDK_OFFSET(0x1D208C30)
#define RPG_GAMECORE_HOYOTAGNODEINFO_METHOD_2_501E7A3E999BA1E8_OFFSET UNITYSDK_OFFSET(0x1D207CE0)
#define RPG_GAMECORE_HOYOTAGNODEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D208E10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HoyoTagNodeInfo_TypeDefinitionIndex = 18101;
