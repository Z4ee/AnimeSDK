...
#define RPG_GAMECORE_ROGUEMODIFIERSETCOUNTBYENTERROOMCONFIG_METHOD_3_BB94AE826303E5AB_OFFSET UNITYSDK_OFFSET(0x1D3FC650)
#define RPG_GAMECORE_ROGUEMODIFIERSETCOUNTBYENTERROOMCONFIG_METHOD_3_E42478DBBD6E36AF_OFFSET UNITYSDK_OFFSET(0x1D3FC6A0)
#define RPG_GAMECORE_ROGUEMODIFIERSETCOUNTBYENTERROOMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3FC690)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierSetCountByEnterRoomConfig_TypeDefinitionIndex = 17509;
