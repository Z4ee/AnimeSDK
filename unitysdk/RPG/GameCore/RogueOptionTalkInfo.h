...
#define RPG_GAMECORE_ROGUEOPTIONTALKINFO_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x19BACEF0)
#define RPG_GAMECORE_ROGUEOPTIONTALKINFO_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19BACE50)
#define RPG_GAMECORE_ROGUEOPTIONTALKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19BACEB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueOptionTalkInfo_TypeDefinitionIndex = 19949;
