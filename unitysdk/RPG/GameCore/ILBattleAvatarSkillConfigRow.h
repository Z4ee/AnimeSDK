...
#define RPG_GAMECORE_ILBATTLEAVATARSKILLCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18A0B080)
#define RPG_GAMECORE_ILBATTLEAVATARSKILLCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18A0B5E0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::AttackType AttackType; // 0x28
		::System::UInt32 ID; // 0x2C
		::System::UInt32 MaxLevel; // 0x30
		::System::UInt32 RatedPromotionID; // 0x34
		...
		::RPG::GameCore::FixPoint CoolDown; // 0x70
