...
#define RPG_GAMECORE_ILBATTLEAVATARSKILLCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1983D400)
#define RPG_GAMECORE_ILBATTLEAVATARSKILLCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1983D950)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ILBattleAvatarSkillConfigRow_TypeDefinitionIndex = 13138;
	...
	public:
		...
		::RPG::GameCore::FixPoint InitialCD; // 0x28
		::System::UInt32 RatedPromotionID; // 0x30
