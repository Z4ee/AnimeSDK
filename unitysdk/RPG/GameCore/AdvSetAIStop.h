...
#define RPG_GAMECORE_ADVSETAISTOP_METHOD_3_7A56A9F13D08FDF4_OFFSET UNITYSDK_OFFSET(0x18661FB0)
#define RPG_GAMECORE_ADVSETAISTOP_METHOD_3_BD2BB6D8721CBC17_OFFSET UNITYSDK_OFFSET(0x18662030)
#define RPG_GAMECORE_ADVSETAISTOP__CTOR_OFFSET UNITYSDK_OFFSET(0x18662000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSetAIStop_TypeDefinitionIndex = 21074;
