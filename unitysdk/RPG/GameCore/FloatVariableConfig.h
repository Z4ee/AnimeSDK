...
#define RPG_GAMECORE_FLOATVARIABLECONFIG_METHOD_2_A04FE3F194013DB9_OFFSET UNITYSDK_OFFSET(0x17213C10)
#define RPG_GAMECORE_FLOATVARIABLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17213D20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FloatVariableConfig_TypeDefinitionIndex = 14189;
