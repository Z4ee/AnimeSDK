...
#define RPG_GAMECORE_TARGETFETCHTIMEREWINDSTRIKESOURCE_METHOD_4_0BBD8A547109B5D2_OFFSET UNITYSDK_OFFSET(0x1D0BD8D0)
#define RPG_GAMECORE_TARGETFETCHTIMEREWINDSTRIKESOURCE_METHOD_4_602F478E4FE5F5C7_OFFSET UNITYSDK_OFFSET(0x1D0BD9D0)
#define RPG_GAMECORE_TARGETFETCHTIMEREWINDSTRIKESOURCE_METHOD_4_9CC404137650E5D3_OFFSET UNITYSDK_OFFSET(0x1D0BD970)
#define RPG_GAMECORE_TARGETFETCHTIMEREWINDSTRIKESOURCE_METHOD_4_B2B14B1404C85E6B_OFFSET UNITYSDK_OFFSET(0x1D0BDA10)
#define RPG_GAMECORE_TARGETFETCHTIMEREWINDSTRIKESOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0BD960)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchTimeRewindStrikeSource_TypeDefinitionIndex = 23033;
