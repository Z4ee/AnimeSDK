...
#define RPG_GAMECORE_TRIGGERMARBLEAFTERSTREAMINGACTION_METHOD_3_1B1D8D2331478BD2_OFFSET UNITYSDK_OFFSET(0x178C9600)
#define RPG_GAMECORE_TRIGGERMARBLEAFTERSTREAMINGACTION_METHOD_3_E9617C78E8463BDE_OFFSET UNITYSDK_OFFSET(0x178C9710)
#define RPG_GAMECORE_TRIGGERMARBLEAFTERSTREAMINGACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x178C96E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerMarbleAfterStreamingAction_TypeDefinitionIndex = 19570;
