...
#define RPG_GAMECORE_TRIGGERMARBLEAFTERSTREAMINGACTION_METHOD_3_1B1D8D2331478BD2_OFFSET UNITYSDK_OFFSET(0x190C7D20)
#define RPG_GAMECORE_TRIGGERMARBLEAFTERSTREAMINGACTION_METHOD_3_E9617C78E8463BDE_OFFSET UNITYSDK_OFFSET(0x190C7E30)
#define RPG_GAMECORE_TRIGGERMARBLEAFTERSTREAMINGACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x190C7E00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerMarbleAfterStreamingAction_TypeDefinitionIndex = 20245;
