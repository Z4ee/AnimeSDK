...
#define RPG_GAMECORE_FIVEDIMDROPENTITYACTION_METHOD_3_ADA1F9EE3C404D1E_OFFSET UNITYSDK_OFFSET(0x171F0670)
#define RPG_GAMECORE_FIVEDIMDROPENTITYACTION_METHOD_3_CFBDFA9FA639A785_OFFSET UNITYSDK_OFFSET(0x171E7080)
#define RPG_GAMECORE_FIVEDIMDROPENTITYACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x171E7060)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimDropEntityAction_TypeDefinitionIndex = 17176;
