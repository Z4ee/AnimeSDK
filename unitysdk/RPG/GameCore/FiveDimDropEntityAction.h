...
#define RPG_GAMECORE_FIVEDIMDROPENTITYACTION_METHOD_3_B202B7106FD4C392_OFFSET UNITYSDK_OFFSET(0x1BA927B0)
#define RPG_GAMECORE_FIVEDIMDROPENTITYACTION_METHOD_3_CFBDFA9FA639A785_OFFSET UNITYSDK_OFFSET(0x1BA92800)
#define RPG_GAMECORE_FIVEDIMDROPENTITYACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA927F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimDropEntityAction_TypeDefinitionIndex = 17981;
