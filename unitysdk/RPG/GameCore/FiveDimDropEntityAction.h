...
#define RPG_GAMECORE_FIVEDIMDROPENTITYACTION_METHOD_3_ADA1F9EE3C404D1E_OFFSET UNITYSDK_OFFSET(0x188FECD0)
#define RPG_GAMECORE_FIVEDIMDROPENTITYACTION_METHOD_3_CFBDFA9FA639A785_OFFSET UNITYSDK_OFFSET(0x188F4780)
#define RPG_GAMECORE_FIVEDIMDROPENTITYACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x188F4760)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimDropEntityAction_TypeDefinitionIndex = 17778;
