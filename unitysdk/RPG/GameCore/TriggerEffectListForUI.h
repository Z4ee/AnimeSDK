...
#define RPG_GAMECORE_TRIGGEREFFECTLISTFORUI_METHOD_4_48FA53C77A63BD51_OFFSET UNITYSDK_OFFSET(0x190C4800)
#define RPG_GAMECORE_TRIGGEREFFECTLISTFORUI_METHOD_4_C96983DA1F5F1F8D_OFFSET UNITYSDK_OFFSET(0x190C4680)
#define RPG_GAMECORE_TRIGGEREFFECTLISTFORUI__CTOR_OFFSET UNITYSDK_OFFSET(0x190C4650)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerEffectListForUI_TypeDefinitionIndex = 21806;
