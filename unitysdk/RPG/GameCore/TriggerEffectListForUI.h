...
#define RPG_GAMECORE_TRIGGEREFFECTLISTFORUI_METHOD_4_6B180752972582D3_OFFSET UNITYSDK_OFFSET(0x1D5FD800)
#define RPG_GAMECORE_TRIGGEREFFECTLISTFORUI_METHOD_4_985BBD5F1E4E2064_OFFSET UNITYSDK_OFFSET(0x1D5FD830)
#define RPG_GAMECORE_TRIGGEREFFECTLISTFORUI_METHOD_4_BCA314B6F485615A_OFFSET UNITYSDK_OFFSET(0x1D5FD650)
#define RPG_GAMECORE_TRIGGEREFFECTLISTFORUI_METHOD_4_C96983DA1F5F1F8D_OFFSET UNITYSDK_OFFSET(0x1D5FD690)
#define RPG_GAMECORE_TRIGGEREFFECTLISTFORUI__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5FD680)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerEffectListForUI_TypeDefinitionIndex = 22635;
