...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYPERSONAROOMCONTENTIDCONFIG_METHOD_3_DFE5C374B0CB7554_OFFSET UNITYSDK_OFFSET(0x176350D0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYPERSONAROOMCONTENTIDCONFIG_METHOD_3_F3FE0BED7E6DCECD_OFFSET UNITYSDK_OFFSET(0x176351A0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYPERSONAROOMCONTENTIDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17635150)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyPersonaRoomContentIDConfig_TypeDefinitionIndex = 16349;
