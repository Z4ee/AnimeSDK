...
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCCOMPOSEMAGICUNITCONFIG_METHOD_3_286FFA7F31FCA01D_OFFSET UNITYSDK_OFFSET(0x19BD4290)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCCOMPOSEMAGICUNITCONFIG_METHOD_3_62C3A00C080F3859_OFFSET UNITYSDK_OFFSET(0x19BD4400)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCCOMPOSEMAGICUNITCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19BD4280)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueWorkbenchFuncComposeMagicUnitConfig_TypeDefinitionIndex = 17140;
