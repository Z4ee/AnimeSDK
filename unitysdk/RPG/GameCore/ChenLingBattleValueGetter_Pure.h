...
#define RPG_GAMECORE_CHENLINGBATTLEVALUEGETTER_PURE_METHOD_3_55349FDEF4ED3656_OFFSET UNITYSDK_OFFSET(0x17083110)
#define RPG_GAMECORE_CHENLINGBATTLEVALUEGETTER_PURE_METHOD_3_AF4F2A87806231DA_OFFSET UNITYSDK_OFFSET(0x17083230)
#define RPG_GAMECORE_CHENLINGBATTLEVALUEGETTER_PURE__CTOR_OFFSET UNITYSDK_OFFSET(0x17083220)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleValueGetter_Pure_TypeDefinitionIndex = 14493;
