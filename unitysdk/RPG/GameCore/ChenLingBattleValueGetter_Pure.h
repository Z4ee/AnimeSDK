...
#define RPG_GAMECORE_CHENLINGBATTLEVALUEGETTER_PURE_METHOD_3_55349FDEF4ED3656_OFFSET UNITYSDK_OFFSET(0x1E010B40)
#define RPG_GAMECORE_CHENLINGBATTLEVALUEGETTER_PURE_METHOD_3_AF4F2A87806231DA_OFFSET UNITYSDK_OFFSET(0x1E010C60)
#define RPG_GAMECORE_CHENLINGBATTLEVALUEGETTER_PURE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E010C50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleValueGetter_Pure_TypeDefinitionIndex = 15627;
