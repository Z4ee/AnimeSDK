...
#define RPG_GAMECORE_SETDYNAMICVALUEBYCURRENTBP_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x18E1F670)
#define RPG_GAMECORE_SETDYNAMICVALUEBYCURRENTBP_METHOD_4_D4F9E2EB196B42F6_OFFSET UNITYSDK_OFFSET(0x18E1F470)
#define RPG_GAMECORE_SETDYNAMICVALUEBYCURRENTBP_METHOD_4_F1975248C08BDEFA_OFFSET UNITYSDK_OFFSET(0x18E1F390)
#define RPG_GAMECORE_SETDYNAMICVALUEBYCURRENTBP__CTOR_OFFSET UNITYSDK_OFFSET(0x18E1F410)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByCurrentBP_TypeDefinitionIndex = 22032;
