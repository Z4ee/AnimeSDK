...
#define RPG_GAMECORE_RESTAURANTDAILYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1DB980A0)
#define RPG_GAMECORE_RESTAURANTDAILYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB985F0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 LockNextDayMission; // 0x30
		::System::UInt32 FestivalID; // 0x34
		::System::UInt32 DayID; // 0x38
		::System::UInt32 ProgressID; // 0x3C
		::RPG::Client::TextID Tips; // 0x40
		::System::Boolean IsLoop; // 0x50
		::System::UInt32 RandomEventNumber; // 0x54
		::System::UInt32 StartMessageID; // 0x58
		::System::UInt32 BeginMainPageMission; // 0x5C
		::System::UInt32 ShareCropsRewardID; // 0x60
		::System::UInt32 OrderTableID; // 0x64
