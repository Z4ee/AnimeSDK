...
#define RPG_GAMECORE_RESTAURANTDAILYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19AD4420)
#define RPG_GAMECORE_RESTAURANTDAILYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19AD4970)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RestaurantDailyRow_TypeDefinitionIndex = 10887;
	...
	public:
		...
		::System::UInt32 RandomEventNumber; // 0x30
		::System::UInt32 ShareCropsRewardID; // 0x34
		::System::UInt32 FestivalID; // 0x38
		::System::UInt32 ProgressID; // 0x3C
		::System::UInt32 OrderTableID; // 0x40
		::System::UInt32 BeginMainPageMission; // 0x44
		::RPG::Client::TextID Tips; // 0x48
		::System::UInt32 DayID; // 0x58
		::System::Boolean IsLoop; // 0x5C
		::System::UInt32 LockRestaurantMission; // 0x60
