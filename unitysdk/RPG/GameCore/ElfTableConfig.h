...
#define RPG_GAMECORE_ELFTABLECONFIG_METHOD_3_AC3E11657E1DED23_OFFSET UNITYSDK_OFFSET(0x1889FBE0)
#define RPG_GAMECORE_ELFTABLECONFIG_METHOD_3_DAF835FE23AA7DA0_OFFSET UNITYSDK_OFFSET(0x1889FD00)
#define RPG_GAMECORE_ELFTABLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1889FCE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfTableConfig_TypeDefinitionIndex = 17549;
