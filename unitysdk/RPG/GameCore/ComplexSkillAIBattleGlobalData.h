...
#define RPG_GAMECORE_COMPLEXSKILLAIBATTLEGLOBALDATA_METHOD_3_24568FFAE06AC09A_OFFSET UNITYSDK_OFFSET(0x1BC23BD0)
#define RPG_GAMECORE_COMPLEXSKILLAIBATTLEGLOBALDATA_METHOD_3_3D54F65345E34E01_OFFSET UNITYSDK_OFFSET(0x1BC23C10)
#define RPG_GAMECORE_COMPLEXSKILLAIBATTLEGLOBALDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC23C00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAIBattleGlobalData_TypeDefinitionIndex = 14924;
