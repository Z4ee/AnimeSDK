...
#define RPG_GAMECORE_COMPLEXSKILLAIBATTLEGLOBALDATA_METHOD_3_3D54F65345E34E01_OFFSET UNITYSDK_OFFSET(0x18828990)
#define RPG_GAMECORE_COMPLEXSKILLAIBATTLEGLOBALDATA_METHOD_3_FD983D0710AA89C6_OFFSET UNITYSDK_OFFSET(0x18828920)
#define RPG_GAMECORE_COMPLEXSKILLAIBATTLEGLOBALDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18828970)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAIBattleGlobalData_TypeDefinitionIndex = 14699;
