...
#define RPG_GAMECORE_COMPLEXSKILLAIBATTLEGLOBALDATA_METHOD_3_3D54F65345E34E01_OFFSET UNITYSDK_OFFSET(0x17122310)
#define RPG_GAMECORE_COMPLEXSKILLAIBATTLEGLOBALDATA_METHOD_3_FD983D0710AA89C6_OFFSET UNITYSDK_OFFSET(0x171222A0)
#define RPG_GAMECORE_COMPLEXSKILLAIBATTLEGLOBALDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x171222F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAIBattleGlobalData_TypeDefinitionIndex = 14229;
