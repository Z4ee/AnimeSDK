...
#define RPG_GAMECORE_POINTGENERATORMERGECONFIG_METHOD_3_47ECD3F993326AFC_OFFSET UNITYSDK_OFFSET(0x174EBF40)
#define RPG_GAMECORE_POINTGENERATORMERGECONFIG_METHOD_3_9D73104F48B8F1A7_OFFSET UNITYSDK_OFFSET(0x174EC1E0)
#define RPG_GAMECORE_POINTGENERATORMERGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x174EBF30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PointGeneratorMergeConfig_TypeDefinitionIndex = 14323;
