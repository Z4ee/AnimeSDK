...
#define RPG_GAMECORE_POINTGENERATORMERGECONFIG_METHOD_3_45A51BE34CE0AFF9_OFFSET UNITYSDK_OFFSET(0x1BA13910)
#define RPG_GAMECORE_POINTGENERATORMERGECONFIG_METHOD_3_90EDCBD9A517F1F2_OFFSET UNITYSDK_OFFSET(0x1BA13B60)
#define RPG_GAMECORE_POINTGENERATORMERGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA13900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PointGeneratorMergeConfig_TypeDefinitionIndex = 15019;
