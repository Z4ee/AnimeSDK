...
#define RPG_GAMECORE_MONSTERSKILLROW_FROMBINARYWITHOUTNEW_OFFSET UNITYSDK_OFFSET(0x1B1CB280)
#define RPG_GAMECORE_MONSTERSKILLROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B1CBAA0)
#define RPG_GAMECORE_MONSTERSKILLROW_FROMTABLEOFFSET_OFFSET UNITYSDK_OFFSET(0x1B1CCB40)
#define RPG_GAMECORE_MONSTERSKILLROW_RESET_OFFSET UNITYSDK_OFFSET(0x1B1CCBA0)
#define RPG_GAMECORE_MONSTERSKILLROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1CCBE0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 SortOrder; // 0x50
		::System::UInt32 AI_CD; // 0x54
		::RPG::Client::TextID SkillDesc; // 0x58
		::RPG::Client::TextID SkillTag; // 0x68
		::System::Boolean IsThreat; // 0x78
		::RPG::GameCore::AttackType AttackType; // 0x7C
		::RPG::GameCore::FixPoint SPHitBase; // 0x80
		::RPG::Client::TextID SkillTypeDesc; // 0x88
		::RPG::Client::TextID SkillName; // 0x98
		::RPG::GameCore::AttackDamageType DamageType; // 0xA8
		::System::UInt32 AI_ICD; // 0xAC
