...
#define RPG_GAMECORE_MONSTERSKILLROW_FROMBINARYWITHOUTNEW_OFFSET UNITYSDK_OFFSET(0x18B5FA80)
#define RPG_GAMECORE_MONSTERSKILLROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18B602B0)
#define RPG_GAMECORE_MONSTERSKILLROW_FROMTABLEOFFSET_OFFSET UNITYSDK_OFFSET(0x18B613C0)
#define RPG_GAMECORE_MONSTERSKILLROW_RESET_OFFSET UNITYSDK_OFFSET(0x18B61420)
#define RPG_GAMECORE_MONSTERSKILLROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18B61460)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Boolean IsThreat; // 0x40
		::System::UInt32 AI_ICD; // 0x44
		::RPG::Client::TextID SkillName; // 0x48
		::System::UInt32 SortOrder; // 0x58
		::RPG::GameCore::AttackType AttackType; // 0x5C
