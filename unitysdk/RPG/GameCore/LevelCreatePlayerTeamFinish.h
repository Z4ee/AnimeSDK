...
#define RPG_GAMECORE_LEVELCREATEPLAYERTEAMFINISH_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1BDF19E0)
#define RPG_GAMECORE_LEVELCREATEPLAYERTEAMFINISH_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x1BDF1A30)
#define RPG_GAMECORE_LEVELCREATEPLAYERTEAMFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDF1A80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelCreatePlayerTeamFinish_TypeDefinitionIndex = 54186;
