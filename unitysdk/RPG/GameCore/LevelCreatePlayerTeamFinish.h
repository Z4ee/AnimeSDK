...
#define RPG_GAMECORE_LEVELCREATEPLAYERTEAMFINISH_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xCE3B980)
#define RPG_GAMECORE_LEVELCREATEPLAYERTEAMFINISH_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xCE3B9D0)
#define RPG_GAMECORE_LEVELCREATEPLAYERTEAMFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0xCE3BA20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelCreatePlayerTeamFinish_TypeDefinitionIndex = 52973;
