...
#define RPG_GAMECORE_LEVELCREATEPLAYERTEAMFINISH_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xB6CD660)
#define RPG_GAMECORE_LEVELCREATEPLAYERTEAMFINISH_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xB6CD6B0)
#define RPG_GAMECORE_LEVELCREATEPLAYERTEAMFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0xB6CD700)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelCreatePlayerTeamFinish_TypeDefinitionIndex = 52276;
