...
#define RPG_GAMECORE_ALLEYTUTORIALGRIDITEMDATA_METHOD_3_0CD5BB03DAC11192_OFFSET UNITYSDK_OFFSET(0x194747D0)
#define RPG_GAMECORE_ALLEYTUTORIALGRIDITEMDATA_METHOD_3_52A5D82A7D61670B_OFFSET UNITYSDK_OFFSET(0x19466A10)
#define RPG_GAMECORE_ALLEYTUTORIALGRIDITEMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19466A00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AlleyTutorialGridItemData_TypeDefinitionIndex = 14906;
