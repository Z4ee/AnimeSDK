...
#define RPG_GAMECORE_ALLEYTUTORIALGRIDITEMDATA_METHOD_3_0CD5BB03DAC11192_OFFSET UNITYSDK_OFFSET(0x1C566C20)
#define RPG_GAMECORE_ALLEYTUTORIALGRIDITEMDATA_METHOD_3_52A5D82A7D61670B_OFFSET UNITYSDK_OFFSET(0x1C566C60)
#define RPG_GAMECORE_ALLEYTUTORIALGRIDITEMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1C566C50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AlleyTutorialGridItemData_TypeDefinitionIndex = 15507;
