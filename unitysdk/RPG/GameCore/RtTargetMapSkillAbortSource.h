...
#define RPG_GAMECORE_RTTARGETMAPSKILLABORTSOURCE_METHOD_3_234F2B7F1D6579F9_OFFSET UNITYSDK_OFFSET(0x1D4B84D0)
#define RPG_GAMECORE_RTTARGETMAPSKILLABORTSOURCE_METHOD_3_4A23325FFE6775EA_OFFSET UNITYSDK_OFFSET(0x1D4B83D0)
#define RPG_GAMECORE_RTTARGETMAPSKILLABORTSOURCE_METHOD_3_73A4C0EDB78FB43D_OFFSET UNITYSDK_OFFSET(0x1D4B8510)
#define RPG_GAMECORE_RTTARGETMAPSKILLABORTSOURCE_METHOD_3_B478714DE88136CB_OFFSET UNITYSDK_OFFSET(0x1D4B8470)
#define RPG_GAMECORE_RTTARGETMAPSKILLABORTSOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4B8460)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtTargetMapSkillAbortSource_TypeDefinitionIndex = 23975;
