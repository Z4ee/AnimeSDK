...
#define RPG_GAMECORE_IDLELIVECLTRIGGERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D20E290)
#define RPG_GAMECORE_IDLELIVECLTRIGGERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D20E420)
