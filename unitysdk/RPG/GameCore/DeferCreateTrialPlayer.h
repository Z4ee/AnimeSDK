...
#define RPG_GAMECORE_DEFERCREATETRIALPLAYER_METHOD_3_143A4A5BD52EF068_OFFSET UNITYSDK_OFFSET(0x188587B0)
#define RPG_GAMECORE_DEFERCREATETRIALPLAYER_METHOD_3_5EB8FE9576915FF8_OFFSET UNITYSDK_OFFSET(0x18858730)
#define RPG_GAMECORE_DEFERCREATETRIALPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x18858780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DeferCreateTrialPlayer_TypeDefinitionIndex = 22659;
