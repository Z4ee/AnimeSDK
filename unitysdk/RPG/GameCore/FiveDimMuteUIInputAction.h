...
#define RPG_GAMECORE_FIVEDIMMUTEUIINPUTACTION_METHOD_3_9F1BB6EFC21DA9E2_OFFSET UNITYSDK_OFFSET(0x18910E50)
#define RPG_GAMECORE_FIVEDIMMUTEUIINPUTACTION_METHOD_3_BEB95AD9924F5FB6_OFFSET UNITYSDK_OFFSET(0x18910D40)
#define RPG_GAMECORE_FIVEDIMMUTEUIINPUTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18910E30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimMuteUIInputAction_TypeDefinitionIndex = 17834;
