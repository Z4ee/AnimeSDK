...
#define RPG_GAMECORE_ROGUEACTPERSONARANDOMROOMCARDCASTAPPENDRANDOMATTRIBUTEBYGROUPCONFIG_METHOD_7_556580311A6A01AD_OFFSET UNITYSDK_OFFSET(0x1D02F930)
#define RPG_GAMECORE_ROGUEACTPERSONARANDOMROOMCARDCASTAPPENDRANDOMATTRIBUTEBYGROUPCONFIG_METHOD_7_E142FF1A52523711_OFFSET UNITYSDK_OFFSET(0x1D02F980)
#define RPG_GAMECORE_ROGUEACTPERSONARANDOMROOMCARDCASTAPPENDRANDOMATTRIBUTEBYGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D02F970)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaRandomRoomCardCastAppendRandomAttributeByGroupConfig_TypeDefinitionIndex = 18980;
