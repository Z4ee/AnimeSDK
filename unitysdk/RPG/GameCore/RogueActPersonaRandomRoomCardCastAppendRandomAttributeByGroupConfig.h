...
#define RPG_GAMECORE_ROGUEACTPERSONARANDOMROOMCARDCASTAPPENDRANDOMATTRIBUTEBYGROUPCONFIG_METHOD_7_D142A04756C908DC_OFFSET UNITYSDK_OFFSET(0x175BEF10)
#define RPG_GAMECORE_ROGUEACTPERSONARANDOMROOMCARDCASTAPPENDRANDOMATTRIBUTEBYGROUPCONFIG_METHOD_7_E142FF1A52523711_OFFSET UNITYSDK_OFFSET(0x175BF130)
#define RPG_GAMECORE_ROGUEACTPERSONARANDOMROOMCARDCASTAPPENDRANDOMATTRIBUTEBYGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175BF050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaRandomRoomCardCastAppendRandomAttributeByGroupConfig_TypeDefinitionIndex = 18092;
