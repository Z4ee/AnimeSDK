...
#define RPG_GAMECORE_GRIDFIGHTROLECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x189D2730)
#define RPG_GAMECORE_GRIDFIGHTROLECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x189D2CF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightRoleConfigRow_TypeDefinitionIndex = 12764;
