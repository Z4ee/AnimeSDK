...
#define RPG_GAMECORE_GRIDFIGHTROLECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19805900)
#define RPG_GAMECORE_GRIDFIGHTROLECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19805E50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightRoleConfigRow_TypeDefinitionIndex = 12854;
	...
	public:
		...
		::Il2CppArray<::System::UInt32>* SeasonIDList; // 0x28
		...
		static ::System::Void FromBinary(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::GridFightRoleConfigRow*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::GridFightRoleConfigRow*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_GRIDFIGHTROLECONFIGROW_FROMBINARY_OFFSET))(a1, a2);
		}
	};
}
