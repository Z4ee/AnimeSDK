...
#define RPG_GAMECORE_EVOLVEBUILDGEARSELECTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xCDE5A10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EvolveBuildGearSelectInfo_TypeDefinitionIndex = 52345;
