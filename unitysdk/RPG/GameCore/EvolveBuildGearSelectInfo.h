...
#define RPG_GAMECORE_EVOLVEBUILDGEARSELECTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x154DA3B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EvolveBuildGearSelectInfo_TypeDefinitionIndex = 53549;
