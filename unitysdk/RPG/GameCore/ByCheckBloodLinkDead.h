...
#define RPG_GAMECORE_BYCHECKBLOODLINKDEAD_METHOD_4_36970B05CD3FD1C6_OFFSET UNITYSDK_OFFSET(0x1CEA3280)
#define RPG_GAMECORE_BYCHECKBLOODLINKDEAD_METHOD_4_63C4D12E597B5410_OFFSET UNITYSDK_OFFSET(0x1CEA3140)
#define RPG_GAMECORE_BYCHECKBLOODLINKDEAD_METHOD_4_6B4AE156ECC0143B_OFFSET UNITYSDK_OFFSET(0x1CEA32B0)
#define RPG_GAMECORE_BYCHECKBLOODLINKDEAD_METHOD_4_F12CB8C36C82F7D3_OFFSET UNITYSDK_OFFSET(0x1CEA3100)
#define RPG_GAMECORE_BYCHECKBLOODLINKDEAD__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEA3130)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckBloodLinkDead_TypeDefinitionIndex = 22776;
