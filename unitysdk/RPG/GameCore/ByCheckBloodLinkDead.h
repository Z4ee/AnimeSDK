...
#define RPG_GAMECORE_BYCHECKBLOODLINKDEAD_METHOD_4_63C4D12E597B5410_OFFSET UNITYSDK_OFFSET(0x16FFD000)
#define RPG_GAMECORE_BYCHECKBLOODLINKDEAD_METHOD_4_6E02F0B058B0306A_OFFSET UNITYSDK_OFFSET(0x16FFCF30)
#define RPG_GAMECORE_BYCHECKBLOODLINKDEAD__CTOR_OFFSET UNITYSDK_OFFSET(0x16FFCFB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckBloodLinkDead_TypeDefinitionIndex = 21241;
