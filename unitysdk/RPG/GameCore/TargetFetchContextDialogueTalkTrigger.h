...
#define RPG_GAMECORE_TARGETFETCHCONTEXTDIALOGUETALKTRIGGER_METHOD_4_4B6C6A72FD8E18E2_OFFSET UNITYSDK_OFFSET(0x1D0B8D70)
#define RPG_GAMECORE_TARGETFETCHCONTEXTDIALOGUETALKTRIGGER_METHOD_4_8B7CDD538F97985B_OFFSET UNITYSDK_OFFSET(0x1D0B8EB0)
#define RPG_GAMECORE_TARGETFETCHCONTEXTDIALOGUETALKTRIGGER_METHOD_4_AA93B692FA7D23F7_OFFSET UNITYSDK_OFFSET(0x1D0B8E70)
#define RPG_GAMECORE_TARGETFETCHCONTEXTDIALOGUETALKTRIGGER_METHOD_4_E960BF71D6665F63_OFFSET UNITYSDK_OFFSET(0x1D0B8E10)
#define RPG_GAMECORE_TARGETFETCHCONTEXTDIALOGUETALKTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0B8E00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchContextDialogueTalkTrigger_TypeDefinitionIndex = 23029;
