...
#define RPG_GAMECORE_TARGETFETCHCONTEXTDIALOGUETALKTRIGGER_METHOD_4_610411E440498695_OFFSET UNITYSDK_OFFSET(0x18EE3A20)
#define RPG_GAMECORE_TARGETFETCHCONTEXTDIALOGUETALKTRIGGER_METHOD_4_E960BF71D6665F63_OFFSET UNITYSDK_OFFSET(0x18EDC090)
#define RPG_GAMECORE_TARGETFETCHCONTEXTDIALOGUETALKTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x18EDC040)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchContextDialogueTalkTrigger_TypeDefinitionIndex = 22868;
