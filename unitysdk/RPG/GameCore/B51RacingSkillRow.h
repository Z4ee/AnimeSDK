...
#define RPG_GAMECORE_B51RACINGSKILLROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CE5DFB0)
#define RPG_GAMECORE_B51RACINGSKILLROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE5E4A0)
...
namespace RPG::GameCore
{
	...
	{
	public:
		::System::String* IconPath_128; // 0x10
		::Il2CppArray<::System::String*>* PassiveList; // 0x18
		::System::String* IconPath; // 0x20
		::Il2CppArray<::System::UInt32>* PassiveParamList; // 0x28
		::System::UInt32 ID; // 0x30
		::RPG::Client::TextID Desc; // 0x38
		::RPG::Client::TextID Name; // 0x48
		::RPG::Client::TextID Desc_Back; // 0x58
		::System::UInt32 Level; // 0x68
		::RPG::GameCore::B51RacingSkillType Type; // 0x6C
		::RPG::Client::TextID Desc_Front; // 0x70
