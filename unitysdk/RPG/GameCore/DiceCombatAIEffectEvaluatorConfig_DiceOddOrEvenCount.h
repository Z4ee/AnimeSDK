...
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEODDOREVENCOUNT_METHOD_3_296743F050FD7647_OFFSET UNITYSDK_OFFSET(0x1D028D80)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEODDOREVENCOUNT_METHOD_3_D34FAECC7BE514BB_OFFSET UNITYSDK_OFFSET(0x1D0283D0)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEODDOREVENCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0283C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatAIEffectEvaluatorConfig_DiceOddOrEvenCount_TypeDefinitionIndex = 15993;
