...
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEODDOREVENCOUNT_METHOD_3_296743F050FD7647_OFFSET UNITYSDK_OFFSET(0x18864030)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEODDOREVENCOUNT_METHOD_3_D34FAECC7BE514BB_OFFSET UNITYSDK_OFFSET(0x18863680)
#define RPG_GAMECORE_DICECOMBATAIEFFECTEVALUATORCONFIG_DICEODDOREVENCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x18863670)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatAIEffectEvaluatorConfig_DiceOddOrEvenCount_TypeDefinitionIndex = 15334;
