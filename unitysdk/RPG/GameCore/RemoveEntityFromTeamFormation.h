...
#define RPG_GAMECORE_REMOVEENTITYFROMTEAMFORMATION_METHOD_3_3240488C275C5FE7_OFFSET UNITYSDK_OFFSET(0x1DB8D4B0)
#define RPG_GAMECORE_REMOVEENTITYFROMTEAMFORMATION_METHOD_3_427F600F468C2850_OFFSET UNITYSDK_OFFSET(0x1DB8D470)
#define RPG_GAMECORE_REMOVEENTITYFROMTEAMFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB8D4A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveEntityFromTeamFormation_TypeDefinitionIndex = 22385;
