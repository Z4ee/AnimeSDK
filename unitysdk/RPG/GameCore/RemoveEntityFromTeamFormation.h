...
#define RPG_GAMECORE_REMOVEENTITYFROMTEAMFORMATION_METHOD_3_1E23DD5CC4F89643_OFFSET UNITYSDK_OFFSET(0x17597F00)
#define RPG_GAMECORE_REMOVEENTITYFROMTEAMFORMATION_METHOD_3_3240488C275C5FE7_OFFSET UNITYSDK_OFFSET(0x17597F80)
#define RPG_GAMECORE_REMOVEENTITYFROMTEAMFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x17597F50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveEntityFromTeamFormation_TypeDefinitionIndex = 20817;
