...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYREPLENISHROOMCARDLEVELCONFIG_METHOD_3_BB2B4EDB8A52866A_OFFSET UNITYSDK_OFFSET(0x19B5FF40)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYREPLENISHROOMCARDLEVELCONFIG_METHOD_3_BC51E342ADC8EE23_OFFSET UNITYSDK_OFFSET(0x19B56B00)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYREPLENISHROOMCARDLEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B56AB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyReplenishRoomCardLevelConfig_TypeDefinitionIndex = 16952;
