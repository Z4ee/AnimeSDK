...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYREPLENISHROOMCARDLEVELCONFIG_METHOD_3_BC51E342ADC8EE23_OFFSET UNITYSDK_OFFSET(0x1EEFB400)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYREPLENISHROOMCARDLEVELCONFIG_METHOD_3_FFA3D03B0A4E301F_OFFSET UNITYSDK_OFFSET(0x1EEFB3B0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYREPLENISHROOMCARDLEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEFB3F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyReplenishRoomCardLevelConfig_TypeDefinitionIndex = 17628;
