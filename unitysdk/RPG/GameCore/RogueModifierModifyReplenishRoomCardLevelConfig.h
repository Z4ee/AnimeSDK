...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYREPLENISHROOMCARDLEVELCONFIG_METHOD_3_BB2B4EDB8A52866A_OFFSET UNITYSDK_OFFSET(0x176356F0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYREPLENISHROOMCARDLEVELCONFIG_METHOD_3_BC51E342ADC8EE23_OFFSET UNITYSDK_OFFSET(0x176357C0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYREPLENISHROOMCARDLEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17635770)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyReplenishRoomCardLevelConfig_TypeDefinitionIndex = 16383;
