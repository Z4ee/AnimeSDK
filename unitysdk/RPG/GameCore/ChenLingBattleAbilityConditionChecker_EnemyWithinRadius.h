...
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_ENEMYWITHINRADIUS_METHOD_3_54DA1333745B694C_OFFSET UNITYSDK_OFFSET(0x1961A9E0)
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_ENEMYWITHINRADIUS_METHOD_3_ED40548F0794147E_OFFSET UNITYSDK_OFFSET(0x1961AA40)
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_ENEMYWITHINRADIUS__CTOR_OFFSET UNITYSDK_OFFSET(0x1961AA30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleAbilityConditionChecker_EnemyWithinRadius_TypeDefinitionIndex = 14946;
