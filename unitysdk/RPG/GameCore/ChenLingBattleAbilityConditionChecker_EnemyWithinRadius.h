...
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_ENEMYWITHINRADIUS_METHOD_3_54DA1333745B694C_OFFSET UNITYSDK_OFFSET(0x1B730390)
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_ENEMYWITHINRADIUS_METHOD_3_ED40548F0794147E_OFFSET UNITYSDK_OFFSET(0x1B7303F0)
#define RPG_GAMECORE_CHENLINGBATTLEABILITYCONDITIONCHECKER_ENEMYWITHINRADIUS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7303E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleAbilityConditionChecker_EnemyWithinRadius_TypeDefinitionIndex = 15110;
