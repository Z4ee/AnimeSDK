...
#define RPG_GAMECORE_ROGUEACTEMPTYCONFIG_METHOD_6_1DFB121E8DE1137D_OFFSET UNITYSDK_OFFSET(0x175B4C60)
#define RPG_GAMECORE_ROGUEACTEMPTYCONFIG_METHOD_6_48BDF3326DE652A0_OFFSET UNITYSDK_OFFSET(0x175B4A40)
#define RPG_GAMECORE_ROGUEACTEMPTYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175B4B80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActEmptyConfig_TypeDefinitionIndex = 18058;
