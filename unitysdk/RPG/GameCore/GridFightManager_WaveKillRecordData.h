...
#define RPG_GAMECORE_GRIDFIGHTMANAGER_WAVEKILLRECORDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18442380)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightManager_WaveKillRecordData_TypeDefinitionIndex = 56359;

	class GridFightManager_WaveKillRecordData : public ::System::Object
	{
	public:
		::System::Collections::Generic::List_1<::System::UInt32>* KillMonsterIDList; // 0x10
