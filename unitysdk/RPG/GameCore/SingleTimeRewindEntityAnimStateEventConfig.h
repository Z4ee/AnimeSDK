...
#define RPG_GAMECORE_SINGLETIMEREWINDENTITYANIMSTATEEVENTCONFIG_METHOD_3_AADDCB4F9DF79B1A_OFFSET UNITYSDK_OFFSET(0x19C8B140)
#define RPG_GAMECORE_SINGLETIMEREWINDENTITYANIMSTATEEVENTCONFIG_METHOD_3_ED53A75E5E808C5F_OFFSET UNITYSDK_OFFSET(0x19C8AE50)
#define RPG_GAMECORE_SINGLETIMEREWINDENTITYANIMSTATEEVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19C8AE40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SingleTimeRewindEntityAnimStateEventConfig_TypeDefinitionIndex = 15773;
