...
#define RPG_GAMECORE_SINGLETIMEREWINDENTITYANIMSTATEEVENTCONFIG_METHOD_3_AADDCB4F9DF79B1A_OFFSET UNITYSDK_OFFSET(0x1D0A2120)
#define RPG_GAMECORE_SINGLETIMEREWINDENTITYANIMSTATEEVENTCONFIG_METHOD_3_ED53A75E5E808C5F_OFFSET UNITYSDK_OFFSET(0x1D0A1E30)
#define RPG_GAMECORE_SINGLETIMEREWINDENTITYANIMSTATEEVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0A1E20)
