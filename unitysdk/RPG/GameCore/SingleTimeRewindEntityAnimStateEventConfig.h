...
#define RPG_GAMECORE_SINGLETIMEREWINDENTITYANIMSTATEEVENTCONFIG_METHOD_3_3E11F818A1B232EA_OFFSET UNITYSDK_OFFSET(0x18E6F1B0)
#define RPG_GAMECORE_SINGLETIMEREWINDENTITYANIMSTATEEVENTCONFIG_METHOD_3_A8BDCC33916EF3AD_OFFSET UNITYSDK_OFFSET(0x18E6F4A0)
#define RPG_GAMECORE_SINGLETIMEREWINDENTITYANIMSTATEEVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18E6F1A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SingleTimeRewindEntityAnimStateEventConfig_TypeDefinitionIndex = 15718;
