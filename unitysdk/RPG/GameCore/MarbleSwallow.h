...
#define RPG_GAMECORE_MARBLESWALLOW_METHOD_3_1BF91A4F778FF7F9_OFFSET UNITYSDK_OFFSET(0x1739ABD0)
#define RPG_GAMECORE_MARBLESWALLOW_METHOD_3_937066DA8C4C9CE2_OFFSET UNITYSDK_OFFSET(0x1739ACB0)
#define RPG_GAMECORE_MARBLESWALLOW__CTOR_OFFSET UNITYSDK_OFFSET(0x1739AC60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleSwallow_TypeDefinitionIndex = 15432;
