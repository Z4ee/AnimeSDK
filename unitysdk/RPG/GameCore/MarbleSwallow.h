...
#define RPG_GAMECORE_MARBLESWALLOW_METHOD_3_1BF91A4F778FF7F9_OFFSET UNITYSDK_OFFSET(0x198DBA60)
#define RPG_GAMECORE_MARBLESWALLOW_METHOD_3_937066DA8C4C9CE2_OFFSET UNITYSDK_OFFSET(0x198DBB40)
#define RPG_GAMECORE_MARBLESWALLOW__CTOR_OFFSET UNITYSDK_OFFSET(0x198DBAF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleSwallow_TypeDefinitionIndex = 16004;
