...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEPASSREPLICATECELL_METHOD_3_6D9556A346B38DEE_OFFSET UNITYSDK_OFFSET(0x19C43F20)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEPASSREPLICATECELL_METHOD_3_871606442B4C8419_OFFSET UNITYSDK_OFFSET(0x19C43EB0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEPASSREPLICATECELL__CTOR_OFFSET UNITYSDK_OFFSET(0x19C43EF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRoguePassReplicateCell_TypeDefinitionIndex = 20566;
