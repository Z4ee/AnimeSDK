...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEPASSREPLICATECELL_METHOD_3_6D9556A346B38DEE_OFFSET UNITYSDK_OFFSET(0x1C5F0680)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEPASSREPLICATECELL_METHOD_3_F85931E74CB7515B_OFFSET UNITYSDK_OFFSET(0x1C5F0640)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUEPASSREPLICATECELL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5F0670)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRoguePassReplicateCell_TypeDefinitionIndex = 20981;
