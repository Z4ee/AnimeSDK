...
#define RPG_GAMECORE_SETVIEWMODESERVANTFOLLOW_METHOD_3_045813813614702B_OFFSET UNITYSDK_OFFSET(0x1C60FE60)
#define RPG_GAMECORE_SETVIEWMODESERVANTFOLLOW_METHOD_3_57BE84F2664C4748_OFFSET UNITYSDK_OFFSET(0x1C60FEA0)
#define RPG_GAMECORE_SETVIEWMODESERVANTFOLLOW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C60FE90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetViewModeServantFollow_TypeDefinitionIndex = 22092;
