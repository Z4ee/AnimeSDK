...
#define RPG_GAMECORE_SETVIEWMODESERVANTFOLLOW_METHOD_3_57BE84F2664C4748_OFFSET UNITYSDK_OFFSET(0x19C66EF0)
#define RPG_GAMECORE_SETVIEWMODESERVANTFOLLOW_METHOD_3_73C74515DA5976E1_OFFSET UNITYSDK_OFFSET(0x19C66E70)
#define RPG_GAMECORE_SETVIEWMODESERVANTFOLLOW__CTOR_OFFSET UNITYSDK_OFFSET(0x19C66EC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetViewModeServantFollow_TypeDefinitionIndex = 21666;
