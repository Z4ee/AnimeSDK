...
#define RPG_GAMECORE_MAPROTATIONVOLUMECONFIG_METHOD_2_AD2D2B3C6A2880CD_OFFSET UNITYSDK_OFFSET(0x1BD0C420)
#define RPG_GAMECORE_MAPROTATIONVOLUMECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD0C760)
