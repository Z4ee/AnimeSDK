...
#define RPG_GAMECORE_MAPROTATIONVOLUMECONFIG_METHOD_2_AD2D2B3C6A2880CD_OFFSET UNITYSDK_OFFSET(0x198C2250)
#define RPG_GAMECORE_MAPROTATIONVOLUMECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x198C2590)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MapRotationVolumeConfig_TypeDefinitionIndex = 16157;
