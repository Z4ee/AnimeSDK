...
#define RPG_GAMECORE_RESTOREWOLFBROPUZZLEARCHIVE_METHOD_3_0FB22ADA95E11849_OFFSET UNITYSDK_OFFSET(0x1DB9F4D0)
#define RPG_GAMECORE_RESTOREWOLFBROPUZZLEARCHIVE_METHOD_3_EBB4847FB5756340_OFFSET UNITYSDK_OFFSET(0x1DB9F480)
#define RPG_GAMECORE_RESTOREWOLFBROPUZZLEARCHIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB9F4C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RestoreWolfBroPuzzleArchive_TypeDefinitionIndex = 21748;
