...
#define RPG_GAMECORE_CAKERACESPARKLEINITCONFIG_METHOD_2_AD39F4B109CFAC4E_OFFSET UNITYSDK_OFFSET(0x1704F700)
#define RPG_GAMECORE_CAKERACESPARKLEINITCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1704F930)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceSparkleInitConfig_TypeDefinitionIndex = 16927;
