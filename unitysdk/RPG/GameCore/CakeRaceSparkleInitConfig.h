...
#define RPG_GAMECORE_CAKERACESPARKLEINITCONFIG_METHOD_2_AD39F4B109CFAC4E_OFFSET UNITYSDK_OFFSET(0x195EE570)
#define RPG_GAMECORE_CAKERACESPARKLEINITCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x195F0EE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceSparkleInitConfig_TypeDefinitionIndex = 17520;
