...
#define RPG_GAMECORE_FIVEDIMARROWBAKEDMOVECONFIG_METHOD_3_61C283336651683D_OFFSET UNITYSDK_OFFSET(0x19727720)
#define RPG_GAMECORE_FIVEDIMARROWBAKEDMOVECONFIG_METHOD_3_A48B93AC69DB0F6C_OFFSET UNITYSDK_OFFSET(0x197276E0)
#define RPG_GAMECORE_FIVEDIMARROWBAKEDMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19727710)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimArrowBakedMoveConfig_TypeDefinitionIndex = 15850;
