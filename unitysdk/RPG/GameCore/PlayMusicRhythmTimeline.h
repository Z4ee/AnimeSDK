...
#define RPG_GAMECORE_PLAYMUSICRHYTHMTIMELINE_METHOD_3_9748D0FAB63BEE9F_OFFSET UNITYSDK_OFFSET(0x18C0EB30)
#define RPG_GAMECORE_PLAYMUSICRHYTHMTIMELINE_METHOD_3_AB4C100569A13719_OFFSET UNITYSDK_OFFSET(0x18C0EBB0)
#define RPG_GAMECORE_PLAYMUSICRHYTHMTIMELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x18C0EB80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayMusicRhythmTimeline_TypeDefinitionIndex = 20925;
