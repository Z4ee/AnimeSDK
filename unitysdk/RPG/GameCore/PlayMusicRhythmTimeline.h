...
#define RPG_GAMECORE_PLAYMUSICRHYTHMTIMELINE_METHOD_3_8C45337C72647024_OFFSET UNITYSDK_OFFSET(0x1D7A5690)
#define RPG_GAMECORE_PLAYMUSICRHYTHMTIMELINE_METHOD_3_AB4C100569A13719_OFFSET UNITYSDK_OFFSET(0x1D7A56D0)
#define RPG_GAMECORE_PLAYMUSICRHYTHMTIMELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7A56C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayMusicRhythmTimeline_TypeDefinitionIndex = 21813;
