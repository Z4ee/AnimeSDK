...
#define RPG_GAMECORE_DEVICERELATEDMONSTERASSETPRELOADCONFIG_METHOD_3_2D464A3B87E7D8AE_OFFSET UNITYSDK_OFFSET(0x1C106710)
#define RPG_GAMECORE_DEVICERELATEDMONSTERASSETPRELOADCONFIG_METHOD_3_4FCE79884906B4D4_OFFSET UNITYSDK_OFFSET(0x1C106A20)
#define RPG_GAMECORE_DEVICERELATEDMONSTERASSETPRELOADCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C106700)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DeviceRelatedMonsterAssetPreloadConfig_TypeDefinitionIndex = 15826;
