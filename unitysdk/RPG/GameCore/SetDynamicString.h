...
#define RPG_GAMECORE_SETDYNAMICSTRING_METHOD_4_6EB0A0B772EC6CE3_OFFSET UNITYSDK_OFFSET(0x1C2DD2C0)
#define RPG_GAMECORE_SETDYNAMICSTRING_METHOD_4_EE4C5FF1C59917B2_OFFSET UNITYSDK_OFFSET(0x1C2DD280)
#define RPG_GAMECORE_SETDYNAMICSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2DD2B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicString_TypeDefinitionIndex = 22964;
