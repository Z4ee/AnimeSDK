...
#define RPG_GAMECORE_CREATEBATTLEEVENTENTITYFROMSTAGE_METHOD_4_1A11EA6D406D0CAE_OFFSET UNITYSDK_OFFSET(0x1BC38A00)
#define RPG_GAMECORE_CREATEBATTLEEVENTENTITYFROMSTAGE_METHOD_4_F0DCD79161E0542D_OFFSET UNITYSDK_OFFSET(0x1BC39520)
#define RPG_GAMECORE_CREATEBATTLEEVENTENTITYFROMSTAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC389F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CreateBattleEventEntityFromStage_TypeDefinitionIndex = 22584;
