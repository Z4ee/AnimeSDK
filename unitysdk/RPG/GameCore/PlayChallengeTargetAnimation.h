...
#define RPG_GAMECORE_PLAYCHALLENGETARGETANIMATION_METHOD_3_000725440F672C6F_OFFSET UNITYSDK_OFFSET(0x1BA02A80)
#define RPG_GAMECORE_PLAYCHALLENGETARGETANIMATION_METHOD_3_F5836DC97638DAF2_OFFSET UNITYSDK_OFFSET(0x1BA029B0)
#define RPG_GAMECORE_PLAYCHALLENGETARGETANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA02A70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayChallengeTargetAnimation_TypeDefinitionIndex = 20815;
