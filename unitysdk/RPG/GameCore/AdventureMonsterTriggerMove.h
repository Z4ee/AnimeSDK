...
#define RPG_GAMECORE_ADVENTUREMONSTERTRIGGERMOVE_METHOD_3_BF22CD411F1CBBC4_OFFSET UNITYSDK_OFFSET(0x18678DF0)
#define RPG_GAMECORE_ADVENTUREMONSTERTRIGGERMOVE_METHOD_3_DB9C9141FDC9BD88_OFFSET UNITYSDK_OFFSET(0x18678E70)
#define RPG_GAMECORE_ADVENTUREMONSTERTRIGGERMOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x18678E40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureMonsterTriggerMove_TypeDefinitionIndex = 19124;
