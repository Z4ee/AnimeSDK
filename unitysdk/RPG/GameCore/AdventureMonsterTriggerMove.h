...
#define RPG_GAMECORE_ADVENTUREMONSTERTRIGGERMOVE_METHOD_3_B39D1D4D5386C6D6_OFFSET UNITYSDK_OFFSET(0x1CDF4780)
#define RPG_GAMECORE_ADVENTUREMONSTERTRIGGERMOVE_METHOD_3_DB9C9141FDC9BD88_OFFSET UNITYSDK_OFFSET(0x1CDF47C0)
#define RPG_GAMECORE_ADVENTUREMONSTERTRIGGERMOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDF47B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureMonsterTriggerMove_TypeDefinitionIndex = 19951;
