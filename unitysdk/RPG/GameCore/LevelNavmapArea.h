...
#define RPG_GAMECORE_LEVELNAVMAPAREA_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18A4E950)
#define RPG_GAMECORE_LEVELNAVMAPAREA__CTOR_OFFSET UNITYSDK_OFFSET(0x18A4EDD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelNavmapArea_TypeDefinitionIndex = 16342;
	...
	public:
		...
		static ::System::Void FromBinary(::Class_1_7A22A3DBEEDD1F80* array, ::RPG::GameCore::LevelNavmapArea*& val)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::LevelNavmapArea*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_LEVELNAVMAPAREA_FROMBINARY_OFFSET))(array, val);
		}
	};
}
