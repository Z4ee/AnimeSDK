...
#define RPG_GAMECORE_LEVELNAVMAPAREA_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C124AB0)
#define RPG_GAMECORE_LEVELNAVMAPAREA__CTOR_OFFSET UNITYSDK_OFFSET(0x1C124F20)
