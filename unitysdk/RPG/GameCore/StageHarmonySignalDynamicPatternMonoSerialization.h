...
#define RPG_GAMECORE_STAGEHARMONYSIGNALDYNAMICPATTERNMONOSERIALIZATION_METHOD_2_F35845005F9A325E_OFFSET UNITYSDK_OFFSET(0x17767D80)
#define RPG_GAMECORE_STAGEHARMONYSIGNALDYNAMICPATTERNMONOSERIALIZATION__CTOR_OFFSET UNITYSDK_OFFSET(0x17767ED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StageHarmonySignalDynamicPatternMonoSerialization_TypeDefinitionIndex = 17618;
