...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERCOPYDRESSEDROLECONFIG_METHOD_3_7C0AC0DE5DB99C05_OFFSET UNITYSDK_OFFSET(0x197EB070)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERCOPYDRESSEDROLECONFIG_METHOD_3_ABA4B6E068A80F6C_OFFSET UNITYSDK_OFFSET(0x197F12A0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERCOPYDRESSEDROLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197EB020)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierCopyDressedRoleConfig_TypeDefinitionIndex = 18485;
