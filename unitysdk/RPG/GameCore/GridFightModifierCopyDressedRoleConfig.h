...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERCOPYDRESSEDROLECONFIG_METHOD_3_56969E351162EAA1_OFFSET UNITYSDK_OFFSET(0x1C5D08D0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERCOPYDRESSEDROLECONFIG_METHOD_3_7C0AC0DE5DB99C05_OFFSET UNITYSDK_OFFSET(0x1C5D0920)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERCOPYDRESSEDROLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5D0910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierCopyDressedRoleConfig_TypeDefinitionIndex = 18735;
