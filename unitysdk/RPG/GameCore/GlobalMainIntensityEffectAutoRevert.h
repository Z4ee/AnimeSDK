...
#define RPG_GAMECORE_GLOBALMAININTENSITYEFFECTAUTOREVERT_METHOD_3_062B4C9387FBEBD4_OFFSET UNITYSDK_OFFSET(0x172485F0)
#define RPG_GAMECORE_GLOBALMAININTENSITYEFFECTAUTOREVERT_METHOD_3_F5823287AD12521F_OFFSET UNITYSDK_OFFSET(0x17248670)
#define RPG_GAMECORE_GLOBALMAININTENSITYEFFECTAUTOREVERT__CTOR_OFFSET UNITYSDK_OFFSET(0x17248640)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GlobalMainIntensityEffectAutoRevert_TypeDefinitionIndex = 20689;
