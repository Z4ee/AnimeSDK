...
#define RPG_GAMECORE_GLOBALMAININTENSITYEFFECTAUTOREVERT_METHOD_3_062B4C9387FBEBD4_OFFSET UNITYSDK_OFFSET(0x18997560)
#define RPG_GAMECORE_GLOBALMAININTENSITYEFFECTAUTOREVERT_METHOD_3_F5823287AD12521F_OFFSET UNITYSDK_OFFSET(0x189975E0)
#define RPG_GAMECORE_GLOBALMAININTENSITYEFFECTAUTOREVERT__CTOR_OFFSET UNITYSDK_OFFSET(0x189975B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GlobalMainIntensityEffectAutoRevert_TypeDefinitionIndex = 21386;
