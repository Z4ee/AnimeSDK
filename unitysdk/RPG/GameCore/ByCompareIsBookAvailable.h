...
#define RPG_GAMECORE_BYCOMPAREISBOOKAVAILABLE_METHOD_4_A93E3B04E85C3E99_OFFSET UNITYSDK_OFFSET(0x187307F0)
#define RPG_GAMECORE_BYCOMPAREISBOOKAVAILABLE_METHOD_4_D6AFE0802CB586FF_OFFSET UNITYSDK_OFFSET(0x18730720)
#define RPG_GAMECORE_BYCOMPAREISBOOKAVAILABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x187307A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareIsBookAvailable_TypeDefinitionIndex = 19869;
