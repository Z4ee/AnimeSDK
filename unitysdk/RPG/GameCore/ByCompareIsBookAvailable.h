...
#define RPG_GAMECORE_BYCOMPAREISBOOKAVAILABLE_METHOD_4_A7377757C6E3A954_OFFSET UNITYSDK_OFFSET(0x1C324DB0)
#define RPG_GAMECORE_BYCOMPAREISBOOKAVAILABLE_METHOD_4_A93E3B04E85C3E99_OFFSET UNITYSDK_OFFSET(0x1C324C00)
#define RPG_GAMECORE_BYCOMPAREISBOOKAVAILABLE_METHOD_4_AC1D1A5D024730FB_OFFSET UNITYSDK_OFFSET(0x1C324DE0)
#define RPG_GAMECORE_BYCOMPAREISBOOKAVAILABLE_METHOD_4_E909527645E4B6EC_OFFSET UNITYSDK_OFFSET(0x1C324BC0)
#define RPG_GAMECORE_BYCOMPAREISBOOKAVAILABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C324BF0)
