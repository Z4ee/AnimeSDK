...
#define RPG_GAMECORE_BYCOMPAREISBOOKAVAILABLE_METHOD_4_A7377757C6E3A954_OFFSET UNITYSDK_OFFSET(0x19CED0A0)
#define RPG_GAMECORE_BYCOMPAREISBOOKAVAILABLE_METHOD_4_A93E3B04E85C3E99_OFFSET UNITYSDK_OFFSET(0x19CECEF0)
#define RPG_GAMECORE_BYCOMPAREISBOOKAVAILABLE_METHOD_4_AC1D1A5D024730FB_OFFSET UNITYSDK_OFFSET(0x19CED0D0)
#define RPG_GAMECORE_BYCOMPAREISBOOKAVAILABLE_METHOD_4_E909527645E4B6EC_OFFSET UNITYSDK_OFFSET(0x19CECEB0)
#define RPG_GAMECORE_BYCOMPAREISBOOKAVAILABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x19CECEE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareIsBookAvailable_TypeDefinitionIndex = 20097;
