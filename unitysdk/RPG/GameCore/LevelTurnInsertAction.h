...
#define RPG_GAMECORE_LEVELTURNINSERTACTION_CLEAR_OFFSET UNITYSDK_OFFSET(0xB6E0DF0)
#define RPG_GAMECORE_LEVELTURNINSERTACTION_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xB6E0E40)
#define RPG_GAMECORE_LEVELTURNINSERTACTION_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xB6E0E90)
#define RPG_GAMECORE_LEVELTURNINSERTACTION_GET_INSERTACTIONENTITY_OFFSET UNITYSDK_OFFSET(0xB6E0EE0)
#define RPG_GAMECORE_LEVELTURNINSERTACTION_INIT_OFFSET UNITYSDK_OFFSET(0xB6E0DA0)
#define RPG_GAMECORE_LEVELTURNINSERTACTION_SET_INSERTACTIONENTITY_OFFSET UNITYSDK_OFFSET(0xB6E0EF0)
#define RPG_GAMECORE_LEVELTURNINSERTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xB6E0F00)
#define RPG_GAMECORE_LEVELTURNINSERTACTION___IFIXBASEPROXY_CLEAR_OFFSET UNITYSDK_OFFSET(0xB6E0F10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelTurnInsertAction_TypeDefinitionIndex = 52260;
