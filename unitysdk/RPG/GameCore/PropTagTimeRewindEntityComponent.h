...
#define RPG_GAMECORE_PROPTAGTIMEREWINDENTITYCOMPONENT_METHOD_3_5C92603549AF3E1E_OFFSET UNITYSDK_OFFSET(0x1B9A6270)
#define RPG_GAMECORE_PROPTAGTIMEREWINDENTITYCOMPONENT_METHOD_3_99012EB67144EAD7_OFFSET UNITYSDK_OFFSET(0x1B9A5610)
#define RPG_GAMECORE_PROPTAGTIMEREWINDENTITYCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9A55F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropTagTimeRewindEntityComponent_TypeDefinitionIndex = 16853;
