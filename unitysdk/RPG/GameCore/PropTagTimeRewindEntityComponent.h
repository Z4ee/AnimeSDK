...
#define RPG_GAMECORE_PROPTAGTIMEREWINDENTITYCOMPONENT_METHOD_3_5EE60B662B35405C_OFFSET UNITYSDK_OFFSET(0x17570C60)
#define RPG_GAMECORE_PROPTAGTIMEREWINDENTITYCOMPONENT_METHOD_3_B2A1B9FC0808C4E9_OFFSET UNITYSDK_OFFSET(0x175718A0)
#define RPG_GAMECORE_PROPTAGTIMEREWINDENTITYCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x17570C40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropTagTimeRewindEntityComponent_TypeDefinitionIndex = 16131;
