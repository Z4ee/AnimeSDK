...
#define RPG_GAMECORE_REFRESHFRAMECAPTURE_METHOD_3_58BB2280F9BC14CE_OFFSET UNITYSDK_OFFSET(0x18C95150)
#define RPG_GAMECORE_REFRESHFRAMECAPTURE_METHOD_3_79C2B7826BC8D1B8_OFFSET UNITYSDK_OFFSET(0x18C950D0)
#define RPG_GAMECORE_REFRESHFRAMECAPTURE__CTOR_OFFSET UNITYSDK_OFFSET(0x18C95120)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RefreshFrameCapture_TypeDefinitionIndex = 19215;
