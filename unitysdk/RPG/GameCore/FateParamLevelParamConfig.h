...
#define RPG_GAMECORE_FATEPARAMLEVELPARAMCONFIG_METHOD_6_628D6FEC4D6B8BA7_OFFSET UNITYSDK_OFFSET(0x1E0CEB80)
#define RPG_GAMECORE_FATEPARAMLEVELPARAMCONFIG_METHOD_6_C802333997D04D27_OFFSET UNITYSDK_OFFSET(0x1E0CEBE0)
#define RPG_GAMECORE_FATEPARAMLEVELPARAMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0CEBD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateParamLevelParamConfig_TypeDefinitionIndex = 16463;
