...
#define RPG_GAMECORE_FATEPARAMLEVELPARAMCONFIG_METHOD_6_3029D3126E0BBE97_OFFSET UNITYSDK_OFFSET(0x188D8120)
#define RPG_GAMECORE_FATEPARAMLEVELPARAMCONFIG_METHOD_6_C802333997D04D27_OFFSET UNITYSDK_OFFSET(0x188D8310)
#define RPG_GAMECORE_FATEPARAMLEVELPARAMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x188D8250)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateParamLevelParamConfig_TypeDefinitionIndex = 15758;
