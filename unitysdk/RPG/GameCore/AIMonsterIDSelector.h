...
#define RPG_GAMECORE_AIMONSTERIDSELECTOR_METHOD_3_C6EC776F7EB711CE_OFFSET UNITYSDK_OFFSET(0x16E911C0)
#define RPG_GAMECORE_AIMONSTERIDSELECTOR_METHOD_3_FAEC61F59F5AC87D_OFFSET UNITYSDK_OFFSET(0x16E91200)
#define RPG_GAMECORE_AIMONSTERIDSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x16E911F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AIMonsterIDSelector_TypeDefinitionIndex = 14298;
