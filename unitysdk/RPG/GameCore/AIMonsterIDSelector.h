...
#define RPG_GAMECORE_AIMONSTERIDSELECTOR_METHOD_3_9A2921A8FEE9CC7F_OFFSET UNITYSDK_OFFSET(0x1B9F5290)
#define RPG_GAMECORE_AIMONSTERIDSELECTOR_METHOD_3_D8F18BACA0E8F988_OFFSET UNITYSDK_OFFSET(0x1B9F5250)
#define RPG_GAMECORE_AIMONSTERIDSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9F5280)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AIMonsterIDSelector_TypeDefinitionIndex = 14994;
