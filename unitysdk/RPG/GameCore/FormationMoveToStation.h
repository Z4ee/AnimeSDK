...
#define RPG_GAMECORE_FORMATIONMOVETOSTATION_METHOD_3_D95EEE923115B0B5_OFFSET UNITYSDK_OFFSET(0x1BEC1770)
#define RPG_GAMECORE_FORMATIONMOVETOSTATION_METHOD_3_EC2A7A2AEF910820_OFFSET UNITYSDK_OFFSET(0x1BEC1730)
#define RPG_GAMECORE_FORMATIONMOVETOSTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEC1760)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FormationMoveToStation_TypeDefinitionIndex = 20463;
