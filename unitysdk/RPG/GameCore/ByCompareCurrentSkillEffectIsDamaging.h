...
#define RPG_GAMECORE_BYCOMPARECURRENTSKILLEFFECTISDAMAGING_METHOD_4_0D828D086C30A04D_OFFSET UNITYSDK_OFFSET(0x1C3123F0)
#define RPG_GAMECORE_BYCOMPARECURRENTSKILLEFFECTISDAMAGING_METHOD_4_AF8EF674A47C315A_OFFSET UNITYSDK_OFFSET(0x1C312420)
#define RPG_GAMECORE_BYCOMPARECURRENTSKILLEFFECTISDAMAGING_METHOD_4_E3F97BB610373EB6_OFFSET UNITYSDK_OFFSET(0x1C312210)
#define RPG_GAMECORE_BYCOMPARECURRENTSKILLEFFECTISDAMAGING_METHOD_4_FF4ED96495684D57_OFFSET UNITYSDK_OFFSET(0x1C312250)
#define RPG_GAMECORE_BYCOMPARECURRENTSKILLEFFECTISDAMAGING__CTOR_OFFSET UNITYSDK_OFFSET(0x1C312240)
