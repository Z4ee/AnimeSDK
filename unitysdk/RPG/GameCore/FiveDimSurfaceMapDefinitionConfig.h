...
#define RPG_GAMECORE_FIVEDIMSURFACEMAPDEFINITIONCONFIG_METHOD_2_08362A704FEF23B6_OFFSET UNITYSDK_OFFSET(0x1BEB6D20)
#define RPG_GAMECORE_FIVEDIMSURFACEMAPDEFINITIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEB6D60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSurfaceMapDefinitionConfig_TypeDefinitionIndex = 17787;
