...
#define RPG_GAMECORE_ANIMTRIGGERRANDOMPLAY_METHOD_3_19C96B0FD48843F2_OFFSET UNITYSDK_OFFSET(0x186A4E50)
#define RPG_GAMECORE_ANIMTRIGGERRANDOMPLAY_METHOD_3_976247451ABAB8A5_OFFSET UNITYSDK_OFFSET(0x186A4DD0)
#define RPG_GAMECORE_ANIMTRIGGERRANDOMPLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x186A4E20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AnimTriggerRandomPlay_TypeDefinitionIndex = 21283;
