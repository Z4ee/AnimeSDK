...
#define RPG_GAMECORE_FOURROTATEVOXELSETENTITYTRIGGERENABLEACTION_METHOD_3_B65D94D9FB82D32E_OFFSET UNITYSDK_OFFSET(0x1721E3E0)
#define RPG_GAMECORE_FOURROTATEVOXELSETENTITYTRIGGERENABLEACTION_METHOD_3_FE287E04D60BB962_OFFSET UNITYSDK_OFFSET(0x1721E2B0)
#define RPG_GAMECORE_FOURROTATEVOXELSETENTITYTRIGGERENABLEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1721E3C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FourRotateVoxelSetEntityTriggerEnableAction_TypeDefinitionIndex = 15362;
