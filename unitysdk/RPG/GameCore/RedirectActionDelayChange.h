...
#define RPG_GAMECORE_REDIRECTACTIONDELAYCHANGE_METHOD_3_1E8B998B50C222F3_OFFSET UNITYSDK_OFFSET(0x17588410)
#define RPG_GAMECORE_REDIRECTACTIONDELAYCHANGE_METHOD_3_23CFBEA35DC688E0_OFFSET UNITYSDK_OFFSET(0x17588390)
#define RPG_GAMECORE_REDIRECTACTIONDELAYCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x175883E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RedirectActionDelayChange_TypeDefinitionIndex = 21509;
