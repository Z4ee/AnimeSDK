...
#define RPG_GAMECORE_REDIRECTACTIONDELAYCHANGE_METHOD_3_1E8B998B50C222F3_OFFSET UNITYSDK_OFFSET(0x18C943D0)
#define RPG_GAMECORE_REDIRECTACTIONDELAYCHANGE_METHOD_3_23CFBEA35DC688E0_OFFSET UNITYSDK_OFFSET(0x18C94350)
#define RPG_GAMECORE_REDIRECTACTIONDELAYCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x18C943A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RedirectActionDelayChange_TypeDefinitionIndex = 22245;
