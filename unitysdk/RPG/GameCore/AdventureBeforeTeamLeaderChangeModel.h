...
#define RPG_GAMECORE_ADVENTUREBEFORETEAMLEADERCHANGEMODEL_CLEAR_OFFSET UNITYSDK_OFFSET(0x11262A10)
#define RPG_GAMECORE_ADVENTUREBEFORETEAMLEADERCHANGEMODEL_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x11262A50)
#define RPG_GAMECORE_ADVENTUREBEFORETEAMLEADERCHANGEMODEL_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x11262AA0)
#define RPG_GAMECORE_ADVENTUREBEFORETEAMLEADERCHANGEMODEL_INIT_OFFSET UNITYSDK_OFFSET(0x112629D0)
#define RPG_GAMECORE_ADVENTUREBEFORETEAMLEADERCHANGEMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x11262AF0)
