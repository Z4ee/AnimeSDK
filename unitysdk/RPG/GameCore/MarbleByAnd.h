...
#define RPG_GAMECORE_MARBLEBYAND_METHOD_4_95572CD41CDE573A_OFFSET UNITYSDK_OFFSET(0x1BD13970)
#define RPG_GAMECORE_MARBLEBYAND_METHOD_4_B7490C64B26BD600_OFFSET UNITYSDK_OFFSET(0x1BD13910)
#define RPG_GAMECORE_MARBLEBYAND__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD13960)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleByAnd_TypeDefinitionIndex = 16201;
