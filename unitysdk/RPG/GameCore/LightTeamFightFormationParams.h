...
#define RPG_GAMECORE_LIGHTTEAMFIGHTFORMATIONPARAMS_METHOD_2_55837DDA0AC506F9_OFFSET UNITYSDK_OFFSET(0x1734D790)
#define RPG_GAMECORE_LIGHTTEAMFIGHTFORMATIONPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x1734DBD0)
