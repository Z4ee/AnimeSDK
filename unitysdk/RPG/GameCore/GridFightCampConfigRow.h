...
#define RPG_GAMECORE_GRIDFIGHTCAMPCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x189A3970)
#define RPG_GAMECORE_GRIDFIGHTCAMPCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x189A3DC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightCampConfigRow_TypeDefinitionIndex = 12896;
	...
	public:
		...
		::System::UInt32 IfRandomEnabled; // 0x30
		::System::UInt32 ID; // 0x34
		::System::UInt32 SeasonID; // 0x38
		::System::UInt32 InitialRandomCode; // 0x3C
		::RPG::Client::TextID CampDesc; // 0x40
		::RPG::Client::TextID CampName; // 0x50
		::System::UInt32 BossBattleArea; // 0x60
