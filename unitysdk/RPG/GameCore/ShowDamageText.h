...
#define RPG_GAMECORE_SHOWDAMAGETEXT_METHOD_3_4E6208DFEB83981B_OFFSET UNITYSDK_OFFSET(0x19C77D60)
#define RPG_GAMECORE_SHOWDAMAGETEXT_METHOD_3_C4EA692CD5193770_OFFSET UNITYSDK_OFFSET(0x19C77CE0)
#define RPG_GAMECORE_SHOWDAMAGETEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x19C77D30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowDamageText_TypeDefinitionIndex = 22276;
