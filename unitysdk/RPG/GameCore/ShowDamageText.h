...
#define RPG_GAMECORE_SHOWDAMAGETEXT_METHOD_3_4E6208DFEB83981B_OFFSET UNITYSDK_OFFSET(0x18E5BB90)
#define RPG_GAMECORE_SHOWDAMAGETEXT_METHOD_3_C4EA692CD5193770_OFFSET UNITYSDK_OFFSET(0x18E5BB10)
#define RPG_GAMECORE_SHOWDAMAGETEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x18E5BB60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowDamageText_TypeDefinitionIndex = 22536;
