...
#define RPG_GAMECORE_SHOWDAMAGETEXT_METHOD_3_130CD96176A5B2F6_OFFSET UNITYSDK_OFFSET(0x1BE3C940)
#define RPG_GAMECORE_SHOWDAMAGETEXT_METHOD_3_4E6208DFEB83981B_OFFSET UNITYSDK_OFFSET(0x1BE3C980)
#define RPG_GAMECORE_SHOWDAMAGETEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE3C970)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowDamageText_TypeDefinitionIndex = 22717;
