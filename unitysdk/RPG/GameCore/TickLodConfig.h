...
#define RPG_GAMECORE_TICKLODCONFIG_METHOD_3_4539F88016B3E011_OFFSET UNITYSDK_OFFSET(0x19098070)
#define RPG_GAMECORE_TICKLODCONFIG_METHOD_3_9C200645AE464E44_OFFSET UNITYSDK_OFFSET(0x190980B0)
#define RPG_GAMECORE_TICKLODCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x190980A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TickLodConfig_TypeDefinitionIndex = 18242;
