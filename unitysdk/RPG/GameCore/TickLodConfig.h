...
#define RPG_GAMECORE_TICKLODCONFIG_METHOD_3_9B9EBB86D7E13330_OFFSET UNITYSDK_OFFSET(0x1C14FA80)
#define RPG_GAMECORE_TICKLODCONFIG_METHOD_3_CB78FA788E6E9A7D_OFFSET UNITYSDK_OFFSET(0x1C14FA40)
#define RPG_GAMECORE_TICKLODCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C14FA70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TickLodConfig_TypeDefinitionIndex = 18450;
