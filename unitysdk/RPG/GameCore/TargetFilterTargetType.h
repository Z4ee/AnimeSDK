...
#define RPG_GAMECORE_TARGETFILTERTARGETTYPE_METHOD_3_BC71E2910CD61BB5_OFFSET UNITYSDK_OFFSET(0x18EE6830)
#define RPG_GAMECORE_TARGETFILTERTARGETTYPE_METHOD_3_D9C196BAAFA25E8A_OFFSET UNITYSDK_OFFSET(0x18EE6700)
#define RPG_GAMECORE_TARGETFILTERTARGETTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x18EE6810)
