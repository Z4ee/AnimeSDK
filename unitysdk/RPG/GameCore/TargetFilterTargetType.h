...
#define RPG_GAMECORE_TARGETFILTERTARGETTYPE_METHOD_3_1D6AE1E55B096910_OFFSET UNITYSDK_OFFSET(0x1D0BEA10)
#define RPG_GAMECORE_TARGETFILTERTARGETTYPE_METHOD_3_3C6B48B7F2803188_OFFSET UNITYSDK_OFFSET(0x1D0BE9C0)
#define RPG_GAMECORE_TARGETFILTERTARGETTYPE_METHOD_3_BC71E2910CD61BB5_OFFSET UNITYSDK_OFFSET(0x1D0BE920)
#define RPG_GAMECORE_TARGETFILTERTARGETTYPE_METHOD_3_D196456F770F0121_OFFSET UNITYSDK_OFFSET(0x1D0BE840)
#define RPG_GAMECORE_TARGETFILTERTARGETTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0BE910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFilterTargetType_TypeDefinitionIndex = 23051;
