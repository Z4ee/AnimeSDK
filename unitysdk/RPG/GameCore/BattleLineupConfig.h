...
#define RPG_GAMECORE_BATTLELINEUPCONFIG_METHOD_2_CE3B5EDCD21307FE_OFFSET UNITYSDK_OFFSET(0x16FD9160)
#define RPG_GAMECORE_BATTLELINEUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16FD93A0)
