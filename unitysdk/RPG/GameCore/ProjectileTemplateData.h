...
#define RPG_GAMECORE_PROJECTILETEMPLATEDATA_METHOD_2_993287E990B17A01_OFFSET UNITYSDK_OFFSET(0x18C648A0)
#define RPG_GAMECORE_PROJECTILETEMPLATEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18C64A10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ProjectileTemplateData_TypeDefinitionIndex = 14818;
