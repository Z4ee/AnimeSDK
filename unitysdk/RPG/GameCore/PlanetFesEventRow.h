...
#define RPG_GAMECORE_PLANETFESEVENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D79C890)
#define RPG_GAMECORE_PLANETFESEVENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D79CB10)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::PlanetFesEventType ID; // 0x20
		::System::UInt32 RecurCD; // 0x24
		::System::UInt32 InitialAppearCD; // 0x28
