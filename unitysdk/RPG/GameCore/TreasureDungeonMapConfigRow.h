...
#define RPG_GAMECORE_TREASUREDUNGEONMAPCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19E063F0)
#define RPG_GAMECORE_TREASUREDUNGEONMAPCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19E06530)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TreasureDungeonMapConfigRow_TypeDefinitionIndex = 11919;
