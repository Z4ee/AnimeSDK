...
#define RPG_GAMECORE_ROGUEADVROOMCANDYCRASHGAMEPROCESS_METHOD_3_7847EC16FC62ECB8_OFFSET UNITYSDK_OFFSET(0x18CE6540)
#define RPG_GAMECORE_ROGUEADVROOMCANDYCRASHGAMEPROCESS_METHOD_3_EE21DE1223E8B42C_OFFSET UNITYSDK_OFFSET(0x18CE6430)
#define RPG_GAMECORE_ROGUEADVROOMCANDYCRASHGAMEPROCESS__CTOR_OFFSET UNITYSDK_OFFSET(0x18CE6510)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueAdvRoomCandyCrashGameProcess_TypeDefinitionIndex = 21159;
