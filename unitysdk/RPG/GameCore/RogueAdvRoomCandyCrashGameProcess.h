...
#define RPG_GAMECORE_ROGUEADVROOMCANDYCRASHGAMEPROCESS_METHOD_3_7847EC16FC62ECB8_OFFSET UNITYSDK_OFFSET(0x175DB590)
#define RPG_GAMECORE_ROGUEADVROOMCANDYCRASHGAMEPROCESS_METHOD_3_EE21DE1223E8B42C_OFFSET UNITYSDK_OFFSET(0x175DB480)
#define RPG_GAMECORE_ROGUEADVROOMCANDYCRASHGAMEPROCESS__CTOR_OFFSET UNITYSDK_OFFSET(0x175DB560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueAdvRoomCandyCrashGameProcess_TypeDefinitionIndex = 20477;
