...
#define RPG_GAMECORE_CAKERACEHITCONFIG_METHOD_2_E1C604084502715A_OFFSET UNITYSDK_OFFSET(0x1B2D23A0)
#define RPG_GAMECORE_CAKERACEHITCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2D24F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceHitConfig_TypeDefinitionIndex = 17669;
