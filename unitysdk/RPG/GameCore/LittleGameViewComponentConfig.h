...
#define RPG_GAMECORE_LITTLEGAMEVIEWCOMPONENTCONFIG_METHOD_3_272CEDFB04ED3720_OFFSET UNITYSDK_OFFSET(0x18A6F060)
#define RPG_GAMECORE_LITTLEGAMEVIEWCOMPONENTCONFIG_METHOD_3_295A0DD05A6799C6_OFFSET UNITYSDK_OFFSET(0x18A696A0)
#define RPG_GAMECORE_LITTLEGAMEVIEWCOMPONENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18A69680)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameViewComponentConfig_TypeDefinitionIndex = 17903;
