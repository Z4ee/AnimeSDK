...
#define RPG_GAMECORE_LITTLEGAMEVIEWCOMPONENTCONFIG_METHOD_3_295A0DD05A6799C6_OFFSET UNITYSDK_OFFSET(0x1BCC5DE0)
#define RPG_GAMECORE_LITTLEGAMEVIEWCOMPONENTCONFIG_METHOD_3_B25D4C4BE07187BD_OFFSET UNITYSDK_OFFSET(0x1BCC5C70)
#define RPG_GAMECORE_LITTLEGAMEVIEWCOMPONENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCC5DD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameViewComponentConfig_TypeDefinitionIndex = 18109;
