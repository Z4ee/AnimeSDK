...
#define RPG_GAMECORE_TRIGGERLOOPSCENE_METHOD_3_6FEA6A8D8BE40FBC_OFFSET UNITYSDK_OFFSET(0x178C8FE0)
#define RPG_GAMECORE_TRIGGERLOOPSCENE_METHOD_3_775B1E44111A89B7_OFFSET UNITYSDK_OFFSET(0x178C8F20)
#define RPG_GAMECORE_TRIGGERLOOPSCENE__CTOR_OFFSET UNITYSDK_OFFSET(0x178C8F90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerLoopScene_TypeDefinitionIndex = 18727;
