...
#define RPG_GAMECORE_QATESTDATACONFIG_METHOD_2_90252C39559F4D0D_OFFSET UNITYSDK_OFFSET(0x17575110)
#define RPG_GAMECORE_QATESTDATACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17575210)
