...
#define RPG_GAMECORE_BATTLESTAGECONFIG_METHOD_2_E47ED9A0CE93B675_OFFSET UNITYSDK_OFFSET(0x16FE1C20)
#define RPG_GAMECORE_BATTLESTAGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16FE1DA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattleStageConfig_TypeDefinitionIndex = 15011;
