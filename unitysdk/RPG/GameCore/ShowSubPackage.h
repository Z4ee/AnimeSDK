...
#define RPG_GAMECORE_SHOWSUBPACKAGE_METHOD_3_5795FDAE3D7D6A60_OFFSET UNITYSDK_OFFSET(0x18E681C0)
#define RPG_GAMECORE_SHOWSUBPACKAGE_METHOD_3_B29674835E98906C_OFFSET UNITYSDK_OFFSET(0x18E682D0)
#define RPG_GAMECORE_SHOWSUBPACKAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E682A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowSubPackage_TypeDefinitionIndex = 20555;
