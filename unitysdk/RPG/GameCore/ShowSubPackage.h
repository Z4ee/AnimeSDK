...
#define RPG_GAMECORE_SHOWSUBPACKAGE_METHOD_3_80C14D1DD0884A29_OFFSET UNITYSDK_OFFSET(0x1BE47980)
#define RPG_GAMECORE_SHOWSUBPACKAGE_METHOD_3_B29674835E98906C_OFFSET UNITYSDK_OFFSET(0x1BE47A50)
#define RPG_GAMECORE_SHOWSUBPACKAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE47A40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowSubPackage_TypeDefinitionIndex = 20905;
