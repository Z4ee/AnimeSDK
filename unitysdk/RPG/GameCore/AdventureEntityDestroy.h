...
#define RPG_GAMECORE_ADVENTUREENTITYDESTROY_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xE4DF310)
#define RPG_GAMECORE_ADVENTUREENTITYDESTROY_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xE4DF360)
#define RPG_GAMECORE_ADVENTUREENTITYDESTROY_GET_ENTITYID_OFFSET UNITYSDK_OFFSET(0xE4DF3A0)
#define RPG_GAMECORE_ADVENTUREENTITYDESTROY_INIT_OFFSET UNITYSDK_OFFSET(0xE4DF2C0)
#define RPG_GAMECORE_ADVENTUREENTITYDESTROY_SET_ENTITYID_OFFSET UNITYSDK_OFFSET(0xE4DF3B0)
#define RPG_GAMECORE_ADVENTUREENTITYDESTROY__CTOR_OFFSET UNITYSDK_OFFSET(0xE4DF3C0)
