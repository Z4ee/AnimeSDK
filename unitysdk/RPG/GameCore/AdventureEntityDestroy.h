...
#define RPG_GAMECORE_ADVENTUREENTITYDESTROY_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xCCE4100)
#define RPG_GAMECORE_ADVENTUREENTITYDESTROY_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xCCE4150)
#define RPG_GAMECORE_ADVENTUREENTITYDESTROY_GET_ENTITYID_OFFSET UNITYSDK_OFFSET(0xCCE4190)
#define RPG_GAMECORE_ADVENTUREENTITYDESTROY_INIT_OFFSET UNITYSDK_OFFSET(0xCCE40B0)
#define RPG_GAMECORE_ADVENTUREENTITYDESTROY_SET_ENTITYID_OFFSET UNITYSDK_OFFSET(0xCCE41A0)
#define RPG_GAMECORE_ADVENTUREENTITYDESTROY__CTOR_OFFSET UNITYSDK_OFFSET(0xCCE41B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureEntityDestroy_TypeDefinitionIndex = 52850;
