...
#define RPG_GAMECORE_SETUPROTATABLEREGIONAIRLOCK_METHOD_3_9AFA6C38688F4A27_OFFSET UNITYSDK_OFFSET(0x1D519AA0)
#define RPG_GAMECORE_SETUPROTATABLEREGIONAIRLOCK_METHOD_3_E5A8D2832A0F27D6_OFFSET UNITYSDK_OFFSET(0x1D519A60)
#define RPG_GAMECORE_SETUPROTATABLEREGIONAIRLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D519A90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetupRotatableRegionAirlock_TypeDefinitionIndex = 21004;
