...
#define RPG_GAMECORE_SETISOMETRICROADLINKERENABLE_METHOD_3_353126AB50C268EA_OFFSET UNITYSDK_OFFSET(0x176D2760)
#define RPG_GAMECORE_SETISOMETRICROADLINKERENABLE_METHOD_3_C89AC4E5FA033109_OFFSET UNITYSDK_OFFSET(0x176D28B0)
#define RPG_GAMECORE_SETISOMETRICROADLINKERENABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x176D2820)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetIsometricRoadLinkerEnable_TypeDefinitionIndex = 20394;
