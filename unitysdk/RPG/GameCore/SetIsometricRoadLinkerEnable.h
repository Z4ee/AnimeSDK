...
#define RPG_GAMECORE_SETISOMETRICROADLINKERENABLE_METHOD_3_353126AB50C268EA_OFFSET UNITYSDK_OFFSET(0x18E35CA0)
#define RPG_GAMECORE_SETISOMETRICROADLINKERENABLE_METHOD_3_C89AC4E5FA033109_OFFSET UNITYSDK_OFFSET(0x18E35DF0)
#define RPG_GAMECORE_SETISOMETRICROADLINKERENABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E35D60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetIsometricRoadLinkerEnable_TypeDefinitionIndex = 21076;
