...
#define RPG_GAMECORE_SETISOMETRICROADLINKERENABLE_METHOD_3_89F50D1EC0DCF703_OFFSET UNITYSDK_OFFSET(0x1E083090)
#define RPG_GAMECORE_SETISOMETRICROADLINKERENABLE_METHOD_3_C89AC4E5FA033109_OFFSET UNITYSDK_OFFSET(0x1E083110)
#define RPG_GAMECORE_SETISOMETRICROADLINKERENABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0830E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetIsometricRoadLinkerEnable_TypeDefinitionIndex = 21957;
