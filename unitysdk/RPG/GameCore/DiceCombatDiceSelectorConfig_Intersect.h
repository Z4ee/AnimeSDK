...
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_INTERSECT_METHOD_3_172127CF50F84727_OFFSET UNITYSDK_OFFSET(0x1C10FB50)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_INTERSECT_METHOD_3_F25CB10BADAE7905_OFFSET UNITYSDK_OFFSET(0x1C10ED70)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_INTERSECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C10ED60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatDiceSelectorConfig_Intersect_TypeDefinitionIndex = 15542;
