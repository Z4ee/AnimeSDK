...
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_INTERSECT_METHOD_3_172127CF50F84727_OFFSET UNITYSDK_OFFSET(0x17160270)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_INTERSECT_METHOD_3_F25CB10BADAE7905_OFFSET UNITYSDK_OFFSET(0x1715F660)
#define RPG_GAMECORE_DICECOMBATDICESELECTORCONFIG_INTERSECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1715F650)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatDiceSelectorConfig_Intersect_TypeDefinitionIndex = 14831;
