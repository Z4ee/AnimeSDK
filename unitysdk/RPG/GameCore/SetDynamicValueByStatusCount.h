...
#define RPG_GAMECORE_SETDYNAMICVALUEBYSTATUSCOUNT_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1E823AA0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSTATUSCOUNT_METHOD_4_717DBA7C9F56F115_OFFSET UNITYSDK_OFFSET(0x1E823870)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSTATUSCOUNT_METHOD_4_90A346ACC2DF5514_OFFSET UNITYSDK_OFFSET(0x1E823820)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSTATUSCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E823860)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByStatusCount_TypeDefinitionIndex = 22829;
