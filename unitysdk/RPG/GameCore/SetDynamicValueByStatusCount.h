...
#define RPG_GAMECORE_SETDYNAMICVALUEBYSTATUSCOUNT_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x18E28B50)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSTATUSCOUNT_METHOD_4_717DBA7C9F56F115_OFFSET UNITYSDK_OFFSET(0x18E28920)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSTATUSCOUNT_METHOD_4_A8128B3A370A15BE_OFFSET UNITYSDK_OFFSET(0x18E28840)
#define RPG_GAMECORE_SETDYNAMICVALUEBYSTATUSCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x18E288C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByStatusCount_TypeDefinitionIndex = 22023;
