...
#define RPG_GAMECORE_MARBLEABSORBTEAMMATES_METHOD_3_621E7F345FCA6372_OFFSET UNITYSDK_OFFSET(0x17386DF0)
#define RPG_GAMECORE_MARBLEABSORBTEAMMATES_METHOD_3_9F6CBEAF3F855286_OFFSET UNITYSDK_OFFSET(0x17386D10)
#define RPG_GAMECORE_MARBLEABSORBTEAMMATES__CTOR_OFFSET UNITYSDK_OFFSET(0x17386DA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleAbsorbTeammates_TypeDefinitionIndex = 15425;
