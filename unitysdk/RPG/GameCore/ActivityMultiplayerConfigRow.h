...
#define RPG_GAMECORE_ACTIVITYMULTIPLAYERCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CA0D080)
#define RPG_GAMECORE_ACTIVITYMULTIPLAYERCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CA0D820)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityMultiplayerConfigRow_TypeDefinitionIndex = 11205;

	class ActivityMultiplayerConfigRow : public ::System::Object
	{
	public:
		::System::String* CardImgPath; // 0x10
		::System::String* CardColor; // 0x18
		::Il2CppArray<::RPG::GameCore::ConditionParam*>* CompleteCondition; // 0x20
		...
		::System::UInt32 GuideVideoID; // 0x3C
