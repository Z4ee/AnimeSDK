...
#define RPG_GAMECORE_ACTIVITYMULTIPLAYERCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CD97480)
#define RPG_GAMECORE_ACTIVITYMULTIPLAYERCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD97C20)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 CurrentModuleID; // 0x28
		::System::UInt32 DisplayModuleID; // 0x2C
