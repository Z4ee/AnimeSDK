...
#define RPG_GAMECORE_SKILLRANGECONFIG_METHOD_2_18AA0045BCF85DFE_OFFSET UNITYSDK_OFFSET(0x1D0A5A20)
#define RPG_GAMECORE_SKILLRANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0A5B50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SkillRangeConfig_TypeDefinitionIndex = 17311;
