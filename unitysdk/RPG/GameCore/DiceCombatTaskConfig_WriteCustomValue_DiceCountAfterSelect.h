...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_WRITECUSTOMVALUE_DICECOUNTAFTERSELECT_METHOD_3_5C376F6B3FAA3170_OFFSET UNITYSDK_OFFSET(0x1887A9D0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_WRITECUSTOMVALUE_DICECOUNTAFTERSELECT_METHOD_3_5FAB01F8AE4C75E7_OFFSET UNITYSDK_OFFSET(0x1887DB20)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_WRITECUSTOMVALUE_DICECOUNTAFTERSELECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1887A980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_WriteCustomValue_DiceCountAfterSelect_TypeDefinitionIndex = 15244;
	...
	public:
		...
		static ::System::Void Method_3_5FAB01F8AE4C75E7(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::DiceCombatTaskConfig_WriteCustomValue_DiceCountAfterSelect*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::DiceCombatTaskConfig_WriteCustomValue_DiceCountAfterSelect*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_DICECOMBATTASKCONFIG_WRITECUSTOMVALUE_DICECOUNTAFTERSELECT_METHOD_3_5FAB01F8AE4C75E7_OFFSET))(a1, a2);
		}
