...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_WRITECUSTOMVALUE_DICECOUNTAFTERSELECT_METHOD_3_5C376F6B3FAA3170_OFFSET UNITYSDK_OFFSET(0x1C11B8C0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_WRITECUSTOMVALUE_DICECOUNTAFTERSELECT_METHOD_3_CD178A3C084A8EA6_OFFSET UNITYSDK_OFFSET(0x1C11B860)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_WRITECUSTOMVALUE_DICECOUNTAFTERSELECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C11B8B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_WriteCustomValue_DiceCountAfterSelect_TypeDefinitionIndex = 15467;
