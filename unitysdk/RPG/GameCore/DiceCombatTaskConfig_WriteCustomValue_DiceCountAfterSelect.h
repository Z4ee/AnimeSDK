...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_WRITECUSTOMVALUE_DICECOUNTAFTERSELECT_METHOD_3_5C376F6B3FAA3170_OFFSET UNITYSDK_OFFSET(0x196B6DD0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_WRITECUSTOMVALUE_DICECOUNTAFTERSELECT_METHOD_3_5FAB01F8AE4C75E7_OFFSET UNITYSDK_OFFSET(0x196BA970)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_WRITECUSTOMVALUE_DICECOUNTAFTERSELECT__CTOR_OFFSET UNITYSDK_OFFSET(0x196B6D80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_WriteCustomValue_DiceCountAfterSelect_TypeDefinitionIndex = 15303;
