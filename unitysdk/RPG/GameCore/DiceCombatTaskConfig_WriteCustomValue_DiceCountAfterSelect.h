...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_WRITECUSTOMVALUE_DICECOUNTAFTERSELECT_METHOD_3_5C376F6B3FAA3170_OFFSET UNITYSDK_OFFSET(0x1D038620)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_WRITECUSTOMVALUE_DICECOUNTAFTERSELECT_METHOD_3_CD178A3C084A8EA6_OFFSET UNITYSDK_OFFSET(0x1D0385C0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_WRITECUSTOMVALUE_DICECOUNTAFTERSELECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D038610)
