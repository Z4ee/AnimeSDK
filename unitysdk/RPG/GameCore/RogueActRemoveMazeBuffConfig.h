...
#define RPG_GAMECORE_ROGUEACTREMOVEMAZEBUFFCONFIG_METHOD_6_3F3B83CB0093419E_OFFSET UNITYSDK_OFFSET(0x175C5A90)
#define RPG_GAMECORE_ROGUEACTREMOVEMAZEBUFFCONFIG_METHOD_6_8793B30374955A1B_OFFSET UNITYSDK_OFFSET(0x175C5870)
#define RPG_GAMECORE_ROGUEACTREMOVEMAZEBUFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175C59B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActRemoveMazeBuffConfig_TypeDefinitionIndex = 17984;
