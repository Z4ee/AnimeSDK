...
#define RPG_GAMECORE_TEMPFIXDEVICE_METHOD_2_C5EE0DD73960CA66_OFFSET UNITYSDK_OFFSET(0x1C14AFF0)
#define RPG_GAMECORE_TEMPFIXDEVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C14B0B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TempFixDevice_TypeDefinitionIndex = 17541;
