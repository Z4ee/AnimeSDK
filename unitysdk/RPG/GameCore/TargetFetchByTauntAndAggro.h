...
#define RPG_GAMECORE_TARGETFETCHBYTAUNTANDAGGRO_METHOD_3_68990A283ED17235_OFFSET UNITYSDK_OFFSET(0x177BD740)
#define RPG_GAMECORE_TARGETFETCHBYTAUNTANDAGGRO_METHOD_3_DEF0F6D1A43FE480_OFFSET UNITYSDK_OFFSET(0x177BD6D0)
#define RPG_GAMECORE_TARGETFETCHBYTAUNTANDAGGRO__CTOR_OFFSET UNITYSDK_OFFSET(0x177BD720)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchByTauntAndAggro_TypeDefinitionIndex = 22246;
