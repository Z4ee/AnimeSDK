...
#define RPG_GAMECORE_COMPLEXSKILLAIMAPPER_METHOD_2_593DECD717905B51_OFFSET UNITYSDK_OFFSET(0x1882A850)
#define RPG_GAMECORE_COMPLEXSKILLAIMAPPER_METHOD_2_76A425D81263FF4C_OFFSET UNITYSDK_OFFSET(0x18829330)
#define RPG_GAMECORE_COMPLEXSKILLAIMAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1882A8B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAIMapper_TypeDefinitionIndex = 14720;
