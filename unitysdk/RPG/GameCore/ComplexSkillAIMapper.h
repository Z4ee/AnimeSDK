...
#define RPG_GAMECORE_COMPLEXSKILLAIMAPPER_METHOD_2_20B55D848AFD9974_OFFSET UNITYSDK_OFFSET(0x1966A030)
#define RPG_GAMECORE_COMPLEXSKILLAIMAPPER_METHOD_2_593DECD717905B51_OFFSET UNITYSDK_OFFSET(0x1966B520)
#define RPG_GAMECORE_COMPLEXSKILLAIMAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1966B580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAIMapper_TypeDefinitionIndex = 14785;
