...
#define RPG_GAMECORE_COMPLEXSKILLAIMAPPER_METHOD_2_20B55D848AFD9974_OFFSET UNITYSDK_OFFSET(0x1BC245B0)
#define RPG_GAMECORE_COMPLEXSKILLAIMAPPER_METHOD_2_593DECD717905B51_OFFSET UNITYSDK_OFFSET(0x1BC25A40)
#define RPG_GAMECORE_COMPLEXSKILLAIMAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC25AA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAIMapper_TypeDefinitionIndex = 14947;
