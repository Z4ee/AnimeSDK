...
#define RPG_GAMECORE_GRIDFIGHTSHOWTRAITEFFECT_METHOD_3_3345C242E6A216E4_OFFSET UNITYSDK_OFFSET(0x1980B250)
#define RPG_GAMECORE_GRIDFIGHTSHOWTRAITEFFECT_METHOD_3_D2D961EADF232050_OFFSET UNITYSDK_OFFSET(0x1980B1D0)
#define RPG_GAMECORE_GRIDFIGHTSHOWTRAITEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1980B220)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightShowTraitEffect_TypeDefinitionIndex = 21970;
	...
	public:
		...
		static ::System::Void Method_3_D2D961EADF232050(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::GridFightShowTraitEffect*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::GridFightShowTraitEffect*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_GRIDFIGHTSHOWTRAITEFFECT_METHOD_3_D2D961EADF232050_OFFSET))(a1, a2);
		}
