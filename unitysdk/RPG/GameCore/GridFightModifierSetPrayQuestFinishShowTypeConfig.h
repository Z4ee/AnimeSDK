...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETPRAYQUESTFINISHSHOWTYPECONFIG_METHOD_3_05B66746295DE3B2_OFFSET UNITYSDK_OFFSET(0x1D06AD40)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETPRAYQUESTFINISHSHOWTYPECONFIG_METHOD_3_0E0E2832A412A7CE_OFFSET UNITYSDK_OFFSET(0x1D06AD90)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETPRAYQUESTFINISHSHOWTYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D06AD80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierSetPrayQuestFinishShowTypeConfig_TypeDefinitionIndex = 18745;
