...
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREQUIPMENTFACTIONTARGETSELECTORCONFIG_METHOD_3_B2BED04BB56484D7_OFFSET UNITYSDK_OFFSET(0x1DD63330)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREQUIPMENTFACTIONTARGETSELECTORCONFIG_METHOD_3_E3D7BDC873F95E97_OFFSET UNITYSDK_OFFSET(0x1DD632D0)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREQUIPMENTFACTIONTARGETSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD63320)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityPixAirEquipmentFactionTargetSelectorConfig_TypeDefinitionIndex = 21130;
