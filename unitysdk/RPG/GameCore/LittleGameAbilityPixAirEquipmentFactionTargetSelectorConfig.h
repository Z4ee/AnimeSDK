...
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREQUIPMENTFACTIONTARGETSELECTORCONFIG_METHOD_3_B2BED04BB56484D7_OFFSET UNITYSDK_OFFSET(0x19894E30)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREQUIPMENTFACTIONTARGETSELECTORCONFIG_METHOD_3_E3D7BDC873F95E97_OFFSET UNITYSDK_OFFSET(0x19894DD0)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREQUIPMENTFACTIONTARGETSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19894E20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityPixAirEquipmentFactionTargetSelectorConfig_TypeDefinitionIndex = 20204;
