...
#define RPG_GAMECORE_FIVEDIMCONDITIONANYOF_METHOD_3_348FD106B7E9B43E_OFFSET UNITYSDK_OFFSET(0x197363B0)
#define RPG_GAMECORE_FIVEDIMCONDITIONANYOF_METHOD_3_44AAB1551AE71665_OFFSET UNITYSDK_OFFSET(0x19733BF0)
#define RPG_GAMECORE_FIVEDIMCONDITIONANYOF__CTOR_OFFSET UNITYSDK_OFFSET(0x19733BE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimConditionAnyOf_TypeDefinitionIndex = 17883;
