...
#define RPG_GAMECORE_FIVEDIMCONDITIONANYOF_METHOD_3_2711921D735A139B_OFFSET UNITYSDK_OFFSET(0x171ECF30)
#define RPG_GAMECORE_FIVEDIMCONDITIONANYOF_METHOD_3_EA885D87F6AD7A50_OFFSET UNITYSDK_OFFSET(0x171EAAD0)
#define RPG_GAMECORE_FIVEDIMCONDITIONANYOF__CTOR_OFFSET UNITYSDK_OFFSET(0x171EAAC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimConditionAnyOf_TypeDefinitionIndex = 17246;
