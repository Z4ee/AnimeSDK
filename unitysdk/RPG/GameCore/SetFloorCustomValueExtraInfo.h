...
#define RPG_GAMECORE_SETFLOORCUSTOMVALUEEXTRAINFO_METHOD_2_8552AABC54F650A7_OFFSET UNITYSDK_OFFSET(0x176CE730)
#define RPG_GAMECORE_SETFLOORCUSTOMVALUEEXTRAINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x176CF430)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetFloorCustomValueExtraInfo_TypeDefinitionIndex = 19007;
