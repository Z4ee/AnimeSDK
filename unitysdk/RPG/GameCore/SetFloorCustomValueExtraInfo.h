...
#define RPG_GAMECORE_SETFLOORCUSTOMVALUEEXTRAINFO_METHOD_2_8552AABC54F650A7_OFFSET UNITYSDK_OFFSET(0x18E31C70)
#define RPG_GAMECORE_SETFLOORCUSTOMVALUEEXTRAINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18E32970)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetFloorCustomValueExtraInfo_TypeDefinitionIndex = 19665;
