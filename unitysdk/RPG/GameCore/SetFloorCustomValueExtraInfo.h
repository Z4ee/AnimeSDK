...
#define RPG_GAMECORE_SETFLOORCUSTOMVALUEEXTRAINFO_METHOD_2_8552AABC54F650A7_OFFSET UNITYSDK_OFFSET(0x1E82B9C0)
#define RPG_GAMECORE_SETFLOORCUSTOMVALUEEXTRAINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1E82C580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetFloorCustomValueExtraInfo_TypeDefinitionIndex = 20450;
