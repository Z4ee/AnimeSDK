...
#define RPG_GAMECORE_PCKPATCHCONFIG_METHOD_2_E78711E933CA50C4_OFFSET UNITYSDK_OFFSET(0x1D419AE0)
#define RPG_GAMECORE_PCKPATCHCONFIG_METHOD_2_F077A5A499DF57B3_OFFSET UNITYSDK_OFFSET(0x1D4199D0)
#define RPG_GAMECORE_PCKPATCHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D419AD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PckPatchConfig_TypeDefinitionIndex = 16222;
