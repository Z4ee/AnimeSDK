...
#define RPG_GAMECORE_MAPROTATIONVOLUMESLOTCONFIGANCHOR_METHOD_3_8A407EBA982173F4_OFFSET UNITYSDK_OFFSET(0x198C2800)
#define RPG_GAMECORE_MAPROTATIONVOLUMESLOTCONFIGANCHOR_METHOD_3_9E786E97244CA868_OFFSET UNITYSDK_OFFSET(0x198C2860)
#define RPG_GAMECORE_MAPROTATIONVOLUMESLOTCONFIGANCHOR__CTOR_OFFSET UNITYSDK_OFFSET(0x198C2850)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MapRotationVolumeSlotConfigAnchor_TypeDefinitionIndex = 16179;
