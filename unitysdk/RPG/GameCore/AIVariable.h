...
#define RPG_GAMECORE_AIVARIABLE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x185F3A40)
#define RPG_GAMECORE_AIVARIABLE_EQUALS_OFFSET UNITYSDK_OFFSET(0x185F39E0)
#define RPG_GAMECORE_AIVARIABLE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x185F3AD0)
#define RPG_GAMECORE_AIVARIABLE_METHOD_2_08841389B3B0EE4A_1_OFFSET UNITYSDK_OFFSET(0x185F3BC0)
#define RPG_GAMECORE_AIVARIABLE_METHOD_2_08841389B3B0EE4A_OFFSET UNITYSDK_OFFSET(0x185F3B80)
#define RPG_GAMECORE_AIVARIABLE_METHOD_2_5082A76794C3F7FF_OFFSET UNITYSDK_OFFSET(0x185F2F80)
#define RPG_GAMECORE_AIVARIABLE_METHOD_2_EAF0FEF732F0BB8E_OFFSET UNITYSDK_OFFSET(0x185F2C90)
#define RPG_GAMECORE_AIVARIABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x185F2F70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AIVariable_TypeDefinitionIndex = 14772;
