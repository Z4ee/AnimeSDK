...
#define RPG_GAMECORE_AIVARIABLE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x16E93460)
#define RPG_GAMECORE_AIVARIABLE_EQUALS_OFFSET UNITYSDK_OFFSET(0x16E93400)
#define RPG_GAMECORE_AIVARIABLE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x16E934F0)
#define RPG_GAMECORE_AIVARIABLE_METHOD_2_08841389B3B0EE4A_1_OFFSET UNITYSDK_OFFSET(0x16E935E0)
#define RPG_GAMECORE_AIVARIABLE_METHOD_2_08841389B3B0EE4A_OFFSET UNITYSDK_OFFSET(0x16E935A0)
#define RPG_GAMECORE_AIVARIABLE_METHOD_2_5082A76794C3F7FF_OFFSET UNITYSDK_OFFSET(0x16E929A0)
#define RPG_GAMECORE_AIVARIABLE_METHOD_2_EAF0FEF732F0BB8E_OFFSET UNITYSDK_OFFSET(0x16E926B0)
#define RPG_GAMECORE_AIVARIABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x16E92990)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AIVariable_TypeDefinitionIndex = 14302;
