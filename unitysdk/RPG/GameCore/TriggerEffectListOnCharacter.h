...
#define RPG_GAMECORE_TRIGGEREFFECTLISTONCHARACTER_METHOD_3_9A571E746DC07165_OFFSET UNITYSDK_OFFSET(0x190C48D0)
#define RPG_GAMECORE_TRIGGEREFFECTLISTONCHARACTER_METHOD_3_B3BDEF99C7D3ED29_OFFSET UNITYSDK_OFFSET(0x190C4850)
#define RPG_GAMECORE_TRIGGEREFFECTLISTONCHARACTER__CTOR_OFFSET UNITYSDK_OFFSET(0x190C48A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerEffectListOnCharacter_TypeDefinitionIndex = 20763;
