...
#define RPG_GAMECORE_SETCOMPONENTASSETANIMSTATECONFIG_METHOD_2_51BEBA6C9DBCC9CF_OFFSET UNITYSDK_OFFSET(0x1C2DA700)
#define RPG_GAMECORE_SETCOMPONENTASSETANIMSTATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2DA860)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetComponentAssetAnimStateConfig_TypeDefinitionIndex = 21990;
