...
#define RPG_GAMECORE_NODEGRAPHCHECKCONFIG_METHOD_2_040565E6F0C9291A_OFFSET UNITYSDK_OFFSET(0x199CED60)
#define RPG_GAMECORE_NODEGRAPHCHECKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x199CEDA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NodeGraphCheckConfig_TypeDefinitionIndex = 15628;
