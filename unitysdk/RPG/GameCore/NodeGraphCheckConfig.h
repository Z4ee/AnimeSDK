...
#define RPG_GAMECORE_NODEGRAPHCHECKCONFIG_METHOD_2_040565E6F0C9291A_OFFSET UNITYSDK_OFFSET(0x1BAF9380)
#define RPG_GAMECORE_NODEGRAPHCHECKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAF93C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NodeGraphCheckConfig_TypeDefinitionIndex = 15801;
