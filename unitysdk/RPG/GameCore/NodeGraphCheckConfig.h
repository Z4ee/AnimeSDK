...
#define RPG_GAMECORE_NODEGRAPHCHECKCONFIG_METHOD_2_040565E6F0C9291A_OFFSET UNITYSDK_OFFSET(0x1CE8F2A0)
#define RPG_GAMECORE_NODEGRAPHCHECKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE8F2E0)
