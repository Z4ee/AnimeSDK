...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETAUGMENTQUALITYCONFIG_METHOD_3_1AF661A3CCFC0968_OFFSET UNITYSDK_OFFSET(0x1D06AC10)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETAUGMENTQUALITYCONFIG_METHOD_3_2343CCEBA506D8EC_OFFSET UNITYSDK_OFFSET(0x1D06ABC0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETAUGMENTQUALITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D06AC00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierSetAugmentQualityConfig_TypeDefinitionIndex = 18695;
