...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETAUGMENTQUALITYCONFIG_METHOD_3_1AF661A3CCFC0968_OFFSET UNITYSDK_OFFSET(0x197EF050)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETAUGMENTQUALITYCONFIG_METHOD_3_C2C66C337A295A51_OFFSET UNITYSDK_OFFSET(0x197F3770)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETAUGMENTQUALITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197EF000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierSetAugmentQualityConfig_TypeDefinitionIndex = 18447;
