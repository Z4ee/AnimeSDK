...
#define RPG_GAMECORE_TRIGGERENTITYEVENT_METHOD_3_71FDD92D94D8B471_OFFSET UNITYSDK_OFFSET(0x1D28DDB0)
#define RPG_GAMECORE_TRIGGERENTITYEVENT_METHOD_3_8D6410A492148874_OFFSET UNITYSDK_OFFSET(0x1D28DD70)
#define RPG_GAMECORE_TRIGGERENTITYEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D28DDA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerEntityEvent_TypeDefinitionIndex = 20482;
