...
#define RPG_GAMECORE_TRIGGERENTITYEVENT_METHOD_3_219BE872DA3B94A6_OFFSET UNITYSDK_OFFSET(0x178C6E00)
#define RPG_GAMECORE_TRIGGERENTITYEVENT_METHOD_3_71FDD92D94D8B471_OFFSET UNITYSDK_OFFSET(0x178C6E80)
#define RPG_GAMECORE_TRIGGERENTITYEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x178C6E50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerEntityEvent_TypeDefinitionIndex = 19039;
