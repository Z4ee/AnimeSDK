...
#define RPG_GAMECORE_FIVEDIMFINISHCHENLINGGAMEBOYACTION_METHOD_3_19519D4CED8DE1C8_OFFSET UNITYSDK_OFFSET(0x1D0E52E0)
#define RPG_GAMECORE_FIVEDIMFINISHCHENLINGGAMEBOYACTION_METHOD_3_ADD3A53B8DF15FAD_OFFSET UNITYSDK_OFFSET(0x1D0E5360)
#define RPG_GAMECORE_FIVEDIMFINISHCHENLINGGAMEBOYACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0E5350)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimFinishChenLingGameBoyAction_TypeDefinitionIndex = 18467;
