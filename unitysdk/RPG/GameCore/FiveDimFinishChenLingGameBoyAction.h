...
#define RPG_GAMECORE_FIVEDIMFINISHCHENLINGGAMEBOYACTION_METHOD_3_ADD3A53B8DF15FAD_OFFSET UNITYSDK_OFFSET(0x1972ECE0)
#define RPG_GAMECORE_FIVEDIMFINISHCHENLINGGAMEBOYACTION_METHOD_3_C6A83391188F4FF8_OFFSET UNITYSDK_OFFSET(0x1973CC80)
#define RPG_GAMECORE_FIVEDIMFINISHCHENLINGGAMEBOYACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1972ECC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimFinishChenLingGameBoyAction_TypeDefinitionIndex = 17770;
