...
#define RPG_GAMECORE_CONVINCEPLAYOPTIONTALK_METHOD_3_CFB1CB6499F30335_OFFSET UNITYSDK_OFFSET(0x1883EBF0)
#define RPG_GAMECORE_CONVINCEPLAYOPTIONTALK_METHOD_3_ED771F327B9729F3_OFFSET UNITYSDK_OFFSET(0x1883EB70)
#define RPG_GAMECORE_CONVINCEPLAYOPTIONTALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1883EBC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConvincePlayOptionTalk_TypeDefinitionIndex = 20696;
