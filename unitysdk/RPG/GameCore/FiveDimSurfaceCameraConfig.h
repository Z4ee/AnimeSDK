...
#define RPG_GAMECORE_FIVEDIMSURFACECAMERACONFIG_METHOD_4_0BF8BD849FB7B859_OFFSET UNITYSDK_OFFSET(0x1DCA73C0)
#define RPG_GAMECORE_FIVEDIMSURFACECAMERACONFIG_METHOD_4_45E4D3DADB73B00C_OFFSET UNITYSDK_OFFSET(0x1DCA7440)
#define RPG_GAMECORE_FIVEDIMSURFACECAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCA7410)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSurfaceCameraConfig_TypeDefinitionIndex = 18415;
