...
#define RPG_GAMECORE_FIVEDIMSURFACECAMERACONFIG_METHOD_4_45E4D3DADB73B00C_OFFSET UNITYSDK_OFFSET(0x1975AD60)
#define RPG_GAMECORE_FIVEDIMSURFACECAMERACONFIG_METHOD_4_8B8E4347B4FEAF0A_OFFSET UNITYSDK_OFFSET(0x1975ACB0)
#define RPG_GAMECORE_FIVEDIMSURFACECAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1975AD20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSurfaceCameraConfig_TypeDefinitionIndex = 17721;
