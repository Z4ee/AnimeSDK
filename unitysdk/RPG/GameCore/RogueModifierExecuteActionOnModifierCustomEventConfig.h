...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONMODIFIERCUSTOMEVENTCONFIG_METHOD_3_2406CA0747BE10EC_OFFSET UNITYSDK_OFFSET(0x17630C90)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONMODIFIERCUSTOMEVENTCONFIG_METHOD_3_C9DC1CF5F2AC01B5_OFFSET UNITYSDK_OFFSET(0x17630BC0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONMODIFIERCUSTOMEVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17630C40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnModifierCustomEventConfig_TypeDefinitionIndex = 16249;
