...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONMODIFIERCUSTOMEVENTCONFIG_METHOD_3_2406CA0747BE10EC_OFFSET UNITYSDK_OFFSET(0x1CFC07F0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONMODIFIERCUSTOMEVENTCONFIG_METHOD_3_7C17365C673CFEF0_OFFSET UNITYSDK_OFFSET(0x1CFC07A0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONMODIFIERCUSTOMEVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFC07E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnModifierCustomEventConfig_TypeDefinitionIndex = 16980;
