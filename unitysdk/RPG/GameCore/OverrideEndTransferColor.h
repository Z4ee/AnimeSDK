...
#define RPG_GAMECORE_OVERRIDEENDTRANSFERCOLOR_METHOD_3_1B42CECC9A280F1A_OFFSET UNITYSDK_OFFSET(0x199DD240)
#define RPG_GAMECORE_OVERRIDEENDTRANSFERCOLOR_METHOD_3_D883FB5A4FE02523_OFFSET UNITYSDK_OFFSET(0x199DD2D0)
#define RPG_GAMECORE_OVERRIDEENDTRANSFERCOLOR__CTOR_OFFSET UNITYSDK_OFFSET(0x199DD2A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OverrideEndTransferColor_TypeDefinitionIndex = 20699;
