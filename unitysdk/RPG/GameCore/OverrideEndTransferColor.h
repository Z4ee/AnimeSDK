...
#define RPG_GAMECORE_OVERRIDEENDTRANSFERCOLOR_METHOD_3_1B42CECC9A280F1A_OFFSET UNITYSDK_OFFSET(0x174822B0)
#define RPG_GAMECORE_OVERRIDEENDTRANSFERCOLOR_METHOD_3_D883FB5A4FE02523_OFFSET UNITYSDK_OFFSET(0x17482340)
#define RPG_GAMECORE_OVERRIDEENDTRANSFERCOLOR__CTOR_OFFSET UNITYSDK_OFFSET(0x17482310)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OverrideEndTransferColor_TypeDefinitionIndex = 20089;
