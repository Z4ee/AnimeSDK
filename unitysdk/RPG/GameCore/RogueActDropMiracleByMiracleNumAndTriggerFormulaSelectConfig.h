...
#define RPG_GAMECORE_ROGUEACTDROPMIRACLEBYMIRACLENUMANDTRIGGERFORMULASELECTCONFIG_METHOD_6_7106AC4D27D4536E_OFFSET UNITYSDK_OFFSET(0x175B4810)
#define RPG_GAMECORE_ROGUEACTDROPMIRACLEBYMIRACLENUMANDTRIGGERFORMULASELECTCONFIG_METHOD_6_93DDC8DBE0AF2D5B_OFFSET UNITYSDK_OFFSET(0x175B4A30)
#define RPG_GAMECORE_ROGUEACTDROPMIRACLEBYMIRACLENUMANDTRIGGERFORMULASELECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175B4950)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActDropMiracleByMiracleNumAndTriggerFormulaSelectConfig_TypeDefinitionIndex = 18061;
