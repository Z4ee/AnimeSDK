...
#define RPG_GAMECORE_ROGUEACTDROPMIRACLEBYMIRACLENUMANDTRIGGERFORMULASELECTCONFIG_METHOD_6_7106AC4D27D4536E_OFFSET UNITYSDK_OFFSET(0x18CC0580)
#define RPG_GAMECORE_ROGUEACTDROPMIRACLEBYMIRACLENUMANDTRIGGERFORMULASELECTCONFIG_METHOD_6_93DDC8DBE0AF2D5B_OFFSET UNITYSDK_OFFSET(0x18CC07A0)
#define RPG_GAMECORE_ROGUEACTDROPMIRACLEBYMIRACLENUMANDTRIGGERFORMULASELECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CC06C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActDropMiracleByMiracleNumAndTriggerFormulaSelectConfig_TypeDefinitionIndex = 18706;
