...
#define RPG_GAMECORE_ROGUEACTPERSONAALLROOMCARDCASTAPPENDATTRIBUTEBYGROUPCONFIG_METHOD_7_5B7E90E1871FE6E6_OFFSET UNITYSDK_OFFSET(0x1D3B81C0)
#define RPG_GAMECORE_ROGUEACTPERSONAALLROOMCARDCASTAPPENDATTRIBUTEBYGROUPCONFIG_METHOD_7_F508C11C5844108A_OFFSET UNITYSDK_OFFSET(0x1D3B8170)
#define RPG_GAMECORE_ROGUEACTPERSONAALLROOMCARDCASTAPPENDATTRIBUTEBYGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3B81B0)
