...
#define RPG_GAMECORE_ROGUEACTPERSONAALLROOMCARDCASTAPPENDATTRIBUTEBYGROUPCONFIG_METHOD_7_5B7E90E1871FE6E6_OFFSET UNITYSDK_OFFSET(0x175B9F80)
#define RPG_GAMECORE_ROGUEACTPERSONAALLROOMCARDCASTAPPENDATTRIBUTEBYGROUPCONFIG_METHOD_7_EFA3EC90865ACD43_OFFSET UNITYSDK_OFFSET(0x175B9D60)
#define RPG_GAMECORE_ROGUEACTPERSONAALLROOMCARDCASTAPPENDATTRIBUTEBYGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175B9EA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaAllRoomCardCastAppendAttributeByGroupConfig_TypeDefinitionIndex = 18098;
