...
#define RPG_GAMECORE_ROGUEACTPERSONAALLROOMCARDCASTAPPENDATTRIBUTEBYGROUPCONFIG_METHOD_7_5B7E90E1871FE6E6_OFFSET UNITYSDK_OFFSET(0x1D02E990)
#define RPG_GAMECORE_ROGUEACTPERSONAALLROOMCARDCASTAPPENDATTRIBUTEBYGROUPCONFIG_METHOD_7_F508C11C5844108A_OFFSET UNITYSDK_OFFSET(0x1D02E940)
#define RPG_GAMECORE_ROGUEACTPERSONAALLROOMCARDCASTAPPENDATTRIBUTEBYGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D02E980)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaAllRoomCardCastAppendAttributeByGroupConfig_TypeDefinitionIndex = 18986;
