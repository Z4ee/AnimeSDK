...
#define RPG_GAMECORE_FATEACTREMOVEOWNERMASTERAFFIXCONFIG_METHOD_6_BCEFD825F02B81C6_OFFSET UNITYSDK_OFFSET(0x188CF7A0)
#define RPG_GAMECORE_FATEACTREMOVEOWNERMASTERAFFIXCONFIG_METHOD_6_D846C589F9CA2E45_OFFSET UNITYSDK_OFFSET(0x188CF910)
#define RPG_GAMECORE_FATEACTREMOVEOWNERMASTERAFFIXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x188CF870)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateActRemoveOwnerMasterAffixConfig_TypeDefinitionIndex = 18273;
