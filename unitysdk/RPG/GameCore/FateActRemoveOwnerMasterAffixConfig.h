...
#define RPG_GAMECORE_FATEACTREMOVEOWNERMASTERAFFIXCONFIG_METHOD_6_BCEFD825F02B81C6_OFFSET UNITYSDK_OFFSET(0x171C1FD0)
#define RPG_GAMECORE_FATEACTREMOVEOWNERMASTERAFFIXCONFIG_METHOD_6_D846C589F9CA2E45_OFFSET UNITYSDK_OFFSET(0x171C2140)
#define RPG_GAMECORE_FATEACTREMOVEOWNERMASTERAFFIXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171C20A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateActRemoveOwnerMasterAffixConfig_TypeDefinitionIndex = 17660;
