...
#define RPG_GAMECORE_MONOPOLYMAPCELLLAYER_METHOD_2_A5B8C388401C52BF_OFFSET UNITYSDK_OFFSET(0x19962310)
#define RPG_GAMECORE_MONOPOLYMAPCELLLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x19962490)
