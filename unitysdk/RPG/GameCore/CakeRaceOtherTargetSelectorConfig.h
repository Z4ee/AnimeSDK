...
#define RPG_GAMECORE_CAKERACEOTHERTARGETSELECTORCONFIG_METHOD_3_72B5D59638031946_OFFSET UNITYSDK_OFFSET(0x18773700)
#define RPG_GAMECORE_CAKERACEOTHERTARGETSELECTORCONFIG_METHOD_3_EE55E426AA47C637_OFFSET UNITYSDK_OFFSET(0x1876E450)
#define RPG_GAMECORE_CAKERACEOTHERTARGETSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1876E440)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceOtherTargetSelectorConfig_TypeDefinitionIndex = 17478;
