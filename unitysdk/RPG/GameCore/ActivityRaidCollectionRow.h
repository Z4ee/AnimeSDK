...
#define RPG_GAMECORE_ACTIVITYRAIDCOLLECTIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1AB09200)
#define RPG_GAMECORE_ACTIVITYRAIDCOLLECTIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB093D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityRaidCollectionRow_TypeDefinitionIndex = 11854;
	...
	public:
		...
		::System::UInt32 RaidCollectionID; // 0x1C
		::RPG::GameCore::RaidCollectionPrepareType PrepareType; // 0x20
