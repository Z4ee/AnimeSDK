...
#define RPG_GAMECORE_ACTIVITYRAIDCOLLECTIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CDA5260)
#define RPG_GAMECORE_ACTIVITYRAIDCOLLECTIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDA5430)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::RaidCollectionPrepareType PrepareType; // 0x18
