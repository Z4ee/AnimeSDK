...
#define RPG_GAMECORE_BYCOMPAREROGUEMODE_METHOD_4_5F1B96F3F38B38A6_OFFSET UNITYSDK_OFFSET(0x187392A0)
#define RPG_GAMECORE_BYCOMPAREROGUEMODE_METHOD_4_D16853805AE457C8_OFFSET UNITYSDK_OFFSET(0x187391D0)
#define RPG_GAMECORE_BYCOMPAREROGUEMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x18739250)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareRogueMode_TypeDefinitionIndex = 21986;
