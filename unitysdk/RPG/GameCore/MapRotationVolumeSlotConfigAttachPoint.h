...
#define RPG_GAMECORE_MAPROTATIONVOLUMESLOTCONFIGATTACHPOINT_METHOD_3_15E302665DA1583A_OFFSET UNITYSDK_OFFSET(0x1BD0CB60)
#define RPG_GAMECORE_MAPROTATIONVOLUMESLOTCONFIGATTACHPOINT_METHOD_3_898241944C77FC1C_OFFSET UNITYSDK_OFFSET(0x1BD0CB00)
#define RPG_GAMECORE_MAPROTATIONVOLUMESLOTCONFIGATTACHPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD0CB50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MapRotationVolumeSlotConfigAttachPoint_TypeDefinitionIndex = 16364;
