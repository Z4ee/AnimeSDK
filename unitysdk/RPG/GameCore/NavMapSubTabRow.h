...
#define RPG_GAMECORE_NAVMAPSUBTABROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1BAF43D0)
#define RPG_GAMECORE_NAVMAPSUBTABROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAF49C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NavMapSubTabRow_TypeDefinitionIndex = 13482;
