...
#define RPG_GAMECORE_NAVMAPSUBTABROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CE8AEF0)
#define RPG_GAMECORE_NAVMAPSUBTABROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE8B520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NavMapSubTabRow_TypeDefinitionIndex = 13897;
