...
#define RPG_GAMECORE_BYCOMPARECOUNTOFBASETYPE_METHOD_4_392AB94E6CF7B6EB_OFFSET UNITYSDK_OFFSET(0x19CD94B0)
#define RPG_GAMECORE_BYCOMPARECOUNTOFBASETYPE_METHOD_4_483DC8DB014C4E0D_OFFSET UNITYSDK_OFFSET(0x19CD9470)
#define RPG_GAMECORE_BYCOMPARECOUNTOFBASETYPE_METHOD_4_758ABF858F0B8441_OFFSET UNITYSDK_OFFSET(0x19CD9120)
#define RPG_GAMECORE_BYCOMPARECOUNTOFBASETYPE_METHOD_4_E5617A0433673E36_OFFSET UNITYSDK_OFFSET(0x19CD90C0)
#define RPG_GAMECORE_BYCOMPARECOUNTOFBASETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x19CD9100)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareCountOfBaseType_TypeDefinitionIndex = 22744;
