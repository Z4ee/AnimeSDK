...
#define RPG_GAMECORE_BYCOMPARECOUNTOFBASETYPE_METHOD_4_C4D067DC607AA33F_OFFSET UNITYSDK_OFFSET(0x18729B30)
#define RPG_GAMECORE_BYCOMPARECOUNTOFBASETYPE_METHOD_4_D50BB2BEDA45B218_OFFSET UNITYSDK_OFFSET(0x18729A50)
#define RPG_GAMECORE_BYCOMPARECOUNTOFBASETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x18729AD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareCountOfBaseType_TypeDefinitionIndex = 22566;
