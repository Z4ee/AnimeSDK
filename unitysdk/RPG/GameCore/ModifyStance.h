...
#define RPG_GAMECORE_MODIFYSTANCE_METHOD_3_1E2805DBCE9EEF50_OFFSET UNITYSDK_OFFSET(0x1D2B87F0)
#define RPG_GAMECORE_MODIFYSTANCE_METHOD_3_DDF4F8DED306C15E_OFFSET UNITYSDK_OFFSET(0x1D2B8840)
#define RPG_GAMECORE_MODIFYSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2B8830)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyStance_TypeDefinitionIndex = 22377;
