...
#define RPG_GAMECORE_CHENLINGBATTLEINITPOSITIONEVALUATOR_FRONT_METHOD_3_10C444FD65F485FA_OFFSET UNITYSDK_OFFSET(0x1C37C690)
#define RPG_GAMECORE_CHENLINGBATTLEINITPOSITIONEVALUATOR_FRONT_METHOD_3_E6F49B6B1948E31B_OFFSET UNITYSDK_OFFSET(0x1C37C5F0)
#define RPG_GAMECORE_CHENLINGBATTLEINITPOSITIONEVALUATOR_FRONT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C37C680)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleInitPositionEvaluator_Front_TypeDefinitionIndex = 15143;
