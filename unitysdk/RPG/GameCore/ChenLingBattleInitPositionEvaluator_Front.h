...
#define RPG_GAMECORE_CHENLINGBATTLEINITPOSITIONEVALUATOR_FRONT_METHOD_3_10C444FD65F485FA_OFFSET UNITYSDK_OFFSET(0x187E46E0)
#define RPG_GAMECORE_CHENLINGBATTLEINITPOSITIONEVALUATOR_FRONT_METHOD_3_E6F49B6B1948E31B_OFFSET UNITYSDK_OFFSET(0x187E4640)
#define RPG_GAMECORE_CHENLINGBATTLEINITPOSITIONEVALUATOR_FRONT__CTOR_OFFSET UNITYSDK_OFFSET(0x187E46D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleInitPositionEvaluator_Front_TypeDefinitionIndex = 14916;
