...
#define RPG_GAMECORE_FIVEDIMSPAWNCLEANERBOTACTION_METHOD_3_276AD73934FF8B7C_OFFSET UNITYSDK_OFFSET(0x1BEB3A70)
#define RPG_GAMECORE_FIVEDIMSPAWNCLEANERBOTACTION_METHOD_3_52019B7E08AB1153_OFFSET UNITYSDK_OFFSET(0x1BEB3AB0)
#define RPG_GAMECORE_FIVEDIMSPAWNCLEANERBOTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEB3AA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSpawnCleanerBotAction_TypeDefinitionIndex = 17998;
