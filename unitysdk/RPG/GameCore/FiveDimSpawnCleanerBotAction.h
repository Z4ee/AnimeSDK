...
#define RPG_GAMECORE_FIVEDIMSPAWNCLEANERBOTACTION_METHOD_3_0977E1F13CBAAB58_OFFSET UNITYSDK_OFFSET(0x19757E10)
#define RPG_GAMECORE_FIVEDIMSPAWNCLEANERBOTACTION_METHOD_3_52019B7E08AB1153_OFFSET UNITYSDK_OFFSET(0x19757E80)
#define RPG_GAMECORE_FIVEDIMSPAWNCLEANERBOTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19757E60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSpawnCleanerBotAction_TypeDefinitionIndex = 17821;
