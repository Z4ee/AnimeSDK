...
#define RPG_GAMECORE_LITTLEGAMEABILITYTEAMTOWERSMAKEBRICKIVYEFFECTCONFIG_METHOD_3_37DE9EFD01E7B6A4_OFFSET UNITYSDK_OFFSET(0x1BCBC8B0)
#define RPG_GAMECORE_LITTLEGAMEABILITYTEAMTOWERSMAKEBRICKIVYEFFECTCONFIG_METHOD_3_AB3475B587852678_OFFSET UNITYSDK_OFFSET(0x1BCBC7E0)
#define RPG_GAMECORE_LITTLEGAMEABILITYTEAMTOWERSMAKEBRICKIVYEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCBC8A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityTeamTowersMakeBrickIvyEffectConfig_TypeDefinitionIndex = 20611;
