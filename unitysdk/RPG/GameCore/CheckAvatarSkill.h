...
#define RPG_GAMECORE_CHECKAVATARSKILL_METHOD_3_DB6A151B70D7F7EE_OFFSET UNITYSDK_OFFSET(0x1B72D430)
#define RPG_GAMECORE_CHECKAVATARSKILL_METHOD_3_FA186F127DD00F25_OFFSET UNITYSDK_OFFSET(0x1B72D3F0)
#define RPG_GAMECORE_CHECKAVATARSKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B72D420)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CheckAvatarSkill_TypeDefinitionIndex = 22144;
