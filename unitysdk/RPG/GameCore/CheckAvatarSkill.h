...
#define RPG_GAMECORE_CHECKAVATARSKILL_METHOD_3_59B23BC122006B8F_OFFSET UNITYSDK_OFFSET(0x17075030)
#define RPG_GAMECORE_CHECKAVATARSKILL_METHOD_3_DB6A151B70D7F7EE_OFFSET UNITYSDK_OFFSET(0x170750B0)
#define RPG_GAMECORE_CHECKAVATARSKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x17075080)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CheckAvatarSkill_TypeDefinitionIndex = 21176;
