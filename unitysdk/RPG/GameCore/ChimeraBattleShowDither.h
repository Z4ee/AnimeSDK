...
#define RPG_GAMECORE_CHIMERABATTLESHOWDITHER_METHOD_3_6FDD38A47487EDD1_OFFSET UNITYSDK_OFFSET(0x17094700)
#define RPG_GAMECORE_CHIMERABATTLESHOWDITHER_METHOD_3_8AF9DA3E1FC9AF23_OFFSET UNITYSDK_OFFSET(0x170933F0)
#define RPG_GAMECORE_CHIMERABATTLESHOWDITHER__CTOR_OFFSET UNITYSDK_OFFSET(0x170933E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraBattleShowDither_TypeDefinitionIndex = 14569;
