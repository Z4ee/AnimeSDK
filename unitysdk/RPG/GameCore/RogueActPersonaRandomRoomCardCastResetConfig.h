...
#define RPG_GAMECORE_ROGUEACTPERSONARANDOMROOMCARDCASTRESETCONFIG_METHOD_7_08C0FE952500FC52_OFFSET UNITYSDK_OFFSET(0x175C04A0)
#define RPG_GAMECORE_ROGUEACTPERSONARANDOMROOMCARDCASTRESETCONFIG_METHOD_7_D3C4DBF2A577C8B7_OFFSET UNITYSDK_OFFSET(0x175BFF80)
#define RPG_GAMECORE_ROGUEACTPERSONARANDOMROOMCARDCASTRESETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175BFEA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaRandomRoomCardCastResetConfig_TypeDefinitionIndex = 18093;
