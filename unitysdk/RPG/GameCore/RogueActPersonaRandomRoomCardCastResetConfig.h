...
#define RPG_GAMECORE_ROGUEACTPERSONARANDOMROOMCARDCASTRESETCONFIG_METHOD_7_08C0FE952500FC52_OFFSET UNITYSDK_OFFSET(0x18CCC210)
#define RPG_GAMECORE_ROGUEACTPERSONARANDOMROOMCARDCASTRESETCONFIG_METHOD_7_D3C4DBF2A577C8B7_OFFSET UNITYSDK_OFFSET(0x18CCBCF0)
#define RPG_GAMECORE_ROGUEACTPERSONARANDOMROOMCARDCASTRESETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CCBC10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaRandomRoomCardCastResetConfig_TypeDefinitionIndex = 18738;
