...
#define RPG_GAMECORE_ADDBEHAVIORFLAGFORMODIFIER_METHOD_3_3FAC58DC867084CF_OFFSET UNITYSDK_OFFSET(0x1863C780)
#define RPG_GAMECORE_ADDBEHAVIORFLAGFORMODIFIER_METHOD_3_E18EC677A56B6E12_OFFSET UNITYSDK_OFFSET(0x1863C800)
#define RPG_GAMECORE_ADDBEHAVIORFLAGFORMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1863C7D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddBehaviorFlagForModifier_TypeDefinitionIndex = 22611;
