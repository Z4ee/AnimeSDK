...
#define RPG_GAMECORE_ADDBEHAVIORFLAGFORMODIFIER_METHOD_3_3FAC58DC867084CF_OFFSET UNITYSDK_OFFSET(0x16F1A690)
#define RPG_GAMECORE_ADDBEHAVIORFLAGFORMODIFIER_METHOD_3_E18EC677A56B6E12_OFFSET UNITYSDK_OFFSET(0x16F1A710)
#define RPG_GAMECORE_ADDBEHAVIORFLAGFORMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x16F1A6E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddBehaviorFlagForModifier_TypeDefinitionIndex = 21873;
