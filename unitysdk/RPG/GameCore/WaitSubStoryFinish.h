...
#define RPG_GAMECORE_WAITSUBSTORYFINISH_METHOD_3_0F754857E3F4123E_OFFSET UNITYSDK_OFFSET(0x1DEC2C80)
#define RPG_GAMECORE_WAITSUBSTORYFINISH_METHOD_3_8C2C1787B2AFDB22_OFFSET UNITYSDK_OFFSET(0x1DEC2C30)
#define RPG_GAMECORE_WAITSUBSTORYFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEC2C70)
