...
#define RPG_GAMECORE_WAITSUBSTORYFINISH_METHOD_3_0F754857E3F4123E_OFFSET UNITYSDK_OFFSET(0x19109ED0)
#define RPG_GAMECORE_WAITSUBSTORYFINISH_METHOD_3_AA2C66E054F0EA1E_OFFSET UNITYSDK_OFFSET(0x19109E40)
#define RPG_GAMECORE_WAITSUBSTORYFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x19109EA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitSubStoryFinish_TypeDefinitionIndex = 19446;
