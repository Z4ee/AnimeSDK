...
#define RPG_GAMECORE_TARGETFETCHFATERINCARDCASTER_METHOD_4_4D182CB262BC1140_OFFSET UNITYSDK_OFFSET(0x1D0B9C90)
#define RPG_GAMECORE_TARGETFETCHFATERINCARDCASTER_METHOD_4_8319BDBD838C610D_OFFSET UNITYSDK_OFFSET(0x1D0B9CB0)
#define RPG_GAMECORE_TARGETFETCHFATERINCARDCASTER_METHOD_4_880AD15FBDF6C04D_OFFSET UNITYSDK_OFFSET(0x1D0B9C30)
#define RPG_GAMECORE_TARGETFETCHFATERINCARDCASTER_METHOD_4_C9F524EDF280C7E8_OFFSET UNITYSDK_OFFSET(0x1D0B9BB0)
#define RPG_GAMECORE_TARGETFETCHFATERINCARDCASTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0B9C20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchFateRinCardCaster_TypeDefinitionIndex = 23158;
