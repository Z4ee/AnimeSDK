...
#define RPG_GAMECORE_ADVENTUREENTITYTICKINTERVALCHANGED_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xB584B30)
#define RPG_GAMECORE_ADVENTUREENTITYTICKINTERVALCHANGED_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xB584B80)
#define RPG_GAMECORE_ADVENTUREENTITYTICKINTERVALCHANGED_GET_ENTITYID_OFFSET UNITYSDK_OFFSET(0xB584BC0)
#define RPG_GAMECORE_ADVENTUREENTITYTICKINTERVALCHANGED_GET_TICKINTERVALNEW_OFFSET UNITYSDK_OFFSET(0xB584C00)
#define RPG_GAMECORE_ADVENTUREENTITYTICKINTERVALCHANGED_GET_TICKINTERVALOLD_OFFSET UNITYSDK_OFFSET(0xB584BE0)
#define RPG_GAMECORE_ADVENTUREENTITYTICKINTERVALCHANGED_INIT_OFFSET UNITYSDK_OFFSET(0xB584AD0)
#define RPG_GAMECORE_ADVENTUREENTITYTICKINTERVALCHANGED_SET_ENTITYID_OFFSET UNITYSDK_OFFSET(0xB584BD0)
#define RPG_GAMECORE_ADVENTUREENTITYTICKINTERVALCHANGED_SET_TICKINTERVALNEW_OFFSET UNITYSDK_OFFSET(0xB584C10)
#define RPG_GAMECORE_ADVENTUREENTITYTICKINTERVALCHANGED_SET_TICKINTERVALOLD_OFFSET UNITYSDK_OFFSET(0xB584BF0)
#define RPG_GAMECORE_ADVENTUREENTITYTICKINTERVALCHANGED__CTOR_OFFSET UNITYSDK_OFFSET(0xB584C20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureEntityTickIntervalChanged_TypeDefinitionIndex = 52163;
