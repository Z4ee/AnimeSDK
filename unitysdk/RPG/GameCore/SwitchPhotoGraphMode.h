...
#define RPG_GAMECORE_SWITCHPHOTOGRAPHMODE_METHOD_3_455A2DFBD33CD5BE_OFFSET UNITYSDK_OFFSET(0x18EBE090)
#define RPG_GAMECORE_SWITCHPHOTOGRAPHMODE_METHOD_3_A8B144FCC885626C_OFFSET UNITYSDK_OFFSET(0x18EBDFF0)
#define RPG_GAMECORE_SWITCHPHOTOGRAPHMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x18EBE050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchPhotoGraphMode_TypeDefinitionIndex = 19479;
