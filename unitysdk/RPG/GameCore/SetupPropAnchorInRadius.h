...
#define RPG_GAMECORE_SETUPPROPANCHORINRADIUS_METHOD_3_9CA61A26CFE6C229_OFFSET UNITYSDK_OFFSET(0x176EAF20)
#define RPG_GAMECORE_SETUPPROPANCHORINRADIUS_METHOD_3_F48EC860D7F7258E_OFFSET UNITYSDK_OFFSET(0x176EAFC0)
#define RPG_GAMECORE_SETUPPROPANCHORINRADIUS__CTOR_OFFSET UNITYSDK_OFFSET(0x176EAF80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetupPropAnchorInRadius_TypeDefinitionIndex = 18635;
