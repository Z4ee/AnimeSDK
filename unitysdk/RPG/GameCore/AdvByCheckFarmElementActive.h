...
#define RPG_GAMECORE_ADVBYCHECKFARMELEMENTACTIVE_METHOD_4_3D3C184F97EDADC2_OFFSET UNITYSDK_OFFSET(0x1BE0D1E0)
#define RPG_GAMECORE_ADVBYCHECKFARMELEMENTACTIVE_METHOD_4_7D61F42E75174C96_OFFSET UNITYSDK_OFFSET(0x1BE0D060)
#define RPG_GAMECORE_ADVBYCHECKFARMELEMENTACTIVE_METHOD_4_AC4BE135D0D63FCC_OFFSET UNITYSDK_OFFSET(0x1BE0D210)
#define RPG_GAMECORE_ADVBYCHECKFARMELEMENTACTIVE_METHOD_4_C6618C21B039DE47_OFFSET UNITYSDK_OFFSET(0x1BE0D020)
#define RPG_GAMECORE_ADVBYCHECKFARMELEMENTACTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE0D050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvByCheckFarmElementActive_TypeDefinitionIndex = 21451;
