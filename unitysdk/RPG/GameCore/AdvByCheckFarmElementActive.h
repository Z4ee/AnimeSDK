...
#define RPG_GAMECORE_ADVBYCHECKFARMELEMENTACTIVE_METHOD_4_3D3C184F97EDADC2_OFFSET UNITYSDK_OFFSET(0x1D6A7C30)
#define RPG_GAMECORE_ADVBYCHECKFARMELEMENTACTIVE_METHOD_4_7D61F42E75174C96_OFFSET UNITYSDK_OFFSET(0x1D6A7AB0)
#define RPG_GAMECORE_ADVBYCHECKFARMELEMENTACTIVE_METHOD_4_AC4BE135D0D63FCC_OFFSET UNITYSDK_OFFSET(0x1D6A7C60)
#define RPG_GAMECORE_ADVBYCHECKFARMELEMENTACTIVE_METHOD_4_C6618C21B039DE47_OFFSET UNITYSDK_OFFSET(0x1D6A7A70)
#define RPG_GAMECORE_ADVBYCHECKFARMELEMENTACTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6A7AA0)
