...
#define RPG_GAMECORE_SETSERVERGROUPPROPERTY_METHOD_3_3E784620D32219B7_OFFSET UNITYSDK_OFFSET(0x19C5D770)
#define RPG_GAMECORE_SETSERVERGROUPPROPERTY_METHOD_3_EC4C29FEE0022790_OFFSET UNITYSDK_OFFSET(0x19C5D7E0)
#define RPG_GAMECORE_SETSERVERGROUPPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x19C5D7B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetServerGroupProperty_TypeDefinitionIndex = 19584;
