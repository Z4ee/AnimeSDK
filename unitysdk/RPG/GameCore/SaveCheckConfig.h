...
#define RPG_GAMECORE_SAVECHECKCONFIG_METHOD_2_26B894EAF3325B5D_OFFSET UNITYSDK_OFFSET(0x19C1C180)
#define RPG_GAMECORE_SAVECHECKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19C1C1C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SaveCheckConfig_TypeDefinitionIndex = 15629;
