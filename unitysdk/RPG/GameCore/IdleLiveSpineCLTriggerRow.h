...
#define RPG_GAMECORE_IDLELIVESPINECLTRIGGERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D2157D0)
#define RPG_GAMECORE_IDLELIVESPINECLTRIGGERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D215910)
