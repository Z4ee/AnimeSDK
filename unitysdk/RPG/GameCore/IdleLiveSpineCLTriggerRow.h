...
#define RPG_GAMECORE_IDLELIVESPINECLTRIGGERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19847E70)
#define RPG_GAMECORE_IDLELIVESPINECLTRIGGERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19847FB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int IdleLiveSpineCLTriggerRow_TypeDefinitionIndex = 11308;
