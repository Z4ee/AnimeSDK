...
#define RPG_GAMECORE_PLAYERRETURNEXTRAHCOINROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1BA0EA90)
#define RPG_GAMECORE_PLAYERRETURNEXTRAHCOINROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA0ECC0)
