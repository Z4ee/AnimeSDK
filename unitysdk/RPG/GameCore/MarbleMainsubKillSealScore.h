...
#define RPG_GAMECORE_MARBLEMAINSUBKILLSEALSCORE_METHOD_2_98590959E007FD03_OFFSET UNITYSDK_OFFSET(0x18A9E7B0)
#define RPG_GAMECORE_MARBLEMAINSUBKILLSEALSCORE__CTOR_OFFSET UNITYSDK_OFFSET(0x18A9E910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleMainsubKillSealScore_TypeDefinitionIndex = 17971;
