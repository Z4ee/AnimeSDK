...
#define RPG_GAMECORE_MARBLEMAINSUBKILLSEALSCORE_METHOD_2_98590959E007FD03_OFFSET UNITYSDK_OFFSET(0x1D4AABF0)
#define RPG_GAMECORE_MARBLEMAINSUBKILLSEALSCORE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4AAD50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleMainsubKillSealScore_TypeDefinitionIndex = 18706;
