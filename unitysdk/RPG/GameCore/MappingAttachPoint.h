...
#define RPG_GAMECORE_MAPPINGATTACHPOINT_METHOD_3_B1933F7AE440284A_OFFSET UNITYSDK_OFFSET(0x18A91910)
#define RPG_GAMECORE_MAPPINGATTACHPOINT_METHOD_3_B3EE888A948D19C6_OFFSET UNITYSDK_OFFSET(0x18A919E0)
#define RPG_GAMECORE_MAPPINGATTACHPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x18A91990)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MappingAttachPoint_TypeDefinitionIndex = 22147;
