...
#define RPG_GAMECORE_MAPPINGATTACHPOINT_METHOD_3_B1933F7AE440284A_OFFSET UNITYSDK_OFFSET(0x198C4CA0)
#define RPG_GAMECORE_MAPPINGATTACHPOINT_METHOD_3_B3EE888A948D19C6_OFFSET UNITYSDK_OFFSET(0x198C4D70)
#define RPG_GAMECORE_MAPPINGATTACHPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x198C4D20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MappingAttachPoint_TypeDefinitionIndex = 21932;
