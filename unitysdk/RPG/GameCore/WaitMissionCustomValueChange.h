...
#define RPG_GAMECORE_WAITMISSIONCUSTOMVALUECHANGE_METHOD_4_A89BF22EC3BBEFED_OFFSET UNITYSDK_OFFSET(0x178FDF40)
#define RPG_GAMECORE_WAITMISSIONCUSTOMVALUECHANGE_METHOD_4_F94FAD5D89AFE754_OFFSET UNITYSDK_OFFSET(0x178FDE60)
#define RPG_GAMECORE_WAITMISSIONCUSTOMVALUECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x178FDEE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitMissionCustomValueChange_TypeDefinitionIndex = 19847;
