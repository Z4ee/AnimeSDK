...
#define RPG_GAMECORE_REMOVEROGUENPCINOTHERGROUP_METHOD_3_4C0017D8827AB24C_OFFSET UNITYSDK_OFFSET(0x17599690)
#define RPG_GAMECORE_REMOVEROGUENPCINOTHERGROUP_METHOD_3_E44211447E09DECC_OFFSET UNITYSDK_OFFSET(0x17599600)
#define RPG_GAMECORE_REMOVEROGUENPCINOTHERGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x17599660)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveRogueNpcInOtherGroup_TypeDefinitionIndex = 18783;
