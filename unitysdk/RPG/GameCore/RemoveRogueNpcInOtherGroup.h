...
#define RPG_GAMECORE_REMOVEROGUENPCINOTHERGROUP_METHOD_3_4C0017D8827AB24C_OFFSET UNITYSDK_OFFSET(0x1D3A0120)
#define RPG_GAMECORE_REMOVEROGUENPCINOTHERGROUP_METHOD_3_C5AFA0B7EAA6D5D0_OFFSET UNITYSDK_OFFSET(0x1D3A00D0)
#define RPG_GAMECORE_REMOVEROGUENPCINOTHERGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3A0110)
