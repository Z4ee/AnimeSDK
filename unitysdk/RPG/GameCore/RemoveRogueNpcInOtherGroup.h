...
#define RPG_GAMECORE_REMOVEROGUENPCINOTHERGROUP_METHOD_3_4C0017D8827AB24C_OFFSET UNITYSDK_OFFSET(0x1D017250)
#define RPG_GAMECORE_REMOVEROGUENPCINOTHERGROUP_METHOD_3_C5AFA0B7EAA6D5D0_OFFSET UNITYSDK_OFFSET(0x1D017200)
#define RPG_GAMECORE_REMOVEROGUENPCINOTHERGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D017240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveRogueNpcInOtherGroup_TypeDefinitionIndex = 19701;
