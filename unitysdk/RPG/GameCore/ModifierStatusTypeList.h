...
#define RPG_GAMECORE_MODIFIERSTATUSTYPELIST_METHOD_2_E8CD149276B99B02_OFFSET UNITYSDK_OFFSET(0x1994DE60)
#define RPG_GAMECORE_MODIFIERSTATUSTYPELIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1994DF20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifierStatusTypeList_TypeDefinitionIndex = 16239;
