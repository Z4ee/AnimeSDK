...
#define RPG_GAMECORE_PENACONYENDMOSTSIMPLETALKDATA_METHOD_2_06EDC62F8A066D20_OFFSET UNITYSDK_OFFSET(0x18BDAA10)
#define RPG_GAMECORE_PENACONYENDMOSTSIMPLETALKDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18BDAB90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PenaconyEndmostSimpleTalkData_TypeDefinitionIndex = 20672;
