...
#define RPG_GAMECORE_LOCKANIMATORSPEED_METHOD_3_6B00C186441F1590_OFFSET UNITYSDK_OFFSET(0x18A77960)
#define RPG_GAMECORE_LOCKANIMATORSPEED_METHOD_3_983F1C7C77231141_OFFSET UNITYSDK_OFFSET(0x18A778E0)
#define RPG_GAMECORE_LOCKANIMATORSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x18A77930)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LockAnimatorSpeed_TypeDefinitionIndex = 22199;
