...
#define RPG_GAMECORE_LOCKANIMATORSPEED_METHOD_3_6B00C186441F1590_OFFSET UNITYSDK_OFFSET(0x17369D50)
#define RPG_GAMECORE_LOCKANIMATORSPEED_METHOD_3_983F1C7C77231141_OFFSET UNITYSDK_OFFSET(0x17369CD0)
#define RPG_GAMECORE_LOCKANIMATORSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x17369D20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LockAnimatorSpeed_TypeDefinitionIndex = 21464;
