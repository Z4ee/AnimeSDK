...
#define RPG_GAMECORE_MARBLECHOOSETARGET_METHOD_3_306D02C3043328B7_OFFSET UNITYSDK_OFFSET(0x18A9AC00)
#define RPG_GAMECORE_MARBLECHOOSETARGET_METHOD_3_813B1BA3435620DC_OFFSET UNITYSDK_OFFSET(0x18A9AB20)
#define RPG_GAMECORE_MARBLECHOOSETARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x18A9ABB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleChooseTarget_TypeDefinitionIndex = 15941;
