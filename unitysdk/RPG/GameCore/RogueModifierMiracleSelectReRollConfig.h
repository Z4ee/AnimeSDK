...
#define RPG_GAMECORE_ROGUEMODIFIERMIRACLESELECTREROLLCONFIG_METHOD_3_1EDB9EBDC6629645_OFFSET UNITYSDK_OFFSET(0x18D3FAA0)
#define RPG_GAMECORE_ROGUEMODIFIERMIRACLESELECTREROLLCONFIG_METHOD_3_20F5143E2C65FAAC_OFFSET UNITYSDK_OFFSET(0x18D3F9D0)
#define RPG_GAMECORE_ROGUEMODIFIERMIRACLESELECTREROLLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D3FA50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierMiracleSelectReRollConfig_TypeDefinitionIndex = 16888;
