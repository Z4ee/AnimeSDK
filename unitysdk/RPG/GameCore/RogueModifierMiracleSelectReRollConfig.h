...
#define RPG_GAMECORE_ROGUEMODIFIERMIRACLESELECTREROLLCONFIG_METHOD_3_1EDB9EBDC6629645_OFFSET UNITYSDK_OFFSET(0x1CFC1730)
#define RPG_GAMECORE_ROGUEMODIFIERMIRACLESELECTREROLLCONFIG_METHOD_3_BEFD289423BD9EE1_OFFSET UNITYSDK_OFFSET(0x1CFC16E0)
#define RPG_GAMECORE_ROGUEMODIFIERMIRACLESELECTREROLLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFC1720)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierMiracleSelectReRollConfig_TypeDefinitionIndex = 17065;
