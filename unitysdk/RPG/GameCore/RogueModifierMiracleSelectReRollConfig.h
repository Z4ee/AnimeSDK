...
#define RPG_GAMECORE_ROGUEMODIFIERMIRACLESELECTREROLLCONFIG_METHOD_3_1EDB9EBDC6629645_OFFSET UNITYSDK_OFFSET(0x19B54480)
#define RPG_GAMECORE_ROGUEMODIFIERMIRACLESELECTREROLLCONFIG_METHOD_3_20F5143E2C65FAAC_OFFSET UNITYSDK_OFFSET(0x19B5E740)
#define RPG_GAMECORE_ROGUEMODIFIERMIRACLESELECTREROLLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B54430)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierMiracleSelectReRollConfig_TypeDefinitionIndex = 16903;
