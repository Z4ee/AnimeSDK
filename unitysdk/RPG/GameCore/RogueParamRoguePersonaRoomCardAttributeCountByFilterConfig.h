...
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONAROOMCARDATTRIBUTECOUNTBYFILTERCONFIG_METHOD_6_35EB47A6490CF37C_OFFSET UNITYSDK_OFFSET(0x1764DCF0)
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONAROOMCARDATTRIBUTECOUNTBYFILTERCONFIG_METHOD_6_7AA7B5DEDBF6AB92_OFFSET UNITYSDK_OFFSET(0x1764DFA0)
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONAROOMCARDATTRIBUTECOUNTBYFILTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1764DE70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamRoguePersonaRoomCardAttributeCountByFilterConfig_TypeDefinitionIndex = 18191;
