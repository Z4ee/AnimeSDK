...
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONAROOMCARDATTRIBUTECOUNTBYFILTERCONFIG_METHOD_6_410CB7DBA8DF6536_OFFSET UNITYSDK_OFFSET(0x1D176D30)
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONAROOMCARDATTRIBUTECOUNTBYFILTERCONFIG_METHOD_6_7AA7B5DEDBF6AB92_OFFSET UNITYSDK_OFFSET(0x1D176D80)
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONAROOMCARDATTRIBUTECOUNTBYFILTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D176D70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamRoguePersonaRoomCardAttributeCountByFilterConfig_TypeDefinitionIndex = 19084;
