...
#define RPG_GAMECORE_MAZESKILLROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x173CCFA0)
#define RPG_GAMECORE_MAZESKILLROW__CTOR_OFFSET UNITYSDK_OFFSET(0x173CD800)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MazeSkillRow_TypeDefinitionIndex = 11483;
	...
	public:
		...
		::System::UInt32 MPCost; // 0x2C
		::System::UInt32 RelatedAvatarSkill; // 0x30
		::System::UInt32 MazeSkilltype; // 0x34
		::System::UInt32 MazeSkillId; // 0x38
		::RPG::Client::TextID MazeSkillName; // 0x40
