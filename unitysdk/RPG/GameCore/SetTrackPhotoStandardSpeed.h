...
#define RPG_GAMECORE_SETTRACKPHOTOSTANDARDSPEED_METHOD_3_9A65B1F8FF91E5CE_OFFSET UNITYSDK_OFFSET(0x176E5440)
#define RPG_GAMECORE_SETTRACKPHOTOSTANDARDSPEED_METHOD_3_C93933A9063A72E2_OFFSET UNITYSDK_OFFSET(0x176E53C0)
#define RPG_GAMECORE_SETTRACKPHOTOSTANDARDSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x176E5410)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetTrackPhotoStandardSpeed_TypeDefinitionIndex = 19812;
