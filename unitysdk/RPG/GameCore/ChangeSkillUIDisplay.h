...
#define RPG_GAMECORE_CHANGESKILLUIDISPLAY_METHOD_3_CA7516A01BF2918F_OFFSET UNITYSDK_OFFSET(0x1D119120)
#define RPG_GAMECORE_CHANGESKILLUIDISPLAY_METHOD_3_E2E9219D7FB53DD0_OFFSET UNITYSDK_OFFSET(0x1D119080)
#define RPG_GAMECORE_CHANGESKILLUIDISPLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1190E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChangeSkillUIDisplay_TypeDefinitionIndex = 23409;
