...
#define RPG_GAMECORE_CHANGESKILLUIDISPLAY_METHOD_3_CA7516A01BF2918F_OFFSET UNITYSDK_OFFSET(0x17064280)
#define RPG_GAMECORE_CHANGESKILLUIDISPLAY_METHOD_3_E2E9219D7FB53DD0_OFFSET UNITYSDK_OFFSET(0x170641B0)
#define RPG_GAMECORE_CHANGESKILLUIDISPLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x17064230)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChangeSkillUIDisplay_TypeDefinitionIndex = 21931;
