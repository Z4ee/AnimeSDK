...
#define RPG_GAMECORE_SETPHAINONCHARGEPOINTPRESHOW_METHOD_3_4252A5A0D4FE7EB2_OFFSET UNITYSDK_OFFSET(0x18E3E7C0)
#define RPG_GAMECORE_SETPHAINONCHARGEPOINTPRESHOW_METHOD_3_F9D50D1FC6DFD7F6_OFFSET UNITYSDK_OFFSET(0x18E3E740)
#define RPG_GAMECORE_SETPHAINONCHARGEPOINTPRESHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x18E3E790)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetPhainonChargePointPreshow_TypeDefinitionIndex = 22109;
