...
#define RPG_GAMECORE_SETPHAINONCHARGEPOINTPRESHOW_METHOD_3_4252A5A0D4FE7EB2_OFFSET UNITYSDK_OFFSET(0x176DB280)
#define RPG_GAMECORE_SETPHAINONCHARGEPOINTPRESHOW_METHOD_3_F9D50D1FC6DFD7F6_OFFSET UNITYSDK_OFFSET(0x176DB200)
#define RPG_GAMECORE_SETPHAINONCHARGEPOINTPRESHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x176DB250)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetPhainonChargePointPreshow_TypeDefinitionIndex = 21392;
