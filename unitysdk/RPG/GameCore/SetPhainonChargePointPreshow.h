...
#define RPG_GAMECORE_SETPHAINONCHARGEPOINTPRESHOW_METHOD_3_4252A5A0D4FE7EB2_OFFSET UNITYSDK_OFFSET(0x1D50AAD0)
#define RPG_GAMECORE_SETPHAINONCHARGEPOINTPRESHOW_METHOD_3_958C7BA54AEA7759_OFFSET UNITYSDK_OFFSET(0x1D50AA90)
#define RPG_GAMECORE_SETPHAINONCHARGEPOINTPRESHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D50AAC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetPhainonChargePointPreshow_TypeDefinitionIndex = 22897;
