...
#define RPG_GAMECORE_ADVENTUREAFTERSWITCHFAKEAVATAR_CLEAR_OFFSET UNITYSDK_OFFSET(0xA81D5B0)
#define RPG_GAMECORE_ADVENTUREAFTERSWITCHFAKEAVATAR_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xA81D600)
#define RPG_GAMECORE_ADVENTUREAFTERSWITCHFAKEAVATAR_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xA81D650)
#define RPG_GAMECORE_ADVENTUREAFTERSWITCHFAKEAVATAR_GET_LEADERENTITY_OFFSET UNITYSDK_OFFSET(0xA81D6A0)
#define RPG_GAMECORE_ADVENTUREAFTERSWITCHFAKEAVATAR_INIT_OFFSET UNITYSDK_OFFSET(0xA81D560)
#define RPG_GAMECORE_ADVENTUREAFTERSWITCHFAKEAVATAR_SET_LEADERENTITY_OFFSET UNITYSDK_OFFSET(0xA81D6B0)
#define RPG_GAMECORE_ADVENTUREAFTERSWITCHFAKEAVATAR__CTOR_OFFSET UNITYSDK_OFFSET(0xA81D6C0)
#define RPG_GAMECORE_ADVENTUREAFTERSWITCHFAKEAVATAR___IFIXBASEPROXY_CLEAR_OFFSET UNITYSDK_OFFSET(0xA81D6D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureAfterSwitchFakeAvatar_TypeDefinitionIndex = 45511;
