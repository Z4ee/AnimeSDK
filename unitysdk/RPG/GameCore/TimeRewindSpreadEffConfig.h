...
#define RPG_GAMECORE_TIMEREWINDSPREADEFFCONFIG_METHOD_2_93FA56BA6F44A012_OFFSET UNITYSDK_OFFSET(0x1789E3F0)
#define RPG_GAMECORE_TIMEREWINDSPREADEFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x178A04B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TimeRewindSpreadEffConfig_TypeDefinitionIndex = 15213;
