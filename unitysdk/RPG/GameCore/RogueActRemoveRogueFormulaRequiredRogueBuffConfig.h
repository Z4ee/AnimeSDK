...
#define RPG_GAMECORE_ROGUEACTREMOVEROGUEFORMULAREQUIREDROGUEBUFFCONFIG_METHOD_6_0159AC2F3F5F9515_OFFSET UNITYSDK_OFFSET(0x19AF6420)
#define RPG_GAMECORE_ROGUEACTREMOVEROGUEFORMULAREQUIREDROGUEBUFFCONFIG_METHOD_6_968C955E720C3568_OFFSET UNITYSDK_OFFSET(0x19AF6640)
#define RPG_GAMECORE_ROGUEACTREMOVEROGUEFORMULAREQUIREDROGUEBUFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AF6560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActRemoveRogueFormulaRequiredRogueBuffConfig_TypeDefinitionIndex = 18637;
