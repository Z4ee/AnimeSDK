...
#define RPG_GAMECORE_ROGUEACTREMOVEROGUEFORMULAREQUIREDROGUEBUFFCONFIG_METHOD_6_968C955E720C3568_OFFSET UNITYSDK_OFFSET(0x1C49DA10)
#define RPG_GAMECORE_ROGUEACTREMOVEROGUEFORMULAREQUIREDROGUEBUFFCONFIG_METHOD_6_9EDA00A64A1704EC_OFFSET UNITYSDK_OFFSET(0x1C49D9C0)
#define RPG_GAMECORE_ROGUEACTREMOVEROGUEFORMULAREQUIREDROGUEBUFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C49DA00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActRemoveRogueFormulaRequiredRogueBuffConfig_TypeDefinitionIndex = 18913;
