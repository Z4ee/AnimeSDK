...
#define RPG_GAMECORE_MARBLETASKCONFIG_METHOD_2_209BF5C52BDE17F7_OFFSET UNITYSDK_OFFSET(0x18AA8DF0)
#define RPG_GAMECORE_MARBLETASKCONFIG_METHOD_2_A165820FBE30C8ED_OFFSET UNITYSDK_OFFSET(0x18AA8FB0)
#define RPG_GAMECORE_MARBLETASKCONFIG__CCTOR_OFFSET UNITYSDK_OFFSET(0x18AA9010)
#define RPG_GAMECORE_MARBLETASKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18AA10B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleTaskConfig_TypeDefinitionIndex = 15930;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Func_2<::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::MarbleTaskConfig*>*>**)Il2CppClass::FromTypeDefinitionIndex(MarbleTaskConfig_TypeDefinitionIndex)->GetStaticField(0x33DB0);
		}
