...
#define RPG_GAMECORE_MARBLETASKCONFIG_METHOD_2_A165820FBE30C8ED_OFFSET UNITYSDK_OFFSET(0x1BD23980)
#define RPG_GAMECORE_MARBLETASKCONFIG_METHOD_2_F3928209EA43B130_OFFSET UNITYSDK_OFFSET(0x1BD23920)
#define RPG_GAMECORE_MARBLETASKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD12100)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleTaskConfig_TypeDefinitionIndex = 16167;
