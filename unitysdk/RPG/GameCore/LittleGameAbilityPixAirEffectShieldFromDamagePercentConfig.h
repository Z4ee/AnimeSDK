...
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTSHIELDFROMDAMAGEPERCENTCONFIG_METHOD_3_B04797CF6DFC505E_OFFSET UNITYSDK_OFFSET(0x19894A80)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTSHIELDFROMDAMAGEPERCENTCONFIG_METHOD_3_E203A879B6FDA052_OFFSET UNITYSDK_OFFSET(0x198949B0)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTSHIELDFROMDAMAGEPERCENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19894A70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityPixAirEffectShieldFromDamagePercentConfig_TypeDefinitionIndex = 20189;
