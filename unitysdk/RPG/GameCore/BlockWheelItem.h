...
#define RPG_GAMECORE_BLOCKWHEELITEM_METHOD_3_67F375E0C16935BF_OFFSET UNITYSDK_OFFSET(0x1B30EDC0)
#define RPG_GAMECORE_BLOCKWHEELITEM_METHOD_3_8FB1F95CA9EB9622_OFFSET UNITYSDK_OFFSET(0x1B30ED80)
#define RPG_GAMECORE_BLOCKWHEELITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B30EDB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BlockWheelItem_TypeDefinitionIndex = 24001;
