...
#define RPG_GAMECORE_BLOCKWHEELITEM_METHOD_3_67F375E0C16935BF_OFFSET UNITYSDK_OFFSET(0x1870D980)
#define RPG_GAMECORE_BLOCKWHEELITEM_METHOD_3_79D0B8357CF0916C_OFFSET UNITYSDK_OFFSET(0x1870D900)
#define RPG_GAMECORE_BLOCKWHEELITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1870D950)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BlockWheelItem_TypeDefinitionIndex = 23288;
