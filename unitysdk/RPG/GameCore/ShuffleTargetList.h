...
#define RPG_GAMECORE_SHUFFLETARGETLIST_METHOD_3_0ABA3081DE54F4E7_OFFSET UNITYSDK_OFFSET(0x177083C0)
#define RPG_GAMECORE_SHUFFLETARGETLIST_METHOD_3_15ECC69324E34FDB_OFFSET UNITYSDK_OFFSET(0x177084D0)
#define RPG_GAMECORE_SHUFFLETARGETLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x177084A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShuffleTargetList_TypeDefinitionIndex = 20653;
