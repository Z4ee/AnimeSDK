...
#define RPG_GAMECORE_ACTIONBACKUP1CONFIG_METHOD_4_85FA07360FF24103_OFFSET UNITYSDK_OFFSET(0x193C9660)
#define RPG_GAMECORE_ACTIONBACKUP1CONFIG_METHOD_4_90AC81906159454A_OFFSET UNITYSDK_OFFSET(0x193C9590)
#define RPG_GAMECORE_ACTIONBACKUP1CONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x193C9610)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActionBackup1Config_TypeDefinitionIndex = 16193;
