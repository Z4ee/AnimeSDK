...
#define RPG_GAMECORE_ACTIONBACKUP1CONFIG_METHOD_4_85FA07360FF24103_OFFSET UNITYSDK_OFFSET(0x1B9FCFB0)
#define RPG_GAMECORE_ACTIONBACKUP1CONFIG_METHOD_4_C6439F7A806217FF_OFFSET UNITYSDK_OFFSET(0x1B9FCF60)
#define RPG_GAMECORE_ACTIONBACKUP1CONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9FCFA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActionBackup1Config_TypeDefinitionIndex = 16377;
