...
#define RPG_GAMECORE_ROGUEMODIFIERSETCOUNTBYREMOVEMIRACLEONENTERROOMCONFIG_METHOD_3_C5256458F882C107_OFFSET UNITYSDK_OFFSET(0x1D3FC870)
#define RPG_GAMECORE_ROGUEMODIFIERSETCOUNTBYREMOVEMIRACLEONENTERROOMCONFIG_METHOD_3_F98EEB7B9D815D83_OFFSET UNITYSDK_OFFSET(0x1D3FC820)
#define RPG_GAMECORE_ROGUEMODIFIERSETCOUNTBYREMOVEMIRACLEONENTERROOMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3FC860)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierSetCountByRemoveMiracleOnEnterRoomConfig_TypeDefinitionIndex = 17512;
