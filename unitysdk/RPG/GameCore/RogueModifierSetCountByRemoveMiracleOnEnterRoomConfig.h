...
#define RPG_GAMECORE_ROGUEMODIFIERSETCOUNTBYREMOVEMIRACLEONENTERROOMCONFIG_METHOD_3_8400E37B13A68A8E_OFFSET UNITYSDK_OFFSET(0x19B9C8C0)
#define RPG_GAMECORE_ROGUEMODIFIERSETCOUNTBYREMOVEMIRACLEONENTERROOMCONFIG_METHOD_3_C5256458F882C107_OFFSET UNITYSDK_OFFSET(0x19B9C990)
#define RPG_GAMECORE_ROGUEMODIFIERSETCOUNTBYREMOVEMIRACLEONENTERROOMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B9C940)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierSetCountByRemoveMiracleOnEnterRoomConfig_TypeDefinitionIndex = 16847;
