...
#define RPG_GAMECORE_PROPREQINTERACT_METHOD_3_25E22B3538397437_OFFSET UNITYSDK_OFFSET(0x1D36D130)
#define RPG_GAMECORE_PROPREQINTERACT_METHOD_3_F46FFC7A29FEC814_OFFSET UNITYSDK_OFFSET(0x1D36D1B0)
#define RPG_GAMECORE_PROPREQINTERACT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D36D180)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropReqInteract_TypeDefinitionIndex = 22078;
