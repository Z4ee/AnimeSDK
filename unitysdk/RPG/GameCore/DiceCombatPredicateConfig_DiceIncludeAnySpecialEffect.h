...
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_DICEINCLUDEANYSPECIALEFFECT_METHOD_4_73D320B6F57334E0_OFFSET UNITYSDK_OFFSET(0x17164640)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_DICEINCLUDEANYSPECIALEFFECT_METHOD_4_A00BD02A1C8E452E_OFFSET UNITYSDK_OFFSET(0x17166E20)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_DICEINCLUDEANYSPECIALEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x171645F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatPredicateConfig_DiceIncludeAnySpecialEffect_TypeDefinitionIndex = 14787;
