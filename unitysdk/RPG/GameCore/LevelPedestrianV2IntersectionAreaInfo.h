...
#define RPG_GAMECORE_LEVELPEDESTRIANV2INTERSECTIONAREAINFO_METHOD_2_A04FDB264E916DC3_OFFSET UNITYSDK_OFFSET(0x17346150)
#define RPG_GAMECORE_LEVELPEDESTRIANV2INTERSECTIONAREAINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x173462F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPedestrianV2IntersectionAreaInfo_TypeDefinitionIndex = 15887;
