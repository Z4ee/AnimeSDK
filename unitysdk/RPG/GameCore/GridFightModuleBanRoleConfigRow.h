...
#define RPG_GAMECORE_GRIDFIGHTMODULEBANROLECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1726D340)
#define RPG_GAMECORE_GRIDFIGHTMODULEBANROLECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1726D460)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModuleBanRoleConfigRow_TypeDefinitionIndex = 12316;
