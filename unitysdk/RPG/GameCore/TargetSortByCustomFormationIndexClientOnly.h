...
#define RPG_GAMECORE_TARGETSORTBYCUSTOMFORMATIONINDEXCLIENTONLY_METHOD_3_2AAC9B45CD6D0201_OFFSET UNITYSDK_OFFSET(0x18EF9000)
#define RPG_GAMECORE_TARGETSORTBYCUSTOMFORMATIONINDEXCLIENTONLY_METHOD_3_951E33194107454D_OFFSET UNITYSDK_OFFSET(0x18EF6EA0)
#define RPG_GAMECORE_TARGETSORTBYCUSTOMFORMATIONINDEXCLIENTONLY__CTOR_OFFSET UNITYSDK_OFFSET(0x18EF6E80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetSortByCustomFormationIndexClientOnly_TypeDefinitionIndex = 22974;
