...
#define RPG_GAMECORE_SWITCHMASCOTTRIGGERUISHOOTEFFECT_METHOD_3_09C3BEDCF8A8DD14_OFFSET UNITYSDK_OFFSET(0x19CDD9A0)
#define RPG_GAMECORE_SWITCHMASCOTTRIGGERUISHOOTEFFECT_METHOD_3_B4FC283DE36AAA28_OFFSET UNITYSDK_OFFSET(0x19CDD890)
#define RPG_GAMECORE_SWITCHMASCOTTRIGGERUISHOOTEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x19CDD970)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchMascotTriggerUIShootEffect_TypeDefinitionIndex = 20780;
