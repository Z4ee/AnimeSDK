...
#define RPG_GAMECORE_SWITCHMASCOTTRIGGERUISHOOTEFFECT_METHOD_3_09C3BEDCF8A8DD14_OFFSET UNITYSDK_OFFSET(0x1B438B00)
#define RPG_GAMECORE_SWITCHMASCOTTRIGGERUISHOOTEFFECT_METHOD_3_AEADB24403D4D351_OFFSET UNITYSDK_OFFSET(0x1B438A30)
#define RPG_GAMECORE_SWITCHMASCOTTRIGGERUISHOOTEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B438AF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwitchMascotTriggerUIShootEffect_TypeDefinitionIndex = 21195;
