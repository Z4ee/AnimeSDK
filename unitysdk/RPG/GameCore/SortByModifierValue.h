...
#define RPG_GAMECORE_SORTBYMODIFIERVALUE_METHOD_3_0AF2CDC00A1579AD_OFFSET UNITYSDK_OFFSET(0x19C901C0)
#define RPG_GAMECORE_SORTBYMODIFIERVALUE_METHOD_3_D5B9E37A1B4C83DC_OFFSET UNITYSDK_OFFSET(0x19C90170)
#define RPG_GAMECORE_SORTBYMODIFIERVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C901B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SortByModifierValue_TypeDefinitionIndex = 17354;
