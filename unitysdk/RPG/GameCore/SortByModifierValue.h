...
#define RPG_GAMECORE_SORTBYMODIFIERVALUE_METHOD_3_0AF2CDC00A1579AD_OFFSET UNITYSDK_OFFSET(0x177109C0)
#define RPG_GAMECORE_SORTBYMODIFIERVALUE_METHOD_3_D5B9E37A1B4C83DC_OFFSET UNITYSDK_OFFSET(0x17710970)
#define RPG_GAMECORE_SORTBYMODIFIERVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x177109B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SortByModifierValue_TypeDefinitionIndex = 16756;
