...
#define RPG_GAMECORE_CAKERACEACTIONROULETTE_METHOD_3_604FCDA8BEC22662_OFFSET UNITYSDK_OFFSET(0x17045610)
#define RPG_GAMECORE_CAKERACEACTIONROULETTE_METHOD_3_DAD21B77DDC9E8E2_OFFSET UNITYSDK_OFFSET(0x17046B10)
#define RPG_GAMECORE_CAKERACEACTIONROULETTE__CTOR_OFFSET UNITYSDK_OFFSET(0x170455F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionRoulette_TypeDefinitionIndex = 16844;
