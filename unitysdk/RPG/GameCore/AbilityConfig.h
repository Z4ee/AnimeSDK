...
#define RPG_GAMECORE_ABILITYCONFIG_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1B9F9B40)
#define RPG_GAMECORE_ABILITYCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B9F9910)
#define RPG_GAMECORE_ABILITYCONFIG_GETTASKLISTTEMPLATE_OFFSET UNITYSDK_OFFSET(0x1B9F9E00)
#define RPG_GAMECORE_ABILITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9F9B30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AbilityConfig_TypeDefinitionIndex = 15035;
