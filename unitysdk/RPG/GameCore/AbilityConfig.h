...
#define RPG_GAMECORE_ABILITYCONFIG_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x185F5070)
#define RPG_GAMECORE_ABILITYCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x185F4E50)
#define RPG_GAMECORE_ABILITYCONFIG_GETTASKLISTTEMPLATE_OFFSET UNITYSDK_OFFSET(0x185F5350)
#define RPG_GAMECORE_ABILITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x185F5060)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AbilityConfig_TypeDefinitionIndex = 14809;
