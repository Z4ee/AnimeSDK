...
#define RPG_GAMECORE_ROGUEPARAMROGUEMAGICLAYERINDEXCONFIG_METHOD_6_626C9D6DFA6FF983_OFFSET UNITYSDK_OFFSET(0x1D40D190)
#define RPG_GAMECORE_ROGUEPARAMROGUEMAGICLAYERINDEXCONFIG_METHOD_6_A2B635B26ADFD07F_OFFSET UNITYSDK_OFFSET(0x1D40D140)
#define RPG_GAMECORE_ROGUEPARAMROGUEMAGICLAYERINDEXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D40D180)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamRogueMagicLayerIndexConfig_TypeDefinitionIndex = 19606;
