...
#define RPG_GAMECORE_ADDRESHASWITCHPROP_METHOD_3_2674FC9CB00E6BD7_OFFSET UNITYSDK_OFFSET(0x16F20B60)
#define RPG_GAMECORE_ADDRESHASWITCHPROP_METHOD_3_A537A15E19D74820_OFFSET UNITYSDK_OFFSET(0x16F20A10)
#define RPG_GAMECORE_ADDRESHASWITCHPROP__CTOR_OFFSET UNITYSDK_OFFSET(0x16F20AD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddReShaSwitchProp_TypeDefinitionIndex = 20206;
