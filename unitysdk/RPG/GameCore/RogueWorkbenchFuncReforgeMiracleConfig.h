...
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCREFORGEMIRACLECONFIG_METHOD_3_25EC4DE6EFC8A90B_OFFSET UNITYSDK_OFFSET(0x17673930)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCREFORGEMIRACLECONFIG_METHOD_3_D2055A028991B10F_OFFSET UNITYSDK_OFFSET(0x17673610)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCREFORGEMIRACLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17673600)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueWorkbenchFuncReforgeMiracleConfig_TypeDefinitionIndex = 16567;
