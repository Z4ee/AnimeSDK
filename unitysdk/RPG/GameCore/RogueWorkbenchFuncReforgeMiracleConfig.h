...
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCREFORGEMIRACLECONFIG_METHOD_3_25EC4DE6EFC8A90B_OFFSET UNITYSDK_OFFSET(0x19BD4710)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCREFORGEMIRACLECONFIG_METHOD_3_D2055A028991B10F_OFFSET UNITYSDK_OFFSET(0x19BD43F0)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCREFORGEMIRACLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19BD43E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueWorkbenchFuncReforgeMiracleConfig_TypeDefinitionIndex = 17134;
