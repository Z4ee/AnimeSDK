...
#define RPG_GAMECORE_ENABLEROOTMOTION_METHOD_3_929B8A2514A8BD9B_OFFSET UNITYSDK_OFFSET(0x17199EE0)
#define RPG_GAMECORE_ENABLEROOTMOTION_METHOD_3_EF5D74E097616932_OFFSET UNITYSDK_OFFSET(0x17199E60)
#define RPG_GAMECORE_ENABLEROOTMOTION__CTOR_OFFSET UNITYSDK_OFFSET(0x17199EB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnableRootMotion_TypeDefinitionIndex = 20600;
