...
#define RPG_GAMECORE_PERFORMANCESHIFTBLOCKCFGROW_FROMBINARYWITHOUTNEW_OFFSET UNITYSDK_OFFSET(0x1D31FE80)
#define RPG_GAMECORE_PERFORMANCESHIFTBLOCKCFGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D31FF70)
#define RPG_GAMECORE_PERFORMANCESHIFTBLOCKCFGROW_FROMTABLEOFFSET_OFFSET UNITYSDK_OFFSET(0x1D31FE10)
#define RPG_GAMECORE_PERFORMANCESHIFTBLOCKCFGROW_RESET_OFFSET UNITYSDK_OFFSET(0x1D31FE70)
#define RPG_GAMECORE_PERFORMANCESHIFTBLOCKCFGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3200A0)
