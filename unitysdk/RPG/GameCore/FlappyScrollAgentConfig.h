...
#define RPG_GAMECORE_FLAPPYSCROLLAGENTCONFIG_METHOD_3_332B41EEDD954A3B_OFFSET UNITYSDK_OFFSET(0x1DCAB4D0)
#define RPG_GAMECORE_FLAPPYSCROLLAGENTCONFIG_METHOD_3_BDEBECBA419ED608_OFFSET UNITYSDK_OFFSET(0x1DCAB510)
#define RPG_GAMECORE_FLAPPYSCROLLAGENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCAB500)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FlappyScrollAgentConfig_TypeDefinitionIndex = 18418;
	...
	public:
		...
		static ::System::Void Method_3_332B41EEDD954A3B(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::FlappyScrollAgentConfig*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::FlappyScrollAgentConfig*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_FLAPPYSCROLLAGENTCONFIG_METHOD_3_332B41EEDD954A3B_OFFSET))(a1, a2);
		}
