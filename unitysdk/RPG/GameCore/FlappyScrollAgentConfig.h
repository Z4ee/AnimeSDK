...
#define RPG_GAMECORE_FLAPPYSCROLLAGENTCONFIG_METHOD_3_96A0D2D78056F99D_OFFSET UNITYSDK_OFFSET(0x1975F1D0)
#define RPG_GAMECORE_FLAPPYSCROLLAGENTCONFIG_METHOD_3_BDEBECBA419ED608_OFFSET UNITYSDK_OFFSET(0x1975F240)
#define RPG_GAMECORE_FLAPPYSCROLLAGENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1975F220)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FlappyScrollAgentConfig_TypeDefinitionIndex = 17724;
