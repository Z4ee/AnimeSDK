...
#define RPG_GAMECORE_FLAPPYSCROLLAGENTCONFIG_METHOD_3_332B41EEDD954A3B_OFFSET UNITYSDK_OFFSET(0x1BEB9AE0)
#define RPG_GAMECORE_FLAPPYSCROLLAGENTCONFIG_METHOD_3_BDEBECBA419ED608_OFFSET UNITYSDK_OFFSET(0x1BEB9B20)
#define RPG_GAMECORE_FLAPPYSCROLLAGENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEB9B10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FlappyScrollAgentConfig_TypeDefinitionIndex = 17898;
