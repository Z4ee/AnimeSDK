...
#define RPG_GAMECORE_TRAINPARTYBUILDITEMDYNAMICBINDVALUE_MISSION_METHOD_3_A39850DC7EF7251E_OFFSET UNITYSDK_OFFSET(0x190A7B40)
#define RPG_GAMECORE_TRAINPARTYBUILDITEMDYNAMICBINDVALUE_MISSION_METHOD_3_F57746EAB0E34422_OFFSET UNITYSDK_OFFSET(0x190A79A0)
#define RPG_GAMECORE_TRAINPARTYBUILDITEMDYNAMICBINDVALUE_MISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x190A7990)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyBuildItemDynamicBindValue_Mission_TypeDefinitionIndex = 15392;
