...
#define RPG_GAMECORE_SETTIMEREWINDENTITYDISABLECONTROL_METHOD_3_627D71E3FF8E17D8_OFFSET UNITYSDK_OFFSET(0x19C64DC0)
#define RPG_GAMECORE_SETTIMEREWINDENTITYDISABLECONTROL_METHOD_3_B0F3C7F5C56B3DDA_OFFSET UNITYSDK_OFFSET(0x19C64E40)
#define RPG_GAMECORE_SETTIMEREWINDENTITYDISABLECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x19C64E10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetTimeRewindEntityDisableControl_TypeDefinitionIndex = 19535;
