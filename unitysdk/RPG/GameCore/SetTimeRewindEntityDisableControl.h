...
#define RPG_GAMECORE_SETTIMEREWINDENTITYDISABLECONTROL_METHOD_3_0358D498DC4F8515_OFFSET UNITYSDK_OFFSET(0x1C60E0E0)
#define RPG_GAMECORE_SETTIMEREWINDENTITYDISABLECONTROL_METHOD_3_B0F3C7F5C56B3DDA_OFFSET UNITYSDK_OFFSET(0x1C60E120)
#define RPG_GAMECORE_SETTIMEREWINDENTITYDISABLECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C60E110)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetTimeRewindEntityDisableControl_TypeDefinitionIndex = 19893;
