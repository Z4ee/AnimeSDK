...
#define RPG_GAMECORE_CHIMERADUELREPLACESAVEDENTITIESNODE_METHOD_3_08ED987880D80073_OFFSET UNITYSDK_OFFSET(0x18804440)
#define RPG_GAMECORE_CHIMERADUELREPLACESAVEDENTITIESNODE_METHOD_3_4B8F1DD33775FA94_OFFSET UNITYSDK_OFFSET(0x18804360)
#define RPG_GAMECORE_CHIMERADUELREPLACESAVEDENTITIESNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x188043F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelReplaceSavedEntitiesNode_TypeDefinitionIndex = 15135;
