...
#define RPG_GAMECORE_PHOTOGRAPHWAITIDENTIFYFINISH_METHOD_3_3A148666410E3256_OFFSET UNITYSDK_OFFSET(0x18BF90F0)
#define RPG_GAMECORE_PHOTOGRAPHWAITIDENTIFYFINISH_METHOD_3_3F10581D785A4A33_OFFSET UNITYSDK_OFFSET(0x18BF9070)
#define RPG_GAMECORE_PHOTOGRAPHWAITIDENTIFYFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x18BF90C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotoGraphWaitIdentifyFinish_TypeDefinitionIndex = 20508;
