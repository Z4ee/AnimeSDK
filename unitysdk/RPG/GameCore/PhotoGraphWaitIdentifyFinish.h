...
#define RPG_GAMECORE_PHOTOGRAPHWAITIDENTIFYFINISH_METHOD_3_8AB88107D8557A77_OFFSET UNITYSDK_OFFSET(0x1D32F160)
#define RPG_GAMECORE_PHOTOGRAPHWAITIDENTIFYFINISH_METHOD_3_96006D1D9952A849_OFFSET UNITYSDK_OFFSET(0x1D32F1A0)
#define RPG_GAMECORE_PHOTOGRAPHWAITIDENTIFYFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1D32F190)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotoGraphWaitIdentifyFinish_TypeDefinitionIndex = 21415;
