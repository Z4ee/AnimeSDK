...
#define RPG_GAMECORE_ROGUEMODIFIERBACKUP3CONFIG_METHOD_3_3DEF903FC64AD94B_OFFSET UNITYSDK_OFFSET(0x1761D5F0)
#define RPG_GAMECORE_ROGUEMODIFIERBACKUP3CONFIG_METHOD_3_6384B8689F4D47F2_OFFSET UNITYSDK_OFFSET(0x1761D520)
#define RPG_GAMECORE_ROGUEMODIFIERBACKUP3CONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1761D5A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierBackup3Config_TypeDefinitionIndex = 16541;
