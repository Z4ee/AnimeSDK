...
#define RPG_GAMECORE_ROGUEMODIFIERBACKUP3CONFIG_METHOD_3_3DEF903FC64AD94B_OFFSET UNITYSDK_OFFSET(0x1D3F6F20)
#define RPG_GAMECORE_ROGUEMODIFIERBACKUP3CONFIG_METHOD_3_45FF6D91F0E49AA7_OFFSET UNITYSDK_OFFSET(0x1D3F6ED0)
#define RPG_GAMECORE_ROGUEMODIFIERBACKUP3CONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3F6F10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierBackup3Config_TypeDefinitionIndex = 17787;
