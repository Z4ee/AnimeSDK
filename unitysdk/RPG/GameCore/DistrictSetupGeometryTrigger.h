...
#define RPG_GAMECORE_DISTRICTSETUPGEOMETRYTRIGGER_METHOD_3_80E7581C65B3E43B_OFFSET UNITYSDK_OFFSET(0x17174300)
#define RPG_GAMECORE_DISTRICTSETUPGEOMETRYTRIGGER_METHOD_3_D1708A962600ACEA_OFFSET UNITYSDK_OFFSET(0x17174380)
#define RPG_GAMECORE_DISTRICTSETUPGEOMETRYTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x17174350)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DistrictSetupGeometryTrigger_TypeDefinitionIndex = 20143;
