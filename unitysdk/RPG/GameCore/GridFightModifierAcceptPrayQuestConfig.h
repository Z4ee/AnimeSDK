...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERACCEPTPRAYQUESTCONFIG_METHOD_3_4CA8803F29D54A1E_OFFSET UNITYSDK_OFFSET(0x1C5CF950)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERACCEPTPRAYQUESTCONFIG_METHOD_3_C35AAAAB2089F602_OFFSET UNITYSDK_OFFSET(0x1C5CF900)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERACCEPTPRAYQUESTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5CF940)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierAcceptPrayQuestConfig_TypeDefinitionIndex = 18742;
