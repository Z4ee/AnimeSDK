...
#define RPG_GAMECORE_ROGUEACTGETROGUEMAGICUNITCONFIG_METHOD_6_6CA5BED8381394D3_OFFSET UNITYSDK_OFFSET(0x1D3B7BC0)
#define RPG_GAMECORE_ROGUEACTGETROGUEMAGICUNITCONFIG_METHOD_6_756F02D2ABFE150F_OFFSET UNITYSDK_OFFSET(0x1D3B7B70)
#define RPG_GAMECORE_ROGUEACTGETROGUEMAGICUNITCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3B7BB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActGetRogueMagicUnitConfig_TypeDefinitionIndex = 19447;
