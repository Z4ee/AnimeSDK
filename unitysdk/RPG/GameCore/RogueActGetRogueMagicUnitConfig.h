...
#define RPG_GAMECORE_ROGUEACTGETROGUEMAGICUNITCONFIG_METHOD_6_46C7DAD438735C46_OFFSET UNITYSDK_OFFSET(0x175B7A60)
#define RPG_GAMECORE_ROGUEACTGETROGUEMAGICUNITCONFIG_METHOD_6_6CA5BED8381394D3_OFFSET UNITYSDK_OFFSET(0x175B7C80)
#define RPG_GAMECORE_ROGUEACTGETROGUEMAGICUNITCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175B7BA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActGetRogueMagicUnitConfig_TypeDefinitionIndex = 18032;
