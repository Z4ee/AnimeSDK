...
#define RPG_GAMECORE_RESETMISSIONAUDIOSTATE_METHOD_3_817BCE334BFF49BB_OFFSET UNITYSDK_OFFSET(0x19ACF530)
#define RPG_GAMECORE_RESETMISSIONAUDIOSTATE_METHOD_3_8830ADF6ADCD624A_OFFSET UNITYSDK_OFFSET(0x19ACF4B0)
#define RPG_GAMECORE_RESETMISSIONAUDIOSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19ACF500)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetMissionAudioState_TypeDefinitionIndex = 20467;
