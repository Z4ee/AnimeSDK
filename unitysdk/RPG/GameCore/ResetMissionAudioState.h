...
#define RPG_GAMECORE_RESETMISSIONAUDIOSTATE_METHOD_3_48B4A71BE33CA0C2_OFFSET UNITYSDK_OFFSET(0x1D3A4CC0)
#define RPG_GAMECORE_RESETMISSIONAUDIOSTATE_METHOD_3_817BCE334BFF49BB_OFFSET UNITYSDK_OFFSET(0x1D3A4D00)
#define RPG_GAMECORE_RESETMISSIONAUDIOSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3A4CF0)
