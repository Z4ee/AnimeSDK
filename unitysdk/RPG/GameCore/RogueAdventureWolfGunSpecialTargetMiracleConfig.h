...
#define RPG_GAMECORE_ROGUEADVENTUREWOLFGUNSPECIALTARGETMIRACLECONFIG_METHOD_3_70F757E4CD506C8C_OFFSET UNITYSDK_OFFSET(0x1D3BDF60)
#define RPG_GAMECORE_ROGUEADVENTUREWOLFGUNSPECIALTARGETMIRACLECONFIG_METHOD_3_C858AB60A5F32108_OFFSET UNITYSDK_OFFSET(0x1D3BDF10)
#define RPG_GAMECORE_ROGUEADVENTUREWOLFGUNSPECIALTARGETMIRACLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3BDF00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueAdventureWolfGunSpecialTargetMiracleConfig_TypeDefinitionIndex = 17686;
