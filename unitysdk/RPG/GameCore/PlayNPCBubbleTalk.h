...
#define RPG_GAMECORE_PLAYNPCBUBBLETALK_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1BA04DE0)
#define RPG_GAMECORE_PLAYNPCBUBBLETALK_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1BA04D70)
#define RPG_GAMECORE_PLAYNPCBUBBLETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA04DC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayNPCBubbleTalk_TypeDefinitionIndex = 19622;
