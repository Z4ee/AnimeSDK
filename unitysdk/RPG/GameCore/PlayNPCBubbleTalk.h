...
#define RPG_GAMECORE_PLAYNPCBUBBLETALK_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1D349BA0)
#define RPG_GAMECORE_PLAYNPCBUBBLETALK_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D349B30)
#define RPG_GAMECORE_PLAYNPCBUBBLETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D349B80)
