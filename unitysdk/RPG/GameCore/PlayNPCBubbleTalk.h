...
#define RPG_GAMECORE_PLAYNPCBUBBLETALK_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x174C3BE0)
#define RPG_GAMECORE_PLAYNPCBUBBLETALK_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x174C3B40)
#define RPG_GAMECORE_PLAYNPCBUBBLETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x174C3BA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayNPCBubbleTalk_TypeDefinitionIndex = 18702;
