...
#define RPG_GAMECORE_CREATEVIRTUALTEAM_METHOD_3_5721071D3F6DC841_OFFSET UNITYSDK_OFFSET(0x1713F7E0)
#define RPG_GAMECORE_CREATEVIRTUALTEAM_METHOD_3_8EC003825F71DA11_OFFSET UNITYSDK_OFFSET(0x1713F750)
#define RPG_GAMECORE_CREATEVIRTUALTEAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1713F7B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CreateVirtualTeam_TypeDefinitionIndex = 19769;
