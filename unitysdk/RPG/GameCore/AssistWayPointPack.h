...
#define RPG_GAMECORE_ASSISTWAYPOINTPACK_METHOD_2_3A2ED95FF830F73F_OFFSET UNITYSDK_OFFSET(0x1A062160)
#define RPG_GAMECORE_ASSISTWAYPOINTPACK_METHOD_2_5159A0BB4DB966FB_OFFSET UNITYSDK_OFFSET(0x1A061F40)
#define RPG_GAMECORE_ASSISTWAYPOINTPACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A062150)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AssistWayPointPack_TypeDefinitionIndex = 18259;
