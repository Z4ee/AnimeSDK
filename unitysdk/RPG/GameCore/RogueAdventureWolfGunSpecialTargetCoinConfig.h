...
#define RPG_GAMECORE_ROGUEADVENTUREWOLFGUNSPECIALTARGETCOINCONFIG_METHOD_3_4AB4EC07D3FB4ADE_OFFSET UNITYSDK_OFFSET(0x1C4A0C00)
#define RPG_GAMECORE_ROGUEADVENTUREWOLFGUNSPECIALTARGETCOINCONFIG_METHOD_3_A55142F5490F381A_OFFSET UNITYSDK_OFFSET(0x1C4A0C50)
#define RPG_GAMECORE_ROGUEADVENTUREWOLFGUNSPECIALTARGETCOINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4A0C40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueAdventureWolfGunSpecialTargetCoinConfig_TypeDefinitionIndex = 17171;
