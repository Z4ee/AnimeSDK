...
#define RPG_GAMECORE_ROGUEADVENTUREWOLFGUNSPECIALTARGETCOINCONFIG_METHOD_3_4AB4EC07D3FB4ADE_OFFSET UNITYSDK_OFFSET(0x19B0D3F0)
#define RPG_GAMECORE_ROGUEADVENTUREWOLFGUNSPECIALTARGETCOINCONFIG_METHOD_3_A55142F5490F381A_OFFSET UNITYSDK_OFFSET(0x19B0D440)
#define RPG_GAMECORE_ROGUEADVENTUREWOLFGUNSPECIALTARGETCOINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B0D430)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueAdventureWolfGunSpecialTargetCoinConfig_TypeDefinitionIndex = 17009;
