...
#define RPG_GAMECORE_ACTIVITYELATIONHIDECUTIN_METHOD_3_2BCEDC3E2122E032_OFFSET UNITYSDK_OFFSET(0x1CD7F880)
#define RPG_GAMECORE_ACTIVITYELATIONHIDECUTIN_METHOD_3_9B8C3CBEBB3680AF_OFFSET UNITYSDK_OFFSET(0x1CD7F950)
#define RPG_GAMECORE_ACTIVITYELATIONHIDECUTIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD7F940)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityElationHideCutIn_TypeDefinitionIndex = 22966;
