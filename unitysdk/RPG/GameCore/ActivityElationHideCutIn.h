...
#define RPG_GAMECORE_ACTIVITYELATIONHIDECUTIN_METHOD_3_9B8C3CBEBB3680AF_OFFSET UNITYSDK_OFFSET(0x16EA9BF0)
#define RPG_GAMECORE_ACTIVITYELATIONHIDECUTIN_METHOD_3_D9D78B8BB12F1EBB_OFFSET UNITYSDK_OFFSET(0x16EA9AE0)
#define RPG_GAMECORE_ACTIVITYELATIONHIDECUTIN__CTOR_OFFSET UNITYSDK_OFFSET(0x16EA9BC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityElationHideCutIn_TypeDefinitionIndex = 21449;
