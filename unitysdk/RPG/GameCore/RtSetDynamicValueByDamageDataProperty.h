...
#define RPG_GAMECORE_RTSETDYNAMICVALUEBYDAMAGEDATAPROPERTY_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x19BEFB50)
#define RPG_GAMECORE_RTSETDYNAMICVALUEBYDAMAGEDATAPROPERTY_METHOD_4_0FEE0E4F0EC933AF_OFFSET UNITYSDK_OFFSET(0x19BEF960)
#define RPG_GAMECORE_RTSETDYNAMICVALUEBYDAMAGEDATAPROPERTY_METHOD_4_578658140F24B247_OFFSET UNITYSDK_OFFSET(0x19BEF8E0)
#define RPG_GAMECORE_RTSETDYNAMICVALUEBYDAMAGEDATAPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x19BEFB60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtSetDynamicValueByDamageDataProperty_TypeDefinitionIndex = 22853;
