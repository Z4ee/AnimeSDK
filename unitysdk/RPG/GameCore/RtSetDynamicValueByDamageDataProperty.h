...
#define RPG_GAMECORE_RTSETDYNAMICVALUEBYDAMAGEDATAPROPERTY_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1B768AB0)
#define RPG_GAMECORE_RTSETDYNAMICVALUEBYDAMAGEDATAPROPERTY_METHOD_4_0FEE0E4F0EC933AF_OFFSET UNITYSDK_OFFSET(0x1B7688C0)
#define RPG_GAMECORE_RTSETDYNAMICVALUEBYDAMAGEDATAPROPERTY_METHOD_4_D7E2A3E42DD8FAC2_OFFSET UNITYSDK_OFFSET(0x1B768880)
#define RPG_GAMECORE_RTSETDYNAMICVALUEBYDAMAGEDATAPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7688B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtSetDynamicValueByDamageDataProperty_TypeDefinitionIndex = 23320;
