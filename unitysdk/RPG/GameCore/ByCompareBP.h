...
#define RPG_GAMECORE_BYCOMPAREBP_METHOD_4_54D45E9FA7386D4C_OFFSET UNITYSDK_OFFSET(0x19CD1E80)
#define RPG_GAMECORE_BYCOMPAREBP_METHOD_4_980706A0FC98F8B1_OFFSET UNITYSDK_OFFSET(0x19CD1E30)
#define RPG_GAMECORE_BYCOMPAREBP_METHOD_4_B2DE93E5468AF571_OFFSET UNITYSDK_OFFSET(0x19CD2100)
#define RPG_GAMECORE_BYCOMPAREBP_METHOD_4_DE15C77EE4CBB66E_OFFSET UNITYSDK_OFFSET(0x19CD20C0)
#define RPG_GAMECORE_BYCOMPAREBP__CTOR_OFFSET UNITYSDK_OFFSET(0x19CD1E70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareBP_TypeDefinitionIndex = 22230;
