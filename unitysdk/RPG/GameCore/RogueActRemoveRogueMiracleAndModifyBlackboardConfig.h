...
#define RPG_GAMECORE_ROGUEACTREMOVEROGUEMIRACLEANDMODIFYBLACKBOARDCONFIG_METHOD_6_9920F0975C23CFED_OFFSET UNITYSDK_OFFSET(0x175C6580)
#define RPG_GAMECORE_ROGUEACTREMOVEROGUEMIRACLEANDMODIFYBLACKBOARDCONFIG_METHOD_6_99846CA6C01F06D0_OFFSET UNITYSDK_OFFSET(0x175C6360)
#define RPG_GAMECORE_ROGUEACTREMOVEROGUEMIRACLEANDMODIFYBLACKBOARDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175C64A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActRemoveRogueMiracleAndModifyBlackboardConfig_TypeDefinitionIndex = 17964;
