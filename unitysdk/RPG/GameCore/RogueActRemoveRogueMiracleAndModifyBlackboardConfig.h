...
#define RPG_GAMECORE_ROGUEACTREMOVEROGUEMIRACLEANDMODIFYBLACKBOARDCONFIG_METHOD_6_8FB16F3CE4DA5869_OFFSET UNITYSDK_OFFSET(0x1EE88860)
#define RPG_GAMECORE_ROGUEACTREMOVEROGUEMIRACLEANDMODIFYBLACKBOARDCONFIG_METHOD_6_9920F0975C23CFED_OFFSET UNITYSDK_OFFSET(0x1EE888B0)
#define RPG_GAMECORE_ROGUEACTREMOVEROGUEMIRACLEANDMODIFYBLACKBOARDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EE888A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActRemoveRogueMiracleAndModifyBlackboardConfig_TypeDefinitionIndex = 19378;
