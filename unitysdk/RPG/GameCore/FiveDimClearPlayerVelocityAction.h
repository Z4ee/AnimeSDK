...
#define RPG_GAMECORE_FIVEDIMCLEARPLAYERVELOCITYACTION_METHOD_3_320071285AB6FF2A_OFFSET UNITYSDK_OFFSET(0x188FAA80)
#define RPG_GAMECORE_FIVEDIMCLEARPLAYERVELOCITYACTION_METHOD_3_E0A36FF4B1731BE7_OFFSET UNITYSDK_OFFSET(0x188F3990)
#define RPG_GAMECORE_FIVEDIMCLEARPLAYERVELOCITYACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x188F3970)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimClearPlayerVelocityAction_TypeDefinitionIndex = 17829;
