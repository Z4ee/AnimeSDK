...
#define RPG_GAMECORE_BYISDIRECTKILLBATTLE_METHOD_4_096294412AE58F5D_OFFSET UNITYSDK_OFFSET(0x1702C890)
#define RPG_GAMECORE_BYISDIRECTKILLBATTLE_METHOD_4_D5D05369782CBF17_OFFSET UNITYSDK_OFFSET(0x1702C7C0)
#define RPG_GAMECORE_BYISDIRECTKILLBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1702C840)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsDirectKillBattle_TypeDefinitionIndex = 21262;
