...
#define RPG_GAMECORE_BYISDIRECTKILLBATTLE_METHOD_4_096294412AE58F5D_OFFSET UNITYSDK_OFFSET(0x1A8DE6F0)
#define RPG_GAMECORE_BYISDIRECTKILLBATTLE_METHOD_4_75B0EF3D933B4657_OFFSET UNITYSDK_OFFSET(0x1A8DE830)
#define RPG_GAMECORE_BYISDIRECTKILLBATTLE_METHOD_4_84980D4F9CC7EA5E_OFFSET UNITYSDK_OFFSET(0x1A8DE6B0)
#define RPG_GAMECORE_BYISDIRECTKILLBATTLE_METHOD_4_B04294EFE88AF4AA_OFFSET UNITYSDK_OFFSET(0x1A8DE860)
#define RPG_GAMECORE_BYISDIRECTKILLBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8DE6E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsDirectKillBattle_TypeDefinitionIndex = 22228;
