...
#define RPG_GAMECORE_ADVNPCIDLE_METHOD_3_A22FB378161500D1_OFFSET UNITYSDK_OFFSET(0x1942A580)
#define RPG_GAMECORE_ADVNPCIDLE_METHOD_3_D1B3CF7E29F5019D_OFFSET UNITYSDK_OFFSET(0x1942A470)
#define RPG_GAMECORE_ADVNPCIDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1942A550)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvNPCIdle_TypeDefinitionIndex = 18861;
