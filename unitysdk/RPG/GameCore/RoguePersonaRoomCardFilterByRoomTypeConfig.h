...
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYROOMTYPECONFIG_METHOD_3_998E9B1FB95D8E0A_OFFSET UNITYSDK_OFFSET(0x19BB9CD0)
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYROOMTYPECONFIG_METHOD_3_B3148174849D1BCE_OFFSET UNITYSDK_OFFSET(0x19BB9F80)
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYROOMTYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19BB9CC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RoguePersonaRoomCardFilterByRoomTypeConfig_TypeDefinitionIndex = 18819;
