...
#define RPG_GAMECORE_ROGUEACTPERSONAROOMCARDREDRAWCOUNTCHANGECONFIG_METHOD_6_8DD552E5669D5445_OFFSET UNITYSDK_OFFSET(0x1D02FF00)
#define RPG_GAMECORE_ROGUEACTPERSONAROOMCARDREDRAWCOUNTCHANGECONFIG_METHOD_6_CC9043EAFD8E9CC9_OFFSET UNITYSDK_OFFSET(0x1D02FF50)
#define RPG_GAMECORE_ROGUEACTPERSONAROOMCARDREDRAWCOUNTCHANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D02FF40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaRoomCardReDrawCountChangeConfig_TypeDefinitionIndex = 19010;
