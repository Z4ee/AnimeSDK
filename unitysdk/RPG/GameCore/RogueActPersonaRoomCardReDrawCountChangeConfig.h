...
#define RPG_GAMECORE_ROGUEACTPERSONAROOMCARDREDRAWCOUNTCHANGECONFIG_METHOD_6_6647A73075FC4294_OFFSET UNITYSDK_OFFSET(0x19AF0EC0)
#define RPG_GAMECORE_ROGUEACTPERSONAROOMCARDREDRAWCOUNTCHANGECONFIG_METHOD_6_CC9043EAFD8E9CC9_OFFSET UNITYSDK_OFFSET(0x19AF10E0)
#define RPG_GAMECORE_ROGUEACTPERSONAROOMCARDREDRAWCOUNTCHANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AF1000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaRoomCardReDrawCountChangeConfig_TypeDefinitionIndex = 18734;
