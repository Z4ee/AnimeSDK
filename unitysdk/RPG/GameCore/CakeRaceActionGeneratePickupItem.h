...
#define RPG_GAMECORE_CAKERACEACTIONGENERATEPICKUPITEM_METHOD_3_88D66DF91BC48048_OFFSET UNITYSDK_OFFSET(0x17044B30)
#define RPG_GAMECORE_CAKERACEACTIONGENERATEPICKUPITEM_METHOD_3_D973838C0C90151D_OFFSET UNITYSDK_OFFSET(0x170467A0)
#define RPG_GAMECORE_CAKERACEACTIONGENERATEPICKUPITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x17044B10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionGeneratePickupItem_TypeDefinitionIndex = 16846;
