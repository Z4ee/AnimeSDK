...
#define RPG_GAMECORE_CAKERACEACTIONGENERATEPICKUPITEM_METHOD_3_88D66DF91BC48048_OFFSET UNITYSDK_OFFSET(0x195E5D90)
#define RPG_GAMECORE_CAKERACEACTIONGENERATEPICKUPITEM_METHOD_3_D973838C0C90151D_OFFSET UNITYSDK_OFFSET(0x195E7EB0)
#define RPG_GAMECORE_CAKERACEACTIONGENERATEPICKUPITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x195E5D70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionGeneratePickupItem_TypeDefinitionIndex = 17443;
