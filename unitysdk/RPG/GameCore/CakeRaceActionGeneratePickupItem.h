...
#define RPG_GAMECORE_CAKERACEACTIONGENERATEPICKUPITEM_METHOD_3_88D66DF91BC48048_OFFSET UNITYSDK_OFFSET(0x1B2CB8B0)
#define RPG_GAMECORE_CAKERACEACTIONGENERATEPICKUPITEM_METHOD_3_89E3A6432978366E_OFFSET UNITYSDK_OFFSET(0x1B2CB850)
#define RPG_GAMECORE_CAKERACEACTIONGENERATEPICKUPITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2CB8A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceActionGeneratePickupItem_TypeDefinitionIndex = 17616;
