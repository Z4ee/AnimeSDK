...
#define RPG_GAMECORE_SWORDTRAININGPROGRESSROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1779F8B0)
#define RPG_GAMECORE_SWORDTRAININGPROGRESSROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1779FCF0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 PartnerAbilitySelectNum; // 0x18
		::RPG::GameCore::SwordTrainingTurnType TurnType; // 0x1C
		::RPG::Client::TextID SectionHint; // 0x20
		::System::UInt32 RecommendPower; // 0x30
		::System::UInt32 TurnID; // 0x34
		::RPG::Client::TextID PartnerAbilitySelectHint; // 0x38
		::RPG::Client::TextID TurnName; // 0x48
		::System::UInt32 ExamID; // 0x58
		::System::UInt32 PartnerAbilityGroupID; // 0x5C
