...
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCCONFIG_METHOD_2_02AE8D330A549B1B_OFFSET UNITYSDK_OFFSET(0x18D80EE0)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D80F20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueWorkbenchFuncConfig_TypeDefinitionIndex = 17132;
