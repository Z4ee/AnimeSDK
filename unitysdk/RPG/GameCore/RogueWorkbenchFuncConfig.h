...
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCCONFIG_METHOD_2_02AE8D330A549B1B_OFFSET UNITYSDK_OFFSET(0x176736A0)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x176736E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueWorkbenchFuncConfig_TypeDefinitionIndex = 16578;
