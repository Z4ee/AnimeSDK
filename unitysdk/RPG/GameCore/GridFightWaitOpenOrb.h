...
#define RPG_GAMECORE_GRIDFIGHTWAITOPENORB_METHOD_3_377A51B97052342C_OFFSET UNITYSDK_OFFSET(0x1728AED0)
#define RPG_GAMECORE_GRIDFIGHTWAITOPENORB_METHOD_3_74348F98F3A78A5D_OFFSET UNITYSDK_OFFSET(0x1728AF50)
#define RPG_GAMECORE_GRIDFIGHTWAITOPENORB__CTOR_OFFSET UNITYSDK_OFFSET(0x1728AF20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightWaitOpenOrb_TypeDefinitionIndex = 18233;
