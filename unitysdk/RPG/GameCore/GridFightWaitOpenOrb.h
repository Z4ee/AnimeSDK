...
#define RPG_GAMECORE_GRIDFIGHTWAITOPENORB_METHOD_3_5BDAA3A2FA4FA8A4_OFFSET UNITYSDK_OFFSET(0x1D07F1B0)
#define RPG_GAMECORE_GRIDFIGHTWAITOPENORB_METHOD_3_74348F98F3A78A5D_OFFSET UNITYSDK_OFFSET(0x1D07F1F0)
#define RPG_GAMECORE_GRIDFIGHTWAITOPENORB__CTOR_OFFSET UNITYSDK_OFFSET(0x1D07F1E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightWaitOpenOrb_TypeDefinitionIndex = 19192;
