...
#define RPG_GAMECORE_GRIDFIGHTWAITOPENORB_METHOD_3_5BDAA3A2FA4FA8A4_OFFSET UNITYSDK_OFFSET(0x1D3C12D0)
#define RPG_GAMECORE_GRIDFIGHTWAITOPENORB_METHOD_3_74348F98F3A78A5D_OFFSET UNITYSDK_OFFSET(0x1D3C1310)
#define RPG_GAMECORE_GRIDFIGHTWAITOPENORB__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3C1300)
