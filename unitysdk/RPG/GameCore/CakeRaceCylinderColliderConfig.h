...
#define RPG_GAMECORE_CAKERACECYLINDERCOLLIDERCONFIG_METHOD_3_C43367CD5FF1C553_OFFSET UNITYSDK_OFFSET(0x1B2D02C0)
#define RPG_GAMECORE_CAKERACECYLINDERCOLLIDERCONFIG_METHOD_3_F1AB60085C501943_OFFSET UNITYSDK_OFFSET(0x1B2D0260)
#define RPG_GAMECORE_CAKERACECYLINDERCOLLIDERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2D02B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceCylinderColliderConfig_TypeDefinitionIndex = 17690;
