...
#define RPG_GAMECORE_CAKERACECYLINDERCOLLIDERCONFIG_METHOD_3_C43367CD5FF1C553_OFFSET UNITYSDK_OFFSET(0x1704A9C0)
#define RPG_GAMECORE_CAKERACECYLINDERCOLLIDERCONFIG_METHOD_3_D660F5F8D03A3D0F_OFFSET UNITYSDK_OFFSET(0x1704A930)
#define RPG_GAMECORE_CAKERACECYLINDERCOLLIDERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1704A9A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceCylinderColliderConfig_TypeDefinitionIndex = 16924;
