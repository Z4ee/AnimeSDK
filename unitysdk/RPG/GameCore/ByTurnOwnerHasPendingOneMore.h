...
#define RPG_GAMECORE_BYTURNOWNERHASPENDINGONEMORE_METHOD_4_499D79B7B46B35E7_OFFSET UNITYSDK_OFFSET(0x1B2C5560)
#define RPG_GAMECORE_BYTURNOWNERHASPENDINGONEMORE_METHOD_4_6E5BDF5442C5D9D2_OFFSET UNITYSDK_OFFSET(0x1B2C5530)
#define RPG_GAMECORE_BYTURNOWNERHASPENDINGONEMORE_METHOD_4_AEE314DF378FCDA7_OFFSET UNITYSDK_OFFSET(0x1B2C53B0)
#define RPG_GAMECORE_BYTURNOWNERHASPENDINGONEMORE_METHOD_4_ECA3DD74D848B9EC_OFFSET UNITYSDK_OFFSET(0x1B2C53F0)
#define RPG_GAMECORE_BYTURNOWNERHASPENDINGONEMORE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2C53E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByTurnOwnerHasPendingOneMore_TypeDefinitionIndex = 22640;
