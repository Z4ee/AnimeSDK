...
#define RPG_GAMECORE_BYTURNOWNERHASPENDINGONEMORE_METHOD_4_448D777543AE0C66_OFFSET UNITYSDK_OFFSET(0x18763910)
#define RPG_GAMECORE_BYTURNOWNERHASPENDINGONEMORE_METHOD_4_ECA3DD74D848B9EC_OFFSET UNITYSDK_OFFSET(0x187639E0)
#define RPG_GAMECORE_BYTURNOWNERHASPENDINGONEMORE__CTOR_OFFSET UNITYSDK_OFFSET(0x18763990)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByTurnOwnerHasPendingOneMore_TypeDefinitionIndex = 22454;
