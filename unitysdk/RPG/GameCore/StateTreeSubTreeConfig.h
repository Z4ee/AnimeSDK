...
#define RPG_GAMECORE_STATETREESUBTREECONFIG_METHOD_3_4C15209D4ACF0B65_OFFSET UNITYSDK_OFFSET(0x1B0C02E0)
#define RPG_GAMECORE_STATETREESUBTREECONFIG_METHOD_3_5397CE903E0F5F5C_OFFSET UNITYSDK_OFFSET(0x1B0C0600)
#define RPG_GAMECORE_STATETREESUBTREECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0C02D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StateTreeSubTreeConfig_TypeDefinitionIndex = 14892;
