...
#define RPG_GAMECORE_SHOWROGUEFORMALUAUI_METHOD_3_DDB3E6CC80F7BEE5_OFFSET UNITYSDK_OFFSET(0x17701DB0)
#define RPG_GAMECORE_SHOWROGUEFORMALUAUI_METHOD_3_EB91225D7B4D19A3_OFFSET UNITYSDK_OFFSET(0x17701E30)
#define RPG_GAMECORE_SHOWROGUEFORMALUAUI__CTOR_OFFSET UNITYSDK_OFFSET(0x17701E00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowRogueFormaluaUI_TypeDefinitionIndex = 19131;
