...
#define RPG_GAMECORE_MESSAGEGROUPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19910B60)
#define RPG_GAMECORE_MESSAGEGROUPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19911790)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MessageGroupRow_TypeDefinitionIndex = 13726;
	...
	public:
		...
		::System::Boolean IsChatGroup; // 0x24
