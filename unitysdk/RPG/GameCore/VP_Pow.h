...
#define RPG_GAMECORE_VP_POW_METHOD_3_0508A64F4585BDA4_OFFSET UNITYSDK_OFFSET(0x1DEAACD0)
#define RPG_GAMECORE_VP_POW_METHOD_3_0993906567F599B0_OFFSET UNITYSDK_OFFSET(0x1DEAAD50)
#define RPG_GAMECORE_VP_POW_METHOD_3_A5D11E933D61A721_OFFSET UNITYSDK_OFFSET(0x1DEAAC20)
#define RPG_GAMECORE_VP_POW_METHOD_3_CCB87A8DF4445B10_OFFSET UNITYSDK_OFFSET(0x1DEAAD80)
#define RPG_GAMECORE_VP_POW__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEAACC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VP_Pow_TypeDefinitionIndex = 23777;
