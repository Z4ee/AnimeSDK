...
#define RPG_GAMECORE_GUIDEROGUETABROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19818B20)
#define RPG_GAMECORE_GUIDEROGUETABROW__CTOR_OFFSET UNITYSDK_OFFSET(0x198194A0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::GuideRogueType GuideType; // 0x38
