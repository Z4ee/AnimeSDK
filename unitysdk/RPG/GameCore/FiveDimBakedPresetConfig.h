...
#define RPG_GAMECORE_FIVEDIMBAKEDPRESETCONFIG_METHOD_2_0D43289C9E1B713B_OFFSET UNITYSDK_OFFSET(0x1E0E2C90)
#define RPG_GAMECORE_FIVEDIMBAKEDPRESETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0E2E70)
