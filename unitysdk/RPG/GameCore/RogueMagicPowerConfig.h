...
#define RPG_GAMECORE_ROGUEMAGICPOWERCONFIG_METHOD_2_3B39469EAC257C43_OFFSET UNITYSDK_OFFSET(0x1D3EE8E0)
#define RPG_GAMECORE_ROGUEMAGICPOWERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3EEB10)
