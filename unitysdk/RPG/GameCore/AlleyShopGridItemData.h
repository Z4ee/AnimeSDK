...
#define RPG_GAMECORE_ALLEYSHOPGRIDITEMDATA_METHOD_3_2E9E96982BCC171C_OFFSET UNITYSDK_OFFSET(0x19472360)
#define RPG_GAMECORE_ALLEYSHOPGRIDITEMDATA_METHOD_3_37D571B5773FCB59_OFFSET UNITYSDK_OFFSET(0x194668E0)
#define RPG_GAMECORE_ALLEYSHOPGRIDITEMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x194668D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AlleyShopGridItemData_TypeDefinitionIndex = 14902;
