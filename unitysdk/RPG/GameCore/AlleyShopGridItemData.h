...
#define RPG_GAMECORE_ALLEYSHOPGRIDITEMDATA_METHOD_3_2E9E96982BCC171C_OFFSET UNITYSDK_OFFSET(0x1869D4F0)
#define RPG_GAMECORE_ALLEYSHOPGRIDITEMDATA_METHOD_3_37D571B5773FCB59_OFFSET UNITYSDK_OFFSET(0x186912A0)
#define RPG_GAMECORE_ALLEYSHOPGRIDITEMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18691290)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AlleyShopGridItemData_TypeDefinitionIndex = 14838;
