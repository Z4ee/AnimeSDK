...
#define RPG_GAMECORE_ALLEYSHOPGRIDITEMDATA_METHOD_3_2E9E96982BCC171C_OFFSET UNITYSDK_OFFSET(0x1AE80700)
#define RPG_GAMECORE_ALLEYSHOPGRIDITEMDATA_METHOD_3_37D571B5773FCB59_OFFSET UNITYSDK_OFFSET(0x1AE74EF0)
#define RPG_GAMECORE_ALLEYSHOPGRIDITEMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE74EE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AlleyShopGridItemData_TypeDefinitionIndex = 15066;
