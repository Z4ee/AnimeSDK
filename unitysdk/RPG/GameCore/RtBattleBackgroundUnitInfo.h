...
#define RPG_GAMECORE_RTBATTLEBACKGROUNDUNITINFO_METHOD_2_ECA9BA2E3541CBB1_OFFSET UNITYSDK_OFFSET(0x18DC2810)
#define RPG_GAMECORE_RTBATTLEBACKGROUNDUNITINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18DC2A80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtBattleBackgroundUnitInfo_TypeDefinitionIndex = 17153;
