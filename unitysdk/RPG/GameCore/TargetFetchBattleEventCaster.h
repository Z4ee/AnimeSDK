...
#define RPG_GAMECORE_TARGETFETCHBATTLEEVENTCASTER_METHOD_4_2EE6A407800CC36C_OFFSET UNITYSDK_OFFSET(0x1D0B8150)
#define RPG_GAMECORE_TARGETFETCHBATTLEEVENTCASTER_METHOD_4_334CFFAA2E26C839_OFFSET UNITYSDK_OFFSET(0x1D0B8130)
#define RPG_GAMECORE_TARGETFETCHBATTLEEVENTCASTER_METHOD_4_7E7992C0C1CCC1FC_OFFSET UNITYSDK_OFFSET(0x1D0B80D0)
#define RPG_GAMECORE_TARGETFETCHBATTLEEVENTCASTER_METHOD_4_DDDF0CBA17DFD4D1_OFFSET UNITYSDK_OFFSET(0x1D0B8050)
#define RPG_GAMECORE_TARGETFETCHBATTLEEVENTCASTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0B80C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchBattleEventCaster_TypeDefinitionIndex = 23073;
