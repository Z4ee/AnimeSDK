...
#define RPG_GAMECORE_TARGETFETCHBATTLEEVENTCASTER_METHOD_4_79823351C2DB1EFE_OFFSET UNITYSDK_OFFSET(0x18EE3300)
#define RPG_GAMECORE_TARGETFETCHBATTLEEVENTCASTER_METHOD_4_7E7992C0C1CCC1FC_OFFSET UNITYSDK_OFFSET(0x18EDB5E0)
#define RPG_GAMECORE_TARGETFETCHBATTLEEVENTCASTER__CTOR_OFFSET UNITYSDK_OFFSET(0x18EDB590)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchBattleEventCaster_TypeDefinitionIndex = 22919;
