...
#define RPG_GAMECORE_RTCHARACTERVISUAL_METHOD_2_DD7184153E7829CA_OFFSET UNITYSDK_OFFSET(0x1CCE1D40)
#define RPG_GAMECORE_RTCHARACTERVISUAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1CCE26A0)
