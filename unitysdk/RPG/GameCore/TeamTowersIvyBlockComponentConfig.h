...
#define RPG_GAMECORE_TEAMTOWERSIVYBLOCKCOMPONENTCONFIG_METHOD_3_03E41278EEFA2A6F_OFFSET UNITYSDK_OFFSET(0x1C148A50)
#define RPG_GAMECORE_TEAMTOWERSIVYBLOCKCOMPONENTCONFIG_METHOD_3_906504D229E277DD_OFFSET UNITYSDK_OFFSET(0x1C148AB0)
#define RPG_GAMECORE_TEAMTOWERSIVYBLOCKCOMPONENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C148AA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TeamTowersIvyBlockComponentConfig_TypeDefinitionIndex = 18198;
