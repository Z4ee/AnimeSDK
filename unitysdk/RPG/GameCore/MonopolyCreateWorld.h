...
#define RPG_GAMECORE_MONOPOLYCREATEWORLD_METHOD_3_3A96485D0BCD8692_OFFSET UNITYSDK_OFFSET(0x17437970)
#define RPG_GAMECORE_MONOPOLYCREATEWORLD_METHOD_3_BB0AAAF0283EA64B_OFFSET UNITYSDK_OFFSET(0x174379F0)
#define RPG_GAMECORE_MONOPOLYCREATEWORLD__CTOR_OFFSET UNITYSDK_OFFSET(0x174379C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonopolyCreateWorld_TypeDefinitionIndex = 19264;
