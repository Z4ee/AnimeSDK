...
#define RPG_GAMECORE_MONOPOLYCREATEWORLD_METHOD_3_3A96485D0BCD8692_OFFSET UNITYSDK_OFFSET(0x18B44550)
#define RPG_GAMECORE_MONOPOLYCREATEWORLD_METHOD_3_BB0AAAF0283EA64B_OFFSET UNITYSDK_OFFSET(0x18B445D0)
#define RPG_GAMECORE_MONOPOLYCREATEWORLD__CTOR_OFFSET UNITYSDK_OFFSET(0x18B445A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonopolyCreateWorld_TypeDefinitionIndex = 19923;
