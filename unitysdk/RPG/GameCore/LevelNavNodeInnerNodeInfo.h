...
#define RPG_GAMECORE_LEVELNAVNODEINNERNODEINFO_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x17340960)
#define RPG_GAMECORE_LEVELNAVNODEINNERNODEINFO_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17340820)
#define RPG_GAMECORE_LEVELNAVNODEINNERNODEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x17340810)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelNavNodeInnerNodeInfo_TypeDefinitionIndex = 15745;
