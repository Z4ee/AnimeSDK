...
#define RPG_GAMECORE_HIPPLENINCIDENTRANDOMSTEPCONFIG_METHOD_3_2EB973A03E9E300B_OFFSET UNITYSDK_OFFSET(0x1D203B80)
#define RPG_GAMECORE_HIPPLENINCIDENTRANDOMSTEPCONFIG_METHOD_3_392FA295D624CBB5_OFFSET UNITYSDK_OFFSET(0x1D203B20)
#define RPG_GAMECORE_HIPPLENINCIDENTRANDOMSTEPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D203B70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HipplenIncidentRandomStepConfig_TypeDefinitionIndex = 16631;
