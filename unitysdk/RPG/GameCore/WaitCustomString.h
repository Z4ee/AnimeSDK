...
#define RPG_GAMECORE_WAITCUSTOMSTRING_GET_ISCLIENTONLY_OFFSET UNITYSDK_OFFSET(0x190FAA10)
#define RPG_GAMECORE_WAITCUSTOMSTRING_METHOD_3_77D53170EB7BF1DA_OFFSET UNITYSDK_OFFSET(0x190FA360)
#define RPG_GAMECORE_WAITCUSTOMSTRING_METHOD_3_CA89EF70B6C7BF4C_OFFSET UNITYSDK_OFFSET(0x190FA5A0)
#define RPG_GAMECORE_WAITCUSTOMSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x190FA570)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitCustomString_TypeDefinitionIndex = 22743;
