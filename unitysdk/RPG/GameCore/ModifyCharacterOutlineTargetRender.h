...
#define RPG_GAMECORE_MODIFYCHARACTEROUTLINETARGETRENDER_METHOD_3_4669A712B8A0C8F0_OFFSET UNITYSDK_OFFSET(0x1742B0A0)
#define RPG_GAMECORE_MODIFYCHARACTEROUTLINETARGETRENDER_METHOD_3_8CF042BB9F9138EF_OFFSET UNITYSDK_OFFSET(0x1742B020)
#define RPG_GAMECORE_MODIFYCHARACTEROUTLINETARGETRENDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1742B070)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyCharacterOutlineTargetRender_TypeDefinitionIndex = 20999;
