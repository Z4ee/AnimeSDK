...
#define RPG_GAMECORE_RTBATTLESTAGEBORNPOINTINFO_METHOD_2_5A1C92B128FEEB3F_OFFSET UNITYSDK_OFFSET(0x18DC5B70)
#define RPG_GAMECORE_RTBATTLESTAGEBORNPOINTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18DC5CB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtBattleStageBornPointInfo_TypeDefinitionIndex = 17151;
