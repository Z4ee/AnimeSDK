...
#define RPG_GAMECORE_MODIFIERCONFIG_METHOD_2_9C1AB945BD3BF1D2_OFFSET UNITYSDK_OFFSET(0x1994BF70)
#define RPG_GAMECORE_MODIFIERCONFIG_METHOD_2_E8D2312C4DC70C83_OFFSET UNITYSDK_OFFSET(0x1994BC10)
#define RPG_GAMECORE_MODIFIERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1994BF60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifierConfig_TypeDefinitionIndex = 14878;
