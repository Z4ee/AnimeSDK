...
#define RPG_GAMECORE_SPRITEPRESETSINFOLDER_METHOD_2_39AA5E2114E8DD53_OFFSET UNITYSDK_OFFSET(0x18E856B0)
#define RPG_GAMECORE_SPRITEPRESETSINFOLDER__CTOR_OFFSET UNITYSDK_OFFSET(0x18E857C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SpritePresetsInFolder_TypeDefinitionIndex = 23451;
