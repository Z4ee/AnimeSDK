...
#define RPG_GAMECORE_SPRITEPRESETSINFOLDER_METHOD_2_A2251CD588FEE1C9_OFFSET UNITYSDK_OFFSET(0x19CA0A40)
#define RPG_GAMECORE_SPRITEPRESETSINFOLDER__CTOR_OFFSET UNITYSDK_OFFSET(0x19CA0B40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SpritePresetsInFolder_TypeDefinitionIndex = 23092;
