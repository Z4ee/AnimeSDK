...
#define RPG_GAMECORE_SPRITEPRESETSINFOLDER_METHOD_2_A2251CD588FEE1C9_OFFSET UNITYSDK_OFFSET(0x1B0A4830)
#define RPG_GAMECORE_SPRITEPRESETSINFOLDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0A4930)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SpritePresetsInFolder_TypeDefinitionIndex = 23559;
