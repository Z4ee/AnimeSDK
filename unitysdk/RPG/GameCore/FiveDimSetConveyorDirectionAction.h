...
#define RPG_GAMECORE_FIVEDIMSETCONVEYORDIRECTIONACTION_METHOD_3_3BC319CDBF439CC9_OFFSET UNITYSDK_OFFSET(0x1BEB0480)
#define RPG_GAMECORE_FIVEDIMSETCONVEYORDIRECTIONACTION_METHOD_3_A703E40E139DEF8C_OFFSET UNITYSDK_OFFSET(0x1BEB03A0)
#define RPG_GAMECORE_FIVEDIMSETCONVEYORDIRECTIONACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEB0470)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSetConveyorDirectionAction_TypeDefinitionIndex = 17932;
