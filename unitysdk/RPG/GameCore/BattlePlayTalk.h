...
#define RPG_GAMECORE_BATTLEPLAYTALK_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1CE7D5D0)
#define RPG_GAMECORE_BATTLEPLAYTALK_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CE7D590)
#define RPG_GAMECORE_BATTLEPLAYTALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE7D5C0)
