...
#define RPG_GAMECORE_TRAVELSHIPHIDELANDONBTN_METHOD_3_040A960E10227C35_OFFSET UNITYSDK_OFFSET(0x190B5B00)
#define RPG_GAMECORE_TRAVELSHIPHIDELANDONBTN_METHOD_3_191AE080CBCD28FD_OFFSET UNITYSDK_OFFSET(0x190B59B0)
#define RPG_GAMECORE_TRAVELSHIPHIDELANDONBTN__CTOR_OFFSET UNITYSDK_OFFSET(0x190B5A70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TravelShipHideLandOnBtn_TypeDefinitionIndex = 19967;
