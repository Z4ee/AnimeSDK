...
#define RPG_GAMECORE_CHENLINGFESTOASTCONFIG_METHOD_2_F62BCDFB8497939B_OFFSET UNITYSDK_OFFSET(0x1CFB4C80)
#define RPG_GAMECORE_CHENLINGFESTOASTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFB5920)
