...
#define RPG_GAMECORE_CHENLINGFESTOASTCONFIG_METHOD_2_F62BCDFB8497939B_OFFSET UNITYSDK_OFFSET(0x1E016F80)
#define RPG_GAMECORE_CHENLINGFESTOASTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1E017C20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingFesToastConfig_TypeDefinitionIndex = 18238;
