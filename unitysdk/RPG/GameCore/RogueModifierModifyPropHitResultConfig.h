...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYPROPHITRESULTCONFIG_METHOD_3_094AF1BA44DC474D_OFFSET UNITYSDK_OFFSET(0x1D1642F0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYPROPHITRESULTCONFIG_METHOD_3_B9491B97601C0B49_OFFSET UNITYSDK_OFFSET(0x1D1642A0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYPROPHITRESULTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1642E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyPropHitResultConfig_TypeDefinitionIndex = 17237;
