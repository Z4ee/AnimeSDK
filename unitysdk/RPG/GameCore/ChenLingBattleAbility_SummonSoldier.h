...
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_SUMMONSOLDIER_METHOD_3_9BBC0ADFF83AF48F_OFFSET UNITYSDK_OFFSET(0x1C3786B0)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_SUMMONSOLDIER_METHOD_3_BF3B3DA5A2A9077F_OFFSET UNITYSDK_OFFSET(0x1C378710)
#define RPG_GAMECORE_CHENLINGBATTLEABILITY_SUMMONSOLDIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C378700)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleAbility_SummonSoldier_TypeDefinitionIndex = 15131;
