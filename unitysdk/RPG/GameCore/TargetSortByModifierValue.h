...
#define RPG_GAMECORE_TARGETSORTBYMODIFIERVALUE_METHOD_3_6026AA4DAA3C1AC2_OFFSET UNITYSDK_OFFSET(0x1E1C2B40)
#define RPG_GAMECORE_TARGETSORTBYMODIFIERVALUE_METHOD_3_63BDE955035B743C_OFFSET UNITYSDK_OFFSET(0x1E1C2AF0)
#define RPG_GAMECORE_TARGETSORTBYMODIFIERVALUE_METHOD_3_C51DEEAF9F01D3F9_OFFSET UNITYSDK_OFFSET(0x1E1C2980)
#define RPG_GAMECORE_TARGETSORTBYMODIFIERVALUE_METHOD_3_E3714B04A8EE1B1F_OFFSET UNITYSDK_OFFSET(0x1E1C2920)
#define RPG_GAMECORE_TARGETSORTBYMODIFIERVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1C2970)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetSortByModifierValue_TypeDefinitionIndex = 23713;
