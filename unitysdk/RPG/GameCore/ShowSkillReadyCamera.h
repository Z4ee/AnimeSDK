...
#define RPG_GAMECORE_SHOWSKILLREADYCAMERA_METHOD_3_17A10D50067AE99B_OFFSET UNITYSDK_OFFSET(0x1D530350)
#define RPG_GAMECORE_SHOWSKILLREADYCAMERA_METHOD_3_689FF340E1755C3C_OFFSET UNITYSDK_OFFSET(0x1D530390)
#define RPG_GAMECORE_SHOWSKILLREADYCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x1D530380)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowSkillReadyCamera_TypeDefinitionIndex = 22593;
