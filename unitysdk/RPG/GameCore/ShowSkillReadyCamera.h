...
#define RPG_GAMECORE_SHOWSKILLREADYCAMERA_METHOD_3_689FF340E1755C3C_OFFSET UNITYSDK_OFFSET(0x18E67640)
#define RPG_GAMECORE_SHOWSKILLREADYCAMERA_METHOD_3_F72AA0DA4503B9CA_OFFSET UNITYSDK_OFFSET(0x18E675C0)
#define RPG_GAMECORE_SHOWSKILLREADYCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x18E67610)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowSkillReadyCamera_TypeDefinitionIndex = 21764;
