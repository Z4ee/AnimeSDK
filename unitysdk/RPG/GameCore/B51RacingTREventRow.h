...
#define RPG_GAMECORE_B51RACINGTREVENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CE5E7C0)
#define RPG_GAMECORE_B51RACINGTREVENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE5EBA0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Single TypeCD; // 0x18
		::RPG::Client::TextID TRName; // 0x20
		::RPG::GameCore::B51RacingTREventType Type; // 0x30
		::System::UInt32 Priority; // 0x34
		::RPG::Client::TextID TRContent; // 0x38
		::System::UInt32 VoiceID; // 0x48
		::System::UInt32 ID; // 0x4C
		::System::UInt32 MaxCount; // 0x50
		::System::UInt32 DriverID; // 0x54
