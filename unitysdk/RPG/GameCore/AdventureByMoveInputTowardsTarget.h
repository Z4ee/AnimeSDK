...
#define RPG_GAMECORE_ADVENTUREBYMOVEINPUTTOWARDSTARGET_METHOD_4_318681CD671514DF_OFFSET UNITYSDK_OFFSET(0x1AE55990)
#define RPG_GAMECORE_ADVENTUREBYMOVEINPUTTOWARDSTARGET_METHOD_4_8A8099B2B0948B29_OFFSET UNITYSDK_OFFSET(0x1AE55740)
#define RPG_GAMECORE_ADVENTUREBYMOVEINPUTTOWARDSTARGET_METHOD_4_9436143EBEE9D814_OFFSET UNITYSDK_OFFSET(0x1AE55780)
#define RPG_GAMECORE_ADVENTUREBYMOVEINPUTTOWARDSTARGET_METHOD_4_D8DFFC86187881D9_OFFSET UNITYSDK_OFFSET(0x1AE55960)
#define RPG_GAMECORE_ADVENTUREBYMOVEINPUTTOWARDSTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE55770)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureByMoveInputTowardsTarget_TypeDefinitionIndex = 19446;
