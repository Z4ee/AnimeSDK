...
#define RPG_GAMECORE_VCAMERANOISECLOSEFORBATTLEDATAVIEW_METHOD_3_DC6A9A0F7B1AA352_OFFSET UNITYSDK_OFFSET(0x190EC910)
#define RPG_GAMECORE_VCAMERANOISECLOSEFORBATTLEDATAVIEW_METHOD_3_E8458AA8FEBCC5E6_OFFSET UNITYSDK_OFFSET(0x190EC800)
#define RPG_GAMECORE_VCAMERANOISECLOSEFORBATTLEDATAVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x190EC8E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VCameraNoiseCloseForBattleDataView_TypeDefinitionIndex = 22353;
