...
#define RPG_GAMECORE_SETUSETEMPORARYLOCKTARGET_METHOD_3_A43CE4B8DC109410_OFFSET UNITYSDK_OFFSET(0x176E65C0)
#define RPG_GAMECORE_SETUSETEMPORARYLOCKTARGET_METHOD_3_CA244DB90EE693B2_OFFSET UNITYSDK_OFFSET(0x176E6640)
#define RPG_GAMECORE_SETUSETEMPORARYLOCKTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x176E6610)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetUseTemporaryLockTarget_TypeDefinitionIndex = 20667;
