...
#define RPG_GAMECORE_SETUSETEMPORARYLOCKTARGET_METHOD_3_A43CE4B8DC109410_OFFSET UNITYSDK_OFFSET(0x18E49AD0)
#define RPG_GAMECORE_SETUSETEMPORARYLOCKTARGET_METHOD_3_CA244DB90EE693B2_OFFSET UNITYSDK_OFFSET(0x18E49B50)
#define RPG_GAMECORE_SETUSETEMPORARYLOCKTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x18E49B20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetUseTemporaryLockTarget_TypeDefinitionIndex = 21362;
