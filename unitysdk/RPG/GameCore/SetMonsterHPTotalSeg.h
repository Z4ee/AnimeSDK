...
#define RPG_GAMECORE_SETMONSTERHPTOTALSEG_METHOD_3_8B459EC1EC5A0CDF_OFFSET UNITYSDK_OFFSET(0x18E3AB70)
#define RPG_GAMECORE_SETMONSTERHPTOTALSEG_METHOD_3_BA2C3602F97BFBDF_OFFSET UNITYSDK_OFFSET(0x18E3AC40)
#define RPG_GAMECORE_SETMONSTERHPTOTALSEG__CTOR_OFFSET UNITYSDK_OFFSET(0x18E3ABF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetMonsterHPTotalSeg_TypeDefinitionIndex = 22089;
