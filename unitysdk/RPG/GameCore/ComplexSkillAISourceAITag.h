...
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEAITAG_METHOD_3_6086B73C11C6E5AA_OFFSET UNITYSDK_OFFSET(0x17125CC0)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEAITAG_METHOD_3_76195365D1F0B028_OFFSET UNITYSDK_OFFSET(0x17128B00)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEAITAG__CTOR_OFFSET UNITYSDK_OFFSET(0x17125CA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAISourceAITag_TypeDefinitionIndex = 14242;
