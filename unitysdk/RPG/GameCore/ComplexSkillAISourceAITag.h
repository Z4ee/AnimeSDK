...
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEAITAG_METHOD_3_6086B73C11C6E5AA_OFFSET UNITYSDK_OFFSET(0x1966C340)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEAITAG_METHOD_3_76195365D1F0B028_OFFSET UNITYSDK_OFFSET(0x1966F750)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEAITAG__CTOR_OFFSET UNITYSDK_OFFSET(0x1966C320)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAISourceAITag_TypeDefinitionIndex = 14777;
