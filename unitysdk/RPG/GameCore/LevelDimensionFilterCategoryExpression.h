...
#define RPG_GAMECORE_LEVELDIMENSIONFILTERCATEGORYEXPRESSION_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x173323B0)
#define RPG_GAMECORE_LEVELDIMENSIONFILTERCATEGORYEXPRESSION_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17332350)
#define RPG_GAMECORE_LEVELDIMENSIONFILTERCATEGORYEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x173323A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelDimensionFilterCategoryExpression_TypeDefinitionIndex = 15789;
