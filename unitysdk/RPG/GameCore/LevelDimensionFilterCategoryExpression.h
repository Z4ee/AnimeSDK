...
#define RPG_GAMECORE_LEVELDIMENSIONFILTERCATEGORYEXPRESSION_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1C111050)
#define RPG_GAMECORE_LEVELDIMENSIONFILTERCATEGORYEXPRESSION_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C110FF0)
#define RPG_GAMECORE_LEVELDIMENSIONFILTERCATEGORYEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C111040)
