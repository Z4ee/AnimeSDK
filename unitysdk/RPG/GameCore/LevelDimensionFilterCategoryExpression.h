...
#define RPG_GAMECORE_LEVELDIMENSIONFILTERCATEGORYEXPRESSION_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1D1CDAB0)
#define RPG_GAMECORE_LEVELDIMENSIONFILTERCATEGORYEXPRESSION_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D1CDA50)
#define RPG_GAMECORE_LEVELDIMENSIONFILTERCATEGORYEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1CDAA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelDimensionFilterCategoryExpression_TypeDefinitionIndex = 17002;
