...
#define RPG_GAMECORE_ROGUEWORKBENCHREFORGEGENBUFFLISTCONFIG_METHOD_2_EC1C91CBC43797E6_OFFSET UNITYSDK_OFFSET(0x1CCD0900)
#define RPG_GAMECORE_ROGUEWORKBENCHREFORGEGENBUFFLISTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CCD0940)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueWorkbenchReforgeGenBuffListConfig_TypeDefinitionIndex = 17807;
