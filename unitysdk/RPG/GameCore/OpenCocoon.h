...
#define RPG_GAMECORE_OPENCOCOON_METHOD_3_0E4B80EF56F3735F_OFFSET UNITYSDK_OFFSET(0x1BB00B40)
#define RPG_GAMECORE_OPENCOCOON_METHOD_3_9CB9B48AC89C2503_OFFSET UNITYSDK_OFFSET(0x1BB00C80)
#define RPG_GAMECORE_OPENCOCOON__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB00BF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OpenCocoon_TypeDefinitionIndex = 21276;
