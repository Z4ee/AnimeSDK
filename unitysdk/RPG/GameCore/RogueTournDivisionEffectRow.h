...
#define RPG_GAMECORE_ROGUETOURNDIVISIONEFFECTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1BB74330)
#define RPG_GAMECORE_ROGUETOURNDIVISIONEFFECTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB74510)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournDivisionEffectRow_TypeDefinitionIndex = 14365;
