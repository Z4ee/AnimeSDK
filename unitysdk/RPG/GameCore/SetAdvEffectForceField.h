...
#define RPG_GAMECORE_SETADVEFFECTFORCEFIELD_METHOD_3_AFDDAC5BDAE4169D_OFFSET UNITYSDK_OFFSET(0x19C27210)
#define RPG_GAMECORE_SETADVEFFECTFORCEFIELD_METHOD_3_C7A7ECF5F8192DE8_OFFSET UNITYSDK_OFFSET(0x19C27290)
#define RPG_GAMECORE_SETADVEFFECTFORCEFIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x19C27260)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetAdvEffectForceField_TypeDefinitionIndex = 21097;
