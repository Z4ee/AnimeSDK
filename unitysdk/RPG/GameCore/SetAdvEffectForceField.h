...
#define RPG_GAMECORE_SETADVEFFECTFORCEFIELD_METHOD_3_AFDDAC5BDAE4169D_OFFSET UNITYSDK_OFFSET(0x176A5620)
#define RPG_GAMECORE_SETADVEFFECTFORCEFIELD_METHOD_3_C7A7ECF5F8192DE8_OFFSET UNITYSDK_OFFSET(0x176A56A0)
#define RPG_GAMECORE_SETADVEFFECTFORCEFIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x176A5670)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetAdvEffectForceField_TypeDefinitionIndex = 20518;
