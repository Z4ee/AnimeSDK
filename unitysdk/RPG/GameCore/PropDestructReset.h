...
#define RPG_GAMECORE_PROPDESTRUCTRESET_METHOD_3_4CB1FB3D6F016DCE_OFFSET UNITYSDK_OFFSET(0x18C69EF0)
#define RPG_GAMECORE_PROPDESTRUCTRESET_METHOD_3_5C87F157B85E8958_OFFSET UNITYSDK_OFFSET(0x18C6A040)
#define RPG_GAMECORE_PROPDESTRUCTRESET__CTOR_OFFSET UNITYSDK_OFFSET(0x18C69FB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropDestructReset_TypeDefinitionIndex = 19112;
