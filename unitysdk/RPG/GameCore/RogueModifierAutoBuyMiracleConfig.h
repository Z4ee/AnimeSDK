...
#define RPG_GAMECORE_ROGUEMODIFIERAUTOBUYMIRACLECONFIG_METHOD_3_6DCA940B87EDE8C2_OFFSET UNITYSDK_OFFSET(0x1CFBF110)
#define RPG_GAMECORE_ROGUEMODIFIERAUTOBUYMIRACLECONFIG_METHOD_3_9014B969C424F1DE_OFFSET UNITYSDK_OFFSET(0x1CFBF160)
#define RPG_GAMECORE_ROGUEMODIFIERAUTOBUYMIRACLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFBF150)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierAutoBuyMiracleConfig_TypeDefinitionIndex = 17264;
