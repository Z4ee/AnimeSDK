...
#define RPG_GAMECORE_ROGUEMODIFIERAUTOBUYMIRACLECONFIG_METHOD_3_2BCB5C670EF41D47_OFFSET UNITYSDK_OFFSET(0x19B4E410)
#define RPG_GAMECORE_ROGUEMODIFIERAUTOBUYMIRACLECONFIG_METHOD_3_9014B969C424F1DE_OFFSET UNITYSDK_OFFSET(0x19B4E4E0)
#define RPG_GAMECORE_ROGUEMODIFIERAUTOBUYMIRACLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B4E490)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierAutoBuyMiracleConfig_TypeDefinitionIndex = 17102;
