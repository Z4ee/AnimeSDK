...
#define RPG_GAMECORE_FORCEKILL_METHOD_3_91F7456C7AD92702_OFFSET UNITYSDK_OFFSET(0x1DCB0AE0)
#define RPG_GAMECORE_FORCEKILL_METHOD_3_ABFEC6364D0D62E3_OFFSET UNITYSDK_OFFSET(0x1DCB0A90)
#define RPG_GAMECORE_FORCEKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCB0AD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ForceKill_TypeDefinitionIndex = 22426;
