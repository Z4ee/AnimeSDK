...
#define RPG_GAMECORE_ROGUEGUIDEACTIVITYPANELDATAROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1760B640)
#define RPG_GAMECORE_ROGUEGUIDEACTIVITYPANELDATAROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1760BBD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueGuideActivityPanelDataRow_TypeDefinitionIndex = 13450;
