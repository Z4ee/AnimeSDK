...
#define RPG_GAMECORE_CAKERACEGAMETARGETSELECTORCONFIG_METHOD_3_B380D52FD556E7CD_OFFSET UNITYSDK_OFFSET(0x1B2CE2D0)
#define RPG_GAMECORE_CAKERACEGAMETARGETSELECTORCONFIG_METHOD_3_F56B28BE09E0EF68_OFFSET UNITYSDK_OFFSET(0x1B2D20E0)
#define RPG_GAMECORE_CAKERACEGAMETARGETSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2CE2C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceGameTargetSelectorConfig_TypeDefinitionIndex = 17657;
