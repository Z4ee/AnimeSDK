...
#define RPG_GAMECORE_CAKERACEGAMETARGETSELECTORCONFIG_METHOD_3_B380D52FD556E7CD_OFFSET UNITYSDK_OFFSET(0x1876E2F0)
#define RPG_GAMECORE_CAKERACEGAMETARGETSELECTORCONFIG_METHOD_3_F56B28BE09E0EF68_OFFSET UNITYSDK_OFFSET(0x18772620)
#define RPG_GAMECORE_CAKERACEGAMETARGETSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1876E2E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceGameTargetSelectorConfig_TypeDefinitionIndex = 17482;
