...
#define RPG_GAMECORE_LEVELBATTLEEVENTCREATE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1BDEF750)
#define RPG_GAMECORE_LEVELBATTLEEVENTCREATE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x1BDEF700)
#define RPG_GAMECORE_LEVELBATTLEEVENTCREATE_INIT_OFFSET UNITYSDK_OFFSET(0x1BDEF6A0)
#define RPG_GAMECORE_LEVELBATTLEEVENTCREATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDEF7A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelBattleEventCreate_TypeDefinitionIndex = 54229;
