...
#define RPG_GAMECORE_LEVELBATTLEEVENTCREATE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x18451790)
#define RPG_GAMECORE_LEVELBATTLEEVENTCREATE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x18451740)
#define RPG_GAMECORE_LEVELBATTLEEVENTCREATE_INIT_OFFSET UNITYSDK_OFFSET(0x184516E0)
#define RPG_GAMECORE_LEVELBATTLEEVENTCREATE__CTOR_OFFSET UNITYSDK_OFFSET(0x184517E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelBattleEventCreate_TypeDefinitionIndex = 56950;
