...
#define RPG_GAMECORE_AVATARINTENSITYEFFECT_METHOD_3_8F92C683468AD394_OFFSET UNITYSDK_OFFSET(0x186C4C70)
#define RPG_GAMECORE_AVATARINTENSITYEFFECT_METHOD_3_A0BC7ACABF026AA5_OFFSET UNITYSDK_OFFSET(0x186C4CF0)
#define RPG_GAMECORE_AVATARINTENSITYEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x186C4CC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AvatarIntensityEffect_TypeDefinitionIndex = 21296;
