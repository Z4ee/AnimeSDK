...
#define RPG_GAMECORE_AVATARINTENSITYEFFECT_METHOD_3_A0BC7ACABF026AA5_OFFSET UNITYSDK_OFFSET(0x1C590940)
#define RPG_GAMECORE_AVATARINTENSITYEFFECT_METHOD_3_BBEF33D02676E246_OFFSET UNITYSDK_OFFSET(0x1C590900)
#define RPG_GAMECORE_AVATARINTENSITYEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C590930)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AvatarIntensityEffect_TypeDefinitionIndex = 22170;
