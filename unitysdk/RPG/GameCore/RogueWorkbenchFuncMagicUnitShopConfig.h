...
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCMAGICUNITSHOPCONFIG_METHOD_3_4A5551F42FDBA9E3_OFFSET UNITYSDK_OFFSET(0x176737F0)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCMAGICUNITSHOPCONFIG_METHOD_3_C6A9DF1246A6B967_OFFSET UNITYSDK_OFFSET(0x17673570)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCMAGICUNITSHOPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17673560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueWorkbenchFuncMagicUnitShopConfig_TypeDefinitionIndex = 16571;
