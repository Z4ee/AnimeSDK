...
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCMAGICUNITSHOPCONFIG_METHOD_3_4A5551F42FDBA9E3_OFFSET UNITYSDK_OFFSET(0x1CCD06E0)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCMAGICUNITSHOPCONFIG_METHOD_3_C6A9DF1246A6B967_OFFSET UNITYSDK_OFFSET(0x1CCD0460)
#define RPG_GAMECORE_ROGUEWORKBENCHFUNCMAGICUNITSHOPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CCD0450)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueWorkbenchFuncMagicUnitShopConfig_TypeDefinitionIndex = 17817;
