...
#define RPG_GAMECORE_BYANIMSTATELOGICTYPE_METHOD_4_3766BB5BA8BFCABC_OFFSET UNITYSDK_OFFSET(0x19CB9F20)
#define RPG_GAMECORE_BYANIMSTATELOGICTYPE_METHOD_4_8193A95F61FFFA39_OFFSET UNITYSDK_OFFSET(0x19CB9FC0)
#define RPG_GAMECORE_BYANIMSTATELOGICTYPE_METHOD_4_C586470227BFB2DF_OFFSET UNITYSDK_OFFSET(0x19CBA1F0)
#define RPG_GAMECORE_BYANIMSTATELOGICTYPE_METHOD_4_F8A91AD5F150D21A_OFFSET UNITYSDK_OFFSET(0x19CBA190)
#define RPG_GAMECORE_BYANIMSTATELOGICTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x19CB9F80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByAnimStateLogicType_TypeDefinitionIndex = 21610;
