...
#define RPG_GAMECORE_TALKTRIGGER_TALKNOTIFYPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xCF00D40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TalkTrigger_TalkNotifyParam_TypeDefinitionIndex = 53745;
