...
#define RPG_GAMECORE_SETLEVEL_METHOD_3_895507202C200CBE_OFFSET UNITYSDK_OFFSET(0x176D2F10)
#define RPG_GAMECORE_SETLEVEL_METHOD_3_E777FEB59BD32382_OFFSET UNITYSDK_OFFSET(0x176D2FE0)
#define RPG_GAMECORE_SETLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x176D2F90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetLevel_TypeDefinitionIndex = 21915;
