...
#define RPG_GAMECORE_SETLEVEL_METHOD_3_E777FEB59BD32382_OFFSET UNITYSDK_OFFSET(0x1D5036B0)
#define RPG_GAMECORE_SETLEVEL_METHOD_3_F64B3161F4373005_OFFSET UNITYSDK_OFFSET(0x1D503610)
#define RPG_GAMECORE_SETLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D503670)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetLevel_TypeDefinitionIndex = 23393;
