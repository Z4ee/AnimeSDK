...
#define RPG_GAMECORE_SETLEVEL_METHOD_3_895507202C200CBE_OFFSET UNITYSDK_OFFSET(0x18E36450)
#define RPG_GAMECORE_SETLEVEL_METHOD_3_E777FEB59BD32382_OFFSET UNITYSDK_OFFSET(0x18E36520)
#define RPG_GAMECORE_SETLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x18E364D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetLevel_TypeDefinitionIndex = 22653;
