...
#define RPG_GAMECORE_ADVTRACKNPCSOUNDTRIGGER_METHOD_3_10CA7E69E90AF326_OFFSET UNITYSDK_OFFSET(0x16F454D0)
#define RPG_GAMECORE_ADVTRACKNPCSOUNDTRIGGER_METHOD_3_A484DB9C10E848F0_OFFSET UNITYSDK_OFFSET(0x16F45550)
#define RPG_GAMECORE_ADVTRACKNPCSOUNDTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x16F45520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvTrackNpcSoundTrigger_TypeDefinitionIndex = 20377;
