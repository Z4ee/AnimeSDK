...
#define RPG_GAMECORE_ADVTRACKNPCSOUNDTRIGGER_METHOD_3_10CA7E69E90AF326_OFFSET UNITYSDK_OFFSET(0x18667690)
#define RPG_GAMECORE_ADVTRACKNPCSOUNDTRIGGER_METHOD_3_A484DB9C10E848F0_OFFSET UNITYSDK_OFFSET(0x18667710)
#define RPG_GAMECORE_ADVTRACKNPCSOUNDTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x186676E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvTrackNpcSoundTrigger_TypeDefinitionIndex = 21059;
