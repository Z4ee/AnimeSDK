...
#define RPG_GAMECORE_ADVTRACKNPCSOUNDTRIGGER_METHOD_3_A484DB9C10E848F0_OFFSET UNITYSDK_OFFSET(0x1AE48EC0)
#define RPG_GAMECORE_ADVTRACKNPCSOUNDTRIGGER_METHOD_3_FFC52772E40F7ADF_OFFSET UNITYSDK_OFFSET(0x1AE48E80)
#define RPG_GAMECORE_ADVTRACKNPCSOUNDTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE48EB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvTrackNpcSoundTrigger_TypeDefinitionIndex = 21382;
