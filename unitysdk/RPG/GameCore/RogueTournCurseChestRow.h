...
#define RPG_GAMECORE_ROGUETOURNCURSECHESTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1BB73890)
#define RPG_GAMECORE_ROGUETOURNCURSECHESTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB741D0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::RogueTournCurseChestType Type; // 0x24
		::RPG::GameCore::FixPoint ParamValue1; // 0x28
		::System::UInt32 SubDescDisplayID; // 0x30
		::System::UInt32 MainTitleDisplayID; // 0x34
