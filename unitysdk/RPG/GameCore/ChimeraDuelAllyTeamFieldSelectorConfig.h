...
#define RPG_GAMECORE_CHIMERADUELALLYTEAMFIELDSELECTORCONFIG_METHOD_3_8B1829E6C2466097_OFFSET UNITYSDK_OFFSET(0x187F4BC0)
#define RPG_GAMECORE_CHIMERADUELALLYTEAMFIELDSELECTORCONFIG_METHOD_3_F04B45A590CCD326_OFFSET UNITYSDK_OFFSET(0x187F4B20)
#define RPG_GAMECORE_CHIMERADUELALLYTEAMFIELDSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x187F4BB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelAllyTeamFieldSelectorConfig_TypeDefinitionIndex = 15102;
