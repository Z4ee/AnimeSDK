...
#define RPG_GAMECORE_CHIMERADUELALLYTEAMFIELDSELECTORCONFIG_METHOD_3_8B1829E6C2466097_OFFSET UNITYSDK_OFFSET(0x1C390C30)
#define RPG_GAMECORE_CHIMERADUELALLYTEAMFIELDSELECTORCONFIG_METHOD_3_F04B45A590CCD326_OFFSET UNITYSDK_OFFSET(0x1C390B90)
#define RPG_GAMECORE_CHIMERADUELALLYTEAMFIELDSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C390C20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelAllyTeamFieldSelectorConfig_TypeDefinitionIndex = 15329;
