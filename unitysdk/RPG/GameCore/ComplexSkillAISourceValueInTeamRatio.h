...
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEVALUEINTEAMRATIO_METHOD_3_0B6818C94A40ED23_OFFSET UNITYSDK_OFFSET(0x18830590)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEVALUEINTEAMRATIO_METHOD_3_DFE5DEE1A1CFEA7B_OFFSET UNITYSDK_OFFSET(0x1882F410)
#define RPG_GAMECORE_COMPLEXSKILLAISOURCEVALUEINTEAMRATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x1882F3E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAISourceValueInTeamRatio_TypeDefinitionIndex = 14695;
