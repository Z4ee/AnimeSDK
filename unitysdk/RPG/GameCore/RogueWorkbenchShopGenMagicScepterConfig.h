...
#define RPG_GAMECORE_ROGUEWORKBENCHSHOPGENMAGICSCEPTERCONFIG_METHOD_2_7BC8C424409BBB22_OFFSET UNITYSDK_OFFSET(0x17673AB0)
#define RPG_GAMECORE_ROGUEWORKBENCHSHOPGENMAGICSCEPTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17673AF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueWorkbenchShopGenMagicScepterConfig_TypeDefinitionIndex = 16568;
