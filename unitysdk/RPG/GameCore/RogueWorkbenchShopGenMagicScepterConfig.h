...
#define RPG_GAMECORE_ROGUEWORKBENCHSHOPGENMAGICSCEPTERCONFIG_METHOD_2_7BC8C424409BBB22_OFFSET UNITYSDK_OFFSET(0x1BB82660)
#define RPG_GAMECORE_ROGUEWORKBENCHSHOPGENMAGICSCEPTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB826A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueWorkbenchShopGenMagicScepterConfig_TypeDefinitionIndex = 17297;
