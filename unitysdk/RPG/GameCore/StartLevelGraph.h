...
#define RPG_GAMECORE_STARTLEVELGRAPH_METHOD_3_143460D953587014_OFFSET UNITYSDK_OFFSET(0x1B0BD8E0)
#define RPG_GAMECORE_STARTLEVELGRAPH_METHOD_3_9CC01F9835518113_OFFSET UNITYSDK_OFFSET(0x1B0BD8A0)
#define RPG_GAMECORE_STARTLEVELGRAPH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0BD8D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StartLevelGraph_TypeDefinitionIndex = 22575;
