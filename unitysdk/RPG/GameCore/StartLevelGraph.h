...
#define RPG_GAMECORE_STARTLEVELGRAPH_METHOD_3_143460D953587014_OFFSET UNITYSDK_OFFSET(0x19CB7B60)
#define RPG_GAMECORE_STARTLEVELGRAPH_METHOD_3_5F8291923D34B3E2_OFFSET UNITYSDK_OFFSET(0x19CB7AE0)
#define RPG_GAMECORE_STARTLEVELGRAPH__CTOR_OFFSET UNITYSDK_OFFSET(0x19CB7B30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StartLevelGraph_TypeDefinitionIndex = 22138;
