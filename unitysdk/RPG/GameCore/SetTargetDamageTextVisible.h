...
#define RPG_GAMECORE_SETTARGETDAMAGETEXTVISIBLE_METHOD_3_6B1429BCB33EE10D_OFFSET UNITYSDK_OFFSET(0x176E1D00)
#define RPG_GAMECORE_SETTARGETDAMAGETEXTVISIBLE_METHOD_3_DDB3B3C8BF9989D1_OFFSET UNITYSDK_OFFSET(0x176E1C80)
#define RPG_GAMECORE_SETTARGETDAMAGETEXTVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x176E1CD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetTargetDamageTextVisible_TypeDefinitionIndex = 21432;
