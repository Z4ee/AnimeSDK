...
#define RPG_GAMECORE_RAIDSCENETRANSFER_METHOD_3_4E98A592D7704178_OFFSET UNITYSDK_OFFSET(0x1B9B4ED0)
#define RPG_GAMECORE_RAIDSCENETRANSFER_METHOD_3_CF8C152494AA643C_OFFSET UNITYSDK_OFFSET(0x1B9B4E80)
#define RPG_GAMECORE_RAIDSCENETRANSFER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9B4EC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RaidSceneTransfer_TypeDefinitionIndex = 19711;
