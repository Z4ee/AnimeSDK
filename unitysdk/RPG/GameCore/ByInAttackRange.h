...
#define RPG_GAMECORE_BYINATTACKRANGE_METHOD_4_06C81865ACFA862D_OFFSET UNITYSDK_OFFSET(0x1CF2A5E0)
#define RPG_GAMECORE_BYINATTACKRANGE_METHOD_4_3111899144208336_OFFSET UNITYSDK_OFFSET(0x1CF2A2B0)
#define RPG_GAMECORE_BYINATTACKRANGE_METHOD_4_6271A56AB7F12775_OFFSET UNITYSDK_OFFSET(0x1CF2A570)
#define RPG_GAMECORE_BYINATTACKRANGE_METHOD_4_A5B2595ECEB880D5_OFFSET UNITYSDK_OFFSET(0x1CF2A1F0)
#define RPG_GAMECORE_BYINATTACKRANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF2A260)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByInAttackRange_TypeDefinitionIndex = 19800;
