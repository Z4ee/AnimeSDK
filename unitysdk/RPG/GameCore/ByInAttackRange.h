...
#define RPG_GAMECORE_BYINATTACKRANGE_METHOD_4_3111899144208336_OFFSET UNITYSDK_OFFSET(0x1874C4C0)
#define RPG_GAMECORE_BYINATTACKRANGE_METHOD_4_743F1238F3F27593_OFFSET UNITYSDK_OFFSET(0x1874C330)
#define RPG_GAMECORE_BYINATTACKRANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1874C410)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByInAttackRange_TypeDefinitionIndex = 18955;
