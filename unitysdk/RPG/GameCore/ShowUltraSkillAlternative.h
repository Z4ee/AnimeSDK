...
#define RPG_GAMECORE_SHOWULTRASKILLALTERNATIVE_METHOD_3_1E8DBE193337542F_OFFSET UNITYSDK_OFFSET(0x1BE4A3F0)
#define RPG_GAMECORE_SHOWULTRASKILLALTERNATIVE_METHOD_3_FDDF8122D025C114_OFFSET UNITYSDK_OFFSET(0x1BE4A3B0)
#define RPG_GAMECORE_SHOWULTRASKILLALTERNATIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE4A3E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowUltraSkillAlternative_TypeDefinitionIndex = 22100;
