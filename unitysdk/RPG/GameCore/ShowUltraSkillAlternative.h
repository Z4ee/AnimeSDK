...
#define RPG_GAMECORE_SHOWULTRASKILLALTERNATIVE_METHOD_3_1E8DBE193337542F_OFFSET UNITYSDK_OFFSET(0x18E6B0B0)
#define RPG_GAMECORE_SHOWULTRASKILLALTERNATIVE_METHOD_3_C82E2027BEB3D5BE_OFFSET UNITYSDK_OFFSET(0x18E6B030)
#define RPG_GAMECORE_SHOWULTRASKILLALTERNATIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E6B080)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowUltraSkillAlternative_TypeDefinitionIndex = 21838;
