...
#define RPG_GAMECORE_MARBLEADDSKILL_METHOD_3_05591B011D32BA82_OFFSET UNITYSDK_OFFSET(0x18A95C80)
#define RPG_GAMECORE_MARBLEADDSKILL_METHOD_3_DFB39F021567D056_OFFSET UNITYSDK_OFFSET(0x18A95BA0)
#define RPG_GAMECORE_MARBLEADDSKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x18A95C30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MarbleAddSkill_TypeDefinitionIndex = 15956;
