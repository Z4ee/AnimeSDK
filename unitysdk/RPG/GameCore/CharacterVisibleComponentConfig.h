...
#define RPG_GAMECORE_CHARACTERVISIBLECOMPONENTCONFIG_METHOD_3_8D4C99D8B12F143E_OFFSET UNITYSDK_OFFSET(0x187D9440)
#define RPG_GAMECORE_CHARACTERVISIBLECOMPONENTCONFIG_METHOD_3_D2295086E6D98C2F_OFFSET UNITYSDK_OFFSET(0x187D93A0)
#define RPG_GAMECORE_CHARACTERVISIBLECOMPONENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x187D9430)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterVisibleComponentConfig_TypeDefinitionIndex = 15679;
