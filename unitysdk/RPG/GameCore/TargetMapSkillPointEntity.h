...
#define RPG_GAMECORE_TARGETMAPSKILLPOINTENTITY_METHOD_3_1884732C7C743BEC_OFFSET UNITYSDK_OFFSET(0x177C3AB0)
#define RPG_GAMECORE_TARGETMAPSKILLPOINTENTITY_METHOD_3_AA112902E5586378_OFFSET UNITYSDK_OFFSET(0x177C3BE0)
#define RPG_GAMECORE_TARGETMAPSKILLPOINTENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x177C3BC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapSkillPointEntity_TypeDefinitionIndex = 22227;
