...
#define RPG_GAMECORE_TARGETMAPSKILLPOINTENTITY_METHOD_3_8E2C7B937F1B85A4_OFFSET UNITYSDK_OFFSET(0x1D0C3610)
#define RPG_GAMECORE_TARGETMAPSKILLPOINTENTITY_METHOD_3_AA112902E5586378_OFFSET UNITYSDK_OFFSET(0x1D0C3520)
#define RPG_GAMECORE_TARGETMAPSKILLPOINTENTITY_METHOD_3_C25F67AFED5DF7B5_OFFSET UNITYSDK_OFFSET(0x1D0C3440)
#define RPG_GAMECORE_TARGETMAPSKILLPOINTENTITY_METHOD_3_F253D5962D391CED_OFFSET UNITYSDK_OFFSET(0x1D0C35E0)
#define RPG_GAMECORE_TARGETMAPSKILLPOINTENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0C3510)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapSkillPointEntity_TypeDefinitionIndex = 23095;
