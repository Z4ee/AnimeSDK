...
#define RPG_GAMECORE_BATTLEPASSWEEKCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x194D42F0)
#define RPG_GAMECORE_BATTLEPASSWEEKCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x194D4430)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattlePassWeekConfigRow_TypeDefinitionIndex = 12258;
