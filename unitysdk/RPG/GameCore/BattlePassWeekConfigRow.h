...
#define RPG_GAMECORE_BATTLEPASSWEEKCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18700EE0)
#define RPG_GAMECORE_BATTLEPASSWEEKCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18701020)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BattlePassWeekConfigRow_TypeDefinitionIndex = 12170;
