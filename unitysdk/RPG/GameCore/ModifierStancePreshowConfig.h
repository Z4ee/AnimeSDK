...
#define RPG_GAMECORE_MODIFIERSTANCEPRESHOWCONFIG_METHOD_2_FF40999DEA72A6DE_OFFSET UNITYSDK_OFFSET(0x1D1B3770)
#define RPG_GAMECORE_MODIFIERSTANCEPRESHOWCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1B3C50)
