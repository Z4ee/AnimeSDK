...
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMERWAITINLINE_METHOD_4_A1AF32191CE601D5_OFFSET UNITYSDK_OFFSET(0x19C00050)
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMERWAITINLINE_METHOD_4_CBE6029EECA5462A_OFFSET UNITYSDK_OFFSET(0x19C17C80)
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMERWAITINLINE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C00000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_ElfCustomerWaitInline_TypeDefinitionIndex = 20332;
