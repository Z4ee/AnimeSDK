...
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMERWAITINLINE_METHOD_4_A1AF32191CE601D5_OFFSET UNITYSDK_OFFSET(0x17683070)
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMERWAITINLINE_METHOD_4_CBE6029EECA5462A_OFFSET UNITYSDK_OFFSET(0x17696AD0)
#define RPG_GAMECORE_ST_MAIN_ELFCUSTOMERWAITINLINE__CTOR_OFFSET UNITYSDK_OFFSET(0x17683020)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_ElfCustomerWaitInline_TypeDefinitionIndex = 19706;
