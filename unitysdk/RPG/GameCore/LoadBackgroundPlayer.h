...
#define RPG_GAMECORE_LOADBACKGROUNDPLAYER_METHOD_3_18628BA4224CB958_OFFSET UNITYSDK_OFFSET(0x1DD71470)
#define RPG_GAMECORE_LOADBACKGROUNDPLAYER_METHOD_3_F5F5210F78AE67EB_OFFSET UNITYSDK_OFFSET(0x1DD714C0)
#define RPG_GAMECORE_LOADBACKGROUNDPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD714B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoadBackgroundPlayer_TypeDefinitionIndex = 19985;
