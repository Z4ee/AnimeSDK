...
#define RPG_GAMECORE_LOADBACKGROUNDPLAYER_METHOD_3_E71936373F5BE682_OFFSET UNITYSDK_OFFSET(0x198A4CC0)
#define RPG_GAMECORE_LOADBACKGROUNDPLAYER_METHOD_3_F5F5210F78AE67EB_OFFSET UNITYSDK_OFFSET(0x198A4D40)
#define RPG_GAMECORE_LOADBACKGROUNDPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x198A4D10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LoadBackgroundPlayer_TypeDefinitionIndex = 19087;
