...
#define RPG_GAMECORE_PHOTOGRAPHSETUNIQUENAMECONFIG_METHOD_2_2E3515EEAB576122_OFFSET UNITYSDK_OFFSET(0x1B4C2A70)
#define RPG_GAMECORE_PHOTOGRAPHSETUNIQUENAMECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4C37C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotoGraphSetUniqueNameConfig_TypeDefinitionIndex = 20825;
