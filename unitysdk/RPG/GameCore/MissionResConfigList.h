...
#define RPG_GAMECORE_MISSIONRESCONFIGLIST_METHOD_2_F45B0C1AF5574D6E_OFFSET UNITYSDK_OFFSET(0x1D1AC690)
#define RPG_GAMECORE_MISSIONRESCONFIGLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1AC7C0)
