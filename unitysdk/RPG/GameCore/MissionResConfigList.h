...
#define RPG_GAMECORE_MISSIONRESCONFIGLIST_METHOD_2_F45B0C1AF5574D6E_OFFSET UNITYSDK_OFFSET(0x1D2A5F00)
#define RPG_GAMECORE_MISSIONRESCONFIGLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2A6030)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MissionResConfigList_TypeDefinitionIndex = 18804;
