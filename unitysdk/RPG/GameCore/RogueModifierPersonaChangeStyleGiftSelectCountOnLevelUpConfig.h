...
#define RPG_GAMECORE_ROGUEMODIFIERPERSONACHANGESTYLEGIFTSELECTCOUNTONLEVELUPCONFIG_METHOD_3_7D08009170ABAC05_OFFSET UNITYSDK_OFFSET(0x18D43AC0)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONACHANGESTYLEGIFTSELECTCOUNTONLEVELUPCONFIG_METHOD_3_A213D59F64491FFC_OFFSET UNITYSDK_OFFSET(0x18D43B90)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONACHANGESTYLEGIFTSELECTCOUNTONLEVELUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D43B40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierPersonaChangeStyleGiftSelectCountOnLevelUpConfig_TypeDefinitionIndex = 16929;
