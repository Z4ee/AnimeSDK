...
#define RPG_GAMECORE_ROGUEMODIFIERPERSONACHANGESTYLEGIFTSELECTCOUNTONLEVELUPCONFIG_METHOD_3_7D08009170ABAC05_OFFSET UNITYSDK_OFFSET(0x19B99AA0)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONACHANGESTYLEGIFTSELECTCOUNTONLEVELUPCONFIG_METHOD_3_A213D59F64491FFC_OFFSET UNITYSDK_OFFSET(0x19B99B70)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONACHANGESTYLEGIFTSELECTCOUNTONLEVELUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B99B20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierPersonaChangeStyleGiftSelectCountOnLevelUpConfig_TypeDefinitionIndex = 16944;
