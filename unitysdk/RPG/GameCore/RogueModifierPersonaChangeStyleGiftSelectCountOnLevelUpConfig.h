...
#define RPG_GAMECORE_ROGUEMODIFIERPERSONACHANGESTYLEGIFTSELECTCOUNTONLEVELUPCONFIG_METHOD_3_33FE2E4AE6A46100_OFFSET UNITYSDK_OFFSET(0x1D164F00)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONACHANGESTYLEGIFTSELECTCOUNTONLEVELUPCONFIG_METHOD_3_A213D59F64491FFC_OFFSET UNITYSDK_OFFSET(0x1D164F50)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONACHANGESTYLEGIFTSELECTCOUNTONLEVELUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D164F40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierPersonaChangeStyleGiftSelectCountOnLevelUpConfig_TypeDefinitionIndex = 17106;
