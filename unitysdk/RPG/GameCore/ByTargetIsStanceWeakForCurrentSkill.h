...
#define RPG_GAMECORE_BYTARGETISSTANCEWEAKFORCURRENTSKILL_METHOD_4_0E351D4F5DC9BA17_OFFSET UNITYSDK_OFFSET(0x1B2BF570)
#define RPG_GAMECORE_BYTARGETISSTANCEWEAKFORCURRENTSKILL_METHOD_4_28F9C2F199DC9481_OFFSET UNITYSDK_OFFSET(0x1B2BF380)
#define RPG_GAMECORE_BYTARGETISSTANCEWEAKFORCURRENTSKILL_METHOD_4_A2B196AFF01C6EEC_OFFSET UNITYSDK_OFFSET(0x1B2BF340)
#define RPG_GAMECORE_BYTARGETISSTANCEWEAKFORCURRENTSKILL_METHOD_4_E867A10AB3004F41_OFFSET UNITYSDK_OFFSET(0x1B2BF540)
#define RPG_GAMECORE_BYTARGETISSTANCEWEAKFORCURRENTSKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2BF370)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByTargetIsStanceWeakForCurrentSkill_TypeDefinitionIndex = 22672;
