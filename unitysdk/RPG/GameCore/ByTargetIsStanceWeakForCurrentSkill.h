...
#define RPG_GAMECORE_BYTARGETISSTANCEWEAKFORCURRENTSKILL_METHOD_4_28F9C2F199DC9481_OFFSET UNITYSDK_OFFSET(0x18761580)
#define RPG_GAMECORE_BYTARGETISSTANCEWEAKFORCURRENTSKILL_METHOD_4_D356ECA6D57867AD_OFFSET UNITYSDK_OFFSET(0x187614B0)
#define RPG_GAMECORE_BYTARGETISSTANCEWEAKFORCURRENTSKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x18761530)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByTargetIsStanceWeakForCurrentSkill_TypeDefinitionIndex = 22483;
