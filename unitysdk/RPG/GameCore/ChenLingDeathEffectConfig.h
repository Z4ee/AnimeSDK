...
#define RPG_GAMECORE_CHENLINGDEATHEFFECTCONFIG_METHOD_2_3141CE82353F699B_OFFSET UNITYSDK_OFFSET(0x1E00C480)
#define RPG_GAMECORE_CHENLINGDEATHEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0121F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingDeathEffectConfig_TypeDefinitionIndex = 15514;
