...
#define RPG_GAMECORE_CHENLINGDEATHEFFECTCONFIG_METHOD_2_3141CE82353F699B_OFFSET UNITYSDK_OFFSET(0x187E38B0)
#define RPG_GAMECORE_CHENLINGDEATHEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x187E98E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingDeathEffectConfig_TypeDefinitionIndex = 14849;
