...
#define RPG_GAMECORE_CHENLINGDEATHEFFECTCONFIG_METHOD_2_3141CE82353F699B_OFFSET UNITYSDK_OFFSET(0x19626C90)
#define RPG_GAMECORE_CHENLINGDEATHEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19627180)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingDeathEffectConfig_TypeDefinitionIndex = 14913;
