...
#define RPG_GAMECORE_REMOVEGLOBALTIMESLOW_METHOD_3_04D5E4002A0EAFDD_OFFSET UNITYSDK_OFFSET(0x17598450)
#define RPG_GAMECORE_REMOVEGLOBALTIMESLOW_METHOD_3_3A34B6945CE0B921_OFFSET UNITYSDK_OFFSET(0x175983D0)
#define RPG_GAMECORE_REMOVEGLOBALTIMESLOW__CTOR_OFFSET UNITYSDK_OFFSET(0x17598420)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveGlobalTimeSlow_TypeDefinitionIndex = 22102;
