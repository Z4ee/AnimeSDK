...
#define RPG_GAMECORE_REMOVEGLOBALTIMESLOW_METHOD_3_04D5E4002A0EAFDD_OFFSET UNITYSDK_OFFSET(0x1DB8D910)
#define RPG_GAMECORE_REMOVEGLOBALTIMESLOW_METHOD_3_275EB5DEE5A7D26A_OFFSET UNITYSDK_OFFSET(0x1DB8D8C0)
#define RPG_GAMECORE_REMOVEGLOBALTIMESLOW__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB8D900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveGlobalTimeSlow_TypeDefinitionIndex = 23554;
