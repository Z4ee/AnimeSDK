...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONROOMCARDLEVELCHANGECONFIG_METHOD_3_AC95E7BCBE9BACEB_OFFSET UNITYSDK_OFFSET(0x1CFC0E00)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONROOMCARDLEVELCHANGECONFIG_METHOD_3_F193A074E7C3FFEF_OFFSET UNITYSDK_OFFSET(0x1CFC0E50)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONROOMCARDLEVELCHANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFC0E40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnRoomCardLevelChangeConfig_TypeDefinitionIndex = 16977;
