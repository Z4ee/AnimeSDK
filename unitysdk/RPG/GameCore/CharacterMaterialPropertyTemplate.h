...
#define RPG_GAMECORE_CHARACTERMATERIALPROPERTYTEMPLATE_METHOD_2_1AC4D3E5F0D754F9_OFFSET UNITYSDK_OFFSET(0x1B724F40)
#define RPG_GAMECORE_CHARACTERMATERIALPROPERTYTEMPLATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B724F80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterMaterialPropertyTemplate_TypeDefinitionIndex = 16749;
