...
#define RPG_GAMECORE_CHARACTERMATERIALPROPERTYTEMPLATE_METHOD_2_1AC4D3E5F0D754F9_OFFSET UNITYSDK_OFFSET(0x1960F230)
#define RPG_GAMECORE_CHARACTERMATERIALPROPERTYTEMPLATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1960F270)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterMaterialPropertyTemplate_TypeDefinitionIndex = 16587;
