...
#define RPG_GAMECORE_FATETEXTDYNAMICPARAMBUFFNAME_METHOD_3_2E8A357E0124CC3A_OFFSET UNITYSDK_OFFSET(0x188DB450)
#define RPG_GAMECORE_FATETEXTDYNAMICPARAMBUFFNAME_METHOD_3_61DA450864B86EDC_OFFSET UNITYSDK_OFFSET(0x188DB4B0)
#define RPG_GAMECORE_FATETEXTDYNAMICPARAMBUFFNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x188DB4A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateTextDynamicParamBuffName_TypeDefinitionIndex = 15767;
