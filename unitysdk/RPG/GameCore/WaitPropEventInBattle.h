...
#define RPG_GAMECORE_WAITPROPEVENTINBATTLE_METHOD_4_1C72DDD187DFDED7_OFFSET UNITYSDK_OFFSET(0x1DEBEDB0)
#define RPG_GAMECORE_WAITPROPEVENTINBATTLE_METHOD_4_7C7D71FC0C19755E_OFFSET UNITYSDK_OFFSET(0x1DEBED60)
#define RPG_GAMECORE_WAITPROPEVENTINBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEBEDA0)
