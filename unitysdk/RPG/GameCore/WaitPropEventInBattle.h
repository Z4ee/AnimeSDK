...
#define RPG_GAMECORE_WAITPROPEVENTINBATTLE_METHOD_4_02EED219AB03BA11_OFFSET UNITYSDK_OFFSET(0x19E5DCE0)
#define RPG_GAMECORE_WAITPROPEVENTINBATTLE_METHOD_4_1C72DDD187DFDED7_OFFSET UNITYSDK_OFFSET(0x19E5DDC0)
#define RPG_GAMECORE_WAITPROPEVENTINBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x19E5DD60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitPropEventInBattle_TypeDefinitionIndex = 21068;
