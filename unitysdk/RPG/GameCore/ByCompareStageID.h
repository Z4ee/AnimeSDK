...
#define RPG_GAMECORE_BYCOMPARESTAGEID_METHOD_4_3947FBDA61BDB682_OFFSET UNITYSDK_OFFSET(0x1873C6A0)
#define RPG_GAMECORE_BYCOMPARESTAGEID_METHOD_4_DB250444F20A9FBE_OFFSET UNITYSDK_OFFSET(0x1873C5D0)
#define RPG_GAMECORE_BYCOMPARESTAGEID__CTOR_OFFSET UNITYSDK_OFFSET(0x1873C650)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareStageID_TypeDefinitionIndex = 21455;
