...
#define RPG_GAMECORE_ROGUEDYNAMICARGCONFIG_METHOD_2_B41333CE3D3840B3_OFFSET UNITYSDK_OFFSET(0x1D3E2DC0)
#define RPG_GAMECORE_ROGUEDYNAMICARGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3E2E00)
