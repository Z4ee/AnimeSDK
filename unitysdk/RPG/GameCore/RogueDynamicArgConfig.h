...
#define RPG_GAMECORE_ROGUEDYNAMICARGCONFIG_METHOD_2_B41333CE3D3840B3_OFFSET UNITYSDK_OFFSET(0x1CFAB1A0)
#define RPG_GAMECORE_ROGUEDYNAMICARGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFAB1E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueDynamicArgConfig_TypeDefinitionIndex = 19049;
