...
#define RPG_GAMECORE_SETCAMERAROOTFOLLOW_METHOD_3_6C6F7006846FFB80_OFFSET UNITYSDK_OFFSET(0x18E0ED70)
#define RPG_GAMECORE_SETCAMERAROOTFOLLOW_METHOD_3_7F8D4D40AE6300F1_OFFSET UNITYSDK_OFFSET(0x18E0EDF0)
#define RPG_GAMECORE_SETCAMERAROOTFOLLOW__CTOR_OFFSET UNITYSDK_OFFSET(0x18E0EDC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetCameraRootFollow_TypeDefinitionIndex = 21805;
