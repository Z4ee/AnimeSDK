...
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_HPFULL_METHOD_4_2D1D988684420400_OFFSET UNITYSDK_OFFSET(0x1886FE90)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_HPFULL_METHOD_4_524798FA21E548DA_OFFSET UNITYSDK_OFFSET(0x1886D320)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_HPFULL__CTOR_OFFSET UNITYSDK_OFFSET(0x1886D2D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatPredicateConfig_HPFull_TypeDefinitionIndex = 15272;
