...
#define RPG_GAMECORE_TARGETFETCHACTIONDELAYEXCEED_METHOD_4_1E9DFBC8FCE1D1C5_OFFSET UNITYSDK_OFFSET(0x1B44E6D0)
#define RPG_GAMECORE_TARGETFETCHACTIONDELAYEXCEED_METHOD_4_719288726689CCA8_OFFSET UNITYSDK_OFFSET(0x1B44E730)
#define RPG_GAMECORE_TARGETFETCHACTIONDELAYEXCEED_METHOD_4_A8D4E9517F6490F5_OFFSET UNITYSDK_OFFSET(0x1B44E750)
#define RPG_GAMECORE_TARGETFETCHACTIONDELAYEXCEED_METHOD_4_B0459859EECCCA00_OFFSET UNITYSDK_OFFSET(0x1B44E650)
#define RPG_GAMECORE_TARGETFETCHACTIONDELAYEXCEED__CTOR_OFFSET UNITYSDK_OFFSET(0x1B44E6C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchActionDelayExceed_TypeDefinitionIndex = 23084;
