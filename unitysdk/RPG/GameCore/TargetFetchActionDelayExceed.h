...
#define RPG_GAMECORE_TARGETFETCHACTIONDELAYEXCEED_METHOD_4_1E9DFBC8FCE1D1C5_OFFSET UNITYSDK_OFFSET(0x177BA3E0)
#define RPG_GAMECORE_TARGETFETCHACTIONDELAYEXCEED_METHOD_4_989FF27FCCA724D3_OFFSET UNITYSDK_OFFSET(0x177BA2D0)
#define RPG_GAMECORE_TARGETFETCHACTIONDELAYEXCEED__CTOR_OFFSET UNITYSDK_OFFSET(0x177BA390)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchActionDelayExceed_TypeDefinitionIndex = 22216;
