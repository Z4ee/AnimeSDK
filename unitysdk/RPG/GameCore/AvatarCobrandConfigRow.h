...
#define RPG_GAMECORE_AVATARCOBRANDCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19490E50)
#define RPG_GAMECORE_AVATARCOBRANDCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19491030)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AvatarCobrandConfigRow_TypeDefinitionIndex = 12094;

	class AvatarCobrandConfigRow : public ::System::Object
	{
	public:
		::System::String* AudioLanguage; // 0x10
		::System::String* OffStateName; // 0x18
		::System::String* OnStateName; // 0x20
		::System::String* StateGroupName; // 0x28
