...
#define RPG_GAMECORE_AVATARCOBRANDCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A070F30)
#define RPG_GAMECORE_AVATARCOBRANDCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A071110)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AvatarCobrandConfigRow_TypeDefinitionIndex = 12226;
