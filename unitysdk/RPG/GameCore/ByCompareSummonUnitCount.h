...
#define RPG_GAMECORE_BYCOMPARESUMMONUNITCOUNT_METHOD_4_B150BD843973F232_OFFSET UNITYSDK_OFFSET(0x1873DD00)
#define RPG_GAMECORE_BYCOMPARESUMMONUNITCOUNT_METHOD_4_D65C8F8F1838411A_OFFSET UNITYSDK_OFFSET(0x1873DE20)
#define RPG_GAMECORE_BYCOMPARESUMMONUNITCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1873DDA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareSummonUnitCount_TypeDefinitionIndex = 19185;
