...
#define RPG_GAMECORE_BYCOMPARESUMMONUNITCOUNT_METHOD_4_B150BD843973F232_OFFSET UNITYSDK_OFFSET(0x17019A20)
#define RPG_GAMECORE_BYCOMPARESUMMONUNITCOUNT_METHOD_4_D65C8F8F1838411A_OFFSET UNITYSDK_OFFSET(0x17019B40)
#define RPG_GAMECORE_BYCOMPARESUMMONUNITCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x17019AC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareSummonUnitCount_TypeDefinitionIndex = 18532;
