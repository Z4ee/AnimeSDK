...
#define RPG_GAMECORE_BYCOMPARESUMMONUNITCOUNT_METHOD_4_41E14F5B051FFE73_OFFSET UNITYSDK_OFFSET(0x1CF02F30)
#define RPG_GAMECORE_BYCOMPARESUMMONUNITCOUNT_METHOD_4_7349E7104DD7D4AE_OFFSET UNITYSDK_OFFSET(0x1CF02C30)
#define RPG_GAMECORE_BYCOMPARESUMMONUNITCOUNT_METHOD_4_D65C8F8F1838411A_OFFSET UNITYSDK_OFFSET(0x1CF02CD0)
#define RPG_GAMECORE_BYCOMPARESUMMONUNITCOUNT_METHOD_4_F1BBE788FE3F3112_OFFSET UNITYSDK_OFFSET(0x1CF02F90)
#define RPG_GAMECORE_BYCOMPARESUMMONUNITCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF02C90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareSummonUnitCount_TypeDefinitionIndex = 20012;
