...
#define RPG_GAMECORE_MAZEPUZZLEORIGAMIROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D280610)
#define RPG_GAMECORE_MAZEPUZZLEORIGAMIROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2809D0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 ColonyID; // 0x18
		::System::UInt32 MirrorMainPropID; // 0x1C
		::System::UInt32 MainPropID; // 0x20
		::System::UInt32 FloorID; // 0x24
		::System::UInt32 GroupID; // 0x28
		::System::UInt32 NpcInstanceID; // 0x2C
		...
		::RPG::GameCore::PropState TargetSubPropState; // 0x40
