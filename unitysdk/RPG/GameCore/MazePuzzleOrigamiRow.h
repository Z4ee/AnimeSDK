...
#define RPG_GAMECORE_MAZEPUZZLEORIGAMIROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19907360)
#define RPG_GAMECORE_MAZEPUZZLEORIGAMIROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19907720)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MazePuzzleOrigamiRow_TypeDefinitionIndex = 13404;
	...
	public:
		...
		::System::UInt32 MirrorMainPropID; // 0x1C
		::System::UInt32 SubPropID; // 0x20
		::RPG::GameCore::PropState TargetSubPropState; // 0x24
		::RPG::GameCore::PropState CreateNpcPropState; // 0x28
		::System::UInt32 GroupID; // 0x2C
		::System::UInt32 MirrorGroupID; // 0x30
		::System::UInt32 ColonyID; // 0x34
		::System::UInt32 FloorID; // 0x38
		::System::UInt32 NpcGroupID; // 0x3C
		::System::UInt32 MainPropID; // 0x40
