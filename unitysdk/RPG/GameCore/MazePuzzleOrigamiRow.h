...
#define RPG_GAMECORE_MAZEPUZZLEORIGAMIROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18AD7860)
#define RPG_GAMECORE_MAZEPUZZLEORIGAMIROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18AD7C70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MazePuzzleOrigamiRow_TypeDefinitionIndex = 13330;
	...
	public:
		...
		::System::UInt32 ColonyID; // 0x1C
		::System::UInt32 MirrorMainPropID; // 0x20
		::System::UInt32 SubPropID; // 0x24
		::System::UInt32 MirrorGroupID; // 0x28
		::System::UInt32 NpcGroupID; // 0x2C
		::System::UInt32 FloorID; // 0x30
		::RPG::GameCore::PropState TargetSubPropState; // 0x34
