...
#define RPG_GAMECORE_NPCMONSTERTRACKQUESTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1BAFCF20)
#define RPG_GAMECORE_NPCMONSTERTRACKQUESTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1BAFD550)

namespace RPG::GameCore
{
	inline static constexpr unsigned int NpcMonsterTrackQuestRow_TypeDefinitionIndex = 13997;

	class NpcMonsterTrackQuestRow : public ::System::Object
	{
	public:
		::System::UInt32 QuestID; // 0x10
		::System::UInt32 MapInfoID; // 0x14
		::System::UInt32 NpcMonsterTrackID; // 0x18
