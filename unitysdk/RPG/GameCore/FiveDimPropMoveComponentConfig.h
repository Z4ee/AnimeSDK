...
#define RPG_GAMECORE_FIVEDIMPROPMOVECOMPONENTCONFIG_METHOD_3_21AB0C0CE7AF0EE4_OFFSET UNITYSDK_OFFSET(0x1D873910)
#define RPG_GAMECORE_FIVEDIMPROPMOVECOMPONENTCONFIG_METHOD_3_DB74FBEAC82C1BD7_OFFSET UNITYSDK_OFFSET(0x1D873950)
#define RPG_GAMECORE_FIVEDIMPROPMOVECOMPONENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D873940)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimPropMoveComponentConfig_TypeDefinitionIndex = 18353;
