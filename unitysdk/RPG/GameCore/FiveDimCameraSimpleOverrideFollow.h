...
#define RPG_GAMECORE_FIVEDIMCAMERASIMPLEOVERRIDEFOLLOW_METHOD_2_3B46AB74DAFF5737_OFFSET UNITYSDK_OFFSET(0x1972AD80)
#define RPG_GAMECORE_FIVEDIMCAMERASIMPLEOVERRIDEFOLLOW__CTOR_OFFSET UNITYSDK_OFFSET(0x197349F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimCameraSimpleOverrideFollow_TypeDefinitionIndex = 17718;
