...
#define RPG_GAMECORE_FIVEDIMCAMERASIMPLEOVERRIDEFOLLOW_METHOD_2_3B46AB74DAFF5737_OFFSET UNITYSDK_OFFSET(0x188ED9C0)
#define RPG_GAMECORE_FIVEDIMCAMERASIMPLEOVERRIDEFOLLOW__CTOR_OFFSET UNITYSDK_OFFSET(0x188F9250)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimCameraSimpleOverrideFollow_TypeDefinitionIndex = 17690;
