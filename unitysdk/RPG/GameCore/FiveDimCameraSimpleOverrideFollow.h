...
#define RPG_GAMECORE_FIVEDIMCAMERASIMPLEOVERRIDEFOLLOW_METHOD_2_3B46AB74DAFF5737_OFFSET UNITYSDK_OFFSET(0x1BA8A480)
#define RPG_GAMECORE_FIVEDIMCAMERASIMPLEOVERRIDEFOLLOW__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA8C450)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimCameraSimpleOverrideFollow_TypeDefinitionIndex = 17892;
