...
#define RPG_GAMECORE_LEVELENTITYSPAWNCONFIG_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1D1D0560)
#define RPG_GAMECORE_LEVELENTITYSPAWNCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D1D0330)
#define RPG_GAMECORE_LEVELENTITYSPAWNCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1D0550)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelEntitySpawnConfig_TypeDefinitionIndex = 17052;
