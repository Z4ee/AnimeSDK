...
#define RPG_GAMECORE_LEVELENTITYSPAWNCONFIG_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x173347D0)
#define RPG_GAMECORE_LEVELENTITYSPAWNCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x173345A0)
#define RPG_GAMECORE_LEVELENTITYSPAWNCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x173347C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelEntitySpawnConfig_TypeDefinitionIndex = 15840;
