...
#define RPG_GAMECORE_PLAYPENACONYCHRONICLEPERFORMANCE_METHOD_3_28766F2E9949F0B4_OFFSET UNITYSDK_OFFSET(0x18C101A0)
#define RPG_GAMECORE_PLAYPENACONYCHRONICLEPERFORMANCE_METHOD_3_7B370E5FDA18E2C3_OFFSET UNITYSDK_OFFSET(0x18C10120)
#define RPG_GAMECORE_PLAYPENACONYCHRONICLEPERFORMANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x18C10170)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayPenaconyChroniclePerformance_TypeDefinitionIndex = 20678;
