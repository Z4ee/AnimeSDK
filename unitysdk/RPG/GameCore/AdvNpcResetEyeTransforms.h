...
#define RPG_GAMECORE_ADVNPCRESETEYETRANSFORMS_METHOD_3_1BC9914B570A3433_OFFSET UNITYSDK_OFFSET(0x16F394F0)
#define RPG_GAMECORE_ADVNPCRESETEYETRANSFORMS_METHOD_3_C823DCC58EB852D7_OFFSET UNITYSDK_OFFSET(0x16F39570)
#define RPG_GAMECORE_ADVNPCRESETEYETRANSFORMS__CTOR_OFFSET UNITYSDK_OFFSET(0x16F39540)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvNpcResetEyeTransforms_TypeDefinitionIndex = 20623;
