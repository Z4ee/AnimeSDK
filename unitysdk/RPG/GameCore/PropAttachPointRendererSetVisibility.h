...
#define RPG_GAMECORE_PROPATTACHPOINTRENDERERSETVISIBILITY_METHOD_3_5AAFEFBCAF9C2EF9_OFFSET UNITYSDK_OFFSET(0x18C65210)
#define RPG_GAMECORE_PROPATTACHPOINTRENDERERSETVISIBILITY_METHOD_3_C6D1FA0308AFBC93_OFFSET UNITYSDK_OFFSET(0x18C650C0)
#define RPG_GAMECORE_PROPATTACHPOINTRENDERERSETVISIBILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x18C65180)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropAttachPointRendererSetVisibility_TypeDefinitionIndex = 19351;
