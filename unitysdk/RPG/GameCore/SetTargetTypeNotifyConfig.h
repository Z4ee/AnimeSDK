...
#define RPG_GAMECORE_SETTARGETTYPENOTIFYCONFIG_METHOD_2_F18C2B5E0F736C1D_OFFSET UNITYSDK_OFFSET(0x18E46690)
#define RPG_GAMECORE_SETTARGETTYPENOTIFYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18E46750)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetTargetTypeNotifyConfig_TypeDefinitionIndex = 16053;
