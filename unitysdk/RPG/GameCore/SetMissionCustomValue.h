...
#define RPG_GAMECORE_SETMISSIONCUSTOMVALUE_METHOD_3_19B996F949A9161A_OFFSET UNITYSDK_OFFSET(0x176D5710)
#define RPG_GAMECORE_SETMISSIONCUSTOMVALUE_METHOD_3_ADEFD935BB7E0461_OFFSET UNITYSDK_OFFSET(0x176D5690)
#define RPG_GAMECORE_SETMISSIONCUSTOMVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x176D56E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetMissionCustomValue_TypeDefinitionIndex = 18736;
