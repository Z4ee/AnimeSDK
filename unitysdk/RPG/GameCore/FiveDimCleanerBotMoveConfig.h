...
#define RPG_GAMECORE_FIVEDIMCLEANERBOTMOVECONFIG_METHOD_3_AD2BBCC8679D1007_OFFSET UNITYSDK_OFFSET(0x1D0A5F60)
#define RPG_GAMECORE_FIVEDIMCLEANERBOTMOVECONFIG_METHOD_3_F1873F39647755EB_OFFSET UNITYSDK_OFFSET(0x1D0A6010)
#define RPG_GAMECORE_FIVEDIMCLEANERBOTMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0A5FD0)
