...
#define RPG_GAMECORE_FIVEDIMCLEANERBOTMOVECONFIG_METHOD_3_AD2BBCC8679D1007_OFFSET UNITYSDK_OFFSET(0x1E0E6530)
#define RPG_GAMECORE_FIVEDIMCLEANERBOTMOVECONFIG_METHOD_3_F1873F39647755EB_OFFSET UNITYSDK_OFFSET(0x1E0E65E0)
#define RPG_GAMECORE_FIVEDIMCLEANERBOTMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0E65A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimCleanerBotMoveConfig_TypeDefinitionIndex = 16514;
