...
#define RPG_GAMECORE_GROUPFILTEREXPRESSION_METHOD_2_249542CE6EBA02E9_OFFSET UNITYSDK_OFFSET(0x1D080410)
#define RPG_GAMECORE_GROUPFILTEREXPRESSION_METHOD_2_71FB6D7059D1051B_OFFSET UNITYSDK_OFFSET(0x1D080570)
#define RPG_GAMECORE_GROUPFILTEREXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D080400)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GroupFilterExpression_TypeDefinitionIndex = 16697;
