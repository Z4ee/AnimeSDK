...
#define RPG_GAMECORE_GROUPFILTEREXPRESSION_METHOD_2_249542CE6EBA02E9_OFFSET UNITYSDK_OFFSET(0x1D3C2500)
#define RPG_GAMECORE_GROUPFILTEREXPRESSION_METHOD_2_71FB6D7059D1051B_OFFSET UNITYSDK_OFFSET(0x1D3C2660)
#define RPG_GAMECORE_GROUPFILTEREXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3C24F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GroupFilterExpression_TypeDefinitionIndex = 17199;
