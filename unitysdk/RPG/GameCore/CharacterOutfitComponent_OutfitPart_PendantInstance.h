...
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_OUTFITPART_PENDANTINSTANCE_APPLY_OFFSET UNITYSDK_OFFSET(0xE5757A0)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_OUTFITPART_PENDANTINSTANCE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xE575400)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_OUTFITPART_PENDANTINSTANCE_GET_ISEFFECT_OFFSET UNITYSDK_OFFSET(0xE5725F0)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_OUTFITPART_PENDANTINSTANCE_LOAD_OFFSET UNITYSDK_OFFSET(0xE575630)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_OUTFITPART_PENDANTINSTANCE_POSTAPPLY_OFFSET UNITYSDK_OFFSET(0xE572B10)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_OUTFITPART_PENDANTINSTANCE_REMOVE_OFFSET UNITYSDK_OFFSET(0xE575EB0)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_OUTFITPART_PENDANTINSTANCE_RESETSPRINGBONE_OFFSET UNITYSDK_OFFSET(0xE576260)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_OUTFITPART_PENDANTINSTANCE_SETANIMATORSPEED_OFFSET UNITYSDK_OFFSET(0xE576470)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_OUTFITPART_PENDANTINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0xE5752E0)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_OUTFITPART_PENDANTINSTANCE__POSTAPPLY_B__12_0_OFFSET UNITYSDK_OFFSET(0xE5764F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterOutfitComponent_OutfitPart_PendantInstance_TypeDefinitionIndex = 57373;

	class CharacterOutfitComponent_OutfitPart_PendantInstance : public ::System::Object
	{
	public:
		::RPG::GameCore::CharacterOutfitPendant* Config; // 0x10
		::UnityEngine::GameObject* GoInstance; // 0x18
		::RPG::Client::TriggerEffectParamsRef EffectParams; // 0x20
		::RPG::Client::MonoEffectPluginFollow* EffectFollow; // 0x30
		::RPG::GameCore::CharacterOutfitComponent_OutfitPartAsset_2<::UnityEngine::GameObject*, ::RPG::GameCore::CharacterOutfitPendant*>* PrefabAsset; // 0x38
