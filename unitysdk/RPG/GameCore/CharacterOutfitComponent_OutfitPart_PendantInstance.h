...
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_OUTFITPART_PENDANTINSTANCE_APPLY_OFFSET UNITYSDK_OFFSET(0x12248880)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_OUTFITPART_PENDANTINSTANCE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x122484D0)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_OUTFITPART_PENDANTINSTANCE_GET_ISEFFECT_OFFSET UNITYSDK_OFFSET(0x12245690)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_OUTFITPART_PENDANTINSTANCE_LOAD_OFFSET UNITYSDK_OFFSET(0x12248710)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_OUTFITPART_PENDANTINSTANCE_POSTAPPLY_OFFSET UNITYSDK_OFFSET(0x12245BB0)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_OUTFITPART_PENDANTINSTANCE_REMOVE_OFFSET UNITYSDK_OFFSET(0x12248F90)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_OUTFITPART_PENDANTINSTANCE_RESETSPRINGBONE_OFFSET UNITYSDK_OFFSET(0x12249340)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_OUTFITPART_PENDANTINSTANCE_SETANIMATORSPEED_OFFSET UNITYSDK_OFFSET(0x12249550)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_OUTFITPART_PENDANTINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x122483B0)
#define RPG_GAMECORE_CHARACTEROUTFITCOMPONENT_OUTFITPART_PENDANTINSTANCE__POSTAPPLY_B__12_0_OFFSET UNITYSDK_OFFSET(0x122495D0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::Client::MonoEffectPluginFollow* EffectFollow; // 0x20
