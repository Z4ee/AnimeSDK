...
#define RPG_GAMECORE_SETDYNAMICVALUEPARAMBASE_METHOD_3_1C785B2217367844_OFFSET UNITYSDK_OFFSET(0x176C89E0)
#define RPG_GAMECORE_SETDYNAMICVALUEPARAMBASE_METHOD_3_649B80729416D0BD_OFFSET UNITYSDK_OFFSET(0x176C8EA0)
#define RPG_GAMECORE_SETDYNAMICVALUEPARAMBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x176C3830)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueParamBase_TypeDefinitionIndex = 19932;
