...
#define RPG_GAMECORE_SO_KEEPDISTANCEMOVETO_METHOD_4_6781C6220E925787_OFFSET UNITYSDK_OFFSET(0x18DDF9A0)
#define RPG_GAMECORE_SO_KEEPDISTANCEMOVETO_METHOD_4_CE108CCD9C25A940_OFFSET UNITYSDK_OFFSET(0x18DE0BB0)
#define RPG_GAMECORE_SO_KEEPDISTANCEMOVETO__CTOR_OFFSET UNITYSDK_OFFSET(0x18DDF960)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SO_KeepDistanceMoveTo_TypeDefinitionIndex = 18986;
