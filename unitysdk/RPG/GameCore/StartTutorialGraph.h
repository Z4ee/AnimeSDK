...
#define RPG_GAMECORE_STARTTUTORIALGRAPH_METHOD_3_7DF792D41D759FB7_OFFSET UNITYSDK_OFFSET(0x1B0BF590)
#define RPG_GAMECORE_STARTTUTORIALGRAPH_METHOD_3_D216B5657C867488_OFFSET UNITYSDK_OFFSET(0x1B0BF5D0)
#define RPG_GAMECORE_STARTTUTORIALGRAPH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0BF5C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StartTutorialGraph_TypeDefinitionIndex = 22576;
