...
#define RPG_GAMECORE_STARTTUTORIALGRAPH_METHOD_3_95B483C229A1777E_OFFSET UNITYSDK_OFFSET(0x17776CB0)
#define RPG_GAMECORE_STARTTUTORIALGRAPH_METHOD_3_D216B5657C867488_OFFSET UNITYSDK_OFFSET(0x17776D30)
#define RPG_GAMECORE_STARTTUTORIALGRAPH__CTOR_OFFSET UNITYSDK_OFFSET(0x17776D00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StartTutorialGraph_TypeDefinitionIndex = 21645;
