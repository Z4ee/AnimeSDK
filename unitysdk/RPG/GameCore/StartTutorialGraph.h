...
#define RPG_GAMECORE_STARTTUTORIALGRAPH_METHOD_3_95B483C229A1777E_OFFSET UNITYSDK_OFFSET(0x19CB9B80)
#define RPG_GAMECORE_STARTTUTORIALGRAPH_METHOD_3_D216B5657C867488_OFFSET UNITYSDK_OFFSET(0x19CB9C00)
#define RPG_GAMECORE_STARTTUTORIALGRAPH__CTOR_OFFSET UNITYSDK_OFFSET(0x19CB9BD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StartTutorialGraph_TypeDefinitionIndex = 22139;
