...
#define RPG_GAMECORE_PROPSETSCENETVMENU_METHOD_3_9A98BBD15F84CBC7_OFFSET UNITYSDK_OFFSET(0x18C74CD0)
#define RPG_GAMECORE_PROPSETSCENETVMENU_METHOD_3_D4A342F7A7819275_OFFSET UNITYSDK_OFFSET(0x18C74E20)
#define RPG_GAMECORE_PROPSETSCENETVMENU__CTOR_OFFSET UNITYSDK_OFFSET(0x18C74D90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropSetSceneTVMenu_TypeDefinitionIndex = 20828;
