...
#define RPG_GAMECORE_PROPSETSCENETVMENU_METHOD_3_D4A342F7A7819275_OFFSET UNITYSDK_OFFSET(0x1BA29620)
#define RPG_GAMECORE_PROPSETSCENETVMENU_METHOD_3_EA861CC247F51F5B_OFFSET UNITYSDK_OFFSET(0x1BA295A0)
#define RPG_GAMECORE_PROPSETSCENETVMENU__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA295F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropSetSceneTVMenu_TypeDefinitionIndex = 21166;
