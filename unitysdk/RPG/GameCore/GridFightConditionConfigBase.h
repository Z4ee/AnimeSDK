...
#define RPG_GAMECORE_GRIDFIGHTCONDITIONCONFIGBASE_METHOD_5_7475CB6159A86560_OFFSET UNITYSDK_OFFSET(0x172556C0)
#define RPG_GAMECORE_GRIDFIGHTCONDITIONCONFIGBASE_METHOD_5_D7E23F6DEED95B39_OFFSET UNITYSDK_OFFSET(0x17256120)
#define RPG_GAMECORE_GRIDFIGHTCONDITIONCONFIGBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x17254950)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightConditionConfigBase_TypeDefinitionIndex = 17745;
