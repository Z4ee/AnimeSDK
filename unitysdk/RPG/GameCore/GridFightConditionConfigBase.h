...
#define RPG_GAMECORE_GRIDFIGHTCONDITIONCONFIGBASE_METHOD_5_7475CB6159A86560_OFFSET UNITYSDK_OFFSET(0x189A5090)
#define RPG_GAMECORE_GRIDFIGHTCONDITIONCONFIGBASE_METHOD_5_D7E23F6DEED95B39_OFFSET UNITYSDK_OFFSET(0x189A5C00)
#define RPG_GAMECORE_GRIDFIGHTCONDITIONCONFIGBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x189A4150)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightConditionConfigBase_TypeDefinitionIndex = 18358;
