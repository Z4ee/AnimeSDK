...
#define RPG_GAMECORE_ROGUEMODIFIERSHOPBUYRETURNMONEYCONFIG_METHOD_3_36689C4D784A55D1_OFFSET UNITYSDK_OFFSET(0x18D46E20)
#define RPG_GAMECORE_ROGUEMODIFIERSHOPBUYRETURNMONEYCONFIG_METHOD_3_8E9891BDCB1D04E8_OFFSET UNITYSDK_OFFSET(0x18D46EF0)
#define RPG_GAMECORE_ROGUEMODIFIERSHOPBUYRETURNMONEYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D46EA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierShopBuyReturnMoneyConfig_TypeDefinitionIndex = 17090;
