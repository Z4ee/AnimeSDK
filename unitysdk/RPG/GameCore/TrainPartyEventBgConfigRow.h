...
#define RPG_GAMECORE_TRAINPARTYEVENTBGCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D5DD230)
#define RPG_GAMECORE_TRAINPARTYEVENTBGCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5DD3F0)
