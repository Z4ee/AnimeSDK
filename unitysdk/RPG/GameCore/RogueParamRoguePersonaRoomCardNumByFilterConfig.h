...
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONAROOMCARDNUMBYFILTERCONFIG_METHOD_6_75FE562CABC8E5B5_OFFSET UNITYSDK_OFFSET(0x1D176E50)
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONAROOMCARDNUMBYFILTERCONFIG_METHOD_6_D089BD4BE8F92EB9_OFFSET UNITYSDK_OFFSET(0x1D176EA0)
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONAROOMCARDNUMBYFILTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D176E90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamRoguePersonaRoomCardNumByFilterConfig_TypeDefinitionIndex = 19082;
