...
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONAROOMCARDNUMBYFILTERCONFIG_METHOD_6_864735A481E9D15F_OFFSET UNITYSDK_OFFSET(0x19BB1600)
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONAROOMCARDNUMBYFILTERCONFIG_METHOD_6_D089BD4BE8F92EB9_OFFSET UNITYSDK_OFFSET(0x19BB18B0)
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONAROOMCARDNUMBYFILTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19BB1780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamRoguePersonaRoomCardNumByFilterConfig_TypeDefinitionIndex = 18801;
