...
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONAROOMCARDNUMBYFILTERCONFIG_METHOD_6_864735A481E9D15F_OFFSET UNITYSDK_OFFSET(0x1764E530)
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONAROOMCARDNUMBYFILTERCONFIG_METHOD_6_D089BD4BE8F92EB9_OFFSET UNITYSDK_OFFSET(0x1764E7E0)
#define RPG_GAMECORE_ROGUEPARAMROGUEPERSONAROOMCARDNUMBYFILTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1764E6B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamRoguePersonaRoomCardNumByFilterConfig_TypeDefinitionIndex = 18189;
