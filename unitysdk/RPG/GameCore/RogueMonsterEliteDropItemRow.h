...
#define RPG_GAMECORE_ROGUEMONSTERELITEDROPITEMROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D1669D0)
#define RPG_GAMECORE_ROGUEMONSTERELITEDROPITEMROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D166AE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueMonsterEliteDropItemRow_TypeDefinitionIndex = 14108;
