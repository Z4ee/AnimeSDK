...
#define RPG_GAMECORE_LEVELAUDIOTRIGGER_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1B02E0A0)
#define RPG_GAMECORE_LEVELAUDIOTRIGGER_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B02E060)
#define RPG_GAMECORE_LEVELAUDIOTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B02E090)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelAudioTrigger_TypeDefinitionIndex = 22136;
