...
#define RPG_GAMECORE_LEVELAUDIOTRIGGER_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x18A3CB80)
#define RPG_GAMECORE_LEVELAUDIOTRIGGER_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18A3CB00)
#define RPG_GAMECORE_LEVELAUDIOTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x18A3CB50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelAudioTrigger_TypeDefinitionIndex = 21885;
