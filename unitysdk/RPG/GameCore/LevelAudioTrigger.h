...
#define RPG_GAMECORE_LEVELAUDIOTRIGGER_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1C10D5E0)
#define RPG_GAMECORE_LEVELAUDIOTRIGGER_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C10D5A0)
#define RPG_GAMECORE_LEVELAUDIOTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C10D5D0)
