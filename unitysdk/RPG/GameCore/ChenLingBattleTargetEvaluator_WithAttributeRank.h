...
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_WITHATTRIBUTERANK_METHOD_3_5A62B5EF45517B2E_OFFSET UNITYSDK_OFFSET(0x19624BE0)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_WITHATTRIBUTERANK_METHOD_3_8F0D95823DFEB9CC_OFFSET UNITYSDK_OFFSET(0x19624B80)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_WITHATTRIBUTERANK__CTOR_OFFSET UNITYSDK_OFFSET(0x19624BD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleTargetEvaluator_WithAttributeRank_TypeDefinitionIndex = 14999;
