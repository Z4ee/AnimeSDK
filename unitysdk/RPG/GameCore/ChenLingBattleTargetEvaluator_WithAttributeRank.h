...
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_WITHATTRIBUTERANK_METHOD_3_5A62B5EF45517B2E_OFFSET UNITYSDK_OFFSET(0x1C37F520)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_WITHATTRIBUTERANK_METHOD_3_8F0D95823DFEB9CC_OFFSET UNITYSDK_OFFSET(0x1C37F4C0)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_WITHATTRIBUTERANK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C37F510)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleTargetEvaluator_WithAttributeRank_TypeDefinitionIndex = 15163;
