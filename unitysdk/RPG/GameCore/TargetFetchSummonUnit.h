...
#define RPG_GAMECORE_TARGETFETCHSUMMONUNIT_METHOD_4_A36255409C5E5AF3_OFFSET UNITYSDK_OFFSET(0x177B8770)
#define RPG_GAMECORE_TARGETFETCHSUMMONUNIT_METHOD_4_F4876A93CDA2A82F_OFFSET UNITYSDK_OFFSET(0x177C0480)
#define RPG_GAMECORE_TARGETFETCHSUMMONUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0x177B8720)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchSummonUnit_TypeDefinitionIndex = 22158;
