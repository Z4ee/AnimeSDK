...
#define RPG_GAMECORE_TARGETFETCHSUMMONUNIT_METHOD_4_822B1E351562750E_OFFSET UNITYSDK_OFFSET(0x1D0BCE90)
#define RPG_GAMECORE_TARGETFETCHSUMMONUNIT_METHOD_4_A36255409C5E5AF3_OFFSET UNITYSDK_OFFSET(0x1D0BCED0)
#define RPG_GAMECORE_TARGETFETCHSUMMONUNIT_METHOD_4_C02C0759BD9A49CD_OFFSET UNITYSDK_OFFSET(0x1D0BD060)
#define RPG_GAMECORE_TARGETFETCHSUMMONUNIT_METHOD_4_CD230238E4921E33_OFFSET UNITYSDK_OFFSET(0x1D0BD030)
#define RPG_GAMECORE_TARGETFETCHSUMMONUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0BCEC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchSummonUnit_TypeDefinitionIndex = 23036;
