...
#define RPG_GAMECORE_AVATARHEIGHTRTPCCONFIG_METHOD_2_754FB2AA9415C887_OFFSET UNITYSDK_OFFSET(0x186C49D0)
#define RPG_GAMECORE_AVATARHEIGHTRTPCCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x186C4B70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AvatarHeightRTPCConfig_TypeDefinitionIndex = 15520;
