...
#define RPG_GAMECORE_AVATARHEIGHTRTPCCONFIG_METHOD_2_754FB2AA9415C887_OFFSET UNITYSDK_OFFSET(0x1949B340)
#define RPG_GAMECORE_AVATARHEIGHTRTPCCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1949B4E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AvatarHeightRTPCConfig_TypeDefinitionIndex = 15582;
