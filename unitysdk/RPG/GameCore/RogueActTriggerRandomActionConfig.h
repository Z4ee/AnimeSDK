...
#define RPG_GAMECORE_ROGUEACTTRIGGERRANDOMACTIONCONFIG_METHOD_6_A8F42528B73E2780_OFFSET UNITYSDK_OFFSET(0x19AFA5C0)
#define RPG_GAMECORE_ROGUEACTTRIGGERRANDOMACTIONCONFIG_METHOD_6_AA4437C85AD419DD_OFFSET UNITYSDK_OFFSET(0x19AFA7E0)
#define RPG_GAMECORE_ROGUEACTTRIGGERRANDOMACTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AFA700)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActTriggerRandomActionConfig_TypeDefinitionIndex = 18668;
