...
#define RPG_GAMECORE_BATTLEREPORTCUSTOMVALUELIST_METHOD_2_F50C8818BE6D2419_OFFSET UNITYSDK_OFFSET(0x1CE7F430)
#define RPG_GAMECORE_BATTLEREPORTCUSTOMVALUELIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE7F4F0)
