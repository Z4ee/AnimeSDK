...
#define RPG_GAMECORE_BYCHECKTIMELINEENTITYSTATE_METHOD_4_2915B6D09CB1D176_OFFSET UNITYSDK_OFFSET(0x170012E0)
#define RPG_GAMECORE_BYCHECKTIMELINEENTITYSTATE_METHOD_4_FA2F1F8F8F8FE276_OFFSET UNITYSDK_OFFSET(0x17001210)
#define RPG_GAMECORE_BYCHECKTIMELINEENTITYSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x17001290)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckTimelineEntityState_TypeDefinitionIndex = 18948;
