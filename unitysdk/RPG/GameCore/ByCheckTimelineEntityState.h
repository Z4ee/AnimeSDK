...
#define RPG_GAMECORE_BYCHECKTIMELINEENTITYSTATE_METHOD_4_2915B6D09CB1D176_OFFSET UNITYSDK_OFFSET(0x19CCC980)
#define RPG_GAMECORE_BYCHECKTIMELINEENTITYSTATE_METHOD_4_350893B1DC52EBF7_OFFSET UNITYSDK_OFFSET(0x19CCC940)
#define RPG_GAMECORE_BYCHECKTIMELINEENTITYSTATE_METHOD_4_588AB0A949BBE14E_OFFSET UNITYSDK_OFFSET(0x19CCCB50)
#define RPG_GAMECORE_BYCHECKTIMELINEENTITYSTATE_METHOD_4_D25E117193D7A480_OFFSET UNITYSDK_OFFSET(0x19CCCB20)
#define RPG_GAMECORE_BYCHECKTIMELINEENTITYSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19CCC970)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckTimelineEntityState_TypeDefinitionIndex = 19851;
