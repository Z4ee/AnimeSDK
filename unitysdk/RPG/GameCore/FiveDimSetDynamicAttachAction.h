...
#define RPG_GAMECORE_FIVEDIMSETDYNAMICATTACHACTION_METHOD_3_04B76EDE182844F0_OFFSET UNITYSDK_OFFSET(0x19754580)
#define RPG_GAMECORE_FIVEDIMSETDYNAMICATTACHACTION_METHOD_3_C51C20E0A026D7FF_OFFSET UNITYSDK_OFFSET(0x19754510)
#define RPG_GAMECORE_FIVEDIMSETDYNAMICATTACHACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19754560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSetDynamicAttachAction_TypeDefinitionIndex = 17850;
