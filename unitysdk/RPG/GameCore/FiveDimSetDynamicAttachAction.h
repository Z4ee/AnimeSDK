...
#define RPG_GAMECORE_FIVEDIMSETDYNAMICATTACHACTION_METHOD_3_04B76EDE182844F0_OFFSET UNITYSDK_OFFSET(0x1891AE80)
#define RPG_GAMECORE_FIVEDIMSETDYNAMICATTACHACTION_METHOD_3_C51C20E0A026D7FF_OFFSET UNITYSDK_OFFSET(0x1891AE10)
#define RPG_GAMECORE_FIVEDIMSETDYNAMICATTACHACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1891AE60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimSetDynamicAttachAction_TypeDefinitionIndex = 17823;
