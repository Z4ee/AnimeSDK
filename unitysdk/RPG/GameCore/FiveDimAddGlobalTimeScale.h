...
#define RPG_GAMECORE_FIVEDIMADDGLOBALTIMESCALE_METHOD_3_5F41A0EC9D858BD8_OFFSET UNITYSDK_OFFSET(0x171DC980)
#define RPG_GAMECORE_FIVEDIMADDGLOBALTIMESCALE_METHOD_3_FB9405CDB49D0C77_OFFSET UNITYSDK_OFFSET(0x171DCA40)
#define RPG_GAMECORE_FIVEDIMADDGLOBALTIMESCALE__CTOR_OFFSET UNITYSDK_OFFSET(0x171DC9F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimAddGlobalTimeScale_TypeDefinitionIndex = 19654;
