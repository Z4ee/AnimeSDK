...
#define RPG_GAMECORE_CHIMERADUELDITHEROUTNODE_METHOD_3_41D078E6E14A4FC5_OFFSET UNITYSDK_OFFSET(0x1CFC3890)
#define RPG_GAMECORE_CHIMERADUELDITHEROUTNODE_METHOD_3_4C67274D68970A9A_OFFSET UNITYSDK_OFFSET(0x1CFC3830)
#define RPG_GAMECORE_CHIMERADUELDITHEROUTNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFC3880)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelDitherOutNode_TypeDefinitionIndex = 15786;
