...
#define RPG_GAMECORE_CHIMERADUELDITHEROUTNODE_METHOD_3_389E618667772EE9_OFFSET UNITYSDK_OFFSET(0x187F8D30)
#define RPG_GAMECORE_CHIMERADUELDITHEROUTNODE_METHOD_3_5176900F3A360A33_OFFSET UNITYSDK_OFFSET(0x187F8E10)
#define RPG_GAMECORE_CHIMERADUELDITHEROUTNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x187F8DC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelDitherOutNode_TypeDefinitionIndex = 15123;
