...
#define RPG_GAMECORE_BYCHECKMONSTERDIE_METHOD_4_0F6567A429D89661_OFFSET UNITYSDK_OFFSET(0x17000490)
#define RPG_GAMECORE_BYCHECKMONSTERDIE_METHOD_4_79C7E717A254DB63_OFFSET UNITYSDK_OFFSET(0x17000560)
#define RPG_GAMECORE_BYCHECKMONSTERDIE__CTOR_OFFSET UNITYSDK_OFFSET(0x17000510)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckMonsterDie_TypeDefinitionIndex = 21666;
