...
#define RPG_GAMECORE_BYCHECKMONSTERDIE_METHOD_4_79C7E717A254DB63_OFFSET UNITYSDK_OFFSET(0x1C3023F0)
#define RPG_GAMECORE_BYCHECKMONSTERDIE_METHOD_4_954B51D4A0BD1B4E_OFFSET UNITYSDK_OFFSET(0x1C3023B0)
#define RPG_GAMECORE_BYCHECKMONSTERDIE_METHOD_4_BA6B235D29070E88_OFFSET UNITYSDK_OFFSET(0x1C302590)
#define RPG_GAMECORE_BYCHECKMONSTERDIE_METHOD_4_C0C3BA47C7E0398F_OFFSET UNITYSDK_OFFSET(0x1C302560)
#define RPG_GAMECORE_BYCHECKMONSTERDIE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3023E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckMonsterDie_TypeDefinitionIndex = 23172;
