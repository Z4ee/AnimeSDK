...
#define RPG_GAMECORE_TRIGGERMAZEITEMUSEBUFFDROP_METHOD_3_7A057EBCBCEA6230_OFFSET UNITYSDK_OFFSET(0x178C9A80)
#define RPG_GAMECORE_TRIGGERMAZEITEMUSEBUFFDROP_METHOD_3_A6BBCB857474FFD7_OFFSET UNITYSDK_OFFSET(0x178C9A10)
#define RPG_GAMECORE_TRIGGERMAZEITEMUSEBUFFDROP__CTOR_OFFSET UNITYSDK_OFFSET(0x178C9A50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerMazeItemUseBuffDrop_TypeDefinitionIndex = 19925;
