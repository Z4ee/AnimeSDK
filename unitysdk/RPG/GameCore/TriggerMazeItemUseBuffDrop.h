...
#define RPG_GAMECORE_TRIGGERMAZEITEMUSEBUFFDROP_METHOD_3_7A057EBCBCEA6230_OFFSET UNITYSDK_OFFSET(0x1B0581F0)
#define RPG_GAMECORE_TRIGGERMAZEITEMUSEBUFFDROP_METHOD_3_C7CDD8FB9645503D_OFFSET UNITYSDK_OFFSET(0x1B0581B0)
#define RPG_GAMECORE_TRIGGERMAZEITEMUSEBUFFDROP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0581E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerMazeItemUseBuffDrop_TypeDefinitionIndex = 20954;
