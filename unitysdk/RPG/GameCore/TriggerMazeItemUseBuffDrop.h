...
#define RPG_GAMECORE_TRIGGERMAZEITEMUSEBUFFDROP_METHOD_3_7A057EBCBCEA6230_OFFSET UNITYSDK_OFFSET(0x190C81A0)
#define RPG_GAMECORE_TRIGGERMAZEITEMUSEBUFFDROP_METHOD_3_A6BBCB857474FFD7_OFFSET UNITYSDK_OFFSET(0x190C8130)
#define RPG_GAMECORE_TRIGGERMAZEITEMUSEBUFFDROP__CTOR_OFFSET UNITYSDK_OFFSET(0x190C8170)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerMazeItemUseBuffDrop_TypeDefinitionIndex = 20606;
