...
#define RPG_GAMECORE_LITTLEGAMEABILITYTEAMTOWERSSPEEDUPEFFECTCONFIG_METHOD_3_4FA9194AE37A8FE3_OFFSET UNITYSDK_OFFSET(0x1BCBCC90)
#define RPG_GAMECORE_LITTLEGAMEABILITYTEAMTOWERSSPEEDUPEFFECTCONFIG_METHOD_3_BEB98EBE3D0F72F7_OFFSET UNITYSDK_OFFSET(0x1BCBCD60)
#define RPG_GAMECORE_LITTLEGAMEABILITYTEAMTOWERSSPEEDUPEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCBCD50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityTeamTowersSpeedUpEffectConfig_TypeDefinitionIndex = 20614;
