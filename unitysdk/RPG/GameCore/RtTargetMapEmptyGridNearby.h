...
#define RPG_GAMECORE_RTTARGETMAPEMPTYGRIDNEARBY_METHOD_3_1B3D6813F610FBEC_OFFSET UNITYSDK_OFFSET(0x1D4B5860)
#define RPG_GAMECORE_RTTARGETMAPEMPTYGRIDNEARBY_METHOD_3_8F7983D1B8F6AC95_OFFSET UNITYSDK_OFFSET(0x1D4B5CB0)
#define RPG_GAMECORE_RTTARGETMAPEMPTYGRIDNEARBY_METHOD_3_AFBF36ED30D88222_OFFSET UNITYSDK_OFFSET(0x1D4B59A0)
#define RPG_GAMECORE_RTTARGETMAPEMPTYGRIDNEARBY_METHOD_3_B58D08B8E1F9A5FE_OFFSET UNITYSDK_OFFSET(0x1D4B5C00)
#define RPG_GAMECORE_RTTARGETMAPEMPTYGRIDNEARBY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4B5910)
