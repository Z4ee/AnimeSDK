...
#define RPG_GAMECORE_ABILITYMAXHPCHANGE_GETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0xE471BB0)
#define RPG_GAMECORE_ABILITYMAXHPCHANGE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xE471B60)
#define RPG_GAMECORE_ABILITYMAXHPCHANGE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xE471B10)
#define RPG_GAMECORE_ABILITYMAXHPCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0xE471AF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AbilityMaxHPChange_TypeDefinitionIndex = 56748;

	class AbilityMaxHPChange : public ::System::Object
	{
	public:
		::Struct_2_5909FD7779934CCA ChangeParams; // 0x10
		::RPG::GameCore::FixPoint _ChangeValue; // 0x118
