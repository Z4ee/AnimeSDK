...
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUESPECIALCELLNUMPARAM_METHOD_4_19819957C09F8385_OFFSET UNITYSDK_OFFSET(0x19C441E0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUESPECIALCELLNUMPARAM_METHOD_4_F2F683DD3C77B2B5_OFFSET UNITYSDK_OFFSET(0x19C44150)
#define RPG_GAMECORE_SETDYNAMICVALUEBYROGUESPECIALCELLNUMPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x19C441B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByRogueSpecialCellNumParam_TypeDefinitionIndex = 20575;
