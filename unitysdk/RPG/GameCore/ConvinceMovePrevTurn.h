...
#define RPG_GAMECORE_CONVINCEMOVEPREVTURN_METHOD_3_302F44137316EB53_OFFSET UNITYSDK_OFFSET(0x1D9BA550)
#define RPG_GAMECORE_CONVINCEMOVEPREVTURN_METHOD_3_A2C75C7E600F4790_OFFSET UNITYSDK_OFFSET(0x1D9BA5A0)
#define RPG_GAMECORE_CONVINCEMOVEPREVTURN__CTOR_OFFSET UNITYSDK_OFFSET(0x1D9BA590)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConvinceMovePrevTurn_TypeDefinitionIndex = 21592;
