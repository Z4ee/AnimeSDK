...
#define RPG_GAMECORE_CONVINCEMOVEPREVTURN_METHOD_3_A2C75C7E600F4790_OFFSET UNITYSDK_OFFSET(0x1883E660)
#define RPG_GAMECORE_CONVINCEMOVEPREVTURN_METHOD_3_AA04D7D8CAC94749_OFFSET UNITYSDK_OFFSET(0x1883E5E0)
#define RPG_GAMECORE_CONVINCEMOVEPREVTURN__CTOR_OFFSET UNITYSDK_OFFSET(0x1883E630)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ConvinceMovePrevTurn_TypeDefinitionIndex = 20689;
