...
#define RPG_GAMECORE_CAKERACEENTERSTATEPREDICATECONFIG_METHOD_3_1FAC102E67F7E1B1_OFFSET UNITYSDK_OFFSET(0x18770D60)
#define RPG_GAMECORE_CAKERACEENTERSTATEPREDICATECONFIG_METHOD_3_EAFE51C5D70E8619_OFFSET UNITYSDK_OFFSET(0x1876D250)
#define RPG_GAMECORE_CAKERACEENTERSTATEPREDICATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1876D240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceEnterStatePredicateConfig_TypeDefinitionIndex = 17473;
