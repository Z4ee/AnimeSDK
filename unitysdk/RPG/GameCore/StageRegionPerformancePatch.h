...
#define RPG_GAMECORE_STAGEREGIONPERFORMANCEPATCH_METHOD_2_872ACE8EFB2C3A0D_OFFSET UNITYSDK_OFFSET(0x1B0B4100)
#define RPG_GAMECORE_STAGEREGIONPERFORMANCEPATCH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0B46F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StageRegionPerformancePatch_TypeDefinitionIndex = 18442;
