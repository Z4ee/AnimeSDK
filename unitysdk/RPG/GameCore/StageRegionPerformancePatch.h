...
#define RPG_GAMECORE_STAGEREGIONPERFORMANCEPATCH_METHOD_2_872ACE8EFB2C3A0D_OFFSET UNITYSDK_OFFSET(0x1CAEA3B0)
#define RPG_GAMECORE_STAGEREGIONPERFORMANCEPATCH__CTOR_OFFSET UNITYSDK_OFFSET(0x1CAEA9F0)
