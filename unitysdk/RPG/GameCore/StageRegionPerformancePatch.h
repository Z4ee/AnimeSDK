...
#define RPG_GAMECORE_STAGEREGIONPERFORMANCEPATCH_METHOD_2_872ACE8EFB2C3A0D_OFFSET UNITYSDK_OFFSET(0x1D55C800)
#define RPG_GAMECORE_STAGEREGIONPERFORMANCEPATCH__CTOR_OFFSET UNITYSDK_OFFSET(0x1D55CE40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StageRegionPerformancePatch_TypeDefinitionIndex = 18966;
