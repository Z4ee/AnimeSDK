...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYWORKBENCHREFORGEBUFFCOINCONFIG_METHOD_3_6505AD0EC4759DFE_OFFSET UNITYSDK_OFFSET(0x18D43740)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYWORKBENCHREFORGEBUFFCOINCONFIG_METHOD_3_B1E274FD9378D9F7_OFFSET UNITYSDK_OFFSET(0x18D43810)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYWORKBENCHREFORGEBUFFCOINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D437C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyWorkbenchReforgeBuffCoinConfig_TypeDefinitionIndex = 16976;
