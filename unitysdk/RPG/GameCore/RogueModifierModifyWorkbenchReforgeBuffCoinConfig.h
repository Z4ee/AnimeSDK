...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYWORKBENCHREFORGEBUFFCOINCONFIG_METHOD_3_32FA63A3F6B277B3_OFFSET UNITYSDK_OFFSET(0x1EEFBCB0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYWORKBENCHREFORGEBUFFCOINCONFIG_METHOD_3_B1E274FD9378D9F7_OFFSET UNITYSDK_OFFSET(0x1EEFBD00)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYWORKBENCHREFORGEBUFFCOINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEFBCF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyWorkbenchReforgeBuffCoinConfig_TypeDefinitionIndex = 17669;
