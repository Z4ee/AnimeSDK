...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYWORKBENCHREFORGEBUFFCOINCONFIG_METHOD_3_6505AD0EC4759DFE_OFFSET UNITYSDK_OFFSET(0x17636BF0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYWORKBENCHREFORGEBUFFCOINCONFIG_METHOD_3_B1E274FD9378D9F7_OFFSET UNITYSDK_OFFSET(0x17636CC0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYWORKBENCHREFORGEBUFFCOINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17636C70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyWorkbenchReforgeBuffCoinConfig_TypeDefinitionIndex = 16422;
