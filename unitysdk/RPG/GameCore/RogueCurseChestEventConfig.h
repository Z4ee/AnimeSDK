...
#define RPG_GAMECORE_ROGUECURSECHESTEVENTCONFIG_METHOD_2_861C15C9D7CF85E9_OFFSET UNITYSDK_OFFSET(0x18CFC770)
#define RPG_GAMECORE_ROGUECURSECHESTEVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CFC7B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueCurseChestEventConfig_TypeDefinitionIndex = 17003;
