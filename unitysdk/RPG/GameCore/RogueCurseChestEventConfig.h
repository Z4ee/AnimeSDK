...
#define RPG_GAMECORE_ROGUECURSECHESTEVENTCONFIG_METHOD_2_861C15C9D7CF85E9_OFFSET UNITYSDK_OFFSET(0x1D3CC040)
#define RPG_GAMECORE_ROGUECURSECHESTEVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3CC080)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueCurseChestEventConfig_TypeDefinitionIndex = 17696;
