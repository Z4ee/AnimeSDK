...
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAROOMCARDFORCEWASHIFDISPLAYEDCONFIG_METHOD_3_DA2529AC4F25398B_OFFSET UNITYSDK_OFFSET(0x176379E0)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAROOMCARDFORCEWASHIFDISPLAYEDCONFIG_METHOD_3_E8A66CF3C0B3B832_OFFSET UNITYSDK_OFFSET(0x17637910)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAROOMCARDFORCEWASHIFDISPLAYEDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17637990)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierPersonaRoomCardForceWashIfDisplayedConfig_TypeDefinitionIndex = 16358;
