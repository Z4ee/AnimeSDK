...
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAROOMCARDFORCEWASHIFDISPLAYEDCONFIG_METHOD_3_2699B42351395CE7_OFFSET UNITYSDK_OFFSET(0x1D165320)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAROOMCARDFORCEWASHIFDISPLAYEDCONFIG_METHOD_3_DA2529AC4F25398B_OFFSET UNITYSDK_OFFSET(0x1D165370)
#define RPG_GAMECORE_ROGUEMODIFIERPERSONAROOMCARDFORCEWASHIFDISPLAYEDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D165360)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierPersonaRoomCardForceWashIfDisplayedConfig_TypeDefinitionIndex = 17089;
