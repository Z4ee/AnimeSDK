...
#define RPG_GAMECORE_ABILITYRALLYHPCHANGE_GETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0xCC7BC70)
#define RPG_GAMECORE_ABILITYRALLYHPCHANGE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xCC7BC20)
#define RPG_GAMECORE_ABILITYRALLYHPCHANGE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xCC7BBD0)
#define RPG_GAMECORE_ABILITYRALLYHPCHANGE_GET_CHANGEPARAMS_OFFSET UNITYSDK_OFFSET(0xCC7BCC0)
#define RPG_GAMECORE_ABILITYRALLYHPCHANGE_INIT_OFFSET UNITYSDK_OFFSET(0xCC7BB30)
#define RPG_GAMECORE_ABILITYRALLYHPCHANGE_SET_CHANGEPARAMS_OFFSET UNITYSDK_OFFSET(0xCC7BCE0)
#define RPG_GAMECORE_ABILITYRALLYHPCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0xCC7BCF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AbilityRallyHPChange_TypeDefinitionIndex = 52840;
