...
#define RPG_GAMECORE_MINIGAMECOLLECTCOIN_CURVECONFIG_METHOD_2_D13B583A864F2BCF_OFFSET UNITYSDK_OFFSET(0x1AF64360)
#define RPG_GAMECORE_MINIGAMECOLLECTCOIN_CURVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF646B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MiniGameCollectCoin_CurveConfig_TypeDefinitionIndex = 18068;
