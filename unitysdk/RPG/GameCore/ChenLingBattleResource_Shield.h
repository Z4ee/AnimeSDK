...
#define RPG_GAMECORE_CHENLINGBATTLERESOURCE_SHIELD_METHOD_3_0FF52939EB6512B8_OFFSET UNITYSDK_OFFSET(0x187E6200)
#define RPG_GAMECORE_CHENLINGBATTLERESOURCE_SHIELD_METHOD_3_CAE4C9D9903B1652_OFFSET UNITYSDK_OFFSET(0x187E61A0)
#define RPG_GAMECORE_CHENLINGBATTLERESOURCE_SHIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x187E61F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleResource_Shield_TypeDefinitionIndex = 14943;
