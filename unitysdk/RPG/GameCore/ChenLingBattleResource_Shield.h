...
#define RPG_GAMECORE_CHENLINGBATTLERESOURCE_SHIELD_METHOD_3_0FF52939EB6512B8_OFFSET UNITYSDK_OFFSET(0x1CFAC820)
#define RPG_GAMECORE_CHENLINGBATTLERESOURCE_SHIELD_METHOD_3_CAE4C9D9903B1652_OFFSET UNITYSDK_OFFSET(0x1CFAC7C0)
#define RPG_GAMECORE_CHENLINGBATTLERESOURCE_SHIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFAC810)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleResource_Shield_TypeDefinitionIndex = 15607;
