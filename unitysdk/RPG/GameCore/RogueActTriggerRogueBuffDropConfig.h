...
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEBUFFDROPCONFIG_METHOD_6_1EAF46493B45E89E_OFFSET UNITYSDK_OFFSET(0x19AFAC40)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEBUFFDROPCONFIG_METHOD_6_67077581AF48011B_OFFSET UNITYSDK_OFFSET(0x19AFAA20)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEBUFFDROPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AFAB60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActTriggerRogueBuffDropConfig_TypeDefinitionIndex = 18555;
