...
#define RPG_GAMECORE_INITFLIPPERLIGHTDEVICE_METHOD_3_6BA956175BD6AFE2_OFFSET UNITYSDK_OFFSET(0x18A1E120)
#define RPG_GAMECORE_INITFLIPPERLIGHTDEVICE_METHOD_3_EF6037CA8CAAB551_OFFSET UNITYSDK_OFFSET(0x18A1E0A0)
#define RPG_GAMECORE_INITFLIPPERLIGHTDEVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x18A1E0F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int InitFlipperLightDevice_TypeDefinitionIndex = 21217;
