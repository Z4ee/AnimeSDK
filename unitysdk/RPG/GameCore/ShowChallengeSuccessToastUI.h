...
#define RPG_GAMECORE_SHOWCHALLENGESUCCESSTOASTUI_METHOD_3_0655D8A6523C648D_OFFSET UNITYSDK_OFFSET(0x18E5B740)
#define RPG_GAMECORE_SHOWCHALLENGESUCCESSTOASTUI_METHOD_3_D4B41737A1EA4D5C_OFFSET UNITYSDK_OFFSET(0x18E5B6C0)
#define RPG_GAMECORE_SHOWCHALLENGESUCCESSTOASTUI__CTOR_OFFSET UNITYSDK_OFFSET(0x18E5B710)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowChallengeSuccessToastUI_TypeDefinitionIndex = 19251;
