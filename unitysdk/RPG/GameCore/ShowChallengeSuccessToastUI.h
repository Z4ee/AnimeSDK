...
#define RPG_GAMECORE_SHOWCHALLENGESUCCESSTOASTUI_METHOD_3_0655D8A6523C648D_OFFSET UNITYSDK_OFFSET(0x1BE3C5B0)
#define RPG_GAMECORE_SHOWCHALLENGESUCCESSTOASTUI_METHOD_3_9C2120D505B813C4_OFFSET UNITYSDK_OFFSET(0x1BE3C570)
#define RPG_GAMECORE_SHOWCHALLENGESUCCESSTOASTUI__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE3C5A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowChallengeSuccessToastUI_TypeDefinitionIndex = 19526;
