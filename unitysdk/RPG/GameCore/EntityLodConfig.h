...
#define RPG_GAMECORE_ENTITYLODCONFIG_METHOD_2_3C3ECD8330832B58_OFFSET UNITYSDK_OFFSET(0x188AD6C0)
#define RPG_GAMECORE_ENTITYLODCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x188AD810)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EntityLodConfig_TypeDefinitionIndex = 18252;
