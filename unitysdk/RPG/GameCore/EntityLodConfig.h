...
#define RPG_GAMECORE_ENTITYLODCONFIG_METHOD_2_3C3ECD8330832B58_OFFSET UNITYSDK_OFFSET(0x1D069840)
#define RPG_GAMECORE_ENTITYLODCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D069990)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EntityLodConfig_TypeDefinitionIndex = 18984;
