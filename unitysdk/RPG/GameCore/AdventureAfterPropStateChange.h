...
#define RPG_GAMECORE_ADVENTUREAFTERPROPSTATECHANGE_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x11262300)
#define RPG_GAMECORE_ADVENTUREAFTERPROPSTATECHANGE_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x11262350)
#define RPG_GAMECORE_ADVENTUREAFTERPROPSTATECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x112622D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdventureAfterPropStateChange_TypeDefinitionIndex = 56806;
