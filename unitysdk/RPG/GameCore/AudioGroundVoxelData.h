...
#define RPG_GAMECORE_AUDIOGROUNDVOXELDATA_METHOD_3_8464F9D0CD646D94_OFFSET UNITYSDK_OFFSET(0x1948C500)
#define RPG_GAMECORE_AUDIOGROUNDVOXELDATA_METHOD_3_E71F68FC3C7F04C4_OFFSET UNITYSDK_OFFSET(0x1948C4A0)
#define RPG_GAMECORE_AUDIOGROUNDVOXELDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1948C4F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AudioGroundVoxelData_TypeDefinitionIndex = 18172;
