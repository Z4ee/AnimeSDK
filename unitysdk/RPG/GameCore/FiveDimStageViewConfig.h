...
#define RPG_GAMECORE_FIVEDIMSTAGEVIEWCONFIG_METHOD_4_B07B6CB33250D2C4_OFFSET UNITYSDK_OFFSET(0x1720D390)
#define RPG_GAMECORE_FIVEDIMSTAGEVIEWCONFIG_METHOD_4_DF6BF463C1DCF9B9_OFFSET UNITYSDK_OFFSET(0x1720D320)
#define RPG_GAMECORE_FIVEDIMSTAGEVIEWCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1720D370)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimStageViewConfig_TypeDefinitionIndex = 17022;
