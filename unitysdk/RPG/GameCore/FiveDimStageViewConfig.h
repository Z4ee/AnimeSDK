...
#define RPG_GAMECORE_FIVEDIMSTAGEVIEWCONFIG_METHOD_4_B07B6CB33250D2C4_OFFSET UNITYSDK_OFFSET(0x1BEB48C0)
#define RPG_GAMECORE_FIVEDIMSTAGEVIEWCONFIG_METHOD_4_C8A5844369152F53_OFFSET UNITYSDK_OFFSET(0x1BEB4880)
#define RPG_GAMECORE_FIVEDIMSTAGEVIEWCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEB48B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimStageViewConfig_TypeDefinitionIndex = 17816;
