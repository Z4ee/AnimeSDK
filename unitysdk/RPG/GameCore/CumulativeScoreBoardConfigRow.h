...
#define RPG_GAMECORE_CUMULATIVESCOREBOARDCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D00B680)
#define RPG_GAMECORE_CUMULATIVESCOREBOARDCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D00C190)
