...
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEMAGICUNITRANDOMLISTCONFIG_METHOD_3_66C3D7B84060EFBF_OFFSET UNITYSDK_OFFSET(0x18D456B0)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEMAGICUNITRANDOMLISTCONFIG_METHOD_3_96AA3665A4F94546_OFFSET UNITYSDK_OFFSET(0x18D455E0)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEMAGICUNITRANDOMLISTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D45660)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierReplaceContentRogueMagicUnitRandomListConfig_TypeDefinitionIndex = 16822;
