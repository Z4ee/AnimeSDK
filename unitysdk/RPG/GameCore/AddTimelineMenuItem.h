...
#define RPG_GAMECORE_ADDTIMELINEMENUITEM_METHOD_4_782D03A3339DC5F6_OFFSET UNITYSDK_OFFSET(0x18644BD0)
#define RPG_GAMECORE_ADDTIMELINEMENUITEM_METHOD_4_BB89D521DDF4495C_OFFSET UNITYSDK_OFFSET(0x18640C00)
#define RPG_GAMECORE_ADDTIMELINEMENUITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x18640BD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddTimelineMenuItem_TypeDefinitionIndex = 20104;
