...
#define RPG_GAMECORE_ADDTIMELINEMENUITEM_METHOD_4_9689A201D5B330D2_OFFSET UNITYSDK_OFFSET(0x1CDB7AB0)
#define RPG_GAMECORE_ADDTIMELINEMENUITEM_METHOD_4_BB89D521DDF4495C_OFFSET UNITYSDK_OFFSET(0x1CDB4100)
#define RPG_GAMECORE_ADDTIMELINEMENUITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDB40F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddTimelineMenuItem_TypeDefinitionIndex = 20883;
