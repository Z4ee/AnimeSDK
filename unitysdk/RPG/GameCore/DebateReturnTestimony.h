...
#define RPG_GAMECORE_DEBATERETURNTESTIMONY_METHOD_3_13AB92FDEA9712D4_OFFSET UNITYSDK_OFFSET(0x19692E90)
#define RPG_GAMECORE_DEBATERETURNTESTIMONY_METHOD_3_8F452363C2A88F20_OFFSET UNITYSDK_OFFSET(0x19692FA0)
#define RPG_GAMECORE_DEBATERETURNTESTIMONY__CTOR_OFFSET UNITYSDK_OFFSET(0x19692F70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DebateReturnTestimony_TypeDefinitionIndex = 20710;
