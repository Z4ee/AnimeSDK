...
#define RPG_GAMECORE_DEBATERETURNTESTIMONY_METHOD_3_8F452363C2A88F20_OFFSET UNITYSDK_OFFSET(0x1C0FC920)
#define RPG_GAMECORE_DEBATERETURNTESTIMONY_METHOD_3_9194A26FF1A1B4DD_OFFSET UNITYSDK_OFFSET(0x1C0FC850)
#define RPG_GAMECORE_DEBATERETURNTESTIMONY__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0FC910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DebateReturnTestimony_TypeDefinitionIndex = 21125;
