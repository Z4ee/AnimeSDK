...
#define RPG_GAMECORE_STRETCHGLOBALTIMESLOWBYKEY_METHOD_3_020FF5E78704E6CC_OFFSET UNITYSDK_OFFSET(0x17782F90)
#define RPG_GAMECORE_STRETCHGLOBALTIMESLOWBYKEY_METHOD_3_8B7ED75473B2E9DA_OFFSET UNITYSDK_OFFSET(0x17782F10)
#define RPG_GAMECORE_STRETCHGLOBALTIMESLOWBYKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x17782F60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StretchGlobalTimeSlowByKey_TypeDefinitionIndex = 20856;
