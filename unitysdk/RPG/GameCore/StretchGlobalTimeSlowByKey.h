...
#define RPG_GAMECORE_STRETCHGLOBALTIMESLOWBYKEY_METHOD_3_020FF5E78704E6CC_OFFSET UNITYSDK_OFFSET(0x1B41FC90)
#define RPG_GAMECORE_STRETCHGLOBALTIMESLOWBYKEY_METHOD_3_20257E4DCCDF37AB_OFFSET UNITYSDK_OFFSET(0x1B41FC50)
#define RPG_GAMECORE_STRETCHGLOBALTIMESLOWBYKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B41FC80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StretchGlobalTimeSlowByKey_TypeDefinitionIndex = 21857;
