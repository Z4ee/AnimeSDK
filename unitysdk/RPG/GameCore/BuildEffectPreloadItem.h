...
#define RPG_GAMECORE_BUILDEFFECTPRELOADITEM_METHOD_2_63DC685939189540_OFFSET UNITYSDK_OFFSET(0x19CB6C10)
#define RPG_GAMECORE_BUILDEFFECTPRELOADITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x19CB6D10)
