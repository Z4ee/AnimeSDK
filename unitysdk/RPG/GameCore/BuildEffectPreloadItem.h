...
#define RPG_GAMECORE_BUILDEFFECTPRELOADITEM_METHOD_2_63DC685939189540_OFFSET UNITYSDK_OFFSET(0x1C2EE990)
#define RPG_GAMECORE_BUILDEFFECTPRELOADITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2EEA90)
