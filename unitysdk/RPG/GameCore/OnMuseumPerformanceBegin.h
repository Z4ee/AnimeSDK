...
#define RPG_GAMECORE_ONMUSEUMPERFORMANCEBEGIN_METHOD_3_8BB6B0C9984F1D7B_OFFSET UNITYSDK_OFFSET(0x1747B090)
#define RPG_GAMECORE_ONMUSEUMPERFORMANCEBEGIN_METHOD_3_B8598C5CE7EF5714_OFFSET UNITYSDK_OFFSET(0x1747B110)
#define RPG_GAMECORE_ONMUSEUMPERFORMANCEBEGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1747B0E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OnMuseumPerformanceBegin_TypeDefinitionIndex = 19232;
