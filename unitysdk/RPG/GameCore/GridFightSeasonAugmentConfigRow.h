...
#define RPG_GAMECORE_GRIDFIGHTSEASONAUGMENTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x198087A0)
#define RPG_GAMECORE_GRIDFIGHTSEASONAUGMENTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x198088C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightSeasonAugmentConfigRow_TypeDefinitionIndex = 12770;
