...
#define RPG_GAMECORE_GRIDFIGHTSEASONAUGMENTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D0758E0)
#define RPG_GAMECORE_GRIDFIGHTSEASONAUGMENTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D075A00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightSeasonAugmentConfigRow_TypeDefinitionIndex = 12907;
