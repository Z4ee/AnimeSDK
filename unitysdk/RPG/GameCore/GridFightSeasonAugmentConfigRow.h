...
#define RPG_GAMECORE_GRIDFIGHTSEASONAUGMENTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x172814A0)
#define RPG_GAMECORE_GRIDFIGHTSEASONAUGMENTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x172815C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightSeasonAugmentConfigRow_TypeDefinitionIndex = 12248;
