...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETTUTORIALBASICCONFIG_METHOD_3_3836C6BE07283FBF_OFFSET UNITYSDK_OFFSET(0x197F3A70)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETTUTORIALBASICCONFIG_METHOD_3_8575E009F8F6CDD6_OFFSET UNITYSDK_OFFSET(0x197EF590)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETTUTORIALBASICCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197EF540)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierSetTutorialBasicConfig_TypeDefinitionIndex = 18435;
