...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETTUTORIALBASICCONFIG_METHOD_3_3B94EAE6DF04057A_OFFSET UNITYSDK_OFFSET(0x1D06AE60)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETTUTORIALBASICCONFIG_METHOD_3_8575E009F8F6CDD6_OFFSET UNITYSDK_OFFSET(0x1D06AEB0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERSETTUTORIALBASICCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D06AEA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierSetTutorialBasicConfig_TypeDefinitionIndex = 18683;
