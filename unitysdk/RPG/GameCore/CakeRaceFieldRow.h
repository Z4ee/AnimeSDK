...
#define RPG_GAMECORE_CAKERACEFIELDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B2D0B30)
#define RPG_GAMECORE_CAKERACEFIELDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2D11E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceFieldRow_TypeDefinitionIndex = 10600;
	...
	public:
		...
		::System::UInt32 FieldSpecialBetCost; // 0x50
		::RPG::GameCore::CakeRaceRegionRandomType RegionRandomType; // 0x54
		::RPG::Client::TextID FieldName; // 0x58
		::System::UInt32 RewardID; // 0x68
		::System::UInt32 FieldID; // 0x6C
		::System::Boolean IsMultiPlaySupported; // 0x70
		::System::UInt32 FieldScoreRate; // 0x74
		::System::UInt32 FieldCost; // 0x78
