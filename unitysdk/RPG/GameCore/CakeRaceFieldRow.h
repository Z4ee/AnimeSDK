...
#define RPG_GAMECORE_CAKERACEFIELDROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D100660)
#define RPG_GAMECORE_CAKERACEFIELDROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D100D10)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::Class_1_A88C3AAF0DD46F4C_4*>* FieldCatWeight; // 0x18
		::Il2CppArray<::Class_1_A88C3AAF0DD46F4C_4*>* FieldEffectWeight; // 0x20
		::Il2CppArray<::Class_1_A88C3AAF0DD46F4C_4*>* FieldSectionWeight; // 0x28
		::Il2CppArray<::Class_1_3A3D56D4D49D35CE*>* FieldUnlockConditionList; // 0x30
		::System::UInt32 FieldSpecialBetCost; // 0x38
		::RPG::GameCore::CakeRaceRegionRandomType RegionRandomType; // 0x3C
		::RPG::Client::TextID FieldUnlockDesc; // 0x40
		::System::UInt32 FieldScoreRate; // 0x50
		::System::UInt32 FieldSectionNum; // 0x54
		::RPG::Client::TextID FieldDesc; // 0x58
		::System::UInt32 FieldBetCost; // 0x68
		::System::Boolean IsMultiPlaySupported; // 0x6C
		::System::UInt32 FieldCost; // 0x70
		::System::UInt32 FieldID; // 0x74
		::RPG::Client::TextID FieldName; // 0x78
		::System::UInt32 RewardID; // 0x88
		::System::UInt32 FieldCatNum; // 0x8C
