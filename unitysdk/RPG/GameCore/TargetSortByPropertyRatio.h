...
#define RPG_GAMECORE_TARGETSORTBYPROPERTYRATIO_METHOD_3_1A32BDA9438001C8_OFFSET UNITYSDK_OFFSET(0x18EF97D0)
#define RPG_GAMECORE_TARGETSORTBYPROPERTYRATIO_METHOD_3_F68B031937003FCA_OFFSET UNITYSDK_OFFSET(0x18EF84E0)
#define RPG_GAMECORE_TARGETSORTBYPROPERTYRATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x18EF84C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetSortByPropertyRatio_TypeDefinitionIndex = 22987;
