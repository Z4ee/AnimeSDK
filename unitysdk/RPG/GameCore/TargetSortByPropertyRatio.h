...
#define RPG_GAMECORE_TARGETSORTBYPROPERTYRATIO_METHOD_3_2C57CFF910399D34_OFFSET UNITYSDK_OFFSET(0x1D0CA0B0)
#define RPG_GAMECORE_TARGETSORTBYPROPERTYRATIO_METHOD_3_B05B3CC2ED309E52_OFFSET UNITYSDK_OFFSET(0x1D0CA080)
#define RPG_GAMECORE_TARGETSORTBYPROPERTYRATIO_METHOD_3_C8249FCE004B2345_OFFSET UNITYSDK_OFFSET(0x1D0C9EB0)
#define RPG_GAMECORE_TARGETSORTBYPROPERTYRATIO_METHOD_3_F68B031937003FCA_OFFSET UNITYSDK_OFFSET(0x1D0C9EF0)
#define RPG_GAMECORE_TARGETSORTBYPROPERTYRATIO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0C9EE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetSortByPropertyRatio_TypeDefinitionIndex = 23141;
