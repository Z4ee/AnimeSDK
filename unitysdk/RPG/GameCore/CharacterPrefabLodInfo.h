...
#define RPG_GAMECORE_CHARACTERPREFABLODINFO_METHOD_2_44B59B1151999100_OFFSET UNITYSDK_OFFSET(0x17070B90)
#define RPG_GAMECORE_CHARACTERPREFABLODINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x17070C60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CharacterPrefabLodInfo_TypeDefinitionIndex = 17482;
