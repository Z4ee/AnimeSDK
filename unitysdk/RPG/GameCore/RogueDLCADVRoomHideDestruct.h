...
#define RPG_GAMECORE_ROGUEDLCADVROOMHIDEDESTRUCT_METHOD_3_94774DB493A1CF39_OFFSET UNITYSDK_OFFSET(0x175F0B30)
#define RPG_GAMECORE_ROGUEDLCADVROOMHIDEDESTRUCT_METHOD_3_D85C1E06890A38B0_OFFSET UNITYSDK_OFFSET(0x175F0AB0)
#define RPG_GAMECORE_ROGUEDLCADVROOMHIDEDESTRUCT__CTOR_OFFSET UNITYSDK_OFFSET(0x175F0B00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueDLCADVRoomHideDestruct_TypeDefinitionIndex = 20474;
