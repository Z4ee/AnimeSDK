...
#define RPG_GAMECORE_BYHASUNGOTTENLEVELREWARD_METHOD_4_9A9CE92F639DC63D_OFFSET UNITYSDK_OFFSET(0x17025D70)
#define RPG_GAMECORE_BYHASUNGOTTENLEVELREWARD_METHOD_4_FF18523880DA9577_OFFSET UNITYSDK_OFFSET(0x17025CA0)
#define RPG_GAMECORE_BYHASUNGOTTENLEVELREWARD__CTOR_OFFSET UNITYSDK_OFFSET(0x17025D20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByHasUnGottenLevelReward_TypeDefinitionIndex = 19537;
