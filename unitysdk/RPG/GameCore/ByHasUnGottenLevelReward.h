...
#define RPG_GAMECORE_BYHASUNGOTTENLEVELREWARD_METHOD_4_706914C5EC97D9BE_OFFSET UNITYSDK_OFFSET(0x1A8CC840)
#define RPG_GAMECORE_BYHASUNGOTTENLEVELREWARD_METHOD_4_9A9CE92F639DC63D_OFFSET UNITYSDK_OFFSET(0x1A8CC880)
#define RPG_GAMECORE_BYHASUNGOTTENLEVELREWARD_METHOD_4_CEFAC115426F3CB7_OFFSET UNITYSDK_OFFSET(0x1A8CC9C0)
#define RPG_GAMECORE_BYHASUNGOTTENLEVELREWARD_METHOD_4_D1182192EC8F758A_OFFSET UNITYSDK_OFFSET(0x1A8CC9F0)
#define RPG_GAMECORE_BYHASUNGOTTENLEVELREWARD__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8CC870)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByHasUnGottenLevelReward_TypeDefinitionIndex = 20440;
