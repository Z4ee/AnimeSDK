...
#define RPG_GAMECORE_BYCONTAINMONSTERONWAVE_METHOD_4_113350CF45DAE883_OFFSET UNITYSDK_OFFSET(0x1A8B5700)
#define RPG_GAMECORE_BYCONTAINMONSTERONWAVE_METHOD_4_2892F5F6582C3038_OFFSET UNITYSDK_OFFSET(0x1A8B5920)
#define RPG_GAMECORE_BYCONTAINMONSTERONWAVE_METHOD_4_4040AB59F4C34E3F_OFFSET UNITYSDK_OFFSET(0x1A8B58F0)
#define RPG_GAMECORE_BYCONTAINMONSTERONWAVE_METHOD_4_416CE58F8C89EF1A_OFFSET UNITYSDK_OFFSET(0x1A8B56C0)
#define RPG_GAMECORE_BYCONTAINMONSTERONWAVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8B56F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByContainMonsterOnWave_TypeDefinitionIndex = 21755;
