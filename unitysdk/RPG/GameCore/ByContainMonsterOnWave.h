...
#define RPG_GAMECORE_BYCONTAINMONSTERONWAVE_METHOD_4_113350CF45DAE883_OFFSET UNITYSDK_OFFSET(0x18741DC0)
#define RPG_GAMECORE_BYCONTAINMONSTERONWAVE_METHOD_4_ACF123DCC9B82027_OFFSET UNITYSDK_OFFSET(0x18741CF0)
#define RPG_GAMECORE_BYCONTAINMONSTERONWAVE__CTOR_OFFSET UNITYSDK_OFFSET(0x18741D70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByContainMonsterOnWave_TypeDefinitionIndex = 21454;
