...
#define RPG_GAMECORE_GRIDFIGHTACTIONCOSTCOINCONFIG_METHOD_6_379128C3B0EA6FC2_OFFSET UNITYSDK_OFFSET(0x1D95FD00)
#define RPG_GAMECORE_GRIDFIGHTACTIONCOSTCOINCONFIG_METHOD_6_59DB4E21ED2178DE_OFFSET UNITYSDK_OFFSET(0x1D95FA30)
#define RPG_GAMECORE_GRIDFIGHTACTIONCOSTCOINCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D95FA20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightActionCostCoinConfig_TypeDefinitionIndex = 19092;
