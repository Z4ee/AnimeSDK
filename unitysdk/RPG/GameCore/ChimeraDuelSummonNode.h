...
#define RPG_GAMECORE_CHIMERADUELSUMMONNODE_METHOD_3_1730EC81CD985747_OFFSET UNITYSDK_OFFSET(0x170A6E80)
#define RPG_GAMECORE_CHIMERADUELSUMMONNODE_METHOD_3_52F3CC04C7305341_OFFSET UNITYSDK_OFFSET(0x170A6CB0)
#define RPG_GAMECORE_CHIMERADUELSUMMONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x170A6E20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelSummonNode_TypeDefinitionIndex = 14661;
