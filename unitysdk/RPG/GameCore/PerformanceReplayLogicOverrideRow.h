...
#define RPG_GAMECORE_PERFORMANCEREPLAYLOGICOVERRIDEROW_FROMBINARYWITHOUTNEW_OFFSET UNITYSDK_OFFSET(0x1749C850)
#define RPG_GAMECORE_PERFORMANCEREPLAYLOGICOVERRIDEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1749CE80)
#define RPG_GAMECORE_PERFORMANCEREPLAYLOGICOVERRIDEROW_FROMTABLEOFFSET_OFFSET UNITYSDK_OFFSET(0x1749C7C0)
#define RPG_GAMECORE_PERFORMANCEREPLAYLOGICOVERRIDEROW_RESET_OFFSET UNITYSDK_OFFSET(0x1749C820)
#define RPG_GAMECORE_PERFORMANCEREPLAYLOGICOVERRIDEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1749D4F0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 OverrideIsBranch; // 0x3C
		...
		::System::UInt32 OverrideMissionLGDisable; // 0x50
		::RPG::GameCore::ELevelPerformanceType PerformanceType; // 0x54
		::System::UInt32 IsOverrideBranchFlag; // 0x58
		::System::UInt32 OverrideIntent; // 0x5C
		::System::Int32 OverridePerformancePriority; // 0x60
		::System::Int32 OverrideEndBlackType; // 0x64
		::System::UInt32 IsOverrideMissionAudioStateFlag; // 0x68
		::System::UInt32 IsOverrideMissionLGDisableFlag; // 0x6C
