...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONGAMBLINGONCECONFIG_METHOD_3_7134DA4D69890E42_OFFSET UNITYSDK_OFFSET(0x19B51E00)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONGAMBLINGONCECONFIG_METHOD_3_7611E972334D8F4B_OFFSET UNITYSDK_OFFSET(0x19B5D0A0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONGAMBLINGONCECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B51DB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnGamblingOnceConfig_TypeDefinitionIndex = 16980;
