...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONGAMBLINGONCECONFIG_METHOD_3_4A575799AC3E2526_OFFSET UNITYSDK_OFFSET(0x1CFC05C0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONGAMBLINGONCECONFIG_METHOD_3_7134DA4D69890E42_OFFSET UNITYSDK_OFFSET(0x1CFC0610)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONGAMBLINGONCECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFC0600)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnGamblingOnceConfig_TypeDefinitionIndex = 17142;
