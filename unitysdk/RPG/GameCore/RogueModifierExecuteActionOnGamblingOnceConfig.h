...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONGAMBLINGONCECONFIG_METHOD_3_7134DA4D69890E42_OFFSET UNITYSDK_OFFSET(0x18D36080)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONGAMBLINGONCECONFIG_METHOD_3_7611E972334D8F4B_OFFSET UNITYSDK_OFFSET(0x18D3D4F0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONGAMBLINGONCECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D36030)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnGamblingOnceConfig_TypeDefinitionIndex = 16965;
