...
#define RPG_GAMECORE_GRIDFIGHTNODEIDCONFIG_METHOD_2_5706BE90DA924E09_OFFSET UNITYSDK_OFFSET(0x197F5430)
#define RPG_GAMECORE_GRIDFIGHTNODEIDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197F5550)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightNodeIdConfig_TypeDefinitionIndex = 10179;
