...
#define RPG_GAMECORE_GRIDFIGHTNODEIDCONFIG_METHOD_2_5706BE90DA924E09_OFFSET UNITYSDK_OFFSET(0x189C0F90)
#define RPG_GAMECORE_GRIDFIGHTNODEIDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189C10B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightNodeIdConfig_TypeDefinitionIndex = 10346;
