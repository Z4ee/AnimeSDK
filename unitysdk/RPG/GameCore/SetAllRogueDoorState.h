...
#define RPG_GAMECORE_SETALLROGUEDOORSTATE_METHOD_3_95F7C5A0BC179D87_OFFSET UNITYSDK_OFFSET(0x176A6180)
#define RPG_GAMECORE_SETALLROGUEDOORSTATE_METHOD_3_E1DD5EB2AFEBD450_OFFSET UNITYSDK_OFFSET(0x176A6110)
#define RPG_GAMECORE_SETALLROGUEDOORSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x176A6150)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetAllRogueDoorState_TypeDefinitionIndex = 18779;
