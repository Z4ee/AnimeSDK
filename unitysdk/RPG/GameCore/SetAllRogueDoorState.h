...
#define RPG_GAMECORE_SETALLROGUEDOORSTATE_METHOD_3_95F7C5A0BC179D87_OFFSET UNITYSDK_OFFSET(0x19C27D70)
#define RPG_GAMECORE_SETALLROGUEDOORSTATE_METHOD_3_E1DD5EB2AFEBD450_OFFSET UNITYSDK_OFFSET(0x19C27D00)
#define RPG_GAMECORE_SETALLROGUEDOORSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C27D40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetAllRogueDoorState_TypeDefinitionIndex = 19341;
