...
#define RPG_GAMECORE_SETALLROGUEDOORSTATE_METHOD_3_780206E5E675D4BA_OFFSET UNITYSDK_OFFSET(0x1C2D1820)
#define RPG_GAMECORE_SETALLROGUEDOORSTATE_METHOD_3_95F7C5A0BC179D87_OFFSET UNITYSDK_OFFSET(0x1C2D1860)
#define RPG_GAMECORE_SETALLROGUEDOORSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2D1850)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetAllRogueDoorState_TypeDefinitionIndex = 19697;
