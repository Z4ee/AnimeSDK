...
#define RPG_GAMECORE_GRIDFIGHTGETGRIDAVATARSLOTPARAM_METHOD_3_1E1F40060D29F55C_OFFSET UNITYSDK_OFFSET(0x1C5CE560)
#define RPG_GAMECORE_GRIDFIGHTGETGRIDAVATARSLOTPARAM_METHOD_3_9FC3DEB5ECA42A7A_OFFSET UNITYSDK_OFFSET(0x1C5CE5C0)
#define RPG_GAMECORE_GRIDFIGHTGETGRIDAVATARSLOTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5CE5B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightGetGridAvatarSlotParam_TypeDefinitionIndex = 19183;
