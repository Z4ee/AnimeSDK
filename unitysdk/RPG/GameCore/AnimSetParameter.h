...
#define RPG_GAMECORE_ANIMSETPARAMETER_METHOD_3_408F2AD73C812A87_OFFSET UNITYSDK_OFFSET(0x186A4880)
#define RPG_GAMECORE_ANIMSETPARAMETER_METHOD_3_A6135AD40564B013_OFFSET UNITYSDK_OFFSET(0x186A4970)
#define RPG_GAMECORE_ANIMSETPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x186A48C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AnimSetParameter_TypeDefinitionIndex = 19563;
