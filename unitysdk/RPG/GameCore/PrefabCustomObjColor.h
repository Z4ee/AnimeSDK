...
#define RPG_GAMECORE_PREFABCUSTOMOBJCOLOR_METHOD_2_FB5609609EBCDDE3_OFFSET UNITYSDK_OFFSET(0x18C60310)
#define RPG_GAMECORE_PREFABCUSTOMOBJCOLOR__CTOR_OFFSET UNITYSDK_OFFSET(0x18C60440)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PrefabCustomObjColor_TypeDefinitionIndex = 18111;
