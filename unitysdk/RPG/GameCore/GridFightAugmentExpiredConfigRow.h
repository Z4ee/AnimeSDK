...
#define RPG_GAMECORE_GRIDFIGHTAUGMENTEXPIREDCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x172526E0)
#define RPG_GAMECORE_GRIDFIGHTAUGMENTEXPIREDCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17252850)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightAugmentExpiredConfigRow_TypeDefinitionIndex = 12252;
