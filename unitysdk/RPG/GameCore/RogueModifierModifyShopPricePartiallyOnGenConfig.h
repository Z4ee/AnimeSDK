...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYSHOPPRICEPARTIALLYONGENCONFIG_METHOD_3_BEB4104621ABE3A8_OFFSET UNITYSDK_OFFSET(0x1D3FAC10)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYSHOPPRICEPARTIALLYONGENCONFIG_METHOD_3_F5AAAF754EC3E02C_OFFSET UNITYSDK_OFFSET(0x1D3FABC0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYSHOPPRICEPARTIALLYONGENCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3FAC00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyShopPricePartiallyOnGenConfig_TypeDefinitionIndex = 17533;
