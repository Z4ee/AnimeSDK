...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYSHOPPRICEPARTIALLYONGENCONFIG_METHOD_3_BEB4104621ABE3A8_OFFSET UNITYSDK_OFFSET(0x17636080)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYSHOPPRICEPARTIALLYONGENCONFIG_METHOD_3_E8B2E7E8EDF00291_OFFSET UNITYSDK_OFFSET(0x17635FB0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYSHOPPRICEPARTIALLYONGENCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17636030)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyShopPricePartiallyOnGenConfig_TypeDefinitionIndex = 16299;
