...
#define RPG_GAMECORE_ENTITYCOLLIDERHEIGHTCAMERACONFIG_METHOD_2_35D1464FEA37EB89_OFFSET UNITYSDK_OFFSET(0x1719F740)
#define RPG_GAMECORE_ENTITYCOLLIDERHEIGHTCAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1719F8B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EntityColliderHeightCameraConfig_TypeDefinitionIndex = 15040;
