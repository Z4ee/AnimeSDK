...
#define RPG_GAMECORE_SETBATTLEENDREASON_METHOD_3_39643F69C8777297_OFFSET UNITYSDK_OFFSET(0x1C2D4500)
#define RPG_GAMECORE_SETBATTLEENDREASON_METHOD_3_A683074EF5BC9B44_OFFSET UNITYSDK_OFFSET(0x1C2D4540)
#define RPG_GAMECORE_SETBATTLEENDREASON__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2D4530)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetBattleEndReason_TypeDefinitionIndex = 22470;
