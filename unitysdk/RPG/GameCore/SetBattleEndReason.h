...
#define RPG_GAMECORE_SETBATTLEENDREASON_METHOD_3_A683074EF5BC9B44_OFFSET UNITYSDK_OFFSET(0x19C2AEE0)
#define RPG_GAMECORE_SETBATTLEENDREASON_METHOD_3_F0581368EC8A40C7_OFFSET UNITYSDK_OFFSET(0x19C2AE60)
#define RPG_GAMECORE_SETBATTLEENDREASON__CTOR_OFFSET UNITYSDK_OFFSET(0x19C2AEB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetBattleEndReason_TypeDefinitionIndex = 22034;
