...
#define RPG_GAMECORE_PLAYMUNICIPALCHAT_METHOD_3_57FC0E0339F82884_OFFSET UNITYSDK_OFFSET(0x174C3170)
#define RPG_GAMECORE_PLAYMUNICIPALCHAT_METHOD_3_A56E6AF8039E8423_OFFSET UNITYSDK_OFFSET(0x174C30F0)
#define RPG_GAMECORE_PLAYMUNICIPALCHAT__CTOR_OFFSET UNITYSDK_OFFSET(0x174C3140)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayMunicipalChat_TypeDefinitionIndex = 19089;
