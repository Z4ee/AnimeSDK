...
#define RPG_GAMECORE_FIVEDIMJUMPTOSPLINEPOINTACTION_METHOD_3_1B30BD581D8577EC_OFFSET UNITYSDK_OFFSET(0x1D865EB0)
#define RPG_GAMECORE_FIVEDIMJUMPTOSPLINEPOINTACTION_METHOD_3_E95B95F28F7531A9_OFFSET UNITYSDK_OFFSET(0x1D865F70)
#define RPG_GAMECORE_FIVEDIMJUMPTOSPLINEPOINTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D865F60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimJumpToSplinePointAction_TypeDefinitionIndex = 18545;
