...
#define RPG_GAMECORE_ADDMISSIONMENUITEM_METHOD_3_6EBA08D46D0F51D2_OFFSET UNITYSDK_OFFSET(0x1CDB4560)
#define RPG_GAMECORE_ADDMISSIONMENUITEM_METHOD_3_7E9AB0F529C023BD_OFFSET UNITYSDK_OFFSET(0x1CDB4510)
#define RPG_GAMECORE_ADDMISSIONMENUITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDB4550)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddMissionMenuItem_TypeDefinitionIndex = 20884;
