...
#define RPG_GAMECORE_ADDMISSIONMENUITEM_METHOD_3_6EBA08D46D0F51D2_OFFSET UNITYSDK_OFFSET(0x16F1EED0)
#define RPG_GAMECORE_ADDMISSIONMENUITEM_METHOD_3_D6691F3D56C5DFED_OFFSET UNITYSDK_OFFSET(0x16F1EE40)
#define RPG_GAMECORE_ADDMISSIONMENUITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x16F1EEA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AddMissionMenuItem_TypeDefinitionIndex = 19432;
