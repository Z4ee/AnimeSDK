...
#define RPG_GAMECORE_FIVEDIMSCROLLVIEWCONFIG_METHOD_3_43ECA74DC3C99077_OFFSET UNITYSDK_OFFSET(0x1BEAEF30)
#define RPG_GAMECORE_FIVEDIMSCROLLVIEWCONFIG_METHOD_3_7A7DC23F44E44D92_OFFSET UNITYSDK_OFFSET(0x1BEAEF70)
#define RPG_GAMECORE_FIVEDIMSCROLLVIEWCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEAEF60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimScrollViewConfig_TypeDefinitionIndex = 17806;
	...
	public:
		...
		static ::System::Void Method_3_43ECA74DC3C99077(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::FiveDimScrollViewConfig*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::FiveDimScrollViewConfig*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_FIVEDIMSCROLLVIEWCONFIG_METHOD_3_43ECA74DC3C99077_OFFSET))(a1, a2);
		}
