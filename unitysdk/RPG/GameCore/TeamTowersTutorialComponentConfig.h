...
#define RPG_GAMECORE_TEAMTOWERSTUTORIALCOMPONENTCONFIG_METHOD_3_31C9171DC5884F4C_OFFSET UNITYSDK_OFFSET(0x1D5C6BA0)
#define RPG_GAMECORE_TEAMTOWERSTUTORIALCOMPONENTCONFIG_METHOD_3_F62640E469B6837E_OFFSET UNITYSDK_OFFSET(0x1D5C6B40)
#define RPG_GAMECORE_TEAMTOWERSTUTORIALCOMPONENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D5C6B90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TeamTowersTutorialComponentConfig_TypeDefinitionIndex = 18730;
