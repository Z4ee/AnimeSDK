...
#define RPG_GAMECORE_CREATEBATTLEEVENTQTEUI_METHOD_3_A2598C6E02DF6B6A_OFFSET UNITYSDK_OFFSET(0x1713AAB0)
#define RPG_GAMECORE_CREATEBATTLEEVENTQTEUI_METHOD_3_C6CFF2C372B32B5B_OFFSET UNITYSDK_OFFSET(0x1713AB30)
#define RPG_GAMECORE_CREATEBATTLEEVENTQTEUI__CTOR_OFFSET UNITYSDK_OFFSET(0x1713AB00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CreateBattleEventQTEUI_TypeDefinitionIndex = 21573;
