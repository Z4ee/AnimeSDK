...
#define RPG_GAMECORE_BYHASSPARETEAMFORMATION_METHOD_4_284602E848201C34_OFFSET UNITYSDK_OFFSET(0x17024FD0)
#define RPG_GAMECORE_BYHASSPARETEAMFORMATION_METHOD_4_FCB989898B621DC4_OFFSET UNITYSDK_OFFSET(0x170250A0)
#define RPG_GAMECORE_BYHASSPARETEAMFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x17025050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByHasSpareTeamFormation_TypeDefinitionIndex = 20819;
