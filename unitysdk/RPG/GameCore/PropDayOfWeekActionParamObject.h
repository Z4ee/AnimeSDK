...
#define RPG_GAMECORE_PROPDAYOFWEEKACTIONPARAMOBJECT_METHOD_2_5F955E3522F9B32A_OFFSET UNITYSDK_OFFSET(0x1D363A10)
#define RPG_GAMECORE_PROPDAYOFWEEKACTIONPARAMOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D363C40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropDayOfWeekActionParamObject_TypeDefinitionIndex = 21827;
