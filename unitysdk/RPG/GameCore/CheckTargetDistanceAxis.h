...
#define RPG_GAMECORE_CHECKTARGETDISTANCEAXIS_METHOD_3_668A889A3FFA8509_OFFSET UNITYSDK_OFFSET(0x1E0045B0)
#define RPG_GAMECORE_CHECKTARGETDISTANCEAXIS_METHOD_3_C6E34E778EE29956_OFFSET UNITYSDK_OFFSET(0x1E004570)
#define RPG_GAMECORE_CHECKTARGETDISTANCEAXIS__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0045A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CheckTargetDistanceAxis_TypeDefinitionIndex = 15342;
