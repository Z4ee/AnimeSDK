...
#define RPG_GAMECORE_CHECKTARGETDISTANCEAXIS_METHOD_3_668A889A3FFA8509_OFFSET UNITYSDK_OFFSET(0x187DBBF0)
#define RPG_GAMECORE_CHECKTARGETDISTANCEAXIS_METHOD_3_C6E34E778EE29956_OFFSET UNITYSDK_OFFSET(0x187DBBB0)
#define RPG_GAMECORE_CHECKTARGETDISTANCEAXIS__CTOR_OFFSET UNITYSDK_OFFSET(0x187DBBE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CheckTargetDistanceAxis_TypeDefinitionIndex = 14680;
