...
#define RPG_GAMECORE_CHECKTARGETDISTANCEAXIS_METHOD_3_668A889A3FFA8509_OFFSET UNITYSDK_OFFSET(0x19619650)
#define RPG_GAMECORE_CHECKTARGETDISTANCEAXIS_METHOD_3_C6E34E778EE29956_OFFSET UNITYSDK_OFFSET(0x19619610)
#define RPG_GAMECORE_CHECKTARGETDISTANCEAXIS__CTOR_OFFSET UNITYSDK_OFFSET(0x19619640)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CheckTargetDistanceAxis_TypeDefinitionIndex = 14746;
