...
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTDAMAGEFROMBURNPERCENTCONFIG_METHOD_3_38D5610A53E96B86_OFFSET UNITYSDK_OFFSET(0x19894540)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTDAMAGEFROMBURNPERCENTCONFIG_METHOD_3_97833CAA6C7CE5BA_OFFSET UNITYSDK_OFFSET(0x19894470)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTDAMAGEFROMBURNPERCENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19894530)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityPixAirEffectDamageFromBurnPercentConfig_TypeDefinitionIndex = 20188;
