...
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTDAMAGEFROMBURNPERCENTCONFIG_METHOD_3_38D5610A53E96B86_OFFSET UNITYSDK_OFFSET(0x1DD62A40)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTDAMAGEFROMBURNPERCENTCONFIG_METHOD_3_97833CAA6C7CE5BA_OFFSET UNITYSDK_OFFSET(0x1DD62970)
#define RPG_GAMECORE_LITTLEGAMEABILITYPIXAIREFFECTDAMAGEFROMBURNPERCENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD62A30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityPixAirEffectDamageFromBurnPercentConfig_TypeDefinitionIndex = 21113;
