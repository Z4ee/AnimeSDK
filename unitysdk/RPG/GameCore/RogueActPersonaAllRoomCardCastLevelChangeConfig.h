...
#define RPG_GAMECORE_ROGUEACTPERSONAALLROOMCARDCASTLEVELCHANGECONFIG_METHOD_7_E2D3A323233AC4FF_OFFSET UNITYSDK_OFFSET(0x175BB100)
#define RPG_GAMECORE_ROGUEACTPERSONAALLROOMCARDCASTLEVELCHANGECONFIG_METHOD_7_ED0222D25CB2B62A_OFFSET UNITYSDK_OFFSET(0x175BAD20)
#define RPG_GAMECORE_ROGUEACTPERSONAALLROOMCARDCASTLEVELCHANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175BAC40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaAllRoomCardCastLevelChangeConfig_TypeDefinitionIndex = 18095;
