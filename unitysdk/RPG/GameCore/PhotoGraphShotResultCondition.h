...
#define RPG_GAMECORE_PHOTOGRAPHSHOTRESULTCONDITION_METHOD_2_D87A4E44315D1918_OFFSET UNITYSDK_OFFSET(0x174ACCA0)
#define RPG_GAMECORE_PHOTOGRAPHSHOTRESULTCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x174ACEF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PhotoGraphShotResultCondition_TypeDefinitionIndex = 19820;
