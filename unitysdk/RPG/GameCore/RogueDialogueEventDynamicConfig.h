...
#define RPG_GAMECORE_ROGUEDIALOGUEEVENTDYNAMICCONFIG_METHOD_2_C3E8FC0FE17DEE27_OFFSET UNITYSDK_OFFSET(0x18D12C60)
#define RPG_GAMECORE_ROGUEDIALOGUEEVENTDYNAMICCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D12CA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueDialogueEventDynamicConfig_TypeDefinitionIndex = 17016;
