...
#define RPG_GAMECORE_CHIMERADUELCASTERATTRIBUTEVALUEGETTER_METHOD_3_2242EEAE31CFBE77_OFFSET UNITYSDK_OFFSET(0x17096B40)
#define RPG_GAMECORE_CHIMERADUELCASTERATTRIBUTEVALUEGETTER_METHOD_3_311F1769A94EF5B7_OFFSET UNITYSDK_OFFSET(0x17096BA0)
#define RPG_GAMECORE_CHIMERADUELCASTERATTRIBUTEVALUEGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x17096B90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelCasterAttributeValueGetter_TypeDefinitionIndex = 14688;
