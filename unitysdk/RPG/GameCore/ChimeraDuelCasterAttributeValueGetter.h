...
#define RPG_GAMECORE_CHIMERADUELCASTERATTRIBUTEVALUEGETTER_METHOD_3_2242EEAE31CFBE77_OFFSET UNITYSDK_OFFSET(0x196381C0)
#define RPG_GAMECORE_CHIMERADUELCASTERATTRIBUTEVALUEGETTER_METHOD_3_311F1769A94EF5B7_OFFSET UNITYSDK_OFFSET(0x19638220)
#define RPG_GAMECORE_CHIMERADUELCASTERATTRIBUTEVALUEGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19638210)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelCasterAttributeValueGetter_TypeDefinitionIndex = 15219;
