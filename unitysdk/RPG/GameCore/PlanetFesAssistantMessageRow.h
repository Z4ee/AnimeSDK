...
#define RPG_GAMECORE_PLANETFESASSISTANTMESSAGEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B4D1540)
#define RPG_GAMECORE_PLANETFESASSISTANTMESSAGEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4D18C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlanetFesAssistantMessageRow_TypeDefinitionIndex = 11802;
	...
	public:
		...
		::RPG::GameCore::PlanetFesAssistantMessageType AssistantMessageType; // 0x1C
		::System::UInt32 Interval; // 0x20
		::RPG::Client::TextID Description; // 0x28
		::System::UInt32 ID; // 0x38
		::System::UInt32 UnlockPlanetFesLevel; // 0x3C
