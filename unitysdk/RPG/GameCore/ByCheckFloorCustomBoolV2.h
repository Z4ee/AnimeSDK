...
#define RPG_GAMECORE_BYCHECKFLOORCUSTOMBOOLV2_METHOD_4_467AC909A012CF04_OFFSET UNITYSDK_OFFSET(0x18722970)
#define RPG_GAMECORE_BYCHECKFLOORCUSTOMBOOLV2_METHOD_4_74525B277C60E0BA_OFFSET UNITYSDK_OFFSET(0x187228A0)
#define RPG_GAMECORE_BYCHECKFLOORCUSTOMBOOLV2__CTOR_OFFSET UNITYSDK_OFFSET(0x18722920)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckFloorCustomBoolV2_TypeDefinitionIndex = 19678;
