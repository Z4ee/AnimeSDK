...
#define RPG_GAMECORE_SETSIMULATIONSPEEDENABLE_METHOD_3_6B6F573ACD2E80E7_OFFSET UNITYSDK_OFFSET(0x19C5DC60)
#define RPG_GAMECORE_SETSIMULATIONSPEEDENABLE_METHOD_3_6F701C4E9C427836_OFFSET UNITYSDK_OFFSET(0x19C5DBE0)
#define RPG_GAMECORE_SETSIMULATIONSPEEDENABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C5DC30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetSimulationSpeedEnable_TypeDefinitionIndex = 22461;
