...
#define RPG_GAMECORE_SETSIMULATIONSPEEDENABLE_METHOD_3_6B6F573ACD2E80E7_OFFSET UNITYSDK_OFFSET(0x1E08CEA0)
#define RPG_GAMECORE_SETSIMULATIONSPEEDENABLE_METHOD_3_EE1E97E903545FAC_OFFSET UNITYSDK_OFFSET(0x1E08CE60)
#define RPG_GAMECORE_SETSIMULATIONSPEEDENABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E08CE90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetSimulationSpeedEnable_TypeDefinitionIndex = 23491;
