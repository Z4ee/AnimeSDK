...
#define RPG_GAMECORE_CHIMERAEMOJIROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C24A3D0)
#define RPG_GAMECORE_CHIMERAEMOJIROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C24A500)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraEmojiRow_TypeDefinitionIndex = 12549;
