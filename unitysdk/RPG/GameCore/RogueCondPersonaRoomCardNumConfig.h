...
#define RPG_GAMECORE_ROGUECONDPERSONAROOMCARDNUMCONFIG_METHOD_6_1188DD87178E6539_OFFSET UNITYSDK_OFFSET(0x18CF82D0)
#define RPG_GAMECORE_ROGUECONDPERSONAROOMCARDNUMCONFIG_METHOD_6_CDC19F845462267F_OFFSET UNITYSDK_OFFSET(0x18CF8580)
#define RPG_GAMECORE_ROGUECONDPERSONAROOMCARDNUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CF8450)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueCondPersonaRoomCardNumConfig_TypeDefinitionIndex = 18796;
