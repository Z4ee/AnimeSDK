...
#define RPG_GAMECORE_BYISCONTAINADVENTUREMODIFIER_METHOD_4_35B2372ACE0BFE56_OFFSET UNITYSDK_OFFSET(0x1702AFC0)
#define RPG_GAMECORE_BYISCONTAINADVENTUREMODIFIER_METHOD_4_D9E9FE15D8B5E0D6_OFFSET UNITYSDK_OFFSET(0x1702AEF0)
#define RPG_GAMECORE_BYISCONTAINADVENTUREMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1702AF70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsContainAdventureModifier_TypeDefinitionIndex = 19107;
