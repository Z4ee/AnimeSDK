...
#define RPG_GAMECORE_MONSTERSKILLEXCELTABLE_INDEXKEY_EQUALS_OFFSET UNITYSDK_OFFSET(0x881AD0)
#define RPG_GAMECORE_MONSTERSKILLEXCELTABLE_INDEXKEY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x167710)
#define RPG_GAMECORE_MONSTERSKILLEXCELTABLE_INDEXKEY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x881A30)
#define RPG_GAMECORE_MONSTERSKILLEXCELTABLE_INDEXKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x167520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MonsterSkillExcelTable_IndexKey_TypeDefinitionIndex = 13664;
