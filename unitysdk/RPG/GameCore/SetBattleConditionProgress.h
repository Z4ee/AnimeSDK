...
#define RPG_GAMECORE_SETBATTLECONDITIONPROGRESS_METHOD_3_1FA5437C87D12A6F_OFFSET UNITYSDK_OFFSET(0x18E0BDF0)
#define RPG_GAMECORE_SETBATTLECONDITIONPROGRESS_METHOD_3_9386764161BEC05E_OFFSET UNITYSDK_OFFSET(0x18E0BD60)
#define RPG_GAMECORE_SETBATTLECONDITIONPROGRESS__CTOR_OFFSET UNITYSDK_OFFSET(0x18E0BDC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetBattleConditionProgress_TypeDefinitionIndex = 22139;
