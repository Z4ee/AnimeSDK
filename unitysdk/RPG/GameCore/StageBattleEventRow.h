...
#define RPG_GAMECORE_STAGEBATTLEEVENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B0AACF0)
#define RPG_GAMECORE_STAGEBATTLEEVENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0AB090)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StageBattleEventRow_TypeDefinitionIndex = 14545;
	...
	public:
		...
		::Il2CppArray<::System::String*>* ModifierNameList; // 0x30
		::RPG::GameCore::StageBattleEventType EventType; // 0x38
		::System::Boolean IncludeAvatar; // 0x3C
		::System::Boolean IncludeMonster; // 0x3D
