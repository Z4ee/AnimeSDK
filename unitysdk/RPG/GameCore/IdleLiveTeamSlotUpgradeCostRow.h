...
#define RPG_GAMECORE_IDLELIVETEAMSLOTUPGRADECOSTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D1A55B0)
#define RPG_GAMECORE_IDLELIVETEAMSLOTUPGRADECOSTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1A5730)
