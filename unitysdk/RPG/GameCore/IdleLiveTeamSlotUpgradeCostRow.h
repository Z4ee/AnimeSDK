...
#define RPG_GAMECORE_IDLELIVETEAMSLOTUPGRADECOSTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19849280)
#define RPG_GAMECORE_IDLELIVETEAMSLOTUPGRADECOSTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19849400)

namespace RPG::GameCore
{
	inline static constexpr unsigned int IdleLiveTeamSlotUpgradeCostRow_TypeDefinitionIndex = 11173;
