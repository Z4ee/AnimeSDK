...
#define RPG_GAMECORE_ADVTRIGGERSKILL_METHOD_3_10A52346A22F4FB0_OFFSET UNITYSDK_OFFSET(0x18668250)
#define RPG_GAMECORE_ADVTRIGGERSKILL_METHOD_3_5B9C1487254F8CBF_OFFSET UNITYSDK_OFFSET(0x186681D0)
#define RPG_GAMECORE_ADVTRIGGERSKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x18668220)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvTriggerSkill_TypeDefinitionIndex = 19498;
