...
#define RPG_GAMECORE_ADVTRIGGERSKILL_METHOD_3_10A52346A22F4FB0_OFFSET UNITYSDK_OFFSET(0x1AE49C60)
#define RPG_GAMECORE_ADVTRIGGERSKILL_METHOD_3_D3C98F249CEBBD8D_OFFSET UNITYSDK_OFFSET(0x1AE49C20)
#define RPG_GAMECORE_ADVTRIGGERSKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE49C50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvTriggerSkill_TypeDefinitionIndex = 19751;
