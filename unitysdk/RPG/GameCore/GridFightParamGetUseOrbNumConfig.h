...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETUSEORBNUMCONFIG_METHOD_6_2E815E3A5536F415_OFFSET UNITYSDK_OFFSET(0x189C8550)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETUSEORBNUMCONFIG_METHOD_6_51094F8680154FDB_OFFSET UNITYSDK_OFFSET(0x189C82A0)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETUSEORBNUMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189C8420)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightParamGetUseOrbNumConfig_TypeDefinitionIndex = 18556;
