...
#define RPG_GAMECORE_ROGUEADVENTURECAPTUREMONSTERCONFIG_METHOD_3_18E4586E4D65A107_OFFSET UNITYSDK_OFFSET(0x175DBF00)
#define RPG_GAMECORE_ROGUEADVENTURECAPTUREMONSTERCONFIG_METHOD_3_63211C8A0D7944AB_OFFSET UNITYSDK_OFFSET(0x175DBF50)
#define RPG_GAMECORE_ROGUEADVENTURECAPTUREMONSTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x175DBF40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueAdventureCaptureMonsterConfig_TypeDefinitionIndex = 16434;
