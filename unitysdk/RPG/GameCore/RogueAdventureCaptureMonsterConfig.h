...
#define RPG_GAMECORE_ROGUEADVENTURECAPTUREMONSTERCONFIG_METHOD_3_18E4586E4D65A107_OFFSET UNITYSDK_OFFSET(0x1C4A00A0)
#define RPG_GAMECORE_ROGUEADVENTURECAPTUREMONSTERCONFIG_METHOD_3_63211C8A0D7944AB_OFFSET UNITYSDK_OFFSET(0x1C4A00F0)
#define RPG_GAMECORE_ROGUEADVENTURECAPTUREMONSTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4A00E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueAdventureCaptureMonsterConfig_TypeDefinitionIndex = 17165;
