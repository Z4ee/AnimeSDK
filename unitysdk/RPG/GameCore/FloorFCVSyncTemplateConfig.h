...
#define RPG_GAMECORE_FLOORFCVSYNCTEMPLATECONFIG_METHOD_2_E6FA2DD678481E1A_OFFSET UNITYSDK_OFFSET(0x19761E40)
#define RPG_GAMECORE_FLOORFCVSYNCTEMPLATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19761E80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FloorFCVSyncTemplateConfig_TypeDefinitionIndex = 16542;
