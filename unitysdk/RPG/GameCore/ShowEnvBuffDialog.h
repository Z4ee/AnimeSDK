...
#define RPG_GAMECORE_SHOWENVBUFFDIALOG_METHOD_3_14794C09B2AB4673_OFFSET UNITYSDK_OFFSET(0x18E5CFE0)
#define RPG_GAMECORE_SHOWENVBUFFDIALOG_METHOD_3_7997A23D7DE1D38A_OFFSET UNITYSDK_OFFSET(0x18E5D060)
#define RPG_GAMECORE_SHOWENVBUFFDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x18E5D030)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowEnvBuffDialog_TypeDefinitionIndex = 19428;
