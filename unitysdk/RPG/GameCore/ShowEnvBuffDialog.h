...
#define RPG_GAMECORE_SHOWENVBUFFDIALOG_METHOD_3_14794C09B2AB4673_OFFSET UNITYSDK_OFFSET(0x176F95A0)
#define RPG_GAMECORE_SHOWENVBUFFDIALOG_METHOD_3_7997A23D7DE1D38A_OFFSET UNITYSDK_OFFSET(0x176F9620)
#define RPG_GAMECORE_SHOWENVBUFFDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x176F95F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowEnvBuffDialog_TypeDefinitionIndex = 18771;
