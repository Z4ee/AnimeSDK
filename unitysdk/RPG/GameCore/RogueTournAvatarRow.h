...
#define RPG_GAMECORE_ROGUETOURNAVATARROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19BBF510)
#define RPG_GAMECORE_ROGUETOURNAVATARROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19BBF600)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueTournAvatarRow_TypeDefinitionIndex = 14266;
