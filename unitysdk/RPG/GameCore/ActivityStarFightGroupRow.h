...
#define RPG_GAMECORE_ACTIVITYSTARFIGHTGROUPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19404E60)
#define RPG_GAMECORE_ACTIVITYSTARFIGHTGROUPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19405320)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityStarFightGroupRow_TypeDefinitionIndex = 11817;
	...
	public:
		...
		::System::UInt32 PerfectWave; // 0x34
		::RPG::Client::TextID GroupTitle; // 0x38
		::RPG::GameCore::StarFightSeason Season; // 0x48
		::System::UInt32 PerfectQuest; // 0x4C
