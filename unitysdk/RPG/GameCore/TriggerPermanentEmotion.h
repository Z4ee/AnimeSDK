...
#define RPG_GAMECORE_TRIGGERPERMANENTEMOTION_METHOD_3_C2F8AD851E53B56D_OFFSET UNITYSDK_OFFSET(0x1D603C10)
#define RPG_GAMECORE_TRIGGERPERMANENTEMOTION_METHOD_3_CEDEB75CDB80F4F8_OFFSET UNITYSDK_OFFSET(0x1D603BC0)
#define RPG_GAMECORE_TRIGGERPERMANENTEMOTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D603C00)
