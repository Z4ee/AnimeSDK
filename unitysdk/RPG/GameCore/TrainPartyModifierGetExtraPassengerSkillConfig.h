...
#define RPG_GAMECORE_TRAINPARTYMODIFIERGETEXTRAPASSENGERSKILLCONFIG_METHOD_3_B6CD533B29182881_OFFSET UNITYSDK_OFFSET(0x190ABB30)
#define RPG_GAMECORE_TRAINPARTYMODIFIERGETEXTRAPASSENGERSKILLCONFIG_METHOD_3_D66EA8255630645D_OFFSET UNITYSDK_OFFSET(0x190ABD20)
#define RPG_GAMECORE_TRAINPARTYMODIFIERGETEXTRAPASSENGERSKILLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x190ABB20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyModifierGetExtraPassengerSkillConfig_TypeDefinitionIndex = 17211;
