...
#define RPG_GAMECORE_MAINMISSIONTYPECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1BCDB0B0)
#define RPG_GAMECORE_MAINMISSIONTYPECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCDBA40)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Boolean IsShowRedDot; // 0x41
		::System::UInt32 TypePriority; // 0x44
		::System::UInt32 IconMapConnect; // 0x48
		::System::UInt32 IconMapOptional; // 0x4C
		::RPG::Client::TextID TypeName; // 0x50
		::RPG::GameCore::MainMissionType Type; // 0x60
		::System::UInt32 WaypointIconType; // 0x64
