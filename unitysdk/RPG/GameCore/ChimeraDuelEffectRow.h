...
#define RPG_GAMECORE_CHIMERADUELEFFECTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C394A60)
#define RPG_GAMECORE_CHIMERADUELEFFECTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C394D40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraDuelEffectRow_TypeDefinitionIndex = 10733;
	...
	public:
		...
		::System::Int32 Attack; // 0x1C
		::System::UInt32 Exp; // 0x20
		::System::Boolean ParamBool; // 0x24
