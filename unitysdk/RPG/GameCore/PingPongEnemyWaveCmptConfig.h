...
#define RPG_GAMECORE_PINGPONGENEMYWAVECMPTCONFIG_METHOD_3_1A88852B04AF5D98_OFFSET UNITYSDK_OFFSET(0x18BFC3A0)
#define RPG_GAMECORE_PINGPONGENEMYWAVECMPTCONFIG_METHOD_3_1ECC060BB24FB0DB_OFFSET UNITYSDK_OFFSET(0x18BFC280)
#define RPG_GAMECORE_PINGPONGENEMYWAVECMPTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18BFC380)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PingPongEnemyWaveCmptConfig_TypeDefinitionIndex = 17976;
