...
#define RPG_GAMECORE_PINGPONGENEMYWAVECMPTCONFIG_METHOD_3_1A88852B04AF5D98_OFFSET UNITYSDK_OFFSET(0x174B0DD0)
#define RPG_GAMECORE_PINGPONGENEMYWAVECMPTCONFIG_METHOD_3_1ECC060BB24FB0DB_OFFSET UNITYSDK_OFFSET(0x174B0CB0)
#define RPG_GAMECORE_PINGPONGENEMYWAVECMPTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x174B0DB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PingPongEnemyWaveCmptConfig_TypeDefinitionIndex = 17368;
