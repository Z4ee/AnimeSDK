...
#define RPG_GAMECORE_COMPLEXSKILLAICONTAINMODIFIERLAYER_METHOD_3_5296B151A185D702_OFFSET UNITYSDK_OFFSET(0x17122720)
#define RPG_GAMECORE_COMPLEXSKILLAICONTAINMODIFIERLAYER_METHOD_3_FC1451CC73B40DFA_OFFSET UNITYSDK_OFFSET(0x171227B0)
#define RPG_GAMECORE_COMPLEXSKILLAICONTAINMODIFIERLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x17122790)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAIContainModifierLayer_TypeDefinitionIndex = 14231;
