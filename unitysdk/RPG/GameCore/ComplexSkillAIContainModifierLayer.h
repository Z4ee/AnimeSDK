...
#define RPG_GAMECORE_COMPLEXSKILLAICONTAINMODIFIERLAYER_METHOD_3_5296B151A185D702_OFFSET UNITYSDK_OFFSET(0x18828F50)
#define RPG_GAMECORE_COMPLEXSKILLAICONTAINMODIFIERLAYER_METHOD_3_FC1451CC73B40DFA_OFFSET UNITYSDK_OFFSET(0x18828FE0)
#define RPG_GAMECORE_COMPLEXSKILLAICONTAINMODIFIERLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x18828FC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAIContainModifierLayer_TypeDefinitionIndex = 14701;
