...
#define RPG_GAMECORE_COMPLEXSKILLAICONTAINMODIFIERLAYER_METHOD_3_236E5BD570AD44C0_OFFSET UNITYSDK_OFFSET(0x1BC24200)
#define RPG_GAMECORE_COMPLEXSKILLAICONTAINMODIFIERLAYER_METHOD_3_FC1451CC73B40DFA_OFFSET UNITYSDK_OFFSET(0x1BC24260)
#define RPG_GAMECORE_COMPLEXSKILLAICONTAINMODIFIERLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC24250)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAIContainModifierLayer_TypeDefinitionIndex = 14926;
