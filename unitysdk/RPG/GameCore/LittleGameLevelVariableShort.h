...
#define RPG_GAMECORE_LITTLEGAMELEVELVARIABLESHORT_METHOD_3_45B7C02A8915F961_OFFSET UNITYSDK_OFFSET(0x1735F8E0)
#define RPG_GAMECORE_LITTLEGAMELEVELVARIABLESHORT_METHOD_3_EF562EAC1AB692B1_OFFSET UNITYSDK_OFFSET(0x1735F310)
#define RPG_GAMECORE_LITTLEGAMELEVELVARIABLESHORT__CTOR_OFFSET UNITYSDK_OFFSET(0x1735F300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameLevelVariableShort_TypeDefinitionIndex = 17332;
