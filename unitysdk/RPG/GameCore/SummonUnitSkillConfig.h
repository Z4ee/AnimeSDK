...
#define RPG_GAMECORE_SUMMONUNITSKILLCONFIG_METHOD_2_344801290C4D7A61_OFFSET UNITYSDK_OFFSET(0x1D586160)
#define RPG_GAMECORE_SUMMONUNITSKILLCONFIG_RPG_GAMECORE_IADVENTURECHARACTERSKILLCONFIG_GET_ABILITYLIST_OFFSET UNITYSDK_OFFSET(0x1D587DA0)
#define RPG_GAMECORE_SUMMONUNITSKILLCONFIG_RPG_GAMECORE_IADVENTURECHARACTERSKILLCONFIG_GET_SKILLABILITYLIST_OFFSET UNITYSDK_OFFSET(0x1D587D90)
#define RPG_GAMECORE_SUMMONUNITSKILLCONFIG_RPG_GAMECORE_IADVENTURECHARACTERSKILLCONFIG_GET_SKILLLIST_OFFSET UNITYSDK_OFFSET(0x1D587D80)
#define RPG_GAMECORE_SUMMONUNITSKILLCONFIG_RPG_GAMECORE_IADVENTURECHARACTERSKILLCONFIG_GET_USETYPEAHEADSKILLINPUT_OFFSET UNITYSDK_OFFSET(0x1D587D70)
#define RPG_GAMECORE_SUMMONUNITSKILLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D587D60)
