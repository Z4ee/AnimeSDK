...
#define RPG_GAMECORE_SUMMONUNITSKILLCONFIG_METHOD_2_119181BFCBBE27B8_OFFSET UNITYSDK_OFFSET(0x19CD52D0)
#define RPG_GAMECORE_SUMMONUNITSKILLCONFIG_RPG_GAMECORE_IADVENTURECHARACTERSKILLCONFIG_GET_ABILITYLIST_OFFSET UNITYSDK_OFFSET(0x19CD6F40)
#define RPG_GAMECORE_SUMMONUNITSKILLCONFIG_RPG_GAMECORE_IADVENTURECHARACTERSKILLCONFIG_GET_SKILLABILITYLIST_OFFSET UNITYSDK_OFFSET(0x19CD6F30)
#define RPG_GAMECORE_SUMMONUNITSKILLCONFIG_RPG_GAMECORE_IADVENTURECHARACTERSKILLCONFIG_GET_SKILLLIST_OFFSET UNITYSDK_OFFSET(0x19CD6F20)
#define RPG_GAMECORE_SUMMONUNITSKILLCONFIG_RPG_GAMECORE_IADVENTURECHARACTERSKILLCONFIG_GET_USETYPEAHEADSKILLINPUT_OFFSET UNITYSDK_OFFSET(0x19CD6F10)
#define RPG_GAMECORE_SUMMONUNITSKILLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19CD6F00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SummonUnitSkillConfig_TypeDefinitionIndex = 16722;
	...
	public:
		...
		static ::System::Void Method_2_119181BFCBBE27B8(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::SummonUnitSkillConfig*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::SummonUnitSkillConfig*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_SUMMONUNITSKILLCONFIG_METHOD_2_119181BFCBBE27B8_OFFSET))(a1, a2);
		}
