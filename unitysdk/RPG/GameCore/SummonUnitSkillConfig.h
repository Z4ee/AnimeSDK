...
#define RPG_GAMECORE_SUMMONUNITSKILLCONFIG_METHOD_2_FF91CCA4979371CA_OFFSET UNITYSDK_OFFSET(0x1778F570)
#define RPG_GAMECORE_SUMMONUNITSKILLCONFIG_RPG_GAMECORE_IADVENTURECHARACTERSKILLCONFIG_GET_ABILITYLIST_OFFSET UNITYSDK_OFFSET(0x17790F00)
#define RPG_GAMECORE_SUMMONUNITSKILLCONFIG_RPG_GAMECORE_IADVENTURECHARACTERSKILLCONFIG_GET_SKILLABILITYLIST_OFFSET UNITYSDK_OFFSET(0x17790EF0)
#define RPG_GAMECORE_SUMMONUNITSKILLCONFIG_RPG_GAMECORE_IADVENTURECHARACTERSKILLCONFIG_GET_SKILLLIST_OFFSET UNITYSDK_OFFSET(0x17790EE0)
#define RPG_GAMECORE_SUMMONUNITSKILLCONFIG_RPG_GAMECORE_IADVENTURECHARACTERSKILLCONFIG_GET_USETYPEAHEADSKILLINPUT_OFFSET UNITYSDK_OFFSET(0x17790ED0)
#define RPG_GAMECORE_SUMMONUNITSKILLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17790EC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SummonUnitSkillConfig_TypeDefinitionIndex = 16165;
	...
	public:
		...
		static ::System::Void Method_2_FF91CCA4979371CA(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::SummonUnitSkillConfig*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::SummonUnitSkillConfig*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_SUMMONUNITSKILLCONFIG_METHOD_2_FF91CCA4979371CA_OFFSET))(a1, a2);
		}
