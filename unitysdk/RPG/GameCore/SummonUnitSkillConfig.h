...
#define RPG_GAMECORE_SUMMONUNITSKILLCONFIG_METHOD_2_344801290C4D7A61_OFFSET UNITYSDK_OFFSET(0x1B430F20)
#define RPG_GAMECORE_SUMMONUNITSKILLCONFIG_RPG_GAMECORE_IADVENTURECHARACTERSKILLCONFIG_GET_ABILITYLIST_OFFSET UNITYSDK_OFFSET(0x1B432B60)
#define RPG_GAMECORE_SUMMONUNITSKILLCONFIG_RPG_GAMECORE_IADVENTURECHARACTERSKILLCONFIG_GET_SKILLABILITYLIST_OFFSET UNITYSDK_OFFSET(0x1B432B50)
#define RPG_GAMECORE_SUMMONUNITSKILLCONFIG_RPG_GAMECORE_IADVENTURECHARACTERSKILLCONFIG_GET_SKILLLIST_OFFSET UNITYSDK_OFFSET(0x1B432B40)
#define RPG_GAMECORE_SUMMONUNITSKILLCONFIG_RPG_GAMECORE_IADVENTURECHARACTERSKILLCONFIG_GET_USETYPEAHEADSKILLINPUT_OFFSET UNITYSDK_OFFSET(0x1B432B30)
#define RPG_GAMECORE_SUMMONUNITSKILLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B432B20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SummonUnitSkillConfig_TypeDefinitionIndex = 16884;
