...
#define RPG_GAMECORE_SUMMONUNITSKILLCONFIG_METHOD_2_7AFFE14C80ECB8D3_OFFSET UNITYSDK_OFFSET(0x18EB5640)
#define RPG_GAMECORE_SUMMONUNITSKILLCONFIG_RPG_GAMECORE_IADVENTURECHARACTERSKILLCONFIG_GET_ABILITYLIST_OFFSET UNITYSDK_OFFSET(0x18EB7340)
#define RPG_GAMECORE_SUMMONUNITSKILLCONFIG_RPG_GAMECORE_IADVENTURECHARACTERSKILLCONFIG_GET_SKILLABILITYLIST_OFFSET UNITYSDK_OFFSET(0x18EB7330)
#define RPG_GAMECORE_SUMMONUNITSKILLCONFIG_RPG_GAMECORE_IADVENTURECHARACTERSKILLCONFIG_GET_SKILLLIST_OFFSET UNITYSDK_OFFSET(0x18EB7320)
#define RPG_GAMECORE_SUMMONUNITSKILLCONFIG_RPG_GAMECORE_IADVENTURECHARACTERSKILLCONFIG_GET_USETYPEAHEADSKILLINPUT_OFFSET UNITYSDK_OFFSET(0x18EB7310)
#define RPG_GAMECORE_SUMMONUNITSKILLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18EB7300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SummonUnitSkillConfig_TypeDefinitionIndex = 16696;
	...
	public:
		...
		static ::System::Void Method_2_7AFFE14C80ECB8D3(::Class_1_7A22A3DBEEDD1F80* a1, ::RPG::GameCore::SummonUnitSkillConfig*& a2)
		{
			return ((::System::Void(*)(::Class_1_7A22A3DBEEDD1F80*, ::RPG::GameCore::SummonUnitSkillConfig*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_SUMMONUNITSKILLCONFIG_METHOD_2_7AFFE14C80ECB8D3_OFFSET))(a1, a2);
		}
