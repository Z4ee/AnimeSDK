...
#define RPG_GAMECORE_FARMELEMENTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x188CB800)
#define RPG_GAMECORE_FARMELEMENTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x188CC1A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FarmElementConfigRow_TypeDefinitionIndex = 11864;
	...
	public:
		...
		::System::UInt32 MaxChallengeCnt; // 0x40
		::System::UInt32 StaminaCost; // 0x44
