...
#define RPG_GAMECORE_FARMELEMENTCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1E0C9E10)
#define RPG_GAMECORE_FARMELEMENTCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0CA720)
