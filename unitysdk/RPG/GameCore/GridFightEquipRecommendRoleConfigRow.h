...
#define RPG_GAMECORE_GRIDFIGHTEQUIPRECOMMENDROLECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x197E2060)
#define RPG_GAMECORE_GRIDFIGHTEQUIPRECOMMENDROLECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x197E21A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightEquipRecommendRoleConfigRow_TypeDefinitionIndex = 12831;
