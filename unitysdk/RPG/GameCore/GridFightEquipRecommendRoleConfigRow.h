...
#define RPG_GAMECORE_GRIDFIGHTEQUIPRECOMMENDROLECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1EE660D0)
#define RPG_GAMECORE_GRIDFIGHTEQUIPRECOMMENDROLECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1EE66210)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightEquipRecommendRoleConfigRow_TypeDefinitionIndex = 13358;
