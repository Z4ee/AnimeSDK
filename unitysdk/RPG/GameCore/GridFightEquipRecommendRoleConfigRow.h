...
#define RPG_GAMECORE_GRIDFIGHTEQUIPRECOMMENDROLECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17259EE0)
#define RPG_GAMECORE_GRIDFIGHTEQUIPRECOMMENDROLECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1725A030)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightEquipRecommendRoleConfigRow_TypeDefinitionIndex = 12310;
