...
#define RPG_GAMECORE_FIVEDIMPLAYERSKILLDASHCONDITION_METHOD_3_4CEB5F141090F0B9_OFFSET UNITYSDK_OFFSET(0x18914100)
#define RPG_GAMECORE_FIVEDIMPLAYERSKILLDASHCONDITION_METHOD_3_C2537DA869F3B264_OFFSET UNITYSDK_OFFSET(0x18914080)
#define RPG_GAMECORE_FIVEDIMPLAYERSKILLDASHCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x189140F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimPlayerSkillDashCondition_TypeDefinitionIndex = 17859;
