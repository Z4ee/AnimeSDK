...
#define RPG_GAMECORE_SWORDTRAININGATTACKDATA_METHOD_3_9CDFBF4E14BA8804_OFFSET UNITYSDK_OFFSET(0x1B43B750)
#define RPG_GAMECORE_SWORDTRAININGATTACKDATA_METHOD_3_D7EF3B241F774D17_OFFSET UNITYSDK_OFFSET(0x1B43B7A0)
#define RPG_GAMECORE_SWORDTRAININGATTACKDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B43B790)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SwordTrainingAttackData_TypeDefinitionIndex = 21779;
