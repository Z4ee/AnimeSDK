...
#define RPG_GAMECORE_MAINMISSIONPERFORMANCECONFIG_METHOD_2_D0879C0DCA636346_OFFSET UNITYSDK_OFFSET(0x1D48FC10)
#define RPG_GAMECORE_MAINMISSIONPERFORMANCECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D48FD10)
