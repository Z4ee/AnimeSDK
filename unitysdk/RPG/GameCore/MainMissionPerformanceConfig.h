...
#define RPG_GAMECORE_MAINMISSIONPERFORMANCECONFIG_METHOD_2_D0879C0DCA636346_OFFSET UNITYSDK_OFFSET(0x198B64F0)
#define RPG_GAMECORE_MAINMISSIONPERFORMANCECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x198B65F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MainMissionPerformanceConfig_TypeDefinitionIndex = 18077;
