...
#define RPG_GAMECORE_PINGPONGLEVELADDPOINTCMPTCONFIG_METHOD_3_1B40E9C07B35D0EC_OFFSET UNITYSDK_OFFSET(0x19A0EE00)
#define RPG_GAMECORE_PINGPONGLEVELADDPOINTCMPTCONFIG_METHOD_3_849B360734902BFD_OFFSET UNITYSDK_OFFSET(0x19A0ED50)
#define RPG_GAMECORE_PINGPONGLEVELADDPOINTCMPTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19A0EDD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PingPongLevelAddPointCmptConfig_TypeDefinitionIndex = 18010;
