...
#define RPG_GAMECORE_LEVELMODIFIERONUNSTACKPROPERTY_CLEAR_OFFSET UNITYSDK_OFFSET(0xCE4C000)
#define RPG_GAMECORE_LEVELMODIFIERONUNSTACKPROPERTY_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xCE4C0A0)
#define RPG_GAMECORE_LEVELMODIFIERONUNSTACKPROPERTY_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xCE4C050)
#define RPG_GAMECORE_LEVELMODIFIERONUNSTACKPROPERTY_INIT_OFFSET UNITYSDK_OFFSET(0xCE4BFB0)
#define RPG_GAMECORE_LEVELMODIFIERONUNSTACKPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0xCE4C0F0)
#define RPG_GAMECORE_LEVELMODIFIERONUNSTACKPROPERTY___IFIXBASEPROXY_CLEAR_OFFSET UNITYSDK_OFFSET(0xCE4C100)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelModifierOnUnstackProperty_TypeDefinitionIndex = 53023;
