...
#define RPG_GAMECORE_LEVELMODIFIERONUNSTACKPROPERTY_CLEAR_OFFSET UNITYSDK_OFFSET(0xA98FC50)
#define RPG_GAMECORE_LEVELMODIFIERONUNSTACKPROPERTY_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xA98FCF0)
#define RPG_GAMECORE_LEVELMODIFIERONUNSTACKPROPERTY_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xA98FCA0)
#define RPG_GAMECORE_LEVELMODIFIERONUNSTACKPROPERTY_INIT_OFFSET UNITYSDK_OFFSET(0xA98FC00)
#define RPG_GAMECORE_LEVELMODIFIERONUNSTACKPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0xA98FD40)
#define RPG_GAMECORE_LEVELMODIFIERONUNSTACKPROPERTY___IFIXBASEPROXY_CLEAR_OFFSET UNITYSDK_OFFSET(0xA98FD50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelModifierOnUnstackProperty_TypeDefinitionIndex = 45674;
