...
#define RPG_GAMECORE_LEVELAFTERADDMODIFIER_CLEAR_OFFSET UNITYSDK_OFFSET(0x1844AF70)
#define RPG_GAMECORE_LEVELAFTERADDMODIFIER_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1844B010)
#define RPG_GAMECORE_LEVELAFTERADDMODIFIER_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0x1844AFC0)
#define RPG_GAMECORE_LEVELAFTERADDMODIFIER_INIT_OFFSET UNITYSDK_OFFSET(0x1844AF20)
#define RPG_GAMECORE_LEVELAFTERADDMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1844B060)
