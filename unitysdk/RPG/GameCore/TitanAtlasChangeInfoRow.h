...
#define RPG_GAMECORE_TITANATLASCHANGEINFOROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C154F40)
#define RPG_GAMECORE_TITANATLASCHANGEINFOROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C155050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TitanAtlasChangeInfoRow_TypeDefinitionIndex = 14693;
