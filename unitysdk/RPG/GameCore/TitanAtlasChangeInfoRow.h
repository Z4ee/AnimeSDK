...
#define RPG_GAMECORE_TITANATLASCHANGEINFOROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D52A2D0)
#define RPG_GAMECORE_TITANATLASCHANGEINFOROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D52A3E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TitanAtlasChangeInfoRow_TypeDefinitionIndex = 15129;
