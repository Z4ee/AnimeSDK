...
#define RPG_GAMECORE_GRIDFIGHTORBEXTRABONUSCONFIG_METHOD_2_034344149C20E4F0_OFFSET UNITYSDK_OFFSET(0x197F6130)
#define RPG_GAMECORE_GRIDFIGHTORBEXTRABONUSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x197F6170)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightOrbExtraBonusConfig_TypeDefinitionIndex = 18404;
