...
#define RPG_GAMECORE_ADVBYFASTDELIVERHASMULTIROUTE_METHOD_4_565FBE0F8A7C62B1_OFFSET UNITYSDK_OFFSET(0x1BE12FB0)
#define RPG_GAMECORE_ADVBYFASTDELIVERHASMULTIROUTE_METHOD_4_B29A8B3E13F243DD_OFFSET UNITYSDK_OFFSET(0x1BE131B0)
#define RPG_GAMECORE_ADVBYFASTDELIVERHASMULTIROUTE_METHOD_4_DDA19FFE55B8F539_OFFSET UNITYSDK_OFFSET(0x1BE13030)
#define RPG_GAMECORE_ADVBYFASTDELIVERHASMULTIROUTE_METHOD_4_E01506BC42F80AE5_OFFSET UNITYSDK_OFFSET(0x1BE13200)
#define RPG_GAMECORE_ADVBYFASTDELIVERHASMULTIROUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE13000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvByFastDeliverHasMultiRoute_TypeDefinitionIndex = 21352;
