...
#define RPG_GAMECORE_ROGUEACTGETSCOINBYCHESSMAINSTORYCONFIG_METHOD_6_0DC0514603D38FC3_OFFSET UNITYSDK_OFFSET(0x18CC44E0)
#define RPG_GAMECORE_ROGUEACTGETSCOINBYCHESSMAINSTORYCONFIG_METHOD_6_1AD180D494C5E9B6_OFFSET UNITYSDK_OFFSET(0x18CC42C0)
#define RPG_GAMECORE_ROGUEACTGETSCOINBYCHESSMAINSTORYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CC4400)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActGetScoinByChessMainStoryConfig_TypeDefinitionIndex = 18651;
