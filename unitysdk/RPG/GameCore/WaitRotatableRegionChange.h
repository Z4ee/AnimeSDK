...
#define RPG_GAMECORE_WAITROTATABLEREGIONCHANGE_METHOD_4_6932E791DA7837A2_OFFSET UNITYSDK_OFFSET(0x1D1BB7F0)
#define RPG_GAMECORE_WAITROTATABLEREGIONCHANGE_METHOD_4_91B4C68C9769355F_OFFSET UNITYSDK_OFFSET(0x1D1BB7A0)
#define RPG_GAMECORE_WAITROTATABLEREGIONCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1BB7E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitRotatableRegionChange_TypeDefinitionIndex = 20453;
