...
#define RPG_GAMECORE_WAITROTATABLEREGIONCHANGE_METHOD_4_6932E791DA7837A2_OFFSET UNITYSDK_OFFSET(0x17903AA0)
#define RPG_GAMECORE_WAITROTATABLEREGIONCHANGE_METHOD_4_73A7329C7CC44F19_OFFSET UNITYSDK_OFFSET(0x179039C0)
#define RPG_GAMECORE_WAITROTATABLEREGIONCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x17903A40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitRotatableRegionChange_TypeDefinitionIndex = 19549;
