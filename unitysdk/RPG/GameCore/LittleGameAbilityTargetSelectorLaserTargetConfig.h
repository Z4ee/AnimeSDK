...
#define RPG_GAMECORE_LITTLEGAMEABILITYTARGETSELECTORLASERTARGETCONFIG_METHOD_3_0D690C86F78CFD16_OFFSET UNITYSDK_OFFSET(0x198962A0)
#define RPG_GAMECORE_LITTLEGAMEABILITYTARGETSELECTORLASERTARGETCONFIG_METHOD_3_BED8C940652C9487_OFFSET UNITYSDK_OFFSET(0x19896200)
#define RPG_GAMECORE_LITTLEGAMEABILITYTARGETSELECTORLASERTARGETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19896290)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityTargetSelectorLaserTargetConfig_TypeDefinitionIndex = 20201;
