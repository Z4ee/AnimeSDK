...
#define RPG_GAMECORE_ST_MAIN_ELFTAKEOUTWAIT_METHOD_4_011B2438C6A538B3_OFFSET UNITYSDK_OFFSET(0x17683C90)
#define RPG_GAMECORE_ST_MAIN_ELFTAKEOUTWAIT_METHOD_4_180A7231BA83051C_OFFSET UNITYSDK_OFFSET(0x17696FD0)
#define RPG_GAMECORE_ST_MAIN_ELFTAKEOUTWAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x17683C40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_ElfTakeOutWait_TypeDefinitionIndex = 19716;
