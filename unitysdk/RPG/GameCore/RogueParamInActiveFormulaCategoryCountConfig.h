...
#define RPG_GAMECORE_ROGUEPARAMINACTIVEFORMULACATEGORYCOUNTCONFIG_METHOD_6_AB6EE4C3AA1BF501_OFFSET UNITYSDK_OFFSET(0x1E5457B0)
#define RPG_GAMECORE_ROGUEPARAMINACTIVEFORMULACATEGORYCOUNTCONFIG_METHOD_6_F6475C0DAB0C7265_OFFSET UNITYSDK_OFFSET(0x1E545800)
#define RPG_GAMECORE_ROGUEPARAMINACTIVEFORMULACATEGORYCOUNTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1E5457F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamInActiveFormulaCategoryCountConfig_TypeDefinitionIndex = 19594;
