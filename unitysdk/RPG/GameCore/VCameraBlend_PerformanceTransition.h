...
#define RPG_GAMECORE_VCAMERABLEND_PERFORMANCETRANSITION_METHOD_2_A75B70F26391EBB1_OFFSET UNITYSDK_OFFSET(0x1B886C50)
#define RPG_GAMECORE_VCAMERABLEND_PERFORMANCETRANSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B887020)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VCameraBlend_PerformanceTransition_TypeDefinitionIndex = 15771;
