...
#define RPG_GAMECORE_VCAMERABLEND_PERFORMANCETRANSITION_METHOD_2_A75B70F26391EBB1_OFFSET UNITYSDK_OFFSET(0x1D2B5210)
#define RPG_GAMECORE_VCAMERABLEND_PERFORMANCETRANSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2B55E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VCameraBlend_PerformanceTransition_TypeDefinitionIndex = 16247;
