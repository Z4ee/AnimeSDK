...
#define RPG_GAMECORE_SETDYNAMICVALUEBYFATECONTENTCOUNT_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x19C411E0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYFATECONTENTCOUNT_METHOD_4_848A49664F383297_OFFSET UNITYSDK_OFFSET(0x19C41160)
#define RPG_GAMECORE_SETDYNAMICVALUEBYFATECONTENTCOUNT_METHOD_4_9AC6292222A1BFBF_OFFSET UNITYSDK_OFFSET(0x19C39D90)
#define RPG_GAMECORE_SETDYNAMICVALUEBYFATECONTENTCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x19C39D40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByFateContentCount_TypeDefinitionIndex = 22016;
