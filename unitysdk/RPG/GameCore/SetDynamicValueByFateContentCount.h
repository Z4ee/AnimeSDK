...
#define RPG_GAMECORE_SETDYNAMICVALUEBYFATECONTENTCOUNT_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1C2E1C40)
#define RPG_GAMECORE_SETDYNAMICVALUEBYFATECONTENTCOUNT_METHOD_4_9AC6292222A1BFBF_OFFSET UNITYSDK_OFFSET(0x1C2E1A60)
#define RPG_GAMECORE_SETDYNAMICVALUEBYFATECONTENTCOUNT_METHOD_4_B6FAE4905C20BF12_OFFSET UNITYSDK_OFFSET(0x1C2E1A20)
#define RPG_GAMECORE_SETDYNAMICVALUEBYFATECONTENTCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2E1A50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByFateContentCount_TypeDefinitionIndex = 22450;
