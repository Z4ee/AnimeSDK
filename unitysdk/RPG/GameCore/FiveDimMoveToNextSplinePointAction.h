...
#define RPG_GAMECORE_FIVEDIMMOVETONEXTSPLINEPOINTACTION_METHOD_3_9C84EE6F3140A951_OFFSET UNITYSDK_OFFSET(0x1974A6A0)
#define RPG_GAMECORE_FIVEDIMMOVETONEXTSPLINEPOINTACTION_METHOD_3_E8AF509602BC3F90_OFFSET UNITYSDK_OFFSET(0x19730580)
#define RPG_GAMECORE_FIVEDIMMOVETONEXTSPLINEPOINTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19730560)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimMoveToNextSplinePointAction_TypeDefinitionIndex = 17759;
