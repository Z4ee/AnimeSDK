...
#define RPG_GAMECORE_FIVEDIMMOVETONEXTSPLINEPOINTACTION_METHOD_3_9C84EE6F3140A951_OFFSET UNITYSDK_OFFSET(0x171FECA0)
#define RPG_GAMECORE_FIVEDIMMOVETONEXTSPLINEPOINTACTION_METHOD_3_E8AF509602BC3F90_OFFSET UNITYSDK_OFFSET(0x171FED60)
#define RPG_GAMECORE_FIVEDIMMOVETONEXTSPLINEPOINTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x171FED40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimMoveToNextSplinePointAction_TypeDefinitionIndex = 17131;
