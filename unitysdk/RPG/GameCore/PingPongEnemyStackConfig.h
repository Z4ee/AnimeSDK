...
#define RPG_GAMECORE_PINGPONGENEMYSTACKCONFIG_METHOD_2_968F8BD808C06A62_OFFSET UNITYSDK_OFFSET(0x18BFBEB0)
#define RPG_GAMECORE_PINGPONGENEMYSTACKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18BFC000)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PingPongEnemyStackConfig_TypeDefinitionIndex = 16081;
