...
#define RPG_GAMECORE_PINGPONGENEMYSTACKCONFIG_METHOD_2_968F8BD808C06A62_OFFSET UNITYSDK_OFFSET(0x1D331D60)
#define RPG_GAMECORE_PINGPONGENEMYSTACKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D331EB0)
