...
#define RPG_GAMECORE_GIFTDANMUCONTENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D95A0F0)
#define RPG_GAMECORE_GIFTDANMUCONTENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D95A2F0)
