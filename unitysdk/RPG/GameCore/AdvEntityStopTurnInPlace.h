...
#define RPG_GAMECORE_ADVENTITYSTOPTURNINPLACE_METHOD_3_2D7A6E933C58D4C7_OFFSET UNITYSDK_OFFSET(0x1CDC8FD0)
#define RPG_GAMECORE_ADVENTITYSTOPTURNINPLACE_METHOD_3_604557905DFC1446_OFFSET UNITYSDK_OFFSET(0x1CDC9020)
#define RPG_GAMECORE_ADVENTITYSTOPTURNINPLACE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CDC9010)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvEntityStopTurnInPlace_TypeDefinitionIndex = 20309;
