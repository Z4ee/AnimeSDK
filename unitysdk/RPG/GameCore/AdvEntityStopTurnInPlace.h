...
#define RPG_GAMECORE_ADVENTITYSTOPTURNINPLACE_METHOD_3_604557905DFC1446_OFFSET UNITYSDK_OFFSET(0x18650530)
#define RPG_GAMECORE_ADVENTITYSTOPTURNINPLACE_METHOD_3_802314FF18A5ACAF_OFFSET UNITYSDK_OFFSET(0x18650490)
#define RPG_GAMECORE_ADVENTITYSTOPTURNINPLACE__CTOR_OFFSET UNITYSDK_OFFSET(0x186504F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvEntityStopTurnInPlace_TypeDefinitionIndex = 19511;
