...
#define RPG_GAMECORE_BYCHECKMODIFIERDEATHSOURCE_METHOD_4_B31C504FCF3370DE_OFFSET UNITYSDK_OFFSET(0x18724560)
#define RPG_GAMECORE_BYCHECKMODIFIERDEATHSOURCE_METHOD_4_EC5D0F97D38DC4E0_OFFSET UNITYSDK_OFFSET(0x18724490)
#define RPG_GAMECORE_BYCHECKMODIFIERDEATHSOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x18724510)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCheckModifierDeathSource_TypeDefinitionIndex = 21973;
