...
#define RPG_GAMECORE_WAITENTERBATTLETRANSITIONFINISH_METHOD_3_3649F7D868A38CEB_OFFSET UNITYSDK_OFFSET(0x1B8A3220)
#define RPG_GAMECORE_WAITENTERBATTLETRANSITIONFINISH_METHOD_3_E249445DB8B08D32_OFFSET UNITYSDK_OFFSET(0x1B8A3270)
#define RPG_GAMECORE_WAITENTERBATTLETRANSITIONFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8A3260)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitEnterBattleTransitionFinish_TypeDefinitionIndex = 22481;
