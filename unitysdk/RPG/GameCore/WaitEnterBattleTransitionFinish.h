...
#define RPG_GAMECORE_WAITENTERBATTLETRANSITIONFINISH_METHOD_3_3649F7D868A38CEB_OFFSET UNITYSDK_OFFSET(0x1D6A1860)
#define RPG_GAMECORE_WAITENTERBATTLETRANSITIONFINISH_METHOD_3_E249445DB8B08D32_OFFSET UNITYSDK_OFFSET(0x1D6A18B0)
#define RPG_GAMECORE_WAITENTERBATTLETRANSITIONFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x1D6A18A0)
