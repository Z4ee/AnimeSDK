...
#define RPG_GAMECORE_ADVCREATEGROUPENTITY_METHOD_3_21569FF52B85BCFD_OFFSET UNITYSDK_OFFSET(0x1864C0F0)
#define RPG_GAMECORE_ADVCREATEGROUPENTITY_METHOD_3_D06B849C1EE95076_OFFSET UNITYSDK_OFFSET(0x1864C070)
#define RPG_GAMECORE_ADVCREATEGROUPENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1864C0C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvCreateGroupEntity_TypeDefinitionIndex = 19225;
