...
#define RPG_GAMECORE_FIVEDIMBASEEVENTCONDITION_METHOD_2_07E47907727C537A_OFFSET UNITYSDK_OFFSET(0x197288E0)
#define RPG_GAMECORE_FIVEDIMBASEEVENTCONDITION_METHOD_2_6129AC8DC6E421E5_OFFSET UNITYSDK_OFFSET(0x19733F30)
#define RPG_GAMECORE_FIVEDIMBASEEVENTCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x19733F90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimBaseEventCondition_TypeDefinitionIndex = 17882;
