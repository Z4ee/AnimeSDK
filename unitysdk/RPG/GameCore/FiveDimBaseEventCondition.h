...
#define RPG_GAMECORE_FIVEDIMBASEEVENTCONDITION_METHOD_2_07E47907727C537A_OFFSET UNITYSDK_OFFSET(0x188EC1A0)
#define RPG_GAMECORE_FIVEDIMBASEEVENTCONDITION_METHOD_2_6129AC8DC6E421E5_OFFSET UNITYSDK_OFFSET(0x188F8790)
#define RPG_GAMECORE_FIVEDIMBASEEVENTCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x188F87F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimBaseEventCondition_TypeDefinitionIndex = 17853;
