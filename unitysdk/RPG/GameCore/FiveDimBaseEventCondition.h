...
#define RPG_GAMECORE_FIVEDIMBASEEVENTCONDITION_METHOD_2_07E47907727C537A_OFFSET UNITYSDK_OFFSET(0x1D0A2040)
#define RPG_GAMECORE_FIVEDIMBASEEVENTCONDITION_METHOD_2_6129AC8DC6E421E5_OFFSET UNITYSDK_OFFSET(0x1D0A4380)
#define RPG_GAMECORE_FIVEDIMBASEEVENTCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0A43E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimBaseEventCondition_TypeDefinitionIndex = 18584;
