...
#define RPG_GAMECORE_BLOCKINPUTCONTROLLER_METHOD_3_4AEA4D716D9911D2_OFFSET UNITYSDK_OFFSET(0x1870CAE0)
#define RPG_GAMECORE_BLOCKINPUTCONTROLLER_METHOD_3_4E292CB22BD4CA83_OFFSET UNITYSDK_OFFSET(0x1870CA60)
#define RPG_GAMECORE_BLOCKINPUTCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1870CAB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BlockInputController_TypeDefinitionIndex = 19424;
