...
#define RPG_GAMECORE_ACTIVITYELATIONSHOWCUTIN_METHOD_3_A94B04E13530B673_OFFSET UNITYSDK_OFFSET(0x1AAE41D0)
#define RPG_GAMECORE_ACTIVITYELATIONSHOWCUTIN_METHOD_3_DE0B16751B358A1E_OFFSET UNITYSDK_OFFSET(0x1AAE4210)
#define RPG_GAMECORE_ACTIVITYELATIONSHOWCUTIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAE4200)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityElationShowCutIn_TypeDefinitionIndex = 22395;
