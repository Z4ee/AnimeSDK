...
#define RPG_GAMECORE_SPACEZOOSPECIALCATROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D5446D0)
#define RPG_GAMECORE_SPACEZOOSPECIALCATROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D544FD0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::Il2CppArray<::System::UInt32>* MatchedChannelFeature; // 0x18
		::System::String* MatPath; // 0x20
		::Il2CppArray<::System::String*>* ColorBar; // 0x28
		::System::String* LargeImagePath; // 0x30
		::Il2CppArray<::System::UInt32>* TipsCustomizedCat; // 0x38
		::System::UInt32 SpecialItem; // 0x40
		...
		::System::UInt32 PhotoSubmissionID; // 0x54
