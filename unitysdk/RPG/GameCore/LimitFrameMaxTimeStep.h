...
#define RPG_GAMECORE_LIMITFRAMEMAXTIMESTEP_METHOD_3_263C9029BA8E4E5B_OFFSET UNITYSDK_OFFSET(0x1734ED40)
#define RPG_GAMECORE_LIMITFRAMEMAXTIMESTEP_METHOD_3_868885340C799948_OFFSET UNITYSDK_OFFSET(0x1734ECA0)
#define RPG_GAMECORE_LIMITFRAMEMAXTIMESTEP__CTOR_OFFSET UNITYSDK_OFFSET(0x1734ED00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LimitFrameMaxTimeStep_TypeDefinitionIndex = 19214;
