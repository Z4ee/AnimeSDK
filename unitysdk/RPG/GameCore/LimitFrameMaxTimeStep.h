...
#define RPG_GAMECORE_LIMITFRAMEMAXTIMESTEP_METHOD_3_263C9029BA8E4E5B_OFFSET UNITYSDK_OFFSET(0x1DD5BD80)
#define RPG_GAMECORE_LIMITFRAMEMAXTIMESTEP_METHOD_3_2F1E13C1FF206B0A_OFFSET UNITYSDK_OFFSET(0x1DD5BD20)
#define RPG_GAMECORE_LIMITFRAMEMAXTIMESTEP__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD5BD60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LimitFrameMaxTimeStep_TypeDefinitionIndex = 20648;
