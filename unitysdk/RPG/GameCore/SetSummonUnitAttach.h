...
#define RPG_GAMECORE_SETSUMMONUNITATTACH_METHOD_3_9B602724071F6F7D_OFFSET UNITYSDK_OFFSET(0x176DFD70)
#define RPG_GAMECORE_SETSUMMONUNITATTACH_METHOD_3_C3B9A446E906BF59_OFFSET UNITYSDK_OFFSET(0x176DFCD0)
#define RPG_GAMECORE_SETSUMMONUNITATTACH__CTOR_OFFSET UNITYSDK_OFFSET(0x176DFD30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetSummonUnitAttach_TypeDefinitionIndex = 18444;
