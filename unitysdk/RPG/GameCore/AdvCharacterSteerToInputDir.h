...
#define RPG_GAMECORE_ADVCHARACTERSTEERTOINPUTDIR_METHOD_3_1F605BCABA65CBFE_OFFSET UNITYSDK_OFFSET(0x16F28E70)
#define RPG_GAMECORE_ADVCHARACTERSTEERTOINPUTDIR_METHOD_3_5D861ADE43A37ABD_OFFSET UNITYSDK_OFFSET(0x16F28EF0)
#define RPG_GAMECORE_ADVCHARACTERSTEERTOINPUTDIR__CTOR_OFFSET UNITYSDK_OFFSET(0x16F28EC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvCharacterSteerToInputDir_TypeDefinitionIndex = 18522;
