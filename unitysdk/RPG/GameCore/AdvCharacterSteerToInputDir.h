...
#define RPG_GAMECORE_ADVCHARACTERSTEERTOINPUTDIR_METHOD_3_5D861ADE43A37ABD_OFFSET UNITYSDK_OFFSET(0x1BE17780)
#define RPG_GAMECORE_ADVCHARACTERSTEERTOINPUTDIR_METHOD_3_D3CAFED6DD117D88_OFFSET UNITYSDK_OFFSET(0x1BE17740)
#define RPG_GAMECORE_ADVCHARACTERSTEERTOINPUTDIR__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE17770)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvCharacterSteerToInputDir_TypeDefinitionIndex = 19457;
