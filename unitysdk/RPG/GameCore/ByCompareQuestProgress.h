...
#define RPG_GAMECORE_BYCOMPAREQUESTPROGRESS_METHOD_4_125783494A95DF5A_OFFSET UNITYSDK_OFFSET(0x18738700)
#define RPG_GAMECORE_BYCOMPAREQUESTPROGRESS_METHOD_4_3EDF3B86EAE712EF_OFFSET UNITYSDK_OFFSET(0x187387E0)
#define RPG_GAMECORE_BYCOMPAREQUESTPROGRESS__CTOR_OFFSET UNITYSDK_OFFSET(0x18738780)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareQuestProgress_TypeDefinitionIndex = 19561;
