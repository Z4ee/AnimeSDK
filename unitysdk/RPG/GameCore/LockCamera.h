...
#define RPG_GAMECORE_LOCKCAMERA_METHOD_3_B91E38D54A5EBE4A_OFFSET UNITYSDK_OFFSET(0x18A77E60)
#define RPG_GAMECORE_LOCKCAMERA_METHOD_3_FD212F36C492D00B_OFFSET UNITYSDK_OFFSET(0x18A77EF0)
#define RPG_GAMECORE_LOCKCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x18A77EC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LockCamera_TypeDefinitionIndex = 19091;
