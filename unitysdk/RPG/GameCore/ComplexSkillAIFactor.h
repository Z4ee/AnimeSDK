...
#define RPG_GAMECORE_COMPLEXSKILLAIFACTOR_METHOD_2_9D6E00DF3F01E5AB_OFFSET UNITYSDK_OFFSET(0x19669EC0)
#define RPG_GAMECORE_COMPLEXSKILLAIFACTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1966A020)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAIFactor_TypeDefinitionIndex = 14795;
