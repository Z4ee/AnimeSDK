...
#define RPG_GAMECORE_COMPLEXSKILLAIFACTOR_METHOD_2_9D6E00DF3F01E5AB_OFFSET UNITYSDK_OFFSET(0x1D9A8570)
#define RPG_GAMECORE_COMPLEXSKILLAIFACTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D9A86D0)
