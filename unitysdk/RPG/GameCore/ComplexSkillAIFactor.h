...
#define RPG_GAMECORE_COMPLEXSKILLAIFACTOR_METHOD_2_9D6E00DF3F01E5AB_OFFSET UNITYSDK_OFFSET(0x1BC24440)
#define RPG_GAMECORE_COMPLEXSKILLAIFACTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC245A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAIFactor_TypeDefinitionIndex = 14957;
