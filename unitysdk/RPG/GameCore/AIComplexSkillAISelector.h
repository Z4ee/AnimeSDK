...
#define RPG_GAMECORE_AICOMPLEXSKILLAISELECTOR_METHOD_3_A89D4A8409FFB675_OFFSET UNITYSDK_OFFSET(0x185EF2D0)
#define RPG_GAMECORE_AICOMPLEXSKILLAISELECTOR_METHOD_3_D1D1E30EAACDB0DA_OFFSET UNITYSDK_OFFSET(0x185EF310)
#define RPG_GAMECORE_AICOMPLEXSKILLAISELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x185EF300)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AIComplexSkillAISelector_TypeDefinitionIndex = 14770;
