...
#define RPG_GAMECORE_AICOMPLEXSKILLAISELECTOR_METHOD_3_A89D4A8409FFB675_OFFSET UNITYSDK_OFFSET(0x16E8ECF0)
#define RPG_GAMECORE_AICOMPLEXSKILLAISELECTOR_METHOD_3_D1D1E30EAACDB0DA_OFFSET UNITYSDK_OFFSET(0x16E8ED30)
#define RPG_GAMECORE_AICOMPLEXSKILLAISELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x16E8ED20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AIComplexSkillAISelector_TypeDefinitionIndex = 14300;
