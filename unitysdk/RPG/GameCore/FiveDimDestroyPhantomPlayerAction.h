...
#define RPG_GAMECORE_FIVEDIMDESTROYPHANTOMPLAYERACTION_METHOD_3_56434138D9DEA3F8_OFFSET UNITYSDK_OFFSET(0x188F44E0)
#define RPG_GAMECORE_FIVEDIMDESTROYPHANTOMPLAYERACTION_METHOD_3_675673FCDDA7FFDD_OFFSET UNITYSDK_OFFSET(0x188FD1D0)
#define RPG_GAMECORE_FIVEDIMDESTROYPHANTOMPLAYERACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x188F44C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimDestroyPhantomPlayerAction_TypeDefinitionIndex = 17735;
