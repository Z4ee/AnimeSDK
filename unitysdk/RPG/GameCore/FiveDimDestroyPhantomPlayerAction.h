...
#define RPG_GAMECORE_FIVEDIMDESTROYPHANTOMPLAYERACTION_METHOD_3_56434138D9DEA3F8_OFFSET UNITYSDK_OFFSET(0x1972D7E0)
#define RPG_GAMECORE_FIVEDIMDESTROYPHANTOMPLAYERACTION_METHOD_3_675673FCDDA7FFDD_OFFSET UNITYSDK_OFFSET(0x197388E0)
#define RPG_GAMECORE_FIVEDIMDESTROYPHANTOMPLAYERACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1972D7C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimDestroyPhantomPlayerAction_TypeDefinitionIndex = 17762;
