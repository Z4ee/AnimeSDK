...
#define RPG_GAMECORE_REMOVEANIMATIONCLIP_METHOD_3_7656FE9BC49539FA_OFFSET UNITYSDK_OFFSET(0x18CA2810)
#define RPG_GAMECORE_REMOVEANIMATIONCLIP_METHOD_3_F921D07A29F5C383_OFFSET UNITYSDK_OFFSET(0x18CA2790)
#define RPG_GAMECORE_REMOVEANIMATIONCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x18CA27E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveAnimationClip_TypeDefinitionIndex = 19224;
