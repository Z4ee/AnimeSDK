...
#define RPG_GAMECORE_REMOVEANIMATIONCLIP_METHOD_3_7656FE9BC49539FA_OFFSET UNITYSDK_OFFSET(0x1D39D900)
#define RPG_GAMECORE_REMOVEANIMATIONCLIP_METHOD_3_8FACF95B4A86E8F1_OFFSET UNITYSDK_OFFSET(0x1D39D8C0)
#define RPG_GAMECORE_REMOVEANIMATIONCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D39D8F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RemoveAnimationClip_TypeDefinitionIndex = 20047;
