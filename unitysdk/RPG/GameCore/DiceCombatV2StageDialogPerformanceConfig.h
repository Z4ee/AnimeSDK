...
#define RPG_GAMECORE_DICECOMBATV2STAGEDIALOGPERFORMANCECONFIG_METHOD_2_D62CAE80E5F0D669_OFFSET UNITYSDK_OFFSET(0x196BBB00)
#define RPG_GAMECORE_DICECOMBATV2STAGEDIALOGPERFORMANCECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x196BBBF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatV2StageDialogPerformanceConfig_TypeDefinitionIndex = 15414;
