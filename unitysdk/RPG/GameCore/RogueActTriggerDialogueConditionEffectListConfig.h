...
#define RPG_GAMECORE_ROGUEACTTRIGGERDIALOGUECONDITIONEFFECTLISTCONFIG_METHOD_6_E25213CFFB826857_OFFSET UNITYSDK_OFFSET(0x18CD5320)
#define RPG_GAMECORE_ROGUEACTTRIGGERDIALOGUECONDITIONEFFECTLISTCONFIG_METHOD_6_F8E99215D109B8E2_OFFSET UNITYSDK_OFFSET(0x18CD5540)
#define RPG_GAMECORE_ROGUEACTTRIGGERDIALOGUECONDITIONEFFECTLISTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CD5460)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActTriggerDialogueConditionEffectListConfig_TypeDefinitionIndex = 18633;
