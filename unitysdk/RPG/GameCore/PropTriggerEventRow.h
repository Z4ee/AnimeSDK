...
#define RPG_GAMECORE_PROPTRIGGEREVENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17571CE0)
#define RPG_GAMECORE_PROPTRIGGEREVENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x17571E80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropTriggerEventRow_TypeDefinitionIndex = 13292;
