...
#define RPG_GAMECORE_PROPTRIGGEREVENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D3755D0)
#define RPG_GAMECORE_PROPTRIGGEREVENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D375770)
