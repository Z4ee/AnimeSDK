...
#define RPG_GAMECORE_LEVELGROUPSPATIALINFO_METHOD_2_B7CE00FCB99BC24F_OFFSET UNITYSDK_OFFSET(0x18A47020)
#define RPG_GAMECORE_LEVELGROUPSPATIALINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18A47060)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelGroupSpatialInfo_TypeDefinitionIndex = 16325;
