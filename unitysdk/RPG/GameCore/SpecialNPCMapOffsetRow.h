...
#define RPG_GAMECORE_SPECIALNPCMAPOFFSETROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B0A2CC0)
#define RPG_GAMECORE_SPECIALNPCMAPOFFSETROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0A35D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SpecialNPCMapOffsetRow_TypeDefinitionIndex = 14541;
