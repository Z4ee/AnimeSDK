...
#define RPG_GAMECORE_SPECIALNPCMAPOFFSETROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19C9EE40)
#define RPG_GAMECORE_SPECIALNPCMAPOFFSETROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19C9F750)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SpecialNPCMapOffsetRow_TypeDefinitionIndex = 14393;
