...
#define RPG_GAMECORE_FIVEDIMLEVELAUDIOCONFIG_METHOD_2_3350751716BE7DAB_OFFSET UNITYSDK_OFFSET(0x1BA9CD10)
#define RPG_GAMECORE_FIVEDIMLEVELAUDIOCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA9CEF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimLevelAudioConfig_TypeDefinitionIndex = 17785;
