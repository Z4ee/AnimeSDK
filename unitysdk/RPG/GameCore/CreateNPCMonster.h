...
#define RPG_GAMECORE_CREATENPCMONSTER_METHOD_3_166DF6316EECEBF4_OFFSET UNITYSDK_OFFSET(0x1BC3B100)
#define RPG_GAMECORE_CREATENPCMONSTER_METHOD_3_21B1B84ADBAE75F0_OFFSET UNITYSDK_OFFSET(0x1BC3B150)
#define RPG_GAMECORE_CREATENPCMONSTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC3B140)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CreateNPCMonster_TypeDefinitionIndex = 19508;
