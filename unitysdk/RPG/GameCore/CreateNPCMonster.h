...
#define RPG_GAMECORE_CREATENPCMONSTER_METHOD_3_21B1B84ADBAE75F0_OFFSET UNITYSDK_OFFSET(0x19683070)
#define RPG_GAMECORE_CREATENPCMONSTER_METHOD_3_F55C200A887EC250_OFFSET UNITYSDK_OFFSET(0x19682FE0)
#define RPG_GAMECORE_CREATENPCMONSTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19683040)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CreateNPCMonster_TypeDefinitionIndex = 19152;
