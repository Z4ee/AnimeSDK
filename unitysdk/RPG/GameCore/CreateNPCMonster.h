...
#define RPG_GAMECORE_CREATENPCMONSTER_METHOD_3_21B1B84ADBAE75F0_OFFSET UNITYSDK_OFFSET(0x18843A90)
#define RPG_GAMECORE_CREATENPCMONSTER_METHOD_3_F55C200A887EC250_OFFSET UNITYSDK_OFFSET(0x18843A00)
#define RPG_GAMECORE_CREATENPCMONSTER__CTOR_OFFSET UNITYSDK_OFFSET(0x18843A60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CreateNPCMonster_TypeDefinitionIndex = 19231;
