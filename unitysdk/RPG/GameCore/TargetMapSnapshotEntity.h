...
#define RPG_GAMECORE_TARGETMAPSNAPSHOTENTITY_METHOD_3_06E3DDDA2129CF58_OFFSET UNITYSDK_OFFSET(0x177C4050)
#define RPG_GAMECORE_TARGETMAPSNAPSHOTENTITY_METHOD_3_5500FE8EDE53ED89_OFFSET UNITYSDK_OFFSET(0x177C3F90)
#define RPG_GAMECORE_TARGETMAPSNAPSHOTENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x177C4030)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapSnapshotEntity_TypeDefinitionIndex = 22233;
