...
#define RPG_GAMECORE_TARGETMAPSNAPSHOTENTITY_METHOD_3_06E3DDDA2129CF58_OFFSET UNITYSDK_OFFSET(0x1D0C3CC0)
#define RPG_GAMECORE_TARGETMAPSNAPSHOTENTITY_METHOD_3_29B61EFCD46F4A67_OFFSET UNITYSDK_OFFSET(0x1D0C3D20)
#define RPG_GAMECORE_TARGETMAPSNAPSHOTENTITY_METHOD_3_AEC8D02ED353079A_OFFSET UNITYSDK_OFFSET(0x1D0C3D40)
#define RPG_GAMECORE_TARGETMAPSNAPSHOTENTITY_METHOD_3_DE88BD6408F33CBD_OFFSET UNITYSDK_OFFSET(0x1D0C3C40)
#define RPG_GAMECORE_TARGETMAPSNAPSHOTENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0C3CB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetMapSnapshotEntity_TypeDefinitionIndex = 23101;
