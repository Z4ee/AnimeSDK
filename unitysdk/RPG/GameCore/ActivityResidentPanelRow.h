...
#define RPG_GAMECORE_ACTIVITYRESIDENTPANELROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x16F12710)
#define RPG_GAMECORE_ACTIVITYRESIDENTPANELROW__CTOR_OFFSET UNITYSDK_OFFSET(0x16F12BB0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 IntroGuideVideoID; // 0x5C
