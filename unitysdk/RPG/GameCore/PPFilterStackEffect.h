...
#define RPG_GAMECORE_PPFILTERSTACKEFFECT_METHOD_3_9B64F0A001D1D53A_OFFSET UNITYSDK_OFFSET(0x17485250)
#define RPG_GAMECORE_PPFILTERSTACKEFFECT_METHOD_3_CDFBB553691295FA_OFFSET UNITYSDK_OFFSET(0x17485180)
#define RPG_GAMECORE_PPFILTERSTACKEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x17485200)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PPFilterStackEffect_TypeDefinitionIndex = 18546;
