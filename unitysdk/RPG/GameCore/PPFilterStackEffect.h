...
#define RPG_GAMECORE_PPFILTERSTACKEFFECT_METHOD_3_9B64F0A001D1D53A_OFFSET UNITYSDK_OFFSET(0x18BCE990)
#define RPG_GAMECORE_PPFILTERSTACKEFFECT_METHOD_3_CDFBB553691295FA_OFFSET UNITYSDK_OFFSET(0x18BCE8C0)
#define RPG_GAMECORE_PPFILTERSTACKEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x18BCE940)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PPFilterStackEffect_TypeDefinitionIndex = 19199;
