...
#define RPG_GAMECORE_LITTLEGAMETEMPLATECONFIG_METHOD_2_4687957CE64D7BB2_OFFSET UNITYSDK_OFFSET(0x198A2890)
#define RPG_GAMECORE_LITTLEGAMETEMPLATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x198A28D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameTemplateConfig_TypeDefinitionIndex = 17988;
