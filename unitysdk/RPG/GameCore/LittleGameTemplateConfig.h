...
#define RPG_GAMECORE_LITTLEGAMETEMPLATECONFIG_METHOD_2_4687957CE64D7BB2_OFFSET UNITYSDK_OFFSET(0x1DD6EAD0)
#define RPG_GAMECORE_LITTLEGAMETEMPLATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD6EB10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameTemplateConfig_TypeDefinitionIndex = 18696;
