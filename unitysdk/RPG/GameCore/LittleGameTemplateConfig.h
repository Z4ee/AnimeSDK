...
#define RPG_GAMECORE_LITTLEGAMETEMPLATECONFIG_METHOD_2_4687957CE64D7BB2_OFFSET UNITYSDK_OFFSET(0x17361290)
#define RPG_GAMECORE_LITTLEGAMETEMPLATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x173612D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameTemplateConfig_TypeDefinitionIndex = 17353;
