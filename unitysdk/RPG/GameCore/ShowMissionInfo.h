...
#define RPG_GAMECORE_SHOWMISSIONINFO_METHOD_3_197CFE3A026AD1D0_OFFSET UNITYSDK_OFFSET(0x18E63E70)
#define RPG_GAMECORE_SHOWMISSIONINFO_METHOD_3_78A05FB8431E3059_OFFSET UNITYSDK_OFFSET(0x18E63EF0)
#define RPG_GAMECORE_SHOWMISSIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18E63EC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowMissionInfo_TypeDefinitionIndex = 23054;
