...
#define RPG_GAMECORE_CHENLINGBATTLEATTACHPOINTCONFIG_METHOD_2_905FA83FF24AF8E4_OFFSET UNITYSDK_OFFSET(0x187E09F0)
#define RPG_GAMECORE_CHENLINGBATTLEATTACHPOINTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x187E0B70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleAttachPointConfig_TypeDefinitionIndex = 14875;
