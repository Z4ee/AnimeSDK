...
#define RPG_GAMECORE_CHENLINGBATTLEATTACHPOINTCONFIG_METHOD_2_905FA83FF24AF8E4_OFFSET UNITYSDK_OFFSET(0x1707BF00)
#define RPG_GAMECORE_CHENLINGBATTLEATTACHPOINTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1707C080)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleAttachPointConfig_TypeDefinitionIndex = 14405;
