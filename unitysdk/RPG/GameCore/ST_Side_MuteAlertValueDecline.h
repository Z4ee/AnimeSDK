...
#define RPG_GAMECORE_ST_SIDE_MUTEALERTVALUEDECLINE_METHOD_4_5ECDFD9044F436A6_OFFSET UNITYSDK_OFFSET(0x1B78AC60)
#define RPG_GAMECORE_ST_SIDE_MUTEALERTVALUEDECLINE_METHOD_4_E3559661F1ED0DA3_OFFSET UNITYSDK_OFFSET(0x1B78AB90)
#define RPG_GAMECORE_ST_SIDE_MUTEALERTVALUEDECLINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B78AC50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_MuteAlertValueDecline_TypeDefinitionIndex = 19336;
