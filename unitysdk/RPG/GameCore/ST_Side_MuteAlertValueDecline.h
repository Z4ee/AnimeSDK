...
#define RPG_GAMECORE_ST_SIDE_MUTEALERTVALUEDECLINE_METHOD_4_02E1E38DBB76F0F1_OFFSET UNITYSDK_OFFSET(0x19C1A9F0)
#define RPG_GAMECORE_ST_SIDE_MUTEALERTVALUEDECLINE_METHOD_4_5ECDFD9044F436A6_OFFSET UNITYSDK_OFFSET(0x19C0B850)
#define RPG_GAMECORE_ST_SIDE_MUTEALERTVALUEDECLINE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C0B800)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_MuteAlertValueDecline_TypeDefinitionIndex = 18985;
