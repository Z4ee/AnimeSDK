...
#define RPG_GAMECORE_FATESHOPGOODSCONFIG_METHOD_2_8B6A975C0E446D96_OFFSET UNITYSDK_OFFSET(0x171CDB90)
#define RPG_GAMECORE_FATESHOPGOODSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171CDBD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateShopGoodsConfig_TypeDefinitionIndex = 17685;
