...
#define RPG_GAMECORE_FATESHOPGOODSCONFIG_METHOD_2_8B6A975C0E446D96_OFFSET UNITYSDK_OFFSET(0x188DB360)
#define RPG_GAMECORE_FATESHOPGOODSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x188DB3A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateShopGoodsConfig_TypeDefinitionIndex = 18298;
