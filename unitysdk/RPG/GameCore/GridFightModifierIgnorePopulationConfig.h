...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERIGNOREPOPULATIONCONFIG_METHOD_3_484BE7FCFEEA2247_OFFSET UNITYSDK_OFFSET(0x1D159E20)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERIGNOREPOPULATIONCONFIG_METHOD_3_9ACDEB82B3CC8AEB_OFFSET UNITYSDK_OFFSET(0x1D159E70)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERIGNOREPOPULATIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D159E60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierIgnorePopulationConfig_TypeDefinitionIndex = 19249;
