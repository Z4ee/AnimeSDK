...
#define RPG_GAMECORE_MODIFYTEAMBOOSTPOINTMAX_METHOD_3_757363779A7C055D_OFFSET UNITYSDK_OFFSET(0x1D1BFA50)
#define RPG_GAMECORE_MODIFYTEAMBOOSTPOINTMAX_METHOD_3_C628B72A0B038274_OFFSET UNITYSDK_OFFSET(0x1D1BFA00)
#define RPG_GAMECORE_MODIFYTEAMBOOSTPOINTMAX__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1BFA40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyTeamBoostPointMax_TypeDefinitionIndex = 22354;
