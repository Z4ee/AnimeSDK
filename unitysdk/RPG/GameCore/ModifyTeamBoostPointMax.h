...
#define RPG_GAMECORE_MODIFYTEAMBOOSTPOINTMAX_METHOD_3_757363779A7C055D_OFFSET UNITYSDK_OFFSET(0x17435810)
#define RPG_GAMECORE_MODIFYTEAMBOOSTPOINTMAX_METHOD_3_D7A5208707A12C7C_OFFSET UNITYSDK_OFFSET(0x17435780)
#define RPG_GAMECORE_MODIFYTEAMBOOSTPOINTMAX__CTOR_OFFSET UNITYSDK_OFFSET(0x174357E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ModifyTeamBoostPointMax_TypeDefinitionIndex = 20789;
