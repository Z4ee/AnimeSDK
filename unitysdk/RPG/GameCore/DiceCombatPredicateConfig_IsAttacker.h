...
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_ISATTACKER_METHOD_4_32015C2B300523BE_OFFSET UNITYSDK_OFFSET(0x17167380)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_ISATTACKER_METHOD_4_AC0DBC0E841D84B0_OFFSET UNITYSDK_OFFSET(0x17165C10)
#define RPG_GAMECORE_DICECOMBATPREDICATECONFIG_ISATTACKER__CTOR_OFFSET UNITYSDK_OFFSET(0x17165BC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatPredicateConfig_IsAttacker_TypeDefinitionIndex = 14790;
