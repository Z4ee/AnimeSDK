...
#define RPG_GAMECORE_PLAYVOICE_SEQUENCE_METHOD_3_1F1AEA60DFC07823_OFFSET UNITYSDK_OFFSET(0x174C86F0)
#define RPG_GAMECORE_PLAYVOICE_SEQUENCE_METHOD_3_33D485DED46FCD94_OFFSET UNITYSDK_OFFSET(0x174C8780)
#define RPG_GAMECORE_PLAYVOICE_SEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x174C8750)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayVoice_Sequence_TypeDefinitionIndex = 18927;
