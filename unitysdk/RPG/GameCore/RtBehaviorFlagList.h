...
#define RPG_GAMECORE_RTBEHAVIORFLAGLIST_METHOD_2_5BCE7C12CA2A7F73_OFFSET UNITYSDK_OFFSET(0x1BB8B190)
#define RPG_GAMECORE_RTBEHAVIORFLAGLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB8B250)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtBehaviorFlagList_TypeDefinitionIndex = 16931;
