...
#define RPG_GAMECORE_TOASTMANAGERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C155D30)
#define RPG_GAMECORE_TOASTMANAGERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C156700)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ToastManagerRow_TypeDefinitionIndex = 14698;
	...
	public:
		...
		::System::Boolean IsinBattle; // 0x1C
