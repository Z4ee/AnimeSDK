...
#define RPG_GAMECORE_ST_BYALERTLEVEL_METHOD_4_3976BC2F9AD70599_OFFSET UNITYSDK_OFFSET(0x1B777100)
#define RPG_GAMECORE_ST_BYALERTLEVEL_METHOD_4_5529FAAE4890EDB6_OFFSET UNITYSDK_OFFSET(0x1B777130)
#define RPG_GAMECORE_ST_BYALERTLEVEL_METHOD_4_EFF4598C53629F23_OFFSET UNITYSDK_OFFSET(0x1B776F80)
#define RPG_GAMECORE_ST_BYALERTLEVEL_METHOD_4_F1799C47B8444EAA_OFFSET UNITYSDK_OFFSET(0x1B776F40)
#define RPG_GAMECORE_ST_BYALERTLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B776F70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_ByAlertLevel_TypeDefinitionIndex = 19295;
