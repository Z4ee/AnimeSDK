...
#define RPG_GAMECORE_ST_BYALERTLEVEL_METHOD_4_6FED1BC65BD3B40D_OFFSET UNITYSDK_OFFSET(0x17691460)
#define RPG_GAMECORE_ST_BYALERTLEVEL_METHOD_4_EFF4598C53629F23_OFFSET UNITYSDK_OFFSET(0x17691530)
#define RPG_GAMECORE_ST_BYALERTLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x176914E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_ByAlertLevel_TypeDefinitionIndex = 18346;
