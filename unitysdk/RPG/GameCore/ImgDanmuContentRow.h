...
#define RPG_GAMECORE_IMGDANMUCONTENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D217620)
#define RPG_GAMECORE_IMGDANMUCONTENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D217750)
