...
#define RPG_GAMECORE_IMGDANMUCONTENTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B00A080)
#define RPG_GAMECORE_IMGDANMUCONTENTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B00A1B0)
