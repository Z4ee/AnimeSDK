...
#define RPG_GAMECORE_ROGUEACTGETMAGICUNITCOUNTBYPARAMCONFIG_METHOD_6_8CE78A5F604E3C7A_OFFSET UNITYSDK_OFFSET(0x1D02DEB0)
#define RPG_GAMECORE_ROGUEACTGETMAGICUNITCOUNTBYPARAMCONFIG_METHOD_6_F693345530C781BE_OFFSET UNITYSDK_OFFSET(0x1D02DE60)
#define RPG_GAMECORE_ROGUEACTGETMAGICUNITCOUNTBYPARAMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D02DEA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActGetMagicUnitCountByParamConfig_TypeDefinitionIndex = 18936;
