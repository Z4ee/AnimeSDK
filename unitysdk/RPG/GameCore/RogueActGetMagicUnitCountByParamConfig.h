...
#define RPG_GAMECORE_ROGUEACTGETMAGICUNITCOUNTBYPARAMCONFIG_METHOD_6_8CE78A5F604E3C7A_OFFSET UNITYSDK_OFFSET(0x18CC1D80)
#define RPG_GAMECORE_ROGUEACTGETMAGICUNITCOUNTBYPARAMCONFIG_METHOD_6_D63AFB3B2E64860F_OFFSET UNITYSDK_OFFSET(0x18CC1B60)
#define RPG_GAMECORE_ROGUEACTGETMAGICUNITCOUNTBYPARAMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CC1CA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActGetMagicUnitCountByParamConfig_TypeDefinitionIndex = 18693;
