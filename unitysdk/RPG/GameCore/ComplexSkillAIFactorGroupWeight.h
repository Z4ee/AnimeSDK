...
#define RPG_GAMECORE_COMPLEXSKILLAIFACTORGROUPWEIGHT_METHOD_2_D2B0171BCBF3A4D2_OFFSET UNITYSDK_OFFSET(0x1BC24B50)
#define RPG_GAMECORE_COMPLEXSKILLAIFACTORGROUPWEIGHT_METHOD_2_FEF69E8D470DD6C3_OFFSET UNITYSDK_OFFSET(0x1BC24C90)
#define RPG_GAMECORE_COMPLEXSKILLAIFACTORGROUPWEIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC24C80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAIFactorGroupWeight_TypeDefinitionIndex = 14959;
