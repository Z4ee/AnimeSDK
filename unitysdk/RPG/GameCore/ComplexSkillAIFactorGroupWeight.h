...
#define RPG_GAMECORE_COMPLEXSKILLAIFACTORGROUPWEIGHT_METHOD_2_D2B0171BCBF3A4D2_OFFSET UNITYSDK_OFFSET(0x1D9A8C80)
#define RPG_GAMECORE_COMPLEXSKILLAIFACTORGROUPWEIGHT_METHOD_2_FEF69E8D470DD6C3_OFFSET UNITYSDK_OFFSET(0x1D9A8DC0)
#define RPG_GAMECORE_COMPLEXSKILLAIFACTORGROUPWEIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D9A8DB0)
