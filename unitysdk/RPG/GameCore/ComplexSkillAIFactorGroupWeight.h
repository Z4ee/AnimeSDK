...
#define RPG_GAMECORE_COMPLEXSKILLAIFACTORGROUPWEIGHT_METHOD_2_D2B0171BCBF3A4D2_OFFSET UNITYSDK_OFFSET(0x1966A5D0)
#define RPG_GAMECORE_COMPLEXSKILLAIFACTORGROUPWEIGHT_METHOD_2_FEF69E8D470DD6C3_OFFSET UNITYSDK_OFFSET(0x1966A710)
#define RPG_GAMECORE_COMPLEXSKILLAIFACTORGROUPWEIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x1966A700)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ComplexSkillAIFactorGroupWeight_TypeDefinitionIndex = 14797;
