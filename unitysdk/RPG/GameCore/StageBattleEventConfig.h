...
#define RPG_GAMECORE_STAGEBATTLEEVENTCONFIG_METHOD_2_8E2FC482D3B6D76A_OFFSET UNITYSDK_OFFSET(0x18E8A1D0)
#define RPG_GAMECORE_STAGEBATTLEEVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18E8A630)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StageBattleEventConfig_TypeDefinitionIndex = 22423;
