...
#define RPG_GAMECORE_STAGEBATTLEEVENTCONFIG_METHOD_2_8E2FC482D3B6D76A_OFFSET UNITYSDK_OFFSET(0x17763C20)
#define RPG_GAMECORE_STAGEBATTLEEVENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17764080)

namespace RPG::GameCore
{
	inline static constexpr unsigned int StageBattleEventConfig_TypeDefinitionIndex = 21685;
