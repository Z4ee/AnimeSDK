...
#define RPG_GAMECORE_HIPPLENGAMEAREALISTENER_METHOD_3_54998919F21D4FB2_OFFSET UNITYSDK_OFFSET(0x1B686390)
#define RPG_GAMECORE_HIPPLENGAMEAREALISTENER_METHOD_3_BF74C21F96BE1A2D_OFFSET UNITYSDK_OFFSET(0x1B686350)
#define RPG_GAMECORE_HIPPLENGAMEAREALISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B686380)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HipplenGameAreaListener_TypeDefinitionIndex = 20503;
