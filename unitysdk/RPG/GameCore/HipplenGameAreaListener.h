...
#define RPG_GAMECORE_HIPPLENGAMEAREALISTENER_METHOD_3_202CCA5AF2120810_OFFSET UNITYSDK_OFFSET(0x172AC830)
#define RPG_GAMECORE_HIPPLENGAMEAREALISTENER_METHOD_3_CEB2B37753C29380_OFFSET UNITYSDK_OFFSET(0x172AC8B0)
#define RPG_GAMECORE_HIPPLENGAMEAREALISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x172AC880)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HipplenGameAreaListener_TypeDefinitionIndex = 19601;
