...
#define RPG_GAMECORE_PLAYTAROTBOOKTALK_METHOD_3_4A801E49CD57F46D_OFFSET UNITYSDK_OFFSET(0x1D7A8F80)
#define RPG_GAMECORE_PLAYTAROTBOOKTALK_METHOD_3_71DF5251EC370B16_OFFSET UNITYSDK_OFFSET(0x1D7A8FC0)
#define RPG_GAMECORE_PLAYTAROTBOOKTALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7A8FB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayTarotBookTalk_TypeDefinitionIndex = 20895;
