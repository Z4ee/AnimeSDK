...
#define RPG_GAMECORE_FIVEDIMEVILSMILESTATEOVERRIDECONFIG_METHOD_2_596EE3A0C2270DCD_OFFSET UNITYSDK_OFFSET(0x1D0E50A0)
#define RPG_GAMECORE_FIVEDIMEVILSMILESTATEOVERRIDECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0E51E0)
