...
#define RPG_GAMECORE_FIVEDIMEVILSMILESTATEOVERRIDECONFIG_METHOD_2_596EE3A0C2270DCD_OFFSET UNITYSDK_OFFSET(0x1D85DB30)
#define RPG_GAMECORE_FIVEDIMEVILSMILESTATEOVERRIDECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D85DC70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimEvilSmileStateOverrideConfig_TypeDefinitionIndex = 18369;
