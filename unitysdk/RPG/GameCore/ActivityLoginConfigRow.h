...
#define RPG_GAMECORE_ACTIVITYLOGINCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1AAFA300)
#define RPG_GAMECORE_ACTIVITYLOGINCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAFA900)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityLoginConfigRow_TypeDefinitionIndex = 10828;
