...
#define RPG_GAMECORE_ACTIVITYLOGINCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CA0BF00)
#define RPG_GAMECORE_ACTIVITYLOGINCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CA0C500)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityLoginConfigRow_TypeDefinitionIndex = 11203;
