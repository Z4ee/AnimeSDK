...
#define RPG_GAMECORE_UNLOADBACKGROUNDPLAYER_METHOD_3_2800F9CD013DB176_OFFSET UNITYSDK_OFFSET(0x19E378D0)
#define RPG_GAMECORE_UNLOADBACKGROUNDPLAYER_METHOD_3_F0D34E654A8B0777_OFFSET UNITYSDK_OFFSET(0x19E37840)
#define RPG_GAMECORE_UNLOADBACKGROUNDPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x19E378A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UnloadBackgroundPlayer_TypeDefinitionIndex = 19086;
