...
#define RPG_GAMECORE_UNLOADBACKGROUNDPLAYER_METHOD_3_2800F9CD013DB176_OFFSET UNITYSDK_OFFSET(0x1D623930)
#define RPG_GAMECORE_UNLOADBACKGROUNDPLAYER_METHOD_3_D7C7B488384FD88D_OFFSET UNITYSDK_OFFSET(0x1D6238E0)
#define RPG_GAMECORE_UNLOADBACKGROUNDPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D623920)

namespace RPG::GameCore
{
	inline static constexpr unsigned int UnloadBackgroundPlayer_TypeDefinitionIndex = 19984;
