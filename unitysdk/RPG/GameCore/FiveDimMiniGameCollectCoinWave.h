...
#define RPG_GAMECORE_FIVEDIMMINIGAMECOLLECTCOINWAVE_METHOD_2_7502ECE3138BA482_OFFSET UNITYSDK_OFFSET(0x171FA6F0)
#define RPG_GAMECORE_FIVEDIMMINIGAMECOLLECTCOINWAVE__CTOR_OFFSET UNITYSDK_OFFSET(0x171FA8E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimMiniGameCollectCoinWave_TypeDefinitionIndex = 17256;
