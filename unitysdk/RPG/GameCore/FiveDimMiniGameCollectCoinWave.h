...
#define RPG_GAMECORE_FIVEDIMMINIGAMECOLLECTCOINWAVE_METHOD_2_FEBE7F531CA16D8D_OFFSET UNITYSDK_OFFSET(0x197469B0)
#define RPG_GAMECORE_FIVEDIMMINIGAMECOLLECTCOINWAVE__CTOR_OFFSET UNITYSDK_OFFSET(0x19746BA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimMiniGameCollectCoinWave_TypeDefinitionIndex = 17893;
