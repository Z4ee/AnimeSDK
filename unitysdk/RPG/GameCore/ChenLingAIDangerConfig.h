...
#define RPG_GAMECORE_CHENLINGAIDANGERCONFIG_METHOD_2_1DB79E4B1F9C125E_OFFSET UNITYSDK_OFFSET(0x17077450)
#define RPG_GAMECORE_CHENLINGAIDANGERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17077630)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingAIDangerConfig_TypeDefinitionIndex = 14388;
