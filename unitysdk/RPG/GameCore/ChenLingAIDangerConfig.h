...
#define RPG_GAMECORE_CHENLINGAIDANGERCONFIG_METHOD_2_1DB79E4B1F9C125E_OFFSET UNITYSDK_OFFSET(0x1CFA2BD0)
#define RPG_GAMECORE_CHENLINGAIDANGERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFA2DB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingAIDangerConfig_TypeDefinitionIndex = 15523;
