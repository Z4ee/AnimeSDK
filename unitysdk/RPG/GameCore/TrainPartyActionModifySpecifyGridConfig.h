...
#define RPG_GAMECORE_TRAINPARTYACTIONMODIFYSPECIFYGRIDCONFIG_METHOD_5_889E8A09A1DAA2A6_OFFSET UNITYSDK_OFFSET(0x190A64C0)
#define RPG_GAMECORE_TRAINPARTYACTIONMODIFYSPECIFYGRIDCONFIG_METHOD_5_DC0F365764D36BCF_OFFSET UNITYSDK_OFFSET(0x190A6750)
#define RPG_GAMECORE_TRAINPARTYACTIONMODIFYSPECIFYGRIDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x190A6470)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TrainPartyActionModifySpecifyGridConfig_TypeDefinitionIndex = 17184;
