...
#define RPG_GAMECORE_SHOWGUIDETALK_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1D52A9C0)
#define RPG_GAMECORE_SHOWGUIDETALK_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D52A970)
#define RPG_GAMECORE_SHOWGUIDETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D52A9B0)
