...
#define RPG_GAMECORE_SHOWGUIDETALK_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1D095250)
#define RPG_GAMECORE_SHOWGUIDETALK_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D095200)
#define RPG_GAMECORE_SHOWGUIDETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D095240)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowGuideTalk_TypeDefinitionIndex = 24059;
