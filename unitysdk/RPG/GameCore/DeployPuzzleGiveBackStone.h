...
#define RPG_GAMECORE_DEPLOYPUZZLEGIVEBACKSTONE_METHOD_3_8EF48CC08B7B8A94_OFFSET UNITYSDK_OFFSET(0x19699E90)
#define RPG_GAMECORE_DEPLOYPUZZLEGIVEBACKSTONE_METHOD_3_B17135A363426E3A_OFFSET UNITYSDK_OFFSET(0x19699D40)
#define RPG_GAMECORE_DEPLOYPUZZLEGIVEBACKSTONE__CTOR_OFFSET UNITYSDK_OFFSET(0x19699E00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DeployPuzzleGiveBackStone_TypeDefinitionIndex = 20757;
