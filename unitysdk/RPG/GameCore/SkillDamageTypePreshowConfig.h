...
#define RPG_GAMECORE_SKILLDAMAGETYPEPRESHOWCONFIG_METHOD_2_F1AA97BC5F2D9469_OFFSET UNITYSDK_OFFSET(0x1770E490)
#define RPG_GAMECORE_SKILLDAMAGETYPEPRESHOWCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1770E620)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SkillDamageTypePreshowConfig_TypeDefinitionIndex = 15678;
