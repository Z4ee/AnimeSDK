...
#define RPG_GAMECORE_SKILLDAMAGETYPEPRESHOWCONFIG_METHOD_2_F1AA97BC5F2D9469_OFFSET UNITYSDK_OFFSET(0x18E71FF0)
#define RPG_GAMECORE_SKILLDAMAGETYPEPRESHOWCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18E72180)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SkillDamageTypePreshowConfig_TypeDefinitionIndex = 16204;
