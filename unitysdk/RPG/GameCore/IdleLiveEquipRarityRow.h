...
#define RPG_GAMECORE_IDLELIVEEQUIPRARITYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19842890)
#define RPG_GAMECORE_IDLELIVEEQUIPRARITYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19842C10)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::FixPoint SpEquipPowerFactor; // 0x48
