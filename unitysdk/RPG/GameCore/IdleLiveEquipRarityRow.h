...
#define RPG_GAMECORE_IDLELIVEEQUIPRARITYROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D19EBC0)
#define RPG_GAMECORE_IDLELIVEEQUIPRARITYROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D19EF40)
