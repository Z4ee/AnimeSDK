...
#define RPG_GAMECORE_EXPEDITIONBATTLESTRONGATKACTION_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1D7DD6F0)
#define RPG_GAMECORE_EXPEDITIONBATTLESTRONGATKACTION_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D7DD610)
#define RPG_GAMECORE_EXPEDITIONBATTLESTRONGATKACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7DD6E0)
