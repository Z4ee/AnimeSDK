...
#define RPG_GAMECORE_STAGEMONSTERINVASIONPARAMROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D559AC0)
#define RPG_GAMECORE_STAGEMONSTERINVASIONPARAMROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D559C40)
