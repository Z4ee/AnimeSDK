...
#define RPG_GAMECORE_SHOWHIPPLENBUBBLETALK_METHOD_3_725079C75BFC73B3_OFFSET UNITYSDK_OFFSET(0x1D096BF0)
#define RPG_GAMECORE_SHOWHIPPLENBUBBLETALK_METHOD_3_BBADCB6F8B8BACC4_OFFSET UNITYSDK_OFFSET(0x1D096C40)
#define RPG_GAMECORE_SHOWHIPPLENBUBBLETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D096C30)
