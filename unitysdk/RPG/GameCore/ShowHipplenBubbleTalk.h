...
#define RPG_GAMECORE_SHOWHIPPLENBUBBLETALK_METHOD_3_BBADCB6F8B8BACC4_OFFSET UNITYSDK_OFFSET(0x176FF410)
#define RPG_GAMECORE_SHOWHIPPLENBUBBLETALK_METHOD_3_EBBAA119287BA65E_OFFSET UNITYSDK_OFFSET(0x176FF380)
#define RPG_GAMECORE_SHOWHIPPLENBUBBLETALK__CTOR_OFFSET UNITYSDK_OFFSET(0x176FF3E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowHipplenBubbleTalk_TypeDefinitionIndex = 19600;
