...
#define RPG_GAMECORE_ELFENTRANCENPCSET_METHOD_2_DEF186780ED1D1CA_OFFSET UNITYSDK_OFFSET(0x1D058EB0)
#define RPG_GAMECORE_ELFENTRANCENPCSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1D058FA0)
