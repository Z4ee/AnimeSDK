...
#define RPG_GAMECORE_LEVELPEDESTRIANNODEINFO_METHOD_2_7245DFC047598AC7_OFFSET UNITYSDK_OFFSET(0x18A53460)
#define RPG_GAMECORE_LEVELPEDESTRIANNODEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18A535B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPedestrianNodeInfo_TypeDefinitionIndex = 16403;
