...
#define RPG_GAMECORE_LEVELPEDESTRIANNODEINFO_METHOD_2_7245DFC047598AC7_OFFSET UNITYSDK_OFFSET(0x1B081F00)
#define RPG_GAMECORE_LEVELPEDESTRIANNODEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B082050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelPedestrianNodeInfo_TypeDefinitionIndex = 16599;
