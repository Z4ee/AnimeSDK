...
#define RPG_GAMECORE_SHOWFUNCBTN_METHOD_3_1FFF7094239D9B4A_OFFSET UNITYSDK_OFFSET(0x176FB130)
#define RPG_GAMECORE_SHOWFUNCBTN_METHOD_3_40DEED2365CA5863_OFFSET UNITYSDK_OFFSET(0x176FB1F0)
#define RPG_GAMECORE_SHOWFUNCBTN__CTOR_OFFSET UNITYSDK_OFFSET(0x176FB1A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowFuncBtn_TypeDefinitionIndex = 18795;
