...
#define RPG_GAMECORE_DEVICERELATEDGAMEOBJECTPOOLCONFIG_METHOD_3_1DE617CE8B142C12_OFFSET UNITYSDK_OFFSET(0x17156E20)
#define RPG_GAMECORE_DEVICERELATEDGAMEOBJECTPOOLCONFIG_METHOD_3_E93DF3D109B71934_OFFSET UNITYSDK_OFFSET(0x17157450)
#define RPG_GAMECORE_DEVICERELATEDGAMEOBJECTPOOLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17156E10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DeviceRelatedGameObjectPoolConfig_TypeDefinitionIndex = 15084;
