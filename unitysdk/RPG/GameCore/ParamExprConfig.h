...
#define RPG_GAMECORE_PARAMEXPRCONFIG_METHOD_4_A687E3B7B29FC14C_OFFSET UNITYSDK_OFFSET(0x18BD3630)
#define RPG_GAMECORE_PARAMEXPRCONFIG_METHOD_4_E987CEF32A2FD927_OFFSET UNITYSDK_OFFSET(0x18BD3770)
#define RPG_GAMECORE_PARAMEXPRCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18BD36F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ParamExprConfig_TypeDefinitionIndex = 16170;
