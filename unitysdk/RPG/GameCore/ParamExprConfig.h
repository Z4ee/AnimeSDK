...
#define RPG_GAMECORE_PARAMEXPRCONFIG_METHOD_4_A687E3B7B29FC14C_OFFSET UNITYSDK_OFFSET(0x17489110)
#define RPG_GAMECORE_PARAMEXPRCONFIG_METHOD_4_E987CEF32A2FD927_OFFSET UNITYSDK_OFFSET(0x17489250)
#define RPG_GAMECORE_PARAMEXPRCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x174891D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ParamExprConfig_TypeDefinitionIndex = 15648;
