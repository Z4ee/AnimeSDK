...
#define RPG_GAMECORE_GRIDFIGHTTRAITREMARKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D16D590)
#define RPG_GAMECORE_GRIDFIGHTTRAITREMARKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D16D9D0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Boolean IsInBook; // 0x40
		::RPG::GameCore::GridFightTraitRemarkActiveEffect Format; // 0x44
