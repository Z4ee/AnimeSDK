...
#define RPG_GAMECORE_ELFSELECTEVENTTALK_METHOD_2_3F94B5673198D43B_OFFSET UNITYSDK_OFFSET(0x1BB39490)
#define RPG_GAMECORE_ELFSELECTEVENTTALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB395F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ElfSelectEventTalk_TypeDefinitionIndex = 17761;
