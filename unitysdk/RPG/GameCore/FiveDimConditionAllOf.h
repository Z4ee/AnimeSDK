...
#define RPG_GAMECORE_FIVEDIMCONDITIONALLOF_METHOD_3_1D2A6B2347ACDC40_OFFSET UNITYSDK_OFFSET(0x1BA8B280)
#define RPG_GAMECORE_FIVEDIMCONDITIONALLOF_METHOD_3_DFD074E1E410140B_OFFSET UNITYSDK_OFFSET(0x1BA8E030)
#define RPG_GAMECORE_FIVEDIMCONDITIONALLOF__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA8B270)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimConditionAllOf_TypeDefinitionIndex = 18062;
