...
#define RPG_GAMECORE_BOXINGCLUBSTAGECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CE95AA0)
#define RPG_GAMECORE_BOXINGCLUBSTAGECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE962D0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 MonsterWaveIndex; // 0x50
		::System::UInt32 BuffID; // 0x54
