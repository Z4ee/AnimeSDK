...
#define RPG_GAMECORE_RESETCHARLIGHTFROMENTITYDIR_METHOD_3_4C67A3CACB17324A_OFFSET UNITYSDK_OFFSET(0x19ACEC50)
#define RPG_GAMECORE_RESETCHARLIGHTFROMENTITYDIR_METHOD_3_F066337EB592BEDE_OFFSET UNITYSDK_OFFSET(0x19ACEB40)
#define RPG_GAMECORE_RESETCHARLIGHTFROMENTITYDIR__CTOR_OFFSET UNITYSDK_OFFSET(0x19ACEC20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetCharLightFromEntityDir_TypeDefinitionIndex = 20654;
