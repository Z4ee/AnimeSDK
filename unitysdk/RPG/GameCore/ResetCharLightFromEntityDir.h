...
#define RPG_GAMECORE_RESETCHARLIGHTFROMENTITYDIR_METHOD_3_4C67A3CACB17324A_OFFSET UNITYSDK_OFFSET(0x1D01B690)
#define RPG_GAMECORE_RESETCHARLIGHTFROMENTITYDIR_METHOD_3_C5EFD93A2BC2EEE7_OFFSET UNITYSDK_OFFSET(0x1D01B5C0)
#define RPG_GAMECORE_RESETCHARLIGHTFROMENTITYDIR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D01B680)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ResetCharLightFromEntityDir_TypeDefinitionIndex = 21069;
