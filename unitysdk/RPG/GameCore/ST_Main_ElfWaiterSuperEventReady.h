...
#define RPG_GAMECORE_ST_MAIN_ELFWAITERSUPEREVENTREADY_METHOD_4_34F1B2ABD5B29E7E_OFFSET UNITYSDK_OFFSET(0x19C188A0)
#define RPG_GAMECORE_ST_MAIN_ELFWAITERSUPEREVENTREADY_METHOD_4_9948245CCBC5E5A1_OFFSET UNITYSDK_OFFSET(0x19C01CD0)
#define RPG_GAMECORE_ST_MAIN_ELFWAITERSUPEREVENTREADY__CTOR_OFFSET UNITYSDK_OFFSET(0x19C01C80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Main_ElfWaiterSuperEventReady_TypeDefinitionIndex = 20328;
