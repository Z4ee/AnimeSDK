...
#define RPG_GAMECORE_PLAYCROSSHAIRPREVIEWFADEIN_METHOD_3_09B73AFC20059162_OFFSET UNITYSDK_OFFSET(0x18C0D1A0)
#define RPG_GAMECORE_PLAYCROSSHAIRPREVIEWFADEIN_METHOD_3_451166C79BD9E8E9_OFFSET UNITYSDK_OFFSET(0x18C0D220)
#define RPG_GAMECORE_PLAYCROSSHAIRPREVIEWFADEIN__CTOR_OFFSET UNITYSDK_OFFSET(0x18C0D1F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlayCrossHairPreviewFadeIn_TypeDefinitionIndex = 21864;
