...
#define RPG_GAMECORE_BYHASACTIVEUNITONSCEPTER_METHOD_4_779219C55CD0AD61_OFFSET UNITYSDK_OFFSET(0x17023040)
#define RPG_GAMECORE_BYHASACTIVEUNITONSCEPTER_METHOD_4_F8B10040173E820B_OFFSET UNITYSDK_OFFSET(0x17023110)
#define RPG_GAMECORE_BYHASACTIVEUNITONSCEPTER__CTOR_OFFSET UNITYSDK_OFFSET(0x170230C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByHasActiveUnitOnScepter_TypeDefinitionIndex = 21326;
