...
#define RPG_GAMECORE_LITTLEGAMETRANSFORMCOMPONENTCONFIG_METHOD_3_B30215058B13169B_OFFSET UNITYSDK_OFFSET(0x1BCC59A0)
#define RPG_GAMECORE_LITTLEGAMETRANSFORMCOMPONENTCONFIG_METHOD_3_F8738315250329FC_OFFSET UNITYSDK_OFFSET(0x1BCC5A00)
#define RPG_GAMECORE_LITTLEGAMETRANSFORMCOMPONENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCC59E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameTransformComponentConfig_TypeDefinitionIndex = 18111;
