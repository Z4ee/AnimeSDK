...
#define RPG_GAMECORE_FATEACTREPLACEMASTERAFFIXBYRARITYCONFIG_METHOD_6_C12EBCF5D34A03F2_OFFSET UNITYSDK_OFFSET(0x1C0739E0)
#define RPG_GAMECORE_FATEACTREPLACEMASTERAFFIXBYRARITYCONFIG_METHOD_6_DBB1464C43398E16_OFFSET UNITYSDK_OFFSET(0x1C073990)
#define RPG_GAMECORE_FATEACTREPLACEMASTERAFFIXBYRARITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0739D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateActReplaceMasterAffixByRarityConfig_TypeDefinitionIndex = 18481;
