...
#define RPG_GAMECORE_FATEACTREPLACEMASTERAFFIXBYRARITYCONFIG_METHOD_6_A44D4705A13790E9_OFFSET UNITYSDK_OFFSET(0x1970C9F0)
#define RPG_GAMECORE_FATEACTREPLACEMASTERAFFIXBYRARITYCONFIG_METHOD_6_C12EBCF5D34A03F2_OFFSET UNITYSDK_OFFSET(0x1970CB60)
#define RPG_GAMECORE_FATEACTREPLACEMASTERAFFIXBYRARITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1970CAC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateActReplaceMasterAffixByRarityConfig_TypeDefinitionIndex = 18247;
