...
#define RPG_GAMECORE_MUNICIPALCHATNODEINFO_METHOD_2_FA05285339FA56C3_OFFSET UNITYSDK_OFFSET(0x1D2DF060)
#define RPG_GAMECORE_MUNICIPALCHATNODEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2DF1E0)
