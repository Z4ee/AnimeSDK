...
#define RPG_GAMECORE_ROGUEACTPERSONAREPLACEROOMCARDBYCOMPOSITIONTYPECONFIG_METHOD_6_BF8D3543DC5D9C32_OFFSET UNITYSDK_OFFSET(0x1D02FEA0)
#define RPG_GAMECORE_ROGUEACTPERSONAREPLACEROOMCARDBYCOMPOSITIONTYPECONFIG_METHOD_6_C7E4F6305712604E_OFFSET UNITYSDK_OFFSET(0x1D02FEF0)
#define RPG_GAMECORE_ROGUEACTPERSONAREPLACEROOMCARDBYCOMPOSITIONTYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D02FEE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaReplaceRoomCardByCompositionTypeConfig_TypeDefinitionIndex = 19013;
