...
#define RPG_GAMECORE_ROGUEACTPERSONAREPLACEROOMCARDBYCOMPOSITIONTYPECONFIG_METHOD_6_2505FC283952908B_OFFSET UNITYSDK_OFFSET(0x19AF0C90)
#define RPG_GAMECORE_ROGUEACTPERSONAREPLACEROOMCARDBYCOMPOSITIONTYPECONFIG_METHOD_6_C7E4F6305712604E_OFFSET UNITYSDK_OFFSET(0x19AF0EB0)
#define RPG_GAMECORE_ROGUEACTPERSONAREPLACEROOMCARDBYCOMPOSITIONTYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AF0DD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaReplaceRoomCardByCompositionTypeConfig_TypeDefinitionIndex = 18737;
