...
#define RPG_GAMECORE_TARGETFETCHDATAVIEWUISELECTENTER_METHOD_4_8B6EE849938F4D67_OFFSET UNITYSDK_OFFSET(0x177B4B40)
#define RPG_GAMECORE_TARGETFETCHDATAVIEWUISELECTENTER_METHOD_4_D4631ADD40EC9C09_OFFSET UNITYSDK_OFFSET(0x177BE440)
#define RPG_GAMECORE_TARGETFETCHDATAVIEWUISELECTENTER__CTOR_OFFSET UNITYSDK_OFFSET(0x177B4AF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchDataViewUISelectEnter_TypeDefinitionIndex = 22237;
