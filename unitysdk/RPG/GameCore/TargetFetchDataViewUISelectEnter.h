...
#define RPG_GAMECORE_TARGETFETCHDATAVIEWUISELECTENTER_METHOD_4_15DFF46E0F762A37_OFFSET UNITYSDK_OFFSET(0x1D0B9590)
#define RPG_GAMECORE_TARGETFETCHDATAVIEWUISELECTENTER_METHOD_4_2F95CABC1547A0EA_OFFSET UNITYSDK_OFFSET(0x1D0B9570)
#define RPG_GAMECORE_TARGETFETCHDATAVIEWUISELECTENTER_METHOD_4_8B6EE849938F4D67_OFFSET UNITYSDK_OFFSET(0x1D0B9510)
#define RPG_GAMECORE_TARGETFETCHDATAVIEWUISELECTENTER_METHOD_4_F5CD0924A19DC2F6_OFFSET UNITYSDK_OFFSET(0x1D0B9490)
#define RPG_GAMECORE_TARGETFETCHDATAVIEWUISELECTENTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0B9500)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchDataViewUISelectEnter_TypeDefinitionIndex = 23105;
