...
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMIRACLESELECTCONFIG_METHOD_6_29858ECB3153842D_OFFSET UNITYSDK_OFFSET(0x1D3BBEB0)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMIRACLESELECTCONFIG_METHOD_6_B5630DB4693BB991_OFFSET UNITYSDK_OFFSET(0x1D3BBF00)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMIRACLESELECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3BBEF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActTriggerRogueMiracleSelectConfig_TypeDefinitionIndex = 19365;
