...
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMIRACLESELECTCONFIG_METHOD_6_A562AEE16DB28B5C_OFFSET UNITYSDK_OFFSET(0x18CD94C0)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMIRACLESELECTCONFIG_METHOD_6_B5630DB4693BB991_OFFSET UNITYSDK_OFFSET(0x18CD96E0)
#define RPG_GAMECORE_ROGUEACTTRIGGERROGUEMIRACLESELECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CD9600)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActTriggerRogueMiracleSelectConfig_TypeDefinitionIndex = 18597;
