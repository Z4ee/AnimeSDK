...
#define RPG_GAMECORE_RAIDTARGETCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B9B5750)
#define RPG_GAMECORE_RAIDTARGETCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9B6110)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Boolean IsInBattle; // 0x4C
		::RPG::GameCore::RaidTargetType TargetType; // 0x50
