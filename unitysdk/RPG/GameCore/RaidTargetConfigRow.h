...
#define RPG_GAMECORE_RAIDTARGETCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D384780)
#define RPG_GAMECORE_RAIDTARGETCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D385140)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::Boolean IsInBattle; // 0x40
		::System::UInt32 ID; // 0x44
		::System::UInt32 TargetParam2; // 0x48
