...
#define RPG_GAMECORE_FORMATIONMOVESETSTREAMSPEED_METHOD_3_0D200E57B862FF28_OFFSET UNITYSDK_OFFSET(0x1892B770)
#define RPG_GAMECORE_FORMATIONMOVESETSTREAMSPEED_METHOD_3_8B3DE2235A6F5338_OFFSET UNITYSDK_OFFSET(0x1892B6F0)
#define RPG_GAMECORE_FORMATIONMOVESETSTREAMSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x1892B740)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FormationMoveSetStreamSpeed_TypeDefinitionIndex = 20232;
