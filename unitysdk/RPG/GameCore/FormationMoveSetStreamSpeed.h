...
#define RPG_GAMECORE_FORMATIONMOVESETSTREAMSPEED_METHOD_3_0D200E57B862FF28_OFFSET UNITYSDK_OFFSET(0x1BEC15E0)
#define RPG_GAMECORE_FORMATIONMOVESETSTREAMSPEED_METHOD_3_CDD81650CB7F5D9B_OFFSET UNITYSDK_OFFSET(0x1BEC15A0)
#define RPG_GAMECORE_FORMATIONMOVESETSTREAMSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEC15D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FormationMoveSetStreamSpeed_TypeDefinitionIndex = 20461;
