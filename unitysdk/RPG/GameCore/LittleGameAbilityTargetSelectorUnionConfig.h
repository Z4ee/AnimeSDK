...
#define RPG_GAMECORE_LITTLEGAMEABILITYTARGETSELECTORUNIONCONFIG_METHOD_3_1EBE28BCCE5FC6A6_OFFSET UNITYSDK_OFFSET(0x1DD64CA0)
#define RPG_GAMECORE_LITTLEGAMEABILITYTARGETSELECTORUNIONCONFIG_METHOD_3_7F97A4A5509CB5EE_OFFSET UNITYSDK_OFFSET(0x1DD64C40)
#define RPG_GAMECORE_LITTLEGAMEABILITYTARGETSELECTORUNIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD64C90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityTargetSelectorUnionConfig_TypeDefinitionIndex = 21122;
