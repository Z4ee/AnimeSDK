...
#define RPG_GAMECORE_LITTLEGAMEABILITYTARGETSELECTORUNIONCONFIG_METHOD_3_1EBE28BCCE5FC6A6_OFFSET UNITYSDK_OFFSET(0x1B096210)
#define RPG_GAMECORE_LITTLEGAMEABILITYTARGETSELECTORUNIONCONFIG_METHOD_3_7F97A4A5509CB5EE_OFFSET UNITYSDK_OFFSET(0x1B0961B0)
#define RPG_GAMECORE_LITTLEGAMEABILITYTARGETSELECTORUNIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B096200)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityTargetSelectorUnionConfig_TypeDefinitionIndex = 20570;
