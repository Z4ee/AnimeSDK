...
#define RPG_GAMECORE_BYCOMPAREFEARCHARACTERCOUNT_METHOD_4_2BCCBCC2B1A6961D_OFFSET UNITYSDK_OFFSET(0x19CE0BE0)
#define RPG_GAMECORE_BYCOMPAREFEARCHARACTERCOUNT_METHOD_4_2F4FD4897BB6F124_OFFSET UNITYSDK_OFFSET(0x19CE0E50)
#define RPG_GAMECORE_BYCOMPAREFEARCHARACTERCOUNT_METHOD_4_8D6730CD1A785C4C_OFFSET UNITYSDK_OFFSET(0x19CE0C20)
#define RPG_GAMECORE_BYCOMPAREFEARCHARACTERCOUNT_METHOD_4_9EE672D78DAA6842_OFFSET UNITYSDK_OFFSET(0x19CE0E80)
#define RPG_GAMECORE_BYCOMPAREFEARCHARACTERCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x19CE0C10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareFearCharacterCount_TypeDefinitionIndex = 19465;
