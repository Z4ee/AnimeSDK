...
#define RPG_GAMECORE_BYCOMPAREFEARCHARACTERCOUNT_METHOD_4_5BAD996CF3374E82_OFFSET UNITYSDK_OFFSET(0x1872C530)
#define RPG_GAMECORE_BYCOMPAREFEARCHARACTERCOUNT_METHOD_4_8D6730CD1A785C4C_OFFSET UNITYSDK_OFFSET(0x1872C600)
#define RPG_GAMECORE_BYCOMPAREFEARCHARACTERCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1872C5B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareFearCharacterCount_TypeDefinitionIndex = 19183;
