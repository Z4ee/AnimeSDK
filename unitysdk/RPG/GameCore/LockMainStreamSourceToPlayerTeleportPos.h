...
#define RPG_GAMECORE_LOCKMAINSTREAMSOURCETOPLAYERTELEPORTPOS_METHOD_3_B245A0EC097935A8_OFFSET UNITYSDK_OFFSET(0x1D2105C0)
#define RPG_GAMECORE_LOCKMAINSTREAMSOURCETOPLAYERTELEPORTPOS_METHOD_3_F3F21784D03E7E25_OFFSET UNITYSDK_OFFSET(0x1D210690)
#define RPG_GAMECORE_LOCKMAINSTREAMSOURCETOPLAYERTELEPORTPOS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D210680)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LockMainStreamSourceToPlayerTeleportPos_TypeDefinitionIndex = 20263;
