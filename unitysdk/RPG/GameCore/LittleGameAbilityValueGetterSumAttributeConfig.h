...
#define RPG_GAMECORE_LITTLEGAMEABILITYVALUEGETTERSUMATTRIBUTECONFIG_METHOD_3_52F8F9B9B70092A4_OFFSET UNITYSDK_OFFSET(0x1DD66AA0)
#define RPG_GAMECORE_LITTLEGAMEABILITYVALUEGETTERSUMATTRIBUTECONFIG_METHOD_3_A767991C8A8542C2_OFFSET UNITYSDK_OFFSET(0x1DD66A40)
#define RPG_GAMECORE_LITTLEGAMEABILITYVALUEGETTERSUMATTRIBUTECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD66A90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityValueGetterSumAttributeConfig_TypeDefinitionIndex = 21140;
