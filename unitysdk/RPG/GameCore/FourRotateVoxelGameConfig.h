...
#define RPG_GAMECORE_FOURROTATEVOXELGAMECONFIG_METHOD_3_84E7B140950F136B_OFFSET UNITYSDK_OFFSET(0x1721BA30)
#define RPG_GAMECORE_FOURROTATEVOXELGAMECONFIG_METHOD_3_9472D1D16958D546_OFFSET UNITYSDK_OFFSET(0x1721BA70)
#define RPG_GAMECORE_FOURROTATEVOXELGAMECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1721BA60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FourRotateVoxelGameConfig_TypeDefinitionIndex = 15347;
