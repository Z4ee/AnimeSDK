...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_WRITECUSTOMVALUE_ENTITYDATA_METHOD_3_49AF7FD55D0AF762_OFFSET UNITYSDK_OFFSET(0x1DB08660)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_WRITECUSTOMVALUE_ENTITYDATA_METHOD_3_76A2F268F79DD662_OFFSET UNITYSDK_OFFSET(0x1DB086C0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_WRITECUSTOMVALUE_ENTITYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1DB086B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_WriteCustomValue_EntityData_TypeDefinitionIndex = 15900;
