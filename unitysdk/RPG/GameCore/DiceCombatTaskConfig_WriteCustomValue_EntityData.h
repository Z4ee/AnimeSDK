...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_WRITECUSTOMVALUE_ENTITYDATA_METHOD_3_4B7B759928DFCECF_OFFSET UNITYSDK_OFFSET(0x1887DBB0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_WRITECUSTOMVALUE_ENTITYDATA_METHOD_3_76A2F268F79DD662_OFFSET UNITYSDK_OFFSET(0x1887ACA0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_WRITECUSTOMVALUE_ENTITYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1887AC50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_WriteCustomValue_EntityData_TypeDefinitionIndex = 15240;
