...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_WRITECUSTOMVALUE_ENTITYDATA_METHOD_3_4B7B759928DFCECF_OFFSET UNITYSDK_OFFSET(0x196BAA00)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_WRITECUSTOMVALUE_ENTITYDATA_METHOD_3_76A2F268F79DD662_OFFSET UNITYSDK_OFFSET(0x196B70A0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_WRITECUSTOMVALUE_ENTITYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x196B7050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_WriteCustomValue_EntityData_TypeDefinitionIndex = 15299;
