...
#define RPG_GAMECORE_SYNCHRONOUSLYTRIGGERSOUND_METHOD_4_81FA7E95E2A1900D_OFFSET UNITYSDK_OFFSET(0x18ECA6A0)
#define RPG_GAMECORE_SYNCHRONOUSLYTRIGGERSOUND_METHOD_4_B533B14F62F1B355_OFFSET UNITYSDK_OFFSET(0x18ECA620)
#define RPG_GAMECORE_SYNCHRONOUSLYTRIGGERSOUND__CTOR_OFFSET UNITYSDK_OFFSET(0x18ECA670)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SynchronouslyTriggerSound_TypeDefinitionIndex = 19578;
