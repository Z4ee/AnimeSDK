...
#define RPG_GAMECORE_SYNCHRONOUSLYTRIGGERSOUND_METHOD_4_55A80675F96CD613_OFFSET UNITYSDK_OFFSET(0x1B4448E0)
#define RPG_GAMECORE_SYNCHRONOUSLYTRIGGERSOUND_METHOD_4_81FA7E95E2A1900D_OFFSET UNITYSDK_OFFSET(0x1B444920)
#define RPG_GAMECORE_SYNCHRONOUSLYTRIGGERSOUND__CTOR_OFFSET UNITYSDK_OFFSET(0x1B444910)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SynchronouslyTriggerSound_TypeDefinitionIndex = 19825;
