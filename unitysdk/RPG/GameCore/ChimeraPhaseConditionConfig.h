...
#define RPG_GAMECORE_CHIMERAPHASECONDITIONCONFIG_METHOD_2_EC44242E1C97BABB_OFFSET UNITYSDK_OFFSET(0x1C24BC00)
#define RPG_GAMECORE_CHIMERAPHASECONDITIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C24BCF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraPhaseConditionConfig_TypeDefinitionIndex = 15277;
