...
#define RPG_GAMECORE_CHIMERAPHASECONDITIONCONFIG_METHOD_2_EC44242E1C97BABB_OFFSET UNITYSDK_OFFSET(0x1CFD2610)
#define RPG_GAMECORE_CHIMERAPHASECONDITIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFD2700)
