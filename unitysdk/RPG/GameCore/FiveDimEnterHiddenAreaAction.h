...
#define RPG_GAMECORE_FIVEDIMENTERHIDDENAREAACTION_METHOD_3_165CAF032D89E277_OFFSET UNITYSDK_OFFSET(0x171E77B0)
#define RPG_GAMECORE_FIVEDIMENTERHIDDENAREAACTION_METHOD_3_C39D14DEE453B43A_OFFSET UNITYSDK_OFFSET(0x171F0CB0)
#define RPG_GAMECORE_FIVEDIMENTERHIDDENAREAACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x171E7790)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimEnterHiddenAreaAction_TypeDefinitionIndex = 17118;
