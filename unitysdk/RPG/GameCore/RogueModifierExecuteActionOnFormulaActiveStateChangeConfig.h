...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONFORMULAACTIVESTATECHANGECONFIG_METHOD_3_0492D49368FB4CE0_OFFSET UNITYSDK_OFFSET(0x176305A0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONFORMULAACTIVESTATECHANGECONFIG_METHOD_3_67FF489FFE2C42B9_OFFSET UNITYSDK_OFFSET(0x17630670)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONFORMULAACTIVESTATECHANGECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17630620)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnFormulaActiveStateChangeConfig_TypeDefinitionIndex = 16522;
