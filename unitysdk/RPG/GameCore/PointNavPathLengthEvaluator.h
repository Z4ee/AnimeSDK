...
#define RPG_GAMECORE_POINTNAVPATHLENGTHEVALUATOR_METHOD_4_420771743CBF304A_OFFSET UNITYSDK_OFFSET(0x174EB6E0)
#define RPG_GAMECORE_POINTNAVPATHLENGTHEVALUATOR_METHOD_4_D224151EEEFCD9A5_OFFSET UNITYSDK_OFFSET(0x174EC2A0)
#define RPG_GAMECORE_POINTNAVPATHLENGTHEVALUATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x174EB6D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PointNavPathLengthEvaluator_TypeDefinitionIndex = 14327;
