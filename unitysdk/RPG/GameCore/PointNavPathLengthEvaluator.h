...
#define RPG_GAMECORE_POINTNAVPATHLENGTHEVALUATOR_METHOD_4_420771743CBF304A_OFFSET UNITYSDK_OFFSET(0x1D7B3DD0)
#define RPG_GAMECORE_POINTNAVPATHLENGTHEVALUATOR_METHOD_4_D224151EEEFCD9A5_OFFSET UNITYSDK_OFFSET(0x1D7B48C0)
#define RPG_GAMECORE_POINTNAVPATHLENGTHEVALUATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7B3DC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PointNavPathLengthEvaluator_TypeDefinitionIndex = 15459;
