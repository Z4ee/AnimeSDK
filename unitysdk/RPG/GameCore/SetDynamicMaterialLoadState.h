...
#define RPG_GAMECORE_SETDYNAMICMATERIALLOADSTATE_METHOD_3_140CDA269C42BC97_OFFSET UNITYSDK_OFFSET(0x18E15700)
#define RPG_GAMECORE_SETDYNAMICMATERIALLOADSTATE_METHOD_3_679245ABD34F656A_OFFSET UNITYSDK_OFFSET(0x18E15630)
#define RPG_GAMECORE_SETDYNAMICMATERIALLOADSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E156B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicMaterialLoadState_TypeDefinitionIndex = 21715;
