...
#define RPG_GAMECORE_SETDYNAMICMATERIALLOADSTATE_METHOD_3_140CDA269C42BC97_OFFSET UNITYSDK_OFFSET(0x1D4EB4F0)
#define RPG_GAMECORE_SETDYNAMICMATERIALLOADSTATE_METHOD_3_93A0EB626180EA73_OFFSET UNITYSDK_OFFSET(0x1D4EB450)
#define RPG_GAMECORE_SETDYNAMICMATERIALLOADSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4EB4B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicMaterialLoadState_TypeDefinitionIndex = 22553;
