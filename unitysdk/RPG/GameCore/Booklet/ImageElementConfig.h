...
#define RPG_GAMECORE_BOOKLET_IMAGEELEMENTCONFIG_METHOD_4_0B5CCF8F80C04C09_OFFSET UNITYSDK_OFFSET(0x16FED150)
#define RPG_GAMECORE_BOOKLET_IMAGEELEMENTCONFIG_METHOD_4_A96E63BD3BDEF9F9_OFFSET UNITYSDK_OFFSET(0x16FEC5D0)
#define RPG_GAMECORE_BOOKLET_IMAGEELEMENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16FEC5C0)

namespace RPG::GameCore::Booklet
{
	inline static constexpr unsigned int ImageElementConfig_TypeDefinitionIndex = 22804;
