...
#define RPG_GAMECORE_BOOKLET_IMAGEELEMENTCONFIG_METHOD_4_0B5CCF8F80C04C09_OFFSET UNITYSDK_OFFSET(0x1A404670)
#define RPG_GAMECORE_BOOKLET_IMAGEELEMENTCONFIG_METHOD_4_A96E63BD3BDEF9F9_OFFSET UNITYSDK_OFFSET(0x1A403B00)
#define RPG_GAMECORE_BOOKLET_IMAGEELEMENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A403AF0)

namespace RPG::GameCore::Booklet
{
	inline static constexpr unsigned int ImageElementConfig_TypeDefinitionIndex = 24101;
