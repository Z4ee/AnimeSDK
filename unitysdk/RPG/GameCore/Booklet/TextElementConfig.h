...
#define RPG_GAMECORE_BOOKLET_TEXTELEMENTCONFIG_METHOD_3_3A25F389BEC46382_OFFSET UNITYSDK_OFFSET(0x194E3380)
#define RPG_GAMECORE_BOOKLET_TEXTELEMENTCONFIG_METHOD_3_F4388EAD3E16B272_OFFSET UNITYSDK_OFFSET(0x194E5120)
#define RPG_GAMECORE_BOOKLET_TEXTELEMENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x194E3370)

namespace RPG::GameCore::Booklet
{
	inline static constexpr unsigned int TextElementConfig_TypeDefinitionIndex = 23609;
