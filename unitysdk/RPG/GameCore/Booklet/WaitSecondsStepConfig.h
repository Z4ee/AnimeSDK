...
#define RPG_GAMECORE_BOOKLET_WAITSECONDSSTEPCONFIG_METHOD_3_320A511D5FFD0625_OFFSET UNITYSDK_OFFSET(0x187124D0)
#define RPG_GAMECORE_BOOKLET_WAITSECONDSSTEPCONFIG_METHOD_3_EA0F648AB9A1E6D1_OFFSET UNITYSDK_OFFSET(0x187126B0)
#define RPG_GAMECORE_BOOKLET_WAITSECONDSSTEPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x187124C0)

namespace RPG::GameCore::Booklet
{
	inline static constexpr unsigned int WaitSecondsStepConfig_TypeDefinitionIndex = 23783;
