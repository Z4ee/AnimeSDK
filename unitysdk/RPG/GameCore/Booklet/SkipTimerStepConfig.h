...
#define RPG_GAMECORE_BOOKLET_SKIPTIMERSTEPCONFIG_METHOD_3_3E353653C3058846_OFFSET UNITYSDK_OFFSET(0x1C2E39E0)
#define RPG_GAMECORE_BOOKLET_SKIPTIMERSTEPCONFIG_METHOD_3_838BA6A004A2ED4C_OFFSET UNITYSDK_OFFSET(0x1C2E3A40)
#define RPG_GAMECORE_BOOKLET_SKIPTIMERSTEPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2E3A30)
