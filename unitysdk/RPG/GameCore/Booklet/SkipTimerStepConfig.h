...
#define RPG_GAMECORE_BOOKLET_SKIPTIMERSTEPCONFIG_METHOD_3_3E353653C3058846_OFFSET UNITYSDK_OFFSET(0x1A405290)
#define RPG_GAMECORE_BOOKLET_SKIPTIMERSTEPCONFIG_METHOD_3_838BA6A004A2ED4C_OFFSET UNITYSDK_OFFSET(0x1A4052F0)
#define RPG_GAMECORE_BOOKLET_SKIPTIMERSTEPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4052E0)

namespace RPG::GameCore::Booklet
{
	inline static constexpr unsigned int SkipTimerStepConfig_TypeDefinitionIndex = 24112;
