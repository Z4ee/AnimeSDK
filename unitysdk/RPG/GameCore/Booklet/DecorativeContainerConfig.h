...
#define RPG_GAMECORE_BOOKLET_DECORATIVECONTAINERCONFIG_METHOD_4_4631F8F506A3FEDA_OFFSET UNITYSDK_OFFSET(0x1A402F50)
#define RPG_GAMECORE_BOOKLET_DECORATIVECONTAINERCONFIG_METHOD_4_916E0FF76881A405_OFFSET UNITYSDK_OFFSET(0x1A403730)
#define RPG_GAMECORE_BOOKLET_DECORATIVECONTAINERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A402F40)

namespace RPG::GameCore::Booklet
{
	inline static constexpr unsigned int DecorativeContainerConfig_TypeDefinitionIndex = 24099;
