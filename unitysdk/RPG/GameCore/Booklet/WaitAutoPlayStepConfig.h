...
#define RPG_GAMECORE_BOOKLET_WAITAUTOPLAYSTEPCONFIG_METHOD_3_B9F63E55C4A0D277_OFFSET UNITYSDK_OFFSET(0x1C2E4650)
#define RPG_GAMECORE_BOOKLET_WAITAUTOPLAYSTEPCONFIG_METHOD_3_E5AB140482044886_OFFSET UNITYSDK_OFFSET(0x1C2E4300)
#define RPG_GAMECORE_BOOKLET_WAITAUTOPLAYSTEPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2E42F0)
