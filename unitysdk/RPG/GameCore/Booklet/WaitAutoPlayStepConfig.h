...
#define RPG_GAMECORE_BOOKLET_WAITAUTOPLAYSTEPCONFIG_METHOD_3_B9F63E55C4A0D277_OFFSET UNITYSDK_OFFSET(0x1A405CF0)
#define RPG_GAMECORE_BOOKLET_WAITAUTOPLAYSTEPCONFIG_METHOD_3_E5AB140482044886_OFFSET UNITYSDK_OFFSET(0x1A405B30)
#define RPG_GAMECORE_BOOKLET_WAITAUTOPLAYSTEPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A405B20)

namespace RPG::GameCore::Booklet
{
	inline static constexpr unsigned int WaitAutoPlayStepConfig_TypeDefinitionIndex = 24111;
