...
#define RPG_GAMECORE_BOOKLET_PLAYVOICESTEPCONFIG_METHOD_3_346CAAA4BB71CA1E_OFFSET UNITYSDK_OFFSET(0x1B3124E0)
#define RPG_GAMECORE_BOOKLET_PLAYVOICESTEPCONFIG_METHOD_3_943960C470B6D444_OFFSET UNITYSDK_OFFSET(0x1B312480)
#define RPG_GAMECORE_BOOKLET_PLAYVOICESTEPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3124D0)

namespace RPG::GameCore::Booklet
{
	inline static constexpr unsigned int PlayVoiceStepConfig_TypeDefinitionIndex = 24702;
