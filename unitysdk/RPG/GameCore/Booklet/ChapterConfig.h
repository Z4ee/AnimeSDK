...
#define RPG_GAMECORE_BOOKLET_CHAPTERCONFIG_METHOD_2_F8BFC3606F4F8893_OFFSET UNITYSDK_OFFSET(0x16FEB6B0)
#define RPG_GAMECORE_BOOKLET_CHAPTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16FEB890)

namespace RPG::GameCore::Booklet
{
	inline static constexpr unsigned int ChapterConfig_TypeDefinitionIndex = 22791;
