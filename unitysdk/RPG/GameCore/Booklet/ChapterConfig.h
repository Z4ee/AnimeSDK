...
#define RPG_GAMECORE_BOOKLET_CHAPTERCONFIG_METHOD_2_F8BFC3606F4F8893_OFFSET UNITYSDK_OFFSET(0x1B3108A0)
#define RPG_GAMECORE_BOOKLET_CHAPTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B310A80)
