...
#define RPG_GAMECORE_BOOKLET_PAGESPREADCONFIG_METHOD_3_157A43F348EE5886_OFFSET UNITYSDK_OFFSET(0x187111F0)
#define RPG_GAMECORE_BOOKLET_PAGESPREADCONFIG_METHOD_3_18B10BD01B710F24_OFFSET UNITYSDK_OFFSET(0x18711250)
#define RPG_GAMECORE_BOOKLET_PAGESPREADCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18711240)

namespace RPG::GameCore::Booklet
{
	inline static constexpr unsigned int PageSpreadConfig_TypeDefinitionIndex = 23769;
