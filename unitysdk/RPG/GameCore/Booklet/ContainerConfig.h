...
#define RPG_GAMECORE_BOOKLET_CONTAINERCONFIG_METHOD_3_18530C2DD9F0FDCF_OFFSET UNITYSDK_OFFSET(0x1A4032B0)
#define RPG_GAMECORE_BOOKLET_CONTAINERCONFIG_METHOD_3_2C2C967AFE1F4B97_OFFSET UNITYSDK_OFFSET(0x1A402E10)
#define RPG_GAMECORE_BOOKLET_CONTAINERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4035E0)

namespace RPG::GameCore::Booklet
{
	inline static constexpr unsigned int ContainerConfig_TypeDefinitionIndex = 24098;
