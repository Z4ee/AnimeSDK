...
#define RPG_GAMECORE_BOOKLET_MARKSPREADHASREADSTEPCONFIG_METHOD_3_4C5314B819103160_OFFSET UNITYSDK_OFFSET(0x1B312140)
#define RPG_GAMECORE_BOOKLET_MARKSPREADHASREADSTEPCONFIG_METHOD_3_6706F6DA5A60E725_OFFSET UNITYSDK_OFFSET(0x1B3120A0)
#define RPG_GAMECORE_BOOKLET_MARKSPREADHASREADSTEPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B312130)

namespace RPG::GameCore::Booklet
{
	inline static constexpr unsigned int MarkSpreadHasReadStepConfig_TypeDefinitionIndex = 24699;
