...
#define RPG_GAMECORE_BOOKLET_MARKSPREADHASREADSTEPCONFIG_METHOD_3_4C5314B819103160_OFFSET UNITYSDK_OFFSET(0x194E3CE0)
#define RPG_GAMECORE_BOOKLET_MARKSPREADHASREADSTEPCONFIG_METHOD_3_6706F6DA5A60E725_OFFSET UNITYSDK_OFFSET(0x194E3C40)
#define RPG_GAMECORE_BOOKLET_MARKSPREADHASREADSTEPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x194E3CD0)

namespace RPG::GameCore::Booklet
{
	inline static constexpr unsigned int MarkSpreadHasReadStepConfig_TypeDefinitionIndex = 23619;
