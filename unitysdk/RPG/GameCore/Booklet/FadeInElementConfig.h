...
#define RPG_GAMECORE_BOOKLET_FADEINELEMENTCONFIG_METHOD_3_847194E34086FEEA_OFFSET UNITYSDK_OFFSET(0x16FECE30)
#define RPG_GAMECORE_BOOKLET_FADEINELEMENTCONFIG_METHOD_3_FA70FED62A51102D_OFFSET UNITYSDK_OFFSET(0x16FECC30)
#define RPG_GAMECORE_BOOKLET_FADEINELEMENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16FEB2B0)

namespace RPG::GameCore::Booklet
{
	inline static constexpr unsigned int FadeInElementConfig_TypeDefinitionIndex = 22797;
