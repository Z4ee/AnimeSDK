...
#define RPG_GAMECORE_BOOKLET_FADEINELEMENTCONFIG_METHOD_3_847194E34086FEEA_OFFSET UNITYSDK_OFFSET(0x1A404350)
#define RPG_GAMECORE_BOOKLET_FADEINELEMENTCONFIG_METHOD_3_E0EFCBD9B0E24525_OFFSET UNITYSDK_OFFSET(0x1A404160)
#define RPG_GAMECORE_BOOKLET_FADEINELEMENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A402820)

namespace RPG::GameCore::Booklet
{
	inline static constexpr unsigned int FadeInElementConfig_TypeDefinitionIndex = 24094;
