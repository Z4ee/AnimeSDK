...
#define RPG_GAMECORE_BOOKLET_SECTIONCONFIG_METHOD_2_663E6BC9252EA2C3_OFFSET UNITYSDK_OFFSET(0x1A404DB0)
#define RPG_GAMECORE_BOOKLET_SECTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A404F00)

namespace RPG::GameCore::Booklet
{
	inline static constexpr unsigned int SectionConfig_TypeDefinitionIndex = 24090;
