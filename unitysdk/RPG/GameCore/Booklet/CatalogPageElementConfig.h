...
#define RPG_GAMECORE_BOOKLET_CATALOGPAGEELEMENTCONFIG_METHOD_3_AC96D8C3E03F14AC_OFFSET UNITYSDK_OFFSET(0x194E1E80)
#define RPG_GAMECORE_BOOKLET_CATALOGPAGEELEMENTCONFIG_METHOD_3_AEDA88A8E7CE2D52_OFFSET UNITYSDK_OFFSET(0x194E1EE0)
#define RPG_GAMECORE_BOOKLET_CATALOGPAGEELEMENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x194E1ED0)

namespace RPG::GameCore::Booklet
{
	inline static constexpr unsigned int CatalogPageElementConfig_TypeDefinitionIndex = 23606;
