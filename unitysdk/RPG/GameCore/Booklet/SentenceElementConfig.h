...
#define RPG_GAMECORE_BOOKLET_SENTENCEELEMENTCONFIG_METHOD_4_06BEC47572D37B2B_OFFSET UNITYSDK_OFFSET(0x16FEDBE0)
#define RPG_GAMECORE_BOOKLET_SENTENCEELEMENTCONFIG_METHOD_4_A2CAFB5375878D9B_OFFSET UNITYSDK_OFFSET(0x16FEC7D0)
#define RPG_GAMECORE_BOOKLET_SENTENCEELEMENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16FEC7C0)

namespace RPG::GameCore::Booklet
{
	inline static constexpr unsigned int SentenceElementConfig_TypeDefinitionIndex = 22805;
