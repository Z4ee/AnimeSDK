...
#define RPG_GAMECORE_BOOKLET_STEPCONFIG_METHOD_2_16F2BE488661AABC_OFFSET UNITYSDK_OFFSET(0x1A4053B0)
#define RPG_GAMECORE_BOOKLET_STEPCONFIG_METHOD_2_96C845B804F1D42F_OFFSET UNITYSDK_OFFSET(0x1A405C40)
#define RPG_GAMECORE_BOOKLET_STEPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A404660)

namespace RPG::GameCore::Booklet
{
	inline static constexpr unsigned int StepConfig_TypeDefinitionIndex = 24104;
