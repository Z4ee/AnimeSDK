...
#define RPG_GAMECORE_BOOKLET_STEPCONFIG_METHOD_2_16F2BE488661AABC_OFFSET UNITYSDK_OFFSET(0x194E4830)
#define RPG_GAMECORE_BOOKLET_STEPCONFIG_METHOD_2_96C845B804F1D42F_OFFSET UNITYSDK_OFFSET(0x194E50C0)
#define RPG_GAMECORE_BOOKLET_STEPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x194E3AE0)

namespace RPG::GameCore::Booklet
{
	inline static constexpr unsigned int StepConfig_TypeDefinitionIndex = 23613;
