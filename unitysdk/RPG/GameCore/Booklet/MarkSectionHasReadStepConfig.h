...
#define RPG_GAMECORE_BOOKLET_MARKSECTIONHASREADSTEPCONFIG_METHOD_3_2ECDE7405E5BAC37_OFFSET UNITYSDK_OFFSET(0x1CE8C020)
#define RPG_GAMECORE_BOOKLET_MARKSECTIONHASREADSTEPCONFIG_METHOD_3_B32DD8AFEC16FF46_OFFSET UNITYSDK_OFFSET(0x1CE8C0C0)
#define RPG_GAMECORE_BOOKLET_MARKSECTIONHASREADSTEPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE8C0B0)
