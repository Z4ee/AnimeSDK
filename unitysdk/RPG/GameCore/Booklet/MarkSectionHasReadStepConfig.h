...
#define RPG_GAMECORE_BOOKLET_MARKSECTIONHASREADSTEPCONFIG_METHOD_3_2ECDE7405E5BAC37_OFFSET UNITYSDK_OFFSET(0x18710FF0)
#define RPG_GAMECORE_BOOKLET_MARKSECTIONHASREADSTEPCONFIG_METHOD_3_B32DD8AFEC16FF46_OFFSET UNITYSDK_OFFSET(0x18711090)
#define RPG_GAMECORE_BOOKLET_MARKSECTIONHASREADSTEPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18711080)

namespace RPG::GameCore::Booklet
{
	inline static constexpr unsigned int MarkSectionHasReadStepConfig_TypeDefinitionIndex = 23785;
