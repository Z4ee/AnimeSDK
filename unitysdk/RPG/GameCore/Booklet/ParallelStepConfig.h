...
#define RPG_GAMECORE_BOOKLET_PARALLELSTEPCONFIG_METHOD_3_4D09F7921760BD94_OFFSET UNITYSDK_OFFSET(0x194E4030)
#define RPG_GAMECORE_BOOKLET_PARALLELSTEPCONFIG_METHOD_3_AFC466BD867B54C4_OFFSET UNITYSDK_OFFSET(0x194E3FD0)
#define RPG_GAMECORE_BOOKLET_PARALLELSTEPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x194E4020)

namespace RPG::GameCore::Booklet
{
	inline static constexpr unsigned int ParallelStepConfig_TypeDefinitionIndex = 23615;
