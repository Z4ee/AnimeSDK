...
#define RPG_GAMECORE_BOOKLET_PARALLELSTEPCONFIG_METHOD_3_4D09F7921760BD94_OFFSET UNITYSDK_OFFSET(0x1A404BB0)
#define RPG_GAMECORE_BOOKLET_PARALLELSTEPCONFIG_METHOD_3_AFC466BD867B54C4_OFFSET UNITYSDK_OFFSET(0x1A404B50)
#define RPG_GAMECORE_BOOKLET_PARALLELSTEPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A404BA0)

namespace RPG::GameCore::Booklet
{
	inline static constexpr unsigned int ParallelStepConfig_TypeDefinitionIndex = 24106;
