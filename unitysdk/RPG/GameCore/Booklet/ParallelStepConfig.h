...
#define RPG_GAMECORE_BOOKLET_PARALLELSTEPCONFIG_METHOD_3_8C2E079E2F03D321_OFFSET UNITYSDK_OFFSET(0x16FED640)
#define RPG_GAMECORE_BOOKLET_PARALLELSTEPCONFIG_METHOD_3_A8163298E0BF48A9_OFFSET UNITYSDK_OFFSET(0x16FED6A0)
#define RPG_GAMECORE_BOOKLET_PARALLELSTEPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16FED690)

namespace RPG::GameCore::Booklet
{
	inline static constexpr unsigned int ParallelStepConfig_TypeDefinitionIndex = 22809;
