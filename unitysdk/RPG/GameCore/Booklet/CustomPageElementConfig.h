...
#define RPG_GAMECORE_BOOKLET_CUSTOMPAGEELEMENTCONFIG_METHOD_3_5916A55B97407DD1_OFFSET UNITYSDK_OFFSET(0x16FEC0E0)
#define RPG_GAMECORE_BOOKLET_CUSTOMPAGEELEMENTCONFIG_METHOD_3_DA5E9554984A2DB1_OFFSET UNITYSDK_OFFSET(0x16FEC080)
#define RPG_GAMECORE_BOOKLET_CUSTOMPAGEELEMENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16FEC0D0)

namespace RPG::GameCore::Booklet
{
	inline static constexpr unsigned int CustomPageElementConfig_TypeDefinitionIndex = 22799;
