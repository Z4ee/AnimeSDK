...
#define RPG_GAMECORE_BOOKLET_SPREADCONFIG_METHOD_2_C8B49C11501EC34F_OFFSET UNITYSDK_OFFSET(0x18712380)
#define RPG_GAMECORE_BOOKLET_SPREADCONFIG_METHOD_2_CE31A495A297B288_OFFSET UNITYSDK_OFFSET(0x18712230)
#define RPG_GAMECORE_BOOKLET_SPREADCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18711480)

namespace RPG::GameCore::Booklet
{
	inline static constexpr unsigned int SpreadConfig_TypeDefinitionIndex = 23767;
