...
#define RPG_GAMECORE_BOOKLET_SPREADCONFIG_METHOD_2_C8B49C11501EC34F_OFFSET UNITYSDK_OFFSET(0x1A405A50)
#define RPG_GAMECORE_BOOKLET_SPREADCONFIG_METHOD_2_CE31A495A297B288_OFFSET UNITYSDK_OFFSET(0x1A4058F0)
#define RPG_GAMECORE_BOOKLET_SPREADCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A404B40)

namespace RPG::GameCore::Booklet
{
	inline static constexpr unsigned int SpreadConfig_TypeDefinitionIndex = 24091;
