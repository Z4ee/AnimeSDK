...
#define RPG_GAMECORE_BOOKLET_SPREADCONFIG_METHOD_2_C8B49C11501EC34F_OFFSET UNITYSDK_OFFSET(0x16FEE530)
#define RPG_GAMECORE_BOOKLET_SPREADCONFIG_METHOD_2_CE31A495A297B288_OFFSET UNITYSDK_OFFSET(0x16FEE3E0)
#define RPG_GAMECORE_BOOKLET_SPREADCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16FED630)

namespace RPG::GameCore::Booklet
{
	inline static constexpr unsigned int SpreadConfig_TypeDefinitionIndex = 22794;
