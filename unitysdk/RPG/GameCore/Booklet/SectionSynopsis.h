...
#define RPG_GAMECORE_BOOKLET_SECTIONSYNOPSIS_METHOD_2_0B260158A5A971E5_OFFSET UNITYSDK_OFFSET(0x16FEDA00)
#define RPG_GAMECORE_BOOKLET_SECTIONSYNOPSIS__CTOR_OFFSET UNITYSDK_OFFSET(0x16FEDBD0)

namespace RPG::GameCore::Booklet
{
	inline static constexpr unsigned int SectionSynopsis_TypeDefinitionIndex = 22792;
