...
#define RPG_GAMECORE_BOOKLET_BASICPAGEELEMENTCONFIG_METHOD_4_8766E6C65C1DCA36_OFFSET UNITYSDK_OFFSET(0x1870EE60)
#define RPG_GAMECORE_BOOKLET_BASICPAGEELEMENTCONFIG_METHOD_4_CB6E3EA3F308827C_OFFSET UNITYSDK_OFFSET(0x1870EEC0)
#define RPG_GAMECORE_BOOKLET_BASICPAGEELEMENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1870EEB0)

namespace RPG::GameCore::Booklet
{
	inline static constexpr unsigned int BasicPageElementConfig_TypeDefinitionIndex = 23771;
