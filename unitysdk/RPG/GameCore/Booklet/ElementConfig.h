...
#define RPG_GAMECORE_BOOKLET_ELEMENTCONFIG_METHOD_2_1D238AF472583362_OFFSET UNITYSDK_OFFSET(0x1CE8B9F0)
#define RPG_GAMECORE_BOOKLET_ELEMENTCONFIG_METHOD_2_E6AAB73FCC8BF803_OFFSET UNITYSDK_OFFSET(0x1CE8B480)
#define RPG_GAMECORE_BOOKLET_ELEMENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE8A910)

namespace RPG::GameCore::Booklet
{
	inline static constexpr unsigned int ElementConfig_TypeDefinitionIndex = 24681;
