...
#define RPG_GAMECORE_BOOKLET_ELEMENTCONFIG_METHOD_2_1D238AF472583362_OFFSET UNITYSDK_OFFSET(0x1A404080)
#define RPG_GAMECORE_BOOKLET_ELEMENTCONFIG_METHOD_2_E6AAB73FCC8BF803_OFFSET UNITYSDK_OFFSET(0x1A403780)
#define RPG_GAMECORE_BOOKLET_ELEMENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A402C10)

namespace RPG::GameCore::Booklet
{
	inline static constexpr unsigned int ElementConfig_TypeDefinitionIndex = 24092;
