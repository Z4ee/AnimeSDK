...
#define RPG_GAMECORE_BOOKLET_FADEINSTEPCONFIG_METHOD_3_DB78F0A518DDCB20_OFFSET UNITYSDK_OFFSET(0x1B311EC0)
#define RPG_GAMECORE_BOOKLET_FADEINSTEPCONFIG_METHOD_3_E2C3352106F5B96C_OFFSET UNITYSDK_OFFSET(0x1B311DF0)
#define RPG_GAMECORE_BOOKLET_FADEINSTEPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B311EB0)

namespace RPG::GameCore::Booklet
{
	inline static constexpr unsigned int FadeInStepConfig_TypeDefinitionIndex = 24697;
