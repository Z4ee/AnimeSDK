...
#define RPG_GAMECORE_BOOKLET_SEQUENCESTEPCONFIG_METHOD_3_8690655B059E27DE_OFFSET UNITYSDK_OFFSET(0x1A4051A0)
#define RPG_GAMECORE_BOOKLET_SEQUENCESTEPCONFIG_METHOD_3_E2A05FFCF52A7466_OFFSET UNITYSDK_OFFSET(0x1A405140)
#define RPG_GAMECORE_BOOKLET_SEQUENCESTEPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A405190)

namespace RPG::GameCore::Booklet
{
	inline static constexpr unsigned int SequenceStepConfig_TypeDefinitionIndex = 24105;
