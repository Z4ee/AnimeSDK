...
#define RPG_GAMECORE_BOOKLET_SEQUENCESTEPCONFIG_METHOD_3_8690655B059E27DE_OFFSET UNITYSDK_OFFSET(0x1CE8CC00)
#define RPG_GAMECORE_BOOKLET_SEQUENCESTEPCONFIG_METHOD_3_E2A05FFCF52A7466_OFFSET UNITYSDK_OFFSET(0x1CE8CBA0)
#define RPG_GAMECORE_BOOKLET_SEQUENCESTEPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE8CBF0)

namespace RPG::GameCore::Booklet
{
	inline static constexpr unsigned int SequenceStepConfig_TypeDefinitionIndex = 24694;
