...
#define RPG_GAMECORE_BOOKLET_SEQUENCESTEPCONFIG_METHOD_3_22A4882222332A63_OFFSET UNITYSDK_OFFSET(0x16FEDC30)
#define RPG_GAMECORE_BOOKLET_SEQUENCESTEPCONFIG_METHOD_3_5DFFEA4F047BE253_OFFSET UNITYSDK_OFFSET(0x16FEDC90)
#define RPG_GAMECORE_BOOKLET_SEQUENCESTEPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16FEDC80)

namespace RPG::GameCore::Booklet
{
	inline static constexpr unsigned int SequenceStepConfig_TypeDefinitionIndex = 22808;
