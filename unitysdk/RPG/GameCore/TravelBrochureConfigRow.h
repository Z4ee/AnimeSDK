...
#define RPG_GAMECORE_TRAVELBROCHURECONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D53D8F0)
#define RPG_GAMECORE_TRAVELBROCHURECONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D53EE80)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::TravelBrochureType Type; // 0x54
