...
#define RPG_GAMECORE_CAKERACEGAMEPROPERTYCOMPAREPREDICATECONFIG_METHOD_3_9CB0381583C17FE9_OFFSET UNITYSDK_OFFSET(0x1CF76D90)
#define RPG_GAMECORE_CAKERACEGAMEPROPERTYCOMPAREPREDICATECONFIG_METHOD_3_CB6490639DDC108B_OFFSET UNITYSDK_OFFSET(0x1CF71BB0)
#define RPG_GAMECORE_CAKERACEGAMEPROPERTYCOMPAREPREDICATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CF71BA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceGamePropertyComparePredicateConfig_TypeDefinitionIndex = 18164;
