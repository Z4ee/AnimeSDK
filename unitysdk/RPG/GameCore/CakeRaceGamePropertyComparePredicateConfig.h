...
#define RPG_GAMECORE_CAKERACEGAMEPROPERTYCOMPAREPREDICATECONFIG_METHOD_3_9CB0381583C17FE9_OFFSET UNITYSDK_OFFSET(0x1704C8F0)
#define RPG_GAMECORE_CAKERACEGAMEPROPERTYCOMPAREPREDICATECONFIG_METHOD_3_CB6490639DDC108B_OFFSET UNITYSDK_OFFSET(0x17047E30)
#define RPG_GAMECORE_CAKERACEGAMEPROPERTYCOMPAREPREDICATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17047E20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CakeRaceGamePropertyComparePredicateConfig_TypeDefinitionIndex = 16877;
