...
#define RPG_GAMECORE_ROGUEACTREPLACEALLFORMULAANDBUFFCONFIG_METHOD_6_19D464A472E3A11C_OFFSET UNITYSDK_OFFSET(0x19AF6F10)
#define RPG_GAMECORE_ROGUEACTREPLACEALLFORMULAANDBUFFCONFIG_METHOD_6_F71538413F0FF651_OFFSET UNITYSDK_OFFSET(0x19AF7130)
#define RPG_GAMECORE_ROGUEACTREPLACEALLFORMULAANDBUFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AF7050)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActReplaceAllFormulaAndBuffConfig_TypeDefinitionIndex = 18672;
