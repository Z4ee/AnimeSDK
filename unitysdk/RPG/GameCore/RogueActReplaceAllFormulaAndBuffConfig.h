...
#define RPG_GAMECORE_ROGUEACTREPLACEALLFORMULAANDBUFFCONFIG_METHOD_6_C621A2D7ACC34EED_OFFSET UNITYSDK_OFFSET(0x1C49DBA0)
#define RPG_GAMECORE_ROGUEACTREPLACEALLFORMULAANDBUFFCONFIG_METHOD_6_F71538413F0FF651_OFFSET UNITYSDK_OFFSET(0x1C49DBF0)
#define RPG_GAMECORE_ROGUEACTREPLACEALLFORMULAANDBUFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C49DBE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActReplaceAllFormulaAndBuffConfig_TypeDefinitionIndex = 18948;
