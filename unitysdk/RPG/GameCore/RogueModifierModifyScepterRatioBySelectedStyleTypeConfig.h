...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYSCEPTERRATIOBYSELECTEDSTYLETYPECONFIG_METHOD_3_1A0A708B37BAA91C_OFFSET UNITYSDK_OFFSET(0x1D3FAA40)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYSCEPTERRATIOBYSELECTEDSTYLETYPECONFIG_METHOD_3_2636CE7FDE22F858_OFFSET UNITYSDK_OFFSET(0x1D3FAA90)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYSCEPTERRATIOBYSELECTEDSTYLETYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3FAA80)
