...
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYSCEPTERRATIOBYSELECTEDSTYLETYPECONFIG_METHOD_3_1A0A708B37BAA91C_OFFSET UNITYSDK_OFFSET(0x1D1646C0)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYSCEPTERRATIOBYSELECTEDSTYLETYPECONFIG_METHOD_3_2636CE7FDE22F858_OFFSET UNITYSDK_OFFSET(0x1D164710)
#define RPG_GAMECORE_ROGUEMODIFIERMODIFYSCEPTERRATIOBYSELECTEDSTYLETYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D164700)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierModifyScepterRatioBySelectedStyleTypeConfig_TypeDefinitionIndex = 17021;
