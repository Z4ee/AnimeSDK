...
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTAPPENDATTRIBUTEBYGROUPCONFIG_METHOD_7_76F10FE0EDB98E9D_OFFSET UNITYSDK_OFFSET(0x19AF1310)
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTAPPENDATTRIBUTEBYGROUPCONFIG_METHOD_7_C88DEDB340A42040_OFFSET UNITYSDK_OFFSET(0x19AF10F0)
#define RPG_GAMECORE_ROGUEACTPERSONASELECTROOMCARDCASTAPPENDATTRIBUTEBYGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AF1230)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaSelectRoomCardCastAppendAttributeByGroupConfig_TypeDefinitionIndex = 18688;
