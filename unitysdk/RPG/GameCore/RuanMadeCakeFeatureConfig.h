...
#define RPG_GAMECORE_RUANMADECAKEFEATURECONFIG_METHOD_2_2414FB732CD7BF9D_1_OFFSET UNITYSDK_OFFSET(0x19BF9900)
#define RPG_GAMECORE_RUANMADECAKEFEATURECONFIG_METHOD_2_2414FB732CD7BF9D_OFFSET UNITYSDK_OFFSET(0x19BF8C60)
#define RPG_GAMECORE_RUANMADECAKEFEATURECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19BF99A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RuanMadeCakeFeatureConfig_TypeDefinitionIndex = 16601;
