...
#define RPG_GAMECORE_RUANMADECAKEFEATURECONFIG_METHOD_2_2414FB732CD7BF9D_1_OFFSET UNITYSDK_OFFSET(0x1B772B40)
#define RPG_GAMECORE_RUANMADECAKEFEATURECONFIG_METHOD_2_2414FB732CD7BF9D_OFFSET UNITYSDK_OFFSET(0x1B771EA0)
#define RPG_GAMECORE_RUANMADECAKEFEATURECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B772BE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RuanMadeCakeFeatureConfig_TypeDefinitionIndex = 16763;
