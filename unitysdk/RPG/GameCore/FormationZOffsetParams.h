...
#define RPG_GAMECORE_FORMATIONZOFFSETPARAMS_METHOD_2_4D9C6AB1A60F7004_OFFSET UNITYSDK_OFFSET(0x1D1125F0)
#define RPG_GAMECORE_FORMATIONZOFFSETPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D112720)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FormationZOffsetParams_TypeDefinitionIndex = 16399;
