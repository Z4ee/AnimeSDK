...
#define RPG_GAMECORE_PAUSEPROPMOVETO_METHOD_3_1620541E8C05B24D_OFFSET UNITYSDK_OFFSET(0x1748EE10)
#define RPG_GAMECORE_PAUSEPROPMOVETO_METHOD_3_B4C44B3A74AA9CDE_OFFSET UNITYSDK_OFFSET(0x1748ECC0)
#define RPG_GAMECORE_PAUSEPROPMOVETO__CTOR_OFFSET UNITYSDK_OFFSET(0x1748ED80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PausePropMoveTo_TypeDefinitionIndex = 20134;
