...
#define RPG_GAMECORE_PAUSEPROPMOVETO_METHOD_3_1620541E8C05B24D_OFFSET UNITYSDK_OFFSET(0x18BD9360)
#define RPG_GAMECORE_PAUSEPROPMOVETO_METHOD_3_B4C44B3A74AA9CDE_OFFSET UNITYSDK_OFFSET(0x18BD9210)
#define RPG_GAMECORE_PAUSEPROPMOVETO__CTOR_OFFSET UNITYSDK_OFFSET(0x18BD92D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PausePropMoveTo_TypeDefinitionIndex = 20816;
