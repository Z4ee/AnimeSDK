...
#define RPG_GAMECORE_MATERIALSUBMITTERROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D2722B0)
#define RPG_GAMECORE_MATERIALSUBMITTERROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D272500)
