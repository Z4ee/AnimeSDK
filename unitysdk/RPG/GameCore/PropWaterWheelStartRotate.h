...
#define RPG_GAMECORE_PROPWATERWHEELSTARTROTATE_METHOD_3_78259B6F756C5BFA_OFFSET UNITYSDK_OFFSET(0x18C7CB00)
#define RPG_GAMECORE_PROPWATERWHEELSTARTROTATE_METHOD_3_D7ECAC382C05D40C_OFFSET UNITYSDK_OFFSET(0x18C7CCA0)
#define RPG_GAMECORE_PROPWATERWHEELSTARTROTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18C7CB40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropWaterWheelStartRotate_TypeDefinitionIndex = 21020;
