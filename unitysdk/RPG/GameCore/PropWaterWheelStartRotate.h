...
#define RPG_GAMECORE_PROPWATERWHEELSTARTROTATE_METHOD_3_78259B6F756C5BFA_OFFSET UNITYSDK_OFFSET(0x1D375BE0)
#define RPG_GAMECORE_PROPWATERWHEELSTARTROTATE_METHOD_3_D7ECAC382C05D40C_OFFSET UNITYSDK_OFFSET(0x1D375CF0)
#define RPG_GAMECORE_PROPWATERWHEELSTARTROTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D375C20)
