...
#define RPG_GAMECORE_PROPWATERWHEELSTARTROTATE_METHOD_3_78259B6F756C5BFA_OFFSET UNITYSDK_OFFSET(0x17572440)
#define RPG_GAMECORE_PROPWATERWHEELSTARTROTATE_METHOD_3_D7ECAC382C05D40C_OFFSET UNITYSDK_OFFSET(0x175725E0)
#define RPG_GAMECORE_PROPWATERWHEELSTARTROTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x17572480)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropWaterWheelStartRotate_TypeDefinitionIndex = 20338;
