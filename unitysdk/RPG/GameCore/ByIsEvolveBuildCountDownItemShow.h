...
#define RPG_GAMECORE_BYISEVOLVEBUILDCOUNTDOWNITEMSHOW_METHOD_4_8B2F13FB53C16346_OFFSET UNITYSDK_OFFSET(0x1702DA70)
#define RPG_GAMECORE_BYISEVOLVEBUILDCOUNTDOWNITEMSHOW_METHOD_4_9FEB8ED0C604758C_OFFSET UNITYSDK_OFFSET(0x1702D9A0)
#define RPG_GAMECORE_BYISEVOLVEBUILDCOUNTDOWNITEMSHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x1702DA20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByIsEvolveBuildCountDownItemShow_TypeDefinitionIndex = 22410;
