...
#define RPG_GAMECORE_WAITRANDOMSECOND_METHOD_3_05ED5C20F3DF4E02_OFFSET UNITYSDK_OFFSET(0x17902560)
#define RPG_GAMECORE_WAITRANDOMSECOND_METHOD_3_DEC8E5E47DCFFBB4_OFFSET UNITYSDK_OFFSET(0x179025E0)
#define RPG_GAMECORE_WAITRANDOMSECOND__CTOR_OFFSET UNITYSDK_OFFSET(0x179025B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitRandomSecond_TypeDefinitionIndex = 18299;
