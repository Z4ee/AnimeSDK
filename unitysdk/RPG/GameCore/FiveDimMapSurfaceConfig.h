...
#define RPG_GAMECORE_FIVEDIMMAPSURFACECONFIG_METHOD_2_390E4AC85311BFAB_OFFSET UNITYSDK_OFFSET(0x1890AC10)
#define RPG_GAMECORE_FIVEDIMMAPSURFACECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1890AED0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimMapSurfaceConfig_TypeDefinitionIndex = 17590;
