...
#define RPG_GAMECORE_SHOWEVOLVEBUILDTREASUREINBATTLE_METHOD_3_242601D4CEE8293B_OFFSET UNITYSDK_OFFSET(0x19C79B00)
#define RPG_GAMECORE_SHOWEVOLVEBUILDTREASUREINBATTLE_METHOD_3_E43551E45DC87D58_OFFSET UNITYSDK_OFFSET(0x19C79A80)
#define RPG_GAMECORE_SHOWEVOLVEBUILDTREASUREINBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C79AD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowEvolveBuildTreasureInBattle_TypeDefinitionIndex = 21287;
