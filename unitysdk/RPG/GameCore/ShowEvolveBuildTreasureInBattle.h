...
#define RPG_GAMECORE_SHOWEVOLVEBUILDTREASUREINBATTLE_METHOD_3_242601D4CEE8293B_OFFSET UNITYSDK_OFFSET(0x1BE3E4C0)
#define RPG_GAMECORE_SHOWEVOLVEBUILDTREASUREINBATTLE_METHOD_3_60DEF8162A56D360_OFFSET UNITYSDK_OFFSET(0x1BE3E480)
#define RPG_GAMECORE_SHOWEVOLVEBUILDTREASUREINBATTLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BE3E4B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowEvolveBuildTreasureInBattle_TypeDefinitionIndex = 21702;
