...
#define RPG_GAMECORE_ST_SIDE_TRIGGERINSTANTABILITY_METHOD_4_58F32EB10C52B1FD_OFFSET UNITYSDK_OFFSET(0x19C1B8E0)
#define RPG_GAMECORE_ST_SIDE_TRIGGERINSTANTABILITY_METHOD_4_9DB9D614BA5D0FA9_OFFSET UNITYSDK_OFFSET(0x19C1B810)
#define RPG_GAMECORE_ST_SIDE_TRIGGERINSTANTABILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x19C1B890)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ST_Side_TriggerInstantAbility_TypeDefinitionIndex = 19009;
