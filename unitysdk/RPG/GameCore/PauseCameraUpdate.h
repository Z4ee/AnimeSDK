...
#define RPG_GAMECORE_PAUSECAMERAUPDATE_METHOD_3_56DF90479CC246AB_OFFSET UNITYSDK_OFFSET(0x18BD8610)
#define RPG_GAMECORE_PAUSECAMERAUPDATE_METHOD_3_BAD57853B5B95582_OFFSET UNITYSDK_OFFSET(0x18BD8690)
#define RPG_GAMECORE_PAUSECAMERAUPDATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18BD8660)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PauseCameraUpdate_TypeDefinitionIndex = 19801;
