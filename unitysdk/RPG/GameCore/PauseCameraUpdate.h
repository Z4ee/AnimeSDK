...
#define RPG_GAMECORE_PAUSECAMERAUPDATE_METHOD_3_75B1B2AA45FCFA79_OFFSET UNITYSDK_OFFSET(0x1BB12350)
#define RPG_GAMECORE_PAUSECAMERAUPDATE_METHOD_3_BAD57853B5B95582_OFFSET UNITYSDK_OFFSET(0x1BB12390)
#define RPG_GAMECORE_PAUSECAMERAUPDATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB12380)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PauseCameraUpdate_TypeDefinitionIndex = 20036;
