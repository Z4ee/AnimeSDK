...
#define RPG_GAMECORE_GRIDFIGHTMODIFIERENABLEFUNCTIONCONFIG_METHOD_3_3C1568F8D378B2E1_OFFSET UNITYSDK_OFFSET(0x17265DC0)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERENABLEFUNCTIONCONFIG_METHOD_3_94B42183D41BAB08_OFFSET UNITYSDK_OFFSET(0x1726A170)
#define RPG_GAMECORE_GRIDFIGHTMODIFIERENABLEFUNCTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17265D70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightModifierEnableFunctionConfig_TypeDefinitionIndex = 17807;
