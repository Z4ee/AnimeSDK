...
#define RPG_GAMECORE_SETTIMEREWINDATTACHPOINTVISIBLE_METHOD_3_A67139B5A3D2E454_OFFSET UNITYSDK_OFFSET(0x176E44F0)
#define RPG_GAMECORE_SETTIMEREWINDATTACHPOINTVISIBLE_METHOD_3_FA258542EC69D347_OFFSET UNITYSDK_OFFSET(0x176E4570)
#define RPG_GAMECORE_SETTIMEREWINDATTACHPOINTVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x176E4540)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetTimeRewindAttachPointVisible_TypeDefinitionIndex = 18991;
