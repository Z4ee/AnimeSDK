...
#define RPG_GAMECORE_SETTIMEREWINDATTACHPOINTVISIBLE_METHOD_3_2F141A3671A1F68A_OFFSET UNITYSDK_OFFSET(0x1C60DB20)
#define RPG_GAMECORE_SETTIMEREWINDATTACHPOINTVISIBLE_METHOD_3_FA258542EC69D347_OFFSET UNITYSDK_OFFSET(0x1C60DB60)
#define RPG_GAMECORE_SETTIMEREWINDATTACHPOINTVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C60DB50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetTimeRewindAttachPointVisible_TypeDefinitionIndex = 19890;
