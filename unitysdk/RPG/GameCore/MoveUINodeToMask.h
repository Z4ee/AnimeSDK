...
#define RPG_GAMECORE_MOVEUINODETOMASK_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x17458C40)
#define RPG_GAMECORE_MOVEUINODETOMASK_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x17458BC0)
#define RPG_GAMECORE_MOVEUINODETOMASK__CTOR_OFFSET UNITYSDK_OFFSET(0x17458C10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MoveUINodeToMask_TypeDefinitionIndex = 22328;
