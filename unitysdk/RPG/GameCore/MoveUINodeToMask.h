...
#define RPG_GAMECORE_MOVEUINODETOMASK_FROMBINARYIMPL_OFFSET UNITYSDK_OFFSET(0x1B1D0FA0)
#define RPG_GAMECORE_MOVEUINODETOMASK_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B1D0F60)
#define RPG_GAMECORE_MOVEUINODETOMASK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1D0F90)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MoveUINodeToMask_TypeDefinitionIndex = 23429;
