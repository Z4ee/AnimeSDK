...
#define RPG_GAMECORE_MARKRECOMMENDDICEITEM_METHOD_2_6661CD32BB42EF5F_OFFSET UNITYSDK_OFFSET(0x1BD23EF0)
#define RPG_GAMECORE_MARKRECOMMENDDICEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD23FF0)
