...
#define RPG_GAMECORE_ENABLENPCMONSTERAI_METHOD_3_ABD8CFB81786013F_OFFSET UNITYSDK_OFFSET(0x1BB40C10)
#define RPG_GAMECORE_ENABLENPCMONSTERAI_METHOD_3_B6E199BDBB7E35E1_OFFSET UNITYSDK_OFFSET(0x1BB40C60)
#define RPG_GAMECORE_ENABLENPCMONSTERAI__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB40C50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EnableNPCMonsterAI_TypeDefinitionIndex = 19639;
