...
#define RPG_GAMECORE_FIVEDIMFORCERESETMASCOTFAKEPLAYERACTION_METHOD_3_002EA2144EC72A80_OFFSET UNITYSDK_OFFSET(0x18902C60)
#define RPG_GAMECORE_FIVEDIMFORCERESETMASCOTFAKEPLAYERACTION_METHOD_3_A87B04BB9509D7E5_OFFSET UNITYSDK_OFFSET(0x188F5BD0)
#define RPG_GAMECORE_FIVEDIMFORCERESETMASCOTFAKEPLAYERACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x188F5BB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimForceResetMascotFakePlayerAction_TypeDefinitionIndex = 17755;
