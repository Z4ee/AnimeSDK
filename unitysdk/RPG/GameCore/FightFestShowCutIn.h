...
#define RPG_GAMECORE_FIGHTFESTSHOWCUTIN_METHOD_3_DE3370DB2746ACB5_OFFSET UNITYSDK_OFFSET(0x188E1BD0)
#define RPG_GAMECORE_FIGHTFESTSHOWCUTIN_METHOD_3_E851689F1FD33449_OFFSET UNITYSDK_OFFSET(0x188E1C50)
#define RPG_GAMECORE_FIGHTFESTSHOWCUTIN__CTOR_OFFSET UNITYSDK_OFFSET(0x188E1C20)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FightFestShowCutIn_TypeDefinitionIndex = 22188;
