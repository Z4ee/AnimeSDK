...
#define RPG_GAMECORE_CHENLINGCONDITIONROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1E011E70)
#define RPG_GAMECORE_CHENLINGCONDITIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1E0120E0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::RPG::GameCore::ChenLingConditionType Type; // 0x14
