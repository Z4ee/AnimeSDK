...
#define RPG_GAMECORE_PLANETFESSKILLTREEPHASEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x174BFA60)
#define RPG_GAMECORE_PLANETFESSKILLTREEPHASEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x174BFC10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PlanetFesSkillTreePhaseRow_TypeDefinitionIndex = 11133;
