...
#define RPG_GAMECORE_PLANETFESSKILLTREEPHASEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D7A1F90)
#define RPG_GAMECORE_PLANETFESSKILLTREEPHASEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7A2140)
