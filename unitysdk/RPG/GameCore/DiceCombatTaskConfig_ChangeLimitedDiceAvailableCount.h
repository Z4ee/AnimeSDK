...
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_CHANGELIMITEDDICEAVAILABLECOUNT_METHOD_3_2D6D27D628091CAE_OFFSET UNITYSDK_OFFSET(0x171706B0)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_CHANGELIMITEDDICEAVAILABLECOUNT_METHOD_3_8983F3BEEE3F5F12_OFFSET UNITYSDK_OFFSET(0x1716C170)
#define RPG_GAMECORE_DICECOMBATTASKCONFIG_CHANGELIMITEDDICEAVAILABLECOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1716C120)

namespace RPG::GameCore
{
	inline static constexpr unsigned int DiceCombatTaskConfig_ChangeLimitedDiceAvailableCount_TypeDefinitionIndex = 14776;
