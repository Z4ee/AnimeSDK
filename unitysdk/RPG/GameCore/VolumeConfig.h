...
#define RPG_GAMECORE_VOLUMECONFIG_METHOD_2_CC7B259483DD5D90_OFFSET UNITYSDK_OFFSET(0x1DEB2C00)
#define RPG_GAMECORE_VOLUMECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEB2D30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int VolumeConfig_TypeDefinitionIndex = 18920;
