...
#define RPG_GAMECORE_FIVEDIMREFILLPLAYERJUMPENERGYACTION_METHOD_3_6540E5D865568174_OFFSET UNITYSDK_OFFSET(0x189188C0)
#define RPG_GAMECORE_FIVEDIMREFILLPLAYERJUMPENERGYACTION_METHOD_3_6BB9855695E7DBB1_OFFSET UNITYSDK_OFFSET(0x18918980)
#define RPG_GAMECORE_FIVEDIMREFILLPLAYERJUMPENERGYACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18918960)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimRefillPlayerJumpEnergyAction_TypeDefinitionIndex = 17790;
