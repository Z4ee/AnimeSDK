...
#define RPG_GAMECORE_FIVEDIMREFILLPLAYERJUMPENERGYACTION_METHOD_3_6540E5D865568174_OFFSET UNITYSDK_OFFSET(0x19752020)
#define RPG_GAMECORE_FIVEDIMREFILLPLAYERJUMPENERGYACTION_METHOD_3_6BB9855695E7DBB1_OFFSET UNITYSDK_OFFSET(0x197520E0)
#define RPG_GAMECORE_FIVEDIMREFILLPLAYERJUMPENERGYACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x197520C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimRefillPlayerJumpEnergyAction_TypeDefinitionIndex = 17816;
