...
#define RPG_GAMECORE_BYCURRENTSKILLTARGETTYPE_METHOD_4_58F7ED50A6F5D029_OFFSET UNITYSDK_OFFSET(0x1701F710)
#define RPG_GAMECORE_BYCURRENTSKILLTARGETTYPE_METHOD_4_C3D92E64A73FB331_OFFSET UNITYSDK_OFFSET(0x1701F7E0)
#define RPG_GAMECORE_BYCURRENTSKILLTARGETTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1701F790)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCurrentSkillTargetType_TypeDefinitionIndex = 21735;
