...
#define RPG_GAMECORE_PAUSETOTURNEND_METHOD_3_2A979BB884BADA1F_OFFSET UNITYSDK_OFFSET(0x1BB13580)
#define RPG_GAMECORE_PAUSETOTURNEND_METHOD_3_60DA35A2615B4584_OFFSET UNITYSDK_OFFSET(0x1BB13540)
#define RPG_GAMECORE_PAUSETOTURNEND__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB13570)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PauseToTurnEnd_TypeDefinitionIndex = 22574;
