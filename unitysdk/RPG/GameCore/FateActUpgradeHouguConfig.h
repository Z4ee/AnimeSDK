...
#define RPG_GAMECORE_FATEACTUPGRADEHOUGUCONFIG_METHOD_6_20F77618893803A0_OFFSET UNITYSDK_OFFSET(0x188CFD90)
#define RPG_GAMECORE_FATEACTUPGRADEHOUGUCONFIG_METHOD_6_A17BE014394B0D1B_OFFSET UNITYSDK_OFFSET(0x188CFC20)
#define RPG_GAMECORE_FATEACTUPGRADEHOUGUCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x188CFCF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateActUpgradeHouguConfig_TypeDefinitionIndex = 18267;
