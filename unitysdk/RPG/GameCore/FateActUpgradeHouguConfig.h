...
#define RPG_GAMECORE_FATEACTUPGRADEHOUGUCONFIG_METHOD_6_20F77618893803A0_OFFSET UNITYSDK_OFFSET(0x1C073A40)
#define RPG_GAMECORE_FATEACTUPGRADEHOUGUCONFIG_METHOD_6_51C2463D6DC7EE64_OFFSET UNITYSDK_OFFSET(0x1C0739F0)
#define RPG_GAMECORE_FATEACTUPGRADEHOUGUCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C073A30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateActUpgradeHouguConfig_TypeDefinitionIndex = 18474;
