...
#define RPG_GAMECORE_FATEACTUPGRADEHOUGUCONFIG_METHOD_6_20F77618893803A0_OFFSET UNITYSDK_OFFSET(0x171C25C0)
#define RPG_GAMECORE_FATEACTUPGRADEHOUGUCONFIG_METHOD_6_A17BE014394B0D1B_OFFSET UNITYSDK_OFFSET(0x171C2450)
#define RPG_GAMECORE_FATEACTUPGRADEHOUGUCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x171C2520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FateActUpgradeHouguConfig_TypeDefinitionIndex = 17654;
