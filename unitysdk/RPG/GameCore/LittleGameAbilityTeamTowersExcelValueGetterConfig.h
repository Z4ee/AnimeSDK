...
#define RPG_GAMECORE_LITTLEGAMEABILITYTEAMTOWERSEXCELVALUEGETTERCONFIG_METHOD_3_3A40C8116FC49C2B_OFFSET UNITYSDK_OFFSET(0x1B096A60)
#define RPG_GAMECORE_LITTLEGAMEABILITYTEAMTOWERSEXCELVALUEGETTERCONFIG_METHOD_3_9B873C1FCC66B1DF_OFFSET UNITYSDK_OFFSET(0x1B096960)
#define RPG_GAMECORE_LITTLEGAMEABILITYTEAMTOWERSEXCELVALUEGETTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B096A50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LittleGameAbilityTeamTowersExcelValueGetterConfig_TypeDefinitionIndex = 20622;
