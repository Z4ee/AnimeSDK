...
#define RPG_GAMECORE_WAITANIMSTATECHANGEV2_METHOD_4_27D31F5A063BCF1E_OFFSET UNITYSDK_OFFSET(0x1DEB3DC0)
#define RPG_GAMECORE_WAITANIMSTATECHANGEV2_METHOD_4_6441EDDB2DD17BD7_OFFSET UNITYSDK_OFFSET(0x1DEB3E10)
#define RPG_GAMECORE_WAITANIMSTATECHANGEV2__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEB3E00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitAnimStateChangeV2_TypeDefinitionIndex = 22048;
