...
#define RPG_GAMECORE_WAITANIMSTATECHANGEV2_METHOD_4_6441EDDB2DD17BD7_OFFSET UNITYSDK_OFFSET(0x190F87A0)
#define RPG_GAMECORE_WAITANIMSTATECHANGEV2_METHOD_4_6C1B62B879683399_OFFSET UNITYSDK_OFFSET(0x190F86C0)
#define RPG_GAMECORE_WAITANIMSTATECHANGEV2__CTOR_OFFSET UNITYSDK_OFFSET(0x190F8740)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitAnimStateChangeV2_TypeDefinitionIndex = 21174;
