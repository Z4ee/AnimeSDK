...
#define RPG_GAMECORE_RTSUMMONCHARACTEREXTRADATABASE_METHOD_2_75F0A7B16914EA57_OFFSET UNITYSDK_OFFSET(0x19BF31F0)
#define RPG_GAMECORE_RTSUMMONCHARACTEREXTRADATABASE__CTOR_OFFSET UNITYSDK_OFFSET(0x19BF3280)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtSummonCharacterExtraDataBase_TypeDefinitionIndex = 22801;
