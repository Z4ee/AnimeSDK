...
#define RPG_GAMECORE_RTSUMMONCHARACTEREXTRADATABASE_METHOD_2_75F0A7B16914EA57_OFFSET UNITYSDK_OFFSET(0x18DD9190)
#define RPG_GAMECORE_RTSUMMONCHARACTEREXTRADATABASE__CTOR_OFFSET UNITYSDK_OFFSET(0x18DD9220)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtSummonCharacterExtraDataBase_TypeDefinitionIndex = 23120;
