...
#define RPG_GAMECORE_RTSUMMONCHARACTEREXTRADATABASE_METHOD_2_75F0A7B16914EA57_OFFSET UNITYSDK_OFFSET(0x1B76BDA0)
#define RPG_GAMECORE_RTSUMMONCHARACTEREXTRADATABASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B76BE30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtSummonCharacterExtraDataBase_TypeDefinitionIndex = 23268;
