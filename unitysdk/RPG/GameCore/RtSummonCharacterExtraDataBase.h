...
#define RPG_GAMECORE_RTSUMMONCHARACTEREXTRADATABASE_METHOD_2_75F0A7B16914EA57_OFFSET UNITYSDK_OFFSET(0x1D4B2EE0)
#define RPG_GAMECORE_RTSUMMONCHARACTEREXTRADATABASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4B2F70)
