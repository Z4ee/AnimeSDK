...
#define RPG_GAMECORE_ROGUEDLCAEONCROSSROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D3CDD90)
#define RPG_GAMECORE_ROGUEDLCAEONCROSSROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3CDF80)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 SubAeonID; // 0x14
		::System::UInt32 MainAeonNum; // 0x18
		::System::UInt32 MainAeonID; // 0x1C
