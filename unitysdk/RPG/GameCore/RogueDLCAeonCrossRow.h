...
#define RPG_GAMECORE_ROGUEDLCAEONCROSSROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C4B0E80)
#define RPG_GAMECORE_ROGUEDLCAEONCROSSROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4B1070)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueDLCAeonCrossRow_TypeDefinitionIndex = 14154;

	class RogueDLCAeonCrossRow : public ::System::Object
	{
	public:
		::System::UInt32 MainAeonID; // 0x10
		::System::UInt32 MainAeonNum; // 0x14
