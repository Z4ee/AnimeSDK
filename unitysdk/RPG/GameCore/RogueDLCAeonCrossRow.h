...
#define RPG_GAMECORE_ROGUEDLCAEONCROSSROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18CFE850)
#define RPG_GAMECORE_ROGUEDLCAEONCROSSROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18CFEA40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueDLCAeonCrossRow_TypeDefinitionIndex = 13940;
