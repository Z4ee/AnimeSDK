...
#define RPG_GAMECORE_ADVISOMETRICSETSWIPECAMERA_METHOD_3_3C7F17FB9A67D410_OFFSET UNITYSDK_OFFSET(0x16F31E10)
#define RPG_GAMECORE_ADVISOMETRICSETSWIPECAMERA_METHOD_3_AD561F48FBB2AB32_OFFSET UNITYSDK_OFFSET(0x16F31D90)
#define RPG_GAMECORE_ADVISOMETRICSETSWIPECAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x16F31DE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvIsometricSetSwipeCamera_TypeDefinitionIndex = 20404;
