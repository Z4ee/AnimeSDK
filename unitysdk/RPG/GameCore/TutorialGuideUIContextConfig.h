...
#define RPG_GAMECORE_TUTORIALGUIDEUICONTEXTCONFIG_METHOD_2_E5E3A9B97425398F_OFFSET UNITYSDK_OFFSET(0x1D2A79A0)
#define RPG_GAMECORE_TUTORIALGUIDEUICONTEXTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2A7AE0)
