...
#define RPG_GAMECORE_GRIDFIGHTCONDHASANYROLEDRESSEQUIPMATCHLISTCONFIG_METHOD_6_2BFD07B4190D7198_OFFSET UNITYSDK_OFFSET(0x189A4780)
#define RPG_GAMECORE_GRIDFIGHTCONDHASANYROLEDRESSEQUIPMATCHLISTCONFIG_METHOD_6_A37234E431800F3C_OFFSET UNITYSDK_OFFSET(0x189A4940)
#define RPG_GAMECORE_GRIDFIGHTCONDHASANYROLEDRESSEQUIPMATCHLISTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189A4880)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightCondHasAnyRoleDressEquipMatchListConfig_TypeDefinitionIndex = 18364;
