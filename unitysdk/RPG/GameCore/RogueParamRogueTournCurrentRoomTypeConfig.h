...
#define RPG_GAMECORE_ROGUEPARAMROGUETOURNCURRENTROOMTYPECONFIG_METHOD_6_305ED6C345DD3E21_OFFSET UNITYSDK_OFFSET(0x19BB2EC0)
#define RPG_GAMECORE_ROGUEPARAMROGUETOURNCURRENTROOMTYPECONFIG_METHOD_6_E2F01FAEF2DBB657_OFFSET UNITYSDK_OFFSET(0x19BB3170)
#define RPG_GAMECORE_ROGUEPARAMROGUETOURNCURRENTROOMTYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19BB3040)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueParamRogueTournCurrentRoomTypeConfig_TypeDefinitionIndex = 18772;
