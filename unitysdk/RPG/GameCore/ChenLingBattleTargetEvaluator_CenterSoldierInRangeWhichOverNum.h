...
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_CENTERSOLDIERINRANGEWHICHOVERNUM_METHOD_3_776481424355A4C4_OFFSET UNITYSDK_OFFSET(0x1C37E230)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_CENTERSOLDIERINRANGEWHICHOVERNUM_METHOD_3_C0DF2D20B178C81A_OFFSET UNITYSDK_OFFSET(0x1C37E1D0)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_CENTERSOLDIERINRANGEWHICHOVERNUM__CTOR_OFFSET UNITYSDK_OFFSET(0x1C37E220)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleTargetEvaluator_CenterSoldierInRangeWhichOverNum_TypeDefinitionIndex = 15168;
