...
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_CENTERSOLDIERINRANGEWHICHOVERNUM_METHOD_3_776481424355A4C4_OFFSET UNITYSDK_OFFSET(0x17081420)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_CENTERSOLDIERINRANGEWHICHOVERNUM_METHOD_3_C0DF2D20B178C81A_OFFSET UNITYSDK_OFFSET(0x170813C0)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_CENTERSOLDIERINRANGEWHICHOVERNUM__CTOR_OFFSET UNITYSDK_OFFSET(0x17081410)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleTargetEvaluator_CenterSoldierInRangeWhichOverNum_TypeDefinitionIndex = 14471;
