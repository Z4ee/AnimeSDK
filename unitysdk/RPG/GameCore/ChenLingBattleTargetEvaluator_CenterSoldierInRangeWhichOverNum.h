...
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_CENTERSOLDIERINRANGEWHICHOVERNUM_METHOD_3_776481424355A4C4_OFFSET UNITYSDK_OFFSET(0x1CFACB50)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_CENTERSOLDIERINRANGEWHICHOVERNUM_METHOD_3_C0DF2D20B178C81A_OFFSET UNITYSDK_OFFSET(0x1CFACAF0)
#define RPG_GAMECORE_CHENLINGBATTLETARGETEVALUATOR_CENTERSOLDIERINRANGEWHICHOVERNUM__CTOR_OFFSET UNITYSDK_OFFSET(0x1CFACB40)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChenLingBattleTargetEvaluator_CenterSoldierInRangeWhichOverNum_TypeDefinitionIndex = 15605;
