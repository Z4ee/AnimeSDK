...
#define RPG_GAMECORE_BOOMROBOTGAMEPLAYBOOMEND_METHOD_3_25E0B33CBC08F10C_OFFSET UNITYSDK_OFFSET(0x194E55C0)
#define RPG_GAMECORE_BOOMROBOTGAMEPLAYBOOMEND_METHOD_3_6C26EC058C697698_OFFSET UNITYSDK_OFFSET(0x194E56D0)
#define RPG_GAMECORE_BOOMROBOTGAMEPLAYBOOMEND__CTOR_OFFSET UNITYSDK_OFFSET(0x194E56A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BoomRobotGameplayBoomEnd_TypeDefinitionIndex = 19095;
