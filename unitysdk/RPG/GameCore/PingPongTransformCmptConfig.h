...
#define RPG_GAMECORE_PINGPONGTRANSFORMCMPTCONFIG_METHOD_3_8D0B40C6CD967CC6_OFFSET UNITYSDK_OFFSET(0x1D333B90)
#define RPG_GAMECORE_PINGPONGTRANSFORMCMPTCONFIG_METHOD_3_D261B1130F33E1CC_OFFSET UNITYSDK_OFFSET(0x1D333BF0)
#define RPG_GAMECORE_PINGPONGTRANSFORMCMPTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D333BE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PingPongTransformCmptConfig_TypeDefinitionIndex = 18708;
