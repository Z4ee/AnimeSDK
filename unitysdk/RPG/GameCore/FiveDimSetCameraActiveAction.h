...
#define RPG_GAMECORE_FIVEDIMSETCAMERAACTIVEACTION_METHOD_3_5A74C665AA7AE3A6_OFFSET UNITYSDK_OFFSET(0x1D0FFA30)
#define RPG_GAMECORE_FIVEDIMSETCAMERAACTIVEACTION_METHOD_3_DEFC5F375773BAA3_OFFSET UNITYSDK_OFFSET(0x1D0FF950)
#define RPG_GAMECORE_FIVEDIMSETCAMERAACTIVEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0FFA20)
