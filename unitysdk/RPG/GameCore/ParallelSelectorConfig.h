...
#define RPG_GAMECORE_PARALLELSELECTORCONFIG_METHOD_4_C6F67081A6188014_OFFSET UNITYSDK_OFFSET(0x1D30A270)
#define RPG_GAMECORE_PARALLELSELECTORCONFIG_METHOD_4_E7A4AD78092A132F_OFFSET UNITYSDK_OFFSET(0x1D30A2B0)
#define RPG_GAMECORE_PARALLELSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D30A2A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ParallelSelectorConfig_TypeDefinitionIndex = 23508;
