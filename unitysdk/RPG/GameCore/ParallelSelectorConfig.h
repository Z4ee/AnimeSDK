...
#define RPG_GAMECORE_PARALLELSELECTORCONFIG_METHOD_4_91450F8694A694BE_OFFSET UNITYSDK_OFFSET(0x199E4530)
#define RPG_GAMECORE_PARALLELSELECTORCONFIG_METHOD_4_E7A4AD78092A132F_OFFSET UNITYSDK_OFFSET(0x199E45B0)
#define RPG_GAMECORE_PARALLELSELECTORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x199E4580)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ParallelSelectorConfig_TypeDefinitionIndex = 22478;
