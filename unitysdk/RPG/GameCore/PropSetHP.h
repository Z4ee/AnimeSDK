...
#define RPG_GAMECORE_PROPSETHP_METHOD_3_A58FAB121CB1344B_OFFSET UNITYSDK_OFFSET(0x18C74AC0)
#define RPG_GAMECORE_PROPSETHP_METHOD_3_C8E1A0CAAC334FEF_OFFSET UNITYSDK_OFFSET(0x18C74980)
#define RPG_GAMECORE_PROPSETHP__CTOR_OFFSET UNITYSDK_OFFSET(0x18C74A30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropSetHP_TypeDefinitionIndex = 20933;
