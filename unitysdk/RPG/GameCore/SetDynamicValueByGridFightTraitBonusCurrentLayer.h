...
#define RPG_GAMECORE_SETDYNAMICVALUEBYGRIDFIGHTTRAITBONUSCURRENTLAYER_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x19C417E0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYGRIDFIGHTTRAITBONUSCURRENTLAYER_METHOD_4_0D7D8EA3BC6CE9B2_OFFSET UNITYSDK_OFFSET(0x19C3AEA0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYGRIDFIGHTTRAITBONUSCURRENTLAYER_METHOD_4_416404B035A6E770_OFFSET UNITYSDK_OFFSET(0x19C41760)
#define RPG_GAMECORE_SETDYNAMICVALUEBYGRIDFIGHTTRAITBONUSCURRENTLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x19C3AE50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByGridFightTraitBonusCurrentLayer_TypeDefinitionIndex = 21303;
