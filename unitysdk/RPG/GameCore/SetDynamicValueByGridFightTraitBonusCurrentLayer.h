...
#define RPG_GAMECORE_SETDYNAMICVALUEBYGRIDFIGHTTRAITBONUSCURRENTLAYER_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x176C1850)
#define RPG_GAMECORE_SETDYNAMICVALUEBYGRIDFIGHTTRAITBONUSCURRENTLAYER_METHOD_4_0D7D8EA3BC6CE9B2_OFFSET UNITYSDK_OFFSET(0x176BBD50)
#define RPG_GAMECORE_SETDYNAMICVALUEBYGRIDFIGHTTRAITBONUSCURRENTLAYER_METHOD_4_416404B035A6E770_OFFSET UNITYSDK_OFFSET(0x176C17D0)
#define RPG_GAMECORE_SETDYNAMICVALUEBYGRIDFIGHTTRAITBONUSCURRENTLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x176BBD00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetDynamicValueByGridFightTraitBonusCurrentLayer_TypeDefinitionIndex = 20719;
