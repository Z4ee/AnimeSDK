...
#define RPG_GAMECORE_LEVELREGIONINFOS_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18A59650)
#define RPG_GAMECORE_LEVELREGIONINFOS__CTOR_OFFSET UNITYSDK_OFFSET(0x18A59720)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelRegionInfos_TypeDefinitionIndex = 16501;
