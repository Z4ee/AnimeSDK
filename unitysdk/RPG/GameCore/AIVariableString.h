...
#define RPG_GAMECORE_AIVARIABLESTRING_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1B9F9390)
#define RPG_GAMECORE_AIVARIABLESTRING_EQUALS_2_OFFSET UNITYSDK_OFFSET(0x1B9F92E0)
#define RPG_GAMECORE_AIVARIABLESTRING_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B9F9290)
#define RPG_GAMECORE_AIVARIABLESTRING_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B9F9450)
#define RPG_GAMECORE_AIVARIABLESTRING_METHOD_3_137C60875DC60289_OFFSET UNITYSDK_OFFSET(0x1B9F73E0)
#define RPG_GAMECORE_AIVARIABLESTRING_METHOD_3_48224D7DE21A8BB0_OFFSET UNITYSDK_OFFSET(0x1B9F95A0)
#define RPG_GAMECORE_AIVARIABLESTRING_METHOD_3_6ED46C6A6D4D2AC6_OFFSET UNITYSDK_OFFSET(0x1B9F9260)
#define RPG_GAMECORE_AIVARIABLESTRING_METHOD_3_777B33BFEB21C149_OFFSET UNITYSDK_OFFSET(0x1B9F96F0)
#define RPG_GAMECORE_AIVARIABLESTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9F73D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AIVariableString_TypeDefinitionIndex = 15003;
