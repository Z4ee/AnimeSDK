...
#define RPG_GAMECORE_AIVARIABLESTRING_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x193C5AA0)
#define RPG_GAMECORE_AIVARIABLESTRING_EQUALS_2_OFFSET UNITYSDK_OFFSET(0x193C59F0)
#define RPG_GAMECORE_AIVARIABLESTRING_EQUALS_OFFSET UNITYSDK_OFFSET(0x193C59A0)
#define RPG_GAMECORE_AIVARIABLESTRING_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x193C5B60)
#define RPG_GAMECORE_AIVARIABLESTRING_METHOD_3_137C60875DC60289_OFFSET UNITYSDK_OFFSET(0x193C4610)
#define RPG_GAMECORE_AIVARIABLESTRING_METHOD_3_6ED46C6A6D4D2AC6_OFFSET UNITYSDK_OFFSET(0x193C5970)
#define RPG_GAMECORE_AIVARIABLESTRING_METHOD_3_9970F33A5835AE4F_1_OFFSET UNITYSDK_OFFSET(0x193C5CF0)
#define RPG_GAMECORE_AIVARIABLESTRING_METHOD_3_9970F33A5835AE4F_OFFSET UNITYSDK_OFFSET(0x193C5CB0)
#define RPG_GAMECORE_AIVARIABLESTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x193C4600)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AIVariableString_TypeDefinitionIndex = 14841;
