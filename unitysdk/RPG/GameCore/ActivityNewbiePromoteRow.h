...
#define RPG_GAMECORE_ACTIVITYNEWBIEPROMOTEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x193F3920)
#define RPG_GAMECORE_ACTIVITYNEWBIEPROMOTEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x193F3FB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ActivityNewbiePromoteRow_TypeDefinitionIndex = 10784;

	class ActivityNewbiePromoteRow : public ::System::Object
	{
	public:
		::System::UInt32 ID; // 0x10
		::System::UInt32 FinishQuest; // 0x14
