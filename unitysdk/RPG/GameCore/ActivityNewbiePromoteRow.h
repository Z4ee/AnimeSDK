...
#define RPG_GAMECORE_ACTIVITYNEWBIEPROMOTEROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1CD98460)
#define RPG_GAMECORE_ACTIVITYNEWBIEPROMOTEROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD98AF0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::UInt32 DisplayItem; // 0x24
