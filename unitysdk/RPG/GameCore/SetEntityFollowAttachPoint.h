...
#define RPG_GAMECORE_SETENTITYFOLLOWATTACHPOINT_METHOD_3_BEAADE656044253A_OFFSET UNITYSDK_OFFSET(0x18E2EB20)
#define RPG_GAMECORE_SETENTITYFOLLOWATTACHPOINT_METHOD_3_EF1D1D8404074EF0_OFFSET UNITYSDK_OFFSET(0x18E2EA90)
#define RPG_GAMECORE_SETENTITYFOLLOWATTACHPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x18E2EAF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetEntityFollowAttachPoint_TypeDefinitionIndex = 21621;
