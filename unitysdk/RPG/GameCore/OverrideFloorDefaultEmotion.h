...
#define RPG_GAMECORE_OVERRIDEFLOORDEFAULTEMOTION_METHOD_3_5A7321E12357D98E_OFFSET UNITYSDK_OFFSET(0x18BCC210)
#define RPG_GAMECORE_OVERRIDEFLOORDEFAULTEMOTION_METHOD_3_7B7BC59C92208ADF_OFFSET UNITYSDK_OFFSET(0x18BCC190)
#define RPG_GAMECORE_OVERRIDEFLOORDEFAULTEMOTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18BCC1E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int OverrideFloorDefaultEmotion_TypeDefinitionIndex = 20248;
