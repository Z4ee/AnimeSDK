...
#define RPG_GAMECORE_LEVELDOEXTERNALAPPLYOPEVENT_CLEAR_OFFSET UNITYSDK_OFFSET(0xA9876D0)
#define RPG_GAMECORE_LEVELDOEXTERNALAPPLYOPEVENT_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xA987770)
#define RPG_GAMECORE_LEVELDOEXTERNALAPPLYOPEVENT_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xA987720)
#define RPG_GAMECORE_LEVELDOEXTERNALAPPLYOPEVENT_INIT_OFFSET UNITYSDK_OFFSET(0xA987650)
#define RPG_GAMECORE_LEVELDOEXTERNALAPPLYOPEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0xA9877C0)
#define RPG_GAMECORE_LEVELDOEXTERNALAPPLYOPEVENT___IFIXBASEPROXY_CLEAR_OFFSET UNITYSDK_OFFSET(0xA9877D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelDoExternalApplyOpEvent_TypeDefinitionIndex = 45705;
