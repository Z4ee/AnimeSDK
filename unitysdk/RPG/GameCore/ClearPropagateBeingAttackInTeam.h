...
#define RPG_GAMECORE_CLEARPROPAGATEBEINGATTACKINTEAM_METHOD_3_901A0065ECB36F88_OFFSET UNITYSDK_OFFSET(0x1E3484E0)
#define RPG_GAMECORE_CLEARPROPAGATEBEINGATTACKINTEAM_METHOD_3_D86ED7AFF6DEB95B_OFFSET UNITYSDK_OFFSET(0x1E348520)
#define RPG_GAMECORE_CLEARPROPAGATEBEINGATTACKINTEAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1E348510)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClearPropagateBeingAttackInTeam_TypeDefinitionIndex = 22950;
