...
#define RPG_GAMECORE_ROGUEACTBATCHGETROGUEBUFFFROMFORMULACONFIG_METHOD_6_2B05863EC22DF426_OFFSET UNITYSDK_OFFSET(0x19AE1740)
#define RPG_GAMECORE_ROGUEACTBATCHGETROGUEBUFFFROMFORMULACONFIG_METHOD_6_FA5C31166BF625B3_OFFSET UNITYSDK_OFFSET(0x19AE1960)
#define RPG_GAMECORE_ROGUEACTBATCHGETROGUEBUFFFROMFORMULACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19AE1880)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActBatchGetRogueBuffFromFormulaConfig_TypeDefinitionIndex = 18630;
