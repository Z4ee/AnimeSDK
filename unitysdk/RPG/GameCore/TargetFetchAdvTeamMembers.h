...
#define RPG_GAMECORE_TARGETFETCHADVTEAMMEMBERS_METHOD_4_63315671B3CEEEAD_OFFSET UNITYSDK_OFFSET(0x1D0B6470)
#define RPG_GAMECORE_TARGETFETCHADVTEAMMEMBERS_METHOD_4_AE730C307F962D20_OFFSET UNITYSDK_OFFSET(0x1D0B64D0)
#define RPG_GAMECORE_TARGETFETCHADVTEAMMEMBERS_METHOD_4_CEAF4E83136B70C8_OFFSET UNITYSDK_OFFSET(0x1D0B63F0)
#define RPG_GAMECORE_TARGETFETCHADVTEAMMEMBERS_METHOD_4_E10DDCFA89EA846D_OFFSET UNITYSDK_OFFSET(0x1D0B64F0)
#define RPG_GAMECORE_TARGETFETCHADVTEAMMEMBERS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0B6460)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchAdvTeamMembers_TypeDefinitionIndex = 23011;
