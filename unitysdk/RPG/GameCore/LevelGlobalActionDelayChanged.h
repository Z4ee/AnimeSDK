...
#define RPG_GAMECORE_LEVELGLOBALACTIONDELAYCHANGED_CLEAR_OFFSET UNITYSDK_OFFSET(0xE693D70)
#define RPG_GAMECORE_LEVELGLOBALACTIONDELAYCHANGED_GETEVENTTYPE_OFFSET UNITYSDK_OFFSET(0xE693E00)
#define RPG_GAMECORE_LEVELGLOBALACTIONDELAYCHANGED_GETSOURCERUNTIMEID_OFFSET UNITYSDK_OFFSET(0xE693DB0)
#define RPG_GAMECORE_LEVELGLOBALACTIONDELAYCHANGED_INIT_OFFSET UNITYSDK_OFFSET(0xE693D00)
#define RPG_GAMECORE_LEVELGLOBALACTIONDELAYCHANGED__CTOR_OFFSET UNITYSDK_OFFSET(0xE693E50)
