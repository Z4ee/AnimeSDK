...
#define RPG_GAMECORE_TARGETFETCHCAMERAANCHORTARGETLIST_METHOD_4_01A2D5804AD76405_OFFSET UNITYSDK_OFFSET(0x19D04D70)
#define RPG_GAMECORE_TARGETFETCHCAMERAANCHORTARGETLIST_METHOD_4_0DBE86CB96046373_OFFSET UNITYSDK_OFFSET(0x19D0C0A0)
#define RPG_GAMECORE_TARGETFETCHCAMERAANCHORTARGETLIST_METHOD_4_5968BAE8F1678565_OFFSET UNITYSDK_OFFSET(0x19CF8140)
#define RPG_GAMECORE_TARGETFETCHCAMERAANCHORTARGETLIST_METHOD_4_B2B5962AE26E5E95_OFFSET UNITYSDK_OFFSET(0x19D0C160)
#define RPG_GAMECORE_TARGETFETCHCAMERAANCHORTARGETLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x19CF80F0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TargetFetchCameraAnchorTargetList_TypeDefinitionIndex = 22708;
	...
	public:
		...
		static ::System::Void Method_4_01A2D5804AD76405(::SimpleJSON::JSONNode* a1, ::RPG::GameCore::TargetFetchCameraAnchorTargetList*& a2)
		{
			return ((::System::Void(*)(::SimpleJSON::JSONNode*, ::RPG::GameCore::TargetFetchCameraAnchorTargetList*&))((::PBYTE)hIl2Cpp + RPG_GAMECORE_TARGETFETCHCAMERAANCHORTARGETLIST_METHOD_4_01A2D5804AD76405_OFFSET))(a1, a2);
		}
