...
#define RPG_GAMECORE_RTBYINALERTRANGE_METHOD_4_169368F11DE32A39_OFFSET UNITYSDK_OFFSET(0x1BB8EDC0)
#define RPG_GAMECORE_RTBYINALERTRANGE_METHOD_4_AC0A73EC5CBC8DAB_OFFSET UNITYSDK_OFFSET(0x1BB8EBD0)
#define RPG_GAMECORE_RTBYINALERTRANGE_METHOD_4_D56B0DE018B04F62_OFFSET UNITYSDK_OFFSET(0x1BB8EB90)
#define RPG_GAMECORE_RTBYINALERTRANGE_METHOD_4_DA843652E79C0AE7_OFFSET UNITYSDK_OFFSET(0x1BB8ED90)
#define RPG_GAMECORE_RTBYINALERTRANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB8EBC0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RtByInAlertRange_TypeDefinitionIndex = 23373;
