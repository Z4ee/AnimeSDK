...
#define RPG_GAMECORE_PROPPUZZLEVIEWEVENTSENDER_METHOD_3_593E79CBE5296D3D_OFFSET UNITYSDK_OFFSET(0x19A94C90)
#define RPG_GAMECORE_PROPPUZZLEVIEWEVENTSENDER_METHOD_3_E00F1A40B5C8D8CE_OFFSET UNITYSDK_OFFSET(0x19A94D20)
#define RPG_GAMECORE_PROPPUZZLEVIEWEVENTSENDER__CTOR_OFFSET UNITYSDK_OFFSET(0x19A94CF0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropPuzzleViewEventSender_TypeDefinitionIndex = 20765;
