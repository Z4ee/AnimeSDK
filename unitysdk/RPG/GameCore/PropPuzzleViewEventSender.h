...
#define RPG_GAMECORE_PROPPUZZLEVIEWEVENTSENDER_METHOD_3_46766588ADC6AB65_OFFSET UNITYSDK_OFFSET(0x1BA27860)
#define RPG_GAMECORE_PROPPUZZLEVIEWEVENTSENDER_METHOD_3_E00F1A40B5C8D8CE_OFFSET UNITYSDK_OFFSET(0x1BA278B0)
#define RPG_GAMECORE_PROPPUZZLEVIEWEVENTSENDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA278A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropPuzzleViewEventSender_TypeDefinitionIndex = 21180;
