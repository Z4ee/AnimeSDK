...
#define RPG_GAMECORE_TIMEREWINDLOOPCONTROLSTATECHANGELISTENER_METHOD_3_549B574BA222D364_OFFSET UNITYSDK_OFFSET(0x1C153530)
#define RPG_GAMECORE_TIMEREWINDLOOPCONTROLSTATECHANGELISTENER_METHOD_3_DA890645B9FF9BE3_OFFSET UNITYSDK_OFFSET(0x1C1534F0)
#define RPG_GAMECORE_TIMEREWINDLOOPCONTROLSTATECHANGELISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C153520)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TimeRewindLoopControlStateChangeListener_TypeDefinitionIndex = 19885;
