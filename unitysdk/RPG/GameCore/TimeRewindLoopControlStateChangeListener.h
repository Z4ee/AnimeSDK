...
#define RPG_GAMECORE_TIMEREWINDLOOPCONTROLSTATECHANGELISTENER_METHOD_3_549B574BA222D364_OFFSET UNITYSDK_OFFSET(0x1909BD40)
#define RPG_GAMECORE_TIMEREWINDLOOPCONTROLSTATECHANGELISTENER_METHOD_3_72B463B2728283F2_OFFSET UNITYSDK_OFFSET(0x1909BCC0)
#define RPG_GAMECORE_TIMEREWINDLOOPCONTROLSTATECHANGELISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1909BD10)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TimeRewindLoopControlStateChangeListener_TypeDefinitionIndex = 19644;
