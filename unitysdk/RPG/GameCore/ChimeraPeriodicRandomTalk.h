...
#define RPG_GAMECORE_CHIMERAPERIODICRANDOMTALK_METHOD_3_575AC62B04A05021_OFFSET UNITYSDK_OFFSET(0x170A9B10)
#define RPG_GAMECORE_CHIMERAPERIODICRANDOMTALK_METHOD_3_78783645F584EAC9_OFFSET UNITYSDK_OFFSET(0x170A9B80)
#define RPG_GAMECORE_CHIMERAPERIODICRANDOMTALK__CTOR_OFFSET UNITYSDK_OFFSET(0x170A9B70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraPeriodicRandomTalk_TypeDefinitionIndex = 14546;
