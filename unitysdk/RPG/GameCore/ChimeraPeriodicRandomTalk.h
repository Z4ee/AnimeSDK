...
#define RPG_GAMECORE_CHIMERAPERIODICRANDOMTALK_METHOD_3_2418E58DB6439DDE_OFFSET UNITYSDK_OFFSET(0x1C24B730)
#define RPG_GAMECORE_CHIMERAPERIODICRANDOMTALK_METHOD_3_42084D168C879C5A_OFFSET UNITYSDK_OFFSET(0x1C24B6C0)
#define RPG_GAMECORE_CHIMERAPERIODICRANDOMTALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C24B720)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraPeriodicRandomTalk_TypeDefinitionIndex = 15243;
