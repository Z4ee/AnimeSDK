...
#define RPG_GAMECORE_ATTACHENTITYDEPARTED_METHOD_3_7612907818328953_OFFSET UNITYSDK_OFFSET(0x186AD4B0)
#define RPG_GAMECORE_ATTACHENTITYDEPARTED_METHOD_3_A7409A602B16818A_OFFSET UNITYSDK_OFFSET(0x186AD430)
#define RPG_GAMECORE_ATTACHENTITYDEPARTED__CTOR_OFFSET UNITYSDK_OFFSET(0x186AD480)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AttachEntityDeparted_TypeDefinitionIndex = 22586;
