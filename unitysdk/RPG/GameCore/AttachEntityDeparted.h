...
#define RPG_GAMECORE_ATTACHENTITYDEPARTED_METHOD_3_5ACE9C44B10B4FC0_OFFSET UNITYSDK_OFFSET(0x1A065100)
#define RPG_GAMECORE_ATTACHENTITYDEPARTED_METHOD_3_7612907818328953_OFFSET UNITYSDK_OFFSET(0x1A065140)
#define RPG_GAMECORE_ATTACHENTITYDEPARTED__CTOR_OFFSET UNITYSDK_OFFSET(0x1A065130)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AttachEntityDeparted_TypeDefinitionIndex = 22762;
