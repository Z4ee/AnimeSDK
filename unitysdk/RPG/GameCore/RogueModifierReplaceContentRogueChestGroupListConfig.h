...
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUECHESTGROUPLISTCONFIG_METHOD_3_2654E1F4B9AC8859_OFFSET UNITYSDK_OFFSET(0x18D44FB0)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUECHESTGROUPLISTCONFIG_METHOD_3_DF0AF667788E2180_OFFSET UNITYSDK_OFFSET(0x18D44EE0)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUECHESTGROUPLISTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D44F60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierReplaceContentRogueChestGroupListConfig_TypeDefinitionIndex = 16818;
