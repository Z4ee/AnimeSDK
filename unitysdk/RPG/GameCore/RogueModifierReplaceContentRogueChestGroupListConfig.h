...
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUECHESTGROUPLISTCONFIG_METHOD_3_23F380D140A8DE55_OFFSET UNITYSDK_OFFSET(0x1EEFC850)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUECHESTGROUPLISTCONFIG_METHOD_3_2654E1F4B9AC8859_OFFSET UNITYSDK_OFFSET(0x1EEFC8A0)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUECHESTGROUPLISTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEFC890)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierReplaceContentRogueChestGroupListConfig_TypeDefinitionIndex = 17498;
