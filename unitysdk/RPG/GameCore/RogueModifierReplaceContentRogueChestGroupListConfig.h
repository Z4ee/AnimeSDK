...
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUECHESTGROUPLISTCONFIG_METHOD_3_2654E1F4B9AC8859_OFFSET UNITYSDK_OFFSET(0x17638460)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUECHESTGROUPLISTCONFIG_METHOD_3_DF0AF667788E2180_OFFSET UNITYSDK_OFFSET(0x17638390)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUECHESTGROUPLISTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17638410)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierReplaceContentRogueChestGroupListConfig_TypeDefinitionIndex = 16264;
