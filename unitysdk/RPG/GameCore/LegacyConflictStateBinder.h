...
#define RPG_GAMECORE_LEGACYCONFLICTSTATEBINDER_METHOD_3_F423A866F957387D_OFFSET UNITYSDK_OFFSET(0x1B02B8B0)
#define RPG_GAMECORE_LEGACYCONFLICTSTATEBINDER_METHOD_3_FB049DF6F409E348_OFFSET UNITYSDK_OFFSET(0x1B02B870)
#define RPG_GAMECORE_LEGACYCONFLICTSTATEBINDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B02B8A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LegacyConflictStateBinder_TypeDefinitionIndex = 20251;
