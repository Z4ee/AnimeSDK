...
#define RPG_GAMECORE_DOTBARTYPECONFIG_METHOD_2_2FCB8D1BAC757D28_OFFSET UNITYSDK_OFFSET(0x1D03C7A0)
#define RPG_GAMECORE_DOTBARTYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D03C8D0)
