...
#define RPG_GAMECORE_SHAREDSERIALIZATIONDATAIDXLIST_METHOD_2_D87F96ED570F6182_OFFSET UNITYSDK_OFFSET(0x176EE4D0)
#define RPG_GAMECORE_SHAREDSERIALIZATIONDATAIDXLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x176EE590)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SharedSerializationDataIdxList_TypeDefinitionIndex = 17523;
