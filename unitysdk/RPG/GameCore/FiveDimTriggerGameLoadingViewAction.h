...
#define RPG_GAMECORE_FIVEDIMTRIGGERGAMELOADINGVIEWACTION_METHOD_3_791088880809E6D1_OFFSET UNITYSDK_OFFSET(0x1BEB8360)
#define RPG_GAMECORE_FIVEDIMTRIGGERGAMELOADINGVIEWACTION_METHOD_3_ACDC4213E7843CAA_OFFSET UNITYSDK_OFFSET(0x1BEB8320)
#define RPG_GAMECORE_FIVEDIMTRIGGERGAMELOADINGVIEWACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEB8350)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimTriggerGameLoadingViewAction_TypeDefinitionIndex = 17928;
