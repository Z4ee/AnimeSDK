...
#define RPG_GAMECORE_FIVEDIMTRIGGERGAMELOADINGVIEWACTION_METHOD_3_27BDF911FFC9F958_OFFSET UNITYSDK_OFFSET(0x1975D240)
#define RPG_GAMECORE_FIVEDIMTRIGGERGAMELOADINGVIEWACTION_METHOD_3_913BA470D39616CC_OFFSET UNITYSDK_OFFSET(0x1975D110)
#define RPG_GAMECORE_FIVEDIMTRIGGERGAMELOADINGVIEWACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1975D220)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FiveDimTriggerGameLoadingViewAction_TypeDefinitionIndex = 17754;
