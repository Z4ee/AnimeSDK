...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONASTYLESELECTCONFIG_METHOD_3_6746E3C7FBAA991C_OFFSET UNITYSDK_OFFSET(0x18D3E190)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONASTYLESELECTCONFIG_METHOD_3_A8A0173AAD5C3AF5_OFFSET UNITYSDK_OFFSET(0x18D3E260)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONASTYLESELECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D3E210)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnPersonaStyleSelectConfig_TypeDefinitionIndex = 16972;
