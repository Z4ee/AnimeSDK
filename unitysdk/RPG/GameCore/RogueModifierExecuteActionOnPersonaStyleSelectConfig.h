...
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONASTYLESELECTCONFIG_METHOD_3_6B0F4061B4EB9FD1_OFFSET UNITYSDK_OFFSET(0x1EEF9590)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONASTYLESELECTCONFIG_METHOD_3_A8A0173AAD5C3AF5_OFFSET UNITYSDK_OFFSET(0x1EEF95E0)
#define RPG_GAMECORE_ROGUEMODIFIEREXECUTEACTIONONPERSONASTYLESELECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEF95D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierExecuteActionOnPersonaStyleSelectConfig_TypeDefinitionIndex = 17664;
