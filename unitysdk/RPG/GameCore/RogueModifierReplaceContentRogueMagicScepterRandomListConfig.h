...
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEMAGICSCEPTERRANDOMLISTCONFIG_METHOD_3_09D78F6AC6E835E9_OFFSET UNITYSDK_OFFSET(0x1EEFCAE0)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEMAGICSCEPTERRANDOMLISTCONFIG_METHOD_3_642004675BBBEA65_OFFSET UNITYSDK_OFFSET(0x1EEFCA90)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEMAGICSCEPTERRANDOMLISTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EEFCAD0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierReplaceContentRogueMagicScepterRandomListConfig_TypeDefinitionIndex = 17499;
