...
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEMAGICSCEPTERRANDOMLISTCONFIG_METHOD_3_09D78F6AC6E835E9_OFFSET UNITYSDK_OFFSET(0x19B9B4D0)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEMAGICSCEPTERRANDOMLISTCONFIG_METHOD_3_E9E0B25F2FE47C90_OFFSET UNITYSDK_OFFSET(0x19B9B400)
#define RPG_GAMECORE_ROGUEMODIFIERREPLACECONTENTROGUEMAGICSCEPTERRANDOMLISTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B9B480)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueModifierReplaceContentRogueMagicScepterRandomListConfig_TypeDefinitionIndex = 16834;
