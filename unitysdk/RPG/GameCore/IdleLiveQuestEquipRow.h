...
#define RPG_GAMECORE_IDLELIVEQUESTEQUIPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x19845B10)
#define RPG_GAMECORE_IDLELIVEQUESTEQUIPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x19845DB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int IdleLiveQuestEquipRow_TypeDefinitionIndex = 11256;
