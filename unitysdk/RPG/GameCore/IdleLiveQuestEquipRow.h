...
#define RPG_GAMECORE_IDLELIVEQUESTEQUIPROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D213470)
#define RPG_GAMECORE_IDLELIVEQUESTEQUIPROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D213710)

namespace RPG::GameCore
{
	inline static constexpr unsigned int IdleLiveQuestEquipRow_TypeDefinitionIndex = 11745;

	class IdleLiveQuestEquipRow : public ::System::Object
	{
	public:
		::Il2CppArray<::System::UInt32>* PropertyIDList; // 0x10
		::System::UInt32 RandomFactorIndex; // 0x18
