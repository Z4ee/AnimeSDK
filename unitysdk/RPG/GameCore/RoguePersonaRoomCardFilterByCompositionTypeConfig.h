...
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYCOMPOSITIONTYPECONFIG_METHOD_3_66C35781D9ACCC93_OFFSET UNITYSDK_OFFSET(0x18D65940)
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYCOMPOSITIONTYPECONFIG_METHOD_3_AA44E1E4A35984D7_OFFSET UNITYSDK_OFFSET(0x18D65750)
#define RPG_GAMECORE_ROGUEPERSONAROOMCARDFILTERBYCOMPOSITIONTYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D65740)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RoguePersonaRoomCardFilterByCompositionTypeConfig_TypeDefinitionIndex = 18855;
