...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETCURSECTIONCONFIG_METHOD_6_900D5A7B3CA14A74_OFFSET UNITYSDK_OFFSET(0x189C32E0)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETCURSECTIONCONFIG_METHOD_6_F09536C93376603A_OFFSET UNITYSDK_OFFSET(0x189C3590)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETCURSECTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189C3460)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightParamGetCurSectionConfig_TypeDefinitionIndex = 18548;
