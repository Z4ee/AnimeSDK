...
#define RPG_GAMECORE_GRIDFIGHTPARAMGETCURSECTIONCONFIG_METHOD_6_E98D60DE952FCC7E_OFFSET UNITYSDK_OFFSET(0x1D15D160)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETCURSECTIONCONFIG_METHOD_6_F09536C93376603A_OFFSET UNITYSDK_OFFSET(0x1D15D1B0)
#define RPG_GAMECORE_GRIDFIGHTPARAMGETCURSECTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D15D1A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int GridFightParamGetCurSectionConfig_TypeDefinitionIndex = 19308;
