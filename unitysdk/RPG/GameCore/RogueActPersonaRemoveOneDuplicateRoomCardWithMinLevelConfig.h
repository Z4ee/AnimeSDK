...
#define RPG_GAMECORE_ROGUEACTPERSONAREMOVEONEDUPLICATEROOMCARDWITHMINLEVELCONFIG_METHOD_6_3D719E94FE788157_OFFSET UNITYSDK_OFFSET(0x18CCC580)
#define RPG_GAMECORE_ROGUEACTPERSONAREMOVEONEDUPLICATEROOMCARDWITHMINLEVELCONFIG_METHOD_6_54091CDAD3FFD1E2_OFFSET UNITYSDK_OFFSET(0x18CCC7A0)
#define RPG_GAMECORE_ROGUEACTPERSONAREMOVEONEDUPLICATEROOMCARDWITHMINLEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CCC6C0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaRemoveOneDuplicateRoomCardWithMinLevelConfig_TypeDefinitionIndex = 18771;
