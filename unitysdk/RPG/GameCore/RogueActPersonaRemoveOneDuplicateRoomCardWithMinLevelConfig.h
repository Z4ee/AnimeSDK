...
#define RPG_GAMECORE_ROGUEACTPERSONAREMOVEONEDUPLICATEROOMCARDWITHMINLEVELCONFIG_METHOD_6_507D75FC28C74946_OFFSET UNITYSDK_OFFSET(0x1D02FE40)
#define RPG_GAMECORE_ROGUEACTPERSONAREMOVEONEDUPLICATEROOMCARDWITHMINLEVELCONFIG_METHOD_6_54091CDAD3FFD1E2_OFFSET UNITYSDK_OFFSET(0x1D02FE90)
#define RPG_GAMECORE_ROGUEACTPERSONAREMOVEONEDUPLICATEROOMCARDWITHMINLEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1D02FE80)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueActPersonaRemoveOneDuplicateRoomCardWithMinLevelConfig_TypeDefinitionIndex = 19014;
