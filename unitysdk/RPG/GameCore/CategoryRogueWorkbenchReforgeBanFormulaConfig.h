...
#define RPG_GAMECORE_CATEGORYROGUEWORKBENCHREFORGEBANFORMULACONFIG_METHOD_2_6AA4E669DBBA9C82_OFFSET UNITYSDK_OFFSET(0x187B8AA0)
#define RPG_GAMECORE_CATEGORYROGUEWORKBENCHREFORGEBANFORMULACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x187B8AE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int CategoryRogueWorkbenchReforgeBanFormulaConfig_TypeDefinitionIndex = 16864;
