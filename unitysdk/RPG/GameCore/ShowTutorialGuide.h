...
#define RPG_GAMECORE_SHOWTUTORIALGUIDE_METHOD_3_A788721232A8A5EE_OFFSET UNITYSDK_OFFSET(0x1D531B70)
#define RPG_GAMECORE_SHOWTUTORIALGUIDE_METHOD_3_E971ED3AAF37953F_OFFSET UNITYSDK_OFFSET(0x1D531BB0)
#define RPG_GAMECORE_SHOWTUTORIALGUIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D531BA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowTutorialGuide_TypeDefinitionIndex = 24068;
