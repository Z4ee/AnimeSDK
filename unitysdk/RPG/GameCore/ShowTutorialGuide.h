...
#define RPG_GAMECORE_SHOWTUTORIALGUIDE_METHOD_3_628650E90EA63604_OFFSET UNITYSDK_OFFSET(0x19C85210)
#define RPG_GAMECORE_SHOWTUTORIALGUIDE_METHOD_3_E971ED3AAF37953F_OFFSET UNITYSDK_OFFSET(0x19C85290)
#define RPG_GAMECORE_SHOWTUTORIALGUIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C85260)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ShowTutorialGuide_TypeDefinitionIndex = 23019;
