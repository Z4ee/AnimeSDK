...
#define RPG_GAMECORE_FOURROTATEVOXELREVERT2DVOXELCONFIG_METHOD_3_0E42A601CEB56B2B_OFFSET UNITYSDK_OFFSET(0x1721DC00)
#define RPG_GAMECORE_FOURROTATEVOXELREVERT2DVOXELCONFIG_METHOD_3_F149CA3D1F4E85C2_OFFSET UNITYSDK_OFFSET(0x1721DB90)
#define RPG_GAMECORE_FOURROTATEVOXELREVERT2DVOXELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1721DBE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FourRotateVoxelRevert2DVoxelConfig_TypeDefinitionIndex = 15358;
