...
#define RPG_GAMECORE_FOURROTATEVOXELREVERT2DVOXELCONFIG_METHOD_3_0E42A601CEB56B2B_OFFSET UNITYSDK_OFFSET(0x189303A0)
#define RPG_GAMECORE_FOURROTATEVOXELREVERT2DVOXELCONFIG_METHOD_3_F149CA3D1F4E85C2_OFFSET UNITYSDK_OFFSET(0x18930330)
#define RPG_GAMECORE_FOURROTATEVOXELREVERT2DVOXELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18930380)

namespace RPG::GameCore
{
	inline static constexpr unsigned int FourRotateVoxelRevert2DVoxelConfig_TypeDefinitionIndex = 15877;
