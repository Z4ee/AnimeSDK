...
#define RPG_GAMECORE_CLEARFORMATIONFACEDELTARECORD_METHOD_3_568BE85EF0456BD8_OFFSET UNITYSDK_OFFSET(0x170B27F0)
#define RPG_GAMECORE_CLEARFORMATIONFACEDELTARECORD_METHOD_3_E873E901D158D932_OFFSET UNITYSDK_OFFSET(0x170B28C0)
#define RPG_GAMECORE_CLEARFORMATIONFACEDELTARECORD__CTOR_OFFSET UNITYSDK_OFFSET(0x170B2870)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClearFormationFaceDeltaRecord_TypeDefinitionIndex = 20635;
