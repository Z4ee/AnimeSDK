...
#define RPG_GAMECORE_CLEARFORMATIONFACEDELTARECORD_METHOD_3_1196FF6763756FDB_OFFSET UNITYSDK_OFFSET(0x1E348000)
#define RPG_GAMECORE_CLEARFORMATIONFACEDELTARECORD_METHOD_3_E873E901D158D932_OFFSET UNITYSDK_OFFSET(0x1E3480A0)
#define RPG_GAMECORE_CLEARFORMATIONFACEDELTARECORD__CTOR_OFFSET UNITYSDK_OFFSET(0x1E348060)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ClearFormationFaceDeltaRecord_TypeDefinitionIndex = 22202;
