...
#define RPG_GAMECORE_ROGUEHINTROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x18D1B090)
#define RPG_GAMECORE_ROGUEHINTROW__CTOR_OFFSET UNITYSDK_OFFSET(0x18D1B640)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RogueHintRow_TypeDefinitionIndex = 13889;
