...
#define RPG_GAMECORE_TRIGGERENERGYBAREFFECT_METHOD_3_1A85060C061433F0_OFFSET UNITYSDK_OFFSET(0x190C4FC0)
#define RPG_GAMECORE_TRIGGERENERGYBAREFFECT_METHOD_3_7CAE0755DB6F1B3C_OFFSET UNITYSDK_OFFSET(0x190C4EF0)
#define RPG_GAMECORE_TRIGGERENERGYBAREFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x190C4F70)

namespace RPG::GameCore
{
	inline static constexpr unsigned int TriggerEnergyBarEffect_TypeDefinitionIndex = 21643;
