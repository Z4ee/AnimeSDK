...
#define RPG_GAMECORE_MAKECHARACTERHUDVISIBLE_METHOD_3_13AE624A7DD4AC54_OFFSET UNITYSDK_OFFSET(0x1D21E0A0)
#define RPG_GAMECORE_MAKECHARACTERHUDVISIBLE_METHOD_3_7637FFAA3CB52109_OFFSET UNITYSDK_OFFSET(0x1D21E0E0)
#define RPG_GAMECORE_MAKECHARACTERHUDVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D21E0D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MakeCharacterHUDVisible_TypeDefinitionIndex = 22562;
