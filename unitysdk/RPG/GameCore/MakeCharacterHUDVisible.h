...
#define RPG_GAMECORE_MAKECHARACTERHUDVISIBLE_METHOD_3_5DCCFC9B6A20DC8C_OFFSET UNITYSDK_OFFSET(0x17377B10)
#define RPG_GAMECORE_MAKECHARACTERHUDVISIBLE_METHOD_3_7637FFAA3CB52109_OFFSET UNITYSDK_OFFSET(0x17377B90)
#define RPG_GAMECORE_MAKECHARACTERHUDVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x17377B60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int MakeCharacterHUDVisible_TypeDefinitionIndex = 21015;
