...
#define RPG_GAMECORE_TRAINPARTYPASSENGERCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1D537840)
#define RPG_GAMECORE_TRAINPARTYPASSENGERCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1D537C40)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* AvatarCardPrefabPath; // 0x28
