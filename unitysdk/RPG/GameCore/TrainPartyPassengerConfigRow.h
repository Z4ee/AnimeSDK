...
#define RPG_GAMECORE_TRAINPARTYPASSENGERCONFIGROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1C1624B0)
#define RPG_GAMECORE_TRAINPARTYPASSENGERCONFIGROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1628B0)
...
namespace RPG::GameCore
{
	...
	public:
		...
		::System::String* AvatarCardPrefabPath; // 0x20
		::System::String* MeetingIconPath; // 0x28
		::System::String* AvatarRoundIconBgPath; // 0x30
		::System::String* AvatarRoundIconPath; // 0x38
		::System::UInt32 DiaryOrder; // 0x40
		::System::UInt32 PassengerQuest; // 0x44
