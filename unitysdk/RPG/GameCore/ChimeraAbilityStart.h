...
#define RPG_GAMECORE_CHIMERAABILITYSTART_METHOD_3_6FADE5E9CEB757D4_OFFSET UNITYSDK_OFFSET(0x1C38DD10)
#define RPG_GAMECORE_CHIMERAABILITYSTART_METHOD_3_C911B17D9296D5E8_OFFSET UNITYSDK_OFFSET(0x1C38F080)
#define RPG_GAMECORE_CHIMERAABILITYSTART__CTOR_OFFSET UNITYSDK_OFFSET(0x1C38DD00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ChimeraAbilityStart_TypeDefinitionIndex = 15248;
