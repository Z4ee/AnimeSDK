...
#define RPG_GAMECORE_PROPPUZZLEMISSIONRESETEVENTLISTENER_METHOD_3_69397066C01BB7C9_OFFSET UNITYSDK_OFFSET(0x17522D10)
#define RPG_GAMECORE_PROPPUZZLEMISSIONRESETEVENTLISTENER_METHOD_3_A5AE181562965240_OFFSET UNITYSDK_OFFSET(0x17522D90)
#define RPG_GAMECORE_PROPPUZZLEMISSIONRESETEVENTLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x17522D60)

namespace RPG::GameCore
{
	inline static constexpr unsigned int PropPuzzleMissionResetEventListener_TypeDefinitionIndex = 20184;
