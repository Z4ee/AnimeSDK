...
#define RPG_GAMECORE_BASELITTLEGAMEABILITYEFFECTCONFIG_METHOD_2_47A2A1384DDA465A_OFFSET UNITYSDK_OFFSET(0x1CE67060)
#define RPG_GAMECORE_BASELITTLEGAMEABILITYEFFECTCONFIG_METHOD_2_4C82FBED36025703_OFFSET UNITYSDK_OFFSET(0x1CE670C0)
#define RPG_GAMECORE_BASELITTLEGAMEABILITYEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CE67120)

namespace RPG::GameCore
{
	inline static constexpr unsigned int BaseLittleGameAbilityEffectConfig_TypeDefinitionIndex = 21091;
