...
#define RPG_GAMECORE_BYALLOWINSTANTKILL_METHOD_4_527F622E67A2D194_OFFSET UNITYSDK_OFFSET(0x19CB7F80)
#define RPG_GAMECORE_BYALLOWINSTANTKILL_METHOD_4_B01CF882783D7D6B_OFFSET UNITYSDK_OFFSET(0x19CB8140)
#define RPG_GAMECORE_BYALLOWINSTANTKILL_METHOD_4_BCBF13F6C7A5D7D1_OFFSET UNITYSDK_OFFSET(0x19CB7FC0)
#define RPG_GAMECORE_BYALLOWINSTANTKILL_METHOD_4_E574C0D36760948D_OFFSET UNITYSDK_OFFSET(0x19CB8170)
#define RPG_GAMECORE_BYALLOWINSTANTKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x19CB7FB0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByAllowInstantKill_TypeDefinitionIndex = 19471;
