...
#define RPG_GAMECORE_BYALLOWINSTANTKILL_METHOD_4_775863C1C6B28947_OFFSET UNITYSDK_OFFSET(0x16FF9660)
#define RPG_GAMECORE_BYALLOWINSTANTKILL_METHOD_4_BCBF13F6C7A5D7D1_OFFSET UNITYSDK_OFFSET(0x16FF9730)
#define RPG_GAMECORE_BYALLOWINSTANTKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x16FF96E0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByAllowInstantKill_TypeDefinitionIndex = 18536;
