...
#define RPG_GAMECORE_BYCOMPAREROGUEREMAINMONSTERNUM_METHOD_4_71A2A566C7B6535E_OFFSET UNITYSDK_OFFSET(0x1BBB6590)
#define RPG_GAMECORE_BYCOMPAREROGUEREMAINMONSTERNUM_METHOD_4_CC3EFC543CCA409A_OFFSET UNITYSDK_OFFSET(0x1BBB65E0)
#define RPG_GAMECORE_BYCOMPAREROGUEREMAINMONSTERNUM__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBB65D0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int ByCompareRogueRemainMonsterNum_TypeDefinitionIndex = 20562;
