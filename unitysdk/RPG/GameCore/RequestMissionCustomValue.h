...
#define RPG_GAMECORE_REQUESTMISSIONCUSTOMVALUE_METHOD_3_0312C9BE1D1B8AB2_OFFSET UNITYSDK_OFFSET(0x1759C790)
#define RPG_GAMECORE_REQUESTMISSIONCUSTOMVALUE_METHOD_3_095288287618B1D4_OFFSET UNITYSDK_OFFSET(0x1759C670)
#define RPG_GAMECORE_REQUESTMISSIONCUSTOMVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x1759C710)

namespace RPG::GameCore
{
	inline static constexpr unsigned int RequestMissionCustomValue_TypeDefinitionIndex = 18743;
