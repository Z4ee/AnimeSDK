...
#define RPG_GAMECORE_SETSKILLTARGETFORMATION_METHOD_3_41A165EC774DF21D_OFFSET UNITYSDK_OFFSET(0x1C607C40)
#define RPG_GAMECORE_SETSKILLTARGETFORMATION_METHOD_3_62756C6FFFF4C671_OFFSET UNITYSDK_OFFSET(0x1C607BA0)
#define RPG_GAMECORE_SETSKILLTARGETFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C607C00)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetSkillTargetFormation_TypeDefinitionIndex = 21682;
