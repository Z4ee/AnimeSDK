...
#define RPG_GAMECORE_SETSKILLTARGETFORMATION_METHOD_3_613B037FE6B31A8A_OFFSET UNITYSDK_OFFSET(0x176DDF80)
#define RPG_GAMECORE_SETSKILLTARGETFORMATION_METHOD_3_99C9F1B17F962EE0_OFFSET UNITYSDK_OFFSET(0x176DDEB0)
#define RPG_GAMECORE_SETSKILLTARGETFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x176DDF30)

namespace RPG::GameCore
{
	inline static constexpr unsigned int SetSkillTargetFormation_TypeDefinitionIndex = 20680;
