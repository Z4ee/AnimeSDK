...
#define RPG_GAMECORE_ENDDIALOGUEENTITYINTERACT_METHOD_3_5913A781866F7360_OFFSET UNITYSDK_OFFSET(0x1D064BF0)
#define RPG_GAMECORE_ENDDIALOGUEENTITYINTERACT_METHOD_3_893583003D9DA623_OFFSET UNITYSDK_OFFSET(0x1D064BB0)
#define RPG_GAMECORE_ENDDIALOGUEENTITYINTERACT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D064BE0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int EndDialogueEntityInteract_TypeDefinitionIndex = 20158;
