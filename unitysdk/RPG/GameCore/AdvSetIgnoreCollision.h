...
#define RPG_GAMECORE_ADVSETIGNORECOLLISION_METHOD_3_01683D60DDD8F8B1_OFFSET UNITYSDK_OFFSET(0x19436CD0)
#define RPG_GAMECORE_ADVSETIGNORECOLLISION_METHOD_3_90B5814827F5BCDD_OFFSET UNITYSDK_OFFSET(0x19436C50)
#define RPG_GAMECORE_ADVSETIGNORECOLLISION__CTOR_OFFSET UNITYSDK_OFFSET(0x19436CA0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AdvSetIgnoreCollision_TypeDefinitionIndex = 19391;
