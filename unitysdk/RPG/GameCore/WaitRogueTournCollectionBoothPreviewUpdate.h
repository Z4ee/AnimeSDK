...
#define RPG_GAMECORE_WAITROGUETOURNCOLLECTIONBOOTHPREVIEWUPDATE_METHOD_4_ED254606BC15CAC8_OFFSET UNITYSDK_OFFSET(0x17903120)
#define RPG_GAMECORE_WAITROGUETOURNCOLLECTIONBOOTHPREVIEWUPDATE_METHOD_4_F240B587F730E15E_OFFSET UNITYSDK_OFFSET(0x17903200)
#define RPG_GAMECORE_WAITROGUETOURNCOLLECTIONBOOTHPREVIEWUPDATE__CTOR_OFFSET UNITYSDK_OFFSET(0x179031A0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitRogueTournCollectionBoothPreviewUpdate_TypeDefinitionIndex = 20294;
