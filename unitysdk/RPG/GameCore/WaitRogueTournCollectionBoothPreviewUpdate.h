...
#define RPG_GAMECORE_WAITROGUETOURNCOLLECTIONBOOTHPREVIEWUPDATE_METHOD_4_ED254606BC15CAC8_OFFSET UNITYSDK_OFFSET(0x19106FE0)
#define RPG_GAMECORE_WAITROGUETOURNCOLLECTIONBOOTHPREVIEWUPDATE_METHOD_4_F240B587F730E15E_OFFSET UNITYSDK_OFFSET(0x191070C0)
#define RPG_GAMECORE_WAITROGUETOURNCOLLECTIONBOOTHPREVIEWUPDATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19107060)

namespace RPG::GameCore
{
	inline static constexpr unsigned int WaitRogueTournCollectionBoothPreviewUpdate_TypeDefinitionIndex = 20976;
