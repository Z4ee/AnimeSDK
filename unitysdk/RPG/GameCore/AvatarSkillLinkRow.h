...
#define RPG_GAMECORE_AVATARSKILLLINKROW_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1B2DA310)
#define RPG_GAMECORE_AVATARSKILLLINKROW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2DA4B0)

namespace RPG::GameCore
{
	inline static constexpr unsigned int AvatarSkillLinkRow_TypeDefinitionIndex = 12681;

	class AvatarSkillLinkRow : public ::System::Object
	{
	public:
		::Il2CppArray<::System::UInt32>* LinkToAvatarIDList; // 0x10
		::Il2CppArray<::System::UInt32>* LinkToAvatarIDSimplifiedList; // 0x18
