...
#define RPG_GAMECORE_LEVELGROUPMISSIONCONDITION_METHOD_2_27970A41F9808B31_OFFSET UNITYSDK_OFFSET(0x1D1D5360)
#define RPG_GAMECORE_LEVELGROUPMISSIONCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1D54B0)
