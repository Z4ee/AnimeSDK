...
#define RPG_GAMECORE_LEVELGROUPMISSIONCONDITION_METHOD_2_27970A41F9808B31_OFFSET UNITYSDK_OFFSET(0x1C118900)
#define RPG_GAMECORE_LEVELGROUPMISSIONCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C118A50)

namespace RPG::GameCore
{
	inline static constexpr unsigned int LevelGroupMissionCondition_TypeDefinitionIndex = 17012;
