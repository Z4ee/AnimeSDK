...
#define RPG_GAMECORE_HANUBARNOTIFYCONFIG_METHOD_2_E2C4C08A95F007AE_OFFSET UNITYSDK_OFFSET(0x1B66F4E0)
#define RPG_GAMECORE_HANUBARNOTIFYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B66F610)

namespace RPG::GameCore
{
	inline static constexpr unsigned int HanuBarNotifyConfig_TypeDefinitionIndex = 16291;
