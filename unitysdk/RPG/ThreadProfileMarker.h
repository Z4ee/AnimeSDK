...
#define RPG_THREADPROFILEMARKER_BEGIN_OFFSET UNITYSDK_OFFSET(0x182E2C00)
#define RPG_THREADPROFILEMARKER_END_OFFSET UNITYSDK_OFFSET(0x182E3150)
#define RPG_THREADPROFILEMARKER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x182E3330)
#define RPG_THREADPROFILEMARKER__CCTOR_OFFSET UNITYSDK_OFFSET(0x182E3340)
#define RPG_THREADPROFILEMARKER__CTOR_OFFSET UNITYSDK_OFFSET(0x182E2BF0)

namespace RPG
{
	inline static constexpr unsigned int ThreadProfileMarker_TypeDefinitionIndex = 27625;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::RPG::ThreadProfileMarker*>**)Il2CppClass::FromTypeDefinitionIndex(ThreadProfileMarker_TypeDefinitionIndex)->GetStaticField(0x930);
		}
