...
#define RPG_CLIENT_FIGHTFESTLINEUPSNAPSHOT_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0xB9C7290)
#define RPG_CLIENT_FIGHTFESTLINEUPSNAPSHOT__CTOR_OFFSET UNITYSDK_OFFSET(0xB9C72F0)

namespace RPG::Client
{
	inline static constexpr unsigned int FightFestLineupSnapShot_TypeDefinitionIndex = 59990;
