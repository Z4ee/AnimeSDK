...
#define RPG_CLIENT_BATTLEUIUTILS_CANOPENTIMELINEDETAILINFOPANEL_1_OFFSET UNITYSDK_OFFSET(0xC940430)
#define RPG_CLIENT_BATTLEUIUTILS_CANOPENTIMELINEDETAILINFOPANEL_OFFSET UNITYSDK_OFFSET(0xC940340)
#define RPG_CLIENT_BATTLEUIUTILS_CHECKPENDINGDOWNLOADREPLAYTOPLAY_OFFSET UNITYSDK_OFFSET(0xC941AD0)
#define RPG_CLIENT_BATTLEUIUTILS_CREATEBATTLERESULTREWARDLIST_OFFSET UNITYSDK_OFFSET(0xC941290)
#define RPG_CLIENT_BATTLEUIUTILS_CREATEMAZESKILLREWARDLISTFROMRESULT_OFFSET UNITYSDK_OFFSET(0xC940EF0)
#define RPG_CLIENT_BATTLEUIUTILS_CREATEMULTIPLEREWARDLISTFROMRESULT_OFFSET UNITYSDK_OFFSET(0xC9419F0)
#define RPG_CLIENT_BATTLEUIUTILS_CREATEREWARDLISTFROMRESULT_OFFSET UNITYSDK_OFFSET(0xC9356B0)
#define RPG_CLIENT_BATTLEUIUTILS_FINDBYRUNTIMEID_OFFSET UNITYSDK_OFFSET(0xC940B70)
#define RPG_CLIENT_BATTLEUIUTILS_GETACTIVESKILLCONFIG_OFFSET UNITYSDK_OFFSET(0xC93F6A0)
#define RPG_CLIENT_BATTLEUIUTILS_GETACTIVESKILLDAMAGETYPE_OFFSET UNITYSDK_OFFSET(0xC93F980)
#define RPG_CLIENT_BATTLEUIUTILS_GETACTIVESKILLDATA_OFFSET UNITYSDK_OFFSET(0xC93F810)
#define RPG_CLIENT_BATTLEUIUTILS_GETACTIVESKILLINDEX_OFFSET UNITYSDK_OFFSET(0xC93F540)
#define RPG_CLIENT_BATTLEUIUTILS_GETALLAVATARGLOBALMAZEBUFFDATALIST_OFFSET UNITYSDK_OFFSET(0xC943410)
#define RPG_CLIENT_BATTLEUIUTILS_GETATTACHPRESHOWSKILLDAMAGETYPE_OFFSET UNITYSDK_OFFSET(0xC93FC80)
#define RPG_CLIENT_BATTLEUIUTILS_GETBATTLERESULAUTODECOMPOSEINFO_OFFSET UNITYSDK_OFFSET(0xC9411C0)
#define RPG_CLIENT_BATTLEUIUTILS_GETBATTLETARGETICONTYPE_OFFSET UNITYSDK_OFFSET(0xC943700)
#define RPG_CLIENT_BATTLEUIUTILS_GETBATTLETARGETSTATUS_OFFSET UNITYSDK_OFFSET(0xC943640)
#define RPG_CLIENT_BATTLEUIUTILS_GETCURBATTLESUBTARGET_OFFSET UNITYSDK_OFFSET(0xC943860)
#define RPG_CLIENT_BATTLEUIUTILS_GETCURRENTURNACTIONENTITY_OFFSET UNITYSDK_OFFSET(0xC93F3F0)
#define RPG_CLIENT_BATTLEUIUTILS_GETCURSTAGETYPE_OFFSET UNITYSDK_OFFSET(0xC942D50)
#define RPG_CLIENT_BATTLEUIUTILS_GETENTITYBYRUNTIMEID_OFFSET UNITYSDK_OFFSET(0xC943170)
#define RPG_CLIENT_BATTLEUIUTILS_GETMETRONOMETIME_OFFSET UNITYSDK_OFFSET(0xC940960)
#define RPG_CLIENT_BATTLEUIUTILS_GETMODELSCALE_OFFSET UNITYSDK_OFFSET(0xC945350)
#define RPG_CLIENT_BATTLEUIUTILS_GETSKILLTIPOFFSET_OFFSET UNITYSDK_OFFSET(0xC93FE50)
#define RPG_CLIENT_BATTLEUIUTILS_GETSPEEDUPRATIO_OFFSET UNITYSDK_OFFSET(0xC943530)
#define RPG_CLIENT_BATTLEUIUTILS_GETUINODE_OFFSET UNITYSDK_OFFSET(0xC9454D0)
#define RPG_CLIENT_BATTLEUIUTILS_GETULTRAUIOPERATIONINDEX_OFFSET UNITYSDK_OFFSET(0xC945FB0)
#define RPG_CLIENT_BATTLEUIUTILS_GET__LUA_BATTLE_PAUSE_DIALOG_NAME_OFFSET UNITYSDK_OFFSET(0xC93F2B0)
#define RPG_CLIENT_BATTLEUIUTILS_GET__LUA_BATTLE_TEAM_INFO_PAGE_NAME_OFFSET UNITYSDK_OFFSET(0xC945080)
#define RPG_CLIENT_BATTLEUIUTILS_ISACTIONBARCANSCROLL_OFFSET UNITYSDK_OFFSET(0xC940030)
#define RPG_CLIENT_BATTLEUIUTILS_ISBATTLETARGETFORWARD_OFFSET UNITYSDK_OFFSET(0xC9437D0)
#define RPG_CLIENT_BATTLEUIUTILS_ISENTITYHAVESHIELDBUFF_OFFSET UNITYSDK_OFFSET(0xC93E630)
#define RPG_CLIENT_BATTLEUIUTILS_ISENTITYNEEDSHOWINVIEWMODE_OFFSET UNITYSDK_OFFSET(0xC945A10)
#define RPG_CLIENT_BATTLEUIUTILS_ISENVBUFFEXIST_OFFSET UNITYSDK_OFFSET(0xC9427A0)
#define RPG_CLIENT_BATTLEUIUTILS_ISFAILPROGRESS_OFFSET UNITYSDK_OFFSET(0xC943D30)
#define RPG_CLIENT_BATTLEUIUTILS_ISGAMECORECODEEXPIRE_OFFSET UNITYSDK_OFFSET(0xC942280)
#define RPG_CLIENT_BATTLEUIUTILS_ISHPCHANGENEEDSHOW_OFFSET UNITYSDK_OFFSET(0xC943F80)
#define RPG_CLIENT_BATTLEUIUTILS_ISMONSTERBOUNDSCULLEDBYCAMERA_OFFSET UNITYSDK_OFFSET(0xC945640)
#define RPG_CLIENT_BATTLEUIUTILS_ISSHIELDCHANGENEEDSHOW_OFFSET UNITYSDK_OFFSET(0xC944630)
#define RPG_CLIENT_BATTLEUIUTILS_ISSHIELDMODIFIER_OFFSET UNITYSDK_OFFSET(0xC93E710)
#define RPG_CLIENT_BATTLEUIUTILS_ISSPEICALULTRASKILLTYPE_OFFSET UNITYSDK_OFFSET(0xC943130)
#define RPG_CLIENT_BATTLEUIUTILS_ISTARGETSTATUSCHANGE_OFFSET UNITYSDK_OFFSET(0xC943CD0)
#define RPG_CLIENT_BATTLEUIUTILS_ISTOASTPAUSE_OFFSET UNITYSDK_OFFSET(0xC943D80)
#define RPG_CLIENT_BATTLEUIUTILS_ISUIOPERATIONENABLE_OFFSET UNITYSDK_OFFSET(0xC93E770)
#define RPG_CLIENT_BATTLEUIUTILS_ISVIEWMODEENABLE_OFFSET UNITYSDK_OFFSET(0xC93EF90)
#define RPG_CLIENT_BATTLEUIUTILS_ISWAITORDER_OFFSET UNITYSDK_OFFSET(0xC940600)
#define RPG_CLIENT_BATTLEUIUTILS_LATEOPENPAUSEDIALOG_OFFSET UNITYSDK_OFFSET(0xC944A40)
#define RPG_CLIENT_BATTLEUIUTILS_OPENPAUSEDIALOG_OFFSET UNITYSDK_OFFSET(0xC9448C0)
#define RPG_CLIENT_BATTLEUIUTILS_PLAYANIMATIONFROMMETRONOMETIME_OFFSET UNITYSDK_OFFSET(0xC9409C0)
#define RPG_CLIENT_BATTLEUIUTILS_PLAYANIMATIONWITHSIMULATIONSPEED_OFFSET UNITYSDK_OFFSET(0xC9408A0)
#define RPG_CLIENT_BATTLEUIUTILS_PLAYANIMATIONWITHTIMESCALE_OFFSET UNITYSDK_OFFSET(0xC9407E0)
#define RPG_CLIENT_BATTLEUIUTILS_QUERYACTIVEAVATARPANELENTITIES_OFFSET UNITYSDK_OFFSET(0xC945B80)
#define RPG_CLIENT_BATTLEUIUTILS_QUERYENTITIES_OFFSET UNITYSDK_OFFSET(0xC945840)
#define RPG_CLIENT_BATTLEUIUTILS_QUERYSERVANT_OFFSET UNITYSDK_OFFSET(0xC945B10)
#define RPG_CLIENT_BATTLEUIUTILS_SETBATTLEPAUSE_OFFSET UNITYSDK_OFFSET(0xC945170)
#define RPG_CLIENT_BATTLEUIUTILS_SHOULDSHOWWAVEINFO_OFFSET UNITYSDK_OFFSET(0xC942F00)
#define RPG_CLIENT_BATTLEUIUTILS_SHOWTEAMDETAILDIALOG_1_OFFSET UNITYSDK_OFFSET(0xC93EB40)
#define RPG_CLIENT_BATTLEUIUTILS_SHOWTEAMDETAILDIALOG_OFFSET UNITYSDK_OFFSET(0xC93EA40)
#define RPG_CLIENT_BATTLEUIUTILS_TRYDOWNLOADREPLAY_OFFSET UNITYSDK_OFFSET(0xC942340)
#define RPG_CLIENT_BATTLEUIUTILS_TRYGETSTAGEINVASIONSTATUS_OFFSET UNITYSDK_OFFSET(0xC9432B0)
#define RPG_CLIENT_BATTLEUIUTILS_TRYPLAYREPLAY_OFFSET UNITYSDK_OFFSET(0xC941CE0)
#define RPG_CLIENT_BATTLEUIUTILS__CANENTITYSHOWAVATARPANEL_OFFSET UNITYSDK_OFFSET(0xC945DF0)
#define RPG_CLIENT_BATTLEUIUTILS__CANENTITYSHOWDAMAGETEXT_OFFSET UNITYSDK_OFFSET(0xC944200)
#define RPG_CLIENT_BATTLEUIUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0xC946080)
#define RPG_CLIENT_BATTLEUIUTILS__ENTITYHASSHIELD_OFFSET UNITYSDK_OFFSET(0xC944280)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleUIUtils_TypeDefinitionIndex = 72006;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::Class_1_8654F1DF226F6DE3_2*>**)Il2CppClass::FromTypeDefinitionIndex(BattleUIUtils_TypeDefinitionIndex)->GetStaticField(0x107C0);
		}
		static ::System::Boolean* StaticGet_LockDownLoadReplayFlag()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(BattleUIUtils_TypeDefinitionIndex)->GetStaticField(0x75B0);
		}
		static ::System::UInt32* StaticGet_s_AvatarExpVirtualItemID()
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(BattleUIUtils_TypeDefinitionIndex)->GetStaticField(0x75B4);
		}
