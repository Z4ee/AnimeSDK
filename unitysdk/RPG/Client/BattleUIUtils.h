...
#define RPG_CLIENT_BATTLEUIUTILS_CANOPENTIMELINEDETAILINFOPANEL_1_OFFSET UNITYSDK_OFFSET(0x19FC4430)
#define RPG_CLIENT_BATTLEUIUTILS_CANOPENTIMELINEDETAILINFOPANEL_OFFSET UNITYSDK_OFFSET(0x19FC4340)
#define RPG_CLIENT_BATTLEUIUTILS_CHECKPENDINGDOWNLOADREPLAYTOPLAY_OFFSET UNITYSDK_OFFSET(0x19FC5AC0)
#define RPG_CLIENT_BATTLEUIUTILS_CREATEBATTLERESULTREWARDLIST_OFFSET UNITYSDK_OFFSET(0x19FC5280)
#define RPG_CLIENT_BATTLEUIUTILS_CREATEMAZESKILLREWARDLISTFROMRESULT_OFFSET UNITYSDK_OFFSET(0x19FC4EE0)
#define RPG_CLIENT_BATTLEUIUTILS_CREATEMULTIPLEREWARDLISTFROMRESULT_OFFSET UNITYSDK_OFFSET(0x19FC59E0)
#define RPG_CLIENT_BATTLEUIUTILS_CREATEREWARDLISTFROMRESULT_OFFSET UNITYSDK_OFFSET(0x19FB9BD0)
#define RPG_CLIENT_BATTLEUIUTILS_FINDBYRUNTIMEID_OFFSET UNITYSDK_OFFSET(0x19FC4B60)
#define RPG_CLIENT_BATTLEUIUTILS_GETACTIVESKILLCONFIG_OFFSET UNITYSDK_OFFSET(0x19FC36C0)
#define RPG_CLIENT_BATTLEUIUTILS_GETACTIVESKILLDAMAGETYPE_OFFSET UNITYSDK_OFFSET(0x19FC3980)
#define RPG_CLIENT_BATTLEUIUTILS_GETACTIVESKILLDATA_OFFSET UNITYSDK_OFFSET(0x19FC3820)
#define RPG_CLIENT_BATTLEUIUTILS_GETACTIVESKILLINDEX_OFFSET UNITYSDK_OFFSET(0x19FC3570)
#define RPG_CLIENT_BATTLEUIUTILS_GETALLAVATARGLOBALMAZEBUFFDATALIST_OFFSET UNITYSDK_OFFSET(0x19FC7280)
#define RPG_CLIENT_BATTLEUIUTILS_GETATTACHPRESHOWSKILLDAMAGETYPE_OFFSET UNITYSDK_OFFSET(0x19FC3C80)
#define RPG_CLIENT_BATTLEUIUTILS_GETBATTLERESULAUTODECOMPOSEINFO_OFFSET UNITYSDK_OFFSET(0x19FC51B0)
#define RPG_CLIENT_BATTLEUIUTILS_GETBATTLETARGETICONTYPE_OFFSET UNITYSDK_OFFSET(0x19FC7570)
#define RPG_CLIENT_BATTLEUIUTILS_GETBATTLETARGETSTATUS_OFFSET UNITYSDK_OFFSET(0x19FC74B0)
#define RPG_CLIENT_BATTLEUIUTILS_GETCURBATTLESUBTARGET_OFFSET UNITYSDK_OFFSET(0x19FC76D0)
#define RPG_CLIENT_BATTLEUIUTILS_GETCURRENTURNACTIONENTITY_OFFSET UNITYSDK_OFFSET(0x19FC3410)
#define RPG_CLIENT_BATTLEUIUTILS_GETCURSTAGETYPE_OFFSET UNITYSDK_OFFSET(0x19FC6D30)
#define RPG_CLIENT_BATTLEUIUTILS_GETENTITYBYRUNTIMEID_OFFSET UNITYSDK_OFFSET(0x19FC7140)
#define RPG_CLIENT_BATTLEUIUTILS_GETMETRONOMETIME_OFFSET UNITYSDK_OFFSET(0x19FC4950)
#define RPG_CLIENT_BATTLEUIUTILS_GETMODELSCALE_OFFSET UNITYSDK_OFFSET(0x19FC91C0)
#define RPG_CLIENT_BATTLEUIUTILS_GETSKILLTIPOFFSET_OFFSET UNITYSDK_OFFSET(0x19FC3E50)
#define RPG_CLIENT_BATTLEUIUTILS_GETSPEEDUPRATIO_OFFSET UNITYSDK_OFFSET(0x19FC73A0)
#define RPG_CLIENT_BATTLEUIUTILS_GETUINODE_OFFSET UNITYSDK_OFFSET(0x19FC9330)
#define RPG_CLIENT_BATTLEUIUTILS_GETULTRAUIOPERATIONINDEX_OFFSET UNITYSDK_OFFSET(0x19FC9E00)
#define RPG_CLIENT_BATTLEUIUTILS_GET__LUA_BATTLE_PAUSE_DIALOG_NAME_OFFSET UNITYSDK_OFFSET(0x19FC32D0)
#define RPG_CLIENT_BATTLEUIUTILS_GET__LUA_BATTLE_TEAM_INFO_PAGE_NAME_OFFSET UNITYSDK_OFFSET(0x19FC8EF0)
#define RPG_CLIENT_BATTLEUIUTILS_ISACTIONBARCANSCROLL_OFFSET UNITYSDK_OFFSET(0x19FC4030)
#define RPG_CLIENT_BATTLEUIUTILS_ISBATTLETARGETFORWARD_OFFSET UNITYSDK_OFFSET(0x19FC7640)
#define RPG_CLIENT_BATTLEUIUTILS_ISENTITYHAVESHIELDBUFF_OFFSET UNITYSDK_OFFSET(0x19FC2920)
#define RPG_CLIENT_BATTLEUIUTILS_ISENTITYNEEDSHOWINVIEWMODE_OFFSET UNITYSDK_OFFSET(0x19FC9870)
#define RPG_CLIENT_BATTLEUIUTILS_ISENVBUFFEXIST_OFFSET UNITYSDK_OFFSET(0x19FC6790)
#define RPG_CLIENT_BATTLEUIUTILS_ISFAILPROGRESS_OFFSET UNITYSDK_OFFSET(0x19FC7BA0)
#define RPG_CLIENT_BATTLEUIUTILS_ISGAMECORECODEEXPIRE_OFFSET UNITYSDK_OFFSET(0x19FC6270)
#define RPG_CLIENT_BATTLEUIUTILS_ISHPCHANGENEEDSHOW_OFFSET UNITYSDK_OFFSET(0x19FC7DF0)
#define RPG_CLIENT_BATTLEUIUTILS_ISMONSTERBOUNDSCULLEDBYCAMERA_OFFSET UNITYSDK_OFFSET(0x19FC94A0)
#define RPG_CLIENT_BATTLEUIUTILS_ISSHIELDCHANGENEEDSHOW_OFFSET UNITYSDK_OFFSET(0x19FC84A0)
#define RPG_CLIENT_BATTLEUIUTILS_ISSHIELDMODIFIER_OFFSET UNITYSDK_OFFSET(0x19FC2A00)
#define RPG_CLIENT_BATTLEUIUTILS_ISSPEICALULTRASKILLTYPE_OFFSET UNITYSDK_OFFSET(0x19FC7100)
#define RPG_CLIENT_BATTLEUIUTILS_ISTARGETSTATUSCHANGE_OFFSET UNITYSDK_OFFSET(0x19FC7B40)
#define RPG_CLIENT_BATTLEUIUTILS_ISTOASTPAUSE_OFFSET UNITYSDK_OFFSET(0x19FC7BF0)
#define RPG_CLIENT_BATTLEUIUTILS_ISUIOPERATIONENABLE_OFFSET UNITYSDK_OFFSET(0x19FB2E40)
#define RPG_CLIENT_BATTLEUIUTILS_ISVIEWMODEENABLE_OFFSET UNITYSDK_OFFSET(0x19FC2FB0)
#define RPG_CLIENT_BATTLEUIUTILS_ISWAITORDER_OFFSET UNITYSDK_OFFSET(0x19FC4600)
#define RPG_CLIENT_BATTLEUIUTILS_LATEOPENPAUSEDIALOG_OFFSET UNITYSDK_OFFSET(0x19FC88B0)
#define RPG_CLIENT_BATTLEUIUTILS_OPENPAUSEDIALOG_OFFSET UNITYSDK_OFFSET(0x19FC8730)
#define RPG_CLIENT_BATTLEUIUTILS_PLAYANIMATIONFROMMETRONOMETIME_OFFSET UNITYSDK_OFFSET(0x19FC49B0)
#define RPG_CLIENT_BATTLEUIUTILS_PLAYANIMATIONWITHSIMULATIONSPEED_OFFSET UNITYSDK_OFFSET(0x19FC4890)
#define RPG_CLIENT_BATTLEUIUTILS_PLAYANIMATIONWITHTIMESCALE_OFFSET UNITYSDK_OFFSET(0x19FC47D0)
#define RPG_CLIENT_BATTLEUIUTILS_QUERYACTIVEAVATARPANELENTITIES_OFFSET UNITYSDK_OFFSET(0x19FC99E0)
#define RPG_CLIENT_BATTLEUIUTILS_QUERYENTITIES_OFFSET UNITYSDK_OFFSET(0x19FC96A0)
#define RPG_CLIENT_BATTLEUIUTILS_QUERYSERVANT_OFFSET UNITYSDK_OFFSET(0x19FC9970)
#define RPG_CLIENT_BATTLEUIUTILS_SETBATTLEPAUSE_OFFSET UNITYSDK_OFFSET(0x19FC8FE0)
#define RPG_CLIENT_BATTLEUIUTILS_SHOULDSHOWWAVEINFO_OFFSET UNITYSDK_OFFSET(0x19FC6EE0)
#define RPG_CLIENT_BATTLEUIUTILS_SHOWTEAMDETAILDIALOG_1_OFFSET UNITYSDK_OFFSET(0x19FC2B60)
#define RPG_CLIENT_BATTLEUIUTILS_SHOWTEAMDETAILDIALOG_OFFSET UNITYSDK_OFFSET(0x19FC2A60)
#define RPG_CLIENT_BATTLEUIUTILS_TRYDOWNLOADREPLAY_OFFSET UNITYSDK_OFFSET(0x19FC6330)
#define RPG_CLIENT_BATTLEUIUTILS_TRYPLAYREPLAY_OFFSET UNITYSDK_OFFSET(0x19FC5CD0)
#define RPG_CLIENT_BATTLEUIUTILS__CANENTITYSHOWAVATARPANEL_OFFSET UNITYSDK_OFFSET(0x19FC9C50)
#define RPG_CLIENT_BATTLEUIUTILS__CANENTITYSHOWDAMAGETEXT_OFFSET UNITYSDK_OFFSET(0x19FC8070)
#define RPG_CLIENT_BATTLEUIUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0x19FC9ED0)
#define RPG_CLIENT_BATTLEUIUTILS__ENTITYHASSHIELD_OFFSET UNITYSDK_OFFSET(0x19FC80F0)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleUIUtils_TypeDefinitionIndex = 68807;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::Class_1_8654F1DF226F6DE3_2*>**)Il2CppClass::FromTypeDefinitionIndex(BattleUIUtils_TypeDefinitionIndex)->GetStaticField(0x5D8D0);
		}
		static ::System::UInt32* StaticGet_s_AvatarExpVirtualItemID()
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(BattleUIUtils_TypeDefinitionIndex)->GetStaticField(0xF690);
		}
		static ::System::Boolean* StaticGet_LockDownLoadReplayFlag()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(BattleUIUtils_TypeDefinitionIndex)->GetStaticField(0xF694);
		}
