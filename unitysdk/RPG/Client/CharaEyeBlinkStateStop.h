...
#define RPG_CLIENT_CHARAEYEBLINKSTATESTOP_METHOD_1_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0x9F653A0)
#define RPG_CLIENT_CHARAEYEBLINKSTATESTOP_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x9F65430)
#define RPG_CLIENT_CHARAEYEBLINKSTATESTOP_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x9F653F0)
#define RPG_CLIENT_CHARAEYEBLINKSTATESTOP_TICK_OFFSET UNITYSDK_OFFSET(0x9F65470)
#define RPG_CLIENT_CHARAEYEBLINKSTATESTOP__CTOR_OFFSET UNITYSDK_OFFSET(0x9F654D0)

namespace RPG::Client
{
	inline static constexpr unsigned int CharaEyeBlinkStateStop_TypeDefinitionIndex = 63044;
