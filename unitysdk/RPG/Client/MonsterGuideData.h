...
#define RPG_CLIENT_MONSTERGUIDEDATA_GETAVAILABLETAGLIST_OFFSET UNITYSDK_OFFSET(0x1955A600)
#define RPG_CLIENT_MONSTERGUIDEDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0x1955A140)
#define RPG_CLIENT_MONSTERGUIDEDATA_GET_PHASELIST_OFFSET UNITYSDK_OFFSET(0x1955A180)
#define RPG_CLIENT_MONSTERGUIDEDATA_GET_ROW_OFFSET UNITYSDK_OFFSET(0x1955A1A0)
#define RPG_CLIENT_MONSTERGUIDEDATA_GET_TAGLIST_OFFSET UNITYSDK_OFFSET(0x1955A160)
#define RPG_CLIENT_MONSTERGUIDEDATA_INITPHASEDATA_OFFSET UNITYSDK_OFFSET(0x1955A410)
#define RPG_CLIENT_MONSTERGUIDEDATA_INITTAGDATA_OFFSET UNITYSDK_OFFSET(0x1955A220)
#define RPG_CLIENT_MONSTERGUIDEDATA_SET_ID_OFFSET UNITYSDK_OFFSET(0x1955A150)
#define RPG_CLIENT_MONSTERGUIDEDATA_SET_PHASELIST_OFFSET UNITYSDK_OFFSET(0x1955A190)
#define RPG_CLIENT_MONSTERGUIDEDATA_SET_ROW_OFFSET UNITYSDK_OFFSET(0x1955A1B0)
#define RPG_CLIENT_MONSTERGUIDEDATA_SET_TAGLIST_OFFSET UNITYSDK_OFFSET(0x1955A170)
#define RPG_CLIENT_MONSTERGUIDEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1955A1C0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonsterGuideData_TypeDefinitionIndex = 60359;
	...
	public:
		...
		::RPG::GameCore::MonsterGuideConfigRow* _Row_k__BackingField; // 0x20
