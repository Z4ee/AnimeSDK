...
#define RPG_CLIENT_CHARAEYEBLINKSTATEVOICELOUDNESS_METHOD_1_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0xB57E5C0)
#define RPG_CLIENT_CHARAEYEBLINKSTATEVOICELOUDNESS_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xB57E650)
#define RPG_CLIENT_CHARAEYEBLINKSTATEVOICELOUDNESS_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xB57E610)
#define RPG_CLIENT_CHARAEYEBLINKSTATEVOICELOUDNESS_TICK_OFFSET UNITYSDK_OFFSET(0xB57E6A0)
#define RPG_CLIENT_CHARAEYEBLINKSTATEVOICELOUDNESS__CTOR_OFFSET UNITYSDK_OFFSET(0xB57E740)

namespace RPG::Client
{
	inline static constexpr unsigned int CharaEyeBlinkStateVoiceLoudness_TypeDefinitionIndex = 63961;
