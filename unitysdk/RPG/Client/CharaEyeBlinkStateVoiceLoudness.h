...
#define RPG_CLIENT_CHARAEYEBLINKSTATEVOICELOUDNESS_METHOD_1_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0xCAC2CD0)
#define RPG_CLIENT_CHARAEYEBLINKSTATEVOICELOUDNESS_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xCAC2D60)
#define RPG_CLIENT_CHARAEYEBLINKSTATEVOICELOUDNESS_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xCAC2D20)
#define RPG_CLIENT_CHARAEYEBLINKSTATEVOICELOUDNESS_TICK_OFFSET UNITYSDK_OFFSET(0xCAC2DB0)
#define RPG_CLIENT_CHARAEYEBLINKSTATEVOICELOUDNESS__CTOR_OFFSET UNITYSDK_OFFSET(0xCAC2E50)
