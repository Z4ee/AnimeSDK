...
#define RPG_CLIENT_CHARAEYEBLINKSTATEVOICELOUDNESS_METHOD_1_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0x191FEEE0)
#define RPG_CLIENT_CHARAEYEBLINKSTATEVOICELOUDNESS_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x191FEF70)
#define RPG_CLIENT_CHARAEYEBLINKSTATEVOICELOUDNESS_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x191FEF30)
#define RPG_CLIENT_CHARAEYEBLINKSTATEVOICELOUDNESS_TICK_OFFSET UNITYSDK_OFFSET(0x191FEFC0)
#define RPG_CLIENT_CHARAEYEBLINKSTATEVOICELOUDNESS__CTOR_OFFSET UNITYSDK_OFFSET(0x191FF060)

namespace RPG::Client
{
	inline static constexpr unsigned int CharaEyeBlinkStateVoiceLoudness_TypeDefinitionIndex = 65332;
