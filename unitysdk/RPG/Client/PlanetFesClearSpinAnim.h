...
#define RPG_CLIENT_PLANETFESCLEARSPINANIM_METHOD_3_72720FDFF0A55CAD_OFFSET UNITYSDK_OFFSET(0x185EBEA0)
#define RPG_CLIENT_PLANETFESCLEARSPINANIM_METHOD_3_F462F47445B9BF39_OFFSET UNITYSDK_OFFSET(0x185EBD90)
#define RPG_CLIENT_PLANETFESCLEARSPINANIM__CTOR_OFFSET UNITYSDK_OFFSET(0x185EBE70)

namespace RPG::Client
{
	inline static constexpr unsigned int PlanetFesClearSpinAnim_TypeDefinitionIndex = 10150;
