...
#define RPG_CLIENT_PLANETFESCLEARSPINANIM_METHOD_3_480D0526B71EA870_OFFSET UNITYSDK_OFFSET(0x1D312C30)
#define RPG_CLIENT_PLANETFESCLEARSPINANIM_METHOD_3_72720FDFF0A55CAD_OFFSET UNITYSDK_OFFSET(0x1D312D00)
#define RPG_CLIENT_PLANETFESCLEARSPINANIM__CTOR_OFFSET UNITYSDK_OFFSET(0x1D312CF0)

namespace RPG::Client
{
	inline static constexpr unsigned int PlanetFesClearSpinAnim_TypeDefinitionIndex = 10266;
