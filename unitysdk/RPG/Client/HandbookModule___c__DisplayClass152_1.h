...
#define RPG_CLIENT_HANDBOOKMODULE___C__DISPLAYCLASS152_1__CTOR_OFFSET UNITYSDK_OFFSET(0xBCFE7C0)
#define RPG_CLIENT_HANDBOOKMODULE___C__DISPLAYCLASS152_1__GOTOTOGUIDEROGUETOURNENTRANCE_B__1_OFFSET UNITYSDK_OFFSET(0xBCFE7D0)

namespace RPG::Client
{
	inline static constexpr unsigned int HandbookModule___c__DisplayClass152_1_TypeDefinitionIndex = 61367;
