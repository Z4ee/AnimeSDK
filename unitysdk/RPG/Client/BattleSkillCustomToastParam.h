...
#define RPG_CLIENT_BATTLESKILLCUSTOMTOASTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x91D5590)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleSkillCustomToastParam_TypeDefinitionIndex = 58919;
