...
#define RPG_CLIENT_BATTLESKILLCUSTOMTOASTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xC93A250)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleSkillCustomToastParam_TypeDefinitionIndex = 71884;
