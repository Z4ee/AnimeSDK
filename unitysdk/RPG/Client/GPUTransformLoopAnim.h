...
#define RPG_CLIENT_GPUTRANSFORMLOOPANIM_BAKEBEZIERCURVEDRAWMODE_OFFSET UNITYSDK_OFFSET(0x19395270)
#define RPG_CLIENT_GPUTRANSFORMLOOPANIM_GET_ARTBOUNDFULL_OFFSET UNITYSDK_OFFSET(0x19395EF0)
#define RPG_CLIENT_GPUTRANSFORMLOOPANIM_GET_ARTBOUND_OFFSET UNITYSDK_OFFSET(0x19396740)
#define RPG_CLIENT_GPUTRANSFORMLOOPANIM_GET_BAKETEXTURE_OFFSET UNITYSDK_OFFSET(0x19395210)
#define RPG_CLIENT_GPUTRANSFORMLOOPANIM_GET_RENDERBUDGETDATA_OFFSET UNITYSDK_OFFSET(0x193967F0)
#define RPG_CLIENT_GPUTRANSFORMLOOPANIM_GET_RENDERINSTANCECOLLECTMODE_OFFSET UNITYSDK_OFFSET(0x19396D50)
#define RPG_CLIENT_GPUTRANSFORMLOOPANIM_METHOD_7_193B69F9A0A775CE_OFFSET UNITYSDK_OFFSET(0x193952B0)
#define RPG_CLIENT_GPUTRANSFORMLOOPANIM__CTOR_OFFSET UNITYSDK_OFFSET(0x19396D60)

namespace RPG::Client
{
	inline static constexpr unsigned int GPUTransformLoopAnim_TypeDefinitionIndex = 70286;
	...
	public:
		...
		{
			return ((::Class_0_16E4307DCC419505_1028_ERenderInstanceCollectMode(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_GPUTRANSFORMLOOPANIM_GET_RENDERINSTANCECOLLECTMODE_OFFSET))(this);
		}
	};
}
