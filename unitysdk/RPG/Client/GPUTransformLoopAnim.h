...
#define RPG_CLIENT_GPUTRANSFORMLOOPANIM_BAKEBEZIERCURVEDRAWMODE_OFFSET UNITYSDK_OFFSET(0xD0EE490)
#define RPG_CLIENT_GPUTRANSFORMLOOPANIM_GET_ARTBOUNDFULL_OFFSET UNITYSDK_OFFSET(0xD0EF110)
#define RPG_CLIENT_GPUTRANSFORMLOOPANIM_GET_ARTBOUND_OFFSET UNITYSDK_OFFSET(0xD0EF960)
#define RPG_CLIENT_GPUTRANSFORMLOOPANIM_GET_BAKETEXTURE_OFFSET UNITYSDK_OFFSET(0xD0EE430)
#define RPG_CLIENT_GPUTRANSFORMLOOPANIM_GET_RENDERBUDGETDATA_OFFSET UNITYSDK_OFFSET(0xD0EFA10)
#define RPG_CLIENT_GPUTRANSFORMLOOPANIM_GET_RENDERINSTANCECOLLECTMODE_OFFSET UNITYSDK_OFFSET(0xD0EFF70)
#define RPG_CLIENT_GPUTRANSFORMLOOPANIM_METHOD_7_193B69F9A0A775CE_OFFSET UNITYSDK_OFFSET(0xD0EE4D0)
#define RPG_CLIENT_GPUTRANSFORMLOOPANIM__CTOR_OFFSET UNITYSDK_OFFSET(0xD0EFF80)
