...
#define RPG_CLIENT_MONOWOLFBROBOSSCUSTOMDATA_GETHP_OFFSET UNITYSDK_OFFSET(0xAA123A0)
#define RPG_CLIENT_MONOWOLFBROBOSSCUSTOMDATA_LOSSHP_OFFSET UNITYSDK_OFFSET(0xAA123E0)
#define RPG_CLIENT_MONOWOLFBROBOSSCUSTOMDATA_ONBEINVALIDHIT_OFFSET UNITYSDK_OFFSET(0xAA12460)
#define RPG_CLIENT_MONOWOLFBROBOSSCUSTOMDATA_ONENABLE_OFFSET UNITYSDK_OFFSET(0xAA12350)
#define RPG_CLIENT_MONOWOLFBROBOSSCUSTOMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xAA124E0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoWolfBroBossCustomData_TypeDefinitionIndex = 63293;
