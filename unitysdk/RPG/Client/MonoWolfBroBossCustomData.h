...
#define RPG_CLIENT_MONOWOLFBROBOSSCUSTOMDATA_GETHP_OFFSET UNITYSDK_OFFSET(0x1A367E30)
#define RPG_CLIENT_MONOWOLFBROBOSSCUSTOMDATA_LOSSHP_OFFSET UNITYSDK_OFFSET(0x1A367E70)
#define RPG_CLIENT_MONOWOLFBROBOSSCUSTOMDATA_ONBEINVALIDHIT_OFFSET UNITYSDK_OFFSET(0x1A367EF0)
#define RPG_CLIENT_MONOWOLFBROBOSSCUSTOMDATA_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A367DE0)
#define RPG_CLIENT_MONOWOLFBROBOSSCUSTOMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A367F70)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoWolfBroBossCustomData_TypeDefinitionIndex = 65581;
