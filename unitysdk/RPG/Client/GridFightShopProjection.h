...
#define RPG_CLIENT_GRIDFIGHTSHOPPROJECTION_GET_DESC_OFFSET UNITYSDK_OFFSET(0x1C5B1C80)
#define RPG_CLIENT_GRIDFIGHTSHOPPROJECTION_GET_GOODTYPE_OFFSET UNITYSDK_OFFSET(0x1C5B25A0)
#define RPG_CLIENT_GRIDFIGHTSHOPPROJECTION_GET_ID_OFFSET UNITYSDK_OFFSET(0x1C5B1A50)
#define RPG_CLIENT_GRIDFIGHTSHOPPROJECTION_GET_NAMETEXTID_OFFSET UNITYSDK_OFFSET(0x1C5B1BC0)
#define RPG_CLIENT_GRIDFIGHTSHOPPROJECTION_GET_OWNED_OFFSET UNITYSDK_OFFSET(0x1C5B1ED0)
#define RPG_CLIENT_GRIDFIGHTSHOPPROJECTION_GET_PRESETTYPE_OFFSET UNITYSDK_OFFSET(0x1C5B2470)
#define RPG_CLIENT_GRIDFIGHTSHOPPROJECTION_GET_PROJECTION_OFFSET UNITYSDK_OFFSET(0x1C5B1AA0)
#define RPG_CLIENT_GRIDFIGHTSHOPPROJECTION_GET_RARITY_OFFSET UNITYSDK_OFFSET(0x1C5B1B30)
#define RPG_CLIENT_GRIDFIGHTSHOPPROJECTION_GET_ROLECONFIG_OFFSET UNITYSDK_OFFSET(0x1C5B1AB0)
#define RPG_CLIENT_GRIDFIGHTSHOPPROJECTION_GET_SHOPICON_OFFSET UNITYSDK_OFFSET(0x1C5B2390)
#define RPG_CLIENT_GRIDFIGHTSHOPPROJECTION_GET_TRAITS_OFFSET UNITYSDK_OFFSET(0x1C5B1CE0)
#define RPG_CLIENT_GRIDFIGHTSHOPPROJECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5B1780)
...
namespace RPG::Client
{
	...
	{
	public:
		::RPG::Client::GridFightProjection* _Projection_k__BackingField; // 0x20
		::Class_1_D17272E82AE804C2_435* _ProtoGoodsProjection; // 0x28
