...
class Class_2_70D507E43F3FAFF3;
...
#define RPG_CLIENT_MONOEFFECTPLUGINMULTICRPVCAMERA_AWAKEPLUGIN_OFFSET UNITYSDK_OFFSET(0x9CD49C0)
#define RPG_CLIENT_MONOEFFECTPLUGINMULTICRPVCAMERA_DESTROYPLUGIN_OFFSET UNITYSDK_OFFSET(0x9CD4A90)
#define RPG_CLIENT_MONOEFFECTPLUGINMULTICRPVCAMERA_DISABLEPLUGIN_OFFSET UNITYSDK_OFFSET(0x9CD4BB0)
#define RPG_CLIENT_MONOEFFECTPLUGINMULTICRPVCAMERA_DISPOSEPLUGIN_OFFSET UNITYSDK_OFFSET(0x9CD48F0)
#define RPG_CLIENT_MONOEFFECTPLUGINMULTICRPVCAMERA_ENABLEPLUGIN_OFFSET UNITYSDK_OFFSET(0x9CD4B40)
#define RPG_CLIENT_MONOEFFECTPLUGINMULTICRPVCAMERA_ENDOFLATETICK_OFFSET UNITYSDK_OFFSET(0x9CD4CC0)
#define RPG_CLIENT_MONOEFFECTPLUGINMULTICRPVCAMERA_GET_BEHAVIOR_OFFSET UNITYSDK_OFFSET(0x9CD4D30)
#define RPG_CLIENT_MONOEFFECTPLUGINMULTICRPVCAMERA_IGNOREINEDITOR_OFFSET UNITYSDK_OFFSET(0x9CD47C0)
#define RPG_CLIENT_MONOEFFECTPLUGINMULTICRPVCAMERA_RESETPLUGIN_OFFSET UNITYSDK_OFFSET(0x9CD4800)
#define RPG_CLIENT_MONOEFFECTPLUGINMULTICRPVCAMERA_TICK_OFFSET UNITYSDK_OFFSET(0x9CD4C30)
#define RPG_CLIENT_MONOEFFECTPLUGINMULTICRPVCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x9CD4D40)
#define RPG_CLIENT_MONOEFFECTPLUGINMULTICRPVCAMERA___IFIXBASEPROXY_AWAKEPLUGIN_OFFSET UNITYSDK_OFFSET(0x9CD5050)
#define RPG_CLIENT_MONOEFFECTPLUGINMULTICRPVCAMERA___IFIXBASEPROXY_DESTROYPLUGIN_OFFSET UNITYSDK_OFFSET(0x9CD50B0)
#define RPG_CLIENT_MONOEFFECTPLUGINMULTICRPVCAMERA___IFIXBASEPROXY_DISABLEPLUGIN_OFFSET UNITYSDK_OFFSET(0x9CD5170)
#define RPG_CLIENT_MONOEFFECTPLUGINMULTICRPVCAMERA___IFIXBASEPROXY_ENABLEPLUGIN_OFFSET UNITYSDK_OFFSET(0x9CD5110)
#define RPG_CLIENT_MONOEFFECTPLUGINMULTICRPVCAMERA___IFIXBASEPROXY_ENDOFLATETICK_OFFSET UNITYSDK_OFFSET(0x9CD5240)
#define RPG_CLIENT_MONOEFFECTPLUGINMULTICRPVCAMERA___IFIXBASEPROXY_IGNOREINEDITOR_OFFSET UNITYSDK_OFFSET(0x9CD4FE0)
#define RPG_CLIENT_MONOEFFECTPLUGINMULTICRPVCAMERA___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x9CD51D0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginMultiCRPVCamera_TypeDefinitionIndex = 57348;
	...
	public:
		...
		::Class_2_70D507E43F3FAFF3* Field_6_18; // 0xB0
		...
		::Class_2_70D507E43F3FAFF3* get_Behavior()
		{
			return ((::Class_2_70D507E43F3FAFF3*(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_MONOEFFECTPLUGINMULTICRPVCAMERA_GET_BEHAVIOR_OFFSET))(this);
		}
