...
#define RPG_CLIENT_CHENLINGPREPARECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CB21320)

namespace RPG::Client
{
	inline static constexpr unsigned int ChenLingPrepareConfig_TypeDefinitionIndex = 72393;
