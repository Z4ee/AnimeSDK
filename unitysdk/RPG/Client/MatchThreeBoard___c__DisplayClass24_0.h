...
#define RPG_CLIENT_MATCHTHREEBOARD___C__DISPLAYCLASS24_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A88EB50)
#define RPG_CLIENT_MATCHTHREEBOARD___C__DISPLAYCLASS24_0__PLAYENEMYSWITCHTIPEFFECT_B__0_OFFSET UNITYSDK_OFFSET(0x1A896EE0)
#define RPG_CLIENT_MATCHTHREEBOARD___C__DISPLAYCLASS24_0__PLAYENEMYSWITCHTIPEFFECT_B__1_OFFSET UNITYSDK_OFFSET(0x1A896F00)

namespace RPG::Client
{
	inline static constexpr unsigned int MatchThreeBoard___c__DisplayClass24_0_TypeDefinitionIndex = 62968;

	class MatchThreeBoard___c__DisplayClass24_0 : public ::System::Object
	{
	public:
		::System::Action* onFinish; // 0x10
		::RPG::Client::MatchThreeEnemySwitchTipEffect* effect; // 0x18
