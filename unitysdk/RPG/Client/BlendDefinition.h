...
#define RPG_CLIENT_BLENDDEFINITION__CTOR_OFFSET UNITYSDK_OFFSET(0xB438CA0)

namespace RPG::Client
{
	inline static constexpr unsigned int BlendDefinition_TypeDefinitionIndex = 64995;
