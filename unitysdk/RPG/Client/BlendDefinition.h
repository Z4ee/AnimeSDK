...
#define RPG_CLIENT_BLENDDEFINITION__CTOR_OFFSET UNITYSDK_OFFSET(0x19FE1270)

namespace RPG::Client
{
	inline static constexpr unsigned int BlendDefinition_TypeDefinitionIndex = 66400;
