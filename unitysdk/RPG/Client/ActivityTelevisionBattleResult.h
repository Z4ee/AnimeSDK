...
class Class_1_C66F08F6BAF5805C_6;
namespace RPG::Client { class RogueEndlessBattleResult; }

#define RPG_CLIENT_ACTIVITYTELEVISIONBATTLERESULT_CLONE_OFFSET UNITYSDK_OFFSET(0x8FC55F0)
#define RPG_CLIENT_ACTIVITYTELEVISIONBATTLERESULT_CREATE_OFFSET UNITYSDK_OFFSET(0x8FC5530)
#define RPG_CLIENT_ACTIVITYTELEVISIONBATTLERESULT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8FC5660)
#define RPG_CLIENT_ACTIVITYTELEVISIONBATTLERESULT_GET_BASESCORE_OFFSET UNITYSDK_OFFSET(0x8FC5700)
#define RPG_CLIENT_ACTIVITYTELEVISIONBATTLERESULT_GET_BUFFLAYER_OFFSET UNITYSDK_OFFSET(0x8FC5770)
#define RPG_CLIENT_ACTIVITYTELEVISIONBATTLERESULT_GET_EXTRASCORE_OFFSET UNITYSDK_OFFSET(0x8FC56E0)
#define RPG_CLIENT_ACTIVITYTELEVISIONBATTLERESULT_GET_ISNEWSCORERECORD_OFFSET UNITYSDK_OFFSET(0x8FC5790)
#define RPG_CLIENT_ACTIVITYTELEVISIONBATTLERESULT_GET_LEFTROUNDCNT_OFFSET UNITYSDK_OFFSET(0x8FC5750)
#define RPG_CLIENT_ACTIVITYTELEVISIONBATTLERESULT_GET_MAXSCORE_OFFSET UNITYSDK_OFFSET(0x8FC56A0)
#define RPG_CLIENT_ACTIVITYTELEVISIONBATTLERESULT_GET_TOTALSCORE_OFFSET UNITYSDK_OFFSET(0x8FC56C0)
#define RPG_CLIENT_ACTIVITYTELEVISIONBATTLERESULT_SET_BUFFLAYER_OFFSET UNITYSDK_OFFSET(0x8FC5780)
#define RPG_CLIENT_ACTIVITYTELEVISIONBATTLERESULT_SET_EXTRASCORE_OFFSET UNITYSDK_OFFSET(0x8FC56F0)
#define RPG_CLIENT_ACTIVITYTELEVISIONBATTLERESULT_SET_ISNEWSCORERECORD_OFFSET UNITYSDK_OFFSET(0x8FC57A0)
#define RPG_CLIENT_ACTIVITYTELEVISIONBATTLERESULT_SET_LEFTROUNDCNT_OFFSET UNITYSDK_OFFSET(0x8FC5760)
#define RPG_CLIENT_ACTIVITYTELEVISIONBATTLERESULT_SET_MAXSCORE_OFFSET UNITYSDK_OFFSET(0x8FC56B0)
#define RPG_CLIENT_ACTIVITYTELEVISIONBATTLERESULT_SET_TOTALSCORE_OFFSET UNITYSDK_OFFSET(0x8FC56D0)
#define RPG_CLIENT_ACTIVITYTELEVISIONBATTLERESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x8FC55E0)

namespace RPG::Client
{
	inline static constexpr unsigned int ActivityTelevisionBattleResult_TypeDefinitionIndex = 50329;
	...
	public:
		...
		::System::UInt32 _ExtraScore_k__BackingField; // 0x20
		...
		static ::RPG::Client::ActivityTelevisionBattleResult* Create(::Class_1_C66F08F6BAF5805C_6* ntf, ::System::UInt32 BaseMaxScore)
		{
			return ((::RPG::Client::ActivityTelevisionBattleResult*(*)(::Class_1_C66F08F6BAF5805C_6*, ::System::UInt32))((::PBYTE)hIl2Cpp + RPG_CLIENT_ACTIVITYTELEVISIONBATTLERESULT_CREATE_OFFSET))(ntf, BaseMaxScore);
		}
