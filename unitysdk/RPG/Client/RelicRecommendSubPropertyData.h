...
#define RPG_CLIENT_RELICRECOMMENDSUBPROPERTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA2AB810)

namespace RPG::Client
{
	inline static constexpr unsigned int RelicRecommendSubPropertyData_TypeDefinitionIndex = 54363;
