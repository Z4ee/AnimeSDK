...
#define RPG_CLIENT_RELICRECOMMENDSUBPROPERTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19888230)

namespace RPG::Client
{
	inline static constexpr unsigned int RelicRecommendSubPropertyData_TypeDefinitionIndex = 63825;
