...
#define RPG_CLIENT_RELICRECOMMENDSUBPROPERTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1794F4C0)

namespace RPG::Client
{
	inline static constexpr unsigned int RelicRecommendSubPropertyData_TypeDefinitionIndex = 66816;
