...
#define RPG_CLIENT_DEVUIDEBUGREPORTDATASPINE__CTOR_OFFSET UNITYSDK_OFFSET(0x944B850)

namespace RPG::Client
{
	inline static constexpr unsigned int DevUIDebugReportDataSpine_TypeDefinitionIndex = 55785;
