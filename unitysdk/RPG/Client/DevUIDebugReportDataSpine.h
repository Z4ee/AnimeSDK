...
#define RPG_CLIENT_DEVUIDEBUGREPORTDATASPINE__CTOR_OFFSET UNITYSDK_OFFSET(0xA0F9A20)

namespace RPG::Client
{
	inline static constexpr unsigned int DevUIDebugReportDataSpine_TypeDefinitionIndex = 63017;
