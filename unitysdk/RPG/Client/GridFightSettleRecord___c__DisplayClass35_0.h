...
#define RPG_CLIENT_GRIDFIGHTSETTLERECORD___C__DISPLAYCLASS35_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5AC610)
#define RPG_CLIENT_GRIDFIGHTSETTLERECORD___C__DISPLAYCLASS35_0__GETEQUIPSBYID_B__0_OFFSET UNITYSDK_OFFSET(0x1C5AEF90)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightSettleRecord___c__DisplayClass35_0_TypeDefinitionIndex = 65276;
