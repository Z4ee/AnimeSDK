...
#define RPG_CLIENT_EFFECT_ELECTRICCHAINANIMATIONSUPPORT_METHOD_5_6F73A40265D5B980_OFFSET UNITYSDK_OFFSET(0x150E7120)
#define RPG_CLIENT_EFFECT_ELECTRICCHAINANIMATIONSUPPORT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x150E6F50)
#define RPG_CLIENT_EFFECT_ELECTRICCHAINANIMATIONSUPPORT__CTOR_OFFSET UNITYSDK_OFFSET(0x150E72A0)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_ElectricChainAnimationSupport_TypeDefinitionIndex = 67296;
