...
#define RPG_CLIENT_EFFECT_ELECTRICCHAINANIMATIONSUPPORT_METHOD_5_6F73A40265D5B980_OFFSET UNITYSDK_OFFSET(0x9546D40)
#define RPG_CLIENT_EFFECT_ELECTRICCHAINANIMATIONSUPPORT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x9546B10)
#define RPG_CLIENT_EFFECT_ELECTRICCHAINANIMATIONSUPPORT__CTOR_OFFSET UNITYSDK_OFFSET(0x9546EE0)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_ElectricChainAnimationSupport_TypeDefinitionIndex = 57689;
