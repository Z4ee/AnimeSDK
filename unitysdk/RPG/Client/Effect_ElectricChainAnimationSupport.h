...
#define RPG_CLIENT_EFFECT_ELECTRICCHAINANIMATIONSUPPORT_METHOD_5_6F73A40265D5B980_OFFSET UNITYSDK_OFFSET(0xCDD73F0)
#define RPG_CLIENT_EFFECT_ELECTRICCHAINANIMATIONSUPPORT_ONENABLE_OFFSET UNITYSDK_OFFSET(0xCDD7220)
#define RPG_CLIENT_EFFECT_ELECTRICCHAINANIMATIONSUPPORT__CTOR_OFFSET UNITYSDK_OFFSET(0xCDD7570)
