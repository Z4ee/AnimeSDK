...
#define RPG_CLIENT_PLANETFESCARDDATA_CHECKISFINISH_OFFSET UNITYSDK_OFFSET(0x9F90E00)
#define RPG_CLIENT_PLANETFESCARDDATA_CHECKISPIECELISTCANUNLOCKCARD_OFFSET UNITYSDK_OFFSET(0x9F90D00)
#define RPG_CLIENT_PLANETFESCARDDATA_GETCARDITEMNUM_OFFSET UNITYSDK_OFFSET(0x9F90F90)
#define RPG_CLIENT_PLANETFESCARDDATA_GET_BUFFIDLIST_OFFSET UNITYSDK_OFFSET(0x9F91450)
#define RPG_CLIENT_PLANETFESCARDDATA_GET_CARDID_OFFSET UNITYSDK_OFFSET(0x9F913F0)
#define RPG_CLIENT_PLANETFESCARDDATA_GET_CARDPIECECOLLECTNUM_OFFSET UNITYSDK_OFFSET(0x9F91240)
#define RPG_CLIENT_PLANETFESCARDDATA_GET_CARDPIECENUMDICT_OFFSET UNITYSDK_OFFSET(0x9F911D0)
#define RPG_CLIENT_PLANETFESCARDDATA_GET_CARDPIECENUM_OFFSET UNITYSDK_OFFSET(0x9F911E0)
#define RPG_CLIENT_PLANETFESCARDDATA_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x9F914A0)
#define RPG_CLIENT_PLANETFESCARDDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0x9F91410)
#define RPG_CLIENT_PLANETFESCARDDATA_GET_IMGPATH_OFFSET UNITYSDK_OFFSET(0x9F91430)
#define RPG_CLIENT_PLANETFESCARDDATA_GET_ISFINISH_OFFSET UNITYSDK_OFFSET(0x9F911C0)
#define RPG_CLIENT_PLANETFESCARDDATA_GET_ITEMLIST_OFFSET UNITYSDK_OFFSET(0x9F90DE0)
#define RPG_CLIENT_PLANETFESCARDDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0x9F91470)
#define RPG_CLIENT_PLANETFESCARDDATA_GET_RARITY_OFFSET UNITYSDK_OFFSET(0x9F914D0)
#define RPG_CLIENT_PLANETFESCARDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9F90CC0)
#define RPG_CLIENT_PLANETFESCARDDATA__GETCARDITEMCOLLECTNUM_OFFSET UNITYSDK_OFFSET(0x9F91250)

namespace RPG::Client
{
	inline static constexpr unsigned int PlanetFesCardData_TypeDefinitionIndex = 54160;
