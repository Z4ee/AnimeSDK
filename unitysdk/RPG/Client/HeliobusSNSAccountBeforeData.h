...
#define RPG_CLIENT_HELIOBUSSNSACCOUNTBEFOREDATA_COPYTO_OFFSET UNITYSDK_OFFSET(0x19812F00)
#define RPG_CLIENT_HELIOBUSSNSACCOUNTBEFOREDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19812F80)
...
namespace RPG::Client
{
	...
	{
	public:
		::System::UInt32 Incomes; // 0x10
		::System::UInt32 Comments; // 0x14
		::System::UInt32 PopPhase; // 0x18
