...
#define RPG_CLIENT_MATCHTHREEV2ACTIVITYPANELDATA___C__DISPLAYCLASS14_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB7E580)
#define RPG_CLIENT_MATCHTHREEV2ACTIVITYPANELDATA___C__DISPLAYCLASS14_0___GOTOENTRANCEPAGE_B__0_OFFSET UNITYSDK_OFFSET(0x1AB7E7B0)
#define RPG_CLIENT_MATCHTHREEV2ACTIVITYPANELDATA___C__DISPLAYCLASS14_0___GOTOENTRANCEPAGE_B__1_OFFSET UNITYSDK_OFFSET(0x1AB7E990)

namespace RPG::Client
{
	inline static constexpr unsigned int MatchThreeV2ActivityPanelData___c__DisplayClass14_0_TypeDefinitionIndex = 58895;
