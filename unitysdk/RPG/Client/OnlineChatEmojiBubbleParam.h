...
#define RPG_CLIENT_ONLINECHATEMOJIBUBBLEPARAM_CREATE_OFFSET UNITYSDK_OFFSET(0xD9E30B0)
#define RPG_CLIENT_ONLINECHATEMOJIBUBBLEPARAM_GET_DURATION_OFFSET UNITYSDK_OFFSET(0xD9E3080)
#define RPG_CLIENT_ONLINECHATEMOJIBUBBLEPARAM_GET_EMOJIICONPATH_OFFSET UNITYSDK_OFFSET(0xD9E3060)
#define RPG_CLIENT_ONLINECHATEMOJIBUBBLEPARAM_GET_ENTITY_OFFSET UNITYSDK_OFFSET(0xD9E3040)
#define RPG_CLIENT_ONLINECHATEMOJIBUBBLEPARAM_SET_DURATION_OFFSET UNITYSDK_OFFSET(0xD9E3090)
#define RPG_CLIENT_ONLINECHATEMOJIBUBBLEPARAM_SET_EMOJIICONPATH_OFFSET UNITYSDK_OFFSET(0xD9E3070)
#define RPG_CLIENT_ONLINECHATEMOJIBUBBLEPARAM_SET_ENTITY_OFFSET UNITYSDK_OFFSET(0xD9E3050)
#define RPG_CLIENT_ONLINECHATEMOJIBUBBLEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xD9E30A0)
