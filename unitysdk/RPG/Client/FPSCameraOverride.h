...
#define RPG_CLIENT_FPSCAMERAOVERRIDE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1B8A73D0)
#define RPG_CLIENT_FPSCAMERAOVERRIDE_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x1B8A72C0)
#define RPG_CLIENT_FPSCAMERAOVERRIDE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1B8A7350)
#define RPG_CLIENT_FPSCAMERAOVERRIDE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B8A7150)
#define RPG_CLIENT_FPSCAMERAOVERRIDE_PREVIEW_OFFSET UNITYSDK_OFFSET(0x1B8A74A0)
#define RPG_CLIENT_FPSCAMERAOVERRIDE_REVERT_OFFSET UNITYSDK_OFFSET(0x1B8A75C0)
#define RPG_CLIENT_FPSCAMERAOVERRIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8A7650)

namespace RPG::Client
{
	inline static constexpr unsigned int FPSCameraOverride_TypeDefinitionIndex = 70552;
	...
	public:
		...
		::Class_1_0B45428C848E725C* LJNPGFBOBAB; // 0x40
