...
#define RPG_CLIENT_FPSCAMERAOVERRIDE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xA318F70)
#define RPG_CLIENT_FPSCAMERAOVERRIDE_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xA318E60)
#define RPG_CLIENT_FPSCAMERAOVERRIDE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xA318EF0)
#define RPG_CLIENT_FPSCAMERAOVERRIDE_ONENABLE_OFFSET UNITYSDK_OFFSET(0xA318CF0)
#define RPG_CLIENT_FPSCAMERAOVERRIDE_PREVIEW_OFFSET UNITYSDK_OFFSET(0xA319040)
#define RPG_CLIENT_FPSCAMERAOVERRIDE_REVERT_OFFSET UNITYSDK_OFFSET(0xA319160)
#define RPG_CLIENT_FPSCAMERAOVERRIDE__CTOR_OFFSET UNITYSDK_OFFSET(0xA3191F0)

namespace RPG::Client
{
	inline static constexpr unsigned int FPSCameraOverride_TypeDefinitionIndex = 65079;
