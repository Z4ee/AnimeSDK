...
#define RPG_CLIENT_IMAGECOLORGRADINGSCANLINE_GETMATERIALFORRENDERING_OFFSET UNITYSDK_OFFSET(0xBD277C0)
#define RPG_CLIENT_IMAGECOLORGRADINGSCANLINE_GET_IMAGE_OFFSET UNITYSDK_OFFSET(0xBD27710)
#define RPG_CLIENT_IMAGECOLORGRADINGSCANLINE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xBD27E20)
#define RPG_CLIENT_IMAGECOLORGRADINGSCANLINE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xBD28100)
#define RPG_CLIENT_IMAGECOLORGRADINGSCANLINE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xBD28160)
#define RPG_CLIENT_IMAGECOLORGRADINGSCANLINE__CTOR_OFFSET UNITYSDK_OFFSET(0xBD281B0)
#define RPG_CLIENT_IMAGECOLORGRADINGSCANLINE___IFIXBASEPROXY_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xBD28320)
#define RPG_CLIENT_IMAGECOLORGRADINGSCANLINE___IFIXBASEPROXY_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xBD28330)

namespace RPG::Client
{
	inline static constexpr unsigned int ImageColorGradingScanline_TypeDefinitionIndex = 66403;
