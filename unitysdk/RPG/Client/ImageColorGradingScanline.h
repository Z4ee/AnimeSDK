...
#define RPG_CLIENT_IMAGECOLORGRADINGSCANLINE_GETMATERIALFORRENDERING_OFFSET UNITYSDK_OFFSET(0xA622E20)
#define RPG_CLIENT_IMAGECOLORGRADINGSCANLINE_GET_IMAGE_OFFSET UNITYSDK_OFFSET(0xA622D70)
#define RPG_CLIENT_IMAGECOLORGRADINGSCANLINE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xA623490)
#define RPG_CLIENT_IMAGECOLORGRADINGSCANLINE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xA623770)
#define RPG_CLIENT_IMAGECOLORGRADINGSCANLINE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xA6237D0)
#define RPG_CLIENT_IMAGECOLORGRADINGSCANLINE__CTOR_OFFSET UNITYSDK_OFFSET(0xA623820)
#define RPG_CLIENT_IMAGECOLORGRADINGSCANLINE___IFIXBASEPROXY_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xA623990)
#define RPG_CLIENT_IMAGECOLORGRADINGSCANLINE___IFIXBASEPROXY_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xA6239A0)

namespace RPG::Client
{
	inline static constexpr unsigned int ImageColorGradingScanline_TypeDefinitionIndex = 65473;
