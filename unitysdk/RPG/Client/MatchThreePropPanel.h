...
#define RPG_CLIENT_MATCHTHREEPROPPANEL_AWAKE_OFFSET UNITYSDK_OFFSET(0x1AB756A0)
#define RPG_CLIENT_MATCHTHREEPROPPANEL_GET_ITEMPANELS_OFFSET UNITYSDK_OFFSET(0x1AB75620)
#define RPG_CLIENT_MATCHTHREEPROPPANEL_GET_ONBUTTONCANCEL_OFFSET UNITYSDK_OFFSET(0x1AB75680)
#define RPG_CLIENT_MATCHTHREEPROPPANEL_GET_ONBUTTONOK_OFFSET UNITYSDK_OFFSET(0x1AB75660)
#define RPG_CLIENT_MATCHTHREEPROPPANEL_GET_ONPROPUSE_OFFSET UNITYSDK_OFFSET(0x1AB75640)
#define RPG_CLIENT_MATCHTHREEPROPPANEL_HIDECONTROLS_OFFSET UNITYSDK_OFFSET(0x1AB760C0)
#define RPG_CLIENT_MATCHTHREEPROPPANEL_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0x1AB757E0)
#define RPG_CLIENT_MATCHTHREEPROPPANEL_SET_ITEMPANELS_OFFSET UNITYSDK_OFFSET(0x1AB75630)
#define RPG_CLIENT_MATCHTHREEPROPPANEL_SET_ONBUTTONCANCEL_OFFSET UNITYSDK_OFFSET(0x1AB75690)
#define RPG_CLIENT_MATCHTHREEPROPPANEL_SET_ONBUTTONOK_OFFSET UNITYSDK_OFFSET(0x1AB75670)
#define RPG_CLIENT_MATCHTHREEPROPPANEL_SET_ONPROPUSE_OFFSET UNITYSDK_OFFSET(0x1AB75650)
#define RPG_CLIENT_MATCHTHREEPROPPANEL_SHOWCONTROLS_OFFSET UNITYSDK_OFFSET(0x1AB76120)
#define RPG_CLIENT_MATCHTHREEPROPPANEL__AWAKE_B__23_0_OFFSET UNITYSDK_OFFSET(0x1AB761D0)
#define RPG_CLIENT_MATCHTHREEPROPPANEL__AWAKE_B__23_1_OFFSET UNITYSDK_OFFSET(0x1AB761F0)
#define RPG_CLIENT_MATCHTHREEPROPPANEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB76180)

namespace RPG::Client
{
	inline static constexpr unsigned int MatchThreePropPanel_TypeDefinitionIndex = 63030;
