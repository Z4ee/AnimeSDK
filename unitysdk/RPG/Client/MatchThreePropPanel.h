...
#define RPG_CLIENT_MATCHTHREEPROPPANEL_AWAKE_OFFSET UNITYSDK_OFFSET(0xBF8FA80)
#define RPG_CLIENT_MATCHTHREEPROPPANEL_GET_ITEMPANELS_OFFSET UNITYSDK_OFFSET(0xBF8FA00)
#define RPG_CLIENT_MATCHTHREEPROPPANEL_GET_ONBUTTONCANCEL_OFFSET UNITYSDK_OFFSET(0xBF8FA60)
#define RPG_CLIENT_MATCHTHREEPROPPANEL_GET_ONBUTTONOK_OFFSET UNITYSDK_OFFSET(0xBF8FA40)
#define RPG_CLIENT_MATCHTHREEPROPPANEL_GET_ONPROPUSE_OFFSET UNITYSDK_OFFSET(0xBF8FA20)
#define RPG_CLIENT_MATCHTHREEPROPPANEL_HIDECONTROLS_OFFSET UNITYSDK_OFFSET(0xBF90530)
#define RPG_CLIENT_MATCHTHREEPROPPANEL_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0xBF8FBC0)
#define RPG_CLIENT_MATCHTHREEPROPPANEL_SET_ITEMPANELS_OFFSET UNITYSDK_OFFSET(0xBF8FA10)
#define RPG_CLIENT_MATCHTHREEPROPPANEL_SET_ONBUTTONCANCEL_OFFSET UNITYSDK_OFFSET(0xBF8FA70)
#define RPG_CLIENT_MATCHTHREEPROPPANEL_SET_ONBUTTONOK_OFFSET UNITYSDK_OFFSET(0xBF8FA50)
#define RPG_CLIENT_MATCHTHREEPROPPANEL_SET_ONPROPUSE_OFFSET UNITYSDK_OFFSET(0xBF8FA30)
#define RPG_CLIENT_MATCHTHREEPROPPANEL_SHOWCONTROLS_OFFSET UNITYSDK_OFFSET(0xBF90590)
#define RPG_CLIENT_MATCHTHREEPROPPANEL__AWAKE_B__23_0_OFFSET UNITYSDK_OFFSET(0xBF90640)
#define RPG_CLIENT_MATCHTHREEPROPPANEL__AWAKE_B__23_1_OFFSET UNITYSDK_OFFSET(0xBF90660)
#define RPG_CLIENT_MATCHTHREEPROPPANEL__CTOR_OFFSET UNITYSDK_OFFSET(0xBF905F0)

namespace RPG::Client
{
	inline static constexpr unsigned int MatchThreePropPanel_TypeDefinitionIndex = 61668;
