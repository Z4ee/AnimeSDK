...
#define RPG_CLIENT_WOLFBROGUNPLAYTARGETACTIONCONFIG_BOSSSETTLEMENT_METHOD_2_47FCE72550F759BF_OFFSET UNITYSDK_OFFSET(0x17427D10)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGETACTIONCONFIG_BOSSSETTLEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x17427D90)

namespace RPG::Client
{
	inline static constexpr unsigned int WolfBroGunPlayTargetActionConfig_BossSettlement_TypeDefinitionIndex = 65644;
