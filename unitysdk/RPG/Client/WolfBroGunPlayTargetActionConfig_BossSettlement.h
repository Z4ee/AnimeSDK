...
#define RPG_CLIENT_WOLFBROGUNPLAYTARGETACTIONCONFIG_BOSSSETTLEMENT_METHOD_2_47FCE72550F759BF_OFFSET UNITYSDK_OFFSET(0xA794A00)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGETACTIONCONFIG_BOSSSETTLEMENT_METHOD_2_F8B73ECE7F883AC1_OFFSET UNITYSDK_OFFSET(0xA794A90)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGETACTIONCONFIG_BOSSSETTLEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0xA794A80)

namespace RPG::Client
{
	inline static constexpr unsigned int WolfBroGunPlayTargetActionConfig_BossSettlement_TypeDefinitionIndex = 56113;
