...
#define RPG_CLIENT_MONOPREFABLIGHTFADEINOUTBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0x1AD01AF0)
#define RPG_CLIENT_MONOPREFABLIGHTFADEINOUTBEHAVIOR_METHOD_3_1947BC35B7A7FCB8_OFFSET UNITYSDK_OFFSET(0x1AD018A0)
#define RPG_CLIENT_MONOPREFABLIGHTFADEINOUTBEHAVIOR_METHOD_3_31F40A8A1EFC6074_OFFSET UNITYSDK_OFFSET(0x1AD01B70)
#define RPG_CLIENT_MONOPREFABLIGHTFADEINOUTBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD01C50)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoPrefabLightFadeInOutBehavior_TypeDefinitionIndex = 70891;
