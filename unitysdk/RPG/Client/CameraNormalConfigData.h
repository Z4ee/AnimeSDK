...
#define RPG_CLIENT_CAMERANORMALCONFIGDATA_ADDFROMCONFIG_OFFSET UNITYSDK_OFFSET(0xC9E3790)
#define RPG_CLIENT_CAMERANORMALCONFIGDATA_ADDFROMDATA_OFFSET UNITYSDK_OFFSET(0xC9EA520)
#define RPG_CLIENT_CAMERANORMALCONFIGDATA_COPYFROMCONFIG_OFFSET UNITYSDK_OFFSET(0xC9E2F50)
#define RPG_CLIENT_CAMERANORMALCONFIGDATA_COPYFROMOTHEREXCLUDEINVALID_OFFSET UNITYSDK_OFFSET(0xC9E30B0)
#define RPG_CLIENT_CAMERANORMALCONFIGDATA_GET_ISMELEEATTACK_OFFSET UNITYSDK_OFFSET(0xC9EA690)
#define RPG_CLIENT_CAMERANORMALCONFIGDATA_RESETTARGETENTITIES_OFFSET UNITYSDK_OFFSET(0xC9E3900)
#define RPG_CLIENT_CAMERANORMALCONFIGDATA_SETFOLLOWANGLETOFOLLOWSPHERICALPOS_OFFSET UNITYSDK_OFFSET(0xC9EA610)
#define RPG_CLIENT_CAMERANORMALCONFIGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC9E15D0)
