...
#define RPG_CLIENT_MATERIALREPLACERBASE_AWAKE_OFFSET UNITYSDK_OFFSET(0x9B78850)
#define RPG_CLIENT_MATERIALREPLACERBASE_METHOD_5_27EEE9768439A81E_OFFSET UNITYSDK_OFFSET(0x9B78D70)
#define RPG_CLIENT_MATERIALREPLACERBASE_METHOD_5_77DD15830483C589_OFFSET UNITYSDK_OFFSET(0x9B78910)
#define RPG_CLIENT_MATERIALREPLACERBASE_METHOD_5_E6FA84ECDEF620CE_OFFSET UNITYSDK_OFFSET(0x9B78D10)
#define RPG_CLIENT_MATERIALREPLACERBASE_REPLACEMATERIAL_OFFSET UNITYSDK_OFFSET(0x9B788A0)
#define RPG_CLIENT_MATERIALREPLACERBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x9B78E70)
