...
#define RPG_CLIENT_IKHITREACTIONLIMB__CTOR_OFFSET UNITYSDK_OFFSET(0xA620FC0)

namespace RPG::Client
{
	inline static constexpr unsigned int IKHitReactionLimb_TypeDefinitionIndex = 63122;
