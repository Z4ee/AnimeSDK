...
#define RPG_CLIENT_IKHITREACTIONLIMB__CTOR_OFFSET UNITYSDK_OFFSET(0x9936360)

namespace RPG::Client
{
	inline static constexpr unsigned int IKHitReactionLimb_TypeDefinitionIndex = 55888;
