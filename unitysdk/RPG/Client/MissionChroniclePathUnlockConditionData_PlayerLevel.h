...
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_PLAYERLEVEL_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x169721B0)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_PLAYERLEVEL_EQUALS_OFFSET UNITYSDK_OFFSET(0x16972100)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_PLAYERLEVEL_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x169722D0)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_PLAYERLEVEL_GET_CONDITIONTEXT_OFFSET UNITYSDK_OFFSET(0x16972350)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_PLAYERLEVEL_GET_REQUIREDLEVEL_OFFSET UNITYSDK_OFFSET(0x16972340)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_PLAYERLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x169720F0)
