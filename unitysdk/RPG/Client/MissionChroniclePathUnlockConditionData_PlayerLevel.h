...
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_PLAYERLEVEL_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x15830740)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_PLAYERLEVEL_EQUALS_OFFSET UNITYSDK_OFFSET(0x15830690)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_PLAYERLEVEL_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x15830860)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_PLAYERLEVEL_GET_CONDITIONTEXT_OFFSET UNITYSDK_OFFSET(0x158308E0)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_PLAYERLEVEL_GET_REQUIREDLEVEL_OFFSET UNITYSDK_OFFSET(0x158308D0)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_PLAYERLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x15830680)

namespace RPG::Client
{
	inline static constexpr unsigned int MissionChroniclePathUnlockConditionData_PlayerLevel_TypeDefinitionIndex = 63185;
