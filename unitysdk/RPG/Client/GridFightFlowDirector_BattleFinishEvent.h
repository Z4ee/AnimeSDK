...
#define RPG_CLIENT_GRIDFIGHTFLOWDIRECTOR_BATTLEFINISHEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0xA49B070)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightFlowDirector_BattleFinishEvent_TypeDefinitionIndex = 59432;
