...
#define RPG_CLIENT_ROGUEWORKBENCHREFORGEFORMULA_GETFUNCID_OFFSET UNITYSDK_OFFSET(0xDFD0020)
#define RPG_CLIENT_ROGUEWORKBENCHREFORGEFORMULA_GETFUNCTYPE_OFFSET UNITYSDK_OFFSET(0xDFCFFD0)
#define RPG_CLIENT_ROGUEWORKBENCHREFORGEFORMULA_GET_COSTDATA_OFFSET UNITYSDK_OFFSET(0xDFD01E0)
#define RPG_CLIENT_ROGUEWORKBENCHREFORGEFORMULA_GET_ISDISABLE_OFFSET UNITYSDK_OFFSET(0xDFD01C0)
#define RPG_CLIENT_ROGUEWORKBENCHREFORGEFORMULA_OPENFUNCUIPAGE_OFFSET UNITYSDK_OFFSET(0xDFD0060)
#define RPG_CLIENT_ROGUEWORKBENCHREFORGEFORMULA_REFRESH_OFFSET UNITYSDK_OFFSET(0xDFCFF60)
#define RPG_CLIENT_ROGUEWORKBENCHREFORGEFORMULA_SET_COSTDATA_OFFSET UNITYSDK_OFFSET(0xDFD01F0)
#define RPG_CLIENT_ROGUEWORKBENCHREFORGEFORMULA_SET_ISDISABLE_OFFSET UNITYSDK_OFFSET(0xDFD01D0)
#define RPG_CLIENT_ROGUEWORKBENCHREFORGEFORMULA__CTOR_OFFSET UNITYSDK_OFFSET(0xDFCFE70)
