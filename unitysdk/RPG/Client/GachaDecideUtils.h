...
#define RPG_CLIENT_GACHADECIDEUTILS_CREATEDECIDEDATA_OFFSET UNITYSDK_OFFSET(0xBAAA7C0)
#define RPG_CLIENT_GACHADECIDEUTILS_ISFEATUREOPEN_OFFSET UNITYSDK_OFFSET(0xBAAA820)

namespace RPG::Client
{
	inline static constexpr unsigned int GachaDecideUtils_TypeDefinitionIndex = 60090;
