...
#define RPG_CLIENT_FREELOOK3RDRIGPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x16D1C960)

namespace RPG::Client
{
	inline static constexpr unsigned int Freelook3rdRigParams_TypeDefinitionIndex = 66546;
