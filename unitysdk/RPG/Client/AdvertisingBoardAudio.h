...
#define RPG_CLIENT_ADVERTISINGBOARDAUDIO_METHOD_5_0865E94460F11643_OFFSET UNITYSDK_OFFSET(0x906F110)
#define RPG_CLIENT_ADVERTISINGBOARDAUDIO_METHOD_5_33ACA6CB2ABC73F7_1_OFFSET UNITYSDK_OFFSET(0x906EEA0)
#define RPG_CLIENT_ADVERTISINGBOARDAUDIO_METHOD_5_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0x906ED70)
#define RPG_CLIENT_ADVERTISINGBOARDAUDIO_METHOD_5_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0x906F080)
#define RPG_CLIENT_ADVERTISINGBOARDAUDIO_METHOD_5_AD23FDCC7576BB32_OFFSET UNITYSDK_OFFSET(0x906EFD0)
#define RPG_CLIENT_ADVERTISINGBOARDAUDIO_MUTEAUDIO_OFFSET UNITYSDK_OFFSET(0x906EC30)
#define RPG_CLIENT_ADVERTISINGBOARDAUDIO_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x906EF80)
#define RPG_CLIENT_ADVERTISINGBOARDAUDIO_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x906EE50)
#define RPG_CLIENT_ADVERTISINGBOARDAUDIO_ONENABLE_OFFSET UNITYSDK_OFFSET(0x906ED10)
#define RPG_CLIENT_ADVERTISINGBOARDAUDIO__CTOR_OFFSET UNITYSDK_OFFSET(0x906F1E0)

namespace RPG::Client
{
	inline static constexpr unsigned int AdvertisingBoardAudio_TypeDefinitionIndex = 55761;
