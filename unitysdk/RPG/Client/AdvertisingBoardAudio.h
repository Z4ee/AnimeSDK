...
#define RPG_CLIENT_ADVERTISINGBOARDAUDIO_METHOD_5_0865E94460F11643_OFFSET UNITYSDK_OFFSET(0x182D6FE0)
#define RPG_CLIENT_ADVERTISINGBOARDAUDIO_METHOD_5_33ACA6CB2ABC73F7_1_OFFSET UNITYSDK_OFFSET(0x182D6D50)
#define RPG_CLIENT_ADVERTISINGBOARDAUDIO_METHOD_5_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0x182D6C00)
#define RPG_CLIENT_ADVERTISINGBOARDAUDIO_METHOD_5_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0x182D6F50)
#define RPG_CLIENT_ADVERTISINGBOARDAUDIO_METHOD_5_AD23FDCC7576BB32_OFFSET UNITYSDK_OFFSET(0x182D6EA0)
#define RPG_CLIENT_ADVERTISINGBOARDAUDIO_MUTEAUDIO_OFFSET UNITYSDK_OFFSET(0x182D6A90)
#define RPG_CLIENT_ADVERTISINGBOARDAUDIO_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x182D6E50)
#define RPG_CLIENT_ADVERTISINGBOARDAUDIO_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x182D6D00)
#define RPG_CLIENT_ADVERTISINGBOARDAUDIO_ONENABLE_OFFSET UNITYSDK_OFFSET(0x182D6BA0)
#define RPG_CLIENT_ADVERTISINGBOARDAUDIO__CTOR_OFFSET UNITYSDK_OFFSET(0x182D70B0)

namespace RPG::Client
{
	inline static constexpr unsigned int AdvertisingBoardAudio_TypeDefinitionIndex = 65270;
