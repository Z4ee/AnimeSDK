...
#define RPG_CLIENT_ADVERTISINGBOARDAUDIO_METHOD_5_0865E94460F11643_OFFSET UNITYSDK_OFFSET(0xB270C00)
#define RPG_CLIENT_ADVERTISINGBOARDAUDIO_METHOD_5_33ACA6CB2ABC73F7_1_OFFSET UNITYSDK_OFFSET(0xB270970)
#define RPG_CLIENT_ADVERTISINGBOARDAUDIO_METHOD_5_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0xB270820)
#define RPG_CLIENT_ADVERTISINGBOARDAUDIO_METHOD_5_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0xB270B70)
#define RPG_CLIENT_ADVERTISINGBOARDAUDIO_METHOD_5_AD23FDCC7576BB32_OFFSET UNITYSDK_OFFSET(0xB270AC0)
#define RPG_CLIENT_ADVERTISINGBOARDAUDIO_MUTEAUDIO_OFFSET UNITYSDK_OFFSET(0xB2706B0)
#define RPG_CLIENT_ADVERTISINGBOARDAUDIO_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB270A70)
#define RPG_CLIENT_ADVERTISINGBOARDAUDIO_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xB270920)
#define RPG_CLIENT_ADVERTISINGBOARDAUDIO_ONENABLE_OFFSET UNITYSDK_OFFSET(0xB2707C0)
#define RPG_CLIENT_ADVERTISINGBOARDAUDIO__CTOR_OFFSET UNITYSDK_OFFSET(0xB270CD0)

namespace RPG::Client
{
	inline static constexpr unsigned int AdvertisingBoardAudio_TypeDefinitionIndex = 63899;
