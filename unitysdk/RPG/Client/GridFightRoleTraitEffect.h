...
#define RPG_CLIENT_GRIDFIGHTROLETRAITEFFECT_DESPAWNED_OFFSET UNITYSDK_OFFSET(0x989E250)
#define RPG_CLIENT_GRIDFIGHTROLETRAITEFFECT_METHOD_6_90BC2B951C8F8F73_OFFSET UNITYSDK_OFFSET(0x989E3F0)
#define RPG_CLIENT_GRIDFIGHTROLETRAITEFFECT_ONCREATE_OFFSET UNITYSDK_OFFSET(0x989E0E0)
#define RPG_CLIENT_GRIDFIGHTROLETRAITEFFECT_PLAY_OFFSET UNITYSDK_OFFSET(0x989E2D0)
#define RPG_CLIENT_GRIDFIGHTROLETRAITEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x989E4A0)
#define RPG_CLIENT_GRIDFIGHTROLETRAITEFFECT___IFIXBASEPROXY_DESPAWNED_OFFSET UNITYSDK_OFFSET(0x989E4C0)
#define RPG_CLIENT_GRIDFIGHTROLETRAITEFFECT___IFIXBASEPROXY_ONCREATE_OFFSET UNITYSDK_OFFSET(0x989E4B0)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightRoleTraitEffect_TypeDefinitionIndex = 52397;
