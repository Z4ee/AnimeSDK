...
#define RPG_CLIENT_DEBATEMANAGER___C__DISPLAYCLASS20_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA0F54A0)
#define RPG_CLIENT_DEBATEMANAGER___C__DISPLAYCLASS20_0___SETTESTIMONYGROUPS_B__0_OFFSET UNITYSDK_OFFSET(0xA0F5760)

namespace RPG::Client
{
	inline static constexpr unsigned int DebateManager___c__DisplayClass20_0_TypeDefinitionIndex = 55968;
