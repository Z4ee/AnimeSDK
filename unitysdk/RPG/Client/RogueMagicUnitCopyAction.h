...
#define RPG_CLIENT_ROGUEMAGICUNITCOPYACTION_GETROGUEACTIONID_OFFSET UNITYSDK_OFFSET(0xDEEC220)
#define RPG_CLIENT_ROGUEMAGICUNITCOPYACTION_GETUIPATH_OFFSET UNITYSDK_OFFSET(0xDEEC2B0)
#define RPG_CLIENT_ROGUEMAGICUNITCOPYACTION_GET_HINTID_OFFSET UNITYSDK_OFFSET(0xDEEBD00)
#define RPG_CLIENT_ROGUEMAGICUNITCOPYACTION_GET_ROGUEACTIONID_OFFSET UNITYSDK_OFFSET(0xDEEBCC0)
#define RPG_CLIENT_ROGUEMAGICUNITCOPYACTION_GET_SELECTUNITS_OFFSET UNITYSDK_OFFSET(0xDEEBCE0)
#define RPG_CLIENT_ROGUEMAGICUNITCOPYACTION_SET_HINTID_OFFSET UNITYSDK_OFFSET(0xDEEBD10)
#define RPG_CLIENT_ROGUEMAGICUNITCOPYACTION_SET_ROGUEACTIONID_OFFSET UNITYSDK_OFFSET(0xDEEBCD0)
#define RPG_CLIENT_ROGUEMAGICUNITCOPYACTION_SET_SELECTUNITS_OFFSET UNITYSDK_OFFSET(0xDEEBCF0)
#define RPG_CLIENT_ROGUEMAGICUNITCOPYACTION_TRIGGERACTION_OFFSET UNITYSDK_OFFSET(0xDEEC260)
#define RPG_CLIENT_ROGUEMAGICUNITCOPYACTION__CONSTRUCT_OFFSET UNITYSDK_OFFSET(0xDEEBD30)
#define RPG_CLIENT_ROGUEMAGICUNITCOPYACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xDEEBD20)
