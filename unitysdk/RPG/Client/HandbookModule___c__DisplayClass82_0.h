...
namespace RPG::Client
{
	...
	public:
		...
		::System::Boolean _GetMaterialGuideIDListByAvatar_b__0(::RPG::GameCore::ItemConfig* item)
		{
			return ((::System::Boolean(*)(::PVOID, ::RPG::GameCore::ItemConfig*))((::PBYTE)hIl2Cpp + RPG_CLIENT_HANDBOOKMODULE___C__DISPLAYCLASS82_0__GETMATERIALGUIDEIDLISTBYAVATAR_B__0_OFFSET))(this, item);
		}
	};
}
