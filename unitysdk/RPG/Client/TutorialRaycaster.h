...
#define RPG_CLIENT_TUTORIALRAYCASTER_GET_EVENTCAMERA_OFFSET UNITYSDK_OFFSET(0x16FD9A60)
#define RPG_CLIENT_TUTORIALRAYCASTER_GET_SORTORDERPRIORITY_OFFSET UNITYSDK_OFFSET(0x16FD9A90)
#define RPG_CLIENT_TUTORIALRAYCASTER_RAYCAST_OFFSET UNITYSDK_OFFSET(0x16FD9AF0)
#define RPG_CLIENT_TUTORIALRAYCASTER_SETTARGET_OFFSET UNITYSDK_OFFSET(0x16FD9AA0)
#define RPG_CLIENT_TUTORIALRAYCASTER__CTOR_OFFSET UNITYSDK_OFFSET(0x16FD9CE0)

namespace RPG::Client
{
	inline static constexpr unsigned int TutorialRaycaster_TypeDefinitionIndex = 65961;
