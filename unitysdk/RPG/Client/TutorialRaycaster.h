...
#define RPG_CLIENT_TUTORIALRAYCASTER_GET_EVENTCAMERA_OFFSET UNITYSDK_OFFSET(0xCAFD630)
#define RPG_CLIENT_TUTORIALRAYCASTER_GET_SORTORDERPRIORITY_OFFSET UNITYSDK_OFFSET(0xCAFD660)
#define RPG_CLIENT_TUTORIALRAYCASTER_RAYCAST_OFFSET UNITYSDK_OFFSET(0xCAFD6C0)
#define RPG_CLIENT_TUTORIALRAYCASTER_SETTARGET_OFFSET UNITYSDK_OFFSET(0xCAFD670)
#define RPG_CLIENT_TUTORIALRAYCASTER__CTOR_OFFSET UNITYSDK_OFFSET(0xCAFD900)

namespace RPG::Client
{
	inline static constexpr unsigned int TutorialRaycaster_TypeDefinitionIndex = 64561;
