...
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_GENERATECONFIG_METHOD_2_0CC4BC19C602BCD0_OFFSET UNITYSDK_OFFSET(0xD8EC0)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_GENERATECONFIG_METHOD_2_ED65AE7582736594_1_OFFSET UNITYSDK_OFFSET(0xD8EB0)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_GENERATECONFIG_METHOD_2_ED65AE7582736594_OFFSET UNITYSDK_OFFSET(0xD8EA0)

namespace RPG::Client
{
	inline static constexpr unsigned int LoopGenerateBehavior_GenerateConfig_TypeDefinitionIndex = 65365;
