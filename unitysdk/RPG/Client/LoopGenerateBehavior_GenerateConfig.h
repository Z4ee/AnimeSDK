...
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_GENERATECONFIG_METHOD_2_7FBAA229ED524F8E_OFFSET UNITYSDK_OFFSET(0x38F4AB0)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_GENERATECONFIG_METHOD_2_89EF21CA0414B145_OFFSET UNITYSDK_OFFSET(0x38F4AA0)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_GENERATECONFIG_METHOD_2_C1D3BDE2A17F5C9D_OFFSET UNITYSDK_OFFSET(0x38F4A90)

namespace RPG::Client
{
	inline static constexpr unsigned int LoopGenerateBehavior_GenerateConfig_TypeDefinitionIndex = 67717;
