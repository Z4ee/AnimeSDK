...
#define RPG_CLIENT_FATEGAMEMASTERTALKRANDOMCONTEXT_CLONEAVATARSWAPPED_OFFSET UNITYSDK_OFFSET(0x14E7B0)
#define RPG_CLIENT_FATEGAMEMASTERTALKRANDOMCONTEXT_CREATEBYGAMEDATA_OFFSET UNITYSDK_OFFSET(0xCF488C0)
#define RPG_CLIENT_FATEGAMEMASTERTALKRANDOMCONTEXT_GET_ISAVATAR2WIN_OFFSET UNITYSDK_OFFSET(0x14E760)
#define RPG_CLIENT_FATEGAMEMASTERTALKRANDOMCONTEXT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x14E7D0)
