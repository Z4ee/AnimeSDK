...
#define RPG_CLIENT_FATEGAMEMASTERTALKRANDOMCONTEXT_CLONEAVATARSWAPPED_OFFSET UNITYSDK_OFFSET(0x7DAE0)
#define RPG_CLIENT_FATEGAMEMASTERTALKRANDOMCONTEXT_CREATEBYGAMEDATA_OFFSET UNITYSDK_OFFSET(0x9688480)
#define RPG_CLIENT_FATEGAMEMASTERTALKRANDOMCONTEXT_GET_ISAVATAR2WIN_OFFSET UNITYSDK_OFFSET(0x7DAD0)
#define RPG_CLIENT_FATEGAMEMASTERTALKRANDOMCONTEXT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x7DB80)
#define RPG_CLIENT_FATEGAMEMASTERTALKRANDOMCONTEXT___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x7DB90)

namespace RPG::Client
{
	inline static constexpr unsigned int FateGameMasterTalkRandomContext_TypeDefinitionIndex = 52020;
