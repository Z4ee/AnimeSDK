...
#define RPG_CLIENT_ACTIVEACTIVITYPANELDATA_GET_ACTIVEACTIVITYDATA_OFFSET UNITYSDK_OFFSET(0x8ECFC90)
#define RPG_CLIENT_ACTIVEACTIVITYPANELDATA_ISEXTRACONDSATISFY_OFFSET UNITYSDK_OFFSET(0x8ECFC40)
#define RPG_CLIENT_ACTIVEACTIVITYPANELDATA_ISSHOWNORMALREDDOT_OFFSET UNITYSDK_OFFSET(0x8ECFDC0)
#define RPG_CLIENT_ACTIVEACTIVITYPANELDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x8ECFC30)
#define RPG_CLIENT_ACTIVEACTIVITYPANELDATA__ISNEEDSHOWDAILYREDDOT_OFFSET UNITYSDK_OFFSET(0x8ECFD80)
#define RPG_CLIENT_ACTIVEACTIVITYPANELDATA__ONACTIVITYOPENEDCUSTOM_OFFSET UNITYSDK_OFFSET(0x8ECFF40)
#define RPG_CLIENT_ACTIVEACTIVITYPANELDATA___IFIXBASEPROXY_ISEXTRACONDSATISFY_OFFSET UNITYSDK_OFFSET(0x8ED01F0)
#define RPG_CLIENT_ACTIVEACTIVITYPANELDATA___IFIXBASEPROXY_ISSHOWNORMALREDDOT_OFFSET UNITYSDK_OFFSET(0x8ED0270)
#define RPG_CLIENT_ACTIVEACTIVITYPANELDATA___IFIXBASEPROXY__ISNEEDSHOWDAILYREDDOT_OFFSET UNITYSDK_OFFSET(0x8ED0260)
#define RPG_CLIENT_ACTIVEACTIVITYPANELDATA___IFIXBASEPROXY__ONACTIVITYOPENEDCUSTOM_OFFSET UNITYSDK_OFFSET(0x8ED02E0)
