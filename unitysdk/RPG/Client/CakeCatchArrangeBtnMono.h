...
#define RPG_CLIENT_CAKECATCHARRANGEBTNMONO_AWAKE_OFFSET UNITYSDK_OFFSET(0x18CC6C80)
#define RPG_CLIENT_CAKECATCHARRANGEBTNMONO_CLEARBUTTONCONFIG_OFFSET UNITYSDK_OFFSET(0x18CC6E70)
#define RPG_CLIENT_CAKECATCHARRANGEBTNMONO_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x18CC6EB0)
#define RPG_CLIENT_CAKECATCHARRANGEBTNMONO_SETBUTTONCONFIG_OFFSET UNITYSDK_OFFSET(0x18CC6E10)
#define RPG_CLIENT_CAKECATCHARRANGEBTNMONO__CTOR_OFFSET UNITYSDK_OFFSET(0x18CC7500)
#define RPG_CLIENT_CAKECATCHARRANGEBTNMONO__GETANCHORPOSITION_OFFSET UNITYSDK_OFFSET(0x18CC73A0)
#define RPG_CLIENT_CAKECATCHARRANGEBTNMONO__GETWORLDPOSITION_OFFSET UNITYSDK_OFFSET(0x18CC7110)

namespace RPG::Client
{
	inline static constexpr unsigned int CakeCatchArrangeBtnMono_TypeDefinitionIndex = 60180;
