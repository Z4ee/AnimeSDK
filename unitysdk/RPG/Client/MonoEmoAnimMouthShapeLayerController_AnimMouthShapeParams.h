...
#define RPG_CLIENT_MONOEMOANIMMOUTHSHAPELAYERCONTROLLER_ANIMMOUTHSHAPEPARAMS_GET_FULLPARAMS_OFFSET UNITYSDK_OFFSET(0xC0F94F0)
#define RPG_CLIENT_MONOEMOANIMMOUTHSHAPELAYERCONTROLLER_ANIMMOUTHSHAPEPARAMS_GET_MIDDLEPARAMS_OFFSET UNITYSDK_OFFSET(0xC0F9540)
#define RPG_CLIENT_MONOEMOANIMMOUTHSHAPELAYERCONTROLLER_ANIMMOUTHSHAPEPARAMS_GET_SMALLPARAMS_OFFSET UNITYSDK_OFFSET(0xC0F9590)
#define RPG_CLIENT_MONOEMOANIMMOUTHSHAPELAYERCONTROLLER_ANIMMOUTHSHAPEPARAMS_GET_STOPPARAMS_OFFSET UNITYSDK_OFFSET(0xC0F95E0)
#define RPG_CLIENT_MONOEMOANIMMOUTHSHAPELAYERCONTROLLER_ANIMMOUTHSHAPEPARAMS_METHOD_2_0291408F883F68BB_OFFSET UNITYSDK_OFFSET(0xC0F96B0)
#define RPG_CLIENT_MONOEMOANIMMOUTHSHAPELAYERCONTROLLER_ANIMMOUTHSHAPEPARAMS_METHOD_2_965753FE2B573CAF_OFFSET UNITYSDK_OFFSET(0xC0F9630)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEmoAnimMouthShapeLayerController_AnimMouthShapeParams_TypeDefinitionIndex = 66501;
