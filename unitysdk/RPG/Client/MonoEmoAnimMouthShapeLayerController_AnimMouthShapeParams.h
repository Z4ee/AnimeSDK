...
#define RPG_CLIENT_MONOEMOANIMMOUTHSHAPELAYERCONTROLLER_ANIMMOUTHSHAPEPARAMS_GET_FULLPARAMS_OFFSET UNITYSDK_OFFSET(0x19144DE0)
#define RPG_CLIENT_MONOEMOANIMMOUTHSHAPELAYERCONTROLLER_ANIMMOUTHSHAPEPARAMS_GET_MIDDLEPARAMS_OFFSET UNITYSDK_OFFSET(0x19144E30)
#define RPG_CLIENT_MONOEMOANIMMOUTHSHAPELAYERCONTROLLER_ANIMMOUTHSHAPEPARAMS_GET_SMALLPARAMS_OFFSET UNITYSDK_OFFSET(0x19144E80)
#define RPG_CLIENT_MONOEMOANIMMOUTHSHAPELAYERCONTROLLER_ANIMMOUTHSHAPEPARAMS_GET_STOPPARAMS_OFFSET UNITYSDK_OFFSET(0x19144ED0)
#define RPG_CLIENT_MONOEMOANIMMOUTHSHAPELAYERCONTROLLER_ANIMMOUTHSHAPEPARAMS_METHOD_2_0291408F883F68BB_OFFSET UNITYSDK_OFFSET(0x19144FA0)
#define RPG_CLIENT_MONOEMOANIMMOUTHSHAPELAYERCONTROLLER_ANIMMOUTHSHAPEPARAMS_METHOD_2_965753FE2B573CAF_OFFSET UNITYSDK_OFFSET(0x19144F20)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEmoAnimMouthShapeLayerController_AnimMouthShapeParams_TypeDefinitionIndex = 67937;
