...
#define RPG_CLIENT_MONOPOLYDAILYREWARDDISPLAYDATA_GET_CHEATDICEVALUE_OFFSET UNITYSDK_OFFSET(0x9D551A0)
#define RPG_CLIENT_MONOPOLYDAILYREWARDDISPLAYDATA_GET_CURRENCYVALUE_OFFSET UNITYSDK_OFFSET(0x9D55160)
#define RPG_CLIENT_MONOPOLYDAILYREWARDDISPLAYDATA_GET_DICEVALUE_OFFSET UNITYSDK_OFFSET(0x9D55180)
#define RPG_CLIENT_MONOPOLYDAILYREWARDDISPLAYDATA_GET_ISRECEIVEDDICE_OFFSET UNITYSDK_OFFSET(0x9D551C0)
#define RPG_CLIENT_MONOPOLYDAILYREWARDDISPLAYDATA_GET_NEXTTIMESTAMP_OFFSET UNITYSDK_OFFSET(0x9D551E0)
#define RPG_CLIENT_MONOPOLYDAILYREWARDDISPLAYDATA_SET_CHEATDICEVALUE_OFFSET UNITYSDK_OFFSET(0x9D551B0)
#define RPG_CLIENT_MONOPOLYDAILYREWARDDISPLAYDATA_SET_CURRENCYVALUE_OFFSET UNITYSDK_OFFSET(0x9D55170)
#define RPG_CLIENT_MONOPOLYDAILYREWARDDISPLAYDATA_SET_DICEVALUE_OFFSET UNITYSDK_OFFSET(0x9D55190)
#define RPG_CLIENT_MONOPOLYDAILYREWARDDISPLAYDATA_SET_ISRECEIVEDDICE_OFFSET UNITYSDK_OFFSET(0x9D551D0)
#define RPG_CLIENT_MONOPOLYDAILYREWARDDISPLAYDATA_SET_NEXTTIMESTAMP_OFFSET UNITYSDK_OFFSET(0x9D551F0)
#define RPG_CLIENT_MONOPOLYDAILYREWARDDISPLAYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9D55130)
...
namespace RPG::Client
{
	...
	{
	public:
		::System::UInt32 _CheatDiceValue_k__BackingField; // 0x10
		::System::UInt32 _DiceValue_k__BackingField; // 0x14
		::System::UInt32 _CurrencyValue_k__BackingField; // 0x18
