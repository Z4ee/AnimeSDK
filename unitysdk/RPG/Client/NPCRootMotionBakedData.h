...
#define RPG_CLIENT_NPCROOTMOTIONBAKEDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9DF1930)

namespace RPG::Client
{
	inline static constexpr unsigned int NPCRootMotionBakedData_TypeDefinitionIndex = 48660;
