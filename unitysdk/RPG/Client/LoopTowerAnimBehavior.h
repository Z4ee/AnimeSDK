...
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0xD594030)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_METHOD_3_107FD70DCCEDAA2A_OFFSET UNITYSDK_OFFSET(0xD593A20)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0xD595FB0)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_METHOD_3_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0xD596010)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_METHOD_3_4343F372F34C05BF_3_OFFSET UNITYSDK_OFFSET(0xD596A10)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_METHOD_3_4343F372F34C05BF_4_OFFSET UNITYSDK_OFFSET(0xD596A70)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xD595F50)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_METHOD_3_43690B86AECB092E_OFFSET UNITYSDK_OFFSET(0xD594B80)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_METHOD_3_508D4DD02D3DB74E_OFFSET UNITYSDK_OFFSET(0xD595B40)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_METHOD_3_6516B39957C2E680_OFFSET UNITYSDK_OFFSET(0xD593350)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_METHOD_3_85A29D63AC16EE29_OFFSET UNITYSDK_OFFSET(0xD593550)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_METHOD_3_8C4AEC0BC1CA0CB4_OFFSET UNITYSDK_OFFSET(0xD593250)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_METHOD_3_B0351A8151A472A4_1_OFFSET UNITYSDK_OFFSET(0xD5956E0)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_METHOD_3_B0351A8151A472A4_OFFSET UNITYSDK_OFFSET(0xD5940B0)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_METHOD_3_FDA446125651C201_OFFSET UNITYSDK_OFFSET(0xD595840)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_METHOD_3_FFBC3E5986CAC663_OFFSET UNITYSDK_OFFSET(0xD5957F0)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0xD596080)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0xD596AD0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(LoopTowerAnimBehavior_TypeDefinitionIndex)->GetStaticField(0xF1F0);
		}
