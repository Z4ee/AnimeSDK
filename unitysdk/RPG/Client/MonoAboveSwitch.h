...
#define RPG_CLIENT_MONOABOVESWITCH__CTOR_OFFSET UNITYSDK_OFFSET(0x9C11AB0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoAboveSwitch_TypeDefinitionIndex = 59915;
