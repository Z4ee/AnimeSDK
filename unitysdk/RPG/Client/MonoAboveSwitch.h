...
#define RPG_CLIENT_MONOABOVESWITCH__CTOR_OFFSET UNITYSDK_OFFSET(0xA90CB70)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoAboveSwitch_TypeDefinitionIndex = 67313;
