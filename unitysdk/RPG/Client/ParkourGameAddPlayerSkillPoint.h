...
#define RPG_CLIENT_PARKOURGAMEADDPLAYERSKILLPOINT_METHOD_3_7B88FD6D309FE5C1_OFFSET UNITYSDK_OFFSET(0x193BB730)
#define RPG_CLIENT_PARKOURGAMEADDPLAYERSKILLPOINT_METHOD_3_FE1BE572522A09B6_OFFSET UNITYSDK_OFFSET(0x193BB6B0)
#define RPG_CLIENT_PARKOURGAMEADDPLAYERSKILLPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x193BB700)

namespace RPG::Client
{
	inline static constexpr unsigned int ParkourGameAddPlayerSkillPoint_TypeDefinitionIndex = 9932;
