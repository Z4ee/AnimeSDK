...
#define RPG_CLIENT_PARKOURGAMEADDPLAYERSKILLPOINT_METHOD_3_781077C79BB44444_OFFSET UNITYSDK_OFFSET(0x1D312640)
#define RPG_CLIENT_PARKOURGAMEADDPLAYERSKILLPOINT_METHOD_3_7B88FD6D309FE5C1_OFFSET UNITYSDK_OFFSET(0x1D312680)
#define RPG_CLIENT_PARKOURGAMEADDPLAYERSKILLPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D312670)

namespace RPG::Client
{
	inline static constexpr unsigned int ParkourGameAddPlayerSkillPoint_TypeDefinitionIndex = 10246;
