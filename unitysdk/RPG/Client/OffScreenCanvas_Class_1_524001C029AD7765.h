...
#define RPG_CLIENT_OFFSCREENCANVAS_CLASS_1_524001C029AD7765_METHOD_1_6105334A729F22E3_OFFSET UNITYSDK_OFFSET(0x191C96E0)
#define RPG_CLIENT_OFFSCREENCANVAS_CLASS_1_524001C029AD7765_METHOD_1_64C8CF167B1D4401_OFFSET UNITYSDK_OFFSET(0x191C9470)
#define RPG_CLIENT_OFFSCREENCANVAS_CLASS_1_524001C029AD7765_METHOD_1_69AB98955CC24B74_OFFSET UNITYSDK_OFFSET(0x191C8720)
#define RPG_CLIENT_OFFSCREENCANVAS_CLASS_1_524001C029AD7765_METHOD_1_77911CCFAC6246A2_OFFSET UNITYSDK_OFFSET(0x191C9600)
#define RPG_CLIENT_OFFSCREENCANVAS_CLASS_1_524001C029AD7765_METHOD_1_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0x191C9770)
#define RPG_CLIENT_OFFSCREENCANVAS_CLASS_1_524001C029AD7765_METHOD_1_C4DFC65547D95EA7_OFFSET UNITYSDK_OFFSET(0x191C9520)
#define RPG_CLIENT_OFFSCREENCANVAS_CLASS_1_524001C029AD7765_METHOD_1_D09831639F615812_OFFSET UNITYSDK_OFFSET(0x191C9680)
#define RPG_CLIENT_OFFSCREENCANVAS_CLASS_1_524001C029AD7765__CTOR_OFFSET UNITYSDK_OFFSET(0x191C9130)

namespace RPG::Client
{
	inline static constexpr unsigned int OffScreenCanvas_Class_1_524001C029AD7765_TypeDefinitionIndex = 72545;

	class OffScreenCanvas_Class_1_524001C029AD7765 : public ::System::Object
	{
	public:
		::UnityEngine::GameObject* OKAPOOKNFAD; // 0x10
		::UnityEngine::CanvasRenderer* DJCKHMEJAJM; // 0x18
		::UnityEngine::MeshFilter* CDBIPMEMHOI; // 0x20
