...
#define RPG_CLIENT_OFFSCREENCANVAS_CLASS_1_524001C029AD7765_METHOD_1_6105334A729F22E3_OFFSET UNITYSDK_OFFSET(0xABE2B20)
#define RPG_CLIENT_OFFSCREENCANVAS_CLASS_1_524001C029AD7765_METHOD_1_64C8CF167B1D4401_OFFSET UNITYSDK_OFFSET(0xABE28B0)
#define RPG_CLIENT_OFFSCREENCANVAS_CLASS_1_524001C029AD7765_METHOD_1_69AB98955CC24B74_OFFSET UNITYSDK_OFFSET(0xABE1A90)
#define RPG_CLIENT_OFFSCREENCANVAS_CLASS_1_524001C029AD7765_METHOD_1_77911CCFAC6246A2_OFFSET UNITYSDK_OFFSET(0xABE2A40)
#define RPG_CLIENT_OFFSCREENCANVAS_CLASS_1_524001C029AD7765_METHOD_1_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0xABE2BB0)
#define RPG_CLIENT_OFFSCREENCANVAS_CLASS_1_524001C029AD7765_METHOD_1_C4DFC65547D95EA7_OFFSET UNITYSDK_OFFSET(0xABE2960)
#define RPG_CLIENT_OFFSCREENCANVAS_CLASS_1_524001C029AD7765_METHOD_1_D09831639F615812_OFFSET UNITYSDK_OFFSET(0xABE2AC0)
#define RPG_CLIENT_OFFSCREENCANVAS_CLASS_1_524001C029AD7765__CTOR_OFFSET UNITYSDK_OFFSET(0xABE2570)

namespace RPG::Client
{
	inline static constexpr unsigned int OffScreenCanvas_Class_1_524001C029AD7765_TypeDefinitionIndex = 66911;

	class OffScreenCanvas_Class_1_524001C029AD7765 : public ::System::Object
	{
	public:
		::UnityEngine::CanvasRenderer* Field_1_2; // 0x10
		::UnityEngine::GameObject* Field_1_0; // 0x18
		::UnityEngine::MeshFilter* Field_1_4; // 0x20
		::UnityEngine::Canvas* Field_1_1; // 0x28
		::UnityEngine::MeshRenderer* Field_1_3; // 0x30
