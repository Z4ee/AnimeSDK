...
#define RPG_CLIENT_GRIDFIGHTPOSITIONTAGCONTROL__BINDCOLORSTATE_OFFSET UNITYSDK_OFFSET(0x1CA58B20)
#define RPG_CLIENT_GRIDFIGHTPOSITIONTAGCONTROL__BINDDISPLAYTYPE_OFFSET UNITYSDK_OFFSET(0x1CA580F0)
#define RPG_CLIENT_GRIDFIGHTPOSITIONTAGCONTROL__BINDING_OFFSET UNITYSDK_OFFSET(0x1CA58090)
#define RPG_CLIENT_GRIDFIGHTPOSITIONTAGCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1CA58E50)
#define RPG_CLIENT_GRIDFIGHTPOSITIONTAGCONTROL__GETTEXTID_OFFSET UNITYSDK_OFFSET(0x1CA58D60)
