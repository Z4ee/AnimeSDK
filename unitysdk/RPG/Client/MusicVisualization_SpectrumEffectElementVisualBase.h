...
#define RPG_CLIENT_MUSICVISUALIZATION_SPECTRUMEFFECTELEMENTVISUALBASE_METHOD_1_1B839C6E2E9774D0_1_OFFSET UNITYSDK_OFFSET(0xAB256B0)
#define RPG_CLIENT_MUSICVISUALIZATION_SPECTRUMEFFECTELEMENTVISUALBASE_METHOD_1_1B839C6E2E9774D0_OFFSET UNITYSDK_OFFSET(0xAB254E0)
#define RPG_CLIENT_MUSICVISUALIZATION_SPECTRUMEFFECTELEMENTVISUALBASE_METHOD_1_818C8938061AC0D4_OFFSET UNITYSDK_OFFSET(0xAB30040)
#define RPG_CLIENT_MUSICVISUALIZATION_SPECTRUMEFFECTELEMENTVISUALBASE_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xAB30000)
#define RPG_CLIENT_MUSICVISUALIZATION_SPECTRUMEFFECTELEMENTVISUALBASE_METHOD_1_D76778020DDB2FEC_OFFSET UNITYSDK_OFFSET(0xAB250A0)
#define RPG_CLIENT_MUSICVISUALIZATION_SPECTRUMEFFECTELEMENTVISUALBASE_METHOD_1_E9A575D18A0748D9_OFFSET UNITYSDK_OFFSET(0xAB26280)
#define RPG_CLIENT_MUSICVISUALIZATION_SPECTRUMEFFECTELEMENTVISUALBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xAB302A0)

namespace RPG::Client
{
	inline static constexpr unsigned int MusicVisualization_SpectrumEffectElementVisualBase_TypeDefinitionIndex = 65316;
