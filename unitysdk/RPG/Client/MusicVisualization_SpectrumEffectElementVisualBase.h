...
#define RPG_CLIENT_MUSICVISUALIZATION_SPECTRUMEFFECTELEMENTVISUALBASE_METHOD_1_1B839C6E2E9774D0_1_OFFSET UNITYSDK_OFFSET(0x18E9CC20)
#define RPG_CLIENT_MUSICVISUALIZATION_SPECTRUMEFFECTELEMENTVISUALBASE_METHOD_1_1B839C6E2E9774D0_OFFSET UNITYSDK_OFFSET(0x18E9CA50)
#define RPG_CLIENT_MUSICVISUALIZATION_SPECTRUMEFFECTELEMENTVISUALBASE_METHOD_1_4EF1C1799390414B_OFFSET UNITYSDK_OFFSET(0x18E9D780)
#define RPG_CLIENT_MUSICVISUALIZATION_SPECTRUMEFFECTELEMENTVISUALBASE_METHOD_1_818C8938061AC0D4_OFFSET UNITYSDK_OFFSET(0x18EA6E90)
#define RPG_CLIENT_MUSICVISUALIZATION_SPECTRUMEFFECTELEMENTVISUALBASE_METHOD_1_90589AE08EBFDB6A_OFFSET UNITYSDK_OFFSET(0x18E9C4D0)
#define RPG_CLIENT_MUSICVISUALIZATION_SPECTRUMEFFECTELEMENTVISUALBASE_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x18EA6E50)
#define RPG_CLIENT_MUSICVISUALIZATION_SPECTRUMEFFECTELEMENTVISUALBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x18EA70E0)

namespace RPG::Client
{
	inline static constexpr unsigned int MusicVisualization_SpectrumEffectElementVisualBase_TypeDefinitionIndex = 67668;
