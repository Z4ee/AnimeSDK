...
#define RPG_CLIENT_CREATEPLAYEREFFECTCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xB714A10)
#define RPG_CLIENT_CREATEPLAYEREFFECTCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xB714900)
#define RPG_CLIENT_CREATEPLAYEREFFECTCONTROLLER_PLAYEFFECT_OFFSET UNITYSDK_OFFSET(0xB714BC0)
#define RPG_CLIENT_CREATEPLAYEREFFECTCONTROLLER_SETDOF_OFFSET UNITYSDK_OFFSET(0xB714F00)
#define RPG_CLIENT_CREATEPLAYEREFFECTCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0xB714770)
#define RPG_CLIENT_CREATEPLAYEREFFECTCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB7150E0)
#define RPG_CLIENT_CREATEPLAYEREFFECTCONTROLLER__INITUI3DCAMERA_OFFSET UNITYSDK_OFFSET(0xB714880)

namespace RPG::Client
{
	inline static constexpr unsigned int CreatePlayerEffectController_TypeDefinitionIndex = 68114;
