...
#define RPG_CLIENT_CREATEPLAYEREFFECTCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x94272F0)
#define RPG_CLIENT_CREATEPLAYEREFFECTCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x94271E0)
#define RPG_CLIENT_CREATEPLAYEREFFECTCONTROLLER_PLAYEFFECT_OFFSET UNITYSDK_OFFSET(0x9427490)
#define RPG_CLIENT_CREATEPLAYEREFFECTCONTROLLER_SETDOF_OFFSET UNITYSDK_OFFSET(0x94277D0)
#define RPG_CLIENT_CREATEPLAYEREFFECTCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0x9427050)
#define RPG_CLIENT_CREATEPLAYEREFFECTCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x94279B0)
#define RPG_CLIENT_CREATEPLAYEREFFECTCONTROLLER__INITUI3DCAMERA_OFFSET UNITYSDK_OFFSET(0x9427160)

namespace RPG::Client
{
	inline static constexpr unsigned int CreatePlayerEffectController_TypeDefinitionIndex = 59775;
