...
#define RPG_CLIENT_SPRINGBONECOMMONCONFIG_GET_NAMEHASH_OFFSET UNITYSDK_OFFSET(0x18919EE0)
#define RPG_CLIENT_SPRINGBONECOMMONCONFIG_SET_NAMEHASH_OFFSET UNITYSDK_OFFSET(0x18919EF0)
#define RPG_CLIENT_SPRINGBONECOMMONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18919F00)

namespace RPG::Client
{
	inline static constexpr unsigned int SpringBoneCommonConfig_TypeDefinitionIndex = 57397;
