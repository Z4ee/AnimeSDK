...
#define RPG_CLIENT_SPRINGBONECOMMONCONFIG_GET_NAMEHASH_OFFSET UNITYSDK_OFFSET(0xA4B4D40)
#define RPG_CLIENT_SPRINGBONECOMMONCONFIG_SET_NAMEHASH_OFFSET UNITYSDK_OFFSET(0xA4B4D50)
#define RPG_CLIENT_SPRINGBONECOMMONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xA4B4D60)

namespace RPG::Client
{
	inline static constexpr unsigned int SpringBoneCommonConfig_TypeDefinitionIndex = 48663;
