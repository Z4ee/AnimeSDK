...
#define RPG_CLIENT_CHALLENGESTORYDATA_GETALLWAVEMONSTERDATABYSTAGEINDEXANDEVENTINDEX_OFFSET UNITYSDK_OFFSET(0xB57A1E0)
#define RPG_CLIENT_CHALLENGESTORYDATA_GETDESCRIPTIONPARAMS_OFFSET UNITYSDK_OFFSET(0xB57A190)
#define RPG_CLIENT_CHALLENGESTORYDATA_GETDESCRIPTION_OFFSET UNITYSDK_OFFSET(0xB57A0E0)
#define RPG_CLIENT_CHALLENGESTORYDATA_GET_STORYEXTRAINFOROW_OFFSET UNITYSDK_OFFSET(0xB57A0C0)
#define RPG_CLIENT_CHALLENGESTORYDATA_SET_STORYEXTRAINFOROW_OFFSET UNITYSDK_OFFSET(0xB57A0D0)
#define RPG_CLIENT_CHALLENGESTORYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB55A6B0)
#define RPG_CLIENT_CHALLENGESTORYDATA___IFIXBASEPROXY_GETALLWAVEMONSTERDATABYSTAGEINDEXANDEVENTINDEX_OFFSET UNITYSDK_OFFSET(0xB57A470)
#define RPG_CLIENT_CHALLENGESTORYDATA___IFIXBASEPROXY_GETDESCRIPTIONPARAMS_OFFSET UNITYSDK_OFFSET(0xB57A460)
#define RPG_CLIENT_CHALLENGESTORYDATA___IFIXBASEPROXY_GETDESCRIPTION_OFFSET UNITYSDK_OFFSET(0xB57A430)
