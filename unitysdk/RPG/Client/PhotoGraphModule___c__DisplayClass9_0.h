...
#define RPG_CLIENT_PHOTOGRAPHMODULE___C__DISPLAYCLASS9_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9F49570)
#define RPG_CLIENT_PHOTOGRAPHMODULE___C__DISPLAYCLASS9_0__GETROAMINGCONFIG_B__0_OFFSET UNITYSDK_OFFSET(0x9F4A4B0)

namespace RPG::Client
{
	inline static constexpr unsigned int PhotoGraphModule___c__DisplayClass9_0_TypeDefinitionIndex = 54054;
