...
#define RPG_CLIENT_CRPLENSFLAREPLUGIN_METHOD_5_079E5C91214C7EF3_OFFSET UNITYSDK_OFFSET(0xB456B60)
#define RPG_CLIENT_CRPLENSFLAREPLUGIN_METHOD_5_E11AC65AA0DC2249_OFFSET UNITYSDK_OFFSET(0xB456FE0)
#define RPG_CLIENT_CRPLENSFLAREPLUGIN_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xB456240)
#define RPG_CLIENT_CRPLENSFLAREPLUGIN_ONENABLE_OFFSET UNITYSDK_OFFSET(0xB457460)
#define RPG_CLIENT_CRPLENSFLAREPLUGIN_UPDATELENSFLARE_OFFSET UNITYSDK_OFFSET(0xB457420)
#define RPG_CLIENT_CRPLENSFLAREPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xB4575C0)

namespace RPG::Client
{
	inline static constexpr unsigned int CRPLensFlarePlugin_TypeDefinitionIndex = 65608;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_CRPLENSFLAREPLUGIN_METHOD_5_E11AC65AA0DC2249_OFFSET))(this);
		}
