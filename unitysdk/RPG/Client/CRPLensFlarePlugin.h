...
#define RPG_CLIENT_CRPLENSFLAREPLUGIN_METHOD_5_079E5C91214C7EF3_OFFSET UNITYSDK_OFFSET(0x1A11CDB0)
#define RPG_CLIENT_CRPLENSFLAREPLUGIN_METHOD_5_E41B6A823556FEEA_OFFSET UNITYSDK_OFFSET(0x1A11D230)
#define RPG_CLIENT_CRPLENSFLAREPLUGIN_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1A11C400)
#define RPG_CLIENT_CRPLENSFLAREPLUGIN_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A11D6C0)
#define RPG_CLIENT_CRPLENSFLAREPLUGIN_UPDATELENSFLARE_OFFSET UNITYSDK_OFFSET(0x1A11D680)
#define RPG_CLIENT_CRPLENSFLAREPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1A11D820)
