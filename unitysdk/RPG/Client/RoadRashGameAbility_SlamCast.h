...
#define RPG_CLIENT_ROADRASHGAMEABILITY_SLAMCAST_METHOD_4_1822A26C1A12F9DE_OFFSET UNITYSDK_OFFSET(0x1CD5A6F0)
#define RPG_CLIENT_ROADRASHGAMEABILITY_SLAMCAST_METHOD_4_39EC3C026D5C72BD_OFFSET UNITYSDK_OFFSET(0x1CD5A730)
#define RPG_CLIENT_ROADRASHGAMEABILITY_SLAMCAST__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD5A720)
