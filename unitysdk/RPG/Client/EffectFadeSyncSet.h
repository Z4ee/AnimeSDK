...
#define RPG_CLIENT_EFFECTFADESYNCSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6A53F0)

namespace RPG::Client
{
	inline static constexpr unsigned int EffectFadeSyncSet_TypeDefinitionIndex = 69840;
