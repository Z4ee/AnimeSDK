...
#define RPG_CLIENT_EFFECTSCREENADAPTERMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xA1B9620)

namespace RPG::Client
{
	inline static constexpr unsigned int EffectScreenAdapterMonoPlugin_TypeDefinitionIndex = 64919;
