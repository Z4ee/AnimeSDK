...
#define RPG_CLIENT_EFFECTSCREENADAPTERMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x15E49050)

namespace RPG::Client
{
	inline static constexpr unsigned int EffectScreenAdapterMonoPlugin_TypeDefinitionIndex = 70384;
