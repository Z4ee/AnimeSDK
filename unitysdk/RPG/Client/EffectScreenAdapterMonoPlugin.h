...
#define RPG_CLIENT_EFFECTSCREENADAPTERMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x95368F0)

namespace RPG::Client
{
	inline static constexpr unsigned int EffectScreenAdapterMonoPlugin_TypeDefinitionIndex = 57655;
