...
#define RPG_CLIENT_ERAFLIPPERMANAGERDEBUG_METHOD_5_9D455FE4693966A8_OFFSET UNITYSDK_OFFSET(0xCECC310)
#define RPG_CLIENT_ERAFLIPPERMANAGERDEBUG_METHOD_5_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xCECC390)
#define RPG_CLIENT_ERAFLIPPERMANAGERDEBUG__CTOR_OFFSET UNITYSDK_OFFSET(0xCECC3A0)
