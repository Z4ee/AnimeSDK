...
#define RPG_CLIENT_ERAFLIPPERMANAGERDEBUG_METHOD_5_EBBC49A9109F0F2F_OFFSET UNITYSDK_OFFSET(0x9628D30)
#define RPG_CLIENT_ERAFLIPPERMANAGERDEBUG_METHOD_5_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x9628DB0)
#define RPG_CLIENT_ERAFLIPPERMANAGERDEBUG__CTOR_OFFSET UNITYSDK_OFFSET(0x9628DC0)

namespace RPG::Client
{
	inline static constexpr unsigned int EraFlipperManagerDebug_TypeDefinitionIndex = 49003;
