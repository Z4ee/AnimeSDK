...
#define RPG_CLIENT_ERAFLIPPERMANAGERDEBUG_METHOD_5_9D455FE4693966A8_OFFSET UNITYSDK_OFFSET(0x17CE2470)
#define RPG_CLIENT_ERAFLIPPERMANAGERDEBUG_METHOD_5_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x17CE24F0)
#define RPG_CLIENT_ERAFLIPPERMANAGERDEBUG__CTOR_OFFSET UNITYSDK_OFFSET(0x17CE2500)

namespace RPG::Client
{
	inline static constexpr unsigned int EraFlipperManagerDebug_TypeDefinitionIndex = 57792;
