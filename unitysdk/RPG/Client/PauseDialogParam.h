...
#define RPG_CLIENT_PAUSEDIALOGPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xDA458C0)

namespace RPG::Client
{
	inline static constexpr unsigned int PauseDialogParam_TypeDefinitionIndex = 71598;

	class PauseDialogParam : public ::System::Object
	{
	public:
		::System::Boolean IsExitBattleBtnDisable; // 0x10
		::System::Boolean IsExitBattleBtnShow; // 0x11
