...
#define RPG_CLIENT_ASSISTANTTIPSDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xC783260)
#define RPG_CLIENT_ASSISTANTTIPSDATA_GET_CONTENT_OFFSET UNITYSDK_OFFSET(0xC783500)
#define RPG_CLIENT_ASSISTANTTIPSDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0xC7833E0)
#define RPG_CLIENT_ASSISTANTTIPSDATA_GET_PARAMLIST_OFFSET UNITYSDK_OFFSET(0xC7835C0)
#define RPG_CLIENT_ASSISTANTTIPSDATA_GET_TIPSRULE_OFFSET UNITYSDK_OFFSET(0xC783400)
#define RPG_CLIENT_ASSISTANTTIPSDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xC7834A0)
#define RPG_CLIENT_ASSISTANTTIPSDATA_SET_ID_OFFSET UNITYSDK_OFFSET(0xC7833F0)
#define RPG_CLIENT_ASSISTANTTIPSDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC7833D0)
