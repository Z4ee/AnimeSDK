...
#define RPG_CLIENT_ASSISTANTTIPSDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1B333DD0)
#define RPG_CLIENT_ASSISTANTTIPSDATA_GET_CONTENT_OFFSET UNITYSDK_OFFSET(0x1B334070)
#define RPG_CLIENT_ASSISTANTTIPSDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0x1B333F50)
#define RPG_CLIENT_ASSISTANTTIPSDATA_GET_PARAMLIST_OFFSET UNITYSDK_OFFSET(0x1B334130)
#define RPG_CLIENT_ASSISTANTTIPSDATA_GET_TIPSRULE_OFFSET UNITYSDK_OFFSET(0x1B333F70)
#define RPG_CLIENT_ASSISTANTTIPSDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0x1B334010)
#define RPG_CLIENT_ASSISTANTTIPSDATA_SET_ID_OFFSET UNITYSDK_OFFSET(0x1B333F60)
#define RPG_CLIENT_ASSISTANTTIPSDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B333F40)

namespace RPG::Client
{
	inline static constexpr unsigned int AssistantTipsData_TypeDefinitionIndex = 62522;
