...
#define RPG_CLIENT_BYCANPLANETFESLEVELUP_METHOD_4_55F879832F736708_OFFSET UNITYSDK_OFFSET(0x1B9E2870)
#define RPG_CLIENT_BYCANPLANETFESLEVELUP_METHOD_4_730F80178A024FD1_OFFSET UNITYSDK_OFFSET(0x1B9E2840)
#define RPG_CLIENT_BYCANPLANETFESLEVELUP_METHOD_4_7B1515D662FB7098_OFFSET UNITYSDK_OFFSET(0x1B9E26C0)
#define RPG_CLIENT_BYCANPLANETFESLEVELUP_METHOD_4_FAF58B019465EA2B_OFFSET UNITYSDK_OFFSET(0x1B9E2700)
#define RPG_CLIENT_BYCANPLANETFESLEVELUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9E26F0)

namespace RPG::Client
{
	inline static constexpr unsigned int ByCanPlanetFesLevelUp_TypeDefinitionIndex = 9959;
