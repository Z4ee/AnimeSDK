...
#define RPG_CLIENT_ROGUETOURNNULLGAMEDATA_GETMONSTERELITEDROPID_OFFSET UNITYSDK_OFFSET(0x1AA58330)
#define RPG_CLIENT_ROGUETOURNNULLGAMEDATA_GETROGUEAVATARCOLLECTION_OFFSET UNITYSDK_OFFSET(0x1AA58280)
#define RPG_CLIENT_ROGUETOURNNULLGAMEDATA_GETROGUEBLACKBOARDINFO_OFFSET UNITYSDK_OFFSET(0x1AA583C0)
#define RPG_CLIENT_ROGUETOURNNULLGAMEDATA_GETROGUEDEBUGINFO_OFFSET UNITYSDK_OFFSET(0x1AA58370)
#define RPG_CLIENT_ROGUETOURNNULLGAMEDATA_GET_AREAGROUP_OFFSET UNITYSDK_OFFSET(0x1AA584C0)
#define RPG_CLIENT_ROGUETOURNNULLGAMEDATA_GET_AREAID_OFFSET UNITYSDK_OFFSET(0x1AA58480)
#define RPG_CLIENT_ROGUETOURNNULLGAMEDATA_GET_BLACKBOARDINFO_OFFSET UNITYSDK_OFFSET(0x1AA58690)
#define RPG_CLIENT_ROGUETOURNNULLGAMEDATA_GET_DIFFICULTY_OFFSET UNITYSDK_OFFSET(0x1AA58520)
#define RPG_CLIENT_ROGUETOURNNULLGAMEDATA_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1AA4C8C0)
#define RPG_CLIENT_ROGUETOURNNULLGAMEDATA_GET_ISCANUSECONSUMEITEM_OFFSET UNITYSDK_OFFSET(0x1AA585C0)
#define RPG_CLIENT_ROGUETOURNNULLGAMEDATA_GET_LEVELINFO_OFFSET UNITYSDK_OFFSET(0x1AA58650)
#define RPG_CLIENT_ROGUETOURNNULLGAMEDATA_GET_REPORTTRANSNO_OFFSET UNITYSDK_OFFSET(0x1AA58600)
#define RPG_CLIENT_ROGUETOURNNULLGAMEDATA_GET_SERVERCONTROLLERID_OFFSET UNITYSDK_OFFSET(0x1AA58440)
#define RPG_CLIENT_ROGUETOURNNULLGAMEDATA_GET_SETTLERESULTFACTORY_OFFSET UNITYSDK_OFFSET(0x1AA586A0)
#define RPG_CLIENT_ROGUETOURNNULLGAMEDATA_GET_TOURNMODE_OFFSET UNITYSDK_OFFSET(0x1AA58400)
#define RPG_CLIENT_ROGUETOURNNULLGAMEDATA_INIT_OFFSET UNITYSDK_OFFSET(0x1AA58240)
#define RPG_CLIENT_ROGUETOURNNULLGAMEDATA_SYNC_OFFSET UNITYSDK_OFFSET(0x1AA582E0)
#define RPG_CLIENT_ROGUETOURNNULLGAMEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA58210)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueTournNullGameData_TypeDefinitionIndex = 64651;
	...
	public:
		...
		{
			return (::RPG::Client::RogueTournNullGameData**)Il2CppClass::FromTypeDefinitionIndex(RogueTournNullGameData_TypeDefinitionIndex)->GetStaticField(0x2C220);
		}
		...
		{
			return ((::Class_0_16E4307DCC419505_937*(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_ROGUETOURNNULLGAMEDATA_GET_SETTLERESULTFACTORY_OFFSET))(this);
		}
	};
}
