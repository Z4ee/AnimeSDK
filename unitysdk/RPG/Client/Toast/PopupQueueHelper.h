...
#define RPG_CLIENT_TOAST_POPUPQUEUEHELPER_ISSOFAWINDOW_OFFSET UNITYSDK_OFFSET(0x197BA2E0)

namespace RPG::Client::Toast
{
	inline static constexpr unsigned int PopupQueueHelper_TypeDefinitionIndex = 78531;
