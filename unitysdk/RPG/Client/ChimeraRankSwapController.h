...
#define RPG_CLIENT_CHIMERARANKSWAPCONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0x93C8D00)
#define RPG_CLIENT_CHIMERARANKSWAPCONTROLLER_CREATEVIRTUALTEAMLIST_OFFSET UNITYSDK_OFFSET(0x93C9600)
#define RPG_CLIENT_CHIMERARANKSWAPCONTROLLER_STARTRANKINCREASEANDSWAP_OFFSET UNITYSDK_OFFSET(0x93C95A0)
#define RPG_CLIENT_CHIMERARANKSWAPCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x93C8FD0)
#define RPG_CLIENT_CHIMERARANKSWAPCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x93CA1B0)
#define RPG_CLIENT_CHIMERARANKSWAPCONTROLLER__GETTARGETMAXSLIDERVALUE_OFFSET UNITYSDK_OFFSET(0x93C9D60)
#define RPG_CLIENT_CHIMERARANKSWAPCONTROLLER__INITVIRTUALTEAMRANK_OFFSET UNITYSDK_OFFSET(0x93C9910)
#define RPG_CLIENT_CHIMERARANKSWAPCONTROLLER__ONRANKINCREASEFINISH_OFFSET UNITYSDK_OFFSET(0x93C91C0)
#define RPG_CLIENT_CHIMERARANKSWAPCONTROLLER__REFRESHVIRTUALTEAMRANK_OFFSET UNITYSDK_OFFSET(0x93C9430)
#define RPG_CLIENT_CHIMERARANKSWAPCONTROLLER__VIRTUALTEAMINCREASE_OFFSET UNITYSDK_OFFSET(0x93C9220)
#define RPG_CLIENT_CHIMERARANKSWAPCONTROLLER___REFRESHVIRTUALTEAMRANK_B__5_0_OFFSET UNITYSDK_OFFSET(0x93CA1C0)

namespace RPG::Client
{
	inline static constexpr unsigned int ChimeraRankSwapController_TypeDefinitionIndex = 59384;
