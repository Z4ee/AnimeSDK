...
#define RPG_CLIENT_GRIDFIGHTGAMEREF___C__DISPLAYCLASS4_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA4C4780)
#define RPG_CLIENT_GRIDFIGHTGAMEREF___C__DISPLAYCLASS4_0__SENDGETGAMEREFSTATICDATAAPIHTTPREQ_B__0_OFFSET UNITYSDK_OFFSET(0xA4C4790)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightGameRef___c__DisplayClass4_0_TypeDefinitionIndex = 59560;
