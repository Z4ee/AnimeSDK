...
#define RPG_CLIENT_EXPEDITIONBATTLESTARINFODETAILVIEWMODEL_GET_RANKVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCF03E00)
#define RPG_CLIENT_EXPEDITIONBATTLESTARINFODETAILVIEWMODEL_GET_STARCOUNT_OFFSET UNITYSDK_OFFSET(0xCF03E20)
#define RPG_CLIENT_EXPEDITIONBATTLESTARINFODETAILVIEWMODEL_SET_RANKVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCF03E10)
#define RPG_CLIENT_EXPEDITIONBATTLESTARINFODETAILVIEWMODEL_SET_STARCOUNT_OFFSET UNITYSDK_OFFSET(0xCF03E30)
#define RPG_CLIENT_EXPEDITIONBATTLESTARINFODETAILVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xCF03E40)
