...
#define RPG_CLIENT_BAT_BATCONTROLLERBASE_GET_GPUDRIVEN_OFFSET UNITYSDK_OFFSET(0x9DC44C0)
#define RPG_CLIENT_BAT_BATCONTROLLERBASE_GET_MODE_OFFSET UNITYSDK_OFFSET(0x9DC48D0)
#define RPG_CLIENT_BAT_BATCONTROLLERBASE_GET_TOTALCOUNT_OFFSET UNITYSDK_OFFSET(0x9DC4BD0)
#define RPG_CLIENT_BAT_BATCONTROLLERBASE_GET_VALIDFORCULLING_OFFSET UNITYSDK_OFFSET(0x9DC4BB0)
#define RPG_CLIENT_BAT_BATCONTROLLERBASE_GET_VALIDFORRENDERING_OFFSET UNITYSDK_OFFSET(0x9DC49A0)
#define RPG_CLIENT_BAT_BATCONTROLLERBASE_GET__PROTOTYPECOUNT_OFFSET UNITYSDK_OFFSET(0x9DC4460)
#define RPG_CLIENT_BAT_BATCONTROLLERBASE_METHOD_1_2566AD459572DFC3_OFFSET UNITYSDK_OFFSET(0x9DC4880)
#define RPG_CLIENT_BAT_BATCONTROLLERBASE_METHOD_1_6916CB2AB9451DD7_OFFSET UNITYSDK_OFFSET(0x9DC4580)
#define RPG_CLIENT_BAT_BATCONTROLLERBASE_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x9DC48E0)
#define RPG_CLIENT_BAT_BATCONTROLLERBASE_METHOD_1_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0x9DC4920)
#define RPG_CLIENT_BAT_BATCONTROLLERBASE_METHOD_1_CA373AA1C7054598_3_OFFSET UNITYSDK_OFFSET(0x9DC4960)
#define RPG_CLIENT_BAT_BATCONTROLLERBASE_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x9DC4530)
#define RPG_CLIENT_BAT_BATCONTROLLERBASE_METHOD_1_EB7282B6745B4611_OFFSET UNITYSDK_OFFSET(0x9DC3AF0)
#define RPG_CLIENT_BAT_BATCONTROLLERBASE_SET_TOTALCOUNT_OFFSET UNITYSDK_OFFSET(0x9DC4BE0)
#define RPG_CLIENT_BAT_BATCONTROLLERBASE__CCTOR_OFFSET UNITYSDK_OFFSET(0x9DC4C00)
#define RPG_CLIENT_BAT_BATCONTROLLERBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x9DC4BF0)

namespace RPG::Client::BAT
{
	inline static constexpr unsigned int BATControllerBase_TypeDefinitionIndex = 67800;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(BATControllerBase_TypeDefinitionIndex)->GetStaticField(0xD3A0);
		}
		static ::System::Int32* StaticGet__InstanceDataOffsetShaderProperty()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(BATControllerBase_TypeDefinitionIndex)->GetStaticField(0xD3A4);
		}
