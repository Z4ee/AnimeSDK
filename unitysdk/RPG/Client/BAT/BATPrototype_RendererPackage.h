...
#define RPG_CLIENT_BAT_BATPROTOTYPE_RENDERERPACKAGE_GET_VALIDFORRENDERING_OFFSET UNITYSDK_OFFSET(0x9DC5C20)
#define RPG_CLIENT_BAT_BATPROTOTYPE_RENDERERPACKAGE_GET_VERTEXCOUNT_OFFSET UNITYSDK_OFFSET(0x9DC5BC0)
#define RPG_CLIENT_BAT_BATPROTOTYPE_RENDERERPACKAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x9DC5CA0)

namespace RPG::Client::BAT
{
	inline static constexpr unsigned int BATPrototype_RendererPackage_TypeDefinitionIndex = 67806;
