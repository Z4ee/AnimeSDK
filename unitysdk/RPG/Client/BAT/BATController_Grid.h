...
#define RPG_CLIENT_BAT_BATCONTROLLER_GRID_GET_MODE_OFFSET UNITYSDK_OFFSET(0x9163210)
#define RPG_CLIENT_BAT_BATCONTROLLER_GRID_GET__GRIDCOUNT_OFFSET UNITYSDK_OFFSET(0x9163290)
#define RPG_CLIENT_BAT_BATCONTROLLER_GRID_METHOD_2_A2172401030892FD_OFFSET UNITYSDK_OFFSET(0x91634E0)
#define RPG_CLIENT_BAT_BATCONTROLLER_GRID_METHOD_2_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x9163DF0)
#define RPG_CLIENT_BAT_BATCONTROLLER_GRID_METHOD_2_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0x9163E30)
#define RPG_CLIENT_BAT_BATCONTROLLER_GRID_METHOD_2_CA373AA1C7054598_3_OFFSET UNITYSDK_OFFSET(0x9163E70)
#define RPG_CLIENT_BAT_BATCONTROLLER_GRID_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x9163CA0)
#define RPG_CLIENT_BAT_BATCONTROLLER_GRID_METHOD_2_F4C8B018D655630D_OFFSET UNITYSDK_OFFSET(0x91632E0)
#define RPG_CLIENT_BAT_BATCONTROLLER_GRID__CTOR_OFFSET UNITYSDK_OFFSET(0x9163CF0)
#define RPG_CLIENT_BAT_BATCONTROLLER_GRID___IFIXBASEPROXY_GET_MODE_OFFSET UNITYSDK_OFFSET(0x9163DE0)

namespace RPG::Client::BAT
{
	inline static constexpr unsigned int BATController_Grid_TypeDefinitionIndex = 60381;
