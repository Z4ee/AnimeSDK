...
#define RPG_CLIENT_POINTSANIMRENDERMODULE_POINTSANIMRENDERERPACKAGE_METHOD_1_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0xC4AD990)
#define RPG_CLIENT_POINTSANIMRENDERMODULE_POINTSANIMRENDERERPACKAGE_METHOD_1_C46588A6E2C180DB_OFFSET UNITYSDK_OFFSET(0xC4ADD10)
#define RPG_CLIENT_POINTSANIMRENDERMODULE_POINTSANIMRENDERERPACKAGE__CTOR_OFFSET UNITYSDK_OFFSET(0xC4ADB80)

namespace RPG::Client
{
	inline static constexpr unsigned int PointsAnimRenderModule_PointsAnimRendererPackage_TypeDefinitionIndex = 66045;
