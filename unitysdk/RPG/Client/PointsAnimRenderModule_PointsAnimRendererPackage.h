...
#define RPG_CLIENT_POINTSANIMRENDERMODULE_POINTSANIMRENDERERPACKAGE_METHOD_1_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0x1AE170E0)
#define RPG_CLIENT_POINTSANIMRENDERMODULE_POINTSANIMRENDERERPACKAGE_METHOD_1_C46588A6E2C180DB_OFFSET UNITYSDK_OFFSET(0x1AE17380)
#define RPG_CLIENT_POINTSANIMRENDERMODULE_POINTSANIMRENDERERPACKAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE172B0)

namespace RPG::Client
{
	inline static constexpr unsigned int PointsAnimRenderModule_PointsAnimRendererPackage_TypeDefinitionIndex = 70593;
