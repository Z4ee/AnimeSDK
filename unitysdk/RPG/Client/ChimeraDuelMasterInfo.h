...
#define RPG_CLIENT_CHIMERADUELMASTERINFO_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19AE5820)
#define RPG_CLIENT_CHIMERADUELMASTERINFO_GETDATA_OFFSET UNITYSDK_OFFSET(0x19AE1490)
#define RPG_CLIENT_CHIMERADUELMASTERINFO_GETORDEREDMASTER_OFFSET UNITYSDK_OFFSET(0x19AE9B40)
#define RPG_CLIENT_CHIMERADUELMASTERINFO_GET_DATADICT_OFFSET UNITYSDK_OFFSET(0x19AE9B00)
#define RPG_CLIENT_CHIMERADUELMASTERINFO_GET_ISSKIPCONFIRMDIALOG_OFFSET UNITYSDK_OFFSET(0x19AEA470)
#define RPG_CLIENT_CHIMERADUELMASTERINFO_GET_MASTERMONEY_OFFSET UNITYSDK_OFFSET(0x19AEA430)
#define RPG_CLIENT_CHIMERADUELMASTERINFO_SET_ISSKIPCONFIRMDIALOG_OFFSET UNITYSDK_OFFSET(0x19AEA480)
#define RPG_CLIENT_CHIMERADUELMASTERINFO_SET_MASTERMONEY_OFFSET UNITYSDK_OFFSET(0x19AE9E00)
#define RPG_CLIENT_CHIMERADUELMASTERINFO_SYNCMASTERMONEY_OFFSET UNITYSDK_OFFSET(0x19AE9DB0)
#define RPG_CLIENT_CHIMERADUELMASTERINFO_SYNCMASTERPURCHASED_1_OFFSET UNITYSDK_OFFSET(0x19AEA350)
#define RPG_CLIENT_CHIMERADUELMASTERINFO_SYNCMASTERPURCHASED_OFFSET UNITYSDK_OFFSET(0x19AE9EB0)
#define RPG_CLIENT_CHIMERADUELMASTERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19AE4450)

namespace RPG::Client
{
	inline static constexpr unsigned int ChimeraDuelMasterInfo_TypeDefinitionIndex = 60582;
