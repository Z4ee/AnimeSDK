...
#define RPG_CLIENT_ROGUEFORMULASHOPDATA_CLEAR_OFFSET UNITYSDK_OFFSET(0xDEB8FB0)
#define RPG_CLIENT_ROGUEFORMULASHOPDATA_GET_INSHOPITEMS_OFFSET UNITYSDK_OFFSET(0xDEB9A30)
#define RPG_CLIENT_ROGUEFORMULASHOPDATA_GET_REFRESHCOST_OFFSET UNITYSDK_OFFSET(0xDEB9A90)
#define RPG_CLIENT_ROGUEFORMULASHOPDATA_GET_REMAINREFRESHTIMES_OFFSET UNITYSDK_OFFSET(0xDEB9A50)
#define RPG_CLIENT_ROGUEFORMULASHOPDATA_GET_TOTALREFRESHTIMES_OFFSET UNITYSDK_OFFSET(0xDEB9A70)
#define RPG_CLIENT_ROGUEFORMULASHOPDATA_SENDBUYROGUESHOPFORMULACSREQ_OFFSET UNITYSDK_OFFSET(0xDEB91D0)
#define RPG_CLIENT_ROGUEFORMULASHOPDATA_SENDGETROGUESHOPFORMULAINFOCSREQ_OFFSET UNITYSDK_OFFSET(0xDEB9050)
#define RPG_CLIENT_ROGUEFORMULASHOPDATA_SENDREFRESHROGUESHOPFORMULACSREQ_OFFSET UNITYSDK_OFFSET(0xDEB98B0)
#define RPG_CLIENT_ROGUEFORMULASHOPDATA_SET_INSHOPITEMS_OFFSET UNITYSDK_OFFSET(0xDEB9A40)
#define RPG_CLIENT_ROGUEFORMULASHOPDATA_SET_REFRESHCOST_OFFSET UNITYSDK_OFFSET(0xDEB9AA0)
#define RPG_CLIENT_ROGUEFORMULASHOPDATA_SET_REMAINREFRESHTIMES_OFFSET UNITYSDK_OFFSET(0xDEB9A60)
#define RPG_CLIENT_ROGUEFORMULASHOPDATA_SET_TOTALREFRESHTIMES_OFFSET UNITYSDK_OFFSET(0xDEB9A80)
#define RPG_CLIENT_ROGUEFORMULASHOPDATA_SYNCCONFIG_OFFSET UNITYSDK_OFFSET(0xDEB8E10)
#define RPG_CLIENT_ROGUEFORMULASHOPDATA_SYNCITEM_OFFSET UNITYSDK_OFFSET(0xDEB8910)
#define RPG_CLIENT_ROGUEFORMULASHOPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xDEB9AB0)
#define RPG_CLIENT_ROGUEFORMULASHOPDATA__REPORTBUYFORMULA_OFFSET UNITYSDK_OFFSET(0xDEB9300)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueFormulaShopData_TypeDefinitionIndex = 67328;
	...
	public:
		...
		::System::Void SyncItem(::Class_1_D40936EF3BF54118_89* a1)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_D40936EF3BF54118_89*))((::PBYTE)hIl2Cpp + RPG_CLIENT_ROGUEFORMULASHOPDATA_SYNCITEM_OFFSET))(this, a1);
		}
