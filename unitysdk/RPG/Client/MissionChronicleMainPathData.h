...
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_CHECKISCANTAKEMISSION_OFFSET UNITYSDK_OFFSET(0x9BB61A0)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_CHECKISMIDDLEMISSIONSTATE_OFFSET UNITYSDK_OFFSET(0x9BB6DE0)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_CHECKISPREDICTION_OFFSET UNITYSDK_OFFSET(0x9BB69E0)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9BB4030)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_GETALLSUBGRAPHMISSIONID_OFFSET UNITYSDK_OFFSET(0x9BB5360)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_GETCURPROCESSINGMISSIONDATA_OFFSET UNITYSDK_OFFSET(0x9BB5F00)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_GETSTORYLINEID_OFFSET UNITYSDK_OFFSET(0x9BB6FD0)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_GET_CANTAKEMISSIONPATHIDLIST_OFFSET UNITYSDK_OFFSET(0x9BB6230)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_GET_CHRONICLESUBPATHDICT_OFFSET UNITYSDK_OFFSET(0x9BB8C10)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_GET_CONNECTIONLIST_OFFSET UNITYSDK_OFFSET(0x9BB8BB0)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_GET_CUSTOMUNLOCKCONDITIONCONFIGLIST_OFFSET UNITYSDK_OFFSET(0x9BB8F10)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_GET_FINISHMISSIONID_OFFSET UNITYSDK_OFFSET(0x9BB8B50)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_GET_FIRSTSUBPATHID_OFFSET UNITYSDK_OFFSET(0x9BB8B90)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_GET_ISWORLDUNLOCKED_OFFSET UNITYSDK_OFFSET(0x9BB8FD0)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_GET_MAINMISSIONID_OFFSET UNITYSDK_OFFSET(0x9BB8C30)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_GET_PARENTLINETYPEMAINPATHDATA_OFFSET UNITYSDK_OFFSET(0x9BB8BF0)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_GET_PARENTMAINPATHLIST_OFFSET UNITYSDK_OFFSET(0x9BB8BD0)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_GET_SUBGRAPHPATH_OFFSET UNITYSDK_OFFSET(0x9BB8B70)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_GET_WORLDPATHDATA_OFFSET UNITYSDK_OFFSET(0x9BB8180)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_INIT_OFFSET UNITYSDK_OFFSET(0x9BB4120)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_ISANYPARENTPATHFINISH_OFFSET UNITYSDK_OFFSET(0x9BB6AB0)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_ISANYPARENTPATHPROCESSINGFINISH_OFFSET UNITYSDK_OFFSET(0x9BB6C30)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_ISCANSTEPNEXTPATH_OFFSET UNITYSDK_OFFSET(0x9BB5070)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_ISCONNECTMISSIONFINISH_OFFSET UNITYSDK_OFFSET(0x9BB5DD0)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_ISNEWLEGAL_OFFSET UNITYSDK_OFFSET(0x9BB6360)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_ISNEW_OFFSET UNITYSDK_OFFSET(0x9BB6280)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_ISWORLDUNLOCK_OFFSET UNITYSDK_OFFSET(0x9BB8120)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_REFRESHEARLYACCESSINFO_OFFSET UNITYSDK_OFFSET(0x9BB7150)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_REFRESHWORLDUNLOCK_OFFSET UNITYSDK_OFFSET(0x9BB82C0)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_SETDATA_OFFSET UNITYSDK_OFFSET(0x9BB4160)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_SETMOCKFINISHNODEDATA_OFFSET UNITYSDK_OFFSET(0x9BB4F60)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_SETSEEN_OFFSET UNITYSDK_OFFSET(0x9BB64F0)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_SET_CHRONICLESUBPATHDICT_OFFSET UNITYSDK_OFFSET(0x9BB8C20)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_SET_CONNECTIONLIST_OFFSET UNITYSDK_OFFSET(0x9BB8BC0)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_SET_FINISHMISSIONID_OFFSET UNITYSDK_OFFSET(0x9BB8B60)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_SET_FIRSTSUBPATHID_OFFSET UNITYSDK_OFFSET(0x9BB8BA0)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_SET_ISWORLDUNLOCKED_OFFSET UNITYSDK_OFFSET(0x9BB8FE0)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_SET_PARENTLINETYPEMAINPATHDATA_OFFSET UNITYSDK_OFFSET(0x9BB8C00)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_SET_PARENTMAINPATHLIST_OFFSET UNITYSDK_OFFSET(0x9BB8BE0)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA_SET_SUBGRAPHPATH_OFFSET UNITYSDK_OFFSET(0x9BB8B80)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA__CHECKISWORLDUNLOCK_OFFSET UNITYSDK_OFFSET(0x9BB8320)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9BB3FB0)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA__GENERATECHRONICLESUBPATH_OFFSET UNITYSDK_OFFSET(0x9BB43E0)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA__GETCURCHRONICLESTATUSBYSELF_OFFSET UNITYSDK_OFFSET(0x9BB7DD0)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA__GETCURCHRONICLESTATUS_OFFSET UNITYSDK_OFFSET(0x9BB5190)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA__GETSTORYLINEID_OFFSET UNITYSDK_OFFSET(0x9BB7040)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA__ISFORCENOTASPREDICTION_OFFSET UNITYSDK_OFFSET(0x9BB6A40)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA__ISNOTHAVESUBPATHTYPE_OFFSET UNITYSDK_OFFSET(0x9BB80D0)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA__ISSUBPATHACTIVE_OFFSET UNITYSDK_OFFSET(0x9BB7FD0)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA__SEARCHEARLYACCESSEFFECTED_OFFSET UNITYSDK_OFFSET(0x9BB7C70)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA__SETASSISTPATHDATALISTEAEFFECTED_OFFSET UNITYSDK_OFFSET(0x9BB8AA0)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA__SETCANTAKEMISSIONPATHIDLIST_OFFSET UNITYSDK_OFFSET(0x9BB8600)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA__SETCONNECTIONWAYDATA_OFFSET UNITYSDK_OFFSET(0x9BB4A30)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA__SETSUBPATHCANTAKEMISSIONLIST_OFFSET UNITYSDK_OFFSET(0x9BB87E0)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA__SETUPCONNECTIONLIST_OFFSET UNITYSDK_OFFSET(0x9BB4250)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA___IFIXBASEPROXY_CHECKISCANTAKEMISSION_OFFSET UNITYSDK_OFFSET(0x9BB9120)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA___IFIXBASEPROXY_CHECKISMIDDLEMISSIONSTATE_OFFSET UNITYSDK_OFFSET(0x9BB9130)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9BB8FF0)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA___IFIXBASEPROXY_GETCURPROCESSINGMISSIONDATA_OFFSET UNITYSDK_OFFSET(0x9BB90E0)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA___IFIXBASEPROXY_GETSTORYLINEID_OFFSET UNITYSDK_OFFSET(0x9BB9170)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA___IFIXBASEPROXY_GET_CUSTOMUNLOCKCONDITIONCONFIGLIST_OFFSET UNITYSDK_OFFSET(0x9BB9240)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA___IFIXBASEPROXY_GET_MAINMISSIONID_OFFSET UNITYSDK_OFFSET(0x9BB9230)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA___IFIXBASEPROXY_GET_WORLDPATHDATA_OFFSET UNITYSDK_OFFSET(0x9BB9250)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA___IFIXBASEPROXY_ISCANSTEPNEXTPATH_OFFSET UNITYSDK_OFFSET(0x9BB9060)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA___IFIXBASEPROXY_ISCONNECTMISSIONFINISH_OFFSET UNITYSDK_OFFSET(0x9BB90A0)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA___IFIXBASEPROXY_ISWORLDUNLOCK_OFFSET UNITYSDK_OFFSET(0x9BB91B0)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA___IFIXBASEPROXY_SETDATA_OFFSET UNITYSDK_OFFSET(0x9BB9000)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA___IFIXBASEPROXY_SETMOCKFINISHNODEDATA_OFFSET UNITYSDK_OFFSET(0x9BB9010)
#define RPG_CLIENT_MISSIONCHRONICLEMAINPATHDATA___IFIXBASEPROXY__GETCURCHRONICLESTATUS_OFFSET UNITYSDK_OFFSET(0x9BB91F0)

namespace RPG::Client
{
	inline static constexpr unsigned int MissionChronicleMainPathData_TypeDefinitionIndex = 53706;

	class MissionChronicleMainPathData : public ::RPG::Client::MissionChronicleBasePathData
	{
	public:
		::System::Collections::Generic::List_1<::RPG::Client::MissionChronicleSubPathData*>* _AssistEAPathDataList; // 0xB0
		::System::Collections::Generic::List_1<::RPG::Client::MissionChronicleMainPathData*>* _ParentMainPathList_k__BackingField; // 0xB8
		::System::String* _SubGraphPath_k__BackingField; // 0xC0
		::System::Collections::Generic::List_1<::RPG::Client::MainChronicleConnectionWay>* _ConnectionList_k__BackingField; // 0xC8
		::RPG::Client::MissionChronicleMainPathData* _ParentLineTypeMainPathData_k__BackingField; // 0xD0
		::System::Collections::Generic::List_1<::System::UInt32>* _CanTakeMissionPathIDList; // 0xD8
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::Client::MissionChronicleSubPathData*>* _ChronicleSubPathDict_k__BackingField; // 0xE0
