...
#define RPG_CLIENT_GRIDFIGHTGAMEREFEXPIREDSUMMARY___C__DISPLAYCLASS26_0__CTOR_OFFSET UNITYSDK_OFFSET(0xD1D1EA0)
#define RPG_CLIENT_GRIDFIGHTGAMEREFEXPIREDSUMMARY___C__DISPLAYCLASS26_0___CTOR_B__5_OFFSET UNITYSDK_OFFSET(0xD1D29A0)
#define RPG_CLIENT_GRIDFIGHTGAMEREFEXPIREDSUMMARY___C__DISPLAYCLASS26_0___CTOR_B__6_OFFSET UNITYSDK_OFFSET(0xD1D29F0)
