...
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xCE684A0)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_EQUALS_OFFSET UNITYSDK_OFFSET(0xCE684F0)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GETDIALOGATTACHPOINT_OFFSET UNITYSDK_OFFSET(0xCE68780)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GETENTITYRUNTIMEID_OFFSET UNITYSDK_OFFSET(0xCE68570)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GETTIPSATTACHTRANSFORM_OFFSET UNITYSDK_OFFSET(0xCE685F0)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_BORNNUMBER_OFFSET UNITYSDK_OFFSET(0xCE69330)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_CURRENTWAVE_OFFSET UNITYSDK_OFFSET(0xCE69B00)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_CUSTOMERID_OFFSET UNITYSDK_OFFSET(0xCE697C0)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_CUSTOMERWAITTIME_OFFSET UNITYSDK_OFFSET(0xCE68C10)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_EMOJIPATH_OFFSET UNITYSDK_OFFSET(0xCE68E90)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_EMOJITYPE_OFFSET UNITYSDK_OFFSET(0xCE68F20)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_EMPLOYEEID_OFFSET UNITYSDK_OFFSET(0xCE69890)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_ENTITY_OFFSET UNITYSDK_OFFSET(0xCE69BE0)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_LIFETIME_OFFSET UNITYSDK_OFFSET(0xCE69250)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_ORDERRECIPEIDLIST_OFFSET UNITYSDK_OFFSET(0xCE68CF0)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_PAYPRICE_OFFSET UNITYSDK_OFFSET(0xCE68A70)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_PREORDERRECIPEIDLIST_OFFSET UNITYSDK_OFFSET(0xCE68DC0)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_SELECTEVENTCONFIG_OFFSET UNITYSDK_OFFSET(0xCE695D0)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_SPECIALBUBBLETEXT_OFFSET UNITYSDK_OFFSET(0xCE69140)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_SPECIALCUSTOMERID_OFFSET UNITYSDK_OFFSET(0xCE696F0)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_TALKTEXT_OFFSET UNITYSDK_OFFSET(0xCE68FF0)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_THUMBCOUNT_OFFSET UNITYSDK_OFFSET(0xCE68B40)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_WAVEORDERCNT_OFFSET UNITYSDK_OFFSET(0xCE69960)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_GET_WAVEWAITTIME_OFFSET UNITYSDK_OFFSET(0xCE69410)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_ISCHEFBUSY_OFFSET UNITYSDK_OFFSET(0xCE689A0)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY_ISWAITERBUSY_OFFSET UNITYSDK_OFFSET(0xCE68910)
#define RPG_CLIENT_ELFRESTAURANTGAMEENTITYPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0xCE68490)
