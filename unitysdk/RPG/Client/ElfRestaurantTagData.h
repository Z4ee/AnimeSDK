...
#define RPG_CLIENT_ELFRESTAURANTTAGDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xCE78D20)
#define RPG_CLIENT_ELFRESTAURANTTAGDATA_GET_COLORID_OFFSET UNITYSDK_OFFSET(0xCE910F0)
#define RPG_CLIENT_ELFRESTAURANTTAGDATA_GET_COLOR_OFFSET UNITYSDK_OFFSET(0xCE91190)
#define RPG_CLIENT_ELFRESTAURANTTAGDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xCE90FD0)
#define RPG_CLIENT_ELFRESTAURANTTAGDATA_GET_TAGID_OFFSET UNITYSDK_OFFSET(0xCE90FB0)
#define RPG_CLIENT_ELFRESTAURANTTAGDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xCE91090)
#define RPG_CLIENT_ELFRESTAURANTTAGDATA_SET_TAGID_OFFSET UNITYSDK_OFFSET(0xCE90FC0)
#define RPG_CLIENT_ELFRESTAURANTTAGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCE90FA0)
