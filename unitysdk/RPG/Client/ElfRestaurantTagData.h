...
#define RPG_CLIENT_ELFRESTAURANTTAGDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x18D68550)
#define RPG_CLIENT_ELFRESTAURANTTAGDATA_GET_COLORID_OFFSET UNITYSDK_OFFSET(0x18D81360)
#define RPG_CLIENT_ELFRESTAURANTTAGDATA_GET_COLOR_OFFSET UNITYSDK_OFFSET(0x18D81400)
#define RPG_CLIENT_ELFRESTAURANTTAGDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0x18D81240)
#define RPG_CLIENT_ELFRESTAURANTTAGDATA_GET_TAGID_OFFSET UNITYSDK_OFFSET(0x18D81220)
#define RPG_CLIENT_ELFRESTAURANTTAGDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0x18D81300)
#define RPG_CLIENT_ELFRESTAURANTTAGDATA_SET_TAGID_OFFSET UNITYSDK_OFFSET(0x18D81230)
#define RPG_CLIENT_ELFRESTAURANTTAGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18D81210)

namespace RPG::Client
{
	inline static constexpr unsigned int ElfRestaurantTagData_TypeDefinitionIndex = 60965;
