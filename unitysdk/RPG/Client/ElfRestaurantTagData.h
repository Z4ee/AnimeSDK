...
#define RPG_CLIENT_ELFRESTAURANTTAGDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1A156AA0)
#define RPG_CLIENT_ELFRESTAURANTTAGDATA_GET_COLORID_OFFSET UNITYSDK_OFFSET(0x1A16EFF0)
#define RPG_CLIENT_ELFRESTAURANTTAGDATA_GET_COLOR_OFFSET UNITYSDK_OFFSET(0x1A16F090)
#define RPG_CLIENT_ELFRESTAURANTTAGDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A16EED0)
#define RPG_CLIENT_ELFRESTAURANTTAGDATA_GET_TAGID_OFFSET UNITYSDK_OFFSET(0x1A16EEB0)
#define RPG_CLIENT_ELFRESTAURANTTAGDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0x1A16EF90)
#define RPG_CLIENT_ELFRESTAURANTTAGDATA_SET_TAGID_OFFSET UNITYSDK_OFFSET(0x1A16EEC0)
#define RPG_CLIENT_ELFRESTAURANTTAGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A16EEA0)

namespace RPG::Client
{
	inline static constexpr unsigned int ElfRestaurantTagData_TypeDefinitionIndex = 63818;
