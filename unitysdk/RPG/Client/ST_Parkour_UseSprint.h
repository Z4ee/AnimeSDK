...
#define RPG_CLIENT_ST_PARKOUR_USESPRINT_METHOD_4_A1E03D6FBE224B76_OFFSET UNITYSDK_OFFSET(0x185EDF30)
#define RPG_CLIENT_ST_PARKOUR_USESPRINT_METHOD_4_D0C6D4B0CB443A76_OFFSET UNITYSDK_OFFSET(0x185EE000)
#define RPG_CLIENT_ST_PARKOUR_USESPRINT__CTOR_OFFSET UNITYSDK_OFFSET(0x185EDFB0)

namespace RPG::Client
{
	inline static constexpr unsigned int ST_Parkour_UseSprint_TypeDefinitionIndex = 10137;
