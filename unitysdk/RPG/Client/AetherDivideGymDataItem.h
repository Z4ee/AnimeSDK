...
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_CLEARNEWSTATUS_OFFSET UNITYSDK_OFFSET(0xB276340)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB275A90)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GETDISPLAYMONSTERDATAS_OFFSET UNITYSDK_OFFSET(0xB276630)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GETSCHEDULEDATA_OFFSET UNITYSDK_OFFSET(0xB276180)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GETSPIRITCOLLECTIONINFO_OFFSET UNITYSDK_OFFSET(0xB275CC0)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GETSTARCOUNT_OFFSET UNITYSDK_OFFSET(0xB276980)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GETTRAINERCHALLENGEINFO_OFFSET UNITYSDK_OFFSET(0xB275E40)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GET_ACTIVITYMODULEID_OFFSET UNITYSDK_OFFSET(0xB276500)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GET_BGPATH_OFFSET UNITYSDK_OFFSET(0xB277340)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GET_DESC_OFFSET UNITYSDK_OFFSET(0xB276F20)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GET_ENTRANCEID_OFFSET UNITYSDK_OFFSET(0xB274D60)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GET_FLOORID_OFFSET UNITYSDK_OFFSET(0xB277480)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GET_GYMINFOROW_OFFSET UNITYSDK_OFFSET(0xB275910)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xB277200)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GET_NAME_OFFSET UNITYSDK_OFFSET(0xB276DB0)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GET_RULE_OFFSET UNITYSDK_OFFSET(0xB277090)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GET__BADGEUNLOCKKEY_OFFSET UNITYSDK_OFFSET(0xB276C30)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_GET__FIRSTUNLOCKKEY_OFFSET UNITYSDK_OFFSET(0xB277550)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_ISALREADYUNLOCKED_OFFSET UNITYSDK_OFFSET(0xB275C80)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_ISBADGEALREADYUNLOCKED_OFFSET UNITYSDK_OFFSET(0xB275AF0)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_ISBADGEUNLOCK_OFFSET UNITYSDK_OFFSET(0xB276450)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_ISNEW_OFFSET UNITYSDK_OFFSET(0xB276260)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0xB275FC0)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_RECORDBADGEUNLOCKEFFECTPLAYED_OFFSET UNITYSDK_OFFSET(0xB276C80)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM_SHOULDPLAYBADGEUNLOCKEFFECT_OFFSET UNITYSDK_OFFSET(0xB276AF0)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM__CTOR_1_OFFSET UNITYSDK_OFFSET(0xB275AE0)
#define RPG_CLIENT_AETHERDIVIDEGYMDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xB275980)

namespace RPG::Client
{
	inline static constexpr unsigned int AetherDivideGymDataItem_TypeDefinitionIndex = 58202;
