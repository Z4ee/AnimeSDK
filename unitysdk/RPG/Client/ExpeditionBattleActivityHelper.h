...
#define RPG_CLIENT_EXPEDITIONBATTLEACTIVITYHELPER_GETACTIVITYREWARDID_OFFSET UNITYSDK_OFFSET(0xCEF6030)
#define RPG_CLIENT_EXPEDITIONBATTLEACTIVITYHELPER_GETRANDOMAVATARICONPATHS_OFFSET UNITYSDK_OFFSET(0xCEF6500)
#define RPG_CLIENT_EXPEDITIONBATTLEACTIVITYHELPER_GETRANDOMMONSTERICONPATHS_OFFSET UNITYSDK_OFFSET(0xCEF6A30)
#define RPG_CLIENT_EXPEDITIONBATTLEACTIVITYHELPER_ISSHOWTIMELIMITREWARDENTRANCENEW_OFFSET UNITYSDK_OFFSET(0xCEF6430)
#define RPG_CLIENT_EXPEDITIONBATTLEACTIVITYHELPER_MARKTIMELIMITREWARDPAGESEEN_OFFSET UNITYSDK_OFFSET(0xCEF64A0)
