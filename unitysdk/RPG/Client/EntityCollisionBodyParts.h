...
#define RPG_CLIENT_ENTITYCOLLISIONBODYPARTS_COMPAREBYPRIORITY_OFFSET UNITYSDK_OFFSET(0xB90FC00)
#define RPG_CLIENT_ENTITYCOLLISIONBODYPARTS_FINDBODYPARTANCHORHITPOSITION_OFFSET UNITYSDK_OFFSET(0xB910230)
#define RPG_CLIENT_ENTITYCOLLISIONBODYPARTS_FINDBODYPARTANCHORMODEL_OFFSET UNITYSDK_OFFSET(0xB9100D0)
#define RPG_CLIENT_ENTITYCOLLISIONBODYPARTS_FINDBODYPARTINDEX_OFFSET UNITYSDK_OFFSET(0xB9103B0)
#define RPG_CLIENT_ENTITYCOLLISIONBODYPARTS_METHOD_5_5F32FD20E92D0466_OFFSET UNITYSDK_OFFSET(0xB910750)
#define RPG_CLIENT_ENTITYCOLLISIONBODYPARTS_SETUPPARTSMAPPING_OFFSET UNITYSDK_OFFSET(0xB90FE80)
#define RPG_CLIENT_ENTITYCOLLISIONBODYPARTS_TRIGGERBODYPARTHITANIMSTATE_OFFSET UNITYSDK_OFFSET(0xB910500)
#define RPG_CLIENT_ENTITYCOLLISIONBODYPARTS_UPDATE_OFFSET UNITYSDK_OFFSET(0xB910BE0)
#define RPG_CLIENT_ENTITYCOLLISIONBODYPARTS__CTOR_OFFSET UNITYSDK_OFFSET(0xB910CE0)

namespace RPG::Client
{
	inline static constexpr unsigned int EntityCollisionBodyParts_TypeDefinitionIndex = 63998;
