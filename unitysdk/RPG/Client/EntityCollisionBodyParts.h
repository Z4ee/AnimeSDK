...
#define RPG_CLIENT_ENTITYCOLLISIONBODYPARTS_COMPAREBYPRIORITY_OFFSET UNITYSDK_OFFSET(0x9602490)
#define RPG_CLIENT_ENTITYCOLLISIONBODYPARTS_FINDBODYPARTANCHORHITPOSITION_OFFSET UNITYSDK_OFFSET(0x9602A60)
#define RPG_CLIENT_ENTITYCOLLISIONBODYPARTS_FINDBODYPARTANCHORMODEL_OFFSET UNITYSDK_OFFSET(0x9602920)
#define RPG_CLIENT_ENTITYCOLLISIONBODYPARTS_FINDBODYPARTINDEX_OFFSET UNITYSDK_OFFSET(0x9602BD0)
#define RPG_CLIENT_ENTITYCOLLISIONBODYPARTS_METHOD_5_5F32FD20E92D0466_OFFSET UNITYSDK_OFFSET(0x9602F70)
#define RPG_CLIENT_ENTITYCOLLISIONBODYPARTS_SETUPPARTSMAPPING_OFFSET UNITYSDK_OFFSET(0x9602700)
#define RPG_CLIENT_ENTITYCOLLISIONBODYPARTS_TRIGGERBODYPARTHITANIMSTATE_OFFSET UNITYSDK_OFFSET(0x9602D20)
#define RPG_CLIENT_ENTITYCOLLISIONBODYPARTS_UPDATE_OFFSET UNITYSDK_OFFSET(0x9603400)
#define RPG_CLIENT_ENTITYCOLLISIONBODYPARTS__CTOR_OFFSET UNITYSDK_OFFSET(0x9603520)

namespace RPG::Client
{
	inline static constexpr unsigned int EntityCollisionBodyParts_TypeDefinitionIndex = 55847;
