...
#define RPG_CLIENT_GRIDFIGHTFLOWDIRECTOR_PREPAREUNFINISHEDGAMEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0xBB3CA60)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightFlowDirector_PrepareUnfinishedGameEvent_TypeDefinitionIndex = 60375;
