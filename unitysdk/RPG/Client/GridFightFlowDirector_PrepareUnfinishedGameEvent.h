...
#define RPG_CLIENT_GRIDFIGHTFLOWDIRECTOR_PREPAREUNFINISHEDGAMEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0xA49D260)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightFlowDirector_PrepareUnfinishedGameEvent_TypeDefinitionIndex = 59440;
