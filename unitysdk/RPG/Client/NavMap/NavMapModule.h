...
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE_CLEARMAPDATA_OFFSET UNITYSDK_OFFSET(0xAB630E0)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE_GETCARTOGRAPHERENTITYIN_OFFSET UNITYSDK_OFFSET(0xAB65720)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE_GETCARTOGRAPHERMAPPINGINFOIDIN_1_OFFSET UNITYSDK_OFFSET(0xAB66D10)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE_GETCARTOGRAPHERMAPPINGINFOIDIN_OFFSET UNITYSDK_OFFSET(0xAB66470)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE_GETCARTOGRAPHERPLAYERIN_OFFSET UNITYSDK_OFFSET(0xAB3EDD0)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE_GETCARTOGRAPHERSUBMISSIONIN_OFFSET UNITYSDK_OFFSET(0xAB65550)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE_GETENTRYIDBYFLOORID_OFFSET UNITYSDK_OFFSET(0xAB469A0)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE_GETFIVEDIMINSTANCECONTAINSCHESTMONSTERLIMAO_OFFSET UNITYSDK_OFFSET(0xAB62560)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE_GETFIVEDIMINSTANCECONTAINSCHEST_OFFSET UNITYSDK_OFFSET(0xAB62450)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE_GETFIVEDIMINSTANCECONTAINSCOLLECTIONDATA_OFFSET UNITYSDK_OFFSET(0xAB62670)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE_GETMAPDATASOURCE_1_OFFSET UNITYSDK_OFFSET(0xAB4DE00)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE_GETMAPDATASOURCE_OFFSET UNITYSDK_OFFSET(0xAB5DDC0)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE_GETPLANEIDBYFLOORID_OFFSET UNITYSDK_OFFSET(0xAB49F50)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE_GETPLAYERLOCATEDMAINTAB_OFFSET UNITYSDK_OFFSET(0xAB670D0)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE_GETPLAYERLOCATEDSUBNAVMAP_OFFSET UNITYSDK_OFFSET(0xAB64CD0)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE_GETPLAYERLOCATEDSUBTAB_OFFSET UNITYSDK_OFFSET(0xAB652B0)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE_GETRAIDSUBTAB_OFFSET UNITYSDK_OFFSET(0xAB66D90)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE_GETSUBTABFLOORID_OFFSET UNITYSDK_OFFSET(0xAB4F930)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE_GETSYNCEDMAPDATASOURCE_OFFSET UNITYSDK_OFFSET(0xAB4E540)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE_GETUNIVERSEDATA_OFFSET UNITYSDK_OFFSET(0xAB65FF0)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE_GET_CURRENTMAPDATASTRATEGY_OFFSET UNITYSDK_OFFSET(0xAB60FC0)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0xAB3ED70)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE_GET_PLAYERLOCATEDVERSE_OFFSET UNITYSDK_OFFSET(0xAB66E50)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE_GET_SUBTABCONDITIONCHECKERS_OFFSET UNITYSDK_OFFSET(0xAB6D6D0)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE_GET_SUBTABCONTAINOTHERFLOORSUBNAVMAPS_OFFSET UNITYSDK_OFFSET(0xAB6D6B0)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE_GET_SUBTABCONTAINSAMEFLOORSUBNAVMAPS_OFFSET UNITYSDK_OFFSET(0xAB6D6C0)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE_GET_TABCONTAINSUBTABS_OFFSET UNITYSDK_OFFSET(0xAB6D6A0)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE_GET_WORLDCONTAINTABS_OFFSET UNITYSDK_OFFSET(0xAB6D690)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE_INIT_OFFSET UNITYSDK_OFFSET(0xAB67C10)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE_ISSCENEENTERED_OFFSET UNITYSDK_OFFSET(0xAB67BB0)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE_MARKALLMAPDATADIRTY_OFFSET UNITYSDK_OFFSET(0xAB643E0)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE_ONRECONNECT_OFFSET UNITYSDK_OFFSET(0xAB68520)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE_PREPAREMAPDATASOURCE_OFFSET UNITYSDK_OFFSET(0xAB4E830)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE_PREPAREMISSIONDATA_OFFSET UNITYSDK_OFFSET(0xAB68600)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE__ADDCHESTMONSTERLIMAO_OFFSET UNITYSDK_OFFSET(0xAB62BE0)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE__ADDCOLLECTIONDATA_OFFSET UNITYSDK_OFFSET(0xAB62EE0)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE__ADDGPCHEST_OFFSET UNITYSDK_OFFSET(0xAB628B0)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE__ADDNOTIFYHANDLERS_OFFSET UNITYSDK_OFFSET(0xAB68900)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE__ADDPACKETHANDLERS_OFFSET UNITYSDK_OFFSET(0xAB687E0)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE__BUILDTABCONDITIONCHECKER_OFFSET UNITYSDK_OFFSET(0xAB682F0)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE__CLEARRAIDCARTOGRAPHYDATA_OFFSET UNITYSDK_OFFSET(0xAB63D50)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE__CLEARRAIDSUBTABDATA_OFFSET UNITYSDK_OFFSET(0xAB6B5B0)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0xAB6D6E0)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE__GETCARTOGRAPHERENTITYIN_OFFSET UNITYSDK_OFFSET(0xAB65A30)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE__HAVEMAPPINGINFOID_OFFSET UNITYSDK_OFFSET(0xAB66740)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE__INITDEFAULTENTRANCEID_OFFSET UNITYSDK_OFFSET(0xAB67D20)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE__INITFIVEDIMINSTANCECONTAINSCHESTMONSTERLIMAO_OFFSET UNITYSDK_OFFSET(0xAB62AB0)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE__INITFIVEDIMINSTANCECONTAINSCHEST_OFFSET UNITYSDK_OFFSET(0xAB62780)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE__INITFIVEDIMINSTANCECONTAINSCOLLECTIONDATA_OFFSET UNITYSDK_OFFSET(0xAB62DC0)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE__INITFLOORID2PLANEID_OFFSET UNITYSDK_OFFSET(0xAB68060)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE__INITSAMEFLOORSUBNAVMAPHIERARCHY_OFFSET UNITYSDK_OFFSET(0xAB6CEB0)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE__INITSUBTABCONTAINOTHERFLOORSUBNAVMAPS_OFFSET UNITYSDK_OFFSET(0xAB6CAF0)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE__INITTABCONTAINSUBTABS_OFFSET UNITYSDK_OFFSET(0xAB6C560)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE__INITTABHIERARCHYINDEX_OFFSET UNITYSDK_OFFSET(0xAB68290)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE__INITWORLDCONTAINTABS_OFFSET UNITYSDK_OFFSET(0xAB6C240)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE__ISREQUESTEDSYNCMAPDATA_OFFSET UNITYSDK_OFFSET(0xAB6D090)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE__ONADDTEMPSHOWICON_OFFSET UNITYSDK_OFFSET(0xAB6C1A0)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE__ONADVENTUREPHASEENTERED_OFFSET UNITYSDK_OFFSET(0xAB6B4A0)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE__ONCMDENTEREDSCENECHANGESCNOTIFY_OFFSET UNITYSDK_OFFSET(0xAB6AA40)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE__ONCMDGETENTEREDSCENESCRSP_OFFSET UNITYSDK_OFFSET(0xAB6A6F0)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE__ONCMDGETSCENEMAPINFOSCRSP_OFFSET UNITYSDK_OFFSET(0xAB68BA0)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE__ONCMDWORLDUNLOCKSCRSP_OFFSET UNITYSDK_OFFSET(0xAB6B420)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE__ONFINISHEDMAINMISSION_OFFSET UNITYSDK_OFFSET(0xAB6B600)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE__ONFINISHSUBMISSION_OFFSET UNITYSDK_OFFSET(0xAB6BBE0)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE__ONMAPGROUPDEFREFRESH_OFFSET UNITYSDK_OFFSET(0xAB6C150)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE__ONMASTERMAINTABUNLOCK_OFFSET UNITYSDK_OFFSET(0xAB6ADA0)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE__ONMISSIONSYNC_OFFSET UNITYSDK_OFFSET(0xAB6C100)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE__ONRAIDMAPDATADIRTY_OFFSET UNITYSDK_OFFSET(0xAB64A40)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE__ONREMOVETEMPSHOWICON_OFFSET UNITYSDK_OFFSET(0xAB6C1F0)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE__REFRESHCURRENTMAPDATASTRATEGY_OFFSET UNITYSDK_OFFSET(0xAB6B560)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE__SENDGETSCENEMAPINFO_OFFSET UNITYSDK_OFFSET(0xAB6D1D0)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE__TRYUPDATERAIDDATA_OFFSET UNITYSDK_OFFSET(0xAB6A3B0)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0xAB6DCE0)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE___IFIXBASEPROXY_ONRECONNECT_OFFSET UNITYSDK_OFFSET(0xAB6DD70)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE___IFIXBASEPROXY__ADDNOTIFYHANDLERS_OFFSET UNITYSDK_OFFSET(0xAB6DE30)
#define RPG_CLIENT_NAVMAP_NAVMAPMODULE___IFIXBASEPROXY__ADDPACKETHANDLERS_OFFSET UNITYSDK_OFFSET(0xAB6DDD0)

namespace RPG::Client::NavMap
{
	inline static constexpr unsigned int NavMapModule_TypeDefinitionIndex = 68859;

	class NavMapModule : public ::RPG::Client::BaseModule
	{
	public:
		::System::Collections::Generic::Dictionary_2<::RPG::Client::MapDataKey*, ::RPG::Client::Promises::Promise_1<::RPG::Client::NavMap::IMapDataSource*>*>* _SyncMapDataPromises; // 0x10
		...
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Collections::Generic::IReadOnlyList_1<::RPG::GameCore::NavMapTabRow*>*>* _WorldContainTabs; // 0x28
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Collections::Generic::IReadOnlyList_1<::RPG::GameCore::NavMapSubTabRow*>*>* _TabContainSubTabs; // 0x30
		...
		::System::Collections::Generic::Dictionary_2<::System::ValueTuple_3<::System::UInt32, ::System::UInt32, ::System::UInt32>, ::System::Collections::Generic::List_1<::System::UInt32>*>* _FiveDimInstanceContainsChestMonsterLimaoIDs; // 0x40
		::System::Collections::Generic::Dictionary_2<::RPG::Client::VerseParam, ::RPG::Client::NavMap::UniverseData*>* _UniverseDatas; // 0x48
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::Client::ConditionChecker*>* _SubTabConditionCheckers; // 0x50
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::UInt32>* _FloorID2DefaultEntranceID; // 0x58
		...
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::UInt32>* _FloorID2PlaneID; // 0x78
		::System::Collections::Generic::Dictionary_2<::System::ValueTuple_3<::System::UInt32, ::System::UInt32, ::System::UInt32>, ::System::Collections::Generic::List_1<::Class_1_813743369E0E31B2_1*>*>* _FiveDimInstanceContainsGPChestDatas; // 0x80
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Collections::Generic::IReadOnlyList_1<::RPG::GameCore::SubNavMapRow*>*>* _SubTabContainOtherFloorSubNavMaps; // 0x88
