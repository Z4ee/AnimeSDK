...
#define RPG_CLIENT_NAVMAP_UNIVERSEDATA_SUBNAVMAPBUILDCONTEXT_GETFIVEDIMENTRYID_OFFSET UNITYSDK_OFFSET(0xD979460)
#define RPG_CLIENT_NAVMAP_UNIVERSEDATA_SUBNAVMAPBUILDCONTEXT_GETSTANDARDENTRYID_OFFSET UNITYSDK_OFFSET(0xD9795B0)
#define RPG_CLIENT_NAVMAP_UNIVERSEDATA_SUBNAVMAPBUILDCONTEXT_GET_BUILDMODE_OFFSET UNITYSDK_OFFSET(0xD97A1D0)
#define RPG_CLIENT_NAVMAP_UNIVERSEDATA_SUBNAVMAPBUILDCONTEXT_GET_ORDEREDSAMEFLOORNODES_OFFSET UNITYSDK_OFFSET(0xD97A1F0)
#define RPG_CLIENT_NAVMAP_UNIVERSEDATA_SUBNAVMAPBUILDCONTEXT_GET_OTHERFLOORCONFIGS_OFFSET UNITYSDK_OFFSET(0xD97A1E0)
#define RPG_CLIENT_NAVMAP_UNIVERSEDATA_SUBNAVMAPBUILDCONTEXT_GET_ROOTSUBNAVMAPS_OFFSET UNITYSDK_OFFSET(0xD97A200)
#define RPG_CLIENT_NAVMAP_UNIVERSEDATA_SUBNAVMAPBUILDCONTEXT_GET_ROOTSUBTAB_OFFSET UNITYSDK_OFFSET(0xD97A1C0)
#define RPG_CLIENT_NAVMAP_UNIVERSEDATA_SUBNAVMAPBUILDCONTEXT_GET_SHOULDREGISTERTOUNIVERSE_OFFSET UNITYSDK_OFFSET(0xD979720)
#define RPG_CLIENT_NAVMAP_UNIVERSEDATA_SUBNAVMAPBUILDCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xD978070)

namespace RPG::Client::NavMap
{
	inline static constexpr unsigned int UniverseData_SubNavMapBuildContext_TypeDefinitionIndex = 74510;

	class UniverseData_SubNavMapBuildContext : public ::System::Object
	{
	public:
		::System::Collections::Generic::List_1<::RPG::Client::NavMap::ISubNavMap*>* _RootSubNavMaps_k__BackingField; // 0x10
		::System::Collections::Generic::IReadOnlyList_1<::RPG::GameCore::SubNavMapRow*>* _OtherFloorConfigs_k__BackingField; // 0x18
		...
		::RPG::Client::NavMap::SubTabData* _RootSubTab_k__BackingField; // 0x28
