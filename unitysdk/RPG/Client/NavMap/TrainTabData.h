...
#define RPG_CLIENT_NAVMAP_TRAINTABDATA_GETDEFAULTSUBTABANDLAYER_OFFSET UNITYSDK_OFFSET(0xAB72EB0)
#define RPG_CLIENT_NAVMAP_TRAINTABDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xAB3F460)
#define RPG_CLIENT_NAVMAP_TRAINTABDATA___IFIXBASEPROXY_GETDEFAULTSUBTABANDLAYER_OFFSET UNITYSDK_OFFSET(0xAB732E0)

namespace RPG::Client::NavMap
{
	inline static constexpr unsigned int TrainTabData_TypeDefinitionIndex = 68773;
