...
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON_GET_CARTOGRAPHY_OFFSET UNITYSDK_OFFSET(0x166A3DF0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON_GET_CONTAINERGROUPID_OFFSET UNITYSDK_OFFSET(0x166A36B0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON_GET_CONTAINERINSTANCEID_OFFSET UNITYSDK_OFFSET(0x166A3700)
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON_GET_CONTENTID_OFFSET UNITYSDK_OFFSET(0x166A4670)
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON_GET_DESC_OFFSET UNITYSDK_OFFSET(0x166A4290)
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON_GET_ENTITYID_OFFSET UNITYSDK_OFFSET(0x166A35C0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON_GET_ENTITYROTATION_OFFSET UNITYSDK_OFFSET(0x166A3B10)
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON_GET_ENTITYSCALE_OFFSET UNITYSDK_OFFSET(0x166A3BB0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON_GET_ENTRANCEID_OFFSET UNITYSDK_OFFSET(0x166A4770)
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON_GET_FACE_OFFSET UNITYSDK_OFFSET(0x166A3640)
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON_GET_FLOORID_OFFSET UNITYSDK_OFFSET(0x166A3D60)
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON_GET_ISCONNECTID_OFFSET UNITYSDK_OFFSET(0x166A3FA0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON_GET_ISONLINEPLAYROOM_OFFSET UNITYSDK_OFFSET(0x166A4730)
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON_GET_ISTRACKING_OFFSET UNITYSDK_OFFSET(0x166A3FE0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON_GET_MAPICONCOLOR_OFFSET UNITYSDK_OFFSET(0x166A4980)
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON_GET_MAPICONTYPE_OFFSET UNITYSDK_OFFSET(0x166A3E40)
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON_GET_MAPPINGINFOID_OFFSET UNITYSDK_OFFSET(0x166A3F20)
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON_GET_MAPPINGINFOROW_OFFSET UNITYSDK_OFFSET(0x166A4040)
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON_GET_MAPPOSITION_OFFSET UNITYSDK_OFFSET(0x166A3750)
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON_GET_NAME_OFFSET UNITYSDK_OFFSET(0x166A4110)
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON_GET_PATH_OFFSET UNITYSDK_OFFSET(0x166A3C50)
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON_GET_STORYLINEID_OFFSET UNITYSDK_OFFSET(0x166A45B0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON_GET_SUBMISSIONDATA_OFFSET UNITYSDK_OFFSET(0x166A3F80)
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON_GET__ICONROW_OFFSET UNITYSDK_OFFSET(0x166A3CF0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON_GET__MAPTRANSFORM_OFFSET UNITYSDK_OFFSET(0x166A38B0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON_SET_SUBMISSIONDATA_OFFSET UNITYSDK_OFFSET(0x166A3F90)
#define RPG_CLIENT_NAVMAP_FIVEDIM_MISSIONICON__CTOR_OFFSET UNITYSDK_OFFSET(0x166A35B0)

namespace RPG::Client::NavMap::FiveDim
{
	inline static constexpr unsigned int MissionIcon_TypeDefinitionIndex = 71240;
