...
#define RPG_CLIENT_NAVMAP_FIVEDIM_SECTIONBORDER_CALCULATEINNERPOINTS_OFFSET UNITYSDK_OFFSET(0xD9443A0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_SECTIONBORDER_GET_DEFAULTMATERIAL_OFFSET UNITYSDK_OFFSET(0xD943E50)
#define RPG_CLIENT_NAVMAP_FIVEDIM_SECTIONBORDER_ONPOPULATEMESH_OFFSET UNITYSDK_OFFSET(0xD944010)
#define RPG_CLIENT_NAVMAP_FIVEDIM_SECTIONBORDER_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0xD943EA0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_SECTIONBORDER__BUILDBORDER_OFFSET UNITYSDK_OFFSET(0xD944B10)
#define RPG_CLIENT_NAVMAP_FIVEDIM_SECTIONBORDER__CTOR_OFFSET UNITYSDK_OFFSET(0xD945410)
#define RPG_CLIENT_NAVMAP_FIVEDIM_SECTIONBORDER__GENERATEBORDERGEOMETRY_OFFSET UNITYSDK_OFFSET(0xD944080)

namespace RPG::Client::NavMap::FiveDim
{
	inline static constexpr unsigned int SectionBorder_TypeDefinitionIndex = 74553;
