...
#define RPG_CLIENT_NAVMAP_FIVEDIM_SURFACECONNECTICON_SURFACECONNECTTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0xD948220)

namespace RPG::Client::NavMap::FiveDim
{
	inline static constexpr unsigned int SurfaceConnectIcon_SurfaceConnectTarget_TypeDefinitionIndex = 74552;

	class SurfaceConnectIcon_SurfaceConnectTarget : public ::System::Object
	{
	public:
		::System::UInt32 ContainerGroupID; // 0x10
		::System::UInt32 ContainerInstanceID; // 0x14
		::System::UInt32 SurfaceID; // 0x18
