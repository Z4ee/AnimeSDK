...
#define RPG_CLIENT_NAVMAP_FIVEDIM_SURFACECONNECTICON_GET_CONNECTTARGETENTITYID_OFFSET UNITYSDK_OFFSET(0x9E06C60)
#define RPG_CLIENT_NAVMAP_FIVEDIM_SURFACECONNECTICON_GET_CONNECTTARGETFACE_OFFSET UNITYSDK_OFFSET(0x9E06C80)
#define RPG_CLIENT_NAVMAP_FIVEDIM_SURFACECONNECTICON_GET_CONNECTTARGETICON_OFFSET UNITYSDK_OFFSET(0x9E06D80)
#define RPG_CLIENT_NAVMAP_FIVEDIM_SURFACECONNECTICON_GET_DIRECTION_OFFSET UNITYSDK_OFFSET(0x9E06E40)
#define RPG_CLIENT_NAVMAP_FIVEDIM_SURFACECONNECTICON_GET_ENTITYID_OFFSET UNITYSDK_OFFSET(0x9E06E60)
#define RPG_CLIENT_NAVMAP_FIVEDIM_SURFACECONNECTICON_GET_MAPPOSITION_OFFSET UNITYSDK_OFFSET(0x9E06EC0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_SURFACECONNECTICON_SET_DIRECTION_OFFSET UNITYSDK_OFFSET(0x9E06E50)
#define RPG_CLIENT_NAVMAP_FIVEDIM_SURFACECONNECTICON__CTOR_OFFSET UNITYSDK_OFFSET(0x9E06F40)
#define RPG_CLIENT_NAVMAP_FIVEDIM_SURFACECONNECTICON__GET_CONNECTTARGETICON_B__6_0_OFFSET UNITYSDK_OFFSET(0x9E06F60)

namespace RPG::Client::NavMap::FiveDim
{
	inline static constexpr unsigned int SurfaceConnectIcon_TypeDefinitionIndex = 61403;
	...
	public:
		...
		::RPG::Client::NavMap::FiveDim::SurfaceConnectIcon_SurfaceConnectTarget* _ConnectTarget; // 0x20
