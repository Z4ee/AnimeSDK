...
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18EBA0A0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GETCHESTICONS_OFFSET UNITYSDK_OFFSET(0x18EBB600)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GETFACEPLAYERIN_OFFSET UNITYSDK_OFFSET(0x18EBC7E0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GETFACE_1_OFFSET UNITYSDK_OFFSET(0x18EBD3A0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GETFACE_OFFSET UNITYSDK_OFFSET(0x18EBCFA0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GETICONS_OFFSET UNITYSDK_OFFSET(0x18EBB2A0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GETLEVELINSTANCE_OFFSET UNITYSDK_OFFSET(0x18EBC100)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GETMISSIONICONS_OFFSET UNITYSDK_OFFSET(0x18EBB880)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GETSURFACEPLAYERIN_OFFSET UNITYSDK_OFFSET(0x18EBC880)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_ALLFACES_OFFSET UNITYSDK_OFFSET(0x18EBB4C0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_ALWAYSSHOWENTRYONMAP_OFFSET UNITYSDK_OFFSET(0x18EBDC40)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_CARTOGRAPHER_OFFSET UNITYSDK_OFFSET(0x18EBDFB0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_CONTENTID_OFFSET UNITYSDK_OFFSET(0x18EBBBD0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_CURFACE_OFFSET UNITYSDK_OFFSET(0x18EBC860)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_DIFFICULTYLEVEL_OFFSET UNITYSDK_OFFSET(0x18EBDBB0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_ENTRYID_OFFSET UNITYSDK_OFFSET(0x18EBDFF0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_EXPLORATIONPROGRESS_OFFSET UNITYSDK_OFFSET(0x18EBD4E0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_FLOORID_OFFSET UNITYSDK_OFFSET(0x18EBBA20)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_ISEXPLORATIONCOMPLETED_OFFSET UNITYSDK_OFFSET(0x18EBD430)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_ISPLAYERHERE_OFFSET UNITYSDK_OFFSET(0x18EBC790)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_LEVELINSTANCES_OFFSET UNITYSDK_OFFSET(0x18EBE400)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_MAPAREALIST_OFFSET UNITYSDK_OFFSET(0x18EBE300)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_MAPDATA_OFFSET UNITYSDK_OFFSET(0x18EBDDB0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_NAVMAPCONFIG_OFFSET UNITYSDK_OFFSET(0x18EBE2F0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_PLANEID_OFFSET UNITYSDK_OFFSET(0x18EBDE50)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_STORYLINEID_OFFSET UNITYSDK_OFFSET(0x18EBBB80)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_SUBMAPID_OFFSET UNITYSDK_OFFSET(0x18EBD0B0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_SYNCEDWITHSERVER_OFFSET UNITYSDK_OFFSET(0x18EBDD50)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_GET_VERSEPARAM_OFFSET UNITYSDK_OFFSET(0x18EBE150)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_ONMAPDATADIRTY_OFFSET UNITYSDK_OFFSET(0x18EBE360)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_REPORTOPENEDDIALOG_OFFSET UNITYSDK_OFFSET(0x18EBD100)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_RESETDEFAULTFACE_OFFSET UNITYSDK_OFFSET(0x18EBC650)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_RPG_CLIENT_NAVMAP_ICARTOGRAPHY_GET_MAPDATA_OFFSET UNITYSDK_OFFSET(0x18EBE310)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_SETCURFACE_OFFSET UNITYSDK_OFFSET(0x18EBCB00)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_SET_CURFACE_OFFSET UNITYSDK_OFFSET(0x18EBC870)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM_UPDATEDATA_OFFSET UNITYSDK_OFFSET(0x18EBE3A0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM__COLLECTMISSIONICON_OFFSET UNITYSDK_OFFSET(0x18EBAA60)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM__COLLECTTRACKINGMISSIONICON_OFFSET UNITYSDK_OFFSET(0x18EBBC20)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM__CTOR_OFFSET UNITYSDK_OFFSET(0x18EB9C90)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM__GETFACEBYID_OFFSET UNITYSDK_OFFSET(0x18EBC520)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM__INITCURFACE_OFFSET UNITYSDK_OFFSET(0x18EBAF40)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM__INITEXPLORATIONPROGRESS_OFFSET UNITYSDK_OFFSET(0x18EB9D70)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM__INITFACEINDEX_OFFSET UNITYSDK_OFFSET(0x18EBA970)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM__INITLEVELINSTANCES_OFFSET UNITYSDK_OFFSET(0x18EBA290)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM__INITMAP_OFFSET UNITYSDK_OFFSET(0x18EB9D00)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM__REFRESHEXPLORATIONPROGRESS_OFFSET UNITYSDK_OFFSET(0x18EBB0D0)
#define RPG_CLIENT_NAVMAP_FIVEDIM_CARTOGRAPHYFIVEDIM__TRYADDMISSIONGUIDEICON_OFFSET UNITYSDK_OFFSET(0x18EBAB90)

namespace RPG::Client::NavMap::FiveDim
{
	inline static constexpr unsigned int CartographyFiveDim_TypeDefinitionIndex = 71212;

	class CartographyFiveDim : public ::System::Object
	{
	public:
		// static const ::System::String* ExplorationCompletedSubMapIconPath; // 0x0
		::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_1167*>* _ExplorationProgressList; // 0x10
		::RPG::Client::NavMap::FiveDim::SubNavMapDataFiveDim* _SubNavMapDataFiveDim; // 0x18
		::RPG::Client::NavMap::FiveDim::Face* _CurFace_k__BackingField; // 0x20
		::RPG::GameCore::LevelNavmapConfig* _NavmapConfig_k__BackingField; // 0x28
		::System::Collections::Generic::List_1<::Class_1_A3C62CC0DC4BD2F1*>* _LevelInstances; // 0x30
