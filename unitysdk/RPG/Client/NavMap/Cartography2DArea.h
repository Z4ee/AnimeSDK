...
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DAREA_GETDEFAULTLAYER_OFFSET UNITYSDK_OFFSET(0x9DF2720)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DAREA_GETLOCALPOSITION_OFFSET UNITYSDK_OFFSET(0x9DF2B10)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DAREA_GET_BACKGROUNDMAPSPRITEPATH_OFFSET UNITYSDK_OFFSET(0x9DF2F50)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DAREA_GET_BACKGROUNDSIZE_OFFSET UNITYSDK_OFFSET(0x9DF2970)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DAREA_GET_DEFAULTCENTERPOSINMAP_OFFSET UNITYSDK_OFFSET(0x9DF28A0)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DAREA_GET_INPUTSCALEMAX_OFFSET UNITYSDK_OFFSET(0x9DF2840)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DAREA_GET_INPUTSCALEMIN_OFFSET UNITYSDK_OFFSET(0x9DF2870)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DAREA_GET_LAYERCOUNT_OFFSET UNITYSDK_OFFSET(0x9DF26B0)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DAREA_GET_LAYERLIST_OFFSET UNITYSDK_OFFSET(0x9DF2600)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DAREA_GET_MAPMAPPINGINFODATALIST_OFFSET UNITYSDK_OFFSET(0x9DF2EB0)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DAREA_GET_MAPMISSIONDATALIST_OFFSET UNITYSDK_OFFSET(0x9DF2E90)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DAREA_GET_MAPSCALE_OFFSET UNITYSDK_OFFSET(0x9DF27B0)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DAREA_GET_MAPTELEPORTDATALIST_OFFSET UNITYSDK_OFFSET(0x9DF2DE0)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DAREA_GET_MAPTRACKMONSTERDATALIST_OFFSET UNITYSDK_OFFSET(0x9DF2EF0)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DAREA_GET_OUTCONTROLTEAMLEADERICON_OFFSET UNITYSDK_OFFSET(0x9DF2F30)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DAREA_GET_SUBNAVMAPLINKDATALIST_OFFSET UNITYSDK_OFFSET(0x9DF2F10)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DAREA_GET_TEMPSHOWICONLIST_OFFSET UNITYSDK_OFFSET(0x9DF2ED0)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DAREA_GET__NAVMAPAREADATA_OFFSET UNITYSDK_OFFSET(0x9DF2630)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DAREA__CTOR_OFFSET UNITYSDK_OFFSET(0x9DF2040)

namespace RPG::Client::NavMap
{
	inline static constexpr unsigned int Cartography2DArea_TypeDefinitionIndex = 61233;
