...
#define RPG_CLIENT_NAVMAP_MAZEFLOORCARTOGRAPHERIDENTIFIER_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x3904290)
#define RPG_CLIENT_NAVMAP_MAZEFLOORCARTOGRAPHERIDENTIFIER_EQUALS_2_OFFSET UNITYSDK_OFFSET(0x39042A0)
#define RPG_CLIENT_NAVMAP_MAZEFLOORCARTOGRAPHERIDENTIFIER_EQUALS_OFFSET UNITYSDK_OFFSET(0x39041D0)
#define RPG_CLIENT_NAVMAP_MAZEFLOORCARTOGRAPHERIDENTIFIER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3904140)
#define RPG_CLIENT_NAVMAP_MAZEFLOORCARTOGRAPHERIDENTIFIER_GET_FLOORID_OFFSET UNITYSDK_OFFSET(0x167710)
#define RPG_CLIENT_NAVMAP_MAZEFLOORCARTOGRAPHERIDENTIFIER_GET_VERSEPARAM_OFFSET UNITYSDK_OFFSET(0x38F4340)
#define RPG_CLIENT_NAVMAP_MAZEFLOORCARTOGRAPHERIDENTIFIER_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x166BEA90)
#define RPG_CLIENT_NAVMAP_MAZEFLOORCARTOGRAPHERIDENTIFIER_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x166BEAF0)
#define RPG_CLIENT_NAVMAP_MAZEFLOORCARTOGRAPHERIDENTIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x3904110)

namespace RPG::Client::NavMap
{
	inline static constexpr unsigned int MazeFloorCartographerIdentifier_TypeDefinitionIndex = 71086;
