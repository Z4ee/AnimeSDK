...
#define RPG_CLIENT_NAVMAP_SECTIONDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x166CF960)
#define RPG_CLIENT_NAVMAP_SECTIONDATA_GET_AREADATA_OFFSET UNITYSDK_OFFSET(0x166D0690)
#define RPG_CLIENT_NAVMAP_SECTIONDATA_GET_CENTER_OFFSET UNITYSDK_OFFSET(0x166D0470)
#define RPG_CLIENT_NAVMAP_SECTIONDATA_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x166D04C0)
#define RPG_CLIENT_NAVMAP_SECTIONDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0x166CFA00)
#define RPG_CLIENT_NAVMAP_SECTIONDATA_GET_INDICES_OFFSET UNITYSDK_OFFSET(0x166D0330)
#define RPG_CLIENT_NAVMAP_SECTIONDATA_GET_INITIALHIDDEN_OFFSET UNITYSDK_OFFSET(0x166D03D0)
#define RPG_CLIENT_NAVMAP_SECTIONDATA_GET_ISRECT_OFFSET UNITYSDK_OFFSET(0x166D02E0)
#define RPG_CLIENT_NAVMAP_SECTIONDATA_GET_MAPLAYERID_OFFSET UNITYSDK_OFFSET(0x166CFA50)
#define RPG_CLIENT_NAVMAP_SECTIONDATA_GET_PASSAGES_OFFSET UNITYSDK_OFFSET(0x166D0600)
#define RPG_CLIENT_NAVMAP_SECTIONDATA_GET_PIVOT_OFFSET UNITYSDK_OFFSET(0x166D05B0)
#define RPG_CLIENT_NAVMAP_SECTIONDATA_GET_PROPID_OFFSET UNITYSDK_OFFSET(0x166D0510)
#define RPG_CLIENT_NAVMAP_SECTIONDATA_GET_REFERENCEPROPKEY_OFFSET UNITYSDK_OFFSET(0x166D0290)
#define RPG_CLIENT_NAVMAP_SECTIONDATA_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x166CFD40)
#define RPG_CLIENT_NAVMAP_SECTIONDATA_GET_SECTIONCONFIG_OFFSET UNITYSDK_OFFSET(0x166D0650)
#define RPG_CLIENT_NAVMAP_SECTIONDATA_GET_SPRITEPATH_OFFSET UNITYSDK_OFFSET(0x166CFAA0)
#define RPG_CLIENT_NAVMAP_SECTIONDATA_GET_TRIANGLES_OFFSET UNITYSDK_OFFSET(0x166D0560)
#define RPG_CLIENT_NAVMAP_SECTIONDATA_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x166D0420)
#define RPG_CLIENT_NAVMAP_SECTIONDATA_GET_UIPOSITION_OFFSET UNITYSDK_OFFSET(0x166D0380)
#define RPG_CLIENT_NAVMAP_SECTIONDATA_SET_AREADATA_OFFSET UNITYSDK_OFFSET(0x166D06A0)
#define RPG_CLIENT_NAVMAP_SECTIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x166CF9F0)

namespace RPG::Client::NavMap
{
	inline static constexpr unsigned int SectionData_TypeDefinitionIndex = 71105;
