...
#define RPG_CLIENT_NAVMAP_WORLDDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1826BEB0)
#define RPG_CLIENT_NAVMAP_WORLDDATA_GETTRACKINGSUBMISSIONFORSHOW_OFFSET UNITYSDK_OFFSET(0x1826B7B0)
#define RPG_CLIENT_NAVMAP_WORLDDATA_GET_DESC_OFFSET UNITYSDK_OFFSET(0x1826FA70)
#define RPG_CLIENT_NAVMAP_WORLDDATA_GET_IMAGEPATH_OFFSET UNITYSDK_OFFSET(0x1826FAE0)
#define RPG_CLIENT_NAVMAP_WORLDDATA_GET_ISPLAYERHERE_OFFSET UNITYSDK_OFFSET(0x1826B370)
#define RPG_CLIENT_NAVMAP_WORLDDATA_GET_ISSHOW_OFFSET UNITYSDK_OFFSET(0x1826F870)
#define RPG_CLIENT_NAVMAP_WORLDDATA_GET_ISTRAINWORLD_OFFSET UNITYSDK_OFFSET(0x1826FC30)
#define RPG_CLIENT_NAVMAP_WORLDDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1826FA00)
#define RPG_CLIENT_NAVMAP_WORLDDATA_GET_NEEDSHOWSPACETYPE_OFFSET UNITYSDK_OFFSET(0x1826FB80)
#define RPG_CLIENT_NAVMAP_WORLDDATA_GET_PREWORLDID_OFFSET UNITYSDK_OFFSET(0x1826FD20)
#define RPG_CLIENT_NAVMAP_WORLDDATA_GET_SHOWTABS_OFFSET UNITYSDK_OFFSET(0x1826B1C0)
#define RPG_CLIENT_NAVMAP_WORLDDATA_GET_SPACETYPELIST_OFFSET UNITYSDK_OFFSET(0x1826FB30)
#define RPG_CLIENT_NAVMAP_WORLDDATA_GET_TABS_OFFSET UNITYSDK_OFFSET(0x1826FC10)
#define RPG_CLIENT_NAVMAP_WORLDDATA_GET_TRAINSPACETYPE_OFFSET UNITYSDK_OFFSET(0x1826FCD0)
#define RPG_CLIENT_NAVMAP_WORLDDATA_GET_VERSEPARAM_OFFSET UNITYSDK_OFFSET(0x182693E0)
#define RPG_CLIENT_NAVMAP_WORLDDATA_GET_WORLDID_OFFSET UNITYSDK_OFFSET(0x1826F9E0)
#define RPG_CLIENT_NAVMAP_WORLDDATA_SET_TABS_OFFSET UNITYSDK_OFFSET(0x1826FC20)
#define RPG_CLIENT_NAVMAP_WORLDDATA_SET_WORLDID_OFFSET UNITYSDK_OFFSET(0x1826F9F0)
#define RPG_CLIENT_NAVMAP_WORLDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1826F9D0)

namespace RPG::Client::NavMap
{
	inline static constexpr unsigned int WorldData_TypeDefinitionIndex = 74516;
	...
	public:
		...
		::RPG::GameCore::WorldUnlockConfigRow* _UnlockRow; // 0x28
