...
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR_GETDEFAULTLAYER_OFFSET UNITYSDK_OFFSET(0xC24A2B0)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR_GETLOCALPOSITION_OFFSET UNITYSDK_OFFSET(0xC249B60)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR_GET_BACKGROUNDMAPSPRITEPATH_OFFSET UNITYSDK_OFFSET(0xC24A250)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR_GET_BACKGROUNDSIZE_OFFSET UNITYSDK_OFFSET(0xC249F50)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR_GET_DEFAULTCENTERPOSINMAP_OFFSET UNITYSDK_OFFSET(0xC24A180)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR_GET_INPUTSCALEMAX_OFFSET UNITYSDK_OFFSET(0xC24A120)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR_GET_INPUTSCALEMIN_OFFSET UNITYSDK_OFFSET(0xC24A150)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR_GET_LAYERCOUNT_OFFSET UNITYSDK_OFFSET(0xC249A60)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR_GET_LAYERLIST_OFFSET UNITYSDK_OFFSET(0xC249B00)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR_GET_MAPMAPPINGINFODATALIST_OFFSET UNITYSDK_OFFSET(0xC24A460)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR_GET_MAPMISSIONDATALIST_OFFSET UNITYSDK_OFFSET(0xC24A440)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR_GET_MAPSCALE_OFFSET UNITYSDK_OFFSET(0xC24A0B0)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR_GET_MAPTELEPORTDATALIST_OFFSET UNITYSDK_OFFSET(0xC24A420)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR_GET_MAPTRACKMONSTERDATALIST_OFFSET UNITYSDK_OFFSET(0xC24A4A0)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR_GET_OUTCONTROLTEAMLEADERICON_OFFSET UNITYSDK_OFFSET(0xC24A4E0)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR_GET_SUBNAVMAPLINKDATALIST_OFFSET UNITYSDK_OFFSET(0xC24A4C0)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR_GET_TEMPSHOWICONLIST_OFFSET UNITYSDK_OFFSET(0xC24A480)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0xC249600)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR__CTOR_OFFSET UNITYSDK_OFFSET(0xC249430)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR__INITAREA_1_OFFSET UNITYSDK_OFFSET(0xC249460)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR__INITAREA_OFFSET UNITYSDK_OFFSET(0xC249630)

namespace RPG::Client::NavMap
{
	inline static constexpr unsigned int Cartography2DFloor_TypeDefinitionIndex = 69554;
