...
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR_GETDEFAULTLAYER_OFFSET UNITYSDK_OFFSET(0xD932F10)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR_GETLOCALPOSITION_OFFSET UNITYSDK_OFFSET(0xD932510)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR_GET_BACKGROUNDMAPSPRITEPATH_OFFSET UNITYSDK_OFFSET(0xD932E80)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR_GET_BACKGROUNDSIZE_OFFSET UNITYSDK_OFFSET(0xD932950)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR_GET_DEFAULTCENTERPOSINMAP_OFFSET UNITYSDK_OFFSET(0xD932D70)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR_GET_INPUTSCALEMAX_OFFSET UNITYSDK_OFFSET(0xD932C50)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR_GET_INPUTSCALEMIN_OFFSET UNITYSDK_OFFSET(0xD932CE0)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR_GET_LAYERCOUNT_OFFSET UNITYSDK_OFFSET(0xD932420)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR_GET_LAYERLIST_OFFSET UNITYSDK_OFFSET(0xD932480)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR_GET_MAPMAPPINGINFODATALIST_OFFSET UNITYSDK_OFFSET(0xD933060)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR_GET_MAPMISSIONDATALIST_OFFSET UNITYSDK_OFFSET(0xD932FE0)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR_GET_MAPSCALE_OFFSET UNITYSDK_OFFSET(0xD932BC0)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR_GET_MAPTELEPORTDATALIST_OFFSET UNITYSDK_OFFSET(0xD932F60)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR_GET_MAPTRACKMONSTERDATALIST_OFFSET UNITYSDK_OFFSET(0xD933160)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR_GET_OUTCONTROLTEAMLEADERICON_OFFSET UNITYSDK_OFFSET(0xD933260)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR_GET_SUBNAVMAPLINKDATALIST_OFFSET UNITYSDK_OFFSET(0xD9331E0)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR_GET_TEMPSHOWICONLIST_OFFSET UNITYSDK_OFFSET(0xD9330E0)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0xD931E20)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR__CTOR_OFFSET UNITYSDK_OFFSET(0xD931C10)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR__INITAREA_1_OFFSET UNITYSDK_OFFSET(0xD931C40)
#define RPG_CLIENT_NAVMAP_CARTOGRAPHY2DFLOOR__INITAREA_OFFSET UNITYSDK_OFFSET(0xD931E50)

namespace RPG::Client::NavMap
{
	inline static constexpr unsigned int Cartography2DFloor_TypeDefinitionIndex = 74377;
