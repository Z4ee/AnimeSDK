...
#define RPG_CLIENT_NAVMAP_SECTIONBOUNDSPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x18263930)

namespace RPG::Client::NavMap
{
	inline static constexpr unsigned int SectionBoundsParam_TypeDefinitionIndex = 74403;

	class SectionBoundsParam : public ::System::Object
	{
	public:
		::System::Single MaxX; // 0x10
		::System::Single MinY; // 0x14
