...
#define RPG_CLIENT_REFLECTIONHSVVOLUMEBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0xDE16420)
#define RPG_CLIENT_REFLECTIONHSVVOLUMEBEHAVIOR_METHOD_3_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xDE16AC0)
#define RPG_CLIENT_REFLECTIONHSVVOLUMEBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0xDE16A00)
#define RPG_CLIENT_REFLECTIONHSVVOLUMEBEHAVIOR_METHOD_3_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0xDE16A60)
#define RPG_CLIENT_REFLECTIONHSVVOLUMEBEHAVIOR_METHOD_3_4343F372F34C05BF_3_OFFSET UNITYSDK_OFFSET(0xDE16B00)
#define RPG_CLIENT_REFLECTIONHSVVOLUMEBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xDE169A0)
#define RPG_CLIENT_REFLECTIONHSVVOLUMEBEHAVIOR_METHOD_3_672D56D99D734395_OFFSET UNITYSDK_OFFSET(0xDE164A0)
#define RPG_CLIENT_REFLECTIONHSVVOLUMEBEHAVIOR_METHOD_3_704FAC4600717444_OFFSET UNITYSDK_OFFSET(0xDE16C50)
#define RPG_CLIENT_REFLECTIONHSVVOLUMEBEHAVIOR_METHOD_3_7C2C2820B36B9508_OFFSET UNITYSDK_OFFSET(0xDE16150)
#define RPG_CLIENT_REFLECTIONHSVVOLUMEBEHAVIOR_METHOD_3_9681042564541CD6_1_OFFSET UNITYSDK_OFFSET(0xDE16880)
#define RPG_CLIENT_REFLECTIONHSVVOLUMEBEHAVIOR_METHOD_3_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xDE160B0)
#define RPG_CLIENT_REFLECTIONHSVVOLUMEBEHAVIOR_METHOD_3_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0xDE170C0)
#define RPG_CLIENT_REFLECTIONHSVVOLUMEBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0xDE16B60)
#define RPG_CLIENT_REFLECTIONHSVVOLUMEBEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0xDE17270)
#define RPG_CLIENT_REFLECTIONHSVVOLUMEBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0xDE17200)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::RPG::Client::ReflectionHSVVolumeMonoPlugin*>**)Il2CppClass::FromTypeDefinitionIndex(ReflectionHSVVolumeBehavior_TypeDefinitionIndex)->GetStaticField(0x5EBE0);
		}
		static ::System::Int32* StaticGet__ReflectionHSVVolumePosMatrixID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ReflectionHSVVolumeBehavior_TypeDefinitionIndex)->GetStaticField(0x13630);
		}
		static ::System::Int32* StaticGet__ReflectionHSVVolumeCountID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ReflectionHSVVolumeBehavior_TypeDefinitionIndex)->GetStaticField(0x13634);
		}
		static ::System::Int32* StaticGet__ReflectionHSVVolumeSizeMatrixID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ReflectionHSVVolumeBehavior_TypeDefinitionIndex)->GetStaticField(0x13638);
		}
		static ::System::Boolean* StaticGet_isDirty()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(ReflectionHSVVolumeBehavior_TypeDefinitionIndex)->GetStaticField(0x1363C);
		}
