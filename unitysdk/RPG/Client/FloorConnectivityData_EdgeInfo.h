...
#define RPG_CLIENT_FLOORCONNECTIVITYDATA_EDGEINFO_GETFIRSTORDEFAULTCONNECTION_OFFSET UNITYSDK_OFFSET(0xBA60A40)
#define RPG_CLIENT_FLOORCONNECTIVITYDATA_EDGEINFO_TOSTRING_OFFSET UNITYSDK_OFFSET(0xBA61450)
#define RPG_CLIENT_FLOORCONNECTIVITYDATA_EDGEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xBA61030)
#define RPG_CLIENT_FLOORCONNECTIVITYDATA_EDGEINFO___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0xBA61550)

namespace RPG::Client
{
	inline static constexpr unsigned int FloorConnectivityData_EdgeInfo_TypeDefinitionIndex = 60026;
