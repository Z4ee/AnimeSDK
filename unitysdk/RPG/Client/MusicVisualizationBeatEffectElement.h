...
#define RPG_CLIENT_MUSICVISUALIZATIONBEATEFFECTELEMENT_METHOD_1_050E70FEDB783306_OFFSET UNITYSDK_OFFSET(0x9DDD190)
#define RPG_CLIENT_MUSICVISUALIZATIONBEATEFFECTELEMENT_METHOD_1_08DE6D6055D48622_OFFSET UNITYSDK_OFFSET(0x9DDC620)
#define RPG_CLIENT_MUSICVISUALIZATIONBEATEFFECTELEMENT_METHOD_1_1AF176CFC417D7E6_OFFSET UNITYSDK_OFFSET(0x9DDD350)
#define RPG_CLIENT_MUSICVISUALIZATIONBEATEFFECTELEMENT_METHOD_1_235F2F68A3E18565_OFFSET UNITYSDK_OFFSET(0x9DDD1E0)
#define RPG_CLIENT_MUSICVISUALIZATIONBEATEFFECTELEMENT_METHOD_1_25EC451C0EA68F53_1_OFFSET UNITYSDK_OFFSET(0x9DDBA00)
#define RPG_CLIENT_MUSICVISUALIZATIONBEATEFFECTELEMENT_METHOD_1_25EC451C0EA68F53_OFFSET UNITYSDK_OFFSET(0x9DDB830)
#define RPG_CLIENT_MUSICVISUALIZATIONBEATEFFECTELEMENT_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x9DDC1F0)
#define RPG_CLIENT_MUSICVISUALIZATIONBEATEFFECTELEMENT_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x9DDCCD0)
#define RPG_CLIENT_MUSICVISUALIZATIONBEATEFFECTELEMENT_METHOD_1_64865938ADBCB300_OFFSET UNITYSDK_OFFSET(0x9DDBCB0)
#define RPG_CLIENT_MUSICVISUALIZATIONBEATEFFECTELEMENT_METHOD_1_6D29A9D2B772184B_OFFSET UNITYSDK_OFFSET(0x9DDC770)
#define RPG_CLIENT_MUSICVISUALIZATIONBEATEFFECTELEMENT_METHOD_1_773889DEDA28F8D7_OFFSET UNITYSDK_OFFSET(0x9DDC8A0)
#define RPG_CLIENT_MUSICVISUALIZATIONBEATEFFECTELEMENT_METHOD_1_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0x9DDB770)
#define RPG_CLIENT_MUSICVISUALIZATIONBEATEFFECTELEMENT_METHOD_1_8FAD57395F26ACC4_OFFSET UNITYSDK_OFFSET(0x9DDCF60)
#define RPG_CLIENT_MUSICVISUALIZATIONBEATEFFECTELEMENT_METHOD_1_907E24F785836BA0_OFFSET UNITYSDK_OFFSET(0x9DDB300)
#define RPG_CLIENT_MUSICVISUALIZATIONBEATEFFECTELEMENT_METHOD_1_B768DA94E3FD91D9_OFFSET UNITYSDK_OFFSET(0x9DDC400)
#define RPG_CLIENT_MUSICVISUALIZATIONBEATEFFECTELEMENT_METHOD_1_BD10C86B2DE11FBC_OFFSET UNITYSDK_OFFSET(0x9DDCAA0)
#define RPG_CLIENT_MUSICVISUALIZATIONBEATEFFECTELEMENT_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x9DDB720)
#define RPG_CLIENT_MUSICVISUALIZATIONBEATEFFECTELEMENT_METHOD_1_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0x9DDC3B0)
#define RPG_CLIENT_MUSICVISUALIZATIONBEATEFFECTELEMENT_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x9DDB6E0)
#define RPG_CLIENT_MUSICVISUALIZATIONBEATEFFECTELEMENT_METHOD_1_CB613A5EF970C11B_OFFSET UNITYSDK_OFFSET(0x9DDD0A0)
#define RPG_CLIENT_MUSICVISUALIZATIONBEATEFFECTELEMENT_METHOD_1_CEE72EAC18ECC163_OFFSET UNITYSDK_OFFSET(0x9DDCEF0)
#define RPG_CLIENT_MUSICVISUALIZATIONBEATEFFECTELEMENT_METHOD_1_DB67EEFB041425EC_OFFSET UNITYSDK_OFFSET(0x9DDBBD0)
#define RPG_CLIENT_MUSICVISUALIZATIONBEATEFFECTELEMENT_METHOD_1_EDFD49C942C75D6C_OFFSET UNITYSDK_OFFSET(0x9DDC270)
#define RPG_CLIENT_MUSICVISUALIZATIONBEATEFFECTELEMENT_METHOD_1_F3DBA65049E25CB1_OFFSET UNITYSDK_OFFSET(0x9DDCE40)
#define RPG_CLIENT_MUSICVISUALIZATIONBEATEFFECTELEMENT_METHOD_1_FF98CB4188C95FE7_OFFSET UNITYSDK_OFFSET(0x9DDC530)
#define RPG_CLIENT_MUSICVISUALIZATIONBEATEFFECTELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x9DDD420)

namespace RPG::Client
{
	inline static constexpr unsigned int MusicVisualizationBeatEffectElement_TypeDefinitionIndex = 58009;
