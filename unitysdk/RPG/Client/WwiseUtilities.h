...
#define RPG_CLIENT_WWISEUTILITIES_ADDOUTPUT_OFFSET UNITYSDK_OFFSET(0xE43F910)
#define RPG_CLIENT_WWISEUTILITIES_EXCUTEACTIONONPLYAINGID_OFFSET UNITYSDK_OFFSET(0xE442400)
#define RPG_CLIENT_WWISEUTILITIES_EXECUTEACTIONONEVENT_OFFSET UNITYSDK_OFFSET(0xE442250)
#define RPG_CLIENT_WWISEUTILITIES_GETAUDIOBUFFER_OFFSET UNITYSDK_OFFSET(0xE442620)
#define RPG_CLIENT_WWISEUTILITIES_GETCURRENTLANGUAGE_OFFSET UNITYSDK_OFFSET(0xE441BD0)
#define RPG_CLIENT_WWISEUTILITIES_GETDEVICEIDFROMNAME_OFFSET UNITYSDK_OFFSET(0xE441F20)
#define RPG_CLIENT_WWISEUTILITIES_GETIDFROMSTRING_OFFSET UNITYSDK_OFFSET(0xE43FFC0)
#define RPG_CLIENT_WWISEUTILITIES_GETREFILLSBUFFER_OFFSET UNITYSDK_OFFSET(0xE441930)
#define RPG_CLIENT_WWISEUTILITIES_GETRTPCVALUE_OFFSET UNITYSDK_OFFSET(0xE441090)
#define RPG_CLIENT_WWISEUTILITIES_GETSOURCEPLAYPOSITION_OFFSET UNITYSDK_OFFSET(0xE440660)
#define RPG_CLIENT_WWISEUTILITIES_GETSTATE_OFFSET UNITYSDK_OFFSET(0xE440E50)
#define RPG_CLIENT_WWISEUTILITIES_ISWWISEENABLED_OFFSET UNITYSDK_OFFSET(0xE43E190)
#define RPG_CLIENT_WWISEUTILITIES_LOADBANKASYNC_OFFSET UNITYSDK_OFFSET(0xE43EE50)
#define RPG_CLIENT_WWISEUTILITIES_LOADBANK_1_OFFSET UNITYSDK_OFFSET(0xE43EA20)
#define RPG_CLIENT_WWISEUTILITIES_LOADBANK_OFFSET UNITYSDK_OFFSET(0xE43E630)
#define RPG_CLIENT_WWISEUTILITIES_LOADPATCHCONFIG_OFFSET UNITYSDK_OFFSET(0xE4427F0)
#define RPG_CLIENT_WWISEUTILITIES_LOADPCK_OFFSET UNITYSDK_OFFSET(0xE43DD50)
#define RPG_CLIENT_WWISEUTILITIES_POSTEVENT_OFFSET UNITYSDK_OFFSET(0xE43FE50)
#define RPG_CLIENT_WWISEUTILITIES_POSTEXTERNALSOURCE_OFFSET UNITYSDK_OFFSET(0xE4401B0)
#define RPG_CLIENT_WWISEUTILITIES_REMOVEOUTPUT_OFFSET UNITYSDK_OFFSET(0xE43FAA0)
#define RPG_CLIENT_WWISEUTILITIES_RENDERAUDIO_OFFSET UNITYSDK_OFFSET(0xE43F740)
#define RPG_CLIENT_WWISEUTILITIES_REPLACEOUTPUT_OFFSET UNITYSDK_OFFSET(0xE43FCC0)
#define RPG_CLIENT_WWISEUTILITIES_RESETGAMEOBJECTOUTPUTVOLUME_OFFSET UNITYSDK_OFFSET(0xE442750)
#define RPG_CLIENT_WWISEUTILITIES_SEEKONEVENTBYPERCENT_OFFSET UNITYSDK_OFFSET(0xE4404D0)
#define RPG_CLIENT_WWISEUTILITIES_SEEKONEVENT_OFFSET UNITYSDK_OFFSET(0xE440350)
#define RPG_CLIENT_WWISEUTILITIES_SETCURRENTLANGUAGE_OFFSET UNITYSDK_OFFSET(0xE441D00)
#define RPG_CLIENT_WWISEUTILITIES_SETGAMEOBJECTOUTPUTVOLUME_OFFSET UNITYSDK_OFFSET(0xE442690)
#define RPG_CLIENT_WWISEUTILITIES_SETMULTIPLEPOSITION_OFFSET UNITYSDK_OFFSET(0xE441510)
#define RPG_CLIENT_WWISEUTILITIES_SETOCCLUSION_OFFSET UNITYSDK_OFFSET(0xE4408A0)
#define RPG_CLIENT_WWISEUTILITIES_SETREFILLSBUFFER_OFFSET UNITYSDK_OFFSET(0xE4416A0)
#define RPG_CLIENT_WWISEUTILITIES_SETRTPCVALUE_OFFSET UNITYSDK_OFFSET(0xE441230)
#define RPG_CLIENT_WWISEUTILITIES_SETSTATE_OFFSET UNITYSDK_OFFSET(0xE440C20)
#define RPG_CLIENT_WWISEUTILITIES_SETSWITCH_OFFSET UNITYSDK_OFFSET(0xE440A90)
#define RPG_CLIENT_WWISEUTILITIES_STOPALLONOBJECT_OFFSET UNITYSDK_OFFSET(0xE442110)
#define RPG_CLIENT_WWISEUTILITIES_UNLOADALLBANKS_OFFSET UNITYSDK_OFFSET(0xE43F530)
#define RPG_CLIENT_WWISEUTILITIES_UNLOADALLPCKS_OFFSET UNITYSDK_OFFSET(0xE43E420)
#define RPG_CLIENT_WWISEUTILITIES_UNLOADBANKASYNC_OFFSET UNITYSDK_OFFSET(0xE43F3C0)
#define RPG_CLIENT_WWISEUTILITIES_UNLOADBANK_OFFSET UNITYSDK_OFFSET(0xE43F1A0)
#define RPG_CLIENT_WWISEUTILITIES_UNLOADPCK_OFFSET UNITYSDK_OFFSET(0xE43E210)
#define RPG_CLIENT_WWISEUTILITIES_WATCHRESULT_OFFSET UNITYSDK_OFFSET(0xE43E1D0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(WwiseUtilities_TypeDefinitionIndex)->GetStaticField(0x14C50);
		}
