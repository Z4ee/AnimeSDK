...
#define RPG_CLIENT_PROPSELECTIONSTATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xA234FB0)

namespace RPG::Client
{
	inline static constexpr unsigned int PropSelectionStateConfig_TypeDefinitionIndex = 48796;
