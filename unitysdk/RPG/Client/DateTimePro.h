...
#define RPG_CLIENT_DATETIMEPRO_ADDDAYS_OFFSET UNITYSDK_OFFSET(0x20F9640)
#define RPG_CLIENT_DATETIMEPRO_ADDHOURS_OFFSET UNITYSDK_OFFSET(0x20F96E0)
#define RPG_CLIENT_DATETIMEPRO_ADDMILLISECONDS_OFFSET UNITYSDK_OFFSET(0x20F98C0)
#define RPG_CLIENT_DATETIMEPRO_ADDMINUTES_OFFSET UNITYSDK_OFFSET(0x20F9780)
#define RPG_CLIENT_DATETIMEPRO_ADDMONTHSINBEIJINGTIME_OFFSET UNITYSDK_OFFSET(0x20F9A40)
#define RPG_CLIENT_DATETIMEPRO_ADDMONTHSINSERVERTIME_OFFSET UNITYSDK_OFFSET(0x20F9960)
#define RPG_CLIENT_DATETIMEPRO_ADDMONTHSINUTCTIME_OFFSET UNITYSDK_OFFSET(0x20F99B0)
#define RPG_CLIENT_DATETIMEPRO_ADDSECONDS_OFFSET UNITYSDK_OFFSET(0x20F9820)
#define RPG_CLIENT_DATETIMEPRO_ADDTICKS_OFFSET UNITYSDK_OFFSET(0x20F9550)
#define RPG_CLIENT_DATETIMEPRO_ADD_OFFSET UNITYSDK_OFFSET(0x20F9550)
#define RPG_CLIENT_DATETIMEPRO_COMPARETO_OFFSET UNITYSDK_OFFSET(0x20D23A0)
#define RPG_CLIENT_DATETIMEPRO_COMPARE_OFFSET UNITYSDK_OFFSET(0x18340AA0)
#define RPG_CLIENT_DATETIMEPRO_CREATEBYBEIJINGTIME_OFFSET UNITYSDK_OFFSET(0x1833FF20)
#define RPG_CLIENT_DATETIMEPRO_CREATEBYSERVERTIME_OFFSET UNITYSDK_OFFSET(0x1833FE70)
#define RPG_CLIENT_DATETIMEPRO_CREATEBYTIMESTAMPMILLISECONDS_OFFSET UNITYSDK_OFFSET(0x1833F8C0)
#define RPG_CLIENT_DATETIMEPRO_CREATEBYTIMESTAMPSECONDS_OFFSET UNITYSDK_OFFSET(0x1833F6D0)
#define RPG_CLIENT_DATETIMEPRO_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x20D2400)
#define RPG_CLIENT_DATETIMEPRO_EQUALS_2_OFFSET UNITYSDK_OFFSET(0x20F9B10)
#define RPG_CLIENT_DATETIMEPRO_EQUALS_OFFSET UNITYSDK_OFFSET(0x18340B00)
#define RPG_CLIENT_DATETIMEPRO_GETBEIJINGLITERALDATE_OFFSET UNITYSDK_OFFSET(0x20F9210)
#define RPG_CLIENT_DATETIMEPRO_GETBEIJINGSTARTOFDAY_OFFSET UNITYSDK_OFFSET(0x20F9380)
#define RPG_CLIENT_DATETIMEPRO_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x20D26B0)
#define RPG_CLIENT_DATETIMEPRO_GETLOCALLITERALDATE_OFFSET UNITYSDK_OFFSET(0x20F9180)
#define RPG_CLIENT_DATETIMEPRO_GETSERVERLITERALDATE_OFFSET UNITYSDK_OFFSET(0x20F91E0)
#define RPG_CLIENT_DATETIMEPRO_GETSERVERSTARTOFDAY_OFFSET UNITYSDK_OFFSET(0x20F9310)
#define RPG_CLIENT_DATETIMEPRO_GETSERVERSTARTOFHOUR_OFFSET UNITYSDK_OFFSET(0x20F9460)
#define RPG_CLIENT_DATETIMEPRO_GETTIMESTAMPMILLISECONDS_OFFSET UNITYSDK_OFFSET(0x20F9120)
#define RPG_CLIENT_DATETIMEPRO_GETTIMESTAMPSECONDS_OFFSET UNITYSDK_OFFSET(0x20F90B0)
#define RPG_CLIENT_DATETIMEPRO_GETUTCLITERALDATE_OFFSET UNITYSDK_OFFSET(0x20F91B0)
#define RPG_CLIENT_DATETIMEPRO_GETUTCSTARTOFDAY_OFFSET UNITYSDK_OFFSET(0x20F9240)
#define RPG_CLIENT_DATETIMEPRO_GET_MAXVALUE_OFFSET UNITYSDK_OFFSET(0x18341850)
#define RPG_CLIENT_DATETIMEPRO_GET_MINVALUE_OFFSET UNITYSDK_OFFSET(0x183418E0)
#define RPG_CLIENT_DATETIMEPRO_GET__BEIJINGTIME_OFFSET UNITYSDK_OFFSET(0x20F9D70)
#define RPG_CLIENT_DATETIMEPRO_GET__LOCALTIME_OFFSET UNITYSDK_OFFSET(0x20F9D60)
#define RPG_CLIENT_DATETIMEPRO_GET__SERVERTIME_OFFSET UNITYSDK_OFFSET(0x20F9CA0)
#define RPG_CLIENT_DATETIMEPRO_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x18340C10)
#define RPG_CLIENT_DATETIMEPRO_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x18340B70)
#define RPG_CLIENT_DATETIMEPRO_OP_GREATERTHANOREQUAL_OFFSET UNITYSDK_OFFSET(0x18340BF0)
#define RPG_CLIENT_DATETIMEPRO_OP_GREATERTHAN_OFFSET UNITYSDK_OFFSET(0x18340BB0)
#define RPG_CLIENT_DATETIMEPRO_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x18340B80)
#define RPG_CLIENT_DATETIMEPRO_OP_LESSTHANOREQUAL_OFFSET UNITYSDK_OFFSET(0x18340BD0)
#define RPG_CLIENT_DATETIMEPRO_OP_LESSTHAN_OFFSET UNITYSDK_OFFSET(0x18340B90)
#define RPG_CLIENT_DATETIMEPRO_OP_SUBTRACTION_1_OFFSET UNITYSDK_OFFSET(0x18340E90)
#define RPG_CLIENT_DATETIMEPRO_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x18340D70)
#define RPG_CLIENT_DATETIMEPRO_PARSEBEIJINGTIME_OFFSET UNITYSDK_OFFSET(0x1833FC90)
#define RPG_CLIENT_DATETIMEPRO_PARSESERVERTIME_OFFSET UNITYSDK_OFFSET(0x1833FAB0)
#define RPG_CLIENT_DATETIMEPRO_SUBTRACT_1_OFFSET UNITYSDK_OFFSET(0x20F9B40)
#define RPG_CLIENT_DATETIMEPRO_SUBTRACT_OFFSET UNITYSDK_OFFSET(0x20D2950)
#define RPG_CLIENT_DATETIMEPRO_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x20F9C70)
#define RPG_CLIENT_DATETIMEPRO_TOSTRING_2_OFFSET UNITYSDK_OFFSET(0x20F9C80)
#define RPG_CLIENT_DATETIMEPRO_TOSTRING_3_OFFSET UNITYSDK_OFFSET(0x20F9C90)
#define RPG_CLIENT_DATETIMEPRO_TOSTRING_OFFSET UNITYSDK_OFFSET(0x20F9C60)
#define RPG_CLIENT_DATETIMEPRO_TRYPARSEBEIJINGTIME_OFFSET UNITYSDK_OFFSET(0x1833FCD0)
#define RPG_CLIENT_DATETIMEPRO_TRYPARSESERVERTIME_OFFSET UNITYSDK_OFFSET(0x1833FAF0)
#define RPG_CLIENT_DATETIMEPRO__CCTOR_OFFSET UNITYSDK_OFFSET(0x18341970)
#define RPG_CLIENT_DATETIMEPRO__CREATEBYBEIJINGTIME_OFFSET UNITYSDK_OFFSET(0x18341700)
#define RPG_CLIENT_DATETIMEPRO__CREATEBYLOCALTIME_OFFSET UNITYSDK_OFFSET(0x183415F0)
#define RPG_CLIENT_DATETIMEPRO__CREATEBYSERVERTIME_OFFSET UNITYSDK_OFFSET(0x18341510)
#define RPG_CLIENT_DATETIMEPRO__CREATEBYUTCTIME_OFFSET UNITYSDK_OFFSET(0x18340D00)

namespace RPG::Client
{
	inline static constexpr unsigned int DateTimePro_TypeDefinitionIndex = 9492;

	struct alignas(8) DateTimePro
	{
		static ::System::DateTime* StaticGet__TimeStampEpoch()
		{
			return (::System::DateTime*)Il2CppClass::FromTypeDefinitionIndex(DateTimePro_TypeDefinitionIndex)->GetStaticField(0xC380);
		}
		static ::System::Int32* StaticGet__BeijingTimeOffset()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(DateTimePro_TypeDefinitionIndex)->GetStaticField(0xC388);
		}
