...
#define RPG_CLIENT_SEALPOOLMANAGER_CLEARALLSEALS_OFFSET UNITYSDK_OFFSET(0xB15A910)
#define RPG_CLIENT_SEALPOOLMANAGER_METHOD_5_1FD1221B75305432_OFFSET UNITYSDK_OFFSET(0xB15A2C0)
#define RPG_CLIENT_SEALPOOLMANAGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB15B200)
#define RPG_CLIENT_SEALPOOLMANAGER_START_OFFSET UNITYSDK_OFFSET(0xB15A150)
#define RPG_CLIENT_SEALPOOLMANAGER_TRYADDSEAL_OFFSET UNITYSDK_OFFSET(0xB15A530)
#define RPG_CLIENT_SEALPOOLMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0xB15AA80)
#define RPG_CLIENT_SEALPOOLMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xB15B400)

namespace RPG::Client
{
	inline static constexpr unsigned int SealPoolManager_TypeDefinitionIndex = 55711;
