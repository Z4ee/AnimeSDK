...
#define RPG_CLIENT_SEALPOOLMANAGER_CLEARALLSEALS_OFFSET UNITYSDK_OFFSET(0xC8AF030)
#define RPG_CLIENT_SEALPOOLMANAGER_METHOD_5_1FD1221B75305432_OFFSET UNITYSDK_OFFSET(0xC8AEA60)
#define RPG_CLIENT_SEALPOOLMANAGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC8AF930)
#define RPG_CLIENT_SEALPOOLMANAGER_START_OFFSET UNITYSDK_OFFSET(0xC8AE8F0)
#define RPG_CLIENT_SEALPOOLMANAGER_TRYADDSEAL_OFFSET UNITYSDK_OFFSET(0xC8AED20)
#define RPG_CLIENT_SEALPOOLMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0xC8AF180)
#define RPG_CLIENT_SEALPOOLMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xC8AFB40)

namespace RPG::Client
{
	inline static constexpr unsigned int SealPoolManager_TypeDefinitionIndex = 56465;
