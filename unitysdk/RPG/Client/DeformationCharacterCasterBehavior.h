...
#define RPG_CLIENT_DEFORMATIONCHARACTERCASTERBEHAVIOR_GET_HASRUNTIMEBINDING_OFFSET UNITYSDK_OFFSET(0xCC9B8E0)
#define RPG_CLIENT_DEFORMATIONCHARACTERCASTERBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0xCC9BF10)
#define RPG_CLIENT_DEFORMATIONCHARACTERCASTERBEHAVIOR_METHOD_3_0A827B867256B61D_OFFSET UNITYSDK_OFFSET(0xCC9BFF0)
#define RPG_CLIENT_DEFORMATIONCHARACTERCASTERBEHAVIOR_METHOD_3_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0xCC9C400)
#define RPG_CLIENT_DEFORMATIONCHARACTERCASTERBEHAVIOR_METHOD_3_245860B16C924CF6_OFFSET UNITYSDK_OFFSET(0xCC9BDF0)
#define RPG_CLIENT_DEFORMATIONCHARACTERCASTERBEHAVIOR_METHOD_3_305BA812E29C43AF_OFFSET UNITYSDK_OFFSET(0xCC9CA30)
#define RPG_CLIENT_DEFORMATIONCHARACTERCASTERBEHAVIOR_METHOD_3_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xCC9C700)
#define RPG_CLIENT_DEFORMATIONCHARACTERCASTERBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0xCC9C690)
#define RPG_CLIENT_DEFORMATIONCHARACTERCASTERBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xCC9B5D0)
#define RPG_CLIENT_DEFORMATIONCHARACTERCASTERBEHAVIOR_METHOD_3_83259CE775EE8F19_OFFSET UNITYSDK_OFFSET(0xCC9C7A0)
#define RPG_CLIENT_DEFORMATIONCHARACTERCASTERBEHAVIOR_METHOD_3_8542E37E74FDE1B5_OFFSET UNITYSDK_OFFSET(0xCC9B980)
#define RPG_CLIENT_DEFORMATIONCHARACTERCASTERBEHAVIOR_METHOD_3_930073A6194C4594_OFFSET UNITYSDK_OFFSET(0xCC9B470)
#define RPG_CLIENT_DEFORMATIONCHARACTERCASTERBEHAVIOR_METHOD_3_9681042564541CD6_1_OFFSET UNITYSDK_OFFSET(0xCC9B400)
#define RPG_CLIENT_DEFORMATIONCHARACTERCASTERBEHAVIOR_METHOD_3_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xCC9B370)
#define RPG_CLIENT_DEFORMATIONCHARACTERCASTERBEHAVIOR_METHOD_3_A30A293C4A520E17_OFFSET UNITYSDK_OFFSET(0xCC9C380)
#define RPG_CLIENT_DEFORMATIONCHARACTERCASTERBEHAVIOR_METHOD_3_AA317D53E714CBE8_OFFSET UNITYSDK_OFFSET(0xCC9BF50)
#define RPG_CLIENT_DEFORMATIONCHARACTERCASTERBEHAVIOR_METHOD_3_B749F4B0D43F6641_OFFSET UNITYSDK_OFFSET(0xCC9BD90)
#define RPG_CLIENT_DEFORMATIONCHARACTERCASTERBEHAVIOR_METHOD_3_C3F147D70BD50952_OFFSET UNITYSDK_OFFSET(0xCC9CF40)
#define RPG_CLIENT_DEFORMATIONCHARACTERCASTERBEHAVIOR_METHOD_3_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xCC9C640)
#define RPG_CLIENT_DEFORMATIONCHARACTERCASTERBEHAVIOR_METHOD_3_CE8DC3326B601721_OFFSET UNITYSDK_OFFSET(0xCC9CAD0)
#define RPG_CLIENT_DEFORMATIONCHARACTERCASTERBEHAVIOR_METHOD_3_D9BF9B27FAC3AAD2_OFFSET UNITYSDK_OFFSET(0xCC9C4C0)
#define RPG_CLIENT_DEFORMATIONCHARACTERCASTERBEHAVIOR_METHOD_3_F1C870D01294DAF7_OFFSET UNITYSDK_OFFSET(0xCC9B640)
#define RPG_CLIENT_DEFORMATIONCHARACTERCASTERBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0xCC9C740)
#define RPG_CLIENT_DEFORMATIONCHARACTERCASTERBEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0xCC9D210)
#define RPG_CLIENT_DEFORMATIONCHARACTERCASTERBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0xCC9D180)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(DeformationCharacterCasterBehavior_TypeDefinitionIndex)->GetStaticField(0x5C630);
		}
