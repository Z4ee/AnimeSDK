...
#define RPG_CLIENT_MONOESCALATORITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xC109260)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEscalatorItem_TypeDefinitionIndex = 64170;
