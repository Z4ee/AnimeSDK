...
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATIONBATCHER_AWAKE_OFFSET UNITYSDK_OFFSET(0x150ED2F0)
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATIONBATCHER_GET_BEHAVIOR_OFFSET UNITYSDK_OFFSET(0x150ED4F0)
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATIONBATCHER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x150ED4A0)
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATIONBATCHER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x150ED3C0)
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATIONBATCHER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x150ED450)
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATIONBATCHER__CTOR_OFFSET UNITYSDK_OFFSET(0x150ED500)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_GPUCrowdAnimationBatcher_TypeDefinitionIndex = 67323;

	class Effect_GPUCrowdAnimationBatcher : public ::UnityEngine::MonoBehaviour
	{
	public:
		::Class_2_3092D1F427FB5418* Field_5_0; // 0x18
