...
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE_FINISHROUND_OFFSET UNITYSDK_OFFSET(0xCC3B790)
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE_GETBATTLEBUFFEFFECTDATAITEMS_OFFSET UNITYSDK_OFFSET(0xCC3B6C0)
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE_GETSUCCESSEFFECTRESULT_OFFSET UNITYSDK_OFFSET(0xCC3B700)
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE_GET_ISINHANUSHOOTING_OFFSET UNITYSDK_OFFSET(0xCC3D6A0)
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE_GET_ISINMOVIEGAME_OFFSET UNITYSDK_OFFSET(0xCC3D680)
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE_GET_SCORELEVEL_OFFSET UNITYSDK_OFFSET(0xCC3D6C0)
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE_SET_ISINHANUSHOOTING_OFFSET UNITYSDK_OFFSET(0xCC3D6B0)
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE_SET_ISINMOVIEGAME_OFFSET UNITYSDK_OFFSET(0xCC3D690)
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE_SET_SCORELEVEL_OFFSET UNITYSDK_OFFSET(0xCC3D6D0)
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE__ADDHANUSHOOTINGNOTIFY_OFFSET UNITYSDK_OFFSET(0xCC3D0E0)
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0xCC39770)
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE__GETHANUSHOOTINGLEVELID_OFFSET UNITYSDK_OFFSET(0xCC3CCD0)
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE__GETHANUSHOOTINGSCORELEVEL_OFFSET UNITYSDK_OFFSET(0xCC3D3F0)
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE__GETHANUSHOOTINGTRIGGERSTR_OFFSET UNITYSDK_OFFSET(0xCC3D050)
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE__GETMOVIESTAGEID_OFFSET UNITYSDK_OFFSET(0xCC3C430)
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE__ISVALIDGAMEBUFFTYPE_OFFSET UNITYSDK_OFFSET(0xCC3C3E0)
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE__ONENTER_OFFSET UNITYSDK_OFFSET(0xCC3ABC0)
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE__ONFINISHHANUSHOOTING_OFFSET UNITYSDK_OFFSET(0xCC3D460)
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE__ONFINISHMOVIEGAME_OFFSET UNITYSDK_OFFSET(0xCC3CB10)
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE__ONUIMOVIERACINGGAMERESULT_OFFSET UNITYSDK_OFFSET(0xCC3C7A0)
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE__ONUIWOLFBROSHOOTINGEXITGAME_OFFSET UNITYSDK_OFFSET(0xCC3D620)
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE__ONUIWOLFBROSHOOTINGSUCCESS_OFFSET UNITYSDK_OFFSET(0xCC3D300)
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE__RECORDEFFECTDATAITEMS_OFFSET UNITYSDK_OFFSET(0xCC3B1D0)
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE__REMOVEHANUSHOOTINGNOTIFY_OFFSET UNITYSDK_OFFSET(0xCC3D1F0)
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE__SETMOVIEGAMETARGETSCORE_OFFSET UNITYSDK_OFFSET(0xCC3BA70)
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE__TRIGGERHANUSHOOTING_OFFSET UNITYSDK_OFFSET(0xCC3C120)
#define RPG_CLIENT_CLOCKPARKLITTLEGAMESTATE__TRIGGERMOVIEGAME_OFFSET UNITYSDK_OFFSET(0xCC3BEA0)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::UInt32 _ScoreLevel_k__BackingField; // 0x30
