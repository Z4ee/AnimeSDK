...
#define RPG_CLIENT_UIADVENTUREMINIMAP_INSTANCEDLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0xA671810)

namespace RPG::Client
{
	inline static constexpr unsigned int UIAdventureMinimap_InstancedLayer_TypeDefinitionIndex = 56421;
