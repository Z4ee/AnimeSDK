...
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0xB2D2E20)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_GET_TARGETALPHA_OFFSET UNITYSDK_OFFSET(0xB2D49C0)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_GET_TARGETEVALUATOR_OFFSET UNITYSDK_OFFSET(0xB2D4980)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_GET_TARGETLIMITHEIGHT_OFFSET UNITYSDK_OFFSET(0xB2D49A0)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_GET_TARGET_OFFSET UNITYSDK_OFFSET(0xB2D4950)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_GET_WEIGHT_OFFSET UNITYSDK_OFFSET(0xB2D4930)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_METHOD_1_06052BE3262A4192_OFFSET UNITYSDK_OFFSET(0xB2D3E10)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_METHOD_1_374781907C88EFD7_OFFSET UNITYSDK_OFFSET(0xB2D3750)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_METHOD_1_472E9805B297BD58_OFFSET UNITYSDK_OFFSET(0xB2D48A0)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_METHOD_1_4F6E40C18A7A5A9E_OFFSET UNITYSDK_OFFSET(0xB2D2B60)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_METHOD_1_508D4DD02D3DB74E_OFFSET UNITYSDK_OFFSET(0xB2D3910)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_METHOD_1_A84CEAF7AFA573B3_OFFSET UNITYSDK_OFFSET(0xB2D35E0)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_METHOD_1_BB8271ED1BDF8503_OFFSET UNITYSDK_OFFSET(0xB2D3D60)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_SET_TARGETALPHA_OFFSET UNITYSDK_OFFSET(0xB2D49D0)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_SET_TARGETEVALUATOR_OFFSET UNITYSDK_OFFSET(0xB2D4990)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_SET_TARGETLIMITHEIGHT_OFFSET UNITYSDK_OFFSET(0xB2D49B0)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_SET_TARGET_OFFSET UNITYSDK_OFFSET(0xB2D4970)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_SET_WEIGHT_OFFSET UNITYSDK_OFFSET(0xB2D4940)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER__CTOR_OFFSET UNITYSDK_OFFSET(0xB2D49E0)

namespace RPG::Client
{
	inline static constexpr unsigned int AimSolverMultiAimer_TypeDefinitionIndex = 64073;
