...
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x9086C30)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_GET_TARGETALPHA_OFFSET UNITYSDK_OFFSET(0x9088820)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_GET_TARGETEVALUATOR_OFFSET UNITYSDK_OFFSET(0x90887E0)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_GET_TARGETLIMITHEIGHT_OFFSET UNITYSDK_OFFSET(0x9088800)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_GET_TARGET_OFFSET UNITYSDK_OFFSET(0x90887B0)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_GET_WEIGHT_OFFSET UNITYSDK_OFFSET(0x9088790)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_METHOD_1_06052BE3262A4192_OFFSET UNITYSDK_OFFSET(0x9087C70)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_METHOD_1_374781907C88EFD7_OFFSET UNITYSDK_OFFSET(0x9087560)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_METHOD_1_472E9805B297BD58_OFFSET UNITYSDK_OFFSET(0x9088700)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_METHOD_1_4F6E40C18A7A5A9E_OFFSET UNITYSDK_OFFSET(0x9086950)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_METHOD_1_508D4DD02D3DB74E_OFFSET UNITYSDK_OFFSET(0x9087740)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_METHOD_1_A84CEAF7AFA573B3_OFFSET UNITYSDK_OFFSET(0x90873F0)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_METHOD_1_BB8271ED1BDF8503_OFFSET UNITYSDK_OFFSET(0x9087BC0)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_SET_TARGETALPHA_OFFSET UNITYSDK_OFFSET(0x9088830)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_SET_TARGETEVALUATOR_OFFSET UNITYSDK_OFFSET(0x90887F0)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_SET_TARGETLIMITHEIGHT_OFFSET UNITYSDK_OFFSET(0x9088810)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_SET_TARGET_OFFSET UNITYSDK_OFFSET(0x90887D0)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_SET_WEIGHT_OFFSET UNITYSDK_OFFSET(0x90887A0)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER__CTOR_OFFSET UNITYSDK_OFFSET(0x9088840)

namespace RPG::Client
{
	inline static constexpr unsigned int AimSolverMultiAimer_TypeDefinitionIndex = 55922;
