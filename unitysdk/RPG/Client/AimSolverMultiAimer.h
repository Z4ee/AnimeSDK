...
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0xC71C540)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_GET_TARGETALPHA_OFFSET UNITYSDK_OFFSET(0xC71E0E0)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_GET_TARGETEVALUATOR_OFFSET UNITYSDK_OFFSET(0xC71E0A0)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_GET_TARGETLIMITHEIGHT_OFFSET UNITYSDK_OFFSET(0xC71E0C0)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_GET_TARGET_OFFSET UNITYSDK_OFFSET(0xC71E070)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_GET_WEIGHT_OFFSET UNITYSDK_OFFSET(0xC71E050)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_METHOD_1_06052BE3262A4192_OFFSET UNITYSDK_OFFSET(0xC71D530)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_METHOD_1_374781907C88EFD7_OFFSET UNITYSDK_OFFSET(0xC71CE70)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_METHOD_1_472E9805B297BD58_OFFSET UNITYSDK_OFFSET(0xC71DFC0)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_METHOD_1_4F6E40C18A7A5A9E_OFFSET UNITYSDK_OFFSET(0xC71C280)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_METHOD_1_508D4DD02D3DB74E_OFFSET UNITYSDK_OFFSET(0xC71D030)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_METHOD_1_A84CEAF7AFA573B3_OFFSET UNITYSDK_OFFSET(0xC71CD00)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_METHOD_1_BB8271ED1BDF8503_OFFSET UNITYSDK_OFFSET(0xC71D480)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_SET_TARGETALPHA_OFFSET UNITYSDK_OFFSET(0xC71E0F0)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_SET_TARGETEVALUATOR_OFFSET UNITYSDK_OFFSET(0xC71E0B0)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_SET_TARGETLIMITHEIGHT_OFFSET UNITYSDK_OFFSET(0xC71E0D0)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_SET_TARGET_OFFSET UNITYSDK_OFFSET(0xC71E090)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER_SET_WEIGHT_OFFSET UNITYSDK_OFFSET(0xC71E060)
#define RPG_CLIENT_AIMSOLVERMULTIAIMER__CTOR_OFFSET UNITYSDK_OFFSET(0xC71E100)
