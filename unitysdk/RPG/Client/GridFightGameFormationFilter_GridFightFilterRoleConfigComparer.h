...
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER_GRIDFIGHTFILTERROLECONFIGCOMPARER_EQUALS_OFFSET UNITYSDK_OFFSET(0x1ABDDB50)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER_GRIDFIGHTFILTERROLECONFIGCOMPARER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1ABDDBC0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER_GRIDFIGHTFILTERROLECONFIGCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABDD140)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightGameFormationFilter_GridFightFilterRoleConfigComparer_TypeDefinitionIndex = 61765;
