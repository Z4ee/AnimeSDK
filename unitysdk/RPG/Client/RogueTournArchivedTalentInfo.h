...
#define RPG_CLIENT_ROGUETOURNARCHIVEDTALENTINFO_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1983FBD0)
#define RPG_CLIENT_ROGUETOURNARCHIVEDTALENTINFO_GET_TITANTALENTINFO_OFFSET UNITYSDK_OFFSET(0x1983FC20)
#define RPG_CLIENT_ROGUETOURNARCHIVEDTALENTINFO_INIT_OFFSET UNITYSDK_OFFSET(0x1983FB80)
#define RPG_CLIENT_ROGUETOURNARCHIVEDTALENTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1983FB50)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueTournArchivedTalentInfo_TypeDefinitionIndex = 64845;
