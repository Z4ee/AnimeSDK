...
#define RPG_CLIENT_ROGUETOURNARCHIVEDTALENTINFO_DISPOSE_OFFSET UNITYSDK_OFFSET(0xDF28B40)
#define RPG_CLIENT_ROGUETOURNARCHIVEDTALENTINFO_GET_TITANTALENTINFO_OFFSET UNITYSDK_OFFSET(0xDF28B90)
#define RPG_CLIENT_ROGUETOURNARCHIVEDTALENTINFO_INIT_OFFSET UNITYSDK_OFFSET(0xDF28AF0)
#define RPG_CLIENT_ROGUETOURNARCHIVEDTALENTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xDF28AC0)
