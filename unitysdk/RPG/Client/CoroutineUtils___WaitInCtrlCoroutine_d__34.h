...
#define RPG_CLIENT_COROUTINEUTILS___WAITINCTRLCOROUTINE_D__34_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1E58EC60)
#define RPG_CLIENT_COROUTINEUTILS___WAITINCTRLCOROUTINE_D__34_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1E58EEA0)
#define RPG_CLIENT_COROUTINEUTILS___WAITINCTRLCOROUTINE_D__34_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1E58EF00)
#define RPG_CLIENT_COROUTINEUTILS___WAITINCTRLCOROUTINE_D__34_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1E58EEB0)
#define RPG_CLIENT_COROUTINEUTILS___WAITINCTRLCOROUTINE_D__34_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E58EC50)
#define RPG_CLIENT_COROUTINEUTILS___WAITINCTRLCOROUTINE_D__34__CTOR_OFFSET UNITYSDK_OFFSET(0x1E58E130)
