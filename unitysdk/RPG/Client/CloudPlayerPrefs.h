...
#define RPG_CLIENT_CLOUDPLAYERPREFS_DELETEKEY_OFFSET UNITYSDK_OFFSET(0x1BC1B3C0)
#define RPG_CLIENT_CLOUDPLAYERPREFS_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1BC1A630)
#define RPG_CLIENT_CLOUDPLAYERPREFS_FLUSH_OFFSET UNITYSDK_OFFSET(0x1BC1B4D0)
#define RPG_CLIENT_CLOUDPLAYERPREFS_GET_ISPARTIALSAVE_OFFSET UNITYSDK_OFFSET(0x1BC1BEF0)
#define RPG_CLIENT_CLOUDPLAYERPREFS_LOAD_OFFSET UNITYSDK_OFFSET(0x1BC1A8E0)
#define RPG_CLIENT_CLOUDPLAYERPREFS_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1BC1A580)
#define RPG_CLIENT_CLOUDPLAYERPREFS__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC1BF00)
