...
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_00A968F776BCC204_OFFSET UNITYSDK_OFFSET(0x1A310170)
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_224BCAB043AC8B27_OFFSET UNITYSDK_OFFSET(0x1A3106F0)
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_25EC451C0EA68F53_1_OFFSET UNITYSDK_OFFSET(0x1A30F840)
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_25EC451C0EA68F53_OFFSET UNITYSDK_OFFSET(0x1A30F670)
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x1A3105A0)
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_314BF8EF46C5FD93_OFFSET UNITYSDK_OFFSET(0x1A311240)
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_3200429A74A84938_OFFSET UNITYSDK_OFFSET(0x1A311440)
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x1A30FCA0)
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_3E23A2EE3F65066B_OFFSET UNITYSDK_OFFSET(0x1A30FEB0)
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_558C6AE12602A241_OFFSET UNITYSDK_OFFSET(0x1A30F610)
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_71D239EC67769A2B_OFFSET UNITYSDK_OFFSET(0x1A311360)
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_893814ED967AF5E7_OFFSET UNITYSDK_OFFSET(0x1A30FAF0)
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_89ECADC0D3C7C373_OFFSET UNITYSDK_OFFSET(0x1A311070)
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_941E84C8EA8C3EAE_OFFSET UNITYSDK_OFFSET(0x1A310870)
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_A56385E6706FA723_OFFSET UNITYSDK_OFFSET(0x1A30F110)
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_B7F8E0B4AF22DEA3_1_OFFSET UNITYSDK_OFFSET(0x1A310030)
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_B7F8E0B4AF22DEA3_OFFSET UNITYSDK_OFFSET(0x1A30FD20)
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x1A30F5C0)
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0x1A30FE60)
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_CA373AA1C7054598_3_OFFSET UNITYSDK_OFFSET(0x1A310FF0)
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_CA373AA1C7054598_4_OFFSET UNITYSDK_OFFSET(0x1A311030)
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1A30F580)
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_CEE72EAC18ECC163_1_OFFSET UNITYSDK_OFFSET(0x1A310690)
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_CEE72EAC18ECC163_OFFSET UNITYSDK_OFFSET(0x1A310630)
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_E855A974FE0C8866_OFFSET UNITYSDK_OFFSET(0x1A30FA10)
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT_METHOD_1_FE30E111A9764985_OFFSET UNITYSDK_OFFSET(0x1A3109A0)
#define RPG_CLIENT_MUSICVISUALIZATIONSPECTRUMEFFECTELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3117B0)

namespace RPG::Client
{
	inline static constexpr unsigned int MusicVisualizationSpectrumEffectElement_TypeDefinitionIndex = 70790;
