...
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCELEFTNORMALMONSTERITEM_GET_DESC_OFFSET UNITYSDK_OFFSET(0xA34AB00)
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCELEFTNORMALMONSTERITEM_GET_VALUE_OFFSET UNITYSDK_OFFSET(0xA34A690)
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCELEFTNORMALMONSTERITEM_GET__DMGMAXLIMIT_OFFSET UNITYSDK_OFFSET(0xA34A9A0)
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCELEFTNORMALMONSTERITEM_GET__DMGPERLEFTMONSTER_OFFSET UNITYSDK_OFFSET(0xA34A840)
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCELEFTNORMALMONSTERITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xA34A680)
