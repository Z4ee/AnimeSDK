...
#define RPG_CLIENT_PROPSELECTIONMATERIALCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xA234FA0)

namespace RPG::Client
{
	inline static constexpr unsigned int PropSelectionMaterialConfig_TypeDefinitionIndex = 48795;
