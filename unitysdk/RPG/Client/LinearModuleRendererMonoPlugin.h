...
#define RPG_CLIENT_LINEARMODULERENDERERMONOPLUGIN_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x99831E0)
#define RPG_CLIENT_LINEARMODULERENDERERMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x9983230)
#define RPG_CLIENT_LINEARMODULERENDERERMONOPLUGIN___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x9983240)

namespace RPG::Client
{
	inline static constexpr unsigned int LinearModuleRendererMonoPlugin_TypeDefinitionIndex = 58076;
