...
#define RPG_CLIENT_UIUTILS___C__DISPLAYCLASS67_0__CREATEBLOCKER_B__0_OFFSET UNITYSDK_OFFSET(0xA73F300)
#define RPG_CLIENT_UIUTILS___C__DISPLAYCLASS67_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA73EF50)

namespace RPG::Client
{
	inline static constexpr unsigned int UIUtils___c__DisplayClass67_0_TypeDefinitionIndex = 59998;
