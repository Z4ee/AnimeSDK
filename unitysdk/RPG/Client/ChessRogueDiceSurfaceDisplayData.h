...
#define RPG_CLIENT_CHESSROGUEDICESURFACEDISPLAYDATA_CREATE_1_OFFSET UNITYSDK_OFFSET(0xCBA4D80)
#define RPG_CLIENT_CHESSROGUEDICESURFACEDISPLAYDATA_CREATE_2_OFFSET UNITYSDK_OFFSET(0xCBA4E10)
#define RPG_CLIENT_CHESSROGUEDICESURFACEDISPLAYDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xCBA4BE0)
#define RPG_CLIENT_CHESSROGUEDICESURFACEDISPLAYDATA_GET_DESCPARAM_OFFSET UNITYSDK_OFFSET(0xCBA50D0)
#define RPG_CLIENT_CHESSROGUEDICESURFACEDISPLAYDATA_GET_DICEACTIVESTAGE_OFFSET UNITYSDK_OFFSET(0xCBA52D0)
#define RPG_CLIENT_CHESSROGUEDICESURFACEDISPLAYDATA_GET_DICEEFFECTTYPE_OFFSET UNITYSDK_OFFSET(0xCBA5330)
#define RPG_CLIENT_CHESSROGUEDICESURFACEDISPLAYDATA_GET_DICESURFACEDESC_OFFSET UNITYSDK_OFFSET(0xCBA5050)
#define RPG_CLIENT_CHESSROGUEDICESURFACEDISPLAYDATA_GET_DICESURFACEICON_OFFSET UNITYSDK_OFFSET(0xCBA4F10)
#define RPG_CLIENT_CHESSROGUEDICESURFACEDISPLAYDATA_GET_DICESURFACENAME_OFFSET UNITYSDK_OFFSET(0xCBA4FD0)
#define RPG_CLIENT_CHESSROGUEDICESURFACEDISPLAYDATA_GET_EXTRAEFFECT_OFFSET UNITYSDK_OFFSET(0xCBA51A0)
#define RPG_CLIENT_CHESSROGUEDICESURFACEDISPLAYDATA_GET_ICONNEEDSETCOLOR_OFFSET UNITYSDK_OFFSET(0xCBA4F80)
#define RPG_CLIENT_CHESSROGUEDICESURFACEDISPLAYDATA_GET_RARITY_OFFSET UNITYSDK_OFFSET(0xCBA5140)
#define RPG_CLIENT_CHESSROGUEDICESURFACEDISPLAYDATA_GET_SORT_OFFSET UNITYSDK_OFFSET(0xCBA5270)
#define RPG_CLIENT_CHESSROGUEDICESURFACEDISPLAYDATA_GET_SURFACEID_OFFSET UNITYSDK_OFFSET(0xCBA4EB0)
#define RPG_CLIENT_CHESSROGUEDICESURFACEDISPLAYDATA_GET_SURFACETAGS_OFFSET UNITYSDK_OFFSET(0xCBA5210)
#define RPG_CLIENT_CHESSROGUEDICESURFACEDISPLAYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCBA4EA0)
