...
#define RPG_CLIENT_CHESSROGUEDICESURFACEDISPLAYDATA_CREATE_1_OFFSET UNITYSDK_OFFSET(0x1AA9EE00)
#define RPG_CLIENT_CHESSROGUEDICESURFACEDISPLAYDATA_CREATE_2_OFFSET UNITYSDK_OFFSET(0x1AA9EE90)
#define RPG_CLIENT_CHESSROGUEDICESURFACEDISPLAYDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1AA9EC60)
#define RPG_CLIENT_CHESSROGUEDICESURFACEDISPLAYDATA_GET_DESCPARAM_OFFSET UNITYSDK_OFFSET(0x1AA9F140)
#define RPG_CLIENT_CHESSROGUEDICESURFACEDISPLAYDATA_GET_DICEACTIVESTAGE_OFFSET UNITYSDK_OFFSET(0x1AA9F330)
#define RPG_CLIENT_CHESSROGUEDICESURFACEDISPLAYDATA_GET_DICEEFFECTTYPE_OFFSET UNITYSDK_OFFSET(0x1AA9F390)
#define RPG_CLIENT_CHESSROGUEDICESURFACEDISPLAYDATA_GET_DICESURFACEDESC_OFFSET UNITYSDK_OFFSET(0x1AA9F0C0)
#define RPG_CLIENT_CHESSROGUEDICESURFACEDISPLAYDATA_GET_DICESURFACEICON_OFFSET UNITYSDK_OFFSET(0x1AA9EF90)
#define RPG_CLIENT_CHESSROGUEDICESURFACEDISPLAYDATA_GET_DICESURFACENAME_OFFSET UNITYSDK_OFFSET(0x1AA9F050)
#define RPG_CLIENT_CHESSROGUEDICESURFACEDISPLAYDATA_GET_EXTRAEFFECT_OFFSET UNITYSDK_OFFSET(0x1AA9F210)
#define RPG_CLIENT_CHESSROGUEDICESURFACEDISPLAYDATA_GET_ICONNEEDSETCOLOR_OFFSET UNITYSDK_OFFSET(0x1AA9F000)
#define RPG_CLIENT_CHESSROGUEDICESURFACEDISPLAYDATA_GET_RARITY_OFFSET UNITYSDK_OFFSET(0x1AA9F1B0)
#define RPG_CLIENT_CHESSROGUEDICESURFACEDISPLAYDATA_GET_SORT_OFFSET UNITYSDK_OFFSET(0x1AA9F2D0)
#define RPG_CLIENT_CHESSROGUEDICESURFACEDISPLAYDATA_GET_SURFACEID_OFFSET UNITYSDK_OFFSET(0x1AA9EF30)
#define RPG_CLIENT_CHESSROGUEDICESURFACEDISPLAYDATA_GET_SURFACETAGS_OFFSET UNITYSDK_OFFSET(0x1AA9F270)
#define RPG_CLIENT_CHESSROGUEDICESURFACEDISPLAYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA9EF20)

namespace RPG::Client
{
	inline static constexpr unsigned int ChessRogueDiceSurfaceDisplayData_TypeDefinitionIndex = 63957;
