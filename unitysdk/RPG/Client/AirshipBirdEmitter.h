...
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_AWAKE_OFFSET UNITYSDK_OFFSET(0x17EC1930)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_CREATEMANAGER_OFFSET UNITYSDK_OFFSET(0x17EC0DD0)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17EC14F0)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_GET_CURRENTEMITINTERVAL_OFFSET UNITYSDK_OFFSET(0x17EC1BC0)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_GET_CURRENTMAXALIVECOUNT_OFFSET UNITYSDK_OFFSET(0x17EC1BA0)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_GET_WAITEMITTIMER_OFFSET UNITYSDK_OFFSET(0x17EC0E80)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_ISREADYTOEMIT_OFFSET UNITYSDK_OFFSET(0x17EC0ED0)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_METHOD_5_22C04E98AEE4E2EB_OFFSET UNITYSDK_OFFSET(0x17EC1730)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_METHOD_5_4DE65AB3A4860CEB_OFFSET UNITYSDK_OFFSET(0x17EC1540)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_METHOD_5_886F54B83F44F5F0_OFFSET UNITYSDK_OFFSET(0x17EC1220)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_METHOD_5_C51A83DB17CCB044_OFFSET UNITYSDK_OFFSET(0x17EC1270)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_METHOD_5_F5445E49035A19AE_OFFSET UNITYSDK_OFFSET(0x17EC1450)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_READYTOEMIT_OFFSET UNITYSDK_OFFSET(0x17EC0F40)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_RESETTIMER_OFFSET UNITYSDK_OFFSET(0x17EC1170)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_RESET_OFFSET UNITYSDK_OFFSET(0x17EC1AF0)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_SET_CURRENTEMITINTERVAL_OFFSET UNITYSDK_OFFSET(0x17EC1BD0)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_SET_CURRENTMAXALIVECOUNT_OFFSET UNITYSDK_OFFSET(0x17EC1BB0)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_TICK_OFFSET UNITYSDK_OFFSET(0x17EC16D0)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_TRYDESTROY_OFFSET UNITYSDK_OFFSET(0x17EC1380)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_TRYEMIT_OFFSET UNITYSDK_OFFSET(0x17EC0F90)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_UPDATELEVELINFO_OFFSET UNITYSDK_OFFSET(0x17EC19C0)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER__CTOR_OFFSET UNITYSDK_OFFSET(0x17EC1BE0)

namespace RPG::Client
{
	inline static constexpr unsigned int AirshipBirdEmitter_TypeDefinitionIndex = 57143;
	...
	public:
		...
		{
			return ((::Class_0_16E4307DCC419505_624*(*)(::PVOID, ::System::UInt32, ::System::String*))((::PBYTE)hIl2Cpp + RPG_CLIENT_AIRSHIPBIRDEMITTER_CREATEMANAGER_OFFSET))(this, a1, a2);
		}
