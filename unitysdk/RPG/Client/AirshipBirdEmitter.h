...
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_AWAKE_OFFSET UNITYSDK_OFFSET(0x9CF0BA0)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_CREATEMANAGER_OFFSET UNITYSDK_OFFSET(0x9CEFFD0)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9CF0740)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_GET_CURRENTEMITINTERVAL_OFFSET UNITYSDK_OFFSET(0x9CF0E30)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_GET_CURRENTMAXALIVECOUNT_OFFSET UNITYSDK_OFFSET(0x9CF0E10)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_GET_WAITEMITTIMER_OFFSET UNITYSDK_OFFSET(0x9CF0080)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_ISREADYTOEMIT_OFFSET UNITYSDK_OFFSET(0x9CF00D0)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_METHOD_5_22C04E98AEE4E2EB_OFFSET UNITYSDK_OFFSET(0x9CF09A0)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_METHOD_5_886F54B83F44F5F0_OFFSET UNITYSDK_OFFSET(0x9CF0470)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_METHOD_5_C51A83DB17CCB044_OFFSET UNITYSDK_OFFSET(0x9CF04C0)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_METHOD_5_D4885672DDCDDB39_OFFSET UNITYSDK_OFFSET(0x9CF06A0)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_METHOD_5_FCB175EE4400634C_OFFSET UNITYSDK_OFFSET(0x9CF0790)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_READYTOEMIT_OFFSET UNITYSDK_OFFSET(0x9CF0140)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_RESETTIMER_OFFSET UNITYSDK_OFFSET(0x9CF03C0)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_RESET_OFFSET UNITYSDK_OFFSET(0x9CF0CF0)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_SET_CURRENTEMITINTERVAL_OFFSET UNITYSDK_OFFSET(0x9CF0E40)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_SET_CURRENTMAXALIVECOUNT_OFFSET UNITYSDK_OFFSET(0x9CF0E20)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_TICK_OFFSET UNITYSDK_OFFSET(0x9CF0940)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_TRYDESTROY_OFFSET UNITYSDK_OFFSET(0x9CF05D0)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_TRYEMIT_OFFSET UNITYSDK_OFFSET(0x9CF0190)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_UPDATELEVELINFO_OFFSET UNITYSDK_OFFSET(0x9CF0C00)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER__CTOR_OFFSET UNITYSDK_OFFSET(0x9CF0E50)

namespace RPG::Client
{
	inline static constexpr unsigned int AirshipBirdEmitter_TypeDefinitionIndex = 55170;
	...
	public:
		...
		{
			return ((::Class_0_16E4307DCC419505_567*(*)(::PVOID, ::System::UInt32, ::System::String*))((::PBYTE)hIl2Cpp + RPG_CLIENT_AIRSHIPBIRDEMITTER_CREATEMANAGER_OFFSET))(this, a1, a2);
		}
