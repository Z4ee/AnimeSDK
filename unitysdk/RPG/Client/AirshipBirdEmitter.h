...
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_AWAKE_OFFSET UNITYSDK_OFFSET(0x9093A80)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_CREATEMANAGER_OFFSET UNITYSDK_OFFSET(0x9092EB0)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9093620)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_GET_CURRENTEMITINTERVAL_OFFSET UNITYSDK_OFFSET(0x9093D10)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_GET_CURRENTMAXALIVECOUNT_OFFSET UNITYSDK_OFFSET(0x9093CF0)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_GET_WAITEMITTIMER_OFFSET UNITYSDK_OFFSET(0x9092F60)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_ISREADYTOEMIT_OFFSET UNITYSDK_OFFSET(0x9092FB0)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_METHOD_5_22C04E98AEE4E2EB_OFFSET UNITYSDK_OFFSET(0x9093880)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_METHOD_5_886F54B83F44F5F0_OFFSET UNITYSDK_OFFSET(0x9093350)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_METHOD_5_C51A83DB17CCB044_OFFSET UNITYSDK_OFFSET(0x90933A0)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_METHOD_5_D4885672DDCDDB39_OFFSET UNITYSDK_OFFSET(0x9093580)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_METHOD_5_FCB175EE4400634C_OFFSET UNITYSDK_OFFSET(0x9093670)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_READYTOEMIT_OFFSET UNITYSDK_OFFSET(0x9093020)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_RESETTIMER_OFFSET UNITYSDK_OFFSET(0x90932A0)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_RESET_OFFSET UNITYSDK_OFFSET(0x9093BD0)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_SET_CURRENTEMITINTERVAL_OFFSET UNITYSDK_OFFSET(0x9093D20)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_SET_CURRENTMAXALIVECOUNT_OFFSET UNITYSDK_OFFSET(0x9093D00)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_TICK_OFFSET UNITYSDK_OFFSET(0x9093820)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_TRYDESTROY_OFFSET UNITYSDK_OFFSET(0x90934B0)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_TRYEMIT_OFFSET UNITYSDK_OFFSET(0x9093070)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER_UPDATELEVELINFO_OFFSET UNITYSDK_OFFSET(0x9093AE0)
#define RPG_CLIENT_AIRSHIPBIRDEMITTER__CTOR_OFFSET UNITYSDK_OFFSET(0x9093D30)

namespace RPG::Client
{
	inline static constexpr unsigned int AirshipBirdEmitter_TypeDefinitionIndex = 48422;
	...
	public:
		...
		::System::Collections::Generic::List_1<::Class_1_FD711FBD7923B1D0*>* Field_5_9; // 0x58
		...
		{
			return ((::Class_0_16E4307DCC419505_488*(*)(::PVOID, ::System::UInt32, ::System::String*))((::PBYTE)hIl2Cpp + RPG_CLIENT_AIRSHIPBIRDEMITTER_CREATEMANAGER_OFFSET))(this, a1, a2);
		}
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_AIRSHIPBIRDEMITTER_METHOD_5_FCB175EE4400634C_OFFSET))(this);
		}

		::System::Void Method_5_D4885672DDCDDB39(::RPG::Client::AirshipBird* a1)
		{
			return ((::System::Void(*)(::PVOID, ::RPG::Client::AirshipBird*))((::PBYTE)hIl2Cpp + RPG_CLIENT_AIRSHIPBIRDEMITTER_METHOD_5_D4885672DDCDDB39_OFFSET))(this, a1);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32))((::PBYTE)hIl2Cpp + RPG_CLIENT_AIRSHIPBIRDEMITTER_SET_CURRENTMAXALIVECOUNT_OFFSET))(this, value);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + RPG_CLIENT_AIRSHIPBIRDEMITTER_SET_CURRENTEMITINTERVAL_OFFSET))(this, value);
		}
