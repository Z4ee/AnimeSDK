...
#define RPG_CLIENT_CHALLENGESTORYACTIVITYDATA_ISNEW_OFFSET UNITYSDK_OFFSET(0x92F5F10)
#define RPG_CLIENT_CHALLENGESTORYACTIVITYDATA_ISSHOWNORMALREDDOT_OFFSET UNITYSDK_OFFSET(0x92F5B60)
#define RPG_CLIENT_CHALLENGESTORYACTIVITYDATA_SYNCSCHEDULE_OFFSET UNITYSDK_OFFSET(0x92F56D0)
#define RPG_CLIENT_CHALLENGESTORYACTIVITYDATA_UPDATEREDDOTSTATUS_OFFSET UNITYSDK_OFFSET(0x92F6080)
#define RPG_CLIENT_CHALLENGESTORYACTIVITYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x92F5600)
#define RPG_CLIENT_CHALLENGESTORYACTIVITYDATA__ONSCHEDULEENDS_OFFSET UNITYSDK_OFFSET(0x92F6170)
#define RPG_CLIENT_CHALLENGESTORYACTIVITYDATA___IFIXBASEPROXY_ISNEW_OFFSET UNITYSDK_OFFSET(0x92F62B0)
#define RPG_CLIENT_CHALLENGESTORYACTIVITYDATA___IFIXBASEPROXY_ISSHOWNORMALREDDOT_OFFSET UNITYSDK_OFFSET(0x92F6240)
#define RPG_CLIENT_CHALLENGESTORYACTIVITYDATA___IFIXBASEPROXY_SYNCSCHEDULE_OFFSET UNITYSDK_OFFSET(0x92F61C0)
#define RPG_CLIENT_CHALLENGESTORYACTIVITYDATA___IFIXBASEPROXY_UPDATEREDDOTSTATUS_OFFSET UNITYSDK_OFFSET(0x92F62C0)

namespace RPG::Client
{
	inline static constexpr unsigned int ChallengeStoryActivityData_TypeDefinitionIndex = 49976;
