...
#define RPG_CLIENT_AVATARPATHCHANGEBGDELAYCONTROLLER_METHOD_5_515934F910E07F75_OFFSET UNITYSDK_OFFSET(0x9DB28D0)
#define RPG_CLIENT_AVATARPATHCHANGEBGDELAYCONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9DB2800)
#define RPG_CLIENT_AVATARPATHCHANGEBGDELAYCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x9DB2730)
#define RPG_CLIENT_AVATARPATHCHANGEBGDELAYCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x9DB2490)
#define RPG_CLIENT_AVATARPATHCHANGEBGDELAYCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9DB2DD0)

namespace RPG::Client
{
	inline static constexpr unsigned int AvatarPathChangeBgDelayController_TypeDefinitionIndex = 65747;
