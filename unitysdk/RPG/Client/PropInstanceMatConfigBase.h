...
#define RPG_CLIENT_PROPINSTANCEMATCONFIGBASE_METHOD_1_42314D937731DCE7_OFFSET UNITYSDK_OFFSET(0x17B48BB0)
#define RPG_CLIENT_PROPINSTANCEMATCONFIGBASE_METHOD_1_5620A498479AEA0C_OFFSET UNITYSDK_OFFSET(0x17B48B60)
#define RPG_CLIENT_PROPINSTANCEMATCONFIGBASE_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x17B48A10)
#define RPG_CLIENT_PROPINSTANCEMATCONFIGBASE_METHOD_1_F1E2CFDA70BD4DCE_OFFSET UNITYSDK_OFFSET(0x17B48B10)
#define RPG_CLIENT_PROPINSTANCEMATCONFIGBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x17B48C00)

namespace RPG::Client
{
	inline static constexpr unsigned int PropInstanceMatConfigBase_TypeDefinitionIndex = 70715;
