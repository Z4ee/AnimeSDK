...
#define RPG_CLIENT_PROPINSTANCEMATCONFIGBASE_METHOD_1_42314D937731DCE7_OFFSET UNITYSDK_OFFSET(0x16149650)
#define RPG_CLIENT_PROPINSTANCEMATCONFIGBASE_METHOD_1_5620A498479AEA0C_OFFSET UNITYSDK_OFFSET(0x16149600)
#define RPG_CLIENT_PROPINSTANCEMATCONFIGBASE_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x161494B0)
#define RPG_CLIENT_PROPINSTANCEMATCONFIGBASE_METHOD_1_F1E2CFDA70BD4DCE_OFFSET UNITYSDK_OFFSET(0x161495B0)
#define RPG_CLIENT_PROPINSTANCEMATCONFIGBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x161496A0)

namespace RPG::Client
{
	inline static constexpr unsigned int PropInstanceMatConfigBase_TypeDefinitionIndex = 67592;
