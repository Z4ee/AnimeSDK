...
#define RPG_CLIENT_GIFTSROLEACTIVITYDATA_ISALLREWARDTAKEN_OFFSET UNITYSDK_OFFSET(0x1AD9A120)
#define RPG_CLIENT_GIFTSROLEACTIVITYDATA_ISSHOWBTNGOTOEVERYDAYREDDOT_OFFSET UNITYSDK_OFFSET(0x1AD9A090)
#define RPG_CLIENT_GIFTSROLEACTIVITYDATA_ISSHOWNORMALREDDOT_OFFSET UNITYSDK_OFFSET(0x1AD99FD0)
#define RPG_CLIENT_GIFTSROLEACTIVITYDATA_UPDATEFULLCOMPLETESTATUS_OFFSET UNITYSDK_OFFSET(0x1AD99F10)
#define RPG_CLIENT_GIFTSROLEACTIVITYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD99EB0)
#define RPG_CLIENT_GIFTSROLEACTIVITYDATA__ONACTIVITYENDEDCUSTOM_OFFSET UNITYSDK_OFFSET(0x1AD99EC0)
