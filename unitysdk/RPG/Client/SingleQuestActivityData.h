...
#define RPG_CLIENT_SINGLEQUESTACTIVITYDATA_GETQUESTLIST_OFFSET UNITYSDK_OFFSET(0x188FDEC0)
#define RPG_CLIENT_SINGLEQUESTACTIVITYDATA_GET_AVATARID_OFFSET UNITYSDK_OFFSET(0x188FE160)
#define RPG_CLIENT_SINGLEQUESTACTIVITYDATA_GET_GOTOID_OFFSET UNITYSDK_OFFSET(0x188FE1C0)
#define RPG_CLIENT_SINGLEQUESTACTIVITYDATA_GET_QUESTLIST_OFFSET UNITYSDK_OFFSET(0x188FDC20)
#define RPG_CLIENT_SINGLEQUESTACTIVITYDATA_ISSHOWNORMALREDDOT_OFFSET UNITYSDK_OFFSET(0x188FD9F0)
#define RPG_CLIENT_SINGLEQUESTACTIVITYDATA_UPDATEFULLCOMPLETESTATUS_OFFSET UNITYSDK_OFFSET(0x188FDCA0)
#define RPG_CLIENT_SINGLEQUESTACTIVITYDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x188FE220)
#define RPG_CLIENT_SINGLEQUESTACTIVITYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x188FD970)
#define RPG_CLIENT_SINGLEQUESTACTIVITYDATA__ONINIT_OFFSET UNITYSDK_OFFSET(0x188FD980)

namespace RPG::Client
{
	inline static constexpr unsigned int SingleQuestActivityData_TypeDefinitionIndex = 58919;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(SingleQuestActivityData_TypeDefinitionIndex)->GetStaticField(0x34BB0);
		}
