...
#define RPG_CLIENT_RESIDENTCLOCKPARKACTIVITYDATA_ISSHOWMAPPINGINFONEWCONTENTREDDOT_OFFSET UNITYSDK_OFFSET(0x17983DB0)
#define RPG_CLIENT_RESIDENTCLOCKPARKACTIVITYDATA_ISSHOWMAPPINGINFOREWARDREDDOT_OFFSET UNITYSDK_OFFSET(0x17983D50)
#define RPG_CLIENT_RESIDENTCLOCKPARKACTIVITYDATA_ISSHOWNORMALREDDOT_OFFSET UNITYSDK_OFFSET(0x17983BD0)
#define RPG_CLIENT_RESIDENTCLOCKPARKACTIVITYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17983B60)
#define RPG_CLIENT_RESIDENTCLOCKPARKACTIVITYDATA__HASREWARDTOTAKE_OFFSET UNITYSDK_OFFSET(0x17983C50)
