...
#define RPG_CLIENT_EFFECT_TRANSFORM_AWAKE_OFFSET UNITYSDK_OFFSET(0x15EA11A0)
#define RPG_CLIENT_EFFECT_TRANSFORM_DESPAWNED_OFFSET UNITYSDK_OFFSET(0x15EA1360)
#define RPG_CLIENT_EFFECT_TRANSFORM_FORCEINITAXIS_OFFSET UNITYSDK_OFFSET(0x15EA1CD0)
#define RPG_CLIENT_EFFECT_TRANSFORM_INITIAL_OFFSET UNITYSDK_OFFSET(0x15EA1260)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_0A0A8830B02C5A4B_OFFSET UNITYSDK_OFFSET(0x15EA29B0)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_148427E1422FAA45_OFFSET UNITYSDK_OFFSET(0x15EA3580)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_1DDD10252C795DC3_OFFSET UNITYSDK_OFFSET(0x15EA2350)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_3F9269A3073770D4_OFFSET UNITYSDK_OFFSET(0x15EA13C0)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0x15EA2670)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x15EA19D0)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_54757B8B62FBF467_OFFSET UNITYSDK_OFFSET(0x15EA32A0)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_7744894CEC41BF06_OFFSET UNITYSDK_OFFSET(0x15EA1FA0)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0x15EA2440)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x15EA35D0)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0x15EA2740)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_C12F95298348D268_OFFSET UNITYSDK_OFFSET(0x15EA27A0)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_C561FF611C07A44C_OFFSET UNITYSDK_OFFSET(0x15EA2FA0)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x15EA1F90)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_F5447CD65612575D_OFFSET UNITYSDK_OFFSET(0x15EA23D0)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_F765D40FE0DB4953_OFFSET UNITYSDK_OFFSET(0x15EA2050)
#define RPG_CLIENT_EFFECT_TRANSFORM_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x15EA3670)
#define RPG_CLIENT_EFFECT_TRANSFORM_ONENABLE_OFFSET UNITYSDK_OFFSET(0x15EA1AB0)
#define RPG_CLIENT_EFFECT_TRANSFORM_PAUSE_OFFSET UNITYSDK_OFFSET(0x15EA1D20)
#define RPG_CLIENT_EFFECT_TRANSFORM_SETCURRENTPOS_OFFSET UNITYSDK_OFFSET(0x15EA1BE0)
#define RPG_CLIENT_EFFECT_TRANSFORM_SETINITIALPOS_OFFSET UNITYSDK_OFFSET(0x15EA1B40)
#define RPG_CLIENT_EFFECT_TRANSFORM_SPAWNED_OFFSET UNITYSDK_OFFSET(0x15EA1300)
#define RPG_CLIENT_EFFECT_TRANSFORM_TICK_OFFSET UNITYSDK_OFFSET(0x15EA1D90)
#define RPG_CLIENT_EFFECT_TRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x15EA3700)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_Transform_TypeDefinitionIndex = 70531;

	class Effect_Transform : public ::UnityEngine::MonoBehaviour
	{
	public:
		::System::Boolean OEFNIBPMDAF; // 0x18
		...
		::UnityEngine::Vector3 OCDLNFEHCAM; // 0x70
		::UnityEngine::Vector3 EJLDDMOKPCL; // 0x7C
		::UnityEngine::Vector3 PMDKAFPJNHG; // 0x88
		::UnityEngine::Quaternion DGKFHBAPOLL; // 0x94
		::UnityEngine::Vector3 CJNDPFBCFHP; // 0xA4
		::System::Single OIIKPCBOEHA; // 0xB0
		::System::Single NPINECOCALC; // 0xB4
		::System::Single PJJLEJDPNHI; // 0xB8
		::System::Boolean IDBEBIDMHME; // 0xBC
		::UnityEngine::Vector3 MOLOKMBIAFJ; // 0xC0
		::UnityEngine::Vector3 ONAGAJOCAIF; // 0xCC
		::UnityEngine::Transform* ANKENPDODEG; // 0xD8
		::UnityEngine::Transform* DALOJFHOFGN; // 0xE0
		::System::Boolean JDMPNIFOCGF; // 0xE8
		::UnityEngine::Quaternion OCBCNANLBDC; // 0xEC
		::System::Int32 JFHCMNAEEBA; // 0xFC
		::RPG::GameCore::GameEntity* KCKEHDGBGGG; // 0x100
		...
		::System::Void Method_5_F765D40FE0DB4953()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_F765D40FE0DB4953_OFFSET))(this);
		}
