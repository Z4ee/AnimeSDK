...
#define RPG_CLIENT_EFFECT_TRANSFORM_AWAKE_OFFSET UNITYSDK_OFFSET(0xA20C500)
#define RPG_CLIENT_EFFECT_TRANSFORM_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xA20C660)
#define RPG_CLIENT_EFFECT_TRANSFORM_FORCEINITAXIS_OFFSET UNITYSDK_OFFSET(0xA20CFD0)
#define RPG_CLIENT_EFFECT_TRANSFORM_INITIAL_OFFSET UNITYSDK_OFFSET(0xA20C5A0)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_0A0A8830B02C5A4B_OFFSET UNITYSDK_OFFSET(0xA20DC80)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_148427E1422FAA45_OFFSET UNITYSDK_OFFSET(0xA20E840)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_1DDD10252C795DC3_OFFSET UNITYSDK_OFFSET(0xA20D620)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_3F9269A3073770D4_OFFSET UNITYSDK_OFFSET(0xA20C6B0)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0xA20D940)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xA20CCD0)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_54757B8B62FBF467_OFFSET UNITYSDK_OFFSET(0xA20E560)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_7744894CEC41BF06_OFFSET UNITYSDK_OFFSET(0xA20D2B0)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0xA20D710)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xA20E890)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0xA20DA10)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_ADEAE12D8AEE479C_OFFSET UNITYSDK_OFFSET(0xA20D360)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_C12F95298348D268_OFFSET UNITYSDK_OFFSET(0xA20DA70)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_C561FF611C07A44C_OFFSET UNITYSDK_OFFSET(0xA20E260)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xA20D2A0)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_F5447CD65612575D_OFFSET UNITYSDK_OFFSET(0xA20D6A0)
#define RPG_CLIENT_EFFECT_TRANSFORM_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xA20E930)
#define RPG_CLIENT_EFFECT_TRANSFORM_ONENABLE_OFFSET UNITYSDK_OFFSET(0xA20CDB0)
#define RPG_CLIENT_EFFECT_TRANSFORM_PAUSE_OFFSET UNITYSDK_OFFSET(0xA20D020)
#define RPG_CLIENT_EFFECT_TRANSFORM_SETCURRENTPOS_OFFSET UNITYSDK_OFFSET(0xA20CEE0)
#define RPG_CLIENT_EFFECT_TRANSFORM_SETINITIALPOS_OFFSET UNITYSDK_OFFSET(0xA20CE40)
#define RPG_CLIENT_EFFECT_TRANSFORM_SPAWNED_OFFSET UNITYSDK_OFFSET(0xA20C620)
#define RPG_CLIENT_EFFECT_TRANSFORM_TICK_OFFSET UNITYSDK_OFFSET(0xA20D090)
#define RPG_CLIENT_EFFECT_TRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0xA20E9C0)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_Transform_TypeDefinitionIndex = 65058;
	...
	public:
		...
		::System::Void Method_5_ADEAE12D8AEE479C()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_ADEAE12D8AEE479C_OFFSET))(this);
		}
