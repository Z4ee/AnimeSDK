...
#define RPG_CLIENT_EFFECT_TRANSFORM_AWAKE_OFFSET UNITYSDK_OFFSET(0xCE20100)
#define RPG_CLIENT_EFFECT_TRANSFORM_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xCE202C0)
#define RPG_CLIENT_EFFECT_TRANSFORM_FORCEINITAXIS_OFFSET UNITYSDK_OFFSET(0xCE20C30)
#define RPG_CLIENT_EFFECT_TRANSFORM_INITIAL_OFFSET UNITYSDK_OFFSET(0xCE201C0)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_0A0A8830B02C5A4B_OFFSET UNITYSDK_OFFSET(0xCE21910)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_148427E1422FAA45_OFFSET UNITYSDK_OFFSET(0xCE224E0)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_1DDD10252C795DC3_OFFSET UNITYSDK_OFFSET(0xCE212B0)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_3F9269A3073770D4_OFFSET UNITYSDK_OFFSET(0xCE20320)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0xCE215D0)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xCE20930)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_54757B8B62FBF467_OFFSET UNITYSDK_OFFSET(0xCE22200)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_7744894CEC41BF06_OFFSET UNITYSDK_OFFSET(0xCE20F00)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0xCE213A0)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xCE22530)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0xCE216A0)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_C12F95298348D268_OFFSET UNITYSDK_OFFSET(0xCE21700)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_C561FF611C07A44C_OFFSET UNITYSDK_OFFSET(0xCE21F00)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xCE20EF0)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_F5447CD65612575D_OFFSET UNITYSDK_OFFSET(0xCE21330)
#define RPG_CLIENT_EFFECT_TRANSFORM_METHOD_5_F765D40FE0DB4953_OFFSET UNITYSDK_OFFSET(0xCE20FB0)
#define RPG_CLIENT_EFFECT_TRANSFORM_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xCE225D0)
#define RPG_CLIENT_EFFECT_TRANSFORM_ONENABLE_OFFSET UNITYSDK_OFFSET(0xCE20A10)
#define RPG_CLIENT_EFFECT_TRANSFORM_PAUSE_OFFSET UNITYSDK_OFFSET(0xCE20C80)
#define RPG_CLIENT_EFFECT_TRANSFORM_SETCURRENTPOS_OFFSET UNITYSDK_OFFSET(0xCE20B40)
#define RPG_CLIENT_EFFECT_TRANSFORM_SETINITIALPOS_OFFSET UNITYSDK_OFFSET(0xCE20AA0)
#define RPG_CLIENT_EFFECT_TRANSFORM_SPAWNED_OFFSET UNITYSDK_OFFSET(0xCE20260)
#define RPG_CLIENT_EFFECT_TRANSFORM_TICK_OFFSET UNITYSDK_OFFSET(0xCE20CF0)
#define RPG_CLIENT_EFFECT_TRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0xCE22660)
