...
#define RPG_CLIENT_MATCHTHREEENEMYSWITCHTIPEFFECT_DESPAWNED_OFFSET UNITYSDK_OFFSET(0x1A8987B0)
#define RPG_CLIENT_MATCHTHREEENEMYSWITCHTIPEFFECT_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x1A898730)
#define RPG_CLIENT_MATCHTHREEENEMYSWITCHTIPEFFECT_METHOD_5_C1062F26C50C07EE_OFFSET UNITYSDK_OFFSET(0x1A8987F0)
#define RPG_CLIENT_MATCHTHREEENEMYSWITCHTIPEFFECT_ONCREATE_OFFSET UNITYSDK_OFFSET(0x1A8988B0)
#define RPG_CLIENT_MATCHTHREEENEMYSWITCHTIPEFFECT_PLAY_OFFSET UNITYSDK_OFFSET(0x1A88EC80)
#define RPG_CLIENT_MATCHTHREEENEMYSWITCHTIPEFFECT_SETPOSITION_OFFSET UNITYSDK_OFFSET(0x1A88EB60)
#define RPG_CLIENT_MATCHTHREEENEMYSWITCHTIPEFFECT_SPAWNED_OFFSET UNITYSDK_OFFSET(0x1A898690)
#define RPG_CLIENT_MATCHTHREEENEMYSWITCHTIPEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A898A20)

namespace RPG::Client
{
	inline static constexpr unsigned int MatchThreeEnemySwitchTipEffect_TypeDefinitionIndex = 62991;
