...
#define RPG_CLIENT_MATCHTHREEENEMYSWITCHTIPEFFECT_DESPAWNED_OFFSET UNITYSDK_OFFSET(0x9B34A40)
#define RPG_CLIENT_MATCHTHREEENEMYSWITCHTIPEFFECT_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x9B349C0)
#define RPG_CLIENT_MATCHTHREEENEMYSWITCHTIPEFFECT_METHOD_5_C1062F26C50C07EE_OFFSET UNITYSDK_OFFSET(0x9B34A80)
#define RPG_CLIENT_MATCHTHREEENEMYSWITCHTIPEFFECT_ONCREATE_OFFSET UNITYSDK_OFFSET(0x9B34B40)
#define RPG_CLIENT_MATCHTHREEENEMYSWITCHTIPEFFECT_PLAY_OFFSET UNITYSDK_OFFSET(0x9B2A750)
#define RPG_CLIENT_MATCHTHREEENEMYSWITCHTIPEFFECT_SETPOSITION_OFFSET UNITYSDK_OFFSET(0x9B2A630)
#define RPG_CLIENT_MATCHTHREEENEMYSWITCHTIPEFFECT_SPAWNED_OFFSET UNITYSDK_OFFSET(0x9B34920)
#define RPG_CLIENT_MATCHTHREEENEMYSWITCHTIPEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x9B34CB0)

namespace RPG::Client
{
	inline static constexpr unsigned int MatchThreeEnemySwitchTipEffect_TypeDefinitionIndex = 53551;
