...
#define RPG_CLIENT_MONOEFFECTPLUGINREPLACEMATERIAL_DISPOSEPLUGIN_OFFSET UNITYSDK_OFFSET(0xA99D600)
#define RPG_CLIENT_MONOEFFECTPLUGINREPLACEMATERIAL_IGNOREINEDITOR_OFFSET UNITYSDK_OFFSET(0xA99D540)
#define RPG_CLIENT_MONOEFFECTPLUGINREPLACEMATERIAL_METHOD_6_334241B7253414E6_OFFSET UNITYSDK_OFFSET(0xA99D660)
#define RPG_CLIENT_MONOEFFECTPLUGINREPLACEMATERIAL_METHOD_6_749948B663FCCCEF_OFFSET UNITYSDK_OFFSET(0xA99DC80)
#define RPG_CLIENT_MONOEFFECTPLUGINREPLACEMATERIAL_RESETPLUGIN_OFFSET UNITYSDK_OFFSET(0xA99D580)
#define RPG_CLIENT_MONOEFFECTPLUGINREPLACEMATERIAL_TICK_OFFSET UNITYSDK_OFFSET(0xA99D770)
#define RPG_CLIENT_MONOEFFECTPLUGINREPLACEMATERIAL__CTOR_OFFSET UNITYSDK_OFFSET(0xA99DFB0)
#define RPG_CLIENT_MONOEFFECTPLUGINREPLACEMATERIAL___IFIXBASEPROXY_IGNOREINEDITOR_OFFSET UNITYSDK_OFFSET(0xA99DFC0)
#define RPG_CLIENT_MONOEFFECTPLUGINREPLACEMATERIAL___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0xA99E030)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginReplaceMaterial_TypeDefinitionIndex = 64628;
