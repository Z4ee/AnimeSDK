...
#define RPG_CLIENT_MONOEFFECTPLUGINREPLACEMATERIAL_DISPOSEPLUGIN_OFFSET UNITYSDK_OFFSET(0x1B392F30)
#define RPG_CLIENT_MONOEFFECTPLUGINREPLACEMATERIAL_IGNOREINEDITOR_OFFSET UNITYSDK_OFFSET(0x1B392E70)
#define RPG_CLIENT_MONOEFFECTPLUGINREPLACEMATERIAL_METHOD_6_17BD30EFE8176014_OFFSET UNITYSDK_OFFSET(0x1B3935B0)
#define RPG_CLIENT_MONOEFFECTPLUGINREPLACEMATERIAL_METHOD_6_F77BBFBC56288301_OFFSET UNITYSDK_OFFSET(0x1B392F90)
#define RPG_CLIENT_MONOEFFECTPLUGINREPLACEMATERIAL_RESETPLUGIN_OFFSET UNITYSDK_OFFSET(0x1B392EB0)
#define RPG_CLIENT_MONOEFFECTPLUGINREPLACEMATERIAL_TICK_OFFSET UNITYSDK_OFFSET(0x1B3930C0)
#define RPG_CLIENT_MONOEFFECTPLUGINREPLACEMATERIAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3938B0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginReplaceMaterial_TypeDefinitionIndex = 70069;
	...
	public:
		...
		::System::Boolean GPJODGBCCBE; // 0x38
		::Il2CppArray<::UnityEngine::Renderer*>* MOECGMPCECP; // 0x40
		::System::Collections::Generic::List_1<::UnityEngine::Material*>* HMBAAFHNFDH; // 0x48
		::System::Boolean IOBIICPBOIH; // 0x50
