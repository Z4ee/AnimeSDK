...
#define RPG_CLIENT_QINGQUEBATTLEENERGYBARNOTIFY__CTOR_OFFSET UNITYSDK_OFFSET(0xC672450)

namespace RPG::Client
{
	inline static constexpr unsigned int QingQueBattleEnergyBarNotify_TypeDefinitionIndex = 67128;
