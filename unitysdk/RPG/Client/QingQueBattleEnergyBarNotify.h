...
#define RPG_CLIENT_QINGQUEBATTLEENERGYBARNOTIFY__CTOR_OFFSET UNITYSDK_OFFSET(0x1677CAD0)

namespace RPG::Client
{
	inline static constexpr unsigned int QingQueBattleEnergyBarNotify_TypeDefinitionIndex = 68572;
