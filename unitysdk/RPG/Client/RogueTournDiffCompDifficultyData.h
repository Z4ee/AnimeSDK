...
#define RPG_CLIENT_ROGUETOURNDIFFCOMPDIFFICULTYDATA_COMPARETO_OFFSET UNITYSDK_OFFSET(0xC80FB50)
#define RPG_CLIENT_ROGUETOURNDIFFCOMPDIFFICULTYDATA_CREATEDATA_OFFSET UNITYSDK_OFFSET(0xC8088A0)
#define RPG_CLIENT_ROGUETOURNDIFFCOMPDIFFICULTYDATA_GET_DIFFCOMPS_OFFSET UNITYSDK_OFFSET(0xC80FEB0)
#define RPG_CLIENT_ROGUETOURNDIFFCOMPDIFFICULTYDATA_GET_DIFFICULTY_OFFSET UNITYSDK_OFFSET(0xC80FEA0)
#define RPG_CLIENT_ROGUETOURNDIFFCOMPDIFFICULTYDATA_GET_HASSUBLEVEL_OFFSET UNITYSDK_OFFSET(0xC80FF80)
#define RPG_CLIENT_ROGUETOURNDIFFCOMPDIFFICULTYDATA_GET_ISHARD_OFFSET UNITYSDK_OFFSET(0xC80FEC0)
#define RPG_CLIENT_ROGUETOURNDIFFCOMPDIFFICULTYDATA_GET_ROMANNUMBER_OFFSET UNITYSDK_OFFSET(0xC80FED0)
#define RPG_CLIENT_ROGUETOURNDIFFCOMPDIFFICULTYDATA_GET_SUBLEVELNUMBER_OFFSET UNITYSDK_OFFSET(0xC80FF90)
#define RPG_CLIENT_ROGUETOURNDIFFCOMPDIFFICULTYDATA_TOSTRING_OFFSET UNITYSDK_OFFSET(0xC80FBE0)
#define RPG_CLIENT_ROGUETOURNDIFFCOMPDIFFICULTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC80FB00)
#define RPG_CLIENT_ROGUETOURNDIFFCOMPDIFFICULTYDATA___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0xC80FFE0)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueTournDiffCompDifficultyData_TypeDefinitionIndex = 63215;
