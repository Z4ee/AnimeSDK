...
#define RPG_CLIENT_DRINKMAKERCHEERSGROUPDATA_GET_AVATARNAME_OFFSET UNITYSDK_OFFSET(0x1A67DD90)
#define RPG_CLIENT_DRINKMAKERCHEERSGROUPDATA_GET_AVATARREQUESTHEADICONPATH_OFFSET UNITYSDK_OFFSET(0x1A67DCD0)
#define RPG_CLIENT_DRINKMAKERCHEERSGROUPDATA_GET_DAYSTARTTOASTDESC_OFFSET UNITYSDK_OFFSET(0x1A67DC60)
#define RPG_CLIENT_DRINKMAKERCHEERSGROUPDATA_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x1A673240)
#define RPG_CLIENT_DRINKMAKERCHEERSGROUPDATA_GET_GUESTHEADICON_OFFSET UNITYSDK_OFFSET(0x1A67DE50)
#define RPG_CLIENT_DRINKMAKERCHEERSGROUPDATA_GET_INTRODUCEID_OFFSET UNITYSDK_OFFSET(0x1A67DE00)
#define RPG_CLIENT_DRINKMAKERCHEERSGROUPDATA_GET_ISSHOWINHANDBOOK_OFFSET UNITYSDK_OFFSET(0x1A673690)
#define RPG_CLIENT_DRINKMAKERCHEERSGROUPDATA_GET_MADEDRINKCOUNT_OFFSET UNITYSDK_OFFSET(0x1A673CF0)
#define RPG_CLIENT_DRINKMAKERCHEERSGROUPDATA_GET_NEGATIVEDRINKDATA_OFFSET UNITYSDK_OFFSET(0x1A672C30)
#define RPG_CLIENT_DRINKMAKERCHEERSGROUPDATA_GET_NEXTGROUPID_OFFSET UNITYSDK_OFFSET(0x1A6731F0)
#define RPG_CLIENT_DRINKMAKERCHEERSGROUPDATA_GET_POSITIVEDRINKDATA_OFFSET UNITYSDK_OFFSET(0x1A672B30)
#define RPG_CLIENT_DRINKMAKERCHEERSGROUPDATA_GET_ROLEREQUIREMENT_OFFSET UNITYSDK_OFFSET(0x1A67DD20)
#define RPG_CLIENT_DRINKMAKERCHEERSGROUPDATA_GET_TOTALDRINKCOUNT_OFFSET UNITYSDK_OFFSET(0x1A673A40)
#define RPG_CLIENT_DRINKMAKERCHEERSGROUPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A679030)
