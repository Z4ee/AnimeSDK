...
#define RPG_CLIENT_WOLFBROGUNPLAYTARGETACTIONCONFIG_METHOD_1_7E9AC3FFDA4606D5_OFFSET UNITYSDK_OFFSET(0xB4D7750)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGETACTIONCONFIG_METHOD_1_F8B73ECE7F883AC1_OFFSET UNITYSDK_OFFSET(0xB4D77C0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGETACTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xB4D7800)

namespace RPG::Client
{
	inline static constexpr unsigned int WolfBroGunPlayTargetActionConfig_TypeDefinitionIndex = 63346;
