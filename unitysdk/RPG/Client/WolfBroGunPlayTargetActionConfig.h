...
#define RPG_CLIENT_WOLFBROGUNPLAYTARGETACTIONCONFIG_METHOD_1_7E9AC3FFDA4606D5_OFFSET UNITYSDK_OFFSET(0xCC3DA70)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGETACTIONCONFIG_METHOD_1_F8B73ECE7F883AC1_OFFSET UNITYSDK_OFFSET(0xCC3DAE0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGETACTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xCC3DB20)

namespace RPG::Client
{
	inline static constexpr unsigned int WolfBroGunPlayTargetActionConfig_TypeDefinitionIndex = 64263;
