...
#define RPG_CLIENT_BATTLELOGUPLOADCONTENT__CTOR_OFFSET UNITYSDK_OFFSET(0xB3FE730)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleLogUploadContent_TypeDefinitionIndex = 56981;
