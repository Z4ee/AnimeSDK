...
#define RPG_CLIENT_BATTLELOGUPLOADCONTENT__CTOR_OFFSET UNITYSDK_OFFSET(0x91BDFB0)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleLogUploadContent_TypeDefinitionIndex = 49422;
