...
#define RPG_CLIENT_BATTLELOGUPLOADCONTENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19F6AC20)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleLogUploadContent_TypeDefinitionIndex = 61055;
