...
#define RPG_CLIENT_BATTLELOGUPLOADCONTENT__CTOR_OFFSET UNITYSDK_OFFSET(0x9E64620)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleLogUploadContent_TypeDefinitionIndex = 56219;
