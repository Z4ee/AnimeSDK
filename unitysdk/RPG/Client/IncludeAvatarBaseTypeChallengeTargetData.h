...
#define RPG_CLIENT_INCLUDEAVATARBASETYPECHALLENGETARGETDATA_CALCULATETARGETSTATE_OFFSET UNITYSDK_OFFSET(0xD3FC4F0)
#define RPG_CLIENT_INCLUDEAVATARBASETYPECHALLENGETARGETDATA_GETNAMEPARAM_OFFSET UNITYSDK_OFFSET(0xD3FC8A0)
#define RPG_CLIENT_INCLUDEAVATARBASETYPECHALLENGETARGETDATA_SETCHALLENGETARGETSTATE_OFFSET UNITYSDK_OFFSET(0xD3FC810)
#define RPG_CLIENT_INCLUDEAVATARBASETYPECHALLENGETARGETDATA_UPDATECHALLENGETARGETSTATE_OFFSET UNITYSDK_OFFSET(0xD3FC350)
#define RPG_CLIENT_INCLUDEAVATARBASETYPECHALLENGETARGETDATA__CHECKINCLUDEBASICTYPE_OFFSET UNITYSDK_OFFSET(0xD3FC5B0)
#define RPG_CLIENT_INCLUDEAVATARBASETYPECHALLENGETARGETDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD3FC260)
#define RPG_CLIENT_INCLUDEAVATARBASETYPECHALLENGETARGETDATA__UPDATECHALLENGETARGETSTATE_B__1_0_OFFSET UNITYSDK_OFFSET(0xD3FCAA0)
