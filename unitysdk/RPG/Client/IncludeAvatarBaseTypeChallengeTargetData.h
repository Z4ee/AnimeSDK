...
#define RPG_CLIENT_INCLUDEAVATARBASETYPECHALLENGETARGETDATA_CALCULATETARGETSTATE_OFFSET UNITYSDK_OFFSET(0x9946E90)
#define RPG_CLIENT_INCLUDEAVATARBASETYPECHALLENGETARGETDATA_GETNAMEPARAM_OFFSET UNITYSDK_OFFSET(0x9947250)
#define RPG_CLIENT_INCLUDEAVATARBASETYPECHALLENGETARGETDATA_SETCHALLENGETARGETSTATE_OFFSET UNITYSDK_OFFSET(0x99471C0)
#define RPG_CLIENT_INCLUDEAVATARBASETYPECHALLENGETARGETDATA_UPDATECHALLENGETARGETSTATE_OFFSET UNITYSDK_OFFSET(0x9946CB0)
#define RPG_CLIENT_INCLUDEAVATARBASETYPECHALLENGETARGETDATA__CHECKINCLUDEBASICTYPE_OFFSET UNITYSDK_OFFSET(0x9946F50)
#define RPG_CLIENT_INCLUDEAVATARBASETYPECHALLENGETARGETDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9946C70)
#define RPG_CLIENT_INCLUDEAVATARBASETYPECHALLENGETARGETDATA__UPDATECHALLENGETARGETSTATE_B__1_0_OFFSET UNITYSDK_OFFSET(0x9947460)
#define RPG_CLIENT_INCLUDEAVATARBASETYPECHALLENGETARGETDATA___IFIXBASEPROXY_CALCULATETARGETSTATE_OFFSET UNITYSDK_OFFSET(0x99474F0)
#define RPG_CLIENT_INCLUDEAVATARBASETYPECHALLENGETARGETDATA___IFIXBASEPROXY_GETNAMEPARAM_OFFSET UNITYSDK_OFFSET(0x99475D0)
#define RPG_CLIENT_INCLUDEAVATARBASETYPECHALLENGETARGETDATA___IFIXBASEPROXY_SETCHALLENGETARGETSTATE_OFFSET UNITYSDK_OFFSET(0x9947560)
#define RPG_CLIENT_INCLUDEAVATARBASETYPECHALLENGETARGETDATA___IFIXBASEPROXY_UPDATECHALLENGETARGETSTATE_OFFSET UNITYSDK_OFFSET(0x9947480)

namespace RPG::Client
{
	inline static constexpr unsigned int IncludeAvatarBaseTypeChallengeTargetData_TypeDefinitionIndex = 51212;
