...
#define RPG_CLIENT_SIMPLETEXTMANAGERMONO_CLASS_1_7F572A2075EA0638_METHOD_1_A239DF324AF4215D_OFFSET UNITYSDK_OFFSET(0xE095E90)
#define RPG_CLIENT_SIMPLETEXTMANAGERMONO_CLASS_1_7F572A2075EA0638_METHOD_1_D09831639F615812_OFFSET UNITYSDK_OFFSET(0xE09B7A0)
#define RPG_CLIENT_SIMPLETEXTMANAGERMONO_CLASS_1_7F572A2075EA0638__CTOR_OFFSET UNITYSDK_OFFSET(0xE09E640)

namespace RPG::Client
{
	inline static constexpr unsigned int SimpleTextManagerMono_Class_1_7F572A2075EA0638_TypeDefinitionIndex = 72572;

	class SimpleTextManagerMono_Class_1_7F572A2075EA0638 : public ::System::Object
	{
	public:
		::UnityEngine::GameObject* IOHOMAPFIGH; // 0x10
		::UnityEngine::Mesh* HKHIMGIMIFI; // 0x18
		::UnityEngine::MeshRenderer* EMHJGPKACPK; // 0x20
