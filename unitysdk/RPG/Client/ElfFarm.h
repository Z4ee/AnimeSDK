...
#define RPG_CLIENT_ELFFARM_GETCELL_OFFSET UNITYSDK_OFFSET(0x1AC66DE0)
#define RPG_CLIENT_ELFFARM_GETVCAMERAGO_OFFSET UNITYSDK_OFFSET(0x1AC670B0)
#define RPG_CLIENT_ELFFARM_INIT_OFFSET UNITYSDK_OFFSET(0x1AC667C0)
#define RPG_CLIENT_ELFFARM_SETVCAMERAACTIVE_OFFSET UNITYSDK_OFFSET(0x1AC67200)
#define RPG_CLIENT_ELFFARM_UNINIT_OFFSET UNITYSDK_OFFSET(0x1AC66CD0)
#define RPG_CLIENT_ELFFARM_UPDATEFARM_OFFSET UNITYSDK_OFFSET(0x1AC66A50)
#define RPG_CLIENT_ELFFARM__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC673B0)

namespace RPG::Client
{
	inline static constexpr unsigned int ElfFarm_TypeDefinitionIndex = 68625;
