...
#define RPG_CLIENT_ELFFARM_GETCELL_OFFSET UNITYSDK_OFFSET(0x95A1400)
#define RPG_CLIENT_ELFFARM_GETVCAMERAGO_OFFSET UNITYSDK_OFFSET(0x95A1780)
#define RPG_CLIENT_ELFFARM_INIT_OFFSET UNITYSDK_OFFSET(0x95A0C60)
#define RPG_CLIENT_ELFFARM_SETVCAMERAACTIVE_OFFSET UNITYSDK_OFFSET(0x95A18D0)
#define RPG_CLIENT_ELFFARM_UNINIT_OFFSET UNITYSDK_OFFSET(0x95A12D0)
#define RPG_CLIENT_ELFFARM_UPDATEFARM_OFFSET UNITYSDK_OFFSET(0x95A0FF0)
#define RPG_CLIENT_ELFFARM__CTOR_OFFSET UNITYSDK_OFFSET(0x95A1A80)

namespace RPG::Client
{
	inline static constexpr unsigned int ElfFarm_TypeDefinitionIndex = 56078;
