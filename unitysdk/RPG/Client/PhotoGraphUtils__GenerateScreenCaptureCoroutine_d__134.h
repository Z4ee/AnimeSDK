...
#define RPG_CLIENT_PHOTOGRAPHUTILS__GENERATESCREENCAPTURECOROUTINE_D__134_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19EB2E10)
#define RPG_CLIENT_PHOTOGRAPHUTILS__GENERATESCREENCAPTURECOROUTINE_D__134_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19EB3300)
#define RPG_CLIENT_PHOTOGRAPHUTILS__GENERATESCREENCAPTURECOROUTINE_D__134_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19EB3360)
#define RPG_CLIENT_PHOTOGRAPHUTILS__GENERATESCREENCAPTURECOROUTINE_D__134_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19EB3310)
#define RPG_CLIENT_PHOTOGRAPHUTILS__GENERATESCREENCAPTURECOROUTINE_D__134_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19EB2E00)
#define RPG_CLIENT_PHOTOGRAPHUTILS__GENERATESCREENCAPTURECOROUTINE_D__134__CTOR_OFFSET UNITYSDK_OFFSET(0x19EB0B70)

namespace RPG::Client
{
	inline static constexpr unsigned int PhotoGraphUtils__GenerateScreenCaptureCoroutine_d__134_TypeDefinitionIndex = 66346;

	class PhotoGraphUtils__GenerateScreenCaptureCoroutine_d__134 : public ::System::Object
	{
	public:
		::RPG::Client::PhotoGraphUtils___c__DisplayClass134_0* __8__1; // 0x10
