...
#define RPG_CLIENT_DEVUIDEBUGREPORTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA0F9990)

namespace RPG::Client
{
	inline static constexpr unsigned int DevUIDebugReportData_TypeDefinitionIndex = 63012;
