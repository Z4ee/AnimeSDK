...
#define RPG_CLIENT_DEVUIDEBUGREPORTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18094D70)

namespace RPG::Client
{
	inline static constexpr unsigned int DevUIDebugReportData_TypeDefinitionIndex = 65298;
