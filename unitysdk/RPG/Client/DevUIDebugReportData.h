...
#define RPG_CLIENT_DEVUIDEBUGREPORTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB73AC90)

namespace RPG::Client
{
	inline static constexpr unsigned int DevUIDebugReportData_TypeDefinitionIndex = 63927;
