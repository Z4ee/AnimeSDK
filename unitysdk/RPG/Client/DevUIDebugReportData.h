...
#define RPG_CLIENT_DEVUIDEBUGREPORTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x944B7C0)

namespace RPG::Client
{
	inline static constexpr unsigned int DevUIDebugReportData_TypeDefinitionIndex = 55780;
