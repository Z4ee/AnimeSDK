...
#define RPG_CLIENT_SKYBOXFLOORROTATIONADAPTER_AWAKE_OFFSET UNITYSDK_OFFSET(0xC8E7020)
#define RPG_CLIENT_SKYBOXFLOORROTATIONADAPTER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xC8E70C0)
#define RPG_CLIENT_SKYBOXFLOORROTATIONADAPTER__CTOR_OFFSET UNITYSDK_OFFSET(0xC8E7240)

namespace RPG::Client
{
	inline static constexpr unsigned int SkyboxFloorRotationAdapter_TypeDefinitionIndex = 68183;
