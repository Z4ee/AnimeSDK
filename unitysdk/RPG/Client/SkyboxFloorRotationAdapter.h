...
#define RPG_CLIENT_SKYBOXFLOORROTATIONADAPTER_AWAKE_OFFSET UNITYSDK_OFFSET(0xB1920F0)
#define RPG_CLIENT_SKYBOXFLOORROTATIONADAPTER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xB192190)
#define RPG_CLIENT_SKYBOXFLOORROTATIONADAPTER__CTOR_OFFSET UNITYSDK_OFFSET(0xB192310)

namespace RPG::Client
{
	inline static constexpr unsigned int SkyboxFloorRotationAdapter_TypeDefinitionIndex = 67231;
