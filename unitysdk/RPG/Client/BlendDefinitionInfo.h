...
#define RPG_CLIENT_BLENDDEFINITIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x91F3B30)

namespace RPG::Client
{
	inline static constexpr unsigned int BlendDefinitionInfo_TypeDefinitionIndex = 56829;
