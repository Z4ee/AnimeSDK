...
#define RPG_CLIENT_BLENDDEFINITIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x9E9CC40)

namespace RPG::Client
{
	inline static constexpr unsigned int BlendDefinitionInfo_TypeDefinitionIndex = 64075;
