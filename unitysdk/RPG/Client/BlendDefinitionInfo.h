...
#define RPG_CLIENT_BLENDDEFINITIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xB438CB0)

namespace RPG::Client
{
	inline static constexpr unsigned int BlendDefinitionInfo_TypeDefinitionIndex = 64996;
