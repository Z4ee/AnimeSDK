...
#define RPG_CLIENT_BLENDDEFINITIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19FE1280)

namespace RPG::Client
{
	inline static constexpr unsigned int BlendDefinitionInfo_TypeDefinitionIndex = 66401;
