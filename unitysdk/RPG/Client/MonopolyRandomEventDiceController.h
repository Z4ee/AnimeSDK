...
#define RPG_CLIENT_MONOPOLYRANDOMEVENTDICECONTROLLER_CLEAREVENT_OFFSET UNITYSDK_OFFSET(0x9D76AA0)
#define RPG_CLIENT_MONOPOLYRANDOMEVENTDICECONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0x9D76990)
#define RPG_CLIENT_MONOPOLYRANDOMEVENTDICECONTROLLER_STARTROTATE_OFFSET UNITYSDK_OFFSET(0x9D76B00)
#define RPG_CLIENT_MONOPOLYRANDOMEVENTDICECONTROLLER_START_OFFSET UNITYSDK_OFFSET(0x9D768F0)
#define RPG_CLIENT_MONOPOLYRANDOMEVENTDICECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9D76D40)
#define RPG_CLIENT_MONOPOLYRANDOMEVENTDICECONTROLLER__ONROTATEFINISH_OFFSET UNITYSDK_OFFSET(0x9D76CF0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonopolyRandomEventDiceController_TypeDefinitionIndex = 59709;
