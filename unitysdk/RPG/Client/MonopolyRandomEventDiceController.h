...
#define RPG_CLIENT_MONOPOLYRANDOMEVENTDICECONTROLLER_CLEAREVENT_OFFSET UNITYSDK_OFFSET(0x1954A4B0)
#define RPG_CLIENT_MONOPOLYRANDOMEVENTDICECONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0x1954A380)
#define RPG_CLIENT_MONOPOLYRANDOMEVENTDICECONTROLLER_STARTROTATE_OFFSET UNITYSDK_OFFSET(0x1954A510)
#define RPG_CLIENT_MONOPOLYRANDOMEVENTDICECONTROLLER_START_OFFSET UNITYSDK_OFFSET(0x1954A290)
#define RPG_CLIENT_MONOPOLYRANDOMEVENTDICECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1954A7C0)
#define RPG_CLIENT_MONOPOLYRANDOMEVENTDICECONTROLLER__ONROTATEFINISH_OFFSET UNITYSDK_OFFSET(0x1954A760)

namespace RPG::Client
{
	inline static constexpr unsigned int MonopolyRandomEventDiceController_TypeDefinitionIndex = 69534;
