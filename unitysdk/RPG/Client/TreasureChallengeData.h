...
#define RPG_CLIENT_TREASURECHALLENGEDATA_GETCHALLENGESTATUS_OFFSET UNITYSDK_OFFSET(0xB37E2B0)
#define RPG_CLIENT_TREASURECHALLENGEDATA_GETISSAVE_OFFSET UNITYSDK_OFFSET(0xB37E340)
#define RPG_CLIENT_TREASURECHALLENGEDATA_GETRAIDID_OFFSET UNITYSDK_OFFSET(0xB37E230)
#define RPG_CLIENT_TREASURECHALLENGEDATA_GETWORLDLV_OFFSET UNITYSDK_OFFSET(0xB37E270)
#define RPG_CLIENT_TREASURECHALLENGEDATA_SETCHALLENGESTATUS_OFFSET UNITYSDK_OFFSET(0xB37E2F0)
#define RPG_CLIENT_TREASURECHALLENGEDATA_SETISSAVE_OFFSET UNITYSDK_OFFSET(0xB37E380)
#define RPG_CLIENT_TREASURECHALLENGEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB37E220)

namespace RPG::Client
{
	inline static constexpr unsigned int TreasureChallengeData_TypeDefinitionIndex = 62866;
