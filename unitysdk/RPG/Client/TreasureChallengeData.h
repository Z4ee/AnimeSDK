...
#define RPG_CLIENT_TREASURECHALLENGEDATA_GETCHALLENGESTATUS_OFFSET UNITYSDK_OFFSET(0x1B2BAF80)
#define RPG_CLIENT_TREASURECHALLENGEDATA_GETISSAVE_OFFSET UNITYSDK_OFFSET(0x1B2BB010)
#define RPG_CLIENT_TREASURECHALLENGEDATA_GETRAIDID_OFFSET UNITYSDK_OFFSET(0x1B2BAF00)
#define RPG_CLIENT_TREASURECHALLENGEDATA_GETWORLDLV_OFFSET UNITYSDK_OFFSET(0x1B2BAF40)
#define RPG_CLIENT_TREASURECHALLENGEDATA_SETCHALLENGESTATUS_OFFSET UNITYSDK_OFFSET(0x1B2BAFC0)
#define RPG_CLIENT_TREASURECHALLENGEDATA_SETISSAVE_OFFSET UNITYSDK_OFFSET(0x1B2BB050)
#define RPG_CLIENT_TREASURECHALLENGEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2BAEF0)

namespace RPG::Client
{
	inline static constexpr unsigned int TreasureChallengeData_TypeDefinitionIndex = 68177;

	class TreasureChallengeData : public ::System::Object
	{
	public:
		::System::UInt32 _RaidID; // 0x10
		::System::Boolean _IsSave; // 0x14
		::RPG::Client::TreasureChallengeStatus _Status; // 0x18
		::System::UInt32 _WorldLv; // 0x1C
