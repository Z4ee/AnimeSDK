...
#define RPG_CLIENT_CRPVOLUMETRICFOGSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A11DD60)

namespace RPG::Client
{
	inline static constexpr unsigned int CRPVolumetricFogSettings_TypeDefinitionIndex = 67931;
