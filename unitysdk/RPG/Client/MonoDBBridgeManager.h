...
class Class_2_CA541659BF2DC4A9;
namespace RPG::Client { class MonoDBBridgeControl; }
namespace UnityEngine { class GameObject; }

#define RPG_CLIENT_MONODBBRIDGEMANAGER_AWAKE_OFFSET UNITYSDK_OFFSET(0x10CC5460)
#define RPG_CLIENT_MONODBBRIDGEMANAGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x10CC55A0)
#define RPG_CLIENT_MONODBBRIDGEMANAGER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x10CC54D0)
#define RPG_CLIENT_MONODBBRIDGEMANAGER_UPDATEREFERENCEPOS_OFFSET UNITYSDK_OFFSET(0x10CC52B0)
#define RPG_CLIENT_MONODBBRIDGEMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x10CC5530)
#define RPG_CLIENT_MONODBBRIDGEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x10CC5660)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoDBBridgeManager_TypeDefinitionIndex = 67570;
	...
	public:
		...
		::Class_2_CA541659BF2DC4A9* _Behavior; // 0x58
