...
class Class_2_31F3A61EE353E2DB;
namespace RPG::Client { class MonoDBBridgeControl; }
namespace UnityEngine { class GameObject; }

#define RPG_CLIENT_MONODBBRIDGEMANAGER_AWAKE_OFFSET UNITYSDK_OFFSET(0xC0708A0)
#define RPG_CLIENT_MONODBBRIDGEMANAGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC0709E0)
#define RPG_CLIENT_MONODBBRIDGEMANAGER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xC070910)
#define RPG_CLIENT_MONODBBRIDGEMANAGER_UPDATEREFERENCEPOS_OFFSET UNITYSDK_OFFSET(0xC0706F0)
#define RPG_CLIENT_MONODBBRIDGEMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0xC070970)
#define RPG_CLIENT_MONODBBRIDGEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xC070AA0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoDBBridgeManager_TypeDefinitionIndex = 66145;
	...
	public:
		...
		::Class_2_31F3A61EE353E2DB* _Behavior; // 0x58
