...
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORBEHAVIOR_STATECURVECONTROLLER_METHOD_1_6F7271C62F1FE776_OFFSET UNITYSDK_OFFSET(0xC910EF0)
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORBEHAVIOR_STATECURVECONTROLLER_METHOD_1_805C56F44231AEF9_OFFSET UNITYSDK_OFFSET(0xC910E00)
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORBEHAVIOR_STATECURVECONTROLLER_METHOD_1_EABB3B542C82E557_OFFSET UNITYSDK_OFFSET(0xC910B10)
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORBEHAVIOR_STATECURVECONTROLLER_METHOD_1_FC353143FEF1A387_OFFSET UNITYSDK_OFFSET(0xC90F0B0)
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORBEHAVIOR_STATECURVECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC911170)

namespace RPG::Client
{
	inline static constexpr unsigned int StageHarmonySignalDemodulatorBehavior_StateCurveController_TypeDefinitionIndex = 66368;
