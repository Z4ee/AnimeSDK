...
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORBEHAVIOR_STATECURVECONTROLLER_METHOD_1_6F7271C62F1FE776_OFFSET UNITYSDK_OFFSET(0x17B4E290)
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORBEHAVIOR_STATECURVECONTROLLER_METHOD_1_805C56F44231AEF9_OFFSET UNITYSDK_OFFSET(0x17B4E1A0)
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORBEHAVIOR_STATECURVECONTROLLER_METHOD_1_EABB3B542C82E557_OFFSET UNITYSDK_OFFSET(0x17B4DEB0)
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORBEHAVIOR_STATECURVECONTROLLER_METHOD_1_FC353143FEF1A387_OFFSET UNITYSDK_OFFSET(0x17B4C810)
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORBEHAVIOR_STATECURVECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17B4E510)

namespace RPG::Client
{
	inline static constexpr unsigned int StageHarmonySignalDemodulatorBehavior_StateCurveController_TypeDefinitionIndex = 67793;
