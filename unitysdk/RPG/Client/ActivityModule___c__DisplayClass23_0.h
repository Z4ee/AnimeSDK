...
#define RPG_CLIENT_ACTIVITYMODULE___C__DISPLAYCLASS23_0__CTOR_OFFSET UNITYSDK_OFFSET(0xB1BB780)
#define RPG_CLIENT_ACTIVITYMODULE___C__DISPLAYCLASS23_0__GETACTIVITYLOGINDATABYACTIVITYID_B__0_OFFSET UNITYSDK_OFFSET(0xB1CD3A0)
#define RPG_CLIENT_ACTIVITYMODULE___C__DISPLAYCLASS23_0__GETACTIVITYLOGINDATABYACTIVITYID_B__1_OFFSET UNITYSDK_OFFSET(0xB1CD3C0)

namespace RPG::Client
{
	inline static constexpr unsigned int ActivityModule___c__DisplayClass23_0_TypeDefinitionIndex = 57680;
