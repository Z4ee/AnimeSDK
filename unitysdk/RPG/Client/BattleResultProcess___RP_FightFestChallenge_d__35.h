...
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FIGHTFESTCHALLENGE_D__35_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x9E7AE60)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FIGHTFESTCHALLENGE_D__35_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x9E7AFE0)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FIGHTFESTCHALLENGE_D__35_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x9E7B040)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FIGHTFESTCHALLENGE_D__35_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x9E7AFF0)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FIGHTFESTCHALLENGE_D__35_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9E7AE50)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FIGHTFESTCHALLENGE_D__35__CTOR_OFFSET UNITYSDK_OFFSET(0x9E76C50)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleResultProcess___RP_FightFestChallenge_d__35_TypeDefinitionIndex = 56272;
