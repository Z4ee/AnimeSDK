...
#define RPG_CLIENT_ACTIVITYTAGDATAEXT_CONTAINSTAG_OFFSET UNITYSDK_OFFSET(0x1963B1A0)

namespace RPG::Client
{
	inline static constexpr unsigned int ActivityTagDataExt_TypeDefinitionIndex = 61797;
