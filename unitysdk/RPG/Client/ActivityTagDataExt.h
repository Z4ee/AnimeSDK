...
#define RPG_CLIENT_ACTIVITYTAGDATAEXT_CONTAINSTAG_OFFSET UNITYSDK_OFFSET(0x18A9E9C0)

namespace RPG::Client
{
	inline static constexpr unsigned int ActivityTagDataExt_TypeDefinitionIndex = 58962;
