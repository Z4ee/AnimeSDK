...
#define RPG_CLIENT_EXPEDITIONBATTLEFLOWMAPVIEWMODEL_GET_MAPNAME_OFFSET UNITYSDK_OFFSET(0x1B88B3C0)
#define RPG_CLIENT_EXPEDITIONBATTLEFLOWMAPVIEWMODEL_SET_MAPNAME_OFFSET UNITYSDK_OFFSET(0x1B88B3D0)
#define RPG_CLIENT_EXPEDITIONBATTLEFLOWMAPVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B88B3E0)
