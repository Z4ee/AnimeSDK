...
#define RPG_CLIENT_RECOMMEND_RELICRECOMMENDBIGDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xAF81300)
#define RPG_CLIENT_RECOMMEND_RELICRECOMMENDBIGDATA_GET_AVATARID_OFFSET UNITYSDK_OFFSET(0xAF829E0)
#define RPG_CLIENT_RECOMMEND_RELICRECOMMENDBIGDATA_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0xAF82A00)
#define RPG_CLIENT_RECOMMEND_RELICRECOMMENDBIGDATA_GET_ISEXPIRED_OFFSET UNITYSDK_OFFSET(0xAF80480)
#define RPG_CLIENT_RECOMMEND_RELICRECOMMENDBIGDATA_GET_RELICSUITLIST_OFFSET UNITYSDK_OFFSET(0xAF82A20)
#define RPG_CLIENT_RECOMMEND_RELICRECOMMENDBIGDATA_SET_AVATARID_OFFSET UNITYSDK_OFFSET(0xAF829F0)
#define RPG_CLIENT_RECOMMEND_RELICRECOMMENDBIGDATA_SET_ENABLED_OFFSET UNITYSDK_OFFSET(0xAF82A10)
#define RPG_CLIENT_RECOMMEND_RELICRECOMMENDBIGDATA_SET_RELICSUITLIST_OFFSET UNITYSDK_OFFSET(0xAF82A30)
#define RPG_CLIENT_RECOMMEND_RELICRECOMMENDBIGDATA__CREATERELICSUITLIST_OFFSET UNITYSDK_OFFSET(0xAF82A50)
#define RPG_CLIENT_RECOMMEND_RELICRECOMMENDBIGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xAF82A40)

namespace RPG::Client::Recommend
{
	inline static constexpr unsigned int RelicRecommendBigData_TypeDefinitionIndex = 68723;
	...
	public:
		...
		static ::RPG::Client::Recommend::RelicRecommendBigData* Create(::Class_1_2EFC5657EFE4E7C9* rsp)
		{
			return ((::RPG::Client::Recommend::RelicRecommendBigData*(*)(::Class_1_2EFC5657EFE4E7C9*))((::PBYTE)hIl2Cpp + RPG_CLIENT_RECOMMEND_RELICRECOMMENDBIGDATA_CREATE_OFFSET))(rsp);
		}

		static ::System::Collections::Generic::List_1<::RPG::Client::Recommend::RelicSuitBigData*>* _CreateRelicSuitList(::Class_1_D40936EF3BF54118_72* relicSuitRecommend)
		{
			return ((::System::Collections::Generic::List_1<::RPG::Client::Recommend::RelicSuitBigData*>*(*)(::Class_1_D40936EF3BF54118_72*))((::PBYTE)hIl2Cpp + RPG_CLIENT_RECOMMEND_RELICRECOMMENDBIGDATA__CREATERELICSUITLIST_OFFSET))(relicSuitRecommend);
		}
	};
}
