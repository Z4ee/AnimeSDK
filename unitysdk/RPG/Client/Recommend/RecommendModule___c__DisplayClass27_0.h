...
#define RPG_CLIENT_RECOMMEND_RECOMMENDMODULE___C__DISPLAYCLASS27_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC6C69E0)
#define RPG_CLIENT_RECOMMEND_RECOMMENDMODULE___C__DISPLAYCLASS27_0__REQUESTRELICRECOMMENDDATA_B__0_OFFSET UNITYSDK_OFFSET(0xC6C8CF0)

namespace RPG::Client::Recommend
{
	inline static constexpr unsigned int RecommendModule___c__DisplayClass27_0_TypeDefinitionIndex = 69540;

	class RecommendModule___c__DisplayClass27_0 : public ::System::Object
	{
	public:
		::RPG::Client::Recommend::RecommendModule* __4__this; // 0x10
		::RPG::Client::Promises::Promise_1<::RPG::Client::RelicRecommendData*>* newPromise; // 0x18
