...
#define RPG_CLIENT_RECOMMEND_RELICSUITBIGDATA_GET_INNERSETID_OFFSET UNITYSDK_OFFSET(0xC6C9030)
#define RPG_CLIENT_RECOMMEND_RELICSUITBIGDATA_GET_OUTERSETID1_OFFSET UNITYSDK_OFFSET(0xC6C8FF0)
#define RPG_CLIENT_RECOMMEND_RELICSUITBIGDATA_GET_OUTERSETID2_OFFSET UNITYSDK_OFFSET(0xC6C9010)
#define RPG_CLIENT_RECOMMEND_RELICSUITBIGDATA_SET_INNERSETID_OFFSET UNITYSDK_OFFSET(0xC6C9040)
#define RPG_CLIENT_RECOMMEND_RELICSUITBIGDATA_SET_OUTERSETID1_OFFSET UNITYSDK_OFFSET(0xC6C9000)
#define RPG_CLIENT_RECOMMEND_RELICSUITBIGDATA_SET_OUTERSETID2_OFFSET UNITYSDK_OFFSET(0xC6C9020)
#define RPG_CLIENT_RECOMMEND_RELICSUITBIGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC6C8FE0)

namespace RPG::Client::Recommend
{
	inline static constexpr unsigned int RelicSuitBigData_TypeDefinitionIndex = 69534;

	class RelicSuitBigData : public ::System::Object
	{
	public:
		::System::UInt32 _InnerSetID_k__BackingField; // 0x10
