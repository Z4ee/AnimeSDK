...
#define RPG_CLIENT_RECOMMEND_RELICSUITBIGDATA_GET_INNERSETID_OFFSET UNITYSDK_OFFSET(0x19864820)
#define RPG_CLIENT_RECOMMEND_RELICSUITBIGDATA_GET_OUTERSETID1_OFFSET UNITYSDK_OFFSET(0x198647E0)
#define RPG_CLIENT_RECOMMEND_RELICSUITBIGDATA_GET_OUTERSETID2_OFFSET UNITYSDK_OFFSET(0x19864800)
#define RPG_CLIENT_RECOMMEND_RELICSUITBIGDATA_SET_INNERSETID_OFFSET UNITYSDK_OFFSET(0x19864830)
#define RPG_CLIENT_RECOMMEND_RELICSUITBIGDATA_SET_OUTERSETID1_OFFSET UNITYSDK_OFFSET(0x198647F0)
#define RPG_CLIENT_RECOMMEND_RELICSUITBIGDATA_SET_OUTERSETID2_OFFSET UNITYSDK_OFFSET(0x19864810)
#define RPG_CLIENT_RECOMMEND_RELICSUITBIGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x198647D0)

namespace RPG::Client::Recommend
{
	inline static constexpr unsigned int RelicSuitBigData_TypeDefinitionIndex = 71057;

	class RelicSuitBigData : public ::System::Object
	{
	public:
		::System::UInt32 _OuterSetID1_k__BackingField; // 0x10
		::System::UInt32 _OuterSetID2_k__BackingField; // 0x14
