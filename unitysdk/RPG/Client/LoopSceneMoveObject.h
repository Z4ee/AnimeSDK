...
#define RPG_CLIENT_LOOPSCENEMOVEOBJECT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15BEEDF0)
#define RPG_CLIENT_LOOPSCENEMOVEOBJECT_INIT_OFFSET UNITYSDK_OFFSET(0x15BEFD00)
#define RPG_CLIENT_LOOPSCENEMOVEOBJECT_MOVE_OFFSET UNITYSDK_OFFSET(0x15BEFA30)
#define RPG_CLIENT_LOOPSCENEMOVEOBJECT_ROLLBACK_OFFSET UNITYSDK_OFFSET(0x15BEFB30)
#define RPG_CLIENT_LOOPSCENEMOVEOBJECT_SETOWNERENTITY_OFFSET UNITYSDK_OFFSET(0x15BEFDB0)
#define RPG_CLIENT_LOOPSCENEMOVEOBJECT_SETOWNERLOOPSCENE_OFFSET UNITYSDK_OFFSET(0x15BEFE00)
#define RPG_CLIENT_LOOPSCENEMOVEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x15BEFE50)

namespace RPG::Client
{
	inline static constexpr unsigned int LoopSceneMoveObject_TypeDefinitionIndex = 65796;
