...
#define RPG_CLIENT_LOOPSCENEMOVEOBJECT_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA71C8B0)
#define RPG_CLIENT_LOOPSCENEMOVEOBJECT_INIT_OFFSET UNITYSDK_OFFSET(0xA71D770)
#define RPG_CLIENT_LOOPSCENEMOVEOBJECT_MOVE_OFFSET UNITYSDK_OFFSET(0xA71D4A0)
#define RPG_CLIENT_LOOPSCENEMOVEOBJECT_ROLLBACK_OFFSET UNITYSDK_OFFSET(0xA71D5A0)
#define RPG_CLIENT_LOOPSCENEMOVEOBJECT_SETOWNERENTITY_OFFSET UNITYSDK_OFFSET(0xA71D820)
#define RPG_CLIENT_LOOPSCENEMOVEOBJECT_SETOWNERLOOPSCENE_OFFSET UNITYSDK_OFFSET(0xA71D870)
#define RPG_CLIENT_LOOPSCENEMOVEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0xA71D8C0)

namespace RPG::Client
{
	inline static constexpr unsigned int LoopSceneMoveObject_TypeDefinitionIndex = 63505;
