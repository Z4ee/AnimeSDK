...
#define RPG_CLIENT_CUSTOMPOSITIONCONSTRAINT_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x18087B10)
#define RPG_CLIENT_CUSTOMPOSITIONCONSTRAINT_METHOD_5_3905F8092E1B5E52_OFFSET UNITYSDK_OFFSET(0x18088A20)
#define RPG_CLIENT_CUSTOMPOSITIONCONSTRAINT_METHOD_5_861970C5F2C21AB2_OFFSET UNITYSDK_OFFSET(0x18088940)
#define RPG_CLIENT_CUSTOMPOSITIONCONSTRAINT_METHOD_5_ECA33935490AF2E4_OFFSET UNITYSDK_OFFSET(0x18087B60)
#define RPG_CLIENT_CUSTOMPOSITIONCONSTRAINT__CTOR_OFFSET UNITYSDK_OFFSET(0x18088AF0)

namespace RPG::Client
{
	inline static constexpr unsigned int CustomPositionConstraint_TypeDefinitionIndex = 67101;
