...
#define RPG_CLIENT_CUSTOMPOSITIONCONSTRAINT_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xA0EE840)
#define RPG_CLIENT_CUSTOMPOSITIONCONSTRAINT_METHOD_5_3905F8092E1B5E52_OFFSET UNITYSDK_OFFSET(0xA0EF780)
#define RPG_CLIENT_CUSTOMPOSITIONCONSTRAINT_METHOD_5_861970C5F2C21AB2_OFFSET UNITYSDK_OFFSET(0xA0EF6A0)
#define RPG_CLIENT_CUSTOMPOSITIONCONSTRAINT_METHOD_5_ECA33935490AF2E4_OFFSET UNITYSDK_OFFSET(0xA0EE890)
#define RPG_CLIENT_CUSTOMPOSITIONCONSTRAINT__CTOR_OFFSET UNITYSDK_OFFSET(0xA0EF850)

namespace RPG::Client
{
	inline static constexpr unsigned int CustomPositionConstraint_TypeDefinitionIndex = 64762;
