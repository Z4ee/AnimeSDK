...
#define RPG_CLIENT_UITEXTUTILS_REMAINTIMEUNITTEXTPALETTE_GET_DAY_OFFSET UNITYSDK_OFFSET(0xE3C25D0)
#define RPG_CLIENT_UITEXTUTILS_REMAINTIMEUNITTEXTPALETTE_GET_HOUR_OFFSET UNITYSDK_OFFSET(0xE3C25E0)
#define RPG_CLIENT_UITEXTUTILS_REMAINTIMEUNITTEXTPALETTE_GET_MINUTE_OFFSET UNITYSDK_OFFSET(0xE3C25F0)
#define RPG_CLIENT_UITEXTUTILS_REMAINTIMEUNITTEXTPALETTE_GET_SECOND_OFFSET UNITYSDK_OFFSET(0xE3C2600)
#define RPG_CLIENT_UITEXTUTILS_REMAINTIMEUNITTEXTPALETTE__CCTOR_OFFSET UNITYSDK_OFFSET(0xE3C2640)
#define RPG_CLIENT_UITEXTUTILS_REMAINTIMEUNITTEXTPALETTE__CTOR_OFFSET UNITYSDK_OFFSET(0xE3C2610)

namespace RPG::Client
{
	inline static constexpr unsigned int UITextUtils_RemainTimeUnitTextPalette_TypeDefinitionIndex = 73089;
	...
	public:
		...
		{
			return (::RPG::Client::UITextUtils_RemainTimeUnitTextPalette**)Il2CppClass::FromTypeDefinitionIndex(UITextUtils_RemainTimeUnitTextPalette_TypeDefinitionIndex)->GetStaticField(0x165E0);
		}
