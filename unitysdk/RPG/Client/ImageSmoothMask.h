...
#define RPG_CLIENT_IMAGESMOOTHMASK_AWAKE_OFFSET UNITYSDK_OFFSET(0xD3EEFD0)
#define RPG_CLIENT_IMAGESMOOTHMASK_GENERATEUIQUADS_OFFSET UNITYSDK_OFFSET(0xD3ED760)
#define RPG_CLIENT_IMAGESMOOTHMASK_METHOD_5_1CCA678374876A08_OFFSET UNITYSDK_OFFSET(0xD3EF0C0)
#define RPG_CLIENT_IMAGESMOOTHMASK_METHOD_5_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0xD3EED40)
#define RPG_CLIENT_IMAGESMOOTHMASK_METHOD_5_6916CB2AB9451DD7_OFFSET UNITYSDK_OFFSET(0xD3EE800)
#define RPG_CLIENT_IMAGESMOOTHMASK_METHOD_5_999B8B439422C7E7_OFFSET UNITYSDK_OFFSET(0xD3EEF00)
#define RPG_CLIENT_IMAGESMOOTHMASK_METHOD_5_A3233D9B1105D899_OFFSET UNITYSDK_OFFSET(0xD3EEEB0)
#define RPG_CLIENT_IMAGESMOOTHMASK_METHOD_5_B3F39261B5412C77_OFFSET UNITYSDK_OFFSET(0xD3EF150)
#define RPG_CLIENT_IMAGESMOOTHMASK_METHOD_5_CB7604B59F367726_OFFSET UNITYSDK_OFFSET(0xD3EE790)
#define RPG_CLIENT_IMAGESMOOTHMASK_METHOD_5_E28A3E956899D038_OFFSET UNITYSDK_OFFSET(0xD3EF300)
#define RPG_CLIENT_IMAGESMOOTHMASK_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xD3EF030)
#define RPG_CLIENT_IMAGESMOOTHMASK__CTOR_OFFSET UNITYSDK_OFFSET(0xD3F0140)

namespace RPG::Client
{
	inline static constexpr unsigned int ImageSmoothMask_TypeDefinitionIndex = 72473;
