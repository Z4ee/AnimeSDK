...
#define RPG_CLIENT_IMAGESMOOTHMASK_AWAKE_OFFSET UNITYSDK_OFFSET(0xBD2A290)
#define RPG_CLIENT_IMAGESMOOTHMASK_GENERATEUIQUADS_OFFSET UNITYSDK_OFFSET(0xBD28860)
#define RPG_CLIENT_IMAGESMOOTHMASK_METHOD_5_1CCA678374876A08_OFFSET UNITYSDK_OFFSET(0xBD2A380)
#define RPG_CLIENT_IMAGESMOOTHMASK_METHOD_5_1D71E7B379E7CC08_OFFSET UNITYSDK_OFFSET(0xBD2A5C0)
#define RPG_CLIENT_IMAGESMOOTHMASK_METHOD_5_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0xBD29F60)
#define RPG_CLIENT_IMAGESMOOTHMASK_METHOD_5_99053D1AE5A59190_OFFSET UNITYSDK_OFFSET(0xBD29970)
#define RPG_CLIENT_IMAGESMOOTHMASK_METHOD_5_999B8B439422C7E7_OFFSET UNITYSDK_OFFSET(0xBD2A170)
#define RPG_CLIENT_IMAGESMOOTHMASK_METHOD_5_B3F39261B5412C77_OFFSET UNITYSDK_OFFSET(0xBD2A410)
#define RPG_CLIENT_IMAGESMOOTHMASK_METHOD_5_C561FF611C07A44C_OFFSET UNITYSDK_OFFSET(0xBD2A0D0)
#define RPG_CLIENT_IMAGESMOOTHMASK_METHOD_5_CB7604B59F367726_OFFSET UNITYSDK_OFFSET(0xBD29900)
#define RPG_CLIENT_IMAGESMOOTHMASK_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xBD2A2F0)
#define RPG_CLIENT_IMAGESMOOTHMASK__CTOR_OFFSET UNITYSDK_OFFSET(0xBD2B3C0)

namespace RPG::Client
{
	inline static constexpr unsigned int ImageSmoothMask_TypeDefinitionIndex = 67786;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_IMAGESMOOTHMASK_METHOD_5_99053D1AE5A59190_OFFSET))(this);
		}
