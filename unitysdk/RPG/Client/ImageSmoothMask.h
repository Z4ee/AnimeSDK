...
#define RPG_CLIENT_IMAGESMOOTHMASK_AWAKE_OFFSET UNITYSDK_OFFSET(0x993AD80)
#define RPG_CLIENT_IMAGESMOOTHMASK_GENERATEUIQUADS_OFFSET UNITYSDK_OFFSET(0x9939240)
#define RPG_CLIENT_IMAGESMOOTHMASK_METHOD_5_1CCA678374876A08_OFFSET UNITYSDK_OFFSET(0x993AE70)
#define RPG_CLIENT_IMAGESMOOTHMASK_METHOD_5_1D71E7B379E7CC08_OFFSET UNITYSDK_OFFSET(0x993B100)
#define RPG_CLIENT_IMAGESMOOTHMASK_METHOD_5_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0x993AA50)
#define RPG_CLIENT_IMAGESMOOTHMASK_METHOD_5_601EF3E7226D7DC2_OFFSET UNITYSDK_OFFSET(0x993A5F0)
#define RPG_CLIENT_IMAGESMOOTHMASK_METHOD_5_999B8B439422C7E7_OFFSET UNITYSDK_OFFSET(0x993AC60)
#define RPG_CLIENT_IMAGESMOOTHMASK_METHOD_5_B3F39261B5412C77_OFFSET UNITYSDK_OFFSET(0x993AF00)
#define RPG_CLIENT_IMAGESMOOTHMASK_METHOD_5_C561FF611C07A44C_OFFSET UNITYSDK_OFFSET(0x993ABC0)
#define RPG_CLIENT_IMAGESMOOTHMASK_METHOD_5_CB7604B59F367726_OFFSET UNITYSDK_OFFSET(0x993A580)
#define RPG_CLIENT_IMAGESMOOTHMASK_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x993ADE0)
#define RPG_CLIENT_IMAGESMOOTHMASK__CTOR_OFFSET UNITYSDK_OFFSET(0x993BF00)

namespace RPG::Client
{
	inline static constexpr unsigned int ImageSmoothMask_TypeDefinitionIndex = 59451;
