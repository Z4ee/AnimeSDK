...
#define RPG_CLIENT_TAROTBOOKMAILMANAGER___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x19776FF0)
#define RPG_CLIENT_TAROTBOOKMAILMANAGER___C__CTOR_OFFSET UNITYSDK_OFFSET(0x19777030)
#define RPG_CLIENT_TAROTBOOKMAILMANAGER___C__MARKSEENANDGETALLDATA_B__9_0_OFFSET UNITYSDK_OFFSET(0x19777040)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Comparison_1<::RPG::Client::TarotMailData*>**)Il2CppClass::FromTypeDefinitionIndex(TarotBookMailManager___c_TypeDefinitionIndex)->GetStaticField(0x3BA80);
		}
		static ::RPG::Client::TarotBookMailManager___c** StaticGet___9()
		{
			return (::RPG::Client::TarotBookMailManager___c**)Il2CppClass::FromTypeDefinitionIndex(TarotBookMailManager___c_TypeDefinitionIndex)->GetStaticField(0x3BA88);
		}
