...
#define RPG_CLIENT_PERFORMANCESKIPUTILS_REPORTPERFORMANCESKIPDIALOG_OFFSET UNITYSDK_OFFSET(0x9F2FC10)
#define RPG_CLIENT_PERFORMANCESKIPUTILS_SHOWOLDPERFORMANCESKIPDIALOG_OFFSET UNITYSDK_OFFSET(0x9F2F250)
#define RPG_CLIENT_PERFORMANCESKIPUTILS_SHOWPERFORMANCESKIPDIALOG_OFFSET UNITYSDK_OFFSET(0x9F2EBA0)
#define RPG_CLIENT_PERFORMANCESKIPUTILS__CHECKOVERRIDECONFIG_OFFSET UNITYSDK_OFFSET(0x9F2F720)
#define RPG_CLIENT_PERFORMANCESKIPUTILS__GETACTORICONPATHLIST_OFFSET UNITYSDK_OFFSET(0x9F2F870)
#define RPG_CLIENT_PERFORMANCESKIPUTILS__ISCONTENTEXIST_OFFSET UNITYSDK_OFFSET(0x9F2F800)

namespace RPG::Client
{
	inline static constexpr unsigned int PerformanceSkipUtils_TypeDefinitionIndex = 49206;
