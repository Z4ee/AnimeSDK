...
#define RPG_CLIENT_PERFORMANCESKIPUTILS_REPORTPERFORMANCESKIPDIALOG_OFFSET UNITYSDK_OFFSET(0x186569E0)
#define RPG_CLIENT_PERFORMANCESKIPUTILS_SHOWOLDPERFORMANCESKIPDIALOG_OFFSET UNITYSDK_OFFSET(0x18656090)
#define RPG_CLIENT_PERFORMANCESKIPUTILS_SHOWPERFORMANCESKIPDIALOG_OFFSET UNITYSDK_OFFSET(0x18655A20)
#define RPG_CLIENT_PERFORMANCESKIPUTILS__CHECKOVERRIDECONFIG_OFFSET UNITYSDK_OFFSET(0x186564A0)
#define RPG_CLIENT_PERFORMANCESKIPUTILS__GETACTORICONPATHLIST_OFFSET UNITYSDK_OFFSET(0x186565F0)
#define RPG_CLIENT_PERFORMANCESKIPUTILS__ISCONTENTEXIST_OFFSET UNITYSDK_OFFSET(0x18656580)
