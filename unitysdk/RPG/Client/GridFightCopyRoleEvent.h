...
#define RPG_CLIENT_GRIDFIGHTCOPYROLEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0xA467EB0)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightCopyRoleEvent_TypeDefinitionIndex = 60007;
