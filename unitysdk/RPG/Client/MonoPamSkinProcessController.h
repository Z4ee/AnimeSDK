...
#define RPG_CLIENT_MONOPAMSKINPROCESSCONTROLLER_GET_PAMPOSITION_OFFSET UNITYSDK_OFFSET(0x9D24CF0)
#define RPG_CLIENT_MONOPAMSKINPROCESSCONTROLLER_GET_PAMROTATION_OFFSET UNITYSDK_OFFSET(0x9D24DD0)
#define RPG_CLIENT_MONOPAMSKINPROCESSCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9D24DE0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoPamSkinProcessController_TypeDefinitionIndex = 59714;
