...
#define RPG_CLIENT_MONOPAMSKINPROCESSCONTROLLER_GET_PAMPOSITION_OFFSET UNITYSDK_OFFSET(0xA9E8070)
#define RPG_CLIENT_MONOPAMSKINPROCESSCONTROLLER_GET_PAMROTATION_OFFSET UNITYSDK_OFFSET(0xA9E8150)
#define RPG_CLIENT_MONOPAMSKINPROCESSCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA9E8160)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoPamSkinProcessController_TypeDefinitionIndex = 67110;
