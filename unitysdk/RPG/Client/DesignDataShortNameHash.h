...
#define RPG_CLIENT_DESIGNDATASHORTNAMEHASH_COMPARETO_1_OFFSET UNITYSDK_OFFSET(0x3B651D0)
#define RPG_CLIENT_DESIGNDATASHORTNAMEHASH_COMPARETO_OFFSET UNITYSDK_OFFSET(0x3B9CCA0)
#define RPG_CLIENT_DESIGNDATASHORTNAMEHASH_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x3B9CCB0)
#define RPG_CLIENT_DESIGNDATASHORTNAMEHASH_EQUALS_OFFSET UNITYSDK_OFFSET(0x2E7B720)
#define RPG_CLIENT_DESIGNDATASHORTNAMEHASH_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x15FB60)
#define RPG_CLIENT_DESIGNDATASHORTNAMEHASH_METHOD_2_3F760D501F194509_OFFSET UNITYSDK_OFFSET(0x1E592490)
#define RPG_CLIENT_DESIGNDATASHORTNAMEHASH_METHOD_2_6D7E8958B064AE42_OFFSET UNITYSDK_OFFSET(0x1E592400)
#define RPG_CLIENT_DESIGNDATASHORTNAMEHASH_METHOD_2_C6FDF346FA3CF4A3_OFFSET UNITYSDK_OFFSET(0x1E592460)
#define RPG_CLIENT_DESIGNDATASHORTNAMEHASH_METHOD_2_CEC046D7238DBFD9_1_OFFSET UNITYSDK_OFFSET(0x1E592680)
#define RPG_CLIENT_DESIGNDATASHORTNAMEHASH_METHOD_2_CEC046D7238DBFD9_OFFSET UNITYSDK_OFFSET(0x1E592670)
#define RPG_CLIENT_DESIGNDATASHORTNAMEHASH_METHOD_2_EC3ED7E35FB3EB27_OFFSET UNITYSDK_OFFSET(0x1E592450)
#define RPG_CLIENT_DESIGNDATASHORTNAMEHASH_METHOD_2_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x2E7B630)
#define RPG_CLIENT_DESIGNDATASHORTNAMEHASH_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3B65210)
#define RPG_CLIENT_DESIGNDATASHORTNAMEHASH__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E592690)
#define RPG_CLIENT_DESIGNDATASHORTNAMEHASH__CTOR_OFFSET UNITYSDK_OFFSET(0xC610)
