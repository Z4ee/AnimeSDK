...
#define RPG_CLIENT_FIVEDIMMANAGER_CAMERACONTEXT_CLEAR_OFFSET UNITYSDK_OFFSET(0x96EBFD0)
#define RPG_CLIENT_FIVEDIMMANAGER_CAMERACONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x96EC020)
...
namespace RPG::Client
{
	...
	public:
		...
		::RPG::Client::FiveDimGameInstance* Instance; // 0x20
		::RPG::Client::LittleGame::FiveDim::FiveDimMonoCamera* Camera; // 0x28
		::RPG::GameCore::FiveDimCameraDOFConfig* DOFConfig; // 0x30
