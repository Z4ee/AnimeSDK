...
#define RPG_CLIENT_FIVEDIMMANAGER_CAMERACONTEXT_CLEAR_OFFSET UNITYSDK_OFFSET(0xD08AAB0)
#define RPG_CLIENT_FIVEDIMMANAGER_CAMERACONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xD08AB00)
...
namespace RPG::Client
{
	...
	{
	public:
		::RPG::Client::LittleGame::FiveDim::FiveDimMonoCamera* Camera; // 0x10
		::RPG::GameCore::FiveDimVCameraBlendConfig* OutBlend; // 0x18
		::RPG::GameCore::FiveDimVCameraBlendConfig* InBlend; // 0x20
		::RPG::GameCore::FiveDimCameraDOFConfig* DOFConfig; // 0x28
