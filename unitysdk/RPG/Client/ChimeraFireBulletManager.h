...
#define RPG_CLIENT_CHIMERAFIREBULLETMANAGER_FIREBULLET_OFFSET UNITYSDK_OFFSET(0xCBFAB30)
#define RPG_CLIENT_CHIMERAFIREBULLETMANAGER_METHOD_5_1AE3C916218B4E29_OFFSET UNITYSDK_OFFSET(0xCBFACD0)
#define RPG_CLIENT_CHIMERAFIREBULLETMANAGER_METHOD_5_E824431C22EF9361_OFFSET UNITYSDK_OFFSET(0xCBFB410)
#define RPG_CLIENT_CHIMERAFIREBULLETMANAGER_START_OFFSET UNITYSDK_OFFSET(0xCBFA2B0)
#define RPG_CLIENT_CHIMERAFIREBULLETMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0xCBFA350)
#define RPG_CLIENT_CHIMERAFIREBULLETMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xCBFB640)
#define RPG_CLIENT_CHIMERAFIREBULLETMANAGER___FIREBULLETIMPL_B__3_0_OFFSET UNITYSDK_OFFSET(0xCBFB6D0)
