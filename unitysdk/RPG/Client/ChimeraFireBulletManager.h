...
#define RPG_CLIENT_CHIMERAFIREBULLETMANAGER_FIREBULLET_OFFSET UNITYSDK_OFFSET(0x19AFACA0)
#define RPG_CLIENT_CHIMERAFIREBULLETMANAGER_METHOD_5_1AE3C916218B4E29_OFFSET UNITYSDK_OFFSET(0x19AFAE40)
#define RPG_CLIENT_CHIMERAFIREBULLETMANAGER_METHOD_5_E824431C22EF9361_OFFSET UNITYSDK_OFFSET(0x19AFB580)
#define RPG_CLIENT_CHIMERAFIREBULLETMANAGER_START_OFFSET UNITYSDK_OFFSET(0x19AFA420)
#define RPG_CLIENT_CHIMERAFIREBULLETMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x19AFA4C0)
#define RPG_CLIENT_CHIMERAFIREBULLETMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x19AFB7B0)
#define RPG_CLIENT_CHIMERAFIREBULLETMANAGER___FIREBULLETIMPL_B__3_0_OFFSET UNITYSDK_OFFSET(0x19AFB840)

namespace RPG::Client
{
	inline static constexpr unsigned int ChimeraFireBulletManager_TypeDefinitionIndex = 65597;
