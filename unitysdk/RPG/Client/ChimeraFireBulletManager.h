...
#define RPG_CLIENT_CHIMERAFIREBULLETMANAGER_FIREBULLET_OFFSET UNITYSDK_OFFSET(0xA029570)
#define RPG_CLIENT_CHIMERAFIREBULLETMANAGER_METHOD_5_025E4B1A2211CF52_OFFSET UNITYSDK_OFFSET(0xA029DB0)
#define RPG_CLIENT_CHIMERAFIREBULLETMANAGER_METHOD_5_1AE3C916218B4E29_OFFSET UNITYSDK_OFFSET(0xA0296F0)
#define RPG_CLIENT_CHIMERAFIREBULLETMANAGER_START_OFFSET UNITYSDK_OFFSET(0xA028C70)
#define RPG_CLIENT_CHIMERAFIREBULLETMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0xA028D20)
#define RPG_CLIENT_CHIMERAFIREBULLETMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xA029FD0)
#define RPG_CLIENT_CHIMERAFIREBULLETMANAGER___FIREBULLETIMPL_B__3_0_OFFSET UNITYSDK_OFFSET(0xA02A060)

namespace RPG::Client
{
	inline static constexpr unsigned int ChimeraFireBulletManager_TypeDefinitionIndex = 63309;
