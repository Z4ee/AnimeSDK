...
#define RPG_CLIENT_CHIMERAFIREBULLETMANAGER_FIREBULLET_OFFSET UNITYSDK_OFFSET(0xB6A5F00)
#define RPG_CLIENT_CHIMERAFIREBULLETMANAGER_METHOD_5_1AE3C916218B4E29_OFFSET UNITYSDK_OFFSET(0xB6A60A0)
#define RPG_CLIENT_CHIMERAFIREBULLETMANAGER_METHOD_5_E824431C22EF9361_OFFSET UNITYSDK_OFFSET(0xB6A67E0)
#define RPG_CLIENT_CHIMERAFIREBULLETMANAGER_START_OFFSET UNITYSDK_OFFSET(0xB6A5600)
#define RPG_CLIENT_CHIMERAFIREBULLETMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0xB6A56A0)
#define RPG_CLIENT_CHIMERAFIREBULLETMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xB6A6A10)
#define RPG_CLIENT_CHIMERAFIREBULLETMANAGER___FIREBULLETIMPL_B__3_0_OFFSET UNITYSDK_OFFSET(0xB6A6AA0)

namespace RPG::Client
{
	inline static constexpr unsigned int ChimeraFireBulletManager_TypeDefinitionIndex = 64226;
