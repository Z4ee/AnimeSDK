...
#define RPG_CLIENT_BATTLESHOWMESSAGEMANAGER_MESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0xC939850)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleShowMessageManager_Message_TypeDefinitionIndex = 71792;
