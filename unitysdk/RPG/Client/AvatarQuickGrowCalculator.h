...
#define RPG_CLIENT_AVATARQUICKGROWCALCULATOR_CLEARRULECONTEXT_OFFSET UNITYSDK_OFFSET(0xC83CC60)
#define RPG_CLIENT_AVATARQUICKGROWCALCULATOR_GET_RESULT_OFFSET UNITYSDK_OFFSET(0xC83CA30)
#define RPG_CLIENT_AVATARQUICKGROWCALCULATOR_MARKDIRTY_OFFSET UNITYSDK_OFFSET(0xC83CB90)
#define RPG_CLIENT_AVATARQUICKGROWCALCULATOR_SETAVATAR_OFFSET UNITYSDK_OFFSET(0xC83CB10)
#define RPG_CLIENT_AVATARQUICKGROWCALCULATOR_SETRULECONTEXT_OFFSET UNITYSDK_OFFSET(0xC83CBD0)
#define RPG_CLIENT_AVATARQUICKGROWCALCULATOR__BUILDEXPPLAN_OFFSET UNITYSDK_OFFSET(0xC83E720)
#define RPG_CLIENT_AVATARQUICKGROWCALCULATOR__CALCULATE_OFFSET UNITYSDK_OFFSET(0xC83CCD0)
#define RPG_CLIENT_AVATARQUICKGROWCALCULATOR__CCTOR_OFFSET UNITYSDK_OFFSET(0xC83FE50)
#define RPG_CLIENT_AVATARQUICKGROWCALCULATOR__CEILDIV_OFFSET UNITYSDK_OFFSET(0xC83FDB0)
#define RPG_CLIENT_AVATARQUICKGROWCALCULATOR__CTOR_OFFSET UNITYSDK_OFFSET(0xC83CA20)
#define RPG_CLIENT_AVATARQUICKGROWCALCULATOR__DETERMINELEVELTARGET_OFFSET UNITYSDK_OFFSET(0xC83E510)
#define RPG_CLIENT_AVATARQUICKGROWCALCULATOR__ENSUREAVATAREXPROWS_OFFSET UNITYSDK_OFFSET(0xC83D0F0)
#define RPG_CLIENT_AVATARQUICKGROWCALCULATOR__FILLPREVIEWCOSTS_OFFSET UNITYSDK_OFFSET(0xC83F450)
#define RPG_CLIENT_AVATARQUICKGROWCALCULATOR__FILLREQCOSTLISTS_OFFSET UNITYSDK_OFFSET(0xC83F0F0)
#define RPG_CLIENT_AVATARQUICKGROWCALCULATOR__FINALIZERESULT_OFFSET UNITYSDK_OFFSET(0xC83E300)
#define RPG_CLIENT_AVATARQUICKGROWCALCULATOR__GETAVAILABLEITEMCOUNT_OFFSET UNITYSDK_OFFSET(0xC83EE60)
#define RPG_CLIENT_AVATARQUICKGROWCALCULATOR__GETDISPLAYMAXPROMOTIONLEVEL_OFFSET UNITYSDK_OFFSET(0xC83E410)
#define RPG_CLIENT_AVATARQUICKGROWCALCULATOR__GETEFFECTIVERULECONTEXT_OFFSET UNITYSDK_OFFSET(0xC83D8C0)
#define RPG_CLIENT_AVATARQUICKGROWCALCULATOR__GETEXPCOSTFORLEVELS_OFFSET UNITYSDK_OFFSET(0xC83EC60)
#define RPG_CLIENT_AVATARQUICKGROWCALCULATOR__GETLEVELUPCOINCOST_OFFSET UNITYSDK_OFFSET(0xC83EF90)
#define RPG_CLIENT_AVATARQUICKGROWCALCULATOR__GETMAXLEVELOFPROMOTION_OFFSET UNITYSDK_OFFSET(0xC83DC00)
#define RPG_CLIENT_AVATARQUICKGROWCALCULATOR__GETTARGETPROMOTIONLEVEL_OFFSET UNITYSDK_OFFSET(0xC83DA20)
#define RPG_CLIENT_AVATARQUICKGROWCALCULATOR__GETTOTALAVAILABLEEXP_OFFSET UNITYSDK_OFFSET(0xC83DC80)
#define RPG_CLIENT_AVATARQUICKGROWCALCULATOR__RESOLVEFARMDEMAND_OFFSET UNITYSDK_OFFSET(0xC83FA60)
#define RPG_CLIENT_AVATARQUICKGROWCALCULATOR__SIMULATEGROW_OFFSET UNITYSDK_OFFSET(0xC83DE30)
#define RPG_CLIENT_AVATARQUICKGROWCALCULATOR__TRYPROMOTION_OFFSET UNITYSDK_OFFSET(0xC83ECC0)
#define RPG_CLIENT_AVATARQUICKGROWCALCULATOR__TRYRECALCULATE_OFFSET UNITYSDK_OFFSET(0xC83CAB0)

namespace RPG::Client
{
	inline static constexpr unsigned int AvatarQuickGrowCalculator_TypeDefinitionIndex = 62551;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::RPG::GameCore::AvatarExpItemConfigRow*>**)Il2CppClass::FromTypeDefinitionIndex(AvatarQuickGrowCalculator_TypeDefinitionIndex)->GetStaticField(0x66560);
		}
		static ::System::UInt32* StaticGet__HighestExpItemID()
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(AvatarQuickGrowCalculator_TypeDefinitionIndex)->GetStaticField(0x15160);
		}
		static ::System::UInt32* StaticGet__HighestExpProvide()
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(AvatarQuickGrowCalculator_TypeDefinitionIndex)->GetStaticField(0x15164);
		}
		static ::System::UInt32* StaticGet__CoinItemID()
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(AvatarQuickGrowCalculator_TypeDefinitionIndex)->GetStaticField(0x15168);
		}
		::RPG::AvatarSystem::IAvatar* _Avatar; // 0x10
		::RPG::Client::AvatarGrowPlanResult* _Result; // 0x18
		::System::UInt32 _RulePlayerLevel; // 0x20
		::System::UInt32 _RuleWorldLevel; // 0x24
		::System::Boolean _IsDirty; // 0x28
