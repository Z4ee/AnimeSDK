...
#define RPG_CLIENT_EARLYACCESSCONTENT___C__DISPLAYCLASS22_0__CONTAINSDIMENSION_B__0_OFFSET UNITYSDK_OFFSET(0xA1AD1C0)
#define RPG_CLIENT_EARLYACCESSCONTENT___C__DISPLAYCLASS22_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA1ABB50)

namespace RPG::Client
{
	inline static constexpr unsigned int EarlyAccessContent___c__DisplayClass22_0_TypeDefinitionIndex = 58639;
