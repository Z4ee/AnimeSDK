...
#define RPG_CLIENT_TWEEN_MONOTWEENBEHAVIOUR_GETCUSTOMANICURVE_1_OFFSET UNITYSDK_OFFSET(0x16FE06C0)
#define RPG_CLIENT_TWEEN_MONOTWEENBEHAVIOUR_GETCUSTOMANICURVE_OFFSET UNITYSDK_OFFSET(0x16FE0520)
#define RPG_CLIENT_TWEEN_MONOTWEENBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x16FE0760)

namespace RPG::Client::Tween
{
	inline static constexpr unsigned int MonoTweenBehaviour_TypeDefinitionIndex = 70074;
