...
#define RPG_CLIENT_TWEEN_MONOTWEENBEHAVIOUR_GETCUSTOMANICURVE_1_OFFSET UNITYSDK_OFFSET(0xB3A3340)
#define RPG_CLIENT_TWEEN_MONOTWEENBEHAVIOUR_GETCUSTOMANICURVE_OFFSET UNITYSDK_OFFSET(0xB3A3180)
#define RPG_CLIENT_TWEEN_MONOTWEENBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xB3A33F0)

namespace RPG::Client::Tween
{
	inline static constexpr unsigned int MonoTweenBehaviour_TypeDefinitionIndex = 67619;
