...
#define RPG_CLIENT_AUDIENCEMOODMAPCONFIG_METHOD_3_1E69147855C867D9_OFFSET UNITYSDK_OFFSET(0x1B344400)
#define RPG_CLIENT_AUDIENCEMOODMAPCONFIG_METHOD_3_4204875C2FA6F503_OFFSET UNITYSDK_OFFSET(0x1B3444F0)
#define RPG_CLIENT_AUDIENCEMOODMAPCONFIG_METHOD_3_EA0BA3E4AF50C583_OFFSET UNITYSDK_OFFSET(0x1B3445D0)
#define RPG_CLIENT_AUDIENCEMOODMAPCONFIG_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1B344840)
#define RPG_CLIENT_AUDIENCEMOODMAPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3448E0)

namespace RPG::Client
{
	inline static constexpr unsigned int AudienceMoodMapConfig_TypeDefinitionIndex = 69118;
