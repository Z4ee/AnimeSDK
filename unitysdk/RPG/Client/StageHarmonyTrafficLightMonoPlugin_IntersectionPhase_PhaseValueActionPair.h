...
#define RPG_CLIENT_STAGEHARMONYTRAFFICLIGHTMONOPLUGIN_INTERSECTIONPHASE_PHASEVALUEACTIONPAIR_METHOD_1_D0BD1377F2594D33_OFFSET UNITYSDK_OFFSET(0x17B52570)
#define RPG_CLIENT_STAGEHARMONYTRAFFICLIGHTMONOPLUGIN_INTERSECTIONPHASE_PHASEVALUEACTIONPAIR__CTOR_OFFSET UNITYSDK_OFFSET(0x17B535D0)

namespace RPG::Client
{
	inline static constexpr unsigned int StageHarmonyTrafficLightMonoPlugin_IntersectionPhase_PhaseValueActionPair_TypeDefinitionIndex = 67802;
