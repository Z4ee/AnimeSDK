...
#define RPG_CLIENT_STAGEHARMONYTRAFFICLIGHTMONOPLUGIN_INTERSECTIONPHASE_PHASEVALUEACTIONPAIR_METHOD_1_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0xB1BD990)
#define RPG_CLIENT_STAGEHARMONYTRAFFICLIGHTMONOPLUGIN_INTERSECTIONPHASE_PHASEVALUEACTIONPAIR__CTOR_OFFSET UNITYSDK_OFFSET(0xB1BE750)

namespace RPG::Client
{
	inline static constexpr unsigned int StageHarmonyTrafficLightMonoPlugin_IntersectionPhase_PhaseValueActionPair_TypeDefinitionIndex = 65450;
