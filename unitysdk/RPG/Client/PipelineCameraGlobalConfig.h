...
#define RPG_CLIENT_PIPELINECAMERAGLOBALCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19EBC150)

namespace RPG::Client
{
	inline static constexpr unsigned int PipelineCameraGlobalConfig_TypeDefinitionIndex = 66586;
