...
#define RPG_CLIENT_PIPELINECAMERAGLOBALCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C82AAB0)

namespace RPG::Client
{
	inline static constexpr unsigned int PipelineCameraGlobalConfig_TypeDefinitionIndex = 69684;
