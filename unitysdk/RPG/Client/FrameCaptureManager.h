...
#define RPG_CLIENT_FRAMECAPTUREMANAGER_CAPTUREFRAME_OFFSET UNITYSDK_OFFSET(0xA3CA350)
#define RPG_CLIENT_FRAMECAPTUREMANAGER_ISFRAMECAPTUREFULL_OFFSET UNITYSDK_OFFSET(0xA3CA2C0)
#define RPG_CLIENT_FRAMECAPTUREMANAGER_RELEASECAPTUREFRAME_OFFSET UNITYSDK_OFFSET(0xA3CA450)
#define RPG_CLIENT_FRAMECAPTUREMANAGER_STARTFRAMEBLENDING_OFFSET UNITYSDK_OFFSET(0xA3CA560)
#define RPG_CLIENT_FRAMECAPTUREMANAGER__CLEARCAPTUREFRAME_OFFSET UNITYSDK_OFFSET(0xA3CA500)
#define RPG_CLIENT_FRAMECAPTUREMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xA3CA260)

namespace RPG::Client
{
	inline static constexpr unsigned int FrameCaptureManager_TypeDefinitionIndex = 64300;
