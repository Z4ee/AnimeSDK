...
#define RPG_CLIENT_FRAMECAPTUREMANAGER_CAPTUREFRAME_OFFSET UNITYSDK_OFFSET(0xBA67390)
#define RPG_CLIENT_FRAMECAPTUREMANAGER_ISFRAMECAPTUREFULL_OFFSET UNITYSDK_OFFSET(0xBA67300)
#define RPG_CLIENT_FRAMECAPTUREMANAGER_RELEASECAPTUREFRAME_OFFSET UNITYSDK_OFFSET(0xBA67490)
#define RPG_CLIENT_FRAMECAPTUREMANAGER_STARTFRAMEBLENDING_OFFSET UNITYSDK_OFFSET(0xBA675A0)
#define RPG_CLIENT_FRAMECAPTUREMANAGER__CLEARCAPTUREFRAME_OFFSET UNITYSDK_OFFSET(0xBA67540)
#define RPG_CLIENT_FRAMECAPTUREMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xBA672A0)

namespace RPG::Client
{
	inline static constexpr unsigned int FrameCaptureManager_TypeDefinitionIndex = 65221;

	class FrameCaptureManager : public ::System::Object
	{
	public:
		::RPG::Client::FrameCaptureManager_FrameBlendingEndOPDefault* _FrameBlendingEndOp; // 0x10
		::RPG::Client::FrameCaptureManager_FrameCaptureEndOPDefault* _FrameCaptureEndOp; // 0x18
