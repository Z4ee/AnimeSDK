...
#define RPG_CLIENT_ADDNEWAVATARINFO_CREATEADDNEWAVATARINFO_OFFSET UNITYSDK_OFFSET(0x18AAA3A0)
#define RPG_CLIENT_ADDNEWAVATARINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18AAA780)

namespace RPG::Client
{
	inline static constexpr unsigned int AddNewAvatarInfo_TypeDefinitionIndex = 59700;
	...
	public:
		...
		::RPG::AvatarSystem::IAvatar* NewAvatar; // 0x20
