...
#define RPG_CLIENT_ADDNEWAVATARINFO_CREATEADDNEWAVATARINFO_OFFSET UNITYSDK_OFFSET(0xB21DAC0)
#define RPG_CLIENT_ADDNEWAVATARINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xB21DEA0)

namespace RPG::Client
{
	inline static constexpr unsigned int AddNewAvatarInfo_TypeDefinitionIndex = 58438;
