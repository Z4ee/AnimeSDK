...
class Class_2_6867D91E1C435326;
...
#define RPG_CLIENT_PIPELINECAMERAENGINE_ABORTCLOSEUPSHOTTIMELINE_OFFSET UNITYSDK_OFFSET(0x1C8299A0)
#define RPG_CLIENT_PIPELINECAMERAENGINE_CLEARCLOSEUPSHOT_OFFSET UNITYSDK_OFFSET(0x1C827960)
#define RPG_CLIENT_PIPELINECAMERAENGINE_CLEARORTHOGRAPHICLOCK_OFFSET UNITYSDK_OFFSET(0x1C827430)
#define RPG_CLIENT_PIPELINECAMERAENGINE_DISPOSEOVERRIDECONFIGS_OFFSET UNITYSDK_OFFSET(0x1C8296E0)
#define RPG_CLIENT_PIPELINECAMERAENGINE_DISPOSEPIPELINELOOKDEV_OFFSET UNITYSDK_OFFSET(0x1C8245E0)
#define RPG_CLIENT_PIPELINECAMERAENGINE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C827490)
#define RPG_CLIENT_PIPELINECAMERAENGINE_FORCEREFRESHPIPELINEMODULE_OFFSET UNITYSDK_OFFSET(0x1C828830)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GETACTIVECLOSEUPSHOTTIMELINEYLIMIT_OFFSET UNITYSDK_OFFSET(0x1C8268D0)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GETCAMERADATA_OFFSET UNITYSDK_OFFSET(0x1C826880)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GETCAMERAMODULEFIGHTMODULE_OFFSET UNITYSDK_OFFSET(0x1C826BE0)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GETFREELOOK3RDMODULECHANGEBLEND_OFFSET UNITYSDK_OFFSET(0x1C827370)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GETINHERITMONODELEGATEACTIONS_OFFSET UNITYSDK_OFFSET(0x1C829740)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GETREALMODULECONFIGBYTYPE_OFFSET UNITYSDK_OFFSET(0x1C826A40)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GETVCAMCONTROLMODULE_OFFSET UNITYSDK_OFFSET(0x1C827BE0)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GET_ADVENTURECAMERALOOKATTEMPLATE_OFFSET UNITYSDK_OFFSET(0x1C82A710)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GET_CINEMACHINEBRAINREF_OFFSET UNITYSDK_OFFSET(0x1C82A7D0)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GET_CRPVIRTUALCAMERATEMPLATEASSET_OFFSET UNITYSDK_OFFSET(0x1C82A770)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GET_CURRENTCAMERAMODE_OFFSET UNITYSDK_OFFSET(0x1C82A840)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GET_GLOBALCONFIG_OFFSET UNITYSDK_OFFSET(0x1C82A7B0)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GET_INITFOV_OFFSET UNITYSDK_OFFSET(0x1C82A640)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GET_INITIALIZED_OFFSET UNITYSDK_OFFSET(0x1C82A7E0)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GET_ISFIRSTREFRESHPIPELINEAFTERINIT_OFFSET UNITYSDK_OFFSET(0x1C82A7F0)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GET_ISFREELOOK3RDLIVE_OFFSET UNITYSDK_OFFSET(0x1C82A870)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GET_ISLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1C82A8F0)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GET_ISPAUSE_OFFSET UNITYSDK_OFFSET(0x1C8285D0)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GET_LOADEDMODULECONFIGPATH_OFFSET UNITYSDK_OFFSET(0x1C82A900)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GET_MODULECONFIG_OFFSET UNITYSDK_OFFSET(0x1C82A7C0)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GET_SHAKESOURCEMGR_OFFSET UNITYSDK_OFFSET(0x1C82A790)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GET_SKIPONEFRAME_OFFSET UNITYSDK_OFFSET(0x1C82A600)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GET_TEMPLATECONFIG_OFFSET UNITYSDK_OFFSET(0x1C82A6D0)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GET_UPDATECOUNT_OFFSET UNITYSDK_OFFSET(0x1C82A810)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GET_USECINEMACHINEZOOM_OFFSET UNITYSDK_OFFSET(0x1C82A820)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GET_VCAMERAFREELOOK3RDCONFIGCHANGETEMPLATE_OFFSET UNITYSDK_OFFSET(0x1C82A6F0)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GET_VCAMERAFREELOOK3RDTEMPLATEASSET_OFFSET UNITYSDK_OFFSET(0x1C82A750)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GET_VCAMERATEMPLATEASSET_OFFSET UNITYSDK_OFFSET(0x1C82A730)
#define RPG_CLIENT_PIPELINECAMERAENGINE_GET_VCAMINSTANCEPOOL_OFFSET UNITYSDK_OFFSET(0x1C82A620)
#define RPG_CLIENT_PIPELINECAMERAENGINE_HASOVERRIDECONFIG_OFFSET UNITYSDK_OFFSET(0x1C8269D0)
#define RPG_CLIENT_PIPELINECAMERAENGINE_INITPIPELINELOOKDEV_OFFSET UNITYSDK_OFFSET(0x1C824770)
#define RPG_CLIENT_PIPELINECAMERAENGINE_INITPIPELINE_OFFSET UNITYSDK_OFFSET(0x1C824F40)
#define RPG_CLIENT_PIPELINECAMERAENGINE_MANUALLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1C8293B0)
#define RPG_CLIENT_PIPELINECAMERAENGINE_ONLOGICUPDATE_OFFSET UNITYSDK_OFFSET(0x1C826290)
#define RPG_CLIENT_PIPELINECAMERAENGINE_OVERRIDEMODULECONFIG_OFFSET UNITYSDK_OFFSET(0x1C826AD0)
#define RPG_CLIENT_PIPELINECAMERAENGINE_PAUSECAMERAUPDATE_OFFSET UNITYSDK_OFFSET(0x1C829420)
#define RPG_CLIENT_PIPELINECAMERAENGINE_REFRESHALL_OFFSET UNITYSDK_OFFSET(0x1C8261F0)
#define RPG_CLIENT_PIPELINECAMERAENGINE_REFRESHHIDEENTITYMODULE_OFFSET UNITYSDK_OFFSET(0x1C828450)
#define RPG_CLIENT_PIPELINECAMERAENGINE_REFRESHPIPELINELOOKDEV_OFFSET UNITYSDK_OFFSET(0x1C824DC0)
#define RPG_CLIENT_PIPELINECAMERAENGINE_REFRESHPIPELINEMODULE_OFFSET UNITYSDK_OFFSET(0x1C828530)
#define RPG_CLIENT_PIPELINECAMERAENGINE_REGISTERMONODELEGATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1C829480)
#define RPG_CLIENT_PIPELINECAMERAENGINE_RELEASEMONODELEGATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1C8294F0)
#define RPG_CLIENT_PIPELINECAMERAENGINE_RELOADMODULECONFIG_OFFSET UNITYSDK_OFFSET(0x1C829560)
#define RPG_CLIENT_PIPELINECAMERAENGINE_RESETFREELOOK3RDMODULE_OFFSET UNITYSDK_OFFSET(0x1C827C90)
#define RPG_CLIENT_PIPELINECAMERAENGINE_RESETOVERRIDEMODULECONFIG_OFFSET UNITYSDK_OFFSET(0x1C826B80)
#define RPG_CLIENT_PIPELINECAMERAENGINE_SETCINEMACHINEBRAINBLENDFINISH_OFFSET UNITYSDK_OFFSET(0x1C827270)
#define RPG_CLIENT_PIPELINECAMERAENGINE_SETCINEMACHINEBRAINBLENDTYPEBYCURVE_OFFSET UNITYSDK_OFFSET(0x1C826F70)
#define RPG_CLIENT_PIPELINECAMERAENGINE_SETCINEMACHINEBRAINBLENDTYPE_1_OFFSET UNITYSDK_OFFSET(0x1C827000)
#define RPG_CLIENT_PIPELINECAMERAENGINE_SETCINEMACHINEBRAINBLENDTYPE_OFFSET UNITYSDK_OFFSET(0x1C826DD0)
#define RPG_CLIENT_PIPELINECAMERAENGINE_SETCONTROLLERAXISVALUEBYTARGETROTATION_OFFSET UNITYSDK_OFFSET(0x1C828030)
#define RPG_CLIENT_PIPELINECAMERAENGINE_SETFREELOOKLOOKAT_OFFSET UNITYSDK_OFFSET(0x1C8282D0)
#define RPG_CLIENT_PIPELINECAMERAENGINE_SETINHERITMONODELEGATEACTIONS_OFFSET UNITYSDK_OFFSET(0x1C8297F0)
#define RPG_CLIENT_PIPELINECAMERAENGINE_SETPIPELINE_OFFSET UNITYSDK_OFFSET(0x1C824EF0)
#define RPG_CLIENT_PIPELINECAMERAENGINE_SET_ADVENTURECAMERALOOKATTEMPLATE_OFFSET UNITYSDK_OFFSET(0x1C82A720)
#define RPG_CLIENT_PIPELINECAMERAENGINE_SET_CRPVIRTUALCAMERATEMPLATEASSET_OFFSET UNITYSDK_OFFSET(0x1C82A780)
#define RPG_CLIENT_PIPELINECAMERAENGINE_SET_ISFIRSTREFRESHPIPELINEAFTERINIT_OFFSET UNITYSDK_OFFSET(0x1C82A800)
#define RPG_CLIENT_PIPELINECAMERAENGINE_SET_SHAKESOURCEMGR_OFFSET UNITYSDK_OFFSET(0x1C82A7A0)
#define RPG_CLIENT_PIPELINECAMERAENGINE_SET_SKIPONEFRAME_OFFSET UNITYSDK_OFFSET(0x1C82A610)
#define RPG_CLIENT_PIPELINECAMERAENGINE_SET_TEMPLATECONFIG_OFFSET UNITYSDK_OFFSET(0x1C82A6E0)
#define RPG_CLIENT_PIPELINECAMERAENGINE_SET_USECINEMACHINEZOOM_OFFSET UNITYSDK_OFFSET(0x1C82A830)
#define RPG_CLIENT_PIPELINECAMERAENGINE_SET_VCAMERAFREELOOK3RDCONFIGCHANGETEMPLATE_OFFSET UNITYSDK_OFFSET(0x1C82A700)
#define RPG_CLIENT_PIPELINECAMERAENGINE_SET_VCAMERAFREELOOK3RDTEMPLATEASSET_OFFSET UNITYSDK_OFFSET(0x1C82A760)
#define RPG_CLIENT_PIPELINECAMERAENGINE_SET_VCAMERATEMPLATEASSET_OFFSET UNITYSDK_OFFSET(0x1C82A740)
#define RPG_CLIENT_PIPELINECAMERAENGINE_SET_VCAMINSTANCEPOOL_OFFSET UNITYSDK_OFFSET(0x1C82A630)
#define RPG_CLIENT_PIPELINECAMERAENGINE_TRYLOADALLCONFIG_OFFSET UNITYSDK_OFFSET(0x1C823E80)
#define RPG_CLIENT_PIPELINECAMERAENGINE_TRYRESETCAMERAAXISIMMEDIATELY_OFFSET UNITYSDK_OFFSET(0x1C8281D0)
#define RPG_CLIENT_PIPELINECAMERAENGINE_UNLOADALLCONFIG_OFFSET UNITYSDK_OFFSET(0x1C824200)
#define RPG_CLIENT_PIPELINECAMERAENGINE__BACKUPINPUTDATA_OFFSET UNITYSDK_OFFSET(0x1C829150)
#define RPG_CLIENT_PIPELINECAMERAENGINE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C82A9C0)
#define RPG_CLIENT_PIPELINECAMERAENGINE__CREATECAMERALOOKATTEMPLATE_OFFSET UNITYSDK_OFFSET(0x1C824490)
#define RPG_CLIENT_PIPELINECAMERAENGINE__CREATEVCAMERAFREELOOK3RDCONFIGCHANGETEMPLATE_OFFSET UNITYSDK_OFFSET(0x1C824360)
#define RPG_CLIENT_PIPELINECAMERAENGINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C82A910)
#define RPG_CLIENT_PIPELINECAMERAENGINE__DOREFRESHPIPELINEMODULE_OFFSET UNITYSDK_OFFSET(0x1C8285E0)
#define RPG_CLIENT_PIPELINECAMERAENGINE__INSPECTBATTLEFINISHFALLBACK_OFFSET UNITYSDK_OFFSET(0x1C828B10)
#define RPG_CLIENT_PIPELINECAMERAENGINE__INTERVALLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1C826310)
#define RPG_CLIENT_PIPELINECAMERAENGINE__ONACTIVEENTITYCHANGE_OFFSET UNITYSDK_OFFSET(0x1C829B10)
#define RPG_CLIENT_PIPELINECAMERAENGINE__ONLATEUPDATEAFTERRESETTOFIGHTNORMAL_OFFSET UNITYSDK_OFFSET(0x1C828C60)
#define RPG_CLIENT_PIPELINECAMERAENGINE__ONREALCAMERACHANGE_OFFSET UNITYSDK_OFFSET(0x1C829C20)
#define RPG_CLIENT_PIPELINECAMERAENGINE__ONTEAMLEADERSWITCHED_OFFSET UNITYSDK_OFFSET(0x1C829BC0)
#define RPG_CLIENT_PIPELINECAMERAENGINE__ONWORLDSHIFTING_OFFSET UNITYSDK_OFFSET(0x1C829C80)
#define RPG_CLIENT_PIPELINECAMERAENGINE__REGIST_OFFSET UNITYSDK_OFFSET(0x1C826090)
#define RPG_CLIENT_PIPELINECAMERAENGINE__RESETTOFIGHTNORMALMODE_OFFSET UNITYSDK_OFFSET(0x1C8288D0)
#define RPG_CLIENT_PIPELINECAMERAENGINE__UNREGIST_OFFSET UNITYSDK_OFFSET(0x1C8277B0)

namespace RPG::Client
{
	inline static constexpr unsigned int PipelineCameraEngine_TypeDefinitionIndex = 69681;

	class PipelineCameraEngine : public ::UnityEngine::MonoBehaviour
	{
	public:
		static ::System::Int32* StaticGet_SSRWorldShiftFrameId()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(PipelineCameraEngine_TypeDefinitionIndex)->GetStaticField(0x12F90);
		}
		...
		{
			return ((::System::Void(*)())((::PBYTE)hIl2Cpp + RPG_CLIENT_PIPELINECAMERAENGINE__CCTOR_OFFSET))();
		}
		...
		::System::Void SetPipeline(::Il2CppArray<::Class_1_4A7F3B1CD6560F7E*>* a1)
		{
			return ((::System::Void(*)(::PVOID, ::Il2CppArray<::Class_1_4A7F3B1CD6560F7E*>*))((::PBYTE)hIl2Cpp + RPG_CLIENT_PIPELINECAMERAENGINE_SETPIPELINE_OFFSET))(this, a1);
		}
		...
		::System::Nullable_1<::System::Single> GetActiveCloseupShotTimelineYLimit()
		{
			return ((::System::Nullable_1<::System::Single>(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_PIPELINECAMERAENGINE_GETACTIVECLOSEUPSHOTTIMELINEYLIMIT_OFFSET))(this);
		}
		...
		::Class_2_4C3F9D9CF221EFEC* GetCameraModuleFightModule()
		{
			return ((::Class_2_4C3F9D9CF221EFEC*(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_PIPELINECAMERAENGINE_GETCAMERAMODULEFIGHTMODULE_OFFSET))(this);
		}
