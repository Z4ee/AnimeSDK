...
#define RPG_CLIENT_AVATARRANKCONTROL_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x9154E80)
#define RPG_CLIENT_AVATARRANKCONTROL_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x9154CB0)
#define RPG_CLIENT_AVATARRANKCONTROL_ONENABLE_OFFSET UNITYSDK_OFFSET(0x9154D00)
#define RPG_CLIENT_AVATARRANKCONTROL_SETRANKTEXTURES_OFFSET UNITYSDK_OFFSET(0x91547B0)
#define RPG_CLIENT_AVATARRANKCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x9155AD0)
#define RPG_CLIENT_AVATARRANKCONTROL__GETTEXTUREPATH_OFFSET UNITYSDK_OFFSET(0x9154BD0)
#define RPG_CLIENT_AVATARRANKCONTROL__RELEASETEXTUREASSET_OFFSET UNITYSDK_OFFSET(0x9154980)

namespace RPG::Client
{
	inline static constexpr unsigned int AvatarRankControl_TypeDefinitionIndex = 58184;
