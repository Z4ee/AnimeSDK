...
#define RPG_CLIENT_CHARACTERHEADPULLBACKIK_PROCESSIK_OFFSET UNITYSDK_OFFSET(0x9305E00)
#define RPG_CLIENT_CHARACTERHEADPULLBACKIK__CTOR_OFFSET UNITYSDK_OFFSET(0x9306460)

namespace RPG::Client
{
	inline static constexpr unsigned int CharacterHeadPullBackIK_TypeDefinitionIndex = 55817;
