...
#define RPG_CLIENT_BATTLEGAMEPHASE___C__DISPLAYCLASS59_0__CTOR_OFFSET UNITYSDK_OFFSET(0x174A0EF0)
#define RPG_CLIENT_BATTLEGAMEPHASE___C__DISPLAYCLASS59_0__TRYRESTARTGAME_B__0_OFFSET UNITYSDK_OFFSET(0x174B4F70)
#define RPG_CLIENT_BATTLEGAMEPHASE___C__DISPLAYCLASS59_0__TRYRESTARTGAME_B__1_OFFSET UNITYSDK_OFFSET(0x174B4FA0)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleGamePhase___c__DisplayClass59_0_TypeDefinitionIndex = 58238;
