...
#define RPG_CLIENT_IRIRUNTIMESTATE_INIT_OFFSET UNITYSDK_OFFSET(0x17962BA0)
#define RPG_CLIENT_IRIRUNTIMESTATE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x17962B40)
#define RPG_CLIENT_IRIRUNTIMESTATE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x17962AE0)
#define RPG_CLIENT_IRIRUNTIMESTATE_UNINIT_OFFSET UNITYSDK_OFFSET(0x17962C10)
#define RPG_CLIENT_IRIRUNTIMESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x17962C60)

namespace RPG::Client
{
	inline static constexpr unsigned int IRIRuntimeState_TypeDefinitionIndex = 65820;

	class IRIRuntimeState : public ::UnityEngine::MonoBehaviour
	{
	public:
		::Class_2_250DE1D032671F25* Field_5_0; // 0x18
