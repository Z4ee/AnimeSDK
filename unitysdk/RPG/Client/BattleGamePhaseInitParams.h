...
#define RPG_CLIENT_BATTLEGAMEPHASEINITPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x174B5560)
...
namespace RPG::Client
{
	...
	{
	public:
		::RPG::Client::Map* ADVMap; // 0x10
		::RPG::GameCore::BattleAreaReferenceInfo* BattleAreaInfo; // 0x18
		::System::Object* ExtraData; // 0x20
		::RPG::GameCore::BattleLineupData* LineupData; // 0x28
		::System::String* BattleSceneName; // 0x30
		::System::UInt32 FloorID; // 0x38
		::System::Int32 LogicRandomSeed; // 0x3C
		::RPG::Client::GamePhaseType FromPhaseType; // 0x40
		::System::UInt32 RoundsLimit; // 0x44
		::System::Boolean DirectKillBattle; // 0x48
		::System::Boolean IsForceLoadScene; // 0x49
		::System::Boolean Simulate; // 0x4A
		::System::Boolean AutoBattleAtStart; // 0x4B
		::System::UInt32 BattleID; // 0x4C
		::System::Boolean EncryptTime; // 0x50
		::System::Boolean IsClientBattle; // 0x51
		::UnityEngine::Vector3 CoordinatePos; // 0x54
		::System::Boolean IsShowBattleUI; // 0x60
		::System::Boolean TriggerBattleFromDevPage; // 0x61
		::System::Boolean IsFromRestart; // 0x62
		::System::Int32 RestartCount; // 0x64
		::System::UInt32 PlanID; // 0x68
