...
#define RPG_CLIENT_LOOPLISTVIEWANIMATIONSNAP_UPDATE_OFFSET UNITYSDK_OFFSET(0xD5904F0)
#define RPG_CLIENT_LOOPLISTVIEWANIMATIONSNAP__CTOR_OFFSET UNITYSDK_OFFSET(0xD5907B0)
#define RPG_CLIENT_LOOPLISTVIEWANIMATIONSNAP__UPDATEITEMANIMSTATE_OFFSET UNITYSDK_OFFSET(0xD590560)
