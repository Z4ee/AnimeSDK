...
#define RPG_CLIENT_LOOPLISTVIEWANIMATIONSNAP_UPDATE_OFFSET UNITYSDK_OFFSET(0x9A6D8F0)
#define RPG_CLIENT_LOOPLISTVIEWANIMATIONSNAP__CTOR_OFFSET UNITYSDK_OFFSET(0x9A6DC30)
#define RPG_CLIENT_LOOPLISTVIEWANIMATIONSNAP__UPDATEITEMANIMSTATE_OFFSET UNITYSDK_OFFSET(0x9A6D960)

namespace RPG::Client
{
	inline static constexpr unsigned int LoopListViewAnimationSnap_TypeDefinitionIndex = 56378;
