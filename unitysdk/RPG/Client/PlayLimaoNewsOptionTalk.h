...
#define RPG_CLIENT_PLAYLIMAONEWSOPTIONTALK_METHOD_3_570329A0FC2B4A05_OFFSET UNITYSDK_OFFSET(0x193BC390)
#define RPG_CLIENT_PLAYLIMAONEWSOPTIONTALK_METHOD_3_936C50083A1FD7D4_OFFSET UNITYSDK_OFFSET(0x193BC410)
#define RPG_CLIENT_PLAYLIMAONEWSOPTIONTALK__CTOR_OFFSET UNITYSDK_OFFSET(0x193BC3E0)

namespace RPG::Client
{
	inline static constexpr unsigned int PlayLimaoNewsOptionTalk_TypeDefinitionIndex = 9924;
