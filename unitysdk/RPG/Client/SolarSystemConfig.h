...
#define RPG_CLIENT_SOLARSYSTEMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xA4A3660)

namespace RPG::Client
{
	inline static constexpr unsigned int SolarSystemConfig_TypeDefinitionIndex = 57073;
