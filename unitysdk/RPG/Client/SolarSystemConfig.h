...
#define RPG_CLIENT_SOLARSYSTEMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18906B80)

namespace RPG::Client
{
	inline static constexpr unsigned int SolarSystemConfig_TypeDefinitionIndex = 66655;
