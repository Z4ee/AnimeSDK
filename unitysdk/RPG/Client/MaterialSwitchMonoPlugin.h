...
#define RPG_CLIENT_MATERIALSWITCHMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xA8772F0)

namespace RPG::Client
{
	inline static constexpr unsigned int MaterialSwitchMonoPlugin_TypeDefinitionIndex = 65213;
