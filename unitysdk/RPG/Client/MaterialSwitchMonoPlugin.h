...
#define RPG_CLIENT_MATERIALSWITCHMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1B21D9F0)

namespace RPG::Client
{
	inline static constexpr unsigned int MaterialSwitchMonoPlugin_TypeDefinitionIndex = 70688;
