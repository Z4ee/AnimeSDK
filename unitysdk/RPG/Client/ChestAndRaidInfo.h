...
#define RPG_CLIENT_CHESTANDRAIDINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x9FF3B30)

namespace RPG::Client
{
	inline static constexpr unsigned int ChestAndRaidInfo_TypeDefinitionIndex = 61131;
