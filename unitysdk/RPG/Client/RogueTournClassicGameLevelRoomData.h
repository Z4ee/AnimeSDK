...
#define RPG_CLIENT_ROGUETOURNCLASSICGAMELEVELROOMDATA_GETDEBUGINFO_OFFSET UNITYSDK_OFFSET(0x19C19B20)
#define RPG_CLIENT_ROGUETOURNCLASSICGAMELEVELROOMDATA_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x19C19D30)
#define RPG_CLIENT_ROGUETOURNCLASSICGAMELEVELROOMDATA_GET_MARKTYPE_OFFSET UNITYSDK_OFFSET(0x19C19C40)
#define RPG_CLIENT_ROGUETOURNCLASSICGAMELEVELROOMDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19C19CD0)
#define RPG_CLIENT_ROGUETOURNCLASSICGAMELEVELROOMDATA_GET_ROOMID_OFFSET UNITYSDK_OFFSET(0x19C19B70)
#define RPG_CLIENT_ROGUETOURNCLASSICGAMELEVELROOMDATA_GET_ROOMINDEX_OFFSET UNITYSDK_OFFSET(0x19C19BB0)
#define RPG_CLIENT_ROGUETOURNCLASSICGAMELEVELROOMDATA_GET_ROOMTYPE_OFFSET UNITYSDK_OFFSET(0x19C19BF0)
#define RPG_CLIENT_ROGUETOURNCLASSICGAMELEVELROOMDATA_GET_STATUS_OFFSET UNITYSDK_OFFSET(0x19C19C90)
#define RPG_CLIENT_ROGUETOURNCLASSICGAMELEVELROOMDATA_GET_TOASTICONPATH_OFFSET UNITYSDK_OFFSET(0x19C19D80)
#define RPG_CLIENT_ROGUETOURNCLASSICGAMELEVELROOMDATA_SYNC_OFFSET UNITYSDK_OFFSET(0x19C199A0)
#define RPG_CLIENT_ROGUETOURNCLASSICGAMELEVELROOMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19C194A0)
...
namespace RPG::Client
{
	...
	public:
		...
		::Enum_3_DB663931210BBC27_61 _Status; // 0x20
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_C9DFE5EE7107C629_16*))((::PBYTE)hIl2Cpp + RPG_CLIENT_ROGUETOURNCLASSICGAMELEVELROOMDATA_SYNC_OFFSET))(this, a1);
		}
