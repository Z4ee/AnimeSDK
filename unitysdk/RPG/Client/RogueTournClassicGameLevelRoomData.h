...
#define RPG_CLIENT_ROGUETOURNCLASSICGAMELEVELROOMDATA_GETDEBUGINFO_OFFSET UNITYSDK_OFFSET(0xC80B1E0)
#define RPG_CLIENT_ROGUETOURNCLASSICGAMELEVELROOMDATA_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xC80B2D0)
#define RPG_CLIENT_ROGUETOURNCLASSICGAMELEVELROOMDATA_GET_MARKTYPE_OFFSET UNITYSDK_OFFSET(0xC80B270)
#define RPG_CLIENT_ROGUETOURNCLASSICGAMELEVELROOMDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xC80B2A0)
#define RPG_CLIENT_ROGUETOURNCLASSICGAMELEVELROOMDATA_GET_ROOMID_OFFSET UNITYSDK_OFFSET(0xC80B230)
#define RPG_CLIENT_ROGUETOURNCLASSICGAMELEVELROOMDATA_GET_ROOMINDEX_OFFSET UNITYSDK_OFFSET(0xC80B240)
#define RPG_CLIENT_ROGUETOURNCLASSICGAMELEVELROOMDATA_GET_ROOMTYPE_OFFSET UNITYSDK_OFFSET(0xC80B250)
#define RPG_CLIENT_ROGUETOURNCLASSICGAMELEVELROOMDATA_GET_STATUS_OFFSET UNITYSDK_OFFSET(0xC80B290)
#define RPG_CLIENT_ROGUETOURNCLASSICGAMELEVELROOMDATA_GET_TOASTICONPATH_OFFSET UNITYSDK_OFFSET(0xC80B2F0)
#define RPG_CLIENT_ROGUETOURNCLASSICGAMELEVELROOMDATA_SYNC_OFFSET UNITYSDK_OFFSET(0xC80B060)
#define RPG_CLIENT_ROGUETOURNCLASSICGAMELEVELROOMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC80AD70)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueTournClassicGameLevelRoomData_TypeDefinitionIndex = 63269;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_02098A44CBBFEEE1_2*))((::PBYTE)hIl2Cpp + RPG_CLIENT_ROGUETOURNCLASSICGAMELEVELROOMDATA_SYNC_OFFSET))(this, a1);
		}
