...
#define RPG_CLIENT_AIRSHIPCARAUDIO_GET_DISTANCETOPLAYER_OFFSET UNITYSDK_OFFSET(0x90949E0)
#define RPG_CLIENT_AIRSHIPCARAUDIO_GET_DISTANCETOTANGENT_OFFSET UNITYSDK_OFFSET(0x9094A20)
#define RPG_CLIENT_AIRSHIPCARAUDIO_GET_ENABLELISTENER_OFFSET UNITYSDK_OFFSET(0x9094A40)
#define RPG_CLIENT_AIRSHIPCARAUDIO_GET_SPEED_OFFSET UNITYSDK_OFFSET(0x9094A00)
#define RPG_CLIENT_AIRSHIPCARAUDIO_INIT_OFFSET UNITYSDK_OFFSET(0x9094AB0)
#define RPG_CLIENT_AIRSHIPCARAUDIO_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x9094D20)
#define RPG_CLIENT_AIRSHIPCARAUDIO_ONENABLE_OFFSET UNITYSDK_OFFSET(0x9094A50)
#define RPG_CLIENT_AIRSHIPCARAUDIO_SET_DISTANCETOPLAYER_OFFSET UNITYSDK_OFFSET(0x90949F0)
#define RPG_CLIENT_AIRSHIPCARAUDIO_SET_DISTANCETOTANGENT_OFFSET UNITYSDK_OFFSET(0x9094A30)
#define RPG_CLIENT_AIRSHIPCARAUDIO_SET_SPEED_OFFSET UNITYSDK_OFFSET(0x9094A10)
#define RPG_CLIENT_AIRSHIPCARAUDIO_TICK_OFFSET UNITYSDK_OFFSET(0x9094F30)
#define RPG_CLIENT_AIRSHIPCARAUDIO_TRIGGERAVOID_OFFSET UNITYSDK_OFFSET(0x90952A0)
#define RPG_CLIENT_AIRSHIPCARAUDIO_TRIGGERSHUTDOWN_OFFSET UNITYSDK_OFFSET(0x90954C0)
#define RPG_CLIENT_AIRSHIPCARAUDIO_TRIGGERSTARTUP_OFFSET UNITYSDK_OFFSET(0x90953B0)
#define RPG_CLIENT_AIRSHIPCARAUDIO_UNINIT_OFFSET UNITYSDK_OFFSET(0x9094E20)
#define RPG_CLIENT_AIRSHIPCARAUDIO__CTOR_OFFSET UNITYSDK_OFFSET(0x90955D0)

namespace RPG::Client
{
	inline static constexpr unsigned int AirshipCarAudio_TypeDefinitionIndex = 48427;
