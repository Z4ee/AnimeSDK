...
#define RPG_CLIENT_STAGEHARMONYSIGNALDYNAMICPATTERNMONOPLUGIN_DUMP_OFFSET UNITYSDK_OFFSET(0x1A4EBF90)
#define RPG_CLIENT_STAGEHARMONYSIGNALDYNAMICPATTERNMONOPLUGIN_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x1A4EC560)
#define RPG_CLIENT_STAGEHARMONYSIGNALDYNAMICPATTERNMONOPLUGIN_LOAD_OFFSET UNITYSDK_OFFSET(0x1A4EBC90)
#define RPG_CLIENT_STAGEHARMONYSIGNALDYNAMICPATTERNMONOPLUGIN_UNLOAD_OFFSET UNITYSDK_OFFSET(0x1A4EBF40)
#define RPG_CLIENT_STAGEHARMONYSIGNALDYNAMICPATTERNMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4EC5B0)

namespace RPG::Client
{
	inline static constexpr unsigned int StageHarmonySignalDynamicPatternMonoPlugin_TypeDefinitionIndex = 70966;
