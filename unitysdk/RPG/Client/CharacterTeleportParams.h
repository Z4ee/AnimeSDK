...
#define RPG_CLIENT_CHARACTERTELEPORTPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x930DF30)

namespace RPG::Client
{
	inline static constexpr unsigned int CharacterTeleportParams_TypeDefinitionIndex = 48713;
