...
#define RPG_CLIENT_PAMCHATQUESTIONRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0xC32F1C0)

namespace RPG::Client
{
	inline static constexpr unsigned int PamChatQuestionResult_TypeDefinitionIndex = 59223;
