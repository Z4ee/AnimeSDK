...
#define RPG_CLIENT_FIVEDIMMODULE_ADD_ONMONEYWEEKLYLIMITREACHED_OFFSET UNITYSDK_OFFSET(0x96F06A0)
#define RPG_CLIENT_FIVEDIMMODULE_APPLYFLUTE_OFFSET UNITYSDK_OFFSET(0x96EEA10)
#define RPG_CLIENT_FIVEDIMMODULE_CHENLINGCAPTUREFRAME_OFFSET UNITYSDK_OFFSET(0x96EB3C0)
#define RPG_CLIENT_FIVEDIMMODULE_CLEARNETWORKDATA_OFFSET UNITYSDK_OFFSET(0x96F26F0)
#define RPG_CLIENT_FIVEDIMMODULE_CLOSETRANSITIONVIEW_OFFSET UNITYSDK_OFFSET(0x96E9690)
#define RPG_CLIENT_FIVEDIMMODULE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x96F4980)
#define RPG_CLIENT_FIVEDIMMODULE_ENTERCHENLINGGAMEBOYINSTANCE_OFFSET UNITYSDK_OFFSET(0x96ED690)
#define RPG_CLIENT_FIVEDIMMODULE_ENTERCHENLINGGAMEBOY_OFFSET UNITYSDK_OFFSET(0x96EC9A0)
#define RPG_CLIENT_FIVEDIMMODULE_EXITCHENLINGGAMEBOYINSTANCE_OFFSET UNITYSDK_OFFSET(0x96EDB30)
#define RPG_CLIENT_FIVEDIMMODULE_EXITFIVEDIMGAME_OFFSET UNITYSDK_OFFSET(0x96E71B0)
#define RPG_CLIENT_FIVEDIMMODULE_EXITTYPETONETWORKLEAVETYPE_OFFSET UNITYSDK_OFFSET(0x96F1DB0)
#define RPG_CLIENT_FIVEDIMMODULE_FETCHPLAYERJUMPDISPLAYINFO_OFFSET UNITYSDK_OFFSET(0x96F4860)
#define RPG_CLIENT_FIVEDIMMODULE_FETCHPLAYERSKILLDISPLAYINFO_OFFSET UNITYSDK_OFFSET(0x96F4100)
#define RPG_CLIENT_FIVEDIMMODULE_FETCHPLAYERSRANKINGINFO_OFFSET UNITYSDK_OFFSET(0x96ED440)
#define RPG_CLIENT_FIVEDIMMODULE_FETCHTRAINMODEDISPLAYINFOS_OFFSET UNITYSDK_OFFSET(0x96F3CE0)
#define RPG_CLIENT_FIVEDIMMODULE_FINISHFIVEDIMACHIEVEMENT_OFFSET UNITYSDK_OFFSET(0x96F5430)
#define RPG_CLIENT_FIVEDIMMODULE_FINISHFIVEDIMMINIGAME_OFFSET UNITYSDK_OFFSET(0x96EF280)
#define RPG_CLIENT_FIVEDIMMODULE_FINISHFLUTE_OFFSET UNITYSDK_OFFSET(0x96EE940)
#define RPG_CLIENT_FIVEDIMMODULE_GETCHENLINGGAMEBOYPUZZLEDATA_OFFSET UNITYSDK_OFFSET(0x96ECE30)
#define RPG_CLIENT_FIVEDIMMODULE_GETMINIGAMEHIGHSCORE_OFFSET UNITYSDK_OFFSET(0x96EF9D0)
#define RPG_CLIENT_FIVEDIMMODULE_GETMINIGAMEID_OFFSET UNITYSDK_OFFSET(0x96EFDE0)
#define RPG_CLIENT_FIVEDIMMODULE_GETMINIGAMEONETIMEREWARDS_1_OFFSET UNITYSDK_OFFSET(0x96F01B0)
#define RPG_CLIENT_FIVEDIMMODULE_GETMINIGAMEONETIMEREWARDS_OFFSET UNITYSDK_OFFSET(0x96F0100)
#define RPG_CLIENT_FIVEDIMMODULE_GETMINIGAMEPREVIEWREWARDS_OFFSET UNITYSDK_OFFSET(0x96F0390)
#define RPG_CLIENT_FIVEDIMMODULE_GETMINIGAMESCORETARGETS_OFFSET UNITYSDK_OFFSET(0x96EFF30)
#define RPG_CLIENT_FIVEDIMMODULE_GETSETTLEMENTTEXTURE_OFFSET UNITYSDK_OFFSET(0x96EE560)
#define RPG_CLIENT_FIVEDIMMODULE_GET_CANUSECAMERAOBSERVE_OFFSET UNITYSDK_OFFSET(0x96F55F0)
#define RPG_CLIENT_FIVEDIMMODULE_GET_CHENLINGGAMEBOYPUZZLEDATA_OFFSET UNITYSDK_OFFSET(0x96ED3D0)
#define RPG_CLIENT_FIVEDIMMODULE_GET_CURRENTGAMEINSTANCE_OFFSET UNITYSDK_OFFSET(0x96F55C0)
#define RPG_CLIENT_FIVEDIMMODULE_GET_CURRENTPLAYER2DINFO_OFFSET UNITYSDK_OFFSET(0x96F3B60)
#define RPG_CLIENT_FIVEDIMMODULE_GET_FIVEDIMJOYSTICKDEBUGSHOW_OFFSET UNITYSDK_OFFSET(0x96F5AA0)
#define RPG_CLIENT_FIVEDIMMODULE_GET_GAMEDIFFICULTY_OFFSET UNITYSDK_OFFSET(0x96F5650)
#define RPG_CLIENT_FIVEDIMMODULE_GET_GAMELEVELCONFIG_OFFSET UNITYSDK_OFFSET(0x96F56B0)
#define RPG_CLIENT_FIVEDIMMODULE_GET_INPUTJOYSTICKTYPE_OFFSET UNITYSDK_OFFSET(0x96F59F0)
#define RPG_CLIENT_FIVEDIMMODULE_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x96D9E40)
#define RPG_CLIENT_FIVEDIMMODULE_GET_INWALLREVERSEINPUTCD_OFFSET UNITYSDK_OFFSET(0x96F58A0)
#define RPG_CLIENT_FIVEDIMMODULE_GET_ISINFIVEDIMGAME_OFFSET UNITYSDK_OFFSET(0x96E73A0)
#define RPG_CLIENT_FIVEDIMMODULE_GET_ISMONEYWEEKLYLIMITREACHED_OFFSET UNITYSDK_OFFSET(0x96F11D0)
#define RPG_CLIENT_FIVEDIMMODULE_GET_MAXJUMPENERGY_OFFSET UNITYSDK_OFFSET(0x96F55E0)
#define RPG_CLIENT_FIVEDIMMODULE_GET_MONEYITEMID_OFFSET UNITYSDK_OFFSET(0x96F0FF0)
#define RPG_CLIENT_FIVEDIMMODULE_GET_MONEYNUM_OFFSET UNITYSDK_OFFSET(0x96F10D0)
#define RPG_CLIENT_FIVEDIMMODULE_GET_MONEYWEEKLYLIMIT_OFFSET UNITYSDK_OFFSET(0x96F0CA0)
#define RPG_CLIENT_FIVEDIMMODULE_GET_MONEYWEEKLYNUM_OFFSET UNITYSDK_OFFSET(0x96F11B0)
#define RPG_CLIENT_FIVEDIMMODULE_GET_MOVECONFIG_OFFSET UNITYSDK_OFFSET(0x96F5770)
#define RPG_CLIENT_FIVEDIMMODULE_GET_MOVEINPUTDEADZONE_OFFSET UNITYSDK_OFFSET(0x96F57D0)
#define RPG_CLIENT_FIVEDIMMODULE_GET_MOVEINPUTHORIZONTALANGLE_OFFSET UNITYSDK_OFFSET(0x96F5980)
#define RPG_CLIENT_FIVEDIMMODULE_GET_OUTWALLREVERSEINPUTCD_OFFSET UNITYSDK_OFFSET(0x96F5910)
#define RPG_CLIENT_FIVEDIMMODULE_GET_PENDINGPLAYER2DINFO_OFFSET UNITYSDK_OFFSET(0x96F3BC0)
#define RPG_CLIENT_FIVEDIMMODULE_GET_PENDINGPLAYER3DINFO_OFFSET UNITYSDK_OFFSET(0x96F3C80)
#define RPG_CLIENT_FIVEDIMMODULE_GET_PENDINGSERVERPLAYER2DINFO_OFFSET UNITYSDK_OFFSET(0x96F3C20)
#define RPG_CLIENT_FIVEDIMMODULE_GET_PLAYERSKILLUPGRADED_OFFSET UNITYSDK_OFFSET(0x96F4500)
#define RPG_CLIENT_FIVEDIMMODULE_GET_PUZZLEDATA_OFFSET UNITYSDK_OFFSET(0x96F3CC0)
#define RPG_CLIENT_FIVEDIMMODULE_GET_SHOULDREVERSEINPUTDEADZONE_OFFSET UNITYSDK_OFFSET(0x96F5840)
#define RPG_CLIENT_FIVEDIMMODULE_GET_SIDEPUZZLETARGETDATA_OFFSET UNITYSDK_OFFSET(0x96F5A70)
#define RPG_CLIENT_FIVEDIMMODULE_GET_SKILLPANELCONFIGID_OFFSET UNITYSDK_OFFSET(0x96F4370)
#define RPG_CLIENT_FIVEDIMMODULE_GET_USEDIRECTIONBTN_OFFSET UNITYSDK_OFFSET(0x96F5A60)
#define RPG_CLIENT_FIVEDIMMODULE_GET_USEPOLARCOORDINATES_OFFSET UNITYSDK_OFFSET(0x96F5A90)
#define RPG_CLIENT_FIVEDIMMODULE_GET__DEFAULTSKILLPANELCONFIGID_OFFSET UNITYSDK_OFFSET(0x96F4420)
#define RPG_CLIENT_FIVEDIMMODULE_INIT_OFFSET UNITYSDK_OFFSET(0x96F3D40)
#define RPG_CLIENT_FIVEDIMMODULE_INVOKEREACHMAXTIMELIMITSEQUENCE_OFFSET UNITYSDK_OFFSET(0x96EE280)
#define RPG_CLIENT_FIVEDIMMODULE_ISFLUTEAPPLIED_OFFSET UNITYSDK_OFFSET(0x96EED00)
#define RPG_CLIENT_FIVEDIMMODULE_ISFLUTEBUTTONENABLE_OFFSET UNITYSDK_OFFSET(0x96EE8F0)
#define RPG_CLIENT_FIVEDIMMODULE_ISFLUTEFINISHED_OFFSET UNITYSDK_OFFSET(0x96EE840)
#define RPG_CLIENT_FIVEDIMMODULE_ISFLUTEVALID_OFFSET UNITYSDK_OFFSET(0x96EE7D0)
#define RPG_CLIENT_FIVEDIMMODULE_LEAVECHENLINGGAMEBOYINSTANCE_OFFSET UNITYSDK_OFFSET(0x96EDC80)
#define RPG_CLIENT_FIVEDIMMODULE_NOTIFYDISPLAYREWARDS_OFFSET UNITYSDK_OFFSET(0x96F0E60)
#define RPG_CLIENT_FIVEDIMMODULE_ONENTERGAME_OFFSET UNITYSDK_OFFSET(0x96E2560)
#define RPG_CLIENT_FIVEDIMMODULE_ONEXITCHENLINGGAMEBOYGAMEENTRANCE_OFFSET UNITYSDK_OFFSET(0x96EE0D0)
#define RPG_CLIENT_FIVEDIMMODULE_ONEXITGAME_OFFSET UNITYSDK_OFFSET(0x96E3040)
#define RPG_CLIENT_FIVEDIMMODULE_OPENTRANSITIONVIEW_OFFSET UNITYSDK_OFFSET(0x96E9550)
#define RPG_CLIENT_FIVEDIMMODULE_RECOVERMINIGAMEFCV_OFFSET UNITYSDK_OFFSET(0x96F0560)
#define RPG_CLIENT_FIVEDIMMODULE_RELEASEFRAME_OFFSET UNITYSDK_OFFSET(0x96EE5A0)
#define RPG_CLIENT_FIVEDIMMODULE_REMOVE_ONMONEYWEEKLYLIMITREACHED_OFFSET UNITYSDK_OFFSET(0x96F0710)
#define RPG_CLIENT_FIVEDIMMODULE_REQUESTADDMONEY_OFFSET UNITYSDK_OFFSET(0x96F0780)
#define RPG_CLIENT_FIVEDIMMODULE_REQUESTENTERGAME_OFFSET UNITYSDK_OFFSET(0x96F1560)
#define RPG_CLIENT_FIVEDIMMODULE_REQUESTGAMEDATA_OFFSET UNITYSDK_OFFSET(0x96F1CC0)
#define RPG_CLIENT_FIVEDIMMODULE_REQUESTLEAVEGAME_OFFSET UNITYSDK_OFFSET(0x96E77F0)
#define RPG_CLIENT_FIVEDIMMODULE_REQUESTNETWORKFINISHCHENLINGGAMEBOY_OFFSET UNITYSDK_OFFSET(0x96ED0A0)
#define RPG_CLIENT_FIVEDIMMODULE_REQUESTTRANSFER_OFFSET UNITYSDK_OFFSET(0x96F22A0)
#define RPG_CLIENT_FIVEDIMMODULE_REQUESTUPDATEPLAYEREXTRAABILITY_OFFSET UNITYSDK_OFFSET(0x96F1FD0)
#define RPG_CLIENT_FIVEDIMMODULE_REQUESTUPDATETWODIMPLAYERINFO_OFFSET UNITYSDK_OFFSET(0x96F1E10)
#define RPG_CLIENT_FIVEDIMMODULE_REQUIRECHENLINGGAMEBOYDATA_OFFSET UNITYSDK_OFFSET(0x96ED010)
#define RPG_CLIENT_FIVEDIMMODULE_RESETCHENLINGGAMEBOYINSTANCE_OFFSET UNITYSDK_OFFSET(0x96ED910)
#define RPG_CLIENT_FIVEDIMMODULE_SENDCHENLINGCHEATINPUTKEYREQ_OFFSET UNITYSDK_OFFSET(0x96F25C0)
#define RPG_CLIENT_FIVEDIMMODULE_SENDCHENLINGCHEATMODEREQ_OFFSET UNITYSDK_OFFSET(0x96F2650)
#define RPG_CLIENT_FIVEDIMMODULE_SENDCHENLINGGAMEBOYCHANGESETTINGSCSREQ_OFFSET UNITYSDK_OFFSET(0x96F2190)
#define RPG_CLIENT_FIVEDIMMODULE_SETCHENLINGGAMEBOYTIMEPAUSED_OFFSET UNITYSDK_OFFSET(0x96EE1B0)
#define RPG_CLIENT_FIVEDIMMODULE_SETCURRENTACTIVEFLUTEID_OFFSET UNITYSDK_OFFSET(0x96EE8A0)
#define RPG_CLIENT_FIVEDIMMODULE_SETMAXJUMPENERGY_OFFSET UNITYSDK_OFFSET(0x96F36F0)
#define RPG_CLIENT_FIVEDIMMODULE_SETMOVEABILITYENABLED_OFFSET UNITYSDK_OFFSET(0x96F4010)
#define RPG_CLIENT_FIVEDIMMODULE_SETPLAYERSKILLUPGRADED_OFFSET UNITYSDK_OFFSET(0x96F4090)
#define RPG_CLIENT_FIVEDIMMODULE_SET_CURRENTGAMEINSTANCE_OFFSET UNITYSDK_OFFSET(0x96F55D0)
#define RPG_CLIENT_FIVEDIMMODULE_SET_CURRENTPLAYER2DINFO_OFFSET UNITYSDK_OFFSET(0x96F3B90)
#define RPG_CLIENT_FIVEDIMMODULE_SET_FIVEDIMJOYSTICKDEBUGSHOW_OFFSET UNITYSDK_OFFSET(0x96F5AB0)
#define RPG_CLIENT_FIVEDIMMODULE_SET_INPUTJOYSTICKTYPE_OFFSET UNITYSDK_OFFSET(0x96F5A00)
#define RPG_CLIENT_FIVEDIMMODULE_SET_ISMONEYWEEKLYLIMITREACHED_OFFSET UNITYSDK_OFFSET(0x96F11E0)
#define RPG_CLIENT_FIVEDIMMODULE_SET_MONEYNUM_OFFSET UNITYSDK_OFFSET(0x96F0BF0)
#define RPG_CLIENT_FIVEDIMMODULE_SET_MONEYWEEKLYNUM_OFFSET UNITYSDK_OFFSET(0x96F11C0)
#define RPG_CLIENT_FIVEDIMMODULE_SET_PENDINGPLAYER2DINFO_OFFSET UNITYSDK_OFFSET(0x96F3BF0)
#define RPG_CLIENT_FIVEDIMMODULE_SET_PENDINGPLAYER3DINFO_OFFSET UNITYSDK_OFFSET(0x96F3CA0)
#define RPG_CLIENT_FIVEDIMMODULE_SET_PENDINGSERVERPLAYER2DINFO_OFFSET UNITYSDK_OFFSET(0x96F3C50)
#define RPG_CLIENT_FIVEDIMMODULE_SET_PUZZLEDATA_OFFSET UNITYSDK_OFFSET(0x96F3CD0)
#define RPG_CLIENT_FIVEDIMMODULE_SET_SIDEPUZZLETARGETDATA_OFFSET UNITYSDK_OFFSET(0x96F5A80)
#define RPG_CLIENT_FIVEDIMMODULE_TRYAUTOSHOW_OFFSET UNITYSDK_OFFSET(0x96F4560)
#define RPG_CLIENT_FIVEDIMMODULE__ADDMINIGAMEPACKEDHANDLERS_OFFSET UNITYSDK_OFFSET(0x96EF550)
#define RPG_CLIENT_FIVEDIMMODULE__ADDNOTIFYHANDLERS_OFFSET UNITYSDK_OFFSET(0x96F4BF0)
#define RPG_CLIENT_FIVEDIMMODULE__ADDPACKETHANDLERS_OFFSET UNITYSDK_OFFSET(0x96F11F0)
#define RPG_CLIENT_FIVEDIMMODULE__CREATELITTLEWHEELSELECTCONFIG_OFFSET UNITYSDK_OFFSET(0x96F4A20)
#define RPG_CLIENT_FIVEDIMMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0x96F5B10)
#define RPG_CLIENT_FIVEDIMMODULE__EXECUTEENTERGAMESEQUENCE_OFFSET UNITYSDK_OFFSET(0x96EE610)
#define RPG_CLIENT_FIVEDIMMODULE__EXECUTEEXITGAMESEQUENCE_OFFSET UNITYSDK_OFFSET(0x96EE6F0)
#define RPG_CLIENT_FIVEDIMMODULE__FROMNETWORKDATA_OFFSET UNITYSDK_OFFSET(0x96F2C40)
#define RPG_CLIENT_FIVEDIMMODULE__FROMPROTOPOSITION_OFFSET UNITYSDK_OFFSET(0x96F3A10)
#define RPG_CLIENT_FIVEDIMMODULE__FROMPROTOROTATION_OFFSET UNITYSDK_OFFSET(0x96F3AA0)
#define RPG_CLIENT_FIVEDIMMODULE__GETSCREENRECT_OFFSET UNITYSDK_OFFSET(0x96EE360)
#define RPG_CLIENT_FIVEDIMMODULE__INITGAMECONFIG_OFFSET UNITYSDK_OFFSET(0x96F3FC0)
#define RPG_CLIENT_FIVEDIMMODULE__LEAVECHENLINGGAMEBOYINSTANCE_OFFSET UNITYSDK_OFFSET(0x96EDCD0)
#define RPG_CLIENT_FIVEDIMMODULE__LOADGAMECONFIG_OFFSET UNITYSDK_OFFSET(0x96F5280)
#define RPG_CLIENT_FIVEDIMMODULE__NOTIFYDISPLAYREWARDS_OFFSET UNITYSDK_OFFSET(0x96F0EB0)
#define RPG_CLIENT_FIVEDIMMODULE__ONADVENTUREPHASEEND_OFFSET UNITYSDK_OFFSET(0x96F50F0)
#define RPG_CLIENT_FIVEDIMMODULE__ONCHENLINGGAMEBOYGETFRIENDRANKINGINFOSCRSP_OFFSET UNITYSDK_OFFSET(0x96F33F0)
#define RPG_CLIENT_FIVEDIMMODULE__ONENTERFIVEDIMGAMESCRSP_OFFSET UNITYSDK_OFFSET(0x96F2780)
#define RPG_CLIENT_FIVEDIMMODULE__ONFINISHCHENLINGGAMEBOYSCRSP_OFFSET UNITYSDK_OFFSET(0x96F34B0)
#define RPG_CLIENT_FIVEDIMMODULE__ONFINISHFIVEDIMMINIGAMESCRSP_OFFSET UNITYSDK_OFFSET(0x96EF600)
#define RPG_CLIENT_FIVEDIMMODULE__ONFIVEDIMFLUTEDATACHANGENOTIFY_OFFSET UNITYSDK_OFFSET(0x96EF130)
#define RPG_CLIENT_FIVEDIMMODULE__ONFIVEDIMGAMEDATAUPDATESCNOTIFY_OFFSET UNITYSDK_OFFSET(0x96F28A0)
#define RPG_CLIENT_FIVEDIMMODULE__ONFIVEDIMGAMETRANSFERSCRSP_OFFSET UNITYSDK_OFFSET(0x96F2E10)
#define RPG_CLIENT_FIVEDIMMODULE__ONFIVEDIMJUMPENERGYCHANGESCNOTIFY_OFFSET UNITYSDK_OFFSET(0x96F3740)
#define RPG_CLIENT_FIVEDIMMODULE__ONFIVEDIMMONEYCHANGESCNOTIFY_OFFSET UNITYSDK_OFFSET(0x96F0D80)
#define RPG_CLIENT_FIVEDIMMODULE__ONFIVEDIMONMAINPAGERETURNTOP_OFFSET UNITYSDK_OFFSET(0x96F5140)
#define RPG_CLIENT_FIVEDIMMODULE__ONGETCHENLINGGAMEBOYDATASCRSP_OFFSET UNITYSDK_OFFSET(0x96F3330)
#define RPG_CLIENT_FIVEDIMMODULE__ONGETFIVEDIMFLUTEDATASCRSP_OFFSET UNITYSDK_OFFSET(0x96EEFE0)
#define RPG_CLIENT_FIVEDIMMODULE__ONGETFIVEDIMGAMEDATASCRSP_OFFSET UNITYSDK_OFFSET(0x96F3650)
#define RPG_CLIENT_FIVEDIMMODULE__ONGETFIVEDIMMINIGAMEDATASCRSP_OFFSET UNITYSDK_OFFSET(0x96EFB10)
#define RPG_CLIENT_FIVEDIMMODULE__ONGETFIVEDIMMONEYDATASCRSP_OFFSET UNITYSDK_OFFSET(0x96F0B60)
#define RPG_CLIENT_FIVEDIMMODULE__ONGETFIVEDIMMONEYSCRSP_OFFSET UNITYSDK_OFFSET(0x96F08F0)
#define RPG_CLIENT_FIVEDIMMODULE__ONHIDESIDEPUZZLETARGET_OFFSET UNITYSDK_OFFSET(0x96F4FA0)
#define RPG_CLIENT_FIVEDIMMODULE__ONLEAVEFIVEDIMGAMESCRSP_OFFSET UNITYSDK_OFFSET(0x96F2F30)
#define RPG_CLIENT_FIVEDIMMODULE__ONMAPCREATED_OFFSET UNITYSDK_OFFSET(0x96F5190)
#define RPG_CLIENT_FIVEDIMMODULE__ONSHOWSIDEPUZZLETARGET_OFFSET UNITYSDK_OFFSET(0x96F4EE0)
#define RPG_CLIENT_FIVEDIMMODULE__ONUPDATEFIVEDIMGAMEDATASCRSP_OFFSET UNITYSDK_OFFSET(0x96F3240)
#define RPG_CLIENT_FIVEDIMMODULE__ONUPDATESIDEPUZZLETARGET_OFFSET UNITYSDK_OFFSET(0x96F4FF0)
#define RPG_CLIENT_FIVEDIMMODULE__REQUESTQUITCHENLINGGAMEBOY_OFFSET UNITYSDK_OFFSET(0x96EDBE0)
#define RPG_CLIENT_FIVEDIMMODULE__RESETCHENLINGGAMEBOYINSTANCE_OFFSET UNITYSDK_OFFSET(0x96EDA90)
#define RPG_CLIENT_FIVEDIMMODULE__SENDMINIGAMEINITREQUEST_OFFSET UNITYSDK_OFFSET(0x96EFA60)
#define RPG_CLIENT_FIVEDIMMODULE__SENDMONEYINITREQUEST_OFFSET UNITYSDK_OFFSET(0x96F0840)
#define RPG_CLIENT_FIVEDIMMODULE__SETCAMERARECT_OFFSET UNITYSDK_OFFSET(0x96EE4E0)
#define RPG_CLIENT_FIVEDIMMODULE__SHOWDISPLAYREWARDS_OFFSET UNITYSDK_OFFSET(0x96F0970)
#define RPG_CLIENT_FIVEDIMMODULE__TONETWORKDATA_1_OFFSET UNITYSDK_OFFSET(0x96F1880)
#define RPG_CLIENT_FIVEDIMMODULE__TONETWORKDATA_2_OFFSET UNITYSDK_OFFSET(0x96F1900)
#define RPG_CLIENT_FIVEDIMMODULE__TONETWORKDATA_3_OFFSET UNITYSDK_OFFSET(0x96F1A10)
#define RPG_CLIENT_FIVEDIMMODULE__TONETWORKDATA_4_OFFSET UNITYSDK_OFFSET(0x96F3980)
#define RPG_CLIENT_FIVEDIMMODULE__TONETWORKDATA_OFFSET UNITYSDK_OFFSET(0x96F37E0)
#define RPG_CLIENT_FIVEDIMMODULE__TRYUPDATECLIENTPOSVERSION_OFFSET UNITYSDK_OFFSET(0x96F29E0)
#define RPG_CLIENT_FIVEDIMMODULE___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x96F5D90)
#define RPG_CLIENT_FIVEDIMMODULE___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0x96F5D00)
#define RPG_CLIENT_FIVEDIMMODULE___IFIXBASEPROXY__ADDNOTIFYHANDLERS_OFFSET UNITYSDK_OFFSET(0x96F5DA0)
#define RPG_CLIENT_FIVEDIMMODULE___IFIXBASEPROXY__ADDPACKETHANDLERS_OFFSET UNITYSDK_OFFSET(0x96F5CA0)
...
namespace RPG::Client
{
	...
	public:
		...
		::Class_3_5775A4FEC79026BC* _ExitChenLingGameSequence; // 0x10
		::Class_3_5775A4FEC79026BC* _ReachMaxTimeLimitSequence; // 0x18
		::System::Collections::Generic::HashSet_1<::System::UInt32>* ValidTeleportFluteIDs; // 0x20
		::RPG::Client::LittleGame::FiveDim::FiveDimFluteDataManager* FluteDataManager; // 0x28
		::System::Collections::Generic::HashSet_1<::System::UInt32>* FinishedFluteIDs; // 0x30
		::System::Action_1<::Class_1_FA4F4A67B1C04320_312*>* OnLeaveFiveDimGameScRsp; // 0x38
		...
		::RPG::Client::UIFrameCapture* _FrameCapture; // 0x48
		::Class_1_43BD383C98B4C0C5_134* _PuzzleData_k__BackingField; // 0x50
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::UInt32>* _MiniGameHighScores; // 0x58
		::RPG::Client::LittleGame::FiveDim::SidePuzzleTargetData* _SidePuzzleTargetData_k__BackingField; // 0x60
		::System::Action_1<::Class_1_FA4F4A67B1C04320_314*>* OnFiveDimGameTransferScRsp; // 0x68
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::Client::ChenLingGameBoy::ChenLingGameBoyPuzzleData*>* _ChenLingGameBoyPuzzleDataDir; // 0x70
		::UnityEngine::Texture* _SettlementTexture; // 0x78
		::Class_3_5775A4FEC79026BC* _EnterChenLingGameSequence; // 0x80
		::RPG::Client::FiveDimGameInstance* _CurrentGameInstance_k__BackingField; // 0x88
		::System::String* GameSerialNumber; // 0x90
		::RPG::GameCore::FiveDimGameConfig* _GameConfig; // 0x98
		::System::Action_1<::Class_1_FA4F4A67B1C04320_311*>* OnEnterFiveDimGameScRsp; // 0xA0
		::Class_3_5775A4FEC79026BC* _ExitSequence; // 0xA8
		::System::Action_1<::System::Boolean>* OnMoneyWeeklyLimitReached; // 0xB0
		::System::UInt32 CurrentActiveFluteID; // 0xB8
		::System::UInt32 _InputJoyStickType; // 0xBC
		::System::UInt32 _MoneyWeeklyNum_k__BackingField; // 0xC0
		::Struct_2_F01DF3CDCF3FD7AC _CurrentPlayer2DInfo_k__BackingField; // 0xC4
		::System::UInt32 _FiveDimInputID; // 0xF0
		::RPG::Client::FiveDimModule_OverridableVariable_1<::RPG::GameCore::FiveDimAvatarMoveAbility> _MoveAbility; // 0xF4
		::System::Nullable_1<::Struct_2_F01DF3CDCF3FD7AC> _PendingServerPlayer2DInfo_k__BackingField; // 0x100
		::Struct_2_F01DF3CDCF3FD7AC _PendingPlayer2DInfo_k__BackingField; // 0x130
		::System::Nullable_1<::Struct_2_FC595D1A561D8C6F> _PendingPlayer3DInfo_k__BackingField; // 0x15C
		::System::Int32 _TimerIndex; // 0x17C
		::RPG::Client::FiveDimTransitionStatus TransitionStatus; // 0x180
		::System::Single _CaptureFrameRadio; // 0x184
		::System::UInt32 _MaxJumpEnergy; // 0x188
		::System::Boolean IncontrolUseDeadZoneValue; // 0x18C
		::System::Boolean _IsMoneyWeeklyLimitReached_k__BackingField; // 0x18D
		::System::Boolean _FiveDimJoyStickDebugShow; // 0x18E
		::System::UInt32 _RewardShowCount; // 0x190
