...
#define RPG_CLIENT_UIVIRTUALCAMERACONTROLLER_ACTIVEVIRTUALCAMERA_OFFSET UNITYSDK_OFFSET(0x1831FB20)
#define RPG_CLIENT_UIVIRTUALCAMERACONTROLLER_DEACTIVEVIRTUALCAMERA_OFFSET UNITYSDK_OFFSET(0x183203C0)
#define RPG_CLIENT_UIVIRTUALCAMERACONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18320600)
#define RPG_CLIENT_UIVIRTUALCAMERACONTROLLER__SETUPBLENDCONFIG_OFFSET UNITYSDK_OFFSET(0x183202A0)

namespace RPG::Client
{
	inline static constexpr unsigned int UIVirtualCameraController_TypeDefinitionIndex = 66044;
