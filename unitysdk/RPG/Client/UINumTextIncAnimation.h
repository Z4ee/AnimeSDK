...
#define RPG_CLIENT_UINUMTEXTINCANIMATION_ADDDIGIT_OFFSET UNITYSDK_OFFSET(0xE3927F0)
#define RPG_CLIENT_UINUMTEXTINCANIMATION_CLEARDIGITS_OFFSET UNITYSDK_OFFSET(0xE3928D0)
#define RPG_CLIENT_UINUMTEXTINCANIMATION_GET_CURVALUE_OFFSET UNITYSDK_OFFSET(0xE392980)
#define RPG_CLIENT_UINUMTEXTINCANIMATION_GET_ISPLAYING_OFFSET UNITYSDK_OFFSET(0xE392970)
#define RPG_CLIENT_UINUMTEXTINCANIMATION_PLAY_OFFSET UNITYSDK_OFFSET(0xE392790)
#define RPG_CLIENT_UINUMTEXTINCANIMATION_SETFORMATTEXT_OFFSET UNITYSDK_OFFSET(0xE392740)
#define RPG_CLIENT_UINUMTEXTINCANIMATION_START_OFFSET UNITYSDK_OFFSET(0xE392100)
#define RPG_CLIENT_UINUMTEXTINCANIMATION_STOP_OFFSET UNITYSDK_OFFSET(0xE3926F0)
#define RPG_CLIENT_UINUMTEXTINCANIMATION_UPDATE_OFFSET UNITYSDK_OFFSET(0xE3921D0)
#define RPG_CLIENT_UINUMTEXTINCANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0xE392990)
#define RPG_CLIENT_UINUMTEXTINCANIMATION__UPDATEDIGITS_OFFSET UNITYSDK_OFFSET(0xE392490)
#define RPG_CLIENT_UINUMTEXTINCANIMATION__UPDATENUMBER_OFFSET UNITYSDK_OFFSET(0xE3922D0)
