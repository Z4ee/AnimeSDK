...
#define RPG_CLIENT_UINUMTEXTINCANIMATION_ADDDIGIT_OFFSET UNITYSDK_OFFSET(0x17B6D120)
#define RPG_CLIENT_UINUMTEXTINCANIMATION_CLEARDIGITS_OFFSET UNITYSDK_OFFSET(0x17B6D200)
#define RPG_CLIENT_UINUMTEXTINCANIMATION_GET_CURVALUE_OFFSET UNITYSDK_OFFSET(0x17B6D2B0)
#define RPG_CLIENT_UINUMTEXTINCANIMATION_GET_ISPLAYING_OFFSET UNITYSDK_OFFSET(0x17B6D2A0)
#define RPG_CLIENT_UINUMTEXTINCANIMATION_PLAY_OFFSET UNITYSDK_OFFSET(0x17B6D0C0)
#define RPG_CLIENT_UINUMTEXTINCANIMATION_SETFORMATTEXT_OFFSET UNITYSDK_OFFSET(0x17B6D070)
#define RPG_CLIENT_UINUMTEXTINCANIMATION_START_OFFSET UNITYSDK_OFFSET(0x17B6CA30)
#define RPG_CLIENT_UINUMTEXTINCANIMATION_STOP_OFFSET UNITYSDK_OFFSET(0x17B6D020)
#define RPG_CLIENT_UINUMTEXTINCANIMATION_UPDATE_OFFSET UNITYSDK_OFFSET(0x17B6CB00)
#define RPG_CLIENT_UINUMTEXTINCANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x17B6D2C0)
#define RPG_CLIENT_UINUMTEXTINCANIMATION__UPDATEDIGITS_OFFSET UNITYSDK_OFFSET(0x17B6CDC0)
#define RPG_CLIENT_UINUMTEXTINCANIMATION__UPDATENUMBER_OFFSET UNITYSDK_OFFSET(0x17B6CC00)

namespace RPG::Client
{
	inline static constexpr unsigned int UINumTextIncAnimation_TypeDefinitionIndex = 69073;
