...
#define RPG_CLIENT_MONOTRAVELSHIPJOYSTICKPROVIDER_TRAVELSHIPPRESSSTATE_ENTER_OFFSET UNITYSDK_OFFSET(0x1A35A1D0)
#define RPG_CLIENT_MONOTRAVELSHIPJOYSTICKPROVIDER_TRAVELSHIPPRESSSTATE_EXIT_OFFSET UNITYSDK_OFFSET(0x1A35A6B0)
#define RPG_CLIENT_MONOTRAVELSHIPJOYSTICKPROVIDER_TRAVELSHIPPRESSSTATE_TICK_OFFSET UNITYSDK_OFFSET(0x1A35A2B0)
#define RPG_CLIENT_MONOTRAVELSHIPJOYSTICKPROVIDER_TRAVELSHIPPRESSSTATE__CHECKINBOUNDRYVEC2_OFFSET UNITYSDK_OFFSET(0x1A35A4D0)
#define RPG_CLIENT_MONOTRAVELSHIPJOYSTICKPROVIDER_TRAVELSHIPPRESSSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A35A1C0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoTravelShipJoyStickProvider_TravelShipPressState_TypeDefinitionIndex = 58586;
