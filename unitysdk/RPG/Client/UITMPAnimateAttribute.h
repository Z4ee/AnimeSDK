...
#define RPG_CLIENT_UITMPANIMATEATTRIBUTE_GET_MAT_OFFSET UNITYSDK_OFFSET(0xCB9C630)
#define RPG_CLIENT_UITMPANIMATEATTRIBUTE_INIT_OFFSET UNITYSDK_OFFSET(0xCB94830)
#define RPG_CLIENT_UITMPANIMATEATTRIBUTE_ONENABLE_OFFSET UNITYSDK_OFFSET(0xCB9C530)
#define RPG_CLIENT_UITMPANIMATEATTRIBUTE_TMPMATPROPERTIESUPDATE_OFFSET UNITYSDK_OFFSET(0xCB94920)
#define RPG_CLIENT_UITMPANIMATEATTRIBUTE_UPDATE_OFFSET UNITYSDK_OFFSET(0xCB9C5E0)
#define RPG_CLIENT_UITMPANIMATEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0xCB9C6E0)

namespace RPG::Client
{
	inline static constexpr unsigned int UITMPAnimateAttribute_TypeDefinitionIndex = 66130;
