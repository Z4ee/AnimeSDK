...
#define RPG_CLIENT_UITMPANIMATEATTRIBUTE_METHOD_5_19844080C13BA28F_OFFSET UNITYSDK_OFFSET(0x17B993F0)
#define RPG_CLIENT_UITMPANIMATEATTRIBUTE_METHOD_5_4EA6B1791DACA9CC_OFFSET UNITYSDK_OFFSET(0x17B99A90)
#define RPG_CLIENT_UITMPANIMATEATTRIBUTE_METHOD_5_507ECF0ACFA5483C_OFFSET UNITYSDK_OFFSET(0x17B9A2C0)
#define RPG_CLIENT_UITMPANIMATEATTRIBUTE_METHOD_5_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0x17B998F0)
#define RPG_CLIENT_UITMPANIMATEATTRIBUTE_METHOD_5_D799715F2EF979EA_OFFSET UNITYSDK_OFFSET(0x17B99A20)
#define RPG_CLIENT_UITMPANIMATEATTRIBUTE_METHOD_5_DFCD85BB4714F8C7_OFFSET UNITYSDK_OFFSET(0x17B99DD0)
#define RPG_CLIENT_UITMPANIMATEATTRIBUTE_METHOD_5_F5447CD65612575D_OFFSET UNITYSDK_OFFSET(0x17B99880)
#define RPG_CLIENT_UITMPANIMATEATTRIBUTE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x17B99190)
#define RPG_CLIENT_UITMPANIMATEATTRIBUTE_REFRESHFONTMATREF_OFFSET UNITYSDK_OFFSET(0x17B99260)
#define RPG_CLIENT_UITMPANIMATEATTRIBUTE_SETQUADSCALE_OFFSET UNITYSDK_OFFSET(0x17B92390)
#define RPG_CLIENT_UITMPANIMATEATTRIBUTE_TMPMATPROPERTIESUPDATE_OFFSET UNITYSDK_OFFSET(0x17B99740)
#define RPG_CLIENT_UITMPANIMATEATTRIBUTE_UPDATE_OFFSET UNITYSDK_OFFSET(0x17B996F0)
#define RPG_CLIENT_UITMPANIMATEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x17B9A410)
