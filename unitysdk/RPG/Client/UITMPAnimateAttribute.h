...
#define RPG_CLIENT_UITMPANIMATEATTRIBUTE_GET_MAT_OFFSET UNITYSDK_OFFSET(0xB43C300)
#define RPG_CLIENT_UITMPANIMATEATTRIBUTE_INIT_OFFSET UNITYSDK_OFFSET(0xB4343C0)
#define RPG_CLIENT_UITMPANIMATEATTRIBUTE_ONENABLE_OFFSET UNITYSDK_OFFSET(0xB43C200)
#define RPG_CLIENT_UITMPANIMATEATTRIBUTE_TMPMATPROPERTIESUPDATE_OFFSET UNITYSDK_OFFSET(0xB4344B0)
#define RPG_CLIENT_UITMPANIMATEATTRIBUTE_UPDATE_OFFSET UNITYSDK_OFFSET(0xB43C2B0)
#define RPG_CLIENT_UITMPANIMATEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0xB43C3B0)

namespace RPG::Client
{
	inline static constexpr unsigned int UITMPAnimateAttribute_TypeDefinitionIndex = 65203;
