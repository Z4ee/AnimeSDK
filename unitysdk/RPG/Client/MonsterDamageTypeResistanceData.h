...
#define RPG_CLIENT_MONSTERDAMAGETYPERESISTANCEDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xD8BA600)
#define RPG_CLIENT_MONSTERDAMAGETYPERESISTANCEDATA_GET_DAMAGETYPE_OFFSET UNITYSDK_OFFSET(0xD8BAA20)
#define RPG_CLIENT_MONSTERDAMAGETYPERESISTANCEDATA_GET_DESC_OFFSET UNITYSDK_OFFSET(0xD8BAA00)
#define RPG_CLIENT_MONSTERDAMAGETYPERESISTANCEDATA_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xD8BA9E0)
#define RPG_CLIENT_MONSTERDAMAGETYPERESISTANCEDATA_SET_DAMAGETYPE_OFFSET UNITYSDK_OFFSET(0xD8BAA30)
#define RPG_CLIENT_MONSTERDAMAGETYPERESISTANCEDATA_SET_DESC_OFFSET UNITYSDK_OFFSET(0xD8BAA10)
#define RPG_CLIENT_MONSTERDAMAGETYPERESISTANCEDATA_SET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xD8BA9F0)
#define RPG_CLIENT_MONSTERDAMAGETYPERESISTANCEDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0xD8BAA40)
#define RPG_CLIENT_MONSTERDAMAGETYPERESISTANCEDATA__CREATEHIGHRESISTANCEDATA_OFFSET UNITYSDK_OFFSET(0xD8BA840)
#define RPG_CLIENT_MONSTERDAMAGETYPERESISTANCEDATA__CREATERESISTANCEDATA_OFFSET UNITYSDK_OFFSET(0xD8BA730)
#define RPG_CLIENT_MONSTERDAMAGETYPERESISTANCEDATA__CREATE_OFFSET UNITYSDK_OFFSET(0xD8BA950)
#define RPG_CLIENT_MONSTERDAMAGETYPERESISTANCEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD8BA9D0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonsterDamageTypeResistanceData_TypeDefinitionIndex = 71720;
	...
	public:
		...
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(MonsterDamageTypeResistanceData_TypeDefinitionIndex)->GetStaticField(0x9CC0);
		}
		static ::System::Single* StaticGet__HightResistanceThreshold()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(MonsterDamageTypeResistanceData_TypeDefinitionIndex)->GetStaticField(0x9CC4);
		}
