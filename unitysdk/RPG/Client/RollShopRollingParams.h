...
#define RPG_CLIENT_ROLLSHOPROLLINGPARAMS_GET_DISPLAYITEMS_OFFSET UNITYSDK_OFFSET(0x16A1CA80)
#define RPG_CLIENT_ROLLSHOPROLLINGPARAMS_GET_REWARDGROUPTYPE_OFFSET UNITYSDK_OFFSET(0x16A1CA70)
#define RPG_CLIENT_ROLLSHOPROLLINGPARAMS_GET_ROLLSHOPID_OFFSET UNITYSDK_OFFSET(0x16A1CA50)
#define RPG_CLIENT_ROLLSHOPROLLINGPARAMS_GET_WALKNUM_OFFSET UNITYSDK_OFFSET(0x16A1CA60)
#define RPG_CLIENT_ROLLSHOPROLLINGPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x16A1CA90)

namespace RPG::Client
{
	inline static constexpr unsigned int RollShopRollingParams_TypeDefinitionIndex = 67890;
	...
	public:
		...
		::System::UInt32 _RollShopID_k__BackingField; // 0x18
