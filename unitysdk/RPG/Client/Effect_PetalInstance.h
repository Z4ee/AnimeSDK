...
#define RPG_CLIENT_EFFECT_PETALINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x15E8E410)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_PetalInstance_TypeDefinitionIndex = 70494;
