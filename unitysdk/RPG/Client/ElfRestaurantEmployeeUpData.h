...
#define RPG_CLIENT_ELFRESTAURANTEMPLOYEEUPDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xCE673C0)
#define RPG_CLIENT_ELFRESTAURANTEMPLOYEEUPDATA_GET_ABILITIES_OFFSET UNITYSDK_OFFSET(0xCE64B90)
#define RPG_CLIENT_ELFRESTAURANTEMPLOYEEUPDATA_GET_ABILITYDATALIST_OFFSET UNITYSDK_OFFSET(0xCE67580)
#define RPG_CLIENT_ELFRESTAURANTEMPLOYEEUPDATA_GET_EMPLOYEEUPID_OFFSET UNITYSDK_OFFSET(0xCE67430)
#define RPG_CLIENT_ELFRESTAURANTEMPLOYEEUPDATA_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0xCE67450)
#define RPG_CLIENT_ELFRESTAURANTEMPLOYEEUPDATA_GET_ORDINARYABILITYDATA_OFFSET UNITYSDK_OFFSET(0xCE67780)
#define RPG_CLIENT_ELFRESTAURANTEMPLOYEEUPDATA_GET_UPGRADEPRICE_OFFSET UNITYSDK_OFFSET(0xCE67470)
#define RPG_CLIENT_ELFRESTAURANTEMPLOYEEUPDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xCE67510)
#define RPG_CLIENT_ELFRESTAURANTEMPLOYEEUPDATA_SET_EMPLOYEEUPID_OFFSET UNITYSDK_OFFSET(0xCE67440)
#define RPG_CLIENT_ELFRESTAURANTEMPLOYEEUPDATA_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0xCE67460)
#define RPG_CLIENT_ELFRESTAURANTEMPLOYEEUPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCE67420)
