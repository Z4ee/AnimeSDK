...
#define RPG_CLIENT_ELFRESTAURANTEMPLOYEEUPDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xA24F340)
#define RPG_CLIENT_ELFRESTAURANTEMPLOYEEUPDATA_GET_ABILITIES_OFFSET UNITYSDK_OFFSET(0xA24F2C0)
#define RPG_CLIENT_ELFRESTAURANTEMPLOYEEUPDATA_GET_ABILITYDATALIST_OFFSET UNITYSDK_OFFSET(0xA24EF00)
#define RPG_CLIENT_ELFRESTAURANTEMPLOYEEUPDATA_GET_EMPLOYEEUPID_OFFSET UNITYSDK_OFFSET(0xA2522F0)
#define RPG_CLIENT_ELFRESTAURANTEMPLOYEEUPDATA_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0xA252310)
#define RPG_CLIENT_ELFRESTAURANTEMPLOYEEUPDATA_GET_ORDINARYABILITYDATA_OFFSET UNITYSDK_OFFSET(0xA24EA00)
#define RPG_CLIENT_ELFRESTAURANTEMPLOYEEUPDATA_GET_UPGRADEPRICE_OFFSET UNITYSDK_OFFSET(0xA24E5C0)
#define RPG_CLIENT_ELFRESTAURANTEMPLOYEEUPDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xA252330)
#define RPG_CLIENT_ELFRESTAURANTEMPLOYEEUPDATA_SET_EMPLOYEEUPID_OFFSET UNITYSDK_OFFSET(0xA252300)
#define RPG_CLIENT_ELFRESTAURANTEMPLOYEEUPDATA_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0xA252320)
#define RPG_CLIENT_ELFRESTAURANTEMPLOYEEUPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA2522E0)

namespace RPG::Client
{
	inline static constexpr unsigned int ElfRestaurantEmployeeUpData_TypeDefinitionIndex = 58659;

	class ElfRestaurantEmployeeUpData : public ::System::Object
	{
	public:
		::System::Collections::Generic::List_1<::RPG::Client::ElfAbilityData*>* _AbilityDataList; // 0x10
		::RPG::Client::ElfAbilityData* _OrdinaryAbilityData; // 0x18
		::System::UInt32 _EmployeeUpID_k__BackingField; // 0x20
