...
#define RPG_CLIENT_CHIMERABATTLERECORDDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x9FF8690)
#define RPG_CLIENT_CHIMERABATTLERECORDDATA_GETCHIMERACHIMERARECORD_OFFSET UNITYSDK_OFFSET(0x9FF8BA0)
#define RPG_CLIENT_CHIMERABATTLERECORDDATA_GETCHIMERAWORKRECORD_OFFSET UNITYSDK_OFFSET(0x9FF8CF0)
#define RPG_CLIENT_CHIMERABATTLERECORDDATA_GET_CHIMERARECORDS_OFFSET UNITYSDK_OFFSET(0x9FF9170)
#define RPG_CLIENT_CHIMERABATTLERECORDDATA_GET_COSTTIMEINSECONDS_OFFSET UNITYSDK_OFFSET(0x9FF91B0)
#define RPG_CLIENT_CHIMERABATTLERECORDDATA_GET_STARTBATTLETIMESTAMP_OFFSET UNITYSDK_OFFSET(0x9FF9270)
#define RPG_CLIENT_CHIMERABATTLERECORDDATA_GET_TOTALAUTOTURNS_OFFSET UNITYSDK_OFFSET(0x9FF9210)
#define RPG_CLIENT_CHIMERABATTLERECORDDATA_GET_TOTALDAMAGETOWORK_OFFSET UNITYSDK_OFFSET(0x9FF9230)
#define RPG_CLIENT_CHIMERABATTLERECORDDATA_GET_TOTALQUICKERAUTOTURNS_OFFSET UNITYSDK_OFFSET(0x9FF91F0)
#define RPG_CLIENT_CHIMERABATTLERECORDDATA_GET_TOTALQUICKERTURNS_OFFSET UNITYSDK_OFFSET(0x9FF91D0)
#define RPG_CLIENT_CHIMERABATTLERECORDDATA_GET_TOTALTURNS_OFFSET UNITYSDK_OFFSET(0x9FF9250)
#define RPG_CLIENT_CHIMERABATTLERECORDDATA_GET_WORKRECORDS_OFFSET UNITYSDK_OFFSET(0x9FF9190)
#define RPG_CLIENT_CHIMERABATTLERECORDDATA_SET_CHIMERARECORDS_OFFSET UNITYSDK_OFFSET(0x9FF9180)
#define RPG_CLIENT_CHIMERABATTLERECORDDATA_SET_COSTTIMEINSECONDS_OFFSET UNITYSDK_OFFSET(0x9FF91C0)
#define RPG_CLIENT_CHIMERABATTLERECORDDATA_SET_STARTBATTLETIMESTAMP_OFFSET UNITYSDK_OFFSET(0x9FF9280)
#define RPG_CLIENT_CHIMERABATTLERECORDDATA_SET_TOTALAUTOTURNS_OFFSET UNITYSDK_OFFSET(0x9FF9220)
#define RPG_CLIENT_CHIMERABATTLERECORDDATA_SET_TOTALDAMAGETOWORK_OFFSET UNITYSDK_OFFSET(0x9FF9240)
#define RPG_CLIENT_CHIMERABATTLERECORDDATA_SET_TOTALQUICKERAUTOTURNS_OFFSET UNITYSDK_OFFSET(0x9FF9200)
#define RPG_CLIENT_CHIMERABATTLERECORDDATA_SET_TOTALQUICKERTURNS_OFFSET UNITYSDK_OFFSET(0x9FF91E0)
#define RPG_CLIENT_CHIMERABATTLERECORDDATA_SET_TOTALTURNS_OFFSET UNITYSDK_OFFSET(0x9FF9260)
#define RPG_CLIENT_CHIMERABATTLERECORDDATA_SET_WORKRECORDS_OFFSET UNITYSDK_OFFSET(0x9FF91A0)
#define RPG_CLIENT_CHIMERABATTLERECORDDATA_TURNUPDATE_OFFSET UNITYSDK_OFFSET(0x9FF8E40)
#define RPG_CLIENT_CHIMERABATTLERECORDDATA_UPDATEDAMAGETOWORK_OFFSET UNITYSDK_OFFSET(0x9FF9120)
#define RPG_CLIENT_CHIMERABATTLERECORDDATA_WRITETOREQ_OFFSET UNITYSDK_OFFSET(0x9FF8B50)
#define RPG_CLIENT_CHIMERABATTLERECORDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9FF8940)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::UInt32 _TotalTurns_k__BackingField; // 0x20
		...
		::System::UInt32 _CostTimeInSeconds_k__BackingField; // 0x38
