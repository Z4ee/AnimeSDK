...
#define RPG_CLIENT_MAP_ONMAPOBJECTSUPDATEREQUESTFINISH_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xA7D2E30)
#define RPG_CLIENT_MAP_ONMAPOBJECTSUPDATEREQUESTFINISH_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xA7D2E60)
#define RPG_CLIENT_MAP_ONMAPOBJECTSUPDATEREQUESTFINISH_INVOKE_OFFSET UNITYSDK_OFFSET(0xA7D0B90)
#define RPG_CLIENT_MAP_ONMAPOBJECTSUPDATEREQUESTFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0xA7D2E10)
