...
#define RPG_CLIENT_WHEEL_FINALIZE_OFFSET UNITYSDK_OFFSET(0xA7851C0)
#define RPG_CLIENT_WHEEL_METHOD_1_0BDFAC56E6B704CB_OFFSET UNITYSDK_OFFSET(0xA784990)
#define RPG_CLIENT_WHEEL_METHOD_1_2450CFC043E97F54_OFFSET UNITYSDK_OFFSET(0xA7850D0)
#define RPG_CLIENT_WHEEL_METHOD_1_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0xA785160)
#define RPG_CLIENT_WHEEL_METHOD_1_515AB539783606E0_OFFSET UNITYSDK_OFFSET(0xA784610)
#define RPG_CLIENT_WHEEL_METHOD_1_8853398907028921_OFFSET UNITYSDK_OFFSET(0xA784460)
#define RPG_CLIENT_WHEEL_METHOD_1_8C4F5769C49BF3B7_OFFSET UNITYSDK_OFFSET(0xA7845B0)
#define RPG_CLIENT_WHEEL_METHOD_1_A9DAF3FE2888211B_OFFSET UNITYSDK_OFFSET(0xA7847F0)
#define RPG_CLIENT_WHEEL_METHOD_1_D4E1804C25B5032C_OFFSET UNITYSDK_OFFSET(0xA7847A0)
#define RPG_CLIENT_WHEEL_METHOD_1_E7EF6BC52B28648C_OFFSET UNITYSDK_OFFSET(0xA785000)
#define RPG_CLIENT_WHEEL_METHOD_1_ED7D428BE58A1065_OFFSET UNITYSDK_OFFSET(0xA784B50)
#define RPG_CLIENT_WHEEL__CTOR_OFFSET UNITYSDK_OFFSET(0xA7843D0)

namespace RPG::Client
{
	inline static constexpr unsigned int Wheel_TypeDefinitionIndex = 57963;
