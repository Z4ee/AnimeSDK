...
#define RPG_CLIENT_WHEEL_FINALIZE_OFFSET UNITYSDK_OFFSET(0xB4C80A0)
#define RPG_CLIENT_WHEEL_METHOD_1_0BDFAC56E6B704CB_OFFSET UNITYSDK_OFFSET(0xB4C7870)
#define RPG_CLIENT_WHEEL_METHOD_1_2450CFC043E97F54_OFFSET UNITYSDK_OFFSET(0xB4C7FB0)
#define RPG_CLIENT_WHEEL_METHOD_1_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0xB4C8040)
#define RPG_CLIENT_WHEEL_METHOD_1_515AB539783606E0_OFFSET UNITYSDK_OFFSET(0xB4C74F0)
#define RPG_CLIENT_WHEEL_METHOD_1_8853398907028921_OFFSET UNITYSDK_OFFSET(0xB4C7340)
#define RPG_CLIENT_WHEEL_METHOD_1_8C4F5769C49BF3B7_OFFSET UNITYSDK_OFFSET(0xB4C7490)
#define RPG_CLIENT_WHEEL_METHOD_1_A9DAF3FE2888211B_OFFSET UNITYSDK_OFFSET(0xB4C76D0)
#define RPG_CLIENT_WHEEL_METHOD_1_D4E1804C25B5032C_OFFSET UNITYSDK_OFFSET(0xB4C7680)
#define RPG_CLIENT_WHEEL_METHOD_1_E7EF6BC52B28648C_OFFSET UNITYSDK_OFFSET(0xB4C7EE0)
#define RPG_CLIENT_WHEEL_METHOD_1_ED7D428BE58A1065_OFFSET UNITYSDK_OFFSET(0xB4C7A30)
#define RPG_CLIENT_WHEEL__CTOR_OFFSET UNITYSDK_OFFSET(0xB4C72B0)

namespace RPG::Client
{
	inline static constexpr unsigned int Wheel_TypeDefinitionIndex = 65250;
	...
	public:
		...
		::System::Void Method_1_ED7D428BE58A1065(::System::Collections::Generic::List_1<::System::String*>* a1, ::System::Boolean a2)
		{
			return ((::System::Void(*)(::PVOID, ::System::Collections::Generic::List_1<::System::String*>*, ::System::Boolean))((::PBYTE)hIl2Cpp + RPG_CLIENT_WHEEL_METHOD_1_ED7D428BE58A1065_OFFSET))(this, a1, a2);
		}

		::System::Void Method_1_E7EF6BC52B28648C()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_WHEEL_METHOD_1_E7EF6BC52B28648C_OFFSET))(this);
		}
