...
#define RPG_CLIENT_MONOMATERIALSWITCH_ONENABLE_OFFSET UNITYSDK_OFFSET(0x9D1E010)
#define RPG_CLIENT_MONOMATERIALSWITCH_RECOVERMATERIAL_OFFSET UNITYSDK_OFFSET(0x9D1E140)
#define RPG_CLIENT_MONOMATERIALSWITCH_START_OFFSET UNITYSDK_OFFSET(0x9D1DED0)
#define RPG_CLIENT_MONOMATERIALSWITCH_SWITCHMATERIAL_OFFSET UNITYSDK_OFFSET(0x9D1E060)
#define RPG_CLIENT_MONOMATERIALSWITCH__CTOR_OFFSET UNITYSDK_OFFSET(0x9D1E2B0)
#define RPG_CLIENT_MONOMATERIALSWITCH__SETMATERIAL_OFFSET UNITYSDK_OFFSET(0x9D1E0E0)
#define RPG_CLIENT_MONOMATERIALSWITCH__TRYCACHEUI_OFFSET UNITYSDK_OFFSET(0x9D1E1D0)
#define RPG_CLIENT_MONOMATERIALSWITCH__UPDATEMATERIAL_OFFSET UNITYSDK_OFFSET(0x9D1DF20)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoMaterialSwitch_TypeDefinitionIndex = 59488;
