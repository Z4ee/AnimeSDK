...
#define RPG_CLIENT_MONOEFFECTPLUGINTRANSFORM_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xC0F0C00)
#define RPG_CLIENT_MONOEFFECTPLUGINTRANSFORM_METHOD_5_283DA224BE06DA9F_OFFSET UNITYSDK_OFFSET(0xC0F0C60)
#define RPG_CLIENT_MONOEFFECTPLUGINTRANSFORM_METHOD_5_CD9F3CEFB366C27A_OFFSET UNITYSDK_OFFSET(0xC0F0F50)
#define RPG_CLIENT_MONOEFFECTPLUGINTRANSFORM_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xC0F1540)
#define RPG_CLIENT_MONOEFFECTPLUGINTRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0xC0F15E0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginTransform_TypeDefinitionIndex = 65570;
