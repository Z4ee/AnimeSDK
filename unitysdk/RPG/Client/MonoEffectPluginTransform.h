...
#define RPG_CLIENT_MONOEFFECTPLUGINTRANSFORM_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x9CE0420)
#define RPG_CLIENT_MONOEFFECTPLUGINTRANSFORM_METHOD_5_00DEF5A164D9A9D5_OFFSET UNITYSDK_OFFSET(0x9CE06B0)
#define RPG_CLIENT_MONOEFFECTPLUGINTRANSFORM_METHOD_5_DAEB67F34AF80609_OFFSET UNITYSDK_OFFSET(0x9CE0480)
#define RPG_CLIENT_MONOEFFECTPLUGINTRANSFORM_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x9CE0C80)
#define RPG_CLIENT_MONOEFFECTPLUGINTRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x9CE0D20)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginTransform_TypeDefinitionIndex = 57388;
