...
#define RPG_CLIENT_SIGNALANIMATIONSTATE_METHOD_1_3E6AC3F92EF81B16_OFFSET UNITYSDK_OFFSET(0x19F4B600)
#define RPG_CLIENT_SIGNALANIMATIONSTATE_METHOD_1_6D723F32667667A4_OFFSET UNITYSDK_OFFSET(0x19F4B940)
#define RPG_CLIENT_SIGNALANIMATIONSTATE_METHOD_1_7E7F311119CB2FF0_OFFSET UNITYSDK_OFFSET(0x19F4B470)
#define RPG_CLIENT_SIGNALANIMATIONSTATE_METHOD_1_9504824418C27EF8_OFFSET UNITYSDK_OFFSET(0x19F4B420)
#define RPG_CLIENT_SIGNALANIMATIONSTATE_METHOD_1_A9E445C5683F09FE_OFFSET UNITYSDK_OFFSET(0x19F4B9C0)
#define RPG_CLIENT_SIGNALANIMATIONSTATE_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x19F4B900)
#define RPG_CLIENT_SIGNALANIMATIONSTATE_METHOD_1_DAC9219D09D338F5_OFFSET UNITYSDK_OFFSET(0x19F4B2C0)
#define RPG_CLIENT_SIGNALANIMATIONSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19F4BA30)

namespace RPG::Client
{
	inline static constexpr unsigned int SignalAnimationState_TypeDefinitionIndex = 67778;
