...
#define RPG_CLIENT_SIGNALANIMATIONSTATE_METHOD_1_6D723F32667667A4_OFFSET UNITYSDK_OFFSET(0xA47D010)
#define RPG_CLIENT_SIGNALANIMATIONSTATE_METHOD_1_7E7F311119CB2FF0_OFFSET UNITYSDK_OFFSET(0xA47CAC0)
#define RPG_CLIENT_SIGNALANIMATIONSTATE_METHOD_1_9504824418C27EF8_OFFSET UNITYSDK_OFFSET(0xA47CA70)
#define RPG_CLIENT_SIGNALANIMATIONSTATE_METHOD_1_A9E445C5683F09FE_OFFSET UNITYSDK_OFFSET(0xA47D090)
#define RPG_CLIENT_SIGNALANIMATIONSTATE_METHOD_1_C891C7A20C824FD8_OFFSET UNITYSDK_OFFSET(0xA47CC50)
#define RPG_CLIENT_SIGNALANIMATIONSTATE_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xA47CFD0)
#define RPG_CLIENT_SIGNALANIMATIONSTATE_METHOD_1_DAC9219D09D338F5_OFFSET UNITYSDK_OFFSET(0xA47C910)
#define RPG_CLIENT_SIGNALANIMATIONSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0xA47D100)

namespace RPG::Client
{
	inline static constexpr unsigned int SignalAnimationState_TypeDefinitionIndex = 58139;
