...
#define RPG_CLIENT_SIGNALANIMATIONSTATE_METHOD_1_3E6AC3F92EF81B16_OFFSET UNITYSDK_OFFSET(0xC8C0D40)
#define RPG_CLIENT_SIGNALANIMATIONSTATE_METHOD_1_6D723F32667667A4_OFFSET UNITYSDK_OFFSET(0xC8C1170)
#define RPG_CLIENT_SIGNALANIMATIONSTATE_METHOD_1_7E7F311119CB2FF0_OFFSET UNITYSDK_OFFSET(0xC8C0BB0)
#define RPG_CLIENT_SIGNALANIMATIONSTATE_METHOD_1_9504824418C27EF8_OFFSET UNITYSDK_OFFSET(0xC8C0B60)
#define RPG_CLIENT_SIGNALANIMATIONSTATE_METHOD_1_A9E445C5683F09FE_OFFSET UNITYSDK_OFFSET(0xC8C11F0)
#define RPG_CLIENT_SIGNALANIMATIONSTATE_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xC8C1130)
#define RPG_CLIENT_SIGNALANIMATIONSTATE_METHOD_1_DAC9219D09D338F5_OFFSET UNITYSDK_OFFSET(0xC8C0A00)
#define RPG_CLIENT_SIGNALANIMATIONSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0xC8C1260)

namespace RPG::Client
{
	inline static constexpr unsigned int SignalAnimationState_TypeDefinitionIndex = 66353;
