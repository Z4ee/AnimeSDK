...
#define RPG_CLIENT_STATETRANSFORMMODIFIER_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0x17B6A4D0)
#define RPG_CLIENT_STATETRANSFORMMODIFIER_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0x17B6A610)
#define RPG_CLIENT_STATETRANSFORMMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x17B6A750)

namespace RPG::Client
{
	inline static constexpr unsigned int StateTransformModifier_TypeDefinitionIndex = 65775;
