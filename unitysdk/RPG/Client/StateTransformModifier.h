...
#define RPG_CLIENT_STATETRANSFORMMODIFIER_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0xB1D0640)
#define RPG_CLIENT_STATETRANSFORMMODIFIER_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0xB1D0780)
#define RPG_CLIENT_STATETRANSFORMMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0xB1D08C0)
#define RPG_CLIENT_STATETRANSFORMMODIFIER___IFIXBASEPROXY_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0xB1D08E0)
#define RPG_CLIENT_STATETRANSFORMMODIFIER___IFIXBASEPROXY_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0xB1D08F0)

namespace RPG::Client
{
	inline static constexpr unsigned int StateTransformModifier_TypeDefinitionIndex = 63486;
