...
#define RPG_CLIENT_CHESSROGUECABINETDATAINFO_DISPOSE_OFFSET UNITYSDK_OFFSET(0x936BBF0)
#define RPG_CLIENT_CHESSROGUECABINETDATAINFO_GETHIDECABINETINFO_OFFSET UNITYSDK_OFFSET(0x936BEB0)
#define RPG_CLIENT_CHESSROGUECABINETDATAINFO_GETNORMALCABINETINFO_OFFSET UNITYSDK_OFFSET(0x936BCA0)
#define RPG_CLIENT_CHESSROGUECABINETDATAINFO_GET_CABINETDICT_OFFSET UNITYSDK_OFFSET(0x936C0D0)
#define RPG_CLIENT_CHESSROGUECABINETDATAINFO_INIT_OFFSET UNITYSDK_OFFSET(0x936BA30)
#define RPG_CLIENT_CHESSROGUECABINETDATAINFO_SET_CABINETDICT_OFFSET UNITYSDK_OFFSET(0x936C0E0)
#define RPG_CLIENT_CHESSROGUECABINETDATAINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x936B9B0)
#define RPG_CLIENT_CHESSROGUECABINETDATAINFO__INITCABINET_OFFSET UNITYSDK_OFFSET(0x936BA80)

namespace RPG::Client
{
	inline static constexpr unsigned int ChessRogueCabinetDataInfo_TypeDefinitionIndex = 54430;
