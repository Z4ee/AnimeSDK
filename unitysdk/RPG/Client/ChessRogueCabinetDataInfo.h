...
#define RPG_CLIENT_CHESSROGUECABINETDATAINFO_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AA98C90)
#define RPG_CLIENT_CHESSROGUECABINETDATAINFO_GETHIDECABINETINFO_OFFSET UNITYSDK_OFFSET(0x1AA99030)
#define RPG_CLIENT_CHESSROGUECABINETDATAINFO_GETNORMALCABINETINFO_OFFSET UNITYSDK_OFFSET(0x1AA98D30)
#define RPG_CLIENT_CHESSROGUECABINETDATAINFO_GET_CABINETDICT_OFFSET UNITYSDK_OFFSET(0x1AA99340)
#define RPG_CLIENT_CHESSROGUECABINETDATAINFO_INIT_OFFSET UNITYSDK_OFFSET(0x1AA98A50)
#define RPG_CLIENT_CHESSROGUECABINETDATAINFO_SET_CABINETDICT_OFFSET UNITYSDK_OFFSET(0x1AA99350)
#define RPG_CLIENT_CHESSROGUECABINETDATAINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA989D0)
#define RPG_CLIENT_CHESSROGUECABINETDATAINFO__INITCABINET_OFFSET UNITYSDK_OFFSET(0x1AA98AA0)

namespace RPG::Client
{
	inline static constexpr unsigned int ChessRogueCabinetDataInfo_TypeDefinitionIndex = 63918;
