...
#define RPG_CLIENT_CHESSROGUECABINETDATAINFO_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB64FAB0)
#define RPG_CLIENT_CHESSROGUECABINETDATAINFO_GETHIDECABINETINFO_OFFSET UNITYSDK_OFFSET(0xB64FE50)
#define RPG_CLIENT_CHESSROGUECABINETDATAINFO_GETNORMALCABINETINFO_OFFSET UNITYSDK_OFFSET(0xB64FB50)
#define RPG_CLIENT_CHESSROGUECABINETDATAINFO_GET_CABINETDICT_OFFSET UNITYSDK_OFFSET(0xB650160)
#define RPG_CLIENT_CHESSROGUECABINETDATAINFO_INIT_OFFSET UNITYSDK_OFFSET(0xB64F870)
#define RPG_CLIENT_CHESSROGUECABINETDATAINFO_SET_CABINETDICT_OFFSET UNITYSDK_OFFSET(0xB650170)
#define RPG_CLIENT_CHESSROGUECABINETDATAINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xB64F7F0)
#define RPG_CLIENT_CHESSROGUECABINETDATAINFO__INITCABINET_OFFSET UNITYSDK_OFFSET(0xB64F8C0)

namespace RPG::Client
{
	inline static constexpr unsigned int ChessRogueCabinetDataInfo_TypeDefinitionIndex = 62551;
