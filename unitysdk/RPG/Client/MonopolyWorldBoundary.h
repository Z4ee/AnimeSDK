...
#define RPG_CLIENT_MONOPOLYWORLDBOUNDARY_GETWORLDCORNERS_OFFSET UNITYSDK_OFFSET(0x9D824E0)
#define RPG_CLIENT_MONOPOLYWORLDBOUNDARY_START_OFFSET UNITYSDK_OFFSET(0x9D82360)
#define RPG_CLIENT_MONOPOLYWORLDBOUNDARY__CTOR_OFFSET UNITYSDK_OFFSET(0x9D82540)

namespace RPG::Client
{
	inline static constexpr unsigned int MonopolyWorldBoundary_TypeDefinitionIndex = 59713;
