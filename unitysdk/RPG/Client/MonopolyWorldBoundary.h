...
#define RPG_CLIENT_MONOPOLYWORLDBOUNDARY_GETWORLDCORNERS_OFFSET UNITYSDK_OFFSET(0xC1976D0)
#define RPG_CLIENT_MONOPOLYWORLDBOUNDARY_START_OFFSET UNITYSDK_OFFSET(0xC197560)
#define RPG_CLIENT_MONOPOLYWORLDBOUNDARY__CTOR_OFFSET UNITYSDK_OFFSET(0xC197730)

namespace RPG::Client
{
	inline static constexpr unsigned int MonopolyWorldBoundary_TypeDefinitionIndex = 68052;
