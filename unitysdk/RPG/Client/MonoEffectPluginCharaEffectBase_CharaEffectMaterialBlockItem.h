...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_CHARAEFFECTMATERIALBLOCKITEM_METHOD_1_40AF2F11955B0F70_OFFSET UNITYSDK_OFFSET(0x116A3960)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_CHARAEFFECTMATERIALBLOCKITEM_METHOD_1_A3C617F1A916563F_OFFSET UNITYSDK_OFFSET(0x116A2050)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_CHARAEFFECTMATERIALBLOCKITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x116A41D0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginCharaEffectBase_CharaEffectMaterialBlockItem_TypeDefinitionIndex = 69905;
