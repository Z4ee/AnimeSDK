...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_CHARAEFFECTMATERIALBLOCKITEM_METHOD_1_40AF2F11955B0F70_OFFSET UNITYSDK_OFFSET(0xA964B90)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_CHARAEFFECTMATERIALBLOCKITEM_METHOD_1_A3C617F1A916563F_OFFSET UNITYSDK_OFFSET(0xA9632C0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_CHARAEFFECTMATERIALBLOCKITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xA965520)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginCharaEffectBase_CharaEffectMaterialBlockItem_TypeDefinitionIndex = 64469;
