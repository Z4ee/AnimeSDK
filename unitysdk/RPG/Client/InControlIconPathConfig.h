...
#define RPG_CLIENT_INCONTROLICONPATHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x9946C60)

namespace RPG::Client
{
	inline static constexpr unsigned int InControlIconPathConfig_TypeDefinitionIndex = 49750;
