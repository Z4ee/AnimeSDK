...
#define RPG_CLIENT_INCONTROLICONPATHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xA631A40)

namespace RPG::Client
{
	inline static constexpr unsigned int InControlIconPathConfig_TypeDefinitionIndex = 56572;
