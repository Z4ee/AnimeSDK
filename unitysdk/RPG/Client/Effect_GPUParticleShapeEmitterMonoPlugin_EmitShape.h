...
#define RPG_CLIENT_EFFECT_GPUPARTICLESHAPEEMITTERMONOPLUGIN_EMITSHAPE_GET_SHAPETOOBJSPACEM_OFFSET UNITYSDK_OFFSET(0xCDDF860)
#define RPG_CLIENT_EFFECT_GPUPARTICLESHAPEEMITTERMONOPLUGIN_EMITSHAPE_GET_SHAPETOOBJSPACENOSCALEM_OFFSET UNITYSDK_OFFSET(0xCDE40D0)
#define RPG_CLIENT_EFFECT_GPUPARTICLESHAPEEMITTERMONOPLUGIN_EMITSHAPE__CTOR_OFFSET UNITYSDK_OFFSET(0xCDE0600)
