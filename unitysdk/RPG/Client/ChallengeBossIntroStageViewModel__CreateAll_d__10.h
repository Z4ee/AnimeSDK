...
#define RPG_CLIENT_CHALLENGEBOSSINTROSTAGEVIEWMODEL__CREATEALL_D__10_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xB4F4830)
#define RPG_CLIENT_CHALLENGEBOSSINTROSTAGEVIEWMODEL__CREATEALL_D__10_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_RPG_CLIENT_CHALLENGEBOSSINTROSTAGEVIEWMODEL__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xB4F4A90)
#define RPG_CLIENT_CHALLENGEBOSSINTROSTAGEVIEWMODEL__CREATEALL_D__10_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_RPG_CLIENT_CHALLENGEBOSSINTROSTAGEVIEWMODEL__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xB4F4A20)
#define RPG_CLIENT_CHALLENGEBOSSINTROSTAGEVIEWMODEL__CREATEALL_D__10_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xB4F4B10)
#define RPG_CLIENT_CHALLENGEBOSSINTROSTAGEVIEWMODEL__CREATEALL_D__10_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xB4F4A80)
#define RPG_CLIENT_CHALLENGEBOSSINTROSTAGEVIEWMODEL__CREATEALL_D__10_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xB4F4A30)
#define RPG_CLIENT_CHALLENGEBOSSINTROSTAGEVIEWMODEL__CREATEALL_D__10_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB4F4820)
#define RPG_CLIENT_CHALLENGEBOSSINTROSTAGEVIEWMODEL__CREATEALL_D__10__CTOR_OFFSET UNITYSDK_OFFSET(0xB4F42E0)

namespace RPG::Client
{
	inline static constexpr unsigned int ChallengeBossIntroStageViewModel__CreateAll_d__10_TypeDefinitionIndex = 59023;
	...
	public:
		...
		::System::Boolean _isTierce_5__2; // 0x34
