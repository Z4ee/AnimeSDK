...
#define RPG_CLIENT_HANDBOOKMODULE___C__DISPLAYCLASS76_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA5F1510)
#define RPG_CLIENT_HANDBOOKMODULE___C__DISPLAYCLASS76_0__REQUESTPREAVATARRELICDATAREFRESH_B__0_OFFSET UNITYSDK_OFFSET(0xA5FC1D0)
#define RPG_CLIENT_HANDBOOKMODULE___C__DISPLAYCLASS76_0__REQUESTPREAVATARRELICDATAREFRESH_B__1_OFFSET UNITYSDK_OFFSET(0xA5FC1F0)
#define RPG_CLIENT_HANDBOOKMODULE___C__DISPLAYCLASS76_0__REQUESTPREAVATARRELICDATAREFRESH_B__2_OFFSET UNITYSDK_OFFSET(0xA5FC210)
