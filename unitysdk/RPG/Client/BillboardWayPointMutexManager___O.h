...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Comparison_1<::RPG::Client::UIBillboard*>**)Il2CppClass::FromTypeDefinitionIndex(BillboardWayPointMutexManager___O_TypeDefinitionIndex)->GetStaticField(0x12700);
		}
	};
}
