...
#define RPG_CLIENT_TIMESPACECRISSCROSSADDITIONSBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0x178839F0)
#define RPG_CLIENT_TIMESPACECRISSCROSSADDITIONSBEHAVIOR_METHOD_3_0BDFAC56E6B704CB_OFFSET UNITYSDK_OFFSET(0x17886670)
#define RPG_CLIENT_TIMESPACECRISSCROSSADDITIONSBEHAVIOR_METHOD_3_367A5F1ECD1BC1A2_OFFSET UNITYSDK_OFFSET(0x17884E90)
#define RPG_CLIENT_TIMESPACECRISSCROSSADDITIONSBEHAVIOR_METHOD_3_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x17886B30)
#define RPG_CLIENT_TIMESPACECRISSCROSSADDITIONSBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0x17886C80)
#define RPG_CLIENT_TIMESPACECRISSCROSSADDITIONSBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x17886C20)
#define RPG_CLIENT_TIMESPACECRISSCROSSADDITIONSBEHAVIOR_METHOD_3_4DF79CB98933D255_OFFSET UNITYSDK_OFFSET(0x17882A30)
#define RPG_CLIENT_TIMESPACECRISSCROSSADDITIONSBEHAVIOR_METHOD_3_563FD36D519B168A_OFFSET UNITYSDK_OFFSET(0x17883A70)
#define RPG_CLIENT_TIMESPACECRISSCROSSADDITIONSBEHAVIOR_METHOD_3_6055A93732CC885D_OFFSET UNITYSDK_OFFSET(0x17886100)
#define RPG_CLIENT_TIMESPACECRISSCROSSADDITIONSBEHAVIOR_METHOD_3_7DFA6217A9A4E501_OFFSET UNITYSDK_OFFSET(0x178832A0)
#define RPG_CLIENT_TIMESPACECRISSCROSSADDITIONSBEHAVIOR_METHOD_3_83DA3EC57FF907F4_OFFSET UNITYSDK_OFFSET(0x17886CE0)
#define RPG_CLIENT_TIMESPACECRISSCROSSADDITIONSBEHAVIOR_METHOD_3_9C844AB9164FA35A_OFFSET UNITYSDK_OFFSET(0x17884180)
#define RPG_CLIENT_TIMESPACECRISSCROSSADDITIONSBEHAVIOR_METHOD_3_A002848F130F70CA_OFFSET UNITYSDK_OFFSET(0x17883580)
#define RPG_CLIENT_TIMESPACECRISSCROSSADDITIONSBEHAVIOR_METHOD_3_A09861D42EE0D9FD_OFFSET UNITYSDK_OFFSET(0x17884D40)
#define RPG_CLIENT_TIMESPACECRISSCROSSADDITIONSBEHAVIOR_METHOD_3_AD77E911045B3A4C_OFFSET UNITYSDK_OFFSET(0x178860A0)
#define RPG_CLIENT_TIMESPACECRISSCROSSADDITIONSBEHAVIOR_METHOD_3_BA1BB49741CFDFE1_OFFSET UNITYSDK_OFFSET(0x17886480)
#define RPG_CLIENT_TIMESPACECRISSCROSSADDITIONSBEHAVIOR_METHOD_3_D0BD1377F2594D33_1_OFFSET UNITYSDK_OFFSET(0x17885F70)
#define RPG_CLIENT_TIMESPACECRISSCROSSADDITIONSBEHAVIOR_METHOD_3_D0BD1377F2594D33_OFFSET UNITYSDK_OFFSET(0x17885EA0)
#define RPG_CLIENT_TIMESPACECRISSCROSSADDITIONSBEHAVIOR_METHOD_3_D3129FE8DF635B48_OFFSET UNITYSDK_OFFSET(0x178866E0)
#define RPG_CLIENT_TIMESPACECRISSCROSSADDITIONSBEHAVIOR_METHOD_3_DDBFE8E9D8449B5F_OFFSET UNITYSDK_OFFSET(0x178863C0)
#define RPG_CLIENT_TIMESPACECRISSCROSSADDITIONSBEHAVIOR_METHOD_3_EBB320E5E22F7D94_OFFSET UNITYSDK_OFFSET(0x17885790)
#define RPG_CLIENT_TIMESPACECRISSCROSSADDITIONSBEHAVIOR_METHOD_3_F3DF1839115449CE_OFFSET UNITYSDK_OFFSET(0x17886040)
#define RPG_CLIENT_TIMESPACECRISSCROSSADDITIONSBEHAVIOR_METHOD_3_F74441856239DF08_OFFSET UNITYSDK_OFFSET(0x17886730)
#define RPG_CLIENT_TIMESPACECRISSCROSSADDITIONSBEHAVIOR_METHOD_3_F8DD998647B4A01A_OFFSET UNITYSDK_OFFSET(0x17886B70)
#define RPG_CLIENT_TIMESPACECRISSCROSSADDITIONSBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0x17886530)
#define RPG_CLIENT_TIMESPACECRISSCROSSADDITIONSBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x17886D90)

namespace RPG::Client
{
	inline static constexpr unsigned int TimeSpaceCrisscrossAdditionsBehavior_TypeDefinitionIndex = 67053;
	...
	public:
		...
		{
			return (::UnityEngine::Mesh**)Il2CppClass::FromTypeDefinitionIndex(TimeSpaceCrisscrossAdditionsBehavior_TypeDefinitionIndex)->GetStaticField(0x42580);
		}
