...
#define RPG_CLIENT_GRIDFIGHTANIMEFFECT_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xBADE530)
#define RPG_CLIENT_GRIDFIGHTANIMEFFECT_METHOD_5_B3A88D7849969A71_OFFSET UNITYSDK_OFFSET(0xBADE9F0)
#define RPG_CLIENT_GRIDFIGHTANIMEFFECT_ONCREATE_OFFSET UNITYSDK_OFFSET(0xBADE570)
#define RPG_CLIENT_GRIDFIGHTANIMEFFECT_PLAY_1_OFFSET UNITYSDK_OFFSET(0xBADE800)
#define RPG_CLIENT_GRIDFIGHTANIMEFFECT_PLAY_OFFSET UNITYSDK_OFFSET(0xBADE6A0)
#define RPG_CLIENT_GRIDFIGHTANIMEFFECT_SPAWNED_OFFSET UNITYSDK_OFFSET(0xBADE4F0)
#define RPG_CLIENT_GRIDFIGHTANIMEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xBADEA60)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightAnimEffect_TypeDefinitionIndex = 60259;
