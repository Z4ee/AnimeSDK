...
#define RPG_CLIENT_SIGNALCURVEPOOLBEHAVIOR_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x188DF500)
#define RPG_CLIENT_SIGNALCURVEPOOLBEHAVIOR_GET__CURVES_OFFSET UNITYSDK_OFFSET(0x188DE2C0)
#define RPG_CLIENT_SIGNALCURVEPOOLBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0x188DE240)
#define RPG_CLIENT_SIGNALCURVEPOOLBEHAVIOR_METHOD_3_28EB11670A8E5A86_OFFSET UNITYSDK_OFFSET(0x188DDFD0)
#define RPG_CLIENT_SIGNALCURVEPOOLBEHAVIOR_METHOD_3_3129BDB20712C068_OFFSET UNITYSDK_OFFSET(0x188DF1F0)
#define RPG_CLIENT_SIGNALCURVEPOOLBEHAVIOR_METHOD_3_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x188DEBE0)
#define RPG_CLIENT_SIGNALCURVEPOOLBEHAVIOR_METHOD_3_3F07804D8892197E_1_OFFSET UNITYSDK_OFFSET(0x188DF150)
#define RPG_CLIENT_SIGNALCURVEPOOLBEHAVIOR_METHOD_3_3F07804D8892197E_OFFSET UNITYSDK_OFFSET(0x188DF0C0)
#define RPG_CLIENT_SIGNALCURVEPOOLBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0x188DE9C0)
#define RPG_CLIENT_SIGNALCURVEPOOLBEHAVIOR_METHOD_3_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0x188DEB20)
#define RPG_CLIENT_SIGNALCURVEPOOLBEHAVIOR_METHOD_3_4343F372F34C05BF_3_OFFSET UNITYSDK_OFFSET(0x188DEB80)
#define RPG_CLIENT_SIGNALCURVEPOOLBEHAVIOR_METHOD_3_4343F372F34C05BF_4_OFFSET UNITYSDK_OFFSET(0x188DEC20)
#define RPG_CLIENT_SIGNALCURVEPOOLBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x188DE960)
#define RPG_CLIENT_SIGNALCURVEPOOLBEHAVIOR_METHOD_3_69CEABFED67045C9_OFFSET UNITYSDK_OFFSET(0x188DEE80)
#define RPG_CLIENT_SIGNALCURVEPOOLBEHAVIOR_METHOD_3_7C2F4A88645035A8_OFFSET UNITYSDK_OFFSET(0x188DEC80)
#define RPG_CLIENT_SIGNALCURVEPOOLBEHAVIOR_METHOD_3_8542E37E74FDE1B5_OFFSET UNITYSDK_OFFSET(0x188DE700)
#define RPG_CLIENT_SIGNALCURVEPOOLBEHAVIOR_METHOD_3_942DCC931DF352DA_OFFSET UNITYSDK_OFFSET(0x188DEFB0)
#define RPG_CLIENT_SIGNALCURVEPOOLBEHAVIOR_METHOD_3_97D83E4CB3B11935_OFFSET UNITYSDK_OFFSET(0x188DEA20)
#define RPG_CLIENT_SIGNALCURVEPOOLBEHAVIOR_METHOD_3_B260AE72D1F1CB0C_OFFSET UNITYSDK_OFFSET(0x188DF460)
#define RPG_CLIENT_SIGNALCURVEPOOLBEHAVIOR_METHOD_3_F91B0AD50C072273_OFFSET UNITYSDK_OFFSET(0x188DEF20)
#define RPG_CLIENT_SIGNALCURVEPOOLBEHAVIOR_METHOD_3_F978A1D172468895_OFFSET UNITYSDK_OFFSET(0x188DE330)
#define RPG_CLIENT_SIGNALCURVEPOOLBEHAVIOR_SET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x188DF510)
#define RPG_CLIENT_SIGNALCURVEPOOLBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x188DF520)

namespace RPG::Client
{
	inline static constexpr unsigned int SignalCurvePoolBehavior_TypeDefinitionIndex = 67760;
	...
	public:
		...
		{
			return (::RPG::Client::SignalCurvePoolBehavior**)Il2CppClass::FromTypeDefinitionIndex(SignalCurvePoolBehavior_TypeDefinitionIndex)->GetStaticField(0x338E0);
		}
