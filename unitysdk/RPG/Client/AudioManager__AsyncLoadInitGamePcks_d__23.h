...
#define RPG_CLIENT_AUDIOMANAGER__ASYNCLOADINITGAMEPCKS_D__23_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xC7F74E0)
#define RPG_CLIENT_AUDIOMANAGER__ASYNCLOADINITGAMEPCKS_D__23_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xC7F7740)
#define RPG_CLIENT_AUDIOMANAGER__ASYNCLOADINITGAMEPCKS_D__23_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xC7F77A0)
#define RPG_CLIENT_AUDIOMANAGER__ASYNCLOADINITGAMEPCKS_D__23_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xC7F7750)
#define RPG_CLIENT_AUDIOMANAGER__ASYNCLOADINITGAMEPCKS_D__23_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC7F74D0)
#define RPG_CLIENT_AUDIOMANAGER__ASYNCLOADINITGAMEPCKS_D__23__CTOR_OFFSET UNITYSDK_OFFSET(0xC7F74C0)
