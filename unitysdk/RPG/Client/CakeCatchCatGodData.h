...
#define RPG_CLIENT_CAKECATCHCATGODDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1A130240)
#define RPG_CLIENT_CAKECATCHCATGODDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A1303A0)
#define RPG_CLIENT_CAKECATCHCATGODDATA_GET_CATIMAGEPATH_OFFSET UNITYSDK_OFFSET(0x1A130400)
#define RPG_CLIENT_CAKECATCHCATGODDATA_GET_CATNAME_OFFSET UNITYSDK_OFFSET(0x1A130420)
#define RPG_CLIENT_CAKECATCHCATGODDATA_GET_INTERACTCOUNT_OFFSET UNITYSDK_OFFSET(0x1A1303E0)
#define RPG_CLIENT_CAKECATCHCATGODDATA_SET_CATIMAGEPATH_OFFSET UNITYSDK_OFFSET(0x1A130410)
#define RPG_CLIENT_CAKECATCHCATGODDATA_SET_CATNAME_OFFSET UNITYSDK_OFFSET(0x1A130430)
#define RPG_CLIENT_CAKECATCHCATGODDATA_SET_INTERACTCOUNT_OFFSET UNITYSDK_OFFSET(0x1A1303F0)
#define RPG_CLIENT_CAKECATCHCATGODDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A130390)

namespace RPG::Client
{
	inline static constexpr unsigned int CakeCatchCatGodData_TypeDefinitionIndex = 63055;
