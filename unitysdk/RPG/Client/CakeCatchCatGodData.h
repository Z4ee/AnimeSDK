...
#define RPG_CLIENT_CAKECATCHCATGODDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x18CCF4F0)
#define RPG_CLIENT_CAKECATCHCATGODDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18CCF650)
#define RPG_CLIENT_CAKECATCHCATGODDATA_GET_CATIMAGEPATH_OFFSET UNITYSDK_OFFSET(0x18CCF6B0)
#define RPG_CLIENT_CAKECATCHCATGODDATA_GET_CATNAME_OFFSET UNITYSDK_OFFSET(0x18CCF6D0)
#define RPG_CLIENT_CAKECATCHCATGODDATA_GET_INTERACTCOUNT_OFFSET UNITYSDK_OFFSET(0x18CCF690)
#define RPG_CLIENT_CAKECATCHCATGODDATA_SET_CATIMAGEPATH_OFFSET UNITYSDK_OFFSET(0x18CCF6C0)
#define RPG_CLIENT_CAKECATCHCATGODDATA_SET_CATNAME_OFFSET UNITYSDK_OFFSET(0x18CCF6E0)
#define RPG_CLIENT_CAKECATCHCATGODDATA_SET_INTERACTCOUNT_OFFSET UNITYSDK_OFFSET(0x18CCF6A0)
#define RPG_CLIENT_CAKECATCHCATGODDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18CCF640)

namespace RPG::Client
{
	inline static constexpr unsigned int CakeCatchCatGodData_TypeDefinitionIndex = 60207;
