...
#define RPG_CLIENT_CAKECATCHCATGODDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xC991E80)
#define RPG_CLIENT_CAKECATCHCATGODDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC991FE0)
#define RPG_CLIENT_CAKECATCHCATGODDATA_GET_CATIMAGEPATH_OFFSET UNITYSDK_OFFSET(0xC992040)
#define RPG_CLIENT_CAKECATCHCATGODDATA_GET_CATNAME_OFFSET UNITYSDK_OFFSET(0xC992060)
#define RPG_CLIENT_CAKECATCHCATGODDATA_GET_INTERACTCOUNT_OFFSET UNITYSDK_OFFSET(0xC992020)
#define RPG_CLIENT_CAKECATCHCATGODDATA_SET_CATIMAGEPATH_OFFSET UNITYSDK_OFFSET(0xC992050)
#define RPG_CLIENT_CAKECATCHCATGODDATA_SET_CATNAME_OFFSET UNITYSDK_OFFSET(0xC992070)
#define RPG_CLIENT_CAKECATCHCATGODDATA_SET_INTERACTCOUNT_OFFSET UNITYSDK_OFFSET(0xC992030)
#define RPG_CLIENT_CAKECATCHCATGODDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC991FD0)
