...
#define RPG_CLIENT_LIGHTCONEARCHIVEENTRY_GETAVATARBASETYPE_OFFSET UNITYSDK_OFFSET(0xBD72180)
#define RPG_CLIENT_LIGHTCONEARCHIVEENTRY_GET_ROW_OFFSET UNITYSDK_OFFSET(0xBD71D10)
#define RPG_CLIENT_LIGHTCONEARCHIVEENTRY_GET_SORTID_OFFSET UNITYSDK_OFFSET(0xBD720D0)
#define RPG_CLIENT_LIGHTCONEARCHIVEENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0xBD71FF0)
#define RPG_CLIENT_LIGHTCONEARCHIVEENTRY___IFIXBASEPROXY_GET_SORTID_OFFSET UNITYSDK_OFFSET(0xBD72230)

namespace RPG::Client
{
	inline static constexpr unsigned int LightConeArchiveEntry_TypeDefinitionIndex = 58410;
