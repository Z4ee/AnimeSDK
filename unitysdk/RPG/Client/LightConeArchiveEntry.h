...
#define RPG_CLIENT_LIGHTCONEARCHIVEENTRY_GETAVATARBASETYPE_OFFSET UNITYSDK_OFFSET(0x16C6CA90)
#define RPG_CLIENT_LIGHTCONEARCHIVEENTRY_GET_ROW_OFFSET UNITYSDK_OFFSET(0x16C6C620)
#define RPG_CLIENT_LIGHTCONEARCHIVEENTRY_GET_SORTID_OFFSET UNITYSDK_OFFSET(0x16C6C9E0)
#define RPG_CLIENT_LIGHTCONEARCHIVEENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x16C6C9C0)
