...
#define RPG_CLIENT_PLANETFESFLOATINGLAYERADJUSTER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1C372D10)
#define RPG_CLIENT_PLANETFESFLOATINGLAYERADJUSTER_METHOD_5_2BA181E87C3A32FF_OFFSET UNITYSDK_OFFSET(0x1C372E10)
#define RPG_CLIENT_PLANETFESFLOATINGLAYERADJUSTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C372F20)
