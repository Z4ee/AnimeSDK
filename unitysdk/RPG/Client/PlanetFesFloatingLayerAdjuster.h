...
#define RPG_CLIENT_PLANETFESFLOATINGLAYERADJUSTER_AWAKE_OFFSET UNITYSDK_OFFSET(0x9F98CD0)
#define RPG_CLIENT_PLANETFESFLOATINGLAYERADJUSTER_METHOD_5_2BA181E87C3A32FF_OFFSET UNITYSDK_OFFSET(0x9F98DD0)
#define RPG_CLIENT_PLANETFESFLOATINGLAYERADJUSTER__CTOR_OFFSET UNITYSDK_OFFSET(0x9F98EE0)

namespace RPG::Client
{
	inline static constexpr unsigned int PlanetFesFloatingLayerAdjuster_TypeDefinitionIndex = 54093;
