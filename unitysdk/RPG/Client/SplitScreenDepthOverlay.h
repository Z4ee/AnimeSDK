...
#define RPG_CLIENT_SPLITSCREENDEPTHOVERLAY_METHOD_5_0E23A1762570D091_OFFSET UNITYSDK_OFFSET(0xE0C0FB0)
#define RPG_CLIENT_SPLITSCREENDEPTHOVERLAY_METHOD_5_3BC8B8F2BB08C1C2_OFFSET UNITYSDK_OFFSET(0xE0C0EB0)
#define RPG_CLIENT_SPLITSCREENDEPTHOVERLAY_METHOD_5_95EAF395E6F95EA4_OFFSET UNITYSDK_OFFSET(0xE0C0BB0)
#define RPG_CLIENT_SPLITSCREENDEPTHOVERLAY_METHOD_5_C77E904E892D00B4_OFFSET UNITYSDK_OFFSET(0xE0C0F00)
#define RPG_CLIENT_SPLITSCREENDEPTHOVERLAY_SETCUSTOMOVERLAYDEPTH01_OFFSET UNITYSDK_OFFSET(0xE0C0E30)
#define RPG_CLIENT_SPLITSCREENDEPTHOVERLAY_UPDATEDEPTHOVERLAY_OFFSET UNITYSDK_OFFSET(0xE0C0AC0)
#define RPG_CLIENT_SPLITSCREENDEPTHOVERLAY__CCTOR_OFFSET UNITYSDK_OFFSET(0xE0C1010)
#define RPG_CLIENT_SPLITSCREENDEPTHOVERLAY__CTOR_OFFSET UNITYSDK_OFFSET(0xE0C1000)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(SplitScreenDepthOverlay_TypeDefinitionIndex)->GetStaticField(0xC010);
		}
