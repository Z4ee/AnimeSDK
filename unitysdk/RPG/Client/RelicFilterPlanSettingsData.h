...
#define RPG_CLIENT_RELICFILTERPLANSETTINGSDATA_CREATE_1_OFFSET UNITYSDK_OFFSET(0xAF91650)
#define RPG_CLIENT_RELICFILTERPLANSETTINGSDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xAF91470)
#define RPG_CLIENT_RELICFILTERPLANSETTINGSDATA_FILLTOSERVERDATA_OFFSET UNITYSDK_OFFSET(0xAF919D0)
#define RPG_CLIENT_RELICFILTERPLANSETTINGSDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xAF92160)

namespace RPG::Client
{
	inline static constexpr unsigned int RelicFilterPlanSettingsData_TypeDefinitionIndex = 61595;

	class RelicFilterPlanSettingsData : public ::System::Object
	{
	public:
		::System::Collections::Generic::List_1<::System::UInt32>* SphereMainPropertyList; // 0x10
		...
		::System::Collections::Generic::List_1<::System::UInt32>* SubPropertyList; // 0x28
		::System::Collections::Generic::List_1<::System::UInt32>* RopeMainPropertyList; // 0x30
		::System::Collections::Generic::List_1<::System::UInt32>* HeadMainPropertyList; // 0x38
		::System::Collections::Generic::List_1<::System::UInt32>* FootMainPropertyList; // 0x40
		::System::Collections::Generic::List_1<::System::UInt32>* RelicSetList; // 0x48
		::System::UInt32 RarityBitset; // 0x50
		::System::Boolean IsIncludeFilterSubProperty; // 0x54
		::System::UInt32 SubPropertyNum; // 0x58
