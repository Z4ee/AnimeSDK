...
#define RPG_CLIENT_RELICFILTERPLANSETTINGSDATA_CREATE_1_OFFSET UNITYSDK_OFFSET(0x1B664F70)
#define RPG_CLIENT_RELICFILTERPLANSETTINGSDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1B664D90)
#define RPG_CLIENT_RELICFILTERPLANSETTINGSDATA_FILLTOSERVERDATA_OFFSET UNITYSDK_OFFSET(0x1B665280)
#define RPG_CLIENT_RELICFILTERPLANSETTINGSDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B665A80)
