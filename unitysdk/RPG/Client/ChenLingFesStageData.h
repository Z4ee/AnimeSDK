...
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_GET_AWARDLISTID_OFFSET UNITYSDK_OFFSET(0x1AA80AB0)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_GET_HASSERVERHISTORYDATA_OFFSET UNITYSDK_OFFSET(0x1AA80740)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_GET_ISAVAILABLE_OFFSET UNITYSDK_OFFSET(0x1AA7F0C0)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_GET_ISENDLESS_OFFSET UNITYSDK_OFFSET(0x1AA7E360)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_GET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0x1AA807A0)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_GET_ISINPROGRESS_OFFSET UNITYSDK_OFFSET(0x1AA808F0)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_GET_ISPREVSTAGEFINISH_OFFSET UNITYSDK_OFFSET(0x1AA807E0)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_GET_ISSEENUNLOCK_OFFSET UNITYSDK_OFFSET(0x1AA7F150)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_GET_ISSUBMISSIONFINISH_OFFSET UNITYSDK_OFFSET(0x1AA80840)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_GET_ITEMRULEGROUPIDLIST_OFFSET UNITYSDK_OFFSET(0x1AA80A30)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_GET_LEVELDAYDURATIONLIST_OFFSET UNITYSDK_OFFSET(0x1AA80A70)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_GET_LEVELID_OFFSET UNITYSDK_OFFSET(0x1AA809B0)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_GET_LEVELNAME_OFFSET UNITYSDK_OFFSET(0x1AA809D0)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_GET_LEVELTYPE_OFFSET UNITYSDK_OFFSET(0x1AA809F0)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_GET_PREVSTAGEDATA_OFFSET UNITYSDK_OFFSET(0x1AA807C0)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_GET_REQUIREDSCORELIST_OFFSET UNITYSDK_OFFSET(0x1AA80A10)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_GET_STARNUM_OFFSET UNITYSDK_OFFSET(0x1AA80760)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_GET_TOTALSCORE_OFFSET UNITYSDK_OFFSET(0x1AA80780)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_GET_TOTALSTARNUM_OFFSET UNITYSDK_OFFSET(0x1AA80AF0)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_GET_UNLOCKSUBMISSION_OFFSET UNITYSDK_OFFSET(0x1AA80AD0)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_GET_VISITORRULEGROUPIDLIST_OFFSET UNITYSDK_OFFSET(0x1AA80A50)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_GET_VISITORTIMEINTERVALLIST_OFFSET UNITYSDK_OFFSET(0x1AA80A90)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_MARKSEENUNLOCK_OFFSET UNITYSDK_OFFSET(0x1AA7F260)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_SETPREVSTAGEDATA_OFFSET UNITYSDK_OFFSET(0x1AA803E0)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_SET_AWARDLISTID_OFFSET UNITYSDK_OFFSET(0x1AA80AC0)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_SET_HASSERVERHISTORYDATA_OFFSET UNITYSDK_OFFSET(0x1AA80750)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_SET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0x1AA807B0)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_SET_ITEMRULEGROUPIDLIST_OFFSET UNITYSDK_OFFSET(0x1AA80A40)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_SET_LEVELDAYDURATIONLIST_OFFSET UNITYSDK_OFFSET(0x1AA80A80)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_SET_LEVELID_OFFSET UNITYSDK_OFFSET(0x1AA809C0)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_SET_LEVELNAME_OFFSET UNITYSDK_OFFSET(0x1AA809E0)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_SET_LEVELTYPE_OFFSET UNITYSDK_OFFSET(0x1AA80A00)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_SET_PREVSTAGEDATA_OFFSET UNITYSDK_OFFSET(0x1AA807D0)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_SET_REQUIREDSCORELIST_OFFSET UNITYSDK_OFFSET(0x1AA80A20)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_SET_STARNUM_OFFSET UNITYSDK_OFFSET(0x1AA80770)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_SET_TOTALSCORE_OFFSET UNITYSDK_OFFSET(0x1AA80790)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_SET_TOTALSTARNUM_OFFSET UNITYSDK_OFFSET(0x1AA80B00)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_SET_UNLOCKSUBMISSION_OFFSET UNITYSDK_OFFSET(0x1AA80AE0)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_SET_VISITORRULEGROUPIDLIST_OFFSET UNITYSDK_OFFSET(0x1AA80A60)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_SET_VISITORTIMEINTERVALLIST_OFFSET UNITYSDK_OFFSET(0x1AA80AA0)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA_SYNC_OFFSET UNITYSDK_OFFSET(0x1AA7D6A0)
#define RPG_CLIENT_CHENLINGFESSTAGEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA80340)

namespace RPG::Client
{
	inline static constexpr unsigned int ChenLingFesStageData_TypeDefinitionIndex = 58728;

	class ChenLingFesStageData : public ::System::Object
	{
	public:
		// static const ::System::UInt32 _EndlessLevelID = 0x3E7; // 0x0
		::Il2CppArray<::System::UInt32>* _LevelDayDurationList_k__BackingField; // 0x10
		::System::String* _LevelName_k__BackingField; // 0x18
		::RPG::Client::ChenLingFesStageData* _PrevStageData_k__BackingField; // 0x20
		::Il2CppArray<::System::UInt32>* _ItemRuleGroupIDList_k__BackingField; // 0x28
		::Il2CppArray<::System::UInt32>* _VisitorRuleGroupIDList_k__BackingField; // 0x30
		::Il2CppArray<::System::UInt32>* _RequiredScoreList_k__BackingField; // 0x38
		::Il2CppArray<::System::UInt32>* _AwardListID_k__BackingField; // 0x40
		::Il2CppArray<::System::UInt32>* _VisitorTimeIntervalList_k__BackingField; // 0x48
		::System::Int32 _TotalStarNum_k__BackingField; // 0x50
		::System::Boolean _HasServerHistoryData_k__BackingField; // 0x54
		::System::Boolean _HasSeenUnlock; // 0x55
		::System::Boolean _IsFinished_k__BackingField; // 0x56
		::System::UInt32 _UnlockSubMission_k__BackingField; // 0x58
