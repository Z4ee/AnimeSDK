...
#define RPG_CLIENT_SCENETRANSFORMANIM_GET_ISUPATEINEDITORMODE_OFFSET UNITYSDK_OFFSET(0xA4189B0)
#define RPG_CLIENT_SCENETRANSFORMANIM_SET_ISUPATEINEDITORMODE_OFFSET UNITYSDK_OFFSET(0xA4189C0)
#define RPG_CLIENT_SCENETRANSFORMANIM__CTOR_OFFSET UNITYSDK_OFFSET(0xA4189D0)

namespace RPG::Client
{
	inline static constexpr unsigned int SceneTransformAnim_TypeDefinitionIndex = 58106;
