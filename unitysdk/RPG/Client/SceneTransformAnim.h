...
#define RPG_CLIENT_SCENETRANSFORMANIM_GET_ISUPATEINEDITORMODE_OFFSET UNITYSDK_OFFSET(0xE05B210)
#define RPG_CLIENT_SCENETRANSFORMANIM_SET_ISUPATEINEDITORMODE_OFFSET UNITYSDK_OFFSET(0xE05B220)
#define RPG_CLIENT_SCENETRANSFORMANIM__CTOR_OFFSET UNITYSDK_OFFSET(0xE05B230)
