...
#define RPG_CLIENT_TEAMBUILDSYNOPSIS_CREATE_OFFSET UNITYSDK_OFFSET(0xC9F3600)
#define RPG_CLIENT_TEAMBUILDSYNOPSIS_GET_AVATARIDS_OFFSET UNITYSDK_OFFSET(0xC9F35F0)
#define RPG_CLIENT_TEAMBUILDSYNOPSIS__CTOR_OFFSET UNITYSDK_OFFSET(0xC9F3C60)

namespace RPG::Client
{
	inline static constexpr unsigned int TeamBuildSynopsis_TypeDefinitionIndex = 63715;
