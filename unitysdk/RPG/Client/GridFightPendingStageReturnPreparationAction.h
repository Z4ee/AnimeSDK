...
#define RPG_CLIENT_GRIDFIGHTPENDINGSTAGERETURNPREPARATIONACTION_HANDLE_OFFSET UNITYSDK_OFFSET(0x987B210)
#define RPG_CLIENT_GRIDFIGHTPENDINGSTAGERETURNPREPARATIONACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x987B200)
#define RPG_CLIENT_GRIDFIGHTPENDINGSTAGERETURNPREPARATIONACTION___IFIXBASEPROXY_HANDLE_OFFSET UNITYSDK_OFFSET(0x987B300)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightPendingStageReturnPreparationAction_TypeDefinitionIndex = 52509;
