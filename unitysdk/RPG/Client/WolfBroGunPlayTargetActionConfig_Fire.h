...
#define RPG_CLIENT_WOLFBROGUNPLAYTARGETACTIONCONFIG_FIRE_METHOD_2_47FCE72550F759BF_OFFSET UNITYSDK_OFFSET(0x17427E30)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGETACTIONCONFIG_FIRE__CTOR_OFFSET UNITYSDK_OFFSET(0x17427EB0)

namespace RPG::Client
{
	inline static constexpr unsigned int WolfBroGunPlayTargetActionConfig_Fire_TypeDefinitionIndex = 65642;
