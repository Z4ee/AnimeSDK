...
#define RPG_CLIENT_WOLFBROGUNPLAYTARGETACTIONCONFIG_FIRE_METHOD_2_47FCE72550F759BF_OFFSET UNITYSDK_OFFSET(0xA794BA0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGETACTIONCONFIG_FIRE_METHOD_2_F8B73ECE7F883AC1_OFFSET UNITYSDK_OFFSET(0xA794C30)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGETACTIONCONFIG_FIRE__CTOR_OFFSET UNITYSDK_OFFSET(0xA794C20)

namespace RPG::Client
{
	inline static constexpr unsigned int WolfBroGunPlayTargetActionConfig_Fire_TypeDefinitionIndex = 56111;
