...
#define RPG_CLIENT_TRACKPHOTOSHOTPARAM_CREATE_OFFSET UNITYSDK_OFFSET(0x197C04A0)
#define RPG_CLIENT_TRACKPHOTOSHOTPARAM_GET_EXTRASCORE_OFFSET UNITYSDK_OFFSET(0x3AFDEF0)
#define RPG_CLIENT_TRACKPHOTOSHOTPARAM_GET_SCORE_OFFSET UNITYSDK_OFFSET(0x3AFDE90)

namespace RPG::Client
{
	inline static constexpr unsigned int TrackPhotoShotParam_TypeDefinitionIndex = 61022;
