...
#define RPG_CLIENT_TRACKPHOTOSHOTPARAM_CREATE_OFFSET UNITYSDK_OFFSET(0xA5E5890)
#define RPG_CLIENT_TRACKPHOTOSHOTPARAM_GET_EXTRASCORE_OFFSET UNITYSDK_OFFSET(0x84DD0)
#define RPG_CLIENT_TRACKPHOTOSHOTPARAM_GET_SCORE_OFFSET UNITYSDK_OFFSET(0x84D70)

namespace RPG::Client
{
	inline static constexpr unsigned int TrackPhotoShotParam_TypeDefinitionIndex = 49389;
