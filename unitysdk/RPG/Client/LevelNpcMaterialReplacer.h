...
#define RPG_CLIENT_LEVELNPCMATERIALREPLACER_CHANGENPCMATERIAL_OFFSET UNITYSDK_OFFSET(0xA6670E0)
#define RPG_CLIENT_LEVELNPCMATERIALREPLACER_METHOD_6_BFC434719CC16F3C_OFFSET UNITYSDK_OFFSET(0xA6673E0)
#define RPG_CLIENT_LEVELNPCMATERIALREPLACER_REPLACEMATERIAL_OFFSET UNITYSDK_OFFSET(0xA667280)
#define RPG_CLIENT_LEVELNPCMATERIALREPLACER__CTOR_OFFSET UNITYSDK_OFFSET(0xA667470)
#define RPG_CLIENT_LEVELNPCMATERIALREPLACER___IFIXBASEPROXY_REPLACEMATERIAL_OFFSET UNITYSDK_OFFSET(0xA667480)

namespace RPG::Client
{
	inline static constexpr unsigned int LevelNpcMaterialReplacer_TypeDefinitionIndex = 63642;
