...
#define RPG_CLIENT_OVERRIDELIGHTMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x9EB9D90)

namespace RPG::Client
{
	inline static constexpr unsigned int OverrideLightMonoPlugin_TypeDefinitionIndex = 57537;
