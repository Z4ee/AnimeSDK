...
#define RPG_CLIENT_ELATIONBATTLEBUFFGROUPVIEWDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1AC54000)
#define RPG_CLIENT_ELATIONBATTLEBUFFGROUPVIEWDATA_GET_BUFFVIEWDATAS_OFFSET UNITYSDK_OFFSET(0x1AC544B0)
#define RPG_CLIENT_ELATIONBATTLEBUFFGROUPVIEWDATA_GET_ELATIONECHOPOINTMAX_OFFSET UNITYSDK_OFFSET(0x1AC54490)
#define RPG_CLIENT_ELATIONBATTLEBUFFGROUPVIEWDATA_GET_GROUPDESC_OFFSET UNITYSDK_OFFSET(0x1AC54470)
#define RPG_CLIENT_ELATIONBATTLEBUFFGROUPVIEWDATA_GET_TOTALPOINT_OFFSET UNITYSDK_OFFSET(0x1AC54450)
#define RPG_CLIENT_ELATIONBATTLEBUFFGROUPVIEWDATA_SET_BUFFVIEWDATAS_OFFSET UNITYSDK_OFFSET(0x1AC544C0)
#define RPG_CLIENT_ELATIONBATTLEBUFFGROUPVIEWDATA_SET_ELATIONECHOPOINTMAX_OFFSET UNITYSDK_OFFSET(0x1AC544A0)
#define RPG_CLIENT_ELATIONBATTLEBUFFGROUPVIEWDATA_SET_GROUPDESC_OFFSET UNITYSDK_OFFSET(0x1AC54480)
#define RPG_CLIENT_ELATIONBATTLEBUFFGROUPVIEWDATA_SET_TOTALPOINT_OFFSET UNITYSDK_OFFSET(0x1AC54460)
#define RPG_CLIENT_ELATIONBATTLEBUFFGROUPVIEWDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC540B0)

namespace RPG::Client
{
	inline static constexpr unsigned int ElationBattleBuffGroupViewData_TypeDefinitionIndex = 71472;
	...
	public:
		...
		::System::Single _ElationEchoPointMax_k__BackingField; // 0x1C
