...
#define RPG_CLIENT_EFFECT_CHIPSCOLUMN_LATETICK_OFFSET UNITYSDK_OFFSET(0xA1C0AA0)
#define RPG_CLIENT_EFFECT_CHIPSCOLUMN_METHOD_5_2566AD459572DFC3_OFFSET UNITYSDK_OFFSET(0xA1C0BC0)
#define RPG_CLIENT_EFFECT_CHIPSCOLUMN_METHOD_5_F7300E87EC49A206_OFFSET UNITYSDK_OFFSET(0xA1C10B0)
#define RPG_CLIENT_EFFECT_CHIPSCOLUMN_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xA1C0A10)
#define RPG_CLIENT_EFFECT_CHIPSCOLUMN_ONENABLE_OFFSET UNITYSDK_OFFSET(0xA1C0980)
#define RPG_CLIENT_EFFECT_CHIPSCOLUMN__CTOR_OFFSET UNITYSDK_OFFSET(0xA1C1910)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_ChipsColumn_TypeDefinitionIndex = 64933;
