...
#define RPG_CLIENT_EFFECT_CHIPSCOLUMN_LATETICK_OFFSET UNITYSDK_OFFSET(0x953DD70)
#define RPG_CLIENT_EFFECT_CHIPSCOLUMN_METHOD_5_2566AD459572DFC3_OFFSET UNITYSDK_OFFSET(0x953DE90)
#define RPG_CLIENT_EFFECT_CHIPSCOLUMN_METHOD_5_F7300E87EC49A206_OFFSET UNITYSDK_OFFSET(0x953E380)
#define RPG_CLIENT_EFFECT_CHIPSCOLUMN_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x953DCE0)
#define RPG_CLIENT_EFFECT_CHIPSCOLUMN_ONENABLE_OFFSET UNITYSDK_OFFSET(0x953DC50)
#define RPG_CLIENT_EFFECT_CHIPSCOLUMN__CTOR_OFFSET UNITYSDK_OFFSET(0x953EBE0)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_ChipsColumn_TypeDefinitionIndex = 57669;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_EFFECT_CHIPSCOLUMN_METHOD_5_2566AD459572DFC3_OFFSET))(this);
		}
	};
}
