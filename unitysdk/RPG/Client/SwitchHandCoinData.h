...
#define RPG_CLIENT_SWITCHHANDCOINDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1B469F40)
#define RPG_CLIENT_SWITCHHANDCOINDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B46A300)

namespace RPG::Client
{
	inline static constexpr unsigned int SwitchHandCoinData_TypeDefinitionIndex = 67996;
