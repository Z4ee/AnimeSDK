...
#define RPG_CLIENT_GRIDFIGHTGAMEREFFILTER_GRIDFIGHTFILTERROLECONFIGCOMPARER_EQUALS_OFFSET UNITYSDK_OFFSET(0x1ABFAF50)
#define RPG_CLIENT_GRIDFIGHTGAMEREFFILTER_GRIDFIGHTFILTERROLECONFIGCOMPARER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1ABFAFC0)
#define RPG_CLIENT_GRIDFIGHTGAMEREFFILTER_GRIDFIGHTFILTERROLECONFIGCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABF9FC0)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightGameRefFilter_GridFightFilterRoleConfigComparer_TypeDefinitionIndex = 61834;
