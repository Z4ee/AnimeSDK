...
#define RPG_CLIENT_ROGUEMAGICRESIDENTACTIVITYPANELDATA_CREATEBYROW_OFFSET UNITYSDK_OFFSET(0xC7AD130)
#define RPG_CLIENT_ROGUEMAGICRESIDENTACTIVITYPANELDATA_GET_LOCKEDREASON_OFFSET UNITYSDK_OFFSET(0xC7AD830)
#define RPG_CLIENT_ROGUEMAGICRESIDENTACTIVITYPANELDATA_ISHIDEALLREDDOT_OFFSET UNITYSDK_OFFSET(0xC7AD7F0)
#define RPG_CLIENT_ROGUEMAGICRESIDENTACTIVITYPANELDATA_ISSHOWNEWREDDOT_OFFSET UNITYSDK_OFFSET(0xC7AD7B0)
#define RPG_CLIENT_ROGUEMAGICRESIDENTACTIVITYPANELDATA_ISSHOWNOPASSNORMALREDDOT_OFFSET UNITYSDK_OFFSET(0xC7AD770)
#define RPG_CLIENT_ROGUEMAGICRESIDENTACTIVITYPANELDATA_ISSHOWNORMALREDDOT_OFFSET UNITYSDK_OFFSET(0xC7AD220)
#define RPG_CLIENT_ROGUEMAGICRESIDENTACTIVITYPANELDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC7AD120)
#define RPG_CLIENT_ROGUEMAGICRESIDENTACTIVITYPANELDATA__ISSHOWHANDBOOKREWARDREDDOT_OFFSET UNITYSDK_OFFSET(0xC7AD3D0)
#define RPG_CLIENT_ROGUEMAGICRESIDENTACTIVITYPANELDATA__ISSHOWQUESTREWARDREDDOT_OFFSET UNITYSDK_OFFSET(0xC7AD330)
#define RPG_CLIENT_ROGUEMAGICRESIDENTACTIVITYPANELDATA__ISSHOWSTORYARCHIVEREWARDREDDOT_OFFSET UNITYSDK_OFFSET(0xC7AD6D0)
#define RPG_CLIENT_ROGUEMAGICRESIDENTACTIVITYPANELDATA___IFIXBASEPROXY_GET_LOCKEDREASON_OFFSET UNITYSDK_OFFSET(0xC7AD900)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueMagicResidentActivityPanelData_TypeDefinitionIndex = 57767;
