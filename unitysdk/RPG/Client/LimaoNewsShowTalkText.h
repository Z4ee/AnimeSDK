...
#define RPG_CLIENT_LIMAONEWSSHOWTALKTEXT_METHOD_4_2756ADFA7CFFC305_OFFSET UNITYSDK_OFFSET(0x16E85080)
#define RPG_CLIENT_LIMAONEWSSHOWTALKTEXT_METHOD_4_63BFD461BAF450D4_OFFSET UNITYSDK_OFFSET(0x16E85100)
#define RPG_CLIENT_LIMAONEWSSHOWTALKTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x16E850D0)

namespace RPG::Client
{
	inline static constexpr unsigned int LimaoNewsShowTalkText_TypeDefinitionIndex = 9942;
