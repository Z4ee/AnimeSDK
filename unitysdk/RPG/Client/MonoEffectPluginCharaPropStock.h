...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPSTOCK_INIT_OFFSET UNITYSDK_OFFSET(0xA984F10)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPSTOCK_UNINIT_OFFSET UNITYSDK_OFFSET(0xA985880)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPSTOCK_UPDATEPROPERTY_OFFSET UNITYSDK_OFFSET(0xA984FB0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPSTOCK__CTOR_OFFSET UNITYSDK_OFFSET(0xA985990)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPSTOCK___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0xA9859C0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginCharaPropStock_TypeDefinitionIndex = 64513;
