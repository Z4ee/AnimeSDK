...
#define RPG_CLIENT_WORLD3DMAPUTILS_GETWORLD3DMAPENTRANCECONFIGS_OFFSET UNITYSDK_OFFSET(0xE437B00)
#define RPG_CLIENT_WORLD3DMAPUTILS_PREPAREWORLD3DMAPENTRANCESUBMISSIONDATA_OFFSET UNITYSDK_OFFSET(0xE4380C0)
#define RPG_CLIENT_WORLD3DMAPUTILS__CHECKENTRANCECONFIGCONDITIONWITHOUTEARLYACCESS_OFFSET UNITYSDK_OFFSET(0xE437FC0)
#define RPG_CLIENT_WORLD3DMAPUTILS__CHECKENTRANCECONFIGCONDITION_OFFSET UNITYSDK_OFFSET(0xE438050)
#define RPG_CLIENT_WORLD3DMAPUTILS__CHECKSUBMISSIONCONDITION_OFFSET UNITYSDK_OFFSET(0xE438310)
#define RPG_CLIENT_WORLD3DMAPUTILS__ISMISSIONBEFORECONTENTRELEASECONDITION_OFFSET UNITYSDK_OFFSET(0xE438720)
#define RPG_CLIENT_WORLD3DMAPUTILS__ISSUBMISSIONBEFORECURRENT_OFFSET UNITYSDK_OFFSET(0xE4388D0)
