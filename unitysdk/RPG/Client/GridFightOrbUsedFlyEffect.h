...
#define RPG_CLIENT_GRIDFIGHTORBUSEDFLYEFFECT_DESPAWNED_OFFSET UNITYSDK_OFFSET(0x98789D0)
#define RPG_CLIENT_GRIDFIGHTORBUSEDFLYEFFECT_ONCREATE_OFFSET UNITYSDK_OFFSET(0x98786F0)
#define RPG_CLIENT_GRIDFIGHTORBUSEDFLYEFFECT_PLAY_OFFSET UNITYSDK_OFFSET(0x9878A10)
#define RPG_CLIENT_GRIDFIGHTORBUSEDFLYEFFECT_SPAWNED_OFFSET UNITYSDK_OFFSET(0x9878990)
#define RPG_CLIENT_GRIDFIGHTORBUSEDFLYEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x9878C80)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightOrbUsedFlyEffect_TypeDefinitionIndex = 52396;
