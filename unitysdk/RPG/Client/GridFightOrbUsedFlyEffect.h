...
#define RPG_CLIENT_GRIDFIGHTORBUSEDFLYEFFECT_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xBBC3B60)
#define RPG_CLIENT_GRIDFIGHTORBUSEDFLYEFFECT_ONCREATE_OFFSET UNITYSDK_OFFSET(0xBBC3880)
#define RPG_CLIENT_GRIDFIGHTORBUSEDFLYEFFECT_PLAY_OFFSET UNITYSDK_OFFSET(0xBBC3BA0)
#define RPG_CLIENT_GRIDFIGHTORBUSEDFLYEFFECT_SPAWNED_OFFSET UNITYSDK_OFFSET(0xBBC3B20)
#define RPG_CLIENT_GRIDFIGHTORBUSEDFLYEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xBBC3E00)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightOrbUsedFlyEffect_TypeDefinitionIndex = 60287;
