...
#define RPG_CLIENT_COROUTINEUTILS___INVOKEAFTERSECONDSCOROUTINE_D__29_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1E58E660)
#define RPG_CLIENT_COROUTINEUTILS___INVOKEAFTERSECONDSCOROUTINE_D__29_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1E58E700)
#define RPG_CLIENT_COROUTINEUTILS___INVOKEAFTERSECONDSCOROUTINE_D__29_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1E58E760)
#define RPG_CLIENT_COROUTINEUTILS___INVOKEAFTERSECONDSCOROUTINE_D__29_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1E58E710)
#define RPG_CLIENT_COROUTINEUTILS___INVOKEAFTERSECONDSCOROUTINE_D__29_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E58E650)
#define RPG_CLIENT_COROUTINEUTILS___INVOKEAFTERSECONDSCOROUTINE_D__29__CTOR_OFFSET UNITYSDK_OFFSET(0x1E58DFE0)
