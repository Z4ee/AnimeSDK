...
#define RPG_CLIENT_GRIDFIGHTPROJECTION__GETALLTRAITS_D__48_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1AEA5830)
#define RPG_CLIENT_GRIDFIGHTPROJECTION__GETALLTRAITS_D__48_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_RPG_CLIENT_GRIDFIGHTTRAIT__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1AEA5BC0)
#define RPG_CLIENT_GRIDFIGHTPROJECTION__GETALLTRAITS_D__48_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_RPG_CLIENT_GRIDFIGHTTRAIT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AEA5B50)
#define RPG_CLIENT_GRIDFIGHTPROJECTION__GETALLTRAITS_D__48_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1AEA5C40)
#define RPG_CLIENT_GRIDFIGHTPROJECTION__GETALLTRAITS_D__48_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AEA5BB0)
#define RPG_CLIENT_GRIDFIGHTPROJECTION__GETALLTRAITS_D__48_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1AEA5B60)
#define RPG_CLIENT_GRIDFIGHTPROJECTION__GETALLTRAITS_D__48_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AEA5820)
#define RPG_CLIENT_GRIDFIGHTPROJECTION__GETALLTRAITS_D__48__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEA5540)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightProjection__GetAllTraits_d__48_TypeDefinitionIndex = 62154;
