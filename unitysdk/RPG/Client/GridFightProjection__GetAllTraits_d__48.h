...
#define RPG_CLIENT_GRIDFIGHTPROJECTION__GETALLTRAITS_D__48_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xD2EF670)
#define RPG_CLIENT_GRIDFIGHTPROJECTION__GETALLTRAITS_D__48_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_RPG_CLIENT_GRIDFIGHTTRAIT__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xD2EFA00)
#define RPG_CLIENT_GRIDFIGHTPROJECTION__GETALLTRAITS_D__48_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_RPG_CLIENT_GRIDFIGHTTRAIT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xD2EF990)
#define RPG_CLIENT_GRIDFIGHTPROJECTION__GETALLTRAITS_D__48_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xD2EFA80)
#define RPG_CLIENT_GRIDFIGHTPROJECTION__GETALLTRAITS_D__48_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xD2EF9F0)
#define RPG_CLIENT_GRIDFIGHTPROJECTION__GETALLTRAITS_D__48_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xD2EF9A0)
#define RPG_CLIENT_GRIDFIGHTPROJECTION__GETALLTRAITS_D__48_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD2EF660)
#define RPG_CLIENT_GRIDFIGHTPROJECTION__GETALLTRAITS_D__48__CTOR_OFFSET UNITYSDK_OFFSET(0xD2EF380)
