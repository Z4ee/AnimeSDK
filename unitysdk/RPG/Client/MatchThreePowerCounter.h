...
#define RPG_CLIENT_MATCHTHREEPOWERCOUNTER_DESPAWNED_OFFSET UNITYSDK_OFFSET(0x9B4B4A0)
#define RPG_CLIENT_MATCHTHREEPOWERCOUNTER_ONCREATE_OFFSET UNITYSDK_OFFSET(0x9B4B4E0)
#define RPG_CLIENT_MATCHTHREEPOWERCOUNTER_PLAY_1_OFFSET UNITYSDK_OFFSET(0x9B4BB50)
#define RPG_CLIENT_MATCHTHREEPOWERCOUNTER_PLAY_OFFSET UNITYSDK_OFFSET(0x9B4B710)
#define RPG_CLIENT_MATCHTHREEPOWERCOUNTER_SETSIZE_OFFSET UNITYSDK_OFFSET(0x9B4B690)
#define RPG_CLIENT_MATCHTHREEPOWERCOUNTER_SPAWNED_OFFSET UNITYSDK_OFFSET(0x9B4B460)
#define RPG_CLIENT_MATCHTHREEPOWERCOUNTER__CTOR_OFFSET UNITYSDK_OFFSET(0x9B4BCD0)

namespace RPG::Client
{
	inline static constexpr unsigned int MatchThreePowerCounter_TypeDefinitionIndex = 53582;
