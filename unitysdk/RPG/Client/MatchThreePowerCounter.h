...
#define RPG_CLIENT_MATCHTHREEPOWERCOUNTER_DESPAWNED_OFFSET UNITYSDK_OFFSET(0x1AB74810)
#define RPG_CLIENT_MATCHTHREEPOWERCOUNTER_ONCREATE_OFFSET UNITYSDK_OFFSET(0x1AB74850)
#define RPG_CLIENT_MATCHTHREEPOWERCOUNTER_PLAY_1_OFFSET UNITYSDK_OFFSET(0x1AB74EE0)
#define RPG_CLIENT_MATCHTHREEPOWERCOUNTER_PLAY_OFFSET UNITYSDK_OFFSET(0x1AB74A80)
#define RPG_CLIENT_MATCHTHREEPOWERCOUNTER_SETSIZE_OFFSET UNITYSDK_OFFSET(0x1AB74A00)
#define RPG_CLIENT_MATCHTHREEPOWERCOUNTER_SPAWNED_OFFSET UNITYSDK_OFFSET(0x1AB747D0)
#define RPG_CLIENT_MATCHTHREEPOWERCOUNTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB75040)

namespace RPG::Client
{
	inline static constexpr unsigned int MatchThreePowerCounter_TypeDefinitionIndex = 63022;
	...
	public:
		...
		::UnityEngine::Animation* Field_5_2; // 0x28
