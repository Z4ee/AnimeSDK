...
#define RPG_CLIENT_STATEPARAMMODIFIER_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0x1A5011A0)
#define RPG_CLIENT_STATEPARAMMODIFIER_ONSTATEEXIT_OFFSET UNITYSDK_OFFSET(0x1A5013C0)
#define RPG_CLIENT_STATEPARAMMODIFIER_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1A501280)
#define RPG_CLIENT_STATEPARAMMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5014A0)
