...
#define RPG_CLIENT_ALLEYCONSTVALUE_INIT_OFFSET UNITYSDK_OFFSET(0x9CF8FF0)
#define RPG_CLIENT_ALLEYCONSTVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x9CF9710)

namespace RPG::Client
{
	inline static constexpr unsigned int AlleyConstValue_TypeDefinitionIndex = 57425;
	...
	public:
		...
		::System::String* FundItemIconPath; // 0x20
		::System::UInt32 StampItemID; // 0x28
		::System::UInt32 AlleySpecialOrderStartEventID; // 0x2C
		::System::UInt32 TutorialOrderID; // 0x30
		::System::UInt32 RenownUnlockMission; // 0x34
		::System::UInt32 RepeatUnlockMissionID; // 0x38
		::System::UInt32 AlleyOrderBasicProfitRatio; // 0x3C
		::System::UInt32 TotalOrderNum; // 0x40
		::System::UInt32 CurrencyConfigID; // 0x44
