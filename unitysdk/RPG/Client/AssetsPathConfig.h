...
#define RPG_CLIENT_ASSETSPATHCONFIG_METHOD_3_2CBE0B79DD36047E_OFFSET UNITYSDK_OFFSET(0xB32ECE0)
#define RPG_CLIENT_ASSETSPATHCONFIG_METHOD_3_3543E185ADE7267F_1_OFFSET UNITYSDK_OFFSET(0xB32F2C0)
#define RPG_CLIENT_ASSETSPATHCONFIG_METHOD_3_3543E185ADE7267F_OFFSET UNITYSDK_OFFSET(0xB32F130)
#define RPG_CLIENT_ASSETSPATHCONFIG_METHOD_3_8830D8EC8431D81A_OFFSET UNITYSDK_OFFSET(0xB32F200)
#define RPG_CLIENT_ASSETSPATHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xB32F390)

namespace RPG::Client
{
	inline static constexpr unsigned int AssetsPathConfig_TypeDefinitionIndex = 56110;
