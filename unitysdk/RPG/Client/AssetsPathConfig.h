...
#define RPG_CLIENT_ASSETSPATHCONFIG_METHOD_3_3543E185ADE7267F_1_OFFSET UNITYSDK_OFFSET(0x90DD760)
#define RPG_CLIENT_ASSETSPATHCONFIG_METHOD_3_3543E185ADE7267F_OFFSET UNITYSDK_OFFSET(0x90DD5A0)
#define RPG_CLIENT_ASSETSPATHCONFIG_METHOD_3_8830D8EC8431D81A_OFFSET UNITYSDK_OFFSET(0x90DD690)
#define RPG_CLIENT_ASSETSPATHCONFIG_METHOD_3_E693A0026D178D8E_OFFSET UNITYSDK_OFFSET(0x90DD150)
#define RPG_CLIENT_ASSETSPATHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x90DD850)

namespace RPG::Client
{
	inline static constexpr unsigned int AssetsPathConfig_TypeDefinitionIndex = 48627;
