...
#define RPG_CLIENT_MONOREMAINTIMERTEXT_AWAKE_OFFSET UNITYSDK_OFFSET(0x9D2F2B0)
#define RPG_CLIENT_MONOREMAINTIMERTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x9D2F860)
#define RPG_CLIENT_MONOREMAINTIMERTEXT__LOADPALETTE_OFFSET UNITYSDK_OFFSET(0x9D2F400)
#define RPG_CLIENT_MONOREMAINTIMERTEXT__ONREMAINTIMEEXPIRED_OFFSET UNITYSDK_OFFSET(0x9D2F7F0)
#define RPG_CLIENT_MONOREMAINTIMERTEXT__ONREMAINTIMEUPDATED_OFFSET UNITYSDK_OFFSET(0x9D2F540)
#define RPG_CLIENT_MONOREMAINTIMERTEXT__SETREMAINTIMETEXT_OFFSET UNITYSDK_OFFSET(0x9D2F5A0)
#define RPG_CLIENT_MONOREMAINTIMERTEXT__TRYINITPALETTE_OFFSET UNITYSDK_OFFSET(0x9D2F3A0)
#define RPG_CLIENT_MONOREMAINTIMERTEXT___IFIXBASEPROXY__ONREMAINTIMEEXPIRED_OFFSET UNITYSDK_OFFSET(0x9D2F8F0)
#define RPG_CLIENT_MONOREMAINTIMERTEXT___IFIXBASEPROXY__ONREMAINTIMEUPDATED_OFFSET UNITYSDK_OFFSET(0x9D2F8A0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoRemainTimerText_TypeDefinitionIndex = 59498;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_MONOREMAINTIMERTEXT___IFIXBASEPROXY__ONREMAINTIMEEXPIRED_OFFSET))(this);
		}
	};
}
