...
#define RPG_CLIENT_ADVENTUREPHASE___C__DISPLAYCLASS229_0__CTOR_OFFSET UNITYSDK_OFFSET(0x19DE1DB0)
#define RPG_CLIENT_ADVENTUREPHASE___C__DISPLAYCLASS229_0___PRELOAD_B__0_OFFSET UNITYSDK_OFFSET(0x19DE1DC0)

namespace RPG::Client
{
	inline static constexpr unsigned int AdventurePhase___c__DisplayClass229_0_TypeDefinitionIndex = 60258;
