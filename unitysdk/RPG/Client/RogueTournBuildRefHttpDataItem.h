...
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_CLEAR_OFFSET UNITYSDK_OFFSET(0xA36FC80)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA36FDC0)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_APPLIEDCOUNTFORSORT_OFFSET UNITYSDK_OFFSET(0xA370430)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_AUTHOR_OFFSET UNITYSDK_OFFSET(0xA3701D0)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_BUILDREFID_OFFSET UNITYSDK_OFFSET(0xA36FFE0)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_ESSENTIALFORMULAS_OFFSET UNITYSDK_OFFSET(0xA370270)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_ESSENTIALHEXMIRACLES_OFFSET UNITYSDK_OFFSET(0xA370330)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_FAVORITECOUNTFORSORT_OFFSET UNITYSDK_OFFSET(0xA370450)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_GAMEMAJORVERSIONFORSORT_OFFSET UNITYSDK_OFFSET(0xA3704B0)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_GAMEMINORVERSIONFORSORT_OFFSET UNITYSDK_OFFSET(0xA3704D0)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_ISLIKE_OFFSET UNITYSDK_OFFSET(0xA3703F0)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_LANGUAGE_OFFSET UNITYSDK_OFFSET(0xA3701F0)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_LIKECOUNTFORSORT_OFFSET UNITYSDK_OFFSET(0xA370470)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_LIKECOUNT_OFFSET UNITYSDK_OFFSET(0xA370410)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_OPTIONALFORMULAS_OFFSET UNITYSDK_OFFSET(0xA3702D0)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_OPTIONALHEXMIRACLES_OFFSET UNITYSDK_OFFSET(0xA370390)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_TEAMS_OFFSET UNITYSDK_OFFSET(0xA370210)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_TITLE_OFFSET UNITYSDK_OFFSET(0xA3701B0)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_UNIONINDEX_OFFSET UNITYSDK_OFFSET(0xA370010)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_GET_WEIGHTFORSORT_OFFSET UNITYSDK_OFFSET(0xA370490)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_SETCONTENT_OFFSET UNITYSDK_OFFSET(0xA36FE30)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_SET_APPLIEDCOUNTFORSORT_OFFSET UNITYSDK_OFFSET(0xA370440)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_SET_AUTHOR_OFFSET UNITYSDK_OFFSET(0xA3701E0)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_SET_BUILDREFID_OFFSET UNITYSDK_OFFSET(0xA370000)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_SET_FAVORITECOUNTFORSORT_OFFSET UNITYSDK_OFFSET(0xA370460)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_SET_GAMEMAJORVERSIONFORSORT_OFFSET UNITYSDK_OFFSET(0xA3704C0)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_SET_GAMEMINORVERSIONFORSORT_OFFSET UNITYSDK_OFFSET(0xA3704E0)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_SET_ISLIKE_OFFSET UNITYSDK_OFFSET(0xA370400)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_SET_LANGUAGE_OFFSET UNITYSDK_OFFSET(0xA370200)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_SET_LIKECOUNTFORSORT_OFFSET UNITYSDK_OFFSET(0xA370480)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_SET_LIKECOUNT_OFFSET UNITYSDK_OFFSET(0xA370420)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_SET_TITLE_OFFSET UNITYSDK_OFFSET(0xA3701C0)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_SET_WEIGHTFORSORT_OFFSET UNITYSDK_OFFSET(0xA3704A0)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_SYNCINTERACTDATA_OFFSET UNITYSDK_OFFSET(0xA36FE80)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_SYNCISLIKE_OFFSET UNITYSDK_OFFSET(0xA36FEE0)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM_TOSTRING_OFFSET UNITYSDK_OFFSET(0xA36F970)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xA36F960)
#define RPG_CLIENT_ROGUETOURNBUILDREFHTTPDATAITEM___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0xA3704F0)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueTournBuildRefHttpDataItem_TypeDefinitionIndex = 55025;
	...
	public:
		...
		::System::UInt32 _GameMajorVersionForSort_k__BackingField; // 0x30
		::System::Boolean _IsLike_k__BackingField; // 0x34
		::System::UInt64 _LikeCount_k__BackingField; // 0x38
		::System::Double _WeightForSort_k__BackingField; // 0x40
		::RPG::Client::MongoObjectId _BuildRefID_k__BackingField; // 0x48
		::System::UInt32 _GameMinorVersionForSort_k__BackingField; // 0x54
