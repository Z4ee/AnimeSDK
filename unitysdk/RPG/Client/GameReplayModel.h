...
#define RPG_CLIENT_GAMEREPLAYMODEL_METHOD_1_A17E43A2B3CD15D8_OFFSET UNITYSDK_OFFSET(0x1AD8F740)
#define RPG_CLIENT_GAMEREPLAYMODEL_METHOD_1_F012FBFFC9656E9C_OFFSET UNITYSDK_OFFSET(0x1AD8F600)
#define RPG_CLIENT_GAMEREPLAYMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD8F8C0)

namespace RPG::Client
{
	inline static constexpr unsigned int GameReplayModel_TypeDefinitionIndex = 61072;
