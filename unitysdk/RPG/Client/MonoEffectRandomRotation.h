...
#define RPG_CLIENT_MONOEFFECTRANDOMROTATION_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xA9A85C0)
#define RPG_CLIENT_MONOEFFECTRANDOMROTATION__CTOR_OFFSET UNITYSDK_OFFSET(0xA9A8610)
#define RPG_CLIENT_MONOEFFECTRANDOMROTATION___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xA9A8630)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectRandomRotation_TypeDefinitionIndex = 63249;
