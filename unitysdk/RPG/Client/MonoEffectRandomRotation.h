...
#define RPG_CLIENT_MONOEFFECTRANDOMROTATION_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x9CE5290)
#define RPG_CLIENT_MONOEFFECTRANDOMROTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x9CE52E0)
#define RPG_CLIENT_MONOEFFECTRANDOMROTATION___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x9CE5300)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectRandomRotation_TypeDefinitionIndex = 56006;
