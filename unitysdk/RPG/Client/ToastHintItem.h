...
#define RPG_CLIENT_TOASTHINTITEM_AWAKE_OFFSET UNITYSDK_OFFSET(0x178AA560)
#define RPG_CLIENT_TOASTHINTITEM_FADEIN_OFFSET UNITYSDK_OFFSET(0x178AA480)
#define RPG_CLIENT_TOASTHINTITEM_FADEOUT_OFFSET UNITYSDK_OFFSET(0x178AA4F0)
#define RPG_CLIENT_TOASTHINTITEM_GET_ANIMATING_OFFSET UNITYSDK_OFFSET(0x178AA8B0)
#define RPG_CLIENT_TOASTHINTITEM_GET_CURSTATUS_OFFSET UNITYSDK_OFFSET(0x178AA870)
#define RPG_CLIENT_TOASTHINTITEM_GET_HEIGHT_OFFSET UNITYSDK_OFFSET(0x178AA7E0)
#define RPG_CLIENT_TOASTHINTITEM_GET_LIFETIME_OFFSET UNITYSDK_OFFSET(0x178AA830)
#define RPG_CLIENT_TOASTHINTITEM_GET_POSITIONINDEX_OFFSET UNITYSDK_OFFSET(0x178AA850)
#define RPG_CLIENT_TOASTHINTITEM_GET_TIMEPOINT_OFFSET UNITYSDK_OFFSET(0x178AA890)
#define RPG_CLIENT_TOASTHINTITEM_HIDE_OFFSET UNITYSDK_OFFSET(0x178AA0B0)
#define RPG_CLIENT_TOASTHINTITEM_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x178A9F40)
#define RPG_CLIENT_TOASTHINTITEM_METHOD_5_14045882BC5C6CA9_OFFSET UNITYSDK_OFFSET(0x178AA340)
#define RPG_CLIENT_TOASTHINTITEM_METHOD_5_3CA62E1B04B7F162_OFFSET UNITYSDK_OFFSET(0x178AA6F0)
#define RPG_CLIENT_TOASTHINTITEM_METHOD_5_61CD3163D493FB64_OFFSET UNITYSDK_OFFSET(0x178AA140)
#define RPG_CLIENT_TOASTHINTITEM_METHOD_5_BD91A57DF699283A_OFFSET UNITYSDK_OFFSET(0x178AA290)
#define RPG_CLIENT_TOASTHINTITEM_SETPOSITIONY_OFFSET UNITYSDK_OFFSET(0x178AA020)
#define RPG_CLIENT_TOASTHINTITEM_SET_ANIMATING_OFFSET UNITYSDK_OFFSET(0x178AA8C0)
#define RPG_CLIENT_TOASTHINTITEM_SET_CURSTATUS_OFFSET UNITYSDK_OFFSET(0x178AA880)
#define RPG_CLIENT_TOASTHINTITEM_SET_LIFETIME_OFFSET UNITYSDK_OFFSET(0x178AA840)
#define RPG_CLIENT_TOASTHINTITEM_SET_POSITIONINDEX_OFFSET UNITYSDK_OFFSET(0x178AA860)
#define RPG_CLIENT_TOASTHINTITEM_SET_TIMEPOINT_OFFSET UNITYSDK_OFFSET(0x178AA8A0)
#define RPG_CLIENT_TOASTHINTITEM_SHOW_OFFSET UNITYSDK_OFFSET(0x178AA3A0)
#define RPG_CLIENT_TOASTHINTITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x178AA8D0)

namespace RPG::Client
{
	inline static constexpr unsigned int ToastHintItem_TypeDefinitionIndex = 69630;
