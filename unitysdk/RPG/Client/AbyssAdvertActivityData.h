...
#define RPG_CLIENT_ABYSSADVERTACTIVITYDATA_ISNEW_OFFSET UNITYSDK_OFFSET(0x8EC66D0)
#define RPG_CLIENT_ABYSSADVERTACTIVITYDATA_ISSHOWNORMALREDDOT_OFFSET UNITYSDK_OFFSET(0x8EC65F0)
#define RPG_CLIENT_ABYSSADVERTACTIVITYDATA_SYNCSCHEDULE_OFFSET UNITYSDK_OFFSET(0x8EC5D20)
#define RPG_CLIENT_ABYSSADVERTACTIVITYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x8EC5C50)
#define RPG_CLIENT_ABYSSADVERTACTIVITYDATA__ONSCHEDULEENDS_OFFSET UNITYSDK_OFFSET(0x8EC6780)
#define RPG_CLIENT_ABYSSADVERTACTIVITYDATA___IFIXBASEPROXY_ISNEW_OFFSET UNITYSDK_OFFSET(0x8EC68C0)
#define RPG_CLIENT_ABYSSADVERTACTIVITYDATA___IFIXBASEPROXY_ISSHOWNORMALREDDOT_OFFSET UNITYSDK_OFFSET(0x8EC6850)
#define RPG_CLIENT_ABYSSADVERTACTIVITYDATA___IFIXBASEPROXY_SYNCSCHEDULE_OFFSET UNITYSDK_OFFSET(0x8EC67D0)

namespace RPG::Client
{
	inline static constexpr unsigned int AbyssAdvertActivityData_TypeDefinitionIndex = 49952;
