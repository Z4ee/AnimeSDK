...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPEMISSION_INIT_OFFSET UNITYSDK_OFFSET(0xA9756D0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPEMISSION_UNINIT_OFFSET UNITYSDK_OFFSET(0xA9759D0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPEMISSION_UPDATEPROPERTY_OFFSET UNITYSDK_OFFSET(0xA975770)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPEMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0xA975A70)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPEMISSION___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0xA975A90)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPEMISSION___IFIXBASEPROXY_UNINIT_OFFSET UNITYSDK_OFFSET(0xA975AA0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginCharaPropEmission_TypeDefinitionIndex = 64486;
