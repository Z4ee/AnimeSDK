...
#define RPG_CLIENT_CHARAEYELIGHT_METHOD_5_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x9F659F0)
#define RPG_CLIENT_CHARAEYELIGHT_METHOD_5_A239DF324AF4215D_OFFSET UNITYSDK_OFFSET(0x9F65AA0)
#define RPG_CLIENT_CHARAEYELIGHT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x9F65930)
#define RPG_CLIENT_CHARAEYELIGHT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x9F65670)
#define RPG_CLIENT_CHARAEYELIGHT_SETEYEINTENSITY_OFFSET UNITYSDK_OFFSET(0x9F64A80)
#define RPG_CLIENT_CHARAEYELIGHT_UPDATE_OFFSET UNITYSDK_OFFSET(0x9F659A0)
#define RPG_CLIENT_CHARAEYELIGHT__CCTOR_OFFSET UNITYSDK_OFFSET(0x9F65BC0)
#define RPG_CLIENT_CHARAEYELIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x9F65BB0)

namespace RPG::Client
{
	inline static constexpr unsigned int CharaEyeLight_TypeDefinitionIndex = 64767;

	class CharaEyeLight : public ::UnityEngine::MonoBehaviour
	{
	public:
		static ::Il2CppArray<::System::Int32>** StaticGet_Field_5_10()
		{
			return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(CharaEyeLight_TypeDefinitionIndex)->GetStaticField(0x4B8B0);
		}
		...
		::UnityEngine::Renderer* Field_5_6; // 0x38
		::UnityEngine::Material* Field_5_7; // 0x40
		::UnityEngine::MaterialPropertyBlock* Field_5_8; // 0x48
		::System::Int32 Field_5_9; // 0x50
