...
#define RPG_CLIENT_CHARAEYELIGHT_METHOD_5_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x92FAF10)
#define RPG_CLIENT_CHARAEYELIGHT_METHOD_5_A239DF324AF4215D_OFFSET UNITYSDK_OFFSET(0x92FAFC0)
#define RPG_CLIENT_CHARAEYELIGHT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x92FAE50)
#define RPG_CLIENT_CHARAEYELIGHT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x92FAB90)
#define RPG_CLIENT_CHARAEYELIGHT_SETEYEINTENSITY_OFFSET UNITYSDK_OFFSET(0x92F9FA0)
#define RPG_CLIENT_CHARAEYELIGHT_UPDATE_OFFSET UNITYSDK_OFFSET(0x92FAEC0)
#define RPG_CLIENT_CHARAEYELIGHT__CCTOR_OFFSET UNITYSDK_OFFSET(0x92FB0E0)
#define RPG_CLIENT_CHARAEYELIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x92FB0D0)

namespace RPG::Client
{
	inline static constexpr unsigned int CharaEyeLight_TypeDefinitionIndex = 57504;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(CharaEyeLight_TypeDefinitionIndex)->GetStaticField(0x45680);
		}
