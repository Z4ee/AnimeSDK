...
#define RPG_CLIENT_UIADJUSTMAINCAMERAVIEWPORT_METHOD_5_9AFCA18B112F248A_OFFSET UNITYSDK_OFFSET(0x16FE9420)
#define RPG_CLIENT_UIADJUSTMAINCAMERAVIEWPORT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x16FE93B0)
#define RPG_CLIENT_UIADJUSTMAINCAMERAVIEWPORT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x16FE8E30)
#define RPG_CLIENT_UIADJUSTMAINCAMERAVIEWPORT_REFRESHADJUSTMENT_OFFSET UNITYSDK_OFFSET(0x16FE8F00)
#define RPG_CLIENT_UIADJUSTMAINCAMERAVIEWPORT__CTOR_OFFSET UNITYSDK_OFFSET(0x16FE9470)

namespace RPG::Client
{
	inline static constexpr unsigned int UIAdjustMainCameraViewport_TypeDefinitionIndex = 72936;
