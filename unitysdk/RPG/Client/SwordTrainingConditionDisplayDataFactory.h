...
#define RPG_CLIENT_SWORDTRAININGCONDITIONDISPLAYDATAFACTORY_CREATECONDITIONDISPLAYDATALIST_OFFSET UNITYSDK_OFFSET(0x1B47DF90)
#define RPG_CLIENT_SWORDTRAININGCONDITIONDISPLAYDATAFACTORY__CREATEMULTICONDITIONDISPLAYDATA_OFFSET UNITYSDK_OFFSET(0x1B47E130)
#define RPG_CLIENT_SWORDTRAININGCONDITIONDISPLAYDATAFACTORY__CREATESINGLECONDITIONDISPLAYDATA_OFFSET UNITYSDK_OFFSET(0x1B47E380)
#define RPG_CLIENT_SWORDTRAININGCONDITIONDISPLAYDATAFACTORY__CREATESTATUSDISPLAYDATA_OFFSET UNITYSDK_OFFSET(0x1B47E3E0)
