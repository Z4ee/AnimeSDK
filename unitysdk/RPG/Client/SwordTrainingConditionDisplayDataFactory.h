...
#define RPG_CLIENT_SWORDTRAININGCONDITIONDISPLAYDATAFACTORY_CREATECONDITIONDISPLAYDATALIST_OFFSET UNITYSDK_OFFSET(0x19C67D50)
#define RPG_CLIENT_SWORDTRAININGCONDITIONDISPLAYDATAFACTORY__CREATEMULTICONDITIONDISPLAYDATA_OFFSET UNITYSDK_OFFSET(0x19C67EF0)
#define RPG_CLIENT_SWORDTRAININGCONDITIONDISPLAYDATAFACTORY__CREATESINGLECONDITIONDISPLAYDATA_OFFSET UNITYSDK_OFFSET(0x19C68140)
#define RPG_CLIENT_SWORDTRAININGCONDITIONDISPLAYDATAFACTORY__CREATESTATUSDISPLAYDATA_OFFSET UNITYSDK_OFFSET(0x19C681A0)

namespace RPG::Client
{
	inline static constexpr unsigned int SwordTrainingConditionDisplayDataFactory_TypeDefinitionIndex = 59184;
