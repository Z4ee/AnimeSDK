...
#define RPG_CLIENT_EFFECT_SETMOTIONVECTORPASSDISTANCE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xB8864C0)
#define RPG_CLIENT_EFFECT_SETMOTIONVECTORPASSDISTANCE_ONENABLE_OFFSET UNITYSDK_OFFSET(0xB886300)
#define RPG_CLIENT_EFFECT_SETMOTIONVECTORPASSDISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0xB8865C0)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_SetMotionVectorPassDistance_TypeDefinitionIndex = 65969;
