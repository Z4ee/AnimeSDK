...
#define RPG_CLIENT_EFFECT_SETMOTIONVECTORPASSDISTANCE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x15126250)
#define RPG_CLIENT_EFFECT_SETMOTIONVECTORPASSDISTANCE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x15126090)
#define RPG_CLIENT_EFFECT_SETMOTIONVECTORPASSDISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x15126350)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_SetMotionVectorPassDistance_TypeDefinitionIndex = 67394;
