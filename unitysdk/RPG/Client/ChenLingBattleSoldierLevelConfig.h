...
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG_GETALLDISPLAYPROPERTIES_OFFSET UNITYSDK_OFFSET(0xB5D9910)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG_GET_ATKSPD_OFFSET UNITYSDK_OFFSET(0xB5DA2A0)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG_GET_ATK_OFFSET UNITYSDK_OFFSET(0xB5DA120)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG_GET_BATTLESCOREFIX_OFFSET UNITYSDK_OFFSET(0xB5CD6A0)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG_GET_CRTDMG_OFFSET UNITYSDK_OFFSET(0xB5DA480)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG_GET_CRT_OFFSET UNITYSDK_OFFSET(0xB5DA420)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG_GET_FORMATIONTYPE_OFFSET UNITYSDK_OFFSET(0xB5CDC40)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG_GET_HP_OFFSET UNITYSDK_OFFSET(0xB5DA1E0)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0xB5D9600)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG_GET_MOVESPD_OFFSET UNITYSDK_OFFSET(0xB5DA360)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG_GET_NUM_OFFSET UNITYSDK_OFFSET(0xB5DA4E0)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG_GET_SOLDIERID_OFFSET UNITYSDK_OFFSET(0xB5D95E0)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG_GET_UNITIDLIST_OFFSET UNITYSDK_OFFSET(0xB5CD840)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG_GET__MAXLEVELUNITCONFIG_OFFSET UNITYSDK_OFFSET(0xB5D9690)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG_GET__ROW_OFFSET UNITYSDK_OFFSET(0xB5D9620)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0xB5D9610)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG_SET_SOLDIERID_OFFSET UNITYSDK_OFFSET(0xB5D95F0)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xB5D95A0)

namespace RPG::Client
{
	inline static constexpr unsigned int ChenLingBattleSoldierLevelConfig_TypeDefinitionIndex = 57454;
