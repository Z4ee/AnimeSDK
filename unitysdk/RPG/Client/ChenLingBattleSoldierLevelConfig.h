...
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG_GETALLDISPLAYPROPERTIES_OFFSET UNITYSDK_OFFSET(0x9350790)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG_GET_ATKSPD_OFFSET UNITYSDK_OFFSET(0x9350E90)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG_GET_ATK_OFFSET UNITYSDK_OFFSET(0x9350D10)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG_GET_BATTLESCOREFIX_OFFSET UNITYSDK_OFFSET(0x9351740)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG_GET_CRTDMG_OFFSET UNITYSDK_OFFSET(0x9351070)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG_GET_CRT_OFFSET UNITYSDK_OFFSET(0x9351010)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG_GET_FORMATIONTYPE_OFFSET UNITYSDK_OFFSET(0x93516C0)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG_GET_HP_OFFSET UNITYSDK_OFFSET(0x9350DD0)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x9350400)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG_GET_MOVESPD_OFFSET UNITYSDK_OFFSET(0x9350F50)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG_GET_NUM_OFFSET UNITYSDK_OFFSET(0x93510D0)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG_GET_SOLDIERID_OFFSET UNITYSDK_OFFSET(0x93503E0)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG_GET_UNITIDLIST_OFFSET UNITYSDK_OFFSET(0x9350710)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG_GET__MAXLEVELUNITCONFIG_OFFSET UNITYSDK_OFFSET(0x9350490)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG_GET__ROW_OFFSET UNITYSDK_OFFSET(0x9350420)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0x9350410)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG_SET_SOLDIERID_OFFSET UNITYSDK_OFFSET(0x93503F0)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERLEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x93501D0)

namespace RPG::Client
{
	inline static constexpr unsigned int ChenLingBattleSoldierLevelConfig_TypeDefinitionIndex = 49855;
