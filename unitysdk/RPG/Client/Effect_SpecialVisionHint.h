...
#define RPG_CLIENT_EFFECT_SPECIALVISIONHINT_METHOD_5_01509228E3A9577B_OFFSET UNITYSDK_OFFSET(0xB887ED0)
#define RPG_CLIENT_EFFECT_SPECIALVISIONHINT_METHOD_5_1CD1133DC003C11C_OFFSET UNITYSDK_OFFSET(0xB8873B0)
#define RPG_CLIENT_EFFECT_SPECIALVISIONHINT_METHOD_5_4389275F4099DE36_OFFSET UNITYSDK_OFFSET(0xB887FA0)
#define RPG_CLIENT_EFFECT_SPECIALVISIONHINT_METHOD_5_7744894CEC41BF06_OFFSET UNITYSDK_OFFSET(0xB886EE0)
#define RPG_CLIENT_EFFECT_SPECIALVISIONHINT_METHOD_5_D9BF9B27FAC3AAD2_OFFSET UNITYSDK_OFFSET(0xB887050)
#define RPG_CLIENT_EFFECT_SPECIALVISIONHINT_METHOD_5_F155B191B658A4B9_OFFSET UNITYSDK_OFFSET(0xB887A80)
#define RPG_CLIENT_EFFECT_SPECIALVISIONHINT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB887540)
#define RPG_CLIENT_EFFECT_SPECIALVISIONHINT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xB886FA0)
#define RPG_CLIENT_EFFECT_SPECIALVISIONHINT_ONENABLE_OFFSET UNITYSDK_OFFSET(0xB886E40)
#define RPG_CLIENT_EFFECT_SPECIALVISIONHINT_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0xB8875E0)
#define RPG_CLIENT_EFFECT_SPECIALVISIONHINT_UPDATE_OFFSET UNITYSDK_OFFSET(0xB887150)
#define RPG_CLIENT_EFFECT_SPECIALVISIONHINT__CTOR_OFFSET UNITYSDK_OFFSET(0xB888170)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_SpecialVisionHint_TypeDefinitionIndex = 65972;
