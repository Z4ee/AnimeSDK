...
#define RPG_CLIENT_EFFECT_SPECIALVISIONHINT_METHOD_5_1CD1133DC003C11C_OFFSET UNITYSDK_OFFSET(0xA202F30)
#define RPG_CLIENT_EFFECT_SPECIALVISIONHINT_METHOD_5_3FBFF32C81033F7A_OFFSET UNITYSDK_OFFSET(0xA2035D0)
#define RPG_CLIENT_EFFECT_SPECIALVISIONHINT_METHOD_5_4389275F4099DE36_OFFSET UNITYSDK_OFFSET(0xA203AA0)
#define RPG_CLIENT_EFFECT_SPECIALVISIONHINT_METHOD_5_7443AD94E7275ABA_OFFSET UNITYSDK_OFFSET(0xA202BF0)
#define RPG_CLIENT_EFFECT_SPECIALVISIONHINT_METHOD_5_7744894CEC41BF06_OFFSET UNITYSDK_OFFSET(0xA202AB0)
#define RPG_CLIENT_EFFECT_SPECIALVISIONHINT_METHOD_5_DAE67D4DC8B67113_OFFSET UNITYSDK_OFFSET(0xA2039D0)
#define RPG_CLIENT_EFFECT_SPECIALVISIONHINT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xA2030B0)
#define RPG_CLIENT_EFFECT_SPECIALVISIONHINT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xA202B70)
#define RPG_CLIENT_EFFECT_SPECIALVISIONHINT_ONENABLE_OFFSET UNITYSDK_OFFSET(0xA202A30)
#define RPG_CLIENT_EFFECT_SPECIALVISIONHINT_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0xA203130)
#define RPG_CLIENT_EFFECT_SPECIALVISIONHINT_UPDATE_OFFSET UNITYSDK_OFFSET(0xA202CD0)
#define RPG_CLIENT_EFFECT_SPECIALVISIONHINT__CTOR_OFFSET UNITYSDK_OFFSET(0xA203C80)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_SpecialVisionHint_TypeDefinitionIndex = 65046;
