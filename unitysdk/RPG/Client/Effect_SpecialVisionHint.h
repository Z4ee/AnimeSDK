...
#define RPG_CLIENT_EFFECT_SPECIALVISIONHINT_METHOD_5_01509228E3A9577B_OFFSET UNITYSDK_OFFSET(0x15127CC0)
#define RPG_CLIENT_EFFECT_SPECIALVISIONHINT_METHOD_5_1CD1133DC003C11C_OFFSET UNITYSDK_OFFSET(0x15127170)
#define RPG_CLIENT_EFFECT_SPECIALVISIONHINT_METHOD_5_4389275F4099DE36_OFFSET UNITYSDK_OFFSET(0x15127D90)
#define RPG_CLIENT_EFFECT_SPECIALVISIONHINT_METHOD_5_7744894CEC41BF06_OFFSET UNITYSDK_OFFSET(0x15126CA0)
#define RPG_CLIENT_EFFECT_SPECIALVISIONHINT_METHOD_5_D9BF9B27FAC3AAD2_OFFSET UNITYSDK_OFFSET(0x15126E10)
#define RPG_CLIENT_EFFECT_SPECIALVISIONHINT_METHOD_5_F155B191B658A4B9_OFFSET UNITYSDK_OFFSET(0x15127870)
#define RPG_CLIENT_EFFECT_SPECIALVISIONHINT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x15127300)
#define RPG_CLIENT_EFFECT_SPECIALVISIONHINT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x15126D60)
#define RPG_CLIENT_EFFECT_SPECIALVISIONHINT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x15126C00)
#define RPG_CLIENT_EFFECT_SPECIALVISIONHINT_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x151273A0)
#define RPG_CLIENT_EFFECT_SPECIALVISIONHINT_UPDATE_OFFSET UNITYSDK_OFFSET(0x15126F10)
#define RPG_CLIENT_EFFECT_SPECIALVISIONHINT__CTOR_OFFSET UNITYSDK_OFFSET(0x15127F60)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_SpecialVisionHint_TypeDefinitionIndex = 67397;
