...
#define RPG_CLIENT_UI3DLINKREGISTRY_ENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x6B85C0)

namespace RPG::Client
{
	inline static constexpr unsigned int UI3DLinkRegistry_Entry_TypeDefinitionIndex = 72921;
