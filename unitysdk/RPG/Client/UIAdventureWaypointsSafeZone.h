...
#define RPG_CLIENT_UIADVENTUREWAYPOINTSSAFEZONE_METHOD_1_0BD0714BE5D6FE72_OFFSET UNITYSDK_OFFSET(0xA6733C0)
#define RPG_CLIENT_UIADVENTUREWAYPOINTSSAFEZONE_METHOD_1_16CE38D4976EB720_OFFSET UNITYSDK_OFFSET(0xA6735B0)
#define RPG_CLIENT_UIADVENTUREWAYPOINTSSAFEZONE_METHOD_1_28FA93E83BA2E9D5_OFFSET UNITYSDK_OFFSET(0xA673140)
#define RPG_CLIENT_UIADVENTUREWAYPOINTSSAFEZONE_METHOD_1_54078F5E87FE9B49_OFFSET UNITYSDK_OFFSET(0xA672030)
#define RPG_CLIENT_UIADVENTUREWAYPOINTSSAFEZONE_METHOD_1_56B2E27E517339A0_OFFSET UNITYSDK_OFFSET(0xA6732B0)
#define RPG_CLIENT_UIADVENTUREWAYPOINTSSAFEZONE_METHOD_1_62DF1EBE90234E13_OFFSET UNITYSDK_OFFSET(0xA671B90)
#define RPG_CLIENT_UIADVENTUREWAYPOINTSSAFEZONE_METHOD_1_A79387F1F80CA62C_OFFSET UNITYSDK_OFFSET(0xA672F70)
#define RPG_CLIENT_UIADVENTUREWAYPOINTSSAFEZONE_METHOD_1_AB145FEC5E4E4D0D_OFFSET UNITYSDK_OFFSET(0xA673050)
#define RPG_CLIENT_UIADVENTUREWAYPOINTSSAFEZONE_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xA671A00)
#define RPG_CLIENT_UIADVENTUREWAYPOINTSSAFEZONE__CTOR_OFFSET UNITYSDK_OFFSET(0xA673680)

namespace RPG::Client
{
	inline static constexpr unsigned int UIAdventureWaypointsSafeZone_TypeDefinitionIndex = 56437;
