...
#define RPG_CLIENT_UIADVENTUREWAYPOINTSSAFEZONE_METHOD_1_0BD0714BE5D6FE72_OFFSET UNITYSDK_OFFSET(0xB3CDB40)
#define RPG_CLIENT_UIADVENTUREWAYPOINTSSAFEZONE_METHOD_1_16CE38D4976EB720_OFFSET UNITYSDK_OFFSET(0xB3CDD30)
#define RPG_CLIENT_UIADVENTUREWAYPOINTSSAFEZONE_METHOD_1_28FA93E83BA2E9D5_OFFSET UNITYSDK_OFFSET(0xB3CD8C0)
#define RPG_CLIENT_UIADVENTUREWAYPOINTSSAFEZONE_METHOD_1_54078F5E87FE9B49_OFFSET UNITYSDK_OFFSET(0xB3CC7B0)
#define RPG_CLIENT_UIADVENTUREWAYPOINTSSAFEZONE_METHOD_1_56B2E27E517339A0_OFFSET UNITYSDK_OFFSET(0xB3CDA30)
#define RPG_CLIENT_UIADVENTUREWAYPOINTSSAFEZONE_METHOD_1_62DF1EBE90234E13_OFFSET UNITYSDK_OFFSET(0xB3CC310)
#define RPG_CLIENT_UIADVENTUREWAYPOINTSSAFEZONE_METHOD_1_A79387F1F80CA62C_OFFSET UNITYSDK_OFFSET(0xB3CD6F0)
#define RPG_CLIENT_UIADVENTUREWAYPOINTSSAFEZONE_METHOD_1_AB145FEC5E4E4D0D_OFFSET UNITYSDK_OFFSET(0xB3CD7D0)
#define RPG_CLIENT_UIADVENTUREWAYPOINTSSAFEZONE_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xB3CC180)
#define RPG_CLIENT_UIADVENTUREWAYPOINTSSAFEZONE__CTOR_OFFSET UNITYSDK_OFFSET(0xB3CDE00)

namespace RPG::Client
{
	inline static constexpr unsigned int UIAdventureWaypointsSafeZone_TypeDefinitionIndex = 63681;
