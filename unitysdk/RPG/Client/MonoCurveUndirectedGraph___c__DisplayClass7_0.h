...
#define RPG_CLIENT_MONOCURVEUNDIRECTEDGRAPH___C__DISPLAYCLASS7_0__CTOR_OFFSET UNITYSDK_OFFSET(0x19E41950)
#define RPG_CLIENT_MONOCURVEUNDIRECTEDGRAPH___C__DISPLAYCLASS7_0__GENERATECURVEEDGES_B__1_OFFSET UNITYSDK_OFFSET(0x19E41AC0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoCurveUndirectedGraph___c__DisplayClass7_0_TypeDefinitionIndex = 68543;

	class MonoCurveUndirectedGraph___c__DisplayClass7_0 : public ::System::Object
	{
	public:
		::System::Collections::Generic::List_1<::RPG::Client::CurveUndirectedEdgeSetting*>* settings; // 0x10
		::System::Predicate_1<::RPG::Client::CurveUndirectedEdge*>* __9__1; // 0x18
		::System::Int32 i; // 0x20
