...
#define RPG_CLIENT_VERSIONBANNERDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1C7FDF60)
#define RPG_CLIENT_VERSIONBANNERDATA_GET_CHAPTERID_OFFSET UNITYSDK_OFFSET(0x1C7FE070)
#define RPG_CLIENT_VERSIONBANNERDATA_GET_MISSIONTYPECOLOR_OFFSET UNITYSDK_OFFSET(0x1C7FE0C0)
#define RPG_CLIENT_VERSIONBANNERDATA_GET_MISSIONTYPE_OFFSET UNITYSDK_OFFSET(0x1C7FE020)
#define RPG_CLIENT_VERSIONBANNERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1C7FE010)

namespace RPG::Client
{
	inline static constexpr unsigned int VersionBannerData_TypeDefinitionIndex = 61764;
