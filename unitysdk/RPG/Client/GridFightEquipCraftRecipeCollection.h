...
#define RPG_CLIENT_GRIDFIGHTEQUIPCRAFTRECIPECOLLECTION_ADDRECIPE_OFFSET UNITYSDK_OFFSET(0xD170490)
#define RPG_CLIENT_GRIDFIGHTEQUIPCRAFTRECIPECOLLECTION_CANCRAFT_OFFSET UNITYSDK_OFFSET(0xD171580)
#define RPG_CLIENT_GRIDFIGHTEQUIPCRAFTRECIPECOLLECTION_GET_RECIPES_OFFSET UNITYSDK_OFFSET(0xD171710)
#define RPG_CLIENT_GRIDFIGHTEQUIPCRAFTRECIPECOLLECTION_GET_TARGETEQUIPITEMID_OFFSET UNITYSDK_OFFSET(0xD1716F0)
#define RPG_CLIENT_GRIDFIGHTEQUIPCRAFTRECIPECOLLECTION_SET_RECIPES_OFFSET UNITYSDK_OFFSET(0xD171720)
#define RPG_CLIENT_GRIDFIGHTEQUIPCRAFTRECIPECOLLECTION_SET_TARGETEQUIPITEMID_OFFSET UNITYSDK_OFFSET(0xD171700)
#define RPG_CLIENT_GRIDFIGHTEQUIPCRAFTRECIPECOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0xD170450)
