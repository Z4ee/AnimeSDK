...
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE_GENPROPERTYNAMELIST_OFFSET UNITYSDK_OFFSET(0xC4B0190)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE_GETCOLOR_OFFSET UNITYSDK_OFFSET(0xC4AE2D0)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE_GETFLOAT_OFFSET UNITYSDK_OFFSET(0xC4ADDB0)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE_GETSLOTID_OFFSET UNITYSDK_OFFSET(0xC4AE5A0)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE_GETVECTOR_OFFSET UNITYSDK_OFFSET(0xC4AE000)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0xC4AEB50)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE_ONPOLYMERREBUILDAFTERFADING_OFFSET UNITYSDK_OFFSET(0xC4AE670)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE_ONPOLYMERREBUILDBEFOREFADING_OFFSET UNITYSDK_OFFSET(0xC4AE800)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE_SETCOLOR_OFFSET UNITYSDK_OFFSET(0xC4AE420)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE_SETFLOAT_OFFSET UNITYSDK_OFFSET(0xC4ADED0)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE_SETVECTOR_OFFSET UNITYSDK_OFFSET(0xC4AE150)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE_TICK_OFFSET UNITYSDK_OFFSET(0xC4AEE40)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE_UPDATE_OFFSET UNITYSDK_OFFSET(0xC4AEDF0)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE__CTOR_OFFSET UNITYSDK_OFFSET(0xC4B0400)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE___IFIXBASEPROXY_ONPOLYMERREBUILDAFTERFADING_OFFSET UNITYSDK_OFFSET(0xC4B0420)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE___IFIXBASEPROXY_ONPOLYMERREBUILDBEFOREFADING_OFFSET UNITYSDK_OFFSET(0xC4B04D0)

namespace RPG::Client
{
	inline static constexpr unsigned int PolymerAnimationPropertyDatabase_TypeDefinitionIndex = 65729;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_303D5A33D1401D59*, ::RPG::Client::OpenWorld::StreamingItemData*, ::UnityEngine::GameObject*))((::PBYTE)hIl2Cpp + RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE___IFIXBASEPROXY_ONPOLYMERREBUILDAFTERFADING_OFFSET))(this, a1, a2, a3);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_303D5A33D1401D59*, ::RPG::Client::OpenWorld::StreamingItemData*, ::UnityEngine::GameObject*, ::UnityEngine::GameObject*))((::PBYTE)hIl2Cpp + RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE___IFIXBASEPROXY_ONPOLYMERREBUILDBEFOREFADING_OFFSET))(this, a1, a2, a3, a4);
		}
	};
}
