...
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE_GENPROPERTYNAMELIST_OFFSET UNITYSDK_OFFSET(0x1AE19800)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE_GETCOLOR_OFFSET UNITYSDK_OFFSET(0x1AE17940)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE_GETFLOAT_OFFSET UNITYSDK_OFFSET(0x1AE17420)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE_GETSLOTID_OFFSET UNITYSDK_OFFSET(0x1AE17C10)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE_GETVECTOR_OFFSET UNITYSDK_OFFSET(0x1AE17670)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1AE181C0)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE_ONPOLYMERREBUILDAFTERFADING_OFFSET UNITYSDK_OFFSET(0x1AE17CE0)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE_ONPOLYMERREBUILDBEFOREFADING_OFFSET UNITYSDK_OFFSET(0x1AE17E70)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE_SETCOLOR_OFFSET UNITYSDK_OFFSET(0x1AE17A90)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE_SETFLOAT_OFFSET UNITYSDK_OFFSET(0x1AE17540)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE_SETVECTOR_OFFSET UNITYSDK_OFFSET(0x1AE177C0)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE_TICK_OFFSET UNITYSDK_OFFSET(0x1AE184B0)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1AE18460)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE19A70)

namespace RPG::Client
{
	inline static constexpr unsigned int PolymerAnimationPropertyDatabase_TypeDefinitionIndex = 70263;
