...
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE_GENPROPERTYNAMELIST_OFFSET UNITYSDK_OFFSET(0x9FF29A0)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE_GETCOLOR_OFFSET UNITYSDK_OFFSET(0x9FF0C10)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE_GETFLOAT_OFFSET UNITYSDK_OFFSET(0x9FF06F0)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE_GETSLOTID_OFFSET UNITYSDK_OFFSET(0x9FF0EE0)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE_GETVECTOR_OFFSET UNITYSDK_OFFSET(0x9FF0940)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x9FF13F0)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE_ONPOLYMERREBUILDAFTERFADING_OFFSET UNITYSDK_OFFSET(0x9FF0F90)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE_ONPOLYMERREBUILDBEFOREFADING_OFFSET UNITYSDK_OFFSET(0x9FF1110)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE_SETCOLOR_OFFSET UNITYSDK_OFFSET(0x9FF0D60)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE_SETFLOAT_OFFSET UNITYSDK_OFFSET(0x9FF0810)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE_SETVECTOR_OFFSET UNITYSDK_OFFSET(0x9FF0A90)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE_TICK_OFFSET UNITYSDK_OFFSET(0x9FF1690)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE_UPDATE_OFFSET UNITYSDK_OFFSET(0x9FF1640)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE__CTOR_OFFSET UNITYSDK_OFFSET(0x9FF2B20)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE___IFIXBASEPROXY_ONPOLYMERREBUILDAFTERFADING_OFFSET UNITYSDK_OFFSET(0x9FF2B40)
#define RPG_CLIENT_POLYMERANIMATIONPROPERTYDATABASE___IFIXBASEPROXY_ONPOLYMERREBUILDBEFOREFADING_OFFSET UNITYSDK_OFFSET(0x9FF2BF0)

namespace RPG::Client
{
	inline static constexpr unsigned int PolymerAnimationPropertyDatabase_TypeDefinitionIndex = 57540;
