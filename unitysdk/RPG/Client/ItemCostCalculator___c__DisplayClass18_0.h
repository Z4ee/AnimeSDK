...
#define RPG_CLIENT_ITEMCOSTCALCULATOR___C__DISPLAYCLASS18_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA65D2F0)
#define RPG_CLIENT_ITEMCOSTCALCULATOR___C__DISPLAYCLASS18_0__GETITEMNEEDCOUNT_B__0_OFFSET UNITYSDK_OFFSET(0xA65DE10)
#define RPG_CLIENT_ITEMCOSTCALCULATOR___C__DISPLAYCLASS18_0__GETITEMNEEDCOUNT_B__1_OFFSET UNITYSDK_OFFSET(0xA65DDF0)

namespace RPG::Client
{
	inline static constexpr unsigned int ItemCostCalculator___c__DisplayClass18_0_TypeDefinitionIndex = 60497;
