...
#define RPG_CLIENT_PARKOURGAMEFLOW___C__DISPLAYCLASS13_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9F08720)
#define RPG_CLIENT_PARKOURGAMEFLOW___C__DISPLAYCLASS13_0__ONENTERED_B__0_OFFSET UNITYSDK_OFFSET(0x9F0AC70)

namespace RPG::Client
{
	inline static constexpr unsigned int ParkourGameFlow___c__DisplayClass13_0_TypeDefinitionIndex = 50196;
