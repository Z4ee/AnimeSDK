...
#define RPG_CLIENT_GRIDFIGHTGRIDOPERATIONVALIDATOR_NPCBLOCKCONSTRAIT_VALIDATE_OFFSET UNITYSDK_OFFSET(0x194FE0E0)
#define RPG_CLIENT_GRIDFIGHTGRIDOPERATIONVALIDATOR_NPCBLOCKCONSTRAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x194FCF00)
#define RPG_CLIENT_GRIDFIGHTGRIDOPERATIONVALIDATOR_NPCBLOCKCONSTRAIT__SHOULDBLOCK_OFFSET UNITYSDK_OFFSET(0x194FE370)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightGridOperationValidator_NPCBlockConstrait_TypeDefinitionIndex = 61925;
