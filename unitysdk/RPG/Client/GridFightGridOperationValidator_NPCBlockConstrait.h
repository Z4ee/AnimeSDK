...
#define RPG_CLIENT_GRIDFIGHTGRIDOPERATIONVALIDATOR_NPCBLOCKCONSTRAIT_VALIDATE_OFFSET UNITYSDK_OFFSET(0x1BA43F70)
#define RPG_CLIENT_GRIDFIGHTGRIDOPERATIONVALIDATOR_NPCBLOCKCONSTRAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA42D90)
#define RPG_CLIENT_GRIDFIGHTGRIDOPERATIONVALIDATOR_NPCBLOCKCONSTRAIT__SHOULDBLOCK_OFFSET UNITYSDK_OFFSET(0x1BA44200)
