...
#define RPG_CLIENT_GACHALIGHTCONEITEMDATA_GET_EQUIPMENTROW_OFFSET UNITYSDK_OFFSET(0xBAAC4D0)
#define RPG_CLIENT_GACHALIGHTCONEITEMDATA_SETROW_OFFSET UNITYSDK_OFFSET(0xBAAC3D0)
#define RPG_CLIENT_GACHALIGHTCONEITEMDATA_SET_EQUIPMENTROW_OFFSET UNITYSDK_OFFSET(0xBAAC4E0)
#define RPG_CLIENT_GACHALIGHTCONEITEMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBAAC370)
#define RPG_CLIENT_GACHALIGHTCONEITEMDATA___IFIXBASEPROXY_SETROW_OFFSET UNITYSDK_OFFSET(0xBAAC4F0)

namespace RPG::Client
{
	inline static constexpr unsigned int GachaLightConeItemData_TypeDefinitionIndex = 60094;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::UInt32))((::PBYTE)hIl2Cpp + RPG_CLIENT_GACHALIGHTCONEITEMDATA___IFIXBASEPROXY_SETROW_OFFSET))(this, a1);
		}
	};
}
