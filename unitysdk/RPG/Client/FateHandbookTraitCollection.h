...
#define RPG_CLIENT_FATEHANDBOOKTRAITCOLLECTION_DISPOSE_OFFSET UNITYSDK_OFFSET(0xCF4F370)
#define RPG_CLIENT_FATEHANDBOOKTRAITCOLLECTION_GET_TRAITITEMLIST_OFFSET UNITYSDK_OFFSET(0xCF52230)
#define RPG_CLIENT_FATEHANDBOOKTRAITCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0xCF4F640)
#define RPG_CLIENT_FATEHANDBOOKTRAITCOLLECTION__GENERATETRAITHANDBOOKLIST_OFFSET UNITYSDK_OFFSET(0xCF51EC0)
