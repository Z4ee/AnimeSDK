...
#define RPG_CLIENT_NAVMESHSTATEPARAMSSET__CTOR_OFFSET UNITYSDK_OFFSET(0xC288270)

namespace RPG::Client
{
	inline static constexpr unsigned int NavMeshStateParamsSet_TypeDefinitionIndex = 64220;
