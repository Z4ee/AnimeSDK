...
#define RPG_CLIENT_RESIDENTMUSEUMACTIVITYDATA_ISSHOWMAPPINGINFOREWARDREDDOT_OFFSET UNITYSDK_OFFSET(0x173A5860)
#define RPG_CLIENT_RESIDENTMUSEUMACTIVITYDATA_ISSHOWNORMALREDDOT_OFFSET UNITYSDK_OFFSET(0x173A5780)
#define RPG_CLIENT_RESIDENTMUSEUMACTIVITYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x173A5770)
#define RPG_CLIENT_RESIDENTMUSEUMACTIVITYDATA__ISSHOWPHASEQUESTREWARDREDDOT_OFFSET UNITYSDK_OFFSET(0x173A57C0)

namespace RPG::Client
{
	inline static constexpr unsigned int ResidentMuseumActivityData_TypeDefinitionIndex = 59018;
