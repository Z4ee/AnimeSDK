...
#define RPG_CLIENT_MATCHTHREEV2LEVELINFOS_CREATE_OFFSET UNITYSDK_OFFSET(0xBF9E4B0)
#define RPG_CLIENT_MATCHTHREEV2LEVELINFOS_GETLEVELDATA_OFFSET UNITYSDK_OFFSET(0xBF9E8A0)
#define RPG_CLIENT_MATCHTHREEV2LEVELINFOS_GETREQUIREDSUBMISSIONIDS_OFFSET UNITYSDK_OFFSET(0xBF9E930)
#define RPG_CLIENT_MATCHTHREEV2LEVELINFOS_GET_ALLLEVELDATAS_OFFSET UNITYSDK_OFFSET(0xBF9E380)
#define RPG_CLIENT_MATCHTHREEV2LEVELINFOS_INIT_OFFSET UNITYSDK_OFFSET(0xBF9E620)
#define RPG_CLIENT_MATCHTHREEV2LEVELINFOS__CTOR_OFFSET UNITYSDK_OFFSET(0xBF9E5A0)
#define RPG_CLIENT_MATCHTHREEV2LEVELINFOS__INITALLLEVELDATAS_OFFSET UNITYSDK_OFFSET(0xBF9E670)

namespace RPG::Client
{
	inline static constexpr unsigned int MatchThreeV2LevelInfos_TypeDefinitionIndex = 61701;
