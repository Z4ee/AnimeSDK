...
#define RPG_CLIENT_AVATARFARMGUIDEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9DA11D0)

namespace RPG::Client
{
	inline static constexpr unsigned int AvatarFarmGuideData_TypeDefinitionIndex = 60443;
