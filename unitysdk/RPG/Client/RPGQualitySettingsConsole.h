...
#define RPG_CLIENT_RPGQUALITYSETTINGSCONSOLE__CTOR_OFFSET UNITYSDK_OFFSET(0x18044D30)

namespace RPG::Client
{
	inline static constexpr unsigned int RPGQualitySettingsConsole_TypeDefinitionIndex = 67941;
