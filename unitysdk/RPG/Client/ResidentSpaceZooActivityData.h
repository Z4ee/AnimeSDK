...
#define RPG_CLIENT_RESIDENTSPACEZOOACTIVITYDATA_ISSHOWMAPPINGINFOREWARDREDDOT_OFFSET UNITYSDK_OFFSET(0xDE71C50)
#define RPG_CLIENT_RESIDENTSPACEZOOACTIVITYDATA_ISSHOWNORMALREDDOT_OFFSET UNITYSDK_OFFSET(0xDE71B20)
#define RPG_CLIENT_RESIDENTSPACEZOOACTIVITYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xDE71B10)
#define RPG_CLIENT_RESIDENTSPACEZOOACTIVITYDATA__ISPOINTREWARDFINISH_OFFSET UNITYSDK_OFFSET(0xDE71BA0)
