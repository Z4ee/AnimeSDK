...
#define RPG_CLIENT_DYNAMICMATERIALLOADER_MATERIALLOADITEM_GET_MATINST_OFFSET UNITYSDK_OFFSET(0x177168A0)
#define RPG_CLIENT_DYNAMICMATERIALLOADER_MATERIALLOADITEM_METHOD_1_9681042564541CD6_1_OFFSET UNITYSDK_OFFSET(0x17716840)
#define RPG_CLIENT_DYNAMICMATERIALLOADER_MATERIALLOADITEM_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x177167C0)
#define RPG_CLIENT_DYNAMICMATERIALLOADER_MATERIALLOADITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x177168B0)

namespace RPG::Client
{
	inline static constexpr unsigned int DynamicMaterialLoader_MaterialLoadItem_TypeDefinitionIndex = 65364;
