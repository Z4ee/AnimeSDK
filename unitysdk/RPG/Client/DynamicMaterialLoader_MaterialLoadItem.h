...
#define RPG_CLIENT_DYNAMICMATERIALLOADER_MATERIALLOADITEM_GET_MATINST_OFFSET UNITYSDK_OFFSET(0xA1A0BD0)
#define RPG_CLIENT_DYNAMICMATERIALLOADER_MATERIALLOADITEM_METHOD_1_9681042564541CD6_1_OFFSET UNITYSDK_OFFSET(0xA1A0B70)
#define RPG_CLIENT_DYNAMICMATERIALLOADER_MATERIALLOADITEM_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xA1A0AF0)
#define RPG_CLIENT_DYNAMICMATERIALLOADER_MATERIALLOADITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xA1A0BE0)

namespace RPG::Client
{
	inline static constexpr unsigned int DynamicMaterialLoader_MaterialLoadItem_TypeDefinitionIndex = 63076;
