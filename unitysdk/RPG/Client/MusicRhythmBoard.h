...
#define RPG_CLIENT_MUSICRHYTHMBOARD_ADDTUTORIALFAILTIMES_OFFSET UNITYSDK_OFFSET(0x18E8E660)
#define RPG_CLIENT_MUSICRHYTHMBOARD_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18E8C2A0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x18E8DAE0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_GETENTITY_OFFSET UNITYSDK_OFFSET(0x18E8E240)
#define RPG_CLIENT_MUSICRHYTHMBOARD_GETPOINT_OFFSET UNITYSDK_OFFSET(0x18E8DB40)
#define RPG_CLIENT_MUSICRHYTHMBOARD_GET_GROUPROW_OFFSET UNITYSDK_OFFSET(0x18E8E710)
#define RPG_CLIENT_MUSICRHYTHMBOARD_GET_ISDISPOSED_OFFSET UNITYSDK_OFFSET(0x18E8E6B0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_GET_LEVELID_OFFSET UNITYSDK_OFFSET(0x18E8E6D0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_GET_LEVELROW_OFFSET UNITYSDK_OFFSET(0x18E8E6F0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_GET_SKIPTUTORIAL_OFFSET UNITYSDK_OFFSET(0x18E8E750)
#define RPG_CLIENT_MUSICRHYTHMBOARD_GET_TUTORIALFAILTIMES_OFFSET UNITYSDK_OFFSET(0x18E8E730)
#define RPG_CLIENT_MUSICRHYTHMBOARD_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0x18E8A890)
#define RPG_CLIENT_MUSICRHYTHMBOARD_ISTIMELINEFINISH_OFFSET UNITYSDK_OFFSET(0x18E8CBB0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_022B0D58A3077BF2_OFFSET UNITYSDK_OFFSET(0x18E8D210)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_2566AD459572DFC3_OFFSET UNITYSDK_OFFSET(0x18E8AFE0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_5AAD8A621CCD075B_OFFSET UNITYSDK_OFFSET(0x18E8D6D0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_802D2A6E195347E8_OFFSET UNITYSDK_OFFSET(0x18E8C010)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_8C3DB70FFBBF01C7_1_OFFSET UNITYSDK_OFFSET(0x18E8D020)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_8C3DB70FFBBF01C7_2_OFFSET UNITYSDK_OFFSET(0x18E8D330)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_8C3DB70FFBBF01C7_3_OFFSET UNITYSDK_OFFSET(0x18E8D430)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_8C3DB70FFBBF01C7_4_OFFSET UNITYSDK_OFFSET(0x18E8D620)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_8C3DB70FFBBF01C7_5_OFFSET UNITYSDK_OFFSET(0x18E8D820)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_8C3DB70FFBBF01C7_6_OFFSET UNITYSDK_OFFSET(0x18E8D900)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_8C3DB70FFBBF01C7_OFFSET UNITYSDK_OFFSET(0x18E8CDA0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x18E8AEF0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_B484DF6A9226D45B_OFFSET UNITYSDK_OFFSET(0x18E8D9C0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_D2666B2B900DD38A_OFFSET UNITYSDK_OFFSET(0x18E8DC70)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_DFD7F5C5419FD422_OFFSET UNITYSDK_OFFSET(0x18E8D4E0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_F4702DCB1E895B7F_OFFSET UNITYSDK_OFFSET(0x18E8D0D0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_F69068FADEFBD596_OFFSET UNITYSDK_OFFSET(0x18E8CEC0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_PLAYTIMELINE_OFFSET UNITYSDK_OFFSET(0x18E8BCA0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_RESETANIMATORS_OFFSET UNITYSDK_OFFSET(0x18E8E320)
#define RPG_CLIENT_MUSICRHYTHMBOARD_SETADJUSTMODE_OFFSET UNITYSDK_OFFSET(0x18E8C0B0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_SET_GROUPROW_OFFSET UNITYSDK_OFFSET(0x18E8E720)
#define RPG_CLIENT_MUSICRHYTHMBOARD_SET_ISDISPOSED_OFFSET UNITYSDK_OFFSET(0x18E8E6C0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_SET_LEVELID_OFFSET UNITYSDK_OFFSET(0x18E8E6E0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_SET_LEVELROW_OFFSET UNITYSDK_OFFSET(0x18E8E700)
#define RPG_CLIENT_MUSICRHYTHMBOARD_SET_SKIPTUTORIAL_OFFSET UNITYSDK_OFFSET(0x18E8E760)
#define RPG_CLIENT_MUSICRHYTHMBOARD_SET_TUTORIALFAILTIMES_OFFSET UNITYSDK_OFFSET(0x18E8E740)
#define RPG_CLIENT_MUSICRHYTHMBOARD_SHOWPLAYERHINT_OFFSET UNITYSDK_OFFSET(0x18E8CC10)
#define RPG_CLIENT_MUSICRHYTHMBOARD_STARTMUSICRHYTHM_OFFSET UNITYSDK_OFFSET(0x18E8BBF0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_UPDATE_OFFSET UNITYSDK_OFFSET(0x18E8DA80)
#define RPG_CLIENT_MUSICRHYTHMBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x18E8E770)

namespace RPG::Client
{
	inline static constexpr unsigned int MusicRhythmBoard_TypeDefinitionIndex = 57477;
	...
	public:
		...
		{
			return (::RPG::GameCore::MusicRhythmLevelRow**)Il2CppClass::FromTypeDefinitionIndex(MusicRhythmBoard_TypeDefinitionIndex)->GetStaticField(0x2C3A0);
		}
		static ::RPG::GameCore::MusicRhythmGameConfig** StaticGet_MusicRhythmConfig()
		{
			return (::RPG::GameCore::MusicRhythmGameConfig**)Il2CppClass::FromTypeDefinitionIndex(MusicRhythmBoard_TypeDefinitionIndex)->GetStaticField(0x2C3A8);
		}
		static ::RPG::GameCore::MusicRhythmGroupRow** StaticGet__GroupRow_k__BackingField()
		{
			return (::RPG::GameCore::MusicRhythmGroupRow**)Il2CppClass::FromTypeDefinitionIndex(MusicRhythmBoard_TypeDefinitionIndex)->GetStaticField(0x2C3B0);
		}
