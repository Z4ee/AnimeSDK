...
#define RPG_CLIENT_MUSICRHYTHMBOARD_ADDTUTORIALFAILTIMES_OFFSET UNITYSDK_OFFSET(0xD90E1C0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD90BE00)
#define RPG_CLIENT_MUSICRHYTHMBOARD_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0xD90D630)
#define RPG_CLIENT_MUSICRHYTHMBOARD_GETENTITY_OFFSET UNITYSDK_OFFSET(0xD90DDA0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_GETPOINT_OFFSET UNITYSDK_OFFSET(0xD90D690)
#define RPG_CLIENT_MUSICRHYTHMBOARD_GET_GROUPROW_OFFSET UNITYSDK_OFFSET(0xD90E270)
#define RPG_CLIENT_MUSICRHYTHMBOARD_GET_ISDISPOSED_OFFSET UNITYSDK_OFFSET(0xD90E210)
#define RPG_CLIENT_MUSICRHYTHMBOARD_GET_LEVELID_OFFSET UNITYSDK_OFFSET(0xD90E230)
#define RPG_CLIENT_MUSICRHYTHMBOARD_GET_LEVELROW_OFFSET UNITYSDK_OFFSET(0xD90E250)
#define RPG_CLIENT_MUSICRHYTHMBOARD_GET_SKIPTUTORIAL_OFFSET UNITYSDK_OFFSET(0xD90E2B0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_GET_TUTORIALFAILTIMES_OFFSET UNITYSDK_OFFSET(0xD90E290)
#define RPG_CLIENT_MUSICRHYTHMBOARD_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xD90A3F0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_ISTIMELINEFINISH_OFFSET UNITYSDK_OFFSET(0xD90C700)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_022B0D58A3077BF2_OFFSET UNITYSDK_OFFSET(0xD90CD60)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_2566AD459572DFC3_OFFSET UNITYSDK_OFFSET(0xD90AB40)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_802D2A6E195347E8_OFFSET UNITYSDK_OFFSET(0xD90BB70)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_8C3DB70FFBBF01C7_1_OFFSET UNITYSDK_OFFSET(0xD90CB70)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_8C3DB70FFBBF01C7_2_OFFSET UNITYSDK_OFFSET(0xD90CE80)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_8C3DB70FFBBF01C7_3_OFFSET UNITYSDK_OFFSET(0xD90CF80)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_8C3DB70FFBBF01C7_4_OFFSET UNITYSDK_OFFSET(0xD90D170)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_8C3DB70FFBBF01C7_5_OFFSET UNITYSDK_OFFSET(0xD90D370)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_8C3DB70FFBBF01C7_6_OFFSET UNITYSDK_OFFSET(0xD90D450)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_8C3DB70FFBBF01C7_OFFSET UNITYSDK_OFFSET(0xD90C8F0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xD90AA50)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_B484DF6A9226D45B_OFFSET UNITYSDK_OFFSET(0xD90D510)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_D2666B2B900DD38A_OFFSET UNITYSDK_OFFSET(0xD90D7C0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_DFD7F5C5419FD422_OFFSET UNITYSDK_OFFSET(0xD90D030)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_EE33E0531969166F_OFFSET UNITYSDK_OFFSET(0xD90D220)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_F4702DCB1E895B7F_OFFSET UNITYSDK_OFFSET(0xD90CC20)
#define RPG_CLIENT_MUSICRHYTHMBOARD_METHOD_6_F69068FADEFBD596_OFFSET UNITYSDK_OFFSET(0xD90CA10)
#define RPG_CLIENT_MUSICRHYTHMBOARD_PLAYTIMELINE_OFFSET UNITYSDK_OFFSET(0xD90B800)
#define RPG_CLIENT_MUSICRHYTHMBOARD_RESETANIMATORS_OFFSET UNITYSDK_OFFSET(0xD90DE80)
#define RPG_CLIENT_MUSICRHYTHMBOARD_SETADJUSTMODE_OFFSET UNITYSDK_OFFSET(0xD90BC10)
#define RPG_CLIENT_MUSICRHYTHMBOARD_SET_GROUPROW_OFFSET UNITYSDK_OFFSET(0xD90E280)
#define RPG_CLIENT_MUSICRHYTHMBOARD_SET_ISDISPOSED_OFFSET UNITYSDK_OFFSET(0xD90E220)
#define RPG_CLIENT_MUSICRHYTHMBOARD_SET_LEVELID_OFFSET UNITYSDK_OFFSET(0xD90E240)
#define RPG_CLIENT_MUSICRHYTHMBOARD_SET_LEVELROW_OFFSET UNITYSDK_OFFSET(0xD90E260)
#define RPG_CLIENT_MUSICRHYTHMBOARD_SET_SKIPTUTORIAL_OFFSET UNITYSDK_OFFSET(0xD90E2C0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_SET_TUTORIALFAILTIMES_OFFSET UNITYSDK_OFFSET(0xD90E2A0)
#define RPG_CLIENT_MUSICRHYTHMBOARD_SHOWPLAYERHINT_OFFSET UNITYSDK_OFFSET(0xD90C760)
#define RPG_CLIENT_MUSICRHYTHMBOARD_STARTMUSICRHYTHM_OFFSET UNITYSDK_OFFSET(0xD90B750)
#define RPG_CLIENT_MUSICRHYTHMBOARD_UPDATE_OFFSET UNITYSDK_OFFSET(0xD90D5D0)
#define RPG_CLIENT_MUSICRHYTHMBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0xD90E2D0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::RPG::GameCore::MusicRhythmLevelRow**)Il2CppClass::FromTypeDefinitionIndex(MusicRhythmBoard_TypeDefinitionIndex)->GetStaticField(0x21F20);
		}
		static ::RPG::GameCore::MusicRhythmGroupRow** StaticGet__GroupRow_k__BackingField()
		{
			return (::RPG::GameCore::MusicRhythmGroupRow**)Il2CppClass::FromTypeDefinitionIndex(MusicRhythmBoard_TypeDefinitionIndex)->GetStaticField(0x21F28);
		}
		static ::RPG::GameCore::MusicRhythmGameConfig** StaticGet_MusicRhythmConfig()
		{
			return (::RPG::GameCore::MusicRhythmGameConfig**)Il2CppClass::FromTypeDefinitionIndex(MusicRhythmBoard_TypeDefinitionIndex)->GetStaticField(0x21F30);
		}
