...
#define RPG_CLIENT_ROGUETOURNRELICCOCOONTEAMSAVEDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x184B8490)
#define RPG_CLIENT_ROGUETOURNRELICCOCOONTEAMSAVEDATA_GET_COCOONID_OFFSET UNITYSDK_OFFSET(0x184B8C40)
#define RPG_CLIENT_ROGUETOURNRELICCOCOONTEAMSAVEDATA_SAVEDATA_OFFSET UNITYSDK_OFFSET(0x184B8550)
#define RPG_CLIENT_ROGUETOURNRELICCOCOONTEAMSAVEDATA_SET_COCOONID_OFFSET UNITYSDK_OFFSET(0x184B8C50)
#define RPG_CLIENT_ROGUETOURNRELICCOCOONTEAMSAVEDATA_TRYGETSAVEDATA_OFFSET UNITYSDK_OFFSET(0x184B8340)
#define RPG_CLIENT_ROGUETOURNRELICCOCOONTEAMSAVEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x184B8970)
#define RPG_CLIENT_ROGUETOURNRELICCOCOONTEAMSAVEDATA__INIT_OFFSET UNITYSDK_OFFSET(0x184B89B0)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueTournRelicCocoonTeamSaveData_TypeDefinitionIndex = 64765;
