...
#define RPG_CLIENT_MONOPOLYGAMEGUESSDATA_ADDBETCOUNT_OFFSET UNITYSDK_OFFSET(0x9D5D840)
#define RPG_CLIENT_MONOPOLYGAMEGUESSDATA_CLEARBETCOUNT_OFFSET UNITYSDK_OFFSET(0x9D5D7A0)
#define RPG_CLIENT_MONOPOLYGAMEGUESSDATA_GETPLAYERBETCOUNT_OFFSET UNITYSDK_OFFSET(0x9D5D940)
#define RPG_CLIENT_MONOPOLYGAMEGUESSDATA_GET_GUESSID_OFFSET UNITYSDK_OFFSET(0x9D5D9D0)
#define RPG_CLIENT_MONOPOLYGAMEGUESSDATA_GET_HASBOUGHT_OFFSET UNITYSDK_OFFSET(0x9D5DAB0)
#define RPG_CLIENT_MONOPOLYGAMEGUESSDATA_GET_PLAYERIDS_OFFSET UNITYSDK_OFFSET(0x9D5DA10)
#define RPG_CLIENT_MONOPOLYGAMEGUESSDATA_GET_ROW_OFFSET UNITYSDK_OFFSET(0x9D5D9F0)
#define RPG_CLIENT_MONOPOLYGAMEGUESSDATA_SET_GUESSID_OFFSET UNITYSDK_OFFSET(0x9D5D9E0)
#define RPG_CLIENT_MONOPOLYGAMEGUESSDATA_SET_HASBOUGHT_OFFSET UNITYSDK_OFFSET(0x9D5DAC0)
#define RPG_CLIENT_MONOPOLYGAMEGUESSDATA_SET_ROW_OFFSET UNITYSDK_OFFSET(0x9D5DA00)
#define RPG_CLIENT_MONOPOLYGAMEGUESSDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9D5D680)

namespace RPG::Client
{
	inline static constexpr unsigned int MonopolyGameGuessData_TypeDefinitionIndex = 53880;
