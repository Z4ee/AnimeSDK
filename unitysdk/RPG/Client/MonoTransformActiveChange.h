...
#define RPG_CLIENT_MONOTRANSFORMACTIVECHANGE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1C289A10)
#define RPG_CLIENT_MONOTRANSFORMACTIVECHANGE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1C2899C0)
#define RPG_CLIENT_MONOTRANSFORMACTIVECHANGE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1C2898B0)
#define RPG_CLIENT_MONOTRANSFORMACTIVECHANGE_SETUPCHANGECALLBACK_OFFSET UNITYSDK_OFFSET(0x1C289850)
#define RPG_CLIENT_MONOTRANSFORMACTIVECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C289A60)
#define RPG_CLIENT_MONOTRANSFORMACTIVECHANGE__ONACTIVECHANGE_OFFSET UNITYSDK_OFFSET(0x1C289900)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoTransformActiveChange_TypeDefinitionIndex = 72536;
