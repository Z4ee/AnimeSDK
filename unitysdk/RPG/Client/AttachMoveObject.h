...
#define RPG_CLIENT_ATTACHMOVEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x90E4C00)

namespace RPG::Client
{
	inline static constexpr unsigned int AttachMoveObject_TypeDefinitionIndex = 56259;
