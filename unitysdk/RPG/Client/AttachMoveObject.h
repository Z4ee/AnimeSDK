...
#define RPG_CLIENT_ATTACHMOVEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x19B3BCB0)

namespace RPG::Client
{
	inline static constexpr unsigned int AttachMoveObject_TypeDefinitionIndex = 65793;
