...
#define RPG_CLIENT_PHOTOGRAPHGIANTTARGETDEBUGDRAW_CHECKQUADVALID_OFFSET UNITYSDK_OFFSET(0xDA74B70)
#define RPG_CLIENT_PHOTOGRAPHGIANTTARGETDEBUGDRAW_CHECKRAYCASTPASS_OFFSET UNITYSDK_OFFSET(0xDA759B0)
#define RPG_CLIENT_PHOTOGRAPHGIANTTARGETDEBUGDRAW_CHECKSINGLEPOSARRAY_OFFSET UNITYSDK_OFFSET(0xDA744B0)
#define RPG_CLIENT_PHOTOGRAPHGIANTTARGETDEBUGDRAW_CHECKVISIBLE_OFFSET UNITYSDK_OFFSET(0xDA73AD0)
#define RPG_CLIENT_PHOTOGRAPHGIANTTARGETDEBUGDRAW_DETECTINTERSECTWITHVIEWPORT_OFFSET UNITYSDK_OFFSET(0xDA75770)
#define RPG_CLIENT_PHOTOGRAPHGIANTTARGETDEBUGDRAW_DETECTRAYCASTPASS_OFFSET UNITYSDK_OFFSET(0xDA74890)
#define RPG_CLIENT_PHOTOGRAPHGIANTTARGETDEBUGDRAW_DRAWPOS_OFFSET UNITYSDK_OFFSET(0xDA747F0)
#define RPG_CLIENT_PHOTOGRAPHGIANTTARGETDEBUGDRAW_GENCHECKARRAY_OFFSET UNITYSDK_OFFSET(0xDA73470)
#define RPG_CLIENT_PHOTOGRAPHGIANTTARGETDEBUGDRAW_GETDETECTPOINTS_OFFSET UNITYSDK_OFFSET(0xDA75D80)
#define RPG_CLIENT_PHOTOGRAPHGIANTTARGETDEBUGDRAW_LINESEGMENTSINTERSECT_OFFSET UNITYSDK_OFFSET(0xDA75BE0)
#define RPG_CLIENT_PHOTOGRAPHGIANTTARGETDEBUGDRAW_SINGLEAXISFLOATTOVIEWSTATE_OFFSET UNITYSDK_OFFSET(0xDA733F0)
#define RPG_CLIENT_PHOTOGRAPHGIANTTARGETDEBUGDRAW_START_OFFSET UNITYSDK_OFFSET(0xDA73310)
#define RPG_CLIENT_PHOTOGRAPHGIANTTARGETDEBUGDRAW_UPDATE_OFFSET UNITYSDK_OFFSET(0xDA760A0)
#define RPG_CLIENT_PHOTOGRAPHGIANTTARGETDEBUGDRAW__CTOR_OFFSET UNITYSDK_OFFSET(0xDA76130)
