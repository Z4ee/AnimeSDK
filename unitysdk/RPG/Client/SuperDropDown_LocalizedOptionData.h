...
#define RPG_CLIENT_SUPERDROPDOWN_LOCALIZEDOPTIONDATA_GET_LOCALIZEDTEXTID_OFFSET UNITYSDK_OFFSET(0x1B4679A0)
#define RPG_CLIENT_SUPERDROPDOWN_LOCALIZEDOPTIONDATA_SET_LOCALIZEDTEXTID_OFFSET UNITYSDK_OFFSET(0x1B4679B0)
#define RPG_CLIENT_SUPERDROPDOWN_LOCALIZEDOPTIONDATA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B4679C0)
#define RPG_CLIENT_SUPERDROPDOWN_LOCALIZEDOPTIONDATA__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B467A10)
#define RPG_CLIENT_SUPERDROPDOWN_LOCALIZEDOPTIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B466EC0)

namespace RPG::Client
{
	inline static constexpr unsigned int SuperDropDown_LocalizedOptionData_TypeDefinitionIndex = 72593;
