...
#define RPG_CLIENT_MODELUI3DMODECONSTRAINT_AWAKE_OFFSET UNITYSDK_OFFSET(0xA905030)
#define RPG_CLIENT_MODELUI3DMODECONSTRAINT_INIT_OFFSET UNITYSDK_OFFSET(0xA905790)
#define RPG_CLIENT_MODELUI3DMODECONSTRAINT_LOGICUPDATE_OFFSET UNITYSDK_OFFSET(0xA905A90)
#define RPG_CLIENT_MODELUI3DMODECONSTRAINT_METHOD_5_ECA33935490AF2E4_OFFSET UNITYSDK_OFFSET(0xA905310)
#define RPG_CLIENT_MODELUI3DMODECONSTRAINT__CTOR_OFFSET UNITYSDK_OFFSET(0xA905FB0)

namespace RPG::Client
{
	inline static constexpr unsigned int ModelUI3DModeConstraint_TypeDefinitionIndex = 63173;
