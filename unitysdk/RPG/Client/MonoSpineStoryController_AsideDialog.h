...
#define RPG_CLIENT_MONOSPINESTORYCONTROLLER_ASIDEDIALOG_ISVALID_OFFSET UNITYSDK_OFFSET(0x81260)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoSpineStoryController_AsideDialog_TypeDefinitionIndex = 48833;
