...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACESPECIALEYE_INIT_OFFSET UNITYSDK_OFFSET(0x9CB6950)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACESPECIALEYE_UNINIT_OFFSET UNITYSDK_OFFSET(0x9CB70E0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACESPECIALEYE_UPDATEPROPERTY_OFFSET UNITYSDK_OFFSET(0x9CB69F0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACESPECIALEYE__CTOR_OFFSET UNITYSDK_OFFSET(0x9CB7180)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACESPECIALEYE___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0x9CB71C0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACESPECIALEYE___IFIXBASEPROXY_UNINIT_OFFSET UNITYSDK_OFFSET(0x9CB71D0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginCharaPropFaceSpecialEye_TypeDefinitionIndex = 57238;
