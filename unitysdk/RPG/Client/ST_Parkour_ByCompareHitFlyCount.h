...
#define RPG_CLIENT_ST_PARKOUR_BYCOMPAREHITFLYCOUNT_METHOD_4_016DB7CF21D60B3C_OFFSET UNITYSDK_OFFSET(0x185ECBB0)
#define RPG_CLIENT_ST_PARKOUR_BYCOMPAREHITFLYCOUNT_METHOD_4_8A3AE30400818658_OFFSET UNITYSDK_OFFSET(0x185ECAE0)
#define RPG_CLIENT_ST_PARKOUR_BYCOMPAREHITFLYCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x185ECB60)

namespace RPG::Client
{
	inline static constexpr unsigned int ST_Parkour_ByCompareHitFlyCount_TypeDefinitionIndex = 10136;
