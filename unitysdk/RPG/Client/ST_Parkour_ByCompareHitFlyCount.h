...
#define RPG_CLIENT_ST_PARKOUR_BYCOMPAREHITFLYCOUNT_METHOD_4_016DB7CF21D60B3C_OFFSET UNITYSDK_OFFSET(0x1D31DE90)
#define RPG_CLIENT_ST_PARKOUR_BYCOMPAREHITFLYCOUNT_METHOD_4_94B6AA8C376C57A0_OFFSET UNITYSDK_OFFSET(0x1D31E070)
#define RPG_CLIENT_ST_PARKOUR_BYCOMPAREHITFLYCOUNT_METHOD_4_CC25DE6DD343AF77_OFFSET UNITYSDK_OFFSET(0x1D31E0A0)
#define RPG_CLIENT_ST_PARKOUR_BYCOMPAREHITFLYCOUNT_METHOD_4_D8905A23C5ACCEFD_OFFSET UNITYSDK_OFFSET(0x1D31DE50)
#define RPG_CLIENT_ST_PARKOUR_BYCOMPAREHITFLYCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D31DE80)

namespace RPG::Client
{
	inline static constexpr unsigned int ST_Parkour_ByCompareHitFlyCount_TypeDefinitionIndex = 10252;
