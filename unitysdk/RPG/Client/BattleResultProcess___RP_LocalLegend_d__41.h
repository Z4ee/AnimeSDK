...
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_LOCALLEGEND_D__41_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x91D34F0)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_LOCALLEGEND_D__41_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x91D3730)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_LOCALLEGEND_D__41_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x91D3790)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_LOCALLEGEND_D__41_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x91D3740)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_LOCALLEGEND_D__41_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x91D34E0)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_LOCALLEGEND_D__41__CTOR_OFFSET UNITYSDK_OFFSET(0x91CEB80)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleResultProcess___RP_LocalLegend_d__41_TypeDefinitionIndex = 49477;
