...
#define RPG_CLIENT_MONOHITREACTION_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0xC117BF0)
#define RPG_CLIENT_MONOHITREACTION_START_OFFSET UNITYSDK_OFFSET(0xC117B90)
#define RPG_CLIENT_MONOHITREACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xC117C40)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoHitReaction_TypeDefinitionIndex = 64186;
