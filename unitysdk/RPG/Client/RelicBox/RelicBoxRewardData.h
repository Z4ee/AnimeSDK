...
#define RPG_CLIENT_RELICBOX_RELICBOXREWARDDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xC6D64B0)
#define RPG_CLIENT_RELICBOX_RELICBOXREWARDDATA_GETALLREWARDCOUNT_OFFSET UNITYSDK_OFFSET(0xC6D6750)
#define RPG_CLIENT_RELICBOX_RELICBOXREWARDDATA_GETCURRENTQUEST_OFFSET UNITYSDK_OFFSET(0xC6D6570)
#define RPG_CLIENT_RELICBOX_RELICBOXREWARDDATA_GETQUESTREWARDCOUNT_OFFSET UNITYSDK_OFFSET(0xC6D6860)
#define RPG_CLIENT_RELICBOX_RELICBOXREWARDDATA_GETTAKENREWARDCOUNT_OFFSET UNITYSDK_OFFSET(0xC6D6900)
#define RPG_CLIENT_RELICBOX_RELICBOXREWARDDATA_GET_GOTOID_OFFSET UNITYSDK_OFFSET(0xC6D6A60)
#define RPG_CLIENT_RELICBOX_RELICBOXREWARDDATA_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0xC6D6A40)
#define RPG_CLIENT_RELICBOX_RELICBOXREWARDDATA_GET_QUESTIDLIST_OFFSET UNITYSDK_OFFSET(0xC6D6550)
#define RPG_CLIENT_RELICBOX_RELICBOXREWARDDATA_GET_TABID_OFFSET UNITYSDK_OFFSET(0xC6D6A20)
#define RPG_CLIENT_RELICBOX_RELICBOXREWARDDATA_TAKEREWARD_OFFSET UNITYSDK_OFFSET(0xC6D6510)
#define RPG_CLIENT_RELICBOX_RELICBOXREWARDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC6D6500)

namespace RPG::Client::RelicBox
{
	inline static constexpr unsigned int RelicBoxRewardData_TypeDefinitionIndex = 69529;
