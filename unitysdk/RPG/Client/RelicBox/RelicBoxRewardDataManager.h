...
#define RPG_CLIENT_RELICBOX_RELICBOXREWARDDATAMANAGER_GETALLREWARDCOUNT_OFFSET UNITYSDK_OFFSET(0xAF90420)
#define RPG_CLIENT_RELICBOX_RELICBOXREWARDDATAMANAGER_GETRELICBOXREWARDDATALIST_OFFSET UNITYSDK_OFFSET(0xAF903E0)
#define RPG_CLIENT_RELICBOX_RELICBOXREWARDDATAMANAGER_GETTAKENREWARDCOUNT_OFFSET UNITYSDK_OFFSET(0xAF904C0)
#define RPG_CLIENT_RELICBOX_RELICBOXREWARDDATAMANAGER_HASANYREWARDCANTAKE_OFFSET UNITYSDK_OFFSET(0xAF90340)
#define RPG_CLIENT_RELICBOX_RELICBOXREWARDDATAMANAGER_INIT_OFFSET UNITYSDK_OFFSET(0xAF8B7E0)
#define RPG_CLIENT_RELICBOX_RELICBOXREWARDDATAMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xAF8F130)

namespace RPG::Client::RelicBox
{
	inline static constexpr unsigned int RelicBoxRewardDataManager_TypeDefinitionIndex = 68719;
