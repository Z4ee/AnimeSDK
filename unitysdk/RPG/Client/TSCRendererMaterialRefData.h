...
#define RPG_CLIENT_TSCRENDERERMATERIALREFDATA_METHOD_1_0CDD9FD39783A4B5_OFFSET UNITYSDK_OFFSET(0x19760130)
#define RPG_CLIENT_TSCRENDERERMATERIALREFDATA_METHOD_1_45D00B3FDD3C2A62_OFFSET UNITYSDK_OFFSET(0x1975FDC0)
#define RPG_CLIENT_TSCRENDERERMATERIALREFDATA_METHOD_1_9F8F6511E8EF1235_OFFSET UNITYSDK_OFFSET(0x197600D0)
#define RPG_CLIENT_TSCRENDERERMATERIALREFDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1975FCE0)

namespace RPG::Client
{
	inline static constexpr unsigned int TSCRendererMaterialRefData_TypeDefinitionIndex = 67065;
