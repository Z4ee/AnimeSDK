...
#define RPG_CLIENT_TALKMODULE_DIALOGUEEVENTKEY_CLEAR_OFFSET UNITYSDK_OFFSET(0x39D7AB0)
#define RPG_CLIENT_TALKMODULE_DIALOGUEEVENTKEY_EQUALS_OFFSET UNITYSDK_OFFSET(0x39D7B00)
#define RPG_CLIENT_TALKMODULE_DIALOGUEEVENTKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x6ED5C0)

namespace RPG::Client
{
	inline static constexpr unsigned int TalkModule_DialogueEventKey_TypeDefinitionIndex = 65022;
