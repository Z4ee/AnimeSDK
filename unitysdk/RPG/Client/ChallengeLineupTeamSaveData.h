...
#define RPG_CLIENT_CHALLENGELINEUPTEAMSAVEDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x18C21DD0)
#define RPG_CLIENT_CHALLENGELINEUPTEAMSAVEDATA_GET_AVATARLIST1_OFFSET UNITYSDK_OFFSET(0x18C22B10)
#define RPG_CLIENT_CHALLENGELINEUPTEAMSAVEDATA_GET_AVATARLIST2_OFFSET UNITYSDK_OFFSET(0x18C22B90)
#define RPG_CLIENT_CHALLENGELINEUPTEAMSAVEDATA_GET_BUFF1_OFFSET UNITYSDK_OFFSET(0x18C22C10)
#define RPG_CLIENT_CHALLENGELINEUPTEAMSAVEDATA_GET_BUFF2_OFFSET UNITYSDK_OFFSET(0x18C22C80)
#define RPG_CLIENT_CHALLENGELINEUPTEAMSAVEDATA_GET_BUFFLIST_OFFSET UNITYSDK_OFFSET(0x18C22AF0)
#define RPG_CLIENT_CHALLENGELINEUPTEAMSAVEDATA_SAVELINEUPDATA_OFFSET UNITYSDK_OFFSET(0x18C21E70)
#define RPG_CLIENT_CHALLENGELINEUPTEAMSAVEDATA_SET_BUFFLIST_OFFSET UNITYSDK_OFFSET(0x18C22B00)
#define RPG_CLIENT_CHALLENGELINEUPTEAMSAVEDATA_TRYGETSAVEDATA_OFFSET UNITYSDK_OFFSET(0x18C21B50)
#define RPG_CLIENT_CHALLENGELINEUPTEAMSAVEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18C223E0)
#define RPG_CLIENT_CHALLENGELINEUPTEAMSAVEDATA__GETCHALLENGELINEUPAVATARSAVEDATALIST_OFFSET UNITYSDK_OFFSET(0x18C22160)
#define RPG_CLIENT_CHALLENGELINEUPTEAMSAVEDATA__INIT_OFFSET UNITYSDK_OFFSET(0x18C223F0)
