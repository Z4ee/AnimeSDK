...
#define RPG_CLIENT_MONOMASKSLIDER_GETBLINGANIMATIONNORMALIZEDTIME_OFFSET UNITYSDK_OFFSET(0x18C5FDA0)
#define RPG_CLIENT_MONOMASKSLIDER_GETRATIO_OFFSET UNITYSDK_OFFSET(0x18C5FA30)
#define RPG_CLIENT_MONOMASKSLIDER_GET_LOOPANIMNAMESTR_OFFSET UNITYSDK_OFFSET(0x18C5F4C0)
#define RPG_CLIENT_MONOMASKSLIDER_METHOD_5_7C2C2820B36B9508_OFFSET UNITYSDK_OFFSET(0x18C60160)
#define RPG_CLIENT_MONOMASKSLIDER_METHOD_5_C457B99D85451047_OFFSET UNITYSDK_OFFSET(0x18C5FF60)
#define RPG_CLIENT_MONOMASKSLIDER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x18C602F0)
#define RPG_CLIENT_MONOMASKSLIDER_SETREFSLIDER_OFFSET UNITYSDK_OFFSET(0x18C5FAA0)
#define RPG_CLIENT_MONOMASKSLIDER_STARTFLASHLOOP_OFFSET UNITYSDK_OFFSET(0x18C5FC90)
#define RPG_CLIENT_MONOMASKSLIDER_STARTFLASHSPREAD_OFFSET UNITYSDK_OFFSET(0x18C5FB00)
#define RPG_CLIENT_MONOMASKSLIDER_STOPFLASHLOOPANIM_OFFSET UNITYSDK_OFFSET(0x18C60020)
#define RPG_CLIENT_MONOMASKSLIDER_STOPFLASHSPREADANIM_OFFSET UNITYSDK_OFFSET(0x18C5FE50)
#define RPG_CLIENT_MONOMASKSLIDER_UPDATEVALUE_OFFSET UNITYSDK_OFFSET(0x18C5F690)
#define RPG_CLIENT_MONOMASKSLIDER_UPDATE_OFFSET UNITYSDK_OFFSET(0x18C60110)
#define RPG_CLIENT_MONOMASKSLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x18C60340)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoMaskSlider_TypeDefinitionIndex = 69302;
	...
	public:
		...
		::RPG::Client::MonoMaskSlider* Field_5_10; // 0x58
