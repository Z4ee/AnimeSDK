...
#define RPG_CLIENT_GRIDFIGHTTEAM_CYRENEPOSSUMMARIZER_UPDATEDONE_OFFSET UNITYSDK_OFFSET(0x1C5CECF0)
#define RPG_CLIENT_GRIDFIGHTTEAM_CYRENEPOSSUMMARIZER_UPDATESTART_OFFSET UNITYSDK_OFFSET(0x1C5CEB30)
#define RPG_CLIENT_GRIDFIGHTTEAM_CYRENEPOSSUMMARIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5CEED0)
#define RPG_CLIENT_GRIDFIGHTTEAM_CYRENEPOSSUMMARIZER__UPDATEDONE_B__3_0_OFFSET UNITYSDK_OFFSET(0x1C5CEF40)
#define RPG_CLIENT_GRIDFIGHTTEAM_CYRENEPOSSUMMARIZER__UPDATESTART_B__2_0_OFFSET UNITYSDK_OFFSET(0x1C5CEEE0)
