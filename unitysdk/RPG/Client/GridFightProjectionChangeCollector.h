...
#define RPG_CLIENT_GRIDFIGHTPROJECTIONCHANGECOLLECTOR_GET_PROJECTIONADDEDORREMOVED_OFFSET UNITYSDK_OFFSET(0x1AEA5F60)
#define RPG_CLIENT_GRIDFIGHTPROJECTIONCHANGECOLLECTOR_ONCOLLECTIONCHANGEDEVENTHANDLER_OFFSET UNITYSDK_OFFSET(0x1AEA5EF0)
#define RPG_CLIENT_GRIDFIGHTPROJECTIONCHANGECOLLECTOR_ONPROPERTYCHANGEDEVENTHANDLER_OFFSET UNITYSDK_OFFSET(0x1AEA5D60)
#define RPG_CLIENT_GRIDFIGHTPROJECTIONCHANGECOLLECTOR_RESET_OFFSET UNITYSDK_OFFSET(0x1AEA5CC0)
#define RPG_CLIENT_GRIDFIGHTPROJECTIONCHANGECOLLECTOR_SET_PROJECTIONADDEDORREMOVED_OFFSET UNITYSDK_OFFSET(0x1AEA5F70)
#define RPG_CLIENT_GRIDFIGHTPROJECTIONCHANGECOLLECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEA5F80)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightProjectionChangeCollector_TypeDefinitionIndex = 61639;
