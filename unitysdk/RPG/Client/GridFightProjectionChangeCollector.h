...
#define RPG_CLIENT_GRIDFIGHTPROJECTIONCHANGECOLLECTOR_GET_PROJECTIONADDEDORREMOVED_OFFSET UNITYSDK_OFFSET(0x9886720)
#define RPG_CLIENT_GRIDFIGHTPROJECTIONCHANGECOLLECTOR_ONCOLLECTIONCHANGEDEVENTHANDLER_OFFSET UNITYSDK_OFFSET(0x98866B0)
#define RPG_CLIENT_GRIDFIGHTPROJECTIONCHANGECOLLECTOR_ONPROPERTYCHANGEDEVENTHANDLER_OFFSET UNITYSDK_OFFSET(0x98865A0)
#define RPG_CLIENT_GRIDFIGHTPROJECTIONCHANGECOLLECTOR_RESET_OFFSET UNITYSDK_OFFSET(0x9886510)
#define RPG_CLIENT_GRIDFIGHTPROJECTIONCHANGECOLLECTOR_SET_PROJECTIONADDEDORREMOVED_OFFSET UNITYSDK_OFFSET(0x9886730)
#define RPG_CLIENT_GRIDFIGHTPROJECTIONCHANGECOLLECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x9886740)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightProjectionChangeCollector_TypeDefinitionIndex = 52455;
