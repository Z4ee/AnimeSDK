...
#define RPG_CLIENT_CAKERACECHATMESSAGEDATAITEM_CREATE_OFFSET UNITYSDK_OFFSET(0x1AAC0180)
#define RPG_CLIENT_CAKERACECHATMESSAGEDATAITEM_GET_CATID_OFFSET UNITYSDK_OFFSET(0x1AAC09C0)
#define RPG_CLIENT_CAKERACECHATMESSAGEDATAITEM_GET_ISPLAYERUSE_OFFSET UNITYSDK_OFFSET(0x1AAC0A60)
#define RPG_CLIENT_CAKERACECHATMESSAGEDATAITEM_GET_MESSAGEID_OFFSET UNITYSDK_OFFSET(0x1AAC1200)
#define RPG_CLIENT_CAKERACECHATMESSAGEDATAITEM_GET_TEXT_OFFSET UNITYSDK_OFFSET(0x1AAC1270)
#define RPG_CLIENT_CAKERACECHATMESSAGEDATAITEM_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1AAC01D0)
#define RPG_CLIENT_CAKERACECHATMESSAGEDATAITEM_GET__ROW_OFFSET UNITYSDK_OFFSET(0x1AAC1210)
#define RPG_CLIENT_CAKERACECHATMESSAGEDATAITEM_ISSPECIAL_OFFSET UNITYSDK_OFFSET(0x1AAC11B0)
#define RPG_CLIENT_CAKERACECHATMESSAGEDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAC11A0)

namespace RPG::Client
{
	inline static constexpr unsigned int CakeRaceChatMessageDataItem_TypeDefinitionIndex = 60257;
