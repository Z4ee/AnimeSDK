...
#define RPG_CLIENT_CAKERACECHATMESSAGEDATAITEM_CREATE_OFFSET UNITYSDK_OFFSET(0xB493280)
#define RPG_CLIENT_CAKERACECHATMESSAGEDATAITEM_GET_CATID_OFFSET UNITYSDK_OFFSET(0xB493AC0)
#define RPG_CLIENT_CAKERACECHATMESSAGEDATAITEM_GET_ISPLAYERUSE_OFFSET UNITYSDK_OFFSET(0xB493B60)
#define RPG_CLIENT_CAKERACECHATMESSAGEDATAITEM_GET_MESSAGEID_OFFSET UNITYSDK_OFFSET(0xB494300)
#define RPG_CLIENT_CAKERACECHATMESSAGEDATAITEM_GET_TEXT_OFFSET UNITYSDK_OFFSET(0xB494370)
#define RPG_CLIENT_CAKERACECHATMESSAGEDATAITEM_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xB4932D0)
#define RPG_CLIENT_CAKERACECHATMESSAGEDATAITEM_GET__ROW_OFFSET UNITYSDK_OFFSET(0xB494310)
#define RPG_CLIENT_CAKERACECHATMESSAGEDATAITEM_ISSPECIAL_OFFSET UNITYSDK_OFFSET(0xB4942B0)
#define RPG_CLIENT_CAKERACECHATMESSAGEDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xB4942A0)
