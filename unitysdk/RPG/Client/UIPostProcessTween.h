...
#define RPG_CLIENT_UIPOSTPROCESSTWEEN_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0xB428940)
#define RPG_CLIENT_UIPOSTPROCESSTWEEN_METHOD_5_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0xB42AB20)
#define RPG_CLIENT_UIPOSTPROCESSTWEEN_METHOD_5_7250DE5FF780E436_OFFSET UNITYSDK_OFFSET(0xB428AA0)
#define RPG_CLIENT_UIPOSTPROCESSTWEEN_METHOD_5_8C704EC832EDEFC8_OFFSET UNITYSDK_OFFSET(0xB42A660)
#define RPG_CLIENT_UIPOSTPROCESSTWEEN_METHOD_5_93E6B8A6D29521ED_OFFSET UNITYSDK_OFFSET(0xB4290B0)
#define RPG_CLIENT_UIPOSTPROCESSTWEEN_METHOD_5_E41B6A823556FEEA_OFFSET UNITYSDK_OFFSET(0xB429E50)
#define RPG_CLIENT_UIPOSTPROCESSTWEEN_RESET_OFFSET UNITYSDK_OFFSET(0xB42AD40)
#define RPG_CLIENT_UIPOSTPROCESSTWEEN_SETDISABLEUIBLURTWEEN_OFFSET UNITYSDK_OFFSET(0xB42ACF0)
#define RPG_CLIENT_UIPOSTPROCESSTWEEN_SETUIMETA_OFFSET UNITYSDK_OFFSET(0xB428CF0)
#define RPG_CLIENT_UIPOSTPROCESSTWEEN_UPDATE_OFFSET UNITYSDK_OFFSET(0xB42AFA0)
#define RPG_CLIENT_UIPOSTPROCESSTWEEN__CTOR_OFFSET UNITYSDK_OFFSET(0xB42B000)

namespace RPG::Client
{
	inline static constexpr unsigned int UIPostProcessTween_TypeDefinitionIndex = 67299;
	...
	public:
		...
		{
			return (::RPG::Client::UIPostProcessTween**)Il2CppClass::FromTypeDefinitionIndex(UIPostProcessTween_TypeDefinitionIndex)->GetStaticField(0x313D0);
		}
