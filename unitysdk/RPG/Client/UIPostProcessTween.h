...
#define RPG_CLIENT_UIPOSTPROCESSTWEEN_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x17B51090)
#define RPG_CLIENT_UIPOSTPROCESSTWEEN_METHOD_5_24B05D2E15A5C3C8_OFFSET UNITYSDK_OFFSET(0x17B80170)
#define RPG_CLIENT_UIPOSTPROCESSTWEEN_METHOD_5_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0x17B80990)
#define RPG_CLIENT_UIPOSTPROCESSTWEEN_METHOD_5_422AB1A19F04E217_OFFSET UNITYSDK_OFFSET(0x17B7F0D0)
#define RPG_CLIENT_UIPOSTPROCESSTWEEN_METHOD_5_755870B55A8B3AFF_OFFSET UNITYSDK_OFFSET(0x17B7F7B0)
#define RPG_CLIENT_UIPOSTPROCESSTWEEN_METHOD_5_CCFFC97FF79A551F_OFFSET UNITYSDK_OFFSET(0x17B7EAC0)
#define RPG_CLIENT_UIPOSTPROCESSTWEEN_RESET_OFFSET UNITYSDK_OFFSET(0x17B511F0)
#define RPG_CLIENT_UIPOSTPROCESSTWEEN_SETDISABLEUIBLURTWEEN_OFFSET UNITYSDK_OFFSET(0x17B80B60)
#define RPG_CLIENT_UIPOSTPROCESSTWEEN_SETUIMETA_OFFSET UNITYSDK_OFFSET(0x17B7ED20)
#define RPG_CLIENT_UIPOSTPROCESSTWEEN_UPDATE_OFFSET UNITYSDK_OFFSET(0x17B80BB0)
#define RPG_CLIENT_UIPOSTPROCESSTWEEN__CTOR_OFFSET UNITYSDK_OFFSET(0x17B810B0)
#define RPG_CLIENT_UIPOSTPROCESSTWEEN__UPDATEBLURPARAMS_G__FILLPARTIALBLURAREA_25_0_OFFSET UNITYSDK_OFFSET(0x17B80C10)

namespace RPG::Client
{
	inline static constexpr unsigned int UIPostProcessTween_TypeDefinitionIndex = 72998;
	...
	public:
		...
		{
			return (::RPG::Client::UIPostProcessTween**)Il2CppClass::FromTypeDefinitionIndex(UIPostProcessTween_TypeDefinitionIndex)->GetStaticField(0x62CB0);
		}
