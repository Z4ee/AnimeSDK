...
#define RPG_CLIENT_CONVINCESPLITELINECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xB712E30)

namespace RPG::Client
{
	inline static constexpr unsigned int ConvinceSpliteLineConfig_TypeDefinitionIndex = 56709;
