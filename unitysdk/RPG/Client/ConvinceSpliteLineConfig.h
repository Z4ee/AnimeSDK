...
#define RPG_CLIENT_CONVINCESPLITELINECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1802AA50)

namespace RPG::Client
{
	inline static constexpr unsigned int ConvinceSpliteLineConfig_TypeDefinitionIndex = 57955;
