...
#define RPG_CLIENT_UIPROCEDURALSHAPE_CALCULATEPOLYGONMETRICS_OFFSET UNITYSDK_OFFSET(0x17B87BD0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GETPOLYVERTEXEXTENT_OFFSET UNITYSDK_OFFSET(0x17B84E40)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GETPOLYVERTEXRADIUS_OFFSET UNITYSDK_OFFSET(0x17B84880)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_ARCCLOCKWISE_OFFSET UNITYSDK_OFFSET(0x17B86FD0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_ARCEND_OFFSET UNITYSDK_OFFSET(0x17B86DA0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_ARCPROGRESS_OFFSET UNITYSDK_OFFSET(0x17B86F00)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_ARCROUNDCAPS_OFFSET UNITYSDK_OFFSET(0x17B87140)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_ARCSTART_OFFSET UNITYSDK_OFFSET(0x17B86CF0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_ARCTHICKNESS_OFFSET UNITYSDK_OFFSET(0x17B87080)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_ENABLEGLOW_OFFSET UNITYSDK_OFFSET(0x17B85370)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_ENABLEINNERGLOW_OFFSET UNITYSDK_OFFSET(0x17B86C40)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_ENABLEINNERSHADOW_OFFSET UNITYSDK_OFFSET(0x17B86790)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_ENABLEOUTERGLOW_OFFSET UNITYSDK_OFFSET(0x17B852C0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_ENABLESHADOW_OFFSET UNITYSDK_OFFSET(0x17B85690)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_EXTENTMODE_OFFSET UNITYSDK_OFFSET(0x17B84A70)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_FALLOFFDISTANCE_OFFSET UNITYSDK_OFFSET(0x17B85120)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_FILLAMOUNT_OFFSET UNITYSDK_OFFSET(0x17B86490)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_FILLCLOCKWISE_OFFSET UNITYSDK_OFFSET(0x17B866A0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_FILLCOLOR_OFFSET UNITYSDK_OFFSET(0x17B83F70)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_FILLMETHOD_OFFSET UNITYSDK_OFFSET(0x17B863A0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_FILLORIGIN_OFFSET UNITYSDK_OFFSET(0x17B865B0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_GLOWCOLOR_OFFSET UNITYSDK_OFFSET(0x17B85420)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_GLOWSIZE_OFFSET UNITYSDK_OFFSET(0x17B85530)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_GLOWSPREAD_OFFSET UNITYSDK_OFFSET(0x17B855E0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_GRADIENTANGLE_OFFSET UNITYSDK_OFFSET(0x17B85C40)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_GRADIENTCOLORA_OFFSET UNITYSDK_OFFSET(0x17B85D40)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_GRADIENTCOLORB_OFFSET UNITYSDK_OFFSET(0x17B85E50)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_GRADIENTCOLORC_OFFSET UNITYSDK_OFFSET(0x17B85F60)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_GRADIENTCOLORD_OFFSET UNITYSDK_OFFSET(0x17B86070)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_GRADIENTMODE_OFFSET UNITYSDK_OFFSET(0x17B85B50)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_IMAGETYPE_OFFSET UNITYSDK_OFFSET(0x17B86230)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_INDEPENDENTCHANNELALPHA_OFFSET UNITYSDK_OFFSET(0x17B851D0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_INNERSHADOWCOLOR_OFFSET UNITYSDK_OFFSET(0x17B86840)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_INNERSHADOWOFFSET_OFFSET UNITYSDK_OFFSET(0x17B86950)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_INNERSHADOWSIZE_OFFSET UNITYSDK_OFFSET(0x17B86A40)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_INNERSHADOWSPREAD_OFFSET UNITYSDK_OFFSET(0x17B86B40)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_MAINTEXTURE_OFFSET UNITYSDK_OFFSET(0x17B88A30)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_PIXELSPERUNITMULTIPLIER_OFFSET UNITYSDK_OFFSET(0x17B862E0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_POLYGONOFFSET_OFFSET UNITYSDK_OFFSET(0x17B848F0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_POLYGONSIDES_OFFSET UNITYSDK_OFFSET(0x17B84550)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_POLYGONUNIFORMITY_OFFSET UNITYSDK_OFFSET(0x17B84610)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_POLYVERTEXEXTENTS_OFFSET UNITYSDK_OFFSET(0x17B84D50)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_POLYVERTEXRADII_OFFSET UNITYSDK_OFFSET(0x17B84790)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_PRESERVEASPECT_OFFSET UNITYSDK_OFFSET(0x17B872F0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_RADIUSBOTTOMLEFT_OFFSET UNITYSDK_OFFSET(0x17B844A0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_RADIUSBOTTOMRIGHT_OFFSET UNITYSDK_OFFSET(0x17B843F0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_RADIUSINSOURCEPIXELS_OFFSET UNITYSDK_OFFSET(0x17B87450)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_RADIUSSOURCESCALE_OFFSET UNITYSDK_OFFSET(0x17B87500)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_RADIUSTOPLEFT_OFFSET UNITYSDK_OFFSET(0x17B84290)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_RADIUSTOPRIGHT_OFFSET UNITYSDK_OFFSET(0x17B84340)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_RADIUS_OFFSET UNITYSDK_OFFSET(0x17B84130)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_RAYCASTPADDING_OFFSET UNITYSDK_OFFSET(0x17B87230)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x17B849A0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_SHADOWBLEND_OFFSET UNITYSDK_OFFSET(0x17B85A60)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_SHADOWCOLOR_OFFSET UNITYSDK_OFFSET(0x17B85740)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_SHADOWOFFSET_OFFSET UNITYSDK_OFFSET(0x17B85850)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_SHADOWSIZE_OFFSET UNITYSDK_OFFSET(0x17B85900)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_SHADOWSPREAD_OFFSET UNITYSDK_OFFSET(0x17B859B0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_SHAPERADIUSX_OFFSET UNITYSDK_OFFSET(0x17B84B20)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_SHAPERADIUSY_OFFSET UNITYSDK_OFFSET(0x17B84BE0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_SHAPETYPE_OFFSET UNITYSDK_OFFSET(0x17B84080)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_SPRITE_OFFSET UNITYSDK_OFFSET(0x17B86180)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_STROKEALIGNMENT_OFFSET UNITYSDK_OFFSET(0x17B85070)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_STROKECOLOR_OFFSET UNITYSDK_OFFSET(0x17B84F60)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_STROKEWIDTH_OFFSET UNITYSDK_OFFSET(0x17B84EB0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_USEARCPROGRESS_OFFSET UNITYSDK_OFFSET(0x17B86E50)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_USEPERCORNERRADIUS_OFFSET UNITYSDK_OFFSET(0x17B841E0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_USEPERVERTEXEXTENT_OFFSET UNITYSDK_OFFSET(0x17B84CA0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_USEPERVERTEXRADIUS_OFFSET UNITYSDK_OFFSET(0x17B846E0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_GET_USESOURCEPIXELSCALE_OFFSET UNITYSDK_OFFSET(0x17B873A0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_METHOD_8_00033B651FB9F53D_OFFSET UNITYSDK_OFFSET(0x17B89C00)
#define RPG_CLIENT_UIPROCEDURALSHAPE_METHOD_8_006F4D5C221D8114_OFFSET UNITYSDK_OFFSET(0x17B89100)
#define RPG_CLIENT_UIPROCEDURALSHAPE_METHOD_8_10E6005C55578E4A_OFFSET UNITYSDK_OFFSET(0x17B87FB0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_METHOD_8_163DC9A61F1D3AF0_OFFSET UNITYSDK_OFFSET(0x17B88AC0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_METHOD_8_2D0BCE0D36736E0C_OFFSET UNITYSDK_OFFSET(0x17B88270)
#define RPG_CLIENT_UIPROCEDURALSHAPE_METHOD_8_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0x17B88F20)
#define RPG_CLIENT_UIPROCEDURALSHAPE_METHOD_8_3A6CA94423A5B9DB_OFFSET UNITYSDK_OFFSET(0x17B88330)
#define RPG_CLIENT_UIPROCEDURALSHAPE_METHOD_8_68A2CA32DC720C44_OFFSET UNITYSDK_OFFSET(0x17B87B20)
#define RPG_CLIENT_UIPROCEDURALSHAPE_METHOD_8_68D158D7FBF6D878_OFFSET UNITYSDK_OFFSET(0x17B88120)
#define RPG_CLIENT_UIPROCEDURALSHAPE_METHOD_8_73321D22C595F259_OFFSET UNITYSDK_OFFSET(0x17B87EC0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_METHOD_8_861970C5F2C21AB2_OFFSET UNITYSDK_OFFSET(0x17B87670)
#define RPG_CLIENT_UIPROCEDURALSHAPE_METHOD_8_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0x17B87760)
#define RPG_CLIENT_UIPROCEDURALSHAPE_METHOD_8_B1508D96B5FD5094_OFFSET UNITYSDK_OFFSET(0x17B87560)
#define RPG_CLIENT_UIPROCEDURALSHAPE_METHOD_8_B2C52ACF9D9B435B_OFFSET UNITYSDK_OFFSET(0x17B88B60)
#define RPG_CLIENT_UIPROCEDURALSHAPE_METHOD_8_DF892EE47C651B9A_OFFSET UNITYSDK_OFFSET(0x17B89180)
#define RPG_CLIENT_UIPROCEDURALSHAPE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x17B88D50)
#define RPG_CLIENT_UIPROCEDURALSHAPE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x17B88E60)
#define RPG_CLIENT_UIPROCEDURALSHAPE_ONPOPULATEMESH_OFFSET UNITYSDK_OFFSET(0x17B89670)
#define RPG_CLIENT_UIPROCEDURALSHAPE_ONRECTTRANSFORMDIMENSIONSCHANGE_OFFSET UNITYSDK_OFFSET(0x17B89060)
#define RPG_CLIENT_UIPROCEDURALSHAPE_ONTRANSFORMPARENTCHANGED_OFFSET UNITYSDK_OFFSET(0x17B88FB0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SETNATIVESIZE_OFFSET UNITYSDK_OFFSET(0x17B877A0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SETPOLYVERTEXEXTENT_OFFSET UNITYSDK_OFFSET(0x17B84DA0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SETPOLYVERTEXRADIUS_OFFSET UNITYSDK_OFFSET(0x17B847E0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_ARCCLOCKWISE_OFFSET UNITYSDK_OFFSET(0x17B87020)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_ARCEND_OFFSET UNITYSDK_OFFSET(0x17B86DF0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_ARCPROGRESS_OFFSET UNITYSDK_OFFSET(0x17B86F50)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_ARCROUNDCAPS_OFFSET UNITYSDK_OFFSET(0x17B87190)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_ARCSTART_OFFSET UNITYSDK_OFFSET(0x17B86D40)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_ARCTHICKNESS_OFFSET UNITYSDK_OFFSET(0x17B870D0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_ENABLEGLOW_OFFSET UNITYSDK_OFFSET(0x17B853C0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_ENABLEINNERGLOW_OFFSET UNITYSDK_OFFSET(0x17B86C90)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_ENABLEINNERSHADOW_OFFSET UNITYSDK_OFFSET(0x17B867E0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_ENABLEOUTERGLOW_OFFSET UNITYSDK_OFFSET(0x17B85310)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_ENABLESHADOW_OFFSET UNITYSDK_OFFSET(0x17B856E0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_EXTENTMODE_OFFSET UNITYSDK_OFFSET(0x17B84AC0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_FALLOFFDISTANCE_OFFSET UNITYSDK_OFFSET(0x17B85170)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_FILLAMOUNT_OFFSET UNITYSDK_OFFSET(0x17B864E0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_FILLCLOCKWISE_OFFSET UNITYSDK_OFFSET(0x17B866F0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_FILLCOLOR_OFFSET UNITYSDK_OFFSET(0x17B83FD0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_FILLMETHOD_OFFSET UNITYSDK_OFFSET(0x17B863F0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_FILLORIGIN_OFFSET UNITYSDK_OFFSET(0x17B86600)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_GLOWCOLOR_OFFSET UNITYSDK_OFFSET(0x17B85480)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_GLOWSIZE_OFFSET UNITYSDK_OFFSET(0x17B85580)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_GLOWSPREAD_OFFSET UNITYSDK_OFFSET(0x17B85630)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_GRADIENTANGLE_OFFSET UNITYSDK_OFFSET(0x17B85C90)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_GRADIENTCOLORA_OFFSET UNITYSDK_OFFSET(0x17B85DA0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_GRADIENTCOLORB_OFFSET UNITYSDK_OFFSET(0x17B85EB0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_GRADIENTCOLORC_OFFSET UNITYSDK_OFFSET(0x17B85FC0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_GRADIENTCOLORD_OFFSET UNITYSDK_OFFSET(0x17B860D0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_GRADIENTMODE_OFFSET UNITYSDK_OFFSET(0x17B85BA0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_IMAGETYPE_OFFSET UNITYSDK_OFFSET(0x17B86280)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_INDEPENDENTCHANNELALPHA_OFFSET UNITYSDK_OFFSET(0x17B85220)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_INNERSHADOWCOLOR_OFFSET UNITYSDK_OFFSET(0x17B868A0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_INNERSHADOWOFFSET_OFFSET UNITYSDK_OFFSET(0x17B869A0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_INNERSHADOWSIZE_OFFSET UNITYSDK_OFFSET(0x17B86A90)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_INNERSHADOWSPREAD_OFFSET UNITYSDK_OFFSET(0x17B86B90)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_PIXELSPERUNITMULTIPLIER_OFFSET UNITYSDK_OFFSET(0x17B86330)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_POLYGONOFFSET_OFFSET UNITYSDK_OFFSET(0x17B84940)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_POLYGONSIDES_OFFSET UNITYSDK_OFFSET(0x17B845A0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_POLYGONUNIFORMITY_OFFSET UNITYSDK_OFFSET(0x17B84660)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_PRESERVEASPECT_OFFSET UNITYSDK_OFFSET(0x17B87340)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_RADIUSBOTTOMLEFT_OFFSET UNITYSDK_OFFSET(0x17B844F0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_RADIUSBOTTOMRIGHT_OFFSET UNITYSDK_OFFSET(0x17B84440)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_RADIUSINSOURCEPIXELS_OFFSET UNITYSDK_OFFSET(0x17B874A0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_RADIUSTOPLEFT_OFFSET UNITYSDK_OFFSET(0x17B842E0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_RADIUSTOPRIGHT_OFFSET UNITYSDK_OFFSET(0x17B84390)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_RADIUS_OFFSET UNITYSDK_OFFSET(0x17B84180)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_RAYCASTPADDING_OFFSET UNITYSDK_OFFSET(0x17B87290)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_ROTATION_OFFSET UNITYSDK_OFFSET(0x17B849F0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_SHADOWBLEND_OFFSET UNITYSDK_OFFSET(0x17B85AB0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_SHADOWCOLOR_OFFSET UNITYSDK_OFFSET(0x17B857A0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_SHADOWOFFSET_OFFSET UNITYSDK_OFFSET(0x17B858A0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_SHADOWSIZE_OFFSET UNITYSDK_OFFSET(0x17B85950)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_SHADOWSPREAD_OFFSET UNITYSDK_OFFSET(0x17B85A00)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_SHAPERADIUSX_OFFSET UNITYSDK_OFFSET(0x17B84B70)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_SHAPERADIUSY_OFFSET UNITYSDK_OFFSET(0x17B84C30)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_SHAPETYPE_OFFSET UNITYSDK_OFFSET(0x17B840D0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_SPRITE_OFFSET UNITYSDK_OFFSET(0x17B861D0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_STROKEALIGNMENT_OFFSET UNITYSDK_OFFSET(0x17B850C0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_STROKECOLOR_OFFSET UNITYSDK_OFFSET(0x17B84FC0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_STROKEWIDTH_OFFSET UNITYSDK_OFFSET(0x17B84F00)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_USEARCPROGRESS_OFFSET UNITYSDK_OFFSET(0x17B86EA0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_USEPERCORNERRADIUS_OFFSET UNITYSDK_OFFSET(0x17B84230)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_USEPERVERTEXEXTENT_OFFSET UNITYSDK_OFFSET(0x17B84CF0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_USEPERVERTEXRADIUS_OFFSET UNITYSDK_OFFSET(0x17B84730)
#define RPG_CLIENT_UIPROCEDURALSHAPE_SET_USESOURCEPIXELSCALE_OFFSET UNITYSDK_OFFSET(0x17B873F0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_UNITYENGINE_ICANVASRAYCASTFILTER_ISRAYCASTLOCATIONVALID_OFFSET UNITYSDK_OFFSET(0x17B8B7A0)
#define RPG_CLIENT_UIPROCEDURALSHAPE_UPDATEMATERIAL_OFFSET UNITYSDK_OFFSET(0x17B8B680)
#define RPG_CLIENT_UIPROCEDURALSHAPE__APPLYMATERIALPROPERTIES_G__E_290_0_OFFSET UNITYSDK_OFFSET(0x17B8B630)
#define RPG_CLIENT_UIPROCEDURALSHAPE__CTOR_OFFSET UNITYSDK_OFFSET(0x17B8BEF0)

namespace RPG::Client
{
	inline static constexpr unsigned int UIProceduralShape_TypeDefinitionIndex = 72629;
	...
	public:
		...
		{
			return (::UnityEngine::Material**)Il2CppClass::FromTypeDefinitionIndex(UIProceduralShape_TypeDefinitionIndex)->GetStaticField(0x63060);
		}
