...
#define RPG_CLIENT_GRIDBASEDEVENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD127D40)

namespace RPG::Client
{
	inline static constexpr unsigned int GridBasedEventData_TypeDefinitionIndex = 72461;
