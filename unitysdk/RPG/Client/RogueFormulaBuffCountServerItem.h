...
#define RPG_CLIENT_ROGUEFORMULABUFFCOUNTSERVERITEM_GET_ACHIEVEDBUFFCOUNT_OFFSET UNITYSDK_OFFSET(0x1BC86380)
#define RPG_CLIENT_ROGUEFORMULABUFFCOUNTSERVERITEM_GET_ISBUFFCOUNTSATISFIED_OFFSET UNITYSDK_OFFSET(0x1BC86400)
#define RPG_CLIENT_ROGUEFORMULABUFFCOUNTSERVERITEM_GET_REQUIREDBUFFCOUNT_OFFSET UNITYSDK_OFFSET(0x1BC863C0)
#define RPG_CLIENT_ROGUEFORMULABUFFCOUNTSERVERITEM_SYNCBUFFCOUNT_OFFSET UNITYSDK_OFFSET(0x1BC86220)
#define RPG_CLIENT_ROGUEFORMULABUFFCOUNTSERVERITEM_SYNCCONDITION_OFFSET UNITYSDK_OFFSET(0x1BC861B0)
#define RPG_CLIENT_ROGUEFORMULABUFFCOUNTSERVERITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC861A0)
