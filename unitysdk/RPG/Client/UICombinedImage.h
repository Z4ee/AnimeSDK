...
#define RPG_CLIENT_UICOMBINEDIMAGE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1721C080)
#define RPG_CLIENT_UICOMBINEDIMAGE_HIDE_OFFSET UNITYSDK_OFFSET(0x1721BDC0)
#define RPG_CLIENT_UICOMBINEDIMAGE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1721C0E0)
#define RPG_CLIENT_UICOMBINEDIMAGE_SHOW_OFFSET UNITYSDK_OFFSET(0x1721B830)
#define RPG_CLIENT_UICOMBINEDIMAGE__CLEARTEXTURES_OFFSET UNITYSDK_OFFSET(0x1721BE10)
#define RPG_CLIENT_UICOMBINEDIMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1721C220)
#define RPG_CLIENT_UICOMBINEDIMAGE__GETTEXTUREPROPERTY_OFFSET UNITYSDK_OFFSET(0x1721C140)
#define RPG_CLIENT_UICOMBINEDIMAGE__LOADCOMBINEDTEXTURES_OFFSET UNITYSDK_OFFSET(0x1721BA70)
#define RPG_CLIENT_UICOMBINEDIMAGE__RELEASECOMBINEDTEXTURES_OFFSET UNITYSDK_OFFSET(0x1721B990)
#define RPG_CLIENT_UICOMBINEDIMAGE__SAFEINIT_OFFSET UNITYSDK_OFFSET(0x1721B8B0)
#define RPG_CLIENT_UICOMBINEDIMAGE__SETUPTEXTURES_OFFSET UNITYSDK_OFFSET(0x1721BBF0)

namespace RPG::Client
{
	inline static constexpr unsigned int UICombinedImage_TypeDefinitionIndex = 66007;
