...
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0xD1A3CD0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION_EXPORTSHARECODE_OFFSET UNITYSDK_OFFSET(0xD1A4260)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION_GETBASICRECOMMENDEQUIP_OFFSET UNITYSDK_OFFSET(0xD1A8F90)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION_GETCOPY_OFFSET UNITYSDK_OFFSET(0xD1A7110)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION_GETEDITOR_OFFSET UNITYSDK_OFFSET(0xD1A89C0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION_GETEQUIPIDFROMPALETTE_OFFSET UNITYSDK_OFFSET(0xD1A3760)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION_GETEQUIPPALETTEINDEX_OFFSET UNITYSDK_OFFSET(0xD1A3690)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION_GETRECOMMENDEQUIPS_OFFSET UNITYSDK_OFFSET(0xD1A9D90)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION_GETRECOMMENDEQUIP_OFFSET UNITYSDK_OFFSET(0xD1A8E60)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION_GETROLEIDFROMPALETTE_OFFSET UNITYSDK_OFFSET(0xD1A3560)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION_GETROLEPALETTEINDEX_OFFSET UNITYSDK_OFFSET(0xD1A3490)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION_GETSHARECODETITLE_OFFSET UNITYSDK_OFFSET(0xD1A5700)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION_GET_COREROLEIDS_OFFSET UNITYSDK_OFFSET(0xD1A79A0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0xD1A70D0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION_GET_EARLYROLES_OFFSET UNITYSDK_OFFSET(0xD1A9580)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION_GET_EARLYTEAM_OFFSET UNITYSDK_OFFSET(0xD1A9A60)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION_GET_EXPIREDSUMMARY_OFFSET UNITYSDK_OFFSET(0xD1A2FF0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION_GET_FINALROLES_OFFSET UNITYSDK_OFFSET(0xD1A9560)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION_GET_FINALTEAM_OFFSET UNITYSDK_OFFSET(0xD1A9940)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION_GET_FROMREFID_OFFSET UNITYSDK_OFFSET(0xD1A98D0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION_GET_FROMREF_OFFSET UNITYSDK_OFFSET(0xD1A98F0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION_GET_ISAPPLIED_OFFSET UNITYSDK_OFFSET(0xD1A9DF0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0xD1A95B0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION_GET_ISPALETTEREADY_OFFSET UNITYSDK_OFFSET(0xD1A33F0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION_GET_MAINROLES_OFFSET UNITYSDK_OFFSET(0xD1A9AF0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION_GET_MIDROLES_OFFSET UNITYSDK_OFFSET(0xD1A9570)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION_GET_MIDTEAM_OFFSET UNITYSDK_OFFSET(0xD1A99D0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION_GET_ORDEREDRECOMMENDBASICEQUIPIDS_OFFSET UNITYSDK_OFFSET(0xD1A9590)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION_GET_ORDEREDRECOMMENDEQUIPIDS_OFFSET UNITYSDK_OFFSET(0xD1A95A0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION_GET_RECOMMENDBASICEQUIPS_OFFSET UNITYSDK_OFFSET(0xD1A90C0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION_GET_RECOMMENDEQUIPS_OFFSET UNITYSDK_OFFSET(0xD1A9300)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION_GET_SEASONUID_OFFSET UNITYSDK_OFFSET(0xD1A98B0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION_GET_SLOTINDEX_OFFSET UNITYSDK_OFFSET(0xD1A9540)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION_GET_TITLE_OFFSET UNITYSDK_OFFSET(0xD1A4840)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION_HASANYEQUIPTOTRACK_OFFSET UNITYSDK_OFFSET(0xD1A5B10)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION_IMPORTREF_OFFSET UNITYSDK_OFFSET(0xD1A5EC0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION_IMPORTSHARECODE_OFFSET UNITYSDK_OFFSET(0xD1A4880)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION_INITSHARECODEPALETTE_OFFSET UNITYSDK_OFFSET(0xD1A3070)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION_ISREFERENCED_OFFSET UNITYSDK_OFFSET(0xD1A81E0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION_ISROLEMAIN_OFFSET UNITYSDK_OFFSET(0xD1A9CF0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION_SERIALIZE_OFFSET UNITYSDK_OFFSET(0xD1A3890)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION_SET_COREROLEIDS_OFFSET UNITYSDK_OFFSET(0xD1A6700)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION_SET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0xD1A6690)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION_SET_FROMREFID_OFFSET UNITYSDK_OFFSET(0xD1A98E0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION_SET_SEASONUID_OFFSET UNITYSDK_OFFSET(0xD1A98C0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION_SET_SLOTINDEX_OFFSET UNITYSDK_OFFSET(0xD1A9550)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION_SET_TITLE_OFFSET UNITYSDK_OFFSET(0xD1A5690)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION_UPDATETOSERVER_OFFSET UNITYSDK_OFFSET(0xD1A6F60)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION__ADDROLESTO_OFFSET UNITYSDK_OFFSET(0xD1A6790)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION__CCTOR_OFFSET UNITYSDK_OFFSET(0xD1A9EF0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION__CLEAR_OFFSET UNITYSDK_OFFSET(0xD1A5330)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION__CLIPTEXTWITHUNICODELENGTH_OFFSET UNITYSDK_OFFSET(0xD1A5D10)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION__COMPRESS_OFFSET UNITYSDK_OFFSET(0xD1A4460)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION__COPYROLESTO_OFFSET UNITYSDK_OFFSET(0xD1A79E0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0xD1A58C0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION__DECOMPRESS_OFFSET UNITYSDK_OFFSET(0xD1A4D40)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION__IMPORTREF_B__31_0_OFFSET UNITYSDK_OFFSET(0xD1AA050)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATION__IMPORTREF_B__31_1_OFFSET UNITYSDK_OFFSET(0xD1AA350)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(GridFightGameFormation_TypeDefinitionIndex)->GetStaticField(0x2CC90);
		}
		static ::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Int32>** StaticGet__RoleIndexMap()
		{
			return (::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(GridFightGameFormation_TypeDefinitionIndex)->GetStaticField(0x2CC98);
		}
		static ::System::Collections::Generic::List_1<::System::UInt32>** StaticGet__EquipPalette()
		{
			return (::System::Collections::Generic::List_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(GridFightGameFormation_TypeDefinitionIndex)->GetStaticField(0x2CCA0);
		}
		static ::Class_0_16E4307DCC419505_864** StaticGet__ShareSerializerV2()
		{
			return (::Class_0_16E4307DCC419505_864**)Il2CppClass::FromTypeDefinitionIndex(GridFightGameFormation_TypeDefinitionIndex)->GetStaticField(0x2CCA8);
		}
		static ::Class_0_16E4307DCC419505_864** StaticGet__ShareSerializerV3()
		{
			return (::Class_0_16E4307DCC419505_864**)Il2CppClass::FromTypeDefinitionIndex(GridFightGameFormation_TypeDefinitionIndex)->GetStaticField(0x2CCB0);
		}
		static ::Class_0_16E4307DCC419505_864** StaticGet__ShareSerializerV1()
		{
			return (::Class_0_16E4307DCC419505_864**)Il2CppClass::FromTypeDefinitionIndex(GridFightGameFormation_TypeDefinitionIndex)->GetStaticField(0x2CCB8);
		}
		static ::Il2CppArray<::System::UInt32>** StaticGet_s_FixedRolePalette()
		{
			return (::Il2CppArray<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(GridFightGameFormation_TypeDefinitionIndex)->GetStaticField(0x2CCC0);
		}
		static ::Il2CppArray<::System::UInt32>** StaticGet_s_FixedEquipPalette()
		{
			return (::Il2CppArray<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(GridFightGameFormation_TypeDefinitionIndex)->GetStaticField(0x2CCC8);
		}
		static ::System::Collections::Generic::List_1<::System::UInt32>** StaticGet__RolePalette()
		{
			return (::System::Collections::Generic::List_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(GridFightGameFormation_TypeDefinitionIndex)->GetStaticField(0x2CCD0);
		}
		static ::System::Boolean* StaticGet_UseV3ShareCode()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(GridFightGameFormation_TypeDefinitionIndex)->GetStaticField(0xCBE0);
		}
		...
		::Class_1_AF67E01114A98070* _FinalRoles_k__BackingField; // 0x28
		::Class_1_AF67E01114A98070* _MidRoles_k__BackingField; // 0x30
		...
		::Sofa::Core::ObservableList_1<::System::UInt32>* _OrderedRecommendBasicEquipIDs_k__BackingField; // 0x58
