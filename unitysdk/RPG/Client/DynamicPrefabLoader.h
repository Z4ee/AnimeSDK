...
#define RPG_CLIENT_DYNAMICPREFABLOADER_GET_COUNT_OFFSET UNITYSDK_OFFSET(0xCDB1700)
#define RPG_CLIENT_DYNAMICPREFABLOADER_GET_MOUNTPOINT_OFFSET UNITYSDK_OFFSET(0xCDB1790)
#define RPG_CLIENT_DYNAMICPREFABLOADER_GET_PREFABREFERENCES_OFFSET UNITYSDK_OFFSET(0xCDB1750)
#define RPG_CLIENT_DYNAMICPREFABLOADER_METHOD_1_06967C08089797EA_OFFSET UNITYSDK_OFFSET(0xCDB1A80)
#define RPG_CLIENT_DYNAMICPREFABLOADER_METHOD_1_263D31130C40FFCE_OFFSET UNITYSDK_OFFSET(0xCDB1B00)
#define RPG_CLIENT_DYNAMICPREFABLOADER_METHOD_1_7900DB25C44BBC9B_OFFSET UNITYSDK_OFFSET(0xCDB17D0)
#define RPG_CLIENT_DYNAMICPREFABLOADER_METHOD_1_CDB4AF41FB50E1D8_OFFSET UNITYSDK_OFFSET(0xCDB1C40)
#define RPG_CLIENT_DYNAMICPREFABLOADER_METHOD_1_EAA1AA53E20D568D_OFFSET UNITYSDK_OFFSET(0xCDB1820)
#define RPG_CLIENT_DYNAMICPREFABLOADER__CTOR_OFFSET UNITYSDK_OFFSET(0xCDB1CF0)

namespace RPG::Client
{
	inline static constexpr unsigned int DynamicPrefabLoader_TypeDefinitionIndex = 72684;
