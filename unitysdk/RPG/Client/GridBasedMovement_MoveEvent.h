...
#define RPG_CLIENT_GRIDBASEDMOVEMENT_MOVEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0xD128940)

namespace RPG::Client
{
	inline static constexpr unsigned int GridBasedMovement_MoveEvent_TypeDefinitionIndex = 72463;
