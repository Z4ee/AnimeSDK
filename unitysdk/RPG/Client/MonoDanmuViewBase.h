...
#define RPG_CLIENT_MONODANMUVIEWBASE_AWAKE_OFFSET UNITYSDK_OFFSET(0x10CC8E50)
#define RPG_CLIENT_MONODANMUVIEWBASE_GET_RECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x10CC8E30)
#define RPG_CLIENT_MONODANMUVIEWBASE_SET_RECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x10CC8E40)
#define RPG_CLIENT_MONODANMUVIEWBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x10CC8EF0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoDanmuViewBase_TypeDefinitionIndex = 65876;
