...
#define RPG_CLIENT_FATESUPPORTCOLLECTIONPART_GETGAMEPLAYACTIVITYPANELDATA_OFFSET UNITYSDK_OFFSET(0xD03A290)
#define RPG_CLIENT_FATESUPPORTCOLLECTIONPART_GET_COLLECTIONACTIVITYID_OFFSET UNITYSDK_OFFSET(0xD039EB0)
#define RPG_CLIENT_FATESUPPORTCOLLECTIONPART_GET_GAMEPLAYACTIVITYID_OFFSET UNITYSDK_OFFSET(0xD039E70)
#define RPG_CLIENT_FATESUPPORTCOLLECTIONPART_GET_MISSIONCHRONICLEMAINPATHID_OFFSET UNITYSDK_OFFSET(0xD03A0B0)
#define RPG_CLIENT_FATESUPPORTCOLLECTIONPART_GET_MISSIONCONTENTID_OFFSET UNITYSDK_OFFSET(0xD039EF0)
#define RPG_CLIENT_FATESUPPORTCOLLECTIONPART_GET__GACHAREWARDQUESTID_OFFSET UNITYSDK_OFFSET(0xD039FA0)
#define RPG_CLIENT_FATESUPPORTCOLLECTIONPART_HASGACHAREWARD_OFFSET UNITYSDK_OFFSET(0xD03A5E0)
#define RPG_CLIENT_FATESUPPORTCOLLECTIONPART_ISMAINMISSIONFINISHED_OFFSET UNITYSDK_OFFSET(0xD03A4F0)
#define RPG_CLIENT_FATESUPPORTCOLLECTIONPART_ONLOGINFINISH_OFFSET UNITYSDK_OFFSET(0xD03A1A0)
#define RPG_CLIENT_FATESUPPORTCOLLECTIONPART__CTOR_OFFSET UNITYSDK_OFFSET(0xD03A7C0)
