...
#define RPG_CLIENT_ST_PARKOUR_BYCOMPAREPROJECTILEHITCOUNT_METHOD_4_2A420BA176281294_OFFSET UNITYSDK_OFFSET(0x185ED110)
#define RPG_CLIENT_ST_PARKOUR_BYCOMPAREPROJECTILEHITCOUNT_METHOD_4_95EC1CEABF7FE5F0_OFFSET UNITYSDK_OFFSET(0x185ED040)
#define RPG_CLIENT_ST_PARKOUR_BYCOMPAREPROJECTILEHITCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x185ED0C0)

namespace RPG::Client
{
	inline static constexpr unsigned int ST_Parkour_ByCompareProjectileHitCount_TypeDefinitionIndex = 10135;
