...
#define RPG_CLIENT_ST_PARKOUR_BYCOMPAREPROJECTILEHITCOUNT_METHOD_4_2A420BA176281294_OFFSET UNITYSDK_OFFSET(0x1D31EE30)
#define RPG_CLIENT_ST_PARKOUR_BYCOMPAREPROJECTILEHITCOUNT_METHOD_4_3025C325438C1838_OFFSET UNITYSDK_OFFSET(0x1D31F010)
#define RPG_CLIENT_ST_PARKOUR_BYCOMPAREPROJECTILEHITCOUNT_METHOD_4_47314AB0F820515F_OFFSET UNITYSDK_OFFSET(0x1D31F040)
#define RPG_CLIENT_ST_PARKOUR_BYCOMPAREPROJECTILEHITCOUNT_METHOD_4_69EC066A6F156695_OFFSET UNITYSDK_OFFSET(0x1D31EDF0)
#define RPG_CLIENT_ST_PARKOUR_BYCOMPAREPROJECTILEHITCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D31EE20)

namespace RPG::Client
{
	inline static constexpr unsigned int ST_Parkour_ByCompareProjectileHitCount_TypeDefinitionIndex = 10251;
