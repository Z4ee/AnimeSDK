...
#define RPG_CLIENT_IRI_DEFERREDDECALMONOPLUGIN_ADDDECALINSTANCE_OFFSET UNITYSDK_OFFSET(0x19833ED0)
#define RPG_CLIENT_IRI_DEFERREDDECALMONOPLUGIN_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x198348D0)
#define RPG_CLIENT_IRI_DEFERREDDECALMONOPLUGIN_GET_ARTBOUNDFULL_OFFSET UNITYSDK_OFFSET(0x19834380)
#define RPG_CLIENT_IRI_DEFERREDDECALMONOPLUGIN_GET_ARTBOUND_OFFSET UNITYSDK_OFFSET(0x198342D0)
#define RPG_CLIENT_IRI_DEFERREDDECALMONOPLUGIN_GET_RENDERBUDGETDATA_OFFSET UNITYSDK_OFFSET(0x198346B0)
#define RPG_CLIENT_IRI_DEFERREDDECALMONOPLUGIN_GET_RENDERINSTANCECOLLECTMODE_OFFSET UNITYSDK_OFFSET(0x198348C0)
#define RPG_CLIENT_IRI_DEFERREDDECALMONOPLUGIN_REMOVEDECALINSTANCE_OFFSET UNITYSDK_OFFSET(0x19834000)
#define RPG_CLIENT_IRI_DEFERREDDECALMONOPLUGIN_SETDECALVISIBLE_OFFSET UNITYSDK_OFFSET(0x19834230)
#define RPG_CLIENT_IRI_DEFERREDDECALMONOPLUGIN_UPDATEDECALCUSTOMDATA_OFFSET UNITYSDK_OFFSET(0x19834180)
#define RPG_CLIENT_IRI_DEFERREDDECALMONOPLUGIN_UPDATEDECALINSTANCE_OFFSET UNITYSDK_OFFSET(0x19834090)
#define RPG_CLIENT_IRI_DEFERREDDECALMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x19834920)
