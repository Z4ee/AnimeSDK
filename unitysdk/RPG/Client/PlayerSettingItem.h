...
#define RPG_CLIENT_PLAYERSETTINGITEM_GET_VALUE_OFFSET UNITYSDK_OFFSET(0xDBB44D0)
#define RPG_CLIENT_PLAYERSETTINGITEM_SET_DEFAULTVALUE_OFFSET UNITYSDK_OFFSET(0xDBB4560)
#define RPG_CLIENT_PLAYERSETTINGITEM_SET_VALUE_OFFSET UNITYSDK_OFFSET(0xDBB4510)
#define RPG_CLIENT_PLAYERSETTINGITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xDBB4570)
