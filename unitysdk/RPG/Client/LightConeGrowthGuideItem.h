...
#define RPG_CLIENT_LIGHTCONEGROWTHGUIDEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x997AEB0)

namespace RPG::Client
{
	inline static constexpr unsigned int LightConeGrowthGuideItem_TypeDefinitionIndex = 53224;
