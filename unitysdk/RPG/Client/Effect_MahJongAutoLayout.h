...
class Class_2_C754764E80A7E657;
namespace RPG::Client { class MonoEffectPluginMahJongItem; }
namespace System { class String; }
namespace System::Collections::Generic { template <typename T> class List_1; }

#define RPG_CLIENT_EFFECT_MAHJONGAUTOLAYOUT_AWAKEPLUGIN_OFFSET UNITYSDK_OFFSET(0xB868D70)
#define RPG_CLIENT_EFFECT_MAHJONGAUTOLAYOUT_DESTROYPLUGIN_OFFSET UNITYSDK_OFFSET(0xB868E60)
#define RPG_CLIENT_EFFECT_MAHJONGAUTOLAYOUT_DISPOSEPLUGIN_OFFSET UNITYSDK_OFFSET(0xB868CD0)
#define RPG_CLIENT_EFFECT_MAHJONGAUTOLAYOUT_ENDOFLATETICK_OFFSET UNITYSDK_OFFSET(0xB868C60)
#define RPG_CLIENT_EFFECT_MAHJONGAUTOLAYOUT_GET_BEHAVIOR_OFFSET UNITYSDK_OFFSET(0xB868F20)
#define RPG_CLIENT_EFFECT_MAHJONGAUTOLAYOUT_RESETPLUGIN_OFFSET UNITYSDK_OFFSET(0xB868B50)
#define RPG_CLIENT_EFFECT_MAHJONGAUTOLAYOUT__CTOR_OFFSET UNITYSDK_OFFSET(0xB868F30)
#define RPG_CLIENT_EFFECT_MAHJONGAUTOLAYOUT___IFIXBASEPROXY_AWAKEPLUGIN_OFFSET UNITYSDK_OFFSET(0xB8690B0)
#define RPG_CLIENT_EFFECT_MAHJONGAUTOLAYOUT___IFIXBASEPROXY_DESTROYPLUGIN_OFFSET UNITYSDK_OFFSET(0xB869110)
#define RPG_CLIENT_EFFECT_MAHJONGAUTOLAYOUT___IFIXBASEPROXY_ENDOFLATETICK_OFFSET UNITYSDK_OFFSET(0xB869050)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_MahJongAutoLayout_TypeDefinitionIndex = 65470;
	...
	public:
		...
		::Class_2_C754764E80A7E657* Field_6_16; // 0x98
		...
		::Class_2_C754764E80A7E657* get_Behavior()
		{
			return ((::Class_2_C754764E80A7E657*(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_EFFECT_MAHJONGAUTOLAYOUT_GET_BEHAVIOR_OFFSET))(this);
		}

		::System::Void __iFixBaseProxy_EndOfLateTick(::System::Single a1)
		{
			return ((::System::Void(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + RPG_CLIENT_EFFECT_MAHJONGAUTOLAYOUT___IFIXBASEPROXY_ENDOFLATETICK_OFFSET))(this, a1);
		}
