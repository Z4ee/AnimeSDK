...
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORMONOPLUGIN_DUMP_OFFSET UNITYSDK_OFFSET(0xB1BA700)
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORMONOPLUGIN_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xB1BA900)
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORMONOPLUGIN_GET_ACTIVECURVEPOOL_OFFSET UNITYSDK_OFFSET(0xB1BA8F0)
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORMONOPLUGIN_GET_SIGNALCURVE_OFFSET UNITYSDK_OFFSET(0xB1B8A40)
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORMONOPLUGIN_LOAD_OFFSET UNITYSDK_OFFSET(0xB1BA660)
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORMONOPLUGIN_METHOD_7_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xB1BA890)
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORMONOPLUGIN_METHOD_7_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xB1BA8E0)
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xB1BA950)
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORMONOPLUGIN___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xB1BA9A0)

namespace RPG::Client
{
	inline static constexpr unsigned int StageHarmonySignalDemodulatorMonoPlugin_TypeDefinitionIndex = 65442;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::RPG::GameCore::StageSceneItemSerializationData*))((::PBYTE)hIl2Cpp + RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORMONOPLUGIN_LOAD_OFFSET))(this, a1);
		}

		::System::Void Dump(::RPG::GameCore::StageSceneItemSerializationData* a1)
		{
			return ((::System::Void(*)(::PVOID, ::RPG::GameCore::StageSceneItemSerializationData*))((::PBYTE)hIl2Cpp + RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORMONOPLUGIN_DUMP_OFFSET))(this, a1);
		}
