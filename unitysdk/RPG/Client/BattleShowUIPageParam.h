...
#define RPG_CLIENT_BATTLESHOWUIPAGEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xB417AE0)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleShowUIPageParam_TypeDefinitionIndex = 67151;

	class BattleShowUIPageParam : public ::System::Object
	{
	public:
		::Il2CppArray<::RPG::GameCore::UIImageNode*>* UIImageNodes; // 0x10
		::System::Collections::Generic::List_1<::RPG::Client::BattleShowUIPageTextParam*>* UITextParams; // 0x18
