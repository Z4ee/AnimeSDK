...
#define RPG_CLIENT_BATTLESHOWUIPAGEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x9E7D570)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleShowUIPageParam_TypeDefinitionIndex = 66212;
