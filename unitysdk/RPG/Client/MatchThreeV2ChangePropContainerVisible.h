...
#define RPG_CLIENT_MATCHTHREEV2CHANGEPROPCONTAINERVISIBLE_METHOD_3_0CE87EFF075956C4_OFFSET UNITYSDK_OFFSET(0x193BB4F0)
#define RPG_CLIENT_MATCHTHREEV2CHANGEPROPCONTAINERVISIBLE_METHOD_3_F3278A475339E135_OFFSET UNITYSDK_OFFSET(0x193BB570)
#define RPG_CLIENT_MATCHTHREEV2CHANGEPROPCONTAINERVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x193BB540)

namespace RPG::Client
{
	inline static constexpr unsigned int MatchThreeV2ChangePropContainerVisible_TypeDefinitionIndex = 9928;
