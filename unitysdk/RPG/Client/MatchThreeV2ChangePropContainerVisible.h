...
#define RPG_CLIENT_MATCHTHREEV2CHANGEPROPCONTAINERVISIBLE_METHOD_3_8D9E9D929C3EA876_OFFSET UNITYSDK_OFFSET(0x1D3124C0)
#define RPG_CLIENT_MATCHTHREEV2CHANGEPROPCONTAINERVISIBLE_METHOD_3_F3278A475339E135_OFFSET UNITYSDK_OFFSET(0x1D312500)
#define RPG_CLIENT_MATCHTHREEV2CHANGEPROPCONTAINERVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3124F0)

namespace RPG::Client
{
	inline static constexpr unsigned int MatchThreeV2ChangePropContainerVisible_TypeDefinitionIndex = 10242;
