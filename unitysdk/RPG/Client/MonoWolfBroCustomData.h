...
#define RPG_CLIENT_MONOWOLFBROCUSTOMDATA_GET_GUNPLAYPUZZLEBOARD_OFFSET UNITYSDK_OFFSET(0x1A368220)
#define RPG_CLIENT_MONOWOLFBROCUSTOMDATA_GET_ISBULLETCNTVALID_OFFSET UNITYSDK_OFFSET(0x1A3681C0)
#define RPG_CLIENT_MONOWOLFBROCUSTOMDATA_SET_GUNPLAYPUZZLEBOARD_OFFSET UNITYSDK_OFFSET(0x1A368230)
#define RPG_CLIENT_MONOWOLFBROCUSTOMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A368240)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoWolfBroCustomData_TypeDefinitionIndex = 65582;
