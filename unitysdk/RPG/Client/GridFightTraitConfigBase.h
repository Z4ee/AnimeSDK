...
#define RPG_CLIENT_GRIDFIGHTTRAITCONFIGBASE_CONTAINSEFFECTTYPE_OFFSET UNITYSDK_OFFSET(0x1BB04BE0)
#define RPG_CLIENT_GRIDFIGHTTRAITCONFIGBASE_GETACTIVATEDLAYER_OFFSET UNITYSDK_OFFSET(0x1BB046A0)
#define RPG_CLIENT_GRIDFIGHTTRAITCONFIGBASE_GETACTIVETEDLAYERCONFIG_OFFSET UNITYSDK_OFFSET(0x1BAF88D0)
#define RPG_CLIENT_GRIDFIGHTTRAITCONFIGBASE_GETLAYERCONFIG_OFFSET UNITYSDK_OFFSET(0x1BB04400)
#define RPG_CLIENT_GRIDFIGHTTRAITCONFIGBASE_GETLAYERS_OFFSET UNITYSDK_OFFSET(0x1BB044F0)
#define RPG_CLIENT_GRIDFIGHTTRAITCONFIGBASE_GETTRAITBACKREMARKLINECONFIGS_OFFSET UNITYSDK_OFFSET(0x1BB04740)
#define RPG_CLIENT_GRIDFIGHTTRAITCONFIGBASE_GETTRAITFRONTREMARKLINECONFIGS_OFFSET UNITYSDK_OFFSET(0x1BB04B90)
#define RPG_CLIENT_GRIDFIGHTTRAITCONFIGBASE_GETTRAITREMARKLINECONFIGROWS_OFFSET UNITYSDK_OFFSET(0x1BB04E70)
#define RPG_CLIENT_GRIDFIGHTTRAITCONFIGBASE_GET_LAYERCONFIGS_OFFSET UNITYSDK_OFFSET(0x1BB04120)
#define RPG_CLIENT_GRIDFIGHTTRAITCONFIGBASE_GET_VIDEODESC_OFFSET UNITYSDK_OFFSET(0x1BB052A0)
#define RPG_CLIENT_GRIDFIGHTTRAITCONFIGBASE_GET_VIDEOID_OFFSET UNITYSDK_OFFSET(0x1BB05170)
#define RPG_CLIENT_GRIDFIGHTTRAITCONFIGBASE_GET__VIDEOROW_OFFSET UNITYSDK_OFFSET(0x1BB051D0)
#define RPG_CLIENT_GRIDFIGHTTRAITCONFIGBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB039B0)
#define RPG_CLIENT_GRIDFIGHTTRAITCONFIGBASE__GETTRAITREMARKLINECONFIGS_OFFSET UNITYSDK_OFFSET(0x1BB04790)
#define RPG_CLIENT_GRIDFIGHTTRAITCONFIGBASE__INITSHAREDLAYERS_OFFSET UNITYSDK_OFFSET(0x1BB04160)
