...
#define RPG_CLIENT_MONORANDOMOFFSETSCALE_AWAKE_OFFSET UNITYSDK_OFFSET(0x9D2A300)
#define RPG_CLIENT_MONORANDOMOFFSETSCALE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9D2A490)
#define RPG_CLIENT_MONORANDOMOFFSETSCALE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x9D2A370)
#define RPG_CLIENT_MONORANDOMOFFSETSCALE_UPDATE_OFFSET UNITYSDK_OFFSET(0x9D2A440)
#define RPG_CLIENT_MONORANDOMOFFSETSCALE__CTOR_OFFSET UNITYSDK_OFFSET(0x9D2A520)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoRandomOffsetScale_TypeDefinitionIndex = 56037;
