...
#define RPG_CLIENT_CHECKITEMCLOSEQUEST_FILLNOTIFYTYPESTO_OFFSET UNITYSDK_OFFSET(0x19634660)
#define RPG_CLIENT_CHECKITEMCLOSEQUEST_TOSTRING_OFFSET UNITYSDK_OFFSET(0x196347A0)
#define RPG_CLIENT_CHECKITEMCLOSEQUEST__CTOR_OFFSET UNITYSDK_OFFSET(0x19634640)
#define RPG_CLIENT_CHECKITEMCLOSEQUEST__DOCHECKIMPL_OFFSET UNITYSDK_OFFSET(0x196346F0)

namespace RPG::Client
{
	inline static constexpr unsigned int CheckItemCloseQuest_TypeDefinitionIndex = 57214;
