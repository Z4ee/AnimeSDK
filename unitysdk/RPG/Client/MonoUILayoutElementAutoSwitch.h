...
#define RPG_CLIENT_MONOUILAYOUTELEMENTAUTOSWITCH_AWAKE_OFFSET UNITYSDK_OFFSET(0xD87BCC0)
#define RPG_CLIENT_MONOUILAYOUTELEMENTAUTOSWITCH_METHOD_6_08A80BC6503C83C1_OFFSET UNITYSDK_OFFSET(0xD87BD50)
#define RPG_CLIENT_MONOUILAYOUTELEMENTAUTOSWITCH__CTOR_OFFSET UNITYSDK_OFFSET(0xD87C270)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoUILayoutElementAutoSwitch_TypeDefinitionIndex = 72540;
