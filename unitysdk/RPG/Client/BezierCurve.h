...
#define RPG_CLIENT_BEZIERCURVE_ADDPOINTAT_OFFSET UNITYSDK_OFFSET(0x16598F60)
#define RPG_CLIENT_BEZIERCURVE_ADDPOINT_OFFSET UNITYSDK_OFFSET(0x16598E60)
#define RPG_CLIENT_BEZIERCURVE_APPROXIMATELENGTH_OFFSET UNITYSDK_OFFSET(0x1659CDE0)
#define RPG_CLIENT_BEZIERCURVE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1659D380)
#define RPG_CLIENT_BEZIERCURVE_CREATECURVE_OFFSET UNITYSDK_OFFSET(0x1659CF70)
#define RPG_CLIENT_BEZIERCURVE_DRAWCURVE_OFFSET UNITYSDK_OFFSET(0x1659CBC0)
#define RPG_CLIENT_BEZIERCURVE_GETANCHORPOINTREF_OFFSET UNITYSDK_OFFSET(0x16599330)
#define RPG_CLIENT_BEZIERCURVE_GETANCHORPOINTSREF_OFFSET UNITYSDK_OFFSET(0x16599320)
#define RPG_CLIENT_BEZIERCURVE_GETANCHORPOINTS_OFFSET UNITYSDK_OFFSET(0x16599220)
#define RPG_CLIENT_BEZIERCURVE_GETDERIVATIVEATDISTANCE_OFFSET UNITYSDK_OFFSET(0x1659B690)
#define RPG_CLIENT_BEZIERCURVE_GETDERIVATIVEAT_OFFSET UNITYSDK_OFFSET(0x1659A860)
#define RPG_CLIENT_BEZIERCURVE_GETDERIVATIVE_OFFSET UNITYSDK_OFFSET(0x1659B010)
#define RPG_CLIENT_BEZIERCURVE_GETPOINTANDDERIVATIVEATDISTANCE_OFFSET UNITYSDK_OFFSET(0x1659C640)
#define RPG_CLIENT_BEZIERCURVE_GETPOINTANDDERIVATIVEAT_OFFSET UNITYSDK_OFFSET(0x1659BA80)
#define RPG_CLIENT_BEZIERCURVE_GETPOINTATDISTANCE_OFFSET UNITYSDK_OFFSET(0x1659A410)
#define RPG_CLIENT_BEZIERCURVE_GETPOINTAT_OFFSET UNITYSDK_OFFSET(0x16599430)
#define RPG_CLIENT_BEZIERCURVE_GETPOINTINDEX_OFFSET UNITYSDK_OFFSET(0x16599370)
#define RPG_CLIENT_BEZIERCURVE_GETPOINT_OFFSET UNITYSDK_OFFSET(0x16599D10)
#define RPG_CLIENT_BEZIERCURVE_GET_BAKECURVERESOLUTION_OFFSET UNITYSDK_OFFSET(0x16599870)
#define RPG_CLIENT_BEZIERCURVE_GET_CLOSE_OFFSET UNITYSDK_OFFSET(0x1659D760)
#define RPG_CLIENT_BEZIERCURVE_GET_DIRTY_OFFSET UNITYSDK_OFFSET(0x1659D9C0)
#define RPG_CLIENT_BEZIERCURVE_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1659D770)
#define RPG_CLIENT_BEZIERCURVE_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x16599CE0)
#define RPG_CLIENT_BEZIERCURVE_GET_POINTCOUNT_OFFSET UNITYSDK_OFFSET(0x165990B0)
#define RPG_CLIENT_BEZIERCURVE_GET_SEGMENTLENGTHS_OFFSET UNITYSDK_OFFSET(0x16599CB0)
#define RPG_CLIENT_BEZIERCURVE_METHOD_5_048F2526C99D6AFF_OFFSET UNITYSDK_OFFSET(0x1659C0A0)
#define RPG_CLIENT_BEZIERCURVE_METHOD_5_394F35BBA0EE596A_OFFSET UNITYSDK_OFFSET(0x1659D7B0)
#define RPG_CLIENT_BEZIERCURVE_METHOD_5_D37001935D58FD7A_1_OFFSET UNITYSDK_OFFSET(0x1659AC30)
#define RPG_CLIENT_BEZIERCURVE_METHOD_5_D37001935D58FD7A_OFFSET UNITYSDK_OFFSET(0x165998A0)
#define RPG_CLIENT_BEZIERCURVE_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x1659D390)
#define RPG_CLIENT_BEZIERCURVE_REMOVEPOINT_OFFSET UNITYSDK_OFFSET(0x16599120)
#define RPG_CLIENT_BEZIERCURVE_SETDIRTY_OFFSET UNITYSDK_OFFSET(0x1659CBB0)
#define RPG_CLIENT_BEZIERCURVE_SET_BAKECURVERESOLUTION_OFFSET UNITYSDK_OFFSET(0x1659D9E0)
#define RPG_CLIENT_BEZIERCURVE_SET_CLOSE_OFFSET UNITYSDK_OFFSET(0x1659D360)
#define RPG_CLIENT_BEZIERCURVE_SET_DIRTY_OFFSET UNITYSDK_OFFSET(0x1659D9D0)
#define RPG_CLIENT_BEZIERCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1659DA10)

namespace RPG::Client
{
	inline static constexpr unsigned int BezierCurve_TypeDefinitionIndex = 28254;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Boolean))((::PBYTE)hIl2Cpp + RPG_CLIENT_BEZIERCURVE_SET_DIRTY_OFFSET))(this, value);
		}
