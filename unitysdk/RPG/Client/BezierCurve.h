...
#define RPG_CLIENT_BEZIERCURVE_ADDPOINTAT_OFFSET UNITYSDK_OFFSET(0x17BC3C90)
#define RPG_CLIENT_BEZIERCURVE_ADDPOINT_OFFSET UNITYSDK_OFFSET(0x17BC3B90)
#define RPG_CLIENT_BEZIERCURVE_APPROXIMATELENGTH_OFFSET UNITYSDK_OFFSET(0x17BC7B10)
#define RPG_CLIENT_BEZIERCURVE_AWAKE_OFFSET UNITYSDK_OFFSET(0x17BC80B0)
#define RPG_CLIENT_BEZIERCURVE_CREATECURVE_OFFSET UNITYSDK_OFFSET(0x17BC7CA0)
#define RPG_CLIENT_BEZIERCURVE_DRAWCURVE_OFFSET UNITYSDK_OFFSET(0x17BC78F0)
#define RPG_CLIENT_BEZIERCURVE_GETANCHORPOINTREF_OFFSET UNITYSDK_OFFSET(0x17BC4060)
#define RPG_CLIENT_BEZIERCURVE_GETANCHORPOINTSREF_OFFSET UNITYSDK_OFFSET(0x17BC4050)
#define RPG_CLIENT_BEZIERCURVE_GETANCHORPOINTS_OFFSET UNITYSDK_OFFSET(0x17BC3F50)
#define RPG_CLIENT_BEZIERCURVE_GETDERIVATIVEATDISTANCE_OFFSET UNITYSDK_OFFSET(0x17BC63C0)
#define RPG_CLIENT_BEZIERCURVE_GETDERIVATIVEAT_OFFSET UNITYSDK_OFFSET(0x17BC5590)
#define RPG_CLIENT_BEZIERCURVE_GETDERIVATIVE_OFFSET UNITYSDK_OFFSET(0x17BC5D40)
#define RPG_CLIENT_BEZIERCURVE_GETPOINTANDDERIVATIVEATDISTANCE_OFFSET UNITYSDK_OFFSET(0x17BC7370)
#define RPG_CLIENT_BEZIERCURVE_GETPOINTANDDERIVATIVEAT_OFFSET UNITYSDK_OFFSET(0x17BC67B0)
#define RPG_CLIENT_BEZIERCURVE_GETPOINTATDISTANCE_OFFSET UNITYSDK_OFFSET(0x17BC5140)
#define RPG_CLIENT_BEZIERCURVE_GETPOINTAT_OFFSET UNITYSDK_OFFSET(0x17BC4160)
#define RPG_CLIENT_BEZIERCURVE_GETPOINTINDEX_OFFSET UNITYSDK_OFFSET(0x17BC40A0)
#define RPG_CLIENT_BEZIERCURVE_GETPOINT_OFFSET UNITYSDK_OFFSET(0x17BC4A40)
#define RPG_CLIENT_BEZIERCURVE_GET_BAKECURVERESOLUTION_OFFSET UNITYSDK_OFFSET(0x17BC45A0)
#define RPG_CLIENT_BEZIERCURVE_GET_CLOSE_OFFSET UNITYSDK_OFFSET(0x17BC8490)
#define RPG_CLIENT_BEZIERCURVE_GET_DIRTY_OFFSET UNITYSDK_OFFSET(0x17BC86F0)
#define RPG_CLIENT_BEZIERCURVE_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x17BC84A0)
#define RPG_CLIENT_BEZIERCURVE_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x17BC4A10)
#define RPG_CLIENT_BEZIERCURVE_GET_POINTCOUNT_OFFSET UNITYSDK_OFFSET(0x17BC3DE0)
#define RPG_CLIENT_BEZIERCURVE_GET_SEGMENTLENGTHS_OFFSET UNITYSDK_OFFSET(0x17BC49E0)
#define RPG_CLIENT_BEZIERCURVE_METHOD_5_048F2526C99D6AFF_OFFSET UNITYSDK_OFFSET(0x17BC6DD0)
#define RPG_CLIENT_BEZIERCURVE_METHOD_5_394F35BBA0EE596A_OFFSET UNITYSDK_OFFSET(0x17BC84E0)
#define RPG_CLIENT_BEZIERCURVE_METHOD_5_D37001935D58FD7A_1_OFFSET UNITYSDK_OFFSET(0x17BC5960)
#define RPG_CLIENT_BEZIERCURVE_METHOD_5_D37001935D58FD7A_OFFSET UNITYSDK_OFFSET(0x17BC45D0)
#define RPG_CLIENT_BEZIERCURVE_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x17BC80C0)
#define RPG_CLIENT_BEZIERCURVE_REMOVEPOINT_OFFSET UNITYSDK_OFFSET(0x17BC3E50)
#define RPG_CLIENT_BEZIERCURVE_SETDIRTY_OFFSET UNITYSDK_OFFSET(0x17BC78E0)
#define RPG_CLIENT_BEZIERCURVE_SET_BAKECURVERESOLUTION_OFFSET UNITYSDK_OFFSET(0x17BC8710)
#define RPG_CLIENT_BEZIERCURVE_SET_CLOSE_OFFSET UNITYSDK_OFFSET(0x17BC8090)
#define RPG_CLIENT_BEZIERCURVE_SET_DIRTY_OFFSET UNITYSDK_OFFSET(0x17BC8700)
#define RPG_CLIENT_BEZIERCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x17BC8740)

namespace RPG::Client
{
	inline static constexpr unsigned int BezierCurve_TypeDefinitionIndex = 33878;
