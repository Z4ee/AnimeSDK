...
#define RPG_CLIENT_SCREENCLICKEFFECT_AWAKE_OFFSET UNITYSDK_OFFSET(0xC8AA8F0)
#define RPG_CLIENT_SCREENCLICKEFFECT_GET_SHOULDHIDE_OFFSET UNITYSDK_OFFSET(0xC8AC130)
#define RPG_CLIENT_SCREENCLICKEFFECT_METHOD_5_09ACA71C17EF0726_1_OFFSET UNITYSDK_OFFSET(0xC8ABCA0)
#define RPG_CLIENT_SCREENCLICKEFFECT_METHOD_5_09ACA71C17EF0726_OFFSET UNITYSDK_OFFSET(0xC8AB880)
#define RPG_CLIENT_SCREENCLICKEFFECT_METHOD_5_235779E3A1B24A75_OFFSET UNITYSDK_OFFSET(0xC8ABCF0)
#define RPG_CLIENT_SCREENCLICKEFFECT_METHOD_5_494458CA7765DC42_OFFSET UNITYSDK_OFFSET(0xC8AC030)
#define RPG_CLIENT_SCREENCLICKEFFECT_METHOD_5_4B299A7B44D66F76_OFFSET UNITYSDK_OFFSET(0xC8ABEA0)
#define RPG_CLIENT_SCREENCLICKEFFECT_METHOD_5_4EA6B1791DACA9CC_1_OFFSET UNITYSDK_OFFSET(0xC8AB290)
#define RPG_CLIENT_SCREENCLICKEFFECT_METHOD_5_4EA6B1791DACA9CC_OFFSET UNITYSDK_OFFSET(0xC8AB080)
#define RPG_CLIENT_SCREENCLICKEFFECT_METHOD_5_50AE2676D9583449_OFFSET UNITYSDK_OFFSET(0xC8ABD80)
#define RPG_CLIENT_SCREENCLICKEFFECT_METHOD_5_AAD21DE195D05736_1_OFFSET UNITYSDK_OFFSET(0xC8AACA0)
#define RPG_CLIENT_SCREENCLICKEFFECT_METHOD_5_AAD21DE195D05736_OFFSET UNITYSDK_OFFSET(0xC8AB4A0)
#define RPG_CLIENT_SCREENCLICKEFFECT_METHOD_5_B7BFE5D35A542E8B_OFFSET UNITYSDK_OFFSET(0xC8ABFB0)
#define RPG_CLIENT_SCREENCLICKEFFECT_METHOD_5_DF028CAA51A328F2_OFFSET UNITYSDK_OFFSET(0xC8AC0B0)
#define RPG_CLIENT_SCREENCLICKEFFECT_METHOD_5_FC4FFB09CD8F8D39_OFFSET UNITYSDK_OFFSET(0xC8AB8D0)
#define RPG_CLIENT_SCREENCLICKEFFECT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xC8AAAF0)
#define RPG_CLIENT_SCREENCLICKEFFECT_ONENABLE_OFFSET UNITYSDK_OFFSET(0xC8AAAA0)
#define RPG_CLIENT_SCREENCLICKEFFECT_SET_SHOULDHIDE_OFFSET UNITYSDK_OFFSET(0xC8AC140)
#define RPG_CLIENT_SCREENCLICKEFFECT__CCTOR_OFFSET UNITYSDK_OFFSET(0xC8AC160)
#define RPG_CLIENT_SCREENCLICKEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xC8AC150)

namespace RPG::Client
{
	inline static constexpr unsigned int ScreenClickEffect_TypeDefinitionIndex = 64538;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(ScreenClickEffect_TypeDefinitionIndex)->GetStaticField(0x46180);
		}
