...
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_AETHERDIVIDE_D__28_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xB414070)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_AETHERDIVIDE_D__28_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xB4140B0)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_AETHERDIVIDE_D__28_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xB414110)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_AETHERDIVIDE_D__28_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xB4140C0)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_AETHERDIVIDE_D__28_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB414060)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_AETHERDIVIDE_D__28__CTOR_OFFSET UNITYSDK_OFFSET(0xB411200)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleResultProcess___RP_AetherDivide_d__28_TypeDefinitionIndex = 57023;
