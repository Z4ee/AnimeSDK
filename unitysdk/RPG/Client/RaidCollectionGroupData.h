...
#define RPG_CLIENT_RAIDCOLLECTIONGROUPDATA_GETALLCOLLECTIONDATAS_OFFSET UNITYSDK_OFFSET(0x167B9830)
#define RPG_CLIENT_RAIDCOLLECTIONGROUPDATA_GETCOLLECTIONDATA_OFFSET UNITYSDK_OFFSET(0x167B97B0)
#define RPG_CLIENT_RAIDCOLLECTIONGROUPDATA_GETCOLLECTIONINDEX_OFFSET UNITYSDK_OFFSET(0x167B9AB0)
#define RPG_CLIENT_RAIDCOLLECTIONGROUPDATA_GETFINISHEDCOLLECTIONCOUNT_OFFSET UNITYSDK_OFFSET(0x167B9CB0)
#define RPG_CLIENT_RAIDCOLLECTIONGROUPDATA_GET_ALLCOLLECTIONIDS_OFFSET UNITYSDK_OFFSET(0x167B9650)
#define RPG_CLIENT_RAIDCOLLECTIONGROUPDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0x167B9F70)
#define RPG_CLIENT_RAIDCOLLECTIONGROUPDATA_GET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0x167BA2C0)
#define RPG_CLIENT_RAIDCOLLECTIONGROUPDATA_GET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0x167BA020)
#define RPG_CLIENT_RAIDCOLLECTIONGROUPDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0x167B9FB0)
#define RPG_CLIENT_RAIDCOLLECTIONGROUPDATA_GET_ROW_OFFSET UNITYSDK_OFFSET(0x167B9F90)
#define RPG_CLIENT_RAIDCOLLECTIONGROUPDATA_SET_ID_OFFSET UNITYSDK_OFFSET(0x167B9F80)
#define RPG_CLIENT_RAIDCOLLECTIONGROUPDATA_SET_ROW_OFFSET UNITYSDK_OFFSET(0x167B9FA0)
#define RPG_CLIENT_RAIDCOLLECTIONGROUPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x167B9460)
#define RPG_CLIENT_RAIDCOLLECTIONGROUPDATA__SAFEGETCOLLECTIONDATA_OFFSET UNITYSDK_OFFSET(0x167B96F0)

namespace RPG::Client
{
	inline static constexpr unsigned int RaidCollectionGroupData_TypeDefinitionIndex = 63786;

	class RaidCollectionGroupData : public ::System::Object
	{
	public:
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::Client::RaidCollectionData*>* _CollectionDatas; // 0x10
		::RPG::GameCore::ActivityRaidCollectionGroupRow* _Row_k__BackingField; // 0x18
