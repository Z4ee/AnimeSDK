...
#define RPG_CLIENT_EFFECT_PATHDEFORMBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0xCE0C310)
#define RPG_CLIENT_EFFECT_PATHDEFORMBEHAVIOR_METHOD_3_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0xCE0BAC0)
#define RPG_CLIENT_EFFECT_PATHDEFORMBEHAVIOR_METHOD_3_3CCA0B8A31B650A8_OFFSET UNITYSDK_OFFSET(0xCE0C350)
#define RPG_CLIENT_EFFECT_PATHDEFORMBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0xCE0BC70)
#define RPG_CLIENT_EFFECT_PATHDEFORMBEHAVIOR_METHOD_3_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0xCE0BCD0)
#define RPG_CLIENT_EFFECT_PATHDEFORMBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xCE0BC10)
#define RPG_CLIENT_EFFECT_PATHDEFORMBEHAVIOR_METHOD_3_8F7825DAFFB9B517_OFFSET UNITYSDK_OFFSET(0xCE0B610)
#define RPG_CLIENT_EFFECT_PATHDEFORMBEHAVIOR_METHOD_3_9681042564541CD6_1_OFFSET UNITYSDK_OFFSET(0xCE0BB90)
#define RPG_CLIENT_EFFECT_PATHDEFORMBEHAVIOR_METHOD_3_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xCE0B510)
#define RPG_CLIENT_EFFECT_PATHDEFORMBEHAVIOR_METHOD_3_F0D9B6AAFF504D87_OFFSET UNITYSDK_OFFSET(0xCE0B5A0)
#define RPG_CLIENT_EFFECT_PATHDEFORMBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0xCE0BD30)
#define RPG_CLIENT_EFFECT_PATHDEFORMBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0xCE0D270)
