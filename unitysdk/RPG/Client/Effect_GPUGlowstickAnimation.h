...
#define RPG_CLIENT_EFFECT_GPUGLOWSTICKANIMATION_LATETICK_OFFSET UNITYSDK_OFFSET(0xB852FC0)
#define RPG_CLIENT_EFFECT_GPUGLOWSTICKANIMATION_METHOD_5_04F02FC65FAA2E0C_OFFSET UNITYSDK_OFFSET(0xB8530B0)
#define RPG_CLIENT_EFFECT_GPUGLOWSTICKANIMATION_METHOD_5_B29205EE7F7B640C_OFFSET UNITYSDK_OFFSET(0xB8539F0)
#define RPG_CLIENT_EFFECT_GPUGLOWSTICKANIMATION_METHOD_5_C1E0405EEC95DC65_OFFSET UNITYSDK_OFFSET(0xB853020)
#define RPG_CLIENT_EFFECT_GPUGLOWSTICKANIMATION_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xB852F30)
#define RPG_CLIENT_EFFECT_GPUGLOWSTICKANIMATION_ONENABLE_OFFSET UNITYSDK_OFFSET(0xB852EA0)
#define RPG_CLIENT_EFFECT_GPUGLOWSTICKANIMATION_ONINVISIBLE_OFFSET UNITYSDK_OFFSET(0xB852E60)
#define RPG_CLIENT_EFFECT_GPUGLOWSTICKANIMATION_ONVISIBLE_OFFSET UNITYSDK_OFFSET(0xB852E20)
#define RPG_CLIENT_EFFECT_GPUGLOWSTICKANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0xB853C90)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_GPUGlowstickAnimation_TypeDefinitionIndex = 65907;
