...
#define RPG_CLIENT_EFFECT_GPUGLOWSTICKANIMATION_LATETICK_OFFSET UNITYSDK_OFFSET(0x954CC50)
#define RPG_CLIENT_EFFECT_GPUGLOWSTICKANIMATION_METHOD_5_7B411317D337F87A_OFFSET UNITYSDK_OFFSET(0x954D4E0)
#define RPG_CLIENT_EFFECT_GPUGLOWSTICKANIMATION_METHOD_5_D308836DB54415C3_OFFSET UNITYSDK_OFFSET(0x954CD40)
#define RPG_CLIENT_EFFECT_GPUGLOWSTICKANIMATION_METHOD_5_F96B1C7229DF29DF_OFFSET UNITYSDK_OFFSET(0x954CCB0)
#define RPG_CLIENT_EFFECT_GPUGLOWSTICKANIMATION_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x954CBC0)
#define RPG_CLIENT_EFFECT_GPUGLOWSTICKANIMATION_ONENABLE_OFFSET UNITYSDK_OFFSET(0x954CB30)
#define RPG_CLIENT_EFFECT_GPUGLOWSTICKANIMATION_ONINVISIBLE_OFFSET UNITYSDK_OFFSET(0x954CAF0)
#define RPG_CLIENT_EFFECT_GPUGLOWSTICKANIMATION_ONVISIBLE_OFFSET UNITYSDK_OFFSET(0x954CAB0)
#define RPG_CLIENT_EFFECT_GPUGLOWSTICKANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x954D780)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_GPUGlowstickAnimation_TypeDefinitionIndex = 57717;
