...
#define RPG_CLIENT_EFFECT_GPUGLOWSTICKANIMATION_LATETICK_OFFSET UNITYSDK_OFFSET(0xA1CF820)
#define RPG_CLIENT_EFFECT_GPUGLOWSTICKANIMATION_METHOD_5_7B411317D337F87A_OFFSET UNITYSDK_OFFSET(0xA1CFFF0)
#define RPG_CLIENT_EFFECT_GPUGLOWSTICKANIMATION_METHOD_5_D308836DB54415C3_OFFSET UNITYSDK_OFFSET(0xA1CF910)
#define RPG_CLIENT_EFFECT_GPUGLOWSTICKANIMATION_METHOD_5_F96B1C7229DF29DF_OFFSET UNITYSDK_OFFSET(0xA1CF880)
#define RPG_CLIENT_EFFECT_GPUGLOWSTICKANIMATION_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xA1CF790)
#define RPG_CLIENT_EFFECT_GPUGLOWSTICKANIMATION_ONENABLE_OFFSET UNITYSDK_OFFSET(0xA1CF700)
#define RPG_CLIENT_EFFECT_GPUGLOWSTICKANIMATION_ONINVISIBLE_OFFSET UNITYSDK_OFFSET(0xA1CF6C0)
#define RPG_CLIENT_EFFECT_GPUGLOWSTICKANIMATION_ONVISIBLE_OFFSET UNITYSDK_OFFSET(0xA1CF680)
#define RPG_CLIENT_EFFECT_GPUGLOWSTICKANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0xA1D0290)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_GPUGlowstickAnimation_TypeDefinitionIndex = 64981;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_EFFECT_GPUGLOWSTICKANIMATION_METHOD_5_F96B1C7229DF29DF_OFFSET))(this);
		}

		::System::Void Method_5_7B411317D337F87A()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_EFFECT_GPUGLOWSTICKANIMATION_METHOD_5_7B411317D337F87A_OFFSET))(this);
		}

		::System::Void Method_5_D308836DB54415C3()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_EFFECT_GPUGLOWSTICKANIMATION_METHOD_5_D308836DB54415C3_OFFSET))(this);
		}
	};
}
