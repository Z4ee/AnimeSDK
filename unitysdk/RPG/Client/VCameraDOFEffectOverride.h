...
#define RPG_CLIENT_VCAMERADOFEFFECTOVERRIDE_METHOD_5_19844080C13BA28F_OFFSET UNITYSDK_OFFSET(0x1C552960)
#define RPG_CLIENT_VCAMERADOFEFFECTOVERRIDE_METHOD_5_51CFFE2AF748ECD7_OFFSET UNITYSDK_OFFSET(0x1C552810)
#define RPG_CLIENT_VCAMERADOFEFFECTOVERRIDE_ONACTIVEVCAMERA_OFFSET UNITYSDK_OFFSET(0x1C553040)
#define RPG_CLIENT_VCAMERADOFEFFECTOVERRIDE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1C552740)
#define RPG_CLIENT_VCAMERADOFEFFECTOVERRIDE_ONDISACTIVEVCAMERA_OFFSET UNITYSDK_OFFSET(0x1C553090)
#define RPG_CLIENT_VCAMERADOFEFFECTOVERRIDE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1C552640)
#define RPG_CLIENT_VCAMERADOFEFFECTOVERRIDE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1C552790)
#define RPG_CLIENT_VCAMERADOFEFFECTOVERRIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5530E0)

namespace RPG::Client
{
	inline static constexpr unsigned int VCameraDOFEffectOverride_TypeDefinitionIndex = 65277;
