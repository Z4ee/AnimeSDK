...
#define RPG_CLIENT_TIMELINECONTROLGAMEMONSTERCONFIGASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x197B3120)

namespace RPG::Client
{
	inline static constexpr unsigned int TimelineControlGameMonsterConfigAsset_TypeDefinitionIndex = 60533;
