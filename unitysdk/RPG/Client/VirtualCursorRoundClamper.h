...
#define RPG_CLIENT_VIRTUALCURSORROUNDCLAMPER_CLAMP_OFFSET UNITYSDK_OFFSET(0xCC256E0)
#define RPG_CLIENT_VIRTUALCURSORROUNDCLAMPER__CTOR_OFFSET UNITYSDK_OFFSET(0xCC256D0)

namespace RPG::Client
{
	inline static constexpr unsigned int VirtualCursorRoundClamper_TypeDefinitionIndex = 68393;
