...
#define RPG_CLIENT_GRIDFIGHTFLOWDIRECTOR_PENDINGACTIONUPDATEEVENT_GET_HASFORBIDMONSTERREVEAL_OFFSET UNITYSDK_OFFSET(0x1BD43430)
#define RPG_CLIENT_GRIDFIGHTFLOWDIRECTOR_PENDINGACTIONUPDATEEVENT_GET_HASINITIALSUPPLYBONUS_OFFSET UNITYSDK_OFFSET(0x1BD43880)
#define RPG_CLIENT_GRIDFIGHTFLOWDIRECTOR_PENDINGACTIONUPDATEEVENT_GET_HASPORTALBUFFSELECTION_OFFSET UNITYSDK_OFFSET(0x1BD432B0)
#define RPG_CLIENT_GRIDFIGHTFLOWDIRECTOR_PENDINGACTIONUPDATEEVENT_GET_NEEDSHOWSTAGEHINT_OFFSET UNITYSDK_OFFSET(0x1BD43610)
#define RPG_CLIENT_GRIDFIGHTFLOWDIRECTOR_PENDINGACTIONUPDATEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD456F0)
