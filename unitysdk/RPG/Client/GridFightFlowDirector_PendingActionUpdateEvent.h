...
#define RPG_CLIENT_GRIDFIGHTFLOWDIRECTOR_PENDINGACTIONUPDATEEVENT_GET_HASFORBIDMONSTERREVEAL_OFFSET UNITYSDK_OFFSET(0x1A6A5020)
#define RPG_CLIENT_GRIDFIGHTFLOWDIRECTOR_PENDINGACTIONUPDATEEVENT_GET_HASINITIALSUPPLYBONUS_OFFSET UNITYSDK_OFFSET(0x1A6A5470)
#define RPG_CLIENT_GRIDFIGHTFLOWDIRECTOR_PENDINGACTIONUPDATEEVENT_GET_HASPORTALBUFFSELECTION_OFFSET UNITYSDK_OFFSET(0x1A6A4EA0)
#define RPG_CLIENT_GRIDFIGHTFLOWDIRECTOR_PENDINGACTIONUPDATEEVENT_GET_NEEDSHOWSTAGEHINT_OFFSET UNITYSDK_OFFSET(0x1A6A5200)
#define RPG_CLIENT_GRIDFIGHTFLOWDIRECTOR_PENDINGACTIONUPDATEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6A7330)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightFlowDirector_PendingActionUpdateEvent_TypeDefinitionIndex = 61654;
