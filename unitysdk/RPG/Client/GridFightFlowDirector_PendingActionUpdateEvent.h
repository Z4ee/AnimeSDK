...
#define RPG_CLIENT_GRIDFIGHTFLOWDIRECTOR_PENDINGACTIONUPDATEEVENT_GET_HASFORBIDMONSTERREVEAL_OFFSET UNITYSDK_OFFSET(0xA49A510)
#define RPG_CLIENT_GRIDFIGHTFLOWDIRECTOR_PENDINGACTIONUPDATEEVENT_GET_HASINITIALSUPPLYBONUS_OFFSET UNITYSDK_OFFSET(0xA49A8A0)
#define RPG_CLIENT_GRIDFIGHTFLOWDIRECTOR_PENDINGACTIONUPDATEEVENT_GET_HASPORTALBUFFSELECTION_OFFSET UNITYSDK_OFFSET(0xA49A3E0)
#define RPG_CLIENT_GRIDFIGHTFLOWDIRECTOR_PENDINGACTIONUPDATEEVENT_GET_NEEDSHOWSTAGEHINT_OFFSET UNITYSDK_OFFSET(0xA49A690)
#define RPG_CLIENT_GRIDFIGHTFLOWDIRECTOR_PENDINGACTIONUPDATEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0xA49C460)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightFlowDirector_PendingActionUpdateEvent_TypeDefinitionIndex = 59428;
