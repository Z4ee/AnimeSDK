...
#define RPG_CLIENT_ROGUEMIRACLEDROPACTION_GETROGUEACTIONID_OFFSET UNITYSDK_OFFSET(0xDEF4B30)
#define RPG_CLIENT_ROGUEMIRACLEDROPACTION_GETUIPATH_OFFSET UNITYSDK_OFFSET(0xDEF4BC0)
#define RPG_CLIENT_ROGUEMIRACLEDROPACTION_GET_HINTID_OFFSET UNITYSDK_OFFSET(0xDEF4A40)
#define RPG_CLIENT_ROGUEMIRACLEDROPACTION_GET_ROGUEACTIONID_OFFSET UNITYSDK_OFFSET(0xDEF4A00)
#define RPG_CLIENT_ROGUEMIRACLEDROPACTION_GET_SELECTMIRACLEIDS_OFFSET UNITYSDK_OFFSET(0xDEF4A20)
#define RPG_CLIENT_ROGUEMIRACLEDROPACTION_SET_HINTID_OFFSET UNITYSDK_OFFSET(0xDEF4A50)
#define RPG_CLIENT_ROGUEMIRACLEDROPACTION_SET_ROGUEACTIONID_OFFSET UNITYSDK_OFFSET(0xDEF4A10)
#define RPG_CLIENT_ROGUEMIRACLEDROPACTION_SET_SELECTMIRACLEIDS_OFFSET UNITYSDK_OFFSET(0xDEF4A30)
#define RPG_CLIENT_ROGUEMIRACLEDROPACTION_TRIGGERACTION_OFFSET UNITYSDK_OFFSET(0xDEF4B70)
#define RPG_CLIENT_ROGUEMIRACLEDROPACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xDEF4A60)
