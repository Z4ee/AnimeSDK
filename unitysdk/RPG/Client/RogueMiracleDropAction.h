...
#define RPG_CLIENT_ROGUEMIRACLEDROPACTION_GETROGUEACTIONID_OFFSET UNITYSDK_OFFSET(0x1B9E2240)
#define RPG_CLIENT_ROGUEMIRACLEDROPACTION_GETUIPATH_OFFSET UNITYSDK_OFFSET(0x1B9E22D0)
#define RPG_CLIENT_ROGUEMIRACLEDROPACTION_GET_HINTID_OFFSET UNITYSDK_OFFSET(0x1B9E2150)
#define RPG_CLIENT_ROGUEMIRACLEDROPACTION_GET_ROGUEACTIONID_OFFSET UNITYSDK_OFFSET(0x1B9E2110)
#define RPG_CLIENT_ROGUEMIRACLEDROPACTION_GET_SELECTMIRACLEIDS_OFFSET UNITYSDK_OFFSET(0x1B9E2130)
#define RPG_CLIENT_ROGUEMIRACLEDROPACTION_SET_HINTID_OFFSET UNITYSDK_OFFSET(0x1B9E2160)
#define RPG_CLIENT_ROGUEMIRACLEDROPACTION_SET_ROGUEACTIONID_OFFSET UNITYSDK_OFFSET(0x1B9E2120)
#define RPG_CLIENT_ROGUEMIRACLEDROPACTION_SET_SELECTMIRACLEIDS_OFFSET UNITYSDK_OFFSET(0x1B9E2140)
#define RPG_CLIENT_ROGUEMIRACLEDROPACTION_TRIGGERACTION_OFFSET UNITYSDK_OFFSET(0x1B9E2280)
#define RPG_CLIENT_ROGUEMIRACLEDROPACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9E2170)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueMiracleDropAction_TypeDefinitionIndex = 67021;
	...
	public:
		...
		::System::Void _ctor(::System::UInt32 a1, ::Class_1_45BB92167AED63A0_81* a2)
		{
			return ((::System::Void(*)(::PVOID, ::System::UInt32, ::Class_1_45BB92167AED63A0_81*))((::PBYTE)hIl2Cpp + RPG_CLIENT_ROGUEMIRACLEDROPACTION__CTOR_OFFSET))(this, a1, a2);
		}
