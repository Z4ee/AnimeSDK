...
#define RPG_CLIENT_ACTIVITYSTRONGCHALLENGEMODULE___C__DISPLAYCLASS8_0__CTOR_OFFSET UNITYSDK_OFFSET(0xB1FDC50)
#define RPG_CLIENT_ACTIVITYSTRONGCHALLENGEMODULE___C__DISPLAYCLASS8_0__RETURNTOMAZE_B__0_OFFSET UNITYSDK_OFFSET(0xB200170)
#define RPG_CLIENT_ACTIVITYSTRONGCHALLENGEMODULE___C__DISPLAYCLASS8_0__RETURNTOMAZE_B__1_OFFSET UNITYSDK_OFFSET(0xB200290)

namespace RPG::Client
{
	inline static constexpr unsigned int ActivityStrongChallengeModule___c__DisplayClass8_0_TypeDefinitionIndex = 57897;
