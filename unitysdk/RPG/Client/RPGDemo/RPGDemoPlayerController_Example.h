...
#define RPG_CLIENT_RPGDEMO_RPGDEMOPLAYERCONTROLLER_EXAMPLE_UPDATE_OFFSET UNITYSDK_OFFSET(0x16795380)
#define RPG_CLIENT_RPGDEMO_RPGDEMOPLAYERCONTROLLER_EXAMPLE__CTOR_OFFSET UNITYSDK_OFFSET(0x167954D0)

namespace RPG::Client::RPGDemo
{
	inline static constexpr unsigned int RPGDemoPlayerController_Example_TypeDefinitionIndex = 72097;
