...
#define RPG_CLIENT_RPGDEMO_RPGDEMOPLAYERCONTROLLER_EXAMPLE_UPDATE_OFFSET UNITYSDK_OFFSET(0xA255040)
#define RPG_CLIENT_RPGDEMO_RPGDEMOPLAYERCONTROLLER_EXAMPLE__CTOR_OFFSET UNITYSDK_OFFSET(0xA255170)

namespace RPG::Client::RPGDemo
{
	inline static constexpr unsigned int RPGDemoPlayerController_Example_TypeDefinitionIndex = 61862;
