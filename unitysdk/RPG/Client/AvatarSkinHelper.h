...
#define RPG_CLIENT_AVATARSKINHELPER_ADDAVATARSKINDATACACHE_OFFSET UNITYSDK_OFFSET(0xB395570)
#define RPG_CLIENT_AVATARSKINHELPER_CHECKSKINISNEW_OFFSET UNITYSDK_OFFSET(0xB3960E0)
#define RPG_CLIENT_AVATARSKINHELPER_CHECKSKINISOWNED_OFFSET UNITYSDK_OFFSET(0xB395F40)
#define RPG_CLIENT_AVATARSKINHELPER_FILLNEWSKINIDSTO_OFFSET UNITYSDK_OFFSET(0xB396430)
#define RPG_CLIENT_AVATARSKINHELPER_GETORIGINSKIN_OFFSET UNITYSDK_OFFSET(0xB395D20)
#define RPG_CLIENT_AVATARSKINHELPER_GETOWNERAVATARPATHNAME_OFFSET UNITYSDK_OFFSET(0xB395D70)
#define RPG_CLIENT_AVATARSKINHELPER_GETSKINBYSKINID_OFFSET UNITYSDK_OFFSET(0xB395AE0)
#define RPG_CLIENT_AVATARSKINHELPER_GETSKIN_OFFSET UNITYSDK_OFFSET(0xB395C30)
#define RPG_CLIENT_AVATARSKINHELPER_MARKSKINHASSEEN_OFFSET UNITYSDK_OFFSET(0xB396270)
#define RPG_CLIENT_AVATARSKINHELPER_TRYGETAVATARSKINDATACACHE_OFFSET UNITYSDK_OFFSET(0xB395440)

namespace RPG::Client
{
	inline static constexpr unsigned int AvatarSkinHelper_TypeDefinitionIndex = 58607;
	...
	public:
		...
		static ::System::Boolean TryGetAvatarSkinDataCache(::Struct_2_137AB23E3A00ECA1& a1, ::RPG::Client::IAvatarSkinData*& a2)
		{
			return ((::System::Boolean(*)(::Struct_2_137AB23E3A00ECA1&, ::RPG::Client::IAvatarSkinData*&))((::PBYTE)hIl2Cpp + RPG_CLIENT_AVATARSKINHELPER_TRYGETAVATARSKINDATACACHE_OFFSET))(a1, a2);
		}

		static ::System::Void AddAvatarSkinDataCache(::Struct_2_137AB23E3A00ECA1& a1, ::RPG::Client::IAvatarSkinData* a2)
		{
			return ((::System::Void(*)(::Struct_2_137AB23E3A00ECA1&, ::RPG::Client::IAvatarSkinData*))((::PBYTE)hIl2Cpp + RPG_CLIENT_AVATARSKINHELPER_ADDAVATARSKINDATACACHE_OFFSET))(a1, a2);
		}
	};
}
