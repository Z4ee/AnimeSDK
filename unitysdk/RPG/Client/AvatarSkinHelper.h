...
#define RPG_CLIENT_AVATARSKINHELPER_ADDAVATARSKINDATACACHE_OFFSET UNITYSDK_OFFSET(0x186703D0)
#define RPG_CLIENT_AVATARSKINHELPER_CHECKSKINISNEW_OFFSET UNITYSDK_OFFSET(0x18670EB0)
#define RPG_CLIENT_AVATARSKINHELPER_CHECKSKINISOWNED_OFFSET UNITYSDK_OFFSET(0x18670D10)
#define RPG_CLIENT_AVATARSKINHELPER_FILLNEWSKINIDSTO_OFFSET UNITYSDK_OFFSET(0x18671200)
#define RPG_CLIENT_AVATARSKINHELPER_GETORIGINSKIN_OFFSET UNITYSDK_OFFSET(0x18670AF0)
#define RPG_CLIENT_AVATARSKINHELPER_GETOWNERAVATARPATHNAME_OFFSET UNITYSDK_OFFSET(0x18670B40)
#define RPG_CLIENT_AVATARSKINHELPER_GETSKINBYSKINID_OFFSET UNITYSDK_OFFSET(0x186708B0)
#define RPG_CLIENT_AVATARSKINHELPER_GETSKIN_OFFSET UNITYSDK_OFFSET(0x18670A00)
#define RPG_CLIENT_AVATARSKINHELPER_MARKSKINHASSEEN_OFFSET UNITYSDK_OFFSET(0x18671040)
#define RPG_CLIENT_AVATARSKINHELPER_TRYGETAVATARSKINDATACACHE_OFFSET UNITYSDK_OFFSET(0x186702A0)

namespace RPG::Client
{
	inline static constexpr unsigned int AvatarSkinHelper_TypeDefinitionIndex = 59878;
