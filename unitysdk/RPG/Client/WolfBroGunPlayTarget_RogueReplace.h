...
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_ROGUEREPLACE_AWAKE_OFFSET UNITYSDK_OFFSET(0xCC435C0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_ROGUEREPLACE_GETREPLACEPREFAB_OFFSET UNITYSDK_OFFSET(0xCC43610)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_ROGUEREPLACE_GET_ROGUEROADMAP_OFFSET UNITYSDK_OFFSET(0xCC43890)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_ROGUEREPLACE_ONREPLACEPREFABINSTANCED_OFFSET UNITYSDK_OFFSET(0xCC437A0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_ROGUEREPLACE__CTOR_OFFSET UNITYSDK_OFFSET(0xCC43910)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_ROGUEREPLACE___IFIXBASEPROXY_AWAKE_OFFSET UNITYSDK_OFFSET(0xCC43920)

namespace RPG::Client
{
	inline static constexpr unsigned int WolfBroGunPlayTarget_RogueReplace_TypeDefinitionIndex = 64293;
	...
	public:
		...
		::Class_2_B85B80C8344EC8D5* get_RogueRoadMap()
		{
			return ((::Class_2_B85B80C8344EC8D5*(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_WOLFBROGUNPLAYTARGET_ROGUEREPLACE_GET_ROGUEROADMAP_OFFSET))(this);
		}
