...
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCEPHASEFIXEDITEM_GET_DESC_OFFSET UNITYSDK_OFFSET(0x1A5A87A0)
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCEPHASEFIXEDITEM_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A5A8620)
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCEPHASEFIXEDITEM_GET__PHASEROW_OFFSET UNITYSDK_OFFSET(0x1A5A85C0)
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCEPHASEFIXEDITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5A8150)
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCEPHASEFIXEDITEM__GETPHASEFIXEDDAMAGE_OFFSET UNITYSDK_OFFSET(0x1A5A8170)

namespace RPG::Client
{
	inline static constexpr unsigned int FateGameRoundSettleDmgSourcePhaseFixedItem_TypeDefinitionIndex = 61137;

	class FateGameRoundSettleDmgSourcePhaseFixedItem : public ::System::Object
	{
	public:
		::System::UInt32 _PhaseID; // 0x10
		::System::UInt32 _PhaseIndex; // 0x14
