...
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCEPHASEFIXEDITEM_GET_DESC_OFFSET UNITYSDK_OFFSET(0x968B8B0)
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCEPHASEFIXEDITEM_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x968B730)
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCEPHASEFIXEDITEM_GET__PHASEROW_OFFSET UNITYSDK_OFFSET(0x968B6D0)
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCEPHASEFIXEDITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x968B270)
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCEPHASEFIXEDITEM__GETPHASEFIXEDDAMAGE_OFFSET UNITYSDK_OFFSET(0x968B290)

namespace RPG::Client
{
	inline static constexpr unsigned int FateGameRoundSettleDmgSourcePhaseFixedItem_TypeDefinitionIndex = 51973;
