...
#define RPG_CLIENT_SIGNALANIMATIONSTATECONNECTION_GET_NEXTSTATEINDEX_OFFSET UNITYSDK_OFFSET(0x188DBF90)
#define RPG_CLIENT_SIGNALANIMATIONSTATECONNECTION_METHOD_1_15C46FE02323990A_OFFSET UNITYSDK_OFFSET(0x19F4B830)
#define RPG_CLIENT_SIGNALANIMATIONSTATECONNECTION_METHOD_1_654FFD98884CDDEC_OFFSET UNITYSDK_OFFSET(0x188DBCA0)
#define RPG_CLIENT_SIGNALANIMATIONSTATECONNECTION_METHOD_1_8B7EF0490E4F5997_OFFSET UNITYSDK_OFFSET(0x188DBE70)
#define RPG_CLIENT_SIGNALANIMATIONSTATECONNECTION_METHOD_1_C533D7088789E5A0_OFFSET UNITYSDK_OFFSET(0x188DBDD0)
#define RPG_CLIENT_SIGNALANIMATIONSTATECONNECTION_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x188DBFB0)
#define RPG_CLIENT_SIGNALANIMATIONSTATECONNECTION_METHOD_1_E6E4670CC7E80120_OFFSET UNITYSDK_OFFSET(0x188DBB50)
#define RPG_CLIENT_SIGNALANIMATIONSTATECONNECTION_SET_NEXTSTATEINDEX_OFFSET UNITYSDK_OFFSET(0x188DBFA0)
#define RPG_CLIENT_SIGNALANIMATIONSTATECONNECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x188DC000)

namespace RPG::Client
{
	inline static constexpr unsigned int SignalAnimationStateConnection_TypeDefinitionIndex = 67775;
