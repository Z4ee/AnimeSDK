...
#define RPG_CLIENT_SIGNALANIMATIONSTATECONNECTION_GET_NEXTSTATEINDEX_OFFSET UNITYSDK_OFFSET(0xB16C6B0)
#define RPG_CLIENT_SIGNALANIMATIONSTATECONNECTION_METHOD_1_15C46FE02323990A_OFFSET UNITYSDK_OFFSET(0xB16BEE0)
#define RPG_CLIENT_SIGNALANIMATIONSTATECONNECTION_METHOD_1_654FFD98884CDDEC_OFFSET UNITYSDK_OFFSET(0xB16C270)
#define RPG_CLIENT_SIGNALANIMATIONSTATECONNECTION_METHOD_1_8B7EF0490E4F5997_OFFSET UNITYSDK_OFFSET(0xB16C4F0)
#define RPG_CLIENT_SIGNALANIMATIONSTATECONNECTION_METHOD_1_C533D7088789E5A0_OFFSET UNITYSDK_OFFSET(0xB16C610)
#define RPG_CLIENT_SIGNALANIMATIONSTATECONNECTION_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xB16C6D0)
#define RPG_CLIENT_SIGNALANIMATIONSTATECONNECTION_METHOD_1_E6E4670CC7E80120_OFFSET UNITYSDK_OFFSET(0xB16C3A0)
#define RPG_CLIENT_SIGNALANIMATIONSTATECONNECTION_SET_NEXTSTATEINDEX_OFFSET UNITYSDK_OFFSET(0xB16C6C0)
#define RPG_CLIENT_SIGNALANIMATIONSTATECONNECTION__CTOR_OFFSET UNITYSDK_OFFSET(0xB16C250)

namespace RPG::Client
{
	inline static constexpr unsigned int SignalAnimationStateConnection_TypeDefinitionIndex = 65423;
