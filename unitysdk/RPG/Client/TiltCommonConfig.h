...
#define RPG_CLIENT_TILTCOMMONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACBC8F0)

namespace RPG::Client
{
	inline static constexpr unsigned int TiltCommonConfig_TypeDefinitionIndex = 60201;
