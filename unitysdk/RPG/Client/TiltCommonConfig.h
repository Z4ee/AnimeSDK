...
#define RPG_CLIENT_TILTCOMMONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xCA30CB0)

namespace RPG::Client
{
	inline static constexpr unsigned int TiltCommonConfig_TypeDefinitionIndex = 56159;
