...
#define RPG_CLIENT_TILTCOMMONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19493FB0)

namespace RPG::Client
{
	inline static constexpr unsigned int TiltCommonConfig_TypeDefinitionIndex = 57399;
