...
#define RPG_CLIENT_FATEHANDBOOKBUFFITEM_CREATE_OFFSET UNITYSDK_OFFSET(0xB99D640)
#define RPG_CLIENT_FATEHANDBOOKBUFFITEM_GET_ALLLEVELBUFFPREVIEWDICT_OFFSET UNITYSDK_OFFSET(0xB99E050)
#define RPG_CLIENT_FATEHANDBOOKBUFFITEM_GET_BUFFDISPLAYDATA_OFFSET UNITYSDK_OFFSET(0xB99D770)
#define RPG_CLIENT_FATEHANDBOOKBUFFITEM_GET_BUFFICONPATH_OFFSET UNITYSDK_OFFSET(0xB99DC90)
#define RPG_CLIENT_FATEHANDBOOKBUFFITEM_GET_BUFFID_OFFSET UNITYSDK_OFFSET(0xB99D730)
#define RPG_CLIENT_FATEHANDBOOKBUFFITEM_GET_BUFFLEVEL_OFFSET UNITYSDK_OFFSET(0xB99D750)
#define RPG_CLIENT_FATEHANDBOOKBUFFITEM_GET_BUFFNAME_OFFSET UNITYSDK_OFFSET(0xB99DAA0)
#define RPG_CLIENT_FATEHANDBOOKBUFFITEM_GET_EXTRAEFFECTARRAY_OFFSET UNITYSDK_OFFSET(0xB99E180)
#define RPG_CLIENT_FATEHANDBOOKBUFFITEM_GET_MAINTRAITDATA_OFFSET UNITYSDK_OFFSET(0xB99D840)
#define RPG_CLIENT_FATEHANDBOOKBUFFITEM_GET_RARITY_OFFSET UNITYSDK_OFFSET(0xB99DDE0)
#define RPG_CLIENT_FATEHANDBOOKBUFFITEM_GET_SELLPRICE_OFFSET UNITYSDK_OFFSET(0xB99DF20)
#define RPG_CLIENT_FATEHANDBOOKBUFFITEM_GET_SUBTRAITDATA_OFFSET UNITYSDK_OFFSET(0xB99D970)
#define RPG_CLIENT_FATEHANDBOOKBUFFITEM_SET_BUFFID_OFFSET UNITYSDK_OFFSET(0xB99D740)
#define RPG_CLIENT_FATEHANDBOOKBUFFITEM_SET_BUFFLEVEL_OFFSET UNITYSDK_OFFSET(0xB99D760)
#define RPG_CLIENT_FATEHANDBOOKBUFFITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xB99D720)

namespace RPG::Client
{
	inline static constexpr unsigned int FateHandbookBuffItem_TypeDefinitionIndex = 59865;
