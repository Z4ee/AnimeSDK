...
#define RPG_CLIENT_HEADICONUTILS___C__DISPLAYCLASS5_0__CTOR_OFFSET UNITYSDK_OFFSET(0x17930340)
#define RPG_CLIENT_HEADICONUTILS___C__DISPLAYCLASS5_0__GETSORTEDHEADICONDATALIST_B__0_OFFSET UNITYSDK_OFFSET(0x179307C0)

namespace RPG::Client
{
	inline static constexpr unsigned int HeadIconUtils___c__DisplayClass5_0_TypeDefinitionIndex = 62732;
