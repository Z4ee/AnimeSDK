...
#define RPG_CLIENT_TUTORIAL_TUTORIALGUIDECATEGORYINFO_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x16FCB010)
#define RPG_CLIENT_TUTORIAL_TUTORIALGUIDECATEGORYINFO_GET_NAMETEXT_OFFSET UNITYSDK_OFFSET(0x16FCB000)
#define RPG_CLIENT_TUTORIAL_TUTORIALGUIDECATEGORYINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16FCAFF0)

namespace RPG::Client::Tutorial
{
	inline static constexpr unsigned int TutorialGuideCategoryInfo_TypeDefinitionIndex = 75034;
