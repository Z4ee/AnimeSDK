...
#define RPG_CLIENT_TUTORIAL_TUTORIALGUIDECATEGORYINFO_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xCAF0B50)
#define RPG_CLIENT_TUTORIAL_TUTORIALGUIDECATEGORYINFO_GET_NAMETEXT_OFFSET UNITYSDK_OFFSET(0xCAF0B40)
#define RPG_CLIENT_TUTORIAL_TUTORIALGUIDECATEGORYINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xCAF0B30)

namespace RPG::Client::Tutorial
{
	inline static constexpr unsigned int TutorialGuideCategoryInfo_TypeDefinitionIndex = 73509;
