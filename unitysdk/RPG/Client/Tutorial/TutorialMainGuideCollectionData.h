...
#define RPG_CLIENT_TUTORIAL_TUTORIALMAINGUIDECOLLECTIONDATA_CREATEGUIDEGROUPDATA_OFFSET UNITYSDK_OFFSET(0xE2F54E0)
#define RPG_CLIENT_TUTORIAL_TUTORIALMAINGUIDECOLLECTIONDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xE2F4660)
#define RPG_CLIENT_TUTORIAL_TUTORIALMAINGUIDECOLLECTIONDATA_GETCATEGORYIDLISTBYGROUPTYPEID_OFFSET UNITYSDK_OFFSET(0xE2F5640)
#define RPG_CLIENT_TUTORIAL_TUTORIALMAINGUIDECOLLECTIONDATA_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xE2F5310)
#define RPG_CLIENT_TUTORIAL_TUTORIALMAINGUIDECOLLECTIONDATA_GETGUIDECATEGORYINFO_OFFSET UNITYSDK_OFFSET(0xE2F5570)
#define RPG_CLIENT_TUTORIAL_TUTORIALMAINGUIDECOLLECTIONDATA_GETGUIDEGROUPDATABYID_OFFSET UNITYSDK_OFFSET(0xE2F5450)
#define RPG_CLIENT_TUTORIAL_TUTORIALMAINGUIDECOLLECTIONDATA_GETSPECIALGOTOINFO_OFFSET UNITYSDK_OFFSET(0xE2F5860)
#define RPG_CLIENT_TUTORIAL_TUTORIALMAINGUIDECOLLECTIONDATA_GET_GUIDETYPE_OFFSET UNITYSDK_OFFSET(0xE2F5930)
#define RPG_CLIENT_TUTORIAL_TUTORIALMAINGUIDECOLLECTIONDATA__CREATEGUIDEGROUPDATA_OFFSET UNITYSDK_OFFSET(0xE2F5250)
#define RPG_CLIENT_TUTORIAL_TUTORIALMAINGUIDECOLLECTIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xE2F51D0)

namespace RPG::Client::Tutorial
{
	inline static constexpr unsigned int TutorialMainGuideCollectionData_TypeDefinitionIndex = 78529;
