...
#define RPG_CLIENT_TUTORIAL_TUTORIALMAINGUIDECOLLECTIONDATA_CREATEGUIDEGROUPDATA_OFFSET UNITYSDK_OFFSET(0xCAF2430)
#define RPG_CLIENT_TUTORIAL_TUTORIALMAINGUIDECOLLECTIONDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xCAF1690)
#define RPG_CLIENT_TUTORIAL_TUTORIALMAINGUIDECOLLECTIONDATA_GETCATEGORYIDLISTBYGROUPTYPEID_OFFSET UNITYSDK_OFFSET(0xCAF2590)
#define RPG_CLIENT_TUTORIAL_TUTORIALMAINGUIDECOLLECTIONDATA_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xCAF2260)
#define RPG_CLIENT_TUTORIAL_TUTORIALMAINGUIDECOLLECTIONDATA_GETGUIDECATEGORYINFO_OFFSET UNITYSDK_OFFSET(0xCAF24C0)
#define RPG_CLIENT_TUTORIAL_TUTORIALMAINGUIDECOLLECTIONDATA_GETGUIDEGROUPDATABYID_OFFSET UNITYSDK_OFFSET(0xCAF23A0)
#define RPG_CLIENT_TUTORIAL_TUTORIALMAINGUIDECOLLECTIONDATA_GETSPECIALGOTOINFO_OFFSET UNITYSDK_OFFSET(0xCAF27B0)
#define RPG_CLIENT_TUTORIAL_TUTORIALMAINGUIDECOLLECTIONDATA_GET_GUIDETYPE_OFFSET UNITYSDK_OFFSET(0xCAF2880)
#define RPG_CLIENT_TUTORIAL_TUTORIALMAINGUIDECOLLECTIONDATA__CREATEGUIDEGROUPDATA_OFFSET UNITYSDK_OFFSET(0xCAF21A0)
#define RPG_CLIENT_TUTORIAL_TUTORIALMAINGUIDECOLLECTIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCAF2120)

namespace RPG::Client::Tutorial
{
	inline static constexpr unsigned int TutorialMainGuideCollectionData_TypeDefinitionIndex = 73512;
	...
	public:
		...
		{
			return ((::Enum_3_ED790DAC948A65A9_29(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_TUTORIAL_TUTORIALMAINGUIDECOLLECTIONDATA_GET_GUIDETYPE_OFFSET))(this);
		}
	};
}
