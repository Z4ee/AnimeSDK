...
#define RPG_CLIENT_TUTORIAL_TUTORIALGUIDESPECIALGOTOINFO_GET_GOTOID_OFFSET UNITYSDK_OFFSET(0xCAF2090)
#define RPG_CLIENT_TUTORIAL_TUTORIALGUIDESPECIALGOTOINFO_GET_HINTTEXT_OFFSET UNITYSDK_OFFSET(0xCAF2080)
#define RPG_CLIENT_TUTORIAL_TUTORIALGUIDESPECIALGOTOINFO_GET_NEEDREDDOT_OFFSET UNITYSDK_OFFSET(0xCAF20C0)
#define RPG_CLIENT_TUTORIAL_TUTORIALGUIDESPECIALGOTOINFO_GET_REDDOTKEY_OFFSET UNITYSDK_OFFSET(0xCAF20A0)
#define RPG_CLIENT_TUTORIAL_TUTORIALGUIDESPECIALGOTOINFO_GET_REDDOTSUBKEY_OFFSET UNITYSDK_OFFSET(0xCAF20B0)
#define RPG_CLIENT_TUTORIAL_TUTORIALGUIDESPECIALGOTOINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xCAF2040)

namespace RPG::Client::Tutorial
{
	inline static constexpr unsigned int TutorialGuideSpecialGotoInfo_TypeDefinitionIndex = 73511;
