...
#define RPG_CLIENT_TUTORIAL_TUTORIALGUIDESPECIALGOTOINFO_GET_GOTOID_OFFSET UNITYSDK_OFFSET(0x16FCC790)
#define RPG_CLIENT_TUTORIAL_TUTORIALGUIDESPECIALGOTOINFO_GET_HINTTEXT_OFFSET UNITYSDK_OFFSET(0x16FCC780)
#define RPG_CLIENT_TUTORIAL_TUTORIALGUIDESPECIALGOTOINFO_GET_NEEDREDDOT_OFFSET UNITYSDK_OFFSET(0x16FCC7C0)
#define RPG_CLIENT_TUTORIAL_TUTORIALGUIDESPECIALGOTOINFO_GET_REDDOTKEY_OFFSET UNITYSDK_OFFSET(0x16FCC7A0)
#define RPG_CLIENT_TUTORIAL_TUTORIALGUIDESPECIALGOTOINFO_GET_REDDOTSUBKEY_OFFSET UNITYSDK_OFFSET(0x16FCC7B0)
#define RPG_CLIENT_TUTORIAL_TUTORIALGUIDESPECIALGOTOINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16FCC740)

namespace RPG::Client::Tutorial
{
	inline static constexpr unsigned int TutorialGuideSpecialGotoInfo_TypeDefinitionIndex = 75036;
