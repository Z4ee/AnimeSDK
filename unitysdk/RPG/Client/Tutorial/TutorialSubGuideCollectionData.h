...
#define RPG_CLIENT_TUTORIAL_TUTORIALSUBGUIDECOLLECTIONDATA_CREATEGUIDEGROUPDATA_OFFSET UNITYSDK_OFFSET(0xE2F5E00)
#define RPG_CLIENT_TUTORIAL_TUTORIALSUBGUIDECOLLECTIONDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xE2F4900)
#define RPG_CLIENT_TUTORIAL_TUTORIALSUBGUIDECOLLECTIONDATA_GETCATEGORYIDLISTBYGROUPTYPEID_OFFSET UNITYSDK_OFFSET(0xE2F5F60)
#define RPG_CLIENT_TUTORIAL_TUTORIALSUBGUIDECOLLECTIONDATA_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xE2F5C30)
#define RPG_CLIENT_TUTORIAL_TUTORIALSUBGUIDECOLLECTIONDATA_GETGUIDECATEGORYINFO_OFFSET UNITYSDK_OFFSET(0xE2F5E90)
#define RPG_CLIENT_TUTORIAL_TUTORIALSUBGUIDECOLLECTIONDATA_GETGUIDEGROUPDATABYID_OFFSET UNITYSDK_OFFSET(0xE2F5D70)
#define RPG_CLIENT_TUTORIAL_TUTORIALSUBGUIDECOLLECTIONDATA_GETSPECIALGOTOINFO_OFFSET UNITYSDK_OFFSET(0xE2F6170)
#define RPG_CLIENT_TUTORIAL_TUTORIALSUBGUIDECOLLECTIONDATA_GET_GUIDETYPE_OFFSET UNITYSDK_OFFSET(0xE2F61C0)
#define RPG_CLIENT_TUTORIAL_TUTORIALSUBGUIDECOLLECTIONDATA__CREATEGUIDEGROUPDATA_OFFSET UNITYSDK_OFFSET(0xE2F5A10)
#define RPG_CLIENT_TUTORIAL_TUTORIALSUBGUIDECOLLECTIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xE2F5990)

namespace RPG::Client::Tutorial
{
	inline static constexpr unsigned int TutorialSubGuideCollectionData_TypeDefinitionIndex = 78530;
