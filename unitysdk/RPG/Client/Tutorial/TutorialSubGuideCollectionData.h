...
#define RPG_CLIENT_TUTORIAL_TUTORIALSUBGUIDECOLLECTIONDATA_CREATEGUIDEGROUPDATA_OFFSET UNITYSDK_OFFSET(0x1B108C20)
#define RPG_CLIENT_TUTORIAL_TUTORIALSUBGUIDECOLLECTIONDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1B107720)
#define RPG_CLIENT_TUTORIAL_TUTORIALSUBGUIDECOLLECTIONDATA_GETCATEGORYIDLISTBYGROUPTYPEID_OFFSET UNITYSDK_OFFSET(0x1B108D80)
#define RPG_CLIENT_TUTORIAL_TUTORIALSUBGUIDECOLLECTIONDATA_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B108A50)
#define RPG_CLIENT_TUTORIAL_TUTORIALSUBGUIDECOLLECTIONDATA_GETGUIDECATEGORYINFO_OFFSET UNITYSDK_OFFSET(0x1B108CB0)
#define RPG_CLIENT_TUTORIAL_TUTORIALSUBGUIDECOLLECTIONDATA_GETGUIDEGROUPDATABYID_OFFSET UNITYSDK_OFFSET(0x1B108B90)
#define RPG_CLIENT_TUTORIAL_TUTORIALSUBGUIDECOLLECTIONDATA_GETSPECIALGOTOINFO_OFFSET UNITYSDK_OFFSET(0x1B108F90)
#define RPG_CLIENT_TUTORIAL_TUTORIALSUBGUIDECOLLECTIONDATA_GET_GUIDETYPE_OFFSET UNITYSDK_OFFSET(0x1B108FE0)
#define RPG_CLIENT_TUTORIAL_TUTORIALSUBGUIDECOLLECTIONDATA__CREATEGUIDEGROUPDATA_OFFSET UNITYSDK_OFFSET(0x1B108830)
#define RPG_CLIENT_TUTORIAL_TUTORIALSUBGUIDECOLLECTIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1087B0)

namespace RPG::Client::Tutorial
{
	inline static constexpr unsigned int TutorialSubGuideCollectionData_TypeDefinitionIndex = 78529;
	...
	public:
		...
		{
			return ((::Enum_3_ED790DAC948A65A9_31(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_TUTORIAL_TUTORIALSUBGUIDECOLLECTIONDATA_GET_GUIDETYPE_OFFSET))(this);
		}
	};
}
