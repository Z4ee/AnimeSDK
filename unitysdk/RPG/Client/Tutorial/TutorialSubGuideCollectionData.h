...
#define RPG_CLIENT_TUTORIAL_TUTORIALSUBGUIDECOLLECTIONDATA_CREATEGUIDEGROUPDATA_OFFSET UNITYSDK_OFFSET(0x16FCD440)
#define RPG_CLIENT_TUTORIAL_TUTORIALSUBGUIDECOLLECTIONDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x16FCBF50)
#define RPG_CLIENT_TUTORIAL_TUTORIALSUBGUIDECOLLECTIONDATA_GETCATEGORYIDLISTBYGROUPTYPEID_OFFSET UNITYSDK_OFFSET(0x16FCD5A0)
#define RPG_CLIENT_TUTORIAL_TUTORIALSUBGUIDECOLLECTIONDATA_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x16FCD270)
#define RPG_CLIENT_TUTORIAL_TUTORIALSUBGUIDECOLLECTIONDATA_GETGUIDECATEGORYINFO_OFFSET UNITYSDK_OFFSET(0x16FCD4D0)
#define RPG_CLIENT_TUTORIAL_TUTORIALSUBGUIDECOLLECTIONDATA_GETGUIDEGROUPDATABYID_OFFSET UNITYSDK_OFFSET(0x16FCD3B0)
#define RPG_CLIENT_TUTORIAL_TUTORIALSUBGUIDECOLLECTIONDATA_GETSPECIALGOTOINFO_OFFSET UNITYSDK_OFFSET(0x16FCD7B0)
#define RPG_CLIENT_TUTORIAL_TUTORIALSUBGUIDECOLLECTIONDATA_GET_GUIDETYPE_OFFSET UNITYSDK_OFFSET(0x16FCD800)
#define RPG_CLIENT_TUTORIAL_TUTORIALSUBGUIDECOLLECTIONDATA__CREATEGUIDEGROUPDATA_OFFSET UNITYSDK_OFFSET(0x16FCD060)
#define RPG_CLIENT_TUTORIAL_TUTORIALSUBGUIDECOLLECTIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x16FCCFE0)

namespace RPG::Client::Tutorial
{
	inline static constexpr unsigned int TutorialSubGuideCollectionData_TypeDefinitionIndex = 75038;
	...
	public:
		...
		{
			return ((::Enum_3_ED790DAC948A65A9_30(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_TUTORIAL_TUTORIALSUBGUIDECOLLECTIONDATA_GET_GUIDETYPE_OFFSET))(this);
		}
	};
}
