...
#define RPG_CLIENT_TUTORIAL_TUTORIALSINGLEGUIDEINFO_GET_DESCTEXT_OFFSET UNITYSDK_OFFSET(0x16FCCFD0)
#define RPG_CLIENT_TUTORIAL_TUTORIALSINGLEGUIDEINFO_GET_IMAGEPATH_OFFSET UNITYSDK_OFFSET(0x16FCCFC0)
#define RPG_CLIENT_TUTORIAL_TUTORIALSINGLEGUIDEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16FCB620)

namespace RPG::Client::Tutorial
{
	inline static constexpr unsigned int TutorialSingleGuideInfo_TypeDefinitionIndex = 75033;
