...
#define RPG_CLIENT_DEBUGGUIMANAGER_ADDGUI_OFFSET UNITYSDK_OFFSET(0x1808FB30)
#define RPG_CLIENT_DEBUGGUIMANAGER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1808F540)
#define RPG_CLIENT_DEBUGGUIMANAGER_BEGINCHANGECHECK_OFFSET UNITYSDK_OFFSET(0x18090CB0)
#define RPG_CLIENT_DEBUGGUIMANAGER_ENDCHANGECHECK_OFFSET UNITYSDK_OFFSET(0x18090DA0)
#define RPG_CLIENT_DEBUGGUIMANAGER_GETCURRENTCONTENTSCALE_OFFSET UNITYSDK_OFFSET(0x18090680)
#define RPG_CLIENT_DEBUGGUIMANAGER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x18090F00)
#define RPG_CLIENT_DEBUGGUIMANAGER_ONGUI_OFFSET UNITYSDK_OFFSET(0x1808F590)
#define RPG_CLIENT_DEBUGGUIMANAGER_POPCOLOR_OFFSET UNITYSDK_OFFSET(0x18090B30)
#define RPG_CLIENT_DEBUGGUIMANAGER_POPCONTENTSCALE_OFFSET UNITYSDK_OFFSET(0x180904E0)
#define RPG_CLIENT_DEBUGGUIMANAGER_POPGROUP_OFFSET UNITYSDK_OFFSET(0x18090810)
#define RPG_CLIENT_DEBUGGUIMANAGER_PUSHCOLOR_OFFSET UNITYSDK_OFFSET(0x18090960)
#define RPG_CLIENT_DEBUGGUIMANAGER_PUSHCONTENTSCALE_OFFSET UNITYSDK_OFFSET(0x18090070)
#define RPG_CLIENT_DEBUGGUIMANAGER_PUSHGROUP_OFFSET UNITYSDK_OFFSET(0x18090710)
#define RPG_CLIENT_DEBUGGUIMANAGER_REMOVEGUI_OFFSET UNITYSDK_OFFSET(0x1808FDD0)
#define RPG_CLIENT_DEBUGGUIMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x18090F10)

namespace RPG::Client
{
	inline static constexpr unsigned int DebugGUIManager_TypeDefinitionIndex = 65291;

	class DebugGUIManager : public ::UnityEngine::MonoBehaviour
	{
	public:
		static ::RPG::Client::DebugGUIManager** StaticGet_Field_5_0()
		{
			return (::RPG::Client::DebugGUIManager**)Il2CppClass::FromTypeDefinitionIndex(DebugGUIManager_TypeDefinitionIndex)->GetStaticField(0x5EED0);
		}
		::System::Boolean EnableGUI; // 0x18
		::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_958*>* Field_5_2; // 0x20
		...
		static ::System::Void AddGUI(::Class_0_16E4307DCC419505_958* a1)
		{
			return ((::System::Void(*)(::Class_0_16E4307DCC419505_958*))((::PBYTE)hIl2Cpp + RPG_CLIENT_DEBUGGUIMANAGER_ADDGUI_OFFSET))(a1);
		}

		static ::System::Void RemoveGUI(::Class_0_16E4307DCC419505_958* a1)
		{
			return ((::System::Void(*)(::Class_0_16E4307DCC419505_958*))((::PBYTE)hIl2Cpp + RPG_CLIENT_DEBUGGUIMANAGER_REMOVEGUI_OFFSET))(a1);
		}
