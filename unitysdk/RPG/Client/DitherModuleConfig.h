...
#define RPG_CLIENT_DITHERMODULECONFIG_METHOD_4_2BF4648671111A7E_OFFSET UNITYSDK_OFFSET(0x1B8E26F0)
#define RPG_CLIENT_DITHERMODULECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8E2740)
