...
#define RPG_CLIENT_PAGELISTVIEW_DESPAWNED_OFFSET UNITYSDK_OFFSET(0x1A2DD2A0)
#define RPG_CLIENT_PAGELISTVIEW_GET_CURRENTPAGEINDEX_OFFSET UNITYSDK_OFFSET(0x1A2DD880)
#define RPG_CLIENT_PAGELISTVIEW_GET_PAGENUM_OFFSET UNITYSDK_OFFSET(0x1A2DC840)
#define RPG_CLIENT_PAGELISTVIEW_MOVETOPAGEBYITEMCHILDNAME_OFFSET UNITYSDK_OFFSET(0x1A2DCEC0)
#define RPG_CLIENT_PAGELISTVIEW_MOVETOPAGE_OFFSET UNITYSDK_OFFSET(0x1A2DCDF0)
#define RPG_CLIENT_PAGELISTVIEW_ONSCROLL_OFFSET UNITYSDK_OFFSET(0x1A2DD1A0)
#define RPG_CLIENT_PAGELISTVIEW_REFRESHALLPAGES_OFFSET UNITYSDK_OFFSET(0x1A2DD100)
#define RPG_CLIENT_PAGELISTVIEW_SAFEINIT_OFFSET UNITYSDK_OFFSET(0x1A2DC890)
#define RPG_CLIENT_PAGELISTVIEW_SETNEARESTCHANGEDCALLBACK_OFFSET UNITYSDK_OFFSET(0x1A2DD150)
#define RPG_CLIENT_PAGELISTVIEW_SETPAGENUM_OFFSET UNITYSDK_OFFSET(0x1A2DCA40)
#define RPG_CLIENT_PAGELISTVIEW__ADDDOTS_OFFSET UNITYSDK_OFFSET(0x1A2DD6D0)
#define RPG_CLIENT_PAGELISTVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2DD8D0)
#define RPG_CLIENT_PAGELISTVIEW__GETTARGETSCROLLINDEX_OFFSET UNITYSDK_OFFSET(0x1A2DD580)
#define RPG_CLIENT_PAGELISTVIEW__ONDRAGEND_OFFSET UNITYSDK_OFFSET(0x1A2DD330)
#define RPG_CLIENT_PAGELISTVIEW__ONSNAPNEARESTCHANGED_OFFSET UNITYSDK_OFFSET(0x1A2DD650)
#define RPG_CLIENT_PAGELISTVIEW__REFRESHDOTS_OFFSET UNITYSDK_OFFSET(0x1A2DCBE0)

namespace RPG::Client
{
	inline static constexpr unsigned int PageListView_TypeDefinitionIndex = 69339;
