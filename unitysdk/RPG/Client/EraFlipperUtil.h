...
#define RPG_CLIENT_ERAFLIPPERUTIL_COMPARECONFIGTAG_OFFSET UNITYSDK_OFFSET(0x9629AF0)
#define RPG_CLIENT_ERAFLIPPERUTIL_COMPAREENTITYERATAG_OFFSET UNITYSDK_OFFSET(0x96299D0)
#define RPG_CLIENT_ERAFLIPPERUTIL_COMPAREGROUPTAG_OFFSET UNITYSDK_OFFSET(0x9627E80)
#define RPG_CLIENT_ERAFLIPPERUTIL_COMPARETAG_1_OFFSET UNITYSDK_OFFSET(0x96297E0)
#define RPG_CLIENT_ERAFLIPPERUTIL_COMPARETAG_OFFSET UNITYSDK_OFFSET(0x9629B60)
#define RPG_CLIENT_ERAFLIPPERUTIL_CURRENTERASTATETOTSCSTATE_OFFSET UNITYSDK_OFFSET(0x9628330)
#define RPG_CLIENT_ERAFLIPPERUTIL_FILLFOLLOWINGPLAYERLIGHTCONEINFO_OFFSET UNITYSDK_OFFSET(0x96293E0)
#define RPG_CLIENT_ERAFLIPPERUTIL_FILLPARTIALDEVICEPOINTATINFO_OFFSET UNITYSDK_OFFSET(0x9628F80)
#define RPG_CLIENT_ERAFLIPPERUTIL_GETFLOORCONFIGPATH_OFFSET UNITYSDK_OFFSET(0x9628E40)
#define RPG_CLIENT_ERAFLIPPERUTIL_HASANYFOLLOWPLAYERDEVICE_OFFSET UNITYSDK_OFFSET(0x9629240)
#define RPG_CLIENT_ERAFLIPPERUTIL_HASFOLLOWPLAYERDEVICE_OFFSET UNITYSDK_OFFSET(0x9629310)
#define RPG_CLIENT_ERAFLIPPERUTIL_ISCURRENTREGION_OFFSET UNITYSDK_OFFSET(0x9629D10)
#define RPG_CLIENT_ERAFLIPPERUTIL_ISFLIPSTATESAMEWITHFLOORDEFAULT_OFFSET UNITYSDK_OFFSET(0x9629C40)
#define RPG_CLIENT_ERAFLIPPERUTIL_ISGROUPCOLLIDERACTIVE_OFFSET UNITYSDK_OFFSET(0x9628380)
#define RPG_CLIENT_ERAFLIPPERUTIL_ISGROUPVISIBLEALWAYS_OFFSET UNITYSDK_OFFSET(0x9627FF0)
#define RPG_CLIENT_ERAFLIPPERUTIL_ISGROUPVISIBLE_1_OFFSET UNITYSDK_OFFSET(0x9629860)
#define RPG_CLIENT_ERAFLIPPERUTIL_ISGROUPVISIBLE_OFFSET UNITYSDK_OFFSET(0x9626260)
#define RPG_CLIENT_ERAFLIPPERUTIL_ISMAPINFOVISIBLE_OFFSET UNITYSDK_OFFSET(0x9629590)
#define RPG_CLIENT_ERAFLIPPERUTIL_ISPARTIALDEVICEACTIVE_OFFSET UNITYSDK_OFFSET(0x9629500)
#define RPG_CLIENT_ERAFLIPPERUTIL_ISVISIBLEALWAYS_OFFSET UNITYSDK_OFFSET(0x96296B0)
#define RPG_CLIENT_ERAFLIPPERUTIL_REVERSESTATE_OFFSET UNITYSDK_OFFSET(0x9624580)
#define RPG_CLIENT_ERAFLIPPERUTIL_RUNTIMEPARTIALDEVICEPOINTATMAPPINGPROPS_OFFSET UNITYSDK_OFFSET(0x9628EF0)
#define RPG_CLIENT_ERAFLIPPERUTIL_SETTARGETNAVANDCOLLIDERSTATE_OFFSET UNITYSDK_OFFSET(0x9629FE0)
#define RPG_CLIENT_ERAFLIPPERUTIL__CCTOR_OFFSET UNITYSDK_OFFSET(0x962A650)

namespace RPG::Client
{
	inline static constexpr unsigned int EraFlipperUtil_TypeDefinitionIndex = 49004;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::AI::NavMeshObstacle*>**)Il2CppClass::FromTypeDefinitionIndex(EraFlipperUtil_TypeDefinitionIndex)->GetStaticField(0x47230);
		}
		static ::System::Collections::Generic::List_1<::UnityEngine::AI::NavMeshSurface*>** StaticGet__TempNavMeshSurfaceList()
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::AI::NavMeshSurface*>**)Il2CppClass::FromTypeDefinitionIndex(EraFlipperUtil_TypeDefinitionIndex)->GetStaticField(0x47238);
		}
		static ::System::Collections::Generic::List_1<::UnityEngine::Collider*>** StaticGet__TempColliderList()
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::Collider*>**)Il2CppClass::FromTypeDefinitionIndex(EraFlipperUtil_TypeDefinitionIndex)->GetStaticField(0x47240);
		}
		static ::System::Collections::Generic::List_1<::UnityEngine::AI::NavMeshLink*>** StaticGet__TempNavMeshLinkList()
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::AI::NavMeshLink*>**)Il2CppClass::FromTypeDefinitionIndex(EraFlipperUtil_TypeDefinitionIndex)->GetStaticField(0x47248);
		}
