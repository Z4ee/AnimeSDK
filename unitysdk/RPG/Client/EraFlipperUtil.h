...
#define RPG_CLIENT_ERAFLIPPERUTIL_COMPARECONFIGTAG_OFFSET UNITYSDK_OFFSET(0x1993D030)
#define RPG_CLIENT_ERAFLIPPERUTIL_COMPAREENTITYERATAG_OFFSET UNITYSDK_OFFSET(0x1993CF10)
#define RPG_CLIENT_ERAFLIPPERUTIL_COMPAREGROUPTAG_OFFSET UNITYSDK_OFFSET(0x1993AF90)
#define RPG_CLIENT_ERAFLIPPERUTIL_COMPARETAG_1_OFFSET UNITYSDK_OFFSET(0x1993CD20)
#define RPG_CLIENT_ERAFLIPPERUTIL_COMPARETAG_OFFSET UNITYSDK_OFFSET(0x1993D0A0)
#define RPG_CLIENT_ERAFLIPPERUTIL_CURRENTERASTATETOTSCSTATE_OFFSET UNITYSDK_OFFSET(0x1993B440)
#define RPG_CLIENT_ERAFLIPPERUTIL_FILLFOLLOWINGPLAYERLIGHTCONEINFO_OFFSET UNITYSDK_OFFSET(0x1993C880)
#define RPG_CLIENT_ERAFLIPPERUTIL_FILLPARTIALDEVICEPOINTATINFO_OFFSET UNITYSDK_OFFSET(0x1993C430)
#define RPG_CLIENT_ERAFLIPPERUTIL_GETFLOORCONFIGPATH_OFFSET UNITYSDK_OFFSET(0x1993C2F0)
#define RPG_CLIENT_ERAFLIPPERUTIL_HASANYFOLLOWPLAYERDEVICE_OFFSET UNITYSDK_OFFSET(0x1993C6E0)
#define RPG_CLIENT_ERAFLIPPERUTIL_HASFOLLOWPLAYERDEVICE_OFFSET UNITYSDK_OFFSET(0x1993C7B0)
#define RPG_CLIENT_ERAFLIPPERUTIL_ISCURRENTREGION_OFFSET UNITYSDK_OFFSET(0x1993D250)
#define RPG_CLIENT_ERAFLIPPERUTIL_ISFLIPSTATESAMEWITHFLOORDEFAULT_OFFSET UNITYSDK_OFFSET(0x1993D180)
#define RPG_CLIENT_ERAFLIPPERUTIL_ISGROUPCOLLIDERACTIVE_OFFSET UNITYSDK_OFFSET(0x1993B490)
#define RPG_CLIENT_ERAFLIPPERUTIL_ISGROUPVISIBLEALWAYS_OFFSET UNITYSDK_OFFSET(0x1993B100)
#define RPG_CLIENT_ERAFLIPPERUTIL_ISGROUPVISIBLE_1_OFFSET UNITYSDK_OFFSET(0x1993CDA0)
#define RPG_CLIENT_ERAFLIPPERUTIL_ISGROUPVISIBLE_OFFSET UNITYSDK_OFFSET(0x199390B0)
#define RPG_CLIENT_ERAFLIPPERUTIL_ISMAPINFOVISIBLE_OFFSET UNITYSDK_OFFSET(0x1993CA30)
#define RPG_CLIENT_ERAFLIPPERUTIL_ISPARTIALDEVICEACTIVE_OFFSET UNITYSDK_OFFSET(0x1993C9A0)
#define RPG_CLIENT_ERAFLIPPERUTIL_ISVISIBLEALWAYS_OFFSET UNITYSDK_OFFSET(0x1993CB50)
#define RPG_CLIENT_ERAFLIPPERUTIL_REVERSESTATE_OFFSET UNITYSDK_OFFSET(0x19937360)
#define RPG_CLIENT_ERAFLIPPERUTIL_RUNTIMEPARTIALDEVICEPOINTATMAPPINGPROPS_OFFSET UNITYSDK_OFFSET(0x1993C3A0)
#define RPG_CLIENT_ERAFLIPPERUTIL_SETTARGETNAVANDCOLLIDERSTATE_OFFSET UNITYSDK_OFFSET(0x1993D500)
#define RPG_CLIENT_ERAFLIPPERUTIL__CCTOR_OFFSET UNITYSDK_OFFSET(0x1993DAD0)

namespace RPG::Client
{
	inline static constexpr unsigned int EraFlipperUtil_TypeDefinitionIndex = 60613;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::AI::NavMeshSurface*>**)Il2CppClass::FromTypeDefinitionIndex(EraFlipperUtil_TypeDefinitionIndex)->GetStaticField(0x642B0);
		}
		static ::System::Collections::Generic::List_1<::UnityEngine::Collider*>** StaticGet__TempColliderList()
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::Collider*>**)Il2CppClass::FromTypeDefinitionIndex(EraFlipperUtil_TypeDefinitionIndex)->GetStaticField(0x642B8);
		}
		static ::System::Collections::Generic::List_1<::UnityEngine::AI::NavMeshObstacle*>** StaticGet__TempNavMeshObstacleList()
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::AI::NavMeshObstacle*>**)Il2CppClass::FromTypeDefinitionIndex(EraFlipperUtil_TypeDefinitionIndex)->GetStaticField(0x642C0);
		}
		static ::System::Collections::Generic::List_1<::UnityEngine::AI::NavMeshLink*>** StaticGet__TempNavMeshLinkList()
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::AI::NavMeshLink*>**)Il2CppClass::FromTypeDefinitionIndex(EraFlipperUtil_TypeDefinitionIndex)->GetStaticField(0x642C8);
		}
