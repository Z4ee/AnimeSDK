...
#define RPG_CLIENT_GRIDFIGHTGAMEPLAYRESCONFIG_CREATE_OFFSET UNITYSDK_OFFSET(0xD1B8CE0)
#define RPG_CLIENT_GRIDFIGHTGAMEPLAYRESCONFIG_GET_DESC_OFFSET UNITYSDK_OFFSET(0xD1B8E50)
#define RPG_CLIENT_GRIDFIGHTGAMEPLAYRESCONFIG_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xD1B8F00)
#define RPG_CLIENT_GRIDFIGHTGAMEPLAYRESCONFIG_GET_ID_OFFSET UNITYSDK_OFFSET(0xD1B8F50)
#define RPG_CLIENT_GRIDFIGHTGAMEPLAYRESCONFIG_GET_NAME_OFFSET UNITYSDK_OFFSET(0xD1B8DA0)
#define RPG_CLIENT_GRIDFIGHTGAMEPLAYRESCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xD1B8D90)
