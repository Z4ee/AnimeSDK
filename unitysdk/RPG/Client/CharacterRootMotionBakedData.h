...
#define RPG_CLIENT_CHARACTERROOTMOTIONBAKEDDATA_METHOD_1_2082A5CF70CD5C62_OFFSET UNITYSDK_OFFSET(0x930B530)
#define RPG_CLIENT_CHARACTERROOTMOTIONBAKEDDATA_METHOD_1_369897B8D90C5F5F_OFFSET UNITYSDK_OFFSET(0x930B620)
#define RPG_CLIENT_CHARACTERROOTMOTIONBAKEDDATA_METHOD_1_4F0040A703640ABF_OFFSET UNITYSDK_OFFSET(0x930B9C0)
#define RPG_CLIENT_CHARACTERROOTMOTIONBAKEDDATA_METHOD_1_87BD0C5330ED6BCB_OFFSET UNITYSDK_OFFSET(0x930B450)
#define RPG_CLIENT_CHARACTERROOTMOTIONBAKEDDATA_METHOD_1_B09E78EE7EE4F8FA_OFFSET UNITYSDK_OFFSET(0x930B3B0)
#define RPG_CLIENT_CHARACTERROOTMOTIONBAKEDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x930BBE0)

namespace RPG::Client
{
	inline static constexpr unsigned int CharacterRootMotionBakedData_TypeDefinitionIndex = 48658;
