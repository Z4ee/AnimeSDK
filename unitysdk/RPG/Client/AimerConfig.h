...
#define RPG_CLIENT_AIMERCONFIG_METHOD_1_72A9C35A6067A4C0_OFFSET UNITYSDK_OFFSET(0x9CE5710)
#define RPG_CLIENT_AIMERCONFIG_METHOD_1_A733AB2FC7A9B88A_OFFSET UNITYSDK_OFFSET(0x9CE4040)
#define RPG_CLIENT_AIMERCONFIG_METHOD_1_E91361DFF1424851_OFFSET UNITYSDK_OFFSET(0x9CE4A20)
#define RPG_CLIENT_AIMERCONFIG_METHOD_1_ECA72114536D14FE_OFFSET UNITYSDK_OFFSET(0x9CE3E80)
#define RPG_CLIENT_AIMERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x9CE5BB0)

namespace RPG::Client
{
	inline static constexpr unsigned int AimerConfig_TypeDefinitionIndex = 63155;
