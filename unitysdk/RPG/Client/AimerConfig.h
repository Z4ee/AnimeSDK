...
#define RPG_CLIENT_AIMERCONFIG_METHOD_1_11A4B5B9C7557187_OFFSET UNITYSDK_OFFSET(0x9088510)
#define RPG_CLIENT_AIMERCONFIG_METHOD_1_A733AB2FC7A9B88A_OFFSET UNITYSDK_OFFSET(0x9086E70)
#define RPG_CLIENT_AIMERCONFIG_METHOD_1_E91361DFF1424851_OFFSET UNITYSDK_OFFSET(0x9087850)
#define RPG_CLIENT_AIMERCONFIG_METHOD_1_ECA72114536D14FE_OFFSET UNITYSDK_OFFSET(0x9086CB0)
#define RPG_CLIENT_AIMERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x9088970)

namespace RPG::Client
{
	inline static constexpr unsigned int AimerConfig_TypeDefinitionIndex = 55921;
