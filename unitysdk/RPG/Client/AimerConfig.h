...
#define RPG_CLIENT_AIMERCONFIG_METHOD_1_11A4B5B9C7557187_OFFSET UNITYSDK_OFFSET(0xB2D46B0)
#define RPG_CLIENT_AIMERCONFIG_METHOD_1_A733AB2FC7A9B88A_OFFSET UNITYSDK_OFFSET(0xB2D3060)
#define RPG_CLIENT_AIMERCONFIG_METHOD_1_E91361DFF1424851_OFFSET UNITYSDK_OFFSET(0xB2D39F0)
#define RPG_CLIENT_AIMERCONFIG_METHOD_1_ECA72114536D14FE_OFFSET UNITYSDK_OFFSET(0xB2D2EA0)
#define RPG_CLIENT_AIMERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xB2D4B20)

namespace RPG::Client
{
	inline static constexpr unsigned int AimerConfig_TypeDefinitionIndex = 64072;
