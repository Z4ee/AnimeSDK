...
#define RPG_CLIENT_TREASUREDUNGEONNOTIFYPARAM_CLEARTUTORIAL_OFFSET UNITYSDK_OFFSET(0xB38F930)
#define RPG_CLIENT_TREASUREDUNGEONNOTIFYPARAM_CLEAR_OFFSET UNITYSDK_OFFSET(0xB387BD0)
#define RPG_CLIENT_TREASUREDUNGEONNOTIFYPARAM_GET_ISGETCHEST_OFFSET UNITYSDK_OFFSET(0xB38F9A0)
#define RPG_CLIENT_TREASUREDUNGEONNOTIFYPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xB388170)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::Collections::Generic::List_1<::Class_1_1CBA230307F9C289_67*>* RecordData; // 0x18
		::System::Collections::Generic::List_1<::System::String*>* TriggeredTutorialKeys; // 0x20
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::Client::TreasureDungeonBaseGrid*>* TypeChangedGrids; // 0x28
		::System::Collections::Generic::List_1<::System::UInt32>* EmptyChangedGrids; // 0x30
		...
		::System::Boolean IsGetNewFloorBuff; // 0x44
		::System::Boolean IsGetNewEnvBuff; // 0x45
		::System::Boolean IsExplorePointUpdated; // 0x46
		::System::Boolean IsBuffUpdated; // 0x47
		::System::Boolean IsFloorUpdated; // 0x48
		::System::Boolean IsFloorBuffReplaced; // 0x49
