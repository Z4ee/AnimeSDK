...
#define RPG_CLIENT_MAZEGACHABOXPAGE_GET_GACHAGROUPSFOCUS_OFFSET UNITYSDK_OFFSET(0x9B822E0)
#define RPG_CLIENT_MAZEGACHABOXPAGE_GET_GACHAGROUPSMASK1_OFFSET UNITYSDK_OFFSET(0x9B82300)
#define RPG_CLIENT_MAZEGACHABOXPAGE_GET_GACHAGROUPSMASK2_OFFSET UNITYSDK_OFFSET(0x9B82320)
#define RPG_CLIENT_MAZEGACHABOXPAGE_GET_ROLLSPEED_OFFSET UNITYSDK_OFFSET(0x9B82340)
#define RPG_CLIENT_MAZEGACHABOXPAGE_GET_WAITSECONDS_OFFSET UNITYSDK_OFFSET(0x9B822C0)
#define RPG_CLIENT_MAZEGACHABOXPAGE_ONFINISH_OFFSET UNITYSDK_OFFSET(0x9B826F0)
#define RPG_CLIENT_MAZEGACHABOXPAGE_ONSTOPROLLING_OFFSET UNITYSDK_OFFSET(0x9B826A0)
#define RPG_CLIENT_MAZEGACHABOXPAGE_SET_GACHAGROUPSFOCUS_OFFSET UNITYSDK_OFFSET(0x9B822F0)
#define RPG_CLIENT_MAZEGACHABOXPAGE_SET_GACHAGROUPSMASK1_OFFSET UNITYSDK_OFFSET(0x9B82310)
#define RPG_CLIENT_MAZEGACHABOXPAGE_SET_GACHAGROUPSMASK2_OFFSET UNITYSDK_OFFSET(0x9B82330)
#define RPG_CLIENT_MAZEGACHABOXPAGE_SET_ROLLSPEED_OFFSET UNITYSDK_OFFSET(0x9B82350)
#define RPG_CLIENT_MAZEGACHABOXPAGE_SET_WAITSECONDS_OFFSET UNITYSDK_OFFSET(0x9B822D0)
#define RPG_CLIENT_MAZEGACHABOXPAGE_STARTROLLING_OFFSET UNITYSDK_OFFSET(0x9B82360)
#define RPG_CLIENT_MAZEGACHABOXPAGE_UPDATE_OFFSET UNITYSDK_OFFSET(0x9B82740)
#define RPG_CLIENT_MAZEGACHABOXPAGE__CALCCURRENTINDEX_OFFSET UNITYSDK_OFFSET(0x9B82800)
#define RPG_CLIENT_MAZEGACHABOXPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x9B82E60)
#define RPG_CLIENT_MAZEGACHABOXPAGE__POS2INDEX_OFFSET UNITYSDK_OFFSET(0x9B82B20)
#define RPG_CLIENT_MAZEGACHABOXPAGE__REMOVEHIGHLIGHT_OFFSET UNITYSDK_OFFSET(0x9B82470)
#define RPG_CLIENT_MAZEGACHABOXPAGE__SETHIGHLIGHTGACHAGROUP_OFFSET UNITYSDK_OFFSET(0x9B829A0)
#define RPG_CLIENT_MAZEGACHABOXPAGE__SETHIGHLIGHT_OFFSET UNITYSDK_OFFSET(0x9B82C30)

namespace RPG::Client
{
	inline static constexpr unsigned int MazeGachaBoxPage_TypeDefinitionIndex = 59774;
