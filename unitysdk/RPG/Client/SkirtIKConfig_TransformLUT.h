...
#define RPG_CLIENT_SKIRTIKCONFIG_TRANSFORMLUT__CTOR_OFFSET UNITYSDK_OFFSET(0xC8E6C20)

namespace RPG::Client
{
	inline static constexpr unsigned int SkirtIKConfig_TransformLUT_TypeDefinitionIndex = 63964;
