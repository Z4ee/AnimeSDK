...
#define RPG_CLIENT_MONOCITYTRAIN_ALERT_OFFSET UNITYSDK_OFFSET(0x1807D070)
#define RPG_CLIENT_MONOCITYTRAIN_AWAKE_OFFSET UNITYSDK_OFFSET(0x1807A750)
#define RPG_CLIENT_MONOCITYTRAIN_BOOST_OFFSET UNITYSDK_OFFSET(0x1807CD80)
#define RPG_CLIENT_MONOCITYTRAIN_BRAKE_OFFSET UNITYSDK_OFFSET(0x1807CF20)
#define RPG_CLIENT_MONOCITYTRAIN_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1807C700)
#define RPG_CLIENT_MONOCITYTRAIN_GETSLIDEMAXSPEED_OFFSET UNITYSDK_OFFSET(0x1807D2C0)
#define RPG_CLIENT_MONOCITYTRAIN_GET_SPEED_OFFSET UNITYSDK_OFFSET(0x1807A740)
#define RPG_CLIENT_MONOCITYTRAIN_HARDBRAKE_OFFSET UNITYSDK_OFFSET(0x1807CF70)
#define RPG_CLIENT_MONOCITYTRAIN_HIDEHARDBRAKEEFFECT_OFFSET UNITYSDK_OFFSET(0x1807CD10)
#define RPG_CLIENT_MONOCITYTRAIN_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1807B520)
#define RPG_CLIENT_MONOCITYTRAIN_METHOD_5_078D85152011B919_1_OFFSET UNITYSDK_OFFSET(0x1807AA60)
#define RPG_CLIENT_MONOCITYTRAIN_METHOD_5_078D85152011B919_OFFSET UNITYSDK_OFFSET(0x1807A9D0)
#define RPG_CLIENT_MONOCITYTRAIN_METHOD_5_3B4FCCB1316C6ED8_OFFSET UNITYSDK_OFFSET(0x1807B8E0)
#define RPG_CLIENT_MONOCITYTRAIN_METHOD_5_3C56C1AF247AC1EC_OFFSET UNITYSDK_OFFSET(0x1807DAF0)
#define RPG_CLIENT_MONOCITYTRAIN_METHOD_5_3CCA0B8A31B650A8_OFFSET UNITYSDK_OFFSET(0x1807D850)
#define RPG_CLIENT_MONOCITYTRAIN_METHOD_5_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0x1807C820)
#define RPG_CLIENT_MONOCITYTRAIN_METHOD_5_46DF29ACE60986D7_OFFSET UNITYSDK_OFFSET(0x1807D4B0)
#define RPG_CLIENT_MONOCITYTRAIN_METHOD_5_497833CF065C1894_OFFSET UNITYSDK_OFFSET(0x1807BB60)
#define RPG_CLIENT_MONOCITYTRAIN_METHOD_5_6CAB718A3750A897_OFFSET UNITYSDK_OFFSET(0x1807D330)
#define RPG_CLIENT_MONOCITYTRAIN_METHOD_5_79830F666EE579C0_OFFSET UNITYSDK_OFFSET(0x1807DDD0)
#define RPG_CLIENT_MONOCITYTRAIN_METHOD_5_9D8CB5E47C1952BD_OFFSET UNITYSDK_OFFSET(0x1807DB90)
#define RPG_CLIENT_MONOCITYTRAIN_METHOD_5_A5CFA053D190B8E6_OFFSET UNITYSDK_OFFSET(0x1807D7E0)
#define RPG_CLIENT_MONOCITYTRAIN_METHOD_5_BE68D528C0C9EE88_OFFSET UNITYSDK_OFFSET(0x1807D570)
#define RPG_CLIENT_MONOCITYTRAIN_METHOD_5_C8D6B29192F288ED_OFFSET UNITYSDK_OFFSET(0x1807B050)
#define RPG_CLIENT_MONOCITYTRAIN_METHOD_5_C9F59B9D8CCA4DFF_OFFSET UNITYSDK_OFFSET(0x1807C050)
#define RPG_CLIENT_MONOCITYTRAIN_METHOD_5_CA6BDDCC5F7CE11E_OFFSET UNITYSDK_OFFSET(0x1807B3F0)
#define RPG_CLIENT_MONOCITYTRAIN_METHOD_5_CC61F5A692F0C75B_OFFSET UNITYSDK_OFFSET(0x1807CDE0)
#define RPG_CLIENT_MONOCITYTRAIN_METHOD_5_D0BD1377F2594D33_OFFSET UNITYSDK_OFFSET(0x1807DD10)
#define RPG_CLIENT_MONOCITYTRAIN_METHOD_5_EE7A41C190351096_OFFSET UNITYSDK_OFFSET(0x1807D740)
#define RPG_CLIENT_MONOCITYTRAIN_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1807AC40)
#define RPG_CLIENT_MONOCITYTRAIN_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1807AAF0)
#define RPG_CLIENT_MONOCITYTRAIN_PLAYCLOSEDOOR_OFFSET UNITYSDK_OFFSET(0x1807D1D0)
#define RPG_CLIENT_MONOCITYTRAIN_PLAYOPENDOOR_OFFSET UNITYSDK_OFFSET(0x1807D0C0)
#define RPG_CLIENT_MONOCITYTRAIN_SETDITHERALPHA_OFFSET UNITYSDK_OFFSET(0x1807DED0)
#define RPG_CLIENT_MONOCITYTRAIN_SETWHEELVIEWDISTANCE_OFFSET UNITYSDK_OFFSET(0x1807C9E0)
#define RPG_CLIENT_MONOCITYTRAIN_SET_SPEED_OFFSET UNITYSDK_OFFSET(0x1807A6A0)
#define RPG_CLIENT_MONOCITYTRAIN_SHOWHARDBRAKEEFFECT_OFFSET UNITYSDK_OFFSET(0x1807CA40)
#define RPG_CLIENT_MONOCITYTRAIN_START_OFFSET UNITYSDK_OFFSET(0x1807ADD0)
#define RPG_CLIENT_MONOCITYTRAIN_STOPLOOPSOUND_OFFSET UNITYSDK_OFFSET(0x1807D020)
#define RPG_CLIENT_MONOCITYTRAIN_TRAVELTOSTATION_OFFSET UNITYSDK_OFFSET(0x1807CFD0)
#define RPG_CLIENT_MONOCITYTRAIN_UPDATE_OFFSET UNITYSDK_OFFSET(0x1807B320)
#define RPG_CLIENT_MONOCITYTRAIN__CCTOR_OFFSET UNITYSDK_OFFSET(0x1807E0A0)
#define RPG_CLIENT_MONOCITYTRAIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1807DF40)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoCityTrain_TypeDefinitionIndex = 66113;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MonoCityTrain_TypeDefinitionIndex)->GetStaticField(0xE240);
		}
		static ::System::Int32* StaticGet_Field_5_1()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MonoCityTrain_TypeDefinitionIndex)->GetStaticField(0xE244);
		}
