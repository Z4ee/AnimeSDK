...
#define RPG_CLIENT_GRIDFIGHTEQUIPCHANGEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A67D820)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightEquipChangeEvent_TypeDefinitionIndex = 61994;
