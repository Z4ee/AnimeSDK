...
#define RPG_CLIENT_ROGUEMAGICUNITDROPACTION_GETROGUEACTIONID_OFFSET UNITYSDK_OFFSET(0xC7B82B0)
#define RPG_CLIENT_ROGUEMAGICUNITDROPACTION_GETUIPATH_OFFSET UNITYSDK_OFFSET(0xC7B8340)
#define RPG_CLIENT_ROGUEMAGICUNITDROPACTION_GET_HINTID_OFFSET UNITYSDK_OFFSET(0xC7B7EB0)
#define RPG_CLIENT_ROGUEMAGICUNITDROPACTION_GET_ROGUEACTIONID_OFFSET UNITYSDK_OFFSET(0xC7B7E70)
#define RPG_CLIENT_ROGUEMAGICUNITDROPACTION_GET_SELECTUNITS_OFFSET UNITYSDK_OFFSET(0xC7B7E90)
#define RPG_CLIENT_ROGUEMAGICUNITDROPACTION_SET_HINTID_OFFSET UNITYSDK_OFFSET(0xC7B7EC0)
#define RPG_CLIENT_ROGUEMAGICUNITDROPACTION_SET_ROGUEACTIONID_OFFSET UNITYSDK_OFFSET(0xC7B7E80)
#define RPG_CLIENT_ROGUEMAGICUNITDROPACTION_SET_SELECTUNITS_OFFSET UNITYSDK_OFFSET(0xC7B7EA0)
#define RPG_CLIENT_ROGUEMAGICUNITDROPACTION_TRIGGERACTION_OFFSET UNITYSDK_OFFSET(0xC7B82F0)
#define RPG_CLIENT_ROGUEMAGICUNITDROPACTION__CONSTRUCT_OFFSET UNITYSDK_OFFSET(0xC7B7EE0)
#define RPG_CLIENT_ROGUEMAGICUNITDROPACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xC7B7ED0)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueMagicUnitDropAction_TypeDefinitionIndex = 62650;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::UInt32, ::Class_1_455008579EB95638_90*))((::PBYTE)hIl2Cpp + RPG_CLIENT_ROGUEMAGICUNITDROPACTION__CTOR_OFFSET))(this, a1, a2);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_455008579EB95638_90*))((::PBYTE)hIl2Cpp + RPG_CLIENT_ROGUEMAGICUNITDROPACTION__CONSTRUCT_OFFSET))(this, a1);
		}
	};
}
