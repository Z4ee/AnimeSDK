...
#define RPG_CLIENT_ROGUEMAGICUNITDROPACTION_GETROGUEACTIONID_OFFSET UNITYSDK_OFFSET(0x1B9D9810)
#define RPG_CLIENT_ROGUEMAGICUNITDROPACTION_GETUIPATH_OFFSET UNITYSDK_OFFSET(0x1B9D98A0)
#define RPG_CLIENT_ROGUEMAGICUNITDROPACTION_GET_HINTID_OFFSET UNITYSDK_OFFSET(0x1B9D92F0)
#define RPG_CLIENT_ROGUEMAGICUNITDROPACTION_GET_ROGUEACTIONID_OFFSET UNITYSDK_OFFSET(0x1B9D92B0)
#define RPG_CLIENT_ROGUEMAGICUNITDROPACTION_GET_SELECTUNITS_OFFSET UNITYSDK_OFFSET(0x1B9D92D0)
#define RPG_CLIENT_ROGUEMAGICUNITDROPACTION_SET_HINTID_OFFSET UNITYSDK_OFFSET(0x1B9D9300)
#define RPG_CLIENT_ROGUEMAGICUNITDROPACTION_SET_ROGUEACTIONID_OFFSET UNITYSDK_OFFSET(0x1B9D92C0)
#define RPG_CLIENT_ROGUEMAGICUNITDROPACTION_SET_SELECTUNITS_OFFSET UNITYSDK_OFFSET(0x1B9D92E0)
#define RPG_CLIENT_ROGUEMAGICUNITDROPACTION_TRIGGERACTION_OFFSET UNITYSDK_OFFSET(0x1B9D9850)
#define RPG_CLIENT_ROGUEMAGICUNITDROPACTION__CONSTRUCT_OFFSET UNITYSDK_OFFSET(0x1B9D9320)
#define RPG_CLIENT_ROGUEMAGICUNITDROPACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9D9310)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueMagicUnitDropAction_TypeDefinitionIndex = 67008;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::UInt32, ::Class_1_7FF19F6206AF6DD7_86*))((::PBYTE)hIl2Cpp + RPG_CLIENT_ROGUEMAGICUNITDROPACTION__CTOR_OFFSET))(this, a1, a2);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_7FF19F6206AF6DD7_86*))((::PBYTE)hIl2Cpp + RPG_CLIENT_ROGUEMAGICUNITDROPACTION__CONSTRUCT_OFFSET))(this, a1);
		}
	};
}
