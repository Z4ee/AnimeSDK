...
#define RPG_CLIENT_CHATPAMCONTROLLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x196336E0)
#define RPG_CLIENT_CHATPAMCONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0x19633620)
#define RPG_CLIENT_CHATPAMCONTROLLER_LOADPAM_OFFSET UNITYSDK_OFFSET(0x19633940)
#define RPG_CLIENT_CHATPAMCONTROLLER_SETPAMSKIN_OFFSET UNITYSDK_OFFSET(0x19633E10)
#define RPG_CLIENT_CHATPAMCONTROLLER_STOPFREESTYLE_OFFSET UNITYSDK_OFFSET(0x19633D30)
#define RPG_CLIENT_CHATPAMCONTROLLER_UNLOADPAM_OFFSET UNITYSDK_OFFSET(0x196337C0)
#define RPG_CLIENT_CHATPAMCONTROLLER__CHANGEPAMSKIN_OFFSET UNITYSDK_OFFSET(0x19633E80)
#define RPG_CLIENT_CHATPAMCONTROLLER__CREATEPAMENTITY_OFFSET UNITYSDK_OFFSET(0x19633A00)
#define RPG_CLIENT_CHATPAMCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19634370)
#define RPG_CLIENT_CHATPAMCONTROLLER__GETMANIKINJSONPATH_OFFSET UNITYSDK_OFFSET(0x19633F50)
#define RPG_CLIENT_CHATPAMCONTROLLER__ONENTITYLOADFINISH_OFFSET UNITYSDK_OFFSET(0x19634110)
#define RPG_CLIENT_CHATPAMCONTROLLER__ONPAMCHATFREESTYLEEVENT_OFFSET UNITYSDK_OFFSET(0x19634020)
#define RPG_CLIENT_CHATPAMCONTROLLER__ONPOSSESSIONLOADED_OFFSET UNITYSDK_OFFSET(0x196340B0)
#define RPG_CLIENT_CHATPAMCONTROLLER__PLAYEFFECT_OFFSET UNITYSDK_OFFSET(0x19634290)

namespace RPG::Client
{
	inline static constexpr unsigned int ChatPamController_TypeDefinitionIndex = 69191;
