...
#define RPG_CLIENT_CHATPAMCONTROLLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB5A0E60)
#define RPG_CLIENT_CHATPAMCONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0xB5A0DA0)
#define RPG_CLIENT_CHATPAMCONTROLLER_LOADPAM_OFFSET UNITYSDK_OFFSET(0xB5A10C0)
#define RPG_CLIENT_CHATPAMCONTROLLER_SETPAMSKIN_OFFSET UNITYSDK_OFFSET(0xB5A16D0)
#define RPG_CLIENT_CHATPAMCONTROLLER_STOPFREESTYLE_OFFSET UNITYSDK_OFFSET(0xB5A1560)
#define RPG_CLIENT_CHATPAMCONTROLLER_UNLOADPAM_OFFSET UNITYSDK_OFFSET(0xB5A0F40)
#define RPG_CLIENT_CHATPAMCONTROLLER__CHANGEPAMSKIN_OFFSET UNITYSDK_OFFSET(0xB5A1740)
#define RPG_CLIENT_CHATPAMCONTROLLER__CREATEPAMENTITY_OFFSET UNITYSDK_OFFSET(0xB5A11D0)
#define RPG_CLIENT_CHATPAMCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB5A1C90)
#define RPG_CLIENT_CHATPAMCONTROLLER__GETMANIKINJSONPATH_OFFSET UNITYSDK_OFFSET(0xB5A1880)
#define RPG_CLIENT_CHATPAMCONTROLLER__ONENTITYLOADFINISH_OFFSET UNITYSDK_OFFSET(0xB5A1A40)
#define RPG_CLIENT_CHATPAMCONTROLLER__ONPAMCHATFREESTYLEEVENT_OFFSET UNITYSDK_OFFSET(0xB5A1950)
#define RPG_CLIENT_CHATPAMCONTROLLER__ONPOSSESSIONLOADED_OFFSET UNITYSDK_OFFSET(0xB5A19E0)
#define RPG_CLIENT_CHATPAMCONTROLLER__PLAYEFFECT_OFFSET UNITYSDK_OFFSET(0xB5A1BB0)

namespace RPG::Client
{
	inline static constexpr unsigned int ChatPamController_TypeDefinitionIndex = 67707;
