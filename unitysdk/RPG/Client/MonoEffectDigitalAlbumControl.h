...
#define RPG_CLIENT_MONOEFFECTDIGITALALBUMCONTROL_METHOD_5_96563D36EE253EE2_OFFSET UNITYSDK_OFFSET(0xC089F70)
#define RPG_CLIENT_MONOEFFECTDIGITALALBUMCONTROL_METHOD_5_9A4DCB2B4ADEB8A9_OFFSET UNITYSDK_OFFSET(0xC08A940)
#define RPG_CLIENT_MONOEFFECTDIGITALALBUMCONTROL_METHOD_5_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0xC08A610)
#define RPG_CLIENT_MONOEFFECTDIGITALALBUMCONTROL_METHOD_5_ED65AE7582736594_OFFSET UNITYSDK_OFFSET(0xC08A990)
#define RPG_CLIENT_MONOEFFECTDIGITALALBUMCONTROL_METHOD_5_F70DC5473DF715AD_OFFSET UNITYSDK_OFFSET(0xC08A050)
#define RPG_CLIENT_MONOEFFECTDIGITALALBUMCONTROL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC089F20)
#define RPG_CLIENT_MONOEFFECTDIGITALALBUMCONTROL_ONENABLE_OFFSET UNITYSDK_OFFSET(0xC089E90)
#define RPG_CLIENT_MONOEFFECTDIGITALALBUMCONTROL_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0xC08A000)
#define RPG_CLIENT_MONOEFFECTDIGITALALBUMCONTROL_START_OFFSET UNITYSDK_OFFSET(0xC089D40)
#define RPG_CLIENT_MONOEFFECTDIGITALALBUMCONTROL_UPDATE_OFFSET UNITYSDK_OFFSET(0xC08A740)
#define RPG_CLIENT_MONOEFFECTDIGITALALBUMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC08AD00)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectDigitalAlbumControl_TypeDefinitionIndex = 66149;
