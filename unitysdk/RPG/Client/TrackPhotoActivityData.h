...
#define RPG_CLIENT_TRACKPHOTOACTIVITYDATA_ISSHOWDAILYGOTOREDDOT_OFFSET UNITYSDK_OFFSET(0x178AD5C0)
#define RPG_CLIENT_TRACKPHOTOACTIVITYDATA_ISSHOWMAPPINGINFONEWCONTENTREDDOT_OFFSET UNITYSDK_OFFSET(0x178AD720)
#define RPG_CLIENT_TRACKPHOTOACTIVITYDATA_ISSHOWMAPPINGINFOREWARDREDDOT_OFFSET UNITYSDK_OFFSET(0x178AD630)
#define RPG_CLIENT_TRACKPHOTOACTIVITYDATA_ISSHOWNORMALREDDOT_OFFSET UNITYSDK_OFFSET(0x178AD440)
#define RPG_CLIENT_TRACKPHOTOACTIVITYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x178AD430)

namespace RPG::Client
{
	inline static constexpr unsigned int TrackPhotoActivityData_TypeDefinitionIndex = 58926;
