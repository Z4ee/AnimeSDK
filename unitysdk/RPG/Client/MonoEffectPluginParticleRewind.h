...
#define RPG_CLIENT_MONOEFFECTPLUGINPARTICLEREWIND_AWAKEPLUGIN_OFFSET UNITYSDK_OFFSET(0x19133EF0)
#define RPG_CLIENT_MONOEFFECTPLUGINPARTICLEREWIND_DISPOSEPLUGIN_OFFSET UNITYSDK_OFFSET(0x191344C0)
#define RPG_CLIENT_MONOEFFECTPLUGINPARTICLEREWIND_IGNOREINEDITOR_OFFSET UNITYSDK_OFFSET(0x19133EB0)
#define RPG_CLIENT_MONOEFFECTPLUGINPARTICLEREWIND_METHOD_6_08DCF72FBE01FF99_OFFSET UNITYSDK_OFFSET(0x191343B0)
#define RPG_CLIENT_MONOEFFECTPLUGINPARTICLEREWIND_METHOD_6_137034D6EE7EADFD_OFFSET UNITYSDK_OFFSET(0x191349B0)
#define RPG_CLIENT_MONOEFFECTPLUGINPARTICLEREWIND_METHOD_6_6A0EBEECA245A27C_OFFSET UNITYSDK_OFFSET(0x19133F90)
#define RPG_CLIENT_MONOEFFECTPLUGINPARTICLEREWIND_METHOD_6_C72B925A491E9859_OFFSET UNITYSDK_OFFSET(0x19134AF0)
#define RPG_CLIENT_MONOEFFECTPLUGINPARTICLEREWIND_RESETPLUGIN_OFFSET UNITYSDK_OFFSET(0x19133F30)
#define RPG_CLIENT_MONOEFFECTPLUGINPARTICLEREWIND_TICK_OFFSET UNITYSDK_OFFSET(0x19134500)
#define RPG_CLIENT_MONOEFFECTPLUGINPARTICLEREWIND__CTOR_OFFSET UNITYSDK_OFFSET(0x19134C60)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginParticleRewind_TypeDefinitionIndex = 66951;
