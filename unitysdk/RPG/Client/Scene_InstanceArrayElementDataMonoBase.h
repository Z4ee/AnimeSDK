...
#define RPG_CLIENT_SCENE_INSTANCEARRAYELEMENTDATAMONOBASE_GETDEFORMDATA_OFFSET UNITYSDK_OFFSET(0xE05F0E0)
#define RPG_CLIENT_SCENE_INSTANCEARRAYELEMENTDATAMONOBASE_GETLINEARDEFORMDATA_OFFSET UNITYSDK_OFFSET(0xE05F170)
#define RPG_CLIENT_SCENE_INSTANCEARRAYELEMENTDATAMONOBASE_METHOD_6_A3FAE12D7B6ACD62_1_OFFSET UNITYSDK_OFFSET(0xE062A60)
#define RPG_CLIENT_SCENE_INSTANCEARRAYELEMENTDATAMONOBASE_METHOD_6_A3FAE12D7B6ACD62_2_OFFSET UNITYSDK_OFFSET(0xE062B10)
#define RPG_CLIENT_SCENE_INSTANCEARRAYELEMENTDATAMONOBASE_METHOD_6_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0xE0629B0)
#define RPG_CLIENT_SCENE_INSTANCEARRAYELEMENTDATAMONOBASE_METHOD_6_ADC07F7C5F028A97_OFFSET UNITYSDK_OFFSET(0xE062920)
#define RPG_CLIENT_SCENE_INSTANCEARRAYELEMENTDATAMONOBASE_SETDEFORMDATA_OFFSET UNITYSDK_OFFSET(0xE062BC0)
#define RPG_CLIENT_SCENE_INSTANCEARRAYELEMENTDATAMONOBASE_SETLINEARDEFORMDATA_OFFSET UNITYSDK_OFFSET(0xE062C60)
#define RPG_CLIENT_SCENE_INSTANCEARRAYELEMENTDATAMONOBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xE062D50)
