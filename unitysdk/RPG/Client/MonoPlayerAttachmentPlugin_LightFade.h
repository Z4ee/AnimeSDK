...
#define RPG_CLIENT_MONOPLAYERATTACHMENTPLUGIN_LIGHTFADE_AWAKE_OFFSET UNITYSDK_OFFSET(0x18C6B330)
#define RPG_CLIENT_MONOPLAYERATTACHMENTPLUGIN_LIGHTFADE_GET_ISTICKABLE_OFFSET UNITYSDK_OFFSET(0x18C6AED0)
#define RPG_CLIENT_MONOPLAYERATTACHMENTPLUGIN_LIGHTFADE_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x18C6B2A0)
#define RPG_CLIENT_MONOPLAYERATTACHMENTPLUGIN_LIGHTFADE_METHOD_5_627C7524E98F4AC5_OFFSET UNITYSDK_OFFSET(0x18C6B2B0)
#define RPG_CLIENT_MONOPLAYERATTACHMENTPLUGIN_LIGHTFADE_ONALLOC_OFFSET UNITYSDK_OFFSET(0x18C6AB80)
#define RPG_CLIENT_MONOPLAYERATTACHMENTPLUGIN_LIGHTFADE_ONRELEASE_OFFSET UNITYSDK_OFFSET(0x18C6AD30)
#define RPG_CLIENT_MONOPLAYERATTACHMENTPLUGIN_LIGHTFADE_ONTICK_OFFSET UNITYSDK_OFFSET(0x18C6AEE0)
#define RPG_CLIENT_MONOPLAYERATTACHMENTPLUGIN_LIGHTFADE__CTOR_OFFSET UNITYSDK_OFFSET(0x18C6B3A0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoPlayerAttachmentPlugin_LightFade_TypeDefinitionIndex = 57465;
