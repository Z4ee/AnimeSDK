...
#define RPG_CLIENT_MONOPLAYERATTACHMENTPLUGIN_LIGHTFADE_AWAKE_OFFSET UNITYSDK_OFFSET(0xA9EAE10)
#define RPG_CLIENT_MONOPLAYERATTACHMENTPLUGIN_LIGHTFADE_GET_ISTICKABLE_OFFSET UNITYSDK_OFFSET(0xA9EAA20)
#define RPG_CLIENT_MONOPLAYERATTACHMENTPLUGIN_LIGHTFADE_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xA9EAD80)
#define RPG_CLIENT_MONOPLAYERATTACHMENTPLUGIN_LIGHTFADE_METHOD_5_627C7524E98F4AC5_OFFSET UNITYSDK_OFFSET(0xA9EAD90)
#define RPG_CLIENT_MONOPLAYERATTACHMENTPLUGIN_LIGHTFADE_ONALLOC_OFFSET UNITYSDK_OFFSET(0xA9EA6B0)
#define RPG_CLIENT_MONOPLAYERATTACHMENTPLUGIN_LIGHTFADE_ONRELEASE_OFFSET UNITYSDK_OFFSET(0xA9EA870)
#define RPG_CLIENT_MONOPLAYERATTACHMENTPLUGIN_LIGHTFADE_ONTICK_OFFSET UNITYSDK_OFFSET(0xA9EAA30)
#define RPG_CLIENT_MONOPLAYERATTACHMENTPLUGIN_LIGHTFADE__CTOR_OFFSET UNITYSDK_OFFSET(0xA9EAE80)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoPlayerAttachmentPlugin_LightFade_TypeDefinitionIndex = 55475;
