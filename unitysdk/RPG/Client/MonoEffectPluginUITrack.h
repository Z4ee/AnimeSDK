...
#define RPG_CLIENT_MONOEFFECTPLUGINUITRACK_AWAKEPLUGIN_OFFSET UNITYSDK_OFFSET(0xC0F21D0)
#define RPG_CLIENT_MONOEFFECTPLUGINUITRACK_DESTROYPLUGIN_OFFSET UNITYSDK_OFFSET(0xC0F22B0)
#define RPG_CLIENT_MONOEFFECTPLUGINUITRACK_DISPOSEPLUGIN_OFFSET UNITYSDK_OFFSET(0xC0F2140)
#define RPG_CLIENT_MONOEFFECTPLUGINUITRACK_ENDOFLATETICK_OFFSET UNITYSDK_OFFSET(0xC0F2340)
#define RPG_CLIENT_MONOEFFECTPLUGINUITRACK_GET_BEHAVIOR_OFFSET UNITYSDK_OFFSET(0xC0F23B0)
#define RPG_CLIENT_MONOEFFECTPLUGINUITRACK_RESETPLUGIN_OFFSET UNITYSDK_OFFSET(0xC0F20A0)
#define RPG_CLIENT_MONOEFFECTPLUGINUITRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xC0F23C0)
#define RPG_CLIENT_MONOEFFECTPLUGINUITRACK___IFIXBASEPROXY_AWAKEPLUGIN_OFFSET UNITYSDK_OFFSET(0xC0F2460)
#define RPG_CLIENT_MONOEFFECTPLUGINUITRACK___IFIXBASEPROXY_DESTROYPLUGIN_OFFSET UNITYSDK_OFFSET(0xC0F24C0)
#define RPG_CLIENT_MONOEFFECTPLUGINUITRACK___IFIXBASEPROXY_ENDOFLATETICK_OFFSET UNITYSDK_OFFSET(0xC0F2520)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginUITrack_TypeDefinitionIndex = 65574;
	...
	public:
		...
		::Class_2_327EB1EE78A95630* Field_6_5; // 0x48
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + RPG_CLIENT_MONOEFFECTPLUGINUITRACK___IFIXBASEPROXY_ENDOFLATETICK_OFFSET))(this, a1);
		}
	};
}
