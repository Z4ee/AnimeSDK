...
#define RPG_CLIENT_MONOEFFECTPLUGINPERFORMEVENTLISTENER_AWAKEPLUGIN_OFFSET UNITYSDK_OFFSET(0x19134C70)
#define RPG_CLIENT_MONOEFFECTPLUGINPERFORMEVENTLISTENER_DESTROYPLUGIN_OFFSET UNITYSDK_OFFSET(0x19134D50)
#define RPG_CLIENT_MONOEFFECTPLUGINPERFORMEVENTLISTENER_DISPOSEPLUGIN_OFFSET UNITYSDK_OFFSET(0x19134E80)
#define RPG_CLIENT_MONOEFFECTPLUGINPERFORMEVENTLISTENER_RESETPLUGIN_OFFSET UNITYSDK_OFFSET(0x19134E20)
#define RPG_CLIENT_MONOEFFECTPLUGINPERFORMEVENTLISTENER_TICK_OFFSET UNITYSDK_OFFSET(0x19134ED0)
#define RPG_CLIENT_MONOEFFECTPLUGINPERFORMEVENTLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x19134F40)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginPerformEventListener_TypeDefinitionIndex = 66955;
