...
#define RPG_CLIENT_MONOEFFECTPLUGINPERFORMEVENTLISTENER_AWAKEPLUGIN_OFFSET UNITYSDK_OFFSET(0x9CD7E20)
#define RPG_CLIENT_MONOEFFECTPLUGINPERFORMEVENTLISTENER_DESTROYPLUGIN_OFFSET UNITYSDK_OFFSET(0x9CD7F00)
#define RPG_CLIENT_MONOEFFECTPLUGINPERFORMEVENTLISTENER_DISPOSEPLUGIN_OFFSET UNITYSDK_OFFSET(0x9CD8030)
#define RPG_CLIENT_MONOEFFECTPLUGINPERFORMEVENTLISTENER_RESETPLUGIN_OFFSET UNITYSDK_OFFSET(0x9CD7FD0)
#define RPG_CLIENT_MONOEFFECTPLUGINPERFORMEVENTLISTENER_TICK_OFFSET UNITYSDK_OFFSET(0x9CD8080)
#define RPG_CLIENT_MONOEFFECTPLUGINPERFORMEVENTLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x9CD80F0)
#define RPG_CLIENT_MONOEFFECTPLUGINPERFORMEVENTLISTENER___IFIXBASEPROXY_AWAKEPLUGIN_OFFSET UNITYSDK_OFFSET(0x9CD8100)
#define RPG_CLIENT_MONOEFFECTPLUGINPERFORMEVENTLISTENER___IFIXBASEPROXY_DESTROYPLUGIN_OFFSET UNITYSDK_OFFSET(0x9CD8160)
#define RPG_CLIENT_MONOEFFECTPLUGINPERFORMEVENTLISTENER___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x9CD81C0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginPerformEventListener_TypeDefinitionIndex = 57358;
