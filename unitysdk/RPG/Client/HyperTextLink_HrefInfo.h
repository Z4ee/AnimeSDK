...
#define RPG_CLIENT_HYPERTEXTLINK_HREFINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xBD20360)

namespace RPG::Client
{
	inline static constexpr unsigned int HyperTextLink_HrefInfo_TypeDefinitionIndex = 67782;
