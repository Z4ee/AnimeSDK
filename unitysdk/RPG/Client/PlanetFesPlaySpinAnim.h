...
#define RPG_CLIENT_PLANETFESPLAYSPINANIM_METHOD_3_8C9A31F9B5800A33_OFFSET UNITYSDK_OFFSET(0x16E8BA50)
#define RPG_CLIENT_PLANETFESPLAYSPINANIM_METHOD_3_9492EA95D6901E22_OFFSET UNITYSDK_OFFSET(0x16E8BAD0)
#define RPG_CLIENT_PLANETFESPLAYSPINANIM__CTOR_OFFSET UNITYSDK_OFFSET(0x16E8BAA0)

namespace RPG::Client
{
	inline static constexpr unsigned int PlanetFesPlaySpinAnim_TypeDefinitionIndex = 9975;
