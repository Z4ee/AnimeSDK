...
#define RPG_CLIENT_FALLINGOBJECTTEMPLATE_CLASS_1_BB32A9E6F97FB4FE__CTOR_OFFSET UNITYSDK_OFFSET(0xCF13EC0)
...
namespace RPG::Client
{
	...
	{
	public:
		::UnityEngine::Mesh* HLMADHIMMMC; // 0x10
		::UnityEngine::Material* PPPHAPMOPLF; // 0x18
