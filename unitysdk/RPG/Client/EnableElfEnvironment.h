...
#define RPG_CLIENT_ENABLEELFENVIRONMENT_METHOD_3_D49CF3245DD693F8_OFFSET UNITYSDK_OFFSET(0x16E84B80)
#define RPG_CLIENT_ENABLEELFENVIRONMENT_METHOD_3_E768B99BEA3AA751_OFFSET UNITYSDK_OFFSET(0x16E84C00)
#define RPG_CLIENT_ENABLEELFENVIRONMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x16E84BD0)

namespace RPG::Client
{
	inline static constexpr unsigned int EnableElfEnvironment_TypeDefinitionIndex = 9933;
