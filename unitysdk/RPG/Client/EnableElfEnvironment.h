...
#define RPG_CLIENT_ENABLEELFENVIRONMENT_METHOD_3_1B347327C9B4FD2A_OFFSET UNITYSDK_OFFSET(0x1D308EE0)
#define RPG_CLIENT_ENABLEELFENVIRONMENT_METHOD_3_E768B99BEA3AA751_OFFSET UNITYSDK_OFFSET(0x1D308F20)
#define RPG_CLIENT_ENABLEELFENVIRONMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D308F10)

namespace RPG::Client
{
	inline static constexpr unsigned int EnableElfEnvironment_TypeDefinitionIndex = 10200;
