...
#define RPG_CLIENT_GRIDFIGHTTRAITREMARKLINESTATEPARSERFACTORY_CREATEPARSER_OFFSET UNITYSDK_OFFSET(0xA5BD5A0)
#define RPG_CLIENT_GRIDFIGHTTRAITREMARKLINESTATEPARSERFACTORY__CCTOR_OFFSET UNITYSDK_OFFSET(0xA5BECC0)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightTraitRemarkLineStateParserFactory_TypeDefinitionIndex = 60293;
