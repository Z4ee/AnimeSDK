...
#define RPG_CLIENT_COMPONENTASSETLOADER_CLASS_2_F00699C7B50A73DF_METHOD_2_1B5623B3CB8D63BF_OFFSET UNITYSDK_OFFSET(0x1A2899F0)
#define RPG_CLIENT_COMPONENTASSETLOADER_CLASS_2_F00699C7B50A73DF_METHOD_2_908668BEC77D9726_OFFSET UNITYSDK_OFFSET(0x1A289920)
#define RPG_CLIENT_COMPONENTASSETLOADER_CLASS_2_F00699C7B50A73DF_METHOD_2_C8553AEB07BE1FEF_OFFSET UNITYSDK_OFFSET(0x1A2898C0)
#define RPG_CLIENT_COMPONENTASSETLOADER_CLASS_2_F00699C7B50A73DF_METHOD_2_E97DD0112E31A642_OFFSET UNITYSDK_OFFSET(0x1A289770)
#define RPG_CLIENT_COMPONENTASSETLOADER_CLASS_2_F00699C7B50A73DF__CTOR_OFFSET UNITYSDK_OFFSET(0x1A289580)

namespace RPG::Client
{
	inline static constexpr unsigned int ComponentAssetLoader_Class_2_F00699C7B50A73DF_TypeDefinitionIndex = 68363;
