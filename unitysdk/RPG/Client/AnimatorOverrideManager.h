...
#define RPG_CLIENT_ANIMATOROVERRIDEMANAGER_BEGINBATCHANIMCLIPOVERRIDE_OFFSET UNITYSDK_OFFSET(0xB315ED0)
#define RPG_CLIENT_ANIMATOROVERRIDEMANAGER_CLEANUPOVERRIDE_OFFSET UNITYSDK_OFFSET(0xB314CA0)
#define RPG_CLIENT_ANIMATOROVERRIDEMANAGER_ENDBATCHANIMCLIPOVERRIDE_OFFSET UNITYSDK_OFFSET(0xB315F50)
#define RPG_CLIENT_ANIMATOROVERRIDEMANAGER_ISINBATCHANIMCLIPOVERRIDE_OFFSET UNITYSDK_OFFSET(0xB315E80)
#define RPG_CLIENT_ANIMATOROVERRIDEMANAGER_METHOD_5_9216B801ACD0B564_OFFSET UNITYSDK_OFFSET(0xB315180)
#define RPG_CLIENT_ANIMATOROVERRIDEMANAGER_METHOD_5_97D83E4CB3B11935_OFFSET UNITYSDK_OFFSET(0xB315FD0)
#define RPG_CLIENT_ANIMATOROVERRIDEMANAGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB314C50)
#define RPG_CLIENT_ANIMATOROVERRIDEMANAGER_SETANIMCLIPOVERRIDE_OFFSET UNITYSDK_OFFSET(0xB315A20)
#define RPG_CLIENT_ANIMATOROVERRIDEMANAGER_SETREPLACEANIMATORCONTROLLER_OFFSET UNITYSDK_OFFSET(0xB314E50)
#define RPG_CLIENT_ANIMATOROVERRIDEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xB3160F0)

namespace RPG::Client
{
	inline static constexpr unsigned int AnimatorOverrideManager_TypeDefinitionIndex = 63939;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_ANIMATOROVERRIDEMANAGER_METHOD_5_9216B801ACD0B564_OFFSET))(this);
		}
	};
}
