...
#define RPG_CLIENT_ROGUETOURNGAMEDIVISIONSETTLERESULT_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0xA38FD80)
#define RPG_CLIENT_ROGUETOURNGAMEDIVISIONSETTLERESULT_GET_PROGRESS_OFFSET UNITYSDK_OFFSET(0xA38FDA0)
#define RPG_CLIENT_ROGUETOURNGAMEDIVISIONSETTLERESULT_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0xA38FD90)
#define RPG_CLIENT_ROGUETOURNGAMEDIVISIONSETTLERESULT_SET_PROGRESS_OFFSET UNITYSDK_OFFSET(0xA38FDB0)
#define RPG_CLIENT_ROGUETOURNGAMEDIVISIONSETTLERESULT__CTOR_OFFSET UNITYSDK_OFFSET(0xA38FD70)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueTournGameDivisionSettleResult_TypeDefinitionIndex = 55343;
