...
#define RPG_CLIENT_ROGUETOURNGAMEDIVISIONSETTLERESULT_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x19C27F70)
#define RPG_CLIENT_ROGUETOURNGAMEDIVISIONSETTLERESULT_GET_PROGRESS_OFFSET UNITYSDK_OFFSET(0x19C27F90)
#define RPG_CLIENT_ROGUETOURNGAMEDIVISIONSETTLERESULT_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0x19C27F80)
#define RPG_CLIENT_ROGUETOURNGAMEDIVISIONSETTLERESULT_SET_PROGRESS_OFFSET UNITYSDK_OFFSET(0x19C27FA0)
#define RPG_CLIENT_ROGUETOURNGAMEDIVISIONSETTLERESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x19C27F60)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueTournGameDivisionSettleResult_TypeDefinitionIndex = 64834;
