...
#define RPG_CLIENT_GRIDFIGHTGAMEREFTEAM___C__DISPLAYCLASS60_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABFDF70)
#define RPG_CLIENT_GRIDFIGHTGAMEREFTEAM___C__DISPLAYCLASS60_0__GETROLESBYTRAIT_B__0_OFFSET UNITYSDK_OFFSET(0x1ABFF0A0)
#define RPG_CLIENT_GRIDFIGHTGAMEREFTEAM___C__DISPLAYCLASS60_0__GETROLESBYTRAIT_B__2_OFFSET UNITYSDK_OFFSET(0x1ABFF140)
#define RPG_CLIENT_GRIDFIGHTGAMEREFTEAM___C__DISPLAYCLASS60_0__GETROLESBYTRAIT_B__3_OFFSET UNITYSDK_OFFSET(0x1ABFF210)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightGameRefTeam___c__DisplayClass60_0_TypeDefinitionIndex = 61888;
