...
#define RPG_CLIENT_PHOTOEXHIBITIONACTIVITYPANELDATA_GET__MODULE_OFFSET UNITYSDK_OFFSET(0x18663B80)
#define RPG_CLIENT_PHOTOEXHIBITIONACTIVITYPANELDATA_ISSHOWDAILYREDDOT_OFFSET UNITYSDK_OFFSET(0x18663A90)
#define RPG_CLIENT_PHOTOEXHIBITIONACTIVITYPANELDATA_ISSHOWGOTOBTNREDDOT_OFFSET UNITYSDK_OFFSET(0x186638F0)
#define RPG_CLIENT_PHOTOEXHIBITIONACTIVITYPANELDATA_ISSHOWNORMALREDDOT_OFFSET UNITYSDK_OFFSET(0x18663890)
#define RPG_CLIENT_PHOTOEXHIBITIONACTIVITYPANELDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18663880)
