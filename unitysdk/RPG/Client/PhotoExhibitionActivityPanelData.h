...
#define RPG_CLIENT_PHOTOEXHIBITIONACTIVITYPANELDATA_GET__MODULE_OFFSET UNITYSDK_OFFSET(0x17F517B0)
#define RPG_CLIENT_PHOTOEXHIBITIONACTIVITYPANELDATA_ISSHOWDAILYREDDOT_OFFSET UNITYSDK_OFFSET(0x17F516C0)
#define RPG_CLIENT_PHOTOEXHIBITIONACTIVITYPANELDATA_ISSHOWGOTOBTNREDDOT_OFFSET UNITYSDK_OFFSET(0x17F51520)
#define RPG_CLIENT_PHOTOEXHIBITIONACTIVITYPANELDATA_ISSHOWNORMALREDDOT_OFFSET UNITYSDK_OFFSET(0x17F514C0)
#define RPG_CLIENT_PHOTOEXHIBITIONACTIVITYPANELDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17F514B0)

namespace RPG::Client
{
	inline static constexpr unsigned int PhotoExhibitionActivityPanelData_TypeDefinitionIndex = 58965;
