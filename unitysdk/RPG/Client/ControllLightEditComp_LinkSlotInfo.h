...
#define RPG_CLIENT_CONTROLLLIGHTEDITCOMP_LINKSLOTINFO_GET_HOSTOBJECTNAME_OFFSET UNITYSDK_OFFSET(0xB7126D0)
#define RPG_CLIENT_CONTROLLLIGHTEDITCOMP_LINKSLOTINFO_GET_HOSTOBJECT_OFFSET UNITYSDK_OFFSET(0xB712730)
#define RPG_CLIENT_CONTROLLLIGHTEDITCOMP_LINKSLOTINFO_GET_LIGHTINDEX_OFFSET UNITYSDK_OFFSET(0xB712710)
#define RPG_CLIENT_CONTROLLLIGHTEDITCOMP_LINKSLOTINFO_GET_LINKSLOTTYPE_OFFSET UNITYSDK_OFFSET(0xB7126F0)
#define RPG_CLIENT_CONTROLLLIGHTEDITCOMP_LINKSLOTINFO_GET_LINKSLOT_OFFSET UNITYSDK_OFFSET(0xB712750)
#define RPG_CLIENT_CONTROLLLIGHTEDITCOMP_LINKSLOTINFO_GET_OWNERCOMPONENT_OFFSET UNITYSDK_OFFSET(0xB712770)
#define RPG_CLIENT_CONTROLLLIGHTEDITCOMP_LINKSLOTINFO_SET_HOSTOBJECTNAME_OFFSET UNITYSDK_OFFSET(0xB7126E0)
#define RPG_CLIENT_CONTROLLLIGHTEDITCOMP_LINKSLOTINFO_SET_HOSTOBJECT_OFFSET UNITYSDK_OFFSET(0xB712740)
#define RPG_CLIENT_CONTROLLLIGHTEDITCOMP_LINKSLOTINFO_SET_LIGHTINDEX_OFFSET UNITYSDK_OFFSET(0xB712720)
#define RPG_CLIENT_CONTROLLLIGHTEDITCOMP_LINKSLOTINFO_SET_LINKSLOTTYPE_OFFSET UNITYSDK_OFFSET(0xB712700)
#define RPG_CLIENT_CONTROLLLIGHTEDITCOMP_LINKSLOTINFO_SET_LINKSLOT_OFFSET UNITYSDK_OFFSET(0xB712760)
#define RPG_CLIENT_CONTROLLLIGHTEDITCOMP_LINKSLOTINFO_SET_OWNERCOMPONENT_OFFSET UNITYSDK_OFFSET(0xB712780)
#define RPG_CLIENT_CONTROLLLIGHTEDITCOMP_LINKSLOTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xB712790)

namespace RPG::Client
{
	inline static constexpr unsigned int ControllLightEditComp_LinkSlotInfo_TypeDefinitionIndex = 65624;
