...
#define RPG_CLIENT_CONTROLLLIGHTEDITCOMP_LINKSLOTINFO_GET_HOSTOBJECTNAME_OFFSET UNITYSDK_OFFSET(0xCC72CB0)
#define RPG_CLIENT_CONTROLLLIGHTEDITCOMP_LINKSLOTINFO_GET_HOSTOBJECT_OFFSET UNITYSDK_OFFSET(0xCC72D10)
#define RPG_CLIENT_CONTROLLLIGHTEDITCOMP_LINKSLOTINFO_GET_LIGHTINDEX_OFFSET UNITYSDK_OFFSET(0xCC72CF0)
#define RPG_CLIENT_CONTROLLLIGHTEDITCOMP_LINKSLOTINFO_GET_LINKSLOTTYPE_OFFSET UNITYSDK_OFFSET(0xCC72CD0)
#define RPG_CLIENT_CONTROLLLIGHTEDITCOMP_LINKSLOTINFO_GET_LINKSLOT_OFFSET UNITYSDK_OFFSET(0xCC72D30)
#define RPG_CLIENT_CONTROLLLIGHTEDITCOMP_LINKSLOTINFO_GET_OWNERCOMPONENT_OFFSET UNITYSDK_OFFSET(0xCC72D50)
#define RPG_CLIENT_CONTROLLLIGHTEDITCOMP_LINKSLOTINFO_SET_HOSTOBJECTNAME_OFFSET UNITYSDK_OFFSET(0xCC72CC0)
#define RPG_CLIENT_CONTROLLLIGHTEDITCOMP_LINKSLOTINFO_SET_HOSTOBJECT_OFFSET UNITYSDK_OFFSET(0xCC72D20)
#define RPG_CLIENT_CONTROLLLIGHTEDITCOMP_LINKSLOTINFO_SET_LIGHTINDEX_OFFSET UNITYSDK_OFFSET(0xCC72D00)
#define RPG_CLIENT_CONTROLLLIGHTEDITCOMP_LINKSLOTINFO_SET_LINKSLOTTYPE_OFFSET UNITYSDK_OFFSET(0xCC72CE0)
#define RPG_CLIENT_CONTROLLLIGHTEDITCOMP_LINKSLOTINFO_SET_LINKSLOT_OFFSET UNITYSDK_OFFSET(0xCC72D40)
#define RPG_CLIENT_CONTROLLLIGHTEDITCOMP_LINKSLOTINFO_SET_OWNERCOMPONENT_OFFSET UNITYSDK_OFFSET(0xCC72D60)
#define RPG_CLIENT_CONTROLLLIGHTEDITCOMP_LINKSLOTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xCC72D70)
