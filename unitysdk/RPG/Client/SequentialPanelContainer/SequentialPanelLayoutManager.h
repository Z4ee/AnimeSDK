...
#define RPG_CLIENT_SEQUENTIALPANELCONTAINER_SEQUENTIALPANELLAYOUTMANAGER_UPDATELAYOUT_OFFSET UNITYSDK_OFFSET(0xC8B2960)
#define RPG_CLIENT_SEQUENTIALPANELCONTAINER_SEQUENTIALPANELLAYOUTMANAGER__ADJUSTPANELSTOSCREENBOUNDS_OFFSET UNITYSDK_OFFSET(0xC8B3C40)
#define RPG_CLIENT_SEQUENTIALPANELCONTAINER_SEQUENTIALPANELLAYOUTMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xC8B32E0)
#define RPG_CLIENT_SEQUENTIALPANELCONTAINER_SEQUENTIALPANELLAYOUTMANAGER__GETSCREENBOUNDS_OFFSET UNITYSDK_OFFSET(0xC8B43B0)
#define RPG_CLIENT_SEQUENTIALPANELCONTAINER_SEQUENTIALPANELLAYOUTMANAGER__GETSCREENRECT_OFFSET UNITYSDK_OFFSET(0xC8B41E0)
#define RPG_CLIENT_SEQUENTIALPANELCONTAINER_SEQUENTIALPANELLAYOUTMANAGER__GETUISCALEFACTOR_OFFSET UNITYSDK_OFFSET(0xC8B45F0)

namespace RPG::Client::SequentialPanelContainer
{
	inline static constexpr unsigned int SequentialPanelLayoutManager_TypeDefinitionIndex = 69784;
	...
	public:
		...
		::System::Collections::Generic::Dictionary_2<::RPG::Client::SequentialPanelContainer::AlignmentType, ::Class_0_16E4307DCC419505_1123*>* _Strategies; // 0x10
