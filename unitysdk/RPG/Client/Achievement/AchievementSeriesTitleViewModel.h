...
#define RPG_CLIENT_ACHIEVEMENT_ACHIEVEMENTSERIESTITLEVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0x1ABB6390)
#define RPG_CLIENT_ACHIEVEMENT_ACHIEVEMENTSERIESTITLEVIEWMODEL_GET_TITLE_OFFSET UNITYSDK_OFFSET(0x1ABB6470)
#define RPG_CLIENT_ACHIEVEMENT_ACHIEVEMENTSERIESTITLEVIEWMODEL_GET_VIEWINDEX_OFFSET UNITYSDK_OFFSET(0x1ABB6430)
#define RPG_CLIENT_ACHIEVEMENT_ACHIEVEMENTSERIESTITLEVIEWMODEL_SET_TITLE_OFFSET UNITYSDK_OFFSET(0x1ABB6480)
#define RPG_CLIENT_ACHIEVEMENT_ACHIEVEMENTSERIESTITLEVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABB6420)

namespace RPG::Client::Achievement
{
	inline static constexpr unsigned int AchievementSeriesTitleViewModel_TypeDefinitionIndex = 80734;
