...
#define RPG_CLIENT_ACHIEVEMENT_ACHIEVEMENTSERIESTITLEVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0xC4A12A0)
#define RPG_CLIENT_ACHIEVEMENT_ACHIEVEMENTSERIESTITLEVIEWMODEL_GET_TITLE_OFFSET UNITYSDK_OFFSET(0xC4A1380)
#define RPG_CLIENT_ACHIEVEMENT_ACHIEVEMENTSERIESTITLEVIEWMODEL_GET_VIEWINDEX_OFFSET UNITYSDK_OFFSET(0xC4A1340)
#define RPG_CLIENT_ACHIEVEMENT_ACHIEVEMENTSERIESTITLEVIEWMODEL_SET_TITLE_OFFSET UNITYSDK_OFFSET(0xC4A1390)
#define RPG_CLIENT_ACHIEVEMENT_ACHIEVEMENTSERIESTITLEVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC4A1330)

namespace RPG::Client::Achievement
{
	inline static constexpr unsigned int AchievementSeriesTitleViewModel_TypeDefinitionIndex = 80735;
