...
#define RPG_CLIENT_ACHIEVEMENT_ACHIEVEMENTNETWORKSERVICE___C__CCTOR_OFFSET UNITYSDK_OFFSET(0xC4A1160)
#define RPG_CLIENT_ACHIEVEMENT_ACHIEVEMENTNETWORKSERVICE___C__CTOR_OFFSET UNITYSDK_OFFSET(0xC4A11A0)
#define RPG_CLIENT_ACHIEVEMENT_ACHIEVEMENTNETWORKSERVICE___C__SENDTAKEACHIEVEMENTREWARDCSREQANDBUILDRESULT_B__3_0_OFFSET UNITYSDK_OFFSET(0xC4A11B0)

namespace RPG::Client::Achievement
{
	inline static constexpr unsigned int AchievementNetworkService___c_TypeDefinitionIndex = 80734;
	...
	public:
		...
		{
			return (::RPG::Client::Achievement::AchievementNetworkService___c**)Il2CppClass::FromTypeDefinitionIndex(AchievementNetworkService___c_TypeDefinitionIndex)->GetStaticField(0x610B0);
		}
		...
		{
			return (::System::Func_2<::Class_1_79B49C00C46243B4*, ::RPG::Client::Achievement::AchievementTakeRewardResultViewModel*>**)Il2CppClass::FromTypeDefinitionIndex(AchievementNetworkService___c_TypeDefinitionIndex)->GetStaticField(0x610B8);
		}
