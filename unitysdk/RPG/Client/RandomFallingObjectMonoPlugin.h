...
#define RPG_CLIENT_RANDOMFALLINGOBJECTMONOPLUGIN_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xA286140)
#define RPG_CLIENT_RANDOMFALLINGOBJECTMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xA286190)
#define RPG_CLIENT_RANDOMFALLINGOBJECTMONOPLUGIN___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xA2861B0)

namespace RPG::Client
{
	inline static constexpr unsigned int RandomFallingObjectMonoPlugin_TypeDefinitionIndex = 58105;
