...
#define RPG_CLIENT_RANDOMFALLINGOBJECTMONOPLUGIN_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xAF74AA0)
#define RPG_CLIENT_RANDOMFALLINGOBJECTMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xAF74AF0)
#define RPG_CLIENT_RANDOMFALLINGOBJECTMONOPLUGIN___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xAF74B10)

namespace RPG::Client
{
	inline static constexpr unsigned int RandomFallingObjectMonoPlugin_TypeDefinitionIndex = 65392;
