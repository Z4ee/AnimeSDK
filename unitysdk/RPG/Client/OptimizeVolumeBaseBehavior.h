...
#define RPG_CLIENT_OPTIMIZEVOLUMEBASEBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0xDA0C2C0)
#define RPG_CLIENT_OPTIMIZEVOLUMEBASEBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0xDA0C6B0)
#define RPG_CLIENT_OPTIMIZEVOLUMEBASEBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xDA0C650)
#define RPG_CLIENT_OPTIMIZEVOLUMEBASEBEHAVIOR_METHOD_3_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xDA0C380)
#define RPG_CLIENT_OPTIMIZEVOLUMEBASEBEHAVIOR_METHOD_3_B6AF0B902BD08637_OFFSET UNITYSDK_OFFSET(0xDA0BEC0)
#define RPG_CLIENT_OPTIMIZEVOLUMEBASEBEHAVIOR_METHOD_3_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xDA0C340)
#define RPG_CLIENT_OPTIMIZEVOLUMEBASEBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0xDA0C410)
#define RPG_CLIENT_OPTIMIZEVOLUMEBASEBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0xDA0C710)
