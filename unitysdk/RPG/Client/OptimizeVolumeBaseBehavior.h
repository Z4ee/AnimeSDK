...
#define RPG_CLIENT_OPTIMIZEVOLUMEBASEBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0x1829F1B0)
#define RPG_CLIENT_OPTIMIZEVOLUMEBASEBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0x1829F5A0)
#define RPG_CLIENT_OPTIMIZEVOLUMEBASEBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x1829F540)
#define RPG_CLIENT_OPTIMIZEVOLUMEBASEBEHAVIOR_METHOD_3_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x1829F270)
#define RPG_CLIENT_OPTIMIZEVOLUMEBASEBEHAVIOR_METHOD_3_B6AF0B902BD08637_OFFSET UNITYSDK_OFFSET(0x1829EDB0)
#define RPG_CLIENT_OPTIMIZEVOLUMEBASEBEHAVIOR_METHOD_3_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1829F230)
#define RPG_CLIENT_OPTIMIZEVOLUMEBASEBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0x1829F300)
#define RPG_CLIENT_OPTIMIZEVOLUMEBASEBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1829F600)

namespace RPG::Client
{
	inline static constexpr unsigned int OptimizeVolumeBaseBehavior_TypeDefinitionIndex = 67671;
