...
#define RPG_CLIENT_CHIMERAGALLERYINFO___C__CCTOR_OFFSET UNITYSDK_OFFSET(0xA02B570)
#define RPG_CLIENT_CHIMERAGALLERYINFO___C__CTOR_OFFSET UNITYSDK_OFFSET(0xA02B5A0)
#define RPG_CLIENT_CHIMERAGALLERYINFO___C__GETGALLERYTALKS_B__6_1_OFFSET UNITYSDK_OFFSET(0xA02B720)
#define RPG_CLIENT_CHIMERAGALLERYINFO___C__INIT_B__5_0_OFFSET UNITYSDK_OFFSET(0xA02B5B0)

namespace RPG::Client
{
	inline static constexpr unsigned int ChimeraGalleryInfo___c_TypeDefinitionIndex = 58434;
	...
	public:
		...
		{
			return (::System::Func_2<::RPG::Client::ChimeraGalleryGroupedTalkData*, ::System::Single>**)Il2CppClass::FromTypeDefinitionIndex(ChimeraGalleryInfo___c_TypeDefinitionIndex)->GetStaticField(0x57660);
		}
		static ::RPG::Client::ChimeraGalleryInfo___c** StaticGet___9()
		{
			return (::RPG::Client::ChimeraGalleryInfo___c**)Il2CppClass::FromTypeDefinitionIndex(ChimeraGalleryInfo___c_TypeDefinitionIndex)->GetStaticField(0x57668);
		}
		static ::System::Comparison_1<::RPG::Client::ChimeraGalleryActData*>** StaticGet___9__5_0()
		{
			return (::System::Comparison_1<::RPG::Client::ChimeraGalleryActData*>**)Il2CppClass::FromTypeDefinitionIndex(ChimeraGalleryInfo___c_TypeDefinitionIndex)->GetStaticField(0x57670);
		}
