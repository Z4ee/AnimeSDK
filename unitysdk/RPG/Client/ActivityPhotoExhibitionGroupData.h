...
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x9C3D9B0)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GETCURINPROGRESSDETAILDATA_OFFSET UNITYSDK_OFFSET(0x9C3DCC0)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_ACTIVITYMODULEID_OFFSET UNITYSDK_OFFSET(0x9C3E480)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_COMMENTLIST_OFFSET UNITYSDK_OFFSET(0x9C3DCA0)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_DAILY_OFFSET UNITYSDK_OFFSET(0x9C3E8B0)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x9C3E240)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_GROUPINDEX_OFFSET UNITYSDK_OFFSET(0x9C3E260)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_HASREWARDCANTAKE_OFFSET UNITYSDK_OFFSET(0x9C3E7E0)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_ISANYDETAILFINISHED_OFFSET UNITYSDK_OFFSET(0x9C3E6B0)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_ISAVAILABLE_OFFSET UNITYSDK_OFFSET(0x9C3D6B0)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0x9C3DE60)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_ISINSCHEDULE_OFFSET UNITYSDK_OFFSET(0x9C3E4A0)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_ISLASTDAYFINISHED_OFFSET UNITYSDK_OFFSET(0x9C3E6A0)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_ISLASTDAY_OFFSET UNITYSDK_OFFSET(0x9C3D2D0)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_ISPREGROUPFINISH_OFFSET UNITYSDK_OFFSET(0x9C3E550)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_ISSEENUNLOCK_OFFSET UNITYSDK_OFFSET(0x9C3E130)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0x9C3E680)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_PHOTOID_OFFSET UNITYSDK_OFFSET(0x9C3D410)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_QUESTID_OFFSET UNITYSDK_OFFSET(0x9C3E890)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_SCHEDULEDATA_OFFSET UNITYSDK_OFFSET(0x9C3E3A0)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_GET_TAB_OFFSET UNITYSDK_OFFSET(0x9C3E8E0)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_RECORDSEENUNLOCK_OFFSET UNITYSDK_OFFSET(0x9C3DFA0)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA_SET_GROUPID_OFFSET UNITYSDK_OFFSET(0x9C3E250)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONGROUPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9C3DC00)

namespace RPG::Client
{
	inline static constexpr unsigned int ActivityPhotoExhibitionGroupData_TypeDefinitionIndex = 56928;
