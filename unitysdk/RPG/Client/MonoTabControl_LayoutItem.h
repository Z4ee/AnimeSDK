...
#define RPG_CLIENT_MONOTABCONTROL_LAYOUTITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1C283CD0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoTabControl_LayoutItem_TypeDefinitionIndex = 72533;
