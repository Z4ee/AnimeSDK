...
#define RPG_CLIENT_MONOTABCONTROL_LAYOUTITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A351A60)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoTabControl_LayoutItem_TypeDefinitionIndex = 69325;
