...
#define RPG_CLIENT_BATTLEELATIONSTARTTOASTDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xC8F62B0)
#define RPG_CLIENT_BATTLEELATIONSTARTTOASTDATA_GETAUDIOEVENTNAME_OFFSET UNITYSDK_OFFSET(0xC8F67D0)
#define RPG_CLIENT_BATTLEELATIONSTARTTOASTDATA_GETPREFABPATH_OFFSET UNITYSDK_OFFSET(0xC8F6550)
#define RPG_CLIENT_BATTLEELATIONSTARTTOASTDATA_GET_POINTNUM_OFFSET UNITYSDK_OFFSET(0xC8F66A0)
#define RPG_CLIENT_BATTLEELATIONSTARTTOASTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC8F6430)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleElationStartToastData_TypeDefinitionIndex = 72082;

	class BattleElationStartToastData : public ::System::Object
	{
	public:
		::Il2CppArray<::System::String*>* _PrefabPaths; // 0x10
		::Il2CppArray<::System::String*>* _AudioEventNames; // 0x18
		::Class_1_CDF807379B3F27B3* _ElationPointManager; // 0x20
		::Class_1_E08DCD252AEE7AEA* _LevelSetting; // 0x28
