...
#define RPG_CLIENT_EFFECT_AFTERIMAGENEW_ACTIVATEAFTERIMAGE_OFFSET UNITYSDK_OFFSET(0xA1BDF30)
#define RPG_CLIENT_EFFECT_AFTERIMAGENEW_ADDWORLDOFFSET_OFFSET UNITYSDK_OFFSET(0xA1BEC70)
#define RPG_CLIENT_EFFECT_AFTERIMAGENEW_ADDWORLDROTATION_OFFSET UNITYSDK_OFFSET(0xA1BEFA0)
#define RPG_CLIENT_EFFECT_AFTERIMAGENEW_ALLOWBAKEIMAGE_OFFSET UNITYSDK_OFFSET(0xA1BD2E0)
#define RPG_CLIENT_EFFECT_AFTERIMAGENEW_AWAKE_OFFSET UNITYSDK_OFFSET(0xA1BC3A0)
#define RPG_CLIENT_EFFECT_AFTERIMAGENEW_BAKEMESHIMAGE_OFFSET UNITYSDK_OFFSET(0xA1BDEF0)
#define RPG_CLIENT_EFFECT_AFTERIMAGENEW_DEACTIVATEAFTERIMAGE_OFFSET UNITYSDK_OFFSET(0xA1BC660)
#define RPG_CLIENT_EFFECT_AFTERIMAGENEW_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0xA1BC5A0)
#define RPG_CLIENT_EFFECT_AFTERIMAGENEW_GET_CURRENTIMAGECOUNT_OFFSET UNITYSDK_OFFSET(0xA1BD550)
#define RPG_CLIENT_EFFECT_AFTERIMAGENEW_LATETICK_OFFSET UNITYSDK_OFFSET(0xA1BC7D0)
#define RPG_CLIENT_EFFECT_AFTERIMAGENEW_METHOD_5_3ABEC8F14503754E_OFFSET UNITYSDK_OFFSET(0xA1BCFC0)
#define RPG_CLIENT_EFFECT_AFTERIMAGENEW_METHOD_5_82020AC4BCE8251D_OFFSET UNITYSDK_OFFSET(0xA1BF410)
#define RPG_CLIENT_EFFECT_AFTERIMAGENEW_METHOD_5_C3FAEDDB7D84362E_OFFSET UNITYSDK_OFFSET(0xA1BD5B0)
#define RPG_CLIENT_EFFECT_AFTERIMAGENEW_METHOD_5_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xA1BF5C0)
#define RPG_CLIENT_EFFECT_AFTERIMAGENEW_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xA1BF570)
#define RPG_CLIENT_EFFECT_AFTERIMAGENEW_METHOD_5_DC715239B8B98D9C_OFFSET UNITYSDK_OFFSET(0xA1BE110)
#define RPG_CLIENT_EFFECT_AFTERIMAGENEW_METHOD_5_E250BBB8026CD6B5_OFFSET UNITYSDK_OFFSET(0xA1BD470)
#define RPG_CLIENT_EFFECT_AFTERIMAGENEW_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xA1BC5F0)
#define RPG_CLIENT_EFFECT_AFTERIMAGENEW_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xA1BC500)
#define RPG_CLIENT_EFFECT_AFTERIMAGENEW_ONENABLE_OFFSET UNITYSDK_OFFSET(0xA1BC470)
#define RPG_CLIENT_EFFECT_AFTERIMAGENEW__CCTOR_OFFSET UNITYSDK_OFFSET(0xA1BF6D0)
#define RPG_CLIENT_EFFECT_AFTERIMAGENEW__CTOR_OFFSET UNITYSDK_OFFSET(0xA1BF610)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_AfterImageNew_TypeDefinitionIndex = 64926;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Effect_AfterImageNew_TypeDefinitionIndex)->GetStaticField(0x11500);
		}
		static ::System::Int32* StaticGet_Field_5_42()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Effect_AfterImageNew_TypeDefinitionIndex)->GetStaticField(0x11504);
		}
		static ::System::Int32* StaticGet_Field_5_40()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Effect_AfterImageNew_TypeDefinitionIndex)->GetStaticField(0x11508);
		}
		static ::System::Int32* StaticGet_Field_5_44()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Effect_AfterImageNew_TypeDefinitionIndex)->GetStaticField(0x1150C);
		}
		static ::System::Int32* StaticGet_Field_5_43()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Effect_AfterImageNew_TypeDefinitionIndex)->GetStaticField(0x11510);
		}
		...
		::Class_0_16E4307DCC419505_926* Field_5_38; // 0x108
