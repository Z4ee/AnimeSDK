...
#define RPG_CLIENT_EFFECT_AFTERIMAGENEW_ACTIVATEAFTERIMAGE_OFFSET UNITYSDK_OFFSET(0xB840D50)
#define RPG_CLIENT_EFFECT_AFTERIMAGENEW_ADDWORLDOFFSET_OFFSET UNITYSDK_OFFSET(0xB8419B0)
#define RPG_CLIENT_EFFECT_AFTERIMAGENEW_ADDWORLDROTATION_OFFSET UNITYSDK_OFFSET(0xB841C90)
#define RPG_CLIENT_EFFECT_AFTERIMAGENEW_ALLOWBAKEIMAGE_OFFSET UNITYSDK_OFFSET(0xB8401E0)
#define RPG_CLIENT_EFFECT_AFTERIMAGENEW_AWAKE_OFFSET UNITYSDK_OFFSET(0xB83F3B0)
#define RPG_CLIENT_EFFECT_AFTERIMAGENEW_BAKEMESHIMAGE_OFFSET UNITYSDK_OFFSET(0xB840D10)
#define RPG_CLIENT_EFFECT_AFTERIMAGENEW_DEACTIVATEAFTERIMAGE_OFFSET UNITYSDK_OFFSET(0xB83F5B0)
#define RPG_CLIENT_EFFECT_AFTERIMAGENEW_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0xB83F700)
#define RPG_CLIENT_EFFECT_AFTERIMAGENEW_GET_CURRENTIMAGECOUNT_OFFSET UNITYSDK_OFFSET(0xB840460)
#define RPG_CLIENT_EFFECT_AFTERIMAGENEW_LATETICK_OFFSET UNITYSDK_OFFSET(0xB83FAC0)
#define RPG_CLIENT_EFFECT_AFTERIMAGENEW_METHOD_5_3ABEC8F14503754E_OFFSET UNITYSDK_OFFSET(0xB83F750)
#define RPG_CLIENT_EFFECT_AFTERIMAGENEW_METHOD_5_82020AC4BCE8251D_OFFSET UNITYSDK_OFFSET(0xB8420B0)
#define RPG_CLIENT_EFFECT_AFTERIMAGENEW_METHOD_5_C3FAEDDB7D84362E_OFFSET UNITYSDK_OFFSET(0xB8404C0)
#define RPG_CLIENT_EFFECT_AFTERIMAGENEW_METHOD_5_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xB842260)
#define RPG_CLIENT_EFFECT_AFTERIMAGENEW_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xB842210)
#define RPG_CLIENT_EFFECT_AFTERIMAGENEW_METHOD_5_DC715239B8B98D9C_OFFSET UNITYSDK_OFFSET(0xB840F20)
#define RPG_CLIENT_EFFECT_AFTERIMAGENEW_METHOD_5_E250BBB8026CD6B5_OFFSET UNITYSDK_OFFSET(0xB840380)
#define RPG_CLIENT_EFFECT_AFTERIMAGENEW_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB83FA50)
#define RPG_CLIENT_EFFECT_AFTERIMAGENEW_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xB83F510)
#define RPG_CLIENT_EFFECT_AFTERIMAGENEW_ONENABLE_OFFSET UNITYSDK_OFFSET(0xB83F480)
#define RPG_CLIENT_EFFECT_AFTERIMAGENEW__CCTOR_OFFSET UNITYSDK_OFFSET(0xB842370)
#define RPG_CLIENT_EFFECT_AFTERIMAGENEW__CTOR_OFFSET UNITYSDK_OFFSET(0xB8422B0)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_AfterImageNew_TypeDefinitionIndex = 65852;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Effect_AfterImageNew_TypeDefinitionIndex)->GetStaticField(0x44A0);
		}
		static ::System::Int32* StaticGet_Field_5_1()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Effect_AfterImageNew_TypeDefinitionIndex)->GetStaticField(0x44A4);
		}
		static ::System::Int32* StaticGet_Field_5_2()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Effect_AfterImageNew_TypeDefinitionIndex)->GetStaticField(0x44A8);
		}
		static ::System::Int32* StaticGet_Field_5_3()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Effect_AfterImageNew_TypeDefinitionIndex)->GetStaticField(0x44AC);
		}
		static ::System::Int32* StaticGet_Field_5_4()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Effect_AfterImageNew_TypeDefinitionIndex)->GetStaticField(0x44B0);
		}
		...
		::Class_0_16E4307DCC419505_976* Field_5_43; // 0x108
