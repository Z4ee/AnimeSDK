...
#define RPG_CLIENT_SIMPLETEXT_AWAKE_OFFSET UNITYSDK_OFFSET(0x196B8C60)
#define RPG_CLIENT_SIMPLETEXT_FONTTEXTURECHANGED_OFFSET UNITYSDK_OFFSET(0x196B96B0)
#define RPG_CLIENT_SIMPLETEXT_GET_DATACOUNT_OFFSET UNITYSDK_OFFSET(0x196B8740)
#define RPG_CLIENT_SIMPLETEXT_GET_ENABLEGLOW_OFFSET UNITYSDK_OFFSET(0x196B88F0)
#define RPG_CLIENT_SIMPLETEXT_GET_ENABLEOUTLINE1_OFFSET UNITYSDK_OFFSET(0x196B8380)
#define RPG_CLIENT_SIMPLETEXT_GET_ENABLEOUTLINE_OFFSET UNITYSDK_OFFSET(0x196B81E0)
#define RPG_CLIENT_SIMPLETEXT_GET_ENABLESHADOW_OFFSET UNITYSDK_OFFSET(0x196B83D0)
#define RPG_CLIENT_SIMPLETEXT_GET_FONTSIZE_OFFSET UNITYSDK_OFFSET(0x196B7FF0)
#define RPG_CLIENT_SIMPLETEXT_GET_FONT_OFFSET UNITYSDK_OFFSET(0x196B7BF0)
#define RPG_CLIENT_SIMPLETEXT_GET_GLOWINTENSITY_OFFSET UNITYSDK_OFFSET(0x196B8790)
#define RPG_CLIENT_SIMPLETEXT_GET_GLOWWIDTH_OFFSET UNITYSDK_OFFSET(0x196B8940)
#define RPG_CLIENT_SIMPLETEXT_GET_KEYFONT_OFFSET UNITYSDK_OFFSET(0x196B7B00)
#define RPG_CLIENT_SIMPLETEXT_GET_MANAGER_OFFSET UNITYSDK_OFFSET(0x196B7F10)
#define RPG_CLIENT_SIMPLETEXT_GET_OUTLINE1WIDTH_OFFSET UNITYSDK_OFFSET(0x196B8230)
#define RPG_CLIENT_SIMPLETEXT_GET_OUTLINEWIDTH_OFFSET UNITYSDK_OFFSET(0x196B8090)
#define RPG_CLIENT_SIMPLETEXT_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x196B8AA0)
#define RPG_CLIENT_SIMPLETEXT_GET_RAWKEYFONT_OFFSET UNITYSDK_OFFSET(0x196B7B60)
#define RPG_CLIENT_SIMPLETEXT_GET_RECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x196B89C0)
#define RPG_CLIENT_SIMPLETEXT_GET_SHADOWOFFSET_OFFSET UNITYSDK_OFFSET(0x196B8430)
#define RPG_CLIENT_SIMPLETEXT_GET_TEXTMAPID_OFFSET UNITYSDK_OFFSET(0x196B77B0)
#define RPG_CLIENT_SIMPLETEXT_GET_TEXT_OFFSET UNITYSDK_OFFSET(0x196B77F0)
#define RPG_CLIENT_SIMPLETEXT_GET_USESECONDFONT_OFFSET UNITYSDK_OFFSET(0x196BA630)
#define RPG_CLIENT_SIMPLETEXT_GET_UV0_OFFSET UNITYSDK_OFFSET(0x196B8650)
#define RPG_CLIENT_SIMPLETEXT_GET_UV1_OFFSET UNITYSDK_OFFSET(0x196B86A0)
#define RPG_CLIENT_SIMPLETEXT_GET_UVEXTENDS_OFFSET UNITYSDK_OFFSET(0x196B86F0)
#define RPG_CLIENT_SIMPLETEXT_GET_VERTCOLORS_OFFSET UNITYSDK_OFFSET(0x196B8600)
#define RPG_CLIENT_SIMPLETEXT_GET_VERTICES_OFFSET UNITYSDK_OFFSET(0x196B85B0)
#define RPG_CLIENT_SIMPLETEXT_METHOD_5_3A2FD50416797880_OFFSET UNITYSDK_OFFSET(0x196BA060)
#define RPG_CLIENT_SIMPLETEXT_METHOD_5_3A514AAAECDAA096_OFFSET UNITYSDK_OFFSET(0x196BA830)
#define RPG_CLIENT_SIMPLETEXT_METHOD_5_6916CB2AB9451DD7_OFFSET UNITYSDK_OFFSET(0x196B8ED0)
#define RPG_CLIENT_SIMPLETEXT_METHOD_5_737220D2233A9067_OFFSET UNITYSDK_OFFSET(0x196BB6C0)
#define RPG_CLIENT_SIMPLETEXT_METHOD_5_8A640A3233BC6CBF_OFFSET UNITYSDK_OFFSET(0x196B8DD0)
#define RPG_CLIENT_SIMPLETEXT_METHOD_5_A239DF324AF4215D_OFFSET UNITYSDK_OFFSET(0x196B9620)
#define RPG_CLIENT_SIMPLETEXT_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x196B9270)
#define RPG_CLIENT_SIMPLETEXT_METHOD_5_D9AAE950C6F28BA6_OFFSET UNITYSDK_OFFSET(0x196BA740)
#define RPG_CLIENT_SIMPLETEXT_METHOD_5_DA37DFE3A5BDA9F4_OFFSET UNITYSDK_OFFSET(0x196B9920)
#define RPG_CLIENT_SIMPLETEXT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x196B93A0)
#define RPG_CLIENT_SIMPLETEXT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x196B9200)
#define RPG_CLIENT_SIMPLETEXT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x196B91B0)
#define RPG_CLIENT_SIMPLETEXT_ONLIGHTWEIGHTACTIVATE_OFFSET UNITYSDK_OFFSET(0x196B92C0)
#define RPG_CLIENT_SIMPLETEXT_ONLIGHTWEIGHTDEACTIVATE_OFFSET UNITYSDK_OFFSET(0x196B9320)
#define RPG_CLIENT_SIMPLETEXT_ONUITEXTCHANGEFONTFROMCONDENSETOCOMPLETE_OFFSET UNITYSDK_OFFSET(0x196B9540)
#define RPG_CLIENT_SIMPLETEXT_ONUITEXTLANGUAGECHANGE_OFFSET UNITYSDK_OFFSET(0x196B94E0)
#define RPG_CLIENT_SIMPLETEXT_ONUITEXTSWITCH_OFFSET UNITYSDK_OFFSET(0x196B9580)
#define RPG_CLIENT_SIMPLETEXT_ONUIWORLDFONTCHANGE_OFFSET UNITYSDK_OFFSET(0x196B95D0)
#define RPG_CLIENT_SIMPLETEXT_SETTEXTID_1_OFFSET UNITYSDK_OFFSET(0x196BB750)
#define RPG_CLIENT_SIMPLETEXT_SETTEXTID_OFFSET UNITYSDK_OFFSET(0x196BB640)
#define RPG_CLIENT_SIMPLETEXT_SET_FONTSIZE_OFFSET UNITYSDK_OFFSET(0x196B8030)
#define RPG_CLIENT_SIMPLETEXT_SET_FONT_OFFSET UNITYSDK_OFFSET(0x196B7920)
#define RPG_CLIENT_SIMPLETEXT_SET_GLOWINTENSITY_OFFSET UNITYSDK_OFFSET(0x196B87E0)
#define RPG_CLIENT_SIMPLETEXT_SET_MANAGER_OFFSET UNITYSDK_OFFSET(0x196B8C10)
#define RPG_CLIENT_SIMPLETEXT_SET_OUTLINE1WIDTH_OFFSET UNITYSDK_OFFSET(0x196B8280)
#define RPG_CLIENT_SIMPLETEXT_SET_OUTLINEWIDTH_OFFSET UNITYSDK_OFFSET(0x196B80E0)
#define RPG_CLIENT_SIMPLETEXT_SET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x196B8AF0)
#define RPG_CLIENT_SIMPLETEXT_SET_RAWKEYFONT_OFFSET UNITYSDK_OFFSET(0x196B7BA0)
#define RPG_CLIENT_SIMPLETEXT_SET_SHADOWOFFSET_OFFSET UNITYSDK_OFFSET(0x196B8480)
#define RPG_CLIENT_SIMPLETEXT_SET_TEXT_OFFSET UNITYSDK_OFFSET(0x196B7830)
#define RPG_CLIENT_SIMPLETEXT_START_OFFSET UNITYSDK_OFFSET(0x196B8E40)
#define RPG_CLIENT_SIMPLETEXT_UPDATEMESHDATA_OFFSET UNITYSDK_OFFSET(0x196B9FB0)
#define RPG_CLIENT_SIMPLETEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x196BB7D0)

namespace RPG::Client
{
	inline static constexpr unsigned int SimpleText_TypeDefinitionIndex = 72568;
	...
	public:
		...
		::UnityEngine::RectTransform* FPAJPFIBHGN; // 0xC8
		::System::Int32 JMLHAJJNPBL; // 0xD0
		::System::Int32 orderInHierarchy; // 0xD4
		::System::Int32 sortingOrder; // 0xD8
		::RPG::Client::SimpleTextManagerMono* EBENBNINEEG; // 0xE0
		::RPG::Client::TextID IEOEFHIACLK; // 0xE8
		::Il2CppArray<::System::Object*>* KCNDHEHJKJB; // 0xF8
		::UnityEngine::TextGenerationSettings KDDOCEHPKKN; // 0x100
		::System::Single alpha; // 0x168
		::System::Boolean DEBFMDMKKMF; // 0x16C
		::System::Boolean POGILOGNKJF; // 0x16D
		::UnityEngine::Canvas* HEDBJGFDNBN; // 0x170
		::Il2CppArray<::UnityEngine::Vector3>* HCJLAGALICG; // 0x178
		::Il2CppArray<::UnityEngine::Color32>* MKAOKECOCAD; // 0x180
		::Il2CppArray<::UnityEngine::Vector4>* EPBJOHGCDEM; // 0x188
		::Il2CppArray<::UnityEngine::Vector4>* JEKNOKFKNHK; // 0x190
		::Il2CppArray<::UnityEngine::Vector4>* KEDFADOILHI; // 0x198
		::System::Int32 JDFOMACCABG; // 0x1A0
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_SIMPLETEXT_METHOD_5_DA37DFE3A5BDA9F4_OFFSET))(this);
		}
		...
		::System::Void Method_5_3A514AAAECDAA096(::UnityEngine::Pooled::PooledList_1<::UnityEngine::UIVertex>* a1, ::System::Single a2)
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::Pooled::PooledList_1<::UnityEngine::UIVertex>*, ::System::Single))((::PBYTE)hIl2Cpp + RPG_CLIENT_SIMPLETEXT_METHOD_5_3A514AAAECDAA096_OFFSET))(this, a1, a2);
		}
		...
		::UnityEngine::TextGenerationSettings Method_5_3A2FD50416797880()
		{
			return ((::UnityEngine::TextGenerationSettings(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_SIMPLETEXT_METHOD_5_3A2FD50416797880_OFFSET))(this);
		}
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_SIMPLETEXT_METHOD_5_6916CB2AB9451DD7_OFFSET))(this);
		}

		::System::Void Method_5_737220D2233A9067()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_SIMPLETEXT_METHOD_5_737220D2233A9067_OFFSET))(this);
		}

		::RPG::Client::LocalizationManager* Method_5_8A640A3233BC6CBF()
		{
			return ((::RPG::Client::LocalizationManager*(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_SIMPLETEXT_METHOD_5_8A640A3233BC6CBF_OFFSET))(this);
		}
