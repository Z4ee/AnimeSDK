...
#define RPG_CLIENT_SIMPLETEXT_AWAKE_OFFSET UNITYSDK_OFFSET(0x188E8160)
#define RPG_CLIENT_SIMPLETEXT_FONTTEXTURECHANGED_OFFSET UNITYSDK_OFFSET(0x188E8BB0)
#define RPG_CLIENT_SIMPLETEXT_GET_DATACOUNT_OFFSET UNITYSDK_OFFSET(0x188E7C70)
#define RPG_CLIENT_SIMPLETEXT_GET_ENABLEGLOW_OFFSET UNITYSDK_OFFSET(0x188E7E20)
#define RPG_CLIENT_SIMPLETEXT_GET_ENABLEOUTLINE1_OFFSET UNITYSDK_OFFSET(0x188E78B0)
#define RPG_CLIENT_SIMPLETEXT_GET_ENABLEOUTLINE_OFFSET UNITYSDK_OFFSET(0x188E7710)
#define RPG_CLIENT_SIMPLETEXT_GET_ENABLESHADOW_OFFSET UNITYSDK_OFFSET(0x188E7900)
#define RPG_CLIENT_SIMPLETEXT_GET_FONTSIZE_OFFSET UNITYSDK_OFFSET(0x188E7520)
#define RPG_CLIENT_SIMPLETEXT_GET_FONT_OFFSET UNITYSDK_OFFSET(0x188E7120)
#define RPG_CLIENT_SIMPLETEXT_GET_GLOWINTENSITY_OFFSET UNITYSDK_OFFSET(0x188E7CC0)
#define RPG_CLIENT_SIMPLETEXT_GET_GLOWWIDTH_OFFSET UNITYSDK_OFFSET(0x188E7E70)
#define RPG_CLIENT_SIMPLETEXT_GET_KEYFONT_OFFSET UNITYSDK_OFFSET(0x188E7030)
#define RPG_CLIENT_SIMPLETEXT_GET_MANAGER_OFFSET UNITYSDK_OFFSET(0x188E7440)
#define RPG_CLIENT_SIMPLETEXT_GET_OUTLINE1WIDTH_OFFSET UNITYSDK_OFFSET(0x188E7760)
#define RPG_CLIENT_SIMPLETEXT_GET_OUTLINEWIDTH_OFFSET UNITYSDK_OFFSET(0x188E75C0)
#define RPG_CLIENT_SIMPLETEXT_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x188E7FA0)
#define RPG_CLIENT_SIMPLETEXT_GET_RAWKEYFONT_OFFSET UNITYSDK_OFFSET(0x188E7090)
#define RPG_CLIENT_SIMPLETEXT_GET_RECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x188E7EF0)
#define RPG_CLIENT_SIMPLETEXT_GET_SHADOWOFFSET_OFFSET UNITYSDK_OFFSET(0x188E7960)
#define RPG_CLIENT_SIMPLETEXT_GET_TEXTMAPID_OFFSET UNITYSDK_OFFSET(0x188E6CE0)
#define RPG_CLIENT_SIMPLETEXT_GET_TEXT_OFFSET UNITYSDK_OFFSET(0x188E6D20)
#define RPG_CLIENT_SIMPLETEXT_GET_USESECONDFONT_OFFSET UNITYSDK_OFFSET(0x188E9AD0)
#define RPG_CLIENT_SIMPLETEXT_GET_UV0_OFFSET UNITYSDK_OFFSET(0x188E7B80)
#define RPG_CLIENT_SIMPLETEXT_GET_UV1_OFFSET UNITYSDK_OFFSET(0x188E7BD0)
#define RPG_CLIENT_SIMPLETEXT_GET_UVEXTENDS_OFFSET UNITYSDK_OFFSET(0x188E7C20)
#define RPG_CLIENT_SIMPLETEXT_GET_VERTCOLORS_OFFSET UNITYSDK_OFFSET(0x188E7B30)
#define RPG_CLIENT_SIMPLETEXT_GET_VERTICES_OFFSET UNITYSDK_OFFSET(0x188E7AE0)
#define RPG_CLIENT_SIMPLETEXT_METHOD_5_3A514AAAECDAA096_OFFSET UNITYSDK_OFFSET(0x188E9CD0)
#define RPG_CLIENT_SIMPLETEXT_METHOD_5_6916CB2AB9451DD7_OFFSET UNITYSDK_OFFSET(0x188E83D0)
#define RPG_CLIENT_SIMPLETEXT_METHOD_5_6AC35DD773277EEA_OFFSET UNITYSDK_OFFSET(0x188E9560)
#define RPG_CLIENT_SIMPLETEXT_METHOD_5_737220D2233A9067_OFFSET UNITYSDK_OFFSET(0x188EAB60)
#define RPG_CLIENT_SIMPLETEXT_METHOD_5_8A640A3233BC6CBF_OFFSET UNITYSDK_OFFSET(0x188E82D0)
#define RPG_CLIENT_SIMPLETEXT_METHOD_5_A239DF324AF4215D_OFFSET UNITYSDK_OFFSET(0x188E8B20)
#define RPG_CLIENT_SIMPLETEXT_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x188E8770)
#define RPG_CLIENT_SIMPLETEXT_METHOD_5_D9AAE950C6F28BA6_OFFSET UNITYSDK_OFFSET(0x188E9BE0)
#define RPG_CLIENT_SIMPLETEXT_METHOD_5_DA37DFE3A5BDA9F4_OFFSET UNITYSDK_OFFSET(0x188E8E20)
#define RPG_CLIENT_SIMPLETEXT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x188E88A0)
#define RPG_CLIENT_SIMPLETEXT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x188E8700)
#define RPG_CLIENT_SIMPLETEXT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x188E86B0)
#define RPG_CLIENT_SIMPLETEXT_ONLIGHTWEIGHTACTIVATE_OFFSET UNITYSDK_OFFSET(0x188E87C0)
#define RPG_CLIENT_SIMPLETEXT_ONLIGHTWEIGHTDEACTIVATE_OFFSET UNITYSDK_OFFSET(0x188E8820)
#define RPG_CLIENT_SIMPLETEXT_ONUITEXTCHANGEFONTFROMCONDENSETOCOMPLETE_OFFSET UNITYSDK_OFFSET(0x188E8A40)
#define RPG_CLIENT_SIMPLETEXT_ONUITEXTLANGUAGECHANGE_OFFSET UNITYSDK_OFFSET(0x188E89E0)
#define RPG_CLIENT_SIMPLETEXT_ONUITEXTSWITCH_OFFSET UNITYSDK_OFFSET(0x188E8A80)
#define RPG_CLIENT_SIMPLETEXT_ONUIWORLDFONTCHANGE_OFFSET UNITYSDK_OFFSET(0x188E8AD0)
#define RPG_CLIENT_SIMPLETEXT_SETTEXTID_1_OFFSET UNITYSDK_OFFSET(0x188EABF0)
#define RPG_CLIENT_SIMPLETEXT_SETTEXTID_OFFSET UNITYSDK_OFFSET(0x188EAAE0)
#define RPG_CLIENT_SIMPLETEXT_SET_FONTSIZE_OFFSET UNITYSDK_OFFSET(0x188E7560)
#define RPG_CLIENT_SIMPLETEXT_SET_FONT_OFFSET UNITYSDK_OFFSET(0x188E6E50)
#define RPG_CLIENT_SIMPLETEXT_SET_GLOWINTENSITY_OFFSET UNITYSDK_OFFSET(0x188E7D10)
#define RPG_CLIENT_SIMPLETEXT_SET_MANAGER_OFFSET UNITYSDK_OFFSET(0x188E8110)
#define RPG_CLIENT_SIMPLETEXT_SET_OUTLINE1WIDTH_OFFSET UNITYSDK_OFFSET(0x188E77B0)
#define RPG_CLIENT_SIMPLETEXT_SET_OUTLINEWIDTH_OFFSET UNITYSDK_OFFSET(0x188E7610)
#define RPG_CLIENT_SIMPLETEXT_SET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x188E7FF0)
#define RPG_CLIENT_SIMPLETEXT_SET_RAWKEYFONT_OFFSET UNITYSDK_OFFSET(0x188E70D0)
#define RPG_CLIENT_SIMPLETEXT_SET_SHADOWOFFSET_OFFSET UNITYSDK_OFFSET(0x188E79B0)
#define RPG_CLIENT_SIMPLETEXT_SET_TEXT_OFFSET UNITYSDK_OFFSET(0x188E6D60)
#define RPG_CLIENT_SIMPLETEXT_START_OFFSET UNITYSDK_OFFSET(0x188E8340)
#define RPG_CLIENT_SIMPLETEXT_UPDATEMESHDATA_OFFSET UNITYSDK_OFFSET(0x188E94B0)
#define RPG_CLIENT_SIMPLETEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x188EAC70)

namespace RPG::Client
{
	inline static constexpr unsigned int SimpleText_TypeDefinitionIndex = 69360;
	...
	public:
		...
		::UnityEngine::TextGenerationSettings Method_5_6AC35DD773277EEA()
		{
			return ((::UnityEngine::TextGenerationSettings(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_SIMPLETEXT_METHOD_5_6AC35DD773277EEA_OFFSET))(this);
		}
