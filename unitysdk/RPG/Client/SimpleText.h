...
#define RPG_CLIENT_SIMPLETEXT_AWAKE_OFFSET UNITYSDK_OFFSET(0xA489160)
#define RPG_CLIENT_SIMPLETEXT_FONTTEXTURECHANGED_OFFSET UNITYSDK_OFFSET(0xA489980)
#define RPG_CLIENT_SIMPLETEXT_GET_DATACOUNT_OFFSET UNITYSDK_OFFSET(0xA488E50)
#define RPG_CLIENT_SIMPLETEXT_GET_ENABLEGLOW_OFFSET UNITYSDK_OFFSET(0xA488F00)
#define RPG_CLIENT_SIMPLETEXT_GET_ENABLEOUTLINE1_OFFSET UNITYSDK_OFFSET(0xA488C50)
#define RPG_CLIENT_SIMPLETEXT_GET_ENABLEOUTLINE_OFFSET UNITYSDK_OFFSET(0xA488BA0)
#define RPG_CLIENT_SIMPLETEXT_GET_ENABLESHADOW_OFFSET UNITYSDK_OFFSET(0xA488C60)
#define RPG_CLIENT_SIMPLETEXT_GET_FONTSIZE_OFFSET UNITYSDK_OFFSET(0xA488A90)
#define RPG_CLIENT_SIMPLETEXT_GET_FONT_OFFSET UNITYSDK_OFFSET(0xA488720)
#define RPG_CLIENT_SIMPLETEXT_GET_GLOWINTENSITY_OFFSET UNITYSDK_OFFSET(0xA488E60)
#define RPG_CLIENT_SIMPLETEXT_GET_GLOWWIDTH_OFFSET UNITYSDK_OFFSET(0xA488F20)
#define RPG_CLIENT_SIMPLETEXT_GET_KEYFONT_OFFSET UNITYSDK_OFFSET(0xA4886C0)
#define RPG_CLIENT_SIMPLETEXT_GET_MANAGER_OFFSET UNITYSDK_OFFSET(0xA4889F0)
#define RPG_CLIENT_SIMPLETEXT_GET_OUTLINE1WIDTH_OFFSET UNITYSDK_OFFSET(0xA488BB0)
#define RPG_CLIENT_SIMPLETEXT_GET_OUTLINEWIDTH_OFFSET UNITYSDK_OFFSET(0xA488B00)
#define RPG_CLIENT_SIMPLETEXT_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xA489020)
#define RPG_CLIENT_SIMPLETEXT_GET_RECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0xA488F70)
#define RPG_CLIENT_SIMPLETEXT_GET_SHADOWOFFSET_OFFSET UNITYSDK_OFFSET(0xA488CC0)
#define RPG_CLIENT_SIMPLETEXT_GET_TEXTMAPID_OFFSET UNITYSDK_OFFSET(0xA488600)
#define RPG_CLIENT_SIMPLETEXT_GET_TEXT_OFFSET UNITYSDK_OFFSET(0xA488610)
#define RPG_CLIENT_SIMPLETEXT_GET_USESECONDFONT_OFFSET UNITYSDK_OFFSET(0xA48ABF0)
#define RPG_CLIENT_SIMPLETEXT_GET_UV0_OFFSET UNITYSDK_OFFSET(0xA488E20)
#define RPG_CLIENT_SIMPLETEXT_GET_UV1_OFFSET UNITYSDK_OFFSET(0xA488E30)
#define RPG_CLIENT_SIMPLETEXT_GET_UVEXTENDS_OFFSET UNITYSDK_OFFSET(0xA488E40)
#define RPG_CLIENT_SIMPLETEXT_GET_VERTCOLORS_OFFSET UNITYSDK_OFFSET(0xA488E10)
#define RPG_CLIENT_SIMPLETEXT_GET_VERTICES_OFFSET UNITYSDK_OFFSET(0xA488E00)
#define RPG_CLIENT_SIMPLETEXT_METHOD_5_146E6E50FAF07D8F_OFFSET UNITYSDK_OFFSET(0xA489B30)
#define RPG_CLIENT_SIMPLETEXT_METHOD_5_9EB0BC18871AB79D_OFFSET UNITYSDK_OFFSET(0xA48C180)
#define RPG_CLIENT_SIMPLETEXT_METHOD_5_A239DF324AF4215D_OFFSET UNITYSDK_OFFSET(0xA4898F0)
#define RPG_CLIENT_SIMPLETEXT_METHOD_5_ABE8B3657B1F8305_OFFSET UNITYSDK_OFFSET(0xA48ADB0)
#define RPG_CLIENT_SIMPLETEXT_METHOD_5_B7F8E0B4AF22DEA3_OFFSET UNITYSDK_OFFSET(0xA489350)
#define RPG_CLIENT_SIMPLETEXT_METHOD_5_BB2928BEC244DEB7_OFFSET UNITYSDK_OFFSET(0xA48C070)
#define RPG_CLIENT_SIMPLETEXT_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xA489570)
#define RPG_CLIENT_SIMPLETEXT_METHOD_5_D9AAE950C6F28BA6_OFFSET UNITYSDK_OFFSET(0xA48ACC0)
#define RPG_CLIENT_SIMPLETEXT_METHOD_5_FE9CC166D09C957F_OFFSET UNITYSDK_OFFSET(0xA48A750)
#define RPG_CLIENT_SIMPLETEXT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xA4896A0)
#define RPG_CLIENT_SIMPLETEXT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xA489500)
#define RPG_CLIENT_SIMPLETEXT_ONENABLE_OFFSET UNITYSDK_OFFSET(0xA4894B0)
#define RPG_CLIENT_SIMPLETEXT_ONLIGHTWEIGHTACTIVATE_OFFSET UNITYSDK_OFFSET(0xA4895C0)
#define RPG_CLIENT_SIMPLETEXT_ONLIGHTWEIGHTDEACTIVATE_OFFSET UNITYSDK_OFFSET(0xA489620)
#define RPG_CLIENT_SIMPLETEXT_ONUITEXTCHANGEFONTFROMCONDENSETOCOMPLETE_OFFSET UNITYSDK_OFFSET(0xA489810)
#define RPG_CLIENT_SIMPLETEXT_ONUITEXTLANGUAGECHANGE_OFFSET UNITYSDK_OFFSET(0xA4897B0)
#define RPG_CLIENT_SIMPLETEXT_ONUITEXTSWITCH_OFFSET UNITYSDK_OFFSET(0xA489850)
#define RPG_CLIENT_SIMPLETEXT_ONUIWORLDFONTCHANGE_OFFSET UNITYSDK_OFFSET(0xA4898A0)
#define RPG_CLIENT_SIMPLETEXT_SETTEXTID_1_OFFSET UNITYSDK_OFFSET(0xA48C100)
#define RPG_CLIENT_SIMPLETEXT_SETTEXTID_OFFSET UNITYSDK_OFFSET(0xA48BFF0)
#define RPG_CLIENT_SIMPLETEXT_SET_FONTSIZE_OFFSET UNITYSDK_OFFSET(0xA488AA0)
#define RPG_CLIENT_SIMPLETEXT_SET_FONT_OFFSET UNITYSDK_OFFSET(0xA488730)
#define RPG_CLIENT_SIMPLETEXT_SET_GLOWINTENSITY_OFFSET UNITYSDK_OFFSET(0xA488E70)
#define RPG_CLIENT_SIMPLETEXT_SET_MANAGER_OFFSET UNITYSDK_OFFSET(0xA489150)
#define RPG_CLIENT_SIMPLETEXT_SET_OUTLINE1WIDTH_OFFSET UNITYSDK_OFFSET(0xA488BC0)
#define RPG_CLIENT_SIMPLETEXT_SET_OUTLINEWIDTH_OFFSET UNITYSDK_OFFSET(0xA488B10)
#define RPG_CLIENT_SIMPLETEXT_SET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xA489030)
#define RPG_CLIENT_SIMPLETEXT_SET_SHADOWOFFSET_OFFSET UNITYSDK_OFFSET(0xA488CD0)
#define RPG_CLIENT_SIMPLETEXT_SET_TEXT_OFFSET UNITYSDK_OFFSET(0xA488620)
#define RPG_CLIENT_SIMPLETEXT_START_OFFSET UNITYSDK_OFFSET(0xA4892C0)
#define RPG_CLIENT_SIMPLETEXT_UPDATEMESHDATA_OFFSET UNITYSDK_OFFSET(0xA48A6A0)
#define RPG_CLIENT_SIMPLETEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xA48C1B0)

namespace RPG::Client
{
	inline static constexpr unsigned int SimpleText_TypeDefinitionIndex = 59539;
	...
	public:
		...
		::System::Boolean Field_5_29; // 0x168
		::System::Boolean Field_5_30; // 0x169
		::UnityEngine::Canvas* Field_5_31; // 0x170
		::Il2CppArray<::UnityEngine::Vector3>* Field_5_32; // 0x178
		::Il2CppArray<::UnityEngine::Color32>* Field_5_33; // 0x180
		::Il2CppArray<::UnityEngine::Vector4>* Field_5_34; // 0x188
		::Il2CppArray<::UnityEngine::Vector4>* Field_5_35; // 0x190
		::Il2CppArray<::UnityEngine::Vector4>* Field_5_36; // 0x198
		::System::Int32 Field_5_37; // 0x1A0
