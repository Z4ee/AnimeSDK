...
#define RPG_CLIENT_GRIDFIGHTFLOWDIRECTOR_LEAVESTATE_ONENTER_OFFSET UNITYSDK_OFFSET(0x1A6A6880)
#define RPG_CLIENT_GRIDFIGHTFLOWDIRECTOR_LEAVESTATE_ONEVENT_OFFSET UNITYSDK_OFFSET(0x1A6A6DB0)
#define RPG_CLIENT_GRIDFIGHTFLOWDIRECTOR_LEAVESTATE_ONEXIT_OFFSET UNITYSDK_OFFSET(0x1A6A6D60)
#define RPG_CLIENT_GRIDFIGHTFLOWDIRECTOR_LEAVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6A4920)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightFlowDirector_LeaveState_TypeDefinitionIndex = 61681;
