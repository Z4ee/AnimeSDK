...
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0xA0B36C0)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_METHOD_3_0076C796B2045359_OFFSET UNITYSDK_OFFSET(0xA0B18D0)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_METHOD_3_0A1EBDC04FF09910_OFFSET UNITYSDK_OFFSET(0xA0B66A0)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_METHOD_3_0FD0EC313FAAB75A_OFFSET UNITYSDK_OFFSET(0xA0B3D80)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_METHOD_3_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0xA0B3FF0)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_METHOD_3_1F3793A40D6D0F7F_OFFSET UNITYSDK_OFFSET(0xA0B25D0)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_METHOD_3_22AFCF77865E9802_OFFSET UNITYSDK_OFFSET(0xA0B6CE0)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_METHOD_3_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xA0B3FB0)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0xA0B3ED0)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_METHOD_3_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0xA0B3F40)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xA0B3D20)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_METHOD_3_5790A55946AA509D_1_OFFSET UNITYSDK_OFFSET(0xA0B6EA0)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_METHOD_3_5790A55946AA509D_2_OFFSET UNITYSDK_OFFSET(0xA0B6F00)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_METHOD_3_5790A55946AA509D_3_OFFSET UNITYSDK_OFFSET(0xA0B6F60)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_METHOD_3_5790A55946AA509D_4_OFFSET UNITYSDK_OFFSET(0xA0B6FC0)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_METHOD_3_5790A55946AA509D_5_OFFSET UNITYSDK_OFFSET(0xA0B7030)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_METHOD_3_5790A55946AA509D_6_OFFSET UNITYSDK_OFFSET(0xA0B7110)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_METHOD_3_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0xA0B6E40)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_METHOD_3_6D93101E4CE10A96_OFFSET UNITYSDK_OFFSET(0xA0B1820)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_METHOD_3_825CC99DD653DEE0_OFFSET UNITYSDK_OFFSET(0xA0B1A60)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_METHOD_3_8F7825DAFFB9B517_OFFSET UNITYSDK_OFFSET(0xA0B4880)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_METHOD_3_A21BBA85D4EF7B41_OFFSET UNITYSDK_OFFSET(0xA0B4A30)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_METHOD_3_AF7DB9C9316245A8_OFFSET UNITYSDK_OFFSET(0xA0B6470)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_METHOD_3_B1EA412ACAE87C15_OFFSET UNITYSDK_OFFSET(0xA0B22F0)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_METHOD_3_DBA8CB09BF007EAD_OFFSET UNITYSDK_OFFSET(0xA0B6610)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_METHOD_3_F0E307B84478A272_OFFSET UNITYSDK_OFFSET(0xA0B70A0)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_METHOD_3_F63FE1AA9633F811_OFFSET UNITYSDK_OFFSET(0xA0B4EB0)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0xA0B40D0)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0xA0B6E20)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0xA0B6DF0)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0xA0B7170)

namespace RPG::Client
{
	inline static constexpr unsigned int ComicDialogEmitterBehavior_TypeDefinitionIndex = 65339;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ComicDialogEmitterBehavior_TypeDefinitionIndex)->GetStaticField(0x10320);
		}
