...
#define RPG_CLIENT_TIMEREWINDRAYCAST__CTOR_OFFSET UNITYSDK_OFFSET(0x19790220)

namespace RPG::Client
{
	inline static constexpr unsigned int TimeRewindRaycast_TypeDefinitionIndex = 60945;
