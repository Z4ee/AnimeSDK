...
#define RPG_CLIENT_ANIMSTATEDEBUGITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x9D1FE20)

namespace RPG::Client
{
	inline static constexpr unsigned int AnimStateDebugItem_TypeDefinitionIndex = 67002;
