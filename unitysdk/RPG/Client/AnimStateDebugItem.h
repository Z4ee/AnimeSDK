...
#define RPG_CLIENT_ANIMSTATEDEBUGITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xC760B30)

namespace RPG::Client
{
	inline static constexpr unsigned int AnimStateDebugItem_TypeDefinitionIndex = 72657;
