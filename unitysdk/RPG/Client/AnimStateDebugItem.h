...
#define RPG_CLIENT_ANIMSTATEDEBUGITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x90C29B0)

namespace RPG::Client
{
	inline static constexpr unsigned int AnimStateDebugItem_TypeDefinitionIndex = 59606;
