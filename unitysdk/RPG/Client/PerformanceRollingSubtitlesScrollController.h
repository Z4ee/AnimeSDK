...
#define RPG_CLIENT_PERFORMANCEROLLINGSUBTITLESSCROLLCONTROLLER_STARTSCROLL_OFFSET UNITYSDK_OFFSET(0xAC53B20)
#define RPG_CLIENT_PERFORMANCEROLLINGSUBTITLESSCROLLCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0xAC537B0)
#define RPG_CLIENT_PERFORMANCEROLLINGSUBTITLESSCROLLCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xAC53870)
#define RPG_CLIENT_PERFORMANCEROLLINGSUBTITLESSCROLLCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAC53C80)
#define RPG_CLIENT_PERFORMANCEROLLINGSUBTITLESSCROLLCONTROLLER__ONSCROLLFINISH_OFFSET UNITYSDK_OFFSET(0xAC539A0)
#define RPG_CLIENT_PERFORMANCEROLLINGSUBTITLESSCROLLCONTROLLER___ONSCROLLFINISH_B__3_0_OFFSET UNITYSDK_OFFSET(0xAC53C90)

namespace RPG::Client
{
	inline static constexpr unsigned int PerformanceRollingSubtitlesScrollController_TypeDefinitionIndex = 67113;
