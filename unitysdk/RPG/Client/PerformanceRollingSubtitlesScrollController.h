...
#define RPG_CLIENT_PERFORMANCEROLLINGSUBTITLESSCROLLCONTROLLER_STARTSCROLL_OFFSET UNITYSDK_OFFSET(0xC364DC0)
#define RPG_CLIENT_PERFORMANCEROLLINGSUBTITLESSCROLLCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0xC364A50)
#define RPG_CLIENT_PERFORMANCEROLLINGSUBTITLESSCROLLCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xC364B00)
#define RPG_CLIENT_PERFORMANCEROLLINGSUBTITLESSCROLLCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC364F20)
#define RPG_CLIENT_PERFORMANCEROLLINGSUBTITLESSCROLLCONTROLLER__ONSCROLLFINISH_OFFSET UNITYSDK_OFFSET(0xC364C30)
#define RPG_CLIENT_PERFORMANCEROLLINGSUBTITLESSCROLLCONTROLLER___ONSCROLLFINISH_B__3_0_OFFSET UNITYSDK_OFFSET(0xC364F30)

namespace RPG::Client
{
	inline static constexpr unsigned int PerformanceRollingSubtitlesScrollController_TypeDefinitionIndex = 68056;
