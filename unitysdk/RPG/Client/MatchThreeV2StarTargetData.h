...
#define RPG_CLIENT_MATCHTHREEV2STARTARGETDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xD675480)
#define RPG_CLIENT_MATCHTHREEV2STARTARGETDATA_GET_DESC_OFFSET UNITYSDK_OFFSET(0xD6751D0)
#define RPG_CLIENT_MATCHTHREEV2STARTARGETDATA_GET_FINISHPARAMLIST_OFFSET UNITYSDK_OFFSET(0xD6753D0)
#define RPG_CLIENT_MATCHTHREEV2STARTARGETDATA_GET_FINISHTYPE_OFFSET UNITYSDK_OFFSET(0xD675330)
#define RPG_CLIENT_MATCHTHREEV2STARTARGETDATA_GET_REWARDID_OFFSET UNITYSDK_OFFSET(0xD675290)
#define RPG_CLIENT_MATCHTHREEV2STARTARGETDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xD675170)
#define RPG_CLIENT_MATCHTHREEV2STARTARGETDATA_ISBIRDMEETTARGET_OFFSET UNITYSDK_OFFSET(0xD6754E0)
#define RPG_CLIENT_MATCHTHREEV2STARTARGETDATA_ISPROPMEETTARGET_OFFSET UNITYSDK_OFFSET(0xD6755A0)
#define RPG_CLIENT_MATCHTHREEV2STARTARGETDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD675470)
