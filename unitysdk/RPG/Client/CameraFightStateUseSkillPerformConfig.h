...
#define RPG_CLIENT_CAMERAFIGHTSTATEUSESKILLPERFORMCONFIG_METHOD_4_8985156732701889_OFFSET UNITYSDK_OFFSET(0x925A350)
#define RPG_CLIENT_CAMERAFIGHTSTATEUSESKILLPERFORMCONFIG_METHOD_4_A69140B461109D58_OFFSET UNITYSDK_OFFSET(0x925A220)
#define RPG_CLIENT_CAMERAFIGHTSTATEUSESKILLPERFORMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x925A3B0)

namespace RPG::Client
{
	inline static constexpr unsigned int CameraFightStateUseSkillPerformConfig_TypeDefinitionIndex = 56882;
