...
#define RPG_CLIENT_MONOANIMATORSTATESIMPLEEVENT_TIMEDEVENT_METHOD_2_183DCE814B2CC19A_OFFSET UNITYSDK_OFFSET(0xC0591F0)
#define RPG_CLIENT_MONOANIMATORSTATESIMPLEEVENT_TIMEDEVENT_METHOD_2_44EEB2BE4941EFE3_OFFSET UNITYSDK_OFFSET(0xC0590C0)
#define RPG_CLIENT_MONOANIMATORSTATESIMPLEEVENT_TIMEDEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0xC0592F0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoAnimatorStateSimpleEvent_TimedEvent_TypeDefinitionIndex = 64099;
