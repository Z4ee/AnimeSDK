...
#define RPG_CLIENT_MONOANIMATORSTATESIMPLEEVENT_TIMEDEVENT_METHOD_2_3CAD769FC088779C_OFFSET UNITYSDK_OFFSET(0x18075BF0)
#define RPG_CLIENT_MONOANIMATORSTATESIMPLEEVENT_TIMEDEVENT_METHOD_2_44EEB2BE4941EFE3_OFFSET UNITYSDK_OFFSET(0x18075AC0)
#define RPG_CLIENT_MONOANIMATORSTATESIMPLEEVENT_TIMEDEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x18075D70)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoAnimatorStateSimpleEvent_TimedEvent_TypeDefinitionIndex = 65470;
