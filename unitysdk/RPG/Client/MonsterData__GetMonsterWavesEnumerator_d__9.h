...
#define RPG_CLIENT_MONSTERDATA__GETMONSTERWAVESENUMERATOR_D__9_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xAACAAE0)
#define RPG_CLIENT_MONSTERDATA__GETMONSTERWAVESENUMERATOR_D__9_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_UINT32___GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xAACAD60)
#define RPG_CLIENT_MONSTERDATA__GETMONSTERWAVESENUMERATOR_D__9_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xAACADC0)
#define RPG_CLIENT_MONSTERDATA__GETMONSTERWAVESENUMERATOR_D__9_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xAACAD70)
#define RPG_CLIENT_MONSTERDATA__GETMONSTERWAVESENUMERATOR_D__9_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xAACAAD0)
#define RPG_CLIENT_MONSTERDATA__GETMONSTERWAVESENUMERATOR_D__9__CTOR_OFFSET UNITYSDK_OFFSET(0xAAC9400)

namespace RPG::Client
{
	inline static constexpr unsigned int MonsterData__GetMonsterWavesEnumerator_d__9_TypeDefinitionIndex = 58156;

	class MonsterData__GetMonsterWavesEnumerator_d__9 : public ::System::Object
	{
	public:
		::Il2CppArray<::System::UInt32>* _waveIDs_5__2; // 0x10
		::RPG::GameCore::StageRow* stageRow; // 0x18
