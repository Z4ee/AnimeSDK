...
#define RPG_CLIENT_EXPEDITIONBATTLERECOMMENDLINEUPVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0xCEFF530)
#define RPG_CLIENT_EXPEDITIONBATTLERECOMMENDLINEUPVIEWMODEL_GETLINEUPDETAILINFO_OFFSET UNITYSDK_OFFSET(0xCEFFF90)
#define RPG_CLIENT_EXPEDITIONBATTLERECOMMENDLINEUPVIEWMODEL_GETLINEUPPLAYERBRIEFDISPLAYDATA_OFFSET UNITYSDK_OFFSET(0xCEFF860)
#define RPG_CLIENT_EXPEDITIONBATTLERECOMMENDLINEUPVIEWMODEL_GETLINEUPRANKSTATENAME_OFFSET UNITYSDK_OFFSET(0xCF00890)
#define RPG_CLIENT_EXPEDITIONBATTLERECOMMENDLINEUPVIEWMODEL_GETLINEUPROUTEINFOBYSORTEDINDEX_OFFSET UNITYSDK_OFFSET(0xCF00650)
#define RPG_CLIENT_EXPEDITIONBATTLERECOMMENDLINEUPVIEWMODEL_GETLINEUPROUTEINFO_OFFSET UNITYSDK_OFFSET(0xCEFFCC0)
#define RPG_CLIENT_EXPEDITIONBATTLERECOMMENDLINEUPVIEWMODEL_GETLINEUPSTARCOUNT_OFFSET UNITYSDK_OFFSET(0xCF007C0)
#define RPG_CLIENT_EXPEDITIONBATTLERECOMMENDLINEUPVIEWMODEL_GETRECOMMENDAVATARITEMS_OFFSET UNITYSDK_OFFSET(0xCF00070)
#define RPG_CLIENT_EXPEDITIONBATTLERECOMMENDLINEUPVIEWMODEL_GETRECOMMENDMYOWNEDAVATARITEMS_OFFSET UNITYSDK_OFFSET(0xCF00930)
#define RPG_CLIENT_EXPEDITIONBATTLERECOMMENDLINEUPVIEWMODEL_GET_CANREFRESH_OFFSET UNITYSDK_OFFSET(0xCEFF470)
#define RPG_CLIENT_EXPEDITIONBATTLERECOMMENDLINEUPVIEWMODEL_GET_COUNTOFLINEUPS_OFFSET UNITYSDK_OFFSET(0xCEFF2B0)
#define RPG_CLIENT_EXPEDITIONBATTLERECOMMENDLINEUPVIEWMODEL_GET_ISDATAREADY_OFFSET UNITYSDK_OFFSET(0xCEFF3F0)
#define RPG_CLIENT_EXPEDITIONBATTLERECOMMENDLINEUPVIEWMODEL_GET_ROUTECOUNT_OFFSET UNITYSDK_OFFSET(0xCEFF4D0)
#define RPG_CLIENT_EXPEDITIONBATTLERECOMMENDLINEUPVIEWMODEL_REFRESH_OFFSET UNITYSDK_OFFSET(0xCEFF720)
#define RPG_CLIENT_EXPEDITIONBATTLERECOMMENDLINEUPVIEWMODEL_REPORTACTION_OFFSET UNITYSDK_OFFSET(0xCEFFFF0)
#define RPG_CLIENT_EXPEDITIONBATTLERECOMMENDLINEUPVIEWMODEL_SORTRECOMMENDATION_OFFSET UNITYSDK_OFFSET(0xCEFF800)
#define RPG_CLIENT_EXPEDITIONBATTLERECOMMENDLINEUPVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xCEFF690)
#define RPG_CLIENT_EXPEDITIONBATTLERECOMMENDLINEUPVIEWMODEL__ISVALIDSORTEDINDEX_OFFSET UNITYSDK_OFFSET(0xCEFF9D0)
...
namespace RPG::Client
{
	...
	{
	public:
		::RPG::Client::ExpeditionBattleMap* _Map; // 0x10
		::Class_1_B2C6C1C7059BA141* _Recommendation; // 0x18
		::Class_1_79CDF1654A8D2474* _RecommendAvatarService; // 0x20
		::System::Collections::Generic::IReadOnlyList_1<::System::Int32>* _SortedIndices; // 0x28
