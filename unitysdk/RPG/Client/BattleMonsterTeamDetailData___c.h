...
#define RPG_CLIENT_BATTLEMONSTERTEAMDETAILDATA___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x19F6E0C0)
#define RPG_CLIENT_BATTLEMONSTERTEAMDETAILDATA___C__CTOR_OFFSET UNITYSDK_OFFSET(0x19F6E100)
#define RPG_CLIENT_BATTLEMONSTERTEAMDETAILDATA___C__GETALLPHASESKILLS_B__3_0_OFFSET UNITYSDK_OFFSET(0x19F6E110)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleMonsterTeamDetailData___c_TypeDefinitionIndex = 71969;
	...
	public:
		...
		{
			return (::System::Comparison_1<::RPG::Client::BattleMonsterTeamDetailSkillData*>**)Il2CppClass::FromTypeDefinitionIndex(BattleMonsterTeamDetailData___c_TypeDefinitionIndex)->GetStaticField(0xC0F0);
		}
		static ::RPG::Client::BattleMonsterTeamDetailData___c** StaticGet___9()
		{
			return (::RPG::Client::BattleMonsterTeamDetailData___c**)Il2CppClass::FromTypeDefinitionIndex(BattleMonsterTeamDetailData___c_TypeDefinitionIndex)->GetStaticField(0xC0F8);
		}
