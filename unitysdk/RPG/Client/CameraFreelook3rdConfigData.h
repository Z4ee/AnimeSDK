...
#define RPG_CLIENT_CAMERAFREELOOK3RDCONFIGDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x925A440)
#define RPG_CLIENT_CAMERAFREELOOK3RDCONFIGDATA_METHOD_1_950F1A2A17A751A2_OFFSET UNITYSDK_OFFSET(0x925A610)
#define RPG_CLIENT_CAMERAFREELOOK3RDCONFIGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x92566C0)

namespace RPG::Client
{
	inline static constexpr unsigned int CameraFreelook3rdConfigData_TypeDefinitionIndex = 56867;
