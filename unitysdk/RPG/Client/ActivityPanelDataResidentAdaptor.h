...
#define RPG_CLIENT_ACTIVITYPANELDATARESIDENTADAPTOR_GET_ACTIVITYNAME_OFFSET UNITYSDK_OFFSET(0x1B852E80)
#define RPG_CLIENT_ACTIVITYPANELDATARESIDENTADAPTOR_GET_ACTIVITYPANELDATA_OFFSET UNITYSDK_OFFSET(0x1B852DE0)
#define RPG_CLIENT_ACTIVITYPANELDATARESIDENTADAPTOR_GET_BRIEFDESC_OFFSET UNITYSDK_OFFSET(0x1B853010)
#define RPG_CLIENT_ACTIVITYPANELDATARESIDENTADAPTOR_GET_CURSTATE_OFFSET UNITYSDK_OFFSET(0x1B853BB0)
#define RPG_CLIENT_ACTIVITYPANELDATARESIDENTADAPTOR_GET_DISPLAYREWARDS_OFFSET UNITYSDK_OFFSET(0x1B853810)
#define RPG_CLIENT_ACTIVITYPANELDATARESIDENTADAPTOR_GET_EXPECTEDPLAYINGHOURS_OFFSET UNITYSDK_OFFSET(0x1B8533B0)
#define RPG_CLIENT_ACTIVITYPANELDATARESIDENTADAPTOR_GET_GAMEPLAYINTROGUIDEVIDEOID_OFFSET UNITYSDK_OFFSET(0x1B8538F0)
#define RPG_CLIENT_ACTIVITYPANELDATARESIDENTADAPTOR_GET_GAMEPLAYINTROIMGPATH_OFFSET UNITYSDK_OFFSET(0x1B8539D0)
#define RPG_CLIENT_ACTIVITYPANELDATARESIDENTADAPTOR_GET_INDEXKEY_OFFSET UNITYSDK_OFFSET(0x1B852E20)
#define RPG_CLIENT_ACTIVITYPANELDATARESIDENTADAPTOR_GET_INTROBUTTONTEXT_OFFSET UNITYSDK_OFFSET(0x1B853130)
#define RPG_CLIENT_ACTIVITYPANELDATARESIDENTADAPTOR_GET_INTRODESC_OFFSET UNITYSDK_OFFSET(0x1B853290)
#define RPG_CLIENT_ACTIVITYPANELDATARESIDENTADAPTOR_GET_INTROTITLE_OFFSET UNITYSDK_OFFSET(0x1B8531E0)
#define RPG_CLIENT_ACTIVITYPANELDATARESIDENTADAPTOR_GET_IPDESC_OFFSET UNITYSDK_OFFSET(0x1B8530C0)
#define RPG_CLIENT_ACTIVITYPANELDATARESIDENTADAPTOR_GET_ISSHOWREMAINTIME_OFFSET UNITYSDK_OFFSET(0x1B853FF0)
#define RPG_CLIENT_ACTIVITYPANELDATARESIDENTADAPTOR_GET_LEFTCOUNTTEXT_OFFSET UNITYSDK_OFFSET(0x1B853300)
#define RPG_CLIENT_ACTIVITYPANELDATARESIDENTADAPTOR_GET_LISTITEMIMGPATH_OFFSET UNITYSDK_OFFSET(0x1B852F30)
#define RPG_CLIENT_ACTIVITYPANELDATARESIDENTADAPTOR_GET_REWARDCOUNT_OFFSET UNITYSDK_OFFSET(0x1B853AB0)
#define RPG_CLIENT_ACTIVITYPANELDATARESIDENTADAPTOR_GET_SCHEDULE_OFFSET UNITYSDK_OFFSET(0x1B853F30)
#define RPG_CLIENT_ACTIVITYPANELDATARESIDENTADAPTOR_GET_SORTWEIGHT_OFFSET UNITYSDK_OFFSET(0x1B8538A0)
#define RPG_CLIENT_ACTIVITYPANELDATARESIDENTADAPTOR_GET_TAGS_OFFSET UNITYSDK_OFFSET(0x1B8537A0)
#define RPG_CLIENT_ACTIVITYPANELDATARESIDENTADAPTOR_GET__DEBUGGERDISPLAY_OFFSET UNITYSDK_OFFSET(0x1B854030)
#define RPG_CLIENT_ACTIVITYPANELDATARESIDENTADAPTOR_ISHIDEALLREDDOT_OFFSET UNITYSDK_OFFSET(0x1B852C60)
#define RPG_CLIENT_ACTIVITYPANELDATARESIDENTADAPTOR_ISSHOWNEWREDDOT_OFFSET UNITYSDK_OFFSET(0x1B852BA0)
#define RPG_CLIENT_ACTIVITYPANELDATARESIDENTADAPTOR_ISSHOWNOPASSNORMALREDDOT_OFFSET UNITYSDK_OFFSET(0x1B852AE0)
#define RPG_CLIENT_ACTIVITYPANELDATARESIDENTADAPTOR_ISSHOWNORMALREDDOT_OFFSET UNITYSDK_OFFSET(0x1B8528F0)
#define RPG_CLIENT_ACTIVITYPANELDATARESIDENTADAPTOR_SETPANELSEEN_OFFSET UNITYSDK_OFFSET(0x1B852D20)
#define RPG_CLIENT_ACTIVITYPANELDATARESIDENTADAPTOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B8541B0)
#define RPG_CLIENT_ACTIVITYPANELDATARESIDENTADAPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B84DE20)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::RPG::Client::TextID*)Il2CppClass::FromTypeDefinitionIndex(ActivityPanelDataResidentAdaptor_TypeDefinitionIndex)->GetStaticField(0x14230);
		}
		static ::RPG::Client::TextID* StaticGet__ExpectedPlayingHoursIntegerFormat()
		{
			return (::RPG::Client::TextID*)Il2CppClass::FromTypeDefinitionIndex(ActivityPanelDataResidentAdaptor_TypeDefinitionIndex)->GetStaticField(0x14240);
		}
