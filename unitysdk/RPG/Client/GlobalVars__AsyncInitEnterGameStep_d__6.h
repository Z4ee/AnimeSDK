...
#define RPG_CLIENT_GLOBALVARS__ASYNCINITENTERGAMESTEP_D__6_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xD11F7A0)
#define RPG_CLIENT_GLOBALVARS__ASYNCINITENTERGAMESTEP_D__6_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xD1200F0)
#define RPG_CLIENT_GLOBALVARS__ASYNCINITENTERGAMESTEP_D__6_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xD120150)
#define RPG_CLIENT_GLOBALVARS__ASYNCINITENTERGAMESTEP_D__6_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xD120100)
#define RPG_CLIENT_GLOBALVARS__ASYNCINITENTERGAMESTEP_D__6_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD11F790)
#define RPG_CLIENT_GLOBALVARS__ASYNCINITENTERGAMESTEP_D__6__CTOR_OFFSET UNITYSDK_OFFSET(0xD11B0B0)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::Collections::IEnumerator* _enumerator_5__2; // 0x20
