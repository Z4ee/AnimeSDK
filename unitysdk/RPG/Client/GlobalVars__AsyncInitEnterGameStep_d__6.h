...
#define RPG_CLIENT_GLOBALVARS__ASYNCINITENTERGAMESTEP_D__6_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xBAD39C0)
#define RPG_CLIENT_GLOBALVARS__ASYNCINITENTERGAMESTEP_D__6_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xBAD4240)
#define RPG_CLIENT_GLOBALVARS__ASYNCINITENTERGAMESTEP_D__6_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xBAD42A0)
#define RPG_CLIENT_GLOBALVARS__ASYNCINITENTERGAMESTEP_D__6_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xBAD4250)
#define RPG_CLIENT_GLOBALVARS__ASYNCINITENTERGAMESTEP_D__6_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xBAD39B0)
#define RPG_CLIENT_GLOBALVARS__ASYNCINITENTERGAMESTEP_D__6__CTOR_OFFSET UNITYSDK_OFFSET(0xBACF420)

namespace RPG::Client
{
	inline static constexpr unsigned int GlobalVars__AsyncInitEnterGameStep_d__6_TypeDefinitionIndex = 57298;
