...
#define RPG_CLIENT_CITYCARFLOW_MONOCITYCAR__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADF30B0)

namespace RPG::Client::CityCarFlow
{
	inline static constexpr unsigned int MonoCityCar_TypeDefinitionIndex = 76797;
