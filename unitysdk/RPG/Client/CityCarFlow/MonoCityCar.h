...
#define RPG_CLIENT_CITYCARFLOW_MONOCITYCAR__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBFCB10)

namespace RPG::Client::CityCarFlow
{
	inline static constexpr unsigned int MonoCityCar_TypeDefinitionIndex = 80837;
