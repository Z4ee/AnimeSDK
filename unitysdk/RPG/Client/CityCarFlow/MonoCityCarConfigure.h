...
#define RPG_CLIENT_CITYCARFLOW_MONOCITYCARCONFIGURE_CREATEMANAGER_OFFSET UNITYSDK_OFFSET(0x93DFB90)
#define RPG_CLIENT_CITYCARFLOW_MONOCITYCARCONFIGURE__CTOR_OFFSET UNITYSDK_OFFSET(0x93DFC00)

namespace RPG::Client::CityCarFlow
{
	inline static constexpr unsigned int MonoCityCarConfigure_TypeDefinitionIndex = 64540;
	...
	public:
		...
		{
			return ((::Class_0_16E4307DCC419505_488*(*)(::PVOID, ::System::UInt32, ::System::String*))((::PBYTE)hIl2Cpp + RPG_CLIENT_CITYCARFLOW_MONOCITYCARCONFIGURE_CREATEMANAGER_OFFSET))(this, a1, a2);
		}
	};
}
