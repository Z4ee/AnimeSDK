...
#define RPG_CLIENT_CITYCARFLOW_MONOCITYCARAUDIO_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1BBFCDF0)
#define RPG_CLIENT_CITYCARFLOW_MONOCITYCARAUDIO_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1BBFCB30)
#define RPG_CLIENT_CITYCARFLOW_MONOCITYCARAUDIO_POSTBLOCKEVENT_OFFSET UNITYSDK_OFFSET(0x1BBFD3A0)
#define RPG_CLIENT_CITYCARFLOW_MONOCITYCARAUDIO_POSTDETECTEVENT_OFFSET UNITYSDK_OFFSET(0x1BBFD4A0)
#define RPG_CLIENT_CITYCARFLOW_MONOCITYCARAUDIO_POSTIDLEEVENT_OFFSET UNITYSDK_OFFSET(0x1BBFD6A0)
#define RPG_CLIENT_CITYCARFLOW_MONOCITYCARAUDIO_POSTIDLESTOPEVENT_OFFSET UNITYSDK_OFFSET(0x1BBFD7A0)
#define RPG_CLIENT_CITYCARFLOW_MONOCITYCARAUDIO_POSTROADRAGEEVENT_OFFSET UNITYSDK_OFFSET(0x1BBFD8A0)
#define RPG_CLIENT_CITYCARFLOW_MONOCITYCARAUDIO_POSTSTARTEVENT_OFFSET UNITYSDK_OFFSET(0x1BBFD5A0)
#define RPG_CLIENT_CITYCARFLOW_MONOCITYCARAUDIO_SHUTDOWN_OFFSET UNITYSDK_OFFSET(0x1BBFCEF0)
#define RPG_CLIENT_CITYCARFLOW_MONOCITYCARAUDIO_STARTUP_OFFSET UNITYSDK_OFFSET(0x1BBFCB90)
#define RPG_CLIENT_CITYCARFLOW_MONOCITYCARAUDIO_UPDATEEVENT_OFFSET UNITYSDK_OFFSET(0x1BBFD000)
#define RPG_CLIENT_CITYCARFLOW_MONOCITYCARAUDIO__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBFD9A0)

namespace RPG::Client::CityCarFlow
{
	inline static constexpr unsigned int MonoCityCarAudio_TypeDefinitionIndex = 80839;
