...
#define RPG_CLIENT_CITYCARFLOW_MONOCITYCARAUDIO_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xB6CAF90)
#define RPG_CLIENT_CITYCARFLOW_MONOCITYCARAUDIO_ONENABLE_OFFSET UNITYSDK_OFFSET(0xB6CACD0)
#define RPG_CLIENT_CITYCARFLOW_MONOCITYCARAUDIO_POSTBLOCKEVENT_OFFSET UNITYSDK_OFFSET(0xB6CB540)
#define RPG_CLIENT_CITYCARFLOW_MONOCITYCARAUDIO_POSTDETECTEVENT_OFFSET UNITYSDK_OFFSET(0xB6CB640)
#define RPG_CLIENT_CITYCARFLOW_MONOCITYCARAUDIO_POSTIDLEEVENT_OFFSET UNITYSDK_OFFSET(0xB6CB840)
#define RPG_CLIENT_CITYCARFLOW_MONOCITYCARAUDIO_POSTIDLESTOPEVENT_OFFSET UNITYSDK_OFFSET(0xB6CB940)
#define RPG_CLIENT_CITYCARFLOW_MONOCITYCARAUDIO_POSTROADRAGEEVENT_OFFSET UNITYSDK_OFFSET(0xB6CBA40)
#define RPG_CLIENT_CITYCARFLOW_MONOCITYCARAUDIO_POSTSTARTEVENT_OFFSET UNITYSDK_OFFSET(0xB6CB740)
#define RPG_CLIENT_CITYCARFLOW_MONOCITYCARAUDIO_SHUTDOWN_OFFSET UNITYSDK_OFFSET(0xB6CB090)
#define RPG_CLIENT_CITYCARFLOW_MONOCITYCARAUDIO_STARTUP_OFFSET UNITYSDK_OFFSET(0xB6CAD30)
#define RPG_CLIENT_CITYCARFLOW_MONOCITYCARAUDIO_UPDATEEVENT_OFFSET UNITYSDK_OFFSET(0xB6CB1A0)
#define RPG_CLIENT_CITYCARFLOW_MONOCITYCARAUDIO__CTOR_OFFSET UNITYSDK_OFFSET(0xB6CBB40)

namespace RPG::Client::CityCarFlow
{
	inline static constexpr unsigned int MonoCityCarAudio_TypeDefinitionIndex = 74409;
