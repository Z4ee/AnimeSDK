...
#define RPG_CLIENT_CITYCARFLOW_MONOCITYCARIRI__CTOR_OFFSET UNITYSDK_OFFSET(0xB6CC440)

namespace RPG::Client::CityCarFlow
{
	inline static constexpr unsigned int MonoCityCarIRI_TypeDefinitionIndex = 74425;
