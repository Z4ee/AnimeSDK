...
#define RPG_CLIENT_CITYCARFLOW_MONOCITYCARIRI__CTOR_OFFSET UNITYSDK_OFFSET(0x93E0230)

namespace RPG::Client::CityCarFlow
{
	inline static constexpr unsigned int MonoCityCarIRI_TypeDefinitionIndex = 64555;
