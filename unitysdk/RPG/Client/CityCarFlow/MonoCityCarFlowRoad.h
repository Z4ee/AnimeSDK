...
#define RPG_CLIENT_CITYCARFLOW_MONOCITYCARFLOWROAD_AWAKE_OFFSET UNITYSDK_OFFSET(0xA08DC10)
#define RPG_CLIENT_CITYCARFLOW_MONOCITYCARFLOWROAD__CTOR_OFFSET UNITYSDK_OFFSET(0xA08DCD0)

namespace RPG::Client::CityCarFlow
{
	inline static constexpr unsigned int MonoCityCarFlowRoad_TypeDefinitionIndex = 72599;
