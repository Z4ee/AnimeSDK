...
#define RPG_CLIENT_BAPARTVARIANTARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0x18677430)

namespace RPG::Client
{
	inline static constexpr unsigned int BAPartVariantArray_TypeDefinitionIndex = 66390;
