...
#define RPG_CLIENT_BUNDLEUPDATEPOSTFILEOPITEM_EXEC_OFFSET UNITYSDK_OFFSET(0x18CBB7E0)
#define RPG_CLIENT_BUNDLEUPDATEPOSTFILEOPITEM_GETSRCFULLPATH_OFFSET UNITYSDK_OFFSET(0x18CBB7A0)
#define RPG_CLIENT_BUNDLEUPDATEPOSTFILEOPITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x18CBB8D0)

namespace RPG::Client
{
	inline static constexpr unsigned int BundleUpdatePostFileOpItem_TypeDefinitionIndex = 58489;
