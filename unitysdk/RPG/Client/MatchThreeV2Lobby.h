...
#define RPG_CLIENT_MATCHTHREEV2LOBBY_CHANGESELFBIRDANDPROPS_OFFSET UNITYSDK_OFFSET(0xBF9EC60)
#define RPG_CLIENT_MATCHTHREEV2LOBBY_CHANGESELFSTATE_OFFSET UNITYSDK_OFFSET(0xBF9EF40)
#define RPG_CLIENT_MATCHTHREEV2LOBBY_GETCUROPPONENTCOUNT_OFFSET UNITYSDK_OFFSET(0xBF9F720)
#define RPG_CLIENT_MATCHTHREEV2LOBBY_GETOPPONENTDATABYUID_OFFSET UNITYSDK_OFFSET(0xBF9F0E0)
#define RPG_CLIENT_MATCHTHREEV2LOBBY_GET_OPPONENTS_OFFSET UNITYSDK_OFFSET(0xBF9FE00)
#define RPG_CLIENT_MATCHTHREEV2LOBBY_GET_SELFOPPONENTDATA_OFFSET UNITYSDK_OFFSET(0xBF9EEC0)
#define RPG_CLIENT_MATCHTHREEV2LOBBY_ISTARGETEDBYINVITATION_OFFSET UNITYSDK_OFFSET(0xBF9F6B0)
#define RPG_CLIENT_MATCHTHREEV2LOBBY_SAVECURUSEBIRD_OFFSET UNITYSDK_OFFSET(0xBF9F1E0)
#define RPG_CLIENT_MATCHTHREEV2LOBBY_SAVECURUSEPROPS_OFFSET UNITYSDK_OFFSET(0xBF9F330)
#define RPG_CLIENT_MATCHTHREEV2LOBBY_SET_OPPONENTS_OFFSET UNITYSDK_OFFSET(0xBF9FE10)
#define RPG_CLIENT_MATCHTHREEV2LOBBY_STARTMATCH_OFFSET UNITYSDK_OFFSET(0xBF9ED20)
#define RPG_CLIENT_MATCHTHREEV2LOBBY__CTOR_OFFSET UNITYSDK_OFFSET(0xBF9FE20)
#define RPG_CLIENT_MATCHTHREEV2LOBBY__GETMEMBERSBYLOBBYSTATE_OFFSET UNITYSDK_OFFSET(0xBF9FCD0)
#define RPG_CLIENT_MATCHTHREEV2LOBBY__ISINMATCHEDSTATE_OFFSET UNITYSDK_OFFSET(0xBF9FD90)
#define RPG_CLIENT_MATCHTHREEV2LOBBY__ONINIT_OFFSET UNITYSDK_OFFSET(0xBF9F840)
#define RPG_CLIENT_MATCHTHREEV2LOBBY__ONMATCHRESULTMEMBERSCHANGE_OFFSET UNITYSDK_OFFSET(0xBF9FC70)
#define RPG_CLIENT_MATCHTHREEV2LOBBY__ONMEMBERCHANGE_OFFSET UNITYSDK_OFFSET(0xBF9F9C0)
#define RPG_CLIENT_MATCHTHREEV2LOBBY__SYNCOPPONENTS_OFFSET UNITYSDK_OFFSET(0xBF9FA20)
#define RPG_CLIENT_MATCHTHREEV2LOBBY___IFIXBASEPROXY__ONINIT_OFFSET UNITYSDK_OFFSET(0xBF9FE80)
#define RPG_CLIENT_MATCHTHREEV2LOBBY___IFIXBASEPROXY__ONMATCHRESULTMEMBERSCHANGE_OFFSET UNITYSDK_OFFSET(0xBF9FF40)
#define RPG_CLIENT_MATCHTHREEV2LOBBY___IFIXBASEPROXY__ONMEMBERCHANGE_OFFSET UNITYSDK_OFFSET(0xBF9FEE0)

namespace RPG::Client
{
	inline static constexpr unsigned int MatchThreeV2Lobby_TypeDefinitionIndex = 61738;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::UInt32))((::PBYTE)hIl2Cpp + RPG_CLIENT_MATCHTHREEV2LOBBY___IFIXBASEPROXY__ONINIT_OFFSET))(this, a1);
		}
