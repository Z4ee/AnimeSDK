...
#define RPG_CLIENT_MATCHTHREEV2LOBBY_CHANGESELFBIRDANDPROPS_OFFSET UNITYSDK_OFFSET(0xD662140)
#define RPG_CLIENT_MATCHTHREEV2LOBBY_CHANGESELFSTATE_OFFSET UNITYSDK_OFFSET(0xD662480)
#define RPG_CLIENT_MATCHTHREEV2LOBBY_GETCUROPPONENTCOUNT_OFFSET UNITYSDK_OFFSET(0xD662D70)
#define RPG_CLIENT_MATCHTHREEV2LOBBY_GETOPPONENTDATABYUID_OFFSET UNITYSDK_OFFSET(0xD662680)
#define RPG_CLIENT_MATCHTHREEV2LOBBY_GET_OPPONENTS_OFFSET UNITYSDK_OFFSET(0xD6634B0)
#define RPG_CLIENT_MATCHTHREEV2LOBBY_GET_SELFOPPONENTDATA_OFFSET UNITYSDK_OFFSET(0xD662400)
#define RPG_CLIENT_MATCHTHREEV2LOBBY_ISTARGETEDBYINVITATION_OFFSET UNITYSDK_OFFSET(0xD662D00)
#define RPG_CLIENT_MATCHTHREEV2LOBBY_SAVECURUSEBIRD_OFFSET UNITYSDK_OFFSET(0xD662780)
#define RPG_CLIENT_MATCHTHREEV2LOBBY_SAVECURUSEPROPS_OFFSET UNITYSDK_OFFSET(0xD662930)
#define RPG_CLIENT_MATCHTHREEV2LOBBY_SET_OPPONENTS_OFFSET UNITYSDK_OFFSET(0xD6634C0)
#define RPG_CLIENT_MATCHTHREEV2LOBBY_STARTMATCH_OFFSET UNITYSDK_OFFSET(0xD662200)
#define RPG_CLIENT_MATCHTHREEV2LOBBY__CTOR_OFFSET UNITYSDK_OFFSET(0xD6634D0)
#define RPG_CLIENT_MATCHTHREEV2LOBBY__GETMEMBERSBYLOBBYSTATE_OFFSET UNITYSDK_OFFSET(0xD663380)
#define RPG_CLIENT_MATCHTHREEV2LOBBY__ISINMATCHEDSTATE_OFFSET UNITYSDK_OFFSET(0xD663440)
#define RPG_CLIENT_MATCHTHREEV2LOBBY__ONINIT_OFFSET UNITYSDK_OFFSET(0xD662E90)
#define RPG_CLIENT_MATCHTHREEV2LOBBY__ONMATCHRESULTMEMBERSCHANGE_OFFSET UNITYSDK_OFFSET(0xD663320)
#define RPG_CLIENT_MATCHTHREEV2LOBBY__ONMEMBERCHANGE_OFFSET UNITYSDK_OFFSET(0xD663040)
#define RPG_CLIENT_MATCHTHREEV2LOBBY__SYNCOPPONENTS_OFFSET UNITYSDK_OFFSET(0xD6630A0)
