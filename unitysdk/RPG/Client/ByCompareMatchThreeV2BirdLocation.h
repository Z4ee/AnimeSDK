...
#define RPG_CLIENT_BYCOMPAREMATCHTHREEV2BIRDLOCATION_METHOD_4_2951BB2CD21716CD_OFFSET UNITYSDK_OFFSET(0x185E44B0)
#define RPG_CLIENT_BYCOMPAREMATCHTHREEV2BIRDLOCATION_METHOD_4_DFFB8C04AECD941F_OFFSET UNITYSDK_OFFSET(0x185E43E0)
#define RPG_CLIENT_BYCOMPAREMATCHTHREEV2BIRDLOCATION__CTOR_OFFSET UNITYSDK_OFFSET(0x185E4460)

namespace RPG::Client
{
	inline static constexpr unsigned int ByCompareMatchThreeV2BirdLocation_TypeDefinitionIndex = 10128;
