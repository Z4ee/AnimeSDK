...
#define RPG_CLIENT_ROGUELOOPLISTVIEWEXTRA_GET_ITEMSCALEDISTANCE_OFFSET UNITYSDK_OFFSET(0xDECB900)
#define RPG_CLIENT_ROGUELOOPLISTVIEWEXTRA_GET_ITEMSNAPANIMATIONLAYER_OFFSET UNITYSDK_OFFSET(0xDECB9C0)
#define RPG_CLIENT_ROGUELOOPLISTVIEWEXTRA_GET_ITEMSNAPANIMATIONNAME_OFFSET UNITYSDK_OFFSET(0xDECBA50)
#define RPG_CLIENT_ROGUELOOPLISTVIEWEXTRA_GET_SCROLLCONTENTANCHOREDPOS_OFFSET UNITYSDK_OFFSET(0xDECBAE0)
#define RPG_CLIENT_ROGUELOOPLISTVIEWEXTRA_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0xDECC4C0)
#define RPG_CLIENT_ROGUELOOPLISTVIEWEXTRA_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xDECBBE0)
#define RPG_CLIENT_ROGUELOOPLISTVIEWEXTRA_REGISTERDRAGSTARTCALLBACK_OFFSET UNITYSDK_OFFSET(0xDECC460)
#define RPG_CLIENT_ROGUELOOPLISTVIEWEXTRA_SET_ITEMSCALEDISTANCE_OFFSET UNITYSDK_OFFSET(0xDECB950)
#define RPG_CLIENT_ROGUELOOPLISTVIEWEXTRA_SET_ITEMSNAPANIMATIONLAYER_OFFSET UNITYSDK_OFFSET(0xDECBA00)
#define RPG_CLIENT_ROGUELOOPLISTVIEWEXTRA_SET_ITEMSNAPANIMATIONNAME_OFFSET UNITYSDK_OFFSET(0xDECBA90)
#define RPG_CLIENT_ROGUELOOPLISTVIEWEXTRA_SET_SCROLLCONTENTANCHOREDPOS_OFFSET UNITYSDK_OFFSET(0xDECBB60)
#define RPG_CLIENT_ROGUELOOPLISTVIEWEXTRA_SHOWBORDERADJUST_OFFSET UNITYSDK_OFFSET(0xDECC3E0)
#define RPG_CLIENT_ROGUELOOPLISTVIEWEXTRA_UPDATE_OFFSET UNITYSDK_OFFSET(0xDECBCD0)
#define RPG_CLIENT_ROGUELOOPLISTVIEWEXTRA__CTOR_OFFSET UNITYSDK_OFFSET(0xDECC560)
#define RPG_CLIENT_ROGUELOOPLISTVIEWEXTRA__UPDATEBORDERADJUSTPROCESS_OFFSET UNITYSDK_OFFSET(0xDECBDC0)
#define RPG_CLIENT_ROGUELOOPLISTVIEWEXTRA__UPDATEITEMANIMSTATE_OFFSET UNITYSDK_OFFSET(0xDECC010)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueLoopListViewExtra_TypeDefinitionIndex = 72792;
