...
#define RPG_CLIENT_ROGUELOOPLISTVIEWEXTRA_GET_ITEMSCALEDISTANCE_OFFSET UNITYSDK_OFFSET(0xB04A8F0)
#define RPG_CLIENT_ROGUELOOPLISTVIEWEXTRA_GET_ITEMSNAPANIMATIONLAYER_OFFSET UNITYSDK_OFFSET(0xB04A970)
#define RPG_CLIENT_ROGUELOOPLISTVIEWEXTRA_GET_ITEMSNAPANIMATIONNAME_OFFSET UNITYSDK_OFFSET(0xB04A990)
#define RPG_CLIENT_ROGUELOOPLISTVIEWEXTRA_GET_SCROLLCONTENTANCHOREDPOS_OFFSET UNITYSDK_OFFSET(0xB04A9B0)
#define RPG_CLIENT_ROGUELOOPLISTVIEWEXTRA_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0xB04B450)
#define RPG_CLIENT_ROGUELOOPLISTVIEWEXTRA_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB04AAB0)
#define RPG_CLIENT_ROGUELOOPLISTVIEWEXTRA_REGISTERDRAGSTARTCALLBACK_OFFSET UNITYSDK_OFFSET(0xB04B3F0)
#define RPG_CLIENT_ROGUELOOPLISTVIEWEXTRA_SET_ITEMSCALEDISTANCE_OFFSET UNITYSDK_OFFSET(0xB04A900)
#define RPG_CLIENT_ROGUELOOPLISTVIEWEXTRA_SET_ITEMSNAPANIMATIONLAYER_OFFSET UNITYSDK_OFFSET(0xB04A980)
#define RPG_CLIENT_ROGUELOOPLISTVIEWEXTRA_SET_ITEMSNAPANIMATIONNAME_OFFSET UNITYSDK_OFFSET(0xB04A9A0)
#define RPG_CLIENT_ROGUELOOPLISTVIEWEXTRA_SET_SCROLLCONTENTANCHOREDPOS_OFFSET UNITYSDK_OFFSET(0xB04AA30)
#define RPG_CLIENT_ROGUELOOPLISTVIEWEXTRA_SHOWBORDERADJUST_OFFSET UNITYSDK_OFFSET(0xB04B370)
#define RPG_CLIENT_ROGUELOOPLISTVIEWEXTRA_UPDATE_OFFSET UNITYSDK_OFFSET(0xB04ABB0)
#define RPG_CLIENT_ROGUELOOPLISTVIEWEXTRA__CTOR_OFFSET UNITYSDK_OFFSET(0xB04B4E0)
#define RPG_CLIENT_ROGUELOOPLISTVIEWEXTRA__UPDATEBORDERADJUSTPROCESS_OFFSET UNITYSDK_OFFSET(0xB04ACA0)
#define RPG_CLIENT_ROGUELOOPLISTVIEWEXTRA__UPDATEITEMANIMSTATE_OFFSET UNITYSDK_OFFSET(0xB04AEF0)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueLoopListViewExtra_TypeDefinitionIndex = 67134;
