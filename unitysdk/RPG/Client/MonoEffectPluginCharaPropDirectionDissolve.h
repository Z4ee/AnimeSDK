...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPDIRECTIONDISSOLVE_INIT_OFFSET UNITYSDK_OFFSET(0x9CAD690)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPDIRECTIONDISSOLVE_UNINIT_OFFSET UNITYSDK_OFFSET(0x9CAD730)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPDIRECTIONDISSOLVE_UPDATEPROPERTY_OFFSET UNITYSDK_OFFSET(0x9CAD7E0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPDIRECTIONDISSOLVE__CTOR_OFFSET UNITYSDK_OFFSET(0x9CAE5F0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPDIRECTIONDISSOLVE___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0x9CAE630)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPDIRECTIONDISSOLVE___IFIXBASEPROXY_UNINIT_OFFSET UNITYSDK_OFFSET(0x9CAE640)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginCharaPropDirectionDissolve_TypeDefinitionIndex = 57230;
