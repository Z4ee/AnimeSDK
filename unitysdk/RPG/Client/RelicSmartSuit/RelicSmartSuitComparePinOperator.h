...
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREPINOPERATOR_CREATE_OFFSET UNITYSDK_OFFSET(0xC6F9590)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREPINOPERATOR_GETPINNEDUID_OFFSET UNITYSDK_OFFSET(0xC6F9890)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREPINOPERATOR_GET_DATASOURCE_OFFSET UNITYSDK_OFFSET(0xC6F9530)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREPINOPERATOR_GET_PININFORECORDER_OFFSET UNITYSDK_OFFSET(0xC6F94D0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREPINOPERATOR_GET_PLANRESULT_OFFSET UNITYSDK_OFFSET(0xC6F9550)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREPINOPERATOR_GET_SELECTINFO_OFFSET UNITYSDK_OFFSET(0xC6F9570)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREPINOPERATOR_ISPINNED_OFFSET UNITYSDK_OFFSET(0xC6F97C0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREPINOPERATOR_PINORUNPINRELIC_OFFSET UNITYSDK_OFFSET(0xC6F9920)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREPINOPERATOR_PINRELIC_OFFSET UNITYSDK_OFFSET(0xC6F9D80)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREPINOPERATOR_UNPINRELIC_OFFSET UNITYSDK_OFFSET(0xC6F9A70)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREPINOPERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0xC6F9610)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREPINOPERATOR__GETCLONEPINDATA_OFFSET UNITYSDK_OFFSET(0xC6FA250)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREPINOPERATOR__INITPINCHECKER_OFFSET UNITYSDK_OFFSET(0xC6F9700)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREPINOPERATOR__INIT_OFFSET UNITYSDK_OFFSET(0xC6F9620)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREPINOPERATOR__NOTIFYMODIFYPIN_OFFSET UNITYSDK_OFFSET(0xC6FA980)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREPINOPERATOR__PINRELIC_B__17_0_OFFSET UNITYSDK_OFFSET(0xC6FAA20)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREPINOPERATOR__REQUESTMODIFYPINRELIC_OFFSET UNITYSDK_OFFSET(0xC6FA510)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREPINOPERATOR__UNPINRELIC_B__18_0_OFFSET UNITYSDK_OFFSET(0xC6FAB90)

namespace RPG::Client::RelicSmartSuit
{
	inline static constexpr unsigned int RelicSmartSuitComparePinOperator_TypeDefinitionIndex = 69478;
