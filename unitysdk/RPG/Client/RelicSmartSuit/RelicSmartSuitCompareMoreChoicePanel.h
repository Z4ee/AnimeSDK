...
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREMORECHOICEPANEL_CANCONFIRM_OFFSET UNITYSDK_OFFSET(0x1795C3B0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREMORECHOICEPANEL_CLEARCACHEDDATA_OFFSET UNITYSDK_OFFSET(0x1795BFB0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREMORECHOICEPANEL_CONFIRM_OFFSET UNITYSDK_OFFSET(0x1795C680)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREMORECHOICEPANEL_CREATE_OFFSET UNITYSDK_OFFSET(0x1795BDF0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREMORECHOICEPANEL_GETCONFIRMTEXTID_OFFSET UNITYSDK_OFFSET(0x1795C500)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREMORECHOICEPANEL_GETCURPAGERELICINFOS_OFFSET UNITYSDK_OFFSET(0x1795C260)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREMORECHOICEPANEL_GET_ISSHOW_OFFSET UNITYSDK_OFFSET(0x1795BDD0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREMORECHOICEPANEL_HIDE_OFFSET UNITYSDK_OFFSET(0x1795C140)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREMORECHOICEPANEL_SET_ISSHOW_OFFSET UNITYSDK_OFFSET(0x1795BDE0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREMORECHOICEPANEL_SHOW_OFFSET UNITYSDK_OFFSET(0x1795C100)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREMORECHOICEPANEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1795BEA0)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREMORECHOICEPANEL__INITSTRATEGY_OFFSET UNITYSDK_OFFSET(0x1795BF00)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCOMPAREMORECHOICEPANEL__INIT_OFFSET UNITYSDK_OFFSET(0x1795BEB0)

namespace RPG::Client::RelicSmartSuit
{
	inline static constexpr unsigned int RelicSmartSuitCompareMoreChoicePanel_TypeDefinitionIndex = 74299;
	...
	public:
		...
		::Class_0_16E4307DCC419505_1200* _Strategy; // 0x18
