...
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCALCULATIONRESULTDATA___C__CCTOR_OFFSET UNITYSDK_OFFSET(0xA2B4710)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCALCULATIONRESULTDATA___C__CTOR_OFFSET UNITYSDK_OFFSET(0xA2B4750)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCALCULATIONRESULTDATA___C__GET_RELICINFOLIST_B__32_0_OFFSET UNITYSDK_OFFSET(0xA2B4760)
#define RPG_CLIENT_RELICSMARTSUIT_RELICSMARTSUITCALCULATIONRESULTDATA___C__GET_RELICITEMDATAS_B__34_0_OFFSET UNITYSDK_OFFSET(0xA2B4810)

namespace RPG::Client::RelicSmartSuit
{
	inline static constexpr unsigned int RelicSmartSuitCalculationResultData___c_TypeDefinitionIndex = 61175;
	...
	public:
		...
		{
			return (::System::Comparison_1<::RPG::Client::RelicItemData*>**)Il2CppClass::FromTypeDefinitionIndex(RelicSmartSuitCalculationResultData___c_TypeDefinitionIndex)->GetStaticField(0x138A0);
		}
		static ::RPG::Client::RelicSmartSuit::RelicSmartSuitCalculationResultData___c** StaticGet___9()
		{
			return (::RPG::Client::RelicSmartSuit::RelicSmartSuitCalculationResultData___c**)Il2CppClass::FromTypeDefinitionIndex(RelicSmartSuitCalculationResultData___c_TypeDefinitionIndex)->GetStaticField(0x138A8);
		}
		static ::System::Comparison_1<::RPG::Client::RelicSmartSuit::RelicSmartSuitResultRelicInfo*>** StaticGet___9__32_0()
		{
			return (::System::Comparison_1<::RPG::Client::RelicSmartSuit::RelicSmartSuitResultRelicInfo*>**)Il2CppClass::FromTypeDefinitionIndex(RelicSmartSuitCalculationResultData___c_TypeDefinitionIndex)->GetStaticField(0x138B0);
		}
