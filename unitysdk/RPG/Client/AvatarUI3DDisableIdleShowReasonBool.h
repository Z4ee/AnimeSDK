...
#define RPG_CLIENT_AVATARUI3DDISABLEIDLESHOWREASONBOOL_ISNEEDDISABLE_OFFSET UNITYSDK_OFFSET(0xC8470C0)
#define RPG_CLIENT_AVATARUI3DDISABLEIDLESHOWREASONBOOL_SETDISABLE_OFFSET UNITYSDK_OFFSET(0xC847110)
#define RPG_CLIENT_AVATARUI3DDISABLEIDLESHOWREASONBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0xC8470B0)
