...
#define RPG_CLIENT_AVATARUI3DDISABLEIDLESHOWREASONBOOL_ISNEEDDISABLE_OFFSET UNITYSDK_OFFSET(0x915E3F0)
#define RPG_CLIENT_AVATARUI3DDISABLEIDLESHOWREASONBOOL_SETDISABLE_OFFSET UNITYSDK_OFFSET(0x915E440)
#define RPG_CLIENT_AVATARUI3DDISABLEIDLESHOWREASONBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x915E3E0)

namespace RPG::Client
{
	inline static constexpr unsigned int AvatarUI3DDisableIdleShowReasonBool_TypeDefinitionIndex = 50783;
