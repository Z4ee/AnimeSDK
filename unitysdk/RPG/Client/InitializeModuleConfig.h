...
#define RPG_CLIENT_INITIALIZEMODULECONFIG_METHOD_4_2BF4648671111A7E_OFFSET UNITYSDK_OFFSET(0x16C2F310)
#define RPG_CLIENT_INITIALIZEMODULECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16C2F360)

namespace RPG::Client
{
	inline static constexpr unsigned int InitializeModuleConfig_TypeDefinitionIndex = 66552;
