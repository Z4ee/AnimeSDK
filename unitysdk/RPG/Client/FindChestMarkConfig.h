...
#define RPG_CLIENT_FINDCHESTMARKCONFIG_GETGOTOMAPPARAM_OFFSET UNITYSDK_OFFSET(0xD7140)
#define RPG_CLIENT_FINDCHESTMARKCONFIG_GETICONATTACHCONFIG_OFFSET UNITYSDK_OFFSET(0xD7150)
#define RPG_CLIENT_FINDCHESTMARKCONFIG__CHECKNEEDREPLACE_OFFSET UNITYSDK_OFFSET(0xD7160)
#define RPG_CLIENT_FINDCHESTMARKCONFIG__GETCHESTGROUPPROPERTYROW_OFFSET UNITYSDK_OFFSET(0xD7170)
