...
#define RPG_CLIENT_TERRAINVOLUMEBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0x19477720)
#define RPG_CLIENT_TERRAINVOLUMEBEHAVIOR_METHOD_3_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x19477980)
#define RPG_CLIENT_TERRAINVOLUMEBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0x19477800)
#define RPG_CLIENT_TERRAINVOLUMEBEHAVIOR_METHOD_3_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0x19477860)
#define RPG_CLIENT_TERRAINVOLUMEBEHAVIOR_METHOD_3_4343F372F34C05BF_3_OFFSET UNITYSDK_OFFSET(0x194778C0)
#define RPG_CLIENT_TERRAINVOLUMEBEHAVIOR_METHOD_3_4343F372F34C05BF_4_OFFSET UNITYSDK_OFFSET(0x19477920)
#define RPG_CLIENT_TERRAINVOLUMEBEHAVIOR_METHOD_3_4343F372F34C05BF_5_OFFSET UNITYSDK_OFFSET(0x194779C0)
#define RPG_CLIENT_TERRAINVOLUMEBEHAVIOR_METHOD_3_4343F372F34C05BF_6_OFFSET UNITYSDK_OFFSET(0x19477B50)
#define RPG_CLIENT_TERRAINVOLUMEBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x194777A0)
#define RPG_CLIENT_TERRAINVOLUMEBEHAVIOR_METHOD_3_51CFFE2AF748ECD7_OFFSET UNITYSDK_OFFSET(0x194775E0)
#define RPG_CLIENT_TERRAINVOLUMEBEHAVIOR_METHOD_3_90C2A6D9F95BF55B_OFFSET UNITYSDK_OFFSET(0x19477C70)
#define RPG_CLIENT_TERRAINVOLUMEBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0x19477A20)
#define RPG_CLIENT_TERRAINVOLUMEBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x19477D40)

namespace RPG::Client
{
	inline static constexpr unsigned int TerrainVolumeBehavior_TypeDefinitionIndex = 67829;
