...
#define RPG_CLIENT_TERRAINVOLUMEBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0xE1C7260)
#define RPG_CLIENT_TERRAINVOLUMEBEHAVIOR_METHOD_3_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xE1C7480)
#define RPG_CLIENT_TERRAINVOLUMEBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0xE1C7300)
#define RPG_CLIENT_TERRAINVOLUMEBEHAVIOR_METHOD_3_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0xE1C7360)
#define RPG_CLIENT_TERRAINVOLUMEBEHAVIOR_METHOD_3_4343F372F34C05BF_3_OFFSET UNITYSDK_OFFSET(0xE1C73C0)
#define RPG_CLIENT_TERRAINVOLUMEBEHAVIOR_METHOD_3_4343F372F34C05BF_4_OFFSET UNITYSDK_OFFSET(0xE1C7420)
#define RPG_CLIENT_TERRAINVOLUMEBEHAVIOR_METHOD_3_4343F372F34C05BF_5_OFFSET UNITYSDK_OFFSET(0xE1C74C0)
#define RPG_CLIENT_TERRAINVOLUMEBEHAVIOR_METHOD_3_4343F372F34C05BF_6_OFFSET UNITYSDK_OFFSET(0xE1C7650)
#define RPG_CLIENT_TERRAINVOLUMEBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xE1C72A0)
#define RPG_CLIENT_TERRAINVOLUMEBEHAVIOR_METHOD_3_90C2A6D9F95BF55B_OFFSET UNITYSDK_OFFSET(0xE1C7770)
#define RPG_CLIENT_TERRAINVOLUMEBEHAVIOR_METHOD_3_E7EF6BC52B28648C_OFFSET UNITYSDK_OFFSET(0xE1C7150)
#define RPG_CLIENT_TERRAINVOLUMEBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0xE1C7520)
#define RPG_CLIENT_TERRAINVOLUMEBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0xE1C7840)
