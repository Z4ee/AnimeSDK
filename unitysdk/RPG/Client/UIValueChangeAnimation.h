...
#define RPG_CLIENT_UIVALUECHANGEANIMATION_AWAKE_OFFSET UNITYSDK_OFFSET(0x1831F340)
#define RPG_CLIENT_UIVALUECHANGEANIMATION_CONTINUE_OFFSET UNITYSDK_OFFSET(0x1831F650)
#define RPG_CLIENT_UIVALUECHANGEANIMATION_GET_ISPLAYING_OFFSET UNITYSDK_OFFSET(0x1831FB00)
#define RPG_CLIENT_UIVALUECHANGEANIMATION_PLAY_OFFSET UNITYSDK_OFFSET(0x1831F590)
#define RPG_CLIENT_UIVALUECHANGEANIMATION_SETFINISHCALLBACK_OFFSET UNITYSDK_OFFSET(0x1831F9B0)
#define RPG_CLIENT_UIVALUECHANGEANIMATION_SETVALUECHANGECALLBACK_OFFSET UNITYSDK_OFFSET(0x1831F960)
#define RPG_CLIENT_UIVALUECHANGEANIMATION_STOP_OFFSET UNITYSDK_OFFSET(0x1831F890)
#define RPG_CLIENT_UIVALUECHANGEANIMATION_UPDATE_OFFSET UNITYSDK_OFFSET(0x1831F3F0)
#define RPG_CLIENT_UIVALUECHANGEANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1831FB10)
#define RPG_CLIENT_UIVALUECHANGEANIMATION__EVALUATE_OFFSET UNITYSDK_OFFSET(0x1831F4F0)
#define RPG_CLIENT_UIVALUECHANGEANIMATION__PLAYNEXTANIMCLIP_OFFSET UNITYSDK_OFFSET(0x1831FA00)

namespace RPG::Client
{
	inline static constexpr unsigned int UIValueChangeAnimation_TypeDefinitionIndex = 66043;
