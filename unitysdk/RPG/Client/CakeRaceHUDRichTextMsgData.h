...
#define RPG_CLIENT_CAKERACEHUDRICHTEXTMSGDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1C64B2F0)
#define RPG_CLIENT_CAKERACEHUDRICHTEXTMSGDATA_GETPARTICIPANT_OFFSET UNITYSDK_OFFSET(0x1C64B5A0)
#define RPG_CLIENT_CAKERACEHUDRICHTEXTMSGDATA_GETTEXTID_OFFSET UNITYSDK_OFFSET(0x1C64B4E0)
#define RPG_CLIENT_CAKERACEHUDRICHTEXTMSGDATA_GETTEXTPARAMS_OFFSET UNITYSDK_OFFSET(0x1C64B540)
#define RPG_CLIENT_CAKERACEHUDRICHTEXTMSGDATA_GETTEXTSTR_OFFSET UNITYSDK_OFFSET(0x1C64B3A0)
#define RPG_CLIENT_CAKERACEHUDRICHTEXTMSGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1C64B390)

namespace RPG::Client
{
	inline static constexpr unsigned int CakeRaceHUDRichTextMsgData_TypeDefinitionIndex = 63128;

	class CakeRaceHUDRichTextMsgData : public ::System::Object
	{
	public:
		::Class_3_FA020C2C23A72B3F* _Services; // 0x10
