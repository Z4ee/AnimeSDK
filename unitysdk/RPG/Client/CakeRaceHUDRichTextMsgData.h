...
#define RPG_CLIENT_CAKERACEHUDRICHTEXTMSGDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xB4A0730)
#define RPG_CLIENT_CAKERACEHUDRICHTEXTMSGDATA_GETPARTICIPANT_OFFSET UNITYSDK_OFFSET(0xB4A09D0)
#define RPG_CLIENT_CAKERACEHUDRICHTEXTMSGDATA_GETTEXTID_OFFSET UNITYSDK_OFFSET(0xB4A0910)
#define RPG_CLIENT_CAKERACEHUDRICHTEXTMSGDATA_GETTEXTPARAMS_OFFSET UNITYSDK_OFFSET(0xB4A0970)
#define RPG_CLIENT_CAKERACEHUDRICHTEXTMSGDATA_GETTEXTSTR_OFFSET UNITYSDK_OFFSET(0xB4A07E0)
#define RPG_CLIENT_CAKERACEHUDRICHTEXTMSGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB4A07D0)

namespace RPG::Client
{
	inline static constexpr unsigned int CakeRaceHUDRichTextMsgData_TypeDefinitionIndex = 59009;
