...
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_MESSAGE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0xD6D5D90)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_MESSAGE_EQUALS_OFFSET UNITYSDK_OFFSET(0xD6D5CE0)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_MESSAGE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xD6D5EB0)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_MESSAGE_GET_CONDITIONTEXT_OFFSET UNITYSDK_OFFSET(0xD6D5F30)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_MESSAGE_GET_MESSAGEGROUPID_OFFSET UNITYSDK_OFFSET(0xD6D5F20)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_MESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0xD6D5CD0)
