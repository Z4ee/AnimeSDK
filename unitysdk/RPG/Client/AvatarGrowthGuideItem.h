...
#define RPG_CLIENT_AVATARGROWTHGUIDEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x9DA15A0)

namespace RPG::Client
{
	inline static constexpr unsigned int AvatarGrowthGuideItem_TypeDefinitionIndex = 60344;
