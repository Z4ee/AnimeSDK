...
#define RPG_CLIENT_CAMERADYNAMICOFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0xB4BA120)

namespace RPG::Client
{
	inline static constexpr unsigned int CameraDynamicOffset_TypeDefinitionIndex = 65179;
