...
#define RPG_CLIENT_CAMERADYNAMICOFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x9259CF0)

namespace RPG::Client
{
	inline static constexpr unsigned int CameraDynamicOffset_TypeDefinitionIndex = 57008;
