...
#define RPG_CLIENT_CAMERADYNAMICOFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x9F1D950)

namespace RPG::Client
{
	inline static constexpr unsigned int CameraDynamicOffset_TypeDefinitionIndex = 64258;
