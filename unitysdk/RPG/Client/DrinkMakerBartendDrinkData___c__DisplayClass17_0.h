...
#define RPG_CLIENT_DRINKMAKERBARTENDDRINKDATA___C__DISPLAYCLASS17_0__CTOR_OFFSET UNITYSDK_OFFSET(0x94FFAE0)
#define RPG_CLIENT_DRINKMAKERBARTENDDRINKDATA___C__DISPLAYCLASS17_0__GETQUANTIFYTAGBYTYPE_B__0_OFFSET UNITYSDK_OFFSET(0x94FFAF0)

namespace RPG::Client
{
	inline static constexpr unsigned int DrinkMakerBartendDrinkData___c__DisplayClass17_0_TypeDefinitionIndex = 51645;
