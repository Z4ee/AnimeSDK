...
#define RPG_CLIENT_STATESTANDBYBREAK_METHOD_4_CE3CD1D1492D0382_OFFSET UNITYSDK_OFFSET(0x1A5051D0)
#define RPG_CLIENT_STATESTANDBYBREAK_METHOD_4_E60607EEEA67A558_OFFSET UNITYSDK_OFFSET(0x1A505600)
#define RPG_CLIENT_STATESTANDBYBREAK_METHOD_4_EEFE3CA8386BEC1A_OFFSET UNITYSDK_OFFSET(0x1A505520)
#define RPG_CLIENT_STATESTANDBYBREAK_METHOD_4_F5030600344F3898_OFFSET UNITYSDK_OFFSET(0x1A505360)
#define RPG_CLIENT_STATESTANDBYBREAK_METHOD_4_FF7B2911BBACA4A9_OFFSET UNITYSDK_OFFSET(0x1A504E50)
#define RPG_CLIENT_STATESTANDBYBREAK_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0x1A504CF0)
#define RPG_CLIENT_STATESTANDBYBREAK_ONSTATEEXIT_OFFSET UNITYSDK_OFFSET(0x1A505740)
#define RPG_CLIENT_STATESTANDBYBREAK_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1A504EC0)
#define RPG_CLIENT_STATESTANDBYBREAK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A505800)

namespace RPG::Client
{
	inline static constexpr unsigned int StateStandByBreak_TypeDefinitionIndex = 68811;
