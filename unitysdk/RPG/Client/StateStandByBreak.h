...
#define RPG_CLIENT_STATESTANDBYBREAK_METHOD_4_CE3CD1D1492D0382_OFFSET UNITYSDK_OFFSET(0x17B69AB0)
#define RPG_CLIENT_STATESTANDBYBREAK_METHOD_4_E60607EEEA67A558_OFFSET UNITYSDK_OFFSET(0x17B69EE0)
#define RPG_CLIENT_STATESTANDBYBREAK_METHOD_4_EEFE3CA8386BEC1A_OFFSET UNITYSDK_OFFSET(0x17B69E00)
#define RPG_CLIENT_STATESTANDBYBREAK_METHOD_4_F5030600344F3898_OFFSET UNITYSDK_OFFSET(0x17B69C40)
#define RPG_CLIENT_STATESTANDBYBREAK_METHOD_4_FF7B2911BBACA4A9_OFFSET UNITYSDK_OFFSET(0x17B69730)
#define RPG_CLIENT_STATESTANDBYBREAK_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0x17B695D0)
#define RPG_CLIENT_STATESTANDBYBREAK_ONSTATEEXIT_OFFSET UNITYSDK_OFFSET(0x17B6A020)
#define RPG_CLIENT_STATESTANDBYBREAK_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0x17B697A0)
#define RPG_CLIENT_STATESTANDBYBREAK__CTOR_OFFSET UNITYSDK_OFFSET(0x17B6A0E0)

namespace RPG::Client
{
	inline static constexpr unsigned int StateStandByBreak_TypeDefinitionIndex = 65773;
