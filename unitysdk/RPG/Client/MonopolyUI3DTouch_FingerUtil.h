...
#define RPG_CLIENT_MONOPOLYUI3DTOUCH_FINGERUTIL_ADDFINGER_OFFSET UNITYSDK_OFFSET(0x195FF010)
#define RPG_CLIENT_MONOPOLYUI3DTOUCH_FINGERUTIL_CLEAR_OFFSET UNITYSDK_OFFSET(0x195FED00)
#define RPG_CLIENT_MONOPOLYUI3DTOUCH_FINGERUTIL_CONTAINFINGER_OFFSET UNITYSDK_OFFSET(0x195FF350)
#define RPG_CLIENT_MONOPOLYUI3DTOUCH_FINGERUTIL_GETFINGERNUM_OFFSET UNITYSDK_OFFSET(0x195FF300)
#define RPG_CLIENT_MONOPOLYUI3DTOUCH_FINGERUTIL_REMOVEFINGER_OFFSET UNITYSDK_OFFSET(0x195FF170)
#define RPG_CLIENT_MONOPOLYUI3DTOUCH_FINGERUTIL__CTOR_OFFSET UNITYSDK_OFFSET(0x195FF800)

namespace RPG::Client
{
	inline static constexpr unsigned int MonopolyUI3DTouch_FingerUtil_TypeDefinitionIndex = 72765;
