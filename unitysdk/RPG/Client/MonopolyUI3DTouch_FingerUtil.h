...
#define RPG_CLIENT_MONOPOLYUI3DTOUCH_FINGERUTIL_ADDFINGER_OFFSET UNITYSDK_OFFSET(0x1954CD00)
#define RPG_CLIENT_MONOPOLYUI3DTOUCH_FINGERUTIL_CLEAR_OFFSET UNITYSDK_OFFSET(0x1954C9F0)
#define RPG_CLIENT_MONOPOLYUI3DTOUCH_FINGERUTIL_CONTAINFINGER_OFFSET UNITYSDK_OFFSET(0x1954D040)
#define RPG_CLIENT_MONOPOLYUI3DTOUCH_FINGERUTIL_GETFINGERNUM_OFFSET UNITYSDK_OFFSET(0x1954CFF0)
#define RPG_CLIENT_MONOPOLYUI3DTOUCH_FINGERUTIL_REMOVEFINGER_OFFSET UNITYSDK_OFFSET(0x1954CE60)
#define RPG_CLIENT_MONOPOLYUI3DTOUCH_FINGERUTIL__CTOR_OFFSET UNITYSDK_OFFSET(0x1954D4F0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonopolyUI3DTouch_FingerUtil_TypeDefinitionIndex = 69537;
