...
#define RPG_CLIENT_MONOPOLYUI3DTOUCH_FINGERUTIL_ADDFINGER_OFFSET UNITYSDK_OFFSET(0xD8AF490)
#define RPG_CLIENT_MONOPOLYUI3DTOUCH_FINGERUTIL_CLEAR_OFFSET UNITYSDK_OFFSET(0xD8AF180)
#define RPG_CLIENT_MONOPOLYUI3DTOUCH_FINGERUTIL_CONTAINFINGER_OFFSET UNITYSDK_OFFSET(0xD8AF7D0)
#define RPG_CLIENT_MONOPOLYUI3DTOUCH_FINGERUTIL_GETFINGERNUM_OFFSET UNITYSDK_OFFSET(0xD8AF780)
#define RPG_CLIENT_MONOPOLYUI3DTOUCH_FINGERUTIL_REMOVEFINGER_OFFSET UNITYSDK_OFFSET(0xD8AF5F0)
#define RPG_CLIENT_MONOPOLYUI3DTOUCH_FINGERUTIL__CTOR_OFFSET UNITYSDK_OFFSET(0xD8AFC80)

namespace RPG::Client
{
	inline static constexpr unsigned int MonopolyUI3DTouch_FingerUtil_TypeDefinitionIndex = 72766;
