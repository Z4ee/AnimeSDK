...
#define RPG_CLIENT_PARTICLESYSTEMCHILDGROUP_METHOD_5_83BE0299944D0F77_OFFSET UNITYSDK_OFFSET(0x1C4F5E00)
#define RPG_CLIENT_PARTICLESYSTEMCHILDGROUP_METHOD_5_E876C8B6D3B840A6_OFFSET UNITYSDK_OFFSET(0x1C4F5960)
#define RPG_CLIENT_PARTICLESYSTEMCHILDGROUP_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1C4F5E90)
#define RPG_CLIENT_PARTICLESYSTEMCHILDGROUP_ONPARENTGROUPALPHACHANGE_OFFSET UNITYSDK_OFFSET(0x1C4F5520)
#define RPG_CLIENT_PARTICLESYSTEMCHILDGROUP_START_OFFSET UNITYSDK_OFFSET(0x1C4F5910)
#define RPG_CLIENT_PARTICLESYSTEMCHILDGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4F61C0)
