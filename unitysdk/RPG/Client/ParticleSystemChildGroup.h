...
#define RPG_CLIENT_PARTICLESYSTEMCHILDGROUP_METHOD_5_71912DBB0D113575_OFFSET UNITYSDK_OFFSET(0x9F1A160)
#define RPG_CLIENT_PARTICLESYSTEMCHILDGROUP_METHOD_5_E876C8B6D3B840A6_OFFSET UNITYSDK_OFFSET(0x9F19D50)
#define RPG_CLIENT_PARTICLESYSTEMCHILDGROUP_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9F1A1F0)
#define RPG_CLIENT_PARTICLESYSTEMCHILDGROUP_ONPARENTGROUPALPHACHANGE_OFFSET UNITYSDK_OFFSET(0x9F19960)
#define RPG_CLIENT_PARTICLESYSTEMCHILDGROUP_START_OFFSET UNITYSDK_OFFSET(0x9F19D00)
#define RPG_CLIENT_PARTICLESYSTEMCHILDGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x9F1A4C0)

namespace RPG::Client
{
	inline static constexpr unsigned int ParticleSystemChildGroup_TypeDefinitionIndex = 56372;
