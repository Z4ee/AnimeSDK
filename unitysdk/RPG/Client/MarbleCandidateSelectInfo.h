...
#define RPG_CLIENT_MARBLECANDIDATESELECTINFO_CREATE_OFFSET UNITYSDK_OFFSET(0xD61A780)
#define RPG_CLIENT_MARBLECANDIDATESELECTINFO_GETSKILLDESCCONTENT_OFFSET UNITYSDK_OFFSET(0xD61A8C0)
#define RPG_CLIENT_MARBLECANDIDATESELECTINFO_GET_ENTITYID_OFFSET UNITYSDK_OFFSET(0xD61AE90)
#define RPG_CLIENT_MARBLECANDIDATESELECTINFO_GET_MARBLEID_OFFSET UNITYSDK_OFFSET(0xD61AE50)
#define RPG_CLIENT_MARBLECANDIDATESELECTINFO_GET_MARBLELEVEL_OFFSET UNITYSDK_OFFSET(0xD61AE70)
#define RPG_CLIENT_MARBLECANDIDATESELECTINFO_GET_MARBLESEALICONPATH_OFFSET UNITYSDK_OFFSET(0xD61ABB0)
#define RPG_CLIENT_MARBLECANDIDATESELECTINFO_GET_MARBLESEALNAME_OFFSET UNITYSDK_OFFSET(0xD61ACD0)
#define RPG_CLIENT_MARBLECANDIDATESELECTINFO_GET_PLAYERID_OFFSET UNITYSDK_OFFSET(0xD61AE30)
#define RPG_CLIENT_MARBLECANDIDATESELECTINFO_GET_SKILLICONPATH_OFFSET UNITYSDK_OFFSET(0xD61AC00)
#define RPG_CLIENT_MARBLECANDIDATESELECTINFO_GET_SKILLLEVEL_OFFSET UNITYSDK_OFFSET(0xD61AC70)
#define RPG_CLIENT_MARBLECANDIDATESELECTINFO_GET_SKILLTITLE_OFFSET UNITYSDK_OFFSET(0xD61AD70)
#define RPG_CLIENT_MARBLECANDIDATESELECTINFO_SET_ENTITYID_OFFSET UNITYSDK_OFFSET(0xD61AEA0)
#define RPG_CLIENT_MARBLECANDIDATESELECTINFO_SET_MARBLEID_OFFSET UNITYSDK_OFFSET(0xD61AE60)
#define RPG_CLIENT_MARBLECANDIDATESELECTINFO_SET_MARBLELEVEL_OFFSET UNITYSDK_OFFSET(0xD61AE80)
#define RPG_CLIENT_MARBLECANDIDATESELECTINFO_SET_PLAYERID_OFFSET UNITYSDK_OFFSET(0xD61AE40)
#define RPG_CLIENT_MARBLECANDIDATESELECTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xD61A770)
...
namespace RPG::Client
{
	...
	public:
		...
		::RPG::GameCore::MarbleSealRow* _MarbleSealRow; // 0x20
		...
		::System::UInt32 _PlayerId_k__BackingField; // 0x34
