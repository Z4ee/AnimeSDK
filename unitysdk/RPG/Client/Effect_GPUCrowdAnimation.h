...
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATION_AWAKE_OFFSET UNITYSDK_OFFSET(0xB852590)
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATION_GETMESHLIST_OFFSET UNITYSDK_OFFSET(0xB852990)
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATION_GETMPBLIST_OFFSET UNITYSDK_OFFSET(0xB8529F0)
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATION_GETWORLDMATRIX_OFFSET UNITYSDK_OFFSET(0xB852A50)
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATION_GET_BEHAVIOR_OFFSET UNITYSDK_OFFSET(0xB852BD0)
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATION_GET_CURVECONTROLPOINTS_OFFSET UNITYSDK_OFFSET(0xB852BB0)
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATION_GET_CURVEPOINTS_OFFSET UNITYSDK_OFFSET(0xB852B50)
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATION_GET_HASBEBATCHED_OFFSET UNITYSDK_OFFSET(0xB852AB0)
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATION_GET_INSTANCEINIT_OFFSET UNITYSDK_OFFSET(0xB852AD0)
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATION_GET_PROXYNODE_OFFSET UNITYSDK_OFFSET(0xB852B30)
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATION_GET_TOWARDVECTOR_OFFSET UNITYSDK_OFFSET(0xB852B70)
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATION_LATETICK_OFFSET UNITYSDK_OFFSET(0xB8528E0)
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATION_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB852670)
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATION_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xB852850)
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATION_ONENABLE_OFFSET UNITYSDK_OFFSET(0xB8527C0)
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATION_ONINVISIBLE_OFFSET UNITYSDK_OFFSET(0xB852760)
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATION_ONVISIBLE_OFFSET UNITYSDK_OFFSET(0xB852700)
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATION_SET_CURVECONTROLPOINTS_OFFSET UNITYSDK_OFFSET(0xB852BC0)
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATION_SET_CURVEPOINTS_OFFSET UNITYSDK_OFFSET(0xB852B60)
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATION_SET_HASBEBATCHED_OFFSET UNITYSDK_OFFSET(0xB852AC0)
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATION_SET_INSTANCEINIT_OFFSET UNITYSDK_OFFSET(0xB852B00)
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATION_SET_PROXYNODE_OFFSET UNITYSDK_OFFSET(0xB852B40)
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATION_SET_TOWARDVECTOR_OFFSET UNITYSDK_OFFSET(0xB852B90)
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0xB852BE0)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_GPUCrowdAnimation_TypeDefinitionIndex = 65904;
