...
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATION_AWAKE_OFFSET UNITYSDK_OFFSET(0x954C220)
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATION_GETMESHLIST_OFFSET UNITYSDK_OFFSET(0x954C620)
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATION_GETMPBLIST_OFFSET UNITYSDK_OFFSET(0x954C680)
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATION_GETWORLDMATRIX_OFFSET UNITYSDK_OFFSET(0x954C6E0)
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATION_GET_BEHAVIOR_OFFSET UNITYSDK_OFFSET(0x954C860)
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATION_GET_CURVECONTROLPOINTS_OFFSET UNITYSDK_OFFSET(0x954C840)
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATION_GET_CURVEPOINTS_OFFSET UNITYSDK_OFFSET(0x954C7E0)
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATION_GET_HASBEBATCHED_OFFSET UNITYSDK_OFFSET(0x954C740)
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATION_GET_INSTANCEINIT_OFFSET UNITYSDK_OFFSET(0x954C760)
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATION_GET_PROXYNODE_OFFSET UNITYSDK_OFFSET(0x954C7C0)
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATION_GET_TOWARDVECTOR_OFFSET UNITYSDK_OFFSET(0x954C800)
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATION_LATETICK_OFFSET UNITYSDK_OFFSET(0x954C570)
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATION_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x954C300)
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATION_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x954C4E0)
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATION_ONENABLE_OFFSET UNITYSDK_OFFSET(0x954C450)
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATION_ONINVISIBLE_OFFSET UNITYSDK_OFFSET(0x954C3F0)
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATION_ONVISIBLE_OFFSET UNITYSDK_OFFSET(0x954C390)
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATION_SET_CURVECONTROLPOINTS_OFFSET UNITYSDK_OFFSET(0x954C850)
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATION_SET_CURVEPOINTS_OFFSET UNITYSDK_OFFSET(0x954C7F0)
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATION_SET_HASBEBATCHED_OFFSET UNITYSDK_OFFSET(0x954C750)
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATION_SET_INSTANCEINIT_OFFSET UNITYSDK_OFFSET(0x954C790)
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATION_SET_PROXYNODE_OFFSET UNITYSDK_OFFSET(0x954C7D0)
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATION_SET_TOWARDVECTOR_OFFSET UNITYSDK_OFFSET(0x954C820)
#define RPG_CLIENT_EFFECT_GPUCROWDANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x954C870)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_GPUCrowdAnimation_TypeDefinitionIndex = 57714;
