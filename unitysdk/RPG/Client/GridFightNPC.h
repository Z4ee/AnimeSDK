...
#define RPG_CLIENT_GRIDFIGHTNPC_ADD_ONACTIVECHANGED_OFFSET UNITYSDK_OFFSET(0x1BC50E70)
#define RPG_CLIENT_GRIDFIGHTNPC_CONTAINSTRAIT_OFFSET UNITYSDK_OFFSET(0x1BC50F30)
#define RPG_CLIENT_GRIDFIGHTNPC_CREATEBATTLE_OFFSET UNITYSDK_OFFSET(0x1BC50830)
#define RPG_CLIENT_GRIDFIGHTNPC_CREATE_OFFSET UNITYSDK_OFFSET(0x1BC504C0)
#define RPG_CLIENT_GRIDFIGHTNPC_GET_CANACTIVETRAIT_OFFSET UNITYSDK_OFFSET(0x1BC50E00)
#define RPG_CLIENT_GRIDFIGHTNPC_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0x1BC50DC0)
#define RPG_CLIENT_GRIDFIGHTNPC_GET_EQUIPCOMPONENT_OFFSET UNITYSDK_OFFSET(0x1BC50DA0)
#define RPG_CLIENT_GRIDFIGHTNPC_GET_MEMBERTYPE_OFFSET UNITYSDK_OFFSET(0x1BC50D30)
#define RPG_CLIENT_GRIDFIGHTNPC_GET_ROLEEFFECT_OFFSET UNITYSDK_OFFSET(0x1BC50DE0)
#define RPG_CLIENT_GRIDFIGHTNPC_GET_TRAITCOMPONENT_OFFSET UNITYSDK_OFFSET(0x1BC50D80)
#define RPG_CLIENT_GRIDFIGHTNPC_REMOVE_ONACTIVECHANGED_OFFSET UNITYSDK_OFFSET(0x1BC50ED0)
#define RPG_CLIENT_GRIDFIGHTNPC_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0x1BC50DD0)
#define RPG_CLIENT_GRIDFIGHTNPC_SET_EQUIPCOMPONENT_OFFSET UNITYSDK_OFFSET(0x1BC50DB0)
#define RPG_CLIENT_GRIDFIGHTNPC_SET_ROLEEFFECT_OFFSET UNITYSDK_OFFSET(0x1BC50DF0)
#define RPG_CLIENT_GRIDFIGHTNPC_SET_TRAITCOMPONENT_OFFSET UNITYSDK_OFFSET(0x1BC50D90)
#define RPG_CLIENT_GRIDFIGHTNPC_UPDATE_OFFSET UNITYSDK_OFFSET(0x1BC50C40)
#define RPG_CLIENT_GRIDFIGHTNPC__CONTAINSTRAIT_B__27_0_OFFSET UNITYSDK_OFFSET(0x1BC512E0)
#define RPG_CLIENT_GRIDFIGHTNPC__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC503C0)
#define RPG_CLIENT_GRIDFIGHTNPC__ONEQUIPCOMPONENTCOLLECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1BC51150)
#define RPG_CLIENT_GRIDFIGHTNPC__ONEQUIPCOMPONENTPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1BC51050)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightNPC_TypeDefinitionIndex = 65122;
	...
	public:
		...
		::RPG::Client::GridFightNPCConfig* _Config_k__BackingField; // 0x28
		...
		static ::RPG::Client::GridFightNPC* Create(::Class_1_10F56A639581CEB1_11* a1, ::Class_0_16E4307DCC419505_855* a2)
		{
			return ((::RPG::Client::GridFightNPC*(*)(::Class_1_10F56A639581CEB1_11*, ::Class_0_16E4307DCC419505_855*))((::PBYTE)hIl2Cpp + RPG_CLIENT_GRIDFIGHTNPC_CREATE_OFFSET))(a1, a2);
		}

		static ::RPG::Client::GridFightNPC* CreateBattle(::Class_1_AE4553DBAC72BB2D* a1, ::Class_0_16E4307DCC419505_855* a2)
		{
			return ((::RPG::Client::GridFightNPC*(*)(::Class_1_AE4553DBAC72BB2D*, ::Class_0_16E4307DCC419505_855*))((::PBYTE)hIl2Cpp + RPG_CLIENT_GRIDFIGHTNPC_CREATEBATTLE_OFFSET))(a1, a2);
		}

		::System::Void Update(::Class_1_10F56A639581CEB1_11* a1)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_10F56A639581CEB1_11*))((::PBYTE)hIl2Cpp + RPG_CLIENT_GRIDFIGHTNPC_UPDATE_OFFSET))(this, a1);
		}
