...
#define RPG_CLIENT_MONOPREFABLIGHTFADEINOUTMONOPLUGIN_ISFORBIDFASTFADING_OFFSET UNITYSDK_OFFSET(0x9D28290)
#define RPG_CLIENT_MONOPREFABLIGHTFADEINOUTMONOPLUGIN_SETFADEINOUTINTENSITY_OFFSET UNITYSDK_OFFSET(0x9D281F0)
#define RPG_CLIENT_MONOPREFABLIGHTFADEINOUTMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x9D282D0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoPrefabLightFadeInOutMonoPlugin_TypeDefinitionIndex = 58093;
