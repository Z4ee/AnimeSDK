...
#define RPG_CLIENT_MONOPREFABLIGHTFADEINOUTMONOPLUGIN_ISFORBIDFASTFADING_OFFSET UNITYSDK_OFFSET(0xC1399D0)
#define RPG_CLIENT_MONOPREFABLIGHTFADEINOUTMONOPLUGIN_SETFADEINOUTINTENSITY_OFFSET UNITYSDK_OFFSET(0xC139930)
#define RPG_CLIENT_MONOPREFABLIGHTFADEINOUTMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xC139A10)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoPrefabLightFadeInOutMonoPlugin_TypeDefinitionIndex = 66307;
