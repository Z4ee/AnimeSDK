...
#define RPG_CLIENT_TEXTICONS___C__DISPLAYCLASS13_0__BUILDICONATLAS_B__2_OFFSET UNITYSDK_OFFSET(0x19480540)
#define RPG_CLIENT_TEXTICONS___C__DISPLAYCLASS13_0__CTOR_OFFSET UNITYSDK_OFFSET(0x194804A0)

namespace RPG::Client
{
	inline static constexpr unsigned int TextIcons___c__DisplayClass13_0_TypeDefinitionIndex = 69393;
