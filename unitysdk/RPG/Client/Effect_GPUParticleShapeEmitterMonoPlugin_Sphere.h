...
#define RPG_CLIENT_EFFECT_GPUPARTICLESHAPEEMITTERMONOPLUGIN_SPHERE_METHOD_2_1B30420CE6B88FBA_OFFSET UNITYSDK_OFFSET(0x150F3F20)
#define RPG_CLIENT_EFFECT_GPUPARTICLESHAPEEMITTERMONOPLUGIN_SPHERE_METHOD_2_38DF093766CC711E_1_OFFSET UNITYSDK_OFFSET(0x150F56F0)
#define RPG_CLIENT_EFFECT_GPUPARTICLESHAPEEMITTERMONOPLUGIN_SPHERE_METHOD_2_38DF093766CC711E_OFFSET UNITYSDK_OFFSET(0x150F5BE0)
#define RPG_CLIENT_EFFECT_GPUPARTICLESHAPEEMITTERMONOPLUGIN_SPHERE_METHOD_2_4F2C6507D17C6667_OFFSET UNITYSDK_OFFSET(0x150F5630)
#define RPG_CLIENT_EFFECT_GPUPARTICLESHAPEEMITTERMONOPLUGIN_SPHERE__CTOR_OFFSET UNITYSDK_OFFSET(0x150F60A0)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_GPUParticleShapeEmitterMonoPlugin_Sphere_TypeDefinitionIndex = 67330;
