...
#define RPG_CLIENT_GRIDFIGHTEFFECTCONTROLLER___C__DISPLAYCLASS28_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1A63D0C0)
#define RPG_CLIENT_GRIDFIGHTEFFECTCONTROLLER___C__DISPLAYCLASS28_1__PLAYUPGRADEEFFECT_B__1_OFFSET UNITYSDK_OFFSET(0x1A63EB20)
#define RPG_CLIENT_GRIDFIGHTEFFECTCONTROLLER___C__DISPLAYCLASS28_1__PLAYUPGRADEEFFECT_B__2_OFFSET UNITYSDK_OFFSET(0x1A63EB90)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightEffectController___c__DisplayClass28_1_TypeDefinitionIndex = 61563;

	class GridFightEffectController___c__DisplayClass28_1 : public ::System::Object
	{
	public:
		::RPG::Client::GridFightUpgradeFlyEffect* fly; // 0x10
		::RPG::Client::GridFightEffectController___c__DisplayClass28_0* CS___8__locals1; // 0x18
