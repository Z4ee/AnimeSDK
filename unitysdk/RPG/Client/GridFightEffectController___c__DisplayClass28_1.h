...
#define RPG_CLIENT_GRIDFIGHTEFFECTCONTROLLER___C__DISPLAYCLASS28_1__CTOR_OFFSET UNITYSDK_OFFSET(0xBB0ECD0)
#define RPG_CLIENT_GRIDFIGHTEFFECTCONTROLLER___C__DISPLAYCLASS28_1__PLAYUPGRADEEFFECT_B__1_OFFSET UNITYSDK_OFFSET(0xBB0ECE0)
#define RPG_CLIENT_GRIDFIGHTEFFECTCONTROLLER___C__DISPLAYCLASS28_1__PLAYUPGRADEEFFECT_B__2_OFFSET UNITYSDK_OFFSET(0xBB0ED50)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightEffectController___c__DisplayClass28_1_TypeDefinitionIndex = 60274;
