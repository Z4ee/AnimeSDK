...
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_WORLDLEVEL_EQUALS_1_OFFSET UNITYSDK_OFFSET(0xD6D7430)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_WORLDLEVEL_EQUALS_OFFSET UNITYSDK_OFFSET(0xD6D7380)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_WORLDLEVEL_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xD6D7550)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_WORLDLEVEL_GET_CONDITIONTEXT_OFFSET UNITYSDK_OFFSET(0xD6D75D0)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_WORLDLEVEL_GET_REQUIREDLEVEL_OFFSET UNITYSDK_OFFSET(0xD6D75C0)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_WORLDLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0xD6D7370)
