...
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_WORLDLEVEL_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x16972580)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_WORLDLEVEL_EQUALS_OFFSET UNITYSDK_OFFSET(0x169724D0)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_WORLDLEVEL_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x169726A0)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_WORLDLEVEL_GET_CONDITIONTEXT_OFFSET UNITYSDK_OFFSET(0x16972720)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_WORLDLEVEL_GET_REQUIREDLEVEL_OFFSET UNITYSDK_OFFSET(0x16972710)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_WORLDLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x169724C0)

namespace RPG::Client
{
	inline static constexpr unsigned int MissionChroniclePathUnlockConditionData_WorldLevel_TypeDefinitionIndex = 66171;
