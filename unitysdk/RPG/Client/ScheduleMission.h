...
#define RPG_CLIENT_SCHEDULEMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0xB152850)

namespace RPG::Client
{
	inline static constexpr unsigned int ScheduleMission_TypeDefinitionIndex = 60954;
