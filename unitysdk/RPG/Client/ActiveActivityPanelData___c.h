...
namespace RPG::Client
{
	...
	public:
		...
		::System::Boolean _IsShowNormalRedDot_b__3_0(::RPG::Client::ActiveActivityBenefitData* x)
		{
			return ((::System::Boolean(*)(::PVOID, ::RPG::Client::ActiveActivityBenefitData*))((::PBYTE)hIl2Cpp + RPG_CLIENT_ACTIVEACTIVITYPANELDATA___C__ISSHOWNORMALREDDOT_B__3_0_OFFSET))(this, x);
		}
	};
}
