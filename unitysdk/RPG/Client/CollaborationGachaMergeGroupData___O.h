...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Comparison_1<::RPG::Client::BaseGachaPoolData*>**)Il2CppClass::FromTypeDefinitionIndex(CollaborationGachaMergeGroupData___O_TypeDefinitionIndex)->GetStaticField(0x55930);
		}
	};
}
