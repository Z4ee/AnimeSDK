...
#define RPG_CLIENT_LAYERORDERADJUSTCANVASITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x99745A0)

namespace RPG::Client
{
	inline static constexpr unsigned int LayerOrderAdjustCanvasItem_TypeDefinitionIndex = 59885;
