...
#define RPG_CLIENT_LAYERORDERADJUSTCANVASITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xA664A20)

namespace RPG::Client
{
	inline static constexpr unsigned int LayerOrderAdjustCanvasItem_TypeDefinitionIndex = 67283;
