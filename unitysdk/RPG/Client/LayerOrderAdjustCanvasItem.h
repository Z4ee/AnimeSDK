...
#define RPG_CLIENT_LAYERORDERADJUSTCANVASITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xBD6C1B0)

namespace RPG::Client
{
	inline static constexpr unsigned int LayerOrderAdjustCanvasItem_TypeDefinitionIndex = 68235;
