...
#define RPG_CLIENT_MONOCURVEUNDIRECTEDGRAPH_AWAKE_OFFSET UNITYSDK_OFFSET(0xA924370)
#define RPG_CLIENT_MONOCURVEUNDIRECTEDGRAPH_FINDEDGEBYCURVE_OFFSET UNITYSDK_OFFSET(0xA9251D0)
#define RPG_CLIENT_MONOCURVEUNDIRECTEDGRAPH_FINDEDGEBYNAME_OFFSET UNITYSDK_OFFSET(0xA922440)
#define RPG_CLIENT_MONOCURVEUNDIRECTEDGRAPH_METHOD_5_AE80CBC984AADFD5_OFFSET UNITYSDK_OFFSET(0xA924440)
#define RPG_CLIENT_MONOCURVEUNDIRECTEDGRAPH_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xA9250F0)
#define RPG_CLIENT_MONOCURVEUNDIRECTEDGRAPH__CTOR_OFFSET UNITYSDK_OFFSET(0xA9252E0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoCurveUndirectedGraph_TypeDefinitionIndex = 63236;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_MONOCURVEUNDIRECTEDGRAPH_METHOD_5_AE80CBC984AADFD5_OFFSET))(this);
		}
	};
}
