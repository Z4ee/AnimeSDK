...
#define RPG_CLIENT_MONOCURVEUNDIRECTEDGRAPH_AWAKE_OFFSET UNITYSDK_OFFSET(0x10CC3F40)
#define RPG_CLIENT_MONOCURVEUNDIRECTEDGRAPH_FINDEDGEBYCURVE_OFFSET UNITYSDK_OFFSET(0x10CC4B90)
#define RPG_CLIENT_MONOCURVEUNDIRECTEDGRAPH_FINDEDGEBYNAME_OFFSET UNITYSDK_OFFSET(0x10CC1DF0)
#define RPG_CLIENT_MONOCURVEUNDIRECTEDGRAPH_METHOD_5_2566AD459572DFC3_OFFSET UNITYSDK_OFFSET(0x10CC4010)
#define RPG_CLIENT_MONOCURVEUNDIRECTEDGRAPH_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x10CC4AB0)
#define RPG_CLIENT_MONOCURVEUNDIRECTEDGRAPH__CTOR_OFFSET UNITYSDK_OFFSET(0x10CC4CB0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoCurveUndirectedGraph_TypeDefinitionIndex = 65524;
