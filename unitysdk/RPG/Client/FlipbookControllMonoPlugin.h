...
#define RPG_CLIENT_FLIPBOOKCONTROLLMONOPLUGIN_EVALUATTIMEBYINPUT_OFFSET UNITYSDK_OFFSET(0x97027C0)
#define RPG_CLIENT_FLIPBOOKCONTROLLMONOPLUGIN_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x9702880)
#define RPG_CLIENT_FLIPBOOKCONTROLLMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x97028D0)
#define RPG_CLIENT_FLIPBOOKCONTROLLMONOPLUGIN___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x9702910)

namespace RPG::Client
{
	inline static constexpr unsigned int FlipbookControllMonoPlugin_TypeDefinitionIndex = 57817;
