...
#define RPG_CLIENT_FLIPBOOKCONTROLLMONOPLUGIN_EVALUATTIMEBYINPUT_OFFSET UNITYSDK_OFFSET(0xA3C2D00)
#define RPG_CLIENT_FLIPBOOKCONTROLLMONOPLUGIN_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xA3C2DC0)
#define RPG_CLIENT_FLIPBOOKCONTROLLMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xA3C2E10)
#define RPG_CLIENT_FLIPBOOKCONTROLLMONOPLUGIN___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xA3C2E50)

namespace RPG::Client
{
	inline static constexpr unsigned int FlipbookControllMonoPlugin_TypeDefinitionIndex = 65094;
