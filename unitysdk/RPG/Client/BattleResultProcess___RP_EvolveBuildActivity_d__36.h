...
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_EVOLVEBUILDACTIVITY_D__36_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xB414570)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_EVOLVEBUILDACTIVITY_D__36_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xB4146B0)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_EVOLVEBUILDACTIVITY_D__36_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xB414710)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_EVOLVEBUILDACTIVITY_D__36_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xB4146C0)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_EVOLVEBUILDACTIVITY_D__36_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB414560)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_EVOLVEBUILDACTIVITY_D__36__CTOR_OFFSET UNITYSDK_OFFSET(0xB411680)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleResultProcess___RP_EvolveBuildActivity_d__36_TypeDefinitionIndex = 57027;
