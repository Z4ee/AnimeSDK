...
#define RPG_CLIENT_RELICINTELLIGENTSELLFILTER_RELICRECOMMENDSUBPROPERTYFILTER_FILTER_OFFSET UNITYSDK_OFFSET(0xA2A2250)
#define RPG_CLIENT_RELICINTELLIGENTSELLFILTER_RELICRECOMMENDSUBPROPERTYFILTER_GETDESC_OFFSET UNITYSDK_OFFSET(0xA2A2750)
#define RPG_CLIENT_RELICINTELLIGENTSELLFILTER_RELICRECOMMENDSUBPROPERTYFILTER_GETMAXSELECTCOUNT_OFFSET UNITYSDK_OFFSET(0xA2A2710)
#define RPG_CLIENT_RELICINTELLIGENTSELLFILTER_RELICRECOMMENDSUBPROPERTYFILTER_GET_ISOPENED_OFFSET UNITYSDK_OFFSET(0xA2A21B0)
#define RPG_CLIENT_RELICINTELLIGENTSELLFILTER_RELICRECOMMENDSUBPROPERTYFILTER_GET_MATCHCOUNT_OFFSET UNITYSDK_OFFSET(0xA2A2190)
#define RPG_CLIENT_RELICINTELLIGENTSELLFILTER_RELICRECOMMENDSUBPROPERTYFILTER_ISMATCH_OFFSET UNITYSDK_OFFSET(0xA2A22B0)
#define RPG_CLIENT_RELICINTELLIGENTSELLFILTER_RELICRECOMMENDSUBPROPERTYFILTER_SET_ISOPENED_OFFSET UNITYSDK_OFFSET(0xA2A21C0)
#define RPG_CLIENT_RELICINTELLIGENTSELLFILTER_RELICRECOMMENDSUBPROPERTYFILTER_SET_MATCHCOUNT_OFFSET UNITYSDK_OFFSET(0xA2A21A0)
#define RPG_CLIENT_RELICINTELLIGENTSELLFILTER_RELICRECOMMENDSUBPROPERTYFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0xA2A21D0)
#define RPG_CLIENT_RELICINTELLIGENTSELLFILTER_RELICRECOMMENDSUBPROPERTYFILTER__ISMATCH_OFFSET UNITYSDK_OFFSET(0xA2A24D0)

namespace RPG::Client::RelicIntelligentSellFilter
{
	inline static constexpr unsigned int RelicRecommendSubPropertyFilter_TypeDefinitionIndex = 61206;
	...
	public:
		...
		::System::UInt32 _MatchCount_k__BackingField; // 0x18
		::System::UInt32 _MaxSelectCount; // 0x1C
