...
#define RPG_CLIENT_RELICINTELLIGENTSELLFILTER_RELICMAINPROPERTYFILTER_FILTER_OFFSET UNITYSDK_OFFSET(0xDE26080)
#define RPG_CLIENT_RELICINTELLIGENTSELLFILTER_RELICMAINPROPERTYFILTER_GETDESC_OFFSET UNITYSDK_OFFSET(0xDE26460)
#define RPG_CLIENT_RELICINTELLIGENTSELLFILTER_RELICMAINPROPERTYFILTER_GET_ISOPENED_OFFSET UNITYSDK_OFFSET(0xDE25FB0)
#define RPG_CLIENT_RELICINTELLIGENTSELLFILTER_RELICMAINPROPERTYFILTER_SET_ISOPENED_OFFSET UNITYSDK_OFFSET(0xDE25FC0)
#define RPG_CLIENT_RELICINTELLIGENTSELLFILTER_RELICMAINPROPERTYFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0xDE25FD0)
#define RPG_CLIENT_RELICINTELLIGENTSELLFILTER_RELICMAINPROPERTYFILTER__ISMATCH_OFFSET UNITYSDK_OFFSET(0xDE26330)
#define RPG_CLIENT_RELICINTELLIGENTSELLFILTER_RELICMAINPROPERTYFILTER__ISRECOMMENDMAINPROPERTY_OFFSET UNITYSDK_OFFSET(0xDE260D0)

namespace RPG::Client::RelicIntelligentSellFilter
{
	inline static constexpr unsigned int RelicMainPropertyFilter_TypeDefinitionIndex = 74348;
