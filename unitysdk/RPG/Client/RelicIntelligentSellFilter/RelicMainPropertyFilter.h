...
#define RPG_CLIENT_RELICINTELLIGENTSELLFILTER_RELICMAINPROPERTYFILTER_FILTER_OFFSET UNITYSDK_OFFSET(0x19875190)
#define RPG_CLIENT_RELICINTELLIGENTSELLFILTER_RELICMAINPROPERTYFILTER_GETDESC_OFFSET UNITYSDK_OFFSET(0x198756B0)
#define RPG_CLIENT_RELICINTELLIGENTSELLFILTER_RELICMAINPROPERTYFILTER_GET_ISOPENED_OFFSET UNITYSDK_OFFSET(0x198750C0)
#define RPG_CLIENT_RELICINTELLIGENTSELLFILTER_RELICMAINPROPERTYFILTER_SET_ISOPENED_OFFSET UNITYSDK_OFFSET(0x198750D0)
#define RPG_CLIENT_RELICINTELLIGENTSELLFILTER_RELICMAINPROPERTYFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x198750E0)
#define RPG_CLIENT_RELICINTELLIGENTSELLFILTER_RELICMAINPROPERTYFILTER__ISMATCH_OFFSET UNITYSDK_OFFSET(0x19875440)
#define RPG_CLIENT_RELICINTELLIGENTSELLFILTER_RELICMAINPROPERTYFILTER__ISRECOMMENDMAINPROPERTY_OFFSET UNITYSDK_OFFSET(0x198751E0)

namespace RPG::Client::RelicIntelligentSellFilter
{
	inline static constexpr unsigned int RelicMainPropertyFilter_TypeDefinitionIndex = 71048;
	...
	public:
		...
		::System::UInt32 FlagID; // 0x18
		::System::Boolean _IsOpened_k__BackingField; // 0x1C
