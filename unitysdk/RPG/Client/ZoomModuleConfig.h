...
#define RPG_CLIENT_ZOOMMODULECONFIG_METHOD_4_2BF4648671111A7E_OFFSET UNITYSDK_OFFSET(0xA7A90B0)
#define RPG_CLIENT_ZOOMMODULECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xA7A9100)

namespace RPG::Client
{
	inline static constexpr unsigned int ZoomModuleConfig_TypeDefinitionIndex = 56981;
