...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPHAIRRIMLIGHT_INIT_OFFSET UNITYSDK_OFFSET(0x9CB7240)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPHAIRRIMLIGHT_UNINIT_OFFSET UNITYSDK_OFFSET(0x9CB7AE0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPHAIRRIMLIGHT_UPDATEPROPERTY_OFFSET UNITYSDK_OFFSET(0x9CB72E0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPHAIRRIMLIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x9CB7B80)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPHAIRRIMLIGHT___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0x9CB7BA0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPHAIRRIMLIGHT___IFIXBASEPROXY_UNINIT_OFFSET UNITYSDK_OFFSET(0x9CB7BB0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginCharaPropHairRimLight_TypeDefinitionIndex = 57239;
