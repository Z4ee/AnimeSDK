...
#define RPG_CLIENT_LOOKATSOLVER_CLEAR_OFFSET UNITYSDK_OFFSET(0x18633020)
#define RPG_CLIENT_LOOKATSOLVER_GET_HEADIKROTATION_OFFSET UNITYSDK_OFFSET(0x1863C760)
#define RPG_CLIENT_LOOKATSOLVER_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x186340B0)
#define RPG_CLIENT_LOOKATSOLVER_GET_LOOKATTARGET_OFFSET UNITYSDK_OFFSET(0x1863C780)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_176EDC9D2FA71031_OFFSET UNITYSDK_OFFSET(0x1863BE10)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_218124418542E081_OFFSET UNITYSDK_OFFSET(0x1863B690)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_3BB91AA8A66C2378_OFFSET UNITYSDK_OFFSET(0x18636800)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_486E5C360891CE3D_OFFSET UNITYSDK_OFFSET(0x1863C7C0)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_6409EF8034A68A6B_OFFSET UNITYSDK_OFFSET(0x18637D40)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_834133B9DC560EF2_OFFSET UNITYSDK_OFFSET(0x1863A1A0)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_8CE0803574BB66D7_OFFSET UNITYSDK_OFFSET(0x1863CC10)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_A116C8ED96BD8D99_OFFSET UNITYSDK_OFFSET(0x1863C1F0)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_B45333C63548FF10_OFFSET UNITYSDK_OFFSET(0x18639DF0)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_C69123962DC01A7E_OFFSET UNITYSDK_OFFSET(0x1863B8B0)
#define RPG_CLIENT_LOOKATSOLVER_SET_LOOKATTARGET_OFFSET UNITYSDK_OFFSET(0x1863C7A0)
#define RPG_CLIENT_LOOKATSOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0x1863B0C0)
