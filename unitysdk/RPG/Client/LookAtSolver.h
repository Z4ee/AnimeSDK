...
#define RPG_CLIENT_LOOKATSOLVER_CLEAR_OFFSET UNITYSDK_OFFSET(0xBE6DE40)
#define RPG_CLIENT_LOOKATSOLVER_GET_HEADIKROTATION_OFFSET UNITYSDK_OFFSET(0xBE774D0)
#define RPG_CLIENT_LOOKATSOLVER_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0xBE6EED0)
#define RPG_CLIENT_LOOKATSOLVER_GET_LOOKATTARGET_OFFSET UNITYSDK_OFFSET(0xBE774F0)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_176EDC9D2FA71031_OFFSET UNITYSDK_OFFSET(0xBE76B80)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_218124418542E081_OFFSET UNITYSDK_OFFSET(0xBE76400)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_3BB91AA8A66C2378_OFFSET UNITYSDK_OFFSET(0xBE71580)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_486E5C360891CE3D_OFFSET UNITYSDK_OFFSET(0xBE77530)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_6409EF8034A68A6B_OFFSET UNITYSDK_OFFSET(0xBE72AC0)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_834133B9DC560EF2_OFFSET UNITYSDK_OFFSET(0xBE74F10)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_8CE0803574BB66D7_OFFSET UNITYSDK_OFFSET(0xBE77980)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_A116C8ED96BD8D99_OFFSET UNITYSDK_OFFSET(0xBE76F60)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_B45333C63548FF10_OFFSET UNITYSDK_OFFSET(0xBE74B60)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_C69123962DC01A7E_OFFSET UNITYSDK_OFFSET(0xBE76620)
#define RPG_CLIENT_LOOKATSOLVER_SET_LOOKATTARGET_OFFSET UNITYSDK_OFFSET(0xBE77510)
#define RPG_CLIENT_LOOKATSOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0xBE75E30)

namespace RPG::Client
{
	inline static constexpr unsigned int LookAtSolver_TypeDefinitionIndex = 64052;
