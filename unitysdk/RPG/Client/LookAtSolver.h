...
#define RPG_CLIENT_LOOKATSOLVER_CLEAR_OFFSET UNITYSDK_OFFSET(0x15BDC290)
#define RPG_CLIENT_LOOKATSOLVER_GET_HEADIKROTATION_OFFSET UNITYSDK_OFFSET(0x15BE5920)
#define RPG_CLIENT_LOOKATSOLVER_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x15BDD320)
#define RPG_CLIENT_LOOKATSOLVER_GET_LOOKATTARGET_OFFSET UNITYSDK_OFFSET(0x15BE5940)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_176EDC9D2FA71031_OFFSET UNITYSDK_OFFSET(0x15BE4FD0)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_218124418542E081_OFFSET UNITYSDK_OFFSET(0x15BE4850)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_3BB91AA8A66C2378_OFFSET UNITYSDK_OFFSET(0x15BDF9D0)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_486E5C360891CE3D_OFFSET UNITYSDK_OFFSET(0x15BE5980)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_6409EF8034A68A6B_OFFSET UNITYSDK_OFFSET(0x15BE0F10)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_834133B9DC560EF2_OFFSET UNITYSDK_OFFSET(0x15BE3360)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_8CE0803574BB66D7_OFFSET UNITYSDK_OFFSET(0x15BE5DD0)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_A116C8ED96BD8D99_OFFSET UNITYSDK_OFFSET(0x15BE53B0)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_B45333C63548FF10_OFFSET UNITYSDK_OFFSET(0x15BE2FB0)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_C69123962DC01A7E_OFFSET UNITYSDK_OFFSET(0x15BE4A70)
#define RPG_CLIENT_LOOKATSOLVER_SET_LOOKATTARGET_OFFSET UNITYSDK_OFFSET(0x15BE5960)
#define RPG_CLIENT_LOOKATSOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0x15BE4280)

namespace RPG::Client
{
	inline static constexpr unsigned int LookAtSolver_TypeDefinitionIndex = 65423;
