...
#define RPG_CLIENT_LOOKATSOLVER_CLEAR_OFFSET UNITYSDK_OFFSET(0xA70D440)
#define RPG_CLIENT_LOOKATSOLVER_GET_HEADIKROTATION_OFFSET UNITYSDK_OFFSET(0xA716820)
#define RPG_CLIENT_LOOKATSOLVER_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0xA70E4F0)
#define RPG_CLIENT_LOOKATSOLVER_GET_LOOKATTARGET_OFFSET UNITYSDK_OFFSET(0xA716840)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_6409EF8034A68A6B_OFFSET UNITYSDK_OFFSET(0xA712030)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_6B72D4EE8C6E907F_OFFSET UNITYSDK_OFFSET(0xA715840)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_88BF69F2F98093D5_OFFSET UNITYSDK_OFFSET(0xA7143C0)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_8CE0803574BB66D7_OFFSET UNITYSDK_OFFSET(0xA716CD0)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_9F100D0D149E9A73_OFFSET UNITYSDK_OFFSET(0xA710BD0)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_A116C8ED96BD8D99_OFFSET UNITYSDK_OFFSET(0xA7162A0)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_B45333C63548FF10_OFFSET UNITYSDK_OFFSET(0xA714010)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_EC6B9B01A2C923AD_OFFSET UNITYSDK_OFFSET(0xA716880)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_EF613104545B8E04_OFFSET UNITYSDK_OFFSET(0xA715A40)
#define RPG_CLIENT_LOOKATSOLVER_METHOD_1_F27A64F8FEB174E3_OFFSET UNITYSDK_OFFSET(0xA715F10)
#define RPG_CLIENT_LOOKATSOLVER_SET_LOOKATTARGET_OFFSET UNITYSDK_OFFSET(0xA716860)
#define RPG_CLIENT_LOOKATSOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0xA7152A0)

namespace RPG::Client
{
	inline static constexpr unsigned int LookAtSolver_TypeDefinitionIndex = 63135;
	...
	public:
		...
		::System::Void Method_1_EF613104545B8E04(::System::Single a1, ::System::Int32 a2)
		{
			return ((::System::Void(*)(::PVOID, ::System::Single, ::System::Int32))((::PBYTE)hIl2Cpp + RPG_CLIENT_LOOKATSOLVER_METHOD_1_EF613104545B8E04_OFFSET))(this, a1, a2);
		}
