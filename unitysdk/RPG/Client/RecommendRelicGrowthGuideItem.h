...
#define RPG_CLIENT_RECOMMENDRELICGROWTHGUIDEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x19864840)

namespace RPG::Client
{
	inline static constexpr unsigned int RecommendRelicGrowthGuideItem_TypeDefinitionIndex = 62634;
	...
	public:
		...
		::System::UInt32 OuterSetID1; // 0x38
