...
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FEVERTIMEACTIVITY_D__32_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19FBB070)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FEVERTIMEACTIVITY_D__32_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19FBB120)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FEVERTIMEACTIVITY_D__32_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19FBB180)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FEVERTIMEACTIVITY_D__32_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19FBB130)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FEVERTIMEACTIVITY_D__32_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19FBB060)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FEVERTIMEACTIVITY_D__32__CTOR_OFFSET UNITYSDK_OFFSET(0x19FB57B0)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleResultProcess___RP_FeverTimeActivity_d__32_TypeDefinitionIndex = 58282;
