...
#define RPG_CLIENT_MATCHTHREEGAME___C__DISPLAYCLASS70_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2714E0)
#define RPG_CLIENT_MATCHTHREEGAME___C__DISPLAYCLASS70_0__INITPLAYERS_B__1_OFFSET UNITYSDK_OFFSET(0x1C2766C0)

namespace RPG::Client
{
	inline static constexpr unsigned int MatchThreeGame___c__DisplayClass70_0_TypeDefinitionIndex = 65993;
