...
#define RPG_CLIENT_UVMOVELOOKATSOLVER_METHOD_1_B09E78EE7EE4F8FA_OFFSET UNITYSDK_OFFSET(0xA740BC0)
#define RPG_CLIENT_UVMOVELOOKATSOLVER_METHOD_1_E626BE42DAD16303_OFFSET UNITYSDK_OFFSET(0xA740840)
#define RPG_CLIENT_UVMOVELOOKATSOLVER__CCTOR_OFFSET UNITYSDK_OFFSET(0xA740CE0)
#define RPG_CLIENT_UVMOVELOOKATSOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0xA740CA0)

namespace RPG::Client
{
	inline static constexpr unsigned int UVMoveLookAtSolver_TypeDefinitionIndex = 57520;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UVMoveLookAtSolver_TypeDefinitionIndex)->GetStaticField(0x10F20);
		}
