...
#define RPG_CLIENT_PERMUSICPARAMETERBEAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1864A190)

namespace RPG::Client
{
	inline static constexpr unsigned int PerMusicParameterBeat_TypeDefinitionIndex = 70763;
