...
#define RPG_CLIENT_PERMUSICPARAMETERBEAT__CTOR_OFFSET UNITYSDK_OFFSET(0xC35A1B0)

namespace RPG::Client
{
	inline static constexpr unsigned int PerMusicParameterBeat_TypeDefinitionIndex = 66215;
