...
#define RPG_CLIENT_PERMUSICPARAMETERBEAT__CTOR_OFFSET UNITYSDK_OFFSET(0x9F24E60)

namespace RPG::Client
{
	inline static constexpr unsigned int PerMusicParameterBeat_TypeDefinitionIndex = 58001;
