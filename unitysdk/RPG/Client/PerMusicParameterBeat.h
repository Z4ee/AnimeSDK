...
#define RPG_CLIENT_PERMUSICPARAMETERBEAT__CTOR_OFFSET UNITYSDK_OFFSET(0xAC49BD0)

namespace RPG::Client
{
	inline static constexpr unsigned int PerMusicParameterBeat_TypeDefinitionIndex = 65288;
