...
#define RPG_CLIENT_STATESPECIALIDLETIMER_METHOD_5_00B48D91709955E0_OFFSET UNITYSDK_OFFSET(0xC9290B0)
#define RPG_CLIENT_STATESPECIALIDLETIMER_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0xC928F20)
#define RPG_CLIENT_STATESPECIALIDLETIMER__CTOR_OFFSET UNITYSDK_OFFSET(0xC929140)
#define RPG_CLIENT_STATESPECIALIDLETIMER___IFIXBASEPROXY_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0xC929150)

namespace RPG::Client
{
	inline static constexpr unsigned int StateSpecialIdleTimer_TypeDefinitionIndex = 64401;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::Animator*, ::UnityEngine::AnimatorStateInfo, ::System::Int32))((::PBYTE)hIl2Cpp + RPG_CLIENT_STATESPECIALIDLETIMER___IFIXBASEPROXY_ONSTATEUPDATE_OFFSET))(this, a1, a2, a3);
		}
	};
}
