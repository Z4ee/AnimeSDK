...
#define RPG_CLIENT_STATESPECIALIDLETIMER_METHOD_5_00B48D91709955E0_OFFSET UNITYSDK_OFFSET(0xB1D01A0)
#define RPG_CLIENT_STATESPECIALIDLETIMER_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0xB1D0010)
#define RPG_CLIENT_STATESPECIALIDLETIMER__CTOR_OFFSET UNITYSDK_OFFSET(0xB1D0230)
#define RPG_CLIENT_STATESPECIALIDLETIMER___IFIXBASEPROXY_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0xB1D0240)

namespace RPG::Client
{
	inline static constexpr unsigned int StateSpecialIdleTimer_TypeDefinitionIndex = 63484;
