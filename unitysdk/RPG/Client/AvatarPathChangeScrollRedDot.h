...
#define RPG_CLIENT_AVATARPATHCHANGESCROLLREDDOT_ADDITEMREDDOTROOT_OFFSET UNITYSDK_OFFSET(0x19EC2290)
#define RPG_CLIENT_AVATARPATHCHANGESCROLLREDDOT_CLEARITEMREDDOTROOTLIST_OFFSET UNITYSDK_OFFSET(0x19EC2340)
#define RPG_CLIENT_AVATARPATHCHANGESCROLLREDDOT_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x19EC23B0)
#define RPG_CLIENT_AVATARPATHCHANGESCROLLREDDOT__CTOR_OFFSET UNITYSDK_OFFSET(0x19EC28C0)
#define RPG_CLIENT_AVATARPATHCHANGESCROLLREDDOT__ISSHOWINGREDDOT_OFFSET UNITYSDK_OFFSET(0x19EC27E0)
#define RPG_CLIENT_AVATARPATHCHANGESCROLLREDDOT__REFRESHSCROLLREDDOT_OFFSET UNITYSDK_OFFSET(0x19EC2550)

namespace RPG::Client
{
	inline static constexpr unsigned int AvatarPathChangeScrollRedDot_TypeDefinitionIndex = 71301;
