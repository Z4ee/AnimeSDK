...
#define RPG_CLIENT_ROGUETOURNBUILDREFINFO___C__DISPLAYCLASS9_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1984A850)
#define RPG_CLIENT_ROGUETOURNBUILDREFINFO___C__DISPLAYCLASS9_0__PREPAREFAVORITEBUILDREF_B__0_OFFSET UNITYSDK_OFFSET(0x1984C3C0)
#define RPG_CLIENT_ROGUETOURNBUILDREFINFO___C__DISPLAYCLASS9_0__PREPAREFAVORITEBUILDREF_B__1_OFFSET UNITYSDK_OFFSET(0x1984C4A0)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueTournBuildRefInfo___c__DisplayClass9_0_TypeDefinitionIndex = 64532;
	...
	public:
		...
		::RPG::Client::Promises::Promise_1<::System::Boolean>* promise; // 0x20
