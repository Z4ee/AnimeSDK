...
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_GET_BATTLECOUNT_OFFSET UNITYSDK_OFFSET(0xDBA2240)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_GET_CHALLENGEBUFFID1_OFFSET UNITYSDK_OFFSET(0xDBA2350)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_GET_CHALLENGEBUFFID2_OFFSET UNITYSDK_OFFSET(0xDBA2370)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_GET_CHALLENGEID_OFFSET UNITYSDK_OFFSET(0xDBA1F30)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_GET_CHALLENGEMEMBERS1_OFFSET UNITYSDK_OFFSET(0xDBA23A0)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_GET_CHALLENGEMEMBERS2_OFFSET UNITYSDK_OFFSET(0xDBA23C0)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_GET_CHALLENGENAME_OFFSET UNITYSDK_OFFSET(0xDBA2090)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_GET_CHALLENGEPROGRESSCOUNT_OFFSET UNITYSDK_OFFSET(0xDBA21C0)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_GET_CHALLENGEROW_OFFSET UNITYSDK_OFFSET(0xDBA1F70)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_GET_CHALLENGESCORE_OFFSET UNITYSDK_OFFSET(0xDBA22F0)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_GET_CHALLENGESTARCOUNT_OFFSET UNITYSDK_OFFSET(0xDBA2330)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_GET_CHALLENGETURN_OFFSET UNITYSDK_OFFSET(0xDBA2310)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_GET_CURRENTPROGRESSCOUNT_OFFSET UNITYSDK_OFFSET(0xDBA21E0)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_GET_CURRENTSTARCOUNT_OFFSET UNITYSDK_OFFSET(0xDBA2200)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_GET_DISPLAYTYPE_OFFSET UNITYSDK_OFFSET(0xDBA24D0)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0xDBA1F10)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_GET_GROUPNAME_OFFSET UNITYSDK_OFFSET(0xDBA1FD0)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_GET_GROUPROW_OFFSET UNITYSDK_OFFSET(0xDBA1860)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_GET_GROUPTYPE_OFFSET UNITYSDK_OFFSET(0xDBA1F50)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_GET_HASRECORD_OFFSET UNITYSDK_OFFSET(0xDBA1EB0)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_GET_ISNEWUPDATE_OFFSET UNITYSDK_OFFSET(0xDBA23E0)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_GET_ISSHOWTIERCERECORD_OFFSET UNITYSDK_OFFSET(0xDBA25A0)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_GET_NORMALCHALLENGETIMES_OFFSET UNITYSDK_OFFSET(0xDBA2220)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_GET_TIERCERECORD_OFFSET UNITYSDK_OFFSET(0xDBA2390)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_GET_TOTALPROGRESSCOUNT_OFFSET UNITYSDK_OFFSET(0xDBA2150)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_GET_TOTALSTARCOUNT_OFFSET UNITYSDK_OFFSET(0xDBA2170)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_SET_CHALLENGEBUFFID1_OFFSET UNITYSDK_OFFSET(0xDBA2360)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_SET_CHALLENGEBUFFID2_OFFSET UNITYSDK_OFFSET(0xDBA2380)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_SET_CHALLENGEID_OFFSET UNITYSDK_OFFSET(0xDBA1F40)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_SET_CHALLENGEMEMBERS1_OFFSET UNITYSDK_OFFSET(0xDBA23B0)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_SET_CHALLENGEMEMBERS2_OFFSET UNITYSDK_OFFSET(0xDBA23D0)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_SET_CHALLENGEPROGRESSCOUNT_OFFSET UNITYSDK_OFFSET(0xDBA21D0)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_SET_CHALLENGESCORE_OFFSET UNITYSDK_OFFSET(0xDBA2300)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_SET_CHALLENGESTARCOUNT_OFFSET UNITYSDK_OFFSET(0xDBA2340)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_SET_CHALLENGETURN_OFFSET UNITYSDK_OFFSET(0xDBA2320)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_SET_CURRENTPROGRESSCOUNT_OFFSET UNITYSDK_OFFSET(0xDBA21F0)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_SET_CURRENTSTARCOUNT_OFFSET UNITYSDK_OFFSET(0xDBA2210)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_SET_GROUPID_OFFSET UNITYSDK_OFFSET(0xDBA1F20)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_SET_GROUPTYPE_OFFSET UNITYSDK_OFFSET(0xDBA1F60)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_SET_NORMALCHALLENGETIMES_OFFSET UNITYSDK_OFFSET(0xDBA2230)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_SET_TOTALPROGRESSCOUNT_OFFSET UNITYSDK_OFFSET(0xDBA2160)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA_SYNC_OFFSET UNITYSDK_OFFSET(0xDBA0830)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xDBA2670)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA__GETAVATAR_OFFSET UNITYSDK_OFFSET(0xDBA17E0)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA__GETCURRENTSTARCOUNT_OFFSET UNITYSDK_OFFSET(0xDBA0CD0)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA__SYNCLINEUP_OFFSET UNITYSDK_OFFSET(0xDBA0E40)
#define RPG_CLIENT_PLAYERCHALLENGERECORDDATA__SYNCTIERCE_OFFSET UNITYSDK_OFFSET(0xDBA09B0)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::Int32 _TotalProgressCount_k__BackingField; // 0x28
		::System::UInt32 _NormalChallengeTimes_k__BackingField; // 0x2C
		::System::UInt32 _ChallengeStarCount_k__BackingField; // 0x30
		::System::Int32 _ChallengeProgressCount_k__BackingField; // 0x34
		::System::UInt32 _ChallengeBuffID1_k__BackingField; // 0x38
		::System::Int32 _CurrentStarCount_k__BackingField; // 0x3C
		::System::UInt32 _ChallengeBuffID2_k__BackingField; // 0x40
		...
		::System::UInt32 _ChallengeID_k__BackingField; // 0x54
