...
#define RPG_CLIENT_TRACKPHOTOREDDOTFILTER_GETNEWSTAGEIDS_OFFSET UNITYSDK_OFFSET(0xA5E5630)
#define RPG_CLIENT_TRACKPHOTOREDDOTFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0xA5E5830)

namespace RPG::Client
{
	inline static constexpr unsigned int TrackPhotoRedDotFilter_TypeDefinitionIndex = 54398;
