...
#define RPG_CLIENT_EFFECT_PATHDEFORMMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xA1F8410)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_PathDeformMonoPlugin_TypeDefinitionIndex = 65020;
