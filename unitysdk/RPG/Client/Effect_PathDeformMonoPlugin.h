...
#define RPG_CLIENT_EFFECT_PATHDEFORMMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x9575040)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_PathDeformMonoPlugin_TypeDefinitionIndex = 57756;
