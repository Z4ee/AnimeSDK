...
#define RPG_CLIENT_TEAMMODULE___C__DISPLAYCLASS9_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A399BB0)
#define RPG_CLIENT_TEAMMODULE___C__DISPLAYCLASS9_0__GETSTORYLINETEAM_B__0_OFFSET UNITYSDK_OFFSET(0x1A3A69C0)

namespace RPG::Client
{
	inline static constexpr unsigned int TeamModule___c__DisplayClass9_0_TypeDefinitionIndex = 68126;
