...
#define RPG_CLIENT_LOCALIZATIONMANAGER_ONUIWORLDFONTCHANGE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19AD4590)
#define RPG_CLIENT_LOCALIZATIONMANAGER_ONUIWORLDFONTCHANGE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19AD45E0)
#define RPG_CLIENT_LOCALIZATIONMANAGER_ONUIWORLDFONTCHANGE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19AD4580)
#define RPG_CLIENT_LOCALIZATIONMANAGER_ONUIWORLDFONTCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x19AD4510)

namespace RPG::Client
{
	inline static constexpr unsigned int LocalizationManager_OnUIWorldFontChange_TypeDefinitionIndex = 58617;
