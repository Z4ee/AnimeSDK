...
#define RPG_CLIENT_ROGUEENDLESSACTIVITYDATA___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BC814A0)
#define RPG_CLIENT_ROGUEENDLESSACTIVITYDATA___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC814E0)
#define RPG_CLIENT_ROGUEENDLESSACTIVITYDATA___C___HASNEWAREA_B__5_0_OFFSET UNITYSDK_OFFSET(0x1BC814F0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Func_2<::System::UInt32, ::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(RogueEndlessActivityData___c_TypeDefinitionIndex)->GetStaticField(0x670F0);
		}
		static ::RPG::Client::RogueEndlessActivityData___c** StaticGet___9()
		{
			return (::RPG::Client::RogueEndlessActivityData___c**)Il2CppClass::FromTypeDefinitionIndex(RogueEndlessActivityData___c_TypeDefinitionIndex)->GetStaticField(0x670F8);
		}
