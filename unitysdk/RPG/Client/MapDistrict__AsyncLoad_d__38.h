...
#define RPG_CLIENT_MAPDISTRICT__ASYNCLOAD_D__38_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B54B930)
#define RPG_CLIENT_MAPDISTRICT__ASYNCLOAD_D__38_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_RPG_WORK_IASYNCWORKSTEPRESULT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B54BD60)
#define RPG_CLIENT_MAPDISTRICT__ASYNCLOAD_D__38_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B54BDC0)
#define RPG_CLIENT_MAPDISTRICT__ASYNCLOAD_D__38_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B54BD70)
#define RPG_CLIENT_MAPDISTRICT__ASYNCLOAD_D__38_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B54B920)
#define RPG_CLIENT_MAPDISTRICT__ASYNCLOAD_D__38__CTOR_OFFSET UNITYSDK_OFFSET(0x1B54B0C0)
