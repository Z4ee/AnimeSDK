...
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB729380)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_GET_CURVE_OFFSET UNITYSDK_OFFSET(0xB7285B0)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_GET_DISTANCE_OFFSET UNITYSDK_OFFSET(0xB7235B0)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_GET_GRAPH_OFFSET UNITYSDK_OFFSET(0xB728590)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_GET_MATH_OFFSET UNITYSDK_OFFSET(0xB7285C0)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_GET_NAME_OFFSET UNITYSDK_OFFSET(0xB7285A0)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_METHOD_1_0FDE67E8BCF7203D_OFFSET UNITYSDK_OFFSET(0xB727420)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_METHOD_1_1D700A68EF27EF83_OFFSET UNITYSDK_OFFSET(0xB728E90)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_METHOD_1_3C24F6FFDD40F9E9_OFFSET UNITYSDK_OFFSET(0xB728990)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_METHOD_1_4BB6A1AF1F6E7D3E_OFFSET UNITYSDK_OFFSET(0xB728D80)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_METHOD_1_6D4EED649DB90654_OFFSET UNITYSDK_OFFSET(0xB722DF0)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_METHOD_1_7EEC86D7A31C7C87_OFFSET UNITYSDK_OFFSET(0xB728C50)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_METHOD_1_95DEB009F6EC8741_OFFSET UNITYSDK_OFFSET(0xB728850)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_METHOD_1_A1EB2E3ADE286198_OFFSET UNITYSDK_OFFSET(0xB728AD0)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_METHOD_1_AFC0AF10542FE0A9_OFFSET UNITYSDK_OFFSET(0xB722EE0)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_METHOD_1_B7447ED1D1F41826_OFFSET UNITYSDK_OFFSET(0xB7261A0)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_METHOD_1_D9E7614FB85246A5_OFFSET UNITYSDK_OFFSET(0xB7293C0)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE_TOSTRING_OFFSET UNITYSDK_OFFSET(0xB729340)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE__CTOR_OFFSET UNITYSDK_OFFSET(0xB7285D0)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0xB729870)

namespace RPG::Client
{
	inline static constexpr unsigned int CurveUndirectedEdge_TypeDefinitionIndex = 64149;
	...
	public:
		...
		::System::Void Method_1_4BB6A1AF1F6E7D3E(::RPG::Client::ECurveEdgePoint a1)
		{
			return ((::System::Void(*)(::PVOID, ::RPG::Client::ECurveEdgePoint))((::PBYTE)hIl2Cpp + RPG_CLIENT_CURVEUNDIRECTEDEDGE_METHOD_1_4BB6A1AF1F6E7D3E_OFFSET))(this, a1);
		}

		::System::Void Method_1_1D700A68EF27EF83(::RPG::Client::ECurveEdgePoint a1, ::System::Int32 a2, ::System::Boolean a3)
		{
			return ((::System::Void(*)(::PVOID, ::RPG::Client::ECurveEdgePoint, ::System::Int32, ::System::Boolean))((::PBYTE)hIl2Cpp + RPG_CLIENT_CURVEUNDIRECTEDEDGE_METHOD_1_1D700A68EF27EF83_OFFSET))(this, a1, a2, a3);
		}
