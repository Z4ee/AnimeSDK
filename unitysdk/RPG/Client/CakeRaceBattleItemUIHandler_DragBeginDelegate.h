...
#define RPG_CLIENT_CAKERACEBATTLEITEMUIHANDLER_DRAGBEGINDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x9EF3960)
#define RPG_CLIENT_CAKERACEBATTLEITEMUIHANDLER_DRAGBEGINDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x9EF39D0)
#define RPG_CLIENT_CAKERACEBATTLEITEMUIHANDLER_DRAGBEGINDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x9EF2240)
#define RPG_CLIENT_CAKERACEBATTLEITEMUIHANDLER_DRAGBEGINDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x9EF3940)

namespace RPG::Client
{
	inline static constexpr unsigned int CakeRaceBattleItemUIHandler_DragBeginDelegate_TypeDefinitionIndex = 58036;
