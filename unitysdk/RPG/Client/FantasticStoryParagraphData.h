...
#define RPG_CLIENT_FANTASTICSTORYPARAGRAPHDATA_GET_AVAILABLEBUFFSLOTID_OFFSET UNITYSDK_OFFSET(0xA326EB0)
#define RPG_CLIENT_FANTASTICSTORYPARAGRAPHDATA_GET_BOOKCONTEXTINREWRITTING_OFFSET UNITYSDK_OFFSET(0xA326D50)
#define RPG_CLIENT_FANTASTICSTORYPARAGRAPHDATA_GET_BOOKCONTEXT_OFFSET UNITYSDK_OFFSET(0xA326D20)
#define RPG_CLIENT_FANTASTICSTORYPARAGRAPHDATA_GET_BOOKTITLE_OFFSET UNITYSDK_OFFSET(0xA326D80)
#define RPG_CLIENT_FANTASTICSTORYPARAGRAPHDATA_GET_DEFAULTAVATARDATALIST_OFFSET UNITYSDK_OFFSET(0xA326ED0)
#define RPG_CLIENT_FANTASTICSTORYPARAGRAPHDATA_GET_DISPLAYMONSTERLIST_OFFSET UNITYSDK_OFFSET(0xA326E90)
#define RPG_CLIENT_FANTASTICSTORYPARAGRAPHDATA_GET_ENVBUFFID_OFFSET UNITYSDK_OFFSET(0xA326DD0)
#define RPG_CLIENT_FANTASTICSTORYPARAGRAPHDATA_GET_FIGHTEVENTID_OFFSET UNITYSDK_OFFSET(0xA326DB0)
#define RPG_CLIENT_FANTASTICSTORYPARAGRAPHDATA_GET_FIGUREPATH_OFFSET UNITYSDK_OFFSET(0xA326E50)
#define RPG_CLIENT_FANTASTICSTORYPARAGRAPHDATA_GET_FINISHQUESTID_OFFSET UNITYSDK_OFFSET(0xA326DF0)
#define RPG_CLIENT_FANTASTICSTORYPARAGRAPHDATA_GET_HASREWARDAVAIL_OFFSET UNITYSDK_OFFSET(0xA323A60)
#define RPG_CLIENT_FANTASTICSTORYPARAGRAPHDATA_GET_ISFINISH_OFFSET UNITYSDK_OFFSET(0xA322560)
#define RPG_CLIENT_FANTASTICSTORYPARAGRAPHDATA_GET_ISPRECHAPTERFINISH_OFFSET UNITYSDK_OFFSET(0xA326C50)
#define RPG_CLIENT_FANTASTICSTORYPARAGRAPHDATA_GET_ISPREPARAGRAPHFINISH_OFFSET UNITYSDK_OFFSET(0xA326B30)
#define RPG_CLIENT_FANTASTICSTORYPARAGRAPHDATA_GET_ISQUESTALLCLOSE_OFFSET UNITYSDK_OFFSET(0xA3269D0)
#define RPG_CLIENT_FANTASTICSTORYPARAGRAPHDATA_GET_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0xA31B9A0)
#define RPG_CLIENT_FANTASTICSTORYPARAGRAPHDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xA326CF0)
#define RPG_CLIENT_FANTASTICSTORYPARAGRAPHDATA_GET_QUESTLIST_OFFSET UNITYSDK_OFFSET(0xA326B10)
#define RPG_CLIENT_FANTASTICSTORYPARAGRAPHDATA_GET_RECOMMENDAVATAR_OFFSET UNITYSDK_OFFSET(0xA326E30)
#define RPG_CLIENT_FANTASTICSTORYPARAGRAPHDATA_GET_RECOMMENDNATURE_OFFSET UNITYSDK_OFFSET(0xA326E10)
#define RPG_CLIENT_FANTASTICSTORYPARAGRAPHDATA_GET_SCHEDULEDATA_OFFSET UNITYSDK_OFFSET(0xA31C7E0)
#define RPG_CLIENT_FANTASTICSTORYPARAGRAPHDATA_GET_TRIVIALAVATARIDLIST_OFFSET UNITYSDK_OFFSET(0xA326080)
#define RPG_CLIENT_FANTASTICSTORYPARAGRAPHDATA_GET_TURNLIMIT_OFFSET UNITYSDK_OFFSET(0xA326E70)
#define RPG_CLIENT_FANTASTICSTORYPARAGRAPHDATA_GET_UNLOCKCHAPTERID_OFFSET UNITYSDK_OFFSET(0xA3269B0)
#define RPG_CLIENT_FANTASTICSTORYPARAGRAPHDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA322F20)
