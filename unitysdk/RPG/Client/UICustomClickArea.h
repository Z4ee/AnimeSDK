...
#define RPG_CLIENT_UICUSTOMCLICKAREA_ISRAYCASTLOCATIONVALID_OFFSET UNITYSDK_OFFSET(0xCB43960)
#define RPG_CLIENT_UICUSTOMCLICKAREA_METHOD_5_1A98FB043EC9FF2A_OFFSET UNITYSDK_OFFSET(0xCB43A50)
#define RPG_CLIENT_UICUSTOMCLICKAREA__CTOR_OFFSET UNITYSDK_OFFSET(0xCB43B30)

namespace RPG::Client
{
	inline static constexpr unsigned int UICustomClickArea_TypeDefinitionIndex = 68035;
