...
#define RPG_CLIENT_GAMEOBJECTAUDIO_DODISABLE_OFFSET UNITYSDK_OFFSET(0xD101D20)
#define RPG_CLIENT_GAMEOBJECTAUDIO_DOENABLE_OFFSET UNITYSDK_OFFSET(0xD101BF0)
#define RPG_CLIENT_GAMEOBJECTAUDIO_METHOD_5_211942F2A3D74CCB_OFFSET UNITYSDK_OFFSET(0xD102310)
#define RPG_CLIENT_GAMEOBJECTAUDIO_METHOD_5_2DCDFF29E7FDDAA8_OFFSET UNITYSDK_OFFSET(0xD101D70)
#define RPG_CLIENT_GAMEOBJECTAUDIO_METHOD_5_64501B5CB67A94C3_OFFSET UNITYSDK_OFFSET(0xD101C40)
#define RPG_CLIENT_GAMEOBJECTAUDIO_METHOD_5_77FD543600E00498_OFFSET UNITYSDK_OFFSET(0xD102420)
#define RPG_CLIENT_GAMEOBJECTAUDIO_METHOD_5_98060E4D16CBDFE4_OFFSET UNITYSDK_OFFSET(0xD102510)
#define RPG_CLIENT_GAMEOBJECTAUDIO_METHOD_5_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0xD1024C0)
#define RPG_CLIENT_GAMEOBJECTAUDIO_METHOD_5_BD658202BB4C4431_OFFSET UNITYSDK_OFFSET(0xD102560)
#define RPG_CLIENT_GAMEOBJECTAUDIO_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xD102020)
#define RPG_CLIENT_GAMEOBJECTAUDIO_ONENABLE_OFFSET UNITYSDK_OFFSET(0xD101F80)
#define RPG_CLIENT_GAMEOBJECTAUDIO_ONLIGHTWEIGHTACTIVATE_OFFSET UNITYSDK_OFFSET(0xD102270)
#define RPG_CLIENT_GAMEOBJECTAUDIO_ONLIGHTWEIGHTDEACTIVATE_OFFSET UNITYSDK_OFFSET(0xD1022C0)
#define RPG_CLIENT_GAMEOBJECTAUDIO_UPDATE_OFFSET UNITYSDK_OFFSET(0xD1020B0)
#define RPG_CLIENT_GAMEOBJECTAUDIO__CTOR_OFFSET UNITYSDK_OFFSET(0xD1025B0)
