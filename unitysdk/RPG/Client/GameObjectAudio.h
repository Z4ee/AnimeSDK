...
#define RPG_CLIENT_GAMEOBJECTAUDIO_DODISABLE_OFFSET UNITYSDK_OFFSET(0x975C230)
#define RPG_CLIENT_GAMEOBJECTAUDIO_DOENABLE_OFFSET UNITYSDK_OFFSET(0x975C100)
#define RPG_CLIENT_GAMEOBJECTAUDIO_METHOD_5_211942F2A3D74CCB_OFFSET UNITYSDK_OFFSET(0x975C840)
#define RPG_CLIENT_GAMEOBJECTAUDIO_METHOD_5_2DCDFF29E7FDDAA8_OFFSET UNITYSDK_OFFSET(0x975C280)
#define RPG_CLIENT_GAMEOBJECTAUDIO_METHOD_5_5A94436233800AC6_OFFSET UNITYSDK_OFFSET(0x975CA90)
#define RPG_CLIENT_GAMEOBJECTAUDIO_METHOD_5_64501B5CB67A94C3_OFFSET UNITYSDK_OFFSET(0x975C150)
#define RPG_CLIENT_GAMEOBJECTAUDIO_METHOD_5_77FD543600E00498_OFFSET UNITYSDK_OFFSET(0x975C950)
#define RPG_CLIENT_GAMEOBJECTAUDIO_METHOD_5_98060E4D16CBDFE4_OFFSET UNITYSDK_OFFSET(0x975CA40)
#define RPG_CLIENT_GAMEOBJECTAUDIO_METHOD_5_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0x975C9F0)
#define RPG_CLIENT_GAMEOBJECTAUDIO_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x975C560)
#define RPG_CLIENT_GAMEOBJECTAUDIO_ONENABLE_OFFSET UNITYSDK_OFFSET(0x975C4C0)
#define RPG_CLIENT_GAMEOBJECTAUDIO_ONLIGHTWEIGHTACTIVATE_OFFSET UNITYSDK_OFFSET(0x975C7A0)
#define RPG_CLIENT_GAMEOBJECTAUDIO_ONLIGHTWEIGHTDEACTIVATE_OFFSET UNITYSDK_OFFSET(0x975C7F0)
#define RPG_CLIENT_GAMEOBJECTAUDIO_UPDATE_OFFSET UNITYSDK_OFFSET(0x975C5F0)
#define RPG_CLIENT_GAMEOBJECTAUDIO__CTOR_OFFSET UNITYSDK_OFFSET(0x975CAE0)

namespace RPG::Client
{
	inline static constexpr unsigned int GameObjectAudio_TypeDefinitionIndex = 55864;
	...
	public:
		...
		::System::Void Method_5_5A94436233800AC6()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_GAMEOBJECTAUDIO_METHOD_5_5A94436233800AC6_OFFSET))(this);
		}
