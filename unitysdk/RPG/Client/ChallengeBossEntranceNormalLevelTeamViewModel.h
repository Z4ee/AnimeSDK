...
#define RPG_CLIENT_CHALLENGEBOSSENTRANCENORMALLEVELTEAMVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0x18785680)
#define RPG_CLIENT_CHALLENGEBOSSENTRANCENORMALLEVELTEAMVIEWMODEL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18785710)
#define RPG_CLIENT_CHALLENGEBOSSENTRANCENORMALLEVELTEAMVIEWMODEL_GETLINEUP_OFFSET UNITYSDK_OFFSET(0x18785750)
#define RPG_CLIENT_CHALLENGEBOSSENTRANCENORMALLEVELTEAMVIEWMODEL_GET_BOSSICONPATH_OFFSET UNITYSDK_OFFSET(0x18785490)
#define RPG_CLIENT_CHALLENGEBOSSENTRANCENORMALLEVELTEAMVIEWMODEL_GET_ISPASSED_OFFSET UNITYSDK_OFFSET(0x18785620)
#define RPG_CLIENT_CHALLENGEBOSSENTRANCENORMALLEVELTEAMVIEWMODEL_GET_SCORE_OFFSET UNITYSDK_OFFSET(0x187855A0)
#define RPG_CLIENT_CHALLENGEBOSSENTRANCENORMALLEVELTEAMVIEWMODEL_GET_STAGENUMBER_OFFSET UNITYSDK_OFFSET(0x18785290)
#define RPG_CLIENT_CHALLENGEBOSSENTRANCENORMALLEVELTEAMVIEWMODEL_GET__MONSTERID_OFFSET UNITYSDK_OFFSET(0x187852D0)
#define RPG_CLIENT_CHALLENGEBOSSENTRANCENORMALLEVELTEAMVIEWMODEL_GET__MONSTERROW_OFFSET UNITYSDK_OFFSET(0x18785360)
#define RPG_CLIENT_CHALLENGEBOSSENTRANCENORMALLEVELTEAMVIEWMODEL_GET__MONSTERTEMPLATEROW_OFFSET UNITYSDK_OFFSET(0x187853D0)
#define RPG_CLIENT_CHALLENGEBOSSENTRANCENORMALLEVELTEAMVIEWMODEL_GET__NODEINFO_OFFSET UNITYSDK_OFFSET(0x187854F0)
#define RPG_CLIENT_CHALLENGEBOSSENTRANCENORMALLEVELTEAMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x18785700)

namespace RPG::Client
{
	inline static constexpr unsigned int ChallengeBossEntranceNormalLevelTeamViewModel_TypeDefinitionIndex = 60300;
