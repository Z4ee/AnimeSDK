...
#define RPG_CLIENT_CHALLENGEBOSSENTRANCENORMALLEVELTEAMVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0x18C0C520)
#define RPG_CLIENT_CHALLENGEBOSSENTRANCENORMALLEVELTEAMVIEWMODEL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18C0C5B0)
#define RPG_CLIENT_CHALLENGEBOSSENTRANCENORMALLEVELTEAMVIEWMODEL_GETLINEUP_OFFSET UNITYSDK_OFFSET(0x18C0C5F0)
#define RPG_CLIENT_CHALLENGEBOSSENTRANCENORMALLEVELTEAMVIEWMODEL_GET_BOSSICONPATH_OFFSET UNITYSDK_OFFSET(0x18C0C330)
#define RPG_CLIENT_CHALLENGEBOSSENTRANCENORMALLEVELTEAMVIEWMODEL_GET_ISPASSED_OFFSET UNITYSDK_OFFSET(0x18C0C4C0)
#define RPG_CLIENT_CHALLENGEBOSSENTRANCENORMALLEVELTEAMVIEWMODEL_GET_SCORE_OFFSET UNITYSDK_OFFSET(0x18C0C440)
#define RPG_CLIENT_CHALLENGEBOSSENTRANCENORMALLEVELTEAMVIEWMODEL_GET_STAGENUMBER_OFFSET UNITYSDK_OFFSET(0x18C0C130)
#define RPG_CLIENT_CHALLENGEBOSSENTRANCENORMALLEVELTEAMVIEWMODEL_GET__MONSTERID_OFFSET UNITYSDK_OFFSET(0x18C0C170)
#define RPG_CLIENT_CHALLENGEBOSSENTRANCENORMALLEVELTEAMVIEWMODEL_GET__MONSTERROW_OFFSET UNITYSDK_OFFSET(0x18C0C200)
#define RPG_CLIENT_CHALLENGEBOSSENTRANCENORMALLEVELTEAMVIEWMODEL_GET__MONSTERTEMPLATEROW_OFFSET UNITYSDK_OFFSET(0x18C0C270)
#define RPG_CLIENT_CHALLENGEBOSSENTRANCENORMALLEVELTEAMVIEWMODEL_GET__NODEINFO_OFFSET UNITYSDK_OFFSET(0x18C0C390)
#define RPG_CLIENT_CHALLENGEBOSSENTRANCENORMALLEVELTEAMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x18C0C5A0)
