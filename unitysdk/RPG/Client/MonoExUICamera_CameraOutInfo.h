...
#define RPG_CLIENT_MONOEXUICAMERA_CAMERAOUTINFO_ININNER_OFFSET UNITYSDK_OFFSET(0x1ACD3500)
#define RPG_CLIENT_MONOEXUICAMERA_CAMERAOUTINFO_OUTOUTER_OFFSET UNITYSDK_OFFSET(0x1ACD3BC0)
#define RPG_CLIENT_MONOEXUICAMERA_CAMERAOUTINFO_RESET_OFFSET UNITYSDK_OFFSET(0x1ACD5900)
#define RPG_CLIENT_MONOEXUICAMERA_CAMERAOUTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACD5950)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoExUICamera_CameraOutInfo_TypeDefinitionIndex = 72898;
