...
#define RPG_CLIENT_ROOTMOTIONBAKER__CTOR_OFFSET UNITYSDK_OFFSET(0xC884B70)

namespace RPG::Client
{
	inline static constexpr unsigned int RootMotionBaker_TypeDefinitionIndex = 64374;
