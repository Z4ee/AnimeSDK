...
#define RPG_CLIENT_MONOEMOANIMMOUTHSHAPELAYERCONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0x9CE8170)
#define RPG_CLIENT_MONOEMOANIMMOUTHSHAPELAYERCONTROLLER_GET_ANIMLAYERWEIGHT_OFFSET UNITYSDK_OFFSET(0x9CE84E0)
#define RPG_CLIENT_MONOEMOANIMMOUTHSHAPELAYERCONTROLLER_GET_ANIMPARAMS_OFFSET UNITYSDK_OFFSET(0x9CE8540)
#define RPG_CLIENT_MONOEMOANIMMOUTHSHAPELAYERCONTROLLER_ONAUDIOLANGUAGECHANGED_OFFSET UNITYSDK_OFFSET(0x9CE8230)
#define RPG_CLIENT_MONOEMOANIMMOUTHSHAPELAYERCONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9CE81D0)
#define RPG_CLIENT_MONOEMOANIMMOUTHSHAPELAYERCONTROLLER_PLAY_OFFSET UNITYSDK_OFFSET(0x9CE82C0)
#define RPG_CLIENT_MONOEMOANIMMOUTHSHAPELAYERCONTROLLER_SETUPFRAMEDELTATIME_OFFSET UNITYSDK_OFFSET(0x9CE83F0)
#define RPG_CLIENT_MONOEMOANIMMOUTHSHAPELAYERCONTROLLER_STOP_OFFSET UNITYSDK_OFFSET(0x9CE8350)
#define RPG_CLIENT_MONOEMOANIMMOUTHSHAPELAYERCONTROLLER_TICK_OFFSET UNITYSDK_OFFSET(0x9CE8470)
#define RPG_CLIENT_MONOEMOANIMMOUTHSHAPELAYERCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9CE85B0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEmoAnimMouthShapeLayerController_TypeDefinitionIndex = 58279;
