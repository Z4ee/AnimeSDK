...
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL_AWAKE_OFFSET UNITYSDK_OFFSET(0x18085280)
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL_METHOD_5_2A4F3E470B1283DD_OFFSET UNITYSDK_OFFSET(0x18085550)
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL_METHOD_5_40E03D354D1ACC85_OFFSET UNITYSDK_OFFSET(0x18085D80)
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL_METHOD_5_5B06CEE7A34B50AD_OFFSET UNITYSDK_OFFSET(0x180877C0)
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL_METHOD_5_96189EDEF38976A6_1_OFFSET UNITYSDK_OFFSET(0x18086B90)
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL_METHOD_5_96189EDEF38976A6_OFFSET UNITYSDK_OFFSET(0x18086270)
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL_METHOD_5_B50CA01B5EDC1228_OFFSET UNITYSDK_OFFSET(0x180876E0)
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL_METHOD_5_F2BB8CA4A5596DD6_OFFSET UNITYSDK_OFFSET(0x18087420)
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL_REBUILDLINE_OFFSET UNITYSDK_OFFSET(0x18085350)
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL_UPDATEPOINTS_OFFSET UNITYSDK_OFFSET(0x180853E0)
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL__CTOR_OFFSET UNITYSDK_OFFSET(0x18087B00)

namespace RPG::Client
{
	inline static constexpr unsigned int CustomLineProcedural_TypeDefinitionIndex = 67242;
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::Vector3>**)Il2CppClass::FromTypeDefinitionIndex(CustomLineProcedural_TypeDefinitionIndex)->GetStaticField(0x6AE80);
		}
