...
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL_AWAKE_OFFSET UNITYSDK_OFFSET(0x943E460)
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL_METHOD_5_7B411317D337F87A_1_OFFSET UNITYSDK_OFFSET(0x943FBC0)
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL_METHOD_5_7B411317D337F87A_OFFSET UNITYSDK_OFFSET(0x943F3A0)
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL_METHOD_5_8336E89DF737C001_OFFSET UNITYSDK_OFFSET(0x943EF00)
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL_METHOD_5_95288ADC9C10D154_OFFSET UNITYSDK_OFFSET(0x943E710)
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL_METHOD_5_B50CA01B5EDC1228_OFFSET UNITYSDK_OFFSET(0x9440670)
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL_METHOD_5_E4F0C07FA0B569BB_OFFSET UNITYSDK_OFFSET(0x9440760)
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL_METHOD_5_F2BB8CA4A5596DD6_OFFSET UNITYSDK_OFFSET(0x94403B0)
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL_REBUILDLINE_OFFSET UNITYSDK_OFFSET(0x943E530)
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL_UPDATEPOINTS_OFFSET UNITYSDK_OFFSET(0x943E5C0)
#define RPG_CLIENT_CUSTOMLINEPROCEDURAL__CTOR_OFFSET UNITYSDK_OFFSET(0x9440AD0)

namespace RPG::Client
{
	inline static constexpr unsigned int CustomLineProcedural_TypeDefinitionIndex = 57635;
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::Vector3>**)Il2CppClass::FromTypeDefinitionIndex(CustomLineProcedural_TypeDefinitionIndex)->GetStaticField(0x44370);
		}
