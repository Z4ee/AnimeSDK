...
#define RPG_CLIENT_ONBACKPRESSEDDISPATCHER_CALLBACKENTRY_GET_CALLBACK_OFFSET UNITYSDK_OFFSET(0x191CEAF0)
#define RPG_CLIENT_ONBACKPRESSEDDISPATCHER_CALLBACKENTRY_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x191CEB10)
#define RPG_CLIENT_ONBACKPRESSEDDISPATCHER_CALLBACKENTRY_SET_CALLBACK_OFFSET UNITYSDK_OFFSET(0x191CEB00)
#define RPG_CLIENT_ONBACKPRESSEDDISPATCHER_CALLBACKENTRY_SET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x191CEB20)
#define RPG_CLIENT_ONBACKPRESSEDDISPATCHER_CALLBACKENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x191CE5E0)

namespace RPG::Client
{
	inline static constexpr unsigned int OnBackPressedDispatcher_CallbackEntry_TypeDefinitionIndex = 71308;
