...
#define RPG_CLIENT_ONBACKPRESSEDDISPATCHER_CALLBACKENTRY_GET_CALLBACK_OFFSET UNITYSDK_OFFSET(0xD9E26C0)
#define RPG_CLIENT_ONBACKPRESSEDDISPATCHER_CALLBACKENTRY_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xD9E26E0)
#define RPG_CLIENT_ONBACKPRESSEDDISPATCHER_CALLBACKENTRY_SET_CALLBACK_OFFSET UNITYSDK_OFFSET(0xD9E26D0)
#define RPG_CLIENT_ONBACKPRESSEDDISPATCHER_CALLBACKENTRY_SET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xD9E26F0)
#define RPG_CLIENT_ONBACKPRESSEDDISPATCHER_CALLBACKENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0xD9E21B0)

namespace RPG::Client
{
	inline static constexpr unsigned int OnBackPressedDispatcher_CallbackEntry_TypeDefinitionIndex = 71309;
