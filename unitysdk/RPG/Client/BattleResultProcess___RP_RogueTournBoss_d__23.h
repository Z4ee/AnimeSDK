...
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_ROGUETOURNBOSS_D__23_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x9E7C0B0)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_ROGUETOURNBOSS_D__23_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x9E7C0F0)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_ROGUETOURNBOSS_D__23_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x9E7C150)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_ROGUETOURNBOSS_D__23_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x9E7C100)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_ROGUETOURNBOSS_D__23_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9E7C0A0)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_ROGUETOURNBOSS_D__23__CTOR_OFFSET UNITYSDK_OFFSET(0x9E76590)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleResultProcess___RP_RogueTournBoss_d__23_TypeDefinitionIndex = 56280;
