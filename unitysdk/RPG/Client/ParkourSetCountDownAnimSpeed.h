...
#define RPG_CLIENT_PARKOURSETCOUNTDOWNANIMSPEED_METHOD_3_CD61A7EF67988DC4_OFFSET UNITYSDK_OFFSET(0x1B9EDF80)
#define RPG_CLIENT_PARKOURSETCOUNTDOWNANIMSPEED_METHOD_3_F2371ACD59D5E15F_OFFSET UNITYSDK_OFFSET(0x1B9EDFC0)
#define RPG_CLIENT_PARKOURSETCOUNTDOWNANIMSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9EDFB0)

namespace RPG::Client
{
	inline static constexpr unsigned int ParkourSetCountDownAnimSpeed_TypeDefinitionIndex = 9948;
