...
#define RPG_CLIENT_PARKOURSETCOUNTDOWNANIMSPEED_METHOD_3_AD749595B9849A2E_OFFSET UNITYSDK_OFFSET(0x185EB860)
#define RPG_CLIENT_PARKOURSETCOUNTDOWNANIMSPEED_METHOD_3_F2371ACD59D5E15F_OFFSET UNITYSDK_OFFSET(0x185EB8E0)
#define RPG_CLIENT_PARKOURSETCOUNTDOWNANIMSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x185EB8B0)

namespace RPG::Client
{
	inline static constexpr unsigned int ParkourSetCountDownAnimSpeed_TypeDefinitionIndex = 10131;
