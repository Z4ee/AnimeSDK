...
#define RPG_CLIENT_LUATOCS_FULLGC_OFFSET UNITYSDK_OFFSET(0xD59C790)
#define RPG_CLIENT_LUATOCS_GETISDOWNLOADALLTXTLANG_OFFSET UNITYSDK_OFFSET(0xD59CF20)
#define RPG_CLIENT_LUATOCS_GETISUSEINTERIORNETDISKDOWNLOADASSETBUNDLE_OFFSET UNITYSDK_OFFSET(0xD59CE60)
#define RPG_CLIENT_LUATOCS_GETLUAMEMROY_OFFSET UNITYSDK_OFFSET(0xD59C920)
#define RPG_CLIENT_LUATOCS_INSTANTIATE_1_OFFSET UNITYSDK_OFFSET(0xD59CD60)
#define RPG_CLIENT_LUATOCS_INSTANTIATE_OFFSET UNITYSDK_OFFSET(0xD59CD00)
#define RPG_CLIENT_LUATOCS_ISSAMETYPE_OFFSET UNITYSDK_OFFSET(0xD59D160)
#define RPG_CLIENT_LUATOCS_LOAD_OFFSET UNITYSDK_OFFSET(0xD59D100)
#define RPG_CLIENT_LUATOCS_MEMORYLEAKCHECK_OFFSET UNITYSDK_OFFSET(0xD59CB70)
#define RPG_CLIENT_LUATOCS_MEMORYLEAKREPORT_OFFSET UNITYSDK_OFFSET(0xD59CC30)
#define RPG_CLIENT_LUATOCS_PLAYAUDIO_OFFSET UNITYSDK_OFFSET(0xD59D010)
#define RPG_CLIENT_LUATOCS_PLAYVIDEO_OFFSET UNITYSDK_OFFSET(0xD59CF60)
#define RPG_CLIENT_LUATOCS_SETDOWNLOADALLTXTLANG_OFFSET UNITYSDK_OFFSET(0xD59CEE0)
#define RPG_CLIENT_LUATOCS_SETISUSEINTERIORNETDISKDOWNLOADASSETBUNDLE_OFFSET UNITYSDK_OFFSET(0xD59CE20)
#define RPG_CLIENT_LUATOCS_SETUSELOCAL_OFFSET UNITYSDK_OFFSET(0xD59CEA0)
#define RPG_CLIENT_LUATOCS_STARTMEMORYLEAKCHECK_OFFSET UNITYSDK_OFFSET(0xD59CAB0)
#define RPG_CLIENT_LUATOCS_TRYONLYONCEINITPROFILE_OFFSET UNITYSDK_OFFSET(0xD59CDB0)
