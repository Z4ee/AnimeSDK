...
#define RPG_CLIENT_AIRSHIPAUDIO_AWAKE_OFFSET UNITYSDK_OFFSET(0xB2DDAC0)
#define RPG_CLIENT_AIRSHIPAUDIO_METHOD_5_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0xB2DD8B0)
#define RPG_CLIENT_AIRSHIPAUDIO_METHOD_5_CA6BDDCC5F7CE11E_OFFSET UNITYSDK_OFFSET(0xB2DDB70)
#define RPG_CLIENT_AIRSHIPAUDIO_ONENABLE_OFFSET UNITYSDK_OFFSET(0xB2DDA30)
#define RPG_CLIENT_AIRSHIPAUDIO_POSTAIRSHIPMOOREDSPEED_OFFSET UNITYSDK_OFFSET(0xB2D8670)
#define RPG_CLIENT_AIRSHIPAUDIO_POSTAIRSHIPMOVINGEVENT_OFFSET UNITYSDK_OFFSET(0xB2DD950)
#define RPG_CLIENT_AIRSHIPAUDIO_POSTAIRSHIPMOVINGSPEED_OFFSET UNITYSDK_OFFSET(0xB2DD9A0)
#define RPG_CLIENT_AIRSHIPAUDIO_POSTAIRSHIPTRANSITIONDOWNEVENT_OFFSET UNITYSDK_OFFSET(0xB2D8600)
#define RPG_CLIENT_AIRSHIPAUDIO_POSTAIRSHIPTRANSITIONDOWNSTOPEVENT_OFFSET UNITYSDK_OFFSET(0xB2D8710)
#define RPG_CLIENT_AIRSHIPAUDIO_POSTAIRSHIPTRANSITIONUPEVENT_OFFSET UNITYSDK_OFFSET(0xB2D8770)
#define RPG_CLIENT_AIRSHIPAUDIO_POSTAIRSHIPTRANSITIONUPSTOPEVENT_OFFSET UNITYSDK_OFFSET(0xB2D87E0)
#define RPG_CLIENT_AIRSHIPAUDIO_POSTEVENT_OFFSET UNITYSDK_OFFSET(0xB2D84F0)
#define RPG_CLIENT_AIRSHIPAUDIO_UPDATEENABLED_OFFSET UNITYSDK_OFFSET(0xB2DD7E0)
#define RPG_CLIENT_AIRSHIPAUDIO_UPDATE_OFFSET UNITYSDK_OFFSET(0xB2DDB10)
#define RPG_CLIENT_AIRSHIPAUDIO__CTOR_OFFSET UNITYSDK_OFFSET(0xB2DDCA0)

namespace RPG::Client
{
	inline static constexpr unsigned int AirshipAudio_TypeDefinitionIndex = 55890;
