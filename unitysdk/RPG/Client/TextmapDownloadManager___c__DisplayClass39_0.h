...
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER___C__DISPLAYCLASS39_0__ASYNCAPPLYTEXTLANGUAGE_B__0_OFFSET UNITYSDK_OFFSET(0xCA2A5A0)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER___C__DISPLAYCLASS39_0__ASYNCAPPLYTEXTLANGUAGE_B__1_OFFSET UNITYSDK_OFFSET(0xCA2A760)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER___C__DISPLAYCLASS39_0__CTOR_OFFSET UNITYSDK_OFFSET(0xCA29310)

namespace RPG::Client
{
	inline static constexpr unsigned int TextmapDownloadManager___c__DisplayClass39_0_TypeDefinitionIndex = 57254;

	class TextmapDownloadManager___c__DisplayClass39_0 : public ::System::Object
	{
	public:
		::System::Threading::SynchronizationContext* mainThreadContext; // 0x10
		::System::String* previousLanguage; // 0x18
		::RPG::Client::TextmapDownloadManager* __4__this; // 0x20
