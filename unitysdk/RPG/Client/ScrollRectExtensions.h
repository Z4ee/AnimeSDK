...
#define RPG_CLIENT_SCROLLRECTEXTENSIONS_FORCEUPDATECANSCROLL_OFFSET UNITYSDK_OFFSET(0xE06F200)

namespace RPG::Client
{
	inline static constexpr unsigned int ScrollRectExtensions_TypeDefinitionIndex = 72703;
