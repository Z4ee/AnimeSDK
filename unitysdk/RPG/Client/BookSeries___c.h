...
#define RPG_CLIENT_BOOKSERIES___C__CCTOR_OFFSET UNITYSDK_OFFSET(0xB43AE20)
#define RPG_CLIENT_BOOKSERIES___C__CTOR_OFFSET UNITYSDK_OFFSET(0xB43AE60)
#define RPG_CLIENT_BOOKSERIES___C__GETBOOKS_B__5_0_OFFSET UNITYSDK_OFFSET(0xB43AE70)
#define RPG_CLIENT_BOOKSERIES___C__GET_HASAUDIOCONTENT_B__53_0_OFFSET UNITYSDK_OFFSET(0xB43AEC0)

namespace RPG::Client
{
	inline static constexpr unsigned int BookSeries___c_TypeDefinitionIndex = 62069;
	...
	public:
		...
		{
			return (::System::Comparison_1<::RPG::Client::Book*>**)Il2CppClass::FromTypeDefinitionIndex(BookSeries___c_TypeDefinitionIndex)->GetStaticField(0x58F50);
		}
		static ::RPG::Client::BookSeries___c** StaticGet___9()
		{
			return (::RPG::Client::BookSeries___c**)Il2CppClass::FromTypeDefinitionIndex(BookSeries___c_TypeDefinitionIndex)->GetStaticField(0x58F58);
		}
		...
		{
			return (::System::Func_2<::System::Collections::Generic::KeyValuePair_2<::System::UInt32, ::RPG::Client::Book*>, ::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(BookSeries___c_TypeDefinitionIndex)->GetStaticField(0x58F60);
		}
