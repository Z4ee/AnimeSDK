...
#define RPG_CLIENT_SILVERWOLFSHOOTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x188E1400)

namespace RPG::Client
{
	inline static constexpr unsigned int SilverWolfShootData_TypeDefinitionIndex = 64948;
