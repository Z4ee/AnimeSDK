...
#define RPG_CLIENT_SILVERWOLFSHOOTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x196B5DC0)

namespace RPG::Client
{
	inline static constexpr unsigned int SilverWolfShootData_TypeDefinitionIndex = 67955;
