...
#define RPG_CLIENT_MUSICRHYTHMSCOREINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xC22ABE0)

namespace RPG::Client
{
	inline static constexpr unsigned int MusicRhythmScoreInfo_TypeDefinitionIndex = 56247;

	class MusicRhythmScoreInfo : public ::System::Object
	{
	public:
		::System::UInt32 CountDown; // 0x10
