...
#define RPG_CLIENT_MUSICRHYTHMSCOREINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18E952A0)

namespace RPG::Client
{
	inline static constexpr unsigned int MusicRhythmScoreInfo_TypeDefinitionIndex = 57486;
