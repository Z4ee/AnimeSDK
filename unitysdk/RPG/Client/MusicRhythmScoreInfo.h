...
#define RPG_CLIENT_MUSICRHYTHMSCOREINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1A307FE0)

namespace RPG::Client
{
	inline static constexpr unsigned int MusicRhythmScoreInfo_TypeDefinitionIndex = 60303;
