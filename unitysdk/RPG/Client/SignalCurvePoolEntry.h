...
#define RPG_CLIENT_SIGNALCURVEPOOLENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0xA47EC10)

namespace RPG::Client
{
	inline static constexpr unsigned int SignalCurvePoolEntry_TypeDefinitionIndex = 58122;
