...
#define RPG_CLIENT_SIGNALCURVEPOOLENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x188DD990)

namespace RPG::Client
{
	inline static constexpr unsigned int SignalCurvePoolEntry_TypeDefinitionIndex = 67761;
