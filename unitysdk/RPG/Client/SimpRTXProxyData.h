...
#define RPG_CLIENT_SIMPRTXPROXYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x3997CD0)

namespace RPG::Client
{
	inline static constexpr unsigned int SimpRTXProxyData_TypeDefinitionIndex = 67047;
