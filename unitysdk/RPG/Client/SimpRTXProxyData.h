...
#define RPG_CLIENT_SIMPRTXPROXYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x3AFC440)

namespace RPG::Client
{
	inline static constexpr unsigned int SimpRTXProxyData_TypeDefinitionIndex = 70152;
