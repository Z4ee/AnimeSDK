...
#define RPG_CLIENT_MATCHTHREELOOPEFFECT_DESPAWNED_OFFSET UNITYSDK_OFFSET(0x1AB69280)
#define RPG_CLIENT_MATCHTHREELOOPEFFECT_GET_POSINDEX_OFFSET UNITYSDK_OFFSET(0x1AB69020)
#define RPG_CLIENT_MATCHTHREELOOPEFFECT_ONCREATE_OFFSET UNITYSDK_OFFSET(0x1AB690E0)
#define RPG_CLIENT_MATCHTHREELOOPEFFECT_SETPOSITION_OFFSET UNITYSDK_OFFSET(0x1AB69040)
#define RPG_CLIENT_MATCHTHREELOOPEFFECT_SET_POSINDEX_OFFSET UNITYSDK_OFFSET(0x1AB69030)
#define RPG_CLIENT_MATCHTHREELOOPEFFECT_SPAWNED_OFFSET UNITYSDK_OFFSET(0x1AB69240)
#define RPG_CLIENT_MATCHTHREELOOPEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB692C0)

namespace RPG::Client
{
	inline static constexpr unsigned int MatchThreeLoopEffect_TypeDefinitionIndex = 63015;
