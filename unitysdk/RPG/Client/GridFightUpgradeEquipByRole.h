...
#define RPG_CLIENT_GRIDFIGHTUPGRADEEQUIPBYROLE_GET_RICHTEXTMESSAGENAME_OFFSET UNITYSDK_OFFSET(0x1BB1DDA0)
#define RPG_CLIENT_GRIDFIGHTUPGRADEEQUIPBYROLE_GET_RICHTEXTVALUEMAP_OFFSET UNITYSDK_OFFSET(0x1BB1DE10)
#define RPG_CLIENT_GRIDFIGHTUPGRADEEQUIPBYROLE_GET_ROLEUNIQUEID_OFFSET UNITYSDK_OFFSET(0x1BB1DCB0)
#define RPG_CLIENT_GRIDFIGHTUPGRADEEQUIPBYROLE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1BB1DD50)
#define RPG_CLIENT_GRIDFIGHTUPGRADEEQUIPBYROLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB1DCA0)
