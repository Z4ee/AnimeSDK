...
#define RPG_CLIENT_ADVGMSUMMONMONSTERITEMCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xC6AC300)

namespace RPG::Client
{
	inline static constexpr unsigned int AdvGMSummonMonsterItemContext_TypeDefinitionIndex = 72653;
