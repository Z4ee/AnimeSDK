...
#define RPG_CLIENT_ADVGMSUMMONMONSTERITEMCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x901F620)

namespace RPG::Client
{
	inline static constexpr unsigned int AdvGMSummonMonsterItemContext_TypeDefinitionIndex = 59602;
