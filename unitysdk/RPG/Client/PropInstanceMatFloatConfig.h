...
#define RPG_CLIENT_PROPINSTANCEMATFLOATCONFIG_METHOD_2_1ECFB1C19B577E7A_OFFSET UNITYSDK_OFFSET(0x16149850)
#define RPG_CLIENT_PROPINSTANCEMATFLOATCONFIG_METHOD_2_2313F2256728F710_OFFSET UNITYSDK_OFFSET(0x161497D0)
#define RPG_CLIENT_PROPINSTANCEMATFLOATCONFIG_METHOD_2_7033EFB970A18315_OFFSET UNITYSDK_OFFSET(0x161496B0)
#define RPG_CLIENT_PROPINSTANCEMATFLOATCONFIG_METHOD_2_8DF68C4BE895E6C3_OFFSET UNITYSDK_OFFSET(0x16149040)
#define RPG_CLIENT_PROPINSTANCEMATFLOATCONFIG_METHOD_2_90D369AA14AFEE1C_OFFSET UNITYSDK_OFFSET(0x16149730)
#define RPG_CLIENT_PROPINSTANCEMATFLOATCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x161498E0)

namespace RPG::Client
{
	inline static constexpr unsigned int PropInstanceMatFloatConfig_TypeDefinitionIndex = 67593;
