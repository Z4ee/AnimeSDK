...
#define RPG_CLIENT_RANDOMPLAYANIMATION___PLAYRANDOMLY_D__1_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B645620)
#define RPG_CLIENT_RANDOMPLAYANIMATION___PLAYRANDOMLY_D__1_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B645740)
#define RPG_CLIENT_RANDOMPLAYANIMATION___PLAYRANDOMLY_D__1_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B6457A0)
#define RPG_CLIENT_RANDOMPLAYANIMATION___PLAYRANDOMLY_D__1_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B645750)
#define RPG_CLIENT_RANDOMPLAYANIMATION___PLAYRANDOMLY_D__1_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B645610)
#define RPG_CLIENT_RANDOMPLAYANIMATION___PLAYRANDOMLY_D__1__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6455F0)
