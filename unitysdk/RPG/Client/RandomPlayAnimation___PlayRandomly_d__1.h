...
#define RPG_CLIENT_RANDOMPLAYANIMATION___PLAYRANDOMLY_D__1_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19855B70)
#define RPG_CLIENT_RANDOMPLAYANIMATION___PLAYRANDOMLY_D__1_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19855C90)
#define RPG_CLIENT_RANDOMPLAYANIMATION___PLAYRANDOMLY_D__1_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19855CF0)
#define RPG_CLIENT_RANDOMPLAYANIMATION___PLAYRANDOMLY_D__1_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19855CA0)
#define RPG_CLIENT_RANDOMPLAYANIMATION___PLAYRANDOMLY_D__1_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19855B60)
#define RPG_CLIENT_RANDOMPLAYANIMATION___PLAYRANDOMLY_D__1__CTOR_OFFSET UNITYSDK_OFFSET(0x19855B40)
