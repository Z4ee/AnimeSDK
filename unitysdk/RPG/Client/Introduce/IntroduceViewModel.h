...
#define RPG_CLIENT_INTRODUCE_INTRODUCEVIEWMODEL_GET_DESC_OFFSET UNITYSDK_OFFSET(0xBD404A0)
#define RPG_CLIENT_INTRODUCE_INTRODUCEVIEWMODEL_GET_TITLE_OFFSET UNITYSDK_OFFSET(0xBD40470)
#define RPG_CLIENT_INTRODUCE_INTRODUCEVIEWMODEL_TRYCREATE_OFFSET UNITYSDK_OFFSET(0xBD40310)
#define RPG_CLIENT_INTRODUCE_INTRODUCEVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xBD404E0)

namespace RPG::Client::Introduce
{
	inline static constexpr unsigned int IntroduceViewModel_TypeDefinitionIndex = 73896;
