...
#define RPG_CLIENT_INTRODUCE_INTRODUCETEXTSCONTROL_GET_CONTENT_OFFSET UNITYSDK_OFFSET(0xBD40170)
#define RPG_CLIENT_INTRODUCE_INTRODUCETEXTSCONTROL_SET_CONTENT_OFFSET UNITYSDK_OFFSET(0xBD40180)
#define RPG_CLIENT_INTRODUCE_INTRODUCETEXTSCONTROL_TRYSETCONTENTBYINTROID_OFFSET UNITYSDK_OFFSET(0xBD401E0)
#define RPG_CLIENT_INTRODUCE_INTRODUCETEXTSCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xBD404D0)
#define RPG_CLIENT_INTRODUCE_INTRODUCETEXTSCONTROL__REFRESH_OFFSET UNITYSDK_OFFSET(0xBD403C0)

namespace RPG::Client::Introduce
{
	inline static constexpr unsigned int IntroduceTextsControl_TypeDefinitionIndex = 73895;
