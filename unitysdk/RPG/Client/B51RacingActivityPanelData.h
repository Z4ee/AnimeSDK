...
#define RPG_CLIENT_B51RACINGACTIVITYPANELDATA_ISSHOWGOTOBTNREDDOT_OFFSET UNITYSDK_OFFSET(0x19EFF8A0)
#define RPG_CLIENT_B51RACINGACTIVITYPANELDATA_ISSHOWMAPPINGINFONEWCONTENTREDDOT_OFFSET UNITYSDK_OFFSET(0x19EFFCC0)
#define RPG_CLIENT_B51RACINGACTIVITYPANELDATA_ISSHOWMAPPINGINFOREWARDREDDOT_OFFSET UNITYSDK_OFFSET(0x19EFFD90)
#define RPG_CLIENT_B51RACINGACTIVITYPANELDATA_ISSHOWNORMALREDDOT_OFFSET UNITYSDK_OFFSET(0x19EFFB90)
#define RPG_CLIENT_B51RACINGACTIVITYPANELDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19EFF890)
#define RPG_CLIENT_B51RACINGACTIVITYPANELDATA__HASANYCLAIMABLEREWARD_OFFSET UNITYSDK_OFFSET(0x19EFFBF0)
#define RPG_CLIENT_B51RACINGACTIVITYPANELDATA__HASRESIDENTCLAIMABLEREWARD_OFFSET UNITYSDK_OFFSET(0x19EFF900)
