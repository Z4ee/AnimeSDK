...
#define RPG_CLIENT_MONOTIMELINECONTROLGAMELEVELGROUP_CREATEGAMEWORLDLEVELGROUP_OFFSET UNITYSDK_OFFSET(0x9D3B390)
#define RPG_CLIENT_MONOTIMELINECONTROLGAMELEVELGROUP_GETCELLCENTER_OFFSET UNITYSDK_OFFSET(0x9D3DB10)
#define RPG_CLIENT_MONOTIMELINECONTROLGAMELEVELGROUP_GETCELLCOUNT_OFFSET UNITYSDK_OFFSET(0x9D3E570)
#define RPG_CLIENT_MONOTIMELINECONTROLGAMELEVELGROUP_GET_CELLLENGTH_OFFSET UNITYSDK_OFFSET(0x9D3DB00)
#define RPG_CLIENT_MONOTIMELINECONTROLGAMELEVELGROUP_GET_VECTOR_OFFSET UNITYSDK_OFFSET(0x9D3E100)
#define RPG_CLIENT_MONOTIMELINECONTROLGAMELEVELGROUP_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x9D3D3F0)
#define RPG_CLIENT_MONOTIMELINECONTROLGAMELEVELGROUP_REFRESHPOSITION_OFFSET UNITYSDK_OFFSET(0x9D3E5C0)
#define RPG_CLIENT_MONOTIMELINECONTROLGAMELEVELGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x9D3EB80)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoTimelineControlGameLevelGroup_TypeDefinitionIndex = 48940;
