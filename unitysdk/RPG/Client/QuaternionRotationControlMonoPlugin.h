...
#define RPG_CLIENT_QUATERNIONROTATIONCONTROLMONOPLUGIN_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xAF36900)
#define RPG_CLIENT_QUATERNIONROTATIONCONTROLMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xAF36950)
#define RPG_CLIENT_QUATERNIONROTATIONCONTROLMONOPLUGIN___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xAF36A00)

namespace RPG::Client
{
	inline static constexpr unsigned int QuaternionRotationControlMonoPlugin_TypeDefinitionIndex = 65246;
