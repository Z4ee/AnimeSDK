...
#define RPG_CLIENT_QUATERNIONROTATIONCONTROLMONOPLUGIN_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xA247F40)
#define RPG_CLIENT_QUATERNIONROTATIONCONTROLMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xA247F90)
#define RPG_CLIENT_QUATERNIONROTATIONCONTROLMONOPLUGIN___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xA248040)

namespace RPG::Client
{
	inline static constexpr unsigned int QuaternionRotationControlMonoPlugin_TypeDefinitionIndex = 57959;
