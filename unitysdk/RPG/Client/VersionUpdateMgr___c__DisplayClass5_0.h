...
#define RPG_CLIENT_VERSIONUPDATEMGR___C__DISPLAYCLASS5_0__CTOR_OFFSET UNITYSDK_OFFSET(0x173FB710)
#define RPG_CLIENT_VERSIONUPDATEMGR___C__DISPLAYCLASS5_0__GETDOWNLOADALLSIZE_B__0_OFFSET UNITYSDK_OFFSET(0x17402450)

namespace RPG::Client
{
	inline static constexpr unsigned int VersionUpdateMgr___c__DisplayClass5_0_TypeDefinitionIndex = 58545;

	class VersionUpdateMgr___c__DisplayClass5_0 : public ::System::Object
	{
	public:
		::Class_1_630CB84C93B59414* board; // 0x10
		::System::Action_1<::System::Int64>* callback; // 0x18
