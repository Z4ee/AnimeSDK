...
#define RPG_CLIENT_SCREENSPACEGPUPARTICLES_SCREENSPACEGPUPARTICLES__CTOR_OFFSET UNITYSDK_OFFSET(0xE06DDC0)

namespace RPG::Client::ScreenSpaceGPUParticles
{
	inline static constexpr unsigned int ScreenSpaceGPUParticles_TypeDefinitionIndex = 73598;
