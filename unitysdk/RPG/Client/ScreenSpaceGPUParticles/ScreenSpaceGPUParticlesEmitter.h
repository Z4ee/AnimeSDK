...
#define RPG_CLIENT_SCREENSPACEGPUPARTICLES_SCREENSPACEGPUPARTICLESEMITTER_GET_EMITTERMATRIX_OFFSET UNITYSDK_OFFSET(0xC8AE0B0)
#define RPG_CLIENT_SCREENSPACEGPUPARTICLES_SCREENSPACEGPUPARTICLESEMITTER__CTOR_OFFSET UNITYSDK_OFFSET(0xC8AE770)

namespace RPG::Client::ScreenSpaceGPUParticles
{
	inline static constexpr unsigned int ScreenSpaceGPUParticlesEmitter_TypeDefinitionIndex = 68799;
