...
#define RPG_CLIENT_ROGUETOURNUTILS___C__DISPLAYCLASS80_1__CTOR_OFFSET UNITYSDK_OFFSET(0xA3E7DC0)
#define RPG_CLIENT_ROGUETOURNUTILS___C__DISPLAYCLASS80_1___DELAYEDPROMISE_B__1_OFFSET UNITYSDK_OFFSET(0xA3E7DD0)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueTournUtils___c__DisplayClass80_1_TypeDefinitionIndex = 55322;
