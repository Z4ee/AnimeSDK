...
#define RPG_CLIENT_CRPSHADOWSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x9211DA0)

namespace RPG::Client
{
	inline static constexpr unsigned int CRPShadowSettings_TypeDefinitionIndex = 55427;
