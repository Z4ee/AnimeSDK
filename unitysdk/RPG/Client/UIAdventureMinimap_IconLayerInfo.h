...
#define RPG_CLIENT_UIADVENTUREMINIMAP_ICONLAYERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xB3C9670)

namespace RPG::Client
{
	inline static constexpr unsigned int UIAdventureMinimap_IconLayerInfo_TypeDefinitionIndex = 63666;
