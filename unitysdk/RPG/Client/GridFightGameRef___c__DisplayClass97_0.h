...
#define RPG_CLIENT_GRIDFIGHTGAMEREF___C__DISPLAYCLASS97_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA13CA0)
#define RPG_CLIENT_GRIDFIGHTGAMEREF___C__DISPLAYCLASS97_0__FAVOUR_B__0_OFFSET UNITYSDK_OFFSET(0x1BA16FE0)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightGameRef___c__DisplayClass97_0_TypeDefinitionIndex = 64782;
