...
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_LOOKAT_METHOD_1_54B0E9D6F6DD967C_OFFSET UNITYSDK_OFFSET(0x150FB190)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_LOOKAT_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x150FB100)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_LOOKAT__CTOR_OFFSET UNITYSDK_OFFSET(0x150FB410)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_InstanceArrayBehavior_LookAt_TypeDefinitionIndex = 67451;
