...
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_LOOKAT_METHOD_1_54B0E9D6F6DD967C_OFFSET UNITYSDK_OFFSET(0x15E6C510)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_LOOKAT_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x15E6C480)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_LOOKAT__CTOR_OFFSET UNITYSDK_OFFSET(0x15E6C790)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_InstanceArrayBehavior_LookAt_TypeDefinitionIndex = 70574;
