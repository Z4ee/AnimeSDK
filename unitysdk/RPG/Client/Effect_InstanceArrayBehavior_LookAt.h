...
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_LOOKAT_METHOD_1_54B0E9D6F6DD967C_OFFSET UNITYSDK_OFFSET(0xA1D61A0)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_LOOKAT_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xA1D6110)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_LOOKAT__CTOR_OFFSET UNITYSDK_OFFSET(0xA1D6420)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_InstanceArrayBehavior_LookAt_TypeDefinitionIndex = 65100;
