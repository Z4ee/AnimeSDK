...
#define RPG_CLIENT_STARGIFTACTIVITYDATA_CHECKCANCLAIMREWARD_OFFSET UNITYSDK_OFFSET(0x1A4FD530)
#define RPG_CLIENT_STARGIFTACTIVITYDATA_GET_QUESTID_OFFSET UNITYSDK_OFFSET(0x1A4FD6F0)
#define RPG_CLIENT_STARGIFTACTIVITYDATA_ISSHOWNORMALREDDOT_OFFSET UNITYSDK_OFFSET(0x1A4FD4B0)
#define RPG_CLIENT_STARGIFTACTIVITYDATA_UPDATEFULLCOMPLETESTATUS_OFFSET UNITYSDK_OFFSET(0x1A4FD630)
#define RPG_CLIENT_STARGIFTACTIVITYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4FD4A0)
#define RPG_CLIENT_STARGIFTACTIVITYDATA__ONACTIVITYENDEDCUSTOM_OFFSET UNITYSDK_OFFSET(0x1A4FD5E0)
