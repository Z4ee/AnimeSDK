...
#define RPG_CLIENT_STARGIFTACTIVITYDATA_CHECKCANCLAIMREWARD_OFFSET UNITYSDK_OFFSET(0x17B61E10)
#define RPG_CLIENT_STARGIFTACTIVITYDATA_GET_QUESTID_OFFSET UNITYSDK_OFFSET(0x17B61FD0)
#define RPG_CLIENT_STARGIFTACTIVITYDATA_ISSHOWNORMALREDDOT_OFFSET UNITYSDK_OFFSET(0x17B61D90)
#define RPG_CLIENT_STARGIFTACTIVITYDATA_UPDATEFULLCOMPLETESTATUS_OFFSET UNITYSDK_OFFSET(0x17B61F10)
#define RPG_CLIENT_STARGIFTACTIVITYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17B61D80)
#define RPG_CLIENT_STARGIFTACTIVITYDATA__ONACTIVITYENDEDCUSTOM_OFFSET UNITYSDK_OFFSET(0x17B61EC0)

namespace RPG::Client
{
	inline static constexpr unsigned int StarGiftActivityData_TypeDefinitionIndex = 58922;
