...
#define RPG_CLIENT_ROGUEDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0xDEAA0B0)
#define RPG_CLIENT_ROGUEDATA_GETCURRENTEXPLORESITENAME_OFFSET UNITYSDK_OFFSET(0xDEAA970)
#define RPG_CLIENT_ROGUEDATA_GETCURRENTROGUEROOMROW_OFFSET UNITYSDK_OFFSET(0xDEAAA00)
#define RPG_CLIENT_ROGUEDATA_GETFINISHEDAREACOUNT_OFFSET UNITYSDK_OFFSET(0xDEAAA90)
#define RPG_CLIENT_ROGUEDATA_GETMONSTERELITEDROPID_OFFSET UNITYSDK_OFFSET(0xDEAABC0)
#define RPG_CLIENT_ROGUEDATA_GETROGUEAVATARCOLLECTION_OFFSET UNITYSDK_OFFSET(0xDEAA140)
#define RPG_CLIENT_ROGUEDATA_GETROGUEDEBUGINFO_OFFSET UNITYSDK_OFFSET(0xDEAACE0)
#define RPG_CLIENT_ROGUEDATA_GETSELECTABLEAEONIDLIST_OFFSET UNITYSDK_OFFSET(0xDEAB0A0)
#define RPG_CLIENT_ROGUEDATA_GETSELECTEDROGUEAEONBUFFINFO_OFFSET UNITYSDK_OFFSET(0xDEAB000)
#define RPG_CLIENT_ROGUEDATA_GETSELECTEDROGUEAEONID_OFFSET UNITYSDK_OFFSET(0xDEAB050)
#define RPG_CLIENT_ROGUEDATA_GETUNLOCKAEONENHANCENUM_OFFSET UNITYSDK_OFFSET(0xDEAB0F0)
#define RPG_CLIENT_ROGUEDATA_GET_BEGINTIMESTAMP_OFFSET UNITYSDK_OFFSET(0xDEAB220)
#define RPG_CLIENT_ROGUEDATA_GET_CURRENTSTATUS_OFFSET UNITYSDK_OFFSET(0xDEAB1C0)
#define RPG_CLIENT_ROGUEDATA_GET_ENDTIMESTAMP_OFFSET UNITYSDK_OFFSET(0xDEAB240)
#define RPG_CLIENT_ROGUEDATA_GET_ISEXPLOREWIN_OFFSET UNITYSDK_OFFSET(0xDEAB1E0)
#define RPG_CLIENT_ROGUEDATA_GET_MAPDATA_OFFSET UNITYSDK_OFFSET(0xDEAB280)
#define RPG_CLIENT_ROGUEDATA_GET_PROGRESSINFO_OFFSET UNITYSDK_OFFSET(0xDEAB260)
#define RPG_CLIENT_ROGUEDATA_GET_ROGUEROW_OFFSET UNITYSDK_OFFSET(0xDEAB140)
#define RPG_CLIENT_ROGUEDATA_GET_SEASONID_OFFSET UNITYSDK_OFFSET(0xDEAB200)
#define RPG_CLIENT_ROGUEDATA_GET_SELECTAEONINFO_OFFSET UNITYSDK_OFFSET(0xDEAB2A0)
#define RPG_CLIENT_ROGUEDATA_SET_BEGINTIMESTAMP_OFFSET UNITYSDK_OFFSET(0xDEAB230)
#define RPG_CLIENT_ROGUEDATA_SET_CURRENTSTATUS_OFFSET UNITYSDK_OFFSET(0xDEAB1D0)
#define RPG_CLIENT_ROGUEDATA_SET_ENDTIMESTAMP_OFFSET UNITYSDK_OFFSET(0xDEAB250)
#define RPG_CLIENT_ROGUEDATA_SET_ISEXPLOREWIN_OFFSET UNITYSDK_OFFSET(0xDEAB1F0)
#define RPG_CLIENT_ROGUEDATA_SET_MAPDATA_OFFSET UNITYSDK_OFFSET(0xDEAB290)
#define RPG_CLIENT_ROGUEDATA_SET_PROGRESSINFO_OFFSET UNITYSDK_OFFSET(0xDEAB270)
#define RPG_CLIENT_ROGUEDATA_SET_SEASONID_OFFSET UNITYSDK_OFFSET(0xDEAB210)
#define RPG_CLIENT_ROGUEDATA_SET_SELECTAEONINFO_OFFSET UNITYSDK_OFFSET(0xDEAB2B0)
#define RPG_CLIENT_ROGUEDATA_SYNCROGUEDATA_OFFSET UNITYSDK_OFFSET(0xDEAA190)
#define RPG_CLIENT_ROGUEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xDEA9D60)
...
namespace RPG::Client
{
	...
	{
	public:
		::Class_1_59B86BCB4AA13938* _SelectAeonInfo_k__BackingField; // 0x30
		...
		::Enum_3_4608E37A1B3D374A_29 _CurrentStatus_k__BackingField; // 0x68
