...
#define RPG_CLIENT_PLANESLICE_METHOD_5_2566AD459572DFC3_OFFSET UNITYSDK_OFFSET(0x1A0E73C0)
#define RPG_CLIENT_PLANESLICE_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x1A0EA630)
#define RPG_CLIENT_PLANESLICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0EA8B0)

namespace RPG::Client
{
	inline static constexpr unsigned int PlaneSlice_TypeDefinitionIndex = 67539;
