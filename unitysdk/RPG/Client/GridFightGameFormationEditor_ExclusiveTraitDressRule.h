...
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_EXCLUSIVETRAITDRESSRULE_CANDRESS_OFFSET UNITYSDK_OFFSET(0x1ABD8A50)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_EXCLUSIVETRAITDRESSRULE_GET_REASON_OFFSET UNITYSDK_OFFSET(0x1ABD89A0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_EXCLUSIVETRAITDRESSRULE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABD7A90)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightGameFormationEditor_ExclusiveTraitDressRule_TypeDefinitionIndex = 61709;
