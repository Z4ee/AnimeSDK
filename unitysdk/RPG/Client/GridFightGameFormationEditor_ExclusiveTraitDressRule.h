...
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_EXCLUSIVETRAITDRESSRULE_CANDRESS_OFFSET UNITYSDK_OFFSET(0xBB59380)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_EXCLUSIVETRAITDRESSRULE_GET_REASON_OFFSET UNITYSDK_OFFSET(0xBB592D0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_EXCLUSIVETRAITDRESSRULE__CTOR_OFFSET UNITYSDK_OFFSET(0xBB46A10)
