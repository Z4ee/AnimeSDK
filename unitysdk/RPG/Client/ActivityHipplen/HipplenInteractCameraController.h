...
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENINTERACTCAMERACONTROLLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC5471D0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENINTERACTCAMERACONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0xC546AF0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENINTERACTCAMERACONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xC562820)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENINTERACTCAMERACONTROLLER_METHOD_5_1C4DCEC4A71E9244_OFFSET UNITYSDK_OFFSET(0xC563590)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENINTERACTCAMERACONTROLLER_METHOD_5_2C95AFAD0256302F_1_OFFSET UNITYSDK_OFFSET(0xC562CB0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENINTERACTCAMERACONTROLLER_METHOD_5_2C95AFAD0256302F_OFFSET UNITYSDK_OFFSET(0xC562B40)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENINTERACTCAMERACONTROLLER_METHOD_5_7C7377C794E8973C_1_OFFSET UNITYSDK_OFFSET(0xC562F40)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENINTERACTCAMERACONTROLLER_METHOD_5_7C7377C794E8973C_OFFSET UNITYSDK_OFFSET(0xC562E20)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENINTERACTCAMERACONTROLLER_METHOD_5_7DD84EAFF333A1E4_OFFSET UNITYSDK_OFFSET(0xC563630)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENINTERACTCAMERACONTROLLER_METHOD_5_C638E91FC0D3A13A_OFFSET UNITYSDK_OFFSET(0xC5628F0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENINTERACTCAMERACONTROLLER_METHOD_5_EA3847E5520B6A95_OFFSET UNITYSDK_OFFSET(0xC5632F0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENINTERACTCAMERACONTROLLER_RESET_OFFSET UNITYSDK_OFFSET(0xC5499E0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENINTERACTCAMERACONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC563690)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int HipplenInteractCameraController_TypeDefinitionIndex = 75278;
