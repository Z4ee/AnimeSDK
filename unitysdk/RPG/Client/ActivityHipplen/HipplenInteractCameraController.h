...
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENINTERACTCAMERACONTROLLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B7A9620)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENINTERACTCAMERACONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0x1B7A8CC0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENINTERACTCAMERACONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1B7C4CC0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENINTERACTCAMERACONTROLLER_METHOD_5_1C4DCEC4A71E9244_OFFSET UNITYSDK_OFFSET(0x1B7C5A30)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENINTERACTCAMERACONTROLLER_METHOD_5_2C95AFAD0256302F_1_OFFSET UNITYSDK_OFFSET(0x1B7C5150)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENINTERACTCAMERACONTROLLER_METHOD_5_2C95AFAD0256302F_OFFSET UNITYSDK_OFFSET(0x1B7C4FE0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENINTERACTCAMERACONTROLLER_METHOD_5_7C7377C794E8973C_1_OFFSET UNITYSDK_OFFSET(0x1B7C53E0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENINTERACTCAMERACONTROLLER_METHOD_5_7C7377C794E8973C_OFFSET UNITYSDK_OFFSET(0x1B7C52C0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENINTERACTCAMERACONTROLLER_METHOD_5_7DD84EAFF333A1E4_OFFSET UNITYSDK_OFFSET(0x1B7C5AD0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENINTERACTCAMERACONTROLLER_METHOD_5_C638E91FC0D3A13A_OFFSET UNITYSDK_OFFSET(0x1B7C4D90)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENINTERACTCAMERACONTROLLER_METHOD_5_EA3847E5520B6A95_OFFSET UNITYSDK_OFFSET(0x1B7C5790)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENINTERACTCAMERACONTROLLER_RESET_OFFSET UNITYSDK_OFFSET(0x1B7ABE30)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENINTERACTCAMERACONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7C5B30)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int HipplenInteractCameraController_TypeDefinitionIndex = 75277;

	class HipplenInteractCameraController : public ::UnityEngine::MonoBehaviour
	{
	public:
		::System::Single AKAJAJDNIOP; // 0x18
		::System::Single DBCBACNBGPD; // 0x1C
		::UnityEngine::Transform* KHPMDEJPJGA; // 0x20
		::System::Nullable_1<::UnityEngine::Vector2> OIPCDKEFHHN; // 0x28
		::UnityEngine::Quaternion AAMLGAMNAIF; // 0x34
