...
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENREQUIREGOODSDATA_GET_CURNUM_OFFSET UNITYSDK_OFFSET(0xB0F5390)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENREQUIREGOODSDATA_GET_DISPLAYTYPE_OFFSET UNITYSDK_OFFSET(0xB0F4B70)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENREQUIREGOODSDATA_GET_FADETIME_OFFSET UNITYSDK_OFFSET(0xB0F4B90)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENREQUIREGOODSDATA_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xB0F52F0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENREQUIREGOODSDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0xB0F0BE0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENREQUIREGOODSDATA_GET_REQUIRENUM_OFFSET UNITYSDK_OFFSET(0xB0F0C00)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENREQUIREGOODSDATA_SET_CURNUM_OFFSET UNITYSDK_OFFSET(0xB0F53A0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENREQUIREGOODSDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB0F3A20)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int HipplenRequireGoodsData_TypeDefinitionIndex = 70465;
