...
#define RPG_CLIENT_ACTIVITYHIPPLEN_MONOBABYHIPPLEN_CLASS_1_F5A99FD3A852F19F_METHOD_1_39590AB2089F9F4D_OFFSET UNITYSDK_OFFSET(0xC56B4D0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_MONOBABYHIPPLEN_CLASS_1_F5A99FD3A852F19F_METHOD_1_F230511816A7C6C1_OFFSET UNITYSDK_OFFSET(0xC56BA60)
#define RPG_CLIENT_ACTIVITYHIPPLEN_MONOBABYHIPPLEN_CLASS_1_F5A99FD3A852F19F__CTOR_OFFSET UNITYSDK_OFFSET(0xC56C340)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int MonoBabyHipplen_Class_1_F5A99FD3A852F19F_TypeDefinitionIndex = 75301;

	class MonoBabyHipplen_Class_1_F5A99FD3A852F19F : public ::System::Object
	{
	public:
		::RPG::Client::LookAtIK* LHEEDHAPKOA; // 0x10
		::System::Single LLNIGIGFCEA; // 0x18
		::System::Single LFKMOIDKOEL; // 0x1C
		::System::Single IPMECJCKIGM; // 0x20
		::System::Single PKCKMONNBLM; // 0x24
		::System::Single OHHLGJCJLPH; // 0x28
