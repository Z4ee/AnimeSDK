...
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENSTATUSCHANGEINFO_GETSTATCONFIG_OFFSET UNITYSDK_OFFSET(0x1B7BBC10)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENSTATUSCHANGEINFO_GET_CHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1B7BBC70)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENSTATUSCHANGEINFO_GET_STATTYPE_OFFSET UNITYSDK_OFFSET(0x1B7BBC90)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENSTATUSCHANGEINFO_SET_CHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1B7BBC80)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENSTATUSCHANGEINFO_SET_STATTYPE_OFFSET UNITYSDK_OFFSET(0x1B7BBCA0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENSTATUSCHANGEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7BBBE0)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int ActivityHipplenStatusChangeInfo_TypeDefinitionIndex = 75179;
	...
	public:
		...
		::System::Void _ctor(::Class_1_D17272E82AE804C2_557* a1)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_D17272E82AE804C2_557*))((::PBYTE)hIl2Cpp + RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENSTATUSCHANGEINFO__CTOR_OFFSET))(this, a1);
		}
