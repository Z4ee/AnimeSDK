...
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENSTATUSCHANGEINFO_GETSTATCONFIG_OFFSET UNITYSDK_OFFSET(0x19BCC060)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENSTATUSCHANGEINFO_GET_CHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x19BCC0C0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENSTATUSCHANGEINFO_GET_STATTYPE_OFFSET UNITYSDK_OFFSET(0x19BCC0E0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENSTATUSCHANGEINFO_SET_CHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x19BCC0D0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENSTATUSCHANGEINFO_SET_STATTYPE_OFFSET UNITYSDK_OFFSET(0x19BCC0F0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENSTATUSCHANGEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19BCC030)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int ActivityHipplenStatusChangeInfo_TypeDefinitionIndex = 71873;
	...
	public:
		...
		::System::Void _ctor(::Class_1_D17272E82AE804C2_544* a1)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_D17272E82AE804C2_544*))((::PBYTE)hIl2Cpp + RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENSTATUSCHANGEINFO__CTOR_OFFSET))(this, a1);
		}
