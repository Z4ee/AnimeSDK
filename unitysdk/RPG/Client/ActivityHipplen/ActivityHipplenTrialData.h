...
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENTRIALDATA_GET_GAMEJSONPATH_OFFSET UNITYSDK_OFFSET(0xC55B010)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENTRIALDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0xC55AEE0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENTRIALDATA_GET_TRIALROW_OFFSET UNITYSDK_OFFSET(0xC55AF00)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENTRIALDATA_GET_TRIALTITLE_OFFSET UNITYSDK_OFFSET(0xC55AF20)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENTRIALDATA_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xC55AFC0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENTRIALDATA_SET_ID_OFFSET UNITYSDK_OFFSET(0xC55AEF0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENTRIALDATA_SET_TRIALROW_OFFSET UNITYSDK_OFFSET(0xC55AF10)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENTRIALDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC5569A0)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int ActivityHipplenTrialData_TypeDefinitionIndex = 75309;
