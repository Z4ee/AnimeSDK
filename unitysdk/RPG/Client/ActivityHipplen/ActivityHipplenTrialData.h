...
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENTRIALDATA_GET_GAMEJSONPATH_OFFSET UNITYSDK_OFFSET(0x19BCD910)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENTRIALDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0x19BCD7E0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENTRIALDATA_GET_TRIALROW_OFFSET UNITYSDK_OFFSET(0x19BCD800)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENTRIALDATA_GET_TRIALTITLE_OFFSET UNITYSDK_OFFSET(0x19BCD820)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENTRIALDATA_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x19BCD8C0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENTRIALDATA_SET_ID_OFFSET UNITYSDK_OFFSET(0x19BCD7F0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENTRIALDATA_SET_TRIALROW_OFFSET UNITYSDK_OFFSET(0x19BCD810)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENTRIALDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19BC9250)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int ActivityHipplenTrialData_TypeDefinitionIndex = 72002;
