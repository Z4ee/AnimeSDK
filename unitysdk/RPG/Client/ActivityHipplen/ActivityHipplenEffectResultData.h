...
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENEFFECTRESULTDATA_ADD_OFFSET UNITYSDK_OFFSET(0x1B79FB60)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENEFFECTRESULTDATA_CEILTOINT_OFFSET UNITYSDK_OFFSET(0x1B79D920)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENEFFECTRESULTDATA_CLONE_OFFSET UNITYSDK_OFFSET(0x1B79DE90)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENEFFECTRESULTDATA_GETVIEWDATABYTYPE_OFFSET UNITYSDK_OFFSET(0x1B7A0730)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENEFFECTRESULTDATA_GETVIEWDATA_OFFSET UNITYSDK_OFFSET(0x1B7A08A0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENEFFECTRESULTDATA_RESET_OFFSET UNITYSDK_OFFSET(0x1B79D820)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENEFFECTRESULTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B79E4A0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENEFFECTRESULTDATA__GETHIPPLENSTATTYPEORDER_OFFSET UNITYSDK_OFFSET(0x1B7A0D90)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENEFFECTRESULTDATA__GETVIEWDATA_B__5_0_OFFSET UNITYSDK_OFFSET(0x1B7A0DF0)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int ActivityHipplenEffectResultData_TypeDefinitionIndex = 75188;
