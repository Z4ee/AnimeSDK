...
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENEFFECTRESULTDATA_ADD_OFFSET UNITYSDK_OFFSET(0x19BB0380)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENEFFECTRESULTDATA_CEILTOINT_OFFSET UNITYSDK_OFFSET(0x19BAE140)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENEFFECTRESULTDATA_CLONE_OFFSET UNITYSDK_OFFSET(0x19BAE6B0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENEFFECTRESULTDATA_GETVIEWDATABYTYPE_OFFSET UNITYSDK_OFFSET(0x19BB0F50)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENEFFECTRESULTDATA_GETVIEWDATA_OFFSET UNITYSDK_OFFSET(0x19BB10C0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENEFFECTRESULTDATA_RESET_OFFSET UNITYSDK_OFFSET(0x19BAE040)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENEFFECTRESULTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19BAECC0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENEFFECTRESULTDATA__GETHIPPLENSTATTYPEORDER_OFFSET UNITYSDK_OFFSET(0x19BB15A0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENEFFECTRESULTDATA__GETVIEWDATA_B__5_0_OFFSET UNITYSDK_OFFSET(0x19BB1600)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int ActivityHipplenEffectResultData_TypeDefinitionIndex = 71882;
