...
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINCIDENTWORKDATA_GETWORKDATARATIOPROBABILITY_OFFSET UNITYSDK_OFFSET(0xC546090)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINCIDENTWORKDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC545C90)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINCIDENTWORKDATA__INITWORKEFFECTS_OFFSET UNITYSDK_OFFSET(0xC545D80)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int ActivityHipplenIncidentWorkData_TypeDefinitionIndex = 75315;
