...
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINCIDENTSHOWSTORYPARAM_GET_DIALOGID_OFFSET UNITYSDK_OFFSET(0x19BB8650)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINCIDENTSHOWSTORYPARAM_GET_IMAGEPATH_OFFSET UNITYSDK_OFFSET(0x19BB8640)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINCIDENTSHOWSTORYPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x19BB8660)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int ActivityHipplenIncidentShowStoryParam_TypeDefinitionIndex = 71950;
