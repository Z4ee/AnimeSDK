...
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINCIDENTSHOWSTORYPARAM_GET_DIALOGID_OFFSET UNITYSDK_OFFSET(0x1B7A7E40)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINCIDENTSHOWSTORYPARAM_GET_IMAGEPATH_OFFSET UNITYSDK_OFFSET(0x1B7A7E30)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINCIDENTSHOWSTORYPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7A7E50)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int ActivityHipplenIncidentShowStoryParam_TypeDefinitionIndex = 75256;
