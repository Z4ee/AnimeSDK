...
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_CANRESTART_OFFSET UNITYSDK_OFFSET(0x8F245F0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8F23E60)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_DOREPORT_OFFSET UNITYSDK_OFFSET(0x8F245A0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_ENABLEAUTOMODESWITCH_OFFSET UNITYSDK_OFFSET(0x8F24920)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_ENABLEAUTOMODE_OFFSET UNITYSDK_OFFSET(0x8F24760)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_GET_ISAUTOMODE_OFFSET UNITYSDK_OFFSET(0x8F25C70)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_GET_ROOTANCHORNAME_OFFSET UNITYSDK_OFFSET(0x8F25C90)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_INIT_OFFSET UNITYSDK_OFFSET(0x8F23CC0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_LOADCHARACTER_OFFSET UNITYSDK_OFFSET(0x8F249C0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_ONUISCREENSIZECHANGED_OFFSET UNITYSDK_OFFSET(0x8F25020)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_PAUSE_OFFSET UNITYSDK_OFFSET(0x8F244A0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_RESTART_OFFSET UNITYSDK_OFFSET(0x8F24520)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_RESUME_OFFSET UNITYSDK_OFFSET(0x8F244E0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_SETTLEGAME_OFFSET UNITYSDK_OFFSET(0x8F24630)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_SET_ISAUTOMODE_OFFSET UNITYSDK_OFFSET(0x8F25C80)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_START_OFFSET UNITYSDK_OFFSET(0x8F23C70)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_TICK_OFFSET UNITYSDK_OFFSET(0x8F23860)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_TRYLOADATMOSPHERE_OFFSET UNITYSDK_OFFSET(0x8F24D00)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE_TRYUNLOADATMOSPHERE_OFFSET UNITYSDK_OFFSET(0x8F24FD0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__CREATECHARACTER_OFFSET UNITYSDK_OFFSET(0x8F24A20)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__CREATENPC_OFFSET UNITYSDK_OFFSET(0x8F25560)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__CREATESTATICPREFAB_OFFSET UNITYSDK_OFFSET(0x8F257A0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x8F23820)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__DESTORYALLENTITY_OFFSET UNITYSDK_OFFSET(0x8F241C0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__DOSETAUTOMODE_OFFSET UNITYSDK_OFFSET(0x8F24820)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__ENDCURRENTLG_OFFSET UNITYSDK_OFFSET(0x8F243C0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__EXECUTETASKLIST_OFFSET UNITYSDK_OFFSET(0x8F25420)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__FIREAUTOMODEEVENT_OFFSET UNITYSDK_OFFSET(0x8F24880)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__GETGRADETYPE_OFFSET UNITYSDK_OFFSET(0x8F252D0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__GETLOCALPLAYERNPCID_OFFSET UNITYSDK_OFFSET(0x8F259A0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__LOADATMOSPHERE_OFFSET UNITYSDK_OFFSET(0x8F24D50)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__ONAUTOMODECHANGED_OFFSET UNITYSDK_OFFSET(0x8F25310)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__ONDISPOSE_OFFSET UNITYSDK_OFFSET(0x8F25250)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__ONINIT_OFFSET UNITYSDK_OFFSET(0x8F251B0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__ONSETTLE_OFFSET UNITYSDK_OFFSET(0x8F25290)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__ONSTART_OFFSET UNITYSDK_OFFSET(0x8F25170)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__ONTICK_OFFSET UNITYSDK_OFFSET(0x8F251F0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__SENDSETTLEPACKET_OFFSET UNITYSDK_OFFSET(0x8F239A0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__SETATMOSPHERECONFIG_OFFSET UNITYSDK_OFFSET(0x8F25110)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__SETENTITYDITHER_OFFSET UNITYSDK_OFFSET(0x8F25B10)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__STARTLG_OFFSET UNITYSDK_OFFSET(0x8F25350)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEBASE__UNLOADATMOSPHERE_OFFSET UNITYSDK_OFFSET(0x8F23F60)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int ActivityHipplenMiniGameBase_TypeDefinitionIndex = 61729;

	class ActivityHipplenMiniGameBase : public ::System::Object
	{
	public:
		::Class_1_7E0DCA9D208905FE* _BabyHipplenRef; // 0x10
		::System::Action* _OnTaskFinished; // 0x18
		::RPG::Client::ActivityHipplen::ActivityHipplenMiniGameManager* _Manager; // 0x20
		::System::String* _RootAnchorName_k__BackingField; // 0x28
		::RPG::Client::ActivityHipplen::ActivityHipplenGameConfig _Config; // 0x30
		...
		::Class_1_69FF5DE516C87A66* _TaskExecuter; // 0x50
		::UnityEngine::Transform* _Root; // 0x58
		::System::Boolean _IsAutoMode_k__BackingField; // 0x60
		::System::Boolean _IsAtmosphereLoaded; // 0x61
		::System::Boolean _IsAutoModeSwitchEnabled; // 0x62
		::System::Boolean _IsLGStarted; // 0x63
