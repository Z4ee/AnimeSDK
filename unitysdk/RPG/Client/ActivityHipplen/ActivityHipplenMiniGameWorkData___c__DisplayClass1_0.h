...
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEWORKDATA___C__DISPLAYCLASS1_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC552570)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEWORKDATA___C__DISPLAYCLASS1_0___INITWORKEFFECTS_B__0_OFFSET UNITYSDK_OFFSET(0xC5525C0)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int ActivityHipplenMiniGameWorkData___c__DisplayClass1_0_TypeDefinitionIndex = 75313;
