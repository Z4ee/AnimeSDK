...
#define RPG_CLIENT_ACTIVITYHIPPLEN_HIPPLENCOUNTINGCHIMERAMINIGAME_PLAYINGTRACKASSET__CTOR_OFFSET UNITYSDK_OFFSET(0xB0E98D0)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int HipplenCountingChimeraMiniGame_PlayingTrackAsset_TypeDefinitionIndex = 70457;
	...
	public:
		...
		::System::Double StartTime; // 0x28
		::System::Boolean IsWorking; // 0x30
		::System::Boolean IsFinished; // 0x31
