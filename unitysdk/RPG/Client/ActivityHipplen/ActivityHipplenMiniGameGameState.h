...
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEGAMESTATE_DEBUGFORCESETGAMECONFIG_OFFSET UNITYSDK_OFFSET(0xC550630)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEGAMESTATE_GET_CANSWITCHAUTOMODE_OFFSET UNITYSDK_OFFSET(0xC5506B0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEGAMESTATE_GET_GAMECONFIG_OFFSET UNITYSDK_OFFSET(0xC550690)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEGAMESTATE_GET_STATETYPE_OFFSET UNITYSDK_OFFSET(0xC550280)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEGAMESTATE_GET__CYCLEDATA_OFFSET UNITYSDK_OFFSET(0xC5501E0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEGAMESTATE_ONFINISH_OFFSET UNITYSDK_OFFSET(0xC550470)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEGAMESTATE_ONREALENTER_OFFSET UNITYSDK_OFFSET(0xC5502D0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEGAMESTATE_SETTLEGAME_OFFSET UNITYSDK_OFFSET(0xC5504C0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEGAMESTATE_SET_CANSWITCHAUTOMODE_OFFSET UNITYSDK_OFFSET(0xC5506C0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEGAMESTATE_SET_GAMECONFIG_OFFSET UNITYSDK_OFFSET(0xC5506A0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENMINIGAMEGAMESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0xC54FF80)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int ActivityHipplenMiniGameGameState_TypeDefinitionIndex = 75219;
