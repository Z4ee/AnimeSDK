...
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENENDINGDATA_GET_DESCTEXTID_OFFSET UNITYSDK_OFFSET(0x9AE87A0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENENDINGDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0x9AE8730)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENENDINGDATA_GET_IMAGEPATH_OFFSET UNITYSDK_OFFSET(0x9AE8800)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENENDINGDATA_GET_ISREWARDTAKEN_OFFSET UNITYSDK_OFFSET(0x9AE8760)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENENDINGDATA_GET_NAMETEXTID_OFFSET UNITYSDK_OFFSET(0x9AE8770)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENENDINGDATA_GET_REWARDID_OFFSET UNITYSDK_OFFSET(0x9AE8820)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENENDINGDATA_GET_UNLOCKDESCTEXTID_OFFSET UNITYSDK_OFFSET(0x9AE87D0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENENDINGDATA_GET_UNLOCKED_OFFSET UNITYSDK_OFFSET(0x9AE8750)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENENDINGDATA_MARKSEEN_OFFSET UNITYSDK_OFFSET(0x9AE85C0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENENDINGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9AE3B00)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int ActivityHipplenEndingData_TypeDefinitionIndex = 69558;
