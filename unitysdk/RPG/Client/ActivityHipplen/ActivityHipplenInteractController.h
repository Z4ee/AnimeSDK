...
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_ADDPROGRESS_OFFSET UNITYSDK_OFFSET(0x19BBBA30)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19BB99C0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_ENDINTERACT_OFFSET UNITYSDK_OFFSET(0x19BBA850)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_FINISH_OFFSET UNITYSDK_OFFSET(0x19BBBE40)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_GETHINTTEXTID_OFFSET UNITYSDK_OFFSET(0x19BBA190)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_GETINTERACTPROPS_OFFSET UNITYSDK_OFFSET(0x19BB9C70)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_GETINTERACTPROPTRANSFORM_OFFSET UNITYSDK_OFFSET(0x19BB98B0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_GETINTERACT_OFFSET UNITYSDK_OFFSET(0x19BBC4D0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_GETISLASTINTERACTVALID_OFFSET UNITYSDK_OFFSET(0x19BB9980)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_GET_CANRESTART_OFFSET UNITYSDK_OFFSET(0x19BBC640)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_GET_CANROTATECAMERA_OFFSET UNITYSDK_OFFSET(0x19BBC690)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_GET_CURINTERACTPROP_OFFSET UNITYSDK_OFFSET(0x19BBC5D0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_GET_MAINCTRLREF_OFFSET UNITYSDK_OFFSET(0x19BBC620)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0x19BB8CF0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_ONUISCREENSIZECHANGED_OFFSET UNITYSDK_OFFSET(0x19BBC510)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_PAUSE_OFFSET UNITYSDK_OFFSET(0x19BBC0D0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_REGISTERCOMPLETEDCALLBACK_OFFSET UNITYSDK_OFFSET(0x19BB9860)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_REGISTERINTERACTSTATECHANGEDCALLBACK_OFFSET UNITYSDK_OFFSET(0x19BB9810)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_REGISTERPROGRESSCHANGEDCALLBACK_OFFSET UNITYSDK_OFFSET(0x19BB97C0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_REPORT_OFFSET UNITYSDK_OFFSET(0x19BBC420)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_RESTART_OFFSET UNITYSDK_OFFSET(0x19BBC170)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_RESUME_OFFSET UNITYSDK_OFFSET(0x19BBC120)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_SETINTERACTTRIGGERNAME_OFFSET UNITYSDK_OFFSET(0x19BBAAD0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_SET_CANROTATECAMERA_OFFSET UNITYSDK_OFFSET(0x19BBC6A0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_SET_MAINCTRLREF_OFFSET UNITYSDK_OFFSET(0x19BBC630)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_STARTINTERACT_OFFSET UNITYSDK_OFFSET(0x19BBA260)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_TICK_OFFSET UNITYSDK_OFFSET(0x19BB8B60)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_UPDATEINTERACTPREFABLOCATION_OFFSET UNITYSDK_OFFSET(0x19BBAB60)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_UPDATEINTERACTVALIDSTATE_OFFSET UNITYSDK_OFFSET(0x19BBBED0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x19BBC6F0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER__CLEAR_OFFSET UNITYSDK_OFFSET(0x19BBA950)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19BBC6B0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER__GETPROGRESSINCREASERATIO_OFFSET UNITYSDK_OFFSET(0x19BBBC70)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER__GETSHAKEPARAMS_OFFSET UNITYSDK_OFFSET(0x19BBB070)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER__ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x19BBA5E0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER__ONINTERACTVALIDSTATECHANGED_OFFSET UNITYSDK_OFFSET(0x19BBBF20)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER__UPDATEINTERACTPREFABPOSITION_OFFSET UNITYSDK_OFFSET(0x19BBB1A0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER__UPDATEINTERACTPREFABROTATION_OFFSET UNITYSDK_OFFSET(0x19BBB3E0)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int ActivityHipplenInteractController_TypeDefinitionIndex = 71966;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ActivityHipplenInteractController_TypeDefinitionIndex)->GetStaticField(0x9C00);
		}
		...
		::Class_1_6B68BF08CE41EC5F* _HipplenInstance; // 0x78
