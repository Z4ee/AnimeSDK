...
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_ADDPROGRESS_OFFSET UNITYSDK_OFFSET(0xC549050)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC546FE0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_ENDINTERACT_OFFSET UNITYSDK_OFFSET(0xC547E70)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_FINISH_OFFSET UNITYSDK_OFFSET(0xC549460)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_GETHINTTEXTID_OFFSET UNITYSDK_OFFSET(0xC5477B0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_GETINTERACTPROPS_OFFSET UNITYSDK_OFFSET(0xC547290)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_GETINTERACTPROPTRANSFORM_OFFSET UNITYSDK_OFFSET(0xC546ED0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_GETINTERACT_OFFSET UNITYSDK_OFFSET(0xC549AF0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_GETISLASTINTERACTVALID_OFFSET UNITYSDK_OFFSET(0xC546FA0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_GET_CANRESTART_OFFSET UNITYSDK_OFFSET(0xC549C60)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_GET_CANROTATECAMERA_OFFSET UNITYSDK_OFFSET(0xC549CB0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_GET_CURINTERACTPROP_OFFSET UNITYSDK_OFFSET(0xC549BF0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_GET_MAINCTRLREF_OFFSET UNITYSDK_OFFSET(0xC549C40)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0xC546310)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_ONUISCREENSIZECHANGED_OFFSET UNITYSDK_OFFSET(0xC549B30)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_PAUSE_OFFSET UNITYSDK_OFFSET(0xC5496F0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_REGISTERCOMPLETEDCALLBACK_OFFSET UNITYSDK_OFFSET(0xC546E80)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_REGISTERINTERACTSTATECHANGEDCALLBACK_OFFSET UNITYSDK_OFFSET(0xC546E30)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_REGISTERPROGRESSCHANGEDCALLBACK_OFFSET UNITYSDK_OFFSET(0xC546DE0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_REPORT_OFFSET UNITYSDK_OFFSET(0xC549A40)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_RESTART_OFFSET UNITYSDK_OFFSET(0xC549790)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_RESUME_OFFSET UNITYSDK_OFFSET(0xC549740)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_SETINTERACTTRIGGERNAME_OFFSET UNITYSDK_OFFSET(0xC5480F0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_SET_CANROTATECAMERA_OFFSET UNITYSDK_OFFSET(0xC549CC0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_SET_MAINCTRLREF_OFFSET UNITYSDK_OFFSET(0xC549C50)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_STARTINTERACT_OFFSET UNITYSDK_OFFSET(0xC547880)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_TICK_OFFSET UNITYSDK_OFFSET(0xC546180)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_UPDATEINTERACTPREFABLOCATION_OFFSET UNITYSDK_OFFSET(0xC548180)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER_UPDATEINTERACTVALIDSTATE_OFFSET UNITYSDK_OFFSET(0xC5494F0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xC549D10)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER__CLEAR_OFFSET UNITYSDK_OFFSET(0xC547F70)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC549CD0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER__GETPROGRESSINCREASERATIO_OFFSET UNITYSDK_OFFSET(0xC549290)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER__GETSHAKEPARAMS_OFFSET UNITYSDK_OFFSET(0xC548690)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER__ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0xC547C00)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER__ONINTERACTVALIDSTATECHANGED_OFFSET UNITYSDK_OFFSET(0xC549540)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER__UPDATEINTERACTPREFABPOSITION_OFFSET UNITYSDK_OFFSET(0xC5487C0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTCONTROLLER__UPDATEINTERACTPREFABROTATION_OFFSET UNITYSDK_OFFSET(0xC548A00)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int ActivityHipplenInteractController_TypeDefinitionIndex = 75273;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ActivityHipplenInteractController_TypeDefinitionIndex)->GetStaticField(0x14420);
		}
