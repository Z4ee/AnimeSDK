...
#define RPG_CLIENT_ACTIVITYHIPPLEN_MONOHIPPLENGAMEBALL_ONCOLLISIONENTER_OFFSET UNITYSDK_OFFSET(0x19D09620)
#define RPG_CLIENT_ACTIVITYHIPPLEN_MONOHIPPLENGAMEBALL_REGISTERONCOLLISIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x19D09690)
#define RPG_CLIENT_ACTIVITYHIPPLEN_MONOHIPPLENGAMEBALL_UNREGISTERONCOLLISIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x19D09700)
#define RPG_CLIENT_ACTIVITYHIPPLEN_MONOHIPPLENGAMEBALL__CTOR_OFFSET UNITYSDK_OFFSET(0x19D09770)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int MonoHipplenGameBall_TypeDefinitionIndex = 71992;
