...
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENWORKGAMESTATEBASE___C__DISPLAYCLASS4_0__CTOR_OFFSET UNITYSDK_OFFSET(0x19BCE760)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENWORKGAMESTATEBASE___C__DISPLAYCLASS4_0__ONENTER_B__0_OFFSET UNITYSDK_OFFSET(0x19BCE820)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int ActivityHipplenWorkGameStateBase___c__DisplayClass4_0_TypeDefinitionIndex = 71930;

	class ActivityHipplenWorkGameStateBase___c__DisplayClass4_0 : public ::System::Object
	{
	public:
		::RPG::Client::ActivityHipplen::ActivityHipplenWorkGameStateBase* __4__this; // 0x10
