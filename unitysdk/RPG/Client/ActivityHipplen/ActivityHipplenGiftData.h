...
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGIFTDATA_GET_GIFTSHOWTEXT_OFFSET UNITYSDK_OFFSET(0x9AEBE70)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGIFTDATA_GET_GIFTSHOWTITLE_OFFSET UNITYSDK_OFFSET(0x9AEBE40)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGIFTDATA_GET_REWARDID_OFFSET UNITYSDK_OFFSET(0x9AEBEA0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGIFTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9AEBE00)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int ActivityHipplenGiftData_TypeDefinitionIndex = 69533;
