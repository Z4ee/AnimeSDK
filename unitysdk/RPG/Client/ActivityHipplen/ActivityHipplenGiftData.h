...
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGIFTDATA_GET_GIFTSHOWTEXT_OFFSET UNITYSDK_OFFSET(0xB0D02C0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGIFTDATA_GET_GIFTSHOWTITLE_OFFSET UNITYSDK_OFFSET(0xB0D0290)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGIFTDATA_GET_REWARDID_OFFSET UNITYSDK_OFFSET(0xB0D02F0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENGIFTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB0D0250)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int ActivityHipplenGiftData_TypeDefinitionIndex = 70345;
