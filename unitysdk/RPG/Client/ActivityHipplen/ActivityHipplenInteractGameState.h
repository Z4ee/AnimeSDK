...
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTGAMESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B7AC6A0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTGAMESTATE_DOSETTLEINTERACT_OFFSET UNITYSDK_OFFSET(0x1B7AC4E0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTGAMESTATE_GET_INTERACTIONROW_OFFSET UNITYSDK_OFFSET(0x1B7ACC80)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTGAMESTATE_GET_INTERACTTYPE_OFFSET UNITYSDK_OFFSET(0x1B7ACD00)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTGAMESTATE_GET_STATETYPE_OFFSET UNITYSDK_OFFSET(0x1B7AC2B0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTGAMESTATE_ONFINISH_OFFSET UNITYSDK_OFFSET(0x1B7AC470)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTGAMESTATE_ONREALENTER_OFFSET UNITYSDK_OFFSET(0x1B7AC300)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTGAMESTATE_SET_INTERACTTYPE_OFFSET UNITYSDK_OFFSET(0x1B7ACD10)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTGAMESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7AC240)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTGAMESTATE__ONCLIENTUNLOCKTRAITS_OFFSET UNITYSDK_OFFSET(0x1B7AC760)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int ActivityHipplenInteractGameState_TypeDefinitionIndex = 75216;
