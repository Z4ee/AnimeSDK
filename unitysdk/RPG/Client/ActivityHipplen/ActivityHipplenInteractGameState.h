...
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTGAMESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19BBCC30)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTGAMESTATE_DOSETTLEINTERACT_OFFSET UNITYSDK_OFFSET(0x19BBCA70)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTGAMESTATE_GET_INTERACTIONROW_OFFSET UNITYSDK_OFFSET(0x19BBD210)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTGAMESTATE_GET_INTERACTTYPE_OFFSET UNITYSDK_OFFSET(0x19BBD290)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTGAMESTATE_GET_STATETYPE_OFFSET UNITYSDK_OFFSET(0x19BBC840)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTGAMESTATE_ONFINISH_OFFSET UNITYSDK_OFFSET(0x19BBCA00)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTGAMESTATE_ONREALENTER_OFFSET UNITYSDK_OFFSET(0x19BBC890)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTGAMESTATE_SET_INTERACTTYPE_OFFSET UNITYSDK_OFFSET(0x19BBD2A0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTGAMESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19BBC7D0)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINTERACTGAMESTATE__ONCLIENTUNLOCKTRAITS_OFFSET UNITYSDK_OFFSET(0x19BBCCF0)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int ActivityHipplenInteractGameState_TypeDefinitionIndex = 71910;
