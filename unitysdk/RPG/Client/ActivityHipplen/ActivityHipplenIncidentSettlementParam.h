...
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINCIDENTSETTLEMENTPARAM_GET_DIALOGID_OFFSET UNITYSDK_OFFSET(0xC545B30)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINCIDENTSETTLEMENTPARAM_GET_IMAGEPATH_OFFSET UNITYSDK_OFFSET(0xC545B20)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINCIDENTSETTLEMENTPARAM_GET_ISRANDOM_OFFSET UNITYSDK_OFFSET(0xC545B40)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINCIDENTSETTLEMENTPARAM_GET_ISSUCC_OFFSET UNITYSDK_OFFSET(0xC545B50)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINCIDENTSETTLEMENTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xC545900)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int ActivityHipplenIncidentSettlementParam_TypeDefinitionIndex = 75243;
