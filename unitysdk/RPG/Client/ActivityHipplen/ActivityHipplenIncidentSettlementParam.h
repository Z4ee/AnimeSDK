...
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINCIDENTSETTLEMENTPARAM_GET_DIALOGID_OFFSET UNITYSDK_OFFSET(0x8F1C750)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINCIDENTSETTLEMENTPARAM_GET_IMAGEPATH_OFFSET UNITYSDK_OFFSET(0x8F1C740)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINCIDENTSETTLEMENTPARAM_GET_ISRANDOM_OFFSET UNITYSDK_OFFSET(0x8F1C760)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINCIDENTSETTLEMENTPARAM_GET_ISSUCC_OFFSET UNITYSDK_OFFSET(0x8F1C770)
#define RPG_CLIENT_ACTIVITYHIPPLEN_ACTIVITYHIPPLENINCIDENTSETTLEMENTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x8F1C5F0)

namespace RPG::Client::ActivityHipplen
{
	inline static constexpr unsigned int ActivityHipplenIncidentSettlementParam_TypeDefinitionIndex = 61691;
