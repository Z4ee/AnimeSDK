...
#define RPG_CLIENT_ROGUETOURNPERSONAHEXEQUIPMENTSLOTPANELINFO_CREATE_OFFSET UNITYSDK_OFFSET(0x1C35B710)
#define RPG_CLIENT_ROGUETOURNPERSONAHEXEQUIPMENTSLOTPANELINFO_GETREMOVEEQUIPPEDHEXID_OFFSET UNITYSDK_OFFSET(0x1C35BC10)
#define RPG_CLIENT_ROGUETOURNPERSONAHEXEQUIPMENTSLOTPANELINFO_GET_EQUIPPEDCOUNT_OFFSET UNITYSDK_OFFSET(0x1C35B4F0)
#define RPG_CLIENT_ROGUETOURNPERSONAHEXEQUIPMENTSLOTPANELINFO_GET_PRESLOTCNT_OFFSET UNITYSDK_OFFSET(0x1C35B350)
#define RPG_CLIENT_ROGUETOURNPERSONAHEXEQUIPMENTSLOTPANELINFO_GET_SLOTCNT_OFFSET UNITYSDK_OFFSET(0x1C35B240)
#define RPG_CLIENT_ROGUETOURNPERSONAHEXEQUIPMENTSLOTPANELINFO_GET_SLOTITEMS_OFFSET UNITYSDK_OFFSET(0x1C35B6D0)
#define RPG_CLIENT_ROGUETOURNPERSONAHEXEQUIPMENTSLOTPANELINFO_ISSLOTSFULL_OFFSET UNITYSDK_OFFSET(0x1C35BB70)
#define RPG_CLIENT_ROGUETOURNPERSONAHEXEQUIPMENTSLOTPANELINFO_REFRESH_OFFSET UNITYSDK_OFFSET(0x1C79ADF0)
#define RPG_CLIENT_ROGUETOURNPERSONAHEXEQUIPMENTSLOTPANELINFO_TRYUNEQUIPHEX_OFFSET UNITYSDK_OFFSET(0x1C79AC90)
#define RPG_CLIENT_ROGUETOURNPERSONAHEXEQUIPMENTSLOTPANELINFO__ADDACHIVEDHEXES_OFFSET UNITYSDK_OFFSET(0x1C79B110)
#define RPG_CLIENT_ROGUETOURNPERSONAHEXEQUIPMENTSLOTPANELINFO__ADDHEX_OFFSET UNITYSDK_OFFSET(0x1C79B8E0)
#define RPG_CLIENT_ROGUETOURNPERSONAHEXEQUIPMENTSLOTPANELINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1C79B970)
#define RPG_CLIENT_ROGUETOURNPERSONAHEXEQUIPMENTSLOTPANELINFO__INIT_OFFSET UNITYSDK_OFFSET(0x1C35B7D0)
#define RPG_CLIENT_ROGUETOURNPERSONAHEXEQUIPMENTSLOTPANELINFO__REMOVEINVALIDHEXES_OFFSET UNITYSDK_OFFSET(0x1C79AE50)
#define RPG_CLIENT_ROGUETOURNPERSONAHEXEQUIPMENTSLOTPANELINFO__SHIFTHEXES_OFFSET UNITYSDK_OFFSET(0x1C79B720)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueTournPersonaHexEquipmentSlotPanelInfo_TypeDefinitionIndex = 72804;
