...
#define RPG_CLIENT_ROGUETOURNPERSONAHEXEQUIPMENTSLOTPANELINFO_CREATE_OFFSET UNITYSDK_OFFSET(0xDF88260)
#define RPG_CLIENT_ROGUETOURNPERSONAHEXEQUIPMENTSLOTPANELINFO_GETREMOVEEQUIPPEDHEXID_OFFSET UNITYSDK_OFFSET(0xDF887E0)
#define RPG_CLIENT_ROGUETOURNPERSONAHEXEQUIPMENTSLOTPANELINFO_GET_EQUIPPEDCOUNT_OFFSET UNITYSDK_OFFSET(0xDF88040)
#define RPG_CLIENT_ROGUETOURNPERSONAHEXEQUIPMENTSLOTPANELINFO_GET_PRESLOTCNT_OFFSET UNITYSDK_OFFSET(0xDF87EA0)
#define RPG_CLIENT_ROGUETOURNPERSONAHEXEQUIPMENTSLOTPANELINFO_GET_SLOTCNT_OFFSET UNITYSDK_OFFSET(0xDF87D90)
#define RPG_CLIENT_ROGUETOURNPERSONAHEXEQUIPMENTSLOTPANELINFO_GET_SLOTITEMS_OFFSET UNITYSDK_OFFSET(0xDF88220)
#define RPG_CLIENT_ROGUETOURNPERSONAHEXEQUIPMENTSLOTPANELINFO_ISSLOTSFULL_OFFSET UNITYSDK_OFFSET(0xDF88740)
#define RPG_CLIENT_ROGUETOURNPERSONAHEXEQUIPMENTSLOTPANELINFO_REFRESH_OFFSET UNITYSDK_OFFSET(0xDF889E0)
#define RPG_CLIENT_ROGUETOURNPERSONAHEXEQUIPMENTSLOTPANELINFO_TRYUNEQUIPHEX_OFFSET UNITYSDK_OFFSET(0xDF88880)
#define RPG_CLIENT_ROGUETOURNPERSONAHEXEQUIPMENTSLOTPANELINFO__ADDACHIVEDHEXES_OFFSET UNITYSDK_OFFSET(0xDF88D00)
#define RPG_CLIENT_ROGUETOURNPERSONAHEXEQUIPMENTSLOTPANELINFO__ADDHEX_OFFSET UNITYSDK_OFFSET(0xDF89490)
#define RPG_CLIENT_ROGUETOURNPERSONAHEXEQUIPMENTSLOTPANELINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xDF88320)
#define RPG_CLIENT_ROGUETOURNPERSONAHEXEQUIPMENTSLOTPANELINFO__INIT_OFFSET UNITYSDK_OFFSET(0xDF88360)
#define RPG_CLIENT_ROGUETOURNPERSONAHEXEQUIPMENTSLOTPANELINFO__REMOVEINVALIDHEXES_OFFSET UNITYSDK_OFFSET(0xDF88A40)
#define RPG_CLIENT_ROGUETOURNPERSONAHEXEQUIPMENTSLOTPANELINFO__SHIFTHEXES_OFFSET UNITYSDK_OFFSET(0xDF89310)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueTournPersonaHexEquipmentSlotPanelInfo_TypeDefinitionIndex = 72805;
