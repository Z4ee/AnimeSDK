...
#define RPG_CLIENT_CAMERANORMALCONFIGTEMPLATE__CTOR_OFFSET UNITYSDK_OFFSET(0x9F1F5C0)

namespace RPG::Client
{
	inline static constexpr unsigned int CameraNormalConfigTemplate_TypeDefinitionIndex = 64233;
