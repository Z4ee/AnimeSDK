...
#define RPG_CLIENT_CAMERANORMALCONFIGTEMPLATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C85A680)

namespace RPG::Client
{
	inline static constexpr unsigned int CameraNormalConfigTemplate_TypeDefinitionIndex = 69655;
