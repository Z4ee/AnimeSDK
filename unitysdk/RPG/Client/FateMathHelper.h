...
#define RPG_CLIENT_FATEMATHHELPER_FIXPOINT2PERCENTAGEINT_OFFSET UNITYSDK_OFFSET(0xB9A5420)

namespace RPG::Client
{
	inline static constexpr unsigned int FateMathHelper_TypeDefinitionIndex = 59821;
