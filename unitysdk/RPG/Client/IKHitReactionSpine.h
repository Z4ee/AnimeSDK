...
#define RPG_CLIENT_IKHITREACTIONSPINE__CTOR_OFFSET UNITYSDK_OFFSET(0x9936370)

namespace RPG::Client
{
	inline static constexpr unsigned int IKHitReactionSpine_TypeDefinitionIndex = 55887;
