...
#define RPG_CLIENT_FULLBODYIKBODYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xBAA4480)

namespace RPG::Client
{
	inline static constexpr unsigned int FullBodyIKBodyConfig_TypeDefinitionIndex = 64182;
