...
#define RPG_CLIENT_FULLBODYIKBODYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xA409EA0)

namespace RPG::Client
{
	inline static constexpr unsigned int FullBodyIKBodyConfig_TypeDefinitionIndex = 63265;
