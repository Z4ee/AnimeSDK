...
#define RPG_CLIENT_FULLBODYIKBODYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x193918D0)

namespace RPG::Client
{
	inline static constexpr unsigned int FullBodyIKBodyConfig_TypeDefinitionIndex = 68568;
