...
#define RPG_CLIENT_FULLBODYIKBODYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16D57C00)

namespace RPG::Client
{
	inline static constexpr unsigned int FullBodyIKBodyConfig_TypeDefinitionIndex = 65553;
