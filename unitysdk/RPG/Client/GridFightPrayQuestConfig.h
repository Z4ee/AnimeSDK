...
#define RPG_CLIENT_GRIDFIGHTPRAYQUESTCONFIG_GETCONFIG_OFFSET UNITYSDK_OFFSET(0x1CA59FC0)
#define RPG_CLIENT_GRIDFIGHTPRAYQUESTCONFIG_GET_COSTDESC_OFFSET UNITYSDK_OFFSET(0x1CA5B210)
#define RPG_CLIENT_GRIDFIGHTPRAYQUESTCONFIG_GET_DESC_OFFSET UNITYSDK_OFFSET(0x1CA5A570)
#define RPG_CLIENT_GRIDFIGHTPRAYQUESTCONFIG_GET_DISPLAYDESC_OFFSET UNITYSDK_OFFSET(0x1CA5A500)
#define RPG_CLIENT_GRIDFIGHTPRAYQUESTCONFIG_GET_HASCOST_OFFSET UNITYSDK_OFFSET(0x1CA5B2D0)
#define RPG_CLIENT_GRIDFIGHTPRAYQUESTCONFIG_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x1CA5B340)
#define RPG_CLIENT_GRIDFIGHTPRAYQUESTCONFIG_GET_PRAYTYPE_OFFSET UNITYSDK_OFFSET(0x1CA5AA40)
#define RPG_CLIENT_GRIDFIGHTPRAYQUESTCONFIG_GET_QUESTID_OFFSET UNITYSDK_OFFSET(0x1CA5A8F0)
#define RPG_CLIENT_GRIDFIGHTPRAYQUESTCONFIG_GET_TITLE_OFFSET UNITYSDK_OFFSET(0x1CA5B1A0)
#define RPG_CLIENT_GRIDFIGHTPRAYQUESTCONFIG_GET_TOTALPROGRESS_OFFSET UNITYSDK_OFFSET(0x1CA5B280)
#define RPG_CLIENT_GRIDFIGHTPRAYQUESTCONFIG__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CA5B390)
#define RPG_CLIENT_GRIDFIGHTPRAYQUESTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1CA5B130)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::Client::GridFightPrayQuestConfig*>**)Il2CppClass::FromTypeDefinitionIndex(GridFightPrayQuestConfig_TypeDefinitionIndex)->GetStaticField(0x3D9C0);
		}
