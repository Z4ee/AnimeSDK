...
#define RPG_CLIENT_PLANETFESFLOATINGITEM_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xACBD0B0)
#define RPG_CLIENT_PLANETFESFLOATINGITEM_METHOD_5_2EA3D2C84685E32A_OFFSET UNITYSDK_OFFSET(0xACBD2B0)
#define RPG_CLIENT_PLANETFESFLOATINGITEM_ONCREATE_OFFSET UNITYSDK_OFFSET(0xACBD0F0)
#define RPG_CLIENT_PLANETFESFLOATINGITEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xACBD020)
#define RPG_CLIENT_PLANETFESFLOATINGITEM_PLAY_OFFSET UNITYSDK_OFFSET(0xACBB540)
#define RPG_CLIENT_PLANETFESFLOATINGITEM_SETICON_OFFSET UNITYSDK_OFFSET(0xACBB430)
#define RPG_CLIENT_PLANETFESFLOATINGITEM_SETNUMBER_OFFSET UNITYSDK_OFFSET(0xACBB4E0)
#define RPG_CLIENT_PLANETFESFLOATINGITEM_SPAWNED_OFFSET UNITYSDK_OFFSET(0xACBD070)
#define RPG_CLIENT_PLANETFESFLOATINGITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xACBD530)

namespace RPG::Client
{
	inline static constexpr unsigned int PlanetFesFloatingItem_TypeDefinitionIndex = 61255;
