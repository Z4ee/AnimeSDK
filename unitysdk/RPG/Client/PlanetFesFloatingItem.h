...
#define RPG_CLIENT_PLANETFESFLOATINGITEM_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xC411910)
#define RPG_CLIENT_PLANETFESFLOATINGITEM_METHOD_5_2EA3D2C84685E32A_OFFSET UNITYSDK_OFFSET(0xC411B10)
#define RPG_CLIENT_PLANETFESFLOATINGITEM_ONCREATE_OFFSET UNITYSDK_OFFSET(0xC411950)
#define RPG_CLIENT_PLANETFESFLOATINGITEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC411880)
#define RPG_CLIENT_PLANETFESFLOATINGITEM_PLAY_OFFSET UNITYSDK_OFFSET(0xC40FDF0)
#define RPG_CLIENT_PLANETFESFLOATINGITEM_SETICON_OFFSET UNITYSDK_OFFSET(0xC40FCE0)
#define RPG_CLIENT_PLANETFESFLOATINGITEM_SETNUMBER_OFFSET UNITYSDK_OFFSET(0xC40FD90)
#define RPG_CLIENT_PLANETFESFLOATINGITEM_SPAWNED_OFFSET UNITYSDK_OFFSET(0xC4118D0)
#define RPG_CLIENT_PLANETFESFLOATINGITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xC411D90)

namespace RPG::Client
{
	inline static constexpr unsigned int PlanetFesFloatingItem_TypeDefinitionIndex = 62179;
