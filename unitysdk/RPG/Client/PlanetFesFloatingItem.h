...
#define RPG_CLIENT_PLANETFESFLOATINGITEM_DESPAWNED_OFFSET UNITYSDK_OFFSET(0x9F98820)
#define RPG_CLIENT_PLANETFESFLOATINGITEM_METHOD_5_2EA3D2C84685E32A_OFFSET UNITYSDK_OFFSET(0x9F98A20)
#define RPG_CLIENT_PLANETFESFLOATINGITEM_ONCREATE_OFFSET UNITYSDK_OFFSET(0x9F98860)
#define RPG_CLIENT_PLANETFESFLOATINGITEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9F98790)
#define RPG_CLIENT_PLANETFESFLOATINGITEM_PLAY_OFFSET UNITYSDK_OFFSET(0x9F96DF0)
#define RPG_CLIENT_PLANETFESFLOATINGITEM_SETICON_OFFSET UNITYSDK_OFFSET(0x9F96CE0)
#define RPG_CLIENT_PLANETFESFLOATINGITEM_SETNUMBER_OFFSET UNITYSDK_OFFSET(0x9F96D90)
#define RPG_CLIENT_PLANETFESFLOATINGITEM_SPAWNED_OFFSET UNITYSDK_OFFSET(0x9F987E0)
#define RPG_CLIENT_PLANETFESFLOATINGITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x9F98CA0)

namespace RPG::Client
{
	inline static constexpr unsigned int PlanetFesFloatingItem_TypeDefinitionIndex = 54092;
	...
	public:
		...
		::Class_1_43B508F64DA705FE* Field_5_6; // 0x48
