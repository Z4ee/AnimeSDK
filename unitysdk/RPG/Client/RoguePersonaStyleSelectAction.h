...
#define RPG_CLIENT_ROGUEPERSONASTYLESELECTACTION_GETROGUEACTIONID_OFFSET UNITYSDK_OFFSET(0x1BA04170)
#define RPG_CLIENT_ROGUEPERSONASTYLESELECTACTION_GET_ISDISABLEREROLL_OFFSET UNITYSDK_OFFSET(0x1BA03F90)
#define RPG_CLIENT_ROGUEPERSONASTYLESELECTACTION_GET_MAXREROLLCOUNT_OFFSET UNITYSDK_OFFSET(0x1BA03F70)
#define RPG_CLIENT_ROGUEPERSONASTYLESELECTACTION_GET_STYLELIST_OFFSET UNITYSDK_OFFSET(0x1BA03F30)
#define RPG_CLIENT_ROGUEPERSONASTYLESELECTACTION_GET_USEDREROLLCOUNT_OFFSET UNITYSDK_OFFSET(0x1BA03F50)
#define RPG_CLIENT_ROGUEPERSONASTYLESELECTACTION_REFRESHONROLLRSP_OFFSET UNITYSDK_OFFSET(0x1BA040C0)
#define RPG_CLIENT_ROGUEPERSONASTYLESELECTACTION_SET_ISDISABLEREROLL_OFFSET UNITYSDK_OFFSET(0x1BA03FA0)
#define RPG_CLIENT_ROGUEPERSONASTYLESELECTACTION_SET_MAXREROLLCOUNT_OFFSET UNITYSDK_OFFSET(0x1BA03F80)
#define RPG_CLIENT_ROGUEPERSONASTYLESELECTACTION_SET_STYLELIST_OFFSET UNITYSDK_OFFSET(0x1BA03F40)
#define RPG_CLIENT_ROGUEPERSONASTYLESELECTACTION_SET_USEDREROLLCOUNT_OFFSET UNITYSDK_OFFSET(0x1BA03F60)
#define RPG_CLIENT_ROGUEPERSONASTYLESELECTACTION_TRIGGERACTION_OFFSET UNITYSDK_OFFSET(0x1BA041B0)
#define RPG_CLIENT_ROGUEPERSONASTYLESELECTACTION__CONSTRUCT_OFFSET UNITYSDK_OFFSET(0x1BA04050)
#define RPG_CLIENT_ROGUEPERSONASTYLESELECTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA03FB0)
#define RPG_CLIENT_ROGUEPERSONASTYLESELECTACTION__SETUPSTYLELIST_OFFSET UNITYSDK_OFFSET(0x1BA04200)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::Boolean _IsDisableReroll_k__BackingField; // 0x20
