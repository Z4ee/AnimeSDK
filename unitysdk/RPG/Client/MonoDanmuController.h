...
#define RPG_CLIENT_MONODANMUCONTROLLER_ADDSEQUENCE_OFFSET UNITYSDK_OFFSET(0x19E42CC0)
#define RPG_CLIENT_MONODANMUCONTROLLER_CLEAR_OFFSET UNITYSDK_OFFSET(0x19E42DC0)
#define RPG_CLIENT_MONODANMUCONTROLLER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x19E42C70)
#define RPG_CLIENT_MONODANMUCONTROLLER_METHOD_5_022B0D58A3077BF2_OFFSET UNITYSDK_OFFSET(0x19E43490)
#define RPG_CLIENT_MONODANMUCONTROLLER_METHOD_5_04DB6A076713051C_OFFSET UNITYSDK_OFFSET(0x19E44CA0)
#define RPG_CLIENT_MONODANMUCONTROLLER_METHOD_5_07280B24DFAC0CA9_OFFSET UNITYSDK_OFFSET(0x19E425E0)
#define RPG_CLIENT_MONODANMUCONTROLLER_METHOD_5_12A5B534813F3445_OFFSET UNITYSDK_OFFSET(0x19E44080)
#define RPG_CLIENT_MONODANMUCONTROLLER_METHOD_5_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x19E440F0)
#define RPG_CLIENT_MONODANMUCONTROLLER_METHOD_5_1D4B81334E4490D3_OFFSET UNITYSDK_OFFSET(0x19E43820)
#define RPG_CLIENT_MONODANMUCONTROLLER_METHOD_5_2E4E9C95DDAA0B10_OFFSET UNITYSDK_OFFSET(0x19E44160)
#define RPG_CLIENT_MONODANMUCONTROLLER_METHOD_5_3415D88EE6078A04_OFFSET UNITYSDK_OFFSET(0x19E43EA0)
#define RPG_CLIENT_MONODANMUCONTROLLER_METHOD_5_348674E9BAD074BA_OFFSET UNITYSDK_OFFSET(0x19E43D10)
#define RPG_CLIENT_MONODANMUCONTROLLER_METHOD_5_414C8F92528E4746_OFFSET UNITYSDK_OFFSET(0x19E429B0)
#define RPG_CLIENT_MONODANMUCONTROLLER_METHOD_5_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0x19E44240)
#define RPG_CLIENT_MONODANMUCONTROLLER_METHOD_5_44CCBF5B25F21E3A_OFFSET UNITYSDK_OFFSET(0x19E44A40)
#define RPG_CLIENT_MONODANMUCONTROLLER_METHOD_5_805C56F44231AEF9_OFFSET UNITYSDK_OFFSET(0x19E43700)
#define RPG_CLIENT_MONODANMUCONTROLLER_METHOD_5_82E992240300FB30_OFFSET UNITYSDK_OFFSET(0x19E42C00)
#define RPG_CLIENT_MONODANMUCONTROLLER_METHOD_5_871F6AAF8C0E80CC_OFFSET UNITYSDK_OFFSET(0x19E447A0)
#define RPG_CLIENT_MONODANMUCONTROLLER_METHOD_5_B6C6410B1FEA0BB3_OFFSET UNITYSDK_OFFSET(0x19E43750)
#define RPG_CLIENT_MONODANMUCONTROLLER_METHOD_5_CD762BD492FAC131_OFFSET UNITYSDK_OFFSET(0x19E43340)
#define RPG_CLIENT_MONODANMUCONTROLLER_METHOD_5_D549E229DFA00CC6_OFFSET UNITYSDK_OFFSET(0x19E44340)
#define RPG_CLIENT_MONODANMUCONTROLLER_METHOD_5_D9899AB38F7BA87E_OFFSET UNITYSDK_OFFSET(0x19E43E00)
#define RPG_CLIENT_MONODANMUCONTROLLER_METHOD_5_DD784213055292FB_OFFSET UNITYSDK_OFFSET(0x19E43560)
#define RPG_CLIENT_MONODANMUCONTROLLER_METHOD_5_F82AD9CF5EEF353D_OFFSET UNITYSDK_OFFSET(0x19E43AC0)
#define RPG_CLIENT_MONODANMUCONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x19E42450)
#define RPG_CLIENT_MONODANMUCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19E42340)
#define RPG_CLIENT_MONODANMUCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x19E42560)
#define RPG_CLIENT_MONODANMUCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19E44D10)
