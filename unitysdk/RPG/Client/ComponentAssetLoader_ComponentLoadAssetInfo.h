...
#define RPG_CLIENT_COMPONENTASSETLOADER_COMPONENTLOADASSETINFO_METHOD_2_2DC90EE759C8637B_OFFSET UNITYSDK_OFFSET(0xB6FFC20)
#define RPG_CLIENT_COMPONENTASSETLOADER_COMPONENTLOADASSETINFO_METHOD_2_AC59C7CF75B4785D_OFFSET UNITYSDK_OFFSET(0x138760)
#define RPG_CLIENT_COMPONENTASSETLOADER_COMPONENTLOADASSETINFO_METHOD_2_CF5357012C5DE97D_OFFSET UNITYSDK_OFFSET(0xB6FFBD0)

namespace RPG::Client
{
	inline static constexpr unsigned int ComponentAssetLoader_ComponentLoadAssetInfo_TypeDefinitionIndex = 63974;
