...
#define RPG_CLIENT_ROGUEFORMULAINFO___C__DISPLAYCLASS8_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA2FFE90)
#define RPG_CLIENT_ROGUEFORMULAINFO___C__DISPLAYCLASS8_0__GETROGUEFORMULADATA_B__0_OFFSET UNITYSDK_OFFSET(0xA302080)
#define RPG_CLIENT_ROGUEFORMULAINFO___C__DISPLAYCLASS8_0__GETROGUEFORMULADATA_B__1_OFFSET UNITYSDK_OFFSET(0xA3020A0)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueFormulaInfo___c__DisplayClass8_0_TypeDefinitionIndex = 54737;
