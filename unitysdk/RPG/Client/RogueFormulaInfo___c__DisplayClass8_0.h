...
#define RPG_CLIENT_ROGUEFORMULAINFO___C__DISPLAYCLASS8_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC8ACE0)
#define RPG_CLIENT_ROGUEFORMULAINFO___C__DISPLAYCLASS8_0__GETROGUEFORMULADATA_B__0_OFFSET UNITYSDK_OFFSET(0x1BC8D3F0)
#define RPG_CLIENT_ROGUEFORMULAINFO___C__DISPLAYCLASS8_0__GETROGUEFORMULADATA_B__1_OFFSET UNITYSDK_OFFSET(0x1BC8D410)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueFormulaInfo___c__DisplayClass8_0_TypeDefinitionIndex = 67220;
