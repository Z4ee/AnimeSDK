...
#define RPG_CLIENT_ROGUETOURNPERSONAMAPTABROOMITEM_CREATE_OFFSET UNITYSDK_OFFSET(0x1AA69380)
#define RPG_CLIENT_ROGUETOURNPERSONAMAPTABROOMITEM_GET_ITEMTYPE_OFFSET UNITYSDK_OFFSET(0x1AA692F0)
#define RPG_CLIENT_ROGUETOURNPERSONAMAPTABROOMITEM_GET_ROOMDATA_OFFSET UNITYSDK_OFFSET(0x1AA69340)
#define RPG_CLIENT_ROGUETOURNPERSONAMAPTABROOMITEM_GET_ROOMSTATUS_OFFSET UNITYSDK_OFFSET(0x1AA69360)
#define RPG_CLIENT_ROGUETOURNPERSONAMAPTABROOMITEM_SET_ROOMDATA_OFFSET UNITYSDK_OFFSET(0x1AA69350)
#define RPG_CLIENT_ROGUETOURNPERSONAMAPTABROOMITEM_SET_ROOMSTATUS_OFFSET UNITYSDK_OFFSET(0x1AA69370)
#define RPG_CLIENT_ROGUETOURNPERSONAMAPTABROOMITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA69410)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueTournPersonaMapTabRoomItem_TypeDefinitionIndex = 69593;
