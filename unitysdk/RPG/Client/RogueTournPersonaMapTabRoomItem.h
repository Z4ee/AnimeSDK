...
#define RPG_CLIENT_ROGUETOURNPERSONAMAPTABROOMITEM_CREATE_OFFSET UNITYSDK_OFFSET(0xA3BF430)
#define RPG_CLIENT_ROGUETOURNPERSONAMAPTABROOMITEM_GET_ITEMTYPE_OFFSET UNITYSDK_OFFSET(0xA3BF3E0)
#define RPG_CLIENT_ROGUETOURNPERSONAMAPTABROOMITEM_GET_ROOMDATA_OFFSET UNITYSDK_OFFSET(0xA3BF3F0)
#define RPG_CLIENT_ROGUETOURNPERSONAMAPTABROOMITEM_GET_ROOMSTATUS_OFFSET UNITYSDK_OFFSET(0xA3BF410)
#define RPG_CLIENT_ROGUETOURNPERSONAMAPTABROOMITEM_SET_ROOMDATA_OFFSET UNITYSDK_OFFSET(0xA3BF400)
#define RPG_CLIENT_ROGUETOURNPERSONAMAPTABROOMITEM_SET_ROOMSTATUS_OFFSET UNITYSDK_OFFSET(0xA3BF420)
#define RPG_CLIENT_ROGUETOURNPERSONAMAPTABROOMITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xA3BF4C0)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueTournPersonaMapTabRoomItem_TypeDefinitionIndex = 59768;
