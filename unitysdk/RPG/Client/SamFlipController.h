...
#define RPG_CLIENT_SAMFLIPCONTROLLER_CLEAR_OFFSET UNITYSDK_OFFSET(0x19F2BD10)
#define RPG_CLIENT_SAMFLIPCONTROLLER_COMPARETO_OFFSET UNITYSDK_OFFSET(0x19F2C250)
#define RPG_CLIENT_SAMFLIPCONTROLLER_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x19F2BFD0)
#define RPG_CLIENT_SAMFLIPCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x19F2BD50)
#define RPG_CLIENT_SAMFLIPCONTROLLER_METHOD_5_0D262735D01CAB97_OFFSET UNITYSDK_OFFSET(0x19F2BFE0)
#define RPG_CLIENT_SAMFLIPCONTROLLER_PROCESS_OFFSET UNITYSDK_OFFSET(0x19F2BDF0)
#define RPG_CLIENT_SAMFLIPCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19F2C380)

namespace RPG::Client
{
	inline static constexpr unsigned int SamFlipController_TypeDefinitionIndex = 67125;
	...
	public:
		...
		{
			return ((::System::Int32(*)(::PVOID, ::Class_0_16E4307DCC419505_456*))((::PBYTE)hIl2Cpp + RPG_CLIENT_SAMFLIPCONTROLLER_COMPARETO_OFFSET))(this, a1);
		}
	};
}
