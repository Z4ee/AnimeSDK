...
#define RPG_CLIENT_SAMFLIPCONTROLLER_COMPARETO_OFFSET UNITYSDK_OFFSET(0xA4163B0)
#define RPG_CLIENT_SAMFLIPCONTROLLER_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xA416130)
#define RPG_CLIENT_SAMFLIPCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xA415EB0)
#define RPG_CLIENT_SAMFLIPCONTROLLER_METHOD_5_0D262735D01CAB97_OFFSET UNITYSDK_OFFSET(0xA416140)
#define RPG_CLIENT_SAMFLIPCONTROLLER_PROCESS_OFFSET UNITYSDK_OFFSET(0xA415F50)
#define RPG_CLIENT_SAMFLIPCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA416490)

namespace RPG::Client
{
	inline static constexpr unsigned int SamFlipController_TypeDefinitionIndex = 57519;
