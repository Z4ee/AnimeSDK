...
#define RPG_CLIENT_FIGHTFESTSCOREPHASEEXTRADATA_CREATE_OFFSET UNITYSDK_OFFSET(0xA381230)
#define RPG_CLIENT_FIGHTFESTSCOREPHASEEXTRADATA_GET_PLAYERINFO_OFFSET UNITYSDK_OFFSET(0xA381F40)
#define RPG_CLIENT_FIGHTFESTSCOREPHASEEXTRADATA_GET_QUALIFYTIP_OFFSET UNITYSDK_OFFSET(0xA3811B0)
#define RPG_CLIENT_FIGHTFESTSCOREPHASEEXTRADATA_GET_REWARDID_OFFSET UNITYSDK_OFFSET(0xA380D00)
#define RPG_CLIENT_FIGHTFESTSCOREPHASEEXTRADATA_GET_TARGETAVATARICON_OFFSET UNITYSDK_OFFSET(0xA380E00)
#define RPG_CLIENT_FIGHTFESTSCOREPHASEEXTRADATA_GET_TARGETAVATARMINIICON_OFFSET UNITYSDK_OFFSET(0xA380F10)
#define RPG_CLIENT_FIGHTFESTSCOREPHASEEXTRADATA_GET_TARGETAVATARNAME_OFFSET UNITYSDK_OFFSET(0xA381050)
#define RPG_CLIENT_FIGHTFESTSCOREPHASEEXTRADATA_GET_TARGETSCORE_OFFSET UNITYSDK_OFFSET(0xA380C40)
#define RPG_CLIENT_FIGHTFESTSCOREPHASEEXTRADATA_SET_PLAYERINFO_OFFSET UNITYSDK_OFFSET(0xA381F50)
#define RPG_CLIENT_FIGHTFESTSCOREPHASEEXTRADATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA381F30)

namespace RPG::Client
{
	inline static constexpr unsigned int FightFestScorePhaseExtraData_TypeDefinitionIndex = 59044;
