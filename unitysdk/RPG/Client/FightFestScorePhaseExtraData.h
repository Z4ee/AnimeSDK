...
#define RPG_CLIENT_FIGHTFESTSCOREPHASEEXTRADATA_CREATE_OFFSET UNITYSDK_OFFSET(0x183F7AA0)
#define RPG_CLIENT_FIGHTFESTSCOREPHASEEXTRADATA_GET_PLAYERINFO_OFFSET UNITYSDK_OFFSET(0x183F8EC0)
#define RPG_CLIENT_FIGHTFESTSCOREPHASEEXTRADATA_GET_QUALIFYTIP_OFFSET UNITYSDK_OFFSET(0x183F79F0)
#define RPG_CLIENT_FIGHTFESTSCOREPHASEEXTRADATA_GET_REWARDID_OFFSET UNITYSDK_OFFSET(0x183F7540)
#define RPG_CLIENT_FIGHTFESTSCOREPHASEEXTRADATA_GET_TARGETAVATARICON_OFFSET UNITYSDK_OFFSET(0x183F7640)
#define RPG_CLIENT_FIGHTFESTSCOREPHASEEXTRADATA_GET_TARGETAVATARMINIICON_OFFSET UNITYSDK_OFFSET(0x183F7750)
#define RPG_CLIENT_FIGHTFESTSCOREPHASEEXTRADATA_GET_TARGETAVATARNAME_OFFSET UNITYSDK_OFFSET(0x183F7890)
#define RPG_CLIENT_FIGHTFESTSCOREPHASEEXTRADATA_GET_TARGETSCORE_OFFSET UNITYSDK_OFFSET(0x183F7480)
#define RPG_CLIENT_FIGHTFESTSCOREPHASEEXTRADATA_SET_PLAYERINFO_OFFSET UNITYSDK_OFFSET(0x183F8ED0)
#define RPG_CLIENT_FIGHTFESTSCOREPHASEEXTRADATA__CTOR_OFFSET UNITYSDK_OFFSET(0x183F8EB0)

namespace RPG::Client
{
	inline static constexpr unsigned int FightFestScorePhaseExtraData_TypeDefinitionIndex = 61259;
