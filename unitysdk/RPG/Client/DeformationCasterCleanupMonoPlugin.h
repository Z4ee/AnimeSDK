...
#define RPG_CLIENT_DEFORMATIONCASTERCLEANUPMONOPLUGIN_CLEANUPREGISTEREDCASTER_OFFSET UNITYSDK_OFFSET(0x192E1F60)
#define RPG_CLIENT_DEFORMATIONCASTERCLEANUPMONOPLUGIN_MARKREGISTERED_OFFSET UNITYSDK_OFFSET(0x192E2090)
#define RPG_CLIENT_DEFORMATIONCASTERCLEANUPMONOPLUGIN_SETCASTER_OFFSET UNITYSDK_OFFSET(0x192E2030)
#define RPG_CLIENT_DEFORMATIONCASTERCLEANUPMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x192E20F0)
