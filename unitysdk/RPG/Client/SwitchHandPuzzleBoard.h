...
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B470690)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0x1B470740)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_METHOD_6_0584B4481E699952_OFFSET UNITYSDK_OFFSET(0x1B471BD0)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_METHOD_6_508D4DD02D3DB74E_1_OFFSET UNITYSDK_OFFSET(0x1B4704C0)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_METHOD_6_508D4DD02D3DB74E_OFFSET UNITYSDK_OFFSET(0x1B470240)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_METHOD_6_8C945585B4A8C17B_OFFSET UNITYSDK_OFFSET(0x1B471B20)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_ONERAVISIBLESTATECHANGED_OFFSET UNITYSDK_OFFSET(0x1B471340)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_ONGAMERESET_OFFSET UNITYSDK_OFFSET(0x1B471A10)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_ONGESTURETYPESWITCHFROM_OFFSET UNITYSDK_OFFSET(0x1B470780)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_ONGESTURETYPESWITCHTO_OFFSET UNITYSDK_OFFSET(0x1B470930)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_ONLIFTGESTUREEXIT_OFFSET UNITYSDK_OFFSET(0x1B471470)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_ONPLAYERTELEPORT_OFFSET UNITYSDK_OFFSET(0x1B471620)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_ONPLAYERTRIGGERPULLBACK_OFFSET UNITYSDK_OFFSET(0x1B471900)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_ONROCKETGESTUREFIRE_OFFSET UNITYSDK_OFFSET(0x1B470C90)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_ONROCKETGESTURELAUNCH_OFFSET UNITYSDK_OFFSET(0x1B470AE0)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_ONROCKETGESTUREPUNCHED_OFFSET UNITYSDK_OFFSET(0x1B470FF0)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_ONROCKETGESTUREPUNCHHIT_OFFSET UNITYSDK_OFFSET(0x1B4711A0)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_ONROCKETGESTURESTOP_OFFSET UNITYSDK_OFFSET(0x1B470E40)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_ONROCKETPUNCHHITSTUB_OFFSET UNITYSDK_OFFSET(0x1B471750)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0x1B470410)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_STARTPUZZLE_OFFSET UNITYSDK_OFFSET(0x1B470110)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B471D40)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x1B471CC0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(SwitchHandPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x373F0);
		}
