...
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19C5A710)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0x19C5A7C0)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_METHOD_6_0584B4481E699952_OFFSET UNITYSDK_OFFSET(0x19C5BC50)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_METHOD_6_508D4DD02D3DB74E_1_OFFSET UNITYSDK_OFFSET(0x19C5A550)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_METHOD_6_508D4DD02D3DB74E_OFFSET UNITYSDK_OFFSET(0x19C5A2E0)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_METHOD_6_8C945585B4A8C17B_OFFSET UNITYSDK_OFFSET(0x19C5BBA0)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_ONERAVISIBLESTATECHANGED_OFFSET UNITYSDK_OFFSET(0x19C5B3C0)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_ONGAMERESET_OFFSET UNITYSDK_OFFSET(0x19C5BA90)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_ONGESTURETYPESWITCHFROM_OFFSET UNITYSDK_OFFSET(0x19C5A800)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_ONGESTURETYPESWITCHTO_OFFSET UNITYSDK_OFFSET(0x19C5A9B0)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_ONLIFTGESTUREEXIT_OFFSET UNITYSDK_OFFSET(0x19C5B4F0)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_ONPLAYERTELEPORT_OFFSET UNITYSDK_OFFSET(0x19C5B6A0)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_ONPLAYERTRIGGERPULLBACK_OFFSET UNITYSDK_OFFSET(0x19C5B980)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_ONROCKETGESTUREFIRE_OFFSET UNITYSDK_OFFSET(0x19C5AD10)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_ONROCKETGESTURELAUNCH_OFFSET UNITYSDK_OFFSET(0x19C5AB60)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_ONROCKETGESTUREPUNCHED_OFFSET UNITYSDK_OFFSET(0x19C5B070)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_ONROCKETGESTUREPUNCHHIT_OFFSET UNITYSDK_OFFSET(0x19C5B220)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_ONROCKETGESTURESTOP_OFFSET UNITYSDK_OFFSET(0x19C5AEC0)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_ONROCKETPUNCHHITSTUB_OFFSET UNITYSDK_OFFSET(0x19C5B7D0)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0x19C5A4A0)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD_STARTPUZZLE_OFFSET UNITYSDK_OFFSET(0x19C5A1C0)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD__CCTOR_OFFSET UNITYSDK_OFFSET(0x19C5BDC0)
#define RPG_CLIENT_SWITCHHANDPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x19C5BD40)

namespace RPG::Client
{
	inline static constexpr unsigned int SwitchHandPuzzleBoard_TypeDefinitionIndex = 65716;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(SwitchHandPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x393D0);
		}
