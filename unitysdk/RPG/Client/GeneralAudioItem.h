...
#define RPG_CLIENT_GENERALAUDIOITEM_GET_PLAYINGEVENTID_OFFSET UNITYSDK_OFFSET(0x97B6DC0)
#define RPG_CLIENT_GENERALAUDIOITEM_SET_PLAYINGEVENTID_OFFSET UNITYSDK_OFFSET(0x97B6DD0)
#define RPG_CLIENT_GENERALAUDIOITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x97B6DE0)

namespace RPG::Client
{
	inline static constexpr unsigned int GeneralAudioItem_TypeDefinitionIndex = 55862;
