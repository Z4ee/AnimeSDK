...
#define RPG_CLIENT_GENERALAUDIOITEM_GET_PLAYINGEVENTID_OFFSET UNITYSDK_OFFSET(0x1AD99DD0)
#define RPG_CLIENT_GENERALAUDIOITEM_SET_PLAYINGEVENTID_OFFSET UNITYSDK_OFFSET(0x1AD99DE0)
#define RPG_CLIENT_GENERALAUDIOITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD99DF0)

namespace RPG::Client
{
	inline static constexpr unsigned int GeneralAudioItem_TypeDefinitionIndex = 68396;
