...
#define RPG_CLIENT_BASEGACHAPOOLDATA_BASEGACHAPOOLDATACOMPARISON_OFFSET UNITYSDK_OFFSET(0xC8C5210)
#define RPG_CLIENT_BASEGACHAPOOLDATA_GETDECIDEDITEMIDS_OFFSET UNITYSDK_OFFSET(0xC8C3F00)
#define RPG_CLIENT_BASEGACHAPOOLDATA_GETGACHAREWARDQUEST_OFFSET UNITYSDK_OFFSET(0xC8C4DD0)
#define RPG_CLIENT_BASEGACHAPOOLDATA_GET_CANDECIDE_OFFSET UNITYSDK_OFFSET(0xC8C4020)
#define RPG_CLIENT_BASEGACHAPOOLDATA_GET_DECIDEDATA_OFFSET UNITYSDK_OFFSET(0xC8C4250)
#define RPG_CLIENT_BASEGACHAPOOLDATA_GET_DETAILITEMDATAS_OFFSET UNITYSDK_OFFSET(0xC8C5100)
#define RPG_CLIENT_BASEGACHAPOOLDATA_GET_GACHAID_OFFSET UNITYSDK_OFFSET(0xC8C3570)
#define RPG_CLIENT_BASEGACHAPOOLDATA_GET_GACHAPOOLREWARDDATA_OFFSET UNITYSDK_OFFSET(0xC8C5140)
#define RPG_CLIENT_BASEGACHAPOOLDATA_GET_GACHATYPE_OFFSET UNITYSDK_OFFSET(0xC8C49C0)
#define RPG_CLIENT_BASEGACHAPOOLDATA_GET_GOLDITEMDATA_OFFSET UNITYSDK_OFFSET(0xC8C5120)
#define RPG_CLIENT_BASEGACHAPOOLDATA_GET_ISINGROUPPOOL_OFFSET UNITYSDK_OFFSET(0xC8C5160)
#define RPG_CLIENT_BASEGACHAPOOLDATA_GET_PREFABPATH_OFFSET UNITYSDK_OFFSET(0xC8C5070)
#define RPG_CLIENT_BASEGACHAPOOLDATA_GET_PRIZEITEMDATAS_OFFSET UNITYSDK_OFFSET(0xC8C50E0)
#define RPG_CLIENT_BASEGACHAPOOLDATA_GET_ROW_OFFSET UNITYSDK_OFFSET(0xC8C5050)
#define RPG_CLIENT_BASEGACHAPOOLDATA_GET_TYPEBASICINFOROW_OFFSET UNITYSDK_OFFSET(0xC8C50C0)
#define RPG_CLIENT_BASEGACHAPOOLDATA_HAVETIMELIMIT_OFFSET UNITYSDK_OFFSET(0xC8C5010)
#define RPG_CLIENT_BASEGACHAPOOLDATA_ISFEATURECLOSED_OFFSET UNITYSDK_OFFSET(0xC8C4ED0)
#define RPG_CLIENT_BASEGACHAPOOLDATA_ISUPITEMINDECIDEDITEMS_OFFSET UNITYSDK_OFFSET(0xC8C4070)
#define RPG_CLIENT_BASEGACHAPOOLDATA_ISVALID_OFFSET UNITYSDK_OFFSET(0xC8C4E90)
#define RPG_CLIENT_BASEGACHAPOOLDATA_SET_DECIDEDATA_OFFSET UNITYSDK_OFFSET(0xC8C4260)
#define RPG_CLIENT_BASEGACHAPOOLDATA_SET_DETAILITEMDATAS_OFFSET UNITYSDK_OFFSET(0xC8C5110)
#define RPG_CLIENT_BASEGACHAPOOLDATA_SET_GACHAPOOLREWARDDATA_OFFSET UNITYSDK_OFFSET(0xC8C5150)
#define RPG_CLIENT_BASEGACHAPOOLDATA_SET_GOLDITEMDATA_OFFSET UNITYSDK_OFFSET(0xC8C5130)
#define RPG_CLIENT_BASEGACHAPOOLDATA_SET_PRIZEITEMDATAS_OFFSET UNITYSDK_OFFSET(0xC8C50F0)
#define RPG_CLIENT_BASEGACHAPOOLDATA_SET_ROW_OFFSET UNITYSDK_OFFSET(0xC8C5060)
#define RPG_CLIENT_BASEGACHAPOOLDATA_SET_TYPEBASICINFOROW_OFFSET UNITYSDK_OFFSET(0xC8C50D0)
#define RPG_CLIENT_BASEGACHAPOOLDATA_SYNCDECIDEDATA_OFFSET UNITYSDK_OFFSET(0xC8C3DB0)
#define RPG_CLIENT_BASEGACHAPOOLDATA_SYNCGACHAPOOLDATA_OFFSET UNITYSDK_OFFSET(0xC8C4890)
#define RPG_CLIENT_BASEGACHAPOOLDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC8C4270)
#define RPG_CLIENT_BASEGACHAPOOLDATA__INITDETAILITEMSROW_OFFSET UNITYSDK_OFFSET(0xC8C4A10)
#define RPG_CLIENT_BASEGACHAPOOLDATA__INITGACHADRAWDATA_OFFSET UNITYSDK_OFFSET(0xC8C4580)
#define RPG_CLIENT_BASEGACHAPOOLDATA__INITGACHAPOOLREWARDDATA_OFFSET UNITYSDK_OFFSET(0xC8C46D0)
#define RPG_CLIENT_BASEGACHAPOOLDATA__INITGACHATOKENDATA_OFFSET UNITYSDK_OFFSET(0xC8C44F0)
#define RPG_CLIENT_BASEGACHAPOOLDATA__INITPRIZEITEMSROW_OFFSET UNITYSDK_OFFSET(0xC8C4BF0)
...
namespace RPG::Client
{
	...
	public:
		...
		::Il2CppArray<::RPG::Client::ItemData*>* _DetailItemDatas_k__BackingField; // 0x18
		::RPG::Client::GachaPoolRewardData* _GachaPoolRewardData_k__BackingField; // 0x20
		::RPG::GameCore::GachPoolRewardConfigRow* _GachaPoolRewardRow; // 0x28
		::RPG::Client::GachaDrawData* SingleDrawData; // 0x30
		::RPG::Client::GachaDrawData* MultiDrawData; // 0x38
		::RPG::GameCore::GachaBasicInfoConfigRow* _Row_k__BackingField; // 0x40
		::System::String* HistoryURL; // 0x48
		::RPG::GameCore::GachaTypeBasicInfoRow* _TypeBasicInfoRow_k__BackingField; // 0x50
		::RPG::Client::ItemData* _GoldItemData_k__BackingField; // 0x58
		::RPG::Client::BaseGachaDecideData* _DecideData_k__BackingField; // 0x60
		::System::String* DetailURL; // 0x68
		::RPG::Client::GachaTokenData* GachaTokenData; // 0x70
