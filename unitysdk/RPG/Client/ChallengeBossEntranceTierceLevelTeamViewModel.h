...
#define RPG_CLIENT_CHALLENGEBOSSENTRANCETIERCELEVELTEAMVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0xCA28850)
#define RPG_CLIENT_CHALLENGEBOSSENTRANCETIERCELEVELTEAMVIEWMODEL_DISPOSE_OFFSET UNITYSDK_OFFSET(0xCA288F0)
#define RPG_CLIENT_CHALLENGEBOSSENTRANCETIERCELEVELTEAMVIEWMODEL_GETLINEUP_OFFSET UNITYSDK_OFFSET(0xCA28940)
#define RPG_CLIENT_CHALLENGEBOSSENTRANCETIERCELEVELTEAMVIEWMODEL_GET_BOSSICONPATH_OFFSET UNITYSDK_OFFSET(0xCA28570)
#define RPG_CLIENT_CHALLENGEBOSSENTRANCETIERCELEVELTEAMVIEWMODEL_GET_ISPASSED_OFFSET UNITYSDK_OFFSET(0xCA28620)
#define RPG_CLIENT_CHALLENGEBOSSENTRANCETIERCELEVELTEAMVIEWMODEL_GET_SCORE_OFFSET UNITYSDK_OFFSET(0xCA286E0)
#define RPG_CLIENT_CHALLENGEBOSSENTRANCETIERCELEVELTEAMVIEWMODEL_GET_STAGENUMBER_OFFSET UNITYSDK_OFFSET(0xCA28520)
#define RPG_CLIENT_CHALLENGEBOSSENTRANCETIERCELEVELTEAMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xCA288E0)
