...
#define RPG_CLIENT_CHALLENGEBOSSENTRANCETIERCELEVELTEAMVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0x18785BC0)
#define RPG_CLIENT_CHALLENGEBOSSENTRANCETIERCELEVELTEAMVIEWMODEL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18785C60)
#define RPG_CLIENT_CHALLENGEBOSSENTRANCETIERCELEVELTEAMVIEWMODEL_GETLINEUP_OFFSET UNITYSDK_OFFSET(0x18785CB0)
#define RPG_CLIENT_CHALLENGEBOSSENTRANCETIERCELEVELTEAMVIEWMODEL_GET_BOSSICONPATH_OFFSET UNITYSDK_OFFSET(0x187858E0)
#define RPG_CLIENT_CHALLENGEBOSSENTRANCETIERCELEVELTEAMVIEWMODEL_GET_ISPASSED_OFFSET UNITYSDK_OFFSET(0x18785990)
#define RPG_CLIENT_CHALLENGEBOSSENTRANCETIERCELEVELTEAMVIEWMODEL_GET_SCORE_OFFSET UNITYSDK_OFFSET(0x18785A50)
#define RPG_CLIENT_CHALLENGEBOSSENTRANCETIERCELEVELTEAMVIEWMODEL_GET_STAGENUMBER_OFFSET UNITYSDK_OFFSET(0x18785890)
#define RPG_CLIENT_CHALLENGEBOSSENTRANCETIERCELEVELTEAMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x18785C50)

namespace RPG::Client
{
	inline static constexpr unsigned int ChallengeBossEntranceTierceLevelTeamViewModel_TypeDefinitionIndex = 60301;
