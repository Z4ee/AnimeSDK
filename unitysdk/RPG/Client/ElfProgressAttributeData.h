...
#define RPG_CLIENT_ELFPROGRESSATTRIBUTEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x95BC290)

namespace RPG::Client
{
	inline static constexpr unsigned int ElfProgressAttributeData_TypeDefinitionIndex = 51764;
