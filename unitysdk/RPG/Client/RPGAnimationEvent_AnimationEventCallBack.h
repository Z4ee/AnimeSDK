...
#define RPG_CLIENT_RPGANIMATIONEVENT_ANIMATIONEVENTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1802DC00)
#define RPG_CLIENT_RPGANIMATIONEVENT_ANIMATIONEVENTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1802DC30)
#define RPG_CLIENT_RPGANIMATIONEVENT_ANIMATIONEVENTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1802D840)
#define RPG_CLIENT_RPGANIMATIONEVENT_ANIMATIONEVENTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1802DB90)

namespace RPG::Client
{
	inline static constexpr unsigned int RPGAnimationEvent_AnimationEventCallBack_TypeDefinitionIndex = 72775;
