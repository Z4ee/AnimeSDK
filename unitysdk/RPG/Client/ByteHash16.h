...
#define RPG_CLIENT_BYTEHASH16_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x3840810)
#define RPG_CLIENT_BYTEHASH16_EQUALS_OFFSET UNITYSDK_OFFSET(0x3840790)
#define RPG_CLIENT_BYTEHASH16_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3840820)
#define RPG_CLIENT_BYTEHASH16_METHOD_2_16CE6C53D61BC7E4_OFFSET UNITYSDK_OFFSET(0x1892EE20)
#define RPG_CLIENT_BYTEHASH16_METHOD_2_47481B30F0B839BD_OFFSET UNITYSDK_OFFSET(0x1892EEA0)
#define RPG_CLIENT_BYTEHASH16_METHOD_2_7DC101B0AF1C5A10_OFFSET UNITYSDK_OFFSET(0x3840700)
#define RPG_CLIENT_BYTEHASH16_METHOD_2_AC64FAF78AE39F81_OFFSET UNITYSDK_OFFSET(0x38406F0)
#define RPG_CLIENT_BYTEHASH16_METHOD_2_C53AF26E9BF3F1C3_OFFSET UNITYSDK_OFFSET(0x3840780)
#define RPG_CLIENT_BYTEHASH16_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3840770)
#define RPG_CLIENT_BYTEHASH16__CCTOR_OFFSET UNITYSDK_OFFSET(0x1892EF20)
#define RPG_CLIENT_BYTEHASH16__CTOR_1_OFFSET UNITYSDK_OFFSET(0x38406E0)
#define RPG_CLIENT_BYTEHASH16__CTOR_OFFSET UNITYSDK_OFFSET(0x85E10)
#define RPG_CLIENT_BYTEHASH16___IFIXBASEPROXY_EQUALS_OFFSET UNITYSDK_OFFSET(0x38408E0)
#define RPG_CLIENT_BYTEHASH16___IFIXBASEPROXY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3840920)
#define RPG_CLIENT_BYTEHASH16___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3840880)

namespace RPG::Client
{
	inline static constexpr unsigned int ByteHash16_TypeDefinitionIndex = 38411;

	struct alignas(4) ByteHash16
	{
		static ::Il2CppArray<::System::Byte>** StaticGet__ByteArray()
		{
			return (::Il2CppArray<::System::Byte>**)Il2CppClass::FromTypeDefinitionIndex(ByteHash16_TypeDefinitionIndex)->GetStaticField(0x1060);
		}
		static ::RPG::Client::ByteHash16* StaticGet_ZERO()
		{
			return (::RPG::Client::ByteHash16*)Il2CppClass::FromTypeDefinitionIndex(ByteHash16_TypeDefinitionIndex)->GetStaticField(0x900);
		}
		static ::System::Int32* StaticGet_msMainThreadId()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ByteHash16_TypeDefinitionIndex)->GetStaticField(0x910);
		}
		...
		{
			return ((::System::Boolean(*)(::PVOID, ::System::Object*))((::PBYTE)hIl2Cpp + RPG_CLIENT_BYTEHASH16___IFIXBASEPROXY_EQUALS_OFFSET))(this, a1);
		}
