...
#define RPG_CLIENT_LOOKATTARGETCONSTRAINT_GET_OVERRIDECONSTRAINT_OFFSET UNITYSDK_OFFSET(0x9A69980)
#define RPG_CLIENT_LOOKATTARGETCONSTRAINT_RPG_CLIENT_ILOOKATCONSTRAINT_GET_PITCHDOWN_OFFSET UNITYSDK_OFFSET(0x9A69A00)
#define RPG_CLIENT_LOOKATTARGETCONSTRAINT_RPG_CLIENT_ILOOKATCONSTRAINT_GET_PITCHUP_OFFSET UNITYSDK_OFFSET(0x9A699A0)
#define RPG_CLIENT_LOOKATTARGETCONSTRAINT_RPG_CLIENT_ILOOKATCONSTRAINT_GET_YAWLEFT_OFFSET UNITYSDK_OFFSET(0x9A69A60)
#define RPG_CLIENT_LOOKATTARGETCONSTRAINT_RPG_CLIENT_ILOOKATCONSTRAINT_GET_YAWRIGHT_OFFSET UNITYSDK_OFFSET(0x9A69AC0)
#define RPG_CLIENT_LOOKATTARGETCONSTRAINT_SET_OVERRIDECONSTRAINT_OFFSET UNITYSDK_OFFSET(0x9A69990)
#define RPG_CLIENT_LOOKATTARGETCONSTRAINT__CTOR_OFFSET UNITYSDK_OFFSET(0x9A5F680)

namespace RPG::Client
{
	inline static constexpr unsigned int LookAtTargetConstraint_TypeDefinitionIndex = 55909;
