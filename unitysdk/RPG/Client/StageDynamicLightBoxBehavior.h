...
#define RPG_CLIENT_STAGEDYNAMICLIGHTBOXBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0x17B40AE0)
#define RPG_CLIENT_STAGEDYNAMICLIGHTBOXBEHAVIOR_METHOD_3_0869E1192F8E01DF_OFFSET UNITYSDK_OFFSET(0x17B40B20)
#define RPG_CLIENT_STAGEDYNAMICLIGHTBOXBEHAVIOR_METHOD_3_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x17B42460)
#define RPG_CLIENT_STAGEDYNAMICLIGHTBOXBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0x17B42280)
#define RPG_CLIENT_STAGEDYNAMICLIGHTBOXBEHAVIOR_METHOD_3_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0x17B423A0)
#define RPG_CLIENT_STAGEDYNAMICLIGHTBOXBEHAVIOR_METHOD_3_4343F372F34C05BF_3_OFFSET UNITYSDK_OFFSET(0x17B42400)
#define RPG_CLIENT_STAGEDYNAMICLIGHTBOXBEHAVIOR_METHOD_3_4343F372F34C05BF_4_OFFSET UNITYSDK_OFFSET(0x17B424A0)
#define RPG_CLIENT_STAGEDYNAMICLIGHTBOXBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x17B42220)
#define RPG_CLIENT_STAGEDYNAMICLIGHTBOXBEHAVIOR_METHOD_3_8DF47EF45ABD2A6C_OFFSET UNITYSDK_OFFSET(0x17B42190)
#define RPG_CLIENT_STAGEDYNAMICLIGHTBOXBEHAVIOR_METHOD_3_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x17B420F0)
#define RPG_CLIENT_STAGEDYNAMICLIGHTBOXBEHAVIOR_METHOD_3_AF36EBA0C8D1FBA2_OFFSET UNITYSDK_OFFSET(0x17B409B0)
#define RPG_CLIENT_STAGEDYNAMICLIGHTBOXBEHAVIOR_METHOD_3_EEED34E9AAC26D51_OFFSET UNITYSDK_OFFSET(0x17B40EB0)
#define RPG_CLIENT_STAGEDYNAMICLIGHTBOXBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0x17B422E0)
#define RPG_CLIENT_STAGEDYNAMICLIGHTBOXBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x17B42500)

namespace RPG::Client
{
	inline static constexpr unsigned int StageDynamicLightBoxBehavior_TypeDefinitionIndex = 67752;
