...
#define RPG_CLIENT_STAGEDYNAMICLIGHTBOXBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0xE0C8B80)
#define RPG_CLIENT_STAGEDYNAMICLIGHTBOXBEHAVIOR_METHOD_3_0869E1192F8E01DF_OFFSET UNITYSDK_OFFSET(0xE0C8BC0)
#define RPG_CLIENT_STAGEDYNAMICLIGHTBOXBEHAVIOR_METHOD_3_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xE0CA500)
#define RPG_CLIENT_STAGEDYNAMICLIGHTBOXBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0xE0CA320)
#define RPG_CLIENT_STAGEDYNAMICLIGHTBOXBEHAVIOR_METHOD_3_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0xE0CA440)
#define RPG_CLIENT_STAGEDYNAMICLIGHTBOXBEHAVIOR_METHOD_3_4343F372F34C05BF_3_OFFSET UNITYSDK_OFFSET(0xE0CA4A0)
#define RPG_CLIENT_STAGEDYNAMICLIGHTBOXBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xE0CA2C0)
#define RPG_CLIENT_STAGEDYNAMICLIGHTBOXBEHAVIOR_METHOD_3_8DF47EF45ABD2A6C_1_OFFSET UNITYSDK_OFFSET(0xE0CA540)
#define RPG_CLIENT_STAGEDYNAMICLIGHTBOXBEHAVIOR_METHOD_3_8DF47EF45ABD2A6C_OFFSET UNITYSDK_OFFSET(0xE0CA230)
#define RPG_CLIENT_STAGEDYNAMICLIGHTBOXBEHAVIOR_METHOD_3_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xE0CA190)
#define RPG_CLIENT_STAGEDYNAMICLIGHTBOXBEHAVIOR_METHOD_3_AF36EBA0C8D1FBA2_OFFSET UNITYSDK_OFFSET(0xE0C8A50)
#define RPG_CLIENT_STAGEDYNAMICLIGHTBOXBEHAVIOR_METHOD_3_EEED34E9AAC26D51_OFFSET UNITYSDK_OFFSET(0xE0C8F50)
#define RPG_CLIENT_STAGEDYNAMICLIGHTBOXBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0xE0CA380)
#define RPG_CLIENT_STAGEDYNAMICLIGHTBOXBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0xE0CA5D0)
