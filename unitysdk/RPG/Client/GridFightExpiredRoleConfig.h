...
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG_GET_AVATARID_OFFSET UNITYSDK_OFFSET(0x1BD3C2E0)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG_GET_FRONTBACKTYPE_OFFSET UNITYSDK_OFFSET(0x1BD3C290)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG_GET_HEADICONPATH_OFFSET UNITYSDK_OFFSET(0x1BD3C640)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG_GET_ID_OFFSET UNITYSDK_OFFSET(0x1BD3C1F0)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG_GET_ISEXPERT_OFFSET UNITYSDK_OFFSET(0x1BD3C330)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG_GET_MINIROUNDICONPATH_OFFSET UNITYSDK_OFFSET(0x1BD3C830)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG_GET_NAMETEXTID_OFFSET UNITYSDK_OFFSET(0x1BD3CC10)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG_GET_RARITY_OFFSET UNITYSDK_OFFSET(0x1BD3C240)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG_GET_ROUNDICONPATH_OFFSET UNITYSDK_OFFSET(0x1BD3CA20)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG_GET_SHOPICONPATH_OFFSET UNITYSDK_OFFSET(0x1BD3C3C0)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG_GET_TRAITIDS_OFFSET UNITYSDK_OFFSET(0x1BD3C370)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD3C1A0)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG__GETEXPIREDHEADICONPATH_OFFSET UNITYSDK_OFFSET(0x1BD3C690)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG__GETEXPIREDNAMETEXTID_OFFSET UNITYSDK_OFFSET(0x1BD3CCB0)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG__GETEXPIREDSHOPICONPATH_OFFSET UNITYSDK_OFFSET(0x1BD3C410)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG__GETMINIROUNDICONPATH_OFFSET UNITYSDK_OFFSET(0x1BD3C880)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG__GETROUNDICONPATH_OFFSET UNITYSDK_OFFSET(0x1BD3CA70)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightExpiredRoleConfig_TypeDefinitionIndex = 65163;
