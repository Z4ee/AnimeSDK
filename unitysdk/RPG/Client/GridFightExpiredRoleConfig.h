...
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG_GET_AVATARID_OFFSET UNITYSDK_OFFSET(0xD18C0F0)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG_GET_FRONTBACKTYPE_OFFSET UNITYSDK_OFFSET(0xD18C0A0)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG_GET_HEADICONPATH_OFFSET UNITYSDK_OFFSET(0xD18C450)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG_GET_ID_OFFSET UNITYSDK_OFFSET(0xD18C000)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG_GET_ISEXPERT_OFFSET UNITYSDK_OFFSET(0xD18C140)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG_GET_MINIROUNDICONPATH_OFFSET UNITYSDK_OFFSET(0xD18C640)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG_GET_NAMETEXTID_OFFSET UNITYSDK_OFFSET(0xD18CA20)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG_GET_RARITY_OFFSET UNITYSDK_OFFSET(0xD18C050)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG_GET_ROUNDICONPATH_OFFSET UNITYSDK_OFFSET(0xD18C830)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG_GET_SHOPICONPATH_OFFSET UNITYSDK_OFFSET(0xD18C1D0)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG_GET_TRAITIDS_OFFSET UNITYSDK_OFFSET(0xD18C180)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xD18BFB0)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG__GETEXPIREDHEADICONPATH_OFFSET UNITYSDK_OFFSET(0xD18C4A0)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG__GETEXPIREDNAMETEXTID_OFFSET UNITYSDK_OFFSET(0xD18CAC0)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG__GETEXPIREDSHOPICONPATH_OFFSET UNITYSDK_OFFSET(0xD18C220)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG__GETMINIROUNDICONPATH_OFFSET UNITYSDK_OFFSET(0xD18C690)
#define RPG_CLIENT_GRIDFIGHTEXPIREDROLECONFIG__GETROUNDICONPATH_OFFSET UNITYSDK_OFFSET(0xD18C880)
