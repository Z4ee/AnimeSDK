...
#define RPG_CLIENT_MATCHTHREEV2SCORE_CREATE_OFFSET UNITYSDK_OFFSET(0x9B6CDE0)
#define RPG_CLIENT_MATCHTHREEV2SCORE_GET_DATA_OFFSET UNITYSDK_OFFSET(0x9B6C9D0)
#define RPG_CLIENT_MATCHTHREEV2SCORE_GET_RARITY_OFFSET UNITYSDK_OFFSET(0x9B6CD60)
#define RPG_CLIENT_MATCHTHREEV2SCORE_GET_SCOREID_OFFSET UNITYSDK_OFFSET(0x9B6CA30)
#define RPG_CLIENT_MATCHTHREEV2SCORE_GET_SCORE_OFFSET UNITYSDK_OFFSET(0x9B6C9F0)
#define RPG_CLIENT_MATCHTHREEV2SCORE_GET_STATICCOUNT_OFFSET UNITYSDK_OFFSET(0x9B6CA10)
#define RPG_CLIENT_MATCHTHREEV2SCORE_GET_TITLE_OFFSET UNITYSDK_OFFSET(0x9B6CA50)
#define RPG_CLIENT_MATCHTHREEV2SCORE_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x9B6CCE0)
#define RPG_CLIENT_MATCHTHREEV2SCORE_SET_DATA_OFFSET UNITYSDK_OFFSET(0x9B6C9E0)
#define RPG_CLIENT_MATCHTHREEV2SCORE_SET_SCORE_OFFSET UNITYSDK_OFFSET(0x9B6CA00)
#define RPG_CLIENT_MATCHTHREEV2SCORE_SET_STATICCOUNT_OFFSET UNITYSDK_OFFSET(0x9B6CA20)
#define RPG_CLIENT_MATCHTHREEV2SCORE__CTOR_OFFSET UNITYSDK_OFFSET(0x9B6CE70)

namespace RPG::Client
{
	inline static constexpr unsigned int MatchThreeV2Score_TypeDefinitionIndex = 53674;
