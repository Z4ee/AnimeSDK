...
#define RPG_CLIENT_MATCHTHREEV2SCORE_CREATE_OFFSET UNITYSDK_OFFSET(0x1C9ACCD0)
#define RPG_CLIENT_MATCHTHREEV2SCORE_GET_DATA_OFFSET UNITYSDK_OFFSET(0x1C9AC9A0)
#define RPG_CLIENT_MATCHTHREEV2SCORE_GET_RARITY_OFFSET UNITYSDK_OFFSET(0x1C9ACC80)
#define RPG_CLIENT_MATCHTHREEV2SCORE_GET_SCOREID_OFFSET UNITYSDK_OFFSET(0x1C9ACA00)
#define RPG_CLIENT_MATCHTHREEV2SCORE_GET_SCORE_OFFSET UNITYSDK_OFFSET(0x1C9AC9C0)
#define RPG_CLIENT_MATCHTHREEV2SCORE_GET_STATICCOUNT_OFFSET UNITYSDK_OFFSET(0x1C9AC9E0)
#define RPG_CLIENT_MATCHTHREEV2SCORE_GET_TITLE_OFFSET UNITYSDK_OFFSET(0x1C9ACA50)
#define RPG_CLIENT_MATCHTHREEV2SCORE_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1C9ACC30)
#define RPG_CLIENT_MATCHTHREEV2SCORE_SET_DATA_OFFSET UNITYSDK_OFFSET(0x1C9AC9B0)
#define RPG_CLIENT_MATCHTHREEV2SCORE_SET_SCORE_OFFSET UNITYSDK_OFFSET(0x1C9AC9D0)
#define RPG_CLIENT_MATCHTHREEV2SCORE_SET_STATICCOUNT_OFFSET UNITYSDK_OFFSET(0x1C9AC9F0)
#define RPG_CLIENT_MATCHTHREEV2SCORE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9ACD60)
