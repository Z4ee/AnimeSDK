...
#define RPG_CLIENT_TERRAINDEFORMATIONRECEIVERBEHAVIOR_GET__OWNER_OFFSET UNITYSDK_OFFSET(0xE1C6A90)
#define RPG_CLIENT_TERRAINDEFORMATIONRECEIVERBEHAVIOR_METHOD_3_187B835A9D811184_OFFSET UNITYSDK_OFFSET(0xE1C6530)
#define RPG_CLIENT_TERRAINDEFORMATIONRECEIVERBEHAVIOR_METHOD_3_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xE1C6920)
#define RPG_CLIENT_TERRAINDEFORMATIONRECEIVERBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0xE1C6780)
#define RPG_CLIENT_TERRAINDEFORMATIONRECEIVERBEHAVIOR_METHOD_3_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0xE1C67F0)
#define RPG_CLIENT_TERRAINDEFORMATIONRECEIVERBEHAVIOR_METHOD_3_4343F372F34C05BF_3_OFFSET UNITYSDK_OFFSET(0xE1C6860)
#define RPG_CLIENT_TERRAINDEFORMATIONRECEIVERBEHAVIOR_METHOD_3_4343F372F34C05BF_4_OFFSET UNITYSDK_OFFSET(0xE1C68C0)
#define RPG_CLIENT_TERRAINDEFORMATIONRECEIVERBEHAVIOR_METHOD_3_4343F372F34C05BF_5_OFFSET UNITYSDK_OFFSET(0xE1C6960)
#define RPG_CLIENT_TERRAINDEFORMATIONRECEIVERBEHAVIOR_METHOD_3_4343F372F34C05BF_6_OFFSET UNITYSDK_OFFSET(0xE1C69C0)
#define RPG_CLIENT_TERRAINDEFORMATIONRECEIVERBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xE1C64C0)
#define RPG_CLIENT_TERRAINDEFORMATIONRECEIVERBEHAVIOR_METHOD_3_83EC8C142343479D_OFFSET UNITYSDK_OFFSET(0xE1C6B10)
#define RPG_CLIENT_TERRAINDEFORMATIONRECEIVERBEHAVIOR_METHOD_3_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xE1C6430)
#define RPG_CLIENT_TERRAINDEFORMATIONRECEIVERBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0xE1C6A20)
#define RPG_CLIENT_TERRAINDEFORMATIONRECEIVERBEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0xE1C70B0)
#define RPG_CLIENT_TERRAINDEFORMATIONRECEIVERBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0xE1C70A0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(TerrainDeformationReceiverBehavior_TypeDefinitionIndex)->GetStaticField(0x10FB0);
		}
		static ::System::Int32* StaticGet_HeightScaleId()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(TerrainDeformationReceiverBehavior_TypeDefinitionIndex)->GetStaticField(0x10FB4);
		}
		static ::System::Int32* StaticGet_EdgeOffsetId()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(TerrainDeformationReceiverBehavior_TypeDefinitionIndex)->GetStaticField(0x10FB8);
		}
		static ::System::Int32* StaticGet_MaskScaleId()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(TerrainDeformationReceiverBehavior_TypeDefinitionIndex)->GetStaticField(0x10FBC);
		}
		static ::System::Int32* StaticGet_RiseScaleId()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(TerrainDeformationReceiverBehavior_TypeDefinitionIndex)->GetStaticField(0x10FC0);
		}
