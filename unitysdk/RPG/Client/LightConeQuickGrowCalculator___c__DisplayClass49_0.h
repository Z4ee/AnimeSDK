...
#define RPG_CLIENT_LIGHTCONEQUICKGROWCALCULATOR___C__DISPLAYCLASS49_0__CTOR_OFFSET UNITYSDK_OFFSET(0x19500C70)
#define RPG_CLIENT_LIGHTCONEQUICKGROWCALCULATOR___C__DISPLAYCLASS49_0___COLLECTPILEEQUIPMENTS_B__0_OFFSET UNITYSDK_OFFSET(0x19501380)
...
namespace RPG::Client
{
	...
	{
	public:
		::System::UInt32 rarityFilter; // 0x10
		::System::UInt32 targetConfigID; // 0x14
