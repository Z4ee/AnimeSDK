...
#define RPG_CLIENT_MONOTEXTDANMUVIEW_AWAKE_OFFSET UNITYSDK_OFFSET(0xD869F50)
#define RPG_CLIENT_MONOTEXTDANMUVIEW_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xD86A000)
#define RPG_CLIENT_MONOTEXTDANMUVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xD86A0C0)
