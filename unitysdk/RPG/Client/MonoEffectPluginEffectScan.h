...
#define RPG_CLIENT_MONOEFFECTPLUGINEFFECTSCAN_METHOD_8_2566AD459572DFC3_OFFSET UNITYSDK_OFFSET(0xA990A70)
#define RPG_CLIENT_MONOEFFECTPLUGINEFFECTSCAN_METHOD_8_D78B51BFDA4B8B32_OFFSET UNITYSDK_OFFSET(0xA991040)
#define RPG_CLIENT_MONOEFFECTPLUGINEFFECTSCAN__CTOR_OFFSET UNITYSDK_OFFSET(0xA990F00)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginEffectScan_TypeDefinitionIndex = 64534;
