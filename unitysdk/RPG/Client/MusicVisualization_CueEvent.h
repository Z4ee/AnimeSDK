...
#define RPG_CLIENT_MUSICVISUALIZATION_CUEEVENT_METHOD_1_6AC3A5FE99F8BA44_OFFSET UNITYSDK_OFFSET(0xAB2DBC0)
#define RPG_CLIENT_MUSICVISUALIZATION_CUEEVENT_METHOD_1_6DF8E2E2BDB874D5_OFFSET UNITYSDK_OFFSET(0xAB28860)
#define RPG_CLIENT_MUSICVISUALIZATION_CUEEVENT_METHOD_1_A15EF7939F75CCED_OFFSET UNITYSDK_OFFSET(0xAB289B0)
#define RPG_CLIENT_MUSICVISUALIZATION_CUEEVENT_METHOD_1_AB0D5AE688458ECB_OFFSET UNITYSDK_OFFSET(0xAB2DE10)
#define RPG_CLIENT_MUSICVISUALIZATION_CUEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0xAB2E5A0)

namespace RPG::Client
{
	inline static constexpr unsigned int MusicVisualization_CueEvent_TypeDefinitionIndex = 65292;
