...
#define RPG_CLIENT_MUSICVISUALIZATION_CUEEVENT_METHOD_1_04C5CE6A51925CD2_OFFSET UNITYSDK_OFFSET(0x18EA51D0)
#define RPG_CLIENT_MUSICVISUALIZATION_CUEEVENT_METHOD_1_6DF8E2E2BDB874D5_OFFSET UNITYSDK_OFFSET(0x18EA0160)
#define RPG_CLIENT_MUSICVISUALIZATION_CUEEVENT_METHOD_1_A12A2C1EE464D54F_OFFSET UNITYSDK_OFFSET(0x18EA4F60)
#define RPG_CLIENT_MUSICVISUALIZATION_CUEEVENT_METHOD_1_A15EF7939F75CCED_OFFSET UNITYSDK_OFFSET(0x18EA02D0)
#define RPG_CLIENT_MUSICVISUALIZATION_CUEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x18EA5510)

namespace RPG::Client
{
	inline static constexpr unsigned int MusicVisualization_CueEvent_TypeDefinitionIndex = 67644;
