...
#define RPG_CLIENT_MONOANIMATORSTATESYNC_AWAKE_OFFSET UNITYSDK_OFFSET(0x19E2A9C0)
#define RPG_CLIENT_MONOANIMATORSTATESYNC_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x19E2AB20)
#define RPG_CLIENT_MONOANIMATORSTATESYNC_METHOD_5_141D40B68A9E2D14_OFFSET UNITYSDK_OFFSET(0x19E2AC60)
#define RPG_CLIENT_MONOANIMATORSTATESYNC_METHOD_5_7E3758126DC70293_OFFSET UNITYSDK_OFFSET(0x19E2AD30)
#define RPG_CLIENT_MONOANIMATORSTATESYNC_METHOD_5_C74CF020AA42ED85_OFFSET UNITYSDK_OFFSET(0x19E2AD10)
#define RPG_CLIENT_MONOANIMATORSTATESYNC_METHOD_5_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x19E2AD20)
#define RPG_CLIENT_MONOANIMATORSTATESYNC_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x19E2AC00)
#define RPG_CLIENT_MONOANIMATORSTATESYNC_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19E2AB90)
#define RPG_CLIENT_MONOANIMATORSTATESYNC__CTOR_OFFSET UNITYSDK_OFFSET(0x19E2AF80)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoAnimatorStateSync_TypeDefinitionIndex = 68492;
	...
	public:
		...
		::System::Int32 EEJHLPPFAII; // 0x30
		::System::Boolean FNFBEKPGHLF; // 0x34
