...
#define RPG_CLIENT_MONOANIMATORSTATESYNC_AWAKE_OFFSET UNITYSDK_OFFSET(0x9C12B40)
#define RPG_CLIENT_MONOANIMATORSTATESYNC_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x9C12CF0)
#define RPG_CLIENT_MONOANIMATORSTATESYNC_METHOD_5_141D40B68A9E2D14_OFFSET UNITYSDK_OFFSET(0x9C12E30)
#define RPG_CLIENT_MONOANIMATORSTATESYNC_METHOD_5_7E3758126DC70293_OFFSET UNITYSDK_OFFSET(0x9C12F00)
#define RPG_CLIENT_MONOANIMATORSTATESYNC_METHOD_5_C74CF020AA42ED85_OFFSET UNITYSDK_OFFSET(0x9C12EE0)
#define RPG_CLIENT_MONOANIMATORSTATESYNC_METHOD_5_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x9C12EF0)
#define RPG_CLIENT_MONOANIMATORSTATESYNC_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x9C12DD0)
#define RPG_CLIENT_MONOANIMATORSTATESYNC_ONENABLE_OFFSET UNITYSDK_OFFSET(0x9C12D60)
#define RPG_CLIENT_MONOANIMATORSTATESYNC__CTOR_OFFSET UNITYSDK_OFFSET(0x9C13150)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoAnimatorStateSync_TypeDefinitionIndex = 55946;
