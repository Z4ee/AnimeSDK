...
#define RPG_CLIENT_MONOANIMATORSTATESYNC_AWAKE_OFFSET UNITYSDK_OFFSET(0xD730510)
#define RPG_CLIENT_MONOANIMATORSTATESYNC_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xD730670)
#define RPG_CLIENT_MONOANIMATORSTATESYNC_METHOD_5_141D40B68A9E2D14_OFFSET UNITYSDK_OFFSET(0xD7307B0)
#define RPG_CLIENT_MONOANIMATORSTATESYNC_METHOD_5_7E3758126DC70293_OFFSET UNITYSDK_OFFSET(0xD730880)
#define RPG_CLIENT_MONOANIMATORSTATESYNC_METHOD_5_C74CF020AA42ED85_OFFSET UNITYSDK_OFFSET(0xD730860)
#define RPG_CLIENT_MONOANIMATORSTATESYNC_METHOD_5_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xD730870)
#define RPG_CLIENT_MONOANIMATORSTATESYNC_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xD730750)
#define RPG_CLIENT_MONOANIMATORSTATESYNC_ONENABLE_OFFSET UNITYSDK_OFFSET(0xD7306E0)
#define RPG_CLIENT_MONOANIMATORSTATESYNC__CTOR_OFFSET UNITYSDK_OFFSET(0xD730AD0)
