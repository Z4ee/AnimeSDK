...
#define RPG_CLIENT_LITTLEGAME_CHIMERADUEL_CHIMERADUELCHIMERACACHE_CALCULATERANDOMSEEDCOMPONENT_OFFSET UNITYSDK_OFFSET(0xD4C6980)
#define RPG_CLIENT_LITTLEGAME_CHIMERADUEL_CHIMERADUELCHIMERACACHE_CLEAR_OFFSET UNITYSDK_OFFSET(0xD4C7370)
#define RPG_CLIENT_LITTLEGAME_CHIMERADUEL_CHIMERADUELCHIMERACACHE_CREATEFAKE_1_OFFSET UNITYSDK_OFFSET(0xD4C66D0)
#define RPG_CLIENT_LITTLEGAME_CHIMERADUEL_CHIMERADUELCHIMERACACHE_CREATEFAKE_OFFSET UNITYSDK_OFFSET(0xD4C64E0)
#define RPG_CLIENT_LITTLEGAME_CHIMERADUEL_CHIMERADUELCHIMERACACHE_CREATEFROMPRESET_1_OFFSET UNITYSDK_OFFSET(0xD4C6620)
#define RPG_CLIENT_LITTLEGAME_CHIMERADUEL_CHIMERADUELCHIMERACACHE_CREATEFROMPRESET_OFFSET UNITYSDK_OFFSET(0xD4C6560)
#define RPG_CLIENT_LITTLEGAME_CHIMERADUEL_CHIMERADUELCHIMERACACHE_CREATE_1_OFFSET UNITYSDK_OFFSET(0xD4C6300)
#define RPG_CLIENT_LITTLEGAME_CHIMERADUEL_CHIMERADUELCHIMERACACHE_CREATE_2_OFFSET UNITYSDK_OFFSET(0xD4C63E0)
#define RPG_CLIENT_LITTLEGAME_CHIMERADUEL_CHIMERADUELCHIMERACACHE_CREATE_3_OFFSET UNITYSDK_OFFSET(0xD4C6460)
#define RPG_CLIENT_LITTLEGAME_CHIMERADUEL_CHIMERADUELCHIMERACACHE_CREATE_OFFSET UNITYSDK_OFFSET(0xD4C6060)
#define RPG_CLIENT_LITTLEGAME_CHIMERADUEL_CHIMERADUELCHIMERACACHE_GETCHIMERADATA_OFFSET UNITYSDK_OFFSET(0xD4C7280)
#define RPG_CLIENT_LITTLEGAME_CHIMERADUEL_CHIMERADUELCHIMERACACHE_GETSKILLDATA_OFFSET UNITYSDK_OFFSET(0xD4C6FA0)
#define RPG_CLIENT_LITTLEGAME_CHIMERADUEL_CHIMERADUELCHIMERACACHE_GETTONEXTLEVELEXP_OFFSET UNITYSDK_OFFSET(0xD4C6ED0)
#define RPG_CLIENT_LITTLEGAME_CHIMERADUEL_CHIMERADUELCHIMERACACHE_TOCHIMERALOG_OFFSET UNITYSDK_OFFSET(0xD4C6AB0)
#define RPG_CLIENT_LITTLEGAME_CHIMERADUEL_CHIMERADUELCHIMERACACHE_TOLOG_OFFSET UNITYSDK_OFFSET(0xD4C6BB0)
#define RPG_CLIENT_LITTLEGAME_CHIMERADUEL_CHIMERADUELCHIMERACACHE__CTOR_1_OFFSET UNITYSDK_OFFSET(0xD4C5B40)
#define RPG_CLIENT_LITTLEGAME_CHIMERADUEL_CHIMERADUELCHIMERACACHE__CTOR_2_OFFSET UNITYSDK_OFFSET(0xD4C5BA0)
#define RPG_CLIENT_LITTLEGAME_CHIMERADUEL_CHIMERADUELCHIMERACACHE__CTOR_3_OFFSET UNITYSDK_OFFSET(0xD4C5CE0)
#define RPG_CLIENT_LITTLEGAME_CHIMERADUEL_CHIMERADUELCHIMERACACHE__CTOR_4_OFFSET UNITYSDK_OFFSET(0xD4C5D80)
#define RPG_CLIENT_LITTLEGAME_CHIMERADUEL_CHIMERADUELCHIMERACACHE__CTOR_5_OFFSET UNITYSDK_OFFSET(0xD4C67F0)
#define RPG_CLIENT_LITTLEGAME_CHIMERADUEL_CHIMERADUELCHIMERACACHE__CTOR_6_OFFSET UNITYSDK_OFFSET(0xD4C68B0)
#define RPG_CLIENT_LITTLEGAME_CHIMERADUEL_CHIMERADUELCHIMERACACHE__CTOR_OFFSET UNITYSDK_OFFSET(0xD4C5770)

namespace RPG::Client::LittleGame::ChimeraDuel
{
	inline static constexpr unsigned int ChimeraDuelChimeraCache_TypeDefinitionIndex = 77178;
	...
	public:
		...
		::System::Int32 TeamPosition; // 0x2C
