...
#define RPG_CLIENT_LITTLEGAME_LITTLEGAMERUNTIMEBUTTON_CLEAR_OFFSET UNITYSDK_OFFSET(0x19AA6E50)
#define RPG_CLIENT_LITTLEGAME_LITTLEGAMERUNTIMEBUTTON_GET_ENTITYID_OFFSET UNITYSDK_OFFSET(0x19AA6E10)
#define RPG_CLIENT_LITTLEGAME_LITTLEGAMERUNTIMEBUTTON_GET_ORIGINBUTTONNAME_OFFSET UNITYSDK_OFFSET(0x19AA6E30)
#define RPG_CLIENT_LITTLEGAME_LITTLEGAMERUNTIMEBUTTON_SET_ENTITYID_OFFSET UNITYSDK_OFFSET(0x19AA6E20)
#define RPG_CLIENT_LITTLEGAME_LITTLEGAMERUNTIMEBUTTON_SET_ORIGINBUTTONNAME_OFFSET UNITYSDK_OFFSET(0x19AA6E40)
#define RPG_CLIENT_LITTLEGAME_LITTLEGAMERUNTIMEBUTTON__CTOR_OFFSET UNITYSDK_OFFSET(0x19AA6EC0)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int LittleGameRuntimeButton_TypeDefinitionIndex = 72609;
