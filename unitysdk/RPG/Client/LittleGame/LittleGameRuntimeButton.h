...
#define RPG_CLIENT_LITTLEGAME_LITTLEGAMERUNTIMEBUTTON_CLEAR_OFFSET UNITYSDK_OFFSET(0xBE2A4F0)
#define RPG_CLIENT_LITTLEGAME_LITTLEGAMERUNTIMEBUTTON_GET_ENTITYID_OFFSET UNITYSDK_OFFSET(0xBE2A4B0)
#define RPG_CLIENT_LITTLEGAME_LITTLEGAMERUNTIMEBUTTON_GET_ORIGINBUTTONNAME_OFFSET UNITYSDK_OFFSET(0xBE2A4D0)
#define RPG_CLIENT_LITTLEGAME_LITTLEGAMERUNTIMEBUTTON_SET_ENTITYID_OFFSET UNITYSDK_OFFSET(0xBE2A4C0)
#define RPG_CLIENT_LITTLEGAME_LITTLEGAMERUNTIMEBUTTON_SET_ORIGINBUTTONNAME_OFFSET UNITYSDK_OFFSET(0xBE2A4E0)
#define RPG_CLIENT_LITTLEGAME_LITTLEGAMERUNTIMEBUTTON__CTOR_OFFSET UNITYSDK_OFFSET(0xBE2A550)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int LittleGameRuntimeButton_TypeDefinitionIndex = 71096;
