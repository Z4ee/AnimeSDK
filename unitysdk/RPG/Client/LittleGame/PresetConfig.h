...
#define RPG_CLIENT_LITTLEGAME_PRESETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17EF88B0)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int PresetConfig_TypeDefinitionIndex = 38584;
