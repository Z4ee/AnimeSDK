...
#define RPG_CLIENT_LITTLEGAME_PRESETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5944B0)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int PresetConfig_TypeDefinitionIndex = 40160;
