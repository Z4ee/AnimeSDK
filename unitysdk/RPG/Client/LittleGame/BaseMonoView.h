...
#define RPG_CLIENT_LITTLEGAME_BASEMONOVIEW_GETCENTERPOSITION_OFFSET UNITYSDK_OFFSET(0xD4A9D00)
#define RPG_CLIENT_LITTLEGAME_BASEMONOVIEW_GETTRANSFORM_OFFSET UNITYSDK_OFFSET(0xD4A9DA0)
#define RPG_CLIENT_LITTLEGAME_BASEMONOVIEW_SAFESETACTIVE_OFFSET UNITYSDK_OFFSET(0xD4A9DF0)
#define RPG_CLIENT_LITTLEGAME_BASEMONOVIEW_SETLOCALROTATION_OFFSET UNITYSDK_OFFSET(0xD4A9C80)
#define RPG_CLIENT_LITTLEGAME_BASEMONOVIEW_SETPOSITION_OFFSET UNITYSDK_OFFSET(0xD4A9BF0)
#define RPG_CLIENT_LITTLEGAME_BASEMONOVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xD4A9F00)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int BaseMonoView_TypeDefinitionIndex = 76010;
