...
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPLAYER_GETCENTERPOSITION_OFFSET UNITYSDK_OFFSET(0x19AB11B0)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPLAYER_INITIALIZEVIEW_OFFSET UNITYSDK_OFFSET(0x19AB07E0)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPLAYER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x19AB08F0)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPLAYER_METHOD_6_E0E1BDE3C92F9C86_OFFSET UNITYSDK_OFFSET(0x19AB0A20)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPLAYER_ONPLAYERHITSTATEREMOVED_OFFSET UNITYSDK_OFFSET(0x19AB1000)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPLAYER_ONPLAYERHITSTATE_OFFSET UNITYSDK_OFFSET(0x19AB0FA0)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPLAYER_REGISTERLISTENERS_OFFSET UNITYSDK_OFFSET(0x19AB0D50)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPLAYER_RELEASEVIEW_OFFSET UNITYSDK_OFFSET(0x19AB0B70)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPLAYER_SAFESETACTIVE_OFFSET UNITYSDK_OFFSET(0x19AB0D00)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPLAYER_SETANIMBOOLPARAM_OFFSET UNITYSDK_OFFSET(0x19AB1050)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPLAYER_SETANIMFLOATPARAM_OFFSET UNITYSDK_OFFSET(0x19AB10C0)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPLAYER_SETANIMTRIGGER_OFFSET UNITYSDK_OFFSET(0x19AB1140)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPLAYER_SETLOCALROTATION_OFFSET UNITYSDK_OFFSET(0x19AB0E50)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPLAYER_SETMATFLOATPARAM_OFFSET UNITYSDK_OFFSET(0x19AB0F30)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPLAYER_SETMATINTPARAM_OFFSET UNITYSDK_OFFSET(0x19AB0ED0)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPLAYER_SETPOSITION_OFFSET UNITYSDK_OFFSET(0x19AB0DC0)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPLAYER__CCTOR_OFFSET UNITYSDK_OFFSET(0x19AB1270)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x19AB1260)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int MovieGamePlayer_TypeDefinitionIndex = 72699;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MovieGamePlayer_TypeDefinitionIndex)->GetStaticField(0xA140);
		}
