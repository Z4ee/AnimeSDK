...
#define RPG_CLIENT_LITTLEGAME_CHIMERAHEALCOMMAND_EXECUTE_OFFSET UNITYSDK_OFFSET(0xBDE1D00)
#define RPG_CLIENT_LITTLEGAME_CHIMERAHEALCOMMAND__CTOR_OFFSET UNITYSDK_OFFSET(0xBDE1D60)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int ChimeraHealCommand_TypeDefinitionIndex = 71204;
