...
{
	inline static constexpr unsigned int SimpleViewService_1_AssetAsyncLoadHandle_TypeDefinitionIndex = 70285;
	...
	public:
		...
		::Class_0_16E4307DCC419505_104* _PostLoadInterface; // 0x0
