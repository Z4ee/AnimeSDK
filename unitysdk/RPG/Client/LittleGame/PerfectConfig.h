...
#define RPG_CLIENT_LITTLEGAME_PERFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16850E50)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int PerfectConfig_TypeDefinitionIndex = 32790;
