...
#define RPG_CLIENT_LITTLEGAME_ELFRESTAURANT_ELFRESTAURANTCUSTOMERVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xA699F50)

namespace RPG::Client::LittleGame::ElfRestaurant
{
	inline static constexpr unsigned int ElfRestaurantCustomerView_TypeDefinitionIndex = 70980;
