...
#define RPG_CLIENT_LITTLEGAME_ELFRESTAURANT_FOODDEBRIS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC3AC20)

namespace RPG::Client::LittleGame::ElfRestaurant
{
	inline static constexpr unsigned int FoodDebris_TypeDefinitionIndex = 76809;
