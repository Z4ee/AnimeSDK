...
#define RPG_CLIENT_LITTLEGAME_ELFRESTAURANT_ELFRESTAURANTBOARDVIEW_GETCURRENTSUPEREVENTVCAMERAVIEW_OFFSET UNITYSDK_OFFSET(0x1AC39060)
#define RPG_CLIENT_LITTLEGAME_ELFRESTAURANT_ELFRESTAURANTBOARDVIEW_SETBUILDVCAMERAACTIVE_OFFSET UNITYSDK_OFFSET(0x1AC390C0)
#define RPG_CLIENT_LITTLEGAME_ELFRESTAURANT_ELFRESTAURANTBOARDVIEW_SETRESTAURANTVCAMERAACTIVE_OFFSET UNITYSDK_OFFSET(0x1AC392D0)
#define RPG_CLIENT_LITTLEGAME_ELFRESTAURANT_ELFRESTAURANTBOARDVIEW_SETRESTAURANTVCAMERAPHASE2ACTIVE_OFFSET UNITYSDK_OFFSET(0x1AC394E0)
#define RPG_CLIENT_LITTLEGAME_ELFRESTAURANT_ELFRESTAURANTBOARDVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC396F0)

namespace RPG::Client::LittleGame::ElfRestaurant
{
	inline static constexpr unsigned int ElfRestaurantBoardView_TypeDefinitionIndex = 76804;
