...
#define RPG_CLIENT_LITTLEGAME_ELFRESTAURANT_ELFRESTAURANTBOARDVIEW_GETCURRENTSUPEREVENTVCAMERAVIEW_OFFSET UNITYSDK_OFFSET(0xA699860)
#define RPG_CLIENT_LITTLEGAME_ELFRESTAURANT_ELFRESTAURANTBOARDVIEW_SETBUILDVCAMERAACTIVE_OFFSET UNITYSDK_OFFSET(0xA6998C0)
#define RPG_CLIENT_LITTLEGAME_ELFRESTAURANT_ELFRESTAURANTBOARDVIEW_SETRESTAURANTVCAMERAACTIVE_OFFSET UNITYSDK_OFFSET(0xA699AD0)
#define RPG_CLIENT_LITTLEGAME_ELFRESTAURANT_ELFRESTAURANTBOARDVIEW_SETRESTAURANTVCAMERAPHASE2ACTIVE_OFFSET UNITYSDK_OFFSET(0xA699CE0)
#define RPG_CLIENT_LITTLEGAME_ELFRESTAURANT_ELFRESTAURANTBOARDVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xA699EF0)

namespace RPG::Client::LittleGame::ElfRestaurant
{
	inline static constexpr unsigned int ElfRestaurantBoardView_TypeDefinitionIndex = 70978;
