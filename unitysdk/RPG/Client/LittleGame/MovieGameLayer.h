...
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMELAYER__CTOR_OFFSET UNITYSDK_OFFSET(0xD5210C0)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int MovieGameLayer_TypeDefinitionIndex = 76134;
