...
#define RPG_CLIENT_LITTLEGAME_MATCH3_MATCHTHREETEXTDIALOGINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1C593AC0)

namespace RPG::Client::LittleGame::Match3
{
	inline static constexpr unsigned int MatchThreeTextDialogInfo_TypeDefinitionIndex = 40466;
