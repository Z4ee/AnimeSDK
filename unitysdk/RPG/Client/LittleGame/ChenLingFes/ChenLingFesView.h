...
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESVIEW_GETDIALOGATTACHPOINT_OFFSET UNITYSDK_OFFSET(0xBDD7110)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESVIEW_GETEFFECTROOT_OFFSET UNITYSDK_OFFSET(0xBDD70B0)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESVIEW_GETENTITY_OFFSET UNITYSDK_OFFSET(0xBDD7010)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESVIEW_GETROOT_OFFSET UNITYSDK_OFFSET(0xBDD7050)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESVIEW_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xBDD6EC0)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESVIEW_RELEASE_OFFSET UNITYSDK_OFFSET(0xBDD6F70)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xBDD44B0)

namespace RPG::Client::LittleGame::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesView_TypeDefinitionIndex = 72311;
