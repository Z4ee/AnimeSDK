...
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESVIEW_GETDIALOGATTACHPOINT_OFFSET UNITYSDK_OFFSET(0x1AC258C0)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESVIEW_GETEFFECTROOT_OFFSET UNITYSDK_OFFSET(0x1AC25860)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESVIEW_GETENTITY_OFFSET UNITYSDK_OFFSET(0x1AC257C0)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESVIEW_GETROOT_OFFSET UNITYSDK_OFFSET(0x1AC25800)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESVIEW_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1AC25670)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESVIEW_RELEASE_OFFSET UNITYSDK_OFFSET(0x1AC25720)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC22DC0)

namespace RPG::Client::LittleGame::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesView_TypeDefinitionIndex = 77320;
	...
	public:
		...
		::Entitas::IContext* EEFMDEHLLFI; // 0x48
		::Entitas::IEntity* KAKEIDJDNHJ; // 0x50
