...
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESVIEW_GETDIALOGATTACHPOINT_OFFSET UNITYSDK_OFFSET(0xD4C0DB0)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESVIEW_GETEFFECTROOT_OFFSET UNITYSDK_OFFSET(0xD4C0D50)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESVIEW_GETENTITY_OFFSET UNITYSDK_OFFSET(0xD4C0CB0)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESVIEW_GETROOT_OFFSET UNITYSDK_OFFSET(0xD4C0CF0)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESVIEW_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xD4C0B60)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESVIEW_RELEASE_OFFSET UNITYSDK_OFFSET(0xD4C0C10)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xD4BE2B0)

namespace RPG::Client::LittleGame::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesView_TypeDefinitionIndex = 77321;
