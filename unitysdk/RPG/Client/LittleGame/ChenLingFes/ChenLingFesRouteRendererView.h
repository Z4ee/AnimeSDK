...
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW_BINDCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x1AC24FB0)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW_CREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1AC24E00)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW_GET_BGCCMATH_OFFSET UNITYSDK_OFFSET(0x1AC25580)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW_GET_BGCCSPLITTERPOLYLINE_OFFSET UNITYSDK_OFFSET(0x1AC255A0)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW_GET_BGCURVE_OFFSET UNITYSDK_OFFSET(0x1AC25520)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW_GET_LINERENDERER_OFFSET UNITYSDK_OFFSET(0x1AC25540)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW_GET_OUTLINERENDERER_OFFSET UNITYSDK_OFFSET(0x1AC25560)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW_RECYCLE_OFFSET UNITYSDK_OFFSET(0x1AC25490)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW_SET_BGCCMATH_OFFSET UNITYSDK_OFFSET(0x1AC25590)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW_SET_BGCCSPLITTERPOLYLINE_OFFSET UNITYSDK_OFFSET(0x1AC255B0)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW_SET_BGCURVE_OFFSET UNITYSDK_OFFSET(0x1AC25530)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW_SET_LINERENDERER_OFFSET UNITYSDK_OFFSET(0x1AC25550)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW_SET_OUTLINERENDERER_OFFSET UNITYSDK_OFFSET(0x1AC25570)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC255C0)

namespace RPG::Client::LittleGame::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesRouteRendererView_TypeDefinitionIndex = 77318;
