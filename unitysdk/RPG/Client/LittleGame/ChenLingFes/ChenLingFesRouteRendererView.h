...
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW_BINDCOMPONENTS_OFFSET UNITYSDK_OFFSET(0xBDD6800)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW_CREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBDD6650)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW_GET_BGCCMATH_OFFSET UNITYSDK_OFFSET(0xBDD6DD0)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW_GET_BGCCSPLITTERPOLYLINE_OFFSET UNITYSDK_OFFSET(0xBDD6DF0)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW_GET_BGCURVE_OFFSET UNITYSDK_OFFSET(0xBDD6D70)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW_GET_LINERENDERER_OFFSET UNITYSDK_OFFSET(0xBDD6D90)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW_GET_OUTLINERENDERER_OFFSET UNITYSDK_OFFSET(0xBDD6DB0)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW_RECYCLE_OFFSET UNITYSDK_OFFSET(0xBDD6CE0)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW_SET_BGCCMATH_OFFSET UNITYSDK_OFFSET(0xBDD6DE0)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW_SET_BGCCSPLITTERPOLYLINE_OFFSET UNITYSDK_OFFSET(0xBDD6E00)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW_SET_BGCURVE_OFFSET UNITYSDK_OFFSET(0xBDD6D80)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW_SET_LINERENDERER_OFFSET UNITYSDK_OFFSET(0xBDD6DA0)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW_SET_OUTLINERENDERER_OFFSET UNITYSDK_OFFSET(0xBDD6DC0)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xBDD6E10)

namespace RPG::Client::LittleGame::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesRouteRendererView_TypeDefinitionIndex = 72309;
