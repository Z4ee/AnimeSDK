...
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW_BINDCOMPONENTS_OFFSET UNITYSDK_OFFSET(0xD4C04A0)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW_CREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD4C02F0)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW_GET_BGCCMATH_OFFSET UNITYSDK_OFFSET(0xD4C0A70)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW_GET_BGCCSPLITTERPOLYLINE_OFFSET UNITYSDK_OFFSET(0xD4C0A90)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW_GET_BGCURVE_OFFSET UNITYSDK_OFFSET(0xD4C0A10)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW_GET_LINERENDERER_OFFSET UNITYSDK_OFFSET(0xD4C0A30)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW_GET_OUTLINERENDERER_OFFSET UNITYSDK_OFFSET(0xD4C0A50)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW_RECYCLE_OFFSET UNITYSDK_OFFSET(0xD4C0980)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW_SET_BGCCMATH_OFFSET UNITYSDK_OFFSET(0xD4C0A80)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW_SET_BGCCSPLITTERPOLYLINE_OFFSET UNITYSDK_OFFSET(0xD4C0AA0)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW_SET_BGCURVE_OFFSET UNITYSDK_OFFSET(0xD4C0A20)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW_SET_LINERENDERER_OFFSET UNITYSDK_OFFSET(0xD4C0A40)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW_SET_OUTLINERENDERER_OFFSET UNITYSDK_OFFSET(0xD4C0A60)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xD4C0AB0)

namespace RPG::Client::LittleGame::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesRouteRendererView_TypeDefinitionIndex = 77319;
