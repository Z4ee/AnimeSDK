...
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESCELLVIEW_SETLOCKHIGHLIGHT_OFFSET UNITYSDK_OFFSET(0xD4BE2D0)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESCELLVIEW_SETPLACEHIGHLIGHT_OFFSET UNITYSDK_OFFSET(0xD4BE430)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESCELLVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xD4BE530)

namespace RPG::Client::LittleGame::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesCellView_TypeDefinitionIndex = 77316;
