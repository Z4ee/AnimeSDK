...
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESCELLVIEW_SETLOCKHIGHLIGHT_OFFSET UNITYSDK_OFFSET(0x19B92D30)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESCELLVIEW_SETPLACEHIGHLIGHT_OFFSET UNITYSDK_OFFSET(0x19B92E90)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESCELLVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x19B92F90)

namespace RPG::Client::LittleGame::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesCellView_TypeDefinitionIndex = 73831;
