...
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESITEMVIEW_CLEARBREATHHOVERCOLOR_OFFSET UNITYSDK_OFFSET(0xBDD5C30)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESITEMVIEW_CLEAREFFECT_OFFSET UNITYSDK_OFFSET(0xBDD5ED0)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESITEMVIEW_GET_ANIMATOR_OFFSET UNITYSDK_OFFSET(0xBDD5FE0)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESITEMVIEW_GET_OUTLINEPOSTFXMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0xBDD5F90)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESITEMVIEW_GET_PROPSELECTIONEFFECT_OFFSET UNITYSDK_OFFSET(0xBDD5F40)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESITEMVIEW_METHOD_7_A239DF324AF4215D_OFFSET UNITYSDK_OFFSET(0xBDD5920)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESITEMVIEW_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xBDD5E20)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESITEMVIEW_SETDITHERALPHA_OFFSET UNITYSDK_OFFSET(0xBDD58A0)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESITEMVIEW_START_OFFSET UNITYSDK_OFFSET(0xBDD5DD0)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESITEMVIEW_USEBREATHHOVERCOLOR_OFFSET UNITYSDK_OFFSET(0xBDD5B80)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESITEMVIEW__CCTOR_OFFSET UNITYSDK_OFFSET(0xBDD6050)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESITEMVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xBDD6030)

namespace RPG::Client::LittleGame::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesItemView_TypeDefinitionIndex = 72307;
	...
	public:
		...
		{
			return (::UnityEngine::Color*)Il2CppClass::FromTypeDefinitionIndex(ChenLingFesItemView_TypeDefinitionIndex)->GetStaticField(0xDE50);
		}
		static ::System::Int32* StaticGet_Field_7_1()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ChenLingFesItemView_TypeDefinitionIndex)->GetStaticField(0xDE60);
		}
