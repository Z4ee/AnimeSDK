...
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW___C__BINDCOMPONENTS_B__2_0_OFFSET UNITYSDK_OFFSET(0xD4C0B10)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW___C__CCTOR_OFFSET UNITYSDK_OFFSET(0xD4C0AC0)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESROUTERENDERERVIEW___C__CTOR_OFFSET UNITYSDK_OFFSET(0xD4C0B00)

namespace RPG::Client::LittleGame::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesRouteRendererView___c_TypeDefinitionIndex = 77320;
	...
	public:
		...
		{
			return (::RPG::Client::LittleGame::ChenLingFes::ChenLingFesRouteRendererView___c**)Il2CppClass::FromTypeDefinitionIndex(ChenLingFesRouteRendererView___c_TypeDefinitionIndex)->GetStaticField(0x626F0);
		}
		static ::System::Func_2<::BansheeGz::BGSpline::Components::BGCcSplitterPolyline*, ::System::Boolean>** StaticGet___9__2_0()
		{
			return (::System::Func_2<::BansheeGz::BGSpline::Components::BGCcSplitterPolyline*, ::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(ChenLingFesRouteRendererView___c_TypeDefinitionIndex)->GetStaticField(0x626F8);
		}
