...
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESPREVIEWCELLVIEW_INITPEFORMCELL_OFFSET UNITYSDK_OFFSET(0xBDD6080)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESPREVIEWCELLVIEW_METHOD_7_648D33A557BC2E77_OFFSET UNITYSDK_OFFSET(0xBDD64D0)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESPREVIEWCELLVIEW_METHOD_7_84E99AA4DE826971_OFFSET UNITYSDK_OFFSET(0xBDD62B0)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESPREVIEWCELLVIEW_SETPEFORMCELLAVAILABLE_OFFSET UNITYSDK_OFFSET(0xBDD63E0)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESPREVIEWCELLVIEW__CCTOR_OFFSET UNITYSDK_OFFSET(0xBDD6600)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESPREVIEWCELLVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xBDD65E0)

namespace RPG::Client::LittleGame::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesPreviewCellView_TypeDefinitionIndex = 72308;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ChenLingFesPreviewCellView_TypeDefinitionIndex)->GetStaticField(0xDD20);
		}
		static ::System::Int32* StaticGet_RectScaleId()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ChenLingFesPreviewCellView_TypeDefinitionIndex)->GetStaticField(0xDD24);
		}
