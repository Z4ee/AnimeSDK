...
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESBOARDVIEW_INIT_OFFSET UNITYSDK_OFFSET(0x19B92850)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESBOARDVIEW_SETBUILDVCAMERACONFIG_OFFSET UNITYSDK_OFFSET(0x19B92A60)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESBOARDVIEW_SETGAMEVCAMERAACTIVE_OFFSET UNITYSDK_OFFSET(0x19B92C80)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESBOARDVIEW_SETGAMEVCAMERACONFIG_OFFSET UNITYSDK_OFFSET(0x19B92B70)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESBOARDVIEW_SETVCAMERAENABLED_OFFSET UNITYSDK_OFFSET(0x19B929C0)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESBOARDVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x19B92CF0)

namespace RPG::Client::LittleGame::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesBoardView_TypeDefinitionIndex = 73830;
