...
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESBOARDVIEW_INIT_OFFSET UNITYSDK_OFFSET(0xD4BDDF0)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESBOARDVIEW_SETBUILDVCAMERACONFIG_OFFSET UNITYSDK_OFFSET(0xD4BE000)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESBOARDVIEW_SETGAMEVCAMERAACTIVE_OFFSET UNITYSDK_OFFSET(0xD4BE220)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESBOARDVIEW_SETGAMEVCAMERACONFIG_OFFSET UNITYSDK_OFFSET(0xD4BE110)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESBOARDVIEW_SETVCAMERAENABLED_OFFSET UNITYSDK_OFFSET(0xD4BDF60)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESBOARDVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xD4BE290)

namespace RPG::Client::LittleGame::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesBoardView_TypeDefinitionIndex = 77315;
