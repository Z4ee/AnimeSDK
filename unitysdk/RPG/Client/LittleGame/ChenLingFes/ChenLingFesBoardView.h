...
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESBOARDVIEW_INIT_OFFSET UNITYSDK_OFFSET(0xBDD3FF0)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESBOARDVIEW_SETBUILDVCAMERACONFIG_OFFSET UNITYSDK_OFFSET(0xBDD4200)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESBOARDVIEW_SETGAMEVCAMERAACTIVE_OFFSET UNITYSDK_OFFSET(0xBDD4420)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESBOARDVIEW_SETGAMEVCAMERACONFIG_OFFSET UNITYSDK_OFFSET(0xBDD4310)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESBOARDVIEW_SETVCAMERAENABLED_OFFSET UNITYSDK_OFFSET(0xBDD4160)
#define RPG_CLIENT_LITTLEGAME_CHENLINGFES_CHENLINGFESBOARDVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xBDD4490)

namespace RPG::Client::LittleGame::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesBoardView_TypeDefinitionIndex = 72305;
