...
#define RPG_CLIENT_LITTLEGAME_TIMELINECONTROLGAMEWORLDLEVELGRID__CTOR_OFFSET UNITYSDK_OFFSET(0x18CDCCB0)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int TimelineControlGameWorldLevelGrid_TypeDefinitionIndex = 39542;
