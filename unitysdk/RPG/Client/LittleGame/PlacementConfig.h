...
#define RPG_CLIENT_LITTLEGAME_PLACEMENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EF9E0C0)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int PlacementConfig_TypeDefinitionIndex = 41028;
