...
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEFULLSCREENTRANSLATEEFFECT_INITIALIZEVIEW_OFFSET UNITYSDK_OFFSET(0x9A35A80)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEFULLSCREENTRANSLATEEFFECT_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x9A35F50)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEFULLSCREENTRANSLATEEFFECT_ONFEVERTIMEREMOVED_OFFSET UNITYSDK_OFFSET(0x9A35ED0)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEFULLSCREENTRANSLATEEFFECT_ONFEVERTIME_OFFSET UNITYSDK_OFFSET(0x9A35E40)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEFULLSCREENTRANSLATEEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x9A364F0)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int MovieGameFullScreenTranslateEffect_TypeDefinitionIndex = 62366;
