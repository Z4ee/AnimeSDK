...
#define RPG_CLIENT_LITTLEGAME_MATCHTHREETIMELINEBATTLEFIELD_APPLYGROWUPAUDIO_OFFSET UNITYSDK_OFFSET(0x19AA9500)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREETIMELINEBATTLEFIELD_AWAKE_OFFSET UNITYSDK_OFFSET(0x19AAA060)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREETIMELINEBATTLEFIELD_BINDUIPAGE_OFFSET UNITYSDK_OFFSET(0x19AA8530)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREETIMELINEBATTLEFIELD_ISFINISH_OFFSET UNITYSDK_OFFSET(0x19AA8F60)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREETIMELINEBATTLEFIELD_MANUALUPDATE_OFFSET UNITYSDK_OFFSET(0x19AA8F00)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREETIMELINEBATTLEFIELD_PAUSE_OFFSET UNITYSDK_OFFSET(0x19AA8B10)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREETIMELINEBATTLEFIELD_PLAYTOEND_OFFSET UNITYSDK_OFFSET(0x19AA9010)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREETIMELINEBATTLEFIELD_PLAY_OFFSET UNITYSDK_OFFSET(0x19AA8910)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREETIMELINEBATTLEFIELD_RESET_OFFSET UNITYSDK_OFFSET(0x19AA8CB0)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREETIMELINEBATTLEFIELD_RESUME_OFFSET UNITYSDK_OFFSET(0x19AA8BE0)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREETIMELINEBATTLEFIELD_SETBIRDADAPTIVEPOSITIONS_OFFSET UNITYSDK_OFFSET(0x19AA8690)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREETIMELINEBATTLEFIELD_SETDEPLOYPOSITION_OFFSET UNITYSDK_OFFSET(0x19AA9160)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREETIMELINEBATTLEFIELD_SETFIGHTERBODYMATERIAL_OFFSET UNITYSDK_OFFSET(0x19AA9080)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREETIMELINEBATTLEFIELD_SETFIGHTEREMO_OFFSET UNITYSDK_OFFSET(0x19AA91F0)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREETIMELINEBATTLEFIELD_SETFIGHTERFACEMATERIAL_OFFSET UNITYSDK_OFFSET(0x19AA90F0)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREETIMELINEBATTLEFIELD_SETFIGHTERSCALE_OFFSET UNITYSDK_OFFSET(0x19AA8E60)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREETIMELINEBATTLEFIELD_SETUPBACKGROUNDBYLEVEL_OFFSET UNITYSDK_OFFSET(0x19AA9E60)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREETIMELINEBATTLEFIELD_SETUPBACKGROUNDBYROUND_OFFSET UNITYSDK_OFFSET(0x19AA9FB0)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREETIMELINEBATTLEFIELD_STOP_OFFSET UNITYSDK_OFFSET(0x19AA8A50)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREETIMELINEBATTLEFIELD_UPDATE_OFFSET UNITYSDK_OFFSET(0x19AAA400)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREETIMELINEBATTLEFIELD__BINDUIPAGE_OFFSET UNITYSDK_OFFSET(0x19AA9880)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREETIMELINEBATTLEFIELD__CCTOR_OFFSET UNITYSDK_OFFSET(0x19AABC20)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREETIMELINEBATTLEFIELD__COMPUTEADAPTIVEPOSITION_OFFSET UNITYSDK_OFFSET(0x19AAAEC0)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREETIMELINEBATTLEFIELD__COMPUTEWORLDTOCAMERAMATRIXGL_OFFSET UNITYSDK_OFFSET(0x19AAAB30)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREETIMELINEBATTLEFIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x19AABC00)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREETIMELINEBATTLEFIELD__DEACTIVATEALLTIMELINES_OFFSET UNITYSDK_OFFSET(0x19AAA2E0)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREETIMELINEBATTLEFIELD__FITBIRDPOSITIONS_OFFSET UNITYSDK_OFFSET(0x19AA96B0)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREETIMELINEBATTLEFIELD__INITBATTLESHOWFOV_OFFSET UNITYSDK_OFFSET(0x19AAA910)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREETIMELINEBATTLEFIELD__INITFOV_OFFSET UNITYSDK_OFFSET(0x19AAA360)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREETIMELINEBATTLEFIELD__PROJECTIONMATRIX_OFFSET UNITYSDK_OFFSET(0x19AAB950)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREETIMELINEBATTLEFIELD__SCREENTORAY_OFFSET UNITYSDK_OFFSET(0x19AAB460)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREETIMELINEBATTLEFIELD__SETFOV_OFFSET UNITYSDK_OFFSET(0x19AABB80)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREETIMELINEBATTLEFIELD__UIPOSITIONTOSCREENPOINT_OFFSET UNITYSDK_OFFSET(0x19AAACD0)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREETIMELINEBATTLEFIELD__UPDATEFITPOSITIONS_OFFSET UNITYSDK_OFFSET(0x19AA92D0)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREETIMELINEBATTLEFIELD__UPDATEFOV_OFFSET UNITYSDK_OFFSET(0x19AAA450)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREETIMELINEBATTLEFIELD__WORLDTOPROJECTION_OFFSET UNITYSDK_OFFSET(0x19AAB7E0)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREETIMELINEBATTLEFIELD__WORLDTOSCREENPOINT_OFFSET UNITYSDK_OFFSET(0x19AAB2C0)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int MatchThreeTimelineBattleField_TypeDefinitionIndex = 72642;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(MatchThreeTimelineBattleField_TypeDefinitionIndex)->GetStaticField(0x3C970);
		}
		static ::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::UInt32>** StaticGet__Round2BackGroudID()
		{
			return (::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(MatchThreeTimelineBattleField_TypeDefinitionIndex)->GetStaticField(0x3C978);
		}
