...
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER_GETCOLLIDER_OFFSET UNITYSDK_OFFSET(0xA6DF230)
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER_GETENTITY_OFFSET UNITYSDK_OFFSET(0xA6DF140)
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER_GET_ISACTIVEANDENABLED_OFFSET UNITYSDK_OFFSET(0xA6DF2D0)
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xA6DF180)
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER_INITTRIGGERRUNTIMEINFO_OFFSET UNITYSDK_OFFSET(0xA6DF1E0)
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER_METHOD_6_5757AFE81AE625CC_OFFSET UNITYSDK_OFFSET(0xA6DF960)
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER_METHOD_6_C09A7501F3F94DEB_OFFSET UNITYSDK_OFFSET(0xA6DF740)
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER_METHOD_6_F9555880FBE027D5_OFFSET UNITYSDK_OFFSET(0xA6DF3D0)
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER_METHOD_6_FB988A230DFA3F4D_OFFSET UNITYSDK_OFFSET(0xA6DFCA0)
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xA6DFC40)
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0xA6DF560)
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0xA6DFBA0)
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER_RELEASE_OFFSET UNITYSDK_OFFSET(0xA6DF2E0)
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0xA6DFD10)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int MonoTrigger_TypeDefinitionIndex = 70272;

	class MonoTrigger : public ::RPG::Client::LittleGame::BaseMonoGenericView
	{
	public:
		::Entitas::IEntity* Field_6_0; // 0x20
		::Class_1_D3CC73B16B410533* Field_6_1; // 0x28
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_LITTLEGAME_MONOTRIGGER_METHOD_6_F9555880FBE027D5_OFFSET))(this);
		}
		...
		::System::Void Method_6_C09A7501F3F94DEB(::UnityEngine::Collider* a1, ::System::Boolean a2)
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::Collider*, ::System::Boolean))((::PBYTE)hIl2Cpp + RPG_CLIENT_LITTLEGAME_MONOTRIGGER_METHOD_6_C09A7501F3F94DEB_OFFSET))(this, a1, a2);
		}
	};
}
