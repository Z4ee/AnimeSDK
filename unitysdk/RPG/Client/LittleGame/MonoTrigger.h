...
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER_GETCOLLIDER_OFFSET UNITYSDK_OFFSET(0xBE2FF90)
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER_GETENTITY_OFFSET UNITYSDK_OFFSET(0xBE2FEA0)
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER_GET_ISACTIVEANDENABLED_OFFSET UNITYSDK_OFFSET(0xBE30030)
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xBE2FEE0)
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER_INITTRIGGERRUNTIMEINFO_OFFSET UNITYSDK_OFFSET(0xBE2FF40)
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER_METHOD_6_34BE98EC430CA311_OFFSET UNITYSDK_OFFSET(0xBE30510)
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER_METHOD_6_5757AFE81AE625CC_OFFSET UNITYSDK_OFFSET(0xBE307C0)
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER_METHOD_6_7F29568EA964E563_OFFSET UNITYSDK_OFFSET(0xBE30130)
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER_METHOD_6_FB988A230DFA3F4D_OFFSET UNITYSDK_OFFSET(0xBE30A90)
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xBE30A30)
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0xBE302D0)
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0xBE30990)
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER_RELEASE_OFFSET UNITYSDK_OFFSET(0xBE30040)
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0xBE30B00)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int MonoTrigger_TypeDefinitionIndex = 71085;
