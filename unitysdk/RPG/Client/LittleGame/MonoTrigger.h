...
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER_GETCOLLIDER_OFFSET UNITYSDK_OFFSET(0x19AAC9B0)
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER_GETENTITY_OFFSET UNITYSDK_OFFSET(0x19AAC8C0)
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER_GET_ISACTIVEANDENABLED_OFFSET UNITYSDK_OFFSET(0x19AACA50)
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x19AAC900)
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER_INITTRIGGERRUNTIMEINFO_OFFSET UNITYSDK_OFFSET(0x19AAC960)
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER_METHOD_6_34BE98EC430CA311_OFFSET UNITYSDK_OFFSET(0x19AACED0)
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER_METHOD_6_5757AFE81AE625CC_OFFSET UNITYSDK_OFFSET(0x19AAD180)
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER_METHOD_6_7F29568EA964E563_OFFSET UNITYSDK_OFFSET(0x19AACB50)
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER_METHOD_6_FB988A230DFA3F4D_OFFSET UNITYSDK_OFFSET(0x19AAD450)
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x19AAD3F0)
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x19AACD00)
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0x19AAD350)
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER_RELEASE_OFFSET UNITYSDK_OFFSET(0x19AACA60)
#define RPG_CLIENT_LITTLEGAME_MONOTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x19AAD4C0)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int MonoTrigger_TypeDefinitionIndex = 72598;
