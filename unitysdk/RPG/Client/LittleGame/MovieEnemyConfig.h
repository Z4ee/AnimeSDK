...
#define RPG_CLIENT_LITTLEGAME_MOVIEENEMYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4996D0)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int MovieEnemyConfig_TypeDefinitionIndex = 41029;
