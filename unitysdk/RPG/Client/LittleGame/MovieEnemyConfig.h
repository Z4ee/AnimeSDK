...
#define RPG_CLIENT_LITTLEGAME_MOVIEENEMYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17EF8810)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int MovieEnemyConfig_TypeDefinitionIndex = 38574;
