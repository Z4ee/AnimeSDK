...
#define RPG_CLIENT_LITTLEGAME_MATCH3ENERGYVIEWSTATEBUFFER_EXECUTESEQUENCE_OFFSET UNITYSDK_OFFSET(0x1B1CC950)
#define RPG_CLIENT_LITTLEGAME_MATCH3ENERGYVIEWSTATEBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1CCA50)
#define RPG_CLIENT_LITTLEGAME_MATCH3ENERGYVIEWSTATEBUFFER__ONSEQUENCEFINISH_OFFSET UNITYSDK_OFFSET(0x1B1CCA00)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int Match3EnergyViewStateBuffer_TypeDefinitionIndex = 76092;

	class Match3EnergyViewStateBuffer : public ::System::Object
	{
	public:
		::Class_0_16E4307DCC419505_413* IncreaseCommand; // 0x10
		::System::Action* OnFinishIncrease; // 0x18
		::Class_0_16E4307DCC419505_413* CommandSequence; // 0x20
