...
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xBE2B560)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER_METHOD_5_102A1038C38883F3_OFFSET UNITYSDK_OFFSET(0xBE2B160)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER_METHOD_5_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0xBE2AE30)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER_METHOD_5_3422201382CE593B_OFFSET UNITYSDK_OFFSET(0xBE2AD80)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER_METHOD_5_653EEB7EF259681D_OFFSET UNITYSDK_OFFSET(0xBE2B900)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER_METHOD_5_7033EFB970A18315_OFFSET UNITYSDK_OFFSET(0xBE2B2B0)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xBE2AD00)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER_METHOD_5_97D83E4CB3B11935_OFFSET UNITYSDK_OFFSET(0xBE2B5B0)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER_METHOD_5_B7F8E0B4AF22DEA3_OFFSET UNITYSDK_OFFSET(0xBE2B340)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER_RESET_OFFSET UNITYSDK_OFFSET(0xBE2AF80)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER_SETBODYMATERIAL_OFFSET UNITYSDK_OFFSET(0xBE2A8E0)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER_SETEMO_OFFSET UNITYSDK_OFFSET(0xBE2A860)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER_SETFACEMATERIAL_OFFSET UNITYSDK_OFFSET(0xBE2A990)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER_SETSCALE_OFFSET UNITYSDK_OFFSET(0xBE2AA40)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER_STARTBATTLESHOW_OFFSET UNITYSDK_OFFSET(0xBE2AE90)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER_STARTLOOKAT_OFFSET UNITYSDK_OFFSET(0xBE2AF30)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER_UPDATE_OFFSET UNITYSDK_OFFSET(0xBE2B1F0)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER__CCTOR_OFFSET UNITYSDK_OFFSET(0xBE2BA60)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER__CTOR_OFFSET UNITYSDK_OFFSET(0xBE2B9E0)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int MatchThreeFighter_TypeDefinitionIndex = 71127;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MatchThreeFighter_TypeDefinitionIndex)->GetStaticField(0xF140);
		}
