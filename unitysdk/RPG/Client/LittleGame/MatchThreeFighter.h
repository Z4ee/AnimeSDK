...
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x9A2D450)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER_METHOD_5_102A1038C38883F3_OFFSET UNITYSDK_OFFSET(0x9A2D050)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER_METHOD_5_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0x9A2CD20)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER_METHOD_5_3422201382CE593B_OFFSET UNITYSDK_OFFSET(0x9A2CC70)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER_METHOD_5_653EEB7EF259681D_OFFSET UNITYSDK_OFFSET(0x9A2D7F0)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER_METHOD_5_7033EFB970A18315_OFFSET UNITYSDK_OFFSET(0x9A2D1A0)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x9A2CBF0)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER_METHOD_5_97D83E4CB3B11935_OFFSET UNITYSDK_OFFSET(0x9A2D4A0)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER_METHOD_5_B7F8E0B4AF22DEA3_OFFSET UNITYSDK_OFFSET(0x9A2D230)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER_RESET_OFFSET UNITYSDK_OFFSET(0x9A2CE70)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER_SETBODYMATERIAL_OFFSET UNITYSDK_OFFSET(0x9A2C7D0)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER_SETEMO_OFFSET UNITYSDK_OFFSET(0x9A2C750)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER_SETFACEMATERIAL_OFFSET UNITYSDK_OFFSET(0x9A2C880)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER_SETSCALE_OFFSET UNITYSDK_OFFSET(0x9A2C930)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER_STARTBATTLESHOW_OFFSET UNITYSDK_OFFSET(0x9A2CD80)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER_STARTLOOKAT_OFFSET UNITYSDK_OFFSET(0x9A2CE20)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER_UPDATE_OFFSET UNITYSDK_OFFSET(0x9A2D0E0)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x9A2D960)
#define RPG_CLIENT_LITTLEGAME_MATCHTHREEFIGHTER__CTOR_OFFSET UNITYSDK_OFFSET(0x9A2D8E0)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int MatchThreeFighter_TypeDefinitionIndex = 62312;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MatchThreeFighter_TypeDefinitionIndex)->GetStaticField(0xC260);
		}
