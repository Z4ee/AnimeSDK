...
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACEREPLAYRECORD_GET_MESSAGEDATABASE64_OFFSET UNITYSDK_OFFSET(0x1C4CB420)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACEREPLAYRECORD_GET_MESSAGEDATA_OFFSET UNITYSDK_OFFSET(0x1C4CB440)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACEREPLAYRECORD_METHOD_1_87E1F65BD177CEC9_OFFSET UNITYSDK_OFFSET(0x1C4CB590)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACEREPLAYRECORD_SET_MESSAGEDATABASE64_OFFSET UNITYSDK_OFFSET(0x1C4CB430)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACEREPLAYRECORD_SET_MESSAGEDATA_OFFSET UNITYSDK_OFFSET(0x1C4CB4A0)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACEREPLAYRECORD__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C4CB580)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACEREPLAYRECORD__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4CB510)

namespace RPG::Client::LittleGame::CakeRace
{
	inline static constexpr unsigned int CakeRaceReplayRecord_TypeDefinitionIndex = 77620;
