...
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACESUPPORTINDICATORMONOVIEW_AWAKE_OFFSET UNITYSDK_OFFSET(0xA67A520)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACESUPPORTINDICATORMONOVIEW_GET_RECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0xA67A500)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACESUPPORTINDICATORMONOVIEW_SETSUPPORT_OFFSET UNITYSDK_OFFSET(0xA67A580)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACESUPPORTINDICATORMONOVIEW_SET_RECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0xA67A510)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACESUPPORTINDICATORMONOVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xA67A5E0)

namespace RPG::Client::LittleGame::CakeRace
{
	inline static constexpr unsigned int CakeRaceSupportIndicatorMonoView_TypeDefinitionIndex = 71658;
