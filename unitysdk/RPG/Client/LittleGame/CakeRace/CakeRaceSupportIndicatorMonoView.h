...
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACESUPPORTINDICATORMONOVIEW_AWAKE_OFFSET UNITYSDK_OFFSET(0xD4AE040)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACESUPPORTINDICATORMONOVIEW_GET_RECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0xD4AE020)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACESUPPORTINDICATORMONOVIEW_SETSUPPORT_OFFSET UNITYSDK_OFFSET(0xD4AE0A0)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACESUPPORTINDICATORMONOVIEW_SET_RECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0xD4AE030)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACESUPPORTINDICATORMONOVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xD4AE100)

namespace RPG::Client::LittleGame::CakeRace
{
	inline static constexpr unsigned int CakeRaceSupportIndicatorMonoView_TypeDefinitionIndex = 77690;
