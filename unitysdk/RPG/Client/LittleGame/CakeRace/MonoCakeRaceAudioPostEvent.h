...
#define RPG_CLIENT_LITTLEGAME_CAKERACE_MONOCAKERACEAUDIOPOSTEVENT_AWAKE_OFFSET UNITYSDK_OFFSET(0x19B83510)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_MONOCAKERACEAUDIOPOSTEVENT_METHOD_5_3D9D7F249A4577C0_OFFSET UNITYSDK_OFFSET(0x19B83E90)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_MONOCAKERACEAUDIOPOSTEVENT_METHOD_5_D0D3ED1387E89D3E_OFFSET UNITYSDK_OFFSET(0x19B83D20)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_MONOCAKERACEAUDIOPOSTEVENT_METHOD_5_D1CE2F76A761AE12_OFFSET UNITYSDK_OFFSET(0x19B83930)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_MONOCAKERACEAUDIOPOSTEVENT_METHOD_5_F54DE4640CE99063_OFFSET UNITYSDK_OFFSET(0x19B838B0)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_MONOCAKERACEAUDIOPOSTEVENT_METHOD_5_FB257962C61468C7_OFFSET UNITYSDK_OFFSET(0x19B83AB0)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_MONOCAKERACEAUDIOPOSTEVENT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x19B83C40)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_MONOCAKERACEAUDIOPOSTEVENT_UPDATE_OFFSET UNITYSDK_OFFSET(0x19B83690)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_MONOCAKERACEAUDIOPOSTEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19B83F00)

namespace RPG::Client::LittleGame::CakeRace
{
	inline static constexpr unsigned int MonoCakeRaceAudioPostEvent_TypeDefinitionIndex = 74026;
	...
	public:
		...
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Int32>* Field_5_2; // 0x28
		...
		::System::Boolean Method_5_D1CE2F76A761AE12(::RPG::Client::LittleGame::CakeRace::MonoCakeRaceAudioPostEvent_CakeRaceAnimatorAudioEvent a1)
		{
			return ((::System::Boolean(*)(::PVOID, ::RPG::Client::LittleGame::CakeRace::MonoCakeRaceAudioPostEvent_CakeRaceAnimatorAudioEvent))((::PBYTE)hIl2Cpp + RPG_CLIENT_LITTLEGAME_CAKERACE_MONOCAKERACEAUDIOPOSTEVENT_METHOD_5_D1CE2F76A761AE12_OFFSET))(this, a1);
		}
