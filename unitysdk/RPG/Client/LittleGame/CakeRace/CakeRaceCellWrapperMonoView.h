...
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACECELLWRAPPERMONOVIEW_GET_ANIMATION_OFFSET UNITYSDK_OFFSET(0xD4ABAF0)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACECELLWRAPPERMONOVIEW_GET_CELLVIEW_OFFSET UNITYSDK_OFFSET(0xD4ABB50)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACECELLWRAPPERMONOVIEW_LOADCELLVIEW_OFFSET UNITYSDK_OFFSET(0xD4ABF90)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACECELLWRAPPERMONOVIEW_PLAYAPPEARANIMATION_OFFSET UNITYSDK_OFFSET(0xD4ABB70)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACECELLWRAPPERMONOVIEW_PLAYDISAPPEARANIMATION_OFFSET UNITYSDK_OFFSET(0xD4ABCA0)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACECELLWRAPPERMONOVIEW_RELEASECELLVIEW_OFFSET UNITYSDK_OFFSET(0xD4AC250)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACECELLWRAPPERMONOVIEW_RELEASE_OFFSET UNITYSDK_OFFSET(0xD4AC1F0)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACECELLWRAPPERMONOVIEW_SET_CELLVIEW_OFFSET UNITYSDK_OFFSET(0xD4ABB60)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACECELLWRAPPERMONOVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xD4AC300)

namespace RPG::Client::LittleGame::CakeRace
{
	inline static constexpr unsigned int CakeRaceCellWrapperMonoView_TypeDefinitionIndex = 77681;
