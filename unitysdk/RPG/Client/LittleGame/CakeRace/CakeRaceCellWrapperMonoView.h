...
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACECELLWRAPPERMONOVIEW_GET_ANIMATION_OFFSET UNITYSDK_OFFSET(0x19B805A0)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACECELLWRAPPERMONOVIEW_GET_CELLVIEW_OFFSET UNITYSDK_OFFSET(0x19B80600)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACECELLWRAPPERMONOVIEW_LOADCELLVIEW_OFFSET UNITYSDK_OFFSET(0x19B80A40)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACECELLWRAPPERMONOVIEW_PLAYAPPEARANIMATION_OFFSET UNITYSDK_OFFSET(0x19B80620)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACECELLWRAPPERMONOVIEW_PLAYDISAPPEARANIMATION_OFFSET UNITYSDK_OFFSET(0x19B80750)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACECELLWRAPPERMONOVIEW_RELEASECELLVIEW_OFFSET UNITYSDK_OFFSET(0x19B80D00)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACECELLWRAPPERMONOVIEW_RELEASE_OFFSET UNITYSDK_OFFSET(0x19B80CA0)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACECELLWRAPPERMONOVIEW_SET_CELLVIEW_OFFSET UNITYSDK_OFFSET(0x19B80610)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACECELLWRAPPERMONOVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x19B80E50)

namespace RPG::Client::LittleGame::CakeRace
{
	inline static constexpr unsigned int CakeRaceCellWrapperMonoView_TypeDefinitionIndex = 74196;
