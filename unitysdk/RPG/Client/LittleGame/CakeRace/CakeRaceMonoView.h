...
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACEMONOVIEW_GETENTITY_OFFSET UNITYSDK_OFFSET(0xD4AD740)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACEMONOVIEW_GET_SHADERCOMP_OFFSET UNITYSDK_OFFSET(0xD4AD380)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACEMONOVIEW_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xD4AD580)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACEMONOVIEW_RELEASE_OFFSET UNITYSDK_OFFSET(0xD4AD6A0)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACEMONOVIEW_SETDITHERWITHANIM_OFFSET UNITYSDK_OFFSET(0xD4AD430)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACEMONOVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xD4AD780)

namespace RPG::Client::LittleGame::CakeRace
{
	inline static constexpr unsigned int CakeRaceMonoView_TypeDefinitionIndex = 77685;
