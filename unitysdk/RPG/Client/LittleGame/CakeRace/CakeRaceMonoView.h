...
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACEMONOVIEW_GETENTITY_OFFSET UNITYSDK_OFFSET(0x99893E0)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACEMONOVIEW_GET_SHADERCOMP_OFFSET UNITYSDK_OFFSET(0x99890C0)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACEMONOVIEW_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x99892D0)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACEMONOVIEW_RELEASE_OFFSET UNITYSDK_OFFSET(0x9987EE0)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACEMONOVIEW_SETDITHERWITHANIM_OFFSET UNITYSDK_OFFSET(0x9989180)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACEMONOVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x9986A70)

namespace RPG::Client::LittleGame::CakeRace
{
	inline static constexpr unsigned int CakeRaceMonoView_TypeDefinitionIndex = 63613;
