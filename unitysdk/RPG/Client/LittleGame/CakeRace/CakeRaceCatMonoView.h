...
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACECATMONOVIEW_GET_CATID_OFFSET UNITYSDK_OFFSET(0x1C4C8950)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACECATMONOVIEW_GET_CINEMACHINEBRAIN_OFFSET UNITYSDK_OFFSET(0x1C4C8970)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACECATMONOVIEW_PLAYEFFECT_OFFSET UNITYSDK_OFFSET(0x1C4C8E90)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACECATMONOVIEW_PLAYROULETTEEFFECT_OFFSET UNITYSDK_OFFSET(0x1C4C8AB0)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACECATMONOVIEW_SETCATID_OFFSET UNITYSDK_OFFSET(0x1C4C8A60)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACECATMONOVIEW_SETCHAMPIONCAMERAACTIVE_OFFSET UNITYSDK_OFFSET(0x1C4C90C0)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACECATMONOVIEW_SET_CATID_OFFSET UNITYSDK_OFFSET(0x1C4C8960)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACECATMONOVIEW_STOPEFFECT_OFFSET UNITYSDK_OFFSET(0x1C4C8F80)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACECATMONOVIEW_TRYADDHOVEREFFECT_OFFSET UNITYSDK_OFFSET(0x1C4C9000)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACECATMONOVIEW_TRYPLAYEFFECT_OFFSET UNITYSDK_OFFSET(0x1C4C8BD0)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACECATMONOVIEW_TRYREMOVEHOVEREFFECT_OFFSET UNITYSDK_OFFSET(0x1C4C9060)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACECATMONOVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4C9170)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACECATMONOVIEW__GETEFFECTCONFIG_OFFSET UNITYSDK_OFFSET(0x1C4C8C40)

namespace RPG::Client::LittleGame::CakeRace
{
	inline static constexpr unsigned int CakeRaceCatMonoView_TypeDefinitionIndex = 77675;
