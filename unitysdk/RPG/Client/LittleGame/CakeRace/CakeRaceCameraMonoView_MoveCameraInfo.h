...
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACECAMERAMONOVIEW_MOVECAMERAINFO_FINISH_OFFSET UNITYSDK_OFFSET(0x99868A0)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACECAMERAMONOVIEW_MOVECAMERAINFO_GET_ISFINISH_OFFSET UNITYSDK_OFFSET(0x9986A90)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACECAMERAMONOVIEW_MOVECAMERAINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x9986AA0)

namespace RPG::Client::LittleGame::CakeRace
{
	inline static constexpr unsigned int CakeRaceCameraMonoView_MoveCameraInfo_TypeDefinitionIndex = 63603;
