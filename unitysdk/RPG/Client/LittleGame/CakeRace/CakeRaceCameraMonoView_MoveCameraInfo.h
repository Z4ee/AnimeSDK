...
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACECAMERAMONOVIEW_MOVECAMERAINFO_FINISH_OFFSET UNITYSDK_OFFSET(0xA677090)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACECAMERAMONOVIEW_MOVECAMERAINFO_GET_ISFINISH_OFFSET UNITYSDK_OFFSET(0xA677280)
#define RPG_CLIENT_LITTLEGAME_CAKERACE_CAKERACECAMERAMONOVIEW_MOVECAMERAINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xA677290)

namespace RPG::Client::LittleGame::CakeRace
{
	inline static constexpr unsigned int CakeRaceCameraMonoView_MoveCameraInfo_TypeDefinitionIndex = 71643;
