...
#define RPG_CLIENT_LITTLEGAME_FLIPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1684EF50)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int FlipConfig_TypeDefinitionIndex = 32792;
