...
#define RPG_CLIENT_LITTLEGAME_FEVERTIMECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1EF9BD70)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int FeverTimeConfig_TypeDefinitionIndex = 41034;
