...
#define RPG_CLIENT_LITTLEGAME_FEVERTIMECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17EF63A0)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int FeverTimeConfig_TypeDefinitionIndex = 38579;
