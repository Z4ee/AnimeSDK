...
#define RPG_CLIENT_LITTLEGAME_FEVERTIMECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C590F40)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int FeverTimeConfig_TypeDefinitionIndex = 40155;
