...
#define RPG_CLIENT_LITTLEGAME_MOVIEBOSSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18CDC210)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int MovieBossConfig_TypeDefinitionIndex = 39342;
