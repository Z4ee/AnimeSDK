...
#define RPG_CLIENT_LITTLEGAME_PRESETGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5944C0)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int PresetGroupConfig_TypeDefinitionIndex = 40162;
