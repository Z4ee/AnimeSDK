...
#define RPG_CLIENT_LITTLEGAME_PRESETGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17EF88C0)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int PresetGroupConfig_TypeDefinitionIndex = 38586;
