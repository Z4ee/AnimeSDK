...
#define RPG_CLIENT_LITTLEGAME_MONOCURVE_EVALUATE_OFFSET UNITYSDK_OFFSET(0x9A31690)
#define RPG_CLIENT_LITTLEGAME_MONOCURVE_GETDISTANCERATIO_OFFSET UNITYSDK_OFFSET(0x9A317F0)
#define RPG_CLIENT_LITTLEGAME_MONOCURVE_GETENTITY_OFFSET UNITYSDK_OFFSET(0x9A312A0)
#define RPG_CLIENT_LITTLEGAME_MONOCURVE_GETLENGTH_OFFSET UNITYSDK_OFFSET(0x9A31760)
#define RPG_CLIENT_LITTLEGAME_MONOCURVE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x9A312E0)
#define RPG_CLIENT_LITTLEGAME_MONOCURVE_METHOD_6_0076C796B2045359_OFFSET UNITYSDK_OFFSET(0x9A31350)
#define RPG_CLIENT_LITTLEGAME_MONOCURVE_METHOD_6_1697A067BDDFE071_OFFSET UNITYSDK_OFFSET(0x9A31A90)
#define RPG_CLIENT_LITTLEGAME_MONOCURVE_METHOD_6_23562D36E99317B6_OFFSET UNITYSDK_OFFSET(0x9A31F10)
#define RPG_CLIENT_LITTLEGAME_MONOCURVE_METHOD_6_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x9A31600)
#define RPG_CLIENT_LITTLEGAME_MONOCURVE_METHOD_6_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x9A31F60)
#define RPG_CLIENT_LITTLEGAME_MONOCURVE_RECALCULATE_OFFSET UNITYSDK_OFFSET(0x9A31950)
#define RPG_CLIENT_LITTLEGAME_MONOCURVE_RELEASE_OFFSET UNITYSDK_OFFSET(0x9A31530)
#define RPG_CLIENT_LITTLEGAME_MONOCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x9A31FA0)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int MonoCurve_TypeDefinitionIndex = 62272;
