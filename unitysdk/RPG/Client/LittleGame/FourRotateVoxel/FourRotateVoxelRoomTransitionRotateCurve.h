...
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELROOMTRANSITIONROTATECURVE_METHOD_6_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x1B1CA3D0)
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELROOMTRANSITIONROTATECURVE_METHOD_6_71BDFB9DD92E722F_OFFSET UNITYSDK_OFFSET(0x1B1CA090)
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELROOMTRANSITIONROTATECURVE_METHOD_6_D2A08F3D951A0C1D_OFFSET UNITYSDK_OFFSET(0x1B1CA430)
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELROOMTRANSITIONROTATECURVE_STARTCURVE_OFFSET UNITYSDK_OFFSET(0x1B1C9B90)
#define RPG_CLIENT_LITTLEGAME_FOURROTATEVOXEL_FOURROTATEVOXELROOMTRANSITIONROTATECURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1CA760)

namespace RPG::Client::LittleGame::FourRotateVoxel
{
	inline static constexpr unsigned int FourRotateVoxelRoomTransitionRotateCurve_TypeDefinitionIndex = 76369;
