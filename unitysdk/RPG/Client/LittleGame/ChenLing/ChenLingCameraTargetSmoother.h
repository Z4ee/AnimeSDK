...
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGCAMERATARGETSMOOTHER_APPLYASPECTFOVONCE_OFFSET UNITYSDK_OFFSET(0x1AC148E0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGCAMERATARGETSMOOTHER_APPLYASPECTFOVTOALLCAMERAS_OFFSET UNITYSDK_OFFSET(0x1AC16060)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGCAMERATARGETSMOOTHER_INITIALIZEIMMEDIATE_OFFSET UNITYSDK_OFFSET(0x1AC14190)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGCAMERATARGETSMOOTHER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC15400)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGCAMERATARGETSMOOTHER_METHOD_5_682FA2F0C959D8A1_OFFSET UNITYSDK_OFFSET(0x1AC15FC0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGCAMERATARGETSMOOTHER_METHOD_5_A3923838734452A7_OFFSET UNITYSDK_OFFSET(0x1AC144F0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGCAMERATARGETSMOOTHER_METHOD_5_BD4E024E91D3F21C_OFFSET UNITYSDK_OFFSET(0x1AC15CE0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGCAMERATARGETSMOOTHER_METHOD_5_C2F48AC549E484D7_OFFSET UNITYSDK_OFFSET(0x1AC14B80)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGCAMERATARGETSMOOTHER_METHOD_5_D0BD1377F2594D33_OFFSET UNITYSDK_OFFSET(0x1AC159E0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGCAMERATARGETSMOOTHER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1AC15390)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGCAMERATARGETSMOOTHER_STARTFINALPUSH_OFFSET UNITYSDK_OFFSET(0x1AC14DE0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGCAMERATARGETSMOOTHER_STOPFINALPUSH_OFFSET UNITYSDK_OFFSET(0x1AC15310)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGCAMERATARGETSMOOTHER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AC16740)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGCAMERATARGETSMOOTHER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC165D0)

namespace RPG::Client::LittleGame::ChenLing
{
	inline static constexpr unsigned int ChenLingCameraTargetSmoother_TypeDefinitionIndex = 77498;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Single>**)Il2CppClass::FromTypeDefinitionIndex(ChenLingCameraTargetSmoother_TypeDefinitionIndex)->GetStaticField(0x5F7B0);
		}
