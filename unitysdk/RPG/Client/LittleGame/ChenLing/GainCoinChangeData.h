...
#define RPG_CLIENT_LITTLEGAME_CHENLING_GAINCOINCHANGEDATA_GET_ANCHORPOSITION_OFFSET UNITYSDK_OFFSET(0x19B926B0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_GAINCOINCHANGEDATA_GET_DELTACOIN_OFFSET UNITYSDK_OFFSET(0x19B926E0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_GAINCOINCHANGEDATA_SET_ANCHORPOSITION_OFFSET UNITYSDK_OFFSET(0x19B926D0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_GAINCOINCHANGEDATA_SET_DELTACOIN_OFFSET UNITYSDK_OFFSET(0x19B926F0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_GAINCOINCHANGEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19B91BC0)

namespace RPG::Client::LittleGame::ChenLing
{
	inline static constexpr unsigned int GainCoinChangeData_TypeDefinitionIndex = 73871;
