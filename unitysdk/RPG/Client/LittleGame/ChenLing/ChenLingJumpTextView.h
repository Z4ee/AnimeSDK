...
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGJUMPTEXTVIEW_SHOWCOIN_OFFSET UNITYSDK_OFFSET(0x19B8C560)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGJUMPTEXTVIEW_SHOW_OFFSET UNITYSDK_OFFSET(0x19B8C030)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGJUMPTEXTVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x19B8C7D0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGJUMPTEXTVIEW__FINDHPCHANGEFORMATTYPEPAIR_OFFSET UNITYSDK_OFFSET(0x19B8C2C0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGJUMPTEXTVIEW__SETPAIRVISIBLE_OFFSET UNITYSDK_OFFSET(0x19B8C350)

namespace RPG::Client::LittleGame::ChenLing
{
	inline static constexpr unsigned int ChenLingJumpTextView_TypeDefinitionIndex = 74017;
