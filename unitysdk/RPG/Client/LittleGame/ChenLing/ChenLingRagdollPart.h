...
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGRAGDOLLPART_CONFIGUREPHYSICS_OFFSET UNITYSDK_OFFSET(0x19B8CF80)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGRAGDOLLPART_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x19B8DBC0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGRAGDOLLPART_METHOD_5_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x19B8D1D0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGRAGDOLLPART_METHOD_5_3845AD389B8E1E47_OFFSET UNITYSDK_OFFSET(0x19B8DF80)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGRAGDOLLPART_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x19B8DE60)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGRAGDOLLPART_METHOD_5_9D5BEBE295BE65D4_OFFSET UNITYSDK_OFFSET(0x19B8D790)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGRAGDOLLPART_METHOD_5_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0x19B8DF20)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGRAGDOLLPART_METHOD_5_E52129E82CD2D7F8_OFFSET UNITYSDK_OFFSET(0x19B8D310)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGRAGDOLLPART_PLAY_OFFSET UNITYSDK_OFFSET(0x19B8D000)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGRAGDOLLPART_RECOVER_OFFSET UNITYSDK_OFFSET(0x19B8D930)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGRAGDOLLPART__CTOR_OFFSET UNITYSDK_OFFSET(0x19B8E1D0)

namespace RPG::Client::LittleGame::ChenLing
{
	inline static constexpr unsigned int ChenLingRagdollPart_TypeDefinitionIndex = 74020;

	class ChenLingRagdollPart : public ::UnityEngine::MonoBehaviour
	{
	public:
		// static const ::System::Single Field_5_0; // 0x0
		::UnityEngine::Rigidbody* Field_5_1; // 0x18
		::UnityEngine::Collider* Field_5_2; // 0x20
		::System::Boolean Field_5_3; // 0x28
		::System::Boolean Field_5_4; // 0x29
		::System::Boolean Field_5_5; // 0x2A
		::UnityEngine::Transform* Field_5_6; // 0x30
		::UnityEngine::Vector3 Field_5_7; // 0x38
		::UnityEngine::Quaternion Field_5_8; // 0x44
		::UnityEngine::Vector3 Field_5_9; // 0x54
		::System::Boolean Field_5_10; // 0x60
		::System::Single Field_5_11; // 0x64
		::System::Single Field_5_12; // 0x68
		::System::Single Field_5_13; // 0x6C
		...
		::Class_1_1342B57709FD7AC5* Field_5_20; // 0x90
