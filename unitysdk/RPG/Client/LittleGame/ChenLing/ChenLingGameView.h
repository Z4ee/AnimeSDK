...
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGGAMEVIEW_GETENTITY_OFFSET UNITYSDK_OFFSET(0xA682F80)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGGAMEVIEW_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xA6829F0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGGAMEVIEW_LITTLEGAMETICK_OFFSET UNITYSDK_OFFSET(0xA682FC0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGGAMEVIEW_METHOD_6_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0xA683020)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGGAMEVIEW_METHOD_6_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xA6830C0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGGAMEVIEW_METHOD_6_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0xA683100)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGGAMEVIEW_METHOD_6_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xA683080)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGGAMEVIEW_REGISTEREFFECTLIFETIME_OFFSET UNITYSDK_OFFSET(0xA683140)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGGAMEVIEW_RELEASEEFFECTBYLIFETIME_OFFSET UNITYSDK_OFFSET(0xA682C80)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGGAMEVIEW_RELEASE_OFFSET UNITYSDK_OFFSET(0xA682B80)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGGAMEVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xA6800B0)

namespace RPG::Client::LittleGame::ChenLing
{
	inline static constexpr unsigned int ChenLingGameView_TypeDefinitionIndex = 71469;
