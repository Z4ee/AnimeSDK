...
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGGAMEVIEW_GETENTITY_OFFSET UNITYSDK_OFFSET(0x19B8BC70)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGGAMEVIEW_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x19B8B5A0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGGAMEVIEW_LITTLEGAMETICK_OFFSET UNITYSDK_OFFSET(0x19B8BCB0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGGAMEVIEW_METHOD_6_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0x19B8BD10)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGGAMEVIEW_METHOD_6_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x19B8BDB0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGGAMEVIEW_METHOD_6_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0x19B8BDF0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGGAMEVIEW_METHOD_6_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x19B8BD70)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGGAMEVIEW_REGISTEREFFECTLIFETIME_OFFSET UNITYSDK_OFFSET(0x19B8BE30)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGGAMEVIEW_RELEASEEFFECTBYLIFETIME_OFFSET UNITYSDK_OFFSET(0x19B8B970)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGGAMEVIEW_RELEASE_OFFSET UNITYSDK_OFFSET(0x19B8B7A0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGGAMEVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x19B88B60)

namespace RPG::Client::LittleGame::ChenLing
{
	inline static constexpr unsigned int ChenLingGameView_TypeDefinitionIndex = 74016;

	class ChenLingGameView : public ::RPG::Client::LittleGame::BaseMonoGenericView
	{
	public:
		::Class_2_2090B77B5C7838F2* Field_6_0; // 0x20
		::Class_3_543326C044264182* Field_6_1; // 0x28
		::Class_2_6B60059019300BAD* Field_6_2; // 0x30
