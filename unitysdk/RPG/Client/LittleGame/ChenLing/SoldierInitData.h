...
#define RPG_CLIENT_LITTLEGAME_CHENLING_SOLDIERINITDATA_GET_ISALLY_OFFSET UNITYSDK_OFFSET(0xBDD3FB0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_SOLDIERINITDATA_GET_MAXHP_OFFSET UNITYSDK_OFFSET(0xBDD3F90)
#define RPG_CLIENT_LITTLEGAME_CHENLING_SOLDIERINITDATA_GET_ROOTTRANSFORM_OFFSET UNITYSDK_OFFSET(0xBDD3FD0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_SOLDIERINITDATA_GET_UID_OFFSET UNITYSDK_OFFSET(0xBDD3F70)
#define RPG_CLIENT_LITTLEGAME_CHENLING_SOLDIERINITDATA_SET_ISALLY_OFFSET UNITYSDK_OFFSET(0xBDD3FC0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_SOLDIERINITDATA_SET_MAXHP_OFFSET UNITYSDK_OFFSET(0xBDD3FA0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_SOLDIERINITDATA_SET_ROOTTRANSFORM_OFFSET UNITYSDK_OFFSET(0xBDD3FE0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_SOLDIERINITDATA_SET_UID_OFFSET UNITYSDK_OFFSET(0xBDD3F80)
#define RPG_CLIENT_LITTLEGAME_CHENLING_SOLDIERINITDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBDD37B0)

namespace RPG::Client::LittleGame::ChenLing
{
	inline static constexpr unsigned int SoldierInitData_TypeDefinitionIndex = 72348;
