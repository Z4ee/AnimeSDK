...
#define RPG_CLIENT_LITTLEGAME_CHENLING_SOLDIERINITDATA_GET_ISALLY_OFFSET UNITYSDK_OFFSET(0x19B92810)
#define RPG_CLIENT_LITTLEGAME_CHENLING_SOLDIERINITDATA_GET_MAXHP_OFFSET UNITYSDK_OFFSET(0x19B927F0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_SOLDIERINITDATA_GET_ROOTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x19B92830)
#define RPG_CLIENT_LITTLEGAME_CHENLING_SOLDIERINITDATA_GET_UID_OFFSET UNITYSDK_OFFSET(0x19B927D0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_SOLDIERINITDATA_SET_ISALLY_OFFSET UNITYSDK_OFFSET(0x19B92820)
#define RPG_CLIENT_LITTLEGAME_CHENLING_SOLDIERINITDATA_SET_MAXHP_OFFSET UNITYSDK_OFFSET(0x19B92800)
#define RPG_CLIENT_LITTLEGAME_CHENLING_SOLDIERINITDATA_SET_ROOTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x19B92840)
#define RPG_CLIENT_LITTLEGAME_CHENLING_SOLDIERINITDATA_SET_UID_OFFSET UNITYSDK_OFFSET(0x19B927E0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_SOLDIERINITDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19B91F60)

namespace RPG::Client::LittleGame::ChenLing
{
	inline static constexpr unsigned int SoldierInitData_TypeDefinitionIndex = 73873;
