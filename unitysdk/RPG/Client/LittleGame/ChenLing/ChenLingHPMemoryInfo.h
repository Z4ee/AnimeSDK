...
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGHPMEMORYINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16841360)

namespace RPG::Client::LittleGame::ChenLing
{
	inline static constexpr unsigned int ChenLingHPMemoryInfo_TypeDefinitionIndex = 33707;

	class ChenLingHPMemoryInfo : public ::System::Object
	{
	public:
		::RPG::GameCore::FixPoint TotalEnemyHP; // 0x10
