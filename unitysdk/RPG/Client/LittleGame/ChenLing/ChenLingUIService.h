...
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGUISERVICE_GETSOLDIERINITDATA_OFFSET UNITYSDK_OFFSET(0xA689470)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGUISERVICE_NOTIFYARMYNUMBERCHANGE_OFFSET UNITYSDK_OFFSET(0xA687A60)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGUISERVICE_NOTIFYBATTLEFINISHED_OFFSET UNITYSDK_OFFSET(0xA689410)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGUISERVICE_NOTIFYBLOCKCHANGE_OFFSET UNITYSDK_OFFSET(0xA6886F0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGUISERVICE_NOTIFYENTERRAGEMODE_OFFSET UNITYSDK_OFFSET(0xA689340)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGUISERVICE_NOTIFYGAINCOINCHANGE_OFFSET UNITYSDK_OFFSET(0xA688D00)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGUISERVICE_NOTIFYHPCHANGE_OFFSET UNITYSDK_OFFSET(0xA687E10)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGUISERVICE_NOTIFYHPMEMORYCHANGE_OFFSET UNITYSDK_OFFSET(0xA6882E0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGUISERVICE_NOTIFYIMMUNITYCHANGE_OFFSET UNITYSDK_OFFSET(0xA6883A0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGUISERVICE_NOTIFYRTDAMAGECHANGE_OFFSET UNITYSDK_OFFSET(0xA688A40)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGUISERVICE_NOTIFYSHOWTALK_OFFSET UNITYSDK_OFFSET(0xA689920)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGUISERVICE_NOTIFYSHOWTOAST_OFFSET UNITYSDK_OFFSET(0xA6893A0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGUISERVICE_NOTIFYSOLDIERDEAD_OFFSET UNITYSDK_OFFSET(0xA688FF0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGUISERVICE_NOTIFYSOLDIERSPAWNED_OFFSET UNITYSDK_OFFSET(0xA6890A0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGUISERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0xA6879C0)

namespace RPG::Client::LittleGame::ChenLing
{
	inline static constexpr unsigned int ChenLingUIService_TypeDefinitionIndex = 71320;
