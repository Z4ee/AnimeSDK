...
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_APPLYPERFORMANCEFORCE_OFFSET UNITYSDK_OFFSET(0xA685A60)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_GETANIMATIONCURVEBYNAME_OFFSET UNITYSDK_OFFSET(0xA685BE0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_GET_AIRMOTIONCURVE_OFFSET UNITYSDK_OFFSET(0xA685BC0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_GET_DEATHFLYCURVE_OFFSET UNITYSDK_OFFSET(0xA685BD0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_METHOD_7_0D7638DBC93E5002_1_OFFSET UNITYSDK_OFFSET(0xA685940)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_METHOD_7_0D7638DBC93E5002_OFFSET UNITYSDK_OFFSET(0xA685550)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_METHOD_7_229CEF33F0AF9039_OFFSET UNITYSDK_OFFSET(0xA6855A0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_METHOD_7_2D1F8ED8124956FF_OFFSET UNITYSDK_OFFSET(0xA686060)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_METHOD_7_2D52D50D51494A66_OFFSET UNITYSDK_OFFSET(0xA686660)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_METHOD_7_4A86D80F89BDABD3_OFFSET UNITYSDK_OFFSET(0xA6867A0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_METHOD_7_5D85010F084295E6_OFFSET UNITYSDK_OFFSET(0xA686B80)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_METHOD_7_60451B2DE9D371C9_OFFSET UNITYSDK_OFFSET(0xA6874A0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_METHOD_7_8D390BDD6941BEFF_OFFSET UNITYSDK_OFFSET(0xA686430)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_METHOD_7_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xA6875B0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_METHOD_7_A1ADC999CFACEB89_OFFSET UNITYSDK_OFFSET(0xA685810)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_METHOD_7_A1C464B05BB7A5C1_OFFSET UNITYSDK_OFFSET(0xA6862F0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_METHOD_7_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xA687940)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_METHOD_7_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xA687900)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_METHOD_7_F1BFC2CD2ECE3431_OFFSET UNITYSDK_OFFSET(0xA687370)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_SETCHENLINGAUDIOGROUP_OFFSET UNITYSDK_OFFSET(0xA687720)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_START_OFFSET UNITYSDK_OFFSET(0xA685990)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_TRIGGERDEATHEFFECT_OFFSET UNITYSDK_OFFSET(0xA685CD0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xA687880)

namespace RPG::Client::LittleGame::ChenLing
{
	inline static constexpr unsigned int ChenLingSoldierView_TypeDefinitionIndex = 71474;
