...
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_APPLYPERFORMANCEFORCE_OFFSET UNITYSDK_OFFSET(0x1AC1E730)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_GETANIMATIONCURVEBYNAME_OFFSET UNITYSDK_OFFSET(0x1AC1E890)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_GET_AIRMOTIONCURVE_OFFSET UNITYSDK_OFFSET(0x1AC1E870)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_GET_DEATHFLYCURVE_OFFSET UNITYSDK_OFFSET(0x1AC1E880)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_METHOD_7_2C95AFAD0256302F_1_OFFSET UNITYSDK_OFFSET(0x1AC1E5F0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_METHOD_7_2C95AFAD0256302F_OFFSET UNITYSDK_OFFSET(0x1AC1E2C0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_METHOD_7_2D1F8ED8124956FF_OFFSET UNITYSDK_OFFSET(0x1AC1ED50)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_METHOD_7_2D52D50D51494A66_OFFSET UNITYSDK_OFFSET(0x1AC1F340)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_METHOD_7_4A86D80F89BDABD3_OFFSET UNITYSDK_OFFSET(0x1AC1F480)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_METHOD_7_56CE4AFC5339F746_OFFSET UNITYSDK_OFFSET(0x1AC1E5A0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_METHOD_7_5D85010F084295E6_OFFSET UNITYSDK_OFFSET(0x1AC1F910)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_METHOD_7_60451B2DE9D371C9_OFFSET UNITYSDK_OFFSET(0x1AC202E0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_METHOD_7_763B70E1B527E566_OFFSET UNITYSDK_OFFSET(0x1AC1E330)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_METHOD_7_8F59470D29B43916_OFFSET UNITYSDK_OFFSET(0x1AC1F110)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_METHOD_7_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x1AC203F0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_METHOD_7_A1C464B05BB7A5C1_OFFSET UNITYSDK_OFFSET(0x1AC1EFD0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_METHOD_7_F1BFC2CD2ECE3431_OFFSET UNITYSDK_OFFSET(0x1AC201B0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_SETCHENLINGAUDIOGROUP_OFFSET UNITYSDK_OFFSET(0x1AC20480)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_START_OFFSET UNITYSDK_OFFSET(0x1AC1E660)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW_TRIGGERDEATHEFFECT_OFFSET UNITYSDK_OFFSET(0x1AC1E9A0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC205E0)

namespace RPG::Client::LittleGame::ChenLing
{
	inline static constexpr unsigned int ChenLingSoldierView_TypeDefinitionIndex = 77505;
