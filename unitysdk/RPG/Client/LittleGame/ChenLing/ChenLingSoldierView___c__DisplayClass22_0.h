...
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW___C__DISPLAYCLASS22_0__CTOR_OFFSET UNITYSDK_OFFSET(0xBDD02C0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW___C__DISPLAYCLASS22_0__GETANIMATIONCURVEBYNAME_B__0_OFFSET UNITYSDK_OFFSET(0xBDD2010)

namespace RPG::Client::LittleGame::ChenLing
{
	inline static constexpr unsigned int ChenLingSoldierView___c__DisplayClass22_0_TypeDefinitionIndex = 72498;
