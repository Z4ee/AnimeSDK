...
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW___C__DISPLAYCLASS22_0__CTOR_OFFSET UNITYSDK_OFFSET(0x19B8E8E0)
#define RPG_CLIENT_LITTLEGAME_CHENLING_CHENLINGSOLDIERVIEW___C__DISPLAYCLASS22_0__GETANIMATIONCURVEBYNAME_B__0_OFFSET UNITYSDK_OFFSET(0x19B905B0)

namespace RPG::Client::LittleGame::ChenLing
{
	inline static constexpr unsigned int ChenLingSoldierView___c__DisplayClass22_0_TypeDefinitionIndex = 74023;
