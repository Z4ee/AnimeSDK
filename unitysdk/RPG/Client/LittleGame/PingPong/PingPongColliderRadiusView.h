...
#define RPG_CLIENT_LITTLEGAME_PINGPONG_PINGPONGCOLLIDERRADIUSVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x9A38A40)

namespace RPG::Client::LittleGame::PingPong
{
	inline static constexpr unsigned int PingPongColliderRadiusView_TypeDefinitionIndex = 62433;
