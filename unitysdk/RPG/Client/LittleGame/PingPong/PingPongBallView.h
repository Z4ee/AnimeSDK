...
#define RPG_CLIENT_LITTLEGAME_PINGPONG_PINGPONGBALLVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x19AB2200)

namespace RPG::Client::LittleGame::PingPong
{
	inline static constexpr unsigned int PingPongBallView_TypeDefinitionIndex = 72757;
