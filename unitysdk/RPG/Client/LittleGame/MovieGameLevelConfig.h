...
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMELEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C593B00)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int MovieGameLevelConfig_TypeDefinitionIndex = 40163;
