...
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPROP_GETCENTERPOSITION_OFFSET UNITYSDK_OFFSET(0xBE31040)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPROP_INITIALIZEVIEW_OFFSET UNITYSDK_OFFSET(0xBE356B0)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPROP_ONHIT_OFFSET UNITYSDK_OFFSET(0xBE30E10)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPROP_REGISTERLISTENERS_OFFSET UNITYSDK_OFFSET(0xBE358B0)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPROP_RELEASEVIEW_OFFSET UNITYSDK_OFFSET(0xBE357C0)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPROP_SAFESETACTIVE_OFFSET UNITYSDK_OFFSET(0xBE35860)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPROP_SETLOCALROTATION_OFFSET UNITYSDK_OFFSET(0xBE359A0)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPROP_SETPOSITION_OFFSET UNITYSDK_OFFSET(0xBE35910)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPROP__CTOR_OFFSET UNITYSDK_OFFSET(0xBE30DF0)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPROP___IFIXBASEPROXY_GETCENTERPOSITION_OFFSET UNITYSDK_OFFSET(0xBE35A20)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPROP___IFIXBASEPROXY_SAFESETACTIVE_OFFSET UNITYSDK_OFFSET(0xBE35AE0)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPROP___IFIXBASEPROXY_SETLOCALROTATION_OFFSET UNITYSDK_OFFSET(0xBE35BB0)
#define RPG_CLIENT_LITTLEGAME_MOVIEGAMEPROP___IFIXBASEPROXY_SETPOSITION_OFFSET UNITYSDK_OFFSET(0xBE35AF0)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int MovieGameProp_TypeDefinitionIndex = 71187;
