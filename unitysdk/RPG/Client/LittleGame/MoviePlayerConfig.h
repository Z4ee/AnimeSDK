...
#define RPG_CLIENT_LITTLEGAME_MOVIEPLAYERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16850E30)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int MoviePlayerConfig_TypeDefinitionIndex = 32786;
