...
namespace RPG::Client::LittleGame::FiveDim { template <typename T> class BaseLeverSwitchSystem_1_LevelVarCallbackCache; }
...
{
	inline static constexpr unsigned int BaseLeverSwitchSystem_1_TypeDefinitionIndex = 62794;
	...
	public:
		...
		::Entitas::IGroup_1<T>* _LeverSwitchGroup; // 0x0
		::Entitas::ICollector_1<T>* _LeverSwitchCollector; // 0x0
		::RPG::PoolDictionary_2<::System::Int32, ::RPG::Client::LittleGame::FiveDim::BaseLeverSwitchSystem_1_LevelVarCallbackCache<T>*>* _LevelVarCallbackCaches; // 0x0
	};
}
