...
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_PHANTOMPLAYERRECORDFRAMES_RPG_CLIENT_LITTLEGAME_MOVE_MOVESTATE_AUTOGEN__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5914E0)

namespace RPG::Client::LittleGame::FiveDim
{
	inline static constexpr unsigned int PhantomPlayerRecordFrames_RPG_Client_LittleGame_Move_MoveState_AutoGen_TypeDefinitionIndex = 41034;
