...
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEGAMEPADINPUT_ADDINPUTHANDLER_OFFSET UNITYSDK_OFFSET(0x189F0B00)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEGAMEPADINPUT_AWAKE_OFFSET UNITYSDK_OFFSET(0x189F0B50)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEGAMEPADINPUT_UPDATE_OFFSET UNITYSDK_OFFSET(0x189F0D10)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEGAMEPADINPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x189F1720)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEGAMEPADINPUT__GETINCONTROLLEFTSTICKINPUTDIRECTION_OFFSET UNITYSDK_OFFSET(0x189F10C0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEGAMEPADINPUT__GETINPUTINFO_1_OFFSET UNITYSDK_OFFSET(0x189F15A0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEGAMEPADINPUT__GETINPUTINFO_OFFSET UNITYSDK_OFFSET(0x189F14E0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEGAMEPADINPUT__INITVIEW_OFFSET UNITYSDK_OFFSET(0x189F0BA0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEGAMEPADINPUT__TRYINVOKERCALLBACK_OFFSET UNITYSDK_OFFSET(0x189F1470)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEGAMEPADINPUT__UPDATEGAMEPADINPUT_OFFSET UNITYSDK_OFFSET(0x189F0D80)

namespace RPG::Client::LittleGame::FiveDim
{
	inline static constexpr unsigned int FiveDimFluteGamePadInput_TypeDefinitionIndex = 73272;
