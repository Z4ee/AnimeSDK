...
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMDYNAMICJOYSTICK_ADDJOYSTICKDRAGEVENT_OFFSET UNITYSDK_OFFSET(0x1AC3F3E0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMDYNAMICJOYSTICK_ADDJOYSTICKPOINTDOWNEVENT_OFFSET UNITYSDK_OFFSET(0x1AC3F2E0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMDYNAMICJOYSTICK_ADDJOYSTICKPOINTUPEVENT_OFFSET UNITYSDK_OFFSET(0x1AC3F360)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMDYNAMICJOYSTICK_AWAKE_OFFSET UNITYSDK_OFFSET(0x1AC3E430)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMDYNAMICJOYSTICK_DESPAWNED_OFFSET UNITYSDK_OFFSET(0x1AC3EA80)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMDYNAMICJOYSTICK_GETNORMALIZEDDISTANCE_OFFSET UNITYSDK_OFFSET(0x1AC3F280)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMDYNAMICJOYSTICK_GETUIANGLE_OFFSET UNITYSDK_OFFSET(0x1AC3F230)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMDYNAMICJOYSTICK_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1AC3E4E0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMDYNAMICJOYSTICK_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1AC3E490)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMDYNAMICJOYSTICK_ONDRAG_OFFSET UNITYSDK_OFFSET(0x1AC3E050)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMDYNAMICJOYSTICK_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x1AC3E0A0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMDYNAMICJOYSTICK_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0x1AC3DF40)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMDYNAMICJOYSTICK_SPAWNED_OFFSET UNITYSDK_OFFSET(0x1AC3E380)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMDYNAMICJOYSTICK__CLEARALLEVENTS_OFFSET UNITYSDK_OFFSET(0x1AC3EAD0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMDYNAMICJOYSTICK__COMPUTEDRAGINFO_OFFSET UNITYSDK_OFFSET(0x1AC3E580)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMDYNAMICJOYSTICK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC3F480)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMDYNAMICJOYSTICK__GETWORLDPOSITIONFROMPOINTEREVENT_OFFSET UNITYSDK_OFFSET(0x1AC3E1D0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMDYNAMICJOYSTICK__INITVIEW_OFFSET UNITYSDK_OFFSET(0x1AC3EC00)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMDYNAMICJOYSTICK__INIT_OFFSET UNITYSDK_OFFSET(0x1AC3E3E0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMDYNAMICJOYSTICK__ONRELEASE_OFFSET UNITYSDK_OFFSET(0x1AC3DFB0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMDYNAMICJOYSTICK__UPDATEPRESSDRAGHINT_OFFSET UNITYSDK_OFFSET(0x1AC3E680)

namespace RPG::Client::LittleGame::FiveDim
{
	inline static constexpr unsigned int FiveDimDynamicJoyStick_TypeDefinitionIndex = 76747;
