...
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFIXEDUPDATEPROXYVIEW_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x189EDC70)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFIXEDUPDATEPROXYVIEW_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x189ED990)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFIXEDUPDATEPROXYVIEW_METHOD_7_5AFFA079DA8B20AA_OFFSET UNITYSDK_OFFSET(0x189EDB40)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFIXEDUPDATEPROXYVIEW_METHOD_7_A5D032209732E69F_OFFSET UNITYSDK_OFFSET(0x189EDD50)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFIXEDUPDATEPROXYVIEW_RELEASE_OFFSET UNITYSDK_OFFSET(0x189EDBA0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFIXEDUPDATEPROXYVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x189EDDD0)

namespace RPG::Client::LittleGame::FiveDim
{
	inline static constexpr unsigned int FiveDimFixedUpdateProxyView_TypeDefinitionIndex = 73227;
