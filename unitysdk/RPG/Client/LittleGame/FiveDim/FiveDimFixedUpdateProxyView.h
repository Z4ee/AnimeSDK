...
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFIXEDUPDATEPROXYVIEW_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0xD4DE700)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFIXEDUPDATEPROXYVIEW_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xD4DE3F0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFIXEDUPDATEPROXYVIEW_METHOD_7_5AFFA079DA8B20AA_OFFSET UNITYSDK_OFFSET(0xD4DE5A0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFIXEDUPDATEPROXYVIEW_METHOD_7_A5D032209732E69F_OFFSET UNITYSDK_OFFSET(0xD4DE7E0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFIXEDUPDATEPROXYVIEW_RELEASE_OFFSET UNITYSDK_OFFSET(0xD4DE600)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFIXEDUPDATEPROXYVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xD4DE860)

namespace RPG::Client::LittleGame::FiveDim
{
	inline static constexpr unsigned int FiveDimFixedUpdateProxyView_TypeDefinitionIndex = 76704;
