...
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAPCINPUT_METHOD_5_09FE42768C6D9433_OFFSET UNITYSDK_OFFSET(0x1B1B6CF0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAPCINPUT_METHOD_5_EAD49BE374ABF145_1_OFFSET UNITYSDK_OFFSET(0x1B1B6D90)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAPCINPUT_METHOD_5_EAD49BE374ABF145_OFFSET UNITYSDK_OFFSET(0x1B1B6C80)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAPCINPUT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B1B6DF0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAPCINPUT_START_OFFSET UNITYSDK_OFFSET(0x1B1B69A0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAPCINPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1B70D0)

namespace RPG::Client::LittleGame::FiveDim
{
	inline static constexpr unsigned int MonoFiveDimCameraPCInput_TypeDefinitionIndex = 76762;

	class MonoFiveDimCameraPCInput : public ::UnityEngine::MonoBehaviour
	{
	public:
		::System::Boolean MBOOCACELEJ; // 0x18
