...
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMKEYBOARDDASHHELPER_FETCHMOUSEAXISDELTA_OFFSET UNITYSDK_OFFSET(0xD4EB9D0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMKEYBOARDDASHHELPER_GET_MOUSEX_OFFSET UNITYSDK_OFFSET(0xD4EB990)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMKEYBOARDDASHHELPER_GET_MOUSEY_OFFSET UNITYSDK_OFFSET(0xD4EB9B0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMKEYBOARDDASHHELPER_SET_MOUSEX_OFFSET UNITYSDK_OFFSET(0xD4EB9A0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMKEYBOARDDASHHELPER_SET_MOUSEY_OFFSET UNITYSDK_OFFSET(0xD4EB9C0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMKEYBOARDDASHHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0xD4EBA30)

namespace RPG::Client::LittleGame::FiveDim
{
	inline static constexpr unsigned int FiveDimKeyboardDashHelper_TypeDefinitionIndex = 76739;
