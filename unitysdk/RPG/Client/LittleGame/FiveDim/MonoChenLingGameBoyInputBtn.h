...
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOCHENLINGGAMEBOYINPUTBTN_ADDINPUTHANDLER_OFFSET UNITYSDK_OFFSET(0x18A0A050)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOCHENLINGGAMEBOYINPUTBTN_AWAKE_OFFSET UNITYSDK_OFFSET(0x18A0A0A0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOCHENLINGGAMEBOYINPUTBTN_UPDATE_OFFSET UNITYSDK_OFFSET(0x18A0A0E0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOCHENLINGGAMEBOYINPUTBTN__CTOR_OFFSET UNITYSDK_OFFSET(0x18A0AA90)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOCHENLINGGAMEBOYINPUTBTN__GETINCONTROLLEFTSTICKINPUTDIRECTION_OFFSET UNITYSDK_OFFSET(0x18A0A3E0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOCHENLINGGAMEBOYINPUTBTN__GETINPUTINFO_1_OFFSET UNITYSDK_OFFSET(0x18A0A900)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOCHENLINGGAMEBOYINPUTBTN__GETINPUTINFO_OFFSET UNITYSDK_OFFSET(0x18A0A820)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOCHENLINGGAMEBOYINPUTBTN__TRYINVOKERCALLBACK_OFFSET UNITYSDK_OFFSET(0x18A0A790)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOCHENLINGGAMEBOYINPUTBTN__UPDATEGAMEPADINPUT_OFFSET UNITYSDK_OFFSET(0x18A0A150)

namespace RPG::Client::LittleGame::FiveDim
{
	inline static constexpr unsigned int MonoChenLingGameBoyInputBtn_TypeDefinitionIndex = 73280;
