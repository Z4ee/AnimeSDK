...
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEDATAGROUP_ADDFLUTEDATA_OFFSET UNITYSDK_OFFSET(0x1AC448F0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEDATAGROUP_CREATE_OFFSET UNITYSDK_OFFSET(0x1AC447E0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEDATAGROUP_GETFLUTEDATALIST_OFFSET UNITYSDK_OFFSET(0x1AC44AE0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEDATAGROUP_GET_FLOORID_OFFSET UNITYSDK_OFFSET(0x1AC449D0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEDATAGROUP_GET_FLORNAME_OFFSET UNITYSDK_OFFSET(0x1AC449F0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEDATAGROUP_SET_FLOORID_OFFSET UNITYSDK_OFFSET(0x1AC449E0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEDATAGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC448A0)

namespace RPG::Client::LittleGame::FiveDim
{
	inline static constexpr unsigned int FiveDimFluteDataGroup_TypeDefinitionIndex = 76740;
