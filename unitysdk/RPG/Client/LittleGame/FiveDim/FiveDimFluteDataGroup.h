...
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEDATAGROUP_ADDFLUTEDATA_OFFSET UNITYSDK_OFFSET(0xBDF87C0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEDATAGROUP_CREATE_OFFSET UNITYSDK_OFFSET(0xBDF86B0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEDATAGROUP_GETFLUTEDATALIST_OFFSET UNITYSDK_OFFSET(0xBDF89B0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEDATAGROUP_GET_FLOORID_OFFSET UNITYSDK_OFFSET(0xBDF88A0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEDATAGROUP_GET_FLORNAME_OFFSET UNITYSDK_OFFSET(0xBDF88C0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEDATAGROUP_SET_FLOORID_OFFSET UNITYSDK_OFFSET(0xBDF88B0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEDATAGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0xBDF8770)

namespace RPG::Client::LittleGame::FiveDim
{
	inline static constexpr unsigned int FiveDimFluteDataGroup_TypeDefinitionIndex = 71737;
