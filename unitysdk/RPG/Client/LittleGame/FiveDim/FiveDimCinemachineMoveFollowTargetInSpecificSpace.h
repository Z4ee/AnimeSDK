...
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMCINEMACHINEMOVEFOLLOWTARGETINSPECIFICSPACE_POSTPIPELINESTAGECALLBACK_OFFSET UNITYSDK_OFFSET(0x99AC000)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMCINEMACHINEMOVEFOLLOWTARGETINSPECIFICSPACE_PREPIPELINEMUTATECAMERASTATECALLBACK_OFFSET UNITYSDK_OFFSET(0x99ABAC0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMCINEMACHINEMOVEFOLLOWTARGETINSPECIFICSPACE_SETDAMPTARGETSPACE_OFFSET UNITYSDK_OFFSET(0x99AB8F0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMCINEMACHINEMOVEFOLLOWTARGETINSPECIFICSPACE_SETFOLLOWDAMPENTITYMOVE_OFFSET UNITYSDK_OFFSET(0x99ABA20)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMCINEMACHINEMOVEFOLLOWTARGETINSPECIFICSPACE__CTOR_OFFSET UNITYSDK_OFFSET(0x99AC290)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMCINEMACHINEMOVEFOLLOWTARGETINSPECIFICSPACE___IFIXBASEPROXY_PREPIPELINEMUTATECAMERASTATECALLBACK_OFFSET UNITYSDK_OFFSET(0x99AC2A0)

namespace RPG::Client::LittleGame::FiveDim
{
	inline static constexpr unsigned int FiveDimCinemachineMoveFollowTargetInSpecificSpace_TypeDefinitionIndex = 62559;
