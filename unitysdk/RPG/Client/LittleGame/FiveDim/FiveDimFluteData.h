...
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEDATA_CREATE_1_OFFSET UNITYSDK_OFFSET(0xD4DF9C0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xD4DF930)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEDATA_GET_AUTOPLAYCHANGEGPFAILTEXTMAPKEY_OFFSET UNITYSDK_OFFSET(0xD4DFC60)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEDATA_GET_CODE_OFFSET UNITYSDK_OFFSET(0xD4DFA20)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEDATA_GET_FLOORID_OFFSET UNITYSDK_OFFSET(0xD4DFAC0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0xD4DFA70)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEDATA_GET_TELEAREANAME_OFFSET UNITYSDK_OFFSET(0xD4DFBF0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEDATA_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xD4DFCD0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEDATA_ISVALIDCONTENTID_OFFSET UNITYSDK_OFFSET(0xD4DFB50)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMFLUTEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD4DF920)

namespace RPG::Client::LittleGame::FiveDim
{
	inline static constexpr unsigned int FiveDimFluteData_TypeDefinitionIndex = 76740;
