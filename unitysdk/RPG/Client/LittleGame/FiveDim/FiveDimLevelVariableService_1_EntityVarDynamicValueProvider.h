...
{
	inline static constexpr unsigned int FiveDimLevelVariableService_1_EntityVarDynamicValueProvider_TypeDefinitionIndex = 71415;

	template <typename TEntity>
	class FiveDimLevelVariableService_1_EntityVarDynamicValueProvider : public ::System::Object
	{
	public:
		::Class_1_F431D4103CAD3F1C* _LevelVariableCollection; // 0x0
