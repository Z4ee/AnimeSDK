...
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMMISSILEVIEW_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x9A0BAC0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMMISSILEVIEW_RELEASE_OFFSET UNITYSDK_OFFSET(0x9A0BE30)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMMISSILEVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x9A0BF20)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMMISSILEVIEW___IFIXBASEPROXY_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x9A0BF40)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMMISSILEVIEW___IFIXBASEPROXY_RELEASE_OFFSET UNITYSDK_OFFSET(0x9A0BF50)

namespace RPG::Client::LittleGame::FiveDim
{
	inline static constexpr unsigned int FiveDimMissileView_TypeDefinitionIndex = 62855;

	class FiveDimMissileView : public ::RPG::Client::LittleGame::FiveDim::FiveDimPropView
	{
	public:
		::UnityEngine::CapsuleCollider* MissileCollider; // 0x1C0
		::UnityEngine::Vector2 Field_8_1; // 0x1C8
		::UnityEngine::Vector3 Field_8_2; // 0x1D0
		::System::Boolean Field_8_3; // 0x1DC
