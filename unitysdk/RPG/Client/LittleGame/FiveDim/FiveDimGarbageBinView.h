...
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMGARBAGEBINVIEW_GETVIEWBOUND_OFFSET UNITYSDK_OFFSET(0x1AC49680)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMGARBAGEBINVIEW_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1AC490A0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMGARBAGEBINVIEW_METHOD_8_175872DEECEEDC6A_OFFSET UNITYSDK_OFFSET(0x1AC49280)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMGARBAGEBINVIEW_METHOD_8_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0x1AC497C0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMGARBAGEBINVIEW_RELEASE_OFFSET UNITYSDK_OFFSET(0x1AC49460)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMGARBAGEBINVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC498B0)

namespace RPG::Client::LittleGame::FiveDim
{
	inline static constexpr unsigned int FiveDimGarbageBinView_TypeDefinitionIndex = 76705;

	class FiveDimGarbageBinView : public ::RPG::Client::LittleGame::FiveDim::FiveDimPropView
	{
	public:
		::UnityEngine::BoxCollider* GarbageBinMainCollider; // 0x208
		::UnityEngine::Vector3 EIKLCFAGEKP; // 0x210
		::UnityEngine::Vector3 EJLBICDOEPN; // 0x21C
		::System::Boolean OHAAJDGJPMJ; // 0x228
