...
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAJOYSTICK_AWAKE_OFFSET UNITYSDK_OFFSET(0xA6C4E10)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAJOYSTICK_GET__CENTERPOS_OFFSET UNITYSDK_OFFSET(0xA6C59E0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAJOYSTICK_GET__MAXRADIUS_OFFSET UNITYSDK_OFFSET(0xA6C5AE0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAJOYSTICK_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xA6C4F20)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAJOYSTICK_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xA6C4EC0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAJOYSTICK_ONDRAG_OFFSET UNITYSDK_OFFSET(0xA6C4D80)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAJOYSTICK_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0xA6C4C30)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAJOYSTICK_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0xA6C4CB0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAJOYSTICK_SPAWNED_OFFSET UNITYSDK_OFFSET(0xA6C4DD0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAJOYSTICK__CTOR_OFFSET UNITYSDK_OFFSET(0xA6C5CB0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAJOYSTICK__ENDJOYCAMERAOBSERVE_OFFSET UNITYSDK_OFFSET(0xA6C4D00)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAJOYSTICK__GETMOVEDIR_OFFSET UNITYSDK_OFFSET(0xA6C5400)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAJOYSTICK__INITVIEW_OFFSET UNITYSDK_OFFSET(0xA6C5500)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAJOYSTICK__INIT_OFFSET UNITYSDK_OFFSET(0xA6C4E70)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MONOFIVEDIMCAMERAJOYSTICK__SETNODEPOSBYSCREENPOS_OFFSET UNITYSDK_OFFSET(0xA6C4FB0)

namespace RPG::Client::LittleGame::FiveDim
{
	inline static constexpr unsigned int MonoFiveDimCameraJoyStick_TypeDefinitionIndex = 70936;
