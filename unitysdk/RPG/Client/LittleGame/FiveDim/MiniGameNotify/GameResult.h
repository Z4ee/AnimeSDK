...
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MINIGAMENOTIFY_GAMERESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x18A09FC0)

namespace RPG::Client::LittleGame::FiveDim::MiniGameNotify
{
	inline static constexpr unsigned int GameResult_TypeDefinitionIndex = 73296;
	...
	public:
		...
		::System::Single ScoreMultiplier; // 0x20
		::System::UInt32 TimeInSeconds; // 0x24
		::System::UInt32 TotalScore; // 0x28
		::System::UInt32 CoinScore; // 0x2C
		::System::Boolean IsMaxScore; // 0x30
		::System::UInt32 CoinNum; // 0x34
