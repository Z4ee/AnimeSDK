...
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_MINIGAMENOTIFY_GAMERESULT__CTOR_OFFSET UNITYSDK_OFFSET(0xBE145B0)

namespace RPG::Client::LittleGame::FiveDim::MiniGameNotify
{
	inline static constexpr unsigned int GameResult_TypeDefinitionIndex = 71771;
	...
	public:
		...
		::System::Boolean IsMaxScore; // 0x2C
		::System::UInt32 CoinScore; // 0x30
