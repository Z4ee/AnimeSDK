...
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMMISSILEPHYSICSPROXYVIEW_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xD4EBE50)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMMISSILEPHYSICSPROXYVIEW_METHOD_8_45FED451D133E002_OFFSET UNITYSDK_OFFSET(0xD4ECD80)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMMISSILEPHYSICSPROXYVIEW_METHOD_8_66F42CE2EDA79734_OFFSET UNITYSDK_OFFSET(0xD4EBB20)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMMISSILEPHYSICSPROXYVIEW_METHOD_8_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xD4EC5E0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMMISSILEPHYSICSPROXYVIEW_METHOD_8_C6C00AC7D323B1B0_OFFSET UNITYSDK_OFFSET(0xD4ECC10)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMMISSILEPHYSICSPROXYVIEW_RELEASE_OFFSET UNITYSDK_OFFSET(0xD4EC4F0)
#define RPG_CLIENT_LITTLEGAME_FIVEDIM_FIVEDIMMISSILEPHYSICSPROXYVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xD4ECE30)

namespace RPG::Client::LittleGame::FiveDim
{
	inline static constexpr unsigned int FiveDimMissilePhysicsProxyView_TypeDefinitionIndex = 76733;
