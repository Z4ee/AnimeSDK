...
#define RPG_CLIENT_LITTLEGAME_ACTIONGROUPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C48A390)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int ActionGroupConfig_TypeDefinitionIndex = 41044;
