...
#define RPG_CLIENT_LITTLEGAME_TIMELINECONTROLGAMEWORLD_LEVELGROUPACTION_MOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EF9ECE0)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int TimelineControlGameWorld_LevelGroupAction_Move_TypeDefinitionIndex = 41233;
