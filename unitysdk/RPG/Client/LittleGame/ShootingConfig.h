...
#define RPG_CLIENT_LITTLEGAME_SHOOTINGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17EF88D0)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int ShootingConfig_TypeDefinitionIndex = 38581;
