...
#define RPG_CLIENT_LITTLEGAME_SHOOTINGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16850E90)

namespace RPG::Client::LittleGame
{
	inline static constexpr unsigned int ShootingConfig_TypeDefinitionIndex = 32791;
