...
namespace RPG::Client::LittleGame::PixAir
{
	...
	{
	public:
		::System::Int32 ToEquipRuntimeUniqueID; // 0x10
		::System::Int32 FromEquipRuntimeUniqueID; // 0x14
		::RPG::Client::LittleGame::PixAir::PixAirEquipInteractionType InteractionType; // 0x18
		::System::Int32 FromEquipID; // 0x1C
		::System::Int32 ToEquipID; // 0x20
