...
#define RPG_CLIENT_LITTLEGAME_PIXAIR_BASEPIXAIRVIEW_ADD_DESTROYED_OFFSET UNITYSDK_OFFSET(0x1B1D8030)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_BASEPIXAIRVIEW_BINDMESSAGE_OFFSET UNITYSDK_OFFSET(0x1B1D82C0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_BASEPIXAIRVIEW_BIND_OFFSET UNITYSDK_OFFSET(0x1B1D8310)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_BASEPIXAIRVIEW_DESTROYVIEWONLY_OFFSET UNITYSDK_OFFSET(0x1B1D8350)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_BASEPIXAIRVIEW_GETROOT_OFFSET UNITYSDK_OFFSET(0x1B1D8130)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_BASEPIXAIRVIEW_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1B1D8180)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_BASEPIXAIRVIEW_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1B1D8280)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_BASEPIXAIRVIEW_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B1D83D0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_BASEPIXAIRVIEW_REMOVE_DESTROYED_OFFSET UNITYSDK_OFFSET(0x1B1D80B0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_BASEPIXAIRVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1D8430)

namespace RPG::Client::LittleGame::PixAir
{
	inline static constexpr unsigned int BasePixAirView_TypeDefinitionIndex = 76845;
