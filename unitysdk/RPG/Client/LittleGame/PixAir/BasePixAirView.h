...
#define RPG_CLIENT_LITTLEGAME_PIXAIR_BASEPIXAIRVIEW_ADD_DESTROYED_OFFSET UNITYSDK_OFFSET(0x19AB2570)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_BASEPIXAIRVIEW_BINDMESSAGE_OFFSET UNITYSDK_OFFSET(0x19AB2800)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_BASEPIXAIRVIEW_BIND_OFFSET UNITYSDK_OFFSET(0x19AB2850)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_BASEPIXAIRVIEW_DESTROYVIEWONLY_OFFSET UNITYSDK_OFFSET(0x19AB2890)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_BASEPIXAIRVIEW_GETROOT_OFFSET UNITYSDK_OFFSET(0x19AB2670)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_BASEPIXAIRVIEW_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x19AB26C0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_BASEPIXAIRVIEW_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x19AB27C0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_BASEPIXAIRVIEW_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x19AB2910)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_BASEPIXAIRVIEW_REMOVE_DESTROYED_OFFSET UNITYSDK_OFFSET(0x19AB25F0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_BASEPIXAIRVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x19AB2970)

namespace RPG::Client::LittleGame::PixAir
{
	inline static constexpr unsigned int BasePixAirView_TypeDefinitionIndex = 73366;
