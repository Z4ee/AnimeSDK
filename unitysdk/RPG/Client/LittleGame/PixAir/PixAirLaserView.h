...
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLASERVIEW_DESTROYVIEWONLY_OFFSET UNITYSDK_OFFSET(0xD54BA40)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLASERVIEW_FIRE_OFFSET UNITYSDK_OFFSET(0xD54AD40)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLASERVIEW_METHOD_6_045F1AAB54606068_OFFSET UNITYSDK_OFFSET(0xD54B8E0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLASERVIEW_METHOD_6_06010EBCDC42137E_OFFSET UNITYSDK_OFFSET(0xD54B400)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLASERVIEW_METHOD_6_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0xD54B820)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLASERVIEW_METHOD_6_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xD54B190)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLASERVIEW_METHOD_6_556718862C234099_1_OFFSET UNITYSDK_OFFSET(0xD54B390)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLASERVIEW_METHOD_6_556718862C234099_2_OFFSET UNITYSDK_OFFSET(0xD54B580)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLASERVIEW_METHOD_6_556718862C234099_OFFSET UNITYSDK_OFFSET(0xD54B240)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLASERVIEW_METHOD_6_7DEB74453EA11388_OFFSET UNITYSDK_OFFSET(0xD54AF00)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLASERVIEW_METHOD_6_B326214F403C3638_OFFSET UNITYSDK_OFFSET(0xD54BAE0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLASERVIEW_METHOD_6_C43C36081A4D4A3D_OFFSET UNITYSDK_OFFSET(0xD54B5E0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLASERVIEW_METHOD_6_D7CE655458A04FD8_OFFSET UNITYSDK_OFFSET(0xD54B2A0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLASERVIEW_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xD54B100)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLASERVIEW_UPDATE_OFFSET UNITYSDK_OFFSET(0xD54B880)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLASERVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xD54BC30)

namespace RPG::Client::LittleGame::PixAir
{
	inline static constexpr unsigned int PixAirLaserView_TypeDefinitionIndex = 76850;
