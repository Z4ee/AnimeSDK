...
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLASERVIEW_DESTROYVIEWONLY_OFFSET UNITYSDK_OFFSET(0x19ABC5E0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLASERVIEW_FIRE_OFFSET UNITYSDK_OFFSET(0x19ABB8E0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLASERVIEW_METHOD_6_045F1AAB54606068_OFFSET UNITYSDK_OFFSET(0x19ABC480)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLASERVIEW_METHOD_6_06010EBCDC42137E_OFFSET UNITYSDK_OFFSET(0x19ABBFA0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLASERVIEW_METHOD_6_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x19ABC3C0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLASERVIEW_METHOD_6_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x19ABBD30)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLASERVIEW_METHOD_6_556718862C234099_1_OFFSET UNITYSDK_OFFSET(0x19ABBF30)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLASERVIEW_METHOD_6_556718862C234099_2_OFFSET UNITYSDK_OFFSET(0x19ABC120)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLASERVIEW_METHOD_6_556718862C234099_OFFSET UNITYSDK_OFFSET(0x19ABBDE0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLASERVIEW_METHOD_6_7DEB74453EA11388_OFFSET UNITYSDK_OFFSET(0x19ABBAA0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLASERVIEW_METHOD_6_B326214F403C3638_OFFSET UNITYSDK_OFFSET(0x19ABC680)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLASERVIEW_METHOD_6_C43C36081A4D4A3D_OFFSET UNITYSDK_OFFSET(0x19ABC180)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLASERVIEW_METHOD_6_D7CE655458A04FD8_OFFSET UNITYSDK_OFFSET(0x19ABBE40)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLASERVIEW_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x19ABBCA0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLASERVIEW_UPDATE_OFFSET UNITYSDK_OFFSET(0x19ABC420)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLASERVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x19ABC7D0)

namespace RPG::Client::LittleGame::PixAir
{
	inline static constexpr unsigned int PixAirLaserView_TypeDefinitionIndex = 73370;
