...
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRPLANESTATISTICS___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x18CDCB50)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRPLANESTATISTICS___C__CTOR_OFFSET UNITYSDK_OFFSET(0x18CDCB90)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRPLANESTATISTICS___C__GETEQUIPSTATSSORTEDBYUSECOUNT_B__7_0_OFFSET UNITYSDK_OFFSET(0x18CDCBA0)
...
namespace RPG::Client::LittleGame::PixAir
{
	...
	public:
		...
		{
			return (::System::Comparison_1<::RPG::Client::LittleGame::PixAir::PixAirEquipStatistics*>**)Il2CppClass::FromTypeDefinitionIndex(PixAirPlaneStatistics___c_TypeDefinitionIndex)->GetStaticField(0x4DBC0);
		}
		static ::RPG::Client::LittleGame::PixAir::PixAirPlaneStatistics___c** StaticGet___9()
		{
			return (::RPG::Client::LittleGame::PixAir::PixAirPlaneStatistics___c**)Il2CppClass::FromTypeDefinitionIndex(PixAirPlaneStatistics___c_TypeDefinitionIndex)->GetStaticField(0x4DBC8);
		}
