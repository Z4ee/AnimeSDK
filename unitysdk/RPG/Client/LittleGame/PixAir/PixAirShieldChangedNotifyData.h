...
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRSHIELDCHANGEDNOTIFYDATA_GET_CHANGEVALUE_OFFSET UNITYSDK_OFFSET(0xBE46480)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRSHIELDCHANGEDNOTIFYDATA_GET_ISADD_OFFSET UNITYSDK_OFFSET(0xBE46490)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRSHIELDCHANGEDNOTIFYDATA_GET_MAXHP_OFFSET UNITYSDK_OFFSET(0xBE46470)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRSHIELDCHANGEDNOTIFYDATA_GET_NEWSHIELD_OFFSET UNITYSDK_OFFSET(0xBE46460)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRSHIELDCHANGEDNOTIFYDATA_GET_RUNTIMEID_OFFSET UNITYSDK_OFFSET(0xBE46450)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRSHIELDCHANGEDNOTIFYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBE464A0)

namespace RPG::Client::LittleGame::PixAir
{
	inline static constexpr unsigned int PixAirShieldChangedNotifyData_TypeDefinitionIndex = 71832;

	class PixAirShieldChangedNotifyData : public ::System::Object
	{
	public:
		::System::Int32 _ChangeValue_k__BackingField; // 0x10
		::System::Int32 _NewShield_k__BackingField; // 0x14
