...
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRSHIELDCHANGEDNOTIFYDATA_GET_CHANGEVALUE_OFFSET UNITYSDK_OFFSET(0xD5512D0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRSHIELDCHANGEDNOTIFYDATA_GET_ISADD_OFFSET UNITYSDK_OFFSET(0xD5512E0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRSHIELDCHANGEDNOTIFYDATA_GET_MAXHP_OFFSET UNITYSDK_OFFSET(0xD5512C0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRSHIELDCHANGEDNOTIFYDATA_GET_NEWSHIELD_OFFSET UNITYSDK_OFFSET(0xD5512B0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRSHIELDCHANGEDNOTIFYDATA_GET_RUNTIMEID_OFFSET UNITYSDK_OFFSET(0xD5512A0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRSHIELDCHANGEDNOTIFYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD5512F0)

namespace RPG::Client::LittleGame::PixAir
{
	inline static constexpr unsigned int PixAirShieldChangedNotifyData_TypeDefinitionIndex = 76837;
	...
	public:
		...
		::System::Boolean _IsAdd_k__BackingField; // 0x1C
