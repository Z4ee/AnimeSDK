...
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_BINDENEMYPLANE_OFFSET UNITYSDK_OFFSET(0x19ABB490)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_BINDPLAYERPLANE_OFFSET UNITYSDK_OFFSET(0x19ABAF50)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_GET_ENEMYPLANEFOLLOWTARGET_OFFSET UNITYSDK_OFFSET(0x19ABDD20)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_INITFORLOADING_OFFSET UNITYSDK_OFFSET(0x19ABC800)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0x19ABCAD0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_LOADBATTLEFIELD_OFFSET UNITYSDK_OFFSET(0x19ABCD60)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_REBINDTRACK_OFFSET UNITYSDK_OFFSET(0x19ABCDB0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_SETTIMESCALE_OFFSET UNITYSDK_OFFSET(0x19ABDC50)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_SET_ENEMYPLANEFOLLOWTARGET_OFFSET UNITYSDK_OFFSET(0x19ABDD30)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_TRIGGERENDINGANIM_OFFSET UNITYSDK_OFFSET(0x19ABD8D0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_TRIGGERLOADINGANIM_OFFSET UNITYSDK_OFFSET(0x19ABCA50)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_TRIGGERRESULTANIM_OFFSET UNITYSDK_OFFSET(0x19ABDBA0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_TRIGGERSLOWLOSEANIM_OFFSET UNITYSDK_OFFSET(0x19ABD820)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_TRIGGERSLOWWINANIM_OFFSET UNITYSDK_OFFSET(0x19ABD5E0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x19ABD410)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19ABDD40)

namespace RPG::Client::LittleGame::PixAir
{
	inline static constexpr unsigned int PixAirLevelController_TypeDefinitionIndex = 73372;
