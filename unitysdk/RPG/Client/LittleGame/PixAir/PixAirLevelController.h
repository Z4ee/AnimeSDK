...
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_BINDENEMYPLANE_OFFSET UNITYSDK_OFFSET(0x186031A0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_BINDPLAYERPLANE_OFFSET UNITYSDK_OFFSET(0x18602C60)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_GET_ENEMYPLANEFOLLOWTARGET_OFFSET UNITYSDK_OFFSET(0x18605AB0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_INITFORLOADING_OFFSET UNITYSDK_OFFSET(0x18604590)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0x18604860)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_LOADBATTLEFIELD_OFFSET UNITYSDK_OFFSET(0x18604AF0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_REBINDTRACK_OFFSET UNITYSDK_OFFSET(0x18604B40)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_SETTIMESCALE_OFFSET UNITYSDK_OFFSET(0x186059E0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_SET_ENEMYPLANEFOLLOWTARGET_OFFSET UNITYSDK_OFFSET(0x18605AC0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_TRIGGERENDINGANIM_OFFSET UNITYSDK_OFFSET(0x18605660)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_TRIGGERLOADINGANIM_OFFSET UNITYSDK_OFFSET(0x186047E0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_TRIGGERRESULTANIM_OFFSET UNITYSDK_OFFSET(0x18605930)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_TRIGGERSLOWLOSEANIM_OFFSET UNITYSDK_OFFSET(0x186055B0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_TRIGGERSLOWWINANIM_OFFSET UNITYSDK_OFFSET(0x18605370)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x186051A0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18605AD0)

namespace RPG::Client::LittleGame::PixAir
{
	inline static constexpr unsigned int PixAirLevelController_TypeDefinitionIndex = 76851;
