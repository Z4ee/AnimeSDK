...
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_BINDENEMYPLANE_OFFSET UNITYSDK_OFFSET(0xBE3F820)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_BINDPLAYERPLANE_OFFSET UNITYSDK_OFFSET(0xBE3F2E0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_GET_ENEMYPLANEFOLLOWTARGET_OFFSET UNITYSDK_OFFSET(0xBE42330)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_INITFORLOADING_OFFSET UNITYSDK_OFFSET(0xBE40F90)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0xBE41260)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_LOADBATTLEFIELD_OFFSET UNITYSDK_OFFSET(0xBE414F0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_REBINDTRACK_OFFSET UNITYSDK_OFFSET(0xBE41540)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_SETTIMESCALE_OFFSET UNITYSDK_OFFSET(0xBE42260)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_SET_ENEMYPLANEFOLLOWTARGET_OFFSET UNITYSDK_OFFSET(0xBE42340)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_TRIGGERENDINGANIM_OFFSET UNITYSDK_OFFSET(0xBE41EE0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_TRIGGERLOADINGANIM_OFFSET UNITYSDK_OFFSET(0xBE411E0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_TRIGGERRESULTANIM_OFFSET UNITYSDK_OFFSET(0xBE421B0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_TRIGGERSLOWLOSEANIM_OFFSET UNITYSDK_OFFSET(0xBE41E30)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_TRIGGERSLOWWINANIM_OFFSET UNITYSDK_OFFSET(0xBE41BF0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xBE41A20)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRLEVELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBE42350)

namespace RPG::Client::LittleGame::PixAir
{
	inline static constexpr unsigned int PixAirLevelController_TypeDefinitionIndex = 71847;
