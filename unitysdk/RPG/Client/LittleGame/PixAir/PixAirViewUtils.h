...
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRVIEWUTILS_GETEQUIPVIEWPATH_OFFSET UNITYSDK_OFFSET(0x1860A080)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRVIEWUTILS_GETEQUIPVIEW_OFFSET UNITYSDK_OFFSET(0x18609D70)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRVIEWUTILS_GETPLANEVIEW_OFFSET UNITYSDK_OFFSET(0x18609C50)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRVIEWUTILS_GETPLAYERICONPATH_OFFSET UNITYSDK_OFFSET(0x18609E90)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRVIEWUTILS_SETUI3DLAYERS_1_OFFSET UNITYSDK_OFFSET(0x185FEE40)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRVIEWUTILS_SETUI3DLAYERS_OFFSET UNITYSDK_OFFSET(0x18605BB0)

namespace RPG::Client::LittleGame::PixAir
{
	inline static constexpr unsigned int PixAirViewUtils_TypeDefinitionIndex = 76822;
	...
	public:
		...
		static ::System::String* GetEquipViewPath(::Class_1_43BD383C98B4C0C5_108* a1)
		{
			return ((::System::String*(*)(::Class_1_43BD383C98B4C0C5_108*))((::PBYTE)hIl2Cpp + RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRVIEWUTILS_GETEQUIPVIEWPATH_OFFSET))(a1);
		}
	};
}
