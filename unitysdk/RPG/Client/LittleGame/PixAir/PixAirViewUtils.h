...
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRVIEWUTILS_GETEQUIPVIEWPATH_OFFSET UNITYSDK_OFFSET(0xD551740)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRVIEWUTILS_GETEQUIPVIEW_OFFSET UNITYSDK_OFFSET(0xD551430)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRVIEWUTILS_GETPLANEVIEW_OFFSET UNITYSDK_OFFSET(0xD551310)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRVIEWUTILS_GETPLAYERICONPATH_OFFSET UNITYSDK_OFFSET(0xD551550)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRVIEWUTILS_SETUI3DLAYERS_1_OFFSET UNITYSDK_OFFSET(0xD5466F0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRVIEWUTILS_SETUI3DLAYERS_OFFSET UNITYSDK_OFFSET(0xD54D280)

namespace RPG::Client::LittleGame::PixAir
{
	inline static constexpr unsigned int PixAirViewUtils_TypeDefinitionIndex = 76823;
