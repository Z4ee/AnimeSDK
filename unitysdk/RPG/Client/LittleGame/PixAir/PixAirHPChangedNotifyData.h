...
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRHPCHANGEDNOTIFYDATA_GET_DAMAGETYPE_OFFSET UNITYSDK_OFFSET(0xD54ACE0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRHPCHANGEDNOTIFYDATA_GET_DAMAGEVALUE_OFFSET UNITYSDK_OFFSET(0xD54AD10)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRHPCHANGEDNOTIFYDATA_GET_MAXHP_OFFSET UNITYSDK_OFFSET(0xD54AD00)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRHPCHANGEDNOTIFYDATA_GET_NEWHP_OFFSET UNITYSDK_OFFSET(0xD54ACF0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRHPCHANGEDNOTIFYDATA_GET_RUNTIMEID_OFFSET UNITYSDK_OFFSET(0xD54ACD0)
#define RPG_CLIENT_LITTLEGAME_PIXAIR_PIXAIRHPCHANGEDNOTIFYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD54AD20)

namespace RPG::Client::LittleGame::PixAir
{
	inline static constexpr unsigned int PixAirHPChangedNotifyData_TypeDefinitionIndex = 76836;

	class PixAirHPChangedNotifyData : public ::System::Object
	{
	public:
		::System::Int32 _MaxHP_k__BackingField; // 0x10
		::System::Int32 _DamageValue_k__BackingField; // 0x14
		...
		::System::Int32 _NewHP_k__BackingField; // 0x20
