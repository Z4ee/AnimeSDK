...
#define RPG_CLIENT_EVOLVEBUILDACTIVITYDATA_ISSHOWDAILYREDDOT_OFFSET UNITYSDK_OFFSET(0xCECEC10)
#define RPG_CLIENT_EVOLVEBUILDACTIVITYDATA_ISSHOWMAPPINGINFONEWCONTENTREDDOT_OFFSET UNITYSDK_OFFSET(0xCECEE40)
#define RPG_CLIENT_EVOLVEBUILDACTIVITYDATA_ISSHOWMAPPINGINFOREWARDREDDOT_OFFSET UNITYSDK_OFFSET(0xCECED70)
#define RPG_CLIENT_EVOLVEBUILDACTIVITYDATA_ISSHOWNORMALREDDOT_OFFSET UNITYSDK_OFFSET(0xCECE780)
#define RPG_CLIENT_EVOLVEBUILDACTIVITYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCECE770)
