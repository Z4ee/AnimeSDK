...
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_CHECKISCANTAKEMISSION_OFFSET UNITYSDK_OFFSET(0x9BB3010)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_CHECKISMIDDLEMISSIONSTATE_OFFSET UNITYSDK_OFFSET(0x9BB31A0)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9BB1ED0)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GETCURPROCESSINGMISSIONDATA_OFFSET UNITYSDK_OFFSET(0x9BB2FD0)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GETSTORYLINEID_OFFSET UNITYSDK_OFFSET(0x9BB31E0)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_BELONGLINE_OFFSET UNITYSDK_OFFSET(0x9BB39F0)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_COMPATIONPARTNERLIST_OFFSET UNITYSDK_OFFSET(0x9BB3D80)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_CUSTOMSHOWCONDITIONLIST_OFFSET UNITYSDK_OFFSET(0x9BB3F90)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_CUSTOMUNLOCKCONDITIONCONFIGLIST_OFFSET UNITYSDK_OFFSET(0x9BB3DC0)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0x9BB39D0)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_IMAGEPATH_OFFSET UNITYSDK_OFFSET(0x9BB3BA0)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_ISBASELINE_OFFSET UNITYSDK_OFFSET(0x9BB3DF0)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_ISBELONGNOWORLD_OFFSET UNITYSDK_OFFSET(0x9BB3A30)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_ISEARLYACCESSEFFECTED_OFFSET UNITYSDK_OFFSET(0x9BB3F40)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_ISEARLYACCESS_OFFSET UNITYSDK_OFFSET(0x9BB3F20)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_ISFORCEEXPAND_OFFSET UNITYSDK_OFFSET(0x9BB3F60)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_ISPREDICTIONSHOWTYPE_OFFSET UNITYSDK_OFFSET(0x9BB3E10)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_ISSKIPTYPE_OFFSET UNITYSDK_OFFSET(0x9BB3800)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_MAINMISSIONDATA_OFFSET UNITYSDK_OFFSET(0x9BB30B0)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_MAINMISSIONID_OFFSET UNITYSDK_OFFSET(0x9BB3AD0)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_MAINMISSIONTYPE_OFFSET UNITYSDK_OFFSET(0x9BB3AB0)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_MISSIONCONCLUSION_OFFSET UNITYSDK_OFFSET(0x9BB3D60)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_MISSIONTYPECOLOR_OFFSET UNITYSDK_OFFSET(0x9BB3D40)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_MISSIONTYPEICONPATH_OFFSET UNITYSDK_OFFSET(0x9BB3D20)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_MULTIMISSIONIDLIST_OFFSET UNITYSDK_OFFSET(0x9BB3DA0)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_NODENAMEPARAM_OFFSET UNITYSDK_OFFSET(0x9BB3B40)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x9BB3A90)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_ORIGINMAINMISSIONID_OFFSET UNITYSDK_OFFSET(0x9BB3DD0)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_POSX_OFFSET UNITYSDK_OFFSET(0x9BB3A50)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_POSY_OFFSET UNITYSDK_OFFSET(0x9BB3A70)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_STARTMISSIONID_OFFSET UNITYSDK_OFFSET(0x9BB3B60)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_STATUS_OFFSET UNITYSDK_OFFSET(0x9BB30A0)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_STORYLINEID_OFFSET UNITYSDK_OFFSET(0x9BB3EB0)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_TITLE_OFFSET UNITYSDK_OFFSET(0x9BB3B80)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_WORLDID_OFFSET UNITYSDK_OFFSET(0x9BB3A10)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_GET_WORLDPATHDATA_OFFSET UNITYSDK_OFFSET(0x9BB3F80)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_ISCANSTEPNEXTPATH_OFFSET UNITYSDK_OFFSET(0x9BB2F50)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_ISCONNECTMISSIONFINISH_OFFSET UNITYSDK_OFFSET(0x9BB2F90)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_ISCUSTOMCONDITIONSHOW_OFFSET UNITYSDK_OFFSET(0x9BB32E0)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_ISSHOWEARLYACCESSEFFECTED_OFFSET UNITYSDK_OFFSET(0x9BB3220)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_ISWORLDUNLOCK_OFFSET UNITYSDK_OFFSET(0x9BB32A0)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_REGISTERCHECKPREFSCALLBACK_OFFSET UNITYSDK_OFFSET(0x9BB1FD0)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_SETDATA_OFFSET UNITYSDK_OFFSET(0x9BB2020)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_SETMOCKFINISHNODEDATA_OFFSET UNITYSDK_OFFSET(0x9BB2F00)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_SET_BELONGLINE_OFFSET UNITYSDK_OFFSET(0x9BB3A00)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_SET_COMPATIONPARTNERLIST_OFFSET UNITYSDK_OFFSET(0x9BB3D90)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_SET_CUSTOMSHOWCONDITIONLIST_OFFSET UNITYSDK_OFFSET(0x9BB3FA0)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_SET_ID_OFFSET UNITYSDK_OFFSET(0x9BB39E0)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_SET_ISBASELINE_OFFSET UNITYSDK_OFFSET(0x9BB3E00)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_SET_ISBELONGNOWORLD_OFFSET UNITYSDK_OFFSET(0x9BB3A40)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_SET_ISEARLYACCESSEFFECTED_OFFSET UNITYSDK_OFFSET(0x9BB3F50)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_SET_ISEARLYACCESS_OFFSET UNITYSDK_OFFSET(0x9BB3F30)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_SET_ISFORCEEXPAND_OFFSET UNITYSDK_OFFSET(0x9BB3F70)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_SET_MAINMISSIONTYPE_OFFSET UNITYSDK_OFFSET(0x9BB3AC0)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_SET_MISSIONCONCLUSION_OFFSET UNITYSDK_OFFSET(0x9BB3D70)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_SET_MISSIONTYPECOLOR_OFFSET UNITYSDK_OFFSET(0x9BB3D50)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_SET_MISSIONTYPEICONPATH_OFFSET UNITYSDK_OFFSET(0x9BB3D30)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_SET_MULTIMISSIONIDLIST_OFFSET UNITYSDK_OFFSET(0x9BB3DB0)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_SET_NODENAMEPARAM_OFFSET UNITYSDK_OFFSET(0x9BB3B50)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_SET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x9BB3AA0)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_SET_ORIGINMAINMISSIONID_OFFSET UNITYSDK_OFFSET(0x9BB3DE0)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_SET_POSX_OFFSET UNITYSDK_OFFSET(0x9BB3A60)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_SET_POSY_OFFSET UNITYSDK_OFFSET(0x9BB3A80)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_SET_STARTMISSIONID_OFFSET UNITYSDK_OFFSET(0x9BB3B70)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_SET_TITLE_OFFSET UNITYSDK_OFFSET(0x9BB3B90)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA_SET_WORLDID_OFFSET UNITYSDK_OFFSET(0x9BB3A20)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA__CHECKISMISSIONDISABLE_OFFSET UNITYSDK_OFFSET(0x9BB3370)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA__CHECKISMISSIONIDEARLYACCESS_OFFSET UNITYSDK_OFFSET(0x9BB3420)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA__CHECKISWORLDEARLYACCESS_OFFSET UNITYSDK_OFFSET(0x9BB3650)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9BB1E50)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA__GETCURCHRONICLESTATUS_OFFSET UNITYSDK_OFFSET(0x9BB3330)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA__SETCOMPATIONPARTNERLIST_OFFSET UNITYSDK_OFFSET(0x9BB2860)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA__SETCUSTOMSHOWCONDITIONCONFIGLIST_OFFSET UNITYSDK_OFFSET(0x9BB2DD0)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA__SETCUSTOMUNLOCKCONDITIONCONFIGLIST_OFFSET UNITYSDK_OFFSET(0x9BB2C90)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA__SETMAINMISSIONID_OFFSET UNITYSDK_OFFSET(0x9BB2280)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA__SETMISSIONCONCLUSION_OFFSET UNITYSDK_OFFSET(0x9BB27C0)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA__SETMISSIONTYPECOLOR_OFFSET UNITYSDK_OFFSET(0x9BB3850)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA__SETMISSIONTYPE_OFFSET UNITYSDK_OFFSET(0x9BB25F0)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA__SETMULTIMISSIONIDLIST_OFFSET UNITYSDK_OFFSET(0x9BB29C0)
#define RPG_CLIENT_MISSIONCHRONICLEBASEPATHDATA__SETTITLE_OFFSET UNITYSDK_OFFSET(0x9BB2330)

namespace RPG::Client
{
	inline static constexpr unsigned int MissionChronicleBasePathData_TypeDefinitionIndex = 53704;
	...
	public:
		...
		::System::Action* _CheckPrefsCallback; // 0x20
		...
		::System::String* _BaseImagePath; // 0x38
		...
		::System::Boolean _IsBaseLine_k__BackingField; // 0x58
		::System::Boolean _IsEarlyAccess_k__BackingField; // 0x59
		::System::UInt32 _ID_k__BackingField; // 0x5C
		::RPG::Client::TextID _MissionConclusion_k__BackingField; // 0x60
		::RPG::GameCore::ChronicleNodeType _NodeType_k__BackingField; // 0x70
		::RPG::GameCore::MainMissionType _MainMissionType_k__BackingField; // 0x74
		::System::UInt32 _StartMissionID_k__BackingField; // 0x78
		::System::UInt32 _OriginMainMissionID_k__BackingField; // 0x7C
		::System::Int32 _StoryLineID; // 0x80
		::System::Boolean _IsForceExpand_k__BackingField; // 0x84
		::System::Boolean _IsBelongNoWorld_k__BackingField; // 0x85
		::System::Boolean _IsEarlyAccessEffected_k__BackingField; // 0x86
		::System::UInt32 _NodeNameParam_k__BackingField; // 0x88
		::RPG::Client::TextID _Title_k__BackingField; // 0x90
		::System::UInt32 _BelongLine_k__BackingField; // 0xA0
		::System::UInt32 _WorldID_k__BackingField; // 0xA4
		::System::Int32 _PosY_k__BackingField; // 0xA8
		::System::Int32 _PosX_k__BackingField; // 0xAC
