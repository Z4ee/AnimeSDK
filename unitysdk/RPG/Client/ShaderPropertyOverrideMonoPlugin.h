...
#define RPG_CLIENT_SHADERPROPERTYOVERRIDEMONOPLUGIN_DUMP_OFFSET UNITYSDK_OFFSET(0xA476D20)
#define RPG_CLIENT_SHADERPROPERTYOVERRIDEMONOPLUGIN_GET_INSTANCEID_OFFSET UNITYSDK_OFFSET(0xA476B60)
#define RPG_CLIENT_SHADERPROPERTYOVERRIDEMONOPLUGIN_GET_ISLEAFPREFERRED_OFFSET UNITYSDK_OFFSET(0xA476B70)
#define RPG_CLIENT_SHADERPROPERTYOVERRIDEMONOPLUGIN_LOAD_OFFSET UNITYSDK_OFFSET(0xA477340)
#define RPG_CLIENT_SHADERPROPERTYOVERRIDEMONOPLUGIN_METHOD_7_00523BAC9115E920_1_OFFSET UNITYSDK_OFFSET(0xA476C40)
#define RPG_CLIENT_SHADERPROPERTYOVERRIDEMONOPLUGIN_METHOD_7_00523BAC9115E920_OFFSET UNITYSDK_OFFSET(0xA476B80)
#define RPG_CLIENT_SHADERPROPERTYOVERRIDEMONOPLUGIN_METHOD_7_3CDB16AF04E6187A_1_OFFSET UNITYSDK_OFFSET(0xA476CB0)
#define RPG_CLIENT_SHADERPROPERTYOVERRIDEMONOPLUGIN_METHOD_7_3CDB16AF04E6187A_OFFSET UNITYSDK_OFFSET(0xA476BE0)
#define RPG_CLIENT_SHADERPROPERTYOVERRIDEMONOPLUGIN_METHOD_7_A239DF324AF4215D_OFFSET UNITYSDK_OFFSET(0xA4772D0)
#define RPG_CLIENT_SHADERPROPERTYOVERRIDEMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xA4776A0)

namespace RPG::Client
{
	inline static constexpr unsigned int ShaderPropertyOverrideMonoPlugin_TypeDefinitionIndex = 58172;
	...
	public:
		...
		::System::Void Dump(::RPG::GameCore::StageSceneItemSharedSerializationData* a1)
		{
			return ((::System::Void(*)(::PVOID, ::RPG::GameCore::StageSceneItemSharedSerializationData*))((::PBYTE)hIl2Cpp + RPG_CLIENT_SHADERPROPERTYOVERRIDEMONOPLUGIN_DUMP_OFFSET))(this, a1);
		}

		::System::Void Load(::RPG::GameCore::StageSceneItemSharedSerializationData* a1)
		{
			return ((::System::Void(*)(::PVOID, ::RPG::GameCore::StageSceneItemSharedSerializationData*))((::PBYTE)hIl2Cpp + RPG_CLIENT_SHADERPROPERTYOVERRIDEMONOPLUGIN_LOAD_OFFSET))(this, a1);
		}
