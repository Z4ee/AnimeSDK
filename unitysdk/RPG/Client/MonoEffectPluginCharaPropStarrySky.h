...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPSTARRYSKY_INIT_OFFSET UNITYSDK_OFFSET(0x9CC0B80)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPSTARRYSKY_UNINIT_OFFSET UNITYSDK_OFFSET(0x9CC1C80)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPSTARRYSKY_UPDATEPROPERTY_OFFSET UNITYSDK_OFFSET(0x9CC0C20)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPSTARRYSKY__CTOR_OFFSET UNITYSDK_OFFSET(0x9CC1D60)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPSTARRYSKY___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0x9CC1D80)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginCharaPropStarrySky_TypeDefinitionIndex = 57256;
