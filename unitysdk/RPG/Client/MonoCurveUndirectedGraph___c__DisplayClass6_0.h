...
namespace RPG::Client
{
	...
	public:
		...
		::System::Boolean _FindEdgeByCurve_b__0(::RPG::Client::CurveUndirectedEdge* edge)
		{
			return ((::System::Boolean(*)(::PVOID, ::RPG::Client::CurveUndirectedEdge*))((::PBYTE)hIl2Cpp + RPG_CLIENT_MONOCURVEUNDIRECTEDGRAPH___C__DISPLAYCLASS6_0__FINDEDGEBYCURVE_B__0_OFFSET))(this, edge);
		}
	};
}
