...
#define RPG_CLIENT_ST_PARKOUR_SHUTDOWNENGINE_METHOD_4_FB6FA5B354632C38_OFFSET UNITYSDK_OFFSET(0x16E8D4A0)
#define RPG_CLIENT_ST_PARKOUR_SHUTDOWNENGINE_METHOD_4_FBB2A37C10765CE7_OFFSET UNITYSDK_OFFSET(0x16E8D610)
#define RPG_CLIENT_ST_PARKOUR_SHUTDOWNENGINE__CTOR_OFFSET UNITYSDK_OFFSET(0x16E8D5C0)

namespace RPG::Client
{
	inline static constexpr unsigned int ST_Parkour_ShutdownEngine_TypeDefinitionIndex = 9966;
