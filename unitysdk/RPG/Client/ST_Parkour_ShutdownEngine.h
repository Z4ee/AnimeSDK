...
#define RPG_CLIENT_ST_PARKOUR_SHUTDOWNENGINE_METHOD_4_822A6E0CAFCAA04A_OFFSET UNITYSDK_OFFSET(0x1CD631D0)
#define RPG_CLIENT_ST_PARKOUR_SHUTDOWNENGINE_METHOD_4_FBB2A37C10765CE7_OFFSET UNITYSDK_OFFSET(0x1CD632A0)
#define RPG_CLIENT_ST_PARKOUR_SHUTDOWNENGINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD63290)

namespace RPG::Client
{
	inline static constexpr unsigned int ST_Parkour_ShutdownEngine_TypeDefinitionIndex = 10256;
