...
#define RPG_CLIENT_ROGUEMAGICSCEPTERUNITEQUIPPEDNOTIFYPARAMS_ISSLOTUNITEQUIPPED_OFFSET UNITYSDK_OFFSET(0xDEE84A0)
#define RPG_CLIENT_ROGUEMAGICSCEPTERUNITEQUIPPEDNOTIFYPARAMS_MERGE_OFFSET UNITYSDK_OFFSET(0xDEE8540)
#define RPG_CLIENT_ROGUEMAGICSCEPTERUNITEQUIPPEDNOTIFYPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0xDEE85D0)
