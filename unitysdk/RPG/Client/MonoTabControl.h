...
#define RPG_CLIENT_MONOTABCONTROL_ADDLAYOUTBUTTON_OFFSET UNITYSDK_OFFSET(0xC14AD40)
#define RPG_CLIENT_MONOTABCONTROL_CLEARLAYOUTBUTTON_OFFSET UNITYSDK_OFFSET(0xC14B120)
#define RPG_CLIENT_MONOTABCONTROL_CLEARTABBUTTON_OFFSET UNITYSDK_OFFSET(0xC14B980)
#define RPG_CLIENT_MONOTABCONTROL_CREATETABBUTTON_OFFSET UNITYSDK_OFFSET(0xC14B760)
#define RPG_CLIENT_MONOTABCONTROL_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xC14BDF0)
#define RPG_CLIENT_MONOTABCONTROL_GET_ANIMATORBTNMODE_OFFSET UNITYSDK_OFFSET(0xC14C330)
#define RPG_CLIENT_MONOTABCONTROL_GET_CURRENTSELECTITEM_OFFSET UNITYSDK_OFFSET(0xC14C310)
#define RPG_CLIENT_MONOTABCONTROL_GET_MSCROLLRECT_OFFSET UNITYSDK_OFFSET(0xC14BB70)
#define RPG_CLIENT_MONOTABCONTROL_GET__RECTTRANSFORMREF_OFFSET UNITYSDK_OFFSET(0xC14B900)
#define RPG_CLIENT_MONOTABCONTROL_ISANIMATORCHECKMODEENABLECLICK_OFFSET UNITYSDK_OFFSET(0xC14C390)
#define RPG_CLIENT_MONOTABCONTROL_ISANIMATORCHECKMODE_OFFSET UNITYSDK_OFFSET(0xC14C340)
#define RPG_CLIENT_MONOTABCONTROL_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xC14BE40)
#define RPG_CLIENT_MONOTABCONTROL_ONITEMINDEXSELECT_OFFSET UNITYSDK_OFFSET(0xC14BBE0)
#define RPG_CLIENT_MONOTABCONTROL_SCROLLTOINDEX_OFFSET UNITYSDK_OFFSET(0xC14BCD0)
#define RPG_CLIENT_MONOTABCONTROL_SETSCROLLRECT_OFFSET UNITYSDK_OFFSET(0xC14BB90)
#define RPG_CLIENT_MONOTABCONTROL_SET_CURRENTSELECTITEM_OFFSET UNITYSDK_OFFSET(0xC14C320)
#define RPG_CLIENT_MONOTABCONTROL_SET_MSCROLLRECT_OFFSET UNITYSDK_OFFSET(0xC14BB80)
#define RPG_CLIENT_MONOTABCONTROL_SPAWNED_OFFSET UNITYSDK_OFFSET(0xC14BDB0)
#define RPG_CLIENT_MONOTABCONTROL_UPDATELAYOUT_OFFSET UNITYSDK_OFFSET(0xC14B190)
#define RPG_CLIENT_MONOTABCONTROL__ADDHORIZONTAL_OFFSET UNITYSDK_OFFSET(0xC14AF70)
#define RPG_CLIENT_MONOTABCONTROL__ADDVERTICAL_OFFSET UNITYSDK_OFFSET(0xC14ADC0)
#define RPG_CLIENT_MONOTABCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC14C3E0)
#define RPG_CLIENT_MONOTABCONTROL__REFRESHSCROLLBORDERTIPS_OFFSET UNITYSDK_OFFSET(0xC14BE90)
#define RPG_CLIENT_MONOTABCONTROL__SAFEGETLAYOUTPARAM_OFFSET UNITYSDK_OFFSET(0xC14BAC0)
#define RPG_CLIENT_MONOTABCONTROL__UPDATEHORIZONTALLAYOUT_OFFSET UNITYSDK_OFFSET(0xC14B4B0)
#define RPG_CLIENT_MONOTABCONTROL__UPDATEVERTICALLAYOUT_OFFSET UNITYSDK_OFFSET(0xC14B1F0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoTabControl_TypeDefinitionIndex = 67840;
