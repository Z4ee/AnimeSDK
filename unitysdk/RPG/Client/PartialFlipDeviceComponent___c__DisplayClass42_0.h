...
#define RPG_CLIENT_PARTIALFLIPDEVICECOMPONENT___C__DISPLAYCLASS42_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2FF740)
#define RPG_CLIENT_PARTIALFLIPDEVICECOMPONENT___C__DISPLAYCLASS42_0___ONREFRESHSTATE_B__0_OFFSET UNITYSDK_OFFSET(0x1A2FFCD0)
#define RPG_CLIENT_PARTIALFLIPDEVICECOMPONENT___C__DISPLAYCLASS42_0___ONREFRESHSTATE_B__1_OFFSET UNITYSDK_OFFSET(0x1A2FFD00)

namespace RPG::Client
{
	inline static constexpr unsigned int PartialFlipDeviceComponent___c__DisplayClass42_0_TypeDefinitionIndex = 69970;
