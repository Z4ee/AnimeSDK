...
#define RPG_CLIENT_CURVEOBJECTLOADTRIGGER_METHOD_1_B1476C314B32BFD8_OFFSET UNITYSDK_OFFSET(0xA0E8930)
#define RPG_CLIENT_CURVEOBJECTLOADTRIGGER_METHOD_1_B24D6784786E080C_OFFSET UNITYSDK_OFFSET(0xA0E8A70)
#define RPG_CLIENT_CURVEOBJECTLOADTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0xA0E8B60)

namespace RPG::Client
{
	inline static constexpr unsigned int CurveObjectLoadTrigger_TypeDefinitionIndex = 63225;
