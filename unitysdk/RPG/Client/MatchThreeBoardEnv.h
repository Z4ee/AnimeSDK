...
#define RPG_CLIENT_MATCHTHREEBOARDENV_INIT_OFFSET UNITYSDK_OFFSET(0x9B243A0)
#define RPG_CLIENT_MATCHTHREEBOARDENV_METHOD_5_19B91D58E02869BC_OFFSET UNITYSDK_OFFSET(0x9B33AF0)
#define RPG_CLIENT_MATCHTHREEBOARDENV_METHOD_5_380D3A6DB0A496D6_OFFSET UNITYSDK_OFFSET(0x9B339F0)
#define RPG_CLIENT_MATCHTHREEBOARDENV_METHOD_5_87ED86A49598E706_OFFSET UNITYSDK_OFFSET(0x9B33B70)
#define RPG_CLIENT_MATCHTHREEBOARDENV_SETGRIDTAG_OFFSET UNITYSDK_OFFSET(0x9B2DF90)
#define RPG_CLIENT_MATCHTHREEBOARDENV_SETSIZE_OFFSET UNITYSDK_OFFSET(0x9B33870)
#define RPG_CLIENT_MATCHTHREEBOARDENV__CTOR_OFFSET UNITYSDK_OFFSET(0x9B33D40)

namespace RPG::Client
{
	inline static constexpr unsigned int MatchThreeBoardEnv_TypeDefinitionIndex = 53548;
