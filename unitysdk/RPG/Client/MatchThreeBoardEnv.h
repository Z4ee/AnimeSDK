...
#define RPG_CLIENT_MATCHTHREEBOARDENV_INIT_OFFSET UNITYSDK_OFFSET(0xD626300)
#define RPG_CLIENT_MATCHTHREEBOARDENV_METHOD_5_19B91D58E02869BC_OFFSET UNITYSDK_OFFSET(0xD634450)
#define RPG_CLIENT_MATCHTHREEBOARDENV_METHOD_5_94BDBF2773396AF1_OFFSET UNITYSDK_OFFSET(0xD6344D0)
#define RPG_CLIENT_MATCHTHREEBOARDENV_METHOD_5_D27288CEC2E97673_OFFSET UNITYSDK_OFFSET(0xD634340)
#define RPG_CLIENT_MATCHTHREEBOARDENV_SETGRIDTAG_OFFSET UNITYSDK_OFFSET(0xD62EE60)
#define RPG_CLIENT_MATCHTHREEBOARDENV_SETSIZE_OFFSET UNITYSDK_OFFSET(0xD6341C0)
#define RPG_CLIENT_MATCHTHREEBOARDENV__CTOR_OFFSET UNITYSDK_OFFSET(0xD634690)
