...
#define RPG_CLIENT_CHENLINGPRIVILEGETREENODE_ADDCHILD_OFFSET UNITYSDK_OFFSET(0x1AA878D0)
#define RPG_CLIENT_CHENLINGPRIVILEGETREENODE_ADDPARENT_OFFSET UNITYSDK_OFFSET(0x1AA87B30)
#define RPG_CLIENT_CHENLINGPRIVILEGETREENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA87850)

namespace RPG::Client
{
	inline static constexpr unsigned int ChenLingPrivilegeTreeNode_TypeDefinitionIndex = 58708;

	class ChenLingPrivilegeTreeNode : public ::System::Object
	{
	public:
		::System::Collections::Generic::List_1<::RPG::Client::ChenLingPrivilegeTreeNode*>* Parents; // 0x10
		::RPG::Client::ChenLingPrivilege* Config; // 0x18
		::System::Collections::Generic::List_1<::RPG::Client::ChenLingPrivilegeTreeNode*>* Children; // 0x20
