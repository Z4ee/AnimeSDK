...
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECTPROP_AWAKE_OFFSET UNITYSDK_OFFSET(0xC073950)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECTPROP_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0xC074360)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECTPROP_METHOD_5_06330CD58CB602B6_OFFSET UNITYSDK_OFFSET(0xC073A70)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECTPROP_ONCOLLISIONENTER_OFFSET UNITYSDK_OFFSET(0xC073DF0)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECTPROP_SETSIMULATIONSPEED_OFFSET UNITYSDK_OFFSET(0xC0733B0)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECTPROP__CTOR_OFFSET UNITYSDK_OFFSET(0xC0745C0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoDestructibleObjectProp_TypeDefinitionIndex = 64162;
