...
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECTPROP_AWAKE_OFFSET UNITYSDK_OFFSET(0x10CCBC80)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECTPROP_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x10CCC690)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECTPROP_METHOD_5_06330CD58CB602B6_OFFSET UNITYSDK_OFFSET(0x10CCBDA0)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECTPROP_ONCOLLISIONENTER_OFFSET UNITYSDK_OFFSET(0x10CCC120)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECTPROP_SETSIMULATIONSPEED_OFFSET UNITYSDK_OFFSET(0x10CCB800)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECTPROP__CTOR_OFFSET UNITYSDK_OFFSET(0x10CCC8F0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoDestructibleObjectProp_TypeDefinitionIndex = 65533;
	...
	public:
		...
		::UnityEngine::Rigidbody* Field_5_3; // 0x20
		::System::Single Field_5_4; // 0x28
		::UnityEngine::Vector3 Field_5_5; // 0x2C
