...
#define RPG_CLIENT_FATETIMERACTIVITYPANELDATA_CHECKANDMARKMISSINGVIDEO_OFFSET UNITYSDK_OFFSET(0xB9B89C0)
#define RPG_CLIENT_FATETIMERACTIVITYPANELDATA_GETVIDEOIDCURRENTLANGUAGE_OFFSET UNITYSDK_OFFSET(0xB9B85A0)
#define RPG_CLIENT_FATETIMERACTIVITYPANELDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB9B8590)

namespace RPG::Client
{
	inline static constexpr unsigned int FateTimerActivityPanelData_TypeDefinitionIndex = 57617;
