...
#define RPG_CLIENT_AVATARUNLOCKSKILLTREEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x915E500)

namespace RPG::Client
{
	inline static constexpr unsigned int AvatarUnlockSkillTreeData_TypeDefinitionIndex = 50772;
