...
#define RPG_CLIENT_AVATARUNLOCKSKILLTREEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9DACB10)

namespace RPG::Client
{
	inline static constexpr unsigned int AvatarUnlockSkillTreeData_TypeDefinitionIndex = 57651;
