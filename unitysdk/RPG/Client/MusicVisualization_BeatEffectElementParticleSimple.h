...
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTPARTICLESIMPLE_METHOD_2_9F9ED25754A7CAB9_OFFSET UNITYSDK_OFFSET(0x9DE55D0)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTPARTICLESIMPLE_METHOD_2_E9A575D18A0748D9_OFFSET UNITYSDK_OFFSET(0x9DE5520)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTPARTICLESIMPLE__CTOR_OFFSET UNITYSDK_OFFSET(0x9DE5570)

namespace RPG::Client
{
	inline static constexpr unsigned int MusicVisualization_BeatEffectElementParticleSimple_TypeDefinitionIndex = 58017;
