...
#define RPG_CLIENT_COROUTINEUTILS___INVOKECOROUTINE_D__24_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1E58E890)
#define RPG_CLIENT_COROUTINEUTILS___INVOKECOROUTINE_D__24_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1E58E910)
#define RPG_CLIENT_COROUTINEUTILS___INVOKECOROUTINE_D__24_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1E58E970)
#define RPG_CLIENT_COROUTINEUTILS___INVOKECOROUTINE_D__24_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1E58E920)
#define RPG_CLIENT_COROUTINEUTILS___INVOKECOROUTINE_D__24_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E58E880)
#define RPG_CLIENT_COROUTINEUTILS___INVOKECOROUTINE_D__24__CTOR_OFFSET UNITYSDK_OFFSET(0x1E58DF90)

namespace RPG::Client
{
	inline static constexpr unsigned int CoroutineUtils___InvokeCoroutine_d__24_TypeDefinitionIndex = 34569;
