...
#define RPG_CLIENT_COROUTINEUTILS___INVOKECOROUTINE_D__24_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1AC12AE0)
#define RPG_CLIENT_COROUTINEUTILS___INVOKECOROUTINE_D__24_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AC12B60)
#define RPG_CLIENT_COROUTINEUTILS___INVOKECOROUTINE_D__24_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AC12BC0)
#define RPG_CLIENT_COROUTINEUTILS___INVOKECOROUTINE_D__24_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1AC12B70)
#define RPG_CLIENT_COROUTINEUTILS___INVOKECOROUTINE_D__24_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AC12AD0)
#define RPG_CLIENT_COROUTINEUTILS___INVOKECOROUTINE_D__24__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC12210)

namespace RPG::Client
{
	inline static constexpr unsigned int CoroutineUtils___InvokeCoroutine_d__24_TypeDefinitionIndex = 33433;
