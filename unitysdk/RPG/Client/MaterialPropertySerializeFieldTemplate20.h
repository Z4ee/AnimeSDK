...
#define RPG_CLIENT_MATERIALPROPERTYSERIALIZEFIELDTEMPLATE20_GETPROPERTYFIELDS_OFFSET UNITYSDK_OFFSET(0xA8706D0)
#define RPG_CLIENT_MATERIALPROPERTYSERIALIZEFIELDTEMPLATE20__CTOR_OFFSET UNITYSDK_OFFSET(0xA870EE0)
#define RPG_CLIENT_MATERIALPROPERTYSERIALIZEFIELDTEMPLATE20___IFIXBASEPROXY_GETPROPERTYFIELDS_OFFSET UNITYSDK_OFFSET(0xA870EF0)

namespace RPG::Client
{
	inline static constexpr unsigned int MaterialPropertySerializeFieldTemplate20_TypeDefinitionIndex = 65158;
