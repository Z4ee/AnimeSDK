...
#define RPG_CLIENT_AVATARROOTMOTIONBAKEDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18670060)

namespace RPG::Client
{
	inline static constexpr unsigned int AvatarRootMotionBakedData_TypeDefinitionIndex = 57393;
