...
#define RPG_CLIENT_AVATARROOTMOTIONBAKEDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9DB9560)

namespace RPG::Client
{
	inline static constexpr unsigned int AvatarRootMotionBakedData_TypeDefinitionIndex = 55408;
