...
#define RPG_CLIENT_AVATARROOTMOTIONBAKEDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB395200)

namespace RPG::Client
{
	inline static constexpr unsigned int AvatarRootMotionBakedData_TypeDefinitionIndex = 56153;
