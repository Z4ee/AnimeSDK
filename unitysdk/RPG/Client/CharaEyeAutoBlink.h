...
#define RPG_CLIENT_CHARAEYEAUTOBLINK_AWAKE_OFFSET UNITYSDK_OFFSET(0xB57D970)
#define RPG_CLIENT_CHARAEYEAUTOBLINK_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0xB57D680)
#define RPG_CLIENT_CHARAEYEAUTOBLINK_METHOD_5_52CA0F45BC3414DC_OFFSET UNITYSDK_OFFSET(0xB57DAC0)
#define RPG_CLIENT_CHARAEYEAUTOBLINK_UPDATE_OFFSET UNITYSDK_OFFSET(0xB57DBC0)
#define RPG_CLIENT_CHARAEYEAUTOBLINK__CTOR_OFFSET UNITYSDK_OFFSET(0xB57DD60)

namespace RPG::Client
{
	inline static constexpr unsigned int CharaEyeAutoBlink_TypeDefinitionIndex = 63957;
	...
	public:
		...
		::Class_0_16E4307DCC419505_925* Field_5_7; // 0x48
