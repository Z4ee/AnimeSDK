...
#define RPG_CLIENT_MONOEFFECTPLUGINNUMBER_RENDERERDIGITDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA997C20)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginNumber_RendererDigitData_TypeDefinitionIndex = 64608;
