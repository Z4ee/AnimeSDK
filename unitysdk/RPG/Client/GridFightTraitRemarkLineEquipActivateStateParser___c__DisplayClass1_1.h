...
#define RPG_CLIENT_GRIDFIGHTTRAITREMARKLINEEQUIPACTIVATESTATEPARSER___C__DISPLAYCLASS1_1__CTOR_OFFSET UNITYSDK_OFFSET(0xBC30410)
#define RPG_CLIENT_GRIDFIGHTTRAITREMARKLINEEQUIPACTIVATESTATEPARSER___C__DISPLAYCLASS1_1___GETISACTIVE_B__3_OFFSET UNITYSDK_OFFSET(0xBC30420)
#define RPG_CLIENT_GRIDFIGHTTRAITREMARKLINEEQUIPACTIVATESTATEPARSER___C__DISPLAYCLASS1_1___GETISACTIVE_B__4_OFFSET UNITYSDK_OFFSET(0xBC30450)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightTraitRemarkLineEquipActivateStateParser___c__DisplayClass1_1_TypeDefinitionIndex = 61222;
