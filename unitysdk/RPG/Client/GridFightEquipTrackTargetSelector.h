...
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACKTARGETSELECTOR_GETSELECTORTARGET_OFFSET UNITYSDK_OFFSET(0x1A68E850)
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACKTARGETSELECTOR__COMPAREROLE_OFFSET UNITYSDK_OFFSET(0x1A69C1D0)
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACKTARGETSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A68FB10)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightEquipTrackTargetSelector_TypeDefinitionIndex = 62421;
