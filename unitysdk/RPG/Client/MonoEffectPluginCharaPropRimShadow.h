...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPRIMSHADOW_ISNEEDLUTPROPERTY_OFFSET UNITYSDK_OFFSET(0x116BC520)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPRIMSHADOW_UPDATEPROPERTY_OFFSET UNITYSDK_OFFSET(0x116BC560)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPRIMSHADOW__CTOR_OFFSET UNITYSDK_OFFSET(0x116BEE70)
