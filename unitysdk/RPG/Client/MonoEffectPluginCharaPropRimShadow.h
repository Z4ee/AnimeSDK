...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPRIMSHADOW_ISNEEDLUTPROPERTY_OFFSET UNITYSDK_OFFSET(0x9CBD280)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPRIMSHADOW_UPDATEPROPERTY_OFFSET UNITYSDK_OFFSET(0x9CBD2C0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPRIMSHADOW__CTOR_OFFSET UNITYSDK_OFFSET(0x9CBFB30)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPRIMSHADOW___IFIXBASEPROXY_ISNEEDLUTPROPERTY_OFFSET UNITYSDK_OFFSET(0x9CBFB50)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginCharaPropRimShadow_TypeDefinitionIndex = 57254;
