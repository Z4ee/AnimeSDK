...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPRIMSHADOW_ISNEEDLUTPROPERTY_OFFSET UNITYSDK_OFFSET(0xA97F1E0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPRIMSHADOW_UPDATEPROPERTY_OFFSET UNITYSDK_OFFSET(0xA97F220)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPRIMSHADOW__CTOR_OFFSET UNITYSDK_OFFSET(0xA981A90)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPRIMSHADOW___IFIXBASEPROXY_ISNEEDLUTPROPERTY_OFFSET UNITYSDK_OFFSET(0xA981AB0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginCharaPropRimShadow_TypeDefinitionIndex = 64508;
