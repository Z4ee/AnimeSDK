...
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_LEAVEFLOOR_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x16970B10)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_LEAVEFLOOR_EQUALS_OFFSET UNITYSDK_OFFSET(0x16970A60)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_LEAVEFLOOR_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x16970C30)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_LEAVEFLOOR_GET_CONDITIONTEXT_OFFSET UNITYSDK_OFFSET(0x16970CB0)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_LEAVEFLOOR_GET_FLOORID_OFFSET UNITYSDK_OFFSET(0x16970CA0)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_LEAVEFLOOR__CTOR_OFFSET UNITYSDK_OFFSET(0x16970A50)
