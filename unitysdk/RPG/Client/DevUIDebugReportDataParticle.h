...
#define RPG_CLIENT_DEVUIDEBUGREPORTDATAPARTICLE__CTOR_OFFSET UNITYSDK_OFFSET(0x944B820)

namespace RPG::Client
{
	inline static constexpr unsigned int DevUIDebugReportDataParticle_TypeDefinitionIndex = 55783;
