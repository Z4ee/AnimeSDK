...
#define RPG_CLIENT_DEVUIDEBUGREPORTDATAPARTICLE__CTOR_OFFSET UNITYSDK_OFFSET(0xA0F99F0)

namespace RPG::Client
{
	inline static constexpr unsigned int DevUIDebugReportDataParticle_TypeDefinitionIndex = 63015;
