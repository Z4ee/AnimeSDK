...
#define RPG_CLIENT_DEVUIDEBUGREPORTDATAPARTICLE__CTOR_OFFSET UNITYSDK_OFFSET(0x192E4D50)

namespace RPG::Client
{
	inline static constexpr unsigned int DevUIDebugReportDataParticle_TypeDefinitionIndex = 68313;
