...
#define RPG_CLIENT_MONOTIMELINECONTROLGAMELEVELCELL_STAIRFLOOR_METHOD_2_A8149BE512BB2FE1_OFFSET UNITYSDK_OFFSET(0xC14E0F0)
#define RPG_CLIENT_MONOTIMELINECONTROLGAMELEVELCELL_STAIRFLOOR_METHOD_2_D9D9AC52008D123F_OFFSET UNITYSDK_OFFSET(0xC14D5D0)
#define RPG_CLIENT_MONOTIMELINECONTROLGAMELEVELCELL_STAIRFLOOR__CTOR_OFFSET UNITYSDK_OFFSET(0xC14E770)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoTimelineControlGameLevelCell_StairFloor_TypeDefinitionIndex = 56481;
