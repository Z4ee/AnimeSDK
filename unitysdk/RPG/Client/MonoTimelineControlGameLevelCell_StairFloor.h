...
#define RPG_CLIENT_MONOTIMELINECONTROLGAMELEVELCELL_STAIRFLOOR_METHOD_2_A8149BE512BB2FE1_OFFSET UNITYSDK_OFFSET(0x1A3542C0)
#define RPG_CLIENT_MONOTIMELINECONTROLGAMELEVELCELL_STAIRFLOOR_METHOD_2_D9D9AC52008D123F_OFFSET UNITYSDK_OFFSET(0x1A3537A0)
#define RPG_CLIENT_MONOTIMELINECONTROLGAMELEVELCELL_STAIRFLOOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A354940)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoTimelineControlGameLevelCell_StairFloor_TypeDefinitionIndex = 57721;
