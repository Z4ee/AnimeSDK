...
#define RPG_CLIENT_MONOTIMELINECONTROLGAMELEVELCELL_STAIRFLOOR_METHOD_2_A8149BE512BB2FE1_OFFSET UNITYSDK_OFFSET(0xA9FFF30)
#define RPG_CLIENT_MONOTIMELINECONTROLGAMELEVELCELL_STAIRFLOOR_METHOD_2_D9D9AC52008D123F_OFFSET UNITYSDK_OFFSET(0xA9FF360)
#define RPG_CLIENT_MONOTIMELINECONTROLGAMELEVELCELL_STAIRFLOOR__CTOR_OFFSET UNITYSDK_OFFSET(0xAA005B0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoTimelineControlGameLevelCell_StairFloor_TypeDefinitionIndex = 55727;
