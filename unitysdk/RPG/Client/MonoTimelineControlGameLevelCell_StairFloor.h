...
#define RPG_CLIENT_MONOTIMELINECONTROLGAMELEVELCELL_STAIRFLOOR_METHOD_2_A8149BE512BB2FE1_OFFSET UNITYSDK_OFFSET(0x9D3CD50)
#define RPG_CLIENT_MONOTIMELINECONTROLGAMELEVELCELL_STAIRFLOOR_METHOD_2_D9D9AC52008D123F_OFFSET UNITYSDK_OFFSET(0x9D3C180)
#define RPG_CLIENT_MONOTIMELINECONTROLGAMELEVELCELL_STAIRFLOOR__CTOR_OFFSET UNITYSDK_OFFSET(0x9D3D3D0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoTimelineControlGameLevelCell_StairFloor_TypeDefinitionIndex = 48935;
