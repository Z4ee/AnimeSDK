...
#define RPG_CLIENT_GRIDFIGHTEQUIPACTIVEEFFECT_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xA47AB60)
#define RPG_CLIENT_GRIDFIGHTEQUIPACTIVEEFFECT_METHOD_6_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0xA47AA30)
#define RPG_CLIENT_GRIDFIGHTEQUIPACTIVEEFFECT_PLAY_OFFSET UNITYSDK_OFFSET(0xA471A80)
#define RPG_CLIENT_GRIDFIGHTEQUIPACTIVEEFFECT_UPDATE_OFFSET UNITYSDK_OFFSET(0xA47A9E0)
#define RPG_CLIENT_GRIDFIGHTEQUIPACTIVEEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xA47ABF0)
#define RPG_CLIENT_GRIDFIGHTEQUIPACTIVEEFFECT___IFIXBASEPROXY_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xA47AC00)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightEquipActiveEffect_TypeDefinitionIndex = 59323;
