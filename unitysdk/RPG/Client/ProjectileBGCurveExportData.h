...
#define RPG_CLIENT_PROJECTILEBGCURVEEXPORTDATA_METHOD_1_210CB3660FB375EC_OFFSET UNITYSDK_OFFSET(0xAD78390)
#define RPG_CLIENT_PROJECTILEBGCURVEEXPORTDATA_METHOD_1_7ABAA176B11E9110_OFFSET UNITYSDK_OFFSET(0xAD77EC0)
#define RPG_CLIENT_PROJECTILEBGCURVEEXPORTDATA_METHOD_1_B058944D5BF068A2_OFFSET UNITYSDK_OFFSET(0xAD77F40)
#define RPG_CLIENT_PROJECTILEBGCURVEEXPORTDATA_METHOD_1_B1E3EF67E57221AF_OFFSET UNITYSDK_OFFSET(0xAD78060)
#define RPG_CLIENT_PROJECTILEBGCURVEEXPORTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xAD787C0)

namespace RPG::Client
{
	inline static constexpr unsigned int ProjectileBGCurveExportData_TypeDefinitionIndex = 64662;
