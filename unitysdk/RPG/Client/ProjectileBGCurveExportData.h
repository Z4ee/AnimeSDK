...
#define RPG_CLIENT_PROJECTILEBGCURVEEXPORTDATA_METHOD_1_249978DCCF562911_OFFSET UNITYSDK_OFFSET(0x193A1A40)
#define RPG_CLIENT_PROJECTILEBGCURVEEXPORTDATA_METHOD_1_7ABAA176B11E9110_OFFSET UNITYSDK_OFFSET(0x193A19C0)
#define RPG_CLIENT_PROJECTILEBGCURVEEXPORTDATA_METHOD_1_9D5BEBE295BE65D4_OFFSET UNITYSDK_OFFSET(0x193A1B40)
#define RPG_CLIENT_PROJECTILEBGCURVEEXPORTDATA_METHOD_1_D2B4A479609D9515_OFFSET UNITYSDK_OFFSET(0x193A1DD0)
#define RPG_CLIENT_PROJECTILEBGCURVEEXPORTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x193A2270)

namespace RPG::Client
{
	inline static constexpr unsigned int ProjectileBGCurveExportData_TypeDefinitionIndex = 67000;
