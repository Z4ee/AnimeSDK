...
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL_CLASS_1_21454C4E6B2A8467_GET_TRACKER_OFFSET UNITYSDK_OFFSET(0xA989CA0)
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL_CLASS_1_21454C4E6B2A8467_METHOD_1_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0xA9883C0)
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL_CLASS_1_21454C4E6B2A8467_SET_TRACKER_OFFSET UNITYSDK_OFFSET(0xA989CB0)
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL_CLASS_1_21454C4E6B2A8467__CTOR_OFFSET UNITYSDK_OFFSET(0xA989030)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginCyreneMirrorControl_Class_1_21454C4E6B2A8467_TypeDefinitionIndex = 64518;
