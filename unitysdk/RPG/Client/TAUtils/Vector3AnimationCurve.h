...
#define RPG_CLIENT_TAUTILS_VECTOR3ANIMATIONCURVE_METHOD_1_0FDE67E8BCF7203D_OFFSET UNITYSDK_OFFSET(0xB274950)
#define RPG_CLIENT_TAUTILS_VECTOR3ANIMATIONCURVE_METHOD_1_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0xB274CD0)
#define RPG_CLIENT_TAUTILS_VECTOR3ANIMATIONCURVE_METHOD_1_9D28E30D3F31147B_OFFSET UNITYSDK_OFFSET(0xB277120)
#define RPG_CLIENT_TAUTILS_VECTOR3ANIMATIONCURVE_METHOD_1_BEFE6ADDA38A85A9_1_OFFSET UNITYSDK_OFFSET(0xB2772F0)
#define RPG_CLIENT_TAUTILS_VECTOR3ANIMATIONCURVE_METHOD_1_BEFE6ADDA38A85A9_OFFSET UNITYSDK_OFFSET(0xB277210)
#define RPG_CLIENT_TAUTILS_VECTOR3ANIMATIONCURVE__CCTOR_OFFSET UNITYSDK_OFFSET(0xB2773D0)
#define RPG_CLIENT_TAUTILS_VECTOR3ANIMATIONCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0xB277200)

namespace RPG::Client::TAUtils
{
	inline static constexpr unsigned int Vector3AnimationCurve_TypeDefinitionIndex = 67778;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::RPG::Client::TAUtils::Vector3AnimationCurve*>**)Il2CppClass::FromTypeDefinitionIndex(Vector3AnimationCurve_TypeDefinitionIndex)->GetStaticField(0x30710);
		}
