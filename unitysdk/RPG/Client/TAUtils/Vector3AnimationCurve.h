...
#define RPG_CLIENT_TAUTILS_VECTOR3ANIMATIONCURVE_METHOD_1_0FDE67E8BCF7203D_OFFSET UNITYSDK_OFFSET(0xE1518C0)
#define RPG_CLIENT_TAUTILS_VECTOR3ANIMATIONCURVE_METHOD_1_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0xE151C40)
#define RPG_CLIENT_TAUTILS_VECTOR3ANIMATIONCURVE_METHOD_1_9D28E30D3F31147B_OFFSET UNITYSDK_OFFSET(0xE1544A0)
#define RPG_CLIENT_TAUTILS_VECTOR3ANIMATIONCURVE_METHOD_1_BEFE6ADDA38A85A9_1_OFFSET UNITYSDK_OFFSET(0xE154670)
#define RPG_CLIENT_TAUTILS_VECTOR3ANIMATIONCURVE_METHOD_1_BEFE6ADDA38A85A9_OFFSET UNITYSDK_OFFSET(0xE154590)
#define RPG_CLIENT_TAUTILS_VECTOR3ANIMATIONCURVE__CCTOR_OFFSET UNITYSDK_OFFSET(0xE154750)
#define RPG_CLIENT_TAUTILS_VECTOR3ANIMATIONCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0xE154580)

namespace RPG::Client::TAUtils
{
	inline static constexpr unsigned int Vector3AnimationCurve_TypeDefinitionIndex = 73537;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::RPG::Client::TAUtils::Vector3AnimationCurve*>**)Il2CppClass::FromTypeDefinitionIndex(Vector3AnimationCurve_TypeDefinitionIndex)->GetStaticField(0x3CAE0);
		}
