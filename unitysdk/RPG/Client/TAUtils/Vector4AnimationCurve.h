...
#define RPG_CLIENT_TAUTILS_VECTOR4ANIMATIONCURVE_METHOD_1_0C019665D0CC67CB_OFFSET UNITYSDK_OFFSET(0x1B400240)
#define RPG_CLIENT_TAUTILS_VECTOR4ANIMATIONCURVE_METHOD_1_1DE6310FB0FDE57C_OFFSET UNITYSDK_OFFSET(0x1B400320)
#define RPG_CLIENT_TAUTILS_VECTOR4ANIMATIONCURVE_METHOD_1_9037F1E5607EA334_OFFSET UNITYSDK_OFFSET(0x1B400110)
#define RPG_CLIENT_TAUTILS_VECTOR4ANIMATIONCURVE_METHOD_1_97D3CF39CEBC3FD8_OFFSET UNITYSDK_OFFSET(0x1B4005D0)
#define RPG_CLIENT_TAUTILS_VECTOR4ANIMATIONCURVE_METHOD_1_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0x1B3FD330)
#define RPG_CLIENT_TAUTILS_VECTOR4ANIMATIONCURVE_METHOD_1_AD3AC8692C6030B9_OFFSET UNITYSDK_OFFSET(0x1B3FD040)
#define RPG_CLIENT_TAUTILS_VECTOR4ANIMATIONCURVE_METHOD_1_D27E6346B87373D4_1_OFFSET UNITYSDK_OFFSET(0x1B4007E0)
#define RPG_CLIENT_TAUTILS_VECTOR4ANIMATIONCURVE_METHOD_1_D27E6346B87373D4_OFFSET UNITYSDK_OFFSET(0x1B4006E0)
#define RPG_CLIENT_TAUTILS_VECTOR4ANIMATIONCURVE_METHOD_1_E963C7803068697A_OFFSET UNITYSDK_OFFSET(0x1B400500)
#define RPG_CLIENT_TAUTILS_VECTOR4ANIMATIONCURVE_METHOD_1_ED34DCC6F6541B09_OFFSET UNITYSDK_OFFSET(0x1B400460)
#define RPG_CLIENT_TAUTILS_VECTOR4ANIMATIONCURVE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B4008E0)
#define RPG_CLIENT_TAUTILS_VECTOR4ANIMATIONCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4006D0)

namespace RPG::Client::TAUtils
{
	inline static constexpr unsigned int Vector4AnimationCurve_TypeDefinitionIndex = 73537;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::RPG::Client::TAUtils::Vector4AnimationCurve*>**)Il2CppClass::FromTypeDefinitionIndex(Vector4AnimationCurve_TypeDefinitionIndex)->GetStaticField(0x3E260);
		}
