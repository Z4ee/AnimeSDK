...
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALPATHS_EQUALS_1_OFFSET UNITYSDK_OFFSET(0xA538490)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALPATHS_EQUALS_OFFSET UNITYSDK_OFFSET(0xA5383C0)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALPATHS_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xA538610)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALPATHS_GET_MATERIALS_OFFSET UNITYSDK_OFFSET(0xA537DB0)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALPATHS_METHOD_1_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0xA538070)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALPATHS_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xA538370)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALPATHS_METHOD_1_FDF9B21BA16000B3_OFFSET UNITYSDK_OFFSET(0xA5380E0)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALPATHS__CTOR_OFFSET UNITYSDK_OFFSET(0xA538690)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALPATHS___IFIXBASEPROXY_EQUALS_OFFSET UNITYSDK_OFFSET(0xA538730)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALPATHS___IFIXBASEPROXY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xA538740)

namespace RPG::Client::TAUtils
{
	inline static constexpr unsigned int RendererSlotMaterialPaths_TypeDefinitionIndex = 60367;
