...
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALPATHS_EQUALS_1_OFFSET UNITYSDK_OFFSET(0xC9C3100)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALPATHS_EQUALS_OFFSET UNITYSDK_OFFSET(0xC9C3030)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALPATHS_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xC9C3280)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALPATHS_GET_MATERIALS_OFFSET UNITYSDK_OFFSET(0xC9C2A70)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALPATHS_METHOD_1_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0xC9C2D50)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALPATHS_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xC9C2FE0)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALPATHS_METHOD_1_F773D945760BF918_OFFSET UNITYSDK_OFFSET(0xC9C2DC0)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALPATHS__CTOR_OFFSET UNITYSDK_OFFSET(0xC9C3300)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALPATHS___IFIXBASEPROXY_EQUALS_OFFSET UNITYSDK_OFFSET(0xC9C33A0)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALPATHS___IFIXBASEPROXY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xC9C33B0)

namespace RPG::Client::TAUtils
{
	inline static constexpr unsigned int RendererSlotMaterialPaths_TypeDefinitionIndex = 68743;
	...
	public:
		...
		{
			return ((::System::Boolean(*)(::PVOID, ::System::Object*))((::PBYTE)hIl2Cpp + RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALPATHS___IFIXBASEPROXY_EQUALS_OFFSET))(this, a1);
		}
