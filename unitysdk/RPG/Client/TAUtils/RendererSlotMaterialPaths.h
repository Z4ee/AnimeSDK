...
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALPATHS_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1975CB90)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALPATHS_EQUALS_OFFSET UNITYSDK_OFFSET(0x1975C9D0)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALPATHS_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1975CDF0)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALPATHS_GET_MATERIALS_OFFSET UNITYSDK_OFFSET(0x1975C410)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALPATHS_METHOD_1_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0x1975C6F0)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALPATHS_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1975C980)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALPATHS_METHOD_1_F773D945760BF918_OFFSET UNITYSDK_OFFSET(0x1975C760)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALPATHS__CTOR_OFFSET UNITYSDK_OFFSET(0x1975CE70)

namespace RPG::Client::TAUtils
{
	inline static constexpr unsigned int RendererSlotMaterialPaths_TypeDefinitionIndex = 70243;
