...
#define RPG_CLIENT_TAUTILS_MATERIALPROPERTIESCOLLECTION_PROPERTY_GET_PROPERTYID_OFFSET UNITYSDK_OFFSET(0xB271DA0)
#define RPG_CLIENT_TAUTILS_MATERIALPROPERTIESCOLLECTION_PROPERTY_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xB2722D0)
#define RPG_CLIENT_TAUTILS_MATERIALPROPERTIESCOLLECTION_PROPERTY_SET_PROPERTYID_OFFSET UNITYSDK_OFFSET(0xB272330)
#define RPG_CLIENT_TAUTILS_MATERIALPROPERTIESCOLLECTION_PROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0xB272340)

namespace RPG::Client::TAUtils
{
	inline static constexpr unsigned int MaterialPropertiesCollection_Property_TypeDefinitionIndex = 67752;
