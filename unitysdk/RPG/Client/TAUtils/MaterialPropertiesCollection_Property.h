...
#define RPG_CLIENT_TAUTILS_MATERIALPROPERTIESCOLLECTION_PROPERTY_GET_PROPERTYID_OFFSET UNITYSDK_OFFSET(0xA534C40)
#define RPG_CLIENT_TAUTILS_MATERIALPROPERTIESCOLLECTION_PROPERTY_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xA535160)
#define RPG_CLIENT_TAUTILS_MATERIALPROPERTIESCOLLECTION_PROPERTY_SET_PROPERTYID_OFFSET UNITYSDK_OFFSET(0xA5351C0)
#define RPG_CLIENT_TAUTILS_MATERIALPROPERTIESCOLLECTION_PROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0xA5351D0)

namespace RPG::Client::TAUtils
{
	inline static constexpr unsigned int MaterialPropertiesCollection_Property_TypeDefinitionIndex = 60334;
