...
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_055B57D0803DA902_OFFSET UNITYSDK_OFFSET(0x19755950)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_05903074FA8D7D0E_OFFSET UNITYSDK_OFFSET(0x19754EB0)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_06AF7B1A8280FE42_OFFSET UNITYSDK_OFFSET(0x197556F0)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_12419F56E798761A_OFFSET UNITYSDK_OFFSET(0x19755A40)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_1F62297D5DF54B30_OFFSET UNITYSDK_OFFSET(0x19755EE0)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_215094CBF7E59C93_OFFSET UNITYSDK_OFFSET(0x19755510)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_26607977B1AEDB16_OFFSET UNITYSDK_OFFSET(0x19755D40)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_29F27E8C5DCE54E0_OFFSET UNITYSDK_OFFSET(0x19754F30)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_35384A5071CCB96B_OFFSET UNITYSDK_OFFSET(0x19754FF0)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_419D6E7DF60B6F0B_OFFSET UNITYSDK_OFFSET(0x19755BF0)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_42988FE8E033FE1E_OFFSET UNITYSDK_OFFSET(0x19754D00)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_5D9BA1D54A3CDB62_OFFSET UNITYSDK_OFFSET(0x19754CB0)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_5E4EF3B56A795F4D_OFFSET UNITYSDK_OFFSET(0x197555A0)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_5FF1E2B8FCD9B46C_OFFSET UNITYSDK_OFFSET(0x19755400)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_64629612F3646911_OFFSET UNITYSDK_OFFSET(0x19754DC0)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_6CB5060D47BF8A1B_OFFSET UNITYSDK_OFFSET(0x19754E40)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_6DACC73747E6207C_OFFSET UNITYSDK_OFFSET(0x19755490)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_700FE3C732AA435C_OFFSET UNITYSDK_OFFSET(0x19755DD0)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_72E21666A5A5FB58_OFFSET UNITYSDK_OFFSET(0x19755C90)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_791E87BBA5976F0D_OFFSET UNITYSDK_OFFSET(0x197550D0)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_7EB309CB8EB8090D_OFFSET UNITYSDK_OFFSET(0x19755E60)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_803418CD50931138_OFFSET UNITYSDK_OFFSET(0x197557F0)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_859F5F716A958C95_OFFSET UNITYSDK_OFFSET(0x19755370)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_969EF16C38E0FD30_OFFSET UNITYSDK_OFFSET(0x19755160)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_A07C2061B55C1547_OFFSET UNITYSDK_OFFSET(0x197549E0)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_A2B3632F424D6B51_OFFSET UNITYSDK_OFFSET(0x197558E0)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_AEFAF1FAD171856E_OFFSET UNITYSDK_OFFSET(0x19755670)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_B377DFA91C103BC2_OFFSET UNITYSDK_OFFSET(0x19755B50)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_C24D72355EC8903A_OFFSET UNITYSDK_OFFSET(0x19755860)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_C4D9B4D8C0CE03AD_OFFSET UNITYSDK_OFFSET(0x197552E0)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_C5D43255E85826E1_OFFSET UNITYSDK_OFFSET(0x19755AC0)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_C6E14CE377D03CE0_OFFSET UNITYSDK_OFFSET(0x19754D60)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_C8F6DE35233C6A4C_OFFSET UNITYSDK_OFFSET(0x19755260)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_CEE72EAC18ECC163_OFFSET UNITYSDK_OFFSET(0x197559D0)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_E192DE9421E8351F_OFFSET UNITYSDK_OFFSET(0x19755770)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_EB206643D64D33FB_OFFSET UNITYSDK_OFFSET(0x197551E0)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_F0553A46AEC8DA0F_OFFSET UNITYSDK_OFFSET(0x19755060)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_METHOD_3_FD3B916300F77FDA_OFFSET UNITYSDK_OFFSET(0x19754590)
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL__CTOR_OFFSET UNITYSDK_OFFSET(0x19755F50)

namespace RPG::Client::TAUtils
{
	inline static constexpr unsigned int ComputeMaterial_TypeDefinitionIndex = 70203;
