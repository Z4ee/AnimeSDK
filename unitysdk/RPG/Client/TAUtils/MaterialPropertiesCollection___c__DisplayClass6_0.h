...
#define RPG_CLIENT_TAUTILS_MATERIALPROPERTIESCOLLECTION___C__DISPLAYCLASS6_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3F74F0)
#define RPG_CLIENT_TAUTILS_MATERIALPROPERTIESCOLLECTION___C__DISPLAYCLASS6_0__REMOVE_B__0_OFFSET UNITYSDK_OFFSET(0x1B3FA1A0)

namespace RPG::Client::TAUtils
{
	inline static constexpr unsigned int MaterialPropertiesCollection___c__DisplayClass6_0_TypeDefinitionIndex = 73522;
