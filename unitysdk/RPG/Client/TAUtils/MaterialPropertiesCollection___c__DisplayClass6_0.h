...
#define RPG_CLIENT_TAUTILS_MATERIALPROPERTIESCOLLECTION___C__DISPLAYCLASS6_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC9BCD10)
#define RPG_CLIENT_TAUTILS_MATERIALPROPERTIESCOLLECTION___C__DISPLAYCLASS6_0__REMOVE_B__0_OFFSET UNITYSDK_OFFSET(0xC9BF9B0)

namespace RPG::Client::TAUtils
{
	inline static constexpr unsigned int MaterialPropertiesCollection___c__DisplayClass6_0_TypeDefinitionIndex = 68725;
