...
#define RPG_CLIENT_TAUTILS_COMPUTEMATERIAL_VECTORPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3F6F70)

namespace RPG::Client::TAUtils
{
	inline static constexpr unsigned int ComputeMaterial_VectorProperty_TypeDefinitionIndex = 73504;
