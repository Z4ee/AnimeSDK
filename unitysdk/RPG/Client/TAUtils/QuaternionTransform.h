...
#define RPG_CLIENT_TAUTILS_QUATERNIONTRANSFORM_GET_INIT_OFFSET UNITYSDK_OFFSET(0xA537410)
#define RPG_CLIENT_TAUTILS_QUATERNIONTRANSFORM_GET_MATRIX_OFFSET UNITYSDK_OFFSET(0x84720)
#define RPG_CLIENT_TAUTILS_QUATERNIONTRANSFORM_GET_ROTATIONEULER_OFFSET UNITYSDK_OFFSET(0x84700)
#define RPG_CLIENT_TAUTILS_QUATERNIONTRANSFORM_GET_ROTATIONQUATERNION_OFFSET UNITYSDK_OFFSET(0x846E0)
#define RPG_CLIENT_TAUTILS_QUATERNIONTRANSFORM_METHOD_2_5401F29DB96ED85D_OFFSET UNITYSDK_OFFSET(0xA537240)
#define RPG_CLIENT_TAUTILS_QUATERNIONTRANSFORM_METHOD_2_AFB7020F8546C146_OFFSET UNITYSDK_OFFSET(0x84740)

namespace RPG::Client::TAUtils
{
	inline static constexpr unsigned int QuaternionTransform_TypeDefinitionIndex = 60359;
