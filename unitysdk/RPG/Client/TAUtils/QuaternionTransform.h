...
#define RPG_CLIENT_TAUTILS_QUATERNIONTRANSFORM_GET_INIT_OFFSET UNITYSDK_OFFSET(0xC9C20F0)
#define RPG_CLIENT_TAUTILS_QUATERNIONTRANSFORM_GET_MATRIX_OFFSET UNITYSDK_OFFSET(0x143F90)
#define RPG_CLIENT_TAUTILS_QUATERNIONTRANSFORM_GET_ROTATIONEULER_OFFSET UNITYSDK_OFFSET(0x143F70)
#define RPG_CLIENT_TAUTILS_QUATERNIONTRANSFORM_GET_ROTATIONQUATERNION_OFFSET UNITYSDK_OFFSET(0x143F50)
#define RPG_CLIENT_TAUTILS_QUATERNIONTRANSFORM_METHOD_2_5401F29DB96ED85D_OFFSET UNITYSDK_OFFSET(0xC9C1F20)
#define RPG_CLIENT_TAUTILS_QUATERNIONTRANSFORM_METHOD_2_AFB7020F8546C146_OFFSET UNITYSDK_OFFSET(0x143FB0)

namespace RPG::Client::TAUtils
{
	inline static constexpr unsigned int QuaternionTransform_TypeDefinitionIndex = 68735;
