...
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALS_EQUALS_1_OFFSET UNITYSDK_OFFSET(0xA538AF0)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALS_EQUALS_OFFSET UNITYSDK_OFFSET(0xA538A20)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALS_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xA538C70)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALS_METHOD_1_A07C2061B55C1547_OFFSET UNITYSDK_OFFSET(0xA538750)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALS_METHOD_1_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0xA5389B0)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALS__CTOR_OFFSET UNITYSDK_OFFSET(0xA538CF0)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALS___IFIXBASEPROXY_EQUALS_OFFSET UNITYSDK_OFFSET(0xA538D90)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALS___IFIXBASEPROXY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xA538DA0)

namespace RPG::Client::TAUtils
{
	inline static constexpr unsigned int RendererSlotMaterials_TypeDefinitionIndex = 60365;
