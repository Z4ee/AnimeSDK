...
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALS_EQUALS_1_OFFSET UNITYSDK_OFFSET(0xC9C36F0)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALS_EQUALS_OFFSET UNITYSDK_OFFSET(0xC9C3620)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALS_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xC9C3870)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALS_METHOD_1_7223CD34BEFCBF48_OFFSET UNITYSDK_OFFSET(0xC9C33C0)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALS_METHOD_1_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0xC9C35B0)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALS__CTOR_OFFSET UNITYSDK_OFFSET(0xC9C38F0)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALS___IFIXBASEPROXY_EQUALS_OFFSET UNITYSDK_OFFSET(0xC9C3990)
#define RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALS___IFIXBASEPROXY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xC9C39A0)

namespace RPG::Client::TAUtils
{
	inline static constexpr unsigned int RendererSlotMaterials_TypeDefinitionIndex = 68741;
	...
	public:
		...
		{
			return ((::System::Boolean(*)(::PVOID, ::System::Object*))((::PBYTE)hIl2Cpp + RPG_CLIENT_TAUTILS_RENDERERSLOTMATERIALS___IFIXBASEPROXY_EQUALS_OFFSET))(this, a1);
		}
