...
#define RPG_CLIENT_BATTLEALERTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xB3BA090)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleAlertParam_TypeDefinitionIndex = 68442;
