...
#define RPG_CLIENT_BATTLEALERTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x9DE3020)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleAlertParam_TypeDefinitionIndex = 67490;
