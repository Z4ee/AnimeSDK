...
#define RPG_CLIENT_EXPEDITIONBATTLESTAGEDETAILVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0x1B897140)
#define RPG_CLIENT_EXPEDITIONBATTLESTAGEDETAILVIEWMODEL_GET_ALLMAPITEMS_OFFSET UNITYSDK_OFFSET(0x1B897070)
#define RPG_CLIENT_EXPEDITIONBATTLESTAGEDETAILVIEWMODEL_GET_CURRENTINDEX_OFFSET UNITYSDK_OFFSET(0x1B897100)
#define RPG_CLIENT_EXPEDITIONBATTLESTAGEDETAILVIEWMODEL_GET_CURRENTMAPITEMVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1B897030)
#define RPG_CLIENT_EXPEDITIONBATTLESTAGEDETAILVIEWMODEL_GET_CURRENTROUTERECORDS_OFFSET UNITYSDK_OFFSET(0x1B897050)
#define RPG_CLIENT_EXPEDITIONBATTLESTAGEDETAILVIEWMODEL_GET_MAPCOUNT_OFFSET UNITYSDK_OFFSET(0x1B8970B0)
#define RPG_CLIENT_EXPEDITIONBATTLESTAGEDETAILVIEWMODEL_ISSELECTEDFIRSTITEM_OFFSET UNITYSDK_OFFSET(0x1B8976C0)
#define RPG_CLIENT_EXPEDITIONBATTLESTAGEDETAILVIEWMODEL_ISSELECTEDLASTITEM_OFFSET UNITYSDK_OFFSET(0x1B897710)
#define RPG_CLIENT_EXPEDITIONBATTLESTAGEDETAILVIEWMODEL_SELECTBYMAPID_OFFSET UNITYSDK_OFFSET(0x1B897570)
#define RPG_CLIENT_EXPEDITIONBATTLESTAGEDETAILVIEWMODEL_SELECTNEXT_OFFSET UNITYSDK_OFFSET(0x1B897650)
#define RPG_CLIENT_EXPEDITIONBATTLESTAGEDETAILVIEWMODEL_SELECTPREV_OFFSET UNITYSDK_OFFSET(0x1B8975E0)
#define RPG_CLIENT_EXPEDITIONBATTLESTAGEDETAILVIEWMODEL_SET_CURRENTMAPITEMVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1B897040)
#define RPG_CLIENT_EXPEDITIONBATTLESTAGEDETAILVIEWMODEL_SET_CURRENTROUTERECORDS_OFFSET UNITYSDK_OFFSET(0x1B897060)
#define RPG_CLIENT_EXPEDITIONBATTLESTAGEDETAILVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8972F0)
#define RPG_CLIENT_EXPEDITIONBATTLESTAGEDETAILVIEWMODEL__GETINDEXBYMAPID_OFFSET UNITYSDK_OFFSET(0x1B897330)
#define RPG_CLIENT_EXPEDITIONBATTLESTAGEDETAILVIEWMODEL__UPDATECURRENTSELECTION_OFFSET UNITYSDK_OFFSET(0x1B897440)
#define RPG_CLIENT_EXPEDITIONBATTLESTAGEDETAILVIEWMODEL__UPDATEROUTERECORDS_OFFSET UNITYSDK_OFFSET(0x1B897770)
...
namespace RPG::Client
{
	...
	public:
		...
		::RPG::Client::ExpeditionBattleMapItemViewModel* _CurrentMapItemViewModel_k__BackingField; // 0x28
		::Class_1_65EC9CACFF41765E* _MapService; // 0x30
		::Class_1_C350877AE912EE6F* _MonsterService; // 0x38
		::System::Collections::Generic::List_1<::RPG::Client::ExpeditionBattleRouteRecordViewModel*>* _CurrentRouteRecords_k__BackingField; // 0x40
