...
#define RPG_CLIENT_CAMERASOMATODYNAMICOFFSET_METHOD_1_0FDE67E8BCF7203D_OFFSET UNITYSDK_OFFSET(0x925B990)
#define RPG_CLIENT_CAMERASOMATODYNAMICOFFSET_METHOD_1_4ACC2F8684BE1D57_1_OFFSET UNITYSDK_OFFSET(0x925BB20)
#define RPG_CLIENT_CAMERASOMATODYNAMICOFFSET_METHOD_1_4ACC2F8684BE1D57_OFFSET UNITYSDK_OFFSET(0x925BA60)
#define RPG_CLIENT_CAMERASOMATODYNAMICOFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x925BBE0)

namespace RPG::Client
{
	inline static constexpr unsigned int CameraSomatoDynamicOffset_TypeDefinitionIndex = 57012;
