...
#define RPG_CLIENT_CAMERASOMATODYNAMICOFFSET_METHOD_1_0FDE67E8BCF7203D_OFFSET UNITYSDK_OFFSET(0x9F1F5F0)
#define RPG_CLIENT_CAMERASOMATODYNAMICOFFSET_METHOD_1_4ACC2F8684BE1D57_1_OFFSET UNITYSDK_OFFSET(0x9F1F780)
#define RPG_CLIENT_CAMERASOMATODYNAMICOFFSET_METHOD_1_4ACC2F8684BE1D57_OFFSET UNITYSDK_OFFSET(0x9F1F6C0)
#define RPG_CLIENT_CAMERASOMATODYNAMICOFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x9F1F840)

namespace RPG::Client
{
	inline static constexpr unsigned int CameraSomatoDynamicOffset_TypeDefinitionIndex = 64262;
