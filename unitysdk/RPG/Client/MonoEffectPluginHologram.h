...
#define RPG_CLIENT_MONOEFFECTPLUGINHOLOGRAM_METHOD_8_092CD57850778EFC_OFFSET UNITYSDK_OFFSET(0xA994F20)
#define RPG_CLIENT_MONOEFFECTPLUGINHOLOGRAM_METHOD_8_29352E75304CF2A0_OFFSET UNITYSDK_OFFSET(0xA994C40)
#define RPG_CLIENT_MONOEFFECTPLUGINHOLOGRAM__CTOR_OFFSET UNITYSDK_OFFSET(0xA994F00)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginHologram_TypeDefinitionIndex = 64537;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_MONOEFFECTPLUGINHOLOGRAM_METHOD_8_092CD57850778EFC_OFFSET))(this);
		}
	};
}
