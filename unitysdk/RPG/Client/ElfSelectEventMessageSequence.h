...
#define RPG_CLIENT_ELFSELECTEVENTMESSAGESEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x18D82550)

namespace RPG::Client
{
	inline static constexpr unsigned int ElfSelectEventMessageSequence_TypeDefinitionIndex = 60881;
