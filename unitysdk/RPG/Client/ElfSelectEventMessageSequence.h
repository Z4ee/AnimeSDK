...
#define RPG_CLIENT_ELFSELECTEVENTMESSAGESEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0xCE922E0)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::Collections::Generic::List_1<::RPG::Client::ElfSelectEventMessageData*>* OptionList; // 0x20
