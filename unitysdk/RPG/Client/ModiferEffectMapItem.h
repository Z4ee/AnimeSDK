...
#define RPG_CLIENT_MODIFEREFFECTMAPITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x19E259E0)

namespace RPG::Client
{
	inline static constexpr unsigned int ModiferEffectMapItem_TypeDefinitionIndex = 70094;
