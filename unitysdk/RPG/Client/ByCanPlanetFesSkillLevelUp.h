...
#define RPG_CLIENT_BYCANPLANETFESSKILLLEVELUP_METHOD_4_8FB9966913FBE426_OFFSET UNITYSDK_OFFSET(0x1B9E2BC0)
#define RPG_CLIENT_BYCANPLANETFESSKILLLEVELUP_METHOD_4_9EA2B899F24FDFD1_OFFSET UNITYSDK_OFFSET(0x1B9E2D30)
#define RPG_CLIENT_BYCANPLANETFESSKILLLEVELUP_METHOD_4_D33DBF8257F32225_OFFSET UNITYSDK_OFFSET(0x1B9E2B80)
#define RPG_CLIENT_BYCANPLANETFESSKILLLEVELUP_METHOD_4_DD7FC4675DECA9B0_OFFSET UNITYSDK_OFFSET(0x1B9E2D00)
#define RPG_CLIENT_BYCANPLANETFESSKILLLEVELUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9E2BB0)

namespace RPG::Client
{
	inline static constexpr unsigned int ByCanPlanetFesSkillLevelUp_TypeDefinitionIndex = 9960;
