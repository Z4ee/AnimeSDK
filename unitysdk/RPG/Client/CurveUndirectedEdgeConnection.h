...
#define RPG_CLIENT_CURVEUNDIRECTEDEDGECONNECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x943C230)

namespace RPG::Client
{
	inline static constexpr unsigned int CurveUndirectedEdgeConnection_TypeDefinitionIndex = 55987;
