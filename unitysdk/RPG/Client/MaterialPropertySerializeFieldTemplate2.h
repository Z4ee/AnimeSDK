...
#define RPG_CLIENT_MATERIALPROPERTYSERIALIZEFIELDTEMPLATE2_GETPROPERTYFIELDS_OFFSET UNITYSDK_OFFSET(0x9B76D00)
#define RPG_CLIENT_MATERIALPROPERTYSERIALIZEFIELDTEMPLATE2__CTOR_OFFSET UNITYSDK_OFFSET(0x9B76E80)
#define RPG_CLIENT_MATERIALPROPERTYSERIALIZEFIELDTEMPLATE2___IFIXBASEPROXY_GETPROPERTYFIELDS_OFFSET UNITYSDK_OFFSET(0x9B76E90)

namespace RPG::Client
{
	inline static constexpr unsigned int MaterialPropertySerializeFieldTemplate2_TypeDefinitionIndex = 57870;
