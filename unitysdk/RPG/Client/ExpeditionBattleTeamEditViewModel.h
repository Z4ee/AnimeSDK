...
#define RPG_CLIENT_EXPEDITIONBATTLETEAMEDITVIEWMODEL_ADDROUTELINEUP_OFFSET UNITYSDK_OFFSET(0x1B8998C0)
#define RPG_CLIENT_EXPEDITIONBATTLETEAMEDITVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0x1B899020)
#define RPG_CLIENT_EXPEDITIONBATTLETEAMEDITVIEWMODEL_GETALLAVATARLIST_OFFSET UNITYSDK_OFFSET(0x1B899140)
#define RPG_CLIENT_EXPEDITIONBATTLETEAMEDITVIEWMODEL_GETRANKVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1B899BB0)
#define RPG_CLIENT_EXPEDITIONBATTLETEAMEDITVIEWMODEL_GETROUTES_OFFSET UNITYSDK_OFFSET(0x1B899870)
#define RPG_CLIENT_EXPEDITIONBATTLETEAMEDITVIEWMODEL_GETSAVEDTEAMLIST_OFFSET UNITYSDK_OFFSET(0x1B899810)
#define RPG_CLIENT_EXPEDITIONBATTLETEAMEDITVIEWMODEL_GETSTARS_OFFSET UNITYSDK_OFFSET(0x1B899B60)
#define RPG_CLIENT_EXPEDITIONBATTLETEAMEDITVIEWMODEL_GETSTATE_OFFSET UNITYSDK_OFFSET(0x1B899AC0)
#define RPG_CLIENT_EXPEDITIONBATTLETEAMEDITVIEWMODEL_GETTEAMCOUNT_OFFSET UNITYSDK_OFFSET(0x1B8997C0)
#define RPG_CLIENT_EXPEDITIONBATTLETEAMEDITVIEWMODEL_GETTRIALAVATARLIST_OFFSET UNITYSDK_OFFSET(0x1B8990E0)
#define RPG_CLIENT_EXPEDITIONBATTLETEAMEDITVIEWMODEL_GET_MAPID_OFFSET UNITYSDK_OFFSET(0x1B898510)
#define RPG_CLIENT_EXPEDITIONBATTLETEAMEDITVIEWMODEL_GET_MAP_OFFSET UNITYSDK_OFFSET(0x1B898530)
#define RPG_CLIENT_EXPEDITIONBATTLETEAMEDITVIEWMODEL_GET_ROUTEMONSTERVIEWMODELLIST_OFFSET UNITYSDK_OFFSET(0x1B898570)
#define RPG_CLIENT_EXPEDITIONBATTLETEAMEDITVIEWMODEL_GET_ROUTERECORDVIEWMODELLIST_OFFSET UNITYSDK_OFFSET(0x1B898550)
#define RPG_CLIENT_EXPEDITIONBATTLETEAMEDITVIEWMODEL_GET_STARINFODETAILVIEWMODELLIST_OFFSET UNITYSDK_OFFSET(0x1B898590)
#define RPG_CLIENT_EXPEDITIONBATTLETEAMEDITVIEWMODEL_SENDSETLINEUPCSREQ_OFFSET UNITYSDK_OFFSET(0x1B8999E0)
#define RPG_CLIENT_EXPEDITIONBATTLETEAMEDITVIEWMODEL_SET_MAPID_OFFSET UNITYSDK_OFFSET(0x1B898520)
#define RPG_CLIENT_EXPEDITIONBATTLETEAMEDITVIEWMODEL_SET_MAP_OFFSET UNITYSDK_OFFSET(0x1B898540)
#define RPG_CLIENT_EXPEDITIONBATTLETEAMEDITVIEWMODEL_SET_ROUTEMONSTERVIEWMODELLIST_OFFSET UNITYSDK_OFFSET(0x1B898580)
#define RPG_CLIENT_EXPEDITIONBATTLETEAMEDITVIEWMODEL_SET_ROUTERECORDVIEWMODELLIST_OFFSET UNITYSDK_OFFSET(0x1B898560)
#define RPG_CLIENT_EXPEDITIONBATTLETEAMEDITVIEWMODEL_SET_STARINFODETAILVIEWMODELLIST_OFFSET UNITYSDK_OFFSET(0x1B8985A0)
#define RPG_CLIENT_EXPEDITIONBATTLETEAMEDITVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8985B0)
#define RPG_CLIENT_EXPEDITIONBATTLETEAMEDITVIEWMODEL__INITCURRENTRANKVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1B898B30)
#define RPG_CLIENT_EXPEDITIONBATTLETEAMEDITVIEWMODEL__INITROUTEMONSTERS_OFFSET UNITYSDK_OFFSET(0x1B898E00)
#define RPG_CLIENT_EXPEDITIONBATTLETEAMEDITVIEWMODEL__INITROUTEMONSTERVIEWMODELLIST_OFFSET UNITYSDK_OFFSET(0x1B8986C0)
#define RPG_CLIENT_EXPEDITIONBATTLETEAMEDITVIEWMODEL__INITROUTERECORDVIEWMODELLIST_OFFSET UNITYSDK_OFFSET(0x1B8988F0)
#define RPG_CLIENT_EXPEDITIONBATTLETEAMEDITVIEWMODEL__INITSTARINFODETAILVIEWMODELLIST_OFFSET UNITYSDK_OFFSET(0x1B898BE0)
...
namespace RPG::Client
{
	...
	public:
		...
		::Class_1_C350877AE912EE6F* _MonsterService; // 0x20
		::Class_2_2677292940697014* _NetworkService; // 0x28
		::System::Collections::Generic::List_1<::Class_1_B53F5451D96E4B06*>* _PendingLineups; // 0x30
		::System::Collections::Generic::List_1<::RPG::Client::ExpeditionBattleStarInfoDetailViewModel*>* _StarInfoDetailViewModelList_k__BackingField; // 0x38
		::RPG::Client::ExpeditionBattleRankViewModel* _RankViewModel; // 0x40
		::System::Collections::Generic::List_1<::RPG::Client::ExpeditionBattleRouteMonstersViewModel*>* _RouteMonsterViewModelList_k__BackingField; // 0x48
		::Class_1_9EE357109ED696DE* _ViewModelFactory; // 0x50
		::Class_1_65EC9CACFF41765E* _MapService; // 0x58
