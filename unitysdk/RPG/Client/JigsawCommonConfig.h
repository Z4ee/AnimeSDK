...
#define RPG_CLIENT_JIGSAWCOMMONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16C65260)

namespace RPG::Client
{
	inline static constexpr unsigned int JigsawCommonConfig_TypeDefinitionIndex = 57378;
