...
#define RPG_CLIENT_JIGSAWCOMMONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x194F4660)

namespace RPG::Client
{
	inline static constexpr unsigned int JigsawCommonConfig_TypeDefinitionIndex = 60180;
