...
#define RPG_CLIENT_JIGSAWCOMMONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xBD6AA80)

namespace RPG::Client
{
	inline static constexpr unsigned int JigsawCommonConfig_TypeDefinitionIndex = 56138;
