...
#define RPG_CLIENT_ELECTRICCHAIN_GET__LINELENGTH_OFFSET UNITYSDK_OFFSET(0x9591700)
#define RPG_CLIENT_ELECTRICCHAIN_METHOD_1_0987586229167119_OFFSET UNITYSDK_OFFSET(0x95917E0)
#define RPG_CLIENT_ELECTRICCHAIN_METHOD_1_497833CF065C1894_OFFSET UNITYSDK_OFFSET(0x9591D00)
#define RPG_CLIENT_ELECTRICCHAIN_METHOD_1_5CEF726AB76C1B8A_OFFSET UNITYSDK_OFFSET(0x9592B40)
#define RPG_CLIENT_ELECTRICCHAIN_METHOD_1_5DFCD1875A1D33F8_OFFSET UNITYSDK_OFFSET(0x9592450)
#define RPG_CLIENT_ELECTRICCHAIN_METHOD_1_6AE1D0AAD08D1613_OFFSET UNITYSDK_OFFSET(0x95927D0)
#define RPG_CLIENT_ELECTRICCHAIN_METHOD_1_81A66FB988DFA6AA_OFFSET UNITYSDK_OFFSET(0x9591FC0)
#define RPG_CLIENT_ELECTRICCHAIN_METHOD_1_8C97CA3BAB7FB2D7_OFFSET UNITYSDK_OFFSET(0x95915B0)
#define RPG_CLIENT_ELECTRICCHAIN__CTOR_OFFSET UNITYSDK_OFFSET(0x9591C30)
#define RPG_CLIENT_ELECTRICCHAIN__GETRANDOMVALUE_B__45_0_OFFSET UNITYSDK_OFFSET(0x9592E60)

namespace RPG::Client
{
	inline static constexpr unsigned int ElectricChain_TypeDefinitionIndex = 57693;
