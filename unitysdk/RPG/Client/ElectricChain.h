...
#define RPG_CLIENT_ELECTRICCHAIN_GET__LINELENGTH_OFFSET UNITYSDK_OFFSET(0x1AC552B0)
#define RPG_CLIENT_ELECTRICCHAIN_METHOD_1_0987586229167119_OFFSET UNITYSDK_OFFSET(0x1AC55390)
#define RPG_CLIENT_ELECTRICCHAIN_METHOD_1_327B82183EE4CA64_OFFSET UNITYSDK_OFFSET(0x1AC567C0)
#define RPG_CLIENT_ELECTRICCHAIN_METHOD_1_497833CF065C1894_OFFSET UNITYSDK_OFFSET(0x1AC55870)
#define RPG_CLIENT_ELECTRICCHAIN_METHOD_1_81A66FB988DFA6AA_OFFSET UNITYSDK_OFFSET(0x1AC55B30)
#define RPG_CLIENT_ELECTRICCHAIN_METHOD_1_8C97CA3BAB7FB2D7_OFFSET UNITYSDK_OFFSET(0x1AC55160)
#define RPG_CLIENT_ELECTRICCHAIN_METHOD_1_939AC45E04EF0B0A_OFFSET UNITYSDK_OFFSET(0x1AC56060)
#define RPG_CLIENT_ELECTRICCHAIN_METHOD_1_F34F99042D661F25_OFFSET UNITYSDK_OFFSET(0x1AC56420)
#define RPG_CLIENT_ELECTRICCHAIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC557A0)
#define RPG_CLIENT_ELECTRICCHAIN__GETRANDOMVALUE_B__45_0_OFFSET UNITYSDK_OFFSET(0x1AC56B70)

namespace RPG::Client
{
	inline static constexpr unsigned int ElectricChain_TypeDefinitionIndex = 70422;
