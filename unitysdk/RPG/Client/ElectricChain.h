...
#define RPG_CLIENT_ELECTRICCHAIN_GET__LINELENGTH_OFFSET UNITYSDK_OFFSET(0xCE29FA0)
#define RPG_CLIENT_ELECTRICCHAIN_METHOD_1_0987586229167119_OFFSET UNITYSDK_OFFSET(0xCE2A080)
#define RPG_CLIENT_ELECTRICCHAIN_METHOD_1_327B82183EE4CA64_OFFSET UNITYSDK_OFFSET(0xCE2B4B0)
#define RPG_CLIENT_ELECTRICCHAIN_METHOD_1_497833CF065C1894_OFFSET UNITYSDK_OFFSET(0xCE2A560)
#define RPG_CLIENT_ELECTRICCHAIN_METHOD_1_81A66FB988DFA6AA_OFFSET UNITYSDK_OFFSET(0xCE2A820)
#define RPG_CLIENT_ELECTRICCHAIN_METHOD_1_8C97CA3BAB7FB2D7_OFFSET UNITYSDK_OFFSET(0xCE29E50)
#define RPG_CLIENT_ELECTRICCHAIN_METHOD_1_939AC45E04EF0B0A_OFFSET UNITYSDK_OFFSET(0xCE2AD50)
#define RPG_CLIENT_ELECTRICCHAIN_METHOD_1_F34F99042D661F25_OFFSET UNITYSDK_OFFSET(0xCE2B110)
#define RPG_CLIENT_ELECTRICCHAIN__CTOR_OFFSET UNITYSDK_OFFSET(0xCE2A490)
#define RPG_CLIENT_ELECTRICCHAIN__GETRANDOMVALUE_B__45_0_OFFSET UNITYSDK_OFFSET(0xCE2B860)
