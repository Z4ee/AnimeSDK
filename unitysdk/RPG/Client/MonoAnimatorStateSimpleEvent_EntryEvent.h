...
#define RPG_CLIENT_MONOANIMATORSTATESIMPLEEVENT_ENTRYEVENT_METHOD_2_183DCE814B2CC19A_OFFSET UNITYSDK_OFFSET(0xA90DE90)
#define RPG_CLIENT_MONOANIMATORSTATESIMPLEEVENT_ENTRYEVENT_METHOD_2_23F4864AF47CFD90_OFFSET UNITYSDK_OFFSET(0xA90DD80)
#define RPG_CLIENT_MONOANIMATORSTATESIMPLEEVENT_ENTRYEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0xA90DF90)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoAnimatorStateSimpleEvent_EntryEvent_TypeDefinitionIndex = 63183;
