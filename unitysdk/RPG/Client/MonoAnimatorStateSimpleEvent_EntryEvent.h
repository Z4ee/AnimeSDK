...
#define RPG_CLIENT_MONOANIMATORSTATESIMPLEEVENT_ENTRYEVENT_METHOD_2_23F4864AF47CFD90_OFFSET UNITYSDK_OFFSET(0x19E29C20)
#define RPG_CLIENT_MONOANIMATORSTATESIMPLEEVENT_ENTRYEVENT_METHOD_2_3CAD769FC088779C_OFFSET UNITYSDK_OFFSET(0x19E29D40)
#define RPG_CLIENT_MONOANIMATORSTATESIMPLEEVENT_ENTRYEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19E29EC0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoAnimatorStateSimpleEvent_EntryEvent_TypeDefinitionIndex = 68486;
