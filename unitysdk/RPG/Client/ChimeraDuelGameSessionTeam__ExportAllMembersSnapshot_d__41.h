...
#define RPG_CLIENT_CHIMERADUELGAMESESSIONTEAM__EXPORTALLMEMBERSSNAPSHOT_D__41_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x93A5090)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONTEAM__EXPORTALLMEMBERSSNAPSHOT_D__41_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_RPG_CLIENT_LITTLEGAME_CHIMERADUEL_CHIMERADUELCHIMERACACHE__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x93A5280)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONTEAM__EXPORTALLMEMBERSSNAPSHOT_D__41_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_RPG_CLIENT_LITTLEGAME_CHIMERADUEL_CHIMERADUELCHIMERACACHE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x93A5210)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONTEAM__EXPORTALLMEMBERSSNAPSHOT_D__41_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x93A5300)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONTEAM__EXPORTALLMEMBERSSNAPSHOT_D__41_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x93A5270)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONTEAM__EXPORTALLMEMBERSSNAPSHOT_D__41_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x93A5220)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONTEAM__EXPORTALLMEMBERSSNAPSHOT_D__41_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x93A5080)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONTEAM__EXPORTALLMEMBERSSNAPSHOT_D__41__CTOR_OFFSET UNITYSDK_OFFSET(0x93A4ED0)

namespace RPG::Client
{
	inline static constexpr unsigned int ChimeraDuelGameSessionTeam__ExportAllMembersSnapshot_d__41_TypeDefinitionIndex = 51394;
	...
	public:
		...
		::System::Int32 _position_5__2; // 0x24
		::System::Int32 __l__initialThreadId; // 0x28

		::System::Void _ctor(::System::Int32 __1__state)
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32))((::PBYTE)hIl2Cpp + RPG_CLIENT_CHIMERADUELGAMESESSIONTEAM__EXPORTALLMEMBERSSNAPSHOT_D__41__CTOR_OFFSET))(this, __1__state);
		}
