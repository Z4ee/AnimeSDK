...
#define RPG_CLIENT_AUDIENCEPREFABSPECIALTAG__CTOR_OFFSET UNITYSDK_OFFSET(0x90EFF30)

namespace RPG::Client
{
	inline static constexpr unsigned int AudiencePrefabSpecialTag_TypeDefinitionIndex = 56485;
