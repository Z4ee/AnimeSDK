...
#define RPG_CLIENT_ELECTRICCHAINV2_SHAPE_METHOD_1_2450CFC043E97F54_OFFSET UNITYSDK_OFFSET(0xCE33280)
#define RPG_CLIENT_ELECTRICCHAINV2_SHAPE_METHOD_1_BF972395CC722BF9_OFFSET UNITYSDK_OFFSET(0xCE331A0)
#define RPG_CLIENT_ELECTRICCHAINV2_SHAPE__CTOR_OFFSET UNITYSDK_OFFSET(0xCE2C090)

namespace RPG::Client::ElectricChainV2
{
	inline static constexpr unsigned int Shape_TypeDefinitionIndex = 73487;
