...
#define RPG_CLIENT_ELECTRICCHAINV2_SHAPE_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xB8A3500)
#define RPG_CLIENT_ELECTRICCHAINV2_SHAPE_METHOD_1_FC26FA0DD9B4AAF4_OFFSET UNITYSDK_OFFSET(0xB8A2AD0)
#define RPG_CLIENT_ELECTRICCHAINV2_SHAPE__CTOR_OFFSET UNITYSDK_OFFSET(0xB89CD60)

namespace RPG::Client::ElectricChainV2
{
	inline static constexpr unsigned int Shape_TypeDefinitionIndex = 68689;
