...
#define RPG_CLIENT_ELECTRICCHAINV2_UNIFORMSAMPLER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x959A290)
#define RPG_CLIENT_ELECTRICCHAINV2_UNIFORMSAMPLER_GET_VECTOR2VALUE_OFFSET UNITYSDK_OFFSET(0x959A2A0)
#define RPG_CLIENT_ELECTRICCHAINV2_UNIFORMSAMPLER__CTOR_OFFSET UNITYSDK_OFFSET(0x959A310)

namespace RPG::Client::ElectricChainV2
{
	inline static constexpr unsigned int UniformSampler_TypeDefinitionIndex = 60311;
