...
#define RPG_CLIENT_ELECTRICCHAINV2_RANDOMUPDATER_METHOD_1_F10A0D072D26C4BF_OFFSET UNITYSDK_OFFSET(0xA21E100)
#define RPG_CLIENT_ELECTRICCHAINV2_RANDOMUPDATER_METHOD_1_FCAE20CD32D19671_OFFSET UNITYSDK_OFFSET(0xA21B1D0)
#define RPG_CLIENT_ELECTRICCHAINV2_RANDOMUPDATER__CTOR_OFFSET UNITYSDK_OFFSET(0xA21EFC0)

namespace RPG::Client::ElectricChainV2
{
	inline static constexpr unsigned int RandomUpdater_TypeDefinitionIndex = 67724;
