...
#define RPG_CLIENT_ELECTRICCHAINV2_CURVE_METHOD_2_124E7DAB85EAFECD_OFFSET UNITYSDK_OFFSET(0x9593220)
#define RPG_CLIENT_ELECTRICCHAINV2_CURVE_METHOD_2_C30F51361D1AB438_OFFSET UNITYSDK_OFFSET(0x9592FB0)
#define RPG_CLIENT_ELECTRICCHAINV2_CURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x95932A0)

namespace RPG::Client::ElectricChainV2
{
	inline static constexpr unsigned int Curve_TypeDefinitionIndex = 60322;
