...
#define RPG_CLIENT_ELECTRICCHAINV2_LINE_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x95970F0)
#define RPG_CLIENT_ELECTRICCHAINV2_LINE_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x95989B0)
#define RPG_CLIENT_ELECTRICCHAINV2_LINE_METHOD_1_EDCA216BAAE60E47_OFFSET UNITYSDK_OFFSET(0x95979D0)
#define RPG_CLIENT_ELECTRICCHAINV2_LINE__CTOR_OFFSET UNITYSDK_OFFSET(0x95932D0)

namespace RPG::Client::ElectricChainV2
{
	inline static constexpr unsigned int Line_TypeDefinitionIndex = 60319;
