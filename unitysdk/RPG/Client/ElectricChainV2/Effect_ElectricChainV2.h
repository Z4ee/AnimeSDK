...
#define RPG_CLIENT_ELECTRICCHAINV2_EFFECT_ELECTRICCHAINV2_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xCE2C390)
#define RPG_CLIENT_ELECTRICCHAINV2_EFFECT_ELECTRICCHAINV2_GET_BEHAVIOR_OFFSET UNITYSDK_OFFSET(0xCE2C250)
#define RPG_CLIENT_ELECTRICCHAINV2_EFFECT_ELECTRICCHAINV2_RESTART_OFFSET UNITYSDK_OFFSET(0xCE2C0A0)
#define RPG_CLIENT_ELECTRICCHAINV2_EFFECT_ELECTRICCHAINV2__CTOR_OFFSET UNITYSDK_OFFSET(0xCE2C3E0)

namespace RPG::Client::ElectricChainV2
{
	inline static constexpr unsigned int Effect_ElectricChainV2_TypeDefinitionIndex = 73473;
