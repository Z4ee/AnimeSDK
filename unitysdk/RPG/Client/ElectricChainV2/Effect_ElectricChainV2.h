...
#define RPG_CLIENT_ELECTRICCHAINV2_EFFECT_ELECTRICCHAINV2_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x95937C0)
#define RPG_CLIENT_ELECTRICCHAINV2_EFFECT_ELECTRICCHAINV2_GET_BEHAVIOR_OFFSET UNITYSDK_OFFSET(0x9593680)
#define RPG_CLIENT_ELECTRICCHAINV2_EFFECT_ELECTRICCHAINV2_RESTART_OFFSET UNITYSDK_OFFSET(0x95934D0)
#define RPG_CLIENT_ELECTRICCHAINV2_EFFECT_ELECTRICCHAINV2__CTOR_OFFSET UNITYSDK_OFFSET(0x9593810)
#define RPG_CLIENT_ELECTRICCHAINV2_EFFECT_ELECTRICCHAINV2___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x95939E0)

namespace RPG::Client::ElectricChainV2
{
	inline static constexpr unsigned int Effect_ElectricChainV2_TypeDefinitionIndex = 60299;
