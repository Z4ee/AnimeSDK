...
#define RPG_CLIENT_ELECTRICCHAINV2_STRAIGHTLINE_METHOD_2_527527A45EAD8A25_OFFSET UNITYSDK_OFFSET(0xCE33E80)
#define RPG_CLIENT_ELECTRICCHAINV2_STRAIGHTLINE_METHOD_2_A93CA8A3372168B2_OFFSET UNITYSDK_OFFSET(0xCE34090)
#define RPG_CLIENT_ELECTRICCHAINV2_STRAIGHTLINE__CTOR_OFFSET UNITYSDK_OFFSET(0xCE304E0)

namespace RPG::Client::ElectricChainV2
{
	inline static constexpr unsigned int StraightLine_TypeDefinitionIndex = 73494;
