...
#define RPG_CLIENT_ELECTRICCHAINV2_STRAIGHTLINE_METHOD_2_3422201382CE593B_OFFSET UNITYSDK_OFFSET(0xA220850)
#define RPG_CLIENT_ELECTRICCHAINV2_STRAIGHTLINE_METHOD_2_DF64B90BA25AAE64_OFFSET UNITYSDK_OFFSET(0xA220720)
#define RPG_CLIENT_ELECTRICCHAINV2_STRAIGHTLINE__CTOR_OFFSET UNITYSDK_OFFSET(0xA21D110)

namespace RPG::Client::ElectricChainV2
{
	inline static constexpr unsigned int StraightLine_TypeDefinitionIndex = 67738;
