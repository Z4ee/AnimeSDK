...
#define RPG_CLIENT_ELECTRICCHAINV2_STRAIGHTLINE_METHOD_2_3422201382CE593B_OFFSET UNITYSDK_OFFSET(0xB8A40E0)
#define RPG_CLIENT_ELECTRICCHAINV2_STRAIGHTLINE_METHOD_2_DF64B90BA25AAE64_OFFSET UNITYSDK_OFFSET(0xB8A3FB0)
#define RPG_CLIENT_ELECTRICCHAINV2_STRAIGHTLINE__CTOR_OFFSET UNITYSDK_OFFSET(0xB8A07F0)

namespace RPG::Client::ElectricChainV2
{
	inline static constexpr unsigned int StraightLine_TypeDefinitionIndex = 68696;
