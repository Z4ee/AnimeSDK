...
#define RPG_CLIENT_ELECTRICCHAINV2_STRAIGHTLINE_METHOD_2_527527A45EAD8A25_OFFSET UNITYSDK_OFFSET(0x1AC5F190)
#define RPG_CLIENT_ELECTRICCHAINV2_STRAIGHTLINE_METHOD_2_A93CA8A3372168B2_OFFSET UNITYSDK_OFFSET(0x1AC5F3A0)
#define RPG_CLIENT_ELECTRICCHAINV2_STRAIGHTLINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC5B7F0)

namespace RPG::Client::ElectricChainV2
{
	inline static constexpr unsigned int StraightLine_TypeDefinitionIndex = 73493;
