...
#define RPG_CLIENT_ELECTRICCHAINV2_POLYLINE_GET_LENGTHS_OFFSET UNITYSDK_OFFSET(0xCE329B0)
#define RPG_CLIENT_ELECTRICCHAINV2_POLYLINE_METHOD_2_538FE3E275DA3359_OFFSET UNITYSDK_OFFSET(0xCE325A0)
#define RPG_CLIENT_ELECTRICCHAINV2_POLYLINE_METHOD_2_653EEB7EF259681D_OFFSET UNITYSDK_OFFSET(0xCE32E50)
#define RPG_CLIENT_ELECTRICCHAINV2_POLYLINE_METHOD_2_762A9412773049BE_OFFSET UNITYSDK_OFFSET(0xCE32F20)
#define RPG_CLIENT_ELECTRICCHAINV2_POLYLINE_SET_LENGTHS_OFFSET UNITYSDK_OFFSET(0xCE330F0)
#define RPG_CLIENT_ELECTRICCHAINV2_POLYLINE__CTOR_OFFSET UNITYSDK_OFFSET(0xCE33100)

namespace RPG::Client::ElectricChainV2
{
	inline static constexpr unsigned int PolyLine_TypeDefinitionIndex = 73495;
