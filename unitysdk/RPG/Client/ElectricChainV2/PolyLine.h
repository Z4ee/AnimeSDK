...
#define RPG_CLIENT_ELECTRICCHAINV2_POLYLINE_GET_LENGTHS_OFFSET UNITYSDK_OFFSET(0x18E17A30)
#define RPG_CLIENT_ELECTRICCHAINV2_POLYLINE_METHOD_2_538FE3E275DA3359_OFFSET UNITYSDK_OFFSET(0x18E17620)
#define RPG_CLIENT_ELECTRICCHAINV2_POLYLINE_METHOD_2_653EEB7EF259681D_OFFSET UNITYSDK_OFFSET(0x18E17ED0)
#define RPG_CLIENT_ELECTRICCHAINV2_POLYLINE_METHOD_2_762A9412773049BE_OFFSET UNITYSDK_OFFSET(0x18E17FA0)
#define RPG_CLIENT_ELECTRICCHAINV2_POLYLINE_SET_LENGTHS_OFFSET UNITYSDK_OFFSET(0x18E18170)
#define RPG_CLIENT_ELECTRICCHAINV2_POLYLINE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E18180)

namespace RPG::Client::ElectricChainV2
{
	inline static constexpr unsigned int PolyLine_TypeDefinitionIndex = 70195;
