...
#define RPG_CLIENT_ELECTRICCHAINV2_POLYLINE_GET_LENGTHS_OFFSET UNITYSDK_OFFSET(0x9598FD0)
#define RPG_CLIENT_ELECTRICCHAINV2_POLYLINE_METHOD_2_19F951B38D2C86E3_OFFSET UNITYSDK_OFFSET(0x9599310)
#define RPG_CLIENT_ELECTRICCHAINV2_POLYLINE_METHOD_2_49CA198F7882284A_OFFSET UNITYSDK_OFFSET(0x9598D10)
#define RPG_CLIENT_ELECTRICCHAINV2_POLYLINE_METHOD_2_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x9599620)
#define RPG_CLIENT_ELECTRICCHAINV2_POLYLINE_METHOD_2_A66B981E1EA3E23D_OFFSET UNITYSDK_OFFSET(0x9599440)
#define RPG_CLIENT_ELECTRICCHAINV2_POLYLINE_SET_LENGTHS_OFFSET UNITYSDK_OFFSET(0x9599590)
#define RPG_CLIENT_ELECTRICCHAINV2_POLYLINE__CTOR_OFFSET UNITYSDK_OFFSET(0x95995A0)

namespace RPG::Client::ElectricChainV2
{
	inline static constexpr unsigned int PolyLine_TypeDefinitionIndex = 60321;
