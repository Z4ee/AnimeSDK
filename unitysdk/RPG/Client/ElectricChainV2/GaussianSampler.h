...
#define RPG_CLIENT_ELECTRICCHAINV2_GAUSSIANSAMPLER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x9598010)
#define RPG_CLIENT_ELECTRICCHAINV2_GAUSSIANSAMPLER_GET_VECTOR2VALUE_OFFSET UNITYSDK_OFFSET(0x9598180)
#define RPG_CLIENT_ELECTRICCHAINV2_GAUSSIANSAMPLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9597160)

namespace RPG::Client::ElectricChainV2
{
	inline static constexpr unsigned int GaussianSampler_TypeDefinitionIndex = 60312;
