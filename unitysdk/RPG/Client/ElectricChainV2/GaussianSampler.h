...
#define RPG_CLIENT_ELECTRICCHAINV2_GAUSSIANSAMPLER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1AC5CAE0)
#define RPG_CLIENT_ELECTRICCHAINV2_GAUSSIANSAMPLER_GET_VECTOR2VALUE_OFFSET UNITYSDK_OFFSET(0x1AC5CC50)
#define RPG_CLIENT_ELECTRICCHAINV2_GAUSSIANSAMPLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC5BFC0)

namespace RPG::Client::ElectricChainV2
{
	inline static constexpr unsigned int GaussianSampler_TypeDefinitionIndex = 73485;
