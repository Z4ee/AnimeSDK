...
#define RPG_CLIENT_RAIDBATTLESCORINGRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0xA274520)

namespace RPG::Client
{
	inline static constexpr unsigned int RaidBattleScoringResult_TypeDefinitionIndex = 54327;
