...
#define RPG_CLIENT_RAIDBATTLESCORINGRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0xAF63000)

namespace RPG::Client
{
	inline static constexpr unsigned int RaidBattleScoringResult_TypeDefinitionIndex = 61490;
