...
#define RPG_CLIENT_LAYERORDERADJUSTPARTICLEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x99745B0)

namespace RPG::Client
{
	inline static constexpr unsigned int LayerOrderAdjustParticleItem_TypeDefinitionIndex = 59886;
