...
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_EXITSUPEREVENTCAMERA_OFFSET UNITYSDK_OFFSET(0x95D73A0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_FOCUSSUPEREVENTCAMERA_OFFSET UNITYSDK_OFFSET(0x95D70D0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_GETALLFACILITIES_OFFSET UNITYSDK_OFFSET(0x95D1DE0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_GETCHEFENTITYGROUP_OFFSET UNITYSDK_OFFSET(0x95D2C50)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_GETCUSTOMERENTITYGROUP_OFFSET UNITYSDK_OFFSET(0x95D2D80)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_GETEMPLOYEEENTITYGROUP_OFFSET UNITYSDK_OFFSET(0x95D2B20)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_GETENTITYWITHRUNTIMEID_OFFSET UNITYSDK_OFFSET(0x95CEC40)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_GETENTRYPOSITION_OFFSET UNITYSDK_OFFSET(0x95D3910)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_GETGAMEENTITY_OFFSET UNITYSDK_OFFSET(0x95D39A0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_GETGLOBALPROPERTY_OFFSET UNITYSDK_OFFSET(0x95D3A00)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_GETHEADWAITERENTITY_OFFSET UNITYSDK_OFFSET(0x95D2EB0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_GETONSITCUSTOMERCOUNT_OFFSET UNITYSDK_OFFSET(0x95D3130)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_GETSTATETREEROOT_OFFSET UNITYSDK_OFFSET(0x95CEA50)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_GETTOTALSITCOUNT_OFFSET UNITYSDK_OFFSET(0x95D3440)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_GET_GAMECONFIG_OFFSET UNITYSDK_OFFSET(0x95D3B90)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_GET_SERVICES_OFFSET UNITYSDK_OFFSET(0x95D3B80)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_ONENTERRESTAURANTBUILD_OFFSET UNITYSDK_OFFSET(0x95CFDE0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_ONEXITRESTAURANTBUILD_OFFSET UNITYSDK_OFFSET(0x95D0420)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_PAUSEGAME_OFFSET UNITYSDK_OFFSET(0x95D3C00)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_RESUMEGAME_OFFSET UNITYSDK_OFFSET(0x95D40B0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_SETGLOBALPROPERTY_OFFSET UNITYSDK_OFFSET(0x95D3AB0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_SETPREVIEWFACILITYACTIVE_OFFSET UNITYSDK_OFFSET(0x95D7EB0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE_UPGRADEFACILITY_OFFSET UNITYSDK_OFFSET(0x95D0E00)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__ADDNOTIFY_OFFSET UNITYSDK_OFFSET(0x95CF460)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__APPLYTRANSPARENTMATERIAL_1_OFFSET UNITYSDK_OFFSET(0x95D7B00)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__APPLYTRANSPARENTMATERIAL_OFFSET UNITYSDK_OFFSET(0x95D7A40)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__CACHEORIGINALMATERIALS_1_OFFSET UNITYSDK_OFFSET(0x95D7800)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__CACHEORIGINALMATERIALS_OFFSET UNITYSDK_OFFSET(0x95D7740)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__CCTOR_OFFSET UNITYSDK_OFFSET(0x95D87F0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__CLEARTABLEOUTLINE_OFFSET UNITYSDK_OFFSET(0x95D57B0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__CREATEGAMECONTEXT_OFFSET UNITYSDK_OFFSET(0x95CEE50)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x95D8710)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__DESTROYGAMECONTEXT_OFFSET UNITYSDK_OFFSET(0x95CFB90)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__DISPOSEUIMEDIATOR_OFFSET UNITYSDK_OFFSET(0x95D6310)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__EXITCAMERA_OFFSET UNITYSDK_OFFSET(0x95D0480)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__EXITGAME_OFFSET UNITYSDK_OFFSET(0x95D6E60)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__FINISHGAME_OFFSET UNITYSDK_OFFSET(0x95D68B0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__FOCUSRESTAURANTBUILDCAMERA_OFFSET UNITYSDK_OFFSET(0x95CFE40)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__FOCUSRESTAURANTCAMERA_OFFSET UNITYSDK_OFFSET(0x95D4E40)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__INITUIMEDIATOR_OFFSET UNITYSDK_OFFSET(0x95D4BD0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__ONCLEAR_OFFSET UNITYSDK_OFFSET(0x95CF920)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__ONGAMERUN_OFFSET UNITYSDK_OFFSET(0x95D5D80)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__ONGROUPEVENT_OFFSET UNITYSDK_OFFSET(0x95D7670)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__ONINIT_OFFSET UNITYSDK_OFFSET(0x95CED00)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__ONSCREENSIZECHANGED_OFFSET UNITYSDK_OFFSET(0x95D7050)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__ONSTART_OFFSET UNITYSDK_OFFSET(0x95CF5A0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__ONTICK_OFFSET UNITYSDK_OFFSET(0x95CFD30)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__PAUSEGAME_OFFSET UNITYSDK_OFFSET(0x95D3C60)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__PREPAREBUILDINGGAME_OFFSET UNITYSDK_OFFSET(0x95CF630)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__REAPPLYMATERIALS_1_OFFSET UNITYSDK_OFFSET(0x95D85C0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__REAPPLYMATERIALS_OFFSET UNITYSDK_OFFSET(0x95D8360)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__REMOVENOTIFY_OFFSET UNITYSDK_OFFSET(0x95CFA50)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__REMOVEUNPURCHASEDFACILITIES_OFFSET UNITYSDK_OFFSET(0x95D05E0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__RESETFACILITIES_OFFSET UNITYSDK_OFFSET(0x95D69D0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__SETUPBOARD_OFFSET UNITYSDK_OFFSET(0x95D4110)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__SETUPDECORATORS_OFFSET UNITYSDK_OFFSET(0x95D4200)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__SETUPDEVICES_OFFSET UNITYSDK_OFFSET(0x95D4410)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__SETUPEMPLOYEES_OFFSET UNITYSDK_OFFSET(0x95D5270)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__SETUPGAMEENTITY_OFFSET UNITYSDK_OFFSET(0x95D4D20)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__SETUPLEVELCONFIG_OFFSET UNITYSDK_OFFSET(0x95CF690)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__SETUPNEXTUNPURCHASEDDECORATOR_OFFSET UNITYSDK_OFFSET(0x95D7C80)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__SETUPOBSTACLES_OFFSET UNITYSDK_OFFSET(0x95D55E0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__SETUPSMARTOBJECTENTITIES_OFFSET UNITYSDK_OFFSET(0x95D5180)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__SETUPTABLES_OFFSET UNITYSDK_OFFSET(0x95D4620)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__SETUPUNPURCHASEDFACILITIES_OFFSET UNITYSDK_OFFSET(0x95CFF90)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__STARTGAME_OFFSET UNITYSDK_OFFSET(0x95D4920)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__TRIGGERGROUPEVENT_OFFSET UNITYSDK_OFFSET(0x95D6FB0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__UPGRADEDECORATOR_OFFSET UNITYSDK_OFFSET(0x95D15B0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__UPGRADEDEVICE_OFFSET UNITYSDK_OFFSET(0x95D19B0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__UPGRADETABLE_OFFSET UNITYSDK_OFFSET(0x95D0E90)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE___IFIXBASEPROXY_GETSTATETREEROOT_OFFSET UNITYSDK_OFFSET(0x95D89C0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE___IFIXBASEPROXY__ONCLEAR_OFFSET UNITYSDK_OFFSET(0x95D8B00)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE___IFIXBASEPROXY__ONINIT_OFFSET UNITYSDK_OFFSET(0x95D8A30)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE___IFIXBASEPROXY__ONSTART_OFFSET UNITYSDK_OFFSET(0x95D8AA0)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE___IFIXBASEPROXY__ONTICK_OFFSET UNITYSDK_OFFSET(0x95D8B60)
#define RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE___SETUPUNPURCHASEDFACILITIES_B__56_0_OFFSET UNITYSDK_OFFSET(0x95D8830)

namespace RPG::Client
{
	inline static constexpr unsigned int ElfRestaurantGameInstance_TypeDefinitionIndex = 48895;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(ElfRestaurantGameInstance_TypeDefinitionIndex)->GetStaticField(0x17B50);
		}
		::Class_3_68E4C4E7E4DEB30E* _UpdateSystems; // 0x78
		::Class_1_867B6CE75953535A* _Contexts; // 0x80
		::RPG::GameCore::EventManager* _EventManagerRef; // 0x88
		::RPG::Client::LittleGame::ElfRestaurantGameEntity* _BoardEntity; // 0x90
		::Class_3_F4528A5C0F861AF2* _Services; // 0x98
		::RPG::GameCore::GameEntity* _OwnerGroupEntity; // 0xA0
		::RPG::Client::ElfRestaurantModule* _ElfRestaurantModule; // 0xA8
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::Class_1_9CBC71DC5240DC00*>* _RendererCacheMap; // 0xB0
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_375*))((::PBYTE)hIl2Cpp + RPG_CLIENT_ELFRESTAURANTGAMEINSTANCE__ONGROUPEVENT_OFFSET))(this, pEvent);
		}
