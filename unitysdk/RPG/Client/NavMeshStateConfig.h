...
#define RPG_CLIENT_NAVMESHSTATECONFIG_AWAKE_OFFSET UNITYSDK_OFFSET(0xC2874F0)
#define RPG_CLIENT_NAVMESHSTATECONFIG_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC2871D0)
#define RPG_CLIENT_NAVMESHSTATECONFIG_ENABLENAVMESHCONFIG_OFFSET UNITYSDK_OFFSET(0xC2880E0)
#define RPG_CLIENT_NAVMESHSTATECONFIG_METHOD_5_7E64705CB9FB1B5D_OFFSET UNITYSDK_OFFSET(0xC287ED0)
#define RPG_CLIENT_NAVMESHSTATECONFIG_METHOD_5_F74441856239DF08_OFFSET UNITYSDK_OFFSET(0xC287220)
#define RPG_CLIENT_NAVMESHSTATECONFIG_REMOVENAVMESHCONFIG_OFFSET UNITYSDK_OFFSET(0xC288090)
#define RPG_CLIENT_NAVMESHSTATECONFIG_SETNAVMESHCONFIG_OFFSET UNITYSDK_OFFSET(0xC2875C0)
#define RPG_CLIENT_NAVMESHSTATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xC2881D0)

namespace RPG::Client
{
	inline static constexpr unsigned int NavMeshStateConfig_TypeDefinitionIndex = 64221;
