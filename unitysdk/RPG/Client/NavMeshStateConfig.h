...
#define RPG_CLIENT_NAVMESHSTATECONFIG_AWAKE_OFFSET UNITYSDK_OFFSET(0xAB77100)
#define RPG_CLIENT_NAVMESHSTATECONFIG_DISPOSE_OFFSET UNITYSDK_OFFSET(0xAB770B0)
#define RPG_CLIENT_NAVMESHSTATECONFIG_ENABLENAVMESHCONFIG_OFFSET UNITYSDK_OFFSET(0xAB77DF0)
#define RPG_CLIENT_NAVMESHSTATECONFIG_METHOD_5_1F47CAD86E555F5A_OFFSET UNITYSDK_OFFSET(0xAB77A90)
#define RPG_CLIENT_NAVMESHSTATECONFIG_METHOD_5_868C75966CA63116_OFFSET UNITYSDK_OFFSET(0xAB77EE0)
#define RPG_CLIENT_NAVMESHSTATECONFIG_REMOVENAVMESHCONFIG_OFFSET UNITYSDK_OFFSET(0xAB77A40)
#define RPG_CLIENT_NAVMESHSTATECONFIG_SETNAVMESHCONFIG_OFFSET UNITYSDK_OFFSET(0xAB771D0)
#define RPG_CLIENT_NAVMESHSTATECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xAB780F0)

namespace RPG::Client
{
	inline static constexpr unsigned int NavMeshStateConfig_TypeDefinitionIndex = 63304;
