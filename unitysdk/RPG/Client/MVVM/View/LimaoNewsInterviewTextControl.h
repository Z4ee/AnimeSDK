...
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWTEXTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xA74AB50)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWTEXTCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA74AA00)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWTEXTCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xA74A940)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWTEXTCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA74ABC0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWTEXTCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xA74AB60)

namespace RPG::Client::MVVM::View
{
	inline static constexpr unsigned int LimaoNewsInterviewTextControl_TypeDefinitionIndex = 68449;
