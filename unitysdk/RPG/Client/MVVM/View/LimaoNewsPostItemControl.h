...
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTITEMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x9AA2D00)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTITEMCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9AA2430)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTITEMCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x9AA21A0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTITEMCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9AA2D70)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTITEMCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x9AA2D10)

namespace RPG::Client::MVVM::View
{
	inline static constexpr unsigned int LimaoNewsPostItemControl_TypeDefinitionIndex = 61013;
