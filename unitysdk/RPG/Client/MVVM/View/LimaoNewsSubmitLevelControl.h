...
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSUBMITLEVELCONTROL_METHOD_6_071850D2764E9D4C_OFFSET UNITYSDK_OFFSET(0x9AA8370)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSUBMITLEVELCONTROL_METHOD_6_323F95926A2F616E_OFFSET UNITYSDK_OFFSET(0x9AA77C0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSUBMITLEVELCONTROL_METHOD_6_51D4C4EE6EA0D8EF_OFFSET UNITYSDK_OFFSET(0x9AA8180)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSUBMITLEVELCONTROL_METHOD_6_554044C88588C5A0_OFFSET UNITYSDK_OFFSET(0x9AA7FB0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSUBMITLEVELCONTROL_METHOD_6_69AB3F506C73DE73_OFFSET UNITYSDK_OFFSET(0x9AA7830)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSUBMITLEVELCONTROL_METHOD_6_CDA8A3F6E2C03F05_OFFSET UNITYSDK_OFFSET(0x9AA82F0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSUBMITLEVELCONTROL_PLAYLEVELCHANGEANIMATION_OFFSET UNITYSDK_OFFSET(0x9AA3A50)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSUBMITLEVELCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x9AA8780)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSUBMITLEVELCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9AA7B10)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSUBMITLEVELCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x9AA7300)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSUBMITLEVELCONTROL__PLAYFIRECHANGEANIMATION_OFFSET UNITYSDK_OFFSET(0x9AA7A80)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSUBMITLEVELCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9AA87F0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSUBMITLEVELCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x9AA8790)

namespace RPG::Client::MVVM::View
{
	inline static constexpr unsigned int LimaoNewsSubmitLevelControl_TypeDefinitionIndex = 61019;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_MVVM_VIEW_LIMAONEWSSUBMITLEVELCONTROL_METHOD_6_071850D2764E9D4C_OFFSET))(this);
		}
