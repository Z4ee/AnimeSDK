...
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWDESCLISTCONTROL_METHOD_6_933A237F9F33FB1E_OFFSET UNITYSDK_OFFSET(0x9A97E20)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWDESCLISTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x9A981C0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWDESCLISTCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9A97D10)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWDESCLISTCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x9A97BF0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWDESCLISTCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9A98230)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWDESCLISTCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x9A981D0)

namespace RPG::Client::MVVM::View
{
	inline static constexpr unsigned int LimaoNewsInterviewDescListControl_TypeDefinitionIndex = 60990;
