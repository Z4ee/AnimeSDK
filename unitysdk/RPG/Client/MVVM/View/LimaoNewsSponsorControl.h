...
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSPONSORCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x9AA65A0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSPONSORCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9AA5FB0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSPONSORCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x9AA5C70)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSPONSORCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9AA6610)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSPONSORCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x9AA65B0)

namespace RPG::Client::MVVM::View
{
	inline static constexpr unsigned int LimaoNewsSponsorControl_TypeDefinitionIndex = 61015;
