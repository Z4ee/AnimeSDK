...
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSFORUMCONTROL_METHOD_6_06330CD58CB602B6_OFFSET UNITYSDK_OFFSET(0xA7440F0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSFORUMCONTROL_METHOD_6_323F95926A2F616E_OFFSET UNITYSDK_OFFSET(0xA744080)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSFORUMCONTROL_METHOD_6_394DCF9DA306E923_OFFSET UNITYSDK_OFFSET(0xA744880)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSFORUMCONTROL_METHOD_6_3D4F127F6B974E0C_OFFSET UNITYSDK_OFFSET(0xA7446B0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSFORUMCONTROL_REFRESHREDDOTNODE_OFFSET UNITYSDK_OFFSET(0xA744660)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSFORUMCONTROL_TRYMOVETONEWPOST_OFFSET UNITYSDK_OFFSET(0xA7443A0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSFORUMCONTROL_TRYMOVETO_OFFSET UNITYSDK_OFFSET(0xA744240)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSFORUMCONTROL_UPDATE_OFFSET UNITYSDK_OFFSET(0xA744E30)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSFORUMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xA744E90)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSFORUMCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA743E20)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSFORUMCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xA743C00)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSFORUMCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA744F20)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSFORUMCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xA744EC0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSFORUMCONTROL___TRYPLAYPOSTROWANIMATION_B__7_0_OFFSET UNITYSDK_OFFSET(0xA744EA0)

namespace RPG::Client::MVVM::View
{
	inline static constexpr unsigned int LimaoNewsForumControl_TypeDefinitionIndex = 68453;
