...
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWCONTROL_METHOD_6_8DC652D916C182B2_OFFSET UNITYSDK_OFFSET(0xA746450)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xA746B00)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA745DA0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xA745B20)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA746B70)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSINTERVIEWCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xA746B10)

namespace RPG::Client::MVVM::View
{
	inline static constexpr unsigned int LimaoNewsInterviewControl_TypeDefinitionIndex = 68454;
