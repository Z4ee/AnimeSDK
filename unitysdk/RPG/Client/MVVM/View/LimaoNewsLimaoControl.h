...
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSLIMAOCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x9A9D2E0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSLIMAOCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9A9D1C0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSLIMAOCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x9A9D0A0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSLIMAOCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9A9D350)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSLIMAOCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x9A9D2F0)

namespace RPG::Client::MVVM::View
{
	inline static constexpr unsigned int LimaoNewsLimaoControl_TypeDefinitionIndex = 60977;
