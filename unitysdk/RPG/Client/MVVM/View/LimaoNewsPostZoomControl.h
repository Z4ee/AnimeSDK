...
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTZOOMCONTROL_INIT_OFFSET UNITYSDK_OFFSET(0xA75E7F0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTZOOMCONTROL_METHOD_6_073D39C3DB5A9C1F_OFFSET UNITYSDK_OFFSET(0xA75F020)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTZOOMCONTROL_METHOD_6_62588A1BBFF521EC_1_OFFSET UNITYSDK_OFFSET(0xA760110)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTZOOMCONTROL_METHOD_6_62588A1BBFF521EC_OFFSET UNITYSDK_OFFSET(0xA760040)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTZOOMCONTROL_METHOD_6_6D93101E4CE10A96_OFFSET UNITYSDK_OFFSET(0xA75FAD0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTZOOMCONTROL_METHOD_6_75B2F7652BAFC47F_OFFSET UNITYSDK_OFFSET(0xA75E9F0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTZOOMCONTROL_METHOD_6_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xA75E950)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTZOOMCONTROL_METHOD_6_9D967D80C41C7781_OFFSET UNITYSDK_OFFSET(0xA7601E0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTZOOMCONTROL_METHOD_6_A77033F2447DC719_OFFSET UNITYSDK_OFFSET(0xA75FF80)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTZOOMCONTROL_METHOD_6_E1CE0A1C7957700D_OFFSET UNITYSDK_OFFSET(0xA75EE30)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTZOOMCONTROL_METHOD_6_E3ADA5CA2C064E44_OFFSET UNITYSDK_OFFSET(0xA75EC20)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTZOOMCONTROL_METHOD_6_E9A8695D8BBAA196_OFFSET UNITYSDK_OFFSET(0xA75FE90)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTZOOMCONTROL_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xA75F690)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTZOOMCONTROL_ONENABLE_OFFSET UNITYSDK_OFFSET(0xA75F2A0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTZOOMCONTROL_ONJOYSTICKPRESS_OFFSET UNITYSDK_OFFSET(0xA75ED20)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTZOOMCONTROL_ONJOYSTICKRELEASE_OFFSET UNITYSDK_OFFSET(0xA75EF60)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTZOOMCONTROL_ONJOYSTICKZOOM_OFFSET UNITYSDK_OFFSET(0xA75EC90)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTZOOMCONTROL_ONMOUSEWHEELROLL_OFFSET UNITYSDK_OFFSET(0xA75EB90)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTZOOMCONTROL_UPDATE_OFFSET UNITYSDK_OFFSET(0xA75FA80)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSPOSTZOOMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xA760230)

namespace RPG::Client::MVVM::View
{
	inline static constexpr unsigned int LimaoNewsPostZoomControl_TypeDefinitionIndex = 68478;
