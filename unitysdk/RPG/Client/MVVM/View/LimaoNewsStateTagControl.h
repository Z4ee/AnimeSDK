...
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSTATETAGCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xA763260)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSTATETAGCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA763130)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSTATETAGCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xA762EF0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSTATETAGCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA7632D0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSSTATETAGCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xA763270)

namespace RPG::Client::MVVM::View
{
	inline static constexpr unsigned int LimaoNewsStateTagControl_TypeDefinitionIndex = 68434;
