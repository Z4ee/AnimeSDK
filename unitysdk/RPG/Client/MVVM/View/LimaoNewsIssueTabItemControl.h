...
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSISSUETABITEMCONTROL_METHOD_6_323F95926A2F616E_OFFSET UNITYSDK_OFFSET(0xA751900)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSISSUETABITEMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xA751970)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSISSUETABITEMCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA7511F0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSISSUETABITEMCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xA751070)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSISSUETABITEMCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA7519E0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSISSUETABITEMCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xA751980)

namespace RPG::Client::MVVM::View
{
	inline static constexpr unsigned int LimaoNewsIssueTabItemControl_TypeDefinitionIndex = 68461;
