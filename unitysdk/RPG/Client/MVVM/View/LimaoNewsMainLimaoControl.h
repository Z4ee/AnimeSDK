...
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL_INITENTITY_OFFSET UNITYSDK_OFFSET(0x9A9F910)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL_PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0x9A9FB60)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL_PLAYFADEOUT_OFFSET UNITYSDK_OFFSET(0x9A9FF00)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL_PLAYFREESTYLE_OFFSET UNITYSDK_OFFSET(0x9AA00C0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL_SETEYEEMOTION_OFFSET UNITYSDK_OFFSET(0x9A9FA00)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL_SETLOOKATTARGET_OFFSET UNITYSDK_OFFSET(0x9A9F9A0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x9AA0280)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL__GETENTITY_OFFSET UNITYSDK_OFFSET(0x9AA01E0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9A9F7F0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x9A9F5D0)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL__PLAYENTITYDITHER_OFFSET UNITYSDK_OFFSET(0x9A9FD70)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL__PLAYFADEIN_G__ONTIMELINEAPPEARONSTOPPED_3_0_OFFSET UNITYSDK_OFFSET(0x9AA0290)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL__PLAYFADEOUT_G__ONTIMELINEDISAPPEARONSTOPPED_4_0_OFFSET UNITYSDK_OFFSET(0x9AA0350)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9AA0470)
#define RPG_CLIENT_MVVM_VIEW_LIMAONEWSMAINLIMAOCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x9AA0410)

namespace RPG::Client::MVVM::View
{
	inline static constexpr unsigned int LimaoNewsMainLimaoControl_TypeDefinitionIndex = 60985;
