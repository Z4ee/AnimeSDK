...
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSWEBSITEVIEWMODELPARAM_CREATEDEFAULTTAB_OFFSET UNITYSDK_OFFSET(0x9AAFEB0)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSWEBSITEVIEWMODELPARAM_CREATEMOVETONEWPOST_OFFSET UNITYSDK_OFFSET(0x9AB00B0)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSWEBSITEVIEWMODELPARAM_CREATEMOVETOPOST_OFFSET UNITYSDK_OFFSET(0x9AAFFB0)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSWEBSITEVIEWMODELPARAM_CREATESELECTEDISSUE_OFFSET UNITYSDK_OFFSET(0x9AAFF30)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSWEBSITEVIEWMODELPARAM_CREATETOPPOST_OFFSET UNITYSDK_OFFSET(0x9AB0030)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSWEBSITEVIEWMODELPARAM_CREATE_OFFSET UNITYSDK_OFFSET(0x9AAFE30)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSWEBSITEVIEWMODELPARAM_GET_ISSUEID_OFFSET UNITYSDK_OFFSET(0x9AB0150)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSWEBSITEVIEWMODELPARAM_GET_MOVETOPOSTID_OFFSET UNITYSDK_OFFSET(0x9AB0190)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSWEBSITEVIEWMODELPARAM_GET_TOPPOSTID_OFFSET UNITYSDK_OFFSET(0x9AB0170)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSWEBSITEVIEWMODELPARAM_GET_VIEWTAB_OFFSET UNITYSDK_OFFSET(0x9AB0130)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSWEBSITEVIEWMODELPARAM_SET_ISSUEID_OFFSET UNITYSDK_OFFSET(0x9AB0160)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSWEBSITEVIEWMODELPARAM_SET_MOVETOPOSTID_OFFSET UNITYSDK_OFFSET(0x9AB01A0)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSWEBSITEVIEWMODELPARAM_SET_TOPPOSTID_OFFSET UNITYSDK_OFFSET(0x9AB0180)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSWEBSITEVIEWMODELPARAM_SET_VIEWTAB_OFFSET UNITYSDK_OFFSET(0x9AB0140)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSWEBSITEVIEWMODELPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x9AAFEA0)

namespace RPG::Client::MVVM::ViewModel
{
	inline static constexpr unsigned int LimaoNewsWebsiteViewModelParam_TypeDefinitionIndex = 60968;
	...
	public:
		...
		::System::UInt32 _MoveToPostID_k__BackingField; // 0x1C
