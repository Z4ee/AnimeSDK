...
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSOFFICESURVEYVIEWMODEL_FIXCOMPLETEOFFICESURVEYLIST_OFFSET UNITYSDK_OFFSET(0xA769D50)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSOFFICESURVEYVIEWMODEL_GETFILTERLOCATIONDATAS_OFFSET UNITYSDK_OFFSET(0xA769A80)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSOFFICESURVEYVIEWMODEL_GETFILTERSTATES_OFFSET UNITYSDK_OFFSET(0xA769C10)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSOFFICESURVEYVIEWMODEL_GETFILTERSURVEYTYPEDATAS_OFFSET UNITYSDK_OFFSET(0xA7698F0)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSOFFICESURVEYVIEWMODEL_GETSHOWITEMS_OFFSET UNITYSDK_OFFSET(0xA769430)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSOFFICESURVEYVIEWMODEL_GETTOTALSHOWCOUNT_OFFSET UNITYSDK_OFFSET(0xA7695A0)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSOFFICESURVEYVIEWMODEL_GET_RECOMMENDSERVICEID_OFFSET UNITYSDK_OFFSET(0xA769DB0)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSOFFICESURVEYVIEWMODEL_ISANYSURVEYCANSHOW_OFFSET UNITYSDK_OFFSET(0xA769510)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSOFFICESURVEYVIEWMODEL_ISFINISHEDALLSURVEY_OFFSET UNITYSDK_OFFSET(0xA7694B0)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSOFFICESURVEYVIEWMODEL_REFRESHOFFICESURVEYBYFILTER_OFFSET UNITYSDK_OFFSET(0xA769880)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSOFFICESURVEYVIEWMODEL_REFRESHSELECTEDFILTER_OFFSET UNITYSDK_OFFSET(0xA769600)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSOFFICESURVEYVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xA769300)

namespace RPG::Client::MVVM::ViewModel
{
	inline static constexpr unsigned int LimaoNewsOfficeSurveyViewModel_TypeDefinitionIndex = 68396;

	class LimaoNewsOfficeSurveyViewModel : public ::Class_2_E77EE8BE0A609DD9
	{
	public:
		::System::Collections::Generic::List_1<::Enum_3_4608E37A1B3D374A_19>* _SelectedStates; // 0x20
		::RPG::Client::MVVM::Model::LimaoNewsModule* _Module; // 0x28
		::System::Collections::Generic::List_1<::System::UInt32>* _SelectedSurveyTypes; // 0x30
		::System::Collections::Generic::List_1<::System::UInt32>* _SelectedLocationIDs; // 0x38
		...
		::System::Void RefreshSelectedFilter(::System::Collections::Generic::List_1<::RPG::GameCore::LimaoNewsOfficeSurveyType>* surveyTypes, ::System::Collections::Generic::List_1<::System::UInt32>* locationIDs, ::System::Collections::Generic::List_1<::Enum_3_4608E37A1B3D374A_19>* states)
		{
			return ((::System::Void(*)(::PVOID, ::System::Collections::Generic::List_1<::RPG::GameCore::LimaoNewsOfficeSurveyType>*, ::System::Collections::Generic::List_1<::System::UInt32>*, ::System::Collections::Generic::List_1<::Enum_3_4608E37A1B3D374A_19>*))((::PBYTE)hIl2Cpp + RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSOFFICESURVEYVIEWMODEL_REFRESHSELECTEDFILTER_OFFSET))(this, surveyTypes, locationIDs, states);
		}
		...
		::System::Collections::Generic::List_1<::System::Tuple_2<::Enum_3_4608E37A1B3D374A_19, ::RPG::Client::TextID>*>* GetFilterStates()
		{
			return ((::System::Collections::Generic::List_1<::System::Tuple_2<::Enum_3_4608E37A1B3D374A_19, ::RPG::Client::TextID>*>*(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSOFFICESURVEYVIEWMODEL_GETFILTERSTATES_OFFSET))(this);
		}
