...
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSMAINENTRANCESCENEVIEWMODEL_GETCURPHASEDESKS_OFFSET UNITYSDK_OFFSET(0x9AACD90)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSMAINENTRANCESCENEVIEWMODEL_GETCURPHASEPOINTIDS_OFFSET UNITYSDK_OFFSET(0x9AACE40)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSMAINENTRANCESCENEVIEWMODEL_GETSHOWLIMAODATAS_OFFSET UNITYSDK_OFFSET(0x9AACEF0)
#define RPG_CLIENT_MVVM_VIEWMODEL_LIMAONEWSMAINENTRANCESCENEVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x9AACD50)

namespace RPG::Client::MVVM::ViewModel
{
	inline static constexpr unsigned int LimaoNewsMainEntranceSceneViewModel_TypeDefinitionIndex = 60940;

	class LimaoNewsMainEntranceSceneViewModel : public ::Class_2_3DE15EA7F53A0550
	{
	public:
		::Class_1_4780C96744815F8D* _LimaoService; // 0x18
