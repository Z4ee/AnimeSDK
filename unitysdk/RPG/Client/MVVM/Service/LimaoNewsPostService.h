...
class Class_1_EBB10EC01CCC4716_22;
...
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_CLEARNEW_OFFSET UNITYSDK_OFFSET(0xA73A9F0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_CREATECOMMENTVIEWMODELS_OFFSET UNITYSDK_OFFSET(0xA73B150)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA72ECF0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_GETALLCANSUBMITPOSTS_OFFSET UNITYSDK_OFFSET(0xA73A480)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_GETALLSHOWPOSTS_OFFSET UNITYSDK_OFFSET(0xA739FD0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_GETNEWPOSTCOUNT_OFFSET UNITYSDK_OFFSET(0xA73A680)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_GETORCREATEPOSTDATA_OFFSET UNITYSDK_OFFSET(0xA739EA0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_GETPOSTSTATETAGVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xA73AED0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_GETTOPCANSUBMITPOSTDATA_OFFSET UNITYSDK_OFFSET(0xA73A300)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_GOTOPOSTTRACKSURVEYMISSION_OFFSET UNITYSDK_OFFSET(0xA73AE10)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_HASCANSUBMITPOST_OFFSET UNITYSDK_OFFSET(0xA73A620)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_ISCANSHOWQUICKPOSTSUBMIT_OFFSET UNITYSDK_OFFSET(0xA73B8D0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_ISNEWPOST_OFFSET UNITYSDK_OFFSET(0xA73A850)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_ISPOSTCANGOTOSURVEY_OFFSET UNITYSDK_OFFSET(0xA73AC90)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_ISPOSTCANREPLAY_OFFSET UNITYSDK_OFFSET(0xA73AB20)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_ISPOSTCANSUBMIT_OFFSET UNITYSDK_OFFSET(0xA73A1A0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_ISPOSTLOCALCHANGESTATE_OFFSET UNITYSDK_OFFSET(0xA73B9F0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_ONCHANGEPOST_OFFSET UNITYSDK_OFFSET(0xA737A30)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_RECORDPOSTLOCALCHANGESTATE_OFFSET UNITYSDK_OFFSET(0xA73B970)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_REFRESHCANSUBMITPOSTIDS_OFFSET UNITYSDK_OFFSET(0xA737AC0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_REFRESHPOSTUPVOTE_OFFSET UNITYSDK_OFFSET(0xA738AB0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_REFRESHSUBMITTEDPOSTS_OFFSET UNITYSDK_OFFSET(0xA7384B0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_REFRESHSUBMITTEDPOST_OFFSET UNITYSDK_OFFSET(0xA7388C0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_REMOVEPOSTLOCALCHANGESTATE_OFFSET UNITYSDK_OFFSET(0xA739E10)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_SETCOMMENTTONEXTSTATE_OFFSET UNITYSDK_OFFSET(0xA73B800)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_TRYGETPOSTDATA_OFFSET UNITYSDK_OFFSET(0xA73BB00)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0xA72E570)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE__GETCOMMENTSTATEROW_OFFSET UNITYSDK_OFFSET(0xA73B710)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE__GETPOSTDATA_OFFSET UNITYSDK_OFFSET(0xA73BA50)

namespace RPG::Client::MVVM::Service
{
	inline static constexpr unsigned int LimaoNewsPostService_TypeDefinitionIndex = 68499;
	...
	public:
		...
		::System::Collections::Generic::List_1<::RPG::Client::MVVM::Model::LimaoNewsPostData*>* _AllPostDatas; // 0x28
		...
		::System::Void RefreshSubmittedPosts(::Google::Protobuf::Collections::RepeatedField_1<::Class_1_EBB10EC01CCC4716_22*>* submittedPostList)
		{
			return ((::System::Void(*)(::PVOID, ::Google::Protobuf::Collections::RepeatedField_1<::Class_1_EBB10EC01CCC4716_22*>*))((::PBYTE)hIl2Cpp + RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_REFRESHSUBMITTEDPOSTS_OFFSET))(this, submittedPostList);
		}

		::System::Void OnChangePost(::Class_1_EBB10EC01CCC4716_22* proto)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_EBB10EC01CCC4716_22*))((::PBYTE)hIl2Cpp + RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_ONCHANGEPOST_OFFSET))(this, proto);
		}

		::System::Void RefreshSubmittedPost(::Class_1_EBB10EC01CCC4716_22* proto)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_EBB10EC01CCC4716_22*))((::PBYTE)hIl2Cpp + RPG_CLIENT_MVVM_SERVICE_LIMAONEWSPOSTSERVICE_REFRESHSUBMITTEDPOST_OFFSET))(this, proto);
		}
