...
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE_BEGINTRACKOFFICE_OFFSET UNITYSDK_OFFSET(0x9A8E6F0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9A81120)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE_ENDTRACKOFFICE_OFFSET UNITYSDK_OFFSET(0x9A8DE90)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE_GOTOSURVEYMISSIONTARGET_OFFSET UNITYSDK_OFFSET(0x9A8BCD0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE_GOTOSURVEYMISSION_OFFSET UNITYSDK_OFFSET(0x9A8E2B0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE_SETLIMAONEWSTRACKSURVEY_OFFSET UNITYSDK_OFFSET(0x9A8DD70)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE__ADDBILLBOARDINFO_OFFSET UNITYSDK_OFFSET(0x9A8F570)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE__CLEARDATA_OFFSET UNITYSDK_OFFSET(0x9A8EB20)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x9A80910)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE__DOTRACKOFFICE_OFFSET UNITYSDK_OFFSET(0x9A8EB70)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE__GETBILLBOARDCOMPONENT_OFFSET UNITYSDK_OFFSET(0x9A8F670)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE__GETENTRYIDBYFLOORID_OFFSET UNITYSDK_OFFSET(0x9A8E5C0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE__GETFIRSTTRACKABLEDATA_OFFSET UNITYSDK_OFFSET(0x9A8ECD0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE__GETMAPICONINCARTOGRAPHY_OFFSET UNITYSDK_OFFSET(0x9A8EF20)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE__GETPREPARESUBMISSIONLIST_OFFSET UNITYSDK_OFFSET(0x9A8F960)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE__GOTOSURVEYMISSIONTARGET_B__3_0_OFFSET UNITYSDK_OFFSET(0x9A90200)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE__ISDATAVALID_OFFSET UNITYSDK_OFFSET(0x9A8DE30)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE__JUMPTOMISSIONTARGETUIPAGE_OFFSET UNITYSDK_OFFSET(0x9A8DF50)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE__ONCLOSEBIGMAP_OFFSET UNITYSDK_OFFSET(0x9A900F0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE__ONFINISHSUBMISSION_OFFSET UNITYSDK_OFFSET(0x9A8FB20)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE__ONREFRESHBILLBORDINFO_OFFSET UNITYSDK_OFFSET(0x9A8FDD0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE__ONUPDATEMAPPINGINFOTRACE_OFFSET UNITYSDK_OFFSET(0x9A8FF40)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE__OPENMAPPAGE_OFFSET UNITYSDK_OFFSET(0x9A8F1F0)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE__PREPARESUBMISSION_OFFSET UNITYSDK_OFFSET(0x9A8E850)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE__REMOVEBILLBOARDINFO_OFFSET UNITYSDK_OFFSET(0x9A8E900)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE__REMOVEMAPSHOWICON_OFFSET UNITYSDK_OFFSET(0x9A8EA70)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE__TRYTRACKNEXTENTITY_OFFSET UNITYSDK_OFFSET(0x9A8FC00)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE___DOTRACKOFFICE_B__10_0_OFFSET UNITYSDK_OFFSET(0x9A90380)
#define RPG_CLIENT_MVVM_SERVICE_LIMAONEWSTRACKSERVICE___TRYTRACKNEXTENTITY_B__21_0_OFFSET UNITYSDK_OFFSET(0x9A90500)

namespace RPG::Client::MVVM::Service
{
	inline static constexpr unsigned int LimaoNewsTrackService_TypeDefinitionIndex = 61047;

	class LimaoNewsTrackService : public ::System::Object
	{
	public:
		::Class_1_382479A119B6EF73* _CurrentLimaoTrackData; // 0x10
