...
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSLOCATIONDATA_CREATE_1_OFFSET UNITYSDK_OFFSET(0x9A7FE10)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSLOCATIONDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x9A7FDB0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSLOCATIONDATA_GET_LOCATIONID_OFFSET UNITYSDK_OFFSET(0x9A7FEB0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSLOCATIONDATA_GET_LOCATIONNAME_OFFSET UNITYSDK_OFFSET(0x9A7FED0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSLOCATIONDATA_SET_LOCATIONID_OFFSET UNITYSDK_OFFSET(0x9A7FEC0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSLOCATIONDATA_SET_LOCATIONNAME_OFFSET UNITYSDK_OFFSET(0x9A7FEE0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSLOCATIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9A7FEA0)

namespace RPG::Client::MVVM::Model
{
	inline static constexpr unsigned int LimaoNewsLocationData_TypeDefinitionIndex = 61058;
