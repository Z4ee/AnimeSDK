...
#define RPG_CLIENT_MVVM_MODEL_TUTORIALSUBGUIDECOLLECTIONDATA_CREATEGUIDEGROUPDATA_OFFSET UNITYSDK_OFFSET(0xA734210)
#define RPG_CLIENT_MVVM_MODEL_TUTORIALSUBGUIDECOLLECTIONDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xA733C80)
#define RPG_CLIENT_MVVM_MODEL_TUTORIALSUBGUIDECOLLECTIONDATA_GETCATEGORYIDLISTBYGROUPTYPEID_OFFSET UNITYSDK_OFFSET(0xA734370)
#define RPG_CLIENT_MVVM_MODEL_TUTORIALSUBGUIDECOLLECTIONDATA_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xA734080)
#define RPG_CLIENT_MVVM_MODEL_TUTORIALSUBGUIDECOLLECTIONDATA_GETGUIDECATEGORYINFO_OFFSET UNITYSDK_OFFSET(0xA7342A0)
#define RPG_CLIENT_MVVM_MODEL_TUTORIALSUBGUIDECOLLECTIONDATA_GETGUIDEGROUPDATABYID_OFFSET UNITYSDK_OFFSET(0xA734150)
#define RPG_CLIENT_MVVM_MODEL_TUTORIALSUBGUIDECOLLECTIONDATA_GETSPECIALGOTOINFO_OFFSET UNITYSDK_OFFSET(0xA734510)
#define RPG_CLIENT_MVVM_MODEL_TUTORIALSUBGUIDECOLLECTIONDATA_GET_GUIDETYPE_OFFSET UNITYSDK_OFFSET(0xA734560)
#define RPG_CLIENT_MVVM_MODEL_TUTORIALSUBGUIDECOLLECTIONDATA__CREATEGUIDEGROUPDATA_OFFSET UNITYSDK_OFFSET(0xA733EC0)
#define RPG_CLIENT_MVVM_MODEL_TUTORIALSUBGUIDECOLLECTIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA733C00)

namespace RPG::Client::MVVM::Model
{
	inline static constexpr unsigned int TutorialSubGuideCollectionData_TypeDefinitionIndex = 68537;
	...
	public:
		...
		{
			return ((::Enum_3_ED790DAC948A65A9_29(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_MVVM_MODEL_TUTORIALSUBGUIDECOLLECTIONDATA_GET_GUIDETYPE_OFFSET))(this);
		}
	};
}
