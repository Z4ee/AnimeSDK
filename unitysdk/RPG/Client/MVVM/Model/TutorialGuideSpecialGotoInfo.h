...
#define RPG_CLIENT_MVVM_MODEL_TUTORIALGUIDESPECIALGOTOINFO_GET_GOTOID_OFFSET UNITYSDK_OFFSET(0x9A85540)
#define RPG_CLIENT_MVVM_MODEL_TUTORIALGUIDESPECIALGOTOINFO_GET_HINTTEXT_OFFSET UNITYSDK_OFFSET(0x9A85530)
#define RPG_CLIENT_MVVM_MODEL_TUTORIALGUIDESPECIALGOTOINFO_GET_NEEDREDDOT_OFFSET UNITYSDK_OFFSET(0x9A85570)
#define RPG_CLIENT_MVVM_MODEL_TUTORIALGUIDESPECIALGOTOINFO_GET_REDDOTKEY_OFFSET UNITYSDK_OFFSET(0x9A85550)
#define RPG_CLIENT_MVVM_MODEL_TUTORIALGUIDESPECIALGOTOINFO_GET_REDDOTSUBKEY_OFFSET UNITYSDK_OFFSET(0x9A85560)
#define RPG_CLIENT_MVVM_MODEL_TUTORIALGUIDESPECIALGOTOINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x9A854F0)

namespace RPG::Client::MVVM::Model
{
	inline static constexpr unsigned int TutorialGuideSpecialGotoInfo_TypeDefinitionIndex = 61076;
