...
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSISSUEDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x9A7F2B0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSISSUEDATA_GETCOMMENTDATAS_OFFSET UNITYSDK_OFFSET(0x9A7F590)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSISSUEDATA_GETINTERVIEWS_OFFSET UNITYSDK_OFFSET(0x9A7F340)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSISSUEDATA_GETREWARDID_OFFSET UNITYSDK_OFFSET(0x9A7F780)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSISSUEDATA_GETREWARDITEMCOUNT_OFFSET UNITYSDK_OFFSET(0x9A7F820)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSISSUEDATA_GET_HINTPOPUPSHOWTYPE_OFFSET UNITYSDK_OFFSET(0x9A7F8D0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSISSUEDATA_GET_ISSUEID_OFFSET UNITYSDK_OFFSET(0x9A7F8B0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSISSUEDATA_SET_ISSUEID_OFFSET UNITYSDK_OFFSET(0x9A7F8C0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSISSUEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9A7F330)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSISSUEDATA__GETISSUEROW_OFFSET UNITYSDK_OFFSET(0x9A7F530)

namespace RPG::Client::MVVM::Model
{
	inline static constexpr unsigned int LimaoNewsIssueData_TypeDefinitionIndex = 61056;
