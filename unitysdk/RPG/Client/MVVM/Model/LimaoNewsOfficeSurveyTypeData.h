...
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYTYPEDATA_CREATE_1_OFFSET UNITYSDK_OFFSET(0x9A832E0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYTYPEDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x9A823D0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYTYPEDATA_GET_ISNONE_OFFSET UNITYSDK_OFFSET(0x9A83410)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYTYPEDATA_GET_OFFICESURVEYTYPE_OFFSET UNITYSDK_OFFSET(0x9A833B0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYTYPEDATA_GET_SURVEYTYPECOLORSTATE_OFFSET UNITYSDK_OFFSET(0x9A83420)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYTYPEDATA_GET_SURVEYTYPEICON_OFFSET UNITYSDK_OFFSET(0x9A833D0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYTYPEDATA_GET_SURVEYTYPEMASKCOLORSTATE_OFFSET UNITYSDK_OFFSET(0x9A83480)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYTYPEDATA_GET_SURVEYTYPETEXTID_OFFSET UNITYSDK_OFFSET(0x9A833F0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYTYPEDATA_SET_OFFICESURVEYTYPE_OFFSET UNITYSDK_OFFSET(0x9A833C0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYTYPEDATA_SET_SURVEYTYPEICON_OFFSET UNITYSDK_OFFSET(0x9A833E0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYTYPEDATA_SET_SURVEYTYPETEXTID_OFFSET UNITYSDK_OFFSET(0x9A83400)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYTYPEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9A83270)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSOFFICESURVEYTYPEDATA__INITBYROW_OFFSET UNITYSDK_OFFSET(0x9A83280)

namespace RPG::Client::MVVM::Model
{
	inline static constexpr unsigned int LimaoNewsOfficeSurveyTypeData_TypeDefinitionIndex = 61066;
