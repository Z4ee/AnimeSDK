...
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA72E700)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_GET_CONDITIONSERVICE_OFFSET UNITYSDK_OFFSET(0xA72EF90)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_GET_ISSUESERVICE_OFFSET UNITYSDK_OFFSET(0xA72EFF0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_GET_LIMAOSERVICE_OFFSET UNITYSDK_OFFSET(0xA72F030)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_GET_MESSAGESERVICE_OFFSET UNITYSDK_OFFSET(0xA72F0B0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_GET_NETWORKSERVICE_OFFSET UNITYSDK_OFFSET(0xA72EF30)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_GET_OFFERINGSERVICE_OFFSET UNITYSDK_OFFSET(0xA72F050)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_GET_OFFICEEVENTSERVICE_OFFSET UNITYSDK_OFFSET(0xA72EFD0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_GET_OFFICESURVEYSERVICE_OFFSET UNITYSDK_OFFSET(0xA72EFB0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_GET_POSTSERVICE_OFFSET UNITYSDK_OFFSET(0xA72F010)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_GET_SPONSORSERVICE_OFFSET UNITYSDK_OFFSET(0xA72F090)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_GET_TRACKSERVICE_OFFSET UNITYSDK_OFFSET(0xA72F070)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_GET_TUTORIALSERVICE_OFFSET UNITYSDK_OFFSET(0xA72EF70)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_GET_WINDOWSERVICE_OFFSET UNITYSDK_OFFSET(0xA72EF50)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_INIT_OFFSET UNITYSDK_OFFSET(0xA72E160)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_SET_CONDITIONSERVICE_OFFSET UNITYSDK_OFFSET(0xA72EFA0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_SET_ISSUESERVICE_OFFSET UNITYSDK_OFFSET(0xA72F000)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_SET_LIMAOSERVICE_OFFSET UNITYSDK_OFFSET(0xA72F040)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_SET_MESSAGESERVICE_OFFSET UNITYSDK_OFFSET(0xA72F0C0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_SET_NETWORKSERVICE_OFFSET UNITYSDK_OFFSET(0xA72EF40)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_SET_OFFERINGSERVICE_OFFSET UNITYSDK_OFFSET(0xA72F060)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_SET_OFFICEEVENTSERVICE_OFFSET UNITYSDK_OFFSET(0xA72EFE0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_SET_OFFICESURVEYSERVICE_OFFSET UNITYSDK_OFFSET(0xA72EFC0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_SET_POSTSERVICE_OFFSET UNITYSDK_OFFSET(0xA72F020)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_SET_SPONSORSERVICE_OFFSET UNITYSDK_OFFSET(0xA72F0A0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_SET_TRACKSERVICE_OFFSET UNITYSDK_OFFSET(0xA72F080)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_SET_TUTORIALSERVICE_OFFSET UNITYSDK_OFFSET(0xA72EF80)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE_SET_WINDOWSERVICE_OFFSET UNITYSDK_OFFSET(0xA72EF60)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0xA72F0D0)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA72F180)
#define RPG_CLIENT_MVVM_MODEL_LIMAONEWSMODULE___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0xA72F0F0)

namespace RPG::Client::MVVM::Model
{
	inline static constexpr unsigned int LimaoNewsModule_TypeDefinitionIndex = 68520;

	class LimaoNewsModule : public ::RPG::Client::BaseModule
	{
	public:
		::RPG::Client::MVVM::Service::LimaoNewsNetworkService* _NetworkService_k__BackingField; // 0x10
		::RPG::Client::MVVM::Service::LimaoNewsMessageService* _MessageService_k__BackingField; // 0x18
		::RPG::Client::MVVM::Service::LimaoNewsOfferingService* _OfferingService_k__BackingField; // 0x20
		::Class_1_0BE9E9C1D5A3C687* _ConditionService_k__BackingField; // 0x28
		::Class_1_895FB63906FAA27E* _OfficeEventService_k__BackingField; // 0x30
		::RPG::Client::MVVM::Service::LimaoNewsTrackService* _TrackService_k__BackingField; // 0x38
		::RPG::Client::MVVM::Service::LimaoNewsIssueService* _IssueService_k__BackingField; // 0x40
		::RPG::Client::MVVM::Service::LimaoNewsOfficeSurveyService* _OfficeSurveyService_k__BackingField; // 0x48
		::Class_1_4780C96744815F8D* _LimaoService_k__BackingField; // 0x50
		::RPG::Client::MVVM::Service::LimaoNewsPostService* _PostService_k__BackingField; // 0x58
		::Class_1_03D6D30E62EFB374_1* _SponsorService_k__BackingField; // 0x60
		::RPG::Client::MVVM::Service::LimaoNewsTutorialService* _TutorialService_k__BackingField; // 0x68
		::RPG::Client::MVVM::Service::LimaoNewsWindowService* _WindowService_k__BackingField; // 0x70
