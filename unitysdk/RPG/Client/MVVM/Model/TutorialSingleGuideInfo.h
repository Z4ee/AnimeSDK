...
#define RPG_CLIENT_MVVM_MODEL_TUTORIALSINGLEGUIDEINFO_GET_DESCTEXT_OFFSET UNITYSDK_OFFSET(0xA733BF0)
#define RPG_CLIENT_MVVM_MODEL_TUTORIALSINGLEGUIDEINFO_GET_IMAGEPATH_OFFSET UNITYSDK_OFFSET(0xA733BE0)
#define RPG_CLIENT_MVVM_MODEL_TUTORIALSINGLEGUIDEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xA732DE0)

namespace RPG::Client::MVVM::Model
{
	inline static constexpr unsigned int TutorialSingleGuideInfo_TypeDefinitionIndex = 68532;
