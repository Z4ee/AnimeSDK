...
#define RPG_CLIENT_ROGUETOURNDIVISIONCOLLECTION___C__CCTOR_OFFSET UNITYSDK_OFFSET(0xDF4DE70)
#define RPG_CLIENT_ROGUETOURNDIVISIONCOLLECTION___C__CTOR_OFFSET UNITYSDK_OFFSET(0xDF4DEA0)
#define RPG_CLIENT_ROGUETOURNDIVISIONCOLLECTION___C___GENERATEDIVISIONINFO_B__6_0_OFFSET UNITYSDK_OFFSET(0xDF4DEB0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Comparison_1<::RPG::Client::RogueTournDivisionData*>**)Il2CppClass::FromTypeDefinitionIndex(RogueTournDivisionCollection___c_TypeDefinitionIndex)->GetStaticField(0x11710);
		}
		static ::RPG::Client::RogueTournDivisionCollection___c** StaticGet___9()
		{
			return (::RPG::Client::RogueTournDivisionCollection___c**)Il2CppClass::FromTypeDefinitionIndex(RogueTournDivisionCollection___c_TypeDefinitionIndex)->GetStaticField(0x11718);
		}
