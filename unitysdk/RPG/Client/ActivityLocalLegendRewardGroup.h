...
#define RPG_CLIENT_ACTIVITYLOCALLEGENDREWARDGROUP_CREATE_OFFSET UNITYSDK_OFFSET(0x1AF97550)
#define RPG_CLIENT_ACTIVITYLOCALLEGENDREWARDGROUP_GETQUESTSDATA_OFFSET UNITYSDK_OFFSET(0x1AF97610)
#define RPG_CLIENT_ACTIVITYLOCALLEGENDREWARDGROUP_GET_REDDOTNAME_OFFSET UNITYSDK_OFFSET(0x1AF97920)
#define RPG_CLIENT_ACTIVITYLOCALLEGENDREWARDGROUP_GET_REWARDTYPE_OFFSET UNITYSDK_OFFSET(0x1AF97940)
#define RPG_CLIENT_ACTIVITYLOCALLEGENDREWARDGROUP_GET_TITLE_OFFSET UNITYSDK_OFFSET(0x1AF97900)
#define RPG_CLIENT_ACTIVITYLOCALLEGENDREWARDGROUP_HASUNTAKENREWARD_OFFSET UNITYSDK_OFFSET(0x1AF973C0)
#define RPG_CLIENT_ACTIVITYLOCALLEGENDREWARDGROUP_SET_REDDOTNAME_OFFSET UNITYSDK_OFFSET(0x1AF97930)
#define RPG_CLIENT_ACTIVITYLOCALLEGENDREWARDGROUP_SET_REWARDTYPE_OFFSET UNITYSDK_OFFSET(0x1AF97950)
#define RPG_CLIENT_ACTIVITYLOCALLEGENDREWARDGROUP_SET_TITLE_OFFSET UNITYSDK_OFFSET(0x1AF97910)
#define RPG_CLIENT_ACTIVITYLOCALLEGENDREWARDGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF97600)
