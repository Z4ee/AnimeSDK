...
#define RPG_CLIENT_GRIDFIGHTTRAITEQUIPEFFECT_GETEQUIPITEMCONFIGS_OFFSET UNITYSDK_OFFSET(0xA5BBD10)
#define RPG_CLIENT_GRIDFIGHTTRAITEQUIPEFFECT_ONTRAITCHANGE_OFFSET UNITYSDK_OFFSET(0xA5BBCA0)
#define RPG_CLIENT_GRIDFIGHTTRAITEQUIPEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xA5BBBD0)
#define RPG_CLIENT_GRIDFIGHTTRAITEQUIPEFFECT___IFIXBASEPROXY_ONTRAITCHANGE_OFFSET UNITYSDK_OFFSET(0xA5BBF10)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightTraitEquipEffect_TypeDefinitionIndex = 60210;
