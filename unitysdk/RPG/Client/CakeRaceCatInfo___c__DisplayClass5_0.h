...
#define RPG_CLIENT_CAKERACECATINFO___C__DISPLAYCLASS5_0__CTOR_OFFSET UNITYSDK_OFFSET(0x92327D0)
#define RPG_CLIENT_CAKERACECATINFO___C__DISPLAYCLASS5_0__GETRANDOMCATDATAS_B__0_OFFSET UNITYSDK_OFFSET(0x92327E0)

namespace RPG::Client
{
	inline static constexpr unsigned int CakeRaceCatInfo___c__DisplayClass5_0_TypeDefinitionIndex = 51130;
