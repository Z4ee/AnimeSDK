...
#define RPG_CLIENT_CAKERACECATINFO___C__DISPLAYCLASS5_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C63AAD0)
#define RPG_CLIENT_CAKERACECATINFO___C__DISPLAYCLASS5_0__GETRANDOMCATDATAS_B__0_OFFSET UNITYSDK_OFFSET(0x1C63AAE0)

namespace RPG::Client
{
	inline static constexpr unsigned int CakeRaceCatInfo___c__DisplayClass5_0_TypeDefinitionIndex = 63085;
