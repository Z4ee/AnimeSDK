...
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACKUTILS___C__DISPLAYCLASS7_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A69CB80)
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACKUTILS___C__DISPLAYCLASS7_0__ISROLEEQUIPPEDWITH_B__0_OFFSET UNITYSDK_OFFSET(0x1A69DD80)
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACKUTILS___C__DISPLAYCLASS7_0__ISROLEEQUIPPEDWITH_B__1_OFFSET UNITYSDK_OFFSET(0x1A69DDC0)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightEquipTrackUtils___c__DisplayClass7_0_TypeDefinitionIndex = 62425;
