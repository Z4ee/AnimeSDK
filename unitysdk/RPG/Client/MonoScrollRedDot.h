...
#define RPG_CLIENT_MONOSCROLLREDDOT_ADDREDDOTROOT_OFFSET UNITYSDK_OFFSET(0x1A34A650)
#define RPG_CLIENT_MONOSCROLLREDDOT_CLEARREDDOTROOTS_OFFSET UNITYSDK_OFFSET(0x1A34A5C0)
#define RPG_CLIENT_MONOSCROLLREDDOT_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1A34AD70)
#define RPG_CLIENT_MONOSCROLLREDDOT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A34AC10)
#define RPG_CLIENT_MONOSCROLLREDDOT_ONSCROLLRECTVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1A34AF00)
#define RPG_CLIENT_MONOSCROLLREDDOT_SETUPSCROLLREDDOT_OFFSET UNITYSDK_OFFSET(0x1A34A740)
#define RPG_CLIENT_MONOSCROLLREDDOT_START_OFFSET UNITYSDK_OFFSET(0x1A34AAA0)
#define RPG_CLIENT_MONOSCROLLREDDOT__CHECKANDREFRESHUIDATAS_OFFSET UNITYSDK_OFFSET(0x1A34ADD0)
#define RPG_CLIENT_MONOSCROLLREDDOT__CHECKSCROLLREDDOT_OFFSET UNITYSDK_OFFSET(0x1A34AF50)
#define RPG_CLIENT_MONOSCROLLREDDOT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A34B630)
#define RPG_CLIENT_MONOSCROLLREDDOT__ISSHOWINGREDDOT_OFFSET UNITYSDK_OFFSET(0x1A34B500)
#define RPG_CLIENT_MONOSCROLLREDDOT__REFRESHREDDOTCHILDCOUNTLIST_OFFSET UNITYSDK_OFFSET(0x1A34B380)
#define RPG_CLIENT_MONOSCROLLREDDOT__REFRESHSCROLLREDDOT_OFFSET UNITYSDK_OFFSET(0x1A34AA10)
#define RPG_CLIENT_MONOSCROLLREDDOT__REFRESHUIDATAS_OFFSET UNITYSDK_OFFSET(0x1A34A7D0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoScrollRedDot_TypeDefinitionIndex = 69320;
