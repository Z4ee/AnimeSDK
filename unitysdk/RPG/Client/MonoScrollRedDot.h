...
#define RPG_CLIENT_MONOSCROLLREDDOT_ADDREDDOTROOT_OFFSET UNITYSDK_OFFSET(0xC1445A0)
#define RPG_CLIENT_MONOSCROLLREDDOT_CLEARREDDOTROOTS_OFFSET UNITYSDK_OFFSET(0xC144510)
#define RPG_CLIENT_MONOSCROLLREDDOT_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xC144D10)
#define RPG_CLIENT_MONOSCROLLREDDOT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC144B90)
#define RPG_CLIENT_MONOSCROLLREDDOT_ONSCROLLRECTVALUECHANGED_OFFSET UNITYSDK_OFFSET(0xC144EA0)
#define RPG_CLIENT_MONOSCROLLREDDOT_SETUPSCROLLREDDOT_OFFSET UNITYSDK_OFFSET(0xC144690)
#define RPG_CLIENT_MONOSCROLLREDDOT_START_OFFSET UNITYSDK_OFFSET(0xC1449F0)
#define RPG_CLIENT_MONOSCROLLREDDOT__CHECKANDREFRESHUIDATAS_OFFSET UNITYSDK_OFFSET(0xC144D70)
#define RPG_CLIENT_MONOSCROLLREDDOT__CHECKSCROLLREDDOT_OFFSET UNITYSDK_OFFSET(0xC144EF0)
#define RPG_CLIENT_MONOSCROLLREDDOT__CTOR_OFFSET UNITYSDK_OFFSET(0xC1455D0)
#define RPG_CLIENT_MONOSCROLLREDDOT__ISSHOWINGREDDOT_OFFSET UNITYSDK_OFFSET(0xC1454A0)
#define RPG_CLIENT_MONOSCROLLREDDOT__REFRESHREDDOTCHILDCOUNTLIST_OFFSET UNITYSDK_OFFSET(0xC145320)
#define RPG_CLIENT_MONOSCROLLREDDOT__REFRESHSCROLLREDDOT_OFFSET UNITYSDK_OFFSET(0xC144960)
#define RPG_CLIENT_MONOSCROLLREDDOT__REFRESHUIDATAS_OFFSET UNITYSDK_OFFSET(0xC144720)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoScrollRedDot_TypeDefinitionIndex = 67836;
