...
#define RPG_CLIENT_BATTLERESULTPROCESS_CONFIGITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x9E78D90)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleResultProcess_ConfigItem_TypeDefinitionIndex = 56258;
	...
	public:
		...
		::System::Boolean HaveResultPageOnWin; // 0x20
		::System::Boolean HaveResultPageOnQuit; // 0x21
		::System::Boolean HaveResultPageOnLose; // 0x22
		::RPG::GameCore::StageType StageType; // 0x24
