...
#define RPG_CLIENT_MONOJOYSTICKPROVIDER_DRAGINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x7AF9A0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoJoyStickProvider_DragInfo_TypeDefinitionIndex = 58581;
