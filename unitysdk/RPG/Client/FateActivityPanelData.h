...
#define RPG_CLIENT_FATEACTIVITYPANELDATA_GET_ISDISPLAY_OFFSET UNITYSDK_OFFSET(0xA32AA60)
#define RPG_CLIENT_FATEACTIVITYPANELDATA_GET__GUIDEMISSIONGROUPEVENT_OFFSET UNITYSDK_OFFSET(0xA32AA10)
#define RPG_CLIENT_FATEACTIVITYPANELDATA_GET__GUIDEMISSIONGROUPID_OFFSET UNITYSDK_OFFSET(0xA32A900)
#define RPG_CLIENT_FATEACTIVITYPANELDATA_HASREWARDTOTAKE_OFFSET UNITYSDK_OFFSET(0xA32ADA0)
#define RPG_CLIENT_FATEACTIVITYPANELDATA_ISLOCKEDBYPRECONDITIONS_OFFSET UNITYSDK_OFFSET(0xA32AC00)
#define RPG_CLIENT_FATEACTIVITYPANELDATA_ISSHOWMAPPINGINFOREWARDREDDOT_OFFSET UNITYSDK_OFFSET(0xA32AA70)
#define RPG_CLIENT_FATEACTIVITYPANELDATA_TRYTRIGGERGUIDEMISSIONINTERACT_OFFSET UNITYSDK_OFFSET(0xA32AE40)
#define RPG_CLIENT_FATEACTIVITYPANELDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA32AA50)
#define RPG_CLIENT_FATEACTIVITYPANELDATA__HASRESIDENTREWARDTOTAKE_OFFSET UNITYSDK_OFFSET(0xA32AB60)
#define RPG_CLIENT_FATEACTIVITYPANELDATA___IFIXBASEPROXY_ISSHOWMAPPINGINFOREWARDREDDOT_OFFSET UNITYSDK_OFFSET(0xA32AFB0)

namespace RPG::Client
{
	inline static constexpr unsigned int FateActivityPanelData_TypeDefinitionIndex = 56828;
