...
#define RPG_CLIENT_FATEACTIVITYPANELDATA_GET_ISDISPLAY_OFFSET UNITYSDK_OFFSET(0xCF28570)
#define RPG_CLIENT_FATEACTIVITYPANELDATA_GET__GUIDEMISSIONGROUPEVENT_OFFSET UNITYSDK_OFFSET(0xCF284F0)
#define RPG_CLIENT_FATEACTIVITYPANELDATA_GET__GUIDEMISSIONGROUPID_OFFSET UNITYSDK_OFFSET(0xCF283E0)
#define RPG_CLIENT_FATEACTIVITYPANELDATA_HASREWARDTOTAKE_OFFSET UNITYSDK_OFFSET(0xCF28940)
#define RPG_CLIENT_FATEACTIVITYPANELDATA_ISLOCKEDBYPRECONDITIONS_OFFSET UNITYSDK_OFFSET(0xCF28770)
#define RPG_CLIENT_FATEACTIVITYPANELDATA_ISSHOWMAPPINGINFOREWARDREDDOT_OFFSET UNITYSDK_OFFSET(0xCF285B0)
#define RPG_CLIENT_FATEACTIVITYPANELDATA_TRYTRIGGERGUIDEMISSIONINTERACT_OFFSET UNITYSDK_OFFSET(0xCF28CC0)
#define RPG_CLIENT_FATEACTIVITYPANELDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCF28560)
#define RPG_CLIENT_FATEACTIVITYPANELDATA__HASRESIDENTREWARDTOTAKE_OFFSET UNITYSDK_OFFSET(0xCF286A0)
