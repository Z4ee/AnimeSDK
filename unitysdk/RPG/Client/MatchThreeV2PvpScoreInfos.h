...
#define RPG_CLIENT_MATCHTHREEV2PVPSCOREINFOS_CREATE_OFFSET UNITYSDK_OFFSET(0xD6662D0)
#define RPG_CLIENT_MATCHTHREEV2PVPSCOREINFOS_GETSCOREDATALISTBYSCORETYPE_OFFSET UNITYSDK_OFFSET(0xD671320)
#define RPG_CLIENT_MATCHTHREEV2PVPSCOREINFOS_GETSCOREDATA_1_OFFSET UNITYSDK_OFFSET(0xD670BB0)
#define RPG_CLIENT_MATCHTHREEV2PVPSCOREINFOS_GETSCOREDATA_2_OFFSET UNITYSDK_OFFSET(0xD670EF0)
#define RPG_CLIENT_MATCHTHREEV2PVPSCOREINFOS_GETSCOREDATA_OFFSET UNITYSDK_OFFSET(0xD670AA0)
#define RPG_CLIENT_MATCHTHREEV2PVPSCOREINFOS_INIT_OFFSET UNITYSDK_OFFSET(0xD670820)
#define RPG_CLIENT_MATCHTHREEV2PVPSCOREINFOS__CTOR_OFFSET UNITYSDK_OFFSET(0xD6707E0)
#define RPG_CLIENT_MATCHTHREEV2PVPSCOREINFOS__INITALLSCOREDATAS_OFFSET UNITYSDK_OFFSET(0xD670870)
