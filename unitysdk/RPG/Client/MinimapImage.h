...
#define RPG_CLIENT_MINIMAPIMAGE_GET__SECTIONCOUNT_OFFSET UNITYSDK_OFFSET(0x9BB16C0)
#define RPG_CLIENT_MINIMAPIMAGE_ONPOPULATEMESH_OFFSET UNITYSDK_OFFSET(0x9BB0160)
#define RPG_CLIENT_MINIMAPIMAGE_SETFADEINFOS_OFFSET UNITYSDK_OFFSET(0x9BAF6E0)
#define RPG_CLIENT_MINIMAPIMAGE_SETROTATIONANGLES_OFFSET UNITYSDK_OFFSET(0x9BAF650)
#define RPG_CLIENT_MINIMAPIMAGE_SETSPRITEVERTEXDATA_OFFSET UNITYSDK_OFFSET(0x9BAF4D0)
#define RPG_CLIENT_MINIMAPIMAGE_SETTARGETRECT_OFFSET UNITYSDK_OFFSET(0x9BAF580)
#define RPG_CLIENT_MINIMAPIMAGE_SETVISIBILITY_OFFSET UNITYSDK_OFFSET(0x9BAF5D0)
#define RPG_CLIENT_MINIMAPIMAGE_UPDATEGEOMETRY_OFFSET UNITYSDK_OFFSET(0x9BAFB90)
#define RPG_CLIENT_MINIMAPIMAGE_UPDATEMATERIAL_OFFSET UNITYSDK_OFFSET(0x9BAF730)
#define RPG_CLIENT_MINIMAPIMAGE__CCTOR_OFFSET UNITYSDK_OFFSET(0x9BB1810)
#define RPG_CLIENT_MINIMAPIMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x9BB1710)
#define RPG_CLIENT_MINIMAPIMAGE__GETTARGETCIRCLE_OFFSET UNITYSDK_OFFSET(0x9BB0F20)
#define RPG_CLIENT_MINIMAPIMAGE__INITMESH_OFFSET UNITYSDK_OFFSET(0x9BB09C0)
#define RPG_CLIENT_MINIMAPIMAGE__ONPOPULATEMESH_G____DISTPOINTTOLINE_8_1_OFFSET UNITYSDK_OFFSET(0x9BB1880)
#define RPG_CLIENT_MINIMAPIMAGE__ONPOPULATEMESH_G____OVERLAPS_8_0_OFFSET UNITYSDK_OFFSET(0x9BB12C0)
#define RPG_CLIENT_MINIMAPIMAGE__UPDATEFADING_OFFSET UNITYSDK_OFFSET(0x9BAF790)
#define RPG_CLIENT_MINIMAPIMAGE___IFIXBASEPROXY_ONPOPULATEMESH_OFFSET UNITYSDK_OFFSET(0x9BB1990)
#define RPG_CLIENT_MINIMAPIMAGE___IFIXBASEPROXY_UPDATEGEOMETRY_OFFSET UNITYSDK_OFFSET(0x9BB1980)
#define RPG_CLIENT_MINIMAPIMAGE___IFIXBASEPROXY_UPDATEMATERIAL_OFFSET UNITYSDK_OFFSET(0x9BB1970)

namespace RPG::Client
{
	inline static constexpr unsigned int MinimapImage_TypeDefinitionIndex = 59471;
	...
	public:
		...
		{
			return (::UnityEngine::UI::VertexHelper**)Il2CppClass::FromTypeDefinitionIndex(MinimapImage_TypeDefinitionIndex)->GetStaticField(0x314E0);
		}
		static ::System::Int32* StaticGet__FadeParams2ID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MinimapImage_TypeDefinitionIndex)->GetStaticField(0x10170);
		}
		static ::System::Int32* StaticGet__FadeParams1ID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MinimapImage_TypeDefinitionIndex)->GetStaticField(0x10174);
		}
