...
#define RPG_CLIENT_MINIMAPIMAGE_GET__SECTIONCOUNT_OFFSET UNITYSDK_OFFSET(0xD6C8380)
#define RPG_CLIENT_MINIMAPIMAGE_ONPOPULATEMESH_OFFSET UNITYSDK_OFFSET(0xD6C7070)
#define RPG_CLIENT_MINIMAPIMAGE_SETFADEINFOS_OFFSET UNITYSDK_OFFSET(0xD6C64D0)
#define RPG_CLIENT_MINIMAPIMAGE_SETROTATIONANGLES_OFFSET UNITYSDK_OFFSET(0xD6C6450)
#define RPG_CLIENT_MINIMAPIMAGE_SETSPRITEVERTEXDATA_OFFSET UNITYSDK_OFFSET(0xD6C6230)
#define RPG_CLIENT_MINIMAPIMAGE_SETTARGETRECT_OFFSET UNITYSDK_OFFSET(0xD6C62E0)
#define RPG_CLIENT_MINIMAPIMAGE_SETVISIBILITY_OFFSET UNITYSDK_OFFSET(0xD6C6330)
#define RPG_CLIENT_MINIMAPIMAGE_UPDATEGEOMETRY_OFFSET UNITYSDK_OFFSET(0xD6C6900)
#define RPG_CLIENT_MINIMAPIMAGE_UPDATEMATERIAL_OFFSET UNITYSDK_OFFSET(0xD6C6520)
#define RPG_CLIENT_MINIMAPIMAGE__CCTOR_OFFSET UNITYSDK_OFFSET(0xD6C84D0)
#define RPG_CLIENT_MINIMAPIMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0xD6C83D0)
#define RPG_CLIENT_MINIMAPIMAGE__GETTARGETCIRCLE_OFFSET UNITYSDK_OFFSET(0xD6C7C30)
#define RPG_CLIENT_MINIMAPIMAGE__INITMESH_OFFSET UNITYSDK_OFFSET(0xD6C7850)
#define RPG_CLIENT_MINIMAPIMAGE__ONPOPULATEMESH_G____DISTPOINTTOLINE_8_1_OFFSET UNITYSDK_OFFSET(0xD6C8540)
#define RPG_CLIENT_MINIMAPIMAGE__ONPOPULATEMESH_G____OVERLAPS_8_0_OFFSET UNITYSDK_OFFSET(0xD6C7FE0)
#define RPG_CLIENT_MINIMAPIMAGE__UPDATEFADING_OFFSET UNITYSDK_OFFSET(0xD6C6580)

namespace RPG::Client
{
	inline static constexpr unsigned int MinimapImage_TypeDefinitionIndex = 72499;
	...
	public:
		...
		{
			return (::UnityEngine::UI::VertexHelper**)Il2CppClass::FromTypeDefinitionIndex(MinimapImage_TypeDefinitionIndex)->GetStaticField(0x66EE0);
		}
		static ::System::Int32* StaticGet__FadeParams2ID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MinimapImage_TypeDefinitionIndex)->GetStaticField(0x15420);
		}
		static ::System::Int32* StaticGet__FadeParams1ID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MinimapImage_TypeDefinitionIndex)->GetStaticField(0x15424);
		}
