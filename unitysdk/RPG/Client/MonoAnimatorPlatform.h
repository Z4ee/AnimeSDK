...
#define RPG_CLIENT_MONOANIMATORPLATFORM_APPLYPLATFORMMOVEMENT_OFFSET UNITYSDK_OFFSET(0x9C12750)
#define RPG_CLIENT_MONOANIMATORPLATFORM_AWAKE_OFFSET UNITYSDK_OFFSET(0x9C122E0)
#define RPG_CLIENT_MONOANIMATORPLATFORM_CALLPLATFORMMOVE_OFFSET UNITYSDK_OFFSET(0x9C127D0)
#define RPG_CLIENT_MONOANIMATORPLATFORM_GET_MOVEDDELEGATE_OFFSET UNITYSDK_OFFSET(0x9C122B0)
#define RPG_CLIENT_MONOANIMATORPLATFORM_GET_NEEDREFRESHRAYCAST_OFFSET UNITYSDK_OFFSET(0x9C122D0)
#define RPG_CLIENT_MONOANIMATORPLATFORM_GET_OWNERENTITY_OFFSET UNITYSDK_OFFSET(0x9C12290)
#define RPG_CLIENT_MONOANIMATORPLATFORM_METHOD_5_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0x9C12880)
#define RPG_CLIENT_MONOANIMATORPLATFORM_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x9C126E0)
#define RPG_CLIENT_MONOANIMATORPLATFORM_ONENABLE_OFFSET UNITYSDK_OFFSET(0x9C12370)
#define RPG_CLIENT_MONOANIMATORPLATFORM_SET_MOVEDDELEGATE_OFFSET UNITYSDK_OFFSET(0x9C122C0)
#define RPG_CLIENT_MONOANIMATORPLATFORM_SET_OWNERENTITY_OFFSET UNITYSDK_OFFSET(0x9C122A0)
#define RPG_CLIENT_MONOANIMATORPLATFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x9C12B30)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoAnimatorPlatform_TypeDefinitionIndex = 55945;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::RPG::GameCore::GameEntity*))((::PBYTE)hIl2Cpp + RPG_CLIENT_MONOANIMATORPLATFORM_SET_OWNERENTITY_OFFSET))(this, value);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_3_2B2F6402EA3EAA0F*))((::PBYTE)hIl2Cpp + RPG_CLIENT_MONOANIMATORPLATFORM_SET_MOVEDDELEGATE_OFFSET))(this, value);
		}
