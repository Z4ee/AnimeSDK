...
#define RPG_CLIENT_CAKERACECHATEMOJIDATAITEM_CREATE_OFFSET UNITYSDK_OFFSET(0x1C63AB80)
#define RPG_CLIENT_CAKERACECHATEMOJIDATAITEM_GET_EMOJIID_OFFSET UNITYSDK_OFFSET(0x1C63ABE0)
#define RPG_CLIENT_CAKERACECHATEMOJIDATAITEM_GET_IMAGEPATH_OFFSET UNITYSDK_OFFSET(0x1C63AD00)
#define RPG_CLIENT_CAKERACECHATEMOJIDATAITEM_GET_ISPLAYERUSE_OFFSET UNITYSDK_OFFSET(0x1C63ABF0)
#define RPG_CLIENT_CAKERACECHATEMOJIDATAITEM_GET__ROW_OFFSET UNITYSDK_OFFSET(0x1C63ACA0)
#define RPG_CLIENT_CAKERACECHATEMOJIDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1C63ABD0)

namespace RPG::Client
{
	inline static constexpr unsigned int CakeRaceChatEmojiDataItem_TypeDefinitionIndex = 63099;
