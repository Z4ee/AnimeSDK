...
#define RPG_CLIENT_DICECOMBATDICECONFIGDATA_GETDICECONTENTINFOS_OFFSET UNITYSDK_OFFSET(0xCD66C00)
#define RPG_CLIENT_DICECOMBATDICECONFIGDATA_GET_CONDITIONDESC_OFFSET UNITYSDK_OFFSET(0xCD67180)
#define RPG_CLIENT_DICECOMBATDICECONFIGDATA_GET_CONDITIONPARAMLIST_OFFSET UNITYSDK_OFFSET(0xCD67240)
#define RPG_CLIENT_DICECOMBATDICECONFIGDATA_GET_DICEBGPATH_OFFSET UNITYSDK_OFFSET(0xCD67290)
#define RPG_CLIENT_DICECOMBATDICECONFIGDATA_GET_DICEFIGURESICONPATH_OFFSET UNITYSDK_OFFSET(0xCD674A0)
#define RPG_CLIENT_DICECOMBATDICECONFIGDATA_GET_DICEICONPATH_OFFSET UNITYSDK_OFFSET(0xCD67320)
#define RPG_CLIENT_DICECOMBATDICECONFIGDATA_GET_HASSKILLCONTENT_OFFSET UNITYSDK_OFFSET(0xCD66E40)
#define RPG_CLIENT_DICECOMBATDICECONFIGDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0xCD66DA0)
#define RPG_CLIENT_DICECOMBATDICECONFIGDATA_GET_ISCOLLECTION_OFFSET UNITYSDK_OFFSET(0xCD66DF0)
#define RPG_CLIENT_DICECOMBATDICECONFIGDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xCD670C0)
#define RPG_CLIENT_DICECOMBATDICECONFIGDATA_GET_RARITY_OFFSET UNITYSDK_OFFSET(0xCD67130)
#define RPG_CLIENT_DICECOMBATDICECONFIGDATA_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xCD671F0)
#define RPG_CLIENT_DICECOMBATDICECONFIGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCD66BC0)
