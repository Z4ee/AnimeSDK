...
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_ROGUEENDLESSACTIVITY_D__22_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xB416430)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_ROGUEENDLESSACTIVITY_D__22_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xB4164E0)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_ROGUEENDLESSACTIVITY_D__22_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xB416540)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_ROGUEENDLESSACTIVITY_D__22_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xB4164F0)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_ROGUEENDLESSACTIVITY_D__22_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB416420)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_ROGUEENDLESSACTIVITY_D__22__CTOR_OFFSET UNITYSDK_OFFSET(0xB410ED0)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleResultProcess___RP_RogueEndlessActivity_d__22_TypeDefinitionIndex = 57040;
