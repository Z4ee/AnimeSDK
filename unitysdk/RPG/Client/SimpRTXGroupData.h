...
#define RPG_CLIENT_SIMPRTXGROUPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x84090)

namespace RPG::Client
{
	inline static constexpr unsigned int SimpRTXGroupData_TypeDefinitionIndex = 57447;
