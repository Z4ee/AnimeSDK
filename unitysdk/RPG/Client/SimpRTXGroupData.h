...
#define RPG_CLIENT_SIMPRTXGROUPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x3997C70)

namespace RPG::Client
{
	inline static constexpr unsigned int SimpRTXGroupData_TypeDefinitionIndex = 67046;
