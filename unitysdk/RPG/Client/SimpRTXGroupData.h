...
#define RPG_CLIENT_SIMPRTXGROUPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x3AFC3E0)

namespace RPG::Client
{
	inline static constexpr unsigned int SimpRTXGroupData_TypeDefinitionIndex = 70151;
