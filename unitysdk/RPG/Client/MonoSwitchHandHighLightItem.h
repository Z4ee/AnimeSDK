...
#define RPG_CLIENT_MONOSWITCHHANDHIGHLIGHTITEM_AWAKE_OFFSET UNITYSDK_OFFSET(0x9D38630)
#define RPG_CLIENT_MONOSWITCHHANDHIGHLIGHTITEM_BREATHING_OFFSET UNITYSDK_OFFSET(0x9D385E0)
#define RPG_CLIENT_MONOSWITCHHANDHIGHLIGHTITEM_ISHIGHLIGHT_OFFSET UNITYSDK_OFFSET(0x9D382D0)
#define RPG_CLIENT_MONOSWITCHHANDHIGHLIGHTITEM_METHOD_5_03C4FFAD29DE0852_OFFSET UNITYSDK_OFFSET(0x9D39010)
#define RPG_CLIENT_MONOSWITCHHANDHIGHLIGHTITEM_METHOD_5_5C549BF7442375BC_OFFSET UNITYSDK_OFFSET(0x9D39210)
#define RPG_CLIENT_MONOSWITCHHANDHIGHLIGHTITEM_METHOD_5_A8F8D4B2BD31D693_OFFSET UNITYSDK_OFFSET(0x9D389B0)
#define RPG_CLIENT_MONOSWITCHHANDHIGHLIGHTITEM_METHOD_5_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x9D38BA0)
#define RPG_CLIENT_MONOSWITCHHANDHIGHLIGHTITEM_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x9D38A50)
#define RPG_CLIENT_MONOSWITCHHANDHIGHLIGHTITEM_METHOD_5_F4C8B018D655630D_OFFSET UNITYSDK_OFFSET(0x9D38CE0)
#define RPG_CLIENT_MONOSWITCHHANDHIGHLIGHTITEM_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x9D38F10)
#define RPG_CLIENT_MONOSWITCHHANDHIGHLIGHTITEM_ONENABLE_OFFSET UNITYSDK_OFFSET(0x9D38BE0)
#define RPG_CLIENT_MONOSWITCHHANDHIGHLIGHTITEM_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x9D388A0)
#define RPG_CLIENT_MONOSWITCHHANDHIGHLIGHTITEM_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0x9D38A90)
#define RPG_CLIENT_MONOSWITCHHANDHIGHLIGHTITEM_REPLAYFADEIN_OFFSET UNITYSDK_OFFSET(0x9D384A0)
#define RPG_CLIENT_MONOSWITCHHANDHIGHLIGHTITEM_UPDATE_OFFSET UNITYSDK_OFFSET(0x9D38690)
#define RPG_CLIENT_MONOSWITCHHANDHIGHLIGHTITEM__CCTOR_OFFSET UNITYSDK_OFFSET(0x9D392C0)
#define RPG_CLIENT_MONOSWITCHHANDHIGHLIGHTITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x9D392B0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoSwitchHandHighLightItem_TypeDefinitionIndex = 56180;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MonoSwitchHandHighLightItem_TypeDefinitionIndex)->GetStaticField(0x114A0);
		}
