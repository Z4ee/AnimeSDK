...
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FIGHTACTIVITY_D__27_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1BD69220)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FIGHTACTIVITY_D__27_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BD695E0)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FIGHTACTIVITY_D__27_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1BD69640)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FIGHTACTIVITY_D__27_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1BD695F0)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FIGHTACTIVITY_D__27_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1BD69210)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FIGHTACTIVITY_D__27__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD69200)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleResultProcess___RP_FightActivity_d__27_TypeDefinitionIndex = 61110;
