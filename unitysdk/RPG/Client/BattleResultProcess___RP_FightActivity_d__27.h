...
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FIGHTACTIVITY_D__27_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xC936CF0)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FIGHTACTIVITY_D__27_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xC9370B0)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FIGHTACTIVITY_D__27_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xC937110)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FIGHTACTIVITY_D__27_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xC9370C0)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FIGHTACTIVITY_D__27_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC936CE0)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FIGHTACTIVITY_D__27__CTOR_OFFSET UNITYSDK_OFFSET(0xC936CD0)
