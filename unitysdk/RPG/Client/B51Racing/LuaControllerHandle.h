...
#define RPG_CLIENT_B51RACING_LUACONTROLLERHANDLE_ADDONBACKPRESSEDCALLBACK_OFFSET UNITYSDK_OFFSET(0xC874F60)
#define RPG_CLIENT_B51RACING_LUACONTROLLERHANDLE_BINDBTNHOLDTOCS_OFFSET UNITYSDK_OFFSET(0xC89AE10)
#define RPG_CLIENT_B51RACING_LUACONTROLLERHANDLE_BINDBTNRELEASETOCS_OFFSET UNITYSDK_OFFSET(0xC881390)
#define RPG_CLIENT_B51RACING_LUACONTROLLERHANDLE_BINDBTNSHORTDOWNCLICKTOCS_OFFSET UNITYSDK_OFFSET(0xC8812B0)
#define RPG_CLIENT_B51RACING_LUACONTROLLERHANDLE_BINDBTNTOCS_OFFSET UNITYSDK_OFFSET(0xC874E80)
#define RPG_CLIENT_B51RACING_LUACONTROLLERHANDLE_BINDCUSTOMFADEINANIMNAME_OFFSET UNITYSDK_OFFSET(0xC89AF00)
#define RPG_CLIENT_B51RACING_LUACONTROLLERHANDLE_BINDCUSTOMFADEOUTANIMNAME_OFFSET UNITYSDK_OFFSET(0xC89AFE0)
#define RPG_CLIENT_B51RACING_LUACONTROLLERHANDLE_BINDONFADEINANIMEND_OFFSET UNITYSDK_OFFSET(0xC89AC90)
#define RPG_CLIENT_B51RACING_LUACONTROLLERHANDLE_BINDONSTARTEXIT_OFFSET UNITYSDK_OFFSET(0xC8918F0)
#define RPG_CLIENT_B51RACING_LUACONTROLLERHANDLE_BINDREDDOT_1_OFFSET UNITYSDK_OFFSET(0xC89B120)
#define RPG_CLIENT_B51RACING_LUACONTROLLERHANDLE_BINDREDDOT_OFFSET UNITYSDK_OFFSET(0xC89B0C0)
#define RPG_CLIENT_B51RACING_LUACONTROLLERHANDLE_BIND_OFFSET UNITYSDK_OFFSET(0xC89A7B0)
#define RPG_CLIENT_B51RACING_LUACONTROLLERHANDLE_EXITAFTERFRAMES_OFFSET UNITYSDK_OFFSET(0xC89A9E0)
#define RPG_CLIENT_B51RACING_LUACONTROLLERHANDLE_EXIT_OFFSET UNITYSDK_OFFSET(0xC875650)
#define RPG_CLIENT_B51RACING_LUACONTROLLERHANDLE_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0xC89A970)
#define RPG_CLIENT_B51RACING_LUACONTROLLERHANDLE_GET_UICONTROLLER_OFFSET UNITYSDK_OFFSET(0xC89A9C0)
#define RPG_CLIENT_B51RACING_LUACONTROLLERHANDLE_INVOKEONFADEINANIMEND_OFFSET UNITYSDK_OFFSET(0xC89A2A0)
#define RPG_CLIENT_B51RACING_LUACONTROLLERHANDLE_INVOKEONSTARTEXIT_OFFSET UNITYSDK_OFFSET(0xC89ABA0)
#define RPG_CLIENT_B51RACING_LUACONTROLLERHANDLE_SETEXITAFTERTRANSITION_OFFSET UNITYSDK_OFFSET(0xC890450)
#define RPG_CLIENT_B51RACING_LUACONTROLLERHANDLE_SET_UICONTROLLER_OFFSET UNITYSDK_OFFSET(0xC89A9D0)
#define RPG_CLIENT_B51RACING_LUACONTROLLERHANDLE_UNBINDONFADEINANIMEND_OFFSET UNITYSDK_OFFSET(0xC89ADA0)
#define RPG_CLIENT_B51RACING_LUACONTROLLERHANDLE_UNBINDONSTARTEXIT_OFFSET UNITYSDK_OFFSET(0xC89AB30)
#define RPG_CLIENT_B51RACING_LUACONTROLLERHANDLE_UNBIND_OFFSET UNITYSDK_OFFSET(0xC89A840)
#define RPG_CLIENT_B51RACING_LUACONTROLLERHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0xC89B210)
#define RPG_CLIENT_B51RACING_LUACONTROLLERHANDLE__EXITAFTERFRAMES_B__9_0_OFFSET UNITYSDK_OFFSET(0xC89B320)

namespace RPG::Client::B51Racing
{
	inline static constexpr unsigned int LuaControllerHandle_TypeDefinitionIndex = 80433;

	class LuaControllerHandle : public ::System::Object
	{
	public:
		::System::Collections::Generic::List_1<::System::Action*>* _OnFadeInAnimEndCallbacks; // 0x10
		::XLua::LuaTable* _Table; // 0x18
		::System::Collections::Generic::HashSet_1<::System::Func_1<::System::Boolean>*>* _OnBackPressedCallbacks; // 0x20
