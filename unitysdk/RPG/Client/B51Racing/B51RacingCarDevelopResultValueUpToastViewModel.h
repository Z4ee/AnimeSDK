...
#define RPG_CLIENT_B51RACING_B51RACINGCARDEVELOPRESULTVALUEUPTOASTVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC856180)

namespace RPG::Client::B51Racing
{
	inline static constexpr unsigned int B51RacingCarDevelopResultValueUpToastViewModel_TypeDefinitionIndex = 80688;
