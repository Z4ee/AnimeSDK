...
#define RPG_CLIENT_B51RACING_B51RACINGSCOREBOARDPAGEVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC897C00)

namespace RPG::Client::B51Racing
{
	inline static constexpr unsigned int B51RacingScoreBoardPageViewModel_TypeDefinitionIndex = 80724;
	...
	public:
		...
		::System::Int32 PlayerNewRank; // 0x20
		::System::Int32 PlayerPrevRank; // 0x24
