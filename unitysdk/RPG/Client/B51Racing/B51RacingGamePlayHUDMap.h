...
#define RPG_CLIENT_B51RACING_B51RACINGGAMEPLAYHUDMAP_GET_ENEMYCARINFOLIST_OFFSET UNITYSDK_OFFSET(0xC879C10)
#define RPG_CLIENT_B51RACING_B51RACINGGAMEPLAYHUDMAP_INITVIEW_OFFSET UNITYSDK_OFFSET(0xC8787C0)
#define RPG_CLIENT_B51RACING_B51RACINGGAMEPLAYHUDMAP_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0xC877F80)
#define RPG_CLIENT_B51RACING_B51RACINGGAMEPLAYHUDMAP_SET_ENEMYCARINFOLIST_OFFSET UNITYSDK_OFFSET(0xC879C20)
#define RPG_CLIENT_B51RACING_B51RACINGGAMEPLAYHUDMAP_UPDATE_OFFSET UNITYSDK_OFFSET(0xC878A20)
#define RPG_CLIENT_B51RACING_B51RACINGGAMEPLAYHUDMAP__APPLYMAPTRANSFORM_OFFSET UNITYSDK_OFFSET(0xC8782E0)
#define RPG_CLIENT_B51RACING_B51RACINGGAMEPLAYHUDMAP__CREATEMARKER_OFFSET UNITYSDK_OFFSET(0xC8795A0)
#define RPG_CLIENT_B51RACING_B51RACINGGAMEPLAYHUDMAP__CTOR_OFFSET UNITYSDK_OFFSET(0xC879C30)
#define RPG_CLIENT_B51RACING_B51RACINGGAMEPLAYHUDMAP__ENSUREENEMYMARKERCOUNT_OFFSET UNITYSDK_OFFSET(0xC8791B0)
#define RPG_CLIENT_B51RACING_B51RACINGGAMEPLAYHUDMAP__FINDEXISTINGMARKER_OFFSET UNITYSDK_OFFSET(0xC879700)
#define RPG_CLIENT_B51RACING_B51RACINGGAMEPLAYHUDMAP__GETORCREATEPLAYERMARKER_OFFSET UNITYSDK_OFFSET(0xC878D30)
#define RPG_CLIENT_B51RACING_B51RACINGGAMEPLAYHUDMAP__GETROTATIONCOSSIN_OFFSET UNITYSDK_OFFSET(0xC878250)
#define RPG_CLIENT_B51RACING_B51RACINGGAMEPLAYHUDMAP__HIDEENEMYMARKERSFROM_OFFSET UNITYSDK_OFFSET(0xC879040)
#define RPG_CLIENT_B51RACING_B51RACINGGAMEPLAYHUDMAP__INITIALIZEPLAYERMARKER_OFFSET UNITYSDK_OFFSET(0xC879860)
#define RPG_CLIENT_B51RACING_B51RACINGGAMEPLAYHUDMAP__ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC879B60)
#define RPG_CLIENT_B51RACING_B51RACINGGAMEPLAYHUDMAP__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC879A20)
#define RPG_CLIENT_B51RACING_B51RACINGGAMEPLAYHUDMAP__ROTATE_OFFSET UNITYSDK_OFFSET(0xC878900)
#define RPG_CLIENT_B51RACING_B51RACINGGAMEPLAYHUDMAP__SETMARKERTRANSFORM_OFFSET UNITYSDK_OFFSET(0xC878F00)
#define RPG_CLIENT_B51RACING_B51RACINGGAMEPLAYHUDMAP__SETUPENEMYMARKERS_OFFSET UNITYSDK_OFFSET(0xC878600)
#define RPG_CLIENT_B51RACING_B51RACINGGAMEPLAYHUDMAP__SETUPENEMYMARKER_OFFSET UNITYSDK_OFFSET(0xC8792E0)
#define RPG_CLIENT_B51RACING_B51RACINGGAMEPLAYHUDMAP__SETUPMARKERVIEW_OFFSET UNITYSDK_OFFSET(0xC878DE0)
#define RPG_CLIENT_B51RACING_B51RACINGGAMEPLAYHUDMAP__SETUPPLAYERMARKER_OFFSET UNITYSDK_OFFSET(0xC878560)
#define RPG_CLIENT_B51RACING_B51RACINGGAMEPLAYHUDMAP__TOZROTATION_OFFSET UNITYSDK_OFFSET(0xC8789A0)
#define RPG_CLIENT_B51RACING_B51RACINGGAMEPLAYHUDMAP__TRYGETPLAYERINFO_OFFSET UNITYSDK_OFFSET(0xC878160)
#define RPG_CLIENT_B51RACING_B51RACINGGAMEPLAYHUDMAP__TRYLOADMINIMAPSPRITE_OFFSET UNITYSDK_OFFSET(0xC878820)
#define RPG_CLIENT_B51RACING_B51RACINGGAMEPLAYHUDMAP__TRYREGISTERUISHOWADAPTER_OFFSET UNITYSDK_OFFSET(0xC8798F0)
#define RPG_CLIENT_B51RACING_B51RACINGGAMEPLAYHUDMAP__TRYRESOLVESERVICES_OFFSET UNITYSDK_OFFSET(0xC878B70)
#define RPG_CLIENT_B51RACING_B51RACINGGAMEPLAYHUDMAP___TRYREGISTERUISHOWADAPTER_B__20_0_OFFSET UNITYSDK_OFFSET(0xC879CA0)

namespace RPG::Client::B51Racing
{
	inline static constexpr unsigned int B51RacingGamePlayHUDMap_TypeDefinitionIndex = 80560;
