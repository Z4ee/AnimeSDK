...
#define RPG_CLIENT_B51RACING_B51RACINGDIYNUMBUTTONITEMCONTROL_ONBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0xC866920)
#define RPG_CLIENT_B51RACING_B51RACINGDIYNUMBUTTONITEMCONTROL_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0xC8667D0)
#define RPG_CLIENT_B51RACING_B51RACINGDIYNUMBUTTONITEMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC8669D0)
#define RPG_CLIENT_B51RACING_B51RACINGDIYNUMBUTTONITEMCONTROL__GETBRIDGEHANDLE_OFFSET UNITYSDK_OFFSET(0xC866730)
#define RPG_CLIENT_B51RACING_B51RACINGDIYNUMBUTTONITEMCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC8665C0)
#define RPG_CLIENT_B51RACING_B51RACINGDIYNUMBUTTONITEMCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC866500)

namespace RPG::Client::B51Racing
{
	inline static constexpr unsigned int B51RacingDIYNumButtonItemControl_TypeDefinitionIndex = 80446;
