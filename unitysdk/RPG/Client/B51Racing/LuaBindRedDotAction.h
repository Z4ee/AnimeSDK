...
#define RPG_CLIENT_B51RACING_LUABINDREDDOTACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xC899D30)
#define RPG_CLIENT_B51RACING_LUABINDREDDOTACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xC899D80)
#define RPG_CLIENT_B51RACING_LUABINDREDDOTACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0xC899D00)
#define RPG_CLIENT_B51RACING_LUABINDREDDOTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xC899C10)

namespace RPG::Client::B51Racing
{
	inline static constexpr unsigned int LuaBindRedDotAction_TypeDefinitionIndex = 80429;
