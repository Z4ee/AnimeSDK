...
#define RPG_CLIENT_B51RACING_B51RACINGCARDETAILDIALOGCONTROL_ONPROPERTYINFOCLICK_OFFSET UNITYSDK_OFFSET(0x19ED79A0)
#define RPG_CLIENT_B51RACING_B51RACINGCARDETAILDIALOGCONTROL_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0x19ED71A0)
#define RPG_CLIENT_B51RACING_B51RACINGCARDETAILDIALOGCONTROL__BINDSTATITEMCONTROLS_OFFSET UNITYSDK_OFFSET(0x19ED6D10)
#define RPG_CLIENT_B51RACING_B51RACINGCARDETAILDIALOGCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x19ED8430)
#define RPG_CLIENT_B51RACING_B51RACINGCARDETAILDIALOGCONTROL__GETCONFIGREPO_OFFSET UNITYSDK_OFFSET(0x19ED7AD0)
#define RPG_CLIENT_B51RACING_B51RACINGCARDETAILDIALOGCONTROL__GETWINDOWSERVICE_OFFSET UNITYSDK_OFFSET(0x19ED7A00)
#define RPG_CLIENT_B51RACING_B51RACINGCARDETAILDIALOGCONTROL__ONGETBUFFSKILLITEM_OFFSET UNITYSDK_OFFSET(0x19ED81E0)
#define RPG_CLIENT_B51RACING_B51RACINGCARDETAILDIALOGCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x19ED6A90)
#define RPG_CLIENT_B51RACING_B51RACINGCARDETAILDIALOGCONTROL__REFRESHACTIVESKILL_OFFSET UNITYSDK_OFFSET(0x19ED7270)
#define RPG_CLIENT_B51RACING_B51RACINGCARDETAILDIALOGCONTROL__REFRESHBUFFSKILLLIST_OFFSET UNITYSDK_OFFSET(0x19ED77D0)
#define RPG_CLIENT_B51RACING_B51RACINGCARDETAILDIALOGCONTROL__REFRESHDISPLAYMODE_OFFSET UNITYSDK_OFFSET(0x19ED76C0)
#define RPG_CLIENT_B51RACING_B51RACINGCARDETAILDIALOGCONTROL__REFRESHDRIVERBONUSSECTION_OFFSET UNITYSDK_OFFSET(0x19ED7E40)
#define RPG_CLIENT_B51RACING_B51RACINGCARDETAILDIALOGCONTROL__REFRESHSTATBARS_OFFSET UNITYSDK_OFFSET(0x19ED75C0)
#define RPG_CLIENT_B51RACING_B51RACINGCARDETAILDIALOGCONTROL__REFRESHTARGETSTATICONS_OFFSET UNITYSDK_OFFSET(0x19ED7DC0)

namespace RPG::Client::B51Racing
{
	inline static constexpr unsigned int B51RacingCarDetailDialogControl_TypeDefinitionIndex = 80469;
	...
	public:
		...
		::Class_0_16E4307DCC419505_1405* _WindowService; // 0xB0
		...
		{
			return ((::Class_0_16E4307DCC419505_1405*(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_B51RACING_B51RACINGCARDETAILDIALOGCONTROL__GETWINDOWSERVICE_OFFSET))(this);
		}
	};
}
