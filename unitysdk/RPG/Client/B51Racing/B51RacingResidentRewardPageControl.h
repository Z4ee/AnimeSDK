...
#define RPG_CLIENT_B51RACING_B51RACINGRESIDENTREWARDPAGECONTROL_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0xC8960F0)
#define RPG_CLIENT_B51RACING_B51RACINGRESIDENTREWARDPAGECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC8961C0)
#define RPG_CLIENT_B51RACING_B51RACINGRESIDENTREWARDPAGECONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC896070)

namespace RPG::Client::B51Racing
{
	inline static constexpr unsigned int B51RacingResidentRewardPageControl_TypeDefinitionIndex = 80635;
