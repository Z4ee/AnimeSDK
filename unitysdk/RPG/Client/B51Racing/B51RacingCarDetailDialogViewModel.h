...
#define RPG_CLIENT_B51RACING_B51RACINGCARDETAILDIALOGVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x19ED8460)

namespace RPG::Client::B51Racing
{
	inline static constexpr unsigned int B51RacingCarDetailDialogViewModel_TypeDefinitionIndex = 80682;

	class B51RacingCarDetailDialogViewModel : public ::System::Object
	{
	public:
		::System::String* DriverIconID; // 0x10
		...
		::System::Single ActiveSkillExpProgress; // 0x30
		::System::UInt32 ActiveSkillLevel; // 0x34
		::System::UInt32 ActiveSkillID; // 0x38
