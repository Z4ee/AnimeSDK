...
#define RPG_CLIENT_B51RACING_B51RACINGDEVELOPVALUESINGLEICONITEMCONTROL_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0xC8744C0)
#define RPG_CLIENT_B51RACING_B51RACINGDEVELOPVALUESINGLEICONITEMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC874740)
#define RPG_CLIENT_B51RACING_B51RACINGDEVELOPVALUESINGLEICONITEMCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC874680)

namespace RPG::Client::B51Racing
{
	inline static constexpr unsigned int B51RacingDevelopValueSingleIconItemControl_TypeDefinitionIndex = 80498;
