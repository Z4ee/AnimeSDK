...
#define RPG_CLIENT_B51RACING_B51RACINGDIYDECOITEMCONTROL_ONITEMCLICK_OFFSET UNITYSDK_OFFSET(0xC864C10)
#define RPG_CLIENT_B51RACING_B51RACINGDIYDECOITEMCONTROL_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0xC864900)
#define RPG_CLIENT_B51RACING_B51RACINGDIYDECOITEMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC864CD0)
#define RPG_CLIENT_B51RACING_B51RACINGDIYDECOITEMCONTROL__GETBRIDGEHANDLE_OFFSET UNITYSDK_OFFSET(0xC864860)
#define RPG_CLIENT_B51RACING_B51RACINGDIYDECOITEMCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC8646F0)
#define RPG_CLIENT_B51RACING_B51RACINGDIYDECOITEMCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC8645F0)
#define RPG_CLIENT_B51RACING_B51RACINGDIYDECOITEMCONTROL__SETUPCARICON_OFFSET UNITYSDK_OFFSET(0xC864B40)

namespace RPG::Client::B51Racing
{
	inline static constexpr unsigned int B51RacingDIYDecoItemControl_TypeDefinitionIndex = 80443;
