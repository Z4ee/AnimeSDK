...
#define RPG_CLIENT_B51RACING_B51RACINGNEWDEVELOPTARGETSTATITEMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6C8560)

namespace RPG::Client::B51Racing
{
	inline static constexpr unsigned int B51RacingNewDevelopTargetStatItemViewModel_TypeDefinitionIndex = 80699;
