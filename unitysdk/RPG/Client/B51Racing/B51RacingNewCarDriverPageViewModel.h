...
#define RPG_CLIENT_B51RACING_B51RACINGNEWCARDRIVERPAGEVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC8921D0)

namespace RPG::Client::B51Racing
{
	inline static constexpr unsigned int B51RacingNewCarDriverPageViewModel_TypeDefinitionIndex = 80705;

	class B51RacingNewCarDriverPageViewModel : public ::System::Object
	{
	public:
		::System::String* AvatarFullBodyPath; // 0x10
		::System::Action* OnClose; // 0x18
		::RPG::Client::B51Racing::B51RacingDevelopValueIconListViewModel* BonusStatIconList; // 0x20
