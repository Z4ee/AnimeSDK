...
#define RPG_CLIENT_B51RACING_MONOB51RACINGREADYVEHICLEDETAILITEM_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0xC8A6730)
#define RPG_CLIENT_B51RACING_MONOB51RACINGREADYVEHICLEDETAILITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xC8AADE0)
#define RPG_CLIENT_B51RACING_MONOB51RACINGREADYVEHICLEDETAILITEM__ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC8AADA0)
#define RPG_CLIENT_B51RACING_MONOB51RACINGREADYVEHICLEDETAILITEM__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC8AACC0)

namespace RPG::Client::B51Racing
{
	inline static constexpr unsigned int MonoB51RacingReadyVehicleDetailItem_TypeDefinitionIndex = 80634;
