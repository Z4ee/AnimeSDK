...
#define RPG_CLIENT_B51RACING_B51RACINGCARDETAILBUFFSKILLITEMCONTROL_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0xC84DF60)
#define RPG_CLIENT_B51RACING_B51RACINGCARDETAILBUFFSKILLITEMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC84E220)
#define RPG_CLIENT_B51RACING_B51RACINGCARDETAILBUFFSKILLITEMCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC84DEA0)

namespace RPG::Client::B51Racing
{
	inline static constexpr unsigned int B51RacingCarDetailBuffSkillItemControl_TypeDefinitionIndex = 80469;
