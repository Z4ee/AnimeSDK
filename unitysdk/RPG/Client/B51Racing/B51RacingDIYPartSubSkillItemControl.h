...
#define RPG_CLIENT_B51RACING_B51RACINGDIYPARTSUBSKILLITEMCONTROL_ONITEMCLICK_OFFSET UNITYSDK_OFFSET(0x19EF93D0)
#define RPG_CLIENT_B51RACING_B51RACINGDIYPARTSUBSKILLITEMCONTROL_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0x19EF9060)
#define RPG_CLIENT_B51RACING_B51RACINGDIYPARTSUBSKILLITEMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x19EF9490)
#define RPG_CLIENT_B51RACING_B51RACINGDIYPARTSUBSKILLITEMCONTROL__GETBRIDGEHANDLE_OFFSET UNITYSDK_OFFSET(0x19EF8FC0)
#define RPG_CLIENT_B51RACING_B51RACINGDIYPARTSUBSKILLITEMCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x19EF8E50)
#define RPG_CLIENT_B51RACING_B51RACINGDIYPARTSUBSKILLITEMCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x19EF8D70)
#define RPG_CLIENT_B51RACING_B51RACINGDIYPARTSUBSKILLITEMCONTROL__SETUPCARICON_OFFSET UNITYSDK_OFFSET(0x19EF9300)

namespace RPG::Client::B51Racing
{
	inline static constexpr unsigned int B51RacingDIYPartSubSkillItemControl_TypeDefinitionIndex = 80454;
