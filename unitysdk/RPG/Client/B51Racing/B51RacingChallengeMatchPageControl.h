...
#define RPG_CLIENT_B51RACING_B51RACINGCHALLENGEMATCHPAGECONTROL_ONCARDETAILCLICK_OFFSET UNITYSDK_OFFSET(0xC863070)
#define RPG_CLIENT_B51RACING_B51RACINGCHALLENGEMATCHPAGECONTROL_ONCLOSECLICK_OFFSET UNITYSDK_OFFSET(0xC8630E0)
#define RPG_CLIENT_B51RACING_B51RACINGCHALLENGEMATCHPAGECONTROL_ONCUSTOMIZECARCLICK_OFFSET UNITYSDK_OFFSET(0xC863000)
#define RPG_CLIENT_B51RACING_B51RACINGCHALLENGEMATCHPAGECONTROL_ONITEMSELECTED_OFFSET UNITYSDK_OFFSET(0xC862E50)
#define RPG_CLIENT_B51RACING_B51RACINGCHALLENGEMATCHPAGECONTROL_ONRETURNTOTOP_OFFSET UNITYSDK_OFFSET(0xC862E00)
#define RPG_CLIENT_B51RACING_B51RACINGCHALLENGEMATCHPAGECONTROL_ONSTARTCLICK_OFFSET UNITYSDK_OFFSET(0xC862F50)
#define RPG_CLIENT_B51RACING_B51RACINGCHALLENGEMATCHPAGECONTROL_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0xC8625A0)
#define RPG_CLIENT_B51RACING_B51RACINGCHALLENGEMATCHPAGECONTROL__ACQUIRESCENETOKEN_OFFSET UNITYSDK_OFFSET(0xC862180)
#define RPG_CLIENT_B51RACING_B51RACINGCHALLENGEMATCHPAGECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC863780)
#define RPG_CLIENT_B51RACING_B51RACINGCHALLENGEMATCHPAGECONTROL__GETBRIDGEHANDLE_OFFSET UNITYSDK_OFFSET(0xC862500)
#define RPG_CLIENT_B51RACING_B51RACINGCHALLENGEMATCHPAGECONTROL__ONBACKPRESSED_OFFSET UNITYSDK_OFFSET(0xC8631C0)
#define RPG_CLIENT_B51RACING_B51RACINGCHALLENGEMATCHPAGECONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC862290)
#define RPG_CLIENT_B51RACING_B51RACINGCHALLENGEMATCHPAGECONTROL__ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC8635B0)
#define RPG_CLIENT_B51RACING_B51RACINGCHALLENGEMATCHPAGECONTROL__ONGETGRIDITEM_OFFSET UNITYSDK_OFFSET(0xC8632F0)
#define RPG_CLIENT_B51RACING_B51RACINGCHALLENGEMATCHPAGECONTROL__ONGRIDITEMCLICK_OFFSET UNITYSDK_OFFSET(0xC863530)
#define RPG_CLIENT_B51RACING_B51RACINGCHALLENGEMATCHPAGECONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC861FA0)
#define RPG_CLIENT_B51RACING_B51RACINGCHALLENGEMATCHPAGECONTROL__PLAYBGVIDEO_OFFSET UNITYSDK_OFFSET(0xC862BD0)
#define RPG_CLIENT_B51RACING_B51RACINGCHALLENGEMATCHPAGECONTROL__REFRESHDETAIL_OFFSET UNITYSDK_OFFSET(0xC862940)
#define RPG_CLIENT_B51RACING_B51RACINGCHALLENGEMATCHPAGECONTROL__RELEASETRANSIENTTOKEN_OFFSET UNITYSDK_OFFSET(0xC862840)
#define RPG_CLIENT_B51RACING_B51RACINGCHALLENGEMATCHPAGECONTROL__SETUPCAMERA_OFFSET UNITYSDK_OFFSET(0xC862760)

namespace RPG::Client::B51Racing
{
	inline static constexpr unsigned int B51RacingChallengeMatchPageControl_TypeDefinitionIndex = 80502;
