...
#define RPG_CLIENT_B51RACING_B51RACINGCARSTATITEMCONTROL_GETICONTRANSFORM_OFFSET UNITYSDK_OFFSET(0xC856440)
#define RPG_CLIENT_B51RACING_B51RACINGCARSTATITEMCONTROL_GET_ISANIMATING_OFFSET UNITYSDK_OFFSET(0xC858640)
#define RPG_CLIENT_B51RACING_B51RACINGCARSTATITEMCONTROL_PLAYHINTANIMATION_OFFSET UNITYSDK_OFFSET(0xC856BC0)
#define RPG_CLIENT_B51RACING_B51RACINGCARSTATITEMCONTROL_PLAYVALUEANIMATION_OFFSET UNITYSDK_OFFSET(0xC856A20)
#define RPG_CLIENT_B51RACING_B51RACINGCARSTATITEMCONTROL_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0xC84F360)
#define RPG_CLIENT_B51RACING_B51RACINGCARSTATITEMCONTROL_UPDATE_OFFSET UNITYSDK_OFFSET(0xC860CC0)
#define RPG_CLIENT_B51RACING_B51RACINGCARSTATITEMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC861120)
#define RPG_CLIENT_B51RACING_B51RACINGCARSTATITEMCONTROL__ENSUREBARMAX_OFFSET UNITYSDK_OFFSET(0xC860310)
#define RPG_CLIENT_B51RACING_B51RACINGCARSTATITEMCONTROL__ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC860E60)
#define RPG_CLIENT_B51RACING_B51RACINGCARSTATITEMCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC85FF90)
#define RPG_CLIENT_B51RACING_B51RACINGCARSTATITEMCONTROL__SETCURRENTVALUENORMALIZED_OFFSET UNITYSDK_OFFSET(0xC860BD0)
#define RPG_CLIENT_B51RACING_B51RACINGCARSTATITEMCONTROL__SETCURRENTVALUE_OFFSET UNITYSDK_OFFSET(0xC860650)
#define RPG_CLIENT_B51RACING_B51RACINGCARSTATITEMCONTROL__SETFINISHED_OFFSET UNITYSDK_OFFSET(0xC860B50)
#define RPG_CLIENT_B51RACING_B51RACINGCARSTATITEMCONTROL__SETPREFILL_OFFSET UNITYSDK_OFFSET(0xC8606D0)
#define RPG_CLIENT_B51RACING_B51RACINGCARSTATITEMCONTROL__SETSTATTYPE_OFFSET UNITYSDK_OFFSET(0xC860490)
#define RPG_CLIENT_B51RACING_B51RACINGCARSTATITEMCONTROL__SETTARGET_OFFSET UNITYSDK_OFFSET(0xC8609B0)
#define RPG_CLIENT_B51RACING_B51RACINGCARSTATITEMCONTROL__SETUPPREGLOW_OFFSET UNITYSDK_OFFSET(0xC860ED0)
#define RPG_CLIENT_B51RACING_B51RACINGCARSTATITEMCONTROL__STOPANIMATION_OFFSET UNITYSDK_OFFSET(0xC860440)

namespace RPG::Client::B51Racing
{
	inline static constexpr unsigned int B51RacingCarStatItemControl_TypeDefinitionIndex = 80490;
