...
#define RPG_CLIENT_B51RACING_B51RACINGNEWCARDISPLAYPAGEVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC891510)

namespace RPG::Client::B51Racing
{
	inline static constexpr unsigned int B51RacingNewCarDisplayPageViewModel_TypeDefinitionIndex = 80678;
