...
#define RPG_CLIENT_B51RACING_B51RACINGDEVELOPPARTSELECTITEMCONTROL_GET_ITEMINDEX_OFFSET UNITYSDK_OFFSET(0xC8736C0)
#define RPG_CLIENT_B51RACING_B51RACINGDEVELOPPARTSELECTITEMCONTROL_GET_ONSELECTCALLBACK_OFFSET UNITYSDK_OFFSET(0xC8736E0)
#define RPG_CLIENT_B51RACING_B51RACINGDEVELOPPARTSELECTITEMCONTROL_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0xC85A560)
#define RPG_CLIENT_B51RACING_B51RACINGDEVELOPPARTSELECTITEMCONTROL_SET_ITEMINDEX_OFFSET UNITYSDK_OFFSET(0xC8736D0)
#define RPG_CLIENT_B51RACING_B51RACINGDEVELOPPARTSELECTITEMCONTROL_SET_ONSELECTCALLBACK_OFFSET UNITYSDK_OFFSET(0xC8736F0)
#define RPG_CLIENT_B51RACING_B51RACINGDEVELOPPARTSELECTITEMCONTROL__BINDBUTTON_OFFSET UNITYSDK_OFFSET(0xC8737C0)
#define RPG_CLIENT_B51RACING_B51RACINGDEVELOPPARTSELECTITEMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC873A50)
#define RPG_CLIENT_B51RACING_B51RACINGDEVELOPPARTSELECTITEMCONTROL__GETBRIDGEHANDLE_OFFSET UNITYSDK_OFFSET(0xC8739B0)
#define RPG_CLIENT_B51RACING_B51RACINGDEVELOPPARTSELECTITEMCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC873700)
#define RPG_CLIENT_B51RACING_B51RACINGDEVELOPPARTSELECTITEMCONTROL__ONITEMCLICK_OFFSET UNITYSDK_OFFSET(0xC873950)

namespace RPG::Client::B51Racing
{
	inline static constexpr unsigned int B51RacingDevelopPartSelectItemControl_TypeDefinitionIndex = 80495;
