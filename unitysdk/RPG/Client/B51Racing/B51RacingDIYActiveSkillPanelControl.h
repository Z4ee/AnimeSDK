...
#define RPG_CLIENT_B51RACING_B51RACINGDIYACTIVESKILLPANELCONTROL_GETSELECTEDCARID_OFFSET UNITYSDK_OFFSET(0xC864260)
#define RPG_CLIENT_B51RACING_B51RACINGDIYACTIVESKILLPANELCONTROL_HASSELECTION_OFFSET UNITYSDK_OFFSET(0xC864300)
#define RPG_CLIENT_B51RACING_B51RACINGDIYACTIVESKILLPANELCONTROL_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0xC864000)
#define RPG_CLIENT_B51RACING_B51RACINGDIYACTIVESKILLPANELCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC8645B0)
#define RPG_CLIENT_B51RACING_B51RACINGDIYACTIVESKILLPANELCONTROL__GETBRIDGEHANDLE_OFFSET UNITYSDK_OFFSET(0xC863F60)
#define RPG_CLIENT_B51RACING_B51RACINGDIYACTIVESKILLPANELCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC863D00)
#define RPG_CLIENT_B51RACING_B51RACINGDIYACTIVESKILLPANELCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC863C20)
#define RPG_CLIENT_B51RACING_B51RACINGDIYACTIVESKILLPANELCONTROL__ONITEM1CLICK_OFFSET UNITYSDK_OFFSET(0xC8643B0)
#define RPG_CLIENT_B51RACING_B51RACINGDIYACTIVESKILLPANELCONTROL__ONITEM2CLICK_OFFSET UNITYSDK_OFFSET(0xC8644B0)
#define RPG_CLIENT_B51RACING_B51RACINGDIYACTIVESKILLPANELCONTROL__REFRESHCHECKEDSTATE_OFFSET UNITYSDK_OFFSET(0xC864130)

namespace RPG::Client::B51Racing
{
	inline static constexpr unsigned int B51RacingDIYActiveSkillPanelControl_TypeDefinitionIndex = 80442;
