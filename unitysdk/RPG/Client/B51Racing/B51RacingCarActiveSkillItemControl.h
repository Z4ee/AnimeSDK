...
#define RPG_CLIENT_B51RACING_B51RACINGCARACTIVESKILLITEMCONTROL_SETCHECKED_OFFSET UNITYSDK_OFFSET(0x19ED4860)
#define RPG_CLIENT_B51RACING_B51RACINGCARACTIVESKILLITEMCONTROL_SETCURRENT_OFFSET UNITYSDK_OFFSET(0x19ED48C0)
#define RPG_CLIENT_B51RACING_B51RACINGCARACTIVESKILLITEMCONTROL_SETEXPBARVALUE_OFFSET UNITYSDK_OFFSET(0x19ED4760)
#define RPG_CLIENT_B51RACING_B51RACINGCARACTIVESKILLITEMCONTROL_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0x19ED4010)
#define RPG_CLIENT_B51RACING_B51RACINGCARACTIVESKILLITEMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x19ED4A10)
#define RPG_CLIENT_B51RACING_B51RACINGCARACTIVESKILLITEMCONTROL__GETCONFIGREPO_OFFSET UNITYSDK_OFFSET(0x19ED4940)
#define RPG_CLIENT_B51RACING_B51RACINGCARACTIVESKILLITEMCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x19ED3E80)
#define RPG_CLIENT_B51RACING_B51RACINGCARACTIVESKILLITEMCONTROL__REFRESHEXPBAR_OFFSET UNITYSDK_OFFSET(0x19ED4640)
#define RPG_CLIENT_B51RACING_B51RACINGCARACTIVESKILLITEMCONTROL__REFRESHSKILLINFO_OFFSET UNITYSDK_OFFSET(0x19ED4110)

namespace RPG::Client::B51Racing
{
	inline static constexpr unsigned int B51RacingCarActiveSkillItemControl_TypeDefinitionIndex = 80398;
