...
#define RPG_CLIENT_B51RACING_MONOB51RACINGSEASONPROGRESSDIALOG___WAITCALENDARADVANCEPREVIEWASYNC_D__48_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x149F20)
#define RPG_CLIENT_B51RACING_MONOB51RACINGSEASONPROGRESSDIALOG___WAITCALENDARADVANCEPREVIEWASYNC_D__48_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x1020)

namespace RPG::Client::B51Racing
{
	inline static constexpr unsigned int MonoB51RacingSeasonProgressDialog___WaitCalendarAdvancePreviewAsync_d__48_TypeDefinitionIndex = 80654;

	struct alignas(8) MonoB51RacingSeasonProgressDialog___WaitCalendarAdvancePreviewAsync_d__48
	{
		::Cysharp::Threading::Tasks::UniTask_Awaiter __u__1; // 0x10
		::RPG::Client::B51Racing::MonoB51RacingSeasonProgressDialog* __4__this; // 0x20
		...
		::System::Single _targetTime_5__2; // 0x40
