...
#define RPG_CLIENT_B51RACING_B51RACINGNEWCARDRIVERPAGECONTROL_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0x1B6C7180)
#define RPG_CLIENT_B51RACING_B51RACINGNEWCARDRIVERPAGECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6C7750)
#define RPG_CLIENT_B51RACING_B51RACINGNEWCARDRIVERPAGECONTROL__GETBRIDGEHANDLE_OFFSET UNITYSDK_OFFSET(0x1B6C6AD0)
#define RPG_CLIENT_B51RACING_B51RACINGNEWCARDRIVERPAGECONTROL__GETUINAVIGATIONZONEMANAGER_OFFSET UNITYSDK_OFFSET(0x1B6C6B70)
#define RPG_CLIENT_B51RACING_B51RACINGNEWCARDRIVERPAGECONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1B6C6C60)
#define RPG_CLIENT_B51RACING_B51RACINGNEWCARDRIVERPAGECONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1B6C7060)
#define RPG_CLIENT_B51RACING_B51RACINGNEWCARDRIVERPAGECONTROL__ONSTARTEXIT_OFFSET UNITYSDK_OFFSET(0x1B6C6FB0)
#define RPG_CLIENT_B51RACING_B51RACINGNEWCARDRIVERPAGECONTROL__REFRESHAVATAR_OFFSET UNITYSDK_OFFSET(0x1B6C7290)
#define RPG_CLIENT_B51RACING_B51RACINGNEWCARDRIVERPAGECONTROL__REFRESHBONUSICONLIST_OFFSET UNITYSDK_OFFSET(0x1B6C76D0)
#define RPG_CLIENT_B51RACING_B51RACINGNEWCARDRIVERPAGECONTROL__REFRESHTEXTS_OFFSET UNITYSDK_OFFSET(0x1B6C7380)

namespace RPG::Client::B51Racing
{
	inline static constexpr unsigned int B51RacingNewCarDriverPageControl_TypeDefinitionIndex = 80506;
