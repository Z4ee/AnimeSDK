...
#define RPG_CLIENT_B51RACING_B51RACINGCARSTATDESCITEMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC85F9A0)

namespace RPG::Client::B51Racing
{
	inline static constexpr unsigned int B51RacingCarStatDescItemViewModel_TypeDefinitionIndex = 80690;
