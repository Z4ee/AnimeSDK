...
#define RPG_CLIENT_B51RACING_B51RACINGDEVELOPVALUEICONLISTCONTROL_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0xC873E70)
#define RPG_CLIENT_B51RACING_B51RACINGDEVELOPVALUEICONLISTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC874640)
#define RPG_CLIENT_B51RACING_B51RACINGDEVELOPVALUEICONLISTCONTROL__ONGETITEM_OFFSET UNITYSDK_OFFSET(0xC874080)
#define RPG_CLIENT_B51RACING_B51RACINGDEVELOPVALUEICONLISTCONTROL__ONGETLITEVERSIONITEM_OFFSET UNITYSDK_OFFSET(0xC8742A0)
#define RPG_CLIENT_B51RACING_B51RACINGDEVELOPVALUEICONLISTCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC873E10)

namespace RPG::Client::B51Racing
{
	inline static constexpr unsigned int B51RacingDevelopValueIconListControl_TypeDefinitionIndex = 80497;
