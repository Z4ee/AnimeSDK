...
#define RPG_CLIENT_B51RACING_B51RACINGDIYSUBSKILLPANELCONTROL_GETSELECTEDPARTIDS_OFFSET UNITYSDK_OFFSET(0x19EF4660)
#define RPG_CLIENT_B51RACING_B51RACINGDIYSUBSKILLPANELCONTROL_HASSELECTIONCOMPLETED_OFFSET UNITYSDK_OFFSET(0x19EF4840)
#define RPG_CLIENT_B51RACING_B51RACINGDIYSUBSKILLPANELCONTROL_SETCONTENTVISIBLE_OFFSET UNITYSDK_OFFSET(0x19EF4C80)
#define RPG_CLIENT_B51RACING_B51RACINGDIYSUBSKILLPANELCONTROL_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0x19EF5020)
#define RPG_CLIENT_B51RACING_B51RACINGDIYSUBSKILLPANELCONTROL__BUILDPARTITEMVIEWMODELS_OFFSET UNITYSDK_OFFSET(0x19EFA9E0)
#define RPG_CLIENT_B51RACING_B51RACINGDIYSUBSKILLPANELCONTROL__BUILDSLOTITEMVIEWMODELS_OFFSET UNITYSDK_OFFSET(0x19EF9AE0)
#define RPG_CLIENT_B51RACING_B51RACINGDIYSUBSKILLPANELCONTROL__CCTOR_OFFSET UNITYSDK_OFFSET(0x19EFBA30)
#define RPG_CLIENT_B51RACING_B51RACINGDIYSUBSKILLPANELCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x19EFBA00)
#define RPG_CLIENT_B51RACING_B51RACINGDIYSUBSKILLPANELCONTROL__FINDPARTICONPATH_OFFSET UNITYSDK_OFFSET(0x19EFA550)
#define RPG_CLIENT_B51RACING_B51RACINGDIYSUBSKILLPANELCONTROL__GETBRIDGEHANDLE_OFFSET UNITYSDK_OFFSET(0x19EF9A40)
#define RPG_CLIENT_B51RACING_B51RACINGDIYSUBSKILLPANELCONTROL__GETSELECTEDITEMINDEX_OFFSET UNITYSDK_OFFSET(0x19EFADE0)
#define RPG_CLIENT_B51RACING_B51RACINGDIYSUBSKILLPANELCONTROL__GETUINAVIGATIONZONEMANAGER_OFFSET UNITYSDK_OFFSET(0x19EFAF40)
#define RPG_CLIENT_B51RACING_B51RACINGDIYSUBSKILLPANELCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x19EF97E0)
#define RPG_CLIENT_B51RACING_B51RACINGDIYSUBSKILLPANELCONTROL__ONGETPARTITEM_OFFSET UNITYSDK_OFFSET(0x19EFB030)
#define RPG_CLIENT_B51RACING_B51RACINGDIYSUBSKILLPANELCONTROL__ONGETSLOTITEM_OFFSET UNITYSDK_OFFSET(0x19EFA6A0)
#define RPG_CLIENT_B51RACING_B51RACINGDIYSUBSKILLPANELCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x19EF94C0)
#define RPG_CLIENT_B51RACING_B51RACINGDIYSUBSKILLPANELCONTROL__ONNEXTSLOT_OFFSET UNITYSDK_OFFSET(0x19EFB810)
#define RPG_CLIENT_B51RACING_B51RACINGDIYSUBSKILLPANELCONTROL__ONPARTITEMCLICKED_OFFSET UNITYSDK_OFFSET(0x19EFB200)
#define RPG_CLIENT_B51RACING_B51RACINGDIYSUBSKILLPANELCONTROL__ONPRESLOT_OFFSET UNITYSDK_OFFSET(0x19EFB620)
#define RPG_CLIENT_B51RACING_B51RACINGDIYSUBSKILLPANELCONTROL__ONSLOTITEMCLICKED_OFFSET UNITYSDK_OFFSET(0x19EFA8E0)
#define RPG_CLIENT_B51RACING_B51RACINGDIYSUBSKILLPANELCONTROL__REFRESHPARTLIST_OFFSET UNITYSDK_OFFSET(0x19EF9FD0)
#define RPG_CLIENT_B51RACING_B51RACINGDIYSUBSKILLPANELCONTROL__REFRESHSLOTLIST_OFFSET UNITYSDK_OFFSET(0x19EF9E40)
#define RPG_CLIENT_B51RACING_B51RACINGDIYSUBSKILLPANELCONTROL__REFRESHTEXTS_OFFSET UNITYSDK_OFFSET(0x19EFA3A0)
#define RPG_CLIENT_B51RACING_B51RACINGDIYSUBSKILLPANELCONTROL__SETSLOTCHECKED_OFFSET UNITYSDK_OFFSET(0x19EFA270)
#define RPG_CLIENT_B51RACING_B51RACINGDIYSUBSKILLPANELCONTROL__UPDATEPARTSELECTIONSTATE_OFFSET UNITYSDK_OFFSET(0x19EFB380)
#define RPG_CLIENT_B51RACING_B51RACINGDIYSUBSKILLPANELCONTROL__UPDATESLOTEQUIPSTATE_OFFSET UNITYSDK_OFFSET(0x19EFB4B0)

namespace RPG::Client::B51Racing
{
	inline static constexpr unsigned int B51RacingDIYSubSkillPanelControl_TypeDefinitionIndex = 80455;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::RPG::GameCore::B51RacingPartType, ::RPG::Client::TextID>**)Il2CppClass::FromTypeDefinitionIndex(B51RacingDIYSubSkillPanelControl_TypeDefinitionIndex)->GetStaticField(0x66440);
		}
		static ::Il2CppArray<::RPG::GameCore::B51RacingPartType>** StaticGet__SLOT_PART_TYPES()
		{
			return (::Il2CppArray<::RPG::GameCore::B51RacingPartType>**)Il2CppClass::FromTypeDefinitionIndex(B51RacingDIYSubSkillPanelControl_TypeDefinitionIndex)->GetStaticField(0x66448);
		}
