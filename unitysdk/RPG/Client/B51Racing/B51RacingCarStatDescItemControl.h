...
#define RPG_CLIENT_B51RACING_B51RACINGCARSTATDESCITEMCONTROL_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0x19EE8800)
#define RPG_CLIENT_B51RACING_B51RACINGCARSTATDESCITEMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x19EE8BC0)
#define RPG_CLIENT_B51RACING_B51RACINGCARSTATDESCITEMCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x19EE8B00)

namespace RPG::Client::B51Racing
{
	inline static constexpr unsigned int B51RacingCarStatDescItemControl_TypeDefinitionIndex = 80488;
