...
#define RPG_CLIENT_B51RACING_B51RACINGDIYACTIVESKILLPANELVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x19EED250)

namespace RPG::Client::B51Racing
{
	inline static constexpr unsigned int B51RacingDIYActiveSkillPanelViewModel_TypeDefinitionIndex = 80661;
	...
	public:
		...
		::System::UInt32 SelectedCarID; // 0x2C
