...
#define RPG_CLIENT_B51RACING_B51RACINGCARACTIVESKILLUPGRADEPAGECONTROL_PLAYEXPANIMATION_OFFSET UNITYSDK_OFFSET(0x19ED5BF0)
#define RPG_CLIENT_B51RACING_B51RACINGCARACTIVESKILLUPGRADEPAGECONTROL_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0x19ED54B0)
#define RPG_CLIENT_B51RACING_B51RACINGCARACTIVESKILLUPGRADEPAGECONTROL__BLOCKINTERACTION_OFFSET UNITYSDK_OFFSET(0x19ED5A90)
#define RPG_CLIENT_B51RACING_B51RACINGCARACTIVESKILLUPGRADEPAGECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x19ED6290)
#define RPG_CLIENT_B51RACING_B51RACINGCARACTIVESKILLUPGRADEPAGECONTROL__GETBRIDGEHANDLE_OFFSET UNITYSDK_OFFSET(0x19ED4D00)
#define RPG_CLIENT_B51RACING_B51RACINGCARACTIVESKILLUPGRADEPAGECONTROL__GETUINAVIGATIONZONEMANAGER_OFFSET UNITYSDK_OFFSET(0x19ED4DA0)
#define RPG_CLIENT_B51RACING_B51RACINGCARACTIVESKILLUPGRADEPAGECONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x19ED4E90)
#define RPG_CLIENT_B51RACING_B51RACINGCARACTIVESKILLUPGRADEPAGECONTROL__ONDESTROY_OFFSET UNITYSDK_OFFSET(0x19ED5120)
#define RPG_CLIENT_B51RACING_B51RACINGCARACTIVESKILLUPGRADEPAGECONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x19ED4A50)
#define RPG_CLIENT_B51RACING_B51RACINGCARACTIVESKILLUPGRADEPAGECONTROL__ONINPUTDEVICECLASSSWITCHED_OFFSET UNITYSDK_OFFSET(0x19ED5DB0)
#define RPG_CLIENT_B51RACING_B51RACINGCARACTIVESKILLUPGRADEPAGECONTROL__ONLEVELUPANIMFINISH_OFFSET UNITYSDK_OFFSET(0x19ED6170)
#define RPG_CLIENT_B51RACING_B51RACINGCARACTIVESKILLUPGRADEPAGECONTROL__ONSTARTEXIT_OFFSET UNITYSDK_OFFSET(0x19ED5400)
#define RPG_CLIENT_B51RACING_B51RACINGCARACTIVESKILLUPGRADEPAGECONTROL__PLAYEXPANIMSEQUENCE_OFFSET UNITYSDK_OFFSET(0x19ED5D20)
#define RPG_CLIENT_B51RACING_B51RACINGCARACTIVESKILLUPGRADEPAGECONTROL__REFRESHDAYBAR_OFFSET UNITYSDK_OFFSET(0x19ED5570)
#define RPG_CLIENT_B51RACING_B51RACINGCARACTIVESKILLUPGRADEPAGECONTROL__REFRESHSKILLSVIEW_OFFSET UNITYSDK_OFFSET(0x19ED5970)
#define RPG_CLIENT_B51RACING_B51RACINGCARACTIVESKILLUPGRADEPAGECONTROL__REFRESHTITLE_OFFSET UNITYSDK_OFFSET(0x19ED5850)
#define RPG_CLIENT_B51RACING_B51RACINGCARACTIVESKILLUPGRADEPAGECONTROL__SETUPMONOINCONTROLMOVESENABLE_OFFSET UNITYSDK_OFFSET(0x19ED5F10)
#define RPG_CLIENT_B51RACING_B51RACINGCARACTIVESKILLUPGRADEPAGECONTROL__SETUPMONOINCONTROLTIPS_OFFSET UNITYSDK_OFFSET(0x19ED5FB0)
#define RPG_CLIENT_B51RACING_B51RACINGCARACTIVESKILLUPGRADEPAGECONTROL__SETUPNAVISCROLLERENABLE_OFFSET UNITYSDK_OFFSET(0x19ED5E70)
#define RPG_CLIENT_B51RACING_B51RACINGCARACTIVESKILLUPGRADEPAGECONTROL__UNBLOCKINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x19ED51E0)
#define RPG_CLIENT_B51RACING_B51RACINGCARACTIVESKILLUPGRADEPAGECONTROL___ONINITIALIZECOMPONENT_B__16_0_OFFSET UNITYSDK_OFFSET(0x19ED62C0)

namespace RPG::Client::B51Racing
{
	inline static constexpr unsigned int B51RacingCarActiveSkillUpgradePageControl_TypeDefinitionIndex = 80399;
