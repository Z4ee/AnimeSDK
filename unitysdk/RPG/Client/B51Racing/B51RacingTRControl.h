...
#define RPG_CLIENT_B51RACING_B51RACINGTRCONTROL_HIDE_OFFSET UNITYSDK_OFFSET(0x1B6CD5D0)
#define RPG_CLIENT_B51RACING_B51RACINGTRCONTROL_ONTREVENTTRIGGERED_OFFSET UNITYSDK_OFFSET(0x1B6CDB60)
#define RPG_CLIENT_B51RACING_B51RACINGTRCONTROL_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0x1B6CD1C0)
#define RPG_CLIENT_B51RACING_B51RACINGTRCONTROL_TICK_OFFSET UNITYSDK_OFFSET(0x1B6CD9B0)
#define RPG_CLIENT_B51RACING_B51RACINGTRCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6CEC00)
#define RPG_CLIENT_B51RACING_B51RACINGTRCONTROL__FINISHORNOTIFYPRESENTATION_OFFSET UNITYSDK_OFFSET(0x1B6CDD00)
#define RPG_CLIENT_B51RACING_B51RACINGTRCONTROL__FINISHPRESENTATIONIFNEEDED_OFFSET UNITYSDK_OFFSET(0x1B6CD6B0)
#define RPG_CLIENT_B51RACING_B51RACINGTRCONTROL__GETCONFIGREPOSITORY_OFFSET UNITYSDK_OFFSET(0x1B6CDD70)
#define RPG_CLIENT_B51RACING_B51RACINGTRCONTROL__GETMATCHFLOWSERVICE_OFFSET UNITYSDK_OFFSET(0x1B6CE6A0)
#define RPG_CLIENT_B51RACING_B51RACINGTRCONTROL__GETTEMPORARYBETAMINIMUMSHOWDURATION_OFFSET UNITYSDK_OFFSET(0x1B6CE100)
#define RPG_CLIENT_B51RACING_B51RACINGTRCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1B6CE840)
#define RPG_CLIENT_B51RACING_B51RACINGTRCONTROL__ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B6CEA80)
#define RPG_CLIENT_B51RACING_B51RACINGTRCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1B6CE740)
#define RPG_CLIENT_B51RACING_B51RACINGTRCONTROL__ONVOICEFINISHED_OFFSET UNITYSDK_OFFSET(0x1B6CE5F0)
#define RPG_CLIENT_B51RACING_B51RACINGTRCONTROL__PLAYANIMATION_OFFSET UNITYSDK_OFFSET(0x1B6CE1F0)
#define RPG_CLIENT_B51RACING_B51RACINGTRCONTROL__PLAYTOAST_OFFSET UNITYSDK_OFFSET(0x1B6CDE30)
#define RPG_CLIENT_B51RACING_B51RACINGTRCONTROL__PLAYVOICE_OFFSET UNITYSDK_OFFSET(0x1B6CE450)
#define RPG_CLIENT_B51RACING_B51RACINGTRCONTROL__SETVISIBLE_OFFSET UNITYSDK_OFFSET(0x1B6CD860)
#define RPG_CLIENT_B51RACING_B51RACINGTRCONTROL__STARTFADEOUT_OFFSET UNITYSDK_OFFSET(0x1B6CDAA0)
#define RPG_CLIENT_B51RACING_B51RACINGTRCONTROL__STOPVOICE_OFFSET UNITYSDK_OFFSET(0x1B6CD7C0)
#define RPG_CLIENT_B51RACING_B51RACINGTRCONTROL__TRYREGISTERTICK_OFFSET UNITYSDK_OFFSET(0x1B6CE330)

namespace RPG::Client::B51Racing
{
	inline static constexpr unsigned int B51RacingTRControl_TypeDefinitionIndex = 80576;
