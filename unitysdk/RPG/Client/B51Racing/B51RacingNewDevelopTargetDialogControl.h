...
#define RPG_CLIENT_B51RACING_B51RACINGNEWDEVELOPTARGETDIALOGCONTROL_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0xC8928C0)
#define RPG_CLIENT_B51RACING_B51RACINGNEWDEVELOPTARGETDIALOGCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC892F70)
#define RPG_CLIENT_B51RACING_B51RACINGNEWDEVELOPTARGETDIALOGCONTROL__GETBRIDGEHANDLE_OFFSET UNITYSDK_OFFSET(0xC892730)
#define RPG_CLIENT_B51RACING_B51RACINGNEWDEVELOPTARGETDIALOGCONTROL__GETUINAVIGATIONZONEMANAGER_OFFSET UNITYSDK_OFFSET(0xC8927D0)
#define RPG_CLIENT_B51RACING_B51RACINGNEWDEVELOPTARGETDIALOGCONTROL__ONBACKPRESS_OFFSET UNITYSDK_OFFSET(0xC892F30)
#define RPG_CLIENT_B51RACING_B51RACINGNEWDEVELOPTARGETDIALOGCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC892320)
#define RPG_CLIENT_B51RACING_B51RACINGNEWDEVELOPTARGETDIALOGCONTROL__ONEXITCLICK_OFFSET UNITYSDK_OFFSET(0xC892DA0)
#define RPG_CLIENT_B51RACING_B51RACINGNEWDEVELOPTARGETDIALOGCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC8921E0)
#define RPG_CLIENT_B51RACING_B51RACINGNEWDEVELOPTARGETDIALOGCONTROL__ONSTARTEXIT_OFFSET UNITYSDK_OFFSET(0xC892E80)
#define RPG_CLIENT_B51RACING_B51RACINGNEWDEVELOPTARGETDIALOGCONTROL__REFRESHPARTINFO_OFFSET UNITYSDK_OFFSET(0xC8929E0)
#define RPG_CLIENT_B51RACING_B51RACINGNEWDEVELOPTARGETDIALOGCONTROL__REFRESHSKILLINFO_OFFSET UNITYSDK_OFFSET(0xC892B30)
#define RPG_CLIENT_B51RACING_B51RACINGNEWDEVELOPTARGETDIALOGCONTROL__REFRESHTARGETREQUIREICONS_OFFSET UNITYSDK_OFFSET(0xC892D30)

namespace RPG::Client::B51Racing
{
	inline static constexpr unsigned int B51RacingNewDevelopTargetDialogControl_TypeDefinitionIndex = 80499;
