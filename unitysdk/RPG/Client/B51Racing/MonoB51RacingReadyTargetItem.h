...
#define RPG_CLIENT_B51RACING_MONOB51RACINGREADYTARGETITEM_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0x1B6DF4B0)
#define RPG_CLIENT_B51RACING_MONOB51RACINGREADYTARGETITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6E0200)
#define RPG_CLIENT_B51RACING_MONOB51RACINGREADYTARGETITEM__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1B6E0150)

namespace RPG::Client::B51Racing
{
	inline static constexpr unsigned int MonoB51RacingReadyTargetItem_TypeDefinitionIndex = 80632;
