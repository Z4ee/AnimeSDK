...
#define RPG_CLIENT_B51RACING_B51RACINGCARTARGETPARTICONLITECONTROL_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0x19ED3C30)
#define RPG_CLIENT_B51RACING_B51RACINGCARTARGETPARTICONLITECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x19EEA1D0)
#define RPG_CLIENT_B51RACING_B51RACINGCARTARGETPARTICONLITECONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x19EEA0C0)
#define RPG_CLIENT_B51RACING_B51RACINGCARTARGETPARTICONLITECONTROL__PARTTYPETOSTATENAME_OFFSET UNITYSDK_OFFSET(0x19EEA140)

namespace RPG::Client::B51Racing
{
	inline static constexpr unsigned int B51RacingCarTargetPartIconLiteControl_TypeDefinitionIndex = 80491;
