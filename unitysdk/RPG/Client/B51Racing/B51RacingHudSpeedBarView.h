...
#define RPG_CLIENT_B51RACING_B51RACINGHUDSPEEDBARVIEW_GET_GEARTRANSITIONDURATION_OFFSET UNITYSDK_OFFSET(0xC8872D0)
#define RPG_CLIENT_B51RACING_B51RACINGHUDSPEEDBARVIEW_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xC88DE90)
#define RPG_CLIENT_B51RACING_B51RACINGHUDSPEEDBARVIEW_METHOD_5_4389275F4099DE36_OFFSET UNITYSDK_OFFSET(0xC88E280)
#define RPG_CLIENT_B51RACING_B51RACINGHUDSPEEDBARVIEW_METHOD_5_73FB9DE4849AF1B5_OFFSET UNITYSDK_OFFSET(0xC88DE20)
#define RPG_CLIENT_B51RACING_B51RACINGHUDSPEEDBARVIEW_METHOD_5_E52129E82CD2D7F8_OFFSET UNITYSDK_OFFSET(0xC88DF30)
#define RPG_CLIENT_B51RACING_B51RACINGHUDSPEEDBARVIEW_ONENABLE_OFFSET UNITYSDK_OFFSET(0xC88E240)
#define RPG_CLIENT_B51RACING_B51RACINGHUDSPEEDBARVIEW_SETSPEEDBARPROGRESS_OFFSET UNITYSDK_OFFSET(0xC886970)
#define RPG_CLIENT_B51RACING_B51RACINGHUDSPEEDBARVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xC88E2D0)

namespace RPG::Client::B51Racing
{
	inline static constexpr unsigned int B51RacingHudSpeedBarView_TypeDefinitionIndex = 80576;
