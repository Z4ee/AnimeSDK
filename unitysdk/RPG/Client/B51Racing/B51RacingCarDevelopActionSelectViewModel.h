...
#define RPG_CLIENT_B51RACING_B51RACINGCARDEVELOPACTIONSELECTVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC858700)

namespace RPG::Client::B51Racing
{
	inline static constexpr unsigned int B51RacingCarDevelopActionSelectViewModel_TypeDefinitionIndex = 80685;
	...
	public:
		...
		::RPG::Client::B51Racing::B51RacingDevelopValueIconListViewModel* TargetPartRequireStatIconList; // 0x18
		...
		::System::String* TargetPartIconPath; // 0x30
		::RPG::Client::TextID TargetBuffName; // 0x38
		::System::Int32 RoundIndex; // 0x48
		::RPG::GameCore::B51RacingPartType TargetPartSlotType; // 0x4C
		::System::Int32 TotalRounds; // 0x50
		::System::Int32 SelectedCardIndex; // 0x54
		::System::Boolean InitAsEmptyState; // 0x58
		::System::UInt32 TargetPartID; // 0x5C
		::RPG::Client::TextID RoundText; // 0x60
