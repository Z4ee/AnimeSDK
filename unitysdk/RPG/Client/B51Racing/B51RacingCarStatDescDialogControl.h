...
#define RPG_CLIENT_B51RACING_B51RACINGCARSTATDESCDIALOGCONTROL_ONBLANKCLOSEANDEXIT_OFFSET UNITYSDK_OFFSET(0x19EE8460)
#define RPG_CLIENT_B51RACING_B51RACINGCARSTATDESCDIALOGCONTROL_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0x19EE7910)
#define RPG_CLIENT_B51RACING_B51RACINGCARSTATDESCDIALOGCONTROL__BUILDDISPLAYLIST_OFFSET UNITYSDK_OFFSET(0x19EE79C0)
#define RPG_CLIENT_B51RACING_B51RACINGCARSTATDESCDIALOGCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x19EE8AC0)
#define RPG_CLIENT_B51RACING_B51RACINGCARSTATDESCDIALOGCONTROL__GETBRIDGEHANDLE_OFFSET UNITYSDK_OFFSET(0x19EE7780)
#define RPG_CLIENT_B51RACING_B51RACINGCARSTATDESCDIALOGCONTROL__GETCONFIGREPO_OFFSET UNITYSDK_OFFSET(0x19EE8550)
#define RPG_CLIENT_B51RACING_B51RACINGCARSTATDESCDIALOGCONTROL__GETUINAVIGATIONZONEMANAGER_OFFSET UNITYSDK_OFFSET(0x19EE7820)
#define RPG_CLIENT_B51RACING_B51RACINGCARSTATDESCDIALOGCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x19EE7550)
#define RPG_CLIENT_B51RACING_B51RACINGCARSTATDESCDIALOGCONTROL__ONGETSTATITEM_OFFSET UNITYSDK_OFFSET(0x19EE8620)
#define RPG_CLIENT_B51RACING_B51RACINGCARSTATDESCDIALOGCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x19EE74B0)
#define RPG_CLIENT_B51RACING_B51RACINGCARSTATDESCDIALOGCONTROL__REFRESHSTATLIST_OFFSET UNITYSDK_OFFSET(0x19EE8220)

namespace RPG::Client::B51Racing
{
	inline static constexpr unsigned int B51RacingCarStatDescDialogControl_TypeDefinitionIndex = 80487;
