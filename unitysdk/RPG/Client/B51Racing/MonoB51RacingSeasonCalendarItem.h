...
#define RPG_CLIENT_B51RACING_MONOB51RACINGSEASONCALENDARITEM_PLAYSELECTANIMATIONIFCURRENT_OFFSET UNITYSDK_OFFSET(0x1B6E20B0)
#define RPG_CLIENT_B51RACING_MONOB51RACINGSEASONCALENDARITEM_PLAYSELECTANIMATIONIFSELECTED_OFFSET UNITYSDK_OFFSET(0x1B6E2210)
#define RPG_CLIENT_B51RACING_MONOB51RACINGSEASONCALENDARITEM_SETUPVIEW_1_OFFSET UNITYSDK_OFFSET(0x1B6E12B0)
#define RPG_CLIENT_B51RACING_MONOB51RACINGSEASONCALENDARITEM_SETUPVIEW_2_OFFSET UNITYSDK_OFFSET(0x1B6E13C0)
#define RPG_CLIENT_B51RACING_MONOB51RACINGSEASONCALENDARITEM_SETUPVIEW_3_OFFSET UNITYSDK_OFFSET(0x1B6E1430)
#define RPG_CLIENT_B51RACING_MONOB51RACINGSEASONCALENDARITEM_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0x1B6E1260)
#define RPG_CLIENT_B51RACING_MONOB51RACINGSEASONCALENDARITEM__APPLYSELECTANIMATION_1_OFFSET UNITYSDK_OFFSET(0x1B6E1ED0)
#define RPG_CLIENT_B51RACING_MONOB51RACINGSEASONCALENDARITEM__APPLYSELECTANIMATION_OFFSET UNITYSDK_OFFSET(0x1B6E21A0)
#define RPG_CLIENT_B51RACING_MONOB51RACINGSEASONCALENDARITEM__CANPLAYDESELECTANIMATION_OFFSET UNITYSDK_OFFSET(0x1B6E1D90)
#define RPG_CLIENT_B51RACING_MONOB51RACINGSEASONCALENDARITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6E2360)
#define RPG_CLIENT_B51RACING_MONOB51RACINGSEASONCALENDARITEM__GETICONPATH_OFFSET UNITYSDK_OFFSET(0x1B6E2040)
#define RPG_CLIENT_B51RACING_MONOB51RACINGSEASONCALENDARITEM__GETSTATEBYCONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x1B6E1E30)
#define RPG_CLIENT_B51RACING_MONOB51RACINGSEASONCALENDARITEM__ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B6E2300)
#define RPG_CLIENT_B51RACING_MONOB51RACINGSEASONCALENDARITEM__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1B6E0F30)

namespace RPG::Client::B51Racing
{
	inline static constexpr unsigned int MonoB51RacingSeasonCalendarItem_TypeDefinitionIndex = 80649;
