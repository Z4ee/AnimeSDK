...
#define RPG_CLIENT_B51RACING_B51RACINGCHALLENGEMATCHITEMCONTROL_GET_ITEMINDEX_OFFSET UNITYSDK_OFFSET(0x19EEA200)
#define RPG_CLIENT_B51RACING_B51RACINGCHALLENGEMATCHITEMCONTROL_GET_ONSELECTCALLBACK_OFFSET UNITYSDK_OFFSET(0x19EEA220)
#define RPG_CLIENT_B51RACING_B51RACINGCHALLENGEMATCHITEMCONTROL_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0x19EEA500)
#define RPG_CLIENT_B51RACING_B51RACINGCHALLENGEMATCHITEMCONTROL_SET_ITEMINDEX_OFFSET UNITYSDK_OFFSET(0x19EEA210)
#define RPG_CLIENT_B51RACING_B51RACINGCHALLENGEMATCHITEMCONTROL_SET_ONSELECTCALLBACK_OFFSET UNITYSDK_OFFSET(0x19EEA230)
#define RPG_CLIENT_B51RACING_B51RACINGCHALLENGEMATCHITEMCONTROL__BINDBUTTON_OFFSET UNITYSDK_OFFSET(0x19EEA940)
#define RPG_CLIENT_B51RACING_B51RACINGCHALLENGEMATCHITEMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x19EEABD0)
#define RPG_CLIENT_B51RACING_B51RACINGCHALLENGEMATCHITEMCONTROL__GETBRIDGEHANDLE_OFFSET UNITYSDK_OFFSET(0x19EEAAD0)
#define RPG_CLIENT_B51RACING_B51RACINGCHALLENGEMATCHITEMCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x19EEA240)
#define RPG_CLIENT_B51RACING_B51RACINGCHALLENGEMATCHITEMCONTROL__ONITEMCLICK_OFFSET UNITYSDK_OFFSET(0x19EEAB70)

namespace RPG::Client::B51Racing
{
	inline static constexpr unsigned int B51RacingChallengeMatchItemControl_TypeDefinitionIndex = 80500;
