...
#define RPG_CLIENT_B51RACING_MONOB51RACINGGAMEPLAYRESULTDIALOG_ONCHALLENGEBACKCLICK_OFFSET UNITYSDK_OFFSET(0x1B6D65E0)
#define RPG_CLIENT_B51RACING_MONOB51RACINGGAMEPLAYRESULTDIALOG_ONCONTINUECLICK_OFFSET UNITYSDK_OFFSET(0x1B6D6070)
#define RPG_CLIENT_B51RACING_MONOB51RACINGGAMEPLAYRESULTDIALOG_ONRESTARTCLICK_OFFSET UNITYSDK_OFFSET(0x1B6D67E0)
#define RPG_CLIENT_B51RACING_MONOB51RACINGGAMEPLAYRESULTDIALOG_ONSEASONBACKCLICK_OFFSET UNITYSDK_OFFSET(0x1B6D6370)
#define RPG_CLIENT_B51RACING_MONOB51RACINGGAMEPLAYRESULTDIALOG_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0x1B6D4F20)
#define RPG_CLIENT_B51RACING_MONOB51RACINGGAMEPLAYRESULTDIALOG__APPLYRESULTSTATE_OFFSET UNITYSDK_OFFSET(0x1B6D5010)
#define RPG_CLIENT_B51RACING_MONOB51RACINGGAMEPLAYRESULTDIALOG__CANEXITRESULT_OFFSET UNITYSDK_OFFSET(0x1B6D6530)
#define RPG_CLIENT_B51RACING_MONOB51RACINGGAMEPLAYRESULTDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6D7080)
#define RPG_CLIENT_B51RACING_MONOB51RACINGGAMEPLAYRESULTDIALOG__GETBRIDGEHANDLE_OFFSET UNITYSDK_OFFSET(0x1B6D48E0)
#define RPG_CLIENT_B51RACING_MONOB51RACINGGAMEPLAYRESULTDIALOG__GETCAMERASERVICE_OFFSET UNITYSDK_OFFSET(0x1B6D6A20)
#define RPG_CLIENT_B51RACING_MONOB51RACINGGAMEPLAYRESULTDIALOG__GETCUSTOMFADEINANIMNAME_OFFSET UNITYSDK_OFFSET(0x1B6D6AD0)
#define RPG_CLIENT_B51RACING_MONOB51RACINGGAMEPLAYRESULTDIALOG__GETMATCHFLOWSERVICE_OFFSET UNITYSDK_OFFSET(0x1B6D62D0)
#define RPG_CLIENT_B51RACING_MONOB51RACINGGAMEPLAYRESULTDIALOG__GETSCENESERVICE_OFFSET UNITYSDK_OFFSET(0x1B6D4E70)
#define RPG_CLIENT_B51RACING_MONOB51RACINGGAMEPLAYRESULTDIALOG__HANDLEANIMATIONEVENT_OFFSET UNITYSDK_OFFSET(0x1B6D6B80)
#define RPG_CLIENT_B51RACING_MONOB51RACINGGAMEPLAYRESULTDIALOG__ONBACKPRESSED_OFFSET UNITYSDK_OFFSET(0x1B6D6FD0)
#define RPG_CLIENT_B51RACING_MONOB51RACINGGAMEPLAYRESULTDIALOG__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1B6D4980)
#define RPG_CLIENT_B51RACING_MONOB51RACINGGAMEPLAYRESULTDIALOG__ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B6D4D40)
#define RPG_CLIENT_B51RACING_MONOB51RACINGGAMEPLAYRESULTDIALOG__ONGETRANKLISTITEM_OFFSET UNITYSDK_OFFSET(0x1B6D6DA0)
#define RPG_CLIENT_B51RACING_MONOB51RACINGGAMEPLAYRESULTDIALOG__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1B6D4450)
#define RPG_CLIENT_B51RACING_MONOB51RACINGGAMEPLAYRESULTDIALOG__REFRESHINTERACTIONAREA_OFFSET UNITYSDK_OFFSET(0x1B6D55B0)
#define RPG_CLIENT_B51RACING_MONOB51RACINGGAMEPLAYRESULTDIALOG__REFRESHRANKLIST_OFFSET UNITYSDK_OFFSET(0x1B6D53F0)
#define RPG_CLIENT_B51RACING_MONOB51RACINGGAMEPLAYRESULTDIALOG__REFRESHTITLEAREA_OFFSET UNITYSDK_OFFSET(0x1B6D5270)
#define RPG_CLIENT_B51RACING_MONOB51RACINGGAMEPLAYRESULTDIALOG__SETUPGAMEPADNAVIGATION_OFFSET UNITYSDK_OFFSET(0x1B6D5D80)
#define RPG_CLIENT_B51RACING_MONOB51RACINGGAMEPLAYRESULTDIALOG__SWITCHTORESULTSCENE_OFFSET UNITYSDK_OFFSET(0x1B6D6C30)

namespace RPG::Client::B51Racing
{
	inline static constexpr unsigned int MonoB51RacingGameplayResultDialog_TypeDefinitionIndex = 80620;
