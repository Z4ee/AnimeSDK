...
#define RPG_CLIENT_B51RACING_B51RACINGCOMPOPUPDIALOGVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x19EDFCC0)

namespace RPG::Client::B51Racing
{
	inline static constexpr unsigned int B51RacingComPopUpDialogViewModel_TypeDefinitionIndex = 80693;
	...
	public:
		...
		::RPG::Client::TextID BuffName; // 0x28
