...
#define RPG_CLIENT_B51RACING_B51RACINGDIYDECOPANELCONTROL_BUILDITEMVIEWMODELS_1_OFFSET UNITYSDK_OFFSET(0xC866090)
#define RPG_CLIENT_B51RACING_B51RACINGDIYDECOPANELCONTROL_BUILDITEMVIEWMODELS_OFFSET UNITYSDK_OFFSET(0xC865E20)
#define RPG_CLIENT_B51RACING_B51RACINGDIYDECOPANELCONTROL_GETSELECTEDITEMID_OFFSET UNITYSDK_OFFSET(0xC865270)
#define RPG_CLIENT_B51RACING_B51RACINGDIYDECOPANELCONTROL_SETCONTENTVISIBLE_OFFSET UNITYSDK_OFFSET(0xC865160)
#define RPG_CLIENT_B51RACING_B51RACINGDIYDECOPANELCONTROL_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0xC864E30)
#define RPG_CLIENT_B51RACING_B51RACINGDIYDECOPANELCONTROL_SWITCHTOSTATE_OFFSET UNITYSDK_OFFSET(0xC865200)
#define RPG_CLIENT_B51RACING_B51RACINGDIYDECOPANELCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC866310)
#define RPG_CLIENT_B51RACING_B51RACINGDIYDECOPANELCONTROL__GETSELECTEDITEMINDEX_OFFSET UNITYSDK_OFFSET(0xC8657B0)
#define RPG_CLIENT_B51RACING_B51RACINGDIYDECOPANELCONTROL__GETUINAVIGATIONZONEMANAGER_OFFSET UNITYSDK_OFFSET(0xC865D30)
#define RPG_CLIENT_B51RACING_B51RACINGDIYDECOPANELCONTROL__ONDECOITEMCLICKED_OFFSET UNITYSDK_OFFSET(0xC865B30)
#define RPG_CLIENT_B51RACING_B51RACINGDIYDECOPANELCONTROL__ONGETDECOITEM_OFFSET UNITYSDK_OFFSET(0xC865920)
#define RPG_CLIENT_B51RACING_B51RACINGDIYDECOPANELCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC864D00)
#define RPG_CLIENT_B51RACING_B51RACINGDIYDECOPANELCONTROL__REFRESHACCESSORIESLIST_OFFSET UNITYSDK_OFFSET(0xC865560)
#define RPG_CLIENT_B51RACING_B51RACINGDIYDECOPANELCONTROL__REFRESHCURRENTLIST_OFFSET UNITYSDK_OFFSET(0xC864FC0)
#define RPG_CLIENT_B51RACING_B51RACINGDIYDECOPANELCONTROL__REFRESHPAINTLIST_OFFSET UNITYSDK_OFFSET(0xC865310)
#define RPG_CLIENT_B51RACING_B51RACINGDIYDECOPANELCONTROL__SETUPNAVITARGET_OFFSET UNITYSDK_OFFSET(0xC8658B0)
#define RPG_CLIENT_B51RACING_B51RACINGDIYDECOPANELCONTROL__UPDATESELECTIONSTATE_OFFSET UNITYSDK_OFFSET(0xC865C90)

namespace RPG::Client::B51Racing
{
	inline static constexpr unsigned int B51RacingDIYDecoPanelControl_TypeDefinitionIndex = 80444;
