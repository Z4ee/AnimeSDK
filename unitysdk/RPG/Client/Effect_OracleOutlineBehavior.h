...
#define RPG_CLIENT_EFFECT_ORACLEOUTLINEBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0x1510BE50)
#define RPG_CLIENT_EFFECT_ORACLEOUTLINEBEHAVIOR_LATETICK_OFFSET UNITYSDK_OFFSET(0x1510BBA0)
#define RPG_CLIENT_EFFECT_ORACLEOUTLINEBEHAVIOR_METHOD_3_25CD86BF8626C8D9_OFFSET UNITYSDK_OFFSET(0x1510C500)
#define RPG_CLIENT_EFFECT_ORACLEOUTLINEBEHAVIOR_METHOD_3_2E47F09A457E7E05_OFFSET UNITYSDK_OFFSET(0x1510C410)
#define RPG_CLIENT_EFFECT_ORACLEOUTLINEBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0x1510BA10)
#define RPG_CLIENT_EFFECT_ORACLEOUTLINEBEHAVIOR_METHOD_3_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0x1510BA70)
#define RPG_CLIENT_EFFECT_ORACLEOUTLINEBEHAVIOR_METHOD_3_4343F372F34C05BF_3_OFFSET UNITYSDK_OFFSET(0x1510BAE0)
#define RPG_CLIENT_EFFECT_ORACLEOUTLINEBEHAVIOR_METHOD_3_4343F372F34C05BF_4_OFFSET UNITYSDK_OFFSET(0x1510BB40)
#define RPG_CLIENT_EFFECT_ORACLEOUTLINEBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x1510B9B0)
#define RPG_CLIENT_EFFECT_ORACLEOUTLINEBEHAVIOR_METHOD_3_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x1510B920)
#define RPG_CLIENT_EFFECT_ORACLEOUTLINEBEHAVIOR_METHOD_3_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x1510C490)
#define RPG_CLIENT_EFFECT_ORACLEOUTLINEBEHAVIOR_METHOD_3_B76CD5CB3E297DF3_OFFSET UNITYSDK_OFFSET(0x1510BED0)
#define RPG_CLIENT_EFFECT_ORACLEOUTLINEBEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1510C610)
#define RPG_CLIENT_EFFECT_ORACLEOUTLINEBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1510C600)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_OracleOutlineBehavior_TypeDefinitionIndex = 67355;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Effect_OracleOutlineBehavior_TypeDefinitionIndex)->GetStaticField(0x14820);
		}
		static ::System::Int32* StaticGet__Dither_Alpha()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Effect_OracleOutlineBehavior_TypeDefinitionIndex)->GetStaticField(0x14824);
		}
