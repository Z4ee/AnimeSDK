...
#define RPG_CLIENT_EFFECT_ORACLEOUTLINEBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0x15E7D1C0)
#define RPG_CLIENT_EFFECT_ORACLEOUTLINEBEHAVIOR_LATETICK_OFFSET UNITYSDK_OFFSET(0x15E7CF10)
#define RPG_CLIENT_EFFECT_ORACLEOUTLINEBEHAVIOR_METHOD_3_25CD86BF8626C8D9_OFFSET UNITYSDK_OFFSET(0x15E7D870)
#define RPG_CLIENT_EFFECT_ORACLEOUTLINEBEHAVIOR_METHOD_3_2E47F09A457E7E05_OFFSET UNITYSDK_OFFSET(0x15E7D780)
#define RPG_CLIENT_EFFECT_ORACLEOUTLINEBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0x15E7CD80)
#define RPG_CLIENT_EFFECT_ORACLEOUTLINEBEHAVIOR_METHOD_3_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0x15E7CDE0)
#define RPG_CLIENT_EFFECT_ORACLEOUTLINEBEHAVIOR_METHOD_3_4343F372F34C05BF_3_OFFSET UNITYSDK_OFFSET(0x15E7CE50)
#define RPG_CLIENT_EFFECT_ORACLEOUTLINEBEHAVIOR_METHOD_3_4343F372F34C05BF_4_OFFSET UNITYSDK_OFFSET(0x15E7CEB0)
#define RPG_CLIENT_EFFECT_ORACLEOUTLINEBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x15E7CD20)
#define RPG_CLIENT_EFFECT_ORACLEOUTLINEBEHAVIOR_METHOD_3_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x15E7CC90)
#define RPG_CLIENT_EFFECT_ORACLEOUTLINEBEHAVIOR_METHOD_3_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x15E7D800)
#define RPG_CLIENT_EFFECT_ORACLEOUTLINEBEHAVIOR_METHOD_3_B76CD5CB3E297DF3_OFFSET UNITYSDK_OFFSET(0x15E7D240)
#define RPG_CLIENT_EFFECT_ORACLEOUTLINEBEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x15E7D980)
#define RPG_CLIENT_EFFECT_ORACLEOUTLINEBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x15E7D970)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Effect_OracleOutlineBehavior_TypeDefinitionIndex)->GetStaticField(0x13EB0);
		}
		static ::System::Int32* StaticGet__Dither_On()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Effect_OracleOutlineBehavior_TypeDefinitionIndex)->GetStaticField(0x13EB4);
		}
