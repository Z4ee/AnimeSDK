...
#define RPG_CLIENT_RTCHARACTERANIMINFOBAKER__CTOR_OFFSET UNITYSDK_OFFSET(0xDFD7E80)

namespace RPG::Client
{
	inline static constexpr unsigned int RtCharacterAnimInfoBaker_TypeDefinitionIndex = 73157;
