...
namespace RPG::Client { template <typename T> class AsyncActionProgress_1_BatchItem; }
...
{
	inline static constexpr unsigned int AsyncActionProgress_1_TypeDefinitionIndex = 48183;
