...
#define RPG_CLIENT_MULTIPLAYERACTIVITYMODULE_COLLECTREQUIREDMISSIONDATA_OFFSET UNITYSDK_OFFSET(0xAAEF230)
#define RPG_CLIENT_MULTIPLAYERACTIVITYMODULE_GETAVAILABLEMULTIPLAYERACTIVITYINFOS_OFFSET UNITYSDK_OFFSET(0xAAEFB80)
#define RPG_CLIENT_MULTIPLAYERACTIVITYMODULE_GETMULTIPLAYERACTIVITYINFOS_OFFSET UNITYSDK_OFFSET(0xAAEFB40)
#define RPG_CLIENT_MULTIPLAYERACTIVITYMODULE_GET_CURMULTIPLAYERACTIVITYID_OFFSET UNITYSDK_OFFSET(0xAAEF5B0)
#define RPG_CLIENT_MULTIPLAYERACTIVITYMODULE_INIT_OFFSET UNITYSDK_OFFSET(0xAAEF0D0)
#define RPG_CLIENT_MULTIPLAYERACTIVITYMODULE_ISMULTIPLAYERACTIVITYNEW_OFFSET UNITYSDK_OFFSET(0xAAEF930)
#define RPG_CLIENT_MULTIPLAYERACTIVITYMODULE_REFRESHLASTSEENMULTIPLAYERACTIVITYID_OFFSET UNITYSDK_OFFSET(0xAAEF6F0)
#define RPG_CLIENT_MULTIPLAYERACTIVITYMODULE_TRANSFERTOMULTIPLAYERACTIVITYENTRANCEPAGE_OFFSET UNITYSDK_OFFSET(0xAAEF4E0)
#define RPG_CLIENT_MULTIPLAYERACTIVITYMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0xAAEFCF0)
#define RPG_CLIENT_MULTIPLAYERACTIVITYMODULE___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0xAAEFD10)

namespace RPG::Client
{
	inline static constexpr unsigned int MultiPlayerActivityModule_TypeDefinitionIndex = 57003;
	...
	public:
		...
		::System::Void TransferToMultiPlayerActivityEntrancePage(::System::UInt32 activityID)
		{
			return ((::System::Void(*)(::PVOID, ::System::UInt32))((::PBYTE)hIl2Cpp + RPG_CLIENT_MULTIPLAYERACTIVITYMODULE_TRANSFERTOMULTIPLAYERACTIVITYENTRANCEPAGE_OFFSET))(this, activityID);
		}
