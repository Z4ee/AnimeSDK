...
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_GETCLIPLENGTH_OFFSET UNITYSDK_OFFSET(0x1A2A2000)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_GET_CURRENTPLAYINGCLIPINDEX_OFFSET UNITYSDK_OFFSET(0x1A2A20B0)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_GET_CURRENTPLAYINGCLIPLENGTH_OFFSET UNITYSDK_OFFSET(0x1A2A2290)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_GET_CUSTOMDATA_OFFSET UNITYSDK_OFFSET(0x1A2A09D0)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_GET_INSTANCED_OFFSET UNITYSDK_OFFSET(0x1A2A0590)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_GET_VISIBLESTATE_OFFSET UNITYSDK_OFFSET(0x1A2A04B0)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_METHOD_5_03E2B9212B4B6EAF_OFFSET UNITYSDK_OFFSET(0x1A2A0C50)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_METHOD_5_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0x1A2A0C10)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_METHOD_5_ADF4AD3331B4D7AD_OFFSET UNITYSDK_OFFSET(0x1A2A16E0)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1A2A1730)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_METHOD_5_E9A575D18A0748D9_OFFSET UNITYSDK_OFFSET(0x1A2A1690)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_METHOD_5_F8B73ECE7F883AC1_OFFSET UNITYSDK_OFFSET(0x1A2A0BD0)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A2A1640)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_PLAYANIMATION_OFFSET UNITYSDK_OFFSET(0x1A2A1780)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_REGISTER_OFFSET UNITYSDK_OFFSET(0x1A2A0CA0)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_SET_CUSTOMDATA_OFFSET UNITYSDK_OFFSET(0x1A2A09E0)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_SET_VISIBLESTATE_OFFSET UNITYSDK_OFFSET(0x1A2A04C0)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_UNREGISTER_OFFSET UNITYSDK_OFFSET(0x1A2A10C0)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2A2430)

namespace RPG::Client::CrowdAnimator
{
	inline static constexpr unsigned int CrowdInstance_TypeDefinitionIndex = 73610;
