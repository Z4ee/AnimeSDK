...
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_GETCLIPLENGTH_OFFSET UNITYSDK_OFFSET(0xB717030)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_GET_CURRENTPLAYINGCLIPINDEX_OFFSET UNITYSDK_OFFSET(0xB7170E0)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_GET_CURRENTPLAYINGCLIPLENGTH_OFFSET UNITYSDK_OFFSET(0xB7172C0)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_GET_CUSTOMDATA_OFFSET UNITYSDK_OFFSET(0xB715A00)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_GET_INSTANCED_OFFSET UNITYSDK_OFFSET(0xB7155C0)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_GET_VISIBLESTATE_OFFSET UNITYSDK_OFFSET(0xB7154E0)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_METHOD_5_03E2B9212B4B6EAF_OFFSET UNITYSDK_OFFSET(0xB715C80)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_METHOD_5_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0xB715C40)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_METHOD_5_ADF4AD3331B4D7AD_OFFSET UNITYSDK_OFFSET(0xB716710)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xB716760)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_METHOD_5_E9A575D18A0748D9_OFFSET UNITYSDK_OFFSET(0xB7166C0)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_METHOD_5_F8B73ECE7F883AC1_OFFSET UNITYSDK_OFFSET(0xB715C00)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB716670)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_PLAYANIMATION_OFFSET UNITYSDK_OFFSET(0xB7167B0)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_REGISTER_OFFSET UNITYSDK_OFFSET(0xB715CD0)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_SET_CUSTOMDATA_OFFSET UNITYSDK_OFFSET(0xB715A10)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_SET_VISIBLESTATE_OFFSET UNITYSDK_OFFSET(0xB7154F0)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE_UNREGISTER_OFFSET UNITYSDK_OFFSET(0xB7160F0)
#define RPG_CLIENT_CROWDANIMATOR_CROWDINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0xB717460)

namespace RPG::Client::CrowdAnimator
{
	inline static constexpr unsigned int CrowdInstance_TypeDefinitionIndex = 68810;
