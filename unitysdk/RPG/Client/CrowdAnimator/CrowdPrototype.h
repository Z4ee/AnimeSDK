...
#define RPG_CLIENT_CROWDANIMATOR_CROWDPROTOTYPE_GET_ISBAKEREQUIRED_OFFSET UNITYSDK_OFFSET(0x9429D80)
#define RPG_CLIENT_CROWDANIMATOR_CROWDPROTOTYPE_METHOD_3_0E18B07CF5405C59_OFFSET UNITYSDK_OFFSET(0x9429DE0)
#define RPG_CLIENT_CROWDANIMATOR_CROWDPROTOTYPE_METHOD_3_CB05EF9A7B7BC592_OFFSET UNITYSDK_OFFSET(0x9429F00)
#define RPG_CLIENT_CROWDANIMATOR_CROWDPROTOTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x942A000)

namespace RPG::Client::CrowdAnimator
{
	inline static constexpr unsigned int CrowdPrototype_TypeDefinitionIndex = 60431;
