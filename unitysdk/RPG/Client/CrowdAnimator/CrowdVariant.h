...
#define RPG_CLIENT_CROWDANIMATOR_CROWDVARIANT__CTOR_OFFSET UNITYSDK_OFFSET(0x18038070)

namespace RPG::Client::CrowdAnimator
{
	inline static constexpr unsigned int CrowdVariant_TypeDefinitionIndex = 70333;
