...
#define RPG_CLIENT_CROWDANIMATOR_SKINNEDMESHDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB720040)

namespace RPG::Client::CrowdAnimator
{
	inline static constexpr unsigned int SkinnedMeshData_TypeDefinitionIndex = 68823;
