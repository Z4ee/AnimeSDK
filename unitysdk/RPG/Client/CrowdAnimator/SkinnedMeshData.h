...
#define RPG_CLIENT_CROWDANIMATOR_SKINNEDMESHDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18038080)

namespace RPG::Client::CrowdAnimator
{
	inline static constexpr unsigned int SkinnedMeshData_TypeDefinitionIndex = 70323;
