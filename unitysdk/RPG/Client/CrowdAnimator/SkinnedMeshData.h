...
#define RPG_CLIENT_CROWDANIMATOR_SKINNEDMESHDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2AB300)

namespace RPG::Client::CrowdAnimator
{
	inline static constexpr unsigned int SkinnedMeshData_TypeDefinitionIndex = 73623;
