...
#define RPG_CLIENT_RELICSHOWPROPERTYDATA_CREATEPREVIEWSTATUS_OFFSET UNITYSDK_OFFSET(0xDE3A910)
#define RPG_CLIENT_RELICSHOWPROPERTYDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xDE3A7B0)
#define RPG_CLIENT_RELICSHOWPROPERTYDATA_GET_AFFIXID_OFFSET UNITYSDK_OFFSET(0xDE3AB80)
#define RPG_CLIENT_RELICSHOWPROPERTYDATA_GET_DISPLAYDATAVALUE_OFFSET UNITYSDK_OFFSET(0xDE3AB40)
#define RPG_CLIENT_RELICSHOWPROPERTYDATA_GET_POINTVALUE_OFFSET UNITYSDK_OFFSET(0xDE3AB60)
#define RPG_CLIENT_RELICSHOWPROPERTYDATA_GET_PREVIEWUPLEVEL_OFFSET UNITYSDK_OFFSET(0xDE3AAB0)
#define RPG_CLIENT_RELICSHOWPROPERTYDATA_GET_PROPERTYTYPE_OFFSET UNITYSDK_OFFSET(0xDE3AB20)
#define RPG_CLIENT_RELICSHOWPROPERTYDATA_SET_AFFIXID_OFFSET UNITYSDK_OFFSET(0xDE3AB90)
#define RPG_CLIENT_RELICSHOWPROPERTYDATA_SET_DISPLAYDATAVALUE_OFFSET UNITYSDK_OFFSET(0xDE3AB50)
#define RPG_CLIENT_RELICSHOWPROPERTYDATA_SET_POINTVALUE_OFFSET UNITYSDK_OFFSET(0xDE3AB70)
#define RPG_CLIENT_RELICSHOWPROPERTYDATA_SET_PROPERTYTYPE_OFFSET UNITYSDK_OFFSET(0xDE3AB30)
#define RPG_CLIENT_RELICSHOWPROPERTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xDE3A900)
...
namespace RPG::Client
{
	...
	public:
		...
		::RPG::GameCore::FixPoint _PointValue_k__BackingField; // 0x20
		::RPG::GameCore::AvatarPropertyType _PropertyType_k__BackingField; // 0x28
		::System::UInt32 _AffixID_k__BackingField; // 0x2C
		::System::Boolean IsPreview; // 0x30
		::System::UInt32 BonusCnt; // 0x34
