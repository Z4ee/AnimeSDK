...
#define RPG_CLIENT_RELICSHOWPROPERTYDATA_CREATEPREVIEWSTATUS_OFFSET UNITYSDK_OFFSET(0x1794F640)
#define RPG_CLIENT_RELICSHOWPROPERTYDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1794F4E0)
#define RPG_CLIENT_RELICSHOWPROPERTYDATA_GET_AFFIXID_OFFSET UNITYSDK_OFFSET(0x1794F8B0)
#define RPG_CLIENT_RELICSHOWPROPERTYDATA_GET_DISPLAYDATAVALUE_OFFSET UNITYSDK_OFFSET(0x1794F870)
#define RPG_CLIENT_RELICSHOWPROPERTYDATA_GET_POINTVALUE_OFFSET UNITYSDK_OFFSET(0x1794F890)
#define RPG_CLIENT_RELICSHOWPROPERTYDATA_GET_PREVIEWUPLEVEL_OFFSET UNITYSDK_OFFSET(0x1794F7E0)
#define RPG_CLIENT_RELICSHOWPROPERTYDATA_GET_PROPERTYTYPE_OFFSET UNITYSDK_OFFSET(0x1794F850)
#define RPG_CLIENT_RELICSHOWPROPERTYDATA_SET_AFFIXID_OFFSET UNITYSDK_OFFSET(0x1794F8C0)
#define RPG_CLIENT_RELICSHOWPROPERTYDATA_SET_DISPLAYDATAVALUE_OFFSET UNITYSDK_OFFSET(0x1794F880)
#define RPG_CLIENT_RELICSHOWPROPERTYDATA_SET_POINTVALUE_OFFSET UNITYSDK_OFFSET(0x1794F8A0)
#define RPG_CLIENT_RELICSHOWPROPERTYDATA_SET_PROPERTYTYPE_OFFSET UNITYSDK_OFFSET(0x1794F860)
#define RPG_CLIENT_RELICSHOWPROPERTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1794F630)

namespace RPG::Client
{
	inline static constexpr unsigned int RelicShowPropertyData_TypeDefinitionIndex = 66883;

	class RelicShowPropertyData : public ::System::Object
	{
	public:
		::System::String* _DisplayDataValue_k__BackingField; // 0x10
		::System::Int32 _PreviewIndex; // 0x18
		::System::Boolean IsPreview; // 0x1C
		::System::UInt32 _BaseLevel; // 0x20
		::System::UInt32 _AffixID_k__BackingField; // 0x24
		::RPG::GameCore::FixPoint _PointValue_k__BackingField; // 0x28
		::System::UInt32 BonusCnt; // 0x30
		::RPG::GameCore::AvatarPropertyType _PropertyType_k__BackingField; // 0x34
		...
		static ::RPG::Client::RelicShowPropertyData* CreatePreviewStatus(::Class_1_D17272E82AE804C2_8* a1, ::RPG::Client::RelicItemData* a2, ::System::Int32 a3)
		{
			return ((::RPG::Client::RelicShowPropertyData*(*)(::Class_1_D17272E82AE804C2_8*, ::RPG::Client::RelicItemData*, ::System::Int32))((::PBYTE)hIl2Cpp + RPG_CLIENT_RELICSHOWPROPERTYDATA_CREATEPREVIEWSTATUS_OFFSET))(a1, a2, a3);
		}
