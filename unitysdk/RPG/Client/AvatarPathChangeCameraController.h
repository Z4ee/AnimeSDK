...
#define RPG_CLIENT_AVATARPATHCHANGECAMERACONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0xC8389B0)
#define RPG_CLIENT_AVATARPATHCHANGECAMERACONTROLLER_MOVECAMERA_OFFSET UNITYSDK_OFFSET(0xC8390B0)
#define RPG_CLIENT_AVATARPATHCHANGECAMERACONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC838EF0)
#define RPG_CLIENT_AVATARPATHCHANGECAMERACONTROLLER_STARTBLEND_OFFSET UNITYSDK_OFFSET(0xC839300)
#define RPG_CLIENT_AVATARPATHCHANGECAMERACONTROLLER__CHANGEAVATARIDTOMAN_OFFSET UNITYSDK_OFFSET(0xC839020)
#define RPG_CLIENT_AVATARPATHCHANGECAMERACONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC839740)
#define RPG_CLIENT_AVATARPATHCHANGECAMERACONTROLLER__GETENTITYMANAGER_OFFSET UNITYSDK_OFFSET(0xC838CB0)

namespace RPG::Client
{
	inline static constexpr unsigned int AvatarPathChangeCameraController_TypeDefinitionIndex = 71296;
