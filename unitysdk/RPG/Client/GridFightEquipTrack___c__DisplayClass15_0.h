...
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACK___C__DISPLAYCLASS15_0__CTOR_OFFSET UNITYSDK_OFFSET(0xBB27340)
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACK___C__DISPLAYCLASS15_0__UPDATEWAITTRACKEQUIPIDS_B__0_OFFSET UNITYSDK_OFFSET(0xBB277E0)
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACK___C__DISPLAYCLASS15_0__UPDATEWAITTRACKEQUIPIDS_B__1_OFFSET UNITYSDK_OFFSET(0xBB27890)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightEquipTrack___c__DisplayClass15_0_TypeDefinitionIndex = 61073;
