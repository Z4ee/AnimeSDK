...
#define RPG_CLIENT_PERSTATEPARAMSPECTRUM__CTOR_OFFSET UNITYSDK_OFFSET(0x9F25090)

namespace RPG::Client
{
	inline static constexpr unsigned int PerStateParamSpectrum_TypeDefinitionIndex = 58025;
