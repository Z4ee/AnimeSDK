...
#define RPG_CLIENT_PERSTATEPARAMSPECTRUM__CTOR_OFFSET UNITYSDK_OFFSET(0xAC49E00)

namespace RPG::Client
{
	inline static constexpr unsigned int PerStateParamSpectrum_TypeDefinitionIndex = 65312;
