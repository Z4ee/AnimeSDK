...
#define RPG_CLIENT_AVATARARCHIVEINFODATA_APPLYCHANGEINFO_OFFSET UNITYSDK_OFFSET(0x1811D480)
#define RPG_CLIENT_AVATARARCHIVEINFODATA_GET_CAMPID_OFFSET UNITYSDK_OFFSET(0x1811D550)
#define RPG_CLIENT_AVATARARCHIVEINFODATA_GET_ISCAMPNEW_OFFSET UNITYSDK_OFFSET(0x1811D570)
#define RPG_CLIENT_AVATARARCHIVEINFODATA_RECORDSEEN_OFFSET UNITYSDK_OFFSET(0x1811D4F0)
#define RPG_CLIENT_AVATARARCHIVEINFODATA_SET_CAMPID_OFFSET UNITYSDK_OFFSET(0x1811D560)
#define RPG_CLIENT_AVATARARCHIVEINFODATA_SET_ISCAMPNEW_OFFSET UNITYSDK_OFFSET(0x1811D580)
#define RPG_CLIENT_AVATARARCHIVEINFODATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1811D3D0)

namespace RPG::Client
{
	inline static constexpr unsigned int AvatarArchiveInfoData_TypeDefinitionIndex = 59667;

	class AvatarArchiveInfoData : public ::System::Object
	{
	public:
		::System::Boolean _IsCampNew_k__BackingField; // 0x10
