...
#define RPG_CLIENT_GRIDFIGHTTEAM___C__DISPLAYCLASS71_0__CONTAINSROLEID_B__0_OFFSET UNITYSDK_OFFSET(0x1C5CE760)
#define RPG_CLIENT_GRIDFIGHTTEAM___C__DISPLAYCLASS71_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5C9180)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightTeam___c__DisplayClass71_0_TypeDefinitionIndex = 65233;
