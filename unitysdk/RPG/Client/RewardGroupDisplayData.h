...
#define RPG_CLIENT_REWARDGROUPDISPLAYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB01AC50)

namespace RPG::Client
{
	inline static constexpr unsigned int RewardGroupDisplayData_TypeDefinitionIndex = 60511;
