...
#define RPG_CLIENT_REWARDGROUPDISPLAYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA2E4300)

namespace RPG::Client
{
	inline static constexpr unsigned int RewardGroupDisplayData_TypeDefinitionIndex = 53376;
