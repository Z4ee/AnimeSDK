...
#define RPG_CLIENT_REWARDGROUPDISPLAYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC764D20)

namespace RPG::Client
{
	inline static constexpr unsigned int RewardGroupDisplayData_TypeDefinitionIndex = 61445;
