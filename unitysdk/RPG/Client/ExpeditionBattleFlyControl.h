...
#define RPG_CLIENT_EXPEDITIONBATTLEFLYCONTROL_PLAY_OFFSET UNITYSDK_OFFSET(0x1B88EA90)
#define RPG_CLIENT_EXPEDITIONBATTLEFLYCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B88EDF0)
