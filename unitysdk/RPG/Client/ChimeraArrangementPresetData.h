...
#define RPG_CLIENT_CHIMERAARRANGEMENTPRESETDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1C1B3950)
#define RPG_CLIENT_CHIMERAARRANGEMENTPRESETDATA_GET_ARRANGEDCOMMONS_OFFSET UNITYSDK_OFFSET(0x1C1B38A0)
#define RPG_CLIENT_CHIMERAARRANGEMENTPRESETDATA_GET_DESC_OFFSET UNITYSDK_OFFSET(0x1C1B37E0)
#define RPG_CLIENT_CHIMERAARRANGEMENTPRESETDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0x1C1B3770)
#define RPG_CLIENT_CHIMERAARRANGEMENTPRESETDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0x1C1B3780)
#define RPG_CLIENT_CHIMERAARRANGEMENTPRESETDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1B3940)

namespace RPG::Client
{
	inline static constexpr unsigned int ChimeraArrangementPresetData_TypeDefinitionIndex = 63467;
