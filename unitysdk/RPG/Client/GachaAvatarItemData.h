...
#define RPG_CLIENT_GACHAAVATARITEMDATA_GET_AVATARROW_OFFSET UNITYSDK_OFFSET(0xBAA92C0)
#define RPG_CLIENT_GACHAAVATARITEMDATA_SETROW_OFFSET UNITYSDK_OFFSET(0xBAA9130)
#define RPG_CLIENT_GACHAAVATARITEMDATA_SET_AVATARROW_OFFSET UNITYSDK_OFFSET(0xBAA92D0)
#define RPG_CLIENT_GACHAAVATARITEMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBAA9070)
#define RPG_CLIENT_GACHAAVATARITEMDATA___IFIXBASEPROXY_SETROW_OFFSET UNITYSDK_OFFSET(0xBAA92E0)
