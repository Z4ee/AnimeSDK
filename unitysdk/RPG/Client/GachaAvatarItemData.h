...
#define RPG_CLIENT_GACHAAVATARITEMDATA_GET_AVATARROW_OFFSET UNITYSDK_OFFSET(0x974DEE0)
#define RPG_CLIENT_GACHAAVATARITEMDATA_SETROW_OFFSET UNITYSDK_OFFSET(0x974DD50)
#define RPG_CLIENT_GACHAAVATARITEMDATA_SET_AVATARROW_OFFSET UNITYSDK_OFFSET(0x974DEF0)
#define RPG_CLIENT_GACHAAVATARITEMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x974DC90)
#define RPG_CLIENT_GACHAAVATARITEMDATA___IFIXBASEPROXY_SETROW_OFFSET UNITYSDK_OFFSET(0x974DF00)

namespace RPG::Client
{
	inline static constexpr unsigned int GachaAvatarItemData_TypeDefinitionIndex = 52207;
