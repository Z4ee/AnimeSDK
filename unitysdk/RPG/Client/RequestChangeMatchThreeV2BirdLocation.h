...
#define RPG_CLIENT_REQUESTCHANGEMATCHTHREEV2BIRDLOCATION_METHOD_3_CFF7579380403101_OFFSET UNITYSDK_OFFSET(0x193BC5E0)
#define RPG_CLIENT_REQUESTCHANGEMATCHTHREEV2BIRDLOCATION_METHOD_3_F37A589FBB291478_OFFSET UNITYSDK_OFFSET(0x193BC560)
#define RPG_CLIENT_REQUESTCHANGEMATCHTHREEV2BIRDLOCATION__CTOR_OFFSET UNITYSDK_OFFSET(0x193BC5B0)

namespace RPG::Client
{
	inline static constexpr unsigned int RequestChangeMatchThreeV2BirdLocation_TypeDefinitionIndex = 9931;
