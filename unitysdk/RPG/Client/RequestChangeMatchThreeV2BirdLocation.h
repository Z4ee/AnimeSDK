...
#define RPG_CLIENT_REQUESTCHANGEMATCHTHREEV2BIRDLOCATION_METHOD_3_CFF7579380403101_OFFSET UNITYSDK_OFFSET(0x185EC6C0)
#define RPG_CLIENT_REQUESTCHANGEMATCHTHREEV2BIRDLOCATION_METHOD_3_F37A589FBB291478_OFFSET UNITYSDK_OFFSET(0x185EC640)
#define RPG_CLIENT_REQUESTCHANGEMATCHTHREEV2BIRDLOCATION__CTOR_OFFSET UNITYSDK_OFFSET(0x185EC690)

namespace RPG::Client
{
	inline static constexpr unsigned int RequestChangeMatchThreeV2BirdLocation_TypeDefinitionIndex = 10129;
