...
#define RPG_CLIENT_MATERIALPROPERTYANIMBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0xD67C050)
#define RPG_CLIENT_MATERIALPROPERTYANIMBEHAVIOR_METHOD_3_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xD67BCD0)
#define RPG_CLIENT_MATERIALPROPERTYANIMBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0xD67BB50)
#define RPG_CLIENT_MATERIALPROPERTYANIMBEHAVIOR_METHOD_3_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0xD67BBB0)
#define RPG_CLIENT_MATERIALPROPERTYANIMBEHAVIOR_METHOD_3_4343F372F34C05BF_3_OFFSET UNITYSDK_OFFSET(0xD67BC10)
#define RPG_CLIENT_MATERIALPROPERTYANIMBEHAVIOR_METHOD_3_4343F372F34C05BF_4_OFFSET UNITYSDK_OFFSET(0xD67BC70)
#define RPG_CLIENT_MATERIALPROPERTYANIMBEHAVIOR_METHOD_3_4343F372F34C05BF_5_OFFSET UNITYSDK_OFFSET(0xD67BD10)
#define RPG_CLIENT_MATERIALPROPERTYANIMBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xD67BAF0)
#define RPG_CLIENT_MATERIALPROPERTYANIMBEHAVIOR_METHOD_3_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xD67BA60)
#define RPG_CLIENT_MATERIALPROPERTYANIMBEHAVIOR_METHOD_3_9D4AA0DDED7945FC_OFFSET UNITYSDK_OFFSET(0xD67C0D0)
#define RPG_CLIENT_MATERIALPROPERTYANIMBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0xD67BD70)
#define RPG_CLIENT_MATERIALPROPERTYANIMBEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0xD67C2A0)
#define RPG_CLIENT_MATERIALPROPERTYANIMBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0xD67C290)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::RPG::Client::MaterialPropertyAnimBehavior_MaterialProperty, ::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(MaterialPropertyAnimBehavior_TypeDefinitionIndex)->GetStaticField(0x66860);
		}
