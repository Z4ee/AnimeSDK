...
#define RPG_CLIENT_MATERIALPROPERTYANIMBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0x1B213030)
#define RPG_CLIENT_MATERIALPROPERTYANIMBEHAVIOR_METHOD_3_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x1B212CB0)
#define RPG_CLIENT_MATERIALPROPERTYANIMBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0x1B212B30)
#define RPG_CLIENT_MATERIALPROPERTYANIMBEHAVIOR_METHOD_3_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0x1B212B90)
#define RPG_CLIENT_MATERIALPROPERTYANIMBEHAVIOR_METHOD_3_4343F372F34C05BF_3_OFFSET UNITYSDK_OFFSET(0x1B212BF0)
#define RPG_CLIENT_MATERIALPROPERTYANIMBEHAVIOR_METHOD_3_4343F372F34C05BF_4_OFFSET UNITYSDK_OFFSET(0x1B212C50)
#define RPG_CLIENT_MATERIALPROPERTYANIMBEHAVIOR_METHOD_3_4343F372F34C05BF_5_OFFSET UNITYSDK_OFFSET(0x1B212CF0)
#define RPG_CLIENT_MATERIALPROPERTYANIMBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x1B212AD0)
#define RPG_CLIENT_MATERIALPROPERTYANIMBEHAVIOR_METHOD_3_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x1B212A40)
#define RPG_CLIENT_MATERIALPROPERTYANIMBEHAVIOR_METHOD_3_9D4AA0DDED7945FC_OFFSET UNITYSDK_OFFSET(0x1B2130B0)
#define RPG_CLIENT_MATERIALPROPERTYANIMBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0x1B212D50)
#define RPG_CLIENT_MATERIALPROPERTYANIMBEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B213280)
#define RPG_CLIENT_MATERIALPROPERTYANIMBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B213270)

namespace RPG::Client
{
	inline static constexpr unsigned int MaterialPropertyAnimBehavior_TypeDefinitionIndex = 70682;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::RPG::Client::MaterialPropertyAnimBehavior_MaterialProperty, ::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(MaterialPropertyAnimBehavior_TypeDefinitionIndex)->GetStaticField(0x66370);
		}
