...
#define RPG_CLIENT_ATTACHMENTSOLVER_METHOD_1_2CBE0B79DD36047E_OFFSET UNITYSDK_OFFSET(0x1B33C3B0)
#define RPG_CLIENT_ATTACHMENTSOLVER_METHOD_1_609FA3D38FA252B6_OFFSET UNITYSDK_OFFSET(0x1B33C7E0)
#define RPG_CLIENT_ATTACHMENTSOLVER_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1B33CC70)
#define RPG_CLIENT_ATTACHMENTSOLVER_METHOD_1_CAFFF01C1C13C35B_OFFSET UNITYSDK_OFFSET(0x1B33C130)
#define RPG_CLIENT_ATTACHMENTSOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B33CCB0)

namespace RPG::Client
{
	inline static constexpr unsigned int AttachmentSolver_TypeDefinitionIndex = 68406;
