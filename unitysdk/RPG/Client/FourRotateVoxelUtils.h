...
#define RPG_CLIENT_FOURROTATEVOXELUTILS_EVALUATEID_OFFSET UNITYSDK_OFFSET(0x16D18B00)
#define RPG_CLIENT_FOURROTATEVOXELUTILS_GETFOURROTATEENTITYBYENTITYID_OFFSET UNITYSDK_OFFSET(0x16D18F00)
#define RPG_CLIENT_FOURROTATEVOXELUTILS_GETFOURROTATEVOXELLEVELCONFIG_OFFSET UNITYSDK_OFFSET(0x16D19180)
#define RPG_CLIENT_FOURROTATEVOXELUTILS_GETFOURROTATEVOXELLEVELUNITLENGTH_OFFSET UNITYSDK_OFFSET(0x16D194B0)
#define RPG_CLIENT_FOURROTATEVOXELUTILS_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x16D18BD0)
#define RPG_CLIENT_FOURROTATEVOXELUTILS_GETPLAYERGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x16D19520)
#define RPG_CLIENT_FOURROTATEVOXELUTILS_ISFOURROTATEVOXELCONTAINER_OFFSET UNITYSDK_OFFSET(0x16D19410)
#define RPG_CLIENT_FOURROTATEVOXELUTILS_TRYGETCONTAINERENTITY_OFFSET UNITYSDK_OFFSET(0x16D19050)
#define RPG_CLIENT_FOURROTATEVOXELUTILS_TRYGETENTITYWORLDPOSITION_OFFSET UNITYSDK_OFFSET(0x16D192A0)

namespace RPG::Client
{
	inline static constexpr unsigned int FourRotateVoxelUtils_TypeDefinitionIndex = 57699;
	...
	public:
		...
		static ::System::Boolean GetInstance(::Class_2_47C66A3BEB7A5F01*& a1, ::System::UInt32 a2, ::System::UInt32 a3, ::System::Boolean a4)
		{
			return ((::System::Boolean(*)(::Class_2_47C66A3BEB7A5F01*&, ::System::UInt32, ::System::UInt32, ::System::Boolean))((::PBYTE)hIl2Cpp + RPG_CLIENT_FOURROTATEVOXELUTILS_GETINSTANCE_OFFSET))(a1, a2, a3, a4);
		}

		static ::Class_2_56DCA1B58073717B* GetFourRotateEntityByEntityID(::System::UInt32 a1, ::System::UInt32 a2, ::System::UInt32 a3, ::System::Boolean a4)
		{
			return ((::Class_2_56DCA1B58073717B*(*)(::System::UInt32, ::System::UInt32, ::System::UInt32, ::System::Boolean))((::PBYTE)hIl2Cpp + RPG_CLIENT_FOURROTATEVOXELUTILS_GETFOURROTATEENTITYBYENTITYID_OFFSET))(a1, a2, a3, a4);
		}
