...
#define RPG_CLIENT_RANGELIMITCOLLIDER_INIT_OFFSET UNITYSDK_OFFSET(0xAF75760)
#define RPG_CLIENT_RANGELIMITCOLLIDER_SETUPRANGELIMITCOLLIDER_OFFSET UNITYSDK_OFFSET(0xAF758C0)
#define RPG_CLIENT_RANGELIMITCOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0xAF75B80)

namespace RPG::Client
{
	inline static constexpr unsigned int RangeLimitCollider_TypeDefinitionIndex = 63538;
