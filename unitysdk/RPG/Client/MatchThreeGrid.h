...
#define RPG_CLIENT_MATCHTHREEGRID_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xBF81F60)
#define RPG_CLIENT_MATCHTHREEGRID_GET_GRIDDATA_OFFSET UNITYSDK_OFFSET(0xBF81CA0)
#define RPG_CLIENT_MATCHTHREEGRID_GET_POSINDEX_OFFSET UNITYSDK_OFFSET(0xBF81C80)
#define RPG_CLIENT_MATCHTHREEGRID_INIT_OFFSET UNITYSDK_OFFSET(0xBF81CB0)
#define RPG_CLIENT_MATCHTHREEGRID_ONCREATE_OFFSET UNITYSDK_OFFSET(0xBF81FA0)
#define RPG_CLIENT_MATCHTHREEGRID_SETPOSITION_OFFSET UNITYSDK_OFFSET(0xBF81E80)
#define RPG_CLIENT_MATCHTHREEGRID_SETSIZE_OFFSET UNITYSDK_OFFSET(0xBF81D70)
#define RPG_CLIENT_MATCHTHREEGRID_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0xBF81DF0)
#define RPG_CLIENT_MATCHTHREEGRID_SET_POSINDEX_OFFSET UNITYSDK_OFFSET(0xBF81C90)
#define RPG_CLIENT_MATCHTHREEGRID_SPAWNED_OFFSET UNITYSDK_OFFSET(0xBF81F20)
#define RPG_CLIENT_MATCHTHREEGRID__CTOR_OFFSET UNITYSDK_OFFSET(0xBF82120)

namespace RPG::Client
{
	inline static constexpr unsigned int MatchThreeGrid_TypeDefinitionIndex = 61650;
