...
#define RPG_CLIENT_MATCHTHREEGRID_DESPAWNED_OFFSET UNITYSDK_OFFSET(0x9B408D0)
#define RPG_CLIENT_MATCHTHREEGRID_GET_GRIDDATA_OFFSET UNITYSDK_OFFSET(0x9B40740)
#define RPG_CLIENT_MATCHTHREEGRID_GET_POSINDEX_OFFSET UNITYSDK_OFFSET(0x9B40720)
#define RPG_CLIENT_MATCHTHREEGRID_INIT_OFFSET UNITYSDK_OFFSET(0x9B40750)
#define RPG_CLIENT_MATCHTHREEGRID_ONCREATE_OFFSET UNITYSDK_OFFSET(0x9B40910)
#define RPG_CLIENT_MATCHTHREEGRID_SETPOSITION_OFFSET UNITYSDK_OFFSET(0x9B27DD0)
#define RPG_CLIENT_MATCHTHREEGRID_SETSIZE_OFFSET UNITYSDK_OFFSET(0x9B40810)
#define RPG_CLIENT_MATCHTHREEGRID_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0x9B27D40)
#define RPG_CLIENT_MATCHTHREEGRID_SET_POSINDEX_OFFSET UNITYSDK_OFFSET(0x9B40730)
#define RPG_CLIENT_MATCHTHREEGRID_SPAWNED_OFFSET UNITYSDK_OFFSET(0x9B40890)
#define RPG_CLIENT_MATCHTHREEGRID__CTOR_OFFSET UNITYSDK_OFFSET(0x9B40A90)

namespace RPG::Client
{
	inline static constexpr unsigned int MatchThreeGrid_TypeDefinitionIndex = 53572;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::Vector2Int))((::PBYTE)hIl2Cpp + RPG_CLIENT_MATCHTHREEGRID_SET_POSINDEX_OFFSET))(this, value);
		}
