...
#define RPG_CLIENT_MONOHANDCATCHABLEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x18C487A0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoHandCatchableItem_TypeDefinitionIndex = 65706;
