...
#define RPG_CLIENT_MONOHANDCATCHABLEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x9D05E50)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoHandCatchableItem_TypeDefinitionIndex = 56175;
