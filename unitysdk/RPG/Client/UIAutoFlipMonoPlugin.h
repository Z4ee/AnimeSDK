...
#define RPG_CLIENT_UIAUTOFLIPMONOPLUGIN_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xA6760A0)
#define RPG_CLIENT_UIAUTOFLIPMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xA6760F0)
#define RPG_CLIENT_UIAUTOFLIPMONOPLUGIN___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xA676120)

namespace RPG::Client
{
	inline static constexpr unsigned int UIAutoFlipMonoPlugin_TypeDefinitionIndex = 58197;
