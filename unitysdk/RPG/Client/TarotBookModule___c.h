...
namespace RPG::Client
{
	...
	public:
		...
		::System::Boolean _get_HasNewStory_b__26_0(::System::Collections::Generic::KeyValuePair_2<::System::UInt32, ::RPG::Client::TarotBookStory*> element)
		{
			return ((::System::Boolean(*)(::PVOID, ::System::Collections::Generic::KeyValuePair_2<::System::UInt32, ::RPG::Client::TarotBookStory*>))((::PBYTE)hIl2Cpp + RPG_CLIENT_TAROTBOOKMODULE___C__GET_HASNEWSTORY_B__26_0_OFFSET))(this, element);
		}

		::System::Boolean _get_UnlockedCharacterCount_b__56_0(::RPG::Client::TarotBookCharacter* character)
		{
			return ((::System::Boolean(*)(::PVOID, ::RPG::Client::TarotBookCharacter*))((::PBYTE)hIl2Cpp + RPG_CLIENT_TAROTBOOKMODULE___C__GET_UNLOCKEDCHARACTERCOUNT_B__56_0_OFFSET))(this, character);
		}

		::System::Boolean _CheckCanTakeReadReward_b__92_0(::RPG::Client::TarotBookReadReward* reward)
		{
			return ((::System::Boolean(*)(::PVOID, ::RPG::Client::TarotBookReadReward*))((::PBYTE)hIl2Cpp + RPG_CLIENT_TAROTBOOKMODULE___C__CHECKCANTAKEREADREWARD_B__92_0_OFFSET))(this, reward);
		}

		::System::Int32 __InitInteractions_b__168_0(::RPG::Client::TarotBookInteraction* left, ::RPG::Client::TarotBookInteraction* right)
		{
			return ((::System::Int32(*)(::PVOID, ::RPG::Client::TarotBookInteraction*, ::RPG::Client::TarotBookInteraction*))((::PBYTE)hIl2Cpp + RPG_CLIENT_TAROTBOOKMODULE___C___INITINTERACTIONS_B__168_0_OFFSET))(this, left, right);
		}
	};
}
