...
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC7D1C90)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GETEDITMODEUNDERLINEIDS_OFFSET UNITYSDK_OFFSET(0xC7D2290)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GETENTERMODEUNDERLINEIDS_OFFSET UNITYSDK_OFFSET(0xC7D2510)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_BESTCOMPLEVELRECORD_OFFSET UNITYSDK_OFFSET(0xC7D3830)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_BESTLEVELPASSRECORD_OFFSET UNITYSDK_OFFSET(0xC7D3810)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_BRANCHCORELARGEPREFAB_OFFSET UNITYSDK_OFFSET(0xC7D31A0)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_BRANCHCORESMALLPREFAB_OFFSET UNITYSDK_OFFSET(0xC7D3250)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_BRANCHICONPATH_OFFSET UNITYSDK_OFFSET(0xC7D3300)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_BRANCHID_OFFSET UNITYSDK_OFFSET(0xC7D2800)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_BRANCHNAME_OFFSET UNITYSDK_OFFSET(0xC7D2FE0)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_BRIEFINTRO_OFFSET UNITYSDK_OFFSET(0xC7D30C0)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_DESCPARAMVALUE1_OFFSET UNITYSDK_OFFSET(0xC7D2BA0)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_DESCPARAMVALUE2_OFFSET UNITYSDK_OFFSET(0xC7D2D20)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_DESCPARAMVALUE3_OFFSET UNITYSDK_OFFSET(0xC7D2EA0)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_DICEICONPATH_OFFSET UNITYSDK_OFFSET(0xC7D33B0)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_EFFECTDESCPARAM1_OFFSET UNITYSDK_OFFSET(0xC7D2AC0)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_EFFECTDESCPARAM2_OFFSET UNITYSDK_OFFSET(0xC7D2C40)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_EFFECTDESCPARAM3_OFFSET UNITYSDK_OFFSET(0xC7D2DC0)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_EFFECTDESC_OFFSET UNITYSDK_OFFSET(0xC7D2820)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_EFFECTEXTRADESC_OFFSET UNITYSDK_OFFSET(0xC7D23D0)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_GENRETAGVALUE_OFFSET UNITYSDK_OFFSET(0xC7D2F40)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_ISANYLEVELPASSED_OFFSET UNITYSDK_OFFSET(0xC7D3850)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_ISFIRSTTIMEUNLOCK_OFFSET UNITYSDK_OFFSET(0xC7D36B0)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_ISHARDESTLEVELPASSED_OFFSET UNITYSDK_OFFSET(0xC7D3860)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_PASSIVEEFFECTDESC_OFFSET UNITYSDK_OFFSET(0xC7D2900)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_PASSIVEEFFECTEXTRADESC_OFFSET UNITYSDK_OFFSET(0xC7D2470)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_PASSIVEEXTRADESC_OFFSET UNITYSDK_OFFSET(0xC7D2650)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_RECOMMENDHASHSET_OFFSET UNITYSDK_OFFSET(0xC7D36D0)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_SLOTLIST_OFFSET UNITYSDK_OFFSET(0xC7D3580)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_STARTINGEFFECTDESCTOAST_OFFSET UNITYSDK_OFFSET(0xC7D29E0)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_UNLOCKCONDITIONDESC_OFFSET UNITYSDK_OFFSET(0xC7D3460)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET__ROW_OFFSET UNITYSDK_OFFSET(0xC7D2700)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_INIT_OFFSET UNITYSDK_OFFSET(0xC7D16E0)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_REFRESHFIRSTTIMEUNLOCKSTATUS_OFFSET UNITYSDK_OFFSET(0xC7D21B0)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_SET_BESTCOMPLEVELRECORD_OFFSET UNITYSDK_OFFSET(0xC7D3840)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_SET_BESTLEVELPASSRECORD_OFFSET UNITYSDK_OFFSET(0xC7D3820)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_SET_BRANCHID_OFFSET UNITYSDK_OFFSET(0xC7D2810)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_SET_ISFIRSTTIMEUNLOCK_OFFSET UNITYSDK_OFFSET(0xC7D36C0)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_SYNCSLOT_OFFSET UNITYSDK_OFFSET(0xC7D1D30)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xC7D16D0)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM__INITSLOTS_OFFSET UNITYSDK_OFFSET(0xC7D1730)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueNousDiceBranchDataItem_TypeDefinitionIndex = 62591;
	...
	public:
		...
		::System::Boolean _IsFirstTimeUnlock_k__BackingField; // 0x25
		...
		::System::Void SyncSlot(::Class_1_766E1CF11E204F43_3* a1, ::Google::Protobuf::Collections::MapField_2<::System::UInt32, ::System::Boolean>* a2)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_766E1CF11E204F43_3*, ::Google::Protobuf::Collections::MapField_2<::System::UInt32, ::System::Boolean>*))((::PBYTE)hIl2Cpp + RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_SYNCSLOT_OFFSET))(this, a1, a2);
		}
