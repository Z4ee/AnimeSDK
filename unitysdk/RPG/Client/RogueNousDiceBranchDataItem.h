...
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_DISPOSE_OFFSET UNITYSDK_OFFSET(0xDF061A0)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GETEDITMODEUNDERLINEIDS_OFFSET UNITYSDK_OFFSET(0xDF06900)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GETENTERMODEUNDERLINEIDS_OFFSET UNITYSDK_OFFSET(0xDF06B80)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_BESTCOMPLEVELRECORD_OFFSET UNITYSDK_OFFSET(0xDF07ED0)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_BESTLEVELPASSRECORD_OFFSET UNITYSDK_OFFSET(0xDF07EB0)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_BRANCHCORELARGEPREFAB_OFFSET UNITYSDK_OFFSET(0xDF07810)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_BRANCHCORESMALLPREFAB_OFFSET UNITYSDK_OFFSET(0xDF078C0)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_BRANCHICONPATH_OFFSET UNITYSDK_OFFSET(0xDF07970)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_BRANCHID_OFFSET UNITYSDK_OFFSET(0xDF06E70)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_BRANCHNAME_OFFSET UNITYSDK_OFFSET(0xDF07650)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_BRIEFINTRO_OFFSET UNITYSDK_OFFSET(0xDF07730)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_DESCPARAMVALUE1_OFFSET UNITYSDK_OFFSET(0xDF07210)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_DESCPARAMVALUE2_OFFSET UNITYSDK_OFFSET(0xDF07390)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_DESCPARAMVALUE3_OFFSET UNITYSDK_OFFSET(0xDF07510)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_DICEICONPATH_OFFSET UNITYSDK_OFFSET(0xDF07A20)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_EFFECTDESCPARAM1_OFFSET UNITYSDK_OFFSET(0xDF07130)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_EFFECTDESCPARAM2_OFFSET UNITYSDK_OFFSET(0xDF072B0)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_EFFECTDESCPARAM3_OFFSET UNITYSDK_OFFSET(0xDF07430)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_EFFECTDESC_OFFSET UNITYSDK_OFFSET(0xDF06E90)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_EFFECTEXTRADESC_OFFSET UNITYSDK_OFFSET(0xDF06A40)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_GENRETAGVALUE_OFFSET UNITYSDK_OFFSET(0xDF075B0)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_ISANYLEVELPASSED_OFFSET UNITYSDK_OFFSET(0xDF07EF0)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_ISFIRSTTIMEUNLOCK_OFFSET UNITYSDK_OFFSET(0xDF07D20)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_ISHARDESTLEVELPASSED_OFFSET UNITYSDK_OFFSET(0xDF07F40)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_PASSIVEEFFECTDESC_OFFSET UNITYSDK_OFFSET(0xDF06F70)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_PASSIVEEFFECTEXTRADESC_OFFSET UNITYSDK_OFFSET(0xDF06AE0)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_PASSIVEEXTRADESC_OFFSET UNITYSDK_OFFSET(0xDF06CC0)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_RECOMMENDHASHSET_OFFSET UNITYSDK_OFFSET(0xDF07D40)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_SLOTLIST_OFFSET UNITYSDK_OFFSET(0xDF07BF0)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_STARTINGEFFECTDESCTOAST_OFFSET UNITYSDK_OFFSET(0xDF07050)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET_UNLOCKCONDITIONDESC_OFFSET UNITYSDK_OFFSET(0xDF07AD0)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_GET__ROW_OFFSET UNITYSDK_OFFSET(0xDF06D70)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_INIT_OFFSET UNITYSDK_OFFSET(0xDF05BF0)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_REFRESHFIRSTTIMEUNLOCKSTATUS_OFFSET UNITYSDK_OFFSET(0xDF06820)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_SET_BESTCOMPLEVELRECORD_OFFSET UNITYSDK_OFFSET(0xDF07EE0)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_SET_BESTLEVELPASSRECORD_OFFSET UNITYSDK_OFFSET(0xDF07EC0)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_SET_BRANCHID_OFFSET UNITYSDK_OFFSET(0xDF06E80)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_SET_ISFIRSTTIMEUNLOCK_OFFSET UNITYSDK_OFFSET(0xDF07D30)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM_SYNCSLOT_OFFSET UNITYSDK_OFFSET(0xDF06240)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xDF05BE0)
#define RPG_CLIENT_ROGUENOUSDICEBRANCHDATAITEM__INITSLOTS_OFFSET UNITYSDK_OFFSET(0xDF05C40)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::Boolean _IsFirstTimeUnlock_k__BackingField; // 0x28
		::System::Boolean IsUnlocked; // 0x29
		::System::UInt32 _BranchID_k__BackingField; // 0x2C
