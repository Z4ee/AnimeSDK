...
#define RPG_CLIENT_EFFECT_SPECIALVISIONSMELLS_AWAKE_OFFSET UNITYSDK_OFFSET(0x15E99350)
#define RPG_CLIENT_EFFECT_SPECIALVISIONSMELLS_METHOD_5_022B0D58A3077BF2_OFFSET UNITYSDK_OFFSET(0x15E99C70)
#define RPG_CLIENT_EFFECT_SPECIALVISIONSMELLS_METHOD_5_9D4EC0959ED23C46_OFFSET UNITYSDK_OFFSET(0x15E99790)
#define RPG_CLIENT_EFFECT_SPECIALVISIONSMELLS_METHOD_5_B469A1C3583AE516_OFFSET UNITYSDK_OFFSET(0x15E99960)
#define RPG_CLIENT_EFFECT_SPECIALVISIONSMELLS_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x15E99410)
#define RPG_CLIENT_EFFECT_SPECIALVISIONSMELLS_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x15E994D0)
#define RPG_CLIENT_EFFECT_SPECIALVISIONSMELLS__CTOR_OFFSET UNITYSDK_OFFSET(0x15E99D40)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_SpecialVisionSmells_TypeDefinitionIndex = 70520;
