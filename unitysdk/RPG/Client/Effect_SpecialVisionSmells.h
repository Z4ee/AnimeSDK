...
#define RPG_CLIENT_EFFECT_SPECIALVISIONSMELLS_AWAKE_OFFSET UNITYSDK_OFFSET(0xA203CC0)
#define RPG_CLIENT_EFFECT_SPECIALVISIONSMELLS_METHOD_5_022B0D58A3077BF2_OFFSET UNITYSDK_OFFSET(0xA204580)
#define RPG_CLIENT_EFFECT_SPECIALVISIONSMELLS_METHOD_5_9D4EC0959ED23C46_OFFSET UNITYSDK_OFFSET(0xA204090)
#define RPG_CLIENT_EFFECT_SPECIALVISIONSMELLS_METHOD_5_B469A1C3583AE516_OFFSET UNITYSDK_OFFSET(0xA204270)
#define RPG_CLIENT_EFFECT_SPECIALVISIONSMELLS_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xA203D50)
#define RPG_CLIENT_EFFECT_SPECIALVISIONSMELLS_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0xA203DE0)
#define RPG_CLIENT_EFFECT_SPECIALVISIONSMELLS__CTOR_OFFSET UNITYSDK_OFFSET(0xA204650)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_SpecialVisionSmells_TypeDefinitionIndex = 65047;
