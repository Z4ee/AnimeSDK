...
#define RPG_CLIENT_PLANETFESANIMEFFECT_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xDB2EF80)
#define RPG_CLIENT_PLANETFESANIMEFFECT_ONCREATE_OFFSET UNITYSDK_OFFSET(0xDB2EFC0)
#define RPG_CLIENT_PLANETFESANIMEFFECT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xDB2EEF0)
#define RPG_CLIENT_PLANETFESANIMEFFECT_PLAY_OFFSET UNITYSDK_OFFSET(0xDB2F210)
#define RPG_CLIENT_PLANETFESANIMEFFECT_SETICON_OFFSET UNITYSDK_OFFSET(0xDB2F160)
#define RPG_CLIENT_PLANETFESANIMEFFECT_SETNUMBER_OFFSET UNITYSDK_OFFSET(0xDB2F0F0)
#define RPG_CLIENT_PLANETFESANIMEFFECT_SPAWNED_OFFSET UNITYSDK_OFFSET(0xDB2EF40)
#define RPG_CLIENT_PLANETFESANIMEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xDB2F360)
