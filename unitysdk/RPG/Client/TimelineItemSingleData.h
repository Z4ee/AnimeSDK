...
#define RPG_CLIENT_TIMELINEITEMSINGLEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x197B5600)

namespace RPG::Client
{
	inline static constexpr unsigned int TimelineItemSingleData_TypeDefinitionIndex = 60952;
