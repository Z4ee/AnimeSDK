...
#define RPG_CLIENT_TIMELINEITEMSINGLEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x178A5260)

namespace RPG::Client
{
	inline static constexpr unsigned int TimelineItemSingleData_TypeDefinitionIndex = 58125;
