...
#define RPG_CLIENT_LOOPSCENE_ADDATTACHMOVEOBJECT_OFFSET UNITYSDK_OFFSET(0x15BEE800)
#define RPG_CLIENT_LOOPSCENE_AWAKE_OFFSET UNITYSDK_OFFSET(0x15BEEE30)
#define RPG_CLIENT_LOOPSCENE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15BEEA30)
#define RPG_CLIENT_LOOPSCENE_FINDMOVEOBJECT_OFFSET UNITYSDK_OFFSET(0x15BEE8E0)
#define RPG_CLIENT_LOOPSCENE_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x15BEEF60)
#define RPG_CLIENT_LOOPSCENE_INIT_OFFSET UNITYSDK_OFFSET(0x15BEE160)
#define RPG_CLIENT_LOOPSCENE_METHOD_5_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0x15BEF680)
#define RPG_CLIENT_LOOPSCENE_METHOD_5_283DA224BE06DA9F_1_OFFSET UNITYSDK_OFFSET(0x15BEF060)
#define RPG_CLIENT_LOOPSCENE_METHOD_5_283DA224BE06DA9F_OFFSET UNITYSDK_OFFSET(0x15BEF010)
#define RPG_CLIENT_LOOPSCENE_METHOD_5_601EF3E7226D7DC2_OFFSET UNITYSDK_OFFSET(0x15BEEF10)
#define RPG_CLIENT_LOOPSCENE_METHOD_5_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0x15BEF6F0)
#define RPG_CLIENT_LOOPSCENE_METHOD_5_A6544B958241856F_OFFSET UNITYSDK_OFFSET(0x15BEF0B0)
#define RPG_CLIENT_LOOPSCENE_METHOD_5_CD28994AFE636FFF_OFFSET UNITYSDK_OFFSET(0x15BEF740)
#define RPG_CLIENT_LOOPSCENE_METHOD_5_CFF8C0A3594A8E50_OFFSET UNITYSDK_OFFSET(0x15BEF290)
#define RPG_CLIENT_LOOPSCENE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x15BEEEA0)
#define RPG_CLIENT_LOOPSCENE_RESETCAMERA_OFFSET UNITYSDK_OFFSET(0x15BEE690)
#define RPG_CLIENT_LOOPSCENE__CTOR_OFFSET UNITYSDK_OFFSET(0x15BEFBF0)

namespace RPG::Client
{
	inline static constexpr unsigned int LoopScene_TypeDefinitionIndex = 65794;
