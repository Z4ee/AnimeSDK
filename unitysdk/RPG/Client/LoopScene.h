...
#define RPG_CLIENT_LOOPSCENE_ADDATTACHMOVEOBJECT_OFFSET UNITYSDK_OFFSET(0x9A6F070)
#define RPG_CLIENT_LOOPSCENE_AWAKE_OFFSET UNITYSDK_OFFSET(0x9A6F5D0)
#define RPG_CLIENT_LOOPSCENE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9A6F1E0)
#define RPG_CLIENT_LOOPSCENE_FINDMOVEOBJECT_OFFSET UNITYSDK_OFFSET(0x9A6F100)
#define RPG_CLIENT_LOOPSCENE_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x9A6F700)
#define RPG_CLIENT_LOOPSCENE_INIT_OFFSET UNITYSDK_OFFSET(0x9A6EAE0)
#define RPG_CLIENT_LOOPSCENE_METHOD_5_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0x9A6FDE0)
#define RPG_CLIENT_LOOPSCENE_METHOD_5_596FD8239C601ED8_OFFSET UNITYSDK_OFFSET(0x9A6FEA0)
#define RPG_CLIENT_LOOPSCENE_METHOD_5_9D3B43E6609D6005_OFFSET UNITYSDK_OFFSET(0x9A6FA00)
#define RPG_CLIENT_LOOPSCENE_METHOD_5_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0x9A6FE50)
#define RPG_CLIENT_LOOPSCENE_METHOD_5_B7F8E0B4AF22DEA3_OFFSET UNITYSDK_OFFSET(0x9A6F850)
#define RPG_CLIENT_LOOPSCENE_METHOD_5_D9EF75A2D048B8A1_1_OFFSET UNITYSDK_OFFSET(0x9A6F800)
#define RPG_CLIENT_LOOPSCENE_METHOD_5_D9EF75A2D048B8A1_OFFSET UNITYSDK_OFFSET(0x9A6F7B0)
#define RPG_CLIENT_LOOPSCENE_METHOD_5_F79D5EC57FBF426E_OFFSET UNITYSDK_OFFSET(0x9A6F6B0)
#define RPG_CLIENT_LOOPSCENE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9A6F640)
#define RPG_CLIENT_LOOPSCENE_RESETCAMERA_OFFSET UNITYSDK_OFFSET(0x9A6EF00)
#define RPG_CLIENT_LOOPSCENE__CTOR_OFFSET UNITYSDK_OFFSET(0x9A70340)

namespace RPG::Client
{
	inline static constexpr unsigned int LoopScene_TypeDefinitionIndex = 56260;
