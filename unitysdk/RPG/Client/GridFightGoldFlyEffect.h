...
#define RPG_CLIENT_GRIDFIGHTGOLDFLYEFFECT_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xA4E8450)
#define RPG_CLIENT_GRIDFIGHTGOLDFLYEFFECT_ONCREATE_OFFSET UNITYSDK_OFFSET(0xA4E8170)
#define RPG_CLIENT_GRIDFIGHTGOLDFLYEFFECT_PLAY_OFFSET UNITYSDK_OFFSET(0xA4E8490)
#define RPG_CLIENT_GRIDFIGHTGOLDFLYEFFECT_SPAWNED_OFFSET UNITYSDK_OFFSET(0xA4E8410)
#define RPG_CLIENT_GRIDFIGHTGOLDFLYEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xA4E8730)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightGoldFlyEffect_TypeDefinitionIndex = 59348;
