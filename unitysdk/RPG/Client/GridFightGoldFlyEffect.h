...
#define RPG_CLIENT_GRIDFIGHTGOLDFLYEFFECT_DESPAWNED_OFFSET UNITYSDK_OFFSET(0x984A000)
#define RPG_CLIENT_GRIDFIGHTGOLDFLYEFFECT_ONCREATE_OFFSET UNITYSDK_OFFSET(0x9849D20)
#define RPG_CLIENT_GRIDFIGHTGOLDFLYEFFECT_PLAY_OFFSET UNITYSDK_OFFSET(0x984A040)
#define RPG_CLIENT_GRIDFIGHTGOLDFLYEFFECT_SPAWNED_OFFSET UNITYSDK_OFFSET(0x9849FC0)
#define RPG_CLIENT_GRIDFIGHTGOLDFLYEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x984A2E0)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightGoldFlyEffect_TypeDefinitionIndex = 52392;
