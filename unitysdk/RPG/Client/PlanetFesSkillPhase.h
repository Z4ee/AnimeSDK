...
#define RPG_CLIENT_PLANETFESSKILLPHASE_ADDUNLOCKDATA_OFFSET UNITYSDK_OFFSET(0x1A1C1F40)
#define RPG_CLIENT_PLANETFESSKILLPHASE_CREATE_OFFSET UNITYSDK_OFFSET(0x1A1D4520)
#define RPG_CLIENT_PLANETFESSKILLPHASE_GETALLDISPLAYDATA_OFFSET UNITYSDK_OFFSET(0x1A1D4780)
#define RPG_CLIENT_PLANETFESSKILLPHASE_GETFINISHPROGRESS_OFFSET UNITYSDK_OFFSET(0x1A1D45E0)
#define RPG_CLIENT_PLANETFESSKILLPHASE_GETISFINISH_OFFSET UNITYSDK_OFFSET(0x1A1C2A90)
#define RPG_CLIENT_PLANETFESSKILLPHASE_GETISUNLOCK_OFFSET UNITYSDK_OFFSET(0x1A1D2EE0)
#define RPG_CLIENT_PLANETFESSKILLPHASE_GETLOCKREASON_OFFSET UNITYSDK_OFFSET(0x1A1D2CB0)
#define RPG_CLIENT_PLANETFESSKILLPHASE_GETSKILLCOUNT_OFFSET UNITYSDK_OFFSET(0x1A1D4A40)
#define RPG_CLIENT_PLANETFESSKILLPHASE_GET_HASLOCKCONDITION_OFFSET UNITYSDK_OFFSET(0x1A1D4CC0)
#define RPG_CLIENT_PLANETFESSKILLPHASE_GET_HASPASTPHASE_OFFSET UNITYSDK_OFFSET(0x1A1D4B30)
#define RPG_CLIENT_PLANETFESSKILLPHASE_GET_ID_OFFSET UNITYSDK_OFFSET(0x1A1D4B80)
#define RPG_CLIENT_PLANETFESSKILLPHASE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A1D4C00)
#define RPG_CLIENT_PLANETFESSKILLPHASE_GET_ROW_OFFSET UNITYSDK_OFFSET(0x1A1D4BA0)
#define RPG_CLIENT_PLANETFESSKILLPHASE_GET_SHOWNUNLOCKANIM_OFFSET UNITYSDK_OFFSET(0x1A1D4D30)
#define RPG_CLIENT_PLANETFESSKILLPHASE_GET_UNLOCKIDS_OFFSET UNITYSDK_OFFSET(0x1A1C1CF0)
#define RPG_CLIENT_PLANETFESSKILLPHASE_HASSKILL_OFFSET UNITYSDK_OFFSET(0x1A1C2CC0)
#define RPG_CLIENT_PLANETFESSKILLPHASE_PASTPHASEHASSKILL_OFFSET UNITYSDK_OFFSET(0x1A1D4A90)
#define RPG_CLIENT_PLANETFESSKILLPHASE_SETPASTPHASE_OFFSET UNITYSDK_OFFSET(0x1A1D4590)
#define RPG_CLIENT_PLANETFESSKILLPHASE_SET_ID_OFFSET UNITYSDK_OFFSET(0x1A1D4B90)
#define RPG_CLIENT_PLANETFESSKILLPHASE_SET_SHOWNUNLOCKANIM_OFFSET UNITYSDK_OFFSET(0x1A1D4E10)
#define RPG_CLIENT_PLANETFESSKILLPHASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1D4580)

namespace RPG::Client
{
	inline static constexpr unsigned int PlanetFesSkillPhase_TypeDefinitionIndex = 63684;
	...
	public:
		...
		::RPG::Client::PlanetFesSkillPhase* _PastPhase; // 0x28
