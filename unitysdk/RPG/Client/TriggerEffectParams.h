...
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_CLEAR_OFFSET UNITYSDK_OFFSET(0x1B2D1280)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_COPY_OFFSET UNITYSDK_OFFSET(0x1B2D0D50)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_GET_ALIVESTATE_OFFSET UNITYSDK_OFFSET(0x1B2D1A40)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_GET_ATTACHPOINTNAME_OFFSET UNITYSDK_OFFSET(0x1B105220)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_GET_ATTACHTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1B105330)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_GET_CREATETIMESTAMP_OFFSET UNITYSDK_OFFSET(0x1B1051A0)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_GET_EFFECTASYNCLOADEDCALLBACK_OFFSET UNITYSDK_OFFSET(0x1B1051E0)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_GET_EFFECTINSTANCE_OFFSET UNITYSDK_OFFSET(0x1B2D1AE0)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_GET_ISATTACHTOTARGETENTITY_OFFSET UNITYSDK_OFFSET(0x1B105310)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_GET_ISCULLEDHIDE_OFFSET UNITYSDK_OFFSET(0x1B2D1B20)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_GET_ISCULLED_OFFSET UNITYSDK_OFFSET(0x1B2D1B00)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_GET_ISFIRSTLOAD_OFFSET UNITYSDK_OFFSET(0x1B2D1A60)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_GET_ISMANUALLOD_OFFSET UNITYSDK_OFFSET(0x1B2D1A80)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_GET_ISRELEASED_OFFSET UNITYSDK_OFFSET(0x1B105160)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_GET_MUTEXENTITY_OFFSET UNITYSDK_OFFSET(0x1B105240)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_GET_REALPATH_OFFSET UNITYSDK_OFFSET(0x1B2D1AC0)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_GET_RECORDANIMATOR_OFFSET UNITYSDK_OFFSET(0x1B2D1AA0)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_GET_RELEASECALLBACK_OFFSET UNITYSDK_OFFSET(0x1B105200)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_GET_TARGETENTITYANIMNORMALZIEDTIME_OFFSET UNITYSDK_OFFSET(0x1B1051C0)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_GET_UNIQUEEFFECTID_OFFSET UNITYSDK_OFFSET(0x1B105180)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_GET_UNIQUEPARAMID_OFFSET UNITYSDK_OFFSET(0x1B105140)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_HASFLAG_OFFSET UNITYSDK_OFFSET(0x1B2D14C0)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_INNERSETALIVESTATE_OFFSET UNITYSDK_OFFSET(0x1B2D1550)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_INNERSETATTACHPOINTNAME_OFFSET UNITYSDK_OFFSET(0x1B2D1950)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_INNERSETCREATETIMESTAMP_OFFSET UNITYSDK_OFFSET(0x1B2D17F0)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_INNERSETDELAYFIRSTLOAD_OFFSET UNITYSDK_OFFSET(0x1B2D1230)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_INNERSETEFFECTASYNCLOADEDCALLBACK_OFFSET UNITYSDK_OFFSET(0x1B2D18B0)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_INNERSETEFFECTINSTANCE_OFFSET UNITYSDK_OFFSET(0x1B2D19F0)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_INNERSETISCULLEDHIDE_OFFSET UNITYSDK_OFFSET(0x1B2D1700)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_INNERSETISCULLED_OFFSET UNITYSDK_OFFSET(0x1B2D16B0)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_INNERSETISFIRSTLOAD_OFFSET UNITYSDK_OFFSET(0x1B2D15A0)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_INNERSETISMANUALLOD_OFFSET UNITYSDK_OFFSET(0x1B2D1660)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_INNERSETISRELEASED_OFFSET UNITYSDK_OFFSET(0x1B2D1750)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_INNERSETREALPATH_OFFSET UNITYSDK_OFFSET(0x1B2D19A0)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_INNERSETRECORDANIMATOR_OFFSET UNITYSDK_OFFSET(0x1B2D1600)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_INNERSETRELEASECALLBACK_OFFSET UNITYSDK_OFFSET(0x1B2D1900)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_INNERSETTARGETENTITYANIMNORMALZIEDTIME_OFFSET UNITYSDK_OFFSET(0x1B2D1850)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_INNERSETUNIQUEEFFECTID_OFFSET UNITYSDK_OFFSET(0x1B2D17A0)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_SET_ALIVESTATE_OFFSET UNITYSDK_OFFSET(0x1B2D1A50)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_SET_ATTACHPOINTNAME_OFFSET UNITYSDK_OFFSET(0x1B105230)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_SET_ATTACHTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1B105320)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_SET_CREATETIMESTAMP_OFFSET UNITYSDK_OFFSET(0x1B1051B0)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_SET_EFFECTASYNCLOADEDCALLBACK_OFFSET UNITYSDK_OFFSET(0x1B1051F0)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_SET_EFFECTINSTANCE_OFFSET UNITYSDK_OFFSET(0x1B2D1AF0)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_SET_ISATTACHTOTARGETENTITY_OFFSET UNITYSDK_OFFSET(0x1B1052A0)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_SET_ISCULLEDHIDE_OFFSET UNITYSDK_OFFSET(0x1B2D1B30)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_SET_ISCULLED_OFFSET UNITYSDK_OFFSET(0x1B2D1B10)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_SET_ISFIRSTLOAD_OFFSET UNITYSDK_OFFSET(0x1B2D1A70)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_SET_ISMANUALLOD_OFFSET UNITYSDK_OFFSET(0x1B2D1A90)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_SET_ISRELEASED_OFFSET UNITYSDK_OFFSET(0x1B105170)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_SET_REALPATH_OFFSET UNITYSDK_OFFSET(0x1B2D1AD0)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_SET_RECORDANIMATOR_OFFSET UNITYSDK_OFFSET(0x1B2D1AB0)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_SET_RELEASECALLBACK_OFFSET UNITYSDK_OFFSET(0x1B105210)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_SET_TARGETENTITYANIMNORMALZIEDTIME_OFFSET UNITYSDK_OFFSET(0x1B1051D0)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_SET_UNIQUEEFFECTID_OFFSET UNITYSDK_OFFSET(0x1B105190)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS_SET_UNIQUEPARAMID_OFFSET UNITYSDK_OFFSET(0x1B105150)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B105340)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS__COPYRECORDANIMATOR_OFFSET UNITYSDK_OFFSET(0x1B2D11B0)
#define RPG_CLIENT_TRIGGEREFFECTPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2D0CE0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::RPG::MVector3*)Il2CppClass::FromTypeDefinitionIndex(TriggerEffectParams_TypeDefinitionIndex)->GetStaticField(0x8B40);
		}
		static ::RPG::MVector3* StaticGet_InvalidVector3()
		{
			return (::RPG::MVector3*)Il2CppClass::FromTypeDefinitionIndex(TriggerEffectParams_TypeDefinitionIndex)->GetStaticField(0x8B4C);
		}
		static ::System::UInt32* StaticGet_UniqueParamIDGen()
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(TriggerEffectParams_TypeDefinitionIndex)->GetStaticField(0x8B58);
		}
		::Class_1_A53F3A238B732F34* AdvEffectExtraParams; // 0x10
		::System::Action_2<::RPG::Client::MonoEffect*, ::RPG::Client::TriggerEffectCallbackParams>* CompleteCallback; // 0x18
		::RPG::Client::MockAnimator* _RecordAnimator_k__BackingField; // 0x20
		::System::String* DynamicAttach; // 0x28
		::System::String* TowardAttachPoint; // 0x30
		::System::String* InitEffectState; // 0x38
		::System::Action_2<::RPG::Client::MonoEffect*, ::RPG::Client::TriggerEffectCallbackParams>* BeforeResetCompleteCallback; // 0x40
		::RPG::GameCore::GameEntity* ParamEntity; // 0x48
		::System::Action_2<::RPG::Client::MonoEffect*, ::RPG::Client::TriggerEffectCallbackParams>* _ReleaseCallback_k__BackingField; // 0x50
		::RPG::Client::MonoEffect* _EffectInstance_k__BackingField; // 0x58
		::System::String* _AttachPointName_k__BackingField; // 0x60
		::System::String* EffectName; // 0x68
		...
		::System::Action_2<::RPG::Client::MonoEffect*, ::RPG::Client::TriggerEffectCallbackParams>* LodUnloadCallback; // 0x80
		::Struct_2_30CF330D40A40872 LittleGameExtraParams; // 0x88
		::System::String* _RealPath_k__BackingField; // 0xB8
		::RPG::GameCore::OverrideMonoEffectConfig* OverrideConfig; // 0xC0
		::Il2CppArray<::RPG::GameCore::MonoEffectFlag>* Flags; // 0xC8
		::UnityEngine::Transform* _AttachTransform_k__BackingField; // 0xD0
		::Il2CppArray<::RPG::GameCore::EffectModifyData*>* SubObjectModifyDataList; // 0xD8
		::System::String* AudioSwitchName; // 0xE0
		::RPG::GameCore::GameEntity* CasterEntity; // 0xE8
		::System::String* UniqueEffectName; // 0xF0
		::System::String* AudioSwitchGroup; // 0xF8
		::System::String* AdvConfigName; // 0x100
		::Class_0_16E4307DCC419505_127* LittleGameEntity; // 0x108
		::System::Action_1<::RPG::Client::MonoEffect*>* _EffectAsyncLoadedCallback_k__BackingField; // 0x110
		::UnityEngine::Vector3 TowardTargetPosition; // 0x118
		::System::Nullable_1<::UnityEngine::Vector3> RotationOffset; // 0x124
		::System::Nullable_1<::UnityEngine::Vector3> AnchorPosition; // 0x134
		::System::Boolean ForceSimulateImmediately; // 0x144
		::System::Boolean AttachToTimeline; // 0x145
		::System::Boolean _DelayFirstLoad; // 0x146
		::System::Boolean IsForbidInitRenderCache; // 0x147
		::System::Nullable_1<::RPG::GameCore::FixPoint> TaskTimeScale; // 0x148
		::System::UInt32 _UniqueEffectID_k__BackingField; // 0x158
		::RPG::Client::MonoEffectAliveState _AliveState_k__BackingField; // 0x15C
		::System::UInt32 _UniqueParamID_k__BackingField; // 0x160
		::System::Boolean IsEnableReplay; // 0x164
		::System::Boolean _IsCulledHide_k__BackingField; // 0x165
		::System::Boolean _IsReleased_k__BackingField; // 0x166
		::System::Boolean IsForbidResetRenderCache; // 0x167
		::System::Boolean IsModifierAttached; // 0x168
		::System::Boolean IsForbidLod; // 0x169
		::System::Boolean IsUIEffect; // 0x16A
		::System::Boolean TowardRotatePitchOnly; // 0x16B
		::System::Single _TargetEntityAnimNormalziedTime_k__BackingField; // 0x16C
		::System::Nullable_1<::UnityEngine::Vector3> PositionOffset; // 0x170
		::RPG::GameCore::EffectParamEntityUsage ParamEntityUsage; // 0x180
		::System::Boolean SyncPropState; // 0x184
		::System::Boolean _IsManualLOD_k__BackingField; // 0x185
		::System::Boolean FollowFirstFrameOnLateTick; // 0x186
		::System::Boolean _IsCulled_k__BackingField; // 0x187
		::System::Boolean IsCRPEffect; // 0x188
		::System::Boolean EnableSimulateTimeAlign; // 0x189
		::System::Boolean IgnorePrefabAttachPoint; // 0x18A
		::System::Boolean _IsRealAttachToTargetEntity; // 0x18B
		::System::Single TowardMaxPitchAngle; // 0x18C
		::System::Nullable_1<::UnityEngine::Vector3> InitPosition; // 0x190
		::System::Single _CreateTimeStamp_k__BackingField; // 0x1A0
		::System::Boolean _IsFirstLoad_k__BackingField; // 0x1A4
		::System::Boolean FollowCasterTimeSlow; // 0x1A5
		::System::Boolean IsNeedFadeIn; // 0x1A6
		::System::Single Delay; // 0x1A8
		::System::UInt32 AttachToTimelineVersion; // 0x1AC
		::System::Nullable_1<::UnityEngine::Vector3> CustomScale; // 0x1B0
		::System::Nullable_1<::UnityEngine::Quaternion> InitRotation; // 0x1C0
		::RPG::GameCore::EffectScaleAdaptType ScaleAdaptType; // 0x1D4
