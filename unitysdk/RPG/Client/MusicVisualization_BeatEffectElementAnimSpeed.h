...
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTANIMSPEED_METHOD_2_8A4821B6962F6B25_OFFSET UNITYSDK_OFFSET(0x18EA0D30)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTANIMSPEED_METHOD_2_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x18EA0F70)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTANIMSPEED_METHOD_2_E530905EC9C5B4AD_OFFSET UNITYSDK_OFFSET(0x18EA0CE0)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTANIMSPEED_METHOD_2_EF9FF539AE18C3F9_OFFSET UNITYSDK_OFFSET(0x18EA0FD0)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTANIMSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x18EA10E0)

namespace RPG::Client
{
	inline static constexpr unsigned int MusicVisualization_BeatEffectElementAnimSpeed_TypeDefinitionIndex = 67649;
