...
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTANIMSPEED_METHOD_2_8A4821B6962F6B25_OFFSET UNITYSDK_OFFSET(0xAB297F0)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTANIMSPEED_METHOD_2_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xAB29A50)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTANIMSPEED_METHOD_2_9F9ED25754A7CAB9_OFFSET UNITYSDK_OFFSET(0xAB29C80)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTANIMSPEED_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xAB29D20)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTANIMSPEED_METHOD_2_E530905EC9C5B4AD_OFFSET UNITYSDK_OFFSET(0xAB297A0)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTANIMSPEED_METHOD_2_EF9FF539AE18C3F9_OFFSET UNITYSDK_OFFSET(0xAB29AB0)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTANIMSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0xAB29BC0)

namespace RPG::Client
{
	inline static constexpr unsigned int MusicVisualization_BeatEffectElementAnimSpeed_TypeDefinitionIndex = 65297;
