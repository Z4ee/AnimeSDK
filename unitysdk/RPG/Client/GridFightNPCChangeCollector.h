...
#define RPG_CLIENT_GRIDFIGHTNPCCHANGECOLLECTOR_GET_NPCADDEDORREMOVED_OFFSET UNITYSDK_OFFSET(0xD2215C0)
#define RPG_CLIENT_GRIDFIGHTNPCCHANGECOLLECTOR_ONCOLLECTIONCHANGEDEVENTHANDLER_OFFSET UNITYSDK_OFFSET(0xD221550)
#define RPG_CLIENT_GRIDFIGHTNPCCHANGECOLLECTOR_ONPROPERTYCHANGEDEVENTHANDLER_OFFSET UNITYSDK_OFFSET(0xD2213C0)
#define RPG_CLIENT_GRIDFIGHTNPCCHANGECOLLECTOR_RESET_OFFSET UNITYSDK_OFFSET(0xD221320)
#define RPG_CLIENT_GRIDFIGHTNPCCHANGECOLLECTOR_SET_NPCADDEDORREMOVED_OFFSET UNITYSDK_OFFSET(0xD2215D0)
#define RPG_CLIENT_GRIDFIGHTNPCCHANGECOLLECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0xD2215E0)
