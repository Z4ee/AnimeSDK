...
#define RPG_CLIENT_MARBLEBATTLETURNUPDATENOTIFY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A87E380)

namespace RPG::Client
{
	inline static constexpr unsigned int MarbleBattleTurnUpdateNotify_TypeDefinitionIndex = 62893;
