...
#define RPG_CLIENT_BATTLESILVERWOLF999BATTERYUIDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD6BEA0)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleSilverWolf999BatteryUIData_TypeDefinitionIndex = 71424;
