...
#define RPG_CLIENT_BATTLESILVERWOLF999BATTERYUIDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9E7D590)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleSilverWolf999BatteryUIData_TypeDefinitionIndex = 65869;
