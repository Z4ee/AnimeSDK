...
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_APPLYTEXTLANGUAGE_OFFSET UNITYSDK_OFFSET(0xCA28D20)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_ASYNCAPPLYTEXTLANGUAGE_OFFSET UNITYSDK_OFFSET(0xCA290D0)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_ASYNCUPDATELANGSIZE_1_OFFSET UNITYSDK_OFFSET(0xCA27ED0)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_ASYNCUPDATELANGSIZE_OFFSET UNITYSDK_OFFSET(0xCA27DD0)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_BEGINDOWNLOADSESSION_OFFSET UNITYSDK_OFFSET(0xCA28B90)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_CANCELASYNCAPPLYTEXTLANGUAGE_OFFSET UNITYSDK_OFFSET(0xCA26B20)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_CANDELETE_OFFSET UNITYSDK_OFFSET(0xCA29590)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_DELETETEXTMAPPACK_OFFSET UNITYSDK_OFFSET(0xCA27B00)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_DISPOSE_OFFSET UNITYSDK_OFFSET(0xCA268F0)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_ENDDOWNLOADSESSION_OFFSET UNITYSDK_OFFSET(0xCA27A60)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_ENTERDOWNLOADING_OFFSET UNITYSDK_OFFSET(0xCA28C20)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_ENTERIDLE_OFFSET UNITYSDK_OFFSET(0xCA28C90)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_GETDOWNLOADEDTEXTMAPCOUNT_OFFSET UNITYSDK_OFFSET(0xCA29540)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_GETDOWNLOADEDTEXTMAPITEMS_OFFSET UNITYSDK_OFFSET(0xCA29830)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_GETDOWNLOADSTAGE_OFFSET UNITYSDK_OFFSET(0xCA26890)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_GETPARTIALDOWNLOADEDTEXTMAPITEMS_OFFSET UNITYSDK_OFFSET(0xCA29A60)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_GETTEXTMAPITEMBYKEY_OFFSET UNITYSDK_OFFSET(0xCA29750)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_GETTEXTMAPSIZE_OFFSET UNITYSDK_OFFSET(0xCA281B0)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_GET_ISSESSIONDOWNLOADING_OFFSET UNITYSDK_OFFSET(0xCA268E0)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_GET_ISSESSIONIDLE_OFFSET UNITYSDK_OFFSET(0xCA268D0)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_GET_ISVALIDATINGTEXTLANGUAGE_OFFSET UNITYSDK_OFFSET(0xCA29320)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_ISTEXTMAPDOWNLOADED_OFFSET UNITYSDK_OFFSET(0xCA28B20)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_ISTEXTMAPPARTIALDOWNLOADED_OFFSET UNITYSDK_OFFSET(0xCA294A0)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_ONTEXTMAPSIZEFAIL_OFFSET UNITYSDK_OFFSET(0xCA285D0)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_ONTEXTMAPSIZESUCCESS_OFFSET UNITYSDK_OFFSET(0xCA282F0)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_PAUSE_OFFSET UNITYSDK_OFFSET(0xCA27790)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_PLACEHOLDTEXTMAPPACK_OFFSET UNITYSDK_OFFSET(0xCA27D20)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_PREPAREDOWNLOAD_OFFSET UNITYSDK_OFFSET(0xCA27740)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_PREPARETEXTMAPDOWNLOADDATA_OFFSET UNITYSDK_OFFSET(0xCA26BC0)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_RESUME_OFFSET UNITYSDK_OFFSET(0xCA277E0)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_SHOWSIZE_OFFSET UNITYSDK_OFFSET(0xCA295D0)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_STARTDOWNLOAD_OFFSET UNITYSDK_OFFSET(0xCA286F0)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_STOPDOWNLOAD_OFFSET UNITYSDK_OFFSET(0xCA27830)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_UPDATEPARTIALDOWNLOADTEXTMAPLANG_OFFSET UNITYSDK_OFFSET(0xCA29C90)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER_UPDATETEXTMAPDOWNLOADSTATE_OFFSET UNITYSDK_OFFSET(0xCA273A0)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER__ASYNCUPDATELANGSIZE_B__31_0_OFFSET UNITYSDK_OFFSET(0xCA2A480)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER__CLEARASYNCAPPLYCALLBACKS_OFFSET UNITYSDK_OFFSET(0xCA26B70)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xCA2A190)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER__DISPOSEUPDATEASSETCORE_OFFSET UNITYSDK_OFFSET(0xCA27A00)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER__DISPOSEUPDATEASSET_OFFSET UNITYSDK_OFFSET(0xCA26A40)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER__ONTEXTMAPPACKDOWNLOADFAILED_OFFSET UNITYSDK_OFFSET(0xCA29FD0)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER__ONTEXTMAPPACKDOWNLOADSUCCEED_OFFSET UNITYSDK_OFFSET(0xCA29D60)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER__POSTTOMAINTHREAD_OFFSET UNITYSDK_OFFSET(0xCA29370)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER__STRICTVALIDATETEXTLANGUAGE_OFFSET UNITYSDK_OFFSET(0xCA28FE0)

namespace RPG::Client
{
	inline static constexpr unsigned int TextmapDownloadManager_TypeDefinitionIndex = 57248;
	...
	public:
		...
		::System::Collections::Generic::HashSet_1<::System::String*>* _partialDownloadedLanguage; // 0x18
		::Class_1_0AD1433F85E9FBFC* _langSizeLoader; // 0x20
		::System::Action_1<::RPG::Client::TextmapDownloadManager_TextmapApplyChangeErrorCode>* _applyCallback; // 0x28
		::Class_1_B76B01F33EAE3251* _updateOneTextmapLangAsset; // 0x30
		::System::Collections::Generic::List_1<::RPG::Client::TextmapLanguageItem*>* _itemListCache; // 0x38
		::System::Collections::Generic::Dictionary_2<::System::String*, ::RPG::Client::TextmapLanguageItem*>* _languageItems; // 0x40
		::System::Collections::Generic::HashSet_1<::System::String*>* _downloadedLanguage; // 0x48
		...
		::System::Boolean _showSizeDirty; // 0x66
		::System::Boolean _showSizeState; // 0x67
