...
#define RPG_CLIENT_MATCHTHREEBOARD___C__DISPLAYCLASS64_0__CTOR_OFFSET UNITYSDK_OFFSET(0xBF72A30)
#define RPG_CLIENT_MATCHTHREEBOARD___C__DISPLAYCLASS64_0___PLAYGRIDBREAKEFFECT_B__0_OFFSET UNITYSDK_OFFSET(0xBF72A40)

namespace RPG::Client
{
	inline static constexpr unsigned int MatchThreeBoard___c__DisplayClass64_0_TypeDefinitionIndex = 61623;

	class MatchThreeBoard___c__DisplayClass64_0 : public ::System::Object
	{
	public:
		::RPG::Client::MatchThreeTimedEffect* gridBreakEffect; // 0x10
