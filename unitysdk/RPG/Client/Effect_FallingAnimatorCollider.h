...
#define RPG_CLIENT_EFFECT_FALLINGANIMATORCOLLIDER_CONTAINS_OFFSET UNITYSDK_OFFSET(0xCDDA1B0)
#define RPG_CLIENT_EFFECT_FALLINGANIMATORCOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0xCDDA770)
