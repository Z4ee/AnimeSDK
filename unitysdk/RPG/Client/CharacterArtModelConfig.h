...
#define RPG_CLIENT_CHARACTERARTMODELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x191FF6B0)

namespace RPG::Client
{
	inline static constexpr unsigned int CharacterArtModelConfig_TypeDefinitionIndex = 66622;
