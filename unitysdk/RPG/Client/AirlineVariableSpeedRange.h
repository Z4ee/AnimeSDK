...
#define RPG_CLIENT_AIRLINEVARIABLESPEEDRANGE__CTOR_OFFSET UNITYSDK_OFFSET(0xB2D8FD0)

namespace RPG::Client
{
	inline static constexpr unsigned int AirlineVariableSpeedRange_TypeDefinitionIndex = 55875;
