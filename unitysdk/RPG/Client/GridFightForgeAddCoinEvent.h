...
#define RPG_CLIENT_GRIDFIGHTFORGEADDCOINEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD48360)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightForgeAddCoinEvent_TypeDefinitionIndex = 64982;
