...
#define RPG_CLIENT_FAKEDOUBLESCREENMONOPLUGIN_FORCEOVERRIDE_OFFSET UNITYSDK_OFFSET(0xCF13A50)
#define RPG_CLIENT_FAKEDOUBLESCREENMONOPLUGIN_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xCF13AE0)
#define RPG_CLIENT_FAKEDOUBLESCREENMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xCF13B30)
