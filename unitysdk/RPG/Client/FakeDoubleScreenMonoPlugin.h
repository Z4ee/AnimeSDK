...
#define RPG_CLIENT_FAKEDOUBLESCREENMONOPLUGIN_FORCEOVERRIDE_OFFSET UNITYSDK_OFFSET(0x965A0A0)
#define RPG_CLIENT_FAKEDOUBLESCREENMONOPLUGIN_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x965A130)
#define RPG_CLIENT_FAKEDOUBLESCREENMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x965A180)
#define RPG_CLIENT_FAKEDOUBLESCREENMONOPLUGIN___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x965A1F0)

namespace RPG::Client
{
	inline static constexpr unsigned int FakeDoubleScreenMonoPlugin_TypeDefinitionIndex = 57804;
