...
#define RPG_CLIENT_MOVIEGAMECONTROLLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x190757E0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_GETGAMEMODECOMPONENT_OFFSET UNITYSDK_OFFSET(0x19074C80)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_GETGAMEMODEENTITY_OFFSET UNITYSDK_OFFSET(0x19074D00)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_GETGAMEMODE_OFFSET UNITYSDK_OFFSET(0x190748B0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_GETOPERATIONCONFIG_OFFSET UNITYSDK_OFFSET(0x19074D60)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_GETPLAYERSPANCHORPOSITION_OFFSET UNITYSDK_OFFSET(0x19074960)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_GETSTATISTICS_OFFSET UNITYSDK_OFFSET(0x19074C00)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0x19073BA0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0x19075170)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_0C490FF1F071E8D4_OFFSET UNITYSDK_OFFSET(0x19076C90)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0x190741E0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_361917FE49883C86_OFFSET UNITYSDK_OFFSET(0x19076E20)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_6112A1276899AF0F_OFFSET UNITYSDK_OFFSET(0x190751B0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_7908E0A3A062534E_OFFSET UNITYSDK_OFFSET(0x190766D0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_94CBD0C21A609187_OFFSET UNITYSDK_OFFSET(0x19076560)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_A239DF324AF4215D_OFFSET UNITYSDK_OFFSET(0x19075540)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_A43D587A89E24E29_OFFSET UNITYSDK_OFFSET(0x190768B0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_B710AD145420A84D_1_OFFSET UNITYSDK_OFFSET(0x190762E0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_B710AD145420A84D_2_OFFSET UNITYSDK_OFFSET(0x19076420)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_B710AD145420A84D_OFFSET UNITYSDK_OFFSET(0x190761A0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_C7BF9C1E6A78DCAB_OFFSET UNITYSDK_OFFSET(0x19075D10)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_DE52BD42C4B0B772_OFFSET UNITYSDK_OFFSET(0x19076030)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_E52129E82CD2D7F8_OFFSET UNITYSDK_OFFSET(0x19073FA0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_E88B764FDB27A464_OFFSET UNITYSDK_OFFSET(0x190769F0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_F1D0751A34EC3B37_OFFSET UNITYSDK_OFFSET(0x19078190)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_ONANYTRIGGERSOUNDEVENT_OFFSET UNITYSDK_OFFSET(0x19078310)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_ONPLAYERHITSTATE_OFFSET UNITYSDK_OFFSET(0x19078420)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0x19074330)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_STARTPUZZLE_OFFSET UNITYSDK_OFFSET(0x19074420)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_TICKPUZZLE_OFFSET UNITYSDK_OFFSET(0x19074DC0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_TRIGGERPUZZLECUSTOMEVENT_OFFSET UNITYSDK_OFFSET(0x190784F0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x190785B0)

namespace RPG::Client
{
	inline static constexpr unsigned int MovieGameController_TypeDefinitionIndex = 57710;
