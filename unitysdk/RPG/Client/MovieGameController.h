...
#define RPG_CLIENT_MOVIEGAMECONTROLLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC1A93A0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_GETGAMEMODECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC1A8840)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_GETGAMEMODEENTITY_OFFSET UNITYSDK_OFFSET(0xC1A88C0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_GETGAMEMODE_OFFSET UNITYSDK_OFFSET(0xC1A8470)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_GETOPERATIONCONFIG_OFFSET UNITYSDK_OFFSET(0xC1A8920)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_GETPLAYERSPANCHORPOSITION_OFFSET UNITYSDK_OFFSET(0xC1A8520)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_GETSTATISTICS_OFFSET UNITYSDK_OFFSET(0xC1A87C0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xC1A7840)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xC1A8D30)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_0C490FF1F071E8D4_OFFSET UNITYSDK_OFFSET(0xC1AA7F0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0xC1A7E70)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_361917FE49883C86_OFFSET UNITYSDK_OFFSET(0xC1AA980)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_3F2E3E1B8B367F03_OFFSET UNITYSDK_OFFSET(0xC1AA0B0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_6112A1276899AF0F_OFFSET UNITYSDK_OFFSET(0xC1A8D70)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_A239DF324AF4215D_OFFSET UNITYSDK_OFFSET(0xC1A9100)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_A43D587A89E24E29_OFFSET UNITYSDK_OFFSET(0xC1AA410)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_B710AD145420A84D_1_OFFSET UNITYSDK_OFFSET(0xC1A9E30)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_B710AD145420A84D_2_OFFSET UNITYSDK_OFFSET(0xC1A9F70)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_B710AD145420A84D_OFFSET UNITYSDK_OFFSET(0xC1A9CF0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_C7BF9C1E6A78DCAB_OFFSET UNITYSDK_OFFSET(0xC1A9860)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_DE52BD42C4B0B772_OFFSET UNITYSDK_OFFSET(0xC1A9B80)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_E52129E82CD2D7F8_OFFSET UNITYSDK_OFFSET(0xC1A7C30)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_E88B764FDB27A464_OFFSET UNITYSDK_OFFSET(0xC1AA550)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_EF22C41E6BD26CC3_OFFSET UNITYSDK_OFFSET(0xC1AA230)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_F1D0751A34EC3B37_OFFSET UNITYSDK_OFFSET(0xC1ABCF0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_ONANYTRIGGERSOUNDEVENT_OFFSET UNITYSDK_OFFSET(0xC1ABE60)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_ONPLAYERHITSTATE_OFFSET UNITYSDK_OFFSET(0xC1ABF70)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0xC1A7FC0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_STARTPUZZLE_OFFSET UNITYSDK_OFFSET(0xC1A80B0)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_TICKPUZZLE_OFFSET UNITYSDK_OFFSET(0xC1A8980)
#define RPG_CLIENT_MOVIEGAMECONTROLLER_TRIGGERPUZZLECUSTOMEVENT_OFFSET UNITYSDK_OFFSET(0xC1AC040)
#define RPG_CLIENT_MOVIEGAMECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC1AC100)
#define RPG_CLIENT_MOVIEGAMECONTROLLER___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC1AC240)
#define RPG_CLIENT_MOVIEGAMECONTROLLER___IFIXBASEPROXY_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xC1AC110)
#define RPG_CLIENT_MOVIEGAMECONTROLLER___IFIXBASEPROXY_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xC1AC250)
#define RPG_CLIENT_MOVIEGAMECONTROLLER___IFIXBASEPROXY_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0xC1AC120)
#define RPG_CLIENT_MOVIEGAMECONTROLLER___IFIXBASEPROXY_STARTPUZZLE_OFFSET UNITYSDK_OFFSET(0xC1AC180)
#define RPG_CLIENT_MOVIEGAMECONTROLLER___IFIXBASEPROXY_TICKPUZZLE_OFFSET UNITYSDK_OFFSET(0xC1AC1E0)

namespace RPG::Client
{
	inline static constexpr unsigned int MovieGameController_TypeDefinitionIndex = 56470;

	class MovieGameController : public ::RPG::Client::Prop::PuzzleBoardBase
	{
	public:
		::Class_1_D33B7D6901AE39E9* Field_6_0; // 0x48
		...
		::System::Void Method_6_3F2E3E1B8B367F03(::System::Object* a1)
		{
			return ((::System::Void(*)(::PVOID, ::System::Object*))((::PBYTE)hIl2Cpp + RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_3F2E3E1B8B367F03_OFFSET))(this, a1);
		}

		::System::Void Method_6_EF22C41E6BD26CC3(::System::Object* a1)
		{
			return ((::System::Void(*)(::PVOID, ::System::Object*))((::PBYTE)hIl2Cpp + RPG_CLIENT_MOVIEGAMECONTROLLER_METHOD_6_EF22C41E6BD26CC3_OFFSET))(this, a1);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::RPG::GameCore::GameEntity*, ::RPG::GameCore::TaskContext*, ::RPG::GameCore::PropInitPuzzle*))((::PBYTE)hIl2Cpp + RPG_CLIENT_MOVIEGAMECONTROLLER___IFIXBASEPROXY_INITPUZZLE_OFFSET))(this, a1, a2, a3);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + RPG_CLIENT_MOVIEGAMECONTROLLER___IFIXBASEPROXY_TICKPUZZLE_OFFSET))(this, a1);
		}
