...
#define RPG_CLIENT_RPGFADEANIMATION___C__DISPLAYCLASS3_0__CTOR_OFFSET UNITYSDK_OFFSET(0xAF441C0)
#define RPG_CLIENT_RPGFADEANIMATION___C__DISPLAYCLASS3_0__GETFADEOUTANIM_B__0_OFFSET UNITYSDK_OFFSET(0xAF443E0)

namespace RPG::Client
{
	inline static constexpr unsigned int RPGFadeAnimation___c__DisplayClass3_0_TypeDefinitionIndex = 67087;
