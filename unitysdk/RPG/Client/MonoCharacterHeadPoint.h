...
#define RPG_CLIENT_MONOCHARACTERHEADPOINT_GET_WORLDPOS_OFFSET UNITYSDK_OFFSET(0x1807A030)
#define RPG_CLIENT_MONOCHARACTERHEADPOINT_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x1807A270)
#define RPG_CLIENT_MONOCHARACTERHEADPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1807A2B0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoCharacterHeadPoint_TypeDefinitionIndex = 65486;
