...
#define RPG_CLIENT_MONOEFFECTFRAMECAPTURETEXPLUGIN_APPLYFRAMECAPTURE_OFFSET UNITYSDK_OFFSET(0xA93FB30)
#define RPG_CLIENT_MONOEFFECTFRAMECAPTURETEXPLUGIN_AWAKEPLUGIN_OFFSET UNITYSDK_OFFSET(0xA93FB80)
#define RPG_CLIENT_MONOEFFECTFRAMECAPTURETEXPLUGIN_DESTROYPLUGIN_OFFSET UNITYSDK_OFFSET(0xA93FD00)
#define RPG_CLIENT_MONOEFFECTFRAMECAPTURETEXPLUGIN_DISPOSEPLUGIN_OFFSET UNITYSDK_OFFSET(0xA93FCB0)
#define RPG_CLIENT_MONOEFFECTFRAMECAPTURETEXPLUGIN_RESETPLUGIN_OFFSET UNITYSDK_OFFSET(0xA93FC60)
#define RPG_CLIENT_MONOEFFECTFRAMECAPTURETEXPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xA93FDA0)
#define RPG_CLIENT_MONOEFFECTFRAMECAPTURETEXPLUGIN___IFIXBASEPROXY_AWAKEPLUGIN_OFFSET UNITYSDK_OFFSET(0xA93FDC0)
#define RPG_CLIENT_MONOEFFECTFRAMECAPTURETEXPLUGIN___IFIXBASEPROXY_DESTROYPLUGIN_OFFSET UNITYSDK_OFFSET(0xA93FE40)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectFrameCaptureTexPlugin_TypeDefinitionIndex = 64554;
