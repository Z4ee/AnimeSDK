...
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD_GET_BRIEFRECORD_OFFSET UNITYSDK_OFFSET(0xC49B8D0)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD_GET_CHALLENGETIMES_OFFSET UNITYSDK_OFFSET(0xC49B870)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0xC49A180)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD_GET_STAGERECORDS_OFFSET UNITYSDK_OFFSET(0xC49B8E0)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD_GET_STARCOUNT_OFFSET UNITYSDK_OFFSET(0xC49B850)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD_GET_TOTALSCORE_OFFSET UNITYSDK_OFFSET(0xC49B8B0)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD_GET_TOTALUSEROUNDS_OFFSET UNITYSDK_OFFSET(0xC49B890)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD_RESET_OFFSET UNITYSDK_OFFSET(0xC49A280)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD_SET_CHALLENGETIMES_OFFSET UNITYSDK_OFFSET(0xC49B880)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD_SET_STARCOUNT_OFFSET UNITYSDK_OFFSET(0xC49B860)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD_SET_TOTALSCORE_OFFSET UNITYSDK_OFFSET(0xC49B8C0)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD_SET_TOTALUSEROUNDS_OFFSET UNITYSDK_OFFSET(0xC49B8A0)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD_SYNC_OFFSET UNITYSDK_OFFSET(0xC49A350)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD__CTOR_OFFSET UNITYSDK_OFFSET(0xC49ADF0)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD__SYNCSTAGES_OFFSET UNITYSDK_OFFSET(0xC49B8F0)

namespace RPG::Client
{
	inline static constexpr unsigned int PlayerChallengeTierceRecord_TypeDefinitionIndex = 60074;

	class PlayerChallengeTierceRecord : public ::System::Object
	{
	public:
		::System::Collections::Generic::List_1<::RPG::Client::PlayerChallengeTierceStageRecord*>* _StageRecords_k__BackingField; // 0x10
		::RPG::Client::PlayerChallengeTierceBriefRecord* _BriefRecord_k__BackingField; // 0x18
		...
		::System::Void Sync(::Class_1_E577B5580A99D425_1* a1, ::Class_1_06E38C65842C3B24* a2, ::System::UInt32 a3)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_E577B5580A99D425_1*, ::Class_1_06E38C65842C3B24*, ::System::UInt32))((::PBYTE)hIl2Cpp + RPG_CLIENT_PLAYERCHALLENGETIERCERECORD_SYNC_OFFSET))(this, a1, a2, a3);
		}
