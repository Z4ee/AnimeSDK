...
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD_GET_BRIEFRECORD_OFFSET UNITYSDK_OFFSET(0x1AE02FD0)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD_GET_CHALLENGETIMES_OFFSET UNITYSDK_OFFSET(0x1AE02F70)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x1AE01F30)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD_GET_STAGERECORDS_OFFSET UNITYSDK_OFFSET(0x1AE02FE0)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD_GET_STARCOUNT_OFFSET UNITYSDK_OFFSET(0x1AE02F50)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD_GET_TOTALSCORE_OFFSET UNITYSDK_OFFSET(0x1AE02FB0)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD_GET_TOTALUSEROUNDS_OFFSET UNITYSDK_OFFSET(0x1AE02F90)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD_RESET_OFFSET UNITYSDK_OFFSET(0x1AE03BC0)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD_SET_CHALLENGETIMES_OFFSET UNITYSDK_OFFSET(0x1AE02F80)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD_SET_STARCOUNT_OFFSET UNITYSDK_OFFSET(0x1AE02F60)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD_SET_TOTALSCORE_OFFSET UNITYSDK_OFFSET(0x1AE02FC0)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD_SET_TOTALUSEROUNDS_OFFSET UNITYSDK_OFFSET(0x1AE02FA0)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD_SYNC_OFFSET UNITYSDK_OFFSET(0x1AE02FF0)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE02400)
#define RPG_CLIENT_PLAYERCHALLENGETIERCERECORD__SYNCSTAGES_OFFSET UNITYSDK_OFFSET(0x1AE03510)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::UInt32 _ChallengeTimes_k__BackingField; // 0x24
