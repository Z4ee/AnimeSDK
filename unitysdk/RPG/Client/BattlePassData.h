...
#define RPG_CLIENT_BATTLEPASSDATA_GETDISPLAYEQUIPCANREPEAT_OFFSET UNITYSDK_OFFSET(0x3B17F10)
#define RPG_CLIENT_BATTLEPASSDATA_GETDISPLAYEQUIPNOTREPEATED_OFFSET UNITYSDK_OFFSET(0x3B17F20)
#define RPG_CLIENT_BATTLEPASSDATA_GET_CANPURCHASE_OFFSET UNITYSDK_OFFSET(0x3B17FF0)
#define RPG_CLIENT_BATTLEPASSDATA_GET_DEFAULTLEVELMAXEXP_OFFSET UNITYSDK_OFFSET(0x3B17F90)
#define RPG_CLIENT_BATTLEPASSDATA_GET_HASPURCHASED_OFFSET UNITYSDK_OFFSET(0x3B18040)
#define RPG_CLIENT_BATTLEPASSDATA_GET_ISEXPSPEEDUP_OFFSET UNITYSDK_OFFSET(0x3B17F30)
#define RPG_CLIENT_BATTLEPASSDATA_GET_ISPAIDREWARDUNLOCKED_OFFSET UNITYSDK_OFFSET(0x3B17FA0)
#define RPG_CLIENT_BATTLEPASSDATA_GET_LEVELMAXEXP_OFFSET UNITYSDK_OFFSET(0x3B18090)
#define RPG_CLIENT_BATTLEPASSDATA_GET_REFRESHBEGINWEEK_OFFSET UNITYSDK_OFFSET(0x3B180B0)
#define RPG_CLIENT_BATTLEPASSDATA_GET_WEEKMAXEXP_OFFSET UNITYSDK_OFFSET(0x3B180A0)

namespace RPG::Client
{
	inline static constexpr unsigned int BattlePassData_TypeDefinitionIndex = 62957;
	...
	struct alignas(8) BattlePassData
	{
		...
		::Enum_3_DB663931210BBC27_17 PurchaseType; // 0x2C
