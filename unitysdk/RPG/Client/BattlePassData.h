...
#define RPG_CLIENT_BATTLEPASSDATA_GETDISPLAYEQUIPCANREPEAT_OFFSET UNITYSDK_OFFSET(0x149FB0)
#define RPG_CLIENT_BATTLEPASSDATA_GETDISPLAYEQUIPNOTREPEATED_OFFSET UNITYSDK_OFFSET(0x149FC0)
#define RPG_CLIENT_BATTLEPASSDATA_GET_CANPURCHASE_OFFSET UNITYSDK_OFFSET(0x14A090)
#define RPG_CLIENT_BATTLEPASSDATA_GET_DEFAULTLEVELMAXEXP_OFFSET UNITYSDK_OFFSET(0x14A030)
#define RPG_CLIENT_BATTLEPASSDATA_GET_HASPURCHASED_OFFSET UNITYSDK_OFFSET(0x14A0E0)
#define RPG_CLIENT_BATTLEPASSDATA_GET_ISEXPSPEEDUP_OFFSET UNITYSDK_OFFSET(0x149FD0)
#define RPG_CLIENT_BATTLEPASSDATA_GET_ISPAIDREWARDUNLOCKED_OFFSET UNITYSDK_OFFSET(0x14A040)
#define RPG_CLIENT_BATTLEPASSDATA_GET_LEVELMAXEXP_OFFSET UNITYSDK_OFFSET(0x14A130)
#define RPG_CLIENT_BATTLEPASSDATA_GET_REFRESHBEGINWEEK_OFFSET UNITYSDK_OFFSET(0x14A150)
#define RPG_CLIENT_BATTLEPASSDATA_GET_WEEKMAXEXP_OFFSET UNITYSDK_OFFSET(0x14A140)
