...
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0xB3CF370)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_LATETICK_OFFSET UNITYSDK_OFFSET(0xB3CEFD0)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_06330CD58CB602B6_OFFSET UNITYSDK_OFFSET(0xB3CF030)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_119B32705B42FBD9_OFFSET UNITYSDK_OFFSET(0xB3CFB30)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_228E3444D290BEE7_OFFSET UNITYSDK_OFFSET(0xB3CE800)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_3BFE3B9EF8374F61_OFFSET UNITYSDK_OFFSET(0xB3CEC90)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0xB3CEB10)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0xB3CEB70)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_4343F372F34C05BF_3_OFFSET UNITYSDK_OFFSET(0xB3CEBD0)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xB3CEAB0)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_5790A55946AA509D_1_OFFSET UNITYSDK_OFFSET(0xB3D03B0)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_5790A55946AA509D_2_OFFSET UNITYSDK_OFFSET(0xB3D0410)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_5790A55946AA509D_3_OFFSET UNITYSDK_OFFSET(0xB3D0470)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_5790A55946AA509D_4_OFFSET UNITYSDK_OFFSET(0xB3D04D0)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_5790A55946AA509D_5_OFFSET UNITYSDK_OFFSET(0xB3D0540)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0xB3D0350)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_5A50C1842B2C85AF_OFFSET UNITYSDK_OFFSET(0xB3CF5E0)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_704FAC4600717444_OFFSET UNITYSDK_OFFSET(0xB3CE870)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_84895CD37C104CC6_OFFSET UNITYSDK_OFFSET(0xB3CFE00)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0xB3CE730)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_C2F69B077374B167_OFFSET UNITYSDK_OFFSET(0xB3CF3E0)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0xB3CEC30)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0xB3D0310)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR__FLIPLEFTPAGE_B__25_0_OFFSET UNITYSDK_OFFSET(0xB3D0330)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR__FLIPRIGHTPAGE_B__24_0_OFFSET UNITYSDK_OFFSET(0xB3D0320)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR__UPDATE_B__27_0_OFFSET UNITYSDK_OFFSET(0xB3D0340)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR___IFIXBASEPROXY_LATETICK_OFFSET UNITYSDK_OFFSET(0xB3D0620)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0xB3D05B0)

namespace RPG::Client
{
	inline static constexpr unsigned int UIAutoFlipBehavior_TypeDefinitionIndex = 65483;
