...
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0xE342170)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_LATETICK_OFFSET UNITYSDK_OFFSET(0xE341D90)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_3C85D68D960FC053_OFFSET UNITYSDK_OFFSET(0xE3421F0)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_3CAB3F134E5CEF52_OFFSET UNITYSDK_OFFSET(0xE341570)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0xE341820)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0xE341880)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_4343F372F34C05BF_3_OFFSET UNITYSDK_OFFSET(0xE3418E0)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xE3417C0)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_6112A1276899AF0F_OFFSET UNITYSDK_OFFSET(0xE3419A0)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_629B474DE7862D90_OFFSET UNITYSDK_OFFSET(0xE342A10)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_777C630B90A28EF1_OFFSET UNITYSDK_OFFSET(0xE341500)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_97B44ED90A2DE2AB_OFFSET UNITYSDK_OFFSET(0xE341DF0)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0xE341430)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_B839AD5CB4E018CF_OFFSET UNITYSDK_OFFSET(0xE342450)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_METHOD_3_E44A8E4E3318F2F0_OFFSET UNITYSDK_OFFSET(0xE342CE0)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0xE341940)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0xE343250)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR__FLIPLEFTPAGE_B__25_0_OFFSET UNITYSDK_OFFSET(0xE343270)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR__FLIPRIGHTPAGE_B__24_0_OFFSET UNITYSDK_OFFSET(0xE343260)
#define RPG_CLIENT_UIAUTOFLIPBEHAVIOR__UPDATE_B__27_0_OFFSET UNITYSDK_OFFSET(0xE343280)
