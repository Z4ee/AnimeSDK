...
#define RPG_CLIENT_MONOTRAINPARTYBUILDITEMDEBUG_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A357470)
#define RPG_CLIENT_MONOTRAINPARTYBUILDITEMDEBUG_RESET_OFFSET UNITYSDK_OFFSET(0x1A3574C0)
#define RPG_CLIENT_MONOTRAINPARTYBUILDITEMDEBUG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3575B0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoTrainPartyBuildItemDebug_TypeDefinitionIndex = 65805;
