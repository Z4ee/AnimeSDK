...
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_GRIDFIGHTGAMEFORMATIONTRAITOPTION_GETICON_OFFSET UNITYSDK_OFFSET(0x1ABDA840)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_GRIDFIGHTGAMEFORMATIONTRAITOPTION_GETNAME_OFFSET UNITYSDK_OFFSET(0x1ABDA6B0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_GRIDFIGHTGAMEFORMATIONTRAITOPTION_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0x1ABDA5C0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_GRIDFIGHTGAMEFORMATIONTRAITOPTION_GET_ISTRAIT_OFFSET UNITYSDK_OFFSET(0x1ABDA4D0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_GRIDFIGHTGAMEFORMATIONTRAITOPTION_SATISFY_OFFSET UNITYSDK_OFFSET(0x1ABDA510)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_GRIDFIGHTGAMEFORMATIONTRAITOPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABD9700)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightGameFormationEditor_GridFightGameFormationTraitOption_TypeDefinitionIndex = 61724;
