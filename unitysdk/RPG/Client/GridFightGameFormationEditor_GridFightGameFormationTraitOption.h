...
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_GRIDFIGHTGAMEFORMATIONTRAITOPTION_GETICON_OFFSET UNITYSDK_OFFSET(0x1BD65050)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_GRIDFIGHTGAMEFORMATIONTRAITOPTION_GETNAME_OFFSET UNITYSDK_OFFSET(0x1BD64EC0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_GRIDFIGHTGAMEFORMATIONTRAITOPTION_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0x1BD64DD0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_GRIDFIGHTGAMEFORMATIONTRAITOPTION_GET_ISTRAIT_OFFSET UNITYSDK_OFFSET(0x1BD64CE0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_GRIDFIGHTGAMEFORMATIONTRAITOPTION_SATISFY_OFFSET UNITYSDK_OFFSET(0x1BD64D20)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_GRIDFIGHTGAMEFORMATIONTRAITOPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD63F30)
