...
#define RPG_CLIENT_CHECKITEMREACHWORLDLEVEL_FILLNOTIFYTYPESTO_OFFSET UNITYSDK_OFFSET(0x1B93B3D0)
#define RPG_CLIENT_CHECKITEMREACHWORLDLEVEL_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B93B510)
#define RPG_CLIENT_CHECKITEMREACHWORLDLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B93B3B0)
#define RPG_CLIENT_CHECKITEMREACHWORLDLEVEL__DOCHECKIMPL_OFFSET UNITYSDK_OFFSET(0x1B93B460)

namespace RPG::Client
{
	inline static constexpr unsigned int CheckItemReachWorldLevel_TypeDefinitionIndex = 60025;
