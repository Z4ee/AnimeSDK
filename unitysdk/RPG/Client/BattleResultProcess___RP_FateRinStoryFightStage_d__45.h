...
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FATERINSTORYFIGHTSTAGE_D__45_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19FBAC60)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FATERINSTORYFIGHTSTAGE_D__45_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19FBAFF0)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FATERINSTORYFIGHTSTAGE_D__45_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19FBB050)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FATERINSTORYFIGHTSTAGE_D__45_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19FBB000)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FATERINSTORYFIGHTSTAGE_D__45_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19FBAC50)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FATERINSTORYFIGHTSTAGE_D__45__CTOR_OFFSET UNITYSDK_OFFSET(0x19FB6420)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleResultProcess___RP_FateRinStoryFightStage_d__45_TypeDefinitionIndex = 58281;
