...
#define RPG_CLIENT_MONOVIDEOALPHACONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1C299C10)
#define RPG_CLIENT_MONOVIDEOALPHACONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1C299CE0)
#define RPG_CLIENT_MONOVIDEOALPHACONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C299D90)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoVideoAlphaController_TypeDefinitionIndex = 73112;
