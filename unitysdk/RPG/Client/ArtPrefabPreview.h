...
#define RPG_CLIENT_ARTPREFABPREVIEW_GET_MESHLOD_OFFSET UNITYSDK_OFFSET(0xB329ED0)
#define RPG_CLIENT_ARTPREFABPREVIEW_LOADMESH_OFFSET UNITYSDK_OFFSET(0xB32A1C0)
#define RPG_CLIENT_ARTPREFABPREVIEW_METHOD_5_45714050EDEF8291_OFFSET UNITYSDK_OFFSET(0xB32A100)
#define RPG_CLIENT_ARTPREFABPREVIEW_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB329EF0)
#define RPG_CLIENT_ARTPREFABPREVIEW_SET_MESHLOD_OFFSET UNITYSDK_OFFSET(0xB329EE0)
#define RPG_CLIENT_ARTPREFABPREVIEW_UNLOADMESH_OFFSET UNITYSDK_OFFSET(0xB329F40)
#define RPG_CLIENT_ARTPREFABPREVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xB32A4B0)

namespace RPG::Client
{
	inline static constexpr unsigned int ArtPrefabPreview_TypeDefinitionIndex = 63941;
