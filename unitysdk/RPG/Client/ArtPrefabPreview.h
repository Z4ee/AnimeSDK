...
#define RPG_CLIENT_ARTPREFABPREVIEW_GET_MESHLOD_OFFSET UNITYSDK_OFFSET(0x9D39E80)
#define RPG_CLIENT_ARTPREFABPREVIEW_LOADMESH_OFFSET UNITYSDK_OFFSET(0x9D3A150)
#define RPG_CLIENT_ARTPREFABPREVIEW_METHOD_5_E3DE31A03057E055_OFFSET UNITYSDK_OFFSET(0x9D3A0B0)
#define RPG_CLIENT_ARTPREFABPREVIEW_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9D39EA0)
#define RPG_CLIENT_ARTPREFABPREVIEW_SET_MESHLOD_OFFSET UNITYSDK_OFFSET(0x9D39E90)
#define RPG_CLIENT_ARTPREFABPREVIEW_UNLOADMESH_OFFSET UNITYSDK_OFFSET(0x9D39EF0)
#define RPG_CLIENT_ARTPREFABPREVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x9D3A400)

namespace RPG::Client
{
	inline static constexpr unsigned int ArtPrefabPreview_TypeDefinitionIndex = 63026;
