...
#define RPG_CLIENT_UIMAZESELECTCONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0x17257E80)
#define RPG_CLIENT_UIMAZESELECTCONTROLLER_RESETSELECTSTATE_OFFSET UNITYSDK_OFFSET(0x17257DA0)
#define RPG_CLIENT_UIMAZESELECTCONTROLLER_SETSELECTWEAKBLOCK_OFFSET UNITYSDK_OFFSET(0x17257CD0)
#define RPG_CLIENT_UIMAZESELECTCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17258000)

namespace RPG::Client
{
	inline static constexpr unsigned int UIMazeSelectController_TypeDefinitionIndex = 66027;
