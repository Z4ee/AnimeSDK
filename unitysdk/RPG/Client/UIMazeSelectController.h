...
#define RPG_CLIENT_UIMAZESELECTCONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0xA709400)
#define RPG_CLIENT_UIMAZESELECTCONTROLLER_RESETSELECTSTATE_OFFSET UNITYSDK_OFFSET(0xA7092A0)
#define RPG_CLIENT_UIMAZESELECTCONTROLLER_SETSELECTWEAKBLOCK_OFFSET UNITYSDK_OFFSET(0xA709170)
#define RPG_CLIENT_UIMAZESELECTCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA709590)

namespace RPG::Client
{
	inline static constexpr unsigned int UIMazeSelectController_TypeDefinitionIndex = 56461;
