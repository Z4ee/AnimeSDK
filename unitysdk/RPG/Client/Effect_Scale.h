...
#define RPG_CLIENT_EFFECT_SCALE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x15125450)
#define RPG_CLIENT_EFFECT_SCALE_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x151254E0)
#define RPG_CLIENT_EFFECT_SCALE_UPDATE_OFFSET UNITYSDK_OFFSET(0x151253C0)
#define RPG_CLIENT_EFFECT_SCALE__CTOR_OFFSET UNITYSDK_OFFSET(0x151255D0)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_Scale_TypeDefinitionIndex = 67391;
