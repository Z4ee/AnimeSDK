...
#define RPG_CLIENT_EFFECT_SCALE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xA201210)
#define RPG_CLIENT_EFFECT_SCALE_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xA2012A0)
#define RPG_CLIENT_EFFECT_SCALE_UPDATE_OFFSET UNITYSDK_OFFSET(0xA201180)
#define RPG_CLIENT_EFFECT_SCALE__CTOR_OFFSET UNITYSDK_OFFSET(0xA201390)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_Scale_TypeDefinitionIndex = 65040;
