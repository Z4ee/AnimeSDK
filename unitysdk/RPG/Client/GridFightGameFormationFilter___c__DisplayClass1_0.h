...
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER___C__DISPLAYCLASS1_0__APPLY_B__0_OFFSET UNITYSDK_OFFSET(0xD1B8060)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER___C__DISPLAYCLASS1_0__APPLY_B__1_OFFSET UNITYSDK_OFFSET(0xD1B8070)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER___C__DISPLAYCLASS1_0__CTOR_OFFSET UNITYSDK_OFFSET(0xD1B6190)
