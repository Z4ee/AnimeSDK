...
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER___C__DISPLAYCLASS1_0__APPLY_B__0_OFFSET UNITYSDK_OFFSET(0x1ABDD940)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER___C__DISPLAYCLASS1_0__APPLY_B__1_OFFSET UNITYSDK_OFFSET(0x1ABDD950)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER___C__DISPLAYCLASS1_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABDBA70)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightGameFormationFilter___c__DisplayClass1_0_TypeDefinitionIndex = 61769;
