...
#define RPG_CLIENT_PROPEFFECT_METHOD_7_06330CD58CB602B6_OFFSET UNITYSDK_OFFSET(0xA22F100)
#define RPG_CLIENT_PROPEFFECT_METHOD_7_25DEA5C65A602671_OFFSET UNITYSDK_OFFSET(0xA22E7F0)
#define RPG_CLIENT_PROPEFFECT_METHOD_7_82E992240300FB30_OFFSET UNITYSDK_OFFSET(0xA22EFC0)
#define RPG_CLIENT_PROPEFFECT_METHOD_7_8F059A365E90744C_OFFSET UNITYSDK_OFFSET(0xA22EED0)
#define RPG_CLIENT_PROPEFFECT_METHOD_7_D0EAB95EE152A65F_OFFSET UNITYSDK_OFFSET(0xA22EC50)
#define RPG_CLIENT_PROPEFFECT_ONENABLE_OFFSET UNITYSDK_OFFSET(0xA22F010)
#define RPG_CLIENT_PROPEFFECT_RESET_OFFSET UNITYSDK_OFFSET(0xA22EF70)
#define RPG_CLIENT_PROPEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xA22F0C0)
#define RPG_CLIENT_PROPEFFECT___IFIXBASEPROXY_RESET_OFFSET UNITYSDK_OFFSET(0xA22F0F0)

namespace RPG::Client
{
	inline static constexpr unsigned int PropEffect_TypeDefinitionIndex = 57907;
