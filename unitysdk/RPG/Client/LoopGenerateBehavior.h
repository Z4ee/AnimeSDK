...
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_GET_CURRENTCONFIGINDEX_OFFSET UNITYSDK_OFFSET(0x1863DA00)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_GET_PREVIEWMODE_OFFSET UNITYSDK_OFFSET(0x1863D4E0)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_GET__ANCHORPOSITIONONTRACK_OFFSET UNITYSDK_OFFSET(0x1863D890)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_GET__CURRENTCONFIG_OFFSET UNITYSDK_OFFSET(0x1863D500)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_GET__CURRENTSPEED_OFFSET UNITYSDK_OFFSET(0x1863D670)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_GET__ISFORWARD_OFFSET UNITYSDK_OFFSET(0x1863D6F0)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0x1863D630)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_01C1B3BBD3D9744A_OFFSET UNITYSDK_OFFSET(0x18644890)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_05CB392013C2B610_OFFSET UNITYSDK_OFFSET(0x186404B0)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_0F67DFB2AD11AB12_OFFSET UNITYSDK_OFFSET(0x18643430)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_19449DB07865B4DD_OFFSET UNITYSDK_OFFSET(0x186420F0)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_196844B4132EFADA_OFFSET UNITYSDK_OFFSET(0x18642E60)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_1F48AB7B56BDD842_OFFSET UNITYSDK_OFFSET(0x186447C0)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0x1863ED70)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_26C3CEC3D50100E1_OFFSET UNITYSDK_OFFSET(0x186418A0)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_2DF7969B85DC261B_OFFSET UNITYSDK_OFFSET(0x1863FAB0)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_2E3C71AD8E78BD37_1_OFFSET UNITYSDK_OFFSET(0x18640E00)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_2E3C71AD8E78BD37_OFFSET UNITYSDK_OFFSET(0x18640450)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_343A8D0B9A80FA1B_1_OFFSET UNITYSDK_OFFSET(0x1863EBD0)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_343A8D0B9A80FA1B_OFFSET UNITYSDK_OFFSET(0x18642650)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_359F524347624371_OFFSET UNITYSDK_OFFSET(0x18644600)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x1863F810)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_3CF43707BF2E9BBA_OFFSET UNITYSDK_OFFSET(0x18640E60)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_3E8C6C27D3157980_OFFSET UNITYSDK_OFFSET(0x186415D0)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_41F91000B6D154D6_OFFSET UNITYSDK_OFFSET(0x18640F10)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0x1863F850)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0x1863F8B0)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x1863EDD0)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_489605F44A3DA235_OFFSET UNITYSDK_OFFSET(0x18642560)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_4A544B3CFCFBA1DE_OFFSET UNITYSDK_OFFSET(0x18643980)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_4EA6B1791DACA9CC_OFFSET UNITYSDK_OFFSET(0x1863F1B0)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_50CF3DE66FC9EE5E_OFFSET UNITYSDK_OFFSET(0x18642AD0)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_5DB24FF26B3E6B25_OFFSET UNITYSDK_OFFSET(0x1863EE40)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_61929A3103595552_OFFSET UNITYSDK_OFFSET(0x18641260)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_6946C610D47FE5F0_OFFSET UNITYSDK_OFFSET(0x186438D0)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_6B1192ED4B83CD8F_OFFSET UNITYSDK_OFFSET(0x18644360)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_6E9072C320FA29F4_OFFSET UNITYSDK_OFFSET(0x18643E10)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_77322110BAB36133_OFFSET UNITYSDK_OFFSET(0x1863E2A0)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_7AABF16126468CE5_OFFSET UNITYSDK_OFFSET(0x18642F40)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_7C2C2820B36B9508_OFFSET UNITYSDK_OFFSET(0x186424F0)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_7ED1A617F38325F4_OFFSET UNITYSDK_OFFSET(0x1863F700)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_8080E22F79F246F0_1_OFFSET UNITYSDK_OFFSET(0x1863F790)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_8080E22F79F246F0_OFFSET UNITYSDK_OFFSET(0x1863F680)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_82E992240300FB30_OFFSET UNITYSDK_OFFSET(0x18644A00)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_83DA3EC57FF907F4_OFFSET UNITYSDK_OFFSET(0x18641470)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_84B92802FDAFF6C8_OFFSET UNITYSDK_OFFSET(0x18644420)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_85377D41FEE05B66_OFFSET UNITYSDK_OFFSET(0x1863DA10)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_8574F6654C7A1EE7_OFFSET UNITYSDK_OFFSET(0x18641420)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_86DAAF5E57B8D9C5_OFFSET UNITYSDK_OFFSET(0x186427D0)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_8858C2C146C0C88C_OFFSET UNITYSDK_OFFSET(0x18640840)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_896DA42CBA3EC3B7_OFFSET UNITYSDK_OFFSET(0x1863D920)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_96F4DD40F689F030_1_OFFSET UNITYSDK_OFFSET(0x18644270)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_96F4DD40F689F030_OFFSET UNITYSDK_OFFSET(0x186441E0)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_97529D4ED7AD3741_OFFSET UNITYSDK_OFFSET(0x186432B0)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_9F8F6511E8EF1235_OFFSET UNITYSDK_OFFSET(0x1863DDC0)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_A1ADC999CFACEB89_OFFSET UNITYSDK_OFFSET(0x1863E100)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_AEE7D7192A910D28_OFFSET UNITYSDK_OFFSET(0x18640580)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_B1DACD7E8B88788E_OFFSET UNITYSDK_OFFSET(0x186423F0)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_B4399B858EBFA977_OFFSET UNITYSDK_OFFSET(0x18642C50)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_B681CCB7CA0E61C0_OFFSET UNITYSDK_OFFSET(0x18644560)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_B8E82AFAD9F7F4B3_OFFSET UNITYSDK_OFFSET(0x18643080)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_BC41A14DA3276F14_OFFSET UNITYSDK_OFFSET(0x18641110)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_C093753911E3263F_OFFSET UNITYSDK_OFFSET(0x18642DB0)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x18643920)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_D09831639F615812_OFFSET UNITYSDK_OFFSET(0x1863EB70)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_D0BD1377F2594D33_1_OFFSET UNITYSDK_OFFSET(0x18640720)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_D0BD1377F2594D33_OFFSET UNITYSDK_OFFSET(0x18640600)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_D339EFAB24ED44B0_OFFSET UNITYSDK_OFFSET(0x1863F470)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_D5804A5743C3CF97_OFFSET UNITYSDK_OFFSET(0x1863ECF0)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_DB5DF1C74B5F8C15_OFFSET UNITYSDK_OFFSET(0x18641B80)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_DEAC86EB2AD5D389_OFFSET UNITYSDK_OFFSET(0x18643710)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_E80E8B87D44B3447_OFFSET UNITYSDK_OFFSET(0x18641DF0)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_E87DB0AA7B6E1394_OFFSET UNITYSDK_OFFSET(0x18642B50)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_ECA2A63EDDD75AB6_OFFSET UNITYSDK_OFFSET(0x18642FE0)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_F6F711795AB60FA2_OFFSET UNITYSDK_OFFSET(0x18643F80)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_SET_PREVIEWMODE_OFFSET UNITYSDK_OFFSET(0x1863D4F0)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0x1863F910)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x18644C50)
#define RPG_CLIENT_LOOPGENERATEBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x18644B60)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LoopGenerateBehavior_TypeDefinitionIndex)->GetStaticField(0x14850);
		}
		static ::System::Int32* StaticGet__MaxLoopCount()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LoopGenerateBehavior_TypeDefinitionIndex)->GetStaticField(0x14854);
		}
		...
		::System::Single Method_3_896DA42CBA3EC3B7(::System::Int32 a1)
		{
			return ((::System::Single(*)(::PVOID, ::System::Int32))((::PBYTE)hIl2Cpp + RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_896DA42CBA3EC3B7_OFFSET))(this, a1);
		}
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_85377D41FEE05B66_OFFSET))(this);
		}

		::System::Void Method_3_9F8F6511E8EF1235()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_9F8F6511E8EF1235_OFFSET))(this);
		}
		...
		::System::Boolean Method_3_19449DB07865B4DD(::System::Int32 a1, ::System::Collections::Generic::List_1<::System::Int32>*& a2)
		{
			return ((::System::Boolean(*)(::PVOID, ::System::Int32, ::System::Collections::Generic::List_1<::System::Int32>*&))((::PBYTE)hIl2Cpp + RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_19449DB07865B4DD_OFFSET))(this, a1, a2);
		}
		...
		::System::Boolean Method_3_0F67DFB2AD11AB12(::System::Int32 a1, ::System::Single& a2)
		{
			return ((::System::Boolean(*)(::PVOID, ::System::Int32, ::System::Single&))((::PBYTE)hIl2Cpp + RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_0F67DFB2AD11AB12_OFFSET))(this, a1, a2);
		}
		...
		::System::Void Method_3_4A544B3CFCFBA1DE(::System::Int32 a1, ::System::Single a2, ::System::Boolean a3)
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32, ::System::Single, ::System::Boolean))((::PBYTE)hIl2Cpp + RPG_CLIENT_LOOPGENERATEBEHAVIOR_METHOD_3_4A544B3CFCFBA1DE_OFFSET))(this, a1, a2, a3);
		}
