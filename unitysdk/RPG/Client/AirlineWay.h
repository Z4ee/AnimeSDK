...
#define RPG_CLIENT_AIRLINEWAY_AWAKE_OFFSET UNITYSDK_OFFSET(0x908CE80)
#define RPG_CLIENT_AIRLINEWAY_GET_LEAVEDISSOLVEPOINT_OFFSET UNITYSDK_OFFSET(0x908CE60)
#define RPG_CLIENT_AIRLINEWAY_SET_LEAVEDISSOLVEPOINT_OFFSET UNITYSDK_OFFSET(0x908CE70)
#define RPG_CLIENT_AIRLINEWAY_START_OFFSET UNITYSDK_OFFSET(0x908D8E0)
#define RPG_CLIENT_AIRLINEWAY__CTOR_OFFSET UNITYSDK_OFFSET(0x908DCA0)
#define RPG_CLIENT_AIRLINEWAY___IFIXBASEPROXY_AWAKE_OFFSET UNITYSDK_OFFSET(0x908DD50)

namespace RPG::Client
{
	inline static constexpr unsigned int AirlineWay_TypeDefinitionIndex = 48395;
