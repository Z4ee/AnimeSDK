...
#define RPG_CLIENT_AIRLINEWAY_AWAKE_OFFSET UNITYSDK_OFFSET(0xC722A50)
#define RPG_CLIENT_AIRLINEWAY_CLAMPRACINGOFFSET_OFFSET UNITYSDK_OFFSET(0xC725A40)
#define RPG_CLIENT_AIRLINEWAY_EVALUATERACINGBOOSTSPEEDMULTIPLIER_OFFSET UNITYSDK_OFFSET(0xC7257F0)
#define RPG_CLIENT_AIRLINEWAY_EVALUATERACINGBOOSTTRIGGERDISTANCE_OFFSET UNITYSDK_OFFSET(0xC725970)
#define RPG_CLIENT_AIRLINEWAY_GETBAKEDRACINGLINELATERALOFFSET_OFFSET UNITYSDK_OFFSET(0xC726EF0)
#define RPG_CLIENT_AIRLINEWAY_GETNEXTRACINGBOOSTRINGINDEX_OFFSET UNITYSDK_OFFSET(0xC7254F0)
#define RPG_CLIENT_AIRLINEWAY_GETOPTIMALRACINGLINEOFFSET_OFFSET UNITYSDK_OFFSET(0xC726560)
#define RPG_CLIENT_AIRLINEWAY_GETRACINGTRACKANCHOR_OFFSET UNITYSDK_OFFSET(0xC723E50)
#define RPG_CLIENT_AIRLINEWAY_GETRACINGTRACKPOSITION_OFFSET UNITYSDK_OFFSET(0xC7248B0)
#define RPG_CLIENT_AIRLINEWAY_GETRACINGTURNSTRENGTH_OFFSET UNITYSDK_OFFSET(0xC725B50)
#define RPG_CLIENT_AIRLINEWAY_GET_BODYLOOKAHEADDISTANCE_OFFSET UNITYSDK_OFFSET(0xC722600)
#define RPG_CLIENT_AIRLINEWAY_GET_HASBAKEDRACINGLINE_OFFSET UNITYSDK_OFFSET(0xC726800)
#define RPG_CLIENT_AIRLINEWAY_GET_HASBODYLOOKAHEADSTEERING_OFFSET UNITYSDK_OFFSET(0xC7225E0)
#define RPG_CLIENT_AIRLINEWAY_GET_HASCUSTOMSAILBOATWINDDIRECTION_OFFSET UNITYSDK_OFFSET(0xC722650)
#define RPG_CLIENT_AIRLINEWAY_GET_HASRACINGBOOSTRINGS_OFFSET UNITYSDK_OFFSET(0xC7227A0)
#define RPG_CLIENT_AIRLINEWAY_GET_HASRACINGBOOSTSPEEDCONFIG_OFFSET UNITYSDK_OFFSET(0xC722920)
#define RPG_CLIENT_AIRLINEWAY_GET_HASTURNSPEEDCONTROL_OFFSET UNITYSDK_OFFSET(0xC7225D0)
#define RPG_CLIENT_AIRLINEWAY_GET_ISRACINGMODEENABLED_OFFSET UNITYSDK_OFFSET(0xC724A70)
#define RPG_CLIENT_AIRLINEWAY_GET_LEAVEDISSOLVEPOINT_OFFSET UNITYSDK_OFFSET(0xC7225B0)
#define RPG_CLIENT_AIRLINEWAY_GET_RACINGBOOSTMOVETRIGGERHASH_OFFSET UNITYSDK_OFFSET(0xC722800)
#define RPG_CLIENT_AIRLINEWAY_GET_RACINGBOOSTSPEEDDURATION_OFFSET UNITYSDK_OFFSET(0xC722990)
#define RPG_CLIENT_AIRLINEWAY_GET_RACINGBOOSTTRIGGERDISTANCEOFFSET_OFFSET UNITYSDK_OFFSET(0xC7229F0)
#define RPG_CLIENT_AIRLINEWAY_GET_RACINGDRIVESETTINGS_OFFSET UNITYSDK_OFFSET(0xC722730)
#define RPG_CLIENT_AIRLINEWAY_GET_SAILBOATWINDDIRECTION_OFFSET UNITYSDK_OFFSET(0xC7226B0)
#define RPG_CLIENT_AIRLINEWAY_INITRACINGBOOSTRINGS_OFFSET UNITYSDK_OFFSET(0xC724AD0)
#define RPG_CLIENT_AIRLINEWAY_METHOD_6_1EDDD623459E1A71_OFFSET UNITYSDK_OFFSET(0xC727050)
#define RPG_CLIENT_AIRLINEWAY_METHOD_6_2B3F866319C4A343_OFFSET UNITYSDK_OFFSET(0xC7235B0)
#define RPG_CLIENT_AIRLINEWAY_METHOD_6_30D4DB5416FA0B9D_OFFSET UNITYSDK_OFFSET(0xC726BA0)
#define RPG_CLIENT_AIRLINEWAY_METHOD_6_68EC003199A8D3E9_OFFSET UNITYSDK_OFFSET(0xC726650)
#define RPG_CLIENT_AIRLINEWAY_METHOD_6_7728625555DDF702_OFFSET UNITYSDK_OFFSET(0xC727120)
#define RPG_CLIENT_AIRLINEWAY_METHOD_6_ABA4391DF13D43EA_OFFSET UNITYSDK_OFFSET(0xC725C30)
#define RPG_CLIENT_AIRLINEWAY_METHOD_6_BF0BDBC966C0A3D7_OFFSET UNITYSDK_OFFSET(0xC7228B0)
#define RPG_CLIENT_AIRLINEWAY_METHOD_6_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xC727310)
#define RPG_CLIENT_AIRLINEWAY_METHOD_6_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xC7272D0)
#define RPG_CLIENT_AIRLINEWAY_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC723820)
#define RPG_CLIENT_AIRLINEWAY_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xC7237D0)
#define RPG_CLIENT_AIRLINEWAY_ONENABLE_OFFSET UNITYSDK_OFFSET(0xC723560)
#define RPG_CLIENT_AIRLINEWAY_RELEASERACINGBOOSTRINGS_OFFSET UNITYSDK_OFFSET(0xC723870)
#define RPG_CLIENT_AIRLINEWAY_SET_LEAVEDISSOLVEPOINT_OFFSET UNITYSDK_OFFSET(0xC7225C0)
#define RPG_CLIENT_AIRLINEWAY_START_OFFSET UNITYSDK_OFFSET(0xC723A90)
#define RPG_CLIENT_AIRLINEWAY_TRIGGERRACINGBOOSTRING_OFFSET UNITYSDK_OFFSET(0xC725660)
#define RPG_CLIENT_AIRLINEWAY_TRYGETBAKEDRACINGLINEPOSE_OFFSET UNITYSDK_OFFSET(0xC726860)
#define RPG_CLIENT_AIRLINEWAY_TRYGETRACINGBOOSTRINGDISTANCE_OFFSET UNITYSDK_OFFSET(0xC7255B0)
#define RPG_CLIENT_AIRLINEWAY__CTOR_OFFSET UNITYSDK_OFFSET(0xC7273F0)
