...
#define RPG_CLIENT_RELICRECOMMENDDATA_CLONEWITHEXCELLENTMAINPROPERTIES_OFFSET UNITYSDK_OFFSET(0xDE39530)
#define RPG_CLIENT_RELICRECOMMENDDATA_CLONE_OFFSET UNITYSDK_OFFSET(0xDE39360)
#define RPG_CLIENT_RELICRECOMMENDDATA_CREATECONFIGDATA_OFFSET UNITYSDK_OFFSET(0xDE38390)
#define RPG_CLIENT_RELICRECOMMENDDATA_CREATEPROPERTYDATAARRAY_1_OFFSET UNITYSDK_OFFSET(0xDE38FA0)
#define RPG_CLIENT_RELICRECOMMENDDATA_CREATEPROPERTYDATAARRAY_OFFSET UNITYSDK_OFFSET(0xDE385C0)
#define RPG_CLIENT_RELICRECOMMENDDATA_CREATESUITDATAARRAY_1_OFFSET UNITYSDK_OFFSET(0xDE38D10)
#define RPG_CLIENT_RELICRECOMMENDDATA_CREATESUITDATAARRAY_OFFSET UNITYSDK_OFFSET(0xDE38460)
#define RPG_CLIENT_RELICRECOMMENDDATA_CREATE_1_OFFSET UNITYSDK_OFFSET(0xDE39200)
#define RPG_CLIENT_RELICRECOMMENDDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xDE37F50)
#define RPG_CLIENT_RELICRECOMMENDDATA_GETMAINPROPERTYDATALIST_OFFSET UNITYSDK_OFFSET(0xDE39BD0)
#define RPG_CLIENT_RELICRECOMMENDDATA_GETMAINPROPERTYPERCENT_OFFSET UNITYSDK_OFFSET(0xDE3A670)
#define RPG_CLIENT_RELICRECOMMENDDATA_GETMATCHSUBPROPERTYCOUNT_OFFSET UNITYSDK_OFFSET(0xDE39E70)
#define RPG_CLIENT_RELICRECOMMENDDATA_GETSETIDPERCENT_OFFSET UNITYSDK_OFFSET(0xDE3A440)
#define RPG_CLIENT_RELICRECOMMENDDATA_GET_DATATYPE_OFFSET UNITYSDK_OFFSET(0xDE37A00)
#define RPG_CLIENT_RELICRECOMMENDDATA_GET_EXCELLENTMAINPROPERTYCOUNTLIMIT_OFFSET UNITYSDK_OFFSET(0xDE37E80)
#define RPG_CLIENT_RELICRECOMMENDDATA_GET_EXCELLENTMAINPROPERTYPERCENTLOWERLIMIT_OFFSET UNITYSDK_OFFSET(0xDE37CE0)
#define RPG_CLIENT_RELICRECOMMENDDATA_GET_ISBIGDATA_OFFSET UNITYSDK_OFFSET(0xDE37960)
#define RPG_CLIENT_RELICRECOMMENDDATA_GET_ISCONFIGDATA_OFFSET UNITYSDK_OFFSET(0xDE379B0)
#define RPG_CLIENT_RELICRECOMMENDDATA_GET_ISEXPIRED_OFFSET UNITYSDK_OFFSET(0xDE37A20)
#define RPG_CLIENT_RELICRECOMMENDDATA_GET_RECOMMENDPERCENTLOWERLIMIT_OFFSET UNITYSDK_OFFSET(0xDE37B40)
#define RPG_CLIENT_RELICRECOMMENDDATA_ISMATCHEXCELLENTMAINPROPERTY_1_OFFSET UNITYSDK_OFFSET(0xDE39D20)
#define RPG_CLIENT_RELICRECOMMENDDATA_ISMATCHEXCELLENTMAINPROPERTY_OFFSET UNITYSDK_OFFSET(0xDE39CB0)
#define RPG_CLIENT_RELICRECOMMENDDATA_ISMATCHFIRSTMAINPROPERTY_OFFSET UNITYSDK_OFFSET(0xDE3A290)
#define RPG_CLIENT_RELICRECOMMENDDATA_ISMATCHFIRSTSETID_OFFSET UNITYSDK_OFFSET(0xDE3A160)
#define RPG_CLIENT_RELICRECOMMENDDATA_ISMATCHMAINPROPERTY_1_OFFSET UNITYSDK_OFFSET(0xDE39A90)
#define RPG_CLIENT_RELICRECOMMENDDATA_ISMATCHMAINPROPERTY_OFFSET UNITYSDK_OFFSET(0xDE39A20)
#define RPG_CLIENT_RELICRECOMMENDDATA_ISMATCHSETID_OFFSET UNITYSDK_OFFSET(0xDE39F70)
#define RPG_CLIENT_RELICRECOMMENDDATA_ISMATCHSUBPROPERTY_OFFSET UNITYSDK_OFFSET(0xDE39940)
#define RPG_CLIENT_RELICRECOMMENDDATA_ISMATCHTOPNMAINPROPERTY_OFFSET UNITYSDK_OFFSET(0xDE3A2F0)
#define RPG_CLIENT_RELICRECOMMENDDATA_SET_DATATYPE_OFFSET UNITYSDK_OFFSET(0xDE37A10)
#define RPG_CLIENT_RELICRECOMMENDDATA_SYNC_1_OFFSET UNITYSDK_OFFSET(0xDE38910)
#define RPG_CLIENT_RELICRECOMMENDDATA_SYNC_OFFSET UNITYSDK_OFFSET(0xDE37FD0)
#define RPG_CLIENT_RELICRECOMMENDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xDE37FC0)
#define RPG_CLIENT_RELICRECOMMENDDATA__FILTEREXCELLENTMAINPROPERTIES_OFFSET UNITYSDK_OFFSET(0xDE39590)
#define RPG_CLIENT_RELICRECOMMENDDATA__INITSUBPROPERTYLIST_OFFSET UNITYSDK_OFFSET(0xDE38780)
#define RPG_CLIENT_RELICRECOMMENDDATA__REFRESHMAINPROPERTYEXCELLENTSTATE_OFFSET UNITYSDK_OFFSET(0xDE39290)
