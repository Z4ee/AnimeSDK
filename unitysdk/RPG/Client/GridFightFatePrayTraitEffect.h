...
#define RPG_CLIENT_GRIDFIGHTFATEPRAYTRAITEFFECT_CANEDITINPREPARATIONSTATE_OFFSET UNITYSDK_OFFSET(0x1A69FBC0)
#define RPG_CLIENT_GRIDFIGHTFATEPRAYTRAITEFFECT_CANEDIT_OFFSET UNITYSDK_OFFSET(0x1A69FB50)
#define RPG_CLIENT_GRIDFIGHTFATEPRAYTRAITEFFECT_GETEDITICON_OFFSET UNITYSDK_OFFSET(0x1A69FD90)
#define RPG_CLIENT_GRIDFIGHTFATEPRAYTRAITEFFECT_GET_ACTION_OFFSET UNITYSDK_OFFSET(0x1A69FE70)
#define RPG_CLIENT_GRIDFIGHTFATEPRAYTRAITEFFECT_GET_COMPLETEDQUESTCOUNT_OFFSET UNITYSDK_OFFSET(0x1A69FEA0)
#define RPG_CLIENT_GRIDFIGHTFATEPRAYTRAITEFFECT_GET_INPENDING_OFFSET UNITYSDK_OFFSET(0x1A69FE10)
#define RPG_CLIENT_GRIDFIGHTFATEPRAYTRAITEFFECT_GET_SELECTEDQUESTS_OFFSET UNITYSDK_OFFSET(0x1A69FE90)
#define RPG_CLIENT_GRIDFIGHTFATEPRAYTRAITEFFECT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A69F390)
#define RPG_CLIENT_GRIDFIGHTFATEPRAYTRAITEFFECT_REGISTERACTION_OFFSET UNITYSDK_OFFSET(0x1A69FD40)
#define RPG_CLIENT_GRIDFIGHTFATEPRAYTRAITEFFECT_SET_ACTION_OFFSET UNITYSDK_OFFSET(0x1A69FE80)
#define RPG_CLIENT_GRIDFIGHTFATEPRAYTRAITEFFECT_STARTEDIT_OFFSET UNITYSDK_OFFSET(0x1A69FC50)
#define RPG_CLIENT_GRIDFIGHTFATEPRAYTRAITEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A69F320)
#define RPG_CLIENT_GRIDFIGHTFATEPRAYTRAITEFFECT__ONQUESTPROPERTYCHANGEDEVENTHANDLER_OFFSET UNITYSDK_OFFSET(0x1A69FA50)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightFatePrayTraitEffect_TypeDefinitionIndex = 62462;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_E54B123A533AECA8*))((::PBYTE)hIl2Cpp + RPG_CLIENT_GRIDFIGHTFATEPRAYTRAITEFFECT_ONUPDATE_OFFSET))(this, a1);
		}
