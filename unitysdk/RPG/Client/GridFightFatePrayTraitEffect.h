...
#define RPG_CLIENT_GRIDFIGHTFATEPRAYTRAITEFFECT_CANEDITINPREPARATIONSTATE_OFFSET UNITYSDK_OFFSET(0xD18DCB0)
#define RPG_CLIENT_GRIDFIGHTFATEPRAYTRAITEFFECT_CANEDIT_OFFSET UNITYSDK_OFFSET(0xD18DC40)
#define RPG_CLIENT_GRIDFIGHTFATEPRAYTRAITEFFECT_GETEDITICON_OFFSET UNITYSDK_OFFSET(0xD18DE80)
#define RPG_CLIENT_GRIDFIGHTFATEPRAYTRAITEFFECT_GET_ACTION_OFFSET UNITYSDK_OFFSET(0xD18DF60)
#define RPG_CLIENT_GRIDFIGHTFATEPRAYTRAITEFFECT_GET_COMPLETEDQUESTCOUNT_OFFSET UNITYSDK_OFFSET(0xD18DF90)
#define RPG_CLIENT_GRIDFIGHTFATEPRAYTRAITEFFECT_GET_INPENDING_OFFSET UNITYSDK_OFFSET(0xD18DF00)
#define RPG_CLIENT_GRIDFIGHTFATEPRAYTRAITEFFECT_GET_SELECTEDQUESTS_OFFSET UNITYSDK_OFFSET(0xD18DF80)
#define RPG_CLIENT_GRIDFIGHTFATEPRAYTRAITEFFECT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xD18D480)
#define RPG_CLIENT_GRIDFIGHTFATEPRAYTRAITEFFECT_REGISTERACTION_OFFSET UNITYSDK_OFFSET(0xD18DE30)
#define RPG_CLIENT_GRIDFIGHTFATEPRAYTRAITEFFECT_SET_ACTION_OFFSET UNITYSDK_OFFSET(0xD18DF70)
#define RPG_CLIENT_GRIDFIGHTFATEPRAYTRAITEFFECT_STARTEDIT_OFFSET UNITYSDK_OFFSET(0xD18DD40)
#define RPG_CLIENT_GRIDFIGHTFATEPRAYTRAITEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xD18D410)
#define RPG_CLIENT_GRIDFIGHTFATEPRAYTRAITEFFECT__ONQUESTPROPERTYCHANGEDEVENTHANDLER_OFFSET UNITYSDK_OFFSET(0xD18DB40)
