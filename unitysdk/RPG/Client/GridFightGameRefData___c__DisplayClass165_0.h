...
#define RPG_CLIENT_GRIDFIGHTGAMEREFDATA___C__DISPLAYCLASS165_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABEFA70)
#define RPG_CLIENT_GRIDFIGHTGAMEREFDATA___C__DISPLAYCLASS165_0___COLLECTEQUIPSANDTRAIT_B__0_OFFSET UNITYSDK_OFFSET(0x1ABF4D40)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightGameRefData___c__DisplayClass165_0_TypeDefinitionIndex = 61807;

	class GridFightGameRefData___c__DisplayClass165_0 : public ::System::Object
	{
	public:
		::RPG::Client::GridFightGameRefData* __4__this; // 0x10
		::System::Collections::Generic::List_1<::Class_1_50210DAEB46E0CD5*>* rules; // 0x18
