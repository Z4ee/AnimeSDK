...
#define RPG_CLIENT_LOOKATTARGETDATA_CLEARDISABLED_OFFSET UNITYSDK_OFFSET(0x38F45B0)
#define RPG_CLIENT_LOOKATTARGETDATA_COPYFROM_1_OFFSET UNITYSDK_OFFSET(0x38F4260)
#define RPG_CLIENT_LOOKATTARGETDATA_COPYFROM_OFFSET UNITYSDK_OFFSET(0x38F4250)
#define RPG_CLIENT_LOOKATTARGETDATA_COPYTO_OFFSET UNITYSDK_OFFSET(0x38F4240)
#define RPG_CLIENT_LOOKATTARGETDATA_GET_DEFAULTLOOKATPOS_OFFSET UNITYSDK_OFFSET(0x38F48B0)
#define RPG_CLIENT_LOOKATTARGETDATA_GET_DISABLEDCAUSE_OFFSET UNITYSDK_OFFSET(0x38F4940)
#define RPG_CLIENT_LOOKATTARGETDATA_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x38F48D0)
#define RPG_CLIENT_LOOKATTARGETDATA_GET_FORCECHANGETARGETTHISFRAME_OFFSET UNITYSDK_OFFSET(0x167D30)
#define RPG_CLIENT_LOOKATTARGETDATA_GET_LOOKATPOS_OFFSET UNITYSDK_OFFSET(0x38F47F0)
#define RPG_CLIENT_LOOKATTARGETDATA_GET_TARGETDISTANCE_OFFSET UNITYSDK_OFFSET(0x38F4360)
#define RPG_CLIENT_LOOKATTARGETDATA_GET_TARGETPOS_OFFSET UNITYSDK_OFFSET(0x38F4340)
#define RPG_CLIENT_LOOKATTARGETDATA_ISNEARLYLOOKAT_OFFSET UNITYSDK_OFFSET(0x38F4950)
#define RPG_CLIENT_LOOKATTARGETDATA_LERPTARGET_OFFSET UNITYSDK_OFFSET(0x38F4540)
#define RPG_CLIENT_LOOKATTARGETDATA_MOVETARGET_OFFSET UNITYSDK_OFFSET(0x38F44C0)
#define RPG_CLIENT_LOOKATTARGETDATA_SETDISABLED_OFFSET UNITYSDK_OFFSET(0x38F4560)
#define RPG_CLIENT_LOOKATTARGETDATA_SETTARGET_OFFSET UNITYSDK_OFFSET(0x38F43E0)
#define RPG_CLIENT_LOOKATTARGETDATA_SET_ENABLED_OFFSET UNITYSDK_OFFSET(0x38F4930)
#define RPG_CLIENT_LOOKATTARGETDATA_SET_FORCECHANGETARGETTHISFRAME_OFFSET UNITYSDK_OFFSET(0x167B90)
#define RPG_CLIENT_LOOKATTARGETDATA_TICK_OFFSET UNITYSDK_OFFSET(0x38F4550)
#define RPG_CLIENT_LOOKATTARGETDATA_UPDATETARGET_OFFSET UNITYSDK_OFFSET(0x38F4410)
#define RPG_CLIENT_LOOKATTARGETDATA__ALPHAFROMSLERPSPEED_OFFSET UNITYSDK_OFFSET(0x38F4600)
#define RPG_CLIENT_LOOKATTARGETDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x38F4190)
#define RPG_CLIENT_LOOKATTARGETDATA__SETLOOKATPOSLOCAL_OFFSET UNITYSDK_OFFSET(0x38F4720)

namespace RPG::Client
{
	inline static constexpr unsigned int LookAtTargetData_TypeDefinitionIndex = 65428;
