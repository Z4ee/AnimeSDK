...
#define RPG_CLIENT_PLANETFESAVATAREFFECT_DESPAWNED_OFFSET UNITYSDK_OFFSET(0x9F82270)
#define RPG_CLIENT_PLANETFESAVATAREFFECT_ONCREATE_OFFSET UNITYSDK_OFFSET(0x9F822B0)
#define RPG_CLIENT_PLANETFESAVATAREFFECT_PLAY_OFFSET UNITYSDK_OFFSET(0x9F82450)
#define RPG_CLIENT_PLANETFESAVATAREFFECT_SETBASECANVAS_OFFSET UNITYSDK_OFFSET(0x9F823D0)
#define RPG_CLIENT_PLANETFESAVATAREFFECT_SETPOSITION_OFFSET UNITYSDK_OFFSET(0x9F82340)
#define RPG_CLIENT_PLANETFESAVATAREFFECT_SPAWNED_OFFSET UNITYSDK_OFFSET(0x9F82230)
#define RPG_CLIENT_PLANETFESAVATAREFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x9F82580)

namespace RPG::Client
{
	inline static constexpr unsigned int PlanetFesAvatarEffect_TypeDefinitionIndex = 54068;
