...
#define RPG_CLIENT_PLANETFESAVATAREFFECT_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xDB34090)
#define RPG_CLIENT_PLANETFESAVATAREFFECT_ONCREATE_OFFSET UNITYSDK_OFFSET(0xDB340D0)
#define RPG_CLIENT_PLANETFESAVATAREFFECT_PLAY_OFFSET UNITYSDK_OFFSET(0xDB34270)
#define RPG_CLIENT_PLANETFESAVATAREFFECT_SETBASECANVAS_OFFSET UNITYSDK_OFFSET(0xDB341F0)
#define RPG_CLIENT_PLANETFESAVATAREFFECT_SETPOSITION_OFFSET UNITYSDK_OFFSET(0xDB34160)
#define RPG_CLIENT_PLANETFESAVATAREFFECT_SPAWNED_OFFSET UNITYSDK_OFFSET(0xDB34050)
#define RPG_CLIENT_PLANETFESAVATAREFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xDB34380)
