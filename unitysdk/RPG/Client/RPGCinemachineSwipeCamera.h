...
#define RPG_CLIENT_RPGCINEMACHINESWIPECAMERA_ENABLEUPDATE_OFFSET UNITYSDK_OFFSET(0xAF3FC20)
#define RPG_CLIENT_RPGCINEMACHINESWIPECAMERA_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xAF3FE10)
#define RPG_CLIENT_RPGCINEMACHINESWIPECAMERA_OVERRIDESWIPECONFIG_OFFSET UNITYSDK_OFFSET(0xAF3FCA0)
#define RPG_CLIENT_RPGCINEMACHINESWIPECAMERA_POSTPIPELINESTAGECALLBACK_OFFSET UNITYSDK_OFFSET(0xAF3FE80)
#define RPG_CLIENT_RPGCINEMACHINESWIPECAMERA_START_OFFSET UNITYSDK_OFFSET(0xAF3FD10)
#define RPG_CLIENT_RPGCINEMACHINESWIPECAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0xAF3FF50)
#define RPG_CLIENT_RPGCINEMACHINESWIPECAMERA___IFIXBASEPROXY_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xAF3FF60)

namespace RPG::Client
{
	inline static constexpr unsigned int RPGCinemachineSwipeCamera_TypeDefinitionIndex = 64244;
