...
#define RPG_CLIENT_RPGCINEMACHINESWIPECAMERA_ENABLEUPDATE_OFFSET UNITYSDK_OFFSET(0xA251350)
#define RPG_CLIENT_RPGCINEMACHINESWIPECAMERA_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xA251540)
#define RPG_CLIENT_RPGCINEMACHINESWIPECAMERA_OVERRIDESWIPECONFIG_OFFSET UNITYSDK_OFFSET(0xA2513D0)
#define RPG_CLIENT_RPGCINEMACHINESWIPECAMERA_POSTPIPELINESTAGECALLBACK_OFFSET UNITYSDK_OFFSET(0xA2515B0)
#define RPG_CLIENT_RPGCINEMACHINESWIPECAMERA_START_OFFSET UNITYSDK_OFFSET(0xA251440)
#define RPG_CLIENT_RPGCINEMACHINESWIPECAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0xA251680)
#define RPG_CLIENT_RPGCINEMACHINESWIPECAMERA___IFIXBASEPROXY_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xA251690)

namespace RPG::Client
{
	inline static constexpr unsigned int RPGCinemachineSwipeCamera_TypeDefinitionIndex = 56994;
