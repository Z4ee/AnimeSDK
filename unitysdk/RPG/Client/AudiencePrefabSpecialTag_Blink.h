...
#define RPG_CLIENT_AUDIENCEPREFABSPECIALTAG_BLINK_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xB342350)
#define RPG_CLIENT_AUDIENCEPREFABSPECIALTAG_BLINK__CTOR_OFFSET UNITYSDK_OFFSET(0xB342360)

namespace RPG::Client
{
	inline static constexpr unsigned int AudiencePrefabSpecialTag_Blink_TypeDefinitionIndex = 64651;
