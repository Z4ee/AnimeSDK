...
#define RPG_CLIENT_CHIMERAGALLERYACTDATA_GET_ICON_OFFSET UNITYSDK_OFFSET(0xCBFB810)
#define RPG_CLIENT_CHIMERAGALLERYACTDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0xCBFB6E0)
#define RPG_CLIENT_CHIMERAGALLERYACTDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xCBFB750)
#define RPG_CLIENT_CHIMERAGALLERYACTDATA_GET_SORT_OFFSET UNITYSDK_OFFSET(0xCBFB8B0)
#define RPG_CLIENT_CHIMERAGALLERYACTDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xCBFB6F0)
#define RPG_CLIENT_CHIMERAGALLERYACTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCBFB950)
