...
#define RPG_CLIENT_GRIDFIGHTPRAYQUESTCHANGECOLLECTOR_GET_PRAYQUESTUPDATED_OFFSET UNITYSDK_OFFSET(0x1CA5B100)
#define RPG_CLIENT_GRIDFIGHTPRAYQUESTCHANGECOLLECTOR_ONCOLLECTIONCHANGEDEVENTHANDLER_OFFSET UNITYSDK_OFFSET(0x1CA5B0A0)
#define RPG_CLIENT_GRIDFIGHTPRAYQUESTCHANGECOLLECTOR_ONPROPERTYCHANGEDEVENTHANDLER_OFFSET UNITYSDK_OFFSET(0x1CA5B040)
#define RPG_CLIENT_GRIDFIGHTPRAYQUESTCHANGECOLLECTOR_RESET_OFFSET UNITYSDK_OFFSET(0x1CA5B000)
#define RPG_CLIENT_GRIDFIGHTPRAYQUESTCHANGECOLLECTOR_SET_PRAYQUESTUPDATED_OFFSET UNITYSDK_OFFSET(0x1CA5B110)
#define RPG_CLIENT_GRIDFIGHTPRAYQUESTCHANGECOLLECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1CA5B120)
