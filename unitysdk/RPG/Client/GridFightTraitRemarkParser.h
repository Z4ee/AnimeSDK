...
#define RPG_CLIENT_GRIDFIGHTTRAITREMARKPARSER_CREATE_OFFSET UNITYSDK_OFFSET(0xD34E150)
#define RPG_CLIENT_GRIDFIGHTTRAITREMARKPARSER_GETBACKSHOWINGLINEPARSERS_OFFSET UNITYSDK_OFFSET(0xD369880)
#define RPG_CLIENT_GRIDFIGHTTRAITREMARKPARSER_GETFRONTSHOWINGLINEPARSERS_OFFSET UNITYSDK_OFFSET(0xD3694A0)
#define RPG_CLIENT_GRIDFIGHTTRAITREMARKPARSER_GET_HASREMARK_OFFSET UNITYSDK_OFFSET(0xD369C30)
#define RPG_CLIENT_GRIDFIGHTTRAITREMARKPARSER_GET_ISSHOWBACK_OFFSET UNITYSDK_OFFSET(0xD369BE0)
#define RPG_CLIENT_GRIDFIGHTTRAITREMARKPARSER_GET_ISSHOWFRONT_OFFSET UNITYSDK_OFFSET(0xD369B90)
#define RPG_CLIENT_GRIDFIGHTTRAITREMARKPARSER_GET__BACKREMARK_OFFSET UNITYSDK_OFFSET(0xD369DA0)
#define RPG_CLIENT_GRIDFIGHTTRAITREMARKPARSER_GET__CURRENTTRAITCONFIG_OFFSET UNITYSDK_OFFSET(0xD3698D0)
#define RPG_CLIENT_GRIDFIGHTTRAITREMARKPARSER_GET__FRONTREMARK_OFFSET UNITYSDK_OFFSET(0xD369D40)
#define RPG_CLIENT_GRIDFIGHTTRAITREMARKPARSER__CTOR_OFFSET UNITYSDK_OFFSET(0xD369490)
#define RPG_CLIENT_GRIDFIGHTTRAITREMARKPARSER__GETSHOWINGLINEPARSERS_OFFSET UNITYSDK_OFFSET(0xD3694F0)
#define RPG_CLIENT_GRIDFIGHTTRAITREMARKPARSER__HASSHOWINGEFFECT_OFFSET UNITYSDK_OFFSET(0xD369980)
