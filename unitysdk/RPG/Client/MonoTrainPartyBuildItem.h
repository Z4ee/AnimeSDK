...
#define RPG_CLIENT_MONOTRAINPARTYBUILDITEM_CONVERTDYNAMICBINDVALUE_1_OFFSET UNITYSDK_OFFSET(0xAA02C70)
#define RPG_CLIENT_MONOTRAINPARTYBUILDITEM_CONVERTDYNAMICBINDVALUE_OFFSET UNITYSDK_OFFSET(0xAA02B30)
#define RPG_CLIENT_MONOTRAINPARTYBUILDITEM_GETUNIQUEKEY_OFFSET UNITYSDK_OFFSET(0xAA029F0)
#define RPG_CLIENT_MONOTRAINPARTYBUILDITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xAA02DC0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoTrainPartyBuildItem_TypeDefinitionIndex = 63509;
