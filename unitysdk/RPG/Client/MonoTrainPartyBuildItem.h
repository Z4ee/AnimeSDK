...
#define RPG_CLIENT_MONOTRAINPARTYBUILDITEM_CONVERTDYNAMICBINDVALUE_1_OFFSET UNITYSDK_OFFSET(0xD86EB50)
#define RPG_CLIENT_MONOTRAINPARTYBUILDITEM_CONVERTDYNAMICBINDVALUE_OFFSET UNITYSDK_OFFSET(0xD86EA00)
#define RPG_CLIENT_MONOTRAINPARTYBUILDITEM_GETUNIQUEKEY_OFFSET UNITYSDK_OFFSET(0xD86E910)
#define RPG_CLIENT_MONOTRAINPARTYBUILDITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xD86ECA0)
