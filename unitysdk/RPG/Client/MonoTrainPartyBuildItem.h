...
#define RPG_CLIENT_MONOTRAINPARTYBUILDITEM_CONVERTDYNAMICBINDVALUE_1_OFFSET UNITYSDK_OFFSET(0x9D3FA90)
#define RPG_CLIENT_MONOTRAINPARTYBUILDITEM_CONVERTDYNAMICBINDVALUE_OFFSET UNITYSDK_OFFSET(0x9D3F950)
#define RPG_CLIENT_MONOTRAINPARTYBUILDITEM_GETUNIQUEKEY_OFFSET UNITYSDK_OFFSET(0x9D3F810)
#define RPG_CLIENT_MONOTRAINPARTYBUILDITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x9D3FBE0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoTrainPartyBuildItem_TypeDefinitionIndex = 56266;
