...
#define RPG_CLIENT_DYNAMICTRAILMODULE_CLASS_1_2FD11D119AC15752_METHOD_1_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0xCDB6080)
#define RPG_CLIENT_DYNAMICTRAILMODULE_CLASS_1_2FD11D119AC15752_METHOD_1_FFBA317F4D1B70EB_OFFSET UNITYSDK_OFFSET(0xCDB5730)
#define RPG_CLIENT_DYNAMICTRAILMODULE_CLASS_1_2FD11D119AC15752__CTOR_OFFSET UNITYSDK_OFFSET(0xCDB5150)
...
namespace RPG::Client
{
	...
	{
	public:
		::RPG::Client::DynamicTrailModule_Class_1_7EE1B066A3FF5E80* EBJKJAGJGPK; // 0x10
		::RPG::Client::DynamicTrailModule_Class_1_7EE1B066A3FF5E80* GAOAMKBNDPN; // 0x18
