...
#define RPG_CLIENT_GRIDFIGHTTRAITREMARKLINEHIDETOGREYEFFECT_GET_CURRENTCOLORTYPE_OFFSET UNITYSDK_OFFSET(0x1BB10F40)
#define RPG_CLIENT_GRIDFIGHTTRAITREMARKLINEHIDETOGREYEFFECT_GET_ISHIGHLIGHT_OFFSET UNITYSDK_OFFSET(0x1BB10F00)
#define RPG_CLIENT_GRIDFIGHTTRAITREMARKLINEHIDETOGREYEFFECT_GET_ISSHOW_OFFSET UNITYSDK_OFFSET(0x1BB10DB0)
#define RPG_CLIENT_GRIDFIGHTTRAITREMARKLINEHIDETOGREYEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB0F810)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightTraitRemarkLineHideToGreyEffect_TypeDefinitionIndex = 65536;
