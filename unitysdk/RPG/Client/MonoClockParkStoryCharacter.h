...
#define RPG_CLIENT_MONOCLOCKPARKSTORYCHARACTER_AWAKE_OFFSET UNITYSDK_OFFSET(0x19E33850)
#define RPG_CLIENT_MONOCLOCKPARKSTORYCHARACTER_GETCURRENTANIMINFO_OFFSET UNITYSDK_OFFSET(0x19E33BE0)
#define RPG_CLIENT_MONOCLOCKPARKSTORYCHARACTER_GET_FLIPPED_OFFSET UNITYSDK_OFFSET(0x19E33AC0)
#define RPG_CLIENT_MONOCLOCKPARKSTORYCHARACTER_GET_GRAPHIC_OFFSET UNITYSDK_OFFSET(0x19E33C90)
#define RPG_CLIENT_MONOCLOCKPARKSTORYCHARACTER_GET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x19E33C70)
#define RPG_CLIENT_MONOCLOCKPARKSTORYCHARACTER_GET_UNIQUENAME_OFFSET UNITYSDK_OFFSET(0x19E33C50)
#define RPG_CLIENT_MONOCLOCKPARKSTORYCHARACTER_INIT_OFFSET UNITYSDK_OFFSET(0x19E33970)
#define RPG_CLIENT_MONOCLOCKPARKSTORYCHARACTER_PLAYANIMTOLOOP_OFFSET UNITYSDK_OFFSET(0x19E33B80)
#define RPG_CLIENT_MONOCLOCKPARKSTORYCHARACTER_PLAYANIM_OFFSET UNITYSDK_OFFSET(0x19E33B20)
#define RPG_CLIENT_MONOCLOCKPARKSTORYCHARACTER_SET_GRAPHIC_OFFSET UNITYSDK_OFFSET(0x19E33CA0)
#define RPG_CLIENT_MONOCLOCKPARKSTORYCHARACTER_SET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x19E33C80)
#define RPG_CLIENT_MONOCLOCKPARKSTORYCHARACTER_SET_UNIQUENAME_OFFSET UNITYSDK_OFFSET(0x19E33C60)
#define RPG_CLIENT_MONOCLOCKPARKSTORYCHARACTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19E33CB0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoClockParkStoryCharacter_TypeDefinitionIndex = 60398;
	...
	public:
		...
		::System::Boolean BHDMADCAIJF; // 0x30
		::System::Boolean LPHJDGLDDAI; // 0x31
		::Class_1_C1DC709EFDF25E3D* NGCHOMCMKPI; // 0x38
