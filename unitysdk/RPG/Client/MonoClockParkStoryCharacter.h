...
#define RPG_CLIENT_MONOCLOCKPARKSTORYCHARACTER_AWAKE_OFFSET UNITYSDK_OFFSET(0xD7393C0)
#define RPG_CLIENT_MONOCLOCKPARKSTORYCHARACTER_GETCURRENTANIMINFO_OFFSET UNITYSDK_OFFSET(0xD739750)
#define RPG_CLIENT_MONOCLOCKPARKSTORYCHARACTER_GET_FLIPPED_OFFSET UNITYSDK_OFFSET(0xD739630)
#define RPG_CLIENT_MONOCLOCKPARKSTORYCHARACTER_GET_GRAPHIC_OFFSET UNITYSDK_OFFSET(0xD739800)
#define RPG_CLIENT_MONOCLOCKPARKSTORYCHARACTER_GET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0xD7397E0)
#define RPG_CLIENT_MONOCLOCKPARKSTORYCHARACTER_GET_UNIQUENAME_OFFSET UNITYSDK_OFFSET(0xD7397C0)
#define RPG_CLIENT_MONOCLOCKPARKSTORYCHARACTER_INIT_OFFSET UNITYSDK_OFFSET(0xD7394E0)
#define RPG_CLIENT_MONOCLOCKPARKSTORYCHARACTER_PLAYANIMTOLOOP_OFFSET UNITYSDK_OFFSET(0xD7396F0)
#define RPG_CLIENT_MONOCLOCKPARKSTORYCHARACTER_PLAYANIM_OFFSET UNITYSDK_OFFSET(0xD739690)
#define RPG_CLIENT_MONOCLOCKPARKSTORYCHARACTER_SET_GRAPHIC_OFFSET UNITYSDK_OFFSET(0xD739810)
#define RPG_CLIENT_MONOCLOCKPARKSTORYCHARACTER_SET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0xD7397F0)
#define RPG_CLIENT_MONOCLOCKPARKSTORYCHARACTER_SET_UNIQUENAME_OFFSET UNITYSDK_OFFSET(0xD7397D0)
#define RPG_CLIENT_MONOCLOCKPARKSTORYCHARACTER__CTOR_OFFSET UNITYSDK_OFFSET(0xD739820)
