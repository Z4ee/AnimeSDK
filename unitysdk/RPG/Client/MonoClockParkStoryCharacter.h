...
#define RPG_CLIENT_MONOCLOCKPARKSTORYCHARACTER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1807EB60)
#define RPG_CLIENT_MONOCLOCKPARKSTORYCHARACTER_GETCURRENTANIMINFO_OFFSET UNITYSDK_OFFSET(0x1807EEF0)
#define RPG_CLIENT_MONOCLOCKPARKSTORYCHARACTER_GET_FLIPPED_OFFSET UNITYSDK_OFFSET(0x1807EDD0)
#define RPG_CLIENT_MONOCLOCKPARKSTORYCHARACTER_GET_GRAPHIC_OFFSET UNITYSDK_OFFSET(0x1807EFA0)
#define RPG_CLIENT_MONOCLOCKPARKSTORYCHARACTER_GET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x1807EF80)
#define RPG_CLIENT_MONOCLOCKPARKSTORYCHARACTER_GET_UNIQUENAME_OFFSET UNITYSDK_OFFSET(0x1807EF60)
#define RPG_CLIENT_MONOCLOCKPARKSTORYCHARACTER_INIT_OFFSET UNITYSDK_OFFSET(0x1807EC80)
#define RPG_CLIENT_MONOCLOCKPARKSTORYCHARACTER_PLAYANIMTOLOOP_OFFSET UNITYSDK_OFFSET(0x1807EE90)
#define RPG_CLIENT_MONOCLOCKPARKSTORYCHARACTER_PLAYANIM_OFFSET UNITYSDK_OFFSET(0x1807EE30)
#define RPG_CLIENT_MONOCLOCKPARKSTORYCHARACTER_SET_GRAPHIC_OFFSET UNITYSDK_OFFSET(0x1807EFB0)
#define RPG_CLIENT_MONOCLOCKPARKSTORYCHARACTER_SET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x1807EF90)
#define RPG_CLIENT_MONOCLOCKPARKSTORYCHARACTER_SET_UNIQUENAME_OFFSET UNITYSDK_OFFSET(0x1807EF70)
#define RPG_CLIENT_MONOCLOCKPARKSTORYCHARACTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1807EFC0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoClockParkStoryCharacter_TypeDefinitionIndex = 57581;
