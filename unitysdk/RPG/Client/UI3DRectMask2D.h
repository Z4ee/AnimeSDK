...
#define RPG_CLIENT_UI3DRECTMASK2D_METHOD_5_092CD57850778EFC_1_OFFSET UNITYSDK_OFFSET(0xCB19760)
#define RPG_CLIENT_UI3DRECTMASK2D_METHOD_5_092CD57850778EFC_OFFSET UNITYSDK_OFFSET(0xCB19530)
#define RPG_CLIENT_UI3DRECTMASK2D_METHOD_5_907E24F785836BA0_OFFSET UNITYSDK_OFFSET(0xCB18CD0)
#define RPG_CLIENT_UI3DRECTMASK2D_METHOD_5_AA169839CB93802A_OFFSET UNITYSDK_OFFSET(0xCB18EC0)
#define RPG_CLIENT_UI3DRECTMASK2D_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xCB19A80)
#define RPG_CLIENT_UI3DRECTMASK2D_ONENABLE_OFFSET UNITYSDK_OFFSET(0xCB199D0)
#define RPG_CLIENT_UI3DRECTMASK2D_START_OFFSET UNITYSDK_OFFSET(0xCB19980)
#define RPG_CLIENT_UI3DRECTMASK2D_UPDATE_OFFSET UNITYSDK_OFFSET(0xCB19A30)
#define RPG_CLIENT_UI3DRECTMASK2D__CTOR_OFFSET UNITYSDK_OFFSET(0xCB19AD0)

namespace RPG::Client
{
	inline static constexpr unsigned int UI3DRectMask2D_TypeDefinitionIndex = 66412;
