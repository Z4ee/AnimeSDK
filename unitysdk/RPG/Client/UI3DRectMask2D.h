...
#define RPG_CLIENT_UI3DRECTMASK2D_METHOD_5_092CD57850778EFC_1_OFFSET UNITYSDK_OFFSET(0x16FF82E0)
#define RPG_CLIENT_UI3DRECTMASK2D_METHOD_5_092CD57850778EFC_OFFSET UNITYSDK_OFFSET(0x16FF80B0)
#define RPG_CLIENT_UI3DRECTMASK2D_METHOD_5_907E24F785836BA0_OFFSET UNITYSDK_OFFSET(0x16FF7850)
#define RPG_CLIENT_UI3DRECTMASK2D_METHOD_5_AA169839CB93802A_OFFSET UNITYSDK_OFFSET(0x16FF7A40)
#define RPG_CLIENT_UI3DRECTMASK2D_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x16FF8600)
#define RPG_CLIENT_UI3DRECTMASK2D_ONENABLE_OFFSET UNITYSDK_OFFSET(0x16FF8550)
#define RPG_CLIENT_UI3DRECTMASK2D_START_OFFSET UNITYSDK_OFFSET(0x16FF8500)
#define RPG_CLIENT_UI3DRECTMASK2D_UPDATE_OFFSET UNITYSDK_OFFSET(0x16FF85B0)
#define RPG_CLIENT_UI3DRECTMASK2D__CTOR_OFFSET UNITYSDK_OFFSET(0x16FF8650)

namespace RPG::Client
{
	inline static constexpr unsigned int UI3DRectMask2D_TypeDefinitionIndex = 67848;
