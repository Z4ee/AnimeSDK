...
#define RPG_CLIENT_MONSTERGUIDESKILLDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0xD8BD690)
#define RPG_CLIENT_MONSTERGUIDESKILLDATA_GET_ROW_OFFSET UNITYSDK_OFFSET(0xD8BD6D0)
#define RPG_CLIENT_MONSTERGUIDESKILLDATA_GET_SKILLTEXTLIST_OFFSET UNITYSDK_OFFSET(0xD8BD6B0)
#define RPG_CLIENT_MONSTERGUIDESKILLDATA_SET_ID_OFFSET UNITYSDK_OFFSET(0xD8BD6A0)
#define RPG_CLIENT_MONSTERGUIDESKILLDATA_SET_ROW_OFFSET UNITYSDK_OFFSET(0xD8BD6E0)
#define RPG_CLIENT_MONSTERGUIDESKILLDATA_SET_SKILLTEXTLIST_OFFSET UNITYSDK_OFFSET(0xD8BD6C0)
#define RPG_CLIENT_MONSTERGUIDESKILLDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD8BD5F0)
#define RPG_CLIENT_MONSTERGUIDESKILLDATA__INITSKILLTEXT_OFFSET UNITYSDK_OFFSET(0xD8BD6F0)
