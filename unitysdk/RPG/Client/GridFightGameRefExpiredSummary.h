...
#define RPG_CLIENT_GRIDFIGHTGAMEREFEXPIREDSUMMARY_GET_DELETEDEXPIREDROLES_OFFSET UNITYSDK_OFFSET(0xD1D18B0)
#define RPG_CLIENT_GRIDFIGHTGAMEREFEXPIREDSUMMARY_GET_DELETEDSECONDARYEXPIREDROLES_OFFSET UNITYSDK_OFFSET(0xD1D1B70)
#define RPG_CLIENT_GRIDFIGHTGAMEREFEXPIREDSUMMARY_GET_HASEXPIRED_OFFSET UNITYSDK_OFFSET(0xD1D1CF0)
#define RPG_CLIENT_GRIDFIGHTGAMEREFEXPIREDSUMMARY_GET_HASMAINCHANGE_OFFSET UNITYSDK_OFFSET(0xD1D1DA0)
#define RPG_CLIENT_GRIDFIGHTGAMEREFEXPIREDSUMMARY_GET_HASOTHERCHANGE_OFFSET UNITYSDK_OFFSET(0xD1D1E10)
#define RPG_CLIENT_GRIDFIGHTGAMEREFEXPIREDSUMMARY_GET_ISTOTALEXPIRED_OFFSET UNITYSDK_OFFSET(0xD1D1CD0)
#define RPG_CLIENT_GRIDFIGHTGAMEREFEXPIREDSUMMARY_GET_POSEXPIREDROLES_OFFSET UNITYSDK_OFFSET(0xD1D1750)
#define RPG_CLIENT_GRIDFIGHTGAMEREFEXPIREDSUMMARY_GET_RARITYEXPIREDROLES_OFFSET UNITYSDK_OFFSET(0xD1D15F0)
#define RPG_CLIENT_GRIDFIGHTGAMEREFEXPIREDSUMMARY_GET_RARITYSECONDARYEXPIREDROLES_OFFSET UNITYSDK_OFFSET(0xD1D1A10)
#define RPG_CLIENT_GRIDFIGHTGAMEREFEXPIREDSUMMARY_SET_ISTOTALEXPIRED_OFFSET UNITYSDK_OFFSET(0xD1D1CE0)
#define RPG_CLIENT_GRIDFIGHTGAMEREFEXPIREDSUMMARY__CTOR_1_OFFSET UNITYSDK_OFFSET(0xD1D1EC0)
#define RPG_CLIENT_GRIDFIGHTGAMEREFEXPIREDSUMMARY__CTOR_OFFSET UNITYSDK_OFFSET(0xD1C6EA0)
...
namespace RPG::Client
{
	...
	{
	public:
		::System::Collections::Generic::List_1<::RPG::Client::GridFightSeasonRole*>* ExpiredRoles; // 0x10
		...
		::System::Collections::Generic::List_1<::RPG::Client::GridFightAugment*>* ExpiredAugments; // 0x28
