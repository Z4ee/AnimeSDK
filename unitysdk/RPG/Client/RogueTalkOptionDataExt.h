...
#define RPG_CLIENT_ROGUETALKOPTIONDATAEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xA363FB0)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueTalkOptionDataExt_TypeDefinitionIndex = 55533;
	...
	public:
		...
		::System::Int32 DescIntParam; // 0x2C
		::System::Int32 DescParam2; // 0x30
		::System::Single DescRatioParam; // 0x34
		::System::Boolean HasEffectNousValueChange; // 0x38
		::System::UInt32 DisplayID; // 0x3C
		::System::Int32 DescParam4; // 0x40
		::System::Int32 DescCostParam; // 0x44
		::System::UInt32 RogueOptionID; // 0x48
		::System::Int32 DescParam3; // 0x4C
		::System::Int32 EffectNousValueChangeDelta; // 0x50
