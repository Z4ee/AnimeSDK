...
#define RPG_CLIENT_TRANSFERUTILS_TRANSFERCHECK_OFFSET UNITYSDK_OFFSET(0x1B2A80D0)

namespace RPG::Client
{
	inline static constexpr unsigned int TransferUtils_TypeDefinitionIndex = 68169;
