...
#define RPG_CLIENT_REDDOT_REDDOTCONTROL__BINDING_OFFSET UNITYSDK_OFFSET(0x1B655720)
#define RPG_CLIENT_REDDOT_REDDOTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B655E00)

namespace RPG::Client::RedDot
{
	inline static constexpr unsigned int RedDotControl_TypeDefinitionIndex = 78701;
