...
#define RPG_CLIENT_RPGQUALITYSETTINGSPRESET__CTOR_OFFSET UNITYSDK_OFFSET(0xAF50610)

namespace RPG::Client
{
	inline static constexpr unsigned int RPGQualitySettingsPreset_TypeDefinitionIndex = 62632;
