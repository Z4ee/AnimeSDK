...
#define RPG_CLIENT_RPGQUALITYSETTINGSPRESET__CTOR_OFFSET UNITYSDK_OFFSET(0xA261BF0)

namespace RPG::Client
{
	inline static constexpr unsigned int RPGQualitySettingsPreset_TypeDefinitionIndex = 55441;
