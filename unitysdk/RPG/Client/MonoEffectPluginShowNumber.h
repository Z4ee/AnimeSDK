...
#define RPG_CLIENT_MONOEFFECTPLUGINSHOWNUMBER_DISPOSEPLUGIN_OFFSET UNITYSDK_OFFSET(0xA9A0580)
#define RPG_CLIENT_MONOEFFECTPLUGINSHOWNUMBER_METHOD_6_86889F095D50CF32_OFFSET UNITYSDK_OFFSET(0xA9A0230)
#define RPG_CLIENT_MONOEFFECTPLUGINSHOWNUMBER_METHOD_6_EA672F77F1086A27_OFFSET UNITYSDK_OFFSET(0xA9A06F0)
#define RPG_CLIENT_MONOEFFECTPLUGINSHOWNUMBER_RESETPLUGIN_OFFSET UNITYSDK_OFFSET(0xA99F970)
#define RPG_CLIENT_MONOEFFECTPLUGINSHOWNUMBER__CTOR_OFFSET UNITYSDK_OFFSET(0xA9A0770)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginShowNumber_TypeDefinitionIndex = 64634;
