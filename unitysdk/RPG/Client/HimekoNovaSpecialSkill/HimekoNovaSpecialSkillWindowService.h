...
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLWINDOWSERVICE_OPENDISPLAYWINDOW_1_OFFSET UNITYSDK_OFFSET(0xD3DA440)
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLWINDOWSERVICE_OPENDISPLAYWINDOW_OFFSET UNITYSDK_OFFSET(0xD3DA230)
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLWINDOWSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0xD3DA4C0)

namespace RPG::Client::HimekoNovaSpecialSkill
{
	inline static constexpr unsigned int HimekoNovaSpecialSkillWindowService_TypeDefinitionIndex = 79162;
