...
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLWINDOWSERVICE_OPENDISPLAYWINDOW_1_OFFSET UNITYSDK_OFFSET(0x17958C40)
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLWINDOWSERVICE_OPENDISPLAYWINDOW_OFFSET UNITYSDK_OFFSET(0x17958A00)
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLWINDOWSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x17958CC0)

namespace RPG::Client::HimekoNovaSpecialSkill
{
	inline static constexpr unsigned int HimekoNovaSpecialSkillWindowService_TypeDefinitionIndex = 75551;
