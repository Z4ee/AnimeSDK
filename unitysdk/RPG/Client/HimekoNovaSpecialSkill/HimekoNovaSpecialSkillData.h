...
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLDATA_GETDISPLAYSKILLNAME_OFFSET UNITYSDK_OFFSET(0x19819CE0)
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLDATA_GETMAINSKILLNAME_OFFSET UNITYSDK_OFFSET(0x1981A010)
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLDATA_GETSKILLICON_OFFSET UNITYSDK_OFFSET(0x19819E90)
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLDATA_GETSKILLROWDATA_OFFSET UNITYSDK_OFFSET(0x19819CA0)
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLDATA_GET_AVATARIDS_OFFSET UNITYSDK_OFFSET(0x19819C30)
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0x19819BF0)
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLDATA_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x19819C20)
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLDATA_GET_SIMPLIFIEDAVATARIDS_OFFSET UNITYSDK_OFFSET(0x19819C40)
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLDATA_GET_SKILLID_OFFSET UNITYSDK_OFFSET(0x19819C00)
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLDATA_GET_SKILLNAME_OFFSET UNITYSDK_OFFSET(0x19819C10)
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLDATA_GET_SKILLROWDATA_OFFSET UNITYSDK_OFFSET(0x19819C50)
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLDATA_LOADALL_OFFSET UNITYSDK_OFFSET(0x1981A190)
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19819C60)
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLDATA__RESOLVEAVATARIDS_OFFSET UNITYSDK_OFFSET(0x1981A870)

namespace RPG::Client::HimekoNovaSpecialSkill
{
	inline static constexpr unsigned int HimekoNovaSpecialSkillData_TypeDefinitionIndex = 79159;

	class HimekoNovaSpecialSkillData : public ::System::Object
	{
	public:
		// static const ::System::UInt32 FixedDisplaySkillID = 0x24DEE; // 0x0
		::System::Collections::Generic::IReadOnlyList_1<::System::UInt32>* _SimplifiedAvatarIDs_k__BackingField; // 0x10
		::System::Collections::Generic::IReadOnlyList_1<::System::UInt32>* _AvatarIDs_k__BackingField; // 0x18
