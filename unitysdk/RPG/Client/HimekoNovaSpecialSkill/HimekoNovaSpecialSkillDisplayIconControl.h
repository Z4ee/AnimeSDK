...
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLDISPLAYICONCONTROL_GET_TYPEDDATACONTEXT_OFFSET UNITYSDK_OFFSET(0x1981AAA0)
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLDISPLAYICONCONTROL_SET_TYPEDDATACONTEXT_OFFSET UNITYSDK_OFFSET(0x1981AB50)
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLDISPLAYICONCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1981AE90)
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLDISPLAYICONCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1981AC10)
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLDISPLAYICONCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1981ABA0)

namespace RPG::Client::HimekoNovaSpecialSkill
{
	inline static constexpr unsigned int HimekoNovaSpecialSkillDisplayIconControl_TypeDefinitionIndex = 79164;
