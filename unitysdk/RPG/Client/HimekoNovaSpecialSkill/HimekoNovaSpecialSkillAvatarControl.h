...
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLAVATARCONTROL_GET_ISSHOWHINT_OFFSET UNITYSDK_OFFSET(0x1794DDB0)
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLAVATARCONTROL_GET_TYPEDDATACONTEXT_OFFSET UNITYSDK_OFFSET(0x1794DC60)
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLAVATARCONTROL_SET_ISSHOWHINT_OFFSET UNITYSDK_OFFSET(0x1794DDF0)
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLAVATARCONTROL_SET_TYPEDDATACONTEXT_OFFSET UNITYSDK_OFFSET(0x1794DD40)
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLAVATARCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1794E6A0)
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLAVATARCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1794DE50)
#define RPG_CLIENT_HIMEKONOVASPECIALSKILL_HIMEKONOVASPECIALSKILLAVATARCONTROL__ONCLICKOUTSIDE_OFFSET UNITYSDK_OFFSET(0x1794E590)

namespace RPG::Client::HimekoNovaSpecialSkill
{
	inline static constexpr unsigned int HimekoNovaSpecialSkillAvatarControl_TypeDefinitionIndex = 75552;
