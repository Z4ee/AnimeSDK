...
#define RPG_CLIENT_CHALLENGESETTLERESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x39CF770)

namespace RPG::Client
{
	inline static constexpr unsigned int ChallengeSettleResult_TypeDefinitionIndex = 60317;
