...
#define RPG_CLIENT_CHALLENGESETTLERESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x138480)

namespace RPG::Client
{
	inline static constexpr unsigned int ChallengeSettleResult_TypeDefinitionIndex = 59046;
