...
#define RPG_CLIENT_MONOEMOBLENDSHAPESCONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0x19149450)
#define RPG_CLIENT_MONOEMOBLENDSHAPESCONTROLLER_GETBLENDSHAPECONFIGNAMES_OFFSET UNITYSDK_OFFSET(0x19147040)
#define RPG_CLIENT_MONOEMOBLENDSHAPESCONTROLLER_GETBLENDSHAPEDEFAULTVALUE_OFFSET UNITYSDK_OFFSET(0x19147640)
#define RPG_CLIENT_MONOEMOBLENDSHAPESCONTROLLER_GETBLENDSHAPEINDEXBYNAME_OFFSET UNITYSDK_OFFSET(0x191475A0)
#define RPG_CLIENT_MONOEMOBLENDSHAPESCONTROLLER_GETBLENDSHAPEVALUE_OFFSET UNITYSDK_OFFSET(0x191468A0)
#define RPG_CLIENT_MONOEMOBLENDSHAPESCONTROLLER_GET_BLENDSHAPENAMES_OFFSET UNITYSDK_OFFSET(0x19147160)
#define RPG_CLIENT_MONOEMOBLENDSHAPESCONTROLLER_GET_BLINK_OFFSET UNITYSDK_OFFSET(0x191471D0)
#define RPG_CLIENT_MONOEMOBLENDSHAPESCONTROLLER_GET_CACHEDBLENDSHAPECOUNT_OFFSET UNITYSDK_OFFSET(0x19146FE0)
#define RPG_CLIENT_MONOEMOBLENDSHAPESCONTROLLER_GET_CACHEDBLENDSHAPENAMES_OFFSET UNITYSDK_OFFSET(0x19147030)
#define RPG_CLIENT_MONOEMOBLENDSHAPESCONTROLLER_GET_CONTROLENABLED_OFFSET UNITYSDK_OFFSET(0x19146FC0)
#define RPG_CLIENT_MONOEMOBLENDSHAPESCONTROLLER_GET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x191471C0)
#define RPG_CLIENT_MONOEMOBLENDSHAPESCONTROLLER_GET_ISSTORYMODE_OFFSET UNITYSDK_OFFSET(0x191471F0)
#define RPG_CLIENT_MONOEMOBLENDSHAPESCONTROLLER_GET_MOUTH_OFFSET UNITYSDK_OFFSET(0x191471E0)
#define RPG_CLIENT_MONOEMOBLENDSHAPESCONTROLLER_METHOD_5_17BD30EFE8176014_OFFSET UNITYSDK_OFFSET(0x18C2EF20)
#define RPG_CLIENT_MONOEMOBLENDSHAPESCONTROLLER_METHOD_5_438300467EDE6B0B_OFFSET UNITYSDK_OFFSET(0x19148750)
#define RPG_CLIENT_MONOEMOBLENDSHAPESCONTROLLER_METHOD_5_809094DEBF13B21A_OFFSET UNITYSDK_OFFSET(0x19147860)
#define RPG_CLIENT_MONOEMOBLENDSHAPESCONTROLLER_METHOD_5_8608350DFEDEE4FD_OFFSET UNITYSDK_OFFSET(0x191487C0)
#define RPG_CLIENT_MONOEMOBLENDSHAPESCONTROLLER_METHOD_5_94AA348A045D277E_OFFSET UNITYSDK_OFFSET(0x191480A0)
#define RPG_CLIENT_MONOEMOBLENDSHAPESCONTROLLER_METHOD_5_A536C0A3C82A1588_OFFSET UNITYSDK_OFFSET(0x191489F0)
#define RPG_CLIENT_MONOEMOBLENDSHAPESCONTROLLER_METHOD_5_AE5C73F4BEB1C1A8_OFFSET UNITYSDK_OFFSET(0x19149070)
#define RPG_CLIENT_MONOEMOBLENDSHAPESCONTROLLER_METHOD_5_B650CDF375474809_OFFSET UNITYSDK_OFFSET(0x19148910)
#define RPG_CLIENT_MONOEMOBLENDSHAPESCONTROLLER_METHOD_5_CD8EB704BDED69B6_OFFSET UNITYSDK_OFFSET(0x18C2EBA0)
#define RPG_CLIENT_MONOEMOBLENDSHAPESCONTROLLER_METHOD_5_F5B4708E7805566C_OFFSET UNITYSDK_OFFSET(0x19148300)
#define RPG_CLIENT_MONOEMOBLENDSHAPESCONTROLLER_METHOD_5_FD6AF0F9AA9298B1_OFFSET UNITYSDK_OFFSET(0x19149290)
#define RPG_CLIENT_MONOEMOBLENDSHAPESCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x191498B0)
#define RPG_CLIENT_MONOEMOBLENDSHAPESCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x191497E0)
#define RPG_CLIENT_MONOEMOBLENDSHAPESCONTROLLER_RESETADDITIVEVALUES_OFFSET UNITYSDK_OFFSET(0x191477B0)
#define RPG_CLIENT_MONOEMOBLENDSHAPESCONTROLLER_RESETTODEFAULT_OFFSET UNITYSDK_OFFSET(0x19148220)
#define RPG_CLIENT_MONOEMOBLENDSHAPESCONTROLLER_SETCONTROLENABLED_OFFSET UNITYSDK_OFFSET(0x19147210)
#define RPG_CLIENT_MONOEMOBLENDSHAPESCONTROLLER_SETUPAUTOBLINK_OFFSET UNITYSDK_OFFSET(0x19147740)
#define RPG_CLIENT_MONOEMOBLENDSHAPESCONTROLLER_SETUPBLENDSHAPECONFIG_OFFSET UNITYSDK_OFFSET(0x19147ED0)
#define RPG_CLIENT_MONOEMOBLENDSHAPESCONTROLLER_SETUPDEFAULTBLENDSHAPES_OFFSET UNITYSDK_OFFSET(0x19147260)
#define RPG_CLIENT_MONOEMOBLENDSHAPESCONTROLLER_SET_CONTROLENABLED_OFFSET UNITYSDK_OFFSET(0x19146FD0)
#define RPG_CLIENT_MONOEMOBLENDSHAPESCONTROLLER_SET_ISSTORYMODE_OFFSET UNITYSDK_OFFSET(0x19147200)
#define RPG_CLIENT_MONOEMOBLENDSHAPESCONTROLLER_SNAPSHOTCURRENTBLENDSHAPES_OFFSET UNITYSDK_OFFSET(0x191479F0)
#define RPG_CLIENT_MONOEMOBLENDSHAPESCONTROLLER_UPDATEBLENDSHAPECONFIG_OFFSET UNITYSDK_OFFSET(0x19147CB0)
#define RPG_CLIENT_MONOEMOBLENDSHAPESCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x18C2F1D0)
#define RPG_CLIENT_MONOEMOBLENDSHAPESCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18C2F110)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEmoBlendShapesController_TypeDefinitionIndex = 67944;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Single>**)Il2CppClass::FromTypeDefinitionIndex(MonoEmoBlendShapesController_TypeDefinitionIndex)->GetStaticField(0x565D0);
		}
		...
		::System::Void Method_5_FD6AF0F9AA9298B1(::System::Single a1)
		{
			return ((::System::Void(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + RPG_CLIENT_MONOEMOBLENDSHAPESCONTROLLER_METHOD_5_FD6AF0F9AA9298B1_OFFSET))(this, a1);
		}
