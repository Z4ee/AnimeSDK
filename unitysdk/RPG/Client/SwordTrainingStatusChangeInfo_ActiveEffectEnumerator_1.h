...
{
	inline static constexpr unsigned int SwordTrainingStatusChangeInfo_ActiveEffectEnumerator_1_TypeDefinitionIndex = 57172;

	template <typename T>
	struct SwordTrainingStatusChangeInfo_ActiveEffectEnumerator_1
	{
		::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_630*>* _InternalEffectList; // 0x0
