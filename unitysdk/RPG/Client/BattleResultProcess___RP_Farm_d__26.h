...
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FARM_D__26_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xB4148A0)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FARM_D__26_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xB414A40)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FARM_D__26_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xB414AA0)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FARM_D__26_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xB414A50)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FARM_D__26_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB414890)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FARM_D__26__CTOR_OFFSET UNITYSDK_OFFSET(0xB4110E0)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleResultProcess___RP_Farm_d__26_TypeDefinitionIndex = 57029;
