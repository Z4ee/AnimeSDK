...
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FARM_D__26_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19F81F00)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FARM_D__26_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19F81FF0)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FARM_D__26_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19F82050)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FARM_D__26_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19F82000)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FARM_D__26_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19F81EF0)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FARM_D__26__CTOR_OFFSET UNITYSDK_OFFSET(0x19F7D970)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleResultProcess___RP_Farm_d__26_TypeDefinitionIndex = 61103;
