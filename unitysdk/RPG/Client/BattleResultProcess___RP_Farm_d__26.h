...
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FARM_D__26_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xC9355C0)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FARM_D__26_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xC9357A0)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FARM_D__26_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xC935800)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FARM_D__26_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xC9357B0)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FARM_D__26_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC9355B0)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FARM_D__26__CTOR_OFFSET UNITYSDK_OFFSET(0xC9355A0)
