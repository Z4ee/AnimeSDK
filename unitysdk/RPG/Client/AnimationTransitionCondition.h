...
#define RPG_CLIENT_ANIMATIONTRANSITIONCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x19C8DD70)

namespace RPG::Client
{
	inline static constexpr unsigned int AnimationTransitionCondition_TypeDefinitionIndex = 68796;
