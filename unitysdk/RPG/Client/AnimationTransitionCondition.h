...
#define RPG_CLIENT_ANIMATIONTRANSITIONCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x90C3150)

namespace RPG::Client
{
	inline static constexpr unsigned int AnimationTransitionCondition_TypeDefinitionIndex = 56227;
