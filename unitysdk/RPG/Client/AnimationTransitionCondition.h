...
#define RPG_CLIENT_ANIMATIONTRANSITIONCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x9D20A00)

namespace RPG::Client
{
	inline static constexpr unsigned int AnimationTransitionCondition_TypeDefinitionIndex = 63470;
