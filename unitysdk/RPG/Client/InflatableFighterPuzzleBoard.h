...
#define RPG_CLIENT_INFLATABLEFIGHTERPUZZLEBOARD_BROADCASTEVENT_OFFSET UNITYSDK_OFFSET(0xD3FEFB0)
#define RPG_CLIENT_INFLATABLEFIGHTERPUZZLEBOARD_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD3FEC20)
#define RPG_CLIENT_INFLATABLEFIGHTERPUZZLEBOARD_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0xD3FF130)
#define RPG_CLIENT_INFLATABLEFIGHTERPUZZLEBOARD_GET_HITSTOPMANAGER_OFFSET UNITYSDK_OFFSET(0xD3FF420)
#define RPG_CLIENT_INFLATABLEFIGHTERPUZZLEBOARD_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xD3FE880)
#define RPG_CLIENT_INFLATABLEFIGHTERPUZZLEBOARD_METHOD_6_2FBD4BA901CF2BCB_OFFSET UNITYSDK_OFFSET(0xD3FF350)
#define RPG_CLIENT_INFLATABLEFIGHTERPUZZLEBOARD_METHOD_6_7DD84EAFF333A1E4_OFFSET UNITYSDK_OFFSET(0xD3FF220)
#define RPG_CLIENT_INFLATABLEFIGHTERPUZZLEBOARD_METHOD_6_DFBAD309D61905C2_OFFSET UNITYSDK_OFFSET(0xD3FF2D0)
#define RPG_CLIENT_INFLATABLEFIGHTERPUZZLEBOARD_METHOD_6_E6708DD8002BE8CE_OFFSET UNITYSDK_OFFSET(0xD3FF270)
#define RPG_CLIENT_INFLATABLEFIGHTERPUZZLEBOARD_STARTFIGHTER_OFFSET UNITYSDK_OFFSET(0xD3FF1D0)
#define RPG_CLIENT_INFLATABLEFIGHTERPUZZLEBOARD_STARTPUZZLE_OFFSET UNITYSDK_OFFSET(0xD3FE8F0)
#define RPG_CLIENT_INFLATABLEFIGHTERPUZZLEBOARD_TICKPUZZLE_OFFSET UNITYSDK_OFFSET(0xD3FEED0)
#define RPG_CLIENT_INFLATABLEFIGHTERPUZZLEBOARD_UPDATE_OFFSET UNITYSDK_OFFSET(0xD3FF080)
#define RPG_CLIENT_INFLATABLEFIGHTERPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0xD3FF430)
