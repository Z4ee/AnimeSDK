...
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_TELEVISIONACTIVITY_D__31_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xB416DA0)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_TELEVISIONACTIVITY_D__31_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xB416F40)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_TELEVISIONACTIVITY_D__31_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xB416FA0)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_TELEVISIONACTIVITY_D__31_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xB416F50)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_TELEVISIONACTIVITY_D__31_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB416D90)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_TELEVISIONACTIVITY_D__31__CTOR_OFFSET UNITYSDK_OFFSET(0xB4113B0)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleResultProcess___RP_TelevisionActivity_d__31_TypeDefinitionIndex = 57046;
