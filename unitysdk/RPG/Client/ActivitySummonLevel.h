...
#define RPG_CLIENT_ACTIVITYSUMMONLEVEL_CHECKCHALLENGETARGETHASCOMPLETED_OFFSET UNITYSDK_OFFSET(0x9C61060)
#define RPG_CLIENT_ACTIVITYSUMMONLEVEL_CREATE_OFFSET UNITYSDK_OFFSET(0x9C60D70)
#define RPG_CLIENT_ACTIVITYSUMMONLEVEL_GETCHALLENGETARGETS_OFFSET UNITYSDK_OFFSET(0x9C61780)
#define RPG_CLIENT_ACTIVITYSUMMONLEVEL_GETFIRSTCHALLENGETARGET_OFFSET UNITYSDK_OFFSET(0x9C61290)
#define RPG_CLIENT_ACTIVITYSUMMONLEVEL_GETMASTERTRIALAVATAR_OFFSET UNITYSDK_OFFSET(0x9C61570)
#define RPG_CLIENT_ACTIVITYSUMMONLEVEL_GETSORTEDMONSTERS_OFFSET UNITYSDK_OFFSET(0x9C60DE0)
#define RPG_CLIENT_ACTIVITYSUMMONLEVEL_GETSTARCOUNT_OFFSET UNITYSDK_OFFSET(0x9C611C0)
#define RPG_CLIENT_ACTIVITYSUMMONLEVEL_GETTRIALAVATARS_OFFSET UNITYSDK_OFFSET(0x9C61320)
#define RPG_CLIENT_ACTIVITYSUMMONLEVEL_GET_BATTLEEVENTID_OFFSET UNITYSDK_OFFSET(0x9C60D30)
#define RPG_CLIENT_ACTIVITYSUMMONLEVEL_GET_DIFFICULTY_OFFSET UNITYSDK_OFFSET(0x9C60AC0)
#define RPG_CLIENT_ACTIVITYSUMMONLEVEL_GET_HASCOMPLETED_OFFSET UNITYSDK_OFFSET(0x9C60C50)
#define RPG_CLIENT_ACTIVITYSUMMONLEVEL_GET_HASUNLOCKED_OFFSET UNITYSDK_OFFSET(0x9C60AE0)
#define RPG_CLIENT_ACTIVITYSUMMONLEVEL_GET_MASTERAVATARLIST_OFFSET UNITYSDK_OFFSET(0x9C60CF0)
#define RPG_CLIENT_ACTIVITYSUMMONLEVEL_GET_META_OFFSET UNITYSDK_OFFSET(0x9C609F0)
#define RPG_CLIENT_ACTIVITYSUMMONLEVEL_GET_MONSTERIMAGEPATH_OFFSET UNITYSDK_OFFSET(0x9C60D50)
#define RPG_CLIENT_ACTIVITYSUMMONLEVEL_GET_STAGEID_OFFSET UNITYSDK_OFFSET(0x9C60A00)
#define RPG_CLIENT_ACTIVITYSUMMONLEVEL_GET_SUMMONSTAGEREF_OFFSET UNITYSDK_OFFSET(0x9C60A20)
#define RPG_CLIENT_ACTIVITYSUMMONLEVEL_GET_TRIALAVATARLIST_OFFSET UNITYSDK_OFFSET(0x9C60D10)
#define RPG_CLIENT_ACTIVITYSUMMONLEVEL_TRYCONSUMEUNLOCKFLAG_OFFSET UNITYSDK_OFFSET(0x9C61920)
#define RPG_CLIENT_ACTIVITYSUMMONLEVEL__CHECKALLCHALLENGETARGETHASCOMPLETED_OFFSET UNITYSDK_OFFSET(0x9C60C60)
#define RPG_CLIENT_ACTIVITYSUMMONLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x9C60DD0)

namespace RPG::Client
{
	inline static constexpr unsigned int ActivitySummonLevel_TypeDefinitionIndex = 57114;
