...
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_POSSIBLEPROPERTYVECTOR_GET_RANDOMVALUE_OFFSET UNITYSDK_OFFSET(0x150FB520)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_POSSIBLEPROPERTYVECTOR_METHOD_1_E5F22A66D9BCBA01_OFFSET UNITYSDK_OFFSET(0x150FAF60)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_POSSIBLEPROPERTYVECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x150FB5C0)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_InstanceArrayBehavior_PossiblePropertyVector_TypeDefinitionIndex = 67456;
