...
#define RPG_CLIENT_MUSEUMUTILS_CONVERTSTATTYPETOSTUFFSTATS_OFFSET UNITYSDK_OFFSET(0x9DC15B0)
#define RPG_CLIENT_MUSEUMUTILS_CONVERTSTUFFSTATSTOSTATTYPE_OFFSET UNITYSDK_OFFSET(0x9DC82C0)
#define RPG_CLIENT_MUSEUMUTILS_GETAREAFULLSTATNUM_OFFSET UNITYSDK_OFFSET(0x9DB9BB0)
#define RPG_CLIENT_MUSEUMUTILS_GETSTAFFSTATVALUE_OFFSET UNITYSDK_OFFSET(0x9DC8310)
#define RPG_CLIENT_MUSEUMUTILS_SHOWMUSEUMATLASPAGE_OFFSET UNITYSDK_OFFSET(0x9DC8620)
#define RPG_CLIENT_MUSEUMUTILS_SHOWMUSEUMENTRANCEPAGE_OFFSET UNITYSDK_OFFSET(0x9DC83D0)
#define RPG_CLIENT_MUSEUMUTILS_SHOWMUSEUMMARKETPAGE_OFFSET UNITYSDK_OFFSET(0x9DC8770)

namespace RPG::Client
{
	inline static constexpr unsigned int MuseumUtils_TypeDefinitionIndex = 53975;

	class MuseumUtils : public ::System::Object
	{
	public:
		static ::Enum_3_DB663931210BBC27_44 ConvertStuffStatsToStatType(::RPG::GameCore::StuffStats stat)
		{
			return ((::Enum_3_DB663931210BBC27_44(*)(::RPG::GameCore::StuffStats))((::PBYTE)hIl2Cpp + RPG_CLIENT_MUSEUMUTILS_CONVERTSTUFFSTATSTOSTATTYPE_OFFSET))(stat);
		}

		static ::RPG::GameCore::StuffStats ConvertStatTypeToStuffStats(::Enum_3_DB663931210BBC27_44 stat)
		{
			return ((::RPG::GameCore::StuffStats(*)(::Enum_3_DB663931210BBC27_44))((::PBYTE)hIl2Cpp + RPG_CLIENT_MUSEUMUTILS_CONVERTSTATTYPETOSTUFFSTATS_OFFSET))(stat);
		}
