...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPCRYSTAL_INIT_OFFSET UNITYSDK_OFFSET(0xA96DAF0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPCRYSTAL_UNINIT_OFFSET UNITYSDK_OFFSET(0xA96ECC0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPCRYSTAL_UPDATEPROPERTY_OFFSET UNITYSDK_OFFSET(0xA96DB90)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPCRYSTAL__CTOR_OFFSET UNITYSDK_OFFSET(0xA96EDD0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPCRYSTAL___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0xA96EDF0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginCharaPropCrystal_TypeDefinitionIndex = 64481;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Collections::Generic::Dictionary_2<::UnityEngine::Renderer*, ::RPG::Client::MonoEffectPluginCharaEffectBase_Class_1_0875A0359D7C8064*>*, ::System::Collections::Generic::List_1<::UnityEngine::Material*>*, ::System::Collections::Generic::Dictionary_2<::UnityEngine::Shader*, ::System::String*>*&))((::PBYTE)hIl2Cpp + RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPCRYSTAL___IFIXBASEPROXY_INIT_OFFSET))(this, P0, P1, P2);
		}
	};
}
