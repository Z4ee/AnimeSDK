...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPCRYSTAL_INIT_OFFSET UNITYSDK_OFFSET(0x9CABB20)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPCRYSTAL_UNINIT_OFFSET UNITYSDK_OFFSET(0x9CACCF0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPCRYSTAL_UPDATEPROPERTY_OFFSET UNITYSDK_OFFSET(0x9CABBC0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPCRYSTAL__CTOR_OFFSET UNITYSDK_OFFSET(0x9CACE00)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPCRYSTAL___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0x9CACE20)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginCharaPropCrystal_TypeDefinitionIndex = 57227;
