...
#define RPG_CLIENT_MULTIPLAYERACTIVITYMODULE___C__DISPLAYCLASS2_0__CTOR_OFFSET UNITYSDK_OFFSET(0xAAEF5A0)
#define RPG_CLIENT_MULTIPLAYERACTIVITYMODULE___C__DISPLAYCLASS2_0__TRANSFERTOMULTIPLAYERACTIVITYENTRANCEPAGE_B__0_OFFSET UNITYSDK_OFFSET(0xAAEFDA0)
#define RPG_CLIENT_MULTIPLAYERACTIVITYMODULE___C__DISPLAYCLASS2_0__TRANSFERTOMULTIPLAYERACTIVITYENTRANCEPAGE_B__1_OFFSET UNITYSDK_OFFSET(0xAAEFF50)

namespace RPG::Client
{
	inline static constexpr unsigned int MultiPlayerActivityModule___c__DisplayClass2_0_TypeDefinitionIndex = 57004;
