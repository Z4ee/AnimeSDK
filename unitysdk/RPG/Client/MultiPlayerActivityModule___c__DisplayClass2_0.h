...
#define RPG_CLIENT_MULTIPLAYERACTIVITYMODULE___C__DISPLAYCLASS2_0__CTOR_OFFSET UNITYSDK_OFFSET(0xD8DE0A0)
#define RPG_CLIENT_MULTIPLAYERACTIVITYMODULE___C__DISPLAYCLASS2_0__TRANSFERTOMULTIPLAYERACTIVITYENTRANCEPAGE_B__0_OFFSET UNITYSDK_OFFSET(0xD8DE8C0)
#define RPG_CLIENT_MULTIPLAYERACTIVITYMODULE___C__DISPLAYCLASS2_0__TRANSFERTOMULTIPLAYERACTIVITYENTRANCEPAGE_B__1_OFFSET UNITYSDK_OFFSET(0xD8DEA80)
