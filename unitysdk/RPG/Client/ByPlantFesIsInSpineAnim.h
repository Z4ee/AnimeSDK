...
#define RPG_CLIENT_BYPLANTFESISINSPINEANIM_METHOD_4_6D24379EB333B31F_OFFSET UNITYSDK_OFFSET(0x185E4FD0)
#define RPG_CLIENT_BYPLANTFESISINSPINEANIM_METHOD_4_E323203E39344341_OFFSET UNITYSDK_OFFSET(0x185E4F00)
#define RPG_CLIENT_BYPLANTFESISINSPINEANIM__CTOR_OFFSET UNITYSDK_OFFSET(0x185E4F80)

namespace RPG::Client
{
	inline static constexpr unsigned int ByPlantFesIsInSpineAnim_TypeDefinitionIndex = 10148;
