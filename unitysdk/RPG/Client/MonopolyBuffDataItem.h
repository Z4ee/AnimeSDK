...
#define RPG_CLIENT_MONOPOLYBUFFDATAITEM_GET_DESC_OFFSET UNITYSDK_OFFSET(0x9D53A20)
#define RPG_CLIENT_MONOPOLYBUFFDATAITEM_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x9D538A0)
#define RPG_CLIENT_MONOPOLYBUFFDATAITEM_GET_ID_OFFSET UNITYSDK_OFFSET(0x9D53860)
#define RPG_CLIENT_MONOPOLYBUFFDATAITEM_GET_ISPERMANENT_OFFSET UNITYSDK_OFFSET(0x9D53C70)
#define RPG_CLIENT_MONOPOLYBUFFDATAITEM_GET_LEFTROUND_OFFSET UNITYSDK_OFFSET(0x9D53AF0)
#define RPG_CLIENT_MONOPOLYBUFFDATAITEM_GET_NAME_OFFSET UNITYSDK_OFFSET(0x9D53950)
#define RPG_CLIENT_MONOPOLYBUFFDATAITEM_GET_PARAM_OFFSET UNITYSDK_OFFSET(0x9D53B10)
#define RPG_CLIENT_MONOPOLYBUFFDATAITEM_GET_RANK_OFFSET UNITYSDK_OFFSET(0x9D53C00)
#define RPG_CLIENT_MONOPOLYBUFFDATAITEM_GET_UNIQUEKEY_OFFSET UNITYSDK_OFFSET(0x9D53880)
#define RPG_CLIENT_MONOPOLYBUFFDATAITEM_GET__ROW_OFFSET UNITYSDK_OFFSET(0x9D53800)
#define RPG_CLIENT_MONOPOLYBUFFDATAITEM_SETTURN_OFFSET UNITYSDK_OFFSET(0x9D53760)
#define RPG_CLIENT_MONOPOLYBUFFDATAITEM_SETUNIQUEKEY_OFFSET UNITYSDK_OFFSET(0x9D537B0)
#define RPG_CLIENT_MONOPOLYBUFFDATAITEM_SET_ID_OFFSET UNITYSDK_OFFSET(0x9D53870)
#define RPG_CLIENT_MONOPOLYBUFFDATAITEM_SET_LEFTROUND_OFFSET UNITYSDK_OFFSET(0x9D53B00)
#define RPG_CLIENT_MONOPOLYBUFFDATAITEM_SET_UNIQUEKEY_OFFSET UNITYSDK_OFFSET(0x9D53890)
#define RPG_CLIENT_MONOPOLYBUFFDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x9D53750)

namespace RPG::Client
{
	inline static constexpr unsigned int MonopolyBuffDataItem_TypeDefinitionIndex = 53828;
