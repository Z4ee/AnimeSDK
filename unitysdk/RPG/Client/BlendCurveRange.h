...
#define RPG_CLIENT_BLENDCURVERANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD8FBD0)

namespace RPG::Client
{
	inline static constexpr unsigned int BlendCurveRange_TypeDefinitionIndex = 69685;
