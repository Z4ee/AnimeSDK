...
#define RPG_CLIENT_BLENDCURVERANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x91F3B10)

namespace RPG::Client
{
	inline static constexpr unsigned int BlendCurveRange_TypeDefinitionIndex = 57007;
