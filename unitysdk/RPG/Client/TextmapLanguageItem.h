...
#define RPG_CLIENT_TEXTMAPLANGUAGEITEM_CLEARLISTEDSIZE_OFFSET UNITYSDK_OFFSET(0xE1DD280)
#define RPG_CLIENT_TEXTMAPLANGUAGEITEM_GET_LANGUAGEKEY_OFFSET UNITYSDK_OFFSET(0xE1DD1B0)
#define RPG_CLIENT_TEXTMAPLANGUAGEITEM_GET_NAME_OFFSET UNITYSDK_OFFSET(0xE1DD1C0)
#define RPG_CLIENT_TEXTMAPLANGUAGEITEM_GET_RAWSIZE_OFFSET UNITYSDK_OFFSET(0xE1DD2D0)
#define RPG_CLIENT_TEXTMAPLANGUAGEITEM_GET_SIZE_OFFSET UNITYSDK_OFFSET(0xE1DD270)
#define RPG_CLIENT_TEXTMAPLANGUAGEITEM_GET_TEXTLANGUAGEKEY_OFFSET UNITYSDK_OFFSET(0xE1DD190)
#define RPG_CLIENT_TEXTMAPLANGUAGEITEM_SETSIZE_OFFSET UNITYSDK_OFFSET(0xE1D9900)
#define RPG_CLIENT_TEXTMAPLANGUAGEITEM_SET_TEXTLANGUAGEKEY_OFFSET UNITYSDK_OFFSET(0xE1DD1A0)
#define RPG_CLIENT_TEXTMAPLANGUAGEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xE1D98F0)
