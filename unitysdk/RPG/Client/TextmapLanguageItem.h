...
#define RPG_CLIENT_TEXTMAPLANGUAGEITEM_CLEARLISTEDSIZE_OFFSET UNITYSDK_OFFSET(0x1ACB5FE0)
#define RPG_CLIENT_TEXTMAPLANGUAGEITEM_GET_LANGUAGEKEY_OFFSET UNITYSDK_OFFSET(0x1ACB5F10)
#define RPG_CLIENT_TEXTMAPLANGUAGEITEM_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1ACB5F20)
#define RPG_CLIENT_TEXTMAPLANGUAGEITEM_GET_RAWSIZE_OFFSET UNITYSDK_OFFSET(0x1ACB6030)
#define RPG_CLIENT_TEXTMAPLANGUAGEITEM_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x1ACB5FD0)
#define RPG_CLIENT_TEXTMAPLANGUAGEITEM_GET_TEXTLANGUAGEKEY_OFFSET UNITYSDK_OFFSET(0x1ACB5EF0)
#define RPG_CLIENT_TEXTMAPLANGUAGEITEM_SETSIZE_OFFSET UNITYSDK_OFFSET(0x1ACB2680)
#define RPG_CLIENT_TEXTMAPLANGUAGEITEM_SET_TEXTLANGUAGEKEY_OFFSET UNITYSDK_OFFSET(0x1ACB5F00)
#define RPG_CLIENT_TEXTMAPLANGUAGEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACB2670)

namespace RPG::Client
{
	inline static constexpr unsigned int TextmapLanguageItem_TypeDefinitionIndex = 61347;
