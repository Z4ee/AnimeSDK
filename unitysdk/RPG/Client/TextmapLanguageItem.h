...
#define RPG_CLIENT_TEXTMAPLANGUAGEITEM_CLEARLISTEDSIZE_OFFSET UNITYSDK_OFFSET(0x1948D700)
#define RPG_CLIENT_TEXTMAPLANGUAGEITEM_GET_LANGUAGEKEY_OFFSET UNITYSDK_OFFSET(0x1948D630)
#define RPG_CLIENT_TEXTMAPLANGUAGEITEM_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1948D640)
#define RPG_CLIENT_TEXTMAPLANGUAGEITEM_GET_RAWSIZE_OFFSET UNITYSDK_OFFSET(0x1948D750)
#define RPG_CLIENT_TEXTMAPLANGUAGEITEM_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x1948D6F0)
#define RPG_CLIENT_TEXTMAPLANGUAGEITEM_GET_TEXTLANGUAGEKEY_OFFSET UNITYSDK_OFFSET(0x1948D610)
#define RPG_CLIENT_TEXTMAPLANGUAGEITEM_SETSIZE_OFFSET UNITYSDK_OFFSET(0x19489E40)
#define RPG_CLIENT_TEXTMAPLANGUAGEITEM_SET_TEXTLANGUAGEKEY_OFFSET UNITYSDK_OFFSET(0x1948D620)
#define RPG_CLIENT_TEXTMAPLANGUAGEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x19489E30)

namespace RPG::Client
{
	inline static constexpr unsigned int TextmapLanguageItem_TypeDefinitionIndex = 58517;
