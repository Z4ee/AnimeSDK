...
#define RPG_CLIENT_BATTLEAVATARULTRASKILLFLYEFFECT_DESPAWNED_OFFSET UNITYSDK_OFFSET(0x19F3C410)
#define RPG_CLIENT_BATTLEAVATARULTRASKILLFLYEFFECT_METHOD_5_005A196F2DA2B034_OFFSET UNITYSDK_OFFSET(0x19F3C7B0)
#define RPG_CLIENT_BATTLEAVATARULTRASKILLFLYEFFECT_ONCREATE_OFFSET UNITYSDK_OFFSET(0x19F3C110)
#define RPG_CLIENT_BATTLEAVATARULTRASKILLFLYEFFECT_PLAY_OFFSET UNITYSDK_OFFSET(0x19F3C450)
#define RPG_CLIENT_BATTLEAVATARULTRASKILLFLYEFFECT_SPAWNED_OFFSET UNITYSDK_OFFSET(0x19F3C3D0)
#define RPG_CLIENT_BATTLEAVATARULTRASKILLFLYEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x19F3CB60)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleAvatarUltraSkillFlyEffect_TypeDefinitionIndex = 71431;
