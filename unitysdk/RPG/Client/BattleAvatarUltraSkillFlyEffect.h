...
#define RPG_CLIENT_BATTLEAVATARULTRASKILLFLYEFFECT_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xB3D2A00)
#define RPG_CLIENT_BATTLEAVATARULTRASKILLFLYEFFECT_METHOD_5_005A196F2DA2B034_OFFSET UNITYSDK_OFFSET(0xB3D2DA0)
#define RPG_CLIENT_BATTLEAVATARULTRASKILLFLYEFFECT_ONCREATE_OFFSET UNITYSDK_OFFSET(0xB3D2700)
#define RPG_CLIENT_BATTLEAVATARULTRASKILLFLYEFFECT_PLAY_OFFSET UNITYSDK_OFFSET(0xB3D2A40)
#define RPG_CLIENT_BATTLEAVATARULTRASKILLFLYEFFECT_SPAWNED_OFFSET UNITYSDK_OFFSET(0xB3D29C0)
#define RPG_CLIENT_BATTLEAVATARULTRASKILLFLYEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xB3D3150)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleAvatarUltraSkillFlyEffect_TypeDefinitionIndex = 66809;
