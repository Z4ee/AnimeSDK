...
#define RPG_CLIENT_MONOEFFECTPLUGINPLAYERCHANGE_METHOD_8_25DEA5C65A602671_OFFSET UNITYSDK_OFFSET(0xD7C43F0)
#define RPG_CLIENT_MONOEFFECTPLUGINPLAYERCHANGE_METHOD_8_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0xD7C4050)
#define RPG_CLIENT_MONOEFFECTPLUGINPLAYERCHANGE_METHOD_8_8E9E3E0D1D6E6E24_OFFSET UNITYSDK_OFFSET(0xD7C4170)
#define RPG_CLIENT_MONOEFFECTPLUGINPLAYERCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0xD7C4440)
