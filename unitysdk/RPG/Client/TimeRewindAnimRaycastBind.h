...
#define RPG_CLIENT_TIMEREWINDANIMRAYCASTBIND__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACBDCF0)

namespace RPG::Client
{
	inline static constexpr unsigned int TimeRewindAnimRaycastBind_TypeDefinitionIndex = 60944;
