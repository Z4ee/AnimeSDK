...
#define RPG_CLIENT_TIMEREWINDANIMRAYCASTBIND__CTOR_OFFSET UNITYSDK_OFFSET(0xA59CFD0)

namespace RPG::Client
{
	inline static constexpr unsigned int TimeRewindAnimRaycastBind_TypeDefinitionIndex = 49311;
