...
#define RPG_CLIENT_MONOGPUSKINSWITCH_AWAKE_OFFSET UNITYSDK_OFFSET(0xC115660)
#define RPG_CLIENT_MONOGPUSKINSWITCH__CTOR_OFFSET UNITYSDK_OFFSET(0xC115A30)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoGPUSkinSwitch_TypeDefinitionIndex = 64185;
