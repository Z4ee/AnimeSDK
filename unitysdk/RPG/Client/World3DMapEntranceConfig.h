...
#define RPG_CLIENT_WORLD3DMAPENTRANCECONFIG_CREATE_OFFSET UNITYSDK_OFFSET(0x1681AEB0)
#define RPG_CLIENT_WORLD3DMAPENTRANCECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1681AF50)
