...
#define RPG_CLIENT_CAKERACESTATIC_GETACTIVITYREWARDID_OFFSET UNITYSDK_OFFSET(0x9F117B0)
#define RPG_CLIENT_CAKERACESTATIC_GETCURLOANPERFORMENCEID_OFFSET UNITYSDK_OFFSET(0x9F12170)
#define RPG_CLIENT_CAKERACESTATIC_GETSCORERANKRATIO_OFFSET UNITYSDK_OFFSET(0x9F12310)
#define RPG_CLIENT_CAKERACESTATIC_GET_ACTIVITYID_OFFSET UNITYSDK_OFFSET(0x9F117A0)
#define RPG_CLIENT_CAKERACESTATIC_GET_BETRATIOSHOWSPECIAL_OFFSET UNITYSDK_OFFSET(0x9F12050)
#define RPG_CLIENT_CAKERACESTATIC_GET_CAMERACHANGEFOLLOWTIME_OFFSET UNITYSDK_OFFSET(0x9F11C00)
#define RPG_CLIENT_CAKERACESTATIC_GET_CHAMPIONCAMERACHANGETIME_OFFSET UNITYSDK_OFFSET(0x9F11F40)
#define RPG_CLIENT_CAKERACESTATIC_GET_CHAMPIONCAMERASHOWTIME_OFFSET UNITYSDK_OFFSET(0x9F11E30)
#define RPG_CLIENT_CAKERACESTATIC_GET_COINITEMICON128SIZEPATH_OFFSET UNITYSDK_OFFSET(0x9F11540)
#define RPG_CLIENT_CAKERACESTATIC_GET_COINITEMICONPATH_OFFSET UNITYSDK_OFFSET(0x9F11490)
#define RPG_CLIENT_CAKERACESTATIC_GET_COINITEMID_OFFSET UNITYSDK_OFFSET(0x9F0C0F0)
#define RPG_CLIENT_CAKERACESTATIC_GET_COINITEMLIMIT_OFFSET UNITYSDK_OFFSET(0x9F11880)
#define RPG_CLIENT_CAKERACESTATIC_GET_ENTRANCEID_OFFSET UNITYSDK_OFFSET(0x9F11B80)
#define RPG_CLIENT_CAKERACESTATIC_GET_ENTRANCEMAPINFOID_OFFSET UNITYSDK_OFFSET(0x9F11AA0)
#define RPG_CLIENT_CAKERACESTATIC_GET_HIGHWINRATETHRESHOLD_OFFSET UNITYSDK_OFFSET(0x9F01710)
#define RPG_CLIENT_CAKERACESTATIC_GET_LOWWINRATETHRESHOLD_OFFSET UNITYSDK_OFFSET(0x9F01880)
#define RPG_CLIENT_CAKERACESTATIC_GET_SCOREITEMICONPATH_OFFSET UNITYSDK_OFFSET(0x9F115F0)
#define RPG_CLIENT_CAKERACESTATIC_GET_SCOREITEMID_OFFSET UNITYSDK_OFFSET(0x9F0DB90)
#define RPG_CLIENT_CAKERACESTATIC_GET_SCOREITEMLIMIT_OFFSET UNITYSDK_OFFSET(0x9F11990)
#define RPG_CLIENT_CAKERACESTATIC_GET_SHOWSECTIONENDTOASTTIME_OFFSET UNITYSDK_OFFSET(0x9F11D20)
#define RPG_CLIENT_CAKERACESTATIC_GET_SPECIALBETRATIO_OFFSET UNITYSDK_OFFSET(0x9F116A0)

namespace RPG::Client
{
	inline static constexpr unsigned int CakeRaceStatic_TypeDefinitionIndex = 58045;
