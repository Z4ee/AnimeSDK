...
#define RPG_CLIENT_EFFECT_WORLDWIREFRAME_AWAKE_OFFSET UNITYSDK_OFFSET(0x1AC537C0)
#define RPG_CLIENT_EFFECT_WORLDWIREFRAME_GET_BEHAVIOR_OFFSET UNITYSDK_OFFSET(0x1AC53CA0)
#define RPG_CLIENT_EFFECT_WORLDWIREFRAME_GET_LINERENDERERS_OFFSET UNITYSDK_OFFSET(0x1AC53C80)
#define RPG_CLIENT_EFFECT_WORLDWIREFRAME_GET_XOYRENDERER_OFFSET UNITYSDK_OFFSET(0x1AC53C00)
#define RPG_CLIENT_EFFECT_WORLDWIREFRAME_GET_XOZRENDERER_OFFSET UNITYSDK_OFFSET(0x1AC53BE0)
#define RPG_CLIENT_EFFECT_WORLDWIREFRAME_GET_XYZOFFSET_OFFSET UNITYSDK_OFFSET(0x1AC539D0)
#define RPG_CLIENT_EFFECT_WORLDWIREFRAME_GET_XYZROTATION_OFFSET UNITYSDK_OFFSET(0x1AC53A70)
#define RPG_CLIENT_EFFECT_WORLDWIREFRAME_GET_YOZRENDERER_OFFSET UNITYSDK_OFFSET(0x1AC53C20)
#define RPG_CLIENT_EFFECT_WORLDWIREFRAME_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1AC538F0)
#define RPG_CLIENT_EFFECT_WORLDWIREFRAME_SET_LINERENDERERS_OFFSET UNITYSDK_OFFSET(0x1AC53C90)
#define RPG_CLIENT_EFFECT_WORLDWIREFRAME_SET_XOYRENDERER_OFFSET UNITYSDK_OFFSET(0x1AC53C10)
#define RPG_CLIENT_EFFECT_WORLDWIREFRAME_SET_XOZRENDERER_OFFSET UNITYSDK_OFFSET(0x1AC53BF0)
#define RPG_CLIENT_EFFECT_WORLDWIREFRAME_SET_YOZRENDERER_OFFSET UNITYSDK_OFFSET(0x1AC53C30)
#define RPG_CLIENT_EFFECT_WORLDWIREFRAME_START_OFFSET UNITYSDK_OFFSET(0x1AC53890)
#define RPG_CLIENT_EFFECT_WORLDWIREFRAME_UPDATE_OFFSET UNITYSDK_OFFSET(0x1AC53980)
#define RPG_CLIENT_EFFECT_WORLDWIREFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC53CB0)
