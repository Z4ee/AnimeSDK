...
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER___C__DISPLAYCLASS35_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1948B610)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER___C__DISPLAYCLASS35_0__STARTDOWNLOAD_B__0_OFFSET UNITYSDK_OFFSET(0x1948D090)
#define RPG_CLIENT_TEXTMAPDOWNLOADMANAGER___C__DISPLAYCLASS35_0__STARTDOWNLOAD_B__1_OFFSET UNITYSDK_OFFSET(0x1948D0C0)

namespace RPG::Client
{
	inline static constexpr unsigned int TextmapDownloadManager___c__DisplayClass35_0_TypeDefinitionIndex = 58511;
