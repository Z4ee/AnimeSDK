...
#define RPG_CLIENT_MULTIPLAYERCAREERDATA___C__DISPLAYCLASS8_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1908D2F0)
#define RPG_CLIENT_MULTIPLAYERCAREERDATA___C__DISPLAYCLASS8_0__UPDATESELFRANKINGINFO_B__0_OFFSET UNITYSDK_OFFSET(0x1908D9E0)

namespace RPG::Client
{
	inline static constexpr unsigned int MultiplayerCareerData___c__DisplayClass8_0_TypeDefinitionIndex = 63363;

	class MultiplayerCareerData___c__DisplayClass8_0 : public ::System::Object
	{
	public:
		::Class_1_5A95CCE23053F94F* rankingInfo; // 0x10
