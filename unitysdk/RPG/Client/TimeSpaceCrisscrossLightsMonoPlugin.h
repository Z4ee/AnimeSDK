...
#define RPG_CLIENT_TIMESPACECRISSCROSSLIGHTSMONOPLUGIN_GET_EXECUTEINPREFABINSTANCE_OFFSET UNITYSDK_OFFSET(0xCA6C7D0)
#define RPG_CLIENT_TIMESPACECRISSCROSSLIGHTSMONOPLUGIN_ISFORBIDFASTFADING_OFFSET UNITYSDK_OFFSET(0xCA6C790)
#define RPG_CLIENT_TIMESPACECRISSCROSSLIGHTSMONOPLUGIN_SETFADEINOUTINTENSITY_OFFSET UNITYSDK_OFFSET(0xCA6C6E0)
#define RPG_CLIENT_TIMESPACECRISSCROSSLIGHTSMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xCA6C7E0)

namespace RPG::Client
{
	inline static constexpr unsigned int TimeSpaceCrisscrossLightsMonoPlugin_TypeDefinitionIndex = 65672;
