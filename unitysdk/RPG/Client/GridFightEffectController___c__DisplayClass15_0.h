...
#define RPG_CLIENT_GRIDFIGHTEFFECTCONTROLLER___C__DISPLAYCLASS15_0__CTOR_OFFSET UNITYSDK_OFFSET(0xBB0E7F0)
#define RPG_CLIENT_GRIDFIGHTEFFECTCONTROLLER___C__DISPLAYCLASS15_0__PLAYFLYEFFECT_B__0_OFFSET UNITYSDK_OFFSET(0xBB0E800)
#define RPG_CLIENT_GRIDFIGHTEFFECTCONTROLLER___C__DISPLAYCLASS15_0__PLAYFLYEFFECT_B__1_OFFSET UNITYSDK_OFFSET(0xBB0E840)
#define RPG_CLIENT_GRIDFIGHTEFFECTCONTROLLER___C__DISPLAYCLASS15_0__PLAYFLYEFFECT_B__2_OFFSET UNITYSDK_OFFSET(0xBB0E860)
#define RPG_CLIENT_GRIDFIGHTEFFECTCONTROLLER___C__DISPLAYCLASS15_0__PLAYFLYEFFECT_B__3_OFFSET UNITYSDK_OFFSET(0xBB0E8A0)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightEffectController___c__DisplayClass15_0_TypeDefinitionIndex = 60264;
