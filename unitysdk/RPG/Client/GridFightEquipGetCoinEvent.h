...
#define RPG_CLIENT_GRIDFIGHTEQUIPGETCOINEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A684EB0)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightEquipGetCoinEvent_TypeDefinitionIndex = 62145;
