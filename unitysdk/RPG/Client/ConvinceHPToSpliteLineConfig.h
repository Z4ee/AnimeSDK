...
#define RPG_CLIENT_CONVINCEHPTOSPLITELINECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1802A8E0)

namespace RPG::Client
{
	inline static constexpr unsigned int ConvinceHPToSpliteLineConfig_TypeDefinitionIndex = 57956;
