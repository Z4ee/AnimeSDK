...
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONMODULE___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x19B219C0)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONMODULE___C__CTOR_OFFSET UNITYSDK_OFFSET(0x19B219F0)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONMODULE___C__GETANNIVERSARY3RDCOLLECTIONGROUPDATA_B__22_0_OFFSET UNITYSDK_OFFSET(0x19B21A00)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Func_2<::RPG::Client::AnniversaryCollectionGroupData*, ::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(AnniversaryCollectionModule___c_TypeDefinitionIndex)->GetStaticField(0x54800);
		}
		static ::RPG::Client::AnniversaryCollectionModule___c** StaticGet___9()
		{
			return (::RPG::Client::AnniversaryCollectionModule___c**)Il2CppClass::FromTypeDefinitionIndex(AnniversaryCollectionModule___c_TypeDefinitionIndex)->GetStaticField(0x54808);
		}
