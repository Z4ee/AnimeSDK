...
#define RPG_CLIENT_FATEHANDBOOKMASTERCOLLECTION_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C192AE0)
#define RPG_CLIENT_FATEHANDBOOKMASTERCOLLECTION_GET_MASTERITEMLIST_OFFSET UNITYSDK_OFFSET(0x1C193180)
#define RPG_CLIENT_FATEHANDBOOKMASTERCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C192E10)
#define RPG_CLIENT_FATEHANDBOOKMASTERCOLLECTION__GENERATEMASTERHANDBOOKLIST_OFFSET UNITYSDK_OFFSET(0x1C192E20)

namespace RPG::Client
{
	inline static constexpr unsigned int FateHandbookMasterCollection_TypeDefinitionIndex = 64135;
