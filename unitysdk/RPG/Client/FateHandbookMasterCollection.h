...
#define RPG_CLIENT_FATEHANDBOOKMASTERCOLLECTION_DISPOSE_OFFSET UNITYSDK_OFFSET(0xCF4F4B0)
#define RPG_CLIENT_FATEHANDBOOKMASTERCOLLECTION_GET_MASTERITEMLIST_OFFSET UNITYSDK_OFFSET(0xCF4FB50)
#define RPG_CLIENT_FATEHANDBOOKMASTERCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0xCF4F7E0)
#define RPG_CLIENT_FATEHANDBOOKMASTERCOLLECTION__GENERATEMASTERHANDBOOKLIST_OFFSET UNITYSDK_OFFSET(0xCF4F7F0)
