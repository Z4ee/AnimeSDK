...
#define RPG_CLIENT_FATERINAVATARREWARDTOASTCONFIG_GET_UINAME_OFFSET UNITYSDK_OFFSET(0x1B5D1D50)
#define RPG_CLIENT_FATERINAVATARREWARDTOASTCONFIG_GET_UIPATH_OFFSET UNITYSDK_OFFSET(0x1B5D1CE0)
#define RPG_CLIENT_FATERINAVATARREWARDTOASTCONFIG_GET__UINAMEOFTRIALAVATARDIALOG_OFFSET UNITYSDK_OFFSET(0x1B5D1DC0)
#define RPG_CLIENT_FATERINAVATARREWARDTOASTCONFIG_ISTOASTSEEN_OFFSET UNITYSDK_OFFSET(0x1B5D1E20)
#define RPG_CLIENT_FATERINAVATARREWARDTOASTCONFIG_MARKTOASTSEEN_OFFSET UNITYSDK_OFFSET(0x1B5D1ED0)
#define RPG_CLIENT_FATERINAVATARREWARDTOASTCONFIG_TRYDELAYTOAST_OFFSET UNITYSDK_OFFSET(0x1B5D1F90)
#define RPG_CLIENT_FATERINAVATARREWARDTOASTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5D21F0)
#define RPG_CLIENT_FATERINAVATARREWARDTOASTCONFIG__ISTRIALAVATARDIALOGONTOP_OFFSET UNITYSDK_OFFSET(0x1B5D2040)
