...
#define RPG_CLIENT_GRIDFIGHTBATTLESTTINFO_GET_DAMAGESTATISTICS_OFFSET UNITYSDK_OFFSET(0x1ADC6600)
#define RPG_CLIENT_GRIDFIGHTBATTLESTTINFO_SET_DAMAGESTATISTICS_OFFSET UNITYSDK_OFFSET(0x1ADC6610)
#define RPG_CLIENT_GRIDFIGHTBATTLESTTINFO_SYNC_OFFSET UNITYSDK_OFFSET(0x1ADC53A0)
#define RPG_CLIENT_GRIDFIGHTBATTLESTTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADC6620)
