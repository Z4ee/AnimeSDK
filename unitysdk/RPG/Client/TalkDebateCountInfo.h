...
#define RPG_CLIENT_TALKDEBATECOUNTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xC9C6CB0)

namespace RPG::Client
{
	inline static constexpr unsigned int TalkDebateCountInfo_TypeDefinitionIndex = 56722;

	class TalkDebateCountInfo : public ::System::Object
	{
	public:
		::System::Int32 CurrentCount; // 0x10
		::System::Int32 LastCount; // 0x14
