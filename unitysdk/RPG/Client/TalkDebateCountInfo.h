...
#define RPG_CLIENT_TALKDEBATECOUNTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xA53BD00)

namespace RPG::Client
{
	inline static constexpr unsigned int TalkDebateCountInfo_TypeDefinitionIndex = 49169;
