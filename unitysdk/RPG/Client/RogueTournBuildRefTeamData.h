...
#define RPG_CLIENT_ROGUETOURNBUILDREFTEAMDATA_CLEAR_OFFSET UNITYSDK_OFFSET(0xA37C400)
#define RPG_CLIENT_ROGUETOURNBUILDREFTEAMDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA37C770)
#define RPG_CLIENT_ROGUETOURNBUILDREFTEAMDATA_GET_MEMBERCANDIDATES_OFFSET UNITYSDK_OFFSET(0xA37C7E0)
#define RPG_CLIENT_ROGUETOURNBUILDREFTEAMDATA_TOSTRING_OFFSET UNITYSDK_OFFSET(0xA37C0A0)
#define RPG_CLIENT_ROGUETOURNBUILDREFTEAMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA37C060)
#define RPG_CLIENT_ROGUETOURNBUILDREFTEAMDATA___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0xA37C7F0)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueTournBuildRefTeamData_TypeDefinitionIndex = 55047;
