...
#define RPG_CLIENT_GRIDFIGHTFORMATIONROLE_ADDEQUIP_OFFSET UNITYSDK_OFFSET(0xD19C130)
#define RPG_CLIENT_GRIDFIGHTFORMATIONROLE_ADD_ONEQUIPCOLLECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0xD19B920)
#define RPG_CLIENT_GRIDFIGHTFORMATIONROLE_CLEAREQUIP_OFFSET UNITYSDK_OFFSET(0xD19C210)
#define RPG_CLIENT_GRIDFIGHTFORMATIONROLE_GET_EQUIPIDS_OFFSET UNITYSDK_OFFSET(0xD19BCA0)
#define RPG_CLIENT_GRIDFIGHTFORMATIONROLE_GET_POSINDEX_OFFSET UNITYSDK_OFFSET(0xD19BBD0)
#define RPG_CLIENT_GRIDFIGHTFORMATIONROLE_GET_ROLEID_OFFSET UNITYSDK_OFFSET(0xD19BA30)
#define RPG_CLIENT_GRIDFIGHTFORMATIONROLE_GET_STAR_OFFSET UNITYSDK_OFFSET(0xD19BB00)
#define RPG_CLIENT_GRIDFIGHTFORMATIONROLE_GET__EQUIPIDS_OFFSET UNITYSDK_OFFSET(0xD19BA20)
#define RPG_CLIENT_GRIDFIGHTFORMATIONROLE_HASEQUIP_OFFSET UNITYSDK_OFFSET(0xD19C390)
#define RPG_CLIENT_GRIDFIGHTFORMATIONROLE_REMOVEEQUIP_OFFSET UNITYSDK_OFFSET(0xD19C260)
#define RPG_CLIENT_GRIDFIGHTFORMATIONROLE_REMOVE_ONEQUIPCOLLECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0xD19B9A0)
#define RPG_CLIENT_GRIDFIGHTFORMATIONROLE_REPLACEEQUIP_OFFSET UNITYSDK_OFFSET(0xD19C2C0)
#define RPG_CLIENT_GRIDFIGHTFORMATIONROLE_RPG_CLIENT_IGRIDFIGHTREFTRAITLAYERROLEINPUT_GET_EQUIPIDS_OFFSET UNITYSDK_OFFSET(0xD19BD30)
#define RPG_CLIENT_GRIDFIGHTFORMATIONROLE_SET_POSINDEX_OFFSET UNITYSDK_OFFSET(0xD19BC10)
#define RPG_CLIENT_GRIDFIGHTFORMATIONROLE_SET_ROLEID_OFFSET UNITYSDK_OFFSET(0xD19BA70)
#define RPG_CLIENT_GRIDFIGHTFORMATIONROLE_SET_STAR_OFFSET UNITYSDK_OFFSET(0xD19BB40)
#define RPG_CLIENT_GRIDFIGHTFORMATIONROLE__CTOR_OFFSET UNITYSDK_OFFSET(0xD19BDD0)
#define RPG_CLIENT_GRIDFIGHTFORMATIONROLE__ONCOLLECTIONCHANGEDEVENTHANDLER_OFFSET UNITYSDK_OFFSET(0xD19C3F0)
