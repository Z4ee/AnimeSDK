...
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_DIALOGDATA_GET_AUDIOPLAYERGO_OFFSET UNITYSDK_OFFSET(0xCC53AA0)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_DIALOGDATA_GET_LIFETIME_OFFSET UNITYSDK_OFFSET(0xCC53A60)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_DIALOGDATA_GET_OFFSETSCALELIST_OFFSET UNITYSDK_OFFSET(0xCC52FD0)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_DIALOGDATA_GET_PATTERNCOUNT_OFFSET UNITYSDK_OFFSET(0xCC53A40)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_DIALOGDATA_GET_STRIPRECT_OFFSET UNITYSDK_OFFSET(0xCC53A80)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_DIALOGDATA_GET_UVRECTLIST_OFFSET UNITYSDK_OFFSET(0xCC52F30)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_DIALOGDATA_METHOD_1_5D0CCFC50EB9BE02_OFFSET UNITYSDK_OFFSET(0xCC53B20)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_DIALOGDATA_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xCC53AC0)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_DIALOGDATA_SET_AUDIOPLAYERGO_OFFSET UNITYSDK_OFFSET(0xCC53AB0)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_DIALOGDATA_SET_LIFETIME_OFFSET UNITYSDK_OFFSET(0xCC53A70)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_DIALOGDATA_SET_PATTERNCOUNT_OFFSET UNITYSDK_OFFSET(0xCC53A50)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_DIALOGDATA_SET_STRIPRECT_OFFSET UNITYSDK_OFFSET(0xCC53A90)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_DIALOGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCC53BF0)
