...
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_DIALOGDATA_GET_AUDIOPLAYERGO_OFFSET UNITYSDK_OFFSET(0x1A27DB60)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_DIALOGDATA_GET_LIFETIME_OFFSET UNITYSDK_OFFSET(0x1A27DB20)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_DIALOGDATA_GET_OFFSETSCALELIST_OFFSET UNITYSDK_OFFSET(0x1A27D090)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_DIALOGDATA_GET_PATTERNCOUNT_OFFSET UNITYSDK_OFFSET(0x1A27DB00)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_DIALOGDATA_GET_STRIPRECT_OFFSET UNITYSDK_OFFSET(0x1A27DB40)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_DIALOGDATA_GET_UVRECTLIST_OFFSET UNITYSDK_OFFSET(0x1A27CFF0)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_DIALOGDATA_METHOD_1_5D0CCFC50EB9BE02_OFFSET UNITYSDK_OFFSET(0x1A27DBE0)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_DIALOGDATA_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x1A27DB80)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_DIALOGDATA_SET_AUDIOPLAYERGO_OFFSET UNITYSDK_OFFSET(0x1A27DB70)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_DIALOGDATA_SET_LIFETIME_OFFSET UNITYSDK_OFFSET(0x1A27DB30)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_DIALOGDATA_SET_PATTERNCOUNT_OFFSET UNITYSDK_OFFSET(0x1A27DB10)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_DIALOGDATA_SET_STRIPRECT_OFFSET UNITYSDK_OFFSET(0x1A27DB50)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_DIALOGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A27DCB0)

namespace RPG::Client
{
	inline static constexpr unsigned int ComicDialogEmitterBehavior_DialogData_TypeDefinitionIndex = 70839;
