...
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_DIALOGDATA_GET_AUDIOPLAYERGO_OFFSET UNITYSDK_OFFSET(0x9409650)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_DIALOGDATA_GET_LIFETIME_OFFSET UNITYSDK_OFFSET(0x9409610)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_DIALOGDATA_GET_OFFSETSCALELIST_OFFSET UNITYSDK_OFFSET(0x94087E0)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_DIALOGDATA_GET_PATTERNCOUNT_OFFSET UNITYSDK_OFFSET(0x94095F0)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_DIALOGDATA_GET_STRIPRECT_OFFSET UNITYSDK_OFFSET(0x9409630)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_DIALOGDATA_GET_UVRECTLIST_OFFSET UNITYSDK_OFFSET(0x9408740)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_DIALOGDATA_METHOD_1_5D0CCFC50EB9BE02_OFFSET UNITYSDK_OFFSET(0x94096D0)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_DIALOGDATA_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x9409670)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_DIALOGDATA_SET_AUDIOPLAYERGO_OFFSET UNITYSDK_OFFSET(0x9409660)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_DIALOGDATA_SET_LIFETIME_OFFSET UNITYSDK_OFFSET(0x9409620)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_DIALOGDATA_SET_PATTERNCOUNT_OFFSET UNITYSDK_OFFSET(0x9409600)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_DIALOGDATA_SET_STRIPRECT_OFFSET UNITYSDK_OFFSET(0x9409640)
#define RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_DIALOGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x94097A0)

namespace RPG::Client
{
	inline static constexpr unsigned int ComicDialogEmitterBehavior_DialogData_TypeDefinitionIndex = 58053;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32))((::PBYTE)hIl2Cpp + RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_DIALOGDATA_SET_PATTERNCOUNT_OFFSET))(this, value);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_DIALOGDATA_SET_LIFETIME_OFFSET))(this, value);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::Rect))((::PBYTE)hIl2Cpp + RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_DIALOGDATA_SET_STRIPRECT_OFFSET))(this, value);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::GameObject*))((::PBYTE)hIl2Cpp + RPG_CLIENT_COMICDIALOGEMITTERBEHAVIOR_DIALOGDATA_SET_AUDIOPLAYERGO_OFFSET))(this, value);
		}
