...
#define RPG_CLIENT_FIXSTRETCHUV_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xD09EBC0)
#define RPG_CLIENT_FIXSTRETCHUV_METHOD_7_F0088C88851A7DFB_1_OFFSET UNITYSDK_OFFSET(0xD09EBB0)
#define RPG_CLIENT_FIXSTRETCHUV_METHOD_7_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xD09EBA0)
#define RPG_CLIENT_FIXSTRETCHUV__CTOR_OFFSET UNITYSDK_OFFSET(0xD09EC10)
