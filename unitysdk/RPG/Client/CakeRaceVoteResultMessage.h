...
#define RPG_CLIENT_CAKERACEVOTERESULTMESSAGE_CREATE_OFFSET UNITYSDK_OFFSET(0x1AC4EE60)
#define RPG_CLIENT_CAKERACEVOTERESULTMESSAGE_GET_RESULTEFFECTDATA_OFFSET UNITYSDK_OFFSET(0x1AC4F590)
#define RPG_CLIENT_CAKERACEVOTERESULTMESSAGE_GET_RESULTEFFECTINDEX_OFFSET UNITYSDK_OFFSET(0x1AC4F5B0)
#define RPG_CLIENT_CAKERACEVOTERESULTMESSAGE_GET_SELECTEDINDEXINVOTESOFRESULTEFFECT_OFFSET UNITYSDK_OFFSET(0x1AC4F5D0)
#define RPG_CLIENT_CAKERACEVOTERESULTMESSAGE_SET_RESULTEFFECTDATA_OFFSET UNITYSDK_OFFSET(0x1AC4F5A0)
#define RPG_CLIENT_CAKERACEVOTERESULTMESSAGE_SET_RESULTEFFECTINDEX_OFFSET UNITYSDK_OFFSET(0x1AC4F5C0)
#define RPG_CLIENT_CAKERACEVOTERESULTMESSAGE_SET_SELECTEDINDEXINVOTESOFRESULTEFFECT_OFFSET UNITYSDK_OFFSET(0x1AC4F5E0)
#define RPG_CLIENT_CAKERACEVOTERESULTMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC4F580)

namespace RPG::Client
{
	inline static constexpr unsigned int CakeRaceVoteResultMessage_TypeDefinitionIndex = 60289;
