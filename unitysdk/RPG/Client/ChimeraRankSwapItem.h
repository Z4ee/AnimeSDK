...
#define RPG_CLIENT_CHIMERARANKSWAPITEM_AWAKE_OFFSET UNITYSDK_OFFSET(0xA037F20)
#define RPG_CLIENT_CHIMERARANKSWAPITEM_DOSWAP_OFFSET UNITYSDK_OFFSET(0xA0376D0)
#define RPG_CLIENT_CHIMERARANKSWAPITEM_INITSWAPRANK_OFFSET UNITYSDK_OFFSET(0xA037C80)
#define RPG_CLIENT_CHIMERARANKSWAPITEM_METHOD_5_CA6BDDCC5F7CE11E_OFFSET UNITYSDK_OFFSET(0xA038170)
#define RPG_CLIENT_CHIMERARANKSWAPITEM_METHOD_5_E7EF6BC52B28648C_OFFSET UNITYSDK_OFFSET(0xA0381F0)
#define RPG_CLIENT_CHIMERARANKSWAPITEM_SETITEMINDEX_OFFSET UNITYSDK_OFFSET(0xA036B20)
#define RPG_CLIENT_CHIMERARANKSWAPITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xA0382F0)

namespace RPG::Client
{
	inline static constexpr unsigned int ChimeraRankSwapItem_TypeDefinitionIndex = 66783;
