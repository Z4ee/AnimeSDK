...
#define RPG_CLIENT_CHIMERARANKSWAPITEM_AWAKE_OFFSET UNITYSDK_OFFSET(0xB6B5F30)
#define RPG_CLIENT_CHIMERARANKSWAPITEM_DOSWAP_OFFSET UNITYSDK_OFFSET(0xB6B5700)
#define RPG_CLIENT_CHIMERARANKSWAPITEM_INITSWAPRANK_OFFSET UNITYSDK_OFFSET(0xB6B5C80)
#define RPG_CLIENT_CHIMERARANKSWAPITEM_METHOD_5_CA6BDDCC5F7CE11E_OFFSET UNITYSDK_OFFSET(0xB6B61B0)
#define RPG_CLIENT_CHIMERARANKSWAPITEM_METHOD_5_E7EF6BC52B28648C_OFFSET UNITYSDK_OFFSET(0xB6B6230)
#define RPG_CLIENT_CHIMERARANKSWAPITEM_SETITEMINDEX_OFFSET UNITYSDK_OFFSET(0xB6B49F0)
#define RPG_CLIENT_CHIMERARANKSWAPITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xB6B6330)

namespace RPG::Client
{
	inline static constexpr unsigned int ChimeraRankSwapItem_TypeDefinitionIndex = 67723;
