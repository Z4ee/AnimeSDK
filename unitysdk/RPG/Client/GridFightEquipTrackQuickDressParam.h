...
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACKQUICKDRESSPARAM_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A69BE30)
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACKQUICKDRESSPARAM_GET_REFEQUIPITEMDATA_OFFSET UNITYSDK_OFFSET(0x1A69C1B0)
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACKQUICKDRESSPARAM_GET_REFTRACK_OFFSET UNITYSDK_OFFSET(0x1A69C190)
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACKQUICKDRESSPARAM_SET_REFEQUIPITEMDATA_OFFSET UNITYSDK_OFFSET(0x1A69C1C0)
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACKQUICKDRESSPARAM_SET_REFTRACK_OFFSET UNITYSDK_OFFSET(0x1A69C1A0)
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACKQUICKDRESSPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A698CA0)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightEquipTrackQuickDressParam_TypeDefinitionIndex = 62417;
