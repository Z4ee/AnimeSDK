...
#define RPG_CLIENT_WOLFBROGUNPLAYTARGETACTIONCONFIG_DIE_METHOD_2_47FCE72550F759BF_OFFSET UNITYSDK_OFFSET(0xCC3DCD0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGETACTIONCONFIG_DIE_METHOD_2_F8B73ECE7F883AC1_OFFSET UNITYSDK_OFFSET(0xCC3DD60)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGETACTIONCONFIG_DIE__CTOR_OFFSET UNITYSDK_OFFSET(0xCC3DD50)

namespace RPG::Client
{
	inline static constexpr unsigned int WolfBroGunPlayTargetActionConfig_Die_TypeDefinitionIndex = 64269;
