...
#define RPG_CLIENT_SIGNALTRANSFORMPROCESSOR_GET_PROGRESS_OFFSET UNITYSDK_OFFSET(0x188DFB40)
#define RPG_CLIENT_SIGNALTRANSFORMPROCESSOR_GET_SHOULDPLAYCURVE_OFFSET UNITYSDK_OFFSET(0x188DFB50)
#define RPG_CLIENT_SIGNALTRANSFORMPROCESSOR_METHOD_1_62BBF6FB1430C4E2_OFFSET UNITYSDK_OFFSET(0x188DF7E0)
#define RPG_CLIENT_SIGNALTRANSFORMPROCESSOR_METHOD_1_9E3751A8C9767297_OFFSET UNITYSDK_OFFSET(0x188DF970)
#define RPG_CLIENT_SIGNALTRANSFORMPROCESSOR_METHOD_1_A3CE3797867F0E52_OFFSET UNITYSDK_OFFSET(0x188DF5E0)
#define RPG_CLIENT_SIGNALTRANSFORMPROCESSOR_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x188DFA60)
#define RPG_CLIENT_SIGNALTRANSFORMPROCESSOR_METHOD_1_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0x188DFAB0)
#define RPG_CLIENT_SIGNALTRANSFORMPROCESSOR_METHOD_1_CA373AA1C7054598_3_OFFSET UNITYSDK_OFFSET(0x188DFAF0)
#define RPG_CLIENT_SIGNALTRANSFORMPROCESSOR_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x188DFA10)
#define RPG_CLIENT_SIGNALTRANSFORMPROCESSOR_METHOD_1_D437D090E63BE8A7_OFFSET UNITYSDK_OFFSET(0x188DF8F0)
#define RPG_CLIENT_SIGNALTRANSFORMPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x188DFB60)

namespace RPG::Client
{
	inline static constexpr unsigned int SignalTransformProcessor_TypeDefinitionIndex = 67786;
