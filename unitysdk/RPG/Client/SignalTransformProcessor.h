...
#define RPG_CLIENT_SIGNALTRANSFORMPROCESSOR_GET_PROGRESS_OFFSET UNITYSDK_OFFSET(0xB170640)
#define RPG_CLIENT_SIGNALTRANSFORMPROCESSOR_GET_SHOULDPLAYCURVE_OFFSET UNITYSDK_OFFSET(0xB170650)
#define RPG_CLIENT_SIGNALTRANSFORMPROCESSOR_METHOD_1_62BBF6FB1430C4E2_OFFSET UNITYSDK_OFFSET(0xB1702E0)
#define RPG_CLIENT_SIGNALTRANSFORMPROCESSOR_METHOD_1_9E3751A8C9767297_OFFSET UNITYSDK_OFFSET(0xB170470)
#define RPG_CLIENT_SIGNALTRANSFORMPROCESSOR_METHOD_1_A3CE3797867F0E52_OFFSET UNITYSDK_OFFSET(0xB1700E0)
#define RPG_CLIENT_SIGNALTRANSFORMPROCESSOR_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xB170560)
#define RPG_CLIENT_SIGNALTRANSFORMPROCESSOR_METHOD_1_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0xB1705B0)
#define RPG_CLIENT_SIGNALTRANSFORMPROCESSOR_METHOD_1_CA373AA1C7054598_3_OFFSET UNITYSDK_OFFSET(0xB1705F0)
#define RPG_CLIENT_SIGNALTRANSFORMPROCESSOR_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xB170510)
#define RPG_CLIENT_SIGNALTRANSFORMPROCESSOR_METHOD_1_D437D090E63BE8A7_OFFSET UNITYSDK_OFFSET(0xB1703F0)
#define RPG_CLIENT_SIGNALTRANSFORMPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0xB170660)

namespace RPG::Client
{
	inline static constexpr unsigned int SignalTransformProcessor_TypeDefinitionIndex = 65434;
