...
#define RPG_CLIENT_LISTVIEW_CLASS_1_AD72E0B1916E8FE9_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xD4A7050)
#define RPG_CLIENT_LISTVIEW_CLASS_1_AD72E0B1916E8FE9_GET_COUNT_OFFSET UNITYSDK_OFFSET(0xD4A6DB0)
#define RPG_CLIENT_LISTVIEW_CLASS_1_AD72E0B1916E8FE9_GET_ITEM_OFFSET UNITYSDK_OFFSET(0xD4A6E80)
#define RPG_CLIENT_LISTVIEW_CLASS_1_AD72E0B1916E8FE9_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xD4A70E0)
#define RPG_CLIENT_LISTVIEW_CLASS_1_AD72E0B1916E8FE9__CTOR_OFFSET UNITYSDK_OFFSET(0xD4A47E0)

namespace RPG::Client
{
	inline static constexpr unsigned int ListView_Class_1_AD72E0B1916E8FE9_TypeDefinitionIndex = 72485;
