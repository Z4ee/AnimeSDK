...
#define RPG_CLIENT_SHOTANIMMOVEMENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF84080)

namespace RPG::Client
{
	inline static constexpr unsigned int ShotAnimMovementData_TypeDefinitionIndex = 69611;
