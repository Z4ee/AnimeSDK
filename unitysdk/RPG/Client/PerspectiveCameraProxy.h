...
#define RPG_CLIENT_PERSPECTIVECAMERAPROXY_GET_TARGETCAMERA_OFFSET UNITYSDK_OFFSET(0xDA62DF0)
#define RPG_CLIENT_PERSPECTIVECAMERAPROXY_START_OFFSET UNITYSDK_OFFSET(0xDA62E30)
#define RPG_CLIENT_PERSPECTIVECAMERAPROXY_UPDATE_OFFSET UNITYSDK_OFFSET(0xDA62F20)
#define RPG_CLIENT_PERSPECTIVECAMERAPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0xDA63210)

namespace RPG::Client
{
	inline static constexpr unsigned int PerspectiveCameraProxy_TypeDefinitionIndex = 72549;
