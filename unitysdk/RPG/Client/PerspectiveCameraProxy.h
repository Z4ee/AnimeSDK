...
#define RPG_CLIENT_PERSPECTIVECAMERAPROXY_START_OFFSET UNITYSDK_OFFSET(0x9F357B0)
#define RPG_CLIENT_PERSPECTIVECAMERAPROXY_UPDATE_OFFSET UNITYSDK_OFFSET(0x9F358A0)
#define RPG_CLIENT_PERSPECTIVECAMERAPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x9F35BA0)

namespace RPG::Client
{
	inline static constexpr unsigned int PerspectiveCameraProxy_TypeDefinitionIndex = 59519;
