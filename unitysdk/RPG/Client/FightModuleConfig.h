...
#define RPG_CLIENT_FIGHTMODULECONFIG_METHOD_4_2BF4648671111A7E_OFFSET UNITYSDK_OFFSET(0x1AE5EED0)
#define RPG_CLIENT_FIGHTMODULECONFIG_METHOD_4_4C94E33B8854BB0A_OFFSET UNITYSDK_OFFSET(0x1AE5EF20)
#define RPG_CLIENT_FIGHTMODULECONFIG_METHOD_4_86E87AB4982311F8_OFFSET UNITYSDK_OFFSET(0x1AE5F2B0)
#define RPG_CLIENT_FIGHTMODULECONFIG_METHOD_4_B78DF254F2280415_OFFSET UNITYSDK_OFFSET(0x1AE5F360)
#define RPG_CLIENT_FIGHTMODULECONFIG_METHOD_4_BB68B265491E92AD_1_OFFSET UNITYSDK_OFFSET(0x1AE5F200)
#define RPG_CLIENT_FIGHTMODULECONFIG_METHOD_4_BB68B265491E92AD_OFFSET UNITYSDK_OFFSET(0x1AE5F130)
#define RPG_CLIENT_FIGHTMODULECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE5F430)

namespace RPG::Client
{
	inline static constexpr unsigned int FightModuleConfig_TypeDefinitionIndex = 69638;
	...
	public:
		...
		::RPG::Client::CameraNamedDynamicOffset* Method_4_4C94E33B8854BB0A(::System::String* a1)
		{
			return ((::RPG::Client::CameraNamedDynamicOffset*(*)(::PVOID, ::System::String*))((::PBYTE)hIl2Cpp + RPG_CLIENT_FIGHTMODULECONFIG_METHOD_4_4C94E33B8854BB0A_OFFSET))(this, a1);
		}
