...
#define RPG_CLIENT_EMOEYECTRL_EYELOOKATCURVEBLEND_GETBLEND_OFFSET UNITYSDK_OFFSET(0x39CB7C0)
#define RPG_CLIENT_EMOEYECTRL_EYELOOKATCURVEBLEND_GET_INITIALIZED_OFFSET UNITYSDK_OFFSET(0x39CB660)
#define RPG_CLIENT_EMOEYECTRL_EYELOOKATCURVEBLEND_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x39CB680)
#define RPG_CLIENT_EMOEYECTRL_EYELOOKATCURVEBLEND_SET_INITIALIZED_OFFSET UNITYSDK_OFFSET(0x39CB670)
#define RPG_CLIENT_EMOEYECTRL_EYELOOKATCURVEBLEND_UNINITIALIZE_OFFSET UNITYSDK_OFFSET(0x39CB770)
#define RPG_CLIENT_EMOEYECTRL_EYELOOKATCURVEBLEND_UPDATEBLEND_OFFSET UNITYSDK_OFFSET(0x39CB840)

namespace RPG::Client
{
	inline static constexpr unsigned int EmoEyeCtrl_EyeLookAtCurveBlend_TypeDefinitionIndex = 67923;
