...
#define RPG_CLIENT_ASSETSYSTEM_ASSETOBJECTOPTPROXY_ADDLOADEDHANDLE_OFFSET UNITYSDK_OFFSET(0x1892B6B0)
#define RPG_CLIENT_ASSETSYSTEM_ASSETOBJECTOPTPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1892B520)
#define RPG_CLIENT_ASSETSYSTEM_ASSETOBJECTOPTPROXY_FORCESYNCLOAD_OFFSET UNITYSDK_OFFSET(0x1892ABE0)
#define RPG_CLIENT_ASSETSYSTEM_ASSETOBJECTOPTPROXY_GETASSETOBJECT_OFFSET UNITYSDK_OFFSET(0x1892AC30)
#define RPG_CLIENT_ASSETSYSTEM_ASSETOBJECTOPTPROXY_GETLOADER_OFFSET UNITYSDK_OFFSET(0x1892B140)
#define RPG_CLIENT_ASSETSYSTEM_ASSETOBJECTOPTPROXY_GETUSERPARAM_OFFSET UNITYSDK_OFFSET(0x1892B0B0)
#define RPG_CLIENT_ASSETSYSTEM_ASSETOBJECTOPTPROXY_GET_ASSETLOADER_OFFSET UNITYSDK_OFFSET(0x1892A7E0)
#define RPG_CLIENT_ASSETSYSTEM_ASSETOBJECTOPTPROXY_GET_ASSETNAME_OFFSET UNITYSDK_OFFSET(0x1892A840)
#define RPG_CLIENT_ASSETSYSTEM_ASSETOBJECTOPTPROXY_GET_ASSETOPERATIONINDEX_OFFSET UNITYSDK_OFFSET(0x1892A820)
#define RPG_CLIENT_ASSETSYSTEM_ASSETOBJECTOPTPROXY_GET_ASSETSTATE_OFFSET UNITYSDK_OFFSET(0x1892A900)
#define RPG_CLIENT_ASSETSYSTEM_ASSETOBJECTOPTPROXY_GET_ASSETTYPE_OFFSET UNITYSDK_OFFSET(0x1892A8A0)
#define RPG_CLIENT_ASSETSYSTEM_ASSETOBJECTOPTPROXY_ISFAILED_OFFSET UNITYSDK_OFFSET(0x1892AA70)
#define RPG_CLIENT_ASSETSYSTEM_ASSETOBJECTOPTPROXY_ISHANDLECALLED_OFFSET UNITYSDK_OFFSET(0x1892AB90)
#define RPG_CLIENT_ASSETSYSTEM_ASSETOBJECTOPTPROXY_ISLOADED_OFFSET UNITYSDK_OFFSET(0x1892A970)
#define RPG_CLIENT_ASSETSYSTEM_ASSETOBJECTOPTPROXY_ISLOADING_OFFSET UNITYSDK_OFFSET(0x1892AAF0)
#define RPG_CLIENT_ASSETSYSTEM_ASSETOBJECTOPTPROXY_ISSUCCEED_OFFSET UNITYSDK_OFFSET(0x1892A9F0)
#define RPG_CLIENT_ASSETSYSTEM_ASSETOBJECTOPTPROXY_ONASSETOBJECTLOADED_OFFSET UNITYSDK_OFFSET(0x18929D00)
#define RPG_CLIENT_ASSETSYSTEM_ASSETOBJECTOPTPROXY_REMOVELOADEDHANDLE_OFFSET UNITYSDK_OFFSET(0x1892B7D0)
#define RPG_CLIENT_ASSETSYSTEM_ASSETOBJECTOPTPROXY_RESETLOADEDHANDLE_OFFSET UNITYSDK_OFFSET(0x1892B850)
#define RPG_CLIENT_ASSETSYSTEM_ASSETOBJECTOPTPROXY_SETASSETLOADER_OFFSET UNITYSDK_OFFSET(0x1892B8E0)
#define RPG_CLIENT_ASSETSYSTEM_ASSETOBJECTOPTPROXY_SETUSERPARAM_OFFSET UNITYSDK_OFFSET(0x1892B0F0)
#define RPG_CLIENT_ASSETSYSTEM_ASSETOBJECTOPTPROXY_SET_ASSETOPERATIONINDEX_OFFSET UNITYSDK_OFFSET(0x1892A830)
#define RPG_CLIENT_ASSETSYSTEM_ASSETOBJECTOPTPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1892BE50)
#define RPG_CLIENT_ASSETSYSTEM_ASSETOBJECTOPTPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x1892A960)
#define RPG_CLIENT_ASSETSYSTEM_ASSETOBJECTOPTPROXY___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1892BFD0)
