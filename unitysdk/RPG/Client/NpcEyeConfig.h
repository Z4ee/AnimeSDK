...
#define RPG_CLIENT_NPCEYECONFIG_AWAKE_OFFSET UNITYSDK_OFFSET(0x9E915A0)
#define RPG_CLIENT_NPCEYECONFIG_METHOD_3_224AD0AC2C730EE1_OFFSET UNITYSDK_OFFSET(0x9E91810)
#define RPG_CLIENT_NPCEYECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x9E91910)

namespace RPG::Client
{
	inline static constexpr unsigned int NpcEyeConfig_TypeDefinitionIndex = 48654;
