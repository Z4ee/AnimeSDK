...
#define RPG_CLIENT_FABRIK_WEAPONCONTROL_ATTACHANIMSTATE_OFFSET UNITYSDK_OFFSET(0x9653C20)
#define RPG_CLIENT_FABRIK_WEAPONCONTROL_IKRESET_OFFSET UNITYSDK_OFFSET(0x9654130)
#define RPG_CLIENT_FABRIK_WEAPONCONTROL_ISATTACHANIMFIT_OFFSET UNITYSDK_OFFSET(0x9653BC0)
#define RPG_CLIENT_FABRIK_WEAPONCONTROL_LOCKWEAPONHAND_OFFSET UNITYSDK_OFFSET(0x9653C80)
#define RPG_CLIENT_FABRIK_WEAPONCONTROL_PROTECTOTHERHANDS_OFFSET UNITYSDK_OFFSET(0x9653FE0)
#define RPG_CLIENT_FABRIK_WEAPONCONTROL_STOP_OFFSET UNITYSDK_OFFSET(0x9654070)
#define RPG_CLIENT_FABRIK_WEAPONCONTROL_TICK_OFFSET UNITYSDK_OFFSET(0x9654320)
#define RPG_CLIENT_FABRIK_WEAPONCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x96552D0)

namespace RPG::Client
{
	inline static constexpr unsigned int FABRIK_WeaponControl_TypeDefinitionIndex = 55853;
