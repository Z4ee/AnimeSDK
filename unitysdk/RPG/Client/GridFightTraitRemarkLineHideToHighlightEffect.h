...
#define RPG_CLIENT_GRIDFIGHTTRAITREMARKLINEHIDETOHIGHLIGHTEFFECT_GET_CURRENTCOLORTYPE_OFFSET UNITYSDK_OFFSET(0x98D5A40)
#define RPG_CLIENT_GRIDFIGHTTRAITREMARKLINEHIDETOHIGHLIGHTEFFECT_GET_ISHIGHLIGHT_OFFSET UNITYSDK_OFFSET(0x98D5C20)
#define RPG_CLIENT_GRIDFIGHTTRAITREMARKLINEHIDETOHIGHLIGHTEFFECT_GET_ISSHOW_OFFSET UNITYSDK_OFFSET(0x98D5B40)
#define RPG_CLIENT_GRIDFIGHTTRAITREMARKLINEHIDETOHIGHLIGHTEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x98D4CA0)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightTraitRemarkLineHideToHighlightEffect_TypeDefinitionIndex = 53147;
