...
#define RPG_CLIENT_EFFECT_ABYSSCRYSTALMANAGER_ANIMATIONPLAY_OFFSET UNITYSDK_OFFSET(0x17733EE0)
#define RPG_CLIENT_EFFECT_ABYSSCRYSTALMANAGER_GETCRYSTALANIFROMNODE_OFFSET UNITYSDK_OFFSET(0x177336F0)
#define RPG_CLIENT_EFFECT_ABYSSCRYSTALMANAGER_GET_ISALTERNATEMODE_OFFSET UNITYSDK_OFFSET(0x17731F80)
#define RPG_CLIENT_EFFECT_ABYSSCRYSTALMANAGER_INITCRYSTALMAT_OFFSET UNITYSDK_OFFSET(0x17731FE0)
#define RPG_CLIENT_EFFECT_ABYSSCRYSTALMANAGER_INITSETCRYSTALMAT_OFFSET UNITYSDK_OFFSET(0x17733BB0)
#define RPG_CLIENT_EFFECT_ABYSSCRYSTALMANAGER_INITSETCRYSTALSHINESCRIPT_OFFSET UNITYSDK_OFFSET(0x17733D70)
#define RPG_CLIENT_EFFECT_ABYSSCRYSTALMANAGER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x17732270)
#define RPG_CLIENT_EFFECT_ABYSSCRYSTALMANAGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x17733FB0)
#define RPG_CLIENT_EFFECT_ABYSSCRYSTALMANAGER_SETAUREOLEANI_OFFSET UNITYSDK_OFFSET(0x17732A50)
#define RPG_CLIENT_EFFECT_ABYSSCRYSTALMANAGER_SETCRYSTALCENTERWEIGHT_OFFSET UNITYSDK_OFFSET(0x177322C0)
#define RPG_CLIENT_EFFECT_ABYSSCRYSTALMANAGER_START_OFFSET UNITYSDK_OFFSET(0x17731F90)
#define RPG_CLIENT_EFFECT_ABYSSCRYSTALMANAGER_SWITCHCRYSTALMODE_OFFSET UNITYSDK_OFFSET(0x17733990)
#define RPG_CLIENT_EFFECT_ABYSSCRYSTALMANAGER_UNLOCKCRYSTAL_OFFSET UNITYSDK_OFFSET(0x17733890)
#define RPG_CLIENT_EFFECT_ABYSSCRYSTALMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x17734020)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_AbyssCrystalManager_TypeDefinitionIndex = 67263;
