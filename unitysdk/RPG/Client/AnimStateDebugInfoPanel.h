...
#define RPG_CLIENT_ANIMSTATEDEBUGINFOPANEL__CTOR_OFFSET UNITYSDK_OFFSET(0x19C8D160)

namespace RPG::Client
{
	inline static constexpr unsigned int AnimStateDebugInfoPanel_TypeDefinitionIndex = 72655;
