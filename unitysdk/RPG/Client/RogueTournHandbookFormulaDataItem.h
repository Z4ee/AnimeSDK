...
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_CREATE_OFFSET UNITYSDK_OFFSET(0xB0CD350)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_CATEGORY_OFFSET UNITYSDK_OFFSET(0xB0CDF40)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_DESCPARAMS_OFFSET UNITYSDK_OFFSET(0xB0CE1C0)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_DESC_OFFSET UNITYSDK_OFFSET(0xB0CDFC0)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_EXTRAEFFECTIDS_OFFSET UNITYSDK_OFFSET(0xB0CE220)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_FORMULADATA_OFFSET UNITYSDK_OFFSET(0xB0CDE90)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_FORMULAID_OFFSET UNITYSDK_OFFSET(0xB0CD3C0)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_ISSUBBUFFTYPEREQUIRED_OFFSET UNITYSDK_OFFSET(0xB0CE340)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0xB0CE3D0)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_LOCKEDDESC_OFFSET UNITYSDK_OFFSET(0xB0CE050)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_MAINAEONICONPATH_OFFSET UNITYSDK_OFFSET(0xB0CDDF0)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_MAINBUFFCOUNTITEM_OFFSET UNITYSDK_OFFSET(0xB0CE2A0)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_MAINBUFFTYPE_OFFSET UNITYSDK_OFFSET(0xB0CE240)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_NAME_OFFSET UNITYSDK_OFFSET(0xB0CDEA0)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_SUBAEONICONPATH_OFFSET UNITYSDK_OFFSET(0xB0CDE10)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_SUBBUFFCOUNTITEM_OFFSET UNITYSDK_OFFSET(0xB0CE320)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET_SUBBUFFTYPE_OFFSET UNITYSDK_OFFSET(0xB0CE2C0)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET__DISPLAYROW_OFFSET UNITYSDK_OFFSET(0xB0CE460)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET__LOCKEDDESCDISPLAYROW_OFFSET UNITYSDK_OFFSET(0xB0CE140)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_GET__ROW_OFFSET UNITYSDK_OFFSET(0xB0CE3F0)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_SET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0xB0CE3E0)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM_SYNCUNLOCKED_OFFSET UNITYSDK_OFFSET(0xB0CDE40)
#define RPG_CLIENT_ROGUETOURNHANDBOOKFORMULADATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xB0CDE30)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueTournHandbookFormulaDataItem_TypeDefinitionIndex = 62366;
