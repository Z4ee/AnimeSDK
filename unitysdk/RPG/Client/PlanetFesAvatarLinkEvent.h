...
#define RPG_CLIENT_PLANETFESAVATARLINKEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x9F87A60)

namespace RPG::Client
{
	inline static constexpr unsigned int PlanetFesAvatarLinkEvent_TypeDefinitionIndex = 54218;
