...
#define RPG_CLIENT_PLANETFESAVATARLINKEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A95CA10)

namespace RPG::Client
{
	inline static constexpr unsigned int PlanetFesAvatarLinkEvent_TypeDefinitionIndex = 63671;
