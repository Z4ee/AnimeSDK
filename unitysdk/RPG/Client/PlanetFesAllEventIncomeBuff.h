...
#define RPG_CLIENT_PLANETFESALLEVENTINCOMEBUFF_COMBINE_OFFSET UNITYSDK_OFFSET(0xDB2E880)
#define RPG_CLIENT_PLANETFESALLEVENTINCOMEBUFF_GETCOMBINEKEY_OFFSET UNITYSDK_OFFSET(0xDB2E930)
#define RPG_CLIENT_PLANETFESALLEVENTINCOMEBUFF_GET_PERCENTINCREASE_OFFSET UNITYSDK_OFFSET(0xDB2E750)
#define RPG_CLIENT_PLANETFESALLEVENTINCOMEBUFF_ISEFFECTIVEONAVATAR_OFFSET UNITYSDK_OFFSET(0xDB2E7F0)
#define RPG_CLIENT_PLANETFESALLEVENTINCOMEBUFF_ISTRIGGERED_OFFSET UNITYSDK_OFFSET(0xDB2E840)
#define RPG_CLIENT_PLANETFESALLEVENTINCOMEBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0xDB2E990)
#define RPG_CLIENT_PLANETFESALLEVENTINCOMEBUFF__ONINITPARAM_OFFSET UNITYSDK_OFFSET(0xDB2E790)
