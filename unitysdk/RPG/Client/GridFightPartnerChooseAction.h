...
#define RPG_CLIENT_GRIDFIGHTPARTNERCHOOSEACTION_GET_ROLEOPTIONS_OFFSET UNITYSDK_OFFSET(0x1BC5CC70)
#define RPG_CLIENT_GRIDFIGHTPARTNERCHOOSEACTION_SELECTMEMBER_OFFSET UNITYSDK_OFFSET(0x1BC5CBB0)
#define RPG_CLIENT_GRIDFIGHTPARTNERCHOOSEACTION_SET_ROLEOPTIONS_OFFSET UNITYSDK_OFFSET(0x1BC5CC80)
#define RPG_CLIENT_GRIDFIGHTPARTNERCHOOSEACTION_SYNC_OFFSET UNITYSDK_OFFSET(0x1BC5C9C0)
#define RPG_CLIENT_GRIDFIGHTPARTNERCHOOSEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC5C9B0)
