...
#define RPG_CLIENT_ALLEYUTILS___C__DISPLAYCLASS0_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9D1B1B0)
#define RPG_CLIENT_ALLEYUTILS___C__DISPLAYCLASS0_0__SHOWALLEYMAINENTRANCEPAGE_B__0_OFFSET UNITYSDK_OFFSET(0x9D1B680)
