...
#define RPG_CLIENT_ELFHINTTOASTMANAGER___CHECKSHOPTRADEORDERHINTS_D__9_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xCE568D0)
#define RPG_CLIENT_ELFHINTTOASTMANAGER___CHECKSHOPTRADEORDERHINTS_D__9_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_RPG_CLIENT_ELFHINTHANDLER__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xCE56B30)
#define RPG_CLIENT_ELFHINTTOASTMANAGER___CHECKSHOPTRADEORDERHINTS_D__9_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_RPG_CLIENT_ELFHINTHANDLER__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xCE56AC0)
#define RPG_CLIENT_ELFHINTTOASTMANAGER___CHECKSHOPTRADEORDERHINTS_D__9_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xCE56BB0)
#define RPG_CLIENT_ELFHINTTOASTMANAGER___CHECKSHOPTRADEORDERHINTS_D__9_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xCE56B20)
#define RPG_CLIENT_ELFHINTTOASTMANAGER___CHECKSHOPTRADEORDERHINTS_D__9_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xCE56AD0)
#define RPG_CLIENT_ELFHINTTOASTMANAGER___CHECKSHOPTRADEORDERHINTS_D__9_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xCE568C0)
#define RPG_CLIENT_ELFHINTTOASTMANAGER___CHECKSHOPTRADEORDERHINTS_D__9__CTOR_OFFSET UNITYSDK_OFFSET(0xCE554F0)

namespace RPG::Client
{
	inline static constexpr unsigned int ElfHintToastManager___CheckShopTradeOrderHints_d__9_TypeDefinitionIndex = 63771;

	class ElfHintToastManager___CheckShopTradeOrderHints_d__9 : public ::System::Object
	{
	public:
		::RPG::Client::ElfRestaurantModule* elfModule; // 0x10
		::RPG::Client::UserPrefs* __3__userPrefs; // 0x18
		::RPG::Client::UserPrefs* userPrefs; // 0x20
		::RPG::Client::ElfRestaurantModule* __3__elfModule; // 0x28
