...
#define RPG_CLIENT_ELFHINTTOASTMANAGER___CHECKSHOPTRADEORDERHINTS_D__9_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x18E3BBD0)
#define RPG_CLIENT_ELFHINTTOASTMANAGER___CHECKSHOPTRADEORDERHINTS_D__9_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_RPG_CLIENT_ELFHINTHANDLER__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x18E3BE30)
#define RPG_CLIENT_ELFHINTTOASTMANAGER___CHECKSHOPTRADEORDERHINTS_D__9_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_RPG_CLIENT_ELFHINTHANDLER__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x18E3BDC0)
#define RPG_CLIENT_ELFHINTTOASTMANAGER___CHECKSHOPTRADEORDERHINTS_D__9_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x18E3BEB0)
#define RPG_CLIENT_ELFHINTTOASTMANAGER___CHECKSHOPTRADEORDERHINTS_D__9_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x18E3BE20)
#define RPG_CLIENT_ELFHINTTOASTMANAGER___CHECKSHOPTRADEORDERHINTS_D__9_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x18E3BDD0)
#define RPG_CLIENT_ELFHINTTOASTMANAGER___CHECKSHOPTRADEORDERHINTS_D__9_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18E3BBC0)
#define RPG_CLIENT_ELFHINTTOASTMANAGER___CHECKSHOPTRADEORDERHINTS_D__9__CTOR_OFFSET UNITYSDK_OFFSET(0x18E3A7F0)

namespace RPG::Client
{
	inline static constexpr unsigned int ElfHintToastManager___CheckShopTradeOrderHints_d__9_TypeDefinitionIndex = 60918;

	class ElfHintToastManager___CheckShopTradeOrderHints_d__9 : public ::System::Object
	{
	public:
		::RPG::Client::UserPrefs* __3__userPrefs; // 0x10
		::RPG::Client::ElfRestaurantModule* __3__elfModule; // 0x18
		::RPG::Client::ElfHintHandler* __2__current; // 0x20
		::RPG::Client::ElfRestaurantModule* elfModule; // 0x28
		::RPG::Client::UserPrefs* userPrefs; // 0x30
		::System::Int32 __1__state; // 0x38
		::System::Int32 __l__initialThreadId; // 0x3C

		::System::Void _ctor(::System::Int32 a1)
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32))((::PBYTE)hIl2Cpp + RPG_CLIENT_ELFHINTTOASTMANAGER___CHECKSHOPTRADEORDERHINTS_D__9__CTOR_OFFSET))(this, a1);
		}
