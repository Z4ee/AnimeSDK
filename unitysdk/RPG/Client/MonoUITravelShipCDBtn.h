...
#define RPG_CLIENT_MONOUITRAVELSHIPCDBTN_ACTION_OFFSET UNITYSDK_OFFSET(0xAA11730)
#define RPG_CLIENT_MONOUITRAVELSHIPCDBTN_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xAA11690)
#define RPG_CLIENT_MONOUITRAVELSHIPCDBTN_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xAA115E0)
#define RPG_CLIENT_MONOUITRAVELSHIPCDBTN_ONENABLE_OFFSET UNITYSDK_OFFSET(0xAA114C0)
#define RPG_CLIENT_MONOUITRAVELSHIPCDBTN_SETTIMEUPEVENT_OFFSET UNITYSDK_OFFSET(0xAA116E0)
#define RPG_CLIENT_MONOUITRAVELSHIPCDBTN_START_OFFSET UNITYSDK_OFFSET(0xAA112A0)
#define RPG_CLIENT_MONOUITRAVELSHIPCDBTN_UPDATE_OFFSET UNITYSDK_OFFSET(0xAA112E0)
#define RPG_CLIENT_MONOUITRAVELSHIPCDBTN__CTOR_OFFSET UNITYSDK_OFFSET(0xAA11780)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoUITravelShipCDBtn_TypeDefinitionIndex = 63637;
