...
#define RPG_CLIENT_MONOATTACKHITBOX_CLASS_3_A1231C7CCD391D53_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18076C70)
#define RPG_CLIENT_MONOATTACKHITBOX_CLASS_3_A1231C7CCD391D53_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18076CF0)
#define RPG_CLIENT_MONOATTACKHITBOX_CLASS_3_A1231C7CCD391D53_INVOKE_OFFSET UNITYSDK_OFFSET(0x18076A90)
#define RPG_CLIENT_MONOATTACKHITBOX_CLASS_3_A1231C7CCD391D53__CTOR_OFFSET UNITYSDK_OFFSET(0x18076B80)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoAttackHitBox_Class_3_A1231C7CCD391D53_TypeDefinitionIndex = 65481;
