...
#define RPG_CLIENT_EFFECT_WINGINSTANCEMANAGERBEHAVIOR_GET__OWNER_OFFSET UNITYSDK_OFFSET(0x15137BC0)
#define RPG_CLIENT_EFFECT_WINGINSTANCEMANAGERBEHAVIOR_LATETICK_OFFSET UNITYSDK_OFFSET(0x151378D0)
#define RPG_CLIENT_EFFECT_WINGINSTANCEMANAGERBEHAVIOR_METHOD_3_3B258437A86233AC_OFFSET UNITYSDK_OFFSET(0x15137560)
#define RPG_CLIENT_EFFECT_WINGINSTANCEMANAGERBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0x151374F0)
#define RPG_CLIENT_EFFECT_WINGINSTANCEMANAGERBEHAVIOR_METHOD_3_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0x15137870)
#define RPG_CLIENT_EFFECT_WINGINSTANCEMANAGERBEHAVIOR_METHOD_3_4343F372F34C05BF_3_OFFSET UNITYSDK_OFFSET(0x15137FB0)
#define RPG_CLIENT_EFFECT_WINGINSTANCEMANAGERBEHAVIOR_METHOD_3_4343F372F34C05BF_4_OFFSET UNITYSDK_OFFSET(0x15138010)
#define RPG_CLIENT_EFFECT_WINGINSTANCEMANAGERBEHAVIOR_METHOD_3_4343F372F34C05BF_5_OFFSET UNITYSDK_OFFSET(0x15138070)
#define RPG_CLIENT_EFFECT_WINGINSTANCEMANAGERBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x15137490)
#define RPG_CLIENT_EFFECT_WINGINSTANCEMANAGERBEHAVIOR_METHOD_3_A40475C44AA8CEAB_OFFSET UNITYSDK_OFFSET(0x15137E90)
#define RPG_CLIENT_EFFECT_WINGINSTANCEMANAGERBEHAVIOR_METHOD_3_AB88190D695EBEA9_OFFSET UNITYSDK_OFFSET(0x15137C40)
#define RPG_CLIENT_EFFECT_WINGINSTANCEMANAGERBEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x151380E0)
#define RPG_CLIENT_EFFECT_WINGINSTANCEMANAGERBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x151380D0)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_WingInstanceManagerBehavior_TypeDefinitionIndex = 67375;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Effect_WingInstanceManagerBehavior_TypeDefinitionIndex)->GetStaticField(0x14930);
		}
