...
#define RPG_CLIENT_EFFECT_WINGINSTANCEMANAGERBEHAVIOR_GET__OWNER_OFFSET UNITYSDK_OFFSET(0x1AC53240)
#define RPG_CLIENT_EFFECT_WINGINSTANCEMANAGERBEHAVIOR_LATETICK_OFFSET UNITYSDK_OFFSET(0x1AC52F50)
#define RPG_CLIENT_EFFECT_WINGINSTANCEMANAGERBEHAVIOR_METHOD_3_3B258437A86233AC_OFFSET UNITYSDK_OFFSET(0x1AC52BE0)
#define RPG_CLIENT_EFFECT_WINGINSTANCEMANAGERBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0x1AC52B70)
#define RPG_CLIENT_EFFECT_WINGINSTANCEMANAGERBEHAVIOR_METHOD_3_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0x1AC52EF0)
#define RPG_CLIENT_EFFECT_WINGINSTANCEMANAGERBEHAVIOR_METHOD_3_4343F372F34C05BF_3_OFFSET UNITYSDK_OFFSET(0x1AC53630)
#define RPG_CLIENT_EFFECT_WINGINSTANCEMANAGERBEHAVIOR_METHOD_3_4343F372F34C05BF_4_OFFSET UNITYSDK_OFFSET(0x1AC53690)
#define RPG_CLIENT_EFFECT_WINGINSTANCEMANAGERBEHAVIOR_METHOD_3_4343F372F34C05BF_5_OFFSET UNITYSDK_OFFSET(0x1AC536F0)
#define RPG_CLIENT_EFFECT_WINGINSTANCEMANAGERBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x1AC52B10)
#define RPG_CLIENT_EFFECT_WINGINSTANCEMANAGERBEHAVIOR_METHOD_3_A40475C44AA8CEAB_OFFSET UNITYSDK_OFFSET(0x1AC53510)
#define RPG_CLIENT_EFFECT_WINGINSTANCEMANAGERBEHAVIOR_METHOD_3_AB88190D695EBEA9_OFFSET UNITYSDK_OFFSET(0x1AC532C0)
#define RPG_CLIENT_EFFECT_WINGINSTANCEMANAGERBEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AC53760)
#define RPG_CLIENT_EFFECT_WINGINSTANCEMANAGERBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC53750)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Effect_WingInstanceManagerBehavior_TypeDefinitionIndex)->GetStaticField(0x141B0);
		}
