...
#define RPG_CLIENT_GRIDFIGHTTRAITREMARKLINEEFFECTBASE_GET_ORDER_OFFSET UNITYSDK_OFFSET(0x1A60DB10)
#define RPG_CLIENT_GRIDFIGHTTRAITREMARKLINEEFFECTBASE_GET_STATEPARSER_OFFSET UNITYSDK_OFFSET(0x1A60DAF0)
#define RPG_CLIENT_GRIDFIGHTTRAITREMARKLINEEFFECTBASE_GET_TEXTID_OFFSET UNITYSDK_OFFSET(0x1A60DA40)
#define RPG_CLIENT_GRIDFIGHTTRAITREMARKLINEEFFECTBASE_GET_TEXTPARAMLIST_OFFSET UNITYSDK_OFFSET(0x1A60DAA0)
#define RPG_CLIENT_GRIDFIGHTTRAITREMARKLINEEFFECTBASE_SET_STATEPARSER_OFFSET UNITYSDK_OFFSET(0x1A60DB00)
#define RPG_CLIENT_GRIDFIGHTTRAITREMARKLINEEFFECTBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A60D480)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightTraitRemarkLineEffectBase_TypeDefinitionIndex = 62542;
