...
#define RPG_CLIENT_CHIMERAFIREBULLETMANAGER_CLASS_1_8203F020DB866600_CLEAR_OFFSET UNITYSDK_OFFSET(0xCBFB5D0)
#define RPG_CLIENT_CHIMERAFIREBULLETMANAGER_CLASS_1_8203F020DB866600_METHOD_1_79E872D90798D236_OFFSET UNITYSDK_OFFSET(0xCBFA570)
#define RPG_CLIENT_CHIMERAFIREBULLETMANAGER_CLASS_1_8203F020DB866600_METHOD_1_91895701433CBFE0_OFFSET UNITYSDK_OFFSET(0xCBFB1A0)
#define RPG_CLIENT_CHIMERAFIREBULLETMANAGER_CLASS_1_8203F020DB866600__CTOR_OFFSET UNITYSDK_OFFSET(0xCBFB120)
...
namespace RPG::Client
{
	...
	{
	public:
		::UnityEngine::Transform* DEIMGIGLHLK; // 0x10
		::UnityEngine::Transform* GLDEBFOKEMJ; // 0x18
		::RPG::GameCore::ChimeraWorkFireBullet* IGHAHBNLIJA; // 0x20
		::UnityEngine::AnimationCurve* EKBEMMMNOFI; // 0x28
		::System::Action* EGMGFMKIOHL; // 0x30
		::UnityEngine::AnimationCurve* NPFCIFDPHPP; // 0x38
		::UnityEngine::Transform* ONLEMJPMBDH; // 0x40
		::System::Single LLNIGIGFCEA; // 0x48
		::System::Single KKPEIMJKION; // 0x4C
		::System::Boolean MABFMALCGKF; // 0x50
