...
#define RPG_CLIENT_PLANETFESFLOATINGEVENT_DESPAWNED_OFFSET UNITYSDK_OFFSET(0x1A96EC90)
#define RPG_CLIENT_PLANETFESFLOATINGEVENT_ONCREATE_OFFSET UNITYSDK_OFFSET(0x1A96ECD0)
#define RPG_CLIENT_PLANETFESFLOATINGEVENT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A96EC00)
#define RPG_CLIENT_PLANETFESFLOATINGEVENT_PLAY_OFFSET UNITYSDK_OFFSET(0x1A96DB60)
#define RPG_CLIENT_PLANETFESFLOATINGEVENT_SETICON_OFFSET UNITYSDK_OFFSET(0x1A96DAB0)
#define RPG_CLIENT_PLANETFESFLOATINGEVENT_SPAWNED_OFFSET UNITYSDK_OFFSET(0x1A96EC50)
#define RPG_CLIENT_PLANETFESFLOATINGEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A96EE40)

namespace RPG::Client
{
	inline static constexpr unsigned int PlanetFesFloatingEvent_TypeDefinitionIndex = 63543;
