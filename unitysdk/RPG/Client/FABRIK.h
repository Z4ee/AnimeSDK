...
#define RPG_CLIENT_FABRIK_AWAKE_OFFSET UNITYSDK_OFFSET(0x196D2C80)
#define RPG_CLIENT_FABRIK_GET_ISPROCESSABLE_OFFSET UNITYSDK_OFFSET(0x196D26C0)
#define RPG_CLIENT_FABRIK_GET_WEIGHT_OFFSET UNITYSDK_OFFSET(0x196D2750)
#define RPG_CLIENT_FABRIK_IKRESET_OFFSET UNITYSDK_OFFSET(0x196D2BF0)
#define RPG_CLIENT_FABRIK_PROCESS_OFFSET UNITYSDK_OFFSET(0x196D2920)
#define RPG_CLIENT_FABRIK_SAFEINIT_OFFSET UNITYSDK_OFFSET(0x196D27A0)
#define RPG_CLIENT_FABRIK__CTOR_OFFSET UNITYSDK_OFFSET(0x196D2D40)

namespace RPG::Client
{
	inline static constexpr unsigned int FABRIK_TypeDefinitionIndex = 65374;
