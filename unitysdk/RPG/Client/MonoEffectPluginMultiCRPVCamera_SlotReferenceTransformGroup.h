...
#define RPG_CLIENT_MONOEFFECTPLUGINMULTICRPVCAMERA_SLOTREFERENCETRANSFORMGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x9CD52C0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginMultiCRPVCamera_SlotReferenceTransformGroup_TypeDefinitionIndex = 57349;
