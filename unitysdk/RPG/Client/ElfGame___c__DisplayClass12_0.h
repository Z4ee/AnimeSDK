...
#define RPG_CLIENT_ELFGAME___C__DISPLAYCLASS12_0__CTOR_OFFSET UNITYSDK_OFFSET(0x95B2500)
#define RPG_CLIENT_ELFGAME___C__DISPLAYCLASS12_0___ENABLEELFSTREAMING_B__0_OFFSET UNITYSDK_OFFSET(0x95B6310)

namespace RPG::Client
{
	inline static constexpr unsigned int ElfGame___c__DisplayClass12_0_TypeDefinitionIndex = 51738;
