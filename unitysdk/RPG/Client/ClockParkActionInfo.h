...
#define RPG_CLIENT_CLOCKPARKACTIONINFO_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1ADFB550)
#define RPG_CLIENT_CLOCKPARKACTIONINFO_GET_ONCARDACTION_OFFSET UNITYSDK_OFFSET(0x1ADFC000)
#define RPG_CLIENT_CLOCKPARKACTIONINFO_GET_ONCARDEFFECTRESULT_OFFSET UNITYSDK_OFFSET(0x1ADFC050)
#define RPG_CLIENT_CLOCKPARKACTIONINFO_GET_ONCARDSUCCESSEFFECTRESULT_OFFSET UNITYSDK_OFFSET(0x1ADFC0A0)
#define RPG_CLIENT_CLOCKPARKACTIONINFO_INIT_OFFSET UNITYSDK_OFFSET(0x1ADFB3D0)
#define RPG_CLIENT_CLOCKPARKACTIONINFO_REFRESHCARDEFFECTRESULT_OFFSET UNITYSDK_OFFSET(0x1ADFB9E0)
#define RPG_CLIENT_CLOCKPARKACTIONINFO_SYNCACTION_OFFSET UNITYSDK_OFFSET(0x1ADFB6A0)
#define RPG_CLIENT_CLOCKPARKACTIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADFC0F0)
#define RPG_CLIENT_CLOCKPARKACTIONINFO__SYNCACTIONINTERNAL_OFFSET UNITYSDK_OFFSET(0x1ADFB710)

namespace RPG::Client
{
	inline static constexpr unsigned int ClockParkActionInfo_TypeDefinitionIndex = 58740;
	...
	public:
		...
		::Class_1_64C1E63642C4A2DF<::RPG::Client::ClockParkEffectDataItem*>* _EffectDataItemPool; // 0x20
