...
#define RPG_CLIENT_CLOCKPARKACTIONINFO_DISPOSE_OFFSET UNITYSDK_OFFSET(0x93E6820)
#define RPG_CLIENT_CLOCKPARKACTIONINFO_GET_ONCARDACTION_OFFSET UNITYSDK_OFFSET(0x93E7320)
#define RPG_CLIENT_CLOCKPARKACTIONINFO_GET_ONCARDEFFECTRESULT_OFFSET UNITYSDK_OFFSET(0x93E7340)
#define RPG_CLIENT_CLOCKPARKACTIONINFO_GET_ONCARDSUCCESSEFFECTRESULT_OFFSET UNITYSDK_OFFSET(0x93E7360)
#define RPG_CLIENT_CLOCKPARKACTIONINFO_INIT_OFFSET UNITYSDK_OFFSET(0x93E6670)
#define RPG_CLIENT_CLOCKPARKACTIONINFO_REFRESHCARDEFFECTRESULT_OFFSET UNITYSDK_OFFSET(0x93E6D20)
#define RPG_CLIENT_CLOCKPARKACTIONINFO_SYNCACTION_OFFSET UNITYSDK_OFFSET(0x93E69A0)
#define RPG_CLIENT_CLOCKPARKACTIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x93E7380)
#define RPG_CLIENT_CLOCKPARKACTIONINFO__SYNCACTIONINTERNAL_OFFSET UNITYSDK_OFFSET(0x93E6A10)

namespace RPG::Client
{
	inline static constexpr unsigned int ClockParkActionInfo_TypeDefinitionIndex = 49872;

	class ClockParkActionInfo : public ::System::Object
	{
	public:
		::Class_1_64C1E63642C4A2DF<::RPG::Client::ClockParkActionDataItem*>* _ActionDataItemPool; // 0x10
		::Class_1_0EFB4F3865942669* OnCardActionContainer; // 0x18
		::System::Collections::Generic::List_1<::System::UInt32>* _GainBuffIDList; // 0x20
