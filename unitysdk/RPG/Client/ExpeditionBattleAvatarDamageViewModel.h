...
#define RPG_CLIENT_EXPEDITIONBATTLEAVATARDAMAGEVIEWMODEL_GET_AVATARID_OFFSET UNITYSDK_OFFSET(0xCEF70A0)
#define RPG_CLIENT_EXPEDITIONBATTLEAVATARDAMAGEVIEWMODEL_GET_DAMAGEPERCENT_OFFSET UNITYSDK_OFFSET(0xCEF70C0)
#define RPG_CLIENT_EXPEDITIONBATTLEAVATARDAMAGEVIEWMODEL_GET_DAMAGE_OFFSET UNITYSDK_OFFSET(0xCEF70B0)
#define RPG_CLIENT_EXPEDITIONBATTLEAVATARDAMAGEVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xCEF70D0)
...
namespace RPG::Client
{
	...
	{
	public:
		::System::Single _DamagePercent_k__BackingField; // 0x10
		::System::UInt32 _AvatarID_k__BackingField; // 0x14
		::System::UInt64 _Damage_k__BackingField; // 0x18
