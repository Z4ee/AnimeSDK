...
#define RPG_CLIENT_SHAREMODULE___GETSHAREFRAMECAPTUREPROCESS_D__9_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19F46070)
#define RPG_CLIENT_SHAREMODULE___GETSHAREFRAMECAPTUREPROCESS_D__9_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19F46330)
#define RPG_CLIENT_SHAREMODULE___GETSHAREFRAMECAPTUREPROCESS_D__9_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19F46390)
#define RPG_CLIENT_SHAREMODULE___GETSHAREFRAMECAPTUREPROCESS_D__9_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19F46340)
#define RPG_CLIENT_SHAREMODULE___GETSHAREFRAMECAPTUREPROCESS_D__9_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19F46060)
#define RPG_CLIENT_SHAREMODULE___GETSHAREFRAMECAPTUREPROCESS_D__9__CTOR_OFFSET UNITYSDK_OFFSET(0x19F45BF0)

namespace RPG::Client
{
	inline static constexpr unsigned int ShareModule___GetShareFrameCaptureProcess_d__9_TypeDefinitionIndex = 64938;
