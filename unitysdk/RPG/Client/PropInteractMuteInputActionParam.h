...
#define RPG_CLIENT_PROPINTERACTMUTEINPUTACTIONPARAM_METHOD_3_AA8D19CD2E4E7E54_OFFSET UNITYSDK_OFFSET(0x16E8AF10)
#define RPG_CLIENT_PROPINTERACTMUTEINPUTACTIONPARAM_METHOD_3_FE31181E7D31147F_OFFSET UNITYSDK_OFFSET(0x16E8C030)
#define RPG_CLIENT_PROPINTERACTMUTEINPUTACTIONPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x16E8AF00)

namespace RPG::Client
{
	inline static constexpr unsigned int PropInteractMuteInputActionParam_TypeDefinitionIndex = 9926;
