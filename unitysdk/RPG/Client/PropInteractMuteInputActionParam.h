...
#define RPG_CLIENT_PROPINTERACTMUTEINPUTACTIONPARAM_METHOD_3_67BB5732E77B236A_OFFSET UNITYSDK_OFFSET(0x1B9EEA80)
#define RPG_CLIENT_PROPINTERACTMUTEINPUTACTIONPARAM_METHOD_3_B1D9918E2C45F791_OFFSET UNITYSDK_OFFSET(0x1B9EDBD0)
#define RPG_CLIENT_PROPINTERACTMUTEINPUTACTIONPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9EDBC0)

namespace RPG::Client
{
	inline static constexpr unsigned int PropInteractMuteInputActionParam_TypeDefinitionIndex = 9881;
