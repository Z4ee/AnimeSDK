...
#define RPG_CLIENT_STORYFEVERPILETOAST_METHOD_5_24B05D2E15A5C3C8_OFFSET UNITYSDK_OFFSET(0xC935080)
#define RPG_CLIENT_STORYFEVERPILETOAST_METHOD_5_41F5D9C0F0A306F5_OFFSET UNITYSDK_OFFSET(0xC9357E0)
#define RPG_CLIENT_STORYFEVERPILETOAST_METHOD_5_485F3682F812D478_OFFSET UNITYSDK_OFFSET(0xC934C60)
#define RPG_CLIENT_STORYFEVERPILETOAST_METHOD_5_4A111163FD8F1931_OFFSET UNITYSDK_OFFSET(0xC934D90)
#define RPG_CLIENT_STORYFEVERPILETOAST_METHOD_5_51CFFE2AF748ECD7_OFFSET UNITYSDK_OFFSET(0xC9355E0)
#define RPG_CLIENT_STORYFEVERPILETOAST_METHOD_5_8A05DE1403363D53_OFFSET UNITYSDK_OFFSET(0xC934E40)
#define RPG_CLIENT_STORYFEVERPILETOAST_METHOD_5_94E49D8C890638E5_OFFSET UNITYSDK_OFFSET(0xC935840)
#define RPG_CLIENT_STORYFEVERPILETOAST_METHOD_5_E29D671E35F6F43F_OFFSET UNITYSDK_OFFSET(0xC9354B0)
#define RPG_CLIENT_STORYFEVERPILETOAST_METHOD_5_E52129E82CD2D7F8_OFFSET UNITYSDK_OFFSET(0xC9344C0)
#define RPG_CLIENT_STORYFEVERPILETOAST_PILE_OFFSET UNITYSDK_OFFSET(0xC9343D0)
#define RPG_CLIENT_STORYFEVERPILETOAST_START_OFFSET UNITYSDK_OFFSET(0xC934600)
#define RPG_CLIENT_STORYFEVERPILETOAST_UPDATE_OFFSET UNITYSDK_OFFSET(0xC9348D0)
#define RPG_CLIENT_STORYFEVERPILETOAST__CTOR_OFFSET UNITYSDK_OFFSET(0xC935BD0)

namespace RPG::Client
{
	inline static constexpr unsigned int StoryFeverPileToast_TypeDefinitionIndex = 67372;
