...
#define RPG_CLIENT_STORYFEVERPILETOAST_METHOD_5_24B05D2E15A5C3C8_OFFSET UNITYSDK_OFFSET(0xB1DB630)
#define RPG_CLIENT_STORYFEVERPILETOAST_METHOD_5_41F5D9C0F0A306F5_OFFSET UNITYSDK_OFFSET(0xB1DBDC0)
#define RPG_CLIENT_STORYFEVERPILETOAST_METHOD_5_485F3682F812D478_OFFSET UNITYSDK_OFFSET(0xB1DB1B0)
#define RPG_CLIENT_STORYFEVERPILETOAST_METHOD_5_4A111163FD8F1931_OFFSET UNITYSDK_OFFSET(0xB1DB310)
#define RPG_CLIENT_STORYFEVERPILETOAST_METHOD_5_51CFFE2AF748ECD7_OFFSET UNITYSDK_OFFSET(0xB1DBBB0)
#define RPG_CLIENT_STORYFEVERPILETOAST_METHOD_5_8A05DE1403363D53_OFFSET UNITYSDK_OFFSET(0xB1DB3D0)
#define RPG_CLIENT_STORYFEVERPILETOAST_METHOD_5_94E49D8C890638E5_OFFSET UNITYSDK_OFFSET(0xB1DBE20)
#define RPG_CLIENT_STORYFEVERPILETOAST_METHOD_5_E29D671E35F6F43F_OFFSET UNITYSDK_OFFSET(0xB1DBA80)
#define RPG_CLIENT_STORYFEVERPILETOAST_METHOD_5_E52129E82CD2D7F8_OFFSET UNITYSDK_OFFSET(0xB1DAA10)
#define RPG_CLIENT_STORYFEVERPILETOAST_PILE_OFFSET UNITYSDK_OFFSET(0xB1DA920)
#define RPG_CLIENT_STORYFEVERPILETOAST_START_OFFSET UNITYSDK_OFFSET(0xB1DAB60)
#define RPG_CLIENT_STORYFEVERPILETOAST_UPDATE_OFFSET UNITYSDK_OFFSET(0xB1DADF0)
#define RPG_CLIENT_STORYFEVERPILETOAST__CTOR_OFFSET UNITYSDK_OFFSET(0xB1DC1C0)

namespace RPG::Client
{
	inline static constexpr unsigned int StoryFeverPileToast_TypeDefinitionIndex = 66435;
	...
	public:
		...
		::Il2CppArray<::RPG::Client::StoryFeverToastHintItem*>* Field_5_4; // 0x28
		::System::Collections::Generic::Queue_1<::Class_1_77F4DFDB808FBF65*>* Field_5_5; // 0x30
