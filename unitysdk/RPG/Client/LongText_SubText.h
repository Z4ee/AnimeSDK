...
#define RPG_CLIENT_LONGTEXT_SUBTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x9A5D020)

namespace RPG::Client
{
	inline static constexpr unsigned int LongText_SubText_TypeDefinitionIndex = 59468;
