...
#define RPG_CLIENT_PLANETFESLANDREWARD__CTOR_OFFSET UNITYSDK_OFFSET(0x9F9D890)

namespace RPG::Client
{
	inline static constexpr unsigned int PlanetFesLandReward_TypeDefinitionIndex = 54213;
