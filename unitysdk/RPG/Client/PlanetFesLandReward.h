...
#define RPG_CLIENT_PLANETFESLANDREWARD__CTOR_OFFSET UNITYSDK_OFFSET(0xC417310)

namespace RPG::Client
{
	inline static constexpr unsigned int PlanetFesLandReward_TypeDefinitionIndex = 62300;
