...
#define RPG_CLIENT_ELFORDERINFO_DISPOSE_OFFSET UNITYSDK_OFFSET(0x95BAA40)
#define RPG_CLIENT_ELFORDERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x95BAA80)

namespace RPG::Client
{
	inline static constexpr unsigned int ElfOrderInfo_TypeDefinitionIndex = 51789;

	class ElfOrderInfo : public ::System::Object
	{
	public:
		::System::Single CookedTime; // 0x10
		::System::Int32 ChefRuntimeID; // 0x14
		::System::Single CookTime; // 0x18
		::System::UInt32 RecipeLevel; // 0x1C
