...
#define RPG_CLIENT_MESHRENDEREROVERRIDEBOUNDMONOPLUGIN_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x1AA19A20)
#define RPG_CLIENT_MESHRENDEREROVERRIDEBOUNDMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA19A70)
