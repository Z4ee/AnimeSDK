...
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWMONOPLUGIN_CLEAR_OFFSET UNITYSDK_OFFSET(0xB47EA10)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWMONOPLUGIN_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xB47EA70)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xB47EAC0)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWMONOPLUGIN___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xB47EAE0)

namespace RPG::Client
{
	inline static constexpr unsigned int VirtualCameraFollowMonoPlugin_TypeDefinitionIndex = 64851;
