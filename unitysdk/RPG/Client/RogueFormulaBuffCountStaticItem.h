...
#define RPG_CLIENT_ROGUEFORMULABUFFCOUNTSTATICITEM_GET_ACHIEVEDBUFFCOUNT_OFFSET UNITYSDK_OFFSET(0x1A450050)
#define RPG_CLIENT_ROGUEFORMULABUFFCOUNTSTATICITEM_GET_ISBUFFCOUNTSATISFIED_OFFSET UNITYSDK_OFFSET(0x1A4500A0)
#define RPG_CLIENT_ROGUEFORMULABUFFCOUNTSTATICITEM_GET_REQUIREDBUFFCOUNT_OFFSET UNITYSDK_OFFSET(0x1A450090)
#define RPG_CLIENT_ROGUEFORMULABUFFCOUNTSTATICITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A450040)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueFormulaBuffCountStaticItem_TypeDefinitionIndex = 64215;
