...
#define RPG_CLIENT_DEBUGGING_DEBUGUTILS_DRAWSTRING_OFFSET UNITYSDK_OFFSET(0x180914D0)
#define RPG_CLIENT_DEBUGGING_DEBUGUTILS_METHOD_5_CFAA1B02F36ADD7B_OFFSET UNITYSDK_OFFSET(0x180914F0)
#define RPG_CLIENT_DEBUGGING_DEBUGUTILS_METHOD_5_EFC9F5E801B244B0_OFFSET UNITYSDK_OFFSET(0x180915A0)
#define RPG_CLIENT_DEBUGGING_DEBUGUTILS__CTOR_OFFSET UNITYSDK_OFFSET(0x18091640)

namespace RPG::Client::Debugging
{
	inline static constexpr unsigned int DebugUtils_TypeDefinitionIndex = 76711;
