...
#define RPG_CLIENT_DEBUGGING_CHARACTERVISIONSCOPEDEBUG_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xCC989E0)
#define RPG_CLIENT_DEBUGGING_CHARACTERVISIONSCOPEDEBUG_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xCC98A50)
#define RPG_CLIENT_DEBUGGING_CHARACTERVISIONSCOPEDEBUG_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0xCC988B0)
#define RPG_CLIENT_DEBUGGING_CHARACTERVISIONSCOPEDEBUG__CTOR_OFFSET UNITYSDK_OFFSET(0xCC98B20)

namespace RPG::Client::Debugging
{
	inline static constexpr unsigned int CharacterVisionScopeDebug_TypeDefinitionIndex = 80749;
