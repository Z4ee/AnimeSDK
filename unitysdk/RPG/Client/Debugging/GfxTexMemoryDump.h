...
#define RPG_CLIENT_DEBUGGING_GFXTEXMEMORYDUMP_DUMPCPPGFXMEMORY_OFFSET UNITYSDK_OFFSET(0x18091670)
#define RPG_CLIENT_DEBUGGING_GFXTEXMEMORYDUMP_DUMPCSGFXMEMORY_OFFSET UNITYSDK_OFFSET(0x18091680)
#define RPG_CLIENT_DEBUGGING_GFXTEXMEMORYDUMP_RESOLVE_OFFSET UNITYSDK_OFFSET(0x18091690)
#define RPG_CLIENT_DEBUGGING_GFXTEXMEMORYDUMP__CTOR_OFFSET UNITYSDK_OFFSET(0x180916A0)

namespace RPG::Client::Debugging
{
	inline static constexpr unsigned int GfxTexMemoryDump_TypeDefinitionIndex = 76712;
