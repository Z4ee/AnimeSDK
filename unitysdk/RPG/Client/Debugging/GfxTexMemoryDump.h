...
#define RPG_CLIENT_DEBUGGING_GFXTEXMEMORYDUMP_DUMPCPPGFXMEMORY_OFFSET UNITYSDK_OFFSET(0x94493E0)
#define RPG_CLIENT_DEBUGGING_GFXTEXMEMORYDUMP_DUMPCSGFXMEMORY_OFFSET UNITYSDK_OFFSET(0x94493F0)
#define RPG_CLIENT_DEBUGGING_GFXTEXMEMORYDUMP_RESOLVE_OFFSET UNITYSDK_OFFSET(0x9449400)
#define RPG_CLIENT_DEBUGGING_GFXTEXMEMORYDUMP__CTOR_OFFSET UNITYSDK_OFFSET(0x9449410)

namespace RPG::Client::Debugging
{
	inline static constexpr unsigned int GfxTexMemoryDump_TypeDefinitionIndex = 64452;
