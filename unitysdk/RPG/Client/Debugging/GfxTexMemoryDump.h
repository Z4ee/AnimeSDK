...
#define RPG_CLIENT_DEBUGGING_GFXTEXMEMORYDUMP_DUMPCPPGFXMEMORY_OFFSET UNITYSDK_OFFSET(0x192DFB20)
#define RPG_CLIENT_DEBUGGING_GFXTEXMEMORYDUMP_DUMPCSGFXMEMORY_OFFSET UNITYSDK_OFFSET(0x192DFB30)
#define RPG_CLIENT_DEBUGGING_GFXTEXMEMORYDUMP_RESOLVE_OFFSET UNITYSDK_OFFSET(0x192DFB40)
#define RPG_CLIENT_DEBUGGING_GFXTEXMEMORYDUMP__CTOR_OFFSET UNITYSDK_OFFSET(0x192DFB50)

namespace RPG::Client::Debugging
{
	inline static constexpr unsigned int GfxTexMemoryDump_TypeDefinitionIndex = 80752;
