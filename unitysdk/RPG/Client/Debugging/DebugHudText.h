...
#define RPG_CLIENT_DEBUGGING_DEBUGHUDTEXT_GET_OFFSETX_OFFSET UNITYSDK_OFFSET(0xCC98B40)
#define RPG_CLIENT_DEBUGGING_DEBUGHUDTEXT_GET_OFFSETY_OFFSET UNITYSDK_OFFSET(0xCC98B60)
#define RPG_CLIENT_DEBUGGING_DEBUGHUDTEXT_GET_TEXTCOLOR_OFFSET UNITYSDK_OFFSET(0xCC98B80)
#define RPG_CLIENT_DEBUGGING_DEBUGHUDTEXT_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0xCC98BB0)
#define RPG_CLIENT_DEBUGGING_DEBUGHUDTEXT_SET_OFFSETX_OFFSET UNITYSDK_OFFSET(0xCC98B50)
#define RPG_CLIENT_DEBUGGING_DEBUGHUDTEXT_SET_OFFSETY_OFFSET UNITYSDK_OFFSET(0xCC98B70)
#define RPG_CLIENT_DEBUGGING_DEBUGHUDTEXT_SET_TEXTCOLOR_OFFSET UNITYSDK_OFFSET(0xCC98B90)
#define RPG_CLIENT_DEBUGGING_DEBUGHUDTEXT_SHOWTEXT_OFFSET UNITYSDK_OFFSET(0xCC98BA0)
#define RPG_CLIENT_DEBUGGING_DEBUGHUDTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xCC98C00)

namespace RPG::Client::Debugging
{
	inline static constexpr unsigned int DebugHudText_TypeDefinitionIndex = 80751;
