...
#define RPG_CLIENT_DEBUGGING_FORMATIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18091660)

namespace RPG::Client::Debugging
{
	inline static constexpr unsigned int FormationData_TypeDefinitionIndex = 76706;
