...
#define RPG_CLIENT_DEBUGGING_FORMATIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x192DFB10)

namespace RPG::Client::Debugging
{
	inline static constexpr unsigned int FormationData_TypeDefinitionIndex = 80746;
