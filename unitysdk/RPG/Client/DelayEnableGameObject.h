...
#define RPG_CLIENT_DELAYENABLEGAMEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x944AB80)

namespace RPG::Client
{
	inline static constexpr unsigned int DelayEnableGameObject_TypeDefinitionIndex = 57324;
