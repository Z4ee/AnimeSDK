...
#define RPG_CLIENT_MATCHTHREEV2PLAYERPVPCAREER_CREATE_OFFSET UNITYSDK_OFFSET(0xD66AE70)
#define RPG_CLIENT_MATCHTHREEV2PLAYERPVPCAREER_GETSTATISTIC_OFFSET UNITYSDK_OFFSET(0xD66DC00)
#define RPG_CLIENT_MATCHTHREEV2PLAYERPVPCAREER_GET_LASTRANKDATA_OFFSET UNITYSDK_OFFSET(0xD66DB10)
#define RPG_CLIENT_MATCHTHREEV2PLAYERPVPCAREER_GET_LASTSCORE_OFFSET UNITYSDK_OFFSET(0xD66DA10)
#define RPG_CLIENT_MATCHTHREEV2PLAYERPVPCAREER_GET_RANKDATA_OFFSET UNITYSDK_OFFSET(0xD66DA30)
#define RPG_CLIENT_MATCHTHREEV2PLAYERPVPCAREER_GET_SCORE_OFFSET UNITYSDK_OFFSET(0xD66D9F0)
#define RPG_CLIENT_MATCHTHREEV2PLAYERPVPCAREER_SET_LASTSCORE_OFFSET UNITYSDK_OFFSET(0xD66DA20)
#define RPG_CLIENT_MATCHTHREEV2PLAYERPVPCAREER_SET_SCORE_OFFSET UNITYSDK_OFFSET(0xD66DA00)
#define RPG_CLIENT_MATCHTHREEV2PLAYERPVPCAREER_SYNCARENASTATISTICS_OFFSET UNITYSDK_OFFSET(0xD66A770)
#define RPG_CLIENT_MATCHTHREEV2PLAYERPVPCAREER_SYNCSCORE_OFFSET UNITYSDK_OFFSET(0xD66A4B0)
#define RPG_CLIENT_MATCHTHREEV2PLAYERPVPCAREER_SYNCSOLOSTATISTICS_OFFSET UNITYSDK_OFFSET(0xD66A500)
#define RPG_CLIENT_MATCHTHREEV2PLAYERPVPCAREER__CTOR_OFFSET UNITYSDK_OFFSET(0xD66DBF0)

namespace RPG::Client
{
	inline static constexpr unsigned int MatchThreeV2PlayerPvpCareer_TypeDefinitionIndex = 66057;
	...
	public:
		...
		::System::UInt32 _LastScore_k__BackingField; // 0x20
