...
#define RPG_CLIENT_MATCHTHREEV2PLAYERPVPCAREER_CREATE_OFFSET UNITYSDK_OFFSET(0x1C9A3D50)
#define RPG_CLIENT_MATCHTHREEV2PLAYERPVPCAREER_GETSTATISTIC_OFFSET UNITYSDK_OFFSET(0x1C9A6AC0)
#define RPG_CLIENT_MATCHTHREEV2PLAYERPVPCAREER_GET_LASTRANKDATA_OFFSET UNITYSDK_OFFSET(0x1C9A69E0)
#define RPG_CLIENT_MATCHTHREEV2PLAYERPVPCAREER_GET_LASTSCORE_OFFSET UNITYSDK_OFFSET(0x1C9A68F0)
#define RPG_CLIENT_MATCHTHREEV2PLAYERPVPCAREER_GET_RANKDATA_OFFSET UNITYSDK_OFFSET(0x1C9A6910)
#define RPG_CLIENT_MATCHTHREEV2PLAYERPVPCAREER_GET_SCORE_OFFSET UNITYSDK_OFFSET(0x1C9A68D0)
#define RPG_CLIENT_MATCHTHREEV2PLAYERPVPCAREER_SET_LASTSCORE_OFFSET UNITYSDK_OFFSET(0x1C9A6900)
#define RPG_CLIENT_MATCHTHREEV2PLAYERPVPCAREER_SET_SCORE_OFFSET UNITYSDK_OFFSET(0x1C9A68E0)
#define RPG_CLIENT_MATCHTHREEV2PLAYERPVPCAREER_SYNCARENASTATISTICS_OFFSET UNITYSDK_OFFSET(0x1C9A3650)
#define RPG_CLIENT_MATCHTHREEV2PLAYERPVPCAREER_SYNCSCORE_OFFSET UNITYSDK_OFFSET(0x1C9A3390)
#define RPG_CLIENT_MATCHTHREEV2PLAYERPVPCAREER_SYNCSOLOSTATISTICS_OFFSET UNITYSDK_OFFSET(0x1C9A33E0)
#define RPG_CLIENT_MATCHTHREEV2PLAYERPVPCAREER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9A6AB0)
