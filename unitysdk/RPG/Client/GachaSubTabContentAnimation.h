...
#define RPG_CLIENT_GACHASUBTABCONTENTANIMATION_GET_FROMBACKWARDANIMCLIPNAME_OFFSET UNITYSDK_OFFSET(0xD0FD4D0)
#define RPG_CLIENT_GACHASUBTABCONTENTANIMATION_GET_FROMFORWARDANIMCLIPNAME_OFFSET UNITYSDK_OFFSET(0xD0FD470)
#define RPG_CLIENT_GACHASUBTABCONTENTANIMATION_GET_TOBACKWARDANIMCLIPNAME_OFFSET UNITYSDK_OFFSET(0xD0FD410)
#define RPG_CLIENT_GACHASUBTABCONTENTANIMATION_GET_TOFORWARDANIMCLIPNAME_OFFSET UNITYSDK_OFFSET(0xD0FD3B0)
#define RPG_CLIENT_GACHASUBTABCONTENTANIMATION_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xD0FD360)
#define RPG_CLIENT_GACHASUBTABCONTENTANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0xD0FD530)

namespace RPG::Client
{
	inline static constexpr unsigned int GachaSubTabContentAnimation_TypeDefinitionIndex = 72722;
