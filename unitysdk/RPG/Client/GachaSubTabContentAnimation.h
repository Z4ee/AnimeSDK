...
#define RPG_CLIENT_GACHASUBTABCONTENTANIMATION_GET_FROMBACKWARDANIMCLIPNAME_OFFSET UNITYSDK_OFFSET(0x9758580)
#define RPG_CLIENT_GACHASUBTABCONTENTANIMATION_GET_FROMFORWARDANIMCLIPNAME_OFFSET UNITYSDK_OFFSET(0x9758520)
#define RPG_CLIENT_GACHASUBTABCONTENTANIMATION_GET_TOBACKWARDANIMCLIPNAME_OFFSET UNITYSDK_OFFSET(0x97584C0)
#define RPG_CLIENT_GACHASUBTABCONTENTANIMATION_GET_TOFORWARDANIMCLIPNAME_OFFSET UNITYSDK_OFFSET(0x9758460)
#define RPG_CLIENT_GACHASUBTABCONTENTANIMATION_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9758410)
#define RPG_CLIENT_GACHASUBTABCONTENTANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x97585E0)

namespace RPG::Client
{
	inline static constexpr unsigned int GachaSubTabContentAnimation_TypeDefinitionIndex = 59669;
