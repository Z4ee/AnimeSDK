...
#define RPG_CLIENT_CHIMERADUEL_CHIMERADUELBATTLECHIMERAMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xB674C10)

namespace RPG::Client::ChimeraDuel
{
	inline static constexpr unsigned int ChimeraDuelBattleChimeraModel_TypeDefinitionIndex = 73904;
