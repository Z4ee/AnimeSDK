...
#define RPG_CLIENT_EFFECT_CYRENERINGSTARSHININGMONOPLUGIN_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x95439F0)
#define RPG_CLIENT_EFFECT_CYRENERINGSTARSHININGMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x9543A40)
#define RPG_CLIENT_EFFECT_CYRENERINGSTARSHININGMONOPLUGIN___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x9543AF0)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_CyreneRingStarShiningMonoPlugin_TypeDefinitionIndex = 57675;
