...
#define RPG_CLIENT_POLYMERPROPERTYLINKBASE_METHOD_1_4B3308289404939B_OFFSET UNITYSDK_OFFSET(0xAD6FC40)
#define RPG_CLIENT_POLYMERPROPERTYLINKBASE_METHOD_1_947C1FE4941F3BAA_OFFSET UNITYSDK_OFFSET(0xAD6FDF0)
#define RPG_CLIENT_POLYMERPROPERTYLINKBASE_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xAD6F9C0)
#define RPG_CLIENT_POLYMERPROPERTYLINKBASE_METHOD_1_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0xAD6FDB0)
#define RPG_CLIENT_POLYMERPROPERTYLINKBASE_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xAD6F980)
#define RPG_CLIENT_POLYMERPROPERTYLINKBASE_METHOD_1_CB6F6E10453B8642_OFFSET UNITYSDK_OFFSET(0xAD6FB60)
#define RPG_CLIENT_POLYMERPROPERTYLINKBASE_METHOD_1_FD97D2244C0FF5A9_OFFSET UNITYSDK_OFFSET(0xAD6FA00)
#define RPG_CLIENT_POLYMERPROPERTYLINKBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xAD6F8A0)

namespace RPG::Client
{
	inline static constexpr unsigned int PolymerPropertyLinkBase_TypeDefinitionIndex = 64806;
