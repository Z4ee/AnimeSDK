...
#define RPG_CLIENT_POLYMERPROPERTYLINKBASE_METHOD_1_43DF5DDA7D099E0C_OFFSET UNITYSDK_OFFSET(0x1AE1AA00)
#define RPG_CLIENT_POLYMERPROPERTYLINKBASE_METHOD_1_5E06F59A975FD52C_OFFSET UNITYSDK_OFFSET(0x1AE1ACE0)
#define RPG_CLIENT_POLYMERPROPERTYLINKBASE_METHOD_1_90C00AEA2B6E5363_OFFSET UNITYSDK_OFFSET(0x1AE1ABF0)
#define RPG_CLIENT_POLYMERPROPERTYLINKBASE_METHOD_1_C9665CE87E0304EF_OFFSET UNITYSDK_OFFSET(0x1AE1AF30)
#define RPG_CLIENT_POLYMERPROPERTYLINKBASE_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x1AE1A9C0)
#define RPG_CLIENT_POLYMERPROPERTYLINKBASE_METHOD_1_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0x1AE1AEF0)
#define RPG_CLIENT_POLYMERPROPERTYLINKBASE_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1AE1A980)
#define RPG_CLIENT_POLYMERPROPERTYLINKBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE1A8B0)

namespace RPG::Client
{
	inline static constexpr unsigned int PolymerPropertyLinkBase_TypeDefinitionIndex = 70266;
