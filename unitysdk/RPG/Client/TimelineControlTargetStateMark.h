...
#define RPG_CLIENT_TIMELINECONTROLTARGETSTATEMARK__CTOR_OFFSET UNITYSDK_OFFSET(0x178A5060)

namespace RPG::Client
{
	inline static constexpr unsigned int TimelineControlTargetStateMark_TypeDefinitionIndex = 58123;
