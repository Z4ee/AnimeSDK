...
#define RPG_CLIENT_GRIDFIGHTFLOWDIRECTOR_ADVENTURERETURNAUTOSHOWEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6A5DD0)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightFlowDirector_AdventureReturnAutoShowEvent_TypeDefinitionIndex = 61662;
