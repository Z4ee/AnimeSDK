...
#define RPG_CLIENT_ENVWINDTRIGGERMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xB9190D0)

namespace RPG::Client
{
	inline static constexpr unsigned int EnvWindTriggerMonoPlugin_TypeDefinitionIndex = 66428;
