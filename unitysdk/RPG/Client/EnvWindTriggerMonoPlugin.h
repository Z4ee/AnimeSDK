...
#define RPG_CLIENT_ENVWINDTRIGGERMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1991AA50)

namespace RPG::Client
{
	inline static constexpr unsigned int EnvWindTriggerMonoPlugin_TypeDefinitionIndex = 71037;
