...
#define RPG_CLIENT_EFFECTSTATESYNCSET__CTOR_OFFSET UNITYSDK_OFFSET(0x15E490A0)

namespace RPG::Client
{
	inline static constexpr unsigned int EffectStateSyncSet_TypeDefinitionIndex = 69847;
