...
#define RPG_CLIENT_EFFECTSTATESYNCSET__CTOR_OFFSET UNITYSDK_OFFSET(0x9536940)

namespace RPG::Client
{
	inline static constexpr unsigned int EffectStateSyncSet_TypeDefinitionIndex = 57162;
