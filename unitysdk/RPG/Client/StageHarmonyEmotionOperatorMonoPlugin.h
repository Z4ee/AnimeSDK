...
#define RPG_CLIENT_STAGEHARMONYEMOTIONOPERATORMONOPLUGIN_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x1A4DFDF0)
#define RPG_CLIENT_STAGEHARMONYEMOTIONOPERATORMONOPLUGIN_METHOD_7_B1936CE4DA97AA45_1_OFFSET UNITYSDK_OFFSET(0x1A4DFD50)
#define RPG_CLIENT_STAGEHARMONYEMOTIONOPERATORMONOPLUGIN_METHOD_7_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x1A4DFCB0)
#define RPG_CLIENT_STAGEHARMONYEMOTIONOPERATORMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4DFE40)
