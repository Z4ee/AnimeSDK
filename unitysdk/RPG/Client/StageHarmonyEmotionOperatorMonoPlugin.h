...
#define RPG_CLIENT_STAGEHARMONYEMOTIONOPERATORMONOPLUGIN_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x17B44BF0)
#define RPG_CLIENT_STAGEHARMONYEMOTIONOPERATORMONOPLUGIN_METHOD_7_B1936CE4DA97AA45_1_OFFSET UNITYSDK_OFFSET(0x17B44B50)
#define RPG_CLIENT_STAGEHARMONYEMOTIONOPERATORMONOPLUGIN_METHOD_7_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x17B44AB0)
#define RPG_CLIENT_STAGEHARMONYEMOTIONOPERATORMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x17B44C40)

namespace RPG::Client
{
	inline static constexpr unsigned int StageHarmonyEmotionOperatorMonoPlugin_TypeDefinitionIndex = 67766;
