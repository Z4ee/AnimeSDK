...
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYTIMETABLE_FIND_OFFSET UNITYSDK_OFFSET(0x19C4EBE0)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYTIMETABLE_GET_OFFSET UNITYSDK_OFFSET(0x19C4EB50)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYTIMETABLE_GET_TABLECOUNT_OFFSET UNITYSDK_OFFSET(0x19C4EAF0)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYTIMETABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C4ECA0)

namespace RPG::Client::Subway
{
	inline static constexpr unsigned int AirshipSubwayTimetable_TypeDefinitionIndex = 76796;
