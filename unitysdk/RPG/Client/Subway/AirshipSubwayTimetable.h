...
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYTIMETABLE_FIND_OFFSET UNITYSDK_OFFSET(0x1B464A80)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYTIMETABLE_GET_OFFSET UNITYSDK_OFFSET(0x1B4649F0)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYTIMETABLE_GET_TABLECOUNT_OFFSET UNITYSDK_OFFSET(0x1B464990)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYTIMETABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B464B40)

namespace RPG::Client::Subway
{
	inline static constexpr unsigned int AirshipSubwayTimetable_TypeDefinitionIndex = 80836;
