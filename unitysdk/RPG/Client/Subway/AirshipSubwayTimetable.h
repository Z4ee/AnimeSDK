...
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYTIMETABLE_FIND_OFFSET UNITYSDK_OFFSET(0xE10F4E0)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYTIMETABLE_GET_OFFSET UNITYSDK_OFFSET(0xE10F450)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYTIMETABLE_GET_TABLECOUNT_OFFSET UNITYSDK_OFFSET(0xE10F3F0)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYTIMETABLE__CTOR_OFFSET UNITYSDK_OFFSET(0xE10F5A0)

namespace RPG::Client::Subway
{
	inline static constexpr unsigned int AirshipSubwayTimetable_TypeDefinitionIndex = 80837;
