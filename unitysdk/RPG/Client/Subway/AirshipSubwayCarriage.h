...
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE_METHOD_5_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0xB1E5FA0)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE_METHOD_5_1B9EFB8F22728CB8_OFFSET UNITYSDK_OFFSET(0xB1E7F40)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE_METHOD_5_21FBC382EA5ECE99_1_OFFSET UNITYSDK_OFFSET(0xB1E7E60)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE_METHOD_5_21FBC382EA5ECE99_OFFSET UNITYSDK_OFFSET(0xB1E7D80)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE_METHOD_5_44AC3F3C85C7CAA3_OFFSET UNITYSDK_OFFSET(0xB1E7180)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE_METHOD_5_627C7524E98F4AC5_OFFSET UNITYSDK_OFFSET(0xB1E60E0)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE_METHOD_5_6747250BC2D13457_OFFSET UNITYSDK_OFFSET(0xB1E80B0)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE_METHOD_5_B69A6865F8BEDF36_OFFSET UNITYSDK_OFFSET(0xB1E8460)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE_METHOD_5_BE4EBC8FF4054312_OFFSET UNITYSDK_OFFSET(0xB1E6160)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE_METHOD_5_C0342BA270C91EF6_OFFSET UNITYSDK_OFFSET(0xB1E7870)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE_METHOD_5_F59E20BA9BC23BFE_OFFSET UNITYSDK_OFFSET(0xB1E7970)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE_METHOD_5_FDDF7B7E329390B7_OFFSET UNITYSDK_OFFSET(0xB1E73F0)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB1E82A0)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xB1E8260)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0xB1E82E0)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE__CTOR_OFFSET UNITYSDK_OFFSET(0xB1E89A0)

namespace RPG::Client::Subway
{
	inline static constexpr unsigned int AirshipSubwayCarriage_TypeDefinitionIndex = 72567;
