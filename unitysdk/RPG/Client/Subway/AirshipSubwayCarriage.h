...
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE_METHOD_5_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0xC940240)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE_METHOD_5_1B9EFB8F22728CB8_OFFSET UNITYSDK_OFFSET(0xC9420E0)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE_METHOD_5_21FBC382EA5ECE99_1_OFFSET UNITYSDK_OFFSET(0xC942000)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE_METHOD_5_21FBC382EA5ECE99_OFFSET UNITYSDK_OFFSET(0xC941F20)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE_METHOD_5_44AC3F3C85C7CAA3_OFFSET UNITYSDK_OFFSET(0xC941360)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE_METHOD_5_627C7524E98F4AC5_OFFSET UNITYSDK_OFFSET(0xC940380)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE_METHOD_5_6747250BC2D13457_OFFSET UNITYSDK_OFFSET(0xC942230)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE_METHOD_5_B69A6865F8BEDF36_OFFSET UNITYSDK_OFFSET(0xC9425D0)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE_METHOD_5_BE4EBC8FF4054312_OFFSET UNITYSDK_OFFSET(0xC940400)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE_METHOD_5_C0342BA270C91EF6_OFFSET UNITYSDK_OFFSET(0xC941A30)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE_METHOD_5_F59E20BA9BC23BFE_OFFSET UNITYSDK_OFFSET(0xC941B10)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE_METHOD_5_FDDF7B7E329390B7_OFFSET UNITYSDK_OFFSET(0xC9415B0)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC942420)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xC9423E0)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0xC942460)
#define RPG_CLIENT_SUBWAY_AIRSHIPSUBWAYCARRIAGE__CTOR_OFFSET UNITYSDK_OFFSET(0xC942B10)

namespace RPG::Client::Subway
{
	inline static constexpr unsigned int AirshipSubwayCarriage_TypeDefinitionIndex = 74390;
