...
#define RPG_CLIENT_POLYMERDATABASEPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE19A90)

namespace RPG::Client
{
	inline static constexpr unsigned int PolymerDatabaseProperty_TypeDefinitionIndex = 70265;
