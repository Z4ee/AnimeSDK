...
#define RPG_CLIENT_POLYMERDATABASEPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0xC4B0590)

namespace RPG::Client
{
	inline static constexpr unsigned int PolymerDatabaseProperty_TypeDefinitionIndex = 65731;
