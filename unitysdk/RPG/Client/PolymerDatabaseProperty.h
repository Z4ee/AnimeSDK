...
#define RPG_CLIENT_POLYMERDATABASEPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x193979E0)

namespace RPG::Client
{
	inline static constexpr unsigned int PolymerDatabaseProperty_TypeDefinitionIndex = 67148;
