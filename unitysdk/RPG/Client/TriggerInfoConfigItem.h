...
#define RPG_CLIENT_TRIGGERINFOCONFIGITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x16FCA430)

namespace RPG::Client
{
	inline static constexpr unsigned int TriggerInfoConfigItem_TypeDefinitionIndex = 65836;
