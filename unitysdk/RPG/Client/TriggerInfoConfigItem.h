...
#define RPG_CLIENT_TRIGGERINFOCONFIGITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xCAEFEE0)

namespace RPG::Client
{
	inline static constexpr unsigned int TriggerInfoConfigItem_TypeDefinitionIndex = 64465;
