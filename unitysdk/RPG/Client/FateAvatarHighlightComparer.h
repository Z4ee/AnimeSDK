...
#define RPG_CLIENT_FATEAVATARHIGHLIGHTCOMPARER__COMPAREIMPL_OFFSET UNITYSDK_OFFSET(0xB97F180)
#define RPG_CLIENT_FATEAVATARHIGHLIGHTCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0xB97F070)

namespace RPG::Client
{
	inline static constexpr unsigned int FateAvatarHighlightComparer_TypeDefinitionIndex = 59819;
