...
#define RPG_CLIENT_FATEAVATARHIGHLIGHTCOMPARER__COMPAREIMPL_OFFSET UNITYSDK_OFFSET(0x1C16EF80)
#define RPG_CLIENT_FATEAVATARHIGHLIGHTCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C16EE50)

namespace RPG::Client
{
	inline static constexpr unsigned int FateAvatarHighlightComparer_TypeDefinitionIndex = 64085;
