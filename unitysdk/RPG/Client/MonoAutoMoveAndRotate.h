...
#define RPG_CLIENT_MONOAUTOMOVEANDROTATE_START_OFFSET UNITYSDK_OFFSET(0x18076D00)
#define RPG_CLIENT_MONOAUTOMOVEANDROTATE_UPDATE_OFFSET UNITYSDK_OFFSET(0x18076D50)
#define RPG_CLIENT_MONOAUTOMOVEANDROTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18076FE0)
