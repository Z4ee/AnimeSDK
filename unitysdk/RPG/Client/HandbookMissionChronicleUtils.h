...
#define RPG_CLIENT_HANDBOOKMISSIONCHRONICLEUTILS_GETMAINPATHFROMCHAPTERDATALISTBY_OFFSET UNITYSDK_OFFSET(0x1A056FE0)
#define RPG_CLIENT_HANDBOOKMISSIONCHRONICLEUTILS_ISMISSIONINPATH_1_OFFSET UNITYSDK_OFFSET(0x1A04C6D0)
#define RPG_CLIENT_HANDBOOKMISSIONCHRONICLEUTILS_ISMISSIONINPATH_OFFSET UNITYSDK_OFFSET(0x1A04BCC0)
#define RPG_CLIENT_HANDBOOKMISSIONCHRONICLEUTILS_TRYFINDSUBPATHDATAFROMMAINPATH_OFFSET UNITYSDK_OFFSET(0x1A056F40)
