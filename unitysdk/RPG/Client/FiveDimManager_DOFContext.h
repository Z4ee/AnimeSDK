...
#define RPG_CLIENT_FIVEDIMMANAGER_DOFCONTEXT_CLEAR_OFFSET UNITYSDK_OFFSET(0xD7210)

namespace RPG::Client
{
	inline static constexpr unsigned int FiveDimManager_DOFContext_TypeDefinitionIndex = 55826;
