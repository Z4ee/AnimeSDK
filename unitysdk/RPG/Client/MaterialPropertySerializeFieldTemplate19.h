...
#define RPG_CLIENT_MATERIALPROPERTYSERIALIZEFIELDTEMPLATE19_GETPROPERTYFIELDS_OFFSET UNITYSDK_OFFSET(0xA86FD60)
#define RPG_CLIENT_MATERIALPROPERTYSERIALIZEFIELDTEMPLATE19__CTOR_OFFSET UNITYSDK_OFFSET(0xA870510)
#define RPG_CLIENT_MATERIALPROPERTYSERIALIZEFIELDTEMPLATE19___IFIXBASEPROXY_GETPROPERTYFIELDS_OFFSET UNITYSDK_OFFSET(0xA870520)

namespace RPG::Client
{
	inline static constexpr unsigned int MaterialPropertySerializeFieldTemplate19_TypeDefinitionIndex = 65156;
