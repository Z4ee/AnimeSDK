...
#define RPG_CLIENT_STATECOMMONIDLETIMER_METHOD_4_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x1A4FDFD0)
#define RPG_CLIENT_STATECOMMONIDLETIMER_METHOD_4_46E2A9A897493A5F_OFFSET UNITYSDK_OFFSET(0x1A4FDB60)
#define RPG_CLIENT_STATECOMMONIDLETIMER_METHOD_4_5A0484A55720CCC6_OFFSET UNITYSDK_OFFSET(0x1A4FDD20)
#define RPG_CLIENT_STATECOMMONIDLETIMER_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0x1A4FDEA0)
#define RPG_CLIENT_STATECOMMONIDLETIMER_ONSTATEEXIT_OFFSET UNITYSDK_OFFSET(0x1A4FE030)
#define RPG_CLIENT_STATECOMMONIDLETIMER_ONSTATEIK_OFFSET UNITYSDK_OFFSET(0x1A4FE270)
#define RPG_CLIENT_STATECOMMONIDLETIMER_ONSTATEMOVE_OFFSET UNITYSDK_OFFSET(0x1A4FE200)
#define RPG_CLIENT_STATECOMMONIDLETIMER_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1A4FE0F0)
#define RPG_CLIENT_STATECOMMONIDLETIMER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4FE2E0)
