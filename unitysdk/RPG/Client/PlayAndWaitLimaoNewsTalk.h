...
#define RPG_CLIENT_PLAYANDWAITLIMAONEWSTALK_METHOD_4_A16C5D41AEAC317D_OFFSET UNITYSDK_OFFSET(0x16E8BCD0)
#define RPG_CLIENT_PLAYANDWAITLIMAONEWSTALK_METHOD_4_FE169169B2FB666C_OFFSET UNITYSDK_OFFSET(0x16E8BD50)
#define RPG_CLIENT_PLAYANDWAITLIMAONEWSTALK__CTOR_OFFSET UNITYSDK_OFFSET(0x16E8BD20)

namespace RPG::Client
{
	inline static constexpr unsigned int PlayAndWaitLimaoNewsTalk_TypeDefinitionIndex = 9947;
