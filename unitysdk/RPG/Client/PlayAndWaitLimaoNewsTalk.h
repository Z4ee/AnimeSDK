...
#define RPG_CLIENT_PLAYANDWAITLIMAONEWSTALK_METHOD_4_C055C8D412427A27_OFFSET UNITYSDK_OFFSET(0x1B9EE7C0)
#define RPG_CLIENT_PLAYANDWAITLIMAONEWSTALK_METHOD_4_FE169169B2FB666C_OFFSET UNITYSDK_OFFSET(0x1B9EE800)
#define RPG_CLIENT_PLAYANDWAITLIMAONEWSTALK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9EE7F0)

namespace RPG::Client
{
	inline static constexpr unsigned int PlayAndWaitLimaoNewsTalk_TypeDefinitionIndex = 9938;
