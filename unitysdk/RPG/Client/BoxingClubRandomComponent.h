...
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_ACTIVEFINISHNODE_OFFSET UNITYSDK_OFFSET(0x920A790)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_FORCERESETTODEFAULT_OFFSET UNITYSDK_OFFSET(0x920A2E0)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_GENERATEPREFABRELATEDINFO_OFFSET UNITYSDK_OFFSET(0x92098A0)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_GENERATEREALRANDOMLIST_OFFSET UNITYSDK_OFFSET(0x9209AF0)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_GETENEMYIMAGECOMPONENT_OFFSET UNITYSDK_OFFSET(0x920A400)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_GETFINISHNODE_OFFSET UNITYSDK_OFFSET(0x920A6A0)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_GETHINTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x920A5B0)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_GETSHOWMONSTERICONINDEX_OFFSET UNITYSDK_OFFSET(0x920A840)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_INITICONS_OFFSET UNITYSDK_OFFSET(0x9209E60)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_INITRANDOMCOMPONENT_OFFSET UNITYSDK_OFFSET(0x92097F0)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_ISCURINDEXSELECTED_OFFSET UNITYSDK_OFFSET(0x920A8C0)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_LIGHTWEIGHTCLEAR_OFFSET UNITYSDK_OFFSET(0x920A2A0)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_ONSELECTNEXT_OFFSET UNITYSDK_OFFSET(0x920A9D0)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_ONWAITEND_OFFSET UNITYSDK_OFFSET(0x9209750)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_PLAY_OFFSET UNITYSDK_OFFSET(0x920A1A0)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_TRYSELECTNEXT_OFFSET UNITYSDK_OFFSET(0x9209640)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_UPDATESPEED_OFFSET UNITYSDK_OFFSET(0x92095B0)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_UPDATE_OFFSET UNITYSDK_OFFSET(0x9209440)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x920AAD0)

namespace RPG::Client
{
	inline static constexpr unsigned int BoxingClubRandomComponent_TypeDefinitionIndex = 59419;
