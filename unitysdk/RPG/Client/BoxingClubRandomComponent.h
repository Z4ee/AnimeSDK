...
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_ACTIVEFINISHNODE_OFFSET UNITYSDK_OFFSET(0x18CB55C0)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_FORCERESETTODEFAULT_OFFSET UNITYSDK_OFFSET(0x18CB5130)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_GENERATEPREFABRELATEDINFO_OFFSET UNITYSDK_OFFSET(0x18CB4580)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_GENERATEREALRANDOMLIST_OFFSET UNITYSDK_OFFSET(0x18CB4940)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_GETENEMYIMAGECOMPONENT_OFFSET UNITYSDK_OFFSET(0x18CB5230)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_GETFINISHNODE_OFFSET UNITYSDK_OFFSET(0x18CB54D0)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_GETHINTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x18CB53E0)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_GETSHOWMONSTERICONINDEX_OFFSET UNITYSDK_OFFSET(0x18CB5670)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_INITICONS_OFFSET UNITYSDK_OFFSET(0x18CB4C70)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_INITRANDOMCOMPONENT_OFFSET UNITYSDK_OFFSET(0x18CB44D0)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_ISCURINDEXSELECTED_OFFSET UNITYSDK_OFFSET(0x18CB56F0)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_LIGHTWEIGHTCLEAR_OFFSET UNITYSDK_OFFSET(0x18CB50F0)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_ONSELECTNEXT_OFFSET UNITYSDK_OFFSET(0x18CB57F0)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_ONWAITEND_OFFSET UNITYSDK_OFFSET(0x18CB4430)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_PLAY_OFFSET UNITYSDK_OFFSET(0x18CB4FE0)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_TRYSELECTNEXT_OFFSET UNITYSDK_OFFSET(0x18CB42E0)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_UPDATESPEED_OFFSET UNITYSDK_OFFSET(0x18CB4250)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT_UPDATE_OFFSET UNITYSDK_OFFSET(0x18CB40D0)
#define RPG_CLIENT_BOXINGCLUBRANDOMCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x18CB5930)

namespace RPG::Client
{
	inline static constexpr unsigned int BoxingClubRandomComponent_TypeDefinitionIndex = 69238;
