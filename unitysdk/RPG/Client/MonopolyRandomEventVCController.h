...
#define RPG_CLIENT_MONOPOLYRANDOMEVENTVCCONTROLLER_CALCULATEORTHOGRAPHICSIZE_OFFSET UNITYSDK_OFFSET(0xD8AD060)
#define RPG_CLIENT_MONOPOLYRANDOMEVENTVCCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0xD8ACFB0)
#define RPG_CLIENT_MONOPOLYRANDOMEVENTVCCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD8AD260)

namespace RPG::Client
{
	inline static constexpr unsigned int MonopolyRandomEventVCController_TypeDefinitionIndex = 72764;
