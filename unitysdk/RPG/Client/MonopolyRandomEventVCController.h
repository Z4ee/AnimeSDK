...
#define RPG_CLIENT_MONOPOLYRANDOMEVENTVCCONTROLLER_CALCULATEORTHOGRAPHICSIZE_OFFSET UNITYSDK_OFFSET(0xAABD0D0)
#define RPG_CLIENT_MONOPOLYRANDOMEVENTVCCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0xAABD010)
#define RPG_CLIENT_MONOPOLYRANDOMEVENTVCCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAABD2D0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonopolyRandomEventVCController_TypeDefinitionIndex = 67106;
