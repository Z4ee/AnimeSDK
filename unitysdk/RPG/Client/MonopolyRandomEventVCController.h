...
#define RPG_CLIENT_MONOPOLYRANDOMEVENTVCCONTROLLER_CALCULATEORTHOGRAPHICSIZE_OFFSET UNITYSDK_OFFSET(0x1954A8D0)
#define RPG_CLIENT_MONOPOLYRANDOMEVENTVCCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0x1954A820)
#define RPG_CLIENT_MONOPOLYRANDOMEVENTVCCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1954AAD0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonopolyRandomEventVCController_TypeDefinitionIndex = 69535;
