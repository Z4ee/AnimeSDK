...
#define RPG_CLIENT_EXPEDITIONBATTLEFLYCONTROL___C__DISPLAYCLASS4_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B88EDE0)
#define RPG_CLIENT_EXPEDITIONBATTLEFLYCONTROL___C__DISPLAYCLASS4_0__PLAY_B__0_OFFSET UNITYSDK_OFFSET(0x1B88EE00)
...
namespace RPG::Client
{
	...
	public:
		...
		::RPG::Client::ExpeditionBattleFlyControl* __4__this; // 0x18
