...
#define RPG_CLIENT_RUNTIMEGROUPMANAGER_GROUPREFRESHEXTRAINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xC88B460)

namespace RPG::Client
{
	inline static constexpr unsigned int RuntimeGroupManager_GroupRefreshExtraInfo_TypeDefinitionIndex = 58041;

	class RuntimeGroupManager_GroupRefreshExtraInfo : public ::System::Object
	{
	public:
		::RPG::Client::RuntimeGroupManager_GroupRefreshReason Reason; // 0x10
		::System::Boolean IsAsync; // 0x14
