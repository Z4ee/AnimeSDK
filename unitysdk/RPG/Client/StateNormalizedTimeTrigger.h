...
#define RPG_CLIENT_STATENORMALIZEDTIMETRIGGER_AWAKE_OFFSET UNITYSDK_OFFSET(0xA4DB3F0)
#define RPG_CLIENT_STATENORMALIZEDTIMETRIGGER_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0xA4DB460)
#define RPG_CLIENT_STATENORMALIZEDTIMETRIGGER_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0xA4DB4E0)
#define RPG_CLIENT_STATENORMALIZEDTIMETRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0xA4DB5C0)
#define RPG_CLIENT_STATENORMALIZEDTIMETRIGGER___IFIXBASEPROXY_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0xA4DB5D0)
#define RPG_CLIENT_STATENORMALIZEDTIMETRIGGER___IFIXBASEPROXY_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0xA4DB5E0)

namespace RPG::Client
{
	inline static constexpr unsigned int StateNormalizedTimeTrigger_TypeDefinitionIndex = 56229;
