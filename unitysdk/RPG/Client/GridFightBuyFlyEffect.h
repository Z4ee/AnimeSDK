...
#define RPG_CLIENT_GRIDFIGHTBUYFLYEFFECT_DESPAWNED_OFFSET UNITYSDK_OFFSET(0x97E86D0)
#define RPG_CLIENT_GRIDFIGHTBUYFLYEFFECT_ONCREATE_OFFSET UNITYSDK_OFFSET(0x97E83F0)
#define RPG_CLIENT_GRIDFIGHTBUYFLYEFFECT_PLAY_OFFSET UNITYSDK_OFFSET(0x97E8710)
#define RPG_CLIENT_GRIDFIGHTBUYFLYEFFECT_SPAWNED_OFFSET UNITYSDK_OFFSET(0x97E8690)
#define RPG_CLIENT_GRIDFIGHTBUYFLYEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x97E89E0)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightBuyFlyEffect_TypeDefinitionIndex = 52372;
