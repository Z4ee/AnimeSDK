...
#define RPG_CLIENT_GRIDFIGHTROLEEFFECT___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1CA72D10)
#define RPG_CLIENT_GRIDFIGHTROLEEFFECT___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1CA72D50)
#define RPG_CLIENT_GRIDFIGHTROLEEFFECT___C__GETSHOWNEFFECTS_B__4_0_OFFSET UNITYSDK_OFFSET(0x1CA72D60)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Func_2<::RPG::Client::IGridFightTraitShowEffect*, ::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(GridFightRoleEffect___c_TypeDefinitionIndex)->GetStaticField(0x3FC30);
		}
		static ::RPG::Client::GridFightRoleEffect___c** StaticGet___9()
		{
			return (::RPG::Client::GridFightRoleEffect___c**)Il2CppClass::FromTypeDefinitionIndex(GridFightRoleEffect___c_TypeDefinitionIndex)->GetStaticField(0x3FC38);
		}
