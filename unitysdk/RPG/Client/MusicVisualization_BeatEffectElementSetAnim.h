...
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTSETANIM_METHOD_2_9F9ED25754A7CAB9_OFFSET UNITYSDK_OFFSET(0xAB2D320)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTSETANIM_METHOD_2_D4684D4E31B8D8A0_OFFSET UNITYSDK_OFFSET(0xAB2D050)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTSETANIM_METHOD_2_F232DA5FE2B51D5A_OFFSET UNITYSDK_OFFSET(0xAB2D0A0)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTSETANIM__CTOR_OFFSET UNITYSDK_OFFSET(0xAB2D2A0)

namespace RPG::Client
{
	inline static constexpr unsigned int MusicVisualization_BeatEffectElementSetAnim_TypeDefinitionIndex = 65305;
