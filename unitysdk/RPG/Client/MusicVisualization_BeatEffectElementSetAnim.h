...
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTSETANIM_METHOD_2_D4684D4E31B8D8A0_OFFSET UNITYSDK_OFFSET(0xC239E00)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTSETANIM_METHOD_2_E9A575D18A0748D9_OFFSET UNITYSDK_OFFSET(0xC23A0D0)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTSETANIM_METHOD_2_F232DA5FE2B51D5A_OFFSET UNITYSDK_OFFSET(0xC239E50)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTSETANIM__CTOR_OFFSET UNITYSDK_OFFSET(0xC23A050)

namespace RPG::Client
{
	inline static constexpr unsigned int MusicVisualization_BeatEffectElementSetAnim_TypeDefinitionIndex = 66232;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_159F4A26A6FBCACF*))((::PBYTE)hIl2Cpp + RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTSETANIM_METHOD_2_E9A575D18A0748D9_OFFSET))(this, a1);
		}
	};
}
