...
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTSETANIM_METHOD_2_9F9ED25754A7CAB9_OFFSET UNITYSDK_OFFSET(0x9DE58F0)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTSETANIM_METHOD_2_D4684D4E31B8D8A0_OFFSET UNITYSDK_OFFSET(0x9DE5620)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTSETANIM_METHOD_2_F232DA5FE2B51D5A_OFFSET UNITYSDK_OFFSET(0x9DE5670)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTSETANIM__CTOR_OFFSET UNITYSDK_OFFSET(0x9DE5870)

namespace RPG::Client
{
	inline static constexpr unsigned int MusicVisualization_BeatEffectElementSetAnim_TypeDefinitionIndex = 58018;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_159F4A26A6FBCACF*))((::PBYTE)hIl2Cpp + RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTSETANIM_METHOD_2_9F9ED25754A7CAB9_OFFSET))(this, P0);
		}
	};
}
