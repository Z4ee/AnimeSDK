...
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTSETANIM_METHOD_2_D4684D4E31B8D8A0_OFFSET UNITYSDK_OFFSET(0x18EA43A0)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTSETANIM_METHOD_2_F232DA5FE2B51D5A_OFFSET UNITYSDK_OFFSET(0x18EA43F0)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTSETANIM__CTOR_OFFSET UNITYSDK_OFFSET(0x18EA45F0)

namespace RPG::Client
{
	inline static constexpr unsigned int MusicVisualization_BeatEffectElementSetAnim_TypeDefinitionIndex = 67657;
