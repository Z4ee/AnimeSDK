...
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_CUSTOMEVENT_METHOD_6_69225B22C8D30B3E_OFFSET UNITYSDK_OFFSET(0xB4D9B10)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_CUSTOMEVENT_METHOD_6_775B6D644F07B554_OFFSET UNITYSDK_OFFSET(0xB4D9B00)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_CUSTOMEVENT_METHOD_6_C5D98F30ADA6FD61_OFFSET UNITYSDK_OFFSET(0xB4D96F0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_CUSTOMEVENT_METHOD_6_D9EF75A2D048B8A1_OFFSET UNITYSDK_OFFSET(0xB4D9560)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_CUSTOMEVENT_SHOWSCORE_OFFSET UNITYSDK_OFFSET(0xB4D92C0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_CUSTOMEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0xB4D99E0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_CUSTOMEVENT___IFIXBASEPROXY_SHOWSCORE_OFFSET UNITYSDK_OFFSET(0xB4D9AF0)

namespace RPG::Client
{
	inline static constexpr unsigned int WolfBroGunPlayTarget_CustomEvent_TypeDefinitionIndex = 63365;
