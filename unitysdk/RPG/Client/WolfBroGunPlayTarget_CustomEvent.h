...
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_CUSTOMEVENT_METHOD_6_C5D98F30ADA6FD61_OFFSET UNITYSDK_OFFSET(0xE42F680)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_CUSTOMEVENT_METHOD_6_D9EF75A2D048B8A1_OFFSET UNITYSDK_OFFSET(0xE42F4F0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_CUSTOMEVENT_SHOWSCORE_OFFSET UNITYSDK_OFFSET(0xE42F250)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_CUSTOMEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0xE42F980)
