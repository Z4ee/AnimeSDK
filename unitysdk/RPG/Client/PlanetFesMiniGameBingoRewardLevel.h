...
#define RPG_CLIENT_PLANETFESMINIGAMEBINGOREWARDLEVEL_CREATE_OFFSET UNITYSDK_OFFSET(0xDB57820)
#define RPG_CLIENT_PLANETFESMINIGAMEBINGOREWARDLEVEL_GET_END_OFFSET UNITYSDK_OFFSET(0xDB57990)
#define RPG_CLIENT_PLANETFESMINIGAMEBINGOREWARDLEVEL_GET_LEVELDESC_OFFSET UNITYSDK_OFFSET(0xDB579B0)
#define RPG_CLIENT_PLANETFESMINIGAMEBINGOREWARDLEVEL_GET_START_OFFSET UNITYSDK_OFFSET(0xDB57970)
#define RPG_CLIENT_PLANETFESMINIGAMEBINGOREWARDLEVEL_SET_END_OFFSET UNITYSDK_OFFSET(0xDB579A0)
#define RPG_CLIENT_PLANETFESMINIGAMEBINGOREWARDLEVEL_SET_LEVELDESC_OFFSET UNITYSDK_OFFSET(0xDB579C0)
#define RPG_CLIENT_PLANETFESMINIGAMEBINGOREWARDLEVEL_SET_START_OFFSET UNITYSDK_OFFSET(0xDB57980)
#define RPG_CLIENT_PLANETFESMINIGAMEBINGOREWARDLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0xDB57960)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::Int32 _Start_k__BackingField; // 0x18
		::System::Int32 _End_k__BackingField; // 0x1C
