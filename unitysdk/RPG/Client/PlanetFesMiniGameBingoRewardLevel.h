...
#define RPG_CLIENT_PLANETFESMINIGAMEBINGOREWARDLEVEL_CREATE_OFFSET UNITYSDK_OFFSET(0xACC7270)
#define RPG_CLIENT_PLANETFESMINIGAMEBINGOREWARDLEVEL_GET_END_OFFSET UNITYSDK_OFFSET(0xACC73E0)
#define RPG_CLIENT_PLANETFESMINIGAMEBINGOREWARDLEVEL_GET_LEVELDESC_OFFSET UNITYSDK_OFFSET(0xACC7400)
#define RPG_CLIENT_PLANETFESMINIGAMEBINGOREWARDLEVEL_GET_START_OFFSET UNITYSDK_OFFSET(0xACC73C0)
#define RPG_CLIENT_PLANETFESMINIGAMEBINGOREWARDLEVEL_SET_END_OFFSET UNITYSDK_OFFSET(0xACC73F0)
#define RPG_CLIENT_PLANETFESMINIGAMEBINGOREWARDLEVEL_SET_LEVELDESC_OFFSET UNITYSDK_OFFSET(0xACC7410)
#define RPG_CLIENT_PLANETFESMINIGAMEBINGOREWARDLEVEL_SET_START_OFFSET UNITYSDK_OFFSET(0xACC73D0)
#define RPG_CLIENT_PLANETFESMINIGAMEBINGOREWARDLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0xACC73B0)

namespace RPG::Client
{
	inline static constexpr unsigned int PlanetFesMiniGameBingoRewardLevel_TypeDefinitionIndex = 61367;
