...
#define RPG_CLIENT_RELICCOMPOSECONTEXT_CLEAR_OFFSET UNITYSDK_OFFSET(0xDE24580)
#define RPG_CLIENT_RELICCOMPOSECONTEXT_CREATE_OFFSET UNITYSDK_OFFSET(0xDE24530)
#define RPG_CLIENT_RELICCOMPOSECONTEXT_GETRECOMMENDDATA_OFFSET UNITYSDK_OFFSET(0xDE246B0)
#define RPG_CLIENT_RELICCOMPOSECONTEXT_GET_AVATARID_OFFSET UNITYSDK_OFFSET(0xDE24510)
#define RPG_CLIENT_RELICCOMPOSECONTEXT_SETAVATARID_OFFSET UNITYSDK_OFFSET(0xDE245D0)
#define RPG_CLIENT_RELICCOMPOSECONTEXT_SET_AVATARID_OFFSET UNITYSDK_OFFSET(0xDE24520)
#define RPG_CLIENT_RELICCOMPOSECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xDE24570)
#define RPG_CLIENT_RELICCOMPOSECONTEXT__ONAVATARIDCHANGED_OFFSET UNITYSDK_OFFSET(0xDE24660)
