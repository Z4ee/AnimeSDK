...
#define RPG_CLIENT_LOCKTARGETPARAM_METHOD_2_7926AB46F25CEA7C_OFFSET UNITYSDK_OFFSET(0x193BB3D0)
#define RPG_CLIENT_LOCKTARGETPARAM_METHOD_2_DEDA9B3A2805D428_OFFSET UNITYSDK_OFFSET(0x193BB250)
#define RPG_CLIENT_LOCKTARGETPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x193BB3C0)

namespace RPG::Client
{
	inline static constexpr unsigned int LockTargetParam_TypeDefinitionIndex = 9865;
