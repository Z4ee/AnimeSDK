...
#define RPG_CLIENT_LOCKTARGETPARAM_METHOD_2_7926AB46F25CEA7C_OFFSET UNITYSDK_OFFSET(0x1B9EDB60)
#define RPG_CLIENT_LOCKTARGETPARAM_METHOD_2_DEDA9B3A2805D428_OFFSET UNITYSDK_OFFSET(0x1B9ED9E0)
#define RPG_CLIENT_LOCKTARGETPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9EDB50)

namespace RPG::Client
{
	inline static constexpr unsigned int LockTargetParam_TypeDefinitionIndex = 9880;
