...
#define RPG_CLIENT_WATERWHEEL_DEBUGINIT_OFFSET UNITYSDK_OFFSET(0x1C81FAC0)
#define RPG_CLIENT_WATERWHEEL_DEBUG_STARTBUTTONTO_OFFSET UNITYSDK_OFFSET(0x167FEF80)
#define RPG_CLIENT_WATERWHEEL_DEBUG_STARTBUTTON_OFFSET UNITYSDK_OFFSET(0x167FEF10)
#define RPG_CLIENT_WATERWHEEL_DEBUG_STOPBUTTON_OFFSET UNITYSDK_OFFSET(0x167FEFF0)
#define RPG_CLIENT_WATERWHEEL_ONARTLOAD_OFFSET UNITYSDK_OFFSET(0x167FF050)
#define RPG_CLIENT_WATERWHEEL_ONARTUNLOAD_OFFSET UNITYSDK_OFFSET(0x167FF0A0)
#define RPG_CLIENT_WATERWHEEL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x167FF0F0)
#define RPG_CLIENT_WATERWHEEL__CTOR_OFFSET UNITYSDK_OFFSET(0x167FF140)
