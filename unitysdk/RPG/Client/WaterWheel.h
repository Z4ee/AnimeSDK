...
#define RPG_CLIENT_WATERWHEEL_DEBUGINIT_OFFSET UNITYSDK_OFFSET(0xA783AA0)
#define RPG_CLIENT_WATERWHEEL_DEBUG_STARTBUTTONTO_OFFSET UNITYSDK_OFFSET(0xA783B90)
#define RPG_CLIENT_WATERWHEEL_DEBUG_STARTBUTTON_OFFSET UNITYSDK_OFFSET(0xA783B20)
#define RPG_CLIENT_WATERWHEEL_DEBUG_STOPBUTTON_OFFSET UNITYSDK_OFFSET(0xA783C00)
#define RPG_CLIENT_WATERWHEEL_ONARTLOAD_OFFSET UNITYSDK_OFFSET(0xA783C60)
#define RPG_CLIENT_WATERWHEEL_ONARTUNLOAD_OFFSET UNITYSDK_OFFSET(0xA783CB0)
#define RPG_CLIENT_WATERWHEEL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xA783D00)
#define RPG_CLIENT_WATERWHEEL__CTOR_OFFSET UNITYSDK_OFFSET(0xA783D50)

namespace RPG::Client
{
	inline static constexpr unsigned int WaterWheel_TypeDefinitionIndex = 56207;
