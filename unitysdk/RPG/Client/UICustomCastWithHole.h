...
#define RPG_CLIENT_UICUSTOMCASTWITHHOLE_UNITYENGINE_ICANVASRAYCASTFILTER_ISRAYCASTLOCATIONVALID_OFFSET UNITYSDK_OFFSET(0xA688070)
#define RPG_CLIENT_UICUSTOMCASTWITHHOLE__CTOR_OFFSET UNITYSDK_OFFSET(0xA6882A0)

namespace RPG::Client
{
	inline static constexpr unsigned int UICustomCastWithHole_TypeDefinitionIndex = 56442;
