...
#define RPG_CLIENT_EFFECT_GPUPARTICLESHAPEEMITTERMONOPLUGIN_CYLINDER_METHOD_2_4F2C6507D17C6667_OFFSET UNITYSDK_OFFSET(0xCDE3540)
#define RPG_CLIENT_EFFECT_GPUPARTICLESHAPEEMITTERMONOPLUGIN_CYLINDER_METHOD_2_AA5EB6C0E8DC9D74_OFFSET UNITYSDK_OFFSET(0xCDE3600)
#define RPG_CLIENT_EFFECT_GPUPARTICLESHAPEEMITTERMONOPLUGIN_CYLINDER_METHOD_2_B0FB0178D34CC9F5_OFFSET UNITYSDK_OFFSET(0xCDE3A80)
#define RPG_CLIENT_EFFECT_GPUPARTICLESHAPEEMITTERMONOPLUGIN_CYLINDER_METHOD_2_E19F224D4967A3A0_OFFSET UNITYSDK_OFFSET(0xCDE2A50)
#define RPG_CLIENT_EFFECT_GPUPARTICLESHAPEEMITTERMONOPLUGIN_CYLINDER__CTOR_OFFSET UNITYSDK_OFFSET(0xCDE4080)
