...
#define RPG_CLIENT_CHIMERASETTLETOENTRANCECOMMAND__CTOR_OFFSET UNITYSDK_OFFSET(0xA0386A0)
#define RPG_CLIENT_CHIMERASETTLETOENTRANCECOMMAND__EXECUTEIMPL_OFFSET UNITYSDK_OFFSET(0xA03B680)
#define RPG_CLIENT_CHIMERASETTLETOENTRANCECOMMAND___IFIXBASEPROXY__EXECUTEIMPL_OFFSET UNITYSDK_OFFSET(0xA03B6F0)

namespace RPG::Client
{
	inline static constexpr unsigned int ChimeraSettleToEntranceCommand_TypeDefinitionIndex = 58470;
