...
#define RPG_CLIENT_CAMERAFIGHTSTATECOMMONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C858420)

namespace RPG::Client
{
	inline static constexpr unsigned int CameraFightStateCommonConfig_TypeDefinitionIndex = 69542;
