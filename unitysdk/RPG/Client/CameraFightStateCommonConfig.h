...
#define RPG_CLIENT_CAMERAFIGHTSTATECOMMONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x9259D30)

namespace RPG::Client
{
	inline static constexpr unsigned int CameraFightStateCommonConfig_TypeDefinitionIndex = 56873;
