...
#define RPG_CLIENT_BATTLEGAMEPHASE___C__DISPLAYCLASS68_0__CTOR_OFFSET UNITYSDK_OFFSET(0xB3E80E0)
#define RPG_CLIENT_BATTLEGAMEPHASE___C__DISPLAYCLASS68_0__RESTARTBATTLEAFTERLOADFINISH_B__0_OFFSET UNITYSDK_OFFSET(0xB3F8B70)
#define RPG_CLIENT_BATTLEGAMEPHASE___C__DISPLAYCLASS68_0__RESTARTBATTLEAFTERLOADFINISH_B__1_OFFSET UNITYSDK_OFFSET(0xB3F8BD0)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleGamePhase___c__DisplayClass68_0_TypeDefinitionIndex = 56994;
