...
#define RPG_CLIENT_LOOPGENERATOR__COLLECTALLREFASSETPATH_D__0_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x15BEC780)
#define RPG_CLIENT_LOOPGENERATOR__COLLECTALLREFASSETPATH_D__0_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_STRING__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x15BEC8B0)
#define RPG_CLIENT_LOOPGENERATOR__COLLECTALLREFASSETPATH_D__0_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x15BEC910)
#define RPG_CLIENT_LOOPGENERATOR__COLLECTALLREFASSETPATH_D__0_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x15BEC8C0)
#define RPG_CLIENT_LOOPGENERATOR__COLLECTALLREFASSETPATH_D__0_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15BEC770)
#define RPG_CLIENT_LOOPGENERATOR__COLLECTALLREFASSETPATH_D__0__CTOR_OFFSET UNITYSDK_OFFSET(0x15BE9CD0)

namespace RPG::Client
{
	inline static constexpr unsigned int LoopGenerator__CollectAllRefAssetPath_d__0_TypeDefinitionIndex = 69654;

	class LoopGenerator__CollectAllRefAssetPath_d__0 : public ::System::Object
	{
	public:
		::System::Collections::Generic::List_1<::RPG::Client::LoopGenerator_SliderTemplate>* _templates_5__3; // 0x10
