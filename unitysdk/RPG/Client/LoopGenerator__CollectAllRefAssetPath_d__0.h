...
#define RPG_CLIENT_LOOPGENERATOR__COLLECTALLREFASSETPATH_D__0_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xBE7E620)
#define RPG_CLIENT_LOOPGENERATOR__COLLECTALLREFASSETPATH_D__0_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_STRING__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xBE7E750)
#define RPG_CLIENT_LOOPGENERATOR__COLLECTALLREFASSETPATH_D__0_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xBE7E7B0)
#define RPG_CLIENT_LOOPGENERATOR__COLLECTALLREFASSETPATH_D__0_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xBE7E760)
#define RPG_CLIENT_LOOPGENERATOR__COLLECTALLREFASSETPATH_D__0_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xBE7E610)
#define RPG_CLIENT_LOOPGENERATOR__COLLECTALLREFASSETPATH_D__0__CTOR_OFFSET UNITYSDK_OFFSET(0xBE7BC00)

namespace RPG::Client
{
	inline static constexpr unsigned int LoopGenerator__CollectAllRefAssetPath_d__0_TypeDefinitionIndex = 68168;
