...
#define RPG_CLIENT_LOOPGENERATOR__COLLECTALLREFASSETPATH_D__0_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x174855C0)
#define RPG_CLIENT_LOOPGENERATOR__COLLECTALLREFASSETPATH_D__0_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_STRING__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x174856F0)
#define RPG_CLIENT_LOOPGENERATOR__COLLECTALLREFASSETPATH_D__0_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x17485750)
#define RPG_CLIENT_LOOPGENERATOR__COLLECTALLREFASSETPATH_D__0_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x17485700)
#define RPG_CLIENT_LOOPGENERATOR__COLLECTALLREFASSETPATH_D__0_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x174855B0)
#define RPG_CLIENT_LOOPGENERATOR__COLLECTALLREFASSETPATH_D__0__CTOR_OFFSET UNITYSDK_OFFSET(0x17482B10)

namespace RPG::Client
{
	inline static constexpr unsigned int LoopGenerator__CollectAllRefAssetPath_d__0_TypeDefinitionIndex = 72893;

	class LoopGenerator__CollectAllRefAssetPath_d__0 : public ::System::Object
	{
	public:
		::RPG::Client::LoopGenerator* __4__this; // 0x10
