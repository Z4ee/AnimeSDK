...
#define RPG_CLIENT_ENTERGAMEPHASE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A17AE30)
#define RPG_CLIENT_ENTERGAMEPHASE_ENTERGAME_OFFSET UNITYSDK_OFFSET(0x1A17E5D0)
#define RPG_CLIENT_ENTERGAMEPHASE_ENTER_OFFSET UNITYSDK_OFFSET(0x1A17B140)
#define RPG_CLIENT_ENTERGAMEPHASE_FINISHLOGIN_OFFSET UNITYSDK_OFFSET(0x1A17E4C0)
#define RPG_CLIENT_ENTERGAMEPHASE_GETGAMEPHASETYPE_OFFSET UNITYSDK_OFFSET(0x1A17D400)
#define RPG_CLIENT_ENTERGAMEPHASE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1A17B0E0)
#define RPG_CLIENT_ENTERGAMEPHASE_LEAVE_OFFSET UNITYSDK_OFFSET(0x1A17D320)
#define RPG_CLIENT_ENTERGAMEPHASE_PS_PSNCHECK_OFFSET UNITYSDK_OFFSET(0x1A17E330)
#define RPG_CLIENT_ENTERGAMEPHASE_RESETTIMEOUTTIME_OFFSET UNITYSDK_OFFSET(0x1A17D580)
#define RPG_CLIENT_ENTERGAMEPHASE_TICK_OFFSET UNITYSDK_OFFSET(0x1A17AEB0)
#define RPG_CLIENT_ENTERGAMEPHASE_TRYQUITBATTLEWHENLOGIN_OFFSET UNITYSDK_OFFSET(0x1A17E6A0)
#define RPG_CLIENT_ENTERGAMEPHASE__ADDHANDLERS_OFFSET UNITYSDK_OFFSET(0x1A17B8D0)
#define RPG_CLIENT_ENTERGAMEPHASE__CHECKMISSIONRES_OFFSET UNITYSDK_OFFSET(0x1A17CD20)
#define RPG_CLIENT_ENTERGAMEPHASE__CHECKSERVERSTATE_OFFSET UNITYSDK_OFFSET(0x1A17C010)
#define RPG_CLIENT_ENTERGAMEPHASE__CMDIMPORTANTPACKETRECV_OFFSET UNITYSDK_OFFSET(0x1A17D450)
#define RPG_CLIENT_ENTERGAMEPHASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A17ACD0)
#define RPG_CLIENT_ENTERGAMEPHASE__ENABLELOGINBUTTON_OFFSET UNITYSDK_OFFSET(0x1A17BAC0)
#define RPG_CLIENT_ENTERGAMEPHASE__FINISHENTERANIM_OFFSET UNITYSDK_OFFSET(0x1A17BF80)
#define RPG_CLIENT_ENTERGAMEPHASE__LOGINEXCEPTIONHANDLER_OFFSET UNITYSDK_OFFSET(0x1A17E830)
#define RPG_CLIENT_ENTERGAMEPHASE__LOGINREPORTMSG_OFFSET UNITYSDK_OFFSET(0x1A17D7E0)
#define RPG_CLIENT_ENTERGAMEPHASE__ONCONFIRMENTER_OFFSET UNITYSDK_OFFSET(0x1A17D5E0)
#define RPG_CLIENT_ENTERGAMEPHASE__ONEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1A17EA40)
#define RPG_CLIENT_ENTERGAMEPHASE__ONFINISHENTERANIM_OFFSET UNITYSDK_OFFSET(0x1A17BF20)
#define RPG_CLIENT_ENTERGAMEPHASE__ONNETCONTINUE_OFFSET UNITYSDK_OFFSET(0x1A17DBF0)
#define RPG_CLIENT_ENTERGAMEPHASE__RELOADASSETREFMANIFEST_OFFSET UNITYSDK_OFFSET(0x1A17E3B0)
#define RPG_CLIENT_ENTERGAMEPHASE__SETUPFUNCTIONBTN_OFFSET UNITYSDK_OFFSET(0x1A17B800)
#define RPG_CLIENT_ENTERGAMEPHASE__STARTLOGIN_OFFSET UNITYSDK_OFFSET(0x1A17DC60)
#define RPG_CLIENT_ENTERGAMEPHASE__SUBPACKAGECHECKED_OFFSET UNITYSDK_OFFSET(0x1A17CB60)
#define RPG_CLIENT_ENTERGAMEPHASE__SUBPACKAGEMISSIONGOTTED_OFFSET UNITYSDK_OFFSET(0x1A17C610)
#define RPG_CLIENT_ENTERGAMEPHASE__TABLEINITED_OFFSET UNITYSDK_OFFSET(0x1A17C340)
#define RPG_CLIENT_ENTERGAMEPHASE__TRYSAVESELECTEDSERVER_OFFSET UNITYSDK_OFFSET(0x1A17D990)
#define RPG_CLIENT_ENTERGAMEPHASE___SUBPACKAGECHECKED_B__15_0_OFFSET UNITYSDK_OFFSET(0x1A17ED60)

namespace RPG::Client
{
	inline static constexpr unsigned int EnterGamePhase_TypeDefinitionIndex = 61240;

	class EnterGamePhase : public ::RPG::Client::LoginPhase
	{
	public:
		::RPG::Client::Promises::Promise* finishEnterAnimPromise; // 0x28
		...
		::System::Collections::Generic::List_1<::System::UInt16>* WaitPacketQueue; // 0x48
