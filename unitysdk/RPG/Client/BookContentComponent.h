...
#define RPG_CLIENT_BOOKCONTENTCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0xC960600)

namespace RPG::Client
{
	inline static constexpr unsigned int BookContentComponent_TypeDefinitionIndex = 72436;
