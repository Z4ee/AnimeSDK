...
#define RPG_CLIENT_PROMISES_PROMISE___C__DISPLAYCLASS59_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2C6E50)
#define RPG_CLIENT_PROMISES_PROMISE___C__DISPLAYCLASS59_0__THENALL_B__0_OFFSET UNITYSDK_OFFSET(0x1D2C86D0)

namespace RPG::Client::Promises
{
	inline static constexpr unsigned int Promise___c__DisplayClass59_0_TypeDefinitionIndex = 9582;
