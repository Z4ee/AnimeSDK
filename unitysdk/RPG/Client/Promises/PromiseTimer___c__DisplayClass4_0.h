...
#define RPG_CLIENT_PROMISES_PROMISETIMER___C__DISPLAYCLASS4_0__CTOR_OFFSET UNITYSDK_OFFSET(0x18349030)
#define RPG_CLIENT_PROMISES_PROMISETIMER___C__DISPLAYCLASS4_0__WAITWHILE_B__0_OFFSET UNITYSDK_OFFSET(0x18349580)

namespace RPG::Client::Promises
{
	inline static constexpr unsigned int PromiseTimer___c__DisplayClass4_0_TypeDefinitionIndex = 9606;
