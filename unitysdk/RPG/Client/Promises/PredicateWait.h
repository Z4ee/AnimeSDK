...
#define RPG_CLIENT_PROMISES_PREDICATEWAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x18345260)

namespace RPG::Client::Promises
{
	inline static constexpr unsigned int PredicateWait_TypeDefinitionIndex = 9601;
