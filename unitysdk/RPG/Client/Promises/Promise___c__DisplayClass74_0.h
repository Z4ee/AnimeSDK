...
#define RPG_CLIENT_PROMISES_PROMISE___C__DISPLAYCLASS74_0__CONTINUEWITH_B__0_OFFSET UNITYSDK_OFFSET(0x1D2C9280)
#define RPG_CLIENT_PROMISES_PROMISE___C__DISPLAYCLASS74_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2C7E50)

namespace RPG::Client::Promises
{
	inline static constexpr unsigned int Promise___c__DisplayClass74_0_TypeDefinitionIndex = 9594;
