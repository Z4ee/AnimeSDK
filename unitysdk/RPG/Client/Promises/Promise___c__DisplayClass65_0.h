...
#define RPG_CLIENT_PROMISES_PROMISE___C__DISPLAYCLASS65_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2C75E0)
#define RPG_CLIENT_PROMISES_PROMISE___C__DISPLAYCLASS65_0__SEQUENCE_B__0_OFFSET UNITYSDK_OFFSET(0x1D2C8AE0)

namespace RPG::Client::Promises
{
	inline static constexpr unsigned int Promise___c__DisplayClass65_0_TypeDefinitionIndex = 9587;
