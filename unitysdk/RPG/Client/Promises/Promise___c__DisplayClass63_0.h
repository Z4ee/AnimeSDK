...
#define RPG_CLIENT_PROMISES_PROMISE___C__DISPLAYCLASS63_0__CTOR_OFFSET UNITYSDK_OFFSET(0x183472D0)
#define RPG_CLIENT_PROMISES_PROMISE___C__DISPLAYCLASS63_0__THENSEQUENCE_B__0_OFFSET UNITYSDK_OFFSET(0x18348660)

namespace RPG::Client::Promises
{
	inline static constexpr unsigned int Promise___c__DisplayClass63_0_TypeDefinitionIndex = 9623;
