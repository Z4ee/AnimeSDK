...
#define RPG_CLIENT_ST_PARKOUR_SWITCHROAD_METHOD_4_23D1A0E75276F8FB_OFFSET UNITYSDK_OFFSET(0x185EDCB0)
#define RPG_CLIENT_ST_PARKOUR_SWITCHROAD_METHOD_4_24E28BE7C123299D_OFFSET UNITYSDK_OFFSET(0x185EDD90)
#define RPG_CLIENT_ST_PARKOUR_SWITCHROAD__CTOR_OFFSET UNITYSDK_OFFSET(0x185EDD30)

namespace RPG::Client
{
	inline static constexpr unsigned int ST_Parkour_SwitchRoad_TypeDefinitionIndex = 10139;
