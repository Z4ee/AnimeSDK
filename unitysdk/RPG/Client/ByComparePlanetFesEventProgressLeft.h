...
#define RPG_CLIENT_BYCOMPAREPLANETFESEVENTPROGRESSLEFT_METHOD_4_7FAC92942103F342_OFFSET UNITYSDK_OFFSET(0x1D3074D0)
#define RPG_CLIENT_BYCOMPAREPLANETFESEVENTPROGRESSLEFT_METHOD_4_A21E28B548A4224F_OFFSET UNITYSDK_OFFSET(0x1D307490)
#define RPG_CLIENT_BYCOMPAREPLANETFESEVENTPROGRESSLEFT_METHOD_4_B0831A8246B287B4_OFFSET UNITYSDK_OFFSET(0x1D307640)
#define RPG_CLIENT_BYCOMPAREPLANETFESEVENTPROGRESSLEFT_METHOD_4_CF4913875A376DDB_OFFSET UNITYSDK_OFFSET(0x1D307670)
#define RPG_CLIENT_BYCOMPAREPLANETFESEVENTPROGRESSLEFT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D3074C0)

namespace RPG::Client
{
	inline static constexpr unsigned int ByComparePlanetFesEventProgressLeft_TypeDefinitionIndex = 10260;
