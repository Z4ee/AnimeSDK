...
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCELEFTELITEMONSTERITEM_GET_DESC_OFFSET UNITYSDK_OFFSET(0xA34A500)
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCELEFTELITEMONSTERITEM_GET_VALUE_OFFSET UNITYSDK_OFFSET(0xA34A090)
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCELEFTELITEMONSTERITEM_GET__DMGMAXLIMIT_OFFSET UNITYSDK_OFFSET(0xA34A3A0)
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCELEFTELITEMONSTERITEM_GET__DMGPERLEFTMONSTER_OFFSET UNITYSDK_OFFSET(0xA34A240)
#define RPG_CLIENT_FATEGAMEROUNDSETTLEDMGSOURCELEFTELITEMONSTERITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xA34A080)

namespace RPG::Client
{
	inline static constexpr unsigned int FateGameRoundSettleDmgSourceLeftEliteMonsterItem_TypeDefinitionIndex = 58920;
