...
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEDATAITEM_CREATE_OFFSET UNITYSDK_OFFSET(0xC9B6C50)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEDATAITEM_GET_ANIMTRIGGER_OFFSET UNITYSDK_OFFSET(0xC9B69C0)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEDATAITEM_GET_AUDIOTAG_OFFSET UNITYSDK_OFFSET(0xC9B6BB0)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEDATAITEM_GET_CD_OFFSET UNITYSDK_OFFSET(0xC9B6880)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEDATAITEM_GET_DELAY_OFFSET UNITYSDK_OFFSET(0xC9B6920)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEDATAITEM_GET_PARAMS_OFFSET UNITYSDK_OFFSET(0xC9B67E0)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEDATAITEM_GET_PERFORMANCEID_OFFSET UNITYSDK_OFFSET(0xC9B6730)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEDATAITEM_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xC9B6B10)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEDATAITEM_GET_TEXTID_OFFSET UNITYSDK_OFFSET(0xC9B6A50)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEDATAITEM_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xC9B6740)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEDATAITEM_GET__ROW_OFFSET UNITYSDK_OFFSET(0xC9B66D0)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xC9B6CA0)

namespace RPG::Client::CakeRace
{
	inline static constexpr unsigned int CakeRacePerformanceDataItem_TypeDefinitionIndex = 75993;
