...
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEDATAITEM_CREATE_OFFSET UNITYSDK_OFFSET(0x1AAB8C30)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEDATAITEM_GET_ANIMTRIGGER_OFFSET UNITYSDK_OFFSET(0x1AAB89A0)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEDATAITEM_GET_AUDIOTAG_OFFSET UNITYSDK_OFFSET(0x1AAB8B90)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEDATAITEM_GET_CD_OFFSET UNITYSDK_OFFSET(0x1AAB8860)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEDATAITEM_GET_DELAY_OFFSET UNITYSDK_OFFSET(0x1AAB8900)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEDATAITEM_GET_PARAMS_OFFSET UNITYSDK_OFFSET(0x1AAB87C0)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEDATAITEM_GET_PERFORMANCEID_OFFSET UNITYSDK_OFFSET(0x1AAB8710)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEDATAITEM_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x1AAB8AF0)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEDATAITEM_GET_TEXTID_OFFSET UNITYSDK_OFFSET(0x1AAB8A30)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEDATAITEM_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1AAB8720)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEDATAITEM_GET__ROW_OFFSET UNITYSDK_OFFSET(0x1AAB86B0)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAB8C80)

namespace RPG::Client::CakeRace
{
	inline static constexpr unsigned int CakeRacePerformanceDataItem_TypeDefinitionIndex = 72556;
