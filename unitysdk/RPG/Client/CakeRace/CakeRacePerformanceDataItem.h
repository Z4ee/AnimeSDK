...
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEDATAITEM_CREATE_OFFSET UNITYSDK_OFFSET(0x922B660)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEDATAITEM_GET_ANIMTRIGGER_OFFSET UNITYSDK_OFFSET(0x922B390)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEDATAITEM_GET_AUDIOTAG_OFFSET UNITYSDK_OFFSET(0x922B5F0)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEDATAITEM_GET_CD_OFFSET UNITYSDK_OFFSET(0x922B070)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEDATAITEM_GET_DELAY_OFFSET UNITYSDK_OFFSET(0x922B200)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEDATAITEM_GET_PARAMS_OFFSET UNITYSDK_OFFSET(0x922B000)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEDATAITEM_GET_PERFORMANCEID_OFFSET UNITYSDK_OFFSET(0x922AF80)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEDATAITEM_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x922B580)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEDATAITEM_GET_TEXTID_OFFSET UNITYSDK_OFFSET(0x922B500)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEDATAITEM_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x922AF90)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEDATAITEM_GET__ROW_OFFSET UNITYSDK_OFFSET(0x922AF20)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x922B6B0)

namespace RPG::Client::CakeRace
{
	inline static constexpr unsigned int CakeRacePerformanceDataItem_TypeDefinitionIndex = 62232;
