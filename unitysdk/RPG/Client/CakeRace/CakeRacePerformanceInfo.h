...
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEINFO_CREATE_OFFSET UNITYSDK_OFFSET(0x1AAB8C90)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEINFO_GETOWLBERTANIMDATAITEM_OFFSET UNITYSDK_OFFSET(0x1AAB9490)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEINFO_GETPERFORMANCEDATAITEM_OFFSET UNITYSDK_OFFSET(0x1AAB9400)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAB8E10)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEINFO__INITANIMCONFIG_OFFSET UNITYSDK_OFFSET(0x1AAB91C0)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEINFO__INITPERFORMANCEDATAITEMS_OFFSET UNITYSDK_OFFSET(0x1AAB8F40)
#define RPG_CLIENT_CAKERACE_CAKERACEPERFORMANCEINFO__INIT_OFFSET UNITYSDK_OFFSET(0x1AAB8EF0)

namespace RPG::Client::CakeRace
{
	inline static constexpr unsigned int CakeRacePerformanceInfo_TypeDefinitionIndex = 72557;
