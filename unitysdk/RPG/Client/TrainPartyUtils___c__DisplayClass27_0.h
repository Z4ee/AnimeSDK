...
#define RPG_CLIENT_TRAINPARTYUTILS___C__DISPLAYCLASS27_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2A80C0)
#define RPG_CLIENT_TRAINPARTYUTILS___C__DISPLAYCLASS27_0__TRANSFERTOPLAYERROOM_B__0_OFFSET UNITYSDK_OFFSET(0x1B2A8AF0)
#define RPG_CLIENT_TRAINPARTYUTILS___C__DISPLAYCLASS27_0__TRANSFERTOPLAYERROOM_B__1_OFFSET UNITYSDK_OFFSET(0x1B2A8DB0)

namespace RPG::Client
{
	inline static constexpr unsigned int TrainPartyUtils___c__DisplayClass27_0_TypeDefinitionIndex = 68165;
