...
#define RPG_CLIENT_TRAINPARTYUTILS___C__DISPLAYCLASS27_0__CTOR_OFFSET UNITYSDK_OFFSET(0xB36C260)
#define RPG_CLIENT_TRAINPARTYUTILS___C__DISPLAYCLASS27_0__TRANSFERTOPLAYERROOM_B__0_OFFSET UNITYSDK_OFFSET(0xB36CB70)
#define RPG_CLIENT_TRAINPARTYUTILS___C__DISPLAYCLASS27_0__TRANSFERTOPLAYERROOM_B__1_OFFSET UNITYSDK_OFFSET(0xB36CDD0)

namespace RPG::Client
{
	inline static constexpr unsigned int TrainPartyUtils___c__DisplayClass27_0_TypeDefinitionIndex = 62854;
