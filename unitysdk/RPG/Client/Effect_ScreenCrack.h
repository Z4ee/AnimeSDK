...
#define RPG_CLIENT_EFFECT_SCREENCRACK_METHOD_5_2F381734DBBAB430_OFFSET UNITYSDK_OFFSET(0xCE15E40)
#define RPG_CLIENT_EFFECT_SCREENCRACK_METHOD_5_4ADE96F0541BC427_OFFSET UNITYSDK_OFFSET(0xCE16050)
#define RPG_CLIENT_EFFECT_SCREENCRACK_METHOD_5_99D848AEA005759A_OFFSET UNITYSDK_OFFSET(0xCE16180)
#define RPG_CLIENT_EFFECT_SCREENCRACK_METHOD_5_EDFD49C942C75D6C_OFFSET UNITYSDK_OFFSET(0xCE15970)
#define RPG_CLIENT_EFFECT_SCREENCRACK_METHOD_5_FA0119DD445A672F_OFFSET UNITYSDK_OFFSET(0xCE15FF0)
#define RPG_CLIENT_EFFECT_SCREENCRACK_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xCE15DB0)
#define RPG_CLIENT_EFFECT_SCREENCRACK_ONENABLE_OFFSET UNITYSDK_OFFSET(0xCE15BF0)
#define RPG_CLIENT_EFFECT_SCREENCRACK_UPDATE_OFFSET UNITYSDK_OFFSET(0xCE15910)
#define RPG_CLIENT_EFFECT_SCREENCRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xCE16380)
