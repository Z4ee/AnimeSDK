...
#define RPG_CLIENT_EFFECT_SCREENCRACK_METHOD_5_2F381734DBBAB430_OFFSET UNITYSDK_OFFSET(0xA201910)
#define RPG_CLIENT_EFFECT_SCREENCRACK_METHOD_5_4ADE96F0541BC427_OFFSET UNITYSDK_OFFSET(0xA201B40)
#define RPG_CLIENT_EFFECT_SCREENCRACK_METHOD_5_95FC878EB184D294_OFFSET UNITYSDK_OFFSET(0xA201AE0)
#define RPG_CLIENT_EFFECT_SCREENCRACK_METHOD_5_99D848AEA005759A_OFFSET UNITYSDK_OFFSET(0xA201C70)
#define RPG_CLIENT_EFFECT_SCREENCRACK_METHOD_5_EDFD49C942C75D6C_OFFSET UNITYSDK_OFFSET(0xA201420)
#define RPG_CLIENT_EFFECT_SCREENCRACK_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xA201880)
#define RPG_CLIENT_EFFECT_SCREENCRACK_ONENABLE_OFFSET UNITYSDK_OFFSET(0xA2016A0)
#define RPG_CLIENT_EFFECT_SCREENCRACK_UPDATE_OFFSET UNITYSDK_OFFSET(0xA2013C0)
#define RPG_CLIENT_EFFECT_SCREENCRACK__CTOR_OFFSET UNITYSDK_OFFSET(0xA201E90)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_ScreenCrack_TypeDefinitionIndex = 65041;
