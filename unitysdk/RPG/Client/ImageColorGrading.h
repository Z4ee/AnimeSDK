...
#define RPG_CLIENT_IMAGECOLORGRADING_GETMATERIALFORRENDERING_OFFSET UNITYSDK_OFFSET(0xA6223D0)
#define RPG_CLIENT_IMAGECOLORGRADING_GET_IMAGE_OFFSET UNITYSDK_OFFSET(0xA622320)
#define RPG_CLIENT_IMAGECOLORGRADING_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xA622C20)
#define RPG_CLIENT_IMAGECOLORGRADING_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xA622C80)
#define RPG_CLIENT_IMAGECOLORGRADING_UPDATE_OFFSET UNITYSDK_OFFSET(0xA6229C0)
#define RPG_CLIENT_IMAGECOLORGRADING__CTOR_OFFSET UNITYSDK_OFFSET(0xA622CD0)
#define RPG_CLIENT_IMAGECOLORGRADING___IFIXBASEPROXY_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xA622D50)
#define RPG_CLIENT_IMAGECOLORGRADING___IFIXBASEPROXY_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xA622D60)

namespace RPG::Client
{
	inline static constexpr unsigned int ImageColorGrading_TypeDefinitionIndex = 66844;
