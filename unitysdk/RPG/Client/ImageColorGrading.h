...
#define RPG_CLIENT_IMAGECOLORGRADING_GETMATERIALFORRENDERING_OFFSET UNITYSDK_OFFSET(0xBD26D80)
#define RPG_CLIENT_IMAGECOLORGRADING_GET_IMAGE_OFFSET UNITYSDK_OFFSET(0xBD26CD0)
#define RPG_CLIENT_IMAGECOLORGRADING_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xBD275C0)
#define RPG_CLIENT_IMAGECOLORGRADING_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xBD27620)
#define RPG_CLIENT_IMAGECOLORGRADING_UPDATE_OFFSET UNITYSDK_OFFSET(0xBD27360)
#define RPG_CLIENT_IMAGECOLORGRADING__CTOR_OFFSET UNITYSDK_OFFSET(0xBD27670)
#define RPG_CLIENT_IMAGECOLORGRADING___IFIXBASEPROXY_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xBD276F0)
#define RPG_CLIENT_IMAGECOLORGRADING___IFIXBASEPROXY_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xBD27700)

namespace RPG::Client
{
	inline static constexpr unsigned int ImageColorGrading_TypeDefinitionIndex = 67784;
