...
#define RPG_CLIENT_ROLLSHOPREWARDGROUP_GET_ID_OFFSET UNITYSDK_OFFSET(0xA3F8300)
#define RPG_CLIENT_ROLLSHOPREWARDGROUP_GET_ITEMS_OFFSET UNITYSDK_OFFSET(0xA3F8320)
#define RPG_CLIENT_ROLLSHOPREWARDGROUP_GET_REWARDIDS_OFFSET UNITYSDK_OFFSET(0xA3F8310)
#define RPG_CLIENT_ROLLSHOPREWARDGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0xA3F7620)

namespace RPG::Client
{
	inline static constexpr unsigned int RollShopRewardGroup_TypeDefinitionIndex = 55391;
