...
#define RPG_CLIENT_MONOEFFECTPLUGINTIMEREWIND_DISPOSEPLUGIN_OFFSET UNITYSDK_OFFSET(0x1B3988A0)
#define RPG_CLIENT_MONOEFFECTPLUGINTIMEREWIND_PAUSE_OFFSET UNITYSDK_OFFSET(0x1B398BF0)
#define RPG_CLIENT_MONOEFFECTPLUGINTIMEREWIND_PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0x1B398A70)
#define RPG_CLIENT_MONOEFFECTPLUGINTIMEREWIND_PLAYFADEOUT_OFFSET UNITYSDK_OFFSET(0x1B3988F0)
#define RPG_CLIENT_MONOEFFECTPLUGINTIMEREWIND_RESETPLUGIN_OFFSET UNITYSDK_OFFSET(0x1B398700)
#define RPG_CLIENT_MONOEFFECTPLUGINTIMEREWIND_RESUMEPAUSE_OFFSET UNITYSDK_OFFSET(0x1B398C80)
#define RPG_CLIENT_MONOEFFECTPLUGINTIMEREWIND_SETFORWARDANIMANDBACKWARDANIM_OFFSET UNITYSDK_OFFSET(0x1B398D10)
#define RPG_CLIENT_MONOEFFECTPLUGINTIMEREWIND__CTOR_OFFSET UNITYSDK_OFFSET(0x1B398DA0)
