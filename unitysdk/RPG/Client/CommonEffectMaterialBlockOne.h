...
#define RPG_CLIENT_COMMONEFFECTMATERIALBLOCKONE_METHOD_1_03CAA9FC4591314A_OFFSET UNITYSDK_OFFSET(0x1A282950)
#define RPG_CLIENT_COMMONEFFECTMATERIALBLOCKONE_METHOD_1_4F515A5348AB9F15_OFFSET UNITYSDK_OFFSET(0x1A282790)
#define RPG_CLIENT_COMMONEFFECTMATERIALBLOCKONE_METHOD_1_925BAA812281E334_OFFSET UNITYSDK_OFFSET(0x1A282B40)
#define RPG_CLIENT_COMMONEFFECTMATERIALBLOCKONE_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1A282600)
#define RPG_CLIENT_COMMONEFFECTMATERIALBLOCKONE_METHOD_1_FD899611565019E0_OFFSET UNITYSDK_OFFSET(0x1A282660)
#define RPG_CLIENT_COMMONEFFECTMATERIALBLOCKONE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A2825A0)
#define RPG_CLIENT_COMMONEFFECTMATERIALBLOCKONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2824D0)

namespace RPG::Client
{
	inline static constexpr unsigned int CommonEffectMaterialBlockOne_TypeDefinitionIndex = 70360;
