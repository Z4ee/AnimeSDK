...
#define RPG_CLIENT_COMMONEFFECTMATERIALBLOCKONE_METHOD_1_03CAA9FC4591314A_OFFSET UNITYSDK_OFFSET(0x940E0D0)
#define RPG_CLIENT_COMMONEFFECTMATERIALBLOCKONE_METHOD_1_4F515A5348AB9F15_OFFSET UNITYSDK_OFFSET(0x940DF10)
#define RPG_CLIENT_COMMONEFFECTMATERIALBLOCKONE_METHOD_1_57D26ACB9ECBBA35_OFFSET UNITYSDK_OFFSET(0x940E2C0)
#define RPG_CLIENT_COMMONEFFECTMATERIALBLOCKONE_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x940DD80)
#define RPG_CLIENT_COMMONEFFECTMATERIALBLOCKONE_METHOD_1_FD899611565019E0_OFFSET UNITYSDK_OFFSET(0x940DDE0)
#define RPG_CLIENT_COMMONEFFECTMATERIALBLOCKONE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x940DD20)
#define RPG_CLIENT_COMMONEFFECTMATERIALBLOCKONE__CTOR_OFFSET UNITYSDK_OFFSET(0x940DC30)

namespace RPG::Client
{
	inline static constexpr unsigned int CommonEffectMaterialBlockOne_TypeDefinitionIndex = 57631;
