...
#define RPG_CLIENT_COMMONEFFECTMATERIALBLOCKONE_METHOD_1_03CAA9FC4591314A_OFFSET UNITYSDK_OFFSET(0xB6F9ED0)
#define RPG_CLIENT_COMMONEFFECTMATERIALBLOCKONE_METHOD_1_2DC38ACBCA72BA63_OFFSET UNITYSDK_OFFSET(0xB6FA0C0)
#define RPG_CLIENT_COMMONEFFECTMATERIALBLOCKONE_METHOD_1_4F515A5348AB9F15_OFFSET UNITYSDK_OFFSET(0xB6F9D10)
#define RPG_CLIENT_COMMONEFFECTMATERIALBLOCKONE_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xB6F9B80)
#define RPG_CLIENT_COMMONEFFECTMATERIALBLOCKONE_METHOD_1_FD899611565019E0_OFFSET UNITYSDK_OFFSET(0xB6F9BE0)
#define RPG_CLIENT_COMMONEFFECTMATERIALBLOCKONE__CTOR_1_OFFSET UNITYSDK_OFFSET(0xB6F9B20)
#define RPG_CLIENT_COMMONEFFECTMATERIALBLOCKONE__CTOR_OFFSET UNITYSDK_OFFSET(0xB6F9A50)

namespace RPG::Client
{
	inline static constexpr unsigned int CommonEffectMaterialBlockOne_TypeDefinitionIndex = 65821;
	...
	public:
		...
		::System::Void Method_1_2DC38ACBCA72BA63(::System::Collections::Generic::IList_1<::UnityEngine::Material*>* a1, ::System::Int32 a2)
		{
			return ((::System::Void(*)(::PVOID, ::System::Collections::Generic::IList_1<::UnityEngine::Material*>*, ::System::Int32))((::PBYTE)hIl2Cpp + RPG_CLIENT_COMMONEFFECTMATERIALBLOCKONE_METHOD_1_2DC38ACBCA72BA63_OFFSET))(this, a1, a2);
		}
	};
}
