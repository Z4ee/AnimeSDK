...
#define RPG_CLIENT_COLLIDERBUTTON_POINTEREVENT__CTOR_OFFSET UNITYSDK_OFFSET(0xCC4D840)

namespace RPG::Client
{
	inline static constexpr unsigned int ColliderButton_PointerEvent_TypeDefinitionIndex = 72445;
