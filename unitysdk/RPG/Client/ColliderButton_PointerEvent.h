...
#define RPG_CLIENT_COLLIDERBUTTON_POINTEREVENT__CTOR_OFFSET UNITYSDK_OFFSET(0xA0B0FC0)

namespace RPG::Client
{
	inline static constexpr unsigned int ColliderButton_PointerEvent_TypeDefinitionIndex = 66820;
