...
#define RPG_CLIENT_MONOENTITYLOGICBASE_CHANGEOBJECTREFTOPATHREF_OFFSET UNITYSDK_OFFSET(0x9CF5BF0)
#define RPG_CLIENT_MONOENTITYLOGICBASE_DISCONNECTEDOBJECTREF_OFFSET UNITYSDK_OFFSET(0x9CF5C80)
#define RPG_CLIENT_MONOENTITYLOGICBASE_GETRELATIVEPATH_OFFSET UNITYSDK_OFFSET(0x9CF5CC0)
#define RPG_CLIENT_MONOENTITYLOGICBASE_REFRESHOBJECTREFBYPATHREF_OFFSET UNITYSDK_OFFSET(0x9CF5C40)
#define RPG_CLIENT_MONOENTITYLOGICBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x9CF5D20)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEntityLogicBase_TypeDefinitionIndex = 56007;
