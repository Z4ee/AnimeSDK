...
#define RPG_CLIENT_WALKSTYLETRANINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1C81FAB0)

namespace RPG::Client
{
	inline static constexpr unsigned int WalkStyleTranInfo_TypeDefinitionIndex = 68816;
