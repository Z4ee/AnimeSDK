...
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_CLEARSERVERSTATE_OFFSET UNITYSDK_OFFSET(0xE13E900)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xE13E890)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_CONDITIONDESC_OFFSET UNITYSDK_OFFSET(0xE13F0C0)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_CONDITIONID_OFFSET UNITYSDK_OFFSET(0xE13EA10)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_EFFECTDESC_OFFSET UNITYSDK_OFFSET(0xE13F1A0)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_EFFECTIDARR_OFFSET UNITYSDK_OFFSET(0xE13F4B0)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_EXAMID_OFFSET UNITYSDK_OFFSET(0xE13EBD0)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_ISENDING_OFFSET UNITYSDK_OFFSET(0xE13F460)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_ISFINISH_OFFSET UNITYSDK_OFFSET(0xE13EAB0)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_ISSTORY_OFFSET UNITYSDK_OFFSET(0xE13F400)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0xE13E990)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_MISSIONID_OFFSET UNITYSDK_OFFSET(0xE13ED10)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_PARTNERID_OFFSET UNITYSDK_OFFSET(0xE13F360)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_PERFORMANCEID_OFFSET UNITYSDK_OFFSET(0xE13EC70)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_REPEATPERFORMANCEID_OFFSET UNITYSDK_OFFSET(0xE13EDB0)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_STORYDESC_OFFSET UNITYSDK_OFFSET(0xE13EFE0)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_STORYHINT_OFFSET UNITYSDK_OFFSET(0xE13F280)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_STORYIMAGE_OFFSET UNITYSDK_OFFSET(0xE13EE50)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_STORYTITLE_OFFSET UNITYSDK_OFFSET(0xE13EF00)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET_STORYTYPE_OFFSET UNITYSDK_OFFSET(0xE13EAD0)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xE13EB70)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_SETSTORYFINISH_OFFSET UNITYSDK_OFFSET(0xE13E940)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA_SET_ISFINISH_OFFSET UNITYSDK_OFFSET(0xE13EAC0)
#define RPG_CLIENT_SWORDTRAININGSTORYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xE13E8F0)
