...
#define RPG_CLIENT_GRIDFIGHTMERGEEQUIPEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x195097B0)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightMergeEquipEvent_TypeDefinitionIndex = 62030;
