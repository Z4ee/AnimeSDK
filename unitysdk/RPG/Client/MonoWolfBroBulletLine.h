...
#define RPG_CLIENT_MONOWOLFBROBULLETLINE_GET_FORWARD_OFFSET UNITYSDK_OFFSET(0x9D4F370)
#define RPG_CLIENT_MONOWOLFBROBULLETLINE_SETDISTANCE_OFFSET UNITYSDK_OFFSET(0x9D4F3A0)
#define RPG_CLIENT_MONOWOLFBROBULLETLINE_SET_FORWARD_OFFSET UNITYSDK_OFFSET(0x9D4F390)
#define RPG_CLIENT_MONOWOLFBROBULLETLINE__CTOR_OFFSET UNITYSDK_OFFSET(0x9D4F570)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoWolfBroBulletLine_TypeDefinitionIndex = 56117;
