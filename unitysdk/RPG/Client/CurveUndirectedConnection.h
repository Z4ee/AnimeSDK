...
#define RPG_CLIENT_CURVEUNDIRECTEDCONNECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x943AEB0)

namespace RPG::Client
{
	inline static constexpr unsigned int CurveUndirectedConnection_TypeDefinitionIndex = 55984;
