...
#define RPG_CLIENT_MONOROGUEHEXCHESSBOARD_CLEARCELLGAMEOBJECTPOOL_OFFSET UNITYSDK_OFFSET(0x1AD09D70)
#define RPG_CLIENT_MONOROGUEHEXCHESSBOARD_GETMONOITEMLIST_OFFSET UNITYSDK_OFFSET(0x1AD0ACF0)
#define RPG_CLIENT_MONOROGUEHEXCHESSBOARD_INITCHESTBOARDITEM_OFFSET UNITYSDK_OFFSET(0x1AD09F80)
#define RPG_CLIENT_MONOROGUEHEXCHESSBOARD_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1AD09A80)
#define RPG_CLIENT_MONOROGUEHEXCHESSBOARD_PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0x1AD0AD30)
#define RPG_CLIENT_MONOROGUEHEXCHESSBOARD_REFRESHPOSITION_OFFSET UNITYSDK_OFFSET(0x1AD0AED0)
#define RPG_CLIENT_MONOROGUEHEXCHESSBOARD_UPDATE_OFFSET UNITYSDK_OFFSET(0x1AD09030)
#define RPG_CLIENT_MONOROGUEHEXCHESSBOARD__ADDSELECTABLEITEM_OFFSET UNITYSDK_OFFSET(0x1AD09E00)
#define RPG_CLIENT_MONOROGUEHEXCHESSBOARD__CHANGEGAMEOBJECTLAYER_OFFSET UNITYSDK_OFFSET(0x1AD0AAC0)
#define RPG_CLIENT_MONOROGUEHEXCHESSBOARD__CLEARSELECTABLEITEM_OFFSET UNITYSDK_OFFSET(0x1AD09CE0)
#define RPG_CLIENT_MONOROGUEHEXCHESSBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD0B510)
#define RPG_CLIENT_MONOROGUEHEXCHESSBOARD__ENDGETCELLGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1AD0ABD0)
#define RPG_CLIENT_MONOROGUEHEXCHESSBOARD__GETCELLGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1AD0A950)
#define RPG_CLIENT_MONOROGUEHEXCHESSBOARD__GETCELLPOSTION_1_OFFSET UNITYSDK_OFFSET(0x1AD0B000)
#define RPG_CLIENT_MONOROGUEHEXCHESSBOARD__GETCELLPOSTION_OFFSET UNITYSDK_OFFSET(0x1AD0A9F0)
#define RPG_CLIENT_MONOROGUEHEXCHESSBOARD__GETPREFABINDEX_OFFSET UNITYSDK_OFFSET(0x1AD0A8B0)
#define RPG_CLIENT_MONOROGUEHEXCHESSBOARD__ONCLICKEMPTY_OFFSET UNITYSDK_OFFSET(0x1AD09A30)
#define RPG_CLIENT_MONOROGUEHEXCHESSBOARD__STARTGETCELLGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1AD0A5A0)
#define RPG_CLIENT_MONOROGUEHEXCHESSBOARD__TICKFADEIN_OFFSET UNITYSDK_OFFSET(0x1AD09880)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoRogueHexChessBoard_TypeDefinitionIndex = 68885;
