...
#define RPG_CLIENT_TAROTBOOKMAINCATALOGELEMENT_INITVIEW_OFFSET UNITYSDK_OFFSET(0xC9DBBE0)
#define RPG_CLIENT_TAROTBOOKMAINCATALOGELEMENT_METHOD_7_94C39761778BCE52_OFFSET UNITYSDK_OFFSET(0xC9DBC90)
#define RPG_CLIENT_TAROTBOOKMAINCATALOGELEMENT__BEFOREDESTROY_OFFSET UNITYSDK_OFFSET(0xC9DC7C0)
#define RPG_CLIENT_TAROTBOOKMAINCATALOGELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0xC9DC940)
#define RPG_CLIENT_TAROTBOOKMAINCATALOGELEMENT___IFIXBASEPROXY_INITVIEW_OFFSET UNITYSDK_OFFSET(0xC9DC990)
#define RPG_CLIENT_TAROTBOOKMAINCATALOGELEMENT___IFIXBASEPROXY__BEFOREDESTROY_OFFSET UNITYSDK_OFFSET(0xC9DCA40)

namespace RPG::Client
{
	inline static constexpr unsigned int TarotBookMainCatalogElement_TypeDefinitionIndex = 67704;
