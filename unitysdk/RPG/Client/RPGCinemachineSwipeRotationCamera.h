...
#define RPG_CLIENT_RPGCINEMACHINESWIPEROTATIONCAMERA_INITSWIPECAMERA_OFFSET UNITYSDK_OFFSET(0xDDCB1D0)
#define RPG_CLIENT_RPGCINEMACHINESWIPEROTATIONCAMERA_POSTPIPELINESTAGECALLBACK_OFFSET UNITYSDK_OFFSET(0xDDCB360)
#define RPG_CLIENT_RPGCINEMACHINESWIPEROTATIONCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0xDDCB4E0)
