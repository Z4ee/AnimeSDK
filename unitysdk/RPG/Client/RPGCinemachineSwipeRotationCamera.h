...
#define RPG_CLIENT_RPGCINEMACHINESWIPEROTATIONCAMERA_INITSWIPECAMERA_OFFSET UNITYSDK_OFFSET(0x18033960)
#define RPG_CLIENT_RPGCINEMACHINESWIPEROTATIONCAMERA_POSTPIPELINESTAGECALLBACK_OFFSET UNITYSDK_OFFSET(0x18033AE0)
#define RPG_CLIENT_RPGCINEMACHINESWIPEROTATIONCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x18033C60)

namespace RPG::Client
{
	inline static constexpr unsigned int RPGCinemachineSwipeRotationCamera_TypeDefinitionIndex = 69670;

	class RPGCinemachineSwipeRotationCamera : public ::Cinemachine::CinemachineExtension
	{
	public:
		::Class_1_20FCC2F82753283C_1* ILOHDLNCKEL; // 0x28
