...
#define RPG_CLIENT_RPGCINEMACHINESWIPEROTATIONCAMERA_INITSWIPECAMERA_OFFSET UNITYSDK_OFFSET(0x16791360)
#define RPG_CLIENT_RPGCINEMACHINESWIPEROTATIONCAMERA_POSTPIPELINESTAGECALLBACK_OFFSET UNITYSDK_OFFSET(0x167914F0)
#define RPG_CLIENT_RPGCINEMACHINESWIPEROTATIONCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x16791670)

namespace RPG::Client
{
	inline static constexpr unsigned int RPGCinemachineSwipeRotationCamera_TypeDefinitionIndex = 66575;
