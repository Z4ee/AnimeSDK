...
#define RPG_CLIENT_RPGPROFILERMARKERWITHSTRINGDATA_BEGIN_OFFSET UNITYSDK_OFFSET(0x1D2A0550)
#define RPG_CLIENT_RPGPROFILERMARKERWITHSTRINGDATA_END_OFFSET UNITYSDK_OFFSET(0x1D2A05D0)
#define RPG_CLIENT_RPGPROFILERMARKERWITHSTRINGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2A0480)

namespace RPG::Client
{
	inline static constexpr unsigned int RPGProfilerMarkerWithStringData_TypeDefinitionIndex = 33735;
