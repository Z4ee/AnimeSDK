...
#define RPG_CLIENT_RPGPROFILERMARKERWITHSTRINGDATA_BEGIN_OFFSET UNITYSDK_OFFSET(0x1E528220)
#define RPG_CLIENT_RPGPROFILERMARKERWITHSTRINGDATA_END_OFFSET UNITYSDK_OFFSET(0x1E5282A0)
#define RPG_CLIENT_RPGPROFILERMARKERWITHSTRINGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1E528150)
