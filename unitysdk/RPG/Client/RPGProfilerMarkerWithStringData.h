...
#define RPG_CLIENT_RPGPROFILERMARKERWITHSTRINGDATA_BEGIN_OFFSET UNITYSDK_OFFSET(0x182DD630)
#define RPG_CLIENT_RPGPROFILERMARKERWITHSTRINGDATA_END_OFFSET UNITYSDK_OFFSET(0x182DD6B0)
#define RPG_CLIENT_RPGPROFILERMARKERWITHSTRINGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x182DD560)

namespace RPG::Client
{
	inline static constexpr unsigned int RPGProfilerMarkerWithStringData_TypeDefinitionIndex = 27632;
