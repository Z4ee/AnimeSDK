...
#define RPG_CLIENT_RELICGROWTHGUIDEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6663A0)

namespace RPG::Client
{
	inline static constexpr unsigned int RelicGrowthGuideItem_TypeDefinitionIndex = 65618;
