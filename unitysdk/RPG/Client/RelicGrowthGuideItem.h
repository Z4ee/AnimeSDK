...
#define RPG_CLIENT_RELICGROWTHGUIDEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xAF929C0)

namespace RPG::Client
{
	inline static constexpr unsigned int RelicGrowthGuideItem_TypeDefinitionIndex = 60356;
