...
#define RPG_CLIENT_MATCHTHREESKILLDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xBF93BE0)
#define RPG_CLIENT_MATCHTHREESKILLDATA_GET_CHARGECOUNT_OFFSET UNITYSDK_OFFSET(0xBF94090)
#define RPG_CLIENT_MATCHTHREESKILLDATA_GET_CHARGEDICONPATH_OFFSET UNITYSDK_OFFSET(0xBF93DF0)
#define RPG_CLIENT_MATCHTHREESKILLDATA_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0xBF94150)
#define RPG_CLIENT_MATCHTHREESKILLDATA_GET_DESC_OFFSET UNITYSDK_OFFSET(0xBF94010)
#define RPG_CLIENT_MATCHTHREESKILLDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0xBF93DD0)
#define RPG_CLIENT_MATCHTHREESKILLDATA_GET_ISMULTISTYLEBOMB_OFFSET UNITYSDK_OFFSET(0xBF940F0)
#define RPG_CLIENT_MATCHTHREESKILLDATA_GET_ROW_OFFSET UNITYSDK_OFFSET(0xBF93D70)
#define RPG_CLIENT_MATCHTHREESKILLDATA_GET_UNCHARGEDICONPATH_OFFSET UNITYSDK_OFFSET(0xBF93F00)
#define RPG_CLIENT_MATCHTHREESKILLDATA_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0xBF94160)
#define RPG_CLIENT_MATCHTHREESKILLDATA_SET_ID_OFFSET UNITYSDK_OFFSET(0xBF93DE0)
#define RPG_CLIENT_MATCHTHREESKILLDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBF93C50)
#define RPG_CLIENT_MATCHTHREESKILLDATA__INIT_OFFSET UNITYSDK_OFFSET(0xBF93C60)

namespace RPG::Client
{
	inline static constexpr unsigned int MatchThreeSkillData_TypeDefinitionIndex = 61677;
