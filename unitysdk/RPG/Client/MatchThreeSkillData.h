...
#define RPG_CLIENT_MATCHTHREESKILLDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1AB79C20)
#define RPG_CLIENT_MATCHTHREESKILLDATA_GET_CHARGECOUNT_OFFSET UNITYSDK_OFFSET(0x1AB7A110)
#define RPG_CLIENT_MATCHTHREESKILLDATA_GET_CHARGEDICONPATH_OFFSET UNITYSDK_OFFSET(0x1AB79E30)
#define RPG_CLIENT_MATCHTHREESKILLDATA_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0x1AB7A1D0)
#define RPG_CLIENT_MATCHTHREESKILLDATA_GET_DESC_OFFSET UNITYSDK_OFFSET(0x1AB7A050)
#define RPG_CLIENT_MATCHTHREESKILLDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0x1AB79E10)
#define RPG_CLIENT_MATCHTHREESKILLDATA_GET_ISMULTISTYLEBOMB_OFFSET UNITYSDK_OFFSET(0x1AB7A170)
#define RPG_CLIENT_MATCHTHREESKILLDATA_GET_ROW_OFFSET UNITYSDK_OFFSET(0x1AB79DB0)
#define RPG_CLIENT_MATCHTHREESKILLDATA_GET_UNCHARGEDICONPATH_OFFSET UNITYSDK_OFFSET(0x1AB79F40)
#define RPG_CLIENT_MATCHTHREESKILLDATA_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0x1AB7A1E0)
#define RPG_CLIENT_MATCHTHREESKILLDATA_SET_ID_OFFSET UNITYSDK_OFFSET(0x1AB79E20)
#define RPG_CLIENT_MATCHTHREESKILLDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB79C90)
#define RPG_CLIENT_MATCHTHREESKILLDATA__INIT_OFFSET UNITYSDK_OFFSET(0x1AB79CA0)
