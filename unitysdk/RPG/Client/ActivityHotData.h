...
#define RPG_CLIENT_ACTIVITYHOTDATA_GETHCOINCOUNT_OFFSET UNITYSDK_OFFSET(0x1B8F8F40)
#define RPG_CLIENT_ACTIVITYHOTDATA_GET_ACTIVITYDATA_OFFSET UNITYSDK_OFFSET(0x1B8F8290)
#define RPG_CLIENT_ACTIVITYHOTDATA_GET_ACTIVITYID_OFFSET UNITYSDK_OFFSET(0x1B8F7C70)
#define RPG_CLIENT_ACTIVITYHOTDATA_GET_ACTIVITYNAME_OFFSET UNITYSDK_OFFSET(0x1B8F81B0)
#define RPG_CLIENT_ACTIVITYHOTDATA_GET_ACTIVITYPANELIDOVERWRITE_OFFSET UNITYSDK_OFFSET(0x1B8F8370)
#define RPG_CLIENT_ACTIVITYHOTDATA_GET_BEGINTIMESTAMP_OFFSET UNITYSDK_OFFSET(0x1B8F8960)
#define RPG_CLIENT_ACTIVITYHOTDATA_GET_ENDED_OFFSET UNITYSDK_OFFSET(0x1B8F88A0)
#define RPG_CLIENT_ACTIVITYHOTDATA_GET_ENDTIMESTAMP_OFFSET UNITYSDK_OFFSET(0x1B8F8D20)
#define RPG_CLIENT_ACTIVITYHOTDATA_GET_FINISHCONDITIONS_OFFSET UNITYSDK_OFFSET(0x1B8F7AF0)
#define RPG_CLIENT_ACTIVITYHOTDATA_GET_FIRSTITEMDES_OFFSET UNITYSDK_OFFSET(0x1B8F7D30)
#define RPG_CLIENT_ACTIVITYHOTDATA_GET_GOTOID_OFFSET UNITYSDK_OFFSET(0x1B8F8540)
#define RPG_CLIENT_ACTIVITYHOTDATA_GET_HAVESCHEDULE_OFFSET UNITYSDK_OFFSET(0x1B8F8900)
#define RPG_CLIENT_ACTIVITYHOTDATA_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x1B8F7DA0)
#define RPG_CLIENT_ACTIVITYHOTDATA_GET_INTROID_OFFSET UNITYSDK_OFFSET(0x1B8F8E50)
#define RPG_CLIENT_ACTIVITYHOTDATA_GET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0x1B8F8620)
#define RPG_CLIENT_ACTIVITYHOTDATA_GET_ISINSCHEDULE_OFFSET UNITYSDK_OFFSET(0x1B8F8590)
#define RPG_CLIENT_ACTIVITYHOTDATA_GET_ITEMS_OFFSET UNITYSDK_OFFSET(0x1B8F7B40)
#define RPG_CLIENT_ACTIVITYHOTDATA_GET_NOTBEGIN_OFFSET UNITYSDK_OFFSET(0x1B8F8840)
#define RPG_CLIENT_ACTIVITYHOTDATA_GET_OVERRIDEREMAINTIMEDESC_OFFSET UNITYSDK_OFFSET(0x1B8F7C00)
#define RPG_CLIENT_ACTIVITYHOTDATA_GET_PANELDATAFORGOTO_OFFSET UNITYSDK_OFFSET(0x1B8F83C0)
#define RPG_CLIENT_ACTIVITYHOTDATA_GET_REWARDDES_OFFSET UNITYSDK_OFFSET(0x1B8F7CC0)
#define RPG_CLIENT_ACTIVITYHOTDATA_GET_SHOWREWARDITEMID_OFFSET UNITYSDK_OFFSET(0x1B8F7B80)
#define RPG_CLIENT_ACTIVITYHOTDATA_GET_SORTWEIGHT_OFFSET UNITYSDK_OFFSET(0x1B8F8160)
#define RPG_CLIENT_ACTIVITYHOTDATA_GET__CANDIDATE_OFFSET UNITYSDK_OFFSET(0x1B8F8A90)
#define RPG_CLIENT_ACTIVITYHOTDATA_GET__PANELROW_OFFSET UNITYSDK_OFFSET(0x1B8F80F0)
#define RPG_CLIENT_ACTIVITYHOTDATA_ISFINISHCONDITIONSCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1B8F79D0)
#define RPG_CLIENT_ACTIVITYHOTDATA_SYNCITEMPROGRESS_OFFSET UNITYSDK_OFFSET(0x1B8F7410)
#define RPG_CLIENT_ACTIVITYHOTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8F73A0)
