...
#define RPG_CLIENT_TRANSFORMPATROLANIM_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xCACCB60)
#define RPG_CLIENT_TRANSFORMPATROLANIM_GET_ARTBOUNDFULL_OFFSET UNITYSDK_OFFSET(0xCACC2E0)
#define RPG_CLIENT_TRANSFORMPATROLANIM_GET_ARTBOUND_OFFSET UNITYSDK_OFFSET(0xCACC9C0)
#define RPG_CLIENT_TRANSFORMPATROLANIM__CTOR_OFFSET UNITYSDK_OFFSET(0xCACCBB0)
#define RPG_CLIENT_TRANSFORMPATROLANIM___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xCACCF90)
