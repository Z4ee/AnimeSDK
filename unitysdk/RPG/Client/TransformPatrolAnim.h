...
#define RPG_CLIENT_TRANSFORMPATROLANIM_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xA619CF0)
#define RPG_CLIENT_TRANSFORMPATROLANIM_GET_ARTBOUNDFULL_OFFSET UNITYSDK_OFFSET(0xA6194B0)
#define RPG_CLIENT_TRANSFORMPATROLANIM_GET_ARTBOUND_OFFSET UNITYSDK_OFFSET(0xA619B50)
#define RPG_CLIENT_TRANSFORMPATROLANIM__CTOR_OFFSET UNITYSDK_OFFSET(0xA619D40)
#define RPG_CLIENT_TRANSFORMPATROLANIM___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xA61A080)

namespace RPG::Client
{
	inline static constexpr unsigned int TransformPatrolAnim_TypeDefinitionIndex = 57576;
