...
#define RPG_CLIENT_TRANSFORMPATROLANIM_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x1989D680)
#define RPG_CLIENT_TRANSFORMPATROLANIM_GET_ARTBOUNDFULL_OFFSET UNITYSDK_OFFSET(0x1989CE00)
#define RPG_CLIENT_TRANSFORMPATROLANIM_GET_ARTBOUND_OFFSET UNITYSDK_OFFSET(0x1989D4E0)
#define RPG_CLIENT_TRANSFORMPATROLANIM__CTOR_OFFSET UNITYSDK_OFFSET(0x1989D6D0)
