...
#define RPG_CLIENT_CURVEEDGEPOINTSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x7CA80)

namespace RPG::Client
{
	inline static constexpr unsigned int CurveEdgePointSetting_TypeDefinitionIndex = 55985;
