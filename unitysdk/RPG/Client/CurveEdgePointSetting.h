...
#define RPG_CLIENT_CURVEEDGEPOINTSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0xD5DC0)

namespace RPG::Client
{
	inline static constexpr unsigned int CurveEdgePointSetting_TypeDefinitionIndex = 63228;
