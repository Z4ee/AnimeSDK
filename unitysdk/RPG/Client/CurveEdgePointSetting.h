...
#define RPG_CLIENT_CURVEEDGEPOINTSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x3B1A5F0)

namespace RPG::Client
{
	inline static constexpr unsigned int CurveEdgePointSetting_TypeDefinitionIndex = 68531;
