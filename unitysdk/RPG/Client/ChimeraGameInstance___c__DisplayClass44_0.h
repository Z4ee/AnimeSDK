...
#define RPG_CLIENT_CHIMERAGAMEINSTANCE___C__DISPLAYCLASS44_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5FBF70)
#define RPG_CLIENT_CHIMERAGAMEINSTANCE___C__DISPLAYCLASS44_0__TRYSWITCHAREA_B__0_OFFSET UNITYSDK_OFFSET(0x1B5FCA40)
...
namespace RPG::Client
{
	...
	public:
		...
		::RPG::Client::Prop::ChimeraBattlePuzzleBoard* view; // 0x18
