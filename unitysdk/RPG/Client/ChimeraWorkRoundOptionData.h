...
#define RPG_CLIENT_CHIMERAWORKROUNDOPTIONDATA_GET_OPTIONID_OFFSET UNITYSDK_OFFSET(0xA08AC30)
#define RPG_CLIENT_CHIMERAWORKROUNDOPTIONDATA_GET_PARAMLIST_OFFSET UNITYSDK_OFFSET(0xA08AD10)
#define RPG_CLIENT_CHIMERAWORKROUNDOPTIONDATA_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xA08ACA0)
#define RPG_CLIENT_CHIMERAWORKROUNDOPTIONDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xA08AC40)
#define RPG_CLIENT_CHIMERAWORKROUNDOPTIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA08AD80)

namespace RPG::Client
{
	inline static constexpr unsigned int ChimeraWorkRoundOptionData_TypeDefinitionIndex = 58522;
