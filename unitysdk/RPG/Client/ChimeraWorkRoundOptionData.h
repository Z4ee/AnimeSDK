...
#define RPG_CLIENT_CHIMERAWORKROUNDOPTIONDATA_GET_OPTIONID_OFFSET UNITYSDK_OFFSET(0xB6C9390)
#define RPG_CLIENT_CHIMERAWORKROUNDOPTIONDATA_GET_PARAMLIST_OFFSET UNITYSDK_OFFSET(0xB6C9470)
#define RPG_CLIENT_CHIMERAWORKROUNDOPTIONDATA_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xB6C9400)
#define RPG_CLIENT_CHIMERAWORKROUNDOPTIONDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xB6C93A0)
#define RPG_CLIENT_CHIMERAWORKROUNDOPTIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB6C94E0)

namespace RPG::Client
{
	inline static constexpr unsigned int ChimeraWorkRoundOptionData_TypeDefinitionIndex = 59452;
