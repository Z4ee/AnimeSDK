...
#define RPG_CLIENT_STAGE__ONSTREAMINGLOADFINISH_D__51_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x196F2110)
#define RPG_CLIENT_STAGE__ONSTREAMINGLOADFINISH_D__51_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_RPG_WORK_IASYNCWORKSTEPRESULT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x196F2190)
#define RPG_CLIENT_STAGE__ONSTREAMINGLOADFINISH_D__51_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x196F21F0)
#define RPG_CLIENT_STAGE__ONSTREAMINGLOADFINISH_D__51_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x196F21A0)
#define RPG_CLIENT_STAGE__ONSTREAMINGLOADFINISH_D__51_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x196F2100)
#define RPG_CLIENT_STAGE__ONSTREAMINGLOADFINISH_D__51__CTOR_OFFSET UNITYSDK_OFFSET(0x196EE840)
