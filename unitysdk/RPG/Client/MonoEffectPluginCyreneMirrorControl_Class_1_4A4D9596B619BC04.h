...
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL_CLASS_1_4A4D9596B619BC04_GET_TRACKER_OFFSET UNITYSDK_OFFSET(0xC0D62B0)
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL_CLASS_1_4A4D9596B619BC04_METHOD_1_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0xC0D4980)
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL_CLASS_1_4A4D9596B619BC04_SET_TRACKER_OFFSET UNITYSDK_OFFSET(0xC0D62C0)
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL_CLASS_1_4A4D9596B619BC04__CTOR_OFFSET UNITYSDK_OFFSET(0xC0D5650)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginCyreneMirrorControl_Class_1_4A4D9596B619BC04_TypeDefinitionIndex = 65439;
