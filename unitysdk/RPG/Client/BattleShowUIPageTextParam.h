...
#define RPG_CLIENT_BATTLESHOWUIPAGETEXTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x9E7D580)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleShowUIPageTextParam_TypeDefinitionIndex = 66213;
