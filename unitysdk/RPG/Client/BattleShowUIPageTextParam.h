...
#define RPG_CLIENT_BATTLESHOWUIPAGETEXTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD6BE90)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleShowUIPageTextParam_TypeDefinitionIndex = 71794;
