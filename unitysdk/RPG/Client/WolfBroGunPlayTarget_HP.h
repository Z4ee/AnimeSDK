...
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP_INIT_OFFSET UNITYSDK_OFFSET(0xB4DA7C0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP_ISBOOMABLE_OFFSET UNITYSDK_OFFSET(0xB4DA9F0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP_ISHITTABLE_OFFSET UNITYSDK_OFFSET(0xB4DA940)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP_METHOD_6_AD23FDCC7576BB32_OFFSET UNITYSDK_OFFSET(0xB4DA860)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP_METHOD_6_BEC0C6D1D2906F45_OFFSET UNITYSDK_OFFSET(0xB4DAF40)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP_ONHIT_OFFSET UNITYSDK_OFFSET(0xB4DAA80)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP_ONLOSSHP_OFFSET UNITYSDK_OFFSET(0xB4DADC0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP__CTOR_OFFSET UNITYSDK_OFFSET(0xB4DAE00)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0xB4DAF30)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP___IFIXBASEPROXY_ISBOOMABLE_OFFSET UNITYSDK_OFFSET(0xB4DAFC0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP___IFIXBASEPROXY_ISHITTABLE_OFFSET UNITYSDK_OFFSET(0xB4DAF50)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP___IFIXBASEPROXY_ONHIT_OFFSET UNITYSDK_OFFSET(0xB4DB030)

namespace RPG::Client
{
	inline static constexpr unsigned int WolfBroGunPlayTarget_HP_TypeDefinitionIndex = 63370;
