...
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP_INIT_OFFSET UNITYSDK_OFFSET(0xCC40B30)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP_ISBOOMABLE_OFFSET UNITYSDK_OFFSET(0xCC40D80)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP_ISHITTABLE_OFFSET UNITYSDK_OFFSET(0xCC40CD0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP_METHOD_6_AD23FDCC7576BB32_OFFSET UNITYSDK_OFFSET(0xCC40BF0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP_METHOD_6_CEE772DE95055C01_OFFSET UNITYSDK_OFFSET(0xCC41310)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP_ONHIT_OFFSET UNITYSDK_OFFSET(0xCC40E10)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP_ONLOSSHP_OFFSET UNITYSDK_OFFSET(0xCC41190)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP__CTOR_OFFSET UNITYSDK_OFFSET(0xCC411D0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0xCC41300)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP___IFIXBASEPROXY_ISBOOMABLE_OFFSET UNITYSDK_OFFSET(0xCC41390)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP___IFIXBASEPROXY_ISHITTABLE_OFFSET UNITYSDK_OFFSET(0xCC41320)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP___IFIXBASEPROXY_ONHIT_OFFSET UNITYSDK_OFFSET(0xCC41400)

namespace RPG::Client
{
	inline static constexpr unsigned int WolfBroGunPlayTarget_HP_TypeDefinitionIndex = 64287;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_2BF31F3092BDFD9E*, ::RPG::Client::WolfBroGunPlayTarget_Group*))((::PBYTE)hIl2Cpp + RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP___IFIXBASEPROXY_INIT_OFFSET))(this, a1, a2);
		}

		::System::Void Method_6_CEE772DE95055C01(::System::Single a1)
		{
			return ((::System::Void(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP_METHOD_6_CEE772DE95055C01_OFFSET))(this, a1);
		}
		...
		{
			return ((::System::Boolean(*)(::PVOID, ::UnityEngine::Vector3, ::System::Nullable_1<::UnityEngine::Vector3>))((::PBYTE)hIl2Cpp + RPG_CLIENT_WOLFBROGUNPLAYTARGET_HP___IFIXBASEPROXY_ONHIT_OFFSET))(this, a1, a2);
		}
	};
}
