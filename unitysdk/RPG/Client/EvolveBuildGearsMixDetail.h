...
#define RPG_CLIENT_EVOLVEBUILDGEARSMIXDETAIL_CREATE_OFFSET UNITYSDK_OFFSET(0x19947F80)
#define RPG_CLIENT_EVOLVEBUILDGEARSMIXDETAIL_GET_SEASON_OFFSET UNITYSDK_OFFSET(0x19948A10)
#define RPG_CLIENT_EVOLVEBUILDGEARSMIXDETAIL_GET__MODULE_OFFSET UNITYSDK_OFFSET(0x19948A30)
#define RPG_CLIENT_EVOLVEBUILDGEARSMIXDETAIL_SET_SEASON_OFFSET UNITYSDK_OFFSET(0x19948A20)
#define RPG_CLIENT_EVOLVEBUILDGEARSMIXDETAIL__CREATELEVELDATA_OFFSET UNITYSDK_OFFSET(0x19948720)
#define RPG_CLIENT_EVOLVEBUILDGEARSMIXDETAIL__CTOR_OFFSET UNITYSDK_OFFSET(0x199480D0)
#define RPG_CLIENT_EVOLVEBUILDGEARSMIXDETAIL__REFRESHFORGEDETAILS_OFFSET UNITYSDK_OFFSET(0x19948190)
#define RPG_CLIENT_EVOLVEBUILDGEARSMIXDETAIL__REFRESHMIXDETAILS_OFFSET UNITYSDK_OFFSET(0x19948330)
#define RPG_CLIENT_EVOLVEBUILDGEARSMIXDETAIL__REFRESHWEAPONDETAILS_OFFSET UNITYSDK_OFFSET(0x199487E0)

namespace RPG::Client
{
	inline static constexpr unsigned int EvolveBuildGearsMixDetail_TypeDefinitionIndex = 63841;
