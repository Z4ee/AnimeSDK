...
#define RPG_CLIENT_MONOPOLYRANDOMOPTIONCONTENTDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xAABD2E0)
#define RPG_CLIENT_MONOPOLYRANDOMOPTIONCONTENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xAABD380)

namespace RPG::Client
{
	inline static constexpr unsigned int MonopolyRandomOptionContentData_TypeDefinitionIndex = 61044;
	...
	public:
		...
		::System::UInt32 SelectOptionID; // 0x18
