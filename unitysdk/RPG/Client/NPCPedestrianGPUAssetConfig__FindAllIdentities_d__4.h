...
#define RPG_CLIENT_NPCPEDESTRIANGPUASSETCONFIG__FINDALLIDENTITIES_D__4_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A322130)
#define RPG_CLIENT_NPCPEDESTRIANGPUASSETCONFIG__FINDALLIDENTITIES_D__4_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_STRING__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A322240)
#define RPG_CLIENT_NPCPEDESTRIANGPUASSETCONFIG__FINDALLIDENTITIES_D__4_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_STRING__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A3221D0)
#define RPG_CLIENT_NPCPEDESTRIANGPUASSETCONFIG__FINDALLIDENTITIES_D__4_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A3222C0)
#define RPG_CLIENT_NPCPEDESTRIANGPUASSETCONFIG__FINDALLIDENTITIES_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A322230)
#define RPG_CLIENT_NPCPEDESTRIANGPUASSETCONFIG__FINDALLIDENTITIES_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A3221E0)
#define RPG_CLIENT_NPCPEDESTRIANGPUASSETCONFIG__FINDALLIDENTITIES_D__4_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A322120)
#define RPG_CLIENT_NPCPEDESTRIANGPUASSETCONFIG__FINDALLIDENTITIES_D__4__CTOR_OFFSET UNITYSDK_OFFSET(0x1A321E20)

namespace RPG::Client
{
	inline static constexpr unsigned int NPCPedestrianGPUAssetConfig__FindAllIdentities_d__4_TypeDefinitionIndex = 69205;
	...
	public:
		...
		::RPG::Client::NPCPedestrianGPUAssetConfig* __4__this; // 0x20
