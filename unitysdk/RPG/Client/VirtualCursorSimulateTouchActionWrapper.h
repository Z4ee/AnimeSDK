...
#define RPG_CLIENT_VIRTUALCURSORSIMULATETOUCHACTIONWRAPPER_EXECUTEPOINTERCLICK_OFFSET UNITYSDK_OFFSET(0x1740FA40)
#define RPG_CLIENT_VIRTUALCURSORSIMULATETOUCHACTIONWRAPPER_EXECUTEPOINTERPRESS_OFFSET UNITYSDK_OFFSET(0x1740F7F0)
#define RPG_CLIENT_VIRTUALCURSORSIMULATETOUCHACTIONWRAPPER_EXECUTEPOINTERUP_OFFSET UNITYSDK_OFFSET(0x1740F960)
#define RPG_CLIENT_VIRTUALCURSORSIMULATETOUCHACTIONWRAPPER_EXECUTESUBMIT_OFFSET UNITYSDK_OFFSET(0x1740FAE0)
#define RPG_CLIENT_VIRTUALCURSORSIMULATETOUCHACTIONWRAPPER_RPG_CLIENT_IVIRTUALCURSORSIMULATETOUCHACTION_ONPOINTERPRESS_OFFSET UNITYSDK_OFFSET(0x1740FC10)
#define RPG_CLIENT_VIRTUALCURSORSIMULATETOUCHACTIONWRAPPER_RPG_CLIENT_IVIRTUALCURSORSIMULATETOUCHACTION_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0x1740FC90)
#define RPG_CLIENT_VIRTUALCURSORSIMULATETOUCHACTIONWRAPPER_SETONPOINTERPRESS_OFFSET UNITYSDK_OFFSET(0x1740F750)
#define RPG_CLIENT_VIRTUALCURSORSIMULATETOUCHACTIONWRAPPER_SETONPOINTERUP_OFFSET UNITYSDK_OFFSET(0x1740F7A0)
#define RPG_CLIENT_VIRTUALCURSORSIMULATETOUCHACTIONWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1740FD10)

namespace RPG::Client
{
	inline static constexpr unsigned int VirtualCursorSimulateTouchActionWrapper_TypeDefinitionIndex = 69877;
