...
#define RPG_CLIENT_VIRTUALCURSORSIMULATETOUCHACTIONWRAPPER_EXECUTEPOINTERCLICK_OFFSET UNITYSDK_OFFSET(0x1C816C30)
#define RPG_CLIENT_VIRTUALCURSORSIMULATETOUCHACTIONWRAPPER_EXECUTEPOINTERPRESS_OFFSET UNITYSDK_OFFSET(0x1C8169E0)
#define RPG_CLIENT_VIRTUALCURSORSIMULATETOUCHACTIONWRAPPER_EXECUTEPOINTERUP_OFFSET UNITYSDK_OFFSET(0x1C816B50)
#define RPG_CLIENT_VIRTUALCURSORSIMULATETOUCHACTIONWRAPPER_EXECUTESUBMIT_OFFSET UNITYSDK_OFFSET(0x1C816CD0)
#define RPG_CLIENT_VIRTUALCURSORSIMULATETOUCHACTIONWRAPPER_RPG_CLIENT_IVIRTUALCURSORSIMULATETOUCHACTION_ONPOINTERPRESS_OFFSET UNITYSDK_OFFSET(0x1C816E00)
#define RPG_CLIENT_VIRTUALCURSORSIMULATETOUCHACTIONWRAPPER_RPG_CLIENT_IVIRTUALCURSORSIMULATETOUCHACTION_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0x1C816E80)
#define RPG_CLIENT_VIRTUALCURSORSIMULATETOUCHACTIONWRAPPER_SETONPOINTERPRESS_OFFSET UNITYSDK_OFFSET(0x1C816940)
#define RPG_CLIENT_VIRTUALCURSORSIMULATETOUCHACTIONWRAPPER_SETONPOINTERUP_OFFSET UNITYSDK_OFFSET(0x1C816990)
#define RPG_CLIENT_VIRTUALCURSORSIMULATETOUCHACTIONWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C816F00)

namespace RPG::Client
{
	inline static constexpr unsigned int VirtualCursorSimulateTouchActionWrapper_TypeDefinitionIndex = 73134;
