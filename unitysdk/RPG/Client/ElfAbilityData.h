...
#define RPG_CLIENT_ELFABILITYDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xCE342D0)
#define RPG_CLIENT_ELFABILITYDATA_GET_DETAIL_OFFSET UNITYSDK_OFFSET(0xCE34480)
#define RPG_CLIENT_ELFABILITYDATA_GET_DYNAMICVALUES_OFFSET UNITYSDK_OFFSET(0xCE34600)
#define RPG_CLIENT_ELFABILITYDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0xCE34360)
#define RPG_CLIENT_ELFABILITYDATA_GET_ISORDINARYABILITY_OFFSET UNITYSDK_OFFSET(0xCE346A0)
#define RPG_CLIENT_ELFABILITYDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xCE34540)
#define RPG_CLIENT_ELFABILITYDATA_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xCE34380)
#define RPG_CLIENT_ELFABILITYDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xCE34420)
#define RPG_CLIENT_ELFABILITYDATA_SET_ID_OFFSET UNITYSDK_OFFSET(0xCE34370)
#define RPG_CLIENT_ELFABILITYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCE34350)
