...
#define RPG_CLIENT_ELFABILITYDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x959A320)
#define RPG_CLIENT_ELFABILITYDATA_GET_DETAIL_OFFSET UNITYSDK_OFFSET(0x959A4A0)
#define RPG_CLIENT_ELFABILITYDATA_GET_DYNAMICVALUES_OFFSET UNITYSDK_OFFSET(0x959A5A0)
#define RPG_CLIENT_ELFABILITYDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0x959A3B0)
#define RPG_CLIENT_ELFABILITYDATA_GET_ISORDINARYABILITY_OFFSET UNITYSDK_OFFSET(0x959A610)
#define RPG_CLIENT_ELFABILITYDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0x959A520)
#define RPG_CLIENT_ELFABILITYDATA_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x959A3D0)
#define RPG_CLIENT_ELFABILITYDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0x959A440)
#define RPG_CLIENT_ELFABILITYDATA_SET_ID_OFFSET UNITYSDK_OFFSET(0x959A3C0)
#define RPG_CLIENT_ELFABILITYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x959A3A0)

namespace RPG::Client
{
	inline static constexpr unsigned int ElfAbilityData_TypeDefinitionIndex = 51708;
