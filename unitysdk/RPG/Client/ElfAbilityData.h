...
#define RPG_CLIENT_ELFABILITYDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xB8A4250)
#define RPG_CLIENT_ELFABILITYDATA_GET_DETAIL_OFFSET UNITYSDK_OFFSET(0xB8A43D0)
#define RPG_CLIENT_ELFABILITYDATA_GET_DYNAMICVALUES_OFFSET UNITYSDK_OFFSET(0xB8A44D0)
#define RPG_CLIENT_ELFABILITYDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0xB8A42E0)
#define RPG_CLIENT_ELFABILITYDATA_GET_ISORDINARYABILITY_OFFSET UNITYSDK_OFFSET(0xB8A4540)
#define RPG_CLIENT_ELFABILITYDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xB8A4450)
#define RPG_CLIENT_ELFABILITYDATA_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xB8A4300)
#define RPG_CLIENT_ELFABILITYDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xB8A4370)
#define RPG_CLIENT_ELFABILITYDATA_SET_ID_OFFSET UNITYSDK_OFFSET(0xB8A42F0)
#define RPG_CLIENT_ELFABILITYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB8A42D0)

namespace RPG::Client
{
	inline static constexpr unsigned int ElfAbilityData_TypeDefinitionIndex = 59586;
