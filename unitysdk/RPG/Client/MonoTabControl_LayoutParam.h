...
#define RPG_CLIENT_MONOTABCONTROL_LAYOUTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x9D3B0B0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoTabControl_LayoutParam_TypeDefinitionIndex = 59507;
