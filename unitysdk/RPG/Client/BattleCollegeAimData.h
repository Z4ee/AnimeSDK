...
#define RPG_CLIENT_BATTLECOLLEGEAIMDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x19F3D8C0)
#define RPG_CLIENT_BATTLECOLLEGEAIMDATA_GET_AIMID_OFFSET UNITYSDK_OFFSET(0x19F3DA60)
#define RPG_CLIENT_BATTLECOLLEGEAIMDATA_GET_CURRENTVALUE_OFFSET UNITYSDK_OFFSET(0x19F3DA80)
#define RPG_CLIENT_BATTLECOLLEGEAIMDATA_GET_ROW_OFFSET UNITYSDK_OFFSET(0x19F3DA40)
#define RPG_CLIENT_BATTLECOLLEGEAIMDATA_GET_TOTALVALUE_OFFSET UNITYSDK_OFFSET(0x19F3DAA0)
#define RPG_CLIENT_BATTLECOLLEGEAIMDATA_ISFINISH_OFFSET UNITYSDK_OFFSET(0x19F3D9F0)
#define RPG_CLIENT_BATTLECOLLEGEAIMDATA_SET_AIMID_OFFSET UNITYSDK_OFFSET(0x19F3DA70)
#define RPG_CLIENT_BATTLECOLLEGEAIMDATA_SET_CURRENTVALUE_OFFSET UNITYSDK_OFFSET(0x19F3DA90)
#define RPG_CLIENT_BATTLECOLLEGEAIMDATA_SET_ROW_OFFSET UNITYSDK_OFFSET(0x19F3DA50)
#define RPG_CLIENT_BATTLECOLLEGEAIMDATA_SET_TOTALVALUE_OFFSET UNITYSDK_OFFSET(0x19F3DAB0)
#define RPG_CLIENT_BATTLECOLLEGEAIMDATA_UPDATEVALUE_OFFSET UNITYSDK_OFFSET(0x19F3D990)
#define RPG_CLIENT_BATTLECOLLEGEAIMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19F3D980)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::UInt32 _AimID_k__BackingField; // 0x20
