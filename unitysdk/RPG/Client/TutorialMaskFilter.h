...
#define RPG_CLIENT_TUTORIALMASKFILTER_ADDFILTERAREA_OFFSET UNITYSDK_OFFSET(0xB39A040)
#define RPG_CLIENT_TUTORIALMASKFILTER_CLEAR_OFFSET UNITYSDK_OFFSET(0xB399EF0)
#define RPG_CLIENT_TUTORIALMASKFILTER_ENABLEDEBUGDRAW_OFFSET UNITYSDK_OFFSET(0xB39BC60)
#define RPG_CLIENT_TUTORIALMASKFILTER_ISRAYCASTLOCATIONVALID_OFFSET UNITYSDK_OFFSET(0xB39BAE0)
#define RPG_CLIENT_TUTORIALMASKFILTER_REMOVEFILTERAREA_OFFSET UNITYSDK_OFFSET(0xB39BBC0)
#define RPG_CLIENT_TUTORIALMASKFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0xB39BCB0)

namespace RPG::Client
{
	inline static constexpr unsigned int TutorialMaskFilter_TypeDefinitionIndex = 63638;
