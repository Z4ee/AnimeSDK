...
#define RPG_CLIENT_TUTORIALMASKFILTER_ADDFILTERAREA_OFFSET UNITYSDK_OFFSET(0x1B110CB0)
#define RPG_CLIENT_TUTORIALMASKFILTER_CLEAR_OFFSET UNITYSDK_OFFSET(0x1B110B80)
#define RPG_CLIENT_TUTORIALMASKFILTER_ENABLEDEBUGDRAW_OFFSET UNITYSDK_OFFSET(0x1B113EB0)
#define RPG_CLIENT_TUTORIALMASKFILTER_ISRAYCASTLOCATIONVALID_OFFSET UNITYSDK_OFFSET(0x1B113D20)
#define RPG_CLIENT_TUTORIALMASKFILTER_REMOVEFILTERAREA_OFFSET UNITYSDK_OFFSET(0x1B113E20)
#define RPG_CLIENT_TUTORIALMASKFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B113F00)

namespace RPG::Client
{
	inline static constexpr unsigned int TutorialMaskFilter_TypeDefinitionIndex = 68998;

	class TutorialMaskFilter : public ::UnityEngine::MonoBehaviour
	{
	public:
		::System::Collections::Generic::List_1<::System::Nullable_1<::UnityEngine::Rect>>* POFJJNJLMBA; // 0x18
		::System::Boolean AJODECOABDD; // 0x20
