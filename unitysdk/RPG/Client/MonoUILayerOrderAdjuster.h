...
#define RPG_CLIENT_MONOUILAYERORDERADJUSTER_AWAKE_OFFSET UNITYSDK_OFFSET(0x9D4C030)
#define RPG_CLIENT_MONOUILAYERORDERADJUSTER_SETBASECANVASORDER_OFFSET UNITYSDK_OFFSET(0x9D4BFC0)
#define RPG_CLIENT_MONOUILAYERORDERADJUSTER_SETBASECANVAS_OFFSET UNITYSDK_OFFSET(0x9D4BCD0)
#define RPG_CLIENT_MONOUILAYERORDERADJUSTER_SETORDER_OFFSET UNITYSDK_OFFSET(0x9D4BD20)
#define RPG_CLIENT_MONOUILAYERORDERADJUSTER_START_OFFSET UNITYSDK_OFFSET(0x9D4C1E0)
#define RPG_CLIENT_MONOUILAYERORDERADJUSTER_UPDATE_OFFSET UNITYSDK_OFFSET(0x9D4C310)
#define RPG_CLIENT_MONOUILAYERORDERADJUSTER__CHECKBASECANVASORDERCHANGED_OFFSET UNITYSDK_OFFSET(0x9D4C3B0)
#define RPG_CLIENT_MONOUILAYERORDERADJUSTER__CTOR_OFFSET UNITYSDK_OFFSET(0x9D4C410)
#define RPG_CLIENT_MONOUILAYERORDERADJUSTER__FINDPARENTCANVAS_OFFSET UNITYSDK_OFFSET(0x9D4C0D0)
#define RPG_CLIENT_MONOUILAYERORDERADJUSTER__START_B__8_0_OFFSET UNITYSDK_OFFSET(0x9D4C420)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoUILayerOrderAdjuster_TypeDefinitionIndex = 59887;
