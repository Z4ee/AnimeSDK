...
#define RPG_CLIENT_MONOUILAYERORDERADJUSTER_AWAKE_OFFSET UNITYSDK_OFFSET(0xD87B860)
#define RPG_CLIENT_MONOUILAYERORDERADJUSTER_SETBASECANVASORDER_OFFSET UNITYSDK_OFFSET(0xD87B7F0)
#define RPG_CLIENT_MONOUILAYERORDERADJUSTER_SETBASECANVAS_OFFSET UNITYSDK_OFFSET(0xD87B540)
#define RPG_CLIENT_MONOUILAYERORDERADJUSTER_SETORDER_OFFSET UNITYSDK_OFFSET(0xD87B590)
#define RPG_CLIENT_MONOUILAYERORDERADJUSTER_START_OFFSET UNITYSDK_OFFSET(0xD87BA10)
#define RPG_CLIENT_MONOUILAYERORDERADJUSTER_UPDATE_OFFSET UNITYSDK_OFFSET(0xD87BB70)
#define RPG_CLIENT_MONOUILAYERORDERADJUSTER__CHECKBASECANVASORDERCHANGED_OFFSET UNITYSDK_OFFSET(0xD87BC10)
#define RPG_CLIENT_MONOUILAYERORDERADJUSTER__CTOR_OFFSET UNITYSDK_OFFSET(0xD87BC70)
#define RPG_CLIENT_MONOUILAYERORDERADJUSTER__FINDPARENTCANVAS_OFFSET UNITYSDK_OFFSET(0xD87B900)
#define RPG_CLIENT_MONOUILAYERORDERADJUSTER__START_B__8_0_OFFSET UNITYSDK_OFFSET(0xD87BC80)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoUILayerOrderAdjuster_TypeDefinitionIndex = 72982;
