...
#define RPG_CLIENT_SILVERWOLFUNLOCKMISSIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA487140)

namespace RPG::Client
{
	inline static constexpr unsigned int SilverWolfUnlockMissionData_TypeDefinitionIndex = 55451;
