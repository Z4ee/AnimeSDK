...
#define RPG_CLIENT_MINIMAPLIMITAREA_METHOD_5_998B92774C65B108_OFFSET UNITYSDK_OFFSET(0xD6B7D40)
#define RPG_CLIENT_MINIMAPLIMITAREA_METHOD_5_BD96CD5B662D5F6C_OFFSET UNITYSDK_OFFSET(0xD6B7C90)
#define RPG_CLIENT_MINIMAPLIMITAREA_METHOD_5_E3DE31A03057E055_OFFSET UNITYSDK_OFFSET(0xD6B7BA0)
#define RPG_CLIENT_MINIMAPLIMITAREA_REFRESH_OFFSET UNITYSDK_OFFSET(0xD6B7890)
#define RPG_CLIENT_MINIMAPLIMITAREA__CTOR_OFFSET UNITYSDK_OFFSET(0xD6B7E40)
