...
#define RPG_CLIENT_MINIMAPLIMITAREA_METHOD_5_998B92774C65B108_OFFSET UNITYSDK_OFFSET(0x15811750)
#define RPG_CLIENT_MINIMAPLIMITAREA_METHOD_5_BD96CD5B662D5F6C_OFFSET UNITYSDK_OFFSET(0x158116A0)
#define RPG_CLIENT_MINIMAPLIMITAREA_METHOD_5_E3DE31A03057E055_OFFSET UNITYSDK_OFFSET(0x158115B0)
#define RPG_CLIENT_MINIMAPLIMITAREA_REFRESH_OFFSET UNITYSDK_OFFSET(0x158112A0)
#define RPG_CLIENT_MINIMAPLIMITAREA__CTOR_OFFSET UNITYSDK_OFFSET(0x15811850)

namespace RPG::Client
{
	inline static constexpr unsigned int MiniMapLimitArea_TypeDefinitionIndex = 65882;
