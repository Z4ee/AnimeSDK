...
#define RPG_CLIENT_MINIMAPLIMITAREA_METHOD_5_998B92774C65B108_OFFSET UNITYSDK_OFFSET(0x9BA1DD0)
#define RPG_CLIENT_MINIMAPLIMITAREA_METHOD_5_BD96CD5B662D5F6C_OFFSET UNITYSDK_OFFSET(0x9BA1D20)
#define RPG_CLIENT_MINIMAPLIMITAREA_METHOD_5_E3DE31A03057E055_OFFSET UNITYSDK_OFFSET(0x9BA1C30)
#define RPG_CLIENT_MINIMAPLIMITAREA_REFRESH_OFFSET UNITYSDK_OFFSET(0x9BA1920)
#define RPG_CLIENT_MINIMAPLIMITAREA__CTOR_OFFSET UNITYSDK_OFFSET(0x9BA1ED0)

namespace RPG::Client
{
	inline static constexpr unsigned int MiniMapLimitArea_TypeDefinitionIndex = 56319;
