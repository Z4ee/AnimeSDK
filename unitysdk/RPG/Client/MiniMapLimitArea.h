...
#define RPG_CLIENT_MINIMAPLIMITAREA_METHOD_5_998B92774C65B108_OFFSET UNITYSDK_OFFSET(0x16952D00)
#define RPG_CLIENT_MINIMAPLIMITAREA_METHOD_5_BD96CD5B662D5F6C_OFFSET UNITYSDK_OFFSET(0x16952C50)
#define RPG_CLIENT_MINIMAPLIMITAREA_METHOD_5_E3DE31A03057E055_OFFSET UNITYSDK_OFFSET(0x16952B60)
#define RPG_CLIENT_MINIMAPLIMITAREA_REFRESH_OFFSET UNITYSDK_OFFSET(0x16952850)
#define RPG_CLIENT_MINIMAPLIMITAREA__CTOR_OFFSET UNITYSDK_OFFSET(0x16952E00)

namespace RPG::Client
{
	inline static constexpr unsigned int MiniMapLimitArea_TypeDefinitionIndex = 68921;

	class MiniMapLimitArea : public ::UnityEngine::MonoBehaviour
	{
	public:
		::UnityEngine::RectTransform* LGAFBMEJBPI; // 0x18
