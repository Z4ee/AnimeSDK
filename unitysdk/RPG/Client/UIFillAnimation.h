...
#define RPG_CLIENT_UIFILLANIMATION_GET_CURFILLAMOUNT_OFFSET UNITYSDK_OFFSET(0xCB4A330)
#define RPG_CLIENT_UIFILLANIMATION_GET_ISPLAYING_OFFSET UNITYSDK_OFFSET(0xCB4A320)
#define RPG_CLIENT_UIFILLANIMATION_PLAY_1_OFFSET UNITYSDK_OFFSET(0xCB4A1E0)
#define RPG_CLIENT_UIFILLANIMATION_PLAY_OFFSET UNITYSDK_OFFSET(0xCB4A180)
#define RPG_CLIENT_UIFILLANIMATION_START_OFFSET UNITYSDK_OFFSET(0xCB49E40)
#define RPG_CLIENT_UIFILLANIMATION_STOP_OFFSET UNITYSDK_OFFSET(0xCB4A280)
#define RPG_CLIENT_UIFILLANIMATION_UPDATE_OFFSET UNITYSDK_OFFSET(0xCB49F60)
#define RPG_CLIENT_UIFILLANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0xCB4A340)
#define RPG_CLIENT_UIFILLANIMATION__SETUPCMPTVALUE_OFFSET UNITYSDK_OFFSET(0xCB4A080)

namespace RPG::Client
{
	inline static constexpr unsigned int UIFillAnimation_TypeDefinitionIndex = 64621;
