...
#define RPG_CLIENT_UIFILLANIMATION_GET_CURFILLAMOUNT_OFFSET UNITYSDK_OFFSET(0xE35E910)
#define RPG_CLIENT_UIFILLANIMATION_GET_ISPLAYING_OFFSET UNITYSDK_OFFSET(0xE35E900)
#define RPG_CLIENT_UIFILLANIMATION_PLAY_1_OFFSET UNITYSDK_OFFSET(0xE35E7C0)
#define RPG_CLIENT_UIFILLANIMATION_PLAY_OFFSET UNITYSDK_OFFSET(0xE35E760)
#define RPG_CLIENT_UIFILLANIMATION_START_OFFSET UNITYSDK_OFFSET(0xE35E370)
#define RPG_CLIENT_UIFILLANIMATION_STOP_OFFSET UNITYSDK_OFFSET(0xE35E860)
#define RPG_CLIENT_UIFILLANIMATION_UPDATE_OFFSET UNITYSDK_OFFSET(0xE35E4C0)
#define RPG_CLIENT_UIFILLANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0xE35E920)
#define RPG_CLIENT_UIFILLANIMATION__SETUPCMPTVALUE_OFFSET UNITYSDK_OFFSET(0xE35E5E0)
