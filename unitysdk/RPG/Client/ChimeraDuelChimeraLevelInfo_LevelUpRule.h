...
#define RPG_CLIENT_CHIMERADUELCHIMERALEVELINFO_LEVELUPRULE_CONVERTEXPTOLEVEL_OFFSET UNITYSDK_OFFSET(0xA003EE0)
#define RPG_CLIENT_CHIMERADUELCHIMERALEVELINFO_LEVELUPRULE_CONVERTLEVELTOEXP_OFFSET UNITYSDK_OFFSET(0xA003E30)
#define RPG_CLIENT_CHIMERADUELCHIMERALEVELINFO_LEVELUPRULE_CREATEWITHCONSTVALUES_OFFSET UNITYSDK_OFFSET(0xA002A50)
#define RPG_CLIENT_CHIMERADUELCHIMERALEVELINFO_LEVELUPRULE_GETLEVELUPREQUIREDEXP_OFFSET UNITYSDK_OFFSET(0xA003F70)
#define RPG_CLIENT_CHIMERADUELCHIMERALEVELINFO_LEVELUPRULE_GET_MAXGAINEDEXP_OFFSET UNITYSDK_OFFSET(0xA003DE0)
#define RPG_CLIENT_CHIMERADUELCHIMERALEVELINFO_LEVELUPRULE_GET_MAXLEVEL_OFFSET UNITYSDK_OFFSET(0xA003DD0)
#define RPG_CLIENT_CHIMERADUELCHIMERALEVELINFO_LEVELUPRULE_READCONSTVALUEOFEXPBEFORELEVELUP_OFFSET UNITYSDK_OFFSET(0xA003320)
#define RPG_CLIENT_CHIMERADUELCHIMERALEVELINFO_LEVELUPRULE__CTOR_OFFSET UNITYSDK_OFFSET(0xA0035A0)

namespace RPG::Client
{
	inline static constexpr unsigned int ChimeraDuelChimeraLevelInfo_LevelUpRule_TypeDefinitionIndex = 58359;
