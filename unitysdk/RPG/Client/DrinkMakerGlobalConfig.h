...
#define RPG_CLIENT_DRINKMAKERGLOBALCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6820A0)

namespace RPG::Client
{
	inline static constexpr unsigned int DrinkMakerGlobalConfig_TypeDefinitionIndex = 63697;
