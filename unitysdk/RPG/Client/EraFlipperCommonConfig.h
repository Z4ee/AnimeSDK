...
#define RPG_CLIENT_ERAFLIPPERCOMMONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xB9309D0)

namespace RPG::Client
{
	inline static constexpr unsigned int EraFlipperCommonConfig_TypeDefinitionIndex = 56543;
