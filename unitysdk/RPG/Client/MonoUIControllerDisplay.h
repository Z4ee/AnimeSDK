...
#define RPG_CLIENT_MONOUICONTROLLERDISPLAY_INIT_OFFSET UNITYSDK_OFFSET(0xC15C680)
#define RPG_CLIENT_MONOUICONTROLLERDISPLAY_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC15C6D0)
#define RPG_CLIENT_MONOUICONTROLLERDISPLAY__CTOR_OFFSET UNITYSDK_OFFSET(0xC15C720)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoUIControllerDisplay_TypeDefinitionIndex = 68222;
