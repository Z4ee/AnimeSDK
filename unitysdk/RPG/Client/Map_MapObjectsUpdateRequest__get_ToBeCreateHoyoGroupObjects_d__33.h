...
#define RPG_CLIENT_MAP_MAPOBJECTSUPDATEREQUEST__GET_TOBECREATEHOYOGROUPOBJECTS_D__33_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x174C5BD0)
#define RPG_CLIENT_MAP_MAPOBJECTSUPDATEREQUEST__GET_TOBECREATEHOYOGROUPOBJECTS_D__33_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_RPG_CLIENT_MAPENTITYDEF__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x174C5F80)
#define RPG_CLIENT_MAP_MAPOBJECTSUPDATEREQUEST__GET_TOBECREATEHOYOGROUPOBJECTS_D__33_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_RPG_CLIENT_MAPENTITYDEF__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x174C5F10)
#define RPG_CLIENT_MAP_MAPOBJECTSUPDATEREQUEST__GET_TOBECREATEHOYOGROUPOBJECTS_D__33_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x174C5FE0)
#define RPG_CLIENT_MAP_MAPOBJECTSUPDATEREQUEST__GET_TOBECREATEHOYOGROUPOBJECTS_D__33_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x174C5F70)
#define RPG_CLIENT_MAP_MAPOBJECTSUPDATEREQUEST__GET_TOBECREATEHOYOGROUPOBJECTS_D__33_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x174C5F20)
#define RPG_CLIENT_MAP_MAPOBJECTSUPDATEREQUEST__GET_TOBECREATEHOYOGROUPOBJECTS_D__33_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x174C5B90)
#define RPG_CLIENT_MAP_MAPOBJECTSUPDATEREQUEST__GET_TOBECREATEHOYOGROUPOBJECTS_D__33__CTOR_OFFSET UNITYSDK_OFFSET(0x174C5150)
#define RPG_CLIENT_MAP_MAPOBJECTSUPDATEREQUEST__GET_TOBECREATEHOYOGROUPOBJECTS_D__33___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x174C5BA0)
#define RPG_CLIENT_MAP_MAPOBJECTSUPDATEREQUEST__GET_TOBECREATEHOYOGROUPOBJECTS_D__33___M__FINALLY2_OFFSET UNITYSDK_OFFSET(0x174C5BC0)
#define RPG_CLIENT_MAP_MAPOBJECTSUPDATEREQUEST__GET_TOBECREATEHOYOGROUPOBJECTS_D__33___M__FINALLY3_OFFSET UNITYSDK_OFFSET(0x174C5BB0)

namespace RPG::Client
{
	inline static constexpr unsigned int Map_MapObjectsUpdateRequest__get_ToBeCreateHoyoGroupObjects_d__33_TypeDefinitionIndex = 60964;
	...
	public:
		...
		::System::Collections::Generic::List_1_Enumerator<::System::ValueTuple_2<::Class_2_0748E0E1B406181B*, ::System::Collections::Generic::List_1<::RPG::Client::MapEntityDef*>*>> __7__wrap2; // 0x18
		::RPG::Client::MapEntityDef* __2__current; // 0x38
		::System::Collections::Generic::List_1_Enumerator<::RPG::Client::MapEntityDef*> __7__wrap1; // 0x40
