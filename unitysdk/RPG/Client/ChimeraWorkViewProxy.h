...
#define RPG_CLIENT_CHIMERAWORKVIEWPROXY_POSTEVENT_OFFSET UNITYSDK_OFFSET(0x93DD930)
#define RPG_CLIENT_CHIMERAWORKVIEWPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x93DDD00)

namespace RPG::Client
{
	inline static constexpr unsigned int ChimeraWorkViewProxy_TypeDefinitionIndex = 56071;
