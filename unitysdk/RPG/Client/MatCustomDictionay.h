...
#define RPG_CLIENT_MATCUSTOMDICTIONAY_FINALIZE_OFFSET UNITYSDK_OFFSET(0x9B21690)
#define RPG_CLIENT_MATCUSTOMDICTIONAY_METHOD_1_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0x9B215F0)
#define RPG_CLIENT_MATCUSTOMDICTIONAY_METHOD_1_4DB5506DCD053FB2_OFFSET UNITYSDK_OFFSET(0x9B21510)
#define RPG_CLIENT_MATCUSTOMDICTIONAY_METHOD_1_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0x9B215A0)
#define RPG_CLIENT_MATCUSTOMDICTIONAY__CTOR_OFFSET UNITYSDK_OFFSET(0x9B214B0)

namespace RPG::Client
{
	inline static constexpr unsigned int MatCustomDictionay_TypeDefinitionIndex = 57948;
