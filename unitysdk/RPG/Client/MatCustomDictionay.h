...
#define RPG_CLIENT_MATCUSTOMDICTIONAY_FINALIZE_OFFSET UNITYSDK_OFFSET(0xBF039E0)
#define RPG_CLIENT_MATCUSTOMDICTIONAY_METHOD_1_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0xBF038F0)
#define RPG_CLIENT_MATCUSTOMDICTIONAY_METHOD_1_CFE6FB160FFF5938_OFFSET UNITYSDK_OFFSET(0xBF03940)
#define RPG_CLIENT_MATCUSTOMDICTIONAY_METHOD_1_EE995D7DF270EB55_OFFSET UNITYSDK_OFFSET(0xBF037B0)
#define RPG_CLIENT_MATCUSTOMDICTIONAY__CTOR_OFFSET UNITYSDK_OFFSET(0xBF03750)

namespace RPG::Client
{
	inline static constexpr unsigned int MatCustomDictionay_TypeDefinitionIndex = 66162;
