...
#define RPG_CLIENT_UPSTAIRFOOTIK_GET_ISPROCESSABLE_OFFSET UNITYSDK_OFFSET(0x18321250)
#define RPG_CLIENT_UPSTAIRFOOTIK_METHOD_5_301EC52F4A09A83B_OFFSET UNITYSDK_OFFSET(0x18322520)
#define RPG_CLIENT_UPSTAIRFOOTIK_METHOD_5_6900CC9794727188_OFFSET UNITYSDK_OFFSET(0x18322040)
#define RPG_CLIENT_UPSTAIRFOOTIK_METHOD_5_F92EA6C247440E32_OFFSET UNITYSDK_OFFSET(0x18322760)
#define RPG_CLIENT_UPSTAIRFOOTIK_PREPROCESS_OFFSET UNITYSDK_OFFSET(0x18321A80)
#define RPG_CLIENT_UPSTAIRFOOTIK_PROCESS_OFFSET UNITYSDK_OFFSET(0x18321BA0)
#define RPG_CLIENT_UPSTAIRFOOTIK_RESETUPSTAIR_OFFSET UNITYSDK_OFFSET(0x18321200)
#define RPG_CLIENT_UPSTAIRFOOTIK_SAFEINIT_OFFSET UNITYSDK_OFFSET(0x183212B0)
#define RPG_CLIENT_UPSTAIRFOOTIK_SETUPUPSTAIR_OFFSET UNITYSDK_OFFSET(0x18321180)
#define RPG_CLIENT_UPSTAIRFOOTIK__CTOR_OFFSET UNITYSDK_OFFSET(0x18322AD0)

namespace RPG::Client
{
	inline static constexpr unsigned int UpStairFootIK_TypeDefinitionIndex = 65452;
