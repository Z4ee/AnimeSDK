...
#define RPG_CLIENT_UPSTAIRFOOTIK_GET_ISPROCESSABLE_OFFSET UNITYSDK_OFFSET(0xE3D0F60)
#define RPG_CLIENT_UPSTAIRFOOTIK_METHOD_5_301EC52F4A09A83B_OFFSET UNITYSDK_OFFSET(0xE3D2230)
#define RPG_CLIENT_UPSTAIRFOOTIK_METHOD_5_6900CC9794727188_OFFSET UNITYSDK_OFFSET(0xE3D1D50)
#define RPG_CLIENT_UPSTAIRFOOTIK_METHOD_5_F92EA6C247440E32_OFFSET UNITYSDK_OFFSET(0xE3D2470)
#define RPG_CLIENT_UPSTAIRFOOTIK_PREPROCESS_OFFSET UNITYSDK_OFFSET(0xE3D1790)
#define RPG_CLIENT_UPSTAIRFOOTIK_PROCESS_OFFSET UNITYSDK_OFFSET(0xE3D18B0)
#define RPG_CLIENT_UPSTAIRFOOTIK_RESETUPSTAIR_OFFSET UNITYSDK_OFFSET(0xE3D0F10)
#define RPG_CLIENT_UPSTAIRFOOTIK_SAFEINIT_OFFSET UNITYSDK_OFFSET(0xE3D0FC0)
#define RPG_CLIENT_UPSTAIRFOOTIK_SETUPUPSTAIR_OFFSET UNITYSDK_OFFSET(0xE3D0E90)
#define RPG_CLIENT_UPSTAIRFOOTIK__CTOR_OFFSET UNITYSDK_OFFSET(0xE3D27E0)
