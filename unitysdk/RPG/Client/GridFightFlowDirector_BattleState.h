...
#define RPG_CLIENT_GRIDFIGHTFLOWDIRECTOR_BATTLESTATE_ONENTER_OFFSET UNITYSDK_OFFSET(0xA49B0F0)
#define RPG_CLIENT_GRIDFIGHTFLOWDIRECTOR_BATTLESTATE_ONEVENT_OFFSET UNITYSDK_OFFSET(0xA49B300)
#define RPG_CLIENT_GRIDFIGHTFLOWDIRECTOR_BATTLESTATE_ONEXIT_OFFSET UNITYSDK_OFFSET(0xA49B2B0)
#define RPG_CLIENT_GRIDFIGHTFLOWDIRECTOR_BATTLESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0xA499E90)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightFlowDirector_BattleState_TypeDefinitionIndex = 59448;
