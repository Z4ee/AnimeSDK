...
#define RPG_CLIENT_CHECKITEMREACHPLAYERLEVEL_FILLNOTIFYTYPESTO_OFFSET UNITYSDK_OFFSET(0x19635330)
#define RPG_CLIENT_CHECKITEMREACHPLAYERLEVEL_GET_TARGETPLAYERLEVEL_OFFSET UNITYSDK_OFFSET(0x19635550)
#define RPG_CLIENT_CHECKITEMREACHPLAYERLEVEL_TOSTRING_OFFSET UNITYSDK_OFFSET(0x196354A0)
#define RPG_CLIENT_CHECKITEMREACHPLAYERLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x19635310)
#define RPG_CLIENT_CHECKITEMREACHPLAYERLEVEL__DOCHECKIMPL_OFFSET UNITYSDK_OFFSET(0x196353F0)

namespace RPG::Client
{
	inline static constexpr unsigned int CheckItemReachPlayerLevel_TypeDefinitionIndex = 57226;
