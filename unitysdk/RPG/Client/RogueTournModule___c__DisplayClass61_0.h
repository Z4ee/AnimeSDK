...
#define RPG_CLIENT_ROGUETOURNMODULE___C__DISPLAYCLASS61_0__APPLYROGUETOURNBUILDREF_B__0_OFFSET UNITYSDK_OFFSET(0xA3B0FA0)
#define RPG_CLIENT_ROGUETOURNMODULE___C__DISPLAYCLASS61_0__APPLYROGUETOURNBUILDREF_B__1_OFFSET UNITYSDK_OFFSET(0xA3B1040)
#define RPG_CLIENT_ROGUETOURNMODULE___C__DISPLAYCLASS61_0__APPLYROGUETOURNBUILDREF_B__2_OFFSET UNITYSDK_OFFSET(0xA3B0BC0)
#define RPG_CLIENT_ROGUETOURNMODULE___C__DISPLAYCLASS61_0__APPLYROGUETOURNBUILDREF_B__3_OFFSET UNITYSDK_OFFSET(0xA3B0F80)
#define RPG_CLIENT_ROGUETOURNMODULE___C__DISPLAYCLASS61_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA3A5690)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueTournModule___c__DisplayClass61_0_TypeDefinitionIndex = 55305;
	...
	public:
		...
		::System::Collections::Generic::List_1<::System::UInt32>* teamAvatarRealIDs; // 0x28
