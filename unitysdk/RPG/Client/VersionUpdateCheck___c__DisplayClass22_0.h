...
#define RPG_CLIENT_VERSIONUPDATECHECK___C__DISPLAYCLASS22_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA767320)
#define RPG_CLIENT_VERSIONUPDATECHECK___C__DISPLAYCLASS22_0__STARTLOCALASSETVERIFY_B__0_OFFSET UNITYSDK_OFFSET(0xA767F80)
#define RPG_CLIENT_VERSIONUPDATECHECK___C__DISPLAYCLASS22_0__STARTLOCALASSETVERIFY_B__1_OFFSET UNITYSDK_OFFSET(0xA767FE0)
#define RPG_CLIENT_VERSIONUPDATECHECK___C__DISPLAYCLASS22_0__STARTLOCALASSETVERIFY_B__3_OFFSET UNITYSDK_OFFSET(0xA7686C0)

namespace RPG::Client
{
	inline static constexpr unsigned int VersionUpdateCheck___c__DisplayClass22_0_TypeDefinitionIndex = 49667;
