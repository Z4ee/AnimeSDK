...
#define RPG_CLIENT_PHOTOGRAPHSHOTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xAC6F580)

namespace RPG::Client
{
	inline static constexpr unsigned int PhotoGraphShotParam_TypeDefinitionIndex = 56190;
