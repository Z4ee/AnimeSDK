...
#define RPG_CLIENT_UI3DFREELOOKCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16FEA030)

namespace RPG::Client
{
	inline static constexpr unsigned int UI3DFreeLookController_TypeDefinitionIndex = 69673;
