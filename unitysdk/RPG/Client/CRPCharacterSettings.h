...
#define RPG_CLIENT_CRPCHARACTERSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x9EB9C60)

namespace RPG::Client
{
	inline static constexpr unsigned int CRPCharacterSettings_TypeDefinitionIndex = 62621;
