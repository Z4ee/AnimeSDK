...
#define RPG_CLIENT_AVATARCOMPAREREXTENSIONS_SETLEVELRARITYISDESCENDING_OFFSET UNITYSDK_OFFSET(0xB35CCB0)
#define RPG_CLIENT_AVATARCOMPAREREXTENSIONS_SETLEVELRARITYISLEVELFIRST_OFFSET UNITYSDK_OFFSET(0xB35CBA0)
#define RPG_CLIENT_AVATARCOMPAREREXTENSIONS_SETPINNING_OFFSET UNITYSDK_OFFSET(0xB35CAB0)

namespace RPG::Client
{
	inline static constexpr unsigned int AvatarComparerExtensions_TypeDefinitionIndex = 58754;
