...
#define RPG_CLIENT_RENDEROPTIONSMANAGER_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA2BF440)
#define RPG_CLIENT_RENDEROPTIONSMANAGER_LENSFLAREPOPFLAG_OFFSET UNITYSDK_OFFSET(0xA2BF3B0)
#define RPG_CLIENT_RENDEROPTIONSMANAGER_LENSFLAREPUSHFLAG_OFFSET UNITYSDK_OFFSET(0xA2BF2F0)
#define RPG_CLIENT_RENDEROPTIONSMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xA2BF100)

namespace RPG::Client
{
	inline static constexpr unsigned int RenderOptionsManager_TypeDefinitionIndex = 57431;
