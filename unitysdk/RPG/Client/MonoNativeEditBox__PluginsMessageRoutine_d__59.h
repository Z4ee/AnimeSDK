...
#define RPG_CLIENT_MONONATIVEEDITBOX__PLUGINSMESSAGEROUTINE_D__59_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xC1344D0)
#define RPG_CLIENT_MONONATIVEEDITBOX__PLUGINSMESSAGEROUTINE_D__59_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xC134700)
#define RPG_CLIENT_MONONATIVEEDITBOX__PLUGINSMESSAGEROUTINE_D__59_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xC134760)
#define RPG_CLIENT_MONONATIVEEDITBOX__PLUGINSMESSAGEROUTINE_D__59_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xC134710)
#define RPG_CLIENT_MONONATIVEEDITBOX__PLUGINSMESSAGEROUTINE_D__59_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC1344C0)
#define RPG_CLIENT_MONONATIVEEDITBOX__PLUGINSMESSAGEROUTINE_D__59__CTOR_OFFSET UNITYSDK_OFFSET(0xC132FC0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoNativeEditBox__PluginsMessageRoutine_d__59_TypeDefinitionIndex = 66520;
