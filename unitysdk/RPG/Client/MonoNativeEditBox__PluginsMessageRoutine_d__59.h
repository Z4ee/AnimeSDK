...
#define RPG_CLIENT_MONONATIVEEDITBOX__PLUGINSMESSAGEROUTINE_D__59_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xD851CA0)
#define RPG_CLIENT_MONONATIVEEDITBOX__PLUGINSMESSAGEROUTINE_D__59_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xD851F90)
#define RPG_CLIENT_MONONATIVEEDITBOX__PLUGINSMESSAGEROUTINE_D__59_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xD851FF0)
#define RPG_CLIENT_MONONATIVEEDITBOX__PLUGINSMESSAGEROUTINE_D__59_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xD851FA0)
#define RPG_CLIENT_MONONATIVEEDITBOX__PLUGINSMESSAGEROUTINE_D__59_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD851C90)
#define RPG_CLIENT_MONONATIVEEDITBOX__PLUGINSMESSAGEROUTINE_D__59__CTOR_OFFSET UNITYSDK_OFFSET(0xD850750)
