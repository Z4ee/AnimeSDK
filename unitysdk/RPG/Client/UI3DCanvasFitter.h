...
#define RPG_CLIENT_UI3DCANVASFITTER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xB3AAD10)
#define RPG_CLIENT_UI3DCANVASFITTER_METHOD_5_0717423DDEA0E9A4_OFFSET UNITYSDK_OFFSET(0xB3AB750)
#define RPG_CLIENT_UI3DCANVASFITTER_METHOD_5_0865E94460F11643_OFFSET UNITYSDK_OFFSET(0xB3AADC0)
#define RPG_CLIENT_UI3DCANVASFITTER_METHOD_5_0ED2EEE19D10A0A7_OFFSET UNITYSDK_OFFSET(0xB3AAB00)
#define RPG_CLIENT_UI3DCANVASFITTER_METHOD_5_60E1F7F58CCF739F_OFFSET UNITYSDK_OFFSET(0xB3AA880)
#define RPG_CLIENT_UI3DCANVASFITTER_METHOD_5_79661C0243426B92_OFFSET UNITYSDK_OFFSET(0xB3AB250)
#define RPG_CLIENT_UI3DCANVASFITTER_METHOD_5_7FDE31EDE47E1969_OFFSET UNITYSDK_OFFSET(0xB3ABB40)
#define RPG_CLIENT_UI3DCANVASFITTER_METHOD_5_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0xB3AB040)
#define RPG_CLIENT_UI3DCANVASFITTER_METHOD_5_999B8B439422C7E7_OFFSET UNITYSDK_OFFSET(0xB3AB3E0)
#define RPG_CLIENT_UI3DCANVASFITTER_METHOD_5_B41DC260337975FD_OFFSET UNITYSDK_OFFSET(0xB3AB0F0)
#define RPG_CLIENT_UI3DCANVASFITTER_METHOD_5_BB2928BEC244DEB7_OFFSET UNITYSDK_OFFSET(0xB3AAA50)
#define RPG_CLIENT_UI3DCANVASFITTER_METHOD_5_E10F3359B5E0D724_OFFSET UNITYSDK_OFFSET(0xB3AB4F0)
#define RPG_CLIENT_UI3DCANVASFITTER_METHOD_5_EE97EFC752A55D2E_OFFSET UNITYSDK_OFFSET(0xB3AB200)
#define RPG_CLIENT_UI3DCANVASFITTER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xB3AAC20)
#define RPG_CLIENT_UI3DCANVASFITTER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xB3AA770)
#define RPG_CLIENT_UI3DCANVASFITTER_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0xB3AB180)
#define RPG_CLIENT_UI3DCANVASFITTER__CTOR_OFFSET UNITYSDK_OFFSET(0xB3ABD20)
#define RPG_CLIENT_UI3DCANVASFITTER___UPDATERUNTIMETARGETCAMERA_B__6_0_OFFSET UNITYSDK_OFFSET(0xB3ABD40)

namespace RPG::Client
{
	inline static constexpr unsigned int UI3DCanvasFitter_TypeDefinitionIndex = 63653;
