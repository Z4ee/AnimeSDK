...
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE___C__DISPLAYCLASS2_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6ED190)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE___C__DISPLAYCLASS2_0__JOINLOBBY_B__0_OFFSET UNITYSDK_OFFSET(0x1B6EF8E0)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE___C__DISPLAYCLASS2_0__JOINLOBBY_B__1_OFFSET UNITYSDK_OFFSET(0x1B6EF990)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE___C__DISPLAYCLASS2_0__JOINLOBBY_B__2_OFFSET UNITYSDK_OFFSET(0x1B6EFCD0)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE___C__DISPLAYCLASS2_0__JOINLOBBY_B__3_OFFSET UNITYSDK_OFFSET(0x1B6EFD70)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE___C__DISPLAYCLASS2_0__JOINLOBBY_B__4_OFFSET UNITYSDK_OFFSET(0x1B6EFC20)

namespace RPG::Client::Multiplayer
{
	inline static constexpr unsigned int BaseMPGameService___c__DisplayClass2_0_TypeDefinitionIndex = 78932;
