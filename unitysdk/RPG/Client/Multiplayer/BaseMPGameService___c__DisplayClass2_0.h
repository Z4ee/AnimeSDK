...
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE___C__DISPLAYCLASS2_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC1BC700)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE___C__DISPLAYCLASS2_0__JOINLOBBY_B__0_OFFSET UNITYSDK_OFFSET(0xC1BE0E0)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE___C__DISPLAYCLASS2_0__JOINLOBBY_B__1_OFFSET UNITYSDK_OFFSET(0xC1BE120)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE___C__DISPLAYCLASS2_0__JOINLOBBY_B__2_OFFSET UNITYSDK_OFFSET(0xC1BE2F0)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE___C__DISPLAYCLASS2_0__JOINLOBBY_B__3_OFFSET UNITYSDK_OFFSET(0xC1BE320)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE___C__DISPLAYCLASS2_0__JOINLOBBY_B__4_OFFSET UNITYSDK_OFFSET(0xC1BE2B0)

namespace RPG::Client::Multiplayer
{
	inline static constexpr unsigned int BaseMPGameService___c__DisplayClass2_0_TypeDefinitionIndex = 73736;
