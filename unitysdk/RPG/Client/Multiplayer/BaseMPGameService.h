...
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE_ACCEPTINVITATION_OFFSET UNITYSDK_OFFSET(0x19089CD0)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE_CANACCEPTINVITATION_OFFSET UNITYSDK_OFFSET(0x1908B2E0)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE_CANCELMATCH_OFFSET UNITYSDK_OFFSET(0x190897B0)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE_CANSHOWACTIVITYINVITATION_OFFSET UNITYSDK_OFFSET(0x1908B3A0)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE_CHECKCANENTERMPGAME_OFFSET UNITYSDK_OFFSET(0x1908AE60)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE_CHECKRECONNECTTOFIGHT_OFFSET UNITYSDK_OFFSET(0x19089E40)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE_CREATELOBBY_OFFSET UNITYSDK_OFFSET(0x190886D0)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1908A9C0)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE_INVITE_OFFSET UNITYSDK_OFFSET(0x19089C00)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE_JOINLOBBY_OFFSET UNITYSDK_OFFSET(0x19088ED0)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE_ONCREATEGAME_OFFSET UNITYSDK_OFFSET(0x1908AEF0)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE_ONFINISHGAME_OFFSET UNITYSDK_OFFSET(0x1908B060)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE_ONGENERALNOTIFY_OFFSET UNITYSDK_OFFSET(0x1908B290)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE_ONONGENERALRSP_OFFSET UNITYSDK_OFFSET(0x1908B240)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE_ONSERVERCONNECTED_OFFSET UNITYSDK_OFFSET(0x1908B180)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE_ONSERVERCONNECTFAIL_OFFSET UNITYSDK_OFFSET(0x1908B1C0)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE_ONSERVERDISCONNECTED_OFFSET UNITYSDK_OFFSET(0x1908B200)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE_ONSTATECHANGED_OFFSET UNITYSDK_OFFSET(0x1908AEA0)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE_REMINDPREPARE_OFFSET UNITYSDK_OFFSET(0x19089880)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE_STARTMATCH_OFFSET UNITYSDK_OFFSET(0x19089670)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE_TRYGIVEUP_OFFSET UNITYSDK_OFFSET(0x19089DF0)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE_TRYQUITLOBBY_OFFSET UNITYSDK_OFFSET(0x19089580)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE_TRYRECONNECTTOFIGHT_OFFSET UNITYSDK_OFFSET(0x1908A330)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE__CHECKRECONNECTTOFIGHT_B__10_0_OFFSET UNITYSDK_OFFSET(0x1908B640)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x190885D0)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE__INIT_OFFSET UNITYSDK_OFFSET(0x1908A730)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE__ONMPSESSIONSTATECHANGED_OFFSET UNITYSDK_OFFSET(0x1908B460)

namespace RPG::Client::Multiplayer
{
	inline static constexpr unsigned int BaseMPGameService_TypeDefinitionIndex = 75383;
