...
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE_ACCEPTINVITATION_OFFSET UNITYSDK_OFFSET(0xD8E02C0)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE_CANACCEPTINVITATION_OFFSET UNITYSDK_OFFSET(0xD8E18D0)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE_CANCELMATCH_OFFSET UNITYSDK_OFFSET(0xD8DFD30)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE_CANSHOWACTIVITYINVITATION_OFFSET UNITYSDK_OFFSET(0xD8E1990)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE_CHECKCANENTERMPGAME_OFFSET UNITYSDK_OFFSET(0xD8E1450)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE_CHECKRECONNECTTOFIGHT_OFFSET UNITYSDK_OFFSET(0xD8E0430)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE_CREATELOBBY_OFFSET UNITYSDK_OFFSET(0xD8DEC50)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD8E0FB0)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE_INVITE_OFFSET UNITYSDK_OFFSET(0xD8E01F0)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE_JOINLOBBY_OFFSET UNITYSDK_OFFSET(0xD8DF450)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE_ONCREATEGAME_OFFSET UNITYSDK_OFFSET(0xD8E14E0)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE_ONFINISHGAME_OFFSET UNITYSDK_OFFSET(0xD8E1650)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE_ONGENERALNOTIFY_OFFSET UNITYSDK_OFFSET(0xD8E1880)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE_ONONGENERALRSP_OFFSET UNITYSDK_OFFSET(0xD8E1830)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE_ONSERVERCONNECTED_OFFSET UNITYSDK_OFFSET(0xD8E1770)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE_ONSERVERCONNECTFAIL_OFFSET UNITYSDK_OFFSET(0xD8E17B0)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE_ONSERVERDISCONNECTED_OFFSET UNITYSDK_OFFSET(0xD8E17F0)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE_ONSTATECHANGED_OFFSET UNITYSDK_OFFSET(0xD8E1490)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE_REMINDPREPARE_OFFSET UNITYSDK_OFFSET(0xD8DFE00)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE_STARTMATCH_OFFSET UNITYSDK_OFFSET(0xD8DFBF0)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE_TRYGIVEUP_OFFSET UNITYSDK_OFFSET(0xD8E03E0)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE_TRYQUITLOBBY_OFFSET UNITYSDK_OFFSET(0xD8DFB00)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE_TRYRECONNECTTOFIGHT_OFFSET UNITYSDK_OFFSET(0xD8E0920)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE__CHECKRECONNECTTOFIGHT_B__10_0_OFFSET UNITYSDK_OFFSET(0xD8E1C30)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0xD8DEB50)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE__INIT_OFFSET UNITYSDK_OFFSET(0xD8E0D20)
#define RPG_CLIENT_MULTIPLAYER_BASEMPGAMESERVICE__ONMPSESSIONSTATECHANGED_OFFSET UNITYSDK_OFFSET(0xD8E1A50)

namespace RPG::Client::Multiplayer
{
	inline static constexpr unsigned int BaseMPGameService_TypeDefinitionIndex = 78931;

	class BaseMPGameService : public ::System::Object
	{
	public:
		::Class_1_6DBCB1EF77F6CF1A* _InviteService; // 0x10
