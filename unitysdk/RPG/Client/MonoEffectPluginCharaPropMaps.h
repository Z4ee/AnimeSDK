...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPMAPS_INIT_OFFSET UNITYSDK_OFFSET(0xC0C6BF0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPMAPS_UNINIT_OFFSET UNITYSDK_OFFSET(0xC0C6C90)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPMAPS_UPDATEPROPERTY_OFFSET UNITYSDK_OFFSET(0xC0C6D30)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPMAPS__CTOR_OFFSET UNITYSDK_OFFSET(0xC0C7100)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPMAPS___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0xC0C7120)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPMAPS___IFIXBASEPROXY_UNINIT_OFFSET UNITYSDK_OFFSET(0xC0C7130)
