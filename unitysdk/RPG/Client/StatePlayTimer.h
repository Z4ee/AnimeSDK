...
#define RPG_CLIENT_STATEPLAYTIMER_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0xA4DC230)
#define RPG_CLIENT_STATEPLAYTIMER_ONSTATEEXIT_OFFSET UNITYSDK_OFFSET(0xA4DC2E0)
#define RPG_CLIENT_STATEPLAYTIMER_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0xA4DC390)
#define RPG_CLIENT_STATEPLAYTIMER__CTOR_OFFSET UNITYSDK_OFFSET(0xA4DC4C0)
#define RPG_CLIENT_STATEPLAYTIMER___IFIXBASEPROXY_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0xA4DC4E0)
#define RPG_CLIENT_STATEPLAYTIMER___IFIXBASEPROXY_ONSTATEEXIT_OFFSET UNITYSDK_OFFSET(0xA4DC4F0)
#define RPG_CLIENT_STATEPLAYTIMER___IFIXBASEPROXY_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0xA4DC500)

namespace RPG::Client
{
	inline static constexpr unsigned int StatePlayTimer_TypeDefinitionIndex = 56236;
