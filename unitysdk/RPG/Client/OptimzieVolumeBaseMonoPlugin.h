...
#define RPG_CLIENT_OPTIMZIEVOLUMEBASEMONOPLUGIN_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x9EB7440)
#define RPG_CLIENT_OPTIMZIEVOLUMEBASEMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x9EB7490)
#define RPG_CLIENT_OPTIMZIEVOLUMEBASEMONOPLUGIN___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x9EB74B0)

namespace RPG::Client
{
	inline static constexpr unsigned int OptimzieVolumeBaseMonoPlugin_TypeDefinitionIndex = 58034;
