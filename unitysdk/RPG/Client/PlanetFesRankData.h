...
#define RPG_CLIENT_PLANETFESRANKDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x9FBDA10)
#define RPG_CLIENT_PLANETFESRANKDATA_GET_PERSONALRANK_OFFSET UNITYSDK_OFFSET(0x9FC5DF0)
#define RPG_CLIENT_PLANETFESRANKDATA_GET_SORTEDRANK_OFFSET UNITYSDK_OFFSET(0x9FC5DA0)
#define RPG_CLIENT_PLANETFESRANKDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9FC5D90)

namespace RPG::Client
{
	inline static constexpr unsigned int PlanetFesRankData_TypeDefinitionIndex = 54232;
