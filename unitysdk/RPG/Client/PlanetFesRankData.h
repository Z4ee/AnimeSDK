...
#define RPG_CLIENT_PLANETFESRANKDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xAD3C550)
#define RPG_CLIENT_PLANETFESRANKDATA_GET_PERSONALRANK_OFFSET UNITYSDK_OFFSET(0xAD3C610)
#define RPG_CLIENT_PLANETFESRANKDATA_GET_SORTEDRANK_OFFSET UNITYSDK_OFFSET(0xAD3C5C0)
#define RPG_CLIENT_PLANETFESRANKDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xAD3C5B0)

namespace RPG::Client
{
	inline static constexpr unsigned int PlanetFesRankData_TypeDefinitionIndex = 61395;
	...
	public:
		...
		static ::RPG::Client::PlanetFesRankData* Create(::RPG::Client::PlanetFesRankData_IServerAgent* agent)
		{
			return ((::RPG::Client::PlanetFesRankData*(*)(::RPG::Client::PlanetFesRankData_IServerAgent*))((::PBYTE)hIl2Cpp + RPG_CLIENT_PLANETFESRANKDATA_CREATE_OFFSET))(agent);
		}
