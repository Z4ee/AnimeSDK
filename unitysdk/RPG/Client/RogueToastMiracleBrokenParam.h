...
#define RPG_CLIENT_ROGUETOASTMIRACLEBROKENPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xB09AB90)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueToastMiracleBrokenParam_TypeDefinitionIndex = 61725;
