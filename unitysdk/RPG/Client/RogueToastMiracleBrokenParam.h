...
#define RPG_CLIENT_ROGUETOASTMIRACLEBROKENPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xA363FC0)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueToastMiracleBrokenParam_TypeDefinitionIndex = 54537;
