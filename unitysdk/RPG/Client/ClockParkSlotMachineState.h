...
#define RPG_CLIENT_CLOCKPARKSLOTMACHINESTATE_CONTINUEGACHA_OFFSET UNITYSDK_OFFSET(0x93FACB0)
#define RPG_CLIENT_CLOCKPARKSLOTMACHINESTATE_EXITGACHA_OFFSET UNITYSDK_OFFSET(0x93FAE00)
#define RPG_CLIENT_CLOCKPARKSLOTMACHINESTATE_GETBUFFEFFECTDATAITEMS_OFFSET UNITYSDK_OFFSET(0x93FA720)
#define RPG_CLIENT_CLOCKPARKSLOTMACHINESTATE_GETSORTEDLOTTERYLIST_OFFSET UNITYSDK_OFFSET(0x93FAF40)
#define RPG_CLIENT_CLOCKPARKSLOTMACHINESTATE_ISSHOWDICEPLACEMENT_OFFSET UNITYSDK_OFFSET(0x93FA6E0)
#define RPG_CLIENT_CLOCKPARKSLOTMACHINESTATE_SYNCGACHAINFO_OFFSET UNITYSDK_OFFSET(0x93F3970)
#define RPG_CLIENT_CLOCKPARKSLOTMACHINESTATE_SYNCLOTTERYID_OFFSET UNITYSDK_OFFSET(0x93F21B0)
#define RPG_CLIENT_CLOCKPARKSLOTMACHINESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x93F4970)
#define RPG_CLIENT_CLOCKPARKSLOTMACHINESTATE__ONENTER_OFFSET UNITYSDK_OFFSET(0x93FA090)
#define RPG_CLIENT_CLOCKPARKSLOTMACHINESTATE___IFIXBASEPROXY_ISSHOWDICEPLACEMENT_OFFSET UNITYSDK_OFFSET(0x93FAFF0)
#define RPG_CLIENT_CLOCKPARKSLOTMACHINESTATE___IFIXBASEPROXY__ONENTER_OFFSET UNITYSDK_OFFSET(0x93FAF80)

namespace RPG::Client
{
	inline static constexpr unsigned int ClockParkSlotMachineState_TypeDefinitionIndex = 49897;
	...
	public:
		...
		::System::Collections::Generic::List_1<::System::UInt32>* LotteryIDList; // 0x28
		::System::UInt32 GachaRemainTime; // 0x30
		::System::UInt32 ResultLotteryID; // 0x34
		::System::UInt32 GachaRandom; // 0x38
		::System::UInt32 GachaTotalCount; // 0x3C
