...
#define RPG_CLIENT_CHIMERADUELPVPTEAMSNAPSHOT_EXPORTBATTLESETUP_OFFSET UNITYSDK_OFFSET(0xB69E020)
#define RPG_CLIENT_CHIMERADUELPVPTEAMSNAPSHOT_GET_CHIMERAS_OFFSET UNITYSDK_OFFSET(0xB69DFE0)
#define RPG_CLIENT_CHIMERADUELPVPTEAMSNAPSHOT_GET_MASTERID_OFFSET UNITYSDK_OFFSET(0xB69E000)
#define RPG_CLIENT_CHIMERADUELPVPTEAMSNAPSHOT_SET_CHIMERAS_OFFSET UNITYSDK_OFFSET(0xB69DFF0)
#define RPG_CLIENT_CHIMERADUELPVPTEAMSNAPSHOT_SET_MASTERID_OFFSET UNITYSDK_OFFSET(0xB69E010)
#define RPG_CLIENT_CHIMERADUELPVPTEAMSNAPSHOT__CTOR_OFFSET UNITYSDK_OFFSET(0xB69D4C0)

namespace RPG::Client
{
	inline static constexpr unsigned int ChimeraDuelPvpTeamSnapshot_TypeDefinitionIndex = 59237;
	...
	public:
		...
		::System::Void _ctor(::Class_1_6FC4D75D938BC053_1* a1, ::RPG::GameCore::ChimeraDuelTeamType a2)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_6FC4D75D938BC053_1*, ::RPG::GameCore::ChimeraDuelTeamType))((::PBYTE)hIl2Cpp + RPG_CLIENT_CHIMERADUELPVPTEAMSNAPSHOT__CTOR_OFFSET))(this, a1, a2);
		}
