...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_CLASS_1_0875A0359D7C8064_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD78F610)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_CLASS_1_0875A0359D7C8064_METHOD_1_6E3C7DCF81428CB3_OFFSET UNITYSDK_OFFSET(0xD78F540)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_CLASS_1_0875A0359D7C8064_METHOD_1_935E29CBA8DD617B_OFFSET UNITYSDK_OFFSET(0xD78F3A0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_CLASS_1_0875A0359D7C8064__CTOR_OFFSET UNITYSDK_OFFSET(0xD78A960)
...
namespace RPG::Client
{
	...
	{
	public:
		::System::String* OAKGHGGKALA; // 0x10
		::Il2CppArray<::System::UInt32>* DMNJNFCPGHM; // 0x18
		::Il2CppArray<::UnityEngine::Material*>* CNMOOKIKPLF; // 0x20
		::RPG::GameCore::CharacterReplaceMaterialRender* DLHNEGPIONF; // 0x28
		::System::Collections::Generic::List_1<::UnityEngine::Material*>* HPLODFKEHED; // 0x30
		::UnityEngine::MaterialPropertyBlock* OBINDGFMHIH; // 0x38
