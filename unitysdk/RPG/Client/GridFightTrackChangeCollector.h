...
#define RPG_CLIENT_GRIDFIGHTTRACKCHANGECOLLECTOR_ONCOLLECTIONCHANGEDEVENTHANDLER_OFFSET UNITYSDK_OFFSET(0xBC1D590)
#define RPG_CLIENT_GRIDFIGHTTRACKCHANGECOLLECTOR_ONPROPERTYCHANGEDEVENTHANDLER_OFFSET UNITYSDK_OFFSET(0xBC1D530)
#define RPG_CLIENT_GRIDFIGHTTRACKCHANGECOLLECTOR_RESET_OFFSET UNITYSDK_OFFSET(0xBC1D4F0)
#define RPG_CLIENT_GRIDFIGHTTRACKCHANGECOLLECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0xBC1D5F0)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightTrackChangeCollector_TypeDefinitionIndex = 60353;
