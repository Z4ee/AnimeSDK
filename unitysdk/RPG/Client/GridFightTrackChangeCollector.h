...
#define RPG_CLIENT_GRIDFIGHTTRACKCHANGECOLLECTOR_ONCOLLECTIONCHANGEDEVENTHANDLER_OFFSET UNITYSDK_OFFSET(0x1A5F2360)
#define RPG_CLIENT_GRIDFIGHTTRACKCHANGECOLLECTOR_ONPROPERTYCHANGEDEVENTHANDLER_OFFSET UNITYSDK_OFFSET(0x1A5F2300)
#define RPG_CLIENT_GRIDFIGHTTRACKCHANGECOLLECTOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A5F22C0)
#define RPG_CLIENT_GRIDFIGHTTRACKCHANGECOLLECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5F23C0)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightTrackChangeCollector_TypeDefinitionIndex = 61644;
