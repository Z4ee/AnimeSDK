...
#define RPG_CLIENT_SHOTTEMPLATERUNTIME__CTOR_OFFSET UNITYSDK_OFFSET(0xB16B990)

namespace RPG::Client
{
	inline static constexpr unsigned int ShotTemplateRuntime_TypeDefinitionIndex = 64234;
