...
#define RPG_CLIENT_SHOTTEMPLATERUNTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x19F4B240)

namespace RPG::Client
{
	inline static constexpr unsigned int ShotTemplateRuntime_TypeDefinitionIndex = 66563;
