...
#define RPG_CLIENT_SHOTTEMPLATERUNTIME__CTOR_OFFSET UNITYSDK_OFFSET(0xC8C09C0)

namespace RPG::Client
{
	inline static constexpr unsigned int ShotTemplateRuntime_TypeDefinitionIndex = 65155;
