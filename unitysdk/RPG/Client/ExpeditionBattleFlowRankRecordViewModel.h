...
#define RPG_CLIENT_EXPEDITIONBATTLEFLOWRANKRECORDVIEWMODEL_GET_ISNEWRECORD_OFFSET UNITYSDK_OFFSET(0x1B88BAE0)
#define RPG_CLIENT_EXPEDITIONBATTLEFLOWRANKRECORDVIEWMODEL_GET_RANKVALUE_OFFSET UNITYSDK_OFFSET(0x1B88B430)
#define RPG_CLIENT_EXPEDITIONBATTLEFLOWRANKRECORDVIEWMODEL_GET_RANK_OFFSET UNITYSDK_OFFSET(0x1B88B3F0)
#define RPG_CLIENT_EXPEDITIONBATTLEFLOWRANKRECORDVIEWMODEL_GET_STARCNT_OFFSET UNITYSDK_OFFSET(0x1B88B410)
#define RPG_CLIENT_EXPEDITIONBATTLEFLOWRANKRECORDVIEWMODEL_SET_ISNEWRECORD_OFFSET UNITYSDK_OFFSET(0x1B88BAF0)
#define RPG_CLIENT_EXPEDITIONBATTLEFLOWRANKRECORDVIEWMODEL_SET_RANK_OFFSET UNITYSDK_OFFSET(0x1B88B400)
#define RPG_CLIENT_EXPEDITIONBATTLEFLOWRANKRECORDVIEWMODEL_SET_STARCNT_OFFSET UNITYSDK_OFFSET(0x1B88B420)
#define RPG_CLIENT_EXPEDITIONBATTLEFLOWRANKRECORDVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B88BB00)
