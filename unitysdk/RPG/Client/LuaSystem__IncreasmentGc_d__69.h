...
#define RPG_CLIENT_LUASYSTEM__INCREASMENTGC_D__69_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x15BF8CD0)
#define RPG_CLIENT_LUASYSTEM__INCREASMENTGC_D__69_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x15BF8E60)
#define RPG_CLIENT_LUASYSTEM__INCREASMENTGC_D__69_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x15BF8EC0)
#define RPG_CLIENT_LUASYSTEM__INCREASMENTGC_D__69_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x15BF8E70)
#define RPG_CLIENT_LUASYSTEM__INCREASMENTGC_D__69_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15BF8CC0)
#define RPG_CLIENT_LUASYSTEM__INCREASMENTGC_D__69__CTOR_OFFSET UNITYSDK_OFFSET(0x15BF6A50)

namespace RPG::Client
{
	inline static constexpr unsigned int LuaSystem__IncreasmentGc_d__69_TypeDefinitionIndex = 56781;
