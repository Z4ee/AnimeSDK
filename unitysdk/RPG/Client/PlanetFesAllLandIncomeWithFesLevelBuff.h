...
#define RPG_CLIENT_PLANETFESALLLANDINCOMEWITHFESLEVELBUFF_COMBINE_OFFSET UNITYSDK_OFFSET(0x9F7D9B0)
#define RPG_CLIENT_PLANETFESALLLANDINCOMEWITHFESLEVELBUFF_GETCOMBINEKEY_OFFSET UNITYSDK_OFFSET(0x9F7DAF0)
#define RPG_CLIENT_PLANETFESALLLANDINCOMEWITHFESLEVELBUFF_GET_PERCENTINCREASE_OFFSET UNITYSDK_OFFSET(0x9F7D7F0)
#define RPG_CLIENT_PLANETFESALLLANDINCOMEWITHFESLEVELBUFF_ISEFFECTIVEONAVATAR_OFFSET UNITYSDK_OFFSET(0x9F7D920)
#define RPG_CLIENT_PLANETFESALLLANDINCOMEWITHFESLEVELBUFF_ISTRIGGERED_OFFSET UNITYSDK_OFFSET(0x9F7D970)
#define RPG_CLIENT_PLANETFESALLLANDINCOMEWITHFESLEVELBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x9F7DB50)
#define RPG_CLIENT_PLANETFESALLLANDINCOMEWITHFESLEVELBUFF__ONINITPARAM_OFFSET UNITYSDK_OFFSET(0x9F7D8B0)

namespace RPG::Client
{
	inline static constexpr unsigned int PlanetFesAllLandIncomeWithFesLevelBuff_TypeDefinitionIndex = 54132;
	...
	public:
		...
		{
			return ((::Class_0_16E4307DCC419505_670*(*)(::PVOID, ::RPG::Client::IPlanetFesBuff*))((::PBYTE)hIl2Cpp + RPG_CLIENT_PLANETFESALLLANDINCOMEWITHFESLEVELBUFF_COMBINE_OFFSET))(this, other);
		}
