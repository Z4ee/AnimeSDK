...
#define RPG_CLIENT_STAGEHARMONYPLAYERPOSSIGNALMONOPLUGIN_DUMP_OFFSET UNITYSDK_OFFSET(0x1A4E1430)
#define RPG_CLIENT_STAGEHARMONYPLAYERPOSSIGNALMONOPLUGIN_LOAD_OFFSET UNITYSDK_OFFSET(0x1A4E11C0)
#define RPG_CLIENT_STAGEHARMONYPLAYERPOSSIGNALMONOPLUGIN_UNLOAD_OFFSET UNITYSDK_OFFSET(0x1A4E13E0)
#define RPG_CLIENT_STAGEHARMONYPLAYERPOSSIGNALMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4E19D0)
