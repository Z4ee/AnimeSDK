...
#define RPG_CLIENT_MONOMAPPOSESWITCHER_FILLENTITYINFO_1_OFFSET UNITYSDK_OFFSET(0x1ACF5380)
#define RPG_CLIENT_MONOMAPPOSESWITCHER_FILLENTITYINFO_OFFSET UNITYSDK_OFFSET(0x1ACF52B0)
#define RPG_CLIENT_MONOMAPPOSESWITCHER_GET_COLLIDER_OFFSET UNITYSDK_OFFSET(0x1ACF54B0)
#define RPG_CLIENT_MONOMAPPOSESWITCHER_GET_ENTITY_OFFSET UNITYSDK_OFFSET(0x1ACF5490)
#define RPG_CLIENT_MONOMAPPOSESWITCHER_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x1ACF5430)
#define RPG_CLIENT_MONOMAPPOSESWITCHER_GET_ISDYNAMICCREATED_OFFSET UNITYSDK_OFFSET(0x1ACF5470)
#define RPG_CLIENT_MONOMAPPOSESWITCHER_GET_PROPID_OFFSET UNITYSDK_OFFSET(0x1ACF5450)
#define RPG_CLIENT_MONOMAPPOSESWITCHER_SET_COLLIDER_OFFSET UNITYSDK_OFFSET(0x1ACF54C0)
#define RPG_CLIENT_MONOMAPPOSESWITCHER_SET_ENTITY_OFFSET UNITYSDK_OFFSET(0x1ACF54A0)
#define RPG_CLIENT_MONOMAPPOSESWITCHER_SET_GROUPID_OFFSET UNITYSDK_OFFSET(0x1ACF5440)
#define RPG_CLIENT_MONOMAPPOSESWITCHER_SET_ISDYNAMICCREATED_OFFSET UNITYSDK_OFFSET(0x1ACF5480)
#define RPG_CLIENT_MONOMAPPOSESWITCHER_SET_PROPID_OFFSET UNITYSDK_OFFSET(0x1ACF5460)
#define RPG_CLIENT_MONOMAPPOSESWITCHER__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACF54D0)
