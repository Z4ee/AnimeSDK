...
#define RPG_CLIENT_IRI_DEFERREDDECALBEHAVIOR_GET_DECALCOUNT_OFFSET UNITYSDK_OFFSET(0xD3E9210)
#define RPG_CLIENT_IRI_DEFERREDDECALBEHAVIOR_GET_ISDRAWMESHFALLBACK_OFFSET UNITYSDK_OFFSET(0xD3E63E0)
#define RPG_CLIENT_IRI_DEFERREDDECALBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0xD3E7100)
#define RPG_CLIENT_IRI_DEFERREDDECALBEHAVIOR_LATETICK_OFFSET UNITYSDK_OFFSET(0xD3E8D30)
#define RPG_CLIENT_IRI_DEFERREDDECALBEHAVIOR_METHOD_3_07280B24DFAC0CA9_OFFSET UNITYSDK_OFFSET(0xD3E7C00)
#define RPG_CLIENT_IRI_DEFERREDDECALBEHAVIOR_METHOD_3_0FFCA426B159D768_OFFSET UNITYSDK_OFFSET(0xD3E8DC0)
#define RPG_CLIENT_IRI_DEFERREDDECALBEHAVIOR_METHOD_3_13F0FEDB1C58AAEC_OFFSET UNITYSDK_OFFSET(0xD3E9310)
#define RPG_CLIENT_IRI_DEFERREDDECALBEHAVIOR_METHOD_3_18982EFD3B740683_OFFSET UNITYSDK_OFFSET(0xD3E7180)
#define RPG_CLIENT_IRI_DEFERREDDECALBEHAVIOR_METHOD_3_3A599F23178B2776_OFFSET UNITYSDK_OFFSET(0xD3E72A0)
#define RPG_CLIENT_IRI_DEFERREDDECALBEHAVIOR_METHOD_3_4857357D5C1BFCE8_OFFSET UNITYSDK_OFFSET(0xD3E68A0)
#define RPG_CLIENT_IRI_DEFERREDDECALBEHAVIOR_METHOD_3_508D4DD02D3DB74E_OFFSET UNITYSDK_OFFSET(0xD3E6790)
#define RPG_CLIENT_IRI_DEFERREDDECALBEHAVIOR_METHOD_3_51F384253127E0E9_OFFSET UNITYSDK_OFFSET(0xD3E84C0)
#define RPG_CLIENT_IRI_DEFERREDDECALBEHAVIOR_METHOD_3_64501B5CB67A94C3_OFFSET UNITYSDK_OFFSET(0xD3E63F0)
#define RPG_CLIENT_IRI_DEFERREDDECALBEHAVIOR_METHOD_3_65F12295BB178ECD_OFFSET UNITYSDK_OFFSET(0xD3E8EB0)
#define RPG_CLIENT_IRI_DEFERREDDECALBEHAVIOR_METHOD_3_7244B72D2B0B3D10_OFFSET UNITYSDK_OFFSET(0xD3E89D0)
#define RPG_CLIENT_IRI_DEFERREDDECALBEHAVIOR_METHOD_3_7B0812E4869FD813_OFFSET UNITYSDK_OFFSET(0xD3E81E0)
#define RPG_CLIENT_IRI_DEFERREDDECALBEHAVIOR_METHOD_3_8D6ED0B57406E5F2_OFFSET UNITYSDK_OFFSET(0xD3E8670)
#define RPG_CLIENT_IRI_DEFERREDDECALBEHAVIOR_METHOD_3_AD4B11D621C34D70_OFFSET UNITYSDK_OFFSET(0xD3E93A0)
#define RPG_CLIENT_IRI_DEFERREDDECALBEHAVIOR_METHOD_3_C3010636D81EBE2B_OFFSET UNITYSDK_OFFSET(0xD3E8FE0)
#define RPG_CLIENT_IRI_DEFERREDDECALBEHAVIOR_METHOD_3_C3190F85BA6F80FA_OFFSET UNITYSDK_OFFSET(0xD3E9180)
#define RPG_CLIENT_IRI_DEFERREDDECALBEHAVIOR_METHOD_3_CCEB9A03EDF0676E_OFFSET UNITYSDK_OFFSET(0xD3E9FD0)
#define RPG_CLIENT_IRI_DEFERREDDECALBEHAVIOR_METHOD_3_D41A5580E18FF467_OFFSET UNITYSDK_OFFSET(0xD3E9270)
#define RPG_CLIENT_IRI_DEFERREDDECALBEHAVIOR_METHOD_3_E4EC0FD7A76783C9_OFFSET UNITYSDK_OFFSET(0xD3E86D0)
#define RPG_CLIENT_IRI_DEFERREDDECALBEHAVIOR_METHOD_3_E55199F4E71DB1AE_OFFSET UNITYSDK_OFFSET(0xD3E8950)
#define RPG_CLIENT_IRI_DEFERREDDECALBEHAVIOR_METHOD_3_E721CB93CA3C8A39_OFFSET UNITYSDK_OFFSET(0xD3E90B0)
#define RPG_CLIENT_IRI_DEFERREDDECALBEHAVIOR_METHOD_3_F5B4708E7805566C_OFFSET UNITYSDK_OFFSET(0xD3E6C90)
#define RPG_CLIENT_IRI_DEFERREDDECALBEHAVIOR_METHOD_3_F8BB2A21B4CA90D4_OFFSET UNITYSDK_OFFSET(0xD3E7680)
#define RPG_CLIENT_IRI_DEFERREDDECALBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0xD3E8CB0)
#define RPG_CLIENT_IRI_DEFERREDDECALBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0xD3EA480)
