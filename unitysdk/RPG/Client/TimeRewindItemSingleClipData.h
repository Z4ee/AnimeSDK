...
#define RPG_CLIENT_TIMEREWINDITEMSINGLECLIPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCA4B540)

namespace RPG::Client
{
	inline static constexpr unsigned int TimeRewindItemSingleClipData_TypeDefinitionIndex = 56861;
