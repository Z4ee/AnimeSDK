...
#define RPG_CLIENT_ACTIVITYHIPPLENUTILS_CALCULATEGRADETYPE_OFFSET UNITYSDK_OFFSET(0xC573F60)
#define RPG_CLIENT_ACTIVITYHIPPLENUTILS_CHECKPHASESTATVALUETARGETWITHCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0xC573DA0)
#define RPG_CLIENT_ACTIVITYHIPPLENUTILS_CHECKPHASEUNLOCKAUTOTRIAL_OFFSET UNITYSDK_OFFSET(0xC573C80)
#define RPG_CLIENT_ACTIVITYHIPPLENUTILS_CHECKREQUIRESTATGRADE_OFFSET UNITYSDK_OFFSET(0xC574090)
#define RPG_CLIENT_ACTIVITYHIPPLENUTILS_CHECKSTATGRADEUP_OFFSET UNITYSDK_OFFSET(0xC5733A0)
#define RPG_CLIENT_ACTIVITYHIPPLENUTILS_CHECKWORKDATAISOPTIONINCIDENT_OFFSET UNITYSDK_OFFSET(0xC5742F0)
#define RPG_CLIENT_ACTIVITYHIPPLENUTILS_FETCHMAXREQUIRETIMES_OFFSET UNITYSDK_OFFSET(0xC574000)
#define RPG_CLIENT_ACTIVITYHIPPLENUTILS_GETCYCLEGROWTHPHASETRIALNAMELIST_OFFSET UNITYSDK_OFFSET(0xC5749A0)
#define RPG_CLIENT_ACTIVITYHIPPLENUTILS_GETEVENTNAMEBYEMOTION_OFFSET UNITYSDK_OFFSET(0xC5752A0)
#define RPG_CLIENT_ACTIVITYHIPPLENUTILS_GETFIRSTSENTENCEDESC_OFFSET UNITYSDK_OFFSET(0xC573860)
#define RPG_CLIENT_ACTIVITYHIPPLENUTILS_GETGAMEGRADECONFIG_OFFSET UNITYSDK_OFFSET(0xC573610)
#define RPG_CLIENT_ACTIVITYHIPPLENUTILS_GETGAMEGRADETYPEINT_OFFSET UNITYSDK_OFFSET(0xC573670)
#define RPG_CLIENT_ACTIVITYHIPPLENUTILS_GETHIPPLENENTITY_OFFSET UNITYSDK_OFFSET(0xC573500)
#define RPG_CLIENT_ACTIVITYHIPPLENUTILS_GETHIPPLENGAMEENERGYTYPE_OFFSET UNITYSDK_OFFSET(0xC574160)
#define RPG_CLIENT_ACTIVITYHIPPLENUTILS_GETHIPPLENINTERACTTYPECOUNT_OFFSET UNITYSDK_OFFSET(0xC5734C0)
#define RPG_CLIENT_ACTIVITYHIPPLENUTILS_GETINTERACTCAMERANAME_OFFSET UNITYSDK_OFFSET(0xC573B30)
#define RPG_CLIENT_ACTIVITYHIPPLENUTILS_GETINTERACTCONFIG_OFFSET UNITYSDK_OFFSET(0xC573460)
#define RPG_CLIENT_ACTIVITYHIPPLENUTILS_GETINTERACTPLANEANCHORNAME_OFFSET UNITYSDK_OFFSET(0xC5739E0)
#define RPG_CLIENT_ACTIVITYHIPPLENUTILS_GETITEMDISPLAYDATAFROMGIFTLIST_OFFSET UNITYSDK_OFFSET(0xC575080)
#define RPG_CLIENT_ACTIVITYHIPPLENUTILS_GETNEWUNLOCKEDINTERACTPROPS_OFFSET UNITYSDK_OFFSET(0xC574500)
#define RPG_CLIENT_ACTIVITYHIPPLENUTILS_GETOUTFITTYPEINT_OFFSET UNITYSDK_OFFSET(0xC5736B0)
#define RPG_CLIENT_ACTIVITYHIPPLENUTILS_GETOVERRIDESORTINGORDER_OFFSET UNITYSDK_OFFSET(0xC574F20)
#define RPG_CLIENT_ACTIVITYHIPPLENUTILS_GETSENTENCEDATA_OFFSET UNITYSDK_OFFSET(0xC5737C0)
#define RPG_CLIENT_ACTIVITYHIPPLENUTILS_GETSENTENCEIDLIST_OFFSET UNITYSDK_OFFSET(0xC573750)
#define RPG_CLIENT_ACTIVITYHIPPLENUTILS_GETSTATCONFIG_OFFSET UNITYSDK_OFFSET(0xC5736F0)
#define RPG_CLIENT_ACTIVITYHIPPLENUTILS_GETSTATGRADETYPE_OFFSET UNITYSDK_OFFSET(0xC572FD0)
#define RPG_CLIENT_ACTIVITYHIPPLENUTILS_GETSTATTYPECOUNT_OFFSET UNITYSDK_OFFSET(0xC572F90)
#define RPG_CLIENT_ACTIVITYHIPPLENUTILS_GETWORKDATABEFORECURWORKDATA_OFFSET UNITYSDK_OFFSET(0xC5743A0)
#define RPG_CLIENT_ACTIVITYHIPPLENUTILS_ISMAINPAGEOPEND_OFFSET UNITYSDK_OFFSET(0xC570E70)
#define RPG_CLIENT_ACTIVITYHIPPLENUTILS_OPENHIPPLENMAINPAGE_OFFSET UNITYSDK_OFFSET(0xC572CF0)
#define RPG_CLIENT_ACTIVITYHIPPLENUTILS_SHOWLOADINGPAGE_OFFSET UNITYSDK_OFFSET(0xC5733F0)
#define RPG_CLIENT_ACTIVITYHIPPLENUTILS_SMOOTHEXITGAME_OFFSET UNITYSDK_OFFSET(0xC5753A0)
#define RPG_CLIENT_ACTIVITYHIPPLENUTILS_TRYGETTARGETENTITY_OFFSET UNITYSDK_OFFSET(0xC573EE0)
