...
#define RPG_CLIENT_GRIDFIGHTTRAITDAMAGESTATISTICINFO_GET_TRAITCONFIG_OFFSET UNITYSDK_OFFSET(0x1BB083A0)
#define RPG_CLIENT_GRIDFIGHTTRAITDAMAGESTATISTICINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB081A0)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::Void _ctor(::Class_1_23C1B7E6B450FFB8_5* a1, ::System::Double a2)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_23C1B7E6B450FFB8_5*, ::System::Double))((::PBYTE)hIl2Cpp + RPG_CLIENT_GRIDFIGHTTRAITDAMAGESTATISTICINFO__CTOR_OFFSET))(this, a1, a2);
		}
