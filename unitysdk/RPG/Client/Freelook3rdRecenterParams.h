...
#define RPG_CLIENT_FREELOOK3RDRECENTERPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x16D1C950)

namespace RPG::Client
{
	inline static constexpr unsigned int Freelook3rdRecenterParams_TypeDefinitionIndex = 66550;
