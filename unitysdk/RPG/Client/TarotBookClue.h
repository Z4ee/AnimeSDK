...
#define RPG_CLIENT_TAROTBOOKCLUE_CREATE_OFFSET UNITYSDK_OFFSET(0xC9D93B0)
#define RPG_CLIENT_TAROTBOOKCLUE_GETSDFFONTASSETPATH_OFFSET UNITYSDK_OFFSET(0xC9D94D0)
#define RPG_CLIENT_TAROTBOOKCLUE_GET_COUNT_OFFSET UNITYSDK_OFFSET(0xC9D9300)
#define RPG_CLIENT_TAROTBOOKCLUE_GET_ID_OFFSET UNITYSDK_OFFSET(0xC9D92E0)
#define RPG_CLIENT_TAROTBOOKCLUE_GET_NAME_OFFSET UNITYSDK_OFFSET(0xC9D9360)
#define RPG_CLIENT_TAROTBOOKCLUE_GET_STYLE_OFFSET UNITYSDK_OFFSET(0xC9D9390)
#define RPG_CLIENT_TAROTBOOKCLUE__CTOR_OFFSET UNITYSDK_OFFSET(0xC9D94C0)

namespace RPG::Client
{
	inline static constexpr unsigned int TarotBookClue_TypeDefinitionIndex = 63674;
