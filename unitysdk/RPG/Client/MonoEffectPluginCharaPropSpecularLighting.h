...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPSPECULARLIGHTING_ISNEEDLUTPROPERTY_OFFSET UNITYSDK_OFFSET(0x116BEE90)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPSPECULARLIGHTING_UPDATEPROPERTY_OFFSET UNITYSDK_OFFSET(0x116BEED0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPSPECULARLIGHTING__CTOR_OFFSET UNITYSDK_OFFSET(0x116BFE30)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginCharaPropSpecularLighting_TypeDefinitionIndex = 69945;
