...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPSPECULARLIGHTING_ISNEEDLUTPROPERTY_OFFSET UNITYSDK_OFFSET(0x9CBFB90)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPSPECULARLIGHTING_UPDATEPROPERTY_OFFSET UNITYSDK_OFFSET(0x9CBFBD0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPSPECULARLIGHTING__CTOR_OFFSET UNITYSDK_OFFSET(0x9CC0B20)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPSPECULARLIGHTING___IFIXBASEPROXY_ISNEEDLUTPROPERTY_OFFSET UNITYSDK_OFFSET(0x9CC0B40)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginCharaPropSpecularLighting_TypeDefinitionIndex = 57255;
