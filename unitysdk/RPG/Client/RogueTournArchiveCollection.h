...
#define RPG_CLIENT_ROGUETOURNARCHIVECOLLECTION_CLEARNAME_OFFSET UNITYSDK_OFFSET(0x1983DB80)
#define RPG_CLIENT_ROGUETOURNARCHIVECOLLECTION_DELETEUPDATE_OFFSET UNITYSDK_OFFSET(0x1983D5D0)
#define RPG_CLIENT_ROGUETOURNARCHIVECOLLECTION_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1983CEE0)
#define RPG_CLIENT_ROGUETOURNARCHIVECOLLECTION_GETARCHIVEDATALIST_OFFSET UNITYSDK_OFFSET(0x1983D730)
#define RPG_CLIENT_ROGUETOURNARCHIVECOLLECTION_GETARCHIVEDATA_OFFSET UNITYSDK_OFFSET(0x1983D6A0)
#define RPG_CLIENT_ROGUETOURNARCHIVECOLLECTION_GETSAVEDARCHIVEDATA_OFFSET UNITYSDK_OFFSET(0x1983D930)
#define RPG_CLIENT_ROGUETOURNARCHIVECOLLECTION_GET_MAXSLOT_OFFSET UNITYSDK_OFFSET(0x1983E080)
#define RPG_CLIENT_ROGUETOURNARCHIVECOLLECTION_HASANYARCHIVEDATA_OFFSET UNITYSDK_OFFSET(0x1983D8D0)
#define RPG_CLIENT_ROGUETOURNARCHIVECOLLECTION_INIT_OFFSET UNITYSDK_OFFSET(0x1983CDE0)
#define RPG_CLIENT_ROGUETOURNARCHIVECOLLECTION_RENAME_OFFSET UNITYSDK_OFFSET(0x1983DA40)
#define RPG_CLIENT_ROGUETOURNARCHIVECOLLECTION_SYNCALL_OFFSET UNITYSDK_OFFSET(0x1983D170)
#define RPG_CLIENT_ROGUETOURNARCHIVECOLLECTION_SYNCUPDATE_OFFSET UNITYSDK_OFFSET(0x1983D300)
#define RPG_CLIENT_ROGUETOURNARCHIVECOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1983CDD0)
#define RPG_CLIENT_ROGUETOURNARCHIVECOLLECTION__SYNCARCHIVELIST_OFFSET UNITYSDK_OFFSET(0x1983D230)
#define RPG_CLIENT_ROGUETOURNARCHIVECOLLECTION__SYNCARCHIVE_OFFSET UNITYSDK_OFFSET(0x1983D420)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueTournArchiveCollection_TypeDefinitionIndex = 64494;
