...
#define RPG_CLIENT_PHONECASEDATAMANAGER_ADDUNLOCKED_OFFSET UNITYSDK_OFFSET(0x9F348D0)
#define RPG_CLIENT_PHONECASEDATAMANAGER_CLEAR_OFFSET UNITYSDK_OFFSET(0x9F39050)
#define RPG_CLIENT_PHONECASEDATAMANAGER_GETCURRENTEQUIPPEDPHONECASEDATA_OFFSET UNITYSDK_OFFSET(0x9F35620)
#define RPG_CLIENT_PHONECASEDATAMANAGER_GETDISPLAYPHONECASELIST_OFFSET UNITYSDK_OFFSET(0x9F390D0)
#define RPG_CLIENT_PHONECASEDATAMANAGER_GETPHONECASEDATA_OFFSET UNITYSDK_OFFSET(0x9F394A0)
#define RPG_CLIENT_PHONECASEDATAMANAGER_GET_CURRENTID_OFFSET UNITYSDK_OFFSET(0x9F38D30)
#define RPG_CLIENT_PHONECASEDATAMANAGER_GET_UNLOCKEDIDS_OFFSET UNITYSDK_OFFSET(0x9F394F0)
#define RPG_CLIENT_PHONECASEDATAMANAGER_GET__DEFAULTID_OFFSET UNITYSDK_OFFSET(0x9F393C0)
#define RPG_CLIENT_PHONECASEDATAMANAGER_ISDEFAULTID_OFFSET UNITYSDK_OFFSET(0x9F39360)
#define RPG_CLIENT_PHONECASEDATAMANAGER_ISPHONECASEUNLOCKED_OFFSET UNITYSDK_OFFSET(0x9F387B0)
#define RPG_CLIENT_PHONECASEDATAMANAGER_REGISTERPHONECASECHANGELISTENER_OFFSET UNITYSDK_OFFSET(0x9F39510)
#define RPG_CLIENT_PHONECASEDATAMANAGER_REMOVEPHONECASECHANGELISTENER_OFFSET UNITYSDK_OFFSET(0x9F395C0)
#define RPG_CLIENT_PHONECASEDATAMANAGER_SETCURRENTEQUIPPEDID_OFFSET UNITYSDK_OFFSET(0x9F346C0)
#define RPG_CLIENT_PHONECASEDATAMANAGER_SET_UNLOCKEDIDS_OFFSET UNITYSDK_OFFSET(0x9F39500)
#define RPG_CLIENT_PHONECASEDATAMANAGER_SYNCUNLOCKED_OFFSET UNITYSDK_OFFSET(0x9F342F0)
#define RPG_CLIENT_PHONECASEDATAMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x9F35080)
#define RPG_CLIENT_PHONECASEDATAMANAGER__TRIGGERCREATEPHONETASKRESET_OFFSET UNITYSDK_OFFSET(0x9F38F30)

namespace RPG::Client
{
	inline static constexpr unsigned int PhoneCaseDataManager_TypeDefinitionIndex = 54045;
