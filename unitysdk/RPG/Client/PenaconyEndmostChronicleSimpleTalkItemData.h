...
#define RPG_CLIENT_PENACONYENDMOSTCHRONICLESIMPLETALKITEMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9F24E50)

namespace RPG::Client
{
	inline static constexpr unsigned int PenaconyEndmostChronicleSimpleTalkItemData_TypeDefinitionIndex = 53726;
