...
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_GETAUDIENCEMOODMAPCONFIGPATH_OFFSET UNITYSDK_OFFSET(0xC78F0E0)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_GET_ID_OFFSET UNITYSDK_OFFSET(0xC7927F0)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_GET_ISSTARTED_OFFSET UNITYSDK_OFFSET(0xC7927E0)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_GET_LAYOUTPATH_OFFSET UNITYSDK_OFFSET(0xC78C5F0)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_GET_MEMBERINFO_OFFSET UNITYSDK_OFFSET(0xC792810)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_GET_RENDERERENABLE_OFFSET UNITYSDK_OFFSET(0xC792850)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_GET_STANCEPATH_OFFSET UNITYSDK_OFFSET(0xC78C610)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_GET_VISIBLE_OFFSET UNITYSDK_OFFSET(0xC792830)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_LOADSAVEDSTATE_OFFSET UNITYSDK_OFFSET(0xC7925B0)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_METHOD_5_1A50841E1CAE02B1_OFFSET UNITYSDK_OFFSET(0xC78E590)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_METHOD_5_3E17618FA0E6F9B0_OFFSET UNITYSDK_OFFSET(0xC78E4C0)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_METHOD_5_3EC6749BD0DFCDFF_OFFSET UNITYSDK_OFFSET(0xC78C680)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_METHOD_5_3F20CF295C4129C4_OFFSET UNITYSDK_OFFSET(0xC791690)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_METHOD_5_422C87C2B59A6581_OFFSET UNITYSDK_OFFSET(0xC78C820)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_METHOD_5_583F22C05CEA8706_OFFSET UNITYSDK_OFFSET(0xC78ED20)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_METHOD_5_66DFBEC278B2197F_OFFSET UNITYSDK_OFFSET(0xC78E810)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_METHOD_5_6C17AD4DF6713163_OFFSET UNITYSDK_OFFSET(0xC78F220)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_METHOD_5_7C6115732D5E6CAB_OFFSET UNITYSDK_OFFSET(0xC78E600)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_METHOD_5_7F72D3046872B8AC_OFFSET UNITYSDK_OFFSET(0xC791870)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_METHOD_5_81BFB84A5077EF23_OFFSET UNITYSDK_OFFSET(0xC78EFA0)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_METHOD_5_9B97A1AD8285B007_OFFSET UNITYSDK_OFFSET(0xC791AE0)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_METHOD_5_C73CBB2E1F3BBA7B_OFFSET UNITYSDK_OFFSET(0xC792760)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_METHOD_5_E5557A57B589524B_OFFSET UNITYSDK_OFFSET(0xC78EB80)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_METHOD_5_FB8BD2D3A3A27E57_OFFSET UNITYSDK_OFFSET(0xC78EAD0)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_NOTIFYANIMGROUPCHANGED_OFFSET UNITYSDK_OFFSET(0xC792360)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC78C3D0)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_ONLAYOUTLOADED_OFFSET UNITYSDK_OFFSET(0xC78C630)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_ONSTANCELOADED_OFFSET UNITYSDK_OFFSET(0xC78C7D0)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_RESTART_OFFSET UNITYSDK_OFFSET(0xC791DC0)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_SAVESTATE_OFFSET UNITYSDK_OFFSET(0xC792560)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_SETRENDERERENABLE_OFFSET UNITYSDK_OFFSET(0xC7921C0)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_SET_ID_OFFSET UNITYSDK_OFFSET(0xC792800)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_SET_MEMBERINFO_OFFSET UNITYSDK_OFFSET(0xC792820)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_SET_VISIBLE_OFFSET UNITYSDK_OFFSET(0xC792840)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_STARTUP_OFFSET UNITYSDK_OFFSET(0xC791C70)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE_TICK_OFFSET UNITYSDK_OFFSET(0xC792030)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE__CCTOR_OFFSET UNITYSDK_OFFSET(0xC792870)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0xC792860)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(AudienceGroupInstance_TypeDefinitionIndex)->GetStaticField(0x5C480);
		}
