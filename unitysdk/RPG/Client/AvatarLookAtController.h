...
#define RPG_CLIENT_AVATARLOOKATCONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0x9DA2C60)
#define RPG_CLIENT_AVATARLOOKATCONTROLLER_GET_ISLOOKATENABLED_OFFSET UNITYSDK_OFFSET(0x9DA2E30)
#define RPG_CLIENT_AVATARLOOKATCONTROLLER_LOOKATTARGET_OFFSET UNITYSDK_OFFSET(0x9DA2130)
#define RPG_CLIENT_AVATARLOOKATCONTROLLER_MAPTARGETFORWARD_OFFSET UNITYSDK_OFFSET(0x9DA21D0)
#define RPG_CLIENT_AVATARLOOKATCONTROLLER_METHOD_5_2450CFC043E97F54_OFFSET UNITYSDK_OFFSET(0x9DA2CC0)
#define RPG_CLIENT_AVATARLOOKATCONTROLLER_METHOD_5_51BAC440AEEC47A9_OFFSET UNITYSDK_OFFSET(0x9DA2730)
#define RPG_CLIENT_AVATARLOOKATCONTROLLER_SETDISABLEWITHCAUSE_OFFSET UNITYSDK_OFFSET(0x9DA2BA0)
#define RPG_CLIENT_AVATARLOOKATCONTROLLER_SETUPCURVEBLENDER_OFFSET UNITYSDK_OFFSET(0x9DA2470)
#define RPG_CLIENT_AVATARLOOKATCONTROLLER_STOPLOOKAT_OFFSET UNITYSDK_OFFSET(0x9DA2090)
#define RPG_CLIENT_AVATARLOOKATCONTROLLER_UPDATELOOKATSOLVE_OFFSET UNITYSDK_OFFSET(0x9DA24E0)
#define RPG_CLIENT_AVATARLOOKATCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9DA2EC0)

namespace RPG::Client
{
	inline static constexpr unsigned int AvatarLookAtController_TypeDefinitionIndex = 63038;
