...
#define RPG_CLIENT_LOOKATIK_LOOKATCACHEDATA_COPYTO_OFFSET UNITYSDK_OFFSET(0xBE76070)
#define RPG_CLIENT_LOOKATIK_LOOKATCACHEDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0xBE76350)
#define RPG_CLIENT_LOOKATIK_LOOKATCACHEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBE6CC40)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::Single FadeInTime; // 0xAC
		::System::Single OverrideLookAtFadeInTime; // 0xB0
		::System::Single OverrideLookAtSpeed; // 0xB4
		::System::Single OverrideLookAtFadeOutTime; // 0xB8
		::UnityEngine::Vector3 PrevTracePos; // 0xBC
		::System::Single LeftRightFilterIntensity; // 0xC8
		::System::Single FadeOutTime; // 0xCC
		::System::Single LookAtToTargetSpeed; // 0xD0
		::System::Single Speed; // 0xD4
