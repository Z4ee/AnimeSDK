...
#define RPG_CLIENT_UILAYERCONTROLLER_LAYERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xA6966E0)

namespace RPG::Client
{
	inline static constexpr unsigned int UILayerController_LayerInfo_TypeDefinitionIndex = 59884;
