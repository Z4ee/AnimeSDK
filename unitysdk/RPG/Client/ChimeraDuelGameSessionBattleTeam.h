...
#define RPG_CLIENT_CHIMERADUELGAMESESSIONBATTLETEAM_CREATEAIENEMYTEAM_1_OFFSET UNITYSDK_OFFSET(0xCBC9F10)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONBATTLETEAM_CREATEAIENEMYTEAM_OFFSET UNITYSDK_OFFSET(0xCBD8320)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONBATTLETEAM_CREATEALLYTEAM_OFFSET UNITYSDK_OFFSET(0xCBC9A70)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONBATTLETEAM_GET_CHIMERAS_OFFSET UNITYSDK_OFFSET(0xCBD8980)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONBATTLETEAM_GET_HPREMAIN_OFFSET UNITYSDK_OFFSET(0xCBD8A80)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONBATTLETEAM_GET_MASTERID_OFFSET UNITYSDK_OFFSET(0xCBD89E0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONBATTLETEAM_GET_PLAYERICON_OFFSET UNITYSDK_OFFSET(0xCBD8A40)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONBATTLETEAM_GET_PLAYERNAME_OFFSET UNITYSDK_OFFSET(0xCBD8A20)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONBATTLETEAM_GET_RANKID_OFFSET UNITYSDK_OFFSET(0xCBD8A00)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONBATTLETEAM_GET_SUMMONQUEUE_OFFSET UNITYSDK_OFFSET(0xCBD89A0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONBATTLETEAM_GET_TEAMTYPE_OFFSET UNITYSDK_OFFSET(0xCBD89C0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONBATTLETEAM_GET_WINCOUNT_OFFSET UNITYSDK_OFFSET(0xCBD8A60)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONBATTLETEAM_SET_CHIMERAS_OFFSET UNITYSDK_OFFSET(0xCBD8990)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONBATTLETEAM_SET_HPREMAIN_OFFSET UNITYSDK_OFFSET(0xCBD8A90)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONBATTLETEAM_SET_MASTERID_OFFSET UNITYSDK_OFFSET(0xCBD89F0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONBATTLETEAM_SET_PLAYERICON_OFFSET UNITYSDK_OFFSET(0xCBD8A50)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONBATTLETEAM_SET_PLAYERNAME_OFFSET UNITYSDK_OFFSET(0xCBD8A30)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONBATTLETEAM_SET_RANKID_OFFSET UNITYSDK_OFFSET(0xCBD8A10)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONBATTLETEAM_SET_SUMMONQUEUE_OFFSET UNITYSDK_OFFSET(0xCBD89B0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONBATTLETEAM_SET_TEAMTYPE_OFFSET UNITYSDK_OFFSET(0xCBD89D0)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONBATTLETEAM_SET_WINCOUNT_OFFSET UNITYSDK_OFFSET(0xCBD8A70)
#define RPG_CLIENT_CHIMERADUELGAMESESSIONBATTLETEAM__CTOR_OFFSET UNITYSDK_OFFSET(0xCBD8AA0)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::String* RankIcon; // 0x30
		::System::Int32 _HPRemain_k__BackingField; // 0x38
		::System::UInt32 _RankID_k__BackingField; // 0x3C
		::System::UInt32 _MasterID_k__BackingField; // 0x40
		::System::Int32 _WinCount_k__BackingField; // 0x44
		::RPG::GameCore::ChimeraDuelTeamType _TeamType_k__BackingField; // 0x48
		::RPG::Client::TextID RankName; // 0x50
