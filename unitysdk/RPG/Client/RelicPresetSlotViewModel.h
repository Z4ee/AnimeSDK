...
#define RPG_CLIENT_RELICPRESETSLOTVIEWMODEL_GETEFFECTIVECOUNT_OFFSET UNITYSDK_OFFSET(0xDE37770)
#define RPG_CLIENT_RELICPRESETSLOTVIEWMODEL_GET_AVATARID_OFFSET UNITYSDK_OFFSET(0xDE37500)
#define RPG_CLIENT_RELICPRESETSLOTVIEWMODEL_GET_HITCOUNT_OFFSET UNITYSDK_OFFSET(0xDE37610)
#define RPG_CLIENT_RELICPRESETSLOTVIEWMODEL_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0xDE37520)
#define RPG_CLIENT_RELICPRESETSLOTVIEWMODEL_GET_RELICDATA_OFFSET UNITYSDK_OFFSET(0xDE375B0)
#define RPG_CLIENT_RELICPRESETSLOTVIEWMODEL_GET_SLOTTYPE_OFFSET UNITYSDK_OFFSET(0xDE37510)
#define RPG_CLIENT_RELICPRESETSLOTVIEWMODEL_UPDATERELICDATA_OFFSET UNITYSDK_OFFSET(0xDE378F0)
#define RPG_CLIENT_RELICPRESETSLOTVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xDE37730)
