...
#define RPG_CLIENT_RELICPRESETSLOTVIEWMODEL_GETEFFECTIVECOUNT_OFFSET UNITYSDK_OFFSET(0x1B677BF0)
#define RPG_CLIENT_RELICPRESETSLOTVIEWMODEL_GET_AVATARID_OFFSET UNITYSDK_OFFSET(0x1B677AB0)
#define RPG_CLIENT_RELICPRESETSLOTVIEWMODEL_GET_HITCOUNT_OFFSET UNITYSDK_OFFSET(0x1B677AD0)
#define RPG_CLIENT_RELICPRESETSLOTVIEWMODEL_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x1B676F10)
#define RPG_CLIENT_RELICPRESETSLOTVIEWMODEL_GET_RELICDATA_OFFSET UNITYSDK_OFFSET(0x1B671170)
#define RPG_CLIENT_RELICPRESETSLOTVIEWMODEL_GET_SLOTTYPE_OFFSET UNITYSDK_OFFSET(0x1B677AC0)
#define RPG_CLIENT_RELICPRESETSLOTVIEWMODEL_UPDATERELICDATA_OFFSET UNITYSDK_OFFSET(0x1B675060)
#define RPG_CLIENT_RELICPRESETSLOTVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B674D90)

namespace RPG::Client
{
	inline static constexpr unsigned int RelicPresetSlotViewModel_TypeDefinitionIndex = 66877;
