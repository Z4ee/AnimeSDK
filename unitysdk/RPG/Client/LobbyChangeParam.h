...
#define RPG_CLIENT_LOBBYCHANGEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x19ACA2B0)

namespace RPG::Client
{
	inline static constexpr unsigned int LobbyChangeParam_TypeDefinitionIndex = 62851;
