...
#define RPG_CLIENT_TREASUREDUNGEONMONSTERGRID_CANKILL_OFFSET UNITYSDK_OFFSET(0xE2A7EB0)
#define RPG_CLIENT_TREASUREDUNGEONMONSTERGRID_GET_ENEMYROW_OFFSET UNITYSDK_OFFSET(0xE2A7F20)
#define RPG_CLIENT_TREASUREDUNGEONMONSTERGRID_GET_ISELITE_OFFSET UNITYSDK_OFFSET(0xE2A7FF0)
#define RPG_CLIENT_TREASUREDUNGEONMONSTERGRID_GET_MONSTERSTAGEROW_OFFSET UNITYSDK_OFFSET(0xE2A8050)
#define RPG_CLIENT_TREASUREDUNGEONMONSTERGRID__CTOR_OFFSET UNITYSDK_OFFSET(0xE29B000)
