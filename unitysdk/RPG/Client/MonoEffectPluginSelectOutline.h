...
#define RPG_CLIENT_MONOEFFECTPLUGINSELECTOUTLINE_METHOD_8_A40475C44AA8CEAB_OFFSET UNITYSDK_OFFSET(0x19138AE0)
#define RPG_CLIENT_MONOEFFECTPLUGINSELECTOUTLINE_SETSTENCIL_OFFSET UNITYSDK_OFFSET(0x19138CE0)
#define RPG_CLIENT_MONOEFFECTPLUGINSELECTOUTLINE__CTOR_OFFSET UNITYSDK_OFFSET(0x19138DF0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginSelectOutline_TypeDefinitionIndex = 66879;
