...
#define RPG_CLIENT_MONOEFFECTPLUGINSELECTOUTLINE_METHOD_8_A40475C44AA8CEAB_OFFSET UNITYSDK_OFFSET(0xD7C7910)
#define RPG_CLIENT_MONOEFFECTPLUGINSELECTOUTLINE_SETSTENCIL_OFFSET UNITYSDK_OFFSET(0xD7C7B10)
#define RPG_CLIENT_MONOEFFECTPLUGINSELECTOUTLINE__CTOR_OFFSET UNITYSDK_OFFSET(0xD7C7C20)
