...
#define RPG_CLIENT_CHARACTERARTMODELEFFECTBEHAVIOR_SELFROTATOR_METHOD_2_18D9238B9C310BFF_OFFSET UNITYSDK_OFFSET(0x7C700)
#define RPG_CLIENT_CHARACTERARTMODELEFFECTBEHAVIOR_SELFROTATOR_METHOD_2_B1936CE4DA97AA45_1_OFFSET UNITYSDK_OFFSET(0x7C710)
#define RPG_CLIENT_CHARACTERARTMODELEFFECTBEHAVIOR_SELFROTATOR_METHOD_2_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x7C640)

namespace RPG::Client
{
	inline static constexpr unsigned int CharacterArtModelEffectBehavior_SelfRotator_TypeDefinitionIndex = 57511;
