...
#define RPG_CLIENT_MONOEFFECTPLUGINEFFECTSCANFIVEDIMADAPT_DISPOSEPLUGIN_OFFSET UNITYSDK_OFFSET(0x1B3870B0)
#define RPG_CLIENT_MONOEFFECTPLUGINEFFECTSCANFIVEDIMADAPT_RESETPLUGIN_OFFSET UNITYSDK_OFFSET(0x1B386EF0)
#define RPG_CLIENT_MONOEFFECTPLUGINEFFECTSCANFIVEDIMADAPT_TICK_OFFSET UNITYSDK_OFFSET(0x1B387010)
#define RPG_CLIENT_MONOEFFECTPLUGINEFFECTSCANFIVEDIMADAPT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B387100)
