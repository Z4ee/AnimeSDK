...
#define RPG_CLIENT_FATEEXPREWARDINFO_AREALLREWARDSCLAIMED_OFFSET UNITYSDK_OFFSET(0x196FDA30)
#define RPG_CLIENT_FATEEXPREWARDINFO_CALCLEVELANDREMAINDEREXPBYTOTALEXP_OFFSET UNITYSDK_OFFSET(0x196FC980)
#define RPG_CLIENT_FATEEXPREWARDINFO_DISPOSE_OFFSET UNITYSDK_OFFSET(0x196FD4D0)
#define RPG_CLIENT_FATEEXPREWARDINFO_GETEXPRATIO_OFFSET UNITYSDK_OFFSET(0x196FD870)
#define RPG_CLIENT_FATEEXPREWARDINFO_GETNEXTLEVELREQUIREDEXP_OFFSET UNITYSDK_OFFSET(0x196FD610)
#define RPG_CLIENT_FATEEXPREWARDINFO_GETREQUIREDEXPOFLEVEL_OFFSET UNITYSDK_OFFSET(0x196FD770)
#define RPG_CLIENT_FATEEXPREWARDINFO_GET_EXPREMAINDER_OFFSET UNITYSDK_OFFSET(0x196FE190)
#define RPG_CLIENT_FATEEXPREWARDINFO_GET_EXPTOTAL_OFFSET UNITYSDK_OFFSET(0x196FE150)
#define RPG_CLIENT_FATEEXPREWARDINFO_GET_LEVELDATALIST_OFFSET UNITYSDK_OFFSET(0x196FE1D0)
#define RPG_CLIENT_FATEEXPREWARDINFO_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x196FD5D0)
#define RPG_CLIENT_FATEEXPREWARDINFO_GET_MAXLEVELPOSSIBLE_OFFSET UNITYSDK_OFFSET(0x196FE210)
#define RPG_CLIENT_FATEEXPREWARDINFO_HASCLAIMABLEREWARD_OFFSET UNITYSDK_OFFSET(0x196EDA70)
#define RPG_CLIENT_FATEEXPREWARDINFO_HASPERMANENTCLAIMABLEREWARD_OFFSET UNITYSDK_OFFSET(0x196EDBE0)
#define RPG_CLIENT_FATEEXPREWARDINFO_INIT_OFFSET UNITYSDK_OFFSET(0x196FBC00)
#define RPG_CLIENT_FATEEXPREWARDINFO_ISCLAIMABLELIMITEDTIME_OFFSET UNITYSDK_OFFSET(0x196FDCF0)
#define RPG_CLIENT_FATEEXPREWARDINFO_ISCLAIMABLEPERMANENT_OFFSET UNITYSDK_OFFSET(0x196FDBF0)
#define RPG_CLIENT_FATEEXPREWARDINFO_ISLEVELMAXED_OFFSET UNITYSDK_OFFSET(0x196FD560)
#define RPG_CLIENT_FATEEXPREWARDINFO_SET_MAXLEVELPOSSIBLE_OFFSET UNITYSDK_OFFSET(0x196FE220)
#define RPG_CLIENT_FATEEXPREWARDINFO_SYNCUPDATE_OFFSET UNITYSDK_OFFSET(0x196FCBB0)
#define RPG_CLIENT_FATEEXPREWARDINFO_SYNC_OFFSET UNITYSDK_OFFSET(0x196FC050)
#define RPG_CLIENT_FATEEXPREWARDINFO__CHECKDATAITEMS_OFFSET UNITYSDK_OFFSET(0x196FDEA0)
#define RPG_CLIENT_FATEEXPREWARDINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x196FBBF0)

namespace RPG::Client
{
	inline static constexpr unsigned int FateExpRewardInfo_TypeDefinitionIndex = 61095;
	...
	public:
		...
		::System::Void Sync(::Class_1_5A55E8BED8FA46A4* a1)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_5A55E8BED8FA46A4*))((::PBYTE)hIl2Cpp + RPG_CLIENT_FATEEXPREWARDINFO_SYNC_OFFSET))(this, a1);
		}
