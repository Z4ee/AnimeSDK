...
#define RPG_CLIENT_TOGGLEBUTTON_TOGGLEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x178ACE60)

namespace RPG::Client
{
	inline static constexpr unsigned int ToggleButton_ToggleEvent_TypeDefinitionIndex = 69399;
