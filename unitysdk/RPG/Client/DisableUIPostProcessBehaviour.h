...
#define RPG_CLIENT_DISABLEUIPOSTPROCESSBEHAVIOUR_CHANGEUIRENDERQUEUE_OFFSET UNITYSDK_OFFSET(0x1A009160)
#define RPG_CLIENT_DISABLEUIPOSTPROCESSBEHAVIOUR_METHOD_5_4C088D38C1084C90_OFFSET UNITYSDK_OFFSET(0x1A009930)
#define RPG_CLIENT_DISABLEUIPOSTPROCESSBEHAVIOUR_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A009560)
#define RPG_CLIENT_DISABLEUIPOSTPROCESSBEHAVIOUR_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A009100)
#define RPG_CLIENT_DISABLEUIPOSTPROCESSBEHAVIOUR_REVERTUIRENDERQUEUE_OFFSET UNITYSDK_OFFSET(0x1A0095B0)
#define RPG_CLIENT_DISABLEUIPOSTPROCESSBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A009C10)

namespace RPG::Client
{
	inline static constexpr unsigned int DisableUIPostProcessBehaviour_TypeDefinitionIndex = 69454;
