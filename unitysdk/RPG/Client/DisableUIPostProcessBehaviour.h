...
#define RPG_CLIENT_DISABLEUIPOSTPROCESSBEHAVIOUR_CHANGEUIRENDERQUEUE_OFFSET UNITYSDK_OFFSET(0xCD7E210)
#define RPG_CLIENT_DISABLEUIPOSTPROCESSBEHAVIOUR_METHOD_5_4C088D38C1084C90_OFFSET UNITYSDK_OFFSET(0xCD7E9E0)
#define RPG_CLIENT_DISABLEUIPOSTPROCESSBEHAVIOUR_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xCD7E610)
#define RPG_CLIENT_DISABLEUIPOSTPROCESSBEHAVIOUR_ONENABLE_OFFSET UNITYSDK_OFFSET(0xCD7E1B0)
#define RPG_CLIENT_DISABLEUIPOSTPROCESSBEHAVIOUR_REVERTUIRENDERQUEUE_OFFSET UNITYSDK_OFFSET(0xCD7E660)
#define RPG_CLIENT_DISABLEUIPOSTPROCESSBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xCD7ECC0)

namespace RPG::Client
{
	inline static constexpr unsigned int DisableUIPostProcessBehaviour_TypeDefinitionIndex = 72681;
