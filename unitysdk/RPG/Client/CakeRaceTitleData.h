...
#define RPG_CLIENT_CAKERACETITLEDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xC9DBCF0)
#define RPG_CLIENT_CAKERACETITLEDATA_GET_BGCOLOR_OFFSET UNITYSDK_OFFSET(0xC9DBF90)
#define RPG_CLIENT_CAKERACETITLEDATA_GET_TITLEDESC_OFFSET UNITYSDK_OFFSET(0xC9DBED0)
#define RPG_CLIENT_CAKERACETITLEDATA_GET_TITLEID_OFFSET UNITYSDK_OFFSET(0xC9DC030)
#define RPG_CLIENT_CAKERACETITLEDATA_GET_TITLENAME_OFFSET UNITYSDK_OFFSET(0xC9DBE10)
#define RPG_CLIENT_CAKERACETITLEDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xC9DBDB0)
#define RPG_CLIENT_CAKERACETITLEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC9DBDA0)
