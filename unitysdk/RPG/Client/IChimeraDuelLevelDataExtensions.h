...
#define RPG_CLIENT_ICHIMERADUELLEVELDATAEXTENSIONS_TRYGETBATTLESKILLDATA_OFFSET UNITYSDK_OFFSET(0xD3DFB40)
#define RPG_CLIENT_ICHIMERADUELLEVELDATAEXTENSIONS_TRYGETSHOPSKILLDATA_OFFSET UNITYSDK_OFFSET(0xD3DF9F0)
#define RPG_CLIENT_ICHIMERADUELLEVELDATAEXTENSIONS_TRYGETSKILLDATAFORDISPLAY_OFFSET UNITYSDK_OFFSET(0xD3DFC90)
#define RPG_CLIENT_ICHIMERADUELLEVELDATAEXTENSIONS__TRYGETFIRSTSKILLDATA_OFFSET UNITYSDK_OFFSET(0xD3DF790)
