...
#define RPG_CLIENT_ICHIMERADUELLEVELDATAEXTENSIONS_TRYGETBATTLESKILLDATA_OFFSET UNITYSDK_OFFSET(0x1795C340)
#define RPG_CLIENT_ICHIMERADUELLEVELDATAEXTENSIONS_TRYGETSHOPSKILLDATA_OFFSET UNITYSDK_OFFSET(0x1795C1F0)
#define RPG_CLIENT_ICHIMERADUELLEVELDATAEXTENSIONS_TRYGETSKILLDATAFORDISPLAY_OFFSET UNITYSDK_OFFSET(0x1795C490)
#define RPG_CLIENT_ICHIMERADUELLEVELDATAEXTENSIONS__TRYGETFIRSTSKILLDATA_OFFSET UNITYSDK_OFFSET(0x1795BF90)

namespace RPG::Client
{
	inline static constexpr unsigned int IChimeraDuelLevelDataExtensions_TypeDefinitionIndex = 60555;
