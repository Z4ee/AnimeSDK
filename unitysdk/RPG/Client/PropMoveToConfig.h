...
#define RPG_CLIENT_PROPMOVETOCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16149A00)

namespace RPG::Client
{
	inline static constexpr unsigned int PropMoveToConfig_TypeDefinitionIndex = 65594;
