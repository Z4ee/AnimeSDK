...
#define RPG_CLIENT_PROPMOVETOCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17B48F60)

namespace RPG::Client
{
	inline static constexpr unsigned int PropMoveToConfig_TypeDefinitionIndex = 68610;
