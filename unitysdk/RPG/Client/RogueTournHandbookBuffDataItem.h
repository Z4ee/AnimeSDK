...
#define RPG_CLIENT_ROGUETOURNHANDBOOKBUFFDATAITEM_CREATE_OFFSET UNITYSDK_OFFSET(0xDF59EF0)
#define RPG_CLIENT_ROGUETOURNHANDBOOKBUFFDATAITEM_GET_BUFFTYPENAME_OFFSET UNITYSDK_OFFSET(0xDF5A180)
#define RPG_CLIENT_ROGUETOURNHANDBOOKBUFFDATAITEM_GET_BUFFTYPE_OFFSET UNITYSDK_OFFSET(0xDF5A130)
#define RPG_CLIENT_ROGUETOURNHANDBOOKBUFFDATAITEM_GET_CATEGORY_OFFSET UNITYSDK_OFFSET(0xDF5A0E0)
#define RPG_CLIENT_ROGUETOURNHANDBOOKBUFFDATAITEM_GET_DESCPARAMSUPGRADED_OFFSET UNITYSDK_OFFSET(0xDF5A4E0)
#define RPG_CLIENT_ROGUETOURNHANDBOOKBUFFDATAITEM_GET_DESCPARAMS_OFFSET UNITYSDK_OFFSET(0xDF5A340)
#define RPG_CLIENT_ROGUETOURNHANDBOOKBUFFDATAITEM_GET_DESCUPGRADED_OFFSET UNITYSDK_OFFSET(0xDF5A460)
#define RPG_CLIENT_ROGUETOURNHANDBOOKBUFFDATAITEM_GET_DESC_OFFSET UNITYSDK_OFFSET(0xDF5A200)
#define RPG_CLIENT_ROGUETOURNHANDBOOKBUFFDATAITEM_GET_EXTRAEFFECTIDSUPGRADED_OFFSET UNITYSDK_OFFSET(0xDF5A540)
#define RPG_CLIENT_ROGUETOURNHANDBOOKBUFFDATAITEM_GET_EXTRAEFFECTIDS_OFFSET UNITYSDK_OFFSET(0xDF5A3A0)
#define RPG_CLIENT_ROGUETOURNHANDBOOKBUFFDATAITEM_GET_ICON_OFFSET UNITYSDK_OFFSET(0xDF5A080)
#define RPG_CLIENT_ROGUETOURNHANDBOOKBUFFDATAITEM_GET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0xDF5A5A0)
#define RPG_CLIENT_ROGUETOURNHANDBOOKBUFFDATAITEM_GET_ISUPGRADABLE_OFFSET UNITYSDK_OFFSET(0xDF5A400)
#define RPG_CLIENT_ROGUETOURNHANDBOOKBUFFDATAITEM_GET_LOCKEDDESC_OFFSET UNITYSDK_OFFSET(0xDF5A280)
#define RPG_CLIENT_ROGUETOURNHANDBOOKBUFFDATAITEM_GET_MAZEBUFFID_OFFSET UNITYSDK_OFFSET(0xDF59FB0)
#define RPG_CLIENT_ROGUETOURNHANDBOOKBUFFDATAITEM_GET_NAME_OFFSET UNITYSDK_OFFSET(0xDF5A000)
#define RPG_CLIENT_ROGUETOURNHANDBOOKBUFFDATAITEM_SET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0xDF5A5B0)
#define RPG_CLIENT_ROGUETOURNHANDBOOKBUFFDATAITEM_SYNCUNLOCKED_OFFSET UNITYSDK_OFFSET(0xDF59F60)
#define RPG_CLIENT_ROGUETOURNHANDBOOKBUFFDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xDF59E10)
...
namespace RPG::Client
{
	...
	public:
		...
		::RPG::GameCore::RogueTournBuffTypeRow* _TournBuffTypeRow; // 0x20
		::RPG::GameCore::MazeBuffRow* _MazeBuffRow; // 0x28
		::RPG::GameCore::RogueTournBuffRow* _TournBuffRow; // 0x30
