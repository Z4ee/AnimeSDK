...
#define RPG_CLIENT_PLANETFESAVATARSTOPMOVE_METHOD_3_6035F9FC37D8AFB8_OFFSET UNITYSDK_OFFSET(0x193BBC60)
#define RPG_CLIENT_PLANETFESAVATARSTOPMOVE_METHOD_3_A6A075FD2AF56C11_OFFSET UNITYSDK_OFFSET(0x193BBBE0)
#define RPG_CLIENT_PLANETFESAVATARSTOPMOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x193BBC30)

namespace RPG::Client
{
	inline static constexpr unsigned int PlanetFesAvatarStopMove_TypeDefinitionIndex = 9954;
