...
#define RPG_CLIENT_PLANETFESAVATARSTOPMOVE_METHOD_3_6035F9FC37D8AFB8_OFFSET UNITYSDK_OFFSET(0x16E8B740)
#define RPG_CLIENT_PLANETFESAVATARSTOPMOVE_METHOD_3_A6A075FD2AF56C11_OFFSET UNITYSDK_OFFSET(0x16E8B6C0)
#define RPG_CLIENT_PLANETFESAVATARSTOPMOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x16E8B710)

namespace RPG::Client
{
	inline static constexpr unsigned int PlanetFesAvatarStopMove_TypeDefinitionIndex = 9978;
