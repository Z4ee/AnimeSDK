...
#define RPG_CLIENT_PLANETFESAVATARSTOPMOVE_METHOD_3_6035F9FC37D8AFB8_OFFSET UNITYSDK_OFFSET(0x1CD55980)
#define RPG_CLIENT_PLANETFESAVATARSTOPMOVE_METHOD_3_CA25C5BE506BEE5B_OFFSET UNITYSDK_OFFSET(0x1CD55940)
#define RPG_CLIENT_PLANETFESAVATARSTOPMOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD55970)

namespace RPG::Client
{
	inline static constexpr unsigned int PlanetFesAvatarStopMove_TypeDefinitionIndex = 10268;
