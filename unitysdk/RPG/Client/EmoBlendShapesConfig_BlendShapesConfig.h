...
#define RPG_CLIENT_EMOBLENDSHAPESCONFIG_BLENDSHAPESCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xB904410)

namespace RPG::Client
{
	inline static constexpr unsigned int EmoBlendShapesConfig_BlendShapesConfig_TypeDefinitionIndex = 56134;
