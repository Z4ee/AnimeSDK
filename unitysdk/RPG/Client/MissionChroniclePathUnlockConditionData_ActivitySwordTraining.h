...
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_ACTIVITYSWORDTRAINING_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1582E5A0)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_ACTIVITYSWORDTRAINING_EQUALS_OFFSET UNITYSDK_OFFSET(0x1582E4F0)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_ACTIVITYSWORDTRAINING_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1582E6D0)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_ACTIVITYSWORDTRAINING_GET_CONDITIONTEXT_OFFSET UNITYSDK_OFFSET(0x1582E720)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_ACTIVITYSWORDTRAINING__CTOR_OFFSET UNITYSDK_OFFSET(0x1582E4E0)

namespace RPG::Client
{
	inline static constexpr unsigned int MissionChroniclePathUnlockConditionData_ActivitySwordTraining_TypeDefinitionIndex = 63178;
