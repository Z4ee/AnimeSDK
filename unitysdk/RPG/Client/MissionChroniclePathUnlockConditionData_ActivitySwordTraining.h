...
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_ACTIVITYSWORDTRAINING_EQUALS_1_OFFSET UNITYSDK_OFFSET(0xD6D4ED0)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_ACTIVITYSWORDTRAINING_EQUALS_OFFSET UNITYSDK_OFFSET(0xD6D4E20)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_ACTIVITYSWORDTRAINING_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xD6D5000)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_ACTIVITYSWORDTRAINING_GET_CONDITIONTEXT_OFFSET UNITYSDK_OFFSET(0xD6D5050)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_ACTIVITYSWORDTRAINING__CTOR_OFFSET UNITYSDK_OFFSET(0xD6D4E10)
