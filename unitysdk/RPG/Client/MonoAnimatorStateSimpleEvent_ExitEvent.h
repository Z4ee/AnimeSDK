...
#define RPG_CLIENT_MONOANIMATORSTATESIMPLEEVENT_EXITEVENT_METHOD_2_23F4864AF47CFD90_OFFSET UNITYSDK_OFFSET(0x18075810)
#define RPG_CLIENT_MONOANIMATORSTATESIMPLEEVENT_EXITEVENT_METHOD_2_3CAD769FC088779C_OFFSET UNITYSDK_OFFSET(0x18075930)
#define RPG_CLIENT_MONOANIMATORSTATESIMPLEEVENT_EXITEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x18075AB0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoAnimatorStateSimpleEvent_ExitEvent_TypeDefinitionIndex = 65472;
