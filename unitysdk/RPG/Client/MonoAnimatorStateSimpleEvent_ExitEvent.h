...
#define RPG_CLIENT_MONOANIMATORSTATESIMPLEEVENT_EXITEVENT_METHOD_2_183DCE814B2CC19A_OFFSET UNITYSDK_OFFSET(0xA90E630)
#define RPG_CLIENT_MONOANIMATORSTATESIMPLEEVENT_EXITEVENT_METHOD_2_23F4864AF47CFD90_OFFSET UNITYSDK_OFFSET(0xA90E520)
#define RPG_CLIENT_MONOANIMATORSTATESIMPLEEVENT_EXITEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0xA90E730)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoAnimatorStateSimpleEvent_ExitEvent_TypeDefinitionIndex = 63184;
