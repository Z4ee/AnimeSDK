...
#define RPG_CLIENT_MONOEFFECTPLUGINFIVEDIMDESTRUCTIBLEPLAT_DISPOSEPLUGIN_OFFSET UNITYSDK_OFFSET(0xD7BC530)
#define RPG_CLIENT_MONOEFFECTPLUGINFIVEDIMDESTRUCTIBLEPLAT_RESETPLUGIN_OFFSET UNITYSDK_OFFSET(0xD7BBF40)
#define RPG_CLIENT_MONOEFFECTPLUGINFIVEDIMDESTRUCTIBLEPLAT__CTOR_OFFSET UNITYSDK_OFFSET(0xD7BC720)
