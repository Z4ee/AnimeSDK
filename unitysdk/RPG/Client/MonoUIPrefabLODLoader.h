...
#define RPG_CLIENT_MONOUIPREFABLODLOADER_ADD_ONLOADED_OFFSET UNITYSDK_OFFSET(0x1A365DC0)
#define RPG_CLIENT_MONOUIPREFABLODLOADER_ASYNCLOAD_OFFSET UNITYSDK_OFFSET(0x1A365A50)
#define RPG_CLIENT_MONOUIPREFABLODLOADER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A3658B0)
#define RPG_CLIENT_MONOUIPREFABLODLOADER_DESPAWNED_OFFSET UNITYSDK_OFFSET(0x1A365C20)
#define RPG_CLIENT_MONOUIPREFABLODLOADER_GET_ISLOADED_OFFSET UNITYSDK_OFFSET(0x1A365D50)
#define RPG_CLIENT_MONOUIPREFABLODLOADER_GET_PREFABINSTANCE_OFFSET UNITYSDK_OFFSET(0x1A365DB0)
#define RPG_CLIENT_MONOUIPREFABLODLOADER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A365B70)
#define RPG_CLIENT_MONOUIPREFABLODLOADER_REMOVE_ONLOADED_OFFSET UNITYSDK_OFFSET(0x1A365E20)
#define RPG_CLIENT_MONOUIPREFABLODLOADER_SPAWNED_OFFSET UNITYSDK_OFFSET(0x1A365BD0)
#define RPG_CLIENT_MONOUIPREFABLODLOADER__ASYNCLOAD_B__5_0_OFFSET UNITYSDK_OFFSET(0x1A365E90)
#define RPG_CLIENT_MONOUIPREFABLODLOADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A365E80)
#define RPG_CLIENT_MONOUIPREFABLODLOADER__GETPREFABPATH_OFFSET UNITYSDK_OFFSET(0x1A365CB0)
#define RPG_CLIENT_MONOUIPREFABLODLOADER__GETQUALITYBYGRAPHICSQUALITY_OFFSET UNITYSDK_OFFSET(0x1A3659F0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoUIPrefabLODLoader_TypeDefinitionIndex = 65906;
