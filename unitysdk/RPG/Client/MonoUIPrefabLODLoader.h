...
#define RPG_CLIENT_MONOUIPREFABLODLOADER_ADD_ONLOADED_OFFSET UNITYSDK_OFFSET(0x1C2980B0)
#define RPG_CLIENT_MONOUIPREFABLODLOADER_ASYNCLOAD_OFFSET UNITYSDK_OFFSET(0x1C297D40)
#define RPG_CLIENT_MONOUIPREFABLODLOADER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1C297BA0)
#define RPG_CLIENT_MONOUIPREFABLODLOADER_DESPAWNED_OFFSET UNITYSDK_OFFSET(0x1C297F10)
#define RPG_CLIENT_MONOUIPREFABLODLOADER_GET_ISLOADED_OFFSET UNITYSDK_OFFSET(0x1C298040)
#define RPG_CLIENT_MONOUIPREFABLODLOADER_GET_PREFABINSTANCE_OFFSET UNITYSDK_OFFSET(0x1C2980A0)
#define RPG_CLIENT_MONOUIPREFABLODLOADER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1C297E60)
#define RPG_CLIENT_MONOUIPREFABLODLOADER_REMOVE_ONLOADED_OFFSET UNITYSDK_OFFSET(0x1C298110)
#define RPG_CLIENT_MONOUIPREFABLODLOADER_SPAWNED_OFFSET UNITYSDK_OFFSET(0x1C297EC0)
#define RPG_CLIENT_MONOUIPREFABLODLOADER__ASYNCLOAD_B__5_0_OFFSET UNITYSDK_OFFSET(0x1C298180)
#define RPG_CLIENT_MONOUIPREFABLODLOADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C298170)
#define RPG_CLIENT_MONOUIPREFABLODLOADER__GETPREFABPATH_OFFSET UNITYSDK_OFFSET(0x1C297FA0)
#define RPG_CLIENT_MONOUIPREFABLODLOADER__GETQUALITYBYGRAPHICSQUALITY_OFFSET UNITYSDK_OFFSET(0x1C297CE0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoUIPrefabLODLoader_TypeDefinitionIndex = 68945;
