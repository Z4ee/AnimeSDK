...
#define RPG_CLIENT_MONOUIPREFABLODLOADER_ADD_ONLOADED_OFFSET UNITYSDK_OFFSET(0xD87D7C0)
#define RPG_CLIENT_MONOUIPREFABLODLOADER_ASYNCLOAD_OFFSET UNITYSDK_OFFSET(0xD87D450)
#define RPG_CLIENT_MONOUIPREFABLODLOADER_AWAKE_OFFSET UNITYSDK_OFFSET(0xD87D2B0)
#define RPG_CLIENT_MONOUIPREFABLODLOADER_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xD87D620)
#define RPG_CLIENT_MONOUIPREFABLODLOADER_GET_ISLOADED_OFFSET UNITYSDK_OFFSET(0xD87D750)
#define RPG_CLIENT_MONOUIPREFABLODLOADER_GET_PREFABINSTANCE_OFFSET UNITYSDK_OFFSET(0xD87D7B0)
#define RPG_CLIENT_MONOUIPREFABLODLOADER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xD87D570)
#define RPG_CLIENT_MONOUIPREFABLODLOADER_REMOVE_ONLOADED_OFFSET UNITYSDK_OFFSET(0xD87D820)
#define RPG_CLIENT_MONOUIPREFABLODLOADER_SPAWNED_OFFSET UNITYSDK_OFFSET(0xD87D5D0)
#define RPG_CLIENT_MONOUIPREFABLODLOADER__ASYNCLOAD_B__5_0_OFFSET UNITYSDK_OFFSET(0xD87D890)
#define RPG_CLIENT_MONOUIPREFABLODLOADER__CTOR_OFFSET UNITYSDK_OFFSET(0xD87D880)
#define RPG_CLIENT_MONOUIPREFABLODLOADER__GETPREFABPATH_OFFSET UNITYSDK_OFFSET(0xD87D6B0)
#define RPG_CLIENT_MONOUIPREFABLODLOADER__GETQUALITYBYGRAPHICSQUALITY_OFFSET UNITYSDK_OFFSET(0xD87D3F0)
