...
#define RPG_CLIENT_CHIMERATEAMWORKSETTLEDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1BBF3210)
#define RPG_CLIENT_CHIMERATEAMWORKSETTLEDATA_GETCHIMERAWORKSETTLEDATA_OFFSET UNITYSDK_OFFSET(0x1BBF3300)
#define RPG_CLIENT_CHIMERATEAMWORKSETTLEDATA_GETMAXDAMAGECHIMERAID_OFFSET UNITYSDK_OFFSET(0x1BBF34C0)
#define RPG_CLIENT_CHIMERATEAMWORKSETTLEDATA_GETMAXDAMAGENEWCHIMERAID_OFFSET UNITYSDK_OFFSET(0x1BBF3670)
#define RPG_CLIENT_CHIMERATEAMWORKSETTLEDATA_GETMAXKILLCHIMERAID_OFFSET UNITYSDK_OFFSET(0x1BBF3AA0)
#define RPG_CLIENT_CHIMERATEAMWORKSETTLEDATA_GETMINDAMAGECHIMERAID_OFFSET UNITYSDK_OFFSET(0x1BBF38F0)
#define RPG_CLIENT_CHIMERATEAMWORKSETTLEDATA_INIT_OFFSET UNITYSDK_OFFSET(0x1BBF2EA0)
#define RPG_CLIENT_CHIMERATEAMWORKSETTLEDATA_ISNEWJOINCHIMERAID_OFFSET UNITYSDK_OFFSET(0x1BBF3400)
#define RPG_CLIENT_CHIMERATEAMWORKSETTLEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBF3C60)

namespace RPG::Client
{
	inline static constexpr unsigned int ChimeraTeamWorkSettleData_TypeDefinitionIndex = 63516;

	class ChimeraTeamWorkSettleData : public ::System::Object
	{
	public:
		::System::Collections::Generic::List_1<::RPG::Client::ChimeraWorkSettleData*>* ChimeraWorkSettleDatas; // 0x10
		::System::Collections::Generic::List_1<::System::UInt32>* SurviveChimeras; // 0x18
		::System::Collections::Generic::List_1<::System::UInt32>* NewJoinChimeras; // 0x20
		::System::Collections::Generic::List_1<::System::UInt32>* DeadChimeras; // 0x28
