...
#define RPG_CLIENT_MONSTERDATA___GETMONSTERIDENUMERATORBYINFINITEWAVEID_D__20_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x9D85BC0)
#define RPG_CLIENT_MONSTERDATA___GETMONSTERIDENUMERATORBYINFINITEWAVEID_D__20_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_UINT32__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x9D85CF0)
#define RPG_CLIENT_MONSTERDATA___GETMONSTERIDENUMERATORBYINFINITEWAVEID_D__20_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x9D85D50)
#define RPG_CLIENT_MONSTERDATA___GETMONSTERIDENUMERATORBYINFINITEWAVEID_D__20_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x9D85D00)
#define RPG_CLIENT_MONSTERDATA___GETMONSTERIDENUMERATORBYINFINITEWAVEID_D__20_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9D85BB0)
#define RPG_CLIENT_MONSTERDATA___GETMONSTERIDENUMERATORBYINFINITEWAVEID_D__20__CTOR_OFFSET UNITYSDK_OFFSET(0x9D856D0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonsterData___GetMonsterIDEnumeratorByInfiniteWaveID_d__20_TypeDefinitionIndex = 51233;
