...
#define RPG_CLIENT_CHIMERAPHASEINFO_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19B06920)
#define RPG_CLIENT_CHIMERAPHASEINFO_GETCURRENTPHASEDATA_OFFSET UNITYSDK_OFFSET(0x19B07930)
#define RPG_CLIENT_CHIMERAPHASEINFO_GETPHASEDATABYROUNDID_OFFSET UNITYSDK_OFFSET(0x19B077D0)
#define RPG_CLIENT_CHIMERAPHASEINFO_GETPHASEDATA_OFFSET UNITYSDK_OFFSET(0x19B073A0)
#define RPG_CLIENT_CHIMERAPHASEINFO_GET_LASTPHASECOMPLETESTATUS_OFFSET UNITYSDK_OFFSET(0x19B07A50)
#define RPG_CLIENT_CHIMERAPHASEINFO_INIT_OFFSET UNITYSDK_OFFSET(0x19B06180)
#define RPG_CLIENT_CHIMERAPHASEINFO_SET_LASTPHASECOMPLETESTATUS_OFFSET UNITYSDK_OFFSET(0x19B07A60)
#define RPG_CLIENT_CHIMERAPHASEINFO_SYNCFINISHSTATUS_OFFSET UNITYSDK_OFFSET(0x19B02690)
#define RPG_CLIENT_CHIMERAPHASEINFO_SYNCPHASEID_OFFSET UNITYSDK_OFFSET(0x19B03A90)
#define RPG_CLIENT_CHIMERAPHASEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19B06170)

namespace RPG::Client
{
	inline static constexpr unsigned int ChimeraPhaseInfo_TypeDefinitionIndex = 60642;
	...
	public:
		...
		::System::UInt32 _CurrentPhaseID; // 0x18
		::RPG::Client::ChimeraLastPhaseCompleteStatus _LastPhaseCompleteStatus_k__BackingField; // 0x1C
