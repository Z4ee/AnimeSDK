...
#define RPG_CLIENT_MESSAGECONTENTGOTOBLOCK_GAMETOOLGOTOCOMMAND_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1B23A140)
#define RPG_CLIENT_MESSAGECONTENTGOTOBLOCK_GAMETOOLGOTOCOMMAND__CTOR_OFFSET UNITYSDK_OFFSET(0x1B239C50)
#define RPG_CLIENT_MESSAGECONTENTGOTOBLOCK_GAMETOOLGOTOCOMMAND__ISAVATARRELEASED_OFFSET UNITYSDK_OFFSET(0x1B23A410)
