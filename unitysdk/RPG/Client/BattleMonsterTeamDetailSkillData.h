...
#define RPG_CLIENT_BATTLEMONSTERTEAMDETAILSKILLDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x19F6DF10)
#define RPG_CLIENT_BATTLEMONSTERTEAMDETAILSKILLDATA_GET_EXTRAEFFECTDATAS_OFFSET UNITYSDK_OFFSET(0x19F6EF10)
#define RPG_CLIENT_BATTLEMONSTERTEAMDETAILSKILLDATA_GET_PHASEID_OFFSET UNITYSDK_OFFSET(0x19F6EED0)
#define RPG_CLIENT_BATTLEMONSTERTEAMDETAILSKILLDATA_GET_SKILLROWS_OFFSET UNITYSDK_OFFSET(0x19F6EEF0)
#define RPG_CLIENT_BATTLEMONSTERTEAMDETAILSKILLDATA_ONADDALLSKILLSEND_OFFSET UNITYSDK_OFFSET(0x19F6DB40)
#define RPG_CLIENT_BATTLEMONSTERTEAMDETAILSKILLDATA_SET_EXTRAEFFECTDATAS_OFFSET UNITYSDK_OFFSET(0x19F6EF20)
#define RPG_CLIENT_BATTLEMONSTERTEAMDETAILSKILLDATA_SET_PHASEID_OFFSET UNITYSDK_OFFSET(0x19F6EEE0)
#define RPG_CLIENT_BATTLEMONSTERTEAMDETAILSKILLDATA_SET_SKILLROWS_OFFSET UNITYSDK_OFFSET(0x19F6EF00)
#define RPG_CLIENT_BATTLEMONSTERTEAMDETAILSKILLDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19F6E4D0)
#define RPG_CLIENT_BATTLEMONSTERTEAMDETAILSKILLDATA__GETEXTRAEFFECTIDS_OFFSET UNITYSDK_OFFSET(0x19F6EBF0)
#define RPG_CLIENT_BATTLEMONSTERTEAMDETAILSKILLDATA__SORTSKILLS_OFFSET UNITYSDK_OFFSET(0x19F6E540)
#define RPG_CLIENT_BATTLEMONSTERTEAMDETAILSKILLDATA__UPDATEEXTRAEFFECTDATAS_OFFSET UNITYSDK_OFFSET(0x19F6E960)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleMonsterTeamDetailSkillData_TypeDefinitionIndex = 71970;

	class BattleMonsterTeamDetailSkillData : public ::System::Object
	{
	public:
		::System::Collections::Generic::List_1<::RPG::Client::BattleMonsterTeamDetailExtraEffectData*>* _ExtraEffectDatas_k__BackingField; // 0x10
		::System::Collections::Generic::List_1<::RPG::GameCore::MonsterSkillRowData*>* _SkillRows_k__BackingField; // 0x18
