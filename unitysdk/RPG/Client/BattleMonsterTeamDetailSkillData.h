...
#define RPG_CLIENT_BATTLEMONSTERTEAMDETAILSKILLDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x174BE0D0)
#define RPG_CLIENT_BATTLEMONSTERTEAMDETAILSKILLDATA_GET_EXTRAEFFECTDATAS_OFFSET UNITYSDK_OFFSET(0x174BF0C0)
#define RPG_CLIENT_BATTLEMONSTERTEAMDETAILSKILLDATA_GET_PHASEID_OFFSET UNITYSDK_OFFSET(0x174BF080)
#define RPG_CLIENT_BATTLEMONSTERTEAMDETAILSKILLDATA_GET_SKILLROWS_OFFSET UNITYSDK_OFFSET(0x174BF0A0)
#define RPG_CLIENT_BATTLEMONSTERTEAMDETAILSKILLDATA_ONADDALLSKILLSEND_OFFSET UNITYSDK_OFFSET(0x174BDD40)
#define RPG_CLIENT_BATTLEMONSTERTEAMDETAILSKILLDATA_SET_EXTRAEFFECTDATAS_OFFSET UNITYSDK_OFFSET(0x174BF0D0)
#define RPG_CLIENT_BATTLEMONSTERTEAMDETAILSKILLDATA_SET_PHASEID_OFFSET UNITYSDK_OFFSET(0x174BF090)
#define RPG_CLIENT_BATTLEMONSTERTEAMDETAILSKILLDATA_SET_SKILLROWS_OFFSET UNITYSDK_OFFSET(0x174BF0B0)
#define RPG_CLIENT_BATTLEMONSTERTEAMDETAILSKILLDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x174BE690)
#define RPG_CLIENT_BATTLEMONSTERTEAMDETAILSKILLDATA__GETEXTRAEFFECTIDS_OFFSET UNITYSDK_OFFSET(0x174BEDB0)
#define RPG_CLIENT_BATTLEMONSTERTEAMDETAILSKILLDATA__SORTSKILLS_OFFSET UNITYSDK_OFFSET(0x174BE700)
#define RPG_CLIENT_BATTLEMONSTERTEAMDETAILSKILLDATA__UPDATEEXTRAEFFECTDATAS_OFFSET UNITYSDK_OFFSET(0x174BEB20)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleMonsterTeamDetailSkillData_TypeDefinitionIndex = 68772;
