...
#define RPG_CLIENT_AETHERMONSTERAVATARDISPLAYDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x9CDBFE0)
#define RPG_CLIENT_AETHERMONSTERAVATARDISPLAYDATA_GET_GYMLOCATION_OFFSET UNITYSDK_OFFSET(0x9CDC3E0)
#define RPG_CLIENT_AETHERMONSTERAVATARDISPLAYDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0x9CDC090)
#define RPG_CLIENT_AETHERMONSTERAVATARDISPLAYDATA_GET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0x9CCC640)
#define RPG_CLIENT_AETHERMONSTERAVATARDISPLAYDATA_GET_RARITY_OFFSET UNITYSDK_OFFSET(0x9CDC270)
#define RPG_CLIENT_AETHERMONSTERAVATARDISPLAYDATA_GET_RELATEDSPIRITDATA_OFFSET UNITYSDK_OFFSET(0x9CDC110)
#define RPG_CLIENT_AETHERMONSTERAVATARDISPLAYDATA_GET_ROW_OFFSET UNITYSDK_OFFSET(0x9CDC2F0)
#define RPG_CLIENT_AETHERMONSTERAVATARDISPLAYDATA_GET_SPIRITTYPE_OFFSET UNITYSDK_OFFSET(0x9CDC360)
#define RPG_CLIENT_AETHERMONSTERAVATARDISPLAYDATA_GET_STATUS_OFFSET UNITYSDK_OFFSET(0x9CDC0B0)
#define RPG_CLIENT_AETHERMONSTERAVATARDISPLAYDATA_SET_ID_OFFSET UNITYSDK_OFFSET(0x9CDC0A0)
#define RPG_CLIENT_AETHERMONSTERAVATARDISPLAYDATA_UPDATESTATUS_OFFSET UNITYSDK_OFFSET(0x9CDC050)
#define RPG_CLIENT_AETHERMONSTERAVATARDISPLAYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9CDC040)

namespace RPG::Client
{
	inline static constexpr unsigned int AetherMonsterAvatarDisplayData_TypeDefinitionIndex = 57395;
