...
#define RPG_CLIENT_MUSICRHYTHMLEVELRESULT_CREATEFAKEDATA_OFFSET UNITYSDK_OFFSET(0x9DD37F0)
#define RPG_CLIENT_MUSICRHYTHMLEVELRESULT_GETLEVEL_OFFSET UNITYSDK_OFFSET(0x9DD3900)
#define RPG_CLIENT_MUSICRHYTHMLEVELRESULT_GETREWARDIDS_OFFSET UNITYSDK_OFFSET(0x9DD39A0)
#define RPG_CLIENT_MUSICRHYTHMLEVELRESULT_GET_COMBONUMS_OFFSET UNITYSDK_OFFSET(0x9DD3A20)
#define RPG_CLIENT_MUSICRHYTHMLEVELRESULT_GET_ISFIRSTPASS_OFFSET UNITYSDK_OFFSET(0x9DD3A30)
#define RPG_CLIENT_MUSICRHYTHMLEVELRESULT_GET_ISMAXDIFFICULTY_OFFSET UNITYSDK_OFFSET(0x9DD3A90)
#define RPG_CLIENT_MUSICRHYTHMLEVELRESULT_GET_LEVELID_OFFSET UNITYSDK_OFFSET(0x9DD3A00)
#define RPG_CLIENT_MUSICRHYTHMLEVELRESULT_GET_STARNUM_OFFSET UNITYSDK_OFFSET(0x9DD3A10)
#define RPG_CLIENT_MUSICRHYTHMLEVELRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x9DD3690)

namespace RPG::Client
{
	inline static constexpr unsigned int MusicRhythmLevelResult_TypeDefinitionIndex = 50176;
