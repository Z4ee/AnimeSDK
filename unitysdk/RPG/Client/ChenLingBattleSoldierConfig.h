...
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_GET_ATKSKILLIDLIST_OFFSET UNITYSDK_OFFSET(0xCB23410)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_GET_ID_OFFSET UNITYSDK_OFFSET(0xCB22FE0)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_GET_INITIALMAXLEVEL_OFFSET UNITYSDK_OFFSET(0xCB16AB0)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_GET_ISRANGEATTACK_OFFSET UNITYSDK_OFFSET(0xCB234B0)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_GET_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0xCB23350)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_GET_MODELPATH_OFFSET UNITYSDK_OFFSET(0xCB16760)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_GET_NAME_OFFSET UNITYSDK_OFFSET(0xCB18200)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_GET_POSITION_OFFSET UNITYSDK_OFFSET(0xCB23060)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_GET_PREPARESIZE_OFFSET UNITYSDK_OFFSET(0xCB23150)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_GET_PROMOTIONCONDITIONLIST_OFFSET UNITYSDK_OFFSET(0xCB17760)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_GET_PROMOTIONSKILLDESC_OFFSET UNITYSDK_OFFSET(0xCB23290)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_GET_SCALE_OFFSET UNITYSDK_OFFSET(0xCB23100)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_GET_SKILLDESC_OFFSET UNITYSDK_OFFSET(0xCB231D0)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_GET_SKILLIDLIST_OFFSET UNITYSDK_OFFSET(0xCB23370)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_GET_SMALLICONOUTLINEPATH_OFFSET UNITYSDK_OFFSET(0xCB16670)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_GET_SMALLICONPATH_OFFSET UNITYSDK_OFFSET(0xCB16580)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_GET__ROW_OFFSET UNITYSDK_OFFSET(0xCB23000)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_SET_ID_OFFSET UNITYSDK_OFFSET(0xCB22FF0)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_SET_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0xCB23360)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xCB22FC0)
