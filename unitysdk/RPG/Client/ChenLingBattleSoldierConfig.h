...
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_GET_ATKSKILLIDLIST_OFFSET UNITYSDK_OFFSET(0x934FE60)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_GET_ID_OFFSET UNITYSDK_OFFSET(0x934FB50)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_GET_INITIALMAXLEVEL_OFFSET UNITYSDK_OFFSET(0x93464F0)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_GET_ISRANGEATTACK_OFFSET UNITYSDK_OFFSET(0x934FED0)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_GET_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0x934FDD0)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_GET_MODELPATH_OFFSET UNITYSDK_OFFSET(0x9336EC0)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_GET_NAME_OFFSET UNITYSDK_OFFSET(0x9347320)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x934FBD0)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_GET_PREPARESIZE_OFFSET UNITYSDK_OFFSET(0x934FC50)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_GET_PROMOTIONCONDITIONLIST_OFFSET UNITYSDK_OFFSET(0x9346D40)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_GET_PROMOTIONSKILLDESC_OFFSET UNITYSDK_OFFSET(0x934FD50)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_GET_SCALE_OFFSET UNITYSDK_OFFSET(0x934FC40)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_GET_SKILLDESC_OFFSET UNITYSDK_OFFSET(0x934FCD0)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_GET_SKILLIDLIST_OFFSET UNITYSDK_OFFSET(0x934FDF0)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_GET_SMALLICONOUTLINEPATH_OFFSET UNITYSDK_OFFSET(0x93462B0)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_GET_SMALLICONPATH_OFFSET UNITYSDK_OFFSET(0x93461C0)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_GET__ROW_OFFSET UNITYSDK_OFFSET(0x934FB70)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_SET_ID_OFFSET UNITYSDK_OFFSET(0x934FB60)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG_SET_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0x934FDE0)
#define RPG_CLIENT_CHENLINGBATTLESOLDIERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x934FB30)

namespace RPG::Client
{
	inline static constexpr unsigned int ChenLingBattleSoldierConfig_TypeDefinitionIndex = 49853;
