...
#define RPG_CLIENT_MUSEUMPROPERTYDATA_CLEARALLDATA_OFFSET UNITYSDK_OFFSET(0xAB0C960)
#define RPG_CLIENT_MUSEUMPROPERTYDATA_CLEARPREVIEWDATA_OFFSET UNITYSDK_OFFSET(0xAB0C900)
#define RPG_CLIENT_MUSEUMPROPERTYDATA_COPYTO_OFFSET UNITYSDK_OFFSET(0xAB0C9C0)
#define RPG_CLIENT_MUSEUMPROPERTYDATA_GET_CANUPDATE_OFFSET UNITYSDK_OFFSET(0xAB0C8F0)
#define RPG_CLIENT_MUSEUMPROPERTYDATA_GET_PREVIEWCURNUM_OFFSET UNITYSDK_OFFSET(0xAB0C830)
#define RPG_CLIENT_MUSEUMPROPERTYDATA_GET_PREVIEWMAXNUM_OFFSET UNITYSDK_OFFSET(0xAB0C890)
#define RPG_CLIENT_MUSEUMPROPERTYDATA_ISMAX_OFFSET UNITYSDK_OFFSET(0xAB0BAE0)
#define RPG_CLIENT_MUSEUMPROPERTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xAB0CA40)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::UInt32 UpdateCost; // 0x18
		::System::UInt32 AddMaxNum; // 0x1C
		::System::UInt32 MaxLevel; // 0x20
		::System::Boolean IsAddMaxNumMinus; // 0x24
		::System::Boolean IsJustMax; // 0x25
		::System::Boolean IsJustAdd; // 0x26
		::System::Boolean IsAddCurNumMinus; // 0x27
		::System::UInt32 Level; // 0x28
		::System::UInt32 MaxNum; // 0x2C
