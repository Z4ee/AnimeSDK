...
#define RPG_CLIENT_CHENLINGFESMODELVIEW_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1AA7C8A0)
#define RPG_CLIENT_CHENLINGFESMODELVIEW_SETDITHERALPHA_OFFSET UNITYSDK_OFFSET(0x1AA7C7B0)
#define RPG_CLIENT_CHENLINGFESMODELVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA7C900)

namespace RPG::Client
{
	inline static constexpr unsigned int ChenLingFesModelView_TypeDefinitionIndex = 58724;
