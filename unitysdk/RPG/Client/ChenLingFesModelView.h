...
#define RPG_CLIENT_CHENLINGFESMODELVIEW_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1CB18460)
#define RPG_CLIENT_CHENLINGFESMODELVIEW_SETDITHERALPHA_OFFSET UNITYSDK_OFFSET(0x1CB18370)
#define RPG_CLIENT_CHENLINGFESMODELVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CB184C0)

namespace RPG::Client
{
	inline static constexpr unsigned int ChenLingFesModelView_TypeDefinitionIndex = 61555;
