...
#define RPG_CLIENT_MONOEFFECTPLUGINDIALOGRENDERER_DISPOSEDIALOGRENDERER_OFFSET UNITYSDK_OFFSET(0xD7B3220)
#define RPG_CLIENT_MONOEFFECTPLUGINDIALOGRENDERER_GET_BOUNDS_OFFSET UNITYSDK_OFFSET(0xD7B37B0)
#define RPG_CLIENT_MONOEFFECTPLUGINDIALOGRENDERER_GET_DIALOGCAMERA_OFFSET UNITYSDK_OFFSET(0xD7B3740)
#define RPG_CLIENT_MONOEFFECTPLUGINDIALOGRENDERER_GET_DIALOGTARGETRENDERERS_OFFSET UNITYSDK_OFFSET(0xD7B3840)
#define RPG_CLIENT_MONOEFFECTPLUGINDIALOGRENDERER_GET_DIALOGTARGET_OFFSET UNITYSDK_OFFSET(0xD7B36E0)
#define RPG_CLIENT_MONOEFFECTPLUGINDIALOGRENDERER_GET_MATERIALS_OFFSET UNITYSDK_OFFSET(0xD7B37A0)
#define RPG_CLIENT_MONOEFFECTPLUGINDIALOGRENDERER_METHOD_8_0C6D78F7FB2736C2_OFFSET UNITYSDK_OFFSET(0xD7B25F0)
#define RPG_CLIENT_MONOEFFECTPLUGINDIALOGRENDERER_METHOD_8_1092C5537716905B_OFFSET UNITYSDK_OFFSET(0xD7B2420)
#define RPG_CLIENT_MONOEFFECTPLUGINDIALOGRENDERER_METHOD_8_25DEA5C65A602671_OFFSET UNITYSDK_OFFSET(0xD7B2710)
#define RPG_CLIENT_MONOEFFECTPLUGINDIALOGRENDERER_METHOD_8_7DB49B5407C8FD68_OFFSET UNITYSDK_OFFSET(0xD7B2760)
#define RPG_CLIENT_MONOEFFECTPLUGINDIALOGRENDERER_METHOD_8_B2C0ADBFEA309440_OFFSET UNITYSDK_OFFSET(0xD7B2470)
#define RPG_CLIENT_MONOEFFECTPLUGINDIALOGRENDERER_METHOD_8_B93DCFC57470A0D2_OFFSET UNITYSDK_OFFSET(0xD7B2810)
#define RPG_CLIENT_MONOEFFECTPLUGINDIALOGRENDERER_METHOD_8_BD658202BB4C4431_OFFSET UNITYSDK_OFFSET(0xD7B2570)
#define RPG_CLIENT_MONOEFFECTPLUGINDIALOGRENDERER_METHOD_8_F86BB4A64EB8E850_OFFSET UNITYSDK_OFFSET(0xD7B2890)
#define RPG_CLIENT_MONOEFFECTPLUGINDIALOGRENDERER_ONVIEWMODESTATECHANGED_OFFSET UNITYSDK_OFFSET(0xD7B2940)
#define RPG_CLIENT_MONOEFFECTPLUGINDIALOGRENDERER_REFRESHDIALOGRENDERER_OFFSET UNITYSDK_OFFSET(0xD7B3660)
#define RPG_CLIENT_MONOEFFECTPLUGINDIALOGRENDERER_RESETDIALOGRENDERER_OFFSET UNITYSDK_OFFSET(0xD7B2FF0)
#define RPG_CLIENT_MONOEFFECTPLUGINDIALOGRENDERER_SETOVERRIDEBOUNDS_OFFSET UNITYSDK_OFFSET(0xD7B39E0)
#define RPG_CLIENT_MONOEFFECTPLUGINDIALOGRENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0xD7B41C0)
