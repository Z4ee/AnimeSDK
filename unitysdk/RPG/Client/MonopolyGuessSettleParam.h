...
#define RPG_CLIENT_MONOPOLYGUESSSETTLEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x195E8D40)

namespace RPG::Client
{
	inline static constexpr unsigned int MonopolyGuessSettleParam_TypeDefinitionIndex = 66313;
