...
#define RPG_CLIENT_MONOPOLYGUESSSETTLEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x9D65E60)

namespace RPG::Client
{
	inline static constexpr unsigned int MonopolyGuessSettleParam_TypeDefinitionIndex = 53885;
