...
#define RPG_CLIENT_CAKECATCHARRANGECAMERAMANAGER_ACTIVEENTRANCECAMERASIDE_OFFSET UNITYSDK_OFFSET(0x9EC6120)
#define RPG_CLIENT_CAKECATCHARRANGECAMERAMANAGER_ACTIVEENTRANCECAMERA_OFFSET UNITYSDK_OFFSET(0x9EC5C10)
#define RPG_CLIENT_CAKECATCHARRANGECAMERAMANAGER_ACTIVEFREEAREACAMERA_OFFSET UNITYSDK_OFFSET(0x9EC6620)
#define RPG_CLIENT_CAKECATCHARRANGECAMERAMANAGER_ACTIVEINITCAMERA_OFFSET UNITYSDK_OFFSET(0x9EC5710)
#define RPG_CLIENT_CAKECATCHARRANGECAMERAMANAGER_AWAKE_OFFSET UNITYSDK_OFFSET(0x9EC52E0)
#define RPG_CLIENT_CAKECATCHARRANGECAMERAMANAGER_GET__CINEMACHINEBRAIN_OFFSET UNITYSDK_OFFSET(0x9EC5420)
#define RPG_CLIENT_CAKECATCHARRANGECAMERAMANAGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9EC5510)
#define RPG_CLIENT_CAKECATCHARRANGECAMERAMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x9EC6B30)
#define RPG_CLIENT_CAKECATCHARRANGECAMERAMANAGER__DEACTIVATECAMERAS_OFFSET UNITYSDK_OFFSET(0x9EC5660)
