...
#define RPG_CLIENT_CAKECATCHARRANGECAMERAMANAGER_ACTIVEENTRANCECAMERASIDE_OFFSET UNITYSDK_OFFSET(0xB461B70)
#define RPG_CLIENT_CAKECATCHARRANGECAMERAMANAGER_ACTIVEENTRANCECAMERA_OFFSET UNITYSDK_OFFSET(0xB461A20)
#define RPG_CLIENT_CAKECATCHARRANGECAMERAMANAGER_ACTIVEFREEAREACAMERA_OFFSET UNITYSDK_OFFSET(0xB461CC0)
#define RPG_CLIENT_CAKECATCHARRANGECAMERAMANAGER_ACTIVEINITCAMERA_OFFSET UNITYSDK_OFFSET(0xB4618D0)
#define RPG_CLIENT_CAKECATCHARRANGECAMERAMANAGER_AWAKE_OFFSET UNITYSDK_OFFSET(0xB461670)
#define RPG_CLIENT_CAKECATCHARRANGECAMERAMANAGER_GET__CINEMACHINEBRAIN_OFFSET UNITYSDK_OFFSET(0xB4616D0)
#define RPG_CLIENT_CAKECATCHARRANGECAMERAMANAGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB4617C0)
#define RPG_CLIENT_CAKECATCHARRANGECAMERAMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xB461E10)
#define RPG_CLIENT_CAKECATCHARRANGECAMERAMANAGER__DEACTIVATECAMERAS_OFFSET UNITYSDK_OFFSET(0xB461820)

namespace RPG::Client
{
	inline static constexpr unsigned int CakeCatchArrangeCameraManager_TypeDefinitionIndex = 58924;
