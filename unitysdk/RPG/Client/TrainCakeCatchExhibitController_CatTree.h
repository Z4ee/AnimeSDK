...
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER_CATTREE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x178B0A40)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER_CATTREE_GETATTACHPOINTPOS_OFFSET UNITYSDK_OFFSET(0x178B00B0)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER_CATTREE_GET__CATTREEENTITY_OFFSET UNITYSDK_OFFSET(0x178B5150)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER_CATTREE_SETCATTREETYPE_OFFSET UNITYSDK_OFFSET(0x178AF7F0)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER_CATTREE_SETCAT_OFFSET UNITYSDK_OFFSET(0x178AFA80)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER_CATTREE__CTOR_OFFSET UNITYSDK_OFFSET(0x178B07C0)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER_CATTREE__REFRESHLOCATIONONCATTREETYPECHANGED_OFFSET UNITYSDK_OFFSET(0x178B51E0)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER_CATTREE__SETPREFIX_OFFSET UNITYSDK_OFFSET(0x178B4FA0)

namespace RPG::Client
{
	inline static constexpr unsigned int TrainCakeCatchExhibitController_CatTree_TypeDefinitionIndex = 57516;
