...
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER_CATTREE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xE2340C0)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER_CATTREE_GETATTACHPOINTPOS_OFFSET UNITYSDK_OFFSET(0xE233730)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER_CATTREE_GET__CATTREEENTITY_OFFSET UNITYSDK_OFFSET(0xE2387B0)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER_CATTREE_SETCATTREETYPE_OFFSET UNITYSDK_OFFSET(0xE232E60)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER_CATTREE_SETCAT_OFFSET UNITYSDK_OFFSET(0xE2330F0)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER_CATTREE__CTOR_OFFSET UNITYSDK_OFFSET(0xE233E40)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER_CATTREE__REFRESHLOCATIONONCATTREETYPECHANGED_OFFSET UNITYSDK_OFFSET(0xE238840)
#define RPG_CLIENT_TRAINCAKECATCHEXHIBITCONTROLLER_CATTREE__SETPREFIX_OFFSET UNITYSDK_OFFSET(0xE238600)
