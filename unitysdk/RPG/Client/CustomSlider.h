...
#define RPG_CLIENT_CUSTOMSLIDER_ONDRAGMOVED_OFFSET UNITYSDK_OFFSET(0x9441C40)
#define RPG_CLIENT_CUSTOMSLIDER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x9441B30)
#define RPG_CLIENT_CUSTOMSLIDER_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x9441E40)
#define RPG_CLIENT_CUSTOMSLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x9441E90)
#define RPG_CLIENT_CUSTOMSLIDER___IFIXBASEPROXY_ONDRAGMOVED_OFFSET UNITYSDK_OFFSET(0x9441EE0)
#define RPG_CLIENT_CUSTOMSLIDER___IFIXBASEPROXY_ONENABLE_OFFSET UNITYSDK_OFFSET(0x9441EA0)
#define RPG_CLIENT_CUSTOMSLIDER___IFIXBASEPROXY_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x9441EF0)

namespace RPG::Client
{
	inline static constexpr unsigned int CustomSlider_TypeDefinitionIndex = 59428;
