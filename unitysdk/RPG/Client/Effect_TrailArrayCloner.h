...
#define RPG_CLIENT_EFFECT_TRAILARRAYCLONER__CTOR_OFFSET UNITYSDK_OFFSET(0x9585AC0)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_TrailArrayCloner_TypeDefinitionIndex = 57788;
