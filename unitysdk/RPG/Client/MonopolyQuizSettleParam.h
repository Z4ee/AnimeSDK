...
#define RPG_CLIENT_MONOPOLYQUIZSETTLEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xC18B070)

namespace RPG::Client
{
	inline static constexpr unsigned int MonopolyQuizSettleParam_TypeDefinitionIndex = 61964;
