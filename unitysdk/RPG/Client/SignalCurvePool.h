...
#define RPG_CLIENT_SIGNALCURVEPOOL_GET_CURRENTSCENEPOOL_OFFSET UNITYSDK_OFFSET(0x188DD1A0)
#define RPG_CLIENT_SIGNALCURVEPOOL_METHOD_3_2AB12BF7608A20EF_OFFSET UNITYSDK_OFFSET(0x188DDAE0)
#define RPG_CLIENT_SIGNALCURVEPOOL_METHOD_3_3129BDB20712C068_OFFSET UNITYSDK_OFFSET(0x188DDCA0)
#define RPG_CLIENT_SIGNALCURVEPOOL_METHOD_3_3A5CCD2FDB6F9738_OFFSET UNITYSDK_OFFSET(0x188DD800)
#define RPG_CLIENT_SIGNALCURVEPOOL_METHOD_3_3F07804D8892197E_1_OFFSET UNITYSDK_OFFSET(0x188DDC00)
#define RPG_CLIENT_SIGNALCURVEPOOL_METHOD_3_3F07804D8892197E_OFFSET UNITYSDK_OFFSET(0x188DDB70)
#define RPG_CLIENT_SIGNALCURVEPOOL_METHOD_3_69CEABFED67045C9_OFFSET UNITYSDK_OFFSET(0x188DD9B0)
#define RPG_CLIENT_SIGNALCURVEPOOL_METHOD_3_89EF21CA0414B145_OFFSET UNITYSDK_OFFSET(0x188DD220)
#define RPG_CLIENT_SIGNALCURVEPOOL_METHOD_3_B260AE72D1F1CB0C_OFFSET UNITYSDK_OFFSET(0x188DDE90)
#define RPG_CLIENT_SIGNALCURVEPOOL_METHOD_3_CCD88C0D86A5A786_OFFSET UNITYSDK_OFFSET(0x188DD1C0)
#define RPG_CLIENT_SIGNALCURVEPOOL_METHOD_3_F91B0AD50C072273_OFFSET UNITYSDK_OFFSET(0x188DDA50)
#define RPG_CLIENT_SIGNALCURVEPOOL_METHOD_3_F978A1D172468895_OFFSET UNITYSDK_OFFSET(0x188DD430)
#define RPG_CLIENT_SIGNALCURVEPOOL_SET_CURRENTSCENEPOOL_OFFSET UNITYSDK_OFFSET(0x188DD1B0)
#define RPG_CLIENT_SIGNALCURVEPOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x188DDF30)

namespace RPG::Client
{
	inline static constexpr unsigned int SignalCurvePool_TypeDefinitionIndex = 67759;
	...
	public:
		...
		{
			return (::RPG::Client::SignalCurvePool**)Il2CppClass::FromTypeDefinitionIndex(SignalCurvePool_TypeDefinitionIndex)->GetStaticField(0x33750);
		}
		static ::RPG::Client::SignalCurvePool** StaticGet__currentScenePool()
		{
			return (::RPG::Client::SignalCurvePool**)Il2CppClass::FromTypeDefinitionIndex(SignalCurvePool_TypeDefinitionIndex)->GetStaticField(0x33758);
		}
