...
#define RPG_CLIENT_MATCHTHREEBOARD___C__DISPLAYCLASS42_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA826800)
#define RPG_CLIENT_MATCHTHREEBOARD___C__DISPLAYCLASS42_0__DOSKILLTRIGGEREFFECT_B__0_OFFSET UNITYSDK_OFFSET(0xA82B780)

namespace RPG::Client
{
	inline static constexpr unsigned int MatchThreeBoard___c__DisplayClass42_0_TypeDefinitionIndex = 60686;

	class MatchThreeBoard___c__DisplayClass42_0 : public ::System::Object
	{
	public:
		::RPG::Client::MatchThreeBoard* __4__this; // 0x10
		::RPG::Client::MatchThreeSkillTriggerEffect* effect; // 0x18
