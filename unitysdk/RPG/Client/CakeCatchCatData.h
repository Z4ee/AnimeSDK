...
#define RPG_CLIENT_CAKECATCHCATDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xB4667F0)
#define RPG_CLIENT_CAKECATCHCATDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB468340)
#define RPG_CLIENT_CAKECATCHCATDATA_GETCAKECATCHCOUNTHISTORY_OFFSET UNITYSDK_OFFSET(0xB466C50)
#define RPG_CLIENT_CAKECATCHCATDATA_GET_CATDESC_OFFSET UNITYSDK_OFFSET(0xB468CB0)
#define RPG_CLIENT_CAKECATCHCATDATA_GET_CATID_OFFSET UNITYSDK_OFFSET(0xB468B50)
#define RPG_CLIENT_CAKECATCHCATDATA_GET_CATIMAGEPATH_OFFSET UNITYSDK_OFFSET(0xB468D90)
#define RPG_CLIENT_CAKECATCHCATDATA_GET_CATMINIIMAGEPATH_OFFSET UNITYSDK_OFFSET(0xB468160)
#define RPG_CLIENT_CAKECATCHCATDATA_GET_CATNAME_OFFSET UNITYSDK_OFFSET(0xB468B70)
#define RPG_CLIENT_CAKECATCHCATDATA_GET_CATTAILIMAGEPATH_OFFSET UNITYSDK_OFFSET(0xB4680B0)
#define RPG_CLIENT_CAKECATCHCATDATA_GET_CAUGHTTALKSENTENCEIDS_OFFSET UNITYSDK_OFFSET(0xB468E40)
#define RPG_CLIENT_CAKECATCHCATDATA_GET_DARKMATERIALPATH_OFFSET UNITYSDK_OFFSET(0xB4690F0)
#define RPG_CLIENT_CAKECATCHCATDATA_GET_FINISHEDTALKSENTENCEIDS_OFFSET UNITYSDK_OFFSET(0xB468EF0)
#define RPG_CLIENT_CAKECATCHCATDATA_GET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0xB4691A0)
#define RPG_CLIENT_CAKECATCHCATDATA_GET_MATERIALPATH_OFFSET UNITYSDK_OFFSET(0xB469040)
#define RPG_CLIENT_CAKECATCHCATDATA_GET_NPCID_OFFSET UNITYSDK_OFFSET(0xB4668A0)
#define RPG_CLIENT_CAKECATCHCATDATA_GET_TAILCOLOUR_OFFSET UNITYSDK_OFFSET(0xB468FA0)
#define RPG_CLIENT_CAKECATCHCATDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xB468C50)
#define RPG_CLIENT_CAKECATCHCATDATA_INITCONFIG_OFFSET UNITYSDK_OFFSET(0xB4682F0)
#define RPG_CLIENT_CAKECATCHCATDATA_ISARRANGEUNLOCKSTATUSSEEN_OFFSET UNITYSDK_OFFSET(0xB468930)
#define RPG_CLIENT_CAKECATCHCATDATA_ISATLASCAKESTORYSEEN_OFFSET UNITYSDK_OFFSET(0xB468480)
#define RPG_CLIENT_CAKECATCHCATDATA_ISATLASUNLOCKSTATUSSEEN_OFFSET UNITYSDK_OFFSET(0xB468380)
#define RPG_CLIENT_CAKECATCHCATDATA_SETARRANGEUNLOCKSTATUSSEEN_OFFSET UNITYSDK_OFFSET(0xB468A30)
#define RPG_CLIENT_CAKECATCHCATDATA_SETATLASCAKESTORYSEEN_OFFSET UNITYSDK_OFFSET(0xB468750)
#define RPG_CLIENT_CAKECATCHCATDATA_SETATLASUNLOCKSTATUSSEEN_OFFSET UNITYSDK_OFFSET(0xB4685B0)
#define RPG_CLIENT_CAKECATCHCATDATA_SET_CATID_OFFSET UNITYSDK_OFFSET(0xB468B60)
#define RPG_CLIENT_CAKECATCHCATDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB4682E0)
