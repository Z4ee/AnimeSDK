...
#define RPG_CLIENT_CAKECATCHCATDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1A12CC40)
#define RPG_CLIENT_CAKECATCHCATDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A12F290)
#define RPG_CLIENT_CAKECATCHCATDATA_GETCAKECATCHCOUNTHISTORY_OFFSET UNITYSDK_OFFSET(0x1A12D3A0)
#define RPG_CLIENT_CAKECATCHCATDATA_GET_CATDESC_OFFSET UNITYSDK_OFFSET(0x1A12FD00)
#define RPG_CLIENT_CAKECATCHCATDATA_GET_CATID_OFFSET UNITYSDK_OFFSET(0x1A12FBA0)
#define RPG_CLIENT_CAKECATCHCATDATA_GET_CATIMAGEPATH_OFFSET UNITYSDK_OFFSET(0x1A12FDE0)
#define RPG_CLIENT_CAKECATCHCATDATA_GET_CATMINIIMAGEPATH_OFFSET UNITYSDK_OFFSET(0x1A12F0B0)
#define RPG_CLIENT_CAKECATCHCATDATA_GET_CATNAME_OFFSET UNITYSDK_OFFSET(0x1A12FBC0)
#define RPG_CLIENT_CAKECATCHCATDATA_GET_CATTAILIMAGEPATH_OFFSET UNITYSDK_OFFSET(0x1A12F000)
#define RPG_CLIENT_CAKECATCHCATDATA_GET_CAUGHTTALKSENTENCEIDS_OFFSET UNITYSDK_OFFSET(0x1A12FE90)
#define RPG_CLIENT_CAKECATCHCATDATA_GET_DARKMATERIALPATH_OFFSET UNITYSDK_OFFSET(0x1A130140)
#define RPG_CLIENT_CAKECATCHCATDATA_GET_FINISHEDTALKSENTENCEIDS_OFFSET UNITYSDK_OFFSET(0x1A12FF40)
#define RPG_CLIENT_CAKECATCHCATDATA_GET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0x1A1301F0)
#define RPG_CLIENT_CAKECATCHCATDATA_GET_MATERIALPATH_OFFSET UNITYSDK_OFFSET(0x1A130090)
#define RPG_CLIENT_CAKECATCHCATDATA_GET_NPCID_OFFSET UNITYSDK_OFFSET(0x1A12CCF0)
#define RPG_CLIENT_CAKECATCHCATDATA_GET_TAILCOLOUR_OFFSET UNITYSDK_OFFSET(0x1A12FFF0)
#define RPG_CLIENT_CAKECATCHCATDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0x1A12FCA0)
#define RPG_CLIENT_CAKECATCHCATDATA_INITCONFIG_OFFSET UNITYSDK_OFFSET(0x1A12F240)
#define RPG_CLIENT_CAKECATCHCATDATA_ISARRANGEUNLOCKSTATUSSEEN_OFFSET UNITYSDK_OFFSET(0x1A12F980)
#define RPG_CLIENT_CAKECATCHCATDATA_ISATLASCAKESTORYSEEN_OFFSET UNITYSDK_OFFSET(0x1A12F3D0)
#define RPG_CLIENT_CAKECATCHCATDATA_ISATLASUNLOCKSTATUSSEEN_OFFSET UNITYSDK_OFFSET(0x1A12F2D0)
#define RPG_CLIENT_CAKECATCHCATDATA_SETARRANGEUNLOCKSTATUSSEEN_OFFSET UNITYSDK_OFFSET(0x1A12FA80)
#define RPG_CLIENT_CAKECATCHCATDATA_SETATLASCAKESTORYSEEN_OFFSET UNITYSDK_OFFSET(0x1A12F7A0)
#define RPG_CLIENT_CAKECATCHCATDATA_SETATLASUNLOCKSTATUSSEEN_OFFSET UNITYSDK_OFFSET(0x1A12F600)
#define RPG_CLIENT_CAKECATCHCATDATA_SET_CATID_OFFSET UNITYSDK_OFFSET(0x1A12FBB0)
#define RPG_CLIENT_CAKECATCHCATDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A12F230)
