...
#define RPG_CLIENT_EXPEDITIONBATTLERANKVIEWMODEL_GET_RANKSTATENAME_OFFSET UNITYSDK_OFFSET(0xCEFF280)
#define RPG_CLIENT_EXPEDITIONBATTLERANKVIEWMODEL_SETRANSTATENAME_OFFSET UNITYSDK_OFFSET(0xCEFC580)
#define RPG_CLIENT_EXPEDITIONBATTLERANKVIEWMODEL_SET_RANKSTATENAME_OFFSET UNITYSDK_OFFSET(0xCEFF290)
#define RPG_CLIENT_EXPEDITIONBATTLERANKVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xCEFF2A0)
