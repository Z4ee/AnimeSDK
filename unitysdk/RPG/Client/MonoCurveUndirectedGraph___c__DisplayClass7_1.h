...
#define RPG_CLIENT_MONOCURVEUNDIRECTEDGRAPH___C__DISPLAYCLASS7_1__CTOR_OFFSET UNITYSDK_OFFSET(0x9C29120)
#define RPG_CLIENT_MONOCURVEUNDIRECTEDGRAPH___C__DISPLAYCLASS7_1__GENERATECURVEEDGES_B__2_OFFSET UNITYSDK_OFFSET(0x9C29330)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoCurveUndirectedGraph___c__DisplayClass7_1_TypeDefinitionIndex = 55998;
