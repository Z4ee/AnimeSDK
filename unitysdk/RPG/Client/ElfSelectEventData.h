...
#define RPG_CLIENT_ELFSELECTEVENTDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1A16F4B0)
#define RPG_CLIENT_ELFSELECTEVENTDATA_GET_BUBBLETYPE_OFFSET UNITYSDK_OFFSET(0x1A16F910)
#define RPG_CLIENT_ELFSELECTEVENTDATA_GET_CONTACTSID_OFFSET UNITYSDK_OFFSET(0x1A16F870)
#define RPG_CLIENT_ELFSELECTEVENTDATA_GET_DESCRIBE_OFFSET UNITYSDK_OFFSET(0x1A16F750)
#define RPG_CLIENT_ELFSELECTEVENTDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0x1A16F730)
#define RPG_CLIENT_ELFSELECTEVENTDATA_GET_OPEFFECT1_OFFSET UNITYSDK_OFFSET(0x1A16F5F0)
#define RPG_CLIENT_ELFSELECTEVENTDATA_GET_OPEFFECT2_OFFSET UNITYSDK_OFFSET(0x1A16F690)
#define RPG_CLIENT_ELFSELECTEVENTDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0x1A16F810)
#define RPG_CLIENT_ELFSELECTEVENTDATA_SET_ID_OFFSET UNITYSDK_OFFSET(0x1A16F740)
#define RPG_CLIENT_ELFSELECTEVENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A16F5E0)
