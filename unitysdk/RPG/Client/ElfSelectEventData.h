...
#define RPG_CLIENT_ELFSELECTEVENTDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x95F3B10)
#define RPG_CLIENT_ELFSELECTEVENTDATA_GET_BUBBLETYPE_OFFSET UNITYSDK_OFFSET(0x95F3F20)
#define RPG_CLIENT_ELFSELECTEVENTDATA_GET_CONTACTSID_OFFSET UNITYSDK_OFFSET(0x95F3EB0)
#define RPG_CLIENT_ELFSELECTEVENTDATA_GET_DESCRIBE_OFFSET UNITYSDK_OFFSET(0x95F3DD0)
#define RPG_CLIENT_ELFSELECTEVENTDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0x95F3DB0)
#define RPG_CLIENT_ELFSELECTEVENTDATA_GET_OPEFFECT1_OFFSET UNITYSDK_OFFSET(0x95F3CD0)
#define RPG_CLIENT_ELFSELECTEVENTDATA_GET_OPEFFECT2_OFFSET UNITYSDK_OFFSET(0x95F3D40)
#define RPG_CLIENT_ELFSELECTEVENTDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0x95F3E50)
#define RPG_CLIENT_ELFSELECTEVENTDATA_SET_ID_OFFSET UNITYSDK_OFFSET(0x95F3DC0)
#define RPG_CLIENT_ELFSELECTEVENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x95F3CC0)

namespace RPG::Client
{
	inline static constexpr unsigned int ElfSelectEventData_TypeDefinitionIndex = 51715;
