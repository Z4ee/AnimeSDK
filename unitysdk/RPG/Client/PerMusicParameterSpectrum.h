...
#define RPG_CLIENT_PERMUSICPARAMETERSPECTRUM__CTOR_OFFSET UNITYSDK_OFFSET(0x1864A4B0)

namespace RPG::Client
{
	inline static constexpr unsigned int PerMusicParameterSpectrum_TypeDefinitionIndex = 70786;
