...
#define RPG_CLIENT_PERMUSICPARAMETERSPECTRUM__CTOR_OFFSET UNITYSDK_OFFSET(0x17F38770)

namespace RPG::Client
{
	inline static constexpr unsigned int PerMusicParameterSpectrum_TypeDefinitionIndex = 67663;
