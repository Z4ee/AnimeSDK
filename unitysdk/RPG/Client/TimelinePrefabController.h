...
#define RPG_CLIENT_TIMELINEPREFABCONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0xB31C200)
#define RPG_CLIENT_TIMELINEPREFABCONTROLLER_GET_BEHAVIOUR_OFFSET UNITYSDK_OFFSET(0xB31C1A0)
#define RPG_CLIENT_TIMELINEPREFABCONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB31C3F0)
#define RPG_CLIENT_TIMELINEPREFABCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xB31C3A0)
#define RPG_CLIENT_TIMELINEPREFABCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xB31C2F0)
#define RPG_CLIENT_TIMELINEPREFABCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xB31C490)
#define RPG_CLIENT_TIMELINEPREFABCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB31C4E0)

namespace RPG::Client
{
	inline static constexpr unsigned int TimelinePrefabController_TypeDefinitionIndex = 56024;
