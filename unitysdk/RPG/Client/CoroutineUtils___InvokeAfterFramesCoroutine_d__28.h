...
#define RPG_CLIENT_COROUTINEUTILS___INVOKEAFTERFRAMESCOROUTINE_D__28_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1C8A8AE0)
#define RPG_CLIENT_COROUTINEUTILS___INVOKEAFTERFRAMESCOROUTINE_D__28_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1C8A8B50)
#define RPG_CLIENT_COROUTINEUTILS___INVOKEAFTERFRAMESCOROUTINE_D__28_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1C8A8BB0)
#define RPG_CLIENT_COROUTINEUTILS___INVOKEAFTERFRAMESCOROUTINE_D__28_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1C8A8B60)
#define RPG_CLIENT_COROUTINEUTILS___INVOKEAFTERFRAMESCOROUTINE_D__28_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C8A8AD0)
#define RPG_CLIENT_COROUTINEUTILS___INVOKEAFTERFRAMESCOROUTINE_D__28__CTOR_OFFSET UNITYSDK_OFFSET(0x1C8A8630)
