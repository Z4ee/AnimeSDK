...
#define RPG_CLIENT_COROUTINEUTILS___INVOKEAFTERFRAMESCOROUTINE_D__28_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1ACA23E0)
#define RPG_CLIENT_COROUTINEUTILS___INVOKEAFTERFRAMESCOROUTINE_D__28_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1ACA2450)
#define RPG_CLIENT_COROUTINEUTILS___INVOKEAFTERFRAMESCOROUTINE_D__28_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1ACA24B0)
#define RPG_CLIENT_COROUTINEUTILS___INVOKEAFTERFRAMESCOROUTINE_D__28_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1ACA2460)
#define RPG_CLIENT_COROUTINEUTILS___INVOKEAFTERFRAMESCOROUTINE_D__28_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1ACA23D0)
#define RPG_CLIENT_COROUTINEUTILS___INVOKEAFTERFRAMESCOROUTINE_D__28__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACA1F30)

namespace RPG::Client
{
	inline static constexpr unsigned int CoroutineUtils___InvokeAfterFramesCoroutine_d__28_TypeDefinitionIndex = 33798;
