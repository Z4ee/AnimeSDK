...
#define RPG_CLIENT_CHALLENGEBOSSINTROSTAGEVIEWMODEL_CREATEALL_OFFSET UNITYSDK_OFFSET(0xB4F4250)
#define RPG_CLIENT_CHALLENGEBOSSINTROSTAGEVIEWMODEL_GET_HINTTIERCEFINAL_OFFSET UNITYSDK_OFFSET(0xB4F4230)
#define RPG_CLIENT_CHALLENGEBOSSINTROSTAGEVIEWMODEL_GET_MONSTERLEVEL_OFFSET UNITYSDK_OFFSET(0xB4F4210)
#define RPG_CLIENT_CHALLENGEBOSSINTROSTAGEVIEWMODEL_GET_RECOMMENDDAMAGETYPES_OFFSET UNITYSDK_OFFSET(0xB4F4220)
#define RPG_CLIENT_CHALLENGEBOSSINTROSTAGEVIEWMODEL_SET_HINTTIERCEFINAL_OFFSET UNITYSDK_OFFSET(0xB4F4240)
#define RPG_CLIENT_CHALLENGEBOSSINTROSTAGEVIEWMODEL__CREATENORMAL_OFFSET UNITYSDK_OFFSET(0xB4F4300)
#define RPG_CLIENT_CHALLENGEBOSSINTROSTAGEVIEWMODEL__CREATETIERCE_OFFSET UNITYSDK_OFFSET(0xB4F44B0)
#define RPG_CLIENT_CHALLENGEBOSSINTROSTAGEVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xB4F44A0)

namespace RPG::Client
{
	inline static constexpr unsigned int ChallengeBossIntroStageViewModel_TypeDefinitionIndex = 59022;
