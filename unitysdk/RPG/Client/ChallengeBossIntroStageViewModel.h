...
#define RPG_CLIENT_CHALLENGEBOSSINTROSTAGEVIEWMODEL_CREATEALL_OFFSET UNITYSDK_OFFSET(0xCA2A510)
#define RPG_CLIENT_CHALLENGEBOSSINTROSTAGEVIEWMODEL_GET_HINTTIERCEFINAL_OFFSET UNITYSDK_OFFSET(0xCA2A4F0)
#define RPG_CLIENT_CHALLENGEBOSSINTROSTAGEVIEWMODEL_GET_MONSTERLEVEL_OFFSET UNITYSDK_OFFSET(0xCA2A4C0)
#define RPG_CLIENT_CHALLENGEBOSSINTROSTAGEVIEWMODEL_GET_RECOMMENDDAMAGETYPES_OFFSET UNITYSDK_OFFSET(0xCA2A4D0)
#define RPG_CLIENT_CHALLENGEBOSSINTROSTAGEVIEWMODEL_GET_VORACITYINVASIONLEVEL_OFFSET UNITYSDK_OFFSET(0xCA2A4E0)
#define RPG_CLIENT_CHALLENGEBOSSINTROSTAGEVIEWMODEL_SET_HINTTIERCEFINAL_OFFSET UNITYSDK_OFFSET(0xCA2A500)
#define RPG_CLIENT_CHALLENGEBOSSINTROSTAGEVIEWMODEL__CREATENORMAL_OFFSET UNITYSDK_OFFSET(0xCA2A5C0)
#define RPG_CLIENT_CHALLENGEBOSSINTROSTAGEVIEWMODEL__CREATETIERCE_OFFSET UNITYSDK_OFFSET(0xCA2A780)
#define RPG_CLIENT_CHALLENGEBOSSINTROSTAGEVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xCA2A770)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::Int32 _VoracityInvasionLevel_k__BackingField; // 0x18
		::System::Int32 _MonsterLevel_k__BackingField; // 0x1C
		::System::Boolean _HintTierceFinal_k__BackingField; // 0x20
