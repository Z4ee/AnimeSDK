...
#define RPG_CLIENT_ARTNPCPEDESTRIANASSETCONFIG_IDENTITYDATA_METHOD_1_3EBFCBB7FE30ED6B_OFFSET UNITYSDK_OFFSET(0x90D7F80)
#define RPG_CLIENT_ARTNPCPEDESTRIANASSETCONFIG_IDENTITYDATA_METHOD_1_DA1BF2C227DC3D86_OFFSET UNITYSDK_OFFSET(0x90D7F40)
#define RPG_CLIENT_ARTNPCPEDESTRIANASSETCONFIG_IDENTITYDATA_METHOD_1_DA37DFE3A5BDA9F4_OFFSET UNITYSDK_OFFSET(0x90D7900)
#define RPG_CLIENT_ARTNPCPEDESTRIANASSETCONFIG_IDENTITYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x90D8040)

namespace RPG::Client
{
	inline static constexpr unsigned int ArtNPCPedestrianAssetConfig_IdentityData_TypeDefinitionIndex = 56587;
