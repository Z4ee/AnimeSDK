...
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPMONOPLUGIN_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xCA62160)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPMONOPLUGIN_DISABLETESTMODE_OFFSET UNITYSDK_OFFSET(0xCA61FE0)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPMONOPLUGIN_ENABLETESTMODE_OFFSET UNITYSDK_OFFSET(0xCA61F50)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPMONOPLUGIN_METHOD_7_491027A35182E1D6_OFFSET UNITYSDK_OFFSET(0xCA61C40)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPMONOPLUGIN_ONENTERMAP_OFFSET UNITYSDK_OFFSET(0xCA61DF0)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPMONOPLUGIN_ONLIGHTMOVE_OFFSET UNITYSDK_OFFSET(0xCA61B50)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPMONOPLUGIN_ONTSCCHANGE_OFFSET UNITYSDK_OFFSET(0xCA61B90)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPMONOPLUGIN_OVERRIDESECONDEDGE_OFFSET UNITYSDK_OFFSET(0xCA5EE50)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPMONOPLUGIN_REGISTERRENDERER_OFFSET UNITYSDK_OFFSET(0xCA61E30)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPMONOPLUGIN_SETEDGEPARAM_OFFSET UNITYSDK_OFFSET(0xCA61CF0)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPMONOPLUGIN_SETEDGESCALE_OFFSET UNITYSDK_OFFSET(0xCA5F170)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPMONOPLUGIN_SPAWNED_OFFSET UNITYSDK_OFFSET(0xCA62110)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPMONOPLUGIN_UNREGISTERRENDERER_OFFSET UNITYSDK_OFFSET(0xCA61ED0)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xCA621B0)

namespace RPG::Client
{
	inline static constexpr unsigned int TimeSpaceCrisscrossGroupMonoPlugin_TypeDefinitionIndex = 65663;
