...
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPMONOPLUGIN_DESPAWNED_OFFSET UNITYSDK_OFFSET(0x17893940)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPMONOPLUGIN_DISABLETESTMODE_OFFSET UNITYSDK_OFFSET(0x178937C0)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPMONOPLUGIN_ENABLETESTMODE_OFFSET UNITYSDK_OFFSET(0x17893730)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPMONOPLUGIN_METHOD_7_491027A35182E1D6_OFFSET UNITYSDK_OFFSET(0x17893420)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPMONOPLUGIN_ONENTERMAP_OFFSET UNITYSDK_OFFSET(0x178935D0)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPMONOPLUGIN_ONLIGHTMOVE_OFFSET UNITYSDK_OFFSET(0x17893330)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPMONOPLUGIN_ONTSCCHANGE_OFFSET UNITYSDK_OFFSET(0x17893370)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPMONOPLUGIN_OVERRIDESECONDEDGE_OFFSET UNITYSDK_OFFSET(0x17890A40)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPMONOPLUGIN_REGISTERRENDERER_OFFSET UNITYSDK_OFFSET(0x17893610)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPMONOPLUGIN_SETEDGEPARAM_OFFSET UNITYSDK_OFFSET(0x178934D0)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPMONOPLUGIN_SETEDGESCALE_OFFSET UNITYSDK_OFFSET(0x17890D60)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPMONOPLUGIN_SPAWNED_OFFSET UNITYSDK_OFFSET(0x178938F0)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPMONOPLUGIN_UNREGISTERRENDERER_OFFSET UNITYSDK_OFFSET(0x178936B0)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x17893990)

namespace RPG::Client
{
	inline static constexpr unsigned int TimeSpaceCrisscrossGroupMonoPlugin_TypeDefinitionIndex = 67080;
	...
	public:
		...
		::UnityEngine::Coroutine* Field_7_30; // 0xE8
