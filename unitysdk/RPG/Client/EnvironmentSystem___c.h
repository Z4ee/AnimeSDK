...
#define RPG_CLIENT_ENVIRONMENTSYSTEM___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1991FF70)
#define RPG_CLIENT_ENVIRONMENTSYSTEM___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1991FFB0)
#define RPG_CLIENT_ENVIRONMENTSYSTEM___C___UPDATEGBUFFERLIGHTINGMATBYKEYWORD_B__223_0_OFFSET UNITYSDK_OFFSET(0x1991FFC0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::RPG::Client::OnAssetOperationDelegate**)Il2CppClass::FromTypeDefinitionIndex(EnvironmentSystem___c_TypeDefinitionIndex)->GetStaticField(0x63D80);
		}
		static ::RPG::Client::EnvironmentSystem___c** StaticGet___9()
		{
			return (::RPG::Client::EnvironmentSystem___c**)Il2CppClass::FromTypeDefinitionIndex(EnvironmentSystem___c_TypeDefinitionIndex)->GetStaticField(0x63D88);
		}
