...
#define RPG_CLIENT_STAGEINVASIONFORCEKILLMARKDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xE0E05E0)
#define RPG_CLIENT_STAGEINVASIONFORCEKILLMARKDATA_GET_FILLAMOUNT_OFFSET UNITYSDK_OFFSET(0xE0E0500)
#define RPG_CLIENT_STAGEINVASIONFORCEKILLMARKDATA_GET_ISACTIVATE_OFFSET UNITYSDK_OFFSET(0xE0E05C0)
#define RPG_CLIENT_STAGEINVASIONFORCEKILLMARKDATA_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0xE0E04E0)
#define RPG_CLIENT_STAGEINVASIONFORCEKILLMARKDATA_GET_MARKTYPE_OFFSET UNITYSDK_OFFSET(0xE0E0520)
#define RPG_CLIENT_STAGEINVASIONFORCEKILLMARKDATA_GET_SHOWTYPE_OFFSET UNITYSDK_OFFSET(0xE0E0570)
#define RPG_CLIENT_STAGEINVASIONFORCEKILLMARKDATA_REFRESH_OFFSET UNITYSDK_OFFSET(0xE0E0680)
#define RPG_CLIENT_STAGEINVASIONFORCEKILLMARKDATA_SET_FILLAMOUNT_OFFSET UNITYSDK_OFFSET(0xE0E0510)
#define RPG_CLIENT_STAGEINVASIONFORCEKILLMARKDATA_SET_ISACTIVATE_OFFSET UNITYSDK_OFFSET(0xE0E05D0)
#define RPG_CLIENT_STAGEINVASIONFORCEKILLMARKDATA_SET_ISVALID_OFFSET UNITYSDK_OFFSET(0xE0E04F0)
#define RPG_CLIENT_STAGEINVASIONFORCEKILLMARKDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xE0E0670)
#define RPG_CLIENT_STAGEINVASIONFORCEKILLMARKDATA__ENSURESTAGEINVASIONMODULE_OFFSET UNITYSDK_OFFSET(0xE0E08E0)
#define RPG_CLIENT_STAGEINVASIONFORCEKILLMARKDATA__RESET_OFFSET UNITYSDK_OFFSET(0xE0E0800)
#define RPG_CLIENT_STAGEINVASIONFORCEKILLMARKDATA__TRYGETSTAGEINVASIONUIDATA_OFFSET UNITYSDK_OFFSET(0xE0E0850)

namespace RPG::Client
{
	inline static constexpr unsigned int StageInvasionForceKillMarkData_TypeDefinitionIndex = 71622;

	class StageInvasionForceKillMarkData : public ::System::Object
	{
	public:
		::Class_1_4FBAE6148E0D2FAE* _StageInvasionModule; // 0x10
		::System::Boolean _IsActivate_k__BackingField; // 0x18
