...
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_FILTER_CLEARROLEFILTER_OFFSET UNITYSDK_OFFSET(0x1ABD9070)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_FILTER_FILTEREQUIP_OFFSET UNITYSDK_OFFSET(0x1ABD9020)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_FILTER_FILTERROLE_OFFSET UNITYSDK_OFFSET(0x1ABD8FD0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_FILTER_GETCOSTOPTIONS_OFFSET UNITYSDK_OFFSET(0x1ABD9540)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_FILTER_GETEQUIPFILTEROPTIONS_OFFSET UNITYSDK_OFFSET(0x1ABD9580)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_FILTER_GETEQUIPOPTIONS_OFFSET UNITYSDK_OFFSET(0x1ABD9410)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_FILTER_GETMAINTRAITOPTIONS_OFFSET UNITYSDK_OFFSET(0x1ABD95C0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_FILTER_GETROLEOPTIONS_OFFSET UNITYSDK_OFFSET(0x1ABD9290)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_FILTER_GETSUBTRAITOPTIONS_OFFSET UNITYSDK_OFFSET(0x1ABD9600)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_FILTER_GET_ISEQUIPFILTERACTIVE_OFFSET UNITYSDK_OFFSET(0x1ABD9130)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_FILTER_GET_ISFILTERACTIVE_OFFSET UNITYSDK_OFFSET(0x1ABD91C0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_FILTER_GET_ISROLEFILTERACTIVE_OFFSET UNITYSDK_OFFSET(0x1ABD90E0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_FILTER_INITEQUIPS_OFFSET UNITYSDK_OFFSET(0x1ABD1AA0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_FILTER_INITROLES_OFFSET UNITYSDK_OFFSET(0x1ABD1600)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_FILTER_SELECTRARITY_OFFSET UNITYSDK_OFFSET(0x1ABD9240)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_FILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABD0380)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_FILTER__FILTER_1_OFFSET UNITYSDK_OFFSET(0x1ABD9460)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_FILTER__FILTER_OFFSET UNITYSDK_OFFSET(0x1ABD92E0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_FILTER___CTOR_B__16_0_OFFSET UNITYSDK_OFFSET(0x1ABD9640)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_FILTER___CTOR_B__16_3_OFFSET UNITYSDK_OFFSET(0x1ABD96A0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_FILTER___CTOR_B__16_6_OFFSET UNITYSDK_OFFSET(0x1ABD9710)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_FILTER___FILTER_B__32_0_OFFSET UNITYSDK_OFFSET(0x1ABD9770)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_FILTER___FILTER_B__32_1_OFFSET UNITYSDK_OFFSET(0x1ABD9800)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_FILTER___FILTER_B__33_0_OFFSET UNITYSDK_OFFSET(0x1ABD98B0)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightGameFormationEditor_Filter_TypeDefinitionIndex = 61725;
	...
	public:
		...
		::RPG::Client::GridFightGameFormationEditor_GridFightGameFormationRoleFilterOption* CurRoleFilterOption; // 0x20
		::System::Collections::Generic::List_1<::RPG::Client::GridFightGameFormationEditor_GridFightGameFormationTraitOption*>* _SubTraitOptions; // 0x28
		::System::Collections::Generic::List_1<::RPG::Client::GridFightGameFormationEditor_GridFightGameFormationEquipFilterOption*>* _EquipTypeOptions; // 0x30
		::System::Collections::Generic::List_1<::RPG::Client::GridFightGameFormationEditor_GridFightGameFormationTraitOption*>* _MainTraitOptions; // 0x38
		::System::Collections::Generic::List_1<::RPG::Client::GridFightEquipItemConfig*>* _AllEquips; // 0x40
		::System::Collections::Generic::List_1<::RPG::Client::GridFightGameFormationEditor_GridFightGameFormationRarityOption*>* _RarityOptions; // 0x48
		...
		::System::Collections::Generic::List_1<::RPG::Client::GridFightRole*>* _AllRoles; // 0x58
