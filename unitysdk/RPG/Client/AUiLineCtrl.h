...
#define RPG_CLIENT_AUILINECTRL_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x8EC2D70)
#define RPG_CLIENT_AUILINECTRL_FRESHLINE_OFFSET UNITYSDK_OFFSET(0x8EC2B30)
#define RPG_CLIENT_AUILINECTRL_GET_ANIMOD_OFFSET UNITYSDK_OFFSET(0x8EC2A80)
#define RPG_CLIENT_AUILINECTRL_GET_CURRENTLEVEL_OFFSET UNITYSDK_OFFSET(0x8EC2A10)
#define RPG_CLIENT_AUILINECTRL_GET_LINERCOLOR_OFFSET UNITYSDK_OFFSET(0x8EC27F0)
#define RPG_CLIENT_AUILINECTRL_METHOD_5_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0x8EC2FC0)
#define RPG_CLIENT_AUILINECTRL_METHOD_5_35942D7A8A374AB0_OFFSET UNITYSDK_OFFSET(0x8EC2DC0)
#define RPG_CLIENT_AUILINECTRL_SET_ANIMOD_OFFSET UNITYSDK_OFFSET(0x8EC2A90)
#define RPG_CLIENT_AUILINECTRL_SET_CURRENTLEVEL_OFFSET UNITYSDK_OFFSET(0x8EC2A20)
#define RPG_CLIENT_AUILINECTRL_SET_LINERCOLOR_OFFSET UNITYSDK_OFFSET(0x8EC2800)
#define RPG_CLIENT_AUILINECTRL_START_OFFSET UNITYSDK_OFFSET(0x8EC2AE0)
#define RPG_CLIENT_AUILINECTRL__CTOR_OFFSET UNITYSDK_OFFSET(0x8EC3130)

namespace RPG::Client
{
	inline static constexpr unsigned int AUiLineCtrl_TypeDefinitionIndex = 59400;
