...
#define RPG_CLIENT_OVERRIDECONTROLLERSWITCHER_INIT_OFFSET UNITYSDK_OFFSET(0x9EB8EF0)
#define RPG_CLIENT_OVERRIDECONTROLLERSWITCHER_METHOD_5_622ECCAB087BA15C_OFFSET UNITYSDK_OFFSET(0x9EB9210)
#define RPG_CLIENT_OVERRIDECONTROLLERSWITCHER_METHOD_5_FB3DA77F663C0AAA_OFFSET UNITYSDK_OFFSET(0x9EB9100)
#define RPG_CLIENT_OVERRIDECONTROLLERSWITCHER_ONUNLOADMODEL_OFFSET UNITYSDK_OFFSET(0x9EB9010)
#define RPG_CLIENT_OVERRIDECONTROLLERSWITCHER_RESETTODEFAULT_OFFSET UNITYSDK_OFFSET(0x9EB9060)
#define RPG_CLIENT_OVERRIDECONTROLLERSWITCHER_SWITCHTO_OFFSET UNITYSDK_OFFSET(0x9EB9160)
#define RPG_CLIENT_OVERRIDECONTROLLERSWITCHER__CTOR_OFFSET UNITYSDK_OFFSET(0x9EB9370)

namespace RPG::Client
{
	inline static constexpr unsigned int OverrideControllerSwitcher_TypeDefinitionIndex = 56055;
	...
	public:
		...
		::UnityEngine::RuntimeAnimatorController* Method_5_622ECCAB087BA15C(::System::String* a1)
		{
			return ((::UnityEngine::RuntimeAnimatorController*(*)(::PVOID, ::System::String*))((::PBYTE)hIl2Cpp + RPG_CLIENT_OVERRIDECONTROLLERSWITCHER_METHOD_5_622ECCAB087BA15C_OFFSET))(this, a1);
		}
