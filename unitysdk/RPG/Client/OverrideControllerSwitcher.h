...
#define RPG_CLIENT_OVERRIDECONTROLLERSWITCHER_INIT_OFFSET UNITYSDK_OFFSET(0xC31F090)
#define RPG_CLIENT_OVERRIDECONTROLLERSWITCHER_METHOD_5_9EC4C069E7F8C0F8_OFFSET UNITYSDK_OFFSET(0xC31F3A0)
#define RPG_CLIENT_OVERRIDECONTROLLERSWITCHER_METHOD_5_FB3DA77F663C0AAA_OFFSET UNITYSDK_OFFSET(0xC31F290)
#define RPG_CLIENT_OVERRIDECONTROLLERSWITCHER_ONUNLOADMODEL_OFFSET UNITYSDK_OFFSET(0xC31F1A0)
#define RPG_CLIENT_OVERRIDECONTROLLERSWITCHER_RESETTODEFAULT_OFFSET UNITYSDK_OFFSET(0xC31F1F0)
#define RPG_CLIENT_OVERRIDECONTROLLERSWITCHER_SWITCHTO_OFFSET UNITYSDK_OFFSET(0xC31F2F0)
#define RPG_CLIENT_OVERRIDECONTROLLERSWITCHER__CTOR_OFFSET UNITYSDK_OFFSET(0xC31F550)

namespace RPG::Client
{
	inline static constexpr unsigned int OverrideControllerSwitcher_TypeDefinitionIndex = 64215;
