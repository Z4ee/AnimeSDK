...
#define RPG_CLIENT_POOLPROPERTYSCRIPTABLEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0xC4B1CF0)

namespace RPG::Client
{
	inline static constexpr unsigned int PoolPropertyScriptableObject_TypeDefinitionIndex = 67857;
