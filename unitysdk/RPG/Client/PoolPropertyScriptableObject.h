...
#define RPG_CLIENT_POOLPROPERTYSCRIPTABLEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0xAD702A0)

namespace RPG::Client
{
	inline static constexpr unsigned int PoolPropertyScriptableObject_TypeDefinitionIndex = 66915;
