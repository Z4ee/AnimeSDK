...
#define RPG_CLIENT_CHARAEYEBLINKSTATERANDOM_METHOD_1_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0x191FECE0)
#define RPG_CLIENT_CHARAEYEBLINKSTATERANDOM_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x191FE790)
#define RPG_CLIENT_CHARAEYEBLINKSTATERANDOM_METHOD_1_9D1353263EAF48A2_OFFSET UNITYSDK_OFFSET(0x191FEAD0)
#define RPG_CLIENT_CHARAEYEBLINKSTATERANDOM_METHOD_1_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0x191FE690)
#define RPG_CLIENT_CHARAEYEBLINKSTATERANDOM_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x191FE810)
#define RPG_CLIENT_CHARAEYEBLINKSTATERANDOM_METHOD_1_CA6BDDCC5F7CE11E_OFFSET UNITYSDK_OFFSET(0x191FEA20)
#define RPG_CLIENT_CHARAEYEBLINKSTATERANDOM_METHOD_1_D0CD9A971CA3B1CF_OFFSET UNITYSDK_OFFSET(0x191FE6E0)
#define RPG_CLIENT_CHARAEYEBLINKSTATERANDOM_METHOD_1_FE327FD0760E1514_OFFSET UNITYSDK_OFFSET(0x191FEBB0)
#define RPG_CLIENT_CHARAEYEBLINKSTATERANDOM_TICK_OFFSET UNITYSDK_OFFSET(0x191FE860)
#define RPG_CLIENT_CHARAEYEBLINKSTATERANDOM__CTOR_OFFSET UNITYSDK_OFFSET(0x191FED60)

namespace RPG::Client
{
	inline static constexpr unsigned int CharaEyeBlinkStateRandom_TypeDefinitionIndex = 65331;
