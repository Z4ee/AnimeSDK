...
#define RPG_CLIENT_CHARAEYEBLINKSTATERANDOM_METHOD_1_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0x92FA800)
#define RPG_CLIENT_CHARAEYEBLINKSTATERANDOM_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x92FA2B0)
#define RPG_CLIENT_CHARAEYEBLINKSTATERANDOM_METHOD_1_9D1353263EAF48A2_OFFSET UNITYSDK_OFFSET(0x92FA5F0)
#define RPG_CLIENT_CHARAEYEBLINKSTATERANDOM_METHOD_1_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0x92FA1B0)
#define RPG_CLIENT_CHARAEYEBLINKSTATERANDOM_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x92FA330)
#define RPG_CLIENT_CHARAEYEBLINKSTATERANDOM_METHOD_1_CA6BDDCC5F7CE11E_OFFSET UNITYSDK_OFFSET(0x92FA540)
#define RPG_CLIENT_CHARAEYEBLINKSTATERANDOM_METHOD_1_D0CD9A971CA3B1CF_OFFSET UNITYSDK_OFFSET(0x92FA200)
#define RPG_CLIENT_CHARAEYEBLINKSTATERANDOM_METHOD_1_FE327FD0760E1514_OFFSET UNITYSDK_OFFSET(0x92FA6D0)
#define RPG_CLIENT_CHARAEYEBLINKSTATERANDOM_TICK_OFFSET UNITYSDK_OFFSET(0x92FA380)
#define RPG_CLIENT_CHARAEYEBLINKSTATERANDOM__CTOR_OFFSET UNITYSDK_OFFSET(0x92FA880)

namespace RPG::Client
{
	inline static constexpr unsigned int CharaEyeBlinkStateRandom_TypeDefinitionIndex = 55811;
