...
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_BATTLECOLLEGE_D__30_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x9E799F0)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_BATTLECOLLEGE_D__30_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x9E79B70)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_BATTLECOLLEGE_D__30_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x9E79BD0)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_BATTLECOLLEGE_D__30_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x9E79B80)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_BATTLECOLLEGE_D__30_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9E799E0)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_BATTLECOLLEGE_D__30__CTOR_OFFSET UNITYSDK_OFFSET(0x9E76980)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleResultProcess___RP_BattleCollege_d__30_TypeDefinitionIndex = 56262;
