...
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_NEXTDAILYREFRESH_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x15830470)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_NEXTDAILYREFRESH_EQUALS_OFFSET UNITYSDK_OFFSET(0x158303A0)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_NEXTDAILYREFRESH_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x15830520)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_NEXTDAILYREFRESH_GET_CONDITIONTEXT_OFFSET UNITYSDK_OFFSET(0x158305B0)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_NEXTDAILYREFRESH_GET_TIME_OFFSET UNITYSDK_OFFSET(0x158305A0)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_NEXTDAILYREFRESH__CTOR_OFFSET UNITYSDK_OFFSET(0x15830390)

namespace RPG::Client
{
	inline static constexpr unsigned int MissionChroniclePathUnlockConditionData_NextDailyRefresh_TypeDefinitionIndex = 63184;
