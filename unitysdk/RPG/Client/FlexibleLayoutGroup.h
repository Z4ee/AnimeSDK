...
#define RPG_CLIENT_FLEXIBLELAYOUTGROUP_CALCULATELAYOUTINPUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x96FEF40)
#define RPG_CLIENT_FLEXIBLELAYOUTGROUP_CALCULATELAYOUTINPUTVERTICAL_OFFSET UNITYSDK_OFFSET(0x96FFBA0)
#define RPG_CLIENT_FLEXIBLELAYOUTGROUP_GETGREATESTMINIMUMCHILDWIDTH_OFFSET UNITYSDK_OFFSET(0x96FF000)
#define RPG_CLIENT_FLEXIBLELAYOUTGROUP_GET_RECORDMINCOUNTHORIZONAL_OFFSET UNITYSDK_OFFSET(0x96FEDA0)
#define RPG_CLIENT_FLEXIBLELAYOUTGROUP_GET_RECORDMINCOUNTVERTICAL_OFFSET UNITYSDK_OFFSET(0x96FEDB0)
#define RPG_CLIENT_FLEXIBLELAYOUTGROUP_GET_ROWCOLUMNINDEX_OFFSET UNITYSDK_OFFSET(0x96FEDC0)
#define RPG_CLIENT_FLEXIBLELAYOUTGROUP_GET_ROWCOLUMNREVERSEINDEX_OFFSET UNITYSDK_OFFSET(0x96FEDD0)
#define RPG_CLIENT_FLEXIBLELAYOUTGROUP_METHOD_7_0D6A00AF1E0E3AC9_OFFSET UNITYSDK_OFFSET(0x96FFDC0)
#define RPG_CLIENT_FLEXIBLELAYOUTGROUP_METHOD_7_1D4018D4200358D0_1_OFFSET UNITYSDK_OFFSET(0x96FEE40)
#define RPG_CLIENT_FLEXIBLELAYOUTGROUP_METHOD_7_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x96FEDE0)
#define RPG_CLIENT_FLEXIBLELAYOUTGROUP_METHOD_7_391A84BCD9F51317_1_OFFSET UNITYSDK_OFFSET(0x96FEEF0)
#define RPG_CLIENT_FLEXIBLELAYOUTGROUP_METHOD_7_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x96FEEA0)
#define RPG_CLIENT_FLEXIBLELAYOUTGROUP_METHOD_7_D66617C59550EB9B_OFFSET UNITYSDK_OFFSET(0x96FFCA0)
#define RPG_CLIENT_FLEXIBLELAYOUTGROUP_SETLAYOUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x96FF0D0)
#define RPG_CLIENT_FLEXIBLELAYOUTGROUP_SETLAYOUTVERTICAL_OFFSET UNITYSDK_OFFSET(0x96FFAA0)
#define RPG_CLIENT_FLEXIBLELAYOUTGROUP_SETLAYOUT_OFFSET UNITYSDK_OFFSET(0x96FF1D0)
#define RPG_CLIENT_FLEXIBLELAYOUTGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x9700660)
#define RPG_CLIENT_FLEXIBLELAYOUTGROUP___IFIXBASEPROXY_CALCULATELAYOUTINPUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x9700830)

namespace RPG::Client
{
	inline static constexpr unsigned int FlexibleLayoutGroup_TypeDefinitionIndex = 59438;
