...
#define RPG_CLIENT_MONODICECOMBATOVERRIDEGRAVITY_METHOD_5_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0xD751B60)
#define RPG_CLIENT_MONODICECOMBATOVERRIDEGRAVITY_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xD751FE0)
#define RPG_CLIENT_MONODICECOMBATOVERRIDEGRAVITY_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xD751E60)
#define RPG_CLIENT_MONODICECOMBATOVERRIDEGRAVITY_ONENABLE_OFFSET UNITYSDK_OFFSET(0xD751D50)
#define RPG_CLIENT_MONODICECOMBATOVERRIDEGRAVITY_OVERRIDEGRAVITY_OFFSET UNITYSDK_OFFSET(0xD751C70)
#define RPG_CLIENT_MONODICECOMBATOVERRIDEGRAVITY_RESETGRAVITY_OFFSET UNITYSDK_OFFSET(0xD751F30)
#define RPG_CLIENT_MONODICECOMBATOVERRIDEGRAVITY__CTOR_OFFSET UNITYSDK_OFFSET(0xD7520B0)
