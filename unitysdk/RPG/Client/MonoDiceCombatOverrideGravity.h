...
#define RPG_CLIENT_MONODICECOMBATOVERRIDEGRAVITY_METHOD_5_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x11666890)
#define RPG_CLIENT_MONODICECOMBATOVERRIDEGRAVITY_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x11666D10)
#define RPG_CLIENT_MONODICECOMBATOVERRIDEGRAVITY_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x11666B90)
#define RPG_CLIENT_MONODICECOMBATOVERRIDEGRAVITY_ONENABLE_OFFSET UNITYSDK_OFFSET(0x11666A80)
#define RPG_CLIENT_MONODICECOMBATOVERRIDEGRAVITY_OVERRIDEGRAVITY_OFFSET UNITYSDK_OFFSET(0x116669A0)
#define RPG_CLIENT_MONODICECOMBATOVERRIDEGRAVITY_RESETGRAVITY_OFFSET UNITYSDK_OFFSET(0x11666C60)
#define RPG_CLIENT_MONODICECOMBATOVERRIDEGRAVITY__CTOR_OFFSET UNITYSDK_OFFSET(0x11666DE0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoDiceCombatOverrideGravity_TypeDefinitionIndex = 63631;
	...
	public:
		...
		::System::Single NEPEEENELPG; // 0x20
