...
#define RPG_CLIENT_ALLEYROUTEBIRD_BINDCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x9D16970)
#define RPG_CLIENT_ALLEYROUTEBIRD_DESPAWNED_OFFSET UNITYSDK_OFFSET(0x9D16EC0)
#define RPG_CLIENT_ALLEYROUTEBIRD_FLY_OFFSET UNITYSDK_OFFSET(0x9D16C40)
#define RPG_CLIENT_ALLEYROUTEBIRD_METHOD_5_151E25A63D14DDB0_1_OFFSET UNITYSDK_OFFSET(0x9D16CB0)
#define RPG_CLIENT_ALLEYROUTEBIRD_METHOD_5_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0x9D17090)
#define RPG_CLIENT_ALLEYROUTEBIRD_METHOD_5_60DC879ACE99CF48_OFFSET UNITYSDK_OFFSET(0x9D16BD0)
#define RPG_CLIENT_ALLEYROUTEBIRD_METHOD_5_CB613A5EF970C11B_OFFSET UNITYSDK_OFFSET(0x9D17170)
#define RPG_CLIENT_ALLEYROUTEBIRD_SETACTIVE_OFFSET UNITYSDK_OFFSET(0x9D16A30)
#define RPG_CLIENT_ALLEYROUTEBIRD_SETCOLOR_OFFSET UNITYSDK_OFFSET(0x9D16B40)
#define RPG_CLIENT_ALLEYROUTEBIRD_SPAWNED_OFFSET UNITYSDK_OFFSET(0x9D16D90)
#define RPG_CLIENT_ALLEYROUTEBIRD_UPDATE_OFFSET UNITYSDK_OFFSET(0x9D17000)
#define RPG_CLIENT_ALLEYROUTEBIRD__CCTOR_OFFSET UNITYSDK_OFFSET(0x9D171F0)
#define RPG_CLIENT_ALLEYROUTEBIRD__CTOR_OFFSET UNITYSDK_OFFSET(0x9D171E0)

namespace RPG::Client
{
	inline static constexpr unsigned int AlleyRouteBird_TypeDefinitionIndex = 57461;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(AlleyRouteBird_TypeDefinitionIndex)->GetStaticField(0xB6A0);
		}
		static ::System::Int32* StaticGet_Field_5_0()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(AlleyRouteBird_TypeDefinitionIndex)->GetStaticField(0xB6A4);
		}
