...
#define RPG_CLIENT_ALLEYROUTEBIRD_BINDCOMPONENTS_OFFSET UNITYSDK_OFFSET(0xC756CC0)
#define RPG_CLIENT_ALLEYROUTEBIRD_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xC757130)
#define RPG_CLIENT_ALLEYROUTEBIRD_FLY_OFFSET UNITYSDK_OFFSET(0xC756F90)
#define RPG_CLIENT_ALLEYROUTEBIRD_METHOD_5_151E25A63D14DDB0_1_OFFSET UNITYSDK_OFFSET(0xC757000)
#define RPG_CLIENT_ALLEYROUTEBIRD_METHOD_5_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0xC757210)
#define RPG_CLIENT_ALLEYROUTEBIRD_METHOD_5_60DC879ACE99CF48_OFFSET UNITYSDK_OFFSET(0xC756F20)
#define RPG_CLIENT_ALLEYROUTEBIRD_METHOD_5_CB613A5EF970C11B_OFFSET UNITYSDK_OFFSET(0xC7572F0)
#define RPG_CLIENT_ALLEYROUTEBIRD_SETACTIVE_OFFSET UNITYSDK_OFFSET(0xC756D80)
#define RPG_CLIENT_ALLEYROUTEBIRD_SETCOLOR_OFFSET UNITYSDK_OFFSET(0xC756E90)
#define RPG_CLIENT_ALLEYROUTEBIRD_SPAWNED_OFFSET UNITYSDK_OFFSET(0xC7570E0)
#define RPG_CLIENT_ALLEYROUTEBIRD_UPDATE_OFFSET UNITYSDK_OFFSET(0xC757180)
#define RPG_CLIENT_ALLEYROUTEBIRD__CCTOR_OFFSET UNITYSDK_OFFSET(0xC757370)
#define RPG_CLIENT_ALLEYROUTEBIRD__CTOR_OFFSET UNITYSDK_OFFSET(0xC757360)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(AlleyRouteBird_TypeDefinitionIndex)->GetStaticField(0x14D50);
		}
		static ::System::Int32* StaticGet_LNGDBLEKGHG()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(AlleyRouteBird_TypeDefinitionIndex)->GetStaticField(0x14D54);
		}
