...
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONCOMMENTDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xC665D10)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONCOMMENTDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0xC665DA0)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONCOMMENTDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xC665DC0)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONCOMMENTDATA_GET_NPCHANDICON_OFFSET UNITYSDK_OFFSET(0xC665E30)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONCOMMENTDATA_GET_REPLY_OFFSET UNITYSDK_OFFSET(0xC665E80)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONCOMMENTDATA_SET_ID_OFFSET UNITYSDK_OFFSET(0xC665DB0)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONCOMMENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC665D90)
