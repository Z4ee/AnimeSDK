...
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONCOMMENTDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x193244C0)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONCOMMENTDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0x19324550)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONCOMMENTDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19324570)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONCOMMENTDATA_GET_NPCHANDICON_OFFSET UNITYSDK_OFFSET(0x193245E0)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONCOMMENTDATA_GET_REPLY_OFFSET UNITYSDK_OFFSET(0x19324630)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONCOMMENTDATA_SET_ID_OFFSET UNITYSDK_OFFSET(0x19324560)
#define RPG_CLIENT_ACTIVITYPHOTOEXHIBITIONCOMMENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19324540)

namespace RPG::Client
{
	inline static constexpr unsigned int ActivityPhotoExhibitionCommentData_TypeDefinitionIndex = 58979;
