...
#define RPG_CLIENT_ANCHORVIRTUALCAMERACONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0xC75C9A0)
#define RPG_CLIENT_ANCHORVIRTUALCAMERACONTROLLER_METHOD_5_1EC859072E470A1E_OFFSET UNITYSDK_OFFSET(0xC75E3B0)
#define RPG_CLIENT_ANCHORVIRTUALCAMERACONTROLLER_METHOD_5_2C95AFAD0256302F_OFFSET UNITYSDK_OFFSET(0xC75D080)
#define RPG_CLIENT_ANCHORVIRTUALCAMERACONTROLLER_METHOD_5_2ED6C3773AA1E488_OFFSET UNITYSDK_OFFSET(0xC75FEA0)
#define RPG_CLIENT_ANCHORVIRTUALCAMERACONTROLLER_METHOD_5_391A84BCD9F51317_1_OFFSET UNITYSDK_OFFSET(0xC75D200)
#define RPG_CLIENT_ANCHORVIRTUALCAMERACONTROLLER_METHOD_5_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xC75C920)
#define RPG_CLIENT_ANCHORVIRTUALCAMERACONTROLLER_METHOD_5_461F63418186686D_OFFSET UNITYSDK_OFFSET(0xC75E2A0)
#define RPG_CLIENT_ANCHORVIRTUALCAMERACONTROLLER_METHOD_5_6CAB5262B05DECB0_OFFSET UNITYSDK_OFFSET(0xC75FC80)
#define RPG_CLIENT_ANCHORVIRTUALCAMERACONTROLLER_METHOD_5_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0xC75E700)
#define RPG_CLIENT_ANCHORVIRTUALCAMERACONTROLLER_METHOD_5_8C3DB70FFBBF01C7_OFFSET UNITYSDK_OFFSET(0xC75F0B0)
#define RPG_CLIENT_ANCHORVIRTUALCAMERACONTROLLER_METHOD_5_B09E78EE7EE4F8FA_OFFSET UNITYSDK_OFFSET(0xC75CFD0)
#define RPG_CLIENT_ANCHORVIRTUALCAMERACONTROLLER_METHOD_5_C66E15B631BB1D0F_OFFSET UNITYSDK_OFFSET(0xC7601D0)
#define RPG_CLIENT_ANCHORVIRTUALCAMERACONTROLLER_METHOD_5_F0088C88851A7DFB_1_OFFSET UNITYSDK_OFFSET(0xC75C980)
#define RPG_CLIENT_ANCHORVIRTUALCAMERACONTROLLER_METHOD_5_F0088C88851A7DFB_2_OFFSET UNITYSDK_OFFSET(0xC75C990)
#define RPG_CLIENT_ANCHORVIRTUALCAMERACONTROLLER_METHOD_5_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xC75C970)
#define RPG_CLIENT_ANCHORVIRTUALCAMERACONTROLLER_METHOD_5_F4DD08A31BA3F883_OFFSET UNITYSDK_OFFSET(0xC75D250)
#define RPG_CLIENT_ANCHORVIRTUALCAMERACONTROLLER_METHOD_5_F79D5EC57FBF426E_OFFSET UNITYSDK_OFFSET(0xC75D400)
#define RPG_CLIENT_ANCHORVIRTUALCAMERACONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC75CEA0)
#define RPG_CLIENT_ANCHORVIRTUALCAMERACONTROLLER_SETCENTERPOS_OFFSET UNITYSDK_OFFSET(0xC75E200)
#define RPG_CLIENT_ANCHORVIRTUALCAMERACONTROLLER_STARTUPDATE_OFFSET UNITYSDK_OFFSET(0xC75E7C0)
#define RPG_CLIENT_ANCHORVIRTUALCAMERACONTROLLER_STOPUPDATE_OFFSET UNITYSDK_OFFSET(0xC75F130)
#define RPG_CLIENT_ANCHORVIRTUALCAMERACONTROLLER_UPDATELOOKATPHONECAMERAPOSITIONANDDIRECTION_OFFSET UNITYSDK_OFFSET(0xC75F320)
#define RPG_CLIENT_ANCHORVIRTUALCAMERACONTROLLER_UPDATELOOKATPROPCAMERAPOSITIONANDDIRECTION_OFFSET UNITYSDK_OFFSET(0xC7603C0)
#define RPG_CLIENT_ANCHORVIRTUALCAMERACONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC760A90)
