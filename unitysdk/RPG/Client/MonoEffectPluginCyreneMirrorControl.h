...
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL_AWAKEPLUGIN_OFFSET UNITYSDK_OFFSET(0x191223A0)
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL_DISPOSEPLUGIN_OFFSET UNITYSDK_OFFSET(0x19122640)
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL_GET_MIRRORFOLLOWTRANSFORM_OFFSET UNITYSDK_OFFSET(0x191246A0)
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL_MANUALLYUPDATECAMERAPOSITION_OFFSET UNITYSDK_OFFSET(0x191230D0)
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL_METHOD_6_27266CF5C6A3D539_OFFSET UNITYSDK_OFFSET(0x191244B0)
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL_METHOD_6_743CCE653F5EA979_OFFSET UNITYSDK_OFFSET(0x191232A0)
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL_METHOD_6_ACAF19E8DD89168C_OFFSET UNITYSDK_OFFSET(0x19123D10)
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL_METHOD_6_C20670991DA7E1D3_OFFSET UNITYSDK_OFFSET(0x19123AD0)
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL_METHOD_6_C561FF611C07A44C_OFFSET UNITYSDK_OFFSET(0x19122D20)
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL_RESETPLUGIN_OFFSET UNITYSDK_OFFSET(0x19122460)
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL_SETUPFORMODELCAPTURE_OFFSET UNITYSDK_OFFSET(0x191238F0)
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL_SETUP_OFFSET UNITYSDK_OFFSET(0x19123120)
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL_TICK_OFFSET UNITYSDK_OFFSET(0x19122820)
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x19124700)
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL___GETAIMTARGET_G___GETPOS_8_0_OFFSET UNITYSDK_OFFSET(0x19124030)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginCyreneMirrorControl_TypeDefinitionIndex = 66851;
	...
	public:
		...
		::Class_0_16E4307DCC419505_1006* Field_6_12; // 0x80
		...
		::System::Void Method_6_743CCE653F5EA979(::UnityEngine::Transform* a1, ::Class_0_16E4307DCC419505_1006* a2, ::RPG::MVector3 a3, ::RPG::MVector3 a4, ::System::Single a5, ::System::Boolean a6)
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::Transform*, ::Class_0_16E4307DCC419505_1006*, ::RPG::MVector3, ::RPG::MVector3, ::System::Single, ::System::Boolean))((::PBYTE)hIl2Cpp + RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL_METHOD_6_743CCE653F5EA979_OFFSET))(this, a1, a2, a3, a4, a5, a6);
		}
