...
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL_AWAKEPLUGIN_OFFSET UNITYSDK_OFFSET(0x1B37CE70)
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL_DISPOSEPLUGIN_OFFSET UNITYSDK_OFFSET(0x1B37D110)
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL_GET_MIRRORFOLLOWTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1B37F170)
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL_MANUALLYUPDATECAMERAPOSITION_OFFSET UNITYSDK_OFFSET(0x1B37DBA0)
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL_METHOD_6_27266CF5C6A3D539_OFFSET UNITYSDK_OFFSET(0x1B37EF80)
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL_METHOD_6_743CCE653F5EA979_OFFSET UNITYSDK_OFFSET(0x1B37DD70)
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL_METHOD_6_ACAF19E8DD89168C_OFFSET UNITYSDK_OFFSET(0x1B37E7E0)
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL_METHOD_6_C20670991DA7E1D3_OFFSET UNITYSDK_OFFSET(0x1B37E5A0)
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL_METHOD_6_C561FF611C07A44C_OFFSET UNITYSDK_OFFSET(0x1B37D7F0)
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL_RESETPLUGIN_OFFSET UNITYSDK_OFFSET(0x1B37CF30)
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL_SETUPFORMODELCAPTURE_OFFSET UNITYSDK_OFFSET(0x1B37E3C0)
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL_SETUP_OFFSET UNITYSDK_OFFSET(0x1B37DBF0)
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL_TICK_OFFSET UNITYSDK_OFFSET(0x1B37D2F0)
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B37F1D0)
#define RPG_CLIENT_MONOEFFECTPLUGINCYRENEMIRRORCONTROL___GETAIMTARGET_G___GETPOS_8_0_OFFSET UNITYSDK_OFFSET(0x1B37EB00)
