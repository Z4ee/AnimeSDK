...
#define RPG_CLIENT_MONOCURVEUNDIRECTEDGRAPH___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x10CC4CD0)
#define RPG_CLIENT_MONOCURVEUNDIRECTEDGRAPH___C__CTOR_OFFSET UNITYSDK_OFFSET(0x10CC4D10)
#define RPG_CLIENT_MONOCURVEUNDIRECTEDGRAPH___C__GENERATECURVEEDGES_B__7_0_OFFSET UNITYSDK_OFFSET(0x10CC4D20)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Func_2<::RPG::Client::CurveUndirectedEdgeSetting*, ::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(MonoCurveUndirectedGraph___c_TypeDefinitionIndex)->GetStaticField(0x4FB70);
		}
		static ::RPG::Client::MonoCurveUndirectedGraph___c** StaticGet___9()
		{
			return (::RPG::Client::MonoCurveUndirectedGraph___c**)Il2CppClass::FromTypeDefinitionIndex(MonoCurveUndirectedGraph___c_TypeDefinitionIndex)->GetStaticField(0x4FB78);
		}
