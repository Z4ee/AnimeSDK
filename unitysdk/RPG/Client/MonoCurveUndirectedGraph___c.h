...
#define RPG_CLIENT_MONOCURVEUNDIRECTEDGRAPH___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x9C29160)
#define RPG_CLIENT_MONOCURVEUNDIRECTEDGRAPH___C__CTOR_OFFSET UNITYSDK_OFFSET(0x9C291A0)
#define RPG_CLIENT_MONOCURVEUNDIRECTEDGRAPH___C__GENERATECURVEEDGES_B__7_0_OFFSET UNITYSDK_OFFSET(0x9C291B0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Func_2<::RPG::Client::CurveUndirectedEdgeSetting*, ::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(MonoCurveUndirectedGraph___c_TypeDefinitionIndex)->GetStaticField(0x34E10);
		}
		static ::RPG::Client::MonoCurveUndirectedGraph___c** StaticGet___9()
		{
			return (::RPG::Client::MonoCurveUndirectedGraph___c**)Il2CppClass::FromTypeDefinitionIndex(MonoCurveUndirectedGraph___c_TypeDefinitionIndex)->GetStaticField(0x34E18);
		}
