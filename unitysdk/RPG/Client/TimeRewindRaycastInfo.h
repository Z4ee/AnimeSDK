...
#define RPG_CLIENT_TIMEREWINDRAYCASTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xCA4E170)

namespace RPG::Client
{
	inline static constexpr unsigned int TimeRewindRaycastInfo_TypeDefinitionIndex = 56868;
