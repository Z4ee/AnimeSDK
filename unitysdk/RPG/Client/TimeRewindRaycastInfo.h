...
#define RPG_CLIENT_TIMEREWINDRAYCASTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19790230)

namespace RPG::Client
{
	inline static constexpr unsigned int TimeRewindRaycastInfo_TypeDefinitionIndex = 60942;
