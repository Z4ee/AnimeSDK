...
#define RPG_CLIENT_MONOINPUTICONTIP_AWAKE_OFFSET UNITYSDK_OFFSET(0xC122FF0)
#define RPG_CLIENT_MONOINPUTICONTIP_METHOD_5_460ED92A9D08B0B6_OFFSET UNITYSDK_OFFSET(0xC1232F0)
#define RPG_CLIENT_MONOINPUTICONTIP_METHOD_5_99770A90CCA648B7_OFFSET UNITYSDK_OFFSET(0xC1232A0)
#define RPG_CLIENT_MONOINPUTICONTIP_METHOD_5_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0xC123580)
#define RPG_CLIENT_MONOINPUTICONTIP_METHOD_5_BF622B900A7F3625_OFFSET UNITYSDK_OFFSET(0xC123100)
#define RPG_CLIENT_MONOINPUTICONTIP_METHOD_5_D32194AE7B33706F_OFFSET UNITYSDK_OFFSET(0xC123630)
#define RPG_CLIENT_MONOINPUTICONTIP_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC1231C0)
#define RPG_CLIENT_MONOINPUTICONTIP__CTOR_OFFSET UNITYSDK_OFFSET(0xC123750)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoInputIconTip_TypeDefinitionIndex = 57350;
