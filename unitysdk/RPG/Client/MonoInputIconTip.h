...
#define RPG_CLIENT_MONOINPUTICONTIP_AWAKE_OFFSET UNITYSDK_OFFSET(0x9D11FE0)
#define RPG_CLIENT_MONOINPUTICONTIP_METHOD_5_6D9928F240CC3649_OFFSET UNITYSDK_OFFSET(0x9D122A0)
#define RPG_CLIENT_MONOINPUTICONTIP_METHOD_5_99770A90CCA648B7_OFFSET UNITYSDK_OFFSET(0x9D12250)
#define RPG_CLIENT_MONOINPUTICONTIP_METHOD_5_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0x9D12540)
#define RPG_CLIENT_MONOINPUTICONTIP_METHOD_5_BF622B900A7F3625_OFFSET UNITYSDK_OFFSET(0x9D120D0)
#define RPG_CLIENT_MONOINPUTICONTIP_METHOD_5_D32194AE7B33706F_OFFSET UNITYSDK_OFFSET(0x9D125F0)
#define RPG_CLIENT_MONOINPUTICONTIP_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9D12190)
#define RPG_CLIENT_MONOINPUTICONTIP__CTOR_OFFSET UNITYSDK_OFFSET(0x9D12730)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoInputIconTip_TypeDefinitionIndex = 49751;
