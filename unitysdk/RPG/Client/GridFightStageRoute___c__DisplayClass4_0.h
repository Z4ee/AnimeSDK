...
namespace RPG::Client
{
	...
	public:
		...
		::System::Boolean _SyncRouteID_b__0(::RPG::GameCore::GridFightStageRouteConfigRow* row)
		{
			return ((::System::Boolean(*)(::PVOID, ::RPG::GameCore::GridFightStageRouteConfigRow*))((::PBYTE)hIl2Cpp + RPG_CLIENT_GRIDFIGHTSTAGEROUTE___C__DISPLAYCLASS4_0__SYNCROUTEID_B__0_OFFSET))(this, row);
		}
	};
}
