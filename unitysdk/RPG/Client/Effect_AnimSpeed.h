...
#define RPG_CLIENT_EFFECT_ANIMSPEED_UPDATE_OFFSET UNITYSDK_OFFSET(0x953CA20)
#define RPG_CLIENT_EFFECT_ANIMSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x953CBF0)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_AnimSpeed_TypeDefinitionIndex = 57665;
