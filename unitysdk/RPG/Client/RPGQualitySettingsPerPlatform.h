...
#define RPG_CLIENT_RPGQUALITYSETTINGSPERPLATFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x167A2890)

namespace RPG::Client
{
	inline static constexpr unsigned int RPGQualitySettingsPerPlatform_TypeDefinitionIndex = 64930;
