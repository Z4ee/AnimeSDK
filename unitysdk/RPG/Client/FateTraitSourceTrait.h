...
#define RPG_CLIENT_FATETRAITSOURCETRAIT_GETDESC_OFFSET UNITYSDK_OFFSET(0xD043ED0)
#define RPG_CLIENT_FATETRAITSOURCETRAIT_GETIMGICON_OFFSET UNITYSDK_OFFSET(0xD043C40)
#define RPG_CLIENT_FATETRAITSOURCETRAIT_GETNAME_OFFSET UNITYSDK_OFFSET(0xD043E10)
#define RPG_CLIENT_FATETRAITSOURCETRAIT_GETRARITYBG_OFFSET UNITYSDK_OFFSET(0xD043DA0)
#define RPG_CLIENT_FATETRAITSOURCETRAIT_GET_TRAITDATA_OFFSET UNITYSDK_OFFSET(0xD043CB0)
#define RPG_CLIENT_FATETRAITSOURCETRAIT_GET_TRAITID_OFFSET UNITYSDK_OFFSET(0xD043FE0)
#define RPG_CLIENT_FATETRAITSOURCETRAIT_ISACTIVE_OFFSET UNITYSDK_OFFSET(0xD043FA0)
#define RPG_CLIENT_FATETRAITSOURCETRAIT_SET_TRAITID_OFFSET UNITYSDK_OFFSET(0xD043FF0)
#define RPG_CLIENT_FATETRAITSOURCETRAIT__CTOR_OFFSET UNITYSDK_OFFSET(0xD041C10)
