...
#define RPG_CLIENT_AVATARCOMPAREREXTENSIONS___C__DISPLAYCLASS2_0__CTOR_OFFSET UNITYSDK_OFFSET(0xB35CDB0)
#define RPG_CLIENT_AVATARCOMPAREREXTENSIONS___C__DISPLAYCLASS2_0__SETLEVELRARITYISDESCENDING_B__0_OFFSET UNITYSDK_OFFSET(0xB35CEC0)

namespace RPG::Client
{
	inline static constexpr unsigned int AvatarComparerExtensions___c__DisplayClass2_0_TypeDefinitionIndex = 58757;
