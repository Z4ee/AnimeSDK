...
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORBEHAVIOR_STATECURVE_GET_ONESTEPDURATION_OFFSET UNITYSDK_OFFSET(0x1A4E8CE0)
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORBEHAVIOR_STATECURVE_METHOD_1_5D3A3EE49803D6C0_OFFSET UNITYSDK_OFFSET(0x1A4E89E0)
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORBEHAVIOR_STATECURVE_METHOD_1_6F7271C62F1FE776_OFFSET UNITYSDK_OFFSET(0x1A4E8D80)
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORBEHAVIOR_STATECURVE_METHOD_1_854CAFC5FADAC24E_OFFSET UNITYSDK_OFFSET(0x1A4E8940)
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORBEHAVIOR_STATECURVE_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x1A4E8CA0)
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORBEHAVIOR_STATECURVE_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1A4E8990)
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORBEHAVIOR_STATECURVE_METHOD_1_D225EBCFE9DF5FDA_OFFSET UNITYSDK_OFFSET(0x1A4E8A60)
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORBEHAVIOR_STATECURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4E9170)

namespace RPG::Client
{
	inline static constexpr unsigned int StageHarmonySignalDemodulatorBehavior_StateCurve_TypeDefinitionIndex = 70957;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORBEHAVIOR_STATECURVE_METHOD_1_6F7271C62F1FE776_OFFSET))(this, a1);
		}
