...
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORBEHAVIOR_STATECURVE_GET_ONESTEPDURATION_OFFSET UNITYSDK_OFFSET(0xB1B9CA0)
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORBEHAVIOR_STATECURVE_METHOD_1_45030DA3EF3AEF01_OFFSET UNITYSDK_OFFSET(0xB1B9D40)
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORBEHAVIOR_STATECURVE_METHOD_1_5D3A3EE49803D6C0_OFFSET UNITYSDK_OFFSET(0xB1B99A0)
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORBEHAVIOR_STATECURVE_METHOD_1_854CAFC5FADAC24E_OFFSET UNITYSDK_OFFSET(0xB1B9900)
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORBEHAVIOR_STATECURVE_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xB1B9C60)
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORBEHAVIOR_STATECURVE_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xB1B9950)
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORBEHAVIOR_STATECURVE_METHOD_1_D225EBCFE9DF5FDA_OFFSET UNITYSDK_OFFSET(0xB1B9A20)
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORBEHAVIOR_STATECURVE__CTOR_OFFSET UNITYSDK_OFFSET(0xB1BA0E0)

namespace RPG::Client
{
	inline static constexpr unsigned int StageHarmonySignalDemodulatorBehavior_StateCurve_TypeDefinitionIndex = 65437;
