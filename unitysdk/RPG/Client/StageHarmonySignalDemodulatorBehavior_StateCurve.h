...
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORBEHAVIOR_STATECURVE_GET_ONESTEPDURATION_OFFSET UNITYSDK_OFFSET(0x17B4DAF0)
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORBEHAVIOR_STATECURVE_METHOD_1_5D3A3EE49803D6C0_OFFSET UNITYSDK_OFFSET(0x17B4D7F0)
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORBEHAVIOR_STATECURVE_METHOD_1_6F7271C62F1FE776_OFFSET UNITYSDK_OFFSET(0x17B4DB90)
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORBEHAVIOR_STATECURVE_METHOD_1_854CAFC5FADAC24E_OFFSET UNITYSDK_OFFSET(0x17B4D750)
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORBEHAVIOR_STATECURVE_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x17B4DAB0)
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORBEHAVIOR_STATECURVE_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x17B4D7A0)
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORBEHAVIOR_STATECURVE_METHOD_1_D225EBCFE9DF5FDA_OFFSET UNITYSDK_OFFSET(0x17B4D870)
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORBEHAVIOR_STATECURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x17B4DF80)

namespace RPG::Client
{
	inline static constexpr unsigned int StageHarmonySignalDemodulatorBehavior_StateCurve_TypeDefinitionIndex = 67789;
