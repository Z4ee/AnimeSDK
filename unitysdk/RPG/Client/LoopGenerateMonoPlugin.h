...
#define RPG_CLIENT_LOOPGENERATEMONOPLUGIN_COLLECTALLREFASSETPATH_OFFSET UNITYSDK_OFFSET(0xD58C8F0)
#define RPG_CLIENT_LOOPGENERATEMONOPLUGIN_GET_EFFECTIVESTARTPOS_OFFSET UNITYSDK_OFFSET(0xD58C820)
#define RPG_CLIENT_LOOPGENERATEMONOPLUGIN_HIDEORIGINALCHILDREN_OFFSET UNITYSDK_OFFSET(0xD58CB80)
#define RPG_CLIENT_LOOPGENERATEMONOPLUGIN_ONPHASELOOPRESET_OFFSET UNITYSDK_OFFSET(0xD58CAF0)
#define RPG_CLIENT_LOOPGENERATEMONOPLUGIN_SETTEMPSPEED_OFFSET UNITYSDK_OFFSET(0xD58CA30)
#define RPG_CLIENT_LOOPGENERATEMONOPLUGIN_SHOWORIGINALCHILDREN_OFFSET UNITYSDK_OFFSET(0xD58CC60)
#define RPG_CLIENT_LOOPGENERATEMONOPLUGIN_SWITCHCONFIG_OFFSET UNITYSDK_OFFSET(0xD58C980)
#define RPG_CLIENT_LOOPGENERATEMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xD58CD40)
