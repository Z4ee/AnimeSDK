...
#define RPG_CLIENT_LOOPGENERATEMONOPLUGIN_SETTEMPSPEED_OFFSET UNITYSDK_OFFSET(0x9A6D710)
#define RPG_CLIENT_LOOPGENERATEMONOPLUGIN_SWITCHCONFIG_OFFSET UNITYSDK_OFFSET(0x9A6D660)
#define RPG_CLIENT_LOOPGENERATEMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x9A6D7D0)

namespace RPG::Client
{
	inline static constexpr unsigned int LoopGenerateMonoPlugin_TypeDefinitionIndex = 58084;
