...
#define RPG_CLIENT_LOOPGENERATEMONOPLUGIN_SETTEMPSPEED_OFFSET UNITYSDK_OFFSET(0xA71AA50)
#define RPG_CLIENT_LOOPGENERATEMONOPLUGIN_SWITCHCONFIG_OFFSET UNITYSDK_OFFSET(0xA71A9A0)
#define RPG_CLIENT_LOOPGENERATEMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xA71AB10)

namespace RPG::Client
{
	inline static constexpr unsigned int LoopGenerateMonoPlugin_TypeDefinitionIndex = 65371;
