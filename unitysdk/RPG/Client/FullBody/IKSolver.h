...
#define RPG_CLIENT_FULLBODY_IKSOLVER_GET_INITIATED_OFFSET UNITYSDK_OFFSET(0xA3F9CC0)
#define RPG_CLIENT_FULLBODY_IKSOLVER_METHOD_1_03E2B9212B4B6EAF_OFFSET UNITYSDK_OFFSET(0xA3F9C80)
#define RPG_CLIENT_FULLBODY_IKSOLVER_METHOD_1_050E70FEDB783306_OFFSET UNITYSDK_OFFSET(0xA3F9CE0)
#define RPG_CLIENT_FULLBODY_IKSOLVER_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xA3F9680)
#define RPG_CLIENT_FULLBODY_IKSOLVER_METHOD_1_40E490E2772D5D75_OFFSET UNITYSDK_OFFSET(0xA3F9B50)
#define RPG_CLIENT_FULLBODY_IKSOLVER_METHOD_1_479759059E440327_OFFSET UNITYSDK_OFFSET(0xA3F9C00)
#define RPG_CLIENT_FULLBODY_IKSOLVER_METHOD_1_48312DE5F57AE9EE_OFFSET UNITYSDK_OFFSET(0xA3F9D30)
#define RPG_CLIENT_FULLBODY_IKSOLVER_METHOD_1_8FD0952225841B46_OFFSET UNITYSDK_OFFSET(0xA3F9A60)
#define RPG_CLIENT_FULLBODY_IKSOLVER_METHOD_1_9AD47D8DC12F1689_OFFSET UNITYSDK_OFFSET(0xA3F96E0)
#define RPG_CLIENT_FULLBODY_IKSOLVER_METHOD_1_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0xA3F9BB0)
#define RPG_CLIENT_FULLBODY_IKSOLVER_METHOD_1_AD86BB23236ADD43_OFFSET UNITYSDK_OFFSET(0xA3F9E50)
#define RPG_CLIENT_FULLBODY_IKSOLVER_METHOD_1_FA662896843C137A_OFFSET UNITYSDK_OFFSET(0xA3F9AF0)
#define RPG_CLIENT_FULLBODY_IKSOLVER_SET_INITIATED_OFFSET UNITYSDK_OFFSET(0xA3F9CD0)
#define RPG_CLIENT_FULLBODY_IKSOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0xA3FA420)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int IKSolver_TypeDefinitionIndex = 68361;
