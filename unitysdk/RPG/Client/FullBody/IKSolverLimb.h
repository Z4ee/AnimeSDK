...
#define RPG_CLIENT_FULLBODY_IKSOLVERLIMB_GET_AXISDIRECTIONS_OFFSET UNITYSDK_OFFSET(0x9744DA0)
#define RPG_CLIENT_FULLBODY_IKSOLVERLIMB_METHOD_3_06B2B8EE44199AB7_OFFSET UNITYSDK_OFFSET(0x9743590)
#define RPG_CLIENT_FULLBODY_IKSOLVERLIMB_METHOD_3_0E142E3463F30350_OFFSET UNITYSDK_OFFSET(0x9743790)
#define RPG_CLIENT_FULLBODY_IKSOLVERLIMB_METHOD_3_209AC60266898FC2_OFFSET UNITYSDK_OFFSET(0x97438F0)
#define RPG_CLIENT_FULLBODY_IKSOLVERLIMB_METHOD_3_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0x9744A40)
#define RPG_CLIENT_FULLBODY_IKSOLVERLIMB_METHOD_3_82E992240300FB30_OFFSET UNITYSDK_OFFSET(0x9742830)
#define RPG_CLIENT_FULLBODY_IKSOLVERLIMB_METHOD_3_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x97427A0)
#define RPG_CLIENT_FULLBODY_IKSOLVERLIMB_METHOD_3_B768DA94E3FD91D9_OFFSET UNITYSDK_OFFSET(0x9743110)
#define RPG_CLIENT_FULLBODY_IKSOLVERLIMB_METHOD_3_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x9744F90)
#define RPG_CLIENT_FULLBODY_IKSOLVERLIMB_METHOD_3_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0x9745010)
#define RPG_CLIENT_FULLBODY_IKSOLVERLIMB_METHOD_3_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x9744F10)
#define RPG_CLIENT_FULLBODY_IKSOLVERLIMB__CTOR_1_OFFSET UNITYSDK_OFFSET(0x9744D20)
#define RPG_CLIENT_FULLBODY_IKSOLVERLIMB__CTOR_OFFSET UNITYSDK_OFFSET(0x9744B60)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int IKSolverLimb_TypeDefinitionIndex = 60922;
