...
#define RPG_CLIENT_FULLBODY_IKSOLVER_BONE_METHOD_2_0EC9AEC5DC94C3DD_1_OFFSET UNITYSDK_OFFSET(0x16D499D0)
#define RPG_CLIENT_FULLBODY_IKSOLVER_BONE_METHOD_2_0EC9AEC5DC94C3DD_OFFSET UNITYSDK_OFFSET(0x16D490D0)
#define RPG_CLIENT_FULLBODY_IKSOLVER_BONE_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x16D49D70)
#define RPG_CLIENT_FULLBODY_IKSOLVER_BONE_METHOD_2_F4F7B088C1B5D6D7_OFFSET UNITYSDK_OFFSET(0x16D49560)
#define RPG_CLIENT_FULLBODY_IKSOLVER_BONE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x16D49E40)
#define RPG_CLIENT_FULLBODY_IKSOLVER_BONE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x16D49E80)
#define RPG_CLIENT_FULLBODY_IKSOLVER_BONE__CTOR_OFFSET UNITYSDK_OFFSET(0x16D49DE0)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int IKSolver_Bone_TypeDefinitionIndex = 70858;
