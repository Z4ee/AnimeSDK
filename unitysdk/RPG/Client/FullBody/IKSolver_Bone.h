...
#define RPG_CLIENT_FULLBODY_IKSOLVER_BONE_METHOD_2_0EC9AEC5DC94C3DD_1_OFFSET UNITYSDK_OFFSET(0xBA95EF0)
#define RPG_CLIENT_FULLBODY_IKSOLVER_BONE_METHOD_2_0EC9AEC5DC94C3DD_OFFSET UNITYSDK_OFFSET(0xBA955F0)
#define RPG_CLIENT_FULLBODY_IKSOLVER_BONE_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xBA96290)
#define RPG_CLIENT_FULLBODY_IKSOLVER_BONE_METHOD_2_F4F7B088C1B5D6D7_OFFSET UNITYSDK_OFFSET(0xBA95A80)
#define RPG_CLIENT_FULLBODY_IKSOLVER_BONE__CTOR_1_OFFSET UNITYSDK_OFFSET(0xBA96360)
#define RPG_CLIENT_FULLBODY_IKSOLVER_BONE__CTOR_2_OFFSET UNITYSDK_OFFSET(0xBA963A0)
#define RPG_CLIENT_FULLBODY_IKSOLVER_BONE__CTOR_OFFSET UNITYSDK_OFFSET(0xBA96300)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int IKSolver_Bone_TypeDefinitionIndex = 69337;
