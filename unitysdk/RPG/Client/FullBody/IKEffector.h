...
#define RPG_CLIENT_FULLBODY_IKEFFECTOR_GET_ISENDEFFECTOR_OFFSET UNITYSDK_OFFSET(0xBA8C6A0)
#define RPG_CLIENT_FULLBODY_IKEFFECTOR_METHOD_1_036297786760DCCD_OFFSET UNITYSDK_OFFSET(0xBA8D7D0)
#define RPG_CLIENT_FULLBODY_IKEFFECTOR_METHOD_1_03A1AC84763ACA7B_OFFSET UNITYSDK_OFFSET(0xBA8C6C0)
#define RPG_CLIENT_FULLBODY_IKEFFECTOR_METHOD_1_3E66374F7EBEF0C3_OFFSET UNITYSDK_OFFSET(0xBA8CE40)
#define RPG_CLIENT_FULLBODY_IKEFFECTOR_METHOD_1_427DA2D5A5420560_OFFSET UNITYSDK_OFFSET(0xBA8D010)
#define RPG_CLIENT_FULLBODY_IKEFFECTOR_METHOD_1_4D9D8D32416652E5_OFFSET UNITYSDK_OFFSET(0xBA8D9C0)
#define RPG_CLIENT_FULLBODY_IKEFFECTOR_METHOD_1_AC41839A69ACE562_OFFSET UNITYSDK_OFFSET(0xBA8DD70)
#define RPG_CLIENT_FULLBODY_IKEFFECTOR_METHOD_1_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0xBA8CF60)
#define RPG_CLIENT_FULLBODY_IKEFFECTOR_METHOD_1_BA8FDCAA3DBC2800_OFFSET UNITYSDK_OFFSET(0xBA8C980)
#define RPG_CLIENT_FULLBODY_IKEFFECTOR_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xBA8D780)
#define RPG_CLIENT_FULLBODY_IKEFFECTOR_METHOD_1_E7EA3C355E8D3AFF_OFFSET UNITYSDK_OFFSET(0xBA8C600)
#define RPG_CLIENT_FULLBODY_IKEFFECTOR_METHOD_1_F488396416325F74_OFFSET UNITYSDK_OFFSET(0xBA8CBB0)
#define RPG_CLIENT_FULLBODY_IKEFFECTOR_SET_ISENDEFFECTOR_OFFSET UNITYSDK_OFFSET(0xBA8C6B0)
#define RPG_CLIENT_FULLBODY_IKEFFECTOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0xBA8C8B0)
#define RPG_CLIENT_FULLBODY_IKEFFECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0xBA8C7F0)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int IKEffector_TypeDefinitionIndex = 69328;
