...
#define RPG_CLIENT_FULLBODY_IKEFFECTOR_GET_ISENDEFFECTOR_OFFSET UNITYSDK_OFFSET(0x9730250)
#define RPG_CLIENT_FULLBODY_IKEFFECTOR_METHOD_1_036297786760DCCD_OFFSET UNITYSDK_OFFSET(0x9731460)
#define RPG_CLIENT_FULLBODY_IKEFFECTOR_METHOD_1_03A1AC84763ACA7B_OFFSET UNITYSDK_OFFSET(0x9730270)
#define RPG_CLIENT_FULLBODY_IKEFFECTOR_METHOD_1_189647D441CDAF77_OFFSET UNITYSDK_OFFSET(0x9731A40)
#define RPG_CLIENT_FULLBODY_IKEFFECTOR_METHOD_1_3E66374F7EBEF0C3_OFFSET UNITYSDK_OFFSET(0x9730A50)
#define RPG_CLIENT_FULLBODY_IKEFFECTOR_METHOD_1_4D9D8D32416652E5_OFFSET UNITYSDK_OFFSET(0x9731650)
#define RPG_CLIENT_FULLBODY_IKEFFECTOR_METHOD_1_6BA8F245384CE529_OFFSET UNITYSDK_OFFSET(0x9730C40)
#define RPG_CLIENT_FULLBODY_IKEFFECTOR_METHOD_1_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x9730B90)
#define RPG_CLIENT_FULLBODY_IKEFFECTOR_METHOD_1_C64F1EEE090BF7DB_OFFSET UNITYSDK_OFFSET(0x9730530)
#define RPG_CLIENT_FULLBODY_IKEFFECTOR_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x9731410)
#define RPG_CLIENT_FULLBODY_IKEFFECTOR_METHOD_1_E7EA3C355E8D3AFF_OFFSET UNITYSDK_OFFSET(0x9730190)
#define RPG_CLIENT_FULLBODY_IKEFFECTOR_METHOD_1_F488396416325F74_OFFSET UNITYSDK_OFFSET(0x97307A0)
#define RPG_CLIENT_FULLBODY_IKEFFECTOR_SET_ISENDEFFECTOR_OFFSET UNITYSDK_OFFSET(0x9730260)
#define RPG_CLIENT_FULLBODY_IKEFFECTOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x9730460)
#define RPG_CLIENT_FULLBODY_IKEFFECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x97303A0)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int IKEffector_TypeDefinitionIndex = 60905;
	...
	public:
		...
		::System::Boolean Method_1_C64F1EEE090BF7DB(::RPG::Client::FullBody::IKSolver* a1, ::System::String*& a2)
		{
			return ((::System::Boolean(*)(::PVOID, ::RPG::Client::FullBody::IKSolver*, ::System::String*&))((::PBYTE)hIl2Cpp + RPG_CLIENT_FULLBODY_IKEFFECTOR_METHOD_1_C64F1EEE090BF7DB_OFFSET))(this, a1, a2);
		}
