...
#define RPG_CLIENT_FULLBODY_IKMAPPING_BONEMAP_GET_ISNODEBONE_OFFSET UNITYSDK_OFFSET(0x16D42360)
#define RPG_CLIENT_FULLBODY_IKMAPPING_BONEMAP_GET_LASTANIMATEDTARGETROTATION_OFFSET UNITYSDK_OFFSET(0x16D42E80)
#define RPG_CLIENT_FULLBODY_IKMAPPING_BONEMAP_GET_SWINGDIRECTION_OFFSET UNITYSDK_OFFSET(0x16D42050)
#define RPG_CLIENT_FULLBODY_IKMAPPING_BONEMAP_METHOD_1_036297786760DCCD_OFFSET UNITYSDK_OFFSET(0x16D43640)
#define RPG_CLIENT_FULLBODY_IKMAPPING_BONEMAP_METHOD_1_1A473A8AF62E993A_OFFSET UNITYSDK_OFFSET(0x16D43820)
#define RPG_CLIENT_FULLBODY_IKMAPPING_BONEMAP_METHOD_1_2A3A99221D05589B_OFFSET UNITYSDK_OFFSET(0x16D43290)
#define RPG_CLIENT_FULLBODY_IKMAPPING_BONEMAP_METHOD_1_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0x16D431B0)
#define RPG_CLIENT_FULLBODY_IKMAPPING_BONEMAP_METHOD_1_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0x16D43220)
#define RPG_CLIENT_FULLBODY_IKMAPPING_BONEMAP_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x16D43130)
#define RPG_CLIENT_FULLBODY_IKMAPPING_BONEMAP_METHOD_1_4A5B3C87906AE918_OFFSET UNITYSDK_OFFSET(0x16D42510)
#define RPG_CLIENT_FULLBODY_IKMAPPING_BONEMAP_METHOD_1_5422D32F23CD1298_OFFSET UNITYSDK_OFFSET(0x16D443C0)
#define RPG_CLIENT_FULLBODY_IKMAPPING_BONEMAP_METHOD_1_672E3DECEBB4A051_OFFSET UNITYSDK_OFFSET(0x16D42B10)
#define RPG_CLIENT_FULLBODY_IKMAPPING_BONEMAP_METHOD_1_6A3DFC5A5BD896B1_OFFSET UNITYSDK_OFFSET(0x16D42A20)
#define RPG_CLIENT_FULLBODY_IKMAPPING_BONEMAP_METHOD_1_7A012523248AE06A_OFFSET UNITYSDK_OFFSET(0x16D438B0)
#define RPG_CLIENT_FULLBODY_IKMAPPING_BONEMAP_METHOD_1_871AC6DBEB0AF4F3_OFFSET UNITYSDK_OFFSET(0x16D42820)
#define RPG_CLIENT_FULLBODY_IKMAPPING_BONEMAP_METHOD_1_89CEA643C7DC0619_OFFSET UNITYSDK_OFFSET(0x16D41FD0)
#define RPG_CLIENT_FULLBODY_IKMAPPING_BONEMAP_METHOD_1_8C4AEC0BC1CA0CB4_OFFSET UNITYSDK_OFFSET(0x16D442D0)
#define RPG_CLIENT_FULLBODY_IKMAPPING_BONEMAP_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x16D42200)
#define RPG_CLIENT_FULLBODY_IKMAPPING_BONEMAP_METHOD_1_9C550482A5467161_OFFSET UNITYSDK_OFFSET(0x16D424B0)
#define RPG_CLIENT_FULLBODY_IKMAPPING_BONEMAP_METHOD_1_A03C765EBC5D1677_OFFSET UNITYSDK_OFFSET(0x16D43AA0)
#define RPG_CLIENT_FULLBODY_IKMAPPING_BONEMAP_METHOD_1_BF7FB88706E4AC65_OFFSET UNITYSDK_OFFSET(0x16D43400)
#define RPG_CLIENT_FULLBODY_IKMAPPING_BONEMAP_METHOD_1_CFACABBC63158155_1_OFFSET UNITYSDK_OFFSET(0x16D43F30)
#define RPG_CLIENT_FULLBODY_IKMAPPING_BONEMAP_METHOD_1_CFACABBC63158155_OFFSET UNITYSDK_OFFSET(0x16D43B90)
#define RPG_CLIENT_FULLBODY_IKMAPPING_BONEMAP_METHOD_1_F2FD171383AF1C78_OFFSET UNITYSDK_OFFSET(0x16D42370)
#define RPG_CLIENT_FULLBODY_IKMAPPING_BONEMAP_METHOD_1_FDE09C8D62639E3E_OFFSET UNITYSDK_OFFSET(0x16D422C0)
#define RPG_CLIENT_FULLBODY_IKMAPPING_BONEMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x16D44570)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int IKMapping_BoneMap_TypeDefinitionIndex = 70851;
