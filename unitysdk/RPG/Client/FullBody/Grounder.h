...
#define RPG_CLIENT_FULLBODY_GROUNDER_GET_INITIATED_OFFSET UNITYSDK_OFFSET(0xBA804F0)
#define RPG_CLIENT_FULLBODY_GROUNDER_GET_ISIKENABLED_OFFSET UNITYSDK_OFFSET(0xBA80450)
#define RPG_CLIENT_FULLBODY_GROUNDER_GET_ISIKUPDATEENABLED_OFFSET UNITYSDK_OFFSET(0xBA804E0)
#define RPG_CLIENT_FULLBODY_GROUNDER_METHOD_5_050E70FEDB783306_OFFSET UNITYSDK_OFFSET(0xBA80A40)
#define RPG_CLIENT_FULLBODY_GROUNDER_METHOD_5_135A6C290305C949_OFFSET UNITYSDK_OFFSET(0xBA80A90)
#define RPG_CLIENT_FULLBODY_GROUNDER_METHOD_5_627C7524E98F4AC5_1_OFFSET UNITYSDK_OFFSET(0xBA810A0)
#define RPG_CLIENT_FULLBODY_GROUNDER_METHOD_5_627C7524E98F4AC5_OFFSET UNITYSDK_OFFSET(0xBA81010)
#define RPG_CLIENT_FULLBODY_GROUNDER_METHOD_5_7744894CEC41BF06_OFFSET UNITYSDK_OFFSET(0xBA81130)
#define RPG_CLIENT_FULLBODY_GROUNDER_METHOD_5_968FC12B18A43BC3_OFFSET UNITYSDK_OFFSET(0xBA80630)
#define RPG_CLIENT_FULLBODY_GROUNDER_METHOD_5_E39C6E87494B02E3_OFFSET UNITYSDK_OFFSET(0xBA80510)
#define RPG_CLIENT_FULLBODY_GROUNDER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xBA80F70)
#define RPG_CLIENT_FULLBODY_GROUNDER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xBA80ED0)
#define RPG_CLIENT_FULLBODY_GROUNDER_SET_INITIATED_OFFSET UNITYSDK_OFFSET(0xBA80500)
#define RPG_CLIENT_FULLBODY_GROUNDER_SET_ISIKENABLED_OFFSET UNITYSDK_OFFSET(0xBA80460)
#define RPG_CLIENT_FULLBODY_GROUNDER__CTOR_OFFSET UNITYSDK_OFFSET(0xBA81250)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int Grounder_TypeDefinitionIndex = 69310;
