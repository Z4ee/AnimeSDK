...
#define RPG_CLIENT_FULLBODY_NEWLIMBIK_GETIKSOLVER_OFFSET UNITYSDK_OFFSET(0xD0C80E0)
#define RPG_CLIENT_FULLBODY_NEWLIMBIK_METHOD_7_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0xD0E9CD0)
#define RPG_CLIENT_FULLBODY_NEWLIMBIK_METHOD_7_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0xD0E9D40)
#define RPG_CLIENT_FULLBODY_NEWLIMBIK_METHOD_7_4343F372F34C05BF_3_OFFSET UNITYSDK_OFFSET(0xD0E9DB0)
#define RPG_CLIENT_FULLBODY_NEWLIMBIK_METHOD_7_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xD0E9C60)
#define RPG_CLIENT_FULLBODY_NEWLIMBIK__CTOR_OFFSET UNITYSDK_OFFSET(0xD0E9E20)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int NewLimbIK_TypeDefinitionIndex = 74174;
