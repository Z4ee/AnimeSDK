...
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_0A5B38E728E2F131_OFFSET UNITYSDK_OFFSET(0x16D322F0)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_11B44307560B914A_1_OFFSET UNITYSDK_OFFSET(0x16D30A00)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_11B44307560B914A_OFFSET UNITYSDK_OFFSET(0x16D2F420)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_34F7947C923561B2_OFFSET UNITYSDK_OFFSET(0x16D2F0D0)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_4E79B4E99E5C3D83_OFFSET UNITYSDK_OFFSET(0x16D32800)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_6A31223AFFE8E0B6_OFFSET UNITYSDK_OFFSET(0x16D2EE40)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_7070204E61FA9553_OFFSET UNITYSDK_OFFSET(0x16D32D90)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_71844229BB8A53C3_OFFSET UNITYSDK_OFFSET(0x16D31F70)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_ACEEEF175975141F_OFFSET UNITYSDK_OFFSET(0x16D31100)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_ADE65C435D7ECF4B_OFFSET UNITYSDK_OFFSET(0x16D2F190)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_B10F9C763249D5FB_OFFSET UNITYSDK_OFFSET(0x16D2EFB0)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_B38B48E6FC310048_OFFSET UNITYSDK_OFFSET(0x16D30120)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_B7150905C6969EA6_OFFSET UNITYSDK_OFFSET(0x16D30D50)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_CA9AD3D703CC4954_OFFSET UNITYSDK_OFFSET(0x16D32A50)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_CCE12794AD0BC1CF_OFFSET UNITYSDK_OFFSET(0x16D33120)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_D945CEAD343B5366_OFFSET UNITYSDK_OFFSET(0x16D329B0)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_E906C7CD9400968A_OFFSET UNITYSDK_OFFSET(0x16D32BF0)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_FB3362979DC6F5ED_OFFSET UNITYSDK_OFFSET(0x16D32F90)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN__CTOR_1_OFFSET UNITYSDK_OFFSET(0x16D2ED60)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN__CTOR_OFFSET UNITYSDK_OFFSET(0x16D2ECB0)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int FBIKChain_TypeDefinitionIndex = 70828;
