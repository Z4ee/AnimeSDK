...
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_0A5B38E728E2F131_OFFSET UNITYSDK_OFFSET(0x1936BF40)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_11B44307560B914A_1_OFFSET UNITYSDK_OFFSET(0x1936A650)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_11B44307560B914A_OFFSET UNITYSDK_OFFSET(0x19369070)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_34F7947C923561B2_OFFSET UNITYSDK_OFFSET(0x19368D20)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_4E79B4E99E5C3D83_OFFSET UNITYSDK_OFFSET(0x1936C450)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_6A31223AFFE8E0B6_OFFSET UNITYSDK_OFFSET(0x19368A90)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_7070204E61FA9553_OFFSET UNITYSDK_OFFSET(0x1936C9E0)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_71844229BB8A53C3_OFFSET UNITYSDK_OFFSET(0x1936BBC0)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_ACEEEF175975141F_OFFSET UNITYSDK_OFFSET(0x1936AD50)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_ADE65C435D7ECF4B_OFFSET UNITYSDK_OFFSET(0x19368DE0)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_B10F9C763249D5FB_OFFSET UNITYSDK_OFFSET(0x19368C00)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_B38B48E6FC310048_OFFSET UNITYSDK_OFFSET(0x19369D70)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_B7150905C6969EA6_OFFSET UNITYSDK_OFFSET(0x1936A9A0)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_CA9AD3D703CC4954_OFFSET UNITYSDK_OFFSET(0x1936C6A0)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_CCE12794AD0BC1CF_OFFSET UNITYSDK_OFFSET(0x1936CD70)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_D945CEAD343B5366_OFFSET UNITYSDK_OFFSET(0x1936C600)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_E906C7CD9400968A_OFFSET UNITYSDK_OFFSET(0x1936C840)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_METHOD_1_FB3362979DC6F5ED_OFFSET UNITYSDK_OFFSET(0x1936CBE0)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN__CTOR_1_OFFSET UNITYSDK_OFFSET(0x193689B0)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN__CTOR_OFFSET UNITYSDK_OFFSET(0x19368900)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int FBIKChain_TypeDefinitionIndex = 74127;
