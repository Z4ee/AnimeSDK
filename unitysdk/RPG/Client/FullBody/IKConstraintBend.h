...
#define RPG_CLIENT_FULLBODY_IKCONSTRAINTBEND_GET_INITIATED_OFFSET UNITYSDK_OFFSET(0x16D3EF30)
#define RPG_CLIENT_FULLBODY_IKCONSTRAINTBEND_METHOD_1_2787325FBE894674_OFFSET UNITYSDK_OFFSET(0x16D3F2B0)
#define RPG_CLIENT_FULLBODY_IKCONSTRAINTBEND_METHOD_1_35EDB68198B7034F_OFFSET UNITYSDK_OFFSET(0x16D2FB20)
#define RPG_CLIENT_FULLBODY_IKCONSTRAINTBEND_METHOD_1_6C6B39C825927D70_1_OFFSET UNITYSDK_OFFSET(0x16D3F1A0)
#define RPG_CLIENT_FULLBODY_IKCONSTRAINTBEND_METHOD_1_6C6B39C825927D70_OFFSET UNITYSDK_OFFSET(0x16D3F080)
#define RPG_CLIENT_FULLBODY_IKCONSTRAINTBEND_METHOD_1_CDB9356E62DEB3C0_OFFSET UNITYSDK_OFFSET(0x16D3EB50)
#define RPG_CLIENT_FULLBODY_IKCONSTRAINTBEND_METHOD_1_D945CEAD343B5366_OFFSET UNITYSDK_OFFSET(0x16D2FB90)
#define RPG_CLIENT_FULLBODY_IKCONSTRAINTBEND_METHOD_1_E77295995B04931B_OFFSET UNITYSDK_OFFSET(0x16D314A0)
#define RPG_CLIENT_FULLBODY_IKCONSTRAINTBEND_METHOD_1_F552CBD036D44B0E_OFFSET UNITYSDK_OFFSET(0x16D3F570)
#define RPG_CLIENT_FULLBODY_IKCONSTRAINTBEND_SET_INITIATED_OFFSET UNITYSDK_OFFSET(0x16D3EF40)
#define RPG_CLIENT_FULLBODY_IKCONSTRAINTBEND__CTOR_1_OFFSET UNITYSDK_OFFSET(0x16D3EF50)
#define RPG_CLIENT_FULLBODY_IKCONSTRAINTBEND__CTOR_OFFSET UNITYSDK_OFFSET(0x16D2ED40)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int IKConstraintBend_TypeDefinitionIndex = 70848;
