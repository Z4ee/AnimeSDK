...
#define RPG_CLIENT_FULLBODY_IKCONSTRAINTBEND_GET_INITIATED_OFFSET UNITYSDK_OFFSET(0xBA8B8B0)
#define RPG_CLIENT_FULLBODY_IKCONSTRAINTBEND_METHOD_1_2787325FBE894674_OFFSET UNITYSDK_OFFSET(0xBA8BB80)
#define RPG_CLIENT_FULLBODY_IKCONSTRAINTBEND_METHOD_1_35EDB68198B7034F_OFFSET UNITYSDK_OFFSET(0xBA7C940)
#define RPG_CLIENT_FULLBODY_IKCONSTRAINTBEND_METHOD_1_6C6B39C825927D70_1_OFFSET UNITYSDK_OFFSET(0xBA8BA70)
#define RPG_CLIENT_FULLBODY_IKCONSTRAINTBEND_METHOD_1_6C6B39C825927D70_OFFSET UNITYSDK_OFFSET(0xBA8B950)
#define RPG_CLIENT_FULLBODY_IKCONSTRAINTBEND_METHOD_1_CDB9356E62DEB3C0_OFFSET UNITYSDK_OFFSET(0xBA8B770)
#define RPG_CLIENT_FULLBODY_IKCONSTRAINTBEND_METHOD_1_D945CEAD343B5366_OFFSET UNITYSDK_OFFSET(0xBA7C9B0)
#define RPG_CLIENT_FULLBODY_IKCONSTRAINTBEND_METHOD_1_E77295995B04931B_OFFSET UNITYSDK_OFFSET(0xBA7E2C0)
#define RPG_CLIENT_FULLBODY_IKCONSTRAINTBEND_METHOD_1_F552CBD036D44B0E_OFFSET UNITYSDK_OFFSET(0xBA8BE40)
#define RPG_CLIENT_FULLBODY_IKCONSTRAINTBEND_SET_INITIATED_OFFSET UNITYSDK_OFFSET(0xBA8B8C0)
#define RPG_CLIENT_FULLBODY_IKCONSTRAINTBEND__CTOR_1_OFFSET UNITYSDK_OFFSET(0xBA8B8D0)
#define RPG_CLIENT_FULLBODY_IKCONSTRAINTBEND__CTOR_OFFSET UNITYSDK_OFFSET(0xBA7BB60)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int IKConstraintBend_TypeDefinitionIndex = 69327;
