...
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_CHILDCONSTRAINT_GET_ISRIGID_OFFSET UNITYSDK_OFFSET(0xBA80410)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_CHILDCONSTRAINT_GET_NOMINALDISTANCE_OFFSET UNITYSDK_OFFSET(0xBA803F0)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_CHILDCONSTRAINT_METHOD_1_1F9A386CD1061734_OFFSET UNITYSDK_OFFSET(0xBA800D0)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_CHILDCONSTRAINT_METHOD_1_2B9F611A895AA45C_OFFSET UNITYSDK_OFFSET(0xBA7C8C0)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_CHILDCONSTRAINT_METHOD_1_A24EF832801448FD_OFFSET UNITYSDK_OFFSET(0xBA7D550)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_CHILDCONSTRAINT_SET_ISRIGID_OFFSET UNITYSDK_OFFSET(0xBA80420)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_CHILDCONSTRAINT_SET_NOMINALDISTANCE_OFFSET UNITYSDK_OFFSET(0xBA80400)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_CHILDCONSTRAINT__CTOR_OFFSET UNITYSDK_OFFSET(0xBA80430)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int FBIKChain_ChildConstraint_TypeDefinitionIndex = 69308;
