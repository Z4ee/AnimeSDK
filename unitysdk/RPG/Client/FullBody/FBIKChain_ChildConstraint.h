...
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_CHILDCONSTRAINT_GET_ISRIGID_OFFSET UNITYSDK_OFFSET(0xD0C6530)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_CHILDCONSTRAINT_GET_NOMINALDISTANCE_OFFSET UNITYSDK_OFFSET(0xD0C6510)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_CHILDCONSTRAINT_METHOD_1_1F9A386CD1061734_OFFSET UNITYSDK_OFFSET(0xD0C61F0)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_CHILDCONSTRAINT_METHOD_1_2B9F611A895AA45C_OFFSET UNITYSDK_OFFSET(0xD0C29E0)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_CHILDCONSTRAINT_METHOD_1_A24EF832801448FD_OFFSET UNITYSDK_OFFSET(0xD0C3670)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_CHILDCONSTRAINT_SET_ISRIGID_OFFSET UNITYSDK_OFFSET(0xD0C6540)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_CHILDCONSTRAINT_SET_NOMINALDISTANCE_OFFSET UNITYSDK_OFFSET(0xD0C6520)
#define RPG_CLIENT_FULLBODY_FBIKCHAIN_CHILDCONSTRAINT__CTOR_OFFSET UNITYSDK_OFFSET(0xD0C6550)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int FBIKChain_ChildConstraint_TypeDefinitionIndex = 74129;
