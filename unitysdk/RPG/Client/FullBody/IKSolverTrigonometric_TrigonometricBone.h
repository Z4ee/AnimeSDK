...
#define RPG_CLIENT_FULLBODY_IKSOLVERTRIGONOMETRIC_TRIGONOMETRICBONE_METHOD_3_77FD543600E00498_OFFSET UNITYSDK_OFFSET(0x9742C70)
#define RPG_CLIENT_FULLBODY_IKSOLVERTRIGONOMETRIC_TRIGONOMETRICBONE_METHOD_3_7B0365A8073C120F_OFFSET UNITYSDK_OFFSET(0x9747D30)
#define RPG_CLIENT_FULLBODY_IKSOLVERTRIGONOMETRIC_TRIGONOMETRICBONE_METHOD_3_A4F3D407B322D681_OFFSET UNITYSDK_OFFSET(0x9742E20)
#define RPG_CLIENT_FULLBODY_IKSOLVERTRIGONOMETRIC_TRIGONOMETRICBONE__CTOR_OFFSET UNITYSDK_OFFSET(0x9747EB0)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int IKSolverTrigonometric_TrigonometricBone_TypeDefinitionIndex = 60926;
