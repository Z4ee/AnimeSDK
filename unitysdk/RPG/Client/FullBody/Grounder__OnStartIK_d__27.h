...
#define RPG_CLIENT_FULLBODY_GROUNDER__ONSTARTIK_D__27_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x16D34980)
#define RPG_CLIENT_FULLBODY_GROUNDER__ONSTARTIK_D__27_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x16D349A0)
#define RPG_CLIENT_FULLBODY_GROUNDER__ONSTARTIK_D__27_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x16D34A00)
#define RPG_CLIENT_FULLBODY_GROUNDER__ONSTARTIK_D__27_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x16D349B0)
#define RPG_CLIENT_FULLBODY_GROUNDER__ONSTARTIK_D__27_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16D34970)
#define RPG_CLIENT_FULLBODY_GROUNDER__ONSTARTIK_D__27__CTOR_OFFSET UNITYSDK_OFFSET(0x16D34490)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int Grounder__OnStartIK_d__27_TypeDefinitionIndex = 70833;
