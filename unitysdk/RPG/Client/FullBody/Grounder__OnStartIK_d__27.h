...
#define RPG_CLIENT_FULLBODY_GROUNDER__ONSTARTIK_D__27_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xD0C7900)
#define RPG_CLIENT_FULLBODY_GROUNDER__ONSTARTIK_D__27_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xD0C7920)
#define RPG_CLIENT_FULLBODY_GROUNDER__ONSTARTIK_D__27_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xD0C7980)
#define RPG_CLIENT_FULLBODY_GROUNDER__ONSTARTIK_D__27_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xD0C7930)
#define RPG_CLIENT_FULLBODY_GROUNDER__ONSTARTIK_D__27_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD0C78F0)
#define RPG_CLIENT_FULLBODY_GROUNDER__ONSTARTIK_D__27__CTOR_OFFSET UNITYSDK_OFFSET(0xD0C73D0)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int Grounder__OnStartIK_d__27_TypeDefinitionIndex = 74133;
