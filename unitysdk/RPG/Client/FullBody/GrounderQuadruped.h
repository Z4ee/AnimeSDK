...
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_FORCERESET_OFFSET UNITYSDK_OFFSET(0xA3E4180)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_GET_FINALWEIGHT_OFFSET UNITYSDK_OFFSET(0xA3E3B90)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_GET_ISIKUPDATEENABLED_OFFSET UNITYSDK_OFFSET(0xA3E3B40)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xA3E53A0)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_MANUALUPDATE_OFFSET UNITYSDK_OFFSET(0xA3E3BE0)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_METHOD_6_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0xA3E54F0)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_METHOD_6_18982EFD3B740683_OFFSET UNITYSDK_OFFSET(0xA3E6CC0)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_METHOD_6_2A74484E06FA28B1_OFFSET UNITYSDK_OFFSET(0xA3E4250)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_METHOD_6_2C4180681033D073_OFFSET UNITYSDK_OFFSET(0xA3E4320)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_METHOD_6_41F871B735F19572_OFFSET UNITYSDK_OFFSET(0xA3E4AC0)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_METHOD_6_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0xA3E3AD0)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_METHOD_6_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xA3E3A60)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_METHOD_6_5E6D8BB697956401_OFFSET UNITYSDK_OFFSET(0xA3E7420)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_METHOD_6_5EAB2C5E0D76A6B7_OFFSET UNITYSDK_OFFSET(0xA3E3CB0)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_METHOD_6_627C7524E98F4AC5_1_OFFSET UNITYSDK_OFFSET(0xA3E7E70)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_METHOD_6_627C7524E98F4AC5_2_OFFSET UNITYSDK_OFFSET(0xA3E8230)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_METHOD_6_627C7524E98F4AC5_3_OFFSET UNITYSDK_OFFSET(0xA3E82B0)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_METHOD_6_627C7524E98F4AC5_OFFSET UNITYSDK_OFFSET(0xA3E7DE0)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_METHOD_6_7DCB1001AAA79A6F_OFFSET UNITYSDK_OFFSET(0xA3E7BA0)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_METHOD_6_9E38127F40B34F1F_OFFSET UNITYSDK_OFFSET(0xA3E6150)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_METHOD_6_AE80CBC984AADFD5_OFFSET UNITYSDK_OFFSET(0xA3E7640)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_METHOD_6_CD28994AFE636FFF_OFFSET UNITYSDK_OFFSET(0xA3E4600)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_METHOD_6_F91F0A5E0D7E03BF_OFFSET UNITYSDK_OFFSET(0xA3E5F20)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xA3E7B30)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xA3E4420)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_ONENABLE_OFFSET UNITYSDK_OFFSET(0xA3E43B0)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_REFRESH_OFFSET UNITYSDK_OFFSET(0xA3E7F00)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_RESETPOSITION_OFFSET UNITYSDK_OFFSET(0xA3E3D60)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_UPDATE_OFFSET UNITYSDK_OFFSET(0xA3E4510)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED__CTOR_OFFSET UNITYSDK_OFFSET(0xA3E8110)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED___IFIXBASEPROXY_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xA3E8220)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED___IFIXBASEPROXY_ONENABLE_OFFSET UNITYSDK_OFFSET(0xA3E8210)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int GrounderQuadruped_TypeDefinitionIndex = 68340;
	...
	public:
		...
		::Il2CppArray<::UnityEngine::Transform*>* Method_6_41F871B735F19572(::Il2CppArray<::RPG::Client::FullBody::NewIK*>* a1, ::Il2CppArray<::RPG::Client::FullBody::GrounderQuadruped_Struct_2_F13462FCC9C87AA9>*& a2, ::System::Int32 a3)
		{
			return ((::Il2CppArray<::UnityEngine::Transform*>*(*)(::PVOID, ::Il2CppArray<::RPG::Client::FullBody::NewIK*>*, ::Il2CppArray<::RPG::Client::FullBody::GrounderQuadruped_Struct_2_F13462FCC9C87AA9>*&, ::System::Int32))((::PBYTE)hIl2Cpp + RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_METHOD_6_41F871B735F19572_OFFSET))(this, a1, a2, a3);
		}
