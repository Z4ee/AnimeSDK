...
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_FORCERESET_OFFSET UNITYSDK_OFFSET(0x16D35250)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_GET_FINALWEIGHT_OFFSET UNITYSDK_OFFSET(0x16D34CA0)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_GET_ISIKUPDATEENABLED_OFFSET UNITYSDK_OFFSET(0x16D34C50)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x16D36430)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_MANUALUPDATE_OFFSET UNITYSDK_OFFSET(0x16D34CF0)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_METHOD_6_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0x16D36580)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_METHOD_6_18982EFD3B740683_OFFSET UNITYSDK_OFFSET(0x16D37CD0)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_METHOD_6_218124418542E081_OFFSET UNITYSDK_OFFSET(0x16D371E0)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_METHOD_6_2A74484E06FA28B1_OFFSET UNITYSDK_OFFSET(0x16D352E0)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_METHOD_6_2C4180681033D073_OFFSET UNITYSDK_OFFSET(0x16D353B0)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_METHOD_6_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0x16D34BE0)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_METHOD_6_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x16D34B70)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_METHOD_6_5E6D8BB697956401_OFFSET UNITYSDK_OFFSET(0x16D38420)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_METHOD_6_5EAB2C5E0D76A6B7_OFFSET UNITYSDK_OFFSET(0x16D34DC0)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_METHOD_6_627C7524E98F4AC5_1_OFFSET UNITYSDK_OFFSET(0x16D38F30)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_METHOD_6_627C7524E98F4AC5_OFFSET UNITYSDK_OFFSET(0x16D38EA0)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_METHOD_6_8F0FFD4F86CFEC1A_OFFSET UNITYSDK_OFFSET(0x16D35B80)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_METHOD_6_AE80CBC984AADFD5_OFFSET UNITYSDK_OFFSET(0x16D38650)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_METHOD_6_CA780F692BF1CA71_OFFSET UNITYSDK_OFFSET(0x16D38BA0)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_METHOD_6_CD28994AFE636FFF_OFFSET UNITYSDK_OFFSET(0x16D35700)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_METHOD_6_F91F0A5E0D7E03BF_OFFSET UNITYSDK_OFFSET(0x16D36FB0)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x16D38B30)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x16D354E0)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_ONENABLE_OFFSET UNITYSDK_OFFSET(0x16D35440)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_REFRESH_OFFSET UNITYSDK_OFFSET(0x16D38FC0)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_RESETPOSITION_OFFSET UNITYSDK_OFFSET(0x16D34E70)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED_UPDATE_OFFSET UNITYSDK_OFFSET(0x16D35610)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED__CTOR_OFFSET UNITYSDK_OFFSET(0x16D391A0)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int GrounderQuadruped_TypeDefinitionIndex = 70835;
