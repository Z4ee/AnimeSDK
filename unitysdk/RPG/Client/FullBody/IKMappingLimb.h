...
#define RPG_CLIENT_FULLBODY_IKMAPPINGLIMB_METHOD_2_03F8818C1383CCD8_OFFSET UNITYSDK_OFFSET(0xA3F6D00)
#define RPG_CLIENT_FULLBODY_IKMAPPINGLIMB_METHOD_2_06330CD58CB602B6_OFFSET UNITYSDK_OFFSET(0xA3F62E0)
#define RPG_CLIENT_FULLBODY_IKMAPPINGLIMB_METHOD_2_0B2BD75AED41F026_OFFSET UNITYSDK_OFFSET(0xA3F58E0)
#define RPG_CLIENT_FULLBODY_IKMAPPINGLIMB_METHOD_2_48E0E9D29DE90B49_OFFSET UNITYSDK_OFFSET(0xA3F6260)
#define RPG_CLIENT_FULLBODY_IKMAPPINGLIMB_METHOD_2_6C369E207A334515_OFFSET UNITYSDK_OFFSET(0xA3F5810)
#define RPG_CLIENT_FULLBODY_IKMAPPINGLIMB_METHOD_2_A1ADC999CFACEB89_OFFSET UNITYSDK_OFFSET(0xA3F6A60)
#define RPG_CLIENT_FULLBODY_IKMAPPINGLIMB_METHOD_2_A461AC4695F6A5F0_OFFSET UNITYSDK_OFFSET(0xA3F6D50)
#define RPG_CLIENT_FULLBODY_IKMAPPINGLIMB_METHOD_2_A6544B958241856F_OFFSET UNITYSDK_OFFSET(0xA3F6380)
#define RPG_CLIENT_FULLBODY_IKMAPPINGLIMB_METHOD_2_BA6EB7BC01785CBA_OFFSET UNITYSDK_OFFSET(0xA3F65E0)
#define RPG_CLIENT_FULLBODY_IKMAPPINGLIMB_METHOD_2_C2496B2D8317AC26_OFFSET UNITYSDK_OFFSET(0xA3F6B60)
#define RPG_CLIENT_FULLBODY_IKMAPPINGLIMB_METHOD_2_F9AF6F889DC1CC07_OFFSET UNITYSDK_OFFSET(0xA3F5950)
#define RPG_CLIENT_FULLBODY_IKMAPPINGLIMB__CTOR_1_OFFSET UNITYSDK_OFFSET(0xA3F6120)
#define RPG_CLIENT_FULLBODY_IKMAPPINGLIMB__CTOR_OFFSET UNITYSDK_OFFSET(0xA3F6040)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int IKMappingLimb_TypeDefinitionIndex = 68358;
