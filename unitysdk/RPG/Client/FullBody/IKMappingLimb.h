...
#define RPG_CLIENT_FULLBODY_IKMAPPINGLIMB_METHOD_2_06330CD58CB602B6_OFFSET UNITYSDK_OFFSET(0xD0D8360)
#define RPG_CLIENT_FULLBODY_IKMAPPINGLIMB_METHOD_2_0B2BD75AED41F026_OFFSET UNITYSDK_OFFSET(0xD0D7960)
#define RPG_CLIENT_FULLBODY_IKMAPPINGLIMB_METHOD_2_48E0E9D29DE90B49_OFFSET UNITYSDK_OFFSET(0xD0D82E0)
#define RPG_CLIENT_FULLBODY_IKMAPPINGLIMB_METHOD_2_A1ADC999CFACEB89_OFFSET UNITYSDK_OFFSET(0xD0D8AE0)
#define RPG_CLIENT_FULLBODY_IKMAPPINGLIMB_METHOD_2_A6544B958241856F_OFFSET UNITYSDK_OFFSET(0xD0D8400)
#define RPG_CLIENT_FULLBODY_IKMAPPINGLIMB_METHOD_2_BA6EB7BC01785CBA_OFFSET UNITYSDK_OFFSET(0xD0D8660)
#define RPG_CLIENT_FULLBODY_IKMAPPINGLIMB_METHOD_2_C2453B35E4DF9C3B_OFFSET UNITYSDK_OFFSET(0xD0D7890)
#define RPG_CLIENT_FULLBODY_IKMAPPINGLIMB_METHOD_2_C2496B2D8317AC26_OFFSET UNITYSDK_OFFSET(0xD0D8BE0)
#define RPG_CLIENT_FULLBODY_IKMAPPINGLIMB_METHOD_2_F9AF6F889DC1CC07_OFFSET UNITYSDK_OFFSET(0xD0D79D0)
#define RPG_CLIENT_FULLBODY_IKMAPPINGLIMB__CTOR_1_OFFSET UNITYSDK_OFFSET(0xD0D81A0)
#define RPG_CLIENT_FULLBODY_IKMAPPINGLIMB__CTOR_OFFSET UNITYSDK_OFFSET(0xD0D80C0)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int IKMappingLimb_TypeDefinitionIndex = 74153;
