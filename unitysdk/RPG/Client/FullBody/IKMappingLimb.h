...
#define RPG_CLIENT_FULLBODY_IKMAPPINGLIMB_METHOD_2_06330CD58CB602B6_OFFSET UNITYSDK_OFFSET(0xBA91AB0)
#define RPG_CLIENT_FULLBODY_IKMAPPINGLIMB_METHOD_2_0B2BD75AED41F026_OFFSET UNITYSDK_OFFSET(0xBA910B0)
#define RPG_CLIENT_FULLBODY_IKMAPPINGLIMB_METHOD_2_1C648BC3BB33C550_OFFSET UNITYSDK_OFFSET(0xBA92520)
#define RPG_CLIENT_FULLBODY_IKMAPPINGLIMB_METHOD_2_48E0E9D29DE90B49_OFFSET UNITYSDK_OFFSET(0xBA91A30)
#define RPG_CLIENT_FULLBODY_IKMAPPINGLIMB_METHOD_2_6C369E207A334515_OFFSET UNITYSDK_OFFSET(0xBA90FE0)
#define RPG_CLIENT_FULLBODY_IKMAPPINGLIMB_METHOD_2_A1ADC999CFACEB89_OFFSET UNITYSDK_OFFSET(0xBA92230)
#define RPG_CLIENT_FULLBODY_IKMAPPINGLIMB_METHOD_2_A6544B958241856F_OFFSET UNITYSDK_OFFSET(0xBA91B50)
#define RPG_CLIENT_FULLBODY_IKMAPPINGLIMB_METHOD_2_A980FB7965D4A13F_OFFSET UNITYSDK_OFFSET(0xBA924D0)
#define RPG_CLIENT_FULLBODY_IKMAPPINGLIMB_METHOD_2_BA6EB7BC01785CBA_OFFSET UNITYSDK_OFFSET(0xBA91DB0)
#define RPG_CLIENT_FULLBODY_IKMAPPINGLIMB_METHOD_2_C2496B2D8317AC26_OFFSET UNITYSDK_OFFSET(0xBA92330)
#define RPG_CLIENT_FULLBODY_IKMAPPINGLIMB_METHOD_2_F9AF6F889DC1CC07_OFFSET UNITYSDK_OFFSET(0xBA91120)
#define RPG_CLIENT_FULLBODY_IKMAPPINGLIMB__CTOR_1_OFFSET UNITYSDK_OFFSET(0xBA918F0)
#define RPG_CLIENT_FULLBODY_IKMAPPINGLIMB__CTOR_OFFSET UNITYSDK_OFFSET(0xBA91810)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int IKMappingLimb_TypeDefinitionIndex = 69332;
	...
	public:
		...
		::System::Boolean Method_2_6C369E207A334515(::RPG::Client::FullBody::IKSolver* a1, ::System::String*& a2)
		{
			return ((::System::Boolean(*)(::PVOID, ::RPG::Client::FullBody::IKSolver*, ::System::String*&))((::PBYTE)hIl2Cpp + RPG_CLIENT_FULLBODY_IKMAPPINGLIMB_METHOD_2_6C369E207A334515_OFFSET))(this, a1, a2);
		}
		...
		{
			return ((::System::Boolean(*)(::PVOID, ::RPG::Client::FullBody::IKSolver*, ::System::String*&))((::PBYTE)hIl2Cpp + RPG_CLIENT_FULLBODY_IKMAPPINGLIMB_METHOD_2_A980FB7965D4A13F_OFFSET))(this, a1, a2);
		}

		::System::Void Method_2_1C648BC3BB33C550(::RPG::Client::FullBody::IKSolverFullBody* a1)
		{
			return ((::System::Void(*)(::PVOID, ::RPG::Client::FullBody::IKSolverFullBody*))((::PBYTE)hIl2Cpp + RPG_CLIENT_FULLBODY_IKMAPPINGLIMB_METHOD_2_1C648BC3BB33C550_OFFSET))(this, a1);
		}
	};
}
