...
#define RPG_CLIENT_FULLBODY_GROUNDING_GET_ISGROUNDED_OFFSET UNITYSDK_OFFSET(0x16D39740)
#define RPG_CLIENT_FULLBODY_GROUNDING_GET_LEGS_OFFSET UNITYSDK_OFFSET(0x16D39700)
#define RPG_CLIENT_FULLBODY_GROUNDING_GET_PELVIS_OFFSET UNITYSDK_OFFSET(0x16D39720)
#define RPG_CLIENT_FULLBODY_GROUNDING_GET_ROOTGROUNDED_OFFSET UNITYSDK_OFFSET(0x16D397E0)
#define RPG_CLIENT_FULLBODY_GROUNDING_GET_ROOTHIT_OFFSET UNITYSDK_OFFSET(0x16D39780)
#define RPG_CLIENT_FULLBODY_GROUNDING_GET_ROOT_OFFSET UNITYSDK_OFFSET(0x16D39760)
#define RPG_CLIENT_FULLBODY_GROUNDING_GET_UP_OFFSET UNITYSDK_OFFSET(0x16D39C60)
#define RPG_CLIENT_FULLBODY_GROUNDING_GET_USEROOTROTATION_OFFSET UNITYSDK_OFFSET(0x16D3BA20)
#define RPG_CLIENT_FULLBODY_GROUNDING_METHOD_1_050E70FEDB783306_OFFSET UNITYSDK_OFFSET(0x16D3A1F0)
#define RPG_CLIENT_FULLBODY_GROUNDING_METHOD_1_2BE9489A09D4AB3D_OFFSET UNITYSDK_OFFSET(0x16D36080)
#define RPG_CLIENT_FULLBODY_GROUNDING_METHOD_1_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0x16D351A0)
#define RPG_CLIENT_FULLBODY_GROUNDING_METHOD_1_611142A6ECF0D805_OFFSET UNITYSDK_OFFSET(0x16D39F40)
#define RPG_CLIENT_FULLBODY_GROUNDING_METHOD_1_753A3CECCA76D6CD_OFFSET UNITYSDK_OFFSET(0x16D3BC00)
#define RPG_CLIENT_FULLBODY_GROUNDING_METHOD_1_9317D1B3EB9B664A_OFFSET UNITYSDK_OFFSET(0x16D39840)
#define RPG_CLIENT_FULLBODY_GROUNDING_METHOD_1_96A53A17AC5D0E93_OFFSET UNITYSDK_OFFSET(0x16D38170)
#define RPG_CLIENT_FULLBODY_GROUNDING_METHOD_1_A1C464B05BB7A5C1_OFFSET UNITYSDK_OFFSET(0x16D3C020)
#define RPG_CLIENT_FULLBODY_GROUNDING_METHOD_1_B81930E0C3DB546E_OFFSET UNITYSDK_OFFSET(0x16D3B470)
#define RPG_CLIENT_FULLBODY_GROUNDING_METHOD_1_C1B25D3B3F94E126_OFFSET UNITYSDK_OFFSET(0x16D3BD80)
#define RPG_CLIENT_FULLBODY_GROUNDING_SET_ISGROUNDED_OFFSET UNITYSDK_OFFSET(0x16D39750)
#define RPG_CLIENT_FULLBODY_GROUNDING_SET_LEGS_OFFSET UNITYSDK_OFFSET(0x16D39710)
#define RPG_CLIENT_FULLBODY_GROUNDING_SET_PELVIS_OFFSET UNITYSDK_OFFSET(0x16D39730)
#define RPG_CLIENT_FULLBODY_GROUNDING_SET_ROOTHIT_OFFSET UNITYSDK_OFFSET(0x16D397B0)
#define RPG_CLIENT_FULLBODY_GROUNDING_SET_ROOT_OFFSET UNITYSDK_OFFSET(0x16D39770)
#define RPG_CLIENT_FULLBODY_GROUNDING__CTOR_OFFSET UNITYSDK_OFFSET(0x16D34710)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int Grounding_TypeDefinitionIndex = 70839;
