...
#define RPG_CLIENT_FULLBODY_GROUNDING_GET_ISGROUNDED_OFFSET UNITYSDK_OFFSET(0xBA86390)
#define RPG_CLIENT_FULLBODY_GROUNDING_GET_LEGS_OFFSET UNITYSDK_OFFSET(0xBA86350)
#define RPG_CLIENT_FULLBODY_GROUNDING_GET_PELVIS_OFFSET UNITYSDK_OFFSET(0xBA86370)
#define RPG_CLIENT_FULLBODY_GROUNDING_GET_ROOTGROUNDED_OFFSET UNITYSDK_OFFSET(0xBA86430)
#define RPG_CLIENT_FULLBODY_GROUNDING_GET_ROOTHIT_OFFSET UNITYSDK_OFFSET(0xBA863D0)
#define RPG_CLIENT_FULLBODY_GROUNDING_GET_ROOT_OFFSET UNITYSDK_OFFSET(0xBA863B0)
#define RPG_CLIENT_FULLBODY_GROUNDING_GET_UP_OFFSET UNITYSDK_OFFSET(0xBA868B0)
#define RPG_CLIENT_FULLBODY_GROUNDING_GET_USEROOTROTATION_OFFSET UNITYSDK_OFFSET(0xBA88660)
#define RPG_CLIENT_FULLBODY_GROUNDING_METHOD_1_050E70FEDB783306_OFFSET UNITYSDK_OFFSET(0xBA86E40)
#define RPG_CLIENT_FULLBODY_GROUNDING_METHOD_1_2BE9489A09D4AB3D_OFFSET UNITYSDK_OFFSET(0xBA82B40)
#define RPG_CLIENT_FULLBODY_GROUNDING_METHOD_1_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0xBA81D00)
#define RPG_CLIENT_FULLBODY_GROUNDING_METHOD_1_611142A6ECF0D805_OFFSET UNITYSDK_OFFSET(0xBA86B90)
#define RPG_CLIENT_FULLBODY_GROUNDING_METHOD_1_753A3CECCA76D6CD_OFFSET UNITYSDK_OFFSET(0xBA88840)
#define RPG_CLIENT_FULLBODY_GROUNDING_METHOD_1_9317D1B3EB9B664A_OFFSET UNITYSDK_OFFSET(0xBA86490)
#define RPG_CLIENT_FULLBODY_GROUNDING_METHOD_1_96A53A17AC5D0E93_OFFSET UNITYSDK_OFFSET(0xBA84C90)
#define RPG_CLIENT_FULLBODY_GROUNDING_METHOD_1_A1C464B05BB7A5C1_OFFSET UNITYSDK_OFFSET(0xBA88C60)
#define RPG_CLIENT_FULLBODY_GROUNDING_METHOD_1_B81930E0C3DB546E_OFFSET UNITYSDK_OFFSET(0xBA880B0)
#define RPG_CLIENT_FULLBODY_GROUNDING_METHOD_1_C1B25D3B3F94E126_OFFSET UNITYSDK_OFFSET(0xBA889C0)
#define RPG_CLIENT_FULLBODY_GROUNDING_SET_ISGROUNDED_OFFSET UNITYSDK_OFFSET(0xBA863A0)
#define RPG_CLIENT_FULLBODY_GROUNDING_SET_LEGS_OFFSET UNITYSDK_OFFSET(0xBA86360)
#define RPG_CLIENT_FULLBODY_GROUNDING_SET_PELVIS_OFFSET UNITYSDK_OFFSET(0xBA86380)
#define RPG_CLIENT_FULLBODY_GROUNDING_SET_ROOTHIT_OFFSET UNITYSDK_OFFSET(0xBA86400)
#define RPG_CLIENT_FULLBODY_GROUNDING_SET_ROOT_OFFSET UNITYSDK_OFFSET(0xBA863C0)
#define RPG_CLIENT_FULLBODY_GROUNDING__CTOR_OFFSET UNITYSDK_OFFSET(0xBA812B0)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int Grounding_TypeDefinitionIndex = 69318;
