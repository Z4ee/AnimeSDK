...
#define RPG_CLIENT_FULLBODY_IKMAPPING_METHOD_1_1C648BC3BB33C550_OFFSET UNITYSDK_OFFSET(0xD0D4B80)
#define RPG_CLIENT_FULLBODY_IKMAPPING_METHOD_1_73264D810B7A8424_OFFSET UNITYSDK_OFFSET(0xD0D4BD0)
#define RPG_CLIENT_FULLBODY_IKMAPPING_METHOD_1_A980FB7965D4A13F_OFFSET UNITYSDK_OFFSET(0xD0D4B30)
#define RPG_CLIENT_FULLBODY_IKMAPPING_METHOD_1_CA9AD3D703CC4954_OFFSET UNITYSDK_OFFSET(0xD0D4D00)
#define RPG_CLIENT_FULLBODY_IKMAPPING__CTOR_OFFSET UNITYSDK_OFFSET(0xD0D4EA0)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int IKMapping_TypeDefinitionIndex = 74150;
