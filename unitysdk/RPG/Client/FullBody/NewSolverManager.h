...
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_DISABLE_OFFSET UNITYSDK_OFFSET(0xBAA3AA0)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0xBAA4270)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xBAA4340)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_METHOD_5_1808E1CF7A125519_1_OFFSET UNITYSDK_OFFSET(0xBAA4200)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_METHOD_5_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0xBAA3D60)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xBAA3C50)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_METHOD_5_62B963209E16F919_OFFSET UNITYSDK_OFFSET(0xBAA3DE0)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_METHOD_5_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xBAA36F0)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_METHOD_5_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0xBAA37F0)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xBAA3770)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xBAA3BB0)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_START_OFFSET UNITYSDK_OFFSET(0xBAA3CD0)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_UPDATESOLVEREXTERNAL_OFFSET UNITYSDK_OFFSET(0xBAA4410)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0xBAA4130)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xBAA36A0)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int NewSolverManager_TypeDefinitionIndex = 69354;
