...
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_DISABLE_OFFSET UNITYSDK_OFFSET(0xD0E9ED0)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0xD0EA7A0)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xD0EA8E0)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_METHOD_5_1808E1CF7A125519_1_OFFSET UNITYSDK_OFFSET(0xD0EA730)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_METHOD_5_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0xD0EA220)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_METHOD_5_62B963209E16F919_OFFSET UNITYSDK_OFFSET(0xD0EA2A0)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_METHOD_5_A239DF324AF4215D_OFFSET UNITYSDK_OFFSET(0xD0EA100)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_METHOD_5_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xD0EA020)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_METHOD_5_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0xD0EA060)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xD0E9FE0)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xD0EA0A0)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_START_OFFSET UNITYSDK_OFFSET(0xD0EA1D0)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_UPDATESOLVEREXTERNAL_OFFSET UNITYSDK_OFFSET(0xD0EAA20)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0xD0EA5F0)
#define RPG_CLIENT_FULLBODY_NEWSOLVERMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xD0E9C50)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int NewSolverManager_TypeDefinitionIndex = 74175;
