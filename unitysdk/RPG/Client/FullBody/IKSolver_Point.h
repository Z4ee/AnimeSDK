...
#define RPG_CLIENT_FULLBODY_IKSOLVER_POINT_METHOD_1_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0x16D4A350)
#define RPG_CLIENT_FULLBODY_IKSOLVER_POINT_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x16D4A2D0)
#define RPG_CLIENT_FULLBODY_IKSOLVER_POINT_METHOD_1_9681042564541CD6_1_OFFSET UNITYSDK_OFFSET(0x16D4A3D0)
#define RPG_CLIENT_FULLBODY_IKSOLVER_POINT_METHOD_1_9681042564541CD6_2_OFFSET UNITYSDK_OFFSET(0x16D4A490)
#define RPG_CLIENT_FULLBODY_IKSOLVER_POINT_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x16D4A0A0)
#define RPG_CLIENT_FULLBODY_IKSOLVER_POINT_METHOD_1_AA169839CB93802A_OFFSET UNITYSDK_OFFSET(0x16D4A160)
#define RPG_CLIENT_FULLBODY_IKSOLVER_POINT__CTOR_OFFSET UNITYSDK_OFFSET(0x16D49E20)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int IKSolver_Point_TypeDefinitionIndex = 70857;
