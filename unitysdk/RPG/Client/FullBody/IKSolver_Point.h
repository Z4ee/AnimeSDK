...
#define RPG_CLIENT_FULLBODY_IKSOLVER_POINT_METHOD_1_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0x19384020)
#define RPG_CLIENT_FULLBODY_IKSOLVER_POINT_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x19383FA0)
#define RPG_CLIENT_FULLBODY_IKSOLVER_POINT_METHOD_1_9681042564541CD6_1_OFFSET UNITYSDK_OFFSET(0x193840A0)
#define RPG_CLIENT_FULLBODY_IKSOLVER_POINT_METHOD_1_9681042564541CD6_2_OFFSET UNITYSDK_OFFSET(0x19384160)
#define RPG_CLIENT_FULLBODY_IKSOLVER_POINT_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x19383D70)
#define RPG_CLIENT_FULLBODY_IKSOLVER_POINT_METHOD_1_AA169839CB93802A_OFFSET UNITYSDK_OFFSET(0x19383E30)
#define RPG_CLIENT_FULLBODY_IKSOLVER_POINT__CTOR_OFFSET UNITYSDK_OFFSET(0x19383AF0)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int IKSolver_Point_TypeDefinitionIndex = 74156;
