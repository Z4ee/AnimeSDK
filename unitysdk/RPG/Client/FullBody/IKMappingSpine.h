...
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_03F8818C1383CCD8_OFFSET UNITYSDK_OFFSET(0x9738C50)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_151E25A63D14DDB0_1_OFFSET UNITYSDK_OFFSET(0x97369F0)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0x9736950)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x97377D0)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_2157CED3CDDF8996_OFFSET UNITYSDK_OFFSET(0x9737830)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_2F0DC1CA1AADEABC_OFFSET UNITYSDK_OFFSET(0x9737D50)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_39DB8586C0CDFDE2_OFFSET UNITYSDK_OFFSET(0x9736AA0)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_3FBE0C585F4EF331_OFFSET UNITYSDK_OFFSET(0x97385F0)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_6821143A80BCED87_OFFSET UNITYSDK_OFFSET(0x97368C0)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_8F59263A7D1D04F6_OFFSET UNITYSDK_OFFSET(0x9738460)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_A461AC4695F6A5F0_OFFSET UNITYSDK_OFFSET(0x9738CA0)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_BB5227825222DD2C_OFFSET UNITYSDK_OFFSET(0x9736370)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_FC1A6F0C23BBD83A_OFFSET UNITYSDK_OFFSET(0x9738280)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x9736730)
#define RPG_CLIENT_FULLBODY_IKMAPPINGSPINE__CTOR_OFFSET UNITYSDK_OFFSET(0x9736620)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int IKMappingSpine_TypeDefinitionIndex = 60911;
	...
	public:
		...
		::System::Boolean Method_2_BB5227825222DD2C(::RPG::Client::FullBody::IKSolver* a1, ::System::String*& a2)
		{
			return ((::System::Boolean(*)(::PVOID, ::RPG::Client::FullBody::IKSolver*, ::System::String*&))((::PBYTE)hIl2Cpp + RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_BB5227825222DD2C_OFFSET))(this, a1, a2);
		}
		...
		::System::Void Method_2_39DB8586C0CDFDE2(::RPG::Client::FullBody::IKSolverFullBody* a1)
		{
			return ((::System::Void(*)(::PVOID, ::RPG::Client::FullBody::IKSolverFullBody*))((::PBYTE)hIl2Cpp + RPG_CLIENT_FULLBODY_IKMAPPINGSPINE_METHOD_2_39DB8586C0CDFDE2_OFFSET))(this, a1);
		}
