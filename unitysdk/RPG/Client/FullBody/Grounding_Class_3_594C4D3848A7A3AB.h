...
#define RPG_CLIENT_FULLBODY_GROUNDING_CLASS_3_594C4D3848A7A3AB_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xA3ECCA0)
#define RPG_CLIENT_FULLBODY_GROUNDING_CLASS_3_594C4D3848A7A3AB_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xA3ECDF0)
#define RPG_CLIENT_FULLBODY_GROUNDING_CLASS_3_594C4D3848A7A3AB_INVOKE_OFFSET UNITYSDK_OFFSET(0xA3EC2F0)
#define RPG_CLIENT_FULLBODY_GROUNDING_CLASS_3_594C4D3848A7A3AB__CTOR_OFFSET UNITYSDK_OFFSET(0xA3EC290)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int Grounding_Class_3_594C4D3848A7A3AB_TypeDefinitionIndex = 68347;
