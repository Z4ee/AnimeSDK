...
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED__ONSTOPIK_D__60_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xBA86140)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED__ONSTOPIK_D__60_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xBA862E0)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED__ONSTOPIK_D__60_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xBA86340)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED__ONSTOPIK_D__60_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xBA862F0)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED__ONSTOPIK_D__60_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xBA86130)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED__ONSTOPIK_D__60__CTOR_OFFSET UNITYSDK_OFFSET(0xBA85AA0)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int GrounderQuadruped__OnStopIK_d__60_TypeDefinitionIndex = 69317;
