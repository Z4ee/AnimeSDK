...
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED__ONSTOPIK_D__60_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19373180)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED__ONSTOPIK_D__60_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19373320)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED__ONSTOPIK_D__60_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19373380)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED__ONSTOPIK_D__60_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19373330)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED__ONSTOPIK_D__60_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19373170)
#define RPG_CLIENT_FULLBODY_GROUNDERQUADRUPED__ONSTOPIK_D__60__CTOR_OFFSET UNITYSDK_OFFSET(0x19372C40)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int GrounderQuadruped__OnStopIK_d__60_TypeDefinitionIndex = 74137;
