...
#define RPG_CLIENT_FULLBODY_GROUNDING_CLASS_3_25BFA3B13C8F2459_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19376310)
#define RPG_CLIENT_FULLBODY_GROUNDING_CLASS_3_25BFA3B13C8F2459_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19376430)
#define RPG_CLIENT_FULLBODY_GROUNDING_CLASS_3_25BFA3B13C8F2459_INVOKE_OFFSET UNITYSDK_OFFSET(0x19373B50)
#define RPG_CLIENT_FULLBODY_GROUNDING_CLASS_3_25BFA3B13C8F2459__CTOR_OFFSET UNITYSDK_OFFSET(0x193762A0)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int Grounding_Class_3_25BFA3B13C8F2459_TypeDefinitionIndex = 74142;
