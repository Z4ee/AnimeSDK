...
#define RPG_CLIENT_FULLBODY_IKSOLVERTRIGONOMETRIC_METHOD_2_03100CB4894A3883_OFFSET UNITYSDK_OFFSET(0xBAA0B70)
#define RPG_CLIENT_FULLBODY_IKSOLVERTRIGONOMETRIC_METHOD_2_0B46B29B42A81C6F_OFFSET UNITYSDK_OFFSET(0xBAA0D10)
#define RPG_CLIENT_FULLBODY_IKSOLVERTRIGONOMETRIC_METHOD_2_2E9EFD1763526B05_OFFSET UNITYSDK_OFFSET(0xBAA0F60)
#define RPG_CLIENT_FULLBODY_IKSOLVERTRIGONOMETRIC_METHOD_2_33C4B285E4B1271C_OFFSET UNITYSDK_OFFSET(0xBAA2D00)
#define RPG_CLIENT_FULLBODY_IKSOLVERTRIGONOMETRIC_METHOD_2_383F5EE18A2A3914_OFFSET UNITYSDK_OFFSET(0xBAA1A10)
#define RPG_CLIENT_FULLBODY_IKSOLVERTRIGONOMETRIC_METHOD_2_412F2CEBDE691C81_OFFSET UNITYSDK_OFFSET(0xBAA09E0)
#define RPG_CLIENT_FULLBODY_IKSOLVERTRIGONOMETRIC_METHOD_2_479759059E440327_OFFSET UNITYSDK_OFFSET(0xBAA0A40)
#define RPG_CLIENT_FULLBODY_IKSOLVERTRIGONOMETRIC_METHOD_2_5A6EAD1FC0CCA71D_OFFSET UNITYSDK_OFFSET(0xBAA1210)
#define RPG_CLIENT_FULLBODY_IKSOLVERTRIGONOMETRIC_METHOD_2_7970C5CAFFD9CDA1_OFFSET UNITYSDK_OFFSET(0xBAA0510)
#define RPG_CLIENT_FULLBODY_IKSOLVERTRIGONOMETRIC_METHOD_2_A0C2164E6BC7E6E6_OFFSET UNITYSDK_OFFSET(0xBAA20B0)
#define RPG_CLIENT_FULLBODY_IKSOLVERTRIGONOMETRIC_METHOD_2_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0xBAA0B20)
#define RPG_CLIENT_FULLBODY_IKSOLVERTRIGONOMETRIC_METHOD_2_A742B18FC98A9593_OFFSET UNITYSDK_OFFSET(0xBAA12D0)
#define RPG_CLIENT_FULLBODY_IKSOLVERTRIGONOMETRIC_METHOD_2_A84CEAF7AFA573B3_OFFSET UNITYSDK_OFFSET(0xBAA21D0)
#define RPG_CLIENT_FULLBODY_IKSOLVERTRIGONOMETRIC_METHOD_2_B768DA94E3FD91D9_OFFSET UNITYSDK_OFFSET(0xBAA0770)
#define RPG_CLIENT_FULLBODY_IKSOLVERTRIGONOMETRIC_METHOD_2_C34AC80B04BCFF1B_OFFSET UNITYSDK_OFFSET(0xBAA0AC0)
#define RPG_CLIENT_FULLBODY_IKSOLVERTRIGONOMETRIC_METHOD_2_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xBAA0450)
#define RPG_CLIENT_FULLBODY_IKSOLVERTRIGONOMETRIC_METHOD_2_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0xBAA04D0)
#define RPG_CLIENT_FULLBODY_IKSOLVERTRIGONOMETRIC_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xBAA03D0)
#define RPG_CLIENT_FULLBODY_IKSOLVERTRIGONOMETRIC_METHOD_2_D0BD1377F2594D33_OFFSET UNITYSDK_OFFSET(0xBAA1DA0)
#define RPG_CLIENT_FULLBODY_IKSOLVERTRIGONOMETRIC_METHOD_2_D3129FE8DF635B48_OFFSET UNITYSDK_OFFSET(0xBAA0E50)
#define RPG_CLIENT_FULLBODY_IKSOLVERTRIGONOMETRIC_METHOD_2_E52129E82CD2D7F8_OFFSET UNITYSDK_OFFSET(0xBAA0ED0)
#define RPG_CLIENT_FULLBODY_IKSOLVERTRIGONOMETRIC_METHOD_2_E7EF6BC52B28648C_OFFSET UNITYSDK_OFFSET(0xBAA1F10)
#define RPG_CLIENT_FULLBODY_IKSOLVERTRIGONOMETRIC__CTOR_OFFSET UNITYSDK_OFFSET(0xBAA0050)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int IKSolverTrigonometric_TypeDefinitionIndex = 69348;
