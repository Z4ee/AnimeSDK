...
#define RPG_CLIENT_FULLBODY_GROUNDING_CLASS_3_443CA02E4E068003_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x972EC90)
#define RPG_CLIENT_FULLBODY_GROUNDING_CLASS_3_443CA02E4E068003_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x972ED90)
#define RPG_CLIENT_FULLBODY_GROUNDING_CLASS_3_443CA02E4E068003_INVOKE_OFFSET UNITYSDK_OFFSET(0x9728380)
#define RPG_CLIENT_FULLBODY_GROUNDING_CLASS_3_443CA02E4E068003__CTOR_OFFSET UNITYSDK_OFFSET(0x972B6F0)

namespace RPG::Client::FullBody
{
	inline static constexpr unsigned int Grounding_Class_3_443CA02E4E068003_TypeDefinitionIndex = 60897;
