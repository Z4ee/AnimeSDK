...
#define RPG_CLIENT_ELFBEHAVIORINFO_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AC5FF20)
#define RPG_CLIENT_ELFBEHAVIORINFO_INIT_OFFSET UNITYSDK_OFFSET(0x1AC5FC20)
#define RPG_CLIENT_ELFBEHAVIORINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC5FFC0)
#define RPG_CLIENT_ELFBEHAVIORINFO__INITBEHAVIORDATA_OFFSET UNITYSDK_OFFSET(0x1AC5FC70)

namespace RPG::Client
{
	inline static constexpr unsigned int ElfBehaviorInfo_TypeDefinitionIndex = 63718;
