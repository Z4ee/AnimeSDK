...
#define RPG_CLIENT_MUSICRHYTHMHINTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18E91240)

namespace RPG::Client
{
	inline static constexpr unsigned int MusicRhythmHintInfo_TypeDefinitionIndex = 57489;
