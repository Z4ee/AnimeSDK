...
#define RPG_CLIENT_A4SKYDOMEEFFECTCONTROLMONOPLUGIN_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x8EC0D60)
#define RPG_CLIENT_A4SKYDOMEEFFECTCONTROLMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x8EC0DB0)
#define RPG_CLIENT_A4SKYDOMEEFFECTCONTROLMONOPLUGIN___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x8EC0DD0)

namespace RPG::Client
{
	inline static constexpr unsigned int A4SkyDomeEffectControlMonoPlugin_TypeDefinitionIndex = 58051;
