...
#define RPG_CLIENT_ANIMATIONCLIPBAKER__CTOR_OFFSET UNITYSDK_OFFSET(0x19C8D180)

namespace RPG::Client
{
	inline static constexpr unsigned int AnimationClipBaker_TypeDefinitionIndex = 68321;
