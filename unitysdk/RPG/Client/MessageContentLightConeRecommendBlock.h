...
#define RPG_CLIENT_MESSAGECONTENTLIGHTCONERECOMMENDBLOCK_EQUALS_OFFSET UNITYSDK_OFFSET(0xBFD7710)
#define RPG_CLIENT_MESSAGECONTENTLIGHTCONERECOMMENDBLOCK_GET_AVATARID_OFFSET UNITYSDK_OFFSET(0xBFD7870)
#define RPG_CLIENT_MESSAGECONTENTLIGHTCONERECOMMENDBLOCK_GET_ISDATAREADY_OFFSET UNITYSDK_OFFSET(0xBFD7890)
#define RPG_CLIENT_MESSAGECONTENTLIGHTCONERECOMMENDBLOCK_GET_LIGHTCONEGUIDE_OFFSET UNITYSDK_OFFSET(0xBFD7880)
#define RPG_CLIENT_MESSAGECONTENTLIGHTCONERECOMMENDBLOCK_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xBFD7530)
#define RPG_CLIENT_MESSAGECONTENTLIGHTCONERECOMMENDBLOCK_REQUESTLIGHTCONERECOMMENDDATA_OFFSET UNITYSDK_OFFSET(0xBFD75E0)
#define RPG_CLIENT_MESSAGECONTENTLIGHTCONERECOMMENDBLOCK__CREATELIGHTCONEGUIDE_OFFSET UNITYSDK_OFFSET(0xBFD7560)
#define RPG_CLIENT_MESSAGECONTENTLIGHTCONERECOMMENDBLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0xBFD7540)
#define RPG_CLIENT_MESSAGECONTENTLIGHTCONERECOMMENDBLOCK__ISRECOMMENDDATAREADY_OFFSET UNITYSDK_OFFSET(0xBFD77C0)

namespace RPG::Client
{
	inline static constexpr unsigned int MessageContentLightConeRecommendBlock_TypeDefinitionIndex = 59196;
