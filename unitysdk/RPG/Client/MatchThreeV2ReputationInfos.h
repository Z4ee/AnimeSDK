...
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONINFOS_CREATE_OFFSET UNITYSDK_OFFSET(0xD665F30)
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONINFOS_GETCHALLENGINGREPUTATIONDATALIST_OFFSET UNITYSDK_OFFSET(0xD673260)
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONINFOS_GETMAXREPUTATION_OFFSET UNITYSDK_OFFSET(0xD665300)
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONINFOS_GETREPUTATIONDATALIST_OFFSET UNITYSDK_OFFSET(0xD665340)
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONINFOS_GETREPUTATIONDATA_OFFSET UNITYSDK_OFFSET(0xD66D680)
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONINFOS__CTOR_OFFSET UNITYSDK_OFFSET(0xD672FC0)
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONINFOS__INIT_OFFSET UNITYSDK_OFFSET(0xD672FD0)
