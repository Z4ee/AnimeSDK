...
#define RPG_CLIENT_GRIDFIGHTGRIDCYRENEEFFECT___C__CANCASTER_B__5_0_OFFSET UNITYSDK_OFFSET(0x194FB460)
#define RPG_CLIENT_GRIDFIGHTGRIDCYRENEEFFECT___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x194FB410)
#define RPG_CLIENT_GRIDFIGHTGRIDCYRENEEFFECT___C__CTOR_OFFSET UNITYSDK_OFFSET(0x194FB450)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Func_2<::RPG::Client::GridFightRole*, ::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(GridFightGridCyreneEffect___c_TypeDefinitionIndex)->GetStaticField(0x28180);
		}
		static ::RPG::Client::GridFightGridCyreneEffect___c** StaticGet___9()
		{
			return (::RPG::Client::GridFightGridCyreneEffect___c**)Il2CppClass::FromTypeDefinitionIndex(GridFightGridCyreneEffect___c_TypeDefinitionIndex)->GetStaticField(0x28188);
		}
