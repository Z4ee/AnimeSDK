...
#define RPG_CLIENT_MONOESCALATORCONFIGURE_EVALUATEPOSITION_OFFSET UNITYSDK_OFFSET(0xA9BB1D0)
#define RPG_CLIENT_MONOESCALATORCONFIGURE_GET_DISTANCE_OFFSET UNITYSDK_OFFSET(0xA9BA5D0)
#define RPG_CLIENT_MONOESCALATORCONFIGURE_GET_INSTANCEMATRICES_OFFSET UNITYSDK_OFFSET(0xA9BA610)
#define RPG_CLIENT_MONOESCALATORCONFIGURE_GET_ITEMSORTLENGTH_OFFSET UNITYSDK_OFFSET(0xA9BA5F0)
#define RPG_CLIENT_MONOESCALATORCONFIGURE_METHOD_5_5FB0DC4E8DAA3EC5_OFFSET UNITYSDK_OFFSET(0xA9BA7A0)
#define RPG_CLIENT_MONOESCALATORCONFIGURE_METHOD_5_7443AD94E7275ABA_OFFSET UNITYSDK_OFFSET(0xA9BA670)
#define RPG_CLIENT_MONOESCALATORCONFIGURE_REFRESHITEMS_OFFSET UNITYSDK_OFFSET(0xA9BA730)
#define RPG_CLIENT_MONOESCALATORCONFIGURE_REFRESHITEMTRANSFORM_OFFSET UNITYSDK_OFFSET(0xA9BAE60)
#define RPG_CLIENT_MONOESCALATORCONFIGURE_REMOVEALLITEM_OFFSET UNITYSDK_OFFSET(0xA9BA620)
#define RPG_CLIENT_MONOESCALATORCONFIGURE_SET_DISTANCE_OFFSET UNITYSDK_OFFSET(0xA9BA5E0)
#define RPG_CLIENT_MONOESCALATORCONFIGURE_SET_ITEMSORTLENGTH_OFFSET UNITYSDK_OFFSET(0xA9BA600)
#define RPG_CLIENT_MONOESCALATORCONFIGURE__CTOR_OFFSET UNITYSDK_OFFSET(0xA9BB320)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEscalatorConfigure_TypeDefinitionIndex = 63252;
	...
	public:
		...
		::System::Collections::Generic::List_1<::UnityEngine::Matrix4x4>* Field_5_8; // 0x50
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + RPG_CLIENT_MONOESCALATORCONFIGURE_SET_DISTANCE_OFFSET))(this, value);
		}
		...
		::System::Void set_ItemSortLength(::System::Single value)
		{
			return ((::System::Void(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + RPG_CLIENT_MONOESCALATORCONFIGURE_SET_ITEMSORTLENGTH_OFFSET))(this, value);
		}
