...
#define RPG_CLIENT_MONOESCALATORCONFIGURE_EVALUATEPOSITION_OFFSET UNITYSDK_OFFSET(0x18C39E80)
#define RPG_CLIENT_MONOESCALATORCONFIGURE_GET_DISTANCE_OFFSET UNITYSDK_OFFSET(0x18C392F0)
#define RPG_CLIENT_MONOESCALATORCONFIGURE_GET_INSTANCEMATRICES_OFFSET UNITYSDK_OFFSET(0x18C39330)
#define RPG_CLIENT_MONOESCALATORCONFIGURE_GET_ITEMSORTLENGTH_OFFSET UNITYSDK_OFFSET(0x18C39310)
#define RPG_CLIENT_MONOESCALATORCONFIGURE_METHOD_5_5FB0DC4E8DAA3EC5_OFFSET UNITYSDK_OFFSET(0x18C394C0)
#define RPG_CLIENT_MONOESCALATORCONFIGURE_METHOD_5_7443AD94E7275ABA_OFFSET UNITYSDK_OFFSET(0x18C39390)
#define RPG_CLIENT_MONOESCALATORCONFIGURE_REFRESHITEMS_OFFSET UNITYSDK_OFFSET(0x18C39450)
#define RPG_CLIENT_MONOESCALATORCONFIGURE_REFRESHITEMTRANSFORM_OFFSET UNITYSDK_OFFSET(0x18C39AC0)
#define RPG_CLIENT_MONOESCALATORCONFIGURE_REMOVEALLITEM_OFFSET UNITYSDK_OFFSET(0x18C39340)
#define RPG_CLIENT_MONOESCALATORCONFIGURE_SET_DISTANCE_OFFSET UNITYSDK_OFFSET(0x18C39300)
#define RPG_CLIENT_MONOESCALATORCONFIGURE_SET_ITEMSORTLENGTH_OFFSET UNITYSDK_OFFSET(0x18C39320)
#define RPG_CLIENT_MONOESCALATORCONFIGURE__CTOR_OFFSET UNITYSDK_OFFSET(0x18C39FB0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEscalatorConfigure_TypeDefinitionIndex = 65540;
