...
#define RPG_CLIENT_QUATERNIONROTATIONCONTROLBEHAVIOR_SINGLEROTATION_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xC67B760)
#define RPG_CLIENT_QUATERNIONROTATIONCONTROLBEHAVIOR_SINGLEROTATION_METHOD_1_D3E60AED7A8FFCC5_OFFSET UNITYSDK_OFFSET(0xC67BEF0)
#define RPG_CLIENT_QUATERNIONROTATIONCONTROLBEHAVIOR_SINGLEROTATION__CTOR_OFFSET UNITYSDK_OFFSET(0xC67C460)

namespace RPG::Client
{
	inline static constexpr unsigned int QuaternionRotationControlBehavior_SingleRotation_TypeDefinitionIndex = 66172;
