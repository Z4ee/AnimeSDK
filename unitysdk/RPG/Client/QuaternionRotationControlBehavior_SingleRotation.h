...
#define RPG_CLIENT_QUATERNIONROTATIONCONTROLBEHAVIOR_SINGLEROTATION_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xA247280)
#define RPG_CLIENT_QUATERNIONROTATIONCONTROLBEHAVIOR_SINGLEROTATION_METHOD_1_D3E60AED7A8FFCC5_OFFSET UNITYSDK_OFFSET(0xA247970)
#define RPG_CLIENT_QUATERNIONROTATIONCONTROLBEHAVIOR_SINGLEROTATION__CTOR_OFFSET UNITYSDK_OFFSET(0xA247F20)

namespace RPG::Client
{
	inline static constexpr unsigned int QuaternionRotationControlBehavior_SingleRotation_TypeDefinitionIndex = 57958;
