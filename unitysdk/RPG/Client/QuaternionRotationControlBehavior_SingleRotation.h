...
#define RPG_CLIENT_QUATERNIONROTATIONCONTROLBEHAVIOR_SINGLEROTATION_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x16786290)
#define RPG_CLIENT_QUATERNIONROTATIONCONTROLBEHAVIOR_SINGLEROTATION_METHOD_1_D3E60AED7A8FFCC5_OFFSET UNITYSDK_OFFSET(0x16786A20)
#define RPG_CLIENT_QUATERNIONROTATIONCONTROLBEHAVIOR_SINGLEROTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x16786C30)

namespace RPG::Client
{
	inline static constexpr unsigned int QuaternionRotationControlBehavior_SingleRotation_TypeDefinitionIndex = 67597;
