...
#define RPG_CLIENT_QUATERNIONROTATIONCONTROLBEHAVIOR_SINGLEROTATION_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xAF35C40)
#define RPG_CLIENT_QUATERNIONROTATIONCONTROLBEHAVIOR_SINGLEROTATION_METHOD_1_D3E60AED7A8FFCC5_OFFSET UNITYSDK_OFFSET(0xAF36330)
#define RPG_CLIENT_QUATERNIONROTATIONCONTROLBEHAVIOR_SINGLEROTATION__CTOR_OFFSET UNITYSDK_OFFSET(0xAF368E0)

namespace RPG::Client
{
	inline static constexpr unsigned int QuaternionRotationControlBehavior_SingleRotation_TypeDefinitionIndex = 65245;
