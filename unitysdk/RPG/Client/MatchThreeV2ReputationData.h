...
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONDATA_COMPARETO_OFFSET UNITYSDK_OFFSET(0xD672E30)
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xD672D60)
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONDATA_GET_BENEFITDESC_OFFSET UNITYSDK_OFFSET(0xD672A10)
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONDATA_GET_BENEFITREWARDID_OFFSET UNITYSDK_OFFSET(0xD672C10)
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONDATA_GET_BGICONPATH_OFFSET UNITYSDK_OFFSET(0xD672B70)
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONDATA_GET_CHALLENGERS_OFFSET UNITYSDK_OFFSET(0xD672CB0)
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONDATA_GET_FGICONPATH_OFFSET UNITYSDK_OFFSET(0xD672AD0)
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONDATA_GET_SIGNIFICANCE_OFFSET UNITYSDK_OFFSET(0xD6654B0)
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONDATA_GET_TABNAME_OFFSET UNITYSDK_OFFSET(0xD672950)
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONDATA_GET_TITLE_OFFSET UNITYSDK_OFFSET(0xD672890)
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONDATA_GET_TOTALCHALLENGERCOUNT_OFFSET UNITYSDK_OFFSET(0xD665460)
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xD672830)
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONDATA_MARKSEEN_OFFSET UNITYSDK_OFFSET(0xD672EA0)
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD672CC0)
