...
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONDATA_COMPARETO_OFFSET UNITYSDK_OFFSET(0x1A9F63F0)
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1A9F6320)
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONDATA_GET_BENEFITDESC_OFFSET UNITYSDK_OFFSET(0x1A9F5F80)
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONDATA_GET_BENEFITREWARDID_OFFSET UNITYSDK_OFFSET(0x1A9F6180)
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONDATA_GET_BGICONPATH_OFFSET UNITYSDK_OFFSET(0x1A9F60E0)
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONDATA_GET_CHALLENGERS_OFFSET UNITYSDK_OFFSET(0x1A9F6220)
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONDATA_GET_FGICONPATH_OFFSET UNITYSDK_OFFSET(0x1A9F6040)
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONDATA_GET_SIGNIFICANCE_OFFSET UNITYSDK_OFFSET(0x1A9F2560)
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONDATA_GET_TABNAME_OFFSET UNITYSDK_OFFSET(0x1A9F5EC0)
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONDATA_GET_TITLE_OFFSET UNITYSDK_OFFSET(0x1A9F5E00)
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONDATA_GET_TOTALCHALLENGERCOUNT_OFFSET UNITYSDK_OFFSET(0x1A9F6230)
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0x1A9F5DA0)
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONDATA_MARKSEEN_OFFSET UNITYSDK_OFFSET(0x1A9F6460)
#define RPG_CLIENT_MATCHTHREEV2REPUTATIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9F6280)

namespace RPG::Client
{
	inline static constexpr unsigned int MatchThreeV2ReputationData_TypeDefinitionIndex = 63086;
