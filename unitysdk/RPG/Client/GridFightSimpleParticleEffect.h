...
#define RPG_CLIENT_GRIDFIGHTSIMPLEPARTICLEEFFECT_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xBBFFE10)
#define RPG_CLIENT_GRIDFIGHTSIMPLEPARTICLEEFFECT_ONCREATE_OFFSET UNITYSDK_OFFSET(0xBBFFE50)
#define RPG_CLIENT_GRIDFIGHTSIMPLEPARTICLEEFFECT_PLAY_OFFSET UNITYSDK_OFFSET(0xBBFFEB0)
#define RPG_CLIENT_GRIDFIGHTSIMPLEPARTICLEEFFECT_SPAWNED_OFFSET UNITYSDK_OFFSET(0xBBFFDD0)
#define RPG_CLIENT_GRIDFIGHTSIMPLEPARTICLEEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xBBFFF50)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightSimpleParticleEffect_TypeDefinitionIndex = 60290;
