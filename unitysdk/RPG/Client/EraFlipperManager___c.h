...
#define RPG_CLIENT_ERAFLIPPERMANAGER___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x9628930)
#define RPG_CLIENT_ERAFLIPPERMANAGER___C__CTOR_OFFSET UNITYSDK_OFFSET(0x9628970)
#define RPG_CLIENT_ERAFLIPPERMANAGER___C___ENTERERAREGION_B__29_2_OFFSET UNITYSDK_OFFSET(0x9628980)

namespace RPG::Client
{
	inline static constexpr unsigned int EraFlipperManager___c_TypeDefinitionIndex = 48998;
	...
	public:
		...
		{
			return (::RPG::Client::EraFlipperManager___c**)Il2CppClass::FromTypeDefinitionIndex(EraFlipperManager___c_TypeDefinitionIndex)->GetStaticField(0x47200);
		}
		static ::System::Func_2<::RPG::Client::RuntimeGroupManager_HoYoGroupUnit*, ::System::UInt32>** StaticGet___9__29_2()
		{
			return (::System::Func_2<::RPG::Client::RuntimeGroupManager_HoYoGroupUnit*, ::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(EraFlipperManager___c_TypeDefinitionIndex)->GetStaticField(0x47208);
		}
