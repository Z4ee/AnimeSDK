...
#define RPG_CLIENT_ERAFLIPPERMANAGER___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1993BA50)
#define RPG_CLIENT_ERAFLIPPERMANAGER___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1993BA90)
#define RPG_CLIENT_ERAFLIPPERMANAGER___C___ENTERERAREGION_B__29_2_OFFSET UNITYSDK_OFFSET(0x1993BAA0)

namespace RPG::Client
{
	inline static constexpr unsigned int EraFlipperManager___c_TypeDefinitionIndex = 60607;
	...
	public:
		...
		{
			return (::System::Func_2<::RPG::Client::RuntimeGroupManager_HoYoGroupUnit*, ::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(EraFlipperManager___c_TypeDefinitionIndex)->GetStaticField(0x641F0);
		}
		static ::RPG::Client::EraFlipperManager___c** StaticGet___9()
		{
			return (::RPG::Client::EraFlipperManager___c**)Il2CppClass::FromTypeDefinitionIndex(EraFlipperManager___c_TypeDefinitionIndex)->GetStaticField(0x641F8);
		}
