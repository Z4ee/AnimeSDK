...
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDGIFTSELECTACTION_GETROGUEACTIONID_OFFSET UNITYSDK_OFFSET(0x1C7A9820)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDGIFTSELECTACTION_GET_ADDSELECTEDCARDLEVEL_OFFSET UNITYSDK_OFFSET(0x1C7A9590)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDGIFTSELECTACTION_GET_ROGUEACTIONID_OFFSET UNITYSDK_OFFSET(0x1C7A9550)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDGIFTSELECTACTION_GET_ROOMCARDLIST_OFFSET UNITYSDK_OFFSET(0x1C7A9570)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDGIFTSELECTACTION_SET_ADDSELECTEDCARDLEVEL_OFFSET UNITYSDK_OFFSET(0x1C7A95A0)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDGIFTSELECTACTION_SET_ROGUEACTIONID_OFFSET UNITYSDK_OFFSET(0x1C7A9560)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDGIFTSELECTACTION_SET_ROOMCARDLIST_OFFSET UNITYSDK_OFFSET(0x1C7A9580)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDGIFTSELECTACTION_TRIGGERACTION_OFFSET UNITYSDK_OFFSET(0x1C7A9860)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDGIFTSELECTACTION__CONSTRUCT_OFFSET UNITYSDK_OFFSET(0x1C7A9600)
#define RPG_CLIENT_ROGUETOURNPERSONAROOMCARDGIFTSELECTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C7A95B0)
