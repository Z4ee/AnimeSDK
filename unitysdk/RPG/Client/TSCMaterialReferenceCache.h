...
#define RPG_CLIENT_TSCMATERIALREFERENCECACHE_METHOD_1_5F2883F9130D2889_OFFSET UNITYSDK_OFFSET(0x1B400DE0)
#define RPG_CLIENT_TSCMATERIALREFERENCECACHE_METHOD_1_D4FAD9DF8A6E1E94_OFFSET UNITYSDK_OFFSET(0x1B4010C0)
#define RPG_CLIENT_TSCMATERIALREFERENCECACHE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B400C10)

namespace RPG::Client
{
	inline static constexpr unsigned int TSCMaterialReferenceCache_TypeDefinitionIndex = 70173;
