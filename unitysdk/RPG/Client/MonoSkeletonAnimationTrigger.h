...
#define RPG_CLIENT_MONOSKELETONANIMATIONTRIGGER_METHOD_5_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0x1A34BE30)
#define RPG_CLIENT_MONOSKELETONANIMATIONTRIGGER_METHOD_5_16706DCC9C10BC51_OFFSET UNITYSDK_OFFSET(0x1A34C120)
#define RPG_CLIENT_MONOSKELETONANIMATIONTRIGGER_METHOD_5_2FC095E35C3F5C08_OFFSET UNITYSDK_OFFSET(0x1A34C1A0)
#define RPG_CLIENT_MONOSKELETONANIMATIONTRIGGER_METHOD_5_EC2B405D0723571D_OFFSET UNITYSDK_OFFSET(0x1A34BF80)
#define RPG_CLIENT_MONOSKELETONANIMATIONTRIGGER_START_OFFSET UNITYSDK_OFFSET(0x1A34BDA0)
#define RPG_CLIENT_MONOSKELETONANIMATIONTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A34C380)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoSkeletonAnimationTrigger_TypeDefinitionIndex = 65892;
