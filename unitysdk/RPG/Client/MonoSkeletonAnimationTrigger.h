...
#define RPG_CLIENT_MONOSKELETONANIMATIONTRIGGER_METHOD_5_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0xC145DD0)
#define RPG_CLIENT_MONOSKELETONANIMATIONTRIGGER_METHOD_5_16706DCC9C10BC51_OFFSET UNITYSDK_OFFSET(0xC1460C0)
#define RPG_CLIENT_MONOSKELETONANIMATIONTRIGGER_METHOD_5_2FC095E35C3F5C08_OFFSET UNITYSDK_OFFSET(0xC146140)
#define RPG_CLIENT_MONOSKELETONANIMATIONTRIGGER_METHOD_5_EC2B405D0723571D_OFFSET UNITYSDK_OFFSET(0xC145F20)
#define RPG_CLIENT_MONOSKELETONANIMATIONTRIGGER_START_OFFSET UNITYSDK_OFFSET(0xC145D40)
#define RPG_CLIENT_MONOSKELETONANIMATIONTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0xC146320)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoSkeletonAnimationTrigger_TypeDefinitionIndex = 64492;
