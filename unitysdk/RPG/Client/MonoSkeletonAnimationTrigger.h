...
#define RPG_CLIENT_MONOSKELETONANIMATIONTRIGGER_METHOD_5_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0xA9F7B70)
#define RPG_CLIENT_MONOSKELETONANIMATIONTRIGGER_METHOD_5_16706DCC9C10BC51_OFFSET UNITYSDK_OFFSET(0xA9F7E40)
#define RPG_CLIENT_MONOSKELETONANIMATIONTRIGGER_METHOD_5_2FC095E35C3F5C08_OFFSET UNITYSDK_OFFSET(0xA9F7EC0)
#define RPG_CLIENT_MONOSKELETONANIMATIONTRIGGER_METHOD_5_EC2B405D0723571D_OFFSET UNITYSDK_OFFSET(0xA9F7CD0)
#define RPG_CLIENT_MONOSKELETONANIMATIONTRIGGER_START_OFFSET UNITYSDK_OFFSET(0xA9F7AE0)
#define RPG_CLIENT_MONOSKELETONANIMATIONTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0xA9F80A0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoSkeletonAnimationTrigger_TypeDefinitionIndex = 63571;
