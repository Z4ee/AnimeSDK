...
#define RPG_CLIENT_ACTIVITYSWORDTRAININGEXAMDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xB207C00)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGEXAMDATA_GETCOMMENTDATA_OFFSET UNITYSDK_OFFSET(0xB207C90)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGEXAMDATA_GET_BATTLEAREAID_OFFSET UNITYSDK_OFFSET(0xB208330)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGEXAMDATA_GET_ENEMYIMAGE_OFFSET UNITYSDK_OFFSET(0xB208410)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGEXAMDATA_GET_ENEMYNAME_OFFSET UNITYSDK_OFFSET(0xB208480)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGEXAMDATA_GET_FAILPERFORMANCEID_OFFSET UNITYSDK_OFFSET(0xB208250)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGEXAMDATA_GET_ISFINALEXAM_OFFSET UNITYSDK_OFFSET(0xB208500)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGEXAMDATA_GET_POWERRANKID_OFFSET UNITYSDK_OFFSET(0xB2083A0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGEXAMDATA_GET_PREPERFORMID_OFFSET UNITYSDK_OFFSET(0xB2080F0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGEXAMDATA_GET_STAGEID_OFFSET UNITYSDK_OFFSET(0xB2082C0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGEXAMDATA_GET_SUCCESSPERFORMANCEID_OFFSET UNITYSDK_OFFSET(0xB208160)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGEXAMDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xB208090)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGEXAMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB207C80)

namespace RPG::Client
{
	inline static constexpr unsigned int ActivitySwordTrainingExamData_TypeDefinitionIndex = 57927;
