...
#define RPG_CLIENT_UISETTMPATTRIBUTE_AWAKE_OFFSET UNITYSDK_OFFSET(0x17B900F0)
#define RPG_CLIENT_UISETTMPATTRIBUTE_GETCENTERPOS_OFFSET UNITYSDK_OFFSET(0x17B92780)
#define RPG_CLIENT_UISETTMPATTRIBUTE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x17B909B0)
#define RPG_CLIENT_UISETTMPATTRIBUTE_METHOD_5_08DCF72FBE01FF99_OFFSET UNITYSDK_OFFSET(0x17B91590)
#define RPG_CLIENT_UISETTMPATTRIBUTE_METHOD_5_2C825E716CE9F2F9_OFFSET UNITYSDK_OFFSET(0x17B91160)
#define RPG_CLIENT_UISETTMPATTRIBUTE_METHOD_5_2D1DFA4BDF5C46E6_OFFSET UNITYSDK_OFFSET(0x17B92290)
#define RPG_CLIENT_UISETTMPATTRIBUTE_METHOD_5_43E290A0B26B39F6_OFFSET UNITYSDK_OFFSET(0x17B923F0)
#define RPG_CLIENT_UISETTMPATTRIBUTE_METHOD_5_79830F666EE579C0_OFFSET UNITYSDK_OFFSET(0x17B90BB0)
#define RPG_CLIENT_UISETTMPATTRIBUTE_METHOD_5_88B60F3B95FAA4F1_OFFSET UNITYSDK_OFFSET(0x17B928E0)
#define RPG_CLIENT_UISETTMPATTRIBUTE_METHOD_5_8F7825DAFFB9B517_OFFSET UNITYSDK_OFFSET(0x17B90F10)
#define RPG_CLIENT_UISETTMPATTRIBUTE_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x17B90DF0)
#define RPG_CLIENT_UISETTMPATTRIBUTE_METHOD_5_A44394FA2432C12D_OFFSET UNITYSDK_OFFSET(0x17B91B00)
#define RPG_CLIENT_UISETTMPATTRIBUTE_METHOD_5_E7EF6BC52B28648C_OFFSET UNITYSDK_OFFSET(0x17B906B0)
#define RPG_CLIENT_UISETTMPATTRIBUTE_METHOD_5_FE72BF2F281C4FA8_OFFSET UNITYSDK_OFFSET(0x17B92600)
#define RPG_CLIENT_UISETTMPATTRIBUTE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x17B90260)
#define RPG_CLIENT_UISETTMPATTRIBUTE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x17B90830)
#define RPG_CLIENT_UISETTMPATTRIBUTE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x17B90490)
#define RPG_CLIENT_UISETTMPATTRIBUTE_ONINVISIBLE_OFFSET UNITYSDK_OFFSET(0x17B90E70)
#define RPG_CLIENT_UISETTMPATTRIBUTE_ONUITEXTCHANGEFONTFROMCONDENSETOCOMPLETE_OFFSET UNITYSDK_OFFSET(0x17B92650)
#define RPG_CLIENT_UISETTMPATTRIBUTE_ONUITEXTLANGUAGECHANGE_OFFSET UNITYSDK_OFFSET(0x17B92590)
#define RPG_CLIENT_UISETTMPATTRIBUTE_ONUITEXTSWITCH_OFFSET UNITYSDK_OFFSET(0x17B92690)
#define RPG_CLIENT_UISETTMPATTRIBUTE_ONUIWORLDFONTCHANGE_OFFSET UNITYSDK_OFFSET(0x17B926E0)
#define RPG_CLIENT_UISETTMPATTRIBUTE_ONVISIBLE_OFFSET UNITYSDK_OFFSET(0x17B90D50)
#define RPG_CLIENT_UISETTMPATTRIBUTE_RESETFONTSIZE_OFFSET UNITYSDK_OFFSET(0x17B91440)
#define RPG_CLIENT_UISETTMPATTRIBUTE_SETCONFIGSHOW_OFFSET UNITYSDK_OFFSET(0x17B91790)
#define RPG_CLIENT_UISETTMPATTRIBUTE_SETCUSTOMGETSDFASSETPATHDELEGATE_OFFSET UNITYSDK_OFFSET(0x17B92730)
#define RPG_CLIENT_UISETTMPATTRIBUTE_SETFACETOCAMERA_OFFSET UNITYSDK_OFFSET(0x17B91740)
#define RPG_CLIENT_UISETTMPATTRIBUTE_SETFONTSIZE_OFFSET UNITYSDK_OFFSET(0x17B913D0)
#define RPG_CLIENT_UISETTMPATTRIBUTE_SETOVERRIDEALIGNTYPE_OFFSET UNITYSDK_OFFSET(0x17B91850)
#define RPG_CLIENT_UISETTMPATTRIBUTE_SETOVERRIDEFONTASSET_OFFSET UNITYSDK_OFFSET(0x17B919A0)
#define RPG_CLIENT_UISETTMPATTRIBUTE_SETOVERRIDEISKAOMOJI_OFFSET UNITYSDK_OFFSET(0x17B91A80)
#define RPG_CLIENT_UISETTMPATTRIBUTE_SETOVERRIDESCALE_OFFSET UNITYSDK_OFFSET(0x17B914E0)
#define RPG_CLIENT_UISETTMPATTRIBUTE_SETTEXTID_OFFSET UNITYSDK_OFFSET(0x17B91100)
#define RPG_CLIENT_UISETTMPATTRIBUTE_SETTEXT_OFFSET UNITYSDK_OFFSET(0x17B91360)
#define RPG_CLIENT_UISETTMPATTRIBUTE_START_OFFSET UNITYSDK_OFFSET(0x17B90970)
#define RPG_CLIENT_UISETTMPATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x17B92A30)
#define RPG_CLIENT_UISETTMPATTRIBUTE__SHUFFLE_OFFSET UNITYSDK_OFFSET(0x17B92490)
