...
#define RPG_CLIENT_UISETTMPATTRIBUTE_AWAKE_OFFSET UNITYSDK_OFFSET(0xCB91E00)
#define RPG_CLIENT_UISETTMPATTRIBUTE_FORCETMPMESHUPDATE_OFFSET UNITYSDK_OFFSET(0xCB92250)
#define RPG_CLIENT_UISETTMPATTRIBUTE_GETCENTERPOS_OFFSET UNITYSDK_OFFSET(0xCB946D0)
#define RPG_CLIENT_UISETTMPATTRIBUTE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xCB933B0)
#define RPG_CLIENT_UISETTMPATTRIBUTE_METHOD_5_08DCF72FBE01FF99_OFFSET UNITYSDK_OFFSET(0xCB93E90)
#define RPG_CLIENT_UISETTMPATTRIBUTE_METHOD_5_0FD0EC313FAAB75A_OFFSET UNITYSDK_OFFSET(0xCB93770)
#define RPG_CLIENT_UISETTMPATTRIBUTE_METHOD_5_43E290A0B26B39F6_OFFSET UNITYSDK_OFFSET(0xCB94440)
#define RPG_CLIENT_UISETTMPATTRIBUTE_METHOD_5_56CE4AFC5339F746_OFFSET UNITYSDK_OFFSET(0xCB939B0)
#define RPG_CLIENT_UISETTMPATTRIBUTE_METHOD_5_88B60F3B95FAA4F1_OFFSET UNITYSDK_OFFSET(0xCB965D0)
#define RPG_CLIENT_UISETTMPATTRIBUTE_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xCB93650)
#define RPG_CLIENT_UISETTMPATTRIBUTE_METHOD_5_BB2928BEC244DEB7_OFFSET UNITYSDK_OFFSET(0xCB94550)
#define RPG_CLIENT_UISETTMPATTRIBUTE_METHOD_5_BF622B900A7F3625_OFFSET UNITYSDK_OFFSET(0xCB93900)
#define RPG_CLIENT_UISETTMPATTRIBUTE_METHOD_5_E3DE31A03057E055_OFFSET UNITYSDK_OFFSET(0xCB920B0)
#define RPG_CLIENT_UISETTMPATTRIBUTE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xCB91F40)
#define RPG_CLIENT_UISETTMPATTRIBUTE_ONENABLE_OFFSET UNITYSDK_OFFSET(0xCB92060)
#define RPG_CLIENT_UISETTMPATTRIBUTE_ONINVISIBLE_OFFSET UNITYSDK_OFFSET(0xCB936D0)
#define RPG_CLIENT_UISETTMPATTRIBUTE_ONUITEXTCHANGEFONTFROMCONDENSETOCOMPLETE_OFFSET UNITYSDK_OFFSET(0xCB945A0)
#define RPG_CLIENT_UISETTMPATTRIBUTE_ONUITEXTLANGUAGECHANGE_OFFSET UNITYSDK_OFFSET(0xCB944E0)
#define RPG_CLIENT_UISETTMPATTRIBUTE_ONUITEXTSWITCH_OFFSET UNITYSDK_OFFSET(0xCB945E0)
#define RPG_CLIENT_UISETTMPATTRIBUTE_ONUIWORLDFONTCHANGE_OFFSET UNITYSDK_OFFSET(0xCB94630)
#define RPG_CLIENT_UISETTMPATTRIBUTE_ONVISIBLE_OFFSET UNITYSDK_OFFSET(0xCB935B0)
#define RPG_CLIENT_UISETTMPATTRIBUTE_RESETFONTSIZE_OFFSET UNITYSDK_OFFSET(0xCB93CE0)
#define RPG_CLIENT_UISETTMPATTRIBUTE_SETCONFIGSHOW_OFFSET UNITYSDK_OFFSET(0xCB940A0)
#define RPG_CLIENT_UISETTMPATTRIBUTE_SETCUSTOMGETSDFASSETPATHDELEGATE_OFFSET UNITYSDK_OFFSET(0xCB94680)
#define RPG_CLIENT_UISETTMPATTRIBUTE_SETFACETOCAMERA_OFFSET UNITYSDK_OFFSET(0xCB94050)
#define RPG_CLIENT_UISETTMPATTRIBUTE_SETFONTSIZE_OFFSET UNITYSDK_OFFSET(0xCB93C20)
#define RPG_CLIENT_UISETTMPATTRIBUTE_SETOVERRIDEALIGNTYPE_OFFSET UNITYSDK_OFFSET(0xCB94160)
#define RPG_CLIENT_UISETTMPATTRIBUTE_SETOVERRIDEFONTASSET_OFFSET UNITYSDK_OFFSET(0xCB94240)
#define RPG_CLIENT_UISETTMPATTRIBUTE_SETOVERRIDEISKAOMOJI_OFFSET UNITYSDK_OFFSET(0xCB942C0)
#define RPG_CLIENT_UISETTMPATTRIBUTE_SETOVERRIDESCALE_OFFSET UNITYSDK_OFFSET(0xCB93DE0)
#define RPG_CLIENT_UISETTMPATTRIBUTE_SETTEXTID_OFFSET UNITYSDK_OFFSET(0xCB93950)
#define RPG_CLIENT_UISETTMPATTRIBUTE_SETTEXT_OFFSET UNITYSDK_OFFSET(0xCB93BB0)
#define RPG_CLIENT_UISETTMPATTRIBUTE_START_OFFSET UNITYSDK_OFFSET(0xCB92200)
#define RPG_CLIENT_UISETTMPATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0xCB96720)
#define RPG_CLIENT_UISETTMPATTRIBUTE__SHUFFLE_OFFSET UNITYSDK_OFFSET(0xCB94340)

namespace RPG::Client
{
	inline static constexpr unsigned int UISetTMPAttribute_TypeDefinitionIndex = 66128;
