...
#define RPG_CLIENT_UI3DGAME_MONOPOLYBARRIER_INITIALIZEVIEW_OFFSET UNITYSDK_OFFSET(0xE31BC20)
#define RPG_CLIENT_UI3DGAME_MONOPOLYBARRIER_METHOD_7_B7F8E0B4AF22DEA3_OFFSET UNITYSDK_OFFSET(0xE31BCA0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYBARRIER_SETICON_OFFSET UNITYSDK_OFFSET(0xE31BDE0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYBARRIER_SETMATERIALCOLOR_OFFSET UNITYSDK_OFFSET(0xE31BEB0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYBARRIER__CTOR_OFFSET UNITYSDK_OFFSET(0xE31BF70)

namespace RPG::Client::UI3DGame
{
	inline static constexpr unsigned int MonopolyBarrier_TypeDefinitionIndex = 75395;
