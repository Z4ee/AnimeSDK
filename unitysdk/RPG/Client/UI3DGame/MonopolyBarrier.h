...
#define RPG_CLIENT_UI3DGAME_MONOPOLYBARRIER_INITIALIZEVIEW_OFFSET UNITYSDK_OFFSET(0x1B12EB40)
#define RPG_CLIENT_UI3DGAME_MONOPOLYBARRIER_METHOD_7_B7F8E0B4AF22DEA3_OFFSET UNITYSDK_OFFSET(0x1B12EBC0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYBARRIER_SETICON_OFFSET UNITYSDK_OFFSET(0x1B12ED00)
#define RPG_CLIENT_UI3DGAME_MONOPOLYBARRIER_SETMATERIALCOLOR_OFFSET UNITYSDK_OFFSET(0x1B12EDD0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYBARRIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B12EE90)

namespace RPG::Client::UI3DGame
{
	inline static constexpr unsigned int MonopolyBarrier_TypeDefinitionIndex = 75394;
