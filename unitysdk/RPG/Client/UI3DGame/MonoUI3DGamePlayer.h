...
#define RPG_CLIENT_UI3DGAME_MONOUI3DGAMEPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x16FED890)

namespace RPG::Client::UI3DGame
{
	inline static constexpr unsigned int MonoUI3DGamePlayer_TypeDefinitionIndex = 72063;
