...
#define RPG_CLIENT_UI3DGAME_MONOPOLYGROUND_CLICK_OFFSET UNITYSDK_OFFSET(0x1B135B80)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGROUND_INITIALIZEVIEW_OFFSET UNITYSDK_OFFSET(0x1B135280)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGROUND_METHOD_7_735EE20B25F86BF4_OFFSET UNITYSDK_OFFSET(0x1B135A00)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGROUND_METHOD_7_ABE7715DB28B2DD1_OFFSET UNITYSDK_OFFSET(0x1B135770)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGROUND_METHOD_7_B7F8E0B4AF22DEA3_OFFSET UNITYSDK_OFFSET(0x1B135630)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGROUND_SETICON_OFFSET UNITYSDK_OFFSET(0x1B135AB0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGROUND_SETMATERIALCOLOR_OFFSET UNITYSDK_OFFSET(0x1B135570)
#define RPG_CLIENT_UI3DGAME_MONOPOLYGROUND__CTOR_OFFSET UNITYSDK_OFFSET(0x1B135DE0)

namespace RPG::Client::UI3DGame
{
	inline static constexpr unsigned int MonopolyGround_TypeDefinitionIndex = 75396;
