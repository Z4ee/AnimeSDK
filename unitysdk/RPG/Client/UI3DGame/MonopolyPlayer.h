...
#define RPG_CLIENT_UI3DGAME_MONOPOLYPLAYER_GETWORLDPOS_OFFSET UNITYSDK_OFFSET(0xB3B6AE0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYPLAYER_METHOD_7_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xB3B6A90)
#define RPG_CLIENT_UI3DGAME_MONOPOLYPLAYER_METHOD_7_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0xB3B6F20)
#define RPG_CLIENT_UI3DGAME_MONOPOLYPLAYER_METHOD_7_CA373AA1C7054598_3_OFFSET UNITYSDK_OFFSET(0xB3B6F60)
#define RPG_CLIENT_UI3DGAME_MONOPOLYPLAYER_METHOD_7_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xB3B6A40)
#define RPG_CLIENT_UI3DGAME_MONOPOLYPLAYER_PLAYANIM_OFFSET UNITYSDK_OFFSET(0xB3B5600)
#define RPG_CLIENT_UI3DGAME_MONOPOLYPLAYER_SETANIMBOOLPARAM_OFFSET UNITYSDK_OFFSET(0xB3B68E0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYPLAYER_SETANIMFLOATPARAM_OFFSET UNITYSDK_OFFSET(0xB3B6950)
#define RPG_CLIENT_UI3DGAME_MONOPOLYPLAYER_SETANIMTRIGGER_OFFSET UNITYSDK_OFFSET(0xB3B69D0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYPLAYER_START_OFFSET UNITYSDK_OFFSET(0xB3B6B80)
#define RPG_CLIENT_UI3DGAME_MONOPOLYPLAYER_UPDATE_OFFSET UNITYSDK_OFFSET(0xB3B6DE0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0xB3B6F10)

namespace RPG::Client::UI3DGame
{
	inline static constexpr unsigned int MonopolyPlayer_TypeDefinitionIndex = 69756;
