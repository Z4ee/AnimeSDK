...
#define RPG_CLIENT_UI3DGAME_MONOPOLYPLAYER_GETWORLDPOS_OFFSET UNITYSDK_OFFSET(0x1B136070)
#define RPG_CLIENT_UI3DGAME_MONOPOLYPLAYER_METHOD_7_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x1B136020)
#define RPG_CLIENT_UI3DGAME_MONOPOLYPLAYER_METHOD_7_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1B135FD0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYPLAYER_PLAYANIM_OFFSET UNITYSDK_OFFSET(0x1B134A90)
#define RPG_CLIENT_UI3DGAME_MONOPOLYPLAYER_SETANIMBOOLPARAM_OFFSET UNITYSDK_OFFSET(0x1B135E70)
#define RPG_CLIENT_UI3DGAME_MONOPOLYPLAYER_SETANIMFLOATPARAM_OFFSET UNITYSDK_OFFSET(0x1B135EE0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYPLAYER_SETANIMTRIGGER_OFFSET UNITYSDK_OFFSET(0x1B135F60)
#define RPG_CLIENT_UI3DGAME_MONOPOLYPLAYER_START_OFFSET UNITYSDK_OFFSET(0x1B136110)
#define RPG_CLIENT_UI3DGAME_MONOPOLYPLAYER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B136360)
#define RPG_CLIENT_UI3DGAME_MONOPOLYPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1364A0)

namespace RPG::Client::UI3DGame
{
	inline static constexpr unsigned int MonopolyPlayer_TypeDefinitionIndex = 75398;

	class MonopolyPlayer : public ::RPG::Client::UI3DGame::MonoUI3DGameView
	{
	public:
		::UnityEngine::Animator* APPGGMLEPLN; // 0x30
		::Spine::Unity::SkeletonMecanim* BDOOGHPIGIM; // 0x38
		::UnityEngine::Animator* EDLPLCCOOEP; // 0x40
		::System::String* DOOOGDBEJHB; // 0x48
