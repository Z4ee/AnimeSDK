...
#define RPG_CLIENT_UI3DGAME_MONOPOLYPLAYER_GETWORLDPOS_OFFSET UNITYSDK_OFFSET(0xCB16B20)
#define RPG_CLIENT_UI3DGAME_MONOPOLYPLAYER_METHOD_7_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xCB16AD0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYPLAYER_METHOD_7_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0xCB16F60)
#define RPG_CLIENT_UI3DGAME_MONOPOLYPLAYER_METHOD_7_CA373AA1C7054598_3_OFFSET UNITYSDK_OFFSET(0xCB16FA0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYPLAYER_METHOD_7_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xCB16A80)
#define RPG_CLIENT_UI3DGAME_MONOPOLYPLAYER_PLAYANIM_OFFSET UNITYSDK_OFFSET(0xCB15560)
#define RPG_CLIENT_UI3DGAME_MONOPOLYPLAYER_SETANIMBOOLPARAM_OFFSET UNITYSDK_OFFSET(0xCB16920)
#define RPG_CLIENT_UI3DGAME_MONOPOLYPLAYER_SETANIMFLOATPARAM_OFFSET UNITYSDK_OFFSET(0xCB16990)
#define RPG_CLIENT_UI3DGAME_MONOPOLYPLAYER_SETANIMTRIGGER_OFFSET UNITYSDK_OFFSET(0xCB16A10)
#define RPG_CLIENT_UI3DGAME_MONOPOLYPLAYER_START_OFFSET UNITYSDK_OFFSET(0xCB16BC0)
#define RPG_CLIENT_UI3DGAME_MONOPOLYPLAYER_UPDATE_OFFSET UNITYSDK_OFFSET(0xCB16E10)
#define RPG_CLIENT_UI3DGAME_MONOPOLYPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0xCB16F50)

namespace RPG::Client::UI3DGame
{
	inline static constexpr unsigned int MonopolyPlayer_TypeDefinitionIndex = 70568;
