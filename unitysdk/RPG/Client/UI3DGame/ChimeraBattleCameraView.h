...
#define RPG_CLIENT_UI3DGAME_CHIMERABATTLECAMERAVIEW_DISPOSECAMERA_OFFSET UNITYSDK_OFFSET(0xA652EA0)
#define RPG_CLIENT_UI3DGAME_CHIMERABATTLECAMERAVIEW_INITCAMERA_OFFSET UNITYSDK_OFFSET(0xA652750)
#define RPG_CLIENT_UI3DGAME_CHIMERABATTLECAMERAVIEW_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xA652C40)
#define RPG_CLIENT_UI3DGAME_CHIMERABATTLECAMERAVIEW_ONENABLE_OFFSET UNITYSDK_OFFSET(0xA652960)
#define RPG_CLIENT_UI3DGAME_CHIMERABATTLECAMERAVIEW_REFRESH_OFFSET UNITYSDK_OFFSET(0xA652B40)
#define RPG_CLIENT_UI3DGAME_CHIMERABATTLECAMERAVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xA653030)

namespace RPG::Client::UI3DGame
{
	inline static constexpr unsigned int ChimeraBattleCameraView_TypeDefinitionIndex = 61803;
