...
#define RPG_CLIENT_POOLPROPERTYRECORD__CTOR_OFFSET UNITYSDK_OFFSET(0x9FF3EF0)

namespace RPG::Client
{
	inline static constexpr unsigned int PoolPropertyRecord_TypeDefinitionIndex = 59522;
