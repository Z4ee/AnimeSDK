...
#define RPG_CLIENT_POOLPROPERTYRECORD__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE1B310)

namespace RPG::Client
{
	inline static constexpr unsigned int PoolPropertyRecord_TypeDefinitionIndex = 72551;
