...
#define RPG_CLIENT_EFFECT_LINERENDERER_LATETICK_OFFSET UNITYSDK_OFFSET(0x15E72370)
#define RPG_CLIENT_EFFECT_LINERENDERER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x15E723E0)
#define RPG_CLIENT_EFFECT_LINERENDERER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x15E722E0)
#define RPG_CLIENT_EFFECT_LINERENDERER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x15E72210)
#define RPG_CLIENT_EFFECT_LINERENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x15E72430)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_LineRenderer_TypeDefinitionIndex = 70461;
	...
	public:
		...
		::Class_2_83A4037BA4BD389C* KADDKEGNCHE; // 0x28
