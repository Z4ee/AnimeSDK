...
#define RPG_CLIENT_MONOLIGHTINTENSITYAUDIO_METHOD_5_0C44FB644D25C1C2_OFFSET UNITYSDK_OFFSET(0xA9D8310)
#define RPG_CLIENT_MONOLIGHTINTENSITYAUDIO_METHOD_5_899EC372DEC6EBDF_OFFSET UNITYSDK_OFFSET(0xA9D8100)
#define RPG_CLIENT_MONOLIGHTINTENSITYAUDIO_METHOD_5_B7A43C06FD78D78B_OFFSET UNITYSDK_OFFSET(0xA9D8390)
#define RPG_CLIENT_MONOLIGHTINTENSITYAUDIO_START_OFFSET UNITYSDK_OFFSET(0xA9D7FC0)
#define RPG_CLIENT_MONOLIGHTINTENSITYAUDIO_UPDATE_OFFSET UNITYSDK_OFFSET(0xA9D81D0)
#define RPG_CLIENT_MONOLIGHTINTENSITYAUDIO__CTOR_OFFSET UNITYSDK_OFFSET(0xA9D8400)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoLightIntensityAudio_TypeDefinitionIndex = 63271;
