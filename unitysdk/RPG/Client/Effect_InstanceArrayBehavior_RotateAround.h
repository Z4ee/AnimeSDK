...
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_ROTATEAROUND_METHOD_1_54B0E9D6F6DD967C_OFFSET UNITYSDK_OFFSET(0x150FB9A0)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_ROTATEAROUND_METHOD_1_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x150FB770)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_ROTATEAROUND__CTOR_OFFSET UNITYSDK_OFFSET(0x150FBD80)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_InstanceArrayBehavior_RotateAround_TypeDefinitionIndex = 67452;
