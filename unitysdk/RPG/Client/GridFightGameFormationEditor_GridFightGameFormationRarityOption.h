...
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_GRIDFIGHTGAMEFORMATIONRARITYOPTION_GETICON_OFFSET UNITYSDK_OFFSET(0xD1B4890)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_GRIDFIGHTGAMEFORMATIONRARITYOPTION_GETNAME_OFFSET UNITYSDK_OFFSET(0xD1B47E0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_GRIDFIGHTGAMEFORMATIONRARITYOPTION_SATISFY_OFFSET UNITYSDK_OFFSET(0xD1B4740)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONEDITOR_GRIDFIGHTGAMEFORMATIONRARITYOPTION__CTOR_OFFSET UNITYSDK_OFFSET(0xD1B3D30)
