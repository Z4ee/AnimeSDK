...
#define RPG_CLIENT_PROCEDURALUIIMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE21150)

namespace RPG::Client
{
	inline static constexpr unsigned int ProceduralUIImage_TypeDefinitionIndex = 72631;
