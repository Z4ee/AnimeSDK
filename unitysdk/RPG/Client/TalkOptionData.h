...
#define RPG_CLIENT_TALKOPTIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xE164390)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::UInt32 DialogueGroupID; // 0x40
		::System::UInt32 TalkSentenceID; // 0x44
		::System::Boolean IsSkipDefault; // 0x48
		::System::Boolean IsValid; // 0x49
		::System::Int32 InfoIndex; // 0x4C
		::System::Boolean DeleteAfterSelection; // 0x50
		::System::Boolean HasBeenTriggeredLogic; // 0x51
		::System::Boolean IsLastSelected; // 0x52
		::System::Boolean HasTriggered; // 0x53
