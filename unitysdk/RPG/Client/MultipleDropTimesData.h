...
#define RPG_CLIENT_MULTIPLEDROPTIMESDATA_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0xC1C7B10)

namespace RPG::Client
{
	inline static constexpr unsigned int MultipleDropTimesData_TypeDefinitionIndex = 62007;
