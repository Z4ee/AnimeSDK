...
#define RPG_CLIENT_ASSEMNPC_METHOD_1_92D59DB27A2254BC_OFFSET UNITYSDK_OFFSET(0x9D3A610)
#define RPG_CLIENT_ASSEMNPC_METHOD_1_9672A1E124B0978D_OFFSET UNITYSDK_OFFSET(0x9D3A440)
#define RPG_CLIENT_ASSEMNPC_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x9D3A820)
#define RPG_CLIENT_ASSEMNPC_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x9D3A7E0)
#define RPG_CLIENT_ASSEMNPC_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9D3A6F0)
#define RPG_CLIENT_ASSEMNPC__CTOR_OFFSET UNITYSDK_OFFSET(0x9D3A6B0)
#define RPG_CLIENT_ASSEMNPC___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9D3A920)

namespace RPG::Client
{
	inline static constexpr unsigned int AssemNPC_TypeDefinitionIndex = 55368;
