...
#define RPG_CLIENT_CHENLINGBATTLESTAGEDATA_GET_ALLYTEAMICONPATH_OFFSET UNITYSDK_OFFSET(0xB5DB680)
#define RPG_CLIENT_CHENLINGBATTLESTAGEDATA_GET_ENEMYCOMMANDERNAME_OFFSET UNITYSDK_OFFSET(0xB5DB5E0)
#define RPG_CLIENT_CHENLINGBATTLESTAGEDATA_GET_ENEMYTEAMICONPATHINBATTLE_OFFSET UNITYSDK_OFFSET(0xB5DB890)
#define RPG_CLIENT_CHENLINGBATTLESTAGEDATA_GET_ENEMYTEAMICONPATH_OFFSET UNITYSDK_OFFSET(0xB5DB820)
#define RPG_CLIENT_CHENLINGBATTLESTAGEDATA_GET_FINISHUNLOCKDECKID_OFFSET UNITYSDK_OFFSET(0xB5DB440)
#define RPG_CLIENT_CHENLINGBATTLESTAGEDATA_GET_ISSEENUNLOK_OFFSET UNITYSDK_OFFSET(0xB5DB4C0)
#define RPG_CLIENT_CHENLINGBATTLESTAGEDATA_GET_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0xB5DB4B0)
#define RPG_CLIENT_CHENLINGBATTLESTAGEDATA_GET_LOCKDECKID_OFFSET UNITYSDK_OFFSET(0xB5BD6B0)
#define RPG_CLIENT_CHENLINGBATTLESTAGEDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xB5DB3B0)
#define RPG_CLIENT_CHENLINGBATTLESTAGEDATA_GET_NEXTID_OFFSET UNITYSDK_OFFSET(0xB5DB2C0)
#define RPG_CLIENT_CHENLINGBATTLESTAGEDATA_GET_STAGESTATE_OFFSET UNITYSDK_OFFSET(0xB5DB5D0)
#define RPG_CLIENT_CHENLINGBATTLESTAGEDATA_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xB5DB1F0)
#define RPG_CLIENT_CHENLINGBATTLESTAGEDATA_GET_WAVEDATAS_OFFSET UNITYSDK_OFFSET(0xB5DB660)
#define RPG_CLIENT_CHENLINGBATTLESTAGEDATA_GET__NAME_OFFSET UNITYSDK_OFFSET(0xB5DB330)
#define RPG_CLIENT_CHENLINGBATTLESTAGEDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xB5DB260)
#define RPG_CLIENT_CHENLINGBATTLESTAGEDATA_SETUNLOCKSTATE_OFFSET UNITYSDK_OFFSET(0xB5DADF0)
#define RPG_CLIENT_CHENLINGBATTLESTAGEDATA_SET_WAVEDATAS_OFFSET UNITYSDK_OFFSET(0xB5DB670)
#define RPG_CLIENT_CHENLINGBATTLESTAGEDATA_SYNCSTATE_OFFSET UNITYSDK_OFFSET(0xB5DAE40)
#define RPG_CLIENT_CHENLINGBATTLESTAGEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB5DAA80)

namespace RPG::Client
{
	inline static constexpr unsigned int ChenLingBattleStageData_TypeDefinitionIndex = 57457;
	...
	public:
		...
		::RPG::Client::StageState _StageState; // 0x18
