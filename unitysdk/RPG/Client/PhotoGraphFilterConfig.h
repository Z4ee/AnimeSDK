...
#define RPG_CLIENT_PHOTOGRAPHFILTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xC37C470)

namespace RPG::Client
{
	inline static constexpr unsigned int PhotoGraphFilterConfig_TypeDefinitionIndex = 64916;
