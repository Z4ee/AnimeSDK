...
#define RPG_CLIENT_ELATIONBUFFPRESENTER___C__DISPLAYCLASS9_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC54930)
#define RPG_CLIENT_ELATIONBUFFPRESENTER___C__DISPLAYCLASS9_0__SETUPVIEW_B__0_OFFSET UNITYSDK_OFFSET(0x1AC55120)

namespace RPG::Client
{
	inline static constexpr unsigned int ElationBuffPresenter___c__DisplayClass9_0_TypeDefinitionIndex = 71153;

	class ElationBuffPresenter___c__DisplayClass9_0 : public ::System::Object
	{
	public:
		::System::Collections::Generic::List_1<::Class_1_7807B2B04302CD7B_33*>* mergedList; // 0x10
