...
#define RPG_CLIENT_RUNTIMEGROUPMANAGER___C__DISPLAYCLASS135_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA40B840)
#define RPG_CLIENT_RUNTIMEGROUPMANAGER___C__DISPLAYCLASS135_0__DESTROYLOCALENTITY_B__0_OFFSET UNITYSDK_OFFSET(0xA40C650)
#define RPG_CLIENT_RUNTIMEGROUPMANAGER___C__DISPLAYCLASS135_0__DESTROYLOCALENTITY_B__1_OFFSET UNITYSDK_OFFSET(0xA40C680)
#define RPG_CLIENT_RUNTIMEGROUPMANAGER___C__DISPLAYCLASS135_0__DESTROYLOCALENTITY_B__2_OFFSET UNITYSDK_OFFSET(0xA40C6B0)

namespace RPG::Client
{
	inline static constexpr unsigned int RuntimeGroupManager___c__DisplayClass135_0_TypeDefinitionIndex = 50406;
