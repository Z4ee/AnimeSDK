...
#define RPG_CLIENT_RUNTIMEGROUPMANAGER___C__DISPLAYCLASS135_0__CTOR_OFFSET UNITYSDK_OFFSET(0x19F1E6B0)
#define RPG_CLIENT_RUNTIMEGROUPMANAGER___C__DISPLAYCLASS135_0__DESTROYLOCALENTITY_B__0_OFFSET UNITYSDK_OFFSET(0x19F1F870)
#define RPG_CLIENT_RUNTIMEGROUPMANAGER___C__DISPLAYCLASS135_0__DESTROYLOCALENTITY_B__1_OFFSET UNITYSDK_OFFSET(0x19F1F8A0)
#define RPG_CLIENT_RUNTIMEGROUPMANAGER___C__DISPLAYCLASS135_0__DESTROYLOCALENTITY_B__2_OFFSET UNITYSDK_OFFSET(0x19F1F8D0)

namespace RPG::Client
{
	inline static constexpr unsigned int RuntimeGroupManager___c__DisplayClass135_0_TypeDefinitionIndex = 59321;
