...
#define RPG_CLIENT_BYISPLANETFESBUSINESSDAYFINISHED_METHOD_4_0809368306DFE494_OFFSET UNITYSDK_OFFSET(0x16E842F0)
#define RPG_CLIENT_BYISPLANETFESBUSINESSDAYFINISHED_METHOD_4_9CDA0203E4D9959E_OFFSET UNITYSDK_OFFSET(0x16E843C0)
#define RPG_CLIENT_BYISPLANETFESBUSINESSDAYFINISHED__CTOR_OFFSET UNITYSDK_OFFSET(0x16E84370)

namespace RPG::Client
{
	inline static constexpr unsigned int ByIsPlanetFesBusinessDayFinished_TypeDefinitionIndex = 9971;
