...
#define RPG_CLIENT_BYISPLANETFESBUSINESSDAYFINISHED_METHOD_4_7A30098FA5390EF9_OFFSET UNITYSDK_OFFSET(0x1B9E3F50)
#define RPG_CLIENT_BYISPLANETFESBUSINESSDAYFINISHED_METHOD_4_93CC1C55289CA958_OFFSET UNITYSDK_OFFSET(0x1B9E3F20)
#define RPG_CLIENT_BYISPLANETFESBUSINESSDAYFINISHED_METHOD_4_9CDA0203E4D9959E_OFFSET UNITYSDK_OFFSET(0x1B9E3DE0)
#define RPG_CLIENT_BYISPLANETFESBUSINESSDAYFINISHED_METHOD_4_C3088E9A8E772E5D_OFFSET UNITYSDK_OFFSET(0x1B9E3DA0)
#define RPG_CLIENT_BYISPLANETFESBUSINESSDAYFINISHED__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9E3DD0)

namespace RPG::Client
{
	inline static constexpr unsigned int ByIsPlanetFesBusinessDayFinished_TypeDefinitionIndex = 9962;
