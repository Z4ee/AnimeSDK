...
#define RPG_CLIENT_UI3DTRANSITION___C__DISPLAYCLASS1_0__CTOR_OFFSET UNITYSDK_OFFSET(0xE327B40)
#define RPG_CLIENT_UI3DTRANSITION___C__DISPLAYCLASS1_0__EXECUTESHOW_B__0_OFFSET UNITYSDK_OFFSET(0xE328F00)
#define RPG_CLIENT_UI3DTRANSITION___C__DISPLAYCLASS1_0__EXECUTESHOW_B__1_OFFSET UNITYSDK_OFFSET(0xE328F20)
#define RPG_CLIENT_UI3DTRANSITION___C__DISPLAYCLASS1_0__EXECUTESHOW_B__2_OFFSET UNITYSDK_OFFSET(0xE328F80)

namespace RPG::Client
{
	inline static constexpr unsigned int UI3DTransition___c__DisplayClass1_0_TypeDefinitionIndex = 72926;

	class UI3DTransition___c__DisplayClass1_0 : public ::System::Object
	{
	public:
		::RPG::Client::UIController* from2d; // 0x10
		::RPG::Client::IUI3DController* to3d; // 0x18
		::RPG::Client::IUI3DController* from3d; // 0x20
		::RPG::Client::UIController* to2d; // 0x28
		::RPG::Client::UI3DControllerConfig* toConfig; // 0x30
