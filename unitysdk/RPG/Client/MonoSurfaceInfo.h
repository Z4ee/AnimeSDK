...
#define RPG_CLIENT_MONOSURFACEINFO_AWAKE_OFFSET UNITYSDK_OFFSET(0x9D376B0)
#define RPG_CLIENT_MONOSURFACEINFO_GETSURFACETYPE_OFFSET UNITYSDK_OFFSET(0x9D37080)
#define RPG_CLIENT_MONOSURFACEINFO_GET_ENABLESEALEVELALTITUDE_OFFSET UNITYSDK_OFFSET(0x9D37330)
#define RPG_CLIENT_MONOSURFACEINFO_GET_GETSEALEVELALTITUDE_OFFSET UNITYSDK_OFFSET(0x9D37410)
#define RPG_CLIENT_MONOSURFACEINFO_GET_SEACOLOR_OFFSET UNITYSDK_OFFSET(0x9D374E0)
#define RPG_CLIENT_MONOSURFACEINFO_METHOD_5_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x9D37400)
#define RPG_CLIENT_MONOSURFACEINFO_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9D379E0)
#define RPG_CLIENT_MONOSURFACEINFO_START_OFFSET UNITYSDK_OFFSET(0x9D37870)
#define RPG_CLIENT_MONOSURFACEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x9D37AB0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoSurfaceInfo_TypeDefinitionIndex = 56264;
