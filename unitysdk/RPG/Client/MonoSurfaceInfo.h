...
#define RPG_CLIENT_MONOSURFACEINFO_AWAKE_OFFSET UNITYSDK_OFFSET(0x1C280C60)
#define RPG_CLIENT_MONOSURFACEINFO_GETSURFACETYPE_OFFSET UNITYSDK_OFFSET(0x1C2806E0)
#define RPG_CLIENT_MONOSURFACEINFO_GET_ENABLESEALEVELALTITUDE_OFFSET UNITYSDK_OFFSET(0x1C280940)
#define RPG_CLIENT_MONOSURFACEINFO_GET_GETSEALEVELALTITUDE_OFFSET UNITYSDK_OFFSET(0x1C280A00)
#define RPG_CLIENT_MONOSURFACEINFO_GET_SEACOLOR_OFFSET UNITYSDK_OFFSET(0x1C280AC0)
#define RPG_CLIENT_MONOSURFACEINFO_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1C281030)
#define RPG_CLIENT_MONOSURFACEINFO_METHOD_5_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1C2809F0)
#define RPG_CLIENT_MONOSURFACEINFO_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1C280F60)
#define RPG_CLIENT_MONOSURFACEINFO_START_OFFSET UNITYSDK_OFFSET(0x1C280DF0)
#define RPG_CLIENT_MONOSURFACEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1C281070)
