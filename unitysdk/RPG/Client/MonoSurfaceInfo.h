...
#define RPG_CLIENT_MONOSURFACEINFO_AWAKE_OFFSET UNITYSDK_OFFSET(0xA9FA890)
#define RPG_CLIENT_MONOSURFACEINFO_GETSURFACETYPE_OFFSET UNITYSDK_OFFSET(0xA9FA260)
#define RPG_CLIENT_MONOSURFACEINFO_GET_ENABLESEALEVELALTITUDE_OFFSET UNITYSDK_OFFSET(0xA9FA510)
#define RPG_CLIENT_MONOSURFACEINFO_GET_GETSEALEVELALTITUDE_OFFSET UNITYSDK_OFFSET(0xA9FA5F0)
#define RPG_CLIENT_MONOSURFACEINFO_GET_SEACOLOR_OFFSET UNITYSDK_OFFSET(0xA9FA6C0)
#define RPG_CLIENT_MONOSURFACEINFO_METHOD_5_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xA9FA5E0)
#define RPG_CLIENT_MONOSURFACEINFO_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xA9FABC0)
#define RPG_CLIENT_MONOSURFACEINFO_START_OFFSET UNITYSDK_OFFSET(0xA9FAA50)
#define RPG_CLIENT_MONOSURFACEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xA9FAC90)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoSurfaceInfo_TypeDefinitionIndex = 63507;

	class MonoSurfaceInfo : public ::UnityEngine::MonoBehaviour
	{
	public:
		// static const ::System::Int32 Field_5_10 = 0x2; // 0x0
