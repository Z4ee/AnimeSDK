...
#define RPG_CLIENT_TAROTEXPERIMENTSENTENCE__CTOR_OFFSET UNITYSDK_OFFSET(0xB28C600)

namespace RPG::Client
{
	inline static constexpr unsigned int TarotExperimentSentence_TypeDefinitionIndex = 62745;
