...
#define RPG_CLIENT_TAROTEXPERIMENTSENTENCE__CTOR_OFFSET UNITYSDK_OFFSET(0xC9DA660)

namespace RPG::Client
{
	inline static constexpr unsigned int TarotExperimentSentence_TypeDefinitionIndex = 63678;
