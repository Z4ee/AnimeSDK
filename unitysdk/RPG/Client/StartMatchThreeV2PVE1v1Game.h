...
#define RPG_CLIENT_STARTMATCHTHREEV2PVE1V1GAME_METHOD_3_1703938A48A95BEF_OFFSET UNITYSDK_OFFSET(0x185EE440)
#define RPG_CLIENT_STARTMATCHTHREEV2PVE1V1GAME_METHOD_3_E588D3D2767063A9_OFFSET UNITYSDK_OFFSET(0x185EE3C0)
#define RPG_CLIENT_STARTMATCHTHREEV2PVE1V1GAME__CTOR_OFFSET UNITYSDK_OFFSET(0x185EE410)

namespace RPG::Client
{
	inline static constexpr unsigned int StartMatchThreeV2PVE1v1Game_TypeDefinitionIndex = 10124;
