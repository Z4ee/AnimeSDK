...
#define RPG_CLIENT_STARTMATCHTHREEV2PVE1V1GAME_METHOD_3_1703938A48A95BEF_OFFSET UNITYSDK_OFFSET(0x1B9F20A0)
#define RPG_CLIENT_STARTMATCHTHREEV2PVE1V1GAME_METHOD_3_C2E53916756F2EF2_OFFSET UNITYSDK_OFFSET(0x1B9F2060)
#define RPG_CLIENT_STARTMATCHTHREEV2PVE1V1GAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9F2090)

namespace RPG::Client
{
	inline static constexpr unsigned int StartMatchThreeV2PVE1v1Game_TypeDefinitionIndex = 9941;
