...
#define RPG_CLIENT_STARTMATCHTHREEV2PVE1V1GAME_METHOD_3_1703938A48A95BEF_OFFSET UNITYSDK_OFFSET(0x16E8DE60)
#define RPG_CLIENT_STARTMATCHTHREEV2PVE1V1GAME_METHOD_3_E588D3D2767063A9_OFFSET UNITYSDK_OFFSET(0x16E8DDE0)
#define RPG_CLIENT_STARTMATCHTHREEV2PVE1V1GAME__CTOR_OFFSET UNITYSDK_OFFSET(0x16E8DE30)

namespace RPG::Client
{
	inline static constexpr unsigned int StartMatchThreeV2PVE1v1Game_TypeDefinitionIndex = 9950;
