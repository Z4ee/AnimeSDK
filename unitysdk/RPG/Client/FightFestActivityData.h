...
#define RPG_CLIENT_FIGHTFESTACTIVITYDATA_ISSHOWMAPPINGINFONEWCONTENTREDDOT_OFFSET UNITYSDK_OFFSET(0x1AE4CB50)
#define RPG_CLIENT_FIGHTFESTACTIVITYDATA_ISSHOWMAPPINGINFOREWARDREDDOT_OFFSET UNITYSDK_OFFSET(0x1AE4C970)
#define RPG_CLIENT_FIGHTFESTACTIVITYDATA_ISSHOWNORMALREDDOT_OFFSET UNITYSDK_OFFSET(0x1AE4C2D0)
#define RPG_CLIENT_FIGHTFESTACTIVITYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE4C2C0)
