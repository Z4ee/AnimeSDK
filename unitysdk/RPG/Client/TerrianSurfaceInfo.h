...
#define RPG_CLIENT_TERRIANSURFACEINFO_GET_ENABLESEALEVELALTITUDE_OFFSET UNITYSDK_OFFSET(0xE1C7A30)
#define RPG_CLIENT_TERRIANSURFACEINFO_GET_ISWATERSURFACE_OFFSET UNITYSDK_OFFSET(0xE1C7AC0)
#define RPG_CLIENT_TERRIANSURFACEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xE1C7B20)
