...
#define RPG_CLIENT_TERRIANSURFACEINFO_GET_ENABLESEALEVELALTITUDE_OFFSET UNITYSDK_OFFSET(0xA587090)
#define RPG_CLIENT_TERRIANSURFACEINFO_GET_ISWATERSURFACE_OFFSET UNITYSDK_OFFSET(0xA587120)
#define RPG_CLIENT_TERRIANSURFACEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xA587180)

namespace RPG::Client
{
	inline static constexpr unsigned int TerrianSurfaceInfo_TypeDefinitionIndex = 56265;
