...
#define RPG_CLIENT_MONONODESWITCHBYGAMEPAD_AWAKE_OFFSET UNITYSDK_OFFSET(0xC134770)
#define RPG_CLIENT_MONONODESWITCHBYGAMEPAD_METHOD_5_1752943C8EA15AFA_OFFSET UNITYSDK_OFFSET(0xC1348A0)
#define RPG_CLIENT_MONONODESWITCHBYGAMEPAD_METHOD_5_4AF2A5D5BDF9E39E_OFFSET UNITYSDK_OFFSET(0xC134A70)
#define RPG_CLIENT_MONONODESWITCHBYGAMEPAD_METHOD_5_F16FCAE680E5B284_OFFSET UNITYSDK_OFFSET(0xC1349D0)
#define RPG_CLIENT_MONONODESWITCHBYGAMEPAD_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC134910)
#define RPG_CLIENT_MONONODESWITCHBYGAMEPAD__CTOR_OFFSET UNITYSDK_OFFSET(0xC134C50)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoNodeSwitchByGamepad_TypeDefinitionIndex = 68026;
