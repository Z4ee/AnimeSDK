...
#define RPG_CLIENT_MONONODESWITCHBYGAMEPAD_AWAKE_OFFSET UNITYSDK_OFFSET(0x1ACFC710)
#define RPG_CLIENT_MONONODESWITCHBYGAMEPAD_METHOD_5_1752943C8EA15AFA_OFFSET UNITYSDK_OFFSET(0x1ACFC840)
#define RPG_CLIENT_MONONODESWITCHBYGAMEPAD_METHOD_5_4AF2A5D5BDF9E39E_OFFSET UNITYSDK_OFFSET(0x1ACFCA10)
#define RPG_CLIENT_MONONODESWITCHBYGAMEPAD_METHOD_5_F16FCAE680E5B284_OFFSET UNITYSDK_OFFSET(0x1ACFC970)
#define RPG_CLIENT_MONONODESWITCHBYGAMEPAD_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1ACFC8B0)
#define RPG_CLIENT_MONONODESWITCHBYGAMEPAD__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACFCBF0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoNodeSwitchByGamepad_TypeDefinitionIndex = 72740;
