...
#define RPG_CLIENT_MULTIFLOORCONFLICTMODULE_PAMOCCUPYDETAIL__CTOR_OFFSET UNITYSDK_OFFSET(0x19081FC0)

namespace RPG::Client
{
	inline static constexpr unsigned int MultiFloorConflictModule_PamOccupyDetail_TypeDefinitionIndex = 63356;
