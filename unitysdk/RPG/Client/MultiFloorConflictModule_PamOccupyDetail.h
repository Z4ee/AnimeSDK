...
#define RPG_CLIENT_MULTIFLOORCONFLICTMODULE_PAMOCCUPYDETAIL__CTOR_OFFSET UNITYSDK_OFFSET(0xAAE59B0)

namespace RPG::Client
{
	inline static constexpr unsigned int MultiFloorConflictModule_PamOccupyDetail_TypeDefinitionIndex = 61057;
