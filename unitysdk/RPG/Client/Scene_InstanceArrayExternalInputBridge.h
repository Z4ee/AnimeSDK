...
#define RPG_CLIENT_SCENE_INSTANCEARRAYEXTERNALINPUTBRIDGE_CLEARALLFROMTHISBRIDGE_OFFSET UNITYSDK_OFFSET(0xE063AA0)
#define RPG_CLIENT_SCENE_INSTANCEARRAYEXTERNALINPUTBRIDGE_METHOD_7_3C51FAD380D99C61_OFFSET UNITYSDK_OFFSET(0xE062D80)
#define RPG_CLIENT_SCENE_INSTANCEARRAYEXTERNALINPUTBRIDGE_PUSHFROMTRANSFORM_OFFSET UNITYSDK_OFFSET(0xE062E30)
#define RPG_CLIENT_SCENE_INSTANCEARRAYEXTERNALINPUTBRIDGE_PUSHTRANSFORM_OFFSET UNITYSDK_OFFSET(0xE063490)
#define RPG_CLIENT_SCENE_INSTANCEARRAYEXTERNALINPUTBRIDGE_REMOVETRANSFORM_OFFSET UNITYSDK_OFFSET(0xE063750)
#define RPG_CLIENT_SCENE_INSTANCEARRAYEXTERNALINPUTBRIDGE__CTOR_OFFSET UNITYSDK_OFFSET(0xE063FB0)
