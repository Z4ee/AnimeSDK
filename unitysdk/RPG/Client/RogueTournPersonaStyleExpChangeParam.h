...
#define RPG_CLIENT_ROGUETOURNPERSONASTYLEEXPCHANGEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xA3C7860)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueTournPersonaStyleExpChangeParam_TypeDefinitionIndex = 54562;
