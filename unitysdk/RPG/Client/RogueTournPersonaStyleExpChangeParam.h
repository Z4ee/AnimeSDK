...
#define RPG_CLIENT_ROGUETOURNPERSONASTYLEEXPCHANGEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA728D0)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueTournPersonaStyleExpChangeParam_TypeDefinitionIndex = 64050;
