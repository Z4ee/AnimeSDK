...
#define RPG_CLIENT_PLANETFESASSISTANTCONTROLLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0xDB2F8A0)
#define RPG_CLIENT_PLANETFESASSISTANTCONTROLLER_GETGLOBALCOOLDOWNSENDTIME_OFFSET UNITYSDK_OFFSET(0xDB2F920)
#define RPG_CLIENT_PLANETFESASSISTANTCONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0xDB2F390)
#define RPG_CLIENT_PLANETFESASSISTANTCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xDB2F970)
#define RPG_CLIENT_PLANETFESASSISTANTCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xDB2F9E0)
#define RPG_CLIENT_PLANETFESASSISTANTCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xDB30360)
#define RPG_CLIENT_PLANETFESASSISTANTCONTROLLER__HIDEMESSAGE_OFFSET UNITYSDK_OFFSET(0xDB30070)
#define RPG_CLIENT_PLANETFESASSISTANTCONTROLLER__INITMESSAGES_OFFSET UNITYSDK_OFFSET(0xDB2F4A0)
#define RPG_CLIENT_PLANETFESASSISTANTCONTROLLER__ONPLANETFESASSISTANTMESSAGE_OFFSET UNITYSDK_OFFSET(0xDB30260)
#define RPG_CLIENT_PLANETFESASSISTANTCONTROLLER__SHOWMESSAGE_OFFSET UNITYSDK_OFFSET(0xDB30120)
#define RPG_CLIENT_PLANETFESASSISTANTCONTROLLER__TICKALLMESSAGES_OFFSET UNITYSDK_OFFSET(0xDB2FB90)
#define RPG_CLIENT_PLANETFESASSISTANTCONTROLLER__TICKHIDE_OFFSET UNITYSDK_OFFSET(0xDB30000)
#define RPG_CLIENT_PLANETFESASSISTANTCONTROLLER__TICKSHOWING_OFFSET UNITYSDK_OFFSET(0xDB2FF80)
#define RPG_CLIENT_PLANETFESASSISTANTCONTROLLER__TRYSENDMESSAGE_OFFSET UNITYSDK_OFFSET(0xDB2FCC0)
