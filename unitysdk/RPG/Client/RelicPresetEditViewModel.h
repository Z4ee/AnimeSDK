...
#define RPG_CLIENT_RELICPRESETEDITVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0x1987FC50)
#define RPG_CLIENT_RELICPRESETEDITVIEWMODEL_GETINVENTORYRELICITEMDATALIST_OFFSET UNITYSDK_OFFSET(0x1987FDB0)
#define RPG_CLIENT_RELICPRESETEDITVIEWMODEL_GETRELICITEMDATA_OFFSET UNITYSDK_OFFSET(0x19880160)
#define RPG_CLIENT_RELICPRESETEDITVIEWMODEL_GETRELICRECOMMENDDATA_OFFSET UNITYSDK_OFFSET(0x198802F0)
#define RPG_CLIENT_RELICPRESETEDITVIEWMODEL_GET_PLANVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x19880630)
#define RPG_CLIENT_RELICPRESETEDITVIEWMODEL_SET_PLANVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x19880640)
#define RPG_CLIENT_RELICPRESETEDITVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1987FDA0)
#define RPG_CLIENT_RELICPRESETEDITVIEWMODEL__GETRELICTYPEMATCHSCORE_OFFSET UNITYSDK_OFFSET(0x19880340)
#define RPG_CLIENT_RELICPRESETEDITVIEWMODEL__SORTINVENTORYRELICITEMS_OFFSET UNITYSDK_OFFSET(0x1987FE20)

namespace RPG::Client
{
	inline static constexpr unsigned int RelicPresetEditViewModel_TypeDefinitionIndex = 63870;

	class RelicPresetEditViewModel : public ::System::Object
	{
	public:
		::Class_1_5D2E9E194E93B02A* _PresetDataService; // 0x10
		::Class_1_1D95EF1836E9FE9D* _PresetCalculatorService; // 0x18
		::RPG::Client::RelicRecommendData* _RecommendData; // 0x20
		::RPG::Client::RelicPresetPlanViewModel* _PlanViewModel_k__BackingField; // 0x28
