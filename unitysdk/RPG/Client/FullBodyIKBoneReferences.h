...
#define RPG_CLIENT_FULLBODYIKBONEREFERENCES_METHOD_2_906D8EFA88B137F6_OFFSET UNITYSDK_OFFSET(0x3AF8260)
#define RPG_CLIENT_FULLBODYIKBONEREFERENCES_METHOD_2_99919161C4ADBACD_OFFSET UNITYSDK_OFFSET(0x3AF8270)

namespace RPG::Client
{
	inline static constexpr unsigned int FullBodyIKBoneReferences_TypeDefinitionIndex = 68567;
