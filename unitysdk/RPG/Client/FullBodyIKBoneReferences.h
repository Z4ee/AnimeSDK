...
#define RPG_CLIENT_FULLBODYIKBONEREFERENCES_METHOD_2_906D8EFA88B137F6_OFFSET UNITYSDK_OFFSET(0x3948850)
#define RPG_CLIENT_FULLBODYIKBONEREFERENCES_METHOD_2_99919161C4ADBACD_OFFSET UNITYSDK_OFFSET(0x3948860)

namespace RPG::Client
{
	inline static constexpr unsigned int FullBodyIKBoneReferences_TypeDefinitionIndex = 65552;
