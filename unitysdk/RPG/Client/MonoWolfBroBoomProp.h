...
#define RPG_CLIENT_MONOWOLFBROBOOMPROP__CTOR_OFFSET UNITYSDK_OFFSET(0xAA12340)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoWolfBroBoomProp_TypeDefinitionIndex = 63359;
