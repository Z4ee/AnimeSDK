...
#define RPG_CLIENT_FATEHANDBOOKHOUGUITEM_CREATE_OFFSET UNITYSDK_OFFSET(0x1C191730)
#define RPG_CLIENT_FATEHANDBOOKHOUGUITEM_GET_EXTRAEFFECTARRAY_OFFSET UNITYSDK_OFFSET(0x1C1924B0)
#define RPG_CLIENT_FATEHANDBOOKHOUGUITEM_GET_HOUGUDESC_OFFSET UNITYSDK_OFFSET(0x1C191EE0)
#define RPG_CLIENT_FATEHANDBOOKHOUGUITEM_GET_HOUGUDISPLAYDATA_OFFSET UNITYSDK_OFFSET(0x1C191830)
#define RPG_CLIENT_FATEHANDBOOKHOUGUITEM_GET_HOUGUEFFECT_OFFSET UNITYSDK_OFFSET(0x1C191BA0)
#define RPG_CLIENT_FATEHANDBOOKHOUGUITEM_GET_HOUGUICONPATH_OFFSET UNITYSDK_OFFSET(0x1C1922D0)
#define RPG_CLIENT_FATEHANDBOOKHOUGUITEM_GET_HOUGUID_OFFSET UNITYSDK_OFFSET(0x1C191810)
#define RPG_CLIENT_FATEHANDBOOKHOUGUITEM_GET_HOUGUNAME_OFFSET UNITYSDK_OFFSET(0x1C191970)
#define RPG_CLIENT_FATEHANDBOOKHOUGUITEM_GET_HOUGUTYPE_OFFSET UNITYSDK_OFFSET(0x1C192110)
#define RPG_CLIENT_FATEHANDBOOKHOUGUITEM_SET_HOUGUID_OFFSET UNITYSDK_OFFSET(0x1C191820)
#define RPG_CLIENT_FATEHANDBOOKHOUGUITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1C191800)

namespace RPG::Client
{
	inline static constexpr unsigned int FateHandbookHouguItem_TypeDefinitionIndex = 64133;
