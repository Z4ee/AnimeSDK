...
#define RPG_CLIENT_MONOEFFECTPLUGINSYNCTARGETNORMALIZEDTIME_AWAKEPLUGIN_OFFSET UNITYSDK_OFFSET(0xD7C9EF0)
#define RPG_CLIENT_MONOEFFECTPLUGINSYNCTARGETNORMALIZEDTIME_DESTROYPLUGIN_OFFSET UNITYSDK_OFFSET(0xD7C9FA0)
#define RPG_CLIENT_MONOEFFECTPLUGINSYNCTARGETNORMALIZEDTIME_DISPOSEPLUGIN_OFFSET UNITYSDK_OFFSET(0xD7CA0D0)
#define RPG_CLIENT_MONOEFFECTPLUGINSYNCTARGETNORMALIZEDTIME_IGNOREINEDITOR_OFFSET UNITYSDK_OFFSET(0xD7C9EB0)
#define RPG_CLIENT_MONOEFFECTPLUGINSYNCTARGETNORMALIZEDTIME_RESETPLUGIN_OFFSET UNITYSDK_OFFSET(0xD7CA040)
#define RPG_CLIENT_MONOEFFECTPLUGINSYNCTARGETNORMALIZEDTIME_SETOVERRIDETARGET_OFFSET UNITYSDK_OFFSET(0xD7CA1B0)
#define RPG_CLIENT_MONOEFFECTPLUGINSYNCTARGETNORMALIZEDTIME_TICK_OFFSET UNITYSDK_OFFSET(0xD7CA140)
#define RPG_CLIENT_MONOEFFECTPLUGINSYNCTARGETNORMALIZEDTIME__CTOR_OFFSET UNITYSDK_OFFSET(0xD7CA230)
