...
#define RPG_CLIENT_MATCHTHREEGAME___C__DISPLAYCLASS73_1__CTOR_OFFSET UNITYSDK_OFFSET(0xBF7D470)
#define RPG_CLIENT_MATCHTHREEGAME___C__DISPLAYCLASS73_1___UPDATEPLAYER_B__1_OFFSET UNITYSDK_OFFSET(0xBF81630)

namespace RPG::Client
{
	inline static constexpr unsigned int MatchThreeGame___c__DisplayClass73_1_TypeDefinitionIndex = 61648;

	class MatchThreeGame___c__DisplayClass73_1 : public ::System::Object
	{
	public:
		::Class_1_D17272E82AE804C2_326* itemInfo; // 0x10
