...
#define RPG_CLIENT_RECOMMENDDISPLAYCONFIG_GET_ENVIRONMENTPROFILEPATH_OFFSET UNITYSDK_OFFSET(0xDE13CE0)
#define RPG_CLIENT_RECOMMENDDISPLAYCONFIG_GET_INTROID_OFFSET UNITYSDK_OFFSET(0xDE13D00)
#define RPG_CLIENT_RECOMMENDDISPLAYCONFIG_GET_UI3DPREFAB_OFFSET UNITYSDK_OFFSET(0xDE13CC0)
#define RPG_CLIENT_RECOMMENDDISPLAYCONFIG_GET_UIPREFAB_OFFSET UNITYSDK_OFFSET(0xDE13CA0)
#define RPG_CLIENT_RECOMMENDDISPLAYCONFIG_SET_ENVIRONMENTPROFILEPATH_OFFSET UNITYSDK_OFFSET(0xDE13CF0)
#define RPG_CLIENT_RECOMMENDDISPLAYCONFIG_SET_INTROID_OFFSET UNITYSDK_OFFSET(0xDE13D10)
#define RPG_CLIENT_RECOMMENDDISPLAYCONFIG_SET_UI3DPREFAB_OFFSET UNITYSDK_OFFSET(0xDE13CD0)
#define RPG_CLIENT_RECOMMENDDISPLAYCONFIG_SET_UIPREFAB_OFFSET UNITYSDK_OFFSET(0xDE13CB0)
#define RPG_CLIENT_RECOMMENDDISPLAYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xDE13D20)
...
namespace RPG::Client
{
	...
	{
	public:
		::System::String* _UI3DPrefab_k__BackingField; // 0x10
		::System::String* _EnvironmentProfilePath_k__BackingField; // 0x18
		::System::String* _UIPrefab_k__BackingField; // 0x20
