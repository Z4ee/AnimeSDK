...
#define RPG_CLIENT_GAMESTATESERVICE_ANDROIDGAMESTATESERVICEMANAGER__SENDGAMESTATEINFO_D__93_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xD7840)
#define RPG_CLIENT_GAMESTATESERVICE_ANDROIDGAMESTATESERVICEMANAGER__SENDGAMESTATEINFO_D__93_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0xD7850)

namespace RPG::Client::GameStateService
{
	inline static constexpr unsigned int AndroidGameStateServiceManager__SendGameStateInfo_d__93_TypeDefinitionIndex = 69689;
	...
	struct alignas(8) AndroidGameStateServiceManager__SendGameStateInfo_d__93
	{
		...
		::SimpleJSON::JSONClass* jsonClass; // 0x20
