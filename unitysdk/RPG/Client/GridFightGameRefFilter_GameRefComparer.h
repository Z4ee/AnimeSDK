...
#define RPG_CLIENT_GRIDFIGHTGAMEREFFILTER_GAMEREFCOMPARER_COMPARE_OFFSET UNITYSDK_OFFSET(0x1BA28300)
#define RPG_CLIENT_GRIDFIGHTGAMEREFFILTER_GAMEREFCOMPARER_GETCOMPARER_OFFSET UNITYSDK_OFFSET(0x1BA23E40)
#define RPG_CLIENT_GRIDFIGHTGAMEREFFILTER_GAMEREFCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA282F0)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightGameRefFilter_GameRefComparer_TypeDefinitionIndex = 64818;
