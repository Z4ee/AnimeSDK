...
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_ADDSCORE_OFFSET UNITYSDK_OFFSET(0x16809E70)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_BUILDARRAYINFO_OFFSET UNITYSDK_OFFSET(0x1680B000)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_BUILDGAMEPLAYINFO_OFFSET UNITYSDK_OFFSET(0x1680AB70)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_CONTROLWOLFBROPLAYER_OFFSET UNITYSDK_OFFSET(0x168041C0)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_DELSCORE_OFFSET UNITYSDK_OFFSET(0x16809FA0)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_DISABLEBULLETTIME_OFFSET UNITYSDK_OFFSET(0x16808B00)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16808760)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_ENABLEBULLETTIME_OFFSET UNITYSDK_OFFSET(0x16809170)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_EVALUATECOUNTDOWNSCORE_OFFSET UNITYSDK_OFFSET(0x168070D0)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_EVALUATEDELSCORE_OFFSET UNITYSDK_OFFSET(0x16806DD0)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_EVALUATESCORE_OFFSET UNITYSDK_OFFSET(0x16806570)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_GETTARGETSCORE_OFFSET UNITYSDK_OFFSET(0x1680A960)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x16803930)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_GET_MAINROADMAPNAME_OFFSET UNITYSDK_OFFSET(0x1680B270)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_GET_PLAYERCONTROLLER_OFFSET UNITYSDK_OFFSET(0x1680B280)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_GET_PLAYER_OFFSET UNITYSDK_OFFSET(0x1680B290)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_GET_SCORE_OFFSET UNITYSDK_OFFSET(0x16806520)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_GET_SERIALNUMBER_OFFSET UNITYSDK_OFFSET(0x1680B2F0)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_GET__REALSCORE_OFFSET UNITYSDK_OFFSET(0x1680A180)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0x16803B10)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_ISSUCCESS_1_OFFSET UNITYSDK_OFFSET(0x16807310)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_ISSUCCESS_OFFSET UNITYSDK_OFFSET(0x1680A900)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_MODIFYENERGY_OFFSET UNITYSDK_OFFSET(0x16804B80)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x168039A0)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x16803A30)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_ONENABLE_OFFSET UNITYSDK_OFFSET(0x16803950)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_REGISTEREVENT_OFFSET UNITYSDK_OFFSET(0x16803FA0)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_REPORTGAMEPLAYFINISH_OFFSET UNITYSDK_OFFSET(0x16807500)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_REPORTGAMEPLAYSTARTUP_OFFSET UNITYSDK_OFFSET(0x16804D10)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_REPORTGAMEPLAYUSESKILL_OFFSET UNITYSDK_OFFSET(0x168094B0)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_RESETSCORE_OFFSET UNITYSDK_OFFSET(0x1680B310)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_SETUPSTARTMODE_OFFSET UNITYSDK_OFFSET(0x1680A0D0)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_SETUPTIMELINEENABLE_OFFSET UNITYSDK_OFFSET(0x16809030)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_SET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x16803940)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_SET_SERIALNUMBER_OFFSET UNITYSDK_OFFSET(0x1680B300)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_SET__REALSCORE_OFFSET UNITYSDK_OFFSET(0x16805500)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_STARTPUZZLE_OFFSET UNITYSDK_OFFSET(0x16804540)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_TICKPUZZLE_OFFSET UNITYSDK_OFFSET(0x16805570)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_TICK_OFFSET UNITYSDK_OFFSET(0x168059C0)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_TRIGGERBULLETTIMEKILLQUEST_OFFSET UNITYSDK_OFFSET(0x16809CB0)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_TRIGGERFINISHQUEST_OFFSET UNITYSDK_OFFSET(0x168073C0)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_UNREGISTEREVENT_OFFSET UNITYSDK_OFFSET(0x16808E10)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x1680B430)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD__ONCLICKSHOOT_OFFSET UNITYSDK_OFFSET(0x1680A1D0)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD__ONCLICKSKILL_OFFSET UNITYSDK_OFFSET(0x1680A2A0)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD__ONEXITGAME_OFFSET UNITYSDK_OFFSET(0x1680A6D0)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD__ONPAUSEGAME_OFFSET UNITYSDK_OFFSET(0x1680A330)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD__ONPLAYGAME_OFFSET UNITYSDK_OFFSET(0x1680A460)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD__ONREPLAYGAME_OFFSET UNITYSDK_OFFSET(0x1680A580)

namespace RPG::Client
{
	inline static constexpr unsigned int WolfBroGunPlayPuzzleBoard_TypeDefinitionIndex = 68711;
	...
	public:
		...
		{
			return (::RPG::Client::WolfBroGunPlayPuzzleBoard**)Il2CppClass::FromTypeDefinitionIndex(WolfBroGunPlayPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0xF190);
		}
		static ::System::UInt32* StaticGet__REPLAY_MODE()
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(WolfBroGunPlayPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x4830);
		}
		static ::RPG::Client::WolfBroGunPlayPuzzleBoard_ReplaySaveData* StaticGet__REPLAY_SAVE_DATA()
		{
			return (::RPG::Client::WolfBroGunPlayPuzzleBoard_ReplaySaveData*)Il2CppClass::FromTypeDefinitionIndex(WolfBroGunPlayPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x4834);
		}
		...
		::Class_0_16E4307DCC419505_1024* _Modifier; // 0x140
