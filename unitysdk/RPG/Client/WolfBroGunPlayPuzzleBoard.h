...
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_ADDSCORE_OFFSET UNITYSDK_OFFSET(0xE426A20)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_BUILDARRAYINFO_OFFSET UNITYSDK_OFFSET(0xE427BA0)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_BUILDGAMEPLAYINFO_OFFSET UNITYSDK_OFFSET(0xE427710)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_CONTROLWOLFBROPLAYER_OFFSET UNITYSDK_OFFSET(0xE420D80)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_DELSCORE_OFFSET UNITYSDK_OFFSET(0xE426B50)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_DISABLEBULLETTIME_OFFSET UNITYSDK_OFFSET(0xE4256C0)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_DISPOSE_OFFSET UNITYSDK_OFFSET(0xE425320)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_ENABLEBULLETTIME_OFFSET UNITYSDK_OFFSET(0xE425D20)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_EVALUATECOUNTDOWNSCORE_OFFSET UNITYSDK_OFFSET(0xE423C90)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_EVALUATEDELSCORE_OFFSET UNITYSDK_OFFSET(0xE423990)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_EVALUATESCORE_OFFSET UNITYSDK_OFFSET(0xE423130)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_GETTARGETSCORE_OFFSET UNITYSDK_OFFSET(0xE427500)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0xE4204F0)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_GET_MAINROADMAPNAME_OFFSET UNITYSDK_OFFSET(0xE427E10)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_GET_PLAYERCONTROLLER_OFFSET UNITYSDK_OFFSET(0xE427E20)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_GET_PLAYER_OFFSET UNITYSDK_OFFSET(0xE427E30)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_GET_SCORE_OFFSET UNITYSDK_OFFSET(0xE4230E0)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_GET_SERIALNUMBER_OFFSET UNITYSDK_OFFSET(0xE427E90)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_GET__REALSCORE_OFFSET UNITYSDK_OFFSET(0xE426D30)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xE4206D0)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_ISSUCCESS_1_OFFSET UNITYSDK_OFFSET(0xE423ED0)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_ISSUCCESS_OFFSET UNITYSDK_OFFSET(0xE4274A0)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_MODIFYENERGY_OFFSET UNITYSDK_OFFSET(0xE421740)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xE420560)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0xE4205F0)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_ONENABLE_OFFSET UNITYSDK_OFFSET(0xE420510)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_REGISTEREVENT_OFFSET UNITYSDK_OFFSET(0xE420B60)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_REPORTGAMEPLAYFINISH_OFFSET UNITYSDK_OFFSET(0xE4240C0)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_REPORTGAMEPLAYSTARTUP_OFFSET UNITYSDK_OFFSET(0xE4218D0)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_REPORTGAMEPLAYUSESKILL_OFFSET UNITYSDK_OFFSET(0xE426060)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_RESETSCORE_OFFSET UNITYSDK_OFFSET(0xE427EB0)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_SETUPSTARTMODE_OFFSET UNITYSDK_OFFSET(0xE426C80)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_SETUPTIMELINEENABLE_OFFSET UNITYSDK_OFFSET(0xE425BE0)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_SET_INSTANCE_OFFSET UNITYSDK_OFFSET(0xE420500)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_SET_SERIALNUMBER_OFFSET UNITYSDK_OFFSET(0xE427EA0)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_SET__REALSCORE_OFFSET UNITYSDK_OFFSET(0xE4220C0)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_STARTPUZZLE_OFFSET UNITYSDK_OFFSET(0xE421100)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_TICKPUZZLE_OFFSET UNITYSDK_OFFSET(0xE422130)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_TICK_OFFSET UNITYSDK_OFFSET(0xE422580)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_TRIGGERBULLETTIMEKILLQUEST_OFFSET UNITYSDK_OFFSET(0xE426860)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_TRIGGERFINISHQUEST_OFFSET UNITYSDK_OFFSET(0xE423F80)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD_UNREGISTEREVENT_OFFSET UNITYSDK_OFFSET(0xE4259C0)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0xE427FD0)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD__ONCLICKSHOOT_OFFSET UNITYSDK_OFFSET(0xE426D80)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD__ONCLICKSKILL_OFFSET UNITYSDK_OFFSET(0xE426E50)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD__ONEXITGAME_OFFSET UNITYSDK_OFFSET(0xE427270)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD__ONPAUSEGAME_OFFSET UNITYSDK_OFFSET(0xE426EE0)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD__ONPLAYGAME_OFFSET UNITYSDK_OFFSET(0xE427000)
#define RPG_CLIENT_WOLFBROGUNPLAYPUZZLEBOARD__ONREPLAYGAME_OFFSET UNITYSDK_OFFSET(0xE427120)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::RPG::Client::WolfBroGunPlayPuzzleBoard**)Il2CppClass::FromTypeDefinitionIndex(WolfBroGunPlayPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0xF830);
		}
		static ::RPG::Client::WolfBroGunPlayPuzzleBoard_ReplaySaveData* StaticGet__REPLAY_SAVE_DATA()
		{
			return (::RPG::Client::WolfBroGunPlayPuzzleBoard_ReplaySaveData*)Il2CppClass::FromTypeDefinitionIndex(WolfBroGunPlayPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x6BD0);
		}
		static ::System::UInt32* StaticGet__REPLAY_MODE()
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(WolfBroGunPlayPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x6BD4);
		}
