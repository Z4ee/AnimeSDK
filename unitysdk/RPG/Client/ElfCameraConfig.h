...
#define RPG_CLIENT_ELFCAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC5FFD0)

namespace RPG::Client
{
	inline static constexpr unsigned int ElfCameraConfig_TypeDefinitionIndex = 63749;
