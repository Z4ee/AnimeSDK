...
#define RPG_CLIENT_ELFCAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xB8A4C70)

namespace RPG::Client
{
	inline static constexpr unsigned int ElfCameraConfig_TypeDefinitionIndex = 59611;
