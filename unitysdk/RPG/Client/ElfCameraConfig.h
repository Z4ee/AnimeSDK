...
#define RPG_CLIENT_ELFCAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18E19D40)

namespace RPG::Client
{
	inline static constexpr unsigned int ElfCameraConfig_TypeDefinitionIndex = 60896;
