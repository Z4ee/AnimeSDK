...
#define RPG_CLIENT_MONONODESWITCHBYGENDER_START_OFFSET UNITYSDK_OFFSET(0xD852540)
#define RPG_CLIENT_MONONODESWITCHBYGENDER__CTOR_OFFSET UNITYSDK_OFFSET(0xD852670)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoNodeSwitchByGender_TypeDefinitionIndex = 72742;
