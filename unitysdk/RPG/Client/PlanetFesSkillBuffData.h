...
#define RPG_CLIENT_PLANETFESSKILLBUFFDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1A1D2010)
#define RPG_CLIENT_PLANETFESSKILLBUFFDATA_GET_BUFFID_OFFSET UNITYSDK_OFFSET(0x1A1D26B0)
#define RPG_CLIENT_PLANETFESSKILLBUFFDATA_GET_COST_OFFSET UNITYSDK_OFFSET(0x1A1D2600)
#define RPG_CLIENT_PLANETFESSKILLBUFFDATA_GET_HASNEXTBUFFDATA_OFFSET UNITYSDK_OFFSET(0x1A1C2A40)
#define RPG_CLIENT_PLANETFESSKILLBUFFDATA_GET_ICON_OFFSET UNITYSDK_OFFSET(0x1A1D28B0)
#define RPG_CLIENT_PLANETFESSKILLBUFFDATA_GET_ISMAXLEVEL_OFFSET UNITYSDK_OFFSET(0x1A1D21A0)
#define RPG_CLIENT_PLANETFESSKILLBUFFDATA_GET_ISSPECIAL_OFFSET UNITYSDK_OFFSET(0x1A1D2480)
#define RPG_CLIENT_PLANETFESSKILLBUFFDATA_GET_LEVELCOSTS_OFFSET UNITYSDK_OFFSET(0x1A1D2520)
#define RPG_CLIENT_PLANETFESSKILLBUFFDATA_GET_LEVELSKILLS_OFFSET UNITYSDK_OFFSET(0x1A1D2950)
#define RPG_CLIENT_PLANETFESSKILLBUFFDATA_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x1A1D25E0)
#define RPG_CLIENT_PLANETFESSKILLBUFFDATA_GET_MAXLEVEL_OFFSET UNITYSDK_OFFSET(0x1A1D29F0)
#define RPG_CLIENT_PLANETFESSKILLBUFFDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A1D27F0)
#define RPG_CLIENT_PLANETFESSKILLBUFFDATA_GET_NEXTBUFFID_OFFSET UNITYSDK_OFFSET(0x1A1D2650)
#define RPG_CLIENT_PLANETFESSKILLBUFFDATA_GET_NEXTBUFFLEVEL_OFFSET UNITYSDK_OFFSET(0x1A1D2740)
#define RPG_CLIENT_PLANETFESSKILLBUFFDATA_GET_ROW_OFFSET UNITYSDK_OFFSET(0x1A1D2790)
#define RPG_CLIENT_PLANETFESSKILLBUFFDATA_GET_SKILLID_OFFSET UNITYSDK_OFFSET(0x1A1D25C0)
#define RPG_CLIENT_PLANETFESSKILLBUFFDATA_GET_UPGRADECOST_OFFSET UNITYSDK_OFFSET(0x1A1D1E20)
#define RPG_CLIENT_PLANETFESSKILLBUFFDATA_SETNEXTBUFFDATA_OFFSET UNITYSDK_OFFSET(0x1A1D2110)
#define RPG_CLIENT_PLANETFESSKILLBUFFDATA_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0x1A1D25F0)
#define RPG_CLIENT_PLANETFESSKILLBUFFDATA_SET_SKILLID_OFFSET UNITYSDK_OFFSET(0x1A1D25D0)
#define RPG_CLIENT_PLANETFESSKILLBUFFDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1D23B0)
#define RPG_CLIENT_PLANETFESSKILLBUFFDATA__GETCOST_OFFSET UNITYSDK_OFFSET(0x1A1D23C0)
