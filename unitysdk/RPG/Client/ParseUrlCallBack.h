...
#define RPG_CLIENT_PARSEURLCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A2F8B50)
#define RPG_CLIENT_PARSEURLCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A2F8B80)
#define RPG_CLIENT_PARSEURLCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A2F8B40)
#define RPG_CLIENT_PARSEURLCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2F8AD0)

namespace RPG::Client
{
	inline static constexpr unsigned int ParseUrlCallBack_TypeDefinitionIndex = 56667;
