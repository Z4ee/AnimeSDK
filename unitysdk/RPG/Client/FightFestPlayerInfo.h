...
#define RPG_CLIENT_FIGHTFESTPLAYERINFO_GET_AVATARID_OFFSET UNITYSDK_OFFSET(0x183F8110)
#define RPG_CLIENT_FIGHTFESTPLAYERINFO_GET_AVATARNAME_OFFSET UNITYSDK_OFFSET(0x183F8160)
#define RPG_CLIENT_FIGHTFESTPLAYERINFO_GET_FIGUREOFFSET_OFFSET UNITYSDK_OFFSET(0x183F8300)
#define RPG_CLIENT_FIGHTFESTPLAYERINFO_GET_FULLFIGUREPATH_OFFSET UNITYSDK_OFFSET(0x183F81E0)
#define RPG_CLIENT_FIGHTFESTPLAYERINFO_GET_HALFFIGUREPATH_OFFSET UNITYSDK_OFFSET(0x183F8240)
#define RPG_CLIENT_FIGHTFESTPLAYERINFO_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x183F82A0)
#define RPG_CLIENT_FIGHTFESTPLAYERINFO_GET_VSIMGPATH_OFFSET UNITYSDK_OFFSET(0x183F8380)
#define RPG_CLIENT_FIGHTFESTPLAYERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x183F80D0)

namespace RPG::Client
{
	inline static constexpr unsigned int FightFestPlayerInfo_TypeDefinitionIndex = 61264;
