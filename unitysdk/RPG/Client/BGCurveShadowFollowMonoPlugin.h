...
#define RPG_CLIENT_BGCURVESHADOWFOLLOWMONOPLUGIN_CREATESHADOWS_OFFSET UNITYSDK_OFFSET(0x9DCF510)
#define RPG_CLIENT_BGCURVESHADOWFOLLOWMONOPLUGIN_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x9DCF590)
#define RPG_CLIENT_BGCURVESHADOWFOLLOWMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x9DCF5E0)
#define RPG_CLIENT_BGCURVESHADOWFOLLOWMONOPLUGIN___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x9DCF660)

namespace RPG::Client
{
	inline static constexpr unsigned int BGCurveShadowFollowMonoPlugin_TypeDefinitionIndex = 64859;
