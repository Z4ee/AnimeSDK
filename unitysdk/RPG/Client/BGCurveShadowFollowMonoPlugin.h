...
#define RPG_CLIENT_BGCURVESHADOWFOLLOWMONOPLUGIN_CREATESHADOWS_OFFSET UNITYSDK_OFFSET(0x916DC90)
#define RPG_CLIENT_BGCURVESHADOWFOLLOWMONOPLUGIN_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x916DD10)
#define RPG_CLIENT_BGCURVESHADOWFOLLOWMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x916DD60)
#define RPG_CLIENT_BGCURVESHADOWFOLLOWMONOPLUGIN___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x916DDE0)

namespace RPG::Client
{
	inline static constexpr unsigned int BGCurveShadowFollowMonoPlugin_TypeDefinitionIndex = 57596;
