...
#define RPG_CLIENT_ROGUESEASONFINISHINFO_QUITROGUEMAP_OFFSET UNITYSDK_OFFSET(0x1BA075F0)
#define RPG_CLIENT_ROGUESEASONFINISHINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9F0090)
...
namespace RPG::Client
{
	...
	public:
		...
		::Class_1_F88C6D5EE35F8F30* _SceneInfo; // 0x18
