...
#define RPG_CLIENT_GRIDFIGHTTRAITEFFECTCONFIG_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xA5B8610)
#define RPG_CLIENT_GRIDFIGHTTRAITEFFECTCONFIG_GET_ID_OFFSET UNITYSDK_OFFSET(0xA5B8520)
#define RPG_CLIENT_GRIDFIGHTTRAITEFFECTCONFIG_GET_TRAITEFFECTDESC_OFFSET UNITYSDK_OFFSET(0xA5B8630)
#define RPG_CLIENT_GRIDFIGHTTRAITEFFECTCONFIG_GET_TRAITEFFECTTYPE_OFFSET UNITYSDK_OFFSET(0xA5B8570)
#define RPG_CLIENT_GRIDFIGHTTRAITEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xA5B8600)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightTraitEffectConfig_TypeDefinitionIndex = 60253;
