...
#define RPG_CLIENT_SKILLSIMPLEEXTRAEFFECTDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xE0A5ED0)
#define RPG_CLIENT_SKILLSIMPLEEXTRAEFFECTDATA_GET_DESCPARAMLIST_OFFSET UNITYSDK_OFFSET(0xE0A6DC0)
#define RPG_CLIENT_SKILLSIMPLEEXTRAEFFECTDATA_GET_EXTRAEFFECTDESC_OFFSET UNITYSDK_OFFSET(0xE0A6DA0)
#define RPG_CLIENT_SKILLSIMPLEEXTRAEFFECTDATA_GET_EXTRAEFFECTNAME_OFFSET UNITYSDK_OFFSET(0xE0A6D80)
#define RPG_CLIENT_SKILLSIMPLEEXTRAEFFECTDATA_SET_DESCPARAMLIST_OFFSET UNITYSDK_OFFSET(0xE0A6DD0)
#define RPG_CLIENT_SKILLSIMPLEEXTRAEFFECTDATA_SET_EXTRAEFFECTDESC_OFFSET UNITYSDK_OFFSET(0xE0A6DB0)
#define RPG_CLIENT_SKILLSIMPLEEXTRAEFFECTDATA_SET_EXTRAEFFECTNAME_OFFSET UNITYSDK_OFFSET(0xE0A6D90)
#define RPG_CLIENT_SKILLSIMPLEEXTRAEFFECTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xE0A6D70)

namespace RPG::Client
{
	inline static constexpr unsigned int SkillSimpleExtraEffectData_TypeDefinitionIndex = 72060;
