...
#define RPG_CLIENT_SKILLSIMPLEEXTRAEFFECTDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x196CF980)
#define RPG_CLIENT_SKILLSIMPLEEXTRAEFFECTDATA_GET_DESCPARAMLIST_OFFSET UNITYSDK_OFFSET(0x196D0870)
#define RPG_CLIENT_SKILLSIMPLEEXTRAEFFECTDATA_GET_EXTRAEFFECTDESC_OFFSET UNITYSDK_OFFSET(0x196D0850)
#define RPG_CLIENT_SKILLSIMPLEEXTRAEFFECTDATA_GET_EXTRAEFFECTNAME_OFFSET UNITYSDK_OFFSET(0x196D0830)
#define RPG_CLIENT_SKILLSIMPLEEXTRAEFFECTDATA_SET_DESCPARAMLIST_OFFSET UNITYSDK_OFFSET(0x196D0880)
#define RPG_CLIENT_SKILLSIMPLEEXTRAEFFECTDATA_SET_EXTRAEFFECTDESC_OFFSET UNITYSDK_OFFSET(0x196D0860)
#define RPG_CLIENT_SKILLSIMPLEEXTRAEFFECTDATA_SET_EXTRAEFFECTNAME_OFFSET UNITYSDK_OFFSET(0x196D0840)
#define RPG_CLIENT_SKILLSIMPLEEXTRAEFFECTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x196D0820)

namespace RPG::Client
{
	inline static constexpr unsigned int SkillSimpleExtraEffectData_TypeDefinitionIndex = 72059;
