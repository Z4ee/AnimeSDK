...
#define RPG_CLIENT_UIMETA_ADDBLURPARTIALAREA_OFFSET UNITYSDK_OFFSET(0xA709640)
#define RPG_CLIENT_UIMETA_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xA70A340)
#define RPG_CLIENT_UIMETA_GET_ENABLEBLURFULL_OFFSET UNITYSDK_OFFSET(0xA7095A0)
#define RPG_CLIENT_UIMETA_GET_ENABLEBLURPARTIAL_OFFSET UNITYSDK_OFFSET(0xA7095F0)
#define RPG_CLIENT_UIMETA_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xA70A080)
#define RPG_CLIENT_UIMETA_ONENABLE_OFFSET UNITYSDK_OFFSET(0xA709FC0)
#define RPG_CLIENT_UIMETA_REMOVEBLURPARTIALAREA_OFFSET UNITYSDK_OFFSET(0xA709870)
#define RPG_CLIENT_UIMETA_SETUPBLURPARTIALAREA_OFFSET UNITYSDK_OFFSET(0xA709C20)
#define RPG_CLIENT_UIMETA_SPAWNED_OFFSET UNITYSDK_OFFSET(0xA70A300)
#define RPG_CLIENT_UIMETA_SWITCHBLURPARTIALAREALAYER_OFFSET UNITYSDK_OFFSET(0xA709E00)
#define RPG_CLIENT_UIMETA_TRIGGERAUDIOEVENT_OFFSET UNITYSDK_OFFSET(0xA70A140)
#define RPG_CLIENT_UIMETA__CTOR_OFFSET UNITYSDK_OFFSET(0xA70A3B0)

namespace RPG::Client
{
	inline static constexpr unsigned int UIMeta_TypeDefinitionIndex = 59895;
