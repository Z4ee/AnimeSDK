...
#define RPG_CLIENT_UIMETA_ADDBLURPARTIALAREA_OFFSET UNITYSDK_OFFSET(0xB40DD70)
#define RPG_CLIENT_UIMETA_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xB40E9F0)
#define RPG_CLIENT_UIMETA_GET_ENABLEBLURFULL_OFFSET UNITYSDK_OFFSET(0xB40DCD0)
#define RPG_CLIENT_UIMETA_GET_ENABLEBLURPARTIAL_OFFSET UNITYSDK_OFFSET(0xB40DD20)
#define RPG_CLIENT_UIMETA_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xB40E730)
#define RPG_CLIENT_UIMETA_ONENABLE_OFFSET UNITYSDK_OFFSET(0xB40E670)
#define RPG_CLIENT_UIMETA_REMOVEBLURPARTIALAREA_OFFSET UNITYSDK_OFFSET(0xB40DFA0)
#define RPG_CLIENT_UIMETA_SETUPBLURPARTIALAREA_OFFSET UNITYSDK_OFFSET(0xB40E2D0)
#define RPG_CLIENT_UIMETA_SPAWNED_OFFSET UNITYSDK_OFFSET(0xB40E9B0)
#define RPG_CLIENT_UIMETA_SWITCHBLURPARTIALAREALAYER_OFFSET UNITYSDK_OFFSET(0xB40E4B0)
#define RPG_CLIENT_UIMETA_TRIGGERAUDIOEVENT_OFFSET UNITYSDK_OFFSET(0xB40E7F0)
#define RPG_CLIENT_UIMETA__CTOR_OFFSET UNITYSDK_OFFSET(0xB40EA60)

namespace RPG::Client
{
	inline static constexpr unsigned int UIMeta_TypeDefinitionIndex = 67293;
