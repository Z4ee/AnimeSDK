...
#define RPG_CLIENT_UIMETA_ADDBLURPARTIALAREA_OFFSET UNITYSDK_OFFSET(0xCB6DC70)
#define RPG_CLIENT_UIMETA_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xCB6EA10)
#define RPG_CLIENT_UIMETA_GET_ENABLEBLURFULL_OFFSET UNITYSDK_OFFSET(0xCB6DBD0)
#define RPG_CLIENT_UIMETA_GET_ENABLEBLURPARTIAL_OFFSET UNITYSDK_OFFSET(0xCB6DC20)
#define RPG_CLIENT_UIMETA_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xCB6E760)
#define RPG_CLIENT_UIMETA_ONENABLE_OFFSET UNITYSDK_OFFSET(0xCB6E6A0)
#define RPG_CLIENT_UIMETA_REMOVEBLURPARTIALAREA_OFFSET UNITYSDK_OFFSET(0xCB6DF10)
#define RPG_CLIENT_UIMETA_SETUPBLURPARTIALAREA_OFFSET UNITYSDK_OFFSET(0xCB6E2C0)
#define RPG_CLIENT_UIMETA_SPAWNED_OFFSET UNITYSDK_OFFSET(0xCB6E9D0)
#define RPG_CLIENT_UIMETA_SWITCHBLURPARTIALAREALAYER_OFFSET UNITYSDK_OFFSET(0xCB6E4C0)
#define RPG_CLIENT_UIMETA_TRIGGERAUDIOEVENT_OFFSET UNITYSDK_OFFSET(0xCB6E820)
#define RPG_CLIENT_UIMETA__CTOR_OFFSET UNITYSDK_OFFSET(0xCB6EA80)

namespace RPG::Client
{
	inline static constexpr unsigned int UIMeta_TypeDefinitionIndex = 68245;
