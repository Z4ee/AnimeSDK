...
#define RPG_CLIENT_UIASYNCPREFABLOADERPROXY_CREATE_OFFSET UNITYSDK_OFFSET(0xE341350)
#define RPG_CLIENT_UIASYNCPREFABLOADERPROXY_TRYCANCELASYNCLOAD_OFFSET UNITYSDK_OFFSET(0xE3413D0)
#define RPG_CLIENT_UIASYNCPREFABLOADERPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0xE3413C0)

namespace RPG::Client
{
	inline static constexpr unsigned int UIAsyncPrefabLoaderProxy_TypeDefinitionIndex = 72939;
