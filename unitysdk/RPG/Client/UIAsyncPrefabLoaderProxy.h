...
#define RPG_CLIENT_UIASYNCPREFABLOADERPROXY_CREATE_OFFSET UNITYSDK_OFFSET(0xA674060)
#define RPG_CLIENT_UIASYNCPREFABLOADERPROXY_TRYCANCELASYNCLOAD_OFFSET UNITYSDK_OFFSET(0xA6740E0)
#define RPG_CLIENT_UIASYNCPREFABLOADERPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0xA6740D0)

namespace RPG::Client
{
	inline static constexpr unsigned int UIAsyncPrefabLoaderProxy_TypeDefinitionIndex = 59846;
