...
#define RPG_CLIENT_MONOFOURFEETSIMPLEIK_ORIGINTRANSFORM_GET_POSITION_OFFSET UNITYSDK_OFFSET(0xA9C5100)
#define RPG_CLIENT_MONOFOURFEETSIMPLEIK_ORIGINTRANSFORM_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0xA9C51A0)
#define RPG_CLIENT_MONOFOURFEETSIMPLEIK_ORIGINTRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0xA9C5230)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoFourFeetSimpleIK_OriginTransform_TypeDefinitionIndex = 63255;
