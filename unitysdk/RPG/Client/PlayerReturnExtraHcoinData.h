...
#define RPG_CLIENT_PLAYERRETURNEXTRAHCOINDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xC4A8990)
#define RPG_CLIENT_PLAYERRETURNEXTRAHCOINDATA_GETUIPROGRESS_OFFSET UNITYSDK_OFFSET(0xC4A8DD0)
#define RPG_CLIENT_PLAYERRETURNEXTRAHCOINDATA_GET_CONFIGID_OFFSET UNITYSDK_OFFSET(0xC4A9130)
#define RPG_CLIENT_PLAYERRETURNEXTRAHCOINDATA_SET_CONFIGID_OFFSET UNITYSDK_OFFSET(0xC4A9140)
#define RPG_CLIENT_PLAYERRETURNEXTRAHCOINDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC4A8A60)
#define RPG_CLIENT_PLAYERRETURNEXTRAHCOINDATA__GETTOTALUIRATIOCOUNT_OFFSET UNITYSDK_OFFSET(0xC4A8F10)
#define RPG_CLIENT_PLAYERRETURNEXTRAHCOINDATA__INIT_OFFSET UNITYSDK_OFFSET(0xC4A8AB0)

namespace RPG::Client
{
	inline static constexpr unsigned int PlayerReturnExtraHcoinData_TypeDefinitionIndex = 57862;
