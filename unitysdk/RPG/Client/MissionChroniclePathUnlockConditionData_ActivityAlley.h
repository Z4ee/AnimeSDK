...
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_ACTIVITYALLEY_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1696F6E0)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_ACTIVITYALLEY_EQUALS_OFFSET UNITYSDK_OFFSET(0x1696F630)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_ACTIVITYALLEY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1696F810)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_ACTIVITYALLEY_GET_CONDITIONTEXT_OFFSET UNITYSDK_OFFSET(0x1696F860)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_ACTIVITYALLEY__CTOR_OFFSET UNITYSDK_OFFSET(0x1696F620)
