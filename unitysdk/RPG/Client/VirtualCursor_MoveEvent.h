...
#define RPG_CLIENT_VIRTUALCURSOR_MOVEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0xB481FC0)

namespace RPG::Client
{
	inline static constexpr unsigned int VirtualCursor_MoveEvent_TypeDefinitionIndex = 67433;
