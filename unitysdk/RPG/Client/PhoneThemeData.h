...
#define RPG_CLIENT_PHONETHEMEDATA_ADDUNLOCKED_OFFSET UNITYSDK_OFFSET(0x17F4AE30)
#define RPG_CLIENT_PHONETHEMEDATA_CLEAR_OFFSET UNITYSDK_OFFSET(0x17F50DA0)
#define RPG_CLIENT_PHONETHEMEDATA_GETDISPLAYPHONETHEMES_OFFSET UNITYSDK_OFFSET(0x17F50E20)
#define RPG_CLIENT_PHONETHEMEDATA_GET_CURRENTID_OFFSET UNITYSDK_OFFSET(0x17F51320)
#define RPG_CLIENT_PHONETHEMEDATA_GET_CURRENTIMAGEL_OFFSET UNITYSDK_OFFSET(0x17F51340)
#define RPG_CLIENT_PHONETHEMEDATA_GET_CURRENTIMAGER_OFFSET UNITYSDK_OFFSET(0x17F513F0)
#define RPG_CLIENT_PHONETHEMEDATA_GET_UNLOCKEDIDS_OFFSET UNITYSDK_OFFSET(0x17F51300)
#define RPG_CLIENT_PHONETHEMEDATA_SET_CURRENTID_OFFSET UNITYSDK_OFFSET(0x17F51330)
#define RPG_CLIENT_PHONETHEMEDATA_SET_UNLOCKEDIDS_OFFSET UNITYSDK_OFFSET(0x17F51310)
#define RPG_CLIENT_PHONETHEMEDATA_SYNCCURRENT_OFFSET UNITYSDK_OFFSET(0x17F4A1B0)
#define RPG_CLIENT_PHONETHEMEDATA_SYNCUNLOCKED_OFFSET UNITYSDK_OFFSET(0x17F49BA0)
#define RPG_CLIENT_PHONETHEMEDATA__CANDISPLAY_OFFSET UNITYSDK_OFFSET(0x17F51210)
#define RPG_CLIENT_PHONETHEMEDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x17F514A0)
#define RPG_CLIENT_PHONETHEMEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17F4B390)
#define RPG_CLIENT_PHONETHEMEDATA__NOTIFYTUTORIAL_OFFSET UNITYSDK_OFFSET(0x17F50D20)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(PhoneThemeData_TypeDefinitionIndex)->GetStaticField(0xE660);
		}
