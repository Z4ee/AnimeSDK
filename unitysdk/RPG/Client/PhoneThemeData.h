...
#define RPG_CLIENT_PHONETHEMEDATA_ADDUNLOCKED_OFFSET UNITYSDK_OFFSET(0xDA62400)
#define RPG_CLIENT_PHONETHEMEDATA_CLEAR_OFFSET UNITYSDK_OFFSET(0xDA683D0)
#define RPG_CLIENT_PHONETHEMEDATA_GETDISPLAYPHONETHEMES_OFFSET UNITYSDK_OFFSET(0xDA68450)
#define RPG_CLIENT_PHONETHEMEDATA_GET_CURRENTID_OFFSET UNITYSDK_OFFSET(0xDA68950)
#define RPG_CLIENT_PHONETHEMEDATA_GET_CURRENTIMAGEL_OFFSET UNITYSDK_OFFSET(0xDA68970)
#define RPG_CLIENT_PHONETHEMEDATA_GET_CURRENTIMAGER_OFFSET UNITYSDK_OFFSET(0xDA68A20)
#define RPG_CLIENT_PHONETHEMEDATA_GET_UNLOCKEDIDS_OFFSET UNITYSDK_OFFSET(0xDA68930)
#define RPG_CLIENT_PHONETHEMEDATA_SET_CURRENTID_OFFSET UNITYSDK_OFFSET(0xDA68960)
#define RPG_CLIENT_PHONETHEMEDATA_SET_UNLOCKEDIDS_OFFSET UNITYSDK_OFFSET(0xDA68940)
#define RPG_CLIENT_PHONETHEMEDATA_SYNCCURRENT_OFFSET UNITYSDK_OFFSET(0xDA61780)
#define RPG_CLIENT_PHONETHEMEDATA_SYNCUNLOCKED_OFFSET UNITYSDK_OFFSET(0xDA61170)
#define RPG_CLIENT_PHONETHEMEDATA__CANDISPLAY_OFFSET UNITYSDK_OFFSET(0xDA68840)
#define RPG_CLIENT_PHONETHEMEDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0xDA68AD0)
#define RPG_CLIENT_PHONETHEMEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xDA62960)
#define RPG_CLIENT_PHONETHEMEDATA__NOTIFYTUTORIAL_OFFSET UNITYSDK_OFFSET(0xDA68350)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(PhoneThemeData_TypeDefinitionIndex)->GetStaticField(0x11730);
		}
