...
#define RPG_CLIENT_GRIDFIGHTTRAITELATIONEFFECT_GRIDFIGHTTRAITELATIONADDITEMSUMMARIZER_ISCONCERNEDWITH_OFFSET UNITYSDK_OFFSET(0x1BB0B900)
#define RPG_CLIENT_GRIDFIGHTTRAITELATIONEFFECT_GRIDFIGHTTRAITELATIONADDITEMSUMMARIZER_UPDATEADDITEM_OFFSET UNITYSDK_OFFSET(0x1BB0BBF0)
#define RPG_CLIENT_GRIDFIGHTTRAITELATIONEFFECT_GRIDFIGHTTRAITELATIONADDITEMSUMMARIZER_UPDATEORB_OFFSET UNITYSDK_OFFSET(0x1BB0BA60)
#define RPG_CLIENT_GRIDFIGHTTRAITELATIONEFFECT_GRIDFIGHTTRAITELATIONADDITEMSUMMARIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB0B620)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightTraitElationEffect_GridFightTraitElationAddItemSummarizer_TypeDefinitionIndex = 65444;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_D17272E82AE804C2_470*))((::PBYTE)hIl2Cpp + RPG_CLIENT_GRIDFIGHTTRAITELATIONEFFECT_GRIDFIGHTTRAITELATIONADDITEMSUMMARIZER_UPDATEORB_OFFSET))(this, a1);
		}
