...
#define RPG_CLIENT_GRIDFIGHTTRAITELATIONEFFECT_GRIDFIGHTTRAITELATIONADDITEMSUMMARIZER_ISCONCERNEDWITH_OFFSET UNITYSDK_OFFSET(0xD362CC0)
#define RPG_CLIENT_GRIDFIGHTTRAITELATIONEFFECT_GRIDFIGHTTRAITELATIONADDITEMSUMMARIZER_UPDATEADDITEM_OFFSET UNITYSDK_OFFSET(0xD362FB0)
#define RPG_CLIENT_GRIDFIGHTTRAITELATIONEFFECT_GRIDFIGHTTRAITELATIONADDITEMSUMMARIZER_UPDATEORB_OFFSET UNITYSDK_OFFSET(0xD362E20)
#define RPG_CLIENT_GRIDFIGHTTRAITELATIONEFFECT_GRIDFIGHTTRAITELATIONADDITEMSUMMARIZER__CTOR_OFFSET UNITYSDK_OFFSET(0xD3629F0)
