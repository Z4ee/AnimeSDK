...
namespace RPG::Client
{
	...
	public:
		...
		::System::Boolean __SyncParticipants_b__1(::RPG::Client::CakeRaceParticipantData* participant)
		{
			return ((::System::Boolean(*)(::PVOID, ::RPG::Client::CakeRaceParticipantData*))((::PBYTE)hIl2Cpp + RPG_CLIENT_CAKERACELOBBY___C__DISPLAYCLASS7_1___SYNCPARTICIPANTS_B__1_OFFSET))(this, participant);
		}
	};
}
