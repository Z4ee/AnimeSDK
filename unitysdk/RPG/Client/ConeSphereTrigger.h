...
#define RPG_CLIENT_CONESPHERETRIGGER_FOLLOWCHANGE_OFFSET UNITYSDK_OFFSET(0x1A2953A0)
#define RPG_CLIENT_CONESPHERETRIGGER_GET_PATTERN_OFFSET UNITYSDK_OFFSET(0x1A294EC0)
#define RPG_CLIENT_CONESPHERETRIGGER_INIT_OFFSET UNITYSDK_OFFSET(0x1A294F10)
#define RPG_CLIENT_CONESPHERETRIGGER_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x1A295710)
#define RPG_CLIENT_CONESPHERETRIGGER_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0x1A2957C0)
#define RPG_CLIENT_CONESPHERETRIGGER_SYNCLIGHTCONETRANSWHENFOLLOW_OFFSET UNITYSDK_OFFSET(0x1A295510)
#define RPG_CLIENT_CONESPHERETRIGGER_SYNCLIGHTCONETRANS_OFFSET UNITYSDK_OFFSET(0x1A2950F0)
#define RPG_CLIENT_CONESPHERETRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A295870)

namespace RPG::Client
{
	inline static constexpr unsigned int ConeSphereTrigger_TypeDefinitionIndex = 60614;
	...
	public:
		...
		::RPG::Client::ConeCollider* PMCNGKGAGHH; // 0x28
		::UnityEngine::SphereCollider* HKPKGJNFEDK; // 0x30
		::UnityEngine::Transform* MEMMLNBHMHA; // 0x38
		::System::Single MECMIGFMJCL; // 0x40
		::Class_0_16E4307DCC419505_691* PNJEPPDLNJO; // 0x48
		...
		::System::Void Init(::Class_0_16E4307DCC419505_691* a1, ::UnityEngine::Transform* a2, ::System::Single a3)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_691*, ::UnityEngine::Transform*, ::System::Single))((::PBYTE)hIl2Cpp + RPG_CLIENT_CONESPHERETRIGGER_INIT_OFFSET))(this, a1, a2, a3);
		}
