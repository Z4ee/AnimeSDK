...
#define RPG_CLIENT_CUSTOMTRANSITIONFADEIN__CTOR_OFFSET UNITYSDK_OFFSET(0x192D7330)

namespace RPG::Client
{
	inline static constexpr unsigned int CustomTransitionFadeIn_TypeDefinitionIndex = 72746;
