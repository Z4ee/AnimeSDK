...
#define RPG_CLIENT_CUSTOMTRANSITIONFADEIN__CTOR_OFFSET UNITYSDK_OFFSET(0xCC905A0)

namespace RPG::Client
{
	inline static constexpr unsigned int CustomTransitionFadeIn_TypeDefinitionIndex = 72747;
