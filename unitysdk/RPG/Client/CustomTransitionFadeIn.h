...
#define RPG_CLIENT_CUSTOMTRANSITIONFADEIN__CTOR_OFFSET UNITYSDK_OFFSET(0xB72F2F0)

namespace RPG::Client
{
	inline static constexpr unsigned int CustomTransitionFadeIn_TypeDefinitionIndex = 68032;
