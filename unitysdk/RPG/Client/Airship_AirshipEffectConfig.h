...
#define RPG_CLIENT_AIRSHIP_AIRSHIPEFFECTCONFIG_METHOD_1_0BDFAC56E6B704CB_OFFSET UNITYSDK_OFFSET(0x19C519D0)
#define RPG_CLIENT_AIRSHIP_AIRSHIPEFFECTCONFIG_METHOD_1_19844080C13BA28F_OFFSET UNITYSDK_OFFSET(0x19C57F90)
#define RPG_CLIENT_AIRSHIP_AIRSHIPEFFECTCONFIG_METHOD_1_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x19C58250)
#define RPG_CLIENT_AIRSHIP_AIRSHIPEFFECTCONFIG_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x19C51930)
#define RPG_CLIENT_AIRSHIP_AIRSHIPEFFECTCONFIG_METHOD_1_60E1F7F58CCF739F_OFFSET UNITYSDK_OFFSET(0x19C51A60)
#define RPG_CLIENT_AIRSHIP_AIRSHIPEFFECTCONFIG_METHOD_1_640514F2FC7A7607_OFFSET UNITYSDK_OFFSET(0x19C51DA0)
#define RPG_CLIENT_AIRSHIP_AIRSHIPEFFECTCONFIG_METHOD_1_66D1CC6071325C2F_OFFSET UNITYSDK_OFFSET(0x19C58320)
#define RPG_CLIENT_AIRSHIP_AIRSHIPEFFECTCONFIG_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x19C51AF0)
#define RPG_CLIENT_AIRSHIP_AIRSHIPEFFECTCONFIG_METHOD_1_C8E2469222842786_1_OFFSET UNITYSDK_OFFSET(0x19C57F10)
#define RPG_CLIENT_AIRSHIP_AIRSHIPEFFECTCONFIG_METHOD_1_C8E2469222842786_OFFSET UNITYSDK_OFFSET(0x19C539E0)
#define RPG_CLIENT_AIRSHIP_AIRSHIPEFFECTCONFIG_METHOD_1_C948B80B0E3EE644_OFFSET UNITYSDK_OFFSET(0x19C517B0)
#define RPG_CLIENT_AIRSHIP_AIRSHIPEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19C51750)
#define RPG_CLIENT_AIRSHIP_AIRSHIPEFFECTCONFIG__TRIGGEREFFECT_B__20_0_OFFSET UNITYSDK_OFFSET(0x19C583F0)
