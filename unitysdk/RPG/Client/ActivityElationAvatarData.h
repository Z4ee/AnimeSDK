...
#define RPG_CLIENT_ACTIVITYELATIONAVATARDATA_GET_AVATARDATA_OFFSET UNITYSDK_OFFSET(0x194D8E40)
#define RPG_CLIENT_ACTIVITYELATIONAVATARDATA_GET_BATTLEEVENTSKILLDESCSIMPLE_OFFSET UNITYSDK_OFFSET(0x194D9160)
#define RPG_CLIENT_ACTIVITYELATIONAVATARDATA_GET_BATTLEEVENTSKILLDESC_OFFSET UNITYSDK_OFFSET(0x194D90F0)
#define RPG_CLIENT_ACTIVITYELATIONAVATARDATA_GET_BATTLEEVENTSKILLPARAMLIST_OFFSET UNITYSDK_OFFSET(0x194D91D0)
#define RPG_CLIENT_ACTIVITYELATIONAVATARDATA_GET_ENERGYCOLLECTIONDESCSIMPLE_OFFSET UNITYSDK_OFFSET(0x194D9030)
#define RPG_CLIENT_ACTIVITYELATIONAVATARDATA_GET_ENERGYCOLLECTIONDESC_OFFSET UNITYSDK_OFFSET(0x194D8FC0)
#define RPG_CLIENT_ACTIVITYELATIONAVATARDATA_GET_ENERGYCOLLECTIONPARAMLIST_OFFSET UNITYSDK_OFFSET(0x194D90A0)
#define RPG_CLIENT_ACTIVITYELATIONAVATARDATA_GET_GIFTIMAGEPATH_OFFSET UNITYSDK_OFFSET(0x194D8F70)
#define RPG_CLIENT_ACTIVITYELATIONAVATARDATA_GET_GIFTNAME_OFFSET UNITYSDK_OFFSET(0x194D8F00)
#define RPG_CLIENT_ACTIVITYELATIONAVATARDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0x194D8E60)
#define RPG_CLIENT_ACTIVITYELATIONAVATARDATA_GET_MODIFIEDSKILLDESCSIMPLE_OFFSET UNITYSDK_OFFSET(0x194D9290)
#define RPG_CLIENT_ACTIVITYELATIONAVATARDATA_GET_MODIFIEDSKILLDESC_OFFSET UNITYSDK_OFFSET(0x194D9220)
#define RPG_CLIENT_ACTIVITYELATIONAVATARDATA_GET_MODIFIEDSKILLPARAMLIST_OFFSET UNITYSDK_OFFSET(0x194D9300)
#define RPG_CLIENT_ACTIVITYELATIONAVATARDATA_GET_SPECIALAVATARID_OFFSET UNITYSDK_OFFSET(0x194D8EB0)
#define RPG_CLIENT_ACTIVITYELATIONAVATARDATA_GET_TAG_OFFSET UNITYSDK_OFFSET(0x194D9350)
#define RPG_CLIENT_ACTIVITYELATIONAVATARDATA_SET_AVATARDATA_OFFSET UNITYSDK_OFFSET(0x194D8E50)
#define RPG_CLIENT_ACTIVITYELATIONAVATARDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x194D93C0)

namespace RPG::Client
{
	inline static constexpr unsigned int ActivityElationAvatarData_TypeDefinitionIndex = 58767;
