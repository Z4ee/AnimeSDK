...
#define RPG_CLIENT_UIPREFABLOADER_LOADRESULT_CLEAR_OFFSET UNITYSDK_OFFSET(0xA7293A0)
#define RPG_CLIENT_UIPREFABLOADER_LOADRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0xA728A90)

namespace RPG::Client
{
	inline static constexpr unsigned int UIPrefabLoader_LoadResult_TypeDefinitionIndex = 59903;
