...
#define RPG_CLIENT_MONOMOVEMENTPROPHANDLE_AFTERPROPMOVED_OFFSET UNITYSDK_OFFSET(0x1ACF78D0)
#define RPG_CLIENT_MONOMOVEMENTPROPHANDLE_BEFOREPROPMOVE_OFFSET UNITYSDK_OFFSET(0x1ACF7800)
#define RPG_CLIENT_MONOMOVEMENTPROPHANDLE_GET_MOVEDDELEGATE_OFFSET UNITYSDK_OFFSET(0x1ACF7680)
#define RPG_CLIENT_MONOMOVEMENTPROPHANDLE_GET_NEEDREFRESHRAYCAST_OFFSET UNITYSDK_OFFSET(0x1ACF76A0)
#define RPG_CLIENT_MONOMOVEMENTPROPHANDLE_GET_OWNERENTITY_OFFSET UNITYSDK_OFFSET(0x1ACF7660)
#define RPG_CLIENT_MONOMOVEMENTPROPHANDLE_INITPROPMOVEMENT_OFFSET UNITYSDK_OFFSET(0x1ACF7720)
#define RPG_CLIENT_MONOMOVEMENTPROPHANDLE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1ACF76C0)
#define RPG_CLIENT_MONOMOVEMENTPROPHANDLE_SET_MOVEDDELEGATE_OFFSET UNITYSDK_OFFSET(0x1ACF7690)
#define RPG_CLIENT_MONOMOVEMENTPROPHANDLE_SET_NEEDREFRESHRAYCAST_OFFSET UNITYSDK_OFFSET(0x1ACF76B0)
#define RPG_CLIENT_MONOMOVEMENTPROPHANDLE_SET_OWNERENTITY_OFFSET UNITYSDK_OFFSET(0x1ACF7670)
#define RPG_CLIENT_MONOMOVEMENTPROPHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACF7AC0)
