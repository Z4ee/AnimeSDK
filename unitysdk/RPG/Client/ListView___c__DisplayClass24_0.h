...
#define RPG_CLIENT_LISTVIEW___C__DISPLAYCLASS24_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4C27D0)
#define RPG_CLIENT_LISTVIEW___C__DISPLAYCLASS24_0__INIT_B__0_OFFSET UNITYSDK_OFFSET(0x1C4C4290)
#define RPG_CLIENT_LISTVIEW___C__DISPLAYCLASS24_0__INIT_B__1_OFFSET UNITYSDK_OFFSET(0x1C4C4360)
#define RPG_CLIENT_LISTVIEW___C__DISPLAYCLASS24_0__INIT_B__2_OFFSET UNITYSDK_OFFSET(0x1C4C4400)
#define RPG_CLIENT_LISTVIEW___C__DISPLAYCLASS24_0__INIT_B__3_OFFSET UNITYSDK_OFFSET(0x1C4C4450)
#define RPG_CLIENT_LISTVIEW___C__DISPLAYCLASS24_0__INIT_B__4_OFFSET UNITYSDK_OFFSET(0x1C4C44F0)

namespace RPG::Client
{
	inline static constexpr unsigned int ListView___c__DisplayClass24_0_TypeDefinitionIndex = 72486;
