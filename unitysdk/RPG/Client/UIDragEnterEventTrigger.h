...
#define RPG_CLIENT_UIDRAGENTEREVENTTRIGGER_ADDAREA_OFFSET UNITYSDK_OFFSET(0x17014970)
#define RPG_CLIENT_UIDRAGENTEREVENTTRIGGER_BINDDRAGENTERCALLBACK_OFFSET UNITYSDK_OFFSET(0x17014BF0)
#define RPG_CLIENT_UIDRAGENTEREVENTTRIGGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x17014C90)
#define RPG_CLIENT_UIDRAGENTEREVENTTRIGGER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x17014C40)
#define RPG_CLIENT_UIDRAGENTEREVENTTRIGGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x17014DA0)
#define RPG_CLIENT_UIDRAGENTEREVENTTRIGGER__CANDRAG_OFFSET UNITYSDK_OFFSET(0x17014CE0)
#define RPG_CLIENT_UIDRAGENTEREVENTTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x17015B40)
#define RPG_CLIENT_UIDRAGENTEREVENTTRIGGER__ENDDRAG_OFFSET UNITYSDK_OFFSET(0x17014F80)
#define RPG_CLIENT_UIDRAGENTEREVENTTRIGGER__ISLINESEGMENTSINTERSECT_OFFSET UNITYSDK_OFFSET(0x17015940)
#define RPG_CLIENT_UIDRAGENTEREVENTTRIGGER__REACHTHRESHOLD_OFFSET UNITYSDK_OFFSET(0x17014FD0)
#define RPG_CLIENT_UIDRAGENTEREVENTTRIGGER__STARTDRAG_OFFSET UNITYSDK_OFFSET(0x17015060)
#define RPG_CLIENT_UIDRAGENTEREVENTTRIGGER__TRIGGERDRAGENTER_OFFSET UNITYSDK_OFFSET(0x170158D0)
#define RPG_CLIENT_UIDRAGENTEREVENTTRIGGER__UPDATEDRAG_OFFSET UNITYSDK_OFFSET(0x170153A0)
#define RPG_CLIENT_UIDRAGENTEREVENTTRIGGER___ISLINESEGMENTSINTERSECT_G__CROSSPRODUCT_11_0_OFFSET UNITYSDK_OFFSET(0x17015AF0)

namespace RPG::Client
{
	inline static constexpr unsigned int UIDragEnterEventTrigger_TypeDefinitionIndex = 72970;
