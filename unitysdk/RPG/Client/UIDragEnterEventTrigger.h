...
#define RPG_CLIENT_UIDRAGENTEREVENTTRIGGER_ADDAREA_OFFSET UNITYSDK_OFFSET(0xE357E00)
#define RPG_CLIENT_UIDRAGENTEREVENTTRIGGER_BINDDRAGENTERCALLBACK_OFFSET UNITYSDK_OFFSET(0xE358080)
#define RPG_CLIENT_UIDRAGENTEREVENTTRIGGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xE358120)
#define RPG_CLIENT_UIDRAGENTEREVENTTRIGGER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xE3580D0)
#define RPG_CLIENT_UIDRAGENTEREVENTTRIGGER_UPDATE_OFFSET UNITYSDK_OFFSET(0xE358230)
#define RPG_CLIENT_UIDRAGENTEREVENTTRIGGER__CANDRAG_OFFSET UNITYSDK_OFFSET(0xE358170)
#define RPG_CLIENT_UIDRAGENTEREVENTTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0xE358FD0)
#define RPG_CLIENT_UIDRAGENTEREVENTTRIGGER__ENDDRAG_OFFSET UNITYSDK_OFFSET(0xE358410)
#define RPG_CLIENT_UIDRAGENTEREVENTTRIGGER__ISLINESEGMENTSINTERSECT_OFFSET UNITYSDK_OFFSET(0xE358DD0)
#define RPG_CLIENT_UIDRAGENTEREVENTTRIGGER__REACHTHRESHOLD_OFFSET UNITYSDK_OFFSET(0xE358460)
#define RPG_CLIENT_UIDRAGENTEREVENTTRIGGER__STARTDRAG_OFFSET UNITYSDK_OFFSET(0xE3584F0)
#define RPG_CLIENT_UIDRAGENTEREVENTTRIGGER__TRIGGERDRAGENTER_OFFSET UNITYSDK_OFFSET(0xE358D60)
#define RPG_CLIENT_UIDRAGENTEREVENTTRIGGER__UPDATEDRAG_OFFSET UNITYSDK_OFFSET(0xE358830)
#define RPG_CLIENT_UIDRAGENTEREVENTTRIGGER___ISLINESEGMENTSINTERSECT_G__CROSSPRODUCT_11_0_OFFSET UNITYSDK_OFFSET(0xE358F80)

namespace RPG::Client
{
	inline static constexpr unsigned int UIDragEnterEventTrigger_TypeDefinitionIndex = 72971;
