...
#define RPG_CLIENT_BATTLEGAMEPHASE___RESTARTLOADBATTLEAREAIMPL_D__65_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x174B5240)
#define RPG_CLIENT_BATTLEGAMEPHASE___RESTARTLOADBATTLEAREAIMPL_D__65_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x174B54F0)
#define RPG_CLIENT_BATTLEGAMEPHASE___RESTARTLOADBATTLEAREAIMPL_D__65_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x174B5550)
#define RPG_CLIENT_BATTLEGAMEPHASE___RESTARTLOADBATTLEAREAIMPL_D__65_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x174B5500)
#define RPG_CLIENT_BATTLEGAMEPHASE___RESTARTLOADBATTLEAREAIMPL_D__65_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x174B5230)
#define RPG_CLIENT_BATTLEGAMEPHASE___RESTARTLOADBATTLEAREAIMPL_D__65__CTOR_OFFSET UNITYSDK_OFFSET(0x174A2B20)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleGamePhase___RestartLoadBattleAreaImpl_d__65_TypeDefinitionIndex = 58242;

	class BattleGamePhase___RestartLoadBattleAreaImpl_d__65 : public ::System::Object
	{
	public:
		::RPG::Client::Promises::Promise* promise; // 0x10
		::RPG::Client::Map* _map_5__2; // 0x18
		::System::Object* __2__current; // 0x20
		::RPG::Client::BattleGamePhaseInitParams* initParam; // 0x28
