...
namespace RPG::Client
{
	...
	public:
		...
		::System::Boolean _GetUnlockedHarvestDatasByGroupId_b__0(::RPG::Client::ExpeditionHarvestData* x)
		{
			return ((::System::Boolean(*)(::PVOID, ::RPG::Client::ExpeditionHarvestData*))((::PBYTE)hIl2Cpp + RPG_CLIENT_EXPEDITIONMODULE___C__DISPLAYCLASS6_0__GETUNLOCKEDHARVESTDATASBYGROUPID_B__0_OFFSET))(this, x);
		}
	};
}
