...
#define RPG_CLIENT_CUTSCENECACHEINITPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x192D7620)

namespace RPG::Client
{
	inline static constexpr unsigned int CutsceneCacheInitParams_TypeDefinitionIndex = 59823;
