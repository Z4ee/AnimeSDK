...
#define RPG_CLIENT_PLANARREFLECTION_EXECUTE_OFFSET UNITYSDK_OFFSET(0xC3EDCB0)
#define RPG_CLIENT_PLANARREFLECTION_GETNAMESTR_OFFSET UNITYSDK_OFFSET(0xC3EFBE0)
#define RPG_CLIENT_PLANARREFLECTION_GET_KEY_OFFSET UNITYSDK_OFFSET(0xC3EDC70)
#define RPG_CLIENT_PLANARREFLECTION_GET_NAMEKEY_OFFSET UNITYSDK_OFFSET(0xC3EDC50)
#define RPG_CLIENT_PLANARREFLECTION_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xC3EDF90)
#define RPG_CLIENT_PLANARREFLECTION_GET_RENDERLIST_OFFSET UNITYSDK_OFFSET(0xC3EDC30)
#define RPG_CLIENT_PLANARREFLECTION_GET_USERENDERLIST_OFFSET UNITYSDK_OFFSET(0xC3EDC10)
#define RPG_CLIENT_PLANARREFLECTION_GET_VALIDFORRENDERING_OFFSET UNITYSDK_OFFSET(0xC3EDFA0)
#define RPG_CLIENT_PLANARREFLECTION_METHOD_5_118BDDBD7450B315_OFFSET UNITYSDK_OFFSET(0xC3EF900)
#define RPG_CLIENT_PLANARREFLECTION_METHOD_5_3BDC90EC995068F1_OFFSET UNITYSDK_OFFSET(0xC3F0F10)
#define RPG_CLIENT_PLANARREFLECTION_METHOD_5_3DF8B6CE0C1D4E7D_OFFSET UNITYSDK_OFFSET(0xC3F1440)
#define RPG_CLIENT_PLANARREFLECTION_METHOD_5_40B4E82B9BBDD74D_OFFSET UNITYSDK_OFFSET(0xC3EE970)
#define RPG_CLIENT_PLANARREFLECTION_METHOD_5_51CFFE2AF748ECD7_OFFSET UNITYSDK_OFFSET(0xC3F11E0)
#define RPG_CLIENT_PLANARREFLECTION_METHOD_5_87A0D0E2332A0BEA_OFFSET UNITYSDK_OFFSET(0xC3F16B0)
#define RPG_CLIENT_PLANARREFLECTION_METHOD_5_A6FF6624967F197D_OFFSET UNITYSDK_OFFSET(0xC3EED10)
#define RPG_CLIENT_PLANARREFLECTION_METHOD_5_BBEE5344A89FBA2C_OFFSET UNITYSDK_OFFSET(0xC3F04B0)
#define RPG_CLIENT_PLANARREFLECTION_METHOD_5_BF972395CC722BF9_OFFSET UNITYSDK_OFFSET(0xC3F07B0)
#define RPG_CLIENT_PLANARREFLECTION_METHOD_5_CCFFC97FF79A551F_OFFSET UNITYSDK_OFFSET(0xC3EF400)
#define RPG_CLIENT_PLANARREFLECTION_METHOD_5_E3C376C73DC2AD5B_OFFSET UNITYSDK_OFFSET(0xC3EF540)
#define RPG_CLIENT_PLANARREFLECTION_METHOD_5_EB1F180852FCFCFD_OFFSET UNITYSDK_OFFSET(0xC3F1320)
#define RPG_CLIENT_PLANARREFLECTION_METHOD_5_ED65AE7582736594_OFFSET UNITYSDK_OFFSET(0xC3F0CA0)
#define RPG_CLIENT_PLANARREFLECTION_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC3F00E0)
#define RPG_CLIENT_PLANARREFLECTION_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xC3EFE40)
#define RPG_CLIENT_PLANARREFLECTION_ONENABLE_OFFSET UNITYSDK_OFFSET(0xC3EFC30)
#define RPG_CLIENT_PLANARREFLECTION_RPG_CUSTOMRP_IPLANEREFLECTION_UPDATEREFLECTION_OFFSET UNITYSDK_OFFSET(0xC3F17C0)
#define RPG_CLIENT_PLANARREFLECTION_SET_NAMEKEY_OFFSET UNITYSDK_OFFSET(0xC3EDC60)
#define RPG_CLIENT_PLANARREFLECTION_SET_RENDERLIST_OFFSET UNITYSDK_OFFSET(0xC3EDC40)
#define RPG_CLIENT_PLANARREFLECTION_SET_USERENDERLIST_OFFSET UNITYSDK_OFFSET(0xC3EDC20)
#define RPG_CLIENT_PLANARREFLECTION_SET_VALIDFORRENDERING_OFFSET UNITYSDK_OFFSET(0xC3EDFB0)
#define RPG_CLIENT_PLANARREFLECTION_UPDATEREFLECTION_OFFSET UNITYSDK_OFFSET(0xC3EE020)
#define RPG_CLIENT_PLANARREFLECTION_UPDATE_OFFSET UNITYSDK_OFFSET(0xC3F0200)
#define RPG_CLIENT_PLANARREFLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0xC3F1710)

namespace RPG::Client
{
	inline static constexpr unsigned int PlanarReflection_TypeDefinitionIndex = 65605;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_PLANARREFLECTION_METHOD_5_ED65AE7582736594_OFFSET))(this);
		}
