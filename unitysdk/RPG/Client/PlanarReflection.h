...
#define RPG_CLIENT_PLANARREFLECTION_EXECUTE_OFFSET UNITYSDK_OFFSET(0xAC9A5D0)
#define RPG_CLIENT_PLANARREFLECTION_GETNAMESTR_OFFSET UNITYSDK_OFFSET(0xAC9C5A0)
#define RPG_CLIENT_PLANARREFLECTION_GET_KEY_OFFSET UNITYSDK_OFFSET(0xAC9A590)
#define RPG_CLIENT_PLANARREFLECTION_GET_NAMEKEY_OFFSET UNITYSDK_OFFSET(0xAC9A570)
#define RPG_CLIENT_PLANARREFLECTION_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xAC9A900)
#define RPG_CLIENT_PLANARREFLECTION_GET_RENDERLIST_OFFSET UNITYSDK_OFFSET(0xAC9A550)
#define RPG_CLIENT_PLANARREFLECTION_GET_USERENDERLIST_OFFSET UNITYSDK_OFFSET(0xAC9A530)
#define RPG_CLIENT_PLANARREFLECTION_GET_VALIDFORRENDERING_OFFSET UNITYSDK_OFFSET(0xAC9A910)
#define RPG_CLIENT_PLANARREFLECTION_METHOD_5_3BDC90EC995068F1_OFFSET UNITYSDK_OFFSET(0xAC9D7E0)
#define RPG_CLIENT_PLANARREFLECTION_METHOD_5_3DF8B6CE0C1D4E7D_OFFSET UNITYSDK_OFFSET(0xAC9DD10)
#define RPG_CLIENT_PLANARREFLECTION_METHOD_5_40B4E82B9BBDD74D_OFFSET UNITYSDK_OFFSET(0xAC9B2E0)
#define RPG_CLIENT_PLANARREFLECTION_METHOD_5_46E030E6F5465A66_OFFSET UNITYSDK_OFFSET(0xAC9D640)
#define RPG_CLIENT_PLANARREFLECTION_METHOD_5_51CFFE2AF748ECD7_OFFSET UNITYSDK_OFFSET(0xAC9DAB0)
#define RPG_CLIENT_PLANARREFLECTION_METHOD_5_54CB69821945E90B_OFFSET UNITYSDK_OFFSET(0xAC9C2B0)
#define RPG_CLIENT_PLANARREFLECTION_METHOD_5_7EB19CFE09DC3321_OFFSET UNITYSDK_OFFSET(0xAC9BD90)
#define RPG_CLIENT_PLANARREFLECTION_METHOD_5_87A0D0E2332A0BEA_OFFSET UNITYSDK_OFFSET(0xAC9DF80)
#define RPG_CLIENT_PLANARREFLECTION_METHOD_5_A6FF6624967F197D_OFFSET UNITYSDK_OFFSET(0xAC9B680)
#define RPG_CLIENT_PLANARREFLECTION_METHOD_5_BBEE5344A89FBA2C_OFFSET UNITYSDK_OFFSET(0xAC9CE50)
#define RPG_CLIENT_PLANARREFLECTION_METHOD_5_BF972395CC722BF9_OFFSET UNITYSDK_OFFSET(0xAC9D150)
#define RPG_CLIENT_PLANARREFLECTION_METHOD_5_E3C376C73DC2AD5B_OFFSET UNITYSDK_OFFSET(0xAC9BEB0)
#define RPG_CLIENT_PLANARREFLECTION_METHOD_5_EB1F180852FCFCFD_OFFSET UNITYSDK_OFFSET(0xAC9DBF0)
#define RPG_CLIENT_PLANARREFLECTION_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xAC9CA80)
#define RPG_CLIENT_PLANARREFLECTION_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xAC9C800)
#define RPG_CLIENT_PLANARREFLECTION_ONENABLE_OFFSET UNITYSDK_OFFSET(0xAC9C5F0)
#define RPG_CLIENT_PLANARREFLECTION_RPG_CUSTOMRP_IPLANEREFLECTION_UPDATEREFLECTION_OFFSET UNITYSDK_OFFSET(0xAC9E0A0)
#define RPG_CLIENT_PLANARREFLECTION_SET_NAMEKEY_OFFSET UNITYSDK_OFFSET(0xAC9A580)
#define RPG_CLIENT_PLANARREFLECTION_SET_RENDERLIST_OFFSET UNITYSDK_OFFSET(0xAC9A560)
#define RPG_CLIENT_PLANARREFLECTION_SET_USERENDERLIST_OFFSET UNITYSDK_OFFSET(0xAC9A540)
#define RPG_CLIENT_PLANARREFLECTION_SET_VALIDFORRENDERING_OFFSET UNITYSDK_OFFSET(0xAC9A920)
#define RPG_CLIENT_PLANARREFLECTION_UPDATEREFLECTION_OFFSET UNITYSDK_OFFSET(0xAC9A990)
#define RPG_CLIENT_PLANARREFLECTION_UPDATE_OFFSET UNITYSDK_OFFSET(0xAC9CBA0)
#define RPG_CLIENT_PLANARREFLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0xAC9DFE0)

namespace RPG::Client
{
	inline static constexpr unsigned int PlanarReflection_TypeDefinitionIndex = 64684;
	...
	public:
		...
		::UnityEngine::Vector3 Field_5_19; // 0x7C
		::UnityEngine::Quaternion Field_5_20; // 0x88
		::UnityEngine::Matrix4x4 Field_5_21; // 0x98
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_PLANARREFLECTION_METHOD_5_46E030E6F5465A66_OFFSET))(this);
		}
