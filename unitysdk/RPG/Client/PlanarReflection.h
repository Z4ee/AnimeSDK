...
#define RPG_CLIENT_PLANARREFLECTION_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1A0E2C20)
#define RPG_CLIENT_PLANARREFLECTION_GETNAMESTR_OFFSET UNITYSDK_OFFSET(0x1A0E4B60)
#define RPG_CLIENT_PLANARREFLECTION_GET_KEY_OFFSET UNITYSDK_OFFSET(0x1A0E2BE0)
#define RPG_CLIENT_PLANARREFLECTION_GET_NAMEKEY_OFFSET UNITYSDK_OFFSET(0x1A0E2BC0)
#define RPG_CLIENT_PLANARREFLECTION_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x1A0E2F00)
#define RPG_CLIENT_PLANARREFLECTION_GET_RENDERLIST_OFFSET UNITYSDK_OFFSET(0x1A0E2BA0)
#define RPG_CLIENT_PLANARREFLECTION_GET_USERENDERLIST_OFFSET UNITYSDK_OFFSET(0x1A0E2B80)
#define RPG_CLIENT_PLANARREFLECTION_GET_VALIDFORRENDERING_OFFSET UNITYSDK_OFFSET(0x1A0E2F10)
#define RPG_CLIENT_PLANARREFLECTION_METHOD_5_118BDDBD7450B315_OFFSET UNITYSDK_OFFSET(0x1A0E4880)
#define RPG_CLIENT_PLANARREFLECTION_METHOD_5_3BDC90EC995068F1_OFFSET UNITYSDK_OFFSET(0x1A0E5EE0)
#define RPG_CLIENT_PLANARREFLECTION_METHOD_5_3DF8B6CE0C1D4E7D_OFFSET UNITYSDK_OFFSET(0x1A0E6410)
#define RPG_CLIENT_PLANARREFLECTION_METHOD_5_40B4E82B9BBDD74D_OFFSET UNITYSDK_OFFSET(0x1A0E38E0)
#define RPG_CLIENT_PLANARREFLECTION_METHOD_5_51CFFE2AF748ECD7_OFFSET UNITYSDK_OFFSET(0x1A0E61B0)
#define RPG_CLIENT_PLANARREFLECTION_METHOD_5_62593EE2FE331D20_OFFSET UNITYSDK_OFFSET(0x1A0E5CE0)
#define RPG_CLIENT_PLANARREFLECTION_METHOD_5_87A0D0E2332A0BEA_OFFSET UNITYSDK_OFFSET(0x1A0E6680)
#define RPG_CLIENT_PLANARREFLECTION_METHOD_5_A6FF6624967F197D_OFFSET UNITYSDK_OFFSET(0x1A0E3C80)
#define RPG_CLIENT_PLANARREFLECTION_METHOD_5_BBEE5344A89FBA2C_OFFSET UNITYSDK_OFFSET(0x1A0E54F0)
#define RPG_CLIENT_PLANARREFLECTION_METHOD_5_BF972395CC722BF9_OFFSET UNITYSDK_OFFSET(0x1A0E57F0)
#define RPG_CLIENT_PLANARREFLECTION_METHOD_5_CCFFC97FF79A551F_OFFSET UNITYSDK_OFFSET(0x1A0E4370)
#define RPG_CLIENT_PLANARREFLECTION_METHOD_5_E3C376C73DC2AD5B_OFFSET UNITYSDK_OFFSET(0x1A0E44B0)
#define RPG_CLIENT_PLANARREFLECTION_METHOD_5_EB1F180852FCFCFD_OFFSET UNITYSDK_OFFSET(0x1A0E62F0)
#define RPG_CLIENT_PLANARREFLECTION_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A0E5120)
#define RPG_CLIENT_PLANARREFLECTION_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1A0E4E80)
#define RPG_CLIENT_PLANARREFLECTION_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A0E4BB0)
#define RPG_CLIENT_PLANARREFLECTION_RPG_CUSTOMRP_IPLANEREFLECTION_UPDATEREFLECTION_OFFSET UNITYSDK_OFFSET(0x1A0E6790)
#define RPG_CLIENT_PLANARREFLECTION_SET_NAMEKEY_OFFSET UNITYSDK_OFFSET(0x1A0E2BD0)
#define RPG_CLIENT_PLANARREFLECTION_SET_RENDERLIST_OFFSET UNITYSDK_OFFSET(0x1A0E2BB0)
#define RPG_CLIENT_PLANARREFLECTION_SET_USERENDERLIST_OFFSET UNITYSDK_OFFSET(0x1A0E2B90)
#define RPG_CLIENT_PLANARREFLECTION_SET_VALIDFORRENDERING_OFFSET UNITYSDK_OFFSET(0x1A0E2F20)
#define RPG_CLIENT_PLANARREFLECTION_UPDATEREFLECTION_OFFSET UNITYSDK_OFFSET(0x1A0E2F90)
#define RPG_CLIENT_PLANARREFLECTION_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A0E5240)
#define RPG_CLIENT_PLANARREFLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0E66E0)

namespace RPG::Client
{
	inline static constexpr unsigned int PlanarReflection_TypeDefinitionIndex = 67022;
