...
#define RPG_CLIENT_PREFABSTATEPERFORMER__CTOR_OFFSET UNITYSDK_OFFSET(0xAD74900)

namespace RPG::Client
{
	inline static constexpr unsigned int PrefabStatePerformer_TypeDefinitionIndex = 63569;
