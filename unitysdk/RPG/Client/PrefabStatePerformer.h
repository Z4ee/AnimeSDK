...
#define RPG_CLIENT_PREFABSTATEPERFORMER__CTOR_OFFSET UNITYSDK_OFFSET(0x9FF84F0)

namespace RPG::Client
{
	inline static constexpr unsigned int PrefabStatePerformer_TypeDefinitionIndex = 56326;
