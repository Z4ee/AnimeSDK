...
#define RPG_CLIENT_EMOBLENDSHAPEBLINKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A173390)

namespace RPG::Client
{
	inline static constexpr unsigned int EmoBlendShapeBlinkConfig_TypeDefinitionIndex = 71112;
