...
#define RPG_CLIENT_DECALPUZZLEREGION_METHOD_1_081E84DBAB5CA72B_OFFSET UNITYSDK_OFFSET(0x180926B0)
#define RPG_CLIENT_DECALPUZZLEREGION_METHOD_1_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0x18092720)
#define RPG_CLIENT_DECALPUZZLEREGION_METHOD_1_4C0EBEE9B5A06A83_OFFSET UNITYSDK_OFFSET(0x18092C90)
#define RPG_CLIENT_DECALPUZZLEREGION_METHOD_1_6DE2C674FDD4BF07_OFFSET UNITYSDK_OFFSET(0x180928F0)
#define RPG_CLIENT_DECALPUZZLEREGION_METHOD_1_7002C7609FE8B6AE_1_OFFSET UNITYSDK_OFFSET(0x18092410)
#define RPG_CLIENT_DECALPUZZLEREGION_METHOD_1_7002C7609FE8B6AE_OFFSET UNITYSDK_OFFSET(0x18091F00)
#define RPG_CLIENT_DECALPUZZLEREGION_METHOD_1_853D12DFD2223B1B_OFFSET UNITYSDK_OFFSET(0x18092290)
#define RPG_CLIENT_DECALPUZZLEREGION_METHOD_1_98CD66A7F3C102A5_OFFSET UNITYSDK_OFFSET(0x18091CE0)
#define RPG_CLIENT_DECALPUZZLEREGION_METHOD_1_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x18092780)
#define RPG_CLIENT_DECALPUZZLEREGION_METHOD_1_B34D4E319F95DF95_OFFSET UNITYSDK_OFFSET(0x18092AD0)
#define RPG_CLIENT_DECALPUZZLEREGION_METHOD_1_D64FD9A228A1C4E0_1_OFFSET UNITYSDK_OFFSET(0x18092880)
#define RPG_CLIENT_DECALPUZZLEREGION_METHOD_1_D64FD9A228A1C4E0_OFFSET UNITYSDK_OFFSET(0x18092810)
#define RPG_CLIENT_DECALPUZZLEREGION_METHOD_1_DC07A38C823F6ED7_OFFSET UNITYSDK_OFFSET(0x180925C0)
#define RPG_CLIENT_DECALPUZZLEREGION_METHOD_1_E905D30F05438104_OFFSET UNITYSDK_OFFSET(0x180921C0)
#define RPG_CLIENT_DECALPUZZLEREGION_METHOD_1_F55BE4E8507DAB52_OFFSET UNITYSDK_OFFSET(0x18091C90)
#define RPG_CLIENT_DECALPUZZLEREGION__CTOR_OFFSET UNITYSDK_OFFSET(0x18092D60)

namespace RPG::Client
{
	inline static constexpr unsigned int DecalPuzzleRegion_TypeDefinitionIndex = 65607;
