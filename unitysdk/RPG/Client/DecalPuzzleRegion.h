...
#define RPG_CLIENT_DECALPUZZLEREGION_METHOD_1_081E84DBAB5CA72B_OFFSET UNITYSDK_OFFSET(0xA0F8630)
#define RPG_CLIENT_DECALPUZZLEREGION_METHOD_1_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0xA0F86A0)
#define RPG_CLIENT_DECALPUZZLEREGION_METHOD_1_4C0EBEE9B5A06A83_OFFSET UNITYSDK_OFFSET(0xA0F8C50)
#define RPG_CLIENT_DECALPUZZLEREGION_METHOD_1_5E3EF034189CDBBB_OFFSET UNITYSDK_OFFSET(0xA0F7E40)
#define RPG_CLIENT_DECALPUZZLEREGION_METHOD_1_8635E5424EFC007C_OFFSET UNITYSDK_OFFSET(0xA0F8890)
#define RPG_CLIENT_DECALPUZZLEREGION_METHOD_1_8B20CBA99571EBA3_OFFSET UNITYSDK_OFFSET(0xA0F83A0)
#define RPG_CLIENT_DECALPUZZLEREGION_METHOD_1_98CD66A7F3C102A5_OFFSET UNITYSDK_OFFSET(0xA0F7C20)
#define RPG_CLIENT_DECALPUZZLEREGION_METHOD_1_B09E78EE7EE4F8FA_OFFSET UNITYSDK_OFFSET(0xA0F8700)
#define RPG_CLIENT_DECALPUZZLEREGION_METHOD_1_B34D4E319F95DF95_OFFSET UNITYSDK_OFFSET(0xA0F8A90)
#define RPG_CLIENT_DECALPUZZLEREGION_METHOD_1_D64FD9A228A1C4E0_1_OFFSET UNITYSDK_OFFSET(0xA0F8820)
#define RPG_CLIENT_DECALPUZZLEREGION_METHOD_1_D64FD9A228A1C4E0_OFFSET UNITYSDK_OFFSET(0xA0F87B0)
#define RPG_CLIENT_DECALPUZZLEREGION_METHOD_1_DC07A38C823F6ED7_OFFSET UNITYSDK_OFFSET(0xA0F8520)
#define RPG_CLIENT_DECALPUZZLEREGION_METHOD_1_E905D30F05438104_OFFSET UNITYSDK_OFFSET(0xA0F80D0)
#define RPG_CLIENT_DECALPUZZLEREGION_METHOD_1_F55BE4E8507DAB52_OFFSET UNITYSDK_OFFSET(0xA0F7BD0)
#define RPG_CLIENT_DECALPUZZLEREGION_METHOD_1_FA95EDCD93C90C36_OFFSET UNITYSDK_OFFSET(0xA0F81A0)
#define RPG_CLIENT_DECALPUZZLEREGION__CTOR_OFFSET UNITYSDK_OFFSET(0xA0F8D20)

namespace RPG::Client
{
	inline static constexpr unsigned int DecalPuzzleRegion_TypeDefinitionIndex = 63319;
