...
#define RPG_CLIENT_DECALPUZZLEREGION_METHOD_1_081E84DBAB5CA72B_OFFSET UNITYSDK_OFFSET(0x192E0DB0)
#define RPG_CLIENT_DECALPUZZLEREGION_METHOD_1_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0x192E0E20)
#define RPG_CLIENT_DECALPUZZLEREGION_METHOD_1_4C0EBEE9B5A06A83_OFFSET UNITYSDK_OFFSET(0x192E1390)
#define RPG_CLIENT_DECALPUZZLEREGION_METHOD_1_6DE2C674FDD4BF07_OFFSET UNITYSDK_OFFSET(0x192E0FF0)
#define RPG_CLIENT_DECALPUZZLEREGION_METHOD_1_7002C7609FE8B6AE_1_OFFSET UNITYSDK_OFFSET(0x192E0B10)
#define RPG_CLIENT_DECALPUZZLEREGION_METHOD_1_7002C7609FE8B6AE_OFFSET UNITYSDK_OFFSET(0x192E0600)
#define RPG_CLIENT_DECALPUZZLEREGION_METHOD_1_853D12DFD2223B1B_OFFSET UNITYSDK_OFFSET(0x192E0990)
#define RPG_CLIENT_DECALPUZZLEREGION_METHOD_1_98CD66A7F3C102A5_OFFSET UNITYSDK_OFFSET(0x192E03E0)
#define RPG_CLIENT_DECALPUZZLEREGION_METHOD_1_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x192E0E80)
#define RPG_CLIENT_DECALPUZZLEREGION_METHOD_1_B34D4E319F95DF95_OFFSET UNITYSDK_OFFSET(0x192E11D0)
#define RPG_CLIENT_DECALPUZZLEREGION_METHOD_1_D64FD9A228A1C4E0_1_OFFSET UNITYSDK_OFFSET(0x192E0F80)
#define RPG_CLIENT_DECALPUZZLEREGION_METHOD_1_D64FD9A228A1C4E0_OFFSET UNITYSDK_OFFSET(0x192E0F10)
#define RPG_CLIENT_DECALPUZZLEREGION_METHOD_1_DC07A38C823F6ED7_OFFSET UNITYSDK_OFFSET(0x192E0CC0)
#define RPG_CLIENT_DECALPUZZLEREGION_METHOD_1_E905D30F05438104_OFFSET UNITYSDK_OFFSET(0x192E08C0)
#define RPG_CLIENT_DECALPUZZLEREGION_METHOD_1_F55BE4E8507DAB52_OFFSET UNITYSDK_OFFSET(0x192E0390)
#define RPG_CLIENT_DECALPUZZLEREGION__CTOR_OFFSET UNITYSDK_OFFSET(0x192E1460)

namespace RPG::Client
{
	inline static constexpr unsigned int DecalPuzzleRegion_TypeDefinitionIndex = 68623;
	...
	public:
		...
		::System::Boolean Method_1_7002C7609FE8B6AE(::RPG::Client::FreeDecal* a1)
		{
			return ((::System::Boolean(*)(::PVOID, ::RPG::Client::FreeDecal*))((::PBYTE)hIl2Cpp + RPG_CLIENT_DECALPUZZLEREGION_METHOD_1_7002C7609FE8B6AE_OFFSET))(this, a1);
		}

		::System::Boolean Method_1_7002C7609FE8B6AE_1(::RPG::Client::FreeDecal* a1)
		{
			return ((::System::Boolean(*)(::PVOID, ::RPG::Client::FreeDecal*))((::PBYTE)hIl2Cpp + RPG_CLIENT_DECALPUZZLEREGION_METHOD_1_7002C7609FE8B6AE_1_OFFSET))(this, a1);
		}
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_DECALPUZZLEREGION_METHOD_1_B1936CE4DA97AA45_OFFSET))(this);
		}
		...
		::System::Boolean Method_1_853D12DFD2223B1B(::UnityEngine::Vector2 a1)
		{
			return ((::System::Boolean(*)(::PVOID, ::UnityEngine::Vector2))((::PBYTE)hIl2Cpp + RPG_CLIENT_DECALPUZZLEREGION_METHOD_1_853D12DFD2223B1B_OFFSET))(this, a1);
		}
		...
		::System::Int32 Method_1_6DE2C674FDD4BF07()
		{
			return ((::System::Int32(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_DECALPUZZLEREGION_METHOD_1_6DE2C674FDD4BF07_OFFSET))(this);
		}
