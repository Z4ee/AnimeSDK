...
#define RPG_CLIENT_FIXSTRETCHEDSCALE_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xA3BE820)
#define RPG_CLIENT_FIXSTRETCHEDSCALE__CTOR_OFFSET UNITYSDK_OFFSET(0xA3BE870)
#define RPG_CLIENT_FIXSTRETCHEDSCALE___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xA3BE880)

namespace RPG::Client
{
	inline static constexpr unsigned int FixStretchedScale_TypeDefinitionIndex = 65091;
