...
#define RPG_CLIENT_FIXSTRETCHEDSCALE_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x96FE2F0)
#define RPG_CLIENT_FIXSTRETCHEDSCALE__CTOR_OFFSET UNITYSDK_OFFSET(0x96FE340)
#define RPG_CLIENT_FIXSTRETCHEDSCALE___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x96FE350)

namespace RPG::Client
{
	inline static constexpr unsigned int FixStretchedScale_TypeDefinitionIndex = 57814;
