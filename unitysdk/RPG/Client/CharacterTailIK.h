...
#define RPG_CLIENT_CHARACTERTAILIK_CLEAR_OFFSET UNITYSDK_OFFSET(0x1B928E10)
#define RPG_CLIENT_CHARACTERTAILIK_COMPARETO_OFFSET UNITYSDK_OFFSET(0x1B9298B0)
#define RPG_CLIENT_CHARACTERTAILIK_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x1B9299E0)
#define RPG_CLIENT_CHARACTERTAILIK_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1B928F10)
#define RPG_CLIENT_CHARACTERTAILIK_METHOD_5_6BF81B6CD305D3E3_OFFSET UNITYSDK_OFFSET(0x1B9299F0)
#define RPG_CLIENT_CHARACTERTAILIK_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1B928EB0)
#define RPG_CLIENT_CHARACTERTAILIK_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B928E50)
#define RPG_CLIENT_CHARACTERTAILIK_PROCESS_OFFSET UNITYSDK_OFFSET(0x1B928F60)
#define RPG_CLIENT_CHARACTERTAILIK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B929A70)

namespace RPG::Client
{
	inline static constexpr unsigned int CharacterTailIK_TypeDefinitionIndex = 68353;
	...
	public:
		...
		::UnityEngine::Vector3 AJEGEMCEGEB; // 0x3C
		...
		{
			return ((::System::Int32(*)(::PVOID, ::Class_0_16E4307DCC419505_491*))((::PBYTE)hIl2Cpp + RPG_CLIENT_CHARACTERTAILIK_COMPARETO_OFFSET))(this, a1);
		}
