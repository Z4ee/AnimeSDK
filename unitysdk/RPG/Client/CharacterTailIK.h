...
#define RPG_CLIENT_CHARACTERTAILIK_CLEAR_OFFSET UNITYSDK_OFFSET(0xB5916B0)
#define RPG_CLIENT_CHARACTERTAILIK_COMPARETO_OFFSET UNITYSDK_OFFSET(0xB5920E0)
#define RPG_CLIENT_CHARACTERTAILIK_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xB5921D0)
#define RPG_CLIENT_CHARACTERTAILIK_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xB5917B0)
#define RPG_CLIENT_CHARACTERTAILIK_METHOD_5_6BF81B6CD305D3E3_OFFSET UNITYSDK_OFFSET(0xB5921E0)
#define RPG_CLIENT_CHARACTERTAILIK_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xB591750)
#define RPG_CLIENT_CHARACTERTAILIK_ONENABLE_OFFSET UNITYSDK_OFFSET(0xB5916F0)
#define RPG_CLIENT_CHARACTERTAILIK_PROCESS_OFFSET UNITYSDK_OFFSET(0xB591800)
#define RPG_CLIENT_CHARACTERTAILIK__CTOR_OFFSET UNITYSDK_OFFSET(0xB592260)
