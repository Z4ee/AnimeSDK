...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFICONVIEWMODEL_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x1CC4E400)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFICONVIEWMODEL_SET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x1CC4E060)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFICONVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC4E470)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesBuffIconViewModel_TypeDefinitionIndex = 80040;
