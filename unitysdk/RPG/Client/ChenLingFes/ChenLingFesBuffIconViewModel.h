...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFICONVIEWMODEL_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xB5E4690)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFICONVIEWMODEL_SET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xB5E42E0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFICONVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xB5E46A0)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesBuffIconViewModel_TypeDefinitionIndex = 74025;
