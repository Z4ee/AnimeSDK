...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0x1CC530A0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDVIEWMODEL_GET_CLICKCLOSECOMMAND_OFFSET UNITYSDK_OFFSET(0x1CC53350)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDVIEWMODEL_GET_DESCTEXT_OFFSET UNITYSDK_OFFSET(0x1CC53310)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDVIEWMODEL_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x1CC53330)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDVIEWMODEL_GET_TITLETEXT_OFFSET UNITYSDK_OFFSET(0x1CC532F0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDVIEWMODEL_SET_CLICKCLOSECOMMAND_OFFSET UNITYSDK_OFFSET(0x1CC53360)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDVIEWMODEL_SET_DESCTEXT_OFFSET UNITYSDK_OFFSET(0x1CC53320)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDVIEWMODEL_SET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x1CC53340)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDVIEWMODEL_SET_TITLETEXT_OFFSET UNITYSDK_OFFSET(0x1CC53300)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC53170)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDVIEWMODEL__INIT_OFFSET UNITYSDK_OFFSET(0x1CC53190)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDVIEWMODEL__ONCLICKCLOSE_OFFSET UNITYSDK_OFFSET(0x1CC53270)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameBuffRewardViewModel_TypeDefinitionIndex = 80071;
