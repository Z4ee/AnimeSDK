...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0x1B001D50)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDVIEWMODEL_GET_CLICKCLOSECOMMAND_OFFSET UNITYSDK_OFFSET(0x1B002000)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDVIEWMODEL_GET_DESCTEXT_OFFSET UNITYSDK_OFFSET(0x1B001FC0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDVIEWMODEL_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x1B001FE0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDVIEWMODEL_GET_TITLETEXT_OFFSET UNITYSDK_OFFSET(0x1B001FA0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDVIEWMODEL_SET_CLICKCLOSECOMMAND_OFFSET UNITYSDK_OFFSET(0x1B002010)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDVIEWMODEL_SET_DESCTEXT_OFFSET UNITYSDK_OFFSET(0x1B001FD0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDVIEWMODEL_SET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x1B001FF0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDVIEWMODEL_SET_TITLETEXT_OFFSET UNITYSDK_OFFSET(0x1B001FB0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B001E20)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDVIEWMODEL__INIT_OFFSET UNITYSDK_OFFSET(0x1B001E40)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDVIEWMODEL__ONCLICKCLOSE_OFFSET UNITYSDK_OFFSET(0x1B001F20)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameBuffRewardViewModel_TypeDefinitionIndex = 76438;

	class ChenLingFesGameBuffRewardViewModel : public ::Sofa::BaseViewModel
	{
	public:
		::Sofa::Core::SimpleCommand* _ClickCloseCommand_k__BackingField; // 0x20
