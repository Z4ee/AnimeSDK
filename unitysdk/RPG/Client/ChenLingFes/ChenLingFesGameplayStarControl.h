...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSTARCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1B73FD80)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSTARCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B73FE30)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSTARCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1B73FBC0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSTARCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1B73FB40)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameplayStarControl_TypeDefinitionIndex = 79999;
