...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYTARGETITEMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xB6118C0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYTARGETITEMVIEWMODEL__INITSTARVMS_OFFSET UNITYSDK_OFFSET(0xB6119E0)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameplayTargetItemViewModel_TypeDefinitionIndex = 74046;
	...
	public:
		...
		::System::Collections::Generic::List_1<::RPG::Client::ChenLingFes::ChenLingFesGameplayStarViewModel*>* StarVMs; // 0x28
		::System::Int32 DayCount; // 0x30
		::System::Int32 TargetScore; // 0x34
		::System::Boolean IsEndlessModeForBoss; // 0x38
		::System::Boolean IsEndlessMode; // 0x39
		::System::Int32 Star; // 0x3C
		::System::Int32 RequiredStarCount; // 0x40
		::System::Boolean IsShowGlobalTarget; // 0x44
		::System::Boolean IsCurWeek; // 0x45
		::System::Boolean IsFinished; // 0x46
		::System::Int32 WeekIndex; // 0x48
