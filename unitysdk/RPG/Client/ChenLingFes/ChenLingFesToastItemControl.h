...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTITEMCONTROL_GETHEIGHT_OFFSET UNITYSDK_OFFSET(0xCB7A4A0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTITEMCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCB79400)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTITEMCONTROL_ONDESPAWN_OFFSET UNITYSDK_OFFSET(0xCB7A350)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTITEMCONTROL_ONSPAWN_OFFSET UNITYSDK_OFFSET(0xCB7A2D0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTITEMCONTROL_REFRESHWORLDPOSITION_OFFSET UNITYSDK_OFFSET(0xCB76A90)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTITEMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xCB79C40)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTITEMCONTROL__GETHEIGHT_OFFSET UNITYSDK_OFFSET(0xCB7A220)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTITEMCONTROL__RELEASETOPOOL_OFFSET UNITYSDK_OFFSET(0xCB7A5C0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTITEMCONTROL__SETAUTORELEASETOPOOL_OFFSET UNITYSDK_OFFSET(0xCB79960)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTITEMCONTROL__UPDATEWORLDPOSITION_OFFSET UNITYSDK_OFFSET(0xCB794B0)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesToastItemControl_TypeDefinitionIndex = 80025;
