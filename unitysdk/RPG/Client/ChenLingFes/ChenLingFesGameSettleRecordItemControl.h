...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMESETTLERECORDITEMCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1CC5A330)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMESETTLERECORDITEMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC5A3E0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMESETTLERECORDITEMCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1CC5A0E0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMESETTLERECORDITEMCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1CC59FC0)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameSettleRecordItemControl_TypeDefinitionIndex = 80016;
