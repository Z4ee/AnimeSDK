...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMESETTLERECORDITEMCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1A4A9EB0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMESETTLERECORDITEMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4A9F90)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMESETTLERECORDITEMCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1A4A9C60)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMESETTLERECORDITEMCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1A4A9B40)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameSettleRecordItemControl_TypeDefinitionIndex = 76383;
