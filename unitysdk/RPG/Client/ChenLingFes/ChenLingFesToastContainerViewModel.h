...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL_ADD_ONCLEARPENDINGTOASTQUEUE_OFFSET UNITYSDK_OFFSET(0x1B757160)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL_ADD_ONTOASTREQUEST_OFFSET UNITYSDK_OFFSET(0x1B757080)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0x1B747730)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL_GET_FEVERTOASTVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1B75BF70)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL_GET_OPENDAYSTARTTOASTVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1B75BF50)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL_GET_PREPARESTARTTOASTVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1B75BF30)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL_REGISTERNOTIFYHANDLERS_OFFSET UNITYSDK_OFFSET(0x1B7571C0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL_REMOVE_ONCLEARPENDINGTOASTQUEUE_OFFSET UNITYSDK_OFFSET(0x1B757100)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL_REMOVE_ONTOASTREQUEST_OFFSET UNITYSDK_OFFSET(0x1B757000)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL_SET_FEVERTOASTVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1B75BF80)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL_SET_OPENDAYSTARTTOASTVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1B75BF60)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL_SET_PREPARESTARTTOASTVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1B75BF40)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL_UNREGISTERNOTIFYHANDLERS_OFFSET UNITYSDK_OFFSET(0x1B75A110)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL__CANEMITFLYTOAST_OFFSET UNITYSDK_OFFSET(0x1B75AD30)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B75A780)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL__EMITUIDIALOGREQUEST_OFFSET UNITYSDK_OFFSET(0x1B75B610)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL__GETFLYTOASTMININTERVAL_OFFSET UNITYSDK_OFFSET(0x1B75B0C0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL__GETSPECIALSHOWCOINNUM_OFFSET UNITYSDK_OFFSET(0x1B75AE30)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL__INIT_OFFSET UNITYSDK_OFFSET(0x1B75A830)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL__ONDAYEND_OFFSET UNITYSDK_OFFSET(0x1B75B510)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL__ONFEVERUPDATE_OFFSET UNITYSDK_OFFSET(0x1B75AF50)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL__ONHIDEUIDIALOG_OFFSET UNITYSDK_OFFSET(0x1B75BA40)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL__ONSCOREUPDATE_OFFSET UNITYSDK_OFFSET(0x1B75AA40)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL__ONSHOWTOAST_OFFSET UNITYSDK_OFFSET(0x1B75B160)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL__ONSHOWUIDIALOG_OFFSET UNITYSDK_OFFSET(0x1B75B580)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL__ONSHOWUITOAST_OFFSET UNITYSDK_OFFSET(0x1B75BBE0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL__ONSWITCHDAY_OFFSET UNITYSDK_OFFSET(0x1B75B4A0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL__ONUPDATEUIDIALOG_OFFSET UNITYSDK_OFFSET(0x1B75B850)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL__TRYGETDIALOGPREFABPATH_OFFSET UNITYSDK_OFFSET(0x1B75B8E0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERVIEWMODEL__TRYGETTOASTPREFABPATH_OFFSET UNITYSDK_OFFSET(0x1B75BE80)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesToastContainerViewModel_TypeDefinitionIndex = 80081;

	class ChenLingFesToastContainerViewModel : public ::Sofa::BaseViewModel
	{
	public:
		::RPG::Client::ChenLingFes::ChenLingFesGameplayFeverViewModel* _FeverToastViewModel_k__BackingField; // 0x20
		...
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Single>* _LastFlyToastTriggerTimeByEntity; // 0x48
