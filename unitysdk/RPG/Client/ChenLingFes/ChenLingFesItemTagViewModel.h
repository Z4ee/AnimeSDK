...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMTAGVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0x1A4B4180)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMTAGVIEWMODEL_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x1A4DB900)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMTAGVIEWMODEL_GET_TAGUISTATE_OFFSET UNITYSDK_OFFSET(0x1A4DB9E0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMTAGVIEWMODEL_GET_TEXT_OFFSET UNITYSDK_OFFSET(0x1A4DB950)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMTAGVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4DBDA0)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesItemTagViewModel_TypeDefinitionIndex = 76415;
