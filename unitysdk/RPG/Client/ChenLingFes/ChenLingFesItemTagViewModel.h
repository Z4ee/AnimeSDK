...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMTAGVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0xCB46B20)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMTAGVIEWMODEL_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xCB72190)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMTAGVIEWMODEL_GET_TAGUISTATE_OFFSET UNITYSDK_OFFSET(0xCB72270)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMTAGVIEWMODEL_GET_TEXT_OFFSET UNITYSDK_OFFSET(0xCB721E0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMTAGVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xCB72840)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesItemTagViewModel_TypeDefinitionIndex = 80049;
