...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DBTNCONTAINERCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1AFF9210)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DBTNCONTAINERCONTROL_ONTICK_OFFSET UNITYSDK_OFFSET(0x1AFF8F20)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DBTNCONTAINERCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFF9C30)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DBTNCONTAINERCONTROL__GETORCREATEINCOMEPREVIEWCONTROL_OFFSET UNITYSDK_OFFSET(0x1AFF99F0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DBTNCONTAINERCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1AFF90C0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DBTNCONTAINERCONTROL__ONDATAPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1AFF93E0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DBTNCONTAINERCONTROL__ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1AFF9BC0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DBTNCONTAINERCONTROL__ONINCOMEPREVIEWVISIBLECHANGED_OFFSET UNITYSDK_OFFSET(0x1AFF92F0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DBTNCONTAINERCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1AFF9080)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DBTNCONTAINERCONTROL__RECYCLEALLACTIVEINCOMEPREVIEWCONTROLS_OFFSET UNITYSDK_OFFSET(0x1AFF9820)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DBTNCONTAINERCONTROL__REFRESHINCOMEPREVIEWCONTROLS_OFFSET UNITYSDK_OFFSET(0x1AFF95B0)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFes3DBtnContainerControl_TypeDefinitionIndex = 76335;
