...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DBTNCONTAINERCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xB5DF680)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DBTNCONTAINERCONTROL_ONTICK_OFFSET UNITYSDK_OFFSET(0xB5DF360)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DBTNCONTAINERCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xB5DFF50)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DBTNCONTAINERCONTROL__GETORCREATEINCOMEPREVIEWCONTROL_OFFSET UNITYSDK_OFFSET(0xB5DFD50)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DBTNCONTAINERCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xB5DF4F0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DBTNCONTAINERCONTROL__ONDATAPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0xB5DF800)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DBTNCONTAINERCONTROL__ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB5DFEE0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DBTNCONTAINERCONTROL__ONINCOMEPREVIEWVISIBLECHANGED_OFFSET UNITYSDK_OFFSET(0xB5DF700)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DBTNCONTAINERCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xB5DF4B0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DBTNCONTAINERCONTROL__RECYCLEALLACTIVEINCOMEPREVIEWCONTROLS_OFFSET UNITYSDK_OFFSET(0xB5DFBB0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DBTNCONTAINERCONTROL__REFRESHINCOMEPREVIEWCONTROLS_OFFSET UNITYSDK_OFFSET(0xB5DF920)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DBTNCONTAINERCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xB5E0080)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DBTNCONTAINERCONTROL___IFIXBASEPROXY__ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB5E00E0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DBTNCONTAINERCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xB5E0020)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFes3DBtnContainerControl_TypeDefinitionIndex = 73953;
