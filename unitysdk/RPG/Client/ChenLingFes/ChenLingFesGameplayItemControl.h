...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL_GETCENTERWORLDPOSITION_OFFSET UNITYSDK_OFFSET(0xCB44050)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCB44B20)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL_ISRAYCASTLOCATIONVALID_OFFSET UNITYSDK_OFFSET(0xCB46450)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL_PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0xCB43E00)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL_SETMESSAGER_OFFSET UNITYSDK_OFFSET(0xCB43DB0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__CANINTERACT_OFFSET UNITYSDK_OFFSET(0xCB45BA0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xCB464B0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCB44330)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__ONCLICKDETAIL_OFFSET UNITYSDK_OFFSET(0xCB45DF0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__ONCLICKROOT_OFFSET UNITYSDK_OFFSET(0xCB45AF0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__ONDATAPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0xCB45F20)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__ONDESTROY_OFFSET UNITYSDK_OFFSET(0xCB45910)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__ONENABLERAYCASTCHANGED_OFFSET UNITYSDK_OFFSET(0xCB46120)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xCB44180)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__ONSELECTHANDLER_OFFSET UNITYSDK_OFFSET(0xCB45EB0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0xCB43F90)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__REFRESHNAMETEXT_OFFSET UNITYSDK_OFFSET(0xCB44BD0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__SETUPRARITY_OFFSET UNITYSDK_OFFSET(0xCB45370)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__SETUPSTATES_OFFSET UNITYSDK_OFFSET(0xCB45550)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__SETUPTAGS_OFFSET UNITYSDK_OFFSET(0xCB44D40)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__TRYSHOWITEMDETAIL_OFFSET UNITYSDK_OFFSET(0xCB45C00)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameplayItemControl_TypeDefinitionIndex = 79986;
