...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL_GETCENTERWORLDPOSITION_OFFSET UNITYSDK_OFFSET(0x1A4B1D90)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1A4B2660)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL_ISRAYCASTLOCATIONVALID_OFFSET UNITYSDK_OFFSET(0x1A4B3AA0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL_PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0x1A4B1B40)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL_SETMESSAGER_OFFSET UNITYSDK_OFFSET(0x1A4B1AF0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__CANINTERACT_OFFSET UNITYSDK_OFFSET(0x1A4B3330)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4B3B00)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1A4B2070)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__ONCLICKDETAIL_OFFSET UNITYSDK_OFFSET(0x1A4B34D0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__ONCLICKROOT_OFFSET UNITYSDK_OFFSET(0x1A4B3280)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__ONDATAPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1A4B3600)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A4B30A0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__ONENABLERAYCASTCHANGED_OFFSET UNITYSDK_OFFSET(0x1A4B3800)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1A4B1EC0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__ONSELECTHANDLER_OFFSET UNITYSDK_OFFSET(0x1A4B3590)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0x1A4B1CD0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__REFRESHNAMETEXT_OFFSET UNITYSDK_OFFSET(0x1A4B2740)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__SETUPRARITY_OFFSET UNITYSDK_OFFSET(0x1A4B2D50)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__SETUPSTATES_OFFSET UNITYSDK_OFFSET(0x1A4B2EA0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__SETUPTAGS_OFFSET UNITYSDK_OFFSET(0x1A4B2820)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__TRYSHOWITEMDETAIL_OFFSET UNITYSDK_OFFSET(0x1A4B3390)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameplayItemControl_TypeDefinitionIndex = 76352;
