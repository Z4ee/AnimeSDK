...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL_GETCENTERWORLDPOSITION_OFFSET UNITYSDK_OFFSET(0xB5F84A0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xB5F90E0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL_ISRAYCASTLOCATIONVALID_OFFSET UNITYSDK_OFFSET(0xB5FA470)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL_PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0xB5F8200)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL_SETMESSAGER_OFFSET UNITYSDK_OFFSET(0xB5F81B0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__CANINTERACT_OFFSET UNITYSDK_OFFSET(0xB5F9E50)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xB5FA4D0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xB5F8970)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__ONCLICKDETAIL_OFFSET UNITYSDK_OFFSET(0xB5F9FE0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__ONCLICKROOT_OFFSET UNITYSDK_OFFSET(0xB5F9DA0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__ONDATAPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0xB5FA110)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB5F9B90)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__ONENABLERAYCASTCHANGED_OFFSET UNITYSDK_OFFSET(0xB5FA2B0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xB5F8590)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__ONSELECTHANDLER_OFFSET UNITYSDK_OFFSET(0xB5FA0A0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0xB5F8410)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__REFRESHNAMETEXT_OFFSET UNITYSDK_OFFSET(0xB5F9160)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__SETUPRARITY_OFFSET UNITYSDK_OFFSET(0xB5F9780)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__SETUPSTATES_OFFSET UNITYSDK_OFFSET(0xB5F9930)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__SETUPTAGS_OFFSET UNITYSDK_OFFSET(0xB5F9280)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL__TRYSHOWITEMDETAIL_OFFSET UNITYSDK_OFFSET(0xB5F9EB0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xB5FA560)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL___IFIXBASEPROXY__ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB5FA5C0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xB5FA500)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameplayItemControl_TypeDefinitionIndex = 73970;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET))(this);
		}

		::System::Void __iFixBaseProxy__OnBindViewModel()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET))(this);
		}

		::System::Void __iFixBaseProxy__OnDestroy()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYITEMCONTROL___IFIXBASEPROXY__ONDESTROY_OFFSET))(this);
		}
	};
}
