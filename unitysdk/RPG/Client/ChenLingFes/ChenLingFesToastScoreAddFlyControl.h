...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTSCOREADDFLYCONTROL_GETPREFABPATH_OFFSET UNITYSDK_OFFSET(0xCB76760)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTSCOREADDFLYCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xCB7B770)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTSCOREADDFLYCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCB7B610)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTSCOREADDFLYCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xCB7B590)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesToastScoreAddFlyControl_TypeDefinitionIndex = 80034;
