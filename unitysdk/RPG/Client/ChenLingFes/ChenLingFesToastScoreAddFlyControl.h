...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTSCOREADDFLYCONTROL_GETPREFABPATH_OFFSET UNITYSDK_OFFSET(0x1B759550)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTSCOREADDFLYCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B75E560)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTSCOREADDFLYCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1B75E400)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTSCOREADDFLYCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1B75E380)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesToastScoreAddFlyControl_TypeDefinitionIndex = 80033;
