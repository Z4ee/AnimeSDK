...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESFEVERPROGRESSLINECONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xB5E5FD0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESFEVERPROGRESSLINECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xB5E64C0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESFEVERPROGRESSLINECONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xB5E5D60)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESFEVERPROGRESSLINECONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xB5E5BC0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESFEVERPROGRESSLINECONTROL__ONVIEWMODELPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0xB5E60C0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESFEVERPROGRESSLINECONTROL__REFRESHPROGRESSWITHLERP_OFFSET UNITYSDK_OFFSET(0xB5E6190)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESFEVERPROGRESSLINECONTROL__REFRESHPROGRESS_OFFSET UNITYSDK_OFFSET(0xB5E6050)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESFEVERPROGRESSLINECONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xB5E6550)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESFEVERPROGRESSLINECONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xB5E64F0)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesFeverProgressLineControl_TypeDefinitionIndex = 73960;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_CHENLINGFES_CHENLINGFESFEVERPROGRESSLINECONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET))(this);
		}

		::System::Void __iFixBaseProxy__OnBindViewModel()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_CHENLINGFES_CHENLINGFESFEVERPROGRESSLINECONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET))(this);
		}
	};
}
