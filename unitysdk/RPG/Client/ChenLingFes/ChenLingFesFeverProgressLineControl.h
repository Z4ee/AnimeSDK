...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESFEVERPROGRESSLINECONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCB30DD0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESFEVERPROGRESSLINECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xCB314D0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESFEVERPROGRESSLINECONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCB30A10)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESFEVERPROGRESSLINECONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xCB308E0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESFEVERPROGRESSLINECONTROL__ONVIEWMODELPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0xCB30F40)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESFEVERPROGRESSLINECONTROL__REFRESHPROGRESSWITHLERP_OFFSET UNITYSDK_OFFSET(0xCB31080)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESFEVERPROGRESSLINECONTROL__REFRESHPROGRESS_OFFSET UNITYSDK_OFFSET(0xCB30ED0)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesFeverProgressLineControl_TypeDefinitionIndex = 79976;
