...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTITEMEFFECTCONTROL_GETHEIGHT_OFFSET UNITYSDK_OFFSET(0x1A4E3390)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTITEMEFFECTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4E3440)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTITEMEFFECTCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1A4E3300)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTITEMEFFECTCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1A4E3260)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesToastItemEffectControl_TypeDefinitionIndex = 76396;
