...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYGAMEDAYITEMVIEWMODEL_GET_DAYINDEX_OFFSET UNITYSDK_OFFSET(0xCB43860)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYGAMEDAYITEMVIEWMODEL_GET_DAYSTATE_OFFSET UNITYSDK_OFFSET(0xCB43400)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYGAMEDAYITEMVIEWMODEL_GET_ISCURDAY_OFFSET UNITYSDK_OFFSET(0xCB43440)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYGAMEDAYITEMVIEWMODEL_SET_DAYINDEX_OFFSET UNITYSDK_OFFSET(0xCB436B0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYGAMEDAYITEMVIEWMODEL_SET_DAYSTATE_OFFSET UNITYSDK_OFFSET(0xCB43740)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYGAMEDAYITEMVIEWMODEL_SET_ISCURDAY_OFFSET UNITYSDK_OFFSET(0xCB437D0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYGAMEDAYITEMVIEWMODEL_SYNC_OFFSET UNITYSDK_OFFSET(0xCB434B0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYGAMEDAYITEMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xCB438A0)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameplayGameDayItemViewModel_TypeDefinitionIndex = 80052;
