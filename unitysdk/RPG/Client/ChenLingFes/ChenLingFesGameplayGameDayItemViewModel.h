...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYGAMEDAYITEMVIEWMODEL_GET_DAYINDEX_OFFSET UNITYSDK_OFFSET(0x1A4B15A0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYGAMEDAYITEMVIEWMODEL_GET_DAYSTATE_OFFSET UNITYSDK_OFFSET(0x1A4B1140)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYGAMEDAYITEMVIEWMODEL_GET_ISCURDAY_OFFSET UNITYSDK_OFFSET(0x1A4B1180)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYGAMEDAYITEMVIEWMODEL_SET_DAYINDEX_OFFSET UNITYSDK_OFFSET(0x1A4B13F0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYGAMEDAYITEMVIEWMODEL_SET_DAYSTATE_OFFSET UNITYSDK_OFFSET(0x1A4B1480)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYGAMEDAYITEMVIEWMODEL_SET_ISCURDAY_OFFSET UNITYSDK_OFFSET(0x1A4B1510)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYGAMEDAYITEMVIEWMODEL_SYNC_OFFSET UNITYSDK_OFFSET(0x1A4B11F0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYGAMEDAYITEMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4B15E0)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameplayGameDayItemViewModel_TypeDefinitionIndex = 76418;

	class ChenLingFesGameplayGameDayItemViewModel : public ::Sofa::BaseViewModel
	{
	public:
		::System::Boolean _IsCurDay; // 0x20
		::System::Int32 _DayIndex; // 0x24
