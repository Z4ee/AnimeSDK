...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL_CLEARALLPERSISTENTDIALOGSBYENTITY_OFFSET UNITYSDK_OFFSET(0xB627E60)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL_GET_COINENDTRANSFORM_OFFSET UNITYSDK_OFFSET(0xB629150)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL_GET_FEVERENDTRANSFORM_OFFSET UNITYSDK_OFFSET(0xB629170)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL_GET_FEVERTOASTCONTROL_OFFSET UNITYSDK_OFFSET(0xB6291D0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL_GET_OPENDAYSTARTTOASTCONTROL_OFFSET UNITYSDK_OFFSET(0xB6291B0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL_GET_PREPARESTARTTOASTCONTROL_OFFSET UNITYSDK_OFFSET(0xB629190)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xB626280)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL_INITPOSITION_OFFSET UNITYSDK_OFFSET(0xB61B740)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL_ONRELEASETOPOOL_OFFSET UNITYSDK_OFFSET(0xB627970)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL_ONTICK_OFFSET UNITYSDK_OFFSET(0xB61E360)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL_SET_COINENDTRANSFORM_OFFSET UNITYSDK_OFFSET(0xB629160)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL_SET_FEVERENDTRANSFORM_OFFSET UNITYSDK_OFFSET(0xB629180)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL_SET_FEVERTOASTCONTROL_OFFSET UNITYSDK_OFFSET(0xB6291E0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL_SET_OPENDAYSTARTTOASTCONTROL_OFFSET UNITYSDK_OFFSET(0xB6291C0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL_SET_PREPARESTARTTOASTCONTROL_OFFSET UNITYSDK_OFFSET(0xB6291A0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__APPENDMOVEANIMATIONTOTARGET_OFFSET UNITYSDK_OFFSET(0xB628690)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__CREATECONTROLBYTYPE_OFFSET UNITYSDK_OFFSET(0xB628330)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__CREATETOASTITEMCONTROL_OFFSET UNITYSDK_OFFSET(0xB6273F0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xB6291F0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__GETORCREATEACTIVELIST_OFFSET UNITYSDK_OFFSET(0xB6270A0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__GETORCREATEPENDINGQUEUE_OFFSET UNITYSDK_OFFSET(0xB6269B0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__GETPERSISTENTDIALOGKEY_OFFSET UNITYSDK_OFFSET(0xB627910)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__GETPILEKEY_OFFSET UNITYSDK_OFFSET(0xB626950)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__GETTOASTPARENTTRANSFORM_OFFSET UNITYSDK_OFFSET(0xB6281C0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xB625BB0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__ONCLEARPENDINGTOASTQUEUE_OFFSET UNITYSDK_OFFSET(0xB628130)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB6288E0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xB625930)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__ONTOASTREQUEST_OFFSET UNITYSDK_OFFSET(0xB626680)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__REFRESHPILEDTOASTLAYOUT_OFFSET UNITYSDK_OFFSET(0xB627680)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__SHOULDTRACKASPERSISTENTDIALOG_OFFSET UNITYSDK_OFFSET(0xB6278A0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__SHOWREQUESTIMMEDIATELY_OFFSET UNITYSDK_OFFSET(0xB626C60)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__TRYDISPATCHTOASTQUEUE_OFFSET UNITYSDK_OFFSET(0xB626B30)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__TRYHIDEPERSISTENTDIALOG_OFFSET UNITYSDK_OFFSET(0xB6267C0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__TRYUPDATEPERSISTENTDIALOG_OFFSET UNITYSDK_OFFSET(0xB6271E0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__UPDATEPERSISTENTDIALOGPOSITIONS_OFFSET UNITYSDK_OFFSET(0xB624F00)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__UPDATEPILEMOVEANIMATIONS_OFFSET UNITYSDK_OFFSET(0xB6250E0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xB629680)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL___IFIXBASEPROXY__ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB6296E0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xB629620)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesToastContainerControl_TypeDefinitionIndex = 74010;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET))(this);
		}

		::System::Void __iFixBaseProxy__OnBindViewModel()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET))(this);
		}

		::System::Void __iFixBaseProxy__OnDestroy()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL___IFIXBASEPROXY__ONDESTROY_OFFSET))(this);
		}
	};
}
