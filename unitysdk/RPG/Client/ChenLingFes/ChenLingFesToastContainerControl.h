...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL_CLEARALLPERSISTENTDIALOGSBYENTITY_OFFSET UNITYSDK_OFFSET(0x1A4DF1C0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL_GET_COINENDTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1A4E04A0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL_GET_FEVERENDTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1A4E04C0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL_GET_FEVERTOASTCONTROL_OFFSET UNITYSDK_OFFSET(0x1A4E0520)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL_GET_OPENDAYSTARTTOASTCONTROL_OFFSET UNITYSDK_OFFSET(0x1A4E0500)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL_GET_PREPARESTARTTOASTCONTROL_OFFSET UNITYSDK_OFFSET(0x1A4E04E0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1A4DD2B0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL_INITPOSITION_OFFSET UNITYSDK_OFFSET(0x1A4D4190)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL_ONRELEASETOPOOL_OFFSET UNITYSDK_OFFSET(0x1A4DEC50)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL_ONTICK_OFFSET UNITYSDK_OFFSET(0x1A4D6C10)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL_SET_COINENDTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1A4E04B0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL_SET_FEVERENDTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1A4E04D0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL_SET_FEVERTOASTCONTROL_OFFSET UNITYSDK_OFFSET(0x1A4E0530)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL_SET_OPENDAYSTARTTOASTCONTROL_OFFSET UNITYSDK_OFFSET(0x1A4E0510)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL_SET_PREPARESTARTTOASTCONTROL_OFFSET UNITYSDK_OFFSET(0x1A4E04F0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__APPENDMOVEANIMATIONTOTARGET_OFFSET UNITYSDK_OFFSET(0x1A4DFA50)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__CREATECONTROLBYTYPE_OFFSET UNITYSDK_OFFSET(0x1A4DF6C0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__CREATETOASTITEMCONTROL_OFFSET UNITYSDK_OFFSET(0x1A4DE5A0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4E0540)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__GETORCREATEACTIVELIST_OFFSET UNITYSDK_OFFSET(0x1A4DE1D0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__GETORCREATEPENDINGQUEUE_OFFSET UNITYSDK_OFFSET(0x1A4DDA40)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__GETPERSISTENTDIALOGKEY_OFFSET UNITYSDK_OFFSET(0x1A4DEBF0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__GETPILEKEY_OFFSET UNITYSDK_OFFSET(0x1A4DD9E0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__GETTOASTPARENTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1A4DF520)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1A4DCDC0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__ONCLEARPENDINGTOASTQUEUE_OFFSET UNITYSDK_OFFSET(0x1A4DF490)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A4DFD10)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1A4DCCB0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__ONTOASTREQUEST_OFFSET UNITYSDK_OFFSET(0x1A4DD710)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__REFRESHPILEDTOASTLAYOUT_OFFSET UNITYSDK_OFFSET(0x1A4DE830)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__SHOULDTRACKASPERSISTENTDIALOG_OFFSET UNITYSDK_OFFSET(0x1A4DEB80)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__SHOWREQUESTIMMEDIATELY_OFFSET UNITYSDK_OFFSET(0x1A4DDCF0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__TRYDISPATCHTOASTQUEUE_OFFSET UNITYSDK_OFFSET(0x1A4DDBC0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__TRYHIDEPERSISTENTDIALOG_OFFSET UNITYSDK_OFFSET(0x1A4DD850)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__TRYUPDATEPERSISTENTDIALOG_OFFSET UNITYSDK_OFFSET(0x1A4DE310)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__UPDATEPERSISTENTDIALOGPOSITIONS_OFFSET UNITYSDK_OFFSET(0x1A4DC180)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTCONTAINERCONTROL__UPDATEPILEMOVEANIMATIONS_OFFSET UNITYSDK_OFFSET(0x1A4DC3C0)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesToastContainerControl_TypeDefinitionIndex = 76392;
