...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYTARGETITEMCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1B7406C0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYTARGETITEMCONTROL_SHOWANIMREFRESH_OFFSET UNITYSDK_OFFSET(0x1B741530)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYTARGETITEMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7415A0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYTARGETITEMCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1B7405D0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYTARGETITEMCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1B740310)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYTARGETITEMCONTROL__SETUPSTAR_OFFSET UNITYSDK_OFFSET(0x1B741040)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYTARGETITEMCONTROL__SETUPSTATE_OFFSET UNITYSDK_OFFSET(0x1B740770)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYTARGETITEMCONTROL__SETUPTARGETSCORE_OFFSET UNITYSDK_OFFSET(0x1B741420)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYTARGETITEMCONTROL__SETUPTITLE_OFFSET UNITYSDK_OFFSET(0x1B741330)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameplayTargetItemControl_TypeDefinitionIndex = 80000;
