...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTINCOMECHANGECONTROL_GETHEIGHT_OFFSET UNITYSDK_OFFSET(0x1B75CF60)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTINCOMECHANGECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B75D090)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTINCOMECHANGECONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1B75CB20)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTINCOMECHANGECONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1B75CA60)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesToastIncomeChangeControl_TypeDefinitionIndex = 80028;
