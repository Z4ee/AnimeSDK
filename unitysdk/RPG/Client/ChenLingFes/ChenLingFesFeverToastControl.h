...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESFEVERTOASTCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1B000830)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESFEVERTOASTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B000C90)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESFEVERTOASTCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1B0006F0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESFEVERTOASTCONTROL__ONFADEINFINISHED_OFFSET UNITYSDK_OFFSET(0x1B000BE0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESFEVERTOASTCONTROL__ONFADEOUTFINISHED_OFFSET UNITYSDK_OFFSET(0x1B000C50)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESFEVERTOASTCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1B0004C0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESFEVERTOASTCONTROL__ONPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1B000910)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESFEVERTOASTCONTROL__REFRESHVISIBLE_OFFSET UNITYSDK_OFFSET(0x1B000A50)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesFeverToastControl_TypeDefinitionIndex = 76344;
