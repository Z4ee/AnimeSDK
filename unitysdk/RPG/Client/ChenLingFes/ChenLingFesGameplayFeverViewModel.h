...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYFEVERVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0xB5F5980)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYFEVERVIEWMODEL_GET_ISFEVERACTIVE_OFFSET UNITYSDK_OFFSET(0xB5F5D30)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYFEVERVIEWMODEL_GET_PROGRESSVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xB5F5D40)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYFEVERVIEWMODEL_SET_ISFEVERACTIVE_OFFSET UNITYSDK_OFFSET(0xB5F5CA0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYFEVERVIEWMODEL_SET_PROGRESSVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xB5F5D50)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYFEVERVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xB5F5A40)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYFEVERVIEWMODEL__INIT_OFFSET UNITYSDK_OFFSET(0xB5F5A60)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYFEVERVIEWMODEL__ONFEVERSWITCH_OFFSET UNITYSDK_OFFSET(0xB5F5B20)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameplayFeverViewModel_TypeDefinitionIndex = 74029;
	...
	public:
		...
		::System::Void _OnFeverSwitch(::Class_1_83665B095F1535B5_28* a1)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_83665B095F1535B5_28*))((::PBYTE)hIl2Cpp + RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYFEVERVIEWMODEL__ONFEVERSWITCH_OFFSET))(this, a1);
		}
