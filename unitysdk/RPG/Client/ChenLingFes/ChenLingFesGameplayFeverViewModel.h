...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYFEVERVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0x1B724260)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYFEVERVIEWMODEL_GET_ISFEVERACTIVE_OFFSET UNITYSDK_OFFSET(0x1B724190)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYFEVERVIEWMODEL_GET_PROGRESSVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1B724660)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYFEVERVIEWMODEL_SET_ISFEVERACTIVE_OFFSET UNITYSDK_OFFSET(0x1B7245D0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYFEVERVIEWMODEL_SET_PROGRESSVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1B724670)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYFEVERVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B724320)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYFEVERVIEWMODEL__INIT_OFFSET UNITYSDK_OFFSET(0x1B724340)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYFEVERVIEWMODEL__ONFEVERSWITCH_OFFSET UNITYSDK_OFFSET(0x1B724400)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameplayFeverViewModel_TypeDefinitionIndex = 80044;
