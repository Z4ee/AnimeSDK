...
class Class_1_83665B095F1535B5_30;
namespace RPG::Client::ChenLingFes { class ChenLingFesFeverProgressViewModel; }

#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYFEVERVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0xCB41520)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYFEVERVIEWMODEL_GET_ISFEVERACTIVE_OFFSET UNITYSDK_OFFSET(0xCB41450)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYFEVERVIEWMODEL_GET_PROGRESSVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCB41920)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYFEVERVIEWMODEL_SET_ISFEVERACTIVE_OFFSET UNITYSDK_OFFSET(0xCB41890)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYFEVERVIEWMODEL_SET_PROGRESSVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCB41930)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYFEVERVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xCB415E0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYFEVERVIEWMODEL__INIT_OFFSET UNITYSDK_OFFSET(0xCB41600)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYFEVERVIEWMODEL__ONFEVERSWITCH_OFFSET UNITYSDK_OFFSET(0xCB416C0)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameplayFeverViewModel_TypeDefinitionIndex = 80045;

	class ChenLingFesGameplayFeverViewModel : public ::Sofa::BaseViewModel
	{
	public:
		::RPG::Client::ChenLingFes::ChenLingFesFeverProgressViewModel* _ProgressViewModel_k__BackingField; // 0x20
		...
		::System::Void _OnFeverSwitch(::Class_1_83665B095F1535B5_30* a1)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_83665B095F1535B5_30*))((::PBYTE)hIl2Cpp + RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYFEVERVIEWMODEL__ONFEVERSWITCH_OFFSET))(this, a1);
		}
