...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCB352F0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xCB35C90)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCB35090)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTCONTROL__ONFADEINEND_OFFSET UNITYSDK_OFFSET(0xCB35AD0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTCONTROL__ONFADEOUTEND_OFFSET UNITYSDK_OFFSET(0xCB35B40)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xCB34E50)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTCONTROL__ONPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0xCB358D0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTCONTROL__REFRESHTEXT_OFFSET UNITYSDK_OFFSET(0xCB353A0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTCONTROL__REFRESHVISIBLE_OFFSET UNITYSDK_OFFSET(0xCB35570)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGamePhaseToastControl_TypeDefinitionIndex = 80036;
