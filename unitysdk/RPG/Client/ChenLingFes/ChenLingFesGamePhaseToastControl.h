...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1B0031C0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B003800)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1B003070)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTCONTROL__ONFADEINEND_OFFSET UNITYSDK_OFFSET(0x1B0036E0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTCONTROL__ONFADEOUTEND_OFFSET UNITYSDK_OFFSET(0x1B003750)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1B002E30)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTCONTROL__ONPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1B0034E0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTCONTROL__REFRESHTEXT_OFFSET UNITYSDK_OFFSET(0x1B0032A0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTCONTROL__REFRESHVISIBLE_OFFSET UNITYSDK_OFFSET(0x1B003350)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGamePhaseToastControl_TypeDefinitionIndex = 76402;
