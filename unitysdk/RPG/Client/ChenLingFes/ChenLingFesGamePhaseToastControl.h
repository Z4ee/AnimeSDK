...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xB5EA1A0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xB5EA740)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xB5E9F90)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTCONTROL__ONFADEINEND_OFFSET UNITYSDK_OFFSET(0xB5EA5D0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTCONTROL__ONFADEOUTEND_OFFSET UNITYSDK_OFFSET(0xB5EA640)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xB5E9CD0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTCONTROL__ONPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0xB5EA4C0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTCONTROL__REFRESHTEXT_OFFSET UNITYSDK_OFFSET(0xB5EA220)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTCONTROL__REFRESHVISIBLE_OFFSET UNITYSDK_OFFSET(0xB5EA2D0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xB5EA7D0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xB5EA770)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGamePhaseToastControl_TypeDefinitionIndex = 74020;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET))(this);
		}

		::System::Void __iFixBaseProxy__OnBindViewModel()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET))(this);
		}
	};
}
