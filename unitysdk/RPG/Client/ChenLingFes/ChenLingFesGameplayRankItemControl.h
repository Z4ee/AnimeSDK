...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL_GET_ISFIRSTSHOW_OFFSET UNITYSDK_OFFSET(0xCB4F530)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCB4F990)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL_RESETREFRESHANIMTOEND_OFFSET UNITYSDK_OFFSET(0xCB4E780)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL_SET_ISFIRSTSHOW_OFFSET UNITYSDK_OFFSET(0xCB4F540)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xCB50770)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL__INITVIEW_OFFSET UNITYSDK_OFFSET(0xCB4FA40)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL__ONANIMCALLBACK_OFFSET UNITYSDK_OFFSET(0xCB50350)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCB4F6C0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL__ONDESTROY_OFFSET UNITYSDK_OFFSET(0xCB50660)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xCB4F550)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL__ONITEMVIEWMODELPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0xCB500B0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL__REFRESHICONPATH_OFFSET UNITYSDK_OFFSET(0xCB503E0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL__REFRESHITEM_OFFSET UNITYSDK_OFFSET(0xCB50020)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL__REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xCB4FBF0)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameplayRankItemControl_TypeDefinitionIndex = 79991;
