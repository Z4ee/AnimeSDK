...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL_GET_ISFIRSTSHOW_OFFSET UNITYSDK_OFFSET(0x1A4BB6F0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1A4BBA40)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL_RESETREFRESHANIMTOEND_OFFSET UNITYSDK_OFFSET(0x1A4BA910)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL_SET_ISFIRSTSHOW_OFFSET UNITYSDK_OFFSET(0x1A4BB700)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4BC3A0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL__INITVIEW_OFFSET UNITYSDK_OFFSET(0x1A4BBB20)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL__ONANIMCALLBACK_OFFSET UNITYSDK_OFFSET(0x1A4BC0C0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1A4BB880)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL__ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A4BC290)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1A4BB710)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL__ONITEMVIEWMODELPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1A4BBEA0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL__REFRESHICONPATH_OFFSET UNITYSDK_OFFSET(0x1A4BC150)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL__REFRESHITEM_OFFSET UNITYSDK_OFFSET(0x1A4BBE10)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMCONTROL__REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x1A4BBC20)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameplayRankItemControl_TypeDefinitionIndex = 76357;
