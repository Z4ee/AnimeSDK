...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSCOREITEMCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1A4BFD80)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSCOREITEMCONTROL_SETENDPOSITION_OFFSET UNITYSDK_OFFSET(0x1A4BC7D0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSCOREITEMCONTROL__ADJUSTNODEFLY_OFFSET UNITYSDK_OFFSET(0x1A4C0440)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSCOREITEMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4C0700)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSCOREITEMCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1A4BFC20)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSCOREITEMCONTROL__ONDATAPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1A4C0200)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSCOREITEMCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1A4BFAE0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSCOREITEMCONTROL__REFRESHCOMPLETESTATE_OFFSET UNITYSDK_OFFSET(0x1A4BFF50)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSCOREITEMCONTROL__REFRESHPROGRESS_OFFSET UNITYSDK_OFFSET(0x1A4C00D0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSCOREITEMCONTROL__REFRESHTARGETSCORE_OFFSET UNITYSDK_OFFSET(0x1A4BFE60)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameplayScoreItemControl_TypeDefinitionIndex = 76359;
