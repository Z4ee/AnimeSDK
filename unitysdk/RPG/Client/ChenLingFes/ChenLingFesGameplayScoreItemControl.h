...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSCOREITEMCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCB54110)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSCOREITEMCONTROL_SETENDPOSITION_OFFSET UNITYSDK_OFFSET(0xCB50B80)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSCOREITEMCONTROL__ADJUSTNODEFLY_OFFSET UNITYSDK_OFFSET(0xCB547A0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSCOREITEMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xCB54A60)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSCOREITEMCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCB53FB0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSCOREITEMCONTROL__ONDATAPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0xCB54560)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSCOREITEMCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xCB53E70)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSCOREITEMCONTROL__REFRESHCOMPLETESTATE_OFFSET UNITYSDK_OFFSET(0xCB542B0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSCOREITEMCONTROL__REFRESHPROGRESS_OFFSET UNITYSDK_OFFSET(0xCB54430)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSCOREITEMCONTROL__REFRESHTARGETSCORE_OFFSET UNITYSDK_OFFSET(0xCB541C0)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameplayScoreItemControl_TypeDefinitionIndex = 79993;
