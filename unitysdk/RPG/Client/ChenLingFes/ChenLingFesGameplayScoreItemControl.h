...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSCOREITEMCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xB6073B0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSCOREITEMCONTROL_SETENDPOSITION_OFFSET UNITYSDK_OFFSET(0xB603CB0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSCOREITEMCONTROL__ADJUSTNODEFLY_OFFSET UNITYSDK_OFFSET(0xB6079A0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSCOREITEMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xB607C30)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSCOREITEMCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xB607200)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSCOREITEMCONTROL__ONDATAPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0xB607850)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSCOREITEMCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xB606F30)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSCOREITEMCONTROL__REFRESHCOMPLETESTATE_OFFSET UNITYSDK_OFFSET(0xB607540)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSCOREITEMCONTROL__REFRESHPROGRESS_OFFSET UNITYSDK_OFFSET(0xB607700)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSCOREITEMCONTROL__REFRESHTARGETSCORE_OFFSET UNITYSDK_OFFSET(0xB607420)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSCOREITEMCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xB607CC0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSCOREITEMCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xB607C60)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameplayScoreItemControl_TypeDefinitionIndex = 73977;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSCOREITEMCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET))(this);
		}

		::System::Void __iFixBaseProxy__OnBindViewModel()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSCOREITEMCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET))(this);
		}
	};
}
