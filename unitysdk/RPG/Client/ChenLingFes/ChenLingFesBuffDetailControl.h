...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1AFFC6E0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFFCE40)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1AFFC4C0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILCONTROL__ONBUFFITEMSCHANGED_OFFSET UNITYSDK_OFFSET(0x1AFFCA70)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILCONTROL__ONCLICKOUTSIDE_OFFSET UNITYSDK_OFFSET(0x1AFFC9C0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILCONTROL__ONDATAPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1AFFCAD0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILCONTROL__ONGETITEMBYINDEX_OFFSET UNITYSDK_OFFSET(0x1AFFCC20)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1AFFC2E0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILCONTROL__REFRESHLIST_OFFSET UNITYSDK_OFFSET(0x1AFFC8A0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILCONTROL__REFRESHVISIBLE_OFFSET UNITYSDK_OFFSET(0x1AFFC7C0)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesBuffDetailControl_TypeDefinitionIndex = 76337;
