...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xB5E2B90)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xB5E3340)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xB5E28C0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILCONTROL__ONBUFFITEMSCHANGED_OFFSET UNITYSDK_OFFSET(0xB5E2F90)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILCONTROL__ONCLICKOUTSIDE_OFFSET UNITYSDK_OFFSET(0xB5E2E80)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILCONTROL__ONDATAPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0xB5E2FF0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILCONTROL__ONGETITEMBYINDEX_OFFSET UNITYSDK_OFFSET(0xB5E3090)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xB5E2660)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILCONTROL__REFRESHLIST_OFFSET UNITYSDK_OFFSET(0xB5E2CD0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILCONTROL__REFRESHVISIBLE_OFFSET UNITYSDK_OFFSET(0xB5E2C10)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xB5E33D0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xB5E3370)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesBuffDetailControl_TypeDefinitionIndex = 73955;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET))(this);
		}

		::System::Void __iFixBaseProxy__OnBindViewModel()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET))(this);
		}
	};
}
