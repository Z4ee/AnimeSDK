...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSELECTPANELCONTROL___C__DISPLAYCLASS16_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B73B210)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYSELECTPANELCONTROL___C__DISPLAYCLASS16_0___ONTOGGLESELECTEXPANDED_B__0_OFFSET UNITYSDK_OFFSET(0x1B73C540)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameplaySelectPanelControl___c__DisplayClass16_0_TypeDefinitionIndex = 79997;
