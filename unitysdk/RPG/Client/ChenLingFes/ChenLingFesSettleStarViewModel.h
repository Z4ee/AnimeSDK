...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESSETTLESTARVIEWMODEL_GET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0x1A4DC140)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESSETTLESTARVIEWMODEL_SET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0x1A4DC150)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESSETTLESTARVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4DC160)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesSettleStarViewModel_TypeDefinitionIndex = 76443;
