...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESSETTLESTARVIEWMODEL_GET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0xB624EC0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESSETTLESTARVIEWMODEL_SET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0xB624ED0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESSETTLESTARVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xB624EE0)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesSettleStarViewModel_TypeDefinitionIndex = 74061;
