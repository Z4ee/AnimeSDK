...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKINFOCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1A4B9F60)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKINFOCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4BA9A0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKINFOCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1A4B9BD0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKINFOCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1A4B9B30)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKINFOCONTROL__ONRANKITEMSCHANGED_OFFSET UNITYSDK_OFFSET(0x1A4BA8B0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKINFOCONTROL__ONVIEWMODELPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1A4BA740)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKINFOCONTROL__REFRESHITEMS_OFFSET UNITYSDK_OFFSET(0x1A4BA040)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameplayRankInfoControl_TypeDefinitionIndex = 76358;
