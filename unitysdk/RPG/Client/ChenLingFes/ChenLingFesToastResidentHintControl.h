...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTRESIDENTHINTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4E3710)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTRESIDENTHINTCONTROL__FORMATDYNAMICVALUE_OFFSET UNITYSDK_OFFSET(0x1A4E3690)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTRESIDENTHINTCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1A4E34F0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTRESIDENTHINTCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1A4E3470)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesToastResidentHintControl_TypeDefinitionIndex = 76398;
