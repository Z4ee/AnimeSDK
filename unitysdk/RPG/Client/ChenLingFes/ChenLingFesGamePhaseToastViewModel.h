...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0xCB35CC0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTVIEWMODEL_GET_FINISHCOMMAND_OFFSET UNITYSDK_OFFSET(0xCB36190)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTVIEWMODEL_GET_ISSHOW_OFFSET UNITYSDK_OFFSET(0xCB35A50)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTVIEWMODEL_GET_TOASTSTRING_OFFSET UNITYSDK_OFFSET(0xCB35A90)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTVIEWMODEL_SETFINISHEDPROMISE_OFFSET UNITYSDK_OFFSET(0xCB35F50)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTVIEWMODEL_SET_FINISHCOMMAND_OFFSET UNITYSDK_OFFSET(0xCB361A0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTVIEWMODEL_SET_ISSHOW_OFFSET UNITYSDK_OFFSET(0xCB36120)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTVIEWMODEL_SET_TOASTSTRING_OFFSET UNITYSDK_OFFSET(0xCB35EC0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xCB35E90)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTVIEWMODEL__INIT_OFFSET UNITYSDK_OFFSET(0xCB35FA0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPHASETOASTVIEWMODEL__ONFINISH_OFFSET UNITYSDK_OFFSET(0xCB36070)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGamePhaseToastViewModel_TypeDefinitionIndex = 80080;
	...
	public:
		...
		::System::String* _ToastString; // 0x30
