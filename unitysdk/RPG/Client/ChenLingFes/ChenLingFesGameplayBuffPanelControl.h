...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYBUFFPANELCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1CC5AEB0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYBUFFPANELCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC5BA00)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYBUFFPANELCONTROL__ENSUREDETAILCONTROL_OFFSET UNITYSDK_OFFSET(0x1CC5B2D0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYBUFFPANELCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1CC5A730)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYBUFFPANELCONTROL__ONBUFFICONSCHANGED_OFFSET UNITYSDK_OFFSET(0x1CC5B500)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYBUFFPANELCONTROL__ONDETAILPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1CC5B560)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYBUFFPANELCONTROL__ONGETBUFFICONITEM_OFFSET UNITYSDK_OFFSET(0x1CC5B5C0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYBUFFPANELCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1CC5A550)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYBUFFPANELCONTROL__REFRESHICONLIST_OFFSET UNITYSDK_OFFSET(0x1CC5AF60)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameplayBuffPanelControl_TypeDefinitionIndex = 79973;
