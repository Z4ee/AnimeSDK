...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYBUFFPANELCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCB3BC70)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYBUFFPANELCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xCB3C7C0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYBUFFPANELCONTROL__ENSUREDETAILCONTROL_OFFSET UNITYSDK_OFFSET(0xCB3C090)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYBUFFPANELCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCB3B4F0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYBUFFPANELCONTROL__ONBUFFICONSCHANGED_OFFSET UNITYSDK_OFFSET(0xCB3C2C0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYBUFFPANELCONTROL__ONDETAILPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0xCB3C320)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYBUFFPANELCONTROL__ONGETBUFFICONITEM_OFFSET UNITYSDK_OFFSET(0xCB3C380)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYBUFFPANELCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xCB3B310)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYBUFFPANELCONTROL__REFRESHICONLIST_OFFSET UNITYSDK_OFFSET(0xCB3BD20)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameplayBuffPanelControl_TypeDefinitionIndex = 79974;
