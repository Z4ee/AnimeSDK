...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0x1B731F90)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMVIEWMODEL_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x1B733370)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMVIEWMODEL_GET_INCOME_OFFSET UNITYSDK_OFFSET(0x1B733060)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMVIEWMODEL_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x1B7330F0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMVIEWMODEL_GET_ITEMID_OFFSET UNITYSDK_OFFSET(0x1B732D30)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMVIEWMODEL_SETDATA_OFFSET UNITYSDK_OFFSET(0x1B732050)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMVIEWMODEL_SET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x1B733520)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMVIEWMODEL_SET_INCOME_OFFSET UNITYSDK_OFFSET(0x1B733590)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMVIEWMODEL_SET_INDEX_OFFSET UNITYSDK_OFFSET(0x1B733620)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMVIEWMODEL_SET_ITEMID_OFFSET UNITYSDK_OFFSET(0x1B733690)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7334F0)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameplayRankItemViewModel_TypeDefinitionIndex = 80054;
