...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0x1A4BB3D0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMVIEWMODEL_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x1A4BC250)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMVIEWMODEL_GET_INCOME_OFFSET UNITYSDK_OFFSET(0x1A4BC080)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMVIEWMODEL_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x1A4BC110)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMVIEWMODEL_GET_ITEMID_OFFSET UNITYSDK_OFFSET(0x1A4BBDD0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMVIEWMODEL_SETDATA_OFFSET UNITYSDK_OFFSET(0x1A4BB490)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMVIEWMODEL_SET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x1A4BC400)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMVIEWMODEL_SET_INCOME_OFFSET UNITYSDK_OFFSET(0x1A4BC490)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMVIEWMODEL_SET_INDEX_OFFSET UNITYSDK_OFFSET(0x1A4BC520)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMVIEWMODEL_SET_ITEMID_OFFSET UNITYSDK_OFFSET(0x1A4BC590)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYRANKITEMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4BC3D0)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameplayRankItemViewModel_TypeDefinitionIndex = 76421;
