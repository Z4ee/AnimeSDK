...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DINCOMEPREVIEWCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1AFFB3F0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DINCOMEPREVIEWCONTROL_ONTICK_OFFSET UNITYSDK_OFFSET(0x1AFF9020)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DINCOMEPREVIEWCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFFBD90)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DINCOMEPREVIEWCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1AFFB200)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DINCOMEPREVIEWCONTROL__ONDATAPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1AFFBBA0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DINCOMEPREVIEWCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1AFFB160)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DINCOMEPREVIEWCONTROL__REFRESHINCOME_OFFSET UNITYSDK_OFFSET(0x1AFFB4D0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DINCOMEPREVIEWCONTROL__UPDATESTATE_OFFSET UNITYSDK_OFFSET(0x1AFFBA10)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DINCOMEPREVIEWCONTROL__UPDATEVISIBILITY_OFFSET UNITYSDK_OFFSET(0x1AFFB930)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFES3DINCOMEPREVIEWCONTROL__UPDATEWORLDPOSITION_OFFSET UNITYSDK_OFFSET(0x1AFFB5C0)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFes3DIncomePreviewControl_TypeDefinitionIndex = 76336;
