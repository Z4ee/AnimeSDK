...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0x1CC4D1E0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILVIEWMODEL_GET_BUFFITEMS_OFFSET UNITYSDK_OFFSET(0x1CC4E0F0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILVIEWMODEL_GET_CLOSECOMMAND_OFFSET UNITYSDK_OFFSET(0x1CC4E0D0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILVIEWMODEL_GET_ISSHOW_OFFSET UNITYSDK_OFFSET(0x1CC4CDE0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILVIEWMODEL_REFRESHBUFFDATA_OFFSET UNITYSDK_OFFSET(0x1CC4D4D0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILVIEWMODEL_SET_CLOSECOMMAND_OFFSET UNITYSDK_OFFSET(0x1CC4E0E0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILVIEWMODEL_SET_ISSHOW_OFFSET UNITYSDK_OFFSET(0x1CC4DA10)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILVIEWMODEL__CONVERTPARAMLIST_OFFSET UNITYSDK_OFFSET(0x1CC4DD60)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC4D340)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILVIEWMODEL__INIT_OFFSET UNITYSDK_OFFSET(0x1CC4D400)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILVIEWMODEL__ONCLOSE_OFFSET UNITYSDK_OFFSET(0x1CC4D980)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesBuffDetailViewModel_TypeDefinitionIndex = 80039;
