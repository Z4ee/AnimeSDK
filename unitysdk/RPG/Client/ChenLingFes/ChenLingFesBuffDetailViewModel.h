...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0xCB2DC20)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILVIEWMODEL_GET_BUFFITEMS_OFFSET UNITYSDK_OFFSET(0xCB2EB30)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILVIEWMODEL_GET_CLOSECOMMAND_OFFSET UNITYSDK_OFFSET(0xCB2EB10)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILVIEWMODEL_GET_ISSHOW_OFFSET UNITYSDK_OFFSET(0xCB2D820)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILVIEWMODEL_REFRESHBUFFDATA_OFFSET UNITYSDK_OFFSET(0xCB2DF10)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILVIEWMODEL_SET_CLOSECOMMAND_OFFSET UNITYSDK_OFFSET(0xCB2EB20)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILVIEWMODEL_SET_ISSHOW_OFFSET UNITYSDK_OFFSET(0xCB2E450)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILVIEWMODEL__CONVERTPARAMLIST_OFFSET UNITYSDK_OFFSET(0xCB2E7A0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xCB2DD80)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILVIEWMODEL__INIT_OFFSET UNITYSDK_OFFSET(0xCB2DE40)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFDETAILVIEWMODEL__ONCLOSE_OFFSET UNITYSDK_OFFSET(0xCB2E3C0)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesBuffDetailViewModel_TypeDefinitionIndex = 80040;
