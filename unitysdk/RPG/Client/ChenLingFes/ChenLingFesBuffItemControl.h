...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFITEMCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1AFFE420)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFITEMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFFE660)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFITEMCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1AFFE160)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFITEMCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1AFFE080)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesBuffItemControl_TypeDefinitionIndex = 76339;
