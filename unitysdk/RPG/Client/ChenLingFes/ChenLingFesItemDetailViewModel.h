...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMDETAILVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0x1A4CEEA0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMDETAILVIEWMODEL_GET_CLICKOUTSIDECOMMAND_OFFSET UNITYSDK_OFFSET(0x1A4DABE0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMDETAILVIEWMODEL_GET_DESCTEXT_OFFSET UNITYSDK_OFFSET(0x1A4D9BB0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMDETAILVIEWMODEL_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x1A4D8FC0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMDETAILVIEWMODEL_GET_ISSHOW_OFFSET UNITYSDK_OFFSET(0x1A4D0BC0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMDETAILVIEWMODEL_GET_NAMETEXT_OFFSET UNITYSDK_OFFSET(0x1A4D9B50)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMDETAILVIEWMODEL_GET_RARE_OFFSET UNITYSDK_OFFSET(0x1A4D9C10)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMDETAILVIEWMODEL_GET_TAGVIEWMODELS_OFFSET UNITYSDK_OFFSET(0x1A4DAC00)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMDETAILVIEWMODEL_SET_CLICKOUTSIDECOMMAND_OFFSET UNITYSDK_OFFSET(0x1A4DABF0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMDETAILVIEWMODEL_SET_ISSHOW_OFFSET UNITYSDK_OFFSET(0x1A4D0C00)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMDETAILVIEWMODEL_SYNC_OFFSET UNITYSDK_OFFSET(0x1A4D0C70)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMDETAILVIEWMODEL__BUILDPLACEGRIDROWS_OFFSET UNITYSDK_OFFSET(0x1A4D9DB0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMDETAILVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4D9CC0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMDETAILVIEWMODEL__INIT_OFFSET UNITYSDK_OFFSET(0x1A4D9CE0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMDETAILVIEWMODEL__ONCLICKOUTSIDE_OFFSET UNITYSDK_OFFSET(0x1A4DABA0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMDETAILVIEWMODEL___BUILDPLACEGRIDROWS_G__EXPANDBOUNDS_3_0_OFFSET UNITYSDK_OFFSET(0x1A4DAAA0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMDETAILVIEWMODEL___BUILDPLACEGRIDROWS_G__TOCELLKEY_3_1_OFFSET UNITYSDK_OFFSET(0x1A4DAAE0)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesItemDetailViewModel_TypeDefinitionIndex = 76434;
	...
	public:
		...
		::RPG::Client::ChenLingFes::ChenLingFesGameplayItemViewModel* ItemViewModel; // 0x30
		::System::Collections::Generic::List_1<::RPG::Client::ChenLingFes::ChenLingFesItemPlaceGridRowViewModel*>* PlaceGridRows; // 0x38
		::Sofa::Core::SimpleCommand* _ClickOutSideCommand_k__BackingField; // 0x40
