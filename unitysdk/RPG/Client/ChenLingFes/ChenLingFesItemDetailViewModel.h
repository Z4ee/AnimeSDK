...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMDETAILVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0xCB64B90)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMDETAILVIEWMODEL_GET_CLICKOUTSIDECOMMAND_OFFSET UNITYSDK_OFFSET(0xCB71060)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMDETAILVIEWMODEL_GET_DESCTEXT_OFFSET UNITYSDK_OFFSET(0xCB70030)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMDETAILVIEWMODEL_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xCB6F340)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMDETAILVIEWMODEL_GET_ISSHOW_OFFSET UNITYSDK_OFFSET(0xCB668A0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMDETAILVIEWMODEL_GET_NAMETEXT_OFFSET UNITYSDK_OFFSET(0xCB6FFD0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMDETAILVIEWMODEL_GET_RARE_OFFSET UNITYSDK_OFFSET(0xCB70090)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMDETAILVIEWMODEL_GET_TAGVIEWMODELS_OFFSET UNITYSDK_OFFSET(0xCB71080)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMDETAILVIEWMODEL_SET_CLICKOUTSIDECOMMAND_OFFSET UNITYSDK_OFFSET(0xCB71070)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMDETAILVIEWMODEL_SET_ISSHOW_OFFSET UNITYSDK_OFFSET(0xCB668E0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMDETAILVIEWMODEL_SYNC_OFFSET UNITYSDK_OFFSET(0xCB66950)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMDETAILVIEWMODEL__BUILDPLACEGRIDROWS_OFFSET UNITYSDK_OFFSET(0xCB70230)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMDETAILVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xCB70140)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMDETAILVIEWMODEL__INIT_OFFSET UNITYSDK_OFFSET(0xCB70160)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMDETAILVIEWMODEL__ONCLICKOUTSIDE_OFFSET UNITYSDK_OFFSET(0xCB71020)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMDETAILVIEWMODEL___BUILDPLACEGRIDROWS_G__EXPANDBOUNDS_3_0_OFFSET UNITYSDK_OFFSET(0xCB70F20)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMDETAILVIEWMODEL___BUILDPLACEGRIDROWS_G__TOCELLKEY_3_1_OFFSET UNITYSDK_OFFSET(0xCB70F60)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesItemDetailViewModel_TypeDefinitionIndex = 80068;
	...
	public:
		...
		::System::Collections::Generic::List_1<::RPG::Client::ChenLingFes::ChenLingFesItemPlaceGridRowViewModel*>* PlaceGridRows; // 0x28
