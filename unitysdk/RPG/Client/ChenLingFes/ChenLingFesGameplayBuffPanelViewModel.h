...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYBUFFPANELVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0x1A4AB1A0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYBUFFPANELVIEWMODEL_GET_BUFFICONS_OFFSET UNITYSDK_OFFSET(0x1A4AB910)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYBUFFPANELVIEWMODEL_GET_CLICKBUFFCOMMAND_OFFSET UNITYSDK_OFFSET(0x1A4AB8F0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYBUFFPANELVIEWMODEL_GET_DETAILVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1A4AB920)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYBUFFPANELVIEWMODEL_REFRESHBUFFDATA_OFFSET UNITYSDK_OFFSET(0x1A4AB510)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYBUFFPANELVIEWMODEL_SET_CLICKBUFFCOMMAND_OFFSET UNITYSDK_OFFSET(0x1A4AB900)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYBUFFPANELVIEWMODEL_SET_DETAILVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1A4AB930)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYBUFFPANELVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4AB310)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYBUFFPANELVIEWMODEL__INIT_OFFSET UNITYSDK_OFFSET(0x1A4AB3D0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYBUFFPANELVIEWMODEL__ONBUFFCHANGEMESSAGE_OFFSET UNITYSDK_OFFSET(0x1A4AB8A0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYBUFFPANELVIEWMODEL__ONCLICKBUFF_OFFSET UNITYSDK_OFFSET(0x1A4AB7C0)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameplayBuffPanelViewModel_TypeDefinitionIndex = 76409;

	class ChenLingFesGameplayBuffPanelViewModel : public ::Sofa::BaseViewModel
	{
	public:
		::Sofa::Core::SimpleCommand* _ClickBuffCommand_k__BackingField; // 0x20
		...
		::Sofa::Core::ObservableList_1<::RPG::Client::ChenLingFes::ChenLingFesBuffIconViewModel*>* _BuffIcons_k__BackingField; // 0x38
		...
		::System::Void _OnBuffChangeMessage(::Class_1_43BD383C98B4C0C5_218* a1)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_43BD383C98B4C0C5_218*))((::PBYTE)hIl2Cpp + RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYBUFFPANELVIEWMODEL__ONBUFFCHANGEMESSAGE_OFFSET))(this, a1);
		}
