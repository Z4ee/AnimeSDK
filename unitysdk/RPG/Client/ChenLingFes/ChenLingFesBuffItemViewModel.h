...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFITEMVIEWMODEL_GET_DESCTEXTID_OFFSET UNITYSDK_OFFSET(0x1AFFE700)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFITEMVIEWMODEL_GET_DESCTEXT_OFFSET UNITYSDK_OFFSET(0x1AFFE580)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFITEMVIEWMODEL_GET_ICONVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1AFFE690)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFITEMVIEWMODEL_GET_NAMETEXTID_OFFSET UNITYSDK_OFFSET(0x1AFFE6A0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFITEMVIEWMODEL_GET_NAMETEXT_OFFSET UNITYSDK_OFFSET(0x1AFFE500)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFITEMVIEWMODEL_GET_PARAMLIST_OFFSET UNITYSDK_OFFSET(0x1AFFE760)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFITEMVIEWMODEL_GET_SHOWSPLITLINE_OFFSET UNITYSDK_OFFSET(0x1AFFE620)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFITEMVIEWMODEL_SET_DESCTEXTID_OFFSET UNITYSDK_OFFSET(0x1AFFD8F0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFITEMVIEWMODEL_SET_NAMETEXTID_OFFSET UNITYSDK_OFFSET(0x1AFFD7C0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFITEMVIEWMODEL_SET_PARAMLIST_OFFSET UNITYSDK_OFFSET(0x1AFFDB50)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFITEMVIEWMODEL_SET_SHOWSPLITLINE_OFFSET UNITYSDK_OFFSET(0x1AFFDC90)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESBUFFITEMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFFD740)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesBuffItemViewModel_TypeDefinitionIndex = 76408;
