...
class Class_1_43BD383C98B4C0C5_248;
...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDWINDOW_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1CC53D30)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDWINDOW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC53370)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDWINDOW__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1CC53780)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDWINDOW__ONBUFFREWARDCLOSEMESSAGE_OFFSET UNITYSDK_OFFSET(0x1CC54340)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDWINDOW__ONDATAPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1CC53E80)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDWINDOW__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1CC53450)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDWINDOW__ONSTARTEXIT_OFFSET UNITYSDK_OFFSET(0x1CC53E30)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDWINDOW__REFRESHICON_OFFSET UNITYSDK_OFFSET(0x1CC541E0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDWINDOW__REFRESHTEXT_OFFSET UNITYSDK_OFFSET(0x1CC54020)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDWINDOW__REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x1CC53DE0)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameBuffRewardWindow_TypeDefinitionIndex = 80014;
	...
	public:
		...
		::UnityEngine::UI::Image* _ImageIcon; // 0x60
		...
		::System::Void _OnBuffRewardCloseMessage(::Class_1_43BD383C98B4C0C5_248* a1)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_43BD383C98B4C0C5_248*))((::PBYTE)hIl2Cpp + RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDWINDOW__ONBUFFREWARDCLOSEMESSAGE_OFFSET))(this, a1);
		}
