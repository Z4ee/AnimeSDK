...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDWINDOW_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCB34760)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDWINDOW__CTOR_OFFSET UNITYSDK_OFFSET(0xCB33DB0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDWINDOW__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCB341B0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDWINDOW__ONBUFFREWARDCLOSEMESSAGE_OFFSET UNITYSDK_OFFSET(0xCB34D70)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDWINDOW__ONDATAPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0xCB348B0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDWINDOW__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xCB33E90)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDWINDOW__ONSTARTEXIT_OFFSET UNITYSDK_OFFSET(0xCB34860)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDWINDOW__REFRESHICON_OFFSET UNITYSDK_OFFSET(0xCB34C10)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDWINDOW__REFRESHTEXT_OFFSET UNITYSDK_OFFSET(0xCB34A50)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEBUFFREWARDWINDOW__REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xCB34810)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameBuffRewardWindow_TypeDefinitionIndex = 80015;
