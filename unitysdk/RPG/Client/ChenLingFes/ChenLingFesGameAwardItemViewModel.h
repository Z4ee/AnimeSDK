...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEAWARDITEMVIEWMODEL_GET_DESC_OFFSET UNITYSDK_OFFSET(0xB5E8790)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEAWARDITEMVIEWMODEL_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xB5E89A0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEAWARDITEMVIEWMODEL_GET_STATESTR_OFFSET UNITYSDK_OFFSET(0xB5E89C0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEAWARDITEMVIEWMODEL_SET_STATESTR_OFFSET UNITYSDK_OFFSET(0xB5E89D0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEAWARDITEMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xB5E82B0)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameAwardItemViewModel_TypeDefinitionIndex = 74054;

	class ChenLingFesGameAwardItemViewModel : public ::Sofa::BaseViewModel
	{
	public:
		::System::String* _StateStr_k__BackingField; // 0x20
		::RPG::GameCore::ChenLingFesAwardTypeRow* _Row; // 0x28
