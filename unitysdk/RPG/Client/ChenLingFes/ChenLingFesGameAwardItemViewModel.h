...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEAWARDITEMVIEWMODEL_GET_DESC_OFFSET UNITYSDK_OFFSET(0xCB33920)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEAWARDITEMVIEWMODEL_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xCB33A70)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEAWARDITEMVIEWMODEL_GET_STATESTR_OFFSET UNITYSDK_OFFSET(0xCB33AC0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEAWARDITEMVIEWMODEL_SET_STATESTR_OFFSET UNITYSDK_OFFSET(0xCB33AD0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEAWARDITEMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xCB33380)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameAwardItemViewModel_TypeDefinitionIndex = 80070;
