...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESFEVERPROGRESSCONTROL_GET_NODEANCHOR_OFFSET UNITYSDK_OFFSET(0xCB2F930)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESFEVERPROGRESSCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCB2FEA0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESFEVERPROGRESSCONTROL_ONTICK_OFFSET UNITYSDK_OFFSET(0xCB301B0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESFEVERPROGRESSCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xCB308B0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESFEVERPROGRESSCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCB2F970)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESFEVERPROGRESSCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xCB2F850)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESFEVERPROGRESSCONTROL__ONVIEWMODELPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0xCB30460)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESFEVERPROGRESSCONTROL__REFRESHANIMSTATE_OFFSET UNITYSDK_OFFSET(0xCB2FF90)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesFeverProgressControl_TypeDefinitionIndex = 79977;
