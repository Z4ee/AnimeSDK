...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYGAMEDAYITEMCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1A4B0DF0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYGAMEDAYITEMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4B11C0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYGAMEDAYITEMCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1A4B0C30)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYGAMEDAYITEMCONTROL__ONDATAPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1A4B10E0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYGAMEDAYITEMCONTROL__ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A4B0FD0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYGAMEDAYITEMCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1A4B0B90)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYGAMEDAYITEMCONTROL__REFRESHSTATE_OFFSET UNITYSDK_OFFSET(0x1A4B0ED0)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameplayGameDayItemControl_TypeDefinitionIndex = 76355;
