...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTSUMMONCHENLINGCONTROL_GETHEIGHT_OFFSET UNITYSDK_OFFSET(0xCB7B9F0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTSUMMONCHENLINGCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xCB7BAA0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTSUMMONCHENLINGCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCB7B840)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESTOASTSUMMONCHENLINGCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xCB7B7A0)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesToastSummonChenLingControl_TypeDefinitionIndex = 80035;
