...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYTARGETDOTCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1B740230)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYTARGETDOTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7402E0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYTARGETDOTCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1B73FF00)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEPLAYTARGETDOTCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1B73FE80)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameplayTargetDotControl_TypeDefinitionIndex = 80001;
