...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMTAGCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1B754ED0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMTAGCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7551D0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMTAGCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1B754B60)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMTAGCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1B754AA0)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesItemTagControl_TypeDefinitionIndex = 80011;
