...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMTAGMINICONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCB72760)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMTAGMINICONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xCB72810)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMTAGMINICONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xCB724B0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESITEMTAGMINICONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xCB72410)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesItemTagMiniControl_TypeDefinitionIndex = 80011;
