...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESSELECTPANELLIGHTWEIGHTBRIDGE_ONENABLE_OFFSET UNITYSDK_OFFSET(0xB6249C0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESSELECTPANELLIGHTWEIGHTBRIDGE_ONLIGHTWEIGHTACTIVATE_OFFSET UNITYSDK_OFFSET(0xB624A50)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESSELECTPANELLIGHTWEIGHTBRIDGE_SETOWNER_OFFSET UNITYSDK_OFFSET(0xB624970)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESSELECTPANELLIGHTWEIGHTBRIDGE__CTOR_OFFSET UNITYSDK_OFFSET(0xB624AE0)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesSelectPanelLightweightBridge_TypeDefinitionIndex = 73983;
