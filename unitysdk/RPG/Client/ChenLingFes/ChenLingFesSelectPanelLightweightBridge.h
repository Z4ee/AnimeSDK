...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESSELECTPANELLIGHTWEIGHTBRIDGE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A4DBDC0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESSELECTPANELLIGHTWEIGHTBRIDGE_ONLIGHTWEIGHTACTIVATE_OFFSET UNITYSDK_OFFSET(0x1A4DBE50)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESSELECTPANELLIGHTWEIGHTBRIDGE_SETOWNER_OFFSET UNITYSDK_OFFSET(0x1A4C0DD0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESSELECTPANELLIGHTWEIGHTBRIDGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4DBEE0)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesSelectPanelLightweightBridge_TypeDefinitionIndex = 76365;
