...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEAWARDITEMCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1B001AB0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEAWARDITEMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B001CB0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEAWARDITEMCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1B0019B0)
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESGAMEAWARDITEMCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1B0018F0)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesGameAwardItemControl_TypeDefinitionIndex = 76379;
