...
#define RPG_CLIENT_CHENLINGFES_CHENLINGFESWEEKSETTLEVALUEVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xB62EBF0)

namespace RPG::Client::ChenLingFes
{
	inline static constexpr unsigned int ChenLingFesWeekSettleValueViewModel_TypeDefinitionIndex = 74063;
