...
#define RPG_CLIENT_EVOLVEBUILDTREASURESOLUTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B883CC0)

namespace RPG::Client
{
	inline static constexpr unsigned int EvolveBuildTreasureSolution_TypeDefinitionIndex = 63854;
