...
#define RPG_CLIENT_CINEMACHINEVIRTUALCAMERABINDINGMODEEXT_ACTIVE_OFFSET UNITYSDK_OFFSET(0xB6CABB0)
#define RPG_CLIENT_CINEMACHINEVIRTUALCAMERABINDINGMODEEXT_DEACTIVE_OFFSET UNITYSDK_OFFSET(0xB6CAC50)
#define RPG_CLIENT_CINEMACHINEVIRTUALCAMERABINDINGMODEEXT_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xB6C9EC0)
#define RPG_CLIENT_CINEMACHINEVIRTUALCAMERABINDINGMODEEXT_METHOD_5_0076C796B2045359_OFFSET UNITYSDK_OFFSET(0xB6CA140)
#define RPG_CLIENT_CINEMACHINEVIRTUALCAMERABINDINGMODEEXT_REFRESHVCAM_OFFSET UNITYSDK_OFFSET(0xB6C9F40)
#define RPG_CLIENT_CINEMACHINEVIRTUALCAMERABINDINGMODEEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xB6CACA0)

namespace RPG::Client
{
	inline static constexpr unsigned int CinemachineVirtualCameraBindingModeExt_TypeDefinitionIndex = 63909;
