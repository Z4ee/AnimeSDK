...
#define RPG_CLIENT_HITTIMESLOWCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17959280)

namespace RPG::Client
{
	inline static constexpr unsigned int HitTimeSlowConfig_TypeDefinitionIndex = 57377;
