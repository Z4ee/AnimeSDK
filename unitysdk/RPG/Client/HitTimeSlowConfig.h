...
#define RPG_CLIENT_HITTIMESLOWCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19824510)

namespace RPG::Client
{
	inline static constexpr unsigned int HitTimeSlowConfig_TypeDefinitionIndex = 60179;
