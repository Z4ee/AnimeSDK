...
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_CASTSINGLETARGET_OFFSET UNITYSDK_OFFSET(0xA9C8320)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_GET_TARGETGROUPID_OFFSET UNITYSDK_OFFSET(0xA9C8C50)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_GET_TARGETINSTANCEID_OFFSET UNITYSDK_OFFSET(0xA9C8C60)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_GET_TARGETTYPE_OFFSET UNITYSDK_OFFSET(0xA9C8C40)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_METHOD_6_00A4B38C951C5BD5_OFFSET UNITYSDK_OFFSET(0xA9C7B90)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_METHOD_6_0AB718BEE9EA06D7_OFFSET UNITYSDK_OFFSET(0xA9C8000)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_METHOD_6_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0xA9C7C60)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_METHOD_6_5022DB1DC5AA8CB4_OFFSET UNITYSDK_OFFSET(0xA9C7F10)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_METHOD_6_508D4DD02D3DB74E_OFFSET UNITYSDK_OFFSET(0xA9C8190)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_METHOD_6_8422ABC65E83BF12_OFFSET UNITYSDK_OFFSET(0xA9C7D70)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_METHOD_6_AB389C69D231955F_OFFSET UNITYSDK_OFFSET(0xA9C80F0)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_METHOD_6_C2B13F505CA2DA54_OFFSET UNITYSDK_OFFSET(0xA9C8940)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_METHOD_6_CEA992B6DEFDAF0A_OFFSET UNITYSDK_OFFSET(0xA9C7CC0)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_METHOD_6_E30A0CB4AE5808EA_OFFSET UNITYSDK_OFFSET(0xA9C87E0)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xA9C8BF0)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_OVERLAPPOINT_OFFSET UNITYSDK_OFFSET(0xA9C86C0)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_SETUPGEOMETRYREGION_OFFSET UNITYSDK_OFFSET(0xA9C7AD0)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER_TICK_OFFSET UNITYSDK_OFFSET(0xA9C8260)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0xA9C8C70)
#define RPG_CLIENT_MONOGEOMETRYTRIGGER___IFIXBASEPROXY_OVERLAPPOINT_OFFSET UNITYSDK_OFFSET(0xA9C8C80)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoGeometryTrigger_TypeDefinitionIndex = 63542;

	class MonoGeometryTrigger : public ::RPG::Client::BaseMonoTriggerRegion
	{
	public:
		::Class_0_16E4307DCC419505_888* Field_6_0; // 0x20
