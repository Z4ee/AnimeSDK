...
#define RPG_CLIENT_COLLIDERBUTTON_VOIDEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0xA0B0FB0)

namespace RPG::Client
{
	inline static constexpr unsigned int ColliderButton_VoidEvent_TypeDefinitionIndex = 66819;
