...
#define RPG_CLIENT_COLLIDERBUTTON_VOIDEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0xB6EEE20)

namespace RPG::Client
{
	inline static constexpr unsigned int ColliderButton_VoidEvent_TypeDefinitionIndex = 67759;
