...
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE_GET_PREVIOUSSIGNAL_OFFSET UNITYSDK_OFFSET(0x1AF84F10)
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE_METHOD_1_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0x1AF85550)
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE_METHOD_1_1524BBDF654AD3DF_OFFSET UNITYSDK_OFFSET(0x1AF853C0)
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE_METHOD_1_35C4A143193C04DA_OFFSET UNITYSDK_OFFSET(0x1AF85490)
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE_METHOD_1_35EA095E1AFDD9C8_OFFSET UNITYSDK_OFFSET(0x1AF854F0)
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE_METHOD_1_3BC8B8F2BB08C1C2_OFFSET UNITYSDK_OFFSET(0x1AF85670)
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE_METHOD_1_5CA8D2096F7CF3F5_OFFSET UNITYSDK_OFFSET(0x1AF84750)
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE_METHOD_1_6D723F32667667A4_OFFSET UNITYSDK_OFFSET(0x1AF84F30)
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE_METHOD_1_805C56F44231AEF9_OFFSET UNITYSDK_OFFSET(0x1AF84FC0)
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE_METHOD_1_908CDC094010F209_OFFSET UNITYSDK_OFFSET(0x1AF850B0)
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x1AF85610)
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE_METHOD_1_EBAF10BBA97B82DD_OFFSET UNITYSDK_OFFSET(0x1AF85AD0)
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE_SET_PREVIOUSSIGNAL_OFFSET UNITYSDK_OFFSET(0x1AF84F20)
#define RPG_CLIENT_SIGNALANIMATIONSTATEMACHINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF85F00)
