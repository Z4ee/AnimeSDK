...
#define RPG_CLIENT_ASSEMNPCCONFIG_METHOD_3_2C59D1D0CBDC6514_OFFSET UNITYSDK_OFFSET(0x1B32EE60)
#define RPG_CLIENT_ASSEMNPCCONFIG_METHOD_3_758732BD37F8618C_OFFSET UNITYSDK_OFFSET(0x1B32EC30)
#define RPG_CLIENT_ASSEMNPCCONFIG_METHOD_3_8217D0BE55D652BA_OFFSET UNITYSDK_OFFSET(0x1B32E620)
#define RPG_CLIENT_ASSEMNPCCONFIG_METHOD_3_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0x1B32F130)
#define RPG_CLIENT_ASSEMNPCCONFIG_METHOD_3_A74BD9120F7FD2AB_OFFSET UNITYSDK_OFFSET(0x1B32EA40)
#define RPG_CLIENT_ASSEMNPCCONFIG_METHOD_3_DB67EEFB041425EC_OFFSET UNITYSDK_OFFSET(0x1B32DD40)
#define RPG_CLIENT_ASSEMNPCCONFIG_METHOD_3_EAD10B3E55E2C4C5_OFFSET UNITYSDK_OFFSET(0x1B32D6A0)
#define RPG_CLIENT_ASSEMNPCCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B32F1C0)

namespace RPG::Client
{
	inline static constexpr unsigned int AssemNPCConfig_TypeDefinitionIndex = 60141;
