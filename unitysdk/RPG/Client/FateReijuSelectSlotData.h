...
#define RPG_CLIENT_FATEREIJUSELECTSLOTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x969AC00)

namespace RPG::Client
{
	inline static constexpr unsigned int FateReijuSelectSlotData_TypeDefinitionIndex = 52038;
