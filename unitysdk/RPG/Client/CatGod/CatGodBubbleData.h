...
#define RPG_CLIENT_CATGOD_CATGODBUBBLEDATA_GET_CURRENTCNT_OFFSET UNITYSDK_OFFSET(0x1AC5DFC0)
#define RPG_CLIENT_CATGOD_CATGODBUBBLEDATA_GET_TARGETCNT_OFFSET UNITYSDK_OFFSET(0x1AC5DFE0)
#define RPG_CLIENT_CATGOD_CATGODBUBBLEDATA_SET_CURRENTCNT_OFFSET UNITYSDK_OFFSET(0x1AC5DFD0)
#define RPG_CLIENT_CATGOD_CATGODBUBBLEDATA_SET_TARGETCNT_OFFSET UNITYSDK_OFFSET(0x1AC5DFF0)
#define RPG_CLIENT_CATGOD_CATGODBUBBLEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC5DFB0)

namespace RPG::Client::CatGod
{
	inline static constexpr unsigned int CatGodBubbleData_TypeDefinitionIndex = 76685;
