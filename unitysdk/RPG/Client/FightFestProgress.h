...
#define RPG_CLIENT_FIGHTFESTPROGRESS__CTOR_OFFSET UNITYSDK_OFFSET(0x73E20)

namespace RPG::Client
{
	inline static constexpr unsigned int FightFestProgress_TypeDefinitionIndex = 59061;
