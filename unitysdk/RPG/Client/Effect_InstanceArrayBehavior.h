...
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_GET__OWNER_OFFSET UNITYSDK_OFFSET(0x150F9970)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_METHOD_3_19FB5FBEA9EA66CD_OFFSET UNITYSDK_OFFSET(0x150FA220)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_METHOD_3_1BC539462B1DCAB4_OFFSET UNITYSDK_OFFSET(0x150F6160)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_METHOD_3_20CE56A09BD72B81_OFFSET UNITYSDK_OFFSET(0x150F9FE0)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_METHOD_3_36E2D900C7A8E114_OFFSET UNITYSDK_OFFSET(0x150FAA60)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_METHOD_3_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x150F7DB0)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0x150F7C30)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_METHOD_3_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0x150F7C90)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_METHOD_3_4343F372F34C05BF_3_OFFSET UNITYSDK_OFFSET(0x150F7CF0)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_METHOD_3_4343F372F34C05BF_4_OFFSET UNITYSDK_OFFSET(0x150F7D50)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_METHOD_3_4343F372F34C05BF_5_OFFSET UNITYSDK_OFFSET(0x150F7DF0)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x150F60F0)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_METHOD_3_8B5E3014AFF7F8EA_OFFSET UNITYSDK_OFFSET(0x150F61B0)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_METHOD_3_A21BBA85D4EF7B41_OFFSET UNITYSDK_OFFSET(0x150F7EB0)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_METHOD_3_B9117CCE8BC70D96_OFFSET UNITYSDK_OFFSET(0x150F99B0)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0x150F7E50)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x150FB020)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_InstanceArrayBehavior_TypeDefinitionIndex = 67449;
