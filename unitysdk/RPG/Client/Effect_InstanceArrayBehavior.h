...
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_GET__OWNER_OFFSET UNITYSDK_OFFSET(0x15E6ACF0)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_METHOD_3_19FB5FBEA9EA66CD_OFFSET UNITYSDK_OFFSET(0x15E6B5A0)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_METHOD_3_1BC539462B1DCAB4_OFFSET UNITYSDK_OFFSET(0x15E67510)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_METHOD_3_20CE56A09BD72B81_OFFSET UNITYSDK_OFFSET(0x15E6B360)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_METHOD_3_36E2D900C7A8E114_OFFSET UNITYSDK_OFFSET(0x15E6BDE0)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_METHOD_3_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x15E69130)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0x15E68FB0)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_METHOD_3_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0x15E69010)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_METHOD_3_4343F372F34C05BF_3_OFFSET UNITYSDK_OFFSET(0x15E69070)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_METHOD_3_4343F372F34C05BF_4_OFFSET UNITYSDK_OFFSET(0x15E690D0)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_METHOD_3_4343F372F34C05BF_5_OFFSET UNITYSDK_OFFSET(0x15E69170)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x15E674A0)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_METHOD_3_8B5E3014AFF7F8EA_OFFSET UNITYSDK_OFFSET(0x15E67560)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_METHOD_3_A21BBA85D4EF7B41_OFFSET UNITYSDK_OFFSET(0x15E69230)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_METHOD_3_B9117CCE8BC70D96_OFFSET UNITYSDK_OFFSET(0x15E6AD30)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0x15E691D0)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x15E6C3A0)
