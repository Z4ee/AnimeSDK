...
#define RPG_CLIENT_EFFECT_ABYSSSHINECONTROL_CREATECONTROLPOINT_OFFSET UNITYSDK_OFFSET(0xB83E4E0)
#define RPG_CLIENT_EFFECT_ABYSSSHINECONTROL_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xB83ECD0)
#define RPG_CLIENT_EFFECT_ABYSSSHINECONTROL_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0xB83F030)
#define RPG_CLIENT_EFFECT_ABYSSSHINECONTROL_SETDISTANCE_OFFSET UNITYSDK_OFFSET(0xB83E9F0)
#define RPG_CLIENT_EFFECT_ABYSSSHINECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xB83F260)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_AbyssShineControl_TypeDefinitionIndex = 65849;
