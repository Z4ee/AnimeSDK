...
#define RPG_CLIENT_PLANETFESBUFFSOURCE_CREATE_1_OFFSET UNITYSDK_OFFSET(0x1C364350)
#define RPG_CLIENT_PLANETFESBUFFSOURCE_CREATE_OFFSET UNITYSDK_OFFSET(0x1C3642C0)
#define RPG_CLIENT_PLANETFESBUFFSOURCE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C364430)
#define RPG_CLIENT_PLANETFESBUFFSOURCE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C3643A0)
#define RPG_CLIENT_PLANETFESBUFFSOURCE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C364500)
#define RPG_CLIENT_PLANETFESBUFFSOURCE_GET_ICON_OFFSET UNITYSDK_OFFSET(0x1C3647C0)
#define RPG_CLIENT_PLANETFESBUFFSOURCE_GET_ID_OFFSET UNITYSDK_OFFSET(0x1C364580)
#define RPG_CLIENT_PLANETFESBUFFSOURCE_GET_NAMETEXTID_OFFSET UNITYSDK_OFFSET(0x1C364750)
#define RPG_CLIENT_PLANETFESBUFFSOURCE_GET_SOURCETYPE_OFFSET UNITYSDK_OFFSET(0x1C364700)
#define RPG_CLIENT_PLANETFESBUFFSOURCE_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1C3645D0)
#define RPG_CLIENT_PLANETFESBUFFSOURCE_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1C3646A0)
#define RPG_CLIENT_PLANETFESBUFFSOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C364340)

namespace RPG::Client
{
	inline static constexpr unsigned int PlanetFesBuffSource_TypeDefinitionIndex = 66577;
