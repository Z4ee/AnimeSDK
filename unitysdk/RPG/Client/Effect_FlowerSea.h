...
#define RPG_CLIENT_EFFECT_FLOWERSEA_AWAKE_OFFSET UNITYSDK_OFFSET(0x954A1B0)
#define RPG_CLIENT_EFFECT_FLOWERSEA_LATETICK_OFFSET UNITYSDK_OFFSET(0x954B3E0)
#define RPG_CLIENT_EFFECT_FLOWERSEA_METHOD_5_81FEFD1B22CE37A2_OFFSET UNITYSDK_OFFSET(0x954B440)
#define RPG_CLIENT_EFFECT_FLOWERSEA_METHOD_5_B29205EE7F7B640C_OFFSET UNITYSDK_OFFSET(0x954A200)
#define RPG_CLIENT_EFFECT_FLOWERSEA_METHOD_5_F29D7A7F508EABE1_OFFSET UNITYSDK_OFFSET(0x954C000)
#define RPG_CLIENT_EFFECT_FLOWERSEA_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x954B350)
#define RPG_CLIENT_EFFECT_FLOWERSEA_ONENABLE_OFFSET UNITYSDK_OFFSET(0x954B1F0)
#define RPG_CLIENT_EFFECT_FLOWERSEA__CTOR_OFFSET UNITYSDK_OFFSET(0x954C1D0)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_FlowerSea_TypeDefinitionIndex = 57712;
