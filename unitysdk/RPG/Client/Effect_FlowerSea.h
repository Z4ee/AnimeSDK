...
#define RPG_CLIENT_EFFECT_FLOWERSEA_AWAKE_OFFSET UNITYSDK_OFFSET(0xA1CCDB0)
#define RPG_CLIENT_EFFECT_FLOWERSEA_LATETICK_OFFSET UNITYSDK_OFFSET(0xA1CDFE0)
#define RPG_CLIENT_EFFECT_FLOWERSEA_METHOD_5_81FEFD1B22CE37A2_OFFSET UNITYSDK_OFFSET(0xA1CE040)
#define RPG_CLIENT_EFFECT_FLOWERSEA_METHOD_5_B29205EE7F7B640C_OFFSET UNITYSDK_OFFSET(0xA1CCE00)
#define RPG_CLIENT_EFFECT_FLOWERSEA_METHOD_5_F29D7A7F508EABE1_OFFSET UNITYSDK_OFFSET(0xA1CEC00)
#define RPG_CLIENT_EFFECT_FLOWERSEA_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xA1CDF50)
#define RPG_CLIENT_EFFECT_FLOWERSEA_ONENABLE_OFFSET UNITYSDK_OFFSET(0xA1CDDF0)
#define RPG_CLIENT_EFFECT_FLOWERSEA__CTOR_OFFSET UNITYSDK_OFFSET(0xA1CEDD0)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_FlowerSea_TypeDefinitionIndex = 64976;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_EFFECT_FLOWERSEA_METHOD_5_F29D7A7F508EABE1_OFFSET))(this);
		}
	};
}
