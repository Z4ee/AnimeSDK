...
#define RPG_CLIENT_EFFECT_FLOWERSEA_AWAKE_OFFSET UNITYSDK_OFFSET(0xB84FFF0)
#define RPG_CLIENT_EFFECT_FLOWERSEA_LATETICK_OFFSET UNITYSDK_OFFSET(0xB851640)
#define RPG_CLIENT_EFFECT_FLOWERSEA_METHOD_5_0869E1192F8E01DF_OFFSET UNITYSDK_OFFSET(0xB852350)
#define RPG_CLIENT_EFFECT_FLOWERSEA_METHOD_5_81FEFD1B22CE37A2_OFFSET UNITYSDK_OFFSET(0xB8516A0)
#define RPG_CLIENT_EFFECT_FLOWERSEA_METHOD_5_B29205EE7F7B640C_OFFSET UNITYSDK_OFFSET(0xB850040)
#define RPG_CLIENT_EFFECT_FLOWERSEA_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xB8515B0)
#define RPG_CLIENT_EFFECT_FLOWERSEA_ONENABLE_OFFSET UNITYSDK_OFFSET(0xB851450)
#define RPG_CLIENT_EFFECT_FLOWERSEA__CTOR_OFFSET UNITYSDK_OFFSET(0xB852540)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_FlowerSea_TypeDefinitionIndex = 65902;
