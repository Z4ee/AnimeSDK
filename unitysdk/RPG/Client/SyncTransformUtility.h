...
#define RPG_CLIENT_SYNCTRANSFORMUTILITY_METHOD_6_E1579A152A3CF2C2_OFFSET UNITYSDK_OFFSET(0xC9B38B0)
#define RPG_CLIENT_SYNCTRANSFORMUTILITY_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xC9B3A10)
#define RPG_CLIENT_SYNCTRANSFORMUTILITY_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0xC9B3960)
#define RPG_CLIENT_SYNCTRANSFORMUTILITY_ONRECTTRANSFORMDIMENSIONSCHANGE_OFFSET UNITYSDK_OFFSET(0xC9B2E20)
#define RPG_CLIENT_SYNCTRANSFORMUTILITY__CTOR_OFFSET UNITYSDK_OFFSET(0xC9B3A80)
#define RPG_CLIENT_SYNCTRANSFORMUTILITY___IFIXBASEPROXY_ONRECTTRANSFORMDIMENSIONSCHANGE_OFFSET UNITYSDK_OFFSET(0xC9B3A90)

namespace RPG::Client
{
	inline static constexpr unsigned int SyncTransformUtility_TypeDefinitionIndex = 67901;
