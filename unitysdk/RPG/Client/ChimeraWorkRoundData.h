...
#define RPG_CLIENT_CHIMERAWORKROUNDDATA_GET_ARRANGEHINTIMAGE_OFFSET UNITYSDK_OFFSET(0x93DA490)
#define RPG_CLIENT_CHIMERAWORKROUNDDATA_GET_DISPLAYTEAMID_OFFSET UNITYSDK_OFFSET(0x93DA570)
#define RPG_CLIENT_CHIMERAWORKROUNDDATA_GET_ISSSR_OFFSET UNITYSDK_OFFSET(0x93DA390)
#define RPG_CLIENT_CHIMERAWORKROUNDDATA_GET_NEWCHIMERAIDARR_OFFSET UNITYSDK_OFFSET(0x93DA320)
#define RPG_CLIENT_CHIMERAWORKROUNDDATA_GET_OPTIONS_OFFSET UNITYSDK_OFFSET(0x93DA400)
#define RPG_CLIENT_CHIMERAWORKROUNDDATA_GET_RECOMMENDEDARRANGEMENTPRESETIDARR_OFFSET UNITYSDK_OFFSET(0x93DA500)
#define RPG_CLIENT_CHIMERAWORKROUNDDATA_GET_ROUNDID_OFFSET UNITYSDK_OFFSET(0x93DA240)
#define RPG_CLIENT_CHIMERAWORKROUNDDATA_GET_WARNINGTEXT_OFFSET UNITYSDK_OFFSET(0x93DA410)
#define RPG_CLIENT_CHIMERAWORKROUNDDATA_GET_WORKIDARR_OFFSET UNITYSDK_OFFSET(0x93DA2B0)
#define RPG_CLIENT_CHIMERAWORKROUNDDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0x93DA250)
#define RPG_CLIENT_CHIMERAWORKROUNDDATA_ISFINAL_OFFSET UNITYSDK_OFFSET(0x93DA920)
#define RPG_CLIENT_CHIMERAWORKROUNDDATA_ISINTUTORIALONACCELERATION_OFFSET UNITYSDK_OFFSET(0x93DA8C0)
#define RPG_CLIENT_CHIMERAWORKROUNDDATA_ISINTUTORIALONARRANGE_OFFSET UNITYSDK_OFFSET(0x93DA800)
#define RPG_CLIENT_CHIMERAWORKROUNDDATA_ISINTUTORIALONMISSION_OFFSET UNITYSDK_OFFSET(0x93DA860)
#define RPG_CLIENT_CHIMERAWORKROUNDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x93DA5E0)

namespace RPG::Client
{
	inline static constexpr unsigned int ChimeraWorkRoundData_TypeDefinitionIndex = 51575;
