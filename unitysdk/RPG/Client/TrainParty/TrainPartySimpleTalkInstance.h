...
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYSIMPLETALKINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0xCABE0D0)

namespace RPG::Client::TrainParty
{
	inline static constexpr unsigned int TrainPartySimpleTalkInstance_TypeDefinitionIndex = 69403;
