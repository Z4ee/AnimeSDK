...
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYMOVEGRIDCONTROLLER_MOVE_OFFSET UNITYSDK_OFFSET(0xB35A570)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYMOVEGRIDCONTROLLER_RESET_OFFSET UNITYSDK_OFFSET(0xB35A6C0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYMOVEGRIDCONTROLLER_SETMOVEFINISHCALLBACK_OFFSET UNITYSDK_OFFSET(0xB35A520)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYMOVEGRIDCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0xB35A2F0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYMOVEGRIDCONTROLLER_TESTMOVE_OFFSET UNITYSDK_OFFSET(0xB35A730)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYMOVEGRIDCONTROLLER_TESTRESET_OFFSET UNITYSDK_OFFSET(0xB35A790)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYMOVEGRIDCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xB35A380)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYMOVEGRIDCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB35A820)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYMOVEGRIDCONTROLLER__FINISHMOVE_OFFSET UNITYSDK_OFFSET(0xB35A4D0)

namespace RPG::Client::TrainParty
{
	inline static constexpr unsigned int TrainPartyMoveGridController_TypeDefinitionIndex = 68548;
