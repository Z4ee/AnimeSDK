...
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYMOVEGRIDCONTROLLER_MOVE_OFFSET UNITYSDK_OFFSET(0x1BDFBDC0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYMOVEGRIDCONTROLLER_RESET_OFFSET UNITYSDK_OFFSET(0x1BDFBF20)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYMOVEGRIDCONTROLLER_SETMOVEFINISHCALLBACK_OFFSET UNITYSDK_OFFSET(0x1BDFBD70)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYMOVEGRIDCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0x1BDFBB30)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYMOVEGRIDCONTROLLER_TESTMOVE_OFFSET UNITYSDK_OFFSET(0x1BDFBF90)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYMOVEGRIDCONTROLLER_TESTRESET_OFFSET UNITYSDK_OFFSET(0x1BDFBFF0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYMOVEGRIDCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1BDFBBC0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYMOVEGRIDCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDFC080)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYMOVEGRIDCONTROLLER__FINISHMOVE_OFFSET UNITYSDK_OFFSET(0x1BDFBD10)

namespace RPG::Client::TrainParty
{
	inline static constexpr unsigned int TrainPartyMoveGridController_TypeDefinitionIndex = 74180;
