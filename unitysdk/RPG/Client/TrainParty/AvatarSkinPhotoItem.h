...
#define RPG_CLIENT_TRAINPARTY_AVATARSKINPHOTOITEM_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A29C770)
#define RPG_CLIENT_TRAINPARTY_AVATARSKINPHOTOITEM_GETDETAILIMAGEPATH_OFFSET UNITYSDK_OFFSET(0x1A29C710)
#define RPG_CLIENT_TRAINPARTY_AVATARSKINPHOTOITEM_GETFILTERTYPEID_OFFSET UNITYSDK_OFFSET(0x1A29C7F0)
#define RPG_CLIENT_TRAINPARTY_AVATARSKINPHOTOITEM_GET_AVATARID_OFFSET UNITYSDK_OFFSET(0x1A29CA30)
#define RPG_CLIENT_TRAINPARTY_AVATARSKINPHOTOITEM_GET_PHOTOTYPE_OFFSET UNITYSDK_OFFSET(0x1A29C9E0)
#define RPG_CLIENT_TRAINPARTY_AVATARSKINPHOTOITEM_GET_RARITY_OFFSET UNITYSDK_OFFSET(0x1A29CA50)
#define RPG_CLIENT_TRAINPARTY_AVATARSKINPHOTOITEM_GET_REDDOTKEY_OFFSET UNITYSDK_OFFSET(0x1A29C970)
#define RPG_CLIENT_TRAINPARTY_AVATARSKINPHOTOITEM_GET__REDDOTIDS_OFFSET UNITYSDK_OFFSET(0x1A29C8F0)
#define RPG_CLIENT_TRAINPARTY_AVATARSKINPHOTOITEM_INITDATA_OFFSET UNITYSDK_OFFSET(0x1A29C370)
#define RPG_CLIENT_TRAINPARTY_AVATARSKINPHOTOITEM_SET_AVATARID_OFFSET UNITYSDK_OFFSET(0x1A29CA40)
#define RPG_CLIENT_TRAINPARTY_AVATARSKINPHOTOITEM_SET_RARITY_OFFSET UNITYSDK_OFFSET(0x1A29CA60)
#define RPG_CLIENT_TRAINPARTY_AVATARSKINPHOTOITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A29CA70)

namespace RPG::Client::TrainParty
{
	inline static constexpr unsigned int AvatarSkinPhotoItem_TypeDefinitionIndex = 70884;
	...
	public:
		...
		::Class_1_D17272E82AE804C2_272_Class_1_534EF681CC2FBEA4_Enum_3_0076592102B61814 get_PhotoType()
		{
			return ((::Class_1_D17272E82AE804C2_272_Class_1_534EF681CC2FBEA4_Enum_3_0076592102B61814(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_TRAINPARTY_AVATARSKINPHOTOITEM_GET_PHOTOTYPE_OFFSET))(this);
		}
