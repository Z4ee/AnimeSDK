...
#define RPG_CLIENT_TRAINPARTY_AVATARSKINPHOTOITEM_EQUALS_OFFSET UNITYSDK_OFFSET(0x1BDCE210)
#define RPG_CLIENT_TRAINPARTY_AVATARSKINPHOTOITEM_GETDETAILIMAGEPATH_OFFSET UNITYSDK_OFFSET(0x1BDCE1B0)
#define RPG_CLIENT_TRAINPARTY_AVATARSKINPHOTOITEM_GETFILTERTYPEID_OFFSET UNITYSDK_OFFSET(0x1BDCE290)
#define RPG_CLIENT_TRAINPARTY_AVATARSKINPHOTOITEM_GET_AVATARID_OFFSET UNITYSDK_OFFSET(0x1BDCE4D0)
#define RPG_CLIENT_TRAINPARTY_AVATARSKINPHOTOITEM_GET_PHOTOTYPE_OFFSET UNITYSDK_OFFSET(0x1BDCE480)
#define RPG_CLIENT_TRAINPARTY_AVATARSKINPHOTOITEM_GET_RARITY_OFFSET UNITYSDK_OFFSET(0x1BDCE4F0)
#define RPG_CLIENT_TRAINPARTY_AVATARSKINPHOTOITEM_GET_REDDOTKEY_OFFSET UNITYSDK_OFFSET(0x1BDCE410)
#define RPG_CLIENT_TRAINPARTY_AVATARSKINPHOTOITEM_GET__REDDOTIDS_OFFSET UNITYSDK_OFFSET(0x1BDCE390)
#define RPG_CLIENT_TRAINPARTY_AVATARSKINPHOTOITEM_INITDATA_OFFSET UNITYSDK_OFFSET(0x1BDCDE00)
#define RPG_CLIENT_TRAINPARTY_AVATARSKINPHOTOITEM_SET_AVATARID_OFFSET UNITYSDK_OFFSET(0x1BDCE4E0)
#define RPG_CLIENT_TRAINPARTY_AVATARSKINPHOTOITEM_SET_RARITY_OFFSET UNITYSDK_OFFSET(0x1BDCE500)
#define RPG_CLIENT_TRAINPARTY_AVATARSKINPHOTOITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDCE510)

namespace RPG::Client::TrainParty
{
	inline static constexpr unsigned int AvatarSkinPhotoItem_TypeDefinitionIndex = 74183;
	...
	public:
		...
		::System::UInt32 _AvatarID_k__BackingField; // 0x7C
		...
		{
			return ((::Class_1_D17272E82AE804C2_282_Class_1_534EF681CC2FBEA4_Enum_3_0076592102B61814(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_TRAINPARTY_AVATARSKINPHOTOITEM_GET_PHOTOTYPE_OFFSET))(this);
		}
