...
#define RPG_CLIENT_TRAINPARTY_LIGHTCONEPHOTOITEM_EQUALS_OFFSET UNITYSDK_OFFSET(0xCA8C9E0)
#define RPG_CLIENT_TRAINPARTY_LIGHTCONEPHOTOITEM_GETFILTERTYPEID_OFFSET UNITYSDK_OFFSET(0xCA8CA60)
#define RPG_CLIENT_TRAINPARTY_LIGHTCONEPHOTOITEM_GET_ISFARMABLE_OFFSET UNITYSDK_OFFSET(0xCA8CC30)
#define RPG_CLIENT_TRAINPARTY_LIGHTCONEPHOTOITEM_GET_PHOTOTYPE_OFFSET UNITYSDK_OFFSET(0xCA8CC00)
#define RPG_CLIENT_TRAINPARTY_LIGHTCONEPHOTOITEM_GET_RARITY_OFFSET UNITYSDK_OFFSET(0xCA8CC10)
#define RPG_CLIENT_TRAINPARTY_LIGHTCONEPHOTOITEM_GET_REDDOTKEY_OFFSET UNITYSDK_OFFSET(0xCA8CBC0)
#define RPG_CLIENT_TRAINPARTY_LIGHTCONEPHOTOITEM_GET__REDDOTIDS_OFFSET UNITYSDK_OFFSET(0xCA8CB40)
#define RPG_CLIENT_TRAINPARTY_LIGHTCONEPHOTOITEM_INITDATA_OFFSET UNITYSDK_OFFSET(0xCA8C7F0)
#define RPG_CLIENT_TRAINPARTY_LIGHTCONEPHOTOITEM_SET_ISFARMABLE_OFFSET UNITYSDK_OFFSET(0xCA8CC40)
#define RPG_CLIENT_TRAINPARTY_LIGHTCONEPHOTOITEM_SET_RARITY_OFFSET UNITYSDK_OFFSET(0xCA8CC20)
#define RPG_CLIENT_TRAINPARTY_LIGHTCONEPHOTOITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xCA8CC50)
#define RPG_CLIENT_TRAINPARTY_LIGHTCONEPHOTOITEM___IFIXBASEPROXY_EQUALS_OFFSET UNITYSDK_OFFSET(0xCA8CC70)
#define RPG_CLIENT_TRAINPARTY_LIGHTCONEPHOTOITEM___IFIXBASEPROXY_GETFILTERTYPEID_OFFSET UNITYSDK_OFFSET(0xCA8CC80)
#define RPG_CLIENT_TRAINPARTY_LIGHTCONEPHOTOITEM___IFIXBASEPROXY_INITDATA_OFFSET UNITYSDK_OFFSET(0xCA8CC60)

namespace RPG::Client::TrainParty
{
	inline static constexpr unsigned int LightConePhotoItem_TypeDefinitionIndex = 69364;
	...
	public:
		...
		{
			return ((::Class_1_D1E0AD3915BCCF29_24_Class_1_534EF681CC2FBEA4_Enum_3_0076592102B61814(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_TRAINPARTY_LIGHTCONEPHOTOITEM_GET_PHOTOTYPE_OFFSET))(this);
		}
		...
		{
			return ((::System::Boolean(*)(::PVOID, ::RPG::Client::TrainParty::TrainPartyBuildDIYItem*))((::PBYTE)hIl2Cpp + RPG_CLIENT_TRAINPARTY_LIGHTCONEPHOTOITEM___IFIXBASEPROXY_EQUALS_OFFSET))(this, a1);
		}

		::System::UInt32 __iFixBaseProxy_GetFilterTypeID(::RPG::Client::TrainParty::TrainPartyBuildDIYPhotoItemFilterType a1)
		{
			return ((::System::UInt32(*)(::PVOID, ::RPG::Client::TrainParty::TrainPartyBuildDIYPhotoItemFilterType))((::PBYTE)hIl2Cpp + RPG_CLIENT_TRAINPARTY_LIGHTCONEPHOTOITEM___IFIXBASEPROXY_GETFILTERTYPEID_OFFSET))(this, a1);
		}
	};
}
