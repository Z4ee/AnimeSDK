...
#define RPG_CLIENT_TRAINPARTY_LIGHTCONEPHOTOITEM_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A29D8C0)
#define RPG_CLIENT_TRAINPARTY_LIGHTCONEPHOTOITEM_GETFILTERTYPEID_OFFSET UNITYSDK_OFFSET(0x1A29D940)
#define RPG_CLIENT_TRAINPARTY_LIGHTCONEPHOTOITEM_GET_ISFARMABLE_OFFSET UNITYSDK_OFFSET(0x1A29DBB0)
#define RPG_CLIENT_TRAINPARTY_LIGHTCONEPHOTOITEM_GET_PHOTOTYPE_OFFSET UNITYSDK_OFFSET(0x1A29DB40)
#define RPG_CLIENT_TRAINPARTY_LIGHTCONEPHOTOITEM_GET_RARITY_OFFSET UNITYSDK_OFFSET(0x1A29DB90)
#define RPG_CLIENT_TRAINPARTY_LIGHTCONEPHOTOITEM_GET_REDDOTKEY_OFFSET UNITYSDK_OFFSET(0x1A29DAD0)
#define RPG_CLIENT_TRAINPARTY_LIGHTCONEPHOTOITEM_GET__REDDOTIDS_OFFSET UNITYSDK_OFFSET(0x1A29DA50)
#define RPG_CLIENT_TRAINPARTY_LIGHTCONEPHOTOITEM_INITDATA_OFFSET UNITYSDK_OFFSET(0x1A29D610)
#define RPG_CLIENT_TRAINPARTY_LIGHTCONEPHOTOITEM_SET_ISFARMABLE_OFFSET UNITYSDK_OFFSET(0x1A29DBC0)
#define RPG_CLIENT_TRAINPARTY_LIGHTCONEPHOTOITEM_SET_RARITY_OFFSET UNITYSDK_OFFSET(0x1A29DBA0)
#define RPG_CLIENT_TRAINPARTY_LIGHTCONEPHOTOITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A29DBD0)

namespace RPG::Client::TrainParty
{
	inline static constexpr unsigned int LightConePhotoItem_TypeDefinitionIndex = 70885;
	...
	public:
		...
		{
			return ((::Class_1_D17272E82AE804C2_272_Class_1_534EF681CC2FBEA4_Enum_3_0076592102B61814(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_TRAINPARTY_LIGHTCONEPHOTOITEM_GET_PHOTOTYPE_OFFSET))(this);
		}
