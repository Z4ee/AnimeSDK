...
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDIYITEM_CLEAR_OFFSET UNITYSDK_OFFSET(0xB339AA0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDIYITEM_GETTAGFLAG_OFFSET UNITYSDK_OFFSET(0xB339D50)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDIYITEM_GETTAGNAMETEXTIDLIST_OFFSET UNITYSDK_OFFSET(0xB339DF0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDIYITEM_GET_BELONGSLOTID_OFFSET UNITYSDK_OFFSET(0xB339F40)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDIYITEM_GET_BELONGSLOTINFO_OFFSET UNITYSDK_OFFSET(0xB339F90)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDIYITEM_GET_BGDESC_OFFSET UNITYSDK_OFFSET(0xB339FD0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDIYITEM_GET_FIGUREICONPATH_OFFSET UNITYSDK_OFFSET(0xB339FE0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDIYITEM_GET_FRAMEITEMRARITYPATH_OFFSET UNITYSDK_OFFSET(0xB339FF0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDIYITEM_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xB339FB0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDIYITEM_GET_ISNEW_OFFSET UNITYSDK_OFFSET(0xB33A010)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDIYITEM_GET_ITEMNAME_OFFSET UNITYSDK_OFFSET(0xB339FC0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDIYITEM_GET_TAGLIST_OFFSET UNITYSDK_OFFSET(0xB33A000)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDIYITEM_GET__TAGFLAG_OFFSET UNITYSDK_OFFSET(0xB33A1F0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDIYITEM_SETBELONGSLOTINFO_OFFSET UNITYSDK_OFFSET(0xB339DA0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDIYITEM_SET_BELONGSLOTINFO_OFFSET UNITYSDK_OFFSET(0xB339FA0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDIYITEM_SET_ISNEW_OFFSET UNITYSDK_OFFSET(0xB33A0B0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDIYITEM_SET__TAGFLAG_OFFSET UNITYSDK_OFFSET(0xB33A200)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDIYITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xB339D40)

namespace RPG::Client::TrainParty
{
	inline static constexpr unsigned int TrainPartyBuildDIYItem_TypeDefinitionIndex = 68576;

	class TrainPartyBuildDIYItem : public ::System::Object
	{
	public:
		::System::String* _IconPath; // 0x10
		::System::String* _FigureIconPath; // 0x18
		...
		::Il2CppArray<::System::UInt32>* _DisplayTagList; // 0x30
		::System::String* _FrameItemRarityPath; // 0x38
		::RPG::Client::TextID _ItemName; // 0x40
		::RPG::Client::TextID _BGDesc; // 0x50
		...
		::System::Void set__TagFlag(::System::Int32 value)
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32))((::PBYTE)hIl2Cpp + RPG_CLIENT_TRAINPARTY_TRAINPARTYBUILDDIYITEM_SET__TAGFLAG_OFFSET))(this, value);
		}
	};
}
