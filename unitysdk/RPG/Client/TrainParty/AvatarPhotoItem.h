...
#define RPG_CLIENT_TRAINPARTY_AVATARPHOTOITEM_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A29C070)
#define RPG_CLIENT_TRAINPARTY_AVATARPHOTOITEM_GETDETAILIMAGEPATH_OFFSET UNITYSDK_OFFSET(0x1A29BFF0)
#define RPG_CLIENT_TRAINPARTY_AVATARPHOTOITEM_GETFILTERTYPEID_OFFSET UNITYSDK_OFFSET(0x1A29C0F0)
#define RPG_CLIENT_TRAINPARTY_AVATARPHOTOITEM_GET_PHOTOTYPE_OFFSET UNITYSDK_OFFSET(0x1A29C2E0)
#define RPG_CLIENT_TRAINPARTY_AVATARPHOTOITEM_GET_RARITY_OFFSET UNITYSDK_OFFSET(0x1A29C330)
#define RPG_CLIENT_TRAINPARTY_AVATARPHOTOITEM_GET_REDDOTKEY_OFFSET UNITYSDK_OFFSET(0x1A29C270)
#define RPG_CLIENT_TRAINPARTY_AVATARPHOTOITEM_GET__REDDOTIDS_OFFSET UNITYSDK_OFFSET(0x1A29C1F0)
#define RPG_CLIENT_TRAINPARTY_AVATARPHOTOITEM_INITDATA_OFFSET UNITYSDK_OFFSET(0x1A29BD10)
#define RPG_CLIENT_TRAINPARTY_AVATARPHOTOITEM_SET_RARITY_OFFSET UNITYSDK_OFFSET(0x1A29C340)
#define RPG_CLIENT_TRAINPARTY_AVATARPHOTOITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A29C350)

namespace RPG::Client::TrainParty
{
	inline static constexpr unsigned int AvatarPhotoItem_TypeDefinitionIndex = 70883;
	...
	public:
		...
		{
			return ((::Class_1_D17272E82AE804C2_272_Class_1_534EF681CC2FBEA4_Enum_3_0076592102B61814(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_TRAINPARTY_AVATARPHOTOITEM_GET_PHOTOTYPE_OFFSET))(this);
		}
