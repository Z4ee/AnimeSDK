...
#define RPG_CLIENT_TRAINPARTY_AVATARPHOTOITEM_EQUALS_OFFSET UNITYSDK_OFFSET(0x1BDCDB00)
#define RPG_CLIENT_TRAINPARTY_AVATARPHOTOITEM_GETDETAILIMAGEPATH_OFFSET UNITYSDK_OFFSET(0x1BDCDA80)
#define RPG_CLIENT_TRAINPARTY_AVATARPHOTOITEM_GETFILTERTYPEID_OFFSET UNITYSDK_OFFSET(0x1BDCDB80)
#define RPG_CLIENT_TRAINPARTY_AVATARPHOTOITEM_GET_PHOTOTYPE_OFFSET UNITYSDK_OFFSET(0x1BDCDD70)
#define RPG_CLIENT_TRAINPARTY_AVATARPHOTOITEM_GET_RARITY_OFFSET UNITYSDK_OFFSET(0x1BDCDDC0)
#define RPG_CLIENT_TRAINPARTY_AVATARPHOTOITEM_GET_REDDOTKEY_OFFSET UNITYSDK_OFFSET(0x1BDCDD00)
#define RPG_CLIENT_TRAINPARTY_AVATARPHOTOITEM_GET__REDDOTIDS_OFFSET UNITYSDK_OFFSET(0x1BDCDC80)
#define RPG_CLIENT_TRAINPARTY_AVATARPHOTOITEM_INITDATA_OFFSET UNITYSDK_OFFSET(0x1BDCD7B0)
#define RPG_CLIENT_TRAINPARTY_AVATARPHOTOITEM_SET_RARITY_OFFSET UNITYSDK_OFFSET(0x1BDCDDD0)
#define RPG_CLIENT_TRAINPARTY_AVATARPHOTOITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDCDDE0)

namespace RPG::Client::TrainParty
{
	inline static constexpr unsigned int AvatarPhotoItem_TypeDefinitionIndex = 74182;
