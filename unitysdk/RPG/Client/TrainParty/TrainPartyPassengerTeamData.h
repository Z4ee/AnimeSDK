...
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERTEAMDATA_GETALLPASSENGERS_OFFSET UNITYSDK_OFFSET(0xA60BB40)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERTEAMDATA_GET_DEFAULTSKILLINFO_OFFSET UNITYSDK_OFFSET(0xA60BC80)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERTEAMDATA_GET_INITIALMEETINGSKILL_OFFSET UNITYSDK_OFFSET(0xA60BC60)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERTEAMDATA_GET_LEADERPASSENGER_OFFSET UNITYSDK_OFFSET(0xA60BBA0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERTEAMDATA_GET_LEADERWORKINGBUFFID_OFFSET UNITYSDK_OFFSET(0xA60BC40)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERTEAMDATA_GET_TEAMID_OFFSET UNITYSDK_OFFSET(0xA60BB80)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERTEAMDATA_GET_TEAMNAME_OFFSET UNITYSDK_OFFSET(0xA60BC10)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERTEAMDATA_GET_WORKINGBUFFROW_OFFSET UNITYSDK_OFFSET(0xA60BD50)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERTEAMDATA_SET_TEAMID_OFFSET UNITYSDK_OFFSET(0xA60BB90)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERTEAMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA60B7C0)

namespace RPG::Client::TrainParty
{
	inline static constexpr unsigned int TrainPartyPassengerTeamData_TypeDefinitionIndex = 61137;
