...
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERTEAMDATA_GETALLPASSENGERS_OFFSET UNITYSDK_OFFSET(0xCABAAC0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERTEAMDATA_GET_DEFAULTSKILLINFO_OFFSET UNITYSDK_OFFSET(0xCABABF0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERTEAMDATA_GET_INITIALMEETINGSKILL_OFFSET UNITYSDK_OFFSET(0xCABABD0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERTEAMDATA_GET_LEADERPASSENGER_OFFSET UNITYSDK_OFFSET(0xCABAB20)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERTEAMDATA_GET_LEADERWORKINGBUFFID_OFFSET UNITYSDK_OFFSET(0xCABABB0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERTEAMDATA_GET_TEAMID_OFFSET UNITYSDK_OFFSET(0xCABAB00)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERTEAMDATA_GET_TEAMNAME_OFFSET UNITYSDK_OFFSET(0xCABAB80)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERTEAMDATA_GET_WORKINGBUFFROW_OFFSET UNITYSDK_OFFSET(0xCABACC0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERTEAMDATA_SET_TEAMID_OFFSET UNITYSDK_OFFSET(0xCABAB10)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYPASSENGERTEAMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCABA8A0)

namespace RPG::Client::TrainParty
{
	inline static constexpr unsigned int TrainPartyPassengerTeamData_TypeDefinitionIndex = 69436;
