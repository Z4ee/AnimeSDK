...
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYRECORDINFO_GET_LOGCONTENT_OFFSET UNITYSDK_OFFSET(0xB361260)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYRECORDINFO_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xB3611B0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYRECORDINFO_GET_RECORDTYPE_OFFSET UNITYSDK_OFFSET(0xB361210)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYRECORDINFO_GET_REPLACEPARAMS_OFFSET UNITYSDK_OFFSET(0xB361280)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYRECORDINFO_RECORD_OFFSET UNITYSDK_OFFSET(0xB3525A0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYRECORDINFO_SET_LOGCONTENT_OFFSET UNITYSDK_OFFSET(0xB361270)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYRECORDINFO_SET_REPLACEPARAMS_OFFSET UNITYSDK_OFFSET(0xB361290)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYRECORDINFO_SYSTEM_ICOMPARABLE_RPG_CLIENT_TRAINPARTY_TRAINPARTYRECORDINFO__COMPARETO_OFFSET UNITYSDK_OFFSET(0xB361100)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYRECORDINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xB352CB0)

namespace RPG::Client::TrainParty
{
	inline static constexpr unsigned int TrainPartyRecordInfo_TypeDefinitionIndex = 68627;
