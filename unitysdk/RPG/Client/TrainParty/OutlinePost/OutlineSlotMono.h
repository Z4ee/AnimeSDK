...
#define RPG_CLIENT_TRAINPARTY_OUTLINEPOST_OUTLINESLOTMONO_METHOD_5_ADAFBB6E0E613B6C_OFFSET UNITYSDK_OFFSET(0x1BDD2560)
#define RPG_CLIENT_TRAINPARTY_OUTLINEPOST_OUTLINESLOTMONO_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1BDD2610)
#define RPG_CLIENT_TRAINPARTY_OUTLINEPOST_OUTLINESLOTMONO_START_OFFSET UNITYSDK_OFFSET(0x1BDD2310)
#define RPG_CLIENT_TRAINPARTY_OUTLINEPOST_OUTLINESLOTMONO__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDD2860)

namespace RPG::Client::TrainParty::OutlinePost
{
	inline static constexpr unsigned int OutlineSlotMono_TypeDefinitionIndex = 74269;
