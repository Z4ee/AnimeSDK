...
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYSIMPLETALKBGDATA_GET_BGCONFIGJSONPATH_OFFSET UNITYSDK_OFFSET(0xA60ED70)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYSIMPLETALKBGDATA_GET_BGIMAGEPATH_OFFSET UNITYSDK_OFFSET(0xA60ECA0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYSIMPLETALKBGDATA_GET_TRIGGERANIMATIONNAME_OFFSET UNITYSDK_OFFSET(0xA60EDE0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYSIMPLETALKBGDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xA60ED10)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYSIMPLETALKBGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA60EC90)

namespace RPG::Client::TrainParty
{
	inline static constexpr unsigned int TrainPartySimpleTalkBgData_TypeDefinitionIndex = 61101;
