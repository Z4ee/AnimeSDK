...
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYSIMPLETALKBGDATA_GET_BGCONFIGJSONPATH_OFFSET UNITYSDK_OFFSET(0x1988E5E0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYSIMPLETALKBGDATA_GET_BGIMAGEPATH_OFFSET UNITYSDK_OFFSET(0x1988E4E0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYSIMPLETALKBGDATA_GET_TRIGGERANIMATIONNAME_OFFSET UNITYSDK_OFFSET(0x1988E680)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYSIMPLETALKBGDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0x1988E580)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYSIMPLETALKBGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1988E4D0)

namespace RPG::Client::TrainParty
{
	inline static constexpr unsigned int TrainPartySimpleTalkBgData_TypeDefinitionIndex = 70921;
