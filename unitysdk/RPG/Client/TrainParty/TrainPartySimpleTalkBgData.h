...
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYSIMPLETALKBGDATA_GET_BGCONFIGJSONPATH_OFFSET UNITYSDK_OFFSET(0x1B29E2C0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYSIMPLETALKBGDATA_GET_BGIMAGEPATH_OFFSET UNITYSDK_OFFSET(0x1B29E1C0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYSIMPLETALKBGDATA_GET_TRIGGERANIMATIONNAME_OFFSET UNITYSDK_OFFSET(0x1B29E360)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYSIMPLETALKBGDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0x1B29E260)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYSIMPLETALKBGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B29E1B0)

namespace RPG::Client::TrainParty
{
	inline static constexpr unsigned int TrainPartySimpleTalkBgData_TypeDefinitionIndex = 74220;
