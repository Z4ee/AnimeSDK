...
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYSIMPLETALKINFO_CREATE_OFFSET UNITYSDK_OFFSET(0x1B29E470)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYSIMPLETALKINFO_GET_BGDATA_OFFSET UNITYSDK_OFFSET(0x1B29E5F0)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYSIMPLETALKINFO_GET_NEEDLOADAVATARPREFAB_OFFSET UNITYSDK_OFFSET(0x1B29E590)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYSIMPLETALKINFO_GET_REPLACEPARAMS_OFFSET UNITYSDK_OFFSET(0x1B29E610)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYSIMPLETALKINFO_GET_TALKCONTENT_OFFSET UNITYSDK_OFFSET(0x1B29E570)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYSIMPLETALKINFO_SET_BGDATA_OFFSET UNITYSDK_OFFSET(0x1B29E600)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYSIMPLETALKINFO_SET_REPLACEPARAMS_OFFSET UNITYSDK_OFFSET(0x1B29E620)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYSIMPLETALKINFO_SET_TALKCONTENT_OFFSET UNITYSDK_OFFSET(0x1B29E580)
#define RPG_CLIENT_TRAINPARTY_TRAINPARTYSIMPLETALKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B29E400)

namespace RPG::Client::TrainParty
{
	inline static constexpr unsigned int TrainPartySimpleTalkInfo_TypeDefinitionIndex = 74221;
