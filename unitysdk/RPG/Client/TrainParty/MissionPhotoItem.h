...
#define RPG_CLIENT_TRAINPARTY_MISSIONPHOTOITEM_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A29E9D0)
#define RPG_CLIENT_TRAINPARTY_MISSIONPHOTOITEM_GETFILTERTYPEID_OFFSET UNITYSDK_OFFSET(0x1A29EA50)
#define RPG_CLIENT_TRAINPARTY_MISSIONPHOTOITEM_GET_PHOTOTYPE_OFFSET UNITYSDK_OFFSET(0x1A29EBD0)
#define RPG_CLIENT_TRAINPARTY_MISSIONPHOTOITEM_GET_REDDOTKEY_OFFSET UNITYSDK_OFFSET(0x1A29EB60)
#define RPG_CLIENT_TRAINPARTY_MISSIONPHOTOITEM_GET__REDDOTIDS_OFFSET UNITYSDK_OFFSET(0x1A29EAE0)
#define RPG_CLIENT_TRAINPARTY_MISSIONPHOTOITEM_INITDATA_OFFSET UNITYSDK_OFFSET(0x1A29E820)
#define RPG_CLIENT_TRAINPARTY_MISSIONPHOTOITEM_SETGENDER_OFFSET UNITYSDK_OFFSET(0x1A29E7D0)
#define RPG_CLIENT_TRAINPARTY_MISSIONPHOTOITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A29EC20)

namespace RPG::Client::TrainParty
{
	inline static constexpr unsigned int MissionPhotoItem_TypeDefinitionIndex = 70886;
	...
	public:
		...
		{
			return ((::Class_1_D17272E82AE804C2_272_Class_1_534EF681CC2FBEA4_Enum_3_0076592102B61814(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_TRAINPARTY_MISSIONPHOTOITEM_GET_PHOTOTYPE_OFFSET))(this);
		}
	};
}
