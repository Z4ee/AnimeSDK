...
#define RPG_CLIENT_TRAINPARTY_MISSIONPHOTOITEM_EQUALS_OFFSET UNITYSDK_OFFSET(0x1BDD0490)
#define RPG_CLIENT_TRAINPARTY_MISSIONPHOTOITEM_GETFILTERTYPEID_OFFSET UNITYSDK_OFFSET(0x1BDD0510)
#define RPG_CLIENT_TRAINPARTY_MISSIONPHOTOITEM_GET_PHOTOTYPE_OFFSET UNITYSDK_OFFSET(0x1BDD0690)
#define RPG_CLIENT_TRAINPARTY_MISSIONPHOTOITEM_GET_REDDOTKEY_OFFSET UNITYSDK_OFFSET(0x1BDD0620)
#define RPG_CLIENT_TRAINPARTY_MISSIONPHOTOITEM_GET__REDDOTIDS_OFFSET UNITYSDK_OFFSET(0x1BDD05A0)
#define RPG_CLIENT_TRAINPARTY_MISSIONPHOTOITEM_INITDATA_OFFSET UNITYSDK_OFFSET(0x1BDD02E0)
#define RPG_CLIENT_TRAINPARTY_MISSIONPHOTOITEM_SETGENDER_OFFSET UNITYSDK_OFFSET(0x1BDD0290)
#define RPG_CLIENT_TRAINPARTY_MISSIONPHOTOITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDD06E0)

namespace RPG::Client::TrainParty
{
	inline static constexpr unsigned int MissionPhotoItem_TypeDefinitionIndex = 74185;
