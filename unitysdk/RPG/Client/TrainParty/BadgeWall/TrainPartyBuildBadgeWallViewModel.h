...
#define RPG_CLIENT_TRAINPARTY_BADGEWALL_TRAINPARTYBUILDBADGEWALLVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0x1BDCECC0)
#define RPG_CLIENT_TRAINPARTY_BADGEWALL_TRAINPARTYBUILDBADGEWALLVIEWMODEL_GET_DETAILVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1BDCF080)
#define RPG_CLIENT_TRAINPARTY_BADGEWALL_TRAINPARTYBUILDBADGEWALLVIEWMODEL_GET_SELECTEDSLOTID_OFFSET UNITYSDK_OFFSET(0x1BDCF0A0)
#define RPG_CLIENT_TRAINPARTY_BADGEWALL_TRAINPARTYBUILDBADGEWALLVIEWMODEL_GET_SLOTSVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1BDCF060)
#define RPG_CLIENT_TRAINPARTY_BADGEWALL_TRAINPARTYBUILDBADGEWALLVIEWMODEL_SET_DETAILVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1BDCF090)
#define RPG_CLIENT_TRAINPARTY_BADGEWALL_TRAINPARTYBUILDBADGEWALLVIEWMODEL_SET_SELECTEDSLOTID_OFFSET UNITYSDK_OFFSET(0x1BDCF0B0)
#define RPG_CLIENT_TRAINPARTY_BADGEWALL_TRAINPARTYBUILDBADGEWALLVIEWMODEL_SET_SLOTSVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1BDCF070)
#define RPG_CLIENT_TRAINPARTY_BADGEWALL_TRAINPARTYBUILDBADGEWALLVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1BDCF050)

namespace RPG::Client::TrainParty::BadgeWall
{
	inline static constexpr unsigned int TrainPartyBuildBadgeWallViewModel_TypeDefinitionIndex = 74280;
