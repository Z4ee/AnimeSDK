...
#define RPG_CLIENT_PLAYERRETURNTRIALAVATARHELPER_GETCURRENTUSINGGROUPID_OFFSET UNITYSDK_OFFSET(0x193918C0)
#define RPG_CLIENT_PLAYERRETURNTRIALAVATARHELPER_GETRETURNTRIALAVATARTEAMINDEX_OFFSET UNITYSDK_OFFSET(0x19391A10)
#define RPG_CLIENT_PLAYERRETURNTRIALAVATARHELPER_GETRETURNTRIALAVATAR_OFFSET UNITYSDK_OFFSET(0x19391B80)
#define RPG_CLIENT_PLAYERRETURNTRIALAVATARHELPER_GETTRIALAVATARGROUPIDLIST_OFFSET UNITYSDK_OFFSET(0x193916E0)
#define RPG_CLIENT_PLAYERRETURNTRIALAVATARHELPER_GETTRIALAVATARGROUP_OFFSET UNITYSDK_OFFSET(0x19391780)
#define RPG_CLIENT_PLAYERRETURNTRIALAVATARHELPER_HASRETURNTRIALAVATAR_OFFSET UNITYSDK_OFFSET(0x19391820)
#define RPG_CLIENT_PLAYERRETURNTRIALAVATARHELPER_ISRETURNTRIALAVATARFUNCTIONOPEN_OFFSET UNITYSDK_OFFSET(0x19391640)
#define RPG_CLIENT_PLAYERRETURNTRIALAVATARHELPER_ISSKIPCONFIRMDIALOG_OFFSET UNITYSDK_OFFSET(0x19391C90)
#define RPG_CLIENT_PLAYERRETURNTRIALAVATARHELPER_SETISSKIPCONFIRMDIALOG_OFFSET UNITYSDK_OFFSET(0x19391AB0)
#define RPG_CLIENT_PLAYERRETURNTRIALAVATARHELPER_SETUSINGGROUP_OFFSET UNITYSDK_OFFSET(0x19391950)
