...
#define RPG_CLIENT_PLAYERRETURNTRIALAVATARHELPER_GETCURRENTUSINGGROUPID_OFFSET UNITYSDK_OFFSET(0xDBB3760)
#define RPG_CLIENT_PLAYERRETURNTRIALAVATARHELPER_GETRETURNTRIALAVATARTEAMINDEX_OFFSET UNITYSDK_OFFSET(0xDBB38B0)
#define RPG_CLIENT_PLAYERRETURNTRIALAVATARHELPER_GETRETURNTRIALAVATAR_OFFSET UNITYSDK_OFFSET(0xDBB3A20)
#define RPG_CLIENT_PLAYERRETURNTRIALAVATARHELPER_GETTRIALAVATARGROUPIDLIST_OFFSET UNITYSDK_OFFSET(0xDBB3580)
#define RPG_CLIENT_PLAYERRETURNTRIALAVATARHELPER_GETTRIALAVATARGROUP_OFFSET UNITYSDK_OFFSET(0xDBB3620)
#define RPG_CLIENT_PLAYERRETURNTRIALAVATARHELPER_HASRETURNTRIALAVATAR_OFFSET UNITYSDK_OFFSET(0xDBB36C0)
#define RPG_CLIENT_PLAYERRETURNTRIALAVATARHELPER_ISRETURNTRIALAVATARFUNCTIONOPEN_OFFSET UNITYSDK_OFFSET(0xDBB34E0)
#define RPG_CLIENT_PLAYERRETURNTRIALAVATARHELPER_ISSKIPCONFIRMDIALOG_OFFSET UNITYSDK_OFFSET(0xDBB3B30)
#define RPG_CLIENT_PLAYERRETURNTRIALAVATARHELPER_SETISSKIPCONFIRMDIALOG_OFFSET UNITYSDK_OFFSET(0xDBB3950)
#define RPG_CLIENT_PLAYERRETURNTRIALAVATARHELPER_SETUSINGGROUP_OFFSET UNITYSDK_OFFSET(0xDBB37F0)
