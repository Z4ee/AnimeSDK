...
#define RPG_CLIENT_PLANETFESAVATARMOVETO_METHOD_3_5B19D22B475C30C1_OFFSET UNITYSDK_OFFSET(0x185EB9F0)
#define RPG_CLIENT_PLANETFESAVATARMOVETO_METHOD_3_C6A7ED31A42B57FD_OFFSET UNITYSDK_OFFSET(0x185EBA70)
#define RPG_CLIENT_PLANETFESAVATARMOVETO__CTOR_OFFSET UNITYSDK_OFFSET(0x185EBA40)

namespace RPG::Client
{
	inline static constexpr unsigned int PlanetFesAvatarMoveTo_TypeDefinitionIndex = 10151;
