...
#define RPG_CLIENT_EFFECT_KALEIDOSCOPEANIMATORBEHAVIOR___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x15E71D40)
#define RPG_CLIENT_EFFECT_KALEIDOSCOPEANIMATORBEHAVIOR___C__CTOR_OFFSET UNITYSDK_OFFSET(0x15E71D80)
#define RPG_CLIENT_EFFECT_KALEIDOSCOPEANIMATORBEHAVIOR___C___UPDATE_B__8_0_OFFSET UNITYSDK_OFFSET(0x15E71D90)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_KaleidoscopeAnimatorBehavior___c_TypeDefinitionIndex = 70458;
	...
	public:
		...
		{
			return (::System::Func_2<::RPG::Client::Effect_KaleidoscopeAnimatorBehavior_ParticleData*, ::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(Effect_KaleidoscopeAnimatorBehavior___c_TypeDefinitionIndex)->GetStaticField(0x608F0);
		}
		static ::RPG::Client::Effect_KaleidoscopeAnimatorBehavior___c** StaticGet___9()
		{
			return (::RPG::Client::Effect_KaleidoscopeAnimatorBehavior___c**)Il2CppClass::FromTypeDefinitionIndex(Effect_KaleidoscopeAnimatorBehavior___c_TypeDefinitionIndex)->GetStaticField(0x608F8);
		}
