...
namespace RPG::Client
{
	...
	public:
		...
		::System::Boolean __Update_b__8_0(::RPG::Client::Effect_KaleidoscopeAnimatorBehavior_ParticleData* p)
		{
			return ((::System::Boolean(*)(::PVOID, ::RPG::Client::Effect_KaleidoscopeAnimatorBehavior_ParticleData*))((::PBYTE)hIl2Cpp + RPG_CLIENT_EFFECT_KALEIDOSCOPEANIMATORBEHAVIOR___C___UPDATE_B__8_0_OFFSET))(this, p);
		}
	};
}
