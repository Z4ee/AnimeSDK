...
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_ENDOFLATETICK_OFFSET UNITYSDK_OFFSET(0xB47A730)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0xB47A330)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_1EA97511ABF2B3A7_OFFSET UNITYSDK_OFFSET(0xB47A530)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_2450CFC043E97F54_OFFSET UNITYSDK_OFFSET(0xB47E430)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0xB47A1F0)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xB47A490)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0xB47A370)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0xB47A3D0)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_4343F372F34C05BF_3_OFFSET UNITYSDK_OFFSET(0xB47A430)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_4343F372F34C05BF_4_OFFSET UNITYSDK_OFFSET(0xB47A4D0)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xB47A0F0)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_43E290A0B26B39F6_OFFSET UNITYSDK_OFFSET(0xB47BF60)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_5790A55946AA509D_1_OFFSET UNITYSDK_OFFSET(0xB47E6D0)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_5790A55946AA509D_2_OFFSET UNITYSDK_OFFSET(0xB47E730)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_5790A55946AA509D_3_OFFSET UNITYSDK_OFFSET(0xB47E790)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_5790A55946AA509D_4_OFFSET UNITYSDK_OFFSET(0xB47E7F0)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_5790A55946AA509D_5_OFFSET UNITYSDK_OFFSET(0xB47E860)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_5790A55946AA509D_6_OFFSET UNITYSDK_OFFSET(0xB47E940)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0xB47E670)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_693C4912BF61F072_OFFSET UNITYSDK_OFFSET(0xB47C020)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_7C2CABA4CB548A03_OFFSET UNITYSDK_OFFSET(0xB47D2D0)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xB47A150)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_A1ABB86FA403B48B_OFFSET UNITYSDK_OFFSET(0xB47CE40)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_BED9888991D99A89_OFFSET UNITYSDK_OFFSET(0xB47D380)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_E34EC5C56715D759_OFFSET UNITYSDK_OFFSET(0xB47D9C0)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_E80720BBCF7832DF_OFFSET UNITYSDK_OFFSET(0xB47C710)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_F0E307B84478A272_OFFSET UNITYSDK_OFFSET(0xB47E8D0)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0xB47E580)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0xB47E570)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR___IFIXBASEPROXY_ENDOFLATETICK_OFFSET UNITYSDK_OFFSET(0xB47E9A0)

namespace RPG::Client
{
	inline static constexpr unsigned int VirtualCameraFollowBehavior_TypeDefinitionIndex = 64848;
	...
	public:
		...
		{
			return (::Class_1_0A24888DF04C995E_3**)Il2CppClass::FromTypeDefinitionIndex(VirtualCameraFollowBehavior_TypeDefinitionIndex)->GetStaticField(0x35400);
		}
		static ::Class_1_0A24888DF04C995E_3** StaticGet_VCRect3()
		{
			return (::Class_1_0A24888DF04C995E_3**)Il2CppClass::FromTypeDefinitionIndex(VirtualCameraFollowBehavior_TypeDefinitionIndex)->GetStaticField(0x35408);
		}
		static ::Class_1_0A24888DF04C995E_3** StaticGet_VCRect1()
		{
			return (::Class_1_0A24888DF04C995E_3**)Il2CppClass::FromTypeDefinitionIndex(VirtualCameraFollowBehavior_TypeDefinitionIndex)->GetStaticField(0x35410);
		}
		static ::Class_1_0A24888DF04C995E_3** StaticGet_VCRect2()
		{
			return (::Class_1_0A24888DF04C995E_3**)Il2CppClass::FromTypeDefinitionIndex(VirtualCameraFollowBehavior_TypeDefinitionIndex)->GetStaticField(0x35418);
		}
