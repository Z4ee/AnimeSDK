...
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_ENDOFLATETICK_OFFSET UNITYSDK_OFFSET(0x1C80E630)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0x1C80E220)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_19171609D4441C30_OFFSET UNITYSDK_OFFSET(0x1C810D50)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x1C80E380)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0x1C80E260)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0x1C80E2C0)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_4343F372F34C05BF_3_OFFSET UNITYSDK_OFFSET(0x1C80E320)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_4343F372F34C05BF_4_OFFSET UNITYSDK_OFFSET(0x1C80E3C0)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_4343F372F34C05BF_5_OFFSET UNITYSDK_OFFSET(0x1C8120F0)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x1C80DF30)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_43E290A0B26B39F6_OFFSET UNITYSDK_OFFSET(0x1C80FEC0)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_693C4912BF61F072_OFFSET UNITYSDK_OFFSET(0x1C80FF80)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_7C2CABA4CB548A03_OFFSET UNITYSDK_OFFSET(0x1C8111B0)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_843619D883256BB2_OFFSET UNITYSDK_OFFSET(0x1C80E420)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_8C704EC832EDEFC8_OFFSET UNITYSDK_OFFSET(0x1C80E030)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x1C80DF90)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_BED9888991D99A89_OFFSET UNITYSDK_OFFSET(0x1C811260)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_E34EC5C56715D759_OFFSET UNITYSDK_OFFSET(0x1C811770)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_E80720BBCF7832DF_OFFSET UNITYSDK_OFFSET(0x1C810670)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C812240)
#define RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1C812230)

namespace RPG::Client
{
	inline static constexpr unsigned int VirtualCameraFollowBehavior_TypeDefinitionIndex = 70310;
	...
	public:
		...
		{
			return (::Class_1_0A24888DF04C995E_3**)Il2CppClass::FromTypeDefinitionIndex(VirtualCameraFollowBehavior_TypeDefinitionIndex)->GetStaticField(0x644B0);
		}
		static ::Class_1_0A24888DF04C995E_3** StaticGet_VCRect1()
		{
			return (::Class_1_0A24888DF04C995E_3**)Il2CppClass::FromTypeDefinitionIndex(VirtualCameraFollowBehavior_TypeDefinitionIndex)->GetStaticField(0x644B8);
		}
		static ::Class_1_0A24888DF04C995E_3** StaticGet_VCRect2()
		{
			return (::Class_1_0A24888DF04C995E_3**)Il2CppClass::FromTypeDefinitionIndex(VirtualCameraFollowBehavior_TypeDefinitionIndex)->GetStaticField(0x644C0);
		}
		static ::Class_1_0A24888DF04C995E_3** StaticGet_VCRect0()
		{
			return (::Class_1_0A24888DF04C995E_3**)Il2CppClass::FromTypeDefinitionIndex(VirtualCameraFollowBehavior_TypeDefinitionIndex)->GetStaticField(0x644C8);
		}
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_VIRTUALCAMERAFOLLOWBEHAVIOR_METHOD_3_8C704EC832EDEFC8_OFFSET))(this);
		}
