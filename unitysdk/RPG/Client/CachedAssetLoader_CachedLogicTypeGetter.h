...
#define RPG_CLIENT_CACHEDASSETLOADER_CACHEDLOGICTYPEGETTER_GET_OFFSET UNITYSDK_OFFSET(0x9217EE0)
#define RPG_CLIENT_CACHEDASSETLOADER_CACHEDLOGICTYPEGETTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x9219880)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Type*, ::RPG::Client::CachedAssetLogicType>**)Il2CppClass::FromTypeDefinitionIndex(CachedAssetLoader_CachedLogicTypeGetter_TypeDefinitionIndex)->GetStaticField(0x43FF0);
		}
