...
#define RPG_CLIENT_AVATAROUTFIT_PLAYEROUTFITSLOTTYPEFLAGS__GETENUMERATOR_D__2_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x181461C0)
#define RPG_CLIENT_AVATAROUTFIT_PLAYEROUTFITSLOTTYPEFLAGS__GETENUMERATOR_D__2_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_RPG_GAMECORE_PLAYEROUTFITSLOTTYPE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x181462B0)
#define RPG_CLIENT_AVATAROUTFIT_PLAYEROUTFITSLOTTYPEFLAGS__GETENUMERATOR_D__2_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x18146310)
#define RPG_CLIENT_AVATAROUTFIT_PLAYEROUTFITSLOTTYPEFLAGS__GETENUMERATOR_D__2_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x181462C0)
#define RPG_CLIENT_AVATAROUTFIT_PLAYEROUTFITSLOTTYPEFLAGS__GETENUMERATOR_D__2_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x181461B0)
#define RPG_CLIENT_AVATAROUTFIT_PLAYEROUTFITSLOTTYPEFLAGS__GETENUMERATOR_D__2__CTOR_OFFSET UNITYSDK_OFFSET(0x18145B50)

namespace RPG::Client
{
	inline static constexpr unsigned int AvatarOutfit_PlayerOutfitSlotTypeFlags__GetEnumerator_d__2_TypeDefinitionIndex = 59735;
