...
#define RPG_CLIENT_AVATAROUTFIT_PLAYEROUTFITSLOTTYPEFLAGS__GETENUMERATOR_D__2_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x914DE30)
#define RPG_CLIENT_AVATAROUTFIT_PLAYEROUTFITSLOTTYPEFLAGS__GETENUMERATOR_D__2_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_RPG_GAMECORE_PLAYEROUTFITSLOTTYPE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x914DEE0)
#define RPG_CLIENT_AVATAROUTFIT_PLAYEROUTFITSLOTTYPEFLAGS__GETENUMERATOR_D__2_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x914DF40)
#define RPG_CLIENT_AVATAROUTFIT_PLAYEROUTFITSLOTTYPEFLAGS__GETENUMERATOR_D__2_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x914DEF0)
#define RPG_CLIENT_AVATAROUTFIT_PLAYEROUTFITSLOTTYPEFLAGS__GETENUMERATOR_D__2_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x914DE20)
#define RPG_CLIENT_AVATAROUTFIT_PLAYEROUTFITSLOTTYPEFLAGS__GETENUMERATOR_D__2__CTOR_OFFSET UNITYSDK_OFFSET(0x914D8A0)

namespace RPG::Client
{
	inline static constexpr unsigned int AvatarOutfit_PlayerOutfitSlotTypeFlags__GetEnumerator_d__2_TypeDefinitionIndex = 50795;
	...
	public:
		...
		::RPG::GameCore::PlayerOutfitSlotType __2__current; // 0x18
		::RPG::Client::AvatarOutfit_PlayerOutfitSlotTypeFlags __4__this; // 0x20
