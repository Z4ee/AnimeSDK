...
#define RPG_CLIENT_GAMEFLOWMANAGER___C__DISPLAYCLASS8_0__CTOR_OFFSET UNITYSDK_OFFSET(0x975B6D0)
#define RPG_CLIENT_GAMEFLOWMANAGER___C__DISPLAYCLASS8_0__ENTERGAMEFLOW_B__0_OFFSET UNITYSDK_OFFSET(0x975BF00)

namespace RPG::Client
{
	inline static constexpr unsigned int GameFlowManager___c__DisplayClass8_0_TypeDefinitionIndex = 52238;
