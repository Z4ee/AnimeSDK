...
#define RPG_CLIENT_EFFECT_MATERIALPROPERTYSETTER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1510ADE0)
#define RPG_CLIENT_EFFECT_MATERIALPROPERTYSETTER_METHOD_5_3E522F4B992303E1_OFFSET UNITYSDK_OFFSET(0x1510AE50)
#define RPG_CLIENT_EFFECT_MATERIALPROPERTYSETTER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1510AD30)
#define RPG_CLIENT_EFFECT_MATERIALPROPERTYSETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1510B8F0)
