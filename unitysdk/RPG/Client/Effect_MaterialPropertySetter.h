...
#define RPG_CLIENT_EFFECT_MATERIALPROPERTYSETTER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x15E7C170)
#define RPG_CLIENT_EFFECT_MATERIALPROPERTYSETTER_METHOD_5_3E522F4B992303E1_OFFSET UNITYSDK_OFFSET(0x15E7C1E0)
#define RPG_CLIENT_EFFECT_MATERIALPROPERTYSETTER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x15E7C0C0)
#define RPG_CLIENT_EFFECT_MATERIALPROPERTYSETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x15E7CC60)
