...
#define RPG_CLIENT_PLANETFESINCOMECHANGEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x9F9B810)

namespace RPG::Client
{
	inline static constexpr unsigned int PlanetFesIncomeChangeEvent_TypeDefinitionIndex = 54212;
