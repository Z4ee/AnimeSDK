...
#define RPG_CLIENT_WOLFBROGUNPLAYTARGETACTIONCONFIG_SCATTERFIRE_METHOD_2_47FCE72550F759BF_OFFSET UNITYSDK_OFFSET(0xA794FB0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGETACTIONCONFIG_SCATTERFIRE_METHOD_2_F8B73ECE7F883AC1_OFFSET UNITYSDK_OFFSET(0xA795040)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGETACTIONCONFIG_SCATTERFIRE__CTOR_OFFSET UNITYSDK_OFFSET(0xA795030)

namespace RPG::Client
{
	inline static constexpr unsigned int WolfBroGunPlayTargetActionConfig_ScatterFire_TypeDefinitionIndex = 56112;
