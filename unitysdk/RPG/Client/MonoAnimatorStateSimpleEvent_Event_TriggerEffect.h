...
#define RPG_CLIENT_MONOANIMATORSTATESIMPLEEVENT_EVENT_TRIGGEREFFECT_METHOD_2_A13916F874030531_OFFSET UNITYSDK_OFFSET(0xA90E030)
#define RPG_CLIENT_MONOANIMATORSTATESIMPLEEVENT_EVENT_TRIGGEREFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xA90E3E0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoAnimatorStateSimpleEvent_Event_TriggerEffect_TypeDefinitionIndex = 63188;
