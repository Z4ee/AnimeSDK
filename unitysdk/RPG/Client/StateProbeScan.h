...
#define RPG_CLIENT_STATEPROBESCAN_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0x1A501DD0)
#define RPG_CLIENT_STATEPROBESCAN_ONSTATEEXIT_OFFSET UNITYSDK_OFFSET(0x1A501E80)
#define RPG_CLIENT_STATEPROBESCAN_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1A501F10)
#define RPG_CLIENT_STATEPROBESCAN__CTOR_OFFSET UNITYSDK_OFFSET(0x1A501F80)
