...
#define RPG_CLIENT_EFFECT_SPHEREVOLUMETRICLIGHTBEHAVIOR_EXECUTE_OFFSET UNITYSDK_OFFSET(0x95816F0)
#define RPG_CLIENT_EFFECT_SPHEREVOLUMETRICLIGHTBEHAVIOR_GET_CURRENTRENDERTEXTURE_OFFSET UNITYSDK_OFFSET(0x9581260)
#define RPG_CLIENT_EFFECT_SPHEREVOLUMETRICLIGHTBEHAVIOR_GET_KEY_OFFSET UNITYSDK_OFFSET(0x95816E0)
#define RPG_CLIENT_EFFECT_SPHEREVOLUMETRICLIGHTBEHAVIOR_GET_VOLUMETRICLIGHTMATERIAL_OFFSET UNITYSDK_OFFSET(0x9581250)
#define RPG_CLIENT_EFFECT_SPHEREVOLUMETRICLIGHTBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0x9581510)
#define RPG_CLIENT_EFFECT_SPHEREVOLUMETRICLIGHTBEHAVIOR_METHOD_3_0EFB186E18464702_OFFSET UNITYSDK_OFFSET(0x9581630)
#define RPG_CLIENT_EFFECT_SPHEREVOLUMETRICLIGHTBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0x9584340)
#define RPG_CLIENT_EFFECT_SPHEREVOLUMETRICLIGHTBEHAVIOR_METHOD_3_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0x95843B0)
#define RPG_CLIENT_EFFECT_SPHEREVOLUMETRICLIGHTBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x95842E0)
#define RPG_CLIENT_EFFECT_SPHEREVOLUMETRICLIGHTBEHAVIOR_METHOD_3_5790A55946AA509D_1_OFFSET UNITYSDK_OFFSET(0x9584540)
#define RPG_CLIENT_EFFECT_SPHEREVOLUMETRICLIGHTBEHAVIOR_METHOD_3_5790A55946AA509D_2_OFFSET UNITYSDK_OFFSET(0x95845A0)
#define RPG_CLIENT_EFFECT_SPHEREVOLUMETRICLIGHTBEHAVIOR_METHOD_3_5790A55946AA509D_3_OFFSET UNITYSDK_OFFSET(0x9584600)
#define RPG_CLIENT_EFFECT_SPHEREVOLUMETRICLIGHTBEHAVIOR_METHOD_3_5790A55946AA509D_4_OFFSET UNITYSDK_OFFSET(0x9584660)
#define RPG_CLIENT_EFFECT_SPHEREVOLUMETRICLIGHTBEHAVIOR_METHOD_3_5790A55946AA509D_5_OFFSET UNITYSDK_OFFSET(0x95846D0)
#define RPG_CLIENT_EFFECT_SPHEREVOLUMETRICLIGHTBEHAVIOR_METHOD_3_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0x95844E0)
#define RPG_CLIENT_EFFECT_SPHEREVOLUMETRICLIGHTBEHAVIOR_METHOD_3_7EAA8879197594BA_OFFSET UNITYSDK_OFFSET(0x9582EB0)
#define RPG_CLIENT_EFFECT_SPHEREVOLUMETRICLIGHTBEHAVIOR_METHOD_3_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x9583680)
#define RPG_CLIENT_EFFECT_SPHEREVOLUMETRICLIGHTBEHAVIOR_METHOD_3_AA169839CB93802A_OFFSET UNITYSDK_OFFSET(0x9581580)
#define RPG_CLIENT_EFFECT_SPHEREVOLUMETRICLIGHTBEHAVIOR_METHOD_3_CEBFF096B4C9D46B_OFFSET UNITYSDK_OFFSET(0x9583E80)
#define RPG_CLIENT_EFFECT_SPHEREVOLUMETRICLIGHTBEHAVIOR_METHOD_3_D109CE569415FA03_OFFSET UNITYSDK_OFFSET(0x9583730)
#define RPG_CLIENT_EFFECT_SPHEREVOLUMETRICLIGHTBEHAVIOR_METHOD_3_FE268EA0D7E91617_OFFSET UNITYSDK_OFFSET(0x9581270)
#define RPG_CLIENT_EFFECT_SPHEREVOLUMETRICLIGHTBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0x95835F0)
#define RPG_CLIENT_EFFECT_SPHEREVOLUMETRICLIGHTBEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x9584430)
#define RPG_CLIENT_EFFECT_SPHEREVOLUMETRICLIGHTBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x9584420)
#define RPG_CLIENT_EFFECT_SPHEREVOLUMETRICLIGHTBEHAVIOR___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x9584470)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_SphereVolumetricLightBehavior_TypeDefinitionIndex = 57784;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Effect_SphereVolumetricLightBehavior_TypeDefinitionIndex)->GetStaticField(0x124A0);
		}
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_EFFECT_SPHEREVOLUMETRICLIGHTBEHAVIOR_METHOD_3_FE268EA0D7E91617_OFFSET))(this);
		}
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_EFFECT_SPHEREVOLUMETRICLIGHTBEHAVIOR_METHOD_3_7EAA8879197594BA_OFFSET))(this);
		}
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_EFFECT_SPHEREVOLUMETRICLIGHTBEHAVIOR_METHOD_3_D109CE569415FA03_OFFSET))(this);
		}

		::System::Void Method_3_CEBFF096B4C9D46B()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_EFFECT_SPHEREVOLUMETRICLIGHTBEHAVIOR_METHOD_3_CEBFF096B4C9D46B_OFFSET))(this);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + RPG_CLIENT_EFFECT_SPHEREVOLUMETRICLIGHTBEHAVIOR___IFIXBASEPROXY_TICK_OFFSET))(this, P0);
		}
