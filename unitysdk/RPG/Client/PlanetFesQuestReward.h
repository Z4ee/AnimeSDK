...
#define RPG_CLIENT_PLANETFESQUESTREWARD__CTOR_OFFSET UNITYSDK_OFFSET(0xC479E60)

namespace RPG::Client
{
	inline static constexpr unsigned int PlanetFesQuestReward_TypeDefinitionIndex = 62304;
