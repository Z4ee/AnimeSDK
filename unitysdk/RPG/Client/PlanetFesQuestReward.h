...
#define RPG_CLIENT_PLANETFESQUESTREWARD__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1BFE30)

namespace RPG::Client
{
	inline static constexpr unsigned int PlanetFesQuestReward_TypeDefinitionIndex = 63670;
