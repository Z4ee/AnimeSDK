...
#define RPG_CLIENT_DEFORMATIONCASTERCLEANUPBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0xCC9B190)
#define RPG_CLIENT_DEFORMATIONCASTERCLEANUPBEHAVIOR_METHOD_3_4307B2A4B4A12C1A_1_OFFSET UNITYSDK_OFFSET(0xCC9B0C0)
#define RPG_CLIENT_DEFORMATIONCASTERCLEANUPBEHAVIOR_METHOD_3_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0xCC9AF60)
#define RPG_CLIENT_DEFORMATIONCASTERCLEANUPBEHAVIOR_METHOD_3_870AF3CD1D0A67B1_OFFSET UNITYSDK_OFFSET(0xCC9B030)
#define RPG_CLIENT_DEFORMATIONCASTERCLEANUPBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0xCC9B290)
