...
#define RPG_CLIENT_RPGCOPYLAYOUTELEMENT_CALCULATELAYOUTINPUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x18036F70)
#define RPG_CLIENT_RPGCOPYLAYOUTELEMENT_CALCULATELAYOUTINPUTVERTICAL_OFFSET UNITYSDK_OFFSET(0x18036FB0)
#define RPG_CLIENT_RPGCOPYLAYOUTELEMENT_GET_FLEXIBLEHEIGHT_OFFSET UNITYSDK_OFFSET(0x18036E50)
#define RPG_CLIENT_RPGCOPYLAYOUTELEMENT_GET_FLEXIBLEWIDTH_OFFSET UNITYSDK_OFFSET(0x18036EA0)
#define RPG_CLIENT_RPGCOPYLAYOUTELEMENT_GET_LAYOUTPRIORITY_OFFSET UNITYSDK_OFFSET(0x18036E00)
#define RPG_CLIENT_RPGCOPYLAYOUTELEMENT_GET_MAXHEIGHT_OFFSET UNITYSDK_OFFSET(0x18036EF0)
#define RPG_CLIENT_RPGCOPYLAYOUTELEMENT_GET_MAXWIDTH_OFFSET UNITYSDK_OFFSET(0x18036F30)
#define RPG_CLIENT_RPGCOPYLAYOUTELEMENT_GET_MINHEIGHT_OFFSET UNITYSDK_OFFSET(0x18036D50)
#define RPG_CLIENT_RPGCOPYLAYOUTELEMENT_GET_MINWIDTH_OFFSET UNITYSDK_OFFSET(0x18036CA0)
#define RPG_CLIENT_RPGCOPYLAYOUTELEMENT_GET_PREFERREDHEIGHT_OFFSET UNITYSDK_OFFSET(0x18036BC0)
#define RPG_CLIENT_RPGCOPYLAYOUTELEMENT_GET_PREFERREDWIDTH_OFFSET UNITYSDK_OFFSET(0x18036AE0)
#define RPG_CLIENT_RPGCOPYLAYOUTELEMENT_UPDATE_OFFSET UNITYSDK_OFFSET(0x18036FF0)
#define RPG_CLIENT_RPGCOPYLAYOUTELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x180371F0)

namespace RPG::Client
{
	inline static constexpr unsigned int RPGCopyLayoutElement_TypeDefinitionIndex = 72561;
