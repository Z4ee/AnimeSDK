...
#define RPG_CLIENT_EMSMATCUSTOMDICTIONAY_FINALIZE_OFFSET UNITYSDK_OFFSET(0x18D8BE80)
#define RPG_CLIENT_EMSMATCUSTOMDICTIONAY_METHOD_1_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0x18D8BD90)
#define RPG_CLIENT_EMSMATCUSTOMDICTIONAY_METHOD_1_CFE6FB160FFF5938_OFFSET UNITYSDK_OFFSET(0x18D8BDE0)
#define RPG_CLIENT_EMSMATCUSTOMDICTIONAY_METHOD_1_EE995D7DF270EB55_OFFSET UNITYSDK_OFFSET(0x18D8BC50)
#define RPG_CLIENT_EMSMATCUSTOMDICTIONAY__CTOR_OFFSET UNITYSDK_OFFSET(0x18D8BBF0)

namespace RPG::Client
{
	inline static constexpr unsigned int EmsMatCustomDictionay_TypeDefinitionIndex = 67581;
