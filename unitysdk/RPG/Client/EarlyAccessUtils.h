...
#define RPG_CLIENT_EARLYACCESSUTILS_ISMISSIONINCANUNLOCKEARLYACCESSCONTENT_OFFSET UNITYSDK_OFFSET(0xCDBD5E0)
#define RPG_CLIENT_EARLYACCESSUTILS_ISNEEDSWITCHCONTENT_OFFSET UNITYSDK_OFFSET(0xCDBD370)
#define RPG_CLIENT_EARLYACCESSUTILS_REPORTSWITCHDIALOGBUTTON_OFFSET UNITYSDK_OFFSET(0xCDBD910)
#define RPG_CLIENT_EARLYACCESSUTILS_SHOWEARLYACCESSBLOCKERRORTIPS_OFFSET UNITYSDK_OFFSET(0xCDBD8B0)
#define RPG_CLIENT_EARLYACCESSUTILS_SHOWEARLYACCESSSWITCHDIALOG_OFFSET UNITYSDK_OFFSET(0xCDBD040)
