...
#define RPG_CLIENT_FIXSTRETCHPARTICLE_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xA3BC4B0)
#define RPG_CLIENT_FIXSTRETCHPARTICLE__CTOR_OFFSET UNITYSDK_OFFSET(0xA3BC500)
#define RPG_CLIENT_FIXSTRETCHPARTICLE___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xA3BC520)

namespace RPG::Client
{
	inline static constexpr unsigned int FixStretchParticle_TypeDefinitionIndex = 65084;
