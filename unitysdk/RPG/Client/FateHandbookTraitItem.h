...
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_CREATE_OFFSET UNITYSDK_OFFSET(0xA350E40)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_GET_EXTRAEFFECTARRAY_OFFSET UNITYSDK_OFFSET(0xA351A80)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_GET_RELATEDFATEBUFFIDLIST_OFFSET UNITYSDK_OFFSET(0xA351810)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_GET_TRAITBIGICONPATH_OFFSET UNITYSDK_OFFSET(0xA351440)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_GET_TRAITBUFFITEMLIST_OFFSET UNITYSDK_OFFSET(0xA3516E0)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_GET_TRAITDESC_OFFSET UNITYSDK_OFFSET(0xA351300)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_GET_TRAITDISPLAYDATA_OFFSET UNITYSDK_OFFSET(0xA350F70)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_GET_TRAITID_OFFSET UNITYSDK_OFFSET(0xA350F30)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_GET_TRAITLEVEL_OFFSET UNITYSDK_OFFSET(0xA350F50)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_GET_TRAITNAME_OFFSET UNITYSDK_OFFSET(0xA351040)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_GET_TRAITSMALLICONPATH_OFFSET UNITYSDK_OFFSET(0xA351590)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_GET_TRAITSOURCELIST_OFFSET UNITYSDK_OFFSET(0xA351940)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_GET_TRAITTYPE_OFFSET UNITYSDK_OFFSET(0xA3511C0)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_SET_TRAITID_OFFSET UNITYSDK_OFFSET(0xA350F40)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_SET_TRAITLEVEL_OFFSET UNITYSDK_OFFSET(0xA350F60)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xA350F20)

namespace RPG::Client
{
	inline static constexpr unsigned int FateHandbookTraitItem_TypeDefinitionIndex = 58944;
	...
	public:
		...
		::System::UInt32 _TraitLevel_k__BackingField; // 0x24
