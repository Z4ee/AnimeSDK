...
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_CREATE_OFFSET UNITYSDK_OFFSET(0xCF521B0)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_GET_EXTRAEFFECTARRAY_OFFSET UNITYSDK_OFFSET(0xCF52EC0)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_GET_RELATEDFATEBUFFIDLIST_OFFSET UNITYSDK_OFFSET(0xCF52C50)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_GET_TRAITBIGICONPATH_OFFSET UNITYSDK_OFFSET(0xCF52830)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_GET_TRAITBUFFITEMLIST_OFFSET UNITYSDK_OFFSET(0xCF52B20)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_GET_TRAITDESC_OFFSET UNITYSDK_OFFSET(0xCF526F0)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_GET_TRAITDISPLAYDATA_OFFSET UNITYSDK_OFFSET(0xCF522E0)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_GET_TRAITID_OFFSET UNITYSDK_OFFSET(0xCF522A0)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_GET_TRAITLEVEL_OFFSET UNITYSDK_OFFSET(0xCF522C0)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_GET_TRAITNAME_OFFSET UNITYSDK_OFFSET(0xCF523B0)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_GET_TRAITSMALLICONPATH_OFFSET UNITYSDK_OFFSET(0xCF52980)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_GET_TRAITSOURCELIST_OFFSET UNITYSDK_OFFSET(0xCF52D80)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_GET_TRAITTYPE_OFFSET UNITYSDK_OFFSET(0xCF52580)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_SET_TRAITID_OFFSET UNITYSDK_OFFSET(0xCF522B0)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_SET_TRAITLEVEL_OFFSET UNITYSDK_OFFSET(0xCF522D0)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xCF52290)
