...
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_CREATE_OFFSET UNITYSDK_OFFSET(0x1C1957E0)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_GET_EXTRAEFFECTARRAY_OFFSET UNITYSDK_OFFSET(0x1C1964F0)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_GET_RELATEDFATEBUFFIDLIST_OFFSET UNITYSDK_OFFSET(0x1C196280)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_GET_TRAITBIGICONPATH_OFFSET UNITYSDK_OFFSET(0x1C195E60)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_GET_TRAITBUFFITEMLIST_OFFSET UNITYSDK_OFFSET(0x1C196150)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_GET_TRAITDESC_OFFSET UNITYSDK_OFFSET(0x1C195D20)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_GET_TRAITDISPLAYDATA_OFFSET UNITYSDK_OFFSET(0x1C195910)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_GET_TRAITID_OFFSET UNITYSDK_OFFSET(0x1C1958D0)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_GET_TRAITLEVEL_OFFSET UNITYSDK_OFFSET(0x1C1958F0)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_GET_TRAITNAME_OFFSET UNITYSDK_OFFSET(0x1C1959E0)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_GET_TRAITSMALLICONPATH_OFFSET UNITYSDK_OFFSET(0x1C195FB0)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_GET_TRAITSOURCELIST_OFFSET UNITYSDK_OFFSET(0x1C1963B0)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_GET_TRAITTYPE_OFFSET UNITYSDK_OFFSET(0x1C195BB0)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_SET_TRAITID_OFFSET UNITYSDK_OFFSET(0x1C1958E0)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM_SET_TRAITLEVEL_OFFSET UNITYSDK_OFFSET(0x1C195900)
#define RPG_CLIENT_FATEHANDBOOKTRAITITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1958C0)

namespace RPG::Client
{
	inline static constexpr unsigned int FateHandbookTraitItem_TypeDefinitionIndex = 64140;
