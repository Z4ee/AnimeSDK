...
#define RPG_CLIENT_MONOCURVEMOVEMENTOBJECT_AWAKE_OFFSET UNITYSDK_OFFSET(0xA920250)
#define RPG_CLIENT_MONOCURVEMOVEMENTOBJECT_GET_ANIMATORREF_OFFSET UNITYSDK_OFFSET(0xA920100)
#define RPG_CLIENT_MONOCURVEMOVEMENTOBJECT_GET_CUSTOMDIRECTION_OFFSET UNITYSDK_OFFSET(0xA920120)
#define RPG_CLIENT_MONOCURVEMOVEMENTOBJECT_GET_FREEZEROTATE_OFFSET UNITYSDK_OFFSET(0xA9200B0)
#define RPG_CLIENT_MONOCURVEMOVEMENTOBJECT_ISINANIMIDLESTATE_OFFSET UNITYSDK_OFFSET(0xA920140)
#define RPG_CLIENT_MONOCURVEMOVEMENTOBJECT_SET_ANIMATORREF_OFFSET UNITYSDK_OFFSET(0xA920110)
#define RPG_CLIENT_MONOCURVEMOVEMENTOBJECT_SET_CUSTOMDIRECTION_OFFSET UNITYSDK_OFFSET(0xA920130)
#define RPG_CLIENT_MONOCURVEMOVEMENTOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0xA9202E0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoCurveMovementObject_TypeDefinitionIndex = 63215;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::Animator*))((::PBYTE)hIl2Cpp + RPG_CLIENT_MONOCURVEMOVEMENTOBJECT_SET_ANIMATORREF_OFFSET))(this, value);
		}
		...
		::System::Void set_CustomDirection(::RPG::Client::ECurveMoveDirection value)
		{
			return ((::System::Void(*)(::PVOID, ::RPG::Client::ECurveMoveDirection))((::PBYTE)hIl2Cpp + RPG_CLIENT_MONOCURVEMOVEMENTOBJECT_SET_CUSTOMDIRECTION_OFFSET))(this, value);
		}
