...
#define RPG_CLIENT_MONOCURVEMOVEMENTOBJECT_AWAKE_OFFSET UNITYSDK_OFFSET(0x9C24160)
#define RPG_CLIENT_MONOCURVEMOVEMENTOBJECT_GET_ANIMATORREF_OFFSET UNITYSDK_OFFSET(0x9C24010)
#define RPG_CLIENT_MONOCURVEMOVEMENTOBJECT_GET_CUSTOMDIRECTION_OFFSET UNITYSDK_OFFSET(0x9C24030)
#define RPG_CLIENT_MONOCURVEMOVEMENTOBJECT_GET_FREEZEROTATE_OFFSET UNITYSDK_OFFSET(0x9C23FC0)
#define RPG_CLIENT_MONOCURVEMOVEMENTOBJECT_ISINANIMIDLESTATE_OFFSET UNITYSDK_OFFSET(0x9C24050)
#define RPG_CLIENT_MONOCURVEMOVEMENTOBJECT_SET_ANIMATORREF_OFFSET UNITYSDK_OFFSET(0x9C24020)
#define RPG_CLIENT_MONOCURVEMOVEMENTOBJECT_SET_CUSTOMDIRECTION_OFFSET UNITYSDK_OFFSET(0x9C24040)
#define RPG_CLIENT_MONOCURVEMOVEMENTOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x9C241F0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoCurveMovementObject_TypeDefinitionIndex = 55972;
