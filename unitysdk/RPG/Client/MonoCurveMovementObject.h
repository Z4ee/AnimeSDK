...
#define RPG_CLIENT_MONOCURVEMOVEMENTOBJECT_AWAKE_OFFSET UNITYSDK_OFFSET(0xC06ABF0)
#define RPG_CLIENT_MONOCURVEMOVEMENTOBJECT_GET_ANIMATORREF_OFFSET UNITYSDK_OFFSET(0xC06AAA0)
#define RPG_CLIENT_MONOCURVEMOVEMENTOBJECT_GET_CUSTOMDIRECTION_OFFSET UNITYSDK_OFFSET(0xC06AAC0)
#define RPG_CLIENT_MONOCURVEMOVEMENTOBJECT_GET_FREEZEROTATE_OFFSET UNITYSDK_OFFSET(0xC06AA50)
#define RPG_CLIENT_MONOCURVEMOVEMENTOBJECT_ISINANIMIDLESTATE_OFFSET UNITYSDK_OFFSET(0xC06AAE0)
#define RPG_CLIENT_MONOCURVEMOVEMENTOBJECT_SET_ANIMATORREF_OFFSET UNITYSDK_OFFSET(0xC06AAB0)
#define RPG_CLIENT_MONOCURVEMOVEMENTOBJECT_SET_CUSTOMDIRECTION_OFFSET UNITYSDK_OFFSET(0xC06AAD0)
#define RPG_CLIENT_MONOCURVEMOVEMENTOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0xC06AC80)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoCurveMovementObject_TypeDefinitionIndex = 64132;
