...
#define RPG_CLIENT_BATTLERESULTPROCESS__STARTRESULTPROCESS_D__4_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19F80DD0)
#define RPG_CLIENT_BATTLERESULTPROCESS__STARTRESULTPROCESS_D__4_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19F81650)
#define RPG_CLIENT_BATTLERESULTPROCESS__STARTRESULTPROCESS_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19F816B0)
#define RPG_CLIENT_BATTLERESULTPROCESS__STARTRESULTPROCESS_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19F81660)
#define RPG_CLIENT_BATTLERESULTPROCESS__STARTRESULTPROCESS_D__4_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19F80DB0)
#define RPG_CLIENT_BATTLERESULTPROCESS__STARTRESULTPROCESS_D__4__CTOR_OFFSET UNITYSDK_OFFSET(0x19F7CD40)
