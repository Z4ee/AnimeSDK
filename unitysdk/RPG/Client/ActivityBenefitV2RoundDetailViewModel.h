...
#define RPG_CLIENT_ACTIVITYBENEFITV2ROUNDDETAILVIEWMODEL_ADD_ONCLAIMREWARDFINISHED_OFFSET UNITYSDK_OFFSET(0xC4D55F0)
#define RPG_CLIENT_ACTIVITYBENEFITV2ROUNDDETAILVIEWMODEL_CLAIMREWARD_OFFSET UNITYSDK_OFFSET(0xC4D53A0)
#define RPG_CLIENT_ACTIVITYBENEFITV2ROUNDDETAILVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0xC4D4DD0)
#define RPG_CLIENT_ACTIVITYBENEFITV2ROUNDDETAILVIEWMODEL_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC4D5220)
#define RPG_CLIENT_ACTIVITYBENEFITV2ROUNDDETAILVIEWMODEL_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0xC4D4C70)
#define RPG_CLIENT_ACTIVITYBENEFITV2ROUNDDETAILVIEWMODEL_GET_INDEX_OFFSET UNITYSDK_OFFSET(0xC4D4AF0)
#define RPG_CLIENT_ACTIVITYBENEFITV2ROUNDDETAILVIEWMODEL_GET_ISREWARDCLAIMED_OFFSET UNITYSDK_OFFSET(0xC4D4D60)
#define RPG_CLIENT_ACTIVITYBENEFITV2ROUNDDETAILVIEWMODEL_GET_ITEMS_OFFSET UNITYSDK_OFFSET(0xC4D4D40)
#define RPG_CLIENT_ACTIVITYBENEFITV2ROUNDDETAILVIEWMODEL_GET_TITLE_OFFSET UNITYSDK_OFFSET(0xC4D4BF0)
#define RPG_CLIENT_ACTIVITYBENEFITV2ROUNDDETAILVIEWMODEL_GET__PRIZE_OFFSET UNITYSDK_OFFSET(0xC4D4B00)
#define RPG_CLIENT_ACTIVITYBENEFITV2ROUNDDETAILVIEWMODEL_REMOVE_ONCLAIMREWARDFINISHED_OFFSET UNITYSDK_OFFSET(0xC4D5650)
#define RPG_CLIENT_ACTIVITYBENEFITV2ROUNDDETAILVIEWMODEL_SET_ITEMS_OFFSET UNITYSDK_OFFSET(0xC4D4D50)
#define RPG_CLIENT_ACTIVITYBENEFITV2ROUNDDETAILVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC4D5090)
#define RPG_CLIENT_ACTIVITYBENEFITV2ROUNDDETAILVIEWMODEL__ONCLAIMREWARDFINISHED_OFFSET UNITYSDK_OFFSET(0xC4D5540)
