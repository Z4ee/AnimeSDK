...
#define RPG_CLIENT_DEVUIDEBUGREPORTDATAERROR__CTOR_OFFSET UNITYSDK_OFFSET(0x944B7D0)

namespace RPG::Client
{
	inline static constexpr unsigned int DevUIDebugReportDataError_TypeDefinitionIndex = 55782;
