...
#define RPG_CLIENT_DEVUIDEBUGREPORTDATAERROR__CTOR_OFFSET UNITYSDK_OFFSET(0x192E4D00)

namespace RPG::Client
{
	inline static constexpr unsigned int DevUIDebugReportDataError_TypeDefinitionIndex = 68312;
