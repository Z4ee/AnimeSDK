...
#define RPG_CLIENT_SCORECHALLENGETARGETDATA_CALCULATETARGETSTATE_OFFSET UNITYSDK_OFFSET(0x19F32D30)
#define RPG_CLIENT_SCORECHALLENGETARGETDATA_SETCHALLENGETARGETSTATE_OFFSET UNITYSDK_OFFSET(0x19F32DA0)
#define RPG_CLIENT_SCORECHALLENGETARGETDATA_UPDATECHALLENGETARGETSTATE_OFFSET UNITYSDK_OFFSET(0x19F32C60)
#define RPG_CLIENT_SCORECHALLENGETARGETDATA__CONVERT_OFFSET UNITYSDK_OFFSET(0x19F32AD0)
#define RPG_CLIENT_SCORECHALLENGETARGETDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19F32A40)

namespace RPG::Client
{
	inline static constexpr unsigned int ScoreChallengeTargetData_TypeDefinitionIndex = 60333;
