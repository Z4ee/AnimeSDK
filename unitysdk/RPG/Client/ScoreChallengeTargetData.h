...
#define RPG_CLIENT_SCORECHALLENGETARGETDATA_CALCULATETARGETSTATE_OFFSET UNITYSDK_OFFSET(0xC8A8DC0)
#define RPG_CLIENT_SCORECHALLENGETARGETDATA_SETCHALLENGETARGETSTATE_OFFSET UNITYSDK_OFFSET(0xC8A8E30)
#define RPG_CLIENT_SCORECHALLENGETARGETDATA_UPDATECHALLENGETARGETSTATE_OFFSET UNITYSDK_OFFSET(0xC8A8CF0)
#define RPG_CLIENT_SCORECHALLENGETARGETDATA__CONVERT_OFFSET UNITYSDK_OFFSET(0xC8A8BB0)
#define RPG_CLIENT_SCORECHALLENGETARGETDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC8A8B70)
#define RPG_CLIENT_SCORECHALLENGETARGETDATA___IFIXBASEPROXY_SETCHALLENGETARGETSTATE_OFFSET UNITYSDK_OFFSET(0xC8A8F60)
#define RPG_CLIENT_SCORECHALLENGETARGETDATA___IFIXBASEPROXY_UPDATECHALLENGETARGETSTATE_OFFSET UNITYSDK_OFFSET(0xC8A8F00)

namespace RPG::Client
{
	inline static constexpr unsigned int ScoreChallengeTargetData_TypeDefinitionIndex = 59062;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Object*, ::System::Boolean))((::PBYTE)hIl2Cpp + RPG_CLIENT_SCORECHALLENGETARGETDATA___IFIXBASEPROXY_UPDATECHALLENGETARGETSTATE_OFFSET))(this, a1, a2);
		}

		::System::Void __iFixBaseProxy_SetChallengeTargetState(::System::Object* a1, ::System::Boolean a2)
		{
			return ((::System::Void(*)(::PVOID, ::System::Object*, ::System::Boolean))((::PBYTE)hIl2Cpp + RPG_CLIENT_SCORECHALLENGETARGETDATA___IFIXBASEPROXY_SETCHALLENGETARGETSTATE_OFFSET))(this, a1, a2);
		}
	};
}
