...
#define RPG_CLIENT_MATERIALPROPERTYSERIALIZEFIELDTEMPLATE7_GETPROPERTYFIELDS_OFFSET UNITYSDK_OFFSET(0x9B78100)
#define RPG_CLIENT_MATERIALPROPERTYSERIALIZEFIELDTEMPLATE7__CTOR_OFFSET UNITYSDK_OFFSET(0x9B78450)
#define RPG_CLIENT_MATERIALPROPERTYSERIALIZEFIELDTEMPLATE7___IFIXBASEPROXY_GETPROPERTYFIELDS_OFFSET UNITYSDK_OFFSET(0x9B78460)

namespace RPG::Client
{
	inline static constexpr unsigned int MaterialPropertySerializeFieldTemplate7_TypeDefinitionIndex = 57876;
