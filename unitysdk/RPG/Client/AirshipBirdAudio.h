...
#define RPG_CLIENT_AIRSHIPBIRDAUDIO_METHOD_5_B6BF2A1BCE9B9659_OFFSET UNITYSDK_OFFSET(0x9CEFE80)
#define RPG_CLIENT_AIRSHIPBIRDAUDIO_TRIGGERLOADCARGOEVENT_OFFSET UNITYSDK_OFFSET(0x9CEFBB0)
#define RPG_CLIENT_AIRSHIPBIRDAUDIO_TRIGGERUNLOADCARGOEVENT_OFFSET UNITYSDK_OFFSET(0x9CEE570)
#define RPG_CLIENT_AIRSHIPBIRDAUDIO__CTOR_OFFSET UNITYSDK_OFFSET(0x9CEFF90)

namespace RPG::Client
{
	inline static constexpr unsigned int AirshipBirdAudio_TypeDefinitionIndex = 55166;
