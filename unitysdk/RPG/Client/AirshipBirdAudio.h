...
#define RPG_CLIENT_AIRSHIPBIRDAUDIO_METHOD_5_B6BF2A1BCE9B9659_OFFSET UNITYSDK_OFFSET(0xC72E590)
#define RPG_CLIENT_AIRSHIPBIRDAUDIO_TRIGGERLOADCARGOEVENT_OFFSET UNITYSDK_OFFSET(0xC72E3A0)
#define RPG_CLIENT_AIRSHIPBIRDAUDIO_TRIGGERUNLOADCARGOEVENT_OFFSET UNITYSDK_OFFSET(0xC72CA30)
#define RPG_CLIENT_AIRSHIPBIRDAUDIO__CTOR_OFFSET UNITYSDK_OFFSET(0xC72E6A0)
