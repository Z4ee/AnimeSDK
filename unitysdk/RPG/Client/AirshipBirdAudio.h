...
#define RPG_CLIENT_AIRSHIPBIRDAUDIO_METHOD_5_B6BF2A1BCE9B9659_OFFSET UNITYSDK_OFFSET(0x19C5AC20)
#define RPG_CLIENT_AIRSHIPBIRDAUDIO_TRIGGERLOADCARGOEVENT_OFFSET UNITYSDK_OFFSET(0x19C5AA30)
#define RPG_CLIENT_AIRSHIPBIRDAUDIO_TRIGGERUNLOADCARGOEVENT_OFFSET UNITYSDK_OFFSET(0x19C590C0)
#define RPG_CLIENT_AIRSHIPBIRDAUDIO__CTOR_OFFSET UNITYSDK_OFFSET(0x19C5AD30)

namespace RPG::Client
{
	inline static constexpr unsigned int AirshipBirdAudio_TypeDefinitionIndex = 59937;
