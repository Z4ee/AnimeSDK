...
#define RPG_CLIENT_UINODECOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0xCB775A0)

namespace RPG::Client
{
	inline static constexpr unsigned int UINodeCollection_TypeDefinitionIndex = 64632;
