...
#define RPG_CLIENT_GRIDFIGHTROLESTARCONFIG_GETORIGINALAVATARSKILLID_OFFSET UNITYSDK_OFFSET(0xA57DB90)
#define RPG_CLIENT_GRIDFIGHTROLESTARCONFIG_GETORIGINALSERVANTSKILLID_OFFSET UNITYSDK_OFFSET(0xA57DC40)
#define RPG_CLIENT_GRIDFIGHTROLESTARCONFIG_GET_BACKPOWERBASE_OFFSET UNITYSDK_OFFSET(0xA569220)
#define RPG_CLIENT_GRIDFIGHTROLESTARCONFIG_GET_BACKSHOWSKILLIDLIST_OFFSET UNITYSDK_OFFSET(0xA57CF60)
#define RPG_CLIENT_GRIDFIGHTROLESTARCONFIG_GET_BACKSKILLCONFIG_OFFSET UNITYSDK_OFFSET(0xA57D930)
#define RPG_CLIENT_GRIDFIGHTROLESTARCONFIG_GET_BACKSPEEDMODIFIER_OFFSET UNITYSDK_OFFSET(0xA57FC00)
#define RPG_CLIENT_GRIDFIGHTROLESTARCONFIG_GET_BACKSPMODIFIER_OFFSET UNITYSDK_OFFSET(0xA57FC10)
#define RPG_CLIENT_GRIDFIGHTROLESTARCONFIG_GET_DEFAULTSKILLCONFIG_OFFSET UNITYSDK_OFFSET(0xA57FB40)
#define RPG_CLIENT_GRIDFIGHTROLESTARCONFIG_GET_ENERGYBAR_OFFSET UNITYSDK_OFFSET(0xA5692C0)
#define RPG_CLIENT_GRIDFIGHTROLESTARCONFIG_GET_FRONTPOWERBASE_OFFSET UNITYSDK_OFFSET(0xA569200)
#define RPG_CLIENT_GRIDFIGHTROLESTARCONFIG_GET_FRONTSHOWSKILLIDLIST_OFFSET UNITYSDK_OFFSET(0xA57CC20)
#define RPG_CLIENT_GRIDFIGHTROLESTARCONFIG_GET_FRONTSKILLCONFIG_OFFSET UNITYSDK_OFFSET(0xA57D860)
#define RPG_CLIENT_GRIDFIGHTROLESTARCONFIG_GET_FRONTSPECIALSPCONFIG_OFFSET UNITYSDK_OFFSET(0xA57FBB0)
#define RPG_CLIENT_GRIDFIGHTROLESTARCONFIG_GET_GENERALPROPERTYMODIFIERS_OFFSET UNITYSDK_OFFSET(0xA57FBE0)
#define RPG_CLIENT_GRIDFIGHTROLESTARCONFIG_GET_HASFRONTSPECIALSPCONFIG_OFFSET UNITYSDK_OFFSET(0xA57FBD0)
#define RPG_CLIENT_GRIDFIGHTROLESTARCONFIG_GET_HEALBASE_OFFSET UNITYSDK_OFFSET(0xA569280)
#define RPG_CLIENT_GRIDFIGHTROLESTARCONFIG_GET_HPADDEDRATIO2_OFFSET UNITYSDK_OFFSET(0xA569340)
#define RPG_CLIENT_GRIDFIGHTROLESTARCONFIG_GET_INITIALENERGYBAR_OFFSET UNITYSDK_OFFSET(0xA569490)
#define RPG_CLIENT_GRIDFIGHTROLESTARCONFIG_GET_INITIALSPECIALSP_OFFSET UNITYSDK_OFFSET(0xA568880)
#define RPG_CLIENT_GRIDFIGHTROLESTARCONFIG_GET_LUCKCHANCE_OFFSET UNITYSDK_OFFSET(0xA569240)
#define RPG_CLIENT_GRIDFIGHTROLESTARCONFIG_GET_LUCKDAMAGE_OFFSET UNITYSDK_OFFSET(0xA569260)
#define RPG_CLIENT_GRIDFIGHTROLESTARCONFIG_GET_SERVANTSHOWSKILLIDLIST_OFFSET UNITYSDK_OFFSET(0xA57CD90)
#define RPG_CLIENT_GRIDFIGHTROLESTARCONFIG_GET_SHIELDBASE_OFFSET UNITYSDK_OFFSET(0xA5692A0)
#define RPG_CLIENT_GRIDFIGHTROLESTARCONFIG_GET_SPECIALMAXSP_OFFSET UNITYSDK_OFFSET(0xA5692E0)
#define RPG_CLIENT_GRIDFIGHTROLESTARCONFIG_SET_FRONTSPECIALSPCONFIG_OFFSET UNITYSDK_OFFSET(0xA57FBC0)
#define RPG_CLIENT_GRIDFIGHTROLESTARCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xA573A70)
...
namespace RPG::Client
{
	...
	public:
		...
		::Class_0_16E4307DCC419505_663* _BackSPModifier_k__BackingField; // 0x28
		::RPG::Client::GridFightRoleSkillConfig* _BackSkillConfig; // 0x30
