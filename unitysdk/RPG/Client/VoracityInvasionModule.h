...
#define RPG_CLIENT_VORACITYINVASIONMODULE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C8194E0)
#define RPG_CLIENT_VORACITYINVASIONMODULE_GETFARMINVASIONLEVEL_OFFSET UNITYSDK_OFFSET(0x1C81A240)
#define RPG_CLIENT_VORACITYINVASIONMODULE_GETVORACITYINVASIONLEVELBYGAMEENTITY_OFFSET UNITYSDK_OFFSET(0x1C8187F0)
#define RPG_CLIENT_VORACITYINVASIONMODULE_GETVORACITYINVASIONLEVEL_OFFSET UNITYSDK_OFFSET(0x1C818750)
#define RPG_CLIENT_VORACITYINVASIONMODULE_INIT_OFFSET UNITYSDK_OFFSET(0x1C818D20)
#define RPG_CLIENT_VORACITYINVASIONMODULE_ONLOGINFINISH_OFFSET UNITYSDK_OFFSET(0x1C819460)
#define RPG_CLIENT_VORACITYINVASIONMODULE_ONRECONNECT_OFFSET UNITYSDK_OFFSET(0x1C8194A0)
#define RPG_CLIENT_VORACITYINVASIONMODULE_SENDGETDATACSREQ_OFFSET UNITYSDK_OFFSET(0x1C819530)
#define RPG_CLIENT_VORACITYINVASIONMODULE__ADDNOTIFYHANDLERS_OFFSET UNITYSDK_OFFSET(0x1C819260)
#define RPG_CLIENT_VORACITYINVASIONMODULE__ADDPACKETHANDLERS_OFFSET UNITYSDK_OFFSET(0x1C8192A0)
#define RPG_CLIENT_VORACITYINVASIONMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C81A3A0)
#define RPG_CLIENT_VORACITYINVASIONMODULE__GETFARMINVASIONLEVEL_OFFSET UNITYSDK_OFFSET(0x1C8188C0)
#define RPG_CLIENT_VORACITYINVASIONMODULE__GETMAPMONSTERINVASIONLEVEL_OFFSET UNITYSDK_OFFSET(0x1C818A10)
#define RPG_CLIENT_VORACITYINVASIONMODULE__GETSTAGEINVASIONLEVEL_OFFSET UNITYSDK_OFFSET(0x1C818990)
#define RPG_CLIENT_VORACITYINVASIONMODULE__INITFARMINVASIONLEVEL_OFFSET UNITYSDK_OFFSET(0x1C818D80)
#define RPG_CLIENT_VORACITYINVASIONMODULE__INITNPCMONSTERINVASIONLEVEL_OFFSET UNITYSDK_OFFSET(0x1C819030)
#define RPG_CLIENT_VORACITYINVASIONMODULE__ONGETVORACITYINVASIONDATASCRSP_OFFSET UNITYSDK_OFFSET(0x1C819610)
#define RPG_CLIENT_VORACITYINVASIONMODULE__ONVORACITYINVASIONCHANGESCNOTIFY_OFFSET UNITYSDK_OFFSET(0x1C81A0C0)
...
namespace RPG::Client
{
	...
	{
	public:
		::System::Collections::Generic::Dictionary_2<::RPG::GameCore::FarmTypeConfig, ::System::UInt32>* _FarmInvasionLevels; // 0x10
		::System::Collections::Generic::Dictionary_2<::System::ValueTuple_4<::System::UInt32, ::System::UInt32, ::System::UInt32, ::System::UInt32>, ::System::UInt32>* _NPCMonsterInvasionLevels; // 0x18
		::System::Collections::Generic::HashSet_1<::RPG::GameCore::FarmTypeConfig>* _AllInvadedFarmTypes; // 0x20
