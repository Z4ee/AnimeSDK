...
#define RPG_CLIENT_ST_PARKOUR_MODIFYSCORE_METHOD_4_3FD933B79C4CB108_OFFSET UNITYSDK_OFFSET(0x16E8D0F0)
#define RPG_CLIENT_ST_PARKOUR_MODIFYSCORE_METHOD_4_C4B30AAF83B3C797_OFFSET UNITYSDK_OFFSET(0x16E8D020)
#define RPG_CLIENT_ST_PARKOUR_MODIFYSCORE__CTOR_OFFSET UNITYSDK_OFFSET(0x16E8D0A0)

namespace RPG::Client
{
	inline static constexpr unsigned int ST_Parkour_ModifyScore_TypeDefinitionIndex = 9964;
