...
#define RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE_METHOD_6_290BD11329CA8210_OFFSET UNITYSDK_OFFSET(0x174301E0)
#define RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE_METHOD_6_3CB13632BDCE1D22_OFFSET UNITYSDK_OFFSET(0x174303C0)
#define RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE_METHOD_6_6EBC8CA821972AC9_OFFSET UNITYSDK_OFFSET(0x17430800)
#define RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE_METHOD_6_88E5D000ABA33B13_OFFSET UNITYSDK_OFFSET(0x174302C0)
#define RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE_METHOD_6_8CA88D55ECEFAD59_OFFSET UNITYSDK_OFFSET(0x1742F6A0)
#define RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE_METHOD_6_9B97A7966B23A4A7_OFFSET UNITYSDK_OFFSET(0x1742FDD0)
#define RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE_METHOD_6_A1AF98B26C7CFE0A_OFFSET UNITYSDK_OFFSET(0x174300A0)
#define RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE_TESTTARGET_OFFSET UNITYSDK_OFFSET(0x1742F8D0)
#define RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE_TICK_OFFSET UNITYSDK_OFFSET(0x1742F840)
#define RPG_CLIENT_WOLFBROGUNTARGETPROJECTILE__CTOR_OFFSET UNITYSDK_OFFSET(0x17430E10)

namespace RPG::Client
{
	inline static constexpr unsigned int WolfBroGunTargetProjectile_TypeDefinitionIndex = 65695;
