...
#define RPG_CLIENT_EMOPLAYABLEGRAPHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xB908880)

namespace RPG::Client
{
	inline static constexpr unsigned int EmoPlayableGraphConfig_TypeDefinitionIndex = 66488;
