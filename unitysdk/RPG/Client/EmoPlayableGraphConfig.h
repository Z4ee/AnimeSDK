...
#define RPG_CLIENT_EMOPLAYABLEGRAPHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18D8A260)

namespace RPG::Client
{
	inline static constexpr unsigned int EmoPlayableGraphConfig_TypeDefinitionIndex = 67924;
