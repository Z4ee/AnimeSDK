...
#define RPG_CLIENT_EMOPLAYABLEGRAPHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A177EB0)

namespace RPG::Client
{
	inline static constexpr unsigned int EmoPlayableGraphConfig_TypeDefinitionIndex = 71097;
