...
#define RPG_CLIENT_MATCHTHREETUTORIALEFFECT_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xBF94BB0)
#define RPG_CLIENT_MATCHTHREETUTORIALEFFECT_METHOD_5_C1062F26C50C07EE_OFFSET UNITYSDK_OFFSET(0xBF94E70)
#define RPG_CLIENT_MATCHTHREETUTORIALEFFECT_ONCREATE_OFFSET UNITYSDK_OFFSET(0xBF94F30)
#define RPG_CLIENT_MATCHTHREETUTORIALEFFECT_PLAY_OFFSET UNITYSDK_OFFSET(0xBF94D10)
#define RPG_CLIENT_MATCHTHREETUTORIALEFFECT_SETARROWVISIBLE_OFFSET UNITYSDK_OFFSET(0xBF94FF0)
#define RPG_CLIENT_MATCHTHREETUTORIALEFFECT_SETPOSITION_OFFSET UNITYSDK_OFFSET(0xBF94BF0)
#define RPG_CLIENT_MATCHTHREETUTORIALEFFECT_SPAWNED_OFFSET UNITYSDK_OFFSET(0xBF94B70)
#define RPG_CLIENT_MATCHTHREETUTORIALEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xBF95080)

namespace RPG::Client
{
	inline static constexpr unsigned int MatchThreeTutorialEffect_TypeDefinitionIndex = 61666;
