...
#define RPG_CLIENT_NAVMESHOBSTACLEPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x9E2FCC0)

namespace RPG::Client
{
	inline static constexpr unsigned int NavMeshObstacleParams_TypeDefinitionIndex = 56058;
