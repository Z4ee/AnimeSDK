...
#define RPG_CLIENT_MISSIONMODULE_NOTIFYPACK__CTOR_OFFSET UNITYSDK_OFFSET(0x72EF0)

namespace RPG::Client
{
	inline static constexpr unsigned int MissionModule_NotifyPack_TypeDefinitionIndex = 53766;
