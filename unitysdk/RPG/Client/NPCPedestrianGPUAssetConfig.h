...
#define RPG_CLIENT_NPCPEDESTRIANGPUASSETCONFIG_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC247140)
#define RPG_CLIENT_NPCPEDESTRIANGPUASSETCONFIG_GET_MAXSPAWNCOUNT_OFFSET UNITYSDK_OFFSET(0xC246FD0)
#define RPG_CLIENT_NPCPEDESTRIANGPUASSETCONFIG_METHOD_3_02AC375691BAA612_OFFSET UNITYSDK_OFFSET(0xC246E70)
#define RPG_CLIENT_NPCPEDESTRIANGPUASSETCONFIG_METHOD_3_2330DA4597DE0EDD_OFFSET UNITYSDK_OFFSET(0xC246E30)
#define RPG_CLIENT_NPCPEDESTRIANGPUASSETCONFIG_METHOD_3_30BE3523CF9B739E_OFFSET UNITYSDK_OFFSET(0xC246F20)
#define RPG_CLIENT_NPCPEDESTRIANGPUASSETCONFIG_METHOD_3_A40475C44AA8CEAB_OFFSET UNITYSDK_OFFSET(0xC246FE0)
#define RPG_CLIENT_NPCPEDESTRIANGPUASSETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xC247180)
