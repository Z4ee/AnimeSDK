...
#define RPG_CLIENT_NPCPEDESTRIANGPUASSETCONFIG_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18EAF250)
#define RPG_CLIENT_NPCPEDESTRIANGPUASSETCONFIG_GET_MAXSPAWNCOUNT_OFFSET UNITYSDK_OFFSET(0x18EAF0E0)
#define RPG_CLIENT_NPCPEDESTRIANGPUASSETCONFIG_METHOD_3_02AC375691BAA612_OFFSET UNITYSDK_OFFSET(0x18EAEF50)
#define RPG_CLIENT_NPCPEDESTRIANGPUASSETCONFIG_METHOD_3_2330DA4597DE0EDD_OFFSET UNITYSDK_OFFSET(0x18EAEF10)
#define RPG_CLIENT_NPCPEDESTRIANGPUASSETCONFIG_METHOD_3_A40475C44AA8CEAB_OFFSET UNITYSDK_OFFSET(0x18EAF0F0)
#define RPG_CLIENT_NPCPEDESTRIANGPUASSETCONFIG_METHOD_3_ADE9B05D0E6295A7_OFFSET UNITYSDK_OFFSET(0x18EAF000)
#define RPG_CLIENT_NPCPEDESTRIANGPUASSETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18EAF290)

namespace RPG::Client
{
	inline static constexpr unsigned int NPCPedestrianGPUAssetConfig_TypeDefinitionIndex = 66161;
	...
	public:
		...
		{
			return ((::Class_0_16E4307DCC419505_992*(*)(::PVOID, ::System::String*))((::PBYTE)hIl2Cpp + RPG_CLIENT_NPCPEDESTRIANGPUASSETCONFIG_METHOD_3_ADE9B05D0E6295A7_OFFSET))(this, a1);
		}
