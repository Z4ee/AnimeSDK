...
#define RPG_CLIENT_ROGUETOURNBUILDREFTEAMDATAEXT___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AF03ED0)
#define RPG_CLIENT_ROGUETOURNBUILDREFTEAMDATAEXT___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF03F10)
#define RPG_CLIENT_ROGUETOURNBUILDREFTEAMDATAEXT___C__ISALLSLOTHASRECOM_B__5_0_OFFSET UNITYSDK_OFFSET(0x1AF03F20)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Func_2<::RPG::Client::IRogueTournBuildRefTeamMemberData*, ::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(RogueTournBuildRefTeamDataExt___c_TypeDefinitionIndex)->GetStaticField(0x10B60);
		}
		static ::RPG::Client::RogueTournBuildRefTeamDataExt___c** StaticGet___9()
		{
			return (::RPG::Client::RogueTournBuildRefTeamDataExt___c**)Il2CppClass::FromTypeDefinitionIndex(RogueTournBuildRefTeamDataExt___c_TypeDefinitionIndex)->GetStaticField(0x10B68);
		}
