...
#define RPG_CLIENT_MONODICECOMBATEXTRAGRAVITY_AWAKE_OFFSET UNITYSDK_OFFSET(0x9C2F200)
#define RPG_CLIENT_MONODICECOMBATEXTRAGRAVITY_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x9C2F470)
#define RPG_CLIENT_MONODICECOMBATEXTRAGRAVITY_METHOD_5_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x9C2FA20)
#define RPG_CLIENT_MONODICECOMBATEXTRAGRAVITY_METHOD_5_86143FF46EAE82B7_OFFSET UNITYSDK_OFFSET(0x9C2FBA0)
#define RPG_CLIENT_MONODICECOMBATEXTRAGRAVITY_METHOD_5_F0088C88851A7DFB_1_OFFSET UNITYSDK_OFFSET(0x9C2FCB0)
#define RPG_CLIENT_MONODICECOMBATEXTRAGRAVITY_METHOD_5_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x9C2FCA0)
#define RPG_CLIENT_MONODICECOMBATEXTRAGRAVITY_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9C2FAA0)
#define RPG_CLIENT_MONODICECOMBATEXTRAGRAVITY_START_OFFSET UNITYSDK_OFFSET(0x9C2F320)
#define RPG_CLIENT_MONODICECOMBATEXTRAGRAVITY__CTOR_OFFSET UNITYSDK_OFFSET(0x9C2FCC0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoDiceCombatExtraGravity_TypeDefinitionIndex = 51614;
