...
#define RPG_CLIENT_MONODICECOMBATEXTRAGRAVITY_AWAKE_OFFSET UNITYSDK_OFFSET(0x11665D20)
#define RPG_CLIENT_MONODICECOMBATEXTRAGRAVITY_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x11665F40)
#define RPG_CLIENT_MONODICECOMBATEXTRAGRAVITY_METHOD_5_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x116664F0)
#define RPG_CLIENT_MONODICECOMBATEXTRAGRAVITY_METHOD_5_391A84BCD9F51317_1_OFFSET UNITYSDK_OFFSET(0x11666770)
#define RPG_CLIENT_MONODICECOMBATEXTRAGRAVITY_METHOD_5_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x11666720)
#define RPG_CLIENT_MONODICECOMBATEXTRAGRAVITY_METHOD_5_86143FF46EAE82B7_OFFSET UNITYSDK_OFFSET(0x11666620)
#define RPG_CLIENT_MONODICECOMBATEXTRAGRAVITY_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x11666570)
#define RPG_CLIENT_MONODICECOMBATEXTRAGRAVITY_START_OFFSET UNITYSDK_OFFSET(0x11665E40)
#define RPG_CLIENT_MONODICECOMBATEXTRAGRAVITY__CTOR_OFFSET UNITYSDK_OFFSET(0x116667C0)
