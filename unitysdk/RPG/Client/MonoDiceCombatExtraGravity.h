...
#define RPG_CLIENT_MONODICECOMBATEXTRAGRAVITY_AWAKE_OFFSET UNITYSDK_OFFSET(0x10CCE490)
#define RPG_CLIENT_MONODICECOMBATEXTRAGRAVITY_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x10CCE6B0)
#define RPG_CLIENT_MONODICECOMBATEXTRAGRAVITY_METHOD_5_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x10CCEC60)
#define RPG_CLIENT_MONODICECOMBATEXTRAGRAVITY_METHOD_5_391A84BCD9F51317_1_OFFSET UNITYSDK_OFFSET(0x10CCEEE0)
#define RPG_CLIENT_MONODICECOMBATEXTRAGRAVITY_METHOD_5_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x10CCEE90)
#define RPG_CLIENT_MONODICECOMBATEXTRAGRAVITY_METHOD_5_86143FF46EAE82B7_OFFSET UNITYSDK_OFFSET(0x10CCED90)
#define RPG_CLIENT_MONODICECOMBATEXTRAGRAVITY_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x10CCECE0)
#define RPG_CLIENT_MONODICECOMBATEXTRAGRAVITY_START_OFFSET UNITYSDK_OFFSET(0x10CCE5B0)
#define RPG_CLIENT_MONODICECOMBATEXTRAGRAVITY__CTOR_OFFSET UNITYSDK_OFFSET(0x10CCEF30)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoDiceCombatExtraGravity_TypeDefinitionIndex = 60776;
