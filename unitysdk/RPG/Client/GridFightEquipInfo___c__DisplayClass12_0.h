...
#define RPG_CLIENT_GRIDFIGHTEQUIPINFO___C__DISPLAYCLASS12_0__CONTAINSEQUIPID_B__0_OFFSET UNITYSDK_OFFSET(0x1A68A5F0)
#define RPG_CLIENT_GRIDFIGHTEQUIPINFO___C__DISPLAYCLASS12_0__CONTAINSEQUIPID_B__1_OFFSET UNITYSDK_OFFSET(0x1A68A660)
#define RPG_CLIENT_GRIDFIGHTEQUIPINFO___C__DISPLAYCLASS12_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6860C0)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightEquipInfo___c__DisplayClass12_0_TypeDefinitionIndex = 62040;
