...
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONHELPER_COLLECTUNLOCKCONDITIONS_OFFSET UNITYSDK_OFFSET(0xD6D7740)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONHELPER_GETLOCATIONTEXT_OFFSET UNITYSDK_OFFSET(0xD6D5580)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONHELPER__INITUNLOCKCONDITIONCOLLECTORS_OFFSET UNITYSDK_OFFSET(0xD6D7FD0)
