...
#define RPG_CLIENT_CHALLENGESTORYGROUPDATA_GET_OPTIONALBUFFLIST_OFFSET UNITYSDK_OFFSET(0x1AD6E6F0)
#define RPG_CLIENT_CHALLENGESTORYGROUPDATA_GET_STORYGROUPEXTRAINFOROW_OFFSET UNITYSDK_OFFSET(0x1AD6E690)
#define RPG_CLIENT_CHALLENGESTORYGROUPDATA_GET_STORYTHEMECONFIGROW_OFFSET UNITYSDK_OFFSET(0x1AD6E6B0)
#define RPG_CLIENT_CHALLENGESTORYGROUPDATA_GET_THEMEID_OFFSET UNITYSDK_OFFSET(0x1AD6E6D0)
#define RPG_CLIENT_CHALLENGESTORYGROUPDATA_SET_STORYGROUPEXTRAINFOROW_OFFSET UNITYSDK_OFFSET(0x1AD6E6A0)
#define RPG_CLIENT_CHALLENGESTORYGROUPDATA_SET_STORYTHEMECONFIGROW_OFFSET UNITYSDK_OFFSET(0x1AD6E6C0)
#define RPG_CLIENT_CHALLENGESTORYGROUPDATA_SET_THEMEID_OFFSET UNITYSDK_OFFSET(0x1AD6E6E0)
#define RPG_CLIENT_CHALLENGESTORYGROUPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD6E740)

namespace RPG::Client
{
	inline static constexpr unsigned int ChallengeStoryGroupData_TypeDefinitionIndex = 63216;
