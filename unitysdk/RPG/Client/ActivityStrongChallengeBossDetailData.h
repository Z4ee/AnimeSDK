...
#define RPG_CLIENT_ACTIVITYSTRONGCHALLENGEBOSSDETAILDATA_GET_DETAIL_OFFSET UNITYSDK_OFFSET(0x19345140)
#define RPG_CLIENT_ACTIVITYSTRONGCHALLENGEBOSSDETAILDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0x193450D0)
#define RPG_CLIENT_ACTIVITYSTRONGCHALLENGEBOSSDETAILDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x193451B0)

namespace RPG::Client
{
	inline static constexpr unsigned int ActivityStrongChallengeBossDetailData_TypeDefinitionIndex = 59156;
