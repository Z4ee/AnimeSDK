...
#define RPG_CLIENT_SKILLTREEGROWTHGUIDEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xB18ECD0)

namespace RPG::Client
{
	inline static constexpr unsigned int SkillTreeGrowthGuideItem_TypeDefinitionIndex = 60360;
	...
	public:
		...
		::System::Func_1<::System::String*>* GetPriorityDesc; // 0x30
		::System::String* Name; // 0x38
		::RPG::GameCore::AvatarSkillTreeRow* PointData; // 0x40
		::System::UInt32 CurrLevel; // 0x48
