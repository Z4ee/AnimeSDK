...
#define RPG_CLIENT_SKILLTREEGROWTHGUIDEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xA49EF40)

namespace RPG::Client
{
	inline static constexpr unsigned int SkillTreeGrowthGuideItem_TypeDefinitionIndex = 53233;
	...
	public:
		...
		::System::Boolean IsRecommend; // 0x54
