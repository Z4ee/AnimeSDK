...
#define RPG_CLIENT_LIGHTCONEQUICKGROWCALCULATOR___C__DISPLAYCLASS23_0__CTOR_OFFSET UNITYSDK_OFFSET(0x16C6FE00)
#define RPG_CLIENT_LIGHTCONEQUICKGROWCALCULATOR___C__DISPLAYCLASS23_0___FILLEXPUSAGESUMMARY_B__0_OFFSET UNITYSDK_OFFSET(0x16C71D80)
#define RPG_CLIENT_LIGHTCONEQUICKGROWCALCULATOR___C__DISPLAYCLASS23_0___FILLEXPUSAGESUMMARY_B__1_OFFSET UNITYSDK_OFFSET(0x16C71DA0)

namespace RPG::Client
{
	inline static constexpr unsigned int LightConeQuickGrowCalculator___c__DisplayClass23_0_TypeDefinitionIndex = 62804;
