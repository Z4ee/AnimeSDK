...
#define RPG_CLIENT_GRIDFIGHTROLEAUTOSELLEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD4FA00)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightRoleAutoSellEvent_TypeDefinitionIndex = 62227;
