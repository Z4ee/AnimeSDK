...
#define RPG_CLIENT_STREAMINGFEATURE__CTOR_OFFSET UNITYSDK_OFFSET(0xA4EF300)

namespace RPG::Client
{
	inline static constexpr unsigned int StreamingFeature_TypeDefinitionIndex = 55436;
