...
#define RPG_CLIENT_MAP_MAPOBJECTSUPDATEREQUEST__GET_TOBEDESTROYOBJECTS_D__35_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xA7D2A10)
#define RPG_CLIENT_MAP_MAPOBJECTSUPDATEREQUEST__GET_TOBEDESTROYOBJECTS_D__35_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_RPG_CLIENT_MAPENTITYDEF__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xA7D2CC0)
#define RPG_CLIENT_MAP_MAPOBJECTSUPDATEREQUEST__GET_TOBEDESTROYOBJECTS_D__35_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_RPG_CLIENT_MAPENTITYDEF__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xA7D2C50)
#define RPG_CLIENT_MAP_MAPOBJECTSUPDATEREQUEST__GET_TOBEDESTROYOBJECTS_D__35_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xA7D2D20)
#define RPG_CLIENT_MAP_MAPOBJECTSUPDATEREQUEST__GET_TOBEDESTROYOBJECTS_D__35_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xA7D2CB0)
#define RPG_CLIENT_MAP_MAPOBJECTSUPDATEREQUEST__GET_TOBEDESTROYOBJECTS_D__35_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xA7D2C60)
#define RPG_CLIENT_MAP_MAPOBJECTSUPDATEREQUEST__GET_TOBEDESTROYOBJECTS_D__35_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA7D29D0)
#define RPG_CLIENT_MAP_MAPOBJECTSUPDATEREQUEST__GET_TOBEDESTROYOBJECTS_D__35__CTOR_OFFSET UNITYSDK_OFFSET(0xA7D08C0)
#define RPG_CLIENT_MAP_MAPOBJECTSUPDATEREQUEST__GET_TOBEDESTROYOBJECTS_D__35___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0xA7D29E0)
#define RPG_CLIENT_MAP_MAPOBJECTSUPDATEREQUEST__GET_TOBEDESTROYOBJECTS_D__35___M__FINALLY2_OFFSET UNITYSDK_OFFSET(0xA7D2A00)
#define RPG_CLIENT_MAP_MAPOBJECTSUPDATEREQUEST__GET_TOBEDESTROYOBJECTS_D__35___M__FINALLY3_OFFSET UNITYSDK_OFFSET(0xA7D29F0)

namespace RPG::Client
{
	inline static constexpr unsigned int Map_MapObjectsUpdateRequest__get_ToBeDestroyObjects_d__35_TypeDefinitionIndex = 56131;
