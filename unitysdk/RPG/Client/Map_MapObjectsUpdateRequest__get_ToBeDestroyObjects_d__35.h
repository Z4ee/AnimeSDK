...
#define RPG_CLIENT_MAP_MAPOBJECTSUPDATEREQUEST__GET_TOBEDESTROYOBJECTS_D__35_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x174C69A0)
#define RPG_CLIENT_MAP_MAPOBJECTSUPDATEREQUEST__GET_TOBEDESTROYOBJECTS_D__35_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_RPG_CLIENT_MAPENTITYDEF__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x174C6D10)
#define RPG_CLIENT_MAP_MAPOBJECTSUPDATEREQUEST__GET_TOBEDESTROYOBJECTS_D__35_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_RPG_CLIENT_MAPENTITYDEF__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x174C6CA0)
#define RPG_CLIENT_MAP_MAPOBJECTSUPDATEREQUEST__GET_TOBEDESTROYOBJECTS_D__35_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x174C6D70)
#define RPG_CLIENT_MAP_MAPOBJECTSUPDATEREQUEST__GET_TOBEDESTROYOBJECTS_D__35_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x174C6D00)
#define RPG_CLIENT_MAP_MAPOBJECTSUPDATEREQUEST__GET_TOBEDESTROYOBJECTS_D__35_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x174C6CB0)
#define RPG_CLIENT_MAP_MAPOBJECTSUPDATEREQUEST__GET_TOBEDESTROYOBJECTS_D__35_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x174C6960)
#define RPG_CLIENT_MAP_MAPOBJECTSUPDATEREQUEST__GET_TOBEDESTROYOBJECTS_D__35__CTOR_OFFSET UNITYSDK_OFFSET(0x174C51E0)
#define RPG_CLIENT_MAP_MAPOBJECTSUPDATEREQUEST__GET_TOBEDESTROYOBJECTS_D__35___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x174C6970)
#define RPG_CLIENT_MAP_MAPOBJECTSUPDATEREQUEST__GET_TOBEDESTROYOBJECTS_D__35___M__FINALLY2_OFFSET UNITYSDK_OFFSET(0x174C6990)
#define RPG_CLIENT_MAP_MAPOBJECTSUPDATEREQUEST__GET_TOBEDESTROYOBJECTS_D__35___M__FINALLY3_OFFSET UNITYSDK_OFFSET(0x174C6980)
