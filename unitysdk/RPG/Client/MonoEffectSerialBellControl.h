...
#define RPG_CLIENT_MONOEFFECTSERIALBELLCONTROL_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x9CE6DC0)
#define RPG_CLIENT_MONOEFFECTSERIALBELLCONTROL_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x9CE6C80)
#define RPG_CLIENT_MONOEFFECTSERIALBELLCONTROL_METHOD_5_E068CA3AB067589D_OFFSET UNITYSDK_OFFSET(0x9CE6CF0)
#define RPG_CLIENT_MONOEFFECTSERIALBELLCONTROL_ONENABLE_OFFSET UNITYSDK_OFFSET(0x9CE6ED0)
#define RPG_CLIENT_MONOEFFECTSERIALBELLCONTROL_UPDATE_OFFSET UNITYSDK_OFFSET(0x9CE6F40)
#define RPG_CLIENT_MONOEFFECTSERIALBELLCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x9CE7270)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectSerialBellControl_TypeDefinitionIndex = 57940;
