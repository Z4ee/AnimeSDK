...
#define RPG_CLIENT_MONOFULLBODYIK_AWAKE_OFFSET UNITYSDK_OFFSET(0x1ACDBA10)
#define RPG_CLIENT_MONOFULLBODYIK_CLOSEIDLESHOW_OFFSET UNITYSDK_OFFSET(0x1ACDB9B0)
#define RPG_CLIENT_MONOFULLBODYIK_GET_ISPROCESSABLE_OFFSET UNITYSDK_OFFSET(0x1ACDAD50)
#define RPG_CLIENT_MONOFULLBODYIK_INIT_OFFSET UNITYSDK_OFFSET(0x1ACDAAC0)
#define RPG_CLIENT_MONOFULLBODYIK_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1ACDBA60)
#define RPG_CLIENT_MONOFULLBODYIK_METHOD_5_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x1ACDBEA0)
#define RPG_CLIENT_MONOFULLBODYIK_METHOD_5_E6ACF41C29FA8932_OFFSET UNITYSDK_OFFSET(0x1ACDBCD0)
#define RPG_CLIENT_MONOFULLBODYIK_METHOD_5_E949A493D26573BF_OFFSET UNITYSDK_OFFSET(0x1ACDBB40)
#define RPG_CLIENT_MONOFULLBODYIK_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1ACDBAC0)
#define RPG_CLIENT_MONOFULLBODYIK_PROCESS_OFFSET UNITYSDK_OFFSET(0x1ACDAD60)
#define RPG_CLIENT_MONOFULLBODYIK_RESETLIMBCHAINEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1ACDB370)
#define RPG_CLIENT_MONOFULLBODYIK_SAFEINIT_OFFSET UNITYSDK_OFFSET(0x1ACDA3A0)
#define RPG_CLIENT_MONOFULLBODYIK_SETFORCEUSELIMBCHAINEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1ACDAE30)
#define RPG_CLIENT_MONOFULLBODYIK_SETUPLIMBCHAINBENDGOALWEIGHTBLEND_OFFSET UNITYSDK_OFFSET(0x1ACDB850)
#define RPG_CLIENT_MONOFULLBODYIK_SETUPLIMBCHAINBENDGOAL_OFFSET UNITYSDK_OFFSET(0x1ACDB930)
#define RPG_CLIENT_MONOFULLBODYIK_SETUPLIMBCHAINEFFECTORBLEND_OFFSET UNITYSDK_OFFSET(0x1ACDB0E0)
#define RPG_CLIENT_MONOFULLBODYIK_SETUPLIMBCHAINEFFECTOR_OFFSET UNITYSDK_OFFSET(0x1ACDAF30)
#define RPG_CLIENT_MONOFULLBODYIK_SETUPLIMBCHAINMAPPINGWEIGHTBLEND_OFFSET UNITYSDK_OFFSET(0x1ACDB760)
#define RPG_CLIENT_MONOFULLBODYIK_SETUPLIMBCHAINPOSITIONWEIGHTBLEND_OFFSET UNITYSDK_OFFSET(0x1ACDB580)
#define RPG_CLIENT_MONOFULLBODYIK_SETUPLIMBCHAINROTATIONWEIGHTBLEND_OFFSET UNITYSDK_OFFSET(0x1ACDB670)
#define RPG_CLIENT_MONOFULLBODYIK_SETUPLIMBCHAINWEIGHTBLEND_OFFSET UNITYSDK_OFFSET(0x1ACDB4C0)
#define RPG_CLIENT_MONOFULLBODYIK_UNINIT_OFFSET UNITYSDK_OFFSET(0x1ACDAA60)
#define RPG_CLIENT_MONOFULLBODYIK__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACDC670)
