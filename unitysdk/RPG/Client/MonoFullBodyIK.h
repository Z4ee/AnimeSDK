...
class Class_1_D78DE784A122ADBE;
...
#define RPG_CLIENT_MONOFULLBODYIK_AWAKE_OFFSET UNITYSDK_OFFSET(0x9D035B0)
#define RPG_CLIENT_MONOFULLBODYIK_GET_ISPROCESSABLE_OFFSET UNITYSDK_OFFSET(0x9D02AC0)
#define RPG_CLIENT_MONOFULLBODYIK_INIT_OFFSET UNITYSDK_OFFSET(0x9D027C0)
#define RPG_CLIENT_MONOFULLBODYIK_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x9D03600)
#define RPG_CLIENT_MONOFULLBODYIK_METHOD_5_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x9D03A90)
#define RPG_CLIENT_MONOFULLBODYIK_METHOD_5_E6ACF41C29FA8932_OFFSET UNITYSDK_OFFSET(0x9D03890)
#define RPG_CLIENT_MONOFULLBODYIK_METHOD_5_E949A493D26573BF_OFFSET UNITYSDK_OFFSET(0x9D036E0)
#define RPG_CLIENT_MONOFULLBODYIK_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9D03660)
#define RPG_CLIENT_MONOFULLBODYIK_PROCESS_OFFSET UNITYSDK_OFFSET(0x9D02AD0)
#define RPG_CLIENT_MONOFULLBODYIK_RESETLIMBCHAINEFFECTOR_OFFSET UNITYSDK_OFFSET(0x9D02F50)
#define RPG_CLIENT_MONOFULLBODYIK_SAFEINIT_OFFSET UNITYSDK_OFFSET(0x9D01F60)
#define RPG_CLIENT_MONOFULLBODYIK_SETFORCEUSELIMBCHAINEFFECTOR_OFFSET UNITYSDK_OFFSET(0x9D02BB0)
#define RPG_CLIENT_MONOFULLBODYIK_SETUPLIMBCHAINBENDGOALWEIGHTBLEND_OFFSET UNITYSDK_OFFSET(0x9D03430)
#define RPG_CLIENT_MONOFULLBODYIK_SETUPLIMBCHAINBENDGOAL_OFFSET UNITYSDK_OFFSET(0x9D03520)
#define RPG_CLIENT_MONOFULLBODYIK_SETUPLIMBCHAINEFFECTORBLEND_OFFSET UNITYSDK_OFFSET(0x9D02E50)
#define RPG_CLIENT_MONOFULLBODYIK_SETUPLIMBCHAINEFFECTOR_OFFSET UNITYSDK_OFFSET(0x9D02CA0)
#define RPG_CLIENT_MONOFULLBODYIK_SETUPLIMBCHAINMAPPINGWEIGHTBLEND_OFFSET UNITYSDK_OFFSET(0x9D03340)
#define RPG_CLIENT_MONOFULLBODYIK_SETUPLIMBCHAINPOSITIONWEIGHTBLEND_OFFSET UNITYSDK_OFFSET(0x9D03160)
#define RPG_CLIENT_MONOFULLBODYIK_SETUPLIMBCHAINROTATIONWEIGHTBLEND_OFFSET UNITYSDK_OFFSET(0x9D03250)
#define RPG_CLIENT_MONOFULLBODYIK_SETUPLIMBCHAINWEIGHTBLEND_OFFSET UNITYSDK_OFFSET(0x9D030A0)
#define RPG_CLIENT_MONOFULLBODYIK_UNINIT_OFFSET UNITYSDK_OFFSET(0x9D02760)
#define RPG_CLIENT_MONOFULLBODYIK__CTOR_OFFSET UNITYSDK_OFFSET(0x9D04260)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoFullBodyIK_TypeDefinitionIndex = 56020;
	...
	public:
		...
		::Il2CppArray<::Class_1_D78DE784A122ADBE*>* Field_5_2; // 0x20
