...
#define RPG_CLIENT_MONOPOLYROLLRANDOMRESULTDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x9D70090)
#define RPG_CLIENT_MONOPOLYROLLRANDOMRESULTDATA_GET_EXTRAROLLRESULT_OFFSET UNITYSDK_OFFSET(0x9D77170)
#define RPG_CLIENT_MONOPOLYROLLRANDOMRESULTDATA_GET_OPTIONID_OFFSET UNITYSDK_OFFSET(0x9D77130)
#define RPG_CLIENT_MONOPOLYROLLRANDOMRESULTDATA_GET_ROLLRANDOMLIST_OFFSET UNITYSDK_OFFSET(0x9D77150)
#define RPG_CLIENT_MONOPOLYROLLRANDOMRESULTDATA_SET_EXTRAROLLRESULT_OFFSET UNITYSDK_OFFSET(0x9D77180)
#define RPG_CLIENT_MONOPOLYROLLRANDOMRESULTDATA_SET_OPTIONID_OFFSET UNITYSDK_OFFSET(0x9D77140)
#define RPG_CLIENT_MONOPOLYROLLRANDOMRESULTDATA_SET_ROLLRANDOMLIST_OFFSET UNITYSDK_OFFSET(0x9D77160)
#define RPG_CLIENT_MONOPOLYROLLRANDOMRESULTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9D77120)

namespace RPG::Client
{
	inline static constexpr unsigned int MonopolyRollRandomResultData_TypeDefinitionIndex = 53866;
