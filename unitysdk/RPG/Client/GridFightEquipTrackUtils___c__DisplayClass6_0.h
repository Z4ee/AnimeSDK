...
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACKUTILS___C__DISPLAYCLASS6_0__CTOR_OFFSET UNITYSDK_OFFSET(0xBB33880)
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACKUTILS___C__DISPLAYCLASS6_0__ISROLEEQUIPPEDWITH_B__0_OFFSET UNITYSDK_OFFSET(0xBB34740)
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACKUTILS___C__DISPLAYCLASS6_0__ISROLEEQUIPPEDWITH_B__1_OFFSET UNITYSDK_OFFSET(0xBB34780)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightEquipTrackUtils___c__DisplayClass6_0_TypeDefinitionIndex = 61104;
