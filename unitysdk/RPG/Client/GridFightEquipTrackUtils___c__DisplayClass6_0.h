...
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACKUTILS___C__DISPLAYCLASS6_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9811210)
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACKUTILS___C__DISPLAYCLASS6_0__ISROLEEQUIPPEDWITH_B__0_OFFSET UNITYSDK_OFFSET(0x9811DA0)
#define RPG_CLIENT_GRIDFIGHTEQUIPTRACKUTILS___C__DISPLAYCLASS6_0__ISROLEEQUIPPEDWITH_B__1_OFFSET UNITYSDK_OFFSET(0x9811DE0)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightEquipTrackUtils___c__DisplayClass6_0_TypeDefinitionIndex = 53074;
