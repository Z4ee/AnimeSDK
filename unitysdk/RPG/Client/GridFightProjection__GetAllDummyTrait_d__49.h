...
#define RPG_CLIENT_GRIDFIGHTPROJECTION__GETALLDUMMYTRAIT_D__49_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xD2EF3F0)
#define RPG_CLIENT_GRIDFIGHTPROJECTION__GETALLDUMMYTRAIT_D__49_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_RPG_CLIENT_GRIDFIGHTTRAIT__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xD2EF560)
#define RPG_CLIENT_GRIDFIGHTPROJECTION__GETALLDUMMYTRAIT_D__49_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_RPG_CLIENT_GRIDFIGHTTRAIT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xD2EF4F0)
#define RPG_CLIENT_GRIDFIGHTPROJECTION__GETALLDUMMYTRAIT_D__49_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xD2EF5E0)
#define RPG_CLIENT_GRIDFIGHTPROJECTION__GETALLDUMMYTRAIT_D__49_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xD2EF550)
#define RPG_CLIENT_GRIDFIGHTPROJECTION__GETALLDUMMYTRAIT_D__49_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xD2EF500)
#define RPG_CLIENT_GRIDFIGHTPROJECTION__GETALLDUMMYTRAIT_D__49_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD2EF3E0)
#define RPG_CLIENT_GRIDFIGHTPROJECTION__GETALLDUMMYTRAIT_D__49__CTOR_OFFSET UNITYSDK_OFFSET(0xD2EF3A0)
