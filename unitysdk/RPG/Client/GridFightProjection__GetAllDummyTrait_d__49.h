...
#define RPG_CLIENT_GRIDFIGHTPROJECTION__GETALLDUMMYTRAIT_D__49_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1AEA55B0)
#define RPG_CLIENT_GRIDFIGHTPROJECTION__GETALLDUMMYTRAIT_D__49_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_RPG_CLIENT_GRIDFIGHTTRAIT__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1AEA5720)
#define RPG_CLIENT_GRIDFIGHTPROJECTION__GETALLDUMMYTRAIT_D__49_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_RPG_CLIENT_GRIDFIGHTTRAIT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AEA56B0)
#define RPG_CLIENT_GRIDFIGHTPROJECTION__GETALLDUMMYTRAIT_D__49_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1AEA57A0)
#define RPG_CLIENT_GRIDFIGHTPROJECTION__GETALLDUMMYTRAIT_D__49_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AEA5710)
#define RPG_CLIENT_GRIDFIGHTPROJECTION__GETALLDUMMYTRAIT_D__49_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1AEA56C0)
#define RPG_CLIENT_GRIDFIGHTPROJECTION__GETALLDUMMYTRAIT_D__49_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AEA55A0)
#define RPG_CLIENT_GRIDFIGHTPROJECTION__GETALLDUMMYTRAIT_D__49__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEA5560)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightProjection__GetAllDummyTrait_d__49_TypeDefinitionIndex = 62153;
