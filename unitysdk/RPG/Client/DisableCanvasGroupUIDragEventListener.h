...
#define RPG_CLIENT_DISABLECANVASGROUPUIDRAGEVENTLISTENER_ADDDISABLECANVASGROUP_OFFSET UNITYSDK_OFFSET(0xCD7DFD0)
#define RPG_CLIENT_DISABLECANVASGROUPUIDRAGEVENTLISTENER_REMOVEDISABLECANVASGROUP_OFFSET UNITYSDK_OFFSET(0xCD7E0D0)
#define RPG_CLIENT_DISABLECANVASGROUPUIDRAGEVENTLISTENER_RPG_CLIENT_IUIDRAGEVENTLISTENER_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0xCD7DD90)
#define RPG_CLIENT_DISABLECANVASGROUPUIDRAGEVENTLISTENER_RPG_CLIENT_IUIDRAGEVENTLISTENER_ONSTARTDRAG_OFFSET UNITYSDK_OFFSET(0xCD7DEB0)
#define RPG_CLIENT_DISABLECANVASGROUPUIDRAGEVENTLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0xCD7E170)

namespace RPG::Client
{
	inline static constexpr unsigned int DisableCanvasGroupUIDragEventListener_TypeDefinitionIndex = 72969;
