...
#define RPG_CLIENT_DISABLECANVASGROUPUIDRAGEVENTLISTENER_ADDDISABLECANVASGROUP_OFFSET UNITYSDK_OFFSET(0x1A008F20)
#define RPG_CLIENT_DISABLECANVASGROUPUIDRAGEVENTLISTENER_REMOVEDISABLECANVASGROUP_OFFSET UNITYSDK_OFFSET(0x1A009020)
#define RPG_CLIENT_DISABLECANVASGROUPUIDRAGEVENTLISTENER_RPG_CLIENT_IUIDRAGEVENTLISTENER_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x1A008CE0)
#define RPG_CLIENT_DISABLECANVASGROUPUIDRAGEVENTLISTENER_RPG_CLIENT_IUIDRAGEVENTLISTENER_ONSTARTDRAG_OFFSET UNITYSDK_OFFSET(0x1A008E00)
#define RPG_CLIENT_DISABLECANVASGROUPUIDRAGEVENTLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0090C0)

namespace RPG::Client
{
	inline static constexpr unsigned int DisableCanvasGroupUIDragEventListener_TypeDefinitionIndex = 69713;
