...
#define RPG_CLIENT_PHOTOGRAPHFILTERCONFIGASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1866D590)

namespace RPG::Client
{
	inline static constexpr unsigned int PhotoGraphFilterConfigAsset_TypeDefinitionIndex = 69411;
