...
#define RPG_CLIENT_MONOROTATINGBLOCKCONTROL_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A349D60)
#define RPG_CLIENT_MONOROTATINGBLOCKCONTROL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A349E90)
#define RPG_CLIENT_MONOROTATINGBLOCKCONTROL_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A349DD0)
#define RPG_CLIENT_MONOROTATINGBLOCKCONTROL_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A349E30)
#define RPG_CLIENT_MONOROTATINGBLOCKCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A349F20)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoRotatingBlockControl_TypeDefinitionIndex = 67584;
