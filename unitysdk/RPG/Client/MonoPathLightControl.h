...
#define RPG_CLIENT_MONOPATHLIGHTCONTROL_AWAKE_OFFSET UNITYSDK_OFFSET(0xA9E9D00)
#define RPG_CLIENT_MONOPATHLIGHTCONTROL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xA9E9E40)
#define RPG_CLIENT_MONOPATHLIGHTCONTROL_ONENABLE_OFFSET UNITYSDK_OFFSET(0xA9E9D80)
#define RPG_CLIENT_MONOPATHLIGHTCONTROL_UPDATE_OFFSET UNITYSDK_OFFSET(0xA9E9DE0)
#define RPG_CLIENT_MONOPATHLIGHTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xA9E9ED0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoPathLightControl_TypeDefinitionIndex = 63277;
