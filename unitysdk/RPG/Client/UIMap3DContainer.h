...
#define RPG_CLIENT_UIMAP3DCONTAINER_GETMAPBOUNDINGBOX_OFFSET UNITYSDK_OFFSET(0x17B5AE40)
#define RPG_CLIENT_UIMAP3DCONTAINER_GETMAPBOUNDINGSPHERE_OFFSET UNITYSDK_OFFSET(0x17B5C200)
#define RPG_CLIENT_UIMAP3DCONTAINER_GETMAPROTATION_OFFSET UNITYSDK_OFFSET(0x17B5ACF0)
#define RPG_CLIENT_UIMAP3DCONTAINER_GET_VIEWMODELROTATION_OFFSET UNITYSDK_OFFSET(0x17B5A260)
#define RPG_CLIENT_UIMAP3DCONTAINER_GET__CURRENTMODELUP_OFFSET UNITYSDK_OFFSET(0x17B5DF80)
#define RPG_CLIENT_UIMAP3DCONTAINER_GET__INITMODELUP_OFFSET UNITYSDK_OFFSET(0x17B607D0)
#define RPG_CLIENT_UIMAP3DCONTAINER_GET__MAPMODELTRANSFORM_OFFSET UNITYSDK_OFFSET(0x17B5A200)
#define RPG_CLIENT_UIMAP3DCONTAINER_GET__POSETRANSFORMS_OFFSET UNITYSDK_OFFSET(0x17B5C0D0)
#define RPG_CLIENT_UIMAP3DCONTAINER_INIT_OFFSET UNITYSDK_OFFSET(0x17B59D10)
#define RPG_CLIENT_UIMAP3DCONTAINER_MANUALUPDATE_OFFSET UNITYSDK_OFFSET(0x17B5D2D0)
#define RPG_CLIENT_UIMAP3DCONTAINER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x17B5DB20)
#define RPG_CLIENT_UIMAP3DCONTAINER_RESET_OFFSET UNITYSDK_OFFSET(0x17B5D060)
#define RPG_CLIENT_UIMAP3DCONTAINER_UPDATE_OFFSET UNITYSDK_OFFSET(0x17B5CFF0)
#define RPG_CLIENT_UIMAP3DCONTAINER__CCTOR_OFFSET UNITYSDK_OFFSET(0x17B60AC0)
#define RPG_CLIENT_UIMAP3DCONTAINER__CLAMPPITCH_OFFSET UNITYSDK_OFFSET(0x17B60030)
#define RPG_CLIENT_UIMAP3DCONTAINER__CLEARDAMPINGRECOVERSTATES_OFFSET UNITYSDK_OFFSET(0x17B5D0E0)
#define RPG_CLIENT_UIMAP3DCONTAINER__CLEARROTATELOCK_OFFSET UNITYSDK_OFFSET(0x17B5DE20)
#define RPG_CLIENT_UIMAP3DCONTAINER__COMPUTEPITCHOUTRATIO_OFFSET UNITYSDK_OFFSET(0x17B5EBB0)
#define RPG_CLIENT_UIMAP3DCONTAINER__COMPUTEROTATESPEEDDAMPING_OFFSET UNITYSDK_OFFSET(0x17B5DE70)
#define RPG_CLIENT_UIMAP3DCONTAINER__COMPUTEROTATESPEEDDEFAULT_OFFSET UNITYSDK_OFFSET(0x17B5DCD0)
#define RPG_CLIENT_UIMAP3DCONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x17B609B0)
#define RPG_CLIENT_UIMAP3DCONTAINER__FETCHROTATEINPUT_OFFSET UNITYSDK_OFFSET(0x17B5E870)
#define RPG_CLIENT_UIMAP3DCONTAINER__INITPOSETRANSPROVIDER_OFFSET UNITYSDK_OFFSET(0x17B5A4C0)
#define RPG_CLIENT_UIMAP3DCONTAINER__INITUNWALKABLE_OFFSET UNITYSDK_OFFSET(0x17B5AAA0)
#define RPG_CLIENT_UIMAP3DCONTAINER__ONMAP3DTOUCHENABLED_OFFSET UNITYSDK_OFFSET(0x17B5FFD0)
#define RPG_CLIENT_UIMAP3DCONTAINER__RECOVERPITCH_OFFSET UNITYSDK_OFFSET(0x17B5E190)
#define RPG_CLIENT_UIMAP3DCONTAINER__ROTATEMODEL_OFFSET UNITYSDK_OFFSET(0x17B5D620)
#define RPG_CLIENT_UIMAP3DCONTAINER__SETLAYERRECURSIVELY_OFFSET UNITYSDK_OFFSET(0x17B5A810)
#define RPG_CLIENT_UIMAP3DCONTAINER__STARTRESETROTATION_OFFSET UNITYSDK_OFFSET(0x17B5D130)
#define RPG_CLIENT_UIMAP3DCONTAINER__SYNCMAPTRANSFORM_OFFSET UNITYSDK_OFFSET(0x17B5A910)
#define RPG_CLIENT_UIMAP3DCONTAINER__UPDATEMAPTRANSPARENCY_OFFSET UNITYSDK_OFFSET(0x17B5F310)
#define RPG_CLIENT_UIMAP3DCONTAINER__UPDATERESET_OFFSET UNITYSDK_OFFSET(0x17B5D370)

namespace RPG::Client
{
	inline static constexpr unsigned int UIMap3DContainer_TypeDefinitionIndex = 69018;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIMap3DContainer_TypeDefinitionIndex)->GetStaticField(0x142A0);
		}
		static ::System::Int32* StaticGet_s_Color()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIMap3DContainer_TypeDefinitionIndex)->GetStaticField(0x142A4);
		}
