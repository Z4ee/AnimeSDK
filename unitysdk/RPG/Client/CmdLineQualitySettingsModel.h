...
#define RPG_CLIENT_CMDLINEQUALITYSETTINGSMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1E58C660)

namespace RPG::Client
{
	inline static constexpr unsigned int CmdLineQualitySettingsModel_TypeDefinitionIndex = 34542;
