...
#define RPG_CLIENT_CMDLINEQUALITYSETTINGSMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1833D160)

namespace RPG::Client
{
	inline static constexpr unsigned int CmdLineQualitySettingsModel_TypeDefinitionIndex = 9439;
