...
#define RPG_CLIENT_CMDLINEQUALITYSETTINGSMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x19D92D20)

namespace RPG::Client
{
	inline static constexpr unsigned int CmdLineQualitySettingsModel_TypeDefinitionIndex = 9637;
