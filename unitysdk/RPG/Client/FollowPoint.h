...
#define RPG_CLIENT_FOLLOWPOINT_GET_ISFOLLOWDYNAMIC_OFFSET UNITYSDK_OFFSET(0x16D16810)
#define RPG_CLIENT_FOLLOWPOINT_GET_ISPOINTDYNAMIC_OFFSET UNITYSDK_OFFSET(0x16D16740)
#define RPG_CLIENT_FOLLOWPOINT_METHOD_1_18D9238B9C310BFF_OFFSET UNITYSDK_OFFSET(0x16D16130)
#define RPG_CLIENT_FOLLOWPOINT_METHOD_1_25DEA5C65A602671_OFFSET UNITYSDK_OFFSET(0x16D15FD0)
#define RPG_CLIENT_FOLLOWPOINT_METHOD_1_BF972395CC722BF9_OFFSET UNITYSDK_OFFSET(0x16D16670)
#define RPG_CLIENT_FOLLOWPOINT_METHOD_1_D83D54151A7C7525_OFFSET UNITYSDK_OFFSET(0x16D15EC0)
#define RPG_CLIENT_FOLLOWPOINT_METHOD_1_EDFD49C942C75D6C_OFFSET UNITYSDK_OFFSET(0x16D16250)
#define RPG_CLIENT_FOLLOWPOINT_SET_ISFOLLOWDYNAMIC_OFFSET UNITYSDK_OFFSET(0x16D16870)
#define RPG_CLIENT_FOLLOWPOINT_SET_ISPOINTDYNAMIC_OFFSET UNITYSDK_OFFSET(0x16D167A0)
#define RPG_CLIENT_FOLLOWPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x16D168E0)

namespace RPG::Client
{
	inline static constexpr unsigned int FollowPoint_TypeDefinitionIndex = 65379;
