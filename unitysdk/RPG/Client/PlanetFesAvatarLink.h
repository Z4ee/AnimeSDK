...
#define RPG_CLIENT_PLANETFESAVATARLINK_GETSORTAVATAR_OFFSET UNITYSDK_OFFSET(0x1C35EC00)
#define RPG_CLIENT_PLANETFESAVATARLINK_GETWORKINGLINKAVATARIDS_OFFSET UNITYSDK_OFFSET(0x1C35E6C0)
#define RPG_CLIENT_PLANETFESAVATARLINK_HASAVATARWORKING_OFFSET UNITYSDK_OFFSET(0x1C35E610)
#define RPG_CLIENT_PLANETFESAVATARLINK_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1C35EFC0)
#define RPG_CLIENT_PLANETFESAVATARLINK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C35F150)
#define RPG_CLIENT_PLANETFESAVATARLINK__ISWORKING_OFFSET UNITYSDK_OFFSET(0x1C35EA70)

namespace RPG::Client
{
	inline static constexpr unsigned int PlanetFesAvatarLink_TypeDefinitionIndex = 66559;
