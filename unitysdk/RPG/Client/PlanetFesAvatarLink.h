...
#define RPG_CLIENT_PLANETFESAVATARLINK_GETSORTAVATAR_OFFSET UNITYSDK_OFFSET(0xC3FFAB0)
#define RPG_CLIENT_PLANETFESAVATARLINK_GETWORKINGLINKAVATARIDS_OFFSET UNITYSDK_OFFSET(0xC3FF620)
#define RPG_CLIENT_PLANETFESAVATARLINK_HASAVATARWORKING_OFFSET UNITYSDK_OFFSET(0xC3FF570)
#define RPG_CLIENT_PLANETFESAVATARLINK_ISACTIVE_OFFSET UNITYSDK_OFFSET(0xC3FFC80)
#define RPG_CLIENT_PLANETFESAVATARLINK__CTOR_OFFSET UNITYSDK_OFFSET(0xC3FFE10)
#define RPG_CLIENT_PLANETFESAVATARLINK__ISWORKING_OFFSET UNITYSDK_OFFSET(0xC3FF9D0)

namespace RPG::Client
{
	inline static constexpr unsigned int PlanetFesAvatarLink_TypeDefinitionIndex = 62208;
