...
#define RPG_CLIENT_PLANETFESAVATARLINK_GETSORTAVATAR_OFFSET UNITYSDK_OFFSET(0xDB38CF0)
#define RPG_CLIENT_PLANETFESAVATARLINK_GETWORKINGLINKAVATARIDS_OFFSET UNITYSDK_OFFSET(0xDB387B0)
#define RPG_CLIENT_PLANETFESAVATARLINK_HASAVATARWORKING_OFFSET UNITYSDK_OFFSET(0xDB38700)
#define RPG_CLIENT_PLANETFESAVATARLINK_ISACTIVE_OFFSET UNITYSDK_OFFSET(0xDB390B0)
#define RPG_CLIENT_PLANETFESAVATARLINK__CTOR_OFFSET UNITYSDK_OFFSET(0xDB39240)
#define RPG_CLIENT_PLANETFESAVATARLINK__ISWORKING_OFFSET UNITYSDK_OFFSET(0xDB38B60)
