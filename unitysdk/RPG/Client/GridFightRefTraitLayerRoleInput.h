...
#define RPG_CLIENT_GRIDFIGHTREFTRAITLAYERROLEINPUT_GET_EQUIPIDS_OFFSET UNITYSDK_OFFSET(0x1AEADA10)
#define RPG_CLIENT_GRIDFIGHTREFTRAITLAYERROLEINPUT_GET_ROLEID_OFFSET UNITYSDK_OFFSET(0x1AEAD9F0)
#define RPG_CLIENT_GRIDFIGHTREFTRAITLAYERROLEINPUT_RPG_CLIENT_IGRIDFIGHTREFTRAITLAYERROLEINPUT_GET_EQUIPIDS_OFFSET UNITYSDK_OFFSET(0x1AEADA30)
#define RPG_CLIENT_GRIDFIGHTREFTRAITLAYERROLEINPUT_SET_EQUIPIDS_OFFSET UNITYSDK_OFFSET(0x1AEADA20)
#define RPG_CLIENT_GRIDFIGHTREFTRAITLAYERROLEINPUT_SET_ROLEID_OFFSET UNITYSDK_OFFSET(0x1AEADA00)
#define RPG_CLIENT_GRIDFIGHTREFTRAITLAYERROLEINPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEADA80)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightRefTraitLayerRoleInput_TypeDefinitionIndex = 61892;
