...
#define RPG_CLIENT_GRIDFIGHTREFTRAITLAYERROLEINPUT_GET_EQUIPIDS_OFFSET UNITYSDK_OFFSET(0xD2F7930)
#define RPG_CLIENT_GRIDFIGHTREFTRAITLAYERROLEINPUT_GET_ROLEID_OFFSET UNITYSDK_OFFSET(0xD2F7910)
#define RPG_CLIENT_GRIDFIGHTREFTRAITLAYERROLEINPUT_RPG_CLIENT_IGRIDFIGHTREFTRAITLAYERROLEINPUT_GET_EQUIPIDS_OFFSET UNITYSDK_OFFSET(0xD2F7950)
#define RPG_CLIENT_GRIDFIGHTREFTRAITLAYERROLEINPUT_SET_EQUIPIDS_OFFSET UNITYSDK_OFFSET(0xD2F7940)
#define RPG_CLIENT_GRIDFIGHTREFTRAITLAYERROLEINPUT_SET_ROLEID_OFFSET UNITYSDK_OFFSET(0xD2F7920)
#define RPG_CLIENT_GRIDFIGHTREFTRAITLAYERROLEINPUT__CTOR_OFFSET UNITYSDK_OFFSET(0xD2F79A0)
