...
#define RPG_CLIENT_RPGPROFILERMARKERWITHINTDATA_BEGIN_OFFSET UNITYSDK_OFFSET(0x1D2A00D0)
#define RPG_CLIENT_RPGPROFILERMARKERWITHINTDATA_END_OFFSET UNITYSDK_OFFSET(0x1D2A0250)
#define RPG_CLIENT_RPGPROFILERMARKERWITHINTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2A0000)

namespace RPG::Client
{
	inline static constexpr unsigned int RPGProfilerMarkerWithIntData_TypeDefinitionIndex = 33733;
