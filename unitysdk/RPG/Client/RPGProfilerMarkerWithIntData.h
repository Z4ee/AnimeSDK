...
#define RPG_CLIENT_RPGPROFILERMARKERWITHINTDATA_BEGIN_OFFSET UNITYSDK_OFFSET(0x1EF92510)
#define RPG_CLIENT_RPGPROFILERMARKERWITHINTDATA_END_OFFSET UNITYSDK_OFFSET(0x1EF92690)
#define RPG_CLIENT_RPGPROFILERMARKERWITHINTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1EF92440)

namespace RPG::Client
{
	inline static constexpr unsigned int RPGProfilerMarkerWithIntData_TypeDefinitionIndex = 34499;
