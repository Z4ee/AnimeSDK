...
#define RPG_CLIENT_RPGPROFILERMARKERWITHINTDATA_BEGIN_OFFSET UNITYSDK_OFFSET(0x19D32EF0)
#define RPG_CLIENT_RPGPROFILERMARKERWITHINTDATA_END_OFFSET UNITYSDK_OFFSET(0x19D33070)
#define RPG_CLIENT_RPGPROFILERMARKERWITHINTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19D32E20)

namespace RPG::Client
{
	inline static constexpr unsigned int RPGProfilerMarkerWithIntData_TypeDefinitionIndex = 33254;
