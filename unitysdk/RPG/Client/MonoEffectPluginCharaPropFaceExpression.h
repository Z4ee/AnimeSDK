...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACEEXPRESSION_INIT_OFFSET UNITYSDK_OFFSET(0xD7A0220)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACEEXPRESSION_UNINIT_OFFSET UNITYSDK_OFFSET(0xD7A0A30)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACEEXPRESSION_UPDATEPROPERTY_OFFSET UNITYSDK_OFFSET(0xD7A02C0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACEEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0xD7A0A80)
