...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACEEXPRESSION_INIT_OFFSET UNITYSDK_OFFSET(0x9CB5280)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACEEXPRESSION_UNINIT_OFFSET UNITYSDK_OFFSET(0x9CB5A80)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACEEXPRESSION_UPDATEPROPERTY_OFFSET UNITYSDK_OFFSET(0x9CB5320)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACEEXPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x9CB5B20)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACEEXPRESSION___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0x9CB5B60)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACEEXPRESSION___IFIXBASEPROXY_UNINIT_OFFSET UNITYSDK_OFFSET(0x9CB5B70)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginCharaPropFaceExpression_TypeDefinitionIndex = 57235;
