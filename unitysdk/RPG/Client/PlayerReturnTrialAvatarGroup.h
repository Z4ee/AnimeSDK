...
#define RPG_CLIENT_PLAYERRETURNTRIALAVATARGROUP_CREATE_OFFSET UNITYSDK_OFFSET(0x1AE13120)
#define RPG_CLIENT_PLAYERRETURNTRIALAVATARGROUP_GETTRIALAVATARLIST_OFFSET UNITYSDK_OFFSET(0x1AE13330)
#define RPG_CLIENT_PLAYERRETURNTRIALAVATARGROUP_GETTRIALAVATAR_OFFSET UNITYSDK_OFFSET(0x1AE134A0)
#define RPG_CLIENT_PLAYERRETURNTRIALAVATARGROUP_GET_GROUPDESC_OFFSET UNITYSDK_OFFSET(0x1AE13670)
#define RPG_CLIENT_PLAYERRETURNTRIALAVATARGROUP_INITCONFIG_OFFSET UNITYSDK_OFFSET(0x1AE131F0)
#define RPG_CLIENT_PLAYERRETURNTRIALAVATARGROUP_ISAVAILABLETRIALAVATARCONFIGID_OFFSET UNITYSDK_OFFSET(0x1AE135B0)
#define RPG_CLIENT_PLAYERRETURNTRIALAVATARGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE130C0)

namespace RPG::Client
{
	inline static constexpr unsigned int PlayerReturnTrialAvatarGroup_TypeDefinitionIndex = 61974;
