...
#define RPG_CLIENT_MONOPOLYSHOPGOODSDATAITEM_GET_CURRENCYDISPLAYDATA_OFFSET UNITYSDK_OFFSET(0x1954B1C0)
#define RPG_CLIENT_MONOPOLYSHOPGOODSDATAITEM_GET_CURRENCYICON_OFFSET UNITYSDK_OFFSET(0x1954B320)
#define RPG_CLIENT_MONOPOLYSHOPGOODSDATAITEM_GET_DESC_OFFSET UNITYSDK_OFFSET(0x1954B700)
#define RPG_CLIENT_MONOPOLYSHOPGOODSDATAITEM_GET_GOODSTYPE_OFFSET UNITYSDK_OFFSET(0x1954B460)
#define RPG_CLIENT_MONOPOLYSHOPGOODSDATAITEM_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x1954B7C0)
#define RPG_CLIENT_MONOPOLYSHOPGOODSDATAITEM_GET_ID_OFFSET UNITYSDK_OFFSET(0x1954B1A0)
#define RPG_CLIENT_MONOPOLYSHOPGOODSDATAITEM_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1954B500)
#define RPG_CLIENT_MONOPOLYSHOPGOODSDATAITEM_GET_TEXTDISPLAYPARAM1_OFFSET UNITYSDK_OFFSET(0x1954B5C0)
#define RPG_CLIENT_MONOPOLYSHOPGOODSDATAITEM_GET_TEXTDISPLAYPARAM2_OFFSET UNITYSDK_OFFSET(0x1954B660)
#define RPG_CLIENT_MONOPOLYSHOPGOODSDATAITEM_GET__ROW_OFFSET UNITYSDK_OFFSET(0x1954B140)
#define RPG_CLIENT_MONOPOLYSHOPGOODSDATAITEM_SET_ID_OFFSET UNITYSDK_OFFSET(0x1954B1B0)
#define RPG_CLIENT_MONOPOLYSHOPGOODSDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1954B130)

namespace RPG::Client
{
	inline static constexpr unsigned int MonopolyShopGoodsDataItem_TypeDefinitionIndex = 63348;
