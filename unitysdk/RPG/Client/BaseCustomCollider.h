...
#define RPG_CLIENT_BASECUSTOMCOLLIDER_METHOD_5_59DCF204E71C8F21_OFFSET UNITYSDK_OFFSET(0x18685200)
#define RPG_CLIENT_BASECUSTOMCOLLIDER_METHOD_5_890064904909C587_OFFSET UNITYSDK_OFFSET(0x18685320)
#define RPG_CLIENT_BASECUSTOMCOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x18685440)
