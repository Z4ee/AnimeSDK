...
#define RPG_CLIENT_BASECUSTOMCOLLIDER_METHOD_5_59DCF204E71C8F21_OFFSET UNITYSDK_OFFSET(0xB3A9160)
#define RPG_CLIENT_BASECUSTOMCOLLIDER_METHOD_5_890064904909C587_OFFSET UNITYSDK_OFFSET(0xB3A9280)
#define RPG_CLIENT_BASECUSTOMCOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0xB3A93A0)

namespace RPG::Client
{
	inline static constexpr unsigned int BaseCustomCollider_TypeDefinitionIndex = 64455;
