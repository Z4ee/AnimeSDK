...
#define RPG_CLIENT_MONOEFFECTPLUGINFADE_AWAKEPLUGIN_OFFSET UNITYSDK_OFFSET(0x9CCF040)
#define RPG_CLIENT_MONOEFFECTPLUGINFADE_DESTROYPLUGIN_OFFSET UNITYSDK_OFFSET(0x9CCF0D0)
#define RPG_CLIENT_MONOEFFECTPLUGINFADE_DISPOSEPLUGIN_OFFSET UNITYSDK_OFFSET(0x9CCF220)
#define RPG_CLIENT_MONOEFFECTPLUGINFADE_GET_BEHAVIOR_OFFSET UNITYSDK_OFFSET(0x9CCF430)
#define RPG_CLIENT_MONOEFFECTPLUGINFADE_GET_CURRENTDISSOLVEVALUE_OFFSET UNITYSDK_OFFSET(0x9CCF3D0)
#define RPG_CLIENT_MONOEFFECTPLUGINFADE_GET_NEEDFADEOUT_OFFSET UNITYSDK_OFFSET(0x9CCF370)
#define RPG_CLIENT_MONOEFFECTPLUGINFADE_IGNOREINEDITOR_OFFSET UNITYSDK_OFFSET(0x9CCF000)
#define RPG_CLIENT_MONOEFFECTPLUGINFADE_ONINVISIBLE_OFFSET UNITYSDK_OFFSET(0x9CCF330)
#define RPG_CLIENT_MONOEFFECTPLUGINFADE_ONVISIBLE_OFFSET UNITYSDK_OFFSET(0x9CCF2F0)
#define RPG_CLIENT_MONOEFFECTPLUGINFADE_RESETPLUGIN_OFFSET UNITYSDK_OFFSET(0x9CCF1C0)
#define RPG_CLIENT_MONOEFFECTPLUGINFADE_TICK_OFFSET UNITYSDK_OFFSET(0x9CCF280)
#define RPG_CLIENT_MONOEFFECTPLUGINFADE__CTOR_OFFSET UNITYSDK_OFFSET(0x9CCF440)
#define RPG_CLIENT_MONOEFFECTPLUGINFADE___IFIXBASEPROXY_AWAKEPLUGIN_OFFSET UNITYSDK_OFFSET(0x9CCF520)
#define RPG_CLIENT_MONOEFFECTPLUGINFADE___IFIXBASEPROXY_DESTROYPLUGIN_OFFSET UNITYSDK_OFFSET(0x9CCF580)
#define RPG_CLIENT_MONOEFFECTPLUGINFADE___IFIXBASEPROXY_IGNOREINEDITOR_OFFSET UNITYSDK_OFFSET(0x9CCF4B0)
#define RPG_CLIENT_MONOEFFECTPLUGINFADE___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0x9CCF5E0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginFade_TypeDefinitionIndex = 57328;
