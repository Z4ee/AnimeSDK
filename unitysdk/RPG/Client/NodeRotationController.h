...
#define RPG_CLIENT_NODEROTATIONCONTROLLER_ENDCALCROTATION_OFFSET UNITYSDK_OFFSET(0xD9D1D40)
#define RPG_CLIENT_NODEROTATIONCONTROLLER_GET_ADDOBJ_OFFSET UNITYSDK_OFFSET(0xD9D17D0)
#define RPG_CLIENT_NODEROTATIONCONTROLLER_METHOD_5_41081A5E55D64FFA_OFFSET UNITYSDK_OFFSET(0xD9D18F0)
#define RPG_CLIENT_NODEROTATIONCONTROLLER_METHOD_5_5C45B76158F16B95_OFFSET UNITYSDK_OFFSET(0xD9D1890)
#define RPG_CLIENT_NODEROTATIONCONTROLLER_SET_ADDOBJ_OFFSET UNITYSDK_OFFSET(0xD9D17E0)
#define RPG_CLIENT_NODEROTATIONCONTROLLER_STARTCALCROTATION_OFFSET UNITYSDK_OFFSET(0xD9D1C40)
#define RPG_CLIENT_NODEROTATIONCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0xD9D19D0)
#define RPG_CLIENT_NODEROTATIONCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xD9D1A20)
#define RPG_CLIENT_NODEROTATIONCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD9D1D90)
