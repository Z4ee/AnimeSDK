...
#define RPG_CLIENT_NODEROTATIONCONTROLLER_ENDCALCROTATION_OFFSET UNITYSDK_OFFSET(0xC2E4AB0)
#define RPG_CLIENT_NODEROTATIONCONTROLLER_GET_ADDOBJ_OFFSET UNITYSDK_OFFSET(0xC2E4540)
#define RPG_CLIENT_NODEROTATIONCONTROLLER_METHOD_5_41081A5E55D64FFA_OFFSET UNITYSDK_OFFSET(0xC2E4660)
#define RPG_CLIENT_NODEROTATIONCONTROLLER_METHOD_5_5C45B76158F16B95_OFFSET UNITYSDK_OFFSET(0xC2E4600)
#define RPG_CLIENT_NODEROTATIONCONTROLLER_SET_ADDOBJ_OFFSET UNITYSDK_OFFSET(0xC2E4550)
#define RPG_CLIENT_NODEROTATIONCONTROLLER_STARTCALCROTATION_OFFSET UNITYSDK_OFFSET(0xC2E49B0)
#define RPG_CLIENT_NODEROTATIONCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0xC2E4740)
#define RPG_CLIENT_NODEROTATIONCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xC2E4790)
#define RPG_CLIENT_NODEROTATIONCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC2E4B00)

namespace RPG::Client
{
	inline static constexpr unsigned int NodeRotationController_TypeDefinitionIndex = 64214;
