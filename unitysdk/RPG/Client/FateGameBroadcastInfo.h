...
#define RPG_CLIENT_FATEGAMEBROADCASTINFO_GET_AUDIOEVENT_OFFSET UNITYSDK_OFFSET(0xB98CD20)
#define RPG_CLIENT_FATEGAMEBROADCASTINFO_GET_BROADCASTCONTENT_OFFSET UNITYSDK_OFFSET(0xB98CBE0)
#define RPG_CLIENT_FATEGAMEBROADCASTINFO_GET_BROADCASTID_OFFSET UNITYSDK_OFFSET(0xB98CBD0)
#define RPG_CLIENT_FATEGAMEBROADCASTINFO_GET__BATTLEZONEROW_OFFSET UNITYSDK_OFFSET(0xB98C820)
#define RPG_CLIENT_FATEGAMEBROADCASTINFO_GET__ROW_OFFSET UNITYSDK_OFFSET(0xB98CCC0)
#define RPG_CLIENT_FATEGAMEBROADCASTINFO_INIT_OFFSET UNITYSDK_OFFSET(0xB98C380)
#define RPG_CLIENT_FATEGAMEBROADCASTINFO_ONAFTERROUNDSETTLESYNC_OFFSET UNITYSDK_OFFSET(0xB98C990)
#define RPG_CLIENT_FATEGAMEBROADCASTINFO_ONBEFOREROUNDSETTLESYNC_OFFSET UNITYSDK_OFFSET(0xB98C8A0)
#define RPG_CLIENT_FATEGAMEBROADCASTINFO_ONRECONNECT_OFFSET UNITYSDK_OFFSET(0xB98CA80)
#define RPG_CLIENT_FATEGAMEBROADCASTINFO_REFRESHCURBROADCAST_OFFSET UNITYSDK_OFFSET(0xB98C5B0)
#define RPG_CLIENT_FATEGAMEBROADCASTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xB98C340)

namespace RPG::Client
{
	inline static constexpr unsigned int FateGameBroadcastInfo_TypeDefinitionIndex = 59785;
