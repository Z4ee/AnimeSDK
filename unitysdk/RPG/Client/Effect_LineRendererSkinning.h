...
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_ENDOFLATETICK_OFFSET UNITYSDK_OFFSET(0x95612F0)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_GETDERIVATIVEWEIGHT_OFFSET UNITYSDK_OFFSET(0x9561EB0)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_METHOD_5_02A2D800521F7143_OFFSET UNITYSDK_OFFSET(0x9561790)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_METHOD_5_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x9560D80)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_METHOD_5_218124418542E081_OFFSET UNITYSDK_OFFSET(0x9560E10)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_METHOD_5_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0x9560A40)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_METHOD_5_4A5760CBA050F39E_OFFSET UNITYSDK_OFFSET(0x9561590)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_METHOD_5_89FADE33F34E4AE0_1_OFFSET UNITYSDK_OFFSET(0x9562120)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_METHOD_5_89FADE33F34E4AE0_2_OFFSET UNITYSDK_OFFSET(0x95621C0)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_METHOD_5_89FADE33F34E4AE0_OFFSET UNITYSDK_OFFSET(0x9562080)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_METHOD_5_8A2AC7CD7EA66CAC_OFFSET UNITYSDK_OFFSET(0x9562280)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_METHOD_5_A0433AB55CC45192_OFFSET UNITYSDK_OFFSET(0x9562440)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_METHOD_5_DA5757BC97DEA931_OFFSET UNITYSDK_OFFSET(0x95613E0)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_METHOD_5_DAC9219D09D338F5_OFFSET UNITYSDK_OFFSET(0x9562730)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x9560B90)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_ONENABLE_OFFSET UNITYSDK_OFFSET(0x95609A0)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_UPDATE_OFFSET UNITYSDK_OFFSET(0x9560CB0)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING__CCTOR_OFFSET UNITYSDK_OFFSET(0x9562970)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING__CTOR_OFFSET UNITYSDK_OFFSET(0x95628A0)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_LineRendererSkinning_TypeDefinitionIndex = 57732;
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::Plane>**)Il2CppClass::FromTypeDefinitionIndex(Effect_LineRendererSkinning_TypeDefinitionIndex)->GetStaticField(0x45E60);
		}
		...
		::Il2CppArray<::RPG::Client::Effect_LineRendererSkinning_Struct_2_F7C243F317D8E44A_1>* Method_5_4A5760CBA050F39E(::System::Single a1)
		{
			return ((::Il2CppArray<::RPG::Client::Effect_LineRendererSkinning_Struct_2_F7C243F317D8E44A_1>*(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + RPG_CLIENT_EFFECT_LINERENDERERSKINNING_METHOD_5_4A5760CBA050F39E_OFFSET))(this, a1);
		}
