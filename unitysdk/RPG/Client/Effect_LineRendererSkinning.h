...
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_ENDOFLATETICK_OFFSET UNITYSDK_OFFSET(0x151091E0)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_GETDERIVATIVEWEIGHT_OFFSET UNITYSDK_OFFSET(0x15109D40)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_METHOD_5_02A2D800521F7143_OFFSET UNITYSDK_OFFSET(0x15109630)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_METHOD_5_0F30679B05E70FC1_OFFSET UNITYSDK_OFFSET(0x1510A2C0)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_METHOD_5_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x15108CD0)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_METHOD_5_218124418542E081_OFFSET UNITYSDK_OFFSET(0x15108D60)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_METHOD_5_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0x151089A0)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_METHOD_5_7432254BE2E104AA_OFFSET UNITYSDK_OFFSET(0x15109460)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_METHOD_5_89FADE33F34E4AE0_1_OFFSET UNITYSDK_OFFSET(0x15109FB0)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_METHOD_5_89FADE33F34E4AE0_2_OFFSET UNITYSDK_OFFSET(0x1510A050)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_METHOD_5_89FADE33F34E4AE0_OFFSET UNITYSDK_OFFSET(0x15109F10)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_METHOD_5_8A2AC7CD7EA66CAC_OFFSET UNITYSDK_OFFSET(0x1510A110)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_METHOD_5_DA5757BC97DEA931_OFFSET UNITYSDK_OFFSET(0x151092D0)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_METHOD_5_DAC9219D09D338F5_OFFSET UNITYSDK_OFFSET(0x1510A5D0)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x15108AE0)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_ONENABLE_OFFSET UNITYSDK_OFFSET(0x15108900)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_UPDATE_OFFSET UNITYSDK_OFFSET(0x15108C00)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING__CCTOR_OFFSET UNITYSDK_OFFSET(0x1510A7F0)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING__CTOR_OFFSET UNITYSDK_OFFSET(0x1510A740)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_LineRendererSkinning_TypeDefinitionIndex = 67347;

	class Effect_LineRendererSkinning : public ::UnityEngine::MonoBehaviour
	{
	public:
		static ::Il2CppArray<::UnityEngine::Plane>** StaticGet_Field_5_0()
		{
			return (::Il2CppArray<::UnityEngine::Plane>**)Il2CppClass::FromTypeDefinitionIndex(Effect_LineRendererSkinning_TypeDefinitionIndex)->GetStaticField(0x6B9B0);
		}
		...
		::UnityEngine::LineRenderer* Field_5_23; // 0x80
		::Il2CppArray<::UnityEngine::Vector3>* Field_5_24; // 0x88
		::UnityEngine::Camera* Field_5_25; // 0x90
		::UnityEngine::Vector3 Field_5_26; // 0x98
		::Il2CppArray<::UnityEngine::Matrix4x4>* Field_5_27; // 0xA8
		::UnityEngine::Bounds Field_5_28; // 0xB0
		...
		::Il2CppArray<::RPG::Client::Effect_LineRendererSkinning_Struct_2_F7C243F317D8E44A_1>* Method_5_7432254BE2E104AA(::System::Single a1)
		{
			return ((::Il2CppArray<::RPG::Client::Effect_LineRendererSkinning_Struct_2_F7C243F317D8E44A_1>*(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + RPG_CLIENT_EFFECT_LINERENDERERSKINNING_METHOD_5_7432254BE2E104AA_OFFSET))(this, a1);
		}
