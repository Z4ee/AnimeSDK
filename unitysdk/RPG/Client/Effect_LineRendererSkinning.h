...
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_ENDOFLATETICK_OFFSET UNITYSDK_OFFSET(0xCDF94C0)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_GETDERIVATIVEWEIGHT_OFFSET UNITYSDK_OFFSET(0xCDFA020)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_METHOD_5_02A2D800521F7143_OFFSET UNITYSDK_OFFSET(0xCDF9910)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_METHOD_5_0F30679B05E70FC1_OFFSET UNITYSDK_OFFSET(0xCDFA5A0)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_METHOD_5_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0xCDF8FB0)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_METHOD_5_218124418542E081_OFFSET UNITYSDK_OFFSET(0xCDF9040)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_METHOD_5_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0xCDF8C80)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_METHOD_5_7432254BE2E104AA_OFFSET UNITYSDK_OFFSET(0xCDF9740)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_METHOD_5_89FADE33F34E4AE0_1_OFFSET UNITYSDK_OFFSET(0xCDFA290)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_METHOD_5_89FADE33F34E4AE0_2_OFFSET UNITYSDK_OFFSET(0xCDFA330)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_METHOD_5_89FADE33F34E4AE0_OFFSET UNITYSDK_OFFSET(0xCDFA1F0)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_METHOD_5_8A2AC7CD7EA66CAC_OFFSET UNITYSDK_OFFSET(0xCDFA3F0)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_METHOD_5_DA5757BC97DEA931_OFFSET UNITYSDK_OFFSET(0xCDF95B0)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_METHOD_5_DAC9219D09D338F5_OFFSET UNITYSDK_OFFSET(0xCDFA8B0)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xCDF8DC0)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_ONENABLE_OFFSET UNITYSDK_OFFSET(0xCDF8BE0)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING_UPDATE_OFFSET UNITYSDK_OFFSET(0xCDF8EE0)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING__CCTOR_OFFSET UNITYSDK_OFFSET(0xCDFAAD0)
#define RPG_CLIENT_EFFECT_LINERENDERERSKINNING__CTOR_OFFSET UNITYSDK_OFFSET(0xCDFAA20)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::Plane>**)Il2CppClass::FromTypeDefinitionIndex(Effect_LineRendererSkinning_TypeDefinitionIndex)->GetStaticField(0x64760);
		}
