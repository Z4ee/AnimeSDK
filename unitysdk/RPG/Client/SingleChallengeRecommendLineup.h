...
#define RPG_CLIENT_SINGLECHALLENGERECOMMENDLINEUP_GETDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0xB18A010)
#define RPG_CLIENT_SINGLECHALLENGERECOMMENDLINEUP_GETLINEUPAVATARIDS_OFFSET UNITYSDK_OFFSET(0xB189A60)
#define RPG_CLIENT_SINGLECHALLENGERECOMMENDLINEUP_GETLINEUPAVATARLEVELS_OFFSET UNITYSDK_OFFSET(0xB189CF0)
#define RPG_CLIENT_SINGLECHALLENGERECOMMENDLINEUP_GETLINEUPAVATARSKINIDS_OFFSET UNITYSDK_OFFSET(0xB189EE0)
#define RPG_CLIENT_SINGLECHALLENGERECOMMENDLINEUP_GET_BUFF1ID_OFFSET UNITYSDK_OFFSET(0xB18A480)
#define RPG_CLIENT_SINGLECHALLENGERECOMMENDLINEUP_GET_BUFF2ID_OFFSET UNITYSDK_OFFSET(0xB18A4D0)
#define RPG_CLIENT_SINGLECHALLENGERECOMMENDLINEUP_GET_HASREMARKNAME_OFFSET UNITYSDK_OFFSET(0xB18A5D0)
#define RPG_CLIENT_SINGLECHALLENGERECOMMENDLINEUP_GET_HEADFRAMEINFO_OFFSET UNITYSDK_OFFSET(0xB18A390)
#define RPG_CLIENT_SINGLECHALLENGERECOMMENDLINEUP_GET_HEADICONID_OFFSET UNITYSDK_OFFSET(0xB18A330)
#define RPG_CLIENT_SINGLECHALLENGERECOMMENDLINEUP_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0xB18A2D0)
#define RPG_CLIENT_SINGLECHALLENGERECOMMENDLINEUP_GET_LINEUPCOUNT_OFFSET UNITYSDK_OFFSET(0xB18A570)
#define RPG_CLIENT_SINGLECHALLENGERECOMMENDLINEUP_GET_NICKNAME_OFFSET UNITYSDK_OFFSET(0xB18A210)
#define RPG_CLIENT_SINGLECHALLENGERECOMMENDLINEUP_GET_PLATFORMINFO_OFFSET UNITYSDK_OFFSET(0xB18A630)
#define RPG_CLIENT_SINGLECHALLENGERECOMMENDLINEUP_GET_REMARKNAME_OFFSET UNITYSDK_OFFSET(0xB18A0E0)
#define RPG_CLIENT_SINGLECHALLENGERECOMMENDLINEUP_GET_STARSNUM_OFFSET UNITYSDK_OFFSET(0xB18A520)
#define RPG_CLIENT_SINGLECHALLENGERECOMMENDLINEUP_GET_UID_OFFSET UNITYSDK_OFFSET(0xB18A270)
#define RPG_CLIENT_SINGLECHALLENGERECOMMENDLINEUP_SET_PLATFORMINFO_OFFSET UNITYSDK_OFFSET(0xB18A640)
#define RPG_CLIENT_SINGLECHALLENGERECOMMENDLINEUP_SYNC_OFFSET UNITYSDK_OFFSET(0xB1899E0)
#define RPG_CLIENT_SINGLECHALLENGERECOMMENDLINEUP__CREATEEMPTYLINEUP_OFFSET UNITYSDK_OFFSET(0xB189C40)
#define RPG_CLIENT_SINGLECHALLENGERECOMMENDLINEUP__CTOR_OFFSET UNITYSDK_OFFSET(0xB189920)
...
namespace RPG::Client
{
	...
	public:
		...
		::Class_1_FB0633E85BD6CF8E_6* _RowInfo; // 0x10
		...
		::System::Void Sync(::Class_1_FB0633E85BD6CF8E_6* info)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_FB0633E85BD6CF8E_6*))((::PBYTE)hIl2Cpp + RPG_CLIENT_SINGLECHALLENGERECOMMENDLINEUP_SYNC_OFFSET))(this, info);
		}
