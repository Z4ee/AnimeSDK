...
#define RPG_CLIENT_PSMANAGER___C__DISPLAYCLASS46_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9EC3950)
#define RPG_CLIENT_PSMANAGER___C__DISPLAYCLASS46_0__JOINSESSION_B__0_OFFSET UNITYSDK_OFFSET(0x9EC4460)

namespace RPG::Client
{
	inline static constexpr unsigned int PSManager___c__DisplayClass46_0_TypeDefinitionIndex = 54295;
