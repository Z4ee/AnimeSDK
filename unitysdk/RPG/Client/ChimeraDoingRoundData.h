...
#define RPG_CLIENT_CHIMERADOINGROUNDDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x9FFAD20)
#define RPG_CLIENT_CHIMERADOINGROUNDDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9FFB270)
#define RPG_CLIENT_CHIMERADOINGROUNDDATA_GETDEADCHIMERACNT_OFFSET UNITYSDK_OFFSET(0x9FFB5C0)
#define RPG_CLIENT_CHIMERADOINGROUNDDATA_GETFINISHEDWORKVALUE_OFFSET UNITYSDK_OFFSET(0x9FFB390)
#define RPG_CLIENT_CHIMERADOINGROUNDDATA_GET_ALLWORKIDS_OFFSET UNITYSDK_OFFSET(0x9FF8950)
#define RPG_CLIENT_CHIMERADOINGROUNDDATA_GET_BEFOREBATTLEFINISHEDWORKVAL_OFFSET UNITYSDK_OFFSET(0x9FFACC0)
#define RPG_CLIENT_CHIMERADOINGROUNDDATA_GET_CHIMERAIDS_OFFSET UNITYSDK_OFFSET(0x9FFAC40)
#define RPG_CLIENT_CHIMERADOINGROUNDDATA_GET_CHIMERAINBATTLEATTRIBUTEDICT_OFFSET UNITYSDK_OFFSET(0x9FFAD00)
#define RPG_CLIENT_CHIMERADOINGROUNDDATA_GET_CHIMERATEAMWORKSETTLEDATA_OFFSET UNITYSDK_OFFSET(0x9FFB620)
#define RPG_CLIENT_CHIMERADOINGROUNDDATA_GET_FINISHEDWORKIDS_OFFSET UNITYSDK_OFFSET(0x9FFACE0)
#define RPG_CLIENT_CHIMERADOINGROUNDDATA_GET_LEADERCHIMERAID_OFFSET UNITYSDK_OFFSET(0x9FFAC60)
#define RPG_CLIENT_CHIMERADOINGROUNDDATA_GET_NEWWORKINDEX_OFFSET UNITYSDK_OFFSET(0x9FFACA0)
#define RPG_CLIENT_CHIMERADOINGROUNDDATA_GET_RECORD_OFFSET UNITYSDK_OFFSET(0x9FFB640)
#define RPG_CLIENT_CHIMERADOINGROUNDDATA_GET_WORKROUNDID_OFFSET UNITYSDK_OFFSET(0x9FFAC80)
#define RPG_CLIENT_CHIMERADOINGROUNDDATA_SET_BEFOREBATTLEFINISHEDWORKVAL_OFFSET UNITYSDK_OFFSET(0x9FFACD0)
#define RPG_CLIENT_CHIMERADOINGROUNDDATA_SET_CHIMERAIDS_OFFSET UNITYSDK_OFFSET(0x9FFAC50)
#define RPG_CLIENT_CHIMERADOINGROUNDDATA_SET_CHIMERAINBATTLEATTRIBUTEDICT_OFFSET UNITYSDK_OFFSET(0x9FFAD10)
#define RPG_CLIENT_CHIMERADOINGROUNDDATA_SET_CHIMERATEAMWORKSETTLEDATA_OFFSET UNITYSDK_OFFSET(0x9FFB630)
#define RPG_CLIENT_CHIMERADOINGROUNDDATA_SET_FINISHEDWORKIDS_OFFSET UNITYSDK_OFFSET(0x9FFACF0)
#define RPG_CLIENT_CHIMERADOINGROUNDDATA_SET_LEADERCHIMERAID_OFFSET UNITYSDK_OFFSET(0x9FFAC70)
#define RPG_CLIENT_CHIMERADOINGROUNDDATA_SET_NEWWORKINDEX_OFFSET UNITYSDK_OFFSET(0x9FFACB0)
#define RPG_CLIENT_CHIMERADOINGROUNDDATA_SET_RECORD_OFFSET UNITYSDK_OFFSET(0x9FFB650)
#define RPG_CLIENT_CHIMERADOINGROUNDDATA_SET_WORKROUNDID_OFFSET UNITYSDK_OFFSET(0x9FFAC90)
#define RPG_CLIENT_CHIMERADOINGROUNDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9FFADE0)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::Collections::Generic::List_1<::System::UInt32>* _FinishedWorkIDs_k__BackingField; // 0x20
