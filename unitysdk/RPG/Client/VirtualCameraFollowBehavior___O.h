...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::RPG::CustomRP::CRPVirtualCameraVolumn_PostUpdateVCCamera**)Il2CppClass::FromTypeDefinitionIndex(VirtualCameraFollowBehavior___O_TypeDefinitionIndex)->GetStaticField(0x644A0);
		}
	};
}
