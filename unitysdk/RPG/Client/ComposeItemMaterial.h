...
#define RPG_CLIENT_COMPOSEITEMMATERIAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1801AA80)

namespace RPG::Client
{
	inline static constexpr unsigned int ComposeItemMaterial_TypeDefinitionIndex = 62834;
