...
#define RPG_CLIENT_COMMONACTIVITYQUESTREWARDDATA_ADDTABGROUP_OFFSET UNITYSDK_OFFSET(0xB6F7590)
#define RPG_CLIENT_COMMONACTIVITYQUESTREWARDDATA_GET_ACTIVITYREWARDID_OFFSET UNITYSDK_OFFSET(0xB6F7790)
#define RPG_CLIENT_COMMONACTIVITYQUESTREWARDDATA_GET_FINALREWARDQUEST_OFFSET UNITYSDK_OFFSET(0xB6F77B0)
#define RPG_CLIENT_COMMONACTIVITYQUESTREWARDDATA_GET_TABGROUPINFOLIST_OFFSET UNITYSDK_OFFSET(0xB6F77A0)
#define RPG_CLIENT_COMMONACTIVITYQUESTREWARDDATA_GET_UNLOCKSCHEDULE_OFFSET UNITYSDK_OFFSET(0xB6F77D0)
#define RPG_CLIENT_COMMONACTIVITYQUESTREWARDDATA_REFRESHALLQUESTDATA_OFFSET UNITYSDK_OFFSET(0xB6F7460)
#define RPG_CLIENT_COMMONACTIVITYQUESTREWARDDATA_SET_FINALREWARDQUEST_OFFSET UNITYSDK_OFFSET(0xB6F77C0)
#define RPG_CLIENT_COMMONACTIVITYQUESTREWARDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB6F7350)

namespace RPG::Client
{
	inline static constexpr unsigned int CommonActivityQuestRewardData_TypeDefinitionIndex = 57722;
