...
#define RPG_CLIENT_PROPERTYOVERRIDEVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0xA235090)

namespace RPG::Client
{
	inline static constexpr unsigned int PropertyOverrideValue_TypeDefinitionIndex = 58171;
