...
#define RPG_CLIENT_FARMBATTLERESULTINFO_ADDBATTLEMULTIPLEDROP_OFFSET UNITYSDK_OFFSET(0x1C167FB0)
#define RPG_CLIENT_FARMBATTLERESULTINFO_ADDBATTLERESULT_OFFSET UNITYSDK_OFFSET(0x1C167E70)
#define RPG_CLIENT_FARMBATTLERESULTINFO_ADDBATTLETIME_OFFSET UNITYSDK_OFFSET(0x1C167F60)
#define RPG_CLIENT_FARMBATTLERESULTINFO_GET_DECOMPOSEINFO_OFFSET UNITYSDK_OFFSET(0x1C168250)
#define RPG_CLIENT_FARMBATTLERESULTINFO_GET_LASTBATTLEMULTIPLEDROPUSEDDATALIST_OFFSET UNITYSDK_OFFSET(0x1C168280)
#define RPG_CLIENT_FARMBATTLERESULTINFO_GET_LASTBATTLETIME_OFFSET UNITYSDK_OFFSET(0x1C168260)
#define RPG_CLIENT_FARMBATTLERESULTINFO_GET_REWARDITEMS_OFFSET UNITYSDK_OFFSET(0x1C168240)
#define RPG_CLIENT_FARMBATTLERESULTINFO_SET_LASTBATTLETIME_OFFSET UNITYSDK_OFFSET(0x1C168270)
#define RPG_CLIENT_FARMBATTLERESULTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1C168290)
