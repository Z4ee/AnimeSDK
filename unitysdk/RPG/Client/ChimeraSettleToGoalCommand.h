...
#define RPG_CLIENT_CHIMERASETTLETOGOALCOMMAND__CTOR_OFFSET UNITYSDK_OFFSET(0x93CAB20)
#define RPG_CLIENT_CHIMERASETTLETOGOALCOMMAND__EXECUTEIMPL_OFFSET UNITYSDK_OFFSET(0x93CDD20)
#define RPG_CLIENT_CHIMERASETTLETOGOALCOMMAND___IFIXBASEPROXY__EXECUTEIMPL_OFFSET UNITYSDK_OFFSET(0x93CDD90)

namespace RPG::Client
{
	inline static constexpr unsigned int ChimeraSettleToGoalCommand_TypeDefinitionIndex = 51534;
