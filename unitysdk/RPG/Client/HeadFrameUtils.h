...
#define RPG_CLIENT_HEADFRAMEUTILS_GETHEADFRAMEPREFABPATH_OFFSET UNITYSDK_OFFSET(0x1A069470)
#define RPG_CLIENT_HEADFRAMEUTILS_GETPLAYERHEADFRAMEINFOIFDISPLAY_OFFSET UNITYSDK_OFFSET(0x1A069310)
#define RPG_CLIENT_HEADFRAMEUTILS_GET_HASHEADFRAME_OFFSET UNITYSDK_OFFSET(0x1A069270)
#define RPG_CLIENT_HEADFRAMEUTILS_GET_ISDISPLAYHEADFRAME_OFFSET UNITYSDK_OFFSET(0x1A0691D0)
#define RPG_CLIENT_HEADFRAMEUTILS_SWITCHDISPLAYSTATE_OFFSET UNITYSDK_OFFSET(0x1A0693C0)
