...
#define RPG_CLIENT_HEADFRAMEUTILS_GETHEADFRAMEPREFABPATH_OFFSET UNITYSDK_OFFSET(0x1792F980)
#define RPG_CLIENT_HEADFRAMEUTILS_GETPLAYERHEADFRAMEINFOIFDISPLAY_OFFSET UNITYSDK_OFFSET(0x1792F820)
#define RPG_CLIENT_HEADFRAMEUTILS_GET_HASHEADFRAME_OFFSET UNITYSDK_OFFSET(0x1792F780)
#define RPG_CLIENT_HEADFRAMEUTILS_GET_ISDISPLAYHEADFRAME_OFFSET UNITYSDK_OFFSET(0x1792F6E0)
#define RPG_CLIENT_HEADFRAMEUTILS_SWITCHDISPLAYSTATE_OFFSET UNITYSDK_OFFSET(0x1792F8D0)

namespace RPG::Client
{
	inline static constexpr unsigned int HeadFrameUtils_TypeDefinitionIndex = 62727;
