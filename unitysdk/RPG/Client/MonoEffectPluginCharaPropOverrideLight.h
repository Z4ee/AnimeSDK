...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPOVERRIDELIGHT_INIT_OFFSET UNITYSDK_OFFSET(0x9CBA310)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPOVERRIDELIGHT_UNINIT_OFFSET UNITYSDK_OFFSET(0x9CBA370)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPOVERRIDELIGHT_UPDATEPROPERTY_OFFSET UNITYSDK_OFFSET(0x9CBA3C0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPOVERRIDELIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x9CBA490)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPOVERRIDELIGHT___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0x9CBA4F0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPOVERRIDELIGHT___IFIXBASEPROXY_UNINIT_OFFSET UNITYSDK_OFFSET(0x9CBA500)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginCharaPropOverrideLight_TypeDefinitionIndex = 57249;
