...
#define RPG_CLIENT_PSCUSTOMINVITATIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC327840)

namespace RPG::Client
{
	inline static constexpr unsigned int PSCustomInvitationData_TypeDefinitionIndex = 61482;
