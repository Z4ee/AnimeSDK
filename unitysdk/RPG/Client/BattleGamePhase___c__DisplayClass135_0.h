...
#define RPG_CLIENT_BATTLEGAMEPHASE___C__DISPLAYCLASS135_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9E5D3D0)
#define RPG_CLIENT_BATTLEGAMEPHASE___C__DISPLAYCLASS135_0___ONLEVELTURNULTRASKILLPREPAREEVENT_B__1_OFFSET UNITYSDK_OFFSET(0x9E5DB90)
#define RPG_CLIENT_BATTLEGAMEPHASE___C__DISPLAYCLASS135_0___ONLEVELTURNULTRASKILLPREPAREEVENT_G___ONFRAMECAPTUREDONE_0_OFFSET UNITYSDK_OFFSET(0x9E5D3E0)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleGamePhase___c__DisplayClass135_0_TypeDefinitionIndex = 56226;
