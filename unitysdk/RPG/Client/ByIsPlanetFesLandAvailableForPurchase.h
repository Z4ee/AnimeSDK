...
#define RPG_CLIENT_BYISPLANETFESLANDAVAILABLEFORPURCHASE_METHOD_4_40AE727D3B9BFECD_OFFSET UNITYSDK_OFFSET(0x1D307F40)
#define RPG_CLIENT_BYISPLANETFESLANDAVAILABLEFORPURCHASE_METHOD_4_46A302DA86A9F68E_OFFSET UNITYSDK_OFFSET(0x1D307F80)
#define RPG_CLIENT_BYISPLANETFESLANDAVAILABLEFORPURCHASE_METHOD_4_768CA69FD1FBB4C9_OFFSET UNITYSDK_OFFSET(0x1D3080F0)
#define RPG_CLIENT_BYISPLANETFESLANDAVAILABLEFORPURCHASE_METHOD_4_F273FC6357A93CA8_OFFSET UNITYSDK_OFFSET(0x1D3080C0)
#define RPG_CLIENT_BYISPLANETFESLANDAVAILABLEFORPURCHASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D307F70)

namespace RPG::Client
{
	inline static constexpr unsigned int ByIsPlanetFesLandAvailableForPurchase_TypeDefinitionIndex = 10257;
