...
#define RPG_CLIENT_SIMPRTXPROXY_METHOD_1_8ACAC425340483C4_OFFSET UNITYSDK_OFFSET(0xA4882D0)
#define RPG_CLIENT_SIMPRTXPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0xA488580)

namespace RPG::Client
{
	inline static constexpr unsigned int SimpRTXProxy_TypeDefinitionIndex = 57445;
