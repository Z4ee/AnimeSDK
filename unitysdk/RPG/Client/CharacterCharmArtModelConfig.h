...
#define RPG_CLIENT_CHARACTERCHARMARTMODELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x9F67C20)

namespace RPG::Client
{
	inline static constexpr unsigned int CharacterCharmArtModelConfig_TypeDefinitionIndex = 64292;
