...
#define RPG_CLIENT_MATCHTHREEPIECE_DESPAWNED_OFFSET UNITYSDK_OFFSET(0x1C9867D0)
#define RPG_CLIENT_MATCHTHREEPIECE_GET_PIECEDATA_OFFSET UNITYSDK_OFFSET(0x1C983FD0)
#define RPG_CLIENT_MATCHTHREEPIECE_GET_POSINDEX_OFFSET UNITYSDK_OFFSET(0x1C983DE0)
#define RPG_CLIENT_MATCHTHREEPIECE_INIT_OFFSET UNITYSDK_OFFSET(0x1C983FF0)
#define RPG_CLIENT_MATCHTHREEPIECE_MATCHED_OFFSET UNITYSDK_OFFSET(0x1C985F60)
#define RPG_CLIENT_MATCHTHREEPIECE_METHOD_5_19B91D58E02869BC_OFFSET UNITYSDK_OFFSET(0x1C9865F0)
#define RPG_CLIENT_MATCHTHREEPIECE_METHOD_5_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x1C9845B0)
#define RPG_CLIENT_MATCHTHREEPIECE_METHOD_5_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0x1C986160)
#define RPG_CLIENT_MATCHTHREEPIECE_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x1C987180)
#define RPG_CLIENT_MATCHTHREEPIECE_METHOD_5_4805283D59625FD9_OFFSET UNITYSDK_OFFSET(0x1C984A80)
#define RPG_CLIENT_MATCHTHREEPIECE_METHOD_5_4EF01F55C8320404_OFFSET UNITYSDK_OFFSET(0x1C985110)
#define RPG_CLIENT_MATCHTHREEPIECE_METHOD_5_558C6AE12602A241_OFFSET UNITYSDK_OFFSET(0x1C9870F0)
#define RPG_CLIENT_MATCHTHREEPIECE_METHOD_5_570C5557A774C69E_OFFSET UNITYSDK_OFFSET(0x1C987050)
#define RPG_CLIENT_MATCHTHREEPIECE_METHOD_5_592FC68A42F19409_1_OFFSET UNITYSDK_OFFSET(0x1C9858D0)
#define RPG_CLIENT_MATCHTHREEPIECE_METHOD_5_592FC68A42F19409_OFFSET UNITYSDK_OFFSET(0x1C985C70)
#define RPG_CLIENT_MATCHTHREEPIECE_METHOD_5_682FA2F0C959D8A1_OFFSET UNITYSDK_OFFSET(0x1C9863C0)
#define RPG_CLIENT_MATCHTHREEPIECE_METHOD_5_6D8B389448C59BE1_OFFSET UNITYSDK_OFFSET(0x1C9848E0)
#define RPG_CLIENT_MATCHTHREEPIECE_METHOD_5_705AF43C01ED360A_OFFSET UNITYSDK_OFFSET(0x1C986310)
#define RPG_CLIENT_MATCHTHREEPIECE_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x1C984E60)
#define RPG_CLIENT_MATCHTHREEPIECE_METHOD_5_9FBCB7EE3738DEA4_OFFSET UNITYSDK_OFFSET(0x1C985BC0)
#define RPG_CLIENT_MATCHTHREEPIECE_METHOD_5_A3AECC7AAA326A11_OFFSET UNITYSDK_OFFSET(0x1C985870)
#define RPG_CLIENT_MATCHTHREEPIECE_METHOD_5_BCB087DFB7399B96_OFFSET UNITYSDK_OFFSET(0x1C984EE0)
#define RPG_CLIENT_MATCHTHREEPIECE_METHOD_5_F1C2C3722C7B5E2C_OFFSET UNITYSDK_OFFSET(0x1C986FF0)
#define RPG_CLIENT_MATCHTHREEPIECE_METHOD_5_FF7B2911BBACA4A9_1_OFFSET UNITYSDK_OFFSET(0x1C9871D0)
#define RPG_CLIENT_MATCHTHREEPIECE_METHOD_5_FF7B2911BBACA4A9_OFFSET UNITYSDK_OFFSET(0x1C985820)
#define RPG_CLIENT_MATCHTHREEPIECE_MOVEIMMEDIATELY_OFFSET UNITYSDK_OFFSET(0x1C985040)
#define RPG_CLIENT_MATCHTHREEPIECE_MOVEPATH_OFFSET UNITYSDK_OFFSET(0x1C985170)
#define RPG_CLIENT_MATCHTHREEPIECE_ONCREATE_OFFSET UNITYSDK_OFFSET(0x1C986A30)
#define RPG_CLIENT_MATCHTHREEPIECE_ONDRAG_OFFSET UNITYSDK_OFFSET(0x1C986BB0)
#define RPG_CLIENT_MATCHTHREEPIECE_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x1C986C10)
#define RPG_CLIENT_MATCHTHREEPIECE_ONPOINTERENTER_OFFSET UNITYSDK_OFFSET(0x1C986CD0)
#define RPG_CLIENT_MATCHTHREEPIECE_ONPOINTEREXIT_OFFSET UNITYSDK_OFFSET(0x1C986D90)
#define RPG_CLIENT_MATCHTHREEPIECE_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0x1C986C70)
#define RPG_CLIENT_MATCHTHREEPIECE_PLAYBOMBLOOPANIM_OFFSET UNITYSDK_OFFSET(0x1C984FF0)
#define RPG_CLIENT_MATCHTHREEPIECE_PLAYFADEINANIM_OFFSET UNITYSDK_OFFSET(0x1C984DB0)
#define RPG_CLIENT_MATCHTHREEPIECE_SETBOARD_OFFSET UNITYSDK_OFFSET(0x1C9843F0)
#define RPG_CLIENT_MATCHTHREEPIECE_SETHOVERED_OFFSET UNITYSDK_OFFSET(0x1C984520)
#define RPG_CLIENT_MATCHTHREEPIECE_SETINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x1C9844C0)
#define RPG_CLIENT_MATCHTHREEPIECE_SETSELECTED_OFFSET UNITYSDK_OFFSET(0x1C9846E0)
#define RPG_CLIENT_MATCHTHREEPIECE_SETSIZE_OFFSET UNITYSDK_OFFSET(0x1C984440)
#define RPG_CLIENT_MATCHTHREEPIECE_SETUPPIECEDATA_OFFSET UNITYSDK_OFFSET(0x1C984D60)
#define RPG_CLIENT_MATCHTHREEPIECE_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0x1C9847A0)
#define RPG_CLIENT_MATCHTHREEPIECE_SET_PIECEDATA_OFFSET UNITYSDK_OFFSET(0x1C983FE0)
#define RPG_CLIENT_MATCHTHREEPIECE_SET_POSINDEX_OFFSET UNITYSDK_OFFSET(0x1C983E20)
#define RPG_CLIENT_MATCHTHREEPIECE_SHAKE_OFFSET UNITYSDK_OFFSET(0x1C9864C0)
#define RPG_CLIENT_MATCHTHREEPIECE_SPAWNED_OFFSET UNITYSDK_OFFSET(0x1C986660)
#define RPG_CLIENT_MATCHTHREEPIECE_STOPSHAKE_OFFSET UNITYSDK_OFFSET(0x1C986540)
#define RPG_CLIENT_MATCHTHREEPIECE_SWITCHTO_OFFSET UNITYSDK_OFFSET(0x1C986E50)
#define RPG_CLIENT_MATCHTHREEPIECE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C987220)
