...
#define RPG_CLIENT_GRIDFIGHTCONSUMABLEITEMDATA_CREATEFROMSERVER_1_OFFSET UNITYSDK_OFFSET(0x1C95C180)
#define RPG_CLIENT_GRIDFIGHTCONSUMABLEITEMDATA_CREATEFROMSERVER_OFFSET UNITYSDK_OFFSET(0x1C95CDD0)
#define RPG_CLIENT_GRIDFIGHTCONSUMABLEITEMDATA_GET_CONSUMABLECONFIG_OFFSET UNITYSDK_OFFSET(0x1C95EE60)
#define RPG_CLIENT_GRIDFIGHTCONSUMABLEITEMDATA_GET_DELAYROUND_OFFSET UNITYSDK_OFFSET(0x1C95EEE0)
#define RPG_CLIENT_GRIDFIGHTCONSUMABLEITEMDATA_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x1C95EE40)
#define RPG_CLIENT_GRIDFIGHTCONSUMABLEITEMDATA_GET_ISTIMED_OFFSET UNITYSDK_OFFSET(0x1C95EE80)
#define RPG_CLIENT_GRIDFIGHTCONSUMABLEITEMDATA_GET_ITEMCOUNT_OFFSET UNITYSDK_OFFSET(0x1C95EE20)
#define RPG_CLIENT_GRIDFIGHTCONSUMABLEITEMDATA_GET_ITEMID_OFFSET UNITYSDK_OFFSET(0x1C95EE00)
#define RPG_CLIENT_GRIDFIGHTCONSUMABLEITEMDATA_SET_CONSUMABLECONFIG_OFFSET UNITYSDK_OFFSET(0x1C95EE70)
#define RPG_CLIENT_GRIDFIGHTCONSUMABLEITEMDATA_SET_DELAYROUND_OFFSET UNITYSDK_OFFSET(0x1C95EEF0)
#define RPG_CLIENT_GRIDFIGHTCONSUMABLEITEMDATA_SET_GROUPID_OFFSET UNITYSDK_OFFSET(0x1C95EE50)
#define RPG_CLIENT_GRIDFIGHTCONSUMABLEITEMDATA_SET_ITEMCOUNT_OFFSET UNITYSDK_OFFSET(0x1C95EE30)
#define RPG_CLIENT_GRIDFIGHTCONSUMABLEITEMDATA_SET_ITEMID_OFFSET UNITYSDK_OFFSET(0x1C95EE10)
#define RPG_CLIENT_GRIDFIGHTCONSUMABLEITEMDATA_SYNC_1_OFFSET UNITYSDK_OFFSET(0x1C95C090)
#define RPG_CLIENT_GRIDFIGHTCONSUMABLEITEMDATA_SYNC_OFFSET UNITYSDK_OFFSET(0x1C95CCE0)
#define RPG_CLIENT_GRIDFIGHTCONSUMABLEITEMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1C95EBD0)
#define RPG_CLIENT_GRIDFIGHTCONSUMABLEITEMDATA__ISTIMEDCONSUMABLE_OFFSET UNITYSDK_OFFSET(0x1C95EC70)
