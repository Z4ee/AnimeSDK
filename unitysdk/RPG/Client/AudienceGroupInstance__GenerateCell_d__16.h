...
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE__GENERATECELL_D__16_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xB340CD0)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE__GENERATECELL_D__16_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_VALUETUPLE_UNITYENGINE_VECTOR2_RPG_CLIENT_AUDIENCESTANCECONFIG_EPOSITIONPOSETYPE___GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xB340F70)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE__GENERATECELL_D__16_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_VALUETUPLE_UNITYENGINE_VECTOR2_RPG_CLIENT_AUDIENCESTANCECONFIG_EPOSITIONPOSETYPE___GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xB340EB0)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE__GENERATECELL_D__16_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xB340FF0)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE__GENERATECELL_D__16_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xB340F20)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE__GENERATECELL_D__16_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xB340ED0)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE__GENERATECELL_D__16_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB340CC0)
#define RPG_CLIENT_AUDIENCEGROUPINSTANCE__GENERATECELL_D__16__CTOR_OFFSET UNITYSDK_OFFSET(0xB33FBD0)

namespace RPG::Client
{
	inline static constexpr unsigned int AudienceGroupInstance__GenerateCell_d__16_TypeDefinitionIndex = 64671;
	...
	public:
		...
		::UnityEngine::Vector2 size; // 0x44
		::System::ValueTuple_2<::UnityEngine::Vector2, ::RPG::Client::AudienceStanceConfig_EPositionPoseType> __2__current; // 0x4C
