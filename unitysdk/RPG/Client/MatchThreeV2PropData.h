...
#define RPG_CLIENT_MATCHTHREEV2PROPDATA_COMPARETO_OFFSET UNITYSDK_OFFSET(0xD66EAD0)
#define RPG_CLIENT_MATCHTHREEV2PROPDATA_CREATE_1_OFFSET UNITYSDK_OFFSET(0xD66E8A0)
#define RPG_CLIENT_MATCHTHREEV2PROPDATA_CREATE_2_OFFSET UNITYSDK_OFFSET(0xD66E810)
#define RPG_CLIENT_MATCHTHREEV2PROPDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xD66E620)
#define RPG_CLIENT_MATCHTHREEV2PROPDATA_GET_DESCTEXT_OFFSET UNITYSDK_OFFSET(0xD66DEC0)
#define RPG_CLIENT_MATCHTHREEV2PROPDATA_GET_HINTTEXT_OFFSET UNITYSDK_OFFSET(0xD66E2C0)
#define RPG_CLIENT_MATCHTHREEV2PROPDATA_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xD66E040)
#define RPG_CLIENT_MATCHTHREEV2PROPDATA_GET_INPUTGRIDCOUNT_OFFSET UNITYSDK_OFFSET(0xD66E220)
#define RPG_CLIENT_MATCHTHREEV2PROPDATA_GET_ISINITIALUNLOCK_OFFSET UNITYSDK_OFFSET(0xD66E440)
#define RPG_CLIENT_MATCHTHREEV2PROPDATA_GET_LEVELUPCOST_OFFSET UNITYSDK_OFFSET(0xD66E4E0)
#define RPG_CLIENT_MATCHTHREEV2PROPDATA_GET_LEVELUPDESC_OFFSET UNITYSDK_OFFSET(0xD66DF80)
#define RPG_CLIENT_MATCHTHREEV2PROPDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xD66DE00)
#define RPG_CLIENT_MATCHTHREEV2PROPDATA_GET_PROPCANUSECOUNT_OFFSET UNITYSDK_OFFSET(0xD66E0E0)
#define RPG_CLIENT_MATCHTHREEV2PROPDATA_GET_PROPID_OFFSET UNITYSDK_OFFSET(0xD66DDE0)
#define RPG_CLIENT_MATCHTHREEV2PROPDATA_GET_PROPLEVEL_OFFSET UNITYSDK_OFFSET(0xD66DDF0)
#define RPG_CLIENT_MATCHTHREEV2PROPDATA_GET_PROPTYPE_OFFSET UNITYSDK_OFFSET(0xD66E180)
#define RPG_CLIENT_MATCHTHREEV2PROPDATA_GET_ROW_OFFSET UNITYSDK_OFFSET(0xD66DD70)
#define RPG_CLIENT_MATCHTHREEV2PROPDATA_GET_SORTORDER_OFFSET UNITYSDK_OFFSET(0xD66E580)
#define RPG_CLIENT_MATCHTHREEV2PROPDATA_GET_USEFAILHINTTEXT_OFFSET UNITYSDK_OFFSET(0xD66E380)
#define RPG_CLIENT_MATCHTHREEV2PROPDATA_INIT_OFFSET UNITYSDK_OFFSET(0xD66EA90)
#define RPG_CLIENT_MATCHTHREEV2PROPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD66EA80)
