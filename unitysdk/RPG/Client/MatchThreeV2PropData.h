...
#define RPG_CLIENT_MATCHTHREEV2PROPDATA_COMPARETO_OFFSET UNITYSDK_OFFSET(0x9B67C70)
#define RPG_CLIENT_MATCHTHREEV2PROPDATA_CREATE_1_OFFSET UNITYSDK_OFFSET(0x9B67A80)
#define RPG_CLIENT_MATCHTHREEV2PROPDATA_CREATE_2_OFFSET UNITYSDK_OFFSET(0x9B679F0)
#define RPG_CLIENT_MATCHTHREEV2PROPDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x9B67850)
#define RPG_CLIENT_MATCHTHREEV2PROPDATA_GET_DESCTEXT_OFFSET UNITYSDK_OFFSET(0x9B672D0)
#define RPG_CLIENT_MATCHTHREEV2PROPDATA_GET_HINTTEXT_OFFSET UNITYSDK_OFFSET(0x9B675D0)
#define RPG_CLIENT_MATCHTHREEV2PROPDATA_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x9B673D0)
#define RPG_CLIENT_MATCHTHREEV2PROPDATA_GET_INPUTGRIDCOUNT_OFFSET UNITYSDK_OFFSET(0x9B67550)
#define RPG_CLIENT_MATCHTHREEV2PROPDATA_GET_ISINITIALUNLOCK_OFFSET UNITYSDK_OFFSET(0x9B676D0)
#define RPG_CLIENT_MATCHTHREEV2PROPDATA_GET_LEVELUPCOST_OFFSET UNITYSDK_OFFSET(0x9B67750)
#define RPG_CLIENT_MATCHTHREEV2PROPDATA_GET_LEVELUPDESC_OFFSET UNITYSDK_OFFSET(0x9B67350)
#define RPG_CLIENT_MATCHTHREEV2PROPDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0x9B67250)
#define RPG_CLIENT_MATCHTHREEV2PROPDATA_GET_PROPCANUSECOUNT_OFFSET UNITYSDK_OFFSET(0x9B67450)
#define RPG_CLIENT_MATCHTHREEV2PROPDATA_GET_PROPID_OFFSET UNITYSDK_OFFSET(0x9B67230)
#define RPG_CLIENT_MATCHTHREEV2PROPDATA_GET_PROPLEVEL_OFFSET UNITYSDK_OFFSET(0x9B67240)
#define RPG_CLIENT_MATCHTHREEV2PROPDATA_GET_PROPTYPE_OFFSET UNITYSDK_OFFSET(0x9B674D0)
#define RPG_CLIENT_MATCHTHREEV2PROPDATA_GET_ROW_OFFSET UNITYSDK_OFFSET(0x9B671C0)
#define RPG_CLIENT_MATCHTHREEV2PROPDATA_GET_SORTORDER_OFFSET UNITYSDK_OFFSET(0x9B677D0)
#define RPG_CLIENT_MATCHTHREEV2PROPDATA_GET_USEFAILHINTTEXT_OFFSET UNITYSDK_OFFSET(0x9B67650)
#define RPG_CLIENT_MATCHTHREEV2PROPDATA_INIT_OFFSET UNITYSDK_OFFSET(0x9B67C30)
#define RPG_CLIENT_MATCHTHREEV2PROPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9B67C20)

namespace RPG::Client
{
	inline static constexpr unsigned int MatchThreeV2PropData_TypeDefinitionIndex = 53638;
