...
#define RPG_CLIENT_CHIMERAABILITYDISPLAYDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1A4F9CB0)
#define RPG_CLIENT_CHIMERAABILITYDISPLAYDATA_GET_DESC_OFFSET UNITYSDK_OFFSET(0x1A4F9BC0)
#define RPG_CLIENT_CHIMERAABILITYDISPLAYDATA_GET_DISPLAYID_OFFSET UNITYSDK_OFFSET(0x1A4F9A70)
#define RPG_CLIENT_CHIMERAABILITYDISPLAYDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A4F9AE0)
#define RPG_CLIENT_CHIMERAABILITYDISPLAYDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0x1A4F9A80)
#define RPG_CLIENT_CHIMERAABILITYDISPLAYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4F9CA0)

namespace RPG::Client
{
	inline static constexpr unsigned int ChimeraAbilityDisplayData_TypeDefinitionIndex = 60615;
