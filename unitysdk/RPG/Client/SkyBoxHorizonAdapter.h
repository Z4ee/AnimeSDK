...
#define RPG_CLIENT_SKYBOXHORIZONADAPTER_AWAKE_OFFSET UNITYSDK_OFFSET(0xA4A1640)
#define RPG_CLIENT_SKYBOXHORIZONADAPTER_UPDATE_OFFSET UNITYSDK_OFFSET(0xA4A16E0)
#define RPG_CLIENT_SKYBOXHORIZONADAPTER__CTOR_OFFSET UNITYSDK_OFFSET(0xA4A1A20)

namespace RPG::Client
{
	inline static constexpr unsigned int SkyBoxHorizonAdapter_TypeDefinitionIndex = 59834;
