...
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE___C__DISPLAYCLASS28_0__CTOR_OFFSET UNITYSDK_OFFSET(0x180838A0)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE___C__DISPLAYCLASS28_0__TRYCONNECTTOOTHEREDGE_B__0_OFFSET UNITYSDK_OFFSET(0x18083E50)
#define RPG_CLIENT_CURVEUNDIRECTEDEDGE___C__DISPLAYCLASS28_0__TRYCONNECTTOOTHEREDGE_B__1_OFFSET UNITYSDK_OFFSET(0x18083E70)

namespace RPG::Client
{
	inline static constexpr unsigned int CurveUndirectedEdge___c__DisplayClass28_0_TypeDefinitionIndex = 65523;
