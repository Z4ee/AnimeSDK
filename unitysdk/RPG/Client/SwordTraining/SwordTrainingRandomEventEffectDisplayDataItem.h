...
#define RPG_CLIENT_SWORDTRAINING_SWORDTRAININGRANDOMEVENTEFFECTDISPLAYDATAITEM_CREATE_OFFSET UNITYSDK_OFFSET(0xB24B570)
#define RPG_CLIENT_SWORDTRAINING_SWORDTRAININGRANDOMEVENTEFFECTDISPLAYDATAITEM_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xB24B510)
#define RPG_CLIENT_SWORDTRAINING_SWORDTRAININGRANDOMEVENTEFFECTDISPLAYDATAITEM_GET_NAME_OFFSET UNITYSDK_OFFSET(0xB24B530)
#define RPG_CLIENT_SWORDTRAINING_SWORDTRAININGRANDOMEVENTEFFECTDISPLAYDATAITEM_GET_VALUE_OFFSET UNITYSDK_OFFSET(0xB24B550)
#define RPG_CLIENT_SWORDTRAINING_SWORDTRAININGRANDOMEVENTEFFECTDISPLAYDATAITEM_SET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xB24B520)
#define RPG_CLIENT_SWORDTRAINING_SWORDTRAININGRANDOMEVENTEFFECTDISPLAYDATAITEM_SET_NAME_OFFSET UNITYSDK_OFFSET(0xB24B540)
#define RPG_CLIENT_SWORDTRAINING_SWORDTRAININGRANDOMEVENTEFFECTDISPLAYDATAITEM_SET_VALUE_OFFSET UNITYSDK_OFFSET(0xB24B560)
#define RPG_CLIENT_SWORDTRAINING_SWORDTRAININGRANDOMEVENTEFFECTDISPLAYDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xB24B610)

namespace RPG::Client::SwordTraining
{
	inline static constexpr unsigned int SwordTrainingRandomEventEffectDisplayDataItem_TypeDefinitionIndex = 69103;
