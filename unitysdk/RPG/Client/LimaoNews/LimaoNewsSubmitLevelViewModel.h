...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELVIEWMODEL_GET_ITEMCOUNT_OFFSET UNITYSDK_OFFSET(0xD48FFA0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELVIEWMODEL_GET_LEVELOFFERINGREWARDDATA_OFFSET UNITYSDK_OFFSET(0xD48FF50)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELVIEWMODEL_GET_PREITEMCOUNT_OFFSET UNITYSDK_OFFSET(0xD490610)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELVIEWMODEL_GET_PRELEVELOFFERINGREWARDDATA_OFFSET UNITYSDK_OFFSET(0xD4905C0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELVIEWMODEL_ISOFFERINGOVERFLOW_OFFSET UNITYSDK_OFFSET(0xD490830)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELVIEWMODEL_ISPREOFFERINGLIMIT_OFFSET UNITYSDK_OFFSET(0xD48FE60)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xD489270)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsSubmitLevelViewModel_TypeDefinitionIndex = 79151;
