...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELVIEWMODEL_GET_ITEMCOUNT_OFFSET UNITYSDK_OFFSET(0x19B6E240)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELVIEWMODEL_GET_LEVELOFFERINGREWARDDATA_OFFSET UNITYSDK_OFFSET(0x19B6E1F0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELVIEWMODEL_GET_PREITEMCOUNT_OFFSET UNITYSDK_OFFSET(0x19B6E8B0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELVIEWMODEL_GET_PRELEVELOFFERINGREWARDDATA_OFFSET UNITYSDK_OFFSET(0x19B6E860)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELVIEWMODEL_ISOFFERINGOVERFLOW_OFFSET UNITYSDK_OFFSET(0x19B6EAD0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELVIEWMODEL_ISPREOFFERINGLIMIT_OFFSET UNITYSDK_OFFSET(0x19B6E100)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x19B6F8D0)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsSubmitLevelViewModel_TypeDefinitionIndex = 75540;
