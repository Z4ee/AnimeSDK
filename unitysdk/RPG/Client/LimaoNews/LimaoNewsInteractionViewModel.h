...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERACTIONVIEWMODEL_GET_BTNLIKECOMMAND_OFFSET UNITYSDK_OFFSET(0x1A76B060)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERACTIONVIEWMODEL_GET_COMMENTNUM_OFFSET UNITYSDK_OFFSET(0x1A76AFD0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERACTIONVIEWMODEL_GET_ISLIKE_OFFSET UNITYSDK_OFFSET(0x1A76B0E0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERACTIONVIEWMODEL_GET_LIKENUM_OFFSET UNITYSDK_OFFSET(0x1A76B820)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERACTIONVIEWMODEL_GET_NEEDTRANSITION_OFFSET UNITYSDK_OFFSET(0x1A76B0A0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERACTIONVIEWMODEL_GET_SHOWLIKENUM_OFFSET UNITYSDK_OFFSET(0x1A76B010)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERACTIONVIEWMODEL_SET_BTNLIKECOMMAND_OFFSET UNITYSDK_OFFSET(0x1A76B790)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERACTIONVIEWMODEL_SET_COMMENTNUM_OFFSET UNITYSDK_OFFSET(0x1A76B400)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERACTIONVIEWMODEL_SET_ISLIKE_OFFSET UNITYSDK_OFFSET(0x1A76B490)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERACTIONVIEWMODEL_SET_LIKENUM_OFFSET UNITYSDK_OFFSET(0x1A76B370)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERACTIONVIEWMODEL_SET_NEEDTRANSITION_OFFSET UNITYSDK_OFFSET(0x1A76B860)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERACTIONVIEWMODEL__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A76B520)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERACTIONVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A76B1A0)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsInteractionViewModel_TypeDefinitionIndex = 75512;
	...
	public:
		...
		::System::Boolean _NeedTransition; // 0x2C
		::System::Boolean _IsLike; // 0x2D
