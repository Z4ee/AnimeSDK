...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKPROGRESSRECORDITEMVIEWMODEL___C__DISPLAYCLASS0_0__CREATE_B__0_OFFSET UNITYSDK_OFFSET(0xD49EF50)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKPROGRESSRECORDITEMVIEWMODEL___C__DISPLAYCLASS0_0__CTOR_OFFSET UNITYSDK_OFFSET(0xD49EDA0)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsWorkProgressRecordItemViewModel___c__DisplayClass0_0_TypeDefinitionIndex = 79126;
	...
	public:
		...
		::RPG::Client::LimaoNews::LimaoNewsWorkProgressRecordItemViewModel* viewModel; // 0x18
		::RPG::Client::LimaoNews::LimaoNewsEntityTrackService* entityTrackService; // 0x20
