...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANREVIEWDIALOGVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0x1C558C10)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANREVIEWDIALOGVIEWMODEL_GET_PLANITEMS_OFFSET UNITYSDK_OFFSET(0x1C558CD0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANREVIEWDIALOGVIEWMODEL_SET_PLANITEMS_OFFSET UNITYSDK_OFFSET(0x1C558CE0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANREVIEWDIALOGVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C558CB0)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsPlanReviewDialogViewModel_TypeDefinitionIndex = 79117;
