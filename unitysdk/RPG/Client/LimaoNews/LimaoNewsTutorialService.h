...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSTUTORIALSERVICE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C4B2250)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSTUTORIALSERVICE_GET_FIRSTENTEREDMAINPAGEFLAG_OFFSET UNITYSDK_OFFSET(0x1C4B24F0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSTUTORIALSERVICE_ISNEEDSHOWEVENTGUIDE_OFFSET UNITYSDK_OFFSET(0x1C4B2300)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSTUTORIALSERVICE_REFRESHFIRSTENTEREDMAINPAGEFLAG_OFFSET UNITYSDK_OFFSET(0x1C4B22B0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSTUTORIALSERVICE_SET_FIRSTENTEREDMAINPAGEFLAG_OFFSET UNITYSDK_OFFSET(0x1C4B2500)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSTUTORIALSERVICE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C4B2510)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSTUTORIALSERVICE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C4B22A0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSTUTORIALSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4B2290)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsTutorialService_TypeDefinitionIndex = 79021;
	...
	public:
		...
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(LimaoNewsTutorialService_TypeDefinitionIndex)->GetStaticField(0x12E00);
		}
		static ::System::UInt32* StaticGet_TutorialForumNodeID()
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(LimaoNewsTutorialService_TypeDefinitionIndex)->GetStaticField(0x12E04);
		}
		::Class_1_C56ACF52E09DFFD3* _LimaoNewsLimaoService; // 0x10
