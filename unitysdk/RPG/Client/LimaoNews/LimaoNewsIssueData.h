...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUEDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xBD87D10)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUEDATA_GETCOMMENTDATAS_OFFSET UNITYSDK_OFFSET(0xBD88040)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUEDATA_GETINTERVIEWS_OFFSET UNITYSDK_OFFSET(0xBD87D80)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUEDATA_GETREWARDID_OFFSET UNITYSDK_OFFSET(0xBD882A0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUEDATA_GETREWARDITEMCOUNT_OFFSET UNITYSDK_OFFSET(0xBD88340)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUEDATA_GET_HINTPOPUPSHOWTYPE_OFFSET UNITYSDK_OFFSET(0xBD88400)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUEDATA_GET_ISSUEID_OFFSET UNITYSDK_OFFSET(0xBD883E0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUEDATA_SET_ISSUEID_OFFSET UNITYSDK_OFFSET(0xBD883F0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBD87D70)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUEDATA__GETISSUEROW_OFFSET UNITYSDK_OFFSET(0xBD87FE0)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsIssueData_TypeDefinitionIndex = 73761;
