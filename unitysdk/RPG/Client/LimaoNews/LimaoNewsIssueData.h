...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUEDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xD45D6F0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUEDATA_GETCOMMENTDATAS_OFFSET UNITYSDK_OFFSET(0xD45DA40)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUEDATA_GETINTERVIEWS_OFFSET UNITYSDK_OFFSET(0xD45D780)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUEDATA_GETREWARDID_OFFSET UNITYSDK_OFFSET(0xD45DC40)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUEDATA_GETREWARDITEMCOUNT_OFFSET UNITYSDK_OFFSET(0xD45DCE0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUEDATA_GET_HINTPOPUPSHOWTYPE_OFFSET UNITYSDK_OFFSET(0xD45DDA0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUEDATA_GET_ISSUEID_OFFSET UNITYSDK_OFFSET(0xD45DD80)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUEDATA_SET_ISSUEID_OFFSET UNITYSDK_OFFSET(0xD45DD90)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD45D770)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUEDATA__GETISSUEROW_OFFSET UNITYSDK_OFFSET(0xD45D9E0)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsIssueData_TypeDefinitionIndex = 78963;
