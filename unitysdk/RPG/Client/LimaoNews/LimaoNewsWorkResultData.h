...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKRESULTDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1C4BEC30)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKRESULTDATA_GETWORKRECORDDATA_OFFSET UNITYSDK_OFFSET(0x1C4BEE00)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKRESULTDATA_GET_RECORDDATALIST_OFFSET UNITYSDK_OFFSET(0x1C4BEFD0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKRESULTDATA_GET_WORKRESULTEVENTPATH_OFFSET UNITYSDK_OFFSET(0x1C4BEF90)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKRESULTDATA_GET_WORKRESULTID_OFFSET UNITYSDK_OFFSET(0x1C4BEF70)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKRESULTDATA_GET_WORKRESULTMESSAGE_OFFSET UNITYSDK_OFFSET(0x1C4BEFB0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKRESULTDATA_SET_RECORDDATALIST_OFFSET UNITYSDK_OFFSET(0x1C4BEFE0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKRESULTDATA_SET_WORKRESULTEVENTPATH_OFFSET UNITYSDK_OFFSET(0x1C4BEFA0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKRESULTDATA_SET_WORKRESULTID_OFFSET UNITYSDK_OFFSET(0x1C4BEF80)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKRESULTDATA_SET_WORKRESULTMESSAGE_OFFSET UNITYSDK_OFFSET(0x1C4BEFC0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKRESULTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4BEDF0)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsWorkResultData_TypeDefinitionIndex = 78985;

	class LimaoNewsWorkResultData : public ::System::Object
	{
	public:
		::System::Collections::Generic::List_1<::RPG::Client::LimaoNews::LimaoNewsWorkRecordData*>* _RecordDataList_k__BackingField; // 0x10
		::System::String* _WorkResultEventPath_k__BackingField; // 0x18
		::System::UInt32 _WorkResultMessage_k__BackingField; // 0x20
		::System::UInt32 _WorkResultID_k__BackingField; // 0x24
