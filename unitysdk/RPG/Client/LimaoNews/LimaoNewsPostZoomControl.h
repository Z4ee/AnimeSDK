...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL_INIT_OFFSET UNITYSDK_OFFSET(0x1C4A7C30)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1C4A8BB0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1C4A8710)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL_ONJOYSTICKPRESS_OFFSET UNITYSDK_OFFSET(0x1C4A8190)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL_ONJOYSTICKRELEASE_OFFSET UNITYSDK_OFFSET(0x1C4A83D0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL_ONJOYSTICKZOOM_OFFSET UNITYSDK_OFFSET(0x1C4A80F0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL_ONMOUSEWHEELROLL_OFFSET UNITYSDK_OFFSET(0x1C4A7FE0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL_UPDATE_OFFSET UNITYSDK_OFFSET(0x1C4A9050)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL__CALCULATEMINSIZE_OFFSET UNITYSDK_OFFSET(0x1C4A7DA0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4A9800)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL__ONPINCHEND_OFFSET UNITYSDK_OFFSET(0x1C4A97B0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL__ONPINCHIN_OFFSET UNITYSDK_OFFSET(0x1C4A9610)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL__ONPINCHOUT_OFFSET UNITYSDK_OFFSET(0x1C4A96E0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL__ONSWIPEEND_OFFSET UNITYSDK_OFFSET(0x1C4A9550)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL__ONSWIPE_OFFSET UNITYSDK_OFFSET(0x1C4A9460)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL__SETFINALPOS_OFFSET UNITYSDK_OFFSET(0x1C4A8490)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL__SETPOS_OFFSET UNITYSDK_OFFSET(0x1C4A82A0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL__SETSIZE_OFFSET UNITYSDK_OFFSET(0x1C4A7E40)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL__TICK_OFFSET UNITYSDK_OFFSET(0x1C4A90A0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL__ZOOMSIZE_OFFSET UNITYSDK_OFFSET(0x1C4A8080)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsPostZoomControl_TypeDefinitionIndex = 79085;
