...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL_INIT_OFFSET UNITYSDK_OFFSET(0x1A793940)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1A7948C0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A794420)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL_ONJOYSTICKPRESS_OFFSET UNITYSDK_OFFSET(0x1A793EA0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL_ONJOYSTICKRELEASE_OFFSET UNITYSDK_OFFSET(0x1A7940E0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL_ONJOYSTICKZOOM_OFFSET UNITYSDK_OFFSET(0x1A793E00)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL_ONMOUSEWHEELROLL_OFFSET UNITYSDK_OFFSET(0x1A793CF0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A794D60)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL__CALCULATEMINSIZE_OFFSET UNITYSDK_OFFSET(0x1A793AB0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A795510)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL__ONPINCHEND_OFFSET UNITYSDK_OFFSET(0x1A7954C0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL__ONPINCHIN_OFFSET UNITYSDK_OFFSET(0x1A795320)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL__ONPINCHOUT_OFFSET UNITYSDK_OFFSET(0x1A7953F0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL__ONSWIPEEND_OFFSET UNITYSDK_OFFSET(0x1A795260)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL__ONSWIPE_OFFSET UNITYSDK_OFFSET(0x1A795170)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL__SETFINALPOS_OFFSET UNITYSDK_OFFSET(0x1A7941A0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL__SETPOS_OFFSET UNITYSDK_OFFSET(0x1A793FB0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL__SETSIZE_OFFSET UNITYSDK_OFFSET(0x1A793B50)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL__TICK_OFFSET UNITYSDK_OFFSET(0x1A794DB0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL__ZOOMSIZE_OFFSET UNITYSDK_OFFSET(0x1A793D90)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsPostZoomControl_TypeDefinitionIndex = 75504;
