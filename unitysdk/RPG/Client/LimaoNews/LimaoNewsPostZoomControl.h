...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL_INIT_OFFSET UNITYSDK_OFFSET(0xBDAA070)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xBDAAFF0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL_ONENABLE_OFFSET UNITYSDK_OFFSET(0xBDAAB50)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL_ONJOYSTICKPRESS_OFFSET UNITYSDK_OFFSET(0xBDAA5D0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL_ONJOYSTICKRELEASE_OFFSET UNITYSDK_OFFSET(0xBDAA810)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL_ONJOYSTICKZOOM_OFFSET UNITYSDK_OFFSET(0xBDAA530)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL_ONMOUSEWHEELROLL_OFFSET UNITYSDK_OFFSET(0xBDAA420)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL_UPDATE_OFFSET UNITYSDK_OFFSET(0xBDAB490)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL__CALCULATEMINSIZE_OFFSET UNITYSDK_OFFSET(0xBDAA1E0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xBDABC40)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL__ONPINCHEND_OFFSET UNITYSDK_OFFSET(0xBDABBF0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL__ONPINCHIN_OFFSET UNITYSDK_OFFSET(0xBDABA50)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL__ONPINCHOUT_OFFSET UNITYSDK_OFFSET(0xBDABB20)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL__ONSWIPEEND_OFFSET UNITYSDK_OFFSET(0xBDAB990)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL__ONSWIPE_OFFSET UNITYSDK_OFFSET(0xBDAB8A0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL__SETFINALPOS_OFFSET UNITYSDK_OFFSET(0xBDAA8D0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL__SETPOS_OFFSET UNITYSDK_OFFSET(0xBDAA6E0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL__SETSIZE_OFFSET UNITYSDK_OFFSET(0xBDAA280)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL__TICK_OFFSET UNITYSDK_OFFSET(0xBDAB4E0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTZOOMCONTROL__ZOOMSIZE_OFFSET UNITYSDK_OFFSET(0xBDAA4C0)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsPostZoomControl_TypeDefinitionIndex = 73853;
