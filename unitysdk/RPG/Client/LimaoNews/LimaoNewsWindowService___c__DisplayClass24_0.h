...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE___C__DISPLAYCLASS24_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4B7F90)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE___C__DISPLAYCLASS24_0__SHOWPLANPHASESUBMITWINDOW_B__0_OFFSET UNITYSDK_OFFSET(0x1C4B9390)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsWindowService___c__DisplayClass24_0_TypeDefinitionIndex = 79024;
