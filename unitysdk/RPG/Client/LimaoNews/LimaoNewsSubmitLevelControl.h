...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x19B6E020)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELCONTROL_PLAYLEVELCHANGEANIMATION_OFFSET UNITYSDK_OFFSET(0x19B6DE60)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x19B6F110)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x19B6E510)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x19B6DA80)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELCONTROL__PLAYFIRECHANGEANIMATION_OFFSET UNITYSDK_OFFSET(0x19B6E480)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELCONTROL__PLAYLEVELCHANGEANIMATION_OFFSET UNITYSDK_OFFSET(0x19B6EDB0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELCONTROL__SETNODELISTVIEW_1_OFFSET UNITYSDK_OFFSET(0x19B6EB50)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELCONTROL__SETNODELISTVIEW_OFFSET UNITYSDK_OFFSET(0x19B6ED30)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELCONTROL__SETUPREWARDLIMITVIEW_OFFSET UNITYSDK_OFFSET(0x19B6E290)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELCONTROL__SETUPVIEW_OFFSET UNITYSDK_OFFSET(0x19B6E900)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsSubmitLevelControl_TypeDefinitionIndex = 75498;
