...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1C4AD2C0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELCONTROL_PLAYLEVELCHANGEANIMATION_OFFSET UNITYSDK_OFFSET(0x1C4A6960)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4AE380)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1C4AD780)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1C4ACEE0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELCONTROL__PLAYFIRECHANGEANIMATION_OFFSET UNITYSDK_OFFSET(0x1C4AD6F0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELCONTROL__PLAYLEVELCHANGEANIMATION_OFFSET UNITYSDK_OFFSET(0x1C4AE020)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELCONTROL__SETNODELISTVIEW_1_OFFSET UNITYSDK_OFFSET(0x1C4ADDC0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELCONTROL__SETNODELISTVIEW_OFFSET UNITYSDK_OFFSET(0x1C4ADFA0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELCONTROL__SETUPREWARDLIMITVIEW_OFFSET UNITYSDK_OFFSET(0x1C4AD500)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELCONTROL__SETUPVIEW_OFFSET UNITYSDK_OFFSET(0x1C4ADB70)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsSubmitLevelControl_TypeDefinitionIndex = 79079;
