...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD48FDB0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELCONTROL_PLAYLEVELCHANGEANIMATION_OFFSET UNITYSDK_OFFSET(0xD489450)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xD490E70)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD490270)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xD48F9D0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELCONTROL__PLAYFIRECHANGEANIMATION_OFFSET UNITYSDK_OFFSET(0xD4901E0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELCONTROL__PLAYLEVELCHANGEANIMATION_OFFSET UNITYSDK_OFFSET(0xD490B10)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELCONTROL__SETNODELISTVIEW_1_OFFSET UNITYSDK_OFFSET(0xD4908B0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELCONTROL__SETNODELISTVIEW_OFFSET UNITYSDK_OFFSET(0xD490A90)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELCONTROL__SETUPREWARDLIMITVIEW_OFFSET UNITYSDK_OFFSET(0xD48FFF0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSUBMITLEVELCONTROL__SETUPVIEW_OFFSET UNITYSDK_OFFSET(0xD490660)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsSubmitLevelControl_TypeDefinitionIndex = 79080;
