...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINENTRANCEVIEWMODEL_GET_EVENTVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1C548C60)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINENTRANCEVIEWMODEL_GET_ISDLCSUBMISSIONFINISHED_OFFSET UNITYSDK_OFFSET(0x1C548BA0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINENTRANCEVIEWMODEL_GET_ISFIRSTIN_OFFSET UNITYSDK_OFFSET(0x1C548C00)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINENTRANCEVIEWMODEL_GET_SCENEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1C548C40)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINENTRANCEVIEWMODEL_GET_SKIPMANAGEMENTTUTORIALONFIRSTSETUP_OFFSET UNITYSDK_OFFSET(0x1C548C20)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINENTRANCEVIEWMODEL_SETCITYTYPE_OFFSET UNITYSDK_OFFSET(0x1C548AC0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINENTRANCEVIEWMODEL_SETISFIRSTIN_OFFSET UNITYSDK_OFFSET(0x1C548A70)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINENTRANCEVIEWMODEL_SETSKIPMANAGEMENTTUTORIALONFIRSTSETUP_OFFSET UNITYSDK_OFFSET(0x1C548B50)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINENTRANCEVIEWMODEL_SET_EVENTVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1C548C70)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINENTRANCEVIEWMODEL_SET_ISFIRSTIN_OFFSET UNITYSDK_OFFSET(0x1C548C10)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINENTRANCEVIEWMODEL_SET_SCENEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1C548C50)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINENTRANCEVIEWMODEL_SET_SKIPMANAGEMENTTUTORIALONFIRSTSETUP_OFFSET UNITYSDK_OFFSET(0x1C548C30)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINENTRANCEVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C548960)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsMainEntranceViewModel_TypeDefinitionIndex = 79098;
