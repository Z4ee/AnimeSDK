...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERVIEWDETAILWINDOW_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1A770460)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERVIEWDETAILWINDOW_ONCONTENTITEMCHANGE_OFFSET UNITYSDK_OFFSET(0x1A771510)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERVIEWDETAILWINDOW_ONTABITEMCHANGE_OFFSET UNITYSDK_OFFSET(0x1A7713A0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERVIEWDETAILWINDOW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A76F1E0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERVIEWDETAILWINDOW__GETCENTERITEMINDEX_OFFSET UNITYSDK_OFFSET(0x1A770930)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERVIEWDETAILWINDOW__GETTABITEMINDEXBYCONTENTITEMINDEX_OFFSET UNITYSDK_OFFSET(0x1A7709D0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERVIEWDETAILWINDOW__ISCENTERCONTENTITEM_OFFSET UNITYSDK_OFFSET(0x1A770A30)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERVIEWDETAILWINDOW__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1A76FC00)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERVIEWDETAILWINDOW__ONCONTENTSCROLL_OFFSET UNITYSDK_OFFSET(0x1A7706D0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERVIEWDETAILWINDOW__ONEXITFINALSTEP_OFFSET UNITYSDK_OFFSET(0x1A770BC0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERVIEWDETAILWINDOW__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1A76F350)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERVIEWDETAILWINDOW__ONLIMAONEWSCLOSEINTERVIEWDETAIL_OFFSET UNITYSDK_OFFSET(0x1A770F30)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERVIEWDETAILWINDOW__ONLIMAONEWSINTERVIEWMESSAGE_OFFSET UNITYSDK_OFFSET(0x1A770DB0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERVIEWDETAILWINDOW__ONLIMAONEWSINTERVIEWUPVOTE_OFFSET UNITYSDK_OFFSET(0x1A7710B0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERVIEWDETAILWINDOW__ONTICK_OFFSET UNITYSDK_OFFSET(0x1A770540)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERVIEWDETAILWINDOW__SETCONTENTBGHEIGHT_OFFSET UNITYSDK_OFFSET(0x1A770590)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERVIEWDETAILWINDOW__SUBSCRIBEMESSAGE_OFFSET UNITYSDK_OFFSET(0x1A76FB40)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsInterviewDetailWindow_TypeDefinitionIndex = 75470;

	class LimaoNewsInterviewDetailWindow : public ::Sofa::BaseSofaWindow
	{
	public:
		::SuperScrollView::LoopListView2* _LoopListContent; // 0x40
		::Class_1_5F4D64A4B97E38F9* _Messenger; // 0x48
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Single>* _ItemHeights; // 0x50
		::UnityEngine::RectTransform* _NodeContentBg; // 0x58
		...
		::SuperScrollView::LoopListView2* _LoopListTab; // 0x78
		::UnityEngine::UI::ScrollRect* _ScrollRectContent; // 0x80
		::UnityEngine::RectTransform* _NodeViewport; // 0x88
		::UnityEngine::RectTransform* _NodeLoopListContent; // 0x90
