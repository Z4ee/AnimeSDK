...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYTYPEDATA_CREATE_1_OFFSET UNITYSDK_OFFSET(0x1C5576C0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYTYPEDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1C543E00)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYTYPEDATA_GET_ISNONE_OFFSET UNITYSDK_OFFSET(0x1C5575D0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYTYPEDATA_GET_OFFICESURVEYTYPE_OFFSET UNITYSDK_OFFSET(0x1C557770)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYTYPEDATA_GET_SURVEYTYPECOLORSTATE_OFFSET UNITYSDK_OFFSET(0x1C5577D0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYTYPEDATA_GET_SURVEYTYPEICON_OFFSET UNITYSDK_OFFSET(0x1C557790)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYTYPEDATA_GET_SURVEYTYPEMASKCOLORSTATE_OFFSET UNITYSDK_OFFSET(0x1C557830)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYTYPEDATA_GET_SURVEYTYPETEXTID_OFFSET UNITYSDK_OFFSET(0x1C5577B0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYTYPEDATA_SET_OFFICESURVEYTYPE_OFFSET UNITYSDK_OFFSET(0x1C557780)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYTYPEDATA_SET_SURVEYTYPEICON_OFFSET UNITYSDK_OFFSET(0x1C5577A0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYTYPEDATA_SET_SURVEYTYPETEXTID_OFFSET UNITYSDK_OFFSET(0x1C5577C0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYTYPEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1C557650)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYTYPEDATA__INITBYROW_OFFSET UNITYSDK_OFFSET(0x1C557660)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsOfficeSurveyTypeData_TypeDefinitionIndex = 78972;
