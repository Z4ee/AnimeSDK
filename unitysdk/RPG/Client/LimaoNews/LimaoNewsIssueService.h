...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESERVICE_ADDSUBMITTEDISSUEID_OFFSET UNITYSDK_OFFSET(0x1C540F80)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESERVICE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C540450)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESERVICE_GETALLCANSUBMITISSUEDATA_OFFSET UNITYSDK_OFFSET(0x1C541590)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESERVICE_GETALLSHOWISSUEDATA_OFFSET UNITYSDK_OFFSET(0x1C541150)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESERVICE_GETTOPISSUEDATA_OFFSET UNITYSDK_OFFSET(0x1C541410)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESERVICE_HASCANSUBMITISSUE_OFFSET UNITYSDK_OFFSET(0x1C5419E0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESERVICE_ISINTERVIEWUPVOTE_OFFSET UNITYSDK_OFFSET(0x1C53B1D0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESERVICE_ISISSUECANSHOW_OFFSET UNITYSDK_OFFSET(0x1C5410C0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESERVICE_ISISSUECANSUBMIT_OFFSET UNITYSDK_OFFSET(0x1C540FE0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESERVICE_ISISSUESUBMITTED_OFFSET UNITYSDK_OFFSET(0x1C53B130)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESERVICE_REFRESHCANSUBMITISSUEIDS_OFFSET UNITYSDK_OFFSET(0x1C541770)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESERVICE_REFRESHINTERVIEWUPVOTE_OFFSET UNITYSDK_OFFSET(0x1C540F00)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESERVICE_REFRESHSUBMITEDISSUE_OFFSET UNITYSDK_OFFSET(0x1C5404F0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5403F0)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsIssueService_TypeDefinitionIndex = 78998;

	class LimaoNewsIssueService : public ::System::Object
	{
	public:
		::System::Collections::Generic::List_1<::System::UInt32>* _CanSubmitIssueIDs; // 0x10
		::System::Collections::Generic::HashSet_1<::System::UInt32>* _SubmittedIssueIDs; // 0x18
		::Class_1_0BE9E9C1D5A3C687* _LimaoNewsConditionService; // 0x20
		::System::Collections::Generic::HashSet_1<::System::UInt32>* _UpvoteInterviewIDs; // 0x28
		...
		::System::Void RefreshSubmitedIssue(::Google::Protobuf::Collections::RepeatedField_1<::Class_1_7FF19F6206AF6DD7_48*>* a1)
		{
			return ((::System::Void(*)(::PVOID, ::Google::Protobuf::Collections::RepeatedField_1<::Class_1_7FF19F6206AF6DD7_48*>*))((::PBYTE)hIl2Cpp + RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESERVICE_REFRESHSUBMITEDISSUE_OFFSET))(this, a1);
		}
