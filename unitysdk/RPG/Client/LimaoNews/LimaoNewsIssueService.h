...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESERVICE_ADDSUBMITTEDISSUEID_OFFSET UNITYSDK_OFFSET(0x1A778020)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESERVICE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A7774F0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESERVICE_GETALLCANSUBMITISSUEDATA_OFFSET UNITYSDK_OFFSET(0x1A778680)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESERVICE_GETALLSHOWISSUEDATA_OFFSET UNITYSDK_OFFSET(0x1A7781F0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESERVICE_GETTOPISSUEDATA_OFFSET UNITYSDK_OFFSET(0x1A7784E0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESERVICE_HASCANSUBMITISSUE_OFFSET UNITYSDK_OFFSET(0x1A778B00)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESERVICE_ISINTERVIEWUPVOTE_OFFSET UNITYSDK_OFFSET(0x1A772700)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESERVICE_ISISSUECANSHOW_OFFSET UNITYSDK_OFFSET(0x1A778160)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESERVICE_ISISSUECANSUBMIT_OFFSET UNITYSDK_OFFSET(0x1A778080)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESERVICE_ISISSUESUBMITTED_OFFSET UNITYSDK_OFFSET(0x1A772660)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESERVICE_REFRESHCANSUBMITISSUEIDS_OFFSET UNITYSDK_OFFSET(0x1A778890)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESERVICE_REFRESHINTERVIEWUPVOTE_OFFSET UNITYSDK_OFFSET(0x1A777FA0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESERVICE_REFRESHSUBMITEDISSUE_OFFSET UNITYSDK_OFFSET(0x1A777590)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A777490)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsIssueService_TypeDefinitionIndex = 75429;

	class LimaoNewsIssueService : public ::System::Object
	{
	public:
		::System::Collections::Generic::List_1<::System::UInt32>* _CanSubmitIssueIDs; // 0x10
		::System::Collections::Generic::HashSet_1<::System::UInt32>* _UpvoteInterviewIDs; // 0x18
		...
		::System::Void RefreshSubmitedIssue(::Google::Protobuf::Collections::RepeatedField_1<::Class_1_7FF19F6206AF6DD7_38*>* a1)
		{
			return ((::System::Void(*)(::PVOID, ::Google::Protobuf::Collections::RepeatedField_1<::Class_1_7FF19F6206AF6DD7_38*>*))((::PBYTE)hIl2Cpp + RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESERVICE_REFRESHSUBMITEDISSUE_OFFSET))(this, a1);
		}
