...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESERVICE_ADDSUBMITTEDISSUEID_OFFSET UNITYSDK_OFFSET(0xD460A40)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESERVICE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD45FF10)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESERVICE_GETALLCANSUBMITISSUEDATA_OFFSET UNITYSDK_OFFSET(0xD461050)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESERVICE_GETALLSHOWISSUEDATA_OFFSET UNITYSDK_OFFSET(0xD460C10)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESERVICE_GETTOPISSUEDATA_OFFSET UNITYSDK_OFFSET(0xD460ED0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESERVICE_HASCANSUBMITISSUE_OFFSET UNITYSDK_OFFSET(0xD4614A0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESERVICE_ISINTERVIEWUPVOTE_OFFSET UNITYSDK_OFFSET(0xD45ACA0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESERVICE_ISISSUECANSHOW_OFFSET UNITYSDK_OFFSET(0xD460B80)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESERVICE_ISISSUECANSUBMIT_OFFSET UNITYSDK_OFFSET(0xD460AA0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESERVICE_ISISSUESUBMITTED_OFFSET UNITYSDK_OFFSET(0xD45AC00)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESERVICE_REFRESHCANSUBMITISSUEIDS_OFFSET UNITYSDK_OFFSET(0xD461230)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESERVICE_REFRESHINTERVIEWUPVOTE_OFFSET UNITYSDK_OFFSET(0xD4609C0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESERVICE_REFRESHSUBMITEDISSUE_OFFSET UNITYSDK_OFFSET(0xD45FFB0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0xD45FEB0)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsIssueService_TypeDefinitionIndex = 78999;
