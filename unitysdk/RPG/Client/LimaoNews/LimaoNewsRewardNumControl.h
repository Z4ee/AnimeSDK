...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSREWARDNUMCONTROL_SETREWARDID_OFFSET UNITYSDK_OFFSET(0x1C4AB050)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSREWARDNUMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4AB0A0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSREWARDNUMCONTROL__GETREWARDCOUNT_OFFSET UNITYSDK_OFFSET(0x1C4AAFB0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSREWARDNUMCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1C4AAF20)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSREWARDNUMCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1C4AAEC0)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsRewardNumControl_TypeDefinitionIndex = 79036;
