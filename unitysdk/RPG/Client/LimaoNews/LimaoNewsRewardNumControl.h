...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSREWARDNUMCONTROL_SETREWARDID_OFFSET UNITYSDK_OFFSET(0xD48DB40)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSREWARDNUMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xD48DB90)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSREWARDNUMCONTROL__GETREWARDCOUNT_OFFSET UNITYSDK_OFFSET(0xD48DAA0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSREWARDNUMCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD48DA10)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSREWARDNUMCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xD48D9B0)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsRewardNumControl_TypeDefinitionIndex = 79037;
