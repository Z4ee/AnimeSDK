...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUECONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1C53C780)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUECONTROL_ONLIMAONEWSSUBMITISSUE_OFFSET UNITYSDK_OFFSET(0x1C53D490)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUECONTROL_REFRESHSUBMITNODE_OFFSET UNITYSDK_OFFSET(0x1C53D360)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUECONTROL_TRYSHOWSUBMITNODEWITHFADEIN_OFFSET UNITYSDK_OFFSET(0x1C53D030)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C53D870)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUECONTROL__GETPAGENUMITEMCONTROL_OFFSET UNITYSDK_OFFSET(0x1C53CAC0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUECONTROL__GETTABITEMCONTROL_OFFSET UNITYSDK_OFFSET(0x1C53C800)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUECONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1C53B720)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUECONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1C53B370)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsIssueControl_TypeDefinitionIndex = 79063;
