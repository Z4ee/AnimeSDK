...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUECONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1A7739F0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUECONTROL_ONLIMAONEWSSUBMITISSUE_OFFSET UNITYSDK_OFFSET(0x1A774690)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUECONTROL_REFRESHSUBMITNODE_OFFSET UNITYSDK_OFFSET(0x1A7745D0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUECONTROL_TRYSHOWSUBMITNODEWITHFADEIN_OFFSET UNITYSDK_OFFSET(0x1A774330)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A774A70)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUECONTROL__GETPAGENUMITEMCONTROL_OFFSET UNITYSDK_OFFSET(0x1A773D90)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUECONTROL__GETTABITEMCONTROL_OFFSET UNITYSDK_OFFSET(0x1A773AD0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUECONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1A772C90)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUECONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1A7728C0)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsIssueControl_TypeDefinitionIndex = 75482;
