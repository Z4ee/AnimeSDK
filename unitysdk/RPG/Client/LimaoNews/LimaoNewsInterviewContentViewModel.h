...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERVIEWCONTENTVIEWMODEL_ADDSUBCONTENTS_OFFSET UNITYSDK_OFFSET(0x1A76BC80)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERVIEWCONTENTVIEWMODEL_GET_CONTENTDATAS_OFFSET UNITYSDK_OFFSET(0x1A76BD60)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERVIEWCONTENTVIEWMODEL_GET_MAINCONTENT_OFFSET UNITYSDK_OFFSET(0x1A76BAD0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERVIEWCONTENTVIEWMODEL_SET_CONTENTDATAS_OFFSET UNITYSDK_OFFSET(0x1A76BD70)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERVIEWCONTENTVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A76BB80)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsInterviewContentViewModel_TypeDefinitionIndex = 75522;
