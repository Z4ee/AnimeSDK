...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERVIEWCONTENTVIEWMODEL_ADDSUBCONTENTS_OFFSET UNITYSDK_OFFSET(0xBD7DCF0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERVIEWCONTENTVIEWMODEL_GET_CONTENTDATAS_OFFSET UNITYSDK_OFFSET(0xBD7DDD0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERVIEWCONTENTVIEWMODEL_GET_MAINCONTENT_OFFSET UNITYSDK_OFFSET(0xBD7DA80)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERVIEWCONTENTVIEWMODEL_SET_CONTENTDATAS_OFFSET UNITYSDK_OFFSET(0xBD7DDE0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERVIEWCONTENTVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xBD7DBF0)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsInterviewContentViewModel_TypeDefinitionIndex = 73871;
