...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM_CREATE_OFFSET UNITYSDK_OFFSET(0xD4744E0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD4747E0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM_FETCHFIRSTJUMPABLESUBMISSIONDATA_OFFSET UNITYSDK_OFFSET(0xD4758C0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM_GETBIGMAPICON_OFFSET UNITYSDK_OFFSET(0xD475B40)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM_GETLIMAODATA_OFFSET UNITYSDK_OFFSET(0xD474FC0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM_GETLOACTIONDATA_OFFSET UNITYSDK_OFFSET(0xD475140)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM_GETSURVEYTYPEDATA_OFFSET UNITYSDK_OFFSET(0xD475020)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM_GET_CURCONTENTDATAS_OFFSET UNITYSDK_OFFSET(0xD475640)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM_GET_CURCONTENTID_OFFSET UNITYSDK_OFFSET(0xD4754C0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM_GET_DESC_OFFSET UNITYSDK_OFFSET(0xD475340)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM_GET_DISPLAYREWARDID_OFFSET UNITYSDK_OFFSET(0xD4749C0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM_GET_FINISHCONDITIONIDS_OFFSET UNITYSDK_OFFSET(0xD474E70)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM_GET_HIDEREWARDAFTERSTART_OFFSET UNITYSDK_OFFSET(0xD474AC0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM_GET_ISMISSIONTARGET_OFFSET UNITYSDK_OFFSET(0xD475C60)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM_GET_LIMAOID_OFFSET UNITYSDK_OFFSET(0xD474890)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM_GET_PICTUREPATH_OFFSET UNITYSDK_OFFSET(0xD4748B0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM_GET_SHOWCONDITIONIDS_OFFSET UNITYSDK_OFFSET(0xD474BD0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM_GET_STARTCONDITIONIDS_OFFSET UNITYSDK_OFFSET(0xD474D20)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM_GET_SURVEYID_OFFSET UNITYSDK_OFFSET(0xD474870)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM_REFRESH_OFFSET UNITYSDK_OFFSET(0xD474820)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM_SET_LIMAOID_OFFSET UNITYSDK_OFFSET(0xD4748A0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM_SET_SURVEYID_OFFSET UNITYSDK_OFFSET(0xD474880)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xD474560)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM__GETFIRSTJUMPABLESUBMISSIONDATA_OFFSET UNITYSDK_OFFSET(0xD475CC0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM__GETFIRSTSTARTANDHASWAYPOINTSUBMISSIONDATA_OFFSET UNITYSDK_OFFSET(0xD475DA0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM__GETSURVEYROW_OFFSET UNITYSDK_OFFSET(0xD474960)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYITEM__INITTRACKDATALIST_OFFSET UNITYSDK_OFFSET(0xD4745A0)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsOfficeSurveyItem_TypeDefinitionIndex = 78971;
	...
	public:
		...
		::RPG::Client::LimaoNews::LimaoNewsLocationData* _LocationData; // 0x18
		::RPG::Client::LimaoNews::LimaoNewsLimaoData* _LimaoData; // 0x20
