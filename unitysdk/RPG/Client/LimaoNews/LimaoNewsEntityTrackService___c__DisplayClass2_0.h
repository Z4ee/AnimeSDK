...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSENTITYTRACKSERVICE___C__DISPLAYCLASS2_0__BEGINTRACKENTITY_B__0_OFFSET UNITYSDK_OFFSET(0x1C530D50)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSENTITYTRACKSERVICE___C__DISPLAYCLASS2_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C530D40)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsEntityTrackService___c__DisplayClass2_0_TypeDefinitionIndex = 78996;

	class LimaoNewsEntityTrackService___c__DisplayClass2_0 : public ::System::Object
	{
	public:
		::Class_1_F917B69C2E81F61E* trackData; // 0x10
		::RPG::Client::LimaoNews::LimaoNewsEntityTrackService* __4__this; // 0x18
