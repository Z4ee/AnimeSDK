...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKPROGRESSRESULTVIEWMODEL_CREATEFORREVIEW_OFFSET UNITYSDK_OFFSET(0xD49F790)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKPROGRESSRESULTVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0xD49F030)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKPROGRESSRESULTVIEWMODEL_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD49FD30)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKPROGRESSRESULTVIEWMODEL_GET_ISINREVIEW_OFFSET UNITYSDK_OFFSET(0xD4A0400)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKPROGRESSRESULTVIEWMODEL_GET_MESSAGEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD4A0480)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKPROGRESSRESULTVIEWMODEL_GET_ONGOINGVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD4A03E0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKPROGRESSRESULTVIEWMODEL_GET_RECORDITEMVIEWMODELS_OFFSET UNITYSDK_OFFSET(0xD4A0460)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKPROGRESSRESULTVIEWMODEL_GET_RESULTDATA_OFFSET UNITYSDK_OFFSET(0xD4A0440)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKPROGRESSRESULTVIEWMODEL_GET_STARTVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD4A0420)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKPROGRESSRESULTVIEWMODEL_PREPAREJUMPINTERACTSUBMISSIONDATA_OFFSET UNITYSDK_OFFSET(0xD49B230)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKPROGRESSRESULTVIEWMODEL_SET_ISINREVIEW_OFFSET UNITYSDK_OFFSET(0xD4A0410)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKPROGRESSRESULTVIEWMODEL_SET_MESSAGEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD4A0490)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKPROGRESSRESULTVIEWMODEL_SET_ONGOINGVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD4A03F0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKPROGRESSRESULTVIEWMODEL_SET_RECORDITEMVIEWMODELS_OFFSET UNITYSDK_OFFSET(0xD4A0470)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKPROGRESSRESULTVIEWMODEL_SET_RESULTDATA_OFFSET UNITYSDK_OFFSET(0xD4A0450)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKPROGRESSRESULTVIEWMODEL_SET_STARTVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD4A0430)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKPROGRESSRESULTVIEWMODEL__ADDSUBMISSIONID_OFFSET UNITYSDK_OFFSET(0xD49FC10)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKPROGRESSRESULTVIEWMODEL__APPENDHISTORYMESSAGESEQUENCE_OFFSET UNITYSDK_OFFSET(0xD49FAE0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKPROGRESSRESULTVIEWMODEL__CREATEHISTORYMESSAGEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD49F980)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKPROGRESSRESULTVIEWMODEL__CREATEMESSAGEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD49F720)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKPROGRESSRESULTVIEWMODEL__CREATERECORDITEMVIEWMODELS_OFFSET UNITYSDK_OFFSET(0xD49F400)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKPROGRESSRESULTVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xD49F330)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKPROGRESSRESULTVIEWMODEL__ONALLITEMSPLAYED_OFFSET UNITYSDK_OFFSET(0xD4A0170)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKPROGRESSRESULTVIEWMODEL__ONOPTIONCLICK_OFFSET UNITYSDK_OFFSET(0xD49FEC0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKPROGRESSRESULTVIEWMODEL__RECORDMESSAGEOPTION_OFFSET UNITYSDK_OFFSET(0xD49FFC0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKPROGRESSRESULTVIEWMODEL__SENDFINISHMESSAGE_OFFSET UNITYSDK_OFFSET(0xD4A01D0)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsWorkProgressResultViewModel_TypeDefinitionIndex = 79127;

	class LimaoNewsWorkProgressResultViewModel : public ::RPG::Client::LimaoNews::LimaoNewsWorkProgressBaseViewModel
	{
	public:
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Collections::Generic::List_1<::System::UInt32>*>* _MessageOptionFlowByMessageID; // 0x38
		::RPG::Client::LimaoNews::LimaoNewsWorkProgressStartViewModel* _StartViewModel_k__BackingField; // 0x40
		::RPG::Client::LimaoNews::LimaoNewsBoxMessageViewModel* _MessageViewModel_k__BackingField; // 0x48
		::RPG::Client::LimaoNews::LimaoNewsWorkProgressOngoingViewModel* _OngoingViewModel_k__BackingField; // 0x50
		::System::Collections::Generic::List_1<::RPG::Client::LimaoNews::LimaoNewsWorkProgressRecordItemViewModel*>* _RecordItemViewModels_k__BackingField; // 0x58
