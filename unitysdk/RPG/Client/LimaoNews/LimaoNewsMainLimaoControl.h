...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINLIMAOCONTROL_INITENTITY_OFFSET UNITYSDK_OFFSET(0x1A77EED0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINLIMAOCONTROL_PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0x1A77F1B0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINLIMAOCONTROL_PLAYFADEOUT_OFFSET UNITYSDK_OFFSET(0x1A77F560)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINLIMAOCONTROL_PLAYFREESTYLE_OFFSET UNITYSDK_OFFSET(0x1A77F8E0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINLIMAOCONTROL_SETEYEEMOTION_OFFSET UNITYSDK_OFFSET(0x1A77EFC0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINLIMAOCONTROL_SETLOOKATTARGET_OFFSET UNITYSDK_OFFSET(0x1A77EF60)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINLIMAOCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A77FB20)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINLIMAOCONTROL__GETENTITY_OFFSET UNITYSDK_OFFSET(0x1A77FA80)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINLIMAOCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1A77EC60)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINLIMAOCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1A77EB60)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINLIMAOCONTROL__PLAYENTITYDITHER_OFFSET UNITYSDK_OFFSET(0x1A77F3D0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINLIMAOCONTROL__PLAYFADEIN_G__ONTIMELINEAPPEARONSTOPPED_3_0_OFFSET UNITYSDK_OFFSET(0x1A77FB50)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINLIMAOCONTROL__PLAYFADEOUT_G__ONTIMELINEDISAPPEARONSTOPPED_4_0_OFFSET UNITYSDK_OFFSET(0x1A77FC30)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsMainLimaoControl_TypeDefinitionIndex = 75464;
