...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINLIMAOCONTROL_INITENTITY_OFFSET UNITYSDK_OFFSET(0x1C549AC0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINLIMAOCONTROL_PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0x1C549C70)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINLIMAOCONTROL_PLAYFADEOUT_OFFSET UNITYSDK_OFFSET(0x1C549850)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINLIMAOCONTROL_PLAYFREESTYLE_OFFSET UNITYSDK_OFFSET(0x1C549B10)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINLIMAOCONTROL_SETEYEEMOTION_OFFSET UNITYSDK_OFFSET(0x1C54A100)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINLIMAOCONTROL_SETLOOKATTARGET_OFFSET UNITYSDK_OFFSET(0x1C549FD0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINLIMAOCONTROL_SWITCHLIMAOSTATUS_OFFSET UNITYSDK_OFFSET(0x1C549370)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINLIMAOCONTROL__APPLYVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1C549190)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINLIMAOCONTROL__CREATELIMAOGROUP_OFFSET UNITYSDK_OFFSET(0x1C548EB0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINLIMAOCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C54A750)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINLIMAOCONTROL__GETCURRENTLIMAOGROUP_OFFSET UNITYSDK_OFFSET(0x1C549F60)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINLIMAOCONTROL__GETENTITYNAME_OFFSET UNITYSDK_OFFSET(0x1C54A680)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINLIMAOCONTROL__GETENTITY_OFFSET UNITYSDK_OFFSET(0x1C54A480)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINLIMAOCONTROL__GETGROUPPATH_OFFSET UNITYSDK_OFFSET(0x1C54A530)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINLIMAOCONTROL__GETLIMAOPATH_OFFSET UNITYSDK_OFFSET(0x1C54A5A0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINLIMAOCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1C5490E0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINLIMAOCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1C548C80)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINLIMAOCONTROL__PLAYENTITYDITHER_OFFSET UNITYSDK_OFFSET(0x1C54A280)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINLIMAOCONTROL__PLAYFADEIN_G__ONTIMELINEAPPEARONSTOPPED_9_0_OFFSET UNITYSDK_OFFSET(0x1C54A790)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINLIMAOCONTROL__PLAYFADEOUT_G__ONTIMELINEDISAPPEARONSTOPPED_10_0_OFFSET UNITYSDK_OFFSET(0x1C54A870)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINLIMAOCONTROL__SETLIMAOCOUNT_OFFSET UNITYSDK_OFFSET(0x1C549E90)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINLIMAOCONTROL__SWITCHTOVIEWMODELIMMEDIATE_OFFSET UNITYSDK_OFFSET(0x1C549410)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINLIMAOCONTROL__SWITCHTOVIEWMODELWITHFADEINANDFADEOUT_OFFSET UNITYSDK_OFFSET(0x1C549730)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINLIMAOCONTROL__SWITCHTOVIEWMODELWITHFADEIN_OFFSET UNITYSDK_OFFSET(0x1C5494C0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINLIMAOCONTROL__SWITCHTOVIEWMODELWITHFADEOUT_OFFSET UNITYSDK_OFFSET(0x1C549620)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsMainLimaoControl_TypeDefinitionIndex = 79041;
