...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE_CREATEINTERVIEWDETAILPAGE_1_OFFSET UNITYSDK_OFFSET(0x1C4B7650)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE_CREATEINTERVIEWDETAILPAGE_OFFSET UNITYSDK_OFFSET(0x1C4B77B0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE_CREATEPOSTDETAILWINDOW_OFFSET UNITYSDK_OFFSET(0x1C4AC3B0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE_CREATEPOSTSUBMITWINDOW_OFFSET UNITYSDK_OFFSET(0x1C4B7C20)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE_CREATEWEBSITEPAGE_OFFSET UNITYSDK_OFFSET(0x1C4B72B0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C4B6780)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE_ENTERMAINENTRANCEPAGE_1_OFFSET UNITYSDK_OFFSET(0x1C4B69C0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE_ENTERMAINENTRANCEPAGE_OFFSET UNITYSDK_OFFSET(0x1C4B6970)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE_GETCURRENTCITYTYPE_OFFSET UNITYSDK_OFFSET(0x1C4B67C0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE_SHOWINTERVIEWDETAILPAGE_OFFSET UNITYSDK_OFFSET(0x1C4B75D0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE_SHOWISSUESUBMITWINDOW_OFFSET UNITYSDK_OFFSET(0x1C4B7A50)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE_SHOWLIMAONEWSISSUEHINTPOPUPMESSAGE_OFFSET UNITYSDK_OFFSET(0x1C4B80D0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE_SHOWLIMAONEWSMANAGEMENTPAGE_OFFSET UNITYSDK_OFFSET(0x1C4B82A0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE_SHOWLIMAONEWSSPONSORINTRODUCTION_OFFSET UNITYSDK_OFFSET(0x1C4AC7F0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE_SHOWMAINENTRANCEPAGE_OFFSET UNITYSDK_OFFSET(0x1C4B6B80)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE_SHOWMAINENTRANCEWEBSITEPAGE_OFFSET UNITYSDK_OFFSET(0x1C4B6E10)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE_SHOWPLANPHASESUBMITWINDOW_OFFSET UNITYSDK_OFFSET(0x1C4B7E70)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE_SHOWPLANREVIEWDIALOG_OFFSET UNITYSDK_OFFSET(0x1C4B8C30)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE_SHOWPLANSUBMITWINDOW_OFFSET UNITYSDK_OFFSET(0x1C4B7FA0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE_SHOWPOSTDETAILWINDOWBYPOSTDATA_OFFSET UNITYSDK_OFFSET(0x1C4B79E0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE_SHOWPOSTDETAILWINDOW_OFFSET UNITYSDK_OFFSET(0x1C4A78F0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE_SHOWPOSTFULLSCREENCOMIC_OFFSET UNITYSDK_OFFSET(0x1C4A7370)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE_SHOWPOSTFULLSCREENVIDEO_OFFSET UNITYSDK_OFFSET(0x1C4A75D0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE_SHOWPOSTSUBMITWINDOW_OFFSET UNITYSDK_OFFSET(0x1C4A7250)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE_SHOWWEBSITEPAGEANDOPENPOSTDETAIL_OFFSET UNITYSDK_OFFSET(0x1C4B74D0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE_SHOWWEBSITEPAGE_1_OFFSET UNITYSDK_OFFSET(0x1C4B7150)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE_SHOWWEBSITEPAGE_OFFSET UNITYSDK_OFFSET(0x1C4B71C0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE_SHOWWORKPROGRESSONGOINGPAGE_OFFSET UNITYSDK_OFFSET(0x1C4B8690)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE_SHOWWORKPROGRESSRESULTDIALOG_OFFSET UNITYSDK_OFFSET(0x1C4B8DA0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE_SHOWWORKPROGRESSRESULTPAGEBYVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1C4B8740)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE_SHOWWORKPROGRESSSTARTPAGE_OFFSET UNITYSDK_OFFSET(0x1C4B84E0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE_SWITCHCITY_OFFSET UNITYSDK_OFFSET(0x1C4B6860)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4B8E70)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE__ENTERMAINENTRANCEPAGE_B__5_0_OFFSET UNITYSDK_OFFSET(0x1C4B8E80)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE__ENTERMAINENTRANCEPAGE_B__5_1_OFFSET UNITYSDK_OFFSET(0x1C4B91C0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE__ONTRIGGERENTRANCENEWGUIDE_OFFSET UNITYSDK_OFFSET(0x1C4B8DF0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE__SHOWPOSTSUBMITWINDOW_OFFSET UNITYSDK_OFFSET(0x1C4B7E00)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWINDOWSERVICE__SHOWWORKPROGRESSPAGE_OFFSET UNITYSDK_OFFSET(0x1C4B8590)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsWindowService_TypeDefinitionIndex = 79022;
