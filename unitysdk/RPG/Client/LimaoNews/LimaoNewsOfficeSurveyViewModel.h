...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYVIEWMODEL_FIXCOMPLETEOFFICESURVEYLIST_OFFSET UNITYSDK_OFFSET(0x1A7892B0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYVIEWMODEL_GETFILTERLOCATIONDATAS_OFFSET UNITYSDK_OFFSET(0x1A788DA0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYVIEWMODEL_GETFILTERSTATES_OFFSET UNITYSDK_OFFSET(0x1A788FD0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYVIEWMODEL_GETFILTERSURVEYTYPEDATAS_OFFSET UNITYSDK_OFFSET(0x1A788B70)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYVIEWMODEL_GETSHOWITEMS_OFFSET UNITYSDK_OFFSET(0x1A788700)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYVIEWMODEL_GETTOTALSHOWCOUNT_OFFSET UNITYSDK_OFFSET(0x1A788870)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYVIEWMODEL_GET_RECOMMENDSERVICEID_OFFSET UNITYSDK_OFFSET(0x1A789310)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYVIEWMODEL_ISANYSURVEYCANSHOW_OFFSET UNITYSDK_OFFSET(0x1A7887E0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYVIEWMODEL_ISFINISHEDALLSURVEY_OFFSET UNITYSDK_OFFSET(0x1A788780)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYVIEWMODEL_REFRESHOFFICESURVEYBYFILTER_OFFSET UNITYSDK_OFFSET(0x1A788B00)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYVIEWMODEL_REFRESHSELECTEDFILTER_OFFSET UNITYSDK_OFFSET(0x1A7888D0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSOFFICESURVEYVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7885D0)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsOfficeSurveyViewModel_TypeDefinitionIndex = 75520;

	class LimaoNewsOfficeSurveyViewModel : public ::Sofa::BaseViewModel
	{
	public:
		::System::Collections::Generic::List_1<::System::UInt32>* _SelectedSurveyTypes; // 0x20
		::System::Collections::Generic::List_1<::Enum_3_4608E37A1B3D374A_21>* _SelectedStates; // 0x28
		::System::Collections::Generic::List_1<::System::UInt32>* _SelectedLocationIDs; // 0x30
