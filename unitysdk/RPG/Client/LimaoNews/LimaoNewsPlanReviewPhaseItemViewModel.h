...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANREVIEWPHASEITEMVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0xD478640)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANREVIEWPHASEITEMVIEWMODEL_GET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0xD478950)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANREVIEWPHASEITEMVIEWMODEL_GET_OPENWORKPROGRESSCOMMAND_OFFSET UNITYSDK_OFFSET(0xD478990)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANREVIEWPHASEITEMVIEWMODEL_GET_PHASEDESC_OFFSET UNITYSDK_OFFSET(0xD478910)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANREVIEWPHASEITEMVIEWMODEL_GET_PHASERECORD_OFFSET UNITYSDK_OFFSET(0xD478930)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANREVIEWPHASEITEMVIEWMODEL_GET_PLANID_OFFSET UNITYSDK_OFFSET(0xD4788B0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANREVIEWPHASEITEMVIEWMODEL_GET_PLANPHASEID_OFFSET UNITYSDK_OFFSET(0xD4788D0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANREVIEWPHASEITEMVIEWMODEL_GET_PLANPHASETYPE_OFFSET UNITYSDK_OFFSET(0xD4788F0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANREVIEWPHASEITEMVIEWMODEL_GET_REPLAYPERFORMANCECOMMAND_OFFSET UNITYSDK_OFFSET(0xD478970)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANREVIEWPHASEITEMVIEWMODEL_SET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0xD478960)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANREVIEWPHASEITEMVIEWMODEL_SET_OPENWORKPROGRESSCOMMAND_OFFSET UNITYSDK_OFFSET(0xD4789A0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANREVIEWPHASEITEMVIEWMODEL_SET_PHASEDESC_OFFSET UNITYSDK_OFFSET(0xD478920)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANREVIEWPHASEITEMVIEWMODEL_SET_PHASERECORD_OFFSET UNITYSDK_OFFSET(0xD478940)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANREVIEWPHASEITEMVIEWMODEL_SET_PLANID_OFFSET UNITYSDK_OFFSET(0xD4788C0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANREVIEWPHASEITEMVIEWMODEL_SET_PLANPHASEID_OFFSET UNITYSDK_OFFSET(0xD4788E0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANREVIEWPHASEITEMVIEWMODEL_SET_PLANPHASETYPE_OFFSET UNITYSDK_OFFSET(0xD478900)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANREVIEWPHASEITEMVIEWMODEL_SET_REPLAYPERFORMANCECOMMAND_OFFSET UNITYSDK_OFFSET(0xD478980)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANREVIEWPHASEITEMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xD478890)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsPlanReviewPhaseItemViewModel_TypeDefinitionIndex = 79119;

	class LimaoNewsPlanReviewPhaseItemViewModel : public ::Sofa::BaseViewModel
	{
	public:
		::Sofa::Core::SimpleCommand* _OpenWorkProgressCommand_k__BackingField; // 0x20
		::Sofa::Core::SimpleCommand* _ReplayPerformanceCommand_k__BackingField; // 0x28
		::RPG::Client::TextID _PhaseDesc_k__BackingField; // 0x30
		::RPG::Client::TextID _PhaseRecord_k__BackingField; // 0x40
		::System::UInt32 _PlanID_k__BackingField; // 0x50
		::System::UInt32 _PlanPhaseID_k__BackingField; // 0x54
		::RPG::GameCore::LimaoNewsPlanPhaseType _PlanPhaseType_k__BackingField; // 0x58
		::System::Boolean _IsFinished_k__BackingField; // 0x5C
