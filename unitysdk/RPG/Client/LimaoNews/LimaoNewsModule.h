...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C54FD80)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_GET_CONDITIONSERVICE_OFFSET UNITYSDK_OFFSET(0x1C5504E0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_GET_EMPLOYEECHECKSERVICE_OFFSET UNITYSDK_OFFSET(0x1C550640)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_GET_ENTITYTRACKSERVICE_OFFSET UNITYSDK_OFFSET(0x1C550660)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_GET_ISSUESERVICE_OFFSET UNITYSDK_OFFSET(0x1C550540)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_GET_LIMAOSERVICE_OFFSET UNITYSDK_OFFSET(0x1C550580)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_GET_MESSAGESERVICE_OFFSET UNITYSDK_OFFSET(0x1C550600)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_GET_NETWORKSERVICE_OFFSET UNITYSDK_OFFSET(0x1C550480)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_GET_OFFERINGSERVICE_OFFSET UNITYSDK_OFFSET(0x1C5505A0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_GET_OFFICEEVENTSERVICE_OFFSET UNITYSDK_OFFSET(0x1C550520)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_GET_OFFICESURVEYSERVICE_OFFSET UNITYSDK_OFFSET(0x1C550500)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_GET_PLANSERVICE_OFFSET UNITYSDK_OFFSET(0x1C550620)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_GET_POSTSERVICE_OFFSET UNITYSDK_OFFSET(0x1C550560)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_GET_SPONSORSERVICE_OFFSET UNITYSDK_OFFSET(0x1C5505E0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_GET_TRACKSERVICE_OFFSET UNITYSDK_OFFSET(0x1C5505C0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_GET_TUTORIALSERVICE_OFFSET UNITYSDK_OFFSET(0x1C5504C0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_GET_WINDOWSERVICE_OFFSET UNITYSDK_OFFSET(0x1C5504A0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_INIT_OFFSET UNITYSDK_OFFSET(0x1C54F580)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_SET_CONDITIONSERVICE_OFFSET UNITYSDK_OFFSET(0x1C5504F0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_SET_EMPLOYEECHECKSERVICE_OFFSET UNITYSDK_OFFSET(0x1C550650)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_SET_ENTITYTRACKSERVICE_OFFSET UNITYSDK_OFFSET(0x1C550670)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_SET_ISSUESERVICE_OFFSET UNITYSDK_OFFSET(0x1C550550)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_SET_LIMAOSERVICE_OFFSET UNITYSDK_OFFSET(0x1C550590)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_SET_MESSAGESERVICE_OFFSET UNITYSDK_OFFSET(0x1C550610)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_SET_NETWORKSERVICE_OFFSET UNITYSDK_OFFSET(0x1C550490)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_SET_OFFERINGSERVICE_OFFSET UNITYSDK_OFFSET(0x1C5505B0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_SET_OFFICEEVENTSERVICE_OFFSET UNITYSDK_OFFSET(0x1C550530)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_SET_OFFICESURVEYSERVICE_OFFSET UNITYSDK_OFFSET(0x1C550510)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_SET_PLANSERVICE_OFFSET UNITYSDK_OFFSET(0x1C550630)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_SET_POSTSERVICE_OFFSET UNITYSDK_OFFSET(0x1C550570)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_SET_SPONSORSERVICE_OFFSET UNITYSDK_OFFSET(0x1C5505F0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_SET_TRACKSERVICE_OFFSET UNITYSDK_OFFSET(0x1C5505D0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_SET_TUTORIALSERVICE_OFFSET UNITYSDK_OFFSET(0x1C5504D0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_SET_WINDOWSERVICE_OFFSET UNITYSDK_OFFSET(0x1C5504B0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C550680)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsModule_TypeDefinitionIndex = 78967;

	class LimaoNewsModule : public ::RPG::Client::BaseModule
	{
	public:
		::RPG::Client::LimaoNews::LimaoNewsOfferingService* _OfferingService_k__BackingField; // 0x10
		::RPG::Client::LimaoNews::LimaoNewsTrackService* _TrackService_k__BackingField; // 0x18
		::RPG::Client::LimaoNews::LimaoNewsPlanService* _PlanService_k__BackingField; // 0x20
		::RPG::Client::LimaoNews::LimaoNewsNetworkService* _NetworkService_k__BackingField; // 0x28
		::Class_1_895FB63906FAA27E* _OfficeEventService_k__BackingField; // 0x30
		::RPG::Client::LimaoNews::LimaoNewsIssueService* _IssueService_k__BackingField; // 0x38
		::Class_1_C56ACF52E09DFFD3* _LimaoService_k__BackingField; // 0x40
		::RPG::Client::LimaoNews::LimaoNewsOfficeSurveyService* _OfficeSurveyService_k__BackingField; // 0x48
		::RPG::Client::LimaoNews::LimaoNewsEntityTrackService* _EntityTrackService_k__BackingField; // 0x50
		::Class_1_9917656EF7E54194* _SponsorService_k__BackingField; // 0x58
		::RPG::Client::LimaoNews::LimaoNewsPostService* _PostService_k__BackingField; // 0x60
		::RPG::Client::LimaoNews::LimaoNewsMessageService* _MessageService_k__BackingField; // 0x68
		::RPG::Client::LimaoNews::LimaoNewsTutorialService* _TutorialService_k__BackingField; // 0x70
		::Class_1_AB4ED2B21F301DB7* _EmployeeCheckService_k__BackingField; // 0x78
		::RPG::Client::LimaoNews::LimaoNewsWindowService* _WindowService_k__BackingField; // 0x80
		::Class_1_0BE9E9C1D5A3C687* _ConditionService_k__BackingField; // 0x88
