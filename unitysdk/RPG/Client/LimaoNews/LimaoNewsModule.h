...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A781CD0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_GET_CONDITIONSERVICE_OFFSET UNITYSDK_OFFSET(0x1A7822A0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_GET_ISSUESERVICE_OFFSET UNITYSDK_OFFSET(0x1A782300)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_GET_LIMAOSERVICE_OFFSET UNITYSDK_OFFSET(0x1A782340)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_GET_MESSAGESERVICE_OFFSET UNITYSDK_OFFSET(0x1A7823C0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_GET_NETWORKSERVICE_OFFSET UNITYSDK_OFFSET(0x1A782240)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_GET_OFFERINGSERVICE_OFFSET UNITYSDK_OFFSET(0x1A782360)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_GET_OFFICEEVENTSERVICE_OFFSET UNITYSDK_OFFSET(0x1A7822E0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_GET_OFFICESURVEYSERVICE_OFFSET UNITYSDK_OFFSET(0x1A7822C0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_GET_POSTSERVICE_OFFSET UNITYSDK_OFFSET(0x1A782320)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_GET_SPONSORSERVICE_OFFSET UNITYSDK_OFFSET(0x1A7823A0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_GET_TRACKSERVICE_OFFSET UNITYSDK_OFFSET(0x1A782380)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_GET_TUTORIALSERVICE_OFFSET UNITYSDK_OFFSET(0x1A782280)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_GET_WINDOWSERVICE_OFFSET UNITYSDK_OFFSET(0x1A782260)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_INIT_OFFSET UNITYSDK_OFFSET(0x1A781840)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_SET_CONDITIONSERVICE_OFFSET UNITYSDK_OFFSET(0x1A7822B0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_SET_ISSUESERVICE_OFFSET UNITYSDK_OFFSET(0x1A782310)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_SET_LIMAOSERVICE_OFFSET UNITYSDK_OFFSET(0x1A782350)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_SET_MESSAGESERVICE_OFFSET UNITYSDK_OFFSET(0x1A7823D0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_SET_NETWORKSERVICE_OFFSET UNITYSDK_OFFSET(0x1A782250)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_SET_OFFERINGSERVICE_OFFSET UNITYSDK_OFFSET(0x1A782370)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_SET_OFFICEEVENTSERVICE_OFFSET UNITYSDK_OFFSET(0x1A7822F0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_SET_OFFICESURVEYSERVICE_OFFSET UNITYSDK_OFFSET(0x1A7822D0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_SET_POSTSERVICE_OFFSET UNITYSDK_OFFSET(0x1A782330)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_SET_SPONSORSERVICE_OFFSET UNITYSDK_OFFSET(0x1A7823B0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_SET_TRACKSERVICE_OFFSET UNITYSDK_OFFSET(0x1A782390)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_SET_TUTORIALSERVICE_OFFSET UNITYSDK_OFFSET(0x1A782290)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE_SET_WINDOWSERVICE_OFFSET UNITYSDK_OFFSET(0x1A782270)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7823E0)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsModule_TypeDefinitionIndex = 75417;

	class LimaoNewsModule : public ::RPG::Client::BaseModule
	{
	public:
		::RPG::Client::LimaoNews::LimaoNewsMessageService* _MessageService_k__BackingField; // 0x10
		::Class_1_4780C96744815F8D* _LimaoService_k__BackingField; // 0x18
		::RPG::Client::LimaoNews::LimaoNewsNetworkService* _NetworkService_k__BackingField; // 0x20
		::RPG::Client::LimaoNews::LimaoNewsPostService* _PostService_k__BackingField; // 0x28
		::Class_1_9917656EF7E54194* _SponsorService_k__BackingField; // 0x30
		::RPG::Client::LimaoNews::LimaoNewsOfficeSurveyService* _OfficeSurveyService_k__BackingField; // 0x38
		::RPG::Client::LimaoNews::LimaoNewsWindowService* _WindowService_k__BackingField; // 0x40
		::RPG::Client::LimaoNews::LimaoNewsTutorialService* _TutorialService_k__BackingField; // 0x48
		::Class_1_895FB63906FAA27E* _OfficeEventService_k__BackingField; // 0x50
		::RPG::Client::LimaoNews::LimaoNewsOfferingService* _OfferingService_k__BackingField; // 0x58
		::RPG::Client::LimaoNews::LimaoNewsIssueService* _IssueService_k__BackingField; // 0x60
		::Class_1_0BE9E9C1D5A3C687* _ConditionService_k__BackingField; // 0x68
		::RPG::Client::LimaoNews::LimaoNewsTrackService* _TrackService_k__BackingField; // 0x70
