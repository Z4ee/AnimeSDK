...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESUBMITWINDOW_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1A779E50)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESUBMITWINDOW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A779290)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESUBMITWINDOW__ONANIMATIONTRIGGER_OFFSET UNITYSDK_OFFSET(0x1A77A020)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESUBMITWINDOW__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1A779860)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESUBMITWINDOW__ONEXITFINALSTEP_OFFSET UNITYSDK_OFFSET(0x1A779F30)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESUBMITWINDOW__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1A779360)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUESUBMITWINDOW__ONLIMAONEWSWEBSITESTATECHANGEMESSAGE_OFFSET UNITYSDK_OFFSET(0x1A779F80)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsIssueSubmitWindow_TypeDefinitionIndex = 75477;

	class LimaoNewsIssueSubmitWindow : public ::Sofa::BaseSofaWindow
	{
	public:
		::RPG::Client::LimaoNews::LimaoNewsSubmitLevelControl* _CurrentLevelControl; // 0x40
