...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERVIEWCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A76CEF0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERVIEWCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1A76BEA0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERVIEWCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1A76BD80)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERVIEWCONTROL__SETUPDECO_OFFSET UNITYSDK_OFFSET(0x1A76C710)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsInterviewControl_TypeDefinitionIndex = 75480;
