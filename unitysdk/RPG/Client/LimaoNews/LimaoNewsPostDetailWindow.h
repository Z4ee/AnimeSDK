...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1C49DE50)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__BINDBOTTOMVIEW_OFFSET UNITYSDK_OFFSET(0x1C49EE90)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__BINDBTNSVIEW_OFFSET UNITYSDK_OFFSET(0x1C49F0A0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__BINDPOSTBASICVIEW_OFFSET UNITYSDK_OFFSET(0x1C49DED0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__BINDRIGHTVIEW_OFFSET UNITYSDK_OFFSET(0x1C49EB10)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__CLEARREDDOT_OFFSET UNITYSDK_OFFSET(0x1C49FB40)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C49C890)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__MOVETOCOMMENT_OFFSET UNITYSDK_OFFSET(0x1C4A0870)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1C49DBD0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__ONEXITFINALSTEP_OFFSET UNITYSDK_OFFSET(0x1C49FBF0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1C49C930)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__ONLIMAONEWSCLOSEPOSTDETAIL_OFFSET UNITYSDK_OFFSET(0x1C4A0AD0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__ONLIMAONEWSPOSTDETAILOPERATION_OFFSET UNITYSDK_OFFSET(0x1C4A0910)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__ONLIMAONEWSPOSTMESSAGE_OFFSET UNITYSDK_OFFSET(0x1C49FE80)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__ONLIMAONEWSREFRESHUPVOTE_OFFSET UNITYSDK_OFFSET(0x1C4A0CC0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__ONLIMAONEWSREPLAYPOST_OFFSET UNITYSDK_OFFSET(0x1C4A0480)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__ONLIMAONEWSSUBMITPOST_OFFSET UNITYSDK_OFFSET(0x1C49FF20)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__ONNEWCOMMENTITEM_OFFSET UNITYSDK_OFFSET(0x1C4A1870)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILWINDOW__SUBSCRIBEMESSAGE_OFFSET UNITYSDK_OFFSET(0x1C49DB30)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsPostDetailWindow_TypeDefinitionIndex = 79083;

	class LimaoNewsPostDetailWindow : public ::Sofa::BaseSofaWindow
	{
	public:
		::UnityEngine::Transform* _UserOfficialTag; // 0x48
		::RPG::Client::LimaoNews::LimaoNewsCommentListControl* _CommentListControl; // 0x50
		::RPG::Client::AnimatorButton* _BtnImage; // 0x58
		::UnityEngine::UI::Text* _PostDesc; // 0x60
		::UnityEngine::RectTransform* _NodeDescContent; // 0x68
		::UnityEngine::Transform* _NodeBannedMask; // 0x70
		::UnityEngine::Transform* _NodeBottom; // 0x78
		::UnityEngine::Transform* _NodeDivider; // 0x80
		::UnityEngine::Transform* _NodeVideoMask; // 0x88
		::RPG::Client::AnimatorButton* _BtnEmptyClose; // 0x90
		::UnityEngine::Transform* _NodeComicMask; // 0x98
		::RPG::Client::StaticListView* _CommentListView; // 0xA0
		::UnityEngine::UI::Image* _UserImage; // 0xA8
		::RPG::Client::LimaoNews::LimaoNewsInteractionControl* _InteractionControl; // 0xB0
		::RPG::Client::AnimatorButton* _BtnClose; // 0xB8
		::UnityEngine::UI::Text* _PostTitle; // 0xC0
		::RPG::Client::LimaoNews::LimaoNewsOfficeSurveyTypeControl* _SurveyTypeControl; // 0xC8
		::UnityEngine::UI::Text* _UserName; // 0xD0
		::Class_1_5F4D64A4B97E38F9* _Messenger; // 0xD8
		::UnityEngine::UI::Image* _PostImage; // 0xE0
		::RPG::Client::LimaoNews::LimaoNewsLocationControl* _LocationControl; // 0xE8
		::UnityEngine::UI::Text* _BtnGoText; // 0xF0
		::RPG::Client::LimaoNews::LimaoNewsStateTagControl* _StateTagControl; // 0xF8
		::UnityEngine::Transform* _NodeComic; // 0x100
		::UnityEngine::Transform* _NodeComicLoadRoot; // 0x108
		::UnityEngine::Transform* _NodeImage; // 0x110
		::RPG::Client::AnimatorButton* _BtnGo; // 0x118
		::UnityEngine::UI::ScrollRect* _RightScrollRect; // 0x120
