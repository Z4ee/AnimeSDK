...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUETABVIEWMODEL_GET_ISCANSUBMIT_OFFSET UNITYSDK_OFFSET(0x1C543760)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUETABVIEWMODEL_GET_ISCURTABSELECTED_OFFSET UNITYSDK_OFFSET(0x1C53FF40)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUETABVIEWMODEL_GET_ONBTNTABCLICK_OFFSET UNITYSDK_OFFSET(0x1C5438F0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUETABVIEWMODEL_GET_TABTITLE_OFFSET UNITYSDK_OFFSET(0x1C543670)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUETABVIEWMODEL_SET_ONBTNTABCLICK_OFFSET UNITYSDK_OFFSET(0x1C543900)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUETABVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C543840)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUETABVIEWMODEL___CTOR_B__0_0_OFFSET UNITYSDK_OFFSET(0x1C5439C0)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsIssueTabViewModel_TypeDefinitionIndex = 79141;
