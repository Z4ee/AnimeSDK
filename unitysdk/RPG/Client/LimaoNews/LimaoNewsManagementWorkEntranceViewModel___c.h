...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMANAGEMENTWORKENTRANCEVIEWMODEL___C__CCTOR_OFFSET UNITYSDK_OFFSET(0xD46D420)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMANAGEMENTWORKENTRANCEVIEWMODEL___C__CTOR_OFFSET UNITYSDK_OFFSET(0xD46D460)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMANAGEMENTWORKENTRANCEVIEWMODEL___C___GETFIRSTRECRUITABLEEMPLOYEE_B__7_0_OFFSET UNITYSDK_OFFSET(0xD46D470)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsManagementWorkEntranceViewModel___c_TypeDefinitionIndex = 79108;
	...
	public:
		...
		{
			return (::RPG::Client::LimaoNews::LimaoNewsManagementWorkEntranceViewModel___c**)Il2CppClass::FromTypeDefinitionIndex(LimaoNewsManagementWorkEntranceViewModel___c_TypeDefinitionIndex)->GetStaticField(0x60420);
		}
		static ::System::Comparison_1<::RPG::Client::LimaoNews::LimaoNewsEmployeeCheckData*>** StaticGet___9__7_0()
		{
			return (::System::Comparison_1<::RPG::Client::LimaoNews::LimaoNewsEmployeeCheckData*>**)Il2CppClass::FromTypeDefinitionIndex(LimaoNewsManagementWorkEntranceViewModel___c_TypeDefinitionIndex)->GetStaticField(0x60428);
		}
