...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE___C__DISPLAYCLASS16_0__CTOR_OFFSET UNITYSDK_OFFSET(0xD47C950)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE___C__DISPLAYCLASS16_0___FINISHCURRENTPLANPHASEANDSHOWRESULTPAGE_B__0_OFFSET UNITYSDK_OFFSET(0xD47C960)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE___C__DISPLAYCLASS16_0___FINISHCURRENTPLANPHASEANDSHOWRESULTPAGE_B__1_OFFSET UNITYSDK_OFFSET(0xD47CB90)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsPlanService___c__DisplayClass16_0_TypeDefinitionIndex = 79011;
	...
	public:
		...
		::RPG::Client::LimaoNews::LimaoNewsModule* limaoModule; // 0x18
