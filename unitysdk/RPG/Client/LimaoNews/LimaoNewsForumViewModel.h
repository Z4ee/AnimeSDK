...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSFORUMVIEWMODEL_ADDPOST_OFFSET UNITYSDK_OFFSET(0x1C532CE0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSFORUMVIEWMODEL_CHANGEPOSTSTATE_OFFSET UNITYSDK_OFFSET(0x1C532E10)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSFORUMVIEWMODEL_CLEARNEWPOST_OFFSET UNITYSDK_OFFSET(0x1C5334D0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSFORUMVIEWMODEL_CREATESHOWPOSTVIEWMODELS_OFFSET UNITYSDK_OFFSET(0x1C532A10)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSFORUMVIEWMODEL_GETCANSUBMITPOSTCOUNT_OFFSET UNITYSDK_OFFSET(0x1C5331D0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSFORUMVIEWMODEL_GETNEWPOSTCOUNT_OFFSET UNITYSDK_OFFSET(0x1C533350)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSFORUMVIEWMODEL_GET_ISSHOWFILTER_OFFSET UNITYSDK_OFFSET(0x1C533680)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSFORUMVIEWMODEL_INIT_OFFSET UNITYSDK_OFFSET(0x1C532920)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSFORUMVIEWMODEL_MARKVIEWSEEN_OFFSET UNITYSDK_OFFSET(0x1C5316D0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSFORUMVIEWMODEL_REFRESHPOSTS_OFFSET UNITYSDK_OFFSET(0x1C5329C0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSFORUMVIEWMODEL_REFRESHPOST_OFFSET UNITYSDK_OFFSET(0x1C533020)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSFORUMVIEWMODEL_REMOVEPOSTLOCALCHANGESTATE_OFFSET UNITYSDK_OFFSET(0x1C532FD0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSFORUMVIEWMODEL_TRYCLEARNEWPOST_OFFSET UNITYSDK_OFFSET(0x1C533630)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSFORUMVIEWMODEL_TRYOPENPOSTDETAIL_OFFSET UNITYSDK_OFFSET(0x1C532080)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSFORUMVIEWMODEL__CREATESHOWPOSTVIEWMODELS_B__2_0_OFFSET UNITYSDK_OFFSET(0x1C533790)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSFORUMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5328C0)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsForumViewModel_TypeDefinitionIndex = 79135;
	...
	public:
		...
		::System::Collections::Generic::List_1<::RPG::Client::LimaoNews::LimaoNewsPostViewModel*>* PostViewModels; // 0x40
		::System::UInt32 MoveToPostID; // 0x48
		::System::Boolean IsMoveToNewPost; // 0x4C
		::System::Boolean _HasViewSeen; // 0x4D
		::System::UInt32 OpenPostDetailID; // 0x50
