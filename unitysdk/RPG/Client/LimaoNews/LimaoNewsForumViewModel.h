...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSFORUMVIEWMODEL_ADDPOST_OFFSET UNITYSDK_OFFSET(0xBD7BE00)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSFORUMVIEWMODEL_CHANGEPOSTSTATE_OFFSET UNITYSDK_OFFSET(0xBD7BF60)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSFORUMVIEWMODEL_CLEARNEWPOST_OFFSET UNITYSDK_OFFSET(0xBD7C670)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSFORUMVIEWMODEL_CREATESHOWPOSTVIEWMODELS_OFFSET UNITYSDK_OFFSET(0xBD7BB10)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSFORUMVIEWMODEL_GETCANSUBMITPOSTCOUNT_OFFSET UNITYSDK_OFFSET(0xBD7C310)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSFORUMVIEWMODEL_GETNEWPOSTCOUNT_OFFSET UNITYSDK_OFFSET(0xBD7C4C0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSFORUMVIEWMODEL_GET_ISSHOWFILTER_OFFSET UNITYSDK_OFFSET(0xBD7AAF0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSFORUMVIEWMODEL_INIT_OFFSET UNITYSDK_OFFSET(0xBD7BA20)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSFORUMVIEWMODEL_MARKVIEWSEEN_OFFSET UNITYSDK_OFFSET(0xBD7AD50)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSFORUMVIEWMODEL_REFRESHPOSTS_OFFSET UNITYSDK_OFFSET(0xBD7BAC0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSFORUMVIEWMODEL_REFRESHPOST_OFFSET UNITYSDK_OFFSET(0xBD7C170)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSFORUMVIEWMODEL_REMOVEPOSTLOCALCHANGESTATE_OFFSET UNITYSDK_OFFSET(0xBD7C120)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSFORUMVIEWMODEL_TRYCLEARNEWPOST_OFFSET UNITYSDK_OFFSET(0xBD7C7F0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSFORUMVIEWMODEL__CREATESHOWPOSTVIEWMODELS_B__2_0_OFFSET UNITYSDK_OFFSET(0xBD7C840)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSFORUMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xBD7B9C0)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsForumViewModel_TypeDefinitionIndex = 73875;
	...
	public:
		...
		::System::Boolean _HasViewSeen; // 0x4C
		::System::Boolean IsMoveToNewPost; // 0x4D
		::System::UInt32 MoveToPostID; // 0x50
		::System::UInt32 _TopPostID; // 0x54
