...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPERFORMANCEMESSAGEITEMVIEWMODEL_GET_PERFORMANCETEXTLIST_OFFSET UNITYSDK_OFFSET(0x1C558740)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPERFORMANCEMESSAGEITEMVIEWMODEL_SET_PERFORMANCETEXTLIST_OFFSET UNITYSDK_OFFSET(0x1C558750)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPERFORMANCEMESSAGEITEMVIEWMODEL__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C558730)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPERFORMANCEMESSAGEITEMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C558700)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsPerformanceMessageItemViewModel_TypeDefinitionIndex = 79111;
