...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKPROGRESSBASEVIEWMODEL_ADDPOPWINDOW_OFFSET UNITYSDK_OFFSET(0xD49CD80)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKPROGRESSBASEVIEWMODEL_GET_ISREVIEWMODE_OFFSET UNITYSDK_OFFSET(0xD49CD00)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKPROGRESSBASEVIEWMODEL_GET_PLANID_OFFSET UNITYSDK_OFFSET(0xD49CD20)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKPROGRESSBASEVIEWMODEL_GET_PLANPHASEID_OFFSET UNITYSDK_OFFSET(0xD49CD40)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKPROGRESSBASEVIEWMODEL_GET_POPWINDOWLIST_OFFSET UNITYSDK_OFFSET(0xD49CD60)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKPROGRESSBASEVIEWMODEL_GET_PROGRESSTYPE_OFFSET UNITYSDK_OFFSET(0xD49CCE0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKPROGRESSBASEVIEWMODEL_SET_ISREVIEWMODE_OFFSET UNITYSDK_OFFSET(0xD49CD10)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKPROGRESSBASEVIEWMODEL_SET_PLANID_OFFSET UNITYSDK_OFFSET(0xD49CD30)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKPROGRESSBASEVIEWMODEL_SET_PLANPHASEID_OFFSET UNITYSDK_OFFSET(0xD49CD50)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKPROGRESSBASEVIEWMODEL_SET_POPWINDOWLIST_OFFSET UNITYSDK_OFFSET(0xD49CD70)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKPROGRESSBASEVIEWMODEL_SET_PROGRESSTYPE_OFFSET UNITYSDK_OFFSET(0xD49CCF0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKPROGRESSBASEVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xD49CE60)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsWorkProgressBaseViewModel_TypeDefinitionIndex = 79122;
	...
	public:
		...
		::RPG::Client::LimaoNews::LimaoNewsWorkProgressType _ProgressType_k__BackingField; // 0x28
		::System::UInt32 _PlanPhaseID_k__BackingField; // 0x2C
