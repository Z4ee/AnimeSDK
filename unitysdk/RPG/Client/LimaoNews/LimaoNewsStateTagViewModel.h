...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSTATETAGVIEWMODEL_GET_STATETAG_OFFSET UNITYSDK_OFFSET(0x19B6D770)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSTATETAGVIEWMODEL_GET_SUBMITREWARDID_OFFSET UNITYSDK_OFFSET(0x19B6D7B0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSTATETAGVIEWMODEL_SET_STATETAG_OFFSET UNITYSDK_OFFSET(0x19B6D960)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSTATETAGVIEWMODEL_SET_SUBMITREWARDID_OFFSET UNITYSDK_OFFSET(0x19B6D9F0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSTATETAGVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x19B6D820)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsStateTagViewModel_TypeDefinitionIndex = 75513;
