...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSLOCATIONDATA_CREATE_1_OFFSET UNITYSDK_OFFSET(0x1A77C530)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSLOCATIONDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1A77C4D0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSLOCATIONDATA_GET_LOCATIONID_OFFSET UNITYSDK_OFFSET(0x1A77C5D0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSLOCATIONDATA_GET_LOCATIONNAME_OFFSET UNITYSDK_OFFSET(0x1A77C5F0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSLOCATIONDATA_SET_LOCATIONID_OFFSET UNITYSDK_OFFSET(0x1A77C5E0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSLOCATIONDATA_SET_LOCATIONNAME_OFFSET UNITYSDK_OFFSET(0x1A77C600)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSLOCATIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A77C5C0)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsLocationData_TypeDefinitionIndex = 75414;
