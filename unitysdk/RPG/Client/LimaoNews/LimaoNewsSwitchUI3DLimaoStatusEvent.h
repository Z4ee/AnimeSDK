...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSWITCHUI3DLIMAOSTATUSEVENT_GET_SWITCHTYPE_OFFSET UNITYSDK_OFFSET(0xD491650)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSWITCHUI3DLIMAOSTATUSEVENT_GET_VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD491630)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSWITCHUI3DLIMAOSTATUSEVENT_SET_SWITCHTYPE_OFFSET UNITYSDK_OFFSET(0xD491660)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSWITCHUI3DLIMAOSTATUSEVENT_SET_VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD491640)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSSWITCHUI3DLIMAOSTATUSEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0xD491670)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsSwitchUI3DLimaoStatusEvent_TypeDefinitionIndex = 78957;
