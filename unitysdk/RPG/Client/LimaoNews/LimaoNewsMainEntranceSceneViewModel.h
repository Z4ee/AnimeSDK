...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINENTRANCESCENEVIEWMODEL_GETCURPHASEDESKS_OFFSET UNITYSDK_OFFSET(0xD467820)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINENTRANCESCENEVIEWMODEL_GETCURPHASEPOINTIDS_OFFSET UNITYSDK_OFFSET(0xD4678D0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINENTRANCESCENEVIEWMODEL_GETSHOWLIMAODATAS_OFFSET UNITYSDK_OFFSET(0xD467980)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINENTRANCESCENEVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xD468110)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMAINENTRANCESCENEVIEWMODEL__GETEXCLUDELIMAOIDS_OFFSET UNITYSDK_OFFSET(0xD468160)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsMainEntranceSceneViewModel_TypeDefinitionIndex = 79098;
