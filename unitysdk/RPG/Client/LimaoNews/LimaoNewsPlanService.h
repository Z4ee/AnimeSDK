...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE_CREATEMANAGEMENTPLANINFOVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1C54B570)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE_CREATEONGOINGVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1C54C990)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE_CREATERESULTVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1C55BE00)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE_CREATEREVIEWDIALOGVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1C55A630)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE_CREATEREVIEWWORKPROGRESSVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1C5593A0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE_CREATESTARTVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1C54C8F0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C550330)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE_GETMANAGEMENTPLANINFOITEMVIEWMODELSTATE_OFFSET UNITYSDK_OFFSET(0x1C559820)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE_GETMANAGEMENTPLANINFOITEMVIEWMODELS_OFFSET UNITYSDK_OFFSET(0x1C559C30)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE_GETPLANDATA_OFFSET UNITYSDK_OFFSET(0x1C55C6F0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE_GET_CURRENTPLANDATA_OFFSET UNITYSDK_OFFSET(0x1C54D470)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE_GET_CURRENTPLANPHASEDATA_OFFSET UNITYSDK_OFFSET(0x1C54D4C0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE_GET_CURRENTWORKDATA_OFFSET UNITYSDK_OFFSET(0x1C55C180)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE_GET_CURRENTWORKPHASEDATA_OFFSET UNITYSDK_OFFSET(0x1C54C810)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE_GET_CURRENTWORKRESULTDATA_OFFSET UNITYSDK_OFFSET(0x1C54C8A0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE_GET_FINISHEDMESSAGEARCHIVEBYMESSAGEID_OFFSET UNITYSDK_OFFSET(0x1C55CD50)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE_GET_FINISHEDWORKARCHIVEBYWORKID_OFFSET UNITYSDK_OFFSET(0x1C55CD70)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE_GET_ISCURRENTPLANFINISHED_OFFSET UNITYSDK_OFFSET(0x1C55CC90)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE_GET_ISCURRENTPLANPHASEFINISHED_OFFSET UNITYSDK_OFFSET(0x1C55CCB0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE_GET_ISCURRENTPLANUNLOCK_OFFSET UNITYSDK_OFFSET(0x1C55A410)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE_GET_LASTFINISHEDPLANID_OFFSET UNITYSDK_OFFSET(0x1C55CCF0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE_GET_PLANDATALIST_OFFSET UNITYSDK_OFFSET(0x1C55CD30)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE_GET_REFRESHFINISHEDPLANPHASEID_OFFSET UNITYSDK_OFFSET(0x1C55CCD0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE_GET_WORKPHASEWAYLIST_OFFSET UNITYSDK_OFFSET(0x1C55CD10)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE_HASANYFINISHEDPLANPHASE_OFFSET UNITYSDK_OFFSET(0x1C55A480)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE_HASFINISHEDMESSAGEARCHIVE_OFFSET UNITYSDK_OFFSET(0x1C55C8D0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE_PLAYPLANPHASEACT_OFFSET UNITYSDK_OFFSET(0x1C54CE00)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE_PLAYWORKRESULTPERFORMANCEANDSHOWRESULTPAGE_OFFSET UNITYSDK_OFFSET(0x1C54CAD0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE_REFRESHFINISHEDMESSAGEARCHIVE_OFFSET UNITYSDK_OFFSET(0x1C552F30)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE_REFRESHFINISHEDWORKARCHIVE_OFFSET UNITYSDK_OFFSET(0x1C553090)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE_REFRESHPLANSTATE_OFFSET UNITYSDK_OFFSET(0x1C552920)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE_REPLAYPLANPHASEPERFORMANCE_OFFSET UNITYSDK_OFFSET(0x1C559090)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE_SET_FINISHEDMESSAGEARCHIVEBYMESSAGEID_OFFSET UNITYSDK_OFFSET(0x1C55CD60)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE_SET_FINISHEDWORKARCHIVEBYWORKID_OFFSET UNITYSDK_OFFSET(0x1C55CD80)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE_SET_ISCURRENTPLANFINISHED_OFFSET UNITYSDK_OFFSET(0x1C55CCA0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE_SET_ISCURRENTPLANPHASEFINISHED_OFFSET UNITYSDK_OFFSET(0x1C55CCC0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE_SET_LASTFINISHEDPLANID_OFFSET UNITYSDK_OFFSET(0x1C55CD00)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE_SET_PLANDATALIST_OFFSET UNITYSDK_OFFSET(0x1C55CD40)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE_SET_REFRESHFINISHEDPLANPHASEID_OFFSET UNITYSDK_OFFSET(0x1C55CCE0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE_SET_WORKPHASEWAYLIST_OFFSET UNITYSDK_OFFSET(0x1C55CD20)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE_TRYTRIGGERPLANPHASEFINISHTASK_OFFSET UNITYSDK_OFFSET(0x1C559860)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE_TRYTRIGGERPLANSTATUSREFRESHTASK_OFFSET UNITYSDK_OFFSET(0x1C559720)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE__CALCULATEMANAGEMENTPLANINFOITEMVIEWMODELSTATE_OFFSET UNITYSDK_OFFSET(0x1C55A280)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE__CHECKISCURRENTPLANUNLOCK_OFFSET UNITYSDK_OFFSET(0x1C55C970)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE__CHECKPLANPHASEFINISHED_OFFSET UNITYSDK_OFFSET(0x1C559A80)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE__CREATEFLOORSAVEDVALUEOVERRIDELIST_OFFSET UNITYSDK_OFFSET(0x1C55AB00)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE__CREATEHISTORYOPTIONFLOWBYMESSAGEID_OFFSET UNITYSDK_OFFSET(0x1C55BB50)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE__CREATEHISTORYWORKPHASEDATALIST_OFFSET UNITYSDK_OFFSET(0x1C55C1D0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE__CREATEOPTIONFLOW_OFFSET UNITYSDK_OFFSET(0x1C55B5D0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE__CREATEREVIEWONGOINGVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1C55AD20)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE__CREATEREVIEWPHASEITEMS_OFFSET UNITYSDK_OFFSET(0x1C55A880)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C54FB70)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE__FINISHCURRENTPLANPHASEANDSHOWRESULTPAGE_OFFSET UNITYSDK_OFFSET(0x1C55BEA0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE__GETCURRENTPLANDATA_OFFSET UNITYSDK_OFFSET(0x1C55C9D0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE__GETCURRENTPLANPHASEDATA_OFFSET UNITYSDK_OFFSET(0x1C55CA40)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE__GETCURRENTWORKDATA_OFFSET UNITYSDK_OFFSET(0x1C55CB00)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE__GETMESSAGEOPTIONFLOW_OFFSET UNITYSDK_OFFSET(0x1C55B4D0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE__GETOPTIONINDEX_OFFSET UNITYSDK_OFFSET(0x1C55C400)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE__GETREFRESHFINISHEDPLANPHASEID_OFFSET UNITYSDK_OFFSET(0x1C55C820)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE__INITPLANDATALIST_OFFSET UNITYSDK_OFFSET(0x1C55C4C0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPLANSERVICE___CHECKPLANPHASEFINISHED_B__6_0_OFFSET UNITYSDK_OFFSET(0x1C55CD90)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsPlanService_TypeDefinitionIndex = 79008;
	...
	public:
		...
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_1_5A55E8BED8FA46A4_5*>* _FinishedWorkArchiveByWorkID_k__BackingField; // 0x20
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_1_45BB92167AED63A0_54*>* _FinishedMessageArchiveByMessageID_k__BackingField; // 0x28
		::Class_1_5F4D64A4B97E38F9* Messenger; // 0x30
		::System::Collections::Generic::List_1<::RPG::Client::LimaoNews::LimaoNewsPlanData*>* _PlanDataList_k__BackingField; // 0x38
		::RPG::Client::LimaoNews::LimaoNewsWindowService* _WindowService; // 0x40
		::RPG::Client::LimaoNews::LimaoNewsOfferingService* _OfferingService; // 0x48
		::System::Collections::Generic::List_1<::System::UInt32>* _WorkPhaseWayList_k__BackingField; // 0x50
		::RPG::Client::LimaoNews::LimaoNewsMessageService* _MessageService; // 0x58
		::System::UInt32 _RefreshFinishedPlanPhaseID_k__BackingField; // 0x60
		::System::UInt32 _CurrentWorkID; // 0x64
		::System::Boolean _IsCurrentPlanPhaseFinished_k__BackingField; // 0x68
		::System::Boolean _IsCurrentPlanFinished_k__BackingField; // 0x69
		::System::UInt32 _CurrentPlanID; // 0x6C
		::RPG::Client::LimaoNews::LimaoNewsManagementPlanInfoItemViewModelState _ManagementPlanInfoItemViewModelState; // 0x70
		::System::UInt32 _CurrentWorkResultID; // 0x74
		::System::UInt32 _LastFinishedPlanID_k__BackingField; // 0x78
		::System::UInt32 _CurrentPlanPhaseID; // 0x7C
		::System::UInt32 _CurrentWorkPhaseID; // 0x80
