...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMANAGEMENTPLANINFOITEMVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0xD46A3A0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMANAGEMENTPLANINFOITEMVIEWMODEL_GET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0xD46A500)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMANAGEMENTPLANINFOITEMVIEWMODEL_GET_ISNEEDPLAYUNLOCKANIMATION_OFFSET UNITYSDK_OFFSET(0xD46A520)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMANAGEMENTPLANINFOITEMVIEWMODEL_GET_NEXTVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD46A540)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMANAGEMENTPLANINFOITEMVIEWMODEL_GET_TEXT_OFFSET UNITYSDK_OFFSET(0xD46A4C0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMANAGEMENTPLANINFOITEMVIEWMODEL_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xD46A4E0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMANAGEMENTPLANINFOITEMVIEWMODEL_SET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0xD46A510)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMANAGEMENTPLANINFOITEMVIEWMODEL_SET_ISNEEDPLAYUNLOCKANIMATION_OFFSET UNITYSDK_OFFSET(0xD46A530)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMANAGEMENTPLANINFOITEMVIEWMODEL_SET_NEXTVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD46A550)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMANAGEMENTPLANINFOITEMVIEWMODEL_SET_TEXT_OFFSET UNITYSDK_OFFSET(0xD46A4D0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMANAGEMENTPLANINFOITEMVIEWMODEL_SET_TYPE_OFFSET UNITYSDK_OFFSET(0xD46A4F0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMANAGEMENTPLANINFOITEMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xD46A4A0)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsManagementPlanInfoItemViewModel_TypeDefinitionIndex = 79102;
	...
	public:
		...
		::System::Boolean _IsNeedPlayUnlockAnimation_k__BackingField; // 0x39
		::RPG::Client::LimaoNews::LimaoNewsManagementPlanInfoItemType _Type_k__BackingField; // 0x3C
