...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMESSAGESEQUENCE_CREATEITEMSVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD46DB00)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMESSAGESEQUENCE_CREATEOPTIONSVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD46DCF0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMESSAGESEQUENCE_GETMESSAGEITEMIDLISTBYMESSAGE_OFFSET UNITYSDK_OFFSET(0xD46D820)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMESSAGESEQUENCE_GETOPTIONMESSAGESEQUENCE_OFFSET UNITYSDK_OFFSET(0xD46D790)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMESSAGESEQUENCE_GET_MESSAGEID_OFFSET UNITYSDK_OFFSET(0xD46DF90)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMESSAGESEQUENCE_GET_MESSAGELIST_OFFSET UNITYSDK_OFFSET(0xD46DF30)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMESSAGESEQUENCE_GET_OPTIONLIST_OFFSET UNITYSDK_OFFSET(0xD46DF50)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMESSAGESEQUENCE_GET_OPTIONMESSAGESEQUENCELIST_OFFSET UNITYSDK_OFFSET(0xD46DF70)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMESSAGESEQUENCE_SETMESSAGEID_OFFSET UNITYSDK_OFFSET(0xD46DEE0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMESSAGESEQUENCE_SET_MESSAGEID_OFFSET UNITYSDK_OFFSET(0xD46DFA0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMESSAGESEQUENCE_SET_MESSAGELIST_OFFSET UNITYSDK_OFFSET(0xD46DF40)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMESSAGESEQUENCE_SET_OPTIONLIST_OFFSET UNITYSDK_OFFSET(0xD46DF60)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMESSAGESEQUENCE_SET_OPTIONMESSAGESEQUENCELIST_OFFSET UNITYSDK_OFFSET(0xD46DF80)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMESSAGESEQUENCE__APPENDMESSAGEITEMIDLIST_OFFSET UNITYSDK_OFFSET(0xD46D8F0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMESSAGESEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0xD46D6F0)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsMessageSequence_TypeDefinitionIndex = 78967;

	class LimaoNewsMessageSequence : public ::System::Object
	{
	public:
		::System::Collections::Generic::List_1<::RPG::Client::LimaoNews::LimaoNewsMessageSequence*>* _OptionMessageSequenceList_k__BackingField; // 0x10
		::System::Collections::Generic::List_1<::Class_1_2023A453A03A22A2*>* _MessageList_k__BackingField; // 0x18
