...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMESSAGESEQUENCE_CREATEITEMSVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBD93C60)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMESSAGESEQUENCE_CREATEOPTIONSVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBD93E50)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMESSAGESEQUENCE_GETOPTIONMESSAGESEQUENCE_OFFSET UNITYSDK_OFFSET(0xBD93BD0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMESSAGESEQUENCE_GET_MESSAGEID_OFFSET UNITYSDK_OFFSET(0xBD940F0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMESSAGESEQUENCE_GET_MESSAGELIST_OFFSET UNITYSDK_OFFSET(0xBD94090)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMESSAGESEQUENCE_GET_OPTIONLIST_OFFSET UNITYSDK_OFFSET(0xBD940B0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMESSAGESEQUENCE_GET_OPTIONMESSAGESEQUENCELIST_OFFSET UNITYSDK_OFFSET(0xBD940D0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMESSAGESEQUENCE_SETMESSAGEID_OFFSET UNITYSDK_OFFSET(0xBD94040)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMESSAGESEQUENCE_SET_MESSAGEID_OFFSET UNITYSDK_OFFSET(0xBD94100)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMESSAGESEQUENCE_SET_MESSAGELIST_OFFSET UNITYSDK_OFFSET(0xBD940A0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMESSAGESEQUENCE_SET_OPTIONLIST_OFFSET UNITYSDK_OFFSET(0xBD940C0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMESSAGESEQUENCE_SET_OPTIONMESSAGESEQUENCELIST_OFFSET UNITYSDK_OFFSET(0xBD940E0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSMESSAGESEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0xBD93B30)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsMessageSequence_TypeDefinitionIndex = 73765;
