...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTLISTVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0xBD77EB0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTLISTVIEWMODEL_GETCANSHOWCOMMENTCOUNT_OFFSET UNITYSDK_OFFSET(0xBD78320)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTLISTVIEWMODEL_GET_ALLCOMMENTVIEWMODELS_OFFSET UNITYSDK_OFFSET(0xBD78A20)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTLISTVIEWMODEL_GET_SHOWCOMMENTVIEWMODELS_OFFSET UNITYSDK_OFFSET(0xBD78A40)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTLISTVIEWMODEL_REFRESHVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBD78030)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTLISTVIEWMODEL_SETCOMMENTFADEIN_OFFSET UNITYSDK_OFFSET(0xBD78940)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTLISTVIEWMODEL_SETCOMMENTTONEXTSTATE_OFFSET UNITYSDK_OFFSET(0xBD780B0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTLISTVIEWMODEL_SET_ALLCOMMENTVIEWMODELS_OFFSET UNITYSDK_OFFSET(0xBD78A30)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTLISTVIEWMODEL_SET_SHOWCOMMENTVIEWMODELS_OFFSET UNITYSDK_OFFSET(0xBD78A50)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTLISTVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xBD77FA0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTLISTVIEWMODEL__FINDCOMMENTVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBD785D0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTLISTVIEWMODEL__REFRESHSHOWCOMMENTVIEWMODELS_OFFSET UNITYSDK_OFFSET(0xBD78130)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsCommentListViewModel_TypeDefinitionIndex = 73858;

	class LimaoNewsCommentListViewModel : public ::Sofa::BaseViewModel
	{
	public:
		::System::Collections::Generic::List_1<::RPG::Client::LimaoNews::LimaoNewsCommentViewModel*>* _AllCommentViewModels_k__BackingField; // 0x20
		::System::Collections::Generic::List_1<::RPG::Client::LimaoNews::LimaoNewsCommentViewModel*>* _ShowCommentViewModels_k__BackingField; // 0x28
		::RPG::Client::LimaoNews::LimaoNewsPostService* _PostService; // 0x30
