...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTLISTVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0xD44AEE0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTLISTVIEWMODEL_GETCANSHOWCOMMENTCOUNT_OFFSET UNITYSDK_OFFSET(0xD44B350)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTLISTVIEWMODEL_GET_ALLCOMMENTVIEWMODELS_OFFSET UNITYSDK_OFFSET(0xD44BC00)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTLISTVIEWMODEL_GET_SHOWCOMMENTVIEWMODELS_OFFSET UNITYSDK_OFFSET(0xD44BC20)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTLISTVIEWMODEL_REFRESHVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD44B040)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTLISTVIEWMODEL_SETCOMMENTFADEIN_OFFSET UNITYSDK_OFFSET(0xD44BB20)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTLISTVIEWMODEL_SETCOMMENTTONEXTSTATE_OFFSET UNITYSDK_OFFSET(0xD44B0C0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTLISTVIEWMODEL_SET_ALLCOMMENTVIEWMODELS_OFFSET UNITYSDK_OFFSET(0xD44BC10)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTLISTVIEWMODEL_SET_SHOWCOMMENTVIEWMODELS_OFFSET UNITYSDK_OFFSET(0xD44BC30)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTLISTVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xD44AFB0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTLISTVIEWMODEL__FINDCOMMENTVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD44B720)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSCOMMENTLISTVIEWMODEL__REFRESHSHOWCOMMENTVIEWMODELS_OFFSET UNITYSDK_OFFSET(0xD44B140)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsCommentListViewModel_TypeDefinitionIndex = 79091;
	...
	public:
		...
		::System::Collections::Generic::List_1<::RPG::Client::LimaoNews::LimaoNewsCommentViewModel*>* _ShowCommentViewModels_k__BackingField; // 0x30
