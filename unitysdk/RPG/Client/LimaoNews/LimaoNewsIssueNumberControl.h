...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUENUMBERCONTROL_GET__ICONPATH_OFFSET UNITYSDK_OFFSET(0x1C540330)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUENUMBERCONTROL_SETNUMBER_OFFSET UNITYSDK_OFFSET(0x1C53CD80)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUENUMBERCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5403C0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUENUMBERCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1C540080)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUENUMBERCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1C53FFD0)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsIssueNumberControl_TypeDefinitionIndex = 79067;
