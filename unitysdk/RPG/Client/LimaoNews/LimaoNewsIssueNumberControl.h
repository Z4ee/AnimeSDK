...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUENUMBERCONTROL_GET__ICONPATH_OFFSET UNITYSDK_OFFSET(0x1A7773B0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUENUMBERCONTROL_SETNUMBER_OFFSET UNITYSDK_OFFSET(0x1A774050)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUENUMBERCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A777460)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUENUMBERCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1A7772E0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUENUMBERCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1A777200)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsIssueNumberControl_TypeDefinitionIndex = 75486;
