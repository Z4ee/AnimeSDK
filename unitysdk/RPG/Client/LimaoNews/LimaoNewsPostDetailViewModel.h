...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILVIEWMODEL_CLEARREDDOT_OFFSET UNITYSDK_OFFSET(0x1C49B8E0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILVIEWMODEL_GET_DEFAULTCOMMENTID_OFFSET UNITYSDK_OFFSET(0x1C49C590)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILVIEWMODEL_GET_GUID_OFFSET UNITYSDK_OFFSET(0x1C49C5B0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILVIEWMODEL_GET_ONBTNCLOSE_OFFSET UNITYSDK_OFFSET(0x1C49C530)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILVIEWMODEL_GET_ONBTNGO_OFFSET UNITYSDK_OFFSET(0x1C49C510)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILVIEWMODEL_GET_ONBTNIMAGE_OFFSET UNITYSDK_OFFSET(0x1C49C550)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILVIEWMODEL_GET_POSTVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1C49C570)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILVIEWMODEL_GET_TEXTBTNGO_OFFSET UNITYSDK_OFFSET(0x1C49BA10)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILVIEWMODEL_SETDEFAULTCOMMENTID_OFFSET UNITYSDK_OFFSET(0x1C49B9C0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILVIEWMODEL_SET_DEFAULTCOMMENTID_OFFSET UNITYSDK_OFFSET(0x1C49C5A0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILVIEWMODEL_SET_GUID_OFFSET UNITYSDK_OFFSET(0x1C49C5C0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILVIEWMODEL_SET_ONBTNCLOSE_OFFSET UNITYSDK_OFFSET(0x1C49C540)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILVIEWMODEL_SET_ONBTNGO_OFFSET UNITYSDK_OFFSET(0x1C49C520)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILVIEWMODEL_SET_ONBTNIMAGE_OFFSET UNITYSDK_OFFSET(0x1C49C560)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILVIEWMODEL_SET_POSTVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1C49C580)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C49B7A0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILVIEWMODEL__GOTO_OFFSET UNITYSDK_OFFSET(0x1C49C090)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILVIEWMODEL___CTOR_B__0_0_OFFSET UNITYSDK_OFFSET(0x1C49C5D0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILVIEWMODEL___CTOR_B__0_1_OFFSET UNITYSDK_OFFSET(0x1C49C650)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSPOSTDETAILVIEWMODEL___CTOR_B__0_2_OFFSET UNITYSDK_OFFSET(0x1C49C660)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsPostDetailViewModel_TypeDefinitionIndex = 79154;
	...
	public:
		...
		::RPG::Client::LimaoNews::LimaoNewsPostViewModel* _PostViewModel_k__BackingField; // 0x30
		::Sofa::Core::SimpleCommand* _OnBtnImage_k__BackingField; // 0x38
		::RPG::Client::LimaoNews::LimaoNewsTutorialService* _LimaoNewsTutorialService; // 0x40
