...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERVIEWTABVIEWMODEL_GET_ISSELECTED_OFFSET UNITYSDK_OFFSET(0xD45A570)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERVIEWTABVIEWMODEL_GET_ONBTNTABCLICK_OFFSET UNITYSDK_OFFSET(0xD45A6A0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERVIEWTABVIEWMODEL_GET_TABINDEX_OFFSET UNITYSDK_OFFSET(0xD45A690)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERVIEWTABVIEWMODEL_GET_TITLETEXTID_OFFSET UNITYSDK_OFFSET(0xD45A680)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERVIEWTABVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xD456DB0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSINTERVIEWTABVIEWMODEL___CTOR_B__0_0_OFFSET UNITYSDK_OFFSET(0xD45A6B0)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsInterviewTabViewModel_TypeDefinitionIndex = 79135;
