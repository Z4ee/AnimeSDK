...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUEHINTPOPUPVIEWMODEL_GET_ISSUEDATA_OFFSET UNITYSDK_OFFSET(0x1A775750)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUEHINTPOPUPVIEWMODEL_GET_ISSUEID_OFFSET UNITYSDK_OFFSET(0x1A7756F0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUEHINTPOPUPVIEWMODEL_GET_ONBTNCLOSE_OFFSET UNITYSDK_OFFSET(0x1A775710)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUEHINTPOPUPVIEWMODEL_GET_ONBTNFORM_OFFSET UNITYSDK_OFFSET(0x1A775730)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUEHINTPOPUPVIEWMODEL_SET_ISSUEDATA_OFFSET UNITYSDK_OFFSET(0x1A775760)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUEHINTPOPUPVIEWMODEL_SET_ISSUEID_OFFSET UNITYSDK_OFFSET(0x1A775700)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUEHINTPOPUPVIEWMODEL_SET_ONBTNCLOSE_OFFSET UNITYSDK_OFFSET(0x1A775720)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUEHINTPOPUPVIEWMODEL_SET_ONBTNFORM_OFFSET UNITYSDK_OFFSET(0x1A775740)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUEHINTPOPUPVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A775560)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUEHINTPOPUPVIEWMODEL___CTOR_B__0_0_OFFSET UNITYSDK_OFFSET(0x1A775770)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUEHINTPOPUPVIEWMODEL___CTOR_B__0_1_OFFSET UNITYSDK_OFFSET(0x1A7757C0)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsIssueHintPopupViewModel_TypeDefinitionIndex = 75521;

	class LimaoNewsIssueHintPopupViewModel : public ::Sofa::BaseViewModel
	{
	public:
		::Class_1_5F4D64A4B97E38F9* _Messenger; // 0x20
		::Sofa::Core::SimpleCommand* _OnBtnForm_k__BackingField; // 0x28
