...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUEHINTPOPUPVIEWMODEL_GET_ISSUEDATA_OFFSET UNITYSDK_OFFSET(0xD45E030)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUEHINTPOPUPVIEWMODEL_GET_ISSUEID_OFFSET UNITYSDK_OFFSET(0xD45DFD0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUEHINTPOPUPVIEWMODEL_GET_ONBTNCLOSE_OFFSET UNITYSDK_OFFSET(0xD45DFF0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUEHINTPOPUPVIEWMODEL_GET_ONBTNFORM_OFFSET UNITYSDK_OFFSET(0xD45E010)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUEHINTPOPUPVIEWMODEL_SET_ISSUEDATA_OFFSET UNITYSDK_OFFSET(0xD45E040)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUEHINTPOPUPVIEWMODEL_SET_ISSUEID_OFFSET UNITYSDK_OFFSET(0xD45DFE0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUEHINTPOPUPVIEWMODEL_SET_ONBTNCLOSE_OFFSET UNITYSDK_OFFSET(0xD45E000)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUEHINTPOPUPVIEWMODEL_SET_ONBTNFORM_OFFSET UNITYSDK_OFFSET(0xD45E020)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUEHINTPOPUPVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xD45DE40)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUEHINTPOPUPVIEWMODEL___CTOR_B__0_0_OFFSET UNITYSDK_OFFSET(0xD45E050)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSISSUEHINTPOPUPVIEWMODEL___CTOR_B__0_1_OFFSET UNITYSDK_OFFSET(0xD45E0A0)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsIssueHintPopupViewModel_TypeDefinitionIndex = 79131;
	...
	public:
		...
		::Sofa::Core::SimpleCommand* _OnBtnForm_k__BackingField; // 0x38
