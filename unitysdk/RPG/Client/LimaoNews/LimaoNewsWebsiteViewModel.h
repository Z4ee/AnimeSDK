...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_GET_CANSHOWISSUETAB_OFFSET UNITYSDK_OFFSET(0xD495530)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_GET_DEFAULTPARAM_OFFSET UNITYSDK_OFFSET(0xD495640)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_GET_FORUMVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD495680)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_GET_GUID_OFFSET UNITYSDK_OFFSET(0xD4957D0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_GET_ISSUEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD495660)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_GET_ONBTNCLOSE_OFFSET UNITYSDK_OFFSET(0xD4955E0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_GET_ONBTNFORM_OFFSET UNITYSDK_OFFSET(0xD495620)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_GET_ONBTNISSUE_OFFSET UNITYSDK_OFFSET(0xD495600)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_GET_PREFABSTATE_OFFSET UNITYSDK_OFFSET(0xD4955A0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_GET_REPORTSTATE_OFFSET UNITYSDK_OFFSET(0xD4956C0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_GET_SPONSORVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD4956A0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_SET_DEFAULTPARAM_OFFSET UNITYSDK_OFFSET(0xD495650)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_SET_FORUMVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD495690)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_SET_GUID_OFFSET UNITYSDK_OFFSET(0xD4957E0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_SET_ISSUEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD495670)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_SET_ONBTNCLOSE_OFFSET UNITYSDK_OFFSET(0xD4955F0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_SET_ONBTNFORM_OFFSET UNITYSDK_OFFSET(0xD495630)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_SET_ONBTNISSUE_OFFSET UNITYSDK_OFFSET(0xD495610)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_SET_PREFABSTATE_OFFSET UNITYSDK_OFFSET(0xD4954C0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_SET_SPONSORVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD4956B0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xD4950B0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL___CTOR_B__0_0_OFFSET UNITYSDK_OFFSET(0xD4957F0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL___CTOR_B__0_1_OFFSET UNITYSDK_OFFSET(0xD4958F0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL___CTOR_B__0_2_OFFSET UNITYSDK_OFFSET(0xD4959F0)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsWebsiteViewModel_TypeDefinitionIndex = 79152;
	...
	public:
		...
		::RPG::Client::LimaoNews::LimaoNewsIssueViewModel* _IssueViewModel_k__BackingField; // 0x20
		...
		::RPG::Client::LimaoNews::LimaoNewsForumViewModel* _ForumViewModel_k__BackingField; // 0x40
		::RPG::Client::LimaoNews::LimaoNewsWebsiteViewModelParam* _DefaultParam_k__BackingField; // 0x48
		::System::String* _CurrentPrefabState; // 0x50
		...
		::RPG::Client::LimaoNews::LimaoNewsIssueService* _IssueService; // 0x70
		::Sofa::Core::SimpleCommand* _OnBtnIssue_k__BackingField; // 0x78
		::Sofa::Core::SimpleCommand* _OnBtnForm_k__BackingField; // 0x80
