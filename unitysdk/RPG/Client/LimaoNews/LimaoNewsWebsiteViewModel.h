...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_GET_CANSHOWISSUETAB_OFFSET UNITYSDK_OFFSET(0x1C4B2A40)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_GET_DEFAULTPARAM_OFFSET UNITYSDK_OFFSET(0x1C4B2B50)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_GET_FORUMVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1C4B2B90)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_GET_GUID_OFFSET UNITYSDK_OFFSET(0x1C4B2CE0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_GET_ISSUEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1C4B2B70)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_GET_ONBTNCLOSE_OFFSET UNITYSDK_OFFSET(0x1C4B2AF0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_GET_ONBTNFORM_OFFSET UNITYSDK_OFFSET(0x1C4B2B30)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_GET_ONBTNISSUE_OFFSET UNITYSDK_OFFSET(0x1C4B2B10)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_GET_PREFABSTATE_OFFSET UNITYSDK_OFFSET(0x1C4B2AB0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_GET_REPORTSTATE_OFFSET UNITYSDK_OFFSET(0x1C4B2BD0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_GET_SPONSORVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1C4B2BB0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_SET_DEFAULTPARAM_OFFSET UNITYSDK_OFFSET(0x1C4B2B60)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_SET_FORUMVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1C4B2BA0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_SET_GUID_OFFSET UNITYSDK_OFFSET(0x1C4B2CF0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_SET_ISSUEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1C4B2B80)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_SET_ONBTNCLOSE_OFFSET UNITYSDK_OFFSET(0x1C4B2B00)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_SET_ONBTNFORM_OFFSET UNITYSDK_OFFSET(0x1C4B2B40)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_SET_ONBTNISSUE_OFFSET UNITYSDK_OFFSET(0x1C4B2B20)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_SET_PREFABSTATE_OFFSET UNITYSDK_OFFSET(0x1C4B29D0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL_SET_SPONSORVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1C4B2BC0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4B25C0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL___CTOR_B__0_0_OFFSET UNITYSDK_OFFSET(0x1C4B2D00)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL___CTOR_B__0_1_OFFSET UNITYSDK_OFFSET(0x1C4B2E00)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWEBSITEVIEWMODEL___CTOR_B__0_2_OFFSET UNITYSDK_OFFSET(0x1C4B2F00)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsWebsiteViewModel_TypeDefinitionIndex = 79151;
	...
	public:
		...
		::RPG::Client::LimaoNews::LimaoNewsIssueViewModel* _IssueViewModel_k__BackingField; // 0x28
		::Sofa::Core::SimpleCommand* _OnBtnIssue_k__BackingField; // 0x30
		::RPG::Client::LimaoNews::LimaoNewsForumViewModel* _ForumViewModel_k__BackingField; // 0x38
		::RPG::Client::LimaoNews::LimaoNewsPostService* _PostService; // 0x40
		::RPG::Client::LimaoNews::LimaoNewsSponsorViewModel* _SponsorViewModel_k__BackingField; // 0x48
		::Sofa::Core::SimpleCommand* _OnBtnForm_k__BackingField; // 0x50
		::RPG::Client::LimaoNews::LimaoNewsNetworkService* _NetworkService; // 0x58
		::System::String* _CurrentPrefabState; // 0x60
		::Sofa::Core::SimpleCommand* _OnBtnClose_k__BackingField; // 0x68
		::RPG::Client::LimaoNews::LimaoNewsWebsiteViewModelParam* _DefaultParam_k__BackingField; // 0x70
		::RPG::Client::LimaoNews::LimaoNewsWindowService* _WindowService; // 0x78
