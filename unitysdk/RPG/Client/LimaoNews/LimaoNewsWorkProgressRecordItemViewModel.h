...
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKPROGRESSRECORDITEMVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0x1C4BC3C0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKPROGRESSRECORDITEMVIEWMODEL_GETISCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1C4BC540)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKPROGRESSRECORDITEMVIEWMODEL_GET_CLICKCOMMAND_OFFSET UNITYSDK_OFFSET(0x1C4BC690)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKPROGRESSRECORDITEMVIEWMODEL_GET_RECORDID_OFFSET UNITYSDK_OFFSET(0x1C4BC630)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKPROGRESSRECORDITEMVIEWMODEL_GET_RECORDPARAM_OFFSET UNITYSDK_OFFSET(0x1C4BC670)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKPROGRESSRECORDITEMVIEWMODEL_GET_RECORDTITLE_OFFSET UNITYSDK_OFFSET(0x1C4BC6B0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKPROGRESSRECORDITEMVIEWMODEL_GET_RECORDTYPE_OFFSET UNITYSDK_OFFSET(0x1C4BC650)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKPROGRESSRECORDITEMVIEWMODEL_SET_CLICKCOMMAND_OFFSET UNITYSDK_OFFSET(0x1C4BC6A0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKPROGRESSRECORDITEMVIEWMODEL_SET_RECORDID_OFFSET UNITYSDK_OFFSET(0x1C4BC640)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKPROGRESSRECORDITEMVIEWMODEL_SET_RECORDPARAM_OFFSET UNITYSDK_OFFSET(0x1C4BC680)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKPROGRESSRECORDITEMVIEWMODEL_SET_RECORDTITLE_OFFSET UNITYSDK_OFFSET(0x1C4BC6C0)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKPROGRESSRECORDITEMVIEWMODEL_SET_RECORDTYPE_OFFSET UNITYSDK_OFFSET(0x1C4BC660)
#define RPG_CLIENT_LIMAONEWS_LIMAONEWSWORKPROGRESSRECORDITEMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4BC530)

namespace RPG::Client::LimaoNews
{
	inline static constexpr unsigned int LimaoNewsWorkProgressRecordItemViewModel_TypeDefinitionIndex = 79124;
	...
	public:
		...
		::System::UInt32 _RecordParam_k__BackingField; // 0x20
		::RPG::Client::TextID _RecordTitle_k__BackingField; // 0x28
		::RPG::GameCore::LimaoNewsWorkRecordType _RecordType_k__BackingField; // 0x38
		::System::UInt32 _RecordID_k__BackingField; // 0x3C
