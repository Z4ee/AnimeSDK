...
#define RPG_CLIENT_ST_PARKOUR_BYCOMPAREDISTANCETOPLAYER_METHOD_4_08408ECF1AD95AD2_OFFSET UNITYSDK_OFFSET(0x1B9EECB0)
#define RPG_CLIENT_ST_PARKOUR_BYCOMPAREDISTANCETOPLAYER_METHOD_4_1F4FC3EDACBE6F9B_OFFSET UNITYSDK_OFFSET(0x1B9EEEB0)
#define RPG_CLIENT_ST_PARKOUR_BYCOMPAREDISTANCETOPLAYER_METHOD_4_976949D69EC6BD93_OFFSET UNITYSDK_OFFSET(0x1B9EEC70)
#define RPG_CLIENT_ST_PARKOUR_BYCOMPAREDISTANCETOPLAYER_METHOD_4_B7F6535C9744E774_OFFSET UNITYSDK_OFFSET(0x1B9EEE80)
#define RPG_CLIENT_ST_PARKOUR_BYCOMPAREDISTANCETOPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9EECA0)

namespace RPG::Client
{
	inline static constexpr unsigned int ST_Parkour_ByCompareDistanceToPlayer_TypeDefinitionIndex = 9949;
