...
#define RPG_CLIENT_PETMODULE___C__DISPLAYCLASS14_0__CTOR_OFFSET UNITYSDK_OFFSET(0xAC5D100)
#define RPG_CLIENT_PETMODULE___C__DISPLAYCLASS14_0___ONCMDSUMMONPETSCRSP_B__0_OFFSET UNITYSDK_OFFSET(0xAC5DD50)

namespace RPG::Client
{
	inline static constexpr unsigned int PetModule___c__DisplayClass14_0_TypeDefinitionIndex = 61214;

	class PetModule___c__DisplayClass14_0 : public ::System::Object
	{
	public:
		::RPG::Client::PetModule* __4__this; // 0x10
		::Class_1_D1E0AD3915BCCF29_83* rsp; // 0x18
