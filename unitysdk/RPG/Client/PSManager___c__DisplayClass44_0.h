...
#define RPG_CLIENT_PSMANAGER___C__DISPLAYCLASS44_0__CREATESESSION_B__0_OFFSET UNITYSDK_OFFSET(0x1C4D11E0)
#define RPG_CLIENT_PSMANAGER___C__DISPLAYCLASS44_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4D07B0)

namespace RPG::Client
{
	inline static constexpr unsigned int PSManager___c__DisplayClass44_0_TypeDefinitionIndex = 66740;
