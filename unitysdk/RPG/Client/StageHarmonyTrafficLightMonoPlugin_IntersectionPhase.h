...
#define RPG_CLIENT_STAGEHARMONYTRAFFICLIGHTMONOPLUGIN_INTERSECTIONPHASE_METHOD_1_4E6F72124EC1C84B_OFFSET UNITYSDK_OFFSET(0x17B52480)
#define RPG_CLIENT_STAGEHARMONYTRAFFICLIGHTMONOPLUGIN_INTERSECTIONPHASE__CTOR_OFFSET UNITYSDK_OFFSET(0x17B532E0)

namespace RPG::Client
{
	inline static constexpr unsigned int StageHarmonyTrafficLightMonoPlugin_IntersectionPhase_TypeDefinitionIndex = 67801;
