...
#define RPG_CLIENT_EFF_VOXELUNIDIROCCLUSIONMONOPLUGIN_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x1772E020)
#define RPG_CLIENT_EFF_VOXELUNIDIROCCLUSIONMONOPLUGIN_METHOD_7_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1772E010)
#define RPG_CLIENT_EFF_VOXELUNIDIROCCLUSIONMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1772E070)

namespace RPG::Client
{
	inline static constexpr unsigned int Eff_VoxelUnidirOcclusionMonoPlugin_TypeDefinitionIndex = 67249;
