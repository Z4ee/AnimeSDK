...
#define RPG_CLIENT_EFF_VOXELUNIDIROCCLUSIONMONOPLUGIN_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xB838240)
#define RPG_CLIENT_EFF_VOXELUNIDIROCCLUSIONMONOPLUGIN_METHOD_7_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xB838230)
#define RPG_CLIENT_EFF_VOXELUNIDIROCCLUSIONMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xB838290)
#define RPG_CLIENT_EFF_VOXELUNIDIROCCLUSIONMONOPLUGIN___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xB838300)

namespace RPG::Client
{
	inline static constexpr unsigned int Eff_VoxelUnidirOcclusionMonoPlugin_TypeDefinitionIndex = 65832;
	...
	public:
		...
		{
			return ((::System::String*(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_EFF_VOXELUNIDIROCCLUSIONMONOPLUGIN___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET))(this);
		}
	};
}
