...
#define RPG_CLIENT_CAPTIONCOMPONENT_BIND_OFFSET UNITYSDK_OFFSET(0xB4BDDE0)
#define RPG_CLIENT_CAPTIONCOMPONENT_GET_CURRENTSTATE_OFFSET UNITYSDK_OFFSET(0xB4BD910)
#define RPG_CLIENT_CAPTIONCOMPONENT_GET__MOVIECONTROLLERFORUI_OFFSET UNITYSDK_OFFSET(0xB4BDB00)
#define RPG_CLIENT_CAPTIONCOMPONENT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB4BDCF0)
#define RPG_CLIENT_CAPTIONCOMPONENT_REFRESHCAPTION_OFFSET UNITYSDK_OFFSET(0xB4BDE50)
#define RPG_CLIENT_CAPTIONCOMPONENT_SETCAPTIONCONFIG_OFFSET UNITYSDK_OFFSET(0xB4BDD90)
#define RPG_CLIENT_CAPTIONCOMPONENT_SETCAPTIONPARAM_OFFSET UNITYSDK_OFFSET(0xB4BDD40)
#define RPG_CLIENT_CAPTIONCOMPONENT_TICKCAPTION_OFFSET UNITYSDK_OFFSET(0xB4BD190)
#define RPG_CLIENT_CAPTIONCOMPONENT_UPDATE_OFFSET UNITYSDK_OFFSET(0xB4BD140)
#define RPG_CLIENT_CAPTIONCOMPONENT__CLOSECAPTION_OFFSET UNITYSDK_OFFSET(0xB4BDC30)
#define RPG_CLIENT_CAPTIONCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0xB4BDEC0)
#define RPG_CLIENT_CAPTIONCOMPONENT__SETCAPTIONALPHA_OFFSET UNITYSDK_OFFSET(0xB4BDC80)
#define RPG_CLIENT_CAPTIONCOMPONENT__SHOWCAPTION_OFFSET UNITYSDK_OFFSET(0xB4BDB80)

namespace RPG::Client
{
	inline static constexpr unsigned int CaptionComponent_TypeDefinitionIndex = 67755;
