...
#define RPG_CLIENT_TEXTUREREPLACEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xA59BD40)

namespace RPG::Client
{
	inline static constexpr unsigned int TextureReplaceItem_TypeDefinitionIndex = 57938;
