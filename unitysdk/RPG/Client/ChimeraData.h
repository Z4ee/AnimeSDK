...
#define RPG_CLIENT_CHIMERADATA_CLEARINBATTLEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x9FF9600)
#define RPG_CLIENT_CHIMERADATA_GET_ABILITYDISPLAYPARAMS_OFFSET UNITYSDK_OFFSET(0x9FFA1C0)
#define RPG_CLIENT_CHIMERADATA_GET_ABILITYDISPLAY_OFFSET UNITYSDK_OFFSET(0x9FFA110)
#define RPG_CLIENT_CHIMERADATA_GET_ABILITY_OFFSET UNITYSDK_OFFSET(0x9FFA010)
#define RPG_CLIENT_CHIMERADATA_GET_CHIMERAID_OFFSET UNITYSDK_OFFSET(0x9FF9650)
#define RPG_CLIENT_CHIMERADATA_GET_CURRENTATK_OFFSET UNITYSDK_OFFSET(0x9FF9EE0)
#define RPG_CLIENT_CHIMERADATA_GET_CURRENTHP_OFFSET UNITYSDK_OFFSET(0x9FF9E20)
#define RPG_CLIENT_CHIMERADATA_GET_DATAJSON_OFFSET UNITYSDK_OFFSET(0x9FF9A10)
#define RPG_CLIENT_CHIMERADATA_GET_DEFAULTATK_OFFSET UNITYSDK_OFFSET(0x9FF9DA0)
#define RPG_CLIENT_CHIMERADATA_GET_DEFAULTHP_OFFSET UNITYSDK_OFFSET(0x9FF9B60)
#define RPG_CLIENT_CHIMERADATA_GET_DISPLAYID_OFFSET UNITYSDK_OFFSET(0x9FF9A80)
#define RPG_CLIENT_CHIMERADATA_GET_DISPLAY_OFFSET UNITYSDK_OFFSET(0x9FFA100)
#define RPG_CLIENT_CHIMERADATA_GET_EYEPARAM_OFFSET UNITYSDK_OFFSET(0x9FF9900)
#define RPG_CLIENT_CHIMERADATA_GET_HANDLERS_OFFSET UNITYSDK_OFFSET(0x9FFA070)
#define RPG_CLIENT_CHIMERADATA_GET_ICON_OFFSET UNITYSDK_OFFSET(0x9FF96D0)
#define RPG_CLIENT_CHIMERADATA_GET_ISDEAD_OFFSET UNITYSDK_OFFSET(0x9FF9FB0)
#define RPG_CLIENT_CHIMERADATA_GET_ISLEADER_OFFSET UNITYSDK_OFFSET(0x9FF9660)
#define RPG_CLIENT_CHIMERADATA_GET_LEAVEJSON_OFFSET UNITYSDK_OFFSET(0x9FFA0E0)
#define RPG_CLIENT_CHIMERADATA_GET_MEMBERTYPE_OFFSET UNITYSDK_OFFSET(0x9FF6C50)
#define RPG_CLIENT_CHIMERADATA_GET_MODELBODY_OFFSET UNITYSDK_OFFSET(0x9FF9740)
#define RPG_CLIENT_CHIMERADATA_GET_MODELHORN_OFFSET UNITYSDK_OFFSET(0x9FF97B0)
#define RPG_CLIENT_CHIMERADATA_GET_MODELTAIL_OFFSET UNITYSDK_OFFSET(0x9FF9890)
#define RPG_CLIENT_CHIMERADATA_GET_MODELWING_OFFSET UNITYSDK_OFFSET(0x9FF9820)
#define RPG_CLIENT_CHIMERADATA_GET_RARITY_OFFSET UNITYSDK_OFFSET(0x9FF9AF0)
#define RPG_CLIENT_CHIMERADATA_GET_SORT_OFFSET UNITYSDK_OFFSET(0x9FF99A0)
#define RPG_CLIENT_CHIMERADATA_GET_TALKCONFIG_OFFSET UNITYSDK_OFFSET(0x9FFA730)
#define RPG_CLIENT_CHIMERADATA_GET_WWISEAUDIOGROUPNAME_OFFSET UNITYSDK_OFFSET(0x9FFA790)
#define RPG_CLIENT_CHIMERADATA_GET_WWISEAUDIOSWITCHNAME_OFFSET UNITYSDK_OFFSET(0x9FFA7B0)
#define RPG_CLIENT_CHIMERADATA_GET__JSONCONFIG_OFFSET UNITYSDK_OFFSET(0x9FF9BE0)
#define RPG_CLIENT_CHIMERADATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0x9FF9410)
#define RPG_CLIENT_CHIMERADATA_SET_WWISEAUDIOGROUPNAME_OFFSET UNITYSDK_OFFSET(0x9FFA7A0)
#define RPG_CLIENT_CHIMERADATA_SYNCINBATTLEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x9FF9540)
#define RPG_CLIENT_CHIMERADATA_UPDATEINBATTLEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x9FF9480)
#define RPG_CLIENT_CHIMERADATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9FF9380)

namespace RPG::Client
{
	inline static constexpr unsigned int ChimeraData_TypeDefinitionIndex = 58417;
	...
	public:
		...
		::RPG::Client::ChimeraAbilityDisplayData* _AbilityDisplayDataCache; // 0x28
		::RPG::Client::ChimeraDisplayData* _Display_k__BackingField; // 0x30
		...
		::System::Void SyncInBattleAttribute(::Class_1_DB57B006CFFCF00A_1* chimera)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_DB57B006CFFCF00A_1*))((::PBYTE)hIl2Cpp + RPG_CLIENT_CHIMERADATA_SYNCINBATTLEATTRIBUTE_OFFSET))(this, chimera);
		}
