...
#define RPG_CLIENT_CLIENTSTARTUPPHASE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xCC28100)
#define RPG_CLIENT_CLIENTSTARTUPPHASE_ENTER_OFFSET UNITYSDK_OFFSET(0xCC28380)
#define RPG_CLIENT_CLIENTSTARTUPPHASE_GETGAMEPHASETYPE_OFFSET UNITYSDK_OFFSET(0xCC28860)
#define RPG_CLIENT_CLIENTSTARTUPPHASE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xCC28320)
#define RPG_CLIENT_CLIENTSTARTUPPHASE_LEAVE_OFFSET UNITYSDK_OFFSET(0xCC28240)
#define RPG_CLIENT_CLIENTSTARTUPPHASE_TICK_OFFSET UNITYSDK_OFFSET(0xCC282C0)
#define RPG_CLIENT_CLIENTSTARTUPPHASE__CHECKGLOBALDISPATCHSTATE_OFFSET UNITYSDK_OFFSET(0xCC294F0)
#define RPG_CLIENT_CLIENTSTARTUPPHASE__CTOR_OFFSET UNITYSDK_OFFSET(0xCC28050)
#define RPG_CLIENT_CLIENTSTARTUPPHASE__FETCHGLOBALDISPATCHINFO_OFFSET UNITYSDK_OFFSET(0xCC29900)
#define RPG_CLIENT_CLIENTSTARTUPPHASE__GETSERVERPINGS_OFFSET UNITYSDK_OFFSET(0xCC29CB0)
#define RPG_CLIENT_CLIENTSTARTUPPHASE__GLOBALFINISHED_OFFSET UNITYSDK_OFFSET(0xCC29DB0)
#define RPG_CLIENT_CLIENTSTARTUPPHASE__HANDLESPLASHEXCEPTIONS_OFFSET UNITYSDK_OFFSET(0xCC29AB0)
#define RPG_CLIENT_CLIENTSTARTUPPHASE__ONEXCEPTION_OFFSET UNITYSDK_OFFSET(0xCC28BF0)
#define RPG_CLIENT_CLIENTSTARTUPPHASE__ONGAMELOGOSHOW_OFFSET UNITYSDK_OFFSET(0xCC292E0)
#define RPG_CLIENT_CLIENTSTARTUPPHASE__ONGAMESPLASHEND_OFFSET UNITYSDK_OFFSET(0xCC288B0)
#define RPG_CLIENT_CLIENTSTARTUPPHASE__SHOWDEBUGINFO_OFFSET UNITYSDK_OFFSET(0xCC291C0)
#define RPG_CLIENT_CLIENTSTARTUPPHASE__SHOWGAMESTARTUPMAINPAGE_OFFSET UNITYSDK_OFFSET(0xCC28B50)
#define RPG_CLIENT_CLIENTSTARTUPPHASE__SHOWSTARTUPSPLASHPAGE_OFFSET UNITYSDK_OFFSET(0xCC287C0)
#define RPG_CLIENT_CLIENTSTARTUPPHASE___FETCHGLOBALDISPATCHINFO_B__15_0_OFFSET UNITYSDK_OFFSET(0xCC29F80)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(ClientStartupPhase_TypeDefinitionIndex)->GetStaticField(0x15070);
		}
