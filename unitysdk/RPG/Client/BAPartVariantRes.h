...
#define RPG_CLIENT_BAPARTVARIANTRES_METHOD_1_1041E4ED3107B921_OFFSET UNITYSDK_OFFSET(0x19F009A0)
#define RPG_CLIENT_BAPARTVARIANTRES_METHOD_1_18D9238B9C310BFF_OFFSET UNITYSDK_OFFSET(0x19F00A30)
#define RPG_CLIENT_BAPARTVARIANTRES_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x19EFFFD0)
#define RPG_CLIENT_BAPARTVARIANTRES_METHOD_1_3C8D3D5994F57353_OFFSET UNITYSDK_OFFSET(0x19EFFF10)
#define RPG_CLIENT_BAPARTVARIANTRES_METHOD_1_426F10C86F2F4793_OFFSET UNITYSDK_OFFSET(0x19F00070)
#define RPG_CLIENT_BAPARTVARIANTRES_METHOD_1_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0x19F01090)
#define RPG_CLIENT_BAPARTVARIANTRES_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x19F01020)
#define RPG_CLIENT_BAPARTVARIANTRES_METHOD_1_9E0AE5CCF5240C75_OFFSET UNITYSDK_OFFSET(0x19F00920)
#define RPG_CLIENT_BAPARTVARIANTRES_METHOD_1_ADF4AD3331B4D7AD_OFFSET UNITYSDK_OFFSET(0x19F00020)
#define RPG_CLIENT_BAPARTVARIANTRES_METHOD_1_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x19F00B80)
#define RPG_CLIENT_BAPARTVARIANTRES_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x19EFFF80)
#define RPG_CLIENT_BAPARTVARIANTRES_METHOD_1_CC3053D4FB0528C3_OFFSET UNITYSDK_OFFSET(0x19F00C10)
#define RPG_CLIENT_BAPARTVARIANTRES_RESET_OFFSET UNITYSDK_OFFSET(0x19EFFE10)
#define RPG_CLIENT_BAPARTVARIANTRES__CCTOR_OFFSET UNITYSDK_OFFSET(0x19F01160)
#define RPG_CLIENT_BAPARTVARIANTRES__CTOR_OFFSET UNITYSDK_OFFSET(0x19F01100)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(BAPartVariantRes_TypeDefinitionIndex)->GetStaticField(0xAE0);
		}
		static ::System::Int32* StaticGet__DitherAlpha()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(BAPartVariantRes_TypeDefinitionIndex)->GetStaticField(0xAE4);
		}
		static ::System::Int32* StaticGet__UsingDitherAlpha()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(BAPartVariantRes_TypeDefinitionIndex)->GetStaticField(0xAE8);
		}
