...
#define RPG_CLIENT_BILLBOARDCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x91F2540)

namespace RPG::Client
{
	inline static constexpr unsigned int BillboardController_TypeDefinitionIndex = 57981;
