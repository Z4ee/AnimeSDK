...
#define RPG_CLIENT_FANCYLINDERCOLLIDER_AWAKE_OFFSET UNITYSDK_OFFSET(0x965A860)
#define RPG_CLIENT_FANCYLINDERCOLLIDER_METHOD_6_B8D84B51D5BA2413_OFFSET UNITYSDK_OFFSET(0x965AA40)
#define RPG_CLIENT_FANCYLINDERCOLLIDER_RECREATE_OFFSET UNITYSDK_OFFSET(0x965A8C0)
#define RPG_CLIENT_FANCYLINDERCOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x965BFF0)

namespace RPG::Client
{
	inline static constexpr unsigned int FanCylinderCollider_TypeDefinitionIndex = 56294;
