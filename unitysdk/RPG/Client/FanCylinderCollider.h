...
#define RPG_CLIENT_FANCYLINDERCOLLIDER_AWAKE_OFFSET UNITYSDK_OFFSET(0xA3199D0)
#define RPG_CLIENT_FANCYLINDERCOLLIDER_METHOD_6_B8D84B51D5BA2413_OFFSET UNITYSDK_OFFSET(0xA319BB0)
#define RPG_CLIENT_FANCYLINDERCOLLIDER_RECREATE_OFFSET UNITYSDK_OFFSET(0xA319A30)
#define RPG_CLIENT_FANCYLINDERCOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0xA31B160)

namespace RPG::Client
{
	inline static constexpr unsigned int FanCylinderCollider_TypeDefinitionIndex = 63537;
