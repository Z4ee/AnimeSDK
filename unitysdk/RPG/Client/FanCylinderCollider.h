...
#define RPG_CLIENT_FANCYLINDERCOLLIDER_AWAKE_OFFSET UNITYSDK_OFFSET(0xCF14270)
#define RPG_CLIENT_FANCYLINDERCOLLIDER_METHOD_6_B8D84B51D5BA2413_OFFSET UNITYSDK_OFFSET(0xCF14450)
#define RPG_CLIENT_FANCYLINDERCOLLIDER_RECREATE_OFFSET UNITYSDK_OFFSET(0xCF142D0)
#define RPG_CLIENT_FANCYLINDERCOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0xCF15660)
