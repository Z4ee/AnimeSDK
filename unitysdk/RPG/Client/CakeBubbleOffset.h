...
#define RPG_CLIENT_CAKEBUBBLEOFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x3B198B0)

namespace RPG::Client
{
	inline static constexpr unsigned int CakeBubbleOffset_TypeDefinitionIndex = 63029;
