...
#define RPG_CLIENT_CHECKITEMFINISHMAINMISSION_FILLNOTIFYTYPESTO_OFFSET UNITYSDK_OFFSET(0x9F885B0)
#define RPG_CLIENT_CHECKITEMFINISHMAINMISSION_GETCHECKITEMINFO_OFFSET UNITYSDK_OFFSET(0x9F889A0)
#define RPG_CLIENT_CHECKITEMFINISHMAINMISSION_GETTARGETMAINMISSIONID_OFFSET UNITYSDK_OFFSET(0x9F88960)
#define RPG_CLIENT_CHECKITEMFINISHMAINMISSION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9F888B0)
#define RPG_CLIENT_CHECKITEMFINISHMAINMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x9F88590)
#define RPG_CLIENT_CHECKITEMFINISHMAINMISSION__DOCHECKIMPL_OFFSET UNITYSDK_OFFSET(0x9F88640)
#define RPG_CLIENT_CHECKITEMFINISHMAINMISSION__ISDATAREADYIMPL_OFFSET UNITYSDK_OFFSET(0x9F88730)
#define RPG_CLIENT_CHECKITEMFINISHMAINMISSION__PREPAREDATAIMPL_OFFSET UNITYSDK_OFFSET(0x9F88810)
#define RPG_CLIENT_CHECKITEMFINISHMAINMISSION___IFIXBASEPROXY_FILLNOTIFYTYPESTO_OFFSET UNITYSDK_OFFSET(0x9F88B20)
#define RPG_CLIENT_CHECKITEMFINISHMAINMISSION___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9F88D10)
#define RPG_CLIENT_CHECKITEMFINISHMAINMISSION___IFIXBASEPROXY__DOCHECKIMPL_OFFSET UNITYSDK_OFFSET(0x9F88B90)
#define RPG_CLIENT_CHECKITEMFINISHMAINMISSION___IFIXBASEPROXY__ISDATAREADYIMPL_OFFSET UNITYSDK_OFFSET(0x9F88C00)
#define RPG_CLIENT_CHECKITEMFINISHMAINMISSION___IFIXBASEPROXY__PREPAREDATAIMPL_OFFSET UNITYSDK_OFFSET(0x9F88C70)

namespace RPG::Client
{
	inline static constexpr unsigned int CheckItemFinishMainMission_TypeDefinitionIndex = 55245;
