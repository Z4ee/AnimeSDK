...
#define RPG_CLIENT_CHECKITEMFINISHMAINMISSION_FILLNOTIFYTYPESTO_OFFSET UNITYSDK_OFFSET(0x1B93A6C0)
#define RPG_CLIENT_CHECKITEMFINISHMAINMISSION_GETCHECKITEMINFO_OFFSET UNITYSDK_OFFSET(0x1B93AA30)
#define RPG_CLIENT_CHECKITEMFINISHMAINMISSION_GETTARGETMAINMISSIONID_OFFSET UNITYSDK_OFFSET(0x1B93A9F0)
#define RPG_CLIENT_CHECKITEMFINISHMAINMISSION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B93A940)
#define RPG_CLIENT_CHECKITEMFINISHMAINMISSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B93A6A0)
#define RPG_CLIENT_CHECKITEMFINISHMAINMISSION__DOCHECKIMPL_OFFSET UNITYSDK_OFFSET(0x1B93A750)
#define RPG_CLIENT_CHECKITEMFINISHMAINMISSION__ISDATAREADYIMPL_OFFSET UNITYSDK_OFFSET(0x1B93A800)
#define RPG_CLIENT_CHECKITEMFINISHMAINMISSION__PREPAREDATAIMPL_OFFSET UNITYSDK_OFFSET(0x1B93A8A0)
