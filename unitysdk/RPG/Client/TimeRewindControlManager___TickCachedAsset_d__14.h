...
#define RPG_CLIENT_TIMEREWINDCONTROLMANAGER___TICKCACHEDASSET_D__14_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1ACCEB10)
#define RPG_CLIENT_TIMEREWINDCONTROLMANAGER___TICKCACHEDASSET_D__14_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1ACCED10)
#define RPG_CLIENT_TIMEREWINDCONTROLMANAGER___TICKCACHEDASSET_D__14_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1ACCED70)
#define RPG_CLIENT_TIMEREWINDCONTROLMANAGER___TICKCACHEDASSET_D__14_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1ACCED20)
#define RPG_CLIENT_TIMEREWINDCONTROLMANAGER___TICKCACHEDASSET_D__14_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1ACCEB00)
#define RPG_CLIENT_TIMEREWINDCONTROLMANAGER___TICKCACHEDASSET_D__14__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACC5030)
