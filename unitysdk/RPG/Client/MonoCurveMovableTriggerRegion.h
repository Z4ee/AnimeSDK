...
#define RPG_CLIENT_MONOCURVEMOVABLETRIGGERREGION_CONSUMEHITANYCOLLIDER_OFFSET UNITYSDK_OFFSET(0x10CBA700)
#define RPG_CLIENT_MONOCURVEMOVABLETRIGGERREGION_GET_ISBLOCKED_OFFSET UNITYSDK_OFFSET(0x10CBA520)
#define RPG_CLIENT_MONOCURVEMOVABLETRIGGERREGION_METHOD_5_C117F1BAC122F4D0_OFFSET UNITYSDK_OFFSET(0x10CBAA20)
#define RPG_CLIENT_MONOCURVEMOVABLETRIGGERREGION_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x10CBA890)
#define RPG_CLIENT_MONOCURVEMOVABLETRIGGERREGION_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0x10CBAB30)
#define RPG_CLIENT_MONOCURVEMOVABLETRIGGERREGION__CTOR_OFFSET UNITYSDK_OFFSET(0x10CBABB0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoCurveMovableTriggerRegion_TypeDefinitionIndex = 65494;
