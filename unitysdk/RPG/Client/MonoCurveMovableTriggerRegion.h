...
#define RPG_CLIENT_MONOCURVEMOVABLETRIGGERREGION_CONSUMEHITANYCOLLIDER_OFFSET UNITYSDK_OFFSET(0xC065D80)
#define RPG_CLIENT_MONOCURVEMOVABLETRIGGERREGION_GET_ISBLOCKED_OFFSET UNITYSDK_OFFSET(0xC065BA0)
#define RPG_CLIENT_MONOCURVEMOVABLETRIGGERREGION_METHOD_5_C117F1BAC122F4D0_OFFSET UNITYSDK_OFFSET(0xC066190)
#define RPG_CLIENT_MONOCURVEMOVABLETRIGGERREGION_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0xC065F10)
#define RPG_CLIENT_MONOCURVEMOVABLETRIGGERREGION_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0xC0662A0)
#define RPG_CLIENT_MONOCURVEMOVABLETRIGGERREGION__CTOR_OFFSET UNITYSDK_OFFSET(0xC066320)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoCurveMovableTriggerRegion_TypeDefinitionIndex = 64123;
