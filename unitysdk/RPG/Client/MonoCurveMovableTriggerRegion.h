...
#define RPG_CLIENT_MONOCURVEMOVABLETRIGGERREGION_CONSUMEHITANYCOLLIDER_OFFSET UNITYSDK_OFFSET(0x19E37250)
#define RPG_CLIENT_MONOCURVEMOVABLETRIGGERREGION_GET_ISBLOCKED_OFFSET UNITYSDK_OFFSET(0x19E37070)
#define RPG_CLIENT_MONOCURVEMOVABLETRIGGERREGION_METHOD_5_C117F1BAC122F4D0_OFFSET UNITYSDK_OFFSET(0x19E37570)
#define RPG_CLIENT_MONOCURVEMOVABLETRIGGERREGION_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x19E373E0)
#define RPG_CLIENT_MONOCURVEMOVABLETRIGGERREGION_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0x19E37680)
#define RPG_CLIENT_MONOCURVEMOVABLETRIGGERREGION__CTOR_OFFSET UNITYSDK_OFFSET(0x19E37700)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoCurveMovableTriggerRegion_TypeDefinitionIndex = 68509;

	class MonoCurveMovableTriggerRegion : public ::UnityEngine::MonoBehaviour
	{
	public:
		::System::Collections::Generic::List_1<::UnityEngine::Collider*>* NOLADABDIHC; // 0x18
		::System::Collections::Generic::List_1<::UnityEngine::Collider*>* ODBPIGIJMFL; // 0x20
