...
#define RPG_CLIENT_PHOTOGRAPHDECALCONTAINER_PHOTOGRAPHDECALCONTAINERINITPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1866D540)
...
namespace RPG::Client
{
	...
	{
	public:
		::System::Int32 MaxDecalCount; // 0x10
		::System::Single PreviewDecalAlpha; // 0x14
		::System::Single MaxDepthVariance; // 0x18
		::System::Single DecalScale; // 0x1C
		::System::Single DecalWidth; // 0x20
		::System::Single DepthBufferSampleRadiusRatio; // 0x24
		::System::Single FadeInAnimeSpeed; // 0x28
		::System::Single MaxRaycastLength; // 0x2C
		::System::Single MaxDepthTestVariance; // 0x30
		::System::Single PreviewDecalCD; // 0x34
		::System::Single DecalHeight; // 0x38
		::System::Single FadeOutAnimeSpeed; // 0x3C
