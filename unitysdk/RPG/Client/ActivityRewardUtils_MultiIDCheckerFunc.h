...
#define RPG_CLIENT_ACTIVITYREWARDUTILS_MULTIIDCHECKERFUNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x193433E0)
#define RPG_CLIENT_ACTIVITYREWARDUTILS_MULTIIDCHECKERFUNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19343420)
#define RPG_CLIENT_ACTIVITYREWARDUTILS_MULTIIDCHECKERFUNC_INVOKE_OFFSET UNITYSDK_OFFSET(0x193430C0)
#define RPG_CLIENT_ACTIVITYREWARDUTILS_MULTIIDCHECKERFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0x19343360)

namespace RPG::Client
{
	inline static constexpr unsigned int ActivityRewardUtils_MultiIDCheckerFunc_TypeDefinitionIndex = 59001;
