...
{
	inline static constexpr unsigned int PlanetFesTradingCardPersonalData_IServerAgent_TypeDefinitionIndex = 66618;

	class PlanetFesTradingCardPersonalData_IServerAgent
	{
	public:
	};
}
