...
#define RPG_CLIENT_SETBATTLEEVENTSKILLUIPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0xB162BC0)

namespace RPG::Client
{
	inline static constexpr unsigned int SetBattleEventSkillUIParams_TypeDefinitionIndex = 66026;
