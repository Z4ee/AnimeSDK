...
#define RPG_CLIENT_SETBATTLEEVENTSKILLUIPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF7A9E0)

namespace RPG::Client
{
	inline static constexpr unsigned int SetBattleEventSkillUIParams_TypeDefinitionIndex = 71584;
