...
#define RPG_CLIENT_MONOINCONTROLTIP_ADDLONGPRESSPROGRESSEVENT_OFFSET UNITYSDK_OFFSET(0x18C511C0)
#define RPG_CLIENT_MONOINCONTROLTIP_AWAKE_OFFSET UNITYSDK_OFFSET(0x18C509C0)
#define RPG_CLIENT_MONOINCONTROLTIP_CLEARLONGPRESSPROGRESSEVENT_OFFSET UNITYSDK_OFFSET(0x18C514F0)
#define RPG_CLIENT_MONOINCONTROLTIP_CLEARLONGPRESSVIEW_OFFSET UNITYSDK_OFFSET(0x18C52540)
#define RPG_CLIENT_MONOINCONTROLTIP_DESPAWNED_OFFSET UNITYSDK_OFFSET(0x18C51A50)
#define RPG_CLIENT_MONOINCONTROLTIP_GET_ISSHOWTIPBYSELECTED_OFFSET UNITYSDK_OFFSET(0x18C52350)
#define RPG_CLIENT_MONOINCONTROLTIP_GET_ISSHOWTIP_OFFSET UNITYSDK_OFFSET(0x18C522E0)
#define RPG_CLIENT_MONOINCONTROLTIP_GET__ISSHOWTIPINTERNAL_OFFSET UNITYSDK_OFFSET(0x18C522F0)
#define RPG_CLIENT_MONOINCONTROLTIP_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x18C51330)
#define RPG_CLIENT_MONOINCONTROLTIP_SETINCONTROLKEY_OFFSET UNITYSDK_OFFSET(0x18C52410)
#define RPG_CLIENT_MONOINCONTROLTIP_SETINCONTROLTIPKEY_OFFSET UNITYSDK_OFFSET(0x18C4FBF0)
#define RPG_CLIENT_MONOINCONTROLTIP_SETISSUPPORTHOTSWITCH_OFFSET UNITYSDK_OFFSET(0x18C524F0)
#define RPG_CLIENT_MONOINCONTROLTIP_SET_ISSHOWTIPBYSELECTED_OFFSET UNITYSDK_OFFSET(0x18C52360)
#define RPG_CLIENT_MONOINCONTROLTIP_SET_ISSHOWTIP_OFFSET UNITYSDK_OFFSET(0x18C4EE30)
#define RPG_CLIENT_MONOINCONTROLTIP_SPAWNED_OFFSET UNITYSDK_OFFSET(0x18C519F0)
#define RPG_CLIENT_MONOINCONTROLTIP_UPDATE_OFFSET UNITYSDK_OFFSET(0x18C51DF0)
#define RPG_CLIENT_MONOINCONTROLTIP__ADDNOTIFYHANDLERS_OFFSET UNITYSDK_OFFSET(0x18C51020)
#define RPG_CLIENT_MONOINCONTROLTIP__CCTOR_OFFSET UNITYSDK_OFFSET(0x18C54D70)
#define RPG_CLIENT_MONOINCONTROLTIP__CLEAR_OFFSET UNITYSDK_OFFSET(0x18C51380)
#define RPG_CLIENT_MONOINCONTROLTIP__CTOR_OFFSET UNITYSDK_OFFSET(0x18C54C80)
#define RPG_CLIENT_MONOINCONTROLTIP__GETCONTROLLERTIPICON_OFFSET UNITYSDK_OFFSET(0x18C54A20)
#define RPG_CLIENT_MONOINCONTROLTIP__GETINCONTROLGROUPTIPICON_OFFSET UNITYSDK_OFFSET(0x18C54120)
#define RPG_CLIENT_MONOINCONTROLTIP__GETINCONTROLTIPICONBYACTION_OFFSET UNITYSDK_OFFSET(0x18C531C0)
#define RPG_CLIENT_MONOINCONTROLTIP__GETINCONTROLTIPICON_OFFSET UNITYSDK_OFFSET(0x18C54050)
#define RPG_CLIENT_MONOINCONTROLTIP__GETINCONTROLTIPTEXTID_OFFSET UNITYSDK_OFFSET(0x18C53250)
#define RPG_CLIENT_MONOINCONTROLTIP__GETINCONTROLTIPTYPE_OFFSET UNITYSDK_OFFSET(0x18C520E0)
#define RPG_CLIENT_MONOINCONTROLTIP__GETMOUSETIPICON_OFFSET UNITYSDK_OFFSET(0x18C54AF0)
#define RPG_CLIENT_MONOINCONTROLTIP__HIDEPARENTNODE_OFFSET UNITYSDK_OFFSET(0x18C52E20)
#define RPG_CLIENT_MONOINCONTROLTIP__INITACTIONGROUPPREFABOBJECT_OFFSET UNITYSDK_OFFSET(0x18C53900)
#define RPG_CLIENT_MONOINCONTROLTIP__INITACTIONPREFABOBJECT_OFFSET UNITYSDK_OFFSET(0x18C52BE0)
#define RPG_CLIENT_MONOINCONTROLTIP__INITUINODE_OFFSET UNITYSDK_OFFSET(0x18C53330)
#define RPG_CLIENT_MONOINCONTROLTIP__ONASYNCACTIONGROUPLOAD_OFFSET UNITYSDK_OFFSET(0x18C54730)
#define RPG_CLIENT_MONOINCONTROLTIP__ONASYNCACTIONLOAD_OFFSET UNITYSDK_OFFSET(0x18C53610)
#define RPG_CLIENT_MONOINCONTROLTIP__ONIHIDEINCONTROLTIP_OFFSET UNITYSDK_OFFSET(0x18C51DA0)
#define RPG_CLIENT_MONOINCONTROLTIP__ONINPUTACTIONWHITELISTCHANGED_OFFSET UNITYSDK_OFFSET(0x18C51BF0)
#define RPG_CLIENT_MONOINCONTROLTIP__ONINPUTDEVICECLASSSWITCHED_OFFSET UNITYSDK_OFFSET(0x18C52A00)
#define RPG_CLIENT_MONOINCONTROLTIP__ONINPUTFILEDSELECTEDCHANGED_OFFSET UNITYSDK_OFFSET(0x18C51AB0)
#define RPG_CLIENT_MONOINCONTROLTIP__ONKEYBOARDLAYOUTCHANGED_OFFSET UNITYSDK_OFFSET(0x18C54BC0)
#define RPG_CLIENT_MONOINCONTROLTIP__ONLONGPRESSING_OFFSET UNITYSDK_OFFSET(0x18C525A0)
#define RPG_CLIENT_MONOINCONTROLTIP__ONLONGPRESSRELEASE_OFFSET UNITYSDK_OFFSET(0x18C52820)
#define RPG_CLIENT_MONOINCONTROLTIP__ONREFRESHINCONTROLTIP_OFFSET UNITYSDK_OFFSET(0x18C529B0)
#define RPG_CLIENT_MONOINCONTROLTIP__REMOVENOTIFYHANDLERS_OFFSET UNITYSDK_OFFSET(0x18C51850)
#define RPG_CLIENT_MONOINCONTROLTIP__RESETLONGPRESSING_OFFSET UNITYSDK_OFFSET(0x18C51700)
#define RPG_CLIENT_MONOINCONTROLTIP__SHOWPARENTNODE_OFFSET UNITYSDK_OFFSET(0x18C53130)
#define RPG_CLIENT_MONOINCONTROLTIP__TRYGETACTIONLISTFORAND_OFFSET UNITYSDK_OFFSET(0x18C54570)
#define RPG_CLIENT_MONOINCONTROLTIP__TRYGETACTIONLISTFOROR_OFFSET UNITYSDK_OFFSET(0x18C53FB0)
#define RPG_CLIENT_MONOINCONTROLTIP__TRYGETINCONTROLACTIONDATABYGROUP_OFFSET UNITYSDK_OFFSET(0x18C54610)
#define RPG_CLIENT_MONOINCONTROLTIP__UPDATEDESCTEXT_OFFSET UNITYSDK_OFFSET(0x18C52A60)
#define RPG_CLIENT_MONOINCONTROLTIP__UPDATEINCONTROLTIPBYACTIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x18C52EB0)
#define RPG_CLIENT_MONOINCONTROLTIP__UPDATEINCONTROLTIPBYACTIONGROUPCALLBACK_OFFSET UNITYSDK_OFFSET(0x18C53B50)
#define RPG_CLIENT_MONOINCONTROLTIP__UPDATEINCONTROLTIPBYACTIONGROUP_OFFSET UNITYSDK_OFFSET(0x18C52B90)
#define RPG_CLIENT_MONOINCONTROLTIP__UPDATEINCONTROLTIPBYACTION_OFFSET UNITYSDK_OFFSET(0x18C52AE0)
#define RPG_CLIENT_MONOINCONTROLTIP__UPDATEINCONTROLTIPBYICONPATH_OFFSET UNITYSDK_OFFSET(0x18C54440)
#define RPG_CLIENT_MONOINCONTROLTIP__UPDATEINCONTROLTIP_OFFSET UNITYSDK_OFFSET(0x18C50B30)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoInControlTip_TypeDefinitionIndex = 58608;
	...
	public:
		...
		{
			return (::Unity::Profiling::ProfilerMarker*)Il2CppClass::FromTypeDefinitionIndex(MonoInControlTip_TypeDefinitionIndex)->GetStaticField(0xEDE0);
		}
