...
#define RPG_CLIENT_DICECOMBATMODULE___C__DISPLAYCLASS97_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8D6630)
#define RPG_CLIENT_DICECOMBATMODULE___C__DISPLAYCLASS97_0__UPDATEV2FRIENDDATA_B__0_OFFSET UNITYSDK_OFFSET(0x1B8D83C0)
#define RPG_CLIENT_DICECOMBATMODULE___C__DISPLAYCLASS97_0__UPDATEV2FRIENDDATA_B__1_OFFSET UNITYSDK_OFFSET(0x1B8D8400)

namespace RPG::Client
{
	inline static constexpr unsigned int DiceCombatModule___c__DisplayClass97_0_TypeDefinitionIndex = 63624;
