...
#define RPG_CLIENT_TABCONTENTANIMATION_GET_FROMBACKWARDANIMCLIPNAME_OFFSET UNITYSDK_OFFSET(0xB278710)
#define RPG_CLIENT_TABCONTENTANIMATION_GET_FROMFORWARDANIMCLIPNAME_OFFSET UNITYSDK_OFFSET(0xB278670)
#define RPG_CLIENT_TABCONTENTANIMATION_GET_TOBACKWARDANIMCLIPNAME_OFFSET UNITYSDK_OFFSET(0xB2785D0)
#define RPG_CLIENT_TABCONTENTANIMATION_GET_TOFORWARDANIMCLIPNAME_OFFSET UNITYSDK_OFFSET(0xB278530)
#define RPG_CLIENT_TABCONTENTANIMATION_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB2784E0)
#define RPG_CLIENT_TABCONTENTANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0xB2787B0)

namespace RPG::Client
{
	inline static constexpr unsigned int TabContentAnimation_TypeDefinitionIndex = 67091;
