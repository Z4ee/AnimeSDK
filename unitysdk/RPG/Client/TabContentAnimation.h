...
#define RPG_CLIENT_TABCONTENTANIMATION_GET_FROMBACKWARDANIMCLIPNAME_OFFSET UNITYSDK_OFFSET(0xA53B5A0)
#define RPG_CLIENT_TABCONTENTANIMATION_GET_FROMFORWARDANIMCLIPNAME_OFFSET UNITYSDK_OFFSET(0xA53B500)
#define RPG_CLIENT_TABCONTENTANIMATION_GET_TOBACKWARDANIMCLIPNAME_OFFSET UNITYSDK_OFFSET(0xA53B460)
#define RPG_CLIENT_TABCONTENTANIMATION_GET_TOFORWARDANIMCLIPNAME_OFFSET UNITYSDK_OFFSET(0xA53B3C0)
#define RPG_CLIENT_TABCONTENTANIMATION_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xA53B370)
#define RPG_CLIENT_TABCONTENTANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0xA53B640)

namespace RPG::Client
{
	inline static constexpr unsigned int TabContentAnimation_TypeDefinitionIndex = 59695;
