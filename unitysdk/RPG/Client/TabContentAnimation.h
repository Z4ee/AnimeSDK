...
#define RPG_CLIENT_TABCONTENTANIMATION_GET_FROMBACKWARDANIMCLIPNAME_OFFSET UNITYSDK_OFFSET(0xE155FA0)
#define RPG_CLIENT_TABCONTENTANIMATION_GET_FROMFORWARDANIMCLIPNAME_OFFSET UNITYSDK_OFFSET(0xE155EB0)
#define RPG_CLIENT_TABCONTENTANIMATION_GET_TOBACKWARDANIMCLIPNAME_OFFSET UNITYSDK_OFFSET(0xE155DC0)
#define RPG_CLIENT_TABCONTENTANIMATION_GET_TOFORWARDANIMCLIPNAME_OFFSET UNITYSDK_OFFSET(0xE155CD0)
#define RPG_CLIENT_TABCONTENTANIMATION_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xE155C80)
#define RPG_CLIENT_TABCONTENTANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0xE156090)

namespace RPG::Client
{
	inline static constexpr unsigned int TabContentAnimation_TypeDefinitionIndex = 72749;
