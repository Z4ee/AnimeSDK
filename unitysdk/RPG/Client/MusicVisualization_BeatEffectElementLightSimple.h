...
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTLIGHTSIMPLE_METHOD_2_097468641FDED14E_OFFSET UNITYSDK_OFFSET(0x1A3143D0)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTLIGHTSIMPLE_METHOD_2_1A0D3B20C2CC55DC_OFFSET UNITYSDK_OFFSET(0x1A314470)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTLIGHTSIMPLE_METHOD_2_72C9BF8D288CE1D3_1_OFFSET UNITYSDK_OFFSET(0x1A3146D0)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTLIGHTSIMPLE_METHOD_2_72C9BF8D288CE1D3_OFFSET UNITYSDK_OFFSET(0x1A3144F0)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTLIGHTSIMPLE_METHOD_2_89EF21CA0414B145_OFFSET UNITYSDK_OFFSET(0x1A313F40)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTLIGHTSIMPLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A314850)
