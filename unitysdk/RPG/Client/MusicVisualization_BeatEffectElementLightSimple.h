...
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTLIGHTSIMPLE_METHOD_2_097468641FDED14E_OFFSET UNITYSDK_OFFSET(0xAB2A160)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTLIGHTSIMPLE_METHOD_2_6D93101E4CE10A96_OFFSET UNITYSDK_OFFSET(0xAB29DC0)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTLIGHTSIMPLE_METHOD_2_9F9ED25754A7CAB9_OFFSET UNITYSDK_OFFSET(0xAB2A7F0)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTLIGHTSIMPLE_METHOD_2_AA1AB263D4D04DE5_OFFSET UNITYSDK_OFFSET(0xAB2A200)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTLIGHTSIMPLE_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xAB2A770)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTLIGHTSIMPLE_METHOD_2_E5204C0EB6EBF361_1_OFFSET UNITYSDK_OFFSET(0xAB2A4E0)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTLIGHTSIMPLE_METHOD_2_E5204C0EB6EBF361_OFFSET UNITYSDK_OFFSET(0xAB2A280)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTLIGHTSIMPLE__CTOR_OFFSET UNITYSDK_OFFSET(0xAB2A6D0)

namespace RPG::Client
{
	inline static constexpr unsigned int MusicVisualization_BeatEffectElementLightSimple_TypeDefinitionIndex = 65299;
