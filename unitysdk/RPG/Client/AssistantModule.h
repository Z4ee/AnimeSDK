...
#define RPG_CLIENT_ASSISTANTMODULE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC782530)
#define RPG_CLIENT_ASSISTANTMODULE_GETASSISTANTTIPSDATA_OFFSET UNITYSDK_OFFSET(0xC7826E0)
#define RPG_CLIENT_ASSISTANTMODULE_GETASSISTANTTIPSSHOWCASEDATA_OFFSET UNITYSDK_OFFSET(0xC782630)
#define RPG_CLIENT_ASSISTANTMODULE_GETSHOWCASEALLTIPS_OFFSET UNITYSDK_OFFSET(0xC782790)
#define RPG_CLIENT_ASSISTANTMODULE_GETSHOWTIPS_OFFSET UNITYSDK_OFFSET(0xC783060)
#define RPG_CLIENT_ASSISTANTMODULE_INIT_OFFSET UNITYSDK_OFFSET(0xC781F70)
#define RPG_CLIENT_ASSISTANTMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0xC783320)
#define RPG_CLIENT_ASSISTANTMODULE__INITTIPSDATADICT_OFFSET UNITYSDK_OFFSET(0xC781FD0)
#define RPG_CLIENT_ASSISTANTMODULE__INITTIPSSHOWCASEDATADICT_OFFSET UNITYSDK_OFFSET(0xC782280)
