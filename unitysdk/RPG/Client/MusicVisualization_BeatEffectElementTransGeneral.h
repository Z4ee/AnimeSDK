...
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTTRANSGENERAL_METHOD_2_097468641FDED14E_OFFSET UNITYSDK_OFFSET(0xAB2D430)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTTRANSGENERAL_METHOD_2_868FC0444E82D574_OFFSET UNITYSDK_OFFSET(0xAB2D3E0)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTTRANSGENERAL_METHOD_2_9F9ED25754A7CAB9_OFFSET UNITYSDK_OFFSET(0xAB2D7A0)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTTRANSGENERAL_METHOD_2_B660F70070F2A271_OFFSET UNITYSDK_OFFSET(0xAB2D4F0)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTTRANSGENERAL__CTOR_OFFSET UNITYSDK_OFFSET(0xAB2D730)

namespace RPG::Client
{
	inline static constexpr unsigned int MusicVisualization_BeatEffectElementTransGeneral_TypeDefinitionIndex = 65308;
