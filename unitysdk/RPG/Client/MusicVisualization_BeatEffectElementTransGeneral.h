...
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTTRANSGENERAL_METHOD_2_097468641FDED14E_OFFSET UNITYSDK_OFFSET(0x1A317440)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTTRANSGENERAL_METHOD_2_868FC0444E82D574_OFFSET UNITYSDK_OFFSET(0x1A3173F0)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTTRANSGENERAL_METHOD_2_B660F70070F2A271_OFFSET UNITYSDK_OFFSET(0x1A317530)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTTRANSGENERAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A317770)

namespace RPG::Client
{
	inline static constexpr unsigned int MusicVisualization_BeatEffectElementTransGeneral_TypeDefinitionIndex = 70783;
