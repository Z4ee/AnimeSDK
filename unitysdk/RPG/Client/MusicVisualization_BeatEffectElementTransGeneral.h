...
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTTRANSGENERAL_METHOD_2_097468641FDED14E_OFFSET UNITYSDK_OFFSET(0x18EA46E0)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTTRANSGENERAL_METHOD_2_868FC0444E82D574_OFFSET UNITYSDK_OFFSET(0x18EA4690)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTTRANSGENERAL_METHOD_2_B660F70070F2A271_OFFSET UNITYSDK_OFFSET(0x18EA47D0)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTTRANSGENERAL__CTOR_OFFSET UNITYSDK_OFFSET(0x18EA4A10)

namespace RPG::Client
{
	inline static constexpr unsigned int MusicVisualization_BeatEffectElementTransGeneral_TypeDefinitionIndex = 67660;
