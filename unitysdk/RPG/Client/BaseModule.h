...
#define RPG_CLIENT_BASEMODULE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9DAA130)
#define RPG_CLIENT_BASEMODULE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x9DDB840)
#define RPG_CLIENT_BASEMODULE_GET__NET_OFFSET UNITYSDK_OFFSET(0x9DDBAC0)
#define RPG_CLIENT_BASEMODULE_INIT_OFFSET UNITYSDK_OFFSET(0x9DDB960)
#define RPG_CLIENT_BASEMODULE_ONLOGINFINISH_OFFSET UNITYSDK_OFFSET(0x9DDBA00)
#define RPG_CLIENT_BASEMODULE_ONRECONNECT_OFFSET UNITYSDK_OFFSET(0x9DDB9C0)
#define RPG_CLIENT_BASEMODULE_REMOVELISTENER_OFFSET UNITYSDK_OFFSET(0x9DDBA40)
#define RPG_CLIENT_BASEMODULE__ADDNOTIFYHANDLERS_OFFSET UNITYSDK_OFFSET(0x9DAD530)
#define RPG_CLIENT_BASEMODULE__ADDNOTIFYHANDLER_OFFSET UNITYSDK_OFFSET(0x9DAA720)
#define RPG_CLIENT_BASEMODULE__ADDPACKETHANDLERS_OFFSET UNITYSDK_OFFSET(0x9DAD4B0)
#define RPG_CLIENT_BASEMODULE__CCTOR_OFFSET UNITYSDK_OFFSET(0x9DDBB50)
#define RPG_CLIENT_BASEMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0x9DA83E0)

namespace RPG::Client
{
	inline static constexpr unsigned int BaseModule_TypeDefinitionIndex = 57906;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(BaseModule_TypeDefinitionIndex)->GetStaticField(0x3C9C0);
		}
