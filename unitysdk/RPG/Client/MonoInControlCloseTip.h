...
#define RPG_CLIENT_MONOINCONTROLCLOSETIP_AWAKE_OFFSET UNITYSDK_OFFSET(0x9D09CD0)
#define RPG_CLIENT_MONOINCONTROLCLOSETIP_METHOD_5_6D93101E4CE10A96_OFFSET UNITYSDK_OFFSET(0x9D09EB0)
#define RPG_CLIENT_MONOINCONTROLCLOSETIP_METHOD_5_F5ADBA366C2EA507_OFFSET UNITYSDK_OFFSET(0x9D09FD0)
#define RPG_CLIENT_MONOINCONTROLCLOSETIP_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9D09F60)
#define RPG_CLIENT_MONOINCONTROLCLOSETIP__CTOR_OFFSET UNITYSDK_OFFSET(0x9D0A020)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoInControlCloseTip_TypeDefinitionIndex = 49746;
