...
#define RPG_CLIENT_MONOINCONTROLCLOSETIP_AWAKE_OFFSET UNITYSDK_OFFSET(0x1ACE2410)
#define RPG_CLIENT_MONOINCONTROLCLOSETIP_METHOD_5_6D93101E4CE10A96_OFFSET UNITYSDK_OFFSET(0x1ACE2600)
#define RPG_CLIENT_MONOINCONTROLCLOSETIP_METHOD_5_F5ADBA366C2EA507_OFFSET UNITYSDK_OFFSET(0x1ACE2750)
#define RPG_CLIENT_MONOINCONTROLCLOSETIP_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1ACE26B0)
#define RPG_CLIENT_MONOINCONTROLCLOSETIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACE27A0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoInControlCloseTip_TypeDefinitionIndex = 61436;

	class MonoInControlCloseTip : public ::UnityEngine::MonoBehaviour
	{
	public:
		::UnityEngine::Transform* MONLPLNGIOJ; // 0x18
		::UnityEngine::Transform* PGPBJLGKAMI; // 0x20
