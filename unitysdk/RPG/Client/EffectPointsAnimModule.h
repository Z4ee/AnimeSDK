...
#define RPG_CLIENT_EFFECTPOINTSANIMMODULE_METHOD_1_E9A575D18A0748D9_1_OFFSET UNITYSDK_OFFSET(0x1A6A8720)
#define RPG_CLIENT_EFFECTPOINTSANIMMODULE_METHOD_1_E9A575D18A0748D9_OFFSET UNITYSDK_OFFSET(0x1A6A86D0)
#define RPG_CLIENT_EFFECTPOINTSANIMMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6A8770)

namespace RPG::Client
{
	inline static constexpr unsigned int EffectPointsAnimModule_TypeDefinitionIndex = 70591;
