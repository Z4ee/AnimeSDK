...
#define RPG_CLIENT_AIRSHIPEMITTER_AWAKE_OFFSET UNITYSDK_OFFSET(0x9CF6E40)
#define RPG_CLIENT_AIRSHIPEMITTER_CHANNELNAME_OFFSET UNITYSDK_OFFSET(0x9CF7310)
#define RPG_CLIENT_AIRSHIPEMITTER_CREATEMANAGER_OFFSET UNITYSDK_OFFSET(0x9CF5850)
#define RPG_CLIENT_AIRSHIPEMITTER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9CF65F0)
#define RPG_CLIENT_AIRSHIPEMITTER_GET_CURRENTEMITINTERVAL_OFFSET UNITYSDK_OFFSET(0x9CF72D0)
#define RPG_CLIENT_AIRSHIPEMITTER_GET_CURRENTMAXALIVECOUNT_OFFSET UNITYSDK_OFFSET(0x9CF72B0)
#define RPG_CLIENT_AIRSHIPEMITTER_GET_OWNERFMSYSTEM_OFFSET UNITYSDK_OFFSET(0x9CF72F0)
#define RPG_CLIENT_AIRSHIPEMITTER_GET_WAITEMITTIMER_OFFSET UNITYSDK_OFFSET(0x9CF58E0)
#define RPG_CLIENT_AIRSHIPEMITTER_ISREADYTOEMIT_OFFSET UNITYSDK_OFFSET(0x9CF5930)
#define RPG_CLIENT_AIRSHIPEMITTER_METHOD_5_2255B3F0FA1619FE_OFFSET UNITYSDK_OFFSET(0x9CF5D70)
#define RPG_CLIENT_AIRSHIPEMITTER_METHOD_5_2C33C3CB06D1D95F_OFFSET UNITYSDK_OFFSET(0x9CF6570)
#define RPG_CLIENT_AIRSHIPEMITTER_METHOD_5_2F0F99A12DB93F30_OFFSET UNITYSDK_OFFSET(0x9CF7010)
#define RPG_CLIENT_AIRSHIPEMITTER_METHOD_5_3B7145E79424FB75_OFFSET UNITYSDK_OFFSET(0x9CF7130)
#define RPG_CLIENT_AIRSHIPEMITTER_METHOD_5_4E7FADC1B404C65B_OFFSET UNITYSDK_OFFSET(0x9CF5D20)
#define RPG_CLIENT_AIRSHIPEMITTER_METHOD_5_A3979D70DA6179B4_OFFSET UNITYSDK_OFFSET(0x9CF6C40)
#define RPG_CLIENT_AIRSHIPEMITTER_METHOD_5_FEE7938AD36467E5_OFFSET UNITYSDK_OFFSET(0x9CF6640)
#define RPG_CLIENT_AIRSHIPEMITTER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9CF70A0)
#define RPG_CLIENT_AIRSHIPEMITTER_ONSAMPLE_OFFSET UNITYSDK_OFFSET(0x9CF7390)
#define RPG_CLIENT_AIRSHIPEMITTER_READYTOEMIT_OFFSET UNITYSDK_OFFSET(0x9CF59A0)
#define RPG_CLIENT_AIRSHIPEMITTER_RESETTIMER_OFFSET UNITYSDK_OFFSET(0x9CF5C70)
#define RPG_CLIENT_AIRSHIPEMITTER_RESET_OFFSET UNITYSDK_OFFSET(0x9CF7190)
#define RPG_CLIENT_AIRSHIPEMITTER_SAMPLEDELAY_OFFSET UNITYSDK_OFFSET(0x9CF7350)
#define RPG_CLIENT_AIRSHIPEMITTER_SET_CURRENTEMITINTERVAL_OFFSET UNITYSDK_OFFSET(0x9CF72E0)
#define RPG_CLIENT_AIRSHIPEMITTER_SET_CURRENTMAXALIVECOUNT_OFFSET UNITYSDK_OFFSET(0x9CF72C0)
#define RPG_CLIENT_AIRSHIPEMITTER_SET_OWNERFMSYSTEM_OFFSET UNITYSDK_OFFSET(0x9CF7300)
#define RPG_CLIENT_AIRSHIPEMITTER_SHOULDEMITBYSIGNAL_OFFSET UNITYSDK_OFFSET(0x9CF6BC0)
#define RPG_CLIENT_AIRSHIPEMITTER_TICK_OFFSET UNITYSDK_OFFSET(0x9CF6B30)
#define RPG_CLIENT_AIRSHIPEMITTER_TRYDESTROY_OFFSET UNITYSDK_OFFSET(0x9CF62F0)
#define RPG_CLIENT_AIRSHIPEMITTER_TRYEMIT_OFFSET UNITYSDK_OFFSET(0x9CF59F0)
#define RPG_CLIENT_AIRSHIPEMITTER_UPDATELEVELINFO_OFFSET UNITYSDK_OFFSET(0x9CF6F20)
#define RPG_CLIENT_AIRSHIPEMITTER__CTOR_OFFSET UNITYSDK_OFFSET(0x9CF7430)

namespace RPG::Client
{
	inline static constexpr unsigned int AirshipEmitter_TypeDefinitionIndex = 55158;
	...
	public:
		...
		::Class_0_16E4307DCC419505_335* _OwnerFMSystem_k__BackingField; // 0x90
		...
		{
			return ((::Class_0_16E4307DCC419505_567*(*)(::PVOID, ::System::UInt32, ::System::String*))((::PBYTE)hIl2Cpp + RPG_CLIENT_AIRSHIPEMITTER_CREATEMANAGER_OFFSET))(this, a1, a2);
		}
		...
		{
			return ((::Class_0_16E4307DCC419505_335*(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_AIRSHIPEMITTER_GET_OWNERFMSYSTEM_OFFSET))(this);
		}

		::System::Void set_OwnerFMSystem(::Class_0_16E4307DCC419505_335* value)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_335*))((::PBYTE)hIl2Cpp + RPG_CLIENT_AIRSHIPEMITTER_SET_OWNERFMSYSTEM_OFFSET))(this, value);
		}
