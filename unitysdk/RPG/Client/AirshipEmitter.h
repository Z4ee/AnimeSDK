...
#define RPG_CLIENT_AIRSHIPEMITTER_AWAKE_OFFSET UNITYSDK_OFFSET(0x17EC7FE0)
#define RPG_CLIENT_AIRSHIPEMITTER_CHANNELNAME_OFFSET UNITYSDK_OFFSET(0x17EC84D0)
#define RPG_CLIENT_AIRSHIPEMITTER_CREATEMANAGER_OFFSET UNITYSDK_OFFSET(0x17EC6B10)
#define RPG_CLIENT_AIRSHIPEMITTER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17EC7870)
#define RPG_CLIENT_AIRSHIPEMITTER_GET_CURRENTEMITINTERVAL_OFFSET UNITYSDK_OFFSET(0x17EC8490)
#define RPG_CLIENT_AIRSHIPEMITTER_GET_CURRENTMAXALIVECOUNT_OFFSET UNITYSDK_OFFSET(0x17EC8470)
#define RPG_CLIENT_AIRSHIPEMITTER_GET_OWNERFMSYSTEM_OFFSET UNITYSDK_OFFSET(0x17EC84B0)
#define RPG_CLIENT_AIRSHIPEMITTER_GET_WAITEMITTIMER_OFFSET UNITYSDK_OFFSET(0x17EC6BA0)
#define RPG_CLIENT_AIRSHIPEMITTER_ISREADYTOEMIT_OFFSET UNITYSDK_OFFSET(0x17EC6BF0)
#define RPG_CLIENT_AIRSHIPEMITTER_METHOD_5_1FFBCA2671193585_OFFSET UNITYSDK_OFFSET(0x17EC7010)
#define RPG_CLIENT_AIRSHIPEMITTER_METHOD_5_3B258437A86233AC_OFFSET UNITYSDK_OFFSET(0x17EC8360)
#define RPG_CLIENT_AIRSHIPEMITTER_METHOD_5_3BC8B8F2BB08C1C2_OFFSET UNITYSDK_OFFSET(0x17EC8240)
#define RPG_CLIENT_AIRSHIPEMITTER_METHOD_5_4E7FADC1B404C65B_OFFSET UNITYSDK_OFFSET(0x17EC6FC0)
#define RPG_CLIENT_AIRSHIPEMITTER_METHOD_5_A3979D70DA6179B4_OFFSET UNITYSDK_OFFSET(0x17EC7DE0)
#define RPG_CLIENT_AIRSHIPEMITTER_METHOD_5_DDE597491913B761_OFFSET UNITYSDK_OFFSET(0x17EC77D0)
#define RPG_CLIENT_AIRSHIPEMITTER_METHOD_5_E67FA6A042436B76_OFFSET UNITYSDK_OFFSET(0x17EC78C0)
#define RPG_CLIENT_AIRSHIPEMITTER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x17EC82D0)
#define RPG_CLIENT_AIRSHIPEMITTER_ONSAMPLE_OFFSET UNITYSDK_OFFSET(0x17EC8550)
#define RPG_CLIENT_AIRSHIPEMITTER_READYTOEMIT_OFFSET UNITYSDK_OFFSET(0x17EC6C60)
#define RPG_CLIENT_AIRSHIPEMITTER_RESETTIMER_OFFSET UNITYSDK_OFFSET(0x17EC6F10)
#define RPG_CLIENT_AIRSHIPEMITTER_RESET_OFFSET UNITYSDK_OFFSET(0x17EC83C0)
#define RPG_CLIENT_AIRSHIPEMITTER_SAMPLEDELAY_OFFSET UNITYSDK_OFFSET(0x17EC8510)
#define RPG_CLIENT_AIRSHIPEMITTER_SET_CURRENTEMITINTERVAL_OFFSET UNITYSDK_OFFSET(0x17EC84A0)
#define RPG_CLIENT_AIRSHIPEMITTER_SET_CURRENTMAXALIVECOUNT_OFFSET UNITYSDK_OFFSET(0x17EC8480)
#define RPG_CLIENT_AIRSHIPEMITTER_SET_OWNERFMSYSTEM_OFFSET UNITYSDK_OFFSET(0x17EC84C0)
#define RPG_CLIENT_AIRSHIPEMITTER_SHOULDEMITBYSIGNAL_OFFSET UNITYSDK_OFFSET(0x17EC7D60)
#define RPG_CLIENT_AIRSHIPEMITTER_TICK_OFFSET UNITYSDK_OFFSET(0x17EC7CD0)
#define RPG_CLIENT_AIRSHIPEMITTER_TRYDESTROY_OFFSET UNITYSDK_OFFSET(0x17EC7610)
#define RPG_CLIENT_AIRSHIPEMITTER_TRYEMIT_OFFSET UNITYSDK_OFFSET(0x17EC6CB0)
#define RPG_CLIENT_AIRSHIPEMITTER_UPDATELEVELINFO_OFFSET UNITYSDK_OFFSET(0x17EC8110)
#define RPG_CLIENT_AIRSHIPEMITTER__CTOR_OFFSET UNITYSDK_OFFSET(0x17EC85F0)

namespace RPG::Client
{
	inline static constexpr unsigned int AirshipEmitter_TypeDefinitionIndex = 57131;
	...
	public:
		...
		::Class_0_16E4307DCC419505_372* _OwnerFMSystem_k__BackingField; // 0x90
		...
		{
			return ((::Class_0_16E4307DCC419505_624*(*)(::PVOID, ::System::UInt32, ::System::String*))((::PBYTE)hIl2Cpp + RPG_CLIENT_AIRSHIPEMITTER_CREATEMANAGER_OFFSET))(this, a1, a2);
		}
		...
		::Class_1_20A9882BBF853CEE* Method_5_1FFBCA2671193585(::RPG::Client::Airship* a1, ::UnityEngine::Transform* a2)
		{
			return ((::Class_1_20A9882BBF853CEE*(*)(::PVOID, ::RPG::Client::Airship*, ::UnityEngine::Transform*))((::PBYTE)hIl2Cpp + RPG_CLIENT_AIRSHIPEMITTER_METHOD_5_1FFBCA2671193585_OFFSET))(this, a1, a2);
		}

		::System::Void Method_5_E67FA6A042436B76()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_AIRSHIPEMITTER_METHOD_5_E67FA6A042436B76_OFFSET))(this);
		}

		::System::Void Method_5_DDE597491913B761(::RPG::Client::Airship* a1)
		{
			return ((::System::Void(*)(::PVOID, ::RPG::Client::Airship*))((::PBYTE)hIl2Cpp + RPG_CLIENT_AIRSHIPEMITTER_METHOD_5_DDE597491913B761_OFFSET))(this, a1);
		}
		...
		{
			return ((::Class_0_16E4307DCC419505_372*(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_AIRSHIPEMITTER_GET_OWNERFMSYSTEM_OFFSET))(this);
		}

		::System::Void set_OwnerFMSystem(::Class_0_16E4307DCC419505_372* a1)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_372*))((::PBYTE)hIl2Cpp + RPG_CLIENT_AIRSHIPEMITTER_SET_OWNERFMSYSTEM_OFFSET))(this, a1);
		}
