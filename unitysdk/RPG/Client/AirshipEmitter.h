...
#define RPG_CLIENT_AIRSHIPEMITTER_AWAKE_OFFSET UNITYSDK_OFFSET(0xB2E6CD0)
#define RPG_CLIENT_AIRSHIPEMITTER_CHANNELNAME_OFFSET UNITYSDK_OFFSET(0xB2E7130)
#define RPG_CLIENT_AIRSHIPEMITTER_CREATEMANAGER_OFFSET UNITYSDK_OFFSET(0xB2E5800)
#define RPG_CLIENT_AIRSHIPEMITTER_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB2E6560)
#define RPG_CLIENT_AIRSHIPEMITTER_GET_CURRENTEMITINTERVAL_OFFSET UNITYSDK_OFFSET(0xB2E70F0)
#define RPG_CLIENT_AIRSHIPEMITTER_GET_CURRENTMAXALIVECOUNT_OFFSET UNITYSDK_OFFSET(0xB2E70D0)
#define RPG_CLIENT_AIRSHIPEMITTER_GET_OWNERFMSYSTEM_OFFSET UNITYSDK_OFFSET(0xB2E7110)
#define RPG_CLIENT_AIRSHIPEMITTER_GET_WAITEMITTIMER_OFFSET UNITYSDK_OFFSET(0xB2E5890)
#define RPG_CLIENT_AIRSHIPEMITTER_ISREADYTOEMIT_OFFSET UNITYSDK_OFFSET(0xB2E58E0)
#define RPG_CLIENT_AIRSHIPEMITTER_METHOD_5_1FFBCA2671193585_OFFSET UNITYSDK_OFFSET(0xB2E5D00)
#define RPG_CLIENT_AIRSHIPEMITTER_METHOD_5_2F0F99A12DB93F30_OFFSET UNITYSDK_OFFSET(0xB2E6EA0)
#define RPG_CLIENT_AIRSHIPEMITTER_METHOD_5_3B258437A86233AC_OFFSET UNITYSDK_OFFSET(0xB2E6FC0)
#define RPG_CLIENT_AIRSHIPEMITTER_METHOD_5_4E7FADC1B404C65B_OFFSET UNITYSDK_OFFSET(0xB2E5CB0)
#define RPG_CLIENT_AIRSHIPEMITTER_METHOD_5_A3979D70DA6179B4_OFFSET UNITYSDK_OFFSET(0xB2E6AD0)
#define RPG_CLIENT_AIRSHIPEMITTER_METHOD_5_DDE597491913B761_OFFSET UNITYSDK_OFFSET(0xB2E64C0)
#define RPG_CLIENT_AIRSHIPEMITTER_METHOD_5_E67FA6A042436B76_OFFSET UNITYSDK_OFFSET(0xB2E65B0)
#define RPG_CLIENT_AIRSHIPEMITTER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB2E6F30)
#define RPG_CLIENT_AIRSHIPEMITTER_ONSAMPLE_OFFSET UNITYSDK_OFFSET(0xB2E71B0)
#define RPG_CLIENT_AIRSHIPEMITTER_READYTOEMIT_OFFSET UNITYSDK_OFFSET(0xB2E5950)
#define RPG_CLIENT_AIRSHIPEMITTER_RESETTIMER_OFFSET UNITYSDK_OFFSET(0xB2E5C00)
#define RPG_CLIENT_AIRSHIPEMITTER_RESET_OFFSET UNITYSDK_OFFSET(0xB2E7020)
#define RPG_CLIENT_AIRSHIPEMITTER_SAMPLEDELAY_OFFSET UNITYSDK_OFFSET(0xB2E7170)
#define RPG_CLIENT_AIRSHIPEMITTER_SET_CURRENTEMITINTERVAL_OFFSET UNITYSDK_OFFSET(0xB2E7100)
#define RPG_CLIENT_AIRSHIPEMITTER_SET_CURRENTMAXALIVECOUNT_OFFSET UNITYSDK_OFFSET(0xB2E70E0)
#define RPG_CLIENT_AIRSHIPEMITTER_SET_OWNERFMSYSTEM_OFFSET UNITYSDK_OFFSET(0xB2E7120)
#define RPG_CLIENT_AIRSHIPEMITTER_SHOULDEMITBYSIGNAL_OFFSET UNITYSDK_OFFSET(0xB2E6A50)
#define RPG_CLIENT_AIRSHIPEMITTER_TICK_OFFSET UNITYSDK_OFFSET(0xB2E69C0)
#define RPG_CLIENT_AIRSHIPEMITTER_TRYDESTROY_OFFSET UNITYSDK_OFFSET(0xB2E6300)
#define RPG_CLIENT_AIRSHIPEMITTER_TRYEMIT_OFFSET UNITYSDK_OFFSET(0xB2E59A0)
#define RPG_CLIENT_AIRSHIPEMITTER_UPDATELEVELINFO_OFFSET UNITYSDK_OFFSET(0xB2E6DB0)
#define RPG_CLIENT_AIRSHIPEMITTER__CTOR_OFFSET UNITYSDK_OFFSET(0xB2E7250)

namespace RPG::Client
{
	inline static constexpr unsigned int AirshipEmitter_TypeDefinitionIndex = 55892;
	...
	public:
		...
		::Class_0_16E4307DCC419505_348* _OwnerFMSystem_k__BackingField; // 0x90
		...
		{
			return ((::Class_0_16E4307DCC419505_589*(*)(::PVOID, ::System::UInt32, ::System::String*))((::PBYTE)hIl2Cpp + RPG_CLIENT_AIRSHIPEMITTER_CREATEMANAGER_OFFSET))(this, a1, a2);
		}
		...
		{
			return ((::Class_0_16E4307DCC419505_348*(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_AIRSHIPEMITTER_GET_OWNERFMSYSTEM_OFFSET))(this);
		}

		::System::Void set_OwnerFMSystem(::Class_0_16E4307DCC419505_348* a1)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_348*))((::PBYTE)hIl2Cpp + RPG_CLIENT_AIRSHIPEMITTER_SET_OWNERFMSYSTEM_OFFSET))(this, a1);
		}
