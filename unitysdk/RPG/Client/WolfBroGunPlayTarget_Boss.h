...
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_GET_BOSSSCORE_OFFSET UNITYSDK_OFFSET(0xA796070)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_INIT_OFFSET UNITYSDK_OFFSET(0xA795770)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_ISBOOMABLE_OFFSET UNITYSDK_OFFSET(0xA795AE0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_ISHITTABLE_OFFSET UNITYSDK_OFFSET(0xA795A30)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_KILL_OFFSET UNITYSDK_OFFSET(0xA795680)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_METHOD_6_19CCC07C980409E4_OFFSET UNITYSDK_OFFSET(0xA795710)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_METHOD_6_56A28EFF6A9CC5BA_1_OFFSET UNITYSDK_OFFSET(0xA796360)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_METHOD_6_56A28EFF6A9CC5BA_OFFSET UNITYSDK_OFFSET(0xA796310)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_METHOD_6_69225B22C8D30B3E_OFFSET UNITYSDK_OFFSET(0xA7963B0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_METHOD_6_775B6D644F07B554_1_OFFSET UNITYSDK_OFFSET(0xA7963C0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_METHOD_6_775B6D644F07B554_OFFSET UNITYSDK_OFFSET(0xA7961E0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_METHOD_6_A86A455D6AB5B836_1_OFFSET UNITYSDK_OFFSET(0xA795ED0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_METHOD_6_A86A455D6AB5B836_OFFSET UNITYSDK_OFFSET(0xA795E80)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_METHOD_6_AD23FDCC7576BB32_OFFSET UNITYSDK_OFFSET(0xA795810)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_METHOD_6_B961D33AD47A2113_OFFSET UNITYSDK_OFFSET(0xA795F20)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_METHOD_6_BEC0C6D1D2906F45_OFFSET UNITYSDK_OFFSET(0xA7961D0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_METHOD_6_E3DE31A03057E055_OFFSET UNITYSDK_OFFSET(0xA7958F0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_ONHIT_OFFSET UNITYSDK_OFFSET(0xA795B70)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS_SET_BOSSSCORE_OFFSET UNITYSDK_OFFSET(0xA796080)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS__CTOR_OFFSET UNITYSDK_OFFSET(0xA796090)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0xA7961C0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS___IFIXBASEPROXY_ISBOOMABLE_OFFSET UNITYSDK_OFFSET(0xA796260)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS___IFIXBASEPROXY_ISHITTABLE_OFFSET UNITYSDK_OFFSET(0xA7961F0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOSS___IFIXBASEPROXY_ONHIT_OFFSET UNITYSDK_OFFSET(0xA7962D0)

namespace RPG::Client
{
	inline static constexpr unsigned int WolfBroGunPlayTarget_Boss_TypeDefinitionIndex = 56121;
