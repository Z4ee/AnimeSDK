...
#define RPG_CLIENT_GRIDFIGHTFRONTSPECIALSPCONFIG_GET_INITIALSPECIALSP_OFFSET UNITYSDK_OFFSET(0xA4A6BA0)
#define RPG_CLIENT_GRIDFIGHTFRONTSPECIALSPCONFIG_GET_MAXSPECIALSP_OFFSET UNITYSDK_OFFSET(0xA4A6BB0)
#define RPG_CLIENT_GRIDFIGHTFRONTSPECIALSPCONFIG_GET_ROLEID_OFFSET UNITYSDK_OFFSET(0xA4A6B80)
#define RPG_CLIENT_GRIDFIGHTFRONTSPECIALSPCONFIG_GET_SPECIALSPTYPE_OFFSET UNITYSDK_OFFSET(0xA4A6B90)
#define RPG_CLIENT_GRIDFIGHTFRONTSPECIALSPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xA4A6B40)
