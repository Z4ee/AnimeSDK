...
#define RPG_CLIENT_MAP3DUTILS___SMOOTHLYSETOPACITY_D__19_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x17FD0CC0)
#define RPG_CLIENT_MAP3DUTILS___SMOOTHLYSETOPACITY_D__19_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x17FD0E60)
#define RPG_CLIENT_MAP3DUTILS___SMOOTHLYSETOPACITY_D__19_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x17FD0EC0)
#define RPG_CLIENT_MAP3DUTILS___SMOOTHLYSETOPACITY_D__19_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x17FD0E70)
#define RPG_CLIENT_MAP3DUTILS___SMOOTHLYSETOPACITY_D__19_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17FD0CB0)
#define RPG_CLIENT_MAP3DUTILS___SMOOTHLYSETOPACITY_D__19__CTOR_OFFSET UNITYSDK_OFFSET(0x17FD0A20)

namespace RPG::Client
{
	inline static constexpr unsigned int Map3DUtils___SmoothlySetOpacity_d__19_TypeDefinitionIndex = 65965;
