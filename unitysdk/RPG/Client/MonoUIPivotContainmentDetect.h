...
#define RPG_CLIENT_MONOUIPIVOTCONTAINMENTDETECT_ADD_ONISCONTAINEDCHANGED_OFFSET UNITYSDK_OFFSET(0x1A365380)
#define RPG_CLIENT_MONOUIPIVOTCONTAINMENTDETECT_FORCEIMMEDIATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1A365490)
#define RPG_CLIENT_MONOUIPIVOTCONTAINMENTDETECT_GET_AREA_OFFSET UNITYSDK_OFFSET(0x1A365240)
#define RPG_CLIENT_MONOUIPIVOTCONTAINMENTDETECT_GET_ISCONTAINED_OFFSET UNITYSDK_OFFSET(0x1A3652D0)
#define RPG_CLIENT_MONOUIPIVOTCONTAINMENTDETECT_GET_PIVOT_OFFSET UNITYSDK_OFFSET(0x1A365100)
#define RPG_CLIENT_MONOUIPIVOTCONTAINMENTDETECT_REMOVE_ONISCONTAINEDCHANGED_OFFSET UNITYSDK_OFFSET(0x1A3653E0)
#define RPG_CLIENT_MONOUIPIVOTCONTAINMENTDETECT_SET_AREA_OFFSET UNITYSDK_OFFSET(0x1A365280)
#define RPG_CLIENT_MONOUIPIVOTCONTAINMENTDETECT_SET_ISCONTAINED_OFFSET UNITYSDK_OFFSET(0x1A365310)
#define RPG_CLIENT_MONOUIPIVOTCONTAINMENTDETECT_SET_PIVOT_OFFSET UNITYSDK_OFFSET(0x1A365140)
#define RPG_CLIENT_MONOUIPIVOTCONTAINMENTDETECT_SUBSCRIBEISCONTAINEDCHANGED_OFFSET UNITYSDK_OFFSET(0x1A3654E0)
#define RPG_CLIENT_MONOUIPIVOTCONTAINMENTDETECT_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A365440)
#define RPG_CLIENT_MONOUIPIVOTCONTAINMENTDETECT__CHECKISCONTAINED_OFFSET UNITYSDK_OFFSET(0x1A365610)
#define RPG_CLIENT_MONOUIPIVOTCONTAINMENTDETECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A365830)
#define RPG_CLIENT_MONOUIPIVOTCONTAINMENTDETECT__UPDATEISCONTAINED_OFFSET UNITYSDK_OFFSET(0x1A365190)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoUIPivotContainmentDetect_TypeDefinitionIndex = 69333;
