...
#define RPG_CLIENT_MONOUIPIVOTCONTAINMENTDETECT_ADD_ONISCONTAINEDCHANGED_OFFSET UNITYSDK_OFFSET(0xC15E400)
#define RPG_CLIENT_MONOUIPIVOTCONTAINMENTDETECT_FORCEIMMEDIATEUPDATE_OFFSET UNITYSDK_OFFSET(0xC15E510)
#define RPG_CLIENT_MONOUIPIVOTCONTAINMENTDETECT_GET_AREA_OFFSET UNITYSDK_OFFSET(0xC15E320)
#define RPG_CLIENT_MONOUIPIVOTCONTAINMENTDETECT_GET_ISCONTAINED_OFFSET UNITYSDK_OFFSET(0xC15E380)
#define RPG_CLIENT_MONOUIPIVOTCONTAINMENTDETECT_GET_PIVOT_OFFSET UNITYSDK_OFFSET(0xC15E210)
#define RPG_CLIENT_MONOUIPIVOTCONTAINMENTDETECT_REMOVE_ONISCONTAINEDCHANGED_OFFSET UNITYSDK_OFFSET(0xC15E460)
#define RPG_CLIENT_MONOUIPIVOTCONTAINMENTDETECT_SET_AREA_OFFSET UNITYSDK_OFFSET(0xC15E330)
#define RPG_CLIENT_MONOUIPIVOTCONTAINMENTDETECT_SET_ISCONTAINED_OFFSET UNITYSDK_OFFSET(0xC15E390)
#define RPG_CLIENT_MONOUIPIVOTCONTAINMENTDETECT_SET_PIVOT_OFFSET UNITYSDK_OFFSET(0xC15E220)
#define RPG_CLIENT_MONOUIPIVOTCONTAINMENTDETECT_SUBSCRIBEISCONTAINEDCHANGED_OFFSET UNITYSDK_OFFSET(0xC15E560)
#define RPG_CLIENT_MONOUIPIVOTCONTAINMENTDETECT_UPDATE_OFFSET UNITYSDK_OFFSET(0xC15E4C0)
#define RPG_CLIENT_MONOUIPIVOTCONTAINMENTDETECT__CHECKISCONTAINED_OFFSET UNITYSDK_OFFSET(0xC15E690)
#define RPG_CLIENT_MONOUIPIVOTCONTAINMENTDETECT__CTOR_OFFSET UNITYSDK_OFFSET(0xC15E8B0)
#define RPG_CLIENT_MONOUIPIVOTCONTAINMENTDETECT__UPDATEISCONTAINED_OFFSET UNITYSDK_OFFSET(0xC15E270)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoUIPivotContainmentDetect_TypeDefinitionIndex = 67849;
