...
#define RPG_CLIENT_MONOUICOLORSWITCHER_NODEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xC15C660)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoUIColorSwitcher_NodeItem_TypeDefinitionIndex = 64502;
