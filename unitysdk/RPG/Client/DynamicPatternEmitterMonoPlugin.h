...
#define RPG_CLIENT_DYNAMICPATTERNEMITTERMONOPLUGIN_GET_ARTBOUNDFULL_OFFSET UNITYSDK_OFFSET(0xCDAD360)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERMONOPLUGIN_GET_ARTBOUND_OFFSET UNITYSDK_OFFSET(0xCDB1360)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERMONOPLUGIN_GET_AUDIOPLAYERGO_OFFSET UNITYSDK_OFFSET(0xCDB11F0)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERMONOPLUGIN_GET_IFSHOWALLDIALOG_OFFSET UNITYSDK_OFFSET(0xCDB1210)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERMONOPLUGIN_GET_RENDERBUDGETDATA_OFFSET UNITYSDK_OFFSET(0xCDB1410)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERMONOPLUGIN_GET_RENDERINSTANCECOLLECTMODE_OFFSET UNITYSDK_OFFSET(0xCDB15E0)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERMONOPLUGIN_GET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0xCDACF60)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERMONOPLUGIN_METHOD_7_F0088C88851A7DFB_1_OFFSET UNITYSDK_OFFSET(0xCDB11E0)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERMONOPLUGIN_METHOD_7_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xCDB11D0)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERMONOPLUGIN_SET_AUDIOPLAYERGO_OFFSET UNITYSDK_OFFSET(0xCDB1200)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERMONOPLUGIN_SET_IFSHOWALLDIALOG_OFFSET UNITYSDK_OFFSET(0xCDB1220)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERMONOPLUGIN_STARTPLAY_OFFSET UNITYSDK_OFFSET(0xCDB1230)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERMONOPLUGIN_STOPPLAY_OFFSET UNITYSDK_OFFSET(0xCDB12E0)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERMONOPLUGIN__CCTOR_OFFSET UNITYSDK_OFFSET(0xCDB16E0)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xCDB15F0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(DynamicPatternEmitterMonoPlugin_TypeDefinitionIndex)->GetStaticField(0x63A00);
		}
