...
#define RPG_CLIENT_DYNAMICPATTERNEMITTERMONOPLUGIN_GET_ARTBOUNDFULL_OFFSET UNITYSDK_OFFSET(0x951EFE0)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERMONOPLUGIN_GET_ARTBOUND_OFFSET UNITYSDK_OFFSET(0x9522EC0)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERMONOPLUGIN_GET_AUDIOPLAYERGO_OFFSET UNITYSDK_OFFSET(0x9522D50)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERMONOPLUGIN_GET_IFSHOWALLDIALOG_OFFSET UNITYSDK_OFFSET(0x9522D70)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERMONOPLUGIN_GET_RENDERBUDGETDATA_OFFSET UNITYSDK_OFFSET(0x9522F70)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERMONOPLUGIN_GET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x951EBE0)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERMONOPLUGIN_METHOD_7_F0088C88851A7DFB_1_OFFSET UNITYSDK_OFFSET(0x9522D40)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERMONOPLUGIN_METHOD_7_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x9522D30)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERMONOPLUGIN_SET_AUDIOPLAYERGO_OFFSET UNITYSDK_OFFSET(0x9522D60)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERMONOPLUGIN_SET_IFSHOWALLDIALOG_OFFSET UNITYSDK_OFFSET(0x9522D80)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERMONOPLUGIN_STARTPLAY_OFFSET UNITYSDK_OFFSET(0x9522D90)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERMONOPLUGIN_STOPPLAY_OFFSET UNITYSDK_OFFSET(0x9522E40)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERMONOPLUGIN__CCTOR_OFFSET UNITYSDK_OFFSET(0x9523260)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x9523170)

namespace RPG::Client
{
	inline static constexpr unsigned int DynamicPatternEmitterMonoPlugin_TypeDefinitionIndex = 58070;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(DynamicPatternEmitterMonoPlugin_TypeDefinitionIndex)->GetStaticField(0x45990);
		}
