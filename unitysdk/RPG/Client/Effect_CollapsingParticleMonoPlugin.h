...
#define RPG_CLIENT_EFFECT_COLLAPSINGPARTICLEMONOPLUGIN_METHOD_7_28EB11670A8E5A86_OFFSET UNITYSDK_OFFSET(0x9540B10)
#define RPG_CLIENT_EFFECT_COLLAPSINGPARTICLEMONOPLUGIN_METHOD_7_2B85C1969225764F_OFFSET UNITYSDK_OFFSET(0x9541430)
#define RPG_CLIENT_EFFECT_COLLAPSINGPARTICLEMONOPLUGIN_METHOD_7_A3EF4ED894EBFFC3_OFFSET UNITYSDK_OFFSET(0x9541370)
#define RPG_CLIENT_EFFECT_COLLAPSINGPARTICLEMONOPLUGIN_METHOD_7_E46A4D7B872282A4_OFFSET UNITYSDK_OFFSET(0x9540D50)
#define RPG_CLIENT_EFFECT_COLLAPSINGPARTICLEMONOPLUGIN_RENDEREREQUALS_OFFSET UNITYSDK_OFFSET(0x9540660)
#define RPG_CLIENT_EFFECT_COLLAPSINGPARTICLEMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x9541720)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_CollapsingParticleMonoPlugin_TypeDefinitionIndex = 57671;
