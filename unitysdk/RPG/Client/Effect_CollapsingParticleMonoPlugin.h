...
#define RPG_CLIENT_EFFECT_COLLAPSINGPARTICLEMONOPLUGIN_METHOD_7_04F02FC65FAA2E0C_OFFSET UNITYSDK_OFFSET(0xB847050)
#define RPG_CLIENT_EFFECT_COLLAPSINGPARTICLEMONOPLUGIN_METHOD_7_0FD0EC313FAAB75A_OFFSET UNITYSDK_OFFSET(0xB8466F0)
#define RPG_CLIENT_EFFECT_COLLAPSINGPARTICLEMONOPLUGIN_METHOD_7_A3EF4ED894EBFFC3_OFFSET UNITYSDK_OFFSET(0xB846F90)
#define RPG_CLIENT_EFFECT_COLLAPSINGPARTICLEMONOPLUGIN_METHOD_7_E46A4D7B872282A4_OFFSET UNITYSDK_OFFSET(0xB8468E0)
#define RPG_CLIENT_EFFECT_COLLAPSINGPARTICLEMONOPLUGIN_RENDEREREQUALS_OFFSET UNITYSDK_OFFSET(0xB846260)
#define RPG_CLIENT_EFFECT_COLLAPSINGPARTICLEMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xB847410)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_CollapsingParticleMonoPlugin_TypeDefinitionIndex = 65861;
