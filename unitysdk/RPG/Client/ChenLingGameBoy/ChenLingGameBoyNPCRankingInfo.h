...
#define RPG_CLIENT_CHENLINGGAMEBOY_CHENLINGGAMEBOYNPCRANKINGINFO_CREATE_OFFSET UNITYSDK_OFFSET(0x1CB1DAB0)
#define RPG_CLIENT_CHENLINGGAMEBOY_CHENLINGGAMEBOYNPCRANKINGINFO_GET_FINISHEDTIME_OFFSET UNITYSDK_OFFSET(0x1CB1DD80)
#define RPG_CLIENT_CHENLINGGAMEBOY_CHENLINGGAMEBOYNPCRANKINGINFO_GET_ID_OFFSET UNITYSDK_OFFSET(0x1CB1DBC0)
#define RPG_CLIENT_CHENLINGGAMEBOY_CHENLINGGAMEBOYNPCRANKINGINFO_GET_IMAGEPATH_OFFSET UNITYSDK_OFFSET(0x1CB1DD30)
#define RPG_CLIENT_CHENLINGGAMEBOY_CHENLINGGAMEBOYNPCRANKINGINFO_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1CB1DC10)
#define RPG_CLIENT_CHENLINGGAMEBOY_CHENLINGGAMEBOYNPCRANKINGINFO_GET_PLAYERTYPE_OFFSET UNITYSDK_OFFSET(0x1CB1DDD0)
#define RPG_CLIENT_CHENLINGGAMEBOY_CHENLINGGAMEBOYNPCRANKINGINFO_GET_SIGNATURE_OFFSET UNITYSDK_OFFSET(0x1CB1DCA0)
#define RPG_CLIENT_CHENLINGGAMEBOY_CHENLINGGAMEBOYNPCRANKINGINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1CB1DB60)
#define RPG_CLIENT_CHENLINGGAMEBOY_CHENLINGGAMEBOYNPCRANKINGINFO__INIT_OFFSET UNITYSDK_OFFSET(0x1CB1DB70)

namespace RPG::Client::ChenLingGameBoy
{
	inline static constexpr unsigned int ChenLingGameBoyNPCRankingInfo_TypeDefinitionIndex = 74661;
