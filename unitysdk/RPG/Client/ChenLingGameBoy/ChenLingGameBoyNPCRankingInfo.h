...
#define RPG_CLIENT_CHENLINGGAMEBOY_CHENLINGGAMEBOYNPCRANKINGINFO_CREATE_OFFSET UNITYSDK_OFFSET(0x9FC4E60)
#define RPG_CLIENT_CHENLINGGAMEBOY_CHENLINGGAMEBOYNPCRANKINGINFO_GET_FINISHEDTIME_OFFSET UNITYSDK_OFFSET(0x9FC50D0)
#define RPG_CLIENT_CHENLINGGAMEBOY_CHENLINGGAMEBOYNPCRANKINGINFO_GET_ID_OFFSET UNITYSDK_OFFSET(0x9FC4F70)
#define RPG_CLIENT_CHENLINGGAMEBOY_CHENLINGGAMEBOYNPCRANKINGINFO_GET_IMAGEPATH_OFFSET UNITYSDK_OFFSET(0x9FC50B0)
#define RPG_CLIENT_CHENLINGGAMEBOY_CHENLINGGAMEBOYNPCRANKINGINFO_GET_NAME_OFFSET UNITYSDK_OFFSET(0x9FC4F90)
#define RPG_CLIENT_CHENLINGGAMEBOY_CHENLINGGAMEBOYNPCRANKINGINFO_GET_PLAYERTYPE_OFFSET UNITYSDK_OFFSET(0x9FC50F0)
#define RPG_CLIENT_CHENLINGGAMEBOY_CHENLINGGAMEBOYNPCRANKINGINFO_GET_SIGNATURE_OFFSET UNITYSDK_OFFSET(0x9FC5020)
#define RPG_CLIENT_CHENLINGGAMEBOY_CHENLINGGAMEBOYNPCRANKINGINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x9FC4F10)
#define RPG_CLIENT_CHENLINGGAMEBOY_CHENLINGGAMEBOYNPCRANKINGINFO__INIT_OFFSET UNITYSDK_OFFSET(0x9FC4F20)

namespace RPG::Client::ChenLingGameBoy
{
	inline static constexpr unsigned int ChenLingGameBoyNPCRankingInfo_TypeDefinitionIndex = 69020;
