...
#define RPG_CLIENT_UIADVENTUREMINIMAP_ICON__CTOR_OFFSET UNITYSDK_OFFSET(0x16FF7EC0)

namespace RPG::Client
{
	inline static constexpr unsigned int UIAdventureMinimap_Icon_TypeDefinitionIndex = 69027;

	class UIAdventureMinimap_Icon : public ::System::Object
	{
	public:
		::UnityEngine::Animation* MappingInfoEffectAnimation; // 0x10
