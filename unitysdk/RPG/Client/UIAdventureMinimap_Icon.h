...
#define RPG_CLIENT_UIADVENTUREMINIMAP_ICON__CTOR_OFFSET UNITYSDK_OFFSET(0x1700A5F0)

namespace RPG::Client
{
	inline static constexpr unsigned int UIAdventureMinimap_Icon_TypeDefinitionIndex = 65988;

	class UIAdventureMinimap_Icon : public ::System::Object
	{
	public:
		::RPG::Client::UIAdventureMinimap_IconLayerInfo* IconLayer; // 0x10
		::UnityEngine::Animation* MissionEffectAnimation; // 0x18
