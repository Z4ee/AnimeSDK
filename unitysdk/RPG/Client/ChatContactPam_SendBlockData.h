...
#define RPG_CLIENT_CHATCONTACTPAM_SENDBLOCKDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB597EC0)

namespace RPG::Client
{
	inline static constexpr unsigned int ChatContactPam_SendBlockData_TypeDefinitionIndex = 59160;
