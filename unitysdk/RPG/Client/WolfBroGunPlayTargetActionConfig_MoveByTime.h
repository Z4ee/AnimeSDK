...
#define RPG_CLIENT_WOLFBROGUNPLAYTARGETACTIONCONFIG_MOVEBYTIME_METHOD_2_47FCE72550F759BF_OFFSET UNITYSDK_OFFSET(0x17427FE0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGETACTIONCONFIG_MOVEBYTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x17428060)

namespace RPG::Client
{
	inline static constexpr unsigned int WolfBroGunPlayTargetActionConfig_MoveByTime_TypeDefinitionIndex = 65638;
