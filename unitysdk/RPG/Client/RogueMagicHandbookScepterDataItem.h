...
#define RPG_CLIENT_ROGUEMAGICHANDBOOKSCEPTERDATAITEM_GET_BIGICONPATH_OFFSET UNITYSDK_OFFSET(0xB056EC0)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKSCEPTERDATAITEM_GET_DISPLAYDATAITEM_OFFSET UNITYSDK_OFFSET(0xB057760)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKSCEPTERDATAITEM_GET_FUNCTYPE_OFFSET UNITYSDK_OFFSET(0xB0576A0)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKSCEPTERDATAITEM_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xB056D90)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKSCEPTERDATAITEM_GET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0xB057770)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKSCEPTERDATAITEM_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0xB056BE0)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKSCEPTERDATAITEM_GET_LOCKEDUNITEFFECT_OFFSET UNITYSDK_OFFSET(0xB0571C0)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKSCEPTERDATAITEM_GET_LOCKEDUNITEXTRAEFFECTS_OFFSET UNITYSDK_OFFSET(0xB0573D0)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKSCEPTERDATAITEM_GET_NAME_OFFSET UNITYSDK_OFFSET(0xB056C00)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKSCEPTERDATAITEM_GET_SCEPTERID_OFFSET UNITYSDK_OFFSET(0xB056BC0)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKSCEPTERDATAITEM_GET_STYLETYPE_OFFSET UNITYSDK_OFFSET(0xB0575E0)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKSCEPTERDATAITEM_GET_TRIGGERCOND_OFFSET UNITYSDK_OFFSET(0xB056FF0)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKSCEPTERDATAITEM_SET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0xB057780)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKSCEPTERDATAITEM_SYNCISUNLOCKED_OFFSET UNITYSDK_OFFSET(0xB055590)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKSCEPTERDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xB055110)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueMagicHandbookScepterDataItem_TypeDefinitionIndex = 62106;
