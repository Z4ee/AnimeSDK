...
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GETOPTIONDATAITEM_OFFSET UNITYSDK_OFFSET(0xC1695B0)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GET_CANSKIP_OFFSET UNITYSDK_OFFSET(0xC169770)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GET_CONTENT_OFFSET UNITYSDK_OFFSET(0xC1699A0)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GET_DICENUM_OFFSET UNITYSDK_OFFSET(0xC169820)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GET_ID_OFFSET UNITYSDK_OFFSET(0xC1696B0)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GET_ISDATAREPORT_OFFSET UNITYSDK_OFFSET(0xC169B30)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GET_ISEVENTTRIGGERED_OFFSET UNITYSDK_OFFSET(0xC169CB0)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GET_ISSPECIAL_OFFSET UNITYSDK_OFFSET(0xC169BE0)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GET_ISTRIGGERCOUNTED_OFFSET UNITYSDK_OFFSET(0xC169CD0)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GET_OPTIONLIST_OFFSET UNITYSDK_OFFSET(0xC169C90)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GET_PICTUREPATH_OFFSET UNITYSDK_OFFSET(0xC169A80)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GET_TITLE_OFFSET UNITYSDK_OFFSET(0xC1698C0)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xC1696D0)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GET__ROW_OFFSET UNITYSDK_OFFSET(0xC1694F0)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_SETEVENTTRIGGERED_OFFSET UNITYSDK_OFFSET(0xC169560)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_SET_ID_OFFSET UNITYSDK_OFFSET(0xC1696C0)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_SET_ISEVENTTRIGGERED_OFFSET UNITYSDK_OFFSET(0xC169CC0)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_SET_OPTIONLIST_OFFSET UNITYSDK_OFFSET(0xC169CA0)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xC1692C0)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM__INITOPTIONS_OFFSET UNITYSDK_OFFSET(0xC1692D0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonopolyEventDataItem_TypeDefinitionIndex = 61939;
