...
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GETOPTIONDATAITEM_OFFSET UNITYSDK_OFFSET(0x1A3708C0)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GET_CANSKIP_OFFSET UNITYSDK_OFFSET(0x1A370A80)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GET_CONTENT_OFFSET UNITYSDK_OFFSET(0x1A370CB0)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GET_DICENUM_OFFSET UNITYSDK_OFFSET(0x1A370B30)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GET_ID_OFFSET UNITYSDK_OFFSET(0x1A3709C0)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GET_ISDATAREPORT_OFFSET UNITYSDK_OFFSET(0x1A370E40)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GET_ISEVENTTRIGGERED_OFFSET UNITYSDK_OFFSET(0x1A370FC0)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GET_ISSPECIAL_OFFSET UNITYSDK_OFFSET(0x1A370EF0)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GET_ISTRIGGERCOUNTED_OFFSET UNITYSDK_OFFSET(0x1A370FE0)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GET_OPTIONLIST_OFFSET UNITYSDK_OFFSET(0x1A370FA0)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GET_PICTUREPATH_OFFSET UNITYSDK_OFFSET(0x1A370D90)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GET_TITLE_OFFSET UNITYSDK_OFFSET(0x1A370BD0)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1A3709E0)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GET__ROW_OFFSET UNITYSDK_OFFSET(0x1A370800)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_SETEVENTTRIGGERED_OFFSET UNITYSDK_OFFSET(0x1A370870)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_SET_ID_OFFSET UNITYSDK_OFFSET(0x1A3709D0)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_SET_ISEVENTTRIGGERED_OFFSET UNITYSDK_OFFSET(0x1A370FD0)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_SET_OPTIONLIST_OFFSET UNITYSDK_OFFSET(0x1A370FB0)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3705D0)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM__INITOPTIONS_OFFSET UNITYSDK_OFFSET(0x1A3705E0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonopolyEventDataItem_TypeDefinitionIndex = 63304;
