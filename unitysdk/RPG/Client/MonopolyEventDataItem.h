...
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GETOPTIONDATAITEM_OFFSET UNITYSDK_OFFSET(0xAA9CD40)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GET_CANSKIP_OFFSET UNITYSDK_OFFSET(0xAA9CEE0)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GET_CONTENT_OFFSET UNITYSDK_OFFSET(0xAA9D100)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GET_DICENUM_OFFSET UNITYSDK_OFFSET(0xAA9CF90)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GET_ID_OFFSET UNITYSDK_OFFSET(0xAA9CE20)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GET_ISDATAREPORT_OFFSET UNITYSDK_OFFSET(0xAA9D280)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GET_ISEVENTTRIGGERED_OFFSET UNITYSDK_OFFSET(0xAA9D400)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GET_ISSPECIAL_OFFSET UNITYSDK_OFFSET(0xAA9D330)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GET_ISTRIGGERCOUNTED_OFFSET UNITYSDK_OFFSET(0xAA9D420)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GET_OPTIONLIST_OFFSET UNITYSDK_OFFSET(0xAA9D3E0)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GET_PICTUREPATH_OFFSET UNITYSDK_OFFSET(0xAA9D1D0)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GET_TITLE_OFFSET UNITYSDK_OFFSET(0xAA9D030)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xAA9CE40)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_GET__ROW_OFFSET UNITYSDK_OFFSET(0xAA9CC80)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_SETEVENTTRIGGERED_OFFSET UNITYSDK_OFFSET(0xAA9CCF0)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_SET_ID_OFFSET UNITYSDK_OFFSET(0xAA9CE30)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_SET_ISEVENTTRIGGERED_OFFSET UNITYSDK_OFFSET(0xAA9D410)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM_SET_OPTIONLIST_OFFSET UNITYSDK_OFFSET(0xAA9D3F0)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xAA9CA90)
#define RPG_CLIENT_MONOPOLYEVENTDATAITEM__INITOPTIONS_OFFSET UNITYSDK_OFFSET(0xAA9CAA0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonopolyEventDataItem_TypeDefinitionIndex = 61005;
