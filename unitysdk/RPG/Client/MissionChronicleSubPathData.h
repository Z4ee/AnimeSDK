...
#define RPG_CLIENT_MISSIONCHRONICLESUBPATHDATA_CHECKISCANTAKEMISSION_OFFSET UNITYSDK_OFFSET(0x1696AE10)
#define RPG_CLIENT_MISSIONCHRONICLESUBPATHDATA_CHECKISMIDDLEMISSIONSTATE_OFFSET UNITYSDK_OFFSET(0x16975880)
#define RPG_CLIENT_MISSIONCHRONICLESUBPATHDATA_CHECKISPREDICTION_OFFSET UNITYSDK_OFFSET(0x16975530)
#define RPG_CLIENT_MISSIONCHRONICLESUBPATHDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x169745E0)
#define RPG_CLIENT_MISSIONCHRONICLESUBPATHDATA_GETCURPROCESSINGMISSIONDATA_OFFSET UNITYSDK_OFFSET(0x16974CB0)
#define RPG_CLIENT_MISSIONCHRONICLESUBPATHDATA_GETSTORYLINEID_OFFSET UNITYSDK_OFFSET(0x16975B40)
#define RPG_CLIENT_MISSIONCHRONICLESUBPATHDATA_GET_BELONGMAINPATHDATA_OFFSET UNITYSDK_OFFSET(0x16974880)
#define RPG_CLIENT_MISSIONCHRONICLESUBPATHDATA_GET_BELONGMAINPATHID_OFFSET UNITYSDK_OFFSET(0x16975EB0)
#define RPG_CLIENT_MISSIONCHRONICLESUBPATHDATA_GET_CONNECTIONLIST_OFFSET UNITYSDK_OFFSET(0x16976050)
#define RPG_CLIENT_MISSIONCHRONICLESUBPATHDATA_GET_CUSTOMUNLOCKCONDITIONCONFIGLIST_OFFSET UNITYSDK_OFFSET(0x16975F90)
#define RPG_CLIENT_MISSIONCHRONICLESUBPATHDATA_GET_EARLYACCESSCONTENTID_OFFSET UNITYSDK_OFFSET(0x169760B0)
#define RPG_CLIENT_MISSIONCHRONICLESUBPATHDATA_GET_EARLYACCESSCONTENT_OFFSET UNITYSDK_OFFSET(0x16976160)
#define RPG_CLIENT_MISSIONCHRONICLESUBPATHDATA_GET_ISSHOWBYFINISHCONTENT_OFFSET UNITYSDK_OFFSET(0x16976240)
#define RPG_CLIENT_MISSIONCHRONICLESUBPATHDATA_GET_LASTMISSIONID_OFFSET UNITYSDK_OFFSET(0x16975E90)
#define RPG_CLIENT_MISSIONCHRONICLESUBPATHDATA_GET_MAINMISSIONID_OFFSET UNITYSDK_OFFSET(0x16975ED0)
#define RPG_CLIENT_MISSIONCHRONICLESUBPATHDATA_GET_PARENTLINETYPESUBPATHDATA_OFFSET UNITYSDK_OFFSET(0x16976090)
#define RPG_CLIENT_MISSIONCHRONICLESUBPATHDATA_GET_PARENTSUBPATHLIST_OFFSET UNITYSDK_OFFSET(0x16976070)
#define RPG_CLIENT_MISSIONCHRONICLESUBPATHDATA_INIT_OFFSET UNITYSDK_OFFSET(0x16974660)
#define RPG_CLIENT_MISSIONCHRONICLESUBPATHDATA_ISANYPARENTPATHFINISH_OFFSET UNITYSDK_OFFSET(0x16975590)
#define RPG_CLIENT_MISSIONCHRONICLESUBPATHDATA_ISANYPARENTPATHPROCESSINGFINISH_OFFSET UNITYSDK_OFFSET(0x169756F0)
#define RPG_CLIENT_MISSIONCHRONICLESUBPATHDATA_ISCANSTEPNEXTPATH_OFFSET UNITYSDK_OFFSET(0x1696AE60)
#define RPG_CLIENT_MISSIONCHRONICLESUBPATHDATA_ISCONNECTMISSIONFINISH_OFFSET UNITYSDK_OFFSET(0x16974B10)
#define RPG_CLIENT_MISSIONCHRONICLESUBPATHDATA_ISNEWLEGAL_OFFSET UNITYSDK_OFFSET(0x1696F0B0)
#define RPG_CLIENT_MISSIONCHRONICLESUBPATHDATA_ISNEW_OFFSET UNITYSDK_OFFSET(0x169743D0)
#define RPG_CLIENT_MISSIONCHRONICLESUBPATHDATA_ISWORLDUNLOCK_OFFSET UNITYSDK_OFFSET(0x16975E50)
#define RPG_CLIENT_MISSIONCHRONICLESUBPATHDATA_REFRESHEARLYACCESSINFO_OFFSET UNITYSDK_OFFSET(0x16969A20)
#define RPG_CLIENT_MISSIONCHRONICLESUBPATHDATA_SETDATA_OFFSET UNITYSDK_OFFSET(0x1696A8E0)
#define RPG_CLIENT_MISSIONCHRONICLESUBPATHDATA_SETSEEN_OFFSET UNITYSDK_OFFSET(0x16975070)
#define RPG_CLIENT_MISSIONCHRONICLESUBPATHDATA_SET_BELONGMAINPATHID_OFFSET UNITYSDK_OFFSET(0x16975EC0)
#define RPG_CLIENT_MISSIONCHRONICLESUBPATHDATA_SET_CONNECTIONLIST_OFFSET UNITYSDK_OFFSET(0x16976060)
#define RPG_CLIENT_MISSIONCHRONICLESUBPATHDATA_SET_LASTMISSIONID_OFFSET UNITYSDK_OFFSET(0x16975EA0)
#define RPG_CLIENT_MISSIONCHRONICLESUBPATHDATA_SET_PARENTLINETYPESUBPATHDATA_OFFSET UNITYSDK_OFFSET(0x169760A0)
#define RPG_CLIENT_MISSIONCHRONICLESUBPATHDATA_SET_PARENTSUBPATHLIST_OFFSET UNITYSDK_OFFSET(0x16976080)
#define RPG_CLIENT_MISSIONCHRONICLESUBPATHDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1696A850)
#define RPG_CLIENT_MISSIONCHRONICLESUBPATHDATA__GETCURCHRONICLESTATUSBYSELF_OFFSET UNITYSDK_OFFSET(0x16975CA0)
#define RPG_CLIENT_MISSIONCHRONICLESUBPATHDATA__GETCURCHRONICLESTATUS_OFFSET UNITYSDK_OFFSET(0x16974970)
#define RPG_CLIENT_MISSIONCHRONICLESUBPATHDATA__GETSTORYLINEID_OFFSET UNITYSDK_OFFSET(0x16975BA0)
#define RPG_CLIENT_MISSIONCHRONICLESUBPATHDATA__SETUPCONNECTIONLIST_OFFSET UNITYSDK_OFFSET(0x169746A0)
