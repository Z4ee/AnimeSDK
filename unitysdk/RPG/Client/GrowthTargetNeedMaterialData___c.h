...
#define RPG_CLIENT_GROWTHTARGETNEEDMATERIALDATA___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A0421C0)
#define RPG_CLIENT_GROWTHTARGETNEEDMATERIALDATA___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1A042200)
#define RPG_CLIENT_GROWTHTARGETNEEDMATERIALDATA___C___ENSURECOMPOSEMATERIALMAP_B__8_0_OFFSET UNITYSDK_OFFSET(0x1A042210)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Func_2<::RPG::GameCore::ItemConfig*, ::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(GrowthTargetNeedMaterialData___c_TypeDefinitionIndex)->GetStaticField(0x54AF0);
		}
		static ::RPG::Client::GrowthTargetNeedMaterialData___c** StaticGet___9()
		{
			return (::RPG::Client::GrowthTargetNeedMaterialData___c**)Il2CppClass::FromTypeDefinitionIndex(GrowthTargetNeedMaterialData___c_TypeDefinitionIndex)->GetStaticField(0x54AF8);
		}
