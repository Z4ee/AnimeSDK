...
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0x19EC4480)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEVIEWMODEL_GET_ENEMYEQUIPOVERVIEWVM_OFFSET UNITYSDK_OFFSET(0x19EC4980)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEVIEWMODEL_GET_ENEMYPLANESTATUSVM_OFFSET UNITYSDK_OFFSET(0x19EC4940)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEVIEWMODEL_GET_EXITCOMMAND_OFFSET UNITYSDK_OFFSET(0x19EC4900)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEVIEWMODEL_GET_PLAYEREQUIPOVERVIEWVM_OFFSET UNITYSDK_OFFSET(0x19EC4960)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEVIEWMODEL_GET_PLAYERPLANESTATUSVM_OFFSET UNITYSDK_OFFSET(0x19EC4920)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEVIEWMODEL_SET_ENEMYEQUIPOVERVIEWVM_OFFSET UNITYSDK_OFFSET(0x19EC4990)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEVIEWMODEL_SET_ENEMYPLANESTATUSVM_OFFSET UNITYSDK_OFFSET(0x19EC4950)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEVIEWMODEL_SET_EXITCOMMAND_OFFSET UNITYSDK_OFFSET(0x19EC4910)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEVIEWMODEL_SET_PLAYEREQUIPOVERVIEWVM_OFFSET UNITYSDK_OFFSET(0x19EC4970)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEVIEWMODEL_SET_PLAYERPLANESTATUSVM_OFFSET UNITYSDK_OFFSET(0x19EC4930)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x19EC4540)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEVIEWMODEL__INIT_OFFSET UNITYSDK_OFFSET(0x19EC4560)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEVIEWMODEL__ONEXIT_OFFSET UNITYSDK_OFFSET(0x19EC47F0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirBattleViewModel_TypeDefinitionIndex = 75231;

	class PixAirBattleViewModel : public ::Sofa::BaseViewModel
	{
	public:
		::RPG::Client::PixAir::PixAirEquipOverviewViewModel* _PlayerEquipOverviewVM_k__BackingField; // 0x20
		::RPG::Client::PixAir::PixAirPlaneStatusViewModel* _PlayerPlaneStatusVM_k__BackingField; // 0x28
		::RPG::Client::PixAir::PixAirPlaneStatusViewModel* _EnemyPlaneStatusVM_k__BackingField; // 0x30
		::Class_1_5F4D64A4B97E38F9* _UIMessenger; // 0x38
		::Sofa::Core::SimpleCommand* _ExitCommand_k__BackingField; // 0x40
