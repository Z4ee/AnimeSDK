...
#define RPG_CLIENT_PIXAIR_PIXAIRNODEDATA_GET_NODEID_OFFSET UNITYSDK_OFFSET(0x1A0D6950)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEDATA_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1A0C26A0)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0x1A0D6970)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEDATA_SET_NODEID_OFFSET UNITYSDK_OFFSET(0x1A0D6960)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEDATA_TRYCREATE_OFFSET UNITYSDK_OFFSET(0x1A0D69D0)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0D6A60)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirNodeData_TypeDefinitionIndex = 75333;
