...
#define RPG_CLIENT_PIXAIR_PIXAIRNODEDATA_GET_NODEID_OFFSET UNITYSDK_OFFSET(0xC3E0DE0)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEDATA_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0xC3E0E60)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xC3E0E00)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEDATA_SET_NODEID_OFFSET UNITYSDK_OFFSET(0xC3E0DF0)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEDATA_TRYCREATE_OFFSET UNITYSDK_OFFSET(0xC3E0ED0)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC3E0F60)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirNodeData_TypeDefinitionIndex = 73684;
