...
#define RPG_CLIENT_PIXAIR_PIXAIRNODEDATA_GET_NODEID_OFFSET UNITYSDK_OFFSET(0x1BD0D9F0)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEDATA_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x1BCF95F0)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0x1BD0DA10)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEDATA_SET_NODEID_OFFSET UNITYSDK_OFFSET(0x1BD0DA00)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEDATA_TRYCREATE_OFFSET UNITYSDK_OFFSET(0x1BD0DA70)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD0DB00)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirNodeData_TypeDefinitionIndex = 78880;
