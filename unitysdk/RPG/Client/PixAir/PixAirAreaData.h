...
#define RPG_CLIENT_PIXAIR_PIXAIRAREADATA_GET_AREAID_OFFSET UNITYSDK_OFFSET(0x1C82B6D0)
#define RPG_CLIENT_PIXAIR_PIXAIRAREADATA_GET_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0x1C82B7F0)
#define RPG_CLIENT_PIXAIR_PIXAIRAREADATA_GET_NODEIDLIST_OFFSET UNITYSDK_OFFSET(0x1C82B750)
#define RPG_CLIENT_PIXAIR_PIXAIRAREADATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0x1C82B6F0)
#define RPG_CLIENT_PIXAIR_PIXAIRAREADATA_SET_AREAID_OFFSET UNITYSDK_OFFSET(0x1C82B6E0)
#define RPG_CLIENT_PIXAIR_PIXAIRAREADATA_SET_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0x1C82B800)
#define RPG_CLIENT_PIXAIR_PIXAIRAREADATA_TRYCREATE_OFFSET UNITYSDK_OFFSET(0x1C82B810)
#define RPG_CLIENT_PIXAIR_PIXAIRAREADATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1C82B8A0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirAreaData_TypeDefinitionIndex = 78817;
