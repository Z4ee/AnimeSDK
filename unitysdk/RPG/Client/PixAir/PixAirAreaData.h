...
#define RPG_CLIENT_PIXAIR_PIXAIRAREADATA_GET_AREAID_OFFSET UNITYSDK_OFFSET(0xDAE5760)
#define RPG_CLIENT_PIXAIR_PIXAIRAREADATA_GET_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0xDAE5880)
#define RPG_CLIENT_PIXAIR_PIXAIRAREADATA_GET_NODEIDLIST_OFFSET UNITYSDK_OFFSET(0xDAE57E0)
#define RPG_CLIENT_PIXAIR_PIXAIRAREADATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xDAE5780)
#define RPG_CLIENT_PIXAIR_PIXAIRAREADATA_SET_AREAID_OFFSET UNITYSDK_OFFSET(0xDAE5770)
#define RPG_CLIENT_PIXAIR_PIXAIRAREADATA_SET_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0xDAE5890)
#define RPG_CLIENT_PIXAIR_PIXAIRAREADATA_TRYCREATE_OFFSET UNITYSDK_OFFSET(0xDAE58A0)
#define RPG_CLIENT_PIXAIR_PIXAIRAREADATA__CTOR_OFFSET UNITYSDK_OFFSET(0xDAE5930)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirAreaData_TypeDefinitionIndex = 78818;
