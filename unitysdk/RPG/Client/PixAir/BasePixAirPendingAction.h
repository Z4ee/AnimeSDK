...
#define RPG_CLIENT_PIXAIR_BASEPIXAIRPENDINGACTION_FINISH_OFFSET UNITYSDK_OFFSET(0xC3AD370)
#define RPG_CLIENT_PIXAIR_BASEPIXAIRPENDINGACTION_GETACTIONID_OFFSET UNITYSDK_OFFSET(0xC3AD2B0)
#define RPG_CLIENT_PIXAIR_BASEPIXAIRPENDINGACTION_GETCONTENTKEY_OFFSET UNITYSDK_OFFSET(0xC3AD3C0)
#define RPG_CLIENT_PIXAIR_BASEPIXAIRPENDINGACTION_GETISFINISHED_OFFSET UNITYSDK_OFFSET(0xC3AD2F0)
#define RPG_CLIENT_PIXAIR_BASEPIXAIRPENDINGACTION_START_OFFSET UNITYSDK_OFFSET(0xC3AD330)
#define RPG_CLIENT_PIXAIR_BASEPIXAIRPENDINGACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xC3AD2A0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int BasePixAirPendingAction_TypeDefinitionIndex = 73603;
