...
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC3C48B0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC3C4940)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC3C3DE0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC3C3580)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC3C49D0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC3C4970)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEquipItemControl_TypeDefinitionIndex = 73551;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET))(this);
		}

		::System::Void __iFixBaseProxy__OnBindViewModel()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET))(this);
		}
	};
}
