...
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEPREPAREVIEWMODEL_GET_BTNSHOWEQUIPASSEMBLE_OFFSET UNITYSDK_OFFSET(0x1C84A410)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEPREPAREVIEWMODEL_SET_BTNSHOWEQUIPASSEMBLE_OFFSET UNITYSDK_OFFSET(0x1C84A420)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEPREPAREVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C84A300)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEPREPAREVIEWMODEL___CTOR_B__0_0_OFFSET UNITYSDK_OFFSET(0x1C84A430)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirGamePrepareViewModel_TypeDefinitionIndex = 78774;
	...
	public:
		...
		::Class_1_47EB23CB5C4B2615_42* _WindowService; // 0x40
		::RPG::Client::PixAir::PixAirBattleEquipsViewModel* BattleEquipsViewModel; // 0x48
		::Sofa::Core::SimpleCommand* _BtnShowEquipAssemble_k__BackingField; // 0x50
