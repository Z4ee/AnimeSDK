...
#define RPG_CLIENT_PIXAIR_PIXAIRTALENTINFO_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1A0E16B0)
#define RPG_CLIENT_PIXAIR_PIXAIRTALENTINFO_GETALLTALENTDATA_OFFSET UNITYSDK_OFFSET(0x1A0E1740)
#define RPG_CLIENT_PIXAIR_PIXAIRTALENTINFO_GETTALENTDATA_OFFSET UNITYSDK_OFFSET(0x1A0E1530)
#define RPG_CLIENT_PIXAIR_PIXAIRTALENTINFO_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1A0E14E0)
#define RPG_CLIENT_PIXAIR_PIXAIRTALENTINFO_INIT_OFFSET UNITYSDK_OFFSET(0x1A0E1870)
#define RPG_CLIENT_PIXAIR_PIXAIRTALENTINFO_TRYGETTALENTDATA_OFFSET UNITYSDK_OFFSET(0x1A0E15E0)
#define RPG_CLIENT_PIXAIR_PIXAIRTALENTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0E1940)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirTalentInfo_TypeDefinitionIndex = 75351;
