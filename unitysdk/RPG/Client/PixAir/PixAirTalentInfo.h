...
#define RPG_CLIENT_PIXAIR_PIXAIRTALENTINFO_CONTAINS_OFFSET UNITYSDK_OFFSET(0xC3EC5C0)
#define RPG_CLIENT_PIXAIR_PIXAIRTALENTINFO_GETALLTALENTDATA_OFFSET UNITYSDK_OFFSET(0xC3EC650)
#define RPG_CLIENT_PIXAIR_PIXAIRTALENTINFO_GETTALENTDATA_OFFSET UNITYSDK_OFFSET(0xC3EC440)
#define RPG_CLIENT_PIXAIR_PIXAIRTALENTINFO_GET_COUNT_OFFSET UNITYSDK_OFFSET(0xC3EC3F0)
#define RPG_CLIENT_PIXAIR_PIXAIRTALENTINFO_INIT_OFFSET UNITYSDK_OFFSET(0xC3EC780)
#define RPG_CLIENT_PIXAIR_PIXAIRTALENTINFO_TRYGETTALENTDATA_OFFSET UNITYSDK_OFFSET(0xC3EC4F0)
#define RPG_CLIENT_PIXAIR_PIXAIRTALENTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xC3EC850)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirTalentInfo_TypeDefinitionIndex = 73702;
