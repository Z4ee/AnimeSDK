...
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_BUILDBAGEQUIPMENTINFOLIST_OFFSET UNITYSDK_OFFSET(0x1BCF9740)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_BUILDBATTLEREPORTINFO_OFFSET UNITYSDK_OFFSET(0x1BCF9690)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_BUILDEQUIPPEDEQUIPMENTINFOLIST_OFFSET UNITYSDK_OFFSET(0x1BCF9CA0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_BUILDPLANEREPORTINFO_OFFSET UNITYSDK_OFFSET(0x1BCF9300)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_BUILDSTAGEREPORTINFO_OFFSET UNITYSDK_OFFSET(0x1BCF9470)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_CHECKBASICCOSTENOUGH_OFFSET UNITYSDK_OFFSET(0x1BCFDF90)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_CHECKEQUIPCANLEVELUP_OFFSET UNITYSDK_OFFSET(0x1BCFD830)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_CHECKPENDINGACTIONCANLEVELUP_OFFSET UNITYSDK_OFFSET(0x1BCFD9E0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_CREATE_OFFSET UNITYSDK_OFFSET(0x1BCFAE00)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_DEQUEUEACTION_OFFSET UNITYSDK_OFFSET(0x1BCFA530)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1BCFFBC0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_ENQUEUEACTION_OFFSET UNITYSDK_OFFSET(0x1BCFA3A0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GENERATEBROADCASTTEXT_OFFSET UNITYSDK_OFFSET(0x1BCFEEE0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GETEQUIPINSTANCEBYUID_OFFSET UNITYSDK_OFFSET(0x1BCFC310)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GETSLOTTYPEBYSERVERINDEX_OFFSET UNITYSDK_OFFSET(0x1BCFD7D0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_ALIVEPLAYERCOUNT_OFFSET UNITYSDK_OFFSET(0x1BCFA150)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_AREACOUNT_OFFSET UNITYSDK_OFFSET(0x1BCFA020)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_BAG_OFFSET UNITYSDK_OFFSET(0x1BCFA290)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_COREEQUIPID_OFFSET UNITYSDK_OFFSET(0x1BCFA2B0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_CURRECOMMENDDATA_OFFSET UNITYSDK_OFFSET(0x1BCFA2D0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_CURRENCY_OFFSET UNITYSDK_OFFSET(0x1BCFA8B0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_CURRENTAREAINDEX_OFFSET UNITYSDK_OFFSET(0x1BCF9F00)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_CURRENTAREA_OFFSET UNITYSDK_OFFSET(0x1BCF9EE0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_CURRENTNODE_OFFSET UNITYSDK_OFFSET(0x1BCF9590)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_CURRENTSTAGE_OFFSET UNITYSDK_OFFSET(0x1BCF9EC0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_EQUIPBAR_OFFSET UNITYSDK_OFFSET(0x1BCFA270)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_LASTALIVEPLAYERCOUNT_OFFSET UNITYSDK_OFFSET(0x1BCFA110)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_LIFE_OFFSET UNITYSDK_OFFSET(0x1BCFA7C0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_LOCKACTIONCHECKER_OFFSET UNITYSDK_OFFSET(0x1BCFA910)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_MAXLIFE_OFFSET UNITYSDK_OFFSET(0x1BCFA7E0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_OLDALIVEPLAYERCOUNT_OFFSET UNITYSDK_OFFSET(0x1BCFA130)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_PENDINGACTIONQUEUE_OFFSET UNITYSDK_OFFSET(0x1BCFA380)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_PENDINGACTION_OFFSET UNITYSDK_OFFSET(0x1BCFA2F0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_PLANE_OFFSET UNITYSDK_OFFSET(0x1BCFA8D0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_SEENEQUIPIDS_OFFSET UNITYSDK_OFFSET(0x1BCFA930)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_SELLANDREFRESHLOCKER_OFFSET UNITYSDK_OFFSET(0x1BCFA8F0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_TOTALPLAYERCOUNT_OFFSET UNITYSDK_OFFSET(0x1BCFA170)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_TRANSNO_OFFSET UNITYSDK_OFFSET(0x1BCF9EA0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_MARKALLBAGEQUIPSEEN_OFFSET UNITYSDK_OFFSET(0x1BCFA9A0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_MARKEQUIPSEEN_OFFSET UNITYSDK_OFFSET(0x1BCFA940)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SET_ALIVEPLAYERCOUNT_OFFSET UNITYSDK_OFFSET(0x1BCFA160)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SET_BAG_OFFSET UNITYSDK_OFFSET(0x1BCFA2A0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SET_COREEQUIPID_OFFSET UNITYSDK_OFFSET(0x1BCFA2C0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SET_CURRECOMMENDDATA_OFFSET UNITYSDK_OFFSET(0x1BCFA2E0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SET_CURRENCY_OFFSET UNITYSDK_OFFSET(0x1BCFA8C0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SET_CURRENTAREA_OFFSET UNITYSDK_OFFSET(0x1BCF9EF0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SET_CURRENTSTAGE_OFFSET UNITYSDK_OFFSET(0x1BCF9ED0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SET_EQUIPBAR_OFFSET UNITYSDK_OFFSET(0x1BCFA280)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SET_LASTALIVEPLAYERCOUNT_OFFSET UNITYSDK_OFFSET(0x1BCFA120)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SET_LIFE_OFFSET UNITYSDK_OFFSET(0x1BCFA7D0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SET_LOCKACTIONCHECKER_OFFSET UNITYSDK_OFFSET(0x1BCFA920)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SET_OLDALIVEPLAYERCOUNT_OFFSET UNITYSDK_OFFSET(0x1BCFA140)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SET_PENDINGACTIONQUEUE_OFFSET UNITYSDK_OFFSET(0x1BCFA390)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SET_PLANE_OFFSET UNITYSDK_OFFSET(0x1BCFA8E0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SET_SELLANDREFRESHLOCKER_OFFSET UNITYSDK_OFFSET(0x1BCFA900)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SET_TRANSNO_OFFSET UNITYSDK_OFFSET(0x1BCF9EB0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SYNCALIVEPLAYERCOUNT_OFFSET UNITYSDK_OFFSET(0x1BCFB600)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SYNCBASICCHANGE_OFFSET UNITYSDK_OFFSET(0x1BCFE5B0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SYNCENTERNEWNODE_OFFSET UNITYSDK_OFFSET(0x1BCFE500)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SYNCEQUIPCHANGE_OFFSET UNITYSDK_OFFSET(0x1BCFBF20)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SYNCEQUIPREMOVE_OFFSET UNITYSDK_OFFSET(0x1BCFD4C0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SYNCSWAPEQUIP_OFFSET UNITYSDK_OFFSET(0x1BCFC800)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SYNC_OFFSET UNITYSDK_OFFSET(0x1BCFB0F0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__ADDNEWEQUIPINSTANCE_OFFSET UNITYSDK_OFFSET(0x1BCFC390)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__BUILDEQUIPMENTREPORTINFO_OFFSET UNITYSDK_OFFSET(0x1BCF9B20)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__CANLEVELUPFROMSHOPACTION_OFFSET UNITYSDK_OFFSET(0x1BCFDDA0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__CHECKBASICINFO_OFFSET UNITYSDK_OFFSET(0x1BCFE0C0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__CHECKPENDINGACTIONCANLEVELUP_G__MATCHLEVELUPSOURCE_111_0_OFFSET UNITYSDK_OFFSET(0x1BCFDD90)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__CREATEEQUIPINSTANCE_OFFSET UNITYSDK_OFFSET(0x1BCFE4A0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCFAF80)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__GETMODULE_OFFSET UNITYSDK_OFFSET(0x1BCFDF00)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__INITBROADCASTCANDIDATES_OFFSET UNITYSDK_OFFSET(0x1BCFB2B0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__INITSEENEQUIPIDS_OFFSET UNITYSDK_OFFSET(0x1BCFAC40)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__LOGALLSLOTINDICES_OFFSET UNITYSDK_OFFSET(0x1BCFCF90)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__MARKALLEQUIPBAREQUIPSEEN_OFFSET UNITYSDK_OFFSET(0x1BCFAC90)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__MARKAUTOEQUIPPEDASSEEN_OFFSET UNITYSDK_OFFSET(0x1BCFC690)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__REPLACESLOTWITHEMPTYBYSERVERPOSITION_OFFSET UNITYSDK_OFFSET(0x1BCFCE60)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__REPLACESLOTWITHEQUIPBYSERVERPOSITION_OFFSET UNITYSDK_OFFSET(0x1BCFCEF0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__SYNCAREA_OFFSET UNITYSDK_OFFSET(0x1BCFB830)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__SYNCBASICINFO_OFFSET UNITYSDK_OFFSET(0x1BCFE9E0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__SYNCBASIC_OFFSET UNITYSDK_OFFSET(0x1BCFB9A0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__SYNCCURRENCY_OFFSET UNITYSDK_OFFSET(0x1BCFEBE0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__SYNCEQUIPINFO_OFFSET UNITYSDK_OFFSET(0x1BCFC490)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__SYNCEQUIPMGR_OFFSET UNITYSDK_OFFSET(0x1BCFBD90)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__SYNCINCOME_OFFSET UNITYSDK_OFFSET(0x1BCFED20)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__SYNCNODE_OFFSET UNITYSDK_OFFSET(0x1BCFB940)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__SYNCPENDINGACTION_OFFSET UNITYSDK_OFFSET(0x1BCFBE70)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__SYNCRECOMMENDDATA_OFFSET UNITYSDK_OFFSET(0x1BCFB580)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__SYNCSTAGE_OFFSET UNITYSDK_OFFSET(0x1BCFB660)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirGameSession_TypeDefinitionIndex = 78868;
	...
	public:
		...
		::System::Collections::Generic::List_1<::Class_1_7291C38274750BA2_6*>* _BroadcastDeadCandidates; // 0x10
		::RPG::Client::PixAir::PixAirLockActionChecker* _LockActionChecker_k__BackingField; // 0x18
		::RPG::Client::PixAir::PixAirRecommendData* _CurRecommendData_k__BackingField; // 0x20
		::RPG::Client::PixAir::PixAirCurrencyData* _Currency_k__BackingField; // 0x28
		::System::String* _TransNo_k__BackingField; // 0x30
		::RPG::Client::PixAir::PixAirStageInstance* _CurrentStage_k__BackingField; // 0x38
		::System::Random* _BroadcastRandom; // 0x40
		::System::Collections::Generic::HashSet_1<::System::UInt32>* _SeenEquipIDs_k__BackingField; // 0x48
		::RPG::Client::PixAir::PixAirAreaInstance* _CurrentArea_k__BackingField; // 0x50
		::RPG::Client::PixAir::PixAirPlaneInstance* _Plane_k__BackingField; // 0x58
		...
		::System::Collections::Generic::Queue_1<::Class_0_16E4307DCC419505_1335*>* _PendingActionQueue_k__BackingField; // 0x80
		::System::Collections::Generic::List_1<::Class_1_7291C38274750BA2_6*>* _BroadcastCandidates; // 0x88
		::System::UInt32 _OldAlivePlayerCount_k__BackingField; // 0x90
