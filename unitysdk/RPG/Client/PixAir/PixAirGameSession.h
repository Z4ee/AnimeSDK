...
class Class_1_7291C38274750BA2_6;
...
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_BUILDBAGEQUIPMENTINFOLIST_OFFSET UNITYSDK_OFFSET(0xDB05AA0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_BUILDBATTLEREPORTINFO_OFFSET UNITYSDK_OFFSET(0xDB059F0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_BUILDEQUIPPEDEQUIPMENTINFOLIST_OFFSET UNITYSDK_OFFSET(0xDB06000)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_BUILDPLANEREPORTINFO_OFFSET UNITYSDK_OFFSET(0xDB05660)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_BUILDSTAGEREPORTINFO_OFFSET UNITYSDK_OFFSET(0xDB057D0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_CHECKBASICCOSTENOUGH_OFFSET UNITYSDK_OFFSET(0xDB0A300)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_CHECKEQUIPCANLEVELUP_OFFSET UNITYSDK_OFFSET(0xDB09BA0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_CHECKPENDINGACTIONCANLEVELUP_OFFSET UNITYSDK_OFFSET(0xDB09D50)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_CREATE_OFFSET UNITYSDK_OFFSET(0xDB07170)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_DEQUEUEACTION_OFFSET UNITYSDK_OFFSET(0xDB06890)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_DISPOSE_OFFSET UNITYSDK_OFFSET(0xDB0BF20)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_ENQUEUEACTION_OFFSET UNITYSDK_OFFSET(0xDB06700)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GENERATEBROADCASTTEXT_OFFSET UNITYSDK_OFFSET(0xDB0B260)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GETEQUIPINSTANCEBYUID_OFFSET UNITYSDK_OFFSET(0xDB08680)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GETSLOTTYPEBYSERVERINDEX_OFFSET UNITYSDK_OFFSET(0xDB09B40)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_ALIVEPLAYERCOUNT_OFFSET UNITYSDK_OFFSET(0xDB064B0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_AREACOUNT_OFFSET UNITYSDK_OFFSET(0xDB06380)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_BAG_OFFSET UNITYSDK_OFFSET(0xDB065F0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_COREEQUIPID_OFFSET UNITYSDK_OFFSET(0xDB06610)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_CURRECOMMENDDATA_OFFSET UNITYSDK_OFFSET(0xDB06630)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_CURRENCY_OFFSET UNITYSDK_OFFSET(0xDB06C10)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_CURRENTAREAINDEX_OFFSET UNITYSDK_OFFSET(0xDB06260)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_CURRENTAREA_OFFSET UNITYSDK_OFFSET(0xDB06240)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_CURRENTNODE_OFFSET UNITYSDK_OFFSET(0xDB058F0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_CURRENTSTAGE_OFFSET UNITYSDK_OFFSET(0xDB06220)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_EQUIPBAR_OFFSET UNITYSDK_OFFSET(0xDB065D0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_LASTALIVEPLAYERCOUNT_OFFSET UNITYSDK_OFFSET(0xDB06470)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_LIFE_OFFSET UNITYSDK_OFFSET(0xDB06B20)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_LOCKACTIONCHECKER_OFFSET UNITYSDK_OFFSET(0xDB06C70)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_MAXLIFE_OFFSET UNITYSDK_OFFSET(0xDB06B40)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_OLDALIVEPLAYERCOUNT_OFFSET UNITYSDK_OFFSET(0xDB06490)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_PENDINGACTIONQUEUE_OFFSET UNITYSDK_OFFSET(0xDB066E0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_PENDINGACTION_OFFSET UNITYSDK_OFFSET(0xDB06650)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_PLANE_OFFSET UNITYSDK_OFFSET(0xDB06C30)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_SEENEQUIPIDS_OFFSET UNITYSDK_OFFSET(0xDB06C90)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_SELLANDREFRESHLOCKER_OFFSET UNITYSDK_OFFSET(0xDB06C50)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_TOTALPLAYERCOUNT_OFFSET UNITYSDK_OFFSET(0xDB064D0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_TRANSNO_OFFSET UNITYSDK_OFFSET(0xDB06200)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_MARKALLBAGEQUIPSEEN_OFFSET UNITYSDK_OFFSET(0xDB06D00)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_MARKEQUIPSEEN_OFFSET UNITYSDK_OFFSET(0xDB06CA0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SET_ALIVEPLAYERCOUNT_OFFSET UNITYSDK_OFFSET(0xDB064C0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SET_BAG_OFFSET UNITYSDK_OFFSET(0xDB06600)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SET_COREEQUIPID_OFFSET UNITYSDK_OFFSET(0xDB06620)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SET_CURRECOMMENDDATA_OFFSET UNITYSDK_OFFSET(0xDB06640)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SET_CURRENCY_OFFSET UNITYSDK_OFFSET(0xDB06C20)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SET_CURRENTAREA_OFFSET UNITYSDK_OFFSET(0xDB06250)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SET_CURRENTSTAGE_OFFSET UNITYSDK_OFFSET(0xDB06230)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SET_EQUIPBAR_OFFSET UNITYSDK_OFFSET(0xDB065E0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SET_LASTALIVEPLAYERCOUNT_OFFSET UNITYSDK_OFFSET(0xDB06480)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SET_LIFE_OFFSET UNITYSDK_OFFSET(0xDB06B30)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SET_LOCKACTIONCHECKER_OFFSET UNITYSDK_OFFSET(0xDB06C80)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SET_OLDALIVEPLAYERCOUNT_OFFSET UNITYSDK_OFFSET(0xDB064A0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SET_PENDINGACTIONQUEUE_OFFSET UNITYSDK_OFFSET(0xDB066F0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SET_PLANE_OFFSET UNITYSDK_OFFSET(0xDB06C40)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SET_SELLANDREFRESHLOCKER_OFFSET UNITYSDK_OFFSET(0xDB06C60)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SET_TRANSNO_OFFSET UNITYSDK_OFFSET(0xDB06210)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SYNCALIVEPLAYERCOUNT_OFFSET UNITYSDK_OFFSET(0xDB07970)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SYNCBASICCHANGE_OFFSET UNITYSDK_OFFSET(0xDB0A920)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SYNCENTERNEWNODE_OFFSET UNITYSDK_OFFSET(0xDB0A870)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SYNCEQUIPCHANGE_OFFSET UNITYSDK_OFFSET(0xDB08290)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SYNCEQUIPREMOVE_OFFSET UNITYSDK_OFFSET(0xDB09830)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SYNCSWAPEQUIP_OFFSET UNITYSDK_OFFSET(0xDB08B70)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SYNC_OFFSET UNITYSDK_OFFSET(0xDB07460)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__ADDNEWEQUIPINSTANCE_OFFSET UNITYSDK_OFFSET(0xDB08700)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__BUILDEQUIPMENTREPORTINFO_OFFSET UNITYSDK_OFFSET(0xDB05E80)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__CANLEVELUPFROMSHOPACTION_OFFSET UNITYSDK_OFFSET(0xDB0A110)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__CHECKBASICINFO_OFFSET UNITYSDK_OFFSET(0xDB0A430)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__CHECKPENDINGACTIONCANLEVELUP_G__MATCHLEVELUPSOURCE_111_0_OFFSET UNITYSDK_OFFSET(0xDB0A100)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__CREATEEQUIPINSTANCE_OFFSET UNITYSDK_OFFSET(0xDB0A810)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__CTOR_OFFSET UNITYSDK_OFFSET(0xDB072F0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__GETMODULE_OFFSET UNITYSDK_OFFSET(0xDB0A270)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__INITBROADCASTCANDIDATES_OFFSET UNITYSDK_OFFSET(0xDB07620)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__INITSEENEQUIPIDS_OFFSET UNITYSDK_OFFSET(0xDB06FB0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__LOGALLSLOTINDICES_OFFSET UNITYSDK_OFFSET(0xDB09300)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__MARKALLEQUIPBAREQUIPSEEN_OFFSET UNITYSDK_OFFSET(0xDB07000)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__MARKAUTOEQUIPPEDASSEEN_OFFSET UNITYSDK_OFFSET(0xDB08A00)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__REPLACESLOTWITHEMPTYBYSERVERPOSITION_OFFSET UNITYSDK_OFFSET(0xDB091D0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__REPLACESLOTWITHEQUIPBYSERVERPOSITION_OFFSET UNITYSDK_OFFSET(0xDB09260)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__SYNCAREA_OFFSET UNITYSDK_OFFSET(0xDB07BA0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__SYNCBASICINFO_OFFSET UNITYSDK_OFFSET(0xDB0AD50)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__SYNCBASIC_OFFSET UNITYSDK_OFFSET(0xDB07D10)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__SYNCCURRENCY_OFFSET UNITYSDK_OFFSET(0xDB0AF60)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__SYNCEQUIPINFO_OFFSET UNITYSDK_OFFSET(0xDB08800)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__SYNCEQUIPMGR_OFFSET UNITYSDK_OFFSET(0xDB08110)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__SYNCINCOME_OFFSET UNITYSDK_OFFSET(0xDB0B0A0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__SYNCNODE_OFFSET UNITYSDK_OFFSET(0xDB07CB0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__SYNCPENDINGACTION_OFFSET UNITYSDK_OFFSET(0xDB081F0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__SYNCRECOMMENDDATA_OFFSET UNITYSDK_OFFSET(0xDB078F0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__SYNCSTAGE_OFFSET UNITYSDK_OFFSET(0xDB079D0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirGameSession_TypeDefinitionIndex = 78869;
	...
	public:
		...
		::System::Random* _BroadcastRandom; // 0x10
		::RPG::Client::PixAir::PixAirRecommendData* _CurRecommendData_k__BackingField; // 0x18
		::RPG::Client::PixAir::PixAirCurrencyData* _Currency_k__BackingField; // 0x20
		::RPG::Client::PixAir::PixAirSellAndRefreshLocker* _SellAndRefreshLocker_k__BackingField; // 0x28
		::RPG::Client::PixAir::PixAirAreaInstance* _CurrentArea_k__BackingField; // 0x30
		::System::Collections::Generic::List_1<::Class_1_7291C38274750BA2_6*>* _BroadcastDeadCandidates; // 0x38
		::System::Collections::Generic::List_1<::Class_1_7291C38274750BA2_6*>* _BroadcastCandidates; // 0x40
		::System::Collections::Generic::Queue_1<::Class_0_16E4307DCC419505_1335*>* _PendingActionQueue_k__BackingField; // 0x48
		::System::String* _TransNo_k__BackingField; // 0x50
		::RPG::Client::PixAir::PixAirStageInstance* _CurrentStage_k__BackingField; // 0x58
		::RPG::Client::PixAir::PixAirLockActionChecker* _LockActionChecker_k__BackingField; // 0x60
		::Class_1_3F6BDFD89C2271F6* _previewService; // 0x68
		::RPG::Client::PixAir::PixAirBag* _Bag_k__BackingField; // 0x70
		::RPG::Client::PixAir::PixAirEquipBar* _EquipBar_k__BackingField; // 0x78
		::System::Collections::Generic::HashSet_1<::System::UInt32>* _SeenEquipIDs_k__BackingField; // 0x80
		::RPG::Client::PixAir::PixAirPlaneInstance* _Plane_k__BackingField; // 0x88
		::System::UInt32 _AlivePlayerCount_k__BackingField; // 0x90
		::System::UInt32 _LastAlivePlayerCount_k__BackingField; // 0x94
		::System::UInt32 _OldAlivePlayerCount_k__BackingField; // 0x98
		::System::Int32 _Life_k__BackingField; // 0x9C
		::System::UInt32 _CoreEquipID_k__BackingField; // 0xA0
		...
		::Class_0_16E4307DCC419505_1335* get_PendingAction()
		{
			return ((::Class_0_16E4307DCC419505_1335*(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_PENDINGACTION_OFFSET))(this);
		}

		::System::Collections::Generic::Queue_1<::Class_0_16E4307DCC419505_1335*>* get_PendingActionQueue()
		{
			return ((::System::Collections::Generic::Queue_1<::Class_0_16E4307DCC419505_1335*>*(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_GET_PENDINGACTIONQUEUE_OFFSET))(this);
		}

		::System::Void set_PendingActionQueue(::System::Collections::Generic::Queue_1<::Class_0_16E4307DCC419505_1335*>* a1)
		{
			return ((::System::Void(*)(::PVOID, ::System::Collections::Generic::Queue_1<::Class_0_16E4307DCC419505_1335*>*))((::PBYTE)hIl2Cpp + RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SET_PENDINGACTIONQUEUE_OFFSET))(this, a1);
		}

		::System::Void EnqueueAction(::Class_0_16E4307DCC419505_1335* a1)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_1335*))((::PBYTE)hIl2Cpp + RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_ENQUEUEACTION_OFFSET))(this, a1);
		}
		...
		::System::Void SyncEquipChange(::Class_1_D40936EF3BF54118_66* a1, ::Enum_3_63CDB6C405C8FD68_1 a2)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_D40936EF3BF54118_66*, ::Enum_3_63CDB6C405C8FD68_1))((::PBYTE)hIl2Cpp + RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SYNCEQUIPCHANGE_OFFSET))(this, a1, a2);
		}

		::System::Void SyncSwapEquip(::System::Collections::Generic::List_1<::Class_1_D17272E82AE804C2_800*>* a1)
		{
			return ((::System::Void(*)(::PVOID, ::System::Collections::Generic::List_1<::Class_1_D17272E82AE804C2_800*>*))((::PBYTE)hIl2Cpp + RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SYNCSWAPEQUIP_OFFSET))(this, a1);
		}
		...
		::System::Void _SyncEquipInfo(::RPG::Client::PixAir::PixAirEquipInstance* a1, ::Class_1_D17272E82AE804C2_797* a2)
		{
			return ((::System::Void(*)(::PVOID, ::RPG::Client::PixAir::PixAirEquipInstance*, ::Class_1_D17272E82AE804C2_797*))((::PBYTE)hIl2Cpp + RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__SYNCEQUIPINFO_OFFSET))(this, a1, a2);
		}
		...
		::RPG::Client::PixAir::PixAirEquipInstance* _AddNewEquipInstance(::Class_1_D17272E82AE804C2_797* a1)
		{
			return ((::RPG::Client::PixAir::PixAirEquipInstance*(*)(::PVOID, ::Class_1_D17272E82AE804C2_797*))((::PBYTE)hIl2Cpp + RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__ADDNEWEQUIPINSTANCE_OFFSET))(this, a1);
		}
		...
		::System::Void SyncBasicChange(::Class_1_4AF9832A6EE2A67F_1* a1, ::Enum_3_63CDB6C405C8FD68_1 a2)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_4AF9832A6EE2A67F_1*, ::Enum_3_63CDB6C405C8FD68_1))((::PBYTE)hIl2Cpp + RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_SYNCBASICCHANGE_OFFSET))(this, a1, a2);
		}

		::System::Void _SyncBasic(::Class_1_FDFA365FE186E8F2_23* a1)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_FDFA365FE186E8F2_23*))((::PBYTE)hIl2Cpp + RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__SYNCBASIC_OFFSET))(this, a1);
		}
		...
		::System::Void _SyncEquipMgr(::Class_1_333B902B2174BECA_4* a1)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_333B902B2174BECA_4*))((::PBYTE)hIl2Cpp + RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__SYNCEQUIPMGR_OFFSET))(this, a1);
		}

		::System::Void _SyncPendingAction(::Class_1_75361B3778CDC46C* a1)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_75361B3778CDC46C*))((::PBYTE)hIl2Cpp + RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__SYNCPENDINGACTION_OFFSET))(this, a1);
		}

		::RPG::Client::PixAir::PixAirEquipInstance* _CreateEquipInstance(::Class_1_D17272E82AE804C2_797* a1)
		{
			return ((::RPG::Client::PixAir::PixAirEquipInstance*(*)(::PVOID, ::Class_1_D17272E82AE804C2_797*))((::PBYTE)hIl2Cpp + RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION__CREATEEQUIPINSTANCE_OFFSET))(this, a1);
		}
