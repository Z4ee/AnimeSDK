...
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEEQUIPSVIEWMODEL_GETEQUIPITEM_OFFSET UNITYSDK_OFFSET(0x19EC3BA0)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEEQUIPSVIEWMODEL_GET_EQUIPITEMSVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x19EC3CA0)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEEQUIPSVIEWMODEL_GET_EQUIPPROPERTYGETTER_OFFSET UNITYSDK_OFFSET(0x19EC3CC0)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEEQUIPSVIEWMODEL_GET_SLOTNUM_OFFSET UNITYSDK_OFFSET(0x19EC3B50)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEEQUIPSVIEWMODEL_SET_EQUIPITEMSVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x19EC3CB0)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEEQUIPSVIEWMODEL_SET_EQUIPPROPERTYGETTER_OFFSET UNITYSDK_OFFSET(0x19EC3CD0)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEEQUIPSVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x19EC3840)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirBattleEquipsViewModel_TypeDefinitionIndex = 75222;

	class PixAirBattleEquipsViewModel : public ::Sofa::BaseViewModel
	{
	public:
		::Class_1_D031E8F06825AB4F* _EquipService; // 0x20
		::Class_1_180378AE565B7C88* _EquipInfo; // 0x28
		::Class_1_AF3961F295BCE491* _EquipPropertyGetter_k__BackingField; // 0x30
		::System::Collections::Generic::List_1<::RPG::Client::PixAir::PixAirEquipItemViewModel*>* _EquipItemsViewModel_k__BackingField; // 0x38

		::System::Void _ctor(::Class_1_180378AE565B7C88* a1, ::Class_1_D031E8F06825AB4F* a2)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_180378AE565B7C88*, ::Class_1_D031E8F06825AB4F*))((::PBYTE)hIl2Cpp + RPG_CLIENT_PIXAIR_PIXAIRBATTLEEQUIPSVIEWMODEL__CTOR_OFFSET))(this, a1, a2);
		}
