...
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEEQUIPSVIEWMODEL_GETEQUIPITEM_OFFSET UNITYSDK_OFFSET(0xDAEC3E0)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEEQUIPSVIEWMODEL_GET_EQUIPITEMSVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xDAEC4E0)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEEQUIPSVIEWMODEL_GET_EQUIPPROPERTYGETTER_OFFSET UNITYSDK_OFFSET(0xDAEC500)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEEQUIPSVIEWMODEL_GET_SLOTNUM_OFFSET UNITYSDK_OFFSET(0xDAEC390)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEEQUIPSVIEWMODEL_SET_EQUIPITEMSVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xDAEC4F0)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEEQUIPSVIEWMODEL_SET_EQUIPPROPERTYGETTER_OFFSET UNITYSDK_OFFSET(0xDAEC510)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEEQUIPSVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xDAEC080)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirBattleEquipsViewModel_TypeDefinitionIndex = 78770;
	...
	public:
		...
		::Class_1_AF3961F295BCE491* _EquipPropertyGetter_k__BackingField; // 0x28
		::Class_1_D031E8F06825AB4F* _EquipService; // 0x30
		::Class_1_C842F7C215AA68E2* _EquipInfo; // 0x38
