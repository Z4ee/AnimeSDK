...
#define RPG_CLIENT_PIXAIR_PIXAIRBAGEQUIPSVIEWMODEL_GETEQUIPITEM_OFFSET UNITYSDK_OFFSET(0xDAEA280)
#define RPG_CLIENT_PIXAIR_PIXAIRBAGEQUIPSVIEWMODEL_GET_EQUIPITEMSVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xDAEA380)
#define RPG_CLIENT_PIXAIR_PIXAIRBAGEQUIPSVIEWMODEL_GET_EQUIPPROPERTYGETTER_OFFSET UNITYSDK_OFFSET(0xDAEA3A0)
#define RPG_CLIENT_PIXAIR_PIXAIRBAGEQUIPSVIEWMODEL_SET_EQUIPITEMSVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xDAEA390)
#define RPG_CLIENT_PIXAIR_PIXAIRBAGEQUIPSVIEWMODEL_SET_EQUIPPROPERTYGETTER_OFFSET UNITYSDK_OFFSET(0xDAEA3B0)
#define RPG_CLIENT_PIXAIR_PIXAIRBAGEQUIPSVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xDAE9D90)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirBagEquipsViewModel_TypeDefinitionIndex = 78768;

	class PixAirBagEquipsViewModel : public ::Sofa::BaseViewModel
	{
	public:
		::Class_1_D031E8F06825AB4F* _EquipService; // 0x20
		::Class_1_0A50C809A68617FA* _EquipPropertyGetter_k__BackingField; // 0x28
