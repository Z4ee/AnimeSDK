...
#define RPG_CLIENT_PIXAIR_PIXAIREVENTOPTIONDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x19EDA310)
#define RPG_CLIENT_PIXAIR_PIXAIREVENTOPTIONDATA_GET_DESCRIBE_OFFSET UNITYSDK_OFFSET(0x19EDA5A0)
#define RPG_CLIENT_PIXAIR_PIXAIREVENTOPTIONDATA_GET_EFFECTDESCRIBE_OFFSET UNITYSDK_OFFSET(0x19EDA5C0)
#define RPG_CLIENT_PIXAIR_PIXAIREVENTOPTIONDATA_GET_EVENTID_OFFSET UNITYSDK_OFFSET(0x19EDA540)
#define RPG_CLIENT_PIXAIR_PIXAIREVENTOPTIONDATA_GET_OPTIONID_OFFSET UNITYSDK_OFFSET(0x19EDA560)
#define RPG_CLIENT_PIXAIR_PIXAIREVENTOPTIONDATA_GET_TRIGGERCONTENTID_OFFSET UNITYSDK_OFFSET(0x19EDA580)
#define RPG_CLIENT_PIXAIR_PIXAIREVENTOPTIONDATA_ISCOSTENOUGH_OFFSET UNITYSDK_OFFSET(0x19EDA480)
#define RPG_CLIENT_PIXAIR_PIXAIREVENTOPTIONDATA_SET_DESCRIBE_OFFSET UNITYSDK_OFFSET(0x19EDA5B0)
#define RPG_CLIENT_PIXAIR_PIXAIREVENTOPTIONDATA_SET_EFFECTDESCRIBE_OFFSET UNITYSDK_OFFSET(0x19EDA5D0)
#define RPG_CLIENT_PIXAIR_PIXAIREVENTOPTIONDATA_SET_EVENTID_OFFSET UNITYSDK_OFFSET(0x19EDA550)
#define RPG_CLIENT_PIXAIR_PIXAIREVENTOPTIONDATA_SET_OPTIONID_OFFSET UNITYSDK_OFFSET(0x19EDA570)
#define RPG_CLIENT_PIXAIR_PIXAIREVENTOPTIONDATA_SET_TRIGGERCONTENTID_OFFSET UNITYSDK_OFFSET(0x19EDA590)
#define RPG_CLIENT_PIXAIR_PIXAIREVENTOPTIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19EDA470)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEventOptionData_TypeDefinitionIndex = 75315;
	...
	public:
		...
		::RPG::Client::TextID _EffectDescribe_k__BackingField; // 0x20
		::System::UInt32 _TriggerContentID_k__BackingField; // 0x30
		::System::UInt32 _EventID_k__BackingField; // 0x34
