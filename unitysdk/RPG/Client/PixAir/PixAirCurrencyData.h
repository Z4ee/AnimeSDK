...
#define RPG_CLIENT_PIXAIR_PIXAIRCURRENCYDATA_CLEARCHANGE_OFFSET UNITYSDK_OFFSET(0x1C834850)
#define RPG_CLIENT_PIXAIR_PIXAIRCURRENCYDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1C834710)
#define RPG_CLIENT_PIXAIR_PIXAIRCURRENCYDATA_GET_CHANGEAMOUNT_OFFSET UNITYSDK_OFFSET(0x1C8346F0)
#define RPG_CLIENT_PIXAIR_PIXAIRCURRENCYDATA_GET_CURRENTAMOUNT_OFFSET UNITYSDK_OFFSET(0x1C8346B0)
#define RPG_CLIENT_PIXAIR_PIXAIRCURRENCYDATA_GET_FIXAMOUNT_OFFSET UNITYSDK_OFFSET(0x1C8346D0)
#define RPG_CLIENT_PIXAIR_PIXAIRCURRENCYDATA_SETFIXAMOUNT_OFFSET UNITYSDK_OFFSET(0x1C834800)
#define RPG_CLIENT_PIXAIR_PIXAIRCURRENCYDATA_SET_CHANGEAMOUNT_OFFSET UNITYSDK_OFFSET(0x1C834700)
#define RPG_CLIENT_PIXAIR_PIXAIRCURRENCYDATA_SET_CURRENTAMOUNT_OFFSET UNITYSDK_OFFSET(0x1C8346C0)
#define RPG_CLIENT_PIXAIR_PIXAIRCURRENCYDATA_SET_FIXAMOUNT_OFFSET UNITYSDK_OFFSET(0x1C8346E0)
#define RPG_CLIENT_PIXAIR_PIXAIRCURRENCYDATA_UPDATEAMOUNT_OFFSET UNITYSDK_OFFSET(0x1C8347B0)
#define RPG_CLIENT_PIXAIR_PIXAIRCURRENCYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1C8347A0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirCurrencyData_TypeDefinitionIndex = 78833;

	class PixAirCurrencyData : public ::System::Object
	{
	public:
		::System::Int32 _ChangeAmount_k__BackingField; // 0x10
