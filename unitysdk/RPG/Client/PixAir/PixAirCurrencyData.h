...
#define RPG_CLIENT_PIXAIR_PIXAIRCURRENCYDATA_CLEARCHANGE_OFFSET UNITYSDK_OFFSET(0xC3B7650)
#define RPG_CLIENT_PIXAIR_PIXAIRCURRENCYDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xC3B7510)
#define RPG_CLIENT_PIXAIR_PIXAIRCURRENCYDATA_GET_CHANGEAMOUNT_OFFSET UNITYSDK_OFFSET(0xC3B74F0)
#define RPG_CLIENT_PIXAIR_PIXAIRCURRENCYDATA_GET_CURRENTAMOUNT_OFFSET UNITYSDK_OFFSET(0xC3B74B0)
#define RPG_CLIENT_PIXAIR_PIXAIRCURRENCYDATA_GET_FIXAMOUNT_OFFSET UNITYSDK_OFFSET(0xC3B74D0)
#define RPG_CLIENT_PIXAIR_PIXAIRCURRENCYDATA_SETFIXAMOUNT_OFFSET UNITYSDK_OFFSET(0xC3B7600)
#define RPG_CLIENT_PIXAIR_PIXAIRCURRENCYDATA_SET_CHANGEAMOUNT_OFFSET UNITYSDK_OFFSET(0xC3B7500)
#define RPG_CLIENT_PIXAIR_PIXAIRCURRENCYDATA_SET_CURRENTAMOUNT_OFFSET UNITYSDK_OFFSET(0xC3B74C0)
#define RPG_CLIENT_PIXAIR_PIXAIRCURRENCYDATA_SET_FIXAMOUNT_OFFSET UNITYSDK_OFFSET(0xC3B74E0)
#define RPG_CLIENT_PIXAIR_PIXAIRCURRENCYDATA_UPDATEAMOUNT_OFFSET UNITYSDK_OFFSET(0xC3B75B0)
#define RPG_CLIENT_PIXAIR_PIXAIRCURRENCYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC3B75A0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirCurrencyData_TypeDefinitionIndex = 73637;
