...
#define RPG_CLIENT_PIXAIR_PIXAIRNODEINFO_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1A0D6C40)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEINFO_GETALLNODEDATA_OFFSET UNITYSDK_OFFSET(0x1A0D6CD0)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEINFO_GETNODEDATA_OFFSET UNITYSDK_OFFSET(0x1A0D6AC0)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEINFO_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1A0D6A70)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEINFO_INIT_OFFSET UNITYSDK_OFFSET(0x1A0D4AA0)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEINFO_TRYGETNODEDATA_OFFSET UNITYSDK_OFFSET(0x1A0D6B70)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0D4A90)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirNodeInfo_TypeDefinitionIndex = 75334;
