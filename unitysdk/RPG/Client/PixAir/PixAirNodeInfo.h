...
#define RPG_CLIENT_PIXAIR_PIXAIRNODEINFO_CONTAINS_OFFSET UNITYSDK_OFFSET(0xC3E1140)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEINFO_GETALLNODEDATA_OFFSET UNITYSDK_OFFSET(0xC3E11D0)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEINFO_GETNODEDATA_OFFSET UNITYSDK_OFFSET(0xC3E0FC0)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEINFO_GET_COUNT_OFFSET UNITYSDK_OFFSET(0xC3E0F70)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEINFO_INIT_OFFSET UNITYSDK_OFFSET(0xC3DED90)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEINFO_TRYGETNODEDATA_OFFSET UNITYSDK_OFFSET(0xC3E1070)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xC3DED80)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirNodeInfo_TypeDefinitionIndex = 73685;
