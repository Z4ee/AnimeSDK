...
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEROUNDENEMYDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x19EC3D90)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEROUNDENEMYDATA_GET_COINLOOT_OFFSET UNITYSDK_OFFSET(0x19EC3F20)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEROUNDENEMYDATA_GET_ENEMYDESC_OFFSET UNITYSDK_OFFSET(0x19EC3F80)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEROUNDENEMYDATA_GET_ENEMYHEADICONPATH_OFFSET UNITYSDK_OFFSET(0x19EC3FA0)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEROUNDENEMYDATA_GET_ENEMYID_OFFSET UNITYSDK_OFFSET(0x19EC3F40)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEROUNDENEMYDATA_GET_ENEMYNAME_OFFSET UNITYSDK_OFFSET(0x19EC3F60)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEROUNDENEMYDATA_GET_ENEMYTALKCONTENT_OFFSET UNITYSDK_OFFSET(0x19EC3FC0)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEROUNDENEMYDATA_SET_COINLOOT_OFFSET UNITYSDK_OFFSET(0x19EC3F30)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEROUNDENEMYDATA_SET_ENEMYDESC_OFFSET UNITYSDK_OFFSET(0x19EC3F90)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEROUNDENEMYDATA_SET_ENEMYHEADICONPATH_OFFSET UNITYSDK_OFFSET(0x19EC3FB0)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEROUNDENEMYDATA_SET_ENEMYID_OFFSET UNITYSDK_OFFSET(0x19EC3F50)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEROUNDENEMYDATA_SET_ENEMYNAME_OFFSET UNITYSDK_OFFSET(0x19EC3F70)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEROUNDENEMYDATA_SET_ENEMYTALKCONTENT_OFFSET UNITYSDK_OFFSET(0x19EC3FD0)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEROUNDENEMYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19EC3E20)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEROUNDENEMYDATA__INIT_OFFSET UNITYSDK_OFFSET(0x19EC3E30)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirBattleRoundEnemyData_TypeDefinitionIndex = 75288;
	...
	public:
		...
		::RPG::Client::TextID _EnemyTalkContent_k__BackingField; // 0x20
		::RPG::Client::TextID _EnemyDesc_k__BackingField; // 0x30
