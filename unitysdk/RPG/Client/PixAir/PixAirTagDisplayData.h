...
#define RPG_CLIENT_PIXAIR_PIXAIRTAGDISPLAYDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xC3E0D10)
#define RPG_CLIENT_PIXAIR_PIXAIRTAGDISPLAYDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xC3EC040)
#define RPG_CLIENT_PIXAIR_PIXAIRTAGDISPLAYDATA_GET_TAGTYPE_OFFSET UNITYSDK_OFFSET(0xC3EC020)
#define RPG_CLIENT_PIXAIR_PIXAIRTAGDISPLAYDATA_SET_NAME_OFFSET UNITYSDK_OFFSET(0xC3EC050)
#define RPG_CLIENT_PIXAIR_PIXAIRTAGDISPLAYDATA_SET_TAGTYPE_OFFSET UNITYSDK_OFFSET(0xC3EC030)
#define RPG_CLIENT_PIXAIR_PIXAIRTAGDISPLAYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC3EC060)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirTagDisplayData_TypeDefinitionIndex = 73638;
