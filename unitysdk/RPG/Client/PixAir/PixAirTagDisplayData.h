...
#define RPG_CLIENT_PIXAIR_PIXAIRTAGDISPLAYDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xDB19C10)
#define RPG_CLIENT_PIXAIR_PIXAIRTAGDISPLAYDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xDB24400)
#define RPG_CLIENT_PIXAIR_PIXAIRTAGDISPLAYDATA_GET_TAGTYPE_OFFSET UNITYSDK_OFFSET(0xDB243E0)
#define RPG_CLIENT_PIXAIR_PIXAIRTAGDISPLAYDATA_SET_NAME_OFFSET UNITYSDK_OFFSET(0xDB24410)
#define RPG_CLIENT_PIXAIR_PIXAIRTAGDISPLAYDATA_SET_TAGTYPE_OFFSET UNITYSDK_OFFSET(0xDB243F0)
#define RPG_CLIENT_PIXAIR_PIXAIRTAGDISPLAYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xDB24420)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirTagDisplayData_TypeDefinitionIndex = 78835;
