...
#define RPG_CLIENT_PIXAIR_PIXAIRAREAINFO_CONTAINS_OFFSET UNITYSDK_OFFSET(0xC3ADB80)
#define RPG_CLIENT_PIXAIR_PIXAIRAREAINFO_GETALLAREADATA_OFFSET UNITYSDK_OFFSET(0xC3ADC10)
#define RPG_CLIENT_PIXAIR_PIXAIRAREAINFO_GETAREADATA_OFFSET UNITYSDK_OFFSET(0xC3ADA00)
#define RPG_CLIENT_PIXAIR_PIXAIRAREAINFO_GET_COUNT_OFFSET UNITYSDK_OFFSET(0xC3AD9B0)
#define RPG_CLIENT_PIXAIR_PIXAIRAREAINFO_INIT_OFFSET UNITYSDK_OFFSET(0xC3ADD30)
#define RPG_CLIENT_PIXAIR_PIXAIRAREAINFO_TRYGETAREADATA_OFFSET UNITYSDK_OFFSET(0xC3ADAB0)
#define RPG_CLIENT_PIXAIR_PIXAIRAREAINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xC3ADF80)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirAreaInfo_TypeDefinitionIndex = 73622;
