...
#define RPG_CLIENT_PIXAIR_PIXAIRAREAINFO_CONTAINS_OFFSET UNITYSDK_OFFSET(0xDAE5B10)
#define RPG_CLIENT_PIXAIR_PIXAIRAREAINFO_GETALLAREADATA_OFFSET UNITYSDK_OFFSET(0xDAE5BA0)
#define RPG_CLIENT_PIXAIR_PIXAIRAREAINFO_GETAREADATA_OFFSET UNITYSDK_OFFSET(0xDAE5990)
#define RPG_CLIENT_PIXAIR_PIXAIRAREAINFO_GET_COUNT_OFFSET UNITYSDK_OFFSET(0xDAE5940)
#define RPG_CLIENT_PIXAIR_PIXAIRAREAINFO_INIT_OFFSET UNITYSDK_OFFSET(0xDAE5CC0)
#define RPG_CLIENT_PIXAIR_PIXAIRAREAINFO_TRYGETAREADATA_OFFSET UNITYSDK_OFFSET(0xDAE5A40)
#define RPG_CLIENT_PIXAIR_PIXAIRAREAINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xDAE5F10)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirAreaInfo_TypeDefinitionIndex = 78819;
