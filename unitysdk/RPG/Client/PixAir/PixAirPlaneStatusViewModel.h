...
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0x1A0DB060)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSVIEWMODEL_GET_BURNCOUNTTEXT_OFFSET UNITYSDK_OFFSET(0x1A0DADA0)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSVIEWMODEL_GET_BURNCOUNT_OFFSET UNITYSDK_OFFSET(0x1A0DB9B0)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSVIEWMODEL_GET_CURRENTHPTEXT_OFFSET UNITYSDK_OFFSET(0x1A0DBAD0)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSVIEWMODEL_GET_CURRENTHP_OFFSET UNITYSDK_OFFSET(0x1A0DB8D0)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSVIEWMODEL_GET_HPINFOTEXT_OFFSET UNITYSDK_OFFSET(0x1A0DAB60)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSVIEWMODEL_GET_HPPERCENT_OFFSET UNITYSDK_OFFSET(0x1A0DAF60)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSVIEWMODEL_GET_MAXHPTEXT_OFFSET UNITYSDK_OFFSET(0x1A0DBA20)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSVIEWMODEL_GET_MAXHP_OFFSET UNITYSDK_OFFSET(0x1A0DB860)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSVIEWMODEL_GET_SHIELDTEXT_OFFSET UNITYSDK_OFFSET(0x1A0DACF0)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSVIEWMODEL_GET_SHIELD_OFFSET UNITYSDK_OFFSET(0x1A0DB940)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0DB110)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSVIEWMODEL__INIT_OFFSET UNITYSDK_OFFSET(0x1A0DB130)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSVIEWMODEL__ONGHOSTPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1A0DB230)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirPlaneStatusViewModel_TypeDefinitionIndex = 75239;
