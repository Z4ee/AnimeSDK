...
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTACTION_FINISH_OFFSET UNITYSDK_OFFSET(0x1A0C9040)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTACTION_GET_NODECASE_OFFSET UNITYSDK_OFFSET(0x1A0C9170)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTACTION_GET_SETTLEMENTDATA_OFFSET UNITYSDK_OFFSET(0x1A0C9150)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTACTION_SET_SETTLEMENTDATA_OFFSET UNITYSDK_OFFSET(0x1A0C9160)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTACTION_START_OFFSET UNITYSDK_OFFSET(0x1A0C8F50)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0C8F40)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirGameSettlementAction_TypeDefinitionIndex = 75261;
