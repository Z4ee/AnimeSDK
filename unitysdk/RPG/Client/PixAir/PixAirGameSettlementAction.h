...
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTACTION_FINISH_OFFSET UNITYSDK_OFFSET(0x1BCFFFB0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTACTION_GET_NODECASE_OFFSET UNITYSDK_OFFSET(0x1BD000E0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTACTION_GET_SETTLEMENTDATA_OFFSET UNITYSDK_OFFSET(0x1BD000C0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTACTION_SET_SETTLEMENTDATA_OFFSET UNITYSDK_OFFSET(0x1BD000D0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTACTION_START_OFFSET UNITYSDK_OFFSET(0x1BCFFEC0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCFFEB0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirGameSettlementAction_TypeDefinitionIndex = 78808;
