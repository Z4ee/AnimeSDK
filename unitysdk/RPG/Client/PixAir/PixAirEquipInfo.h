...
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFO_CONTAINSEQUIPLEVEL_OFFSET UNITYSDK_OFFSET(0x19ECE910)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFO_CONTAINSEQUIP_OFFSET UNITYSDK_OFFSET(0x19ECE5C0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFO_GETALLEQUIPDATA_OFFSET UNITYSDK_OFFSET(0x19ECE650)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFO_GETALLEQUIPLEVELDATA_OFFSET UNITYSDK_OFFSET(0x19ECE9B0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFO_GETEQUIPDATA_OFFSET UNITYSDK_OFFSET(0x19ECE440)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFO_GETEQUIPLEVELDATA_OFFSET UNITYSDK_OFFSET(0x19ECE770)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFO_GET_EQUIPCOUNT_OFFSET UNITYSDK_OFFSET(0x19ECE3A0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFO_GET_EQUIPLEVELCOUNT_OFFSET UNITYSDK_OFFSET(0x19ECE3F0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFO_INIT_OFFSET UNITYSDK_OFFSET(0x19ECEAD0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFO_TRYGETEQUIPDATA_OFFSET UNITYSDK_OFFSET(0x19ECE4F0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFO_TRYGETEQUIPLEVELDATA_OFFSET UNITYSDK_OFFSET(0x19ECE830)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19ECEFA0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEquipInfo_TypeDefinitionIndex = 75274;
