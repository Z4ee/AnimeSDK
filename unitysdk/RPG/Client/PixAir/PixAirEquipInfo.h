...
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFO_CONTAINSEQUIPLEVEL_OFFSET UNITYSDK_OFFSET(0xDAF6D00)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFO_CONTAINSEQUIP_OFFSET UNITYSDK_OFFSET(0xDAF69B0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFO_GETALLEQUIPDATA_OFFSET UNITYSDK_OFFSET(0xDAF6A40)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFO_GETALLEQUIPLEVELDATA_OFFSET UNITYSDK_OFFSET(0xDAF6DA0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFO_GETEQUIPDATA_OFFSET UNITYSDK_OFFSET(0xDAF6830)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFO_GETEQUIPLEVELDATA_OFFSET UNITYSDK_OFFSET(0xDAF6B60)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFO_GET_EQUIPCOUNT_OFFSET UNITYSDK_OFFSET(0xDAF6790)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFO_GET_EQUIPLEVELCOUNT_OFFSET UNITYSDK_OFFSET(0xDAF67E0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFO_INIT_OFFSET UNITYSDK_OFFSET(0xDAF6EC0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFO_TRYGETEQUIPDATA_OFFSET UNITYSDK_OFFSET(0xDAF68E0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFO_TRYGETEQUIPLEVELDATA_OFFSET UNITYSDK_OFFSET(0xDAF6C20)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xDAF7390)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEquipInfo_TypeDefinitionIndex = 78822;
