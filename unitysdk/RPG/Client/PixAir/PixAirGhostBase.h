...
#define RPG_CLIENT_PIXAIR_PIXAIRGHOSTBASE_GETATTRIBUTEASINT_OFFSET UNITYSDK_OFFSET(0xDB0C7F0)
#define RPG_CLIENT_PIXAIR_PIXAIRGHOSTBASE_GET_RUNTIMEID_OFFSET UNITYSDK_OFFSET(0xDB0C7B0)
#define RPG_CLIENT_PIXAIR_PIXAIRGHOSTBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xDB0C7C0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirGhostBase_TypeDefinitionIndex = 78713;
