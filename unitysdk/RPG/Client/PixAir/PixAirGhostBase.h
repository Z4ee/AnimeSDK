...
#define RPG_CLIENT_PIXAIR_PIXAIRGHOSTBASE_GETATTRIBUTEASINT_OFFSET UNITYSDK_OFFSET(0xC3D4080)
#define RPG_CLIENT_PIXAIR_PIXAIRGHOSTBASE_GET_RUNTIMEID_OFFSET UNITYSDK_OFFSET(0xC3D4070)
#define RPG_CLIENT_PIXAIR_PIXAIRGHOSTBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xC3C8690)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirGhostBase_TypeDefinitionIndex = 73516;
