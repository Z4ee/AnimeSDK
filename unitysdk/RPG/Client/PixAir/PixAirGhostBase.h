...
#define RPG_CLIENT_PIXAIR_PIXAIRGHOSTBASE_GETATTRIBUTEASINT_OFFSET UNITYSDK_OFFSET(0x1A0C9540)
#define RPG_CLIENT_PIXAIR_PIXAIRGHOSTBASE_GET_RUNTIMEID_OFFSET UNITYSDK_OFFSET(0x1A0C9500)
#define RPG_CLIENT_PIXAIR_PIXAIRGHOSTBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0C9510)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirGhostBase_TypeDefinitionIndex = 75165;
