...
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLESETTLEMENTACTION_FINISH_OFFSET UNITYSDK_OFFSET(0x1C832AD0)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLESETTLEMENTACTION_GET_NODECASE_OFFSET UNITYSDK_OFFSET(0x1C832B60)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLESETTLEMENTACTION_GET_SETTLEMENTDATA_OFFSET UNITYSDK_OFFSET(0x1C832B40)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLESETTLEMENTACTION_SET_SETTLEMENTDATA_OFFSET UNITYSDK_OFFSET(0x1C832B50)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLESETTLEMENTACTION_START_OFFSET UNITYSDK_OFFSET(0x1C832830)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLESETTLEMENTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C832820)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLESETTLEMENTACTION__ONDIALOGEXIT_OFFSET UNITYSDK_OFFSET(0x1C8329D0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirBattleSettlementAction_TypeDefinitionIndex = 78801;
