...
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLESETTLEMENTACTION_FINISH_OFFSET UNITYSDK_OFFSET(0xC3B5880)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLESETTLEMENTACTION_GET_NODECASE_OFFSET UNITYSDK_OFFSET(0xC3B5910)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLESETTLEMENTACTION_GET_SETTLEMENTDATA_OFFSET UNITYSDK_OFFSET(0xC3B58F0)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLESETTLEMENTACTION_SET_SETTLEMENTDATA_OFFSET UNITYSDK_OFFSET(0xC3B5900)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLESETTLEMENTACTION_START_OFFSET UNITYSDK_OFFSET(0xC3B5360)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLESETTLEMENTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xC3B5350)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLESETTLEMENTACTION__ONDIALOGEXIT_OFFSET UNITYSDK_OFFSET(0xC3B5500)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLESETTLEMENTACTION___IFIXBASEPROXY_FINISH_OFFSET UNITYSDK_OFFSET(0xC3B5980)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLESETTLEMENTACTION___IFIXBASEPROXY_START_OFFSET UNITYSDK_OFFSET(0xC3B5920)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirBattleSettlementAction_TypeDefinitionIndex = 73605;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_PIXAIR_PIXAIRBATTLESETTLEMENTACTION___IFIXBASEPROXY_START_OFFSET))(this);
		}

		::System::Void __iFixBaseProxy_Finish()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_PIXAIR_PIXAIRBATTLESETTLEMENTACTION___IFIXBASEPROXY_FINISH_OFFSET))(this);
		}
	};
}
