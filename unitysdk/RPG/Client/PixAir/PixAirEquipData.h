...
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDATA_GETDISPLAYTAGLIST_OFFSET UNITYSDK_OFFSET(0x19ECDF70)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDATA_GET_AFFECTEDTAGLIST_OFFSET UNITYSDK_OFFSET(0x19EBC4D0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDATA_GET_EQUIPICON_OFFSET UNITYSDK_OFFSET(0x19ECDD90)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDATA_GET_EQUIPID_OFFSET UNITYSDK_OFFSET(0x19ECDC50)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDATA_GET_ISCORE_OFFSET UNITYSDK_OFFSET(0x19ECDE30)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19ECDCD0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDATA_GET_SLOTTYPE_OFFSET UNITYSDK_OFFSET(0x19EBCB30)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDATA_GET_TAGLIST_OFFSET UNITYSDK_OFFSET(0x19ECDED0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0x19ECDC70)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDATA_SET_EQUIPID_OFFSET UNITYSDK_OFFSET(0x19ECDC60)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDATA_TRYCREATE_OFFSET UNITYSDK_OFFSET(0x19EBC380)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19ECE200)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEquipData_TypeDefinitionIndex = 75272;
