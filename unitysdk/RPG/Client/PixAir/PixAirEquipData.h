...
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDATA_GETDISPLAYTAGLIST_OFFSET UNITYSDK_OFFSET(0xDAF6360)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDATA_GET_AFFECTEDTAGLIST_OFFSET UNITYSDK_OFFSET(0xDAE4EC0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDATA_GET_EQUIPICON_OFFSET UNITYSDK_OFFSET(0xDAF6180)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDATA_GET_EQUIPID_OFFSET UNITYSDK_OFFSET(0xDAF6040)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDATA_GET_ISCORE_OFFSET UNITYSDK_OFFSET(0xDAF6220)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xDAF60C0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDATA_GET_SLOTTYPE_OFFSET UNITYSDK_OFFSET(0xDAE5520)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDATA_GET_TAGLIST_OFFSET UNITYSDK_OFFSET(0xDAF62C0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xDAF6060)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDATA_SET_EQUIPID_OFFSET UNITYSDK_OFFSET(0xDAF6050)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDATA_TRYCREATE_OFFSET UNITYSDK_OFFSET(0xDAE4D70)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xDAF65F0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEquipData_TypeDefinitionIndex = 78820;
