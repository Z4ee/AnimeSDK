...
#define RPG_CLIENT_PIXAIR_PIXAIRBAG_ADDNEWEQUIP_OFFSET UNITYSDK_OFFSET(0xDAE7B50)
#define RPG_CLIENT_PIXAIR_PIXAIRBAG_CREATE_OFFSET UNITYSDK_OFFSET(0xDAE73A0)
#define RPG_CLIENT_PIXAIR_PIXAIRBAG_FINDSLOTBYEQUIPUID_OFFSET UNITYSDK_OFFSET(0xDAE8E20)
#define RPG_CLIENT_PIXAIR_PIXAIRBAG_FINDSLOTBYPOSITION_OFFSET UNITYSDK_OFFSET(0xDAE8990)
#define RPG_CLIENT_PIXAIR_PIXAIRBAG_GETCAPACITY_OFFSET UNITYSDK_OFFSET(0xDAE7350)
#define RPG_CLIENT_PIXAIR_PIXAIRBAG_GETEQUIPINSTANCEBYUID_OFFSET UNITYSDK_OFFSET(0xDAE6BB0)
#define RPG_CLIENT_PIXAIR_PIXAIRBAG_GETEQUIPINSTANCE_OFFSET UNITYSDK_OFFSET(0xDAE6C90)
#define RPG_CLIENT_PIXAIR_PIXAIRBAG_GET_COLUMNCOUNT_OFFSET UNITYSDK_OFFSET(0xDAE6840)
#define RPG_CLIENT_PIXAIR_PIXAIRBAG_GET_OCCUPIEDSLOTCOUNT_OFFSET UNITYSDK_OFFSET(0xDAE6900)
#define RPG_CLIENT_PIXAIR_PIXAIRBAG_GET_SLOTS_OFFSET UNITYSDK_OFFSET(0xDAE66C0)
#define RPG_CLIENT_PIXAIR_PIXAIRBAG_GET_TOTALSLOTCOUNT_OFFSET UNITYSDK_OFFSET(0xDAE68B0)
#define RPG_CLIENT_PIXAIR_PIXAIRBAG_GET__CAPACITY_OFFSET UNITYSDK_OFFSET(0xDAE66E0)
#define RPG_CLIENT_PIXAIR_PIXAIRBAG_GET__COLUMNCOUNT_OFFSET UNITYSDK_OFFSET(0xDAE67F0)
#define RPG_CLIENT_PIXAIR_PIXAIRBAG_HASRECOMMENDEQUIP_OFFSET UNITYSDK_OFFSET(0xDAE6E80)
#define RPG_CLIENT_PIXAIR_PIXAIRBAG_REPLACESLOTWITHEMPTY_OFFSET UNITYSDK_OFFSET(0xDAE9640)
#define RPG_CLIENT_PIXAIR_PIXAIRBAG_REPLACESLOTWITHEQUIP_OFFSET UNITYSDK_OFFSET(0xDAE91A0)
#define RPG_CLIENT_PIXAIR_PIXAIRBAG_SET_SLOTS_OFFSET UNITYSDK_OFFSET(0xDAE66D0)
#define RPG_CLIENT_PIXAIR_PIXAIRBAG_SYNC_OFFSET UNITYSDK_OFFSET(0xDAE7F20)
#define RPG_CLIENT_PIXAIR_PIXAIRBAG__CTOR_OFFSET UNITYSDK_OFFSET(0xDAE6BA0)
#define RPG_CLIENT_PIXAIR_PIXAIRBAG__RELEASESLOTS_OFFSET UNITYSDK_OFFSET(0xDAE81B0)
#define RPG_CLIENT_PIXAIR_PIXAIRBAG__TRYGETEQUIPINFOBYSLOTINDEX_OFFSET UNITYSDK_OFFSET(0xDAE8440)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirBag_TypeDefinitionIndex = 78841;
