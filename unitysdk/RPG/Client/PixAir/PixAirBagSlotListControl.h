...
#define RPG_CLIENT_PIXAIR_PIXAIRBAGSLOTLISTCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xDAEA9E0)
#define RPG_CLIENT_PIXAIR_PIXAIRBAGSLOTLISTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xDAEAA90)
#define RPG_CLIENT_PIXAIR_PIXAIRBAGSLOTLISTCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xDAEA8B0)
#define RPG_CLIENT_PIXAIR_PIXAIRBAGSLOTLISTCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xDAEA750)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirBagSlotListControl_TypeDefinitionIndex = 78746;
