...
#define RPG_CLIENT_PIXAIR_PIXAIRRECOMMENDDATA_GETEQUIPDATALIST_OFFSET UNITYSDK_OFFSET(0xDB20D10)
#define RPG_CLIENT_PIXAIR_PIXAIRRECOMMENDDATA_GETRECOMMENDEQUIPCOUNTINEQUIPBAR_OFFSET UNITYSDK_OFFSET(0xDB213C0)
#define RPG_CLIENT_PIXAIR_PIXAIRRECOMMENDDATA_GETRECOMMENDTIP_OFFSET UNITYSDK_OFFSET(0xDB21160)
#define RPG_CLIENT_PIXAIR_PIXAIRRECOMMENDDATA_GET_COREEQUIPDATA_OFFSET UNITYSDK_OFFSET(0xDB20BD0)
#define RPG_CLIENT_PIXAIR_PIXAIRRECOMMENDDATA_GET_CORERECOMMENDTAGS_OFFSET UNITYSDK_OFFSET(0xDB20C70)
#define RPG_CLIENT_PIXAIR_PIXAIRRECOMMENDDATA_GET_RECOMMENDID_OFFSET UNITYSDK_OFFSET(0xDB20A90)
#define RPG_CLIENT_PIXAIR_PIXAIRRECOMMENDDATA_GET_TITLE_OFFSET UNITYSDK_OFFSET(0xDB20B10)
#define RPG_CLIENT_PIXAIR_PIXAIRRECOMMENDDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xDB20AB0)
#define RPG_CLIENT_PIXAIR_PIXAIRRECOMMENDDATA_ISCORERECOMMEND_OFFSET UNITYSDK_OFFSET(0xDB20F70)
#define RPG_CLIENT_PIXAIR_PIXAIRRECOMMENDDATA_ISEQUIPRECOMMEND_OFFSET UNITYSDK_OFFSET(0xDB21020)
#define RPG_CLIENT_PIXAIR_PIXAIRRECOMMENDDATA_ISRECOMMEND_OFFSET UNITYSDK_OFFSET(0xDB20F00)
#define RPG_CLIENT_PIXAIR_PIXAIRRECOMMENDDATA_SET_RECOMMENDID_OFFSET UNITYSDK_OFFSET(0xDB20AA0)
#define RPG_CLIENT_PIXAIR_PIXAIRRECOMMENDDATA_TRYCREATEBYCOREID_OFFSET UNITYSDK_OFFSET(0xDB21770)
#define RPG_CLIENT_PIXAIR_PIXAIRRECOMMENDDATA_TRYCREATE_OFFSET UNITYSDK_OFFSET(0xDB0A5D0)
#define RPG_CLIENT_PIXAIR_PIXAIRRECOMMENDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xDB21760)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirRecommendData_TypeDefinitionIndex = 78877;
