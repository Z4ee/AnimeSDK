...
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPASSEMBLEVIEWMODEL_GET_BTNCLOSECOMMAND_OFFSET UNITYSDK_OFFSET(0x19EC8F30)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPASSEMBLEVIEWMODEL_SET_BTNCLOSECOMMAND_OFFSET UNITYSDK_OFFSET(0x19EC8F40)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPASSEMBLEVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x19EC8D90)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEquipAssembleViewModel_TypeDefinitionIndex = 75224;

	class PixAirEquipAssembleViewModel : public ::Sofa::BaseViewModel
	{
	public:
		::Class_1_91C9195F7AC754D8* _GameFlowService; // 0x20
		::Class_1_47EB23CB5C4B2615_34* _WindowService; // 0x28
		::RPG::Client::PixAir::PixAirBattleEquipsViewModel* BattleEquipsViewModel; // 0x30
		::Sofa::Core::SimpleCommand* _BtnCloseCommand_k__BackingField; // 0x38
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_47EB23CB5C4B2615_34*, ::Class_1_91C9195F7AC754D8*, ::Class_1_D031E8F06825AB4F*))((::PBYTE)hIl2Cpp + RPG_CLIENT_PIXAIR_PIXAIREQUIPASSEMBLEVIEWMODEL__CTOR_OFFSET))(this, a1, a2, a3);
		}
