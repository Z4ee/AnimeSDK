...
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA_CREATE_1_OFFSET UNITYSDK_OFFSET(0x1C842C70)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1C842BC0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA_GET_BUYPRICE_OFFSET UNITYSDK_OFFSET(0x1C842EC0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA_GET_EQUIPDATA_OFFSET UNITYSDK_OFFSET(0x1C842F80)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA_GET_EQUIPID_OFFSET UNITYSDK_OFFSET(0x1C842E40)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA_GET_GOODINDEX_OFFSET UNITYSDK_OFFSET(0x1C842E80)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA_GET_LEVELDATA_OFFSET UNITYSDK_OFFSET(0x1C842F60)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x1C842EA0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA_GET_SELLPRICE_OFFSET UNITYSDK_OFFSET(0x1C842F10)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA_GET_SOLD_OFFSET UNITYSDK_OFFSET(0x1C842E60)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA_SET_EQUIPDATA_OFFSET UNITYSDK_OFFSET(0x1C842F90)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA_SET_EQUIPID_OFFSET UNITYSDK_OFFSET(0x1C842E50)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA_SET_GOODINDEX_OFFSET UNITYSDK_OFFSET(0x1C842E90)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA_SET_LEVELDATA_OFFSET UNITYSDK_OFFSET(0x1C842F70)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0x1C842EB0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA_SET_SOLD_OFFSET UNITYSDK_OFFSET(0x1C842E70)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA_SYNC_OFFSET UNITYSDK_OFFSET(0x1C842D10)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1C842D70)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA__INIT_OFFSET UNITYSDK_OFFSET(0x1C842D80)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEquipShopData_TypeDefinitionIndex = 78890;
	...
	public:
		...
		::RPG::Client::PixAir::PixAirEquipData* _EquipData_k__BackingField; // 0x20
		::RPG::GameCore::PixAirEquipPriceRow* _PriceRow; // 0x28
		::System::UInt32 _EquipId_k__BackingField; // 0x30
		::System::Boolean _Sold_k__BackingField; // 0x34
		::System::UInt32 _Level_k__BackingField; // 0x38
		::System::UInt32 _GoodIndex_k__BackingField; // 0x3C
