...
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA_CREATE_1_OFFSET UNITYSDK_OFFSET(0xDAFCC20)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xDAFCB70)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA_GET_BUYPRICE_OFFSET UNITYSDK_OFFSET(0xDAFCE70)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA_GET_EQUIPDATA_OFFSET UNITYSDK_OFFSET(0xDAFCF30)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA_GET_EQUIPID_OFFSET UNITYSDK_OFFSET(0xDAFCDF0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA_GET_GOODINDEX_OFFSET UNITYSDK_OFFSET(0xDAFCE30)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA_GET_LEVELDATA_OFFSET UNITYSDK_OFFSET(0xDAFCF10)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0xDAFCE50)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA_GET_SELLPRICE_OFFSET UNITYSDK_OFFSET(0xDAFCEC0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA_GET_SOLD_OFFSET UNITYSDK_OFFSET(0xDAFCE10)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA_SET_EQUIPDATA_OFFSET UNITYSDK_OFFSET(0xDAFCF40)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA_SET_EQUIPID_OFFSET UNITYSDK_OFFSET(0xDAFCE00)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA_SET_GOODINDEX_OFFSET UNITYSDK_OFFSET(0xDAFCE40)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA_SET_LEVELDATA_OFFSET UNITYSDK_OFFSET(0xDAFCF20)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0xDAFCE60)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA_SET_SOLD_OFFSET UNITYSDK_OFFSET(0xDAFCE20)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA_SYNC_OFFSET UNITYSDK_OFFSET(0xDAFCCC0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xDAFCD20)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPDATA__INIT_OFFSET UNITYSDK_OFFSET(0xDAFCD30)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEquipShopData_TypeDefinitionIndex = 78891;

	class PixAirEquipShopData : public ::System::Object
	{
	public:
		::RPG::Client::PixAir::PixAirEquipLevelData* _LevelData_k__BackingField; // 0x10
		::RPG::Client::PixAir::PixAirEquipData* _EquipData_k__BackingField; // 0x18
		::RPG::GameCore::PixAirEquipPriceRow* _PriceRow; // 0x20
		::RPG::GameCore::PixAirEquipRow* _Row; // 0x28
		::System::UInt32 _Level_k__BackingField; // 0x30
		::System::UInt32 _EquipId_k__BackingField; // 0x34
		::System::UInt32 _GoodIndex_k__BackingField; // 0x38
		::System::Boolean _Sold_k__BackingField; // 0x3C
