...
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFOVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0x19ECFA90)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFOVIEWMODEL_GET_CLOSECOMMAND_OFFSET UNITYSDK_OFFSET(0x19ED01D0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFOVIEWMODEL_GET_COOLDOWN_OFFSET UNITYSDK_OFFSET(0x19ECF5D0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFOVIEWMODEL_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x19ECFF90)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFOVIEWMODEL_GET_ISPLAYEREQUIPPED_OFFSET UNITYSDK_OFFSET(0x19EC5A20)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFOVIEWMODEL_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19ECF4F0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFOVIEWMODEL_GET_SKILLDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x19ECF560)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFOVIEWMODEL_GET_STARLEVEL_OFFSET UNITYSDK_OFFSET(0x19ED0040)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFOVIEWMODEL_GET_TAGS_OFFSET UNITYSDK_OFFSET(0x19ECF790)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFOVIEWMODEL_SET_CLOSECOMMAND_OFFSET UNITYSDK_OFFSET(0x19ED01E0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFOVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x19ECFB50)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFOVIEWMODEL__INIT_OFFSET UNITYSDK_OFFSET(0x19ECFB70)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFOVIEWMODEL__ONCLOSE_OFFSET UNITYSDK_OFFSET(0x19ECFE40)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFOVIEWMODEL__ONGHOSTPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x19ECFCE0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEquipInfoViewModel_TypeDefinitionIndex = 75235;
