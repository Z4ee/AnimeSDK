...
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFOVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0xDAF7E50)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFOVIEWMODEL_GET_CLOSECOMMAND_OFFSET UNITYSDK_OFFSET(0xDAF8580)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFOVIEWMODEL_GET_COOLDOWN_OFFSET UNITYSDK_OFFSET(0xDAF7990)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFOVIEWMODEL_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xDAF8350)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFOVIEWMODEL_GET_ISPLAYEREQUIPPED_OFFSET UNITYSDK_OFFSET(0xDAEE070)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFOVIEWMODEL_GET_NAME_OFFSET UNITYSDK_OFFSET(0xDAF78B0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFOVIEWMODEL_GET_SKILLDESCRIPTION_OFFSET UNITYSDK_OFFSET(0xDAF7920)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFOVIEWMODEL_GET_STARLEVEL_OFFSET UNITYSDK_OFFSET(0xDAF8400)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFOVIEWMODEL_GET_TAGS_OFFSET UNITYSDK_OFFSET(0xDAF7B50)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFOVIEWMODEL_SET_CLOSECOMMAND_OFFSET UNITYSDK_OFFSET(0xDAF8590)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFOVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xDAF7F10)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFOVIEWMODEL__INIT_OFFSET UNITYSDK_OFFSET(0xDAF7F30)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFOVIEWMODEL__ONCLOSE_OFFSET UNITYSDK_OFFSET(0xDAF8200)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFOVIEWMODEL__ONGHOSTPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0xDAF80A0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEquipInfoViewModel_TypeDefinitionIndex = 78783;
