...
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPBAR_CREATE_OFFSET UNITYSDK_OFFSET(0x19EC9880)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPBAR_FINDEMPTYSLOTFORSIZE_OFFSET UNITYSDK_OFFSET(0x19ECA5C0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPBAR_FINDSLOTBYEQUIPUID_OFFSET UNITYSDK_OFFSET(0x19ECA480)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPBAR_FINDSLOTBYPOSITION_OFFSET UNITYSDK_OFFSET(0x19ECA2B0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPBAR_GETEQUIPINSTANCEBYUID_OFFSET UNITYSDK_OFFSET(0x19EC9650)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPBAR_GETEQUIPINSTANCE_OFFSET UNITYSDK_OFFSET(0x19EC9730)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPBAR_GET_AVAILABLESLOTNUM_OFFSET UNITYSDK_OFFSET(0x19EC9630)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPBAR_GET_CAPACITY_OFFSET UNITYSDK_OFFSET(0x19EC9540)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPBAR_GET_SLOTS_OFFSET UNITYSDK_OFFSET(0x19EC9520)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPBAR_REPLACESLOTWITHEMPTY_OFFSET UNITYSDK_OFFSET(0x19ECB000)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPBAR_REPLACESLOTWITHEQUIP_OFFSET UNITYSDK_OFFSET(0x19ECA6F0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPBAR_SET_AVAILABLESLOTNUM_OFFSET UNITYSDK_OFFSET(0x19EC9640)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPBAR_SET_SLOTS_OFFSET UNITYSDK_OFFSET(0x19EC9530)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPBAR_SYNC_OFFSET UNITYSDK_OFFSET(0x19EC9AA0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPBAR_UPDATEAVAILABLESLOTNUM_OFFSET UNITYSDK_OFFSET(0x19ECB470)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPBAR__CTOR_OFFSET UNITYSDK_OFFSET(0x19EC9A90)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPBAR__FILLMISSINGSLOTS_OFFSET UNITYSDK_OFFSET(0x19ECAB60)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPBAR__RELEASESLOTS_OFFSET UNITYSDK_OFFSET(0x19EC9CD0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPBAR__TRYGETEQUIPINFOBYSLOTINDEX_OFFSET UNITYSDK_OFFSET(0x19EC9E20)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEquipBar_TypeDefinitionIndex = 75297;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_333B902B2174BECA_6*))((::PBYTE)hIl2Cpp + RPG_CLIENT_PIXAIR_PIXAIREQUIPBAR_SYNC_OFFSET))(this, a1);
		}
		...
		{
			return ((::Class_1_D17272E82AE804C2_779*(*)(::PVOID, ::System::Int32, ::Google::Protobuf::Collections::RepeatedField_1<::Class_1_D17272E82AE804C2_779*>*))((::PBYTE)hIl2Cpp + RPG_CLIENT_PIXAIR_PIXAIREQUIPBAR__TRYGETEQUIPINFOBYSLOTINDEX_OFFSET))(this, a1, a2);
		}
