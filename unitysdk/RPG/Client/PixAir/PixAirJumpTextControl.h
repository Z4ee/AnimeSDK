...
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xDB0E640)
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xDB0EAA0)
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTCONTROL__GETDISPLAYTEXT_OFFSET UNITYSDK_OFFSET(0xDB0E830)
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTCONTROL__GETSIZESTATENAME_OFFSET UNITYSDK_OFFSET(0xDB0EA00)
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTCONTROL__GETTYPESTATENAME_OFFSET UNITYSDK_OFFSET(0xDB0E960)
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTCONTROL__ONANIMATIONEND_OFFSET UNITYSDK_OFFSET(0xDB0E5D0)
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xDB0E4F0)
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xDB0E1B0)
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTCONTROL__PLAYUISTATE_OFFSET UNITYSDK_OFFSET(0xDB0E780)
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTCONTROL__REFRESHDISPLAY_OFFSET UNITYSDK_OFFSET(0xDB0E570)
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTCONTROL__REGISTERANIMATIONEVENT_OFFSET UNITYSDK_OFFSET(0xDB0E410)
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTCONTROL__SETALLTEXTVALUES_OFFSET UNITYSDK_OFFSET(0xDB0E6F0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirJumpTextControl_TypeDefinitionIndex = 78764;
