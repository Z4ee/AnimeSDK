...
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1BD02300)
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD02760)
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTCONTROL__GETDISPLAYTEXT_OFFSET UNITYSDK_OFFSET(0x1BD024F0)
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTCONTROL__GETSIZESTATENAME_OFFSET UNITYSDK_OFFSET(0x1BD026C0)
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTCONTROL__GETTYPESTATENAME_OFFSET UNITYSDK_OFFSET(0x1BD02620)
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTCONTROL__ONANIMATIONEND_OFFSET UNITYSDK_OFFSET(0x1BD02290)
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1BD021B0)
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1BD01E70)
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTCONTROL__PLAYUISTATE_OFFSET UNITYSDK_OFFSET(0x1BD02440)
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTCONTROL__REFRESHDISPLAY_OFFSET UNITYSDK_OFFSET(0x1BD02230)
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTCONTROL__REGISTERANIMATIONEVENT_OFFSET UNITYSDK_OFFSET(0x1BD020D0)
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTCONTROL__SETALLTEXTVALUES_OFFSET UNITYSDK_OFFSET(0x1BD023B0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirJumpTextControl_TypeDefinitionIndex = 78763;
