...
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEBATTLEROUNDDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xDB03840)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEBATTLEROUNDDATA_GET_BATTLEID_OFFSET UNITYSDK_OFFSET(0xDB03DC0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEBATTLEROUNDDATA_GET_ENEMYDATA_OFFSET UNITYSDK_OFFSET(0xDB03DE0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEBATTLEROUNDDATA_GET_ENEMYHEALTHPERCENTAGE_OFFSET UNITYSDK_OFFSET(0xDB03E00)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEBATTLEROUNDDATA_GET_LOOTCOINICONPATH_OFFSET UNITYSDK_OFFSET(0xDB03E60)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEBATTLEROUNDDATA_GET_LOOTCOINNUM_OFFSET UNITYSDK_OFFSET(0xDB03E40)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEBATTLEROUNDDATA_GET_PLAYERHEALTHPERCENTAGE_OFFSET UNITYSDK_OFFSET(0xDB03E20)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEBATTLEROUNDDATA_SET_BATTLEID_OFFSET UNITYSDK_OFFSET(0xDB03DD0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEBATTLEROUNDDATA_SET_ENEMYDATA_OFFSET UNITYSDK_OFFSET(0xDB03DF0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEBATTLEROUNDDATA_SET_ENEMYHEALTHPERCENTAGE_OFFSET UNITYSDK_OFFSET(0xDB03E10)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEBATTLEROUNDDATA_SET_LOOTCOINICONPATH_OFFSET UNITYSDK_OFFSET(0xDB03E70)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEBATTLEROUNDDATA_SET_LOOTCOINNUM_OFFSET UNITYSDK_OFFSET(0xDB03E50)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEBATTLEROUNDDATA_SET_PLAYERHEALTHPERCENTAGE_OFFSET UNITYSDK_OFFSET(0xDB03E30)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEBATTLEROUNDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xDB038E0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEBATTLEROUNDDATA__INIT_OFFSET UNITYSDK_OFFSET(0xDB03900)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEBATTLEROUNDDATA__NORMALIZEHEALTHPERCENTAGE_OFFSET UNITYSDK_OFFSET(0xDB03CC0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirGameBattleRoundData_TypeDefinitionIndex = 78837;
