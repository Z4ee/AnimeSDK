...
#define RPG_CLIENT_PIXAIR_PIXAIRLOOTSELECTACTION_FINISHSUPPLYSTAGE_OFFSET UNITYSDK_OFFSET(0xDB10850)
#define RPG_CLIENT_PIXAIR_PIXAIRLOOTSELECTACTION_FINISH_OFFSET UNITYSDK_OFFSET(0xDB10B60)
#define RPG_CLIENT_PIXAIR_PIXAIRLOOTSELECTACTION_GETCONTENTKEY_OFFSET UNITYSDK_OFFSET(0xDB10AF0)
#define RPG_CLIENT_PIXAIR_PIXAIRLOOTSELECTACTION_GET_ENEMYID_OFFSET UNITYSDK_OFFSET(0xDB10C30)
#define RPG_CLIENT_PIXAIR_PIXAIRLOOTSELECTACTION_GET_NODECASE_OFFSET UNITYSDK_OFFSET(0xDB10BE0)
#define RPG_CLIENT_PIXAIR_PIXAIRLOOTSELECTACTION_SET_ENEMYID_OFFSET UNITYSDK_OFFSET(0xDB10C40)
#define RPG_CLIENT_PIXAIR_PIXAIRLOOTSELECTACTION_START_OFFSET UNITYSDK_OFFSET(0xDB10A70)
#define RPG_CLIENT_PIXAIR_PIXAIRLOOTSELECTACTION_TAKEREWARD_OFFSET UNITYSDK_OFFSET(0xDB10630)
#define RPG_CLIENT_PIXAIR_PIXAIRLOOTSELECTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xDB104B0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirLootSelectAction_TypeDefinitionIndex = 78810;
