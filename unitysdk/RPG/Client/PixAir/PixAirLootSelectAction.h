...
#define RPG_CLIENT_PIXAIR_PIXAIRLOOTSELECTACTION_FINISHSUPPLYSTAGE_OFFSET UNITYSDK_OFFSET(0x1BD04510)
#define RPG_CLIENT_PIXAIR_PIXAIRLOOTSELECTACTION_FINISH_OFFSET UNITYSDK_OFFSET(0x1BD04820)
#define RPG_CLIENT_PIXAIR_PIXAIRLOOTSELECTACTION_GETCONTENTKEY_OFFSET UNITYSDK_OFFSET(0x1BD047B0)
#define RPG_CLIENT_PIXAIR_PIXAIRLOOTSELECTACTION_GET_ENEMYID_OFFSET UNITYSDK_OFFSET(0x1BD048F0)
#define RPG_CLIENT_PIXAIR_PIXAIRLOOTSELECTACTION_GET_NODECASE_OFFSET UNITYSDK_OFFSET(0x1BD048A0)
#define RPG_CLIENT_PIXAIR_PIXAIRLOOTSELECTACTION_SET_ENEMYID_OFFSET UNITYSDK_OFFSET(0x1BD04900)
#define RPG_CLIENT_PIXAIR_PIXAIRLOOTSELECTACTION_START_OFFSET UNITYSDK_OFFSET(0x1BD04730)
#define RPG_CLIENT_PIXAIR_PIXAIRLOOTSELECTACTION_TAKEREWARD_OFFSET UNITYSDK_OFFSET(0x1BD042F0)
#define RPG_CLIENT_PIXAIR_PIXAIRLOOTSELECTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD04170)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirLootSelectAction_TypeDefinitionIndex = 78809;
	...
	public:
		...
		::System::Void _ctor(::System::UInt32 a1, ::Class_1_FDFA365FE186E8F2_24* a2)
		{
			return ((::System::Void(*)(::PVOID, ::System::UInt32, ::Class_1_FDFA365FE186E8F2_24*))((::PBYTE)hIl2Cpp + RPG_CLIENT_PIXAIR_PIXAIRLOOTSELECTACTION__CTOR_OFFSET))(this, a1, a2);
		}
