...
#define RPG_CLIENT_PIXAIR_PIXAIRTRAILPOINTPOSITIONER_PLAY_OFFSET UNITYSDK_OFFSET(0x1A0E1F40)
#define RPG_CLIENT_PIXAIR_PIXAIRTRAILPOINTPOSITIONER_SETPOINTS_OFFSET UNITYSDK_OFFSET(0x1A0E1950)
#define RPG_CLIENT_PIXAIR_PIXAIRTRAILPOINTPOSITIONER__ASSIGNBYSCREENPOS_OFFSET UNITYSDK_OFFSET(0x1A0E1E80)
#define RPG_CLIENT_PIXAIR_PIXAIRTRAILPOINTPOSITIONER__CALCULATERANDOMMIDDLESCREENPOS_OFFSET UNITYSDK_OFFSET(0x1A0E1C40)
#define RPG_CLIENT_PIXAIR_PIXAIRTRAILPOINTPOSITIONER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0E22C0)
#define RPG_CLIENT_PIXAIR_PIXAIRTRAILPOINTPOSITIONER__GETPLANERECT_OFFSET UNITYSDK_OFFSET(0x1A0E1BB0)
#define RPG_CLIENT_PIXAIR_PIXAIRTRAILPOINTPOSITIONER__GETUICAMERA_OFFSET UNITYSDK_OFFSET(0x1A0E1E00)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirTrailPointPositioner_TypeDefinitionIndex = 75364;
