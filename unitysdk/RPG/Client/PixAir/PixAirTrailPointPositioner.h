...
#define RPG_CLIENT_PIXAIR_PIXAIRTRAILPOINTPOSITIONER_PLAY_OFFSET UNITYSDK_OFFSET(0x1BD18F30)
#define RPG_CLIENT_PIXAIR_PIXAIRTRAILPOINTPOSITIONER_SETPOINTS_OFFSET UNITYSDK_OFFSET(0x1BD18940)
#define RPG_CLIENT_PIXAIR_PIXAIRTRAILPOINTPOSITIONER__ASSIGNBYSCREENPOS_OFFSET UNITYSDK_OFFSET(0x1BD18E70)
#define RPG_CLIENT_PIXAIR_PIXAIRTRAILPOINTPOSITIONER__CALCULATERANDOMMIDDLESCREENPOS_OFFSET UNITYSDK_OFFSET(0x1BD18C30)
#define RPG_CLIENT_PIXAIR_PIXAIRTRAILPOINTPOSITIONER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD192B0)
#define RPG_CLIENT_PIXAIR_PIXAIRTRAILPOINTPOSITIONER__GETPLANERECT_OFFSET UNITYSDK_OFFSET(0x1BD18BA0)
#define RPG_CLIENT_PIXAIR_PIXAIRTRAILPOINTPOSITIONER__GETUICAMERA_OFFSET UNITYSDK_OFFSET(0x1BD18DF0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirTrailPointPositioner_TypeDefinitionIndex = 78911;
