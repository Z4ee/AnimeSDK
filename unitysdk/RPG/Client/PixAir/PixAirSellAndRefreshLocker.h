...
#define RPG_CLIENT_PIXAIR_PIXAIRSELLANDREFRESHLOCKER_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0xC3E9770)
#define RPG_CLIENT_PIXAIR_PIXAIRSELLANDREFRESHLOCKER__CTOR_OFFSET UNITYSDK_OFFSET(0xC3E95B0)
#define RPG_CLIENT_PIXAIR_PIXAIRSELLANDREFRESHLOCKER__LOADCONFIG_OFFSET UNITYSDK_OFFSET(0xC3E95C0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirSellAndRefreshLocker_TypeDefinitionIndex = 73668;
