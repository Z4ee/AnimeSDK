...
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMVIEWMODEL_GET_BAGSLOTINDEX_OFFSET UNITYSDK_OFFSET(0xDAEA3F0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMVIEWMODEL_GET_BATTLESLOTINDEX_OFFSET UNITYSDK_OFFSET(0xDAEC550)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMVIEWMODEL_GET_BURNPOWER_OFFSET UNITYSDK_OFFSET(0xDAFB740)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMVIEWMODEL_GET_CDPROGRESS_OFFSET UNITYSDK_OFFSET(0xDAFB790)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMVIEWMODEL_GET_DAMAGEPOWER_OFFSET UNITYSDK_OFFSET(0xDAFB6A0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMVIEWMODEL_GET_ISLARGESLOT_OFFSET UNITYSDK_OFFSET(0xDAFB660)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMVIEWMODEL_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0xDAFB2D0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMVIEWMODEL_GET_POS_OFFSET UNITYSDK_OFFSET(0xDAFB610)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMVIEWMODEL_GET_SHIELDPOWER_OFFSET UNITYSDK_OFFSET(0xDAFB6F0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xDAEA0D0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEquipItemViewModel_TypeDefinitionIndex = 78774;

	class PixAirEquipItemViewModel : public ::Sofa::BaseViewModel
	{
	public:
		// static const ::System::UInt32 PreSlotSize = 0xB; // 0x0
		::Class_0_16E4307DCC419505_1333* _EquipPropertyGetter; // 0x20
		::Class_1_9E825E3D3A62B6E0* _EquipItem; // 0x28
		...
		::System::Void _ctor(::Class_1_9E825E3D3A62B6E0* a1, ::Class_0_16E4307DCC419505_1333* a2, ::Class_1_D031E8F06825AB4F* a3)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_9E825E3D3A62B6E0*, ::Class_0_16E4307DCC419505_1333*, ::Class_1_D031E8F06825AB4F*))((::PBYTE)hIl2Cpp + RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMVIEWMODEL__CTOR_OFFSET))(this, a1, a2, a3);
		}
