...
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMVIEWMODEL_GET_BAGSLOTINDEX_OFFSET UNITYSDK_OFFSET(0x1C830360)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMVIEWMODEL_GET_BATTLESLOTINDEX_OFFSET UNITYSDK_OFFSET(0x1C832550)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMVIEWMODEL_GET_BURNPOWER_OFFSET UNITYSDK_OFFSET(0x1C841790)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMVIEWMODEL_GET_CDPROGRESS_OFFSET UNITYSDK_OFFSET(0x1C8417E0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMVIEWMODEL_GET_DAMAGEPOWER_OFFSET UNITYSDK_OFFSET(0x1C8416F0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMVIEWMODEL_GET_ISLARGESLOT_OFFSET UNITYSDK_OFFSET(0x1C8416B0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMVIEWMODEL_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x1C841320)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMVIEWMODEL_GET_POS_OFFSET UNITYSDK_OFFSET(0x1C841660)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMVIEWMODEL_GET_SHIELDPOWER_OFFSET UNITYSDK_OFFSET(0x1C841740)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C830040)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEquipItemViewModel_TypeDefinitionIndex = 78773;
	...
	public:
		...
		::Class_1_CC76D1702CC17C09_8* _EquipProperty; // 0x30
