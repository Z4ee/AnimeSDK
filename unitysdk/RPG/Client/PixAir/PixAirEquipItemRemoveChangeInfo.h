...
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMREMOVECHANGEINFO_CREATE_OFFSET UNITYSDK_OFFSET(0xDAFB3A0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMREMOVECHANGEINFO_GET_CHANGETYPE_OFFSET UNITYSDK_OFFSET(0xDAFB450)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMREMOVECHANGEINFO_GET_POSITION_OFFSET UNITYSDK_OFFSET(0xDAFB430)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMREMOVECHANGEINFO_SET_POSITION_OFFSET UNITYSDK_OFFSET(0xDAFB440)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMREMOVECHANGEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xDAFB420)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEquipItemRemoveChangeInfo_TypeDefinitionIndex = 78794;
