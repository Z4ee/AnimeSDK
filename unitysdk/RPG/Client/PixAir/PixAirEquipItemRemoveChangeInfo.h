...
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMREMOVECHANGEINFO_CREATE_OFFSET UNITYSDK_OFFSET(0x1C8413F0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMREMOVECHANGEINFO_GET_CHANGETYPE_OFFSET UNITYSDK_OFFSET(0x1C8414A0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMREMOVECHANGEINFO_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1C841480)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMREMOVECHANGEINFO_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1C841490)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMREMOVECHANGEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1C841470)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEquipItemRemoveChangeInfo_TypeDefinitionIndex = 78793;
