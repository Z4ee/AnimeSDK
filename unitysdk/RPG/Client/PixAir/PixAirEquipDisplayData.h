...
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDISPLAYDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1C82B350)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDISPLAYDATA_GET_EQUIPDATA_OFFSET UNITYSDK_OFFSET(0x1C83C7A0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDISPLAYDATA_GET_EQUIPID_OFFSET UNITYSDK_OFFSET(0x1C83C700)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDISPLAYDATA_GET_LEVELDATA_OFFSET UNITYSDK_OFFSET(0x1C83C7C0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDISPLAYDATA_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x1C83C750)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDISPLAYDATA_SET_EQUIPDATA_OFFSET UNITYSDK_OFFSET(0x1C83C7B0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDISPLAYDATA_SET_LEVELDATA_OFFSET UNITYSDK_OFFSET(0x1C83C7D0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDISPLAYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1C83C650)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEquipDisplayData_TypeDefinitionIndex = 78820;
