...
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDISPLAYDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x19EBC9F0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDISPLAYDATA_GET_EQUIPDATA_OFFSET UNITYSDK_OFFSET(0x19ECE360)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDISPLAYDATA_GET_EQUIPID_OFFSET UNITYSDK_OFFSET(0x19ECE2C0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDISPLAYDATA_GET_LEVELDATA_OFFSET UNITYSDK_OFFSET(0x19ECE380)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDISPLAYDATA_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x19ECE310)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDISPLAYDATA_SET_EQUIPDATA_OFFSET UNITYSDK_OFFSET(0x19ECE370)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDISPLAYDATA_SET_LEVELDATA_OFFSET UNITYSDK_OFFSET(0x19ECE390)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDISPLAYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19ECE210)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEquipDisplayData_TypeDefinitionIndex = 75273;
