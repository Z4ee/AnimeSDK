...
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDISPLAYDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xDAE53E0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDISPLAYDATA_GET_EQUIPDATA_OFFSET UNITYSDK_OFFSET(0xDAF6750)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDISPLAYDATA_GET_EQUIPID_OFFSET UNITYSDK_OFFSET(0xDAF66B0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDISPLAYDATA_GET_LEVELDATA_OFFSET UNITYSDK_OFFSET(0xDAF6770)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDISPLAYDATA_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0xDAF6700)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDISPLAYDATA_SET_EQUIPDATA_OFFSET UNITYSDK_OFFSET(0xDAF6760)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDISPLAYDATA_SET_LEVELDATA_OFFSET UNITYSDK_OFFSET(0xDAF6780)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPDISPLAYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xDAF6600)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEquipDisplayData_TypeDefinitionIndex = 78821;
