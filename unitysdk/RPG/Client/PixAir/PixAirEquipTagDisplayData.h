...
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPTAGDISPLAYDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xC3BF650)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPTAGDISPLAYDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xC3C70D0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPTAGDISPLAYDATA_GET_TAGTYPE_OFFSET UNITYSDK_OFFSET(0xC3C70B0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPTAGDISPLAYDATA_SET_NAME_OFFSET UNITYSDK_OFFSET(0xC3C70E0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPTAGDISPLAYDATA_SET_TAGTYPE_OFFSET UNITYSDK_OFFSET(0xC3C70C0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPTAGDISPLAYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC3C70A0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEquipTagDisplayData_TypeDefinitionIndex = 73628;
