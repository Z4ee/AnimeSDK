...
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPTAGDISPLAYDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xDAF6530)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPTAGDISPLAYDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xDAFDDE0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPTAGDISPLAYDATA_GET_TAGTYPE_OFFSET UNITYSDK_OFFSET(0xDAFDDC0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPTAGDISPLAYDATA_SET_NAME_OFFSET UNITYSDK_OFFSET(0xDAFDDF0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPTAGDISPLAYDATA_SET_TAGTYPE_OFFSET UNITYSDK_OFFSET(0xDAFDDD0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPTAGDISPLAYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xDAFDDB0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEquipTagDisplayData_TypeDefinitionIndex = 78825;
