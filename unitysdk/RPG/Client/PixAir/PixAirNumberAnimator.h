...
#define RPG_CLIENT_PIXAIR_PIXAIRNUMBERANIMATOR_SETVALUEIMMEDIATE_OFFSET UNITYSDK_OFFSET(0x1A0D7160)
#define RPG_CLIENT_PIXAIR_PIXAIRNUMBERANIMATOR_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1A0D70D0)
#define RPG_CLIENT_PIXAIR_PIXAIRNUMBERANIMATOR_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A0D72F0)
#define RPG_CLIENT_PIXAIR_PIXAIRNUMBERANIMATOR__APPLYTEXT_OFFSET UNITYSDK_OFFSET(0x1A0D71D0)
#define RPG_CLIENT_PIXAIR_PIXAIRNUMBERANIMATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0D7480)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirNumberAnimator_TypeDefinitionIndex = 75362;
