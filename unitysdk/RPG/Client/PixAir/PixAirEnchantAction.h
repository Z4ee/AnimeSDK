...
#define RPG_CLIENT_PIXAIR_PIXAIRENCHANTACTION_CREATEENCHANTEQUIPINSTANCE_OFFSET UNITYSDK_OFFSET(0x19EC64D0)
#define RPG_CLIENT_PIXAIR_PIXAIRENCHANTACTION_DOENCHANT_OFFSET UNITYSDK_OFFSET(0x19EC62A0)
#define RPG_CLIENT_PIXAIR_PIXAIRENCHANTACTION_GETCONTENTKEY_OFFSET UNITYSDK_OFFSET(0x19EC6610)
#define RPG_CLIENT_PIXAIR_PIXAIRENCHANTACTION_GET_ENCHANTTYPE_OFFSET UNITYSDK_OFFSET(0x19EC6280)
#define RPG_CLIENT_PIXAIR_PIXAIRENCHANTACTION_GET_NODECASE_OFFSET UNITYSDK_OFFSET(0x19EC6680)
#define RPG_CLIENT_PIXAIR_PIXAIRENCHANTACTION_SET_ENCHANTTYPE_OFFSET UNITYSDK_OFFSET(0x19EC6290)
#define RPG_CLIENT_PIXAIR_PIXAIRENCHANTACTION_SKIPENCHANT_OFFSET UNITYSDK_OFFSET(0x19EC6480)
#define RPG_CLIENT_PIXAIR_PIXAIRENCHANTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19EC6250)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEnchantAction_TypeDefinitionIndex = 75256;
	...
	public:
		...
		::System::Void _ctor(::System::UInt32 a1, ::Class_1_D17272E82AE804C2_790* a2)
		{
			return ((::System::Void(*)(::PVOID, ::System::UInt32, ::Class_1_D17272E82AE804C2_790*))((::PBYTE)hIl2Cpp + RPG_CLIENT_PIXAIR_PIXAIRENCHANTACTION__CTOR_OFFSET))(this, a1, a2);
		}
