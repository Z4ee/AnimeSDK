...
#define RPG_CLIENT_PIXAIR_PIXAIRENCHANTACTION_CREATEENCHANTEQUIPINSTANCE_OFFSET UNITYSDK_OFFSET(0x1C834B20)
#define RPG_CLIENT_PIXAIR_PIXAIRENCHANTACTION_DOENCHANT_OFFSET UNITYSDK_OFFSET(0x1C8348F0)
#define RPG_CLIENT_PIXAIR_PIXAIRENCHANTACTION_GETCONTENTKEY_OFFSET UNITYSDK_OFFSET(0x1C834C60)
#define RPG_CLIENT_PIXAIR_PIXAIRENCHANTACTION_GET_ENCHANTTYPE_OFFSET UNITYSDK_OFFSET(0x1C8348D0)
#define RPG_CLIENT_PIXAIR_PIXAIRENCHANTACTION_GET_NODECASE_OFFSET UNITYSDK_OFFSET(0x1C834CD0)
#define RPG_CLIENT_PIXAIR_PIXAIRENCHANTACTION_SET_ENCHANTTYPE_OFFSET UNITYSDK_OFFSET(0x1C8348E0)
#define RPG_CLIENT_PIXAIR_PIXAIRENCHANTACTION_SKIPENCHANT_OFFSET UNITYSDK_OFFSET(0x1C834AD0)
#define RPG_CLIENT_PIXAIR_PIXAIRENCHANTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C8348A0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEnchantAction_TypeDefinitionIndex = 78803;
	...
	public:
		...
		::System::Void _ctor(::System::UInt32 a1, ::Class_1_D17272E82AE804C2_808* a2)
		{
			return ((::System::Void(*)(::PVOID, ::System::UInt32, ::Class_1_D17272E82AE804C2_808*))((::PBYTE)hIl2Cpp + RPG_CLIENT_PIXAIR_PIXAIRENCHANTACTION__CTOR_OFFSET))(this, a1, a2);
		}
