...
#define RPG_CLIENT_PIXAIR_PIXAIRENCHANTACTION_CREATEENCHANTEQUIPINSTANCE_OFFSET UNITYSDK_OFFSET(0xDAEEB20)
#define RPG_CLIENT_PIXAIR_PIXAIRENCHANTACTION_DOENCHANT_OFFSET UNITYSDK_OFFSET(0xDAEE8F0)
#define RPG_CLIENT_PIXAIR_PIXAIRENCHANTACTION_GETCONTENTKEY_OFFSET UNITYSDK_OFFSET(0xDAEEC60)
#define RPG_CLIENT_PIXAIR_PIXAIRENCHANTACTION_GET_ENCHANTTYPE_OFFSET UNITYSDK_OFFSET(0xDAEE8D0)
#define RPG_CLIENT_PIXAIR_PIXAIRENCHANTACTION_GET_NODECASE_OFFSET UNITYSDK_OFFSET(0xDAEECD0)
#define RPG_CLIENT_PIXAIR_PIXAIRENCHANTACTION_SET_ENCHANTTYPE_OFFSET UNITYSDK_OFFSET(0xDAEE8E0)
#define RPG_CLIENT_PIXAIR_PIXAIRENCHANTACTION_SKIPENCHANT_OFFSET UNITYSDK_OFFSET(0xDAEEAD0)
#define RPG_CLIENT_PIXAIR_PIXAIRENCHANTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xDAEE8A0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEnchantAction_TypeDefinitionIndex = 78804;
