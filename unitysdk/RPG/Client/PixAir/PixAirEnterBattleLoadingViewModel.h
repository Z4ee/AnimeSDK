...
class Class_1_5E111983DB4FF715;
...
#define RPG_CLIENT_PIXAIR_PIXAIRENTERBATTLELOADINGVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0x19EC66D0)
#define RPG_CLIENT_PIXAIR_PIXAIRENTERBATTLELOADINGVIEWMODEL_GET_AREAID_OFFSET UNITYSDK_OFFSET(0x19EC6AC0)
#define RPG_CLIENT_PIXAIR_PIXAIRENTERBATTLELOADINGVIEWMODEL_GET_ENEMYHEADICONPATH_OFFSET UNITYSDK_OFFSET(0x19EC6910)
#define RPG_CLIENT_PIXAIR_PIXAIRENTERBATTLELOADINGVIEWMODEL_GET_ENEMYNAME_OFFSET UNITYSDK_OFFSET(0x19EC6830)
#define RPG_CLIENT_PIXAIR_PIXAIRENTERBATTLELOADINGVIEWMODEL_GET_ENEMYTALKCONTENT_OFFSET UNITYSDK_OFFSET(0x19EC6A30)
#define RPG_CLIENT_PIXAIR_PIXAIRENTERBATTLELOADINGVIEWMODEL_GET_PLAYERNAME_OFFSET UNITYSDK_OFFSET(0x19EC67C0)
#define RPG_CLIENT_PIXAIR_PIXAIRENTERBATTLELOADINGVIEWMODEL_GET_PLAYERTALKCONTENT_OFFSET UNITYSDK_OFFSET(0x19EC69A0)
#define RPG_CLIENT_PIXAIR_PIXAIRENTERBATTLELOADINGVIEWMODEL_GET__ENEMYROUNDINFODATA_OFFSET UNITYSDK_OFFSET(0x19EC68C0)
#define RPG_CLIENT_PIXAIR_PIXAIRENTERBATTLELOADINGVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x19EC6790)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEnterBattleLoadingViewModel_TypeDefinitionIndex = 75232;

	class PixAirEnterBattleLoadingViewModel : public ::Sofa::BaseViewModel
	{
	public:
		::Class_1_68EB032547196D7A* _GameBattleRoundInfo; // 0x20
		::Class_1_5E111983DB4FF715* _BattleService; // 0x28
		::System::String* PlayerIconPath; // 0x30
