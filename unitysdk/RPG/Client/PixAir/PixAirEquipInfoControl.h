...
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFOCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC3C0CA0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFOCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC3C1280)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFOCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC3C07C0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFOCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC3C0590)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFOCONTROL__ONNEWTAGITEM_OFFSET UNITYSDK_OFFSET(0xC3C1010)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFOCONTROL__REFRESHDISPLAY_OFFSET UNITYSDK_OFFSET(0xC3C0850)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFOCONTROL__UPDATETAGS_OFFSET UNITYSDK_OFFSET(0xC3C0E30)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFOCONTROL___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC3C1310)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINFOCONTROL___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC3C12B0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEquipInfoControl_TypeDefinitionIndex = 73566;
