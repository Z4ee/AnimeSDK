...
#define RPG_CLIENT_PIXAIR_PIXAIRPLANEGHOST_CLEARONPROPERTYCHANGEDCALLBACKS_OFFSET UNITYSDK_OFFSET(0x1A0D7C80)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANEGHOST_GET_BURNCOUNT_OFFSET UNITYSDK_OFFSET(0x1A0D8130)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANEGHOST_GET_CURRENTHP_OFFSET UNITYSDK_OFFSET(0x1A0D7F90)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANEGHOST_GET_HPPERCENT_OFFSET UNITYSDK_OFFSET(0x1A0D8200)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANEGHOST_GET_MAXHP_OFFSET UNITYSDK_OFFSET(0x1A0D7EE0)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANEGHOST_GET_SHIELD_OFFSET UNITYSDK_OFFSET(0x1A0D8060)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANEGHOST_INITFROMENTITY_OFFSET UNITYSDK_OFFSET(0x1A0CA280)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANEGHOST_NOTIFYPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1A0D7D20)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANEGHOST_REGISTERONPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1A0D7B00)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANEGHOST_SET_BURNCOUNT_OFFSET UNITYSDK_OFFSET(0x1A0D8170)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANEGHOST_SET_CURRENTHP_OFFSET UNITYSDK_OFFSET(0x1A0D7FD0)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANEGHOST_SET_MAXHP_OFFSET UNITYSDK_OFFSET(0x1A0D7F20)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANEGHOST_SET_SHIELD_OFFSET UNITYSDK_OFFSET(0x1A0D80A0)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANEGHOST_SYNCFROMENTITY_OFFSET UNITYSDK_OFFSET(0x1A0CAA70)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANEGHOST_UNREGISTERONPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1A0D7C10)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANEGHOST__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0CA640)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirPlaneGhost_TypeDefinitionIndex = 75167;
