...
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_PIXAIRBATTLEREPORTINFO_GET_PLANEINFO_OFFSET UNITYSDK_OFFSET(0x166160)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_PIXAIRBATTLEREPORTINFO_GET_STAGEINFO_OFFSET UNITYSDK_OFFSET(0x39EC320)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_PIXAIRBATTLEREPORTINFO_SET_PLANEINFO_OFFSET UNITYSDK_OFFSET(0x165E50)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_PIXAIRBATTLEREPORTINFO_SET_STAGEINFO_OFFSET UNITYSDK_OFFSET(0x39EC340)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirGameSession_PixAirBattleReportInfo_TypeDefinitionIndex = 75325;
