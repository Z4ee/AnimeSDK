...
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_PIXAIRBATTLEREPORTINFO_GET_PLANEINFO_OFFSET UNITYSDK_OFFSET(0x13E50)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_PIXAIRBATTLEREPORTINFO_GET_STAGEINFO_OFFSET UNITYSDK_OFFSET(0x3B8DE70)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_PIXAIRBATTLEREPORTINFO_SET_PLANEINFO_OFFSET UNITYSDK_OFFSET(0x13C50)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_PIXAIRBATTLEREPORTINFO_SET_STAGEINFO_OFFSET UNITYSDK_OFFSET(0x3B8DE90)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirGameSession_PixAirBattleReportInfo_TypeDefinitionIndex = 78872;
