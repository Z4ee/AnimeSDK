...
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_PIXAIRBATTLEREPORTINFO_GET_PLANEINFO_OFFSET UNITYSDK_OFFSET(0x154DE0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_PIXAIRBATTLEREPORTINFO_GET_STAGEINFO_OFFSET UNITYSDK_OFFSET(0x154E10)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_PIXAIRBATTLEREPORTINFO_SET_PLANEINFO_OFFSET UNITYSDK_OFFSET(0x154E00)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_PIXAIRBATTLEREPORTINFO_SET_STAGEINFO_OFFSET UNITYSDK_OFFSET(0x154E30)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirGameSession_PixAirBattleReportInfo_TypeDefinitionIndex = 78873;
