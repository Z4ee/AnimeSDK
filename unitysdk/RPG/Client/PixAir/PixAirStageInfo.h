...
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_CLEARDOINGSTAGEID_OFFSET UNITYSDK_OFFSET(0xC3DD5A0)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_CONTAINS_OFFSET UNITYSDK_OFFSET(0xC3EA9F0)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_GETALLSTAGEDATA_OFFSET UNITYSDK_OFFSET(0xC3D6F00)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_GETMAXUNLOCKSTAGE_OFFSET UNITYSDK_OFFSET(0xC3EB310)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_GETSORTEDNORMALSTAGELIST_OFFSET UNITYSDK_OFFSET(0xC3EAF10)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_GETSTAGEDATA_OFFSET UNITYSDK_OFFSET(0xC3DD2D0)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_GETUNLOCKCHALLENGESTAGEDATA_OFFSET UNITYSDK_OFFSET(0xC3EABE0)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_GET_COUNT_OFFSET UNITYSDK_OFFSET(0xC3EA8D0)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_GET_DOINGCOREEQUIPID_OFFSET UNITYSDK_OFFSET(0xC3EA8B0)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_GET_DOINGPLANEID_OFFSET UNITYSDK_OFFSET(0xC3EA890)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_GET_DOINGSTAGEAREA_OFFSET UNITYSDK_OFFSET(0xC3EA830)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_GET_DOINGSTAGECOIN_OFFSET UNITYSDK_OFFSET(0xC3EA870)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_GET_DOINGSTAGEID_OFFSET UNITYSDK_OFFSET(0xC3EA810)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_GET_DOINGSTAGELIFE_OFFSET UNITYSDK_OFFSET(0xC3EA850)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_INIT_OFFSET UNITYSDK_OFFSET(0xC3DEB30)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_ISCHALLENGESTAGEPREMISSIONUNLOCK_OFFSET UNITYSDK_OFFSET(0xC3EAA80)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_SET_DOINGCOREEQUIPID_OFFSET UNITYSDK_OFFSET(0xC3EA8C0)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_SET_DOINGPLANEID_OFFSET UNITYSDK_OFFSET(0xC3EA8A0)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_SET_DOINGSTAGEAREA_OFFSET UNITYSDK_OFFSET(0xC3EA840)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_SET_DOINGSTAGECOIN_OFFSET UNITYSDK_OFFSET(0xC3EA880)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_SET_DOINGSTAGEID_OFFSET UNITYSDK_OFFSET(0xC3EA820)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_SET_DOINGSTAGELIFE_OFFSET UNITYSDK_OFFSET(0xC3EA860)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_SYNCDOINGSTAGEID_OFFSET UNITYSDK_OFFSET(0xC3DDA90)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_SYNCFINISHEDSTAGEIDLIST_OFFSET UNITYSDK_OFFSET(0xC3DA670)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_SYNCFINISHEDSTAGEID_OFFSET UNITYSDK_OFFSET(0xC3DD520)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_SYNC_OFFSET UNITYSDK_OFFSET(0xC3DA350)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO_TRYGETSTAGEDATA_OFFSET UNITYSDK_OFFSET(0xC3EA920)
#define RPG_CLIENT_PIXAIR_PIXAIRSTAGEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xC3DEB20)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirStageInfo_TypeDefinitionIndex = 73698;
	...
	public:
		...
		::System::UInt32 _DoingStageArea_k__BackingField; // 0x1C
		::System::UInt32 _DoingPlaneID_k__BackingField; // 0x20
		::System::UInt32 _DoingCoreEquipID_k__BackingField; // 0x24
		::System::UInt32 _DoingStageID_k__BackingField; // 0x28
		::System::UInt32 _DoingStageLife_k__BackingField; // 0x2C
