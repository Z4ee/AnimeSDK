...
#define RPG_CLIENT_PIXAIR_PIXAIRTRAILPOINTPOSITIONER___C__DISPLAYCLASS10_0__CTOR_OFFSET UNITYSDK_OFFSET(0xDB25590)
#define RPG_CLIENT_PIXAIR_PIXAIRTRAILPOINTPOSITIONER___C__DISPLAYCLASS10_0__PLAY_B__0_OFFSET UNITYSDK_OFFSET(0xDB255B0)
#define RPG_CLIENT_PIXAIR_PIXAIRTRAILPOINTPOSITIONER___C__DISPLAYCLASS10_0__PLAY_B__1_OFFSET UNITYSDK_OFFSET(0xDB255F0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirTrailPointPositioner___c__DisplayClass10_0_TypeDefinitionIndex = 78913;

	class PixAirTrailPointPositioner___c__DisplayClass10_0 : public ::System::Object
	{
	public:
		::System::Action* onComplete; // 0x10
		::RPG::Client::MonoAnimationTrigger* animTrigger; // 0x18
		...
		::System::Action_1<::System::String*>* onAnimEvent; // 0x38
