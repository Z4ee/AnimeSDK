...
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_CALCULATESKILLDESCRIPTIONLIST_OFFSET UNITYSDK_OFFSET(0x19ED90F0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_CLEARONPROPERTYCHANGEDCALLBACKS_OFFSET UNITYSDK_OFFSET(0x19ED75E0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_BURNPOWER_OFFSET UNITYSDK_OFFSET(0x19ED7260)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_CDPROGRESS_OFFSET UNITYSDK_OFFSET(0x19ED7310)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_COOLDOWN_OFFSET UNITYSDK_OFFSET(0x19ED0140)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_CURRENTCD_OFFSET UNITYSDK_OFFSET(0x19ED7C30)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_DAMAGEPOWER_OFFSET UNITYSDK_OFFSET(0x19ED71E0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_DISPLAYTAGS_OFFSET UNITYSDK_OFFSET(0x19ED7DB0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_EQUIPMENTID_OFFSET UNITYSDK_OFFSET(0x19ED6F90)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x19ED0000)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_ISCDRESET_OFFSET UNITYSDK_OFFSET(0x19ED81E0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_ISCORE_OFFSET UNITYSDK_OFFSET(0x19ED81C0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_ISPLAYEREQUIPPED_OFFSET UNITYSDK_OFFSET(0x19ED8160)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_LEFTMOSTINDEX_OFFSET UNITYSDK_OFFSET(0x19ED81A0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19ECFF50)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_NEEDPLAYJAMEFFECT_OFFSET UNITYSDK_OFFSET(0x19ED8200)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_NEEDSTOPJAMEFFECT_OFFSET UNITYSDK_OFFSET(0x19ED8220)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_RUNTIMEUNIQUEID_OFFSET UNITYSDK_OFFSET(0x19ED73E0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_SHIELDPOWER_OFFSET UNITYSDK_OFFSET(0x19ED7220)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x19ED8180)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_SKILLDESCRIPTIONLIST_OFFSET UNITYSDK_OFFSET(0x19ED7AF0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_SKILLDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x19ED0100)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_STARLEVEL_OFFSET UNITYSDK_OFFSET(0x19ED00B0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_TAGS_OFFSET UNITYSDK_OFFSET(0x19ED0190)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_INITFROMENTITY_OFFSET UNITYSDK_OFFSET(0x19ED8240)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_NOTIFYPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x19ED7680)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_REGISTERONPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x19ED7460)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_BURNPOWER_OFFSET UNITYSDK_OFFSET(0x19ED8030)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_CDPROGRESS_OFFSET UNITYSDK_OFFSET(0x19ED80C0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_COOLDOWN_OFFSET UNITYSDK_OFFSET(0x19ED7BC0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_CURRENTCD_OFFSET UNITYSDK_OFFSET(0x19ED7C80)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_DAMAGEPOWER_OFFSET UNITYSDK_OFFSET(0x19ED7F10)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_EQUIPMENTID_OFFSET UNITYSDK_OFFSET(0x19ED7840)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x19ED78B0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_ISCDRESET_OFFSET UNITYSDK_OFFSET(0x19ED81F0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_ISCORE_OFFSET UNITYSDK_OFFSET(0x19ED81D0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_ISPLAYEREQUIPPED_OFFSET UNITYSDK_OFFSET(0x19ED8170)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_LEFTMOSTINDEX_OFFSET UNITYSDK_OFFSET(0x19ED81B0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_NAME_OFFSET UNITYSDK_OFFSET(0x19ED79D0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_NEEDPLAYJAMEFFECT_OFFSET UNITYSDK_OFFSET(0x19ED8210)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_NEEDSTOPJAMEFFECT_OFFSET UNITYSDK_OFFSET(0x19ED8230)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_RUNTIMEUNIQUEID_OFFSET UNITYSDK_OFFSET(0x19ED73F0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_SHIELDPOWER_OFFSET UNITYSDK_OFFSET(0x19ED7FA0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_SIZE_OFFSET UNITYSDK_OFFSET(0x19ED8190)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_SKILLDESCRIPTIONLIST_OFFSET UNITYSDK_OFFSET(0x19ED7B30)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_SKILLDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x19ED7A60)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_STARLEVEL_OFFSET UNITYSDK_OFFSET(0x19ED7940)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_TAGS_OFFSET UNITYSDK_OFFSET(0x19ED7D20)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SYNCFROMENTITY_OFFSET UNITYSDK_OFFSET(0x19ED99E0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_UNREGISTERONPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x19ED7570)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST__CTOR_OFFSET UNITYSDK_OFFSET(0x19ED7400)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEquipmentGhost_TypeDefinitionIndex = 75164;

	class PixAirEquipmentGhost : public ::RPG::Client::PixAir::PixAirGhostBase
	{
	public:
		::System::Collections::Generic::List_1<::System::String*>* _SkillDescriptionList; // 0x20
		::Il2CppArray<::RPG::GameCore::PixAirEquipTag>* _Tags; // 0x28
		::System::String* _IconPath; // 0x30
		::System::String* _Name; // 0x38
		::System::String* _SkillDescription; // 0x40
		::System::Collections::Generic::List_1<::System::Action*>* _onPropertyChangedCallbacks; // 0x48
		::System::Single _CoolDown; // 0x50
		::System::Int32 _BurnPower; // 0x54
		::System::Int32 _RuntimeUniqueID_k__BackingField; // 0x58
		::RPG::GameCore::PixAirSlotType _Size_k__BackingField; // 0x5C
		::System::Boolean _IsCDReset_k__BackingField; // 0x60
		::System::Boolean _NeedStopJamEffect_k__BackingField; // 0x61
		::System::Boolean _IsPlayerEquipped_k__BackingField; // 0x62
		::System::Boolean _IsLastFramJammed; // 0x63
		::System::Boolean _NeedPlayJamEffect_k__BackingField; // 0x64
		::System::Boolean _IsCore_k__BackingField; // 0x65
		::System::Int32 _EquipmentID; // 0x68
		::System::Int32 _LeftMostIndex_k__BackingField; // 0x6C
		::System::Int32 _DamagePower; // 0x70
		::RPG::GameCore::PixAirEnchantmentType _EnchantType; // 0x74
		::System::Int32 _ShieldPower; // 0x78
		::System::Single _CDProgress; // 0x7C
		::System::Single _CurrentCD; // 0x80
		::System::Int32 _StarLevel; // 0x84
