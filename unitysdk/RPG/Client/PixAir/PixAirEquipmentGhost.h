...
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_CALCULATESKILLDESCRIPTIONLIST_OFFSET UNITYSDK_OFFSET(0xDB013F0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_CLEARONPROPERTYCHANGEDCALLBACKS_OFFSET UNITYSDK_OFFSET(0xDAFF980)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_BURNPOWER_OFFSET UNITYSDK_OFFSET(0xDAFF5D0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_CDPROGRESS_OFFSET UNITYSDK_OFFSET(0xDAFF690)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_COOLDOWN_OFFSET UNITYSDK_OFFSET(0xDAF84F0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_CURRENTCD_OFFSET UNITYSDK_OFFSET(0xDAFFF90)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_DAMAGEPOWER_OFFSET UNITYSDK_OFFSET(0xDAFF550)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_DISPLAYTAGS_OFFSET UNITYSDK_OFFSET(0xDB00110)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_EQUIPMENTID_OFFSET UNITYSDK_OFFSET(0xDAFF300)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xDAF83C0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_ISCDRESET_OFFSET UNITYSDK_OFFSET(0xDB00540)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_ISCORE_OFFSET UNITYSDK_OFFSET(0xDB00520)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_ISPLAYEREQUIPPED_OFFSET UNITYSDK_OFFSET(0xDB004C0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_LEFTMOSTINDEX_OFFSET UNITYSDK_OFFSET(0xDB00500)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_NAME_OFFSET UNITYSDK_OFFSET(0xDAF8310)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_NEEDPLAYJAMEFFECT_OFFSET UNITYSDK_OFFSET(0xDB00560)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_NEEDSTOPJAMEFFECT_OFFSET UNITYSDK_OFFSET(0xDB00580)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_RUNTIMEUNIQUEID_OFFSET UNITYSDK_OFFSET(0xDAFF760)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_SHIELDPOWER_OFFSET UNITYSDK_OFFSET(0xDAFF590)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_SIZE_OFFSET UNITYSDK_OFFSET(0xDB004E0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_SKILLDESCRIPTIONLIST_OFFSET UNITYSDK_OFFSET(0xDAFFE50)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_SKILLDESCRIPTION_OFFSET UNITYSDK_OFFSET(0xDAF84B0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_STARLEVEL_OFFSET UNITYSDK_OFFSET(0xDAF8470)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_TAGS_OFFSET UNITYSDK_OFFSET(0xDAF8540)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_INITFROMENTITY_OFFSET UNITYSDK_OFFSET(0xDB005A0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_NOTIFYPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0xDAFFA20)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_REGISTERONPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0xDAFF800)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_BURNPOWER_OFFSET UNITYSDK_OFFSET(0xDB00390)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_CDPROGRESS_OFFSET UNITYSDK_OFFSET(0xDB00420)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_COOLDOWN_OFFSET UNITYSDK_OFFSET(0xDAFFF20)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_CURRENTCD_OFFSET UNITYSDK_OFFSET(0xDAFFFE0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_DAMAGEPOWER_OFFSET UNITYSDK_OFFSET(0xDB00270)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_EQUIPMENTID_OFFSET UNITYSDK_OFFSET(0xDAFFBE0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xDAFFC50)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_ISCDRESET_OFFSET UNITYSDK_OFFSET(0xDB00550)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_ISCORE_OFFSET UNITYSDK_OFFSET(0xDB00530)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_ISPLAYEREQUIPPED_OFFSET UNITYSDK_OFFSET(0xDB004D0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_LEFTMOSTINDEX_OFFSET UNITYSDK_OFFSET(0xDB00510)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_NAME_OFFSET UNITYSDK_OFFSET(0xDAFFD50)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_NEEDPLAYJAMEFFECT_OFFSET UNITYSDK_OFFSET(0xDB00570)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_NEEDSTOPJAMEFFECT_OFFSET UNITYSDK_OFFSET(0xDB00590)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_RUNTIMEUNIQUEID_OFFSET UNITYSDK_OFFSET(0xDAFF770)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_SHIELDPOWER_OFFSET UNITYSDK_OFFSET(0xDB00300)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_SIZE_OFFSET UNITYSDK_OFFSET(0xDB004F0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_SKILLDESCRIPTIONLIST_OFFSET UNITYSDK_OFFSET(0xDAFFE90)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_SKILLDESCRIPTION_OFFSET UNITYSDK_OFFSET(0xDAFFDC0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_STARLEVEL_OFFSET UNITYSDK_OFFSET(0xDAFFCC0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_TAGS_OFFSET UNITYSDK_OFFSET(0xDB00080)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SYNCFROMENTITY_OFFSET UNITYSDK_OFFSET(0xDB01CD0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_UNREGISTERONPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0xDAFF910)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST__CTOR_OFFSET UNITYSDK_OFFSET(0xDAFF780)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEquipmentGhost_TypeDefinitionIndex = 78712;

	class PixAirEquipmentGhost : public ::RPG::Client::PixAir::PixAirGhostBase
	{
	public:
		::System::String* _SkillDescription; // 0x20
		...
		::System::String* _IconPath; // 0x38
		::System::Collections::Generic::List_1<::System::Action*>* _onPropertyChangedCallbacks; // 0x40
		::System::String* _Name; // 0x48
		::System::Boolean _IsCore_k__BackingField; // 0x50
		::System::Boolean _IsCDReset_k__BackingField; // 0x51
		::System::Boolean _IsPlayerEquipped_k__BackingField; // 0x52
		::System::Boolean _NeedStopJamEffect_k__BackingField; // 0x53
		::System::Single _CurrentCD; // 0x54
		::System::Int32 _StarLevel; // 0x58
		::System::Single _CDProgress; // 0x5C
		::System::Int32 _ShieldPower; // 0x60
		::System::Boolean _NeedPlayJamEffect_k__BackingField; // 0x64
		::System::Boolean _IsLastFramJammed; // 0x65
		::RPG::GameCore::PixAirEnchantmentType _EnchantType; // 0x68
		::RPG::GameCore::PixAirSlotType _Size_k__BackingField; // 0x6C
		::System::Int32 _LeftMostIndex_k__BackingField; // 0x70
		::System::Int32 _DamagePower; // 0x74
		::System::Single _CoolDown; // 0x78
		::System::Int32 _EquipmentID; // 0x7C
		::System::Int32 _RuntimeUniqueID_k__BackingField; // 0x80
		::System::Int32 _BurnPower; // 0x84
