...
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_CALCULATESKILLDESCRIPTIONLIST_OFFSET UNITYSDK_OFFSET(0x1C847420)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_CLEARONPROPERTYCHANGEDCALLBACKS_OFFSET UNITYSDK_OFFSET(0x1C8459B0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_BURNPOWER_OFFSET UNITYSDK_OFFSET(0x1C845610)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_CDPROGRESS_OFFSET UNITYSDK_OFFSET(0x1C8456D0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_COOLDOWN_OFFSET UNITYSDK_OFFSET(0x1C83E550)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_CURRENTCD_OFFSET UNITYSDK_OFFSET(0x1C845FC0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_DAMAGEPOWER_OFFSET UNITYSDK_OFFSET(0x1C845590)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_DISPLAYTAGS_OFFSET UNITYSDK_OFFSET(0x1C846140)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_EQUIPMENTID_OFFSET UNITYSDK_OFFSET(0x1C845340)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x1C83E410)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_ISCDRESET_OFFSET UNITYSDK_OFFSET(0x1C846570)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_ISCORE_OFFSET UNITYSDK_OFFSET(0x1C846550)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_ISPLAYEREQUIPPED_OFFSET UNITYSDK_OFFSET(0x1C8464F0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_LEFTMOSTINDEX_OFFSET UNITYSDK_OFFSET(0x1C846530)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1C83E360)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_NEEDPLAYJAMEFFECT_OFFSET UNITYSDK_OFFSET(0x1C846590)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_NEEDSTOPJAMEFFECT_OFFSET UNITYSDK_OFFSET(0x1C8465B0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_RUNTIMEUNIQUEID_OFFSET UNITYSDK_OFFSET(0x1C8457A0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_SHIELDPOWER_OFFSET UNITYSDK_OFFSET(0x1C8455D0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x1C846510)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_SKILLDESCRIPTIONLIST_OFFSET UNITYSDK_OFFSET(0x1C845E80)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_SKILLDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1C83E510)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_STARLEVEL_OFFSET UNITYSDK_OFFSET(0x1C83E4C0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_GET_TAGS_OFFSET UNITYSDK_OFFSET(0x1C83E5A0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_INITFROMENTITY_OFFSET UNITYSDK_OFFSET(0x1C8465D0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_NOTIFYPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1C845A50)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_REGISTERONPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1C845830)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_BURNPOWER_OFFSET UNITYSDK_OFFSET(0x1C8463C0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_CDPROGRESS_OFFSET UNITYSDK_OFFSET(0x1C846450)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_COOLDOWN_OFFSET UNITYSDK_OFFSET(0x1C845F50)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_CURRENTCD_OFFSET UNITYSDK_OFFSET(0x1C846010)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_DAMAGEPOWER_OFFSET UNITYSDK_OFFSET(0x1C8462A0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_EQUIPMENTID_OFFSET UNITYSDK_OFFSET(0x1C845C10)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x1C845C80)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_ISCDRESET_OFFSET UNITYSDK_OFFSET(0x1C846580)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_ISCORE_OFFSET UNITYSDK_OFFSET(0x1C846560)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_ISPLAYEREQUIPPED_OFFSET UNITYSDK_OFFSET(0x1C846500)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_LEFTMOSTINDEX_OFFSET UNITYSDK_OFFSET(0x1C846540)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1C845D80)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_NEEDPLAYJAMEFFECT_OFFSET UNITYSDK_OFFSET(0x1C8465A0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_NEEDSTOPJAMEFFECT_OFFSET UNITYSDK_OFFSET(0x1C8465C0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_RUNTIMEUNIQUEID_OFFSET UNITYSDK_OFFSET(0x1C8457B0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_SHIELDPOWER_OFFSET UNITYSDK_OFFSET(0x1C846330)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_SIZE_OFFSET UNITYSDK_OFFSET(0x1C846520)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_SKILLDESCRIPTIONLIST_OFFSET UNITYSDK_OFFSET(0x1C845EC0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_SKILLDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1C845DF0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_STARLEVEL_OFFSET UNITYSDK_OFFSET(0x1C845CF0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SET_TAGS_OFFSET UNITYSDK_OFFSET(0x1C8460B0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_SYNCFROMENTITY_OFFSET UNITYSDK_OFFSET(0x1C847D10)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST_UNREGISTERONPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1C845940)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPMENTGHOST__CTOR_OFFSET UNITYSDK_OFFSET(0x1C8457C0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEquipmentGhost_TypeDefinitionIndex = 78711;

	class PixAirEquipmentGhost : public ::RPG::Client::PixAir::PixAirGhostBase
	{
	public:
		::Il2CppArray<::RPG::GameCore::PixAirEquipTag>* _Tags; // 0x20
		...
		::System::String* _IconPath; // 0x40
		::System::String* _SkillDescription; // 0x48
		::System::Single _CDProgress; // 0x50
		::System::Single _CoolDown; // 0x54
		::System::Int32 _ShieldPower; // 0x58
		::System::Single _CurrentCD; // 0x5C
		::System::Int32 _RuntimeUniqueID_k__BackingField; // 0x60
		::System::Int32 _LeftMostIndex_k__BackingField; // 0x64
		::System::Boolean _IsCDReset_k__BackingField; // 0x68
		::System::Boolean _NeedPlayJamEffect_k__BackingField; // 0x69
		::RPG::GameCore::PixAirEnchantmentType _EnchantType; // 0x6C
		::System::Int32 _DamagePower; // 0x70
		::System::Boolean _NeedStopJamEffect_k__BackingField; // 0x74
		::System::Boolean _IsPlayerEquipped_k__BackingField; // 0x75
		::System::Boolean _IsCore_k__BackingField; // 0x76
