...
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMSWAPCHANGEINFO_CREATE_OFFSET UNITYSDK_OFFSET(0x19ED3120)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMSWAPCHANGEINFO_GET_CHANGETYPE_OFFSET UNITYSDK_OFFSET(0x19ED31E0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMSWAPCHANGEINFO_GET_SRCITEM_OFFSET UNITYSDK_OFFSET(0x19ED3260)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMSWAPCHANGEINFO_GET_SRCPOS_OFFSET UNITYSDK_OFFSET(0x19ED3220)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMSWAPCHANGEINFO_GET_TARGETITEM_OFFSET UNITYSDK_OFFSET(0x19ED3280)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMSWAPCHANGEINFO_GET_TARGETPOS_OFFSET UNITYSDK_OFFSET(0x19ED3240)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMSWAPCHANGEINFO_SET_SRCITEM_OFFSET UNITYSDK_OFFSET(0x19ED3270)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMSWAPCHANGEINFO_SET_SRCPOS_OFFSET UNITYSDK_OFFSET(0x19ED3230)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMSWAPCHANGEINFO_SET_TARGETITEM_OFFSET UNITYSDK_OFFSET(0x19ED3290)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMSWAPCHANGEINFO_SET_TARGETPOS_OFFSET UNITYSDK_OFFSET(0x19ED3250)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMSWAPCHANGEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19ED31D0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEquipItemSwapChangeInfo_TypeDefinitionIndex = 75245;
