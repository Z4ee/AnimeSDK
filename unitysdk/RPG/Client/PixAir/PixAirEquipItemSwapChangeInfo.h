...
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMSWAPCHANGEINFO_CREATE_OFFSET UNITYSDK_OFFSET(0xC3C4B40)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMSWAPCHANGEINFO_GET_CHANGETYPE_OFFSET UNITYSDK_OFFSET(0xC3C4C00)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMSWAPCHANGEINFO_GET_SRCITEM_OFFSET UNITYSDK_OFFSET(0xC3C4C50)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMSWAPCHANGEINFO_GET_SRCPOS_OFFSET UNITYSDK_OFFSET(0xC3C4C10)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMSWAPCHANGEINFO_GET_TARGETITEM_OFFSET UNITYSDK_OFFSET(0xC3C4C70)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMSWAPCHANGEINFO_GET_TARGETPOS_OFFSET UNITYSDK_OFFSET(0xC3C4C30)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMSWAPCHANGEINFO_SET_SRCITEM_OFFSET UNITYSDK_OFFSET(0xC3C4C60)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMSWAPCHANGEINFO_SET_SRCPOS_OFFSET UNITYSDK_OFFSET(0xC3C4C20)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMSWAPCHANGEINFO_SET_TARGETITEM_OFFSET UNITYSDK_OFFSET(0xC3C4C80)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMSWAPCHANGEINFO_SET_TARGETPOS_OFFSET UNITYSDK_OFFSET(0xC3C4C40)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMSWAPCHANGEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xC3C4BF0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEquipItemSwapChangeInfo_TypeDefinitionIndex = 73596;
	...
	public:
		...
		::RPG::Client::PixAir::PixAirEquipItemChangeType _ChangeType; // 0x20
