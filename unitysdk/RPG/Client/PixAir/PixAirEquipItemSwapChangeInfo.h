...
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMSWAPCHANGEINFO_CREATE_OFFSET UNITYSDK_OFFSET(0xDAFB490)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMSWAPCHANGEINFO_GET_CHANGETYPE_OFFSET UNITYSDK_OFFSET(0xDAFB550)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMSWAPCHANGEINFO_GET_SRCITEM_OFFSET UNITYSDK_OFFSET(0xDAFB5D0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMSWAPCHANGEINFO_GET_SRCPOS_OFFSET UNITYSDK_OFFSET(0xDAFB590)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMSWAPCHANGEINFO_GET_TARGETITEM_OFFSET UNITYSDK_OFFSET(0xDAFB5F0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMSWAPCHANGEINFO_GET_TARGETPOS_OFFSET UNITYSDK_OFFSET(0xDAFB5B0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMSWAPCHANGEINFO_SET_SRCITEM_OFFSET UNITYSDK_OFFSET(0xDAFB5E0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMSWAPCHANGEINFO_SET_SRCPOS_OFFSET UNITYSDK_OFFSET(0xDAFB5A0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMSWAPCHANGEINFO_SET_TARGETITEM_OFFSET UNITYSDK_OFFSET(0xDAFB600)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMSWAPCHANGEINFO_SET_TARGETPOS_OFFSET UNITYSDK_OFFSET(0xDAFB5C0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMSWAPCHANGEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xDAFB540)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEquipItemSwapChangeInfo_TypeDefinitionIndex = 78793;

	class PixAirEquipItemSwapChangeInfo : public ::System::Object
	{
	public:
		::RPG::Client::PixAir::PixAirEquipInstance* _SrcItem_k__BackingField; // 0x10
		::RPG::Client::PixAir::PixAirEquipInstance* _TargetItem_k__BackingField; // 0x18
