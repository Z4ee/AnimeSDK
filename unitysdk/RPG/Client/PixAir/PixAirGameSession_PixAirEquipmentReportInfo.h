...
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_PIXAIREQUIPMENTREPORTINFO_GET_ENCHANT_OFFSET UNITYSDK_OFFSET(0x6EF0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_PIXAIREQUIPMENTREPORTINFO_GET_ID_OFFSET UNITYSDK_OFFSET(0x5FB0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_PIXAIREQUIPMENTREPORTINFO_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x6EE0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_PIXAIREQUIPMENTREPORTINFO_GET_TAGLIST_OFFSET UNITYSDK_OFFSET(0x60D0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_PIXAIREQUIPMENTREPORTINFO_SET_ENCHANT_OFFSET UNITYSDK_OFFSET(0x6F00)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_PIXAIREQUIPMENTREPORTINFO_SET_ID_OFFSET UNITYSDK_OFFSET(0x2C4C0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_PIXAIREQUIPMENTREPORTINFO_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0x2A90)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESESSION_PIXAIREQUIPMENTREPORTINFO_SET_TAGLIST_OFFSET UNITYSDK_OFFSET(0x95B0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirGameSession_PixAirEquipmentReportInfo_TypeDefinitionIndex = 73673;
