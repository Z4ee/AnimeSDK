...
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSCONTROL_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1A0DAA80)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0DAFE0)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1A0D9DC0)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1A0D9CE0)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSCONTROL__REFRESHDISPLAY_OFFSET UNITYSDK_OFFSET(0x1A0DA840)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSCONTROL__UPDATEHPBAR_OFFSET UNITYSDK_OFFSET(0x1A0DAE50)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirPlaneStatusControl_TypeDefinitionIndex = 75217;
