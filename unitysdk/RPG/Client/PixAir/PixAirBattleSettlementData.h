...
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLESETTLEMENTDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xDAECBC0)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLESETTLEMENTDATA_GET_ENEMYSTATISTICS_OFFSET UNITYSDK_OFFSET(0xDAECCA0)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLESETTLEMENTDATA_GET_ISWIN_OFFSET UNITYSDK_OFFSET(0xDAECC60)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLESETTLEMENTDATA_GET_PLAYERSTATISTICS_OFFSET UNITYSDK_OFFSET(0xDAECC80)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLESETTLEMENTDATA_SET_ENEMYSTATISTICS_OFFSET UNITYSDK_OFFSET(0xDAECCB0)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLESETTLEMENTDATA_SET_ISWIN_OFFSET UNITYSDK_OFFSET(0xDAECC70)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLESETTLEMENTDATA_SET_PLAYERSTATISTICS_OFFSET UNITYSDK_OFFSET(0xDAECC90)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLESETTLEMENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xDAECC50)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirBattleSettlementData_TypeDefinitionIndex = 78878;
