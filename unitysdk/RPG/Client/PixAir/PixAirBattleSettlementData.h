...
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLESETTLEMENTDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x19EC4380)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLESETTLEMENTDATA_GET_ENEMYSTATISTICS_OFFSET UNITYSDK_OFFSET(0x19EC4460)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLESETTLEMENTDATA_GET_ISWIN_OFFSET UNITYSDK_OFFSET(0x19EC4420)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLESETTLEMENTDATA_GET_PLAYERSTATISTICS_OFFSET UNITYSDK_OFFSET(0x19EC4440)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLESETTLEMENTDATA_SET_ENEMYSTATISTICS_OFFSET UNITYSDK_OFFSET(0x19EC4470)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLESETTLEMENTDATA_SET_ISWIN_OFFSET UNITYSDK_OFFSET(0x19EC4430)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLESETTLEMENTDATA_SET_PLAYERSTATISTICS_OFFSET UNITYSDK_OFFSET(0x19EC4450)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLESETTLEMENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19EC4410)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirBattleSettlementData_TypeDefinitionIndex = 75330;
