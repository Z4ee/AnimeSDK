...
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_CLONE_1_OFFSET UNITYSDK_OFFSET(0x1C83FE20)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_CLONE_OFFSET UNITYSDK_OFFSET(0x1C83FDD0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_CREATEUPGRADE_OFFSET UNITYSDK_OFFSET(0x1C834B80)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GETSKILLDESCLIST_OFFSET UNITYSDK_OFFSET(0x1C83E9C0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GETSKILLDESC_OFFSET UNITYSDK_OFFSET(0x1C83E910)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_ADDITIONALBURNPOWER_OFFSET UNITYSDK_OFFSET(0x1C83F790)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_ADDITIONALDAMAGEPOWER_OFFSET UNITYSDK_OFFSET(0x1C83F750)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_ADDITIONALJAMPOWER_OFFSET UNITYSDK_OFFSET(0x1C83F7F0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_ADDITIONALMULTICASTPOWER_OFFSET UNITYSDK_OFFSET(0x1C83F7B0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_ADDITIONALSHIELDPOWER_OFFSET UNITYSDK_OFFSET(0x1C83F770)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_BASECOOLDOWNREDUCTION_OFFSET UNITYSDK_OFFSET(0x1C83F7D0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_BURNBOOSTPERCENT_OFFSET UNITYSDK_OFFSET(0x1C83F850)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_BURNFROMDAMAGEPERCENT_OFFSET UNITYSDK_OFFSET(0x1C83F8F0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_BURNFROMSHIELDPERCENT_OFFSET UNITYSDK_OFFSET(0x1C83F910)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_BURNPOWER_OFFSET UNITYSDK_OFFSET(0x1C83F490)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_COOLDOWN_OFFSET UNITYSDK_OFFSET(0x1C83F630)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_DAMAGEBOOSTPERCENT_OFFSET UNITYSDK_OFFSET(0x1C83F810)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_DAMAGEFROMBURNPERCENT_OFFSET UNITYSDK_OFFSET(0x1C83F890)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_DAMAGEFROMSHIELDPERCENT_OFFSET UNITYSDK_OFFSET(0x1C83F870)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_DAMAGEPOWER_OFFSET UNITYSDK_OFFSET(0x1C83F150)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_ENCHANTTYPE_OFFSET UNITYSDK_OFFSET(0x1C83E660)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_EQUIPDATA_OFFSET UNITYSDK_OFFSET(0x1C82AF90)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_EQUIPID_OFFSET UNITYSDK_OFFSET(0x1C83E620)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_EQUIPLEVELDATA_OFFSET UNITYSDK_OFFSET(0x1C83E6A0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_EQUIPLEVEL_OFFSET UNITYSDK_OFFSET(0x1C83E640)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_FINALBURNPOWER_OFFSET UNITYSDK_OFFSET(0x1C83FA30)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_FINALDAMAGEPOWER_OFFSET UNITYSDK_OFFSET(0x1C83F930)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_FINALSHIELDPOWER_OFFSET UNITYSDK_OFFSET(0x1C83F9B0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_HASBURN_OFFSET UNITYSDK_OFFSET(0x1C83FC10)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_HASCOOLDOWN_OFFSET UNITYSDK_OFFSET(0x1C83FCC0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_HASDAMAGE_OFFSET UNITYSDK_OFFSET(0x1C83FAB0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_HASSHIELD_OFFSET UNITYSDK_OFFSET(0x1C83FB60)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1C83E680)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_SELLPRICE_OFFSET UNITYSDK_OFFSET(0x1C83E850)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_SHIELDBOOSTPERCENT_OFFSET UNITYSDK_OFFSET(0x1C83F830)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_SHIELDFROMBURNPERCENT_OFFSET UNITYSDK_OFFSET(0x1C83F8D0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_SHIELDFROMDAMAGEPERCENT_OFFSET UNITYSDK_OFFSET(0x1C83F8B0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_SHIELDPOWER_OFFSET UNITYSDK_OFFSET(0x1C83F2F0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x1C83FD70)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_SLOTTYPE_OFFSET UNITYSDK_OFFSET(0x1C83E750)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_GET_UNIQUEID_OFFSET UNITYSDK_OFFSET(0x1C83E600)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_HASPOSITIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1C840050)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_HASPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1C83FFE0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_RESETADDITIONALATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1C8400B0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_SET_ADDITIONALBURNPOWER_OFFSET UNITYSDK_OFFSET(0x1C83F7A0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_SET_ADDITIONALDAMAGEPOWER_OFFSET UNITYSDK_OFFSET(0x1C83F760)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_SET_ADDITIONALJAMPOWER_OFFSET UNITYSDK_OFFSET(0x1C83F800)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_SET_ADDITIONALMULTICASTPOWER_OFFSET UNITYSDK_OFFSET(0x1C83F7C0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_SET_ADDITIONALSHIELDPOWER_OFFSET UNITYSDK_OFFSET(0x1C83F780)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_SET_BASECOOLDOWNREDUCTION_OFFSET UNITYSDK_OFFSET(0x1C83F7E0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_SET_BURNBOOSTPERCENT_OFFSET UNITYSDK_OFFSET(0x1C83F860)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_SET_BURNFROMDAMAGEPERCENT_OFFSET UNITYSDK_OFFSET(0x1C83F900)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_SET_BURNFROMSHIELDPERCENT_OFFSET UNITYSDK_OFFSET(0x1C83F920)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_SET_DAMAGEBOOSTPERCENT_OFFSET UNITYSDK_OFFSET(0x1C83F820)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_SET_DAMAGEFROMBURNPERCENT_OFFSET UNITYSDK_OFFSET(0x1C83F8A0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_SET_DAMAGEFROMSHIELDPERCENT_OFFSET UNITYSDK_OFFSET(0x1C83F880)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_SET_ENCHANTTYPE_OFFSET UNITYSDK_OFFSET(0x1C83E670)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_SET_EQUIPID_OFFSET UNITYSDK_OFFSET(0x1C83E630)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_SET_EQUIPLEVEL_OFFSET UNITYSDK_OFFSET(0x1C83E650)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1C83E690)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_SET_SHIELDBOOSTPERCENT_OFFSET UNITYSDK_OFFSET(0x1C83F840)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_SET_SHIELDFROMBURNPERCENT_OFFSET UNITYSDK_OFFSET(0x1C83F8E0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_SET_SHIELDFROMDAMAGEPERCENT_OFFSET UNITYSDK_OFFSET(0x1C83F8C0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_SET_UNIQUEID_OFFSET UNITYSDK_OFFSET(0x1C83E610)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_SYNCPOSITION_OFFSET UNITYSDK_OFFSET(0x1C83FF90)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_SYNC_OFFSET UNITYSDK_OFFSET(0x1C83FF20)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE_TRYCREATE_OFFSET UNITYSDK_OFFSET(0x1C82E840)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C83FDC0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEquipInstance_TypeDefinitionIndex = 78847;

	class PixAirEquipInstance : public ::System::Object
	{
	public:
		::RPG::GameCore::FixPoint _BurnFromShieldPercent_k__BackingField; // 0x10
		::RPG::GameCore::FixPoint _ShieldFromBurnPercent_k__BackingField; // 0x18
		::RPG::GameCore::FixPoint _ShieldBoostPercent_k__BackingField; // 0x20
		::RPG::GameCore::FixPoint _ShieldFromDamagePercent_k__BackingField; // 0x28
		::RPG::GameCore::FixPoint _DamageFromShieldPercent_k__BackingField; // 0x30
		::RPG::GameCore::FixPoint _DamageBoostPercent_k__BackingField; // 0x38
		::RPG::GameCore::FixPoint _DamageFromBurnPercent_k__BackingField; // 0x40
		::RPG::GameCore::FixPoint _BaseCooldownReduction_k__BackingField; // 0x48
		::RPG::GameCore::FixPoint _BurnFromDamagePercent_k__BackingField; // 0x50
		::System::UInt32 _EquipID_k__BackingField; // 0x58
		::System::Int32 _AdditionalShieldPower_k__BackingField; // 0x5C
		::System::Int32 _AdditionalBurnPower_k__BackingField; // 0x60
		::System::UInt32 _EquipLevel_k__BackingField; // 0x64
		::RPG::GameCore::FixPoint _BurnBoostPercent_k__BackingField; // 0x68
		::System::Int32 _AdditionalDamagePower_k__BackingField; // 0x70
		::RPG::GameCore::PixAirEnchantmentType _EnchantType_k__BackingField; // 0x74
		::System::UInt32 _UniqueID_k__BackingField; // 0x78
		::System::UInt32 _Position_k__BackingField; // 0x7C
		::System::Int32 _AdditionalMultiCastPower_k__BackingField; // 0x80
		::System::Int32 _AdditionalJamPower_k__BackingField; // 0x84
