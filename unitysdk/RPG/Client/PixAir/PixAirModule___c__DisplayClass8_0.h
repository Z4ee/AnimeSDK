...
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE___C__DISPLAYCLASS8_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC3D9490)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE___C__DISPLAYCLASS8_0___ISBUYBLOCKEDBYSLOTSFULL_B__0_OFFSET UNITYSDK_OFFSET(0xC3DFCF0)
#define RPG_CLIENT_PIXAIR_PIXAIRMODULE___C__DISPLAYCLASS8_0___ISBUYBLOCKEDBYSLOTSFULL_B__1_OFFSET UNITYSDK_OFFSET(0xC3DFD10)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirModule___c__DisplayClass8_0_TypeDefinitionIndex = 73688;
