...
#define RPG_CLIENT_PIXAIR_PIXAIRRECTTRANSFORMBOUNDSLIMITER_ACQUIREJUMPTEXT_OFFSET UNITYSDK_OFFSET(0xDB21910)
#define RPG_CLIENT_PIXAIR_PIXAIRRECTTRANSFORMBOUNDSLIMITER__ACQUIREJUMPTEXT_OFFSET UNITYSDK_OFFSET(0xDB21AE0)
#define RPG_CLIENT_PIXAIR_PIXAIRRECTTRANSFORMBOUNDSLIMITER__ACQUIRELARGEJUMPTEXT_OFFSET UNITYSDK_OFFSET(0xDB21F20)
#define RPG_CLIENT_PIXAIR_PIXAIRRECTTRANSFORMBOUNDSLIMITER__ACQUIRESMALLJUMPTEXT_OFFSET UNITYSDK_OFFSET(0xDB21EA0)
#define RPG_CLIENT_PIXAIR_PIXAIRRECTTRANSFORMBOUNDSLIMITER__CTOR_OFFSET UNITYSDK_OFFSET(0xDB220E0)
#define RPG_CLIENT_PIXAIR_PIXAIRRECTTRANSFORMBOUNDSLIMITER__GETLOCALPOSITION_OFFSET UNITYSDK_OFFSET(0xDB21B60)
#define RPG_CLIENT_PIXAIR_PIXAIRRECTTRANSFORMBOUNDSLIMITER__GETRANDOMJUMPTEXTPOSITION_OFFSET UNITYSDK_OFFSET(0xDB21D00)
#define RPG_CLIENT_PIXAIR_PIXAIRRECTTRANSFORMBOUNDSLIMITER__INSTANTIATEJUMPTEXT_OFFSET UNITYSDK_OFFSET(0xDB22080)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirRectTransformBoundsLimiter_TypeDefinitionIndex = 78911;
