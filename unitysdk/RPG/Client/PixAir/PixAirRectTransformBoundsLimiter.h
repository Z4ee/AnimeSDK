...
#define RPG_CLIENT_PIXAIR_PIXAIRRECTTRANSFORMBOUNDSLIMITER_ACQUIREJUMPTEXT_OFFSET UNITYSDK_OFFSET(0xC3E8DD0)
#define RPG_CLIENT_PIXAIR_PIXAIRRECTTRANSFORMBOUNDSLIMITER__ACQUIREJUMPTEXT_OFFSET UNITYSDK_OFFSET(0xC3E8FA0)
#define RPG_CLIENT_PIXAIR_PIXAIRRECTTRANSFORMBOUNDSLIMITER__ACQUIRELARGEJUMPTEXT_OFFSET UNITYSDK_OFFSET(0xC3E93E0)
#define RPG_CLIENT_PIXAIR_PIXAIRRECTTRANSFORMBOUNDSLIMITER__ACQUIRESMALLJUMPTEXT_OFFSET UNITYSDK_OFFSET(0xC3E9360)
#define RPG_CLIENT_PIXAIR_PIXAIRRECTTRANSFORMBOUNDSLIMITER__CTOR_OFFSET UNITYSDK_OFFSET(0xC3E95A0)
#define RPG_CLIENT_PIXAIR_PIXAIRRECTTRANSFORMBOUNDSLIMITER__GETLOCALPOSITION_OFFSET UNITYSDK_OFFSET(0xC3E9020)
#define RPG_CLIENT_PIXAIR_PIXAIRRECTTRANSFORMBOUNDSLIMITER__GETRANDOMJUMPTEXTPOSITION_OFFSET UNITYSDK_OFFSET(0xC3E91C0)
#define RPG_CLIENT_PIXAIR_PIXAIRRECTTRANSFORMBOUNDSLIMITER__INSTANTIATEJUMPTEXT_OFFSET UNITYSDK_OFFSET(0xC3E9540)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirRectTransformBoundsLimiter_TypeDefinitionIndex = 73714;
