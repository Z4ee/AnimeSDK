...
#define RPG_CLIENT_PIXAIR_PIXAIRRECTTRANSFORMBOUNDSLIMITER_ACQUIREJUMPTEXT_OFFSET UNITYSDK_OFFSET(0x1BD15620)
#define RPG_CLIENT_PIXAIR_PIXAIRRECTTRANSFORMBOUNDSLIMITER__ACQUIREJUMPTEXT_OFFSET UNITYSDK_OFFSET(0x1BD157F0)
#define RPG_CLIENT_PIXAIR_PIXAIRRECTTRANSFORMBOUNDSLIMITER__ACQUIRELARGEJUMPTEXT_OFFSET UNITYSDK_OFFSET(0x1BD15C30)
#define RPG_CLIENT_PIXAIR_PIXAIRRECTTRANSFORMBOUNDSLIMITER__ACQUIRESMALLJUMPTEXT_OFFSET UNITYSDK_OFFSET(0x1BD15BB0)
#define RPG_CLIENT_PIXAIR_PIXAIRRECTTRANSFORMBOUNDSLIMITER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD15DF0)
#define RPG_CLIENT_PIXAIR_PIXAIRRECTTRANSFORMBOUNDSLIMITER__GETLOCALPOSITION_OFFSET UNITYSDK_OFFSET(0x1BD15870)
#define RPG_CLIENT_PIXAIR_PIXAIRRECTTRANSFORMBOUNDSLIMITER__GETRANDOMJUMPTEXTPOSITION_OFFSET UNITYSDK_OFFSET(0x1BD15A10)
#define RPG_CLIENT_PIXAIR_PIXAIRRECTTRANSFORMBOUNDSLIMITER__INSTANTIATEJUMPTEXT_OFFSET UNITYSDK_OFFSET(0x1BD15D90)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirRectTransformBoundsLimiter_TypeDefinitionIndex = 78910;
