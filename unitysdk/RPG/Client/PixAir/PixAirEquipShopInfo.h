...
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPINFO_CREATE_OFFSET UNITYSDK_OFFSET(0xC3C6310)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPINFO_GET_REFRESHCOUNT_OFFSET UNITYSDK_OFFSET(0xC3C63F0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPINFO_GET_SHOPID_OFFSET UNITYSDK_OFFSET(0xC3C63D0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPINFO_SET_SHOPID_OFFSET UNITYSDK_OFFSET(0xC3C63E0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPINFO_SYNCUPDATE_OFFSET UNITYSDK_OFFSET(0xC3C6360)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOPINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xC3C6350)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEquipShopInfo_TypeDefinitionIndex = 73695;
