...
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMCHANGEINFO_CREATE_OFFSET UNITYSDK_OFFSET(0xDAFA140)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMCHANGEINFO_GET_CHANGETYPE_OFFSET UNITYSDK_OFFSET(0xDAFA320)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMCHANGEINFO_GET_NEWITEM_OFFSET UNITYSDK_OFFSET(0xDAFA360)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMCHANGEINFO_GET_OLDITEM_OFFSET UNITYSDK_OFFSET(0xDAFA340)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMCHANGEINFO_SET_CHANGETYPE_OFFSET UNITYSDK_OFFSET(0xDAFA330)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMCHANGEINFO_SET_NEWITEM_OFFSET UNITYSDK_OFFSET(0xDAFA370)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMCHANGEINFO_SET_OLDITEM_OFFSET UNITYSDK_OFFSET(0xDAFA350)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMCHANGEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xDAFA1E0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMCHANGEINFO__GETCHANGETYPE_OFFSET UNITYSDK_OFFSET(0xDAFA2A0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMCHANGEINFO__INIT_OFFSET UNITYSDK_OFFSET(0xDAFA1F0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEquipItemChangeInfo_TypeDefinitionIndex = 78792;
