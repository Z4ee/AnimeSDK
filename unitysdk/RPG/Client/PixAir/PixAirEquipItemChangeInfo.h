...
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMCHANGEINFO_CREATE_OFFSET UNITYSDK_OFFSET(0xC3C3340)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMCHANGEINFO_GET_CHANGETYPE_OFFSET UNITYSDK_OFFSET(0xC3C3520)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMCHANGEINFO_GET_NEWITEM_OFFSET UNITYSDK_OFFSET(0xC3C3560)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMCHANGEINFO_GET_OLDITEM_OFFSET UNITYSDK_OFFSET(0xC3C3540)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMCHANGEINFO_SET_CHANGETYPE_OFFSET UNITYSDK_OFFSET(0xC3C3530)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMCHANGEINFO_SET_NEWITEM_OFFSET UNITYSDK_OFFSET(0xC3C3570)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMCHANGEINFO_SET_OLDITEM_OFFSET UNITYSDK_OFFSET(0xC3C3550)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMCHANGEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xC3C33E0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMCHANGEINFO__GETCHANGETYPE_OFFSET UNITYSDK_OFFSET(0xC3C34A0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPITEMCHANGEINFO__INIT_OFFSET UNITYSDK_OFFSET(0xC3C33F0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEquipItemChangeInfo_TypeDefinitionIndex = 73595;

	class PixAirEquipItemChangeInfo : public ::System::Object
	{
	public:
		::RPG::Client::PixAir::PixAirEquipInstance* _OldItem_k__BackingField; // 0x10
		::RPG::Client::PixAir::PixAirEquipInstance* _NewItem_k__BackingField; // 0x18
