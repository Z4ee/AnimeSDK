...
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW_COMPLETEALLANIMATIONS_OFFSET UNITYSDK_OFFSET(0xDB1CD10)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW_GETHPRATIO_OFFSET UNITYSDK_OFFSET(0xDB1CEF0)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW_GETSHIELDRATIO_OFFSET UNITYSDK_OFFSET(0xDB1CF50)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW_GET_CURRENTHP_OFFSET UNITYSDK_OFFSET(0xDB1CFB0)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW_GET_CURRENTSHIELD_OFFSET UNITYSDK_OFFSET(0xDB1CFD0)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW_GET_MAXHP_OFFSET UNITYSDK_OFFSET(0xDB1CFC0)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xDB1BAC0)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW_SETANIMATIONCURVE_OFFSET UNITYSDK_OFFSET(0xDB1CCC0)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW_SETANIMATIONDURATION_OFFSET UNITYSDK_OFFSET(0xDB1CC50)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW_UPDATEHP_OFFSET UNITYSDK_OFFSET(0xDB1BF60)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW_UPDATEMAXHP_OFFSET UNITYSDK_OFFSET(0xDB1C5F0)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW_UPDATESHIELD_OFFSET UNITYSDK_OFFSET(0xDB1C310)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW_UPDATE_OFFSET UNITYSDK_OFFSET(0xDB1C8A0)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xDB1CFE0)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW__PLAYERBURNDAMAGEHPEFFECT_OFFSET UNITYSDK_OFFSET(0xDB1BDA0)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW__STARTDAMAGEANIMATION_OFFSET UNITYSDK_OFFSET(0xDB1C1A0)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW__STARTSHIELDDAMAGEANIMATION_OFFSET UNITYSDK_OFFSET(0xDB1C560)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirPlaneStatusBarView_TypeDefinitionIndex = 78788;
