...
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW_COMPLETEALLANIMATIONS_OFFSET UNITYSDK_OFFSET(0xC3E3E10)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW_GETHPRATIO_OFFSET UNITYSDK_OFFSET(0xC3E3F00)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW_GETSHIELDRATIO_OFFSET UNITYSDK_OFFSET(0xC3E3F60)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW_GET_CURRENTHP_OFFSET UNITYSDK_OFFSET(0xC3E3FC0)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW_GET_CURRENTSHIELD_OFFSET UNITYSDK_OFFSET(0xC3E3FE0)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW_GET_MAXHP_OFFSET UNITYSDK_OFFSET(0xC3E3FD0)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xC3E3080)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW_SETANIMATIONCURVE_OFFSET UNITYSDK_OFFSET(0xC3E3DC0)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW_SETANIMATIONDURATION_OFFSET UNITYSDK_OFFSET(0xC3E3D50)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW_UPDATEHP_OFFSET UNITYSDK_OFFSET(0xC3E33E0)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW_UPDATEMAXHP_OFFSET UNITYSDK_OFFSET(0xC3E3930)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW_UPDATESHIELD_OFFSET UNITYSDK_OFFSET(0xC3E3650)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW_UPDATE_OFFSET UNITYSDK_OFFSET(0xC3E3AA0)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xC3E3FF0)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW__PLAYERBURNDAMAGEHPEFFECT_OFFSET UNITYSDK_OFFSET(0xC3E3220)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW__STARTDAMAGEANIMATION_OFFSET UNITYSDK_OFFSET(0xC3E3540)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW__STARTSHIELDDAMAGEANIMATION_OFFSET UNITYSDK_OFFSET(0xC3E38A0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirPlaneStatusBarView_TypeDefinitionIndex = 73591;
