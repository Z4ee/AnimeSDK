...
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW_COMPLETEALLANIMATIONS_OFFSET UNITYSDK_OFFSET(0x1A0D9980)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW_GETHPRATIO_OFFSET UNITYSDK_OFFSET(0x1A0D9B60)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW_GETSHIELDRATIO_OFFSET UNITYSDK_OFFSET(0x1A0D9BC0)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW_GET_CURRENTHP_OFFSET UNITYSDK_OFFSET(0x1A0D9C20)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW_GET_CURRENTSHIELD_OFFSET UNITYSDK_OFFSET(0x1A0D9C40)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW_GET_MAXHP_OFFSET UNITYSDK_OFFSET(0x1A0D9C30)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1A0D8730)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW_SETANIMATIONCURVE_OFFSET UNITYSDK_OFFSET(0x1A0D9930)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW_SETANIMATIONDURATION_OFFSET UNITYSDK_OFFSET(0x1A0D98C0)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW_UPDATEHP_OFFSET UNITYSDK_OFFSET(0x1A0D8BD0)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW_UPDATEMAXHP_OFFSET UNITYSDK_OFFSET(0x1A0D9260)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW_UPDATESHIELD_OFFSET UNITYSDK_OFFSET(0x1A0D8F80)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A0D9510)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0D9C50)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW__PLAYERBURNDAMAGEHPEFFECT_OFFSET UNITYSDK_OFFSET(0x1A0D8A10)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW__STARTDAMAGEANIMATION_OFFSET UNITYSDK_OFFSET(0x1A0D8E10)
#define RPG_CLIENT_PIXAIR_PIXAIRPLANESTATUSBARVIEW__STARTSHIELDDAMAGEANIMATION_OFFSET UNITYSDK_OFFSET(0x1A0D91D0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirPlaneStatusBarView_TypeDefinitionIndex = 75240;
