...
#define RPG_CLIENT_PIXAIR_PIXAIRNODECONTENTSELECTACTION_FINISH_OFFSET UNITYSDK_OFFSET(0xDB192D0)
#define RPG_CLIENT_PIXAIR_PIXAIRNODECONTENTSELECTACTION_GETCONTENTKEY_OFFSET UNITYSDK_OFFSET(0xDB19340)
#define RPG_CLIENT_PIXAIR_PIXAIRNODECONTENTSELECTACTION_GET_CONTENTITEMS_OFFSET UNITYSDK_OFFSET(0xDB19390)
#define RPG_CLIENT_PIXAIR_PIXAIRNODECONTENTSELECTACTION_GET_NODECASE_OFFSET UNITYSDK_OFFSET(0xDB193A0)
#define RPG_CLIENT_PIXAIR_PIXAIRNODECONTENTSELECTACTION_SELECTCONTENT_OFFSET UNITYSDK_OFFSET(0xDB191F0)
#define RPG_CLIENT_PIXAIR_PIXAIRNODECONTENTSELECTACTION_START_OFFSET UNITYSDK_OFFSET(0xDB19190)
#define RPG_CLIENT_PIXAIR_PIXAIRNODECONTENTSELECTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xDB18C70)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirNodeContentSelectAction_TypeDefinitionIndex = 78812;
