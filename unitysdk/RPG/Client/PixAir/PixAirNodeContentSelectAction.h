...
#define RPG_CLIENT_PIXAIR_PIXAIRNODECONTENTSELECTACTION_FINISH_OFFSET UNITYSDK_OFFSET(0x1A0D5F80)
#define RPG_CLIENT_PIXAIR_PIXAIRNODECONTENTSELECTACTION_GETCONTENTKEY_OFFSET UNITYSDK_OFFSET(0x1A0D5FF0)
#define RPG_CLIENT_PIXAIR_PIXAIRNODECONTENTSELECTACTION_GET_CONTENTITEMS_OFFSET UNITYSDK_OFFSET(0x1A0D6040)
#define RPG_CLIENT_PIXAIR_PIXAIRNODECONTENTSELECTACTION_GET_NODECASE_OFFSET UNITYSDK_OFFSET(0x1A0D6050)
#define RPG_CLIENT_PIXAIR_PIXAIRNODECONTENTSELECTACTION_SELECTCONTENT_OFFSET UNITYSDK_OFFSET(0x1A0D5EA0)
#define RPG_CLIENT_PIXAIR_PIXAIRNODECONTENTSELECTACTION_START_OFFSET UNITYSDK_OFFSET(0x1A0D5E40)
#define RPG_CLIENT_PIXAIR_PIXAIRNODECONTENTSELECTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0D5920)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirNodeContentSelectAction_TypeDefinitionIndex = 75264;
