...
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0xDB0EE80)
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTVIEWMODEL_GET_SIZE_OFFSET UNITYSDK_OFFSET(0xDB0EF70)
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTVIEWMODEL_GET_TEXTTYPE_OFFSET UNITYSDK_OFFSET(0xDB0EF50)
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTVIEWMODEL_GET_VALUE_OFFSET UNITYSDK_OFFSET(0xDB0EF90)
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTVIEWMODEL_SET_SIZE_OFFSET UNITYSDK_OFFSET(0xDB0EF80)
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTVIEWMODEL_SET_TEXTTYPE_OFFSET UNITYSDK_OFFSET(0xDB0EF60)
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTVIEWMODEL_SET_VALUE_OFFSET UNITYSDK_OFFSET(0xDB0EFA0)
#define RPG_CLIENT_PIXAIR_PIXAIRJUMPTEXTVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xDB0EF30)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirJumpTextViewModel_TypeDefinitionIndex = 78786;

	class PixAirJumpTextViewModel : public ::Sofa::BaseViewModel
	{
	public:
		::System::Int32 _Value_k__BackingField; // 0x20
		::RPG::Client::PixAir::PixAirJumpTextType _TextType_k__BackingField; // 0x24
		::RPG::Client::PixAir::PixAirJumpTextSize _Size_k__BackingField; // 0x28
