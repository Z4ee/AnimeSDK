...
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPUPGRADEVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0xDAFDE40)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPUPGRADEVIEWMODEL_GET_BEFOREINSTANCE_OFFSET UNITYSDK_OFFSET(0xDAFDE00)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPUPGRADEVIEWMODEL_GET_CURRENTINSTANCE_OFFSET UNITYSDK_OFFSET(0xDAFDE20)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPUPGRADEVIEWMODEL_SET_BEFOREINSTANCE_OFFSET UNITYSDK_OFFSET(0xDAFDE10)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPUPGRADEVIEWMODEL_SET_CURRENTINSTANCE_OFFSET UNITYSDK_OFFSET(0xDAFDE30)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPUPGRADEVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xDAFDEE0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEquipUpgradeViewModel_TypeDefinitionIndex = 78849;

	class PixAirEquipUpgradeViewModel : public ::System::Object
	{
	public:
		::RPG::Client::PixAir::PixAirEquipInstance* _BeforeInstance_k__BackingField; // 0x10
		::RPG::Client::PixAir::PixAirEquipInstance* _CurrentInstance_k__BackingField; // 0x18
