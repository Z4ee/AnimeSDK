...
#define RPG_CLIENT_PIXAIR_PIXAIRLOCKACTIONCHECKER_GETTEXTHINT_OFFSET UNITYSDK_OFFSET(0xC3D7450)
#define RPG_CLIENT_PIXAIR_PIXAIRLOCKACTIONCHECKER_ISBUYEQUIPALLOWED_OFFSET UNITYSDK_OFFSET(0xC3D7390)
#define RPG_CLIENT_PIXAIR_PIXAIRLOCKACTIONCHECKER_ISCONTENTSELECTALLOWED_OFFSET UNITYSDK_OFFSET(0xC3D71A0)
#define RPG_CLIENT_PIXAIR_PIXAIRLOCKACTIONCHECKER_ISSELLEQUIPALLOWED_OFFSET UNITYSDK_OFFSET(0xC3D73F0)
#define RPG_CLIENT_PIXAIR_PIXAIRLOCKACTIONCHECKER__CHECKACTION_OFFSET UNITYSDK_OFFSET(0xC3D71F0)
#define RPG_CLIENT_PIXAIR_PIXAIRLOCKACTIONCHECKER__CTOR_OFFSET UNITYSDK_OFFSET(0xC3D7190)
#define RPG_CLIENT_PIXAIR_PIXAIRLOCKACTIONCHECKER__GETCURRENTROWS_OFFSET UNITYSDK_OFFSET(0xC3D75D0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirLockActionChecker_TypeDefinitionIndex = 73667;
