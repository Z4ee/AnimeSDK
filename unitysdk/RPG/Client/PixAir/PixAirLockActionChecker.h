...
#define RPG_CLIENT_PIXAIR_PIXAIRLOCKACTIONCHECKER_GETTEXTHINT_OFFSET UNITYSDK_OFFSET(0xDB10040)
#define RPG_CLIENT_PIXAIR_PIXAIRLOCKACTIONCHECKER_ISBUYEQUIPALLOWED_OFFSET UNITYSDK_OFFSET(0xDB0FF80)
#define RPG_CLIENT_PIXAIR_PIXAIRLOCKACTIONCHECKER_ISCONTENTSELECTALLOWED_OFFSET UNITYSDK_OFFSET(0xDB0FD90)
#define RPG_CLIENT_PIXAIR_PIXAIRLOCKACTIONCHECKER_ISSELLEQUIPALLOWED_OFFSET UNITYSDK_OFFSET(0xDB0FFE0)
#define RPG_CLIENT_PIXAIR_PIXAIRLOCKACTIONCHECKER__CHECKACTION_OFFSET UNITYSDK_OFFSET(0xDB0FDE0)
#define RPG_CLIENT_PIXAIR_PIXAIRLOCKACTIONCHECKER__CTOR_OFFSET UNITYSDK_OFFSET(0xDB07450)
#define RPG_CLIENT_PIXAIR_PIXAIRLOCKACTIONCHECKER__GETCURRENTROWS_OFFSET UNITYSDK_OFFSET(0xDB101C0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirLockActionChecker_TypeDefinitionIndex = 78864;
