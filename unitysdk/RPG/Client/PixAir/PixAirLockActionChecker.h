...
#define RPG_CLIENT_PIXAIR_PIXAIRLOCKACTIONCHECKER_GETTEXTHINT_OFFSET UNITYSDK_OFFSET(0x1BD03D00)
#define RPG_CLIENT_PIXAIR_PIXAIRLOCKACTIONCHECKER_ISBUYEQUIPALLOWED_OFFSET UNITYSDK_OFFSET(0x1BD03C40)
#define RPG_CLIENT_PIXAIR_PIXAIRLOCKACTIONCHECKER_ISCONTENTSELECTALLOWED_OFFSET UNITYSDK_OFFSET(0x1BD03A50)
#define RPG_CLIENT_PIXAIR_PIXAIRLOCKACTIONCHECKER_ISSELLEQUIPALLOWED_OFFSET UNITYSDK_OFFSET(0x1BD03CA0)
#define RPG_CLIENT_PIXAIR_PIXAIRLOCKACTIONCHECKER__CHECKACTION_OFFSET UNITYSDK_OFFSET(0x1BD03AA0)
#define RPG_CLIENT_PIXAIR_PIXAIRLOCKACTIONCHECKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BCFB0E0)
#define RPG_CLIENT_PIXAIR_PIXAIRLOCKACTIONCHECKER__GETCURRENTROWS_OFFSET UNITYSDK_OFFSET(0x1BD03E80)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirLockActionChecker_TypeDefinitionIndex = 78863;
