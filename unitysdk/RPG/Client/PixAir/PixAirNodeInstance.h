...
#define RPG_CLIENT_PIXAIR_PIXAIRNODEINSTANCE_GET_INDEXINAREA_OFFSET UNITYSDK_OFFSET(0x1BD0DFB0)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEINSTANCE_GET_NODEDATA_OFFSET UNITYSDK_OFFSET(0x1BD0DEB0)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEINSTANCE_GET_NODEID_OFFSET UNITYSDK_OFFSET(0x1BD0DE90)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEINSTANCE_GET_NODENAME_OFFSET UNITYSDK_OFFSET(0x1BD0DEF0)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEINSTANCE_GET_STATE_OFFSET UNITYSDK_OFFSET(0x1BD0DED0)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEINSTANCE_MARKASFINISHED_OFFSET UNITYSDK_OFFSET(0x1BD0E0D0)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEINSTANCE_MARKASPROCESSING_OFFSET UNITYSDK_OFFSET(0x1BD0E120)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEINSTANCE_SETSTATE_OFFSET UNITYSDK_OFFSET(0x1BD0E080)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEINSTANCE_SET_INDEXINAREA_OFFSET UNITYSDK_OFFSET(0x1BD0DFC0)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEINSTANCE_SET_NODEDATA_OFFSET UNITYSDK_OFFSET(0x1BD0DEC0)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEINSTANCE_SET_NODEID_OFFSET UNITYSDK_OFFSET(0x1BD0DEA0)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEINSTANCE_SET_STATE_OFFSET UNITYSDK_OFFSET(0x1BD0DEE0)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEINSTANCE_TRYCREATE_OFFSET UNITYSDK_OFFSET(0x1BD0DFD0)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD0E070)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirNodeInstance_TypeDefinitionIndex = 78865;
