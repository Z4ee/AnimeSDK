...
#define RPG_CLIENT_PIXAIR_PIXAIRNODEINSTANCE_GET_INDEXINAREA_OFFSET UNITYSDK_OFFSET(0x1A0D6F10)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEINSTANCE_GET_NODEDATA_OFFSET UNITYSDK_OFFSET(0x1A0D6E10)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEINSTANCE_GET_NODEID_OFFSET UNITYSDK_OFFSET(0x1A0D6DF0)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEINSTANCE_GET_NODENAME_OFFSET UNITYSDK_OFFSET(0x1A0D6E50)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEINSTANCE_GET_STATE_OFFSET UNITYSDK_OFFSET(0x1A0D6E30)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEINSTANCE_MARKASFINISHED_OFFSET UNITYSDK_OFFSET(0x1A0D7030)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEINSTANCE_MARKASPROCESSING_OFFSET UNITYSDK_OFFSET(0x1A0D7080)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEINSTANCE_SETSTATE_OFFSET UNITYSDK_OFFSET(0x1A0D6FE0)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEINSTANCE_SET_INDEXINAREA_OFFSET UNITYSDK_OFFSET(0x1A0D6F20)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEINSTANCE_SET_NODEDATA_OFFSET UNITYSDK_OFFSET(0x1A0D6E20)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEINSTANCE_SET_NODEID_OFFSET UNITYSDK_OFFSET(0x1A0D6E00)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEINSTANCE_SET_STATE_OFFSET UNITYSDK_OFFSET(0x1A0D6E40)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEINSTANCE_TRYCREATE_OFFSET UNITYSDK_OFFSET(0x1A0D6F30)
#define RPG_CLIENT_PIXAIR_PIXAIRNODEINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0D6FD0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirNodeInstance_TypeDefinitionIndex = 75318;
