...
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEACTION_CREATEENEMYPLANESNAPSHOTS_OFFSET UNITYSDK_OFFSET(0x1C831DD0)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEACTION_CREATEPLAYERPLANESNAPSHOT_OFFSET UNITYSDK_OFFSET(0x1C831900)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEACTION_ENTERBATTLE_OFFSET UNITYSDK_OFFSET(0x1C831270)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEACTION_FINISH_OFFSET UNITYSDK_OFFSET(0x1C831610)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEACTION_GETCONTENTKEY_OFFSET UNITYSDK_OFFSET(0x1C8315A0)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEACTION_GET_BATTLEROUNDINFO_OFFSET UNITYSDK_OFFSET(0x1C832010)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEACTION_GET_NODECASE_OFFSET UNITYSDK_OFFSET(0x1C832020)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEACTION_RESOLVEBATTLE_1_OFFSET UNITYSDK_OFFSET(0x1C8316D0)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEACTION_RESOLVEBATTLE_OFFSET UNITYSDK_OFFSET(0x1C831680)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEACTION_START_OFFSET UNITYSDK_OFFSET(0x1C831210)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C831060)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEACTION__DOENTERBATTLE_OFFSET UNITYSDK_OFFSET(0x1C8314B0)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEACTION__REPORTPIXAIRWAVEBATTLESTART_OFFSET UNITYSDK_OFFSET(0x1C8312C0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirBattleAction_TypeDefinitionIndex = 78800;
	...
	public:
		...
		::System::Void _ctor(::System::UInt32 a1, ::Class_1_D17272E82AE804C2_806* a2)
		{
			return ((::System::Void(*)(::PVOID, ::System::UInt32, ::Class_1_D17272E82AE804C2_806*))((::PBYTE)hIl2Cpp + RPG_CLIENT_PIXAIR_PIXAIRBATTLEACTION__CTOR_OFFSET))(this, a1, a2);
		}
