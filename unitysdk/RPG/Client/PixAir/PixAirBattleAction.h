...
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEACTION_CREATEENEMYPLANESNAPSHOTS_OFFSET UNITYSDK_OFFSET(0xDAEBDD0)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEACTION_CREATEPLAYERPLANESNAPSHOT_OFFSET UNITYSDK_OFFSET(0xDAEB900)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEACTION_ENTERBATTLE_OFFSET UNITYSDK_OFFSET(0xDAEB270)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEACTION_FINISH_OFFSET UNITYSDK_OFFSET(0xDAEB610)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEACTION_GETCONTENTKEY_OFFSET UNITYSDK_OFFSET(0xDAEB5A0)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEACTION_GET_BATTLEROUNDINFO_OFFSET UNITYSDK_OFFSET(0xDAEC010)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEACTION_GET_NODECASE_OFFSET UNITYSDK_OFFSET(0xDAEC020)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEACTION_RESOLVEBATTLE_1_OFFSET UNITYSDK_OFFSET(0xDAEB6D0)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEACTION_RESOLVEBATTLE_OFFSET UNITYSDK_OFFSET(0xDAEB680)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEACTION_START_OFFSET UNITYSDK_OFFSET(0xDAEB210)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xDAEB100)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEACTION__DOENTERBATTLE_OFFSET UNITYSDK_OFFSET(0xDAEB4B0)
#define RPG_CLIENT_PIXAIR_PIXAIRBATTLEACTION__REPORTPIXAIRWAVEBATTLESTART_OFFSET UNITYSDK_OFFSET(0xDAEB2C0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirBattleAction_TypeDefinitionIndex = 78801;
