...
#define RPG_CLIENT_PIXAIR_PIXAIRLEVELPROGRESSVIEW_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xC3D6E00)
#define RPG_CLIENT_PIXAIR_PIXAIRLEVELPROGRESSVIEW_TRYSHOWHINT_OFFSET UNITYSDK_OFFSET(0xC3D6370)
#define RPG_CLIENT_PIXAIR_PIXAIRLEVELPROGRESSVIEW_UPDATE_OFFSET UNITYSDK_OFFSET(0xC3D6CF0)
#define RPG_CLIENT_PIXAIR_PIXAIRLEVELPROGRESSVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xC3D7020)
#define RPG_CLIENT_PIXAIR_PIXAIRLEVELPROGRESSVIEW__GETSORTEDCOMMONSTAGEDATA_OFFSET UNITYSDK_OFFSET(0xC3D6680)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirLevelProgressView_TypeDefinitionIndex = 73710;
