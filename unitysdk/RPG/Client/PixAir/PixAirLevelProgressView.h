...
#define RPG_CLIENT_PIXAIR_PIXAIRLEVELPROGRESSVIEW_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1A0CC720)
#define RPG_CLIENT_PIXAIR_PIXAIRLEVELPROGRESSVIEW_TRYSHOWHINT_OFFSET UNITYSDK_OFFSET(0x1A0CBCA0)
#define RPG_CLIENT_PIXAIR_PIXAIRLEVELPROGRESSVIEW_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A0CC610)
#define RPG_CLIENT_PIXAIR_PIXAIRLEVELPROGRESSVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0CC940)
#define RPG_CLIENT_PIXAIR_PIXAIRLEVELPROGRESSVIEW__GETSORTEDCOMMONSTAGEDATA_OFFSET UNITYSDK_OFFSET(0x1A0CBFB0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirLevelProgressView_TypeDefinitionIndex = 75359;
