...
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOWUPGRADEVIEWACTION_FINISH_OFFSET UNITYSDK_OFFSET(0xC3C6EA0)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOWUPGRADEVIEWACTION_GET_NODECASE_OFFSET UNITYSDK_OFFSET(0xC3C6F20)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOWUPGRADEVIEWACTION_START_OFFSET UNITYSDK_OFFSET(0xC3C6C60)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOWUPGRADEVIEWACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xC3C6C40)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOWUPGRADEVIEWACTION__ONDIALOGEXIT_OFFSET UNITYSDK_OFFSET(0xC3C6E00)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOWUPGRADEVIEWACTION___IFIXBASEPROXY_FINISH_OFFSET UNITYSDK_OFFSET(0xC3C6F90)
#define RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOWUPGRADEVIEWACTION___IFIXBASEPROXY_START_OFFSET UNITYSDK_OFFSET(0xC3C6F30)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEquipShowUpgradeViewAction_TypeDefinitionIndex = 73608;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOWUPGRADEVIEWACTION___IFIXBASEPROXY_START_OFFSET))(this);
		}

		::System::Void __iFixBaseProxy_Finish()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_PIXAIR_PIXAIREQUIPSHOWUPGRADEVIEWACTION___IFIXBASEPROXY_FINISH_OFFSET))(this);
		}
	};
}
