...
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEPREPAREWINDOW_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1BCF8810)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEPREPAREWINDOW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C84A450)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEPREPAREWINDOW__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1BCF8430)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEPREPAREWINDOW__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1BCF8210)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirGamePrepareWindow_TypeDefinitionIndex = 78750;

	class PixAirGamePrepareWindow : public ::Sofa::BaseSofaWindow
	{
	public:
		::UnityEngine::UI::Button* _BtnSwitch; // 0x48
		::UnityEngine::UI::Button* _BtnClose; // 0x50
		::Class_1_5F4D64A4B97E38F9* _Messenger; // 0x58
		::RPG::Client::PixAir::PixAirGameEquipListControl* _EquipListControl; // 0x60
		::RPG::Client::PixAir::PixAirPrepareContentControl* _ContentControl; // 0x68
		::RPG::Client::PixAir::PixAirGameProgressControl* _ProgressControl; // 0x70
