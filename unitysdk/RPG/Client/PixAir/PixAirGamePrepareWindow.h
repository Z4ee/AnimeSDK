...
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEPREPAREWINDOW_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC3CDB00)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEPREPAREWINDOW__CTOR_OFFSET UNITYSDK_OFFSET(0xC3CD3C0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEPREPAREWINDOW__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC3CD690)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEPREPAREWINDOW__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC3CD470)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEPREPAREWINDOW___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC3CDBD0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMEPREPAREWINDOW___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xC3CDB70)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirGamePrepareWindow_TypeDefinitionIndex = 73554;

	class PixAirGamePrepareWindow : public ::Sofa::BaseSofaWindow
	{
	public:
		::UnityEngine::UI::Button* _BtnClose; // 0x40
		::RPG::Client::PixAir::PixAirPrepareContentControl* _ContentControl; // 0x48
		::RPG::Client::PixAir::PixAirGameEquipListControl* _EquipListControl; // 0x50
		::UnityEngine::UI::Button* _BtnSwitch; // 0x58
		::Class_1_5F4D64A4B97E38F9* _Messenger; // 0x60
		::RPG::Client::PixAir::PixAirGameProgressControl* _ProgressControl; // 0x68
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_PIXAIR_PIXAIRGAMEPREPAREWINDOW___IFIXBASEPROXY__ONINITIALIZECOMPONENT_OFFSET))(this);
		}

		::System::Void __iFixBaseProxy__OnBindViewModel()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_PIXAIR_PIXAIRGAMEPREPAREWINDOW___IFIXBASEPROXY__ONBINDVIEWMODEL_OFFSET))(this);
		}
	};
}
