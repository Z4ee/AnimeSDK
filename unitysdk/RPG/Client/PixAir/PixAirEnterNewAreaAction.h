...
#define RPG_CLIENT_PIXAIR_PIXAIRENTERNEWAREAACTION_RECORDCHANGE_OFFSET UNITYSDK_OFFSET(0xDAF07A0)
#define RPG_CLIENT_PIXAIR_PIXAIRENTERNEWAREAACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xDAF1250)
#define RPG_CLIENT_PIXAIR_PIXAIRENTERNEWAREAACTION__RECORDBASICCHANGE_OFFSET UNITYSDK_OFFSET(0xDAF0D80)
#define RPG_CLIENT_PIXAIR_PIXAIRENTERNEWAREAACTION__RECORDSLOTNUMCHANGE_OFFSET UNITYSDK_OFFSET(0xDAF11F0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirEnterNewAreaAction_TypeDefinitionIndex = 78797;

	class PixAirEnterNewAreaAction : public ::System::Object
	{
	public:
		::System::Int32 _TempCoin; // 0x10
		::System::Int32 _TempMaxHp; // 0x14
		::System::Int32 AddSlotNum; // 0x18
		::System::Int32 AddMaxHp; // 0x1C
		::System::Int32 _TempSlotNum; // 0x20
		::System::Int32 AddCoin; // 0x24
