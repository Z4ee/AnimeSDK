...
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1BD00130)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_GET_AREASCORE_OFFSET UNITYSDK_OFFSET(0x1BD00350)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_GET_COREEQUIPID_OFFSET UNITYSDK_OFFSET(0x1BD003F0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_GET_FINALBATTLESCORE_OFFSET UNITYSDK_OFFSET(0x1BD00390)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_GET_ISWIN_OFFSET UNITYSDK_OFFSET(0x1BD00310)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_GET_LIFESCORE_OFFSET UNITYSDK_OFFSET(0x1BD00370)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_GET_PLANEID_OFFSET UNITYSDK_OFFSET(0x1BD003D0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_GET_REWARDS_OFFSET UNITYSDK_OFFSET(0x1BD00450)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_GET_STAGEID_OFFSET UNITYSDK_OFFSET(0x1BD003B0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_GET_STOPPEDAREAINDEX_OFFSET UNITYSDK_OFFSET(0x1BD00410)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_GET_TOTALAREACOUNT_OFFSET UNITYSDK_OFFSET(0x1BD00430)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_GET_TOTALSCORE_OFFSET UNITYSDK_OFFSET(0x1BD00330)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_SET_AREASCORE_OFFSET UNITYSDK_OFFSET(0x1BD00360)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_SET_COREEQUIPID_OFFSET UNITYSDK_OFFSET(0x1BD00400)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_SET_FINALBATTLESCORE_OFFSET UNITYSDK_OFFSET(0x1BD003A0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_SET_ISWIN_OFFSET UNITYSDK_OFFSET(0x1BD00320)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_SET_LIFESCORE_OFFSET UNITYSDK_OFFSET(0x1BD00380)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_SET_PLANEID_OFFSET UNITYSDK_OFFSET(0x1BD003E0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_SET_REWARDS_OFFSET UNITYSDK_OFFSET(0x1BD00460)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_SET_STAGEID_OFFSET UNITYSDK_OFFSET(0x1BD003C0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_SET_STOPPEDAREAINDEX_OFFSET UNITYSDK_OFFSET(0x1BD00420)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_SET_TOTALAREACOUNT_OFFSET UNITYSDK_OFFSET(0x1BD00440)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_SET_TOTALSCORE_OFFSET UNITYSDK_OFFSET(0x1BD00340)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_SYNCAREAINFO_OFFSET UNITYSDK_OFFSET(0x1BD00230)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_SYNCREWARDS_OFFSET UNITYSDK_OFFSET(0x1BD00290)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD00220)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirGameSettlementData_TypeDefinitionIndex = 78878;
	...
	public:
		...
		::System::UInt32 _LifeScore_k__BackingField; // 0x1C
		::System::Int32 _TotalAreaCount_k__BackingField; // 0x20
		::System::UInt32 _PlaneID_k__BackingField; // 0x24
		::System::UInt32 _AreaScore_k__BackingField; // 0x28
		::System::UInt32 _TotalScore_k__BackingField; // 0x2C
		::System::UInt32 _CoreEquipID_k__BackingField; // 0x30
		::System::UInt32 _FinalBattleScore_k__BackingField; // 0x34
		::System::Int32 _StoppedAreaIndex_k__BackingField; // 0x38
