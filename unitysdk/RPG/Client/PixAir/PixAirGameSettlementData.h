...
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1A0C91C0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_GET_AREASCORE_OFFSET UNITYSDK_OFFSET(0x1A0C93E0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_GET_COREEQUIPID_OFFSET UNITYSDK_OFFSET(0x1A0C9480)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_GET_FINALBATTLESCORE_OFFSET UNITYSDK_OFFSET(0x1A0C9420)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_GET_ISWIN_OFFSET UNITYSDK_OFFSET(0x1A0C93A0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_GET_LIFESCORE_OFFSET UNITYSDK_OFFSET(0x1A0C9400)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_GET_PLANEID_OFFSET UNITYSDK_OFFSET(0x1A0C9460)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_GET_REWARDS_OFFSET UNITYSDK_OFFSET(0x1A0C94E0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_GET_STAGEID_OFFSET UNITYSDK_OFFSET(0x1A0C9440)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_GET_STOPPEDAREAINDEX_OFFSET UNITYSDK_OFFSET(0x1A0C94A0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_GET_TOTALAREACOUNT_OFFSET UNITYSDK_OFFSET(0x1A0C94C0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_GET_TOTALSCORE_OFFSET UNITYSDK_OFFSET(0x1A0C93C0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_SET_AREASCORE_OFFSET UNITYSDK_OFFSET(0x1A0C93F0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_SET_COREEQUIPID_OFFSET UNITYSDK_OFFSET(0x1A0C9490)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_SET_FINALBATTLESCORE_OFFSET UNITYSDK_OFFSET(0x1A0C9430)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_SET_ISWIN_OFFSET UNITYSDK_OFFSET(0x1A0C93B0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_SET_LIFESCORE_OFFSET UNITYSDK_OFFSET(0x1A0C9410)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_SET_PLANEID_OFFSET UNITYSDK_OFFSET(0x1A0C9470)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_SET_REWARDS_OFFSET UNITYSDK_OFFSET(0x1A0C94F0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_SET_STAGEID_OFFSET UNITYSDK_OFFSET(0x1A0C9450)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_SET_STOPPEDAREAINDEX_OFFSET UNITYSDK_OFFSET(0x1A0C94B0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_SET_TOTALAREACOUNT_OFFSET UNITYSDK_OFFSET(0x1A0C94D0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_SET_TOTALSCORE_OFFSET UNITYSDK_OFFSET(0x1A0C93D0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_SYNCAREAINFO_OFFSET UNITYSDK_OFFSET(0x1A0C92C0)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA_SYNCREWARDS_OFFSET UNITYSDK_OFFSET(0x1A0C9320)
#define RPG_CLIENT_PIXAIR_PIXAIRGAMESETTLEMENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0C92B0)

namespace RPG::Client::PixAir
{
	inline static constexpr unsigned int PixAirGameSettlementData_TypeDefinitionIndex = 75331;
	...
	public:
		...
		::System::UInt32 _AreaScore_k__BackingField; // 0x18
		::System::Int32 _StoppedAreaIndex_k__BackingField; // 0x1C
		::System::UInt32 _TotalScore_k__BackingField; // 0x20
		::System::UInt32 _FinalBattleScore_k__BackingField; // 0x24
		::System::UInt32 _StageID_k__BackingField; // 0x28
		::System::UInt32 _LifeScore_k__BackingField; // 0x2C
		::System::UInt32 _CoreEquipID_k__BackingField; // 0x30
		::System::Boolean _IsWin_k__BackingField; // 0x34
		::System::UInt32 _PlaneID_k__BackingField; // 0x38
		::System::Int32 _TotalAreaCount_k__BackingField; // 0x3C
