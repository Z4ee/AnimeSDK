...
#define RPG_CLIENT_ACTIVITYSWORDTRAININGEXAMCOMMENTDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x18A939E0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGEXAMCOMMENTDATA_GET_COMMENT_OFFSET UNITYSDK_OFFSET(0x18A93B70)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGEXAMCOMMENTDATA_GET_IMGPATH_OFFSET UNITYSDK_OFFSET(0x18A93A70)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGEXAMCOMMENTDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0x18A93B10)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGEXAMCOMMENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18A93A60)

namespace RPG::Client
{
	inline static constexpr unsigned int ActivitySwordTrainingExamCommentData_TypeDefinitionIndex = 59192;
