...
#define RPG_CLIENT_MONOFOURFEETSIMPLEIK_CLASS_1_8EF1E1A464863438_METHOD_1_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0xD82ECE0)
#define RPG_CLIENT_MONOFOURFEETSIMPLEIK_CLASS_1_8EF1E1A464863438_METHOD_1_8A8F4D8840527053_OFFSET UNITYSDK_OFFSET(0xD82F4C0)
#define RPG_CLIENT_MONOFOURFEETSIMPLEIK_CLASS_1_8EF1E1A464863438_METHOD_1_A1C464B05BB7A5C1_OFFSET UNITYSDK_OFFSET(0xD82FA10)
#define RPG_CLIENT_MONOFOURFEETSIMPLEIK_CLASS_1_8EF1E1A464863438__CTOR_OFFSET UNITYSDK_OFFSET(0xD82E660)
...
namespace RPG::Client
{
	...
	{
	public:
		::Class_1_ED17B6CCBE9C897A* PCKJJLKKAHK; // 0x10
		::RPG::Client::MonoFourFeetSimpleIK_OriginTransform* DICDJJOJKGF; // 0x18
