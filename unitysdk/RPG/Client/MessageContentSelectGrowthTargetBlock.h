...
#define RPG_CLIENT_MESSAGECONTENTSELECTGROWTHTARGETBLOCK_EQUALS_OFFSET UNITYSDK_OFFSET(0xBFD9170)
#define RPG_CLIENT_MESSAGECONTENTSELECTGROWTHTARGETBLOCK_GET_FUNCTIONTYPE_OFFSET UNITYSDK_OFFSET(0xBFD9220)
#define RPG_CLIENT_MESSAGECONTENTSELECTGROWTHTARGETBLOCK_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xBFD9150)
#define RPG_CLIENT_MESSAGECONTENTSELECTGROWTHTARGETBLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0xBFD9160)

namespace RPG::Client
{
	inline static constexpr unsigned int MessageContentSelectGrowthTargetBlock_TypeDefinitionIndex = 59195;
