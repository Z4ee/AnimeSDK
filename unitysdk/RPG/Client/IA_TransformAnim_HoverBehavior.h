...
#define RPG_CLIENT_IA_TRANSFORMANIM_HOVERBEHAVIOR_ENDOFLATETICK_OFFSET UNITYSDK_OFFSET(0x19827860)
#define RPG_CLIENT_IA_TRANSFORMANIM_HOVERBEHAVIOR_GET_OWNER_OFFSET UNITYSDK_OFFSET(0x198272E0)
#define RPG_CLIENT_IA_TRANSFORMANIM_HOVERBEHAVIOR_GET_TARGET_OFFSET UNITYSDK_OFFSET(0x19827320)
#define RPG_CLIENT_IA_TRANSFORMANIM_HOVERBEHAVIOR_METHOD_3_1293CB739F1151A1_OFFSET UNITYSDK_OFFSET(0x19827770)
#define RPG_CLIENT_IA_TRANSFORMANIM_HOVERBEHAVIOR_METHOD_3_296B578F799AC8F6_OFFSET UNITYSDK_OFFSET(0x19828E30)
#define RPG_CLIENT_IA_TRANSFORMANIM_HOVERBEHAVIOR_METHOD_3_2B9D478141E0F891_OFFSET UNITYSDK_OFFSET(0x19827980)
#define RPG_CLIENT_IA_TRANSFORMANIM_HOVERBEHAVIOR_METHOD_3_3570E58C2E156B82_OFFSET UNITYSDK_OFFSET(0x198282E0)
#define RPG_CLIENT_IA_TRANSFORMANIM_HOVERBEHAVIOR_METHOD_3_636140A1D6119369_OFFSET UNITYSDK_OFFSET(0x19829080)
#define RPG_CLIENT_IA_TRANSFORMANIM_HOVERBEHAVIOR_METHOD_3_79830F666EE579C0_OFFSET UNITYSDK_OFFSET(0x19827380)
#define RPG_CLIENT_IA_TRANSFORMANIM_HOVERBEHAVIOR_METHOD_3_8B1B933BE4636A41_OFFSET UNITYSDK_OFFSET(0x19828C00)
#define RPG_CLIENT_IA_TRANSFORMANIM_HOVERBEHAVIOR_METHOD_3_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x19828240)
#define RPG_CLIENT_IA_TRANSFORMANIM_HOVERBEHAVIOR_METHOD_3_B1936CE4DA97AA45_1_OFFSET UNITYSDK_OFFSET(0x19827540)
#define RPG_CLIENT_IA_TRANSFORMANIM_HOVERBEHAVIOR_METHOD_3_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x198274A0)
#define RPG_CLIENT_IA_TRANSFORMANIM_HOVERBEHAVIOR_METHOD_3_C1CA05DDEB17E436_OFFSET UNITYSDK_OFFSET(0x19827C20)
#define RPG_CLIENT_IA_TRANSFORMANIM_HOVERBEHAVIOR_METHOD_3_C3B70C7BDD7129EC_OFFSET UNITYSDK_OFFSET(0x19828B90)
#define RPG_CLIENT_IA_TRANSFORMANIM_HOVERBEHAVIOR_METHOD_3_F7BA13C72A6B3F58_OFFSET UNITYSDK_OFFSET(0x198275F0)
#define RPG_CLIENT_IA_TRANSFORMANIM_HOVERBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x19829170)
