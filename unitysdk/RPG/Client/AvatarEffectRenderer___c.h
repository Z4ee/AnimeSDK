...
#define RPG_CLIENT_AVATAREFFECTRENDERER___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x9119BE0)
#define RPG_CLIENT_AVATAREFFECTRENDERER___C__CTOR_OFFSET UNITYSDK_OFFSET(0x9119C20)
#define RPG_CLIENT_AVATAREFFECTRENDERER___C__GET_MATERIALS_B__3_0_OFFSET UNITYSDK_OFFSET(0x9119C30)

namespace RPG::Client
{
	inline static constexpr unsigned int AvatarEffectRenderer___c_TypeDefinitionIndex = 57501;
	...
	public:
		...
		{
			return (::RPG::Client::AvatarEffectRenderer___c**)Il2CppClass::FromTypeDefinitionIndex(AvatarEffectRenderer___c_TypeDefinitionIndex)->GetStaticField(0x36940);
		}
		static ::System::Func_2<::RPG::Client::AvatarEffectRendererBehavior_AvatarEffectMat*, ::UnityEngine::Material*>** StaticGet___9__3_0()
		{
			return (::System::Func_2<::RPG::Client::AvatarEffectRendererBehavior_AvatarEffectMat*, ::UnityEngine::Material*>**)Il2CppClass::FromTypeDefinitionIndex(AvatarEffectRenderer___c_TypeDefinitionIndex)->GetStaticField(0x36948);
		}
