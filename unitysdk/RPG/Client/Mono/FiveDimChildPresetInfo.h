...
#define RPG_CLIENT_MONO_FIVEDIMCHILDPRESETINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xC056770)

namespace RPG::Client::Mono
{
	inline static constexpr unsigned int FiveDimChildPresetInfo_TypeDefinitionIndex = 70596;
