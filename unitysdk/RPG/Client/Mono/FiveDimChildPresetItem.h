...
#define RPG_CLIENT_MONO_FIVEDIMCHILDPRESETITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x18073330)

namespace RPG::Client::Mono
{
	inline static constexpr unsigned int FiveDimChildPresetItem_TypeDefinitionIndex = 72110;
