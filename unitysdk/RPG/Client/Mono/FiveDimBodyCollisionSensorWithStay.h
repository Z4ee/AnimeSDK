...
#define RPG_CLIENT_MONO_FIVEDIMBODYCOLLISIONSENSORWITHSTAY_ADD_ONSTAY_OFFSET UNITYSDK_OFFSET(0x19E27C20)
#define RPG_CLIENT_MONO_FIVEDIMBODYCOLLISIONSENSORWITHSTAY_ONCOLLISIONSTAY_OFFSET UNITYSDK_OFFSET(0x19E27BB0)
#define RPG_CLIENT_MONO_FIVEDIMBODYCOLLISIONSENSORWITHSTAY_REMOVE_ONSTAY_OFFSET UNITYSDK_OFFSET(0x19E27C80)
#define RPG_CLIENT_MONO_FIVEDIMBODYCOLLISIONSENSORWITHSTAY__CTOR_OFFSET UNITYSDK_OFFSET(0x19E27CE0)

namespace RPG::Client::Mono
{
	inline static constexpr unsigned int FiveDimBodyCollisionSensorWithStay_TypeDefinitionIndex = 75543;
