...
#define RPG_CLIENT_MONOENTITYTRIGGERCOLLISION_AWAKE_OFFSET UNITYSDK_OFFSET(0xA9B9EE0)
#define RPG_CLIENT_MONOENTITYTRIGGERCOLLISION_ISIGNOREENTITY_OFFSET UNITYSDK_OFFSET(0xA9B9320)
#define RPG_CLIENT_MONOENTITYTRIGGERCOLLISION_METHOD_5_EB71B5DC11D09A9C_OFFSET UNITYSDK_OFFSET(0xA9B9D40)
#define RPG_CLIENT_MONOENTITYTRIGGERCOLLISION_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0xA9B9670)
#define RPG_CLIENT_MONOENTITYTRIGGERCOLLISION_REGISTERIGNOREENTITY_OFFSET UNITYSDK_OFFSET(0xA9B8F90)
#define RPG_CLIENT_MONOENTITYTRIGGERCOLLISION_RESET_OFFSET UNITYSDK_OFFSET(0xA9B9F30)
#define RPG_CLIENT_MONOENTITYTRIGGERCOLLISION_UNREGISTERIGNOREENTITY_OFFSET UNITYSDK_OFFSET(0xA9B90C0)
#define RPG_CLIENT_MONOENTITYTRIGGERCOLLISION_UPDATE_OFFSET UNITYSDK_OFFSET(0xA9B8F20)
#define RPG_CLIENT_MONOENTITYTRIGGERCOLLISION__CCTOR_OFFSET UNITYSDK_OFFSET(0xA9BA060)
#define RPG_CLIENT_MONOENTITYTRIGGERCOLLISION__CTOR_OFFSET UNITYSDK_OFFSET(0xA9BA050)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEntityTriggerCollision_TypeDefinitionIndex = 63251;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::System::WeakReference_1<::RPG::GameCore::GameEntity*>*>**)Il2CppClass::FromTypeDefinitionIndex(MonoEntityTriggerCollision_TypeDefinitionIndex)->GetStaticField(0x3E820);
		}
