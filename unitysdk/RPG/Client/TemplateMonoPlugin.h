...
#define RPG_CLIENT_TEMPLATEMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC9DEB0)

namespace RPG::Client
{
	inline static constexpr unsigned int TemplateMonoPlugin_TypeDefinitionIndex = 70742;
