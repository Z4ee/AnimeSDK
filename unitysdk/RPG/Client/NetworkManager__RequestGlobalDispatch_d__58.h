...
#define RPG_CLIENT_NETWORKMANAGER__REQUESTGLOBALDISPATCH_D__58_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x18261DA0)
#define RPG_CLIENT_NETWORKMANAGER__REQUESTGLOBALDISPATCH_D__58_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x182623B0)
#define RPG_CLIENT_NETWORKMANAGER__REQUESTGLOBALDISPATCH_D__58_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x18262410)
#define RPG_CLIENT_NETWORKMANAGER__REQUESTGLOBALDISPATCH_D__58_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x182623C0)
#define RPG_CLIENT_NETWORKMANAGER__REQUESTGLOBALDISPATCH_D__58_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18261D30)
#define RPG_CLIENT_NETWORKMANAGER__REQUESTGLOBALDISPATCH_D__58__CTOR_OFFSET UNITYSDK_OFFSET(0x18261D20)
#define RPG_CLIENT_NETWORKMANAGER__REQUESTGLOBALDISPATCH_D__58___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x18261D80)

namespace RPG::Client
{
	inline static constexpr unsigned int NetworkManager__RequestGlobalDispatch_d__58_TypeDefinitionIndex = 66267;

	class NetworkManager__RequestGlobalDispatch_d__58 : public ::System::Object
	{
	public:
		::Il2CppArray<::System::String*>* __7__wrap6; // 0x10
		::System::String* _requestUrl_5__4; // 0x18
		::RPG::Client::NetworkManager* __4__this; // 0x20
		::System::String* _url_5__9; // 0x28
		::System::String* _errMsg_5__6; // 0x30
		::UnityEngine::Networking::UnityWebRequest* _request_5__10; // 0x38
		::System::Action_1<::System::Boolean>* callback; // 0x40
		...
		::System::Int32 _responseCode_5__5; // 0x5C
		::System::Int32 _tryIndex_5__2; // 0x60
