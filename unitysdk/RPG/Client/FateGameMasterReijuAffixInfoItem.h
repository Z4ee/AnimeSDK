...
#define RPG_CLIENT_FATEGAMEMASTERREIJUAFFIXINFOITEM_CREATE_OFFSET UNITYSDK_OFFSET(0xA345630)
#define RPG_CLIENT_FATEGAMEMASTERREIJUAFFIXINFOITEM_GET_EFFECTDESC_OFFSET UNITYSDK_OFFSET(0xA3461C0)
#define RPG_CLIENT_FATEGAMEMASTERREIJUAFFIXINFOITEM_GET_EXTRAEFFECTIDS_OFFSET UNITYSDK_OFFSET(0xA3462D0)
#define RPG_CLIENT_FATEGAMEMASTERREIJUAFFIXINFOITEM_GET_IDFORSORT_OFFSET UNITYSDK_OFFSET(0xA346040)
#define RPG_CLIENT_FATEGAMEMASTERREIJUAFFIXINFOITEM_GET_NAME_OFFSET UNITYSDK_OFFSET(0xA346050)
#define RPG_CLIENT_FATEGAMEMASTERREIJUAFFIXINFOITEM_GET_RARITY_OFFSET UNITYSDK_OFFSET(0xA346120)
#define RPG_CLIENT_FATEGAMEMASTERREIJUAFFIXINFOITEM_GET_REIJUAFFIXID_OFFSET UNITYSDK_OFFSET(0xA346020)
#define RPG_CLIENT_FATEGAMEMASTERREIJUAFFIXINFOITEM_GET_UNIQUEID_OFFSET UNITYSDK_OFFSET(0xA346030)
#define RPG_CLIENT_FATEGAMEMASTERREIJUAFFIXINFOITEM_GET__ROW_OFFSET UNITYSDK_OFFSET(0xA345E00)
#define RPG_CLIENT_FATEGAMEMASTERREIJUAFFIXINFOITEM_SYNC_OFFSET UNITYSDK_OFFSET(0xA345B70)
#define RPG_CLIENT_FATEGAMEMASTERREIJUAFFIXINFOITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xA345DF0)
#define RPG_CLIENT_FATEGAMEMASTERREIJUAFFIXINFOITEM__GETTEXTPARAMLIST_OFFSET UNITYSDK_OFFSET(0xA345E60)

namespace RPG::Client
{
	inline static constexpr unsigned int FateGameMasterReijuAffixInfoItem_TypeDefinitionIndex = 58961;
	...
	public:
		...
		static ::RPG::Client::FateGameMasterReijuAffixInfoItem* Create(::System::UInt32 reijuAffixID, ::System::UInt32 uniqueID, ::Class_1_F9FBCC956DFCF137_10* factory)
		{
			return ((::RPG::Client::FateGameMasterReijuAffixInfoItem*(*)(::System::UInt32, ::System::UInt32, ::Class_1_F9FBCC956DFCF137_10*))((::PBYTE)hIl2Cpp + RPG_CLIENT_FATEGAMEMASTERREIJUAFFIXINFOITEM_CREATE_OFFSET))(reijuAffixID, uniqueID, factory);
		}

		::System::Void Sync(::Class_1_47FACC21020F8B69* proto)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_47FACC21020F8B69*))((::PBYTE)hIl2Cpp + RPG_CLIENT_FATEGAMEMASTERREIJUAFFIXINFOITEM_SYNC_OFFSET))(this, proto);
		}
