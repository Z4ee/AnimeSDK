...
#define RPG_CLIENT_MONSTERDATA___GETMONSTERIDENUMERATORBYINFINITEWAVEID_D__22_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xC19B050)
#define RPG_CLIENT_MONSTERDATA___GETMONSTERIDENUMERATORBYINFINITEWAVEID_D__22_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_UINT32__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xC19B170)
#define RPG_CLIENT_MONSTERDATA___GETMONSTERIDENUMERATORBYINFINITEWAVEID_D__22_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xC19B1D0)
#define RPG_CLIENT_MONSTERDATA___GETMONSTERIDENUMERATORBYINFINITEWAVEID_D__22_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xC19B180)
#define RPG_CLIENT_MONSTERDATA___GETMONSTERIDENUMERATORBYINFINITEWAVEID_D__22_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC19B040)
#define RPG_CLIENT_MONSTERDATA___GETMONSTERIDENUMERATORBYINFINITEWAVEID_D__22__CTOR_OFFSET UNITYSDK_OFFSET(0xC19AB80)

namespace RPG::Client
{
	inline static constexpr unsigned int MonsterData___GetMonsterIDEnumeratorByInfiniteWaveID_d__22_TypeDefinitionIndex = 59087;
