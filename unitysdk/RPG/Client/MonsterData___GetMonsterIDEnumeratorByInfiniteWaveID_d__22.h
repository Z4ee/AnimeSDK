...
#define RPG_CLIENT_MONSTERDATA___GETMONSTERIDENUMERATORBYINFINITEWAVEID_D__22_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19559F90)
#define RPG_CLIENT_MONSTERDATA___GETMONSTERIDENUMERATORBYINFINITEWAVEID_D__22_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_UINT32__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1955A0B0)
#define RPG_CLIENT_MONSTERDATA___GETMONSTERIDENUMERATORBYINFINITEWAVEID_D__22_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1955A110)
#define RPG_CLIENT_MONSTERDATA___GETMONSTERIDENUMERATORBYINFINITEWAVEID_D__22_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1955A0C0)
#define RPG_CLIENT_MONSTERDATA___GETMONSTERIDENUMERATORBYINFINITEWAVEID_D__22_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19559F80)
#define RPG_CLIENT_MONSTERDATA___GETMONSTERIDENUMERATORBYINFINITEWAVEID_D__22__CTOR_OFFSET UNITYSDK_OFFSET(0x19559AE0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonsterData___GetMonsterIDEnumeratorByInfiniteWaveID_d__22_TypeDefinitionIndex = 60358;
