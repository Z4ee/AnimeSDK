...
#define RPG_CLIENT_RPGQUALITYSETTINGSDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18044D40)

namespace RPG::Client
{
	inline static constexpr unsigned int RPGQualitySettingsData_TypeDefinitionIndex = 67942;
