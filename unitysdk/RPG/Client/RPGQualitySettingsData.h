...
#define RPG_CLIENT_RPGQUALITYSETTINGSDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x167A2870)

namespace RPG::Client
{
	inline static constexpr unsigned int RPGQualitySettingsData_TypeDefinitionIndex = 64935;
