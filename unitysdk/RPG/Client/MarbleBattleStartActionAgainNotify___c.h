...
#define RPG_CLIENT_MARBLEBATTLESTARTACTIONAGAINNOTIFY___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x9B18BE0)
#define RPG_CLIENT_MARBLEBATTLESTARTACTIONAGAINNOTIFY___C__CTOR_OFFSET UNITYSDK_OFFSET(0x9B18C20)
#define RPG_CLIENT_MARBLEBATTLESTARTACTIONAGAINNOTIFY___C___CTOR_B__0_0_OFFSET UNITYSDK_OFFSET(0x9B18C30)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Func_2<::RPG::Client::MarbleBattleSealData*, ::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(MarbleBattleStartActionAgainNotify___c_TypeDefinitionIndex)->GetStaticField(0x2D9F0);
		}
		static ::RPG::Client::MarbleBattleStartActionAgainNotify___c** StaticGet___9()
		{
			return (::RPG::Client::MarbleBattleStartActionAgainNotify___c**)Il2CppClass::FromTypeDefinitionIndex(MarbleBattleStartActionAgainNotify___c_TypeDefinitionIndex)->GetStaticField(0x2D9F8);
		}
