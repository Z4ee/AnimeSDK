...
#define RPG_CLIENT_CHIMERAWORKROUNDINFO___C__DISPLAYCLASS42_0__CTOR_OFFSET UNITYSDK_OFFSET(0xB6C8BB0)
#define RPG_CLIENT_CHIMERAWORKROUNDINFO___C__DISPLAYCLASS42_0___ISROUNDANYSUBMISSIONFINISHED_B__0_OFFSET UNITYSDK_OFFSET(0xB6C9280)

namespace RPG::Client
{
	inline static constexpr unsigned int ChimeraWorkRoundInfo___c__DisplayClass42_0_TypeDefinitionIndex = 59451;
