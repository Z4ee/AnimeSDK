...
#define RPG_CLIENT_PLANETFESLINEUPAVATAR_CREATE_OFFSET UNITYSDK_OFFSET(0x1C378740)
#define RPG_CLIENT_PLANETFESLINEUPAVATAR_GET_AVATARID_OFFSET UNITYSDK_OFFSET(0x1C379700)
#define RPG_CLIENT_PLANETFESLINEUPAVATAR_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x1C379680)
#define RPG_CLIENT_PLANETFESLINEUPAVATAR_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x1C379720)
#define RPG_CLIENT_PLANETFESLINEUPAVATAR_SET_AVATARID_OFFSET UNITYSDK_OFFSET(0x1C379710)
#define RPG_CLIENT_PLANETFESLINEUPAVATAR_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0x1C379730)
#define RPG_CLIENT_PLANETFESLINEUPAVATAR__CTOR_OFFSET UNITYSDK_OFFSET(0x1C379670)
