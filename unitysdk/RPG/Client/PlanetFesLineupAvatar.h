...
#define RPG_CLIENT_PLANETFESLINEUPAVATAR_CREATE_OFFSET UNITYSDK_OFFSET(0x1A974F20)
#define RPG_CLIENT_PLANETFESLINEUPAVATAR_GET_AVATARID_OFFSET UNITYSDK_OFFSET(0x1A975D50)
#define RPG_CLIENT_PLANETFESLINEUPAVATAR_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x1A975CD0)
#define RPG_CLIENT_PLANETFESLINEUPAVATAR_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x1A975D70)
#define RPG_CLIENT_PLANETFESLINEUPAVATAR_SET_AVATARID_OFFSET UNITYSDK_OFFSET(0x1A975D60)
#define RPG_CLIENT_PLANETFESLINEUPAVATAR_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0x1A975D80)
#define RPG_CLIENT_PLANETFESLINEUPAVATAR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A975CC0)

namespace RPG::Client
{
	inline static constexpr unsigned int PlanetFesLineupAvatar_TypeDefinitionIndex = 63577;
