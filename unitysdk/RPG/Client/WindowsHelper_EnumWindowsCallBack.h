...
#define RPG_CLIENT_WINDOWSHELPER_ENUMWINDOWSCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xB4C9530)
#define RPG_CLIENT_WINDOWSHELPER_ENUMWINDOWSCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xB4C95A0)
#define RPG_CLIENT_WINDOWSHELPER_ENUMWINDOWSCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0xB4C91C0)
#define RPG_CLIENT_WINDOWSHELPER_ENUMWINDOWSCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0xB4C9140)

namespace RPG::Client
{
	inline static constexpr unsigned int WindowsHelper_EnumWindowsCallBack_TypeDefinitionIndex = 67444;
