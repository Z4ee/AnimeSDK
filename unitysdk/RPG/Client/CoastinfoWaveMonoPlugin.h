...
#define RPG_CLIENT_COASTINFOWAVEMONOPLUGIN_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x18003690)
#define RPG_CLIENT_COASTINFOWAVEMONOPLUGIN_GET_REFCORNER00LS_OFFSET UNITYSDK_OFFSET(0x180033C0)
#define RPG_CLIENT_COASTINFOWAVEMONOPLUGIN_GET_REFCORNER01LS_OFFSET UNITYSDK_OFFSET(0x18003400)
#define RPG_CLIENT_COASTINFOWAVEMONOPLUGIN_GET_REFCORNER10LS_OFFSET UNITYSDK_OFFSET(0x180033E0)
#define RPG_CLIENT_COASTINFOWAVEMONOPLUGIN_GET_REFCORNER11LS_OFFSET UNITYSDK_OFFSET(0x18003420)
#define RPG_CLIENT_COASTINFOWAVEMONOPLUGIN_GET_REFCORNERBAKED_OFFSET UNITYSDK_OFFSET(0x180033B0)
#define RPG_CLIENT_COASTINFOWAVEMONOPLUGIN_GET_REFCORNERUV00_10_OFFSET UNITYSDK_OFFSET(0x18003440)
#define RPG_CLIENT_COASTINFOWAVEMONOPLUGIN_GET_REFCORNERUV01_11_OFFSET UNITYSDK_OFFSET(0x18003450)
#define RPG_CLIENT_COASTINFOWAVEMONOPLUGIN_GET_REFMESHLOCALBOUNDS_OFFSET UNITYSDK_OFFSET(0x18003460)
#define RPG_CLIENT_COASTINFOWAVEMONOPLUGIN_SETREFCORNERDATA_OFFSET UNITYSDK_OFFSET(0x18003480)
#define RPG_CLIENT_COASTINFOWAVEMONOPLUGIN__CCTOR_OFFSET UNITYSDK_OFFSET(0x180037A0)
#define RPG_CLIENT_COASTINFOWAVEMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x180036E0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(CoastinfoWaveMonoPlugin_TypeDefinitionIndex)->GetStaticField(0x68B20);
		}
		static ::System::String** StaticGet_CoastInfoShaderPath()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(CoastinfoWaveMonoPlugin_TypeDefinitionIndex)->GetStaticField(0x68B28);
		}
		static ::System::String** StaticGet_RuntimeClipmapShaderPath()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(CoastinfoWaveMonoPlugin_TypeDefinitionIndex)->GetStaticField(0x68B30);
		}
