...
#define RPG_CLIENT_COASTINFOWAVEMONOPLUGIN_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xA0B04C0)
#define RPG_CLIENT_COASTINFOWAVEMONOPLUGIN_GET_REFCORNER00LS_OFFSET UNITYSDK_OFFSET(0xA0B01F0)
#define RPG_CLIENT_COASTINFOWAVEMONOPLUGIN_GET_REFCORNER01LS_OFFSET UNITYSDK_OFFSET(0xA0B0230)
#define RPG_CLIENT_COASTINFOWAVEMONOPLUGIN_GET_REFCORNER10LS_OFFSET UNITYSDK_OFFSET(0xA0B0210)
#define RPG_CLIENT_COASTINFOWAVEMONOPLUGIN_GET_REFCORNER11LS_OFFSET UNITYSDK_OFFSET(0xA0B0250)
#define RPG_CLIENT_COASTINFOWAVEMONOPLUGIN_GET_REFCORNERBAKED_OFFSET UNITYSDK_OFFSET(0xA0B01E0)
#define RPG_CLIENT_COASTINFOWAVEMONOPLUGIN_GET_REFCORNERUV00_10_OFFSET UNITYSDK_OFFSET(0xA0B0270)
#define RPG_CLIENT_COASTINFOWAVEMONOPLUGIN_GET_REFCORNERUV01_11_OFFSET UNITYSDK_OFFSET(0xA0B0280)
#define RPG_CLIENT_COASTINFOWAVEMONOPLUGIN_GET_REFMESHLOCALBOUNDS_OFFSET UNITYSDK_OFFSET(0xA0B0290)
#define RPG_CLIENT_COASTINFOWAVEMONOPLUGIN_SETREFCORNERDATA_OFFSET UNITYSDK_OFFSET(0xA0B02B0)
#define RPG_CLIENT_COASTINFOWAVEMONOPLUGIN__CCTOR_OFFSET UNITYSDK_OFFSET(0xA0B05D0)
#define RPG_CLIENT_COASTINFOWAVEMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xA0B0510)
#define RPG_CLIENT_COASTINFOWAVEMONOPLUGIN___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xA0B0630)

namespace RPG::Client
{
	inline static constexpr unsigned int CoastinfoWaveMonoPlugin_TypeDefinitionIndex = 65382;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(CoastinfoWaveMonoPlugin_TypeDefinitionIndex)->GetStaticField(0x5E520);
		}
		static ::System::String** StaticGet_TessellationAdaptiveShaderPath()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(CoastinfoWaveMonoPlugin_TypeDefinitionIndex)->GetStaticField(0x5E528);
		}
		static ::System::String** StaticGet_RuntimeClipmapShaderPath()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(CoastinfoWaveMonoPlugin_TypeDefinitionIndex)->GetStaticField(0x5E530);
		}
