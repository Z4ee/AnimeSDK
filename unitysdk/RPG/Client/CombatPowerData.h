...
#define RPG_CLIENT_COMBATPOWERDATA_GETCOMBATPOWERVALUE_OFFSET UNITYSDK_OFFSET(0xA0B13B0)
#define RPG_CLIENT_COMBATPOWERDATA_GETTOTALCOMBATPOWERVALUE_OFFSET UNITYSDK_OFFSET(0xA0B1310)
#define RPG_CLIENT_COMBATPOWERDATA_GETTOTALCOMBATPOWERVALUE_SERVER_OFFSET UNITYSDK_OFFSET(0xA0B1360)
#define RPG_CLIENT_COMBATPOWERDATA_GET__AVATARDATA_OFFSET UNITYSDK_OFFSET(0xA0B1540)
#define RPG_CLIENT_COMBATPOWERDATA_SETCOMBATPOWER_OFFSET UNITYSDK_OFFSET(0xA0B1280)
#define RPG_CLIENT_COMBATPOWERDATA_SET__AVATARDATA_OFFSET UNITYSDK_OFFSET(0xA0B1550)
#define RPG_CLIENT_COMBATPOWERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA0B10D0)

namespace RPG::Client
{
	inline static constexpr unsigned int CombatPowerData_TypeDefinitionIndex = 57664;

	class CombatPowerData : public ::System::Object
	{
	public:
		::System::Collections::Generic::SortedList_2<::RPG::GameCore::CombatPowerSource, ::System::Single>* _CombatPowerDict; // 0x10
		::RPG::Client::AvatarData* __AvatarData_k__BackingField; // 0x18
