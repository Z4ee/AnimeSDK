...
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORBEHAVIOR_STATECURVE_STATECONNECTION_GET_NEXTSTATENAME_OFFSET UNITYSDK_OFFSET(0x17B4E0D0)
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORBEHAVIOR_STATECURVE_STATECONNECTION_METHOD_1_A9E21AEFB7D4CB48_OFFSET UNITYSDK_OFFSET(0x17B4DDE0)
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORBEHAVIOR_STATECURVE_STATECONNECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x17B4E0C0)

namespace RPG::Client
{
	inline static constexpr unsigned int StageHarmonySignalDemodulatorBehavior_StateCurve_StateConnection_TypeDefinitionIndex = 67790;
