...
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORBEHAVIOR_STATECURVE_STATECONNECTION_GET_NEXTSTATENAME_OFFSET UNITYSDK_OFFSET(0xE0D6190)
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORBEHAVIOR_STATECURVE_STATECONNECTION_METHOD_1_A9E21AEFB7D4CB48_OFFSET UNITYSDK_OFFSET(0xE0D5EA0)
#define RPG_CLIENT_STAGEHARMONYSIGNALDEMODULATORBEHAVIOR_STATECURVE_STATECONNECTION__CTOR_OFFSET UNITYSDK_OFFSET(0xE0D6180)
