...
#define RPG_CLIENT_AVATARSERVANTEXTENSIONS_GETSERVANTID_OFFSET UNITYSDK_OFFSET(0x19ECBC40)

namespace RPG::Client
{
	inline static constexpr unsigned int AvatarServantExtensions_TypeDefinitionIndex = 62660;
