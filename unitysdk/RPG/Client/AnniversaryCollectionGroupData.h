...
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONGROUPDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1B31C410)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONGROUPDATA_GETPANELDATABYID_OFFSET UNITYSDK_OFFSET(0x1B31CD00)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONGROUPDATA_GET_ACTIVITYDATA_OFFSET UNITYSDK_OFFSET(0x1B31CC50)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONGROUPDATA_GET_ACTIVITYID_OFFSET UNITYSDK_OFFSET(0x1B31D100)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONGROUPDATA_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x1B31D060)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONGROUPDATA_GET_GROUPTYPE_OFFSET UNITYSDK_OFFSET(0x1B31D040)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONGROUPDATA_GET_ISEXPIRED_OFFSET UNITYSDK_OFFSET(0x1B31D230)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONGROUPDATA_GET_ISOPEN_OFFSET UNITYSDK_OFFSET(0x1B31D1A0)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONGROUPDATA_GET_PANELDATADICT_OFFSET UNITYSDK_OFFSET(0x1B31D290)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONGROUPDATA_GET_TABIDLIST_OFFSET UNITYSDK_OFFSET(0x1B31C6E0)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONGROUPDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0x1B31D0A0)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONGROUPDATA_SET_GROUPTYPE_OFFSET UNITYSDK_OFFSET(0x1B31D050)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONGROUPDATA_SET_PANELDATADICT_OFFSET UNITYSDK_OFFSET(0x1B31D2A0)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONGROUPDATA_SYNCSCHEDULE_OFFSET UNITYSDK_OFFSET(0x1B31C7E0)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONGROUPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B31C4A0)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONGROUPDATA__INITPLANEDATA_OFFSET UNITYSDK_OFFSET(0x1B31C4B0)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONGROUPDATA__ONACTIVITYENDED_OFFSET UNITYSDK_OFFSET(0x1B31CFE0)
#define RPG_CLIENT_ANNIVERSARYCOLLECTIONGROUPDATA__ONACTIVITYOPENED_OFFSET UNITYSDK_OFFSET(0x1B31CF80)
