...
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMEPREVIEW_CLASS_1_840480C78D39CB70__CTOR_OFFSET UNITYSDK_OFFSET(0xDE8D8F0)

namespace RPG::Client::RoadRash
{
	inline static constexpr unsigned int MonoRoadRashGamePreview_Class_1_840480C78D39CB70_TypeDefinitionIndex = 75443;
	...
	public:
		...
		::RPG::Client::RoadRash::MonoRoadRashGamePreviewCar* FMJPMFEDIJL; // 0x18
		::RPG::Client::RoadRash::MonoRoadRashGamePreview_PreviewCar* EABKOHGCHFP; // 0x20
