...
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMESETTINGS_COLLECTALLREFASSETPATH_OFFSET UNITYSDK_OFFSET(0x1BC66CD0)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMESETTINGS_METHOD_5_465B1FB725CC8225_OFFSET UNITYSDK_OFFSET(0x1BC66DF0)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMESETTINGS_METHOD_5_74D0451084850EEE_OFFSET UNITYSDK_OFFSET(0x1BC66D60)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMESETTINGS_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x1BC673A0)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMESETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC67E40)

namespace RPG::Client::RoadRash
{
	inline static constexpr unsigned int MonoRoadRashGameSettings_TypeDefinitionIndex = 75454;
