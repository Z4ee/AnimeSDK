...
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMECARDYNAMICPOSE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1BC611A0)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMECARDYNAMICPOSE_GET_ISAIRBORNE_OFFSET UNITYSDK_OFFSET(0x1BC60AE0)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMECARDYNAMICPOSE_GET_ISINKNOCKUP_OFFSET UNITYSDK_OFFSET(0x1799F9F0)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMECARDYNAMICPOSE_GET_ISINLANDING_OFFSET UNITYSDK_OFFSET(0x1BC60A10)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMECARDYNAMICPOSE_GET_KNOCKUPANCHORBACKWARDDISTANCE_OFFSET UNITYSDK_OFFSET(0x1799FA20)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMECARDYNAMICPOSE_GET_KNOCKUPANCHORDURATION_OFFSET UNITYSDK_OFFSET(0x1BC60770)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMECARDYNAMICPOSE_GET_KNOCKUPANCHORENABLED_OFFSET UNITYSDK_OFFSET(0x1799FA10)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMECARDYNAMICPOSE_GET_KNOCKUPANCHORTRANSITIONTIME_OFFSET UNITYSDK_OFFSET(0x1799FA30)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMECARDYNAMICPOSE_GET_KNOCKUPDURATION_OFFSET UNITYSDK_OFFSET(0x1799FA00)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMECARDYNAMICPOSE_GET_KNOCKUPNONELOCKEXTRA_OFFSET UNITYSDK_OFFSET(0x1BC60780)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMECARDYNAMICPOSE_GET_KNOCKUPPROGRESS01_OFFSET UNITYSDK_OFFSET(0x1BC60790)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMECARDYNAMICPOSE_GET_LANDINGDURATION_OFFSET UNITYSDK_OFFSET(0x1BC60A20)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMECARDYNAMICPOSE_METHOD_5_008BE31585279462_OFFSET UNITYSDK_OFFSET(0x1BC613B0)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMECARDYNAMICPOSE_METHOD_5_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x1BC612F0)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMECARDYNAMICPOSE_METHOD_5_25DEA5C65A602671_OFFSET UNITYSDK_OFFSET(0x1BC60CD0)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMECARDYNAMICPOSE_METHOD_5_30D1209326FA87FC_1_OFFSET UNITYSDK_OFFSET(0x1BC60E50)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMECARDYNAMICPOSE_METHOD_5_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x1BC60D20)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMECARDYNAMICPOSE_METHOD_5_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0x1BC60BE0)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMECARDYNAMICPOSE_METHOD_5_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0x1BC60F80)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMECARDYNAMICPOSE_METHOD_5_4343F372F34C05BF_3_OFFSET UNITYSDK_OFFSET(0x1BC61000)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMECARDYNAMICPOSE_METHOD_5_4343F372F34C05BF_4_OFFSET UNITYSDK_OFFSET(0x1BC60930)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMECARDYNAMICPOSE_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x1BC60AF0)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMECARDYNAMICPOSE_METHOD_5_4C08D8ADEA7109E7_OFFSET UNITYSDK_OFFSET(0x1BC61530)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMECARDYNAMICPOSE_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x1BC61350)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMECARDYNAMICPOSE_METHOD_5_C1D411CCBCF92815_OFFSET UNITYSDK_OFFSET(0x1BC61490)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMECARDYNAMICPOSE_METHOD_5_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x1BC612E0)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMECARDYNAMICPOSE_PRINTDEBUGSNAPSHOT_OFFSET UNITYSDK_OFFSET(0x1799F700)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMECARDYNAMICPOSE_RESETPOSE_OFFSET UNITYSDK_OFFSET(0x1BC61080)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMECARDYNAMICPOSE_SAMPLEPOSETHROTTLE_OFFSET UNITYSDK_OFFSET(0x1799F780)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMECARDYNAMICPOSE_SETAIRBORNE_OFFSET UNITYSDK_OFFSET(0x1BC60A80)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMECARDYNAMICPOSE_TICK_OFFSET UNITYSDK_OFFSET(0x1799E0B0)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMECARDYNAMICPOSE_TRIGGERKNOCKUP_OFFSET UNITYSDK_OFFSET(0x1799F8F0)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMECARDYNAMICPOSE_TRIGGERLANDINGIMPACT_OFFSET UNITYSDK_OFFSET(0x1799F870)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMECARDYNAMICPOSE_TRIGGERLANDING_OFFSET UNITYSDK_OFFSET(0x1BC60820)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMECARDYNAMICPOSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC617F0)

namespace RPG::Client::RoadRash
{
	inline static constexpr unsigned int MonoRoadRashGameCarDynamicPose_TypeDefinitionIndex = 75439;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_ROADRASH_MONOROADRASHGAMECARDYNAMICPOSE_METHOD_5_30D1209326FA87FC_OFFSET))(this);
		}

		::System::Void Method_5_30D1209326FA87FC_1()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_ROADRASH_MONOROADRASHGAMECARDYNAMICPOSE_METHOD_5_30D1209326FA87FC_1_OFFSET))(this);
		}
