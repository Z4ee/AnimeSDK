...
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMEPREVIEW_METHOD_5_1B856EBC2CA7A274_OFFSET UNITYSDK_OFFSET(0x1BC62CB0)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMEPREVIEW_METHOD_5_1CA0F27A750F142A_OFFSET UNITYSDK_OFFSET(0x1BC63150)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMEPREVIEW_METHOD_5_22E2AAA27D01258F_OFFSET UNITYSDK_OFFSET(0x1BC63DD0)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMEPREVIEW_METHOD_5_5EC9653F33CC734C_OFFSET UNITYSDK_OFFSET(0x1BC62390)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMEPREVIEW_METHOD_5_61077A503B5DBB84_OFFSET UNITYSDK_OFFSET(0x1BC63870)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMEPREVIEW_METHOD_5_848DC3DE5BBA4FBF_OFFSET UNITYSDK_OFFSET(0x1BC62060)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMEPREVIEW_METHOD_5_88BFC64A6E80E5DB_OFFSET UNITYSDK_OFFSET(0x1BC621D0)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMEPREVIEW_METHOD_5_CCD7B9751D03600B_OFFSET UNITYSDK_OFFSET(0x1BC63F90)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMEPREVIEW_METHOD_5_DF70B30DD7EC8E09_OFFSET UNITYSDK_OFFSET(0x1BC61F10)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMEPREVIEW_METHOD_5_E876C8B6D3B840A6_OFFSET UNITYSDK_OFFSET(0x1BC628D0)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMEPREVIEW_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1BC62180)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMEPREVIEW_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x1BC62300)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMEPREVIEW_PLAY_OFFSET UNITYSDK_OFFSET(0x1BC62860)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMEPREVIEW_RESETPREVIEW_OFFSET UNITYSDK_OFFSET(0x1BC62C50)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMEPREVIEW_STOP_OFFSET UNITYSDK_OFFSET(0x1BC62C10)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMEPREVIEW_UPDATE_OFFSET UNITYSDK_OFFSET(0x1BC61DD0)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMEPREVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC641E0)

namespace RPG::Client::RoadRash
{
	inline static constexpr unsigned int MonoRoadRashGamePreview_TypeDefinitionIndex = 75440;
