...
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMEPROJECTILE_BIND_OFFSET UNITYSDK_OFFSET(0xDE8EAD0)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMEPROJECTILE_COLLECTALLREFASSETPATH_OFFSET UNITYSDK_OFFSET(0xDE8EA00)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMEPROJECTILE_FORCEUPDATEAUTOEFFECTFOLLOW_OFFSET UNITYSDK_OFFSET(0xDE8F180)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMEPROJECTILE_GET_BINDENTITY_OFFSET UNITYSDK_OFFSET(0xDE8EA90)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMEPROJECTILE_GET_SERVICES_OFFSET UNITYSDK_OFFSET(0xDE8EAB0)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMEPROJECTILE_METHOD_5_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0xDE8F040)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMEPROJECTILE_METHOD_5_8CA88D55ECEFAD59_OFFSET UNITYSDK_OFFSET(0xDE8EB40)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMEPROJECTILE_SET_BINDENTITY_OFFSET UNITYSDK_OFFSET(0xDE8EAA0)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMEPROJECTILE_SET_SERVICES_OFFSET UNITYSDK_OFFSET(0xDE8EAC0)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMEPROJECTILE_UNBIND_OFFSET UNITYSDK_OFFSET(0xDE8EFF0)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMEPROJECTILE__CTOR_OFFSET UNITYSDK_OFFSET(0xDE8F2B0)

namespace RPG::Client::RoadRash
{
	inline static constexpr unsigned int MonoRoadRashGameProjectile_TypeDefinitionIndex = 75446;
