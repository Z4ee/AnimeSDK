...
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMEROAD_GET_DISTANCE_OFFSET UNITYSDK_OFFSET(0xDE8FEA0)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMEROAD_RESET_OFFSET UNITYSDK_OFFSET(0xDE8FF30)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMEROAD__CTOR_OFFSET UNITYSDK_OFFSET(0xDE90000)

namespace RPG::Client::RoadRash
{
	inline static constexpr unsigned int MonoRoadRashGameRoad_TypeDefinitionIndex = 75448;
