...
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMECAR_AWAKE_OFFSET UNITYSDK_OFFSET(0xDE7FF40)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMECAR_BIND_OFFSET UNITYSDK_OFFSET(0xDE800E0)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMECAR_COLLECTALLREFASSETPATH_OFFSET UNITYSDK_OFFSET(0xDE7FEC0)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMECAR_FINDCURVE_OFFSET UNITYSDK_OFFSET(0xDE7FD70)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMECAR_GET_BINDENTITY_OFFSET UNITYSDK_OFFSET(0xDE800A0)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMECAR_GET_SERVICES_OFFSET UNITYSDK_OFFSET(0xDE800C0)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMECAR_METHOD_5_4621217FC8B9E707_OFFSET UNITYSDK_OFFSET(0xDE807F0)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMECAR_METHOD_5_B53EC24F73349D5B_OFFSET UNITYSDK_OFFSET(0xDE801E0)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMECAR_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0xDE80190)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMECAR_ONTRIGGERSTAY_OFFSET UNITYSDK_OFFSET(0xDE807A0)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMECAR_SET_BINDENTITY_OFFSET UNITYSDK_OFFSET(0xDE800B0)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMECAR_SET_SERVICES_OFFSET UNITYSDK_OFFSET(0xDE800D0)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMECAR_UNBIND_OFFSET UNITYSDK_OFFSET(0xDE80140)
#define RPG_CLIENT_ROADRASH_MONOROADRASHGAMECAR__CTOR_OFFSET UNITYSDK_OFFSET(0xDE80850)

namespace RPG::Client::RoadRash
{
	inline static constexpr unsigned int MonoRoadRashGameCar_TypeDefinitionIndex = 75438;
