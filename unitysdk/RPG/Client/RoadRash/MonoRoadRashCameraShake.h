...
#define RPG_CLIENT_ROADRASH_MONOROADRASHCAMERASHAKE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1798F560)
#define RPG_CLIENT_ROADRASH_MONOROADRASHCAMERASHAKE_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x1798F4F0)
#define RPG_CLIENT_ROADRASH_MONOROADRASHCAMERASHAKE_METHOD_5_775B6D644F07B554_OFFSET UNITYSDK_OFFSET(0x1798F0E0)
#define RPG_CLIENT_ROADRASH_MONOROADRASHCAMERASHAKE_METHOD_5_EBAF10BBA97B82DD_OFFSET UNITYSDK_OFFSET(0x1798F650)
#define RPG_CLIENT_ROADRASH_MONOROADRASHCAMERASHAKE_STARTSHAKE_OFFSET UNITYSDK_OFFSET(0x1798F350)
#define RPG_CLIENT_ROADRASH_MONOROADRASHCAMERASHAKE_STOPSHAKE_OFFSET UNITYSDK_OFFSET(0x1798F400)
#define RPG_CLIENT_ROADRASH_MONOROADRASHCAMERASHAKE_TICK_OFFSET UNITYSDK_OFFSET(0x1798EDB0)
#define RPG_CLIENT_ROADRASH_MONOROADRASHCAMERASHAKE__CTOR_OFFSET UNITYSDK_OFFSET(0x1798F6A0)

namespace RPG::Client::RoadRash
{
	inline static constexpr unsigned int MonoRoadRashCameraShake_TypeDefinitionIndex = 75427;
