...
#define RPG_CLIENT_PLANETFESALLLANDINCOMEBUFF_COMBINE_OFFSET UNITYSDK_OFFSET(0x1A0EB7D0)
#define RPG_CLIENT_PLANETFESALLLANDINCOMEBUFF_GETCOMBINEKEY_OFFSET UNITYSDK_OFFSET(0x1A0EB880)
#define RPG_CLIENT_PLANETFESALLLANDINCOMEBUFF_GET_PERCENTINCREASE_OFFSET UNITYSDK_OFFSET(0x1A0EB6A0)
#define RPG_CLIENT_PLANETFESALLLANDINCOMEBUFF_ISEFFECTIVEONAVATAR_OFFSET UNITYSDK_OFFSET(0x1A0EB740)
#define RPG_CLIENT_PLANETFESALLLANDINCOMEBUFF_ISTRIGGERED_OFFSET UNITYSDK_OFFSET(0x1A0EB790)
#define RPG_CLIENT_PLANETFESALLLANDINCOMEBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0EB8E0)
#define RPG_CLIENT_PLANETFESALLLANDINCOMEBUFF__ONINITPARAM_OFFSET UNITYSDK_OFFSET(0x1A0EB6E0)

namespace RPG::Client
{
	inline static constexpr unsigned int PlanetFesAllLandIncomeBuff_TypeDefinitionIndex = 63584;
	...
	public:
		...
		{
			return ((::Class_0_16E4307DCC419505_859*(*)(::PVOID, ::RPG::Client::IPlanetFesBuff*))((::PBYTE)hIl2Cpp + RPG_CLIENT_PLANETFESALLLANDINCOMEBUFF_COMBINE_OFFSET))(this, a1);
		}
