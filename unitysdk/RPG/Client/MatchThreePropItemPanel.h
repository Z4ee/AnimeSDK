...
#define RPG_CLIENT_MATCHTHREEPROPITEMPANEL_AWAKE_OFFSET UNITYSDK_OFFSET(0xD650F10)
#define RPG_CLIENT_MATCHTHREEPROPITEMPANEL_GET_ONBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0xD650ED0)
#define RPG_CLIENT_MATCHTHREEPROPITEMPANEL_GET_PROPINFO_OFFSET UNITYSDK_OFFSET(0xD650EF0)
#define RPG_CLIENT_MATCHTHREEPROPITEMPANEL_INIT_OFFSET UNITYSDK_OFFSET(0xD651050)
#define RPG_CLIENT_MATCHTHREEPROPITEMPANEL_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xD6512A0)
#define RPG_CLIENT_MATCHTHREEPROPITEMPANEL_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0xD6510A0)
#define RPG_CLIENT_MATCHTHREEPROPITEMPANEL_SET_ONBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0xD650EE0)
#define RPG_CLIENT_MATCHTHREEPROPITEMPANEL_SET_PROPINFO_OFFSET UNITYSDK_OFFSET(0xD650F00)
#define RPG_CLIENT_MATCHTHREEPROPITEMPANEL__CTOR_OFFSET UNITYSDK_OFFSET(0xD651300)
