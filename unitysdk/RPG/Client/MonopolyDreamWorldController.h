...
#define RPG_CLIENT_MONOPOLYDREAMWORLDCONTROLLER_METHOD_5_77E4508564C6D7D6_OFFSET UNITYSDK_OFFSET(0xAA9B4D0)
#define RPG_CLIENT_MONOPOLYDREAMWORLDCONTROLLER_METHOD_5_A984848EA3E436DA_OFFSET UNITYSDK_OFFSET(0xAA9B640)
#define RPG_CLIENT_MONOPOLYDREAMWORLDCONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xAA9B450)
#define RPG_CLIENT_MONOPOLYDREAMWORLDCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0xAA9B3B0)
#define RPG_CLIENT_MONOPOLYDREAMWORLDCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAA9B690)

namespace RPG::Client
{
	inline static constexpr unsigned int MonopolyDreamWorldController_TypeDefinitionIndex = 67103;
