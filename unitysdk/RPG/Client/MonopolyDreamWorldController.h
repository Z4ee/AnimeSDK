...
#define RPG_CLIENT_MONOPOLYDREAMWORLDCONTROLLER_METHOD_5_7646FFE662147970_OFFSET UNITYSDK_OFFSET(0x1C2A1860)
#define RPG_CLIENT_MONOPOLYDREAMWORLDCONTROLLER_METHOD_5_77E4508564C6D7D6_OFFSET UNITYSDK_OFFSET(0x1C2A16E0)
#define RPG_CLIENT_MONOPOLYDREAMWORLDCONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1C2A1660)
#define RPG_CLIENT_MONOPOLYDREAMWORLDCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0x1C2A15A0)
#define RPG_CLIENT_MONOPOLYDREAMWORLDCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2A18B0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonopolyDreamWorldController_TypeDefinitionIndex = 72760;
