...
#define RPG_CLIENT_TRANSFORMSCREENADAPTER_METHOD_1_03634C321C72FBE4_OFFSET UNITYSDK_OFFSET(0xA61D2B0)
#define RPG_CLIENT_TRANSFORMSCREENADAPTER__CTOR_OFFSET UNITYSDK_OFFSET(0xA61EF40)
