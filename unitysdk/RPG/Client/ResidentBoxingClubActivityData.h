...
#define RPG_CLIENT_RESIDENTBOXINGCLUBACTIVITYDATA_GETPREMISSIONLIST_OFFSET UNITYSDK_OFFSET(0x173A2810)
#define RPG_CLIENT_RESIDENTBOXINGCLUBACTIVITYDATA_GET_ENTERPANELREDDOT_OFFSET UNITYSDK_OFFSET(0x173A28A0)
#define RPG_CLIENT_RESIDENTBOXINGCLUBACTIVITYDATA_ISENTERPANELFULLCOMPLETED_OFFSET UNITYSDK_OFFSET(0x173A27C0)
#define RPG_CLIENT_RESIDENTBOXINGCLUBACTIVITYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x173A25E0)

namespace RPG::Client
{
	inline static constexpr unsigned int ResidentBoxingClubActivityData_TypeDefinitionIndex = 59013;
