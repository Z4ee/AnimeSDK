...
#define RPG_CLIENT_MESSAGECONTENTRELICRECOMMENDBLOCK_EQUALS_OFFSET UNITYSDK_OFFSET(0x1AA20360)
#define RPG_CLIENT_MESSAGECONTENTRELICRECOMMENDBLOCK_GET_AVATARID_OFFSET UNITYSDK_OFFSET(0x1AA207E0)
#define RPG_CLIENT_MESSAGECONTENTRELICRECOMMENDBLOCK_GET_AVATAR_OFFSET UNITYSDK_OFFSET(0x1AA207F0)
#define RPG_CLIENT_MESSAGECONTENTRELICRECOMMENDBLOCK_GET_ISDATAREADY_OFFSET UNITYSDK_OFFSET(0x1AA20800)
#define RPG_CLIENT_MESSAGECONTENTRELICRECOMMENDBLOCK_GET_RECOMMENDPLAN_OFFSET UNITYSDK_OFFSET(0x1AA20920)
#define RPG_CLIENT_MESSAGECONTENTRELICRECOMMENDBLOCK_GET_SHOWEXPLAIN_OFFSET UNITYSDK_OFFSET(0x1AA20850)
#define RPG_CLIENT_MESSAGECONTENTRELICRECOMMENDBLOCK_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1AA20120)
#define RPG_CLIENT_MESSAGECONTENTRELICRECOMMENDBLOCK_REQUESTRECOMMENDDATA_OFFSET UNITYSDK_OFFSET(0x1AA201A0)
#define RPG_CLIENT_MESSAGECONTENTRELICRECOMMENDBLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA20170)
#define RPG_CLIENT_MESSAGECONTENTRELICRECOMMENDBLOCK__GETRECOMMENDPLAN_OFFSET UNITYSDK_OFFSET(0x1AA20410)
#define RPG_CLIENT_MESSAGECONTENTRELICRECOMMENDBLOCK__HASSMARTSUITSYSTEMPLAN_OFFSET UNITYSDK_OFFSET(0x1AA20710)
#define RPG_CLIENT_MESSAGECONTENTRELICRECOMMENDBLOCK__REQUESTRECOMMENDDATA_B__3_0_OFFSET UNITYSDK_OFFSET(0x1AA20970)

namespace RPG::Client
{
	inline static constexpr unsigned int MessageContentRelicRecommendBlock_TypeDefinitionIndex = 60471;
	...
	public:
		...
		::System::Boolean _WaitingData; // 0x3C
