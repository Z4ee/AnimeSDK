...
#define RPG_CLIENT_ACHIEVEMENTUTILS_DOESENTITYCONTAINSMODIFIER_OFFSET UNITYSDK_OFFSET(0x174802D0)

namespace RPG::Client
{
	inline static constexpr unsigned int AchievementUtils_TypeDefinitionIndex = 58628;
