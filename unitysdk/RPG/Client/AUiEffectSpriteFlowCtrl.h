...
#define RPG_CLIENT_AUIEFFECTSPRITEFLOWCTRL_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x9A93A50)
#define RPG_CLIENT_AUIEFFECTSPRITEFLOWCTRL_GETMATERIALFORRENDERING_OFFSET UNITYSDK_OFFSET(0x9A93BD0)
#define RPG_CLIENT_AUIEFFECTSPRITEFLOWCTRL_GET_IMAGE_OFFSET UNITYSDK_OFFSET(0x9A93800)
#define RPG_CLIENT_AUIEFFECTSPRITEFLOWCTRL_INITVALUE_OFFSET UNITYSDK_OFFSET(0x9A93960)
#define RPG_CLIENT_AUIEFFECTSPRITEFLOWCTRL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9A938B0)
#define RPG_CLIENT_AUIEFFECTSPRITEFLOWCTRL_RESET_OFFSET UNITYSDK_OFFSET(0x9A93910)
#define RPG_CLIENT_AUIEFFECTSPRITEFLOWCTRL__CTOR_OFFSET UNITYSDK_OFFSET(0x9A94040)
#define RPG_CLIENT_AUIEFFECTSPRITEFLOWCTRL___IFIXBASEPROXY_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9A940B0)

namespace RPG::Client
{
	inline static constexpr unsigned int AUiEffectSpriteFlowCtrl_TypeDefinitionIndex = 66793;
