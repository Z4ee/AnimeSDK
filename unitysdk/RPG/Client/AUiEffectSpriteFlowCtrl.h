...
#define RPG_CLIENT_AUIEFFECTSPRITEFLOWCTRL_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0xB072FF0)
#define RPG_CLIENT_AUIEFFECTSPRITEFLOWCTRL_GETMATERIALFORRENDERING_OFFSET UNITYSDK_OFFSET(0xB073170)
#define RPG_CLIENT_AUIEFFECTSPRITEFLOWCTRL_GET_IMAGE_OFFSET UNITYSDK_OFFSET(0xB072DA0)
#define RPG_CLIENT_AUIEFFECTSPRITEFLOWCTRL_INITVALUE_OFFSET UNITYSDK_OFFSET(0xB072F00)
#define RPG_CLIENT_AUIEFFECTSPRITEFLOWCTRL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB072E50)
#define RPG_CLIENT_AUIEFFECTSPRITEFLOWCTRL_RESET_OFFSET UNITYSDK_OFFSET(0xB072EB0)
#define RPG_CLIENT_AUIEFFECTSPRITEFLOWCTRL__CTOR_OFFSET UNITYSDK_OFFSET(0xB0735D0)
#define RPG_CLIENT_AUIEFFECTSPRITEFLOWCTRL___IFIXBASEPROXY_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB073640)

namespace RPG::Client
{
	inline static constexpr unsigned int AUiEffectSpriteFlowCtrl_TypeDefinitionIndex = 67733;
