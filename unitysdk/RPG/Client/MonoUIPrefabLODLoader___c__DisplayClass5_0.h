...
#define RPG_CLIENT_MONOUIPREFABLODLOADER___C__DISPLAYCLASS5_0__ASYNCLOAD_B__0_OFFSET UNITYSDK_OFFSET(0x9D4D380)
#define RPG_CLIENT_MONOUIPREFABLODLOADER___C__DISPLAYCLASS5_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9D4D230)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoUIPrefabLODLoader___c__DisplayClass5_0_TypeDefinitionIndex = 56344;
