...
#define RPG_CLIENT_MATERIALPROPERTYSERIALIZEFIELDTEMPLATE4_GETPROPERTYFIELDS_OFFSET UNITYSDK_OFFSET(0xA871100)
#define RPG_CLIENT_MATERIALPROPERTYSERIALIZEFIELDTEMPLATE4__CTOR_OFFSET UNITYSDK_OFFSET(0xA871340)
#define RPG_CLIENT_MATERIALPROPERTYSERIALIZEFIELDTEMPLATE4___IFIXBASEPROXY_GETPROPERTYFIELDS_OFFSET UNITYSDK_OFFSET(0xA871350)

namespace RPG::Client
{
	inline static constexpr unsigned int MaterialPropertySerializeFieldTemplate4_TypeDefinitionIndex = 65160;
