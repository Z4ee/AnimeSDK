...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPBLOOM_ISNEEDLUTPROPERTY_OFFSET UNITYSDK_OFFSET(0x116AA820)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPBLOOM_UPDATEPROPERTY_OFFSET UNITYSDK_OFFSET(0x116AA860)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPBLOOM__CTOR_OFFSET UNITYSDK_OFFSET(0x116AC250)
