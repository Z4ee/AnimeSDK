...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPBLOOM_ISNEEDLUTPROPERTY_OFFSET UNITYSDK_OFFSET(0x9CAA090)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPBLOOM_UPDATEPROPERTY_OFFSET UNITYSDK_OFFSET(0x9CAA0D0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPBLOOM__CTOR_OFFSET UNITYSDK_OFFSET(0x9CABAC0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPBLOOM___IFIXBASEPROXY_ISNEEDLUTPROPERTY_OFFSET UNITYSDK_OFFSET(0x9CABAE0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginCharaPropBloom_TypeDefinitionIndex = 57226;
