...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPBLOOM_ISNEEDLUTPROPERTY_OFFSET UNITYSDK_OFFSET(0xA96C060)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPBLOOM_UPDATEPROPERTY_OFFSET UNITYSDK_OFFSET(0xA96C0A0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPBLOOM__CTOR_OFFSET UNITYSDK_OFFSET(0xA96DA90)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPBLOOM___IFIXBASEPROXY_ISNEEDLUTPROPERTY_OFFSET UNITYSDK_OFFSET(0xA96DAB0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginCharaPropBloom_TypeDefinitionIndex = 64480;
