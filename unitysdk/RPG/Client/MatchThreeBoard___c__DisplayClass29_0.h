...
#define RPG_CLIENT_MATCHTHREEBOARD___C__DISPLAYCLASS29_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9B2BFD0)
#define RPG_CLIENT_MATCHTHREEBOARD___C__DISPLAYCLASS29_0__DOFLYEFFECTFROMPROPTOPIECE_B__0_OFFSET UNITYSDK_OFFSET(0x9B332F0)
#define RPG_CLIENT_MATCHTHREEBOARD___C__DISPLAYCLASS29_0__DOFLYEFFECTFROMPROPTOPIECE_B__1_OFFSET UNITYSDK_OFFSET(0x9B33300)

namespace RPG::Client
{
	inline static constexpr unsigned int MatchThreeBoard___c__DisplayClass29_0_TypeDefinitionIndex = 53532;
