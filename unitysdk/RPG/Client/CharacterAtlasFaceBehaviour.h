...
#define RPG_CLIENT_CHARACTERATLASFACEBEHAVIOUR_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB5804A0)
#define RPG_CLIENT_CHARACTERATLASFACEBEHAVIOUR_GET_OWNERMONO_OFFSET UNITYSDK_OFFSET(0xB580740)
#define RPG_CLIENT_CHARACTERATLASFACEBEHAVIOUR_METHOD_2_19FB5FBEA9EA66CD_OFFSET UNITYSDK_OFFSET(0xB5808E0)
#define RPG_CLIENT_CHARACTERATLASFACEBEHAVIOUR_METHOD_2_32F371754DD4B742_OFFSET UNITYSDK_OFFSET(0xB580200)
#define RPG_CLIENT_CHARACTERATLASFACEBEHAVIOUR_METHOD_2_6B72D4EE8C6E907F_OFFSET UNITYSDK_OFFSET(0xB580630)
#define RPG_CLIENT_CHARACTERATLASFACEBEHAVIOUR_METHOD_2_8594010D6A57C9BB_1_OFFSET UNITYSDK_OFFSET(0xB5806F0)
#define RPG_CLIENT_CHARACTERATLASFACEBEHAVIOUR_METHOD_2_8594010D6A57C9BB_OFFSET UNITYSDK_OFFSET(0xB580590)
#define RPG_CLIENT_CHARACTERATLASFACEBEHAVIOUR_METHOD_2_8FF354B64B657510_OFFSET UNITYSDK_OFFSET(0xB580790)
#define RPG_CLIENT_CHARACTERATLASFACEBEHAVIOUR_METHOD_2_DEDB6D705D6319DA_OFFSET UNITYSDK_OFFSET(0xB580DE0)
#define RPG_CLIENT_CHARACTERATLASFACEBEHAVIOUR_METHOD_2_E3DE31A03057E055_OFFSET UNITYSDK_OFFSET(0xB580310)
#define RPG_CLIENT_CHARACTERATLASFACEBEHAVIOUR_METHOD_2_EF9F68D628696187_OFFSET UNITYSDK_OFFSET(0xB580C00)
#define RPG_CLIENT_CHARACTERATLASFACEBEHAVIOUR__CCTOR_OFFSET UNITYSDK_OFFSET(0xB580DB0)
#define RPG_CLIENT_CHARACTERATLASFACEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xB580180)
#define RPG_CLIENT_CHARACTERATLASFACEBEHAVIOUR___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB580E40)

namespace RPG::Client
{
	inline static constexpr unsigned int CharacterAtlasFaceBehaviour_TypeDefinitionIndex = 65698;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(CharacterAtlasFaceBehaviour_TypeDefinitionIndex)->GetStaticField(0x12140);
		}
		static ::System::Int32* StaticGet_PROPERTY_USING_ATLAS_FACE()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(CharacterAtlasFaceBehaviour_TypeDefinitionIndex)->GetStaticField(0x12144);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::MonoBehaviour*))((::PBYTE)hIl2Cpp + RPG_CLIENT_CHARACTERATLASFACEBEHAVIOUR_METHOD_2_DEDB6D705D6319DA_OFFSET))(this, a1);
		}
