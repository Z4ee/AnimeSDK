...
#define RPG_CLIENT_CHARACTERATLASFACEBEHAVIOUR_DISPOSE_OFFSET UNITYSDK_OFFSET(0xCAC4B80)
#define RPG_CLIENT_CHARACTERATLASFACEBEHAVIOUR_GET_OWNERMONO_OFFSET UNITYSDK_OFFSET(0xCAC4E20)
#define RPG_CLIENT_CHARACTERATLASFACEBEHAVIOUR_METHOD_2_19FB5FBEA9EA66CD_OFFSET UNITYSDK_OFFSET(0xCAC4FC0)
#define RPG_CLIENT_CHARACTERATLASFACEBEHAVIOUR_METHOD_2_32F371754DD4B742_OFFSET UNITYSDK_OFFSET(0xCAC48E0)
#define RPG_CLIENT_CHARACTERATLASFACEBEHAVIOUR_METHOD_2_6B72D4EE8C6E907F_OFFSET UNITYSDK_OFFSET(0xCAC4D10)
#define RPG_CLIENT_CHARACTERATLASFACEBEHAVIOUR_METHOD_2_8594010D6A57C9BB_1_OFFSET UNITYSDK_OFFSET(0xCAC4DD0)
#define RPG_CLIENT_CHARACTERATLASFACEBEHAVIOUR_METHOD_2_8594010D6A57C9BB_OFFSET UNITYSDK_OFFSET(0xCAC4C70)
#define RPG_CLIENT_CHARACTERATLASFACEBEHAVIOUR_METHOD_2_8FF354B64B657510_OFFSET UNITYSDK_OFFSET(0xCAC4E70)
#define RPG_CLIENT_CHARACTERATLASFACEBEHAVIOUR_METHOD_2_E3DE31A03057E055_OFFSET UNITYSDK_OFFSET(0xCAC49F0)
#define RPG_CLIENT_CHARACTERATLASFACEBEHAVIOUR_METHOD_2_EF9F68D628696187_OFFSET UNITYSDK_OFFSET(0xCAC52E0)
#define RPG_CLIENT_CHARACTERATLASFACEBEHAVIOUR__CCTOR_OFFSET UNITYSDK_OFFSET(0xCAC5490)
#define RPG_CLIENT_CHARACTERATLASFACEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xCAC4860)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(CharacterAtlasFaceBehaviour_TypeDefinitionIndex)->GetStaticField(0xBBF0);
		}
		static ::System::Int32* StaticGet_PROPERTY_USING_ATLAS_FACE()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(CharacterAtlasFaceBehaviour_TypeDefinitionIndex)->GetStaticField(0xBBF4);
		}
