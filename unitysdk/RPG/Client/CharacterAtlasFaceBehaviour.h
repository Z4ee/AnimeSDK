...
#define RPG_CLIENT_CHARACTERATLASFACEBEHAVIOUR_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AD76540)
#define RPG_CLIENT_CHARACTERATLASFACEBEHAVIOUR_GET_OWNERMONO_OFFSET UNITYSDK_OFFSET(0x1AD767E0)
#define RPG_CLIENT_CHARACTERATLASFACEBEHAVIOUR_METHOD_2_19FB5FBEA9EA66CD_OFFSET UNITYSDK_OFFSET(0x1AD76980)
#define RPG_CLIENT_CHARACTERATLASFACEBEHAVIOUR_METHOD_2_32F371754DD4B742_OFFSET UNITYSDK_OFFSET(0x1AD762A0)
#define RPG_CLIENT_CHARACTERATLASFACEBEHAVIOUR_METHOD_2_6B72D4EE8C6E907F_OFFSET UNITYSDK_OFFSET(0x1AD766D0)
#define RPG_CLIENT_CHARACTERATLASFACEBEHAVIOUR_METHOD_2_8594010D6A57C9BB_1_OFFSET UNITYSDK_OFFSET(0x1AD76790)
#define RPG_CLIENT_CHARACTERATLASFACEBEHAVIOUR_METHOD_2_8594010D6A57C9BB_OFFSET UNITYSDK_OFFSET(0x1AD76630)
#define RPG_CLIENT_CHARACTERATLASFACEBEHAVIOUR_METHOD_2_8FF354B64B657510_OFFSET UNITYSDK_OFFSET(0x1AD76830)
#define RPG_CLIENT_CHARACTERATLASFACEBEHAVIOUR_METHOD_2_E3DE31A03057E055_OFFSET UNITYSDK_OFFSET(0x1AD763B0)
#define RPG_CLIENT_CHARACTERATLASFACEBEHAVIOUR_METHOD_2_EF9F68D628696187_OFFSET UNITYSDK_OFFSET(0x1AD76CA0)
#define RPG_CLIENT_CHARACTERATLASFACEBEHAVIOUR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AD76E50)
#define RPG_CLIENT_CHARACTERATLASFACEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD76220)

namespace RPG::Client
{
	inline static constexpr unsigned int CharacterAtlasFaceBehaviour_TypeDefinitionIndex = 70222;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(CharacterAtlasFaceBehaviour_TypeDefinitionIndex)->GetStaticField(0xC3D0);
		}
		static ::System::Int32* StaticGet_PROPERTY_ATLAS_DIVISION()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(CharacterAtlasFaceBehaviour_TypeDefinitionIndex)->GetStaticField(0xC3D4);
		}
