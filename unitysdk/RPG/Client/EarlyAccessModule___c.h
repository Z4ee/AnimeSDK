...
#define RPG_CLIENT_EARLYACCESSMODULE___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x952CAD0)
#define RPG_CLIENT_EARLYACCESSMODULE___C__CTOR_OFFSET UNITYSDK_OFFSET(0x952CB00)
#define RPG_CLIENT_EARLYACCESSMODULE___C__GETDOINGCONTENT_B__14_0_OFFSET UNITYSDK_OFFSET(0x952CB30)
#define RPG_CLIENT_EARLYACCESSMODULE___C__SENDEARLYACCESSDATA_B__9_0_OFFSET UNITYSDK_OFFSET(0x952CB10)

namespace RPG::Client
{
	inline static constexpr unsigned int EarlyAccessModule___c_TypeDefinitionIndex = 51694;
	...
	public:
		...
		{
			return (::System::Predicate_1<::RPG::Client::EarlyAccessContent*>**)Il2CppClass::FromTypeDefinitionIndex(EarlyAccessModule___c_TypeDefinitionIndex)->GetStaticField(0x45A80);
		}
		static ::RPG::Client::EarlyAccessModule___c** StaticGet___9()
		{
			return (::RPG::Client::EarlyAccessModule___c**)Il2CppClass::FromTypeDefinitionIndex(EarlyAccessModule___c_TypeDefinitionIndex)->GetStaticField(0x45A88);
		}
		static ::System::Func_2<::RPG::Client::EarlyAccessContent*, ::RPG::Client::Promises::IPromise*>** StaticGet___9__9_0()
		{
			return (::System::Func_2<::RPG::Client::EarlyAccessContent*, ::RPG::Client::Promises::IPromise*>**)Il2CppClass::FromTypeDefinitionIndex(EarlyAccessModule___c_TypeDefinitionIndex)->GetStaticField(0x45A90);
		}
