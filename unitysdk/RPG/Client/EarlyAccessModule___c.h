...
#define RPG_CLIENT_EARLYACCESSMODULE___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A69E140)
#define RPG_CLIENT_EARLYACCESSMODULE___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1A69E170)
#define RPG_CLIENT_EARLYACCESSMODULE___C__GETDOINGCONTENT_B__17_0_OFFSET UNITYSDK_OFFSET(0x1A69E1A0)
#define RPG_CLIENT_EARLYACCESSMODULE___C__SENDEARLYACCESSDATA_B__9_0_OFFSET UNITYSDK_OFFSET(0x1A69E180)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Func_2<::RPG::Client::EarlyAccessContent*, ::RPG::Client::Promises::IPromise*>**)Il2CppClass::FromTypeDefinitionIndex(EarlyAccessModule___c_TypeDefinitionIndex)->GetStaticField(0x5F570);
		}
		static ::RPG::Client::EarlyAccessModule___c** StaticGet___9()
		{
			return (::RPG::Client::EarlyAccessModule___c**)Il2CppClass::FromTypeDefinitionIndex(EarlyAccessModule___c_TypeDefinitionIndex)->GetStaticField(0x5F578);
		}
		static ::System::Predicate_1<::RPG::Client::EarlyAccessContent*>** StaticGet___9__17_0()
		{
			return (::System::Predicate_1<::RPG::Client::EarlyAccessContent*>**)Il2CppClass::FromTypeDefinitionIndex(EarlyAccessModule___c_TypeDefinitionIndex)->GetStaticField(0x5F580);
		}
