...
#define RPG_CLIENT_GRIDFIGHTSHOPREPLACEROLE__CTOR_OFFSET UNITYSDK_OFFSET(0xBBFECC0)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightShopReplaceRole_TypeDefinitionIndex = 60810;
