...
#define RPG_CLIENT_PLAYERNOUSCHESSROGUERECORDDATA_GET_ADVANCEDDIFFICULTY_OFFSET UNITYSDK_OFFSET(0xAD67190)
#define RPG_CLIENT_PLAYERNOUSCHESSROGUERECORDDATA_GET_AREAID_OFFSET UNITYSDK_OFFSET(0xAD67150)
#define RPG_CLIENT_PLAYERNOUSCHESSROGUERECORDDATA_GET_DIFFICULTY_OFFSET UNITYSDK_OFFSET(0xAD67210)
#define RPG_CLIENT_PLAYERNOUSCHESSROGUERECORDDATA_GET_DISPLAYTYPE_OFFSET UNITYSDK_OFFSET(0xAD671D0)
#define RPG_CLIENT_PLAYERNOUSCHESSROGUERECORDDATA_GET_DLCID_OFFSET UNITYSDK_OFFSET(0xAD67130)
#define RPG_CLIENT_PLAYERNOUSCHESSROGUERECORDDATA_GET_HASRECORD_OFFSET UNITYSDK_OFFSET(0xAD671E0)
#define RPG_CLIENT_PLAYERNOUSCHESSROGUERECORDDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xAD671F0)
#define RPG_CLIENT_PLAYERNOUSCHESSROGUERECORDDATA_GET_PRIMARYDIFFICULT_OFFSET UNITYSDK_OFFSET(0xAD67170)
#define RPG_CLIENT_PLAYERNOUSCHESSROGUERECORDDATA_GET_PROCESS_OFFSET UNITYSDK_OFFSET(0xAD671B0)
#define RPG_CLIENT_PLAYERNOUSCHESSROGUERECORDDATA_SET_ADVANCEDDIFFICULTY_OFFSET UNITYSDK_OFFSET(0xAD671A0)
#define RPG_CLIENT_PLAYERNOUSCHESSROGUERECORDDATA_SET_AREAID_OFFSET UNITYSDK_OFFSET(0xAD67160)
#define RPG_CLIENT_PLAYERNOUSCHESSROGUERECORDDATA_SET_DIFFICULTY_OFFSET UNITYSDK_OFFSET(0xAD67220)
#define RPG_CLIENT_PLAYERNOUSCHESSROGUERECORDDATA_SET_DLCID_OFFSET UNITYSDK_OFFSET(0xAD67140)
#define RPG_CLIENT_PLAYERNOUSCHESSROGUERECORDDATA_SET_NAME_OFFSET UNITYSDK_OFFSET(0xAD67200)
#define RPG_CLIENT_PLAYERNOUSCHESSROGUERECORDDATA_SET_PRIMARYDIFFICULT_OFFSET UNITYSDK_OFFSET(0xAD67180)
#define RPG_CLIENT_PLAYERNOUSCHESSROGUERECORDDATA_SET_PROCESS_OFFSET UNITYSDK_OFFSET(0xAD671C0)
#define RPG_CLIENT_PLAYERNOUSCHESSROGUERECORDDATA_SYNC_OFFSET UNITYSDK_OFFSET(0xAD67230)
#define RPG_CLIENT_PLAYERNOUSCHESSROGUERECORDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xAD67330)

namespace RPG::Client
{
	inline static constexpr unsigned int PlayerNousChessRogueRecordData_TypeDefinitionIndex = 59151;

	class PlayerNousChessRogueRecordData : public ::System::Object
	{
	public:
		::System::UInt32 _PrimaryDifficult_k__BackingField; // 0x10
		::System::UInt32 _DlcID_k__BackingField; // 0x14
		::System::UInt32 _AreaID_k__BackingField; // 0x18
		::System::UInt32 _Process_k__BackingField; // 0x1C
		::System::UInt32 _AdvancedDifficulty_k__BackingField; // 0x20
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_884FF7AB0BB45750*))((::PBYTE)hIl2Cpp + RPG_CLIENT_PLAYERNOUSCHESSROGUERECORDDATA_SYNC_OFFSET))(this, info);
		}
	};
}
