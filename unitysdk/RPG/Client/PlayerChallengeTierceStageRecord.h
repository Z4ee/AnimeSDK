...
#define RPG_CLIENT_PLAYERCHALLENGETIERCESTAGERECORD_GET_BUFFID_OFFSET UNITYSDK_OFFSET(0xDBA3B00)
#define RPG_CLIENT_PLAYERCHALLENGETIERCESTAGERECORD_GET_MEMBERS_OFFSET UNITYSDK_OFFSET(0xDBA3B20)
#define RPG_CLIENT_PLAYERCHALLENGETIERCESTAGERECORD_GET_STAGEINDEX_OFFSET UNITYSDK_OFFSET(0xDBA3AE0)
#define RPG_CLIENT_PLAYERCHALLENGETIERCESTAGERECORD_SET_BUFFID_OFFSET UNITYSDK_OFFSET(0xDBA3B10)
#define RPG_CLIENT_PLAYERCHALLENGETIERCESTAGERECORD_SET_STAGEINDEX_OFFSET UNITYSDK_OFFSET(0xDBA3AF0)
#define RPG_CLIENT_PLAYERCHALLENGETIERCESTAGERECORD_SYNC_OFFSET UNITYSDK_OFFSET(0xDBA3A50)
#define RPG_CLIENT_PLAYERCHALLENGETIERCESTAGERECORD__CTOR_OFFSET UNITYSDK_OFFSET(0xDBA3A10)
#define RPG_CLIENT_PLAYERCHALLENGETIERCESTAGERECORD__SYNCLINEUPMEMBERS_OFFSET UNITYSDK_OFFSET(0xDBA3B30)
