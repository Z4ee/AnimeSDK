...
#define RPG_CLIENT_PLAYERCHALLENGETIERCESTAGERECORD_GET_BUFFID_OFFSET UNITYSDK_OFFSET(0x19381CB0)
#define RPG_CLIENT_PLAYERCHALLENGETIERCESTAGERECORD_GET_MEMBERS_OFFSET UNITYSDK_OFFSET(0x19381CD0)
#define RPG_CLIENT_PLAYERCHALLENGETIERCESTAGERECORD_GET_STAGEINDEX_OFFSET UNITYSDK_OFFSET(0x19381C90)
#define RPG_CLIENT_PLAYERCHALLENGETIERCESTAGERECORD_SET_BUFFID_OFFSET UNITYSDK_OFFSET(0x19381CC0)
#define RPG_CLIENT_PLAYERCHALLENGETIERCESTAGERECORD_SET_STAGEINDEX_OFFSET UNITYSDK_OFFSET(0x19381CA0)
#define RPG_CLIENT_PLAYERCHALLENGETIERCESTAGERECORD_SYNC_OFFSET UNITYSDK_OFFSET(0x19381C00)
#define RPG_CLIENT_PLAYERCHALLENGETIERCESTAGERECORD__CTOR_OFFSET UNITYSDK_OFFSET(0x19381BC0)
#define RPG_CLIENT_PLAYERCHALLENGETIERCESTAGERECORD__SYNCLINEUPMEMBERS_OFFSET UNITYSDK_OFFSET(0x19381CE0)

namespace RPG::Client
{
	inline static constexpr unsigned int PlayerChallengeTierceStageRecord_TypeDefinitionIndex = 61357;
