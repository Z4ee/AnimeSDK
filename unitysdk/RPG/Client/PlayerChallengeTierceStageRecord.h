...
#define RPG_CLIENT_PLAYERCHALLENGETIERCESTAGERECORD_GET_BUFFID_OFFSET UNITYSDK_OFFSET(0xC49BE70)
#define RPG_CLIENT_PLAYERCHALLENGETIERCESTAGERECORD_GET_MEMBERS_OFFSET UNITYSDK_OFFSET(0xC49BE90)
#define RPG_CLIENT_PLAYERCHALLENGETIERCESTAGERECORD_GET_STAGEINDEX_OFFSET UNITYSDK_OFFSET(0xC49BE50)
#define RPG_CLIENT_PLAYERCHALLENGETIERCESTAGERECORD_SET_BUFFID_OFFSET UNITYSDK_OFFSET(0xC49BE80)
#define RPG_CLIENT_PLAYERCHALLENGETIERCESTAGERECORD_SET_STAGEINDEX_OFFSET UNITYSDK_OFFSET(0xC49BE60)
#define RPG_CLIENT_PLAYERCHALLENGETIERCESTAGERECORD_SYNC_OFFSET UNITYSDK_OFFSET(0xC49BDC0)
#define RPG_CLIENT_PLAYERCHALLENGETIERCESTAGERECORD__CTOR_OFFSET UNITYSDK_OFFSET(0xC49BD80)
#define RPG_CLIENT_PLAYERCHALLENGETIERCESTAGERECORD__SYNCLINEUPMEMBERS_OFFSET UNITYSDK_OFFSET(0xC49BEA0)

namespace RPG::Client
{
	inline static constexpr unsigned int PlayerChallengeTierceStageRecord_TypeDefinitionIndex = 60072;
