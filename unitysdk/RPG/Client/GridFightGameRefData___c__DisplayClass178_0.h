...
#define RPG_CLIENT_GRIDFIGHTGAMEREFDATA___C__DISPLAYCLASS178_0__CTOR_OFFSET UNITYSDK_OFFSET(0xBB71690)
#define RPG_CLIENT_GRIDFIGHTGAMEREFDATA___C__DISPLAYCLASS178_0__ISROLEMAIN_B__0_OFFSET UNITYSDK_OFFSET(0xBB744F0)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightGameRefData___c__DisplayClass178_0_TypeDefinitionIndex = 60522;
