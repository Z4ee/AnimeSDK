...
#define RPG_CLIENT_RELICPRESETEDITVIEWMODEL___C__DISPLAYCLASS4_0__CTOR_OFFSET UNITYSDK_OFFSET(0x19880330)
#define RPG_CLIENT_RELICPRESETEDITVIEWMODEL___C__DISPLAYCLASS4_0___SORTINVENTORYRELICITEMS_B__0_OFFSET UNITYSDK_OFFSET(0x19880650)

namespace RPG::Client
{
	inline static constexpr unsigned int RelicPresetEditViewModel___c__DisplayClass4_0_TypeDefinitionIndex = 63871;
	...
	public:
		...
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Int32>* relicTypeMatchScore; // 0x18
		::RPG::Client::RelicItemData* planRelic; // 0x20
		::RPG::Client::RelicPresetEditViewModel* __4__this; // 0x28
