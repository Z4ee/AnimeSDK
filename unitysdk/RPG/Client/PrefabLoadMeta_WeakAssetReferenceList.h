...
namespace RPG::Client
{
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Collections::Generic::List_1<::RPG::Client::WeakAssetReference>*))((::PBYTE)hIl2Cpp + RPG_CLIENT_PREFABLOADMETA_WEAKASSETREFERENCELIST__CTOR_OFFSET))(this, refs);
		}
		...
		::UnityEngine::GameObject* get_Item(::System::Int32 index)
		{
			return ((::UnityEngine::GameObject*(*)(::PVOID, ::System::Int32))((::PBYTE)hIl2Cpp + RPG_CLIENT_PREFABLOADMETA_WEAKASSETREFERENCELIST_GET_ITEM_OFFSET))(this, index);
		}
