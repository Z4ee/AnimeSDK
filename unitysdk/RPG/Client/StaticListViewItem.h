...
#define RPG_CLIENT_STATICLISTVIEWITEM_GET_ALIGNRECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0xC931050)
#define RPG_CLIENT_STATICLISTVIEWITEM_GET_ANIMATION_OFFSET UNITYSDK_OFFSET(0xC933DF0)
#define RPG_CLIENT_STATICLISTVIEWITEM_GET_BUTTONOBJECT_OFFSET UNITYSDK_OFFSET(0xC933D90)
#define RPG_CLIENT_STATICLISTVIEWITEM_GET_CACHEANIMATORBUTTON_OFFSET UNITYSDK_OFFSET(0xC930C80)
#define RPG_CLIENT_STATICLISTVIEWITEM_GET_CACHEANIMATOR_OFFSET UNITYSDK_OFFSET(0xC934040)
#define RPG_CLIENT_STATICLISTVIEWITEM_GET_CACHEDRECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0xC930B70)
#define RPG_CLIENT_STATICLISTVIEWITEM_GET_ITEMTRANSFORM_OFFSET UNITYSDK_OFFSET(0xC933D80)
#define RPG_CLIENT_STATICLISTVIEWITEM_GET_PREFABINDEX_OFFSET UNITYSDK_OFFSET(0xC933D60)
#define RPG_CLIENT_STATICLISTVIEWITEM_GET_USEROBJECTDATA_OFFSET UNITYSDK_OFFSET(0xC933D40)
#define RPG_CLIENT_STATICLISTVIEWITEM_ONNEW_OFFSET UNITYSDK_OFFSET(0xC930C40)
#define RPG_CLIENT_STATICLISTVIEWITEM_ONRECYCLE_OFFSET UNITYSDK_OFFSET(0xC930D90)
#define RPG_CLIENT_STATICLISTVIEWITEM_PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0xC9332C0)
#define RPG_CLIENT_STATICLISTVIEWITEM_SETALIGNRECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0xC933EA0)
#define RPG_CLIENT_STATICLISTVIEWITEM_SET_PREFABINDEX_OFFSET UNITYSDK_OFFSET(0xC933D70)
#define RPG_CLIENT_STATICLISTVIEWITEM_SET_USEROBJECTDATA_OFFSET UNITYSDK_OFFSET(0xC933D50)
#define RPG_CLIENT_STATICLISTVIEWITEM_START_OFFSET UNITYSDK_OFFSET(0xC933EF0)
#define RPG_CLIENT_STATICLISTVIEWITEM_TOSTRING_OFFSET UNITYSDK_OFFSET(0xC934180)
#define RPG_CLIENT_STATICLISTVIEWITEM_UPDATE_OFFSET UNITYSDK_OFFSET(0xC933FF0)
#define RPG_CLIENT_STATICLISTVIEWITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xC9343B0)
#define RPG_CLIENT_STATICLISTVIEWITEM___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0xC9343C0)

namespace RPG::Client
{
	inline static constexpr unsigned int StaticListViewItem_TypeDefinitionIndex = 67891;
