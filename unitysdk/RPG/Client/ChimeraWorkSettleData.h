...
#define RPG_CLIENT_CHIMERAWORKSETTLEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB6C5430)

namespace RPG::Client
{
	inline static constexpr unsigned int ChimeraWorkSettleData_TypeDefinitionIndex = 59391;
