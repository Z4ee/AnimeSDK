...
#define RPG_CLIENT_CHIMERAWORKSETTLEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCC18E80)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::UInt32 ReviveCnt; // 0x14
		::System::Single CauseDamage; // 0x18
		::System::UInt32 SendEmoCnt; // 0x1C
		::System::UInt32 Kill; // 0x20
		::System::Single TeammateBuffNum; // 0x24
