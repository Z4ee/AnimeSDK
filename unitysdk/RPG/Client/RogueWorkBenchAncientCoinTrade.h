...
#define RPG_CLIENT_ROGUEWORKBENCHANCIENTCOINTRADE_GETFUNCID_OFFSET UNITYSDK_OFFSET(0x16A11520)
#define RPG_CLIENT_ROGUEWORKBENCHANCIENTCOINTRADE_GETFUNCTYPE_OFFSET UNITYSDK_OFFSET(0x16A114E0)
#define RPG_CLIENT_ROGUEWORKBENCHANCIENTCOINTRADE_GET_ISDISABLE_OFFSET UNITYSDK_OFFSET(0x16A117A0)
#define RPG_CLIENT_ROGUEWORKBENCHANCIENTCOINTRADE_GET_PROPENTITYID_OFFSET UNITYSDK_OFFSET(0x16A117C0)
#define RPG_CLIENT_ROGUEWORKBENCHANCIENTCOINTRADE_OPENFUNCUIPAGE_OFFSET UNITYSDK_OFFSET(0x16A11560)
#define RPG_CLIENT_ROGUEWORKBENCHANCIENTCOINTRADE_REFRESH_OFFSET UNITYSDK_OFFSET(0x16A11480)
#define RPG_CLIENT_ROGUEWORKBENCHANCIENTCOINTRADE_SET_ISDISABLE_OFFSET UNITYSDK_OFFSET(0x16A117B0)
#define RPG_CLIENT_ROGUEWORKBENCHANCIENTCOINTRADE_SET_PROPENTITYID_OFFSET UNITYSDK_OFFSET(0x16A117D0)
#define RPG_CLIENT_ROGUEWORKBENCHANCIENTCOINTRADE__CTOR_OFFSET UNITYSDK_OFFSET(0x16A11470)
...
namespace RPG::Client
{
	...
	public:
		...
		::RPG::GameCore::RogueWorkbenchFuncType _FuncType; // 0x18
		::System::UInt32 _PropEntityID_k__BackingField; // 0x1C
