...
#define RPG_CLIENT_CURVEUNDIRECTEDEDGESETTING__CTOR_OFFSET UNITYSDK_OFFSET(0xB729D20)

namespace RPG::Client
{
	inline static constexpr unsigned int CurveUndirectedEdgeSetting_TypeDefinitionIndex = 64148;
