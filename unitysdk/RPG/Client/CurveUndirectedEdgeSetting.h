...
#define RPG_CLIENT_CURVEUNDIRECTEDEDGESETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x18083EA0)

namespace RPG::Client
{
	inline static constexpr unsigned int CurveUndirectedEdgeSetting_TypeDefinitionIndex = 65519;
