...
#define RPG_CLIENT_GRIDFIGHTMONSTERBATTLESTAGEDATA_GET_BONUSDROPLIST_OFFSET UNITYSDK_OFFSET(0x1BC4DCD0)
#define RPG_CLIENT_GRIDFIGHTMONSTERBATTLESTAGEDATA_GET_EXTRADIFFICULTY_OFFSET UNITYSDK_OFFSET(0x1BC4DD10)
#define RPG_CLIENT_GRIDFIGHTMONSTERBATTLESTAGEDATA_GET_OPTIONID_OFFSET UNITYSDK_OFFSET(0x1BC4DCF0)
#define RPG_CLIENT_GRIDFIGHTMONSTERBATTLESTAGEDATA_SET_BONUSDROPLIST_OFFSET UNITYSDK_OFFSET(0x1BC4DCE0)
#define RPG_CLIENT_GRIDFIGHTMONSTERBATTLESTAGEDATA_SET_OPTIONID_OFFSET UNITYSDK_OFFSET(0x1BC4DD00)
#define RPG_CLIENT_GRIDFIGHTMONSTERBATTLESTAGEDATA_SYNC_OFFSET UNITYSDK_OFFSET(0x1BC4C2C0)
#define RPG_CLIENT_GRIDFIGHTMONSTERBATTLESTAGEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC4DD60)
#define RPG_CLIENT_GRIDFIGHTMONSTERBATTLESTAGEDATA__GETEXTRADIFFICULTY_OFFSET UNITYSDK_OFFSET(0x1BC4D9F0)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightMonsterBattleStageData_TypeDefinitionIndex = 65118;
