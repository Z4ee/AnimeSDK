...
#define RPG_CLIENT_UI3D_UI3DVIRTUALCAMERASURROUNDVIEW_GET_CAMERASTATE_OFFSET UNITYSDK_OFFSET(0xE312CE0)
#define RPG_CLIENT_UI3D_UI3DVIRTUALCAMERASURROUNDVIEW_RESOLVECAMERASTATETYPE_OFFSET UNITYSDK_OFFSET(0xE312D90)
#define RPG_CLIENT_UI3D_UI3DVIRTUALCAMERASURROUNDVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xE312DF0)

namespace RPG::Client::UI3D
{
	inline static constexpr unsigned int UI3DVirtualCameraSurroundView_TypeDefinitionIndex = 78523;
