...
#define RPG_CLIENT_UI3D_UI3DVIRTUALCAMERABASE_ADDTRACKEDOFFSET_OFFSET UNITYSDK_OFFSET(0x1B125460)
#define RPG_CLIENT_UI3D_UI3DVIRTUALCAMERABASE_ADD_ACTIVECHANGED_OFFSET UNITYSDK_OFFSET(0x1B1250A0)
#define RPG_CLIENT_UI3D_UI3DVIRTUALCAMERABASE_BINDCAMERASTATE_OFFSET UNITYSDK_OFFSET(0x1B124D30)
#define RPG_CLIENT_UI3D_UI3DVIRTUALCAMERABASE_GET_CAMERASTATE_OFFSET UNITYSDK_OFFSET(0x1B1243F0)
#define RPG_CLIENT_UI3D_UI3DVIRTUALCAMERABASE_GET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1B124600)
#define RPG_CLIENT_UI3D_UI3DVIRTUALCAMERABASE_GET_KEY_OFFSET UNITYSDK_OFFSET(0x1B124010)
#define RPG_CLIENT_UI3D_UI3DVIRTUALCAMERABASE_METHOD_5_1B9CC121BDC8766D_OFFSET UNITYSDK_OFFSET(0x1B125760)
#define RPG_CLIENT_UI3D_UI3DVIRTUALCAMERABASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B125640)
#define RPG_CLIENT_UI3D_UI3DVIRTUALCAMERABASE_REMOVE_ACTIVECHANGED_OFFSET UNITYSDK_OFFSET(0x1B125100)
#define RPG_CLIENT_UI3D_UI3DVIRTUALCAMERABASE_SETAUTOFITSCREENENABLED_OFFSET UNITYSDK_OFFSET(0x1B1255E0)
#define RPG_CLIENT_UI3D_UI3DVIRTUALCAMERABASE_SETFOLLOW_OFFSET UNITYSDK_OFFSET(0x1B125230)
#define RPG_CLIENT_UI3D_UI3DVIRTUALCAMERABASE_SETFOV_OFFSET UNITYSDK_OFFSET(0x1B125300)
#define RPG_CLIENT_UI3D_UI3DVIRTUALCAMERABASE_SETLOOKAT_OFFSET UNITYSDK_OFFSET(0x1B125160)
#define RPG_CLIENT_UI3D_UI3DVIRTUALCAMERABASE_SETORBITALTRANSPOSERFOLLOWOFFSET_OFFSET UNITYSDK_OFFSET(0x1B125560)
#define RPG_CLIENT_UI3D_UI3DVIRTUALCAMERABASE_SETSCREENXY_OFFSET UNITYSDK_OFFSET(0x1B1254E0)
#define RPG_CLIENT_UI3D_UI3DVIRTUALCAMERABASE_SETTRACKEDOFFSET_OFFSET UNITYSDK_OFFSET(0x1B1253E0)
#define RPG_CLIENT_UI3D_UI3DVIRTUALCAMERABASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B125090)

namespace RPG::Client::UI3D
{
	inline static constexpr unsigned int UI3DVirtualCameraBase_TypeDefinitionIndex = 78519;
