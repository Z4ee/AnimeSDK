...
#define RPG_CLIENT_MONOEFFECTPLUGINDYNAMICTRAIL_METHOD_7_06330CD58CB602B6_OFFSET UNITYSDK_OFFSET(0x1912BBB0)
#define RPG_CLIENT_MONOEFFECTPLUGINDYNAMICTRAIL_METHOD_7_2CD6D17D088D5DB9_OFFSET UNITYSDK_OFFSET(0x1912BA20)
#define RPG_CLIENT_MONOEFFECTPLUGINDYNAMICTRAIL_METHOD_7_3E7178C5ECF017DB_OFFSET UNITYSDK_OFFSET(0x1912BB60)
#define RPG_CLIENT_MONOEFFECTPLUGINDYNAMICTRAIL_METHOD_7_652F3820D8B242FF_OFFSET UNITYSDK_OFFSET(0x1912BAD0)
#define RPG_CLIENT_MONOEFFECTPLUGINDYNAMICTRAIL_METHOD_7_A86A455D6AB5B836_OFFSET UNITYSDK_OFFSET(0x1912BA80)
#define RPG_CLIENT_MONOEFFECTPLUGINDYNAMICTRAIL__CTOR_OFFSET UNITYSDK_OFFSET(0x1912BC10)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginDynamicTrail_TypeDefinitionIndex = 66867;
