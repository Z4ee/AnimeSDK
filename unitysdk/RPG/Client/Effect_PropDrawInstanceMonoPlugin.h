...
#define RPG_CLIENT_EFFECT_PROPDRAWINSTANCEMONOPLUGIN_SETINSTANCEMATRICES_OFFSET UNITYSDK_OFFSET(0x15E92430)
#define RPG_CLIENT_EFFECT_PROPDRAWINSTANCEMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x15E924E0)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_PropDrawInstanceMonoPlugin_TypeDefinitionIndex = 70503;
