...
#define RPG_CLIENT_EXPEDITIONBATTLEACTIVITYDATA_ISSHOWDAILYREDDOT_OFFSET UNITYSDK_OFFSET(0x1B889F70)
#define RPG_CLIENT_EXPEDITIONBATTLEACTIVITYDATA_ISSHOWGOTOBTNREDDOT_OFFSET UNITYSDK_OFFSET(0x1B889D60)
#define RPG_CLIENT_EXPEDITIONBATTLEACTIVITYDATA_ISSHOWNORMALREDDOT_OFFSET UNITYSDK_OFFSET(0x1B889BC0)
#define RPG_CLIENT_EXPEDITIONBATTLEACTIVITYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B889BB0)
