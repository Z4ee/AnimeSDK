...
#define RPG_CLIENT_MUSICALBUMGROUPDATA_ADDMUSICALBUM_OFFSET UNITYSDK_OFFSET(0x190B08C0)
#define RPG_CLIENT_MUSICALBUMGROUPDATA_GETMUSICALBUMLIST_OFFSET UNITYSDK_OFFSET(0x190B0FD0)
#define RPG_CLIENT_MUSICALBUMGROUPDATA_GETMUSICALBUM_OFFSET UNITYSDK_OFFSET(0x190B0F40)
#define RPG_CLIENT_MUSICALBUMGROUPDATA_GET_GROUPICON_OFFSET UNITYSDK_OFFSET(0x190B13C0)
#define RPG_CLIENT_MUSICALBUMGROUPDATA_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x190B1480)
#define RPG_CLIENT_MUSICALBUMGROUPDATA_GET_GROUPNAME_OFFSET UNITYSDK_OFFSET(0x190B1410)
#define RPG_CLIENT_MUSICALBUMGROUPDATA_GET_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0x190B1280)
#define RPG_CLIENT_MUSICALBUMGROUPDATA_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x190B0AC0)
#define RPG_CLIENT_MUSICALBUMGROUPDATA_ISALLMUSICALBUMPLAYED_OFFSET UNITYSDK_OFFSET(0x190B1130)
#define RPG_CLIENT_MUSICALBUMGROUPDATA_RESETSTATUS_OFFSET UNITYSDK_OFFSET(0x190B0C10)
#define RPG_CLIENT_MUSICALBUMGROUPDATA_SYNCMUSICALBUM_OFFSET UNITYSDK_OFFSET(0x190B0DE0)
#define RPG_CLIENT_MUSICALBUMGROUPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x190B0820)

namespace RPG::Client
{
	inline static constexpr unsigned int MusicAlbumGroupData_TypeDefinitionIndex = 63413;
