...
#define RPG_CLIENT_GRIDFIGHTMONSTERSTAGEDATA_GETMONSTERLISTBYWAVE_OFFSET UNITYSDK_OFFSET(0xD21FB20)
#define RPG_CLIENT_GRIDFIGHTMONSTERSTAGEDATA_GET_BOSSDATA_OFFSET UNITYSDK_OFFSET(0xD2200C0)
#define RPG_CLIENT_GRIDFIGHTMONSTERSTAGEDATA_GET_CAMPCONFIG_OFFSET UNITYSDK_OFFSET(0xD220130)
#define RPG_CLIENT_GRIDFIGHTMONSTERSTAGEDATA_GET_HIGHESTTIERMONSTER_OFFSET UNITYSDK_OFFSET(0xD2200E0)
#define RPG_CLIENT_GRIDFIGHTMONSTERSTAGEDATA_GET_MONSTERLISTDICT_OFFSET UNITYSDK_OFFSET(0xD220170)
#define RPG_CLIENT_GRIDFIGHTMONSTERSTAGEDATA_GET_MONSTERLIST_OFFSET UNITYSDK_OFFSET(0xD21FBE0)
#define RPG_CLIENT_GRIDFIGHTMONSTERSTAGEDATA_GET_WAVECOUNT_OFFSET UNITYSDK_OFFSET(0xD220150)
#define RPG_CLIENT_GRIDFIGHTMONSTERSTAGEDATA_SET_BOSSDATA_OFFSET UNITYSDK_OFFSET(0xD2200D0)
#define RPG_CLIENT_GRIDFIGHTMONSTERSTAGEDATA_SET_CAMPCONFIG_OFFSET UNITYSDK_OFFSET(0xD220140)
#define RPG_CLIENT_GRIDFIGHTMONSTERSTAGEDATA_SET_MONSTERLISTDICT_OFFSET UNITYSDK_OFFSET(0xD220180)
#define RPG_CLIENT_GRIDFIGHTMONSTERSTAGEDATA_SET_WAVECOUNT_OFFSET UNITYSDK_OFFSET(0xD220160)
#define RPG_CLIENT_GRIDFIGHTMONSTERSTAGEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD21DDB0)
#define RPG_CLIENT_GRIDFIGHTMONSTERSTAGEDATA__GETGRIDFIGHTMONSTERWAVEDATA_OFFSET UNITYSDK_OFFSET(0xD21FC30)
#define RPG_CLIENT_GRIDFIGHTMONSTERSTAGEDATA__GETHIGHESTTIERMONSTER_OFFSET UNITYSDK_OFFSET(0xD21FDC0)
#define RPG_CLIENT_GRIDFIGHTMONSTERSTAGEDATA___GETGRIDFIGHTMONSTERWAVEDATA_B__1_0_OFFSET UNITYSDK_OFFSET(0xD220190)
#define RPG_CLIENT_GRIDFIGHTMONSTERSTAGEDATA___GETGRIDFIGHTMONSTERWAVEDATA_B__1_1_OFFSET UNITYSDK_OFFSET(0xD2201E0)
