...
#define RPG_CLIENT_MONOEFFECTPLUGINROTATE_ROTATENODE_METHOD_1_479759059E440327_OFFSET UNITYSDK_OFFSET(0xA99E4E0)
#define RPG_CLIENT_MONOEFFECTPLUGINROTATE_ROTATENODE_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xA99E2D0)
#define RPG_CLIENT_MONOEFFECTPLUGINROTATE_ROTATENODE_METHOD_1_F4ADC37B63F4E9EF_OFFSET UNITYSDK_OFFSET(0xA99E370)
#define RPG_CLIENT_MONOEFFECTPLUGINROTATE_ROTATENODE__CTOR_OFFSET UNITYSDK_OFFSET(0xA99E590)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginRotate_RotateNode_TypeDefinitionIndex = 64630;
