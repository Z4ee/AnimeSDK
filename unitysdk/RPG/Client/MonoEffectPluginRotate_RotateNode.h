...
#define RPG_CLIENT_MONOEFFECTPLUGINROTATE_ROTATENODE_METHOD_1_479759059E440327_OFFSET UNITYSDK_OFFSET(0x1B393D00)
#define RPG_CLIENT_MONOEFFECTPLUGINROTATE_ROTATENODE_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x1B393AF0)
#define RPG_CLIENT_MONOEFFECTPLUGINROTATE_ROTATENODE_METHOD_1_F4ADC37B63F4E9EF_OFFSET UNITYSDK_OFFSET(0x1B393B90)
#define RPG_CLIENT_MONOEFFECTPLUGINROTATE_ROTATENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B393DB0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginRotate_RotateNode_TypeDefinitionIndex = 70071;
