...
#define RPG_CLIENT_MONOEFFECTPLUGINROTATE_ROTATENODE_METHOD_1_479759059E440327_OFFSET UNITYSDK_OFFSET(0xC0EB8E0)
#define RPG_CLIENT_MONOEFFECTPLUGINROTATE_ROTATENODE_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xC0EB6D0)
#define RPG_CLIENT_MONOEFFECTPLUGINROTATE_ROTATENODE_METHOD_1_F4ADC37B63F4E9EF_OFFSET UNITYSDK_OFFSET(0xC0EB770)
#define RPG_CLIENT_MONOEFFECTPLUGINROTATE_ROTATENODE__CTOR_OFFSET UNITYSDK_OFFSET(0xC0EB990)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginRotate_RotateNode_TypeDefinitionIndex = 65551;
