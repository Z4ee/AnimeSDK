...
#define RPG_CLIENT_AIRSHIPCARDETECTAVOIDTRIGGER_GET_WORLDFORWARD_OFFSET UNITYSDK_OFFSET(0x19C5EF60)
#define RPG_CLIENT_AIRSHIPCARDETECTAVOIDTRIGGER_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x19C5F030)
#define RPG_CLIENT_AIRSHIPCARDETECTAVOIDTRIGGER_TICK_OFFSET UNITYSDK_OFFSET(0x19C5F0B0)
#define RPG_CLIENT_AIRSHIPCARDETECTAVOIDTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x19C5F660)
