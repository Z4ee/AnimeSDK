...
#define RPG_CLIENT_TEAMBUILDRECIPE___GETALTERNATIVEAVATARIDS_D__20_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xA567080)
#define RPG_CLIENT_TEAMBUILDRECIPE___GETALTERNATIVEAVATARIDS_D__20_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_UINT32__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xA567460)
#define RPG_CLIENT_TEAMBUILDRECIPE___GETALTERNATIVEAVATARIDS_D__20_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_UINT32__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xA5673D0)
#define RPG_CLIENT_TEAMBUILDRECIPE___GETALTERNATIVEAVATARIDS_D__20_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xA5674E0)
#define RPG_CLIENT_TEAMBUILDRECIPE___GETALTERNATIVEAVATARIDS_D__20_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xA567430)
#define RPG_CLIENT_TEAMBUILDRECIPE___GETALTERNATIVEAVATARIDS_D__20_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xA5673E0)
#define RPG_CLIENT_TEAMBUILDRECIPE___GETALTERNATIVEAVATARIDS_D__20_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA566F00)
#define RPG_CLIENT_TEAMBUILDRECIPE___GETALTERNATIVEAVATARIDS_D__20__CTOR_OFFSET UNITYSDK_OFFSET(0xA566D80)
#define RPG_CLIENT_TEAMBUILDRECIPE___GETALTERNATIVEAVATARIDS_D__20___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0xA566FD0)

namespace RPG::Client
{
	inline static constexpr unsigned int TeamBuildRecipe___GetAlternativeAvatarIDs_d__20_TypeDefinitionIndex = 55585;

	class TeamBuildRecipe___GetAlternativeAvatarIDs_d__20 : public ::System::Object
	{
	public:
		::System::Collections::Generic::IEnumerator_1<::System::UInt32>* __7__wrap1; // 0x10
		...
		::System::Collections::Generic::IList_1<::System::UInt32>* __3__avatarIDs; // 0x30
