...
#define RPG_CLIENT_NPCBODYSIZECONFIG_METHOD_3_A79C59C7B8291CFC_OFFSET UNITYSDK_OFFSET(0x1826D870)
#define RPG_CLIENT_NPCBODYSIZECONFIG_METHOD_3_EAD10B3E55E2C4C5_OFFSET UNITYSDK_OFFSET(0x1826D5F0)
#define RPG_CLIENT_NPCBODYSIZECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1826D970)

namespace RPG::Client
{
	inline static constexpr unsigned int NpcBodySizeConfig_TypeDefinitionIndex = 57382;
