...
#define RPG_CLIENT_WEAKASSETREFERENCE_EQUALS_OFFSET UNITYSDK_OFFSET(0x3B004C0)
#define RPG_CLIENT_WEAKASSETREFERENCE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3B004D0)
#define RPG_CLIENT_WEAKASSETREFERENCE_METHOD_2_050E70FEDB783306_OFFSET UNITYSDK_OFFSET(0x3B00330)
#define RPG_CLIENT_WEAKASSETREFERENCE_METHOD_2_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x3B00390)
#define RPG_CLIENT_WEAKASSETREFERENCE_METHOD_2_374150148187FD76_OFFSET UNITYSDK_OFFSET(0x1D29EFE0)
#define RPG_CLIENT_WEAKASSETREFERENCE_METHOD_2_DA1BF2C227DC3D86_OFFSET UNITYSDK_OFFSET(0x3B003F0)
#define RPG_CLIENT_WEAKASSETREFERENCE_METHOD_2_EDC938276DD38C8F_OFFSET UNITYSDK_OFFSET(0x1D29F090)
#define RPG_CLIENT_WEAKASSETREFERENCE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x3B00480)
#define RPG_CLIENT_WEAKASSETREFERENCE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x3B00440)
#define RPG_CLIENT_WEAKASSETREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x3B002D0)

namespace RPG::Client
{
	inline static constexpr unsigned int WeakAssetReference_TypeDefinitionIndex = 39241;
