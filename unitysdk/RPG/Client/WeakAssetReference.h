...
#define RPG_CLIENT_WEAKASSETREFERENCE_EQUALS_OFFSET UNITYSDK_OFFSET(0x22AFB30)
#define RPG_CLIENT_WEAKASSETREFERENCE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x22AFB40)
#define RPG_CLIENT_WEAKASSETREFERENCE_METHOD_2_050E70FEDB783306_OFFSET UNITYSDK_OFFSET(0x22AF9A0)
#define RPG_CLIENT_WEAKASSETREFERENCE_METHOD_2_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x22AFA00)
#define RPG_CLIENT_WEAKASSETREFERENCE_METHOD_2_374150148187FD76_OFFSET UNITYSDK_OFFSET(0x17B84590)
#define RPG_CLIENT_WEAKASSETREFERENCE_METHOD_2_DA1BF2C227DC3D86_OFFSET UNITYSDK_OFFSET(0x22AFA60)
#define RPG_CLIENT_WEAKASSETREFERENCE_METHOD_2_EDC938276DD38C8F_OFFSET UNITYSDK_OFFSET(0x17B84640)
#define RPG_CLIENT_WEAKASSETREFERENCE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x22AFAF0)
#define RPG_CLIENT_WEAKASSETREFERENCE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x22AFAB0)
#define RPG_CLIENT_WEAKASSETREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x22AF940)
#define RPG_CLIENT_WEAKASSETREFERENCE___IFIXBASEPROXY_EQUALS_OFFSET UNITYSDK_OFFSET(0x22AFC90)
#define RPG_CLIENT_WEAKASSETREFERENCE___IFIXBASEPROXY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x22AFD00)

namespace RPG::Client
{
	inline static constexpr unsigned int WeakAssetReference_TypeDefinitionIndex = 37701;
