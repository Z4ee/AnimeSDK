...
#define RPG_CLIENT_WEAKASSETREFERENCE_EQUALS_OFFSET UNITYSDK_OFFSET(0x3840BC0)
#define RPG_CLIENT_WEAKASSETREFERENCE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3840BD0)
#define RPG_CLIENT_WEAKASSETREFERENCE_METHOD_2_050E70FEDB783306_OFFSET UNITYSDK_OFFSET(0x3840A30)
#define RPG_CLIENT_WEAKASSETREFERENCE_METHOD_2_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x3840A90)
#define RPG_CLIENT_WEAKASSETREFERENCE_METHOD_2_374150148187FD76_OFFSET UNITYSDK_OFFSET(0x189325A0)
#define RPG_CLIENT_WEAKASSETREFERENCE_METHOD_2_DA1BF2C227DC3D86_OFFSET UNITYSDK_OFFSET(0x3840AF0)
#define RPG_CLIENT_WEAKASSETREFERENCE_METHOD_2_EDC938276DD38C8F_OFFSET UNITYSDK_OFFSET(0x18932650)
#define RPG_CLIENT_WEAKASSETREFERENCE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x3840B80)
#define RPG_CLIENT_WEAKASSETREFERENCE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x3840B40)
#define RPG_CLIENT_WEAKASSETREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x38409D0)
#define RPG_CLIENT_WEAKASSETREFERENCE___IFIXBASEPROXY_EQUALS_OFFSET UNITYSDK_OFFSET(0x3840D20)
#define RPG_CLIENT_WEAKASSETREFERENCE___IFIXBASEPROXY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3840D90)

namespace RPG::Client
{
	inline static constexpr unsigned int WeakAssetReference_TypeDefinitionIndex = 38433;
	...
	struct alignas(8) WeakAssetReference
	{
		...
		{
			return ((::System::Boolean(*)(::PVOID, ::System::Object*))((::PBYTE)hIl2Cpp + RPG_CLIENT_WEAKASSETREFERENCE___IFIXBASEPROXY_EQUALS_OFFSET))(this, a1);
		}
