...
#define RPG_CLIENT_QUADRATICEQUATION_METHOD_2_89FADE33F34E4AE0_1_OFFSET UNITYSDK_OFFSET(0x3926670)
#define RPG_CLIENT_QUADRATICEQUATION_METHOD_2_89FADE33F34E4AE0_OFFSET UNITYSDK_OFFSET(0x39265F0)
#define RPG_CLIENT_QUADRATICEQUATION_METHOD_2_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0x39266E0)
#define RPG_CLIENT_QUADRATICEQUATION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3926730)
#define RPG_CLIENT_QUADRATICEQUATION__CTOR_OFFSET UNITYSDK_OFFSET(0x7AF9A0)

namespace RPG::Client
{
	inline static constexpr unsigned int QuadraticEquation_TypeDefinitionIndex = 69903;
