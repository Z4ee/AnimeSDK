...
#define RPG_CLIENT_QUADRATICEQUATION_METHOD_2_89FADE33F34E4AE0_1_OFFSET UNITYSDK_OFFSET(0x141A70)
#define RPG_CLIENT_QUADRATICEQUATION_METHOD_2_89FADE33F34E4AE0_OFFSET UNITYSDK_OFFSET(0x1419F0)
#define RPG_CLIENT_QUADRATICEQUATION_METHOD_2_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0x141AE0)
#define RPG_CLIENT_QUADRATICEQUATION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x141B30)
#define RPG_CLIENT_QUADRATICEQUATION__CTOR_OFFSET UNITYSDK_OFFSET(0x259B0)
#define RPG_CLIENT_QUADRATICEQUATION___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x141B40)

namespace RPG::Client
{
	inline static constexpr unsigned int QuadraticEquation_TypeDefinitionIndex = 68409;
