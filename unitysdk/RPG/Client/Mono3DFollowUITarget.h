...
#define RPG_CLIENT_MONO3DFOLLOWUITARGET_AWAKE_OFFSET UNITYSDK_OFFSET(0x180737A0)
#define RPG_CLIENT_MONO3DFOLLOWUITARGET_GET_CAMERA3D_OFFSET UNITYSDK_OFFSET(0x18073780)
#define RPG_CLIENT_MONO3DFOLLOWUITARGET_GET_FOLLOWTARGET_OFFSET UNITYSDK_OFFSET(0x18073760)
#define RPG_CLIENT_MONO3DFOLLOWUITARGET_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x180738E0)
#define RPG_CLIENT_MONO3DFOLLOWUITARGET_SET_CAMERA3D_OFFSET UNITYSDK_OFFSET(0x18073790)
#define RPG_CLIENT_MONO3DFOLLOWUITARGET_SET_FOLLOWTARGET_OFFSET UNITYSDK_OFFSET(0x18073770)
#define RPG_CLIENT_MONO3DFOLLOWUITARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x18073C20)
#define RPG_CLIENT_MONO3DFOLLOWUITARGET__INIT_OFFSET UNITYSDK_OFFSET(0x18073850)
#define RPG_CLIENT_MONO3DFOLLOWUITARGET__REINITWITHCURRENTPOSITION_OFFSET UNITYSDK_OFFSET(0x18073B70)
#define RPG_CLIENT_MONO3DFOLLOWUITARGET__TRYUPDATEFOLLOWING_OFFSET UNITYSDK_OFFSET(0x18073930)
