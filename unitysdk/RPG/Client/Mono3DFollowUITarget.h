...
#define RPG_CLIENT_MONO3DFOLLOWUITARGET_AWAKE_OFFSET UNITYSDK_OFFSET(0xC056BF0)
#define RPG_CLIENT_MONO3DFOLLOWUITARGET_GET_CAMERA3D_OFFSET UNITYSDK_OFFSET(0xC056BD0)
#define RPG_CLIENT_MONO3DFOLLOWUITARGET_GET_FOLLOWTARGET_OFFSET UNITYSDK_OFFSET(0xC056BB0)
#define RPG_CLIENT_MONO3DFOLLOWUITARGET_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xC056D30)
#define RPG_CLIENT_MONO3DFOLLOWUITARGET_SET_CAMERA3D_OFFSET UNITYSDK_OFFSET(0xC056BE0)
#define RPG_CLIENT_MONO3DFOLLOWUITARGET_SET_FOLLOWTARGET_OFFSET UNITYSDK_OFFSET(0xC056BC0)
#define RPG_CLIENT_MONO3DFOLLOWUITARGET__CTOR_OFFSET UNITYSDK_OFFSET(0xC057070)
#define RPG_CLIENT_MONO3DFOLLOWUITARGET__INIT_OFFSET UNITYSDK_OFFSET(0xC056CA0)
#define RPG_CLIENT_MONO3DFOLLOWUITARGET__REINITWITHCURRENTPOSITION_OFFSET UNITYSDK_OFFSET(0xC056FC0)
#define RPG_CLIENT_MONO3DFOLLOWUITARGET__TRYUPDATEFOLLOWING_OFFSET UNITYSDK_OFFSET(0xC056D80)

namespace RPG::Client
{
	inline static constexpr unsigned int Mono3DFollowUITarget_TypeDefinitionIndex = 64483;
