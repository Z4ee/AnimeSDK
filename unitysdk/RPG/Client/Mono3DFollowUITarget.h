...
#define RPG_CLIENT_MONO3DFOLLOWUITARGET_AWAKE_OFFSET UNITYSDK_OFFSET(0xD72DF30)
#define RPG_CLIENT_MONO3DFOLLOWUITARGET_GET_CAMERA3D_OFFSET UNITYSDK_OFFSET(0xD72DF10)
#define RPG_CLIENT_MONO3DFOLLOWUITARGET_GET_FOLLOWTARGET_OFFSET UNITYSDK_OFFSET(0xD72DEF0)
#define RPG_CLIENT_MONO3DFOLLOWUITARGET_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xD72E070)
#define RPG_CLIENT_MONO3DFOLLOWUITARGET_SET_CAMERA3D_OFFSET UNITYSDK_OFFSET(0xD72DF20)
#define RPG_CLIENT_MONO3DFOLLOWUITARGET_SET_FOLLOWTARGET_OFFSET UNITYSDK_OFFSET(0xD72DF00)
#define RPG_CLIENT_MONO3DFOLLOWUITARGET__CTOR_OFFSET UNITYSDK_OFFSET(0xD72E3B0)
#define RPG_CLIENT_MONO3DFOLLOWUITARGET__INIT_OFFSET UNITYSDK_OFFSET(0xD72DFE0)
#define RPG_CLIENT_MONO3DFOLLOWUITARGET__REINITWITHCURRENTPOSITION_OFFSET UNITYSDK_OFFSET(0xD72E300)
#define RPG_CLIENT_MONO3DFOLLOWUITARGET__TRYUPDATEFOLLOWING_OFFSET UNITYSDK_OFFSET(0xD72E0C0)
