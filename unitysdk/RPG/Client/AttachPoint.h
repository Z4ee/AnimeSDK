...
#define RPG_CLIENT_ATTACHPOINT_GET_ISDYNAMIC_OFFSET UNITYSDK_OFFSET(0x19B3BCC0)
#define RPG_CLIENT_ATTACHPOINT_GET_LOCALSCALE_OFFSET UNITYSDK_OFFSET(0x19B3BD70)
#define RPG_CLIENT_ATTACHPOINT_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19B3BF40)
#define RPG_CLIENT_ATTACHPOINT_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19B3BF00)
#define RPG_CLIENT_ATTACHPOINT_SET_ISDYNAMIC_OFFSET UNITYSDK_OFFSET(0x19B3BD20)
#define RPG_CLIENT_ATTACHPOINT_SET_LOCALSCALE_OFFSET UNITYSDK_OFFSET(0x19B3BE40)
#define RPG_CLIENT_ATTACHPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x19B3BFD0)

namespace RPG::Client
{
	inline static constexpr unsigned int AttachPoint_TypeDefinitionIndex = 65314;
