...
#define RPG_CLIENT_ATTACHPOINT_GET_ISDYNAMIC_OFFSET UNITYSDK_OFFSET(0x9D46990)
#define RPG_CLIENT_ATTACHPOINT_GET_LOCALSCALE_OFFSET UNITYSDK_OFFSET(0x9D46A40)
#define RPG_CLIENT_ATTACHPOINT_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x9D46C10)
#define RPG_CLIENT_ATTACHPOINT_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x9D46BD0)
#define RPG_CLIENT_ATTACHPOINT_SET_ISDYNAMIC_OFFSET UNITYSDK_OFFSET(0x9D469F0)
#define RPG_CLIENT_ATTACHPOINT_SET_LOCALSCALE_OFFSET UNITYSDK_OFFSET(0x9D46B10)
#define RPG_CLIENT_ATTACHPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x9D46CA0)

namespace RPG::Client
{
	inline static constexpr unsigned int AttachPoint_TypeDefinitionIndex = 63028;
