...
#define RPG_CLIENT_EFFECT_CUTSCENE_REPLACEMATERIALS_DISPOSEPLUGIN_OFFSET UNITYSDK_OFFSET(0xB847C60)
#define RPG_CLIENT_EFFECT_CUTSCENE_REPLACEMATERIALS_IGNOREINEDITOR_OFFSET UNITYSDK_OFFSET(0xB8474D0)
#define RPG_CLIENT_EFFECT_CUTSCENE_REPLACEMATERIALS_METHOD_6_454FB4A3C7EA73DD_OFFSET UNITYSDK_OFFSET(0xB847EB0)
#define RPG_CLIENT_EFFECT_CUTSCENE_REPLACEMATERIALS_METHOD_6_7DD84EAFF333A1E4_OFFSET UNITYSDK_OFFSET(0xB847E60)
#define RPG_CLIENT_EFFECT_CUTSCENE_REPLACEMATERIALS_RESETPLUGIN_OFFSET UNITYSDK_OFFSET(0xB847D60)
#define RPG_CLIENT_EFFECT_CUTSCENE_REPLACEMATERIALS_TICK_OFFSET UNITYSDK_OFFSET(0xB847510)
#define RPG_CLIENT_EFFECT_CUTSCENE_REPLACEMATERIALS__CTOR_OFFSET UNITYSDK_OFFSET(0xB848010)
#define RPG_CLIENT_EFFECT_CUTSCENE_REPLACEMATERIALS___IFIXBASEPROXY_IGNOREINEDITOR_OFFSET UNITYSDK_OFFSET(0xB8480D0)
#define RPG_CLIENT_EFFECT_CUTSCENE_REPLACEMATERIALS___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0xB848130)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_Cutscene_ReplaceMaterials_TypeDefinitionIndex = 65863;
	...
	public:
		...
		::Class_1_1342B57709FD7AC5* Field_6_4; // 0x48
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + RPG_CLIENT_EFFECT_CUTSCENE_REPLACEMATERIALS___IFIXBASEPROXY_TICK_OFFSET))(this, a1);
		}
	};
}
