...
#define RPG_CLIENT_EFFECT_CUTSCENE_REPLACEMATERIALS_DISPOSEPLUGIN_OFFSET UNITYSDK_OFFSET(0x150E3050)
#define RPG_CLIENT_EFFECT_CUTSCENE_REPLACEMATERIALS_IGNOREINEDITOR_OFFSET UNITYSDK_OFFSET(0x150E28C0)
#define RPG_CLIENT_EFFECT_CUTSCENE_REPLACEMATERIALS_METHOD_6_454FB4A3C7EA73DD_OFFSET UNITYSDK_OFFSET(0x150E32A0)
#define RPG_CLIENT_EFFECT_CUTSCENE_REPLACEMATERIALS_METHOD_6_7DD84EAFF333A1E4_OFFSET UNITYSDK_OFFSET(0x150E3250)
#define RPG_CLIENT_EFFECT_CUTSCENE_REPLACEMATERIALS_RESETPLUGIN_OFFSET UNITYSDK_OFFSET(0x150E3150)
#define RPG_CLIENT_EFFECT_CUTSCENE_REPLACEMATERIALS_TICK_OFFSET UNITYSDK_OFFSET(0x150E2900)
#define RPG_CLIENT_EFFECT_CUTSCENE_REPLACEMATERIALS__CTOR_OFFSET UNITYSDK_OFFSET(0x150E3400)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_Cutscene_ReplaceMaterials_TypeDefinitionIndex = 67280;
