...
#define RPG_CLIENT_DYNAMICPATTERNEMITTERBEHAVIOR_PATTERNDATA_GET_AUDIOPLAYERGO_OFFSET UNITYSDK_OFFSET(0x1A6923A0)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERBEHAVIOR_PATTERNDATA_GET_IFACTIVE_OFFSET UNITYSDK_OFFSET(0x1A692400)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERBEHAVIOR_PATTERNDATA_GET_IFEMITNEXT_OFFSET UNITYSDK_OFFSET(0x1A6923E0)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERBEHAVIOR_PATTERNDATA_GET_IFPOSTAUDIO_OFFSET UNITYSDK_OFFSET(0x1A6923C0)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERBEHAVIOR_PATTERNDATA_GET_TIMER01_OFFSET UNITYSDK_OFFSET(0x1A692420)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERBEHAVIOR_PATTERNDATA_SET_AUDIOPLAYERGO_OFFSET UNITYSDK_OFFSET(0x1A6923B0)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERBEHAVIOR_PATTERNDATA_SET_IFACTIVE_OFFSET UNITYSDK_OFFSET(0x1A692410)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERBEHAVIOR_PATTERNDATA_SET_IFEMITNEXT_OFFSET UNITYSDK_OFFSET(0x1A6923F0)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERBEHAVIOR_PATTERNDATA_SET_IFPOSTAUDIO_OFFSET UNITYSDK_OFFSET(0x1A6923D0)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERBEHAVIOR_PATTERNDATA_SET_TIMER01_OFFSET UNITYSDK_OFFSET(0x1A692430)
#define RPG_CLIENT_DYNAMICPATTERNEMITTERBEHAVIOR_PATTERNDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A692440)

namespace RPG::Client
{
	inline static constexpr unsigned int DynamicPatternEmitterBehavior_PatternData_TypeDefinitionIndex = 70860;
