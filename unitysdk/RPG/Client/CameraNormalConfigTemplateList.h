...
#define RPG_CLIENT_CAMERANORMALCONFIGTEMPLATELIST_METHOD_3_8560D34C440F7DEB_OFFSET UNITYSDK_OFFSET(0xC9E2E20)
#define RPG_CLIENT_CAMERANORMALCONFIGTEMPLATELIST__CTOR_OFFSET UNITYSDK_OFFSET(0xC9EA6B0)
