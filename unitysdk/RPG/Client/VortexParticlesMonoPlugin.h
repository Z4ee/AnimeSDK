...
#define RPG_CLIENT_VORTEXPARTICLESMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1C81F860)

namespace RPG::Client
{
	inline static constexpr unsigned int VortexParticlesMonoPlugin_TypeDefinitionIndex = 70679;
