...
#define RPG_CLIENT_VORTEXPARTICLESMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xA783980)

namespace RPG::Client
{
	inline static constexpr unsigned int VortexParticlesMonoPlugin_TypeDefinitionIndex = 57917;
