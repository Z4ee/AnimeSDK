...
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0xAA04930)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0xAA049E0)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_GET_DEFAULTROTATEPITCH_OFFSET UNITYSDK_OFFSET(0xAA05420)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_GET_DEFAULTROTATEROLLFLAG_OFFSET UNITYSDK_OFFSET(0xAA05440)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_GET_ENABLEFORCE_OFFSET UNITYSDK_OFFSET(0xAA05370)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_GET_MAXRIGIDBODYROTPITCH_OFFSET UNITYSDK_OFFSET(0xAA05340)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_GET_MONOAVATAR_OFFSET UNITYSDK_OFFSET(0xAA05350)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_GET_MOVEPROXY_OFFSET UNITYSDK_OFFSET(0xAA053B0)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_GET_PROXY_OFFSET UNITYSDK_OFFSET(0xAA05390)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_METHOD_5_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0xAA05290)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_ONBIND_OFFSET UNITYSDK_OFFSET(0xAA04D00)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_ONUNBIND_OFFSET UNITYSDK_OFFSET(0xAA04E60)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xAA04FA0)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_SET_DEFAULTROTATEPITCH_OFFSET UNITYSDK_OFFSET(0xAA05430)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_SET_DEFAULTROTATEROLLFLAG_OFFSET UNITYSDK_OFFSET(0xAA05450)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_SET_ENABLEFORCE_OFFSET UNITYSDK_OFFSET(0xAA05380)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_SET_MONOAVATAR_OFFSET UNITYSDK_OFFSET(0xAA05360)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_SET_PROXY_OFFSET UNITYSDK_OFFSET(0xAA053A0)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAA05460)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoTravelShipController_TypeDefinitionIndex = 63425;
