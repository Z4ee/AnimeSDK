...
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0x9D417A0)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x9D41850)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_GET_DEFAULTROTATEPITCH_OFFSET UNITYSDK_OFFSET(0x9D42290)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_GET_DEFAULTROTATEROLLFLAG_OFFSET UNITYSDK_OFFSET(0x9D422B0)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_GET_ENABLEFORCE_OFFSET UNITYSDK_OFFSET(0x9D421E0)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_GET_MAXRIGIDBODYROTPITCH_OFFSET UNITYSDK_OFFSET(0x9D421B0)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_GET_MONOAVATAR_OFFSET UNITYSDK_OFFSET(0x9D421C0)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_GET_MOVEPROXY_OFFSET UNITYSDK_OFFSET(0x9D42220)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_GET_PROXY_OFFSET UNITYSDK_OFFSET(0x9D42200)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_METHOD_5_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x9D42100)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_ONBIND_OFFSET UNITYSDK_OFFSET(0x9D41B70)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_ONUNBIND_OFFSET UNITYSDK_OFFSET(0x9D41CD0)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x9D41E10)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_SET_DEFAULTROTATEPITCH_OFFSET UNITYSDK_OFFSET(0x9D422A0)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_SET_DEFAULTROTATEROLLFLAG_OFFSET UNITYSDK_OFFSET(0x9D422C0)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_SET_ENABLEFORCE_OFFSET UNITYSDK_OFFSET(0x9D421F0)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_SET_MONOAVATAR_OFFSET UNITYSDK_OFFSET(0x9D421D0)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_SET_PROXY_OFFSET UNITYSDK_OFFSET(0x9D42210)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9D422D0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoTravelShipController_TypeDefinitionIndex = 56182;
	...
	public:
		...
		::Class_2_57CD7C248B8FA7D6* _Proxy_k__BackingField; // 0x168
		...
		{
			return ((::System::Void(*)(::PVOID, ::RPG::Client::CharacterMonoAvatar*))((::PBYTE)hIl2Cpp + RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_SET_MONOAVATAR_OFFSET))(this, value);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Boolean))((::PBYTE)hIl2Cpp + RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_SET_ENABLEFORCE_OFFSET))(this, value);
		}

		::Class_2_57CD7C248B8FA7D6* get_Proxy()
		{
			return ((::Class_2_57CD7C248B8FA7D6*(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_GET_PROXY_OFFSET))(this);
		}

		::System::Void set_Proxy(::Class_2_57CD7C248B8FA7D6* value)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_57CD7C248B8FA7D6*))((::PBYTE)hIl2Cpp + RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_SET_PROXY_OFFSET))(this, value);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_SET_DEFAULTROTATEPITCH_OFFSET))(this, value);
		}
		...
		::System::Void set_DefaultRotateRollFlag(::System::Single value)
		{
			return ((::System::Void(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_SET_DEFAULTROTATEROLLFLAG_OFFSET))(this, value);
		}
	};
}
