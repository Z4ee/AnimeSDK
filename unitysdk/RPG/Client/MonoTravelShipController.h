...
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0xD8706C0)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0xD870770)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_GET_DEFAULTROTATEPITCH_OFFSET UNITYSDK_OFFSET(0xD8711E0)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_GET_DEFAULTROTATEROLLFLAG_OFFSET UNITYSDK_OFFSET(0xD871200)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_GET_ENABLEFORCE_OFFSET UNITYSDK_OFFSET(0xD871120)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_GET_MAXRIGIDBODYROTPITCH_OFFSET UNITYSDK_OFFSET(0xD8710F0)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_GET_MONOAVATAR_OFFSET UNITYSDK_OFFSET(0xD871100)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_GET_MOVEPROXY_OFFSET UNITYSDK_OFFSET(0xD871160)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_GET_PROXY_OFFSET UNITYSDK_OFFSET(0xD871140)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_METHOD_5_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0xD871040)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_ONBIND_OFFSET UNITYSDK_OFFSET(0xD870A90)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_ONUNBIND_OFFSET UNITYSDK_OFFSET(0xD870C00)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xD870D50)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_SET_DEFAULTROTATEPITCH_OFFSET UNITYSDK_OFFSET(0xD8711F0)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_SET_DEFAULTROTATEROLLFLAG_OFFSET UNITYSDK_OFFSET(0xD871210)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_SET_ENABLEFORCE_OFFSET UNITYSDK_OFFSET(0xD871130)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_SET_MONOAVATAR_OFFSET UNITYSDK_OFFSET(0xD871110)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER_SET_PROXY_OFFSET UNITYSDK_OFFSET(0xD871150)
#define RPG_CLIENT_MONOTRAVELSHIPCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD871220)
