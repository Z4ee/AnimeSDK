...
#define RPG_CLIENT_FANTASTICSTORYBUFFSLOTDATA_GET_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0xCF23200)
#define RPG_CLIENT_FANTASTICSTORYBUFFSLOTDATA_GET_UNLOCKCHAPTERID_OFFSET UNITYSDK_OFFSET(0xCF231B0)
#define RPG_CLIENT_FANTASTICSTORYBUFFSLOTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCF23170)
