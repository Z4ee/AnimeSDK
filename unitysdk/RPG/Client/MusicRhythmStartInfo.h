...
#define RPG_CLIENT_MUSICRHYTHMSTARTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xC22FC00)
...
namespace RPG::Client
{
	...
	{
	public:
		::System::Boolean ShowCircle; // 0x10
		::System::Int32 BeatCount; // 0x14
		::System::Single BeatTime; // 0x18
		::System::Single CircleOffset; // 0x1C
		...
		::System::Boolean HintVisible; // 0x34
		::System::Boolean LineVisible; // 0x35
		::System::Boolean IsPuMan; // 0x36
		::System::Boolean IsTutorial; // 0x37
