...
#define RPG_CLIENT_ACTIVITYPLAYERRETURNGACHARECOMMENDDATA_GETUPAVATARID_OFFSET UNITYSDK_OFFSET(0xB1E1FD0)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNGACHARECOMMENDDATA_GET_GACHAID_OFFSET UNITYSDK_OFFSET(0xB1E2080)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNGACHARECOMMENDDATA_GET_GACHAPOOLDATA_OFFSET UNITYSDK_OFFSET(0xB1E1F20)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNGACHARECOMMENDDATA_GET_IMAGEPATH_OFFSET UNITYSDK_OFFSET(0xB1E20A0)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNGACHARECOMMENDDATA_GET_TITLE_OFFSET UNITYSDK_OFFSET(0xB1E2130)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNGACHARECOMMENDDATA_ISAVAILABLE_OFFSET UNITYSDK_OFFSET(0xB1DFA30)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNGACHARECOMMENDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB1DF640)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNGACHARECOMMENDDATA___IFIXBASEPROXY_ISAVAILABLE_OFFSET UNITYSDK_OFFSET(0xB1E2200)

namespace RPG::Client
{
	inline static constexpr unsigned int ActivityPlayerReturnGachaRecommendData_TypeDefinitionIndex = 57867;
