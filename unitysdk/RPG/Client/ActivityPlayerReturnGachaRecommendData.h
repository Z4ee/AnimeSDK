...
#define RPG_CLIENT_ACTIVITYPLAYERRETURNGACHARECOMMENDDATA_GETUPAVATARID_OFFSET UNITYSDK_OFFSET(0xC66C6D0)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNGACHARECOMMENDDATA_GET_GACHAID_OFFSET UNITYSDK_OFFSET(0xC66C7D0)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNGACHARECOMMENDDATA_GET_GACHAPOOLDATA_OFFSET UNITYSDK_OFFSET(0xC66C5F0)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNGACHARECOMMENDDATA_GET_IMAGEPATH_OFFSET UNITYSDK_OFFSET(0xC66C820)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNGACHARECOMMENDDATA_GET_TITLE_OFFSET UNITYSDK_OFFSET(0xC66C8B0)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNGACHARECOMMENDDATA_ISAVAILABLE_OFFSET UNITYSDK_OFFSET(0xC66C510)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNGACHARECOMMENDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC669A80)
