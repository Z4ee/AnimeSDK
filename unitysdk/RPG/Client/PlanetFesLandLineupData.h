...
#define RPG_CLIENT_PLANETFESLANDLINEUPDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x9F9D5C0)
#define RPG_CLIENT_PLANETFESLANDLINEUPDATA_GET_LANDTYPE_OFFSET UNITYSDK_OFFSET(0x9F9D5A0)
#define RPG_CLIENT_PLANETFESLANDLINEUPDATA_SET_LANDTYPE_OFFSET UNITYSDK_OFFSET(0x9F9D5B0)
#define RPG_CLIENT_PLANETFESLANDLINEUPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9F9D7B0)

namespace RPG::Client
{
	inline static constexpr unsigned int PlanetFesLandLineupData_TypeDefinitionIndex = 54123;
