...
#define RPG_CLIENT_ELFRESTAURANTCUSTOMERDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1AC8D040)
#define RPG_CLIENT_ELFRESTAURANTCUSTOMERDATA_GET_CUSTOMERID_OFFSET UNITYSDK_OFFSET(0x1AC8D0B0)
#define RPG_CLIENT_ELFRESTAURANTCUSTOMERDATA_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x1AC8D1D0)
#define RPG_CLIENT_ELFRESTAURANTCUSTOMERDATA_GET_IMGPATH_OFFSET UNITYSDK_OFFSET(0x1AC8D0D0)
#define RPG_CLIENT_ELFRESTAURANTCUSTOMERDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1AC8D270)
#define RPG_CLIENT_ELFRESTAURANTCUSTOMERDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0x1AC8D170)
#define RPG_CLIENT_ELFRESTAURANTCUSTOMERDATA_SET_CUSTOMERID_OFFSET UNITYSDK_OFFSET(0x1AC8D0C0)
#define RPG_CLIENT_ELFRESTAURANTCUSTOMERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC8D0A0)

namespace RPG::Client
{
	inline static constexpr unsigned int ElfRestaurantCustomerData_TypeDefinitionIndex = 63799;
