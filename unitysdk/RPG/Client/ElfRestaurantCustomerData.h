...
#define RPG_CLIENT_ELFRESTAURANTCUSTOMERDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xCE61680)
#define RPG_CLIENT_ELFRESTAURANTCUSTOMERDATA_GET_CUSTOMERID_OFFSET UNITYSDK_OFFSET(0xCE616F0)
#define RPG_CLIENT_ELFRESTAURANTCUSTOMERDATA_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xCE61810)
#define RPG_CLIENT_ELFRESTAURANTCUSTOMERDATA_GET_IMGPATH_OFFSET UNITYSDK_OFFSET(0xCE61710)
#define RPG_CLIENT_ELFRESTAURANTCUSTOMERDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xCE618B0)
#define RPG_CLIENT_ELFRESTAURANTCUSTOMERDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xCE617B0)
#define RPG_CLIENT_ELFRESTAURANTCUSTOMERDATA_SET_CUSTOMERID_OFFSET UNITYSDK_OFFSET(0xCE61700)
#define RPG_CLIENT_ELFRESTAURANTCUSTOMERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCE616E0)
