...
#define RPG_CLIENT_ROGUEWORKBENCHLEVELUPMAGICSCEPTERITEM_GET_COSTDATA_OFFSET UNITYSDK_OFFSET(0xC87C9C0)
#define RPG_CLIENT_ROGUEWORKBENCHLEVELUPMAGICSCEPTERITEM_GET_ID_OFFSET UNITYSDK_OFFSET(0xC87C9A0)
#define RPG_CLIENT_ROGUEWORKBENCHLEVELUPMAGICSCEPTERITEM_GET_SCEPTERDATA_OFFSET UNITYSDK_OFFSET(0xC87C9E0)
#define RPG_CLIENT_ROGUEWORKBENCHLEVELUPMAGICSCEPTERITEM_SET_COSTDATA_OFFSET UNITYSDK_OFFSET(0xC87C9D0)
#define RPG_CLIENT_ROGUEWORKBENCHLEVELUPMAGICSCEPTERITEM_SET_ID_OFFSET UNITYSDK_OFFSET(0xC87C9B0)
#define RPG_CLIENT_ROGUEWORKBENCHLEVELUPMAGICSCEPTERITEM_SET_SCEPTERDATA_OFFSET UNITYSDK_OFFSET(0xC87C9F0)
#define RPG_CLIENT_ROGUEWORKBENCHLEVELUPMAGICSCEPTERITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xC87C680)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueWorkBenchLevelUpMagicScepterItem_TypeDefinitionIndex = 62983;
