...
#define RPG_CLIENT_ROGUEWORKBENCHLEVELUPMAGICSCEPTERITEM_GET_COSTDATA_OFFSET UNITYSDK_OFFSET(0x16A149F0)
#define RPG_CLIENT_ROGUEWORKBENCHLEVELUPMAGICSCEPTERITEM_GET_ID_OFFSET UNITYSDK_OFFSET(0x16A149D0)
#define RPG_CLIENT_ROGUEWORKBENCHLEVELUPMAGICSCEPTERITEM_GET_SCEPTERDATA_OFFSET UNITYSDK_OFFSET(0x16A14A10)
#define RPG_CLIENT_ROGUEWORKBENCHLEVELUPMAGICSCEPTERITEM_SET_COSTDATA_OFFSET UNITYSDK_OFFSET(0x16A14A00)
#define RPG_CLIENT_ROGUEWORKBENCHLEVELUPMAGICSCEPTERITEM_SET_ID_OFFSET UNITYSDK_OFFSET(0x16A149E0)
#define RPG_CLIENT_ROGUEWORKBENCHLEVELUPMAGICSCEPTERITEM_SET_SCEPTERDATA_OFFSET UNITYSDK_OFFSET(0x16A14A20)
#define RPG_CLIENT_ROGUEWORKBENCHLEVELUPMAGICSCEPTERITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x16A14690)
