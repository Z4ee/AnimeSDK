...
#define RPG_CLIENT_REWARDITEM_REWARDITEMCONTROL__BINDBUTTON_OFFSET UNITYSDK_OFFSET(0xDE74150)
#define RPG_CLIENT_REWARDITEM_REWARDITEMCONTROL__BINDCOUNT_OFFSET UNITYSDK_OFFSET(0xDE75C10)
#define RPG_CLIENT_REWARDITEM_REWARDITEMCONTROL__BINDICON_OFFSET UNITYSDK_OFFSET(0xDE74600)
#define RPG_CLIENT_REWARDITEM_REWARDITEMCONTROL__BINDING_OFFSET UNITYSDK_OFFSET(0xDE740B0)
#define RPG_CLIENT_REWARDITEM_REWARDITEMCONTROL__BINDNAMEPANEL_OFFSET UNITYSDK_OFFSET(0xDE77CB0)
#define RPG_CLIENT_REWARDITEM_REWARDITEMCONTROL__BINDRARITY_OFFSET UNITYSDK_OFFSET(0xDE75380)
#define RPG_CLIENT_REWARDITEM_REWARDITEMCONTROL__BINDRECYCLELABELS_OFFSET UNITYSDK_OFFSET(0xDE77600)
#define RPG_CLIENT_REWARDITEM_REWARDITEMCONTROL__BINDREDDOT_OFFSET UNITYSDK_OFFSET(0xDE78130)
#define RPG_CLIENT_REWARDITEM_REWARDITEMCONTROL__BINDSTATUSMARKS_OFFSET UNITYSDK_OFFSET(0xDE76090)
#define RPG_CLIENT_REWARDITEM_REWARDITEMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xDE78680)
#define RPG_CLIENT_REWARDITEM_REWARDITEMCONTROL__STATUSPANELVISIBLE_OFFSET UNITYSDK_OFFSET(0xDE783A0)

namespace RPG::Client::RewardItem
{
	inline static constexpr unsigned int RewardItemControl_TypeDefinitionIndex = 78663;
