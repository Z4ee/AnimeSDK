...
#define RPG_CLIENT_MATCHTHREEV2SPECIALRULEDATA_CREATEBYCONSTVALUE_OFFSET UNITYSDK_OFFSET(0x9B6DD80)
#define RPG_CLIENT_MATCHTHREEV2SPECIALRULEDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x9B5B8F0)
#define RPG_CLIENT_MATCHTHREEV2SPECIALRULEDATA_GET_DESC_OFFSET UNITYSDK_OFFSET(0x9B6DCB0)
#define RPG_CLIENT_MATCHTHREEV2SPECIALRULEDATA_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x9B6DC40)
#define RPG_CLIENT_MATCHTHREEV2SPECIALRULEDATA_GET_ROW_OFFSET UNITYSDK_OFFSET(0x9B6DBD0)
#define RPG_CLIENT_MATCHTHREEV2SPECIALRULEDATA_GET_RULEID_OFFSET UNITYSDK_OFFSET(0x9B6DC30)
#define RPG_CLIENT_MATCHTHREEV2SPECIALRULEDATA_INIT_OFFSET UNITYSDK_OFFSET(0x9B6DD40)
#define RPG_CLIENT_MATCHTHREEV2SPECIALRULEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9B6DD30)

namespace RPG::Client
{
	inline static constexpr unsigned int MatchThreeV2SpecialRuleData_TypeDefinitionIndex = 53625;
