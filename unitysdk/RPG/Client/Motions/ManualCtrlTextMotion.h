...
#define RPG_CLIENT_MOTIONS_MANUALCTRLTEXTMOTION_METHOD_7_17BB6E91B2585477_OFFSET UNITYSDK_OFFSET(0x1960F240)
#define RPG_CLIENT_MOTIONS_MANUALCTRLTEXTMOTION_METHOD_7_AD6DFF3647AB2AE7_OFFSET UNITYSDK_OFFSET(0x1960EBB0)
#define RPG_CLIENT_MOTIONS_MANUALCTRLTEXTMOTION_METHOD_7_E3DE31A03057E055_OFFSET UNITYSDK_OFFSET(0x1960F0D0)
#define RPG_CLIENT_MOTIONS_MANUALCTRLTEXTMOTION_MODIFYMESH_OFFSET UNITYSDK_OFFSET(0x1960EA20)
#define RPG_CLIENT_MOTIONS_MANUALCTRLTEXTMOTION_UPDATE_OFFSET UNITYSDK_OFFSET(0x1960EF60)
#define RPG_CLIENT_MOTIONS_MANUALCTRLTEXTMOTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1960F4C0)

namespace RPG::Client::Motions
{
	inline static constexpr unsigned int ManualCtrlTextMotion_TypeDefinitionIndex = 73433;
