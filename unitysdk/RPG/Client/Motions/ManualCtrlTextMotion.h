...
#define RPG_CLIENT_MOTIONS_MANUALCTRLTEXTMOTION_METHOD_7_17BB6E91B2585477_OFFSET UNITYSDK_OFFSET(0x1955C310)
#define RPG_CLIENT_MOTIONS_MANUALCTRLTEXTMOTION_METHOD_7_AD6DFF3647AB2AE7_OFFSET UNITYSDK_OFFSET(0x1955BC50)
#define RPG_CLIENT_MOTIONS_MANUALCTRLTEXTMOTION_METHOD_7_E7EF6BC52B28648C_OFFSET UNITYSDK_OFFSET(0x1955C170)
#define RPG_CLIENT_MOTIONS_MANUALCTRLTEXTMOTION_MODIFYMESH_OFFSET UNITYSDK_OFFSET(0x1955BAC0)
#define RPG_CLIENT_MOTIONS_MANUALCTRLTEXTMOTION_UPDATE_OFFSET UNITYSDK_OFFSET(0x1955C000)
#define RPG_CLIENT_MOTIONS_MANUALCTRLTEXTMOTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1955C590)

namespace RPG::Client::Motions
{
	inline static constexpr unsigned int ManualCtrlTextMotion_TypeDefinitionIndex = 70134;
