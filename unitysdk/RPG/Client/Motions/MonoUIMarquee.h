...
#define RPG_CLIENT_MOTIONS_MONOUIMARQUEE_AWAKE_OFFSET UNITYSDK_OFFSET(0xAAD5650)
#define RPG_CLIENT_MOTIONS_MONOUIMARQUEE_METHOD_5_7744894CEC41BF06_OFFSET UNITYSDK_OFFSET(0xAAD5A40)
#define RPG_CLIENT_MOTIONS_MONOUIMARQUEE_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xAAD5930)
#define RPG_CLIENT_MOTIONS_MONOUIMARQUEE_METHOD_5_CF8BA38996D09531_OFFSET UNITYSDK_OFFSET(0xAAD58C0)
#define RPG_CLIENT_MOTIONS_MONOUIMARQUEE_METHOD_5_F3E6D35BDBDAABF3_OFFSET UNITYSDK_OFFSET(0xAAD5FE0)
#define RPG_CLIENT_MOTIONS_MONOUIMARQUEE_METHOD_5_FAE9C4050544FE63_1_OFFSET UNITYSDK_OFFSET(0xAAD5BC0)
#define RPG_CLIENT_MOTIONS_MONOUIMARQUEE_METHOD_5_FAE9C4050544FE63_OFFSET UNITYSDK_OFFSET(0xAAD5B00)
#define RPG_CLIENT_MOTIONS_MONOUIMARQUEE_METHOD_5_FD75E07BF87A91BC_OFFSET UNITYSDK_OFFSET(0xAAD5C80)
#define RPG_CLIENT_MOTIONS_MONOUIMARQUEE_UPDATE_OFFSET UNITYSDK_OFFSET(0xAAD57B0)
#define RPG_CLIENT_MOTIONS_MONOUIMARQUEE__CTOR_OFFSET UNITYSDK_OFFSET(0xAAD6320)
#define RPG_CLIENT_MOTIONS_MONOUIMARQUEE___CREATECIRCLEMOTION_B__9_0_OFFSET UNITYSDK_OFFSET(0xAAD6330)

namespace RPG::Client::Motions
{
	inline static constexpr unsigned int MonoUIMarquee_TypeDefinitionIndex = 67682;
