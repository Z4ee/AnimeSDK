...
#define RPG_CLIENT_MOTIONS_MONOUIMARQUEE_AWAKE_OFFSET UNITYSDK_OFFSET(0x196175D0)
#define RPG_CLIENT_MOTIONS_MONOUIMARQUEE_METHOD_5_1BEAB60076010082_OFFSET UNITYSDK_OFFSET(0x19617D60)
#define RPG_CLIENT_MOTIONS_MONOUIMARQUEE_METHOD_5_75B0F17F1816A50B_OFFSET UNITYSDK_OFFSET(0x19618060)
#define RPG_CLIENT_MOTIONS_MONOUIMARQUEE_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x19617940)
#define RPG_CLIENT_MOTIONS_MONOUIMARQUEE_METHOD_5_CF8BA38996D09531_OFFSET UNITYSDK_OFFSET(0x196178D0)
#define RPG_CLIENT_MOTIONS_MONOUIMARQUEE_METHOD_5_F5447CD65612575D_OFFSET UNITYSDK_OFFSET(0x19617A50)
#define RPG_CLIENT_MOTIONS_MONOUIMARQUEE_METHOD_5_FAE9C4050544FE63_1_OFFSET UNITYSDK_OFFSET(0x19617CA0)
#define RPG_CLIENT_MOTIONS_MONOUIMARQUEE_METHOD_5_FAE9C4050544FE63_OFFSET UNITYSDK_OFFSET(0x19617BE0)
#define RPG_CLIENT_MOTIONS_MONOUIMARQUEE_UPDATE_OFFSET UNITYSDK_OFFSET(0x19617760)
#define RPG_CLIENT_MOTIONS_MONOUIMARQUEE__CTOR_OFFSET UNITYSDK_OFFSET(0x19618330)
#define RPG_CLIENT_MOTIONS_MONOUIMARQUEE___CREATECIRCLEMOTION_B__9_0_OFFSET UNITYSDK_OFFSET(0x19618340)

namespace RPG::Client::Motions
{
	inline static constexpr unsigned int MonoUIMarquee_TypeDefinitionIndex = 73437;
