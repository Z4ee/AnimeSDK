...
#define RPG_CLIENT_MOTIONS_MONOEFFECTMOTION_VOIDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xC19E500)
#define RPG_CLIENT_MOTIONS_MONOEFFECTMOTION_VOIDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xC19E530)
#define RPG_CLIENT_MOTIONS_MONOEFFECTMOTION_VOIDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0xC19E470)
#define RPG_CLIENT_MOTIONS_MONOEFFECTMOTION_VOIDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0xC19E490)

namespace RPG::Client::Motions
{
	inline static constexpr unsigned int MonoEffectMotion_VoidDelegate_TypeDefinitionIndex = 68593;
