...
#define RPG_CLIENT_MOTIONS_MONOEFFECTMOTION_GET_OFFSET UNITYSDK_OFFSET(0x9D88970)
#define RPG_CLIENT_MOTIONS_MONOEFFECTMOTION_INITEFFECTMOTION_OFFSET UNITYSDK_OFFSET(0x9D88A80)
#define RPG_CLIENT_MOTIONS_MONOEFFECTMOTION_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9D88E00)
#define RPG_CLIENT_MOTIONS_MONOEFFECTMOTION_UPDATE_OFFSET UNITYSDK_OFFSET(0x9D88D80)
#define RPG_CLIENT_MOTIONS_MONOEFFECTMOTION__CREATEEFFECTMOTION_OFFSET UNITYSDK_OFFSET(0x9D88B70)
#define RPG_CLIENT_MOTIONS_MONOEFFECTMOTION__CTOR_OFFSET UNITYSDK_OFFSET(0x9D89410)
#define RPG_CLIENT_MOTIONS_MONOEFFECTMOTION__ENDCALLBACK_OFFSET UNITYSDK_OFFSET(0x9D88E50)

namespace RPG::Client::Motions
{
	inline static constexpr unsigned int MonoEffectMotion_TypeDefinitionIndex = 60216;
