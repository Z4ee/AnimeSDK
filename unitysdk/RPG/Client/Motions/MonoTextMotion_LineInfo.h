...
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION_LINEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x196125B0)

namespace RPG::Client::Motions
{
	inline static constexpr unsigned int MonoTextMotion_LineInfo_TypeDefinitionIndex = 73436;

	class MonoTextMotion_LineInfo : public ::System::Object
	{
	public:
		::System::Int32 StartVisibleCharIndex; // 0x10
		::System::Int32 NoneRubyTopStrCharacterCount; // 0x14
		::System::Int32 LineIndex; // 0x18
