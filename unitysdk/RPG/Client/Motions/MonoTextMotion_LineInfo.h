...
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION_LINEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x9D8B9E0)

namespace RPG::Client::Motions
{
	inline static constexpr unsigned int MonoTextMotion_LineInfo_TypeDefinitionIndex = 60263;
