...
#define RPG_CLIENT_MOTIONS_MONOTEXTMOTION_LINEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xD8C2A80)

namespace RPG::Client::Motions
{
	inline static constexpr unsigned int MonoTextMotion_LineInfo_TypeDefinitionIndex = 73437;

	class MonoTextMotion_LineInfo : public ::System::Object
	{
	public:
		::System::Int32 NoneRubyTopStrCharacterCount; // 0x10
