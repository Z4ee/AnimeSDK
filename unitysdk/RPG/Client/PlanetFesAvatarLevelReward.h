...
#define RPG_CLIENT_PLANETFESAVATARLEVELREWARD__CTOR_OFFSET UNITYSDK_OFFSET(0x9F864A0)

namespace RPG::Client
{
	inline static constexpr unsigned int PlanetFesAvatarLevelReward_TypeDefinitionIndex = 54215;
