...
#define RPG_CLIENT_PLANETFESAVATARLEVELREWARD__CTOR_OFFSET UNITYSDK_OFFSET(0xACAAE00)

namespace RPG::Client
{
	inline static constexpr unsigned int PlanetFesAvatarLevelReward_TypeDefinitionIndex = 61378;
