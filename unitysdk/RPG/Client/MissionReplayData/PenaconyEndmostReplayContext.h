...
#define RPG_CLIENT_MISSIONREPLAYDATA_PENACONYENDMOSTREPLAYCONTEXT_AUTOSHOW_OFFSET UNITYSDK_OFFSET(0x9BEE8C0)
#define RPG_CLIENT_MISSIONREPLAYDATA_PENACONYENDMOSTREPLAYCONTEXT_CREATE_OFFSET UNITYSDK_OFFSET(0x9BEE600)
#define RPG_CLIENT_MISSIONREPLAYDATA_PENACONYENDMOSTREPLAYCONTEXT_GETCHAPTERID_OFFSET UNITYSDK_OFFSET(0x9BEE720)
#define RPG_CLIENT_MISSIONREPLAYDATA_PENACONYENDMOSTREPLAYCONTEXT_GETMISSIONID_OFFSET UNITYSDK_OFFSET(0x9BEE7A0)
#define RPG_CLIENT_MISSIONREPLAYDATA_PENACONYENDMOSTREPLAYCONTEXT_GETRECORDPAGEID_OFFSET UNITYSDK_OFFSET(0x9BEEB80)
#define RPG_CLIENT_MISSIONREPLAYDATA_PENACONYENDMOSTREPLAYCONTEXT_GET_CURINDEX_OFFSET UNITYSDK_OFFSET(0x9BEEC90)
#define RPG_CLIENT_MISSIONREPLAYDATA_PENACONYENDMOSTREPLAYCONTEXT_GET_REPLAYDATA_OFFSET UNITYSDK_OFFSET(0x9BEECB0)
#define RPG_CLIENT_MISSIONREPLAYDATA_PENACONYENDMOSTREPLAYCONTEXT_SETPENACONYENDMOSTCHRONICLECONTEXT_OFFSET UNITYSDK_OFFSET(0x9BEEB30)
#define RPG_CLIENT_MISSIONREPLAYDATA_PENACONYENDMOSTREPLAYCONTEXT_SETREPLAYDATA_OFFSET UNITYSDK_OFFSET(0x9BEE870)
#define RPG_CLIENT_MISSIONREPLAYDATA_PENACONYENDMOSTREPLAYCONTEXT_SET_CURINDEX_OFFSET UNITYSDK_OFFSET(0x9BEECA0)
#define RPG_CLIENT_MISSIONREPLAYDATA_PENACONYENDMOSTREPLAYCONTEXT_SET_REPLAYDATA_OFFSET UNITYSDK_OFFSET(0x9BEECC0)
#define RPG_CLIENT_MISSIONREPLAYDATA_PENACONYENDMOSTREPLAYCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x9BEE710)

namespace RPG::Client::MissionReplayData
{
	inline static constexpr unsigned int PenaconyEndmostReplayContext_TypeDefinitionIndex = 61413;
	...
	public:
		...
		::System::Boolean _IsFromMissionChronicle; // 0x28
