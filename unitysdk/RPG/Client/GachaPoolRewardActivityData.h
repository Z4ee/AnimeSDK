...
#define RPG_CLIENT_GACHAPOOLREWARDACTIVITYDATA_GET_QUESTDESC_OFFSET UNITYSDK_OFFSET(0x192CF850)
#define RPG_CLIENT_GACHAPOOLREWARDACTIVITYDATA_GET_REWARDDATA_OFFSET UNITYSDK_OFFSET(0x192CF780)
#define RPG_CLIENT_GACHAPOOLREWARDACTIVITYDATA_GET_REWARDQUEST_OFFSET UNITYSDK_OFFSET(0x192CF560)
#define RPG_CLIENT_GACHAPOOLREWARDACTIVITYDATA_ISSHOWDAILYREDDOT_OFFSET UNITYSDK_OFFSET(0x192CF620)
#define RPG_CLIENT_GACHAPOOLREWARDACTIVITYDATA_ISSHOWEARLYACCESSREDDOT_OFFSET UNITYSDK_OFFSET(0x192CF720)
#define RPG_CLIENT_GACHAPOOLREWARDACTIVITYDATA_ISSHOWNEWREDDOT_OFFSET UNITYSDK_OFFSET(0x192CF5C0)
#define RPG_CLIENT_GACHAPOOLREWARDACTIVITYDATA_ISSHOWNORMALREDDOT_OFFSET UNITYSDK_OFFSET(0x192CF4D0)
#define RPG_CLIENT_GACHAPOOLREWARDACTIVITYDATA_SET_REWARDDATA_OFFSET UNITYSDK_OFFSET(0x192CF790)
#define RPG_CLIENT_GACHAPOOLREWARDACTIVITYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x192CF2F0)
#define RPG_CLIENT_GACHAPOOLREWARDACTIVITYDATA__INITGACHAPOOLREWARDDATA_OFFSET UNITYSDK_OFFSET(0x192CF350)
#define RPG_CLIENT_GACHAPOOLREWARDACTIVITYDATA__ISNEEDSHOWDAILYREDDOT_OFFSET UNITYSDK_OFFSET(0x192CF670)
#define RPG_CLIENT_GACHAPOOLREWARDACTIVITYDATA__ONINIT_OFFSET UNITYSDK_OFFSET(0x192CF300)

namespace RPG::Client
{
	inline static constexpr unsigned int GachaPoolRewardActivityData_TypeDefinitionIndex = 58885;
