...
#define RPG_CLIENT_UIADVENTUREMINIMAP_ICONCIRCLE_GET_IMAGE_OFFSET UNITYSDK_OFFSET(0xE33E930)
#define RPG_CLIENT_UIADVENTUREMINIMAP_ICONCIRCLE_SETRADIUS_OFFSET UNITYSDK_OFFSET(0xE33A6B0)
#define RPG_CLIENT_UIADVENTUREMINIMAP_ICONCIRCLE_SET_IMAGE_OFFSET UNITYSDK_OFFSET(0xE33E940)
#define RPG_CLIENT_UIADVENTUREMINIMAP_ICONCIRCLE__CTOR_OFFSET UNITYSDK_OFFSET(0xE33CB40)
