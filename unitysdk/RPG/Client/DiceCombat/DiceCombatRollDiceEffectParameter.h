...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATROLLDICEEFFECTPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0xA135AC0)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatRollDiceEffectParameter_TypeDefinitionIndex = 69790;
