...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATROLLDICEEFFECTPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x9483B90)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatRollDiceEffectParameter_TypeDefinitionIndex = 61880;
