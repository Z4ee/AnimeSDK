...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BRANDRANKINGENTRY_GET_PERCENT_OFFSET UNITYSDK_OFFSET(0xCD4A070)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BRANDRANKINGENTRY_METHOD_5_13E8B1F3F0042AA5_OFFSET UNITYSDK_OFFSET(0xCD4A290)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BRANDRANKINGENTRY_METHOD_5_226558B48AF9A6C1_OFFSET UNITYSDK_OFFSET(0xCD4A090)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BRANDRANKINGENTRY_METHOD_5_70459B7C790C82DB_OFFSET UNITYSDK_OFFSET(0xCD4A5B0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BRANDRANKINGENTRY_METHOD_5_AC088C028EF9B921_OFFSET UNITYSDK_OFFSET(0xCD4A470)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BRANDRANKINGENTRY_SET_PERCENT_OFFSET UNITYSDK_OFFSET(0xCD4A080)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BRANDRANKINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0xCD4A740)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatV2BrandRankingEntry_TypeDefinitionIndex = 75727;
