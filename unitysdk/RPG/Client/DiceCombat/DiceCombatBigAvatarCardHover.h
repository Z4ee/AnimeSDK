...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBIGAVATARCARDHOVER_AWAKE_OFFSET UNITYSDK_OFFSET(0x193123E0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBIGAVATARCARDHOVER_BINDNODE_OFFSET UNITYSDK_OFFSET(0x19312640)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBIGAVATARCARDHOVER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x19312740)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBIGAVATARCARDHOVER_ONMOBILEUPDATE_OFFSET UNITYSDK_OFFSET(0x193131A0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBIGAVATARCARDHOVER_ONPCUPDATE_OFFSET UNITYSDK_OFFSET(0x19312D10)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBIGAVATARCARDHOVER_SETHOVERACTIVE_OFFSET UNITYSDK_OFFSET(0x19312870)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBIGAVATARCARDHOVER_START_OFFSET UNITYSDK_OFFSET(0x193124E0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBIGAVATARCARDHOVER_UPDATE_OFFSET UNITYSDK_OFFSET(0x19312B90)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBIGAVATARCARDHOVER__CTOR_OFFSET UNITYSDK_OFFSET(0x19313440)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatBigAvatarCardHover_TypeDefinitionIndex = 75616;
	...
	public:
		...
		::System::Void SetHoverActive(::System::Boolean a1)
		{
			return ((::System::Void(*)(::PVOID, ::System::Boolean))((::PBYTE)hIl2Cpp + RPG_CLIENT_DICECOMBAT_DICECOMBATBIGAVATARCARDHOVER_SETHOVERACTIVE_OFFSET))(this, a1);
		}
