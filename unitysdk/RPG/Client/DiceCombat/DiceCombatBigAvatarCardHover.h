...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBIGAVATARCARDHOVER_AWAKE_OFFSET UNITYSDK_OFFSET(0x180C0B40)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBIGAVATARCARDHOVER_BINDNODE_OFFSET UNITYSDK_OFFSET(0x180C0DA0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBIGAVATARCARDHOVER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x180C0EA0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBIGAVATARCARDHOVER_ONMOBILEUPDATE_OFFSET UNITYSDK_OFFSET(0x180C1900)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBIGAVATARCARDHOVER_ONPCUPDATE_OFFSET UNITYSDK_OFFSET(0x180C1470)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBIGAVATARCARDHOVER_SETHOVERACTIVE_OFFSET UNITYSDK_OFFSET(0x180C0FD0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBIGAVATARCARDHOVER_START_OFFSET UNITYSDK_OFFSET(0x180C0C40)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBIGAVATARCARDHOVER_UPDATE_OFFSET UNITYSDK_OFFSET(0x180C12F0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBIGAVATARCARDHOVER__CTOR_OFFSET UNITYSDK_OFFSET(0x180C1BA0)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatBigAvatarCardHover_TypeDefinitionIndex = 72180;
