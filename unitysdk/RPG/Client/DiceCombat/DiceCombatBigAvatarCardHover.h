...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBIGAVATARCARDHOVER_AWAKE_OFFSET UNITYSDK_OFFSET(0x9472920)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBIGAVATARCARDHOVER_BINDNODE_OFFSET UNITYSDK_OFFSET(0x9472B80)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBIGAVATARCARDHOVER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9472C80)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBIGAVATARCARDHOVER_ONMOBILEUPDATE_OFFSET UNITYSDK_OFFSET(0x9473670)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBIGAVATARCARDHOVER_ONPCUPDATE_OFFSET UNITYSDK_OFFSET(0x94731E0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBIGAVATARCARDHOVER_SETHOVERACTIVE_OFFSET UNITYSDK_OFFSET(0x9472D40)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBIGAVATARCARDHOVER_START_OFFSET UNITYSDK_OFFSET(0x9472A20)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBIGAVATARCARDHOVER_UPDATE_OFFSET UNITYSDK_OFFSET(0x9473060)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBIGAVATARCARDHOVER__CTOR_OFFSET UNITYSDK_OFFSET(0x9473A40)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatBigAvatarCardHover_TypeDefinitionIndex = 61932;
