...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATUISHOWDICEINFOEVENTPARAM_GET_INFOS_OFFSET UNITYSDK_OFFSET(0x1A4253D0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATUISHOWDICEINFOEVENTPARAM_GET_ISHOLD_OFFSET UNITYSDK_OFFSET(0x1A4253B0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATUISHOWDICEINFOEVENTPARAM_SET_INFOS_OFFSET UNITYSDK_OFFSET(0x1A4253E0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATUISHOWDICEINFOEVENTPARAM_SET_ISHOLD_OFFSET UNITYSDK_OFFSET(0x1A4253C0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATUISHOWDICEINFOEVENTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4253A0)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatUIShowDiceInfoEventParam_TypeDefinitionIndex = 72249;
