...
#define RPG_CLIENT_DICECOMBAT_ONSERVERCONNECTEDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19FEC4B0)
#define RPG_CLIENT_DICECOMBAT_ONSERVERCONNECTEDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19FEC4E0)
#define RPG_CLIENT_DICECOMBAT_ONSERVERCONNECTEDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19FEC4A0)
#define RPG_CLIENT_DICECOMBAT_ONSERVERCONNECTEDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19FEC430)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int OnServerConnectedDelegate_TypeDefinitionIndex = 72222;
