...
#define RPG_CLIENT_DICECOMBAT_ONSERVERCONNECTEDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xB7DD730)
#define RPG_CLIENT_DICECOMBAT_ONSERVERCONNECTEDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xB7DD760)
#define RPG_CLIENT_DICECOMBAT_ONSERVERCONNECTEDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0xB7DD720)
#define RPG_CLIENT_DICECOMBAT_ONSERVERCONNECTEDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0xB7DD6B0)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int OnServerConnectedDelegate_TypeDefinitionIndex = 70709;
