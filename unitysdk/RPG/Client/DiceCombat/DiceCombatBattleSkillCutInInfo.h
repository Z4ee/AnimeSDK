...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLESKILLCUTININFO_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xCD1FB20)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLESKILLCUTININFO_GET_ISLOCALPLAYER_OFFSET UNITYSDK_OFFSET(0xCD1FA90)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLESKILLCUTININFO_GET_NAME_OFFSET UNITYSDK_OFFSET(0xCD1FB70)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLESKILLCUTININFO_GET_PREFABPATH_OFFSET UNITYSDK_OFFSET(0xCD1FAD0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLESKILLCUTININFO__CTOR_OFFSET UNITYSDK_OFFSET(0xCD1FA50)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatBattleSkillCutInInfo_TypeDefinitionIndex = 75574;
