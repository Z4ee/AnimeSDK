...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLESKILLCUTININFO_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x180C0A80)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLESKILLCUTININFO_GET_ISLOCALPLAYER_OFFSET UNITYSDK_OFFSET(0x180C09F0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLESKILLCUTININFO_GET_NAME_OFFSET UNITYSDK_OFFSET(0x180C0AD0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLESKILLCUTININFO_GET_PREFABPATH_OFFSET UNITYSDK_OFFSET(0x180C0A30)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATBATTLESKILLCUTININFO__CTOR_OFFSET UNITYSDK_OFFSET(0x180C09B0)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatBattleSkillCutInInfo_TypeDefinitionIndex = 72137;
