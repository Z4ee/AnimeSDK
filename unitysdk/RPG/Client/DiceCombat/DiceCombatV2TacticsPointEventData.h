...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2TACTICSPOINTEVENTDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xCD5F990)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2TACTICSPOINTEVENTDATA_GET_HINTTEXTPARAM_OFFSET UNITYSDK_OFFSET(0xCD5F8E0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2TACTICSPOINTEVENTDATA_GET_HINTTEXT_OFFSET UNITYSDK_OFFSET(0xCD5F820)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2TACTICSPOINTEVENTDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xCD5F7C0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2TACTICSPOINTEVENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCD5F980)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatV2TacticsPointEventData_TypeDefinitionIndex = 75683;
