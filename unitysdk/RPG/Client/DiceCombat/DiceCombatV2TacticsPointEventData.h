...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2TACTICSPOINTEVENTDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xB7DB940)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2TACTICSPOINTEVENTDATA_GET_HINTTEXTPARAM_OFFSET UNITYSDK_OFFSET(0xB7DB8C0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2TACTICSPOINTEVENTDATA_GET_HINTTEXT_OFFSET UNITYSDK_OFFSET(0xB7DB840)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2TACTICSPOINTEVENTDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xB7DB7E0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2TACTICSPOINTEVENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB7DB930)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatV2TacticsPointEventData_TypeDefinitionIndex = 70733;
