...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2SIDEBARTOASTQUEUE_AWAKE_OFFSET UNITYSDK_OFFSET(0xCD5DED0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2SIDEBARTOASTQUEUE_CLEARPENDING_OFFSET UNITYSDK_OFFSET(0xCD5E820)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2SIDEBARTOASTQUEUE_PUSH_OFFSET UNITYSDK_OFFSET(0xCD5E790)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2SIDEBARTOASTQUEUE_UPDATE_OFFSET UNITYSDK_OFFSET(0xCD5E8E0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2SIDEBARTOASTQUEUE__CTOR_OFFSET UNITYSDK_OFFSET(0xCD5F210)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2SIDEBARTOASTQUEUE__GETORCREATE_OFFSET UNITYSDK_OFFSET(0xCD5EF60)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2SIDEBARTOASTQUEUE__ONTOASTFADEOUTEND_OFFSET UNITYSDK_OFFSET(0xCD5F0A0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2SIDEBARTOASTQUEUE__SHOW_OFFSET UNITYSDK_OFFSET(0xCD5EBD0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2SIDEBARTOASTQUEUE__TRYSHOWNEXTMESSAGES_OFFSET UNITYSDK_OFFSET(0xCD5E930)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2SIDEBARTOASTQUEUE__UPDATEFADEOUT_OFFSET UNITYSDK_OFFSET(0xCD5E9E0)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatV2SideBarToastQueue_TypeDefinitionIndex = 75736;
