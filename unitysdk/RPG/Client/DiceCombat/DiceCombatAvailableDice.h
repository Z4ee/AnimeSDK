...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATAVAILABLEDICE_CREATEAVAILABLEDICELIST_OFFSET UNITYSDK_OFFSET(0x180B4B20)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATAVAILABLEDICE_GET_AVAILABLECOUNT_OFFSET UNITYSDK_OFFSET(0x676EB0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATAVAILABLEDICE_GET_DICEID_OFFSET UNITYSDK_OFFSET(0x167710)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATAVAILABLEDICE_GET_DICERARITY_OFFSET UNITYSDK_OFFSET(0x7A7C20)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATAVAILABLEDICE__CTOR_OFFSET UNITYSDK_OFFSET(0x6ED5C0)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatAvailableDice_TypeDefinitionIndex = 72152;
