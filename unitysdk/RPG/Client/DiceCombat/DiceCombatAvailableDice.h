...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATAVAILABLEDICE_CREATEAVAILABLEDICELIST_OFFSET UNITYSDK_OFFSET(0xB795150)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATAVAILABLEDICE_GET_AVAILABLECOUNT_OFFSET UNITYSDK_OFFSET(0xDAD0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATAVAILABLEDICE_GET_DICEID_OFFSET UNITYSDK_OFFSET(0x5FB0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATAVAILABLEDICE_GET_DICERARITY_OFFSET UNITYSDK_OFFSET(0x1E110)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATAVAILABLEDICE__CTOR_OFFSET UNITYSDK_OFFSET(0x82420)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatAvailableDice_TypeDefinitionIndex = 70639;
