...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BRANDDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xCD49E50)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BRANDDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0xCD49BD0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BRANDDATA_GET_MARKETSHARETREND_OFFSET UNITYSDK_OFFSET(0xCD49DA0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BRANDDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xCD49C40)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BRANDDATA_GET_ROUNDICON_OFFSET UNITYSDK_OFFSET(0xCD49D00)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BRANDDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xCD49BE0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BRANDDATA_VISITIDS_OFFSET UNITYSDK_OFFSET(0xCD49EC0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BRANDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCD49E40)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatV2BrandData_TypeDefinitionIndex = 75675;
