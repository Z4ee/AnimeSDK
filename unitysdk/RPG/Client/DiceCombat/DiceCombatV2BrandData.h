...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BRANDDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1A4360B0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BRANDDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0x1A435E30)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BRANDDATA_GET_MARKETSHARETREND_OFFSET UNITYSDK_OFFSET(0x1A436000)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BRANDDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A435EA0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BRANDDATA_GET_ROUNDICON_OFFSET UNITYSDK_OFFSET(0x1A435F60)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BRANDDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0x1A435E40)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BRANDDATA_VISITIDS_OFFSET UNITYSDK_OFFSET(0x1A436120)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BRANDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4360A0)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatV2BrandData_TypeDefinitionIndex = 72238;
