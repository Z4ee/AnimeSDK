...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATUPGRADELOADMODELREQUEST__CTOR_OFFSET UNITYSDK_OFFSET(0xA139450)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatUpgradeLoadModelRequest_TypeDefinitionIndex = 69804;

	class DiceCombatUpgradeLoadModelRequest : public ::System::Object
	{
	public:
		::System::UInt32 EntityUID; // 0x10
		::System::UInt32 DiceID; // 0x14
		::System::Int32 UpFace; // 0x18
		::RPG::GameCore::DiceCombatDiceType DiceType; // 0x1C
