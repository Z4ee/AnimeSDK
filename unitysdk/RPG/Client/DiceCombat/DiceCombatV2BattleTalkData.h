...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLETALKDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1C42E100)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLETALKDATA_GET_CONTENT_OFFSET UNITYSDK_OFFSET(0x1C42E030)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLETALKDATA_GET_HEADICON_OFFSET UNITYSDK_OFFSET(0x1C42DF90)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLETALKDATA_GET_SIDE_OFFSET UNITYSDK_OFFSET(0x1C42DEF0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLETALKDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0x1C42DE90)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLETALKDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1C42E0F0)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatV2BattleTalkData_TypeDefinitionIndex = 75672;
