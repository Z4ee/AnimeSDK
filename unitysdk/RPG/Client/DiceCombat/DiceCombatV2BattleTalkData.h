...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLETALKDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1A4359C0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLETALKDATA_GET_CONTENT_OFFSET UNITYSDK_OFFSET(0x1A4358F0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLETALKDATA_GET_HEADICON_OFFSET UNITYSDK_OFFSET(0x1A435850)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLETALKDATA_GET_SIDE_OFFSET UNITYSDK_OFFSET(0x1A4357B0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLETALKDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0x1A435750)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLETALKDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4359B0)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatV2BattleTalkData_TypeDefinitionIndex = 72236;
