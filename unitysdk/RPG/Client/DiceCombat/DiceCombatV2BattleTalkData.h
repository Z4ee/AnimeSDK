...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLETALKDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xB7C7090)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLETALKDATA_GET_CONTENT_OFFSET UNITYSDK_OFFSET(0xB7C7000)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLETALKDATA_GET_HEADICON_OFFSET UNITYSDK_OFFSET(0xB7C6F90)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLETALKDATA_GET_SIDE_OFFSET UNITYSDK_OFFSET(0xB7C6F20)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLETALKDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xB7C6EC0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLETALKDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB7C7080)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatV2BattleTalkData_TypeDefinitionIndex = 70723;
