...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLERESULTINFO_GET_ISPVE_OFFSET UNITYSDK_OFFSET(0x1C42DB50)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLERESULTINFO_GET_ISWIN_OFFSET UNITYSDK_OFFSET(0x1C42DB30)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLERESULTINFO_GET_LOCALPLAYERAVATARINFO_OFFSET UNITYSDK_OFFSET(0x1C42DBB0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLERESULTINFO_GET_LOCALPLAYERDATA_OFFSET UNITYSDK_OFFSET(0x1C42DB90)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLERESULTINFO_GET_OPPONENTAVATARINFO_OFFSET UNITYSDK_OFFSET(0x1C42DC30)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLERESULTINFO_GET_OPPONENTDATA_OFFSET UNITYSDK_OFFSET(0x1C42DC10)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLERESULTINFO_GET_STAGEID_OFFSET UNITYSDK_OFFSET(0x1C42DB70)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLERESULTINFO_GET_TEAMMATEPLAYERAVATARINFO_OFFSET UNITYSDK_OFFSET(0x1C42DBF0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLERESULTINFO_GET_TEAMMATEPLAYERDATA_OFFSET UNITYSDK_OFFSET(0x1C42DBD0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLERESULTINFO_SET_ISPVE_OFFSET UNITYSDK_OFFSET(0x1C42DB60)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLERESULTINFO_SET_ISWIN_OFFSET UNITYSDK_OFFSET(0x1C42DB40)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLERESULTINFO_SET_LOCALPLAYERAVATARINFO_OFFSET UNITYSDK_OFFSET(0x1C42DBC0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLERESULTINFO_SET_LOCALPLAYERDATA_OFFSET UNITYSDK_OFFSET(0x1C42DBA0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLERESULTINFO_SET_OPPONENTAVATARINFO_OFFSET UNITYSDK_OFFSET(0x1C42DC40)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLERESULTINFO_SET_OPPONENTDATA_OFFSET UNITYSDK_OFFSET(0x1C42DC20)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLERESULTINFO_SET_STAGEID_OFFSET UNITYSDK_OFFSET(0x1C42DB80)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLERESULTINFO_SET_TEAMMATEPLAYERAVATARINFO_OFFSET UNITYSDK_OFFSET(0x1C42DC00)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLERESULTINFO_SET_TEAMMATEPLAYERDATA_OFFSET UNITYSDK_OFFSET(0x1C42DBE0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLERESULTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1C42DC50)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatV2BattleResultInfo_TypeDefinitionIndex = 75666;
	...
	public:
		...
		::RPG::Client::DiceCombat::IDiceCombatAvatarInfo* _OpponentAvatarInfo_k__BackingField; // 0x18
		...
		::RPG::Client::DiceCombat::DiceCombatV2BattleVsPlayerDisplayData* _TeamMatePlayerData_k__BackingField; // 0x30
		::RPG::Client::DiceCombat::IDiceCombatAvatarInfo* _LocalPlayerAvatarInfo_k__BackingField; // 0x38
