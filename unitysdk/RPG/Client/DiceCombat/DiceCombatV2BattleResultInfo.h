...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLERESULTINFO_GET_ISPVE_OFFSET UNITYSDK_OFFSET(0xB7C6B80)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLERESULTINFO_GET_ISWIN_OFFSET UNITYSDK_OFFSET(0xB7C6B60)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLERESULTINFO_GET_LOCALPLAYERAVATARINFO_OFFSET UNITYSDK_OFFSET(0xB7C6BE0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLERESULTINFO_GET_LOCALPLAYERDATA_OFFSET UNITYSDK_OFFSET(0xB7C6BC0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLERESULTINFO_GET_OPPONENTAVATARINFO_OFFSET UNITYSDK_OFFSET(0xB7C6C60)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLERESULTINFO_GET_OPPONENTDATA_OFFSET UNITYSDK_OFFSET(0xB7C6C40)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLERESULTINFO_GET_STAGEID_OFFSET UNITYSDK_OFFSET(0xB7C6BA0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLERESULTINFO_GET_TEAMMATEPLAYERAVATARINFO_OFFSET UNITYSDK_OFFSET(0xB7C6C20)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLERESULTINFO_GET_TEAMMATEPLAYERDATA_OFFSET UNITYSDK_OFFSET(0xB7C6C00)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLERESULTINFO_SET_ISPVE_OFFSET UNITYSDK_OFFSET(0xB7C6B90)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLERESULTINFO_SET_ISWIN_OFFSET UNITYSDK_OFFSET(0xB7C6B70)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLERESULTINFO_SET_LOCALPLAYERAVATARINFO_OFFSET UNITYSDK_OFFSET(0xB7C6BF0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLERESULTINFO_SET_LOCALPLAYERDATA_OFFSET UNITYSDK_OFFSET(0xB7C6BD0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLERESULTINFO_SET_OPPONENTAVATARINFO_OFFSET UNITYSDK_OFFSET(0xB7C6C70)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLERESULTINFO_SET_OPPONENTDATA_OFFSET UNITYSDK_OFFSET(0xB7C6C50)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLERESULTINFO_SET_STAGEID_OFFSET UNITYSDK_OFFSET(0xB7C6BB0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLERESULTINFO_SET_TEAMMATEPLAYERAVATARINFO_OFFSET UNITYSDK_OFFSET(0xB7C6C30)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLERESULTINFO_SET_TEAMMATEPLAYERDATA_OFFSET UNITYSDK_OFFSET(0xB7C6C10)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLERESULTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xB7C6C80)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatV2BattleResultInfo_TypeDefinitionIndex = 70717;

	class DiceCombatV2BattleResultInfo : public ::System::Object
	{
	public:
		::RPG::Client::DiceCombat::IDiceCombatAvatarInfo* _TeamMatePlayerAvatarInfo_k__BackingField; // 0x10
		...
		::RPG::Client::DiceCombat::IDiceCombatAvatarInfo* _OpponentAvatarInfo_k__BackingField; // 0x38
