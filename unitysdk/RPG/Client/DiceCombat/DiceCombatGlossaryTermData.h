...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATGLOSSARYTERMDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xB7A6890)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATGLOSSARYTERMDATA_GET_DESC_OFFSET UNITYSDK_OFFSET(0xB7A69C0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATGLOSSARYTERMDATA_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xB7A6970)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATGLOSSARYTERMDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0xB7A6950)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATGLOSSARYTERMDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xB7A6990)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATGLOSSARYTERMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB7A6940)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatGlossaryTermData_TypeDefinitionIndex = 70648;
