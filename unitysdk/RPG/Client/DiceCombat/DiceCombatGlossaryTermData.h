...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATGLOSSARYTERMDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1A412C30)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATGLOSSARYTERMDATA_GET_DESC_OFFSET UNITYSDK_OFFSET(0x1A412E00)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATGLOSSARYTERMDATA_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x1A412D40)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATGLOSSARYTERMDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0x1A412CF0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATGLOSSARYTERMDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A412D90)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATGLOSSARYTERMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A412CE0)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatGlossaryTermData_TypeDefinitionIndex = 72161;
