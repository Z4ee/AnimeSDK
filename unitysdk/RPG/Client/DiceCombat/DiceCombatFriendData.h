...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATFRIENDDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1C4095D0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATFRIENDDATA_GET_HASPVPRANKSCORE_OFFSET UNITYSDK_OFFSET(0x1C409CE0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATFRIENDDATA_GET_HEADICONPATH_OFFSET UNITYSDK_OFFSET(0x1C409900)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATFRIENDDATA_GET_ISONLINE_OFFSET UNITYSDK_OFFSET(0x1C409C20)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATFRIENDDATA_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x1C409AE0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATFRIENDDATA_GET_LOGOUTTIMESPAN_OFFSET UNITYSDK_OFFSET(0x1C409C80)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATFRIENDDATA_GET_NICKNAME_OFFSET UNITYSDK_OFFSET(0x1C409A70)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATFRIENDDATA_GET_PLATFORMINFO_OFFSET UNITYSDK_OFFSET(0x1C409B30)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATFRIENDDATA_GET_RANKICONPATH_OFFSET UNITYSDK_OFFSET(0x1C4099A0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATFRIENDDATA_GET_UID_OFFSET UNITYSDK_OFFSET(0x1C4098B0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATFRIENDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4095C0)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatFriendData_TypeDefinitionIndex = 75596;
