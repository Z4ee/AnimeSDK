...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2UIEXCHANGEDICEEVENTPARAM_CREATE_OFFSET UNITYSDK_OFFSET(0x19FEA630)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2UIEXCHANGEDICEEVENTPARAM_GET_CALLBACK_OFFSET UNITYSDK_OFFSET(0x19FEA6E0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2UIEXCHANGEDICEEVENTPARAM_GET_EVENTTYPE_OFFSET UNITYSDK_OFFSET(0x19FEA6C0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2UIEXCHANGEDICEEVENTPARAM_SET_CALLBACK_OFFSET UNITYSDK_OFFSET(0x19FEA6F0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2UIEXCHANGEDICEEVENTPARAM_SET_EVENTTYPE_OFFSET UNITYSDK_OFFSET(0x19FEA6D0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2UIEXCHANGEDICEEVENTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x19FEA620)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatV2UIExchangeDiceEventParam_TypeDefinitionIndex = 72286;
