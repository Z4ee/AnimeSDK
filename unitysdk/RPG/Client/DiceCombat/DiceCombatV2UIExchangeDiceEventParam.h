...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2UIEXCHANGEDICEEVENTPARAM_CREATE_OFFSET UNITYSDK_OFFSET(0x1B8C2F50)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2UIEXCHANGEDICEEVENTPARAM_GET_CALLBACK_OFFSET UNITYSDK_OFFSET(0x1B8C3000)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2UIEXCHANGEDICEEVENTPARAM_GET_EVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1B8C2FE0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2UIEXCHANGEDICEEVENTPARAM_SET_CALLBACK_OFFSET UNITYSDK_OFFSET(0x1B8C3010)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2UIEXCHANGEDICEEVENTPARAM_SET_EVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1B8C2FF0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2UIEXCHANGEDICEEVENTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8C2F40)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatV2UIExchangeDiceEventParam_TypeDefinitionIndex = 75722;
