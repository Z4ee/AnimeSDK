...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2UIEXCHANGEDICEEVENTPARAM_CREATE_OFFSET UNITYSDK_OFFSET(0xCD5FA10)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2UIEXCHANGEDICEEVENTPARAM_GET_CALLBACK_OFFSET UNITYSDK_OFFSET(0xCD5FAC0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2UIEXCHANGEDICEEVENTPARAM_GET_EVENTTYPE_OFFSET UNITYSDK_OFFSET(0xCD5FAA0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2UIEXCHANGEDICEEVENTPARAM_SET_CALLBACK_OFFSET UNITYSDK_OFFSET(0xCD5FAD0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2UIEXCHANGEDICEEVENTPARAM_SET_EVENTTYPE_OFFSET UNITYSDK_OFFSET(0xCD5FAB0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2UIEXCHANGEDICEEVENTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xCD5FA00)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatV2UIExchangeDiceEventParam_TypeDefinitionIndex = 75723;
