...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSHOPPAGEPARAM_CREATE_OFFSET UNITYSDK_OFFSET(0x1A412650)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSHOPPAGEPARAM_GET_SHOPITEMID_OFFSET UNITYSDK_OFFSET(0x1A4235F0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSHOPPAGEPARAM_SET_SHOPITEMID_OFFSET UNITYSDK_OFFSET(0x1A423600)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSHOPPAGEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4235E0)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatShopPageParam_TypeDefinitionIndex = 72215;
