...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLESHOWTALKSPARAM_CREATE_OFFSET UNITYSDK_OFFSET(0xCD492F0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLESHOWTALKSPARAM_GETTALK_OFFSET UNITYSDK_OFFSET(0xCD49470)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLESHOWTALKSPARAM_GET_SECONDSPERTALK_OFFSET UNITYSDK_OFFSET(0xCD492C0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLESHOWTALKSPARAM_GET_TALKCOUNT_OFFSET UNITYSDK_OFFSET(0xCD49420)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLESHOWTALKSPARAM_SET_SECONDSPERTALK_OFFSET UNITYSDK_OFFSET(0xCD492D0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2BATTLESHOWTALKSPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xCD492E0)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatV2BattleShowTalksParam_TypeDefinitionIndex = 75717;
