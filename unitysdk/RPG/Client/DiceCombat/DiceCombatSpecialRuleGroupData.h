...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSPECIALRULEGROUPDATA_CREATE_1_OFFSET UNITYSDK_OFFSET(0xA137FC0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSPECIALRULEGROUPDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xA132E50)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSPECIALRULEGROUPDATA_GET_EFFECTIVEROUNDID_OFFSET UNITYSDK_OFFSET(0xA1383A0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSPECIALRULEGROUPDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0xA1383B0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSPECIALRULEGROUPDATA_GET_RULELIST_OFFSET UNITYSDK_OFFSET(0xA1383D0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSPECIALRULEGROUPDATA_PINSPECIALRULEBYID_OFFSET UNITYSDK_OFFSET(0xA1381A0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSPECIALRULEGROUPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA137FB0)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatSpecialRuleGroupData_TypeDefinitionIndex = 69849;
