...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2PVPSTAGE_GET_CHATINVITEID_OFFSET UNITYSDK_OFFSET(0xCD5ACE0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2PVPSTAGE_GET_HIGHESTSCOREINHISTORY_OFFSET UNITYSDK_OFFSET(0xCD5AD20)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2PVPSTAGE_GET_INVITEROBOTIDLIST_OFFSET UNITYSDK_OFFSET(0xCD5AD00)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2PVPSTAGE_GET_STATE_OFFSET UNITYSDK_OFFSET(0xCD5AD40)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2PVPSTAGE_SET_CHATINVITEID_OFFSET UNITYSDK_OFFSET(0xCD5ACF0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2PVPSTAGE_SET_HIGHESTSCOREINHISTORY_OFFSET UNITYSDK_OFFSET(0xCD5AD30)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2PVPSTAGE_SET_INVITEROBOTIDLIST_OFFSET UNITYSDK_OFFSET(0xCD5AD10)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2PVPSTAGE__CTOR_OFFSET UNITYSDK_OFFSET(0xCD5AED0)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatV2PvPStage_TypeDefinitionIndex = 75696;
