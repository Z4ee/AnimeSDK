...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2PVPSTAGE_GET_CHATINVITEID_OFFSET UNITYSDK_OFFSET(0x1B8BE130)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2PVPSTAGE_GET_HIGHESTSCOREINHISTORY_OFFSET UNITYSDK_OFFSET(0x1B8BE170)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2PVPSTAGE_GET_INVITEROBOTIDLIST_OFFSET UNITYSDK_OFFSET(0x1B8BE150)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2PVPSTAGE_GET_STATE_OFFSET UNITYSDK_OFFSET(0x1B8BE190)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2PVPSTAGE_SET_CHATINVITEID_OFFSET UNITYSDK_OFFSET(0x1B8BE140)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2PVPSTAGE_SET_HIGHESTSCOREINHISTORY_OFFSET UNITYSDK_OFFSET(0x1B8BE180)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2PVPSTAGE_SET_INVITEROBOTIDLIST_OFFSET UNITYSDK_OFFSET(0x1B8BE160)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2PVPSTAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8BE320)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatV2PvPStage_TypeDefinitionIndex = 75695;
	...
	public:
		...
		::System::UInt32 _HighestScoreInHistory_k__BackingField; // 0x78
		::System::UInt32 _ChatInviteID_k__BackingField; // 0x7C
