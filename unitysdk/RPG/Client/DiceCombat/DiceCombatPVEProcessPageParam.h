...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATPVEPROCESSPAGEPARAM_CREATE_OFFSET UNITYSDK_OFFSET(0x9479530)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATPVEPROCESSPAGEPARAM_GET_BEGINSTAGE_OFFSET UNITYSDK_OFFSET(0x94795D0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATPVEPROCESSPAGEPARAM_GET_STAGEINFO_OFFSET UNITYSDK_OFFSET(0x94795F0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATPVEPROCESSPAGEPARAM_SET_BEGINSTAGE_OFFSET UNITYSDK_OFFSET(0x94795E0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATPVEPROCESSPAGEPARAM_SET_STAGEINFO_OFFSET UNITYSDK_OFFSET(0x9479600)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATPVEPROCESSPAGEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x94795C0)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatPVEProcessPageParam_TypeDefinitionIndex = 61962;
