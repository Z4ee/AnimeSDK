...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2SIDEBARTOASTQUEUE___C__DISPLAYCLASS14_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B8C2490)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2SIDEBARTOASTQUEUE___C__DISPLAYCLASS14_0___SHOW_B__0_OFFSET UNITYSDK_OFFSET(0x1B8C2860)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatV2SideBarToastQueue___c__DisplayClass14_0_TypeDefinitionIndex = 75737;

	class DiceCombatV2SideBarToastQueue___c__DisplayClass14_0 : public ::System::Object
	{
	public:
		::RPG::Client::DiceCombat::DiceCombatV2SideBarToastQueue_ActiveToastInfo* info; // 0x10
		::RPG::Client::DiceCombat::DiceCombatV2SideBarToastQueue* __4__this; // 0x18
