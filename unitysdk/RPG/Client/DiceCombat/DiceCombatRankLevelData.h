...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATRANKLEVELDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xCD31290)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATRANKLEVELDATA_GET_DICERANKID_OFFSET UNITYSDK_OFFSET(0xCD314B0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATRANKLEVELDATA_GET_HASSPECIALRULE_OFFSET UNITYSDK_OFFSET(0xCD318D0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATRANKLEVELDATA_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xCD317D0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATRANKLEVELDATA_GET_ICONSMALLPATH_OFFSET UNITYSDK_OFFSET(0xCD25100)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATRANKLEVELDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xCD31820)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATRANKLEVELDATA_GET_RANKMAXSCORE_OFFSET UNITYSDK_OFFSET(0xCD31740)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATRANKLEVELDATA_GET_RANKMINSCORE_OFFSET UNITYSDK_OFFSET(0xCD31790)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATRANKLEVELDATA_GET_SPECIALRULEGROUPDATAS_OFFSET UNITYSDK_OFFSET(0xCD31890)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATRANKLEVELDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCD31280)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatRankLevelData_TypeDefinitionIndex = 75605;
