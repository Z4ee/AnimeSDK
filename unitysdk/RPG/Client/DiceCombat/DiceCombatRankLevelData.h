...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATRANKLEVELDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1C415C20)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATRANKLEVELDATA_GET_DICERANKID_OFFSET UNITYSDK_OFFSET(0x1C415E40)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATRANKLEVELDATA_GET_HASSPECIALRULE_OFFSET UNITYSDK_OFFSET(0x1C416260)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATRANKLEVELDATA_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x1C416160)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATRANKLEVELDATA_GET_ICONSMALLPATH_OFFSET UNITYSDK_OFFSET(0x1C409A20)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATRANKLEVELDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1C4161B0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATRANKLEVELDATA_GET_RANKMAXSCORE_OFFSET UNITYSDK_OFFSET(0x1C4160D0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATRANKLEVELDATA_GET_RANKMINSCORE_OFFSET UNITYSDK_OFFSET(0x1C416120)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATRANKLEVELDATA_GET_SPECIALRULEGROUPDATAS_OFFSET UNITYSDK_OFFSET(0x1C416220)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATRANKLEVELDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1C415C10)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatRankLevelData_TypeDefinitionIndex = 75604;
