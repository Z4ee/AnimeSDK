...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCOMMUNICATEDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xB7A2160)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCOMMUNICATEDATA_GET_CHATCONTENT_OFFSET UNITYSDK_OFFSET(0xB7A2300)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCOMMUNICATEDATA_GET_COMMUNICATEID_OFFSET UNITYSDK_OFFSET(0xB7A22E0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCOMMUNICATEDATA_GET_EMOJIID_OFFSET UNITYSDK_OFFSET(0xB7A2260)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCOMMUNICATEDATA_GET_EMOJIPATH_OFFSET UNITYSDK_OFFSET(0xB7A2280)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCOMMUNICATEDATA_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xB7A2240)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCOMMUNICATEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB7A2150)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatCommunicateData_TypeDefinitionIndex = 70643;
