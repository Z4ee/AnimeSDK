...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCOMMUNICATEDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1C405C70)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCOMMUNICATEDATA_GET_CHATCONTENT_OFFSET UNITYSDK_OFFSET(0x1C405EA0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCOMMUNICATEDATA_GET_COMMUNICATEID_OFFSET UNITYSDK_OFFSET(0x1C405E50)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCOMMUNICATEDATA_GET_EMOJIID_OFFSET UNITYSDK_OFFSET(0x1C405DA0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCOMMUNICATEDATA_GET_EMOJIPATH_OFFSET UNITYSDK_OFFSET(0x1C405DF0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCOMMUNICATEDATA_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1C405D50)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCOMMUNICATEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1C405C60)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatCommunicateData_TypeDefinitionIndex = 75592;
