...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCOMMUNICATEDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x180C22C0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCOMMUNICATEDATA_GET_CHATCONTENT_OFFSET UNITYSDK_OFFSET(0x180C24F0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCOMMUNICATEDATA_GET_COMMUNICATEID_OFFSET UNITYSDK_OFFSET(0x180C24A0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCOMMUNICATEDATA_GET_EMOJIID_OFFSET UNITYSDK_OFFSET(0x180C23F0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCOMMUNICATEDATA_GET_EMOJIPATH_OFFSET UNITYSDK_OFFSET(0x180C2440)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCOMMUNICATEDATA_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x180C23A0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATCOMMUNICATEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x180C22B0)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatCommunicateData_TypeDefinitionIndex = 72156;
