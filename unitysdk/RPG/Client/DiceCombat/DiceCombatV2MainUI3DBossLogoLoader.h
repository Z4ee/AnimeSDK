...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MAINUI3DBOSSLOGOLOADER_BIND_OFFSET UNITYSDK_OFFSET(0x1A4420D0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MAINUI3DBOSSLOGOLOADER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A442490)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MAINUI3DBOSSLOGOLOADER_GET__MATERIAL_OFFSET UNITYSDK_OFFSET(0x1A4423D0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MAINUI3DBOSSLOGOLOADER_SHOWBOSSLOGIBYSTAGEID_OFFSET UNITYSDK_OFFSET(0x1A442120)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MAINUI3DBOSSLOGOLOADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4426C0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MAINUI3DBOSSLOGOLOADER__GETTEXTUREPATHBYSTAGEID_OFFSET UNITYSDK_OFFSET(0x1A442320)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatV2MainUI3DBossLogoLoader_TypeDefinitionIndex = 72293;

	class DiceCombatV2MainUI3DBossLogoLoader : public ::System::Object
	{
	public:
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::UnityEngine::Texture*>* _Textures; // 0x10
		::UnityEngine::Transform* _LogoTransform; // 0x18
