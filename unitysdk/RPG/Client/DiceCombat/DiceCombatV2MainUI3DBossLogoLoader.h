...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MAINUI3DBOSSLOGOLOADER_BIND_OFFSET UNITYSDK_OFFSET(0xCD56210)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MAINUI3DBOSSLOGOLOADER_DISPOSE_OFFSET UNITYSDK_OFFSET(0xCD565D0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MAINUI3DBOSSLOGOLOADER_GET__MATERIAL_OFFSET UNITYSDK_OFFSET(0xCD56510)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MAINUI3DBOSSLOGOLOADER_SHOWBOSSLOGIBYSTAGEID_OFFSET UNITYSDK_OFFSET(0xCD56260)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MAINUI3DBOSSLOGOLOADER__CTOR_OFFSET UNITYSDK_OFFSET(0xCD56970)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2MAINUI3DBOSSLOGOLOADER__GETTEXTUREPATHBYSTAGEID_OFFSET UNITYSDK_OFFSET(0xCD56460)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatV2MainUI3DBossLogoLoader_TypeDefinitionIndex = 75730;
