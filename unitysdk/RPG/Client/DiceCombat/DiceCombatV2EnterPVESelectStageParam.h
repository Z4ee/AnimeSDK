...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2ENTERPVESELECTSTAGEPARAM_CREATE_OFFSET UNITYSDK_OFFSET(0x1C434E80)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2ENTERPVESELECTSTAGEPARAM_GET_SELECTSTAGEID_OFFSET UNITYSDK_OFFSET(0x1C434F10)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2ENTERPVESELECTSTAGEPARAM_SET_SELECTSTAGEID_OFFSET UNITYSDK_OFFSET(0x1C434F20)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATV2ENTERPVESELECTSTAGEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1C434F00)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatV2EnterPVESelectStageParam_TypeDefinitionIndex = 75718;
