...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_CHECKPRESETSTAGESKIP_OFFSET UNITYSDK_OFFSET(0xB7B4190)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_CREATE_OFFSET UNITYSDK_OFFSET(0xB79FB30)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_BANNEDAVATARLIST_OFFSET UNITYSDK_OFFSET(0xB7B43C0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_CAMPAIGNPROGRESSTITLE_OFFSET UNITYSDK_OFFSET(0xB7B4540)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_CAMPAIGNPROGRESS_OFFSET UNITYSDK_OFFSET(0xB7B44E0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_ENEMYAVATARID_OFFSET UNITYSDK_OFFSET(0xB7B4300)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_ENEMYAVATARINFO_OFFSET UNITYSDK_OFFSET(0xB7B3FB0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_ENEMYAVATARLEVEL_OFFSET UNITYSDK_OFFSET(0xB7B4320)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_ENEMYICONPATH_OFFSET UNITYSDK_OFFSET(0xB79FFE0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_ENEMYMAINPAGEIMGPATH_OFFSET UNITYSDK_OFFSET(0xB7B4420)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_ENEMYMAINPAGESILHOUETTEPATH_OFFSET UNITYSDK_OFFSET(0xB7B4480)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_ENEMYNAME_OFFSET UNITYSDK_OFFSET(0xB79FF60)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_ENEMYPROGRESSICONPATH_OFFSET UNITYSDK_OFFSET(0xB7B3F50)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_ENTERPROGRESSBOAST_OFFSET UNITYSDK_OFFSET(0xB7B45C0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_EXITMAINPAGEONFINISH_OFFSET UNITYSDK_OFFSET(0xB7B47C0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_EXITPROGRESSBOAST_OFFSET UNITYSDK_OFFSET(0xB7B4740)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_FIRSTTYPE_OFFSET UNITYSDK_OFFSET(0xB7B4380)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_GROUPENTITYID_OFFSET UNITYSDK_OFFSET(0xB7B43D0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_HARDLEVEL_OFFSET UNITYSDK_OFFSET(0xB7B4360)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_HASSPECIALRULE_OFFSET UNITYSDK_OFFSET(0xB7B3FD0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_ISCAMPAIGN_OFFSET UNITYSDK_OFFSET(0xB7B3EE0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_ISDONE_OFFSET UNITYSDK_OFFSET(0xB7AE330)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_ISPRESETSTAGE_OFFSET UNITYSDK_OFFSET(0xB7B4180)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_ISREWARDTAKEN_OFFSET UNITYSDK_OFFSET(0xB7B40A0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_LOSEBATTLEBOAST_OFFSET UNITYSDK_OFFSET(0xB7B4640)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_MUSTLOSE_OFFSET UNITYSDK_OFFSET(0xB7B4820)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_PLAYERINITAVATARINFO_OFFSET UNITYSDK_OFFSET(0xB79FD70)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_RECOMMENDAVATARLIST_OFFSET UNITYSDK_OFFSET(0xB7B43A0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_REWARDID_OFFSET UNITYSDK_OFFSET(0xB7B4340)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_SPECIALRULEGROUPDATAS_OFFSET UNITYSDK_OFFSET(0xB7B4030)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_STAGEID_OFFSET UNITYSDK_OFFSET(0xB7B4160)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_SUBMISSONID_OFFSET UNITYSDK_OFFSET(0xB7B4040)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_WINBATTLEBOAST_OFFSET UNITYSDK_OFFSET(0xB7B46C0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET__DICECOMBATMODULE_OFFSET UNITYSDK_OFFSET(0xB7B3EF0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_SETNOTINACTIVITYENEMYNAME_OFFSET UNITYSDK_OFFSET(0xB7B42A0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_SET_ENEMYAVATARINFO_OFFSET UNITYSDK_OFFSET(0xB7B3FC0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xB7B3EB0)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatStageInfo_TypeDefinitionIndex = 70664;
	...
	public:
		...
		::RPG::GameCore::ActivityDiceCombatStageRow* _StageRow; // 0x20
