...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_CHECKPRESETSTAGESKIP_OFFSET UNITYSDK_OFFSET(0xCD385E0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_CREATE_OFFSET UNITYSDK_OFFSET(0xCD37C00)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_BANNEDAVATARLIST_OFFSET UNITYSDK_OFFSET(0xCD38970)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_CAMPAIGNPROGRESSTITLE_OFFSET UNITYSDK_OFFSET(0xCD38B30)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_CAMPAIGNPROGRESS_OFFSET UNITYSDK_OFFSET(0xCD38AE0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_ENEMYAVATARID_OFFSET UNITYSDK_OFFSET(0xCD38790)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_ENEMYAVATARINFO_OFFSET UNITYSDK_OFFSET(0xCD38290)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_ENEMYAVATARLEVEL_OFFSET UNITYSDK_OFFSET(0xCD387E0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_ENEMYICONPATH_OFFSET UNITYSDK_OFFSET(0xCD38140)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_ENEMYMAINPAGEIMGPATH_OFFSET UNITYSDK_OFFSET(0xCD38A20)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_ENEMYMAINPAGESILHOUETTEPATH_OFFSET UNITYSDK_OFFSET(0xCD38A80)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_ENEMYNAME_OFFSET UNITYSDK_OFFSET(0xCD28B00)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_ENEMYPROGRESSICONPATH_OFFSET UNITYSDK_OFFSET(0xCD38230)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_ENTERPROGRESSBOAST_OFFSET UNITYSDK_OFFSET(0xCD38BB0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_EXITMAINPAGEONFINISH_OFFSET UNITYSDK_OFFSET(0xCD38DB0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_EXITPROGRESSBOAST_OFFSET UNITYSDK_OFFSET(0xCD38D30)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_FIRSTTYPE_OFFSET UNITYSDK_OFFSET(0xCD388D0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_GROUPENTITYID_OFFSET UNITYSDK_OFFSET(0xCD389C0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_HARDLEVEL_OFFSET UNITYSDK_OFFSET(0xCD38880)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_HASSPECIALRULE_OFFSET UNITYSDK_OFFSET(0xCD382B0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_ISCAMPAIGN_OFFSET UNITYSDK_OFFSET(0xCD38060)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_ISDONE_OFFSET UNITYSDK_OFFSET(0xCD30CE0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_ISPRESETSTAGE_OFFSET UNITYSDK_OFFSET(0xCD38590)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_ISREWARDTAKEN_OFFSET UNITYSDK_OFFSET(0xCD38410)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_LOSEBATTLEBOAST_OFFSET UNITYSDK_OFFSET(0xCD38C30)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_MUSTLOSE_OFFSET UNITYSDK_OFFSET(0xCD38E10)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_PLAYERINITAVATARINFO_OFFSET UNITYSDK_OFFSET(0xCD37E70)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_RECOMMENDAVATARLIST_OFFSET UNITYSDK_OFFSET(0xCD38920)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_REWARDID_OFFSET UNITYSDK_OFFSET(0xCD38830)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_SPECIALRULEGROUPDATAS_OFFSET UNITYSDK_OFFSET(0xCD38370)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_STAGEID_OFFSET UNITYSDK_OFFSET(0xCD38540)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_SUBMISSONID_OFFSET UNITYSDK_OFFSET(0xCD383B0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET_WINBATTLEBOAST_OFFSET UNITYSDK_OFFSET(0xCD38CB0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_GET__DICECOMBATMODULE_OFFSET UNITYSDK_OFFSET(0xCD380B0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_SETNOTINACTIVITYENEMYNAME_OFFSET UNITYSDK_OFFSET(0xCD38730)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO_SET_ENEMYAVATARINFO_OFFSET UNITYSDK_OFFSET(0xCD382A0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATSTAGEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xCD37E40)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatStageInfo_TypeDefinitionIndex = 75614;
