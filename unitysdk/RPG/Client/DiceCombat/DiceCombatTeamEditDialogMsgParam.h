...
#define RPG_CLIENT_DICECOMBAT_DICECOMBATTEAMEDITDIALOGMSGPARAM_CREATE_OFFSET UNITYSDK_OFFSET(0x1A4252B0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATTEAMEDITDIALOGMSGPARAM_GET_AVATARLIST_OFFSET UNITYSDK_OFFSET(0x1A4251F0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATTEAMEDITDIALOGMSGPARAM_GET_CONFIRMCALLBACK_OFFSET UNITYSDK_OFFSET(0x1A425270)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATTEAMEDITDIALOGMSGPARAM_GET_CURRENTCONFIRMEDAVATARID_OFFSET UNITYSDK_OFFSET(0x1A425250)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATTEAMEDITDIALOGMSGPARAM_GET_NEEDSELECTNUM_OFFSET UNITYSDK_OFFSET(0x1A425230)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATTEAMEDITDIALOGMSGPARAM_GET_SELECTEDAVATARIDLIST_OFFSET UNITYSDK_OFFSET(0x1A425210)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATTEAMEDITDIALOGMSGPARAM_GET_STAGEID_OFFSET UNITYSDK_OFFSET(0x1A425290)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATTEAMEDITDIALOGMSGPARAM_SET_AVATARLIST_OFFSET UNITYSDK_OFFSET(0x1A425200)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATTEAMEDITDIALOGMSGPARAM_SET_CONFIRMCALLBACK_OFFSET UNITYSDK_OFFSET(0x1A425280)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATTEAMEDITDIALOGMSGPARAM_SET_CURRENTCONFIRMEDAVATARID_OFFSET UNITYSDK_OFFSET(0x1A425260)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATTEAMEDITDIALOGMSGPARAM_SET_NEEDSELECTNUM_OFFSET UNITYSDK_OFFSET(0x1A425240)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATTEAMEDITDIALOGMSGPARAM_SET_SELECTEDAVATARIDLIST_OFFSET UNITYSDK_OFFSET(0x1A425220)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATTEAMEDITDIALOGMSGPARAM_SET_STAGEID_OFFSET UNITYSDK_OFFSET(0x1A4252A0)
#define RPG_CLIENT_DICECOMBAT_DICECOMBATTEAMEDITDIALOGMSGPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4251E0)

namespace RPG::Client::DiceCombat
{
	inline static constexpr unsigned int DiceCombatTeamEditDialogMsgParam_TypeDefinitionIndex = 72217;

	class DiceCombatTeamEditDialogMsgParam : public ::System::Object
	{
	public:
		::System::Collections::Generic::List_1<::RPG::Client::DiceCombat::IDiceCombatAvatarInfo*>* _AvatarList_k__BackingField; // 0x10
		::System::Collections::Generic::List_1<::System::UInt32>* _SelectedAvatarIDList_k__BackingField; // 0x18
		::System::Action_1<::XLua::LuaTable*>* _ConfirmCallback_k__BackingField; // 0x20
		::System::UInt32 _StageID_k__BackingField; // 0x28
		::System::UInt32 _CurrentConfirmedAvatarID_k__BackingField; // 0x2C
		::System::UInt32 _NeedSelectNum_k__BackingField; // 0x30
