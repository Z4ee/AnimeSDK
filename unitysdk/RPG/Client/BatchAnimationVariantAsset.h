...
#define RPG_CLIENT_BATCHANIMATIONVARIANTASSET_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x9DE1AE0)
#define RPG_CLIENT_BATCHANIMATIONVARIANTASSET_METHOD_5_70589F89E4D22649_OFFSET UNITYSDK_OFFSET(0x9DE20A0)
#define RPG_CLIENT_BATCHANIMATIONVARIANTASSET_METHOD_5_98BDAE1210E561CF_OFFSET UNITYSDK_OFFSET(0x9DE2170)
#define RPG_CLIENT_BATCHANIMATIONVARIANTASSET_METHOD_5_E05CA2D09FC152A8_OFFSET UNITYSDK_OFFSET(0x9DE2390)
#define RPG_CLIENT_BATCHANIMATIONVARIANTASSET_METHOD_5_F442AFF05DE66386_OFFSET UNITYSDK_OFFSET(0x9DE15E0)
#define RPG_CLIENT_BATCHANIMATIONVARIANTASSET_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9DE18E0)
#define RPG_CLIENT_BATCHANIMATIONVARIANTASSET_RELEASEVARIANTRES_OFFSET UNITYSDK_OFFSET(0x9DE1420)
#define RPG_CLIENT_BATCHANIMATIONVARIANTASSET_REQUESTVARIANTRES_OFFSET UNITYSDK_OFFSET(0x9DE1330)
#define RPG_CLIENT_BATCHANIMATIONVARIANTASSET_SETPARTVARIANT_OFFSET UNITYSDK_OFFSET(0x9DE14B0)
#define RPG_CLIENT_BATCHANIMATIONVARIANTASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x9DE25E0)

namespace RPG::Client
{
	inline static constexpr unsigned int BatchAnimationVariantAsset_TypeDefinitionIndex = 64070;
	...
	public:
		...
		::System::Void SetPartVariant(::UnityEngine::Rendering::BatchAnimation* a1, ::Class_1_419365673683D605* a2)
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::Rendering::BatchAnimation*, ::Class_1_419365673683D605*))((::PBYTE)hIl2Cpp + RPG_CLIENT_BATCHANIMATIONVARIANTASSET_SETPARTVARIANT_OFFSET))(this, a1, a2);
		}
