...
#define RPG_CLIENT_FATEHANDBOOKHOUGUCOLLECTION_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA34D200)
#define RPG_CLIENT_FATEHANDBOOKHOUGUCOLLECTION_GET_HOUGUITEMLIST_OFFSET UNITYSDK_OFFSET(0xA34D4F0)
#define RPG_CLIENT_FATEHANDBOOKHOUGUCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0xA34D1F0)
#define RPG_CLIENT_FATEHANDBOOKHOUGUCOLLECTION__GENERATEHOUGUHANDBOOKLIST_OFFSET UNITYSDK_OFFSET(0xA34D270)
