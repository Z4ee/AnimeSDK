...
#define RPG_CLIENT_FATEHANDBOOKHOUGUCOLLECTION_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A5AB450)
#define RPG_CLIENT_FATEHANDBOOKHOUGUCOLLECTION_GET_HOUGUITEMLIST_OFFSET UNITYSDK_OFFSET(0x1A5AB840)
#define RPG_CLIENT_FATEHANDBOOKHOUGUCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5AB440)
#define RPG_CLIENT_FATEHANDBOOKHOUGUCOLLECTION__GENERATEHOUGUHANDBOOKLIST_OFFSET UNITYSDK_OFFSET(0x1A5AB4E0)

namespace RPG::Client
{
	inline static constexpr unsigned int FateHandbookHouguCollection_TypeDefinitionIndex = 61151;
