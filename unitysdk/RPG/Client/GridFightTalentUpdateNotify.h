...
#define RPG_CLIENT_GRIDFIGHTTALENTUPDATENOTIFY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5D94C0)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightTalentUpdateNotify_TypeDefinitionIndex = 62339;
