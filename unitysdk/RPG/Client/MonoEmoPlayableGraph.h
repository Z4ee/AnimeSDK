...
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_AUTOBLINKWITHEYESTATE_OFFSET UNITYSDK_OFFSET(0xD7DC320)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_CANBLINK_OFFSET UNITYSDK_OFFSET(0xD7DC650)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_DESTROY_OFFSET UNITYSDK_OFFSET(0xD7DBCE0)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_GETAVATARMASK_OFFSET UNITYSDK_OFFSET(0xD7E02A0)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_GETCLIP_OFFSET UNITYSDK_OFFSET(0xD7DBE60)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_GETDEFAULTCLIP_OFFSET UNITYSDK_OFFSET(0xD7E0C40)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_GETOUTPUT_OFFSET UNITYSDK_OFFSET(0xD7DBF70)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_GETPLAYABLEGRAPH_OFFSET UNITYSDK_OFFSET(0xD7DFDF0)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_GET_ALWAYSEVALUATE_OFFSET UNITYSDK_OFFSET(0xD7DB920)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_GET_EMOTIONPLAYABLEGRAPH_OFFSET UNITYSDK_OFFSET(0xD7DB8D0)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_GET_FACERENDERER_OFFSET UNITYSDK_OFFSET(0xD7DB940)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_GET_FADEOUTAUTOBLINK_OFFSET UNITYSDK_OFFSET(0xD7DB900)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_GET_OWNERENTITY_OFFSET UNITYSDK_OFFSET(0xD7DB8E0)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_GET_PLAYABLEGRAPH_OFFSET UNITYSDK_OFFSET(0xD7DB8F0)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_0031B2A6B176A873_OFFSET UNITYSDK_OFFSET(0xD7DEE90)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_0D7638DBC93E5002_OFFSET UNITYSDK_OFFSET(0xD7DC100)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_0E3D8071A5930FA8_OFFSET UNITYSDK_OFFSET(0xD7DC7B0)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_104F651E1412A8CC_OFFSET UNITYSDK_OFFSET(0xD7DD670)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_151E25A63D14DDB0_1_OFFSET UNITYSDK_OFFSET(0xD7E0980)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_151E25A63D14DDB0_2_OFFSET UNITYSDK_OFFSET(0xD7E0AE0)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0xD7E0820)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_2450CFC043E97F54_OFFSET UNITYSDK_OFFSET(0xD7DF0D0)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_277F8930086803D1_OFFSET UNITYSDK_OFFSET(0xD7E0130)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_360914574A437C0A_OFFSET UNITYSDK_OFFSET(0xD7E0D10)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xD7DE030)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_515AB539783606E0_OFFSET UNITYSDK_OFFSET(0xD7DE370)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_56C243520A6A6A4C_OFFSET UNITYSDK_OFFSET(0xD7DED90)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_5F9B14860EA6F2FD_OFFSET UNITYSDK_OFFSET(0xD7DDC70)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_7DB49B5407C8FD68_OFFSET UNITYSDK_OFFSET(0xD7DC6B0)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_84FDC7D1E4092695_OFFSET UNITYSDK_OFFSET(0xD7DE930)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_8C3F79E1E85EBE71_OFFSET UNITYSDK_OFFSET(0xD7DE0F0)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_8FAD57395F26ACC4_OFFSET UNITYSDK_OFFSET(0xD7DE2F0)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_9681042564541CD6_1_OFFSET UNITYSDK_OFFSET(0xD7DF320)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xD7DDFC0)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_969EF16C38E0FD30_OFFSET UNITYSDK_OFFSET(0xD7DF510)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_A9D0098EE09DF11B_OFFSET UNITYSDK_OFFSET(0xD7DC530)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_B49D9DFCA7DAD6C6_OFFSET UNITYSDK_OFFSET(0xD7DFD80)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xD7DC260)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_E086BDB08435547E_1_OFFSET UNITYSDK_OFFSET(0xD7E03A0)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_E086BDB08435547E_2_OFFSET UNITYSDK_OFFSET(0xD7E0410)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_E086BDB08435547E_OFFSET UNITYSDK_OFFSET(0xD7E0330)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_E0F023080DE42077_1_OFFSET UNITYSDK_OFFSET(0xD7E05E0)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_E0F023080DE42077_2_OFFSET UNITYSDK_OFFSET(0xD7E0690)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_E0F023080DE42077_OFFSET UNITYSDK_OFFSET(0xD7E0530)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_E3DE31A03057E055_OFFSET UNITYSDK_OFFSET(0xD7DF380)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_EC2B405D0723571D_OFFSET UNITYSDK_OFFSET(0xD7DBAB0)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_F07840BBC25636A7_OFFSET UNITYSDK_OFFSET(0xD7DFB90)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_METHOD_5_F978A1D172468895_OFFSET UNITYSDK_OFFSET(0xD7DF170)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_ONAUDIOLANGUAGECHANGED_OFFSET UNITYSDK_OFFSET(0xD7DB960)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xD7DFF50)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xD7DF7F0)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_ONENABLE_OFFSET UNITYSDK_OFFSET(0xD7DF640)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_ONOWNERRECYCLE_OFFSET UNITYSDK_OFFSET(0xD7E00E0)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_RESETPERMANENTCLIP_OFFSET UNITYSDK_OFFSET(0xD7DDDC0)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_SETAUTOBLINKWITHCURREYESTATE_OFFSET UNITYSDK_OFFSET(0xD7DC2C0)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_SETENABLEAUTOBLICKWITHEYESTATE_OFFSET UNITYSDK_OFFSET(0xD7DC3F0)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_SETENABLEAUTOBLINKSTATE_OFFSET UNITYSDK_OFFSET(0xD7DC010)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_SETEYEPERMANENTEYESTATE_OFFSET UNITYSDK_OFFSET(0xD7E0CB0)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_SETMASKRENDERER_OFFSET UNITYSDK_OFFSET(0xD7DC490)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_SETMOUTHTALK_OFFSET UNITYSDK_OFFSET(0xD7E0E20)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_SETTALKPERMANENT_OFFSET UNITYSDK_OFFSET(0xD7E0480)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_SET_ALWAYSEVALUATE_OFFSET UNITYSDK_OFFSET(0xD7DB930)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_SET_FACERENDERER_OFFSET UNITYSDK_OFFSET(0xD7DB950)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_SET_FADEOUTAUTOBLINK_OFFSET UNITYSDK_OFFSET(0xD7DB910)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_START_OFFSET UNITYSDK_OFFSET(0xD7DF750)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_STOPMOUTHTALK_OFFSET UNITYSDK_OFFSET(0xD7E1020)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_STOPTALKPERMANENT_OFFSET UNITYSDK_OFFSET(0xD7E0740)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_TICKAFTEREVALUATE_OFFSET UNITYSDK_OFFSET(0xD7DFE90)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_TICKBEFOREEVALUATE_OFFSET UNITYSDK_OFFSET(0xD7DFAF0)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_TRIGGERBLINKINGEYECLOSE_OFFSET UNITYSDK_OFFSET(0xD7DC4E0)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_TRYINIT_OFFSET UNITYSDK_OFFSET(0xD7DB9F0)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH_UPDATE_OFFSET UNITYSDK_OFFSET(0xD7DF980)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH__CCTOR_OFFSET UNITYSDK_OFFSET(0xD7E10C0)
#define RPG_CLIENT_MONOEMOPLAYABLEGRAPH__CTOR_OFFSET UNITYSDK_OFFSET(0xD7E1080)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(MonoEmoPlayableGraph_TypeDefinitionIndex)->GetStaticField(0x133B0);
		}
		static ::Il2CppArray<::System::Int32>** StaticGet_PAEAOEKEKJB()
		{
			return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(MonoEmoPlayableGraph_TypeDefinitionIndex)->GetStaticField(0x133B8);
		}
		static ::System::Boolean* StaticGet_USE_NEW_EMO()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(MonoEmoPlayableGraph_TypeDefinitionIndex)->GetStaticField(0x7D70);
		}
