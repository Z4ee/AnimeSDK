...
#define RPG_CLIENT_ROGUETOURNROOMATTRIBUTEUNDERLINEPARAM_CREATE_OFFSET UNITYSDK_OFFSET(0xB109AE0)
#define RPG_CLIENT_ROGUETOURNROOMATTRIBUTEUNDERLINEPARAM_EQUALS_OFFSET UNITYSDK_OFFSET(0xB109A20)
#define RPG_CLIENT_ROGUETOURNROOMATTRIBUTEUNDERLINEPARAM_GET_ATTRIBUTE_OFFSET UNITYSDK_OFFSET(0xB109A10)
#define RPG_CLIENT_ROGUETOURNROOMATTRIBUTEUNDERLINEPARAM_GET_DESC_OFFSET UNITYSDK_OFFSET(0xB109950)
#define RPG_CLIENT_ROGUETOURNROOMATTRIBUTEUNDERLINEPARAM_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xB109900)
#define RPG_CLIENT_ROGUETOURNROOMATTRIBUTEUNDERLINEPARAM_GET_NAME_OFFSET UNITYSDK_OFFSET(0xB109920)
#define RPG_CLIENT_ROGUETOURNROOMATTRIBUTEUNDERLINEPARAM_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xB1098F0)
#define RPG_CLIENT_ROGUETOURNROOMATTRIBUTEUNDERLINEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xB109B60)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueTournRoomAttributeUnderlineParam_TypeDefinitionIndex = 62565;
