...
#define RPG_CLIENT_LOCALIZEDINPUTFIELD_VOIDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19AD63A0)
#define RPG_CLIENT_LOCALIZEDINPUTFIELD_VOIDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19AD63D0)
#define RPG_CLIENT_LOCALIZEDINPUTFIELD_VOIDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19AD56F0)
#define RPG_CLIENT_LOCALIZEDINPUTFIELD_VOIDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19AD6330)

namespace RPG::Client
{
	inline static constexpr unsigned int LocalizedInputField_VoidDelegate_TypeDefinitionIndex = 69280;
