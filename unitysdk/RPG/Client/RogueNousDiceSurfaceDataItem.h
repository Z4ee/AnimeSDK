...
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB083F60)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_BRANCHLIMITATIONS_OFFSET UNITYSDK_OFFSET(0xB084FB0)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_DESCPARAM_OFFSET UNITYSDK_OFFSET(0xB086710)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_DICEACTIVESTAGE_OFFSET UNITYSDK_OFFSET(0xB0868F0)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_EXTRADESC_OFFSET UNITYSDK_OFFSET(0xB086A30)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_ICON_OFFSET UNITYSDK_OFFSET(0xB085FB0)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_ISFIRSTTIMEUNLOCK_OFFSET UNITYSDK_OFFSET(0xB086C90)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0xB086550)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_ITEMID_OFFSET UNITYSDK_OFFSET(0xB085230)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_RARITY_OFFSET UNITYSDK_OFFSET(0xB0867B0)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_SLOTLIST_OFFSET UNITYSDK_OFFSET(0xB086850)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_SORT_OFFSET UNITYSDK_OFFSET(0xB086990)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_SURFACEDESC_OFFSET UNITYSDK_OFFSET(0xB086640)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_SURFACEID_OFFSET UNITYSDK_OFFSET(0xB086530)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_SURFACENAME_OFFSET UNITYSDK_OFFSET(0xB086570)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_TAGLIST_OFFSET UNITYSDK_OFFSET(0xB086AD0)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET_UNLOCKCONDITION_OFFSET UNITYSDK_OFFSET(0xB086B70)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_GET__ROW_OFFSET UNITYSDK_OFFSET(0xB0864D0)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_SET_ISFIRSTTIMEUNLOCK_OFFSET UNITYSDK_OFFSET(0xB086CA0)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_SET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0xB086560)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_SET_SURFACEID_OFFSET UNITYSDK_OFFSET(0xB086540)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_SYNCUNLOCKEDSTATUS_OFFSET UNITYSDK_OFFSET(0xB0846C0)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM_UPDATENEWSTATUS_OFFSET UNITYSDK_OFFSET(0xB0863F0)
#define RPG_CLIENT_ROGUENOUSDICESURFACEDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xB085220)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueNousDiceSurfaceDataItem_TypeDefinitionIndex = 61662;
	...
	public:
		...
		::System::Boolean _IsFirstTimeUnlock_k__BackingField; // 0x18
