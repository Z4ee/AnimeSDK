...
#define RPG_CLIENT_AIRLINEVARIABLESCALEPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0xB2D8FC0)

namespace RPG::Client
{
	inline static constexpr unsigned int AirlineVariableScalePoint_TypeDefinitionIndex = 55876;
