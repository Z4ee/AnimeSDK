...
#define RPG_CLIENT_AIRLINEVARIABLESCALEPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x9CE9C40)

namespace RPG::Client
{
	inline static constexpr unsigned int AirlineVariableScalePoint_TypeDefinitionIndex = 55142;
