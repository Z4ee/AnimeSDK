...
#define RPG_CLIENT_ATTACHMAPPINGITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xB336B80)

namespace RPG::Client
{
	inline static constexpr unsigned int AttachMappingItem_TypeDefinitionIndex = 64466;
