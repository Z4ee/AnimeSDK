...
#define RPG_CLIENT_DYNAMICMATERIALLOADER__COLLECTALLREFASSETPATH_D__10_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xB8221B0)
#define RPG_CLIENT_DYNAMICMATERIALLOADER__COLLECTALLREFASSETPATH_D__10_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_STRING__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xB822300)
#define RPG_CLIENT_DYNAMICMATERIALLOADER__COLLECTALLREFASSETPATH_D__10_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xB822360)
#define RPG_CLIENT_DYNAMICMATERIALLOADER__COLLECTALLREFASSETPATH_D__10_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xB822310)
#define RPG_CLIENT_DYNAMICMATERIALLOADER__COLLECTALLREFASSETPATH_D__10_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB8221A0)
#define RPG_CLIENT_DYNAMICMATERIALLOADER__COLLECTALLREFASSETPATH_D__10__CTOR_OFFSET UNITYSDK_OFFSET(0xB822020)

namespace RPG::Client
{
	inline static constexpr unsigned int DynamicMaterialLoader__CollectAllRefAssetPath_d__10_TypeDefinitionIndex = 63995;

	class DynamicMaterialLoader__CollectAllRefAssetPath_d__10 : public ::System::Object
	{
	public:
		::Il2CppArray<::RPG::Client::DynamicMaterialLoader_MaterialLoadItem*>* _mats_5__3; // 0x10
