...
#define RPG_CLIENT_DYNAMICMATERIALLOADER__COLLECTALLREFASSETPATH_D__10_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x951DC70)
#define RPG_CLIENT_DYNAMICMATERIALLOADER__COLLECTALLREFASSETPATH_D__10_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_STRING__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x951DDD0)
#define RPG_CLIENT_DYNAMICMATERIALLOADER__COLLECTALLREFASSETPATH_D__10_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x951DE30)
#define RPG_CLIENT_DYNAMICMATERIALLOADER__COLLECTALLREFASSETPATH_D__10_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x951DDE0)
#define RPG_CLIENT_DYNAMICMATERIALLOADER__COLLECTALLREFASSETPATH_D__10_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x951DC60)
#define RPG_CLIENT_DYNAMICMATERIALLOADER__COLLECTALLREFASSETPATH_D__10__CTOR_OFFSET UNITYSDK_OFFSET(0x951DAE0)

namespace RPG::Client
{
	inline static constexpr unsigned int DynamicMaterialLoader__CollectAllRefAssetPath_d__10_TypeDefinitionIndex = 55844;
