...
#define RPG_CLIENT_GRIDFIGHTCYRENEMODIFYCONFIG_GET_MODIFYOPS_OFFSET UNITYSDK_OFFSET(0x1C95EFD0)
#define RPG_CLIENT_GRIDFIGHTCYRENEMODIFYCONFIG_GET_MODIFYSKILLID_OFFSET UNITYSDK_OFFSET(0x1C95EF30)
#define RPG_CLIENT_GRIDFIGHTCYRENEMODIFYCONFIG_GET_MODIFYSKILLINDEXS_OFFSET UNITYSDK_OFFSET(0x1C95EF80)
#define RPG_CLIENT_GRIDFIGHTCYRENEMODIFYCONFIG_GET_MODIFYVALUES_OFFSET UNITYSDK_OFFSET(0x1C95F020)
#define RPG_CLIENT_GRIDFIGHTCYRENEMODIFYCONFIG_GET_SKILLTYPE_OFFSET UNITYSDK_OFFSET(0x1C95F0C0)
#define RPG_CLIENT_GRIDFIGHTCYRENEMODIFYCONFIG_GET_VALUEKEY_OFFSET UNITYSDK_OFFSET(0x1C95F070)
#define RPG_CLIENT_GRIDFIGHTCYRENEMODIFYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C95EF20)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightCyreneModifyConfig_TypeDefinitionIndex = 65188;
