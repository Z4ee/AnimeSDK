...
#define RPG_CLIENT_CHENLINGBATTLE_ENTITYMOVEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x9FA7200)

namespace RPG::Client::ChenLingBattle
{
	inline static constexpr unsigned int EntityMoveInfo_TypeDefinitionIndex = 70038;
