...
#define RPG_CLIENT_CHENLINGBATTLE_ENCHANT_CREATE_OFFSET UNITYSDK_OFFSET(0x9FA6D30)
#define RPG_CLIENT_CHENLINGBATTLE_ENCHANT_GETDESC_OFFSET UNITYSDK_OFFSET(0x9FA6E40)
#define RPG_CLIENT_CHENLINGBATTLE_ENCHANT_GET_CONFIGID_OFFSET UNITYSDK_OFFSET(0x9FA6EF0)
#define RPG_CLIENT_CHENLINGBATTLE_ENCHANT_GET_DESC_OFFSET UNITYSDK_OFFSET(0x9FA6F40)
#define RPG_CLIENT_CHENLINGBATTLE_ENCHANT_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x9FA6F90)
#define RPG_CLIENT_CHENLINGBATTLE_ENCHANT_GET_MAXLEVEL_OFFSET UNITYSDK_OFFSET(0x9FA6FB0)
#define RPG_CLIENT_CHENLINGBATTLE_ENCHANT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x9FA6F10)
#define RPG_CLIENT_CHENLINGBATTLE_ENCHANT_GET_SMALLICONPATH_OFFSET UNITYSDK_OFFSET(0x9FA6F70)
#define RPG_CLIENT_CHENLINGBATTLE_ENCHANT_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0x9FA6FA0)
#define RPG_CLIENT_CHENLINGBATTLE_ENCHANT_SET_MAXLEVEL_OFFSET UNITYSDK_OFFSET(0x9FA6FC0)
#define RPG_CLIENT_CHENLINGBATTLE_ENCHANT__CTOR_OFFSET UNITYSDK_OFFSET(0x9FA6DF0)

namespace RPG::Client::ChenLingBattle
{
	inline static constexpr unsigned int Enchant_TypeDefinitionIndex = 70122;
