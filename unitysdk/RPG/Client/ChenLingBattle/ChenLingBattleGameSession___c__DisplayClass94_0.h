...
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEGAMESESSION___C__DISPLAYCLASS94_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9FA07F0)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEGAMESESSION___C__DISPLAYCLASS94_0__GETEFFECT_B__0_OFFSET UNITYSDK_OFFSET(0x9FA1C20)

namespace RPG::Client::ChenLingBattle
{
	inline static constexpr unsigned int ChenLingBattleGameSession___c__DisplayClass94_0_TypeDefinitionIndex = 70103;
