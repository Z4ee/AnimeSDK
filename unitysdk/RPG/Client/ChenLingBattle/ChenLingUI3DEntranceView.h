...
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGUI3DENTRANCEVIEW_REPLAYTIMELINE_OFFSET UNITYSDK_OFFSET(0x19651B40)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGUI3DENTRANCEVIEW_SETSTAGE_OFFSET UNITYSDK_OFFSET(0x196515A0)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGUI3DENTRANCEVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x19652060)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGUI3DENTRANCEVIEW__GETDECKID_OFFSET UNITYSDK_OFFSET(0x19651920)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGUI3DENTRANCEVIEW__GETRANDOMDECK_OFFSET UNITYSDK_OFFSET(0x19651CA0)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGUI3DENTRANCEVIEW__GETSOLDIERMODELPATH_OFFSET UNITYSDK_OFFSET(0x19651A00)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGUI3DENTRANCEVIEW__SHOWTIMELINE_OFFSET UNITYSDK_OFFSET(0x19651DC0)

namespace RPG::Client::ChenLingBattle
{
	inline static constexpr unsigned int ChenLingUI3DEntranceView_TypeDefinitionIndex = 72302;
