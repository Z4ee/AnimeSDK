...
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGUI3DENTRANCEVIEW_REPLAYTIMELINE_OFFSET UNITYSDK_OFFSET(0x1B958050)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGUI3DENTRANCEVIEW_SETSTAGE_OFFSET UNITYSDK_OFFSET(0x1B957AB0)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGUI3DENTRANCEVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B958570)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGUI3DENTRANCEVIEW__GETDECKID_OFFSET UNITYSDK_OFFSET(0x1B957E30)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGUI3DENTRANCEVIEW__GETRANDOMDECK_OFFSET UNITYSDK_OFFSET(0x1B9581B0)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGUI3DENTRANCEVIEW__GETSOLDIERMODELPATH_OFFSET UNITYSDK_OFFSET(0x1B957F10)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGUI3DENTRANCEVIEW__SHOWTIMELINE_OFFSET UNITYSDK_OFFSET(0x1B9582D0)

namespace RPG::Client::ChenLingBattle
{
	inline static constexpr unsigned int ChenLingUI3DEntranceView_TypeDefinitionIndex = 75738;
