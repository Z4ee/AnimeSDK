...
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGUI3DENTRANCEVIEW_REPLAYTIMELINE_OFFSET UNITYSDK_OFFSET(0xCB04860)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGUI3DENTRANCEVIEW_SETSTAGE_OFFSET UNITYSDK_OFFSET(0xCB042C0)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGUI3DENTRANCEVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xCB04D80)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGUI3DENTRANCEVIEW__GETDECKID_OFFSET UNITYSDK_OFFSET(0xCB04640)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGUI3DENTRANCEVIEW__GETRANDOMDECK_OFFSET UNITYSDK_OFFSET(0xCB049C0)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGUI3DENTRANCEVIEW__GETSOLDIERMODELPATH_OFFSET UNITYSDK_OFFSET(0xCB04720)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGUI3DENTRANCEVIEW__SHOWTIMELINE_OFFSET UNITYSDK_OFFSET(0xCB04AE0)

namespace RPG::Client::ChenLingBattle
{
	inline static constexpr unsigned int ChenLingUI3DEntranceView_TypeDefinitionIndex = 75739;
