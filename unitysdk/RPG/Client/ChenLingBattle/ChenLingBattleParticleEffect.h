...
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEPARTICLEEFFECT_DESPAWNED_OFFSET UNITYSDK_OFFSET(0x9333FB0)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEPARTICLEEFFECT_ONCREATE_OFFSET UNITYSDK_OFFSET(0x9334020)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEPARTICLEEFFECT_PLAY_1_OFFSET UNITYSDK_OFFSET(0x93344B0)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEPARTICLEEFFECT_PLAY_OFFSET UNITYSDK_OFFSET(0x9334330)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEPARTICLEEFFECT_SETCAMERA_OFFSET UNITYSDK_OFFSET(0x9334240)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEPARTICLEEFFECT_SPAWNED_OFFSET UNITYSDK_OFFSET(0x9333F70)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEPARTICLEEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x93346B0)

namespace RPG::Client::ChenLingBattle
{
	inline static constexpr unsigned int ChenLingBattleParticleEffect_TypeDefinitionIndex = 62167;
