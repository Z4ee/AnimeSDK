...
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEPARTICLEEFFECT_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xB5BAAD0)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEPARTICLEEFFECT_ONCREATE_OFFSET UNITYSDK_OFFSET(0xB5BAB40)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEPARTICLEEFFECT_PLAY_1_OFFSET UNITYSDK_OFFSET(0xB5BAFB0)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEPARTICLEEFFECT_PLAY_OFFSET UNITYSDK_OFFSET(0xB5BAE40)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEPARTICLEEFFECT_SETCAMERA_OFFSET UNITYSDK_OFFSET(0xB5BAD60)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEPARTICLEEFFECT_SPAWNED_OFFSET UNITYSDK_OFFSET(0xB5BAA90)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEPARTICLEEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xB5BB1A0)

namespace RPG::Client::ChenLingBattle
{
	inline static constexpr unsigned int ChenLingBattleParticleEffect_TypeDefinitionIndex = 70978;
