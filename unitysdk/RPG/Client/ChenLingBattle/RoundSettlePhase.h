...
#define RPG_CLIENT_CHENLINGBATTLE_ROUNDSETTLEPHASE_ONENTER_OFFSET UNITYSDK_OFFSET(0x1AFDBE40)
#define RPG_CLIENT_CHENLINGBATTLE_ROUNDSETTLEPHASE_ONLEAVE_OFFSET UNITYSDK_OFFSET(0x1AFDC1C0)
#define RPG_CLIENT_CHENLINGBATTLE_ROUNDSETTLEPHASE_SWITCHTOPREPAREEDIT_OFFSET UNITYSDK_OFFSET(0x1AFDC3F0)
#define RPG_CLIENT_CHENLINGBATTLE_ROUNDSETTLEPHASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFDBE30)

namespace RPG::Client::ChenLingBattle
{
	inline static constexpr unsigned int RoundSettlePhase_TypeDefinitionIndex = 72399;
