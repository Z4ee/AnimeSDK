...
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEEFFECTCONTROLLER___C__DISPLAYCLASS7_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9F8D7F0)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEEFFECTCONTROLLER___C__DISPLAYCLASS7_0__PLAYPARTICLEEFFECTBYPATH_B__0_OFFSET UNITYSDK_OFFSET(0x9F8DF30)

namespace RPG::Client::ChenLingBattle
{
	inline static constexpr unsigned int ChenLingBattleEffectController___c__DisplayClass7_0_TypeDefinitionIndex = 70165;

	class ChenLingBattleEffectController___c__DisplayClass7_0 : public ::System::Object
	{
	public:
		::RPG::Client::ChenLingBattle::ChenLingBattleEffectController* __4__this; // 0x10
		::RPG::Client::ChenLingBattle::ChenLingBattleParticleEffect* effect; // 0x18
