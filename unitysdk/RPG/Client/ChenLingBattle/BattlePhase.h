...
class Class_1_762C8F7CCCF88C1D;
class Class_1_F65FD1783A40C6D8;
namespace RPG::Client::Promises { class IPromise; }
namespace RPG::Client::Promises { class Promise; }
namespace System { class Object; }

#define RPG_CLIENT_CHENLINGBATTLE_BATTLEPHASE_ONENTER_OFFSET UNITYSDK_OFFSET(0x931D4D0)
#define RPG_CLIENT_CHENLINGBATTLE_BATTLEPHASE_ONLEAVE_OFFSET UNITYSDK_OFFSET(0x931E050)
#define RPG_CLIENT_CHENLINGBATTLE_BATTLEPHASE_SETTLE_OFFSET UNITYSDK_OFFSET(0x931DCC0)
#define RPG_CLIENT_CHENLINGBATTLE_BATTLEPHASE__CTOR_OFFSET UNITYSDK_OFFSET(0x931D4C0)
#define RPG_CLIENT_CHENLINGBATTLE_BATTLEPHASE__HANDLEFINISHBATTLESCRSP_OFFSET UNITYSDK_OFFSET(0x931DE90)
#define RPG_CLIENT_CHENLINGBATTLE_BATTLEPHASE__ONTRANSITIONPAGEENTER_OFFSET UNITYSDK_OFFSET(0x931DB30)

namespace RPG::Client::ChenLingBattle
{
	inline static constexpr unsigned int BattlePhase_TypeDefinitionIndex = 62051;
	...
	public:
		...
		::RPG::Client::Promises::IPromise* Settle(::Class_1_762C8F7CCCF88C1D* info)
		{
			return ((::RPG::Client::Promises::IPromise*(*)(::PVOID, ::Class_1_762C8F7CCCF88C1D*))((::PBYTE)hIl2Cpp + RPG_CLIENT_CHENLINGBATTLE_BATTLEPHASE_SETTLE_OFFSET))(this, info);
		}
