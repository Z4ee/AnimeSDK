...
#define RPG_CLIENT_CHENLINGBATTLE_STAGESETTLEPHASE_ONENTER_OFFSET UNITYSDK_OFFSET(0xCB1BEE0)
#define RPG_CLIENT_CHENLINGBATTLE_STAGESETTLEPHASE_ONLEAVE_OFFSET UNITYSDK_OFFSET(0xCB1C600)
#define RPG_CLIENT_CHENLINGBATTLE_STAGESETTLEPHASE_SWITCHTOPREPAREEDIT_OFFSET UNITYSDK_OFFSET(0xCB1C7D0)
#define RPG_CLIENT_CHENLINGBATTLE_STAGESETTLEPHASE__CTOR_OFFSET UNITYSDK_OFFSET(0xCB1BED0)

namespace RPG::Client::ChenLingBattle
{
	inline static constexpr unsigned int StageSettlePhase_TypeDefinitionIndex = 75850;
