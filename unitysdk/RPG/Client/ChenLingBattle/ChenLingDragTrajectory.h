...
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGDRAGTRAJECTORY_FORCEFOLLOW_OFFSET UNITYSDK_OFFSET(0x19650FA0)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGDRAGTRAJECTORY_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1964FF80)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGDRAGTRAJECTORY_SETDRAGREGION_OFFSET UNITYSDK_OFFSET(0x19651030)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGDRAGTRAJECTORY_SETFOLLOWTARGET_OFFSET UNITYSDK_OFFSET(0x19651080)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGDRAGTRAJECTORY_SETHIGHLIGHTED_OFFSET UNITYSDK_OFFSET(0x196504A0)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGDRAGTRAJECTORY_SETSOURCE_OFFSET UNITYSDK_OFFSET(0x19650520)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGDRAGTRAJECTORY_SETTARGET_OFFSET UNITYSDK_OFFSET(0x196500C0)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGDRAGTRAJECTORY__CCTOR_OFFSET UNITYSDK_OFFSET(0x196510F0)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGDRAGTRAJECTORY__CTOR_OFFSET UNITYSDK_OFFSET(0x196510D0)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGDRAGTRAJECTORY__FOLLOW_OFFSET UNITYSDK_OFFSET(0x19650030)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGDRAGTRAJECTORY__REFRESHSTATEVIEWOFCOLOR_OFFSET UNITYSDK_OFFSET(0x196503B0)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGDRAGTRAJECTORY__REFRESHSTATEVIEW_OFFSET UNITYSDK_OFFSET(0x19650360)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGDRAGTRAJECTORY__SETTARGETFORCURVE_OFFSET UNITYSDK_OFFSET(0x19650820)

namespace RPG::Client::ChenLingBattle
{
	inline static constexpr unsigned int ChenLingDragTrajectory_TypeDefinitionIndex = 72486;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ChenLingDragTrajectory_TypeDefinitionIndex)->GetStaticField(0x13520);
		}
