...
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGDRAGTRAJECTORY_FORCEFOLLOW_OFFSET UNITYSDK_OFFSET(0xCB03CC0)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGDRAGTRAJECTORY_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xCB02CA0)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGDRAGTRAJECTORY_SETDRAGREGION_OFFSET UNITYSDK_OFFSET(0xCB03D50)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGDRAGTRAJECTORY_SETFOLLOWTARGET_OFFSET UNITYSDK_OFFSET(0xCB03DA0)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGDRAGTRAJECTORY_SETHIGHLIGHTED_OFFSET UNITYSDK_OFFSET(0xCB031C0)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGDRAGTRAJECTORY_SETSOURCE_OFFSET UNITYSDK_OFFSET(0xCB03240)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGDRAGTRAJECTORY_SETTARGET_OFFSET UNITYSDK_OFFSET(0xCB02DE0)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGDRAGTRAJECTORY__CCTOR_OFFSET UNITYSDK_OFFSET(0xCB03E10)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGDRAGTRAJECTORY__CTOR_OFFSET UNITYSDK_OFFSET(0xCB03DF0)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGDRAGTRAJECTORY__FOLLOW_OFFSET UNITYSDK_OFFSET(0xCB02D50)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGDRAGTRAJECTORY__REFRESHSTATEVIEWOFCOLOR_OFFSET UNITYSDK_OFFSET(0xCB030D0)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGDRAGTRAJECTORY__REFRESHSTATEVIEW_OFFSET UNITYSDK_OFFSET(0xCB03080)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGDRAGTRAJECTORY__SETTARGETFORCURVE_OFFSET UNITYSDK_OFFSET(0xCB03540)

namespace RPG::Client::ChenLingBattle
{
	inline static constexpr unsigned int ChenLingDragTrajectory_TypeDefinitionIndex = 75923;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ChenLingDragTrajectory_TypeDefinitionIndex)->GetStaticField(0xCBD0);
		}
