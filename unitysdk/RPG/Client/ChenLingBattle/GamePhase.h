...
#define RPG_CLIENT_CHENLINGBATTLE_GAMEPHASE_GET__GAMECONTEXT_OFFSET UNITYSDK_OFFSET(0x1AFD78D0)
#define RPG_CLIENT_CHENLINGBATTLE_GAMEPHASE_GET__NETWORKSERVICE_OFFSET UNITYSDK_OFFSET(0x1AFD7A80)
#define RPG_CLIENT_CHENLINGBATTLE_GAMEPHASE_SENDMESSAGE__OFFSET UNITYSDK_OFFSET(0x1AFD7920)
#define RPG_CLIENT_CHENLINGBATTLE_GAMEPHASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFD78C0)

namespace RPG::Client::ChenLingBattle
{
	inline static constexpr unsigned int GamePhase_TypeDefinitionIndex = 72379;
