...
#define RPG_CLIENT_CHENLINGBATTLE_PREPAREEDITPHASE___C__DISPLAYCLASS12_0__ASKWAITINGPROMISE_B__0_OFFSET UNITYSDK_OFFSET(0xB5C39D0)
#define RPG_CLIENT_CHENLINGBATTLE_PREPAREEDITPHASE___C__DISPLAYCLASS12_0__CTOR_OFFSET UNITYSDK_OFFSET(0xB5C3730)

namespace RPG::Client::ChenLingBattle
{
	inline static constexpr unsigned int PrepareEditPhase___c__DisplayClass12_0_TypeDefinitionIndex = 70879;
