...
#define RPG_CLIENT_CHENLINGBATTLE_POLICY_CREATE_OFFSET UNITYSDK_OFFSET(0x1AFD9000)
#define RPG_CLIENT_CHENLINGBATTLE_POLICY_GETDESC_OFFSET UNITYSDK_OFFSET(0x1AFD9270)
#define RPG_CLIENT_CHENLINGBATTLE_POLICY_GET_CONFIGID_OFFSET UNITYSDK_OFFSET(0x1AFD9320)
#define RPG_CLIENT_CHENLINGBATTLE_POLICY_GET_DESC_OFFSET UNITYSDK_OFFSET(0x1AFD93A0)
#define RPG_CLIENT_CHENLINGBATTLE_POLICY_GET_EFFECTID_OFFSET UNITYSDK_OFFSET(0x1AFD93C0)
#define RPG_CLIENT_CHENLINGBATTLE_POLICY_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x1AFD9360)
#define RPG_CLIENT_CHENLINGBATTLE_POLICY_GET_ICONTYPE_OFFSET UNITYSDK_OFFSET(0x1AFD9340)
#define RPG_CLIENT_CHENLINGBATTLE_POLICY_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1AFD9380)
#define RPG_CLIENT_CHENLINGBATTLE_POLICY_GET_RELATEDCARDCONFIGS_OFFSET UNITYSDK_OFFSET(0x1AFD9440)
#define RPG_CLIENT_CHENLINGBATTLE_POLICY_GET_RELATEDCARDIDS_OFFSET UNITYSDK_OFFSET(0x1AFD9420)
#define RPG_CLIENT_CHENLINGBATTLE_POLICY_GET_SKILLID_OFFSET UNITYSDK_OFFSET(0x1AFD93E0)
#define RPG_CLIENT_CHENLINGBATTLE_POLICY_GET_SKILLSOLDIERLIST_OFFSET UNITYSDK_OFFSET(0x1AFD9400)
#define RPG_CLIENT_CHENLINGBATTLE_POLICY_SET_CONFIGID_OFFSET UNITYSDK_OFFSET(0x1AFD9330)
#define RPG_CLIENT_CHENLINGBATTLE_POLICY_SET_DESC_OFFSET UNITYSDK_OFFSET(0x1AFD93B0)
#define RPG_CLIENT_CHENLINGBATTLE_POLICY_SET_EFFECTID_OFFSET UNITYSDK_OFFSET(0x1AFD93D0)
#define RPG_CLIENT_CHENLINGBATTLE_POLICY_SET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x1AFD9370)
#define RPG_CLIENT_CHENLINGBATTLE_POLICY_SET_ICONTYPE_OFFSET UNITYSDK_OFFSET(0x1AFD9350)
#define RPG_CLIENT_CHENLINGBATTLE_POLICY_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1AFD9390)
#define RPG_CLIENT_CHENLINGBATTLE_POLICY_SET_RELATEDCARDCONFIGS_OFFSET UNITYSDK_OFFSET(0x1AFD9450)
#define RPG_CLIENT_CHENLINGBATTLE_POLICY_SET_RELATEDCARDIDS_OFFSET UNITYSDK_OFFSET(0x1AFD9430)
#define RPG_CLIENT_CHENLINGBATTLE_POLICY_SET_SKILLID_OFFSET UNITYSDK_OFFSET(0x1AFD93F0)
#define RPG_CLIENT_CHENLINGBATTLE_POLICY_SET_SKILLSOLDIERLIST_OFFSET UNITYSDK_OFFSET(0x1AFD9410)
#define RPG_CLIENT_CHENLINGBATTLE_POLICY__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFD90A0)

namespace RPG::Client::ChenLingBattle
{
	inline static constexpr unsigned int Policy_TypeDefinitionIndex = 72456;
	...
	public:
		...
		::System::UInt32 _ConfigID_k__BackingField; // 0x34
		...
		::RPG::GameCore::ChenLingIconType _IconType_k__BackingField; // 0x5C
