...
#define RPG_CLIENT_CHENLINGBATTLE_ACTIONPHASE_ENTERPREVIEWMODE_OFFSET UNITYSDK_OFFSET(0xCAE93D0)
#define RPG_CLIENT_CHENLINGBATTLE_ACTIONPHASE_EXITPREVIEWMODE_OFFSET UNITYSDK_OFFSET(0xCAE9520)
#define RPG_CLIENT_CHENLINGBATTLE_ACTIONPHASE_HANDLEPENDINGACTIONFINISH_OFFSET UNITYSDK_OFFSET(0xCAE86F0)
#define RPG_CLIENT_CHENLINGBATTLE_ACTIONPHASE_ONENTER_OFFSET UNITYSDK_OFFSET(0xCAE83C0)
#define RPG_CLIENT_CHENLINGBATTLE_ACTIONPHASE_ONLEAVE_OFFSET UNITYSDK_OFFSET(0xCAE85F0)
#define RPG_CLIENT_CHENLINGBATTLE_ACTIONPHASE_REQUESTSELLHANDCARD_OFFSET UNITYSDK_OFFSET(0xCAE89A0)
#define RPG_CLIENT_CHENLINGBATTLE_ACTIONPHASE__CREATEPENDINGACTION_OFFSET UNITYSDK_OFFSET(0xCAE8500)
#define RPG_CLIENT_CHENLINGBATTLE_ACTIONPHASE__CTOR_OFFSET UNITYSDK_OFFSET(0xCAE83B0)
#define RPG_CLIENT_CHENLINGBATTLE_ACTIONPHASE__HANDLEPENDINGACTIONFINISH_B__4_0_OFFSET UNITYSDK_OFFSET(0xCAE9670)
#define RPG_CLIENT_CHENLINGBATTLE_ACTIONPHASE__ONCHENLINGSELLHANDCARDSCRSP_OFFSET UNITYSDK_OFFSET(0xCAE8BD0)

namespace RPG::Client::ChenLingBattle
{
	inline static constexpr unsigned int ActionPhase_TypeDefinitionIndex = 75809;
