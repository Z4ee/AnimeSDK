...
#define RPG_CLIENT_CHENLINGBATTLE_SHOPPHASE___C__DISPLAYCLASS11_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC338A0)
#define RPG_CLIENT_CHENLINGBATTLE_SHOPPHASE___C__DISPLAYCLASS11_0__REQUESTFINISHSHOP_B__2_OFFSET UNITYSDK_OFFSET(0x1CC33940)

namespace RPG::Client::ChenLingBattle
{
	inline static constexpr unsigned int ShopPhase___c__DisplayClass11_0_TypeDefinitionIndex = 75845;
