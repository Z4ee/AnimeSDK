...
#define RPG_CLIENT_CHENLINGBATTLE_BUILDINGCARDCONFIG_GETDESC_OFFSET UNITYSDK_OFFSET(0x9F8C650)
#define RPG_CLIENT_CHENLINGBATTLE_BUILDINGCARDCONFIG_GET_NAME_OFFSET UNITYSDK_OFFSET(0x9F8C7C0)
#define RPG_CLIENT_CHENLINGBATTLE_BUILDINGCARDCONFIG_GET_TYPENAME_OFFSET UNITYSDK_OFFSET(0x9F8C710)
#define RPG_CLIENT_CHENLINGBATTLE_BUILDINGCARDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x9F8C5B0)

namespace RPG::Client::ChenLingBattle
{
	inline static constexpr unsigned int BuildingCardConfig_TypeDefinitionIndex = 69981;
