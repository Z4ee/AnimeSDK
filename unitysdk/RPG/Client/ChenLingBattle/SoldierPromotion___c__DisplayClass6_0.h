...
#define RPG_CLIENT_CHENLINGBATTLE_SOLDIERPROMOTION___C__DISPLAYCLASS6_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1CC37640)
#define RPG_CLIENT_CHENLINGBATTLE_SOLDIERPROMOTION___C__DISPLAYCLASS6_0__GETHANDCARDAFFECTCONDITION_B__0_OFFSET UNITYSDK_OFFSET(0x1CC37D10)
#define RPG_CLIENT_CHENLINGBATTLE_SOLDIERPROMOTION___C__DISPLAYCLASS6_0__GETHANDCARDAFFECTCONDITION_B__1_OFFSET UNITYSDK_OFFSET(0x1CC37E10)
#define RPG_CLIENT_CHENLINGBATTLE_SOLDIERPROMOTION___C__DISPLAYCLASS6_0__GETHANDCARDAFFECTCONDITION_B__2_OFFSET UNITYSDK_OFFSET(0x1CC37F10)

namespace RPG::Client::ChenLingBattle
{
	inline static constexpr unsigned int SoldierPromotion___c__DisplayClass6_0_TypeDefinitionIndex = 75898;
