...
#define RPG_CLIENT_CHENLINGBATTLE_MAGICCARDCONFIG_GETDESC_OFFSET UNITYSDK_OFFSET(0x1AFD8C80)
#define RPG_CLIENT_CHENLINGBATTLE_MAGICCARDCONFIG_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1AFD8E20)
#define RPG_CLIENT_CHENLINGBATTLE_MAGICCARDCONFIG_GET_TYPENAME_OFFSET UNITYSDK_OFFSET(0x1AFD8D70)
#define RPG_CLIENT_CHENLINGBATTLE_MAGICCARDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFD8BC0)

namespace RPG::Client::ChenLingBattle
{
	inline static constexpr unsigned int MagicCardConfig_TypeDefinitionIndex = 72307;
