...
#define RPG_CLIENT_CHENLINGBATTLE_SELECTPOLICYPREVIEWSNAPSHOT_CREATESELECTPOLICYSNAPSHOT_OFFSET UNITYSDK_OFFSET(0x1AFE1D70)
#define RPG_CLIENT_CHENLINGBATTLE_SELECTPOLICYPREVIEWSNAPSHOT_GET_PHASEINFO_OFFSET UNITYSDK_OFFSET(0x1AFE1E00)
#define RPG_CLIENT_CHENLINGBATTLE_SELECTPOLICYPREVIEWSNAPSHOT_SET_PHASEINFO_OFFSET UNITYSDK_OFFSET(0x1AFE1E10)
#define RPG_CLIENT_CHENLINGBATTLE_SELECTPOLICYPREVIEWSNAPSHOT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFE1DF0)

namespace RPG::Client::ChenLingBattle
{
	inline static constexpr unsigned int SelectPolicyPreviewSnapshot_TypeDefinitionIndex = 72382;
