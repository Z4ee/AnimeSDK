...
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEGAMESESSION___C__DISPLAYCLASS43_0__CTOR_OFFSET UNITYSDK_OFFSET(0x932E5F0)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEGAMESESSION___C__DISPLAYCLASS43_0__GETSOLDIERBYCONFIGID_B__0_OFFSET UNITYSDK_OFFSET(0x9333BF0)

namespace RPG::Client::ChenLingBattle
{
	inline static constexpr unsigned int ChenLingBattleGameSession___c__DisplayClass43_0_TypeDefinitionIndex = 62094;
