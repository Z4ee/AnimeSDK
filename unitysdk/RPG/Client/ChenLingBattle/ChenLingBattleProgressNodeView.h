...
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEPROGRESSNODEVIEW_SAFESETACTIVE_OFFSET UNITYSDK_OFFSET(0xCB02430)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEPROGRESSNODEVIEW_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0xCB02490)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEPROGRESSNODEVIEW__CLEAR_OFFSET UNITYSDK_OFFSET(0xCB02270)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEPROGRESSNODEVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xCB02600)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEPROGRESSNODEVIEW__SETDOINGSTATE_OFFSET UNITYSDK_OFFSET(0xCB022E0)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEPROGRESSNODEVIEW__SETDONESTATE_OFFSET UNITYSDK_OFFSET(0xCB02390)

namespace RPG::Client::ChenLingBattle
{
	inline static constexpr unsigned int ChenLingBattleProgressNodeView_TypeDefinitionIndex = 75921;
