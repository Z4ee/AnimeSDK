...
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEPROGRESSNODEVIEW_SAFESETACTIVE_OFFSET UNITYSDK_OFFSET(0x1B955C20)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEPROGRESSNODEVIEW_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0x1B955C80)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEPROGRESSNODEVIEW__CLEAR_OFFSET UNITYSDK_OFFSET(0x1B955A60)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEPROGRESSNODEVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B955DF0)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEPROGRESSNODEVIEW__SETDOINGSTATE_OFFSET UNITYSDK_OFFSET(0x1B955AD0)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEPROGRESSNODEVIEW__SETDONESTATE_OFFSET UNITYSDK_OFFSET(0x1B955B80)

namespace RPG::Client::ChenLingBattle
{
	inline static constexpr unsigned int ChenLingBattleProgressNodeView_TypeDefinitionIndex = 75920;
