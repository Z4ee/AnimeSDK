...
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEGAMEFLOW___C__DISPLAYCLASS16_0__CTOR_OFFSET UNITYSDK_OFFSET(0xCAF2160)
#define RPG_CLIENT_CHENLINGBATTLE_CHENLINGBATTLEGAMEFLOW___C__DISPLAYCLASS16_0___SHOWBLACKDIALOGWAITCLOSE_B__0_OFFSET UNITYSDK_OFFSET(0xCAF2690)

namespace RPG::Client::ChenLingBattle
{
	inline static constexpr unsigned int ChenLingBattleGameFlow___c__DisplayClass16_0_TypeDefinitionIndex = 75759;
