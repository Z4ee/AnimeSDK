...
#define RPG_CLIENT_SHOWMATCHTHREEV2LEVELPREPAREPAGE_METHOD_3_ED37FBCAE66DFCFB_OFFSET UNITYSDK_OFFSET(0x1B9F1EE0)
#define RPG_CLIENT_SHOWMATCHTHREEV2LEVELPREPAREPAGE_METHOD_3_F4F121E010CEEA18_OFFSET UNITYSDK_OFFSET(0x1B9F1EA0)
#define RPG_CLIENT_SHOWMATCHTHREEV2LEVELPREPAREPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9F1ED0)

namespace RPG::Client
{
	inline static constexpr unsigned int ShowMatchThreeV2LevelPreparePage_TypeDefinitionIndex = 9942;
