...
#define RPG_CLIENT_SHOWMATCHTHREEV2LEVELPREPAREPAGE_METHOD_3_7D5A9D8938B0BA9D_OFFSET UNITYSDK_OFFSET(0x193BEFD0)
#define RPG_CLIENT_SHOWMATCHTHREEV2LEVELPREPAREPAGE_METHOD_3_ED37FBCAE66DFCFB_OFFSET UNITYSDK_OFFSET(0x193BF050)
#define RPG_CLIENT_SHOWMATCHTHREEV2LEVELPREPAREPAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x193BF020)

namespace RPG::Client
{
	inline static constexpr unsigned int ShowMatchThreeV2LevelPreparePage_TypeDefinitionIndex = 9927;
