...
#define RPG_CLIENT_PREFS___C__DISPLAYCLASS18_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE20CC0)
#define RPG_CLIENT_PREFS___C__DISPLAYCLASS18_0__RECOVERFROMCLOUD_B__0_OFFSET UNITYSDK_OFFSET(0x1AE20CD0)

namespace RPG::Client
{
	inline static constexpr unsigned int Prefs___c__DisplayClass18_0_TypeDefinitionIndex = 59498;
