...
#define RPG_CLIENT_EFFECT_RENDERERMATBACKWARDMONOPLUGIN_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x15125160)
#define RPG_CLIENT_EFFECT_RENDERERMATBACKWARDMONOPLUGIN_PAUSE_OFFSET UNITYSDK_OFFSET(0x15124F40)
#define RPG_CLIENT_EFFECT_RENDERERMATBACKWARDMONOPLUGIN_PLAYBACKWARD_OFFSET UNITYSDK_OFFSET(0x15125000)
#define RPG_CLIENT_EFFECT_RENDERERMATBACKWARDMONOPLUGIN_PLAYFORWARD_OFFSET UNITYSDK_OFFSET(0x151250C0)
#define RPG_CLIENT_EFFECT_RENDERERMATBACKWARDMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x151251B0)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_RendererMatBackwardMonoPlugin_TypeDefinitionIndex = 67389;
