...
#define RPG_CLIENT_EFFECT_RENDERERMATBACKWARDMONOPLUGIN_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x15E96520)
#define RPG_CLIENT_EFFECT_RENDERERMATBACKWARDMONOPLUGIN_PAUSE_OFFSET UNITYSDK_OFFSET(0x15E96300)
#define RPG_CLIENT_EFFECT_RENDERERMATBACKWARDMONOPLUGIN_PLAYBACKWARD_OFFSET UNITYSDK_OFFSET(0x15E963C0)
#define RPG_CLIENT_EFFECT_RENDERERMATBACKWARDMONOPLUGIN_PLAYFORWARD_OFFSET UNITYSDK_OFFSET(0x15E96480)
#define RPG_CLIENT_EFFECT_RENDERERMATBACKWARDMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x15E96570)
