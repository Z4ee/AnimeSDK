...
#define RPG_CLIENT_ONSCENEOPERATIONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x191CED70)
#define RPG_CLIENT_ONSCENEOPERATIONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x191CEDA0)
#define RPG_CLIENT_ONSCENEOPERATIONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x191CED60)
#define RPG_CLIENT_ONSCENEOPERATIONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x191CEC70)

namespace RPG::Client
{
	inline static constexpr unsigned int OnSceneOperationDelegate_TypeDefinitionIndex = 59574;
