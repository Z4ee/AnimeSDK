...
#define RPG_CLIENT_ONSCENEOPERATIONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xD9E2940)
#define RPG_CLIENT_ONSCENEOPERATIONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xD9E2970)
#define RPG_CLIENT_ONSCENEOPERATIONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0xD9E2930)
#define RPG_CLIENT_ONSCENEOPERATIONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0xD9E2840)
