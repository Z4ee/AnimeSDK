...
#define RPG_CLIENT_COMPANIONMISSIONACTIVITYDATA_ISEXTRACONDSATISFY_OFFSET UNITYSDK_OFFSET(0x1A284150)
#define RPG_CLIENT_COMPANIONMISSIONACTIVITYDATA_ISSHOWNORMALREDDOT_OFFSET UNITYSDK_OFFSET(0x1A284090)
#define RPG_CLIENT_COMPANIONMISSIONACTIVITYDATA__ADDNOTIFYHANDLERS_OFFSET UNITYSDK_OFFSET(0x1A283F80)
#define RPG_CLIENT_COMPANIONMISSIONACTIVITYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A283F60)
#define RPG_CLIENT_COMPANIONMISSIONACTIVITYDATA__ISEXTRACONDSATISFY_B__2_0_OFFSET UNITYSDK_OFFSET(0x1A2847D0)
#define RPG_CLIENT_COMPANIONMISSIONACTIVITYDATA__ONCOMPANIONACTIVITYBANNERUPDATE_OFFSET UNITYSDK_OFFSET(0x1A284380)
#define RPG_CLIENT_COMPANIONMISSIONACTIVITYDATA__UPDATEMAINMISSIONDATA_OFFSET UNITYSDK_OFFSET(0x1A2843E0)
#define RPG_CLIENT_COMPANIONMISSIONACTIVITYDATA___UPDATEMAINMISSIONDATA_B__5_0_OFFSET UNITYSDK_OFFSET(0x1A2847E0)

namespace RPG::Client
{
	inline static constexpr unsigned int CompanionMissionActivityData_TypeDefinitionIndex = 61700;
