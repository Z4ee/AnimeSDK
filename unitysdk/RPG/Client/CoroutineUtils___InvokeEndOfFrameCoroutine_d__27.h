...
#define RPG_CLIENT_COROUTINEUTILS___INVOKEENDOFFRAMECOROUTINE_D__27_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1ACA29B0)
#define RPG_CLIENT_COROUTINEUTILS___INVOKEENDOFFRAMECOROUTINE_D__27_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1ACA2A40)
#define RPG_CLIENT_COROUTINEUTILS___INVOKEENDOFFRAMECOROUTINE_D__27_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1ACA2AA0)
#define RPG_CLIENT_COROUTINEUTILS___INVOKEENDOFFRAMECOROUTINE_D__27_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1ACA2A50)
#define RPG_CLIENT_COROUTINEUTILS___INVOKEENDOFFRAMECOROUTINE_D__27_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1ACA29A0)
#define RPG_CLIENT_COROUTINEUTILS___INVOKEENDOFFRAMECOROUTINE_D__27__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACA1F20)

namespace RPG::Client
{
	inline static constexpr unsigned int CoroutineUtils___InvokeEndOfFrameCoroutine_d__27_TypeDefinitionIndex = 33805;
