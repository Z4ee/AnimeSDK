...
#define RPG_CLIENT_COROUTINEUTILS___INVOKEENDOFFRAMECOROUTINE_D__27_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1E58EA80)
#define RPG_CLIENT_COROUTINEUTILS___INVOKEENDOFFRAMECOROUTINE_D__27_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1E58EB10)
#define RPG_CLIENT_COROUTINEUTILS___INVOKEENDOFFRAMECOROUTINE_D__27_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1E58EB70)
#define RPG_CLIENT_COROUTINEUTILS___INVOKEENDOFFRAMECOROUTINE_D__27_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1E58EB20)
#define RPG_CLIENT_COROUTINEUTILS___INVOKEENDOFFRAMECOROUTINE_D__27_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E58EA70)
#define RPG_CLIENT_COROUTINEUTILS___INVOKEENDOFFRAMECOROUTINE_D__27__CTOR_OFFSET UNITYSDK_OFFSET(0x1E58DFC0)
