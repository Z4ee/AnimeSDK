...
#define RPG_CLIENT_MONOPOLYPLAYERHEADICONCONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0xAABCAA0)
#define RPG_CLIENT_MONOPOLYPLAYERHEADICONCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0xAABBD50)
#define RPG_CLIENT_MONOPOLYPLAYERHEADICONCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xAABC0B0)
#define RPG_CLIENT_MONOPOLYPLAYERHEADICONCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAABCAF0)
#define RPG_CLIENT_MONOPOLYPLAYERHEADICONCONTROLLER__GETHEADICONSCPOS_OFFSET UNITYSDK_OFFSET(0xAABC6B0)
#define RPG_CLIENT_MONOPOLYPLAYERHEADICONCONTROLLER__GETSCREENCOORDINATEVALUE_OFFSET UNITYSDK_OFFSET(0xAABBEC0)
#define RPG_CLIENT_MONOPOLYPLAYERHEADICONCONTROLLER__ISPLAYERINSCREEN_OFFSET UNITYSDK_OFFSET(0xAABC2D0)
#define RPG_CLIENT_MONOPOLYPLAYERHEADICONCONTROLLER__ROTATEICON_OFFSET UNITYSDK_OFFSET(0xAABC7A0)
#define RPG_CLIENT_MONOPOLYPLAYERHEADICONCONTROLLER__UPDATEPLAYERICONPOS_OFFSET UNITYSDK_OFFSET(0xAABC350)

namespace RPG::Client
{
	inline static constexpr unsigned int MonopolyPlayerHeadIconController_TypeDefinitionIndex = 67104;
