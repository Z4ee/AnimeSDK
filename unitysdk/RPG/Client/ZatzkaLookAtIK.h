...
#define RPG_CLIENT_ZATZKALOOKATIK_AWAKE_OFFSET UNITYSDK_OFFSET(0xE443320)
#define RPG_CLIENT_ZATZKALOOKATIK_GET_ISPROCESSABLE_OFFSET UNITYSDK_OFFSET(0xE442FB0)
#define RPG_CLIENT_ZATZKALOOKATIK_METHOD_5_01244C5D42565CB2_OFFSET UNITYSDK_OFFSET(0xE443070)
#define RPG_CLIENT_ZATZKALOOKATIK_METHOD_5_18D9238B9C310BFF_OFFSET UNITYSDK_OFFSET(0xE444D90)
#define RPG_CLIENT_ZATZKALOOKATIK_METHOD_5_18DC899D74EF7F38_OFFSET UNITYSDK_OFFSET(0xE445500)
#define RPG_CLIENT_ZATZKALOOKATIK_METHOD_5_2EDAC8CAFF864AE8_OFFSET UNITYSDK_OFFSET(0xE444860)
#define RPG_CLIENT_ZATZKALOOKATIK_METHOD_5_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0xE442ED0)
#define RPG_CLIENT_ZATZKALOOKATIK_METHOD_5_35014F67085C0F4E_OFFSET UNITYSDK_OFFSET(0xE444E10)
#define RPG_CLIENT_ZATZKALOOKATIK_METHOD_5_479759059E440327_OFFSET UNITYSDK_OFFSET(0xE4453C0)
#define RPG_CLIENT_ZATZKALOOKATIK_METHOD_5_4BD1DD9FEF3B7862_OFFSET UNITYSDK_OFFSET(0xE4438F0)
#define RPG_CLIENT_ZATZKALOOKATIK_METHOD_5_4FD079E562D79666_OFFSET UNITYSDK_OFFSET(0xE445150)
#define RPG_CLIENT_ZATZKALOOKATIK_METHOD_5_5323F2DF46A044DA_OFFSET UNITYSDK_OFFSET(0xE442C80)
#define RPG_CLIENT_ZATZKALOOKATIK_METHOD_5_5688F408AF8BA5A8_OFFSET UNITYSDK_OFFSET(0xE444920)
#define RPG_CLIENT_ZATZKALOOKATIK_METHOD_5_602B796CAD5DBEDB_OFFSET UNITYSDK_OFFSET(0xE4436E0)
#define RPG_CLIENT_ZATZKALOOKATIK_METHOD_5_627557CE4CD0ABB4_OFFSET UNITYSDK_OFFSET(0xE444A60)
#define RPG_CLIENT_ZATZKALOOKATIK_METHOD_5_7B5CF29097D2700A_OFFSET UNITYSDK_OFFSET(0xE445470)
#define RPG_CLIENT_ZATZKALOOKATIK_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xE442F50)
#define RPG_CLIENT_ZATZKALOOKATIK_METHOD_5_9AAFA20BE473DBC6_OFFSET UNITYSDK_OFFSET(0xE445E30)
#define RPG_CLIENT_ZATZKALOOKATIK_METHOD_5_9FBCB7EE3738DEA4_OFFSET UNITYSDK_OFFSET(0xE443D00)
#define RPG_CLIENT_ZATZKALOOKATIK_METHOD_5_A0278AEAAD5BAD20_OFFSET UNITYSDK_OFFSET(0xE443F10)
#define RPG_CLIENT_ZATZKALOOKATIK_METHOD_5_A534811CDDC793A9_1_OFFSET UNITYSDK_OFFSET(0xE445970)
#define RPG_CLIENT_ZATZKALOOKATIK_METHOD_5_A534811CDDC793A9_OFFSET UNITYSDK_OFFSET(0xE445770)
#define RPG_CLIENT_ZATZKALOOKATIK_METHOD_5_D62EA523FA1B6C95_OFFSET UNITYSDK_OFFSET(0xE445B70)
#define RPG_CLIENT_ZATZKALOOKATIK_METHOD_5_D8419A5DEE512C03_OFFSET UNITYSDK_OFFSET(0xE444B30)
#define RPG_CLIENT_ZATZKALOOKATIK_METHOD_5_DB11C736C0498425_1_OFFSET UNITYSDK_OFFSET(0xE4461C0)
#define RPG_CLIENT_ZATZKALOOKATIK_METHOD_5_DB11C736C0498425_OFFSET UNITYSDK_OFFSET(0xE444D00)
#define RPG_CLIENT_ZATZKALOOKATIK_METHOD_5_ECF5752EC6D68585_OFFSET UNITYSDK_OFFSET(0xE445DA0)
#define RPG_CLIENT_ZATZKALOOKATIK_METHOD_5_F0BD65B017F2AC0B_OFFSET UNITYSDK_OFFSET(0xE443570)
#define RPG_CLIENT_ZATZKALOOKATIK_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xE4433F0)
#define RPG_CLIENT_ZATZKALOOKATIK_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xE4433B0)
#define RPG_CLIENT_ZATZKALOOKATIK_ONENABLE_OFFSET UNITYSDK_OFFSET(0xE443370)
#define RPG_CLIENT_ZATZKALOOKATIK_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0xE443450)
#define RPG_CLIENT_ZATZKALOOKATIK_PROCESS_OFFSET UNITYSDK_OFFSET(0xE443010)
#define RPG_CLIENT_ZATZKALOOKATIK_SAFEINIT_OFFSET UNITYSDK_OFFSET(0xE442C90)
#define RPG_CLIENT_ZATZKALOOKATIK__CTOR_OFFSET UNITYSDK_OFFSET(0xE446230)
