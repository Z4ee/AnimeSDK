...
#define RPG_CLIENT_ACTIONSKILLNOTIFY__CTOR_OFFSET UNITYSDK_OFFSET(0x8ECF000)

namespace RPG::Client
{
	inline static constexpr unsigned int ActionSkillNotify_TypeDefinitionIndex = 59264;
