...
#define RPG_CLIENT_STATERUNBSSTEP_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0xA4DC6F0)
#define RPG_CLIENT_STATERUNBSSTEP_ONSTATEEXIT_OFFSET UNITYSDK_OFFSET(0xA4DC7F0)
#define RPG_CLIENT_STATERUNBSSTEP__CTOR_OFFSET UNITYSDK_OFFSET(0xA4DCB30)
#define RPG_CLIENT_STATERUNBSSTEP___IFIXBASEPROXY_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0xA4DCB40)
#define RPG_CLIENT_STATERUNBSSTEP___IFIXBASEPROXY_ONSTATEEXIT_OFFSET UNITYSDK_OFFSET(0xA4DCB50)

namespace RPG::Client
{
	inline static constexpr unsigned int StateRunBSStep_TypeDefinitionIndex = 56238;
