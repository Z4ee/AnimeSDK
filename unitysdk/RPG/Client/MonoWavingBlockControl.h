...
#define RPG_CLIENT_MONOWAVINGBLOCKCONTROL_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A367A90)
#define RPG_CLIENT_MONOWAVINGBLOCKCONTROL_METHOD_5_6AC0B31DB7C5670D_OFFSET UNITYSDK_OFFSET(0x1A367D40)
#define RPG_CLIENT_MONOWAVINGBLOCKCONTROL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A367CB0)
#define RPG_CLIENT_MONOWAVINGBLOCKCONTROL_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A367B10)
#define RPG_CLIENT_MONOWAVINGBLOCKCONTROL_SETFLOORID_OFFSET UNITYSDK_OFFSET(0x1A367BA0)
#define RPG_CLIENT_MONOWAVINGBLOCKCONTROL_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A367C50)
#define RPG_CLIENT_MONOWAVINGBLOCKCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A367DA0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoWavingBlockControl_TypeDefinitionIndex = 67588;
