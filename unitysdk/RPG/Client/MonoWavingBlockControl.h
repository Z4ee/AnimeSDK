...
#define RPG_CLIENT_MONOWAVINGBLOCKCONTROL_AWAKE_OFFSET UNITYSDK_OFFSET(0xC160AE0)
#define RPG_CLIENT_MONOWAVINGBLOCKCONTROL_METHOD_5_6AC0B31DB7C5670D_OFFSET UNITYSDK_OFFSET(0xC160D90)
#define RPG_CLIENT_MONOWAVINGBLOCKCONTROL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC160D00)
#define RPG_CLIENT_MONOWAVINGBLOCKCONTROL_ONENABLE_OFFSET UNITYSDK_OFFSET(0xC160B60)
#define RPG_CLIENT_MONOWAVINGBLOCKCONTROL_SETFLOORID_OFFSET UNITYSDK_OFFSET(0xC160BF0)
#define RPG_CLIENT_MONOWAVINGBLOCKCONTROL_UPDATE_OFFSET UNITYSDK_OFFSET(0xC160CA0)
#define RPG_CLIENT_MONOWAVINGBLOCKCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC160DF0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoWavingBlockControl_TypeDefinitionIndex = 66163;
