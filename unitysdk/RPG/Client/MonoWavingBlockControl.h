...
class Class_2_354EF5BB3E2AA1B6;
namespace RPG::Client { class MatCustomDictionay; }
namespace UnityEngine { class AnimationCurve; }
namespace UnityEngine { class GameObject; }
namespace UnityEngine { class Renderer; }

#define RPG_CLIENT_MONOWAVINGBLOCKCONTROL_AWAKE_OFFSET UNITYSDK_OFFSET(0xAA12000)
#define RPG_CLIENT_MONOWAVINGBLOCKCONTROL_METHOD_5_8C945585B4A8C17B_OFFSET UNITYSDK_OFFSET(0xAA122B0)
#define RPG_CLIENT_MONOWAVINGBLOCKCONTROL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xAA12220)
#define RPG_CLIENT_MONOWAVINGBLOCKCONTROL_ONENABLE_OFFSET UNITYSDK_OFFSET(0xAA12080)
#define RPG_CLIENT_MONOWAVINGBLOCKCONTROL_SETFLOORID_OFFSET UNITYSDK_OFFSET(0xAA12110)
#define RPG_CLIENT_MONOWAVINGBLOCKCONTROL_UPDATE_OFFSET UNITYSDK_OFFSET(0xAA121C0)
#define RPG_CLIENT_MONOWAVINGBLOCKCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xAA12310)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoWavingBlockControl_TypeDefinitionIndex = 65236;
	...
	public:
		...
		::Class_2_354EF5BB3E2AA1B6* _Behavior; // 0x88
		...
		::System::Void Method_5_8C945585B4A8C17B()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_MONOWAVINGBLOCKCONTROL_METHOD_5_8C945585B4A8C17B_OFFSET))(this);
		}
	};
}
