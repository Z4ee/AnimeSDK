...
#define RPG_CLIENT_MONOWAVINGBLOCKCONTROL_AWAKE_OFFSET UNITYSDK_OFFSET(0x9D4EE80)
#define RPG_CLIENT_MONOWAVINGBLOCKCONTROL_METHOD_5_8C945585B4A8C17B_OFFSET UNITYSDK_OFFSET(0x9D4F130)
#define RPG_CLIENT_MONOWAVINGBLOCKCONTROL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9D4F0A0)
#define RPG_CLIENT_MONOWAVINGBLOCKCONTROL_ONENABLE_OFFSET UNITYSDK_OFFSET(0x9D4EF00)
#define RPG_CLIENT_MONOWAVINGBLOCKCONTROL_SETFLOORID_OFFSET UNITYSDK_OFFSET(0x9D4EF90)
#define RPG_CLIENT_MONOWAVINGBLOCKCONTROL_UPDATE_OFFSET UNITYSDK_OFFSET(0x9D4F040)
#define RPG_CLIENT_MONOWAVINGBLOCKCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x9D4F190)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoWavingBlockControl_TypeDefinitionIndex = 57949;
