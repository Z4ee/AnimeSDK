...
#define RPG_CLIENT_PETMODULE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17F4CAE0)
#define RPG_CLIENT_PETMODULE_GETPETIDBYITEMID_OFFSET UNITYSDK_OFFSET(0x17F4E6B0)
#define RPG_CLIENT_PETMODULE_GET_CURPET_OFFSET UNITYSDK_OFFSET(0x17F4D1A0)
#define RPG_CLIENT_PETMODULE_GET_ISPETLOCKED_OFFSET UNITYSDK_OFFSET(0x17F4D1E0)
#define RPG_CLIENT_PETMODULE_INIT_OFFSET UNITYSDK_OFFSET(0x17F4CA20)
#define RPG_CLIENT_PETMODULE_ISPETSUMMONED_OFFSET UNITYSDK_OFFSET(0x17F4D110)
#define RPG_CLIENT_PETMODULE_RECALLPET_OFFSET UNITYSDK_OFFSET(0x17F4CF60)
#define RPG_CLIENT_PETMODULE_SUMMONPET_OFFSET UNITYSDK_OFFSET(0x17F4D030)
#define RPG_CLIENT_PETMODULE_TRYHIDEPET_OFFSET UNITYSDK_OFFSET(0x17F4D240)
#define RPG_CLIENT_PETMODULE_TRYSHOWPET_OFFSET UNITYSDK_OFFSET(0x17F4D290)
#define RPG_CLIENT_PETMODULE_USEPETITEM_OFFSET UNITYSDK_OFFSET(0x17F4CED0)
#define RPG_CLIENT_PETMODULE__ADDNOTIFYHANDLERS_OFFSET UNITYSDK_OFFSET(0x17F4CB70)
#define RPG_CLIENT_PETMODULE__ADDPACKETHANDLERS_OFFSET UNITYSDK_OFFSET(0x17F4D2E0)
#define RPG_CLIENT_PETMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0x17F4E700)
#define RPG_CLIENT_PETMODULE__GETPETNAMEBYPETID_OFFSET UNITYSDK_OFFSET(0x17F4E000)
#define RPG_CLIENT_PETMODULE__LOADNEWPET_OFFSET UNITYSDK_OFFSET(0x17F4DC40)
#define RPG_CLIENT_PETMODULE__ONCMDRECALLPETSCRSP_OFFSET UNITYSDK_OFFSET(0x17F4DE20)
#define RPG_CLIENT_PETMODULE__ONCMDSUMMONPETSCRSP_OFFSET UNITYSDK_OFFSET(0x17F4DAA0)
#define RPG_CLIENT_PETMODULE__ONEXITGAMEPHOTOGRAPHCAMERA_OFFSET UNITYSDK_OFFSET(0x17F4E650)
#define RPG_CLIENT_PETMODULE__ONGETPETDATASCRSP_OFFSET UNITYSDK_OFFSET(0x17F4D510)
#define RPG_CLIENT_PETMODULE__ONPETITEMDEL_OFFSET UNITYSDK_OFFSET(0x17F4E190)
#define RPG_CLIENT_PETMODULE__ONSHOWFAKEAVATAR_OFFSET UNITYSDK_OFFSET(0x17F4E530)
#define RPG_CLIENT_PETMODULE__ONSHOWGAMEPHOTOGRAPHCAMERA_OFFSET UNITYSDK_OFFSET(0x17F4E5F0)
#define RPG_CLIENT_PETMODULE__ONSHOWREALAVATAR_OFFSET UNITYSDK_OFFSET(0x17F4E590)
#define RPG_CLIENT_PETMODULE__ONTRYSHOWORHIDEPET_OFFSET UNITYSDK_OFFSET(0x17F4E390)
#define RPG_CLIENT_PETMODULE__TRYGETPETIDBYITEMID_OFFSET UNITYSDK_OFFSET(0x17F4D8B0)
#define RPG_CLIENT_PETMODULE__TRYRECALLCURPET_OFFSET UNITYSDK_OFFSET(0x17F4D740)

namespace RPG::Client
{
	inline static constexpr unsigned int PetModule_TypeDefinitionIndex = 63503;

	class PetModule : public ::RPG::Client::BaseModule
	{
	public:
		::Class_1_4B67E46515ECF7E0* _Lock; // 0x10
