...
#define RPG_CLIENT_COMBATPOWERUTILS_GETMONSTERCOMBATPOWERRATIO_OFFSET UNITYSDK_OFFSET(0x9403970)

namespace RPG::Client
{
	inline static constexpr unsigned int CombatPowerUtils_TypeDefinitionIndex = 50786;
