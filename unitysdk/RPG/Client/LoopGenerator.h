...
#define RPG_CLIENT_LOOPGENERATOR_AWAKE_OFFSET UNITYSDK_OFFSET(0x17482D10)
#define RPG_CLIENT_LOOPGENERATOR_COLLECTALLREFASSETPATH_OFFSET UNITYSDK_OFFSET(0x17482A90)
#define RPG_CLIENT_LOOPGENERATOR_GET_TIMESCALE_OFFSET UNITYSDK_OFFSET(0x17482B20)
#define RPG_CLIENT_LOOPGENERATOR_METHOD_5_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x174847F0)
#define RPG_CLIENT_LOOPGENERATOR_METHOD_5_44E2E78A5C2D0384_OFFSET UNITYSDK_OFFSET(0x17484270)
#define RPG_CLIENT_LOOPGENERATOR_METHOD_5_45FDB639B4E97210_OFFSET UNITYSDK_OFFSET(0x17483220)
#define RPG_CLIENT_LOOPGENERATOR_METHOD_5_77577333B4681208_OFFSET UNITYSDK_OFFSET(0x17482C70)
#define RPG_CLIENT_LOOPGENERATOR_METHOD_5_879E4116B6BD3AF1_OFFSET UNITYSDK_OFFSET(0x17484C00)
#define RPG_CLIENT_LOOPGENERATOR_METHOD_5_9D81CE85FF63522D_OFFSET UNITYSDK_OFFSET(0x17484860)
#define RPG_CLIENT_LOOPGENERATOR_METHOD_5_B357AE5DB3A8BC4F_OFFSET UNITYSDK_OFFSET(0x17484920)
#define RPG_CLIENT_LOOPGENERATOR_METHOD_5_E10635F67939DD2E_OFFSET UNITYSDK_OFFSET(0x17483FC0)
#define RPG_CLIENT_LOOPGENERATOR_METHOD_5_E960A56BD2EFC162_OFFSET UNITYSDK_OFFSET(0x17482B40)
#define RPG_CLIENT_LOOPGENERATOR_METHOD_5_FF7B2911BBACA4A9_OFFSET UNITYSDK_OFFSET(0x17482BF0)
#define RPG_CLIENT_LOOPGENERATOR_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x17483DF0)
#define RPG_CLIENT_LOOPGENERATOR_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x17483970)
#define RPG_CLIENT_LOOPGENERATOR_ONENABLE_OFFSET UNITYSDK_OFFSET(0x17483140)
#define RPG_CLIENT_LOOPGENERATOR_RELEASEALLSLIDERS_OFFSET UNITYSDK_OFFSET(0x174839C0)
#define RPG_CLIENT_LOOPGENERATOR_RESETSTATE_OFFSET UNITYSDK_OFFSET(0x17483010)
#define RPG_CLIENT_LOOPGENERATOR_SETTEMPSPEED_OFFSET UNITYSDK_OFFSET(0x174853B0)
#define RPG_CLIENT_LOOPGENERATOR_SET_TIMESCALE_OFFSET UNITYSDK_OFFSET(0x17482B30)
#define RPG_CLIENT_LOOPGENERATOR_SWITCHCONFIG_OFFSET UNITYSDK_OFFSET(0x174850A0)
#define RPG_CLIENT_LOOPGENERATOR_UPDATE_OFFSET UNITYSDK_OFFSET(0x174831B0)
#define RPG_CLIENT_LOOPGENERATOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x174855A0)
#define RPG_CLIENT_LOOPGENERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x17485410)

namespace RPG::Client
{
	inline static constexpr unsigned int LoopGenerator_TypeDefinitionIndex = 72886;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LoopGenerator_TypeDefinitionIndex)->GetStaticField(0x148D0);
		}
