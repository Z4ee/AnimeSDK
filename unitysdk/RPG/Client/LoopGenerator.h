...
#define RPG_CLIENT_LOOPGENERATOR_AWAKE_OFFSET UNITYSDK_OFFSET(0x15BE9ED0)
#define RPG_CLIENT_LOOPGENERATOR_COLLECTALLREFASSETPATH_OFFSET UNITYSDK_OFFSET(0x15BE9C50)
#define RPG_CLIENT_LOOPGENERATOR_GET_TIMESCALE_OFFSET UNITYSDK_OFFSET(0x15BE9CE0)
#define RPG_CLIENT_LOOPGENERATOR_METHOD_5_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x15BEB9B0)
#define RPG_CLIENT_LOOPGENERATOR_METHOD_5_44E2E78A5C2D0384_OFFSET UNITYSDK_OFFSET(0x15BEB430)
#define RPG_CLIENT_LOOPGENERATOR_METHOD_5_45FDB639B4E97210_OFFSET UNITYSDK_OFFSET(0x15BEA3E0)
#define RPG_CLIENT_LOOPGENERATOR_METHOD_5_77577333B4681208_OFFSET UNITYSDK_OFFSET(0x15BE9E30)
#define RPG_CLIENT_LOOPGENERATOR_METHOD_5_879E4116B6BD3AF1_OFFSET UNITYSDK_OFFSET(0x15BEBDC0)
#define RPG_CLIENT_LOOPGENERATOR_METHOD_5_9D81CE85FF63522D_OFFSET UNITYSDK_OFFSET(0x15BEBA20)
#define RPG_CLIENT_LOOPGENERATOR_METHOD_5_B357AE5DB3A8BC4F_OFFSET UNITYSDK_OFFSET(0x15BEBAE0)
#define RPG_CLIENT_LOOPGENERATOR_METHOD_5_E10635F67939DD2E_OFFSET UNITYSDK_OFFSET(0x15BEB180)
#define RPG_CLIENT_LOOPGENERATOR_METHOD_5_E960A56BD2EFC162_OFFSET UNITYSDK_OFFSET(0x15BE9D00)
#define RPG_CLIENT_LOOPGENERATOR_METHOD_5_FF7B2911BBACA4A9_OFFSET UNITYSDK_OFFSET(0x15BE9DB0)
#define RPG_CLIENT_LOOPGENERATOR_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x15BEAFB0)
#define RPG_CLIENT_LOOPGENERATOR_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x15BEAB30)
#define RPG_CLIENT_LOOPGENERATOR_ONENABLE_OFFSET UNITYSDK_OFFSET(0x15BEA300)
#define RPG_CLIENT_LOOPGENERATOR_RELEASEALLSLIDERS_OFFSET UNITYSDK_OFFSET(0x15BEAB80)
#define RPG_CLIENT_LOOPGENERATOR_RESETSTATE_OFFSET UNITYSDK_OFFSET(0x15BEA1D0)
#define RPG_CLIENT_LOOPGENERATOR_SETTEMPSPEED_OFFSET UNITYSDK_OFFSET(0x15BEC570)
#define RPG_CLIENT_LOOPGENERATOR_SET_TIMESCALE_OFFSET UNITYSDK_OFFSET(0x15BE9CF0)
#define RPG_CLIENT_LOOPGENERATOR_SWITCHCONFIG_OFFSET UNITYSDK_OFFSET(0x15BEC260)
#define RPG_CLIENT_LOOPGENERATOR_UPDATE_OFFSET UNITYSDK_OFFSET(0x15BEA370)
#define RPG_CLIENT_LOOPGENERATOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x15BEC760)
#define RPG_CLIENT_LOOPGENERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x15BEC5D0)

namespace RPG::Client
{
	inline static constexpr unsigned int LoopGenerator_TypeDefinitionIndex = 69647;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(LoopGenerator_TypeDefinitionIndex)->GetStaticField(0xA870);
		}
