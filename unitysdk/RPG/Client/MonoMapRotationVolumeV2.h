...
#define RPG_CLIENT_MONOMAPROTATIONVOLUMEV2__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACF54F0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoMapRotationVolumeV2_TypeDefinitionIndex = 68576;
