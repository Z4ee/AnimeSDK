...
#define RPG_CLIENT_MONOMAPROTATIONVOLUMEV2__CTOR_OFFSET UNITYSDK_OFFSET(0x9D1C350)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoMapRotationVolumeV2_TypeDefinitionIndex = 56030;
