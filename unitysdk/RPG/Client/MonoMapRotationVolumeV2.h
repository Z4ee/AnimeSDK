...
#define RPG_CLIENT_MONOMAPROTATIONVOLUMEV2__CTOR_OFFSET UNITYSDK_OFFSET(0x18C5F4B0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoMapRotationVolumeV2_TypeDefinitionIndex = 65561;
