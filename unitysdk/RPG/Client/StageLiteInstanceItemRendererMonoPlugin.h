...
#define RPG_CLIENT_STAGELITEINSTANCEITEMRENDERERMONOPLUGIN_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xE0E1CD0)
#define RPG_CLIENT_STAGELITEINSTANCEITEMRENDERERMONOPLUGIN_REGISTERITEMINSTANCE_OFFSET UNITYSDK_OFFSET(0xE0E1B90)
#define RPG_CLIENT_STAGELITEINSTANCEITEMRENDERERMONOPLUGIN_UNREGISTERITEMINSTANCE_OFFSET UNITYSDK_OFFSET(0xE0E1C40)
#define RPG_CLIENT_STAGELITEINSTANCEITEMRENDERERMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xE0E1D20)
