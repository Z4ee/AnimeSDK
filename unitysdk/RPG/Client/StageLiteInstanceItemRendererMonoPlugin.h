...
#define RPG_CLIENT_STAGELITEINSTANCEITEMRENDERERMONOPLUGIN_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xB1C0950)
#define RPG_CLIENT_STAGELITEINSTANCEITEMRENDERERMONOPLUGIN_REGISTERITEMINSTANCE_OFFSET UNITYSDK_OFFSET(0xB1C0810)
#define RPG_CLIENT_STAGELITEINSTANCEITEMRENDERERMONOPLUGIN_UNREGISTERITEMINSTANCE_OFFSET UNITYSDK_OFFSET(0xB1C08C0)
#define RPG_CLIENT_STAGELITEINSTANCEITEMRENDERERMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xB1C09A0)
#define RPG_CLIENT_STAGELITEINSTANCEITEMRENDERERMONOPLUGIN___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xB1C09B0)

namespace RPG::Client
{
	inline static constexpr unsigned int StageLiteInstanceItemRendererMonoPlugin_TypeDefinitionIndex = 65456;
	...
	public:
		...
		{
			return ((::System::String*(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_STAGELITEINSTANCEITEMRENDERERMONOPLUGIN___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET))(this);
		}
	};
}
