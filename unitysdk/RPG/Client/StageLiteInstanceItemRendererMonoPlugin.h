...
#define RPG_CLIENT_STAGELITEINSTANCEITEMRENDERERMONOPLUGIN_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x17B596B0)
#define RPG_CLIENT_STAGELITEINSTANCEITEMRENDERERMONOPLUGIN_REGISTERITEMINSTANCE_OFFSET UNITYSDK_OFFSET(0x17B59570)
#define RPG_CLIENT_STAGELITEINSTANCEITEMRENDERERMONOPLUGIN_UNREGISTERITEMINSTANCE_OFFSET UNITYSDK_OFFSET(0x17B59620)
#define RPG_CLIENT_STAGELITEINSTANCEITEMRENDERERMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x17B59700)

namespace RPG::Client
{
	inline static constexpr unsigned int StageLiteInstanceItemRendererMonoPlugin_TypeDefinitionIndex = 67819;
