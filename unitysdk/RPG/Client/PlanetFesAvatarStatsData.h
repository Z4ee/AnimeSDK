...
#define RPG_CLIENT_PLANETFESAVATARSTATSDATA_CREATEDISPLAY_OFFSET UNITYSDK_OFFSET(0xDB3B300)
#define RPG_CLIENT_PLANETFESAVATARSTATSDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xDB3B110)
#define RPG_CLIENT_PLANETFESAVATARSTATSDATA_GET_AVATARICON_OFFSET UNITYSDK_OFFSET(0xDB3B3A0)
#define RPG_CLIENT_PLANETFESAVATARSTATSDATA_GET_AVATARID_OFFSET UNITYSDK_OFFSET(0xDB3B380)
#define RPG_CLIENT_PLANETFESAVATARSTATSDATA_GET_OUTPUTINCOME_OFFSET UNITYSDK_OFFSET(0xDB3B420)
#define RPG_CLIENT_PLANETFESAVATARSTATSDATA_GET_PAMEVENTFINISHCOUNT_OFFSET UNITYSDK_OFFSET(0xDB3B460)
#define RPG_CLIENT_PLANETFESAVATARSTATSDATA_GET_TALKCOUNT_OFFSET UNITYSDK_OFFSET(0xDB3B480)
#define RPG_CLIENT_PLANETFESAVATARSTATSDATA_GET_WORKTIME_OFFSET UNITYSDK_OFFSET(0xDB3B440)
#define RPG_CLIENT_PLANETFESAVATARSTATSDATA_SET_AVATARID_OFFSET UNITYSDK_OFFSET(0xDB3B390)
#define RPG_CLIENT_PLANETFESAVATARSTATSDATA_SET_OUTPUTINCOME_OFFSET UNITYSDK_OFFSET(0xDB3B430)
#define RPG_CLIENT_PLANETFESAVATARSTATSDATA_SET_PAMEVENTFINISHCOUNT_OFFSET UNITYSDK_OFFSET(0xDB3B470)
#define RPG_CLIENT_PLANETFESAVATARSTATSDATA_SET_WORKTIME_OFFSET UNITYSDK_OFFSET(0xDB3B450)
#define RPG_CLIENT_PLANETFESAVATARSTATSDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xDB3B270)

namespace RPG::Client
{
	inline static constexpr unsigned int PlanetFesAvatarStatsData_TypeDefinitionIndex = 66593;
	...
	public:
		...
		::System::UInt32 _PamEventFinishCount_k__BackingField; // 0x28
		...
		static ::RPG::Client::PlanetFesAvatarStatsData* Create(::Class_1_70D5AA87C5BBA20B_5* a1)
		{
			return ((::RPG::Client::PlanetFesAvatarStatsData*(*)(::Class_1_70D5AA87C5BBA20B_5*))((::PBYTE)hIl2Cpp + RPG_CLIENT_PLANETFESAVATARSTATSDATA_CREATE_OFFSET))(a1);
		}
