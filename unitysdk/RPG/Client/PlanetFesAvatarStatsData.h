...
#define RPG_CLIENT_PLANETFESAVATARSTATSDATA_CREATEDISPLAY_OFFSET UNITYSDK_OFFSET(0xC401DA0)
#define RPG_CLIENT_PLANETFESAVATARSTATSDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xC401BB0)
#define RPG_CLIENT_PLANETFESAVATARSTATSDATA_GET_AVATARICON_OFFSET UNITYSDK_OFFSET(0xC401E40)
#define RPG_CLIENT_PLANETFESAVATARSTATSDATA_GET_AVATARID_OFFSET UNITYSDK_OFFSET(0xC401E20)
#define RPG_CLIENT_PLANETFESAVATARSTATSDATA_GET_OUTPUTINCOME_OFFSET UNITYSDK_OFFSET(0xC401EC0)
#define RPG_CLIENT_PLANETFESAVATARSTATSDATA_GET_PAMEVENTFINISHCOUNT_OFFSET UNITYSDK_OFFSET(0xC401F00)
#define RPG_CLIENT_PLANETFESAVATARSTATSDATA_GET_TALKCOUNT_OFFSET UNITYSDK_OFFSET(0xC401F20)
#define RPG_CLIENT_PLANETFESAVATARSTATSDATA_GET_WORKTIME_OFFSET UNITYSDK_OFFSET(0xC401EE0)
#define RPG_CLIENT_PLANETFESAVATARSTATSDATA_SET_AVATARID_OFFSET UNITYSDK_OFFSET(0xC401E30)
#define RPG_CLIENT_PLANETFESAVATARSTATSDATA_SET_OUTPUTINCOME_OFFSET UNITYSDK_OFFSET(0xC401ED0)
#define RPG_CLIENT_PLANETFESAVATARSTATSDATA_SET_PAMEVENTFINISHCOUNT_OFFSET UNITYSDK_OFFSET(0xC401F10)
#define RPG_CLIENT_PLANETFESAVATARSTATSDATA_SET_WORKTIME_OFFSET UNITYSDK_OFFSET(0xC401EF0)
#define RPG_CLIENT_PLANETFESAVATARSTATSDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC401D10)

namespace RPG::Client
{
	inline static constexpr unsigned int PlanetFesAvatarStatsData_TypeDefinitionIndex = 62242;

	class PlanetFesAvatarStatsData : public ::System::Object
	{
	public:
		::System::Numerics::BigInteger _OutputIncome_k__BackingField; // 0x10
		::System::UInt32 _WorkTime_k__BackingField; // 0x20
		...
		static ::RPG::Client::PlanetFesAvatarStatsData* Create(::Class_1_963E317C37FB5E9A_48* a1)
		{
			return ((::RPG::Client::PlanetFesAvatarStatsData*(*)(::Class_1_963E317C37FB5E9A_48*))((::PBYTE)hIl2Cpp + RPG_CLIENT_PLANETFESAVATARSTATSDATA_CREATE_OFFSET))(a1);
		}
