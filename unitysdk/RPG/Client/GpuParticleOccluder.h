...
#define RPG_CLIENT_GPUPARTICLEOCCLUDER_METHOD_5_062295FD6E4F57FD_OFFSET UNITYSDK_OFFSET(0xA4386E0)
#define RPG_CLIENT_GPUPARTICLEOCCLUDER_METHOD_5_CF00617FE35FAA7C_OFFSET UNITYSDK_OFFSET(0xA438820)
#define RPG_CLIENT_GPUPARTICLEOCCLUDER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xA438640)
#define RPG_CLIENT_GPUPARTICLEOCCLUDER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xA438020)
#define RPG_CLIENT_GPUPARTICLEOCCLUDER_REFRESHDISTANCETOCAMERA_OFFSET UNITYSDK_OFFSET(0xA438AB0)
#define RPG_CLIENT_GPUPARTICLEOCCLUDER__CTOR_OFFSET UNITYSDK_OFFSET(0xA438E20)

namespace RPG::Client
{
	inline static constexpr unsigned int GpuParticleOccluder_TypeDefinitionIndex = 64338;
