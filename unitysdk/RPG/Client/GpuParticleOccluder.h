...
#define RPG_CLIENT_GPUPARTICLEOCCLUDER_METHOD_5_062295FD6E4F57FD_OFFSET UNITYSDK_OFFSET(0x97C05E0)
#define RPG_CLIENT_GPUPARTICLEOCCLUDER_METHOD_5_CF00617FE35FAA7C_OFFSET UNITYSDK_OFFSET(0x97C0720)
#define RPG_CLIENT_GPUPARTICLEOCCLUDER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x97C0540)
#define RPG_CLIENT_GPUPARTICLEOCCLUDER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x97BFF20)
#define RPG_CLIENT_GPUPARTICLEOCCLUDER_REFRESHDISTANCETOCAMERA_OFFSET UNITYSDK_OFFSET(0x97C09B0)
#define RPG_CLIENT_GPUPARTICLEOCCLUDER__CTOR_OFFSET UNITYSDK_OFFSET(0x97C0D20)

namespace RPG::Client
{
	inline static constexpr unsigned int GpuParticleOccluder_TypeDefinitionIndex = 57087;
