...
#define RPG_CLIENT_MONOCHARACTERROOTDAMPER_ADDHEIGHT_OFFSET UNITYSDK_OFFSET(0xC05D830)
#define RPG_CLIENT_MONOCHARACTERROOTDAMPER_CRITICALSPRINGDAMPERIMPLICIT_OFFSET UNITYSDK_OFFSET(0xC05D990)
#define RPG_CLIENT_MONOCHARACTERROOTDAMPER_HALFLIFETODAMPING_OFFSET UNITYSDK_OFFSET(0xC05DB30)
#define RPG_CLIENT_MONOCHARACTERROOTDAMPER_RESET_OFFSET UNITYSDK_OFFSET(0xC05D7E0)
#define RPG_CLIENT_MONOCHARACTERROOTDAMPER_UPDATEROOT_OFFSET UNITYSDK_OFFSET(0xC05D890)
#define RPG_CLIENT_MONOCHARACTERROOTDAMPER__CTOR_OFFSET UNITYSDK_OFFSET(0xC05DBB0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoCharacterRootDamper_TypeDefinitionIndex = 64116;
