...
#define RPG_CLIENT_AIRSHIPCARDETECTTRIGGER_AWAKE_OFFSET UNITYSDK_OFFSET(0xB2E44E0)
#define RPG_CLIENT_AIRSHIPCARDETECTTRIGGER_GET_ENTITIES_OFFSET UNITYSDK_OFFSET(0xB2E44D0)
#define RPG_CLIENT_AIRSHIPCARDETECTTRIGGER_GET_ISDETECTED_OFFSET UNITYSDK_OFFSET(0xB2E3B60)
#define RPG_CLIENT_AIRSHIPCARDETECTTRIGGER_METHOD_5_907E24F785836BA0_OFFSET UNITYSDK_OFFSET(0xB2E3880)
#define RPG_CLIENT_AIRSHIPCARDETECTTRIGGER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xB2E4650)
#define RPG_CLIENT_AIRSHIPCARDETECTTRIGGER_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0xB2E46E0)
#define RPG_CLIENT_AIRSHIPCARDETECTTRIGGER_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0xB2E48A0)
#define RPG_CLIENT_AIRSHIPCARDETECTTRIGGER_RESET_OFFSET UNITYSDK_OFFSET(0xB2E4530)
#define RPG_CLIENT_AIRSHIPCARDETECTTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0xB2E3C70)

namespace RPG::Client
{
	inline static constexpr unsigned int AirshipCarDetectTrigger_TypeDefinitionIndex = 55914;
