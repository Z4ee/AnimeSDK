...
#define RPG_CLIENT_AIRSHIPCARDETECTTRIGGER_AWAKE_OFFSET UNITYSDK_OFFSET(0xC7330A0)
#define RPG_CLIENT_AIRSHIPCARDETECTTRIGGER_GET_ENTITIES_OFFSET UNITYSDK_OFFSET(0xC733090)
#define RPG_CLIENT_AIRSHIPCARDETECTTRIGGER_GET_ISDETECTED_OFFSET UNITYSDK_OFFSET(0xC7326E0)
#define RPG_CLIENT_AIRSHIPCARDETECTTRIGGER_METHOD_5_907E24F785836BA0_OFFSET UNITYSDK_OFFSET(0xC732400)
#define RPG_CLIENT_AIRSHIPCARDETECTTRIGGER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xC733270)
#define RPG_CLIENT_AIRSHIPCARDETECTTRIGGER_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0xC733300)
#define RPG_CLIENT_AIRSHIPCARDETECTTRIGGER_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0xC7334C0)
#define RPG_CLIENT_AIRSHIPCARDETECTTRIGGER_RESET_OFFSET UNITYSDK_OFFSET(0xC733150)
#define RPG_CLIENT_AIRSHIPCARDETECTTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0xC732810)
