...
#define RPG_CLIENT_MONOCURVEMOVABLEPLAYERTRIGGERREGION_GET_ISPLAYERENTERED_OFFSET UNITYSDK_OFFSET(0xC0656B0)
#define RPG_CLIENT_MONOCURVEMOVABLEPLAYERTRIGGERREGION_METHOD_5_C117F1BAC122F4D0_OFFSET UNITYSDK_OFFSET(0xC065A00)
#define RPG_CLIENT_MONOCURVEMOVABLEPLAYERTRIGGERREGION_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0xC065890)
#define RPG_CLIENT_MONOCURVEMOVABLEPLAYERTRIGGERREGION_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0xC065AF0)
#define RPG_CLIENT_MONOCURVEMOVABLEPLAYERTRIGGERREGION__CTOR_OFFSET UNITYSDK_OFFSET(0xC065B60)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoCurveMovablePlayerTriggerRegion_TypeDefinitionIndex = 64122;
