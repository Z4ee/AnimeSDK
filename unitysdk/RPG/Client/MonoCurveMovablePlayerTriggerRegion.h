...
#define RPG_CLIENT_MONOCURVEMOVABLEPLAYERTRIGGERREGION_GET_ISPLAYERENTERED_OFFSET UNITYSDK_OFFSET(0x19E36C00)
#define RPG_CLIENT_MONOCURVEMOVABLEPLAYERTRIGGERREGION_METHOD_5_C117F1BAC122F4D0_OFFSET UNITYSDK_OFFSET(0x19E36ED0)
#define RPG_CLIENT_MONOCURVEMOVABLEPLAYERTRIGGERREGION_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x19E36DE0)
#define RPG_CLIENT_MONOCURVEMOVABLEPLAYERTRIGGERREGION_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0x19E36FC0)
#define RPG_CLIENT_MONOCURVEMOVABLEPLAYERTRIGGERREGION__CTOR_OFFSET UNITYSDK_OFFSET(0x19E37030)
