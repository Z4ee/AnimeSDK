...
#define RPG_CLIENT_MONOCURVEMOVABLEPLAYERTRIGGERREGION_GET_ISPLAYERENTERED_OFFSET UNITYSDK_OFFSET(0x18081E50)
#define RPG_CLIENT_MONOCURVEMOVABLEPLAYERTRIGGERREGION_METHOD_5_C117F1BAC122F4D0_OFFSET UNITYSDK_OFFSET(0x18082120)
#define RPG_CLIENT_MONOCURVEMOVABLEPLAYERTRIGGERREGION_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x18082030)
#define RPG_CLIENT_MONOCURVEMOVABLEPLAYERTRIGGERREGION_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0x18082210)
#define RPG_CLIENT_MONOCURVEMOVABLEPLAYERTRIGGERREGION__CTOR_OFFSET UNITYSDK_OFFSET(0x18082280)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoCurveMovablePlayerTriggerRegion_TypeDefinitionIndex = 65493;
