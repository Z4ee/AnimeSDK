...
#define RPG_CLIENT_MANIKINLOOKATCONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0x174B1840)
#define RPG_CLIENT_MANIKINLOOKATCONTROLLER_DISABLELOOKAT_OFFSET UNITYSDK_OFFSET(0x174B3C80)
#define RPG_CLIENT_MANIKINLOOKATCONTROLLER_DOLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x174B3960)
#define RPG_CLIENT_MANIKINLOOKATCONTROLLER_ENABLELOOKAT_OFFSET UNITYSDK_OFFSET(0x174B3BC0)
#define RPG_CLIENT_MANIKINLOOKATCONTROLLER_GET_STATICENABLED_OFFSET UNITYSDK_OFFSET(0x174B1750)
#define RPG_CLIENT_MANIKINLOOKATCONTROLLER_METHOD_5_45F2459C967E3311_OFFSET UNITYSDK_OFFSET(0x174B3850)
#define RPG_CLIENT_MANIKINLOOKATCONTROLLER_METHOD_5_5EB6B43A59A0A89B_OFFSET UNITYSDK_OFFSET(0x174B1D10)
#define RPG_CLIENT_MANIKINLOOKATCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x174B1C70)
#define RPG_CLIENT_MANIKINLOOKATCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x174B1B70)
#define RPG_CLIENT_MANIKINLOOKATCONTROLLER_SETOWNER_OFFSET UNITYSDK_OFFSET(0x174B17F0)
#define RPG_CLIENT_MANIKINLOOKATCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0x174B1AB0)
#define RPG_CLIENT_MANIKINLOOKATCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x174B3D40)

namespace RPG::Client
{
	inline static constexpr unsigned int ManikinLookAtController_TypeDefinitionIndex = 68471;
	...
	public:
		...
		::RPG::GameCore::UI3DCharacterDataComponent* MIPMCEJIAMC; // 0x68
		::RPG::Client::LookAtIK* FJLAEGFIMCK; // 0x70
		::RPG::Client::EmoEyeCtrl* KNOIJPMAFOB; // 0x78
		::SkirtIK* KOOBIGFLPKI; // 0x80
		::UnityChan::SpringManager* GKJGKIPPAIP; // 0x88
		::UnityEngine::Animator* NAHOHKAHBPK; // 0x90
		::RPG::Client::StateIdleTimer* CPNEGCNHMLA; // 0x98
		::System::Single JCJAPHGBLPB; // 0xA0
		::UnityEngine::Transform* DEKAPAGCCGL; // 0xA8
		::System::Single JBCLEIBCDJO; // 0xB0
		::Il2CppArray<::System::Int32>* HILDHBAKDFJ; // 0xB8
		::System::Single CBLICFGIKAC; // 0xC0
		::System::Nullable_1<::UnityEngine::Vector3> IPEKFACFJGG; // 0xC4
		::System::Nullable_1<::UnityEngine::Vector3> IIBBCLPNNDE; // 0xD4
