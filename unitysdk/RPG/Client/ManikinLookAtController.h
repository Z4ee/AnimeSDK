...
#define RPG_CLIENT_MANIKINLOOKATCONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0x9AC7530)
#define RPG_CLIENT_MANIKINLOOKATCONTROLLER_DISABLELOOKAT_OFFSET UNITYSDK_OFFSET(0x9AC9990)
#define RPG_CLIENT_MANIKINLOOKATCONTROLLER_DOLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x9AC9670)
#define RPG_CLIENT_MANIKINLOOKATCONTROLLER_ENABLELOOKAT_OFFSET UNITYSDK_OFFSET(0x9AC98D0)
#define RPG_CLIENT_MANIKINLOOKATCONTROLLER_GET_STATICENABLED_OFFSET UNITYSDK_OFFSET(0x9AC7440)
#define RPG_CLIENT_MANIKINLOOKATCONTROLLER_METHOD_5_45F2459C967E3311_OFFSET UNITYSDK_OFFSET(0x9AC9560)
#define RPG_CLIENT_MANIKINLOOKATCONTROLLER_METHOD_5_5EB6B43A59A0A89B_OFFSET UNITYSDK_OFFSET(0x9AC7A20)
#define RPG_CLIENT_MANIKINLOOKATCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x9AC7980)
#define RPG_CLIENT_MANIKINLOOKATCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x9AC7880)
#define RPG_CLIENT_MANIKINLOOKATCONTROLLER_SETOWNER_OFFSET UNITYSDK_OFFSET(0x9AC74E0)
#define RPG_CLIENT_MANIKINLOOKATCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0x9AC77C0)
#define RPG_CLIENT_MANIKINLOOKATCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9AC9A50)

namespace RPG::Client
{
	inline static constexpr unsigned int ManikinLookAtController_TypeDefinitionIndex = 55934;
