...
#define RPG_CLIENT_EFFECT_TRAJECTORYMONOPLUGIN_GETDIRECTION_OFFSET UNITYSDK_OFFSET(0x9588F70)
#define RPG_CLIENT_EFFECT_TRAJECTORYMONOPLUGIN_GETPOSITION_OFFSET UNITYSDK_OFFSET(0x9588EE0)
#define RPG_CLIENT_EFFECT_TRAJECTORYMONOPLUGIN_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x9589100)
#define RPG_CLIENT_EFFECT_TRAJECTORYMONOPLUGIN_GET_BEHAVIOR_OFFSET UNITYSDK_OFFSET(0x9588480)
#define RPG_CLIENT_EFFECT_TRAJECTORYMONOPLUGIN_GET_ENDDIRECTION_OFFSET UNITYSDK_OFFSET(0x9588BC0)
#define RPG_CLIENT_EFFECT_TRAJECTORYMONOPLUGIN_GET_ENDPOSITION_OFFSET UNITYSDK_OFFSET(0x95886F0)
#define RPG_CLIENT_EFFECT_TRAJECTORYMONOPLUGIN_GET_STARTDIRECTION_OFFSET UNITYSDK_OFFSET(0x95889F0)
#define RPG_CLIENT_EFFECT_TRAJECTORYMONOPLUGIN_GET_STARTPOSITION_OFFSET UNITYSDK_OFFSET(0x9588520)
#define RPG_CLIENT_EFFECT_TRAJECTORYMONOPLUGIN_REGENERATETRAJECTORY_OFFSET UNITYSDK_OFFSET(0x9589000)
#define RPG_CLIENT_EFFECT_TRAJECTORYMONOPLUGIN_SET_BEHAVIOR_OFFSET UNITYSDK_OFFSET(0x9588510)
#define RPG_CLIENT_EFFECT_TRAJECTORYMONOPLUGIN_SET_ENDDIRECTION_OFFSET UNITYSDK_OFFSET(0x9588CD0)
#define RPG_CLIENT_EFFECT_TRAJECTORYMONOPLUGIN_SET_ENDPOSITION_OFFSET UNITYSDK_OFFSET(0x9588850)
#define RPG_CLIENT_EFFECT_TRAJECTORYMONOPLUGIN_SET_STARTDIRECTION_OFFSET UNITYSDK_OFFSET(0x9588AA0)
#define RPG_CLIENT_EFFECT_TRAJECTORYMONOPLUGIN_SET_STARTPOSITION_OFFSET UNITYSDK_OFFSET(0x95885D0)
#define RPG_CLIENT_EFFECT_TRAJECTORYMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x9589150)
#define RPG_CLIENT_EFFECT_TRAJECTORYMONOPLUGIN___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x9589180)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_TrajectoryMonoPlugin_TypeDefinitionIndex = 57791;
