...
#define RPG_CLIENT_EFFECT_TRAJECTORYMONOPLUGIN_GETDIRECTION_OFFSET UNITYSDK_OFFSET(0xA20C2A0)
#define RPG_CLIENT_EFFECT_TRAJECTORYMONOPLUGIN_GETPOSITION_OFFSET UNITYSDK_OFFSET(0xA20C210)
#define RPG_CLIENT_EFFECT_TRAJECTORYMONOPLUGIN_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xA20C430)
#define RPG_CLIENT_EFFECT_TRAJECTORYMONOPLUGIN_GET_BEHAVIOR_OFFSET UNITYSDK_OFFSET(0xA20B8C0)
#define RPG_CLIENT_EFFECT_TRAJECTORYMONOPLUGIN_GET_ENDDIRECTION_OFFSET UNITYSDK_OFFSET(0xA20C000)
#define RPG_CLIENT_EFFECT_TRAJECTORYMONOPLUGIN_GET_ENDPOSITION_OFFSET UNITYSDK_OFFSET(0xA20BB30)
#define RPG_CLIENT_EFFECT_TRAJECTORYMONOPLUGIN_GET_STARTDIRECTION_OFFSET UNITYSDK_OFFSET(0xA20BE30)
#define RPG_CLIENT_EFFECT_TRAJECTORYMONOPLUGIN_GET_STARTPOSITION_OFFSET UNITYSDK_OFFSET(0xA20B960)
#define RPG_CLIENT_EFFECT_TRAJECTORYMONOPLUGIN_REGENERATETRAJECTORY_OFFSET UNITYSDK_OFFSET(0xA20C330)
#define RPG_CLIENT_EFFECT_TRAJECTORYMONOPLUGIN_SET_BEHAVIOR_OFFSET UNITYSDK_OFFSET(0xA20B950)
#define RPG_CLIENT_EFFECT_TRAJECTORYMONOPLUGIN_SET_ENDDIRECTION_OFFSET UNITYSDK_OFFSET(0xA20C110)
#define RPG_CLIENT_EFFECT_TRAJECTORYMONOPLUGIN_SET_ENDPOSITION_OFFSET UNITYSDK_OFFSET(0xA20BC90)
#define RPG_CLIENT_EFFECT_TRAJECTORYMONOPLUGIN_SET_STARTDIRECTION_OFFSET UNITYSDK_OFFSET(0xA20BEE0)
#define RPG_CLIENT_EFFECT_TRAJECTORYMONOPLUGIN_SET_STARTPOSITION_OFFSET UNITYSDK_OFFSET(0xA20BA10)
#define RPG_CLIENT_EFFECT_TRAJECTORYMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xA20C480)
#define RPG_CLIENT_EFFECT_TRAJECTORYMONOPLUGIN___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xA20C4B0)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_TrajectoryMonoPlugin_TypeDefinitionIndex = 65055;
