...
#define RPG_CLIENT_ROGUETOURNMIRACLEUNDERLINEPARAM_CREATE_OFFSET UNITYSDK_OFFSET(0xB0D40A0)
#define RPG_CLIENT_ROGUETOURNMIRACLEUNDERLINEPARAM_EQUALS_OFFSET UNITYSDK_OFFSET(0xB0D3EF0)
#define RPG_CLIENT_ROGUETOURNMIRACLEUNDERLINEPARAM_GET_DESC_OFFSET UNITYSDK_OFFSET(0xB0D3E00)
#define RPG_CLIENT_ROGUETOURNMIRACLEUNDERLINEPARAM_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xB0D3C90)
#define RPG_CLIENT_ROGUETOURNMIRACLEUNDERLINEPARAM_GET_MIRACLE_OFFSET UNITYSDK_OFFSET(0xB0D3EB0)
#define RPG_CLIENT_ROGUETOURNMIRACLEUNDERLINEPARAM_GET_NAME_OFFSET UNITYSDK_OFFSET(0xB0D3D40)
#define RPG_CLIENT_ROGUETOURNMIRACLEUNDERLINEPARAM_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xB0D3C80)
#define RPG_CLIENT_ROGUETOURNMIRACLEUNDERLINEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xB0D4100)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueTournMiracleUnderlineParam_TypeDefinitionIndex = 62561;
