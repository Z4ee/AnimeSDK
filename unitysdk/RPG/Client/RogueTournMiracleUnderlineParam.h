...
#define RPG_CLIENT_ROGUETOURNMIRACLEUNDERLINEPARAM_CREATE_OFFSET UNITYSDK_OFFSET(0xC8245B0)
#define RPG_CLIENT_ROGUETOURNMIRACLEUNDERLINEPARAM_EQUALS_OFFSET UNITYSDK_OFFSET(0xC824400)
#define RPG_CLIENT_ROGUETOURNMIRACLEUNDERLINEPARAM_GET_DESC_OFFSET UNITYSDK_OFFSET(0xC8242F0)
#define RPG_CLIENT_ROGUETOURNMIRACLEUNDERLINEPARAM_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xC824180)
#define RPG_CLIENT_ROGUETOURNMIRACLEUNDERLINEPARAM_GET_MIRACLE_OFFSET UNITYSDK_OFFSET(0xC8243A0)
#define RPG_CLIENT_ROGUETOURNMIRACLEUNDERLINEPARAM_GET_NAME_OFFSET UNITYSDK_OFFSET(0xC824230)
#define RPG_CLIENT_ROGUETOURNMIRACLEUNDERLINEPARAM_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xC824170)
#define RPG_CLIENT_ROGUETOURNMIRACLEUNDERLINEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xC824610)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueTournMiracleUnderlineParam_TypeDefinitionIndex = 63494;
