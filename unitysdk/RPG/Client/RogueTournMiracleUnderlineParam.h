...
#define RPG_CLIENT_ROGUETOURNMIRACLEUNDERLINEPARAM_CREATE_OFFSET UNITYSDK_OFFSET(0x1C338560)
#define RPG_CLIENT_ROGUETOURNMIRACLEUNDERLINEPARAM_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C3382E0)
#define RPG_CLIENT_ROGUETOURNMIRACLEUNDERLINEPARAM_GET_DESC_OFFSET UNITYSDK_OFFSET(0x1C338120)
#define RPG_CLIENT_ROGUETOURNMIRACLEUNDERLINEPARAM_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x1C337EA0)
#define RPG_CLIENT_ROGUETOURNMIRACLEUNDERLINEPARAM_GET_MIRACLE_OFFSET UNITYSDK_OFFSET(0x1C338250)
#define RPG_CLIENT_ROGUETOURNMIRACLEUNDERLINEPARAM_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1C337FD0)
#define RPG_CLIENT_ROGUETOURNMIRACLEUNDERLINEPARAM_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1C337E60)
#define RPG_CLIENT_ROGUETOURNMIRACLEUNDERLINEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3385E0)
