...
#define RPG_CLIENT_REWARDPACKPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x1798E8D0)

namespace RPG::Client
{
	inline static constexpr unsigned int RewardPackParams_TypeDefinitionIndex = 60270;
