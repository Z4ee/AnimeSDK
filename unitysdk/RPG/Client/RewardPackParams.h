...
#define RPG_CLIENT_REWARDPACKPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x173A8550)

namespace RPG::Client
{
	inline static constexpr unsigned int RewardPackParams_TypeDefinitionIndex = 57453;
