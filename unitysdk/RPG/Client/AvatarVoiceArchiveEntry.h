...
#define RPG_CLIENT_AVATARVOICEARCHIVEENTRY_CANUNLOCKED_OFFSET UNITYSDK_OFFSET(0x9DC1BC0)
#define RPG_CLIENT_AVATARVOICEARCHIVEENTRY_COMPARETO_OFFSET UNITYSDK_OFFSET(0x9DC2230)
#define RPG_CLIENT_AVATARVOICEARCHIVEENTRY_GETUNLOCKDESC_OFFSET UNITYSDK_OFFSET(0x9DC2530)
#define RPG_CLIENT_AVATARVOICEARCHIVEENTRY_GETVOICECONTENT_OFFSET UNITYSDK_OFFSET(0x9DC1D60)
#define RPG_CLIENT_AVATARVOICEARCHIVEENTRY_GET_ISHIDE_OFFSET UNITYSDK_OFFSET(0x9DC2630)
#define RPG_CLIENT_AVATARVOICEARCHIVEENTRY_GET_REDDOTKEY_OFFSET UNITYSDK_OFFSET(0x9DC25E0)
#define RPG_CLIENT_AVATARVOICEARCHIVEENTRY_GET_REPLACEENTRY_OFFSET UNITYSDK_OFFSET(0x9DC2720)
#define RPG_CLIENT_AVATARVOICEARCHIVEENTRY_GET_REPLACEID_OFFSET UNITYSDK_OFFSET(0x9DC26A0)
#define RPG_CLIENT_AVATARVOICEARCHIVEENTRY_GET_ROW_OFFSET UNITYSDK_OFFSET(0x9DC1C90)
#define RPG_CLIENT_AVATARVOICEARCHIVEENTRY_GET_SORTID_OFFSET UNITYSDK_OFFSET(0x9DC24B0)
#define RPG_CLIENT_AVATARVOICEARCHIVEENTRY_POSTVOICE_OFFSET UNITYSDK_OFFSET(0x9DC1E20)
#define RPG_CLIENT_AVATARVOICEARCHIVEENTRY_SET_ISHIDE_OFFSET UNITYSDK_OFFSET(0x9DC2690)
#define RPG_CLIENT_AVATARVOICEARCHIVEENTRY_SET_REPLACEENTRY_OFFSET UNITYSDK_OFFSET(0x9DC2730)
#define RPG_CLIENT_AVATARVOICEARCHIVEENTRY_STOPPLAYINGVOICE_OFFSET UNITYSDK_OFFSET(0x9DC2190)
#define RPG_CLIENT_AVATARVOICEARCHIVEENTRY_UNLOCK_OFFSET UNITYSDK_OFFSET(0x9DC1D00)
#define RPG_CLIENT_AVATARVOICEARCHIVEENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x9DC2740)
#define RPG_CLIENT_AVATARVOICEARCHIVEENTRY___IFIXBASEPROXY_CANUNLOCKED_OFFSET UNITYSDK_OFFSET(0x9DC2750)
#define RPG_CLIENT_AVATARVOICEARCHIVEENTRY___IFIXBASEPROXY_COMPARETO_OFFSET UNITYSDK_OFFSET(0x9DC27A0)
#define RPG_CLIENT_AVATARVOICEARCHIVEENTRY___IFIXBASEPROXY_GET_REDDOTKEY_OFFSET UNITYSDK_OFFSET(0x9DC27B0)
#define RPG_CLIENT_AVATARVOICEARCHIVEENTRY___IFIXBASEPROXY_UNLOCK_OFFSET UNITYSDK_OFFSET(0x9DC2790)

namespace RPG::Client
{
	inline static constexpr unsigned int AvatarVoiceArchiveEntry_TypeDefinitionIndex = 57596;
