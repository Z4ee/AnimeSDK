...
#define RPG_CLIENT_EFFECT_PARTICLEBACKWARDBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0x1510D920)
#define RPG_CLIENT_EFFECT_PARTICLEBACKWARDBEHAVIOR_METHOD_3_004D2CE97AA50BBA_OFFSET UNITYSDK_OFFSET(0x15115D40)
#define RPG_CLIENT_EFFECT_PARTICLEBACKWARDBEHAVIOR_METHOD_3_147A527305B2FF1B_OFFSET UNITYSDK_OFFSET(0x151137F0)
#define RPG_CLIENT_EFFECT_PARTICLEBACKWARDBEHAVIOR_METHOD_3_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0x151184C0)
#define RPG_CLIENT_EFFECT_PARTICLEBACKWARDBEHAVIOR_METHOD_3_24B05D2E15A5C3C8_OFFSET UNITYSDK_OFFSET(0x1510D750)
#define RPG_CLIENT_EFFECT_PARTICLEBACKWARDBEHAVIOR_METHOD_3_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0x15113AB0)
#define RPG_CLIENT_EFFECT_PARTICLEBACKWARDBEHAVIOR_METHOD_3_3E43B71D665FF6C0_OFFSET UNITYSDK_OFFSET(0x151158C0)
#define RPG_CLIENT_EFFECT_PARTICLEBACKWARDBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0x1510DC90)
#define RPG_CLIENT_EFFECT_PARTICLEBACKWARDBEHAVIOR_METHOD_3_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0x1510DCF0)
#define RPG_CLIENT_EFFECT_PARTICLEBACKWARDBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x1510D5F0)
#define RPG_CLIENT_EFFECT_PARTICLEBACKWARDBEHAVIOR_METHOD_3_65BB8F0F1E258993_OFFSET UNITYSDK_OFFSET(0x1510D9A0)
#define RPG_CLIENT_EFFECT_PARTICLEBACKWARDBEHAVIOR_METHOD_3_68805403250CC013_OFFSET UNITYSDK_OFFSET(0x15113FF0)
#define RPG_CLIENT_EFFECT_PARTICLEBACKWARDBEHAVIOR_METHOD_3_708FD95A0BF1E451_OFFSET UNITYSDK_OFFSET(0x151142F0)
#define RPG_CLIENT_EFFECT_PARTICLEBACKWARDBEHAVIOR_METHOD_3_7D2C7213E6B374D8_OFFSET UNITYSDK_OFFSET(0x1510DDF0)
#define RPG_CLIENT_EFFECT_PARTICLEBACKWARDBEHAVIOR_METHOD_3_8C1FB0C6AEFFB54E_OFFSET UNITYSDK_OFFSET(0x15118560)
#define RPG_CLIENT_EFFECT_PARTICLEBACKWARDBEHAVIOR_METHOD_3_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x151182A0)
#define RPG_CLIENT_EFFECT_PARTICLEBACKWARDBEHAVIOR_METHOD_3_9E38127F40B34F1F_OFFSET UNITYSDK_OFFSET(0x1510DB80)
#define RPG_CLIENT_EFFECT_PARTICLEBACKWARDBEHAVIOR_METHOD_3_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x1510D8C0)
#define RPG_CLIENT_EFFECT_PARTICLEBACKWARDBEHAVIOR_METHOD_3_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x15118260)
#define RPG_CLIENT_EFFECT_PARTICLEBACKWARDBEHAVIOR_METHOD_3_D0BD1377F2594D33_OFFSET UNITYSDK_OFFSET(0x1510D650)
#define RPG_CLIENT_EFFECT_PARTICLEBACKWARDBEHAVIOR_METHOD_3_D35B60AE823B8CC1_OFFSET UNITYSDK_OFFSET(0x15113B10)
#define RPG_CLIENT_EFFECT_PARTICLEBACKWARDBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0x1510DD50)
#define RPG_CLIENT_EFFECT_PARTICLEBACKWARDBEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x15118880)
#define RPG_CLIENT_EFFECT_PARTICLEBACKWARDBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x151187A0)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_ParticleBackwardBehavior_TypeDefinitionIndex = 67361;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::Vector4>**)Il2CppClass::FromTypeDefinitionIndex(Effect_ParticleBackwardBehavior_TypeDefinitionIndex)->GetStaticField(0x6BA40);
		}
		static ::System::Collections::Generic::List_1<::UnityEngine::Vector4>** StaticGet_customDataList1()
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::Vector4>**)Il2CppClass::FromTypeDefinitionIndex(Effect_ParticleBackwardBehavior_TypeDefinitionIndex)->GetStaticField(0x6BA48);
		}
		static ::System::Int32* StaticGet__Time_ShaderID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Effect_ParticleBackwardBehavior_TypeDefinitionIndex)->GetStaticField(0x14830);
		}
