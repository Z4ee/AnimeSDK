...
#define RPG_CLIENT_MONOSWITCHHANDCOLLIDERITEM_AWAKE_OFFSET UNITYSDK_OFFSET(0x9D37B00)
#define RPG_CLIENT_MONOSWITCHHANDCOLLIDERITEM_METHOD_5_C05CECF17E0BB2B1_1_OFFSET UNITYSDK_OFFSET(0x9D380E0)
#define RPG_CLIENT_MONOSWITCHHANDCOLLIDERITEM_METHOD_5_C05CECF17E0BB2B1_OFFSET UNITYSDK_OFFSET(0x9D37CC0)
#define RPG_CLIENT_MONOSWITCHHANDCOLLIDERITEM_METHOD_5_DF7CEFC0E6C5FD0D_OFFSET UNITYSDK_OFFSET(0x9D37F50)
#define RPG_CLIENT_MONOSWITCHHANDCOLLIDERITEM_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x9D37E50)
#define RPG_CLIENT_MONOSWITCHHANDCOLLIDERITEM_ONENABLE_OFFSET UNITYSDK_OFFSET(0x9D37BA0)
#define RPG_CLIENT_MONOSWITCHHANDCOLLIDERITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x9D382B0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoSwitchHandColliderItem_TypeDefinitionIndex = 56178;
