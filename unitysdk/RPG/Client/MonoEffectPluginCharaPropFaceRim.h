...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACERIM_INIT_OFFSET UNITYSDK_OFFSET(0xC0C4C50)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACERIM_UNINIT_OFFSET UNITYSDK_OFFSET(0xC0C5000)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACERIM_UPDATEPROPERTY_OFFSET UNITYSDK_OFFSET(0xC0C4CF0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACERIM__CTOR_OFFSET UNITYSDK_OFFSET(0xC0C50A0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACERIM___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0xC0C50C0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACERIM___IFIXBASEPROXY_UNINIT_OFFSET UNITYSDK_OFFSET(0xC0C50D0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginCharaPropFaceRim_TypeDefinitionIndex = 65412;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Collections::Generic::Dictionary_2<::UnityEngine::Renderer*, ::RPG::Client::MonoEffectPluginCharaEffectBase_Class_1_0875A0359D7C8064*>*, ::System::Collections::Generic::List_1<::UnityEngine::Material*>*, ::System::Collections::Generic::Dictionary_2<::UnityEngine::Shader*, ::System::String*>*&))((::PBYTE)hIl2Cpp + RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACERIM___IFIXBASEPROXY_INIT_OFFSET))(this, a1, a2, a3);
		}
