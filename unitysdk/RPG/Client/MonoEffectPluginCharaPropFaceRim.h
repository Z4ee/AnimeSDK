...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACERIM_INIT_OFFSET UNITYSDK_OFFSET(0xA978440)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACERIM_UNINIT_OFFSET UNITYSDK_OFFSET(0xA9787E0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACERIM_UPDATEPROPERTY_OFFSET UNITYSDK_OFFSET(0xA9784E0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACERIM__CTOR_OFFSET UNITYSDK_OFFSET(0xA978880)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACERIM___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0xA9788A0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACERIM___IFIXBASEPROXY_UNINIT_OFFSET UNITYSDK_OFFSET(0xA9788B0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginCharaPropFaceRim_TypeDefinitionIndex = 64491;
