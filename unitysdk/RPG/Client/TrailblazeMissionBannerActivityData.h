...
#define RPG_CLIENT_TRAILBLAZEMISSIONBANNERACTIVITYDATA_CANSHOWINPLAYERRETURN_OFFSET UNITYSDK_OFFSET(0x197C08C0)
#define RPG_CLIENT_TRAILBLAZEMISSIONBANNERACTIVITYDATA_GETSUBTITLETEXT_OFFSET UNITYSDK_OFFSET(0x197C0830)
#define RPG_CLIENT_TRAILBLAZEMISSIONBANNERACTIVITYDATA_GETVERSIONBANNERDATA_OFFSET UNITYSDK_OFFSET(0x197C0600)
#define RPG_CLIENT_TRAILBLAZEMISSIONBANNERACTIVITYDATA_GET__MISSIONCHAPTERCONFIGROW_OFFSET UNITYSDK_OFFSET(0x197C0760)
#define RPG_CLIENT_TRAILBLAZEMISSIONBANNERACTIVITYDATA_ISEXTRACONDSATISFY_OFFSET UNITYSDK_OFFSET(0x197C0670)
#define RPG_CLIENT_TRAILBLAZEMISSIONBANNERACTIVITYDATA_ISSUBTITLEACTIVE_OFFSET UNITYSDK_OFFSET(0x197C06C0)
#define RPG_CLIENT_TRAILBLAZEMISSIONBANNERACTIVITYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x197C05F0)
