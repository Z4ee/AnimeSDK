...
#define RPG_CLIENT_SHOPMODULE_FINDSHOPTYPEOFITEM_OFFSET UNITYSDK_OFFSET(0x19F4ABB0)
#define RPG_CLIENT_SHOPMODULE_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x19F4AB30)
#define RPG_CLIENT_SHOPMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0x19F4ACC0)

namespace RPG::Client
{
	inline static constexpr unsigned int ShopModule_TypeDefinitionIndex = 64940;
