...
#define RPG_CLIENT_SWORDTRAININGUNLOCKDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xA520BC0)
#define RPG_CLIENT_SWORDTRAININGUNLOCKDATA_GET_FINISHWAYID_OFFSET UNITYSDK_OFFSET(0xA5289D0)
#define RPG_CLIENT_SWORDTRAININGUNLOCKDATA_GET_UNLOCKDESC_OFFSET UNITYSDK_OFFSET(0xA528430)
#define RPG_CLIENT_SWORDTRAININGUNLOCKDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xA528A70)
#define RPG_CLIENT_SWORDTRAININGUNLOCKDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA5289C0)

namespace RPG::Client
{
	inline static constexpr unsigned int SwordTrainingUnlockData_TypeDefinitionIndex = 50328;
