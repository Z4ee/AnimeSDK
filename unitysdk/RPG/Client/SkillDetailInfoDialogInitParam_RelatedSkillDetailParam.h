...
#define RPG_CLIENT_SKILLDETAILINFODIALOGINITPARAM_RELATEDSKILLDETAILPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x188FEF10)

namespace RPG::Client
{
	inline static constexpr unsigned int SkillDetailInfoDialogInitParam_RelatedSkillDetailParam_TypeDefinitionIndex = 68859;
