...
#define RPG_CLIENT_CAMERABLENDCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C84E440)

namespace RPG::Client
{
	inline static constexpr unsigned int CameraBlendCurve_TypeDefinitionIndex = 69499;
