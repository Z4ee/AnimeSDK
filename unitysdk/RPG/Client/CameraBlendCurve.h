...
#define RPG_CLIENT_CAMERABLENDCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x9250AF0)

namespace RPG::Client
{
	inline static constexpr unsigned int CameraBlendCurve_TypeDefinitionIndex = 56834;
