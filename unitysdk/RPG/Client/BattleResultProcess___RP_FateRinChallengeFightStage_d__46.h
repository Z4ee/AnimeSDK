...
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FATERINCHALLENGEFIGHTSTAGE_D__46_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19FBA180)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FATERINCHALLENGEFIGHTSTAGE_D__46_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19FBA670)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FATERINCHALLENGEFIGHTSTAGE_D__46_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19FBA6D0)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FATERINCHALLENGEFIGHTSTAGE_D__46_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19FBA680)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FATERINCHALLENGEFIGHTSTAGE_D__46_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19FBA170)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FATERINCHALLENGEFIGHTSTAGE_D__46__CTOR_OFFSET UNITYSDK_OFFSET(0x19FB64B0)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleResultProcess___RP_FateRinChallengeFightStage_d__46_TypeDefinitionIndex = 58279;
