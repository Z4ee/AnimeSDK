...
#define RPG_CLIENT_NPCPEDESTRIANV2BATCHANIMATIONEVENT___C__DISPLAYCLASS4_0__AWAKE_B__0_OFFSET UNITYSDK_OFFSET(0xC247A70)
#define RPG_CLIENT_NPCPEDESTRIANV2BATCHANIMATIONEVENT___C__DISPLAYCLASS4_0__AWAKE_B__1_OFFSET UNITYSDK_OFFSET(0xC247B00)
#define RPG_CLIENT_NPCPEDESTRIANV2BATCHANIMATIONEVENT___C__DISPLAYCLASS4_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC2477B0)

namespace RPG::Client
{
	inline static constexpr unsigned int NPCPedestrianV2BatchAnimationEvent___c__DisplayClass4_0_TypeDefinitionIndex = 64778;
