...
#define RPG_CLIENT_FULLBODYIKLIMBCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xA40A0B0)

namespace RPG::Client
{
	inline static constexpr unsigned int FullBodyIKLimbConfig_TypeDefinitionIndex = 63266;
