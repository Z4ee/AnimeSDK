...
#define RPG_CLIENT_FULLBODYIKLIMBCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x9749260)

namespace RPG::Client
{
	inline static constexpr unsigned int FullBodyIKLimbConfig_TypeDefinitionIndex = 56023;
