...
#define RPG_CLIENT_DEVUIDEBUGREPORTDATAIMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x18094D90)

namespace RPG::Client
{
	inline static constexpr unsigned int DevUIDebugReportDataImage_TypeDefinitionIndex = 65306;
