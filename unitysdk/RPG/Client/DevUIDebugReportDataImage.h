...
#define RPG_CLIENT_DEVUIDEBUGREPORTDATAIMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0xA0F99B0)

namespace RPG::Client
{
	inline static constexpr unsigned int DevUIDebugReportDataImage_TypeDefinitionIndex = 63020;
