...
#define RPG_CLIENT_DEVUIDEBUGREPORTDATAIMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0xB73ACB0)

namespace RPG::Client
{
	inline static constexpr unsigned int DevUIDebugReportDataImage_TypeDefinitionIndex = 63935;
