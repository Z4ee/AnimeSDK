...
#define RPG_CLIENT_MONOBODYBLENDSHAPESCONTROLLER_ONIKWORKED_OFFSET UNITYSDK_OFFSET(0x9C14BF0)
#define RPG_CLIENT_MONOBODYBLENDSHAPESCONTROLLER_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x9C14A00)
#define RPG_CLIENT_MONOBODYBLENDSHAPESCONTROLLER_RESET_OFFSET UNITYSDK_OFFSET(0x9C14B40)
#define RPG_CLIENT_MONOBODYBLENDSHAPESCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9C14F10)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoBodyBlendShapesController_TypeDefinitionIndex = 58275;
