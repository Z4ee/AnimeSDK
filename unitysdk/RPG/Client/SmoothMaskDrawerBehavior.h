...
#define RPG_CLIENT_SMOOTHMASKDRAWERBEHAVIOR_ENDOFLATETICK_OFFSET UNITYSDK_OFFSET(0x196D6FA0)
#define RPG_CLIENT_SMOOTHMASKDRAWERBEHAVIOR_GET__OWNER_OFFSET UNITYSDK_OFFSET(0x196D6A50)
#define RPG_CLIENT_SMOOTHMASKDRAWERBEHAVIOR_METHOD_3_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0x196D6950)
#define RPG_CLIENT_SMOOTHMASKDRAWERBEHAVIOR_METHOD_3_30A2382C3FCC5386_OFFSET UNITYSDK_OFFSET(0x196D6AD0)
#define RPG_CLIENT_SMOOTHMASKDRAWERBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x196D6EF0)
#define RPG_CLIENT_SMOOTHMASKDRAWERBEHAVIOR_METHOD_3_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x196D6E70)
#define RPG_CLIENT_SMOOTHMASKDRAWERBEHAVIOR_METHOD_3_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x196D6F50)
#define RPG_CLIENT_SMOOTHMASKDRAWERBEHAVIOR_METHOD_3_CEBFF096B4C9D46B_1_OFFSET UNITYSDK_OFFSET(0x196D7240)
#define RPG_CLIENT_SMOOTHMASKDRAWERBEHAVIOR_METHOD_3_CEBFF096B4C9D46B_OFFSET UNITYSDK_OFFSET(0x196D6B20)
#define RPG_CLIENT_SMOOTHMASKDRAWERBEHAVIOR_METHOD_3_DC2911BC8B5CED9A_OFFSET UNITYSDK_OFFSET(0x196D70E0)
#define RPG_CLIENT_SMOOTHMASKDRAWERBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x196D7550)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::RPG::Client::SmoothMaskDrawer**)Il2CppClass::FromTypeDefinitionIndex(SmoothMaskDrawerBehavior_TypeDefinitionIndex)->GetStaticField(0x288D0);
		}
