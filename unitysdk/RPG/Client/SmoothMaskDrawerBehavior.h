...
#define RPG_CLIENT_SMOOTHMASKDRAWERBEHAVIOR_ENDOFLATETICK_OFFSET UNITYSDK_OFFSET(0x18906520)
#define RPG_CLIENT_SMOOTHMASKDRAWERBEHAVIOR_GET__OWNER_OFFSET UNITYSDK_OFFSET(0x18905FD0)
#define RPG_CLIENT_SMOOTHMASKDRAWERBEHAVIOR_METHOD_3_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0x18905ED0)
#define RPG_CLIENT_SMOOTHMASKDRAWERBEHAVIOR_METHOD_3_30A2382C3FCC5386_OFFSET UNITYSDK_OFFSET(0x18906050)
#define RPG_CLIENT_SMOOTHMASKDRAWERBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x18906470)
#define RPG_CLIENT_SMOOTHMASKDRAWERBEHAVIOR_METHOD_3_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x189063F0)
#define RPG_CLIENT_SMOOTHMASKDRAWERBEHAVIOR_METHOD_3_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x189064D0)
#define RPG_CLIENT_SMOOTHMASKDRAWERBEHAVIOR_METHOD_3_CEBFF096B4C9D46B_1_OFFSET UNITYSDK_OFFSET(0x189067C0)
#define RPG_CLIENT_SMOOTHMASKDRAWERBEHAVIOR_METHOD_3_CEBFF096B4C9D46B_OFFSET UNITYSDK_OFFSET(0x189060A0)
#define RPG_CLIENT_SMOOTHMASKDRAWERBEHAVIOR_METHOD_3_DC2911BC8B5CED9A_OFFSET UNITYSDK_OFFSET(0x18906660)
#define RPG_CLIENT_SMOOTHMASKDRAWERBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x18906AD0)

namespace RPG::Client
{
	inline static constexpr unsigned int SmoothMaskDrawerBehavior_TypeDefinitionIndex = 67847;
	...
	public:
		...
		{
			return (::RPG::Client::SmoothMaskDrawer**)Il2CppClass::FromTypeDefinitionIndex(SmoothMaskDrawerBehavior_TypeDefinitionIndex)->GetStaticField(0x34E90);
		}
