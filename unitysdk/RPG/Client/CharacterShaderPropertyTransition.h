...
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB590AD0)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_DISSOLVETO_OFFSET UNITYSDK_OFFSET(0xB590BD0)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_GETCHARWPOS_OFFSET UNITYSDK_OFFSET(0xB590230)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_GETCURRENTDISSOLVERATE_OFFSET UNITYSDK_OFFSET(0xB591360)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_LATETICK_OFFSET UNITYSDK_OFFSET(0xB5911E0)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_METHOD_6_0CC4BC19C602BCD0_OFFSET UNITYSDK_OFFSET(0xB5905E0)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_METHOD_6_3363D89E03193669_OFFSET UNITYSDK_OFFSET(0xB591300)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_METHOD_6_442C4EFC0D686CFB_1_OFFSET UNITYSDK_OFFSET(0xB5912B0)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_METHOD_6_442C4EFC0D686CFB_OFFSET UNITYSDK_OFFSET(0xB591260)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_METHOD_6_7AEA4B2B25797605_OFFSET UNITYSDK_OFFSET(0xB590870)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_METHOD_6_A6CE5DAA2387E1E2_OFFSET UNITYSDK_OFFSET(0xB590990)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_METHOD_6_C561FF611C07A44C_OFFSET UNITYSDK_OFFSET(0xB590770)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_METHOD_6_D17B49CABC597E3E_OFFSET UNITYSDK_OFFSET(0xB590D40)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB591010)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_ONREFRESHMATERIALS_OFFSET UNITYSDK_OFFSET(0xB591130)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_RESET_OFFSET UNITYSDK_OFFSET(0xB590310)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_SETCHARACTEROUTLINESCALE_OFFSET UNITYSDK_OFFSET(0xB590DD0)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_SETCHARHEIGHT_OFFSET UNITYSDK_OFFSET(0xB590030)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_SETCHARWPOS_OFFSET UNITYSDK_OFFSET(0xB5900D0)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_SETSCENECONTRASTENABLE_OFFSET UNITYSDK_OFFSET(0xB58FFA0)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_SETUPDATECHARWPOSBYSMRBOUNDS_OFFSET UNITYSDK_OFFSET(0xB5902B0)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION_START_OFFSET UNITYSDK_OFFSET(0xB590EE0)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION__CCTOR_OFFSET UNITYSDK_OFFSET(0xB591400)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION__CTOR_OFFSET UNITYSDK_OFFSET(0xB5913B0)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB591460)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION___IFIXBASEPROXY_LATETICK_OFFSET UNITYSDK_OFFSET(0xB591480)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION___IFIXBASEPROXY_ONREFRESHMATERIALS_OFFSET UNITYSDK_OFFSET(0xB591470)
#define RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION___IFIXBASEPROXY_RESET_OFFSET UNITYSDK_OFFSET(0xB591450)

namespace RPG::Client
{
	inline static constexpr unsigned int CharacterShaderPropertyTransition_TypeDefinitionIndex = 64412;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(CharacterShaderPropertyTransition_TypeDefinitionIndex)->GetStaticField(0x12280);
		}
		static ::System::Int32* StaticGet_PropertyIDIsMonster()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(CharacterShaderPropertyTransition_TypeDefinitionIndex)->GetStaticField(0x12284);
		}
		static ::System::Int32* StaticGet_PropertyIDCharHeight()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(CharacterShaderPropertyTransition_TypeDefinitionIndex)->GetStaticField(0x12288);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + RPG_CLIENT_CHARACTERSHADERPROPERTYTRANSITION___IFIXBASEPROXY_LATETICK_OFFSET))(this, a1);
		}
	};
}
