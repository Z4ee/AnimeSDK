...
#define RPG_CLIENT_GRIDFIGHTPARTNERTRAITEFFECT_CANEDITINPREPARATIONSTATE_OFFSET UNITYSDK_OFFSET(0xD2D90A0)
#define RPG_CLIENT_GRIDFIGHTPARTNERTRAITEFFECT_CANEDIT_OFFSET UNITYSDK_OFFSET(0xD2D8ED0)
#define RPG_CLIENT_GRIDFIGHTPARTNERTRAITEFFECT_COPYEFFECTWITHOVERRIDEEQUIPID_OFFSET UNITYSDK_OFFSET(0xD2D79A0)
#define RPG_CLIENT_GRIDFIGHTPARTNERTRAITEFFECT_GETCHOOSEROWBYROLE_OFFSET UNITYSDK_OFFSET(0xD2D94B0)
#define RPG_CLIENT_GRIDFIGHTPARTNERTRAITEFFECT_GETCOPYEQUIPDATA_1_OFFSET UNITYSDK_OFFSET(0xD2D8D50)
#define RPG_CLIENT_GRIDFIGHTPARTNERTRAITEFFECT_GETCOPYEQUIPDATA_OFFSET UNITYSDK_OFFSET(0xD2D9420)
#define RPG_CLIENT_GRIDFIGHTPARTNERTRAITEFFECT_GETEDITICON_OFFSET UNITYSDK_OFFSET(0xD2D9130)
#define RPG_CLIENT_GRIDFIGHTPARTNERTRAITEFFECT_GETSHOWICON_OFFSET UNITYSDK_OFFSET(0xD2D91B0)
#define RPG_CLIENT_GRIDFIGHTPARTNERTRAITEFFECT_GETSHOWMEMBERUIDS_OFFSET UNITYSDK_OFFSET(0xD2D9280)
#define RPG_CLIENT_GRIDFIGHTPARTNERTRAITEFFECT_GET_BONUSTRAITCONFIGS_OFFSET UNITYSDK_OFFSET(0xD2D87E0)
#define RPG_CLIENT_GRIDFIGHTPARTNERTRAITEFFECT_GET_BONUSTRAITS_OFFSET UNITYSDK_OFFSET(0xD2D8A30)
#define RPG_CLIENT_GRIDFIGHTPARTNERTRAITEFFECT_GET_CHOOSEDROLE_OFFSET UNITYSDK_OFFSET(0xD2D7FA0)
#define RPG_CLIENT_GRIDFIGHTPARTNERTRAITEFFECT_GET_CHOOSEROLEUID_OFFSET UNITYSDK_OFFSET(0xD2D87A0)
#define RPG_CLIENT_GRIDFIGHTPARTNERTRAITEFFECT_GET_CURPENDINGACTION_OFFSET UNITYSDK_OFFSET(0xD2D9B30)
#define RPG_CLIENT_GRIDFIGHTPARTNERTRAITEFFECT_GET_CURRENTSUBTRAITCONFIG_OFFSET UNITYSDK_OFFSET(0xD2D83D0)
#define RPG_CLIENT_GRIDFIGHTPARTNERTRAITEFFECT_GET_ENHANCETRAITID_OFFSET UNITYSDK_OFFSET(0xD2DA1E0)
#define RPG_CLIENT_GRIDFIGHTPARTNERTRAITEFFECT_GET_EQUIPCONFIG_OFFSET UNITYSDK_OFFSET(0xD2D8C90)
#define RPG_CLIENT_GRIDFIGHTPARTNERTRAITEFFECT_GET_INPENDING_OFFSET UNITYSDK_OFFSET(0xD2D9B50)
#define RPG_CLIENT_GRIDFIGHTPARTNERTRAITEFFECT_GET_ISSUBTRAITACTIVE_OFFSET UNITYSDK_OFFSET(0xD2D8350)
#define RPG_CLIENT_GRIDFIGHTPARTNERTRAITEFFECT_GET_LASTCHOOSEROLEUID_OFFSET UNITYSDK_OFFSET(0xD2D87C0)
#define RPG_CLIENT_GRIDFIGHTPARTNERTRAITEFFECT_GET_NEEDPLAYEFFECT_OFFSET UNITYSDK_OFFSET(0xD2D7B30)
#define RPG_CLIENT_GRIDFIGHTPARTNERTRAITEFFECT_GET_ROLEOPTIONS_OFFSET UNITYSDK_OFFSET(0xD2D8F30)
#define RPG_CLIENT_GRIDFIGHTPARTNERTRAITEFFECT_GET_SUBTRAITEFFECTS_OFFSET UNITYSDK_OFFSET(0xD2D7B70)
#define RPG_CLIENT_GRIDFIGHTPARTNERTRAITEFFECT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xD2D7C00)
#define RPG_CLIENT_GRIDFIGHTPARTNERTRAITEFFECT_REGISTERPENDINGACTION_OFFSET UNITYSDK_OFFSET(0xD2D9AE0)
#define RPG_CLIENT_GRIDFIGHTPARTNERTRAITEFFECT_SELECTPARTNER_OFFSET UNITYSDK_OFFSET(0xD2DA280)
#define RPG_CLIENT_GRIDFIGHTPARTNERTRAITEFFECT_SET_CHOOSEROLEUID_OFFSET UNITYSDK_OFFSET(0xD2D87B0)
#define RPG_CLIENT_GRIDFIGHTPARTNERTRAITEFFECT_SET_CURPENDINGACTION_OFFSET UNITYSDK_OFFSET(0xD2D9B40)
#define RPG_CLIENT_GRIDFIGHTPARTNERTRAITEFFECT_SET_LASTCHOOSEROLEUID_OFFSET UNITYSDK_OFFSET(0xD2D87D0)
#define RPG_CLIENT_GRIDFIGHTPARTNERTRAITEFFECT_STARTEDIT_OFFSET UNITYSDK_OFFSET(0xD2D9FB0)
#define RPG_CLIENT_GRIDFIGHTPARTNERTRAITEFFECT__CCTOR_OFFSET UNITYSDK_OFFSET(0xD2DA540)
#define RPG_CLIENT_GRIDFIGHTPARTNERTRAITEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xD2D7560)
#define RPG_CLIENT_GRIDFIGHTPARTNERTRAITEFFECT__GETCURRENTSUBTRAITCONFIG_OFFSET UNITYSDK_OFFSET(0xD2D8420)
#define RPG_CLIENT_GRIDFIGHTPARTNERTRAITEFFECT__GETCURROLEOPTIONSFROMTEAM_OFFSET UNITYSDK_OFFSET(0xD2D9BB0)
#define RPG_CLIENT_GRIDFIGHTPARTNERTRAITEFFECT__GET_BONUSTRAITS_B__25_1_OFFSET UNITYSDK_OFFSET(0xD2DA660)
#define RPG_CLIENT_GRIDFIGHTPARTNERTRAITEFFECT__INITROLECHOOSECONFIGCACHE_OFFSET UNITYSDK_OFFSET(0xD2D75E0)
#define RPG_CLIENT_GRIDFIGHTPARTNERTRAITEFFECT__ONEQUIPCOMPONENTCOLLECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0xD2D8250)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::GameCore::GridFightRoleChooseRow*>**)Il2CppClass::FromTypeDefinitionIndex(GridFightPartnerTraitEffect_TypeDefinitionIndex)->GetStaticField(0x41670);
		}
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::GameCore::GridFightRoleChooseRow*>**)Il2CppClass::FromTypeDefinitionIndex(GridFightPartnerTraitEffect_TypeDefinitionIndex)->GetStaticField(0x41678);
		}
		::RPG::Client::GridFightPartnerChooseAction* _CurPendingAction_k__BackingField; // 0x30
		::RPG::Client::GridFightEquipItemConfig* _OverrideEquipItemConfig; // 0x38
