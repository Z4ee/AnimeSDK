...
#define RPG_CLIENT_CHIMERAEVALUATIONPOSITIONCONTROLLER_REFRESHPOSITION_OFFSET UNITYSDK_OFFSET(0x93BA650)
#define RPG_CLIENT_CHIMERAEVALUATIONPOSITIONCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x93BAC40)
#define RPG_CLIENT_CHIMERAEVALUATIONPOSITIONCONTROLLER__REFRESHINFOPOSITION_OFFSET UNITYSDK_OFFSET(0x93BAB10)
#define RPG_CLIENT_CHIMERAEVALUATIONPOSITIONCONTROLLER__REFRESHNAMEPOSITION_OFFSET UNITYSDK_OFFSET(0x93BA8B0)
#define RPG_CLIENT_CHIMERAEVALUATIONPOSITIONCONTROLLER__REFRESHTALKPOPPOSITION_OFFSET UNITYSDK_OFFSET(0x93BA9E0)

namespace RPG::Client
{
	inline static constexpr unsigned int ChimeraEvaluationPositionController_TypeDefinitionIndex = 59381;
