...
#define RPG_CLIENT_SDFOBJECTMONOPLUGIN_GETCHILDRENDERERS_OFFSET UNITYSDK_OFFSET(0xDFF28D0)
#define RPG_CLIENT_SDFOBJECTMONOPLUGIN_GETLOCALTOWORLDMATRIX_OFFSET UNITYSDK_OFFSET(0xDFF24B0)
#define RPG_CLIENT_SDFOBJECTMONOPLUGIN_GETOBJECTID_OFFSET UNITYSDK_OFFSET(0xDFF2290)
#define RPG_CLIENT_SDFOBJECTMONOPLUGIN_GETPRIMARYRENDERER_OFFSET UNITYSDK_OFFSET(0xDFF2990)
#define RPG_CLIENT_SDFOBJECTMONOPLUGIN_GETWORLDBOUNDS_OFFSET UNITYSDK_OFFSET(0xDFF2340)
#define RPG_CLIENT_SDFOBJECTMONOPLUGIN_GETWORLDTOLOCALMATRIX_OFFSET UNITYSDK_OFFSET(0xDFF2620)
#define RPG_CLIENT_SDFOBJECTMONOPLUGIN_HASSURFACECARD_OFFSET UNITYSDK_OFFSET(0xDFF2840)
#define RPG_CLIENT_SDFOBJECTMONOPLUGIN_ISVALID_OFFSET UNITYSDK_OFFSET(0xDFF2790)
#define RPG_CLIENT_SDFOBJECTMONOPLUGIN_UPDATERUNTIMEINFO_OFFSET UNITYSDK_OFFSET(0xDFF0A90)
#define RPG_CLIENT_SDFOBJECTMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xDFF2A20)
