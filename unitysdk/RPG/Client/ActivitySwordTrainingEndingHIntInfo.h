...
#define RPG_CLIENT_ACTIVITYSWORDTRAININGENDINGHINTINFO_CREATE_OFFSET UNITYSDK_OFFSET(0x1962FDB0)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGENDINGHINTINFO_GET_EXAMDAYLIST_OFFSET UNITYSDK_OFFSET(0x19630060)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGENDINGHINTINFO_GET_STORYLINEID_OFFSET UNITYSDK_OFFSET(0x19630040)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGENDINGHINTINFO_GET__ROW_OFFSET UNITYSDK_OFFSET(0x19630080)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGENDINGHINTINFO_SET_EXAMDAYLIST_OFFSET UNITYSDK_OFFSET(0x19630070)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGENDINGHINTINFO_SET_STORYLINEID_OFFSET UNITYSDK_OFFSET(0x19630050)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGENDINGHINTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1962FE50)
#define RPG_CLIENT_ACTIVITYSWORDTRAININGENDINGHINTINFO__INITEXAMDAYS_OFFSET UNITYSDK_OFFSET(0x1962FE60)
