...
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_GET_IFINSTANCENEEDREFRESH_OFFSET UNITYSDK_OFFSET(0xA0F9D70)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_GET_IFUSESIMULATE_OFFSET UNITYSDK_OFFSET(0xA0F9CE0)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0xA0F9D30)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_LATETICK_OFFSET UNITYSDK_OFFSET(0xA0FCFC0)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_0076C796B2045359_OFFSET UNITYSDK_OFFSET(0xA0F9EA0)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_00BC1D03A9F4D997_OFFSET UNITYSDK_OFFSET(0xA100AF0)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_0F2138E056F9294A_OFFSET UNITYSDK_OFFSET(0xA0FCED0)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_14F193ED8E6A3459_OFFSET UNITYSDK_OFFSET(0xA1008C0)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0xA0FA030)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_18982EFD3B740683_OFFSET UNITYSDK_OFFSET(0xA0FA580)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_19578FF14D5CC81B_OFFSET UNITYSDK_OFFSET(0xA100630)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xA0FCE90)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_401F06ADB0C71DD8_OFFSET UNITYSDK_OFFSET(0xA0FD8E0)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0xA0FCDB0)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0xA0FCE20)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xA0FCBF0)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_4857357D5C1BFCE8_OFFSET UNITYSDK_OFFSET(0xA0FA680)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_5790A55946AA509D_1_OFFSET UNITYSDK_OFFSET(0xA101380)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_5790A55946AA509D_2_OFFSET UNITYSDK_OFFSET(0xA1013E0)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_5790A55946AA509D_3_OFFSET UNITYSDK_OFFSET(0xA101440)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_5790A55946AA509D_4_OFFSET UNITYSDK_OFFSET(0xA1014A0)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_5790A55946AA509D_5_OFFSET UNITYSDK_OFFSET(0xA101510)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_5790A55946AA509D_6_OFFSET UNITYSDK_OFFSET(0xA1015F0)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0xA101320)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_81FEFD1B22CE37A2_OFFSET UNITYSDK_OFFSET(0xA0FF2F0)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_A2729CBF245B8253_OFFSET UNITYSDK_OFFSET(0xA100450)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_B1EA412ACAE87C15_OFFSET UNITYSDK_OFFSET(0xA0FA130)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_B5431FFED5A8CE32_OFFSET UNITYSDK_OFFSET(0xA0FFD20)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_D7852DE078ACC1F1_OFFSET UNITYSDK_OFFSET(0xA0FCC50)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_DBA8CB09BF007EAD_OFFSET UNITYSDK_OFFSET(0xA100A60)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_E322D311AC7C7EE8_OFFSET UNITYSDK_OFFSET(0xA101120)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_F0E307B84478A272_OFFSET UNITYSDK_OFFSET(0xA101580)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_F49136C3D3312CEA_OFFSET UNITYSDK_OFFSET(0xA1004D0)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_F4DD08A31BA3F883_OFFSET UNITYSDK_OFFSET(0xA0F9D90)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_SET_IFINSTANCENEEDREFRESH_OFFSET UNITYSDK_OFFSET(0xA0F9D80)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0xA1012F0)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0xA1012E0)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR___IFIXBASEPROXY_LATETICK_OFFSET UNITYSDK_OFFSET(0xA101650)

namespace RPG::Client
{
	inline static constexpr unsigned int DialogEmitterBehavior_TypeDefinitionIndex = 65347;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(DialogEmitterBehavior_TypeDefinitionIndex)->GetStaticField(0x10540);
		}
		static ::System::Int32* StaticGet__MainTexID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(DialogEmitterBehavior_TypeDefinitionIndex)->GetStaticField(0x10544);
		}
