...
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_GET_IFINSTANCENEEDREFRESH_OFFSET UNITYSDK_OFFSET(0xCC9E460)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_GET_IFUSESIMULATE_OFFSET UNITYSDK_OFFSET(0xCC9E3D0)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0xCC9E420)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_GET__USELOCALMATRIXCACHE_OFFSET UNITYSDK_OFFSET(0xCC9E480)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_LATETICK_OFFSET UNITYSDK_OFFSET(0xCCA1B70)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_00BC1D03A9F4D997_OFFSET UNITYSDK_OFFSET(0xCCA7510)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_07F8CB0DBAD2404E_OFFSET UNITYSDK_OFFSET(0xCCA7D00)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_14F193ED8E6A3459_OFFSET UNITYSDK_OFFSET(0xCCA5CA0)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_19844080C13BA28F_OFFSET UNITYSDK_OFFSET(0xCC9EE50)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_270488173B023B4A_OFFSET UNITYSDK_OFFSET(0xCCA56A0)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_28EB11670A8E5A86_OFFSET UNITYSDK_OFFSET(0xCCA17B0)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_2D35BA56E724B985_OFFSET UNITYSDK_OFFSET(0xCC9EFB0)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_2E29E358CA10157F_OFFSET UNITYSDK_OFFSET(0xCCA5720)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xCCA1A30)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0xCCA1950)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0xCCA19C0)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xCCA1750)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_634BCF4C65B50CBB_OFFSET UNITYSDK_OFFSET(0xCCA4E10)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_87318FF00D6BC7EB_OFFSET UNITYSDK_OFFSET(0xCC9E630)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_87D15601B8D27F72_OFFSET UNITYSDK_OFFSET(0xCCA25B0)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_8A8F4D8840527053_OFFSET UNITYSDK_OFFSET(0xCCA1A70)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_9A4DCB2B4ADEB8A9_OFFSET UNITYSDK_OFFSET(0xCC9E900)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_AA169839CB93802A_OFFSET UNITYSDK_OFFSET(0xCC9E800)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_AB7ED27CAB69BE58_OFFSET UNITYSDK_OFFSET(0xCCA41D0)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_B43C848B078B3C34_OFFSET UNITYSDK_OFFSET(0xCCA5E40)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_BA1BB49741CFDFE1_OFFSET UNITYSDK_OFFSET(0xCC9E520)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_D856FC9FAE2DC68F_OFFSET UNITYSDK_OFFSET(0xCCA5980)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_DBA8CB09BF007EAD_OFFSET UNITYSDK_OFFSET(0xCCA7480)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_E322D311AC7C7EE8_OFFSET UNITYSDK_OFFSET(0xCCA7B40)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_METHOD_3_EB7282B6745B4611_OFFSET UNITYSDK_OFFSET(0xCCA6F60)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_SET_IFINSTANCENEEDREFRESH_OFFSET UNITYSDK_OFFSET(0xCC9E470)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0xCCA7E30)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0xCCA7E10)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(DialogEmitterBehavior_TypeDefinitionIndex)->GetStaticField(0x130A0);
		}
		static ::System::Int32* StaticGet_CustomDataID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(DialogEmitterBehavior_TypeDefinitionIndex)->GetStaticField(0x130A4);
		}
