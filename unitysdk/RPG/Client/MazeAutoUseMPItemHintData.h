...
#define RPG_CLIENT_MAZEAUTOUSEMPITEMHINTDATA_GETITEMCOUNT_OFFSET UNITYSDK_OFFSET(0xA877340)
#define RPG_CLIENT_MAZEAUTOUSEMPITEMHINTDATA_GET_ITEMS_OFFSET UNITYSDK_OFFSET(0xA877330)
#define RPG_CLIENT_MAZEAUTOUSEMPITEMHINTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA877390)

namespace RPG::Client
{
	inline static constexpr unsigned int MazeAutoUseMPItemHintData_TypeDefinitionIndex = 57336;
