...
#define RPG_CLIENT_MAZEAUTOUSEMPITEMHINTDATA_GETITEMCOUNT_OFFSET UNITYSDK_OFFSET(0xD686A60)
#define RPG_CLIENT_MAZEAUTOUSEMPITEMHINTDATA_GET_ITEMS_OFFSET UNITYSDK_OFFSET(0xD686A50)
#define RPG_CLIENT_MAZEAUTOUSEMPITEMHINTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD686AB0)
