...
#define RPG_CLIENT_MAZEAUTOUSEMPITEMHINTDATA_GETITEMCOUNT_OFFSET UNITYSDK_OFFSET(0x1AA07B00)
#define RPG_CLIENT_MAZEAUTOUSEMPITEMHINTDATA_GET_ITEMS_OFFSET UNITYSDK_OFFSET(0x1AA07AF0)
#define RPG_CLIENT_MAZEAUTOUSEMPITEMHINTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA07B50)

namespace RPG::Client
{
	inline static constexpr unsigned int MazeAutoUseMPItemHintData_TypeDefinitionIndex = 59392;
