...
#define RPG_CLIENT_GRIDFIGHTPRAYQUESTFINISHTYPE_GET_FINISHTYPE_OFFSET UNITYSDK_OFFSET(0x1CA5B4F0)
#define RPG_CLIENT_GRIDFIGHTPRAYQUESTFINISHTYPE_GET_ISACTIVATED_OFFSET UNITYSDK_OFFSET(0x1CA5B590)
#define RPG_CLIENT_GRIDFIGHTPRAYQUESTFINISHTYPE_GET_PRAYQUESTID_OFFSET UNITYSDK_OFFSET(0x1CA5B450)
#define RPG_CLIENT_GRIDFIGHTPRAYQUESTFINISHTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CA5B440)
#define RPG_CLIENT_GRIDFIGHTPRAYQUESTFINISHTYPE__INNODERANGE_OFFSET UNITYSDK_OFFSET(0x1CA5B6B0)
#define RPG_CLIENT_GRIDFIGHTPRAYQUESTFINISHTYPE__ISROUNDLEFT_OFFSET UNITYSDK_OFFSET(0x1CA5BAE0)
