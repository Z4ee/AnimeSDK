...
#define RPG_CLIENT_ACTIVITYFEVERTIMEPILETOAST_METHOD_5_24B05D2E15A5C3C8_OFFSET UNITYSDK_OFFSET(0xB0BD760)
#define RPG_CLIENT_ACTIVITYFEVERTIMEPILETOAST_METHOD_5_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0xB0BCBF0)
#define RPG_CLIENT_ACTIVITYFEVERTIMEPILETOAST_METHOD_5_485F3682F812D478_OFFSET UNITYSDK_OFFSET(0xB0BD340)
#define RPG_CLIENT_ACTIVITYFEVERTIMEPILETOAST_METHOD_5_4A111163FD8F1931_OFFSET UNITYSDK_OFFSET(0xB0BD470)
#define RPG_CLIENT_ACTIVITYFEVERTIMEPILETOAST_METHOD_5_51CFFE2AF748ECD7_OFFSET UNITYSDK_OFFSET(0xB0BDCC0)
#define RPG_CLIENT_ACTIVITYFEVERTIMEPILETOAST_METHOD_5_82E992240300FB30_OFFSET UNITYSDK_OFFSET(0xB0BDEC0)
#define RPG_CLIENT_ACTIVITYFEVERTIMEPILETOAST_METHOD_5_8A05DE1403363D53_OFFSET UNITYSDK_OFFSET(0xB0BD520)
#define RPG_CLIENT_ACTIVITYFEVERTIMEPILETOAST_METHOD_5_94E49D8C890638E5_OFFSET UNITYSDK_OFFSET(0xB0BDF20)
#define RPG_CLIENT_ACTIVITYFEVERTIMEPILETOAST_METHOD_5_E29D671E35F6F43F_OFFSET UNITYSDK_OFFSET(0xB0BDB90)
#define RPG_CLIENT_ACTIVITYFEVERTIMEPILETOAST_PILE_OFFSET UNITYSDK_OFFSET(0xB0BCB00)
#define RPG_CLIENT_ACTIVITYFEVERTIMEPILETOAST_START_OFFSET UNITYSDK_OFFSET(0xB0BCCE0)
#define RPG_CLIENT_ACTIVITYFEVERTIMEPILETOAST_UPDATE_OFFSET UNITYSDK_OFFSET(0xB0BCFB0)
#define RPG_CLIENT_ACTIVITYFEVERTIMEPILETOAST__CTOR_OFFSET UNITYSDK_OFFSET(0xB0BE2A0)

namespace RPG::Client
{
	inline static constexpr unsigned int ActivityFeverTimePileToast_TypeDefinitionIndex = 66724;
