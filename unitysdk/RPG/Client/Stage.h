...
class Class_1_929238F9B998DC33;
...
#define RPG_CLIENT_STAGE_ACTIVEENVIRONMENT_OFFSET UNITYSDK_OFFSET(0xC900330)
#define RPG_CLIENT_STAGE_ADDENTITYSTREAMING_OFFSET UNITYSDK_OFFSET(0xC900970)
#define RPG_CLIENT_STAGE_ADDMONOEFFECTSTREAMING_OFFSET UNITYSDK_OFFSET(0xC9007C0)
#define RPG_CLIENT_STAGE_ADDSTREAMINGJOBALLFINISHCALLBACKONCE_OFFSET UNITYSDK_OFFSET(0xC8FD5A0)
#define RPG_CLIENT_STAGE_ADDSTREAMINGSOURCE_1_OFFSET UNITYSDK_OFFSET(0xC8FDE20)
#define RPG_CLIENT_STAGE_ADDSTREAMINGSOURCE_OFFSET UNITYSDK_OFFSET(0xC8FDDA0)
#define RPG_CLIENT_STAGE_BEGINPERFORMANCEISLANDFREEZE_OFFSET UNITYSDK_OFFSET(0xC8FE100)
#define RPG_CLIENT_STAGE_CANCELSTREAMINGJOBALLFINISHCALLBACKONCE_OFFSET UNITYSDK_OFFSET(0xC8FD630)
#define RPG_CLIENT_STAGE_CLEARADDITIONCENTERS_OFFSET UNITYSDK_OFFSET(0xC8FDF20)
#define RPG_CLIENT_STAGE_CLEARSIDEEFFECT_OFFSET UNITYSDK_OFFSET(0xC8FFC60)
#define RPG_CLIENT_STAGE_COLLECTBLOCKSBYTAG_1_OFFSET UNITYSDK_OFFSET(0xC8FFA90)
#define RPG_CLIENT_STAGE_COLLECTBLOCKSBYTAG_OFFSET UNITYSDK_OFFSET(0xC8FF930)
#define RPG_CLIENT_STAGE_COLLECTSTREAMINGBLOCKBYNAMESET_OFFSET UNITYSDK_OFFSET(0xC8FF9A0)
#define RPG_CLIENT_STAGE_DEBUGREPORTWHYNOTBATTLEAREALOADFINISH_OFFSET UNITYSDK_OFFSET(0xC8FEFF0)
#define RPG_CLIENT_STAGE_DEBUGSETAREADELTAPOSITION_OFFSET UNITYSDK_OFFSET(0xC8FD430)
#define RPG_CLIENT_STAGE_DESTROY_OFFSET UNITYSDK_OFFSET(0xC8FFD40)
#define RPG_CLIENT_STAGE_ENABLEDYNAMICBLOCKENVPROFILEDATA_OFFSET UNITYSDK_OFFSET(0xC9018C0)
#define RPG_CLIENT_STAGE_ENABLESTREAMINGDEBUGSCRIPT_OFFSET UNITYSDK_OFFSET(0xC9017B0)
#define RPG_CLIENT_STAGE_ENDOFTICK_OFFSET UNITYSDK_OFFSET(0xC8FF440)
#define RPG_CLIENT_STAGE_ENDPERFORMANCEISLANDFREEZE_OFFSET UNITYSDK_OFFSET(0xC8FE150)
#define RPG_CLIENT_STAGE_FORCEACTIVEBLOCKSENTITY_OFFSET UNITYSDK_OFFSET(0xC8FF660)
#define RPG_CLIENT_STAGE_FORCEMONOEFFECTSTREAMINGUPDATE_OFFSET UNITYSDK_OFFSET(0xC9008D0)
#define RPG_CLIENT_STAGE_FOREACHSTREAMINGBLOCKS_OFFSET UNITYSDK_OFFSET(0xC8FFA30)
#define RPG_CLIENT_STAGE_GETALIASINSTANCEANDMARKDISABLESTREAMING_OFFSET UNITYSDK_OFFSET(0xC8FC9F0)
#define RPG_CLIENT_STAGE_GETALIASINSTANCEANDMARK_OFFSET UNITYSDK_OFFSET(0xC900450)
#define RPG_CLIENT_STAGE_GETALIASITEMDATA_OFFSET UNITYSDK_OFFSET(0xC900590)
#define RPG_CLIENT_STAGE_GETALIASITEMGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0xC900670)
#define RPG_CLIENT_STAGE_GETBLOCKCONFIGS_OFFSET UNITYSDK_OFFSET(0xC8FFBD0)
#define RPG_CLIENT_STAGE_GETBLOCKLIST_OFFSET UNITYSDK_OFFSET(0xC8FC900)
#define RPG_CLIENT_STAGE_GETBLOCKNODECONFIGS_OFFSET UNITYSDK_OFFSET(0xC8FFC10)
#define RPG_CLIENT_STAGE_GETBLOCKSWITHOUTTAG_OFFSET UNITYSDK_OFFSET(0xC8FC6E0)
#define RPG_CLIENT_STAGE_GETJSONPATH_OFFSET UNITYSDK_OFFSET(0xC8FD060)
#define RPG_CLIENT_STAGE_GETPERSISTENTINSTOBJ_OFFSET UNITYSDK_OFFSET(0xC900600)
#define RPG_CLIENT_STAGE_GETPERSISTENTTAGROOT_OFFSET UNITYSDK_OFFSET(0xC8FF8D0)
#define RPG_CLIENT_STAGE_GETRANGEENTITY_OFFSET UNITYSDK_OFFSET(0xC8FD4B0)
#define RPG_CLIENT_STAGE_GETREGIONPATH_OFFSET UNITYSDK_OFFSET(0xC8FD0B0)
#define RPG_CLIENT_STAGE_GETTRANSFORMTOOL_OFFSET UNITYSDK_OFFSET(0xC901680)
#define RPG_CLIENT_STAGE_GET_ACTIVESTAGE_OFFSET UNITYSDK_OFFSET(0xC901E50)
#define RPG_CLIENT_STAGE_GET_ENABLENORMDISTANCELODTEMPLATE_OFFSET UNITYSDK_OFFSET(0xC901DB0)
#define RPG_CLIENT_STAGE_GET_HOYOTAGRUNTIMECONTAINER_OFFSET UNITYSDK_OFFSET(0xC8FDCD0)
#define RPG_CLIENT_STAGE_GET_ISSUBSTAGE_OFFSET UNITYSDK_OFFSET(0xC901E70)
#define RPG_CLIENT_STAGE_GET_MAPDEF_OFFSET UNITYSDK_OFFSET(0xC901D50)
#define RPG_CLIENT_STAGE_GET_OPENWORLD_OFFSET UNITYSDK_OFFSET(0xC901920)
#define RPG_CLIENT_STAGE_GET_PARENTSTAGE_OFFSET UNITYSDK_OFFSET(0xC901E80)
#define RPG_CLIENT_STAGE_GET_REGIONMANAGER_OFFSET UNITYSDK_OFFSET(0xC8FEB90)
#define RPG_CLIENT_STAGE_GET_STAGEAUTOGENCONFIG_OFFSET UNITYSDK_OFFSET(0xC901D90)
#define RPG_CLIENT_STAGE_GET_STAGEROOTOBJ_OFFSET UNITYSDK_OFFSET(0xC901D70)
#define RPG_CLIENT_STAGE_INACTIVEENVIROMENT_OFFSET UNITYSDK_OFFSET(0xC9003C0)
#define RPG_CLIENT_STAGE_INITBATTLEAREA_OFFSET UNITYSDK_OFFSET(0xC8FED20)
#define RPG_CLIENT_STAGE_INITBLOCKNODEPREFABINS_ALL_OFFSET UNITYSDK_OFFSET(0xC8FC940)
#define RPG_CLIENT_STAGE_INITOPENWORLD_OFFSET UNITYSDK_OFFSET(0xC8FEC00)
#define RPG_CLIENT_STAGE_INITREGIONMANAGER_OFFSET UNITYSDK_OFFSET(0xC8FEAD0)
#define RPG_CLIENT_STAGE_INITSTAGENAVMESH_OFFSET UNITYSDK_OFFSET(0xC8FC5C0)
#define RPG_CLIENT_STAGE_INITSTAGEROOTOBJ_OFFSET UNITYSDK_OFFSET(0xC8FC4E0)
#define RPG_CLIENT_STAGE_INVOKEUNITYGOLOGICRESETWITHTAMONO_OFFSET UNITYSDK_OFFSET(0xC8FFCF0)
#define RPG_CLIENT_STAGE_ISBATTLEAREALOADFINISH_OFFSET UNITYSDK_OFFSET(0xC8FEF60)
#define RPG_CLIENT_STAGE_ISSTAGEUSELIGHTV2_OFFSET UNITYSDK_OFFSET(0xC8FDBB0)
#define RPG_CLIENT_STAGE_ISSTREAMINGJOBFINISHED_OFFSET UNITYSDK_OFFSET(0xC8FEEA0)
#define RPG_CLIENT_STAGE_ISSTREAMINGLOADFINISH_OFFSET UNITYSDK_OFFSET(0xC8FEE20)
#define RPG_CLIENT_STAGE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xC8FF3C0)
#define RPG_CLIENT_STAGE_LOADAREA_OFFSET UNITYSDK_OFFSET(0xC8FD3C0)
#define RPG_CLIENT_STAGE_LOADBATTLEAREABLOCK_OFFSET UNITYSDK_OFFSET(0xC8FFB00)
#define RPG_CLIENT_STAGE_LOADBLOCKSASSETSALL_OFFSET UNITYSDK_OFFSET(0xC8FC140)
#define RPG_CLIENT_STAGE_LOADBLOCKS_OFFSET UNITYSDK_OFFSET(0xC8FC1E0)
#define RPG_CLIENT_STAGE_LOAD_OFFSET UNITYSDK_OFFSET(0xC8FE1C0)
#define RPG_CLIENT_STAGE_LOCKMAINSTREAMINGSOURCE_OFFSET UNITYSDK_OFFSET(0xC8FDF80)
#define RPG_CLIENT_STAGE_ONENTERMAP_OFFSET UNITYSDK_OFFSET(0xC8FF0B0)
#define RPG_CLIENT_STAGE_ONMONOEFFECTPOSITIONCHANGED_OFFSET UNITYSDK_OFFSET(0xC9015D0)
#define RPG_CLIENT_STAGE_ONSTREAMINGLOADFINISH_OFFSET UNITYSDK_OFFSET(0xC8FF040)
#define RPG_CLIENT_STAGE_PREINITOPENWORLD_OFFSET UNITYSDK_OFFSET(0xC8FE9C0)
#define RPG_CLIENT_STAGE_REMOVEADDITIONCENTER_OFFSET UNITYSDK_OFFSET(0xC8FDEB0)
#define RPG_CLIENT_STAGE_REMOVEBLOCK_OFFSET UNITYSDK_OFFSET(0xC8FCB70)
#define RPG_CLIENT_STAGE_REMOVEENTITYSTREAMING_OFFSET UNITYSDK_OFFSET(0xC9009E0)
#define RPG_CLIENT_STAGE_REMOVEMONOEFFECTSTREAMING_OFFSET UNITYSDK_OFFSET(0xC900820)
#define RPG_CLIENT_STAGE_RUNTIMEADDRENDERSTUB_1_OFFSET UNITYSDK_OFFSET(0xC8FD7C0)
#define RPG_CLIENT_STAGE_RUNTIMEADDRENDERSTUB_OFFSET UNITYSDK_OFFSET(0xC8FD6A0)
#define RPG_CLIENT_STAGE_RUNTIMEADDSTREAMINGITEM_1_OFFSET UNITYSDK_OFFSET(0xC900B10)
#define RPG_CLIENT_STAGE_RUNTIMEADDSTREAMINGITEM_2_OFFSET UNITYSDK_OFFSET(0xC9011A0)
#define RPG_CLIENT_STAGE_RUNTIMEADDSTREAMINGITEM_OFFSET UNITYSDK_OFFSET(0xC900A40)
#define RPG_CLIENT_STAGE_RUNTIMEDYNAMICLOADOPTIONALBLOCK_OFFSET UNITYSDK_OFFSET(0xC9017F0)
#define RPG_CLIENT_STAGE_RUNTIMEDYNAMICREMOVEBLOCK_OFFSET UNITYSDK_OFFSET(0xC901860)
#define RPG_CLIENT_STAGE_RUNTIMELOADOPTIONALBLOCKSCONFIG_OFFSET UNITYSDK_OFFSET(0xC8FD2F0)
#define RPG_CLIENT_STAGE_RUNTIMEREMOVERENDERSTUB_OFFSET UNITYSDK_OFFSET(0xC8FD750)
#define RPG_CLIENT_STAGE_RUNTIMEREMOVESTREAMINGITEM_OFFSET UNITYSDK_OFFSET(0xC901430)
#define RPG_CLIENT_STAGE_RUNTIMESETSTREAMINGENABLE_OFFSET UNITYSDK_OFFSET(0xC901740)
#define RPG_CLIENT_STAGE_RUNTIMESETSTREAMINGITEMVISIBLE_OFFSET UNITYSDK_OFFSET(0xC9014C0)
#define RPG_CLIENT_STAGE_SETACTIVE_OFFSET UNITYSDK_OFFSET(0xC901BE0)
#define RPG_CLIENT_STAGE_SETADDITIONCENTER_OFFSET UNITYSDK_OFFSET(0xC8FDD30)
#define RPG_CLIENT_STAGE_SETALLBLOCKVISIBLE_OFFSET UNITYSDK_OFFSET(0xC8FD280)
#define RPG_CLIENT_STAGE_SETBLOCKFOCUSWITHNAMES_OFFSET UNITYSDK_OFFSET(0xC8FD530)
#define RPG_CLIENT_STAGE_SETBLOCKFORCEHIDEEXCEPTNAMES_OFFSET UNITYSDK_OFFSET(0xC8FF5F0)
#define RPG_CLIENT_STAGE_SETBLOCKFORCEHIDEEXCEPTTAGNAME_OFFSET UNITYSDK_OFFSET(0xC8FF580)
#define RPG_CLIENT_STAGE_SETBLOCKFORCEHLODWITHTAGS_OFFSET UNITYSDK_OFFSET(0xC8FF510)
#define RPG_CLIENT_STAGE_SETBLOCKVISIBLEBYALIAS_OFFSET UNITYSDK_OFFSET(0xC8FD200)
#define RPG_CLIENT_STAGE_SETBLOCKVISIBLEBYHOYOTAG_OFFSET UNITYSDK_OFFSET(0xC8FD180)
#define RPG_CLIENT_STAGE_SETBLOCKVISIBLEBYTAG_OFFSET UNITYSDK_OFFSET(0xC8FD100)
#define RPG_CLIENT_STAGE_SETFORCESTREAMING_OFFSET UNITYSDK_OFFSET(0xC901630)
#define RPG_CLIENT_STAGE_SETLOADFINISHCALLBACK_OFFSET UNITYSDK_OFFSET(0xC8FEDA0)
#define RPG_CLIENT_STAGE_SETMAPDEF_OFFSET UNITYSDK_OFFSET(0xC8FE970)
#define RPG_CLIENT_STAGE_SETNAVMESHACTIVE_OFFSET UNITYSDK_OFFSET(0xC901B10)
#define RPG_CLIENT_STAGE_SETPARENTSTAGE_OFFSET UNITYSDK_OFFSET(0xC8FE920)
#define RPG_CLIENT_STAGE_SETSUBSTAGEACTIVESTATE_OFFSET UNITYSDK_OFFSET(0xC901C50)
#define RPG_CLIENT_STAGE_SETUNLOADENABLE_OFFSET UNITYSDK_OFFSET(0xC900760)
#define RPG_CLIENT_STAGE_SET_ACTIVESTAGE_OFFSET UNITYSDK_OFFSET(0xC901E60)
#define RPG_CLIENT_STAGE_SET_MAPDEF_OFFSET UNITYSDK_OFFSET(0xC901D60)
#define RPG_CLIENT_STAGE_SET_PARENTSTAGE_OFFSET UNITYSDK_OFFSET(0xC901E90)
#define RPG_CLIENT_STAGE_SET_STAGEAUTOGENCONFIG_OFFSET UNITYSDK_OFFSET(0xC901DA0)
#define RPG_CLIENT_STAGE_SET_STAGEROOTOBJ_OFFSET UNITYSDK_OFFSET(0xC901D80)
#define RPG_CLIENT_STAGE_SHOWALLBLOCKS_OFFSET UNITYSDK_OFFSET(0xC8FF880)
#define RPG_CLIENT_STAGE_SHOWAREAONLY_OFFSET UNITYSDK_OFFSET(0xC8FD350)
#define RPG_CLIENT_STAGE_SYNCPLAYERPOSITION_OFFSET UNITYSDK_OFFSET(0xC901A40)
#define RPG_CLIENT_STAGE_TRYGETSTAGEEXCEPTIONDETAIL_OFFSET UNITYSDK_OFFSET(0xC901930)
#define RPG_CLIENT_STAGE_TRYREGISTERRENDERSTUBREBUILDCALLBACK_OFFSET UNITYSDK_OFFSET(0xC9006E0)
#define RPG_CLIENT_STAGE_UNLOADALLRESOURCE_OFFSET UNITYSDK_OFFSET(0xC8FF7C0)
#define RPG_CLIENT_STAGE_UNLOADBATTLEAREABLOCK_OFFSET UNITYSDK_OFFSET(0xC8FF4C0)
#define RPG_CLIENT_STAGE_UNLOADPERSISTENTRESOURCE_OFFSET UNITYSDK_OFFSET(0xC8FF830)
#define RPG_CLIENT_STAGE_UNLOADSTREAMINGRESOURCE_OFFSET UNITYSDK_OFFSET(0xC8FF770)
#define RPG_CLIENT_STAGE_UNLOCKMAINSTREAMINGSOURCE_OFFSET UNITYSDK_OFFSET(0xC8FE050)
#define RPG_CLIENT_STAGE_UNMARKALIASINSTANCE_OFFSET UNITYSDK_OFFSET(0xC900510)
#define RPG_CLIENT_STAGE_UPDATEITEMLODTEMPLATE_OFFSET UNITYSDK_OFFSET(0xC901550)
#define RPG_CLIENT_STAGE_UPDATESTREAMINGLOADFINISH_OFFSET UNITYSDK_OFFSET(0xC8FF2C0)
#define RPG_CLIENT_STAGE_UPDATE_OFFSET UNITYSDK_OFFSET(0xC8FF100)
#define RPG_CLIENT_STAGE_VISIBLEPCONLYBLOCK_OFFSET UNITYSDK_OFFSET(0xC9016E0)
#define RPG_CLIENT_STAGE__CTOR_OFFSET UNITYSDK_OFFSET(0xC901EA0)
#define RPG_CLIENT_STAGE__UPDATEAFTEROPENWORLDUPDATE_OFFSET UNITYSDK_OFFSET(0xC8FF360)

namespace RPG::Client
{
	inline static constexpr unsigned int Stage_TypeDefinitionIndex = 64973;

	class Stage : public ::System::Object
	{
	public:
		::RPG::GameCore::StageBaseConfig* StageConfig; // 0x10
		::System::Collections::Generic::List_1<::Class_1_CC37BE43AC1781E1*>* _blockConfigList; // 0x18
		::Class_1_3948F09825CE1BA8* _RegionManager; // 0x20
		::System::String* _MonsterNavmeshDataPath; // 0x28
		::System::String* _strStageDir; // 0x30
		::UnityEngine::AI::NavMeshData* _NavmeshData; // 0x38
		::System::Action* _LoadFinishCallback; // 0x40
		::System::Collections::Generic::List_1<::Class_1_929238F9B998DC33*>* _blockList; // 0x48
		::Class_1_D70A30D666F20D90* _OpenWorld; // 0x50
		::RPG::Client::MapDef* _MapDef_k__BackingField; // 0x58
		::RPG::GameCore::StageAutoGenConfig* _StageAutoGenConfig_k__BackingField; // 0x60
		::UnityEngine::GameObject* _StageRootObj; // 0x68
		::System::Collections::Generic::HashSet_1<::System::Action*>* _StreamingJobAllFinishCallback; // 0x70
		::Class_2_2CF600F518D344A2* _ParentStage_k__BackingField; // 0x78
		::System::String* _strJsonPath; // 0x80
		::System::String* _NavmeshDataPath; // 0x88
		::UnityEngine::AI::NavMeshData* _MonsterNavmeshData; // 0x90
		::Class_2_7D53347CD75A5D8B* _StageAssetLoader; // 0x98
		::System::Collections::Generic::List_1<::Class_1_CC37BE43AC1781E1*>* _FullBlockConfigList; // 0xA0
		::System::String* Name; // 0xA8
		::System::String* FloorID; // 0xB0
		::System::Boolean _ActiveStage_k__BackingField; // 0xB8
		::System::Boolean _IsSubStageActive; // 0xB9
		::System::Boolean IsPreload; // 0xBA
		...
		::System::Collections::Generic::List_1<::Class_1_CC37BE43AC1781E1*>* LoadBlocks()
		{
			return ((::System::Collections::Generic::List_1<::Class_1_CC37BE43AC1781E1*>*(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_STAGE_LOADBLOCKS_OFFSET))(this);
		}

		::System::Collections::Generic::List_1<::Class_1_929238F9B998DC33*>* GetBlocksWithoutTag(::System::String* a1)
		{
			return ((::System::Collections::Generic::List_1<::Class_1_929238F9B998DC33*>*(*)(::PVOID, ::System::String*))((::PBYTE)hIl2Cpp + RPG_CLIENT_STAGE_GETBLOCKSWITHOUTTAG_OFFSET))(this, a1);
		}

		::System::Collections::Generic::List_1<::Class_1_929238F9B998DC33*>* GetBlockList()
		{
			return ((::System::Collections::Generic::List_1<::Class_1_929238F9B998DC33*>*(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_STAGE_GETBLOCKLIST_OFFSET))(this);
		}
		...
		{
			return ((::RPG::Client::OpenWorld::StreamingItemData*(*)(::PVOID, ::System::String*, ::Struct_2_1A7849E5CC498A4A, ::System::String*, ::System::Boolean))((::PBYTE)hIl2Cpp + RPG_CLIENT_STAGE_RUNTIMEADDRENDERSTUB_OFFSET))(this, a1, a2, a3, a4);
		}
		...
		::System::Collections::Generic::IEnumerator_1<::Class_0_16E4307DCC419505_278*>* OnStreamingLoadFinish()
		{
			return ((::System::Collections::Generic::IEnumerator_1<::Class_0_16E4307DCC419505_278*>*(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_STAGE_ONSTREAMINGLOADFINISH_OFFSET))(this);
		}
		...
		::System::Collections::Generic::List_1<::Class_1_CC37BE43AC1781E1*>* GetBlockConfigs()
		{
			return ((::System::Collections::Generic::List_1<::Class_1_CC37BE43AC1781E1*>*(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_STAGE_GETBLOCKCONFIGS_OFFSET))(this);
		}

		::System::Collections::Generic::List_1<::Class_1_CC37BE43AC1781E1*>* GetBlockNodeConfigs()
		{
			return ((::System::Collections::Generic::List_1<::Class_1_CC37BE43AC1781E1*>*(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_STAGE_GETBLOCKNODECONFIGS_OFFSET))(this);
		}
		...
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_2_F15F6264C4987650*, ::System::Boolean))((::PBYTE)hIl2Cpp + RPG_CLIENT_STAGE_ADDENTITYSTREAMING_OFFSET))(this, a1, a2);
		}

		::System::Void RemoveEntityStreaming(::Class_2_F15F6264C4987650* a1)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_F15F6264C4987650*))((::PBYTE)hIl2Cpp + RPG_CLIENT_STAGE_REMOVEENTITYSTREAMING_OFFSET))(this, a1);
		}
