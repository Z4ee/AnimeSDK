...
#define RPG_CLIENT_CHOOSEDELIVERYREWARDDATA_GET_DELIVERYID_OFFSET UNITYSDK_OFFSET(0xCC21770)
#define RPG_CLIENT_CHOOSEDELIVERYREWARDDATA_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0xCC21790)
#define RPG_CLIENT_CHOOSEDELIVERYREWARDDATA_GET_REWARDLIST_OFFSET UNITYSDK_OFFSET(0xCC217B0)
#define RPG_CLIENT_CHOOSEDELIVERYREWARDDATA_ISAVATARCARDREWARD_OFFSET UNITYSDK_OFFSET(0xCC217D0)
#define RPG_CLIENT_CHOOSEDELIVERYREWARDDATA_SET_DELIVERYID_OFFSET UNITYSDK_OFFSET(0xCC21780)
#define RPG_CLIENT_CHOOSEDELIVERYREWARDDATA_SET_GROUPID_OFFSET UNITYSDK_OFFSET(0xCC217A0)
#define RPG_CLIENT_CHOOSEDELIVERYREWARDDATA_SET_REWARDLIST_OFFSET UNITYSDK_OFFSET(0xCC217C0)
#define RPG_CLIENT_CHOOSEDELIVERYREWARDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCC20B60)
