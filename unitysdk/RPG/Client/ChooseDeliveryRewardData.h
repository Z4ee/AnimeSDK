...
#define RPG_CLIENT_CHOOSEDELIVERYREWARDDATA_GET_DELIVERYID_OFFSET UNITYSDK_OFFSET(0x1ADF2070)
#define RPG_CLIENT_CHOOSEDELIVERYREWARDDATA_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x1ADF2090)
#define RPG_CLIENT_CHOOSEDELIVERYREWARDDATA_GET_REWARDLIST_OFFSET UNITYSDK_OFFSET(0x1ADF20B0)
#define RPG_CLIENT_CHOOSEDELIVERYREWARDDATA_ISAVATARCARDREWARD_OFFSET UNITYSDK_OFFSET(0x1ADF20D0)
#define RPG_CLIENT_CHOOSEDELIVERYREWARDDATA_SET_DELIVERYID_OFFSET UNITYSDK_OFFSET(0x1ADF2080)
#define RPG_CLIENT_CHOOSEDELIVERYREWARDDATA_SET_GROUPID_OFFSET UNITYSDK_OFFSET(0x1ADF20A0)
#define RPG_CLIENT_CHOOSEDELIVERYREWARDDATA_SET_REWARDLIST_OFFSET UNITYSDK_OFFSET(0x1ADF20C0)
#define RPG_CLIENT_CHOOSEDELIVERYREWARDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADF14B0)
