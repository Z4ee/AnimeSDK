...
#define RPG_CLIENT_MONOEMO2DATLAS_AWAKE_OFFSET UNITYSDK_OFFSET(0xD7D2DF0)
#define RPG_CLIENT_MONOEMO2DATLAS_GET_ORIGINALCONFIG_OFFSET UNITYSDK_OFFSET(0xD7D2D50)
#define RPG_CLIENT_MONOEMO2DATLAS_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xD7D2FD0)
#define RPG_CLIENT_MONOEMO2DATLAS_ONENABLE_OFFSET UNITYSDK_OFFSET(0xD7D2EC0)
#define RPG_CLIENT_MONOEMO2DATLAS_ONLIGHTWEIGHTACTIVATE_OFFSET UNITYSDK_OFFSET(0xD7D3040)
#define RPG_CLIENT_MONOEMO2DATLAS_ONLIGHTWEIGHTDEACTIVATE_OFFSET UNITYSDK_OFFSET(0xD7D30C0)
#define RPG_CLIENT_MONOEMO2DATLAS_ONMATERIALRESET_OFFSET UNITYSDK_OFFSET(0xD7D2D80)
#define RPG_CLIENT_MONOEMO2DATLAS_SET_ORIGINALCONFIG_OFFSET UNITYSDK_OFFSET(0xD7D2D70)
#define RPG_CLIENT_MONOEMO2DATLAS__CTOR_OFFSET UNITYSDK_OFFSET(0xD7D3130)
