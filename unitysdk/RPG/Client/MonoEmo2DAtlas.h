...
#define RPG_CLIENT_MONOEMO2DATLAS_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B3A00F0)
#define RPG_CLIENT_MONOEMO2DATLAS_GET_ORIGINALCONFIG_OFFSET UNITYSDK_OFFSET(0x1B3A0050)
#define RPG_CLIENT_MONOEMO2DATLAS_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1B3A02D0)
#define RPG_CLIENT_MONOEMO2DATLAS_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B3A01C0)
#define RPG_CLIENT_MONOEMO2DATLAS_ONLIGHTWEIGHTACTIVATE_OFFSET UNITYSDK_OFFSET(0x1B3A0340)
#define RPG_CLIENT_MONOEMO2DATLAS_ONLIGHTWEIGHTDEACTIVATE_OFFSET UNITYSDK_OFFSET(0x1B3A03C0)
#define RPG_CLIENT_MONOEMO2DATLAS_ONMATERIALRESET_OFFSET UNITYSDK_OFFSET(0x1B3A0080)
#define RPG_CLIENT_MONOEMO2DATLAS_SET_ORIGINALCONFIG_OFFSET UNITYSDK_OFFSET(0x1B3A0070)
#define RPG_CLIENT_MONOEMO2DATLAS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3A0430)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEmo2DAtlas_TypeDefinitionIndex = 71103;

	class MonoEmo2DAtlas : public ::UnityEngine::MonoBehaviour
	{
	public:
		::RPG::Client::Emo2DAtlasConfig Config; // 0x18
		::Class_2_5F562FF13C3DED90* KADDKEGNCHE; // 0x30
