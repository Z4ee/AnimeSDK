...
#define RPG_CLIENT_MONOTVSCREENCONTROL_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A3508E0)
#define RPG_CLIENT_MONOTVSCREENCONTROL_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x1A350790)
#define RPG_CLIENT_MONOTVSCREENCONTROL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A350A30)
#define RPG_CLIENT_MONOTVSCREENCONTROL_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A350940)
#define RPG_CLIENT_MONOTVSCREENCONTROL_PLAYCUSTOMTEXTURE_OFFSET UNITYSDK_OFFSET(0x1A3506A0)
#define RPG_CLIENT_MONOTVSCREENCONTROL_STOPCUSTOMTEXTURE_OFFSET UNITYSDK_OFFSET(0x1A350800)
#define RPG_CLIENT_MONOTVSCREENCONTROL_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A3509B0)
#define RPG_CLIENT_MONOTVSCREENCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A350AC0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoTVScreenControl_TypeDefinitionIndex = 67585;
