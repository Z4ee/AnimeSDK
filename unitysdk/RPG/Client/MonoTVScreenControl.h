...
#define RPG_CLIENT_MONOTVSCREENCONTROL_AWAKE_OFFSET UNITYSDK_OFFSET(0xA9FC7F0)
#define RPG_CLIENT_MONOTVSCREENCONTROL_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xA9FC6A0)
#define RPG_CLIENT_MONOTVSCREENCONTROL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xA9FC940)
#define RPG_CLIENT_MONOTVSCREENCONTROL_ONENABLE_OFFSET UNITYSDK_OFFSET(0xA9FC850)
#define RPG_CLIENT_MONOTVSCREENCONTROL_PLAYCUSTOMTEXTURE_OFFSET UNITYSDK_OFFSET(0xA9FC5B0)
#define RPG_CLIENT_MONOTVSCREENCONTROL_STOPCUSTOMTEXTURE_OFFSET UNITYSDK_OFFSET(0xA9FC710)
#define RPG_CLIENT_MONOTVSCREENCONTROL_UPDATE_OFFSET UNITYSDK_OFFSET(0xA9FC8C0)
#define RPG_CLIENT_MONOTVSCREENCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xA9FC9D0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoTVScreenControl_TypeDefinitionIndex = 65233;
