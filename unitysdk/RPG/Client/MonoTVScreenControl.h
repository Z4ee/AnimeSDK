...
class Class_2_E0DBCC25C40E53BE;
namespace System { class String; }
namespace UnityEngine { class Renderer; }
namespace UnityEngine { class Texture2D; }

#define RPG_CLIENT_MONOTVSCREENCONTROL_AWAKE_OFFSET UNITYSDK_OFFSET(0xC14A930)
#define RPG_CLIENT_MONOTVSCREENCONTROL_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xC14A7E0)
#define RPG_CLIENT_MONOTVSCREENCONTROL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC14AA80)
#define RPG_CLIENT_MONOTVSCREENCONTROL_ONENABLE_OFFSET UNITYSDK_OFFSET(0xC14A990)
#define RPG_CLIENT_MONOTVSCREENCONTROL_PLAYCUSTOMTEXTURE_OFFSET UNITYSDK_OFFSET(0xC14A6F0)
#define RPG_CLIENT_MONOTVSCREENCONTROL_STOPCUSTOMTEXTURE_OFFSET UNITYSDK_OFFSET(0xC14A850)
#define RPG_CLIENT_MONOTVSCREENCONTROL_UPDATE_OFFSET UNITYSDK_OFFSET(0xC14AA00)
#define RPG_CLIENT_MONOTVSCREENCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC14AB10)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoTVScreenControl_TypeDefinitionIndex = 66160;
	...
	public:
		...
		::Class_2_E0DBCC25C40E53BE* _Behavior; // 0xA8
