...
#define RPG_CLIENT_FLOWERRINGSCATTERMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x190E3140)

namespace RPG::Client
{
	inline static constexpr unsigned int FlowerRingScatterMonoPlugin_TypeDefinitionIndex = 70570;
