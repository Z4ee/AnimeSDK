...
#define RPG_CLIENT_FLOWERRINGSCATTERMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xBA645C0)

namespace RPG::Client
{
	inline static constexpr unsigned int FlowerRingScatterMonoPlugin_TypeDefinitionIndex = 66022;
