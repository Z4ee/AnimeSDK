...
#define RPG_CLIENT_FLOWERRINGSCATTERMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x16D15E10)

namespace RPG::Client
{
	inline static constexpr unsigned int FlowerRingScatterMonoPlugin_TypeDefinitionIndex = 67447;
