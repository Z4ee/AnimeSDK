...
#define RPG_CLIENT_NETPACKET_CLEARDATA_OFFSET UNITYSDK_OFFSET(0x1D7B0500)
#define RPG_CLIENT_NETPACKET_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1D7A7500)
#define RPG_CLIENT_NETPACKET_GETBODYLEN_OFFSET UNITYSDK_OFFSET(0x1D7B0350)
#define RPG_CLIENT_NETPACKET_GETCMDID_OFFSET UNITYSDK_OFFSET(0x1D799230)
#define RPG_CLIENT_NETPACKET_GETDATA_OFFSET UNITYSDK_OFFSET(0x1D7B0430)
#define RPG_CLIENT_NETPACKET_GETHEADLEN_OFFSET UNITYSDK_OFFSET(0x1D7B0300)
#define RPG_CLIENT_NETPACKET_GETHEADMAGIC_OFFSET UNITYSDK_OFFSET(0x1D7B02A0)
#define RPG_CLIENT_NETPACKET_GETLENGTH_OFFSET UNITYSDK_OFFSET(0x1D7B0510)
#define RPG_CLIENT_NETPACKET_GETPACKETID_OFFSET UNITYSDK_OFFSET(0x1D7B03B0)
#define RPG_CLIENT_NETPACKET_GETPACKETLEN_OFFSET UNITYSDK_OFFSET(0x1D7AA0E0)
#define RPG_CLIENT_NETPACKET_GETPACKETRECVTIMEMS_OFFSET UNITYSDK_OFFSET(0x1D7B0420)
#define RPG_CLIENT_NETPACKET_GETRAWDATA_OFFSET UNITYSDK_OFFSET(0x1D7B0440)
#define RPG_CLIENT_NETPACKET_GETTAILMAGIC_OFFSET UNITYSDK_OFFSET(0x1D7B03C0)
#define RPG_CLIENT_NETPACKET_ISDATAEMPTY_OFFSET UNITYSDK_OFFSET(0x1D799220)
#define RPG_CLIENT_NETPACKET_ONNEW_OFFSET UNITYSDK_OFFSET(0x1D7B0160)
#define RPG_CLIENT_NETPACKET_ONRECYCLE_OFFSET UNITYSDK_OFFSET(0x1D7B0170)
#define RPG_CLIENT_NETPACKET_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1D7A6AE0)
#define RPG_CLIENT_NETPACKET_SETBODYLEN_OFFSET UNITYSDK_OFFSET(0x1D7B05F0)
#define RPG_CLIENT_NETPACKET_SETCMDID_OFFSET UNITYSDK_OFFSET(0x1D797F40)
#define RPG_CLIENT_NETPACKET_SETDATA_OFFSET UNITYSDK_OFFSET(0x1D7B0650)
#define RPG_CLIENT_NETPACKET_SETHEADLEN_OFFSET UNITYSDK_OFFSET(0x1D7B05A0)
#define RPG_CLIENT_NETPACKET_SETPACKETID_OFFSET UNITYSDK_OFFSET(0x1D7B0590)
#define RPG_CLIENT_NETPACKET_SETPACKETRECVTIMEMS_OFFSET UNITYSDK_OFFSET(0x1D7B0690)
#define RPG_CLIENT_NETPACKET_SETRAWDATA_OFFSET UNITYSDK_OFFSET(0x1D7B0670)
#define RPG_CLIENT_NETPACKET__CTOR_OFFSET UNITYSDK_OFFSET(0x1D797D30)
...
namespace RPG::Client
{
	...
	public:
		...
		::Class_1_21DCD4640D389503_43* _MsgProtoHead; // 0x18
		::Google::Protobuf::IMessage* _Data; // 0x20
		::System::IO::MemoryStream* _Head; // 0x28
		::Class_4_6BD781EAA1CAFD20* _Body; // 0x30
		::System::UInt64 _RecvTimeStampMs; // 0x38
		::System::UInt32 _TailMagic; // 0x40
		::System::UInt32 _PacketID; // 0x44
		::System::UInt16 _HeadLen; // 0x48
		::System::Boolean isInUse; // 0x4A
		::System::Int32 BodySize; // 0x4C
		::System::UInt16 _CmdID; // 0x50
		::System::UInt32 _HeadMagic; // 0x54
		::System::UInt32 _Seed; // 0x58
		::System::Int32 HeadSize; // 0x5C
		::System::UInt32 _BodyLen; // 0x60
