...
#define RPG_CLIENT_REGIONMANAGERDEBUGMONO__CTOR_OFFSET UNITYSDK_OFFSET(0xA296000)

namespace RPG::Client
{
	inline static constexpr unsigned int RegionManagerDebugMono_TypeDefinitionIndex = 50496;
