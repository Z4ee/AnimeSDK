...
#define RPG_CLIENT_BAPARTVARIANTREF__CTOR_OFFSET UNITYSDK_OFFSET(0xB39B0D0)

namespace RPG::Client
{
	inline static constexpr unsigned int BAPartVariantRef_TypeDefinitionIndex = 64984;
