...
#define RPG_CLIENT_FIGHTFESTINPUTHANDLER_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x96B3A50)
#define RPG_CLIENT_FIGHTFESTINPUTHANDLER_ONDRAG_OFFSET UNITYSDK_OFFSET(0x96B3AB0)
#define RPG_CLIENT_FIGHTFESTINPUTHANDLER_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x96B3BB0)
#define RPG_CLIENT_FIGHTFESTINPUTHANDLER_ONPOINTERCLICK_OFFSET UNITYSDK_OFFSET(0x96B3C00)
#define RPG_CLIENT_FIGHTFESTINPUTHANDLER_ONSCROLL_OFFSET UNITYSDK_OFFSET(0x96B3C60)
#define RPG_CLIENT_FIGHTFESTINPUTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x96B3CF0)

namespace RPG::Client
{
	inline static constexpr unsigned int FightFestInputHandler_TypeDefinitionIndex = 52102;
