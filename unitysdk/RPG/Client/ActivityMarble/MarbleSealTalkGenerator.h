...
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTALKGENERATOR_GENERATEBYTEAM_OFFSET UNITYSDK_OFFSET(0xB1B42F0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTALKGENERATOR_GETRANDOMTALKCONFIG_OFFSET UNITYSDK_OFFSET(0xB1B4980)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTALKGENERATOR_GET_OFFSET UNITYSDK_OFFSET(0xB1B41A0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTALKGENERATOR_ISEMPTY_OFFSET UNITYSDK_OFFSET(0xB1B4290)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTALKGENERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xB1B4B10)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTALKGENERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0xB1B4120)

namespace RPG::Client::ActivityMarble
{
	inline static constexpr unsigned int MarbleSealTalkGenerator_TypeDefinitionIndex = 69746;
